...
(define-fun _t_29 () (_ FloatingPoint 8 24) (fp #b1 #b01111011 #b00001110010101100000010))
(define-fun _t_31 () (_ FloatingPoint 8 24) (fp #b0 #b01111010 #b11110011101101100100011))
...
(define-fun _t_35 () (_ FloatingPoint 8 24) (fp #b0 #b01111110 #b10100110011001100110011))
...
(define-fun _t_39 () (_ FloatingPoint 8 24) (fp #b0 #b01111110 #b01110111010010111100011))
...
(define-fun _t_42 () Bool (fp.leq _t_41 _t_29))
(assert _t_42)
(define-fun _t_45 () (_ FloatingPoint 8 24) (fp #b1 #b01111110 #b00101100100010110100001))
(define-fun _t_48 () (_ FloatingPoint 8 24) (fp #b1 #b01111101 #b10111100011010100111111))
...
(define-fun _t_53 () (_ FloatingPoint 8 24) (fp #b1 #b01111101 #b11100010010011011101001))
...
(define-fun _t_57 () (_ FloatingPoint 8 24) (fp #b0 #b01110111 #b11001010110000001000001))
...
(assert _t_60)
(define-fun _t_62 () (_ FloatingPoint 8 24) (fp #b0 #b01111110 #b00000111101011100001001))
(define-fun _t_64 () (_ FloatingPoint 8 24) (fp #b0 #b01111110 #b01011101101100100010110))
...
(define-fun _t_68 () (_ FloatingPoint 8 24) (fp #b0 #b01111110 #b11001110010101100000001))
...
(define-fun _t_73 () (_ FloatingPoint 8 24) (fp #b1 #b01111101 #b01011100001010001111010))
...
(define-fun _t_76 () Bool (fp.leq _t_62 _t_75))
(assert _t_76)
(check-sat)
(exit)
