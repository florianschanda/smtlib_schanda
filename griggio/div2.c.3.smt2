...
(define-fun _t_18 () Bool (fp.lt _t_16 _t_17))
(define-fun _t_19 () Bool (and _t_11 _t_18))
(define-fun _t_20 () Bool (fp.leq _t_17 _t_9))
(define-fun _t_21 () Bool (and _t_19 _t_20))
(define-fun _t_22 () Bool (fp.lt _t_13 _t_12))
(define-fun _t_23 () Bool (and _t_21 _t_22))
(define-fun _t_24 () Bool (fp.leq _t_17 _t_13))
(define-fun _t_25 () Bool (and _t_23 _t_24))
(define-fun _t_26 () Bool (fp.lt _t_15 _t_14))
(define-fun _t_27 () Bool (and _t_25 _t_26))
(define-fun _t_28 () Bool (fp.leq _t_17 _t_15))
