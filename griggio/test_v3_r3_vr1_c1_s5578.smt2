...
(define-fun _t_29 () (_ FloatingPoint 8 24) (fp #b1 #b01111110 #b11001001101110100101110))
(define-fun _t_31 () (_ FloatingPoint 8 24) (fp #b0 #b01111101 #b00111010010111100011010))
...
(define-fun _t_36 () (_ FloatingPoint 8 24) (fp #b1 #b01111101 #b01100101011000000100000))
...
(define-fun _t_41 () (_ FloatingPoint 8 24) (fp #b1 #b01111000 #b00000110001001001101111))
...
(assert _t_44)
(define-fun _t_47 () (_ FloatingPoint 8 24) (fp #b1 #b01111101 #b01010100111111011111001))
(define-fun _t_49 () (_ FloatingPoint 8 24) (fp #b0 #b01111110 #b01011101101100100010110))
...
(define-fun _t_53 () (_ FloatingPoint 8 24) (fp #b0 #b01111101 #b11000110101001111111000))
...
(define-fun _t_58 () (_ FloatingPoint 8 24) (fp #b1 #b01111110 #b01001111010111000010100))
...
(define-fun _t_61 () Bool (fp.leq _t_47 _t_60))
(assert _t_61)
(define-fun _t_63 () (_ FloatingPoint 8 24) (fp #b0 #b01111110 #b11010001111010111000011))
(define-fun _t_66 () (_ FloatingPoint 8 24) (fp #b1 #b01111110 #b11011101101100100010110))
...
(define-fun _t_71 () (_ FloatingPoint 8 24) (fp #b1 #b01111110 #b11000011000100100110110))
...
(define-fun _t_76 () (_ FloatingPoint 8 24) (fp #b1 #b01111001 #b00000110001001001101110))
...
(define-fun _t_79 () Bool (fp.leq _t_63 _t_78))
(assert _t_79)
(check-sat)
(exit)
