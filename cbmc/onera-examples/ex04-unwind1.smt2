...
(define-fun B7 () Bool (bvsge |argc'#0| (_ bv1 32)))
(define-fun B8 () Bool (not (bvsge |argc'#0| (_ bv268435457 32))))
(define-fun B9 () Bool (and (fp.leq |main::1::1::in0!0@1#1| (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)) (fp.geq |main::1::1::in0!0@1#1| (fp #b1 #b01111111111 #b0000000000000000000000000000000000000000000000000000))))
