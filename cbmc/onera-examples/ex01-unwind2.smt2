...
(define-fun B8 () Bool (bvsge |argc'#0| (_ bv1 32)))
(define-fun B9 () Bool (not (bvsge |argc'#0| (_ bv268435457 32))))
(define-fun B10 () Bool (and (fp.leq |main::1::1::in0!0@1#1| (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)) (fp.geq |main::1::1::in0!0@1#1| (fp #b1 #b01111111111 #b0000000000000000000000000000000000000000000000000000))))
(define-fun B11 () Bool (and (fp.leq |main::1::1::in0!0@1#3| (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)) (fp.geq |main::1::1::in0!0@1#3| (fp #b1 #b01111111111 #b0000000000000000000000000000000000000000000000000000))))
(define-fun B12 () Bool (fp.geq (fp.add roundNearestTiesToEven (fp.sub roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b0 #b01111111001 #b0011010011011101001110100011110011111100010100011100) |main::1::x!0@1#3|) |main::1::x!0@1#3|) (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b0 #b01111111001 #b1111110000100000010000000110101101010110011111000000) |main::1::x!0@1#3|) (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))) (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)))
(define-fun B13 () Bool (=> (and true B8 B9 B10) (fp.leq (fp.add roundNearestTiesToEven (fp.sub roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b0 #b01111111001 #b0011010011011101001110100011110011111100010100011100) |main::1::x!0@1#3|) |main::1::x!0@1#3|) (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b0 #b01111111001 #b1111110000100000010000000110101101010110011111000000) |main::1::x!0@1#3|) (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))) (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (fp #b0 #b01111111111 #b0000000000010000110011011110001101100110001010001110))))
(define-fun B14 () Bool (=> (and true B8 B9 B10 B11 B12) (fp.leq (fp.add roundNearestTiesToEven (fp.sub roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b0 #b01111111001 #b0011010011011101001110100011110011111100010100011100) |main::1::x!0@1#4|) |main::1::x!0@1#4|) (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b0 #b01111111001 #b1111110000100000010000000110101101010110011111000000) |main::1::x!0@1#4|) |main::1::y!0@1#4|)) (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b0 #b01111111001 #b0000011010000111110000011110010101011011101010110000) |main::1::y!0@1#4|) |main::1::y!0@1#4|)) (fp #b0 #b01111111111 #b0000000000010000110011011110001101100110001010001110))))
(assert (or (not B13) (not B14)))
(define-fun B15 () Bool (not (fp.leq (fp.add roundNearestTiesToEven (fp.sub roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b0 #b01111111001 #b0011010011011101001110100011110011111100010100011100) |main::1::x!0@1#3|) |main::1::x!0@1#3|) (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b0 #b01111111001 #b1111110000100000010000000110101101010110011111000000) |main::1::x!0@1#3|) (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))) (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (fp #b0 #b01111111111 #b0000000000010000110011011110001101100110001010001110))))
