...
(define-fun |g::x!0@1#1| () (_ BitVec 32) |__CPROVER__start::x!0#2|)
(define-fun |g::1::y!0@1#2| () (_ FloatingPoint 8 24) (fp.sub roundNearestTiesToEven ((_ to_fp 8 24) roundNearestTiesToEven (bvmul |g::x!0@1#1| |g::x!0@1#1|)) (fp #b0 #b10000001 #b00000000000000000000000)))
(declare-fun |__CPROVER__start::x!0#1| () (_ BitVec 32))
(define-fun B0 () Bool (= |__CPROVER__start::x!0#1| |__CPROVER__start::x!0#1|))
(declare-fun |g::1::y!0@1#1| () (_ FloatingPoint 8 24))
(define-fun B1 () Bool (= |g::1::y!0@1#1| |g::1::y!0@1#1|))
(declare-fun |g::1::z!0@1#1| () (_ FloatingPoint 8 24))
(define-fun B2 () Bool (= |g::1::z!0@1#1| |g::1::z!0@1#1|))
(define-fun B3 () Bool (and (bvsge |g::x!0@1#1| (_ bv4294967286 32)) (not (bvsge |g::x!0@1#1| (_ bv11 32)))))
(assert (bvsge |g::x!0@1#1| (_ bv4294967286 32)))
(assert (not (bvsge |g::x!0@1#1| (_ bv11 32))))
(assert (not (not (fp.eq |g::1::y!0@1#2| (fp #b0 #b00000000 #b00000000000000000000000)))))
