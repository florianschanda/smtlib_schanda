...
(assert (= |goto_symex::&92;guard#1| (not (or (not (fp.leq ((_ to_fp 11 53) roundNearestTiesToEven |main::1::x!0@1#2|) (fp #b0 #b10000100000 #b0010101000000101111100100000000000000000000000000000))) (not (fp.geq ((_ to_fp 11 53) roundNearestTiesToEven |main::1::x!0@1#2|) (fp #b1 #b10000100000 #b0010101000000101111100100000000000000000000000000000)))))))
...
(define-fun B6 () Bool (or (not (fp.leq ((_ to_fp 11 53) roundNearestTiesToEven |main::1::x!0@1#2|) (fp #b0 #b10000100000 #b0010101000000101111100100000000000000000000000000000))) (not (fp.geq ((_ to_fp 11 53) roundNearestTiesToEven |main::1::x!0@1#2|) (fp #b1 #b10000100000 #b0010101000000101111100100000000000000000000000000000)))))
