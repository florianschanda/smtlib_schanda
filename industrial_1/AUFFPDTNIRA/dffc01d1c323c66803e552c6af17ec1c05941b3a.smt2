...
(assert (= cat_139 cat_136))
(assert (= cat_140 cat_138))
(assert (= cat_141 cat_137))
(assert (= cat_142 1))
(assert (<= 1 cat_142))
(assert (<= cat_142 (- (spoon_85 (get_potato_26_a (get_potato_28_a cat_129))) 1)))
(assert (and (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10010011 #b00000001101101110000000)) (spoon_56 cat_143)) (and (<= 1 cat_144) (<= cat_144 (- (spoon_85 (get_potato_26_a (get_potato_28_a cat_129))) 1)))))
(assert (not (spoon_64 (+ cat_144 1))))
(check-sat)
(exit)
