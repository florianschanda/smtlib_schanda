...
(assert (and (= cat_136 (spoon_125 (select (get_potato_26_b (get_potato_28_a cat_127)) 1) (select (get_potato_26_b (get_potato_28_a cat_127)) (spoon_83 (get_potato_26_a (get_potato_28_a cat_127)))))) (spoon_117 cat_136)))
(assert (= cat_137 cat_134))
(assert (= cat_138 cat_136))
(assert (= cat_139 cat_135))
(assert (= cat_140 1))
(assert (<= 1 cat_140))
(assert (<= cat_140 (- (spoon_83 (get_potato_26_a (get_potato_28_a cat_127))) 1)))
(assert (and (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10010011 #b00000001101101110000000)) (spoon_54 cat_141)) (and (<= 1 cat_142) (<= cat_142 (- (spoon_83 (get_potato_26_a (get_potato_28_a cat_127))) 1)))))
(assert (not (spoon_62 (+ cat_142 1))))
(check-sat)
(exit)
