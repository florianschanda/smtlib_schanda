...
(assert (= cat_157 cat_152))
(assert (= cat_158 0))
(assert (spoon_119 cat_158))
(assert (=> (<= 1 100) (spoon_60 cat_153)))
(assert (= cat_159 cat_153))
(assert (= cat_160 (spoon_75 (get_potato_22_a (get_potato_24_a cat_105)))))
(assert (= cat_161 (spoon_117 (select (get_potato_22_b (get_potato_24_a cat_105)) 1) (select (get_potato_22_b (get_potato_24_a cat_105)) cat_160))))
(assert (=> (= cat_161 true) (and (= cat_156 (- cat_160 1)) (spoon_60 (- cat_160 1)))))
(assert (=> (= cat_161 true) (= cat_162 cat_160)))
(assert (=> (= cat_161 true) (= cat_163 cat_156)))
(assert (=> (not (= cat_161 true)) (= cat_163 cat_160)))
(assert (= cat_164 cat_154))
(assert (= cat_165 cat_155))
(assert (= (mk_potato_13 cat_166 cat_167) (get_potato_15_a (select (get_potato_22_b (get_potato_24_a cat_105)) cat_163))))
(assert (= cat_163 cat_131))
(assert (spoon_60 cat_131))
(assert (<= 1 cat_131))
(assert (not (<= cat_131 100)))
(check-sat)
(exit)
