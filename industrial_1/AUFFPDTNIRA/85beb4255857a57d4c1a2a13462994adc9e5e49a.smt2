...
(define-fun spoon_188 () potato_13 (mk_potato_13 cat_177 cat_178))
(define-fun spoon_189 () potato_13 (mk_potato_13 cat_171 cat_172))
(assert (= cat_162 cat_150))
(assert (= cat_163 0))
(assert (spoon_117 cat_163))
(assert (=> (<= 1 100) (spoon_58 cat_151)))
(assert (= cat_164 cat_151))
(assert (= cat_165 (spoon_73 (get_potato_22_a (get_potato_24_a cat_103)))))
(assert (= cat_166 (spoon_115 (select (get_potato_22_b (get_potato_24_a cat_103)) 1) (select (get_potato_22_b (get_potato_24_a cat_103)) cat_165))))
(assert (=> (= cat_166 true) (and (= cat_157 (- cat_165 1)) (spoon_58 (- cat_165 1)))))
(assert (=> (= cat_166 true) (= cat_167 cat_165)))
(assert (=> (= cat_166 true) (= cat_168 cat_157)))
(assert (=> (not (= cat_166 true)) (= cat_168 cat_165)))
(assert (= cat_169 cat_152))
(assert (= cat_170 cat_153))
(assert (= spoon_189 (get_potato_15_a (select (get_potato_22_b (get_potato_24_a cat_103)) cat_168))))
(assert (= cat_168 cat_129))
(assert (spoon_58 cat_129))
(assert (= cat_173 cat_156))
(assert (= cat_174 1))
(assert (<= 1 cat_174))
(assert (<= cat_174 cat_129))
(assert (= cat_175 cat_154))
(assert (= cat_176 cat_155))
(assert (= spoon_188 (get_potato_15_a (select (get_potato_22_b (get_potato_24_a cat_103)) cat_174))))
(assert (=> (fp.leq (spoon_36 cat_172) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101)))) (=> (fp.lt (spoon_36 (get_potato_13_b (get_potato_15_a cat_101))) (spoon_36 cat_178)) (and (= cat_158 (spoon_113 (mk_potato_15 spoon_189) (mk_potato_15 spoon_188) cat_101)) (spoon_105 cat_158)))))
(assert (=> (fp.leq (spoon_36 cat_172) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101)))) (=> (fp.lt (spoon_36 (get_potato_13_b (get_potato_15_a cat_101))) (spoon_36 cat_178)) (= cat_179 (ite (= cat_158 0) true false)))))
(assert (=> (fp.leq (spoon_36 cat_172) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101)))) (=> (not (fp.lt (spoon_36 (get_potato_13_b (get_potato_15_a cat_101))) (spoon_36 cat_178))) (= cat_179 false))))
(assert (=> (fp.leq (spoon_36 cat_172) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101)))) (=> (= cat_179 true) (and (= cat_159 (+ cat_163 1)) (spoon_117 (+ cat_163 1))))))
(assert (=> (fp.leq (spoon_36 cat_172) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101)))) (=> (= cat_179 true) (= cat_180 cat_163))))
(assert (=> (fp.leq (spoon_36 cat_172) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101)))) (=> (= cat_179 true) (= cat_181 cat_159))))
(assert (=> (fp.leq (spoon_36 cat_172) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101)))) (=> (not (= cat_179 true)) (= cat_181 cat_163))))
(assert (=> (not (fp.leq (spoon_36 cat_172) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101))))) (=> (fp.leq (spoon_36 cat_178) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101)))) (and (= cat_160 (spoon_113 (mk_potato_15 spoon_189) (mk_potato_15 spoon_188) cat_101)) (spoon_105 cat_160)))))
(assert (=> (not (fp.leq (spoon_36 cat_172) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101))))) (=> (fp.leq (spoon_36 cat_178) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101)))) (= cat_182 (ite (= cat_160 2) true false)))))
(assert (=> (not (fp.leq (spoon_36 cat_172) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101))))) (=> (not (fp.leq (spoon_36 cat_178) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101))))) (= cat_182 false))))
(assert (=> (not (fp.leq (spoon_36 cat_172) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101))))) (=> (= cat_182 true) (and (= cat_161 (- cat_163 1)) (spoon_117 (- cat_163 1))))))
(assert (=> (not (fp.leq (spoon_36 cat_172) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101))))) (=> (= cat_182 true) (= cat_183 cat_163))))
(assert (=> (not (fp.leq (spoon_36 cat_172) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101))))) (=> (= cat_182 true) (= cat_184 cat_161))))
(assert (=> (not (fp.leq (spoon_36 cat_172) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101))))) (=> (not (= cat_182 true)) (= cat_184 cat_163))))
(assert (=> (not (fp.leq (spoon_36 cat_172) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101))))) (= cat_181 cat_184)))
(assert (= cat_185 cat_171))
(assert (= cat_186 cat_172))
(assert (= cat_187 spoon_188))
(assert (not (<= (- cat_174) cat_181)))
(check-sat)
(exit)
