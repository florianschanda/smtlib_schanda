...
(assert (=> (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) (fp (_ bv0 1) (_ bv140 8) (_ bv3489792 23))) (spoon_92 cat_166)))
(assert (=> (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) (fp (_ bv0 1) (_ bv140 8) (_ bv3489792 23))) (spoon_92 cat_167)))
(assert (=> (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) (fp (_ bv0 1) (_ bv127 8) (_ bv0 23))) (spoon_100 cat_168)))
(assert (<= 1 cat_169))
...
(assert (not (spoon_92 (fp.sub roundNearestTiesToEven cat_172 (spoon_117 (get_potato_30_b (get_potato_32_a cat_147)))))))
(check-sat)
(exit)
