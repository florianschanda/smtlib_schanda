...
(assert (= cat_165 1))
(assert (<= 1 cat_165))
(assert (<= cat_165 (spoon_35 (get_potato_20_a (get_potato_22_a cat_145)))))
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000)) (spoon_92 cat_166)))
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000)) (spoon_92 cat_167)))
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b01111111 #b00000000000000000000000)) (spoon_100 cat_168)))
(assert (<= 1 cat_169))
(assert (<= cat_169 (spoon_35 (get_potato_20_a (get_potato_22_a cat_145)))))
(assert (= (mk_potato_15 cat_170 cat_171) (get_potato_17_a (select (get_potato_20_b (get_potato_22_a cat_145)) cat_169))))
(assert (spoon_100 cat_173))
(assert (spoon_92 cat_172))
(assert (not (fp.lt cat_172 (spoon_117 (get_potato_30_b (get_potato_32_a cat_147))))))
(assert (not (spoon_92 (fp.sub RNE cat_172 (spoon_117 (get_potato_30_b (get_potato_32_a cat_147)))))))
(check-sat)
(exit)
