...
(assert (= cat_156 0))
(assert (spoon_118 cat_156))
(assert (=> (<= 1 30) (spoon_105 cat_154)))
(assert (= cat_157 cat_154))
(assert (= cat_158 (spoon_35 (get_potato_20_a (get_potato_22_a cat_115)))))
(assert (= cat_159 (spoon_102 (select (get_potato_20_b (get_potato_22_a cat_115)) 1) (select (get_potato_20_b (get_potato_22_a cat_115)) cat_158))))
(assert (= cat_159 true))
(assert (not (spoon_105 (- cat_158 1))))
(check-sat)
(exit)
