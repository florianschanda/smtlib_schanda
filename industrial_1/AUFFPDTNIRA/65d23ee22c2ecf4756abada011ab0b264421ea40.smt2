...
(declare-fun cat_156 () Int)
(declare-fun cat_157 () Int)
(declare-fun cat_158 () Int)
(declare-fun cat_159 () Bool)
...
(assert (let ((_let_0 (get_potato_20_b (get_potato_22_a cat_115)))) (= cat_159 (spoon_102 (select _let_0 1) (select _let_0 cat_158)))))
(assert (= cat_159 true))
