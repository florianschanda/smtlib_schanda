...
(assert (fp.leq (spoon_38 (get_potato_13_b cat_193)) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103)))))
(assert (=> (fp.lt (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))) (spoon_38 (get_potato_13_b cat_199))) (and (= cat_165 (spoon_115 (mk_potato_15 cat_193) (mk_potato_15 cat_199) cat_103)) (spoon_107 cat_165))))
(assert (=> (fp.lt (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))) (spoon_38 (get_potato_13_b cat_199))) (= cat_200 (ite (= cat_165 0) true false))))
(assert (=> (not (fp.lt (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))) (spoon_38 (get_potato_13_b cat_199)))) (= cat_200 false)))
(assert (= cat_200 true))
