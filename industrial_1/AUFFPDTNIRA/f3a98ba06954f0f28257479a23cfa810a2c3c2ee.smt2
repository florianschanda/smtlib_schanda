...
(assert (fp.leq (spoon_38 (get_potato_13_b cat_199)) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103)))))
(assert (=> (fp.lt (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))) (spoon_38 (get_potato_13_b cat_205))) (and (= cat_168 (spoon_115 (mk_potato_15 cat_199) (mk_potato_15 cat_205) cat_103)) (spoon_107 cat_168))))
(assert (=> (fp.lt (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))) (spoon_38 (get_potato_13_b cat_205))) (= cat_206 (ite (= cat_168 0) true false))))
(assert (=> (not (fp.lt (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))) (spoon_38 (get_potato_13_b cat_205)))) (= cat_206 false)))
(assert (= cat_206 true))
