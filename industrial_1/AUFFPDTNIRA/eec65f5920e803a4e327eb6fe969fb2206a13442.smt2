...
(define-fun spoon_179 () potato_13 (mk_potato_13 cat_176 cat_177))
(define-fun spoon_180 () potato_13 (mk_potato_13 cat_170 cat_171))
(assert (= cat_161 cat_152))
(assert (= cat_162 0))
(assert (spoon_119 cat_162))
(assert (=> (<= 1 100) (spoon_60 cat_153)))
(assert (= cat_163 cat_153))
(assert (= cat_164 (spoon_75 (get_potato_22_a (get_potato_24_a cat_105)))))
(assert (= cat_165 (spoon_117 (select (get_potato_22_b (get_potato_24_a cat_105)) 1) (select (get_potato_22_b (get_potato_24_a cat_105)) cat_164))))
(assert (=> (= cat_165 true) (and (= cat_159 (- cat_164 1)) (spoon_60 (- cat_164 1)))))
(assert (=> (= cat_165 true) (= cat_166 cat_164)))
(assert (=> (= cat_165 true) (= cat_167 cat_159)))
(assert (=> (not (= cat_165 true)) (= cat_167 cat_164)))
(assert (= cat_168 cat_154))
(assert (= cat_169 cat_155))
(assert (= spoon_180 (get_potato_15_a (select (get_potato_22_b (get_potato_24_a cat_105)) cat_167))))
(assert (= cat_167 cat_131))
(assert (spoon_60 cat_131))
(assert (= cat_172 cat_158))
(assert (= cat_173 1))
(assert (<= 1 cat_173))
(assert (<= cat_173 cat_131))
(assert (= cat_174 cat_156))
(assert (= cat_175 cat_157))
(assert (= spoon_179 (get_potato_15_a (select (get_potato_22_b (get_potato_24_a cat_105)) cat_173))))
(assert (not (fp.leq (spoon_38 cat_171) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))))))
(assert (=> (fp.leq (spoon_38 cat_177) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103)))) (and (= cat_160 (spoon_115 (mk_potato_15 spoon_180) (mk_potato_15 spoon_179) cat_103)) (spoon_107 cat_160))))
(assert (=> (fp.leq (spoon_38 cat_177) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103)))) (= cat_178 (ite (= cat_160 2) true false))))
(assert (=> (not (fp.leq (spoon_38 cat_177) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))))) (= cat_178 false)))
(assert (= cat_178 true))
(assert (not (spoon_119 (- cat_162 1))))
(check-sat)
(exit)
