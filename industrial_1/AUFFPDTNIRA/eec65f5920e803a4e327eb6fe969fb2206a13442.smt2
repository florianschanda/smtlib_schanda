...
(define-fun spoon_177 () potato_13 (mk_potato_13 cat_174 cat_175))
(define-fun spoon_178 () potato_13 (mk_potato_13 cat_168 cat_169))
(assert (= cat_159 cat_150))
(assert (= cat_160 0))
(assert (spoon_117 cat_160))
(assert (=> (<= 1 100) (spoon_58 cat_151)))
(assert (= cat_161 cat_151))
(assert (= cat_162 (spoon_73 (get_potato_22_a (get_potato_24_a cat_103)))))
(assert (= cat_163 (spoon_115 (select (get_potato_22_b (get_potato_24_a cat_103)) 1) (select (get_potato_22_b (get_potato_24_a cat_103)) cat_162))))
(assert (=> (= cat_163 true) (and (= cat_157 (- cat_162 1)) (spoon_58 (- cat_162 1)))))
(assert (=> (= cat_163 true) (= cat_164 cat_162)))
(assert (=> (= cat_163 true) (= cat_165 cat_157)))
(assert (=> (not (= cat_163 true)) (= cat_165 cat_162)))
(assert (= cat_166 cat_152))
(assert (= cat_167 cat_153))
(assert (= spoon_178 (get_potato_15_a (select (get_potato_22_b (get_potato_24_a cat_103)) cat_165))))
(assert (= cat_165 cat_129))
(assert (spoon_58 cat_129))
(assert (= cat_170 cat_156))
(assert (= cat_171 1))
(assert (<= 1 cat_171))
(assert (<= cat_171 cat_129))
(assert (= cat_172 cat_154))
(assert (= cat_173 cat_155))
(assert (= spoon_177 (get_potato_15_a (select (get_potato_22_b (get_potato_24_a cat_103)) cat_171))))
(assert (not (fp.leq (spoon_36 cat_169) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101))))))
(assert (=> (fp.leq (spoon_36 cat_175) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101)))) (and (= cat_158 (spoon_113 (mk_potato_15 spoon_178) (mk_potato_15 spoon_177) cat_101)) (spoon_105 cat_158))))
(assert (=> (fp.leq (spoon_36 cat_175) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101)))) (= cat_176 (ite (= cat_158 2) true false))))
(assert (=> (not (fp.leq (spoon_36 cat_175) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101))))) (= cat_176 false)))
(assert (= cat_176 true))
(assert (not (spoon_117 (- cat_160 1))))
(check-sat)
(exit)
