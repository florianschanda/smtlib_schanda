...
(assert (not (fp.leq (spoon_38 cat_181) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))))))
(assert (=> (fp.leq (spoon_38 cat_187) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103)))) (and (= cat_162 (spoon_115 (mk_potato_15 (mk_potato_13 cat_180 cat_181)) (mk_potato_15 (mk_potato_13 cat_186 cat_187)) cat_103)) (spoon_107 cat_162))))
(assert (=> (fp.leq (spoon_38 cat_187) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103)))) (= cat_191 (ite (= cat_162 2) true false))))
(assert (=> (not (fp.leq (spoon_38 cat_187) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))))) (= cat_191 false)))
(assert (= cat_191 true))
(assert (not (spoon_119 (- cat_172 1))))
(check-sat)
(exit)
