...
(define-fun spoon_191 () potato_13 (mk_potato_13 cat_180 cat_181))
(define-fun spoon_192 () potato_13 (mk_potato_13 cat_174 cat_175))
...
(assert (= spoon_192 (get_potato_15_a (select (get_potato_22_b (get_potato_24_a cat_105)) cat_171))))
...
(assert (= spoon_191 (get_potato_15_a (select (get_potato_22_b (get_potato_24_a cat_105)) cat_177))))
(assert (=> (fp.leq (spoon_38 cat_175) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103)))) (=> (fp.lt (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))) (spoon_38 cat_181)) (and (= cat_161 (spoon_115 (mk_potato_15 spoon_192) (mk_potato_15 spoon_191) cat_103)) (spoon_107 cat_161)))))
...
(assert (=> (not (fp.leq (spoon_38 cat_175) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))))) (=> (fp.leq (spoon_38 cat_181) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103)))) (and (= cat_163 (spoon_115 (mk_potato_15 spoon_192) (mk_potato_15 spoon_191) cat_103)) (spoon_107 cat_163)))))
