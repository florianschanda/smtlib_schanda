...
(assert (= cat_132 (spoon_108 cat_112 cat_114)))
...
(assert (= (mk_potato_13 cat_137 cat_138) (get_potato_15_a (select (get_potato_24_b (get_potato_26_a cat_112)) (spoon_76 (get_potato_24_a (get_potato_26_a cat_112)))))))
(assert (= cat_139 cat_129))
(assert (= cat_140 cat_130))
(assert (= (mk_potato_13 cat_141 cat_142) (get_potato_15_a (select (get_potato_24_b (get_potato_26_a cat_114)) (spoon_76 (get_potato_24_a (get_potato_26_a cat_114)))))))
(assert (= cat_143 cat_131))
(assert (= cat_144 1))
(assert (<= 1 cat_144))
(assert (<= cat_144 (spoon_76 (get_potato_24_a (get_potato_26_a cat_112)))))
(assert (and (and (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000)) (spoon_54 cat_145)) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000)) (spoon_54 cat_146))) (and (<= 1 cat_147) (<= cat_147 (spoon_76 (get_potato_24_a (get_potato_26_a cat_112)))))))
(assert (<= 1 (spoon_76 (get_potato_24_a (get_potato_26_a cat_114)))))
(assert (not (<= (spoon_76 (get_potato_24_a (get_potato_26_a cat_114))) 30)))
(check-sat)
(exit)
