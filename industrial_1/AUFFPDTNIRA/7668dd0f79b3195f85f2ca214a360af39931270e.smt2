...
(assert (= cat_146 1))
(assert (<= 1 cat_146))
(assert (<= cat_146 (spoon_78 (get_potato_24_a (get_potato_26_a cat_114)))))
(assert (and (and (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000)) (spoon_56 cat_147)) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000)) (spoon_56 cat_148))) (and (<= 1 cat_149) (<= cat_149 (spoon_78 (get_potato_24_a (get_potato_26_a cat_114)))))))
(assert (<= 1 (spoon_78 (get_potato_24_a (get_potato_26_a cat_116)))))
(assert (not (<= (spoon_78 (get_potato_24_a (get_potato_26_a cat_116))) 30)))
(check-sat)
(exit)
