...
(define-fun spoon_108 ((kitten_91 Float32)) Bool (and (spoon_1 kitten_91) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_91) (fp.leq kitten_91 (fp #b0 #b10010011 #b00000001101101110000000)))))
...
(define-fun spoon_115 ((kitten_93 Float32) (kitten_94 Bool) (kitten_95 Bool) (kitten_96 Bool) (kitten_97 Bool)) Bool (=> (or (= kitten_94 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10010011 #b00000001101101110000000))) (spoon_108 kitten_93)))
(declare-sort potato_30 0)
(declare-fun spoon_116 (potato_30) Int)
(assert (forall ((kitten_98 potato_30)) (and (<= 1 (spoon_116 kitten_98)) (<= (spoon_116 kitten_98) 30))))
(define-fun spoon_117 ((kitten_99 Int)) Bool (and (<= 1 kitten_99) (<= kitten_99 30)))
...
(define-fun spoon_123 ((kitten_100 potato_31)) potato_30 (get_potato_31_a kitten_100))
(define-fun spoon_124 ((kitten_101 Int) (kitten_102 Bool) (kitten_103 Bool) (kitten_104 Bool) (kitten_105 Bool)) Bool (=> (or (= kitten_102 true) (<= 1 30)) (spoon_117 kitten_101)))
(declare-const cat_125 potato_17)
(declare-const cat_126 Int)
(declare-const cat_127 potato_22)
...
(define-fun spoon_136 ((kitten_106 Float32) (kitten_107 Bool) (kitten_108 Bool) (kitten_109 Bool) (kitten_110 Bool)) Bool (=> (or (= kitten_107 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_37 kitten_106)))
(define-fun spoon_137 ((kitten_111 Int) (kitten_112 Bool) (kitten_113 Bool) (kitten_114 Bool) (kitten_115 Bool)) Bool (=> (or (= kitten_112 true) (<= 3 30)) (spoon_28 kitten_111)))
(declare-const cat_138 Int)
(declare-const cat_139 Float32)
(declare-const cat_140 Float32)
(assert (spoon_108 cat_129))
(assert (=> (<= 1 30) (spoon_117 cat_138)))
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b01111111 #b00000000000000000000000)) (spoon_100 cat_139)))
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000)) (spoon_92 cat_140)))
(assert (<= 1 (spoon_35 (get_potato_20_a (get_potato_22_a cat_127)))))
(assert (not (<= 1 1)))
(check-sat)
(exit)
