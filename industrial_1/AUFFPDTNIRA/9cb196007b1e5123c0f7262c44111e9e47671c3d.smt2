...
(define-fun spoon_108 ((kitten_91 (_ FloatingPoint 8 24))) Bool (and (spoon_1 kitten_91) (and (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) kitten_91) (fp.leq kitten_91 (fp (_ bv0 1) (_ bv147 8) (_ bv56192 23))))))
...
(define-fun spoon_115 ((kitten_93 (_ FloatingPoint 8 24)) (kitten_94 Bool) (kitten_95 Bool) (kitten_96 Bool) (kitten_97 Bool)) Bool (=> (or (= kitten_94 true) (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) (fp (_ bv0 1) (_ bv147 8) (_ bv56192 23)))) (spoon_108 kitten_93)))
(declare-sort potato_30 0)
(declare-fun spoon_116 (potato_30) Int)
(assert (forall ((kitten_98 potato_30)) (let ((_let_0 (spoon_116 kitten_98))) (and (<= 1 _let_0) (<= _let_0 30))) ))
...
(declare-fun cat_125 () potato_17)
(declare-fun cat_126 () Int)
(declare-fun cat_127 () potato_22)
...
(define-fun spoon_136 ((kitten_106 (_ FloatingPoint 8 24)) (kitten_107 Bool) (kitten_108 Bool) (kitten_109 Bool) (kitten_110 Bool)) Bool (let ((_let_0 (fp (_ bv0 1) (_ bv139 8) (_ bv0 23)))) (=> (or (= kitten_107 true) (fp.leq (fp.neg _let_0) _let_0)) (spoon_37 kitten_106))))
...
(assert (=> (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) (fp (_ bv0 1) (_ bv127 8) (_ bv0 23))) (spoon_100 cat_139)))
(assert (=> (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) (fp (_ bv0 1) (_ bv140 8) (_ bv3489792 23))) (spoon_92 cat_140)))
