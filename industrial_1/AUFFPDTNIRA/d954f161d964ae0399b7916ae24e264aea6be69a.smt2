...
(assert (forall ((kitten_8 potato_10)) (let ((_let_0 (spoon_13 kitten_8))) (and (<= 3 _let_0) (<= _let_0 30))) ))
(define-fun spoon_14 ((kitten_9 Int)) Bool (and (<= 3 kitten_9) (<= kitten_9 30)))
...
(define-fun spoon_24 ((kitten_15 (_ FloatingPoint 8 24))) Bool (and (fp.isInfinite kitten_15) (fp.isPositive kitten_15)))
(define-fun spoon_25 ((kitten_16 (_ FloatingPoint 8 24))) Bool (and (fp.isInfinite kitten_16) (fp.isNegative kitten_16)))
(define-fun spoon_26 ((kitten_17 (_ FloatingPoint 8 24))) Bool (and (fp.isZero kitten_17) (fp.isPositive kitten_17)))
(define-fun spoon_27 ((kitten_18 (_ FloatingPoint 8 24))) Bool (and (fp.isZero kitten_18) (fp.isNegative kitten_18)))
...
(define-fun spoon_31 ((kitten_21 (_ FloatingPoint 8 24)) (kitten_22 (_ FloatingPoint 8 24))) Bool (or (and (fp.isPositive kitten_21) (fp.isPositive kitten_22)) (and (fp.isNegative kitten_21) (fp.isNegative kitten_22))))
(define-fun spoon_32 ((kitten_23 (_ FloatingPoint 8 24)) (kitten_24 (_ FloatingPoint 8 24))) Bool (or (and (fp.isPositive kitten_23) (fp.isNegative kitten_24)) (and (fp.isNegative kitten_23) (fp.isPositive kitten_24))))
(define-fun spoon_33 ((kitten_25 (_ FloatingPoint 8 24)) (kitten_26 (_ FloatingPoint 8 24)) (kitten_27 (_ FloatingPoint 8 24))) Bool (and (=> (spoon_31 kitten_26 kitten_27) (fp.isPositive kitten_25)) (=> (spoon_32 kitten_26 kitten_27) (fp.isNegative kitten_25))))
(define-fun spoon_34 ((kitten_28 Real)) Real (* kitten_28 kitten_28))
(declare-fun spoon_35 (Real) Real)
(define-fun spoon_36 ((kitten_29 (_ FloatingPoint 8 24)) (kitten_30 Real)) Bool (let ((_let_0 (/ 0 1))) (or (and (fp.isPositive kitten_29) (< _let_0 kitten_30)) (and (fp.isNegative kitten_29) (< kitten_30 _let_0)))))
...
(define-fun spoon_78 ((kitten_72 potato_22) (kitten_73 potato_22)) Bool (let ((_let_0 (get_potato_22_a kitten_72))) (let ((_let_1 (get_potato_22_a kitten_73))) (ite (and (= (spoon_21 (get_potato_20_a _let_0)) (spoon_21 (get_potato_20_a _let_1))) (= (spoon_65 (get_potato_20_b _let_0) 1 30 (get_potato_20_b _let_1) 1 30) true)) true false))))
...
(assert (forall ((kitten_77 potato_24)) (let ((_let_0 (spoon_94 kitten_77))) (and (<= 1 _let_0) (<= _let_0 30))) ))
(define-fun spoon_95 ((kitten_78 Int)) Bool (and (<= 1 kitten_78) (<= kitten_78 30)))
...
(declare-fun cat_102 () potato_22)
(declare-fun cat_103 () Int)
(declare-fun cat_104 () potato_22)
(declare-fun cat_105 () Int)
(declare-fun cat_106 () Int)
(declare-fun cat_107 () Int)
(declare-fun cat_108 () Int)
(define-fun spoon_109 ((kitten_80 (_ FloatingPoint 8 24)) (kitten_81 Bool) (kitten_82 Bool) (kitten_83 Bool) (kitten_84 Bool)) Bool (let ((_let_0 (fp (_ bv0 1) (_ bv139 8) (_ bv0 23)))) (=> (or (= kitten_81 true) (fp.leq (fp.neg _let_0) _let_0)) (spoon_37 kitten_80))))
(define-fun spoon_110 ((kitten_85 Int) (kitten_86 Bool) (kitten_87 Bool) (kitten_88 Bool) (kitten_89 Bool)) Bool (=> (or (= kitten_86 true) (<= 1 30)) (spoon_95 kitten_85)))
(define-fun spoon_111 ((kitten_90 Int) (kitten_91 Bool) (kitten_92 Bool) (kitten_93 Bool) (kitten_94 Bool)) Bool (=> (or (= kitten_91 true) (<= 3 30)) (spoon_14 kitten_90)))
(declare-fun cat_112 () Bool)
(declare-fun cat_113 () Bool)
(declare-fun cat_114 () Bool)
(declare-fun cat_115 () Int)
(declare-fun cat_116 () Bool)
(declare-fun cat_117 () Int)
(declare-fun cat_118 () Bool)
(declare-fun cat_119 () Bool)
(declare-fun cat_120 () Bool)
(declare-fun cat_121 () Int)
(declare-fun cat_122 () Bool)
(declare-fun cat_123 () Int)
(declare-fun cat_124 () Bool)
(declare-fun cat_125 () Int)
(declare-fun cat_126 () Bool)
...
(assert (let ((_let_0 (spoon_21 (get_potato_20_a (get_potato_22_a cat_102))))) (=> (and (<= 1 cat_115) (<= cat_115 _let_0)) (and (<= 1 cat_117) (<= cat_117 _let_0)))))
(assert (let ((_let_0 (get_potato_22_a cat_102))) (=> (and (<= 1 cat_115) (<= cat_115 (spoon_21 (get_potato_20_a _let_0)))) (= cat_113 (spoon_92 (select (get_potato_20_b _let_0) cat_117) cat_104)))))
...
(assert (let ((_let_0 (spoon_21 (get_potato_20_a (get_potato_22_a cat_102))))) (let ((_let_1 (= cat_119 true))) (=> (and (<= 1 cat_115) (<= cat_115 _let_0)) (or _let_1 (and (not _let_1) (= cat_117 _let_0)))))))
...
(assert (not (<= (spoon_21 (get_potato_20_a (get_potato_22_a cat_104))) 30)))
(check-sat)
(exit)
