...
(assert (forall ((kitten_8 potato_10)) (and (<= 3 (spoon_13 kitten_8)) (<= (spoon_13 kitten_8) 30))))
...
(define-fun spoon_78 ((kitten_72 potato_22) (kitten_73 potato_22)) Bool (ite (and (= (spoon_21 (get_potato_20_a (get_potato_22_a kitten_72))) (spoon_21 (get_potato_20_a (get_potato_22_a kitten_73)))) (= (spoon_65 (get_potato_20_b (get_potato_22_a kitten_72)) 1 30 (get_potato_20_b (get_potato_22_a kitten_73)) 1 30) true)) true false))
...
(assert (forall ((kitten_77 potato_24)) (and (<= 1 (spoon_94 kitten_77)) (<= (spoon_94 kitten_77) 30))))
