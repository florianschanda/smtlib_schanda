...
(assert (= spoon_193 (get_potato_15_a (select (get_potato_22_b (get_potato_24_a cat_105)) cat_170))))
...
(assert (= spoon_192 (get_potato_15_a (select (get_potato_22_b (get_potato_24_a cat_105)) cat_176))))
(assert (=> (fp.leq (spoon_38 cat_174) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103)))) (=> (fp.lt (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))) (spoon_38 cat_180)) (and (= cat_160 (spoon_115 (mk_potato_15 spoon_193) (mk_potato_15 spoon_192) cat_103)) (spoon_107 cat_160)))))
...
(assert (=> (not (fp.leq (spoon_38 cat_174) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))))) (=> (fp.leq (spoon_38 cat_180) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103)))) (and (= cat_162 (spoon_115 (mk_potato_15 spoon_193) (mk_potato_15 spoon_192) cat_103)) (spoon_107 cat_162)))))
...
(assert (and (and (=> (<= 1 cat_131) (spoon_142 1 cat_131 cat_191)) (=> (<= (- 100) 100) (spoon_119 cat_190))) (and (<= 1 cat_191) (<= cat_191 cat_131))))
(assert (not (spoon_119 cat_191)))
(check-sat)
(exit)
