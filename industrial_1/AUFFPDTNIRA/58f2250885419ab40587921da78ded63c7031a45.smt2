...
(define-fun spoon_190 () potato_13 (mk_potato_13 cat_177 cat_178))
(define-fun spoon_191 () potato_13 (mk_potato_13 cat_171 cat_172))
...
(assert (= spoon_191 (get_potato_15_a (select (get_potato_22_b (get_potato_24_a cat_103)) cat_168))))
...
(assert (= spoon_190 (get_potato_15_a (select (get_potato_22_b (get_potato_24_a cat_103)) cat_174))))
(assert (=> (fp.leq (spoon_36 cat_172) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101)))) (=> (fp.lt (spoon_36 (get_potato_13_b (get_potato_15_a cat_101))) (spoon_36 cat_178)) (and (= cat_158 (spoon_113 (mk_potato_15 spoon_191) (mk_potato_15 spoon_190) cat_101)) (spoon_105 cat_158)))))
...
(assert (=> (not (fp.leq (spoon_36 cat_172) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101))))) (=> (fp.leq (spoon_36 cat_178) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101)))) (and (= cat_160 (spoon_113 (mk_potato_15 spoon_191) (mk_potato_15 spoon_190) cat_101)) (spoon_105 cat_160)))))
...
(assert (= cat_187 spoon_190))
(assert (and (<= (- cat_189) cat_188) (<= cat_188 cat_189)))
(assert (and (and (=> (<= 1 cat_129) (spoon_140 1 cat_129 cat_189)) (=> (<= (- 100) 100) (spoon_117 cat_188))) (and (<= 1 cat_189) (<= cat_189 cat_129))))
(assert (not (spoon_117 cat_189)))
(check-sat)
(exit)
