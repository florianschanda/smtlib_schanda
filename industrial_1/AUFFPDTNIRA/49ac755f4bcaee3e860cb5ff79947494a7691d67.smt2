...
(assert (forall ((kitten_102 potato_15) (kitten_103 potato_15) (kitten_104 potato_15) (kitten_105 potato_15)) (! (spoon_71 (spoon_119 kitten_102 kitten_103 kitten_104 kitten_105) true false true) :pattern ((spoon_119 kitten_102 kitten_103 kitten_104 kitten_105)))))
...
(define-fun spoon_133 ((kitten_106 Float32) (kitten_107 Bool) (kitten_108 Bool) (kitten_109 Bool)) Bool (=> (or (= kitten_107 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_31 kitten_106)))
(define-fun spoon_134 ((kitten_110 Int) (kitten_111 Bool) (kitten_112 Bool) (kitten_113 Bool)) Bool (=> (or (= kitten_111 true) (<= 3 30)) (spoon_80 kitten_110)))
