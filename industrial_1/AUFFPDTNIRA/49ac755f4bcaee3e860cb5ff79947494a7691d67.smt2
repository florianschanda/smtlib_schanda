...
(declare-fun spoon_117 (potato_15 potato_15 potato_15 potato_15) Float32)
(declare-fun spoon_118 (Float32 potato_15 potato_15 potato_15 potato_15) Bool)
(assert (forall ((kitten_101 potato_15) (kitten_102 potato_15) (kitten_103 potato_15) (kitten_104 potato_15)) (! (spoon_69 (spoon_117 kitten_101 kitten_102 kitten_103 kitten_104) true false true) :pattern ((spoon_117 kitten_101 kitten_102 kitten_103 kitten_104)))))
(declare-const cat_119 potato_15)
...
(define-fun spoon_131 ((kitten_105 Float32) (kitten_106 Bool) (kitten_107 Bool) (kitten_108 Bool)) Bool (=> (or (= kitten_106 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_29 kitten_105)))
(define-fun spoon_132 ((kitten_109 Int) (kitten_110 Bool) (kitten_111 Bool) (kitten_112 Bool)) Bool (=> (or (= kitten_110 true) (<= 3 30)) (spoon_78 kitten_109)))
...
(assert (spoon_54 cat_125))
(assert (= cat_136 cat_133))
(assert (= cat_137 (spoon_24 0)))
(assert (=> (<= 1 30) (spoon_70 cat_134)))
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000)) (spoon_62 cat_135)))
(assert (= cat_138 cat_134))
(assert (= cat_139 (spoon_85 (get_potato_26_a (get_potato_28_a cat_123)))))
(assert (<= 1 (spoon_85 (get_potato_26_a (get_potato_28_a cat_123)))))
(assert (not (<= 1 1)))
(check-sat)
(exit)
