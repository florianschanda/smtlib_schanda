...
(assert (forall ((kitten_87 potato_26)) (and (<= 1 (spoon_104 kitten_87)) (<= (spoon_104 kitten_87) 30))))
...
(assert (forall ((kitten_95 potato_28)) (and (<= (- 30) (spoon_117 kitten_95)) (<= (spoon_117 kitten_95) 30))))
...
(assert (forall ((kitten_103 potato_30)) (and (<= (- 128) (spoon_133 kitten_103)) (<= (spoon_133 kitten_103) 127))))
...
(define-fun spoon_151 ((kitten_114 Float32) (kitten_115 Bool) (kitten_116 Bool) (kitten_117 Bool) (kitten_118 Bool)) Bool (=> (or (= kitten_115 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_37 kitten_114)))
...
(declare-const cat_158 potato_13)
...
(assert (= cat_169 (spoon_102 (select (get_potato_20_b (get_potato_22_a cat_115)) 1) (select (get_potato_20_b (get_potato_22_a cat_115)) cat_168))))
(assert (=> (= cat_169 true) (and (= cat_160 (- cat_168 1)) (spoon_105 (- cat_168 1)))))
...
(assert (=> (fp.leq (spoon_44 cat_175) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (fp.lt (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))) (spoon_44 cat_181)) (and (= cat_161 (spoon_92 (mk_potato_17 spoon_192) (mk_potato_17 spoon_191) cat_113)) (spoon_94 cat_161)))))
(assert (=> (fp.leq (spoon_44 cat_175) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (fp.lt (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))) (spoon_44 cat_181)) (= cat_182 (ite (= cat_161 0) true false)))))
(assert (=> (fp.leq (spoon_44 cat_175) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (not (fp.lt (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))) (spoon_44 cat_181))) (= cat_182 false))))
(assert (=> (fp.leq (spoon_44 cat_175) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (= cat_182 true) (and (= cat_162 (+ cat_166 1)) (spoon_118 (+ cat_166 1))))))
...
(assert (=> (not (fp.leq (spoon_44 cat_175) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (fp.leq (spoon_44 cat_181) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (and (= cat_163 (spoon_92 (mk_potato_17 spoon_192) (mk_potato_17 spoon_191) cat_113)) (spoon_94 cat_163)))))
(assert (=> (not (fp.leq (spoon_44 cat_175) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (fp.leq (spoon_44 cat_181) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (= cat_185 (ite (= cat_163 2) true false)))))
(assert (=> (not (fp.leq (spoon_44 cat_175) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (not (fp.leq (spoon_44 cat_181) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (= cat_185 false))))
(assert (=> (not (fp.leq (spoon_44 cat_175) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (= cat_185 true) (and (= cat_164 (- cat_166 1)) (spoon_118 (- cat_166 1))))))
