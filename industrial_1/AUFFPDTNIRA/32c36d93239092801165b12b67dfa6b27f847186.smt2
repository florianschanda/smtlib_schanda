...
(assert (forall ((kitten_87 potato_26)) (let ((_let_0 (spoon_104 kitten_87))) (and (<= 1 _let_0) (<= _let_0 30))) ))
(define-fun spoon_105 ((kitten_88 Int)) Bool (and (<= 1 kitten_88) (<= kitten_88 30)))
...
(define-fun spoon_112 ((kitten_90 Int) (kitten_91 Bool) (kitten_92 Bool) (kitten_93 Bool) (kitten_94 Bool)) Bool (=> (or (= kitten_91 true) (<= 1 30)) (spoon_105 kitten_90)))
...
(assert (forall ((kitten_95 potato_28)) (let ((_let_0 (spoon_117 kitten_95))) (and (<= (- 30) _let_0) (<= _let_0 30))) ))
(define-fun spoon_118 ((kitten_96 Int)) Bool (and (<= (- 30) kitten_96) (<= kitten_96 30)))
...
(define-fun spoon_125 ((kitten_98 Int) (kitten_99 Bool) (kitten_100 Bool) (kitten_101 Bool) (kitten_102 Bool)) Bool (=> (or (= kitten_99 true) (<= (- 30) 30)) (spoon_118 kitten_98)))
...
(declare-fun spoon_133 (potato_30) Int)
(assert (forall ((kitten_103 potato_30)) (let ((_let_0 (spoon_133 kitten_103))) (and (<= (- 128) _let_0) (<= _let_0 127))) ))
...
(define-fun spoon_141 ((kitten_106 potato_30)) Int (spoon_133 kitten_106))
...
(define-fun spoon_151 ((kitten_114 (_ FloatingPoint 8 24)) (kitten_115 Bool) (kitten_116 Bool) (kitten_117 Bool) (kitten_118 Bool)) Bool (let ((_let_0 (fp (_ bv0 1) (_ bv139 8) (_ bv0 23)))) (=> (or (= kitten_115 true) (fp.leq (fp.neg _let_0) _let_0)) (spoon_37 kitten_114))))
(define-fun spoon_152 ((kitten_119 Int) (kitten_120 Bool) (kitten_121 Bool) (kitten_122 Bool) (kitten_123 Bool)) Bool (=> (or (= kitten_120 true) (<= 3 30)) (spoon_28 kitten_119)))
...
(declare-fun cat_169 () Bool)
(declare-fun cat_170 () Int)
(declare-fun cat_171 () Int)
(declare-fun cat_172 () potato_13)
...
(declare-fun cat_182 () Bool)
(declare-fun cat_183 () Int)
(declare-fun cat_184 () Int)
(declare-fun cat_185 () Bool)
(declare-fun cat_186 () Int)
(declare-fun cat_187 () Int)
(declare-fun cat_188 () potato_13)
(declare-fun cat_189 () potato_13)
(declare-fun cat_190 () potato_15)
(define-fun spoon_191 () potato_15 (mk_potato_15 cat_180 cat_181))
(define-fun spoon_192 () potato_15 (mk_potato_15 cat_174 cat_175))
(assert (= cat_165 cat_153))
(assert (= cat_166 0))
(assert (spoon_118 cat_166))
(assert (=> (<= 1 30) (spoon_105 cat_154)))
(assert (= cat_167 cat_154))
(assert (= cat_168 (spoon_35 (get_potato_20_a (get_potato_22_a cat_115)))))
(assert (let ((_let_0 (get_potato_20_b (get_potato_22_a cat_115)))) (= cat_169 (spoon_102 (select _let_0 1) (select _let_0 cat_168)))))
(assert (let ((_let_0 (- cat_168 1))) (=> (= cat_169 true) (and (= cat_160 _let_0) (spoon_105 _let_0)))))
...
(assert (= spoon_192 (get_potato_17_a (select (get_potato_20_b (get_potato_22_a cat_115)) cat_171))))
(assert (= cat_171 cat_131))
(assert (spoon_105 cat_131))
...
(assert (= spoon_191 (get_potato_17_a (select (get_potato_20_b (get_potato_22_a cat_115)) cat_177))))
(assert (let ((_let_0 (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (fp.leq (spoon_44 cat_175) _let_0) (=> (fp.lt _let_0 (spoon_44 cat_181)) (and (= cat_161 (spoon_92 (mk_potato_17 spoon_192) (mk_potato_17 spoon_191) cat_113)) (spoon_94 cat_161))))))
(assert (let ((_let_0 (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (fp.leq (spoon_44 cat_175) _let_0) (=> (fp.lt _let_0 (spoon_44 cat_181)) (= cat_182 (ite (= cat_161 0) true false))))))
(assert (let ((_let_0 (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (fp.leq (spoon_44 cat_175) _let_0) (=> (not (fp.lt _let_0 (spoon_44 cat_181))) (= cat_182 false)))))
(assert (let ((_let_0 (+ cat_166 1))) (=> (fp.leq (spoon_44 cat_175) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (= cat_182 true) (and (= cat_162 _let_0) (spoon_118 _let_0))))))
(assert (=> (fp.leq (spoon_44 cat_175) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (= cat_182 true) (= cat_183 cat_166))))
(assert (=> (fp.leq (spoon_44 cat_175) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (= cat_182 true) (= cat_184 cat_162))))
(assert (=> (fp.leq (spoon_44 cat_175) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (not (= cat_182 true)) (= cat_184 cat_166))))
(assert (let ((_let_0 (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (not (fp.leq (spoon_44 cat_175) _let_0)) (=> (fp.leq (spoon_44 cat_181) _let_0) (and (= cat_163 (spoon_92 (mk_potato_17 spoon_192) (mk_potato_17 spoon_191) cat_113)) (spoon_94 cat_163))))))
(assert (let ((_let_0 (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (not (fp.leq (spoon_44 cat_175) _let_0)) (=> (fp.leq (spoon_44 cat_181) _let_0) (= cat_185 (ite (= cat_163 2) true false))))))
(assert (let ((_let_0 (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (not (fp.leq (spoon_44 cat_175) _let_0)) (=> (not (fp.leq (spoon_44 cat_181) _let_0)) (= cat_185 false)))))
(assert (let ((_let_0 (- cat_166 1))) (=> (not (fp.leq (spoon_44 cat_175) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (= cat_185 true) (and (= cat_164 _let_0) (spoon_118 _let_0))))))
(assert (=> (not (fp.leq (spoon_44 cat_175) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (= cat_185 true) (= cat_186 cat_166))))
(assert (=> (not (fp.leq (spoon_44 cat_175) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (= cat_185 true) (= cat_187 cat_164))))
(assert (=> (not (fp.leq (spoon_44 cat_175) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (not (= cat_185 true)) (= cat_187 cat_166))))
(assert (=> (not (fp.leq (spoon_44 cat_175) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (= cat_184 cat_187)))
(assert (= cat_188 cat_174))
(assert (= cat_189 cat_175))
(assert (= cat_190 spoon_191))
(assert (not (<= (- cat_177) cat_184)))
(check-sat)
(exit)
