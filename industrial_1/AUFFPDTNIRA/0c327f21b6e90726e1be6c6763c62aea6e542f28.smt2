...
(declare-fun spoon_100 (potato_15 potato_15) Bool)
(declare-fun spoon_101 (Bool potato_15 potato_15) Bool)
(assert true)
(assert (forall ((kitten_85 potato_15) (kitten_86 potato_15)) (! (= (= (spoon_100 kitten_85 kitten_86) true) (and (fp.leq (fp.abs (fp.sub RNE (spoon_36 (get_potato_13_a (get_potato_15_a kitten_85))) (spoon_36 (get_potato_13_a (get_potato_15_a kitten_86))))) (fp #b0 #b01110111 #b01000111101011100001010)) (fp.leq (fp.abs (fp.sub RNE (spoon_36 (get_potato_13_b (get_potato_15_a kitten_85))) (spoon_36 (get_potato_13_b (get_potato_15_a kitten_86))))) (fp #b0 #b01110111 #b01000111101011100001010)))) :pattern ((spoon_100 kitten_85 kitten_86)))))
...
(define-fun spoon_108 ((kitten_87 Float32) (kitten_88 Bool) (kitten_89 Bool) (kitten_90 Bool)) Bool (=> (or (= kitten_88 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_29 kitten_87)))
(define-fun spoon_109 ((kitten_91 Int) (kitten_92 Bool) (kitten_93 Bool) (kitten_94 Bool)) Bool (=> (or (= kitten_92 true) (<= 1 30)) (spoon_54 kitten_91)))
(define-fun spoon_110 ((kitten_95 Int) (kitten_96 Bool) (kitten_97 Bool) (kitten_98 Bool)) Bool (=> (or (= kitten_96 true) (<= 3 30)) (spoon_61 kitten_95)))
(declare-const cat_111 Bool)
(declare-const cat_112 Bool)
(declare-const cat_113 Bool)
(assert (= cat_112 cat_111))
(assert (= cat_113 (spoon_9 0)))
(assert (= (spoon_68 (get_potato_22_a (get_potato_24_a cat_102))) (spoon_68 (get_potato_22_a (get_potato_24_a cat_104)))))
(assert (<= 1 (spoon_68 (get_potato_22_a (get_potato_24_a cat_104)))))
(assert (not (<= 1 1)))
(check-sat)
(exit)
