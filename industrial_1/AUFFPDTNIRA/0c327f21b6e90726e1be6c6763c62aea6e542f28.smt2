...
(assert true)
(assert (forall ((kitten_85 potato_15) (kitten_86 potato_15)) (! (= (= (spoon_102 kitten_85 kitten_86) true) (and (fp.leq (fp.abs (fp.sub RNE (spoon_38 (get_potato_13_a (get_potato_15_a kitten_85))) (spoon_38 (get_potato_13_a (get_potato_15_a kitten_86))))) (fp #b0 #b01110111 #b01000111101011100001010)) (fp.leq (fp.abs (fp.sub RNE (spoon_38 (get_potato_13_b (get_potato_15_a kitten_85))) (spoon_38 (get_potato_13_b (get_potato_15_a kitten_86))))) (fp #b0 #b01110111 #b01000111101011100001010)))) :pattern ((spoon_102 kitten_85 kitten_86)))))
...
(define-fun spoon_110 ((kitten_87 Float32) (kitten_88 Bool) (kitten_89 Bool) (kitten_90 Bool)) Bool (=> (or (= kitten_88 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_31 kitten_87)))
(define-fun spoon_111 ((kitten_91 Int) (kitten_92 Bool) (kitten_93 Bool) (kitten_94 Bool)) Bool (=> (or (= kitten_92 true) (<= 1 30)) (spoon_56 kitten_91)))
(define-fun spoon_112 ((kitten_95 Int) (kitten_96 Bool) (kitten_97 Bool) (kitten_98 Bool)) Bool (=> (or (= kitten_96 true) (<= 3 30)) (spoon_63 kitten_95)))
(declare-const cat_113 Bool)
(declare-const cat_114 Bool)
(declare-const cat_115 Bool)
(assert (= cat_114 cat_113))
(assert (= cat_115 (spoon_9 0)))
