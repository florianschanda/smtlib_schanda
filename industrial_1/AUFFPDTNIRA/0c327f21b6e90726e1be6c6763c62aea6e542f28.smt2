...
(declare-fun spoon_102 (potato_15 potato_15) Bool)
(declare-fun spoon_103 (Bool potato_15 potato_15) Bool)
(assert true)
(assert (forall ((kitten_86 potato_15) (kitten_87 potato_15)) (! (= (= (spoon_102 kitten_86 kitten_87) true) (and (fp.leq (fp.abs (fp.sub RNE (spoon_38 (get_potato_13_a (get_potato_15_a kitten_86))) (spoon_38 (get_potato_13_a (get_potato_15_a kitten_87))))) (fp #b0 #b01110111 #b01000111101011100001010)) (fp.leq (fp.abs (fp.sub RNE (spoon_38 (get_potato_13_b (get_potato_15_a kitten_86))) (spoon_38 (get_potato_13_b (get_potato_15_a kitten_87))))) (fp #b0 #b01110111 #b01000111101011100001010)))) :pattern ((spoon_102 kitten_86 kitten_87)))))
...
(define-fun spoon_110 ((kitten_88 Float32) (kitten_89 Bool) (kitten_90 Bool) (kitten_91 Bool)) Bool (=> (or (= kitten_89 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_31 kitten_88)))
(define-fun spoon_111 ((kitten_92 Int) (kitten_93 Bool) (kitten_94 Bool) (kitten_95 Bool)) Bool (=> (or (= kitten_93 true) (<= 1 30)) (spoon_56 kitten_92)))
(define-fun spoon_112 ((kitten_96 Int) (kitten_97 Bool) (kitten_98 Bool) (kitten_99 Bool)) Bool (=> (or (= kitten_97 true) (<= 3 30)) (spoon_63 kitten_96)))
(declare-const cat_113 Bool)
(declare-const cat_114 Bool)
(declare-const cat_115 Bool)
(assert (= cat_114 cat_113))
(assert (= cat_115 (spoon_10 0)))
(assert (= (spoon_70 (get_potato_22_a (get_potato_24_a cat_104))) (spoon_70 (get_potato_22_a (get_potato_24_a cat_106)))))
(assert (<= 1 (spoon_70 (get_potato_22_a (get_potato_24_a cat_106)))))
(assert (not (<= 1 1)))
(check-sat)
(exit)
