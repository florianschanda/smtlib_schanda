...
(assert (fp.leq (spoon_38 cat_182) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103)))))
(assert (=> (fp.lt (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))) (spoon_38 cat_188)) (and (= cat_161 (spoon_115 (mk_potato_15 (mk_potato_13 cat_181 cat_182)) (mk_potato_15 (mk_potato_13 cat_187 cat_188)) cat_103)) (spoon_107 cat_161))))
(assert (=> (fp.lt (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))) (spoon_38 cat_188)) (= cat_189 (ite (= cat_161 0) true false))))
(assert (=> (not (fp.lt (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))) (spoon_38 cat_188))) (= cat_189 false)))
(assert (= cat_189 true))
(assert (not (spoon_119 (+ cat_173 1))))
(check-sat)
(exit)
