...
(assert (fp.leq (spoon_38 cat_172) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103)))))
(assert (=> (fp.lt (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))) (spoon_38 cat_178)) (and (= cat_161 (spoon_115 (mk_potato_15 spoon_181) (mk_potato_15 spoon_180) cat_103)) (spoon_107 cat_161))))
(assert (=> (fp.lt (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))) (spoon_38 cat_178)) (= cat_179 (ite (= cat_161 0) true false))))
(assert (=> (not (fp.lt (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))) (spoon_38 cat_178))) (= cat_179 false)))
(assert (= cat_179 true))
