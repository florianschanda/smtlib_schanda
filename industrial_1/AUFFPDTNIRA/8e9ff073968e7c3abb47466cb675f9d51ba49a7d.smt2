...
(declare-const cat_177 Bool)
(define-fun spoon_178 () potato_13 (mk_potato_13 cat_175 cat_176))
(define-fun spoon_179 () potato_13 (mk_potato_13 cat_169 cat_170))
(assert (= cat_160 cat_151))
(assert (= cat_161 0))
(assert (spoon_117 cat_161))
(assert (=> (<= 1 30) (spoon_54 cat_152)))
(assert (= cat_162 cat_152))
(assert (= cat_163 (spoon_69 (get_potato_22_a (get_potato_24_a cat_103)))))
(assert (= cat_164 (spoon_115 (select (get_potato_22_b (get_potato_24_a cat_103)) 1) (select (get_potato_22_b (get_potato_24_a cat_103)) cat_163))))
(assert (=> (= cat_164 true) (and (= cat_158 (- cat_163 1)) (spoon_54 (- cat_163 1)))))
(assert (=> (= cat_164 true) (= cat_165 cat_163)))
(assert (=> (= cat_164 true) (= cat_166 cat_158)))
(assert (=> (not (= cat_164 true)) (= cat_166 cat_163)))
(assert (= cat_167 cat_153))
(assert (= cat_168 cat_154))
(assert (= spoon_179 (get_potato_15_a (select (get_potato_22_b (get_potato_24_a cat_103)) cat_166))))
(assert (= cat_166 cat_130))
(assert (spoon_54 cat_130))
(assert (= cat_171 cat_157))
(assert (= cat_172 1))
(assert (<= 1 cat_172))
(assert (<= cat_172 cat_130))
(assert (= cat_173 cat_155))
(assert (= cat_174 cat_156))
(assert (= spoon_178 (get_potato_15_a (select (get_potato_22_b (get_potato_24_a cat_103)) cat_172))))
(assert (fp.leq (spoon_36 cat_170) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101)))))
(assert (=> (fp.lt (spoon_36 (get_potato_13_b (get_potato_15_a cat_101))) (spoon_36 cat_176)) (and (= cat_159 (spoon_113 (mk_potato_15 spoon_179) (mk_potato_15 spoon_178) cat_101)) (spoon_105 cat_159))))
(assert (=> (fp.lt (spoon_36 (get_potato_13_b (get_potato_15_a cat_101))) (spoon_36 cat_176)) (= cat_177 (ite (= cat_159 0) true false))))
(assert (=> (not (fp.lt (spoon_36 (get_potato_13_b (get_potato_15_a cat_101))) (spoon_36 cat_176))) (= cat_177 false)))
(assert (= cat_177 true))
(assert (not (spoon_117 (+ cat_161 1))))
(check-sat)
(exit)
