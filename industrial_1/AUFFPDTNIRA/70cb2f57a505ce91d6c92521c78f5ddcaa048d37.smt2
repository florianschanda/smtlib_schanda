...
(assert (= cat_164 (spoon_142 (get_potato_21_a (get_potato_23_a cat_146)) cat_144)))
(assert (not (= cat_164 true)))
(assert (= cat_165 cat_158))
(assert (= cat_166 (fp #b0 #b10001100 #b01101010100000000000000)))
(assert (= cat_167 cat_160))
(assert (= cat_168 cat_161))
(assert (= (mk_potato_13 cat_169 cat_170) (get_potato_15_a (select (get_potato_30_b (get_potato_32_a cat_144)) (spoon_106 (get_potato_30_a (get_potato_32_a cat_144)))))))
(assert (= cat_171 cat_163))
(assert (= cat_172 1))
(assert (<= 1 cat_172))
(assert (<= cat_172 (spoon_106 (get_potato_30_a (get_potato_32_a cat_144)))))
(assert (and (and (and (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000)) (spoon_54 cat_173)) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000)) (spoon_54 cat_174))) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b01111111 #b00000000000000000000000)) (spoon_134 cat_177))) (and (<= 1 cat_178) (<= cat_178 (spoon_106 (get_potato_30_a (get_potato_32_a cat_144)))))))
(assert (= cat_179 cat_175))
(assert (= cat_180 cat_176))
(assert (= (mk_potato_13 cat_181 cat_182) (get_potato_15_a (select (get_potato_30_b (get_potato_32_a cat_144)) cat_178))))
(assert (and (spoon_134 cat_184) (spoon_54 cat_183)))
(assert (not (fp.lt cat_183 (spoon_69 (get_potato_21_b (get_potato_23_a cat_146))))))
(assert (not (spoon_54 (fp.sub RNE cat_183 (spoon_69 (get_potato_21_b (get_potato_23_a cat_146)))))))
(check-sat)
(exit)
