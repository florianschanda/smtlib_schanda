...
(assert (= cat_174 cat_165))
(assert (= cat_175 1))
(assert (<= 1 cat_175))
(assert (<= cat_175 (spoon_108 (get_potato_30_a (get_potato_32_a cat_146)))))
(assert (and (and (and (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000)) (spoon_56 cat_176)) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000)) (spoon_56 cat_177))) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b01111111 #b00000000000000000000000)) (spoon_136 cat_180))) (and (<= 1 cat_181) (<= cat_181 (spoon_108 (get_potato_30_a (get_potato_32_a cat_146)))))))
(assert (= cat_182 cat_178))
(assert (= cat_183 cat_179))
(assert (= (mk_potato_13 cat_184 cat_185) (get_potato_15_a (select (get_potato_30_b (get_potato_32_a cat_146)) cat_181))))
(assert (and (spoon_136 cat_187) (spoon_56 cat_186)))
(assert (not (fp.lt cat_186 (spoon_71 (get_potato_21_b (get_potato_23_a cat_148))))))
(assert (not (spoon_56 (fp.sub RNE cat_186 (spoon_71 (get_potato_21_b (get_potato_23_a cat_148)))))))
(check-sat)
(exit)
