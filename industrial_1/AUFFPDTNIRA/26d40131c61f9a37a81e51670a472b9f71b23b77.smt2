...
(declare-fun spoon_27 (Float32 Float32) Float32)
(declare-fun spoon_28 (Float32 Float32 Float32) Bool)
(declare-sort potato_11 0)
(define-fun spoon_29 ((kitten_24 Float32)) Bool (and (spoon_1 kitten_24) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_24) (fp.leq kitten_24 (fp #b0 #b10010011 #b00000001101101110000000)))))
...
(define-fun spoon_36 ((kitten_26 Float32) (kitten_27 Bool) (kitten_28 Bool) (kitten_29 Bool) (kitten_30 Bool)) Bool (=> (or (= kitten_27 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10010011 #b00000001101101110000000))) (spoon_29 kitten_26)))
(assert (forall ((kitten_31 Float32) (kitten_32 Float32)) (! (=> (and (spoon_36 kitten_31 true true true true) (spoon_36 kitten_32 true true true true)) (spoon_36 (spoon_27 kitten_31 kitten_32) true false true true)) :pattern ((spoon_27 kitten_31 kitten_32)))))
(declare-sort potato_13 0)
(declare-fun spoon_37 (potato_13) Int)
(assert (forall ((kitten_33 potato_13)) (and (<= 3 (spoon_37 kitten_33)) (<= (spoon_37 kitten_33) 30))))
...
(define-fun spoon_47 ((kitten_40 Float32)) Bool (and (spoon_1 kitten_40) (and (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) kitten_40) (fp.leq kitten_40 (fp #b0 #b10001011 #b00000000000000000000000)))))
...
(assert (forall ((kitten_44 Float32)) (! (=> (spoon_47 kitten_44) (= (spoon_54 (spoon_55 kitten_44)) kitten_44)) :pattern ((spoon_54 (spoon_55 kitten_44))))))
...
(define-fun spoon_60 ((kitten_49 potato_19) (kitten_50 potato_19)) Bool (ite (and (= (spoon_54 (get_potato_17_a (get_potato_19_a kitten_49))) (spoon_54 (get_potato_17_a (get_potato_19_a kitten_50)))) (= (spoon_54 (get_potato_17_b (get_potato_19_a kitten_49))) (spoon_54 (get_potato_17_b (get_potato_19_a kitten_50))))) true false))
...
(declare-datatypes () ((potato_22 (mk_potato_22 (get_potato_22_a potato_13) (get_potato_22_b (Array Int potato_19))))))
...
(define-fun spoon_88 ((kitten_81 potato_24) (kitten_82 potato_24)) Bool (ite (and (= (spoon_45 (get_potato_22_a (get_potato_24_a kitten_81))) (spoon_45 (get_potato_22_a (get_potato_24_a kitten_82)))) (= (spoon_75 (get_potato_22_b (get_potato_24_a kitten_81)) 1 30 (get_potato_22_b (get_potato_24_a kitten_82)) 1 30) true)) true false))
...
(declare-fun spoon_102 (potato_19 potato_19) Float32)
(declare-fun spoon_103 (Float32 potato_19 potato_19) Bool)
(declare-sort potato_26 0)
(define-fun spoon_104 ((kitten_86 Float32)) Bool (and (spoon_1 kitten_86) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_86) (fp.leq kitten_86 (fp #b0 #b10001100 #b01101010100000000000000)))))
...
(define-fun spoon_111 ((kitten_88 Float32) (kitten_89 Bool) (kitten_90 Bool) (kitten_91 Bool) (kitten_92 Bool)) Bool (=> (or (= kitten_89 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000))) (spoon_104 kitten_88)))
...
(assert (forall ((kitten_95 potato_28)) (and (<= (- 128) (spoon_112 kitten_95)) (<= (spoon_112 kitten_95) 127))))
...
(declare-const cat_118 potato_28)
...
(assert (forall ((kitten_98 potato_30)) (and (<= 1 (spoon_120 kitten_98)) (<= (spoon_120 kitten_98) 30))))
...
(declare-const cat_126 potato_30)
...
(declare-const cat_128 potato_24)
(declare-const cat_129 Int)
(declare-const cat_130 Int)
(declare-const cat_131 Int)
(define-fun spoon_132 ((kitten_101 Float32) (kitten_102 Bool) (kitten_103 Bool) (kitten_104 Bool) (kitten_105 Bool)) Bool (=> (or (= kitten_102 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_47 kitten_101)))
...
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10010011 #b00000001101101110000000)) (spoon_29 cat_135)))
(assert (= cat_136 (spoon_102 (select (get_potato_22_b (get_potato_24_a cat_128)) 1) (select (get_potato_22_b (get_potato_24_a cat_128)) (spoon_45 (get_potato_22_a (get_potato_24_a cat_128)))))))
(assert (spoon_104 cat_136))
(assert (<= 1 (- (spoon_45 (get_potato_22_a (get_potato_24_a cat_128))) 1)))
(assert (not (<= (- (spoon_45 (get_potato_22_a (get_potato_24_a cat_128))) 1) 30)))
(check-sat)
(exit)
