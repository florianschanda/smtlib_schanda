...
(assert (let ((_let_0 (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (fp.leq (spoon_44 cat_174) _let_0) (=> (fp.lt _let_0 (spoon_44 cat_180)) (and (= cat_160 (spoon_92 (mk_potato_17 spoon_193) (mk_potato_17 spoon_192) cat_113)) (spoon_94 cat_160))))))
...
(assert (let ((_let_0 (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (not (fp.leq (spoon_44 cat_174) _let_0)) (=> (fp.leq (spoon_44 cat_180) _let_0) (and (= cat_162 (spoon_92 (mk_potato_17 spoon_193) (mk_potato_17 spoon_192) cat_113)) (spoon_94 cat_162))))))
