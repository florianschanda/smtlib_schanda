...
(define-fun spoon_192 () potato_15 (mk_potato_15 cat_179 cat_180))
(define-fun spoon_193 () potato_15 (mk_potato_15 cat_173 cat_174))
...
(assert (= spoon_193 (get_potato_17_a (select (get_potato_20_b (get_potato_22_a cat_115)) cat_170))))
...
(assert (= spoon_192 (get_potato_17_a (select (get_potato_20_b (get_potato_22_a cat_115)) cat_176))))
(assert (=> (fp.leq (spoon_44 cat_174) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (fp.lt (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))) (spoon_44 cat_180)) (and (= cat_160 (spoon_92 (mk_potato_17 spoon_193) (mk_potato_17 spoon_192) cat_113)) (spoon_94 cat_160)))))
...
(assert (=> (not (fp.leq (spoon_44 cat_174) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (fp.leq (spoon_44 cat_180) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (and (= cat_162 (spoon_92 (mk_potato_17 spoon_193) (mk_potato_17 spoon_192) cat_113)) (spoon_94 cat_162)))))
...
(assert (and (and (=> (<= 1 cat_130) (spoon_142 1 cat_130 cat_191)) (=> (<= (- 100) 100) (spoon_118 cat_190))) (and (<= 1 cat_191) (<= cat_191 cat_130))))
(assert (not (spoon_118 cat_191)))
(check-sat)
(exit)
