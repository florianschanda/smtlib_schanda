...
(assert (= cat_153 0))
(assert (spoon_117 cat_153))
(assert (=> (<= 1 100) (spoon_58 cat_151)))
(assert (= cat_154 cat_151))
(assert (= cat_155 (spoon_73 (get_potato_22_a (get_potato_24_a cat_103)))))
(assert (= cat_156 (spoon_115 (select (get_potato_22_b (get_potato_24_a cat_103)) 1) (select (get_potato_22_b (get_potato_24_a cat_103)) cat_155))))
(assert (= cat_156 true))
(assert (not (spoon_58 (- cat_155 1))))
(check-sat)
(exit)
