...
(assert (= cat_155 0))
(assert (spoon_119 cat_155))
(assert (=> (<= 1 100) (spoon_60 cat_153)))
(assert (= cat_156 cat_153))
(assert (= cat_157 (spoon_75 (get_potato_22_a (get_potato_24_a cat_105)))))
(assert (= cat_158 (spoon_117 (select (get_potato_22_b (get_potato_24_a cat_105)) 1) (select (get_potato_22_b (get_potato_24_a cat_105)) cat_157))))
(assert (= cat_158 true))
(assert (not (spoon_60 (- cat_157 1))))
(check-sat)
(exit)
