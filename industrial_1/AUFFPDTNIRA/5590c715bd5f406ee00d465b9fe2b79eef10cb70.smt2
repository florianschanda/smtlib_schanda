...
(assert (let ((_let_0 (get_potato_20_b (get_potato_22_a cat_115)))) (= cat_168 (spoon_102 (select _let_0 1) (select _let_0 cat_167)))))
(assert (let ((_let_0 (- cat_167 1))) (=> (= cat_168 true) (and (= cat_159 _let_0) (spoon_105 _let_0)))))
...
(assert (let ((_let_0 (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (fp.leq (spoon_44 cat_174) _let_0) (=> (fp.lt _let_0 (spoon_44 cat_180)) (and (= cat_160 (spoon_92 (mk_potato_17 spoon_191) (mk_potato_17 spoon_190) cat_113)) (spoon_94 cat_160))))))
(assert (let ((_let_0 (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (fp.leq (spoon_44 cat_174) _let_0) (=> (fp.lt _let_0 (spoon_44 cat_180)) (= cat_181 (ite (= cat_160 0) true false))))))
(assert (let ((_let_0 (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (fp.leq (spoon_44 cat_174) _let_0) (=> (not (fp.lt _let_0 (spoon_44 cat_180))) (= cat_181 false)))))
(assert (let ((_let_0 (+ cat_165 1))) (=> (fp.leq (spoon_44 cat_174) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (= cat_181 true) (and (= cat_161 _let_0) (spoon_118 _let_0))))))
...
(assert (let ((_let_0 (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (not (fp.leq (spoon_44 cat_174) _let_0)) (=> (fp.leq (spoon_44 cat_180) _let_0) (and (= cat_162 (spoon_92 (mk_potato_17 spoon_191) (mk_potato_17 spoon_190) cat_113)) (spoon_94 cat_162))))))
(assert (let ((_let_0 (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (not (fp.leq (spoon_44 cat_174) _let_0)) (=> (fp.leq (spoon_44 cat_180) _let_0) (= cat_184 (ite (= cat_162 2) true false))))))
(assert (let ((_let_0 (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (not (fp.leq (spoon_44 cat_174) _let_0)) (=> (not (fp.leq (spoon_44 cat_180) _let_0)) (= cat_184 false)))))
(assert (let ((_let_0 (- cat_165 1))) (=> (not (fp.leq (spoon_44 cat_174) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (= cat_184 true) (and (= cat_163 _let_0) (spoon_118 _let_0))))))
