...
(assert (forall ((kitten_87 potato_26)) (and (<= 1 (spoon_104 kitten_87)) (<= (spoon_104 kitten_87) 100))))
...
(declare-const cat_115 potato_22)
(declare-const cat_116 Int)
(declare-sort potato_28 0)
(declare-fun spoon_117 (potato_28) Int)
(assert (forall ((kitten_95 potato_28)) (and (<= (- 100) (spoon_117 kitten_95)) (<= (spoon_117 kitten_95) 100))))
...
(assert (forall ((kitten_103 potato_30)) (and (<= (- 128) (spoon_132 kitten_103)) (<= (spoon_132 kitten_103) 127))))
...
(define-fun spoon_150 ((kitten_114 Float32) (kitten_115 Bool) (kitten_116 Bool) (kitten_117 Bool) (kitten_118 Bool)) Bool (=> (or (= kitten_115 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_37 kitten_114)))
...
(declare-const cat_157 potato_13)
...
(declare-const cat_175 potato_13)
(declare-const cat_176 potato_13)
(declare-const cat_177 potato_13)
(declare-const cat_178 potato_13)
(declare-const cat_179 Int)
(declare-const cat_180 Int)
(declare-const cat_181 potato_13)
(declare-const cat_182 potato_13)
(declare-const cat_183 potato_13)
(declare-const cat_184 potato_13)
...
(declare-const cat_208 potato_16)
(declare-const cat_209 potato_15)
...
(assert (= cat_172 (spoon_102 (select (get_potato_20_b (get_potato_22_a cat_115)) 1) (select (get_potato_20_b (get_potato_22_a cat_115)) cat_171))))
(assert (=> (= cat_172 true) (and (= cat_159 (- cat_171 1)) (spoon_105 (- cat_171 1)))))
...
(assert (=> (fp.leq (spoon_44 cat_178) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (fp.lt (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))) (spoon_44 cat_184)) (and (= cat_160 (spoon_92 (mk_potato_17 spoon_211) (mk_potato_17 spoon_210) cat_113)) (spoon_94 cat_160)))))
(assert (=> (fp.leq (spoon_44 cat_178) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (fp.lt (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))) (spoon_44 cat_184)) (= cat_185 (ite (= cat_160 0) true false)))))
(assert (=> (fp.leq (spoon_44 cat_178) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (not (fp.lt (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))) (spoon_44 cat_184))) (= cat_185 false))))
(assert (=> (fp.leq (spoon_44 cat_178) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (= cat_185 true) (and (= cat_161 (+ cat_169 1)) (spoon_118 (+ cat_169 1))))))
...
(assert (=> (not (fp.leq (spoon_44 cat_178) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (fp.leq (spoon_44 cat_184) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (and (= cat_162 (spoon_92 (mk_potato_17 spoon_211) (mk_potato_17 spoon_210) cat_113)) (spoon_94 cat_162)))))
(assert (=> (not (fp.leq (spoon_44 cat_178) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (fp.leq (spoon_44 cat_184) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (= cat_188 (ite (= cat_162 2) true false)))))
(assert (=> (not (fp.leq (spoon_44 cat_178) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (not (fp.leq (spoon_44 cat_184) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (= cat_188 false))))
(assert (=> (not (fp.leq (spoon_44 cat_178) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (= cat_188 true) (and (= cat_163 (- cat_169 1)) (spoon_118 (- cat_169 1))))))
...
(assert (=> (fp.leq (spoon_44 (get_potato_15_b cat_195)) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (fp.lt (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))) (spoon_44 (get_potato_15_b cat_201))) (and (= cat_164 (spoon_92 (mk_potato_17 cat_195) (mk_potato_17 cat_201) cat_113)) (spoon_94 cat_164)))))
(assert (=> (fp.leq (spoon_44 (get_potato_15_b cat_195)) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (fp.lt (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))) (spoon_44 (get_potato_15_b cat_201))) (= cat_202 (ite (= cat_164 0) true false)))))
(assert (=> (fp.leq (spoon_44 (get_potato_15_b cat_195)) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (not (fp.lt (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))) (spoon_44 (get_potato_15_b cat_201)))) (= cat_202 false))))
(assert (=> (fp.leq (spoon_44 (get_potato_15_b cat_195)) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (= cat_202 true) (and (= cat_165 (+ cat_194 1)) (spoon_118 (+ cat_194 1))))))
...
(assert (=> (not (fp.leq (spoon_44 (get_potato_15_b cat_195)) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (fp.leq (spoon_44 (get_potato_15_b cat_201)) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (and (= cat_166 (spoon_92 (mk_potato_17 cat_195) (mk_potato_17 cat_201) cat_113)) (spoon_94 cat_166)))))
(assert (=> (not (fp.leq (spoon_44 (get_potato_15_b cat_195)) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (fp.leq (spoon_44 (get_potato_15_b cat_201)) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (= cat_205 (ite (= cat_166 2) true false)))))
(assert (=> (not (fp.leq (spoon_44 (get_potato_15_b cat_195)) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (not (fp.leq (spoon_44 (get_potato_15_b cat_201)) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (= cat_205 false))))
(assert (=> (not (fp.leq (spoon_44 (get_potato_15_b cat_195)) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (= cat_205 true) (and (= cat_167 (- cat_194 1)) (spoon_118 (- cat_194 1))))))
