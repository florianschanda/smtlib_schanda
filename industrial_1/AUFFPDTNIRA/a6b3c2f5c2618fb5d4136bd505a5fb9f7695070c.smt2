...
(declare-const cat_167 potato_13)
(assert (= cat_157 cat_152))
(assert (= cat_158 0))
(assert (spoon_118 cat_158))
(assert (=> (<= 1 100) (spoon_105 cat_153)))
(assert (= cat_159 cat_153))
(assert (= cat_160 (spoon_35 (get_potato_20_a (get_potato_22_a cat_115)))))
(assert (= cat_161 (spoon_102 (select (get_potato_20_b (get_potato_22_a cat_115)) 1) (select (get_potato_20_b (get_potato_22_a cat_115)) cat_160))))
(assert (=> (= cat_161 true) (and (= cat_156 (- cat_160 1)) (spoon_105 (- cat_160 1)))))
...
(assert (= (mk_potato_15 cat_166 cat_167) (get_potato_17_a (select (get_potato_20_b (get_potato_22_a cat_115)) cat_163))))
(assert (= cat_163 cat_130))
