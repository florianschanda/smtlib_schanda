...
(declare-fun cat_161 () Bool)
(declare-fun cat_162 () Int)
(declare-fun cat_163 () Int)
(declare-fun cat_164 () potato_13)
(declare-fun cat_165 () potato_13)
(declare-fun cat_166 () potato_13)
(declare-fun cat_167 () potato_13)
...
(assert (let ((_let_0 (get_potato_20_b (get_potato_22_a cat_115)))) (= cat_161 (spoon_102 (select _let_0 1) (select _let_0 cat_160)))))
(assert (let ((_let_0 (- cat_160 1))) (=> (= cat_161 true) (and (= cat_156 _let_0) (spoon_105 _let_0)))))
