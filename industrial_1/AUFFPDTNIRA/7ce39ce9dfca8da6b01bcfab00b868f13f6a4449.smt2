...
(define-fun spoon_195 () potato_13 (mk_potato_13 cat_182 cat_183))
(define-fun spoon_196 () potato_13 (mk_potato_13 cat_176 cat_177))
(assert (= cat_167 cat_153))
(assert (= cat_168 0))
(assert (spoon_119 cat_168))
(assert (=> (<= 1 30) (spoon_56 cat_154)))
(assert (= cat_169 cat_154))
(assert (= cat_170 (spoon_71 (get_potato_22_a (get_potato_24_a cat_105)))))
(assert (= cat_171 (spoon_117 (select (get_potato_22_b (get_potato_24_a cat_105)) 1) (select (get_potato_22_b (get_potato_24_a cat_105)) cat_170))))
(assert (=> (= cat_171 true) (and (= cat_160 (- cat_170 1)) (spoon_56 (- cat_170 1)))))
...
(assert (= spoon_196 (get_potato_15_a (select (get_potato_22_b (get_potato_24_a cat_105)) cat_173))))
(assert (= cat_173 cat_132))
(assert (spoon_56 cat_132))
(assert (= cat_178 cat_159))
(assert (= cat_179 1))
(assert (<= 1 cat_179))
(assert (<= cat_179 cat_132))
(assert (= cat_180 cat_157))
(assert (= cat_181 cat_158))
(assert (= spoon_195 (get_potato_15_a (select (get_potato_22_b (get_potato_24_a cat_105)) cat_179))))
(assert (=> (fp.leq (spoon_38 cat_177) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103)))) (=> (fp.lt (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))) (spoon_38 cat_183)) (and (= cat_161 (spoon_115 (mk_potato_15 spoon_196) (mk_potato_15 spoon_195) cat_103)) (spoon_107 cat_161)))))
(assert (=> (fp.leq (spoon_38 cat_177) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103)))) (=> (fp.lt (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))) (spoon_38 cat_183)) (= cat_184 (ite (= cat_161 0) true false)))))
(assert (=> (fp.leq (spoon_38 cat_177) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103)))) (=> (not (fp.lt (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))) (spoon_38 cat_183))) (= cat_184 false))))
(assert (=> (fp.leq (spoon_38 cat_177) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103)))) (=> (= cat_184 true) (and (= cat_162 (+ cat_168 1)) (spoon_119 (+ cat_168 1))))))
(assert (=> (fp.leq (spoon_38 cat_177) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103)))) (=> (= cat_184 true) (= cat_185 cat_168))))
(assert (=> (fp.leq (spoon_38 cat_177) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103)))) (=> (= cat_184 true) (= cat_186 cat_162))))
(assert (=> (fp.leq (spoon_38 cat_177) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103)))) (=> (not (= cat_184 true)) (= cat_186 cat_168))))
(assert (=> (not (fp.leq (spoon_38 cat_177) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))))) (=> (fp.leq (spoon_38 cat_183) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103)))) (and (= cat_163 (spoon_115 (mk_potato_15 spoon_196) (mk_potato_15 spoon_195) cat_103)) (spoon_107 cat_163)))))
(assert (=> (not (fp.leq (spoon_38 cat_177) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))))) (=> (fp.leq (spoon_38 cat_183) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103)))) (= cat_187 (ite (= cat_163 2) true false)))))
(assert (=> (not (fp.leq (spoon_38 cat_177) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))))) (=> (not (fp.leq (spoon_38 cat_183) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))))) (= cat_187 false))))
(assert (=> (not (fp.leq (spoon_38 cat_177) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))))) (=> (= cat_187 true) (and (= cat_164 (- cat_168 1)) (spoon_119 (- cat_168 1))))))
(assert (=> (not (fp.leq (spoon_38 cat_177) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))))) (=> (= cat_187 true) (= cat_188 cat_168))))
(assert (=> (not (fp.leq (spoon_38 cat_177) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))))) (=> (= cat_187 true) (= cat_189 cat_164))))
(assert (=> (not (fp.leq (spoon_38 cat_177) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))))) (=> (not (= cat_187 true)) (= cat_189 cat_168))))
(assert (=> (not (fp.leq (spoon_38 cat_177) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))))) (= cat_186 cat_189)))
(assert (= cat_190 cat_176))
(assert (= cat_191 cat_177))
(assert (= cat_192 spoon_195))
(assert (and (<= (- cat_194) cat_193) (<= cat_193 cat_194)))
(assert (and (and (=> (<= 1 cat_132) (spoon_143 1 cat_132 cat_194)) (=> (<= (- 30) 30) (spoon_119 cat_193))) (and (<= 1 cat_194) (<= cat_194 cat_132))))
(assert (and (= cat_165 cat_194) (spoon_119 cat_194)))
(assert (= cat_166 (ite (<= cat_193 cat_165) true false)))
(assert (not (spoon_119 cat_194)))
(check-sat)
(exit)
