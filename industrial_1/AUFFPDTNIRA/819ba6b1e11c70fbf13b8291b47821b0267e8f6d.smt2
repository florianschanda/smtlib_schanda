...
(declare-const cat_146 potato_31)
(declare-const cat_147 potato_30)
(assert (spoon_8 cat_135))
(assert (= cat_146 (mk_potato_31 (mk_potato_30 (mk_potato_28 (mk_potato_26 cat_142 cat_143)) (mk_potato_14 (mk_potato_12 cat_144 cat_145))))))
(assert (= cat_147 (get_potato_32_a cat_137)))
(assert (< (- cat_135 1000) (spoon_16 (get_potato_12_b (get_potato_14_a (get_potato_30_b (get_potato_32_a cat_137)))))))
(assert (not (<= 149000 (spoon_16 (get_potato_12_b (get_potato_14_a (get_potato_30_b (get_potato_32_a cat_137))))))))
(assert (not (spoon_8 (+ (spoon_16 (get_potato_12_b (get_potato_14_a (get_potato_30_b (get_potato_32_a cat_137))))) 1000))))
(check-sat)
(exit)
