...
(declare-const cat_198 potato_16)
(declare-const cat_199 potato_15)
(declare-const cat_200 Bool)
(define-fun spoon_201 () potato_15 (mk_potato_15 cat_181 cat_182))
(define-fun spoon_202 () potato_15 (mk_potato_15 cat_175 cat_176))
...
(assert (=> (= cat_170 true) (and (= cat_160 (- cat_169 1)) (spoon_105 (- cat_169 1)))))
...
(assert (= spoon_202 (get_potato_17_a (select (get_potato_20_b (get_potato_22_a cat_115)) cat_172))))
...
(assert (= spoon_201 (get_potato_17_a (select (get_potato_20_b (get_potato_22_a cat_115)) cat_178))))
(assert (=> (fp.leq (spoon_44 cat_176) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (fp.lt (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))) (spoon_44 cat_182)) (and (= cat_161 (spoon_92 (mk_potato_17 spoon_202) (mk_potato_17 spoon_201) cat_113)) (spoon_94 cat_161)))))
(assert (=> (fp.leq (spoon_44 cat_176) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (fp.lt (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))) (spoon_44 cat_182)) (= cat_183 (ite (= cat_161 0) true false)))))
...
(assert (=> (fp.leq (spoon_44 cat_176) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (= cat_183 true) (and (= cat_162 (+ cat_167 1)) (spoon_118 (+ cat_167 1))))))
(assert (=> (fp.leq (spoon_44 cat_176) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (= cat_183 true) (= cat_184 cat_167))))
(assert (=> (fp.leq (spoon_44 cat_176) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (= cat_183 true) (= cat_185 cat_162))))
(assert (=> (fp.leq (spoon_44 cat_176) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (not (= cat_183 true)) (= cat_185 cat_167))))
(assert (=> (not (fp.leq (spoon_44 cat_176) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (fp.leq (spoon_44 cat_182) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (and (= cat_163 (spoon_92 (mk_potato_17 spoon_202) (mk_potato_17 spoon_201) cat_113)) (spoon_94 cat_163)))))
(assert (=> (not (fp.leq (spoon_44 cat_176) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (fp.leq (spoon_44 cat_182) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (= cat_186 (ite (= cat_163 2) true false)))))
...
(assert (=> (not (fp.leq (spoon_44 cat_176) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (= cat_186 true) (and (= cat_164 (- cat_167 1)) (spoon_118 (- cat_167 1))))))
(assert (=> (not (fp.leq (spoon_44 cat_176) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (= cat_186 true) (= cat_187 cat_167))))
(assert (=> (not (fp.leq (spoon_44 cat_176) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (= cat_186 true) (= cat_188 cat_164))))
...
(assert (and (and (=> (<= 1 cat_131) (spoon_143 1 cat_131 cat_195)) (=> (<= (- 30) 30) (spoon_118 cat_192))) (and (<= 1 cat_195) (<= cat_195 cat_131))))
(assert (not (= cat_195 cat_131)))
(assert (= cat_196 (mk_potato_6 cat_195)))
(assert (= cat_197 (+ cat_195 1)))
(assert (= cat_198 (mk_potato_16 cat_194)))
(assert (= cat_199 (get_potato_17_a (select (get_potato_20_b (get_potato_22_a cat_115)) cat_197))))
(assert (not (fp.leq (spoon_44 (get_potato_15_b cat_193)) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))))
(assert (=> (fp.leq (spoon_44 (get_potato_15_b cat_199)) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (and (= cat_165 (spoon_92 (mk_potato_17 cat_193) (mk_potato_17 cat_199) cat_113)) (spoon_94 cat_165))))
(assert (=> (fp.leq (spoon_44 (get_potato_15_b cat_199)) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (= cat_200 (ite (= cat_165 2) true false))))
(assert (=> (not (fp.leq (spoon_44 (get_potato_15_b cat_199)) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (= cat_200 false)))
(assert (= cat_200 true))
(assert (not (spoon_118 (- cat_192 1))))
(check-sat)
(exit)
