...
(declare-fun cat_196 () potato_6)
(declare-fun cat_197 () Int)
(declare-fun cat_198 () potato_16)
...
(assert (let ((_let_0 (- cat_169 1))) (=> (= cat_170 true) (and (= cat_160 _let_0) (spoon_105 _let_0)))))
...
(assert (let ((_let_0 (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (fp.leq (spoon_44 cat_176) _let_0) (=> (fp.lt _let_0 (spoon_44 cat_182)) (and (= cat_161 (spoon_92 (mk_potato_17 spoon_202) (mk_potato_17 spoon_201) cat_113)) (spoon_94 cat_161))))))
(assert (let ((_let_0 (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (fp.leq (spoon_44 cat_176) _let_0) (=> (fp.lt _let_0 (spoon_44 cat_182)) (= cat_183 (ite (= cat_161 0) true false))))))
...
(assert (let ((_let_0 (+ cat_167 1))) (=> (fp.leq (spoon_44 cat_176) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (= cat_183 true) (and (= cat_162 _let_0) (spoon_118 _let_0))))))
...
(assert (let ((_let_0 (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (not (fp.leq (spoon_44 cat_176) _let_0)) (=> (fp.leq (spoon_44 cat_182) _let_0) (and (= cat_163 (spoon_92 (mk_potato_17 spoon_202) (mk_potato_17 spoon_201) cat_113)) (spoon_94 cat_163))))))
(assert (let ((_let_0 (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (not (fp.leq (spoon_44 cat_176) _let_0)) (=> (fp.leq (spoon_44 cat_182) _let_0) (= cat_186 (ite (= cat_163 2) true false))))))
...
(assert (let ((_let_0 (- cat_167 1))) (=> (not (fp.leq (spoon_44 cat_176) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (= cat_186 true) (and (= cat_164 _let_0) (spoon_118 _let_0))))))
