...
(assert (not (fp.leq (spoon_44 cat_172) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))))
(assert (=> (fp.leq (spoon_44 cat_178) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (and (= cat_161 (spoon_92 (mk_potato_17 spoon_181) (mk_potato_17 spoon_180) cat_113)) (spoon_94 cat_161))))
(assert (=> (fp.leq (spoon_44 cat_178) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (= cat_179 (ite (= cat_161 2) true false))))
(assert (=> (not (fp.leq (spoon_44 cat_178) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (= cat_179 false)))
(assert (= cat_179 true))
