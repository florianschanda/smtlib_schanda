...
(assert (forall ((kitten_43 (Array Int potato_15))) (forall ((kitten_44 Int)) (! (= (spoon_64 kitten_43 kitten_44 kitten_44) kitten_43) :pattern ((spoon_64 kitten_43 kitten_44 kitten_44))))))
(assert (forall ((kitten_45 (Array Int potato_15))) (forall ((kitten_46 Int)) (forall ((kitten_47 Int)) (forall ((kitten_48 Int)) (! (= (select (spoon_64 kitten_45 kitten_46 kitten_47) kitten_48) (select kitten_45 (- kitten_48 (- kitten_47 kitten_46)))) :pattern ((select (spoon_64 kitten_45 kitten_46 kitten_47) kitten_48))))))))
(declare-fun spoon_65 ((Array Int potato_15) Int Int (Array Int potato_15) Int Int) (Array Int potato_15))
(assert (forall ((kitten_49 (Array Int potato_15)) (kitten_50 (Array Int potato_15))) (forall ((kitten_51 Int) (kitten_52 Int) (kitten_53 Int) (kitten_54 Int)) (forall ((kitten_55 Int)) (! (and (=> (and (<= kitten_51 kitten_55) (<= kitten_55 kitten_52)) (= (select (spoon_65 kitten_49 kitten_51 kitten_52 kitten_50 kitten_53 kitten_54) kitten_55) (select kitten_49 kitten_55))) (=> (< kitten_52 kitten_55) (= (select (spoon_65 kitten_49 kitten_51 kitten_52 kitten_50 kitten_53 kitten_54) kitten_55) (select kitten_50 (+ (- kitten_55 kitten_52) (- kitten_53 1)))))) :pattern ((select (spoon_65 kitten_49 kitten_51 kitten_52 kitten_50 kitten_53 kitten_54) kitten_55)))))))
(declare-fun spoon_66 (potato_15 Int) (Array Int potato_15))
(assert (forall ((kitten_56 potato_15)) (forall ((kitten_57 Int)) (! (= (select (spoon_66 kitten_56 kitten_57) kitten_57) kitten_56) :pattern ((select (spoon_66 kitten_56 kitten_57) kitten_57))))))
(define-fun spoon_67 ((kitten_58 (Array Int potato_15)) (kitten_59 Int) (kitten_60 Int) (kitten_61 (Array Int potato_15)) (kitten_62 Int) (kitten_63 Int)) Bool (ite (and (ite (<= kitten_59 kitten_60) (and (<= kitten_62 kitten_63) (= (- kitten_60 kitten_59) (- kitten_63 kitten_62))) (< kitten_63 kitten_62)) (forall ((kitten_64 Int)) (=> (and (<= kitten_59 kitten_64) (<= kitten_64 kitten_60)) (= (spoon_42 (select kitten_58 kitten_64) (select kitten_61 (+ (- kitten_62 kitten_59) kitten_64))) true)))) true false))
(assert (forall ((kitten_65 (Array Int potato_15)) (kitten_66 (Array Int potato_15))) (forall ((kitten_67 Int) (kitten_68 Int) (kitten_69 Int) (kitten_70 Int)) (=> (= (spoon_67 kitten_66 kitten_69 kitten_70 kitten_65 kitten_67 kitten_68) true) (and (ite (<= kitten_67 kitten_68) (and (<= kitten_69 kitten_70) (= (- kitten_68 kitten_67) (- kitten_70 kitten_69))) (< kitten_70 kitten_69)) (forall ((kitten_71 Int)) (=> (and (<= kitten_67 kitten_71) (<= kitten_71 kitten_68)) (= (spoon_42 (select kitten_65 kitten_71) (select kitten_66 (+ (- kitten_69 kitten_67) kitten_71))) true))))))))
(declare-sort potato_20 0)
(define-fun spoon_68 ((kitten_72 Int)) Bool (and (<= 1 kitten_72) (<= kitten_72 100)))
...
(define-fun spoon_75 ((kitten_74 Int)) Bool (and (<= 3 kitten_74) (<= kitten_74 100)))
...
(define-fun spoon_81 ((kitten_75 potato_23)) potato_22 (get_potato_23_a kitten_75))
(declare-fun spoon_82 (potato_22) Int)
(declare-fun spoon_83 (Int) potato_22)
(assert (forall ((kitten_76 potato_22)) (! (= (spoon_83 (spoon_82 kitten_76)) kitten_76) :pattern ((spoon_82 kitten_76)))))
(assert (forall ((kitten_77 potato_22)) (! (spoon_75 (spoon_82 kitten_77)) :pattern ((spoon_82 kitten_77)))))
(assert (forall ((kitten_78 Int)) (! (=> (spoon_75 kitten_78) (= (spoon_82 (spoon_83 kitten_78)) kitten_78)) :pattern ((spoon_82 (spoon_83 kitten_78))))))
...
(assert (<= 0 cat_85))
(assert (forall ((kitten_79 (Array Int potato_15))) (<= 0 (spoon_86 kitten_79))))
(assert (<= 0 cat_87))
(assert (forall ((kitten_80 (Array Int potato_15))) (<= 0 (spoon_88 kitten_80))))
(assert (<= 0 cat_89))
(assert (forall ((kitten_81 (Array Int potato_15))) (<= 0 (spoon_90 kitten_81))))
...
(define-fun spoon_92 ((kitten_82 potato_24)) potato_22 (get_potato_24_a kitten_82))
(define-fun spoon_93 ((kitten_83 potato_24)) (Array Int potato_15) (get_potato_24_b kitten_83))
(declare-datatypes () ((potato_25 (mk_potato_25 (get_potato_25_a potato_24)))))
(define-fun spoon_94 ((kitten_84 potato_25)) potato_24 (get_potato_25_a kitten_84))
(declare-datatypes () ((potato_26 (mk_potato_26 (get_potato_26_a potato_24)))))
(define-fun spoon_95 ((kitten_85 potato_26)) potato_24 (get_potato_26_a kitten_85))
(define-fun spoon_96 ((kitten_86 potato_26) (kitten_87 potato_26)) Bool (ite (and (= (spoon_82 (get_potato_24_a (get_potato_26_a kitten_86))) (spoon_82 (get_potato_24_a (get_potato_26_a kitten_87)))) (= (spoon_67 (get_potato_24_b (get_potato_26_a kitten_86)) 1 100 (get_potato_24_b (get_potato_26_a kitten_87)) 1 100) true)) true false))
(declare-const cat_97 Int)
(declare-fun spoon_98 (potato_26) Int)
(declare-const cat_99 Int)
(declare-fun spoon_100 (potato_26) Int)
(assert (<= 0 cat_97))
(assert (forall ((kitten_88 potato_26)) (<= 0 (spoon_98 kitten_88))))
(assert (<= 0 cat_99))
(assert (forall ((kitten_89 potato_26)) (<= 0 (spoon_100 kitten_89))))
...
(define-fun spoon_109 ((kitten_90 potato_27)) potato_26 (get_potato_27_a kitten_90))
...
(assert (forall ((kitten_91 potato_15) (kitten_92 potato_15) (kitten_93 potato_15) (kitten_94 potato_15)) (! (spoon_63 (spoon_110 kitten_91 kitten_92 kitten_93 kitten_94) true false true) :pattern ((spoon_110 kitten_91 kitten_92 kitten_93 kitten_94)))))
...
(define-fun spoon_124 ((kitten_95 Float32) (kitten_96 Bool) (kitten_97 Bool) (kitten_98 Bool)) Bool (=> (or (= kitten_96 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_31 kitten_95)))
(define-fun spoon_125 ((kitten_99 Int) (kitten_100 Bool) (kitten_101 Bool) (kitten_102 Bool)) Bool (=> (or (= kitten_100 true) (<= 1 100)) (spoon_68 kitten_99)))
(define-fun spoon_126 ((kitten_103 Int) (kitten_104 Bool) (kitten_105 Bool) (kitten_106 Bool)) Bool (=> (or (= kitten_104 true) (<= 3 100)) (spoon_75 kitten_103)))
...
(assert (= cat_134 (spoon_112 cat_114 cat_116)))
...
(assert (= (mk_potato_13 cat_139 cat_140) (get_potato_15_a (select (get_potato_24_b (get_potato_26_a cat_114)) (spoon_82 (get_potato_24_a (get_potato_26_a cat_114)))))))
(assert (= cat_141 cat_131))
(assert (= cat_142 cat_132))
(assert (= (mk_potato_13 cat_143 cat_144) (get_potato_15_a (select (get_potato_24_b (get_potato_26_a cat_116)) (spoon_82 (get_potato_24_a (get_potato_26_a cat_116)))))))
(assert (= cat_145 cat_133))
(assert (= cat_146 1))
(assert (<= 1 cat_146))
(assert (<= cat_146 (spoon_82 (get_potato_24_a (get_potato_26_a cat_114)))))
(assert (and (and (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000)) (spoon_56 cat_147)) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000)) (spoon_56 cat_148))) (and (<= 1 cat_149) (<= cat_149 (spoon_82 (get_potato_24_a (get_potato_26_a cat_114)))))))
(assert (<= 1 (spoon_82 (get_potato_24_a (get_potato_26_a cat_116)))))
(assert (not (<= (spoon_82 (get_potato_24_a (get_potato_26_a cat_116))) 100)))
(check-sat)
(exit)
