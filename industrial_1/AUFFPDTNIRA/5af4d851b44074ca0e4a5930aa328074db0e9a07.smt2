...
(declare-const cat_169 potato_13)
(declare-const cat_170 potato_13)
...
(assert (= cat_166 (spoon_102 (select (get_potato_20_b (get_potato_22_a cat_115)) 1) (select (get_potato_20_b (get_potato_22_a cat_115)) cat_165))))
(assert (=> (= cat_166 true) (and (= cat_160 (- cat_165 1)) (spoon_105 (- cat_165 1)))))
