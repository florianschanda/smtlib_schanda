...
(assert (fp.leq (spoon_44 (get_potato_15_b cat_193)) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))))
(assert (=> (fp.lt (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))) (spoon_44 (get_potato_15_b cat_199))) (and (= cat_165 (spoon_92 (mk_potato_17 cat_193) (mk_potato_17 cat_199) cat_113)) (spoon_94 cat_165))))
(assert (=> (fp.lt (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))) (spoon_44 (get_potato_15_b cat_199))) (= cat_200 (ite (= cat_165 0) true false))))
(assert (=> (not (fp.lt (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))) (spoon_44 (get_potato_15_b cat_199)))) (= cat_200 false)))
(assert (= cat_200 true))
