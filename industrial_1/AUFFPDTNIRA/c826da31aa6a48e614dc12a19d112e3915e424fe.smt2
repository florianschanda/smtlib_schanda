...
(assert (fp.leq (spoon_38 (get_potato_13_b cat_192)) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103)))))
(assert (=> (fp.lt (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))) (spoon_38 (get_potato_13_b cat_198))) (and (= cat_164 (spoon_115 (mk_potato_15 cat_192) (mk_potato_15 cat_198) cat_103)) (spoon_107 cat_164))))
(assert (=> (fp.lt (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))) (spoon_38 (get_potato_13_b cat_198))) (= cat_199 (ite (= cat_164 0) true false))))
(assert (=> (not (fp.lt (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))) (spoon_38 (get_potato_13_b cat_198)))) (= cat_199 false)))
(assert (= cat_199 true))
