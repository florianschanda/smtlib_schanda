...
(assert (forall ((kitten_8 potato_10)) (and (<= 1 (spoon_13 kitten_8)) (<= (spoon_13 kitten_8) 32))))
...
(assert (forall ((kitten_15 potato_12)) (and (<= 3 (spoon_23 kitten_15)) (<= (spoon_23 kitten_15) 30))))
...
(declare-const cat_29 potato_12)
...
(define-fun spoon_34 ((kitten_22 Float32)) Bool (and (fp.isInfinite kitten_22) (fp.isPositive kitten_22)))
(define-fun spoon_35 ((kitten_23 Float32)) Bool (and (fp.isInfinite kitten_23) (fp.isNegative kitten_23)))
(define-fun spoon_36 ((kitten_24 Float32)) Bool (and (fp.isZero kitten_24) (fp.isPositive kitten_24)))
(define-fun spoon_37 ((kitten_25 Float32)) Bool (and (fp.isZero kitten_25) (fp.isNegative kitten_25)))
...
(define-fun spoon_41 ((kitten_28 Float32) (kitten_29 Float32)) Bool (or (and (fp.isPositive kitten_28) (fp.isPositive kitten_29)) (and (fp.isNegative kitten_28) (fp.isNegative kitten_29))))
(define-fun spoon_42 ((kitten_30 Float32) (kitten_31 Float32)) Bool (or (and (fp.isPositive kitten_30) (fp.isNegative kitten_31)) (and (fp.isNegative kitten_30) (fp.isPositive kitten_31))))
(define-fun spoon_43 ((kitten_32 Float32) (kitten_33 Float32) (kitten_34 Float32)) Bool (and (=> (spoon_41 kitten_33 kitten_34) (fp.isPositive kitten_32)) (=> (spoon_42 kitten_33 kitten_34) (fp.isNegative kitten_32))))
(define-fun spoon_44 ((kitten_35 Real)) Real (* kitten_35 kitten_35))
(declare-fun spoon_45 (Real) Real)
(define-fun spoon_46 ((kitten_36 Float32) (kitten_37 Real)) Bool (or (and (fp.isPositive kitten_36) (< 0.0 kitten_37)) (and (fp.isNegative kitten_36) (< kitten_37 0.0))))
(declare-datatypes () ((potato_14 (mk_potato_14 (get_potato_14_a Float32)))))
(declare-sort potato_15 0)
(define-fun spoon_47 ((kitten_38 Float32)) Bool (and (spoon_1 kitten_38) (and (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) kitten_38) (fp.leq kitten_38 (fp #b0 #b10001011 #b00000000000000000000000)))))
...
(declare-fun spoon_54 (potato_15) Float32)
(declare-fun spoon_55 (Float32) potato_15)
...
(assert (forall ((kitten_42 Float32)) (! (=> (spoon_47 kitten_42) (= (spoon_54 (spoon_55 kitten_42)) kitten_42)) :pattern ((spoon_54 (spoon_55 kitten_42))))))
...
(define-fun spoon_60 ((kitten_47 potato_19) (kitten_48 potato_19)) Bool (ite (and (= (spoon_54 (get_potato_17_a (get_potato_19_a kitten_47))) (spoon_54 (get_potato_17_a (get_potato_19_a kitten_48)))) (= (spoon_54 (get_potato_17_b (get_potato_19_a kitten_47))) (spoon_54 (get_potato_17_b (get_potato_19_a kitten_48))))) true false))
...
(declare-const cat_72 potato_19)
...
(declare-datatypes () ((potato_21 (mk_potato_21 (get_potato_21_a (Array Int potato_19))))))
...
(declare-const cat_76 (Array Int potato_19))
...
(declare-datatypes () ((potato_22 (mk_potato_22 (get_potato_22_a potato_12) (get_potato_22_b (Array Int potato_19))))))
...
(define-fun spoon_88 ((kitten_79 potato_24) (kitten_80 potato_24)) Bool (ite (and (= (spoon_31 (get_potato_22_a (get_potato_24_a kitten_79))) (spoon_31 (get_potato_22_a (get_potato_24_a kitten_80)))) (= (spoon_75 (get_potato_22_b (get_potato_24_a kitten_79)) 1 30 (get_potato_22_b (get_potato_24_a kitten_80)) 1 30) true)) true false))
...
(assert (forall ((kitten_84 potato_26)) (and (<= 0 (spoon_102 kitten_84)) (<= (spoon_102 kitten_84) 150000))))
...
(declare-datatypes () ((potato_28 (mk_potato_28 (get_potato_28_a potato_26) (get_potato_28_b potato_26)))))
...
(define-fun spoon_116 ((kitten_95 potato_30) (kitten_96 potato_30)) Bool (ite (and (= (spoon_110 (get_potato_28_a (get_potato_30_a kitten_95))) (spoon_110 (get_potato_28_a (get_potato_30_a kitten_96)))) (= (spoon_110 (get_potato_28_b (get_potato_30_a kitten_95))) (spoon_110 (get_potato_28_b (get_potato_30_a kitten_96))))) true false))
...
(declare-const cat_128 potato_30)
...
(declare-datatypes () ((potato_32 (mk_potato_32 (get_potato_32_a potato_24) (get_potato_32_b potato_30)))))
...
(declare-datatypes () ((potato_34 (mk_potato_34 (get_potato_34_a potato_32)))))
(define-fun spoon_133 ((kitten_103 potato_34)) potato_32 (get_potato_34_a kitten_103))
(define-fun spoon_134 ((kitten_104 potato_34) (kitten_105 potato_34)) Bool (ite (and (= (spoon_88 (get_potato_32_a (get_potato_34_a kitten_104)) (get_potato_32_a (get_potato_34_a kitten_105))) true) (= (spoon_116 (get_potato_32_b (get_potato_34_a kitten_104)) (get_potato_32_b (get_potato_34_a kitten_105))) true)) true false))
...
(declare-datatypes () ((potato_36 (mk_potato_36 (get_potato_36_a (Array Int potato_34))))))
...
(declare-const cat_150 (Array Int potato_34))
...
(declare-datatypes () ((potato_37 (mk_potato_37 (get_potato_37_a potato_10) (get_potato_37_b (Array Int potato_34))))))
...
(define-fun spoon_162 ((kitten_136 potato_39) (kitten_137 potato_39)) Bool (ite (and (= (spoon_21 (get_potato_37_a (get_potato_39_a kitten_136))) (spoon_21 (get_potato_37_a (get_potato_39_a kitten_137)))) (= (spoon_149 (get_potato_37_b (get_potato_39_a kitten_136)) 1 32 (get_potato_37_b (get_potato_39_a kitten_137)) 1 32) true)) true false))
...
(declare-const cat_174 potato_39)
...
(declare-const cat_182 potato_39)
...
(define-fun spoon_188 ((kitten_151 Float32) (kitten_152 Bool) (kitten_153 Bool) (kitten_154 Bool) (kitten_155 Bool)) Bool (=> (or (= kitten_152 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_47 kitten_151)))
...
(declare-const cat_191 (Array Int potato_34))
