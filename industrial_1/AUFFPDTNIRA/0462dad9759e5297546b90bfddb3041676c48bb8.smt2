...
(assert (forall ((kitten_7 potato_10)) (and (<= 3 (spoon_9 kitten_7)) (<= (spoon_9 kitten_7) 30))))
...
(define-fun spoon_20 ((kitten_14 Float32)) Bool (and (fp.isInfinite kitten_14) (fp.isPositive kitten_14)))
(define-fun spoon_21 ((kitten_15 Float32)) Bool (and (fp.isInfinite kitten_15) (fp.isNegative kitten_15)))
(define-fun spoon_22 ((kitten_16 Float32)) Bool (and (fp.isZero kitten_16) (fp.isPositive kitten_16)))
(define-fun spoon_23 ((kitten_17 Float32)) Bool (and (fp.isZero kitten_17) (fp.isNegative kitten_17)))
...
(define-fun spoon_27 ((kitten_20 Float32) (kitten_21 Float32)) Bool (or (and (fp.isPositive kitten_20) (fp.isPositive kitten_21)) (and (fp.isNegative kitten_20) (fp.isNegative kitten_21))))
(define-fun spoon_28 ((kitten_22 Float32) (kitten_23 Float32)) Bool (or (and (fp.isPositive kitten_22) (fp.isNegative kitten_23)) (and (fp.isNegative kitten_22) (fp.isPositive kitten_23))))
(define-fun spoon_29 ((kitten_24 Float32) (kitten_25 Float32) (kitten_26 Float32)) Bool (and (=> (spoon_27 kitten_25 kitten_26) (fp.isPositive kitten_24)) (=> (spoon_28 kitten_25 kitten_26) (fp.isNegative kitten_24))))
(define-fun spoon_30 ((kitten_27 Real)) Real (* kitten_27 kitten_27))
(declare-fun spoon_31 (Real) Real)
(define-fun spoon_32 ((kitten_28 Float32) (kitten_29 Real)) Bool (or (and (fp.isPositive kitten_28) (< 0.0 kitten_29)) (and (fp.isNegative kitten_28) (< kitten_29 0.0))))
(declare-datatypes () ((potato_12 (mk_potato_12 (get_potato_12_a Float32)))))
(declare-sort potato_13 0)
(define-fun spoon_33 ((kitten_30 Float32)) Bool (and (spoon_1 kitten_30) (and (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) kitten_30) (fp.leq kitten_30 (fp #b0 #b10001011 #b00000000000000000000000)))))
...
(assert (forall ((kitten_34 Float32)) (! (=> (spoon_33 kitten_34) (= (spoon_40 (spoon_41 kitten_34)) kitten_34)) :pattern ((spoon_40 (spoon_41 kitten_34))))))
...
(define-fun spoon_46 ((kitten_39 potato_17) (kitten_40 potato_17)) Bool (ite (and (= (spoon_40 (get_potato_15_a (get_potato_17_a kitten_39))) (spoon_40 (get_potato_15_a (get_potato_17_a kitten_40)))) (= (spoon_40 (get_potato_15_b (get_potato_17_a kitten_39))) (spoon_40 (get_potato_15_b (get_potato_17_a kitten_40))))) true false))
...
(declare-const cat_62 (Array Int potato_17))
...
(define-fun spoon_74 ((kitten_71 potato_22) (kitten_72 potato_22)) Bool (ite (and (= (spoon_17 (get_potato_20_a (get_potato_22_a kitten_71))) (spoon_17 (get_potato_20_a (get_potato_22_a kitten_72)))) (= (spoon_61 (get_potato_20_b (get_potato_22_a kitten_71)) 1 30 (get_potato_20_b (get_potato_22_a kitten_72)) 1 30) true)) true false))
...
(declare-const cat_86 potato_22)
...
(assert (forall ((kitten_76 potato_24)) (and (<= 0 (spoon_88 kitten_76)) (<= (spoon_88 kitten_76) 150000))))
...
(declare-const cat_94 potato_24)
...
(declare-datatypes () ((potato_26 (mk_potato_26 (get_potato_26_a potato_24) (get_potato_26_b potato_24)))))
...
(define-fun spoon_102 ((kitten_87 potato_28) (kitten_88 potato_28)) Bool (ite (and (= (spoon_96 (get_potato_26_a (get_potato_28_a kitten_87))) (spoon_96 (get_potato_26_a (get_potato_28_a kitten_88)))) (= (spoon_96 (get_potato_26_b (get_potato_28_a kitten_87))) (spoon_96 (get_potato_26_b (get_potato_28_a kitten_88))))) true false))
...
(declare-const cat_114 potato_28)
...
(declare-datatypes () ((potato_30 (mk_potato_30 (get_potato_30_a potato_22) (get_potato_30_b potato_28)))))
...
(define-fun spoon_120 ((kitten_96 potato_32) (kitten_97 potato_32)) Bool (ite (and (= (spoon_74 (get_potato_30_a (get_potato_32_a kitten_96)) (get_potato_30_a (get_potato_32_a kitten_97))) true) (= (spoon_102 (get_potato_30_b (get_potato_32_a kitten_96)) (get_potato_30_b (get_potato_32_a kitten_97))) true)) true false))
...
(define-fun spoon_140 ((kitten_106 Float32) (kitten_107 Bool) (kitten_108 Bool) (kitten_109 Bool) (kitten_110 Bool)) Bool (=> (or (= kitten_107 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_33 kitten_106)))
