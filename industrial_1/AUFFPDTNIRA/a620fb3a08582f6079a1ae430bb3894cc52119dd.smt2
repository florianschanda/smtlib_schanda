...
(assert (not (fp.leq (spoon_38 (get_potato_13_b cat_199)) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))))))
(assert (=> (fp.leq (spoon_38 (get_potato_13_b cat_205)) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103)))) (and (= cat_170 (spoon_115 (mk_potato_15 cat_199) (mk_potato_15 cat_205) cat_103)) (spoon_107 cat_170))))
(assert (=> (fp.leq (spoon_38 (get_potato_13_b cat_205)) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103)))) (= cat_209 (ite (= cat_170 2) true false))))
(assert (=> (not (fp.leq (spoon_38 (get_potato_13_b cat_205)) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))))) (= cat_209 false)))
(assert (= cat_209 true))
(assert (not (spoon_119 (- cat_198 1))))
(check-sat)
(exit)
