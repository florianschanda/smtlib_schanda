...
(define-fun spoon_201 () potato_13 (mk_potato_13 cat_181 cat_182))
(define-fun spoon_202 () potato_13 (mk_potato_13 cat_175 cat_176))
(assert (= cat_166 cat_153))
(assert (= cat_167 0))
(assert (spoon_119 cat_167))
(assert (=> (<= 1 30) (spoon_56 cat_154)))
(assert (= cat_168 cat_154))
(assert (= cat_169 (spoon_71 (get_potato_22_a (get_potato_24_a cat_105)))))
(assert (= cat_170 (spoon_117 (select (get_potato_22_b (get_potato_24_a cat_105)) 1) (select (get_potato_22_b (get_potato_24_a cat_105)) cat_169))))
(assert (=> (= cat_170 true) (and (= cat_160 (- cat_169 1)) (spoon_56 (- cat_169 1)))))
(assert (=> (= cat_170 true) (= cat_171 cat_169)))
(assert (=> (= cat_170 true) (= cat_172 cat_160)))
(assert (=> (not (= cat_170 true)) (= cat_172 cat_169)))
(assert (= cat_173 cat_155))
(assert (= cat_174 cat_156))
(assert (= spoon_202 (get_potato_15_a (select (get_potato_22_b (get_potato_24_a cat_105)) cat_172))))
(assert (= cat_172 cat_132))
(assert (spoon_56 cat_132))
(assert (= cat_177 cat_159))
(assert (= cat_178 1))
(assert (<= 1 cat_178))
(assert (<= cat_178 cat_132))
(assert (= cat_179 cat_157))
(assert (= cat_180 cat_158))
(assert (= spoon_201 (get_potato_15_a (select (get_potato_22_b (get_potato_24_a cat_105)) cat_178))))
(assert (=> (fp.leq (spoon_38 cat_176) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103)))) (=> (fp.lt (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))) (spoon_38 cat_182)) (and (= cat_161 (spoon_115 (mk_potato_15 spoon_202) (mk_potato_15 spoon_201) cat_103)) (spoon_107 cat_161)))))
(assert (=> (fp.leq (spoon_38 cat_176) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103)))) (=> (fp.lt (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))) (spoon_38 cat_182)) (= cat_183 (ite (= cat_161 0) true false)))))
(assert (=> (fp.leq (spoon_38 cat_176) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103)))) (=> (not (fp.lt (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))) (spoon_38 cat_182))) (= cat_183 false))))
(assert (=> (fp.leq (spoon_38 cat_176) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103)))) (=> (= cat_183 true) (and (= cat_162 (+ cat_167 1)) (spoon_119 (+ cat_167 1))))))
(assert (=> (fp.leq (spoon_38 cat_176) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103)))) (=> (= cat_183 true) (= cat_184 cat_167))))
(assert (=> (fp.leq (spoon_38 cat_176) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103)))) (=> (= cat_183 true) (= cat_185 cat_162))))
(assert (=> (fp.leq (spoon_38 cat_176) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103)))) (=> (not (= cat_183 true)) (= cat_185 cat_167))))
(assert (=> (not (fp.leq (spoon_38 cat_176) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))))) (=> (fp.leq (spoon_38 cat_182) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103)))) (and (= cat_163 (spoon_115 (mk_potato_15 spoon_202) (mk_potato_15 spoon_201) cat_103)) (spoon_107 cat_163)))))
(assert (=> (not (fp.leq (spoon_38 cat_176) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))))) (=> (fp.leq (spoon_38 cat_182) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103)))) (= cat_186 (ite (= cat_163 2) true false)))))
(assert (=> (not (fp.leq (spoon_38 cat_176) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))))) (=> (not (fp.leq (spoon_38 cat_182) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))))) (= cat_186 false))))
(assert (=> (not (fp.leq (spoon_38 cat_176) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))))) (=> (= cat_186 true) (and (= cat_164 (- cat_167 1)) (spoon_119 (- cat_167 1))))))
(assert (=> (not (fp.leq (spoon_38 cat_176) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))))) (=> (= cat_186 true) (= cat_187 cat_167))))
(assert (=> (not (fp.leq (spoon_38 cat_176) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))))) (=> (= cat_186 true) (= cat_188 cat_164))))
(assert (=> (not (fp.leq (spoon_38 cat_176) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))))) (=> (not (= cat_186 true)) (= cat_188 cat_167))))
(assert (=> (not (fp.leq (spoon_38 cat_176) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))))) (= cat_185 cat_188)))
(assert (= cat_189 cat_175))
(assert (= cat_190 cat_176))
(assert (= cat_191 spoon_201))
(assert (and (<= (- cat_195) cat_192) (<= cat_192 cat_195)))
(assert (and (and (=> (<= 1 cat_132) (spoon_143 1 cat_132 cat_195)) (=> (<= (- 30) 30) (spoon_119 cat_192))) (and (<= 1 cat_195) (<= cat_195 cat_132))))
(assert (not (= cat_195 cat_132)))
(assert (= cat_196 (mk_potato_6 cat_195)))
(assert (= cat_197 (+ cat_195 1)))
(assert (= cat_198 (mk_potato_14 cat_194)))
(assert (= cat_199 (get_potato_15_a (select (get_potato_22_b (get_potato_24_a cat_105)) cat_197))))
(assert (not (fp.leq (spoon_38 (get_potato_13_b cat_193)) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))))))
(assert (=> (fp.leq (spoon_38 (get_potato_13_b cat_199)) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103)))) (and (= cat_165 (spoon_115 (mk_potato_15 cat_193) (mk_potato_15 cat_199) cat_103)) (spoon_107 cat_165))))
(assert (=> (fp.leq (spoon_38 (get_potato_13_b cat_199)) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103)))) (= cat_200 (ite (= cat_165 2) true false))))
(assert (=> (not (fp.leq (spoon_38 (get_potato_13_b cat_199)) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))))) (= cat_200 false)))
(assert (= cat_200 true))
(assert (not (spoon_119 (- cat_192 1))))
(check-sat)
(exit)
