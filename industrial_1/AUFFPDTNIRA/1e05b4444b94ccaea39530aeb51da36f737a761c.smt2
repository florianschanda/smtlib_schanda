...
(declare-const cat_197 potato_16)
(declare-const cat_198 potato_15)
(declare-const cat_199 Bool)
(define-fun spoon_200 () potato_15 (mk_potato_15 cat_180 cat_181))
(define-fun spoon_201 () potato_15 (mk_potato_15 cat_174 cat_175))
...
(assert (=> (= cat_169 true) (and (= cat_159 (- cat_168 1)) (spoon_105 (- cat_168 1)))))
(assert (=> (= cat_169 true) (= cat_170 cat_168)))
(assert (=> (= cat_169 true) (= cat_171 cat_159)))
(assert (=> (not (= cat_169 true)) (= cat_171 cat_168)))
(assert (= cat_172 cat_154))
(assert (= cat_173 cat_155))
(assert (= spoon_201 (get_potato_17_a (select (get_potato_20_b (get_potato_22_a cat_115)) cat_171))))
(assert (= cat_171 cat_130))
(assert (spoon_105 cat_130))
(assert (= cat_176 cat_158))
(assert (= cat_177 1))
(assert (<= 1 cat_177))
(assert (<= cat_177 cat_130))
(assert (= cat_178 cat_156))
(assert (= cat_179 cat_157))
(assert (= spoon_200 (get_potato_17_a (select (get_potato_20_b (get_potato_22_a cat_115)) cat_177))))
(assert (=> (fp.leq (spoon_44 cat_175) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (fp.lt (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))) (spoon_44 cat_181)) (and (= cat_160 (spoon_92 (mk_potato_17 spoon_201) (mk_potato_17 spoon_200) cat_113)) (spoon_94 cat_160)))))
(assert (=> (fp.leq (spoon_44 cat_175) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (fp.lt (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))) (spoon_44 cat_181)) (= cat_182 (ite (= cat_160 0) true false)))))
...
(assert (=> (fp.leq (spoon_44 cat_175) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (= cat_182 true) (and (= cat_161 (+ cat_166 1)) (spoon_118 (+ cat_166 1))))))
(assert (=> (fp.leq (spoon_44 cat_175) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (= cat_182 true) (= cat_183 cat_166))))
(assert (=> (fp.leq (spoon_44 cat_175) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (= cat_182 true) (= cat_184 cat_161))))
(assert (=> (fp.leq (spoon_44 cat_175) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (not (= cat_182 true)) (= cat_184 cat_166))))
(assert (=> (not (fp.leq (spoon_44 cat_175) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (fp.leq (spoon_44 cat_181) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (and (= cat_162 (spoon_92 (mk_potato_17 spoon_201) (mk_potato_17 spoon_200) cat_113)) (spoon_94 cat_162)))))
(assert (=> (not (fp.leq (spoon_44 cat_175) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (fp.leq (spoon_44 cat_181) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (= cat_185 (ite (= cat_162 2) true false)))))
...
(assert (=> (not (fp.leq (spoon_44 cat_175) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (= cat_185 true) (and (= cat_163 (- cat_166 1)) (spoon_118 (- cat_166 1))))))
(assert (=> (not (fp.leq (spoon_44 cat_175) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (= cat_185 true) (= cat_186 cat_166))))
(assert (=> (not (fp.leq (spoon_44 cat_175) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (= cat_185 true) (= cat_187 cat_163))))
...
(assert (= cat_190 spoon_200))
(assert (and (<= (- cat_194) cat_191) (<= cat_191 cat_194)))
(assert (and (and (=> (<= 1 cat_130) (spoon_142 1 cat_130 cat_194)) (=> (<= (- 100) 100) (spoon_118 cat_191))) (and (<= 1 cat_194) (<= cat_194 cat_130))))
(assert (not (= cat_194 cat_130)))
(assert (= cat_195 (mk_potato_6 cat_194)))
(assert (= cat_196 (+ cat_194 1)))
(assert (= cat_197 (mk_potato_16 cat_193)))
(assert (= cat_198 (get_potato_17_a (select (get_potato_20_b (get_potato_22_a cat_115)) cat_196))))
(assert (fp.leq (spoon_44 (get_potato_15_b cat_192)) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))))
(assert (=> (fp.lt (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))) (spoon_44 (get_potato_15_b cat_198))) (and (= cat_164 (spoon_92 (mk_potato_17 cat_192) (mk_potato_17 cat_198) cat_113)) (spoon_94 cat_164))))
(assert (=> (fp.lt (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))) (spoon_44 (get_potato_15_b cat_198))) (= cat_199 (ite (= cat_164 0) true false))))
(assert (=> (not (fp.lt (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))) (spoon_44 (get_potato_15_b cat_198)))) (= cat_199 false)))
(assert (= cat_199 true))
(assert (not (spoon_118 (+ cat_191 1))))
(check-sat)
(exit)
