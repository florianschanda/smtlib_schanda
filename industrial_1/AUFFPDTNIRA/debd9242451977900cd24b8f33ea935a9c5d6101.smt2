...
(assert true)
(declare-fun spoon_94 (potato_17 potato_17 potato_22 Float32) Bool)
(declare-fun spoon_95 (Bool potato_17 potato_17 potato_22 Float32) Bool)
(declare-sort potato_24 0)
(define-fun spoon_96 ((kitten_77 Float32)) Bool (and (spoon_1 kitten_77) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_77) (fp.leq kitten_77 (fp #b0 #b10010011 #b00000001101101110000000)))))
...
(define-fun spoon_103 ((kitten_79 Float32) (kitten_80 Bool) (kitten_81 Bool) (kitten_82 Bool) (kitten_83 Bool)) Bool (=> (or (= kitten_80 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10010011 #b00000001101101110000000))) (spoon_96 kitten_79)))
(assert true)
(declare-sort potato_26 0)
(declare-fun spoon_104 (potato_26) Int)
(assert (forall ((kitten_84 potato_26)) (and (<= 1 (spoon_104 kitten_84)) (<= (spoon_104 kitten_84) 30))))
...
(define-fun spoon_123 ((kitten_87 Float32) (kitten_88 Bool) (kitten_89 Bool) (kitten_90 Bool) (kitten_91 Bool)) Bool (=> (or (= kitten_88 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_37 kitten_87)))
...
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10010011 #b00000001101101110000000)) (spoon_96 cat_126)))
(assert (= cat_130 1))
(assert (=> (and (<= 1 cat_130) (<= cat_130 (spoon_35 (get_potato_20_a (get_potato_22_a cat_112))))) (= cat_127 cat_129)))
(assert (=> (and (<= 1 cat_130) (<= cat_130 (spoon_35 (get_potato_20_a (get_potato_22_a cat_112))))) (and (<= 1 cat_132) (<= cat_132 (spoon_35 (get_potato_20_a (get_potato_22_a cat_112)))))))
(assert (=> (and (<= 1 cat_130) (<= cat_130 (spoon_35 (get_potato_20_a (get_potato_22_a cat_112))))) (= cat_128 (spoon_92 (select (get_potato_20_b (get_potato_22_a cat_112)) cat_132) cat_114))))
...
(assert (=> (and (<= 1 cat_130) (<= cat_130 (spoon_35 (get_potato_20_a (get_potato_22_a cat_112))))) (or (not (= cat_134 true)) (and (= cat_134 true) (= cat_132 (spoon_35 (get_potato_20_a (get_potato_22_a cat_112))))))))
...
(assert (= cat_139 true))
(assert (=> (fp.lt cat_116 (fp #b0 #b01110111 #b01000111101011100001010)) (= cat_143 cat_126)))
(assert (=> (fp.lt cat_116 (fp #b0 #b01110111 #b01000111101011100001010)) (= cat_144 (fp #b0 #b01110111 #b01000111101011100001010))))
(assert (=> (fp.lt cat_116 (fp #b0 #b01110111 #b01000111101011100001010)) (= cat_144 cat_147)))
(assert (=> (fp.lt cat_116 (fp #b0 #b01110111 #b01000111101011100001010)) (= cat_148 cat_144)))
(assert (=> (not (fp.lt cat_116 (fp #b0 #b01110111 #b01000111101011100001010))) (= cat_145 cat_126)))
(assert (=> (not (fp.lt cat_116 (fp #b0 #b01110111 #b01000111101011100001010))) (= cat_146 cat_116)))
(assert (=> (not (fp.lt cat_116 (fp #b0 #b01110111 #b01000111101011100001010))) (= cat_146 cat_147)))
(assert (=> (not (fp.lt cat_116 (fp #b0 #b01110111 #b01000111101011100001010))) (= cat_148 cat_146)))
(assert (= (mk_potato_15 cat_149 cat_150) (get_potato_17_a (select (get_potato_20_b (get_potato_22_a cat_112)) (spoon_35 (get_potato_20_a (get_potato_22_a cat_112)))))))
