...
(define-fun spoon_194 () potato_13 (mk_potato_13 cat_181 cat_182))
(define-fun spoon_195 () potato_13 (mk_potato_13 cat_175 cat_176))
(assert (= cat_166 cat_152))
(assert (= cat_167 0))
(assert (spoon_119 cat_167))
(assert (=> (<= 1 100) (spoon_60 cat_153)))
(assert (= cat_168 cat_153))
(assert (= cat_169 (spoon_75 (get_potato_22_a (get_potato_24_a cat_105)))))
...
(assert (=> (= cat_170 true) (and (= cat_159 (- cat_169 1)) (spoon_60 (- cat_169 1)))))
...
(assert (= spoon_195 (get_potato_15_a (select (get_potato_22_b (get_potato_24_a cat_105)) cat_172))))
(assert (= cat_172 cat_131))
(assert (spoon_60 cat_131))
(assert (= cat_177 cat_158))
(assert (= cat_178 1))
(assert (<= 1 cat_178))
(assert (<= cat_178 cat_131))
(assert (= cat_179 cat_156))
(assert (= cat_180 cat_157))
(assert (= spoon_194 (get_potato_15_a (select (get_potato_22_b (get_potato_24_a cat_105)) cat_178))))
(assert (=> (fp.leq (spoon_38 cat_176) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103)))) (=> (fp.lt (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))) (spoon_38 cat_182)) (and (= cat_160 (spoon_115 (mk_potato_15 spoon_195) (mk_potato_15 spoon_194) cat_103)) (spoon_107 cat_160)))))
(assert (=> (fp.leq (spoon_38 cat_176) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103)))) (=> (fp.lt (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))) (spoon_38 cat_182)) (= cat_183 (ite (= cat_160 0) true false)))))
...
(assert (=> (fp.leq (spoon_38 cat_176) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103)))) (=> (= cat_183 true) (and (= cat_161 (+ cat_167 1)) (spoon_119 (+ cat_167 1))))))
(assert (=> (fp.leq (spoon_38 cat_176) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103)))) (=> (= cat_183 true) (= cat_184 cat_167))))
(assert (=> (fp.leq (spoon_38 cat_176) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103)))) (=> (= cat_183 true) (= cat_185 cat_161))))
(assert (=> (fp.leq (spoon_38 cat_176) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103)))) (=> (not (= cat_183 true)) (= cat_185 cat_167))))
(assert (=> (not (fp.leq (spoon_38 cat_176) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))))) (=> (fp.leq (spoon_38 cat_182) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103)))) (and (= cat_162 (spoon_115 (mk_potato_15 spoon_195) (mk_potato_15 spoon_194) cat_103)) (spoon_107 cat_162)))))
(assert (=> (not (fp.leq (spoon_38 cat_176) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))))) (=> (fp.leq (spoon_38 cat_182) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103)))) (= cat_186 (ite (= cat_162 2) true false)))))
...
(assert (=> (not (fp.leq (spoon_38 cat_176) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))))) (=> (= cat_186 true) (and (= cat_163 (- cat_167 1)) (spoon_119 (- cat_167 1))))))
(assert (=> (not (fp.leq (spoon_38 cat_176) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))))) (=> (= cat_186 true) (= cat_187 cat_167))))
(assert (=> (not (fp.leq (spoon_38 cat_176) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))))) (=> (= cat_186 true) (= cat_188 cat_163))))
...
(assert (and (and (=> (<= 1 cat_131) (spoon_142 1 cat_131 cat_193)) (=> (<= (- 100) 100) (spoon_119 cat_192))) (and (<= 1 cat_193) (<= cat_193 cat_131))))
(assert (and (= cat_164 cat_193) (spoon_119 cat_193)))
(assert (= cat_165 (ite (<= cat_192 cat_164) true false)))
(assert (not (spoon_119 cat_193)))
(check-sat)
(exit)
