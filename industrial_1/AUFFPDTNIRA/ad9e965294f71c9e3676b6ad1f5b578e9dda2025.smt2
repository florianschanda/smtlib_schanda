...
(define-fun spoon_192 () potato_13 (mk_potato_13 cat_179 cat_180))
(define-fun spoon_193 () potato_13 (mk_potato_13 cat_173 cat_174))
(assert (= cat_164 cat_150))
(assert (= cat_165 0))
(assert (spoon_117 cat_165))
(assert (=> (<= 1 100) (spoon_58 cat_151)))
(assert (= cat_166 cat_151))
(assert (= cat_167 (spoon_73 (get_potato_22_a (get_potato_24_a cat_103)))))
...
(assert (=> (= cat_168 true) (and (= cat_157 (- cat_167 1)) (spoon_58 (- cat_167 1)))))
(assert (=> (= cat_168 true) (= cat_169 cat_167)))
(assert (=> (= cat_168 true) (= cat_170 cat_157)))
(assert (=> (not (= cat_168 true)) (= cat_170 cat_167)))
(assert (= cat_171 cat_152))
(assert (= cat_172 cat_153))
(assert (= spoon_193 (get_potato_15_a (select (get_potato_22_b (get_potato_24_a cat_103)) cat_170))))
(assert (= cat_170 cat_129))
(assert (spoon_58 cat_129))
(assert (= cat_175 cat_156))
(assert (= cat_176 1))
(assert (<= 1 cat_176))
(assert (<= cat_176 cat_129))
(assert (= cat_177 cat_154))
(assert (= cat_178 cat_155))
(assert (= spoon_192 (get_potato_15_a (select (get_potato_22_b (get_potato_24_a cat_103)) cat_176))))
(assert (=> (fp.leq (spoon_36 cat_174) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101)))) (=> (fp.lt (spoon_36 (get_potato_13_b (get_potato_15_a cat_101))) (spoon_36 cat_180)) (and (= cat_158 (spoon_113 (mk_potato_15 spoon_193) (mk_potato_15 spoon_192) cat_101)) (spoon_105 cat_158)))))
(assert (=> (fp.leq (spoon_36 cat_174) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101)))) (=> (fp.lt (spoon_36 (get_potato_13_b (get_potato_15_a cat_101))) (spoon_36 cat_180)) (= cat_181 (ite (= cat_158 0) true false)))))
...
(assert (=> (fp.leq (spoon_36 cat_174) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101)))) (=> (= cat_181 true) (and (= cat_159 (+ cat_165 1)) (spoon_117 (+ cat_165 1))))))
(assert (=> (fp.leq (spoon_36 cat_174) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101)))) (=> (= cat_181 true) (= cat_182 cat_165))))
(assert (=> (fp.leq (spoon_36 cat_174) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101)))) (=> (= cat_181 true) (= cat_183 cat_159))))
(assert (=> (fp.leq (spoon_36 cat_174) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101)))) (=> (not (= cat_181 true)) (= cat_183 cat_165))))
(assert (=> (not (fp.leq (spoon_36 cat_174) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101))))) (=> (fp.leq (spoon_36 cat_180) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101)))) (and (= cat_160 (spoon_113 (mk_potato_15 spoon_193) (mk_potato_15 spoon_192) cat_101)) (spoon_105 cat_160)))))
(assert (=> (not (fp.leq (spoon_36 cat_174) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101))))) (=> (fp.leq (spoon_36 cat_180) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101)))) (= cat_184 (ite (= cat_160 2) true false)))))
...
(assert (=> (not (fp.leq (spoon_36 cat_174) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101))))) (=> (= cat_184 true) (and (= cat_161 (- cat_165 1)) (spoon_117 (- cat_165 1))))))
(assert (=> (not (fp.leq (spoon_36 cat_174) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101))))) (=> (= cat_184 true) (= cat_185 cat_165))))
(assert (=> (not (fp.leq (spoon_36 cat_174) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101))))) (=> (= cat_184 true) (= cat_186 cat_161))))
...
(assert (= cat_189 spoon_192))
(assert (and (<= (- cat_191) cat_190) (<= cat_190 cat_191)))
(assert (and (and (=> (<= 1 cat_129) (spoon_140 1 cat_129 cat_191)) (=> (<= (- 100) 100) (spoon_117 cat_190))) (and (<= 1 cat_191) (<= cat_191 cat_129))))
(assert (and (= cat_162 cat_191) (spoon_117 cat_191)))
(assert (= cat_163 (ite (<= cat_190 cat_162) true false)))
(assert (not (spoon_117 cat_191)))
(check-sat)
(exit)
