...
(define-fun spoon_193 () potato_15 (mk_potato_15 cat_180 cat_181))
(define-fun spoon_194 () potato_15 (mk_potato_15 cat_174 cat_175))
...
(assert (= spoon_194 (get_potato_17_a (select (get_potato_20_b (get_potato_22_a cat_115)) cat_171))))
...
(assert (= spoon_193 (get_potato_17_a (select (get_potato_20_b (get_potato_22_a cat_115)) cat_177))))
(assert (=> (fp.leq (spoon_44 cat_175) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (fp.lt (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))) (spoon_44 cat_181)) (and (= cat_161 (spoon_92 (mk_potato_17 spoon_194) (mk_potato_17 spoon_193) cat_113)) (spoon_94 cat_161)))))
...
(assert (=> (not (fp.leq (spoon_44 cat_175) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (fp.leq (spoon_44 cat_181) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (and (= cat_163 (spoon_92 (mk_potato_17 spoon_194) (mk_potato_17 spoon_193) cat_113)) (spoon_94 cat_163)))))
...
(assert (and (and (=> (<= 1 cat_131) (spoon_143 1 cat_131 cat_192)) (=> (<= (- 30) 30) (spoon_118 cat_191))) (and (<= 1 cat_192) (<= cat_192 cat_131))))
(assert (not (spoon_118 cat_192)))
(check-sat)
(exit)
