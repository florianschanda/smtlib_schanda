...
(define-fun spoon_125 ((kitten_91 Float32) (kitten_92 Bool) (kitten_93 Bool) (kitten_94 Bool)) Bool (=> (or (= kitten_92 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_31 kitten_91)))
(define-fun spoon_126 ((kitten_95 Int) (kitten_96 Bool) (kitten_97 Bool) (kitten_98 Bool)) Bool (=> (or (= kitten_96 true) (<= 1 30)) (spoon_64 kitten_95)))
(define-fun spoon_127 ((kitten_99 Int) (kitten_100 Bool) (kitten_101 Bool) (kitten_102 Bool)) Bool (=> (or (= kitten_100 true) (<= 3 30)) (spoon_71 kitten_99)))
