...
(assert (not (fp.leq (spoon_44 (get_potato_15_b cat_192)) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))))
(assert (=> (fp.leq (spoon_44 (get_potato_15_b cat_198)) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (and (= cat_164 (spoon_92 (mk_potato_17 cat_192) (mk_potato_17 cat_198) cat_113)) (spoon_94 cat_164))))
(assert (=> (fp.leq (spoon_44 (get_potato_15_b cat_198)) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (= cat_199 (ite (= cat_164 2) true false))))
(assert (=> (not (fp.leq (spoon_44 (get_potato_15_b cat_198)) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (= cat_199 false)))
(assert (= cat_199 true))
