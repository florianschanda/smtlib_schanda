...
(assert (forall ((kitten_77 potato_24)) (and (<= 3 (spoon_92 kitten_77)) (<= (spoon_92 kitten_77) 30))))
(define-fun spoon_93 ((kitten_78 Int)) Bool (and (<= 3 kitten_78) (<= kitten_78 30)))
(declare-fun spoon_94 (Int) potato_5)
(declare-fun spoon_95 (potato_5) Bool)
(declare-fun spoon_96 (potato_5) Int)
...
(define-fun spoon_99 ((kitten_79 potato_25)) potato_24 (get_potato_25_a kitten_79))
(define-fun spoon_100 ((kitten_80 potato_24)) Int (spoon_92 kitten_80))
(declare-fun spoon_101 (Int) potato_24)
(assert (forall ((kitten_81 potato_24)) (! (= (spoon_101 (spoon_100 kitten_81)) kitten_81) :pattern ((spoon_100 kitten_81)))))
(assert (forall ((kitten_82 potato_24)) (! (spoon_93 (spoon_100 kitten_82)) :pattern ((spoon_100 kitten_82)))))
(assert (forall ((kitten_83 Int)) (! (=> (spoon_93 kitten_83) (= (spoon_100 (spoon_101 kitten_83)) kitten_83)) :pattern ((spoon_100 (spoon_101 kitten_83))))))
(declare-const cat_102 (Array Int potato_17))
(declare-const cat_103 Int)
(declare-fun spoon_104 ((Array Int potato_17)) Int)
(declare-const cat_105 Int)
(declare-fun spoon_106 ((Array Int potato_17)) Int)
(declare-const cat_107 Int)
(declare-fun spoon_108 ((Array Int potato_17)) Int)
(assert (<= 0 cat_103))
(assert (forall ((kitten_84 (Array Int potato_17))) (<= 0 (spoon_104 kitten_84))))
(assert (<= 0 cat_105))
(assert (forall ((kitten_85 (Array Int potato_17))) (<= 0 (spoon_106 kitten_85))))
(assert (<= 0 cat_107))
(assert (forall ((kitten_86 (Array Int potato_17))) (<= 0 (spoon_108 kitten_86))))
(declare-fun spoon_109 ((Array Int potato_17) (Array Int potato_17)) Bool)
(declare-datatypes () ((potato_26 (mk_potato_26 (get_potato_26_a potato_24) (get_potato_26_b (Array Int potato_17))))))
(define-fun spoon_110 ((kitten_87 potato_26)) potato_24 (get_potato_26_a kitten_87))
(define-fun spoon_111 ((kitten_88 potato_26)) (Array Int potato_17) (get_potato_26_b kitten_88))
(declare-datatypes () ((potato_27 (mk_potato_27 (get_potato_27_a potato_26)))))
(define-fun spoon_112 ((kitten_89 potato_27)) potato_26 (get_potato_27_a kitten_89))
(declare-datatypes () ((potato_28 (mk_potato_28 (get_potato_28_a potato_26)))))
(define-fun spoon_113 ((kitten_90 potato_28)) potato_26 (get_potato_28_a kitten_90))
(define-fun spoon_114 ((kitten_91 potato_28) (kitten_92 potato_28)) Bool (ite (and (= (spoon_100 (get_potato_26_a (get_potato_28_a kitten_91))) (spoon_100 (get_potato_26_a (get_potato_28_a kitten_92)))) (= (spoon_65 (get_potato_26_b (get_potato_28_a kitten_91)) 1 30 (get_potato_26_b (get_potato_28_a kitten_92)) 1 30) true)) true false))
(declare-const cat_115 Int)
(declare-fun spoon_116 (potato_28) Int)
(declare-const cat_117 Int)
(declare-fun spoon_118 (potato_28) Int)
(assert (<= 0 cat_115))
(assert (forall ((kitten_93 potato_28)) (<= 0 (spoon_116 kitten_93))))
(assert (<= 0 cat_117))
(assert (forall ((kitten_94 potato_28)) (<= 0 (spoon_118 kitten_94))))
(declare-const cat_119 Int)
(declare-const cat_120 Int)
(declare-const cat_121 Int)
(assert (<= 0 cat_119))
(assert (< cat_119 cat_120))
(assert (<= 0 cat_121))
...
(assert (<= 0 cat_124))
(declare-fun spoon_125 (potato_28 potato_28) Bool)
(declare-const cat_126 potato_28)
(declare-datatypes () ((potato_29 (mk_potato_29 (get_potato_29_a potato_28)))))
(define-fun spoon_127 ((kitten_95 potato_29)) potato_28 (get_potato_29_a kitten_95))
(declare-sort potato_30 0)
(declare-fun spoon_128 (potato_30) Int)
(assert (forall ((kitten_96 potato_30)) (and (<= 1 (spoon_128 kitten_96)) (<= (spoon_128 kitten_96) 30))))
(define-fun spoon_129 ((kitten_97 Int)) Bool (and (<= 1 kitten_97) (<= kitten_97 30)))
(declare-fun spoon_130 (Int) potato_5)
(declare-fun spoon_131 (potato_5) Bool)
(declare-fun spoon_132 (potato_5) Int)
(declare-fun spoon_133 (potato_30 potato_30) Bool)
(declare-const cat_134 potato_30)
(declare-datatypes () ((potato_31 (mk_potato_31 (get_potato_31_a potato_30)))))
(define-fun spoon_135 ((kitten_98 potato_31)) potato_30 (get_potato_31_a kitten_98))
(declare-const cat_136 potato_28)
(declare-const cat_137 Int)
(declare-const cat_138 Int)
(declare-const cat_139 Int)
(define-fun spoon_140 ((kitten_99 Float32) (kitten_100 Bool) (kitten_101 Bool) (kitten_102 Bool) (kitten_103 Bool)) Bool (=> (or (= kitten_100 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_37 kitten_99)))
(define-fun spoon_141 ((kitten_104 Int) (kitten_105 Bool) (kitten_106 Bool) (kitten_107 Bool) (kitten_108 Bool)) Bool (=> (or (= kitten_105 true) (<= 1 30)) (spoon_129 kitten_104)))
(define-fun spoon_142 ((kitten_109 Int) (kitten_110 Bool) (kitten_111 Bool) (kitten_112 Bool) (kitten_113 Bool)) Bool (=> (or (= kitten_110 true) (<= 3 30)) (spoon_93 kitten_109)))
(define-fun spoon_143 ((kitten_114 Int) (kitten_115 Bool) (kitten_116 Bool) (kitten_117 Bool) (kitten_118 Bool)) Bool (=> (or (= kitten_115 true) (<= 3 100)) (spoon_14 kitten_114)))
(assert (<= 1 (spoon_100 (get_potato_26_a (get_potato_28_a cat_136)))))
(assert (not (<= 1 1)))
(check-sat)
(exit)
