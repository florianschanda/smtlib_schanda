...
(declare-fun spoon_109 (Bool potato_26 potato_26) Bool)
(assert true)
...
(assert (forall ((kitten_91 potato_15) (kitten_92 potato_15) (kitten_93 potato_15) (kitten_94 potato_15)) (! (spoon_61 (spoon_110 kitten_91 kitten_92 kitten_93 kitten_94) true false true) :pattern ((spoon_110 kitten_91 kitten_92 kitten_93 kitten_94)))))
...
(define-fun spoon_123 ((kitten_99 Int) (kitten_100 Bool) (kitten_101 Bool) (kitten_102 Bool)) Bool (=> (or (= kitten_100 true) (<= 1 30)) (spoon_62 kitten_99)))
(define-fun spoon_124 ((kitten_103 Int) (kitten_104 Bool) (kitten_105 Bool) (kitten_106 Bool)) Bool (=> (or (= kitten_104 true) (<= 3 30)) (spoon_69 kitten_103)))
...
(assert (= cat_131 (spoon_108 cat_112 cat_114)))
...
(assert (= (mk_potato_13 cat_136 cat_137) (get_potato_15_a (select (get_potato_24_b (get_potato_26_a cat_112)) (spoon_76 (get_potato_24_a (get_potato_26_a cat_112)))))))
(assert (= cat_138 cat_129))
(assert (= cat_139 cat_130))
(assert (= (mk_potato_13 cat_140 cat_141) (get_potato_15_a (select (get_potato_24_b (get_potato_26_a cat_114)) (spoon_76 (get_potato_24_a (get_potato_26_a cat_114)))))))
(assert (<= 1 (spoon_76 (get_potato_24_a (get_potato_26_a cat_112)))))
(assert (not (<= 1 1)))
(check-sat)
(exit)
