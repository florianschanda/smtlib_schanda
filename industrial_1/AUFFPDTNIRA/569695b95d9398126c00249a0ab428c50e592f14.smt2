...
(assert (= cat_170 (spoon_102 (select (get_potato_20_b (get_potato_22_a cat_115)) 1) (select (get_potato_20_b (get_potato_22_a cat_115)) cat_169))))
(assert (=> (= cat_170 true) (and (= cat_159 (- cat_169 1)) (spoon_105 (- cat_169 1)))))
...
(assert (=> (fp.leq (spoon_44 cat_176) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (fp.lt (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))) (spoon_44 cat_182)) (and (= cat_160 (spoon_92 (mk_potato_17 spoon_195) (mk_potato_17 spoon_194) cat_113)) (spoon_94 cat_160)))))
(assert (=> (fp.leq (spoon_44 cat_176) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (fp.lt (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))) (spoon_44 cat_182)) (= cat_183 (ite (= cat_160 0) true false)))))
(assert (=> (fp.leq (spoon_44 cat_176) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (not (fp.lt (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))) (spoon_44 cat_182))) (= cat_183 false))))
(assert (=> (fp.leq (spoon_44 cat_176) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (= cat_183 true) (and (= cat_161 (+ cat_167 1)) (spoon_118 (+ cat_167 1))))))
...
(assert (=> (not (fp.leq (spoon_44 cat_176) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (fp.leq (spoon_44 cat_182) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (and (= cat_162 (spoon_92 (mk_potato_17 spoon_195) (mk_potato_17 spoon_194) cat_113)) (spoon_94 cat_162)))))
(assert (=> (not (fp.leq (spoon_44 cat_176) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (fp.leq (spoon_44 cat_182) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (= cat_186 (ite (= cat_162 2) true false)))))
(assert (=> (not (fp.leq (spoon_44 cat_176) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (not (fp.leq (spoon_44 cat_182) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (= cat_186 false))))
(assert (=> (not (fp.leq (spoon_44 cat_176) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (= cat_186 true) (and (= cat_163 (- cat_167 1)) (spoon_118 (- cat_167 1))))))
