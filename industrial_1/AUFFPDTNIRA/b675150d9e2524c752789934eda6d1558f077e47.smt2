...
(declare-fun spoon_92 (potato_17 potato_17 potato_17 potato_17) (_ FloatingPoint 8 24))
(declare-fun spoon_93 ((_ FloatingPoint 8 24) potato_17 potato_17 potato_17 potato_17) Bool)
(declare-sort potato_24 0)
(define-fun spoon_94 ((kitten_77 (_ FloatingPoint 8 24))) Bool (and (spoon_1 kitten_77) (and (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) kitten_77) (fp.leq kitten_77 (fp (_ bv0 1) (_ bv140 8) (_ bv3489792 23))))))
(declare-fun spoon_95 (potato_24 potato_24) Bool)
(declare-fun spoon_96 ((_ FloatingPoint 8 24)) potato_5)
(declare-fun spoon_97 (potato_5) Bool)
(declare-fun spoon_98 (potato_5) (_ FloatingPoint 8 24))
...
(define-fun spoon_101 ((kitten_79 (_ FloatingPoint 8 24)) (kitten_80 Bool) (kitten_81 Bool) (kitten_82 Bool) (kitten_83 Bool)) Bool (=> (or (= kitten_80 true) (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) (fp (_ bv0 1) (_ bv140 8) (_ bv3489792 23)))) (spoon_94 kitten_79)))
(assert (forall ((kitten_84 potato_17) (kitten_85 potato_17) (kitten_86 potato_17) (kitten_87 potato_17)) (! (spoon_101 (spoon_92 kitten_84 kitten_85 kitten_86 kitten_87) true false true true) :pattern ((spoon_92 kitten_84 kitten_85 kitten_86 kitten_87)))))
(declare-sort potato_26 0)
(define-fun spoon_102 ((kitten_88 (_ FloatingPoint 8 24))) Bool (and (spoon_1 kitten_88) (and (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) kitten_88) (fp.leq kitten_88 (fp (_ bv0 1) (_ bv147 8) (_ bv56192 23))))))
(declare-fun spoon_103 (potato_26 potato_26) Bool)
(declare-fun spoon_104 ((_ FloatingPoint 8 24)) potato_5)
(declare-fun spoon_105 (potato_5) Bool)
(declare-fun spoon_106 (potato_5) (_ FloatingPoint 8 24))
(declare-fun cat_107 () potato_26)
(declare-datatypes ((potato_27 0)) (((mk_potato_27 (get_potato_27_a potato_26)))))

(define-fun spoon_108 ((kitten_89 potato_27)) potato_26 (get_potato_27_a kitten_89))
(define-fun spoon_109 ((kitten_90 (_ FloatingPoint 8 24)) (kitten_91 Bool) (kitten_92 Bool) (kitten_93 Bool) (kitten_94 Bool)) Bool (=> (or (= kitten_91 true) (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) (fp (_ bv0 1) (_ bv147 8) (_ bv56192 23)))) (spoon_102 kitten_90)))
(declare-sort potato_28 0)
(declare-fun spoon_110 (potato_28) Int)
(assert (forall ((kitten_95 potato_28)) (let ((_let_0 (spoon_110 kitten_95))) (and (<= 1 _let_0) (<= _let_0 30))) ))
(define-fun spoon_111 ((kitten_96 Int)) Bool (and (<= 1 kitten_96) (<= kitten_96 30)))
(declare-fun spoon_112 (Int) potato_5)
(declare-fun spoon_113 (potato_5) Bool)
(declare-fun spoon_114 (potato_5) Int)
...
(define-fun spoon_117 ((kitten_97 potato_29)) potato_28 (get_potato_29_a kitten_97))
(define-fun spoon_118 ((kitten_98 Int) (kitten_99 Bool) (kitten_100 Bool) (kitten_101 Bool) (kitten_102 Bool)) Bool (=> (or (= kitten_99 true) (<= 1 30)) (spoon_111 kitten_98)))
(declare-fun cat_119 () potato_17)
(declare-fun cat_120 () Int)
(declare-fun cat_121 () potato_17)
(declare-fun cat_122 () Int)
(declare-fun cat_123 () potato_22)
...
(define-fun spoon_131 ((kitten_103 (_ FloatingPoint 8 24)) (kitten_104 Bool) (kitten_105 Bool) (kitten_106 Bool) (kitten_107 Bool)) Bool (let ((_let_0 (fp (_ bv0 1) (_ bv139 8) (_ bv0 23)))) (=> (or (= kitten_104 true) (fp.leq (fp.neg _let_0) _let_0)) (spoon_37 kitten_103))))
(define-fun spoon_132 ((kitten_108 Int) (kitten_109 Bool) (kitten_110 Bool) (kitten_111 Bool) (kitten_112 Bool)) Bool (=> (or (= kitten_109 true) (<= 3 30)) (spoon_28 kitten_108)))
(declare-fun cat_133 () Int)
(declare-fun cat_134 () (_ FloatingPoint 8 24))
(assert (spoon_102 cat_125))
(assert (=> (<= 1 30) (spoon_111 cat_133)))
(assert (=> (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) (fp (_ bv0 1) (_ bv140 8) (_ bv3489792 23))) (spoon_94 cat_134)))
(assert (<= 1 (spoon_35 (get_potato_20_a (get_potato_22_a cat_123)))))
(assert (not (<= (spoon_35 (get_potato_20_a (get_potato_22_a cat_123))) 30)))
(check-sat)
(exit)
