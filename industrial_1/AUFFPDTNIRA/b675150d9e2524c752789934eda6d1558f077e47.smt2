...
(declare-fun spoon_92 (potato_17 potato_17 potato_17 potato_17) Float32)
(declare-fun spoon_93 (Float32 potato_17 potato_17 potato_17 potato_17) Bool)
(declare-sort potato_24 0)
(define-fun spoon_94 ((kitten_77 Float32)) Bool (and (spoon_1 kitten_77) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_77) (fp.leq kitten_77 (fp #b0 #b10001100 #b01101010100000000000000)))))
...
(define-fun spoon_101 ((kitten_79 Float32) (kitten_80 Bool) (kitten_81 Bool) (kitten_82 Bool) (kitten_83 Bool)) Bool (=> (or (= kitten_80 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000))) (spoon_94 kitten_79)))
...
(define-fun spoon_102 ((kitten_88 Float32)) Bool (and (spoon_1 kitten_88) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_88) (fp.leq kitten_88 (fp #b0 #b10010011 #b00000001101101110000000)))))
...
(define-fun spoon_109 ((kitten_90 Float32) (kitten_91 Bool) (kitten_92 Bool) (kitten_93 Bool) (kitten_94 Bool)) Bool (=> (or (= kitten_91 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10010011 #b00000001101101110000000))) (spoon_102 kitten_90)))
(declare-sort potato_28 0)
(declare-fun spoon_110 (potato_28) Int)
(assert (forall ((kitten_95 potato_28)) (and (<= 1 (spoon_110 kitten_95)) (<= (spoon_110 kitten_95) 30))))
...
(declare-const cat_119 potato_17)
(declare-const cat_120 Int)
(declare-const cat_121 potato_17)
(declare-const cat_122 Int)
(declare-const cat_123 potato_22)
...
(define-fun spoon_131 ((kitten_103 Float32) (kitten_104 Bool) (kitten_105 Bool) (kitten_106 Bool) (kitten_107 Bool)) Bool (=> (or (= kitten_104 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_37 kitten_103)))
...
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000)) (spoon_94 cat_134)))
