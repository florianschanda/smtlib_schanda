...
(assert true)
(declare-fun spoon_94 (potato_17 potato_17 potato_17 potato_17) (_ FloatingPoint 8 24))
(declare-fun spoon_95 ((_ FloatingPoint 8 24) potato_17 potato_17 potato_17 potato_17) Bool)
(declare-sort potato_24 0)
(define-fun spoon_96 ((kitten_77 (_ FloatingPoint 8 24))) Bool (and (spoon_1 kitten_77) (and (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) kitten_77) (fp.leq kitten_77 (fp (_ bv0 1) (_ bv140 8) (_ bv3489792 23))))))
...
(define-fun spoon_103 ((kitten_79 (_ FloatingPoint 8 24)) (kitten_80 Bool) (kitten_81 Bool) (kitten_82 Bool) (kitten_83 Bool)) Bool (=> (or (= kitten_80 true) (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) (fp (_ bv0 1) (_ bv140 8) (_ bv3489792 23)))) (spoon_96 kitten_79)))
...
(assert (forall ((kitten_88 potato_26)) (let ((_let_0 (spoon_104 kitten_88))) (and (<= 1 _let_0) (<= _let_0 30))) ))
...
(define-fun spoon_122 ((kitten_91 (_ FloatingPoint 8 24)) (kitten_92 Bool) (kitten_93 Bool) (kitten_94 Bool) (kitten_95 Bool)) Bool (let ((_let_0 (fp (_ bv0 1) (_ bv139 8) (_ bv0 23)))) (=> (or (= kitten_92 true) (fp.leq (fp.neg _let_0) _let_0)) (spoon_37 kitten_91))))
...
(declare-fun cat_128 () potato_13)
(declare-fun cat_129 () potato_13)
(declare-fun cat_130 () potato_13)
(declare-fun cat_131 () potato_13)
...
(assert (=> (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) (fp (_ bv0 1) (_ bv140 8) (_ bv3489792 23))) (spoon_96 cat_125)))
(assert (=> (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) (fp (_ bv0 1) (_ bv140 8) (_ bv3489792 23))) (spoon_96 cat_126)))
(assert (= cat_127 (spoon_92 cat_112 cat_114)))
(assert (not (= cat_127 true)))
(assert (let ((_let_0 (get_potato_22_a cat_112))) (= (mk_potato_15 cat_128 cat_129) (get_potato_17_a (select (get_potato_20_b _let_0) (spoon_35 (get_potato_20_a _let_0)))))))
(assert (let ((_let_0 (get_potato_22_a cat_114))) (= (mk_potato_15 cat_130 cat_131) (get_potato_17_a (select (get_potato_20_b _let_0) (spoon_35 (get_potato_20_a _let_0)))))))
(assert (= cat_132 1))
(assert (<= 1 cat_132))
(assert (<= cat_132 (spoon_35 (get_potato_20_a (get_potato_22_a cat_112)))))
(assert (=> (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) (fp (_ bv0 1) (_ bv140 8) (_ bv3489792 23))) (spoon_96 cat_133)))
(assert (=> (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) (fp (_ bv0 1) (_ bv140 8) (_ bv3489792 23))) (spoon_96 cat_134)))
(assert (<= 1 cat_135))
