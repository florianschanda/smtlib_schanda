...
(declare-fun spoon_93 (Bool potato_22 potato_22) Bool)
(assert true)
(declare-fun spoon_94 (potato_17 potato_17 potato_17 potato_17) Float32)
(declare-fun spoon_95 (Float32 potato_17 potato_17 potato_17 potato_17) Bool)
(declare-sort potato_24 0)
(define-fun spoon_96 ((kitten_77 Float32)) Bool (and (spoon_1 kitten_77) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_77) (fp.leq kitten_77 (fp #b0 #b10001100 #b01101010100000000000000)))))
...
(define-fun spoon_103 ((kitten_79 Float32) (kitten_80 Bool) (kitten_81 Bool) (kitten_82 Bool) (kitten_83 Bool)) Bool (=> (or (= kitten_80 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000))) (spoon_96 kitten_79)))
(assert (forall ((kitten_84 potato_17) (kitten_85 potato_17) (kitten_86 potato_17) (kitten_87 potato_17)) (! (spoon_103 (spoon_94 kitten_84 kitten_85 kitten_86 kitten_87) true false true true) :pattern ((spoon_94 kitten_84 kitten_85 kitten_86 kitten_87)))))
(declare-sort potato_26 0)
(declare-fun spoon_104 (potato_26) Int)
(assert (forall ((kitten_88 potato_26)) (and (<= 1 (spoon_104 kitten_88)) (<= (spoon_104 kitten_88) 30))))
(define-fun spoon_105 ((kitten_89 Int)) Bool (and (<= 1 kitten_89) (<= kitten_89 30)))
...
(declare-const cat_112 potato_22)
(declare-const cat_113 Int)
(declare-const cat_114 potato_22)
...
(define-fun spoon_122 ((kitten_91 Float32) (kitten_92 Bool) (kitten_93 Bool) (kitten_94 Bool) (kitten_95 Bool)) Bool (=> (or (= kitten_92 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_37 kitten_91)))
(define-fun spoon_123 ((kitten_96 Int) (kitten_97 Bool) (kitten_98 Bool) (kitten_99 Bool) (kitten_100 Bool)) Bool (=> (or (= kitten_97 true) (<= 1 30)) (spoon_105 kitten_96)))
(define-fun spoon_124 ((kitten_101 Int) (kitten_102 Bool) (kitten_103 Bool) (kitten_104 Bool) (kitten_105 Bool)) Bool (=> (or (= kitten_102 true) (<= 3 30)) (spoon_28 kitten_101)))
(declare-const cat_125 Float32)
(declare-const cat_126 Float32)
(declare-const cat_127 Bool)
(declare-const cat_128 potato_13)
(declare-const cat_129 potato_13)
(declare-const cat_130 potato_13)
(declare-const cat_131 potato_13)
(declare-const cat_132 Int)
(declare-const cat_133 Float32)
(declare-const cat_134 Float32)
(declare-const cat_135 Int)
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000)) (spoon_96 cat_125)))
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000)) (spoon_96 cat_126)))
(assert (= cat_127 (spoon_92 cat_112 cat_114)))
(assert (not (= cat_127 true)))
(assert (= (mk_potato_15 cat_128 cat_129) (get_potato_17_a (select (get_potato_20_b (get_potato_22_a cat_112)) (spoon_35 (get_potato_20_a (get_potato_22_a cat_112)))))))
(assert (= (mk_potato_15 cat_130 cat_131) (get_potato_17_a (select (get_potato_20_b (get_potato_22_a cat_114)) (spoon_35 (get_potato_20_a (get_potato_22_a cat_114)))))))
(assert (= cat_132 1))
(assert (<= 1 cat_132))
(assert (<= cat_132 (spoon_35 (get_potato_20_a (get_potato_22_a cat_112)))))
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000)) (spoon_96 cat_133)))
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000)) (spoon_96 cat_134)))
(assert (<= 1 cat_135))
(assert (<= cat_135 (spoon_35 (get_potato_20_a (get_potato_22_a cat_112)))))
(assert (<= 1 (spoon_35 (get_potato_20_a (get_potato_22_a cat_114)))))
(assert (not (<= (spoon_35 (get_potato_20_a (get_potato_22_a cat_114))) 30)))
(check-sat)
(exit)
