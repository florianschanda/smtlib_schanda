...
(define-fun spoon_67 ((kitten_69 Int)) Bool (and (<= 3 kitten_69) (<= kitten_69 100)))
(declare-fun spoon_68 (Int) potato_5)
(declare-fun spoon_69 (potato_5) Bool)
(declare-fun spoon_70 (potato_5) Int)
(declare-fun spoon_71 (potato_20 potato_20) Bool)
(declare-const cat_72 potato_20)
(declare-datatypes () ((potato_21 (mk_potato_21 (get_potato_21_a potato_20)))))
(define-fun spoon_73 ((kitten_70 potato_21)) potato_20 (get_potato_21_a kitten_70))
(declare-fun spoon_74 (potato_20) Int)
(declare-fun spoon_75 (Int) potato_20)
(assert (forall ((kitten_71 potato_20)) (! (= (spoon_75 (spoon_74 kitten_71)) kitten_71) :pattern ((spoon_74 kitten_71)))))
(assert (forall ((kitten_72 potato_20)) (! (spoon_67 (spoon_74 kitten_72)) :pattern ((spoon_74 kitten_72)))))
(assert (forall ((kitten_73 Int)) (! (=> (spoon_67 kitten_73) (= (spoon_74 (spoon_75 kitten_73)) kitten_73)) :pattern ((spoon_74 (spoon_75 kitten_73))))))
...
(define-fun spoon_84 ((kitten_77 potato_22)) potato_20 (get_potato_22_a kitten_77))
...
(define-fun spoon_88 ((kitten_81 potato_24) (kitten_82 potato_24)) Bool (ite (and (= (spoon_74 (get_potato_22_a (get_potato_24_a kitten_81))) (spoon_74 (get_potato_22_a (get_potato_24_a kitten_82)))) (= (spoon_59 (get_potato_22_b (get_potato_24_a kitten_81)) 1 100 (get_potato_22_b (get_potato_24_a kitten_82)) 1 100) true)) true false))
...
(define-fun spoon_112 ((kitten_90 Int) (kitten_91 Bool) (kitten_92 Bool) (kitten_93 Bool)) Bool (=> (or (= kitten_91 true) (<= 1 100)) (spoon_60 kitten_90)))
(define-fun spoon_113 ((kitten_94 Int) (kitten_95 Bool) (kitten_96 Bool) (kitten_97 Bool)) Bool (=> (or (= kitten_95 true) (<= 3 100)) (spoon_67 kitten_94)))
...
(assert (= cat_118 cat_114))
(assert (= cat_119 (spoon_10 0)))
(assert (= cat_120 cat_115))
(assert (= cat_121 1))
(assert (=> (and (<= 1 cat_121) (<= cat_121 (spoon_74 (get_potato_22_a (get_potato_24_a cat_104))))) (= cat_116 cat_119)))
(assert (=> (and (<= 1 cat_121) (<= cat_121 (spoon_74 (get_potato_22_a (get_potato_24_a cat_104))))) (and (<= 1 cat_123) (<= cat_123 (spoon_74 (get_potato_22_a (get_potato_24_a cat_104)))))))
(assert (=> (and (<= 1 cat_121) (<= cat_121 (spoon_74 (get_potato_22_a (get_potato_24_a cat_104))))) (= cat_117 (spoon_102 (select (get_potato_22_b (get_potato_24_a cat_104)) cat_123) cat_106))))
(assert (=> (and (<= 1 cat_121) (<= cat_121 (spoon_74 (get_potato_22_a (get_potato_24_a cat_104))))) (= cat_124 cat_122)))
(assert (=> (and (<= 1 cat_121) (<= cat_121 (spoon_74 (get_potato_22_a (get_potato_24_a cat_104))))) (= cat_125 cat_117)))
(assert (=> (and (<= 1 cat_121) (<= cat_121 (spoon_74 (get_potato_22_a (get_potato_24_a cat_104))))) (or (= cat_125 true) (and (not (= cat_125 true)) (= cat_123 (spoon_74 (get_potato_22_a (get_potato_24_a cat_104))))))))
(assert (=> (and (<= 1 cat_121) (<= cat_121 (spoon_74 (get_potato_22_a (get_potato_24_a cat_104))))) (= cat_123 cat_127)))
(assert (=> (and (<= 1 cat_121) (<= cat_121 (spoon_74 (get_potato_22_a (get_potato_24_a cat_104))))) (= cat_125 cat_126)))
(assert (=> (and (<= 1 cat_121) (<= cat_121 (spoon_74 (get_potato_22_a (get_potato_24_a cat_104))))) (= cat_129 cat_123)))
(assert (=> (and (<= 1 cat_121) (<= cat_121 (spoon_74 (get_potato_22_a (get_potato_24_a cat_104))))) (= cat_128 cat_125)))
(assert (=> (and (<= 1 cat_121) (<= cat_121 (spoon_74 (get_potato_22_a (get_potato_24_a cat_104))))) (= (mk_potato_6 cat_131) (mk_potato_6 cat_127))))
(assert (=> (and (<= 1 cat_121) (<= cat_121 (spoon_74 (get_potato_22_a (get_potato_24_a cat_104))))) (= (mk_potato_7 cat_130) (mk_potato_7 cat_126))))
(assert (=> (and (<= 1 cat_121) (<= cat_121 (spoon_74 (get_potato_22_a (get_potato_24_a cat_104))))) (= cat_133 cat_129)))
(assert (=> (and (<= 1 cat_121) (<= cat_121 (spoon_74 (get_potato_22_a (get_potato_24_a cat_104))))) (= cat_132 cat_128)))
(assert (=> (not (and (<= 1 cat_121) (<= cat_121 (spoon_74 (get_potato_22_a (get_potato_24_a cat_104)))))) (= cat_121 cat_131)))
(assert (=> (not (and (<= 1 cat_121) (<= cat_121 (spoon_74 (get_potato_22_a (get_potato_24_a cat_104)))))) (= cat_119 cat_130)))
(assert (=> (not (and (<= 1 cat_121) (<= cat_121 (spoon_74 (get_potato_22_a (get_potato_24_a cat_104)))))) (= cat_133 cat_121)))
(assert (=> (not (and (<= 1 cat_121) (<= cat_121 (spoon_74 (get_potato_22_a (get_potato_24_a cat_104)))))) (= cat_132 cat_119)))
(assert (not (= cat_130 true)))
(assert (<= 1 (spoon_74 (get_potato_22_a (get_potato_24_a cat_106)))))
(assert (not (<= (spoon_74 (get_potato_22_a (get_potato_24_a cat_106))) 100)))
(check-sat)
(exit)
