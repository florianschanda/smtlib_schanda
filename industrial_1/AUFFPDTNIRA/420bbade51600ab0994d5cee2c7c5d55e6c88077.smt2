...
(assert (= cat_133 (spoon_37 (get_potato_13_a (get_potato_15_a (select (get_potato_26_b (get_potato_28_a cat_119)) 1))))))
(assert (= cat_134 (mk_potato_10 cat_130)))
(assert (= cat_135 (spoon_37 (get_potato_13_b (get_potato_15_a (select (get_potato_26_b (get_potato_28_a cat_119)) 1))))))
(assert (= cat_136 (mk_potato_10 cat_129)))
(assert (= cat_137 (spoon_37 (get_potato_13_a (get_potato_15_a (select (get_potato_26_b (get_potato_28_a cat_119)) 1))))))
(assert (= cat_138 (mk_potato_10 cat_131)))
(assert (= cat_139 (spoon_37 (get_potato_13_b (get_potato_15_a (select (get_potato_26_b (get_potato_28_a cat_119)) 1))))))
(assert (<= 2 (spoon_87 (get_potato_26_a (get_potato_28_a cat_119)))))
(assert (not (<= 1 2)))
(check-sat)
(exit)
