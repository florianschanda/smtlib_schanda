...
(define-fun spoon_57 ((kitten_36 Int)) Bool (and (<= (- cat_56) kitten_36) (<= kitten_36 cat_56)))
(define-fun spoon_58 ((kitten_37 Int)) Bool (and (<= (- 16777216) kitten_37) (<= kitten_37 16777216)))
(define-fun spoon_59 ((kitten_38 Float32) (kitten_39 Float32)) Bool (or (and (fp.isPositive kitten_38) (fp.isPositive kitten_39)) (and (fp.isNegative kitten_38) (fp.isNegative kitten_39))))
(define-fun spoon_60 ((kitten_40 Float32) (kitten_41 Float32)) Bool (or (and (fp.isPositive kitten_40) (fp.isNegative kitten_41)) (and (fp.isNegative kitten_40) (fp.isPositive kitten_41))))
(define-fun spoon_61 ((kitten_42 Float32) (kitten_43 Float32) (kitten_44 Float32)) Bool (and (=> (spoon_59 kitten_43 kitten_44) (fp.isPositive kitten_42)) (=> (spoon_60 kitten_43 kitten_44) (fp.isNegative kitten_42))))
(define-fun spoon_62 ((kitten_45 Real)) Real (* kitten_45 kitten_45))
(declare-fun spoon_63 (Real) Real)
(define-fun spoon_64 ((kitten_46 Float32) (kitten_47 Real)) Bool (or (and (fp.isPositive kitten_46) (< 0.0 kitten_47)) (and (fp.isNegative kitten_46) (< kitten_47 0.0))))
(declare-fun spoon_65 (Float32) Bool)
(declare-datatypes () ((potato_18 (mk_potato_18 (get_potato_18_a Float32)))))
(declare-sort potato_19 0)
(define-fun spoon_66 ((kitten_48 Float32)) Bool (and (spoon_1 kitten_48) (and (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) kitten_48) (fp.leq kitten_48 (fp #b0 #b10001011 #b00000000000000000000000)))))
...
(declare-fun spoon_73 (potato_19) Float32)
(declare-fun spoon_74 (Float32) potato_19)
(assert (forall ((kitten_50 potato_19)) (! (= (spoon_74 (spoon_73 kitten_50)) kitten_50) :pattern ((spoon_73 kitten_50)))))
(assert (forall ((kitten_51 potato_19)) (! (spoon_66 (spoon_73 kitten_51)) :pattern ((spoon_73 kitten_51)))))
(assert (forall ((kitten_52 Float32)) (! (=> (spoon_66 kitten_52) (= (spoon_73 (spoon_74 kitten_52)) kitten_52)) :pattern ((spoon_73 (spoon_74 kitten_52))))))
...
(define-fun spoon_75 ((kitten_53 potato_22)) potato_21 (get_potato_22_a kitten_53))
(declare-datatypes () ((potato_23 (mk_potato_23 (get_potato_23_a potato_21)))))
(define-fun spoon_76 ((kitten_54 potato_23)) potato_21 (get_potato_23_a kitten_54))
(define-fun spoon_77 ((kitten_55 potato_23) (kitten_56 potato_23)) Bool (ite (and (= (spoon_73 (get_potato_21_a (get_potato_23_a kitten_55))) (spoon_73 (get_potato_21_a (get_potato_23_a kitten_56)))) (= (spoon_73 (get_potato_21_b (get_potato_23_a kitten_55))) (spoon_73 (get_potato_21_b (get_potato_23_a kitten_56))))) true false))
(declare-const cat_78 Int)
(declare-fun spoon_79 (potato_23) Int)
(declare-const cat_80 Int)
(declare-fun spoon_81 (potato_23) Int)
(assert (<= 0 cat_78))
(assert (forall ((kitten_57 potato_23)) (<= 0 (spoon_79 kitten_57))))
(assert (<= 0 cat_80))
...
(define-fun spoon_90 ((kitten_59 potato_24)) potato_23 (get_potato_24_a kitten_59))
(declare-datatypes () ((potato_25 (mk_potato_25 (get_potato_25_a (Array Int potato_23))))))
(declare-fun spoon_91 ((Array Int potato_23) Int Int) (Array Int potato_23))
(assert (forall ((kitten_60 (Array Int potato_23))) (forall ((kitten_61 Int)) (! (= (spoon_91 kitten_60 kitten_61 kitten_61) kitten_60) :pattern ((spoon_91 kitten_60 kitten_61 kitten_61))))))
(assert (forall ((kitten_62 (Array Int potato_23))) (forall ((kitten_63 Int)) (forall ((kitten_64 Int)) (forall ((kitten_65 Int)) (! (= (select (spoon_91 kitten_62 kitten_63 kitten_64) kitten_65) (select kitten_62 (- kitten_65 (- kitten_64 kitten_63)))) :pattern ((select (spoon_91 kitten_62 kitten_63 kitten_64) kitten_65))))))))
(declare-fun spoon_92 ((Array Int potato_23) Int Int (Array Int potato_23) Int Int) (Array Int potato_23))
(assert (forall ((kitten_66 (Array Int potato_23)) (kitten_67 (Array Int potato_23))) (forall ((kitten_68 Int) (kitten_69 Int) (kitten_70 Int) (kitten_71 Int)) (forall ((kitten_72 Int)) (! (and (=> (and (<= kitten_68 kitten_72) (<= kitten_72 kitten_69)) (= (select (spoon_92 kitten_66 kitten_68 kitten_69 kitten_67 kitten_70 kitten_71) kitten_72) (select kitten_66 kitten_72))) (=> (< kitten_69 kitten_72) (= (select (spoon_92 kitten_66 kitten_68 kitten_69 kitten_67 kitten_70 kitten_71) kitten_72) (select kitten_67 (+ (- kitten_72 kitten_69) (- kitten_70 1)))))) :pattern ((select (spoon_92 kitten_66 kitten_68 kitten_69 kitten_67 kitten_70 kitten_71) kitten_72)))))))
(declare-fun spoon_93 (potato_23 Int) (Array Int potato_23))
(assert (forall ((kitten_73 potato_23)) (forall ((kitten_74 Int)) (! (= (select (spoon_93 kitten_73 kitten_74) kitten_74) kitten_73) :pattern ((select (spoon_93 kitten_73 kitten_74) kitten_74))))))
(define-fun spoon_94 ((kitten_75 (Array Int potato_23)) (kitten_76 Int) (kitten_77 Int) (kitten_78 (Array Int potato_23)) (kitten_79 Int) (kitten_80 Int)) Bool (ite (and (ite (<= kitten_76 kitten_77) (and (<= kitten_79 kitten_80) (= (- kitten_77 kitten_76) (- kitten_80 kitten_79))) (< kitten_80 kitten_79)) (forall ((kitten_81 Int)) (=> (and (<= kitten_76 kitten_81) (<= kitten_81 kitten_77)) (= (spoon_77 (select kitten_75 kitten_81) (select kitten_78 (+ (- kitten_79 kitten_76) kitten_81))) true)))) true false))
(assert (forall ((kitten_82 (Array Int potato_23)) (kitten_83 (Array Int potato_23))) (forall ((kitten_84 Int) (kitten_85 Int) (kitten_86 Int) (kitten_87 Int)) (=> (= (spoon_94 kitten_83 kitten_86 kitten_87 kitten_82 kitten_84 kitten_85) true) (and (ite (<= kitten_84 kitten_85) (and (<= kitten_86 kitten_87) (= (- kitten_85 kitten_84) (- kitten_87 kitten_86))) (< kitten_87 kitten_86)) (forall ((kitten_88 Int)) (=> (and (<= kitten_84 kitten_88) (<= kitten_88 kitten_85)) (= (spoon_77 (select kitten_82 kitten_88) (select kitten_83 (+ (- kitten_86 kitten_84) kitten_88))) true))))))))
(declare-const cat_95 (Array Int potato_23))
...
(declare-fun spoon_102 ((Array Int potato_23) (Array Int potato_23)) Bool)
(declare-datatypes () ((potato_26 (mk_potato_26 (get_potato_26_a potato_16) (get_potato_26_b (Array Int potato_23))))))
(define-fun spoon_103 ((kitten_92 potato_26)) potato_16 (get_potato_26_a kitten_92))
(define-fun spoon_104 ((kitten_93 potato_26)) (Array Int potato_23) (get_potato_26_b kitten_93))
(declare-datatypes () ((potato_27 (mk_potato_27 (get_potato_27_a potato_26)))))
(define-fun spoon_105 ((kitten_94 potato_27)) potato_26 (get_potato_27_a kitten_94))
(declare-datatypes () ((potato_28 (mk_potato_28 (get_potato_28_a potato_26)))))
(define-fun spoon_106 ((kitten_95 potato_28)) potato_26 (get_potato_28_a kitten_95))
(define-fun spoon_107 ((kitten_96 potato_28) (kitten_97 potato_28)) Bool (ite (and (= (spoon_49 (get_potato_26_a (get_potato_28_a kitten_96))) (spoon_49 (get_potato_26_a (get_potato_28_a kitten_97)))) (= (spoon_94 (get_potato_26_b (get_potato_28_a kitten_96)) 1 30 (get_potato_26_b (get_potato_28_a kitten_97)) 1 30) true)) true false))
(declare-const cat_108 Int)
(declare-fun spoon_109 (potato_28) Int)
(declare-const cat_110 Int)
(declare-fun spoon_111 (potato_28) Int)
(assert (<= 0 cat_108))
(assert (forall ((kitten_98 potato_28)) (<= 0 (spoon_109 kitten_98))))
(assert (<= 0 cat_110))
...
(define-fun spoon_120 ((kitten_100 potato_29)) potato_28 (get_potato_29_a kitten_100))
(declare-datatypes () ((potato_30 (mk_potato_30 (get_potato_30_a potato_28) (get_potato_30_b potato_14)))))
(define-fun spoon_121 ((kitten_101 potato_30)) potato_28 (get_potato_30_a kitten_101))
(define-fun spoon_122 ((kitten_102 potato_30)) potato_14 (get_potato_30_b kitten_102))
(declare-datatypes () ((potato_31 (mk_potato_31 (get_potato_31_a potato_30)))))
(define-fun spoon_123 ((kitten_103 potato_31)) potato_30 (get_potato_31_a kitten_103))
(declare-datatypes () ((potato_32 (mk_potato_32 (get_potato_32_a potato_30)))))
(define-fun spoon_124 ((kitten_104 potato_32)) potato_30 (get_potato_32_a kitten_104))
(define-fun spoon_125 ((kitten_105 potato_32) (kitten_106 potato_32)) Bool (ite (and (= (spoon_107 (get_potato_30_a (get_potato_32_a kitten_105)) (get_potato_30_a (get_potato_32_a kitten_106))) true) (= (spoon_28 (get_potato_30_b (get_potato_32_a kitten_105)) (get_potato_30_b (get_potato_32_a kitten_106))) true)) true false))
(declare-const cat_126 Int)
(declare-fun spoon_127 (potato_32) Int)
(declare-const cat_128 Int)
(declare-fun spoon_129 (potato_32) Int)
(assert (<= 0 cat_126))
(assert (forall ((kitten_107 potato_32)) (<= 0 (spoon_127 kitten_107))))
(assert (<= 0 cat_128))
...
(assert (<= 0 cat_133))
(assert (< cat_133 cat_134))
(assert (<= 0 cat_135))
(declare-fun spoon_136 (potato_32 potato_32) Bool)
(declare-const cat_137 potato_32)
(declare-datatypes () ((potato_33 (mk_potato_33 (get_potato_33_a potato_32)))))
(define-fun spoon_138 ((kitten_109 potato_33)) potato_32 (get_potato_33_a kitten_109))
(declare-sort potato_34 0)
(define-fun spoon_139 ((kitten_110 Int)) Bool (and (<= 1 kitten_110) (<= kitten_110 32)))
(declare-fun spoon_140 (Int) potato_5)
(declare-fun spoon_141 (potato_5) Bool)
(declare-fun spoon_142 (potato_5) Int)
(declare-fun spoon_143 (potato_34 potato_34) Bool)
(declare-const cat_144 potato_34)
(declare-datatypes () ((potato_35 (mk_potato_35 (get_potato_35_a potato_34)))))
(define-fun spoon_145 ((kitten_111 potato_35)) potato_34 (get_potato_35_a kitten_111))
(define-fun spoon_146 ((kitten_112 Int) (kitten_113 Bool) (kitten_114 Bool) (kitten_115 Bool)) Bool (=> (or (= kitten_113 true) (<= 1 32)) (spoon_139 kitten_112)))
(declare-fun spoon_147 (potato_34) Int)
(declare-fun spoon_148 (Int) potato_34)
(assert (forall ((kitten_116 potato_34)) (! (= (spoon_148 (spoon_147 kitten_116)) kitten_116) :pattern ((spoon_147 kitten_116)))))
(assert (forall ((kitten_117 potato_34)) (! (spoon_139 (spoon_147 kitten_117)) :pattern ((spoon_147 kitten_117)))))
(assert (forall ((kitten_118 Int)) (! (=> (spoon_139 kitten_118) (= (spoon_147 (spoon_148 kitten_118)) kitten_118)) :pattern ((spoon_147 (spoon_148 kitten_118))))))
(declare-datatypes () ((potato_36 (mk_potato_36 (get_potato_36_a (Array Int potato_32))))))
(declare-fun spoon_149 ((Array Int potato_32) Int Int) (Array Int potato_32))
(assert (forall ((kitten_119 (Array Int potato_32))) (forall ((kitten_120 Int)) (! (= (spoon_149 kitten_119 kitten_120 kitten_120) kitten_119) :pattern ((spoon_149 kitten_119 kitten_120 kitten_120))))))
(assert (forall ((kitten_121 (Array Int potato_32))) (forall ((kitten_122 Int)) (forall ((kitten_123 Int)) (forall ((kitten_124 Int)) (! (= (select (spoon_149 kitten_121 kitten_122 kitten_123) kitten_124) (select kitten_121 (- kitten_124 (- kitten_123 kitten_122)))) :pattern ((select (spoon_149 kitten_121 kitten_122 kitten_123) kitten_124))))))))
(declare-fun spoon_150 ((Array Int potato_32) Int Int (Array Int potato_32) Int Int) (Array Int potato_32))
(assert (forall ((kitten_125 (Array Int potato_32)) (kitten_126 (Array Int potato_32))) (forall ((kitten_127 Int) (kitten_128 Int) (kitten_129 Int) (kitten_130 Int)) (forall ((kitten_131 Int)) (! (and (=> (and (<= kitten_127 kitten_131) (<= kitten_131 kitten_128)) (= (select (spoon_150 kitten_125 kitten_127 kitten_128 kitten_126 kitten_129 kitten_130) kitten_131) (select kitten_125 kitten_131))) (=> (< kitten_128 kitten_131) (= (select (spoon_150 kitten_125 kitten_127 kitten_128 kitten_126 kitten_129 kitten_130) kitten_131) (select kitten_126 (+ (- kitten_131 kitten_128) (- kitten_129 1)))))) :pattern ((select (spoon_150 kitten_125 kitten_127 kitten_128 kitten_126 kitten_129 kitten_130) kitten_131)))))))
(declare-fun spoon_151 (potato_32 Int) (Array Int potato_32))
(assert (forall ((kitten_132 potato_32)) (forall ((kitten_133 Int)) (! (= (select (spoon_151 kitten_132 kitten_133) kitten_133) kitten_132) :pattern ((select (spoon_151 kitten_132 kitten_133) kitten_133))))))
(define-fun spoon_152 ((kitten_134 (Array Int potato_32)) (kitten_135 Int) (kitten_136 Int) (kitten_137 (Array Int potato_32)) (kitten_138 Int) (kitten_139 Int)) Bool (ite (and (ite (<= kitten_135 kitten_136) (and (<= kitten_138 kitten_139) (= (- kitten_136 kitten_135) (- kitten_139 kitten_138))) (< kitten_139 kitten_138)) (forall ((kitten_140 Int)) (=> (and (<= kitten_135 kitten_140) (<= kitten_140 kitten_136)) (= (spoon_125 (select kitten_134 kitten_140) (select kitten_137 (+ (- kitten_138 kitten_135) kitten_140))) true)))) true false))
(assert (forall ((kitten_141 (Array Int potato_32)) (kitten_142 (Array Int potato_32))) (forall ((kitten_143 Int) (kitten_144 Int) (kitten_145 Int) (kitten_146 Int)) (=> (= (spoon_152 kitten_142 kitten_145 kitten_146 kitten_141 kitten_143 kitten_144) true) (and (ite (<= kitten_143 kitten_144) (and (<= kitten_145 kitten_146) (= (- kitten_144 kitten_143) (- kitten_146 kitten_145))) (< kitten_146 kitten_145)) (forall ((kitten_147 Int)) (=> (and (<= kitten_143 kitten_147) (<= kitten_147 kitten_144)) (= (spoon_125 (select kitten_141 kitten_147) (select kitten_142 (+ (- kitten_145 kitten_143) kitten_147))) true))))))))
(declare-const cat_153 (Array Int potato_32))
(declare-const cat_154 Int)
(declare-fun spoon_155 ((Array Int potato_32)) Int)
...
(assert (<= 0 cat_154))
(assert (forall ((kitten_148 (Array Int potato_32))) (<= 0 (spoon_155 kitten_148))))
(assert (<= 0 cat_156))
...
(declare-fun spoon_160 ((Array Int potato_32) (Array Int potato_32)) Bool)
(declare-datatypes () ((potato_37 (mk_potato_37 (get_potato_37_a potato_34) (get_potato_37_b (Array Int potato_32))))))
(define-fun spoon_161 ((kitten_151 potato_37)) potato_34 (get_potato_37_a kitten_151))
(define-fun spoon_162 ((kitten_152 potato_37)) (Array Int potato_32) (get_potato_37_b kitten_152))
(declare-datatypes () ((potato_38 (mk_potato_38 (get_potato_38_a potato_37)))))
(define-fun spoon_163 ((kitten_153 potato_38)) potato_37 (get_potato_38_a kitten_153))
(declare-datatypes () ((potato_39 (mk_potato_39 (get_potato_39_a potato_37)))))
(define-fun spoon_164 ((kitten_154 potato_39)) potato_37 (get_potato_39_a kitten_154))
(define-fun spoon_165 ((kitten_155 potato_39) (kitten_156 potato_39)) Bool (ite (and (= (spoon_147 (get_potato_37_a (get_potato_39_a kitten_155))) (spoon_147 (get_potato_37_a (get_potato_39_a kitten_156)))) (= (spoon_152 (get_potato_37_b (get_potato_39_a kitten_155)) 1 32 (get_potato_37_b (get_potato_39_a kitten_156)) 1 32) true)) true false))
(declare-const cat_166 Int)
(declare-fun spoon_167 (potato_39) Int)
(declare-const cat_168 Int)
(declare-fun spoon_169 (potato_39) Int)
(assert (<= 0 cat_166))
(assert (forall ((kitten_157 potato_39)) (<= 0 (spoon_167 kitten_157))))
(assert (<= 0 cat_168))
...
(assert (<= 0 cat_175))
(declare-fun spoon_176 (potato_39 potato_39) Bool)
(declare-const cat_177 potato_39)
(declare-datatypes () ((potato_40 (mk_potato_40 (get_potato_40_a potato_39)))))
(define-fun spoon_178 ((kitten_159 potato_40)) potato_39 (get_potato_40_a kitten_159))
(declare-const cat_179 Int)
(declare-const cat_180 Int)
(declare-const cat_181 potato_39)
(declare-const cat_182 Int)
(declare-const cat_183 Int)
(declare-fun spoon_184 (Int potato_32) potato_32)
(declare-fun spoon_185 (potato_32 Int potato_32) Bool)
(assert true)
(declare-const cat_186 Int)
(declare-const cat_187 Int)
(declare-const cat_188 Int)
(define-fun spoon_189 ((kitten_160 Float32) (kitten_161 Bool) (kitten_162 Bool) (kitten_163 Bool)) Bool (=> (or (= kitten_161 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_66 kitten_160)))
(define-fun spoon_190 ((kitten_164 Int) (kitten_165 Bool) (kitten_166 Bool) (kitten_167 Bool)) Bool (=> (or (= kitten_165 true) (<= 3 30)) (spoon_42 kitten_164)))
(declare-const cat_191 potato_34)
(declare-const cat_192 (Array Int potato_32))
...
(assert (spoon_14 cat_179))
(assert (= cat_193 cat_191))
(assert (= cat_194 cat_192))
(assert (= (mk_potato_37 cat_195 cat_196) (get_potato_39_a cat_181)))
(assert (= (spoon_147 cat_195) cat_186))
(assert (spoon_139 cat_186))
(assert (<= 1 cat_186))
(assert (not (<= cat_186 32)))
(check-sat)
(exit)
