...
(assert (fp.leq (spoon_36 cat_169) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101)))))
(assert (=> (fp.lt (spoon_36 (get_potato_13_b (get_potato_15_a cat_101))) (spoon_36 cat_175)) (and (= cat_158 (spoon_113 (mk_potato_15 spoon_178) (mk_potato_15 spoon_177) cat_101)) (spoon_105 cat_158))))
(assert (=> (fp.lt (spoon_36 (get_potato_13_b (get_potato_15_a cat_101))) (spoon_36 cat_175)) (= cat_176 (ite (= cat_158 0) true false))))
(assert (=> (not (fp.lt (spoon_36 (get_potato_13_b (get_potato_15_a cat_101))) (spoon_36 cat_175))) (= cat_176 false)))
(assert (= cat_176 true))
