...
(assert (fp.leq (spoon_38 cat_171) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103)))))
(assert (=> (fp.lt (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))) (spoon_38 cat_177)) (and (= cat_160 (spoon_115 (mk_potato_15 spoon_180) (mk_potato_15 spoon_179) cat_103)) (spoon_107 cat_160))))
(assert (=> (fp.lt (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))) (spoon_38 cat_177)) (= cat_178 (ite (= cat_160 0) true false))))
(assert (=> (not (fp.lt (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))) (spoon_38 cat_177))) (= cat_178 false)))
(assert (= cat_178 true))
