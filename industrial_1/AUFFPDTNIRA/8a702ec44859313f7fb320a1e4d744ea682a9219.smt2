...
(define-fun spoon_119 ((kitten_101 Float32)) Bool (and (spoon_1 kitten_101) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_101) (fp.leq kitten_101 (fp #b0 #b01111111 #b00000000000000000000000)))))
...
(define-fun spoon_125 ((kitten_102 potato_31)) potato_30 (get_potato_31_a kitten_102))
(define-fun spoon_126 ((kitten_103 Float32) (kitten_104 Bool) (kitten_105 Bool) (kitten_106 Bool)) Bool (=> (or (= kitten_104 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b01111111 #b00000000000000000000000))) (spoon_119 kitten_103)))
...
(define-fun spoon_138 ((kitten_107 Float32) (kitten_108 Bool) (kitten_109 Bool) (kitten_110 Bool)) Bool (=> (or (= kitten_108 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_31 kitten_107)))
(define-fun spoon_139 ((kitten_111 Int) (kitten_112 Bool) (kitten_113 Bool) (kitten_114 Bool)) Bool (=> (or (= kitten_112 true) (<= 3 30)) (spoon_80 kitten_111)))
