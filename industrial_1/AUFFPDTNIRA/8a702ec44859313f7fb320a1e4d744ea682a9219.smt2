...
(define-fun spoon_62 ((kitten_43 Float32)) Bool (and (spoon_1 kitten_43) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_43) (fp.leq kitten_43 (fp #b0 #b10001100 #b01101010100000000000000)))))
...
(define-fun spoon_69 ((kitten_45 Float32) (kitten_46 Bool) (kitten_47 Bool) (kitten_48 Bool)) Bool (=> (or (= kitten_46 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000))) (spoon_62 kitten_45)))
(declare-sort potato_21 0)
(define-fun spoon_70 ((kitten_49 Int)) Bool (and (<= 1 kitten_49) (<= kitten_49 30)))
(declare-fun spoon_71 (Int) potato_5)
(declare-fun spoon_72 (potato_5) Bool)
(declare-fun spoon_73 (potato_5) Int)
(declare-fun spoon_74 (potato_21 potato_21) Bool)
(declare-const cat_75 potato_21)
(declare-datatypes () ((potato_22 (mk_potato_22 (get_potato_22_a potato_21)))))
(define-fun spoon_76 ((kitten_50 potato_22)) potato_21 (get_potato_22_a kitten_50))
(define-fun spoon_77 ((kitten_51 Int) (kitten_52 Bool) (kitten_53 Bool) (kitten_54 Bool)) Bool (=> (or (= kitten_52 true) (<= 1 30)) (spoon_70 kitten_51)))
(declare-sort potato_23 0)
(define-fun spoon_78 ((kitten_55 Int)) Bool (and (<= 3 kitten_55) (<= kitten_55 30)))
...
(assert (forall ((kitten_57 potato_23)) (! (= (spoon_86 (spoon_85 kitten_57)) kitten_57) :pattern ((spoon_85 kitten_57)))))
(assert (forall ((kitten_58 potato_23)) (! (spoon_78 (spoon_85 kitten_58)) :pattern ((spoon_85 kitten_58)))))
(assert (forall ((kitten_59 Int)) (! (=> (spoon_78 kitten_59) (= (spoon_85 (spoon_86 kitten_59)) kitten_59)) :pattern ((spoon_85 (spoon_86 kitten_59))))))
...
(assert (forall ((kitten_60 (Array Int potato_15))) (forall ((kitten_61 Int)) (! (= (spoon_87 kitten_60 kitten_61 kitten_61) kitten_60) :pattern ((spoon_87 kitten_60 kitten_61 kitten_61))))))
(assert (forall ((kitten_62 (Array Int potato_15))) (forall ((kitten_63 Int)) (forall ((kitten_64 Int)) (forall ((kitten_65 Int)) (! (= (select (spoon_87 kitten_62 kitten_63 kitten_64) kitten_65) (select kitten_62 (- kitten_65 (- kitten_64 kitten_63)))) :pattern ((select (spoon_87 kitten_62 kitten_63 kitten_64) kitten_65))))))))
(declare-fun spoon_88 ((Array Int potato_15) Int Int (Array Int potato_15) Int Int) (Array Int potato_15))
(assert (forall ((kitten_66 (Array Int potato_15)) (kitten_67 (Array Int potato_15))) (forall ((kitten_68 Int) (kitten_69 Int) (kitten_70 Int) (kitten_71 Int)) (forall ((kitten_72 Int)) (! (and (=> (and (<= kitten_68 kitten_72) (<= kitten_72 kitten_69)) (= (select (spoon_88 kitten_66 kitten_68 kitten_69 kitten_67 kitten_70 kitten_71) kitten_72) (select kitten_66 kitten_72))) (=> (< kitten_69 kitten_72) (= (select (spoon_88 kitten_66 kitten_68 kitten_69 kitten_67 kitten_70 kitten_71) kitten_72) (select kitten_67 (+ (- kitten_72 kitten_69) (- kitten_70 1)))))) :pattern ((select (spoon_88 kitten_66 kitten_68 kitten_69 kitten_67 kitten_70 kitten_71) kitten_72)))))))
(declare-fun spoon_89 (potato_15 Int) (Array Int potato_15))
(assert (forall ((kitten_73 potato_15)) (forall ((kitten_74 Int)) (! (= (select (spoon_89 kitten_73 kitten_74) kitten_74) kitten_73) :pattern ((select (spoon_89 kitten_73 kitten_74) kitten_74))))))
(define-fun spoon_90 ((kitten_75 (Array Int potato_15)) (kitten_76 Int) (kitten_77 Int) (kitten_78 (Array Int potato_15)) (kitten_79 Int) (kitten_80 Int)) Bool (ite (and (ite (<= kitten_76 kitten_77) (and (<= kitten_79 kitten_80) (= (- kitten_77 kitten_76) (- kitten_80 kitten_79))) (< kitten_80 kitten_79)) (forall ((kitten_81 Int)) (=> (and (<= kitten_76 kitten_81) (<= kitten_81 kitten_77)) (= (spoon_40 (select kitten_75 kitten_81) (select kitten_78 (+ (- kitten_79 kitten_76) kitten_81))) true)))) true false))
(assert (forall ((kitten_82 (Array Int potato_15)) (kitten_83 (Array Int potato_15))) (forall ((kitten_84 Int) (kitten_85 Int) (kitten_86 Int) (kitten_87 Int)) (=> (= (spoon_90 kitten_83 kitten_86 kitten_87 kitten_82 kitten_84 kitten_85) true) (and (ite (<= kitten_84 kitten_85) (and (<= kitten_86 kitten_87) (= (- kitten_85 kitten_84) (- kitten_87 kitten_86))) (< kitten_87 kitten_86)) (forall ((kitten_88 Int)) (=> (and (<= kitten_84 kitten_88) (<= kitten_88 kitten_85)) (= (spoon_40 (select kitten_82 kitten_88) (select kitten_83 (+ (- kitten_86 kitten_84) kitten_88))) true))))))))
...
(assert (<= 0 cat_92))
(assert (forall ((kitten_89 (Array Int potato_15))) (<= 0 (spoon_93 kitten_89))))
(assert (<= 0 cat_94))
...
(define-fun spoon_99 ((kitten_92 potato_26)) potato_23 (get_potato_26_a kitten_92))
(define-fun spoon_100 ((kitten_93 potato_26)) (Array Int potato_15) (get_potato_26_b kitten_93))
(declare-datatypes () ((potato_27 (mk_potato_27 (get_potato_27_a potato_26)))))
(define-fun spoon_101 ((kitten_94 potato_27)) potato_26 (get_potato_27_a kitten_94))
(declare-datatypes () ((potato_28 (mk_potato_28 (get_potato_28_a potato_26)))))
(define-fun spoon_102 ((kitten_95 potato_28)) potato_26 (get_potato_28_a kitten_95))
(define-fun spoon_103 ((kitten_96 potato_28) (kitten_97 potato_28)) Bool (ite (and (= (spoon_85 (get_potato_26_a (get_potato_28_a kitten_96))) (spoon_85 (get_potato_26_a (get_potato_28_a kitten_97)))) (= (spoon_90 (get_potato_26_b (get_potato_28_a kitten_96)) 1 30 (get_potato_26_b (get_potato_28_a kitten_97)) 1 30) true)) true false))
(declare-const cat_104 Int)
(declare-fun spoon_105 (potato_28) Int)
(declare-const cat_106 Int)
(declare-fun spoon_107 (potato_28) Int)
(assert (<= 0 cat_104))
(assert (forall ((kitten_98 potato_28)) (<= 0 (spoon_105 kitten_98))))
(assert (<= 0 cat_106))
...
(define-fun spoon_116 ((kitten_100 potato_29)) potato_28 (get_potato_29_a kitten_100))
(declare-sort potato_30 0)
(define-fun spoon_117 ((kitten_101 Float32)) Bool (and (spoon_1 kitten_101) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_101) (fp.leq kitten_101 (fp #b0 #b01111111 #b00000000000000000000000)))))
...
(define-fun spoon_123 ((kitten_102 potato_31)) potato_30 (get_potato_31_a kitten_102))
(define-fun spoon_124 ((kitten_103 Float32) (kitten_104 Bool) (kitten_105 Bool) (kitten_106 Bool)) Bool (=> (or (= kitten_104 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b01111111 #b00000000000000000000000))) (spoon_117 kitten_103)))
(declare-const cat_125 potato_15)
...
(define-fun spoon_136 ((kitten_107 Float32) (kitten_108 Bool) (kitten_109 Bool) (kitten_110 Bool)) Bool (=> (or (= kitten_108 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_29 kitten_107)))
(define-fun spoon_137 ((kitten_111 Int) (kitten_112 Bool) (kitten_113 Bool) (kitten_114 Bool)) Bool (=> (or (= kitten_112 true) (<= 3 30)) (spoon_78 kitten_111)))
...
(assert (spoon_54 cat_129))
(assert (= cat_142 cat_138))
(assert (= cat_143 (spoon_24 0)))
(assert (=> (<= 1 30) (spoon_70 cat_139)))
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b01111111 #b00000000000000000000000)) (spoon_117 cat_140)))
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000)) (spoon_62 cat_141)))
(assert (= cat_144 cat_139))
(assert (= cat_145 (spoon_85 (get_potato_26_a (get_potato_28_a cat_127)))))
(assert (<= 1 (spoon_85 (get_potato_26_a (get_potato_28_a cat_127)))))
(assert (not (<= 1 1)))
(check-sat)
(exit)
