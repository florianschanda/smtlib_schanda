...
(define-fun spoon_62 ((kitten_43 Int)) Bool (and (<= (- 128) kitten_43) (<= kitten_43 127)))
...
(define-fun spoon_69 ((kitten_45 Int)) Bool (and (<= 1 kitten_45) (<= kitten_45 30)))
...
(define-fun spoon_76 ((kitten_47 Int)) Bool (and (<= 3 kitten_47) (<= kitten_47 30)))
(declare-fun spoon_77 (Int) potato_5)
(declare-fun spoon_78 (potato_5) Bool)
(declare-fun spoon_79 (potato_5) Int)
...
(define-fun spoon_82 ((kitten_48 potato_24)) potato_23 (get_potato_24_a kitten_48))
(declare-fun spoon_83 (potato_23) Int)
(declare-fun spoon_84 (Int) potato_23)
(assert (forall ((kitten_49 potato_23)) (! (= (spoon_84 (spoon_83 kitten_49)) kitten_49) :pattern ((spoon_83 kitten_49)))))
(assert (forall ((kitten_50 potato_23)) (! (spoon_76 (spoon_83 kitten_50)) :pattern ((spoon_83 kitten_50)))))
(assert (forall ((kitten_51 Int)) (! (=> (spoon_76 kitten_51) (= (spoon_83 (spoon_84 kitten_51)) kitten_51)) :pattern ((spoon_83 (spoon_84 kitten_51))))))
(declare-datatypes () ((potato_25 (mk_potato_25 (get_potato_25_a (Array Int potato_15))))))
(declare-fun spoon_85 ((Array Int potato_15) Int Int) (Array Int potato_15))
(assert (forall ((kitten_52 (Array Int potato_15))) (forall ((kitten_53 Int)) (! (= (spoon_85 kitten_52 kitten_53 kitten_53) kitten_52) :pattern ((spoon_85 kitten_52 kitten_53 kitten_53))))))
(assert (forall ((kitten_54 (Array Int potato_15))) (forall ((kitten_55 Int)) (forall ((kitten_56 Int)) (forall ((kitten_57 Int)) (! (= (select (spoon_85 kitten_54 kitten_55 kitten_56) kitten_57) (select kitten_54 (- kitten_57 (- kitten_56 kitten_55)))) :pattern ((select (spoon_85 kitten_54 kitten_55 kitten_56) kitten_57))))))))
(declare-fun spoon_86 ((Array Int potato_15) Int Int (Array Int potato_15) Int Int) (Array Int potato_15))
(assert (forall ((kitten_58 (Array Int potato_15)) (kitten_59 (Array Int potato_15))) (forall ((kitten_60 Int) (kitten_61 Int) (kitten_62 Int) (kitten_63 Int)) (forall ((kitten_64 Int)) (! (and (=> (and (<= kitten_60 kitten_64) (<= kitten_64 kitten_61)) (= (select (spoon_86 kitten_58 kitten_60 kitten_61 kitten_59 kitten_62 kitten_63) kitten_64) (select kitten_58 kitten_64))) (=> (< kitten_61 kitten_64) (= (select (spoon_86 kitten_58 kitten_60 kitten_61 kitten_59 kitten_62 kitten_63) kitten_64) (select kitten_59 (+ (- kitten_64 kitten_61) (- kitten_62 1)))))) :pattern ((select (spoon_86 kitten_58 kitten_60 kitten_61 kitten_59 kitten_62 kitten_63) kitten_64)))))))
(declare-fun spoon_87 (potato_15 Int) (Array Int potato_15))
(assert (forall ((kitten_65 potato_15)) (forall ((kitten_66 Int)) (! (= (select (spoon_87 kitten_65 kitten_66) kitten_66) kitten_65) :pattern ((select (spoon_87 kitten_65 kitten_66) kitten_66))))))
(define-fun spoon_88 ((kitten_67 (Array Int potato_15)) (kitten_68 Int) (kitten_69 Int) (kitten_70 (Array Int potato_15)) (kitten_71 Int) (kitten_72 Int)) Bool (ite (and (ite (<= kitten_68 kitten_69) (and (<= kitten_71 kitten_72) (= (- kitten_69 kitten_68) (- kitten_72 kitten_71))) (< kitten_72 kitten_71)) (forall ((kitten_73 Int)) (=> (and (<= kitten_68 kitten_73) (<= kitten_73 kitten_69)) (= (spoon_40 (select kitten_67 kitten_73) (select kitten_70 (+ (- kitten_71 kitten_68) kitten_73))) true)))) true false))
(assert (forall ((kitten_74 (Array Int potato_15)) (kitten_75 (Array Int potato_15))) (forall ((kitten_76 Int) (kitten_77 Int) (kitten_78 Int) (kitten_79 Int)) (=> (= (spoon_88 kitten_75 kitten_78 kitten_79 kitten_74 kitten_76 kitten_77) true) (and (ite (<= kitten_76 kitten_77) (and (<= kitten_78 kitten_79) (= (- kitten_77 kitten_76) (- kitten_79 kitten_78))) (< kitten_79 kitten_78)) (forall ((kitten_80 Int)) (=> (and (<= kitten_76 kitten_80) (<= kitten_80 kitten_77)) (= (spoon_40 (select kitten_74 kitten_80) (select kitten_75 (+ (- kitten_78 kitten_76) kitten_80))) true))))))))
(declare-const cat_89 (Array Int potato_15))
(declare-const cat_90 Int)
(declare-fun spoon_91 ((Array Int potato_15)) Int)
...
(assert (<= 0 cat_90))
(assert (forall ((kitten_81 (Array Int potato_15))) (<= 0 (spoon_91 kitten_81))))
(assert (<= 0 cat_92))
...
(declare-fun spoon_96 ((Array Int potato_15) (Array Int potato_15)) Bool)
(declare-datatypes () ((potato_26 (mk_potato_26 (get_potato_26_a potato_23) (get_potato_26_b (Array Int potato_15))))))
(define-fun spoon_97 ((kitten_84 potato_26)) potato_23 (get_potato_26_a kitten_84))
(define-fun spoon_98 ((kitten_85 potato_26)) (Array Int potato_15) (get_potato_26_b kitten_85))
(declare-datatypes () ((potato_27 (mk_potato_27 (get_potato_27_a potato_26)))))
(define-fun spoon_99 ((kitten_86 potato_27)) potato_26 (get_potato_27_a kitten_86))
(declare-datatypes () ((potato_28 (mk_potato_28 (get_potato_28_a potato_26)))))
(define-fun spoon_100 ((kitten_87 potato_28)) potato_26 (get_potato_28_a kitten_87))
(define-fun spoon_101 ((kitten_88 potato_28) (kitten_89 potato_28)) Bool (ite (and (= (spoon_83 (get_potato_26_a (get_potato_28_a kitten_88))) (spoon_83 (get_potato_26_a (get_potato_28_a kitten_89)))) (= (spoon_88 (get_potato_26_b (get_potato_28_a kitten_88)) 1 30 (get_potato_26_b (get_potato_28_a kitten_89)) 1 30) true)) true false))
(declare-const cat_102 Int)
(declare-fun spoon_103 (potato_28) Int)
(declare-const cat_104 Int)
(declare-fun spoon_105 (potato_28) Int)
(assert (<= 0 cat_102))
(assert (forall ((kitten_90 potato_28)) (<= 0 (spoon_103 kitten_90))))
(assert (<= 0 cat_104))
...
(define-fun spoon_114 ((kitten_92 potato_29)) potato_28 (get_potato_29_a kitten_92))
(declare-fun spoon_115 (Float32 Float32) Float32)
(declare-fun spoon_116 (Float32 Float32 Float32) Bool)
(assert (forall ((kitten_93 Float32) (kitten_94 Float32)) (! (=> (and (spoon_61 kitten_93 true true true) (spoon_61 kitten_94 true true true)) (spoon_61 (spoon_115 kitten_93 kitten_94) true false true)) :pattern ((spoon_115 kitten_93 kitten_94)))))
(declare-sort potato_30 0)
(define-fun spoon_117 ((kitten_95 Float32)) Bool (and (spoon_1 kitten_95) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_95) (fp.leq kitten_95 (fp #b0 #b10001100 #b01101010100000000000000)))))
(declare-fun spoon_118 (potato_30 potato_30) Bool)
(declare-fun spoon_119 (Float32) potato_5)
(declare-fun spoon_120 (potato_5) Bool)
(declare-fun spoon_121 (potato_5) Float32)
(declare-const cat_122 potato_30)
(declare-datatypes () ((potato_31 (mk_potato_31 (get_potato_31_a potato_30)))))
(define-fun spoon_123 ((kitten_96 potato_31)) potato_30 (get_potato_31_a kitten_96))
(define-fun spoon_124 ((kitten_97 Float32) (kitten_98 Bool) (kitten_99 Bool) (kitten_100 Bool)) Bool (=> (or (= kitten_98 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000))) (spoon_117 kitten_97)))
(declare-fun spoon_125 (potato_15 potato_15) Float32)
(declare-fun spoon_126 (Float32 potato_15 potato_15) Bool)
(assert (forall ((kitten_101 potato_15) (kitten_102 potato_15)) (! (spoon_124 (spoon_125 kitten_101 kitten_102) true false true) :pattern ((spoon_125 kitten_101 kitten_102)))))
(declare-const cat_127 potato_28)
(declare-const cat_128 Int)
(declare-const cat_129 Int)
(declare-const cat_130 Int)
(define-fun spoon_131 ((kitten_103 Float32) (kitten_104 Bool) (kitten_105 Bool) (kitten_106 Bool)) Bool (=> (or (= kitten_104 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_29 kitten_103)))
(define-fun spoon_132 ((kitten_107 Int) (kitten_108 Bool) (kitten_109 Bool) (kitten_110 Bool)) Bool (=> (or (= kitten_108 true) (<= 1 30)) (spoon_69 kitten_107)))
(define-fun spoon_133 ((kitten_111 Int) (kitten_112 Bool) (kitten_113 Bool) (kitten_114 Bool)) Bool (=> (or (= kitten_112 true) (<= 3 30)) (spoon_76 kitten_111)))
(declare-const cat_134 Float32)
(declare-const cat_135 Float32)
(declare-const cat_136 Float32)
(declare-const cat_137 Float32)
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10010011 #b00000001101101110000000)) (spoon_54 cat_134)))
(assert (and (= cat_135 (spoon_125 (select (get_potato_26_b (get_potato_28_a cat_127)) 1) (select (get_potato_26_b (get_potato_28_a cat_127)) (spoon_83 (get_potato_26_a (get_potato_28_a cat_127)))))) (spoon_117 cat_135)))
(assert (= cat_136 cat_134))
(assert (= cat_137 cat_135))
(assert (<= 1 (- (spoon_83 (get_potato_26_a (get_potato_28_a cat_127))) 1)))
(assert (not (<= (- (spoon_83 (get_potato_26_a (get_potato_28_a cat_127))) 1) 30)))
(check-sat)
(exit)
