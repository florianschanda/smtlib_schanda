...
(define-fun spoon_102 ((kitten_85 Int)) Bool (and (<= 3 kitten_85) (<= kitten_85 100)))
...
(define-fun spoon_108 ((kitten_86 potato_27)) potato_26 (get_potato_27_a kitten_86))
(declare-fun spoon_109 (potato_26) Int)
(declare-fun spoon_110 (Int) potato_26)
(assert (forall ((kitten_87 potato_26)) (! (= (spoon_110 (spoon_109 kitten_87)) kitten_87) :pattern ((spoon_109 kitten_87)))))
(assert (forall ((kitten_88 potato_26)) (! (spoon_102 (spoon_109 kitten_88)) :pattern ((spoon_109 kitten_88)))))
(assert (forall ((kitten_89 Int)) (! (=> (spoon_102 kitten_89) (= (spoon_109 (spoon_110 kitten_89)) kitten_89)) :pattern ((spoon_109 (spoon_110 kitten_89))))))
...
(assert (<= 0 cat_112))
(assert (forall ((kitten_90 (Array Int potato_15))) (<= 0 (spoon_113 kitten_90))))
(assert (<= 0 cat_114))
(assert (forall ((kitten_91 (Array Int potato_15))) (<= 0 (spoon_115 kitten_91))))
(assert (<= 0 cat_116))
(assert (forall ((kitten_92 (Array Int potato_15))) (<= 0 (spoon_117 kitten_92))))
...
(define-fun spoon_119 ((kitten_93 potato_28)) potato_26 (get_potato_28_a kitten_93))
(define-fun spoon_120 ((kitten_94 potato_28)) (Array Int potato_15) (get_potato_28_b kitten_94))
(declare-datatypes () ((potato_29 (mk_potato_29 (get_potato_29_a potato_28)))))
(define-fun spoon_121 ((kitten_95 potato_29)) potato_28 (get_potato_29_a kitten_95))
(declare-datatypes () ((potato_30 (mk_potato_30 (get_potato_30_a potato_28)))))
(define-fun spoon_122 ((kitten_96 potato_30)) potato_28 (get_potato_30_a kitten_96))
(define-fun spoon_123 ((kitten_97 potato_30) (kitten_98 potato_30)) Bool (ite (and (= (spoon_109 (get_potato_28_a (get_potato_30_a kitten_97))) (spoon_109 (get_potato_28_a (get_potato_30_a kitten_98)))) (= (spoon_75 (get_potato_28_b (get_potato_30_a kitten_97)) 1 100 (get_potato_28_b (get_potato_30_a kitten_98)) 1 100) true)) true false))
(declare-const cat_124 Int)
(declare-fun spoon_125 (potato_30) Int)
(declare-const cat_126 Int)
(declare-fun spoon_127 (potato_30) Int)
(assert (<= 0 cat_124))
(assert (forall ((kitten_99 potato_30)) (<= 0 (spoon_125 kitten_99))))
(assert (<= 0 cat_126))
(assert (forall ((kitten_100 potato_30)) (<= 0 (spoon_127 kitten_100))))
...
(define-fun spoon_136 ((kitten_101 potato_31)) potato_30 (get_potato_31_a kitten_101))
(declare-const cat_137 potato_24)
(declare-const cat_138 Int)
(declare-const cat_139 Int)
(declare-const cat_140 Int)
(define-fun spoon_141 ((kitten_102 Float32) (kitten_103 Bool) (kitten_104 Bool) (kitten_105 Bool)) Bool (=> (or (= kitten_103 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_31 kitten_102)))
(define-fun spoon_142 ((kitten_106 Int) (kitten_107 Bool) (kitten_108 Bool) (kitten_109 Bool)) Bool (=> (or (= kitten_107 true) (<= 1 30)) (spoon_56 kitten_106)))
(define-fun spoon_143 ((kitten_110 Int) (kitten_111 Bool) (kitten_112 Bool) (kitten_113 Bool)) Bool (=> (or (= kitten_111 true) (<= 3 30)) (spoon_63 kitten_110)))
(define-fun spoon_144 ((kitten_114 Int) (kitten_115 Bool) (kitten_116 Bool) (kitten_117 Bool)) Bool (=> (or (= kitten_115 true) (<= 3 100)) (spoon_102 kitten_114)))
