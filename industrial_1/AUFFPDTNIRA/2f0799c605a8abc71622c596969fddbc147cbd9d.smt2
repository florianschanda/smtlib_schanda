...
(define-fun spoon_102 ((kitten_86 Int)) Bool (and (<= 3 kitten_86) (<= kitten_86 100)))
(declare-fun spoon_103 (Int) potato_5)
(declare-fun spoon_104 (potato_5) Bool)
(declare-fun spoon_105 (potato_5) Int)
(declare-fun spoon_106 (potato_26 potato_26) Bool)
(declare-const cat_107 potato_26)
(declare-datatypes () ((potato_27 (mk_potato_27 (get_potato_27_a potato_26)))))
(define-fun spoon_108 ((kitten_87 potato_27)) potato_26 (get_potato_27_a kitten_87))
(declare-fun spoon_109 (potato_26) Int)
(declare-fun spoon_110 (Int) potato_26)
(assert (forall ((kitten_88 potato_26)) (! (= (spoon_110 (spoon_109 kitten_88)) kitten_88) :pattern ((spoon_109 kitten_88)))))
(assert (forall ((kitten_89 potato_26)) (! (spoon_102 (spoon_109 kitten_89)) :pattern ((spoon_109 kitten_89)))))
(assert (forall ((kitten_90 Int)) (! (=> (spoon_102 kitten_90) (= (spoon_109 (spoon_110 kitten_90)) kitten_90)) :pattern ((spoon_109 (spoon_110 kitten_90))))))
(declare-const cat_111 (Array Int potato_15))
...
(declare-fun spoon_117 ((Array Int potato_15)) Int)
(assert (<= 0 cat_112))
...
(assert (<= 0 cat_116))
(assert (forall ((kitten_93 (Array Int potato_15))) (<= 0 (spoon_117 kitten_93))))
(declare-fun spoon_118 ((Array Int potato_15) (Array Int potato_15)) Bool)
(declare-datatypes () ((potato_28 (mk_potato_28 (get_potato_28_a potato_26) (get_potato_28_b (Array Int potato_15))))))
(define-fun spoon_119 ((kitten_94 potato_28)) potato_26 (get_potato_28_a kitten_94))
(define-fun spoon_120 ((kitten_95 potato_28)) (Array Int potato_15) (get_potato_28_b kitten_95))
(declare-datatypes () ((potato_29 (mk_potato_29 (get_potato_29_a potato_28)))))
(define-fun spoon_121 ((kitten_96 potato_29)) potato_28 (get_potato_29_a kitten_96))
(declare-datatypes () ((potato_30 (mk_potato_30 (get_potato_30_a potato_28)))))
(define-fun spoon_122 ((kitten_97 potato_30)) potato_28 (get_potato_30_a kitten_97))
(define-fun spoon_123 ((kitten_98 potato_30) (kitten_99 potato_30)) Bool (ite (and (= (spoon_109 (get_potato_28_a (get_potato_30_a kitten_98))) (spoon_109 (get_potato_28_a (get_potato_30_a kitten_99)))) (= (spoon_75 (get_potato_28_b (get_potato_30_a kitten_98)) 1 100 (get_potato_28_b (get_potato_30_a kitten_99)) 1 100) true)) true false))
(declare-const cat_124 Int)
(declare-fun spoon_125 (potato_30) Int)
(declare-const cat_126 Int)
(declare-fun spoon_127 (potato_30) Int)
(assert (<= 0 cat_124))
(assert (forall ((kitten_100 potato_30)) (<= 0 (spoon_125 kitten_100))))
(assert (<= 0 cat_126))
(assert (forall ((kitten_101 potato_30)) (<= 0 (spoon_127 kitten_101))))
...
(assert (<= 0 cat_133))
(declare-fun spoon_134 (potato_30 potato_30) Bool)
(declare-const cat_135 potato_30)
(declare-datatypes () ((potato_31 (mk_potato_31 (get_potato_31_a potato_30)))))
(define-fun spoon_136 ((kitten_102 potato_31)) potato_30 (get_potato_31_a kitten_102))
(declare-const cat_137 potato_24)
(declare-const cat_138 Int)
(declare-const cat_139 Int)
(declare-const cat_140 Int)
(define-fun spoon_141 ((kitten_103 Float32) (kitten_104 Bool) (kitten_105 Bool) (kitten_106 Bool)) Bool (=> (or (= kitten_104 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_31 kitten_103)))
(define-fun spoon_142 ((kitten_107 Int) (kitten_108 Bool) (kitten_109 Bool) (kitten_110 Bool)) Bool (=> (or (= kitten_108 true) (<= 1 30)) (spoon_56 kitten_107)))
(define-fun spoon_143 ((kitten_111 Int) (kitten_112 Bool) (kitten_113 Bool) (kitten_114 Bool)) Bool (=> (or (= kitten_112 true) (<= 3 30)) (spoon_63 kitten_111)))
(define-fun spoon_144 ((kitten_115 Int) (kitten_116 Bool) (kitten_117 Bool) (kitten_118 Bool)) Bool (=> (or (= kitten_116 true) (<= 3 100)) (spoon_102 kitten_115)))
(assert (<= 1 (spoon_70 (get_potato_22_a (get_potato_24_a cat_137)))))
(assert (not (<= (spoon_70 (get_potato_22_a (get_potato_24_a cat_137))) 30)))
(check-sat)
(exit)
