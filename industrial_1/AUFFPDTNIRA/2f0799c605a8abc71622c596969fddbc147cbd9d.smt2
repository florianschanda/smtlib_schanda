...
(define-fun spoon_61 ((kitten_39 Int)) Bool (and (<= 3 kitten_39) (<= kitten_39 30)))
(declare-fun spoon_62 (Int) potato_5)
(declare-fun spoon_63 (potato_5) Bool)
(declare-fun spoon_64 (potato_5) Int)
...
(define-fun spoon_67 ((kitten_40 potato_20)) potato_19 (get_potato_20_a kitten_40))
(declare-fun spoon_68 (potato_19) Int)
(declare-fun spoon_69 (Int) potato_19)
(assert (forall ((kitten_41 potato_19)) (! (= (spoon_69 (spoon_68 kitten_41)) kitten_41) :pattern ((spoon_68 kitten_41)))))
(assert (forall ((kitten_42 potato_19)) (! (spoon_61 (spoon_68 kitten_42)) :pattern ((spoon_68 kitten_42)))))
(assert (forall ((kitten_43 Int)) (! (=> (spoon_61 kitten_43) (= (spoon_68 (spoon_69 kitten_43)) kitten_43)) :pattern ((spoon_68 (spoon_69 kitten_43))))))
(declare-datatypes () ((potato_21 (mk_potato_21 (get_potato_21_a (Array Int potato_15))))))
(declare-fun spoon_70 ((Array Int potato_15) Int Int) (Array Int potato_15))
(assert (forall ((kitten_44 (Array Int potato_15))) (forall ((kitten_45 Int)) (! (= (spoon_70 kitten_44 kitten_45 kitten_45) kitten_44) :pattern ((spoon_70 kitten_44 kitten_45 kitten_45))))))
(assert (forall ((kitten_46 (Array Int potato_15))) (forall ((kitten_47 Int)) (forall ((kitten_48 Int)) (forall ((kitten_49 Int)) (! (= (select (spoon_70 kitten_46 kitten_47 kitten_48) kitten_49) (select kitten_46 (- kitten_49 (- kitten_48 kitten_47)))) :pattern ((select (spoon_70 kitten_46 kitten_47 kitten_48) kitten_49))))))))
(declare-fun spoon_71 ((Array Int potato_15) Int Int (Array Int potato_15) Int Int) (Array Int potato_15))
(assert (forall ((kitten_50 (Array Int potato_15)) (kitten_51 (Array Int potato_15))) (forall ((kitten_52 Int) (kitten_53 Int) (kitten_54 Int) (kitten_55 Int)) (forall ((kitten_56 Int)) (! (and (=> (and (<= kitten_52 kitten_56) (<= kitten_56 kitten_53)) (= (select (spoon_71 kitten_50 kitten_52 kitten_53 kitten_51 kitten_54 kitten_55) kitten_56) (select kitten_50 kitten_56))) (=> (< kitten_53 kitten_56) (= (select (spoon_71 kitten_50 kitten_52 kitten_53 kitten_51 kitten_54 kitten_55) kitten_56) (select kitten_51 (+ (- kitten_56 kitten_53) (- kitten_54 1)))))) :pattern ((select (spoon_71 kitten_50 kitten_52 kitten_53 kitten_51 kitten_54 kitten_55) kitten_56)))))))
(declare-fun spoon_72 (potato_15 Int) (Array Int potato_15))
(assert (forall ((kitten_57 potato_15)) (forall ((kitten_58 Int)) (! (= (select (spoon_72 kitten_57 kitten_58) kitten_58) kitten_57) :pattern ((select (spoon_72 kitten_57 kitten_58) kitten_58))))))
(define-fun spoon_73 ((kitten_59 (Array Int potato_15)) (kitten_60 Int) (kitten_61 Int) (kitten_62 (Array Int potato_15)) (kitten_63 Int) (kitten_64 Int)) Bool (ite (and (ite (<= kitten_60 kitten_61) (and (<= kitten_63 kitten_64) (= (- kitten_61 kitten_60) (- kitten_64 kitten_63))) (< kitten_64 kitten_63)) (forall ((kitten_65 Int)) (=> (and (<= kitten_60 kitten_65) (<= kitten_65 kitten_61)) (= (spoon_40 (select kitten_59 kitten_65) (select kitten_62 (+ (- kitten_63 kitten_60) kitten_65))) true)))) true false))
(assert (forall ((kitten_66 (Array Int potato_15)) (kitten_67 (Array Int potato_15))) (forall ((kitten_68 Int) (kitten_69 Int) (kitten_70 Int) (kitten_71 Int)) (=> (= (spoon_73 kitten_67 kitten_70 kitten_71 kitten_66 kitten_68 kitten_69) true) (and (ite (<= kitten_68 kitten_69) (and (<= kitten_70 kitten_71) (= (- kitten_69 kitten_68) (- kitten_71 kitten_70))) (< kitten_71 kitten_70)) (forall ((kitten_72 Int)) (=> (and (<= kitten_68 kitten_72) (<= kitten_72 kitten_69)) (= (spoon_40 (select kitten_66 kitten_72) (select kitten_67 (+ (- kitten_70 kitten_68) kitten_72))) true))))))))
...
(define-fun spoon_82 ((kitten_76 potato_22)) potato_19 (get_potato_22_a kitten_76))
...
(define-fun spoon_86 ((kitten_80 potato_24) (kitten_81 potato_24)) Bool (ite (and (= (spoon_68 (get_potato_22_a (get_potato_24_a kitten_80))) (spoon_68 (get_potato_22_a (get_potato_24_a kitten_81)))) (= (spoon_73 (get_potato_22_b (get_potato_24_a kitten_80)) 1 30 (get_potato_22_b (get_potato_24_a kitten_81)) 1 30) true)) true false))
...
(define-fun spoon_100 ((kitten_85 Int)) Bool (and (<= 3 kitten_85) (<= kitten_85 100)))
(declare-fun spoon_101 (Int) potato_5)
(declare-fun spoon_102 (potato_5) Bool)
(declare-fun spoon_103 (potato_5) Int)
...
(define-fun spoon_106 ((kitten_86 potato_27)) potato_26 (get_potato_27_a kitten_86))
(declare-fun spoon_107 (potato_26) Int)
(declare-fun spoon_108 (Int) potato_26)
(assert (forall ((kitten_87 potato_26)) (! (= (spoon_108 (spoon_107 kitten_87)) kitten_87) :pattern ((spoon_107 kitten_87)))))
(assert (forall ((kitten_88 potato_26)) (! (spoon_100 (spoon_107 kitten_88)) :pattern ((spoon_107 kitten_88)))))
(assert (forall ((kitten_89 Int)) (! (=> (spoon_100 kitten_89) (= (spoon_107 (spoon_108 kitten_89)) kitten_89)) :pattern ((spoon_107 (spoon_108 kitten_89))))))
(declare-const cat_109 (Array Int potato_15))
(declare-const cat_110 Int)
(declare-fun spoon_111 ((Array Int potato_15)) Int)
(declare-const cat_112 Int)
(declare-fun spoon_113 ((Array Int potato_15)) Int)
(declare-const cat_114 Int)
(declare-fun spoon_115 ((Array Int potato_15)) Int)
(assert (<= 0 cat_110))
(assert (forall ((kitten_90 (Array Int potato_15))) (<= 0 (spoon_111 kitten_90))))
(assert (<= 0 cat_112))
(assert (forall ((kitten_91 (Array Int potato_15))) (<= 0 (spoon_113 kitten_91))))
(assert (<= 0 cat_114))
(assert (forall ((kitten_92 (Array Int potato_15))) (<= 0 (spoon_115 kitten_92))))
(declare-fun spoon_116 ((Array Int potato_15) (Array Int potato_15)) Bool)
(declare-datatypes () ((potato_28 (mk_potato_28 (get_potato_28_a potato_26) (get_potato_28_b (Array Int potato_15))))))
(define-fun spoon_117 ((kitten_93 potato_28)) potato_26 (get_potato_28_a kitten_93))
(define-fun spoon_118 ((kitten_94 potato_28)) (Array Int potato_15) (get_potato_28_b kitten_94))
(declare-datatypes () ((potato_29 (mk_potato_29 (get_potato_29_a potato_28)))))
(define-fun spoon_119 ((kitten_95 potato_29)) potato_28 (get_potato_29_a kitten_95))
(declare-datatypes () ((potato_30 (mk_potato_30 (get_potato_30_a potato_28)))))
(define-fun spoon_120 ((kitten_96 potato_30)) potato_28 (get_potato_30_a kitten_96))
(define-fun spoon_121 ((kitten_97 potato_30) (kitten_98 potato_30)) Bool (ite (and (= (spoon_107 (get_potato_28_a (get_potato_30_a kitten_97))) (spoon_107 (get_potato_28_a (get_potato_30_a kitten_98)))) (= (spoon_73 (get_potato_28_b (get_potato_30_a kitten_97)) 1 100 (get_potato_28_b (get_potato_30_a kitten_98)) 1 100) true)) true false))
(declare-const cat_122 Int)
(declare-fun spoon_123 (potato_30) Int)
(declare-const cat_124 Int)
(declare-fun spoon_125 (potato_30) Int)
(assert (<= 0 cat_122))
(assert (forall ((kitten_99 potato_30)) (<= 0 (spoon_123 kitten_99))))
(assert (<= 0 cat_124))
(assert (forall ((kitten_100 potato_30)) (<= 0 (spoon_125 kitten_100))))
...
(assert (<= 0 cat_131))
(declare-fun spoon_132 (potato_30 potato_30) Bool)
(declare-const cat_133 potato_30)
(declare-datatypes () ((potato_31 (mk_potato_31 (get_potato_31_a potato_30)))))
(define-fun spoon_134 ((kitten_101 potato_31)) potato_30 (get_potato_31_a kitten_101))
(declare-const cat_135 potato_24)
(declare-const cat_136 Int)
(declare-const cat_137 Int)
(declare-const cat_138 Int)
(define-fun spoon_139 ((kitten_102 Float32) (kitten_103 Bool) (kitten_104 Bool) (kitten_105 Bool)) Bool (=> (or (= kitten_103 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_29 kitten_102)))
(define-fun spoon_140 ((kitten_106 Int) (kitten_107 Bool) (kitten_108 Bool) (kitten_109 Bool)) Bool (=> (or (= kitten_107 true) (<= 1 30)) (spoon_54 kitten_106)))
(define-fun spoon_141 ((kitten_110 Int) (kitten_111 Bool) (kitten_112 Bool) (kitten_113 Bool)) Bool (=> (or (= kitten_111 true) (<= 3 30)) (spoon_61 kitten_110)))
(define-fun spoon_142 ((kitten_114 Int) (kitten_115 Bool) (kitten_116 Bool) (kitten_117 Bool)) Bool (=> (or (= kitten_115 true) (<= 3 100)) (spoon_100 kitten_114)))
(assert (<= 1 (spoon_68 (get_potato_22_a (get_potato_24_a cat_135)))))
(assert (not (<= (spoon_68 (get_potato_22_a (get_potato_24_a cat_135))) 30)))
(check-sat)
(exit)
