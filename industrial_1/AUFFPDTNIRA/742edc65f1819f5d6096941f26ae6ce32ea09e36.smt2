...
(assert (= cat_140 cat_135))
(assert (= cat_141 1))
(assert (<= 1 cat_141))
(assert (<= cat_141 (- (spoon_83 (get_potato_26_a (get_potato_28_a cat_127))) 1)))
(assert (and (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10010011 #b00000001101101110000000)) (spoon_54 cat_142)) (and (<= 1 cat_143) (<= cat_143 (- (spoon_83 (get_potato_26_a (get_potato_28_a cat_127))) 1)))))
(assert (and (= cat_137 (+ cat_143 1)) (spoon_62 (+ cat_143 1))))
