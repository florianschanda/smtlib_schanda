...
(define-fun spoon_195 () potato_15 (mk_potato_15 cat_182 cat_183))
(define-fun spoon_196 () potato_15 (mk_potato_15 cat_176 cat_177))
(assert (= cat_167 cat_153))
(assert (= cat_168 0))
(assert (spoon_118 cat_168))
(assert (=> (<= 1 30) (spoon_105 cat_154)))
(assert (= cat_169 cat_154))
(assert (= cat_170 (spoon_35 (get_potato_20_a (get_potato_22_a cat_115)))))
(assert (= cat_171 (spoon_102 (select (get_potato_20_b (get_potato_22_a cat_115)) 1) (select (get_potato_20_b (get_potato_22_a cat_115)) cat_170))))
(assert (=> (= cat_171 true) (and (= cat_160 (- cat_170 1)) (spoon_105 (- cat_170 1)))))
(assert (=> (= cat_171 true) (= cat_172 cat_170)))
(assert (=> (= cat_171 true) (= cat_173 cat_160)))
(assert (=> (not (= cat_171 true)) (= cat_173 cat_170)))
(assert (= cat_174 cat_155))
(assert (= cat_175 cat_156))
(assert (= spoon_196 (get_potato_17_a (select (get_potato_20_b (get_potato_22_a cat_115)) cat_173))))
(assert (= cat_173 cat_131))
(assert (spoon_105 cat_131))
(assert (= cat_178 cat_159))
(assert (= cat_179 1))
(assert (<= 1 cat_179))
(assert (<= cat_179 cat_131))
(assert (= cat_180 cat_157))
(assert (= cat_181 cat_158))
(assert (= spoon_195 (get_potato_17_a (select (get_potato_20_b (get_potato_22_a cat_115)) cat_179))))
(assert (=> (fp.leq (spoon_44 cat_177) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (fp.lt (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))) (spoon_44 cat_183)) (and (= cat_161 (spoon_92 (mk_potato_17 spoon_196) (mk_potato_17 spoon_195) cat_113)) (spoon_94 cat_161)))))
(assert (=> (fp.leq (spoon_44 cat_177) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (fp.lt (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))) (spoon_44 cat_183)) (= cat_184 (ite (= cat_161 0) true false)))))
(assert (=> (fp.leq (spoon_44 cat_177) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (not (fp.lt (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))) (spoon_44 cat_183))) (= cat_184 false))))
(assert (=> (fp.leq (spoon_44 cat_177) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (= cat_184 true) (and (= cat_162 (+ cat_168 1)) (spoon_118 (+ cat_168 1))))))
(assert (=> (fp.leq (spoon_44 cat_177) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (= cat_184 true) (= cat_185 cat_168))))
(assert (=> (fp.leq (spoon_44 cat_177) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (= cat_184 true) (= cat_186 cat_162))))
(assert (=> (fp.leq (spoon_44 cat_177) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (not (= cat_184 true)) (= cat_186 cat_168))))
(assert (=> (not (fp.leq (spoon_44 cat_177) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (fp.leq (spoon_44 cat_183) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (and (= cat_163 (spoon_92 (mk_potato_17 spoon_196) (mk_potato_17 spoon_195) cat_113)) (spoon_94 cat_163)))))
(assert (=> (not (fp.leq (spoon_44 cat_177) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (fp.leq (spoon_44 cat_183) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (= cat_187 (ite (= cat_163 2) true false)))))
(assert (=> (not (fp.leq (spoon_44 cat_177) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (not (fp.leq (spoon_44 cat_183) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (= cat_187 false))))
(assert (=> (not (fp.leq (spoon_44 cat_177) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (= cat_187 true) (and (= cat_164 (- cat_168 1)) (spoon_118 (- cat_168 1))))))
(assert (=> (not (fp.leq (spoon_44 cat_177) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (= cat_187 true) (= cat_188 cat_168))))
(assert (=> (not (fp.leq (spoon_44 cat_177) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (= cat_187 true) (= cat_189 cat_164))))
(assert (=> (not (fp.leq (spoon_44 cat_177) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (not (= cat_187 true)) (= cat_189 cat_168))))
(assert (=> (not (fp.leq (spoon_44 cat_177) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (= cat_186 cat_189)))
(assert (= cat_190 cat_176))
(assert (= cat_191 cat_177))
(assert (= cat_192 spoon_195))
(assert (and (<= (- cat_194) cat_193) (<= cat_193 cat_194)))
(assert (and (and (=> (<= 1 cat_131) (spoon_143 1 cat_131 cat_194)) (=> (<= (- 30) 30) (spoon_118 cat_193))) (and (<= 1 cat_194) (<= cat_194 cat_131))))
(assert (and (= cat_165 cat_194) (spoon_118 cat_194)))
(assert (= cat_166 (ite (<= cat_193 cat_165) true false)))
(assert (not (spoon_118 cat_194)))
(check-sat)
(exit)
