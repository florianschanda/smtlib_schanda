...
(assert (let ((_let_0 (get_potato_20_b (get_potato_22_a cat_115)))) (= cat_171 (spoon_102 (select _let_0 1) (select _let_0 cat_170)))))
(assert (let ((_let_0 (- cat_170 1))) (=> (= cat_171 true) (and (= cat_160 _let_0) (spoon_105 _let_0)))))
...
(assert (let ((_let_0 (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (fp.leq (spoon_44 cat_177) _let_0) (=> (fp.lt _let_0 (spoon_44 cat_183)) (and (= cat_161 (spoon_92 (mk_potato_17 spoon_196) (mk_potato_17 spoon_195) cat_113)) (spoon_94 cat_161))))))
(assert (let ((_let_0 (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (fp.leq (spoon_44 cat_177) _let_0) (=> (fp.lt _let_0 (spoon_44 cat_183)) (= cat_184 (ite (= cat_161 0) true false))))))
(assert (let ((_let_0 (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (fp.leq (spoon_44 cat_177) _let_0) (=> (not (fp.lt _let_0 (spoon_44 cat_183))) (= cat_184 false)))))
(assert (let ((_let_0 (+ cat_168 1))) (=> (fp.leq (spoon_44 cat_177) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (= cat_184 true) (and (= cat_162 _let_0) (spoon_118 _let_0))))))
...
(assert (let ((_let_0 (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (not (fp.leq (spoon_44 cat_177) _let_0)) (=> (fp.leq (spoon_44 cat_183) _let_0) (and (= cat_163 (spoon_92 (mk_potato_17 spoon_196) (mk_potato_17 spoon_195) cat_113)) (spoon_94 cat_163))))))
(assert (let ((_let_0 (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (not (fp.leq (spoon_44 cat_177) _let_0)) (=> (fp.leq (spoon_44 cat_183) _let_0) (= cat_187 (ite (= cat_163 2) true false))))))
(assert (let ((_let_0 (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (not (fp.leq (spoon_44 cat_177) _let_0)) (=> (not (fp.leq (spoon_44 cat_183) _let_0)) (= cat_187 false)))))
(assert (let ((_let_0 (- cat_168 1))) (=> (not (fp.leq (spoon_44 cat_177) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (= cat_187 true) (and (= cat_164 _let_0) (spoon_118 _let_0))))))
