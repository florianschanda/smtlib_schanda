...
(assert (= cat_156 0))
(assert (spoon_119 cat_156))
(assert (=> (<= 1 30) (spoon_56 cat_154)))
(assert (= cat_157 cat_154))
(assert (= cat_158 (spoon_71 (get_potato_22_a (get_potato_24_a cat_105)))))
(assert (= cat_159 (spoon_117 (select (get_potato_22_b (get_potato_24_a cat_105)) 1) (select (get_potato_22_b (get_potato_24_a cat_105)) cat_158))))
(assert (= cat_159 true))
(assert (not (spoon_56 (- cat_158 1))))
(check-sat)
(exit)
