...
(assert (not (fp.leq (spoon_44 cat_171) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))))
(assert (=> (fp.leq (spoon_44 cat_177) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (and (= cat_160 (spoon_92 (mk_potato_17 spoon_180) (mk_potato_17 spoon_179) cat_113)) (spoon_94 cat_160))))
(assert (=> (fp.leq (spoon_44 cat_177) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (= cat_178 (ite (= cat_160 2) true false))))
(assert (=> (not (fp.leq (spoon_44 cat_177) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (= cat_178 false)))
(assert (= cat_178 true))
