...
(assert (not (fp.leq (spoon_38 cat_182) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))))))
(assert (=> (fp.leq (spoon_38 cat_188) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103)))) (and (= cat_163 (spoon_115 (mk_potato_15 (mk_potato_13 cat_181 cat_182)) (mk_potato_15 (mk_potato_13 cat_187 cat_188)) cat_103)) (spoon_107 cat_163))))
(assert (=> (fp.leq (spoon_38 cat_188) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103)))) (= cat_192 (ite (= cat_163 2) true false))))
(assert (=> (not (fp.leq (spoon_38 cat_188) (spoon_38 (get_potato_13_b (get_potato_15_a cat_103))))) (= cat_192 false)))
(assert (= cat_192 true))
