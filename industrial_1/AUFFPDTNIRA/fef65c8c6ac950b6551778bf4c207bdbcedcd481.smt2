...
(assert (not (fp.leq (spoon_36 cat_170) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101))))))
(assert (=> (fp.leq (spoon_36 cat_176) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101)))) (and (= cat_159 (spoon_113 (mk_potato_15 spoon_179) (mk_potato_15 spoon_178) cat_101)) (spoon_105 cat_159))))
(assert (=> (fp.leq (spoon_36 cat_176) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101)))) (= cat_177 (ite (= cat_159 2) true false))))
(assert (=> (not (fp.leq (spoon_36 cat_176) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101))))) (= cat_177 false)))
(assert (= cat_177 true))
