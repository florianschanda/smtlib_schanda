...
(declare-const cat_193 potato_6)
(declare-const cat_194 Int)
(declare-const cat_195 potato_14)
(declare-const cat_196 potato_13)
(declare-const cat_197 Bool)
(define-fun spoon_198 () potato_13 (mk_potato_13 cat_178 cat_179))
(define-fun spoon_199 () potato_13 (mk_potato_13 cat_172 cat_173))
(assert (= cat_163 cat_150))
(assert (= cat_164 0))
(assert (spoon_117 cat_164))
(assert (=> (<= 1 100) (spoon_58 cat_151)))
(assert (= cat_165 cat_151))
(assert (= cat_166 (spoon_73 (get_potato_22_a (get_potato_24_a cat_103)))))
...
(assert (=> (= cat_167 true) (and (= cat_157 (- cat_166 1)) (spoon_58 (- cat_166 1)))))
(assert (=> (= cat_167 true) (= cat_168 cat_166)))
(assert (=> (= cat_167 true) (= cat_169 cat_157)))
(assert (=> (not (= cat_167 true)) (= cat_169 cat_166)))
(assert (= cat_170 cat_152))
(assert (= cat_171 cat_153))
(assert (= spoon_199 (get_potato_15_a (select (get_potato_22_b (get_potato_24_a cat_103)) cat_169))))
(assert (= cat_169 cat_129))
(assert (spoon_58 cat_129))
(assert (= cat_174 cat_156))
(assert (= cat_175 1))
(assert (<= 1 cat_175))
(assert (<= cat_175 cat_129))
(assert (= cat_176 cat_154))
(assert (= cat_177 cat_155))
(assert (= spoon_198 (get_potato_15_a (select (get_potato_22_b (get_potato_24_a cat_103)) cat_175))))
(assert (=> (fp.leq (spoon_36 cat_173) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101)))) (=> (fp.lt (spoon_36 (get_potato_13_b (get_potato_15_a cat_101))) (spoon_36 cat_179)) (and (= cat_158 (spoon_113 (mk_potato_15 spoon_199) (mk_potato_15 spoon_198) cat_101)) (spoon_105 cat_158)))))
(assert (=> (fp.leq (spoon_36 cat_173) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101)))) (=> (fp.lt (spoon_36 (get_potato_13_b (get_potato_15_a cat_101))) (spoon_36 cat_179)) (= cat_180 (ite (= cat_158 0) true false)))))
...
(assert (=> (fp.leq (spoon_36 cat_173) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101)))) (=> (= cat_180 true) (and (= cat_159 (+ cat_164 1)) (spoon_117 (+ cat_164 1))))))
(assert (=> (fp.leq (spoon_36 cat_173) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101)))) (=> (= cat_180 true) (= cat_181 cat_164))))
(assert (=> (fp.leq (spoon_36 cat_173) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101)))) (=> (= cat_180 true) (= cat_182 cat_159))))
(assert (=> (fp.leq (spoon_36 cat_173) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101)))) (=> (not (= cat_180 true)) (= cat_182 cat_164))))
(assert (=> (not (fp.leq (spoon_36 cat_173) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101))))) (=> (fp.leq (spoon_36 cat_179) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101)))) (and (= cat_160 (spoon_113 (mk_potato_15 spoon_199) (mk_potato_15 spoon_198) cat_101)) (spoon_105 cat_160)))))
(assert (=> (not (fp.leq (spoon_36 cat_173) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101))))) (=> (fp.leq (spoon_36 cat_179) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101)))) (= cat_183 (ite (= cat_160 2) true false)))))
...
(assert (=> (not (fp.leq (spoon_36 cat_173) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101))))) (=> (= cat_183 true) (and (= cat_161 (- cat_164 1)) (spoon_117 (- cat_164 1))))))
(assert (=> (not (fp.leq (spoon_36 cat_173) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101))))) (=> (= cat_183 true) (= cat_184 cat_164))))
(assert (=> (not (fp.leq (spoon_36 cat_173) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101))))) (=> (= cat_183 true) (= cat_185 cat_161))))
...
(assert (= cat_188 spoon_198))
(assert (and (<= (- cat_192) cat_189) (<= cat_189 cat_192)))
(assert (and (and (=> (<= 1 cat_129) (spoon_140 1 cat_129 cat_192)) (=> (<= (- 100) 100) (spoon_117 cat_189))) (and (<= 1 cat_192) (<= cat_192 cat_129))))
(assert (not (= cat_192 cat_129)))
(assert (= cat_193 (mk_potato_6 cat_192)))
(assert (= cat_194 (+ cat_192 1)))
(assert (= cat_195 (mk_potato_14 cat_191)))
(assert (= cat_196 (get_potato_15_a (select (get_potato_22_b (get_potato_24_a cat_103)) cat_194))))
(assert (not (fp.leq (spoon_36 (get_potato_13_b cat_190)) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101))))))
(assert (=> (fp.leq (spoon_36 (get_potato_13_b cat_196)) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101)))) (and (= cat_162 (spoon_113 (mk_potato_15 cat_190) (mk_potato_15 cat_196) cat_101)) (spoon_105 cat_162))))
(assert (=> (fp.leq (spoon_36 (get_potato_13_b cat_196)) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101)))) (= cat_197 (ite (= cat_162 2) true false))))
(assert (=> (not (fp.leq (spoon_36 (get_potato_13_b cat_196)) (spoon_36 (get_potato_13_b (get_potato_15_a cat_101))))) (= cat_197 false)))
(assert (= cat_197 true))
(assert (not (spoon_117 (- cat_189 1))))
(check-sat)
(exit)
