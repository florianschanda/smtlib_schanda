...
(assert (= cat_156 cat_151))
(assert (= cat_157 0))
(assert (spoon_117 cat_157))
(assert (=> (<= 1 30) (spoon_54 cat_152)))
(assert (= cat_158 cat_152))
(assert (= cat_159 (spoon_69 (get_potato_22_a (get_potato_24_a cat_103)))))
(assert (= cat_160 (spoon_115 (select (get_potato_22_b (get_potato_24_a cat_103)) 1) (select (get_potato_22_b (get_potato_24_a cat_103)) cat_159))))
(assert (=> (= cat_160 true) (and (= cat_155 (- cat_159 1)) (spoon_54 (- cat_159 1)))))
(assert (=> (= cat_160 true) (= cat_161 cat_159)))
(assert (=> (= cat_160 true) (= cat_162 cat_155)))
(assert (=> (not (= cat_160 true)) (= cat_162 cat_159)))
(assert (= cat_163 cat_153))
(assert (= cat_164 cat_154))
(assert (= (mk_potato_13 cat_165 cat_166) (get_potato_15_a (select (get_potato_22_b (get_potato_24_a cat_103)) cat_162))))
(assert (= cat_162 cat_130))
