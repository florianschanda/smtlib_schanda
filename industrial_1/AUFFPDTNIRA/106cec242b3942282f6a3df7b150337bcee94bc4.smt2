...
(assert (= cat_158 cat_153))
(assert (= cat_159 0))
(assert (spoon_119 cat_159))
(assert (=> (<= 1 30) (spoon_56 cat_154)))
(assert (= cat_160 cat_154))
(assert (= cat_161 (spoon_71 (get_potato_22_a (get_potato_24_a cat_105)))))
(assert (= cat_162 (spoon_117 (select (get_potato_22_b (get_potato_24_a cat_105)) 1) (select (get_potato_22_b (get_potato_24_a cat_105)) cat_161))))
(assert (=> (= cat_162 true) (and (= cat_157 (- cat_161 1)) (spoon_56 (- cat_161 1)))))
(assert (=> (= cat_162 true) (= cat_163 cat_161)))
(assert (=> (= cat_162 true) (= cat_164 cat_157)))
(assert (=> (not (= cat_162 true)) (= cat_164 cat_161)))
(assert (= cat_165 cat_155))
(assert (= cat_166 cat_156))
(assert (= (mk_potato_13 cat_167 cat_168) (get_potato_15_a (select (get_potato_22_b (get_potato_24_a cat_105)) cat_164))))
(assert (= cat_164 cat_132))
