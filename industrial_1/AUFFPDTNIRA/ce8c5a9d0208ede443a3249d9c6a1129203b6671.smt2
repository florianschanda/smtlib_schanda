...
(assert (let ((_let_0 (get_potato_20_b (get_potato_22_a cat_115)))) (= cat_165 (spoon_102 (select _let_0 1) (select _let_0 cat_164)))))
(assert (let ((_let_0 (- cat_164 1))) (=> (= cat_165 true) (and (= cat_159 _let_0) (spoon_105 _let_0)))))
