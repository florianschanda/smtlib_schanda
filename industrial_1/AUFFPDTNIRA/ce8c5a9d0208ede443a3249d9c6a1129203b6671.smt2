...
(declare-const cat_168 potato_13)
...
(define-fun spoon_179 () potato_15 (mk_potato_15 cat_176 cat_177))
(define-fun spoon_180 () potato_15 (mk_potato_15 cat_170 cat_171))
(assert (= cat_161 cat_152))
(assert (= cat_162 0))
(assert (spoon_118 cat_162))
(assert (=> (<= 1 100) (spoon_105 cat_153)))
(assert (= cat_163 cat_153))
(assert (= cat_164 (spoon_35 (get_potato_20_a (get_potato_22_a cat_115)))))
(assert (= cat_165 (spoon_102 (select (get_potato_20_b (get_potato_22_a cat_115)) 1) (select (get_potato_20_b (get_potato_22_a cat_115)) cat_164))))
(assert (=> (= cat_165 true) (and (= cat_159 (- cat_164 1)) (spoon_105 (- cat_164 1)))))
...
(assert (= spoon_180 (get_potato_17_a (select (get_potato_20_b (get_potato_22_a cat_115)) cat_167))))
(assert (= cat_167 cat_130))
...
(assert (= spoon_179 (get_potato_17_a (select (get_potato_20_b (get_potato_22_a cat_115)) cat_173))))
(assert (fp.leq (spoon_44 cat_171) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))))
(assert (=> (fp.lt (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))) (spoon_44 cat_177)) (and (= cat_160 (spoon_92 (mk_potato_17 spoon_180) (mk_potato_17 spoon_179) cat_113)) (spoon_94 cat_160))))
(assert (=> (fp.lt (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))) (spoon_44 cat_177)) (= cat_178 (ite (= cat_160 0) true false))))
(assert (=> (not (fp.lt (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))) (spoon_44 cat_177))) (= cat_178 false)))
(assert (= cat_178 true))
(assert (not (spoon_118 (+ cat_162 1))))
(check-sat)
(exit)
