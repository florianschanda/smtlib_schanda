...
(assert (= cat_159 0))
(assert (spoon_118 cat_159))
(assert (=> (<= 1 30) (spoon_105 cat_154)))
(assert (= cat_160 cat_154))
(assert (= cat_161 (spoon_35 (get_potato_20_a (get_potato_22_a cat_115)))))
(assert (= cat_162 (spoon_102 (select (get_potato_20_b (get_potato_22_a cat_115)) 1) (select (get_potato_20_b (get_potato_22_a cat_115)) cat_161))))
(assert (=> (= cat_162 true) (and (= cat_157 (- cat_161 1)) (spoon_105 (- cat_161 1)))))
...
(assert (= (mk_potato_15 cat_167 cat_168) (get_potato_17_a (select (get_potato_20_b (get_potato_22_a cat_115)) cat_164))))
(assert (= cat_164 cat_131))
(assert (spoon_105 cat_131))
(assert (<= 1 cat_131))
(assert (not (<= cat_131 30)))
(check-sat)
(exit)
