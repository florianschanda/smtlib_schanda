...
(assert (let ((_let_0 (get_potato_20_b (get_potato_22_a cat_115)))) (= cat_162 (spoon_102 (select _let_0 1) (select _let_0 cat_161)))))
(assert (let ((_let_0 (- cat_161 1))) (=> (= cat_162 true) (and (= cat_157 _let_0) (spoon_105 _let_0)))))
