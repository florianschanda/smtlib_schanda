...
(assert (=> (fp.lt cat_31 cat_33) (= cat_39 cat_36)))
(assert (=> (fp.lt cat_31 cat_33) (= cat_40 (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (=> (not (fp.lt cat_31 cat_33)) (and (= cat_38 (fp.sub RNE cat_31 cat_33)) (spoon_1 (fp.sub RNE cat_31 cat_33)))))
(assert (=> (not (fp.lt cat_31 cat_33)) (= cat_41 cat_36)))
(assert (=> (not (fp.lt cat_31 cat_33)) (= cat_42 cat_38)))
(assert (=> (not (fp.lt cat_31 cat_33)) (= cat_40 cat_42)))
(assert (= cat_44 cat_45))
(assert (= cat_46 cat_44))
(assert (= cat_43 cat_37))
(assert (= cat_44 cat_40))
(assert (= (mk_potato_10 cat_48) (mk_potato_10 cat_45)))
(assert (= cat_47 cat_40))
(assert (= cat_50 cat_46))
(assert (= cat_49 cat_40))
(assert (= cat_51 cat_48))
(assert (not (fp.eq cat_48 (fp.max (fp #b0 #b00000000 #b00000000000000000000000) (fp.sub RNE cat_31 cat_33)))))
(check-sat)
(exit)
