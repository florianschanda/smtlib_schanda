...
(assert (fp.lt (fp (_ bv0 1) (_ bv134 8) (_ bv3407872 23)) (fp.add roundNearestTiesToEven cat_31 cat_33)))
(assert (not (spoon_23 (fp.sub roundNearestTiesToEven (fp.add roundNearestTiesToEven cat_31 cat_33) (fp (_ bv0 1) (_ bv135 8) (_ bv3407872 23))))))
(check-sat)
(exit)
