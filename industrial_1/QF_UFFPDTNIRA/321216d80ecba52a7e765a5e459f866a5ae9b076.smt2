...
(define-fun spoon_23 ((kitten_22 Float32)) Bool (and (spoon_1 kitten_22) (and (fp.leq (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)) kitten_22) (fp.leq kitten_22 (fp #b0 #b10000110 #b01101000000000000000000)))))
...
(define-fun spoon_30 ((kitten_24 Float32) (kitten_25 Bool) (kitten_26 Bool) (kitten_27 Bool)) Bool (=> (or (= kitten_25 true) (fp.leq (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)) (fp #b0 #b10000110 #b01101000000000000000000))) (spoon_23 kitten_24)))
