...
(define-fun spoon_32 ((kitten_25 Float32) (kitten_26 Bool) (kitten_27 Bool) (kitten_28 Bool)) Bool (=> (or (= kitten_26 true) (fp.leq (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)) (fp #b0 #b10000110 #b01101000000000000000000))) (spoon_25 kitten_25)))
...
(assert (fp.lt (fp.add RNE cat_33 cat_35) (fp.neg (fp #b0 #b10000110 #b01101000000000000000000))))
(assert (not (spoon_25 (fp.add RNE (fp.add RNE cat_33 cat_35) (fp #b0 #b10000111 #b01101000000000000000000)))))
(check-sat)
(exit)
