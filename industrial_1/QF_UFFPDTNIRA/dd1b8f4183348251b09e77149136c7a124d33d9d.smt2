...
(define-fun spoon_25 ((kitten_22 Float32)) Bool (and (spoon_1 kitten_22) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_22) (fp.leq kitten_22 (fp #b0 #b10000111 #b01101000000000000000000)))))
...
(define-fun spoon_32 ((kitten_24 Float32) (kitten_25 Bool) (kitten_26 Bool) (kitten_27 Bool)) Bool (=> (or (= kitten_25 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000111 #b01101000000000000000000))) (spoon_25 kitten_24)))
(declare-sort potato_13 0)
(define-fun spoon_33 ((kitten_28 Float32)) Bool (and (spoon_1 kitten_28) (and (fp.leq (fp.neg (fp #b0 #b10000111 #b01101000000000000000000)) kitten_28) (fp.leq kitten_28 (fp #b0 #b10000111 #b01101000000000000000000)))))
...
(define-fun spoon_39 ((kitten_29 potato_14)) potato_13 (get_potato_14_a kitten_29))
(define-fun spoon_40 ((kitten_30 Float32) (kitten_31 Bool) (kitten_32 Bool) (kitten_33 Bool)) Bool (=> (or (= kitten_31 true) (fp.leq (fp.neg (fp #b0 #b10000111 #b01101000000000000000000)) (fp #b0 #b10000111 #b01101000000000000000000))) (spoon_33 kitten_30)))
(declare-const cat_41 Float32)
(declare-const cat_42 Int)
(declare-const cat_43 Int)
(declare-const cat_44 Float32)
(assert (spoon_33 cat_41))
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000111 #b01101000000000000000000)) (spoon_25 cat_44)))
(assert (fp.lt cat_41 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (not (spoon_25 (fp.add RNE cat_41 (fp #b0 #b10000111 #b01101000000000000000000)))))
(check-sat)
(exit)
