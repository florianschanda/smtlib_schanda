...
(define-fun spoon_25 ((kitten_23 Float32)) Bool (and (spoon_1 kitten_23) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_23) (fp.leq kitten_23 (fp #b0 #b10000111 #b01101000000000000000000)))))
...
(define-fun spoon_32 ((kitten_25 Float32) (kitten_26 Bool) (kitten_27 Bool) (kitten_28 Bool)) Bool (=> (or (= kitten_26 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000111 #b01101000000000000000000))) (spoon_25 kitten_25)))
(declare-sort potato_13 0)
(define-fun spoon_33 ((kitten_29 Float32)) Bool (and (spoon_1 kitten_29) (and (fp.leq (fp.neg (fp #b0 #b10000111 #b01101000000000000000000)) kitten_29) (fp.leq kitten_29 (fp #b0 #b10000111 #b01101000000000000000000)))))
...
(define-fun spoon_40 ((kitten_31 Float32) (kitten_32 Bool) (kitten_33 Bool) (kitten_34 Bool)) Bool (=> (or (= kitten_32 true) (fp.leq (fp.neg (fp #b0 #b10000111 #b01101000000000000000000)) (fp #b0 #b10000111 #b01101000000000000000000))) (spoon_33 kitten_31)))
