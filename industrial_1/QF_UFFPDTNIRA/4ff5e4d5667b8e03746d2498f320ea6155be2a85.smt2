...
(define-fun spoon_30 ((kitten_29 (_ FloatingPoint 8 24))) Bool (and (spoon_1 kitten_29) (and (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) kitten_29) (fp.leq kitten_29 (fp (_ bv0 1) (_ bv254 8) (_ bv8388607 23))))))
...
(define-fun spoon_37 ((kitten_31 (_ FloatingPoint 8 24)) (kitten_32 Bool) (kitten_33 Bool) (kitten_34 Bool) (kitten_35 Bool)) Bool (=> (or (= kitten_32 true) (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) (fp (_ bv0 1) (_ bv254 8) (_ bv8388607 23)))) (spoon_30 kitten_31)))
(declare-sort potato_15 0)
(define-fun spoon_38 ((kitten_36 (_ FloatingPoint 8 24))) Bool (and (spoon_1 kitten_36) (and (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) kitten_36) (fp.leq kitten_36 (fp (_ bv0 1) (_ bv191 8) (_ bv48 23))))))
(declare-fun spoon_39 (potato_15 potato_15) Bool)
(declare-fun spoon_40 ((_ FloatingPoint 8 24)) potato_5)
(declare-fun spoon_41 (potato_5) Bool)
(declare-fun spoon_42 (potato_5) (_ FloatingPoint 8 24))
(declare-fun cat_43 () potato_15)
...
(define-fun spoon_48 ((kitten_38 (_ FloatingPoint 8 24)) (kitten_39 Bool) (kitten_40 Bool) (kitten_41 Bool) (kitten_42 Bool)) Bool (=> (or (= kitten_39 true) (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) (fp (_ bv0 1) (_ bv191 8) (_ bv48 23)))) (spoon_38 kitten_38)))
(declare-fun cat_49 () (_ FloatingPoint 8 24))
(assert (spoon_30 cat_45))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv254 8) (_ bv8388607 23)))) (=> (fp.leq (fp.neg _let_0) _let_0) (spoon_1 cat_49))))
(assert (not (or (fp.isZero cat_45) (fp.isPositive cat_45))))
(check-sat)
(exit)
