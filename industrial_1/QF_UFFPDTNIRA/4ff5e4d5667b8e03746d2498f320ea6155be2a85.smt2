...
(define-fun spoon_30 ((kitten_29 Float32)) Bool (and (spoon_1 kitten_29) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_29) (fp.leq kitten_29 (fp #b0 #b11111110 #b11111111111111111111111)))))
...
(define-fun spoon_37 ((kitten_31 Float32) (kitten_32 Bool) (kitten_33 Bool) (kitten_34 Bool) (kitten_35 Bool)) Bool (=> (or (= kitten_32 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b11111110 #b11111111111111111111111))) (spoon_30 kitten_31)))
(declare-sort potato_15 0)
(define-fun spoon_38 ((kitten_36 Float32)) Bool (and (spoon_1 kitten_36) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_36) (fp.leq kitten_36 (fp #b0 #b10111111 #b00000000000000000110000)))))
...
(define-fun spoon_48 ((kitten_38 Float32) (kitten_39 Bool) (kitten_40 Bool) (kitten_41 Bool) (kitten_42 Bool)) Bool (=> (or (= kitten_39 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10111111 #b00000000000000000110000))) (spoon_38 kitten_38)))
