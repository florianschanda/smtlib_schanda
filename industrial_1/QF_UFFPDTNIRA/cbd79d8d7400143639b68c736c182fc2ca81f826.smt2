...
(define-fun spoon_25 ((kitten_23 Float32)) Bool (and (spoon_1 kitten_23) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_23) (fp.leq kitten_23 (fp #b0 #b10010011 #b00000001101101110000000)))))
...
(define-fun spoon_32 ((kitten_25 Float32) (kitten_26 Bool) (kitten_27 Bool) (kitten_28 Bool)) Bool (=> (or (= kitten_26 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10010011 #b00000001101101110000000))) (spoon_25 kitten_25)))
...
(assert (not (fp.lt cat_33 cat_35)))
(assert (not (spoon_25 (fp.sub RNE cat_33 cat_35))))
(check-sat)
(exit)
