...
(assert (=> (fp.lt cat_31 cat_33) (= cat_39 (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (=> (not (fp.lt cat_31 cat_33)) (and (= cat_37 (fp.sub RNE cat_31 cat_33)) (spoon_1 (fp.sub RNE cat_31 cat_33)))))
...
(assert (not (fp.eq cat_44 (fp.max (fp #b0 #b00000000 #b00000000000000000000000) (fp.sub RNE cat_31 cat_33)))))
(check-sat)
(exit)
