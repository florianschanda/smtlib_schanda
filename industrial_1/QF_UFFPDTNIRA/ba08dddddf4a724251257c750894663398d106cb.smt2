...
(assert (= cat_51 (fp.add RNE cat_33 cat_35)))
(assert (=> (fp.leq (fp #b0 #b10000111 #b01101000000000000000000) cat_51) (and (= cat_47 (fp.sub RNE cat_51 (fp #b0 #b10000111 #b01101000000000000000000))) (spoon_1 (fp.sub RNE cat_51 (fp #b0 #b10000111 #b01101000000000000000000))))))
(assert (=> (fp.leq (fp #b0 #b10000111 #b01101000000000000000000) cat_51) (= cat_52 cat_51)))
(assert (=> (fp.leq (fp #b0 #b10000111 #b01101000000000000000000) cat_51) (= cat_53 cat_47)))
(assert (=> (not (fp.leq (fp #b0 #b10000111 #b01101000000000000000000) cat_51)) (=> (fp.lt cat_51 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_48 (fp.add RNE cat_51 (fp #b0 #b10000111 #b01101000000000000000000))) (spoon_1 (fp.add RNE cat_51 (fp #b0 #b10000111 #b01101000000000000000000)))))))
(assert (=> (not (fp.leq (fp #b0 #b10000111 #b01101000000000000000000) cat_51)) (=> (fp.lt cat_51 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_54 cat_51))))
(assert (=> (not (fp.leq (fp #b0 #b10000111 #b01101000000000000000000) cat_51)) (=> (fp.lt cat_51 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_55 cat_48))))
(assert (=> (not (fp.leq (fp #b0 #b10000111 #b01101000000000000000000) cat_51)) (=> (not (fp.lt cat_51 (fp #b0 #b00000000 #b00000000000000000000000))) (= cat_55 cat_51))))
(assert (=> (not (fp.leq (fp #b0 #b10000111 #b01101000000000000000000) cat_51)) (= cat_53 cat_55)))
(assert (not (spoon_25 cat_53)))
(check-sat)
(exit)
