...
(define-fun spoon_35 ((kitten_28 Float32)) Bool (and (spoon_1 kitten_28) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_28) (fp.leq kitten_28 (fp #b0 #b10001000 #b01101000000000000000000)))))
...
(define-fun spoon_41 ((kitten_29 potato_14)) potato_13 (get_potato_14_a kitten_29))
(define-fun spoon_42 ((kitten_30 Float32) (kitten_31 Bool) (kitten_32 Bool) (kitten_33 Bool)) Bool (=> (or (= kitten_31 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001000 #b01101000000000000000000))) (spoon_35 kitten_30)))
...
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001000 #b01101000000000000000000)) (spoon_35 cat_44)))
(assert (= cat_47 cat_44))
(assert (= cat_48 (fp.add RNE cat_31 cat_33)))
(assert (=> (fp.leq (fp #b0 #b10000111 #b01101000000000000000000) cat_48) (and (= cat_45 (fp.sub RNE cat_48 (fp #b0 #b10000111 #b01101000000000000000000))) (spoon_1 (fp.sub RNE cat_48 (fp #b0 #b10000111 #b01101000000000000000000))))))
(assert (=> (fp.leq (fp #b0 #b10000111 #b01101000000000000000000) cat_48) (= cat_49 cat_48)))
(assert (=> (fp.leq (fp #b0 #b10000111 #b01101000000000000000000) cat_48) (= cat_50 cat_45)))
(assert (=> (not (fp.leq (fp #b0 #b10000111 #b01101000000000000000000) cat_48)) (=> (fp.lt cat_48 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_46 (fp.add RNE cat_48 (fp #b0 #b10000111 #b01101000000000000000000))) (spoon_1 (fp.add RNE cat_48 (fp #b0 #b10000111 #b01101000000000000000000)))))))
(assert (=> (not (fp.leq (fp #b0 #b10000111 #b01101000000000000000000) cat_48)) (=> (fp.lt cat_48 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_51 cat_48))))
(assert (=> (not (fp.leq (fp #b0 #b10000111 #b01101000000000000000000) cat_48)) (=> (fp.lt cat_48 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_52 cat_46))))
(assert (=> (not (fp.leq (fp #b0 #b10000111 #b01101000000000000000000) cat_48)) (=> (not (fp.lt cat_48 (fp #b0 #b00000000 #b00000000000000000000000))) (= cat_52 cat_48))))
(assert (=> (not (fp.leq (fp #b0 #b10000111 #b01101000000000000000000) cat_48)) (= cat_50 cat_52)))
(assert (not (spoon_23 cat_50)))
(check-sat)
(exit)
