...
(define-fun spoon_37 ((kitten_28 Float32)) Bool (and (spoon_1 kitten_28) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_28) (fp.leq kitten_28 (fp #b0 #b10001000 #b01101000000000000000000)))))
...
(define-fun spoon_43 ((kitten_29 potato_14)) potato_13 (get_potato_14_a kitten_29))
(define-fun spoon_44 ((kitten_30 Float32) (kitten_31 Bool) (kitten_32 Bool) (kitten_33 Bool)) Bool (=> (or (= kitten_31 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001000 #b01101000000000000000000))) (spoon_37 kitten_30)))
