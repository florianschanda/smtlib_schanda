...
(define-fun spoon_37 ((kitten_29 Float32)) Bool (and (spoon_1 kitten_29) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_29) (fp.leq kitten_29 (fp #b0 #b10001000 #b01101000000000000000000)))))
...
(define-fun spoon_43 ((kitten_30 potato_14)) potato_13 (get_potato_14_a kitten_30))
(define-fun spoon_44 ((kitten_31 Float32) (kitten_32 Bool) (kitten_33 Bool) (kitten_34 Bool)) Bool (=> (or (= kitten_32 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001000 #b01101000000000000000000))) (spoon_37 kitten_31)))
...
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001000 #b01101000000000000000000)) (spoon_37 cat_46)))
(assert (= cat_49 cat_46))
(assert (= cat_50 (fp.add RNE cat_33 cat_35)))
(assert (=> (fp.leq (fp #b0 #b10000111 #b01101000000000000000000) cat_50) (and (= cat_47 (fp.sub RNE cat_50 (fp #b0 #b10000111 #b01101000000000000000000))) (spoon_1 (fp.sub RNE cat_50 (fp #b0 #b10000111 #b01101000000000000000000))))))
(assert (=> (fp.leq (fp #b0 #b10000111 #b01101000000000000000000) cat_50) (= cat_51 cat_50)))
(assert (=> (fp.leq (fp #b0 #b10000111 #b01101000000000000000000) cat_50) (= cat_52 cat_47)))
(assert (=> (not (fp.leq (fp #b0 #b10000111 #b01101000000000000000000) cat_50)) (=> (fp.lt cat_50 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_48 (fp.add RNE cat_50 (fp #b0 #b10000111 #b01101000000000000000000))) (spoon_1 (fp.add RNE cat_50 (fp #b0 #b10000111 #b01101000000000000000000)))))))
(assert (=> (not (fp.leq (fp #b0 #b10000111 #b01101000000000000000000) cat_50)) (=> (fp.lt cat_50 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_53 cat_50))))
(assert (=> (not (fp.leq (fp #b0 #b10000111 #b01101000000000000000000) cat_50)) (=> (fp.lt cat_50 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_54 cat_48))))
(assert (=> (not (fp.leq (fp #b0 #b10000111 #b01101000000000000000000) cat_50)) (=> (not (fp.lt cat_50 (fp #b0 #b00000000 #b00000000000000000000000))) (= cat_54 cat_50))))
(assert (=> (not (fp.leq (fp #b0 #b10000111 #b01101000000000000000000) cat_50)) (= cat_52 cat_54)))
(assert (not (spoon_25 cat_52)))
(check-sat)
(exit)
