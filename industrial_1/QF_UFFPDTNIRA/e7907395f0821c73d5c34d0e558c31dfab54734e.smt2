...
(assert (= cat_45 cat_44))
(assert (= cat_46 (fp.add RNE cat_31 cat_33)))
(assert (not (fp.leq (fp #b0 #b10000111 #b01101000000000000000000) cat_46)))
(assert (fp.lt cat_46 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (not (spoon_35 (fp.add RNE cat_46 (fp #b0 #b10000111 #b01101000000000000000000)))))
(check-sat)
(exit)
