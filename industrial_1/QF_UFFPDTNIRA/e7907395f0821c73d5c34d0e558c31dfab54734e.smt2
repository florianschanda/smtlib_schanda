...
(assert (not (fp.leq (fp #b0 #b10000111 #b01101000000000000000000) cat_51)))
(assert (fp.lt cat_51 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (not (spoon_37 (fp.add RNE cat_51 (fp #b0 #b10000111 #b01101000000000000000000)))))
(check-sat)
(exit)
