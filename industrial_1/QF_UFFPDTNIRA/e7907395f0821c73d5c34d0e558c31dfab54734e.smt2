...
(assert (= cat_48 (fp.add RNE cat_33 cat_35)))
(assert (not (fp.leq (fp #b0 #b10000111 #b01101000000000000000000) cat_48)))
(assert (fp.lt cat_48 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (not (spoon_37 (fp.add RNE cat_48 (fp #b0 #b10000111 #b01101000000000000000000)))))
(check-sat)
(exit)
