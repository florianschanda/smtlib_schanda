...
(define-fun spoon_35 ((kitten_30 Float32)) Bool (and (spoon_1 kitten_30) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_30) (fp.leq kitten_30 (fp #b0 #b10001000 #b01101000000000000000000)))))
...
(define-fun spoon_42 ((kitten_32 Float32) (kitten_33 Bool) (kitten_34 Bool) (kitten_35 Bool) (kitten_36 Bool)) Bool (=> (or (= kitten_33 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001000 #b01101000000000000000000))) (spoon_35 kitten_32)))
...
(assert (= cat_47 (fp.add RNE cat_31 cat_33)))
(assert (=> (fp.leq (fp #b0 #b10000111 #b01101000000000000000000) cat_47) (and (= cat_45 (fp.sub RNE cat_47 (fp #b0 #b10000111 #b01101000000000000000000))) (spoon_1 (fp.sub RNE cat_47 (fp #b0 #b10000111 #b01101000000000000000000))))))
(assert (=> (fp.leq (fp #b0 #b10000111 #b01101000000000000000000) cat_47) (= cat_48 cat_47)))
(assert (=> (fp.leq (fp #b0 #b10000111 #b01101000000000000000000) cat_47) (= cat_49 cat_45)))
(assert (=> (not (fp.leq (fp #b0 #b10000111 #b01101000000000000000000) cat_47)) (=> (fp.lt cat_47 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_46 (fp.add RNE cat_47 (fp #b0 #b10000111 #b01101000000000000000000))) (spoon_1 (fp.add RNE cat_47 (fp #b0 #b10000111 #b01101000000000000000000)))))))
(assert (=> (not (fp.leq (fp #b0 #b10000111 #b01101000000000000000000) cat_47)) (=> (fp.lt cat_47 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_50 cat_47))))
(assert (=> (not (fp.leq (fp #b0 #b10000111 #b01101000000000000000000) cat_47)) (=> (fp.lt cat_47 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_51 cat_46))))
(assert (=> (not (fp.leq (fp #b0 #b10000111 #b01101000000000000000000) cat_47)) (=> (not (fp.lt cat_47 (fp #b0 #b00000000 #b00000000000000000000000))) (= cat_51 cat_47))))
(assert (=> (not (fp.leq (fp #b0 #b10000111 #b01101000000000000000000) cat_47)) (= cat_49 cat_51)))
