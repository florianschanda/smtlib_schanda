...
(define-fun spoon_30 ((kitten_27 Float32)) Bool (and (spoon_1 kitten_27) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_27) (fp.leq kitten_27 (fp #b0 #b11111110 #b11111111111111111111111)))))
...
(define-fun spoon_37 ((kitten_29 Float32) (kitten_30 Bool) (kitten_31 Bool) (kitten_32 Bool)) Bool (=> (or (= kitten_30 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b11111110 #b11111111111111111111111))) (spoon_30 kitten_29)))
(declare-sort potato_15 0)
(define-fun spoon_38 ((kitten_33 Float32)) Bool (and (spoon_1 kitten_33) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_33) (fp.leq kitten_33 (fp #b0 #b10111111 #b00000000000000000110000)))))
(declare-fun spoon_39 (potato_15 potato_15) Bool)
(declare-fun spoon_40 (Float32) potato_5)
(declare-fun spoon_41 (potato_5) Bool)
(declare-fun spoon_42 (potato_5) Float32)
(declare-const cat_43 potato_15)
(declare-datatypes () ((potato_16 (mk_potato_16 (get_potato_16_a potato_15)))))
(define-fun spoon_44 ((kitten_34 potato_16)) potato_15 (get_potato_16_a kitten_34))
(declare-const cat_45 Float32)
(declare-const cat_46 Int)
(declare-const cat_47 Int)
(define-fun spoon_48 ((kitten_35 Float32) (kitten_36 Bool) (kitten_37 Bool) (kitten_38 Bool)) Bool (=> (or (= kitten_36 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10111111 #b00000000000000000110000))) (spoon_38 kitten_35)))
(declare-const cat_49 Float32)
(declare-const cat_50 Float32)
(declare-const cat_51 Float32)
(assert (spoon_30 cat_45))
(assert (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)) (spoon_1 cat_49)))
(assert (= cat_50 cat_49))
(assert (= cat_51 (fp.sqrt RNE cat_45)))
(assert (not (spoon_38 cat_51)))
(check-sat)
(exit)
