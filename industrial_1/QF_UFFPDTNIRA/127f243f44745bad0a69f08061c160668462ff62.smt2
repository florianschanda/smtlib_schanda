...
(define-fun spoon_32 ((kitten_28 Float32)) Bool (and (spoon_1 kitten_28) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_28) (fp.leq kitten_28 (fp #b0 #b11111110 #b11111111111111111111111)))))
...
(define-fun spoon_39 ((kitten_30 Float32) (kitten_31 Bool) (kitten_32 Bool) (kitten_33 Bool)) Bool (=> (or (= kitten_31 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b11111110 #b11111111111111111111111))) (spoon_32 kitten_30)))
(declare-sort potato_15 0)
(define-fun spoon_40 ((kitten_34 Float32)) Bool (and (spoon_1 kitten_34) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_34) (fp.leq kitten_34 (fp #b0 #b10111111 #b00000000000000000110000)))))
...
(define-fun spoon_46 ((kitten_35 potato_16)) potato_15 (get_potato_16_a kitten_35))
(declare-const cat_47 Float32)
(declare-const cat_48 Int)
(declare-const cat_49 Int)
(define-fun spoon_50 ((kitten_36 Float32) (kitten_37 Bool) (kitten_38 Bool) (kitten_39 Bool)) Bool (=> (or (= kitten_37 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10111111 #b00000000000000000110000))) (spoon_40 kitten_36)))
