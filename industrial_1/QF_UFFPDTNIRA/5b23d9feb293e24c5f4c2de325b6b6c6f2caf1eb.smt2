...
(assert (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) (fp.add RNE cat_31 cat_33)))
(assert (not (spoon_23 (fp.sub RNE (fp.add RNE cat_31 cat_33) (fp #b0 #b10000111 #b01101000000000000000000)))))
(check-sat)
(exit)
