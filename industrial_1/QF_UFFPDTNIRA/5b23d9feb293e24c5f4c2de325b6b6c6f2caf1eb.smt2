...
(assert (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) (fp.add RNE cat_33 cat_35)))
(assert (not (spoon_25 (fp.sub RNE (fp.add RNE cat_33 cat_35) (fp #b0 #b10000111 #b01101000000000000000000)))))
(check-sat)
(exit)
