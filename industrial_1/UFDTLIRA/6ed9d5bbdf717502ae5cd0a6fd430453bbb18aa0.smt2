...
(assert (forall ((kitten_5 potato_10)) (and (<= 0 (spoon_7 kitten_5)) (<= (spoon_7 kitten_5) 9007199254740991))))
...
(assert (forall ((kitten_13 potato_12)) (and (<= 0 (spoon_16 kitten_13)) (<= (spoon_16 kitten_13) 9007199254740991))))
