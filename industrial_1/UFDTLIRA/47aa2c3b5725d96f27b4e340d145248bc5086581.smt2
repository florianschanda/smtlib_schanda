...
(define-fun spoon_23 ((kitten_11 Int) (kitten_12 Bool) (kitten_13 Bool) (kitten_14 Bool) (kitten_15 Bool)) Bool (=> (or (= kitten_12 true) (<= 0 150000)) (spoon_16 kitten_11)))
(declare-sort potato_14 0)
(declare-fun spoon_24 (potato_14) Int)
(assert (forall ((kitten_16 potato_14)) (let ((_let_0 (spoon_24 kitten_16))) (and (<= 0 _let_0) (<= _let_0 500000))) ))
(define-fun spoon_25 ((kitten_17 Int)) Bool (and (<= 0 kitten_17) (<= kitten_17 500000)))
...
(declare-fun cat_30 () potato_14)
(declare-datatypes ((potato_15 0)) (((mk_potato_15 (get_potato_15_a potato_14)))))

(define-fun spoon_31 ((kitten_18 potato_15)) potato_14 (get_potato_15_a kitten_18))
(declare-fun cat_32 () Int)
(declare-fun cat_33 () Int)
(declare-fun cat_34 () Int)
(declare-fun cat_35 () Int)
(define-fun spoon_36 ((kitten_19 Int) (kitten_20 Bool) (kitten_21 Bool) (kitten_22 Bool) (kitten_23 Bool)) Bool (=> (or (= kitten_20 true) (<= 0 500000)) (spoon_25 kitten_19)))
(declare-fun cat_37 () Int)
(assert (spoon_16 cat_32))
(assert (spoon_16 cat_34))
(assert (= cat_37 (abs (- cat_32 cat_34))))
(assert (spoon_8 (abs (- cat_32 cat_34))))
(assert (not (spoon_25 cat_37)))
(check-sat)
(exit)
