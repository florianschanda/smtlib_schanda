...
(assert (and (= cat_90 (fp.div RNE (fp.sub RNE cat_124 (spoon_44 (get_potato_15_b (get_potato_17_a cat_62)))) cat_110)) (spoon_1 (fp.div RNE (fp.sub RNE cat_124 (spoon_44 (get_potato_15_b (get_potato_17_a cat_62)))) cat_110))))
(assert (= cat_91 (fp.add RNE cat_90 (spoon_44 (get_potato_15_a (get_potato_17_a cat_62))))))
(assert (not (spoon_1 cat_91)))
(check-sat)
(exit)
