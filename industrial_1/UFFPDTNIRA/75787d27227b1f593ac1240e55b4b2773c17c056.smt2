...
(assert (and (= cat_230 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_257)) (spoon_3 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_257))))
...
(assert (and (= cat_241 (fp.mul RNE cat_263 ((_ to_fp 11 53) RNE cat_183))) (spoon_3 (fp.mul RNE cat_263 ((_ to_fp 11 53) RNE cat_183)))))
(assert (= cat_242 (fp.mul RNE cat_241 cat_269)))
(assert (and (= cat_243 cat_242) (spoon_3 cat_242)))
(assert (and (= cat_237 (fp.sub RNE cat_265 cat_259)) (spoon_3 (fp.sub RNE cat_265 cat_259))))
...
(assert (and (= cat_247 (fp.add RNE cat_265 cat_259)) (spoon_3 (fp.add RNE cat_265 cat_259))))
...
(assert (not (spoon_3 (fp.div RNE cat_271 cat_273))))
(check-sat)
(exit)
