...
(declare-const cat_250 potato_19)
(declare-const cat_251 potato_18)
...
(assert (= cat_250 (mk_potato_19 (mk_potato_18 cat_201 cat_202))))
(assert (= cat_251 (get_potato_20_a cat_85)))
(assert (= cat_252 (mk_potato_11 cat_206)))
(assert (= cat_253 (fp.mul RNE cat_181 cat_181)))
(assert (and (= cat_224 ((_ to_fp 11 53) RNE (fp.mul RNE cat_177 cat_177))) (spoon_2 ((_ to_fp 11 53) RNE (fp.mul RNE cat_177 cat_177)))))
(assert (= cat_254 (mk_potato_11 cat_204)))
(assert (= cat_255 cat_224))
(assert (and (= cat_225 ((_ to_fp 11 53) RNE (fp.mul RNE cat_179 cat_179))) (spoon_2 ((_ to_fp 11 53) RNE (fp.mul RNE cat_179 cat_179)))))
(assert (= cat_256 (mk_potato_11 cat_205)))
(assert (= cat_257 cat_225))
(assert (= cat_258 (mk_potato_11 cat_207)))
(assert (= cat_259 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_181)))
(assert (and (= cat_226 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_253)) (spoon_2 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_253))))
(assert (= cat_260 (mk_potato_11 cat_208)))
(assert (= cat_261 cat_226))
...
(assert (= cat_264 (mk_potato_11 cat_210)))
(assert (= cat_265 cat_232))
(assert (and (= cat_237 (fp.mul RNE cat_259 ((_ to_fp 11 53) RNE cat_179))) (spoon_2 (fp.mul RNE cat_259 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_238 (fp.mul RNE cat_237 cat_265)))
(assert (and (= cat_239 cat_238) (spoon_2 cat_238)))
(assert (and (= cat_233 (fp.sub RNE cat_261 cat_255)) (spoon_2 (fp.sub RNE cat_261 cat_255))))
(assert (= cat_234 (fp.sub RNE cat_233 cat_257)))
(assert (and (= cat_235 cat_234) (spoon_2 cat_234)))
(assert (= cat_236 (fp.mul RNE cat_235 cat_263)))
...
(assert (= cat_267 cat_242))
(assert (and (= cat_243 (fp.add RNE cat_261 cat_255)) (spoon_2 (fp.add RNE cat_261 cat_255))))
(assert (= cat_244 (fp.add RNE cat_243 cat_257)))
(assert (and (= cat_245 cat_244) (spoon_2 cat_244)))
(assert (= cat_268 (mk_potato_11 cat_214)))
(assert (= cat_269 cat_245))
(assert (not (spoon_2 (fp.div RNE cat_267 cat_269))))
(check-sat)
(exit)
