...
(declare-const cat_297 potato_7)
(declare-const cat_298 Bool)
...
(declare-const cat_305 potato_10)
(declare-const cat_306 Float32)
(declare-const cat_307 potato_7)
(declare-const cat_308 Bool)
(declare-const cat_309 potato_10)
(declare-const cat_310 Float32)
(declare-const cat_311 potato_10)
(declare-const cat_312 Float32)
...
(assert (= cat_282 (mk_potato_7 cat_207)))
(assert (= cat_283 (spoon_41 1)))
(assert (= cat_284 (mk_potato_25 (mk_potato_24 cat_205 cat_206))))
(assert (= cat_285 (get_potato_26_a cat_115)))
(assert (= cat_229 (spoon_117 cat_171 cat_78)))
(assert (= cat_286 (ite (not (= cat_229 true)) true false)))
(assert (= cat_286 true))
(assert (=> (= cat_287 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_288))) (and (= cat_230 (spoon_153 (fp #b0 #b10000101 #b01100111111101011101000))) (spoon_133 cat_230)))))
(assert (=> (= cat_287 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_288))) (= cat_289 (mk_potato_10 cat_281)))))
(assert (=> (= cat_287 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_288))) (= cat_290 cat_230))))
(assert (=> (= cat_287 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_288)))) (=> (fp.lt (spoon_88 (get_potato_24_a cat_288)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (and (= cat_231 (spoon_153 (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (spoon_133 cat_231))))))
(assert (=> (= cat_287 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_288)))) (=> (fp.lt (spoon_88 (get_potato_24_a cat_288)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_291 (mk_potato_10 cat_281))))))
(assert (=> (= cat_287 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_288)))) (=> (fp.lt (spoon_88 (get_potato_24_a cat_288)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_292 cat_231)))))
(assert (=> (= cat_287 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_288)))) (=> (not (fp.lt (spoon_88 (get_potato_24_a cat_288)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_232 (spoon_88 (get_potato_24_a cat_288))) (spoon_1 (spoon_88 (get_potato_24_a cat_288))))))))
(assert (=> (= cat_287 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_288)))) (=> (not (fp.lt (spoon_88 (get_potato_24_a cat_288)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_233 (spoon_153 cat_232)) (spoon_133 cat_233))))))
(assert (=> (= cat_287 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_288)))) (=> (not (fp.lt (spoon_88 (get_potato_24_a cat_288)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_293 (mk_potato_10 cat_281))))))
(assert (=> (= cat_287 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_288)))) (=> (not (fp.lt (spoon_88 (get_potato_24_a cat_288)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_294 cat_233)))))
(assert (=> (= cat_287 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_288)))) (=> (not (fp.lt (spoon_88 (get_potato_24_a cat_288)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_292 cat_294)))))
(assert (=> (= cat_287 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_288)))) (= cat_290 cat_292))))
(assert (=> (= cat_287 true) (=> (spoon_193 cat_179) (and (= cat_234 (fp.mul RNE cat_179 cat_179)) (spoon_1 (fp.mul RNE cat_179 cat_179))))))
(assert (=> (= cat_287 true) (=> (spoon_193 cat_179) (= cat_295 (mk_potato_10 cat_279)))))
(assert (=> (= cat_287 true) (=> (spoon_193 cat_179) (= cat_296 cat_234))))
(assert (=> (= cat_287 true) (=> (spoon_193 cat_179) (= cat_298 cat_287))))
(assert (=> (= cat_287 true) (=> (not (spoon_193 cat_179)) (= cat_297 (mk_potato_7 cat_287)))))
(assert (=> (= cat_287 true) (=> (not (spoon_193 cat_179)) (= cat_298 (spoon_41 0)))))
(assert (=> (= cat_287 true) (=> (not (spoon_193 cat_179)) (= cat_296 cat_279))))
(assert (=> (= cat_287 true) (= cat_299 (mk_potato_10 cat_273))))
(assert (=> (= cat_287 true) (= cat_300 ((_ to_fp 8 24) RNE (fp.sub RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) (fp.mul RNE cat_175 cat_175))))))
(assert (=> (= cat_287 true) (and (= cat_235 cat_300) (spoon_1 cat_300))))
(assert (=> (= cat_287 true) (and (= cat_236 (spoon_150 cat_235)) (spoon_142 cat_236))))
(assert (=> (= cat_287 true) (= cat_301 (mk_potato_10 cat_271))))
(assert (=> (= cat_287 true) (= cat_302 cat_236)))
(assert (=> (not (= cat_287 true)) (= cat_290 cat_281)))
(assert (=> (not (= cat_287 true)) (= cat_296 cat_279)))
(assert (=> (not (= cat_287 true)) (= cat_300 cat_273)))
(assert (=> (not (= cat_287 true)) (= cat_302 cat_271)))
(assert (=> (not (= cat_287 true)) (= cat_298 cat_287)))
(assert (=> (= cat_298 true) (and (= cat_237 (fp.sub RNE cat_300 cat_296)) (spoon_1 (fp.sub RNE cat_300 cat_296)))))
(assert (=> (= cat_298 true) (= cat_238 (fp.add RNE cat_237 (fp.mul RNE cat_290 cat_290)))))
(assert (=> (= cat_298 true) (and (= cat_239 cat_238) (spoon_1 cat_238))))
(assert (=> (= cat_298 true) (= cat_303 (mk_potato_10 cat_277))))
(assert (=> (= cat_298 true) (= cat_304 cat_239)))
(assert (=> (= cat_298 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_304) (and (= cat_240 cat_304) (spoon_1 cat_304)))))
(assert (=> (= cat_298 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_304) (and (= cat_241 (spoon_150 cat_240)) (spoon_142 cat_241)))))
(assert (=> (= cat_298 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_304) (= cat_305 (mk_potato_10 cat_275)))))
(assert (=> (= cat_298 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_304) (= cat_306 cat_241))))
(assert (=> (= cat_298 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_304) (= cat_308 cat_298))))
(assert (=> (= cat_298 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_304)) (= cat_307 (mk_potato_7 cat_298)))))
(assert (=> (= cat_298 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_304)) (= cat_308 (spoon_41 0)))))
(assert (=> (= cat_298 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_304)) (= cat_306 cat_275))))
(assert (=> (not (= cat_298 true)) (= cat_304 cat_277)))
(assert (=> (not (= cat_298 true)) (= cat_306 cat_275)))
(assert (=> (not (= cat_298 true)) (= cat_308 cat_298)))
(assert (= cat_308 true))
(assert (and (= cat_246 (fp.mul RNE cat_306 cat_179)) (spoon_1 (fp.mul RNE cat_306 cat_179))))
(assert (and (= cat_242 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_175 cat_175)) cat_296)) (spoon_1 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_175 cat_175)) cat_296))))
(assert (= cat_243 (fp.mul RNE cat_302 cat_242)))
(assert (and (= cat_244 cat_243) (spoon_1 cat_243)))
(assert (= cat_245 (fp.mul RNE cat_244 cat_290)))
...
(assert (= cat_309 (mk_potato_10 cat_215)))
(assert (= cat_310 cat_249))
(assert (and (= cat_250 (fp.mul RNE cat_306 cat_179)) (spoon_1 (fp.mul RNE cat_306 cat_179))))
(assert (= cat_251 (fp.mul RNE cat_250 cat_290)))
(assert (and (= cat_252 cat_251) (spoon_1 cat_251)))
(assert (and (= cat_253 (fp.mul RNE cat_302 cat_304)) (spoon_1 (fp.mul RNE cat_302 cat_304))))
(assert (= cat_254 (fp.sub RNE cat_253 cat_252)))
(assert (and (= cat_255 cat_254) (spoon_1 cat_254)))
(assert (= cat_311 (mk_potato_10 cat_216)))
(assert (= cat_312 cat_255))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_312) (and (= cat_264 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_312)) (spoon_1 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_312)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_312) (and (= cat_265 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_310)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_310)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_312) (= cat_266 (ite (fp.leq cat_265 cat_264) true false))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_312) (and (= cat_262 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_310)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_310)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_312) (and (= cat_263 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_312)) (spoon_1 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_312)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_312) (= cat_267 (ite (fp.leq cat_263 cat_262) true false))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_312) (= cat_314 (ite (= cat_267 true) cat_266 false))))
(assert (=> (not (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_312)) (= cat_314 false)))
(assert (=> (= cat_314 true) (= cat_313 true)))
(assert (=> (not (= cat_314 true)) (=> (fp.lt cat_312 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_258 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_312)) (spoon_1 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_312))))))
(assert (=> (not (= cat_314 true)) (=> (fp.lt cat_312 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_259 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_310)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_310))))))
(assert (=> (not (= cat_314 true)) (=> (fp.lt cat_312 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_260 (ite (fp.leq cat_259 cat_258) true false)))))
(assert (=> (not (= cat_314 true)) (=> (fp.lt cat_312 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_256 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_310)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_310))))))
(assert (=> (not (= cat_314 true)) (=> (fp.lt cat_312 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_257 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_312)) (spoon_1 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_312))))))
(assert (=> (not (= cat_314 true)) (=> (fp.lt cat_312 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_261 (ite (fp.leq cat_257 cat_256) true false)))))
(assert (=> (not (= cat_314 true)) (=> (fp.lt cat_312 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_313 (ite (= cat_261 true) cat_260 false)))))
(assert (=> (not (= cat_314 true)) (=> (not (fp.lt cat_312 (fp #b0 #b00000000 #b00000000000000000000000))) (= cat_313 false))))
(assert (= cat_313 true))
(assert (and (= cat_268 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_310)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_310))))
(assert (= cat_269 (fp.div RNE cat_268 cat_312)))
(assert (not (spoon_1 cat_269)))
(check-sat)
(exit)
