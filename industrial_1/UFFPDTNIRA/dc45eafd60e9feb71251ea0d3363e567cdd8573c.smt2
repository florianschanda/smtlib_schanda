...
(declare-fun cat_227 () potato_7)
(declare-fun cat_228 () Bool)
(declare-fun cat_229 () potato_29)
(declare-fun cat_230 () potato_28)
...
(assert (= cat_228 (distinct 1 0)))
(assert (= cat_229 (mk_potato_29 (mk_potato_28 cat_201 cat_202))))
(assert (= cat_230 (get_potato_30_a cat_138)))
(assert (= cat_231 (mk_potato_11 cat_206)))
(assert (= cat_232 (fp.mul roundNearestTiesToEven cat_181 cat_181)))
...
(assert (not (spoon_161 ((_ to_fp 11 53) roundNearestTiesToEven (fp.mul roundNearestTiesToEven cat_179 cat_179)))))
(check-sat)
(exit)
