...
(declare-const cat_123 potato_21)
...
(assert (= cat_119 (fp.div RNE (spoon_75 cat_113) cat_114)))
(assert (spoon_1 (fp.div RNE (spoon_75 cat_113) cat_114)))
(assert (= cat_120 (fp.mul RNE cat_119 cat_115)))
(assert (= cat_121 cat_120))
(assert (spoon_1 cat_120))
(assert (= cat_122 cat_121))
(assert (= (spoon_75 cat_123) cat_122))
(assert (spoon_1 cat_121))
(assert (= cat_116 (fp.div RNE (spoon_75 cat_112) cat_114)))
(assert (spoon_1 (fp.div RNE (spoon_75 cat_112) cat_114)))
(assert (= cat_117 (fp.mul RNE cat_116 cat_115)))
(assert (= cat_118 cat_117))
(assert (spoon_1 cat_117))
(assert (not (spoon_68 cat_118)))
(check-sat)
(exit)
