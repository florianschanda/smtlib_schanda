...
(assert (and (= cat_230 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_256)) (spoon_2 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_256))))
...
(assert (and (= cat_241 (fp.mul RNE cat_262 ((_ to_fp 11 53) RNE cat_183))) (spoon_2 (fp.mul RNE cat_262 ((_ to_fp 11 53) RNE cat_183)))))
(assert (= cat_242 (fp.mul RNE cat_241 cat_268)))
(assert (and (= cat_243 cat_242) (spoon_2 cat_242)))
(assert (and (= cat_237 (fp.sub RNE cat_264 cat_258)) (spoon_2 (fp.sub RNE cat_264 cat_258))))
...
(assert (and (= cat_247 (fp.add RNE cat_264 cat_258)) (spoon_2 (fp.add RNE cat_264 cat_258))))
(assert (= cat_248 (fp.add RNE cat_247 cat_260)))
(assert (not (spoon_2 cat_248)))
(check-sat)
(exit)
