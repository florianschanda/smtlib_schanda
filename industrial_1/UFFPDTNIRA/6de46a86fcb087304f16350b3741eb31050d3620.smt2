...
(declare-const cat_249 potato_19)
(declare-const cat_250 potato_18)
...
(assert (= cat_248 (spoon_37 1)))
(assert (= cat_249 (mk_potato_19 (mk_potato_18 cat_201 cat_202))))
(assert (= cat_250 (get_potato_20_a cat_85)))
...
(assert (and (= cat_226 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_252)) (spoon_2 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_252))))
...
(assert (and (= cat_237 (fp.mul RNE cat_258 ((_ to_fp 11 53) RNE cat_179))) (spoon_2 (fp.mul RNE cat_258 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_238 (fp.mul RNE cat_237 cat_264)))
(assert (and (= cat_239 cat_238) (spoon_2 cat_238)))
(assert (and (= cat_233 (fp.sub RNE cat_260 cat_254)) (spoon_2 (fp.sub RNE cat_260 cat_254))))
...
(assert (and (= cat_243 (fp.add RNE cat_260 cat_254)) (spoon_2 (fp.add RNE cat_260 cat_254))))
(assert (= cat_244 (fp.add RNE cat_243 cat_256)))
(assert (not (spoon_2 cat_244)))
(check-sat)
(exit)
