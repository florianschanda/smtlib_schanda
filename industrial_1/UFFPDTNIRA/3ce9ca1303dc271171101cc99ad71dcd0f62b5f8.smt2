...
(assert (and (= cat_230 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_263)) (spoon_3 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_263))))
...
(assert (and (= cat_241 (fp.mul RNE cat_269 ((_ to_fp 11 53) RNE cat_183))) (spoon_3 (fp.mul RNE cat_269 ((_ to_fp 11 53) RNE cat_183)))))
(assert (= cat_242 (fp.mul RNE cat_241 cat_275)))
(assert (and (= cat_243 cat_242) (spoon_3 cat_242)))
(assert (and (= cat_237 (fp.sub RNE cat_271 cat_265)) (spoon_3 (fp.sub RNE cat_271 cat_265))))
...
(assert (and (= cat_247 (fp.add RNE cat_271 cat_265)) (spoon_3 (fp.add RNE cat_271 cat_265))))
...
(assert (and (= cat_250 (fp.div RNE cat_277 cat_279)) (spoon_3 (fp.div RNE cat_277 cat_279))))
...
(assert (=> (not (fp.lt cat_281 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_281)) (and (= cat_251 cat_281) (spoon_3 cat_281)))))
...
(assert (and (= cat_252 (fp.mul RNE cat_269 ((_ to_fp 11 53) RNE cat_181))) (spoon_3 (fp.mul RNE cat_269 ((_ to_fp 11 53) RNE cat_181)))))
(assert (= cat_288 (mk_potato_11 cat_220)))
(assert (= cat_289 cat_252))
(assert (and (= cat_253 (fp.mul RNE cat_269 ((_ to_fp 11 53) RNE cat_183))) (spoon_3 (fp.mul RNE cat_269 ((_ to_fp 11 53) RNE cat_183)))))
(assert (= cat_254 (fp.mul RNE cat_253 cat_273)))
(assert (and (= cat_255 cat_254) (spoon_3 cat_254)))
(assert (not (spoon_3 (fp.sub RNE cat_271 cat_265))))
(check-sat)
(exit)
