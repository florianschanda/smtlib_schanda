...
(assert (= cat_255 (spoon_37 1)))
(assert (= cat_256 (mk_potato_19 (mk_potato_18 cat_201 cat_202))))
(assert (= cat_257 (get_potato_20_a cat_85)))
...
(assert (and (= cat_226 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_259)) (spoon_2 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_259))))
...
(assert (and (= cat_237 (fp.mul RNE cat_265 ((_ to_fp 11 53) RNE cat_179))) (spoon_2 (fp.mul RNE cat_265 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_238 (fp.mul RNE cat_237 cat_271)))
(assert (and (= cat_239 cat_238) (spoon_2 cat_238)))
(assert (and (= cat_233 (fp.sub RNE cat_267 cat_261)) (spoon_2 (fp.sub RNE cat_267 cat_261))))
...
(assert (and (= cat_243 (fp.add RNE cat_267 cat_261)) (spoon_2 (fp.add RNE cat_267 cat_261))))
...
(assert (and (= cat_246 (fp.div RNE cat_273 cat_275)) (spoon_2 (fp.div RNE cat_273 cat_275))))
...
(assert (=> (not (fp.lt cat_277 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_277)) (and (= cat_247 cat_277) (spoon_2 cat_277)))))
...
(assert (and (= cat_248 (fp.mul RNE cat_265 ((_ to_fp 11 53) RNE cat_177))) (spoon_2 (fp.mul RNE cat_265 ((_ to_fp 11 53) RNE cat_177)))))
(assert (= cat_284 (mk_potato_11 cat_216)))
(assert (= cat_285 cat_248))
(assert (and (= cat_249 (fp.mul RNE cat_265 ((_ to_fp 11 53) RNE cat_179))) (spoon_2 (fp.mul RNE cat_265 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_250 (fp.mul RNE cat_249 cat_269)))
(assert (and (= cat_251 cat_250) (spoon_2 cat_250)))
(assert (not (spoon_2 (fp.sub RNE cat_267 cat_261))))
(check-sat)
(exit)
