...
(assert (forall ((kitten_29 Float32) (kitten_30 Float32)) (! (=> (and (and (spoon_29 kitten_29 true true true true) (spoon_29 kitten_30 true true true true)) (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) kitten_30)) (let ((kitten_31 (spoon_30 kitten_29 kitten_30))) (and (and (and (fp.leq (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)) kitten_31) (fp.leq kitten_31 (fp #b0 #b01111111 #b00000000000000000000000))) (=> (fp.eq kitten_29 (fp #b0 #b00000000 #b00000000000000000000000)) (fp.eq kitten_31 (fp #b0 #b01111111 #b00000000000000000000000)))) (spoon_29 kitten_31 true false true true)))) :pattern ((spoon_30 kitten_29 kitten_30)))))
...
(assert (fp.leq (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)) cat_52))
(assert (fp.leq cat_52 (fp #b0 #b01111111 #b00000000000000000000000)))
(assert (=> (fp.eq cat_47 (fp #b0 #b00000000 #b00000000000000000000000)) (fp.eq cat_52 (fp #b0 #b01111111 #b00000000000000000000000))))
