...
(assert (forall ((kitten_29 (_ FloatingPoint 8 24)) (kitten_30 (_ FloatingPoint 8 24))) (! (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (spoon_30 kitten_29 kitten_30))) (let ((_let_2 (fp (_ bv0 1) (_ bv127 8) (_ bv0 23)))) (=> (and (and (spoon_29 kitten_29 true true true true) (spoon_29 kitten_30 true true true true)) (fp.lt _let_0 kitten_30)) (and (and (and (fp.leq (fp.neg _let_2) _let_1) (fp.leq _let_1 _let_2)) (=> (fp.eq kitten_29 _let_0) (fp.eq _let_1 _let_2))) (spoon_29 _let_1 true false true true)))))) :pattern ((spoon_30 kitten_29 kitten_30)))))
(declare-sort potato_13 0)
(define-fun spoon_32 ((kitten_32 (_ FloatingPoint 8 24))) Bool (and (spoon_1 kitten_32) (and (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) kitten_32) (fp.leq kitten_32 (fp (_ bv0 1) (_ bv135 8) (_ bv3407872 23))))))
...
(define-fun spoon_39 ((kitten_34 (_ FloatingPoint 8 24)) (kitten_35 Bool) (kitten_36 Bool) (kitten_37 Bool) (kitten_38 Bool)) Bool (=> (or (= kitten_35 true) (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) (fp (_ bv0 1) (_ bv135 8) (_ bv3407872 23)))) (spoon_32 kitten_34)))
(declare-sort potato_15 0)
(define-fun spoon_40 ((kitten_39 (_ FloatingPoint 8 24))) Bool (let ((_let_0 (fp (_ bv0 1) (_ bv127 8) (_ bv0 23)))) (and (spoon_1 kitten_39) (and (fp.leq (fp.neg _let_0) kitten_39) (fp.leq kitten_39 _let_0)))))
...
(define-fun spoon_50 ((kitten_41 (_ FloatingPoint 8 24)) (kitten_42 Bool) (kitten_43 Bool) (kitten_44 Bool) (kitten_45 Bool)) Bool (let ((_let_0 (fp (_ bv0 1) (_ bv127 8) (_ bv0 23)))) (=> (or (= kitten_42 true) (fp.leq (fp.neg _let_0) _let_0)) (spoon_40 kitten_41))))
...
(assert (fp.leq (fp.neg (fp (_ bv0 1) (_ bv127 8) (_ bv0 23))) cat_52))
(assert (fp.leq cat_52 (fp (_ bv0 1) (_ bv127 8) (_ bv0 23))))
(assert (=> (fp.eq cat_47 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))) (fp.eq cat_52 (fp (_ bv0 1) (_ bv127 8) (_ bv0 23)))))
