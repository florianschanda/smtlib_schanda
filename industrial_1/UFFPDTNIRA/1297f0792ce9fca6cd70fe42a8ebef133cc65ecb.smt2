...
(define-fun spoon_52 ((kitten_37 Float32)) Bool (and (spoon_1 kitten_37) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_37) (fp.leq kitten_37 (fp #b0 #b10001100 #b01101010100000000000000)))))
...
(define-fun spoon_59 ((kitten_39 Float32) (kitten_40 Bool) (kitten_41 Bool) (kitten_42 Bool) (kitten_43 Bool)) Bool (=> (or (= kitten_40 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000))) (spoon_52 kitten_39)))
...
(define-fun spoon_60 ((kitten_46 Float32)) Bool (and (spoon_1 kitten_46) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_46) (fp.leq kitten_46 (fp #b0 #b10001001 #b01110111000000000000000)))))
...
(assert (forall ((kitten_50 Float32)) (! (=> (spoon_60 kitten_50) (= (spoon_67 (spoon_68 kitten_50)) kitten_50)) :pattern ((spoon_67 (spoon_68 kitten_50))))))
...
(define-fun spoon_73 ((kitten_55 potato_23) (kitten_56 potato_23)) Bool (ite (and (= (spoon_36 (get_potato_21_a (get_potato_23_a kitten_55)) (get_potato_21_a (get_potato_23_a kitten_56))) true) (= (spoon_67 (get_potato_21_b (get_potato_23_a kitten_55))) (spoon_67 (get_potato_21_b (get_potato_23_a kitten_56))))) true false))
...
(define-fun spoon_92 ((kitten_60 Float32) (kitten_61 Bool) (kitten_62 Bool) (kitten_63 Bool) (kitten_64 Bool)) Bool (=> (or (= kitten_61 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_23 kitten_60)))
(define-fun spoon_93 ((kitten_65 Float32) (kitten_66 Bool) (kitten_67 Bool) (kitten_68 Bool) (kitten_69 Bool)) Bool (=> (or (= kitten_66 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001001 #b01110111000000000000000))) (spoon_60 kitten_65)))
(declare-const cat_94 Float32)
(declare-const cat_95 Float32)
(declare-const cat_96 Float32)
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000)) (spoon_52 cat_94)))
...
(assert (fp.lt (fp.add RNE (spoon_67 (get_potato_21_b (get_potato_23_a cat_87))) (spoon_67 (get_potato_21_b (get_potato_23_a cat_89)))) cat_96))
(assert (not (spoon_52 (fp.sub RNE cat_96 (fp.add RNE (spoon_67 (get_potato_21_b (get_potato_23_a cat_87))) (spoon_67 (get_potato_21_b (get_potato_23_a cat_89))))))))
(check-sat)
(exit)
