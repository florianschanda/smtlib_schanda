...
(define-fun spoon_52 ((kitten_37 (_ FloatingPoint 8 24))) Bool (and (spoon_1 kitten_37) (and (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) kitten_37) (fp.leq kitten_37 (fp (_ bv0 1) (_ bv140 8) (_ bv3489792 23))))))
...
(define-fun spoon_59 ((kitten_39 (_ FloatingPoint 8 24)) (kitten_40 Bool) (kitten_41 Bool) (kitten_42 Bool) (kitten_43 Bool)) Bool (=> (or (= kitten_40 true) (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) (fp (_ bv0 1) (_ bv140 8) (_ bv3489792 23)))) (spoon_52 kitten_39)))
...
(define-fun spoon_60 ((kitten_46 (_ FloatingPoint 8 24))) Bool (and (spoon_1 kitten_46) (and (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) kitten_46) (fp.leq kitten_46 (fp (_ bv0 1) (_ bv137 8) (_ bv3899392 23))))))
...
(declare-fun spoon_67 (potato_19) (_ FloatingPoint 8 24))
(declare-fun spoon_68 ((_ FloatingPoint 8 24)) potato_19)
(assert (forall ((kitten_48 potato_19)) (! (= (spoon_68 (spoon_67 kitten_48)) kitten_48) :pattern ((spoon_67 kitten_48)))))
(assert (forall ((kitten_49 potato_19)) (! (spoon_60 (spoon_67 kitten_49)) :pattern ((spoon_67 kitten_49)))))
(assert (forall ((kitten_50 (_ FloatingPoint 8 24))) (! (=> (spoon_60 kitten_50) (= (spoon_67 (spoon_68 kitten_50)) kitten_50)) :pattern ((spoon_67 (spoon_68 kitten_50))))))
(declare-datatypes ((potato_21 0)) (((mk_potato_21 (get_potato_21_a potato_15) (get_potato_21_b potato_19)))))

(define-fun spoon_69 ((kitten_51 potato_21)) potato_15 (get_potato_21_a kitten_51))
(define-fun spoon_70 ((kitten_52 potato_21)) potato_19 (get_potato_21_b kitten_52))
(declare-datatypes ((potato_22 0)) (((mk_potato_22 (get_potato_22_a potato_21)))))

(define-fun spoon_71 ((kitten_53 potato_22)) potato_21 (get_potato_22_a kitten_53))
(declare-datatypes ((potato_23 0)) (((mk_potato_23 (get_potato_23_a potato_21)))))

(define-fun spoon_72 ((kitten_54 potato_23)) potato_21 (get_potato_23_a kitten_54))
(define-fun spoon_73 ((kitten_55 potato_23) (kitten_56 potato_23)) Bool (let ((_let_0 (get_potato_23_a kitten_55))) (let ((_let_1 (get_potato_23_a kitten_56))) (ite (and (= (spoon_36 (get_potato_21_a _let_0) (get_potato_21_a _let_1)) true) (= (spoon_67 (get_potato_21_b _let_0)) (spoon_67 (get_potato_21_b _let_1)))) true false))))
(declare-fun cat_74 () Int)
(declare-fun spoon_75 (potato_23) Int)
(declare-fun cat_76 () Int)
(declare-fun spoon_77 (potato_23) Int)
(assert (<= 0 cat_74))
(assert (forall ((kitten_57 potato_23)) (<= 0 (spoon_75 kitten_57)) ))
(assert (<= 0 cat_76))
(assert (forall ((kitten_58 potato_23)) (<= 0 (spoon_77 kitten_58)) ))
...
(declare-fun cat_85 () potato_23)
(declare-datatypes ((potato_24 0)) (((mk_potato_24 (get_potato_24_a potato_23)))))

(define-fun spoon_86 ((kitten_59 potato_24)) potato_23 (get_potato_24_a kitten_59))
(declare-fun cat_87 () potato_23)
(declare-fun cat_88 () Int)
(declare-fun cat_89 () potato_23)
(declare-fun cat_90 () Int)
(declare-fun cat_91 () Int)
(define-fun spoon_92 ((kitten_60 (_ FloatingPoint 8 24)) (kitten_61 Bool) (kitten_62 Bool) (kitten_63 Bool) (kitten_64 Bool)) Bool (let ((_let_0 (fp (_ bv0 1) (_ bv139 8) (_ bv0 23)))) (=> (or (= kitten_61 true) (fp.leq (fp.neg _let_0) _let_0)) (spoon_23 kitten_60))))
(define-fun spoon_93 ((kitten_65 (_ FloatingPoint 8 24)) (kitten_66 Bool) (kitten_67 Bool) (kitten_68 Bool) (kitten_69 Bool)) Bool (=> (or (= kitten_66 true) (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) (fp (_ bv0 1) (_ bv137 8) (_ bv3899392 23)))) (spoon_60 kitten_65)))
(declare-fun cat_94 () (_ FloatingPoint 8 24))
(declare-fun cat_95 () (_ FloatingPoint 8 24))
(declare-fun cat_96 () (_ FloatingPoint 8 24))
(assert (=> (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) (fp (_ bv0 1) (_ bv140 8) (_ bv3489792 23))) (spoon_52 cat_94)))
(assert (= cat_95 (spoon_50 (get_potato_21_a (get_potato_23_a cat_87)) (get_potato_21_a (get_potato_23_a cat_89)))))
(assert (spoon_52 cat_95))
(assert (= cat_96 cat_95))
(assert (fp.lt (fp.add roundNearestTiesToEven (spoon_67 (get_potato_21_b (get_potato_23_a cat_87))) (spoon_67 (get_potato_21_b (get_potato_23_a cat_89)))) cat_96))
(assert (not (spoon_52 (fp.sub roundNearestTiesToEven cat_96 (fp.add roundNearestTiesToEven (spoon_67 (get_potato_21_b (get_potato_23_a cat_87))) (spoon_67 (get_potato_21_b (get_potato_23_a cat_89))))))))
(check-sat)
(exit)
