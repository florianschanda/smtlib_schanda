...
(assert (= cat_102 cat_99))
(assert (= cat_103 ((_ to_fp 11 53) RNE (fp.add RNE (spoon_47 (get_potato_14_a (get_potato_16_a cat_67))) (spoon_47 (get_potato_14_a (get_potato_16_a cat_69)))))))
(assert (not (fp.lt (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000) cat_103)))
(assert (fp.lt cat_103 (fp.neg (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000))))
(assert (fp.lt (spoon_47 (get_potato_14_a (get_potato_16_a cat_69))) (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (not (spoon_3 (fp.div RNE ((_ to_fp 11 53) RNE (fp.sub RNE (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (spoon_47 (get_potato_14_a (get_potato_16_a cat_67))))) ((_ to_fp 11 53) RNE (spoon_47 (get_potato_14_a (get_potato_16_a cat_69))))))))
(check-sat)
(exit)
