...
(assert (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_267))
(assert (and (= cat_244 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_267)) (spoon_3 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_267))))
(assert (= cat_245 (ite (fp.leq cat_285 cat_244) true false)))
(assert (not (spoon_3 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_267))))
(check-sat)
(exit)
