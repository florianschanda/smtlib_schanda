...
(assert (= cat_211 true))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (=> (fp.lt _let_0 (spoon_111 (get_potato_28_a cat_212))) (and (= cat_201 (spoon_76 _let_0)) (spoon_86 cat_201)))))
(assert (=> (fp.lt (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)) (spoon_111 (get_potato_28_a cat_212))) (= cat_213 (mk_potato_10 cat_210))))
(assert (=> (fp.lt (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)) (spoon_111 (get_potato_28_a cat_212))) (= cat_214 cat_201)))
(assert (let ((_let_0 (fp.neg (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23))))) (let ((_let_1 (spoon_111 (get_potato_28_a cat_212)))) (=> (not (fp.lt (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)) _let_1)) (=> (fp.lt _let_1 _let_0) (and (= cat_202 (spoon_76 _let_0)) (spoon_86 cat_202)))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (let ((_let_1 (spoon_111 (get_potato_28_a cat_212)))) (=> (not (fp.lt _let_0 _let_1)) (=> (fp.lt _let_1 (fp.neg _let_0)) (= cat_215 (mk_potato_10 cat_210)))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (let ((_let_1 (spoon_111 (get_potato_28_a cat_212)))) (=> (not (fp.lt _let_0 _let_1)) (=> (fp.lt _let_1 (fp.neg _let_0)) (= cat_216 cat_202))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (let ((_let_1 (spoon_111 (get_potato_28_a cat_212)))) (=> (not (fp.lt _let_0 _let_1)) (=> (not (fp.lt _let_1 (fp.neg _let_0))) (and (= cat_203 _let_1) (spoon_1 _let_1)))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (let ((_let_1 (spoon_111 (get_potato_28_a cat_212)))) (=> (not (fp.lt _let_0 _let_1)) (=> (not (fp.lt _let_1 (fp.neg _let_0))) (and (= cat_204 (spoon_76 cat_203)) (spoon_86 cat_204)))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (let ((_let_1 (spoon_111 (get_potato_28_a cat_212)))) (=> (not (fp.lt _let_0 _let_1)) (=> (not (fp.lt _let_1 (fp.neg _let_0))) (= cat_217 (mk_potato_10 cat_210)))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (let ((_let_1 (spoon_111 (get_potato_28_a cat_212)))) (=> (not (fp.lt _let_0 _let_1)) (=> (not (fp.lt _let_1 (fp.neg _let_0))) (= cat_218 cat_204))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (let ((_let_1 (spoon_111 (get_potato_28_a cat_212)))) (=> (not (fp.lt _let_0 _let_1)) (=> (not (fp.lt _let_1 (fp.neg _let_0))) (= cat_216 cat_218))))))
(assert (=> (not (fp.lt (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)) (spoon_111 (get_potato_28_a cat_212)))) (= cat_214 cat_216)))
(assert (= cat_219 ((_ to_fp 8 24) roundNearestTiesToEven (fp.sub roundNearestTiesToEven (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) (fp.mul roundNearestTiesToEven cat_166 cat_166)))))
