...
(declare-const cat_212 potato_28)
...
(assert (= cat_211 true))
(assert (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_212))) (and (= cat_201 (spoon_76 (fp #b0 #b10000101 #b01100111111101011101000))) (spoon_86 cat_201))))
(assert (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_212))) (= cat_213 (mk_potato_10 cat_210))))
(assert (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_212))) (= cat_214 cat_201)))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_212)))) (=> (fp.lt (spoon_111 (get_potato_28_a cat_212)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (and (= cat_202 (spoon_76 (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (spoon_86 cat_202)))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_212)))) (=> (fp.lt (spoon_111 (get_potato_28_a cat_212)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_215 (mk_potato_10 cat_210)))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_212)))) (=> (fp.lt (spoon_111 (get_potato_28_a cat_212)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_216 cat_202))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_212)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_212)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_203 (spoon_111 (get_potato_28_a cat_212))) (spoon_1 (spoon_111 (get_potato_28_a cat_212)))))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_212)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_212)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_204 (spoon_76 cat_203)) (spoon_86 cat_204)))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_212)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_212)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_217 (mk_potato_10 cat_210)))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_212)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_212)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_218 cat_204))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_212)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_212)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_216 cat_218))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_212)))) (= cat_214 cat_216)))
(assert (= cat_219 ((_ to_fp 8 24) RNE (fp.sub RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) (fp.mul RNE cat_166 cat_166)))))
(assert (not (or (fp.isZero cat_219) (fp.isPositive cat_219))))
(check-sat)
(exit)
