...
(assert (= cat_67 (fp.sub RNE (spoon_30 (get_potato_13_a (get_potato_15_a cat_48))) (spoon_30 (get_potato_13_a (get_potato_15_a cat_50))))))
(assert (= cat_68 cat_65))
(assert (= cat_69 (fp.sub RNE (spoon_30 (get_potato_13_b (get_potato_15_a cat_48))) (spoon_30 (get_potato_13_b (get_potato_15_a cat_50))))))
(assert (=> (fp.leq cat_67 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000))) (= cat_70 cat_67)))
(assert (=> (fp.leq cat_67 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000))) (= cat_71 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))))
(assert (=> (not (fp.leq cat_67 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (fp.leq (fp #b0 #b10001011 #b00000000000000000000000) cat_67) (= cat_72 cat_67))))
(assert (=> (not (fp.leq cat_67 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (fp.leq (fp #b0 #b10001011 #b00000000000000000000000) cat_67) (= cat_73 (fp #b0 #b10001011 #b00000000000000000000000)))))
(assert (=> (not (fp.leq cat_67 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.leq (fp #b0 #b10001011 #b00000000000000000000000) cat_67)) (= cat_73 cat_67))))
(assert (=> (not (fp.leq cat_67 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (= cat_71 cat_73)))
