...
(declare-const cat_72 potato_11)
...
(assert (= cat_73 (fp.sub RNE (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) (spoon_34 (get_potato_13_a (get_potato_15_a cat_58)))) (spoon_34 (get_potato_13_a (get_potato_15_a cat_56))))))
(assert (= cat_74 (fp.sub RNE (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) (spoon_34 (get_potato_13_b (get_potato_15_a cat_58)))) (spoon_34 (get_potato_13_b (get_potato_15_a cat_56))))))
(assert (=> (=> (not (fp.lt cat_73 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_73)) (=> (not (fp.lt cat_74 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_74)))) (and (and (and (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) cat_75) (fp.leq cat_75 (fp #b0 #b10001011 #b00000000000000000000000))) (and (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) cat_76) (fp.leq cat_76 (fp #b0 #b10001011 #b00000000000000000000000)))) (and (spoon_60 cat_76) (spoon_60 cat_75)))))
(assert (=> (not (=> (not (fp.lt cat_73 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_73)) (=> (not (fp.lt cat_74 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_74))))) (= cat_76 cat_74)))
(assert (=> (not (=> (not (fp.lt cat_73 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_73)) (=> (not (fp.lt cat_74 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_74))))) (= cat_75 cat_73)))
