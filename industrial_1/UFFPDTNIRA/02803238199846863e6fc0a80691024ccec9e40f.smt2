...
(declare-const cat_146 potato_12)
...
(declare-const cat_152 potato_15)
(declare-const cat_153 potato_14)
(declare-const cat_154 potato_11)
(declare-const cat_155 Float64)
(declare-const cat_156 potato_15)
(declare-const cat_157 potato_14)
(declare-const cat_158 potato_15)
(declare-const cat_159 potato_14)
(declare-const cat_160 potato_11)
(declare-const cat_161 Float64)
(declare-const cat_162 potato_11)
(declare-const cat_163 Float64)
(declare-const cat_164 potato_15)
(declare-const cat_165 potato_14)
(declare-const cat_166 potato_11)
(declare-const cat_167 Float64)
(declare-const cat_168 potato_15)
(declare-const cat_169 potato_14)
...
(assert (= cat_148 cat_103))
(assert (= cat_149 ((_ to_fp 11 53) RNE (fp.add RNE (spoon_53 (get_potato_14_a (get_potato_16_a cat_71))) (spoon_53 (get_potato_14_a (get_potato_16_a cat_73)))))))
(assert (fp.lt (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000) cat_149))
(assert (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) (spoon_53 (get_potato_14_a (get_potato_16_a cat_73)))))
(assert (not (spoon_3 (fp.div RNE ((_ to_fp 11 53) RNE (fp.sub RNE (fp #b0 #b10001011 #b00000000000000000000000) (spoon_53 (get_potato_14_a (get_potato_16_a cat_71))))) ((_ to_fp 11 53) RNE (spoon_53 (get_potato_14_a (get_potato_16_a cat_73))))))))
(check-sat)
(exit)
