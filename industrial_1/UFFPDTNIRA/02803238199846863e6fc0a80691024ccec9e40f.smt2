...
(assert (= cat_106 cat_103))
(assert (= cat_107 ((_ to_fp 11 53) RNE (fp.add RNE (spoon_53 (get_potato_14_a (get_potato_16_a cat_71))) (spoon_53 (get_potato_14_a (get_potato_16_a cat_73)))))))
(assert (fp.lt (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000) cat_107))
(assert (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) (spoon_53 (get_potato_14_a (get_potato_16_a cat_73)))))
(assert (not (spoon_2 (fp.div RNE ((_ to_fp 11 53) RNE (fp.sub RNE (fp #b0 #b10001011 #b00000000000000000000000) (spoon_53 (get_potato_14_a (get_potato_16_a cat_71))))) ((_ to_fp 11 53) RNE (spoon_53 (get_potato_14_a (get_potato_16_a cat_73))))))))
(check-sat)
(exit)
