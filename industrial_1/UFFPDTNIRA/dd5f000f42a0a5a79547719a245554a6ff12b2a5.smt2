...
(assert (and (= cat_52 (spoon_30 cat_47 (fp #b0 #b10000111 #b01101000000000000000000))) (and (spoon_1 cat_52) (=> (fp.eq cat_47 (fp #b0 #b01111111 #b00000000000000000000000)) (fp.eq cat_52 (fp #b0 #b00000000 #b00000000000000000000000))))))
(assert (= cat_53 cat_51))
(assert (= cat_54 cat_52))
(assert (=> (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) cat_54) (= cat_55 cat_54)))
(assert (=> (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) cat_54) (= cat_56 (fp #b0 #b10000110 #b01101000000000000000000))))
(assert (=> (not (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) cat_54)) (=> (fp.lt cat_54 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_57 cat_54))))
(assert (=> (not (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) cat_54)) (=> (fp.lt cat_54 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_58 (fp #b0 #b00000000 #b00000000000000000000000)))))
(assert (=> (not (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) cat_54)) (=> (not (fp.lt cat_54 (fp #b0 #b00000000 #b00000000000000000000000))) (= cat_58 cat_54))))
(assert (=> (not (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) cat_54)) (= cat_56 cat_58)))
