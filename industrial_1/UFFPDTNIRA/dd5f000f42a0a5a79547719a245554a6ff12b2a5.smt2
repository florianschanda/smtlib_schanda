...
(assert (=> (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) cat_56) (= cat_57 cat_56)))
(assert (=> (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) cat_56) (= cat_58 (fp #b0 #b10000110 #b01101000000000000000000))))
(assert (=> (not (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) cat_56)) (=> (fp.lt cat_56 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_59 cat_56))))
(assert (=> (not (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) cat_56)) (=> (fp.lt cat_56 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_60 (fp #b0 #b00000000 #b00000000000000000000000)))))
(assert (=> (not (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) cat_56)) (=> (not (fp.lt cat_56 (fp #b0 #b00000000 #b00000000000000000000000))) (= cat_60 cat_56))))
(assert (=> (not (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) cat_56)) (= cat_58 cat_60)))
