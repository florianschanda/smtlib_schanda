...
(assert (= cat_58 (spoon_34 cat_51 cat_53 (fp (_ bv0 1) (_ bv135 8) (_ bv3407872 23)))))
(assert (spoon_1 cat_58))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (and (fp.lt _let_0 cat_53) (fp.eq cat_51 _let_0)) (fp.eq cat_58 _let_0))))
(assert (= cat_59 cat_58))
(assert (=> (fp.lt (fp (_ bv0 1) (_ bv134 8) (_ bv3407872 23)) cat_59) (= cat_60 cat_59)))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv134 8) (_ bv3407872 23)))) (=> (fp.lt _let_0 cat_59) (= cat_61 _let_0))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv134 8) (_ bv3407872 23)))) (=> (not (fp.lt _let_0 cat_59)) (=> (fp.lt cat_59 (fp.neg _let_0)) (= cat_62 cat_59)))))
(assert (let ((_let_0 (fp.neg (fp (_ bv0 1) (_ bv134 8) (_ bv3407872 23))))) (=> (not (fp.lt (fp (_ bv0 1) (_ bv134 8) (_ bv3407872 23)) cat_59)) (=> (fp.lt cat_59 _let_0) (= cat_63 _let_0)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv134 8) (_ bv3407872 23)))) (=> (not (fp.lt _let_0 cat_59)) (=> (not (fp.lt cat_59 (fp.neg _let_0))) (= cat_63 cat_59)))))
(assert (=> (not (fp.lt (fp (_ bv0 1) (_ bv134 8) (_ bv3407872 23)) cat_59)) (= cat_61 cat_63)))
