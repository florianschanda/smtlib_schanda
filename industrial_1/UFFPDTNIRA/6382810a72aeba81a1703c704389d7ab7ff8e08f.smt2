...
(assert (= cat_58 (spoon_34 cat_51 cat_53 (fp #b0 #b10000111 #b01101000000000000000000))))
(assert (spoon_1 cat_58))
(assert (=> (and (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_53) (fp.eq cat_51 (fp #b0 #b00000000 #b00000000000000000000000))) (fp.eq cat_58 (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (= cat_59 cat_58))
(assert (=> (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) cat_59) (= cat_60 cat_59)))
(assert (=> (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) cat_59) (= cat_61 (fp #b0 #b10000110 #b01101000000000000000000))))
(assert (=> (not (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) cat_59)) (=> (fp.lt cat_59 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000))) (= cat_62 cat_59))))
(assert (=> (not (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) cat_59)) (=> (fp.lt cat_59 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000))) (= cat_63 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000))))))
(assert (=> (not (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) cat_59)) (=> (not (fp.lt cat_59 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)))) (= cat_63 cat_59))))
(assert (=> (not (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) cat_59)) (= cat_61 cat_63)))
(assert (not (spoon_36 cat_61)))
(check-sat)
(exit)
