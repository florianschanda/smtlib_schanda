...
(assert (forall ((kitten_27 Float32) (kitten_28 Float32)) (! (=> (and (and (spoon_29 kitten_27 true true true) (spoon_29 kitten_28 true true true)) (and (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) kitten_28) (fp.leq (fp.abs kitten_27) (fp #b0 #b01111111 #b00000000000000000000000)))) (let ((kitten_29 (spoon_30 kitten_27 kitten_28))) (and (=> (fp.eq kitten_27 (fp #b0 #b01111111 #b00000000000000000000000)) (fp.eq kitten_29 (fp #b0 #b00000000 #b00000000000000000000000))) (spoon_29 kitten_29 true false true)))) :pattern ((spoon_30 kitten_27 kitten_28)))))
(declare-sort potato_13 0)
(define-fun spoon_32 ((kitten_30 Float32)) Bool (and (spoon_1 kitten_30) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_30) (fp.leq kitten_30 (fp #b0 #b10000110 #b01101000000000000000000)))))
...
(define-fun spoon_39 ((kitten_32 Float32)) Bool (and (spoon_1 kitten_32) (and (fp.leq (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)) kitten_32) (fp.leq kitten_32 (fp #b0 #b01111111 #b00000000000000000000000)))))
...
(define-fun spoon_45 ((kitten_33 potato_16)) potato_15 (get_potato_16_a kitten_33))
(define-fun spoon_46 ((kitten_34 Float32) (kitten_35 Bool) (kitten_36 Bool) (kitten_37 Bool)) Bool (=> (or (= kitten_35 true) (fp.leq (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)) (fp #b0 #b01111111 #b00000000000000000000000))) (spoon_39 kitten_34)))
(declare-const cat_47 Float32)
(declare-const cat_48 Int)
(declare-const cat_49 Int)
(define-fun spoon_50 ((kitten_38 Float32) (kitten_39 Bool) (kitten_40 Bool) (kitten_41 Bool)) Bool (=> (or (= kitten_39 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000110 #b01101000000000000000000))) (spoon_32 kitten_38)))
...
(assert (not (fp.leq (fp.abs cat_47) (fp #b0 #b01111111 #b00000000000000000000000))))
(check-sat)
(exit)
