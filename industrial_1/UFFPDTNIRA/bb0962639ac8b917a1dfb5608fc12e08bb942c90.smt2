...
(assert (forall ((kitten_28 Float32) (kitten_29 Float32)) (! (=> (and (and (spoon_31 kitten_28 true true true) (spoon_31 kitten_29 true true true)) (and (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) kitten_29) (fp.leq (fp.abs kitten_28) (fp #b0 #b01111111 #b00000000000000000000000)))) (let ((kitten_30 (spoon_32 kitten_28 kitten_29))) (and (=> (fp.eq kitten_28 (fp #b0 #b01111111 #b00000000000000000000000)) (fp.eq kitten_30 (fp #b0 #b00000000 #b00000000000000000000000))) (spoon_31 kitten_30 true false true)))) :pattern ((spoon_32 kitten_28 kitten_29)))))
(declare-sort potato_13 0)
(define-fun spoon_34 ((kitten_31 Float32)) Bool (and (spoon_1 kitten_31) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_31) (fp.leq kitten_31 (fp #b0 #b10000110 #b01101000000000000000000)))))
...
(define-fun spoon_41 ((kitten_33 Float32)) Bool (and (spoon_1 kitten_33) (and (fp.leq (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)) kitten_33) (fp.leq kitten_33 (fp #b0 #b01111111 #b00000000000000000000000)))))
...
(define-fun spoon_48 ((kitten_35 Float32) (kitten_36 Bool) (kitten_37 Bool) (kitten_38 Bool)) Bool (=> (or (= kitten_36 true) (fp.leq (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)) (fp #b0 #b01111111 #b00000000000000000000000))) (spoon_41 kitten_35)))
(declare-const cat_49 Float32)
(declare-const cat_50 Int)
(declare-const cat_51 Int)
(define-fun spoon_52 ((kitten_39 Float32) (kitten_40 Bool) (kitten_41 Bool) (kitten_42 Bool)) Bool (=> (or (= kitten_40 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000110 #b01101000000000000000000))) (spoon_34 kitten_39)))
