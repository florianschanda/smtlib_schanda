...
(declare-fun cat_240 () potato_7)
(declare-fun cat_241 () Bool)
...
(assert (= cat_215 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
(assert (spoon_1 cat_215))
(assert (= cat_216 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
(assert (spoon_1 cat_216))
(assert (= cat_217 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
(assert (spoon_1 cat_217))
(assert (= cat_218 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
(assert (spoon_1 cat_218))
(assert (= cat_219 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
(assert (spoon_154 cat_219))
(assert (= cat_220 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
...
(assert (= cat_221 true))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (=> (= cat_222 true) (=> (fp.lt _let_0 (spoon_111 (get_potato_28_a cat_223))) (and (= cat_201 (spoon_76 _let_0)) (spoon_86 cat_201))))))
(assert (=> (= cat_222 true) (=> (fp.lt (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)) (spoon_111 (get_potato_28_a cat_223))) (= cat_224 (mk_potato_10 cat_220)))))
(assert (=> (= cat_222 true) (=> (fp.lt (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)) (spoon_111 (get_potato_28_a cat_223))) (= cat_225 cat_201))))
(assert (let ((_let_0 (fp.neg (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23))))) (let ((_let_1 (spoon_111 (get_potato_28_a cat_223)))) (=> (= cat_222 true) (=> (not (fp.lt (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)) _let_1)) (=> (fp.lt _let_1 _let_0) (and (= cat_202 (spoon_76 _let_0)) (spoon_86 cat_202))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (let ((_let_1 (spoon_111 (get_potato_28_a cat_223)))) (=> (= cat_222 true) (=> (not (fp.lt _let_0 _let_1)) (=> (fp.lt _let_1 (fp.neg _let_0)) (= cat_226 (mk_potato_10 cat_220))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (let ((_let_1 (spoon_111 (get_potato_28_a cat_223)))) (=> (= cat_222 true) (=> (not (fp.lt _let_0 _let_1)) (=> (fp.lt _let_1 (fp.neg _let_0)) (= cat_227 cat_202)))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (let ((_let_1 (spoon_111 (get_potato_28_a cat_223)))) (=> (= cat_222 true) (=> (not (fp.lt _let_0 _let_1)) (=> (not (fp.lt _let_1 (fp.neg _let_0))) (and (= cat_203 _let_1) (spoon_1 _let_1))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (let ((_let_1 (spoon_111 (get_potato_28_a cat_223)))) (=> (= cat_222 true) (=> (not (fp.lt _let_0 _let_1)) (=> (not (fp.lt _let_1 (fp.neg _let_0))) (and (= cat_204 (spoon_76 cat_203)) (spoon_86 cat_204))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (let ((_let_1 (spoon_111 (get_potato_28_a cat_223)))) (=> (= cat_222 true) (=> (not (fp.lt _let_0 _let_1)) (=> (not (fp.lt _let_1 (fp.neg _let_0))) (= cat_228 (mk_potato_10 cat_220))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (let ((_let_1 (spoon_111 (get_potato_28_a cat_223)))) (=> (= cat_222 true) (=> (not (fp.lt _let_0 _let_1)) (=> (not (fp.lt _let_1 (fp.neg _let_0))) (= cat_229 cat_204)))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (let ((_let_1 (spoon_111 (get_potato_28_a cat_223)))) (=> (= cat_222 true) (=> (not (fp.lt _let_0 _let_1)) (=> (not (fp.lt _let_1 (fp.neg _let_0))) (= cat_227 cat_229)))))))
(assert (=> (= cat_222 true) (=> (not (fp.lt (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)) (spoon_111 (get_potato_28_a cat_223)))) (= cat_225 cat_227))))
(assert (=> (= cat_222 true) (= cat_230 (mk_potato_10 cat_219))))
(assert (=> (= cat_222 true) (= cat_231 (fp.mul roundNearestTiesToEven cat_170 cat_170))))
(assert (=> (= cat_222 true) (= cat_232 (mk_potato_10 cat_216))))
(assert (=> (= cat_222 true) (= cat_233 ((_ to_fp 8 24) roundNearestTiesToEven (fp.sub roundNearestTiesToEven (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) (fp.mul roundNearestTiesToEven cat_166 cat_166))))))
(assert (=> (= cat_222 true) (= cat_234 (mk_potato_10 cat_215))))
(assert (=> (= cat_222 true) (= cat_235 (fp.sqrt roundNearestTiesToEven cat_233))))
...
(assert (let ((_let_0 (fp.sub roundNearestTiesToEven cat_233 cat_231))) (=> (= cat_222 true) (and (= cat_205 _let_0) (spoon_1 _let_0)))))
(assert (=> (= cat_222 true) (= cat_206 (fp.add roundNearestTiesToEven cat_205 (fp.mul roundNearestTiesToEven cat_225 cat_225)))))
...
(assert (=> (= cat_222 true) (=> (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) cat_237) (= cat_238 (mk_potato_10 cat_217)))))
(assert (=> (= cat_222 true) (=> (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) cat_237) (= cat_239 (fp.sqrt roundNearestTiesToEven cat_237)))))
(assert (=> (= cat_222 true) (=> (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) cat_237) (= cat_241 cat_222))))
(assert (=> (= cat_222 true) (=> (not (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) cat_237)) (= cat_240 (mk_potato_7 cat_222)))))
(assert (=> (= cat_222 true) (=> (not (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) cat_237)) (= cat_241 (distinct 0 0)))))
(assert (=> (= cat_222 true) (=> (not (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) cat_237)) (= cat_239 cat_217))))
(assert (=> (not (= cat_222 true)) (= cat_237 cat_218)))
(assert (=> (not (= cat_222 true)) (= cat_239 cat_217)))
(assert (=> (not (= cat_222 true)) (= cat_241 cat_222)))
(assert (= cat_241 true))
(assert (= cat_210 (fp.mul roundNearestTiesToEven cat_239 cat_170)))
(assert (spoon_1 (fp.mul roundNearestTiesToEven cat_239 cat_170)))
(assert (= cat_208 (fp.mul roundNearestTiesToEven cat_235 (fp.add roundNearestTiesToEven ((_ to_fp 8 24) roundNearestTiesToEven (fp.mul roundNearestTiesToEven cat_166 cat_166)) cat_231))))
(assert (spoon_1 (fp.mul roundNearestTiesToEven cat_235 (fp.add roundNearestTiesToEven ((_ to_fp 8 24) roundNearestTiesToEven (fp.mul roundNearestTiesToEven cat_166 cat_166)) cat_231))))
(assert (= cat_209 (fp.mul roundNearestTiesToEven cat_208 cat_225)))
...
(assert (= cat_213 (fp.mul roundNearestTiesToEven cat_239 cat_170)))
(assert (spoon_1 (fp.mul roundNearestTiesToEven cat_239 cat_170)))
(assert (= cat_214 (fp.mul roundNearestTiesToEven cat_213 cat_225)))
(assert (not (spoon_1 cat_214)))
(check-sat)
(exit)
