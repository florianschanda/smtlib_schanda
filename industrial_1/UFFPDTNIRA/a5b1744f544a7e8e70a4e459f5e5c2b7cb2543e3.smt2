...
(assert (= cat_142 cat_133))
(assert (= cat_143 (fp.sub RNE (spoon_30 (get_potato_13_a (get_potato_15_a cat_88))) (spoon_30 (get_potato_13_a (get_potato_15_a cat_86))))))
(assert (= cat_144 cat_134))
(assert (= cat_145 (fp.sub RNE (spoon_30 (get_potato_13_b (get_potato_15_a cat_88))) (spoon_30 (get_potato_13_b (get_potato_15_a cat_86))))))
(assert (= cat_146 cat_135))
(assert (= cat_147 (fp.add RNE (fp.mul RNE cat_143 cat_143) (fp.mul RNE cat_145 cat_145))))
(assert (not (fp.lt cat_147 (fp #b0 #b01110001 #b10100011011011100010111))))
(assert (= cat_148 cat_137))
(assert (= cat_149 (fp.add RNE (fp.mul RNE (fp.sub RNE (spoon_30 (get_potato_13_a (get_potato_15_a cat_84))) (spoon_30 (get_potato_13_a (get_potato_15_a cat_86)))) cat_143) (fp.mul RNE (fp.sub RNE (spoon_30 (get_potato_13_b (get_potato_15_a cat_84))) (spoon_30 (get_potato_13_b (get_potato_15_a cat_86)))) cat_145))))
(assert (and (= cat_141 (fp.div RNE cat_149 cat_147)) (spoon_1 (fp.div RNE cat_149 cat_147))))
(assert (not (spoon_98 cat_141)))
(check-sat)
(exit)
