...
(assert (= cat_144 cat_135))
(assert (= cat_145 (fp.sub RNE (spoon_32 (get_potato_13_a (get_potato_15_a cat_90))) (spoon_32 (get_potato_13_a (get_potato_15_a cat_88))))))
(assert (= cat_146 cat_136))
(assert (= cat_147 (fp.sub RNE (spoon_32 (get_potato_13_b (get_potato_15_a cat_90))) (spoon_32 (get_potato_13_b (get_potato_15_a cat_88))))))
(assert (= cat_148 cat_137))
(assert (= cat_149 (fp.add RNE (fp.mul RNE cat_145 cat_145) (fp.mul RNE cat_147 cat_147))))
(assert (not (fp.lt cat_149 (fp #b0 #b01110001 #b10100011011011100010111))))
(assert (= cat_150 cat_139))
(assert (= cat_151 (fp.add RNE (fp.mul RNE (fp.sub RNE (spoon_32 (get_potato_13_a (get_potato_15_a cat_86))) (spoon_32 (get_potato_13_a (get_potato_15_a cat_88)))) cat_145) (fp.mul RNE (fp.sub RNE (spoon_32 (get_potato_13_b (get_potato_15_a cat_86))) (spoon_32 (get_potato_13_b (get_potato_15_a cat_88)))) cat_147))))
(assert (and (= cat_143 (fp.div RNE cat_151 cat_149)) (spoon_1 (fp.div RNE cat_151 cat_149))))
