...
(assert (forall ((kitten_29 Float32) (kitten_30 Float32)) (! (=> (and (and (spoon_29 kitten_29 true true true true) (spoon_29 kitten_30 true true true true)) (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) kitten_30)) (let ((kitten_31 (spoon_30 kitten_29 kitten_30))) (and (and (and (fp.leq (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)) kitten_31) (fp.leq kitten_31 (fp #b0 #b01111111 #b00000000000000000000000))) (=> (fp.eq kitten_29 (fp #b0 #b00000000 #b00000000000000000000000)) (fp.eq kitten_31 (fp #b0 #b00000000 #b00000000000000000000000)))) (spoon_29 kitten_31 true false true true)))) :pattern ((spoon_30 kitten_29 kitten_30)))))
(declare-sort potato_13 0)
(define-fun spoon_32 ((kitten_32 Float32)) Bool (and (spoon_1 kitten_32) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_32) (fp.leq kitten_32 (fp #b0 #b10000111 #b01101000000000000000000)))))
...
(define-fun spoon_39 ((kitten_34 Float32) (kitten_35 Bool) (kitten_36 Bool) (kitten_37 Bool) (kitten_38 Bool)) Bool (=> (or (= kitten_35 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000111 #b01101000000000000000000))) (spoon_32 kitten_34)))
(declare-sort potato_15 0)
(define-fun spoon_40 ((kitten_39 Float32)) Bool (and (spoon_1 kitten_39) (and (fp.leq (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)) kitten_39) (fp.leq kitten_39 (fp #b0 #b01111111 #b00000000000000000000000)))))
...
(define-fun spoon_46 ((kitten_40 potato_16)) potato_15 (get_potato_16_a kitten_40))
(declare-const cat_47 Float32)
(declare-const cat_48 Int)
(declare-const cat_49 Int)
(define-fun spoon_50 ((kitten_41 Float32) (kitten_42 Bool) (kitten_43 Bool) (kitten_44 Bool) (kitten_45 Bool)) Bool (=> (or (= kitten_42 true) (fp.leq (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)) (fp #b0 #b01111111 #b00000000000000000000000))) (spoon_40 kitten_41)))
