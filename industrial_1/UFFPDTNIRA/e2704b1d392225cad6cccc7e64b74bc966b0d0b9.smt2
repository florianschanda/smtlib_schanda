...
(assert (fp.lt cat_117 cat_116))
(assert (and (= cat_126 (fp.div RNE (spoon_77 cat_113) cat_116)) (spoon_1 (fp.div RNE (spoon_77 cat_113) cat_116))))
(assert (= cat_127 (fp.mul RNE cat_126 cat_117)))
(assert (and (= cat_128 cat_127) (spoon_1 cat_127)))
(assert (and (= cat_129 cat_128) (spoon_1 cat_128)))
(assert (= (spoon_77 cat_130) cat_129))
(assert (not (spoon_1 (fp.div RNE (spoon_77 cat_112) cat_116))))
(check-sat)
(exit)
