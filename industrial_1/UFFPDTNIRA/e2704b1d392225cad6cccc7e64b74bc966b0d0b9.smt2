...
(define-fun spoon_62 ((kitten_38 Float32)) Bool (and (spoon_1 kitten_38) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_38) (fp.leq kitten_38 (fp #b0 #b10001100 #b01101010100000000000000)))))
...
(define-fun spoon_68 ((kitten_39 potato_20)) potato_19 (get_potato_20_a kitten_39))
(define-fun spoon_69 ((kitten_40 Float32) (kitten_41 Bool) (kitten_42 Bool) (kitten_43 Bool)) Bool (=> (or (= kitten_41 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000))) (spoon_62 kitten_40)))
(declare-sort potato_21 0)
(define-fun spoon_70 ((kitten_44 Float32)) Bool (and (spoon_1 kitten_44) (and (fp.leq (fp.neg (fp #b0 #b10001100 #b00000000000000000000000)) kitten_44) (fp.leq kitten_44 (fp #b0 #b10001100 #b00000000000000000000000)))))
...
(define-fun spoon_76 ((kitten_45 potato_22)) potato_21 (get_potato_22_a kitten_45))
(declare-fun spoon_77 (potato_21) Float32)
(declare-fun spoon_78 (Float32) potato_21)
(assert (forall ((kitten_46 potato_21)) (! (= (spoon_78 (spoon_77 kitten_46)) kitten_46) :pattern ((spoon_77 kitten_46)))))
(assert (forall ((kitten_47 potato_21)) (! (spoon_70 (spoon_77 kitten_47)) :pattern ((spoon_77 kitten_47)))))
(assert (forall ((kitten_48 Float32)) (! (=> (spoon_70 kitten_48) (= (spoon_77 (spoon_78 kitten_48)) kitten_48)) :pattern ((spoon_77 (spoon_78 kitten_48))))))
...
(define-fun spoon_85 ((kitten_49 potato_24)) potato_23 (get_potato_24_a kitten_49))
(declare-datatypes () ((potato_25 (mk_potato_25 (get_potato_25_a potato_23)))))
(define-fun spoon_86 ((kitten_50 potato_25)) potato_23 (get_potato_25_a kitten_50))
(define-fun spoon_87 ((kitten_51 potato_25) (kitten_52 potato_25)) Bool (ite (and (= (spoon_77 (get_potato_23_a (get_potato_25_a kitten_51))) (spoon_77 (get_potato_23_a (get_potato_25_a kitten_52)))) (= (spoon_77 (get_potato_23_b (get_potato_25_a kitten_51))) (spoon_77 (get_potato_23_b (get_potato_25_a kitten_52))))) true false))
(declare-const cat_88 Int)
(declare-fun spoon_89 (potato_25) Int)
(declare-const cat_90 Int)
(declare-fun spoon_91 (potato_25) Int)
(assert (<= 0 cat_88))
(assert (forall ((kitten_53 potato_25)) (<= 0 (spoon_89 kitten_53))))
(assert (<= 0 cat_90))
(assert (forall ((kitten_54 potato_25)) (<= 0 (spoon_91 kitten_54))))
...
(define-fun spoon_109 ((kitten_56 Float32) (kitten_57 Bool) (kitten_58 Bool) (kitten_59 Bool)) Bool (=> (or (= kitten_57 true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111))) (spoon_1 kitten_56)))
(define-fun spoon_110 ((kitten_60 Float32) (kitten_61 Bool) (kitten_62 Bool) (kitten_63 Bool)) Bool (=> (or (= kitten_61 true) (fp.leq (fp.neg (fp #b0 #b10001100 #b00000000000000000000000)) (fp #b0 #b10001100 #b00000000000000000000000))) (spoon_70 kitten_60)))
(define-fun spoon_111 ((kitten_64 Float32) (kitten_65 Bool) (kitten_66 Bool) (kitten_67 Bool)) Bool (=> (or (= kitten_65 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_37 kitten_64)))
...
(assert (spoon_62 cat_114))
(assert (spoon_62 cat_115))
(assert (and (fp.lt (fp #b0 #b01110101 #b00000110001001001101111) cat_114) (fp.lt (fp #b0 #b01110101 #b00000110001001001101111) cat_115)))
(assert (fp.lt cat_115 cat_114))
(assert (and (= cat_116 (fp.div RNE (spoon_77 cat_113) cat_114)) (spoon_1 (fp.div RNE (spoon_77 cat_113) cat_114))))
(assert (= cat_117 (fp.mul RNE cat_116 cat_115)))
(assert (and (= cat_118 cat_117) (spoon_1 cat_117)))
(assert (and (= cat_119 cat_118) (spoon_1 cat_118)))
(assert (= (spoon_77 cat_120) cat_119))
(assert (not (spoon_1 (fp.div RNE (spoon_77 cat_112) cat_114))))
(check-sat)
(exit)
