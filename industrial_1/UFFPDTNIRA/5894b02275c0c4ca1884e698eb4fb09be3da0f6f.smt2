...
(assert (= cat_153 (fp.add RNE (fp.mul RNE (fp.sub RNE (spoon_48 (get_potato_17_a (get_potato_19_a cat_86))) (spoon_48 (get_potato_17_a (get_potato_19_a cat_88)))) (fp.neg cat_149)) (fp.mul RNE (fp.sub RNE (spoon_48 (get_potato_17_b (get_potato_19_a cat_86))) (spoon_48 (get_potato_17_b (get_potato_19_a cat_88)))) cat_148))))
...
(assert (not (spoon_1 (fp.div RNE (fp.abs cat_153) cat_154))))
(check-sat)
(exit)
