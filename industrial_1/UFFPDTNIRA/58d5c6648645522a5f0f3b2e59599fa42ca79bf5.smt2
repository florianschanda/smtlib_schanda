...
(assert (fp.lt cat_77 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000))))
(assert (= (mk_potato_10 cat_84) (mk_potato_10 cat_77)))
(assert (= cat_85 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000))))
(assert (not (spoon_64 (fp.add RNE (fp.mul RNE cat_83 (fp.sub RNE cat_85 (spoon_42 (get_potato_15_a (get_potato_17_a cat_60))))) (spoon_42 (get_potato_15_b (get_potato_17_a cat_60)))))))
(check-sat)
(exit)
