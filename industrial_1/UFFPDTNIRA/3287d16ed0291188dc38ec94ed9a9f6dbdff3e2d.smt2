...
(assert (= cat_277 (mk_potato_7 cat_203)))
(assert (= cat_278 (spoon_37 1)))
(assert (= cat_279 (mk_potato_25 (mk_potato_24 cat_201 cat_202))))
(assert (= cat_280 (get_potato_26_a cat_111)))
(assert (= cat_225 (spoon_113 cat_167 cat_74)))
(assert (= cat_281 (ite (not (= cat_225 true)) true false)))
(assert (= cat_281 true))
(assert (=> (= cat_282 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_283))) (and (= cat_226 (spoon_149 (fp #b0 #b10000101 #b01100111111101011101000))) (spoon_129 cat_226)))))
(assert (=> (= cat_282 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_283))) (= cat_284 (mk_potato_10 cat_276)))))
(assert (=> (= cat_282 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_283))) (= cat_285 cat_226))))
(assert (=> (= cat_282 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_283)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_283)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (and (= cat_227 (spoon_149 (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (spoon_129 cat_227))))))
(assert (=> (= cat_282 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_283)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_283)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_286 (mk_potato_10 cat_276))))))
(assert (=> (= cat_282 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_283)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_283)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_287 cat_227)))))
(assert (=> (= cat_282 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_283)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_283)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_228 (spoon_84 (get_potato_24_a cat_283))) (spoon_1 (spoon_84 (get_potato_24_a cat_283))))))))
(assert (=> (= cat_282 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_283)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_283)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_229 (spoon_149 cat_228)) (spoon_129 cat_229))))))
(assert (=> (= cat_282 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_283)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_283)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_288 (mk_potato_10 cat_276))))))
(assert (=> (= cat_282 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_283)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_283)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_289 cat_229)))))
(assert (=> (= cat_282 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_283)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_283)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_287 cat_289)))))
(assert (=> (= cat_282 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_283)))) (= cat_285 cat_287))))
(assert (=> (= cat_282 true) (=> (spoon_189 cat_175) (and (= cat_230 (fp.mul RNE cat_175 cat_175)) (spoon_1 (fp.mul RNE cat_175 cat_175))))))
(assert (=> (= cat_282 true) (=> (spoon_189 cat_175) (= cat_290 (mk_potato_10 cat_274)))))
(assert (=> (= cat_282 true) (=> (spoon_189 cat_175) (= cat_291 cat_230))))
(assert (=> (= cat_282 true) (=> (spoon_189 cat_175) (= cat_293 cat_282))))
(assert (=> (= cat_282 true) (=> (not (spoon_189 cat_175)) (= cat_292 (mk_potato_7 cat_282)))))
(assert (=> (= cat_282 true) (=> (not (spoon_189 cat_175)) (= cat_293 (spoon_37 0)))))
(assert (=> (= cat_282 true) (=> (not (spoon_189 cat_175)) (= cat_291 cat_274))))
(assert (=> (= cat_282 true) (= cat_294 (mk_potato_10 cat_268))))
(assert (=> (= cat_282 true) (= cat_295 ((_ to_fp 8 24) RNE (fp.sub RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) (fp.mul RNE cat_171 cat_171))))))
(assert (=> (= cat_282 true) (and (= cat_231 cat_295) (spoon_1 cat_295))))
(assert (=> (= cat_282 true) (and (= cat_232 (spoon_146 cat_231)) (spoon_138 cat_232))))
(assert (=> (= cat_282 true) (= cat_296 (mk_potato_10 cat_266))))
(assert (=> (= cat_282 true) (= cat_297 cat_232)))
...
(assert (=> (= cat_293 true) (and (= cat_233 (fp.sub RNE cat_295 cat_291)) (spoon_1 (fp.sub RNE cat_295 cat_291)))))
(assert (=> (= cat_293 true) (= cat_234 (fp.add RNE cat_233 (fp.mul RNE cat_285 cat_285)))))
(assert (=> (= cat_293 true) (and (= cat_235 cat_234) (spoon_1 cat_234))))
(assert (=> (= cat_293 true) (= cat_298 (mk_potato_10 cat_272))))
(assert (=> (= cat_293 true) (= cat_299 cat_235)))
(assert (=> (= cat_293 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_299) (and (= cat_236 cat_299) (spoon_1 cat_299)))))
(assert (=> (= cat_293 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_299) (and (= cat_237 (spoon_146 cat_236)) (spoon_138 cat_237)))))
(assert (=> (= cat_293 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_299) (= cat_300 (mk_potato_10 cat_270)))))
(assert (=> (= cat_293 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_299) (= cat_301 cat_237))))
...
(assert (=> (= cat_293 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_299)) (= cat_303 (spoon_37 0)))))
...
(assert (= cat_303 true))
(assert (and (= cat_242 (fp.mul RNE cat_301 cat_175)) (spoon_1 (fp.mul RNE cat_301 cat_175))))
(assert (and (= cat_238 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_171 cat_171)) cat_291)) (spoon_1 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_171 cat_171)) cat_291))))
(assert (= cat_239 (fp.mul RNE cat_297 cat_238)))
(assert (and (= cat_240 cat_239) (spoon_1 cat_239)))
(assert (= cat_241 (fp.mul RNE cat_240 cat_285)))
...
(assert (= cat_304 (mk_potato_10 cat_211)))
(assert (= cat_305 cat_245))
(assert (and (= cat_246 (fp.mul RNE cat_301 cat_175)) (spoon_1 (fp.mul RNE cat_301 cat_175))))
(assert (= cat_247 (fp.mul RNE cat_246 cat_285)))
(assert (and (= cat_248 cat_247) (spoon_1 cat_247)))
(assert (and (= cat_249 (fp.mul RNE cat_297 cat_299)) (spoon_1 (fp.mul RNE cat_297 cat_299))))
(assert (= cat_250 (fp.sub RNE cat_249 cat_248)))
(assert (and (= cat_251 cat_250) (spoon_1 cat_250)))
(assert (= cat_306 (mk_potato_10 cat_212)))
(assert (= cat_307 cat_251))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_307) (and (= cat_260 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_307)) (spoon_1 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_307)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_307) (and (= cat_261 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_305)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_305)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_307) (= cat_262 (ite (fp.leq cat_261 cat_260) true false))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_307) (and (= cat_258 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_305)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_305)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_307) (and (= cat_259 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_307)) (spoon_1 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_307)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_307) (= cat_263 (ite (fp.leq cat_259 cat_258) true false))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_307) (= cat_309 (ite (= cat_263 true) cat_262 false))))
(assert (=> (not (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_307)) (= cat_309 false)))
(assert (=> (= cat_309 true) (= cat_308 true)))
(assert (=> (not (= cat_309 true)) (=> (fp.lt cat_307 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_254 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_307)) (spoon_1 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_307))))))
(assert (=> (not (= cat_309 true)) (=> (fp.lt cat_307 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_255 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_305)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_305))))))
(assert (=> (not (= cat_309 true)) (=> (fp.lt cat_307 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_256 (ite (fp.leq cat_255 cat_254) true false)))))
(assert (=> (not (= cat_309 true)) (=> (fp.lt cat_307 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_252 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_305)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_305))))))
(assert (=> (not (= cat_309 true)) (=> (fp.lt cat_307 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_253 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_307)) (spoon_1 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_307))))))
(assert (=> (not (= cat_309 true)) (=> (fp.lt cat_307 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_257 (ite (fp.leq cat_253 cat_252) true false)))))
(assert (=> (not (= cat_309 true)) (=> (fp.lt cat_307 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_308 (ite (= cat_257 true) cat_256 false)))))
(assert (=> (not (= cat_309 true)) (=> (not (fp.lt cat_307 (fp #b0 #b00000000 #b00000000000000000000000))) (= cat_308 false))))
(assert (= cat_308 true))
(assert (and (= cat_264 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_305)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_305))))
(assert (not (not (fp.isZero cat_307))))
(check-sat)
(exit)
