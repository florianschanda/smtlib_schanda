...
(declare-const cat_281 potato_7)
(declare-const cat_282 Bool)
(declare-const cat_283 potato_25)
...
(declare-const cat_306 potato_7)
...
(assert (= cat_281 (mk_potato_7 cat_207)))
(assert (= cat_282 (spoon_41 1)))
(assert (= cat_283 (mk_potato_25 (mk_potato_24 cat_205 cat_206))))
(assert (= cat_284 (get_potato_26_a cat_115)))
(assert (= cat_229 (spoon_117 cat_171 cat_78)))
(assert (= cat_285 (ite (not (= cat_229 true)) true false)))
(assert (= cat_285 true))
(assert (=> (= cat_286 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_287))) (and (= cat_230 (spoon_153 (fp #b0 #b10000101 #b01100111111101011101000))) (spoon_133 cat_230)))))
(assert (=> (= cat_286 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_287))) (= cat_288 (mk_potato_10 cat_280)))))
(assert (=> (= cat_286 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_287))) (= cat_289 cat_230))))
(assert (=> (= cat_286 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_287)))) (=> (fp.lt (spoon_88 (get_potato_24_a cat_287)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (and (= cat_231 (spoon_153 (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (spoon_133 cat_231))))))
(assert (=> (= cat_286 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_287)))) (=> (fp.lt (spoon_88 (get_potato_24_a cat_287)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_290 (mk_potato_10 cat_280))))))
(assert (=> (= cat_286 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_287)))) (=> (fp.lt (spoon_88 (get_potato_24_a cat_287)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_291 cat_231)))))
(assert (=> (= cat_286 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_287)))) (=> (not (fp.lt (spoon_88 (get_potato_24_a cat_287)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_232 (spoon_88 (get_potato_24_a cat_287))) (spoon_1 (spoon_88 (get_potato_24_a cat_287))))))))
(assert (=> (= cat_286 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_287)))) (=> (not (fp.lt (spoon_88 (get_potato_24_a cat_287)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_233 (spoon_153 cat_232)) (spoon_133 cat_233))))))
(assert (=> (= cat_286 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_287)))) (=> (not (fp.lt (spoon_88 (get_potato_24_a cat_287)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_292 (mk_potato_10 cat_280))))))
(assert (=> (= cat_286 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_287)))) (=> (not (fp.lt (spoon_88 (get_potato_24_a cat_287)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_293 cat_233)))))
(assert (=> (= cat_286 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_287)))) (=> (not (fp.lt (spoon_88 (get_potato_24_a cat_287)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_291 cat_293)))))
(assert (=> (= cat_286 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_287)))) (= cat_289 cat_291))))
(assert (=> (= cat_286 true) (=> (spoon_193 cat_179) (and (= cat_234 (fp.mul RNE cat_179 cat_179)) (spoon_1 (fp.mul RNE cat_179 cat_179))))))
(assert (=> (= cat_286 true) (=> (spoon_193 cat_179) (= cat_294 (mk_potato_10 cat_278)))))
(assert (=> (= cat_286 true) (=> (spoon_193 cat_179) (= cat_295 cat_234))))
(assert (=> (= cat_286 true) (=> (spoon_193 cat_179) (= cat_297 cat_286))))
(assert (=> (= cat_286 true) (=> (not (spoon_193 cat_179)) (= cat_296 (mk_potato_7 cat_286)))))
(assert (=> (= cat_286 true) (=> (not (spoon_193 cat_179)) (= cat_297 (spoon_41 0)))))
(assert (=> (= cat_286 true) (=> (not (spoon_193 cat_179)) (= cat_295 cat_278))))
(assert (=> (= cat_286 true) (= cat_298 (mk_potato_10 cat_272))))
(assert (=> (= cat_286 true) (= cat_299 ((_ to_fp 8 24) RNE (fp.sub RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) (fp.mul RNE cat_175 cat_175))))))
(assert (=> (= cat_286 true) (and (= cat_235 cat_299) (spoon_1 cat_299))))
(assert (=> (= cat_286 true) (and (= cat_236 (spoon_150 cat_235)) (spoon_142 cat_236))))
(assert (=> (= cat_286 true) (= cat_300 (mk_potato_10 cat_270))))
(assert (=> (= cat_286 true) (= cat_301 cat_236)))
(assert (=> (not (= cat_286 true)) (= cat_289 cat_280)))
(assert (=> (not (= cat_286 true)) (= cat_295 cat_278)))
(assert (=> (not (= cat_286 true)) (= cat_299 cat_272)))
(assert (=> (not (= cat_286 true)) (= cat_301 cat_270)))
(assert (=> (not (= cat_286 true)) (= cat_297 cat_286)))
(assert (=> (= cat_297 true) (and (= cat_237 (fp.sub RNE cat_299 cat_295)) (spoon_1 (fp.sub RNE cat_299 cat_295)))))
(assert (=> (= cat_297 true) (= cat_238 (fp.add RNE cat_237 (fp.mul RNE cat_289 cat_289)))))
(assert (=> (= cat_297 true) (and (= cat_239 cat_238) (spoon_1 cat_238))))
(assert (=> (= cat_297 true) (= cat_302 (mk_potato_10 cat_276))))
(assert (=> (= cat_297 true) (= cat_303 cat_239)))
(assert (=> (= cat_297 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_303) (and (= cat_240 cat_303) (spoon_1 cat_303)))))
(assert (=> (= cat_297 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_303) (and (= cat_241 (spoon_150 cat_240)) (spoon_142 cat_241)))))
(assert (=> (= cat_297 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_303) (= cat_304 (mk_potato_10 cat_274)))))
(assert (=> (= cat_297 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_303) (= cat_305 cat_241))))
(assert (=> (= cat_297 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_303) (= cat_307 cat_297))))
(assert (=> (= cat_297 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_303)) (= cat_306 (mk_potato_7 cat_297)))))
(assert (=> (= cat_297 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_303)) (= cat_307 (spoon_41 0)))))
(assert (=> (= cat_297 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_303)) (= cat_305 cat_274))))
(assert (=> (not (= cat_297 true)) (= cat_303 cat_276)))
(assert (=> (not (= cat_297 true)) (= cat_305 cat_274)))
(assert (=> (not (= cat_297 true)) (= cat_307 cat_297)))
(assert (= cat_307 true))
(assert (and (= cat_246 (fp.mul RNE cat_305 cat_179)) (spoon_1 (fp.mul RNE cat_305 cat_179))))
(assert (and (= cat_242 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_175 cat_175)) cat_295)) (spoon_1 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_175 cat_175)) cat_295))))
(assert (= cat_243 (fp.mul RNE cat_301 cat_242)))
(assert (and (= cat_244 cat_243) (spoon_1 cat_243)))
(assert (= cat_245 (fp.mul RNE cat_244 cat_289)))
...
(assert (= cat_308 (mk_potato_10 cat_215)))
(assert (= cat_309 cat_249))
(assert (and (= cat_250 (fp.mul RNE cat_305 cat_179)) (spoon_1 (fp.mul RNE cat_305 cat_179))))
(assert (= cat_251 (fp.mul RNE cat_250 cat_289)))
(assert (and (= cat_252 cat_251) (spoon_1 cat_251)))
(assert (and (= cat_253 (fp.mul RNE cat_301 cat_303)) (spoon_1 (fp.mul RNE cat_301 cat_303))))
(assert (= cat_254 (fp.sub RNE cat_253 cat_252)))
(assert (and (= cat_255 cat_254) (spoon_1 cat_254)))
(assert (= cat_310 (mk_potato_10 cat_216)))
(assert (= cat_311 cat_255))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_311) (and (= cat_264 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_311)) (spoon_1 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_311)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_311) (and (= cat_265 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_309)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_309)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_311) (= cat_266 (ite (fp.leq cat_265 cat_264) true false))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_311) (and (= cat_262 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_309)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_309)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_311) (and (= cat_263 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_311)) (spoon_1 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_311)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_311) (= cat_267 (ite (fp.leq cat_263 cat_262) true false))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_311) (= cat_313 (ite (= cat_267 true) cat_266 false))))
(assert (=> (not (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_311)) (= cat_313 false)))
(assert (=> (= cat_313 true) (= cat_312 true)))
(assert (=> (not (= cat_313 true)) (=> (fp.lt cat_311 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_258 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_311)) (spoon_1 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_311))))))
(assert (=> (not (= cat_313 true)) (=> (fp.lt cat_311 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_259 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_309)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_309))))))
(assert (=> (not (= cat_313 true)) (=> (fp.lt cat_311 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_260 (ite (fp.leq cat_259 cat_258) true false)))))
(assert (=> (not (= cat_313 true)) (=> (fp.lt cat_311 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_256 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_309)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_309))))))
(assert (=> (not (= cat_313 true)) (=> (fp.lt cat_311 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_257 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_311)) (spoon_1 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_311))))))
(assert (=> (not (= cat_313 true)) (=> (fp.lt cat_311 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_261 (ite (fp.leq cat_257 cat_256) true false)))))
(assert (=> (not (= cat_313 true)) (=> (fp.lt cat_311 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_312 (ite (= cat_261 true) cat_260 false)))))
(assert (=> (not (= cat_313 true)) (=> (not (fp.lt cat_311 (fp #b0 #b00000000 #b00000000000000000000000))) (= cat_312 false))))
(assert (= cat_312 true))
(assert (and (= cat_268 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_309)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_309))))
(assert (not (not (fp.isZero cat_311))))
(check-sat)
(exit)
