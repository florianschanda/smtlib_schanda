...
(assert (= cat_232 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_1 cat_232))
(assert (= cat_233 (fp #b0 #b00000000 #b00000000000000000000000)))
...
(assert (= cat_238 true))
(assert (=> (= cat_239 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_240))) (and (= cat_201 (spoon_76 (fp #b0 #b10000101 #b01100111111101011101000))) (spoon_86 cat_201)))))
(assert (=> (= cat_239 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_240))) (= cat_241 (mk_potato_10 cat_237)))))
(assert (=> (= cat_239 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_240))) (= cat_242 cat_201))))
(assert (=> (= cat_239 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_240)))) (=> (fp.lt (spoon_111 (get_potato_28_a cat_240)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (and (= cat_202 (spoon_76 (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (spoon_86 cat_202))))))
(assert (=> (= cat_239 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_240)))) (=> (fp.lt (spoon_111 (get_potato_28_a cat_240)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_243 (mk_potato_10 cat_237))))))
(assert (=> (= cat_239 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_240)))) (=> (fp.lt (spoon_111 (get_potato_28_a cat_240)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_244 cat_202)))))
(assert (=> (= cat_239 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_240)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_240)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_203 (spoon_111 (get_potato_28_a cat_240))) (spoon_1 (spoon_111 (get_potato_28_a cat_240))))))))
(assert (=> (= cat_239 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_240)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_240)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_204 (spoon_76 cat_203)) (spoon_86 cat_204))))))
(assert (=> (= cat_239 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_240)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_240)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_245 (mk_potato_10 cat_237))))))
(assert (=> (= cat_239 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_240)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_240)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_246 cat_204)))))
(assert (=> (= cat_239 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_240)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_240)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_244 cat_246)))))
(assert (=> (= cat_239 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_240)))) (= cat_242 cat_244))))
(assert (=> (= cat_239 true) (= cat_247 (mk_potato_10 cat_236))))
(assert (=> (= cat_239 true) (= cat_248 (fp.mul RNE cat_170 cat_170))))
(assert (=> (= cat_239 true) (= cat_249 (mk_potato_10 cat_233))))
(assert (=> (= cat_239 true) (= cat_250 ((_ to_fp 8 24) RNE (fp.sub RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) (fp.mul RNE cat_166 cat_166))))))
(assert (=> (= cat_239 true) (= cat_251 (mk_potato_10 cat_232))))
(assert (=> (= cat_239 true) (= cat_252 (fp.sqrt RNE cat_250))))
...
(assert (=> (= cat_239 true) (and (= cat_205 (fp.sub RNE cat_250 cat_248)) (spoon_1 (fp.sub RNE cat_250 cat_248)))))
(assert (=> (= cat_239 true) (= cat_206 (fp.add RNE cat_205 (fp.mul RNE cat_242 cat_242)))))
...
(assert (=> (= cat_239 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_254) (= cat_255 (mk_potato_10 cat_234)))))
(assert (=> (= cat_239 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_254) (= cat_256 (fp.sqrt RNE cat_254)))))
(assert (=> (= cat_239 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_254) (= cat_258 cat_239))))
(assert (=> (= cat_239 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_254)) (= cat_257 (mk_potato_7 cat_239)))))
(assert (=> (= cat_239 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_254)) (= cat_258 (distinct 0 0)))))
(assert (=> (= cat_239 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_254)) (= cat_256 cat_234))))
(assert (=> (not (= cat_239 true)) (= cat_254 cat_235)))
(assert (=> (not (= cat_239 true)) (= cat_256 cat_234)))
(assert (=> (not (= cat_239 true)) (= cat_258 cat_239)))
(assert (= cat_258 true))
(assert (= cat_210 (fp.mul RNE cat_256 cat_170)))
(assert (spoon_1 (fp.mul RNE cat_256 cat_170)))
(assert (= cat_208 (fp.mul RNE cat_252 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_166 cat_166)) cat_248))))
(assert (spoon_1 (fp.mul RNE cat_252 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_166 cat_166)) cat_248))))
...
(assert (= cat_214 (fp.mul RNE cat_256 cat_170)))
(assert (spoon_1 (fp.mul RNE cat_256 cat_170)))
(assert (= cat_215 (fp.mul RNE cat_214 cat_242)))
(assert (= cat_216 cat_215))
(assert (spoon_1 cat_215))
(assert (= cat_217 (fp.mul RNE cat_252 cat_254)))
(assert (spoon_1 (fp.mul RNE cat_252 cat_254)))
(assert (= cat_218 (fp.sub RNE cat_217 cat_216)))
(assert (= cat_219 cat_218))
(assert (= cat_260 cat_219))
(assert (spoon_1 cat_218))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_260) (and (= cat_228 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_260)) (spoon_1 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_260)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_260) (and (= cat_229 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_259)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_259)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_260) (= cat_230 (ite (fp.leq cat_229 cat_228) true false))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_260) (and (= cat_226 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_259)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_259)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_260) (and (= cat_227 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_260)) (spoon_1 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_260)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_260) (= cat_231 (ite (fp.leq cat_227 cat_226) true false))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_260) (= cat_262 (ite (= cat_231 true) cat_230 false))))
(assert (=> (not (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_260)) (= cat_262 false)))
(assert (=> (= cat_262 true) (= cat_261 true)))
(assert (=> (not (= cat_262 true)) (=> (fp.lt cat_260 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_222 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_260)) (spoon_1 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_260))))))
(assert (=> (not (= cat_262 true)) (=> (fp.lt cat_260 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_223 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_259)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_259))))))
(assert (=> (not (= cat_262 true)) (=> (fp.lt cat_260 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_224 (ite (fp.leq cat_223 cat_222) true false)))))
(assert (=> (not (= cat_262 true)) (=> (fp.lt cat_260 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_220 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_259)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_259))))))
(assert (=> (not (= cat_262 true)) (=> (fp.lt cat_260 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_221 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_260)) (spoon_1 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_260))))))
(assert (=> (not (= cat_262 true)) (=> (fp.lt cat_260 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_225 (ite (fp.leq cat_221 cat_220) true false)))))
(assert (=> (not (= cat_262 true)) (=> (fp.lt cat_260 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_261 (ite (= cat_225 true) cat_224 false)))))
(assert (=> (not (= cat_262 true)) (=> (not (fp.lt cat_260 (fp #b0 #b00000000 #b00000000000000000000000))) (= cat_261 false))))
(assert (= cat_261 true))
(assert (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_259)))
(assert (not (not (fp.isZero cat_260))))
(check-sat)
(exit)
