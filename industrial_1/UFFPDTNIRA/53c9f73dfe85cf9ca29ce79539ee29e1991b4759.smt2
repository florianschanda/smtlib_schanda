...
(declare-const cat_252 potato_25)
(declare-const cat_253 potato_24)
...
(assert (= cat_252 (mk_potato_25 (mk_potato_24 cat_201 cat_202))))
(assert (= cat_253 (get_potato_26_a cat_111)))
(assert (= cat_225 (spoon_113 cat_167 cat_74)))
(assert (= cat_254 (ite (not (= cat_225 true)) true false)))
(assert (= cat_254 true))
(assert (=> (= cat_255 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_256))) (and (= cat_226 (spoon_149 (fp #b0 #b10000101 #b01100111111101011101000))) (spoon_129 cat_226)))))
(assert (=> (= cat_255 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_256))) (= cat_257 (mk_potato_10 cat_249)))))
(assert (=> (= cat_255 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_256))) (= cat_258 cat_226))))
(assert (=> (= cat_255 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_256)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_256)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (and (= cat_227 (spoon_149 (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (spoon_129 cat_227))))))
(assert (=> (= cat_255 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_256)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_256)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_259 (mk_potato_10 cat_249))))))
(assert (=> (= cat_255 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_256)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_256)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_260 cat_227)))))
(assert (=> (= cat_255 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_256)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_256)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_228 (spoon_84 (get_potato_24_a cat_256))) (spoon_1 (spoon_84 (get_potato_24_a cat_256))))))))
(assert (=> (= cat_255 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_256)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_256)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_229 (spoon_149 cat_228)) (spoon_129 cat_229))))))
(assert (=> (= cat_255 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_256)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_256)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_261 (mk_potato_10 cat_249))))))
(assert (=> (= cat_255 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_256)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_256)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_262 cat_229)))))
(assert (=> (= cat_255 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_256)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_256)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_260 cat_262)))))
(assert (=> (= cat_255 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_256)))) (= cat_258 cat_260))))
(assert (=> (= cat_255 true) (=> (spoon_189 cat_175) (and (= cat_230 (fp.mul RNE cat_175 cat_175)) (spoon_1 (fp.mul RNE cat_175 cat_175))))))
(assert (=> (= cat_255 true) (=> (spoon_189 cat_175) (= cat_263 (mk_potato_10 cat_247)))))
(assert (=> (= cat_255 true) (=> (spoon_189 cat_175) (= cat_264 cat_230))))
(assert (=> (= cat_255 true) (=> (spoon_189 cat_175) (= cat_266 cat_255))))
(assert (=> (= cat_255 true) (=> (not (spoon_189 cat_175)) (= cat_265 (mk_potato_7 cat_255)))))
(assert (=> (= cat_255 true) (=> (not (spoon_189 cat_175)) (= cat_266 (spoon_37 0)))))
(assert (=> (= cat_255 true) (=> (not (spoon_189 cat_175)) (= cat_264 cat_247))))
(assert (=> (= cat_255 true) (= cat_267 (mk_potato_10 cat_241))))
(assert (=> (= cat_255 true) (= cat_268 ((_ to_fp 8 24) RNE (fp.sub RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) (fp.mul RNE cat_171 cat_171))))))
(assert (=> (= cat_255 true) (and (= cat_231 cat_268) (spoon_1 cat_268))))
(assert (=> (= cat_255 true) (and (= cat_232 (spoon_146 cat_231)) (spoon_138 cat_232))))
(assert (=> (= cat_255 true) (= cat_269 (mk_potato_10 cat_239))))
(assert (=> (= cat_255 true) (= cat_270 cat_232)))
(assert (=> (not (= cat_255 true)) (= cat_258 cat_249)))
(assert (=> (not (= cat_255 true)) (= cat_264 cat_247)))
(assert (=> (not (= cat_255 true)) (= cat_268 cat_241)))
(assert (=> (not (= cat_255 true)) (= cat_270 cat_239)))
(assert (=> (not (= cat_255 true)) (= cat_266 cat_255)))
(assert (=> (= cat_266 true) (and (= cat_233 (fp.sub RNE cat_268 cat_264)) (spoon_1 (fp.sub RNE cat_268 cat_264)))))
(assert (=> (= cat_266 true) (= cat_234 (fp.add RNE cat_233 (fp.mul RNE cat_258 cat_258)))))
(assert (=> (= cat_266 true) (and (= cat_235 cat_234) (spoon_1 cat_234))))
(assert (=> (= cat_266 true) (= cat_271 (mk_potato_10 cat_245))))
(assert (=> (= cat_266 true) (= cat_272 cat_235)))
(assert (=> (= cat_266 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_272) (and (= cat_236 cat_272) (spoon_1 cat_272)))))
(assert (=> (= cat_266 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_272) (and (= cat_237 (spoon_146 cat_236)) (spoon_138 cat_237)))))
(assert (=> (= cat_266 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_272) (= cat_273 (mk_potato_10 cat_243)))))
(assert (=> (= cat_266 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_272) (= cat_274 cat_237))))
(assert (=> (= cat_266 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_272) (= cat_276 cat_266))))
(assert (=> (= cat_266 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_272)) (= cat_275 (mk_potato_7 cat_266)))))
(assert (=> (= cat_266 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_272)) (= cat_276 (spoon_37 0)))))
(assert (=> (= cat_266 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_272)) (= cat_274 cat_243))))
(assert (=> (not (= cat_266 true)) (= cat_272 cat_245)))
(assert (=> (not (= cat_266 true)) (= cat_274 cat_243)))
(assert (=> (not (= cat_266 true)) (= cat_276 cat_266)))
(assert (= cat_276 true))
(assert (not (spoon_1 (fp.mul RNE cat_274 cat_175))))
(check-sat)
(exit)
