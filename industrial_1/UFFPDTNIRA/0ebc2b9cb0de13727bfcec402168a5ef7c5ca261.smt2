...
(declare-const cat_208 potato_28)
...
(assert (= cat_201 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_1 cat_201))
(assert (= cat_202 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_1 cat_202))
(assert (= cat_203 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_1 cat_203))
(assert (= cat_204 (fp #b0 #b00000000 #b00000000000000000000000)))
...
(assert (= cat_207 true))
(assert (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_208)))))
(assert (not (fp.lt (spoon_111 (get_potato_28_a cat_208)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))))
