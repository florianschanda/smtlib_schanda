...
(assert (and (= cat_212 (fp.mul RNE cat_253 cat_257)) (spoon_3 (fp.mul RNE cat_253 cat_257))))
(assert (= cat_213 (fp.mul RNE cat_212 cat_261)))
(assert (and (= cat_214 cat_213) (spoon_3 cat_213)))
(assert (and (= cat_210 (fp.mul RNE cat_251 cat_255)) (spoon_3 (fp.mul RNE cat_251 cat_255))))
...
(assert (and (= cat_218 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_145) cat_259)) (spoon_3 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_145) cat_259))))
...
(assert (=> (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_263) (and (= cat_221 (fp.div RNE cat_265 cat_263)) (spoon_3 (fp.div RNE cat_265 cat_263)))))
...
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_263)) (=> (= cat_268 true) (and (= cat_230 (fp.div RNE cat_265 cat_263)) (spoon_3 (fp.div RNE cat_265 cat_263))))))
...
(assert (and (= cat_231 (fp.mul RNE cat_251 cat_257)) (spoon_3 (fp.mul RNE cat_251 cat_257))))
(assert (= cat_276 (mk_potato_11 cat_189)))
(assert (= cat_277 cat_231))
(assert (and (= cat_232 (fp.mul RNE cat_253 cat_255)) (spoon_3 (fp.mul RNE cat_253 cat_255))))
...
(assert (and (= cat_235 (fp.sub RNE cat_277 cat_279)) (spoon_3 (fp.sub RNE cat_277 cat_279))))
...
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_263) (and (= cat_241 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_263)) (spoon_3 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_263)))))
...
(assert (and (= cat_238 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_263)) (spoon_3 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_263))))
(assert (= cat_239 (ite (fp.leq cat_281 cat_238) true false)))
(assert (not (spoon_3 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_263))))
(check-sat)
(exit)
