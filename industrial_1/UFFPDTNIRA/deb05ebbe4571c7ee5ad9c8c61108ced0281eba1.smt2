...
(assert (and (= cat_240 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_267)) (spoon_3 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_267))))
(assert (= cat_241 (ite (fp.leq cat_285 cat_240) true false)))
