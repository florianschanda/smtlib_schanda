...
(declare-const cat_181 potato_27)
(declare-const cat_182 potato_31)
...
(assert (= cat_179 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_89 cat_179))
...
(assert (= cat_167 cat_180))
(assert (= cat_168 cat_181))
...
(assert (= cat_182 (mk_potato_31 cat_173 cat_174)))
(assert (= cat_183 (fp.add RNE (fp.mul RNE (spoon_104 cat_180) (spoon_104 (get_potato_31_a cat_182))) (fp.mul RNE (spoon_104 cat_181) (spoon_104 (get_potato_31_b cat_182))))))
(assert (= cat_175 (spoon_79 cat_108 cat_106)))
(assert (spoon_81 cat_175))
(assert (= cat_184 cat_175))
(assert (= cat_176 (spoon_79 cat_108 cat_110)))
(assert (spoon_81 cat_176))
(assert (= cat_185 cat_176))
(assert (fp.lt (fp #b0 #b01110101 #b00000110001001001101111) cat_184))
(assert (fp.lt (fp #b0 #b01110101 #b00000110001001001101111) cat_185))
(assert (= cat_177 (fp.div RNE cat_183 (fp.mul RNE cat_184 cat_185))))
(assert (spoon_1 (fp.div RNE cat_183 (fp.mul RNE cat_184 cat_185))))
(assert (= cat_178 cat_177))
(assert (= cat_186 cat_178))
(assert (spoon_1 cat_177))
(assert (not (fp.lt cat_186 (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)))))
(assert (not (fp.lt (fp #b0 #b01111111 #b00000000000000000000000) cat_186)))
(assert (not (spoon_44 cat_186)))
(check-sat)
(exit)
