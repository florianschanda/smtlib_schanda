...
(assert (= cat_124 ((_ to_fp 11 53) RNE (fp.add RNE (spoon_49 (get_potato_14_a (get_potato_16_a cat_67))) (spoon_49 (get_potato_14_a (get_potato_16_a cat_69)))))))
(assert (=> (fp.lt (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000) cat_124) (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) (spoon_49 (get_potato_14_a (get_potato_16_a cat_69))))))
(assert (=> (fp.lt (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000) cat_124) (and (= cat_104 (fp.div RNE ((_ to_fp 11 53) RNE (fp.sub RNE (fp #b0 #b10001011 #b00000000000000000000000) (spoon_49 (get_potato_14_a (get_potato_16_a cat_67))))) ((_ to_fp 11 53) RNE (spoon_49 (get_potato_14_a (get_potato_16_a cat_69)))))) (spoon_2 (fp.div RNE ((_ to_fp 11 53) RNE (fp.sub RNE (fp #b0 #b10001011 #b00000000000000000000000) (spoon_49 (get_potato_14_a (get_potato_16_a cat_67))))) ((_ to_fp 11 53) RNE (spoon_49 (get_potato_14_a (get_potato_16_a cat_69)))))))))
(assert (=> (fp.lt (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000) cat_124) (and (= cat_105 cat_104) (spoon_2 cat_104))))
(assert (=> (fp.lt (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000) cat_124) (= (mk_potato_11 cat_125) spoon_138)))
(assert (=> (fp.lt (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000) cat_124) (= cat_126 cat_105)))
(assert (=> (fp.lt (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000) cat_124) (= (spoon_49 cat_107) ((_ to_fp 8 24) RNE (fp.mul RNE ((_ to_fp 11 53) RNE (spoon_49 (get_potato_14_b (get_potato_16_a cat_69)))) cat_126)))))
(assert (=> (fp.lt (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000) cat_124) (and (= cat_106 (fp.sub RNE (fp #b0 #b10001011 #b00000000000000000000000) (spoon_49 (get_potato_14_a (get_potato_16_a cat_67))))) (spoon_1 (fp.sub RNE (fp #b0 #b10001011 #b00000000000000000000000) (spoon_49 (get_potato_14_a (get_potato_16_a cat_67))))))))
(assert (=> (fp.lt (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000) cat_124) (= (spoon_49 cat_108) cat_106)))
...
(assert (=> (fp.lt (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000) cat_124) (= cat_127 spoon_137)))
...
(assert (=> (not (fp.lt (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000) cat_124)) (=> (fp.lt cat_124 (fp.neg (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000))) (fp.lt (spoon_49 (get_potato_14_a (get_potato_16_a cat_69))) (fp #b0 #b00000000 #b00000000000000000000000)))))
...
(assert (=> (not (fp.lt (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000) cat_124)) (=> (fp.lt cat_124 (fp.neg (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000))) (and (= cat_114 cat_113) (spoon_2 cat_113)))))
(assert (=> (not (fp.lt (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000) cat_124)) (=> (fp.lt cat_124 (fp.neg (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000))) (= cat_129 spoon_138))))
...
(assert (=> (not (fp.lt (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000) cat_124)) (=> (fp.lt cat_124 (fp.neg (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000))) (= (spoon_49 cat_116) ((_ to_fp 8 24) RNE (fp.mul RNE ((_ to_fp 11 53) RNE (spoon_49 (get_potato_14_b (get_potato_16_a cat_69)))) cat_130))))))
...
(assert (=> (not (fp.lt (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000) cat_124)) (=> (fp.lt cat_124 (fp.neg (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000))) (= (spoon_49 cat_117) cat_115))))
...
(assert (=> (not (fp.lt (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000) cat_124)) (=> (fp.lt cat_124 (fp.neg (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000))) (= cat_131 spoon_137))))
...
(assert (=> (not (fp.lt (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000) cat_124)) (=> (not (fp.lt cat_124 (fp.neg (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000)))) (= cat_133 spoon_137))))
...
(assert (spoon_42 (fp.add RNE (spoon_49 (get_potato_14_a (get_potato_16_a cat_67))) (spoon_49 (get_potato_14_a cat_128)))))
(assert (= cat_135 (mk_potato_11 cat_100)))
(assert (= cat_136 ((_ to_fp 11 53) RNE (fp.add RNE (spoon_49 (get_potato_14_b (get_potato_16_a cat_67))) (spoon_49 (get_potato_14_b cat_128))))))
(assert (fp.lt (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000) cat_136))
(assert (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) (spoon_49 (get_potato_14_b cat_128))))
(assert (not (not (fp.isZero ((_ to_fp 11 53) RNE (spoon_49 (get_potato_14_b cat_128)))))))
(check-sat)
(exit)
