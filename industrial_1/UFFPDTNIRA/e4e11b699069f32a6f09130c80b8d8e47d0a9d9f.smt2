...
(declare-const cat_104 potato_12)
(declare-const cat_105 Float64)
(declare-const cat_106 Float64)
(declare-const cat_107 potato_11)
...
(assert (= cat_105 cat_99))
(assert (= cat_106 ((_ to_fp 11 53) RNE (fp.add RNE (spoon_47 (get_potato_14_a (get_potato_16_a cat_67))) (spoon_47 (get_potato_14_a (get_potato_16_a cat_69)))))))
(assert (not (fp.lt (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000) cat_106)))
(assert (fp.lt cat_106 (fp.neg (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000))))
(assert (fp.lt (spoon_47 (get_potato_14_a (get_potato_16_a cat_69))) (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (and (= cat_102 (fp.div RNE ((_ to_fp 11 53) RNE (fp.sub RNE (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (spoon_47 (get_potato_14_a (get_potato_16_a cat_67))))) ((_ to_fp 11 53) RNE (spoon_47 (get_potato_14_a (get_potato_16_a cat_69)))))) (spoon_3 (fp.div RNE ((_ to_fp 11 53) RNE (fp.sub RNE (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (spoon_47 (get_potato_14_a (get_potato_16_a cat_67))))) ((_ to_fp 11 53) RNE (spoon_47 (get_potato_14_a (get_potato_16_a cat_69))))))))
(assert (and (= cat_103 cat_102) (spoon_3 cat_102)))
(assert (= cat_107 (mk_potato_11 cat_101)))
(assert (= cat_108 cat_103))
(assert (= (spoon_47 cat_104) ((_ to_fp 8 24) RNE (fp.mul RNE ((_ to_fp 11 53) RNE (spoon_47 (get_potato_14_b (get_potato_16_a cat_69)))) cat_108))))
(assert (not (spoon_40 (fp.sub RNE (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (spoon_47 (get_potato_14_a (get_potato_16_a cat_67)))))))
(check-sat)
(exit)
