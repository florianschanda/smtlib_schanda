...
(declare-fun spoon_23 ((_ FloatingPoint 8 24) (_ FloatingPoint 8 24)) (_ FloatingPoint 8 24))
(declare-fun spoon_24 ((_ FloatingPoint 8 24) (_ FloatingPoint 8 24) (_ FloatingPoint 8 24)) Bool)
(declare-sort potato_11 0)
(define-fun spoon_25 ((kitten_23 (_ FloatingPoint 8 24))) Bool (let ((_let_0 (fp (_ bv0 1) (_ bv134 8) (_ bv3407872 23)))) (and (spoon_1 kitten_23) (and (fp.leq (fp.neg _let_0) kitten_23) (fp.leq kitten_23 _let_0)))))
...
(define-fun spoon_32 ((kitten_25 (_ FloatingPoint 8 24)) (kitten_26 Bool) (kitten_27 Bool) (kitten_28 Bool) (kitten_29 Bool)) Bool (let ((_let_0 (fp (_ bv0 1) (_ bv134 8) (_ bv3407872 23)))) (=> (or (= kitten_26 true) (fp.leq (fp.neg _let_0) _let_0)) (spoon_25 kitten_25))))
(declare-sort potato_13 0)
(define-fun spoon_33 ((kitten_30 (_ FloatingPoint 8 24))) Bool (let ((_let_0 (fp (_ bv0 1) (_ bv140 8) (_ bv0 23)))) (and (spoon_1 kitten_30) (and (fp.leq (fp.neg _let_0) kitten_30) (fp.leq kitten_30 _let_0)))))
...
(define-fun spoon_40 ((kitten_32 (_ FloatingPoint 8 24)) (kitten_33 Bool) (kitten_34 Bool) (kitten_35 Bool) (kitten_36 Bool)) Bool (let ((_let_0 (fp (_ bv0 1) (_ bv140 8) (_ bv0 23)))) (=> (or (= kitten_33 true) (fp.leq (fp.neg _let_0) _let_0)) (spoon_33 kitten_32))))
(assert (forall ((kitten_37 (_ FloatingPoint 8 24)) (kitten_38 (_ FloatingPoint 8 24))) (! (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (and (and (spoon_40 kitten_37 true true true true) (spoon_40 kitten_38 true true true true)) (or (not (fp.eq kitten_37 _let_0)) (not (fp.eq kitten_38 _let_0)))) (spoon_32 (spoon_23 kitten_37 kitten_38) true false true true))) :pattern ((spoon_23 kitten_37 kitten_38)))))
(declare-sort potato_15 0)
(define-fun spoon_41 ((kitten_39 (_ FloatingPoint 8 24))) Bool (let ((_let_0 (fp (_ bv0 1) (_ bv139 8) (_ bv0 23)))) (and (spoon_1 kitten_39) (and (fp.leq (fp.neg _let_0) kitten_39) (fp.leq kitten_39 _let_0)))))
...
(assert (forall ((kitten_43 (_ FloatingPoint 8 24))) (! (=> (spoon_41 kitten_43) (= (spoon_48 (spoon_49 kitten_43)) kitten_43)) :pattern ((spoon_48 (spoon_49 kitten_43))))))
...
(define-fun spoon_54 ((kitten_48 potato_19) (kitten_49 potato_19)) Bool (let ((_let_0 (get_potato_19_a kitten_48))) (let ((_let_1 (get_potato_19_a kitten_49))) (ite (and (= (spoon_48 (get_potato_17_a _let_0)) (spoon_48 (get_potato_17_a _let_1))) (= (spoon_48 (get_potato_17_b _let_0)) (spoon_48 (get_potato_17_b _let_1)))) true false))))
...
(define-fun spoon_68 ((kitten_53 (_ FloatingPoint 8 24))) Bool (and (spoon_1 kitten_53) (and (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) kitten_53) (fp.leq kitten_53 (fp (_ bv0 1) (_ bv135 8) (_ bv3407872 23))))))
...
(define-fun spoon_75 ((kitten_55 (_ FloatingPoint 8 24)) (kitten_56 Bool) (kitten_57 Bool) (kitten_58 Bool) (kitten_59 Bool)) Bool (=> (or (= kitten_56 true) (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) (fp (_ bv0 1) (_ bv135 8) (_ bv3407872 23)))) (spoon_68 kitten_55)))
(declare-fun cat_76 () potato_19)
(declare-fun cat_77 () Int)
(declare-fun cat_78 () potato_19)
(declare-fun cat_79 () Int)
(declare-fun cat_80 () Int)
(declare-fun cat_81 () Int)
(declare-fun cat_82 () Int)
(declare-fun cat_83 () Int)
(define-fun spoon_84 ((kitten_60 (_ FloatingPoint 8 24)) (kitten_61 Bool) (kitten_62 Bool) (kitten_63 Bool) (kitten_64 Bool)) Bool (let ((_let_0 (fp (_ bv0 1) (_ bv139 8) (_ bv0 23)))) (=> (or (= kitten_61 true) (fp.leq (fp.neg _let_0) _let_0)) (spoon_41 kitten_60))))
...
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv140 8) (_ bv0 23)))) (=> (fp.leq (fp.neg _let_0) _let_0) (spoon_33 cat_85))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv140 8) (_ bv0 23)))) (=> (fp.leq (fp.neg _let_0) _let_0) (spoon_33 cat_86))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv134 8) (_ bv3407872 23)))) (=> (fp.leq (fp.neg _let_0) _let_0) (spoon_25 cat_87))))
(assert (=> (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) (fp (_ bv0 1) (_ bv135 8) (_ bv3407872 23))) (spoon_68 cat_88)))
(assert (not (= (spoon_54 cat_76 cat_78) true)))
(assert (= cat_89 (fp.sub roundNearestTiesToEven (spoon_48 (get_potato_17_a (get_potato_19_a cat_78))) (spoon_48 (get_potato_17_a (get_potato_19_a cat_76))))))
(assert (= cat_90 (fp.sub roundNearestTiesToEven (spoon_48 (get_potato_17_b (get_potato_19_a cat_78))) (spoon_48 (get_potato_17_b (get_potato_19_a cat_76))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (not (or (not (fp.eq cat_89 _let_0)) (not (fp.eq cat_90 _let_0))))))
(check-sat)
(exit)
