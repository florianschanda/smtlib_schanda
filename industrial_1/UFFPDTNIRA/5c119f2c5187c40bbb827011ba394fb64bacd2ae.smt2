...
(assert (= cat_89 (fp.sub RNE (spoon_48 (get_potato_17_a (get_potato_19_a cat_78))) (spoon_48 (get_potato_17_a (get_potato_19_a cat_76))))))
(assert (= cat_90 (fp.sub RNE (spoon_48 (get_potato_17_b (get_potato_19_a cat_78))) (spoon_48 (get_potato_17_b (get_potato_19_a cat_76))))))
(assert (not (or (not (fp.eq cat_89 (fp #b0 #b00000000 #b00000000000000000000000))) (not (fp.eq cat_90 (fp #b0 #b00000000 #b00000000000000000000000))))))
(check-sat)
(exit)
