...
(assert (=> (= cat_319 true) (= cat_318 true)))
(assert (=> (not (= cat_319 true)) (=> (fp.lt cat_317 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_258 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_317)) (spoon_1 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_317))))))
(assert (=> (not (= cat_319 true)) (=> (fp.lt cat_317 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_259 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_315)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_315))))))
(assert (=> (not (= cat_319 true)) (=> (fp.lt cat_317 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_260 (ite (fp.leq cat_259 cat_258) true false)))))
(assert (=> (not (= cat_319 true)) (=> (fp.lt cat_317 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_256 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_315)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_315))))))
(assert (=> (not (= cat_319 true)) (=> (fp.lt cat_317 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_257 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_317)) (spoon_1 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_317))))))
(assert (=> (not (= cat_319 true)) (=> (fp.lt cat_317 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_261 (ite (fp.leq cat_257 cat_256) true false)))))
(assert (=> (not (= cat_319 true)) (=> (fp.lt cat_317 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_318 (ite (= cat_261 true) cat_260 false)))))
(assert (=> (not (= cat_319 true)) (=> (not (fp.lt cat_317 (fp #b0 #b00000000 #b00000000000000000000000))) (= cat_318 false))))
(assert (= cat_318 true))
(assert (and (= cat_268 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_315)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_315))))
(assert (= cat_269 (fp.div RNE cat_268 cat_317)))
