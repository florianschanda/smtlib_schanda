...
(declare-const cat_279 potato_7)
(declare-const cat_280 Bool)
(declare-const cat_281 potato_25)
(declare-const cat_282 potato_24)
(declare-const cat_283 Bool)
(declare-const cat_284 Bool)
(declare-const cat_285 potato_24)
...
(declare-const cat_294 potato_7)
(declare-const cat_295 Bool)
...
(declare-const cat_304 potato_7)
...
(assert (= cat_279 (mk_potato_7 cat_203)))
(assert (= cat_280 (spoon_37 1)))
(assert (= cat_281 (mk_potato_25 (mk_potato_24 cat_201 cat_202))))
(assert (= cat_282 (get_potato_26_a cat_111)))
(assert (= cat_225 (spoon_113 cat_167 cat_74)))
(assert (= cat_283 (ite (not (= cat_225 true)) true false)))
(assert (= cat_283 true))
(assert (=> (= cat_284 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_285))) (and (= cat_226 (spoon_149 (fp #b0 #b10000101 #b01100111111101011101000))) (spoon_129 cat_226)))))
(assert (=> (= cat_284 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_285))) (= cat_286 (mk_potato_10 cat_278)))))
(assert (=> (= cat_284 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_285))) (= cat_287 cat_226))))
(assert (=> (= cat_284 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_285)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_285)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (and (= cat_227 (spoon_149 (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (spoon_129 cat_227))))))
(assert (=> (= cat_284 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_285)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_285)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_288 (mk_potato_10 cat_278))))))
(assert (=> (= cat_284 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_285)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_285)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_289 cat_227)))))
(assert (=> (= cat_284 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_285)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_285)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_228 (spoon_84 (get_potato_24_a cat_285))) (spoon_1 (spoon_84 (get_potato_24_a cat_285))))))))
(assert (=> (= cat_284 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_285)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_285)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_229 (spoon_149 cat_228)) (spoon_129 cat_229))))))
(assert (=> (= cat_284 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_285)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_285)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_290 (mk_potato_10 cat_278))))))
(assert (=> (= cat_284 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_285)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_285)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_291 cat_229)))))
(assert (=> (= cat_284 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_285)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_285)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_289 cat_291)))))
(assert (=> (= cat_284 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_285)))) (= cat_287 cat_289))))
(assert (=> (= cat_284 true) (=> (spoon_189 cat_175) (and (= cat_230 (fp.mul RNE cat_175 cat_175)) (spoon_1 (fp.mul RNE cat_175 cat_175))))))
(assert (=> (= cat_284 true) (=> (spoon_189 cat_175) (= cat_292 (mk_potato_10 cat_276)))))
(assert (=> (= cat_284 true) (=> (spoon_189 cat_175) (= cat_293 cat_230))))
(assert (=> (= cat_284 true) (=> (spoon_189 cat_175) (= cat_295 cat_284))))
(assert (=> (= cat_284 true) (=> (not (spoon_189 cat_175)) (= cat_294 (mk_potato_7 cat_284)))))
(assert (=> (= cat_284 true) (=> (not (spoon_189 cat_175)) (= cat_295 (spoon_37 0)))))
(assert (=> (= cat_284 true) (=> (not (spoon_189 cat_175)) (= cat_293 cat_276))))
(assert (=> (= cat_284 true) (= cat_296 (mk_potato_10 cat_270))))
(assert (=> (= cat_284 true) (= cat_297 ((_ to_fp 8 24) RNE (fp.sub RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) (fp.mul RNE cat_171 cat_171))))))
(assert (=> (= cat_284 true) (and (= cat_231 cat_297) (spoon_1 cat_297))))
(assert (=> (= cat_284 true) (and (= cat_232 (spoon_146 cat_231)) (spoon_138 cat_232))))
(assert (=> (= cat_284 true) (= cat_298 (mk_potato_10 cat_268))))
(assert (=> (= cat_284 true) (= cat_299 cat_232)))
(assert (=> (not (= cat_284 true)) (= cat_287 cat_278)))
(assert (=> (not (= cat_284 true)) (= cat_293 cat_276)))
(assert (=> (not (= cat_284 true)) (= cat_297 cat_270)))
(assert (=> (not (= cat_284 true)) (= cat_299 cat_268)))
(assert (=> (not (= cat_284 true)) (= cat_295 cat_284)))
(assert (=> (= cat_295 true) (and (= cat_233 (fp.sub RNE cat_297 cat_293)) (spoon_1 (fp.sub RNE cat_297 cat_293)))))
(assert (=> (= cat_295 true) (= cat_234 (fp.add RNE cat_233 (fp.mul RNE cat_287 cat_287)))))
(assert (=> (= cat_295 true) (and (= cat_235 cat_234) (spoon_1 cat_234))))
(assert (=> (= cat_295 true) (= cat_300 (mk_potato_10 cat_274))))
(assert (=> (= cat_295 true) (= cat_301 cat_235)))
(assert (=> (= cat_295 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_301) (and (= cat_236 cat_301) (spoon_1 cat_301)))))
(assert (=> (= cat_295 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_301) (and (= cat_237 (spoon_146 cat_236)) (spoon_138 cat_237)))))
(assert (=> (= cat_295 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_301) (= cat_302 (mk_potato_10 cat_272)))))
(assert (=> (= cat_295 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_301) (= cat_303 cat_237))))
(assert (=> (= cat_295 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_301) (= cat_305 cat_295))))
(assert (=> (= cat_295 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_301)) (= cat_304 (mk_potato_7 cat_295)))))
(assert (=> (= cat_295 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_301)) (= cat_305 (spoon_37 0)))))
(assert (=> (= cat_295 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_301)) (= cat_303 cat_272))))
(assert (=> (not (= cat_295 true)) (= cat_301 cat_274)))
(assert (=> (not (= cat_295 true)) (= cat_303 cat_272)))
(assert (=> (not (= cat_295 true)) (= cat_305 cat_295)))
(assert (= cat_305 true))
(assert (and (= cat_242 (fp.mul RNE cat_303 cat_175)) (spoon_1 (fp.mul RNE cat_303 cat_175))))
(assert (and (= cat_238 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_171 cat_171)) cat_293)) (spoon_1 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_171 cat_171)) cat_293))))
(assert (= cat_239 (fp.mul RNE cat_299 cat_238)))
(assert (and (= cat_240 cat_239) (spoon_1 cat_239)))
(assert (= cat_241 (fp.mul RNE cat_240 cat_287)))
...
(assert (= cat_306 (mk_potato_10 cat_211)))
(assert (= cat_307 cat_245))
(assert (and (= cat_246 (fp.mul RNE cat_303 cat_175)) (spoon_1 (fp.mul RNE cat_303 cat_175))))
(assert (= cat_247 (fp.mul RNE cat_246 cat_287)))
(assert (and (= cat_248 cat_247) (spoon_1 cat_247)))
(assert (and (= cat_249 (fp.mul RNE cat_299 cat_301)) (spoon_1 (fp.mul RNE cat_299 cat_301))))
(assert (= cat_250 (fp.sub RNE cat_249 cat_248)))
(assert (and (= cat_251 cat_250) (spoon_1 cat_250)))
(assert (= cat_308 (mk_potato_10 cat_212)))
(assert (= cat_309 cat_251))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_309) (and (= cat_260 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_309)) (spoon_1 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_309)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_309) (and (= cat_261 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_307)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_307)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_309) (= cat_262 (ite (fp.leq cat_261 cat_260) true false))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_309) (and (= cat_258 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_307)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_307)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_309) (and (= cat_259 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_309)) (spoon_1 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_309)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_309) (= cat_263 (ite (fp.leq cat_259 cat_258) true false))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_309) (= cat_311 (ite (= cat_263 true) cat_262 false))))
(assert (=> (not (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_309)) (= cat_311 false)))
(assert (=> (= cat_311 true) (= cat_310 true)))
(assert (=> (not (= cat_311 true)) (=> (fp.lt cat_309 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_254 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_309)) (spoon_1 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_309))))))
(assert (=> (not (= cat_311 true)) (=> (fp.lt cat_309 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_255 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_307)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_307))))))
(assert (=> (not (= cat_311 true)) (=> (fp.lt cat_309 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_256 (ite (fp.leq cat_255 cat_254) true false)))))
(assert (=> (not (= cat_311 true)) (=> (fp.lt cat_309 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_252 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_307)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_307))))))
(assert (=> (not (= cat_311 true)) (=> (fp.lt cat_309 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_253 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_309)) (spoon_1 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_309))))))
(assert (=> (not (= cat_311 true)) (=> (fp.lt cat_309 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_257 (ite (fp.leq cat_253 cat_252) true false)))))
(assert (=> (not (= cat_311 true)) (=> (fp.lt cat_309 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_310 (ite (= cat_257 true) cat_256 false)))))
(assert (=> (not (= cat_311 true)) (=> (not (fp.lt cat_309 (fp #b0 #b00000000 #b00000000000000000000000))) (= cat_310 false))))
(assert (= cat_310 true))
(assert (and (= cat_264 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_307)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_307))))
(assert (= cat_265 (fp.div RNE cat_264 cat_309)))
(assert (and (= cat_266 cat_265) (spoon_1 cat_265)))
(assert (not (spoon_76 cat_266)))
(check-sat)
(exit)
