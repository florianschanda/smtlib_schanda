...
(assert (= cat_291 true))
(assert (= cat_292 true))
(assert (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_293))) (and (= cat_230 (spoon_153 (fp #b0 #b10000101 #b01100111111101011101000))) (spoon_133 cat_230))))
(assert (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_293))) (= cat_294 (mk_potato_10 cat_286))))
(assert (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_293))) (= cat_295 cat_230)))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_293)))) (=> (fp.lt (spoon_88 (get_potato_24_a cat_293)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (and (= cat_231 (spoon_153 (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (spoon_133 cat_231)))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_293)))) (=> (fp.lt (spoon_88 (get_potato_24_a cat_293)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_296 (mk_potato_10 cat_286)))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_293)))) (=> (fp.lt (spoon_88 (get_potato_24_a cat_293)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_297 cat_231))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_293)))) (=> (not (fp.lt (spoon_88 (get_potato_24_a cat_293)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_232 (spoon_88 (get_potato_24_a cat_293))) (spoon_1 (spoon_88 (get_potato_24_a cat_293)))))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_293)))) (=> (not (fp.lt (spoon_88 (get_potato_24_a cat_293)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_233 (spoon_153 cat_232)) (spoon_133 cat_233)))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_293)))) (=> (not (fp.lt (spoon_88 (get_potato_24_a cat_293)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_298 (mk_potato_10 cat_286)))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_293)))) (=> (not (fp.lt (spoon_88 (get_potato_24_a cat_293)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_299 cat_233))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_293)))) (=> (not (fp.lt (spoon_88 (get_potato_24_a cat_293)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_297 cat_299))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_293)))) (= cat_295 cat_297)))
