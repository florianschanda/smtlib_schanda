...
(declare-const cat_244 potato_25)
(declare-const cat_245 potato_24)
...
(assert (= cat_242 (mk_potato_7 cat_203)))
(assert (= cat_243 (spoon_37 1)))
(assert (= cat_244 (mk_potato_25 (mk_potato_24 cat_201 cat_202))))
(assert (= cat_245 (get_potato_26_a cat_111)))
(assert (= cat_225 (spoon_113 cat_167 cat_74)))
(assert (= cat_246 (ite (not (= cat_225 true)) true false)))
(assert (= cat_246 true))
(assert (= cat_247 true))
(assert (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_248))) (and (= cat_226 (spoon_149 (fp #b0 #b10000101 #b01100111111101011101000))) (spoon_129 cat_226))))
(assert (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_248))) (= cat_249 (mk_potato_10 cat_241))))
(assert (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_248))) (= cat_250 cat_226)))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_248)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_248)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (and (= cat_227 (spoon_149 (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (spoon_129 cat_227)))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_248)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_248)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_251 (mk_potato_10 cat_241)))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_248)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_248)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_252 cat_227))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_248)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_248)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_228 (spoon_84 (get_potato_24_a cat_248))) (spoon_1 (spoon_84 (get_potato_24_a cat_248)))))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_248)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_248)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_229 (spoon_149 cat_228)) (spoon_129 cat_229)))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_248)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_248)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_253 (mk_potato_10 cat_241)))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_248)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_248)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_254 cat_229))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_248)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_248)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_252 cat_254))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_248)))) (= cat_250 cat_252)))
(assert (spoon_189 cat_175))
(assert (not (spoon_1 (fp.mul RNE cat_175 cat_175))))
(check-sat)
(exit)
