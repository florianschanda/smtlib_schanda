...
(declare-const cat_232 potato_7)
(declare-const cat_233 Bool)
(declare-const cat_234 potato_19)
(declare-const cat_235 potato_18)
...
(assert (= cat_232 (mk_potato_7 cat_207)))
(assert (= cat_233 (spoon_41 1)))
(assert (= cat_234 (mk_potato_19 (mk_potato_18 cat_205 cat_206))))
(assert (= cat_235 (get_potato_20_a cat_89)))
(assert (= cat_236 (mk_potato_11 cat_210)))
(assert (= cat_237 (fp.mul RNE cat_185 cat_185)))
(assert (and (= cat_228 ((_ to_fp 11 53) RNE (fp.mul RNE cat_181 cat_181))) (spoon_2 ((_ to_fp 11 53) RNE (fp.mul RNE cat_181 cat_181)))))
(assert (= cat_238 (mk_potato_11 cat_208)))
(assert (= cat_239 cat_228))
(assert (and (= cat_229 ((_ to_fp 11 53) RNE (fp.mul RNE cat_183 cat_183))) (spoon_2 ((_ to_fp 11 53) RNE (fp.mul RNE cat_183 cat_183)))))
(assert (= cat_240 (mk_potato_11 cat_209)))
(assert (= cat_241 cat_229))
(assert (= cat_242 (mk_potato_11 cat_211)))
(assert (= cat_243 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_185)))
(assert (not (spoon_2 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_237))))
(check-sat)
(exit)
