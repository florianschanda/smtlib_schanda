...
(declare-const cat_230 potato_19)
(declare-const cat_231 potato_18)
...
(assert (= cat_229 (spoon_37 1)))
(assert (= cat_230 (mk_potato_19 (mk_potato_18 cat_201 cat_202))))
(assert (= cat_231 (get_potato_20_a cat_85)))
...
(assert (not (spoon_2 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_233))))
(check-sat)
(exit)
