...
(assert (= cat_160 ((_ to_fp 8 24) roundNearestTiesToEven (fp.mul roundNearestTiesToEven cat_129 cat_129))))
(assert (= cat_146 (fp.mul roundNearestTiesToEven cat_160 cat_159)))
(assert (spoon_1 (fp.mul roundNearestTiesToEven cat_160 cat_159)))
(assert (= cat_147 cat_146))
(assert (= cat_161 cat_147))
(assert (spoon_1 cat_146))
(assert (= cat_148 (fp.mul roundNearestTiesToEven cat_160 (fp.mul roundNearestTiesToEven cat_159 cat_159))))
(assert (spoon_1 (fp.mul roundNearestTiesToEven cat_160 (fp.mul roundNearestTiesToEven cat_159 cat_159))))
...
(assert (= cat_154 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv127 8) (_ bv0 23)) cat_162)))
(assert (spoon_1 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv127 8) (_ bv0 23)) cat_162)))
(assert (= cat_155 (ite (fp.leq cat_161 cat_154) true false)))
(assert (= cat_153 (fp.mul roundNearestTiesToEven (fp.neg (fp (_ bv0 1) (_ bv127 8) (_ bv0 23))) cat_162)))
(assert (spoon_1 (fp.mul roundNearestTiesToEven (fp.neg (fp (_ bv0 1) (_ bv127 8) (_ bv0 23))) cat_162)))
(assert (= cat_156 (ite (fp.leq cat_153 cat_161) true false)))
(assert (= cat_157 (ite (= cat_156 true) cat_155 false)))
(assert (= cat_163 (ite (fp.lt (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) cat_162) cat_157 false)))
(assert (= cat_163 true))
(assert (= cat_158 (fp.div roundNearestTiesToEven cat_161 cat_162)))
(assert (spoon_1 (fp.div roundNearestTiesToEven cat_161 cat_162)))
