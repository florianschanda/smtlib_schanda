...
(define-fun spoon_248 () potato_10 (mk_potato_10 cat_162))
(define-fun spoon_249 () potato_10 (mk_potato_10 cat_160))
...
(assert (= cat_183 (get_potato_31_a cat_168)))
...
(assert (= cat_185 (get_potato_31_a cat_172)))
...
(assert (= cat_186 (mk_potato_30 (mk_potato_29 cat_153 cat_154))))
(assert (= cat_187 (get_potato_31_a cat_176)))
(assert (and (= cat_177 (spoon_126 (mk_potato_31 cat_183) (mk_potato_31 cat_183))) (and (spoon_94 cat_177) (= cat_177 (fp.add RNE (fp.mul RNE (spoon_71 (get_potato_29_a cat_183)) (spoon_71 (get_potato_29_a cat_183))) (fp.mul RNE (spoon_71 (get_potato_29_b cat_183)) (spoon_71 (get_potato_29_b cat_183))))))))
(assert (= cat_188 (mk_potato_10 cat_155)))
(assert (= cat_189 cat_177))
(assert (and (= cat_178 (spoon_126 (mk_potato_31 cat_183) (mk_potato_31 cat_185))) (and (spoon_94 cat_178) (= cat_178 (fp.add RNE (fp.mul RNE (spoon_71 (get_potato_29_a cat_183)) (spoon_71 (get_potato_29_a cat_185))) (fp.mul RNE (spoon_71 (get_potato_29_b cat_183)) (spoon_71 (get_potato_29_b cat_185))))))))
(assert (= cat_190 (mk_potato_10 cat_156)))
(assert (= cat_191 cat_178))
(assert (and (= cat_179 (spoon_126 (mk_potato_31 cat_185) (mk_potato_31 cat_185))) (and (spoon_94 cat_179) (= cat_179 (fp.add RNE (fp.mul RNE (spoon_71 (get_potato_29_a cat_185)) (spoon_71 (get_potato_29_a cat_185))) (fp.mul RNE (spoon_71 (get_potato_29_b cat_185)) (spoon_71 (get_potato_29_b cat_185))))))))
(assert (= cat_192 (mk_potato_10 cat_157)))
(assert (= cat_193 cat_179))
(assert (and (= cat_180 (spoon_126 (mk_potato_31 cat_183) (mk_potato_31 cat_187))) (and (spoon_94 cat_180) (= cat_180 (fp.add RNE (fp.mul RNE (spoon_71 (get_potato_29_a cat_183)) (spoon_71 (get_potato_29_a cat_187))) (fp.mul RNE (spoon_71 (get_potato_29_b cat_183)) (spoon_71 (get_potato_29_b cat_187))))))))
(assert (= cat_194 (mk_potato_10 cat_158)))
(assert (= cat_195 cat_180))
(assert (and (= cat_181 (spoon_126 (mk_potato_31 cat_185) (mk_potato_31 cat_187))) (and (spoon_94 cat_181) (= cat_181 (fp.add RNE (fp.mul RNE (spoon_71 (get_potato_29_a cat_185)) (spoon_71 (get_potato_29_a cat_187))) (fp.mul RNE (spoon_71 (get_potato_29_b cat_185)) (spoon_71 (get_potato_29_b cat_187))))))))
...
(assert (=> (fp.lt cat_199 (fp #b0 #b01101011 #b00001100011011110111101)) (= cat_204 spoon_249)))
...
(assert (=> (fp.lt cat_199 (fp #b0 #b01101011 #b00001100011011110111101)) (= cat_208 spoon_248)))
...
(assert (=> (not (fp.lt cat_199 (fp #b0 #b01101011 #b00001100011011110111101))) (= cat_212 spoon_249)))
...
(assert (=> (not (fp.lt cat_199 (fp #b0 #b01101011 #b00001100011011110111101))) (= cat_214 spoon_248)))
...
(assert (not (fp.lt cat_237 (fp #b0 #b01101011 #b00001100011011110111101))))
(assert (not (spoon_1 (fp.div RNE cat_231 cat_237))))
(check-sat)
(exit)
