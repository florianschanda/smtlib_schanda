...
(declare-const cat_180 potato_30)
(declare-const cat_181 potato_29)
...
(define-fun spoon_246 () potato_10 (mk_potato_10 cat_160))
(define-fun spoon_247 () potato_10 (mk_potato_10 cat_158))
...
(assert (= cat_180 (mk_potato_30 (mk_potato_29 cat_147 cat_148))))
(assert (= cat_181 (get_potato_31_a cat_166)))
...
(assert (= cat_182 (mk_potato_30 (mk_potato_29 cat_149 cat_150))))
(assert (= cat_183 (get_potato_31_a cat_170)))
...
(assert (= cat_184 (mk_potato_30 (mk_potato_29 cat_151 cat_152))))
(assert (= cat_185 (get_potato_31_a cat_174)))
(assert (and (= cat_175 (spoon_124 (mk_potato_31 cat_181) (mk_potato_31 cat_181))) (and (spoon_92 cat_175) (= cat_175 (fp.add RNE (fp.mul RNE (spoon_69 (get_potato_29_a cat_181)) (spoon_69 (get_potato_29_a cat_181))) (fp.mul RNE (spoon_69 (get_potato_29_b cat_181)) (spoon_69 (get_potato_29_b cat_181))))))))
(assert (= cat_186 (mk_potato_10 cat_153)))
(assert (= cat_187 cat_175))
(assert (and (= cat_176 (spoon_124 (mk_potato_31 cat_181) (mk_potato_31 cat_183))) (and (spoon_92 cat_176) (= cat_176 (fp.add RNE (fp.mul RNE (spoon_69 (get_potato_29_a cat_181)) (spoon_69 (get_potato_29_a cat_183))) (fp.mul RNE (spoon_69 (get_potato_29_b cat_181)) (spoon_69 (get_potato_29_b cat_183))))))))
(assert (= cat_188 (mk_potato_10 cat_154)))
(assert (= cat_189 cat_176))
(assert (and (= cat_177 (spoon_124 (mk_potato_31 cat_183) (mk_potato_31 cat_183))) (and (spoon_92 cat_177) (= cat_177 (fp.add RNE (fp.mul RNE (spoon_69 (get_potato_29_a cat_183)) (spoon_69 (get_potato_29_a cat_183))) (fp.mul RNE (spoon_69 (get_potato_29_b cat_183)) (spoon_69 (get_potato_29_b cat_183))))))))
(assert (= cat_190 (mk_potato_10 cat_155)))
(assert (= cat_191 cat_177))
(assert (and (= cat_178 (spoon_124 (mk_potato_31 cat_181) (mk_potato_31 cat_185))) (and (spoon_92 cat_178) (= cat_178 (fp.add RNE (fp.mul RNE (spoon_69 (get_potato_29_a cat_181)) (spoon_69 (get_potato_29_a cat_185))) (fp.mul RNE (spoon_69 (get_potato_29_b cat_181)) (spoon_69 (get_potato_29_b cat_185))))))))
(assert (= cat_192 (mk_potato_10 cat_156)))
(assert (= cat_193 cat_178))
(assert (and (= cat_179 (spoon_124 (mk_potato_31 cat_183) (mk_potato_31 cat_185))) (and (spoon_92 cat_179) (= cat_179 (fp.add RNE (fp.mul RNE (spoon_69 (get_potato_29_a cat_183)) (spoon_69 (get_potato_29_a cat_185))) (fp.mul RNE (spoon_69 (get_potato_29_b cat_183)) (spoon_69 (get_potato_29_b cat_185))))))))
(assert (= cat_194 (mk_potato_10 cat_157)))
(assert (= cat_195 cat_179))
(assert (= cat_196 (mk_potato_10 cat_162)))
(assert (= cat_197 (fp.sub RNE (fp.mul RNE cat_187 cat_191) (fp.mul RNE cat_189 cat_189))))
(assert (= cat_198 (mk_potato_10 cat_159)))
(assert (= cat_199 cat_197))
(assert (= cat_200 (mk_potato_10 cat_161)))
(assert (= cat_201 cat_197))
(assert (=> (fp.lt cat_197 (fp #b0 #b01101011 #b00001100011011110111101)) (= cat_202 spoon_247)))
(assert (=> (fp.lt cat_197 (fp #b0 #b01101011 #b00001100011011110111101)) (= cat_203 (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (=> (fp.lt cat_197 (fp #b0 #b01101011 #b00001100011011110111101)) (= cat_204 (mk_potato_10 cat_199))))
(assert (=> (fp.lt cat_197 (fp #b0 #b01101011 #b00001100011011110111101)) (= cat_205 (fp #b0 #b01111111 #b00000000000000000000000))))
(assert (=> (fp.lt cat_197 (fp #b0 #b01101011 #b00001100011011110111101)) (= cat_206 spoon_246)))
(assert (=> (fp.lt cat_197 (fp #b0 #b01101011 #b00001100011011110111101)) (= cat_207 cat_195)))
(assert (=> (fp.lt cat_197 (fp #b0 #b01101011 #b00001100011011110111101)) (= cat_208 (mk_potato_10 cat_201))))
(assert (=> (fp.lt cat_197 (fp #b0 #b01101011 #b00001100011011110111101)) (= cat_209 cat_191)))
(assert (=> (not (fp.lt cat_197 (fp #b0 #b01101011 #b00001100011011110111101))) (= cat_210 spoon_247)))
(assert (=> (not (fp.lt cat_197 (fp #b0 #b01101011 #b00001100011011110111101))) (= cat_211 (fp.sub RNE (fp.mul RNE cat_189 cat_195) (fp.mul RNE cat_191 cat_193)))))
(assert (=> (not (fp.lt cat_197 (fp #b0 #b01101011 #b00001100011011110111101))) (= cat_212 spoon_246)))
(assert (=> (not (fp.lt cat_197 (fp #b0 #b01101011 #b00001100011011110111101))) (= cat_213 (fp.sub RNE (fp.mul RNE cat_187 cat_195) (fp.mul RNE cat_189 cat_193)))))
(assert (=> (not (fp.lt cat_197 (fp #b0 #b01101011 #b00001100011011110111101))) (=> (fp.lt cat_211 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_214 (mk_potato_10 cat_211)))))
(assert (=> (not (fp.lt cat_197 (fp #b0 #b01101011 #b00001100011011110111101))) (=> (fp.lt cat_211 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_215 (fp #b0 #b00000000 #b00000000000000000000000)))))
(assert (=> (not (fp.lt cat_197 (fp #b0 #b01101011 #b00001100011011110111101))) (=> (fp.lt cat_211 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_216 (mk_potato_10 cat_213)))))
(assert (=> (not (fp.lt cat_197 (fp #b0 #b01101011 #b00001100011011110111101))) (=> (fp.lt cat_211 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_217 cat_195))))
(assert (=> (not (fp.lt cat_197 (fp #b0 #b01101011 #b00001100011011110111101))) (=> (fp.lt cat_211 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_218 (mk_potato_10 cat_201)))))
(assert (=> (not (fp.lt cat_197 (fp #b0 #b01101011 #b00001100011011110111101))) (=> (fp.lt cat_211 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_219 cat_191))))
(assert (=> (not (fp.lt cat_197 (fp #b0 #b01101011 #b00001100011011110111101))) (=> (not (fp.lt cat_211 (fp #b0 #b00000000 #b00000000000000000000000))) (=> (fp.lt cat_199 cat_211) (= cat_220 (mk_potato_10 cat_211))))))
(assert (=> (not (fp.lt cat_197 (fp #b0 #b01101011 #b00001100011011110111101))) (=> (not (fp.lt cat_211 (fp #b0 #b00000000 #b00000000000000000000000))) (=> (fp.lt cat_199 cat_211) (= cat_221 cat_199)))))
(assert (=> (not (fp.lt cat_197 (fp #b0 #b01101011 #b00001100011011110111101))) (=> (not (fp.lt cat_211 (fp #b0 #b00000000 #b00000000000000000000000))) (=> (fp.lt cat_199 cat_211) (= cat_222 (mk_potato_10 cat_213))))))
(assert (=> (not (fp.lt cat_197 (fp #b0 #b01101011 #b00001100011011110111101))) (=> (not (fp.lt cat_211 (fp #b0 #b00000000 #b00000000000000000000000))) (=> (fp.lt cat_199 cat_211) (= cat_223 (fp.add RNE cat_195 cat_189))))))
(assert (=> (not (fp.lt cat_197 (fp #b0 #b01101011 #b00001100011011110111101))) (=> (not (fp.lt cat_211 (fp #b0 #b00000000 #b00000000000000000000000))) (=> (fp.lt cat_199 cat_211) (= cat_224 (mk_potato_10 cat_201))))))
(assert (=> (not (fp.lt cat_197 (fp #b0 #b01101011 #b00001100011011110111101))) (=> (not (fp.lt cat_211 (fp #b0 #b00000000 #b00000000000000000000000))) (=> (fp.lt cat_199 cat_211) (= cat_225 cat_191)))))
(assert (=> (not (fp.lt cat_197 (fp #b0 #b01101011 #b00001100011011110111101))) (=> (not (fp.lt cat_211 (fp #b0 #b00000000 #b00000000000000000000000))) (=> (not (fp.lt cat_199 cat_211)) (= cat_225 cat_201)))))
(assert (=> (not (fp.lt cat_197 (fp #b0 #b01101011 #b00001100011011110111101))) (=> (not (fp.lt cat_211 (fp #b0 #b00000000 #b00000000000000000000000))) (=> (not (fp.lt cat_199 cat_211)) (= cat_223 cat_213)))))
(assert (=> (not (fp.lt cat_197 (fp #b0 #b01101011 #b00001100011011110111101))) (=> (not (fp.lt cat_211 (fp #b0 #b00000000 #b00000000000000000000000))) (=> (not (fp.lt cat_199 cat_211)) (= cat_221 cat_211)))))
(assert (=> (not (fp.lt cat_197 (fp #b0 #b01101011 #b00001100011011110111101))) (=> (not (fp.lt cat_211 (fp #b0 #b00000000 #b00000000000000000000000))) (= cat_219 cat_225))))
(assert (=> (not (fp.lt cat_197 (fp #b0 #b01101011 #b00001100011011110111101))) (=> (not (fp.lt cat_211 (fp #b0 #b00000000 #b00000000000000000000000))) (= cat_217 cat_223))))
(assert (=> (not (fp.lt cat_197 (fp #b0 #b01101011 #b00001100011011110111101))) (=> (not (fp.lt cat_211 (fp #b0 #b00000000 #b00000000000000000000000))) (= cat_215 cat_221))))
(assert (=> (not (fp.lt cat_197 (fp #b0 #b01101011 #b00001100011011110111101))) (= cat_209 cat_219)))
(assert (=> (not (fp.lt cat_197 (fp #b0 #b01101011 #b00001100011011110111101))) (= cat_207 cat_217)))
(assert (=> (not (fp.lt cat_197 (fp #b0 #b01101011 #b00001100011011110111101))) (= cat_205 cat_199)))
(assert (=> (not (fp.lt cat_197 (fp #b0 #b01101011 #b00001100011011110111101))) (= cat_203 cat_215)))
(assert (=> (fp.lt cat_207 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_226 (mk_potato_10 cat_207))))
(assert (=> (fp.lt cat_207 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_227 (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (=> (fp.lt cat_207 (fp #b0 #b00000000 #b00000000000000000000000)) (=> (fp.lt (fp.neg cat_193) (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_228 (mk_potato_10 cat_203)))))
(assert (=> (fp.lt cat_207 (fp #b0 #b00000000 #b00000000000000000000000)) (=> (fp.lt (fp.neg cat_193) (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_229 (fp #b0 #b00000000 #b00000000000000000000000)))))
(assert (=> (fp.lt cat_207 (fp #b0 #b00000000 #b00000000000000000000000)) (=> (fp.lt (fp.neg cat_193) (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_235 cat_205))))
(assert (=> (fp.lt cat_207 (fp #b0 #b00000000 #b00000000000000000000000)) (=> (not (fp.lt (fp.neg cat_193) (fp #b0 #b00000000 #b00000000000000000000000))) (=> (fp.lt cat_187 (fp.neg cat_193)) (= cat_230 (mk_potato_10 cat_203))))))
(assert (=> (fp.lt cat_207 (fp #b0 #b00000000 #b00000000000000000000000)) (=> (not (fp.lt (fp.neg cat_193) (fp #b0 #b00000000 #b00000000000000000000000))) (=> (fp.lt cat_187 (fp.neg cat_193)) (= cat_231 cat_205)))))
(assert (=> (fp.lt cat_207 (fp #b0 #b00000000 #b00000000000000000000000)) (=> (not (fp.lt (fp.neg cat_193) (fp #b0 #b00000000 #b00000000000000000000000))) (=> (fp.lt cat_187 (fp.neg cat_193)) (= cat_235 cat_205)))))
(assert (=> (fp.lt cat_207 (fp #b0 #b00000000 #b00000000000000000000000)) (=> (not (fp.lt (fp.neg cat_193) (fp #b0 #b00000000 #b00000000000000000000000))) (=> (not (fp.lt cat_187 (fp.neg cat_193))) (= cat_232 (mk_potato_10 cat_203))))))
(assert (=> (fp.lt cat_207 (fp #b0 #b00000000 #b00000000000000000000000)) (=> (not (fp.lt (fp.neg cat_193) (fp #b0 #b00000000 #b00000000000000000000000))) (=> (not (fp.lt cat_187 (fp.neg cat_193))) (= cat_233 (fp.neg cat_193))))))
(assert (=> (fp.lt cat_207 (fp #b0 #b00000000 #b00000000000000000000000)) (=> (not (fp.lt (fp.neg cat_193) (fp #b0 #b00000000 #b00000000000000000000000))) (=> (not (fp.lt cat_187 (fp.neg cat_193))) (= cat_234 (mk_potato_10 cat_205))))))
(assert (=> (fp.lt cat_207 (fp #b0 #b00000000 #b00000000000000000000000)) (=> (not (fp.lt (fp.neg cat_193) (fp #b0 #b00000000 #b00000000000000000000000))) (=> (not (fp.lt cat_187 (fp.neg cat_193))) (= cat_235 cat_187)))))
(assert (=> (fp.lt cat_207 (fp #b0 #b00000000 #b00000000000000000000000)) (=> (not (fp.lt (fp.neg cat_193) (fp #b0 #b00000000 #b00000000000000000000000))) (=> (not (fp.lt cat_187 (fp.neg cat_193))) (= cat_231 cat_233)))))
(assert (=> (fp.lt cat_207 (fp #b0 #b00000000 #b00000000000000000000000)) (=> (not (fp.lt (fp.neg cat_193) (fp #b0 #b00000000 #b00000000000000000000000))) (= cat_229 cat_231))))
(assert (=> (not (fp.lt cat_207 (fp #b0 #b00000000 #b00000000000000000000000))) (=> (fp.lt cat_209 cat_207) (= cat_236 (mk_potato_10 cat_207)))))
(assert (=> (not (fp.lt cat_207 (fp #b0 #b00000000 #b00000000000000000000000))) (=> (fp.lt cat_209 cat_207) (= cat_237 cat_209))))
(assert (=> (not (fp.lt cat_207 (fp #b0 #b00000000 #b00000000000000000000000))) (=> (fp.lt cat_209 cat_207) (=> (fp.lt (fp.add RNE (fp.neg cat_193) cat_189) (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_238 (mk_potato_10 cat_203))))))
(assert (=> (not (fp.lt cat_207 (fp #b0 #b00000000 #b00000000000000000000000))) (=> (fp.lt cat_209 cat_207) (=> (fp.lt (fp.add RNE (fp.neg cat_193) cat_189) (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_239 (fp #b0 #b00000000 #b00000000000000000000000))))))
(assert (=> (not (fp.lt cat_207 (fp #b0 #b00000000 #b00000000000000000000000))) (=> (fp.lt cat_209 cat_207) (=> (fp.lt (fp.add RNE (fp.neg cat_193) cat_189) (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_245 cat_205)))))
(assert (=> (not (fp.lt cat_207 (fp #b0 #b00000000 #b00000000000000000000000))) (=> (fp.lt cat_209 cat_207) (=> (not (fp.lt (fp.add RNE (fp.neg cat_193) cat_189) (fp #b0 #b00000000 #b00000000000000000000000))) (=> (fp.lt cat_187 (fp.add RNE (fp.neg cat_193) cat_189)) (= cat_240 (mk_potato_10 cat_203)))))))
(assert (=> (not (fp.lt cat_207 (fp #b0 #b00000000 #b00000000000000000000000))) (=> (fp.lt cat_209 cat_207) (=> (not (fp.lt (fp.add RNE (fp.neg cat_193) cat_189) (fp #b0 #b00000000 #b00000000000000000000000))) (=> (fp.lt cat_187 (fp.add RNE (fp.neg cat_193) cat_189)) (= cat_241 cat_205))))))
(assert (=> (not (fp.lt cat_207 (fp #b0 #b00000000 #b00000000000000000000000))) (=> (fp.lt cat_209 cat_207) (=> (not (fp.lt (fp.add RNE (fp.neg cat_193) cat_189) (fp #b0 #b00000000 #b00000000000000000000000))) (=> (fp.lt cat_187 (fp.add RNE (fp.neg cat_193) cat_189)) (= cat_245 cat_205))))))
(assert (=> (not (fp.lt cat_207 (fp #b0 #b00000000 #b00000000000000000000000))) (=> (fp.lt cat_209 cat_207) (=> (not (fp.lt (fp.add RNE (fp.neg cat_193) cat_189) (fp #b0 #b00000000 #b00000000000000000000000))) (=> (not (fp.lt cat_187 (fp.add RNE (fp.neg cat_193) cat_189))) (= cat_242 (mk_potato_10 cat_203)))))))
(assert (=> (not (fp.lt cat_207 (fp #b0 #b00000000 #b00000000000000000000000))) (=> (fp.lt cat_209 cat_207) (=> (not (fp.lt (fp.add RNE (fp.neg cat_193) cat_189) (fp #b0 #b00000000 #b00000000000000000000000))) (=> (not (fp.lt cat_187 (fp.add RNE (fp.neg cat_193) cat_189))) (= cat_243 (fp.add RNE (fp.neg cat_193) cat_189)))))))
(assert (=> (not (fp.lt cat_207 (fp #b0 #b00000000 #b00000000000000000000000))) (=> (fp.lt cat_209 cat_207) (=> (not (fp.lt (fp.add RNE (fp.neg cat_193) cat_189) (fp #b0 #b00000000 #b00000000000000000000000))) (=> (not (fp.lt cat_187 (fp.add RNE (fp.neg cat_193) cat_189))) (= cat_244 (mk_potato_10 cat_205)))))))
(assert (=> (not (fp.lt cat_207 (fp #b0 #b00000000 #b00000000000000000000000))) (=> (fp.lt cat_209 cat_207) (=> (not (fp.lt (fp.add RNE (fp.neg cat_193) cat_189) (fp #b0 #b00000000 #b00000000000000000000000))) (=> (not (fp.lt cat_187 (fp.add RNE (fp.neg cat_193) cat_189))) (= cat_245 cat_187))))))
(assert (=> (not (fp.lt cat_207 (fp #b0 #b00000000 #b00000000000000000000000))) (=> (fp.lt cat_209 cat_207) (=> (not (fp.lt (fp.add RNE (fp.neg cat_193) cat_189) (fp #b0 #b00000000 #b00000000000000000000000))) (=> (not (fp.lt cat_187 (fp.add RNE (fp.neg cat_193) cat_189))) (= cat_241 cat_243))))))
(assert (=> (not (fp.lt cat_207 (fp #b0 #b00000000 #b00000000000000000000000))) (=> (fp.lt cat_209 cat_207) (=> (not (fp.lt (fp.add RNE (fp.neg cat_193) cat_189) (fp #b0 #b00000000 #b00000000000000000000000))) (= cat_239 cat_241)))))
(assert (=> (not (fp.lt cat_207 (fp #b0 #b00000000 #b00000000000000000000000))) (=> (not (fp.lt cat_209 cat_207)) (= cat_237 cat_207))))
(assert (=> (not (fp.lt cat_207 (fp #b0 #b00000000 #b00000000000000000000000))) (=> (not (fp.lt cat_209 cat_207)) (= cat_245 cat_205))))
(assert (=> (not (fp.lt cat_207 (fp #b0 #b00000000 #b00000000000000000000000))) (=> (not (fp.lt cat_209 cat_207)) (= cat_239 cat_203))))
(assert (=> (not (fp.lt cat_207 (fp #b0 #b00000000 #b00000000000000000000000))) (= cat_227 cat_237)))
(assert (=> (not (fp.lt cat_207 (fp #b0 #b00000000 #b00000000000000000000000))) (= cat_235 cat_245)))
(assert (=> (not (fp.lt cat_207 (fp #b0 #b00000000 #b00000000000000000000000))) (= cat_229 cat_239)))
(assert (not (fp.lt cat_235 (fp #b0 #b01101011 #b00001100011011110111101))))
(assert (not (spoon_1 (fp.div RNE cat_229 cat_235))))
(check-sat)
(exit)
