...
(declare-const cat_242 potato_29)
...
(assert (and (= cat_226 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_245)) (spoon_3 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_245))))
...
(assert (and (= cat_235 (fp.mul RNE cat_251 ((_ to_fp 11 53) RNE cat_179))) (spoon_3 (fp.mul RNE cat_251 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_236 (fp.mul RNE cat_235 cat_257)))
(assert (and (= cat_237 cat_236) (spoon_3 cat_236)))
(assert (and (= cat_233 (fp.sub RNE cat_253 cat_247)) (spoon_3 (fp.sub RNE cat_253 cat_247))))
