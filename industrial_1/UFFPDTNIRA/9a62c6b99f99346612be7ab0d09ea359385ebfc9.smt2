...
(declare-const cat_270 potato_7)
(declare-const cat_271 Bool)
(declare-const cat_272 potato_25)
(declare-const cat_273 potato_24)
(declare-const cat_274 Bool)
(declare-const cat_275 Bool)
(declare-const cat_276 potato_24)
...
(declare-const cat_285 potato_7)
...
(assert (= cat_258 cat_204))
(assert (= cat_259 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_1 cat_259))
(assert (= cat_260 (mk_potato_10 cat_205)))
(assert (= cat_261 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_1 cat_261))
(assert (= cat_262 (mk_potato_10 cat_206)))
(assert (= cat_263 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_1 cat_263))
(assert (= cat_264 (mk_potato_10 cat_207)))
(assert (= cat_265 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_1 cat_265))
(assert (= cat_266 (mk_potato_10 cat_208)))
(assert (= cat_267 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_1 cat_267))
(assert (= cat_268 (mk_potato_10 cat_209)))
(assert (= cat_269 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_129 cat_269))
...
(assert (= cat_270 (mk_potato_7 cat_203)))
(assert (= cat_271 (spoon_37 1)))
(assert (= cat_272 (mk_potato_25 (mk_potato_24 cat_201 cat_202))))
(assert (= cat_273 (get_potato_26_a cat_111)))
(assert (= cat_225 (spoon_113 cat_167 cat_74)))
(assert (= cat_274 (ite (not (= cat_225 true)) true false)))
(assert (= cat_274 true))
(assert (=> (= cat_275 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_276))) (and (= cat_226 (spoon_149 (fp #b0 #b10000101 #b01100111111101011101000))) (spoon_129 cat_226)))))
(assert (=> (= cat_275 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_276))) (= cat_277 (mk_potato_10 cat_269)))))
(assert (=> (= cat_275 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_276))) (= cat_278 cat_226))))
(assert (=> (= cat_275 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_276)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_276)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (and (= cat_227 (spoon_149 (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (spoon_129 cat_227))))))
(assert (=> (= cat_275 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_276)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_276)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_279 (mk_potato_10 cat_269))))))
(assert (=> (= cat_275 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_276)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_276)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_280 cat_227)))))
(assert (=> (= cat_275 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_276)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_276)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_228 (spoon_84 (get_potato_24_a cat_276))) (spoon_1 (spoon_84 (get_potato_24_a cat_276))))))))
(assert (=> (= cat_275 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_276)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_276)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_229 (spoon_149 cat_228)) (spoon_129 cat_229))))))
(assert (=> (= cat_275 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_276)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_276)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_281 (mk_potato_10 cat_269))))))
(assert (=> (= cat_275 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_276)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_276)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_282 cat_229)))))
(assert (=> (= cat_275 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_276)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_276)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_280 cat_282)))))
(assert (=> (= cat_275 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_276)))) (= cat_278 cat_280))))
(assert (=> (= cat_275 true) (=> (spoon_189 cat_175) (and (= cat_230 (fp.mul RNE cat_175 cat_175)) (spoon_1 (fp.mul RNE cat_175 cat_175))))))
(assert (=> (= cat_275 true) (=> (spoon_189 cat_175) (= cat_283 (mk_potato_10 cat_267)))))
(assert (=> (= cat_275 true) (=> (spoon_189 cat_175) (= cat_284 cat_230))))
(assert (=> (= cat_275 true) (=> (spoon_189 cat_175) (= cat_286 cat_275))))
(assert (=> (= cat_275 true) (=> (not (spoon_189 cat_175)) (= cat_285 (mk_potato_7 cat_275)))))
(assert (=> (= cat_275 true) (=> (not (spoon_189 cat_175)) (= cat_286 (spoon_37 0)))))
(assert (=> (= cat_275 true) (=> (not (spoon_189 cat_175)) (= cat_284 cat_267))))
(assert (=> (= cat_275 true) (= cat_287 (mk_potato_10 cat_261))))
(assert (=> (= cat_275 true) (= cat_288 ((_ to_fp 8 24) RNE (fp.sub RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) (fp.mul RNE cat_171 cat_171))))))
(assert (=> (= cat_275 true) (and (= cat_231 cat_288) (spoon_1 cat_288))))
(assert (=> (= cat_275 true) (and (= cat_232 (spoon_146 cat_231)) (spoon_138 cat_232))))
(assert (=> (= cat_275 true) (= cat_289 (mk_potato_10 cat_259))))
(assert (=> (= cat_275 true) (= cat_290 cat_232)))
(assert (=> (not (= cat_275 true)) (= cat_278 cat_269)))
(assert (=> (not (= cat_275 true)) (= cat_284 cat_267)))
(assert (=> (not (= cat_275 true)) (= cat_288 cat_261)))
(assert (=> (not (= cat_275 true)) (= cat_290 cat_259)))
(assert (=> (not (= cat_275 true)) (= cat_286 cat_275)))
(assert (=> (= cat_286 true) (and (= cat_233 (fp.sub RNE cat_288 cat_284)) (spoon_1 (fp.sub RNE cat_288 cat_284)))))
(assert (=> (= cat_286 true) (= cat_234 (fp.add RNE cat_233 (fp.mul RNE cat_278 cat_278)))))
(assert (=> (= cat_286 true) (and (= cat_235 cat_234) (spoon_1 cat_234))))
(assert (=> (= cat_286 true) (= cat_291 (mk_potato_10 cat_265))))
(assert (=> (= cat_286 true) (= cat_292 cat_235)))
(assert (=> (= cat_286 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_292) (and (= cat_236 cat_292) (spoon_1 cat_292)))))
(assert (=> (= cat_286 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_292) (and (= cat_237 (spoon_146 cat_236)) (spoon_138 cat_237)))))
(assert (=> (= cat_286 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_292) (= cat_293 (mk_potato_10 cat_263)))))
(assert (=> (= cat_286 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_292) (= cat_294 cat_237))))
(assert (=> (= cat_286 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_292) (= cat_296 cat_286))))
(assert (=> (= cat_286 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_292)) (= cat_295 (mk_potato_7 cat_286)))))
(assert (=> (= cat_286 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_292)) (= cat_296 (spoon_37 0)))))
(assert (=> (= cat_286 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_292)) (= cat_294 cat_263))))
(assert (=> (not (= cat_286 true)) (= cat_292 cat_265)))
(assert (=> (not (= cat_286 true)) (= cat_294 cat_263)))
(assert (=> (not (= cat_286 true)) (= cat_296 cat_286)))
(assert (= cat_296 true))
(assert (and (= cat_242 (fp.mul RNE cat_294 cat_175)) (spoon_1 (fp.mul RNE cat_294 cat_175))))
(assert (and (= cat_238 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_171 cat_171)) cat_284)) (spoon_1 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_171 cat_171)) cat_284))))
(assert (= cat_239 (fp.mul RNE cat_290 cat_238)))
(assert (and (= cat_240 cat_239) (spoon_1 cat_239)))
(assert (= cat_241 (fp.mul RNE cat_240 cat_278)))
...
(assert (= cat_297 (mk_potato_10 cat_211)))
(assert (= cat_298 cat_245))
(assert (and (= cat_246 (fp.mul RNE cat_294 cat_175)) (spoon_1 (fp.mul RNE cat_294 cat_175))))
(assert (= cat_247 (fp.mul RNE cat_246 cat_278)))
(assert (and (= cat_248 cat_247) (spoon_1 cat_247)))
(assert (and (= cat_249 (fp.mul RNE cat_290 cat_292)) (spoon_1 (fp.mul RNE cat_290 cat_292))))
(assert (= cat_250 (fp.sub RNE cat_249 cat_248)))
(assert (and (= cat_251 cat_250) (spoon_1 cat_250)))
(assert (= cat_299 (mk_potato_10 cat_212)))
(assert (= cat_300 cat_251))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_300) (and (= cat_254 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_300)) (spoon_1 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_300)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_300) (and (= cat_255 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_298)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_298)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_300) (= cat_256 (ite (fp.leq cat_255 cat_254) true false))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_300) (and (= cat_252 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_298)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_298)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_300) (and (= cat_253 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_300)) (spoon_1 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_300)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_300) (= cat_257 (ite (fp.leq cat_253 cat_252) true false))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_300) (= cat_301 (ite (= cat_257 true) cat_256 false))))
(assert (=> (not (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_300)) (= cat_301 false)))
(assert (not (= cat_301 true)))
(assert (fp.lt cat_300 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (not (spoon_1 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_300))))
(check-sat)
(exit)
