...
(assert (= cat_314 (mk_potato_10 cat_215)))
(assert (= cat_315 cat_249))
(assert (and (= cat_250 (fp.mul RNE cat_311 cat_179)) (spoon_1 (fp.mul RNE cat_311 cat_179))))
(assert (= cat_251 (fp.mul RNE cat_250 cat_295)))
(assert (and (= cat_252 cat_251) (spoon_1 cat_251)))
(assert (and (= cat_253 (fp.mul RNE cat_307 cat_309)) (spoon_1 (fp.mul RNE cat_307 cat_309))))
(assert (= cat_254 (fp.sub RNE cat_253 cat_252)))
(assert (and (= cat_255 cat_254) (spoon_1 cat_254)))
(assert (= cat_316 (mk_potato_10 cat_216)))
(assert (= cat_317 cat_255))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_317) (and (= cat_264 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_317)) (spoon_1 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_317)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_317) (and (= cat_265 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_315)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_315)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_317) (= cat_266 (ite (fp.leq cat_265 cat_264) true false))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_317) (and (= cat_262 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_315)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_315)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_317) (and (= cat_263 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_317)) (spoon_1 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_317)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_317) (= cat_267 (ite (fp.leq cat_263 cat_262) true false))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_317) (= cat_319 (ite (= cat_267 true) cat_266 false))))
(assert (=> (not (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_317)) (= cat_319 false)))
(assert (not (= cat_319 true)))
(assert (fp.lt cat_317 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (not (spoon_1 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_317))))
(check-sat)
(exit)
