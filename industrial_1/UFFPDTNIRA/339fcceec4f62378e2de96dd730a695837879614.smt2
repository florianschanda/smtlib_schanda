...
(declare-const cat_246 potato_29)
(declare-const cat_247 potato_28)
...
(assert (= cat_249 (fp.mul RNE cat_181 cat_181)))
...
(assert (= cat_255 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_181)))
(assert (and (= cat_226 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_249)) (spoon_3 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_249))))
...
(assert (and (= cat_237 (fp.mul RNE cat_255 ((_ to_fp 11 53) RNE cat_179))) (spoon_3 (fp.mul RNE cat_255 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_238 (fp.mul RNE cat_237 cat_261)))
(assert (and (= cat_239 cat_238) (spoon_3 cat_238)))
(assert (and (= cat_233 (fp.sub RNE cat_257 cat_251)) (spoon_3 (fp.sub RNE cat_257 cat_251))))
(assert (= cat_234 (fp.sub RNE cat_233 cat_253)))
(assert (and (= cat_235 cat_234) (spoon_3 cat_234)))
(assert (= cat_236 (fp.mul RNE cat_235 cat_259)))
