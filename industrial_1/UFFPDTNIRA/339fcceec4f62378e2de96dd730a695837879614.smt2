...
(declare-fun cat_244 () potato_7)
(declare-fun cat_245 () Bool)
(declare-fun cat_246 () potato_29)
(declare-fun cat_247 () potato_28)
...
(assert (= cat_242 cat_215))
(assert (= cat_243 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
(assert (spoon_100 cat_243))
...
(assert (= cat_244 (mk_potato_7 cat_203)))
(assert (= cat_245 (distinct 1 0)))
(assert (= cat_246 (mk_potato_29 (mk_potato_28 cat_201 cat_202))))
(assert (= cat_247 (get_potato_30_a cat_138)))
(assert (= cat_248 (mk_potato_11 cat_206)))
(assert (= cat_249 (fp.mul roundNearestTiesToEven cat_181 cat_181)))
...
(assert (= cat_250 (mk_potato_11 cat_204)))
(assert (= cat_251 cat_224))
...
(assert (= cat_252 (mk_potato_11 cat_205)))
(assert (= cat_253 cat_225))
(assert (= cat_254 (mk_potato_11 cat_207)))
(assert (= cat_255 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1025 11) (_ bv0 52)) cat_181)))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1025 11) (_ bv0 52)) cat_249))) (and (= cat_226 _let_0) (spoon_3 _let_0))))
(assert (= cat_256 (mk_potato_11 cat_208)))
(assert (= cat_257 cat_226))
...
(assert (= cat_258 (mk_potato_11 cat_209)))
(assert (= cat_259 cat_229))
...
(assert (= cat_260 (mk_potato_11 cat_210)))
(assert (= cat_261 cat_232))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_255 ((_ to_fp 11 53) roundNearestTiesToEven cat_179)))) (and (= cat_237 _let_0) (spoon_3 _let_0))))
(assert (= cat_238 (fp.mul roundNearestTiesToEven cat_237 cat_261)))
(assert (and (= cat_239 cat_238) (spoon_3 cat_238)))
(assert (let ((_let_0 (fp.sub roundNearestTiesToEven cat_257 cat_251))) (and (= cat_233 _let_0) (spoon_3 _let_0))))
(assert (= cat_234 (fp.sub roundNearestTiesToEven cat_233 cat_253)))
(assert (and (= cat_235 cat_234) (spoon_3 cat_234)))
(assert (= cat_236 (fp.mul roundNearestTiesToEven cat_235 cat_259)))
(assert (and (= cat_240 cat_236) (spoon_3 cat_236)))
(assert (= cat_241 (fp.add roundNearestTiesToEven cat_240 cat_239)))
(assert (not (spoon_3 cat_241)))
(check-sat)
(exit)
