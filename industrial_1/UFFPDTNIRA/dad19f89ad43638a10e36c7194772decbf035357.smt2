...
(assert (= cat_250 (spoon_37 1)))
(assert (= cat_251 (mk_potato_19 (mk_potato_18 cat_201 cat_202))))
(assert (= cat_252 (get_potato_20_a cat_85)))
...
(assert (and (= cat_226 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_254)) (spoon_2 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_254))))
...
(assert (and (= cat_237 (fp.mul RNE cat_260 ((_ to_fp 11 53) RNE cat_179))) (spoon_2 (fp.mul RNE cat_260 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_238 (fp.mul RNE cat_237 cat_266)))
(assert (and (= cat_239 cat_238) (spoon_2 cat_238)))
(assert (and (= cat_233 (fp.sub RNE cat_262 cat_256)) (spoon_2 (fp.sub RNE cat_262 cat_256))))
...
(assert (and (= cat_243 (fp.add RNE cat_262 cat_256)) (spoon_2 (fp.add RNE cat_262 cat_256))))
...
(assert (and (= cat_246 (fp.div RNE cat_268 cat_270)) (spoon_2 (fp.div RNE cat_268 cat_270))))
