...
(assert (and (= cat_230 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_258)) (spoon_3 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_258))))
...
(assert (and (= cat_241 (fp.mul RNE cat_264 ((_ to_fp 11 53) RNE cat_183))) (spoon_3 (fp.mul RNE cat_264 ((_ to_fp 11 53) RNE cat_183)))))
(assert (= cat_242 (fp.mul RNE cat_241 cat_270)))
(assert (and (= cat_243 cat_242) (spoon_3 cat_242)))
(assert (and (= cat_237 (fp.sub RNE cat_266 cat_260)) (spoon_3 (fp.sub RNE cat_266 cat_260))))
...
(assert (and (= cat_247 (fp.add RNE cat_266 cat_260)) (spoon_3 (fp.add RNE cat_266 cat_260))))
...
(assert (and (= cat_250 (fp.div RNE cat_272 cat_274)) (spoon_3 (fp.div RNE cat_272 cat_274))))
