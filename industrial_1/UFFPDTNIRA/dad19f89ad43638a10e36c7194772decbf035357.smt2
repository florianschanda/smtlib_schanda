...
(declare-const cat_255 potato_19)
(declare-const cat_256 potato_18)
...
(assert (= cat_253 (mk_potato_7 cat_207)))
(assert (= cat_254 (spoon_41 1)))
(assert (= cat_255 (mk_potato_19 (mk_potato_18 cat_205 cat_206))))
(assert (= cat_256 (get_potato_20_a cat_89)))
(assert (= cat_257 (mk_potato_11 cat_210)))
(assert (= cat_258 (fp.mul RNE cat_185 cat_185)))
...
(assert (= cat_263 (mk_potato_11 cat_211)))
(assert (= cat_264 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_185)))
(assert (and (= cat_230 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_258)) (spoon_2 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_258))))
(assert (= cat_265 (mk_potato_11 cat_212)))
...
(assert (= cat_270 cat_236))
(assert (and (= cat_241 (fp.mul RNE cat_264 ((_ to_fp 11 53) RNE cat_183))) (spoon_2 (fp.mul RNE cat_264 ((_ to_fp 11 53) RNE cat_183)))))
(assert (= cat_242 (fp.mul RNE cat_241 cat_270)))
(assert (and (= cat_243 cat_242) (spoon_2 cat_242)))
(assert (and (= cat_237 (fp.sub RNE cat_266 cat_260)) (spoon_2 (fp.sub RNE cat_266 cat_260))))
(assert (= cat_238 (fp.sub RNE cat_237 cat_262)))
(assert (and (= cat_239 cat_238) (spoon_2 cat_238)))
(assert (= cat_240 (fp.mul RNE cat_239 cat_268)))
...
(assert (= cat_271 (mk_potato_11 cat_217)))
(assert (= cat_272 cat_246))
(assert (and (= cat_247 (fp.add RNE cat_266 cat_260)) (spoon_2 (fp.add RNE cat_266 cat_260))))
(assert (= cat_248 (fp.add RNE cat_247 cat_262)))
(assert (and (= cat_249 cat_248) (spoon_2 cat_248)))
(assert (= cat_273 (mk_potato_11 cat_218)))
(assert (= cat_274 cat_249))
(assert (and (= cat_250 (fp.div RNE cat_272 cat_274)) (spoon_2 (fp.div RNE cat_272 cat_274))))
(assert (= cat_275 (mk_potato_11 cat_216)))
(assert (= cat_276 cat_250))
(assert (not (fp.lt cat_276 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))))
(assert (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_276)))
(assert (not (spoon_171 cat_276)))
(check-sat)
(exit)
