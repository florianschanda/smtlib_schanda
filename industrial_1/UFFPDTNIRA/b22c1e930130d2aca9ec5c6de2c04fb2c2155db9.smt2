...
(declare-fun cat_250 () potato_7)
(declare-fun cat_251 () Bool)
(declare-fun cat_252 () potato_29)
(declare-fun cat_253 () potato_28)
...
(assert (= cat_249 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
...
(assert (= cat_255 (fp.mul roundNearestTiesToEven cat_181 cat_181)))
...
(assert (= cat_261 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1025 11) (_ bv0 52)) cat_181)))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1025 11) (_ bv0 52)) cat_255))) (and (= cat_226 _let_0) (spoon_3 _let_0))))
...
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_261 ((_ to_fp 11 53) roundNearestTiesToEven cat_179)))) (and (= cat_237 _let_0) (spoon_3 _let_0))))
(assert (= cat_238 (fp.mul roundNearestTiesToEven cat_237 cat_267)))
(assert (and (= cat_239 cat_238) (spoon_3 cat_238)))
(assert (let ((_let_0 (fp.sub roundNearestTiesToEven cat_263 cat_257))) (and (= cat_233 _let_0) (spoon_3 _let_0))))
(assert (= cat_234 (fp.sub roundNearestTiesToEven cat_233 cat_259)))
(assert (and (= cat_235 cat_234) (spoon_3 cat_234)))
(assert (= cat_236 (fp.mul roundNearestTiesToEven cat_235 cat_265)))
...
(assert (let ((_let_0 (fp.add roundNearestTiesToEven cat_263 cat_257))) (and (= cat_243 _let_0) (spoon_3 _let_0))))
(assert (= cat_244 (fp.add roundNearestTiesToEven cat_243 cat_259)))
(assert (and (= cat_245 cat_244) (spoon_3 cat_244)))
(assert (= cat_270 (mk_potato_11 cat_214)))
(assert (= cat_271 cat_245))
(assert (let ((_let_0 (fp.div roundNearestTiesToEven cat_269 cat_271))) (and (= cat_246 _let_0) (spoon_3 _let_0))))
(assert (= cat_272 (mk_potato_11 cat_212)))
(assert (= cat_273 cat_246))
(assert (=> (fp.lt cat_273 (fp.neg (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (= cat_274 spoon_280)))
(assert (let ((_let_0 (fp.neg (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52))))) (=> (fp.lt cat_273 _let_0) (= cat_275 _let_0))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_273 (fp.neg _let_0))) (=> (fp.lt _let_0 cat_273) (= cat_276 spoon_280)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_273 (fp.neg _let_0))) (=> (fp.lt _let_0 cat_273) (= cat_277 _let_0)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_273 (fp.neg _let_0))) (=> (not (fp.lt _let_0 cat_273)) (and (= cat_247 cat_273) (spoon_3 cat_273))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_273 (fp.neg _let_0))) (=> (not (fp.lt _let_0 cat_273)) (= cat_278 spoon_280)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_273 (fp.neg _let_0))) (=> (not (fp.lt _let_0 cat_273)) (= cat_279 cat_247)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_273 (fp.neg _let_0))) (=> (not (fp.lt _let_0 cat_273)) (= cat_277 cat_279)))))
(assert (=> (not (fp.lt cat_273 (fp.neg (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52))))) (= cat_275 cat_277)))
(assert (not (spoon_3 (fp.mul roundNearestTiesToEven cat_261 ((_ to_fp 11 53) roundNearestTiesToEven cat_177)))))
(check-sat)
(exit)
