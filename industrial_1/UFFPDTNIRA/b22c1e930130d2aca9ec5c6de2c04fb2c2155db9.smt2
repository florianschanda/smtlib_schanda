...
(declare-const cat_250 potato_7)
(declare-const cat_251 Bool)
(declare-const cat_252 potato_29)
(declare-const cat_253 potato_28)
...
(define-fun spoon_280 () potato_11 (mk_potato_11 cat_211))
...
(assert (= cat_250 (mk_potato_7 cat_203)))
(assert (= cat_251 (distinct 1 0)))
(assert (= cat_252 (mk_potato_29 (mk_potato_28 cat_201 cat_202))))
(assert (= cat_253 (get_potato_30_a cat_138)))
(assert (= cat_254 (mk_potato_11 cat_206)))
(assert (= cat_255 (fp.mul RNE cat_181 cat_181)))
(assert (and (= cat_224 ((_ to_fp 11 53) RNE (fp.mul RNE cat_177 cat_177))) (spoon_3 ((_ to_fp 11 53) RNE (fp.mul RNE cat_177 cat_177)))))
(assert (= cat_256 (mk_potato_11 cat_204)))
(assert (= cat_257 cat_224))
(assert (and (= cat_225 ((_ to_fp 11 53) RNE (fp.mul RNE cat_179 cat_179))) (spoon_3 ((_ to_fp 11 53) RNE (fp.mul RNE cat_179 cat_179)))))
(assert (= cat_258 (mk_potato_11 cat_205)))
(assert (= cat_259 cat_225))
(assert (= cat_260 (mk_potato_11 cat_207)))
(assert (= cat_261 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_181)))
(assert (and (= cat_226 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_255)) (spoon_3 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_255))))
(assert (= cat_262 (mk_potato_11 cat_208)))
(assert (= cat_263 cat_226))
...
(assert (= cat_264 (mk_potato_11 cat_209)))
(assert (= cat_265 cat_229))
...
(assert (= cat_266 (mk_potato_11 cat_210)))
(assert (= cat_267 cat_232))
(assert (and (= cat_237 (fp.mul RNE cat_261 ((_ to_fp 11 53) RNE cat_179))) (spoon_3 (fp.mul RNE cat_261 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_238 (fp.mul RNE cat_237 cat_267)))
(assert (and (= cat_239 cat_238) (spoon_3 cat_238)))
(assert (and (= cat_233 (fp.sub RNE cat_263 cat_257)) (spoon_3 (fp.sub RNE cat_263 cat_257))))
(assert (= cat_234 (fp.sub RNE cat_233 cat_259)))
(assert (and (= cat_235 cat_234) (spoon_3 cat_234)))
(assert (= cat_236 (fp.mul RNE cat_235 cat_265)))
...
(assert (= cat_269 cat_242))
(assert (and (= cat_243 (fp.add RNE cat_263 cat_257)) (spoon_3 (fp.add RNE cat_263 cat_257))))
(assert (= cat_244 (fp.add RNE cat_243 cat_259)))
(assert (and (= cat_245 cat_244) (spoon_3 cat_244)))
(assert (= cat_270 (mk_potato_11 cat_214)))
(assert (= cat_271 cat_245))
(assert (and (= cat_246 (fp.div RNE cat_269 cat_271)) (spoon_3 (fp.div RNE cat_269 cat_271))))
(assert (= cat_272 (mk_potato_11 cat_212)))
(assert (= cat_273 cat_246))
(assert (=> (fp.lt cat_273 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))) (= cat_274 spoon_280)))
(assert (=> (fp.lt cat_273 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))) (= cat_275 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))))
(assert (=> (not (fp.lt cat_273 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_273) (= cat_276 spoon_280))))
(assert (=> (not (fp.lt cat_273 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_273) (= cat_277 (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))))
(assert (=> (not (fp.lt cat_273 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_273)) (and (= cat_247 cat_273) (spoon_3 cat_273)))))
(assert (=> (not (fp.lt cat_273 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_273)) (= cat_278 spoon_280))))
(assert (=> (not (fp.lt cat_273 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_273)) (= cat_279 cat_247))))
(assert (=> (not (fp.lt cat_273 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_273)) (= cat_277 cat_279))))
(assert (=> (not (fp.lt cat_273 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (= cat_275 cat_277)))
(assert (not (spoon_3 (fp.mul RNE cat_261 ((_ to_fp 11 53) RNE cat_177)))))
(check-sat)
(exit)
