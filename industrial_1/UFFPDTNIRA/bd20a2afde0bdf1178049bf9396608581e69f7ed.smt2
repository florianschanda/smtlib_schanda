...
(assert (= cat_273 (mk_potato_25 (mk_potato_24 cat_201 cat_202))))
(assert (= cat_274 (get_potato_26_a cat_111)))
(assert (= cat_225 (spoon_113 cat_167 cat_74)))
(assert (= cat_275 (ite (not (= cat_225 true)) true false)))
(assert (= cat_275 true))
(assert (=> (= cat_276 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_277))) (and (= cat_226 (spoon_149 (fp #b0 #b10000101 #b01100111111101011101000))) (spoon_129 cat_226)))))
(assert (=> (= cat_276 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_277))) (= cat_278 (mk_potato_10 cat_270)))))
(assert (=> (= cat_276 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_277))) (= cat_279 cat_226))))
(assert (=> (= cat_276 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_277)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_277)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (and (= cat_227 (spoon_149 (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (spoon_129 cat_227))))))
(assert (=> (= cat_276 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_277)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_277)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_280 (mk_potato_10 cat_270))))))
(assert (=> (= cat_276 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_277)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_277)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_281 cat_227)))))
(assert (=> (= cat_276 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_277)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_277)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_228 (spoon_84 (get_potato_24_a cat_277))) (spoon_1 (spoon_84 (get_potato_24_a cat_277))))))))
(assert (=> (= cat_276 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_277)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_277)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_229 (spoon_149 cat_228)) (spoon_129 cat_229))))))
(assert (=> (= cat_276 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_277)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_277)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_282 (mk_potato_10 cat_270))))))
(assert (=> (= cat_276 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_277)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_277)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_283 cat_229)))))
(assert (=> (= cat_276 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_277)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_277)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_281 cat_283)))))
(assert (=> (= cat_276 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_277)))) (= cat_279 cat_281))))
(assert (=> (= cat_276 true) (=> (spoon_189 cat_175) (and (= cat_230 (fp.mul RNE cat_175 cat_175)) (spoon_1 (fp.mul RNE cat_175 cat_175))))))
(assert (=> (= cat_276 true) (=> (spoon_189 cat_175) (= cat_284 (mk_potato_10 cat_268)))))
(assert (=> (= cat_276 true) (=> (spoon_189 cat_175) (= cat_285 cat_230))))
(assert (=> (= cat_276 true) (=> (spoon_189 cat_175) (= cat_287 cat_276))))
(assert (=> (= cat_276 true) (=> (not (spoon_189 cat_175)) (= cat_286 (mk_potato_7 cat_276)))))
(assert (=> (= cat_276 true) (=> (not (spoon_189 cat_175)) (= cat_287 (spoon_37 0)))))
(assert (=> (= cat_276 true) (=> (not (spoon_189 cat_175)) (= cat_285 cat_268))))
(assert (=> (= cat_276 true) (= cat_288 (mk_potato_10 cat_262))))
(assert (=> (= cat_276 true) (= cat_289 ((_ to_fp 8 24) RNE (fp.sub RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) (fp.mul RNE cat_171 cat_171))))))
(assert (=> (= cat_276 true) (and (= cat_231 cat_289) (spoon_1 cat_289))))
(assert (=> (= cat_276 true) (and (= cat_232 (spoon_146 cat_231)) (spoon_138 cat_232))))
(assert (=> (= cat_276 true) (= cat_290 (mk_potato_10 cat_260))))
(assert (=> (= cat_276 true) (= cat_291 cat_232)))
...
(assert (=> (= cat_287 true) (and (= cat_233 (fp.sub RNE cat_289 cat_285)) (spoon_1 (fp.sub RNE cat_289 cat_285)))))
(assert (=> (= cat_287 true) (= cat_234 (fp.add RNE cat_233 (fp.mul RNE cat_279 cat_279)))))
(assert (=> (= cat_287 true) (and (= cat_235 cat_234) (spoon_1 cat_234))))
(assert (=> (= cat_287 true) (= cat_292 (mk_potato_10 cat_266))))
(assert (=> (= cat_287 true) (= cat_293 cat_235)))
(assert (=> (= cat_287 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_293) (and (= cat_236 cat_293) (spoon_1 cat_293)))))
(assert (=> (= cat_287 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_293) (and (= cat_237 (spoon_146 cat_236)) (spoon_138 cat_237)))))
(assert (=> (= cat_287 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_293) (= cat_294 (mk_potato_10 cat_264)))))
(assert (=> (= cat_287 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_293) (= cat_295 cat_237))))
...
(assert (=> (= cat_287 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_293)) (= cat_297 (spoon_37 0)))))
...
(assert (= cat_297 true))
(assert (and (= cat_242 (fp.mul RNE cat_295 cat_175)) (spoon_1 (fp.mul RNE cat_295 cat_175))))
(assert (and (= cat_238 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_171 cat_171)) cat_285)) (spoon_1 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_171 cat_171)) cat_285))))
(assert (= cat_239 (fp.mul RNE cat_291 cat_238)))
(assert (and (= cat_240 cat_239) (spoon_1 cat_239)))
(assert (= cat_241 (fp.mul RNE cat_240 cat_279)))
...
(assert (= cat_298 (mk_potato_10 cat_211)))
(assert (= cat_299 cat_245))
(assert (and (= cat_246 (fp.mul RNE cat_295 cat_175)) (spoon_1 (fp.mul RNE cat_295 cat_175))))
(assert (= cat_247 (fp.mul RNE cat_246 cat_279)))
(assert (and (= cat_248 cat_247) (spoon_1 cat_247)))
(assert (and (= cat_249 (fp.mul RNE cat_291 cat_293)) (spoon_1 (fp.mul RNE cat_291 cat_293))))
(assert (= cat_250 (fp.sub RNE cat_249 cat_248)))
(assert (and (= cat_251 cat_250) (spoon_1 cat_250)))
(assert (= cat_300 (mk_potato_10 cat_212)))
(assert (= cat_301 cat_251))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_301) (and (= cat_255 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_301)) (spoon_1 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_301)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_301) (and (= cat_256 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_299)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_299)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_301) (= cat_257 (ite (fp.leq cat_256 cat_255) true false))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_301) (and (= cat_253 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_299)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_299)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_301) (and (= cat_254 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_301)) (spoon_1 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_301)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_301) (= cat_258 (ite (fp.leq cat_254 cat_253) true false))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_301) (= cat_302 (ite (= cat_258 true) cat_257 false))))
(assert (=> (not (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_301)) (= cat_302 false)))
(assert (not (= cat_302 true)))
(assert (fp.lt cat_301 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (and (= cat_252 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_301)) (spoon_1 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_301))))
