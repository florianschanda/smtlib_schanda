...
(declare-const cat_213 Bool)
(declare-const cat_214 Bool)
(declare-const cat_215 potato_28)
...
(assert (= cat_213 (ite (not (= cat_200 true)) true false)))
(assert (= cat_213 true))
(assert (=> (= cat_214 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_215))) (and (= cat_201 (spoon_76 (fp #b0 #b10000101 #b01100111111101011101000))) (spoon_86 cat_201)))))
(assert (=> (= cat_214 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_215))) (= cat_216 (mk_potato_10 cat_212)))))
(assert (=> (= cat_214 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_215))) (= cat_217 cat_201))))
(assert (=> (= cat_214 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_215)))) (=> (fp.lt (spoon_111 (get_potato_28_a cat_215)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (and (= cat_202 (spoon_76 (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (spoon_86 cat_202))))))
(assert (=> (= cat_214 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_215)))) (=> (fp.lt (spoon_111 (get_potato_28_a cat_215)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_218 (mk_potato_10 cat_212))))))
(assert (=> (= cat_214 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_215)))) (=> (fp.lt (spoon_111 (get_potato_28_a cat_215)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_219 cat_202)))))
(assert (=> (= cat_214 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_215)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_215)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_203 (spoon_111 (get_potato_28_a cat_215))) (spoon_1 (spoon_111 (get_potato_28_a cat_215))))))))
(assert (=> (= cat_214 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_215)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_215)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_204 (spoon_76 cat_203)) (spoon_86 cat_204))))))
(assert (=> (= cat_214 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_215)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_215)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_220 (mk_potato_10 cat_212))))))
(assert (=> (= cat_214 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_215)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_215)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_221 cat_204)))))
(assert (=> (= cat_214 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_215)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_215)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_219 cat_221)))))
(assert (=> (= cat_214 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_215)))) (= cat_217 cat_219))))
(assert (=> (= cat_214 true) (= cat_222 (mk_potato_10 cat_211))))
(assert (=> (= cat_214 true) (= cat_223 (fp.mul RNE cat_170 cat_170))))
(assert (=> (= cat_214 true) (= cat_224 (mk_potato_10 cat_208))))
(assert (=> (= cat_214 true) (= cat_225 ((_ to_fp 8 24) RNE (fp.sub RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) (fp.mul RNE cat_166 cat_166))))))
(assert (=> (= cat_214 true) (= cat_226 (mk_potato_10 cat_207))))
(assert (=> (= cat_214 true) (= cat_227 (fp.sqrt RNE cat_225))))
(assert (=> (not (= cat_214 true)) (= cat_217 cat_212)))
(assert (=> (not (= cat_214 true)) (= cat_223 cat_211)))
(assert (=> (not (= cat_214 true)) (= cat_225 cat_208)))
(assert (=> (not (= cat_214 true)) (= cat_227 cat_207)))
(assert (= cat_214 true))
(assert (= cat_205 (fp.sub RNE cat_225 cat_223)))
(assert (spoon_1 (fp.sub RNE cat_225 cat_223)))
(assert (= cat_206 (fp.add RNE cat_205 (fp.mul RNE cat_217 cat_217))))
(assert (not (spoon_1 cat_206)))
(check-sat)
(exit)
