...
(declare-const cat_258 potato_7)
(declare-const cat_259 Bool)
(declare-const cat_260 potato_25)
...
(declare-const cat_273 potato_7)
...
(assert (= cat_259 (spoon_37 1)))
(assert (= cat_260 (mk_potato_25 (mk_potato_24 cat_201 cat_202))))
(assert (= cat_261 (get_potato_26_a cat_111)))
(assert (= cat_225 (spoon_113 cat_167 cat_74)))
(assert (= cat_262 (ite (not (= cat_225 true)) true false)))
(assert (= cat_262 true))
(assert (=> (= cat_263 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_264))) (and (= cat_226 (spoon_149 (fp #b0 #b10000101 #b01100111111101011101000))) (spoon_129 cat_226)))))
(assert (=> (= cat_263 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_264))) (= cat_265 (mk_potato_10 cat_257)))))
(assert (=> (= cat_263 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_264))) (= cat_266 cat_226))))
(assert (=> (= cat_263 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_264)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_264)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (and (= cat_227 (spoon_149 (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (spoon_129 cat_227))))))
(assert (=> (= cat_263 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_264)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_264)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_267 (mk_potato_10 cat_257))))))
(assert (=> (= cat_263 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_264)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_264)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_268 cat_227)))))
(assert (=> (= cat_263 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_264)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_264)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_228 (spoon_84 (get_potato_24_a cat_264))) (spoon_1 (spoon_84 (get_potato_24_a cat_264))))))))
(assert (=> (= cat_263 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_264)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_264)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_229 (spoon_149 cat_228)) (spoon_129 cat_229))))))
(assert (=> (= cat_263 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_264)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_264)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_269 (mk_potato_10 cat_257))))))
(assert (=> (= cat_263 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_264)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_264)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_270 cat_229)))))
(assert (=> (= cat_263 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_264)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_264)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_268 cat_270)))))
(assert (=> (= cat_263 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_264)))) (= cat_266 cat_268))))
(assert (=> (= cat_263 true) (=> (spoon_189 cat_175) (and (= cat_230 (fp.mul RNE cat_175 cat_175)) (spoon_1 (fp.mul RNE cat_175 cat_175))))))
(assert (=> (= cat_263 true) (=> (spoon_189 cat_175) (= cat_271 (mk_potato_10 cat_255)))))
(assert (=> (= cat_263 true) (=> (spoon_189 cat_175) (= cat_272 cat_230))))
(assert (=> (= cat_263 true) (=> (spoon_189 cat_175) (= cat_274 cat_263))))
(assert (=> (= cat_263 true) (=> (not (spoon_189 cat_175)) (= cat_273 (mk_potato_7 cat_263)))))
(assert (=> (= cat_263 true) (=> (not (spoon_189 cat_175)) (= cat_274 (spoon_37 0)))))
(assert (=> (= cat_263 true) (=> (not (spoon_189 cat_175)) (= cat_272 cat_255))))
(assert (=> (= cat_263 true) (= cat_275 (mk_potato_10 cat_249))))
(assert (=> (= cat_263 true) (= cat_276 ((_ to_fp 8 24) RNE (fp.sub RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) (fp.mul RNE cat_171 cat_171))))))
(assert (=> (= cat_263 true) (and (= cat_231 cat_276) (spoon_1 cat_276))))
(assert (=> (= cat_263 true) (and (= cat_232 (spoon_146 cat_231)) (spoon_138 cat_232))))
(assert (=> (= cat_263 true) (= cat_277 (mk_potato_10 cat_247))))
(assert (=> (= cat_263 true) (= cat_278 cat_232)))
(assert (=> (not (= cat_263 true)) (= cat_266 cat_257)))
(assert (=> (not (= cat_263 true)) (= cat_272 cat_255)))
(assert (=> (not (= cat_263 true)) (= cat_276 cat_249)))
(assert (=> (not (= cat_263 true)) (= cat_278 cat_247)))
(assert (=> (not (= cat_263 true)) (= cat_274 cat_263)))
(assert (=> (= cat_274 true) (and (= cat_233 (fp.sub RNE cat_276 cat_272)) (spoon_1 (fp.sub RNE cat_276 cat_272)))))
(assert (=> (= cat_274 true) (= cat_234 (fp.add RNE cat_233 (fp.mul RNE cat_266 cat_266)))))
(assert (=> (= cat_274 true) (and (= cat_235 cat_234) (spoon_1 cat_234))))
(assert (=> (= cat_274 true) (= cat_279 (mk_potato_10 cat_253))))
(assert (=> (= cat_274 true) (= cat_280 cat_235)))
(assert (=> (= cat_274 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_280) (and (= cat_236 cat_280) (spoon_1 cat_280)))))
(assert (=> (= cat_274 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_280) (and (= cat_237 (spoon_146 cat_236)) (spoon_138 cat_237)))))
(assert (=> (= cat_274 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_280) (= cat_281 (mk_potato_10 cat_251)))))
(assert (=> (= cat_274 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_280) (= cat_282 cat_237))))
(assert (=> (= cat_274 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_280) (= cat_284 cat_274))))
(assert (=> (= cat_274 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_280)) (= cat_283 (mk_potato_7 cat_274)))))
(assert (=> (= cat_274 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_280)) (= cat_284 (spoon_37 0)))))
(assert (=> (= cat_274 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_280)) (= cat_282 cat_251))))
(assert (=> (not (= cat_274 true)) (= cat_280 cat_253)))
(assert (=> (not (= cat_274 true)) (= cat_282 cat_251)))
(assert (=> (not (= cat_274 true)) (= cat_284 cat_274)))
(assert (= cat_284 true))
(assert (and (= cat_242 (fp.mul RNE cat_282 cat_175)) (spoon_1 (fp.mul RNE cat_282 cat_175))))
(assert (and (= cat_238 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_171 cat_171)) cat_272)) (spoon_1 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_171 cat_171)) cat_272))))
(assert (= cat_239 (fp.mul RNE cat_278 cat_238)))
(assert (and (= cat_240 cat_239) (spoon_1 cat_239)))
(assert (= cat_241 (fp.mul RNE cat_240 cat_266)))
...
(assert (= cat_285 (mk_potato_10 cat_211)))
(assert (= cat_286 cat_245))
(assert (not (spoon_1 (fp.mul RNE cat_282 cat_175))))
(check-sat)
(exit)
