...
(assert (= cat_104 ((_ to_fp 11 53) RNE (fp.add RNE (spoon_49 (get_potato_14_a (get_potato_16_a cat_67))) (spoon_49 (get_potato_14_a (get_potato_16_a cat_69)))))))
...
(assert (fp.lt (spoon_49 (get_potato_14_a (get_potato_16_a cat_69))) (fp #b0 #b00000000 #b00000000000000000000000)))
