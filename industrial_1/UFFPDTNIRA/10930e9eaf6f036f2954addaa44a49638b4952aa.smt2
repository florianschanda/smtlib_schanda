...
(assert (= cat_107 cat_103))
(assert (= cat_108 ((_ to_fp 11 53) RNE (fp.add RNE (spoon_53 (get_potato_14_a (get_potato_16_a cat_71))) (spoon_53 (get_potato_14_a (get_potato_16_a cat_73)))))))
(assert (not (fp.lt (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000) cat_108)))
(assert (fp.lt cat_108 (fp.neg (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000))))
(assert (fp.lt (spoon_53 (get_potato_14_a (get_potato_16_a cat_73))) (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (and (= cat_106 (fp.div RNE ((_ to_fp 11 53) RNE (fp.sub RNE (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (spoon_53 (get_potato_14_a (get_potato_16_a cat_71))))) ((_ to_fp 11 53) RNE (spoon_53 (get_potato_14_a (get_potato_16_a cat_73)))))) (spoon_2 (fp.div RNE ((_ to_fp 11 53) RNE (fp.sub RNE (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (spoon_53 (get_potato_14_a (get_potato_16_a cat_71))))) ((_ to_fp 11 53) RNE (spoon_53 (get_potato_14_a (get_potato_16_a cat_73))))))))
(assert (not (spoon_90 cat_106)))
(check-sat)
(exit)
