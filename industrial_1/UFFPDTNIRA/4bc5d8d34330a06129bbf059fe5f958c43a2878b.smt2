...
(assert (= cat_148 cat_133))
(assert (= cat_149 (fp.sub RNE (spoon_30 (get_potato_13_a (get_potato_15_a cat_88))) (spoon_30 (get_potato_13_a (get_potato_15_a cat_86))))))
(assert (= cat_150 cat_134))
(assert (= cat_151 (fp.sub RNE (spoon_30 (get_potato_13_b (get_potato_15_a cat_88))) (spoon_30 (get_potato_13_b (get_potato_15_a cat_86))))))
(assert (= cat_152 cat_135))
...
(assert (= cat_155 (fp.add RNE (fp.mul RNE (fp.sub RNE (spoon_30 (get_potato_13_a (get_potato_15_a cat_84))) (spoon_30 (get_potato_13_a (get_potato_15_a cat_86)))) cat_149) (fp.mul RNE (fp.sub RNE (spoon_30 (get_potato_13_b (get_potato_15_a cat_84))) (spoon_30 (get_potato_13_b (get_potato_15_a cat_86)))) cat_151))))
(assert (and (= cat_141 (fp.div RNE cat_155 cat_153)) (spoon_1 (fp.div RNE cat_155 cat_153))))
(assert (and (= cat_142 cat_141) (spoon_1 cat_141)))
(assert (= cat_156 cat_139))
(assert (= cat_157 cat_142))
...
(assert (= cat_158 cat_138))
(assert (= cat_159 (fp.add RNE (fp.mul RNE (fp.sub RNE (spoon_30 (get_potato_13_a (get_potato_15_a cat_84))) (spoon_30 (get_potato_13_a (get_potato_15_a cat_86)))) (fp.neg cat_151)) (fp.mul RNE (fp.sub RNE (spoon_30 (get_potato_13_b (get_potato_15_a cat_84))) (spoon_30 (get_potato_13_b (get_potato_15_a cat_86)))) cat_149))))
(assert (and (= cat_143 cat_153) (spoon_1 cat_153)))
(assert (and (= cat_144 (spoon_72 cat_143)) (spoon_64 cat_144)))
(assert (and (= cat_145 cat_144) (spoon_1 cat_144)))
(assert (= cat_160 cat_136))
(assert (= cat_161 cat_145))
(assert (and (= cat_146 (fp.div RNE (fp.abs cat_159) cat_161)) (spoon_1 (fp.div RNE (fp.abs cat_159) cat_161))))
(assert (and (= cat_147 cat_146) (spoon_1 cat_146)))
(assert (= cat_162 cat_132))
(assert (= cat_163 cat_147))
(assert (not (spoon_74 cat_157)))
(check-sat)
(exit)
