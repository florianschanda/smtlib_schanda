...
(assert (not (fp.lt (fp (_ bv0 1) (_ bv133 8) (_ bv3407872 23)) (fp.add roundNearestTiesToEven (spoon_111 (get_potato_28_a cat_244)) cat_267))))
(assert (not (spoon_104 (fp.sub roundNearestTiesToEven (fp.neg (fp (_ bv0 1) (_ bv134 8) (_ bv3407872 23))) (fp.add roundNearestTiesToEven (spoon_111 (get_potato_28_a cat_244)) cat_267)))))
(check-sat)
(exit)
