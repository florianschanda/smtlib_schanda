...
(declare-fun cat_254 () potato_7)
(declare-fun cat_255 () Bool)
(declare-fun cat_256 () potato_29)
(declare-fun cat_257 () potato_28)
...
(assert (= cat_253 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
...
(assert (= cat_259 (fp.mul roundNearestTiesToEven cat_181 cat_181)))
...
(assert (= cat_265 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1025 11) (_ bv0 52)) cat_181)))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1025 11) (_ bv0 52)) cat_259))) (and (= cat_226 _let_0) (spoon_3 _let_0))))
...
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_265 ((_ to_fp 11 53) roundNearestTiesToEven cat_179)))) (and (= cat_237 _let_0) (spoon_3 _let_0))))
(assert (= cat_238 (fp.mul roundNearestTiesToEven cat_237 cat_271)))
(assert (and (= cat_239 cat_238) (spoon_3 cat_238)))
(assert (let ((_let_0 (fp.sub roundNearestTiesToEven cat_267 cat_261))) (and (= cat_233 _let_0) (spoon_3 _let_0))))
(assert (= cat_234 (fp.sub roundNearestTiesToEven cat_233 cat_263)))
(assert (and (= cat_235 cat_234) (spoon_3 cat_234)))
(assert (= cat_236 (fp.mul roundNearestTiesToEven cat_235 cat_269)))
...
(assert (let ((_let_0 (fp.add roundNearestTiesToEven cat_267 cat_261))) (and (= cat_243 _let_0) (spoon_3 _let_0))))
(assert (= cat_244 (fp.add roundNearestTiesToEven cat_243 cat_263)))
(assert (and (= cat_245 cat_244) (spoon_3 cat_244)))
(assert (= cat_274 (mk_potato_11 cat_214)))
(assert (= cat_275 cat_245))
(assert (let ((_let_0 (fp.div roundNearestTiesToEven cat_273 cat_275))) (and (= cat_246 _let_0) (spoon_3 _let_0))))
(assert (= cat_276 (mk_potato_11 cat_212)))
(assert (= cat_277 cat_246))
(assert (=> (fp.lt cat_277 (fp.neg (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (= cat_278 spoon_286)))
(assert (let ((_let_0 (fp.neg (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52))))) (=> (fp.lt cat_277 _let_0) (= cat_279 _let_0))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_277 (fp.neg _let_0))) (=> (fp.lt _let_0 cat_277) (= cat_280 spoon_286)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_277 (fp.neg _let_0))) (=> (fp.lt _let_0 cat_277) (= cat_281 _let_0)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_277 (fp.neg _let_0))) (=> (not (fp.lt _let_0 cat_277)) (and (= cat_247 cat_277) (spoon_3 cat_277))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_277 (fp.neg _let_0))) (=> (not (fp.lt _let_0 cat_277)) (= cat_282 spoon_286)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_277 (fp.neg _let_0))) (=> (not (fp.lt _let_0 cat_277)) (= cat_283 cat_247)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_277 (fp.neg _let_0))) (=> (not (fp.lt _let_0 cat_277)) (= cat_281 cat_283)))))
(assert (=> (not (fp.lt cat_277 (fp.neg (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52))))) (= cat_279 cat_281)))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_265 ((_ to_fp 11 53) roundNearestTiesToEven cat_177)))) (and (= cat_248 _let_0) (spoon_3 _let_0))))
(assert (= cat_284 (mk_potato_11 cat_216)))
(assert (= cat_285 cat_248))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_265 ((_ to_fp 11 53) roundNearestTiesToEven cat_179)))) (and (= cat_249 _let_0) (spoon_3 _let_0))))
(assert (= cat_250 (fp.mul roundNearestTiesToEven cat_249 cat_269)))
(assert (and (= cat_251 cat_250) (spoon_3 cat_250)))
(assert (not (spoon_3 (fp.sub roundNearestTiesToEven cat_267 cat_261))))
(check-sat)
(exit)
