...
(declare-const cat_256 potato_29)
(declare-const cat_257 potato_28)
...
(define-fun spoon_286 () potato_11 (mk_potato_11 cat_211))
...
(assert (= cat_254 (mk_potato_7 cat_203)))
(assert (= cat_255 (distinct 1 0)))
(assert (= cat_256 (mk_potato_29 (mk_potato_28 cat_201 cat_202))))
(assert (= cat_257 (get_potato_30_a cat_138)))
(assert (= cat_258 (mk_potato_11 cat_206)))
(assert (= cat_259 (fp.mul RNE cat_181 cat_181)))
(assert (and (= cat_224 ((_ to_fp 11 53) RNE (fp.mul RNE cat_177 cat_177))) (spoon_3 ((_ to_fp 11 53) RNE (fp.mul RNE cat_177 cat_177)))))
(assert (= cat_260 (mk_potato_11 cat_204)))
(assert (= cat_261 cat_224))
(assert (and (= cat_225 ((_ to_fp 11 53) RNE (fp.mul RNE cat_179 cat_179))) (spoon_3 ((_ to_fp 11 53) RNE (fp.mul RNE cat_179 cat_179)))))
(assert (= cat_262 (mk_potato_11 cat_205)))
(assert (= cat_263 cat_225))
(assert (= cat_264 (mk_potato_11 cat_207)))
(assert (= cat_265 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_181)))
(assert (and (= cat_226 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_259)) (spoon_3 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_259))))
(assert (= cat_266 (mk_potato_11 cat_208)))
(assert (= cat_267 cat_226))
...
(assert (= cat_268 (mk_potato_11 cat_209)))
(assert (= cat_269 cat_229))
...
(assert (= cat_270 (mk_potato_11 cat_210)))
(assert (= cat_271 cat_232))
(assert (and (= cat_237 (fp.mul RNE cat_265 ((_ to_fp 11 53) RNE cat_179))) (spoon_3 (fp.mul RNE cat_265 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_238 (fp.mul RNE cat_237 cat_271)))
(assert (and (= cat_239 cat_238) (spoon_3 cat_238)))
(assert (and (= cat_233 (fp.sub RNE cat_267 cat_261)) (spoon_3 (fp.sub RNE cat_267 cat_261))))
(assert (= cat_234 (fp.sub RNE cat_233 cat_263)))
(assert (and (= cat_235 cat_234) (spoon_3 cat_234)))
(assert (= cat_236 (fp.mul RNE cat_235 cat_269)))
...
(assert (= cat_272 (mk_potato_11 cat_213)))
(assert (= cat_273 cat_242))
(assert (and (= cat_243 (fp.add RNE cat_267 cat_261)) (spoon_3 (fp.add RNE cat_267 cat_261))))
(assert (= cat_244 (fp.add RNE cat_243 cat_263)))
(assert (and (= cat_245 cat_244) (spoon_3 cat_244)))
(assert (= cat_274 (mk_potato_11 cat_214)))
(assert (= cat_275 cat_245))
(assert (and (= cat_246 (fp.div RNE cat_273 cat_275)) (spoon_3 (fp.div RNE cat_273 cat_275))))
(assert (= cat_276 (mk_potato_11 cat_212)))
(assert (= cat_277 cat_246))
(assert (=> (fp.lt cat_277 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))) (= cat_278 spoon_286)))
...
(assert (=> (not (fp.lt cat_277 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_277) (= cat_280 spoon_286))))
...
(assert (=> (not (fp.lt cat_277 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_277)) (and (= cat_247 cat_277) (spoon_3 cat_277)))))
(assert (=> (not (fp.lt cat_277 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_277)) (= cat_282 spoon_286))))
(assert (=> (not (fp.lt cat_277 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_277)) (= cat_283 cat_247))))
...
(assert (and (= cat_248 (fp.mul RNE cat_265 ((_ to_fp 11 53) RNE cat_177))) (spoon_3 (fp.mul RNE cat_265 ((_ to_fp 11 53) RNE cat_177)))))
(assert (= cat_284 (mk_potato_11 cat_216)))
(assert (= cat_285 cat_248))
(assert (and (= cat_249 (fp.mul RNE cat_265 ((_ to_fp 11 53) RNE cat_179))) (spoon_3 (fp.mul RNE cat_265 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_250 (fp.mul RNE cat_249 cat_269)))
(assert (and (= cat_251 cat_250) (spoon_3 cat_250)))
(assert (not (spoon_3 (fp.sub RNE cat_267 cat_261))))
(check-sat)
(exit)
