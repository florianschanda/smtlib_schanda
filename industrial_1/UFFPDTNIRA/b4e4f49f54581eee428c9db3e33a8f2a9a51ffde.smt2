...
(assert (= cat_252 (spoon_37 1)))
(assert (= cat_253 (mk_potato_19 (mk_potato_18 cat_201 cat_202))))
(assert (= cat_254 (get_potato_20_a cat_85)))
(assert (= cat_255 (mk_potato_11 cat_206)))
(assert (= cat_256 (fp.mul RNE cat_181 cat_181)))
...
(assert (= cat_262 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_181)))
(assert (and (= cat_226 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_256)) (spoon_2 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_256))))
...
(assert (and (= cat_237 (fp.mul RNE cat_262 ((_ to_fp 11 53) RNE cat_179))) (spoon_2 (fp.mul RNE cat_262 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_238 (fp.mul RNE cat_237 cat_268)))
(assert (and (= cat_239 cat_238) (spoon_2 cat_238)))
(assert (and (= cat_233 (fp.sub RNE cat_264 cat_258)) (spoon_2 (fp.sub RNE cat_264 cat_258))))
(assert (= cat_234 (fp.sub RNE cat_233 cat_260)))
(assert (and (= cat_235 cat_234) (spoon_2 cat_234)))
(assert (= cat_236 (fp.mul RNE cat_235 cat_266)))
...
(assert (and (= cat_243 (fp.add RNE cat_264 cat_258)) (spoon_2 (fp.add RNE cat_264 cat_258))))
(assert (= cat_244 (fp.add RNE cat_243 cat_260)))
(assert (and (= cat_245 cat_244) (spoon_2 cat_244)))
(assert (= cat_271 (mk_potato_11 cat_214)))
(assert (= cat_272 cat_245))
(assert (and (= cat_246 (fp.div RNE cat_270 cat_272)) (spoon_2 (fp.div RNE cat_270 cat_272))))
(assert (= cat_273 (mk_potato_11 cat_212)))
(assert (= cat_274 cat_246))
(assert (=> (fp.lt cat_274 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))) (= cat_275 spoon_283)))
(assert (=> (fp.lt cat_274 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))) (= cat_276 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))))
(assert (=> (not (fp.lt cat_274 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_274) (= cat_277 spoon_283))))
(assert (=> (not (fp.lt cat_274 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_274) (= cat_278 (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))))
(assert (=> (not (fp.lt cat_274 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_274)) (and (= cat_247 cat_274) (spoon_2 cat_274)))))
(assert (=> (not (fp.lt cat_274 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_274)) (= cat_279 spoon_283))))
(assert (=> (not (fp.lt cat_274 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_274)) (= cat_280 cat_247))))
(assert (=> (not (fp.lt cat_274 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_274)) (= cat_278 cat_280))))
(assert (=> (not (fp.lt cat_274 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (= cat_276 cat_278)))
(assert (and (= cat_248 (fp.mul RNE cat_262 ((_ to_fp 11 53) RNE cat_177))) (spoon_2 (fp.mul RNE cat_262 ((_ to_fp 11 53) RNE cat_177)))))
(assert (= cat_281 (mk_potato_11 cat_216)))
(assert (= cat_282 cat_248))
(assert (not (spoon_2 (fp.mul RNE cat_262 ((_ to_fp 11 53) RNE cat_179)))))
(check-sat)
(exit)
