...
(assert (and (= cat_230 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_260)) (spoon_3 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_260))))
...
(assert (and (= cat_241 (fp.mul RNE cat_266 ((_ to_fp 11 53) RNE cat_183))) (spoon_3 (fp.mul RNE cat_266 ((_ to_fp 11 53) RNE cat_183)))))
(assert (= cat_242 (fp.mul RNE cat_241 cat_272)))
(assert (and (= cat_243 cat_242) (spoon_3 cat_242)))
(assert (and (= cat_237 (fp.sub RNE cat_268 cat_262)) (spoon_3 (fp.sub RNE cat_268 cat_262))))
...
(assert (and (= cat_247 (fp.add RNE cat_268 cat_262)) (spoon_3 (fp.add RNE cat_268 cat_262))))
...
(assert (and (= cat_250 (fp.div RNE cat_274 cat_276)) (spoon_3 (fp.div RNE cat_274 cat_276))))
...
(assert (=> (not (fp.lt cat_278 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_278)) (and (= cat_251 cat_278) (spoon_3 cat_278)))))
...
(assert (and (= cat_252 (fp.mul RNE cat_266 ((_ to_fp 11 53) RNE cat_181))) (spoon_3 (fp.mul RNE cat_266 ((_ to_fp 11 53) RNE cat_181)))))
(assert (= cat_285 (mk_potato_11 cat_220)))
(assert (= cat_286 cat_252))
(assert (not (spoon_3 (fp.mul RNE cat_266 ((_ to_fp 11 53) RNE cat_183)))))
(check-sat)
(exit)
