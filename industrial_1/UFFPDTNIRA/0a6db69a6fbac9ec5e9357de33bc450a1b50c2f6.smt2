...
(assert (and (= cat_212 (fp.mul RNE cat_229 cat_233)) (spoon_3 (fp.mul RNE cat_229 cat_233))))
(assert (= cat_213 (fp.mul RNE cat_212 cat_237)))
(assert (and (= cat_214 cat_213) (spoon_3 cat_213)))
(assert (and (= cat_210 (fp.mul RNE cat_227 cat_231)) (spoon_3 (fp.mul RNE cat_227 cat_231))))
...
(assert (and (= cat_218 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_145) cat_235)) (spoon_3 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_145) cat_235))))
(assert (= cat_219 (fp.mul RNE cat_218 cat_229)))
(assert (not (spoon_3 cat_219)))
(check-sat)
(exit)
