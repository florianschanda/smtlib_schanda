...
(assert (= cat_216 cat_177))
(assert (= cat_217 cat_191))
...
(assert (= cat_235 cat_213))
(assert (and (= cat_214 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_141) cat_231)) (spoon_2 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_141) cat_231))))
(assert (= cat_215 (fp.mul RNE cat_214 cat_225)))
(assert (not (spoon_2 cat_215)))
(check-sat)
(exit)
