...
(declare-const cat_211 Bool)
(declare-const cat_212 Bool)
(declare-const cat_213 potato_28)
...
(assert (= cat_205 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_1 cat_205))
(assert (= cat_206 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_1 cat_206))
(assert (= cat_207 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_1 cat_207))
...
(assert (= cat_211 (ite (not (= cat_200 true)) true false)))
(assert (= cat_211 true))
(assert (=> (= cat_212 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_213))) (and (= cat_201 (spoon_76 (fp #b0 #b10000101 #b01100111111101011101000))) (spoon_86 cat_201)))))
(assert (=> (= cat_212 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_213))) (= cat_214 (mk_potato_10 cat_210)))))
(assert (=> (= cat_212 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_213))) (= cat_215 cat_201))))
(assert (=> (= cat_212 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_213)))) (=> (fp.lt (spoon_111 (get_potato_28_a cat_213)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (and (= cat_202 (spoon_76 (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (spoon_86 cat_202))))))
(assert (=> (= cat_212 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_213)))) (=> (fp.lt (spoon_111 (get_potato_28_a cat_213)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_216 (mk_potato_10 cat_210))))))
(assert (=> (= cat_212 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_213)))) (=> (fp.lt (spoon_111 (get_potato_28_a cat_213)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_217 cat_202)))))
(assert (=> (= cat_212 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_213)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_213)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_203 (spoon_111 (get_potato_28_a cat_213))) (spoon_1 (spoon_111 (get_potato_28_a cat_213))))))))
(assert (=> (= cat_212 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_213)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_213)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_204 (spoon_76 cat_203)) (spoon_86 cat_204))))))
(assert (=> (= cat_212 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_213)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_213)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_218 (mk_potato_10 cat_210))))))
(assert (=> (= cat_212 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_213)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_213)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_219 cat_204)))))
(assert (=> (= cat_212 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_213)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_213)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_217 cat_219)))))
(assert (=> (= cat_212 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_213)))) (= cat_215 cat_217))))
(assert (=> (= cat_212 true) (= cat_220 (mk_potato_10 cat_209))))
(assert (=> (= cat_212 true) (= cat_221 (fp.mul RNE cat_170 cat_170))))
(assert (=> (= cat_212 true) (= cat_222 (mk_potato_10 cat_206))))
(assert (=> (= cat_212 true) (= cat_223 ((_ to_fp 8 24) RNE (fp.sub RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) (fp.mul RNE cat_166 cat_166))))))
(assert (=> (= cat_212 true) (= cat_224 (mk_potato_10 cat_205))))
(assert (=> (= cat_212 true) (= cat_225 (fp.sqrt RNE cat_223))))
(assert (=> (not (= cat_212 true)) (= cat_215 cat_210)))
(assert (=> (not (= cat_212 true)) (= cat_221 cat_209)))
(assert (=> (not (= cat_212 true)) (= cat_223 cat_206)))
(assert (=> (not (= cat_212 true)) (= cat_225 cat_205)))
(assert (= cat_212 true))
(assert (not (spoon_1 (fp.sub RNE cat_223 cat_221))))
(check-sat)
(exit)
