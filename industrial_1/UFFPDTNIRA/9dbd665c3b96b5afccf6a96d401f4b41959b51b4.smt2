...
(assert (not (fp.lt (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000) cat_161)))
(assert (fp.lt cat_161 (fp.neg (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000))))
(assert (fp.lt (spoon_53 (get_potato_14_b cat_153)) (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (and (= cat_135 (fp.div RNE ((_ to_fp 11 53) RNE (fp.sub RNE (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (spoon_53 (get_potato_14_b (get_potato_16_a cat_71))))) ((_ to_fp 11 53) RNE (spoon_53 (get_potato_14_b cat_153))))) (spoon_3 (fp.div RNE ((_ to_fp 11 53) RNE (fp.sub RNE (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (spoon_53 (get_potato_14_b (get_potato_16_a cat_71))))) ((_ to_fp 11 53) RNE (spoon_53 (get_potato_14_b cat_153)))))))
(assert (and (= cat_136 cat_135) (spoon_3 cat_135)))
(assert (= cat_166 (mk_potato_11 cat_151)))
(assert (= cat_167 cat_136))
