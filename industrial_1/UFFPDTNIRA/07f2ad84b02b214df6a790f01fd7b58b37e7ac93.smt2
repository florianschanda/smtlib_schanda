...
(assert (=> (fp.lt (fp #b0 #b10001011 #b01101010100000000000000) cat_62) (= cat_63 cat_62)))
(assert (=> (fp.lt (fp #b0 #b10001011 #b01101010100000000000000) cat_62) (= cat_64 (fp #b0 #b10001011 #b01101010100000000000000))))
(assert (=> (not (fp.lt (fp #b0 #b10001011 #b01101010100000000000000) cat_62)) (=> (fp.lt cat_62 (fp.neg (fp #b0 #b10001011 #b01101010100000000000000))) (= cat_65 cat_62))))
(assert (=> (not (fp.lt (fp #b0 #b10001011 #b01101010100000000000000) cat_62)) (=> (fp.lt cat_62 (fp.neg (fp #b0 #b10001011 #b01101010100000000000000))) (= cat_66 (fp.neg (fp #b0 #b10001011 #b01101010100000000000000))))))
(assert (=> (not (fp.lt (fp #b0 #b10001011 #b01101010100000000000000) cat_62)) (=> (not (fp.lt cat_62 (fp.neg (fp #b0 #b10001011 #b01101010100000000000000)))) (= cat_66 cat_62))))
(assert (=> (not (fp.lt (fp #b0 #b10001011 #b01101010100000000000000) cat_62)) (= cat_64 cat_66)))
