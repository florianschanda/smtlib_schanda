...
(assert (and (= cat_58 (spoon_36 cat_53 (fp #b0 #b10000111 #b01101000000000000000000))) (and (spoon_1 cat_58) (=> (fp.eq cat_53 (fp #b0 #b00000000 #b00000000000000000000000)) (fp.eq cat_58 (fp #b0 #b00000000 #b00000000000000000000000))))))
(assert (= cat_59 cat_57))
(assert (= cat_60 cat_58))
(assert (=> (fp.lt (fp #b0 #b10001011 #b01101010100000000000000) cat_60) (= cat_61 cat_60)))
(assert (=> (fp.lt (fp #b0 #b10001011 #b01101010100000000000000) cat_60) (= cat_62 (fp #b0 #b10001011 #b01101010100000000000000))))
(assert (=> (not (fp.lt (fp #b0 #b10001011 #b01101010100000000000000) cat_60)) (=> (fp.lt cat_60 (fp.neg (fp #b0 #b10001011 #b01101010100000000000000))) (= cat_63 cat_60))))
(assert (=> (not (fp.lt (fp #b0 #b10001011 #b01101010100000000000000) cat_60)) (=> (fp.lt cat_60 (fp.neg (fp #b0 #b10001011 #b01101010100000000000000))) (= cat_64 (fp.neg (fp #b0 #b10001011 #b01101010100000000000000))))))
(assert (=> (not (fp.lt (fp #b0 #b10001011 #b01101010100000000000000) cat_60)) (=> (not (fp.lt cat_60 (fp.neg (fp #b0 #b10001011 #b01101010100000000000000)))) (= cat_64 cat_60))))
(assert (=> (not (fp.lt (fp #b0 #b10001011 #b01101010100000000000000) cat_60)) (= cat_62 cat_64)))
(assert (not (spoon_46 cat_62)))
(check-sat)
(exit)
