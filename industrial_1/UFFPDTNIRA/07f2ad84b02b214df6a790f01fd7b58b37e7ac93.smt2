...
(assert (and (= cat_60 (spoon_38 cat_55 (fp #b0 #b10000111 #b01101000000000000000000))) (and (spoon_1 cat_60) (=> (fp.eq cat_55 (fp #b0 #b00000000 #b00000000000000000000000)) (fp.eq cat_60 (fp #b0 #b00000000 #b00000000000000000000000))))))
(assert (= cat_62 cat_59))
(assert (= cat_63 cat_60))
(assert (=> (fp.lt (fp #b0 #b10001011 #b01101010100000000000000) cat_63) (= cat_64 cat_63)))
(assert (=> (fp.lt (fp #b0 #b10001011 #b01101010100000000000000) cat_63) (= cat_65 (fp #b0 #b10001011 #b01101010100000000000000))))
(assert (=> (not (fp.lt (fp #b0 #b10001011 #b01101010100000000000000) cat_63)) (=> (fp.lt cat_63 (fp.neg (fp #b0 #b10001011 #b01101010100000000000000))) (= cat_66 cat_63))))
(assert (=> (not (fp.lt (fp #b0 #b10001011 #b01101010100000000000000) cat_63)) (=> (fp.lt cat_63 (fp.neg (fp #b0 #b10001011 #b01101010100000000000000))) (= cat_67 (fp.neg (fp #b0 #b10001011 #b01101010100000000000000))))))
(assert (=> (not (fp.lt (fp #b0 #b10001011 #b01101010100000000000000) cat_63)) (=> (not (fp.lt cat_63 (fp.neg (fp #b0 #b10001011 #b01101010100000000000000)))) (= cat_67 cat_63))))
(assert (=> (not (fp.lt (fp #b0 #b10001011 #b01101010100000000000000) cat_63)) (= cat_65 cat_67)))
(assert (not (spoon_48 cat_65)))
(check-sat)
(exit)
