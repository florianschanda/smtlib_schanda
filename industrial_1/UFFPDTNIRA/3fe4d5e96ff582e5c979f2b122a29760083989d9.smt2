...
(assert (= cat_249 (mk_potato_25 (mk_potato_24 cat_201 cat_202))))
(assert (= cat_250 (get_potato_26_a cat_111)))
(assert (= cat_225 (spoon_113 cat_167 cat_74)))
(assert (= cat_251 (ite (not (= cat_225 true)) true false)))
(assert (= cat_251 true))
(assert (=> (= cat_252 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_253))) (and (= cat_226 (spoon_149 (fp #b0 #b10000101 #b01100111111101011101000))) (spoon_129 cat_226)))))
(assert (=> (= cat_252 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_253))) (= cat_254 (mk_potato_10 cat_246)))))
(assert (=> (= cat_252 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_253))) (= cat_255 cat_226))))
(assert (=> (= cat_252 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_253)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_253)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (and (= cat_227 (spoon_149 (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (spoon_129 cat_227))))))
(assert (=> (= cat_252 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_253)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_253)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_256 (mk_potato_10 cat_246))))))
(assert (=> (= cat_252 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_253)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_253)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_257 cat_227)))))
(assert (=> (= cat_252 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_253)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_253)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_228 (spoon_84 (get_potato_24_a cat_253))) (spoon_1 (spoon_84 (get_potato_24_a cat_253))))))))
(assert (=> (= cat_252 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_253)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_253)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_229 (spoon_149 cat_228)) (spoon_129 cat_229))))))
(assert (=> (= cat_252 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_253)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_253)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_258 (mk_potato_10 cat_246))))))
(assert (=> (= cat_252 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_253)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_253)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_259 cat_229)))))
(assert (=> (= cat_252 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_253)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_253)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_257 cat_259)))))
(assert (=> (= cat_252 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_253)))) (= cat_255 cat_257))))
(assert (=> (= cat_252 true) (=> (spoon_189 cat_175) (and (= cat_230 (fp.mul RNE cat_175 cat_175)) (spoon_1 (fp.mul RNE cat_175 cat_175))))))
(assert (=> (= cat_252 true) (=> (spoon_189 cat_175) (= cat_260 (mk_potato_10 cat_244)))))
(assert (=> (= cat_252 true) (=> (spoon_189 cat_175) (= cat_261 cat_230))))
(assert (=> (= cat_252 true) (=> (spoon_189 cat_175) (= cat_263 cat_252))))
(assert (=> (= cat_252 true) (=> (not (spoon_189 cat_175)) (= cat_262 (mk_potato_7 cat_252)))))
(assert (=> (= cat_252 true) (=> (not (spoon_189 cat_175)) (= cat_263 (spoon_37 0)))))
(assert (=> (= cat_252 true) (=> (not (spoon_189 cat_175)) (= cat_261 cat_244))))
(assert (=> (= cat_252 true) (= cat_264 (mk_potato_10 cat_238))))
(assert (=> (= cat_252 true) (= cat_265 ((_ to_fp 8 24) RNE (fp.sub RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) (fp.mul RNE cat_171 cat_171))))))
(assert (=> (= cat_252 true) (and (= cat_231 cat_265) (spoon_1 cat_265))))
(assert (=> (= cat_252 true) (and (= cat_232 (spoon_146 cat_231)) (spoon_138 cat_232))))
(assert (=> (= cat_252 true) (= cat_266 (mk_potato_10 cat_236))))
(assert (=> (= cat_252 true) (= cat_267 cat_232)))
(assert (=> (not (= cat_252 true)) (= cat_255 cat_246)))
(assert (=> (not (= cat_252 true)) (= cat_261 cat_244)))
(assert (=> (not (= cat_252 true)) (= cat_265 cat_238)))
(assert (=> (not (= cat_252 true)) (= cat_267 cat_236)))
(assert (=> (not (= cat_252 true)) (= cat_263 cat_252)))
(assert (= cat_263 true))
(assert (and (= cat_233 (fp.sub RNE cat_265 cat_261)) (spoon_1 (fp.sub RNE cat_265 cat_261))))
(assert (= cat_234 (fp.add RNE cat_233 (fp.mul RNE cat_255 cat_255))))
(assert (not (spoon_1 cat_234)))
(check-sat)
(exit)
