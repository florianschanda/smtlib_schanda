...
(declare-const cat_231 potato_7)
(declare-const cat_232 Bool)
(declare-const cat_233 potato_19)
(declare-const cat_234 potato_18)
...
(assert (= cat_231 (mk_potato_7 cat_207)))
(assert (= cat_232 (spoon_41 1)))
(assert (= cat_233 (mk_potato_19 (mk_potato_18 cat_205 cat_206))))
(assert (= cat_234 (get_potato_20_a cat_89)))
(assert (= cat_235 (mk_potato_11 cat_210)))
(assert (= cat_236 (fp.mul RNE cat_185 cat_185)))
(assert (and (= cat_228 ((_ to_fp 11 53) RNE (fp.mul RNE cat_181 cat_181))) (spoon_3 ((_ to_fp 11 53) RNE (fp.mul RNE cat_181 cat_181)))))
(assert (= cat_237 (mk_potato_11 cat_208)))
(assert (= cat_238 cat_228))
