...
(declare-const cat_227 potato_7)
(declare-const cat_228 Bool)
(declare-const cat_229 potato_19)
(declare-const cat_230 potato_18)
...
(assert (= cat_227 (mk_potato_7 cat_203)))
(assert (= cat_228 (spoon_37 1)))
(assert (= cat_229 (mk_potato_19 (mk_potato_18 cat_201 cat_202))))
(assert (= cat_230 (get_potato_20_a cat_85)))
(assert (= cat_231 (mk_potato_11 cat_206)))
(assert (= cat_232 (fp.mul RNE cat_181 cat_181)))
(assert (and (= cat_224 ((_ to_fp 11 53) RNE (fp.mul RNE cat_177 cat_177))) (spoon_2 ((_ to_fp 11 53) RNE (fp.mul RNE cat_177 cat_177)))))
(assert (= cat_233 (mk_potato_11 cat_204)))
(assert (= cat_234 cat_224))
(assert (not (spoon_159 ((_ to_fp 11 53) RNE (fp.mul RNE cat_179 cat_179)))))
(check-sat)
(exit)
