...
(assert (forall ((kitten_27 Float32) (kitten_28 Float32)) (! (=> (and (and (spoon_31 kitten_27 true true true) (spoon_31 kitten_28 true true true)) (and (=> (fp.eq kitten_27 (fp #b0 #b00000000 #b00000000000000000000000)) (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) kitten_28)) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_27))) (let ((kitten_29 (spoon_32 kitten_27 kitten_28))) (and (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_29) (and (=> (fp.eq kitten_28 (fp #b0 #b00000000 #b00000000000000000000000)) (fp.eq kitten_29 (fp #b0 #b01111111 #b00000000000000000000000))) (and (=> (fp.eq kitten_28 (fp #b0 #b01111111 #b00000000000000000000000)) (fp.eq kitten_29 kitten_27)) (and (=> (fp.eq kitten_27 (fp #b0 #b01111111 #b00000000000000000000000)) (fp.eq kitten_29 (fp #b0 #b01111111 #b00000000000000000000000))) (=> (fp.eq kitten_27 (fp #b0 #b00000000 #b00000000000000000000000)) (fp.eq kitten_29 (fp #b0 #b00000000 #b00000000000000000000000))))))) (spoon_31 kitten_29 true false true)))) :pattern ((spoon_32 kitten_27 kitten_28)))))
(declare-sort potato_13 0)
(define-fun spoon_34 ((kitten_30 Float32)) Bool (and (spoon_1 kitten_30) (and (fp.leq (fp #b0 #b01110101 #b00000110001001001000100) kitten_30) (fp.leq kitten_30 (fp #b0 #b10010010 #b11101000010010000000000)))))
...
(define-fun spoon_41 ((kitten_32 Float32) (kitten_33 Bool) (kitten_34 Bool) (kitten_35 Bool)) Bool (=> (or (= kitten_33 true) (fp.leq (fp #b0 #b01110101 #b00000110001001001000100) (fp #b0 #b10010010 #b11101000010010000000000))) (spoon_34 kitten_32)))
(declare-sort potato_15 0)
(define-fun spoon_42 ((kitten_36 Float32)) Bool (and (spoon_1 kitten_36) (and (fp.leq (fp.neg (fp #b0 #b10000000 #b01000000000000000000000)) kitten_36) (fp.leq kitten_36 (fp #b0 #b10000001 #b01100000000000000000000)))))
...
(define-fun spoon_48 ((kitten_37 potato_16)) potato_15 (get_potato_16_a kitten_37))
(define-fun spoon_49 ((kitten_38 Float32) (kitten_39 Bool) (kitten_40 Bool) (kitten_41 Bool)) Bool (=> (or (= kitten_39 true) (fp.leq (fp.neg (fp #b0 #b10000000 #b01000000000000000000000)) (fp #b0 #b10000001 #b01100000000000000000000))) (spoon_42 kitten_38)))
(declare-sort potato_17 0)
(define-fun spoon_50 ((kitten_42 Float32)) Bool (and (spoon_1 kitten_42) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_42) (fp.leq kitten_42 (fp #b0 #b11111110 #b11111111111111111111111)))))
...
(define-fun spoon_56 ((kitten_43 potato_18)) potato_17 (get_potato_18_a kitten_43))
(define-fun spoon_57 ((kitten_44 Float32) (kitten_45 Bool) (kitten_46 Bool) (kitten_47 Bool)) Bool (=> (or (= kitten_45 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b11111110 #b11111111111111111111111))) (spoon_50 kitten_44)))
