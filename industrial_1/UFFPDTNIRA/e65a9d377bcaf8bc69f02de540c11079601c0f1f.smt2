...
(assert (fp.lt (fp #b0 #b10000101 #b01101000000000000000000) (fp.add RNE (spoon_84 (get_potato_24_a cat_286)) cat_314)))
(assert (not (spoon_76 (fp.sub RNE (fp #b0 #b10000110 #b01101000000000000000000) (fp.add RNE (spoon_84 (get_potato_24_a cat_286)) cat_314)))))
(check-sat)
(exit)
