...
(assert (fp.lt (fp #b0 #b10000101 #b01101000000000000000000) (fp.add RNE (spoon_88 (get_potato_24_a cat_293)) cat_321)))
(assert (not (spoon_80 (fp.sub RNE (fp #b0 #b10000110 #b01101000000000000000000) (fp.add RNE (spoon_88 (get_potato_24_a cat_293)) cat_321)))))
(check-sat)
(exit)
