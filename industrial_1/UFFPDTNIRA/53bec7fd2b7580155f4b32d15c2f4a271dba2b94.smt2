...
(define-fun spoon_258 () potato_10 (mk_potato_10 cat_160))
(define-fun spoon_259 () potato_10 (mk_potato_10 cat_158))
(define-fun spoon_260 () potato_10 (mk_potato_10 cat_145))
(define-fun spoon_261 () potato_10 (mk_potato_10 cat_144))
...
(assert (= cat_184 (mk_potato_30 (mk_potato_29 cat_147 cat_148))))
(assert (= cat_185 (get_potato_31_a cat_166)))
...
(assert (= cat_187 (get_potato_31_a cat_170)))
...
(assert (= cat_189 (get_potato_31_a cat_174)))
(assert (and (= cat_175 (spoon_124 (mk_potato_31 cat_185) (mk_potato_31 cat_185))) (and (spoon_92 cat_175) (= cat_175 (fp.add RNE (fp.mul RNE (spoon_69 (get_potato_29_a cat_185)) (spoon_69 (get_potato_29_a cat_185))) (fp.mul RNE (spoon_69 (get_potato_29_b cat_185)) (spoon_69 (get_potato_29_b cat_185))))))))
(assert (= cat_190 (mk_potato_10 cat_153)))
(assert (= cat_191 cat_175))
(assert (and (= cat_176 (spoon_124 (mk_potato_31 cat_185) (mk_potato_31 cat_187))) (and (spoon_92 cat_176) (= cat_176 (fp.add RNE (fp.mul RNE (spoon_69 (get_potato_29_a cat_185)) (spoon_69 (get_potato_29_a cat_187))) (fp.mul RNE (spoon_69 (get_potato_29_b cat_185)) (spoon_69 (get_potato_29_b cat_187))))))))
(assert (= cat_192 (mk_potato_10 cat_154)))
(assert (= cat_193 cat_176))
(assert (and (= cat_177 (spoon_124 (mk_potato_31 cat_187) (mk_potato_31 cat_187))) (and (spoon_92 cat_177) (= cat_177 (fp.add RNE (fp.mul RNE (spoon_69 (get_potato_29_a cat_187)) (spoon_69 (get_potato_29_a cat_187))) (fp.mul RNE (spoon_69 (get_potato_29_b cat_187)) (spoon_69 (get_potato_29_b cat_187))))))))
(assert (= cat_194 (mk_potato_10 cat_155)))
(assert (= cat_195 cat_177))
(assert (and (= cat_178 (spoon_124 (mk_potato_31 cat_185) (mk_potato_31 cat_189))) (and (spoon_92 cat_178) (= cat_178 (fp.add RNE (fp.mul RNE (spoon_69 (get_potato_29_a cat_185)) (spoon_69 (get_potato_29_a cat_189))) (fp.mul RNE (spoon_69 (get_potato_29_b cat_185)) (spoon_69 (get_potato_29_b cat_189))))))))
(assert (= cat_196 (mk_potato_10 cat_156)))
(assert (= cat_197 cat_178))
(assert (and (= cat_179 (spoon_124 (mk_potato_31 cat_187) (mk_potato_31 cat_189))) (and (spoon_92 cat_179) (= cat_179 (fp.add RNE (fp.mul RNE (spoon_69 (get_potato_29_a cat_187)) (spoon_69 (get_potato_29_a cat_189))) (fp.mul RNE (spoon_69 (get_potato_29_b cat_187)) (spoon_69 (get_potato_29_b cat_189))))))))
(assert (= cat_198 (mk_potato_10 cat_157)))
(assert (= cat_199 cat_179))
(assert (= cat_200 (mk_potato_10 cat_162)))
(assert (= cat_201 (fp.sub RNE (fp.mul RNE cat_191 cat_195) (fp.mul RNE cat_193 cat_193))))
(assert (= cat_202 (mk_potato_10 cat_159)))
(assert (= cat_203 cat_201))
(assert (= cat_204 (mk_potato_10 cat_161)))
(assert (= cat_205 cat_201))
(assert (=> (fp.lt cat_201 (fp #b0 #b01101011 #b00001100011011110111101)) (= cat_206 spoon_259)))
...
(assert (=> (fp.lt cat_201 (fp #b0 #b01101011 #b00001100011011110111101)) (= cat_210 spoon_258)))
...
(assert (=> (not (fp.lt cat_201 (fp #b0 #b01101011 #b00001100011011110111101))) (= cat_214 spoon_259)))
...
(assert (=> (not (fp.lt cat_201 (fp #b0 #b01101011 #b00001100011011110111101))) (= cat_216 spoon_258)))
...
(assert (=> (fp.lt cat_239 (fp #b0 #b01101011 #b00001100011011110111101)) (= cat_250 spoon_261)))
(assert (=> (fp.lt cat_239 (fp #b0 #b01101011 #b00001100011011110111101)) (= cat_251 (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (=> (not (fp.lt cat_239 (fp #b0 #b01101011 #b00001100011011110111101))) (and (= cat_180 (fp.div RNE cat_233 cat_239)) (spoon_1 (fp.div RNE cat_233 cat_239)))))
(assert (=> (not (fp.lt cat_239 (fp #b0 #b01101011 #b00001100011011110111101))) (and (= cat_181 cat_180) (spoon_1 cat_180))))
(assert (=> (not (fp.lt cat_239 (fp #b0 #b01101011 #b00001100011011110111101))) (= cat_252 spoon_261)))
(assert (=> (not (fp.lt cat_239 (fp #b0 #b01101011 #b00001100011011110111101))) (= cat_253 cat_181)))
(assert (=> (not (fp.lt cat_239 (fp #b0 #b01101011 #b00001100011011110111101))) (= cat_251 cat_253)))
(assert (=> (fp.lt cat_213 (fp #b0 #b01101011 #b00001100011011110111101)) (= cat_254 spoon_260)))
(assert (=> (fp.lt cat_213 (fp #b0 #b01101011 #b00001100011011110111101)) (= cat_255 (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (=> (not (fp.lt cat_213 (fp #b0 #b01101011 #b00001100011011110111101))) (and (= cat_182 (fp.div RNE cat_231 cat_213)) (spoon_1 (fp.div RNE cat_231 cat_213)))))
(assert (=> (not (fp.lt cat_213 (fp #b0 #b01101011 #b00001100011011110111101))) (and (= cat_183 cat_182) (spoon_1 cat_182))))
(assert (=> (not (fp.lt cat_213 (fp #b0 #b01101011 #b00001100011011110111101))) (= cat_256 spoon_260)))
(assert (=> (not (fp.lt cat_213 (fp #b0 #b01101011 #b00001100011011110111101))) (= cat_257 cat_183)))
(assert (=> (not (fp.lt cat_213 (fp #b0 #b01101011 #b00001100011011110111101))) (= cat_255 cat_257)))
(assert (not (spoon_29 (fp.add RNE (spoon_36 (get_potato_15_a (get_potato_17_a cat_81))) (fp.mul RNE cat_251 (spoon_69 (get_potato_29_a cat_185)))))))
(check-sat)
(exit)
