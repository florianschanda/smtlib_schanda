...
(define-fun spoon_66 ((kitten_46 Float32)) Bool (and (spoon_1 kitten_46) (and (fp.leq (fp.neg (fp #b0 #b10001100 #b00000000000000000000000)) kitten_46) (fp.leq kitten_46 (fp #b0 #b10001100 #b00000000000000000000000)))))
...
(define-fun spoon_73 ((kitten_48 Float32) (kitten_49 Bool) (kitten_50 Bool) (kitten_51 Bool)) Bool (=> (or (= kitten_49 true) (fp.leq (fp.neg (fp #b0 #b10001100 #b00000000000000000000000)) (fp #b0 #b10001100 #b00000000000000000000000))) (spoon_66 kitten_48)))
(declare-fun spoon_74 (Float32 Float32) Float32)
(declare-fun spoon_75 (Float32 Float32 Float32) Bool)
(assert (forall ((kitten_52 Float32) (kitten_53 Float32)) (! (=> (and (and (spoon_73 kitten_52 true true true) (spoon_73 kitten_53 true true true)) (or (not (fp.eq kitten_52 (fp #b0 #b00000000 #b00000000000000000000000))) (not (fp.eq kitten_53 (fp #b0 #b00000000 #b00000000000000000000000))))) (spoon_65 (spoon_74 kitten_52 kitten_53) true false true)) :pattern ((spoon_74 kitten_52 kitten_53)))))
...
(define-fun spoon_84 ((kitten_54 Float32) (kitten_55 Bool) (kitten_56 Bool) (kitten_57 Bool)) Bool (=> (or (= kitten_55 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_25 kitten_54)))
...
(assert (= cat_91 (fp.sub RNE (spoon_32 (get_potato_13_a (get_potato_15_a cat_78))) (spoon_32 (get_potato_13_a (get_potato_15_a cat_76))))))
(assert (= cat_92 cat_86))
(assert (= cat_93 (fp.sub RNE (spoon_32 (get_potato_13_b (get_potato_15_a cat_78))) (spoon_32 (get_potato_13_b (get_potato_15_a cat_76))))))
(assert (and (= cat_89 (spoon_74 cat_91 cat_93)) (spoon_58 cat_89)))
(assert (= cat_94 cat_87))
(assert (= cat_95 cat_89))
(assert (not (fp.lt cat_95 (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (not (spoon_50 cat_95)))
(check-sat)
(exit)
