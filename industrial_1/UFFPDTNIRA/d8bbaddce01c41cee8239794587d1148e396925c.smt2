...
(assert (= (mk_potato_10 cat_115) (mk_potato_10 cat_79)))
(assert (= cat_116 (fp #b0 #b10001011 #b00000000000000000000000)))
(assert (not (spoon_66 (fp.add RNE (fp.mul RNE cat_110 (fp.sub RNE cat_116 (spoon_44 (get_potato_15_a (get_potato_17_a cat_62))))) (spoon_44 (get_potato_15_b (get_potato_17_a cat_62)))))))
(check-sat)
(exit)
