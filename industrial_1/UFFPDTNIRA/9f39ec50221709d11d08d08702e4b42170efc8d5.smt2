...
(declare-const cat_265 potato_29)
(declare-const cat_266 potato_28)
...
(assert (and (= cat_226 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_268)) (spoon_3 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_268))))
...
(assert (and (= cat_237 (fp.mul RNE cat_274 ((_ to_fp 11 53) RNE cat_179))) (spoon_3 (fp.mul RNE cat_274 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_238 (fp.mul RNE cat_237 cat_280)))
(assert (and (= cat_239 cat_238) (spoon_3 cat_238)))
(assert (and (= cat_233 (fp.sub RNE cat_276 cat_270)) (spoon_3 (fp.sub RNE cat_276 cat_270))))
...
(assert (and (= cat_243 (fp.add RNE cat_276 cat_270)) (spoon_3 (fp.add RNE cat_276 cat_270))))
...
(assert (and (= cat_246 (fp.div RNE cat_282 cat_284)) (spoon_3 (fp.div RNE cat_282 cat_284))))
...
(assert (=> (not (fp.lt cat_286 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_286)) (and (= cat_247 cat_286) (spoon_3 cat_286)))))
...
(assert (and (= cat_248 (fp.mul RNE cat_274 ((_ to_fp 11 53) RNE cat_177))) (spoon_3 (fp.mul RNE cat_274 ((_ to_fp 11 53) RNE cat_177)))))
(assert (= cat_293 (mk_potato_11 cat_216)))
(assert (= cat_294 cat_248))
(assert (and (= cat_253 (fp.mul RNE cat_274 ((_ to_fp 11 53) RNE cat_179))) (spoon_3 (fp.mul RNE cat_274 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_254 (fp.mul RNE cat_253 cat_278)))
(assert (and (= cat_255 cat_254) (spoon_3 cat_254)))
(assert (and (= cat_249 (fp.sub RNE cat_276 cat_270)) (spoon_3 (fp.sub RNE cat_276 cat_270))))
...
(assert (and (= cat_259 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_296)) (spoon_3 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_296))))
(assert (= cat_260 (ite (fp.leq cat_294 cat_259) true false)))
(assert (not (spoon_3 (fp.mul RNE (fp.neg (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000)) cat_296))))
(check-sat)
(exit)
