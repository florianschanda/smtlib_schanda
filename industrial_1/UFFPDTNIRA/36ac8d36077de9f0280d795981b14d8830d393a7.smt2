...
(assert (not (fp.lt (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000) cat_149)))
(assert (fp.lt cat_149 (fp.neg (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000))))
(assert (not (fp.lt (spoon_53 (get_potato_14_a (get_potato_16_a cat_73))) (fp #b0 #b00000000 #b00000000000000000000000))))
(check-sat)
(exit)
