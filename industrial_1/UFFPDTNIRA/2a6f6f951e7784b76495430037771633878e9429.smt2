...
(declare-fun cat_237 () potato_29)
(declare-fun cat_238 () potato_28)
...
(assert (= cat_240 (fp.mul roundNearestTiesToEven cat_181 cat_181)))
...
(assert (= cat_246 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1025 11) (_ bv0 52)) cat_181)))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1025 11) (_ bv0 52)) cat_240))) (and (= cat_226 _let_0) (spoon_3 _let_0))))
...
(assert (not (spoon_3 (fp.mul roundNearestTiesToEven cat_246 ((_ to_fp 11 53) roundNearestTiesToEven cat_179)))))
(check-sat)
(exit)
