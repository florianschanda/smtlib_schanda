...
(assert (= cat_303 true))
(assert (and (= cat_237 (fp.sub RNE cat_305 cat_301)) (spoon_1 (fp.sub RNE cat_305 cat_301))))
(assert (= cat_238 (fp.add RNE cat_237 (fp.mul RNE cat_295 cat_295))))
(assert (and (= cat_239 cat_238) (spoon_1 cat_238)))
(assert (= cat_308 (mk_potato_10 cat_282)))
(assert (= cat_309 cat_239))
(assert (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_309))
(assert (not (spoon_119 cat_309)))
(check-sat)
(exit)
