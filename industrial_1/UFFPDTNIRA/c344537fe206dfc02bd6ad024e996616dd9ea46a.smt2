...
(declare-const cat_248 potato_7)
(declare-const cat_249 Bool)
(declare-const cat_250 potato_25)
(declare-const cat_251 potato_24)
(declare-const cat_252 Bool)
(declare-const cat_253 Bool)
(declare-const cat_254 potato_24)
...
(declare-const cat_267 potato_10)
(declare-const cat_268 Float32)
(declare-const cat_269 potato_10)
...
(assert (= cat_236 cat_204))
(assert (= cat_237 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_1 cat_237))
(assert (= cat_238 (mk_potato_10 cat_205)))
(assert (= cat_239 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_1 cat_239))
(assert (= cat_240 (mk_potato_10 cat_206)))
(assert (= cat_241 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_1 cat_241))
(assert (= cat_242 (mk_potato_10 cat_207)))
(assert (= cat_243 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_1 cat_243))
(assert (= cat_244 (mk_potato_10 cat_208)))
(assert (= cat_245 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_1 cat_245))
(assert (= cat_246 (mk_potato_10 cat_209)))
(assert (= cat_247 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_129 cat_247))
...
(assert (= cat_248 (mk_potato_7 cat_203)))
(assert (= cat_249 (spoon_37 1)))
(assert (= cat_250 (mk_potato_25 (mk_potato_24 cat_201 cat_202))))
(assert (= cat_251 (get_potato_26_a cat_111)))
(assert (= cat_225 (spoon_113 cat_167 cat_74)))
(assert (= cat_252 (ite (not (= cat_225 true)) true false)))
(assert (= cat_252 true))
(assert (=> (= cat_253 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_254))) (and (= cat_226 (spoon_149 (fp #b0 #b10000101 #b01100111111101011101000))) (spoon_129 cat_226)))))
(assert (=> (= cat_253 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_254))) (= cat_255 (mk_potato_10 cat_247)))))
(assert (=> (= cat_253 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_254))) (= cat_256 cat_226))))
(assert (=> (= cat_253 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_254)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_254)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (and (= cat_227 (spoon_149 (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (spoon_129 cat_227))))))
(assert (=> (= cat_253 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_254)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_254)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_257 (mk_potato_10 cat_247))))))
(assert (=> (= cat_253 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_254)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_254)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_258 cat_227)))))
(assert (=> (= cat_253 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_254)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_254)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_228 (spoon_84 (get_potato_24_a cat_254))) (spoon_1 (spoon_84 (get_potato_24_a cat_254))))))))
(assert (=> (= cat_253 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_254)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_254)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_229 (spoon_149 cat_228)) (spoon_129 cat_229))))))
(assert (=> (= cat_253 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_254)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_254)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_259 (mk_potato_10 cat_247))))))
(assert (=> (= cat_253 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_254)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_254)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_260 cat_229)))))
(assert (=> (= cat_253 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_254)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_254)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_258 cat_260)))))
(assert (=> (= cat_253 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_254)))) (= cat_256 cat_258))))
(assert (=> (= cat_253 true) (=> (spoon_189 cat_175) (and (= cat_230 (fp.mul RNE cat_175 cat_175)) (spoon_1 (fp.mul RNE cat_175 cat_175))))))
(assert (=> (= cat_253 true) (=> (spoon_189 cat_175) (= cat_261 (mk_potato_10 cat_245)))))
(assert (=> (= cat_253 true) (=> (spoon_189 cat_175) (= cat_262 cat_230))))
(assert (=> (= cat_253 true) (=> (spoon_189 cat_175) (= cat_264 cat_253))))
(assert (=> (= cat_253 true) (=> (not (spoon_189 cat_175)) (= cat_263 (mk_potato_7 cat_253)))))
(assert (=> (= cat_253 true) (=> (not (spoon_189 cat_175)) (= cat_264 (spoon_37 0)))))
(assert (=> (= cat_253 true) (=> (not (spoon_189 cat_175)) (= cat_262 cat_245))))
(assert (=> (= cat_253 true) (= cat_265 (mk_potato_10 cat_239))))
(assert (=> (= cat_253 true) (= cat_266 ((_ to_fp 8 24) RNE (fp.sub RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) (fp.mul RNE cat_171 cat_171))))))
(assert (=> (= cat_253 true) (and (= cat_231 cat_266) (spoon_1 cat_266))))
(assert (=> (= cat_253 true) (and (= cat_232 (spoon_146 cat_231)) (spoon_138 cat_232))))
(assert (=> (= cat_253 true) (= cat_267 (mk_potato_10 cat_237))))
(assert (=> (= cat_253 true) (= cat_268 cat_232)))
(assert (=> (not (= cat_253 true)) (= cat_256 cat_247)))
(assert (=> (not (= cat_253 true)) (= cat_262 cat_245)))
(assert (=> (not (= cat_253 true)) (= cat_266 cat_239)))
(assert (=> (not (= cat_253 true)) (= cat_268 cat_237)))
(assert (=> (not (= cat_253 true)) (= cat_264 cat_253)))
(assert (= cat_264 true))
(assert (and (= cat_233 (fp.sub RNE cat_266 cat_262)) (spoon_1 (fp.sub RNE cat_266 cat_262))))
(assert (= cat_234 (fp.add RNE cat_233 (fp.mul RNE cat_256 cat_256))))
(assert (and (= cat_235 cat_234) (spoon_1 cat_234)))
(assert (= cat_269 (mk_potato_10 cat_243)))
(assert (= cat_270 cat_235))
(assert (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_270))
(assert (not (spoon_115 cat_270)))
(check-sat)
(exit)
