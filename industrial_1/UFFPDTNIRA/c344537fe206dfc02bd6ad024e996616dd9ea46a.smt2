...
(declare-const cat_252 potato_7)
(declare-const cat_253 Bool)
(declare-const cat_254 potato_25)
...
(declare-const cat_271 potato_10)
(declare-const cat_272 Float32)
(declare-const cat_273 potato_10)
...
(assert (= cat_240 cat_208))
(assert (= cat_241 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_1 cat_241))
(assert (= cat_242 (mk_potato_10 cat_209)))
(assert (= cat_243 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_1 cat_243))
(assert (= cat_244 (mk_potato_10 cat_210)))
(assert (= cat_245 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_1 cat_245))
(assert (= cat_246 (mk_potato_10 cat_211)))
(assert (= cat_247 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_1 cat_247))
(assert (= cat_248 (mk_potato_10 cat_212)))
(assert (= cat_249 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_1 cat_249))
(assert (= cat_250 (mk_potato_10 cat_213)))
(assert (= cat_251 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_133 cat_251))
...
(assert (= cat_252 (mk_potato_7 cat_207)))
(assert (= cat_253 (spoon_41 1)))
(assert (= cat_254 (mk_potato_25 (mk_potato_24 cat_205 cat_206))))
(assert (= cat_255 (get_potato_26_a cat_115)))
(assert (= cat_229 (spoon_117 cat_171 cat_78)))
(assert (= cat_256 (ite (not (= cat_229 true)) true false)))
(assert (= cat_256 true))
(assert (=> (= cat_257 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_258))) (and (= cat_230 (spoon_153 (fp #b0 #b10000101 #b01100111111101011101000))) (spoon_133 cat_230)))))
(assert (=> (= cat_257 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_258))) (= cat_259 (mk_potato_10 cat_251)))))
(assert (=> (= cat_257 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_258))) (= cat_260 cat_230))))
(assert (=> (= cat_257 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_258)))) (=> (fp.lt (spoon_88 (get_potato_24_a cat_258)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (and (= cat_231 (spoon_153 (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (spoon_133 cat_231))))))
(assert (=> (= cat_257 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_258)))) (=> (fp.lt (spoon_88 (get_potato_24_a cat_258)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_261 (mk_potato_10 cat_251))))))
(assert (=> (= cat_257 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_258)))) (=> (fp.lt (spoon_88 (get_potato_24_a cat_258)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_262 cat_231)))))
(assert (=> (= cat_257 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_258)))) (=> (not (fp.lt (spoon_88 (get_potato_24_a cat_258)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_232 (spoon_88 (get_potato_24_a cat_258))) (spoon_1 (spoon_88 (get_potato_24_a cat_258))))))))
(assert (=> (= cat_257 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_258)))) (=> (not (fp.lt (spoon_88 (get_potato_24_a cat_258)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_233 (spoon_153 cat_232)) (spoon_133 cat_233))))))
(assert (=> (= cat_257 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_258)))) (=> (not (fp.lt (spoon_88 (get_potato_24_a cat_258)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_263 (mk_potato_10 cat_251))))))
(assert (=> (= cat_257 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_258)))) (=> (not (fp.lt (spoon_88 (get_potato_24_a cat_258)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_264 cat_233)))))
(assert (=> (= cat_257 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_258)))) (=> (not (fp.lt (spoon_88 (get_potato_24_a cat_258)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_262 cat_264)))))
(assert (=> (= cat_257 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_258)))) (= cat_260 cat_262))))
(assert (=> (= cat_257 true) (=> (spoon_193 cat_179) (and (= cat_234 (fp.mul RNE cat_179 cat_179)) (spoon_1 (fp.mul RNE cat_179 cat_179))))))
(assert (=> (= cat_257 true) (=> (spoon_193 cat_179) (= cat_265 (mk_potato_10 cat_249)))))
(assert (=> (= cat_257 true) (=> (spoon_193 cat_179) (= cat_266 cat_234))))
(assert (=> (= cat_257 true) (=> (spoon_193 cat_179) (= cat_268 cat_257))))
(assert (=> (= cat_257 true) (=> (not (spoon_193 cat_179)) (= cat_267 (mk_potato_7 cat_257)))))
(assert (=> (= cat_257 true) (=> (not (spoon_193 cat_179)) (= cat_268 (spoon_41 0)))))
(assert (=> (= cat_257 true) (=> (not (spoon_193 cat_179)) (= cat_266 cat_249))))
(assert (=> (= cat_257 true) (= cat_269 (mk_potato_10 cat_243))))
(assert (=> (= cat_257 true) (= cat_270 ((_ to_fp 8 24) RNE (fp.sub RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) (fp.mul RNE cat_175 cat_175))))))
(assert (=> (= cat_257 true) (and (= cat_235 cat_270) (spoon_1 cat_270))))
(assert (=> (= cat_257 true) (and (= cat_236 (spoon_150 cat_235)) (spoon_142 cat_236))))
(assert (=> (= cat_257 true) (= cat_271 (mk_potato_10 cat_241))))
(assert (=> (= cat_257 true) (= cat_272 cat_236)))
(assert (=> (not (= cat_257 true)) (= cat_260 cat_251)))
(assert (=> (not (= cat_257 true)) (= cat_266 cat_249)))
(assert (=> (not (= cat_257 true)) (= cat_270 cat_243)))
(assert (=> (not (= cat_257 true)) (= cat_272 cat_241)))
(assert (=> (not (= cat_257 true)) (= cat_268 cat_257)))
(assert (= cat_268 true))
(assert (and (= cat_237 (fp.sub RNE cat_270 cat_266)) (spoon_1 (fp.sub RNE cat_270 cat_266))))
(assert (= cat_238 (fp.add RNE cat_237 (fp.mul RNE cat_260 cat_260))))
(assert (and (= cat_239 cat_238) (spoon_1 cat_238)))
(assert (= cat_273 (mk_potato_10 cat_247)))
(assert (= cat_274 cat_239))
(assert (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_274))
(assert (not (spoon_119 cat_274)))
(check-sat)
(exit)
