...
(assert (= cat_146 (fp.add RNE (fp.mul RNE (fp.sub RNE (spoon_48 (get_potato_17_a (get_potato_19_a cat_86))) (spoon_48 (get_potato_17_a (get_potato_19_a cat_88)))) cat_143) (fp.mul RNE (fp.sub RNE (spoon_48 (get_potato_17_b (get_potato_19_a cat_86))) (spoon_48 (get_potato_17_b (get_potato_19_a cat_88)))) cat_144))))
(assert (not (spoon_1 (fp.div RNE cat_146 cat_145))))
(check-sat)
(exit)
