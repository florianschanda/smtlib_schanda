...
(declare-const cat_263 potato_19)
(declare-const cat_264 potato_18)
...
(assert (= cat_263 (mk_potato_19 (mk_potato_18 cat_201 cat_202))))
(assert (= cat_264 (get_potato_20_a cat_85)))
...
(assert (and (= cat_226 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_266)) (spoon_2 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_266))))
...
(assert (and (= cat_237 (fp.mul RNE cat_272 ((_ to_fp 11 53) RNE cat_179))) (spoon_2 (fp.mul RNE cat_272 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_238 (fp.mul RNE cat_237 cat_278)))
(assert (and (= cat_239 cat_238) (spoon_2 cat_238)))
(assert (and (= cat_233 (fp.sub RNE cat_274 cat_268)) (spoon_2 (fp.sub RNE cat_274 cat_268))))
...
(assert (and (= cat_243 (fp.add RNE cat_274 cat_268)) (spoon_2 (fp.add RNE cat_274 cat_268))))
...
(assert (and (= cat_246 (fp.div RNE cat_280 cat_282)) (spoon_2 (fp.div RNE cat_280 cat_282))))
...
(assert (=> (not (fp.lt cat_284 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_284)) (and (= cat_247 cat_284) (spoon_2 cat_284)))))
...
(assert (and (= cat_248 (fp.mul RNE cat_272 ((_ to_fp 11 53) RNE cat_177))) (spoon_2 (fp.mul RNE cat_272 ((_ to_fp 11 53) RNE cat_177)))))
(assert (= cat_291 (mk_potato_11 cat_216)))
(assert (= cat_292 cat_248))
(assert (and (= cat_253 (fp.mul RNE cat_272 ((_ to_fp 11 53) RNE cat_179))) (spoon_2 (fp.mul RNE cat_272 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_254 (fp.mul RNE cat_253 cat_276)))
(assert (and (= cat_255 cat_254) (spoon_2 cat_254)))
(assert (and (= cat_249 (fp.sub RNE cat_274 cat_268)) (spoon_2 (fp.sub RNE cat_274 cat_268))))
...
(assert (not (spoon_2 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_294))))
(check-sat)
(exit)
