...
(assert (and (= cat_212 (fp.mul RNE cat_236 cat_240)) (spoon_2 (fp.mul RNE cat_236 cat_240))))
(assert (= cat_213 (fp.mul RNE cat_212 cat_244)))
(assert (and (= cat_214 cat_213) (spoon_2 cat_213)))
(assert (and (= cat_210 (fp.mul RNE cat_234 cat_238)) (spoon_2 (fp.mul RNE cat_234 cat_238))))
...
(assert (and (= cat_218 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_145) cat_242)) (spoon_2 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_145) cat_242))))
...
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_246) (and (= cat_224 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_246)) (spoon_2 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_246)))))
...
(assert (and (= cat_221 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_246)) (spoon_2 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_246))))
(assert (= cat_222 (ite (fp.leq cat_248 cat_221) true false)))
(assert (not (spoon_2 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_246))))
(check-sat)
(exit)
