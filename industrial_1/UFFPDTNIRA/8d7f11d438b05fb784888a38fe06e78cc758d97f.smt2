...
(assert (not (= cat_273 true)))
(assert (fp.lt cat_267 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)))
(assert (and (= cat_223 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_267)) (spoon_3 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_267))))
(assert (= cat_224 (ite (fp.leq cat_269 cat_223) true false)))
(assert (not (spoon_3 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_267))))
(check-sat)
(exit)
