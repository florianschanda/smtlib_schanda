...
(define-fun spoon_265 () potato_11 (mk_potato_11 cat_175))
...
(assert (= cat_231 cat_178))
(assert (= cat_232 cat_192))
...
(assert (= cat_233 cat_177))
(assert (= cat_234 cat_193))
(assert (and (= cat_194 (spoon_60 (spoon_86 (get_potato_22_a (get_potato_24_a cat_154))))) (spoon_42 cat_194)))
(assert (= cat_235 cat_179))
(assert (= cat_236 cat_194))
(assert (and (= cat_195 (spoon_40 cat_232)) (spoon_50 cat_195)))
(assert (= cat_196 ((_ to_fp 11 53) RNE cat_195)))
(assert (= cat_237 cat_180))
(assert (= cat_238 cat_196))
(assert (and (= cat_197 (spoon_58 cat_232)) (spoon_50 cat_197)))
(assert (= cat_198 ((_ to_fp 11 53) RNE cat_197)))
(assert (= cat_239 cat_181))
(assert (= cat_240 cat_198))
(assert (and (= cat_199 (spoon_40 cat_236)) (spoon_50 cat_199)))
(assert (= cat_200 ((_ to_fp 11 53) RNE cat_199)))
(assert (= cat_241 (mk_potato_11 cat_182)))
(assert (= cat_242 cat_200))
(assert (and (= cat_201 (spoon_58 cat_236)) (spoon_50 cat_201)))
(assert (= cat_202 ((_ to_fp 11 53) RNE cat_201)))
(assert (= cat_243 (mk_potato_11 cat_183)))
(assert (= cat_244 cat_202))
(assert (and (= cat_203 (spoon_40 cat_234)) (spoon_50 cat_203)))
(assert (= cat_204 ((_ to_fp 11 53) RNE cat_203)))
(assert (= cat_245 (mk_potato_11 cat_184)))
(assert (= cat_246 cat_204))
(assert (and (= cat_205 (spoon_58 cat_234)) (spoon_50 cat_205)))
(assert (= cat_206 ((_ to_fp 11 53) RNE cat_205)))
(assert (= cat_247 (mk_potato_11 cat_185)))
(assert (= cat_248 cat_206))
(assert (and (= cat_209 (fp.mul RNE cat_240 cat_244)) (spoon_3 (fp.mul RNE cat_240 cat_244))))
(assert (= cat_210 (fp.mul RNE cat_209 cat_248)))
(assert (and (= cat_211 cat_210) (spoon_3 cat_210)))
(assert (and (= cat_207 (fp.mul RNE cat_238 cat_242)) (spoon_3 (fp.mul RNE cat_238 cat_242))))
...
(assert (= cat_249 (mk_potato_11 cat_188)))
(assert (= cat_250 cat_214))
(assert (and (= cat_215 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_156) cat_246)) (spoon_3 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_156) cat_246))))
(assert (= cat_216 (fp.mul RNE cat_215 cat_240)))
(assert (and (= cat_217 cat_216) (spoon_3 cat_216)))
(assert (= cat_251 (mk_potato_11 cat_189)))
(assert (= cat_252 cat_217))
(assert (=> (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_250) (and (= cat_218 (fp.div RNE cat_252 cat_250)) (spoon_3 (fp.div RNE cat_252 cat_250)))))
(assert (=> (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_250) (= cat_253 spoon_265)))
(assert (=> (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_250) (= cat_254 cat_218)))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_250)) (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_250) (and (= cat_224 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_250)) (spoon_3 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_250))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_250)) (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_250) (= cat_225 (ite (fp.leq cat_252 cat_224) true false)))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_250)) (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_250) (and (= cat_223 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_250)) (spoon_3 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_250))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_250)) (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_250) (= cat_226 (ite (fp.leq cat_223 cat_252) true false)))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_250)) (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_250) (= cat_256 (ite (= cat_226 true) cat_225 false)))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_250)) (=> (not (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_250)) (= cat_256 false))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_250)) (=> (= cat_256 true) (= cat_255 true))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_250)) (=> (not (= cat_256 true)) (=> (fp.lt cat_250 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (and (= cat_220 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_250)) (spoon_3 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_250)))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_250)) (=> (not (= cat_256 true)) (=> (fp.lt cat_250 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_221 (ite (fp.leq cat_252 cat_220) true false))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_250)) (=> (not (= cat_256 true)) (=> (fp.lt cat_250 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (and (= cat_219 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_250)) (spoon_3 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_250)))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_250)) (=> (not (= cat_256 true)) (=> (fp.lt cat_250 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_222 (ite (fp.leq cat_219 cat_252) true false))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_250)) (=> (not (= cat_256 true)) (=> (fp.lt cat_250 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_255 (ite (= cat_222 true) cat_221 false))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_250)) (=> (not (= cat_256 true)) (=> (not (fp.lt cat_250 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))) (= cat_255 false)))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_250)) (=> (= cat_255 true) (and (= cat_227 (fp.div RNE cat_252 cat_250)) (spoon_3 (fp.div RNE cat_252 cat_250))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_250)) (=> (= cat_255 true) (= cat_257 spoon_265))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_250)) (=> (= cat_255 true) (= cat_258 cat_227))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_250)) (=> (not (= cat_255 true)) (=> (fp.lt cat_252 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_259 spoon_265)))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_250)) (=> (not (= cat_255 true)) (=> (fp.lt cat_252 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_260 (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_250)) (=> (not (= cat_255 true)) (=> (not (fp.lt cat_252 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))) (= cat_261 spoon_265)))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_250)) (=> (not (= cat_255 true)) (=> (not (fp.lt cat_252 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))) (= cat_262 (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_250)) (=> (not (= cat_255 true)) (=> (not (fp.lt cat_252 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))) (= cat_260 cat_262)))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_250)) (=> (not (= cat_255 true)) (= cat_258 cat_260))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_250)) (= cat_254 cat_258)))
(assert (and (= cat_228 (fp.mul RNE cat_238 cat_244)) (spoon_3 (fp.mul RNE cat_238 cat_244))))
(assert (= cat_263 (mk_potato_11 cat_186)))
(assert (= cat_264 cat_228))
(assert (and (= cat_229 (fp.mul RNE cat_240 cat_242)) (spoon_3 (fp.mul RNE cat_240 cat_242))))
(assert (= cat_230 (fp.mul RNE cat_229 cat_248)))
(assert (not (spoon_3 cat_230)))
(check-sat)
(exit)
