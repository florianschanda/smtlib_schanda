...
(assert (and (= cat_230 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_246)) (spoon_3 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_246))))
...
(assert (and (= cat_237 (fp.mul RNE cat_252 ((_ to_fp 11 53) RNE cat_183))) (spoon_3 (fp.mul RNE cat_252 ((_ to_fp 11 53) RNE cat_183)))))
