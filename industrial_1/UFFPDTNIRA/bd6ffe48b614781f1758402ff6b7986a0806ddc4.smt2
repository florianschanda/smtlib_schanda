...
(declare-const cat_239 potato_19)
(declare-const cat_240 potato_18)
...
(assert (= cat_238 (spoon_37 1)))
(assert (= cat_239 (mk_potato_19 (mk_potato_18 cat_201 cat_202))))
(assert (= cat_240 (get_potato_20_a cat_85)))
...
(assert (and (= cat_226 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_242)) (spoon_2 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_242))))
...
(assert (and (= cat_233 (fp.mul RNE cat_248 ((_ to_fp 11 53) RNE cat_179))) (spoon_2 (fp.mul RNE cat_248 ((_ to_fp 11 53) RNE cat_179)))))
