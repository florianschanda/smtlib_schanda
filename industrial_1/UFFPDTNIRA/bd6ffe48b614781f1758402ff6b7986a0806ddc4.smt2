...
(declare-const cat_241 potato_7)
(declare-const cat_242 Bool)
(declare-const cat_243 potato_19)
(declare-const cat_244 potato_18)
...
(assert (= cat_241 (mk_potato_7 cat_207)))
(assert (= cat_242 (spoon_41 1)))
(assert (= cat_243 (mk_potato_19 (mk_potato_18 cat_205 cat_206))))
(assert (= cat_244 (get_potato_20_a cat_89)))
(assert (= cat_245 (mk_potato_11 cat_210)))
(assert (= cat_246 (fp.mul RNE cat_185 cat_185)))
(assert (and (= cat_228 ((_ to_fp 11 53) RNE (fp.mul RNE cat_181 cat_181))) (spoon_2 ((_ to_fp 11 53) RNE (fp.mul RNE cat_181 cat_181)))))
(assert (= cat_247 (mk_potato_11 cat_208)))
(assert (= cat_248 cat_228))
(assert (and (= cat_229 ((_ to_fp 11 53) RNE (fp.mul RNE cat_183 cat_183))) (spoon_2 ((_ to_fp 11 53) RNE (fp.mul RNE cat_183 cat_183)))))
(assert (= cat_249 (mk_potato_11 cat_209)))
(assert (= cat_250 cat_229))
(assert (= cat_251 (mk_potato_11 cat_211)))
(assert (= cat_252 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_185)))
(assert (and (= cat_230 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_246)) (spoon_2 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_246))))
(assert (= cat_253 (mk_potato_11 cat_212)))
(assert (= cat_254 cat_230))
...
(assert (= cat_255 (mk_potato_11 cat_213)))
(assert (= cat_256 cat_233))
...
(assert (= cat_257 (mk_potato_11 cat_214)))
(assert (= cat_258 cat_236))
(assert (and (= cat_237 (fp.mul RNE cat_252 ((_ to_fp 11 53) RNE cat_183))) (spoon_2 (fp.mul RNE cat_252 ((_ to_fp 11 53) RNE cat_183)))))
(assert (= cat_238 (fp.mul RNE cat_237 cat_258)))
