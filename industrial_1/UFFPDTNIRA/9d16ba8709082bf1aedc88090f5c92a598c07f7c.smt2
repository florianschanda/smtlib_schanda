...
(assert (forall ((kitten_27 Float32) (kitten_28 Float32) (kitten_29 Float32)) (! (=> (and (and (and (spoon_29 kitten_27 true true true) (spoon_29 kitten_28 true true true)) (spoon_29 kitten_29 true true true)) (and (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) kitten_29) (or (not (fp.eq kitten_28 (fp #b0 #b00000000 #b00000000000000000000000))) (not (fp.eq kitten_27 (fp #b0 #b00000000 #b00000000000000000000000)))))) (let ((kitten_30 (spoon_30 kitten_27 kitten_28 kitten_29))) (and (=> (and (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) kitten_28) (fp.eq kitten_27 (fp #b0 #b00000000 #b00000000000000000000000))) (fp.eq kitten_30 (fp #b0 #b00000000 #b00000000000000000000000))) (spoon_29 kitten_30 true false true)))) :pattern ((spoon_30 kitten_27 kitten_28 kitten_29)))))
(declare-sort potato_13 0)
(define-fun spoon_32 ((kitten_31 Float32)) Bool (and (spoon_1 kitten_31) (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)) kitten_31) (fp.leq kitten_31 (fp #b0 #b10000101 #b01100111111101011101000)))))
...
(define-fun spoon_38 ((kitten_32 potato_14)) potato_13 (get_potato_14_a kitten_32))
(declare-sort potato_15 0)
(define-fun spoon_39 ((kitten_33 Float32)) Bool (and (spoon_1 kitten_33) (and (fp.leq (fp.neg (fp #b0 #b10001011 #b01101010100000000000000)) kitten_33) (fp.leq kitten_33 (fp #b0 #b10001011 #b01101010100000000000000)))))
...
(define-fun spoon_45 ((kitten_34 potato_16)) potato_15 (get_potato_16_a kitten_34))
(define-fun spoon_46 ((kitten_35 Float32) (kitten_36 Bool) (kitten_37 Bool) (kitten_38 Bool)) Bool (=> (or (= kitten_36 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b01101010100000000000000)) (fp #b0 #b10001011 #b01101010100000000000000))) (spoon_39 kitten_35)))
(declare-const cat_47 Float32)
(declare-const cat_48 Int)
(declare-const cat_49 Int)
(define-fun spoon_50 ((kitten_39 Float32) (kitten_40 Bool) (kitten_41 Bool) (kitten_42 Bool)) Bool (=> (or (= kitten_40 true) (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)) (fp #b0 #b10000101 #b01100111111101011101000))) (spoon_32 kitten_39)))
