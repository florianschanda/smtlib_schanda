...
(assert (= cat_159 ((_ to_fp 8 24) RNE (fp.mul RNE cat_129 cat_129))))
(assert (= cat_146 (fp.mul RNE cat_159 cat_158)))
(assert (spoon_1 (fp.mul RNE cat_159 cat_158)))
(assert (= cat_147 cat_146))
(assert (= cat_160 cat_147))
(assert (spoon_1 cat_146))
(assert (= cat_148 (fp.mul RNE cat_159 (fp.mul RNE cat_158 cat_158))))
(assert (spoon_1 (fp.mul RNE cat_159 (fp.mul RNE cat_158 cat_158))))
...
(assert (= cat_154 (fp.mul RNE (fp #b0 #b01111111 #b00000000000000000000000) cat_161)))
(assert (spoon_1 (fp.mul RNE (fp #b0 #b01111111 #b00000000000000000000000) cat_161)))
(assert (= cat_155 (ite (fp.leq cat_160 cat_154) true false)))
(assert (= cat_153 (fp.mul RNE (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)) cat_161)))
(assert (spoon_1 (fp.mul RNE (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)) cat_161)))
(assert (= cat_156 (ite (fp.leq cat_153 cat_160) true false)))
(assert (= cat_157 (ite (= cat_156 true) cat_155 false)))
(assert (= cat_162 (ite (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_161) cat_157 false)))
(assert (= cat_162 true))
