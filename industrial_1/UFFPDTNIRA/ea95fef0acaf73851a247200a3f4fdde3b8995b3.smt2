...
(declare-fun cat_154 () (_ FloatingPoint 8 24))
(declare-fun cat_155 () Bool)
(declare-fun cat_156 () Bool)
(declare-fun cat_157 () Bool)
...
(assert (= cat_158 cat_145))
(assert (= cat_159 ((_ to_fp 8 24) roundNearestTiesToEven (fp.mul roundNearestTiesToEven cat_129 cat_129))))
(assert (= cat_146 (fp.mul roundNearestTiesToEven cat_159 cat_158)))
(assert (spoon_1 (fp.mul roundNearestTiesToEven cat_159 cat_158)))
(assert (= cat_147 cat_146))
(assert (= cat_160 cat_147))
(assert (spoon_1 cat_146))
(assert (= cat_148 (fp.mul roundNearestTiesToEven cat_159 (fp.mul roundNearestTiesToEven cat_158 cat_158))))
(assert (spoon_1 (fp.mul roundNearestTiesToEven cat_159 (fp.mul roundNearestTiesToEven cat_158 cat_158))))
(assert (= cat_149 (fp.sub roundNearestTiesToEven (fp (_ bv0 1) (_ bv127 8) (_ bv0 23)) cat_148)))
(assert (= cat_150 cat_149))
(assert (spoon_1 cat_149))
(assert (= cat_151 (fp.sqrt roundNearestTiesToEven cat_150)))
(assert (= cat_152 cat_151))
(assert (= cat_161 cat_152))
(assert (spoon_1 cat_151))
(assert (= cat_154 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv127 8) (_ bv0 23)) cat_161)))
(assert (spoon_1 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv127 8) (_ bv0 23)) cat_161)))
(assert (= cat_155 (ite (fp.leq cat_160 cat_154) true false)))
(assert (= cat_153 (fp.mul roundNearestTiesToEven (fp.neg (fp (_ bv0 1) (_ bv127 8) (_ bv0 23))) cat_161)))
(assert (spoon_1 (fp.mul roundNearestTiesToEven (fp.neg (fp (_ bv0 1) (_ bv127 8) (_ bv0 23))) cat_161)))
(assert (= cat_156 (ite (fp.leq cat_153 cat_160) true false)))
(assert (= cat_157 (ite (= cat_156 true) cat_155 false)))
(assert (= cat_162 (ite (fp.lt (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) cat_161) cat_157 false)))
(assert (= cat_162 true))
