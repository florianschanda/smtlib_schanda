...
(assert (= cat_261 (mk_potato_7 cat_203)))
(assert (= cat_262 (spoon_37 1)))
(assert (= cat_263 (mk_potato_25 (mk_potato_24 cat_201 cat_202))))
(assert (= cat_264 (get_potato_26_a cat_111)))
(assert (= cat_225 (spoon_113 cat_167 cat_74)))
(assert (= cat_265 (ite (not (= cat_225 true)) true false)))
(assert (= cat_265 true))
(assert (=> (= cat_266 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_267))) (and (= cat_226 (spoon_149 (fp #b0 #b10000101 #b01100111111101011101000))) (spoon_129 cat_226)))))
(assert (=> (= cat_266 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_267))) (= cat_268 (mk_potato_10 cat_260)))))
(assert (=> (= cat_266 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_267))) (= cat_269 cat_226))))
(assert (=> (= cat_266 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_267)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_267)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (and (= cat_227 (spoon_149 (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (spoon_129 cat_227))))))
(assert (=> (= cat_266 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_267)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_267)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_270 (mk_potato_10 cat_260))))))
(assert (=> (= cat_266 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_267)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_267)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_271 cat_227)))))
(assert (=> (= cat_266 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_267)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_267)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_228 (spoon_84 (get_potato_24_a cat_267))) (spoon_1 (spoon_84 (get_potato_24_a cat_267))))))))
(assert (=> (= cat_266 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_267)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_267)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_229 (spoon_149 cat_228)) (spoon_129 cat_229))))))
(assert (=> (= cat_266 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_267)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_267)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_272 (mk_potato_10 cat_260))))))
(assert (=> (= cat_266 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_267)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_267)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_273 cat_229)))))
(assert (=> (= cat_266 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_267)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_267)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_271 cat_273)))))
(assert (=> (= cat_266 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_267)))) (= cat_269 cat_271))))
(assert (=> (= cat_266 true) (=> (spoon_189 cat_175) (and (= cat_230 (fp.mul RNE cat_175 cat_175)) (spoon_1 (fp.mul RNE cat_175 cat_175))))))
(assert (=> (= cat_266 true) (=> (spoon_189 cat_175) (= cat_274 (mk_potato_10 cat_258)))))
(assert (=> (= cat_266 true) (=> (spoon_189 cat_175) (= cat_275 cat_230))))
(assert (=> (= cat_266 true) (=> (spoon_189 cat_175) (= cat_277 cat_266))))
(assert (=> (= cat_266 true) (=> (not (spoon_189 cat_175)) (= cat_276 (mk_potato_7 cat_266)))))
(assert (=> (= cat_266 true) (=> (not (spoon_189 cat_175)) (= cat_277 (spoon_37 0)))))
(assert (=> (= cat_266 true) (=> (not (spoon_189 cat_175)) (= cat_275 cat_258))))
(assert (=> (= cat_266 true) (= cat_278 (mk_potato_10 cat_252))))
(assert (=> (= cat_266 true) (= cat_279 ((_ to_fp 8 24) RNE (fp.sub RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) (fp.mul RNE cat_171 cat_171))))))
(assert (=> (= cat_266 true) (and (= cat_231 cat_279) (spoon_1 cat_279))))
(assert (=> (= cat_266 true) (and (= cat_232 (spoon_146 cat_231)) (spoon_138 cat_232))))
(assert (=> (= cat_266 true) (= cat_280 (mk_potato_10 cat_250))))
(assert (=> (= cat_266 true) (= cat_281 cat_232)))
...
(assert (=> (= cat_277 true) (and (= cat_233 (fp.sub RNE cat_279 cat_275)) (spoon_1 (fp.sub RNE cat_279 cat_275)))))
(assert (=> (= cat_277 true) (= cat_234 (fp.add RNE cat_233 (fp.mul RNE cat_269 cat_269)))))
(assert (=> (= cat_277 true) (and (= cat_235 cat_234) (spoon_1 cat_234))))
(assert (=> (= cat_277 true) (= cat_282 (mk_potato_10 cat_256))))
(assert (=> (= cat_277 true) (= cat_283 cat_235)))
(assert (=> (= cat_277 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_283) (and (= cat_236 cat_283) (spoon_1 cat_283)))))
(assert (=> (= cat_277 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_283) (and (= cat_237 (spoon_146 cat_236)) (spoon_138 cat_237)))))
(assert (=> (= cat_277 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_283) (= cat_284 (mk_potato_10 cat_254)))))
(assert (=> (= cat_277 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_283) (= cat_285 cat_237))))
...
(assert (=> (= cat_277 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_283)) (= cat_287 (spoon_37 0)))))
...
(assert (= cat_287 true))
(assert (and (= cat_242 (fp.mul RNE cat_285 cat_175)) (spoon_1 (fp.mul RNE cat_285 cat_175))))
(assert (and (= cat_238 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_171 cat_171)) cat_275)) (spoon_1 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_171 cat_171)) cat_275))))
(assert (= cat_239 (fp.mul RNE cat_281 cat_238)))
(assert (and (= cat_240 cat_239) (spoon_1 cat_239)))
(assert (= cat_241 (fp.mul RNE cat_240 cat_269)))
...
(assert (= cat_288 (mk_potato_10 cat_211)))
(assert (= cat_289 cat_245))
(assert (and (= cat_246 (fp.mul RNE cat_285 cat_175)) (spoon_1 (fp.mul RNE cat_285 cat_175))))
(assert (= cat_247 (fp.mul RNE cat_246 cat_269)))
(assert (and (= cat_248 cat_247) (spoon_1 cat_247)))
(assert (not (spoon_1 (fp.mul RNE cat_281 cat_283))))
(check-sat)
(exit)
