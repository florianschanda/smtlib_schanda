...
(assert (and (= cat_230 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_251)) (spoon_2 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_251))))
...
(assert (and (= cat_241 (fp.mul RNE cat_257 ((_ to_fp 11 53) RNE cat_183))) (spoon_2 (fp.mul RNE cat_257 ((_ to_fp 11 53) RNE cat_183)))))
(assert (= cat_242 (fp.mul RNE cat_241 cat_263)))
(assert (and (= cat_243 cat_242) (spoon_2 cat_242)))
(assert (and (= cat_237 (fp.sub RNE cat_259 cat_253)) (spoon_2 (fp.sub RNE cat_259 cat_253))))
