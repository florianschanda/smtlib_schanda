...
(declare-const cat_248 potato_19)
(declare-const cat_249 potato_18)
...
(assert (= cat_248 (mk_potato_19 (mk_potato_18 cat_205 cat_206))))
(assert (= cat_249 (get_potato_20_a cat_89)))
(assert (= cat_250 (mk_potato_11 cat_210)))
(assert (= cat_251 (fp.mul RNE cat_185 cat_185)))
...
(assert (= cat_256 (mk_potato_11 cat_211)))
(assert (= cat_257 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_185)))
(assert (and (= cat_230 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_251)) (spoon_3 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_251))))
(assert (= cat_258 (mk_potato_11 cat_212)))
(assert (= cat_259 cat_230))
...
(assert (= cat_260 (mk_potato_11 cat_213)))
(assert (= cat_261 cat_233))
...
(assert (= cat_262 (mk_potato_11 cat_214)))
(assert (= cat_263 cat_236))
(assert (and (= cat_241 (fp.mul RNE cat_257 ((_ to_fp 11 53) RNE cat_183))) (spoon_3 (fp.mul RNE cat_257 ((_ to_fp 11 53) RNE cat_183)))))
(assert (= cat_242 (fp.mul RNE cat_241 cat_263)))
(assert (and (= cat_243 cat_242) (spoon_3 cat_242)))
(assert (and (= cat_237 (fp.sub RNE cat_259 cat_253)) (spoon_3 (fp.sub RNE cat_259 cat_253))))
(assert (= cat_238 (fp.sub RNE cat_237 cat_255)))
(assert (and (= cat_239 cat_238) (spoon_3 cat_238)))
(assert (= cat_240 (fp.mul RNE cat_239 cat_261)))
(assert (not (spoon_3 cat_240)))
(check-sat)
(exit)
