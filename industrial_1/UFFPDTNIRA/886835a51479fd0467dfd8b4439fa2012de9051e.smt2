...
(assert (= cat_244 (mk_potato_19 (mk_potato_18 cat_201 cat_202))))
(assert (= cat_245 (get_potato_20_a cat_85)))
(assert (= cat_246 (mk_potato_11 cat_206)))
(assert (= cat_247 (fp.mul RNE cat_181 cat_181)))
(assert (and (= cat_224 ((_ to_fp 11 53) RNE (fp.mul RNE cat_177 cat_177))) (spoon_2 ((_ to_fp 11 53) RNE (fp.mul RNE cat_177 cat_177)))))
(assert (= cat_248 (mk_potato_11 cat_204)))
(assert (= cat_249 cat_224))
(assert (and (= cat_225 ((_ to_fp 11 53) RNE (fp.mul RNE cat_179 cat_179))) (spoon_2 ((_ to_fp 11 53) RNE (fp.mul RNE cat_179 cat_179)))))
(assert (= cat_250 (mk_potato_11 cat_205)))
(assert (= cat_251 cat_225))
(assert (= cat_252 (mk_potato_11 cat_207)))
(assert (= cat_253 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_181)))
(assert (and (= cat_226 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_247)) (spoon_2 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_247))))
(assert (= cat_254 (mk_potato_11 cat_208)))
(assert (= cat_255 cat_226))
...
(assert (= cat_259 cat_232))
(assert (and (= cat_237 (fp.mul RNE cat_253 ((_ to_fp 11 53) RNE cat_179))) (spoon_2 (fp.mul RNE cat_253 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_238 (fp.mul RNE cat_237 cat_259)))
(assert (and (= cat_239 cat_238) (spoon_2 cat_238)))
(assert (and (= cat_233 (fp.sub RNE cat_255 cat_249)) (spoon_2 (fp.sub RNE cat_255 cat_249))))
(assert (= cat_234 (fp.sub RNE cat_233 cat_251)))
(assert (and (= cat_235 cat_234) (spoon_2 cat_234)))
(assert (= cat_236 (fp.mul RNE cat_235 cat_257)))
(assert (not (spoon_2 cat_236)))
(check-sat)
(exit)
