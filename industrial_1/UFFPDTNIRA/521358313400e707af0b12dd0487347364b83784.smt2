...
(assert (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011100001) cat_56) (= cat_57 cat_56)))
(assert (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011100001) cat_56) (= cat_58 (fp #b0 #b10000101 #b01100111111101011100001))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011100001) cat_56)) (=> (fp.lt cat_56 (fp.neg (fp #b0 #b10000101 #b01100111111101011100001))) (= cat_59 cat_56))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011100001) cat_56)) (=> (fp.lt cat_56 (fp.neg (fp #b0 #b10000101 #b01100111111101011100001))) (= cat_60 (fp.neg (fp #b0 #b10000101 #b01100111111101011100001))))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011100001) cat_56)) (=> (not (fp.lt cat_56 (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)))) (= cat_60 cat_56))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011100001) cat_56)) (= cat_58 cat_60)))
(assert (not (spoon_34 cat_58)))
(check-sat)
(exit)
