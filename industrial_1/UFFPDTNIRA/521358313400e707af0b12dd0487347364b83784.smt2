...
(assert (and (= cat_54 (spoon_32 cat_49 (fp #b0 #b01111111 #b00000000000000000000000) (fp #b0 #b10000111 #b01101000000000000000000))) (and (spoon_1 cat_54) (=> (and (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b01111111 #b00000000000000000000000)) (fp.eq cat_49 (fp #b0 #b00000000 #b00000000000000000000000))) (fp.eq cat_54 (fp #b0 #b00000000 #b00000000000000000000000))))))
(assert (= cat_56 cat_53))
(assert (= cat_57 cat_54))
(assert (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011100001) cat_57) (= cat_58 cat_57)))
(assert (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011100001) cat_57) (= cat_59 (fp #b0 #b10000101 #b01100111111101011100001))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011100001) cat_57)) (=> (fp.lt cat_57 (fp.neg (fp #b0 #b10000101 #b01100111111101011100001))) (= cat_60 cat_57))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011100001) cat_57)) (=> (fp.lt cat_57 (fp.neg (fp #b0 #b10000101 #b01100111111101011100001))) (= cat_61 (fp.neg (fp #b0 #b10000101 #b01100111111101011100001))))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011100001) cat_57)) (=> (not (fp.lt cat_57 (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)))) (= cat_61 cat_57))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011100001) cat_57)) (= cat_59 cat_61)))
(assert (not (spoon_34 cat_59)))
(check-sat)
(exit)
