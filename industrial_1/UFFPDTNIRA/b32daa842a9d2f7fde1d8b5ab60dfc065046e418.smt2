...
(declare-fun cat_263 () potato_29)
(declare-fun cat_264 () potato_28)
...
(assert (= cat_260 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
...
(assert (= cat_266 (fp.mul roundNearestTiesToEven cat_181 cat_181)))
...
(assert (= cat_272 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1025 11) (_ bv0 52)) cat_181)))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1025 11) (_ bv0 52)) cat_266))) (and (= cat_226 _let_0) (spoon_3 _let_0))))
...
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_272 ((_ to_fp 11 53) roundNearestTiesToEven cat_179)))) (and (= cat_237 _let_0) (spoon_3 _let_0))))
(assert (= cat_238 (fp.mul roundNearestTiesToEven cat_237 cat_278)))
(assert (and (= cat_239 cat_238) (spoon_3 cat_238)))
(assert (let ((_let_0 (fp.sub roundNearestTiesToEven cat_274 cat_268))) (and (= cat_233 _let_0) (spoon_3 _let_0))))
(assert (= cat_234 (fp.sub roundNearestTiesToEven cat_233 cat_270)))
(assert (and (= cat_235 cat_234) (spoon_3 cat_234)))
(assert (= cat_236 (fp.mul roundNearestTiesToEven cat_235 cat_276)))
...
(assert (let ((_let_0 (fp.add roundNearestTiesToEven cat_274 cat_268))) (and (= cat_243 _let_0) (spoon_3 _let_0))))
(assert (= cat_244 (fp.add roundNearestTiesToEven cat_243 cat_270)))
(assert (and (= cat_245 cat_244) (spoon_3 cat_244)))
(assert (= cat_281 (mk_potato_11 cat_214)))
(assert (= cat_282 cat_245))
(assert (let ((_let_0 (fp.div roundNearestTiesToEven cat_280 cat_282))) (and (= cat_246 _let_0) (spoon_3 _let_0))))
(assert (= cat_283 (mk_potato_11 cat_212)))
(assert (= cat_284 cat_246))
(assert (=> (fp.lt cat_284 (fp.neg (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (= cat_285 spoon_295)))
(assert (let ((_let_0 (fp.neg (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52))))) (=> (fp.lt cat_284 _let_0) (= cat_286 _let_0))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_284 (fp.neg _let_0))) (=> (fp.lt _let_0 cat_284) (= cat_287 spoon_295)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_284 (fp.neg _let_0))) (=> (fp.lt _let_0 cat_284) (= cat_288 _let_0)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_284 (fp.neg _let_0))) (=> (not (fp.lt _let_0 cat_284)) (and (= cat_247 cat_284) (spoon_3 cat_284))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_284 (fp.neg _let_0))) (=> (not (fp.lt _let_0 cat_284)) (= cat_289 spoon_295)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_284 (fp.neg _let_0))) (=> (not (fp.lt _let_0 cat_284)) (= cat_290 cat_247)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_284 (fp.neg _let_0))) (=> (not (fp.lt _let_0 cat_284)) (= cat_288 cat_290)))))
(assert (=> (not (fp.lt cat_284 (fp.neg (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52))))) (= cat_286 cat_288)))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_272 ((_ to_fp 11 53) roundNearestTiesToEven cat_177)))) (and (= cat_248 _let_0) (spoon_3 _let_0))))
(assert (= cat_291 (mk_potato_11 cat_216)))
(assert (= cat_292 cat_248))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_272 ((_ to_fp 11 53) roundNearestTiesToEven cat_179)))) (and (= cat_253 _let_0) (spoon_3 _let_0))))
(assert (= cat_254 (fp.mul roundNearestTiesToEven cat_253 cat_276)))
(assert (and (= cat_255 cat_254) (spoon_3 cat_254)))
(assert (let ((_let_0 (fp.sub roundNearestTiesToEven cat_274 cat_268))) (and (= cat_249 _let_0) (spoon_3 _let_0))))
(assert (= cat_250 (fp.sub roundNearestTiesToEven cat_249 cat_270)))
(assert (and (= cat_251 cat_250) (spoon_3 cat_250)))
(assert (= cat_252 (fp.mul roundNearestTiesToEven cat_251 cat_278)))
...
(assert (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_294))
(assert (not (spoon_3 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1035 11) (_ bv1873567813730304 52)) cat_294))))
(check-sat)
(exit)
