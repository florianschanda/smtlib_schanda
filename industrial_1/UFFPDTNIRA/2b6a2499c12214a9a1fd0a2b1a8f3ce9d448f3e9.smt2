...
(declare-const cat_261 potato_25)
(declare-const cat_262 potato_24)
(declare-const cat_263 Bool)
(declare-const cat_264 Bool)
(declare-const cat_265 potato_24)
...
(declare-const cat_284 potato_7)
...
(assert (= cat_259 (mk_potato_7 cat_207)))
(assert (= cat_260 (spoon_41 1)))
(assert (= cat_261 (mk_potato_25 (mk_potato_24 cat_205 cat_206))))
(assert (= cat_262 (get_potato_26_a cat_115)))
(assert (= cat_229 (spoon_117 cat_171 cat_78)))
(assert (= cat_263 (ite (not (= cat_229 true)) true false)))
(assert (= cat_263 true))
(assert (=> (= cat_264 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_265))) (and (= cat_230 (spoon_153 (fp #b0 #b10000101 #b01100111111101011101000))) (spoon_133 cat_230)))))
(assert (=> (= cat_264 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_265))) (= cat_266 (mk_potato_10 cat_258)))))
(assert (=> (= cat_264 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_265))) (= cat_267 cat_230))))
(assert (=> (= cat_264 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_265)))) (=> (fp.lt (spoon_88 (get_potato_24_a cat_265)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (and (= cat_231 (spoon_153 (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (spoon_133 cat_231))))))
(assert (=> (= cat_264 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_265)))) (=> (fp.lt (spoon_88 (get_potato_24_a cat_265)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_268 (mk_potato_10 cat_258))))))
(assert (=> (= cat_264 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_265)))) (=> (fp.lt (spoon_88 (get_potato_24_a cat_265)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_269 cat_231)))))
(assert (=> (= cat_264 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_265)))) (=> (not (fp.lt (spoon_88 (get_potato_24_a cat_265)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_232 (spoon_88 (get_potato_24_a cat_265))) (spoon_1 (spoon_88 (get_potato_24_a cat_265))))))))
(assert (=> (= cat_264 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_265)))) (=> (not (fp.lt (spoon_88 (get_potato_24_a cat_265)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_233 (spoon_153 cat_232)) (spoon_133 cat_233))))))
(assert (=> (= cat_264 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_265)))) (=> (not (fp.lt (spoon_88 (get_potato_24_a cat_265)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_270 (mk_potato_10 cat_258))))))
(assert (=> (= cat_264 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_265)))) (=> (not (fp.lt (spoon_88 (get_potato_24_a cat_265)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_271 cat_233)))))
(assert (=> (= cat_264 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_265)))) (=> (not (fp.lt (spoon_88 (get_potato_24_a cat_265)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_269 cat_271)))))
(assert (=> (= cat_264 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_265)))) (= cat_267 cat_269))))
(assert (=> (= cat_264 true) (=> (spoon_193 cat_179) (and (= cat_234 (fp.mul RNE cat_179 cat_179)) (spoon_1 (fp.mul RNE cat_179 cat_179))))))
(assert (=> (= cat_264 true) (=> (spoon_193 cat_179) (= cat_272 (mk_potato_10 cat_256)))))
(assert (=> (= cat_264 true) (=> (spoon_193 cat_179) (= cat_273 cat_234))))
(assert (=> (= cat_264 true) (=> (spoon_193 cat_179) (= cat_275 cat_264))))
(assert (=> (= cat_264 true) (=> (not (spoon_193 cat_179)) (= cat_274 (mk_potato_7 cat_264)))))
(assert (=> (= cat_264 true) (=> (not (spoon_193 cat_179)) (= cat_275 (spoon_41 0)))))
(assert (=> (= cat_264 true) (=> (not (spoon_193 cat_179)) (= cat_273 cat_256))))
(assert (=> (= cat_264 true) (= cat_276 (mk_potato_10 cat_250))))
(assert (=> (= cat_264 true) (= cat_277 ((_ to_fp 8 24) RNE (fp.sub RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) (fp.mul RNE cat_175 cat_175))))))
(assert (=> (= cat_264 true) (and (= cat_235 cat_277) (spoon_1 cat_277))))
(assert (=> (= cat_264 true) (and (= cat_236 (spoon_150 cat_235)) (spoon_142 cat_236))))
(assert (=> (= cat_264 true) (= cat_278 (mk_potato_10 cat_248))))
(assert (=> (= cat_264 true) (= cat_279 cat_236)))
(assert (=> (not (= cat_264 true)) (= cat_267 cat_258)))
(assert (=> (not (= cat_264 true)) (= cat_273 cat_256)))
(assert (=> (not (= cat_264 true)) (= cat_277 cat_250)))
(assert (=> (not (= cat_264 true)) (= cat_279 cat_248)))
(assert (=> (not (= cat_264 true)) (= cat_275 cat_264)))
(assert (=> (= cat_275 true) (and (= cat_237 (fp.sub RNE cat_277 cat_273)) (spoon_1 (fp.sub RNE cat_277 cat_273)))))
(assert (=> (= cat_275 true) (= cat_238 (fp.add RNE cat_237 (fp.mul RNE cat_267 cat_267)))))
(assert (=> (= cat_275 true) (and (= cat_239 cat_238) (spoon_1 cat_238))))
(assert (=> (= cat_275 true) (= cat_280 (mk_potato_10 cat_254))))
(assert (=> (= cat_275 true) (= cat_281 cat_239)))
(assert (=> (= cat_275 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_281) (and (= cat_240 cat_281) (spoon_1 cat_281)))))
(assert (=> (= cat_275 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_281) (and (= cat_241 (spoon_150 cat_240)) (spoon_142 cat_241)))))
(assert (=> (= cat_275 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_281) (= cat_282 (mk_potato_10 cat_252)))))
(assert (=> (= cat_275 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_281) (= cat_283 cat_241))))
(assert (=> (= cat_275 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_281) (= cat_285 cat_275))))
(assert (=> (= cat_275 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_281)) (= cat_284 (mk_potato_7 cat_275)))))
(assert (=> (= cat_275 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_281)) (= cat_285 (spoon_41 0)))))
(assert (=> (= cat_275 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_281)) (= cat_283 cat_252))))
(assert (=> (not (= cat_275 true)) (= cat_281 cat_254)))
(assert (=> (not (= cat_275 true)) (= cat_283 cat_252)))
(assert (=> (not (= cat_275 true)) (= cat_285 cat_275)))
(assert (= cat_285 true))
(assert (and (= cat_246 (fp.mul RNE cat_283 cat_179)) (spoon_1 (fp.mul RNE cat_283 cat_179))))
(assert (and (= cat_242 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_175 cat_175)) cat_273)) (spoon_1 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_175 cat_175)) cat_273))))
(assert (= cat_243 (fp.mul RNE cat_279 cat_242)))
(assert (and (= cat_244 cat_243) (spoon_1 cat_243)))
(assert (= cat_245 (fp.mul RNE cat_244 cat_267)))
(assert (not (spoon_1 cat_245)))
(check-sat)
(exit)
