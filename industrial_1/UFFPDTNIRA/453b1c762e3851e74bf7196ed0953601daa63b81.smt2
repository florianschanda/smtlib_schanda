...
(assert (= cat_245 (spoon_37 1)))
(assert (= cat_246 (mk_potato_19 (mk_potato_18 cat_201 cat_202))))
(assert (= cat_247 (get_potato_20_a cat_85)))
...
(assert (and (= cat_226 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_249)) (spoon_2 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_249))))
...
(assert (and (= cat_237 (fp.mul RNE cat_255 ((_ to_fp 11 53) RNE cat_179))) (spoon_2 (fp.mul RNE cat_255 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_238 (fp.mul RNE cat_237 cat_261)))
(assert (and (= cat_239 cat_238) (spoon_2 cat_238)))
(assert (and (= cat_233 (fp.sub RNE cat_257 cat_251)) (spoon_2 (fp.sub RNE cat_257 cat_251))))
