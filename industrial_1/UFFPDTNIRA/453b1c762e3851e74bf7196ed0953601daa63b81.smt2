...
(assert (= cat_248 (mk_potato_7 cat_207)))
(assert (= cat_249 (spoon_41 1)))
(assert (= cat_250 (mk_potato_19 (mk_potato_18 cat_205 cat_206))))
(assert (= cat_251 (get_potato_20_a cat_89)))
(assert (= cat_252 (mk_potato_11 cat_210)))
(assert (= cat_253 (fp.mul RNE cat_185 cat_185)))
(assert (and (= cat_228 ((_ to_fp 11 53) RNE (fp.mul RNE cat_181 cat_181))) (spoon_2 ((_ to_fp 11 53) RNE (fp.mul RNE cat_181 cat_181)))))
(assert (= cat_254 (mk_potato_11 cat_208)))
(assert (= cat_255 cat_228))
(assert (and (= cat_229 ((_ to_fp 11 53) RNE (fp.mul RNE cat_183 cat_183))) (spoon_2 ((_ to_fp 11 53) RNE (fp.mul RNE cat_183 cat_183)))))
(assert (= cat_256 (mk_potato_11 cat_209)))
(assert (= cat_257 cat_229))
(assert (= cat_258 (mk_potato_11 cat_211)))
(assert (= cat_259 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_185)))
(assert (and (= cat_230 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_253)) (spoon_2 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_253))))
(assert (= cat_260 (mk_potato_11 cat_212)))
(assert (= cat_261 cat_230))
...
(assert (= cat_262 (mk_potato_11 cat_213)))
(assert (= cat_263 cat_233))
...
(assert (= cat_264 (mk_potato_11 cat_214)))
(assert (= cat_265 cat_236))
(assert (and (= cat_241 (fp.mul RNE cat_259 ((_ to_fp 11 53) RNE cat_183))) (spoon_2 (fp.mul RNE cat_259 ((_ to_fp 11 53) RNE cat_183)))))
(assert (= cat_242 (fp.mul RNE cat_241 cat_265)))
(assert (and (= cat_243 cat_242) (spoon_2 cat_242)))
(assert (and (= cat_237 (fp.sub RNE cat_261 cat_255)) (spoon_2 (fp.sub RNE cat_261 cat_255))))
(assert (= cat_238 (fp.sub RNE cat_237 cat_257)))
(assert (and (= cat_239 cat_238) (spoon_2 cat_238)))
(assert (= cat_240 (fp.mul RNE cat_239 cat_263)))
(assert (and (= cat_244 cat_240) (spoon_2 cat_240)))
(assert (= cat_245 (fp.add RNE cat_244 cat_243)))
(assert (not (spoon_2 cat_245)))
(check-sat)
(exit)
