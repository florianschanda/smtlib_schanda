...
(declare-fun cat_247 () potato_29)
(declare-fun cat_248 () potato_28)
...
(assert (= cat_244 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
(assert (spoon_100 cat_244))
...
(assert (= cat_246 (distinct 1 0)))
(assert (= cat_247 (mk_potato_29 (mk_potato_28 cat_201 cat_202))))
(assert (= cat_248 (get_potato_30_a cat_138)))
(assert (= cat_249 (mk_potato_11 cat_206)))
(assert (= cat_250 (fp.mul roundNearestTiesToEven cat_181 cat_181)))
...
(assert (= cat_256 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1025 11) (_ bv0 52)) cat_181)))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1025 11) (_ bv0 52)) cat_250))) (and (= cat_226 _let_0) (spoon_3 _let_0))))
...
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_256 ((_ to_fp 11 53) roundNearestTiesToEven cat_179)))) (and (= cat_237 _let_0) (spoon_3 _let_0))))
(assert (= cat_238 (fp.mul roundNearestTiesToEven cat_237 cat_262)))
(assert (and (= cat_239 cat_238) (spoon_3 cat_238)))
(assert (let ((_let_0 (fp.sub roundNearestTiesToEven cat_258 cat_252))) (and (= cat_233 _let_0) (spoon_3 _let_0))))
(assert (= cat_234 (fp.sub roundNearestTiesToEven cat_233 cat_254)))
(assert (and (= cat_235 cat_234) (spoon_3 cat_234)))
(assert (= cat_236 (fp.mul roundNearestTiesToEven cat_235 cat_260)))
...
(assert (not (spoon_3 (fp.add roundNearestTiesToEven cat_258 cat_252))))
(check-sat)
(exit)
