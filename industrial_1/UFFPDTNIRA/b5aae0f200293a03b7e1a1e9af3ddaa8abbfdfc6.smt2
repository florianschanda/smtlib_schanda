...
(declare-const cat_247 potato_29)
(declare-const cat_248 potato_28)
...
(assert (and (= cat_226 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_250)) (spoon_3 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_250))))
...
(assert (and (= cat_237 (fp.mul RNE cat_256 ((_ to_fp 11 53) RNE cat_179))) (spoon_3 (fp.mul RNE cat_256 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_238 (fp.mul RNE cat_237 cat_262)))
(assert (and (= cat_239 cat_238) (spoon_3 cat_238)))
(assert (and (= cat_233 (fp.sub RNE cat_258 cat_252)) (spoon_3 (fp.sub RNE cat_258 cat_252))))
...
(assert (not (spoon_3 (fp.add RNE cat_258 cat_252))))
(check-sat)
(exit)
