...
(assert (= cat_96 cat_93))
(assert (= cat_97 cat_94))
(assert (fp.lt (fp.add RNE (spoon_65 (get_potato_21_b (get_potato_23_a cat_86))) (spoon_65 (get_potato_21_b (get_potato_23_a cat_88)))) cat_97))
(assert (not (spoon_50 (fp.sub RNE cat_97 (fp.add RNE (spoon_65 (get_potato_21_b (get_potato_23_a cat_86))) (spoon_65 (get_potato_21_b (get_potato_23_a cat_88))))))))
(check-sat)
(exit)
