...
(declare-const cat_253 potato_29)
(declare-const cat_254 potato_28)
...
(assert (and (= cat_226 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_256)) (spoon_3 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_256))))
...
(assert (and (= cat_237 (fp.mul RNE cat_262 ((_ to_fp 11 53) RNE cat_179))) (spoon_3 (fp.mul RNE cat_262 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_238 (fp.mul RNE cat_237 cat_268)))
(assert (and (= cat_239 cat_238) (spoon_3 cat_238)))
(assert (and (= cat_233 (fp.sub RNE cat_264 cat_258)) (spoon_3 (fp.sub RNE cat_264 cat_258))))
...
(assert (and (= cat_243 (fp.add RNE cat_264 cat_258)) (spoon_3 (fp.add RNE cat_264 cat_258))))
...
(assert (and (= cat_246 (fp.div RNE cat_270 cat_272)) (spoon_3 (fp.div RNE cat_270 cat_272))))
...
(assert (=> (not (fp.lt cat_274 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_274)) (and (= cat_247 cat_274) (spoon_3 cat_274)))))
...
(assert (and (= cat_248 (fp.mul RNE cat_262 ((_ to_fp 11 53) RNE cat_177))) (spoon_3 (fp.mul RNE cat_262 ((_ to_fp 11 53) RNE cat_177)))))
(assert (= cat_281 (mk_potato_11 cat_216)))
(assert (= cat_282 cat_248))
(assert (not (spoon_3 (fp.mul RNE cat_262 ((_ to_fp 11 53) RNE cat_179)))))
(check-sat)
(exit)
