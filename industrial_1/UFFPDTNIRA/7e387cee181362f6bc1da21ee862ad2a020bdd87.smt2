...
(declare-const cat_251 potato_29)
(declare-const cat_252 potato_28)
...
(assert (= cat_254 (fp.mul RNE cat_181 cat_181)))
...
(assert (= cat_260 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_181)))
(assert (and (= cat_226 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_254)) (spoon_3 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_254))))
...
(assert (and (= cat_237 (fp.mul RNE cat_260 ((_ to_fp 11 53) RNE cat_179))) (spoon_3 (fp.mul RNE cat_260 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_238 (fp.mul RNE cat_237 cat_266)))
(assert (and (= cat_239 cat_238) (spoon_3 cat_238)))
(assert (and (= cat_233 (fp.sub RNE cat_262 cat_256)) (spoon_3 (fp.sub RNE cat_262 cat_256))))
(assert (= cat_234 (fp.sub RNE cat_233 cat_258)))
(assert (and (= cat_235 cat_234) (spoon_3 cat_234)))
(assert (= cat_236 (fp.mul RNE cat_235 cat_264)))
...
(assert (and (= cat_243 (fp.add RNE cat_262 cat_256)) (spoon_3 (fp.add RNE cat_262 cat_256))))
(assert (= cat_244 (fp.add RNE cat_243 cat_258)))
(assert (and (= cat_245 cat_244) (spoon_3 cat_244)))
(assert (= cat_269 (mk_potato_11 cat_214)))
(assert (= cat_270 cat_245))
(assert (and (= cat_246 (fp.div RNE cat_268 cat_270)) (spoon_3 (fp.div RNE cat_268 cat_270))))
(assert (= cat_271 (mk_potato_11 cat_212)))
(assert (= cat_272 cat_246))
(assert (not (fp.lt cat_272 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))))
(assert (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_272)))
