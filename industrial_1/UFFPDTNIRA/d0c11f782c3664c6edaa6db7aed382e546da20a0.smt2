...
(assert (= cat_146 cat_145))
(assert (= cat_147 ((_ to_fp 8 24) roundNearestTiesToEven (fp.mul roundNearestTiesToEven cat_129 cat_129))))
(assert (not (spoon_1 (fp.mul roundNearestTiesToEven cat_147 cat_146))))
(check-sat)
(exit)
