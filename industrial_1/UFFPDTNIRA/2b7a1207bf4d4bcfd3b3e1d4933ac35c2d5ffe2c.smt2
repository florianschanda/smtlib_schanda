...
(declare-const cat_227 Bool)
(declare-const cat_228 potato_28)
...
(declare-const cat_245 potato_7)
...
(assert (spoon_1 cat_220))
(assert (= cat_221 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_1 cat_221))
(assert (= cat_222 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_1 cat_222))
(assert (= cat_223 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_1 cat_223))
(assert (= cat_224 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_154 cat_224))
(assert (= cat_225 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_86 cat_225))
...
(assert (= cat_226 (ite (not (= cat_200 true)) true false)))
(assert (= cat_226 true))
(assert (=> (= cat_227 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_228))) (and (= cat_201 (spoon_76 (fp #b0 #b10000101 #b01100111111101011101000))) (spoon_86 cat_201)))))
(assert (=> (= cat_227 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_228))) (= cat_229 (mk_potato_10 cat_225)))))
(assert (=> (= cat_227 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_228))) (= cat_230 cat_201))))
(assert (=> (= cat_227 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_228)))) (=> (fp.lt (spoon_111 (get_potato_28_a cat_228)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (and (= cat_202 (spoon_76 (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (spoon_86 cat_202))))))
(assert (=> (= cat_227 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_228)))) (=> (fp.lt (spoon_111 (get_potato_28_a cat_228)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_231 (mk_potato_10 cat_225))))))
(assert (=> (= cat_227 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_228)))) (=> (fp.lt (spoon_111 (get_potato_28_a cat_228)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_232 cat_202)))))
(assert (=> (= cat_227 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_228)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_228)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_203 (spoon_111 (get_potato_28_a cat_228))) (spoon_1 (spoon_111 (get_potato_28_a cat_228))))))))
(assert (=> (= cat_227 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_228)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_228)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_204 (spoon_76 cat_203)) (spoon_86 cat_204))))))
(assert (=> (= cat_227 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_228)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_228)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_233 (mk_potato_10 cat_225))))))
(assert (=> (= cat_227 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_228)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_228)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_234 cat_204)))))
(assert (=> (= cat_227 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_228)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_228)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_232 cat_234)))))
(assert (=> (= cat_227 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_228)))) (= cat_230 cat_232))))
(assert (=> (= cat_227 true) (= cat_235 (mk_potato_10 cat_224))))
(assert (=> (= cat_227 true) (= cat_236 (fp.mul RNE cat_170 cat_170))))
(assert (=> (= cat_227 true) (= cat_237 (mk_potato_10 cat_221))))
(assert (=> (= cat_227 true) (= cat_238 ((_ to_fp 8 24) RNE (fp.sub RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) (fp.mul RNE cat_166 cat_166))))))
(assert (=> (= cat_227 true) (= cat_239 (mk_potato_10 cat_220))))
(assert (=> (= cat_227 true) (= cat_240 (fp.sqrt RNE cat_238))))
(assert (=> (not (= cat_227 true)) (= cat_230 cat_225)))
(assert (=> (not (= cat_227 true)) (= cat_236 cat_224)))
(assert (=> (not (= cat_227 true)) (= cat_238 cat_221)))
(assert (=> (not (= cat_227 true)) (= cat_240 cat_220)))
(assert (=> (= cat_227 true) (and (= cat_205 (fp.sub RNE cat_238 cat_236)) (spoon_1 (fp.sub RNE cat_238 cat_236)))))
(assert (=> (= cat_227 true) (= cat_206 (fp.add RNE cat_205 (fp.mul RNE cat_230 cat_230)))))
(assert (=> (= cat_227 true) (and (= cat_207 cat_206) (spoon_1 cat_206))))
(assert (=> (= cat_227 true) (= cat_241 (mk_potato_10 cat_223))))
(assert (=> (= cat_227 true) (= cat_242 cat_207)))
(assert (=> (= cat_227 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_242) (= cat_243 (mk_potato_10 cat_222)))))
(assert (=> (= cat_227 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_242) (= cat_244 (fp.sqrt RNE cat_242)))))
(assert (=> (= cat_227 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_242) (= cat_246 cat_227))))
(assert (=> (= cat_227 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_242)) (= cat_245 (mk_potato_7 cat_227)))))
(assert (=> (= cat_227 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_242)) (= cat_246 (distinct 0 0)))))
(assert (=> (= cat_227 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_242)) (= cat_244 cat_222))))
(assert (=> (not (= cat_227 true)) (= cat_242 cat_223)))
(assert (=> (not (= cat_227 true)) (= cat_244 cat_222)))
(assert (=> (not (= cat_227 true)) (= cat_246 cat_227)))
(assert (= cat_246 true))
(assert (= cat_210 (fp.mul RNE cat_244 cat_170)))
(assert (spoon_1 (fp.mul RNE cat_244 cat_170)))
(assert (= cat_208 (fp.mul RNE cat_240 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_166 cat_166)) cat_236))))
(assert (spoon_1 (fp.mul RNE cat_240 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_166 cat_166)) cat_236))))
(assert (= cat_209 (fp.mul RNE cat_208 cat_230)))
...
(assert (= cat_214 (fp.mul RNE cat_244 cat_170)))
(assert (spoon_1 (fp.mul RNE cat_244 cat_170)))
(assert (= cat_215 (fp.mul RNE cat_214 cat_230)))
(assert (= cat_216 cat_215))
(assert (spoon_1 cat_215))
(assert (= cat_217 (fp.mul RNE cat_240 cat_242)))
(assert (spoon_1 (fp.mul RNE cat_240 cat_242)))
(assert (= cat_218 (fp.sub RNE cat_217 cat_216)))
(assert (= cat_219 cat_218))
(assert (= cat_248 cat_219))
(assert (spoon_1 cat_218))
(assert (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_248))
(assert (spoon_1 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_248)))
(assert (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_247)))
(assert (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_247)))
(assert (not (spoon_1 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_248))))
(check-sat)
(exit)
