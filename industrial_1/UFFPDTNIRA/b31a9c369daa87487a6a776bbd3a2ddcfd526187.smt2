...
(assert (= cat_107 cat_99))
(assert (= cat_108 cat_101))
(assert (and (= cat_102 (spoon_64 cat_68 cat_70)) (spoon_48 cat_102)))
(assert (= cat_109 cat_100))
(assert (= cat_110 cat_102))
(assert (= cat_111 cat_98))
(assert (= cat_112 (fp.sub RNE cat_110 cat_108)))
(assert (=> (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_112) (and (= cat_103 (fp.sub RNE cat_112 (fp #b0 #b10000111 #b01101000000000000000000))) (spoon_1 (fp.sub RNE cat_112 (fp #b0 #b10000111 #b01101000000000000000000))))))
(assert (=> (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_112) (= cat_113 cat_95)))
(assert (=> (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_112) (= cat_114 cat_103)))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_112)) (=> (fp.leq cat_112 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000))) (and (= cat_104 (fp.add RNE cat_112 (fp #b0 #b10000111 #b01101000000000000000000))) (spoon_1 (fp.add RNE cat_112 (fp #b0 #b10000111 #b01101000000000000000000)))))))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_112)) (=> (fp.leq cat_112 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000))) (= cat_115 cat_95))))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_112)) (=> (fp.leq cat_112 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000))) (= cat_116 cat_104))))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_112)) (=> (not (fp.leq cat_112 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)))) (and (= cat_105 cat_112) (spoon_1 cat_112)))))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_112)) (=> (not (fp.leq cat_112 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)))) (= cat_117 cat_95))))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_112)) (=> (not (fp.leq cat_112 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)))) (= cat_118 cat_105))))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_112)) (=> (not (fp.leq cat_112 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)))) (= cat_116 cat_118))))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_112)) (= cat_114 cat_116)))
(assert (= cat_119 cat_97))
(assert (= cat_120 (fp.div RNE (fp.sub RNE (fp #b0 #b10000110 #b01101000000000000000000) cat_114) (fp #b0 #b10000000 #b00000000000000000000000))))
(assert (and (= cat_106 (fp.add RNE cat_110 cat_120)) (spoon_1 (fp.add RNE cat_110 cat_120))))
(assert (= cat_121 cat_120))
(assert (= cat_122 cat_106))
(assert (not (fp.lt (fp #b0 #b10000111 #b01101000000000000000000) cat_122)))
(assert (not (spoon_48 cat_122)))
(check-sat)
(exit)
