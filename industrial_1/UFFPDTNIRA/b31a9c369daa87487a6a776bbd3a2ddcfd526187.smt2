...
(assert (forall ((kitten_47 potato_15) (kitten_48 potato_15)) (! (spoon_57 (spoon_66 kitten_47 kitten_48) true false true) :pattern ((spoon_66 kitten_47 kitten_48)))))
...
(define-fun spoon_76 ((kitten_49 Float32)) Bool (and (spoon_1 kitten_49) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_49) (fp.leq kitten_49 (fp #b0 #b10001000 #b01101000000000000000000)))))
...
(define-fun spoon_82 ((kitten_50 potato_22)) potato_21 (get_potato_22_a kitten_50))
(define-fun spoon_83 ((kitten_51 Float32) (kitten_52 Bool) (kitten_53 Bool) (kitten_54 Bool)) Bool (=> (or (= kitten_52 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001000 #b01101000000000000000000))) (spoon_76 kitten_51)))
(declare-sort potato_23 0)
(define-fun spoon_84 ((kitten_55 Float32)) Bool (and (spoon_1 kitten_55) (and (fp.leq (fp.neg (fp #b0 #b10000111 #b01101000000000000000000)) kitten_55) (fp.leq kitten_55 (fp #b0 #b10000111 #b01101000000000000000000)))))
...
(define-fun spoon_90 ((kitten_56 potato_24)) potato_23 (get_potato_24_a kitten_56))
(define-fun spoon_91 ((kitten_57 Float32) (kitten_58 Bool) (kitten_59 Bool) (kitten_60 Bool)) Bool (=> (or (= kitten_58 true) (fp.leq (fp.neg (fp #b0 #b10000111 #b01101000000000000000000)) (fp #b0 #b10000111 #b01101000000000000000000))) (spoon_84 kitten_57)))
(declare-const cat_92 Int)
(declare-const cat_93 Int)
(declare-const cat_94 Int)
(declare-const cat_95 Int)
(define-fun spoon_96 ((kitten_61 Float32) (kitten_62 Bool) (kitten_63 Bool) (kitten_64 Bool)) Bool (=> (or (= kitten_62 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_25 kitten_61)))
...
(assert (= cat_111 cat_101))
(assert (= cat_112 cat_103))
(assert (and (= cat_104 (spoon_66 cat_70 cat_72)) (spoon_50 cat_104)))
(assert (= cat_113 cat_102))
(assert (= cat_114 cat_104))
(assert (= cat_115 cat_100))
(assert (= cat_116 (fp.sub RNE cat_114 cat_112)))
(assert (=> (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_116) (and (= cat_105 (fp.sub RNE cat_116 (fp #b0 #b10000111 #b01101000000000000000000))) (spoon_1 (fp.sub RNE cat_116 (fp #b0 #b10000111 #b01101000000000000000000))))))
(assert (=> (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_116) (= cat_117 cat_97)))
(assert (=> (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_116) (= cat_118 cat_105)))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_116)) (=> (fp.leq cat_116 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000))) (and (= cat_106 (fp.add RNE cat_116 (fp #b0 #b10000111 #b01101000000000000000000))) (spoon_1 (fp.add RNE cat_116 (fp #b0 #b10000111 #b01101000000000000000000)))))))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_116)) (=> (fp.leq cat_116 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000))) (= cat_119 cat_97))))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_116)) (=> (fp.leq cat_116 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000))) (= cat_120 cat_106))))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_116)) (=> (not (fp.leq cat_116 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)))) (and (= cat_107 cat_116) (spoon_1 cat_116)))))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_116)) (=> (not (fp.leq cat_116 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)))) (= cat_121 cat_97))))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_116)) (=> (not (fp.leq cat_116 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)))) (= cat_122 cat_107))))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_116)) (=> (not (fp.leq cat_116 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)))) (= cat_120 cat_122))))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_116)) (= cat_118 cat_120)))
(assert (= cat_123 cat_99))
(assert (= cat_124 (fp.div RNE (fp.sub RNE (fp #b0 #b10000110 #b01101000000000000000000) cat_118) (fp #b0 #b10000000 #b00000000000000000000000))))
(assert (and (= cat_108 (fp.add RNE cat_114 cat_124)) (spoon_1 (fp.add RNE cat_114 cat_124))))
(assert (= cat_125 cat_124))
(assert (= cat_126 cat_108))
(assert (not (fp.lt (fp #b0 #b10000111 #b01101000000000000000000) cat_126)))
(assert (not (spoon_50 cat_126)))
(check-sat)
(exit)
