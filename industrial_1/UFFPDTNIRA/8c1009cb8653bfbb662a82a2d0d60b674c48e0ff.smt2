...
(declare-const cat_174 potato_22)
...
(assert (= (spoon_63 cat_154) (fp.neg (fp.mul RNE (fp #b0 #b01111111 #b00000000000000000000000) (spoon_63 (get_potato_21_b cat_175))))))
...
(assert (and (= cat_169 (spoon_83 (mk_potato_23 cat_175) (mk_potato_23 cat_175))) (and (spoon_85 cat_169) (= cat_169 (fp.add RNE (fp.mul RNE (spoon_63 (get_potato_21_a cat_175)) (spoon_63 (get_potato_21_a cat_175))) (fp.mul RNE (spoon_63 (get_potato_21_b cat_175)) (spoon_63 (get_potato_21_b cat_175))))))))
(assert (= cat_182 (mk_potato_10 cat_143)))
(assert (= cat_183 cat_169))
(assert (and (= cat_170 (spoon_83 (mk_potato_23 cat_179) (mk_potato_23 cat_177))) (and (spoon_85 cat_170) (= cat_170 (fp.add RNE (fp.mul RNE (spoon_63 (get_potato_21_a cat_179)) (spoon_63 (get_potato_21_a cat_177))) (fp.mul RNE (spoon_63 (get_potato_21_b cat_179)) (spoon_63 (get_potato_21_b cat_177))))))))
(assert (and (= cat_171 (spoon_83 (mk_potato_23 cat_181) (mk_potato_23 cat_177))) (and (spoon_85 cat_171) (= cat_171 (fp.add RNE (fp.mul RNE (spoon_63 (get_potato_21_a cat_181)) (spoon_63 (get_potato_21_a cat_177))) (fp.mul RNE (spoon_63 (get_potato_21_b cat_181)) (spoon_63 (get_potato_21_b cat_177))))))))
(assert (= cat_172 (fp.sub RNE cat_171 cat_170)))
(assert (= cat_184 (mk_potato_10 cat_145)))
(assert (= cat_185 cat_172))
(assert (and (= cat_173 (fp.sqrt RNE cat_183)) (spoon_1 (fp.sqrt RNE cat_183))))
(assert (= cat_186 (mk_potato_10 cat_146)))
(assert (= cat_187 cat_173))
(assert (not (fp.leq (fp.mul RNE (fp #b0 #b10110110 #b00000000000000000000000) cat_187) (fp.abs cat_185))))
