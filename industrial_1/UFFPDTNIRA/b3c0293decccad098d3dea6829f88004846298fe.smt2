...
(declare-const cat_276 potato_7)
(declare-const cat_277 Bool)
(declare-const cat_278 potato_19)
(declare-const cat_279 potato_18)
...
(declare-const cat_286 potato_11)
(declare-const cat_287 Float64)
(declare-const cat_288 potato_11)
(declare-const cat_289 Float64)
(declare-const cat_290 potato_11)
(declare-const cat_291 Float64)
(declare-const cat_292 potato_11)
(declare-const cat_293 Float64)
(declare-const cat_294 potato_11)
(declare-const cat_295 Float64)
(declare-const cat_296 potato_11)
(declare-const cat_297 Float64)
(declare-const cat_298 potato_11)
(declare-const cat_299 Float64)
(declare-const cat_300 potato_11)
(declare-const cat_301 Float64)
(declare-const cat_302 potato_11)
(declare-const cat_303 Float64)
(declare-const cat_304 potato_11)
(declare-const cat_305 Float64)
(declare-const cat_306 potato_11)
(declare-const cat_307 Float64)
(declare-const cat_308 potato_11)
(declare-const cat_309 Float64)
(declare-const cat_310 Bool)
...
(assert (= cat_276 (mk_potato_7 cat_207)))
(assert (= cat_277 (spoon_41 1)))
(assert (= cat_278 (mk_potato_19 (mk_potato_18 cat_205 cat_206))))
(assert (= cat_279 (get_potato_20_a cat_89)))
(assert (= cat_280 (mk_potato_11 cat_210)))
(assert (= cat_281 (fp.mul RNE cat_185 cat_185)))
(assert (and (= cat_228 ((_ to_fp 11 53) RNE (fp.mul RNE cat_181 cat_181))) (spoon_3 ((_ to_fp 11 53) RNE (fp.mul RNE cat_181 cat_181)))))
(assert (= cat_282 (mk_potato_11 cat_208)))
(assert (= cat_283 cat_228))
(assert (and (= cat_229 ((_ to_fp 11 53) RNE (fp.mul RNE cat_183 cat_183))) (spoon_3 ((_ to_fp 11 53) RNE (fp.mul RNE cat_183 cat_183)))))
(assert (= cat_284 (mk_potato_11 cat_209)))
(assert (= cat_285 cat_229))
(assert (= cat_286 (mk_potato_11 cat_211)))
(assert (= cat_287 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_185)))
(assert (and (= cat_230 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_281)) (spoon_3 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_281))))
(assert (= cat_288 (mk_potato_11 cat_212)))
(assert (= cat_289 cat_230))
...
(assert (= cat_290 (mk_potato_11 cat_213)))
(assert (= cat_291 cat_233))
...
(assert (= cat_292 (mk_potato_11 cat_214)))
(assert (= cat_293 cat_236))
(assert (and (= cat_241 (fp.mul RNE cat_287 ((_ to_fp 11 53) RNE cat_183))) (spoon_3 (fp.mul RNE cat_287 ((_ to_fp 11 53) RNE cat_183)))))
(assert (= cat_242 (fp.mul RNE cat_241 cat_293)))
(assert (and (= cat_243 cat_242) (spoon_3 cat_242)))
(assert (and (= cat_237 (fp.sub RNE cat_289 cat_283)) (spoon_3 (fp.sub RNE cat_289 cat_283))))
(assert (= cat_238 (fp.sub RNE cat_237 cat_285)))
(assert (and (= cat_239 cat_238) (spoon_3 cat_238)))
(assert (= cat_240 (fp.mul RNE cat_239 cat_291)))
...
(assert (= cat_294 (mk_potato_11 cat_217)))
(assert (= cat_295 cat_246))
(assert (and (= cat_247 (fp.add RNE cat_289 cat_283)) (spoon_3 (fp.add RNE cat_289 cat_283))))
(assert (= cat_248 (fp.add RNE cat_247 cat_285)))
(assert (and (= cat_249 cat_248) (spoon_3 cat_248)))
(assert (= cat_296 (mk_potato_11 cat_218)))
(assert (= cat_297 cat_249))
(assert (and (= cat_250 (fp.div RNE cat_295 cat_297)) (spoon_3 (fp.div RNE cat_295 cat_297))))
(assert (= cat_298 (mk_potato_11 cat_216)))
(assert (= cat_299 cat_250))
(assert (=> (fp.lt cat_299 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))) (= cat_300 (mk_potato_11 cat_215))))
(assert (=> (fp.lt cat_299 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))) (= cat_301 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))))
(assert (=> (not (fp.lt cat_299 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_299) (= cat_302 (mk_potato_11 cat_215)))))
(assert (=> (not (fp.lt cat_299 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_299) (= cat_303 (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))))
(assert (=> (not (fp.lt cat_299 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_299)) (and (= cat_251 cat_299) (spoon_3 cat_299)))))
(assert (=> (not (fp.lt cat_299 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_299)) (= cat_304 (mk_potato_11 cat_215)))))
(assert (=> (not (fp.lt cat_299 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_299)) (= cat_305 cat_251))))
(assert (=> (not (fp.lt cat_299 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_299)) (= cat_303 cat_305))))
(assert (=> (not (fp.lt cat_299 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (= cat_301 cat_303)))
(assert (and (= cat_252 (fp.mul RNE cat_287 ((_ to_fp 11 53) RNE cat_181))) (spoon_3 (fp.mul RNE cat_287 ((_ to_fp 11 53) RNE cat_181)))))
(assert (= cat_306 (mk_potato_11 cat_220)))
(assert (= cat_307 cat_252))
(assert (and (= cat_257 (fp.mul RNE cat_287 ((_ to_fp 11 53) RNE cat_183))) (spoon_3 (fp.mul RNE cat_287 ((_ to_fp 11 53) RNE cat_183)))))
(assert (= cat_258 (fp.mul RNE cat_257 cat_291)))
(assert (and (= cat_259 cat_258) (spoon_3 cat_258)))
(assert (and (= cat_253 (fp.sub RNE cat_289 cat_283)) (spoon_3 (fp.sub RNE cat_289 cat_283))))
(assert (= cat_254 (fp.sub RNE cat_253 cat_285)))
(assert (and (= cat_255 cat_254) (spoon_3 cat_254)))
(assert (= cat_256 (fp.mul RNE cat_255 cat_293)))
(assert (and (= cat_260 cat_256) (spoon_3 cat_256)))
(assert (= cat_261 (fp.sub RNE cat_260 cat_259)))
(assert (and (= cat_262 cat_261) (spoon_3 cat_261)))
(assert (= cat_308 (mk_potato_11 cat_221)))
(assert (= cat_309 cat_262))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_309) (and (= cat_268 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_309)) (spoon_3 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_309)))))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_309) (= cat_269 (ite (fp.leq cat_307 cat_268) true false))))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_309) (and (= cat_267 (fp.mul RNE (fp.neg (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000)) cat_309)) (spoon_3 (fp.mul RNE (fp.neg (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000)) cat_309)))))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_309) (= cat_270 (ite (fp.leq cat_267 cat_307) true false))))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_309) (= cat_311 (ite (= cat_270 true) cat_269 false))))
(assert (=> (not (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_309)) (= cat_311 false)))
(assert (not (= cat_311 true)))
(assert (fp.lt cat_309 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)))
(assert (and (= cat_264 (fp.mul RNE (fp.neg (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000)) cat_309)) (spoon_3 (fp.mul RNE (fp.neg (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000)) cat_309))))
(assert (= cat_265 (ite (fp.leq cat_307 cat_264) true false)))
(assert (not (spoon_3 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_309))))
(check-sat)
(exit)
