...
(declare-const cat_271 potato_7)
(declare-const cat_272 Bool)
(declare-const cat_273 potato_19)
(declare-const cat_274 potato_18)
...
(declare-const cat_303 potato_11)
(declare-const cat_304 Float64)
(declare-const cat_305 Bool)
(define-fun spoon_306 () potato_11 (mk_potato_11 cat_215))
...
(assert (= cat_269 cat_219))
(assert (= cat_270 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_63 cat_270))
...
(assert (= cat_271 (mk_potato_7 cat_207)))
(assert (= cat_272 (spoon_41 1)))
(assert (= cat_273 (mk_potato_19 (mk_potato_18 cat_205 cat_206))))
(assert (= cat_274 (get_potato_20_a cat_89)))
(assert (= cat_275 (mk_potato_11 cat_210)))
(assert (= cat_276 (fp.mul RNE cat_185 cat_185)))
(assert (and (= cat_228 ((_ to_fp 11 53) RNE (fp.mul RNE cat_181 cat_181))) (spoon_3 ((_ to_fp 11 53) RNE (fp.mul RNE cat_181 cat_181)))))
(assert (= cat_277 (mk_potato_11 cat_208)))
(assert (= cat_278 cat_228))
(assert (and (= cat_229 ((_ to_fp 11 53) RNE (fp.mul RNE cat_183 cat_183))) (spoon_3 ((_ to_fp 11 53) RNE (fp.mul RNE cat_183 cat_183)))))
(assert (= cat_279 (mk_potato_11 cat_209)))
(assert (= cat_280 cat_229))
(assert (= cat_281 (mk_potato_11 cat_211)))
(assert (= cat_282 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_185)))
(assert (and (= cat_230 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_276)) (spoon_3 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_276))))
(assert (= cat_283 (mk_potato_11 cat_212)))
(assert (= cat_284 cat_230))
...
(assert (= cat_288 cat_236))
(assert (and (= cat_241 (fp.mul RNE cat_282 ((_ to_fp 11 53) RNE cat_183))) (spoon_3 (fp.mul RNE cat_282 ((_ to_fp 11 53) RNE cat_183)))))
(assert (= cat_242 (fp.mul RNE cat_241 cat_288)))
(assert (and (= cat_243 cat_242) (spoon_3 cat_242)))
(assert (and (= cat_237 (fp.sub RNE cat_284 cat_278)) (spoon_3 (fp.sub RNE cat_284 cat_278))))
(assert (= cat_238 (fp.sub RNE cat_237 cat_280)))
(assert (and (= cat_239 cat_238) (spoon_3 cat_238)))
(assert (= cat_240 (fp.mul RNE cat_239 cat_286)))
...
(assert (= cat_289 (mk_potato_11 cat_217)))
(assert (= cat_290 cat_246))
(assert (and (= cat_247 (fp.add RNE cat_284 cat_278)) (spoon_3 (fp.add RNE cat_284 cat_278))))
(assert (= cat_248 (fp.add RNE cat_247 cat_280)))
(assert (and (= cat_249 cat_248) (spoon_3 cat_248)))
(assert (= cat_291 (mk_potato_11 cat_218)))
(assert (= cat_292 cat_249))
(assert (and (= cat_250 (fp.div RNE cat_290 cat_292)) (spoon_3 (fp.div RNE cat_290 cat_292))))
(assert (= cat_293 (mk_potato_11 cat_216)))
(assert (= cat_294 cat_250))
(assert (=> (fp.lt cat_294 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))) (= cat_295 spoon_306)))
(assert (=> (fp.lt cat_294 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))) (= cat_296 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))))
(assert (=> (not (fp.lt cat_294 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_294) (= cat_297 spoon_306))))
(assert (=> (not (fp.lt cat_294 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_294) (= cat_298 (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))))
(assert (=> (not (fp.lt cat_294 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_294)) (and (= cat_251 cat_294) (spoon_3 cat_294)))))
(assert (=> (not (fp.lt cat_294 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_294)) (= cat_299 spoon_306))))
(assert (=> (not (fp.lt cat_294 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_294)) (= cat_300 cat_251))))
(assert (=> (not (fp.lt cat_294 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_294)) (= cat_298 cat_300))))
(assert (=> (not (fp.lt cat_294 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (= cat_296 cat_298)))
(assert (and (= cat_252 (fp.mul RNE cat_282 ((_ to_fp 11 53) RNE cat_181))) (spoon_3 (fp.mul RNE cat_282 ((_ to_fp 11 53) RNE cat_181)))))
(assert (= cat_301 (mk_potato_11 cat_220)))
(assert (= cat_302 cat_252))
(assert (and (= cat_257 (fp.mul RNE cat_282 ((_ to_fp 11 53) RNE cat_183))) (spoon_3 (fp.mul RNE cat_282 ((_ to_fp 11 53) RNE cat_183)))))
(assert (= cat_258 (fp.mul RNE cat_257 cat_286)))
(assert (and (= cat_259 cat_258) (spoon_3 cat_258)))
(assert (and (= cat_253 (fp.sub RNE cat_284 cat_278)) (spoon_3 (fp.sub RNE cat_284 cat_278))))
(assert (= cat_254 (fp.sub RNE cat_253 cat_280)))
(assert (and (= cat_255 cat_254) (spoon_3 cat_254)))
(assert (= cat_256 (fp.mul RNE cat_255 cat_288)))
...
(assert (= cat_303 (mk_potato_11 cat_221)))
(assert (= cat_304 cat_262))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_304) (and (= cat_266 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_304)) (spoon_3 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_304)))))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_304) (= cat_267 (ite (fp.leq cat_302 cat_266) true false))))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_304) (and (= cat_265 (fp.mul RNE (fp.neg (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000)) cat_304)) (spoon_3 (fp.mul RNE (fp.neg (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000)) cat_304)))))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_304) (= cat_268 (ite (fp.leq cat_265 cat_302) true false))))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_304) (= cat_305 (ite (= cat_268 true) cat_267 false))))
(assert (=> (not (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_304)) (= cat_305 false)))
(assert (not (= cat_305 true)))
(assert (fp.lt cat_304 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)))
(assert (and (= cat_263 (fp.mul RNE (fp.neg (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000)) cat_304)) (spoon_3 (fp.mul RNE (fp.neg (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000)) cat_304))))
(assert (= cat_264 (ite (fp.leq cat_302 cat_263) true false)))
(assert (not (spoon_3 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_304))))
(check-sat)
(exit)
