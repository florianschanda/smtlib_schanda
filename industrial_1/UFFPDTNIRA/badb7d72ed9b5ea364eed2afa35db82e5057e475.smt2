...
(define-fun spoon_50 ((kitten_37 (_ FloatingPoint 8 24))) Bool (and (spoon_1 kitten_37) (and (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) kitten_37) (fp.leq kitten_37 (fp (_ bv0 1) (_ bv127 8) (_ bv0 23))))))
...
(define-fun spoon_57 ((kitten_39 (_ FloatingPoint 8 24)) (kitten_40 Bool) (kitten_41 Bool) (kitten_42 Bool) (kitten_43 Bool)) Bool (=> (or (= kitten_40 true) (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) (fp (_ bv0 1) (_ bv127 8) (_ bv0 23)))) (spoon_50 kitten_39)))
(declare-fun cat_58 () potato_15)
(declare-fun cat_59 () Int)
(declare-fun cat_60 () potato_15)
(declare-fun cat_61 () Int)
(declare-fun cat_62 () (_ FloatingPoint 8 24))
(declare-fun cat_63 () Int)
(define-fun spoon_64 ((kitten_44 (_ FloatingPoint 8 24)) (kitten_45 Bool) (kitten_46 Bool) (kitten_47 Bool) (kitten_48 Bool)) Bool (let ((_let_0 (fp (_ bv0 1) (_ bv139 8) (_ bv0 23)))) (=> (or (= kitten_45 true) (fp.leq (fp.neg _let_0) _let_0)) (spoon_23 kitten_44))))
(assert (spoon_50 cat_62))
(assert (not (spoon_23 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (spoon_30 (get_potato_13_b (get_potato_15_a cat_58))) (fp.sub roundNearestTiesToEven (fp (_ bv0 1) (_ bv127 8) (_ bv0 23)) cat_62)) (fp.mul roundNearestTiesToEven (spoon_30 (get_potato_13_b (get_potato_15_a cat_60))) cat_62)))))
(check-sat)
(exit)
