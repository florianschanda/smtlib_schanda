...
(assert (not (spoon_23 (fp.add RNE (fp.mul RNE (spoon_30 (get_potato_13_b (get_potato_15_a cat_58))) (fp.sub RNE (fp #b0 #b01111111 #b00000000000000000000000) cat_62)) (fp.mul RNE (spoon_30 (get_potato_13_b (get_potato_15_a cat_60))) cat_62)))))
(check-sat)
(exit)
