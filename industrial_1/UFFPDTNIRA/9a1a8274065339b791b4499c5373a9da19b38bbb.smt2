...
(declare-fun cat_220 () Bool)
(declare-fun cat_221 () Bool)
(declare-fun cat_222 () (_ FloatingPoint 11 53))
...
(declare-fun cat_248 () Bool)
(declare-fun cat_249 () Bool)
...
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_235 cat_239))) (and (= cat_209 _let_0) (spoon_3 _let_0))))
(assert (= cat_210 (fp.mul roundNearestTiesToEven cat_209 cat_243)))
(assert (and (= cat_211 cat_210) (spoon_3 cat_210)))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_233 cat_237))) (and (= cat_207 _let_0) (spoon_3 _let_0))))
...
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1024 11) (_ bv0 52)) cat_156) cat_241))) (and (= cat_215 _let_0) (spoon_3 _let_0))))
(assert (= cat_216 (fp.mul roundNearestTiesToEven cat_215 cat_235)))
(assert (and (= cat_217 cat_216) (spoon_3 cat_216)))
(assert (= cat_246 (mk_potato_11 cat_189)))
(assert (= cat_247 cat_217))
(assert (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_245)))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv2046 11) (_ bv4503599627370495 52)) cat_245))) (=> (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_245) (and (= cat_223 _let_0) (spoon_3 _let_0)))))
(assert (=> (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_245) (= cat_224 (ite (fp.leq cat_247 cat_223) true false))))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp.neg (fp (_ bv0 1) (_ bv2046 11) (_ bv4503599627370495 52))) cat_245))) (=> (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_245) (and (= cat_222 _let_0) (spoon_3 _let_0)))))
(assert (=> (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_245) (= cat_225 (ite (fp.leq cat_222 cat_247) true false))))
(assert (=> (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_245) (= cat_249 (ite (= cat_225 true) cat_224 false))))
(assert (=> (not (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_245)) (= cat_249 false)))
(assert (=> (= cat_249 true) (= cat_248 true)))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp.neg (fp (_ bv0 1) (_ bv2046 11) (_ bv4503599627370495 52))) cat_245))) (=> (not (= cat_249 true)) (=> (fp.lt cat_245 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52))) (and (= cat_219 _let_0) (spoon_3 _let_0))))))
(assert (=> (not (= cat_249 true)) (=> (fp.lt cat_245 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52))) (= cat_220 (ite (fp.leq cat_247 cat_219) true false)))))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv2046 11) (_ bv4503599627370495 52)) cat_245))) (=> (not (= cat_249 true)) (=> (fp.lt cat_245 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52))) (and (= cat_218 _let_0) (spoon_3 _let_0))))))
(assert (=> (not (= cat_249 true)) (=> (fp.lt cat_245 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52))) (= cat_221 (ite (fp.leq cat_218 cat_247) true false)))))
(assert (=> (not (= cat_249 true)) (=> (fp.lt cat_245 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52))) (= cat_248 (ite (= cat_221 true) cat_220 false)))))
(assert (=> (not (= cat_249 true)) (=> (not (fp.lt cat_245 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)))) (= cat_248 false))))
(assert (= cat_248 true))
(assert (not (spoon_3 (fp.div roundNearestTiesToEven cat_247 cat_245))))
(check-sat)
(exit)
