...
(assert (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_257))
(assert (not (spoon_3 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_257))))
(check-sat)
(exit)
