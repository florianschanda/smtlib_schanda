...
(assert (= cat_148 cat_135))
(assert (= cat_149 (fp.sub RNE (spoon_32 (get_potato_13_a (get_potato_15_a cat_90))) (spoon_32 (get_potato_13_a (get_potato_15_a cat_88))))))
(assert (= cat_150 cat_136))
(assert (= cat_151 (fp.sub RNE (spoon_32 (get_potato_13_b (get_potato_15_a cat_90))) (spoon_32 (get_potato_13_b (get_potato_15_a cat_88))))))
(assert (= cat_152 cat_137))
(assert (= cat_153 (fp.add RNE (fp.mul RNE cat_149 cat_149) (fp.mul RNE cat_151 cat_151))))
(assert (not (fp.lt cat_153 (fp #b0 #b01110001 #b10100011011011100010111))))
(assert (= cat_154 cat_139))
(assert (= cat_155 (fp.add RNE (fp.mul RNE (fp.sub RNE (spoon_32 (get_potato_13_a (get_potato_15_a cat_86))) (spoon_32 (get_potato_13_a (get_potato_15_a cat_88)))) cat_149) (fp.mul RNE (fp.sub RNE (spoon_32 (get_potato_13_b (get_potato_15_a cat_86))) (spoon_32 (get_potato_13_b (get_potato_15_a cat_88)))) cat_151))))
(assert (and (= cat_143 (fp.div RNE cat_155 cat_153)) (spoon_1 (fp.div RNE cat_155 cat_153))))
(assert (and (= cat_144 cat_143) (spoon_1 cat_143)))
(assert (= cat_156 cat_141))
(assert (= cat_157 cat_144))
(assert (not (fp.leq cat_157 (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (not (fp.leq (fp #b0 #b01111111 #b00000000000000000000000) cat_157)))
(assert (= cat_158 cat_140))
(assert (= cat_159 (fp.add RNE (fp.mul RNE (fp.sub RNE (spoon_32 (get_potato_13_a (get_potato_15_a cat_86))) (spoon_32 (get_potato_13_a (get_potato_15_a cat_88)))) (fp.neg cat_151)) (fp.mul RNE (fp.sub RNE (spoon_32 (get_potato_13_b (get_potato_15_a cat_86))) (spoon_32 (get_potato_13_b (get_potato_15_a cat_88)))) cat_149))))
(assert (and (= cat_145 cat_153) (spoon_1 cat_153)))
(assert (and (= cat_146 (spoon_74 cat_145)) (spoon_66 cat_146)))
(assert (and (= cat_147 cat_146) (spoon_1 cat_146)))
(assert (= cat_160 cat_138))
(assert (= cat_161 cat_147))
(assert (not (not (fp.isZero cat_161))))
(check-sat)
(exit)
