...
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_112) (fp.leq cat_112 (fp #b0 #b10000101 #b01100111111101011100001))) (= (mk_potato_11 cat_153) (mk_potato_11 cat_128))))
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_112) (fp.leq cat_112 (fp #b0 #b10000101 #b01100111111101011100001))) (= cat_154 cat_141)))
...
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_112) (fp.leq cat_112 (fp #b0 #b10000101 #b01100111111101011100001))) (= (mk_potato_11 cat_155) (mk_potato_11 cat_129))))
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_112) (fp.leq cat_112 (fp #b0 #b10000101 #b01100111111101011100001))) (= cat_156 cat_145)))
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_112) (fp.leq cat_112 (fp #b0 #b10000101 #b01100111111101011100001))) (and (= cat_146 (fp.mul RNE cat_154 (fp #b0 #b10000000100 #b1100101001011101110000001101000000111100111100100110))) (spoon_3 (fp.mul RNE cat_154 (fp #b0 #b10000000100 #b1100101001011101110000001101000000111100111100100110))))))
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_112) (fp.leq cat_112 (fp #b0 #b10000101 #b01100111111101011100001))) (= cat_154 cat_157)))
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_112) (fp.leq cat_112 (fp #b0 #b10000101 #b01100111111101011100001))) (= cat_158 cat_146)))
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_112) (fp.leq cat_112 (fp #b0 #b10000101 #b01100111111101011100001))) (and (= cat_147 (fp.div RNE cat_158 cat_156)) (spoon_3 (fp.div RNE cat_158 cat_156)))))
...
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_112) (fp.leq cat_112 (fp #b0 #b10000101 #b01100111111101011100001))) (= cat_159 cat_126)))
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_112) (fp.leq cat_112 (fp #b0 #b10000101 #b01100111111101011100001))) (= cat_160 cat_149)))
(assert (=> (not (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_112) (fp.leq cat_112 (fp #b0 #b10000101 #b01100111111101011100001)))) (= cat_161 cat_126)))
(assert (=> (not (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_112) (fp.leq cat_112 (fp #b0 #b10000101 #b01100111111101011100001)))) (= cat_162 (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (=> (not (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_112) (fp.leq cat_112 (fp #b0 #b10000101 #b01100111111101011100001)))) (= cat_156 cat_129)))
(assert (=> (not (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_112) (fp.leq cat_112 (fp #b0 #b10000101 #b01100111111101011100001)))) (= cat_158 cat_128)))
(assert (=> (not (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_112) (fp.leq cat_112 (fp #b0 #b10000101 #b01100111111101011100001)))) (= cat_160 cat_162)))
(assert (=> (not (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_112) (fp.leq cat_112 (fp #b0 #b10000101 #b01100111111101011100001)))) (= cat_156 cat_152)))
(assert (=> (not (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_112) (fp.leq cat_112 (fp #b0 #b10000101 #b01100111111101011100001)))) (= cat_158 cat_151)))
(assert (=> (not (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_112) (fp.leq cat_112 (fp #b0 #b10000101 #b01100111111101011100001)))) (= cat_160 cat_162)))
(assert (not (spoon_53 (fp.min (fp.max (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) (fp.sub RNE cat_112 cat_160)) (fp #b0 #b10000101 #b01101000000000000000000)))))
(check-sat)
(exit)
