...
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_112) (fp.leq cat_112 (fp #b0 #b10000101 #b01100111111101011100001))) (and (= cat_146 (fp.mul RNE cat_153 (fp #b0 #b10000000100 #b1100101001011101110000001101000000111100111100100110))) (spoon_3 (fp.mul RNE cat_153 (fp #b0 #b10000000100 #b1100101001011101110000001101000000111100111100100110))))))
...
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_112) (fp.leq cat_112 (fp #b0 #b10000101 #b01100111111101011100001))) (and (= cat_147 (fp.div RNE cat_157 cat_155)) (spoon_3 (fp.div RNE cat_157 cat_155)))))
