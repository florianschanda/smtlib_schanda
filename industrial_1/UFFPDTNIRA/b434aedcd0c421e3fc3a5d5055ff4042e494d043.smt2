...
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_108) (fp.leq cat_108 (fp #b0 #b10000101 #b01100111111101011100001))) (and (= cat_126 cat_108) (spoon_1 cat_108))))
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_108) (fp.leq cat_108 (fp #b0 #b10000101 #b01100111111101011100001))) (and (= cat_127 (spoon_81 cat_126)) (spoon_72 cat_127))))
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_108) (fp.leq cat_108 (fp #b0 #b10000101 #b01100111111101011100001))) (= cat_127 cat_112)))
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_108) (fp.leq cat_108 (fp #b0 #b10000101 #b01100111111101011100001))) (spoon_72 cat_112)))
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_108) (fp.leq cat_108 (fp #b0 #b10000101 #b01100111111101011100001))) (= ((_ to_fp 8 24) RNE (fp.mul RNE cat_104 cat_104)) cat_114)))
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_108) (fp.leq cat_108 (fp #b0 #b10000101 #b01100111111101011100001))) (spoon_57 cat_114)))
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_108) (fp.leq cat_108 (fp #b0 #b10000101 #b01100111111101011100001))) (and (= cat_128 (fp.sub RNE (fp #b0 #b01111111 #b00000000000000000000000) cat_114)) (spoon_1 (fp.sub RNE (fp #b0 #b01111111 #b00000000000000000000000) cat_114)))))
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_108) (fp.leq cat_108 (fp #b0 #b10000101 #b01100111111101011100001))) (= cat_129 (fp.mul RNE cat_128 (fp.mul RNE cat_112 cat_112)))))
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_108) (fp.leq cat_108 (fp #b0 #b10000101 #b01100111111101011100001))) (and (= cat_130 cat_129) (spoon_1 cat_129))))
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_108) (fp.leq cat_108 (fp #b0 #b10000101 #b01100111111101011100001))) (= cat_131 (fp.add RNE (fp #b0 #b01111111 #b00000000000000000000000) cat_130))))
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_108) (fp.leq cat_108 (fp #b0 #b10000101 #b01100111111101011100001))) (and (= cat_132 cat_131) (spoon_1 cat_131))))
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_108) (fp.leq cat_108 (fp #b0 #b10000101 #b01100111111101011100001))) (and (= cat_133 cat_132) (spoon_1 cat_132))))
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_108) (fp.leq cat_108 (fp #b0 #b10000101 #b01100111111101011100001))) (= cat_133 cat_116)))
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_108) (fp.leq cat_108 (fp #b0 #b10000101 #b01100111111101011100001))) (spoon_57 cat_116)))
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_108) (fp.leq cat_108 (fp #b0 #b10000101 #b01100111111101011100001))) (and (= cat_134 (fp.sqrt RNE cat_116)) (spoon_1 (fp.sqrt RNE cat_116)))))
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_108) (fp.leq cat_108 (fp #b0 #b10000101 #b01100111111101011100001))) (= cat_134 cat_118)))
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_108) (fp.leq cat_108 (fp #b0 #b10000101 #b01100111111101011100001))) (spoon_57 cat_118)))
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_108) (fp.leq cat_108 (fp #b0 #b10000101 #b01100111111101011100001))) (=> (fp.leq (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) (spoon_2 cat_124))))
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_108) (fp.leq cat_108 (fp #b0 #b10000101 #b01100111111101011100001))) (=> (fp.leq (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) (spoon_2 cat_125))))
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_108) (fp.leq cat_108 (fp #b0 #b10000101 #b01100111111101011100001))) (and (= cat_135 (fp.mul RNE cat_114 cat_112)) (spoon_1 (fp.mul RNE cat_114 cat_112)))))
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_108) (fp.leq cat_108 (fp #b0 #b10000101 #b01100111111101011100001))) (= cat_136 ((_ to_fp 11 53) RNE cat_135))))
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_108) (fp.leq cat_108 (fp #b0 #b10000101 #b01100111111101011100001))) (= cat_137 (fp.sub RNE cat_136 (fp.mul RNE ((_ to_fp 11 53) RNE cat_106) ((_ to_fp 11 53) RNE cat_118))))))
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_108) (fp.leq cat_108 (fp #b0 #b10000101 #b01100111111101011100001))) (= (mk_potato_11 cat_148) (mk_potato_11 cat_124))))
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_108) (fp.leq cat_108 (fp #b0 #b10000101 #b01100111111101011100001))) (= cat_149 cat_137)))
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_108) (fp.leq cat_108 (fp #b0 #b10000101 #b01100111111101011100001))) (and (= cat_138 (fp.mul RNE cat_118 cat_112)) (spoon_1 (fp.mul RNE cat_118 cat_112)))))
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_108) (fp.leq cat_108 (fp #b0 #b10000101 #b01100111111101011100001))) (= cat_139 ((_ to_fp 11 53) RNE cat_138))))
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_108) (fp.leq cat_108 (fp #b0 #b10000101 #b01100111111101011100001))) (= cat_140 (fp.mul RNE ((_ to_fp 11 53) RNE cat_106) cat_139))))
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_108) (fp.leq cat_108 (fp #b0 #b10000101 #b01100111111101011100001))) (= cat_141 (fp.add RNE ((_ to_fp 11 53) RNE cat_116) cat_140))))
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_108) (fp.leq cat_108 (fp #b0 #b10000101 #b01100111111101011100001))) (= (mk_potato_11 cat_150) (mk_potato_11 cat_125))))
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_108) (fp.leq cat_108 (fp #b0 #b10000101 #b01100111111101011100001))) (= cat_151 cat_141)))
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_108) (fp.leq cat_108 (fp #b0 #b10000101 #b01100111111101011100001))) (and (= cat_142 (fp.mul RNE cat_149 (fp #b0 #b10000000100 #b1100101001011101110000001101000000111100111100100110))) (spoon_2 (fp.mul RNE cat_149 (fp #b0 #b10000000100 #b1100101001011101110000001101000000111100111100100110))))))
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_108) (fp.leq cat_108 (fp #b0 #b10000101 #b01100111111101011100001))) (= cat_149 cat_152)))
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_108) (fp.leq cat_108 (fp #b0 #b10000101 #b01100111111101011100001))) (= cat_153 cat_142)))
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_108) (fp.leq cat_108 (fp #b0 #b10000101 #b01100111111101011100001))) (and (= cat_143 (fp.div RNE cat_153 cat_151)) (spoon_2 (fp.div RNE cat_153 cat_151)))))
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_108) (fp.leq cat_108 (fp #b0 #b10000101 #b01100111111101011100001))) (= cat_144 ((_ to_fp 8 24) RNE cat_143))))
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_108) (fp.leq cat_108 (fp #b0 #b10000101 #b01100111111101011100001))) (and (= cat_145 cat_144) (spoon_1 cat_144))))
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_108) (fp.leq cat_108 (fp #b0 #b10000101 #b01100111111101011100001))) (= cat_154 cat_122)))
(assert (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_108) (fp.leq cat_108 (fp #b0 #b10000101 #b01100111111101011100001))) (= cat_155 cat_145)))
(assert (=> (not (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_108) (fp.leq cat_108 (fp #b0 #b10000101 #b01100111111101011100001)))) (= cat_156 cat_122)))
(assert (=> (not (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_108) (fp.leq cat_108 (fp #b0 #b10000101 #b01100111111101011100001)))) (= cat_157 (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (=> (not (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_108) (fp.leq cat_108 (fp #b0 #b10000101 #b01100111111101011100001)))) (= cat_151 cat_125)))
(assert (=> (not (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_108) (fp.leq cat_108 (fp #b0 #b10000101 #b01100111111101011100001)))) (= cat_153 cat_124)))
(assert (=> (not (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_108) (fp.leq cat_108 (fp #b0 #b10000101 #b01100111111101011100001)))) (= cat_155 cat_157)))
(assert (=> (not (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_108) (fp.leq cat_108 (fp #b0 #b10000101 #b01100111111101011100001)))) (= cat_151 cat_147)))
(assert (=> (not (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_108) (fp.leq cat_108 (fp #b0 #b10000101 #b01100111111101011100001)))) (= cat_153 cat_146)))
(assert (=> (not (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_108) (fp.leq cat_108 (fp #b0 #b10000101 #b01100111111101011100001)))) (= cat_155 cat_157)))
(assert (not (spoon_49 (fp.min (fp.max (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) (fp.sub RNE cat_108 cat_155)) (fp #b0 #b10000101 #b01101000000000000000000)))))
(check-sat)
(exit)
