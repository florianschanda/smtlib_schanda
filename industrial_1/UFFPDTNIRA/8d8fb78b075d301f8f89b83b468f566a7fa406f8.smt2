...
(assert (= cat_153 ((_ to_fp 8 24) roundNearestTiesToEven (fp.mul roundNearestTiesToEven cat_129 cat_129))))
(assert (= cat_146 (fp.mul roundNearestTiesToEven cat_153 cat_152)))
(assert (spoon_1 (fp.mul roundNearestTiesToEven cat_153 cat_152)))
(assert (spoon_1 cat_146))
(assert (= cat_147 (fp.mul roundNearestTiesToEven cat_153 (fp.mul roundNearestTiesToEven cat_152 cat_152))))
(assert (spoon_1 (fp.mul roundNearestTiesToEven cat_153 (fp.mul roundNearestTiesToEven cat_152 cat_152))))
...
(assert (= cat_151 cat_150))
(assert (= cat_154 cat_151))
(assert (spoon_1 cat_150))
(assert (spoon_1 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv127 8) (_ bv0 23)) cat_154)))
(assert (not (spoon_1 (fp.mul roundNearestTiesToEven (fp.neg (fp (_ bv0 1) (_ bv127 8) (_ bv0 23))) cat_154))))
(check-sat)
(exit)
