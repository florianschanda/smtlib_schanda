...
(assert (= cat_153 ((_ to_fp 8 24) RNE (fp.mul RNE cat_129 cat_129))))
(assert (= cat_146 (fp.mul RNE cat_153 cat_152)))
(assert (spoon_1 (fp.mul RNE cat_153 cat_152)))
(assert (spoon_1 cat_146))
(assert (= cat_147 (fp.mul RNE cat_153 (fp.mul RNE cat_152 cat_152))))
(assert (spoon_1 (fp.mul RNE cat_153 (fp.mul RNE cat_152 cat_152))))
...
(assert (spoon_1 (fp.mul RNE (fp #b0 #b01111111 #b00000000000000000000000) cat_154)))
(assert (not (spoon_1 (fp.mul RNE (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)) cat_154))))
(check-sat)
(exit)
