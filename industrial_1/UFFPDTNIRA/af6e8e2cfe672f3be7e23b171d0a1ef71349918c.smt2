...
(declare-const cat_247 potato_7)
(declare-const cat_248 Bool)
(declare-const cat_249 potato_29)
(declare-const cat_250 potato_28)
...
(assert (= cat_247 (mk_potato_7 cat_203)))
(assert (= cat_248 (distinct 1 0)))
(assert (= cat_249 (mk_potato_29 (mk_potato_28 cat_201 cat_202))))
(assert (= cat_250 (get_potato_30_a cat_138)))
(assert (= cat_251 (mk_potato_11 cat_206)))
(assert (= cat_252 (fp.mul RNE cat_181 cat_181)))
(assert (and (= cat_224 ((_ to_fp 11 53) RNE (fp.mul RNE cat_177 cat_177))) (spoon_3 ((_ to_fp 11 53) RNE (fp.mul RNE cat_177 cat_177)))))
(assert (= cat_253 (mk_potato_11 cat_204)))
(assert (= cat_254 cat_224))
(assert (and (= cat_225 ((_ to_fp 11 53) RNE (fp.mul RNE cat_179 cat_179))) (spoon_3 ((_ to_fp 11 53) RNE (fp.mul RNE cat_179 cat_179)))))
(assert (= cat_255 (mk_potato_11 cat_205)))
(assert (= cat_256 cat_225))
(assert (= cat_257 (mk_potato_11 cat_207)))
(assert (= cat_258 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_181)))
(assert (and (= cat_226 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_252)) (spoon_3 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_252))))
(assert (= cat_259 (mk_potato_11 cat_208)))
(assert (= cat_260 cat_226))
...
(assert (= cat_261 (mk_potato_11 cat_209)))
(assert (= cat_262 cat_229))
...
(assert (= cat_263 (mk_potato_11 cat_210)))
(assert (= cat_264 cat_232))
(assert (and (= cat_237 (fp.mul RNE cat_258 ((_ to_fp 11 53) RNE cat_179))) (spoon_3 (fp.mul RNE cat_258 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_238 (fp.mul RNE cat_237 cat_264)))
(assert (and (= cat_239 cat_238) (spoon_3 cat_238)))
(assert (and (= cat_233 (fp.sub RNE cat_260 cat_254)) (spoon_3 (fp.sub RNE cat_260 cat_254))))
(assert (= cat_234 (fp.sub RNE cat_233 cat_256)))
(assert (and (= cat_235 cat_234) (spoon_3 cat_234)))
(assert (= cat_236 (fp.mul RNE cat_235 cat_262)))
...
(assert (= cat_266 cat_242))
(assert (and (= cat_243 (fp.add RNE cat_260 cat_254)) (spoon_3 (fp.add RNE cat_260 cat_254))))
(assert (= cat_244 (fp.add RNE cat_243 cat_256)))
(assert (not (spoon_3 cat_244)))
(check-sat)
(exit)
