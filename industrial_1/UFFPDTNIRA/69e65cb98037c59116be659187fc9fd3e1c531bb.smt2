...
(declare-const cat_221 potato_28)
...
(assert (= cat_219 (ite (not (= cat_200 true)) true false)))
(assert (= cat_219 true))
(assert (=> (= cat_220 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_221))) (and (= cat_201 (spoon_76 (fp #b0 #b10000101 #b01100111111101011101000))) (spoon_86 cat_201)))))
(assert (=> (= cat_220 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_221))) (= cat_222 (mk_potato_10 cat_218)))))
(assert (=> (= cat_220 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_221))) (= cat_223 cat_201))))
(assert (=> (= cat_220 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_221)))) (=> (fp.lt (spoon_111 (get_potato_28_a cat_221)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (and (= cat_202 (spoon_76 (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (spoon_86 cat_202))))))
(assert (=> (= cat_220 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_221)))) (=> (fp.lt (spoon_111 (get_potato_28_a cat_221)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_224 (mk_potato_10 cat_218))))))
(assert (=> (= cat_220 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_221)))) (=> (fp.lt (spoon_111 (get_potato_28_a cat_221)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_225 cat_202)))))
(assert (=> (= cat_220 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_221)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_221)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_203 (spoon_111 (get_potato_28_a cat_221))) (spoon_1 (spoon_111 (get_potato_28_a cat_221))))))))
(assert (=> (= cat_220 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_221)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_221)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_204 (spoon_76 cat_203)) (spoon_86 cat_204))))))
(assert (=> (= cat_220 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_221)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_221)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_226 (mk_potato_10 cat_218))))))
(assert (=> (= cat_220 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_221)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_221)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_227 cat_204)))))
(assert (=> (= cat_220 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_221)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_221)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_225 cat_227)))))
(assert (=> (= cat_220 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_221)))) (= cat_223 cat_225))))
(assert (=> (= cat_220 true) (= cat_228 (mk_potato_10 cat_217))))
(assert (=> (= cat_220 true) (= cat_229 (fp.mul RNE cat_170 cat_170))))
(assert (=> (= cat_220 true) (= cat_230 (mk_potato_10 cat_214))))
(assert (=> (= cat_220 true) (= cat_231 ((_ to_fp 8 24) RNE (fp.sub RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) (fp.mul RNE cat_166 cat_166))))))
(assert (=> (= cat_220 true) (= cat_232 (mk_potato_10 cat_213))))
(assert (=> (= cat_220 true) (= cat_233 (fp.sqrt RNE cat_231))))
(assert (=> (not (= cat_220 true)) (= cat_223 cat_218)))
(assert (=> (not (= cat_220 true)) (= cat_229 cat_217)))
(assert (=> (not (= cat_220 true)) (= cat_231 cat_214)))
(assert (=> (not (= cat_220 true)) (= cat_233 cat_213)))
(assert (=> (= cat_220 true) (and (= cat_205 (fp.sub RNE cat_231 cat_229)) (spoon_1 (fp.sub RNE cat_231 cat_229)))))
(assert (=> (= cat_220 true) (= cat_206 (fp.add RNE cat_205 (fp.mul RNE cat_223 cat_223)))))
(assert (=> (= cat_220 true) (and (= cat_207 cat_206) (spoon_1 cat_206))))
(assert (=> (= cat_220 true) (= cat_234 (mk_potato_10 cat_216))))
(assert (=> (= cat_220 true) (= cat_235 cat_207)))
(assert (=> (= cat_220 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_235) (= cat_236 (mk_potato_10 cat_215)))))
(assert (=> (= cat_220 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_235) (= cat_237 (fp.sqrt RNE cat_235)))))
(assert (=> (= cat_220 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_235) (= cat_239 cat_220))))
(assert (=> (= cat_220 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_235)) (= cat_238 (mk_potato_7 cat_220)))))
(assert (=> (= cat_220 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_235)) (= cat_239 (distinct 0 0)))))
(assert (=> (= cat_220 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_235)) (= cat_237 cat_215))))
(assert (=> (not (= cat_220 true)) (= cat_235 cat_216)))
(assert (=> (not (= cat_220 true)) (= cat_237 cat_215)))
(assert (=> (not (= cat_220 true)) (= cat_239 cat_220)))
(assert (= cat_239 true))
(assert (= cat_210 (fp.mul RNE cat_237 cat_170)))
(assert (spoon_1 (fp.mul RNE cat_237 cat_170)))
(assert (= cat_208 (fp.mul RNE cat_233 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_166 cat_166)) cat_229))))
(assert (spoon_1 (fp.mul RNE cat_233 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_166 cat_166)) cat_229))))
(assert (= cat_209 (fp.mul RNE cat_208 cat_223)))
(assert (= cat_211 cat_209))
(assert (spoon_1 cat_209))
(assert (= cat_212 (fp.sub RNE cat_211 cat_210)))
(assert (spoon_1 cat_212))
(assert (not (spoon_1 (fp.mul RNE cat_237 cat_170))))
(check-sat)
(exit)
