...
(declare-const cat_167 potato_27)
(declare-const cat_168 potato_27)
(declare-const cat_169 potato_27)
(declare-const cat_170 potato_27)
(declare-const cat_171 potato_27)
(declare-const cat_172 potato_27)
(declare-const cat_173 potato_27)
...
(declare-const cat_179 potato_27)
(declare-const cat_180 potato_27)
(declare-const cat_181 potato_31)
...
(assert (= cat_178 (fp #b0 #b00000000 #b00000000000000000000000)))
...
(assert (= (spoon_104 cat_169) (fp.sub RNE (spoon_59 (get_potato_19_b (get_potato_21_a cat_110))) (spoon_59 (get_potato_19_b (get_potato_21_a cat_108))))))
(assert (= cat_169 cat_172))
(assert (= (spoon_104 cat_170) (fp.sub RNE (spoon_59 (get_potato_19_a (get_potato_21_a cat_110))) (spoon_59 (get_potato_19_a (get_potato_21_a cat_108))))))
(assert (= cat_170 cat_171))
(assert (= cat_173 cat_171))
(assert (= cat_174 cat_172))
(assert (= cat_181 (mk_potato_31 cat_173 cat_174)))
(assert (= cat_182 (fp.add RNE (fp.mul RNE (spoon_104 cat_179) (spoon_104 (get_potato_31_a cat_181))) (fp.mul RNE (spoon_104 cat_180) (spoon_104 (get_potato_31_b cat_181))))))
...
(assert (fp.lt (fp #b0 #b01110101 #b00000110001001001101111) cat_183))
(assert (fp.lt (fp #b0 #b01110101 #b00000110001001001101111) cat_184))
(assert (= cat_177 (fp.div RNE cat_182 (fp.mul RNE cat_183 cat_184))))
(assert (spoon_1 (fp.div RNE cat_182 (fp.mul RNE cat_183 cat_184))))
