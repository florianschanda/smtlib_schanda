...
(assert (= cat_215 cat_194))
(assert (and (= cat_195 (spoon_40 cat_211)) (spoon_50 cat_195)))
(assert (= cat_196 ((_ to_fp 11 53) roundNearestTiesToEven cat_195)))
(assert (= cat_216 cat_180))
(assert (= cat_217 cat_196))
(assert (and (= cat_197 (spoon_58 cat_211)) (spoon_50 cat_197)))
(assert (= cat_198 ((_ to_fp 11 53) roundNearestTiesToEven cat_197)))
(assert (= cat_218 cat_181))
(assert (= cat_219 cat_198))
(assert (and (= cat_199 (spoon_40 cat_215)) (spoon_50 cat_199)))
(assert (= cat_200 ((_ to_fp 11 53) roundNearestTiesToEven cat_199)))
(assert (= cat_220 (mk_potato_11 cat_182)))
(assert (= cat_221 cat_200))
(assert (and (= cat_201 (spoon_58 cat_215)) (spoon_50 cat_201)))
(assert (= cat_202 ((_ to_fp 11 53) roundNearestTiesToEven cat_201)))
(assert (= cat_222 (mk_potato_11 cat_183)))
(assert (= cat_223 cat_202))
(assert (and (= cat_203 (spoon_40 cat_213)) (spoon_50 cat_203)))
(assert (= cat_204 ((_ to_fp 11 53) roundNearestTiesToEven cat_203)))
(assert (= cat_224 (mk_potato_11 cat_184)))
(assert (= cat_225 cat_204))
(assert (and (= cat_205 (spoon_58 cat_213)) (spoon_50 cat_205)))
(assert (= cat_206 ((_ to_fp 11 53) roundNearestTiesToEven cat_205)))
(assert (= cat_226 (mk_potato_11 cat_185)))
(assert (= cat_227 cat_206))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_219 cat_223))) (and (= cat_207 _let_0) (spoon_3 _let_0))))
(assert (= cat_208 (fp.mul roundNearestTiesToEven cat_207 cat_227)))
(assert (and (= cat_209 cat_208) (spoon_3 cat_208)))
(assert (not (spoon_3 (fp.mul roundNearestTiesToEven cat_217 cat_221))))
(check-sat)
(exit)
