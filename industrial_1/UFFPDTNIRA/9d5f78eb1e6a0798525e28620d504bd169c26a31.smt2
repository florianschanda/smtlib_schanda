...
(assert (=> (fp.lt cat_77 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000))) (and (= cat_82 (fp.add RNE (fp.mul RNE cat_89 (fp.sub RNE cat_91 (spoon_40 (get_potato_15_a (get_potato_17_a cat_60))))) (spoon_40 (get_potato_15_b (get_potato_17_a cat_60))))) (spoon_1 (fp.add RNE (fp.mul RNE cat_89 (fp.sub RNE cat_91 (spoon_40 (get_potato_15_a (get_potato_17_a cat_60))))) (spoon_40 (get_potato_15_b (get_potato_17_a cat_60))))))))
...
(assert (=> (not (fp.lt cat_77 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_77) (and (= cat_83 (fp.add RNE (fp.mul RNE cat_89 (fp.sub RNE cat_95 (spoon_40 (get_potato_15_a (get_potato_17_a cat_60))))) (spoon_40 (get_potato_15_b (get_potato_17_a cat_60))))) (spoon_1 (fp.add RNE (fp.mul RNE cat_89 (fp.sub RNE cat_95 (spoon_40 (get_potato_15_a (get_potato_17_a cat_60))))) (spoon_40 (get_potato_15_b (get_potato_17_a cat_60)))))))))
...
(assert (and (= cat_84 (fp.div RNE (fp.sub RNE cat_99 (spoon_40 (get_potato_15_b (get_potato_17_a cat_60)))) cat_89)) (spoon_1 (fp.div RNE (fp.sub RNE cat_99 (spoon_40 (get_potato_15_b (get_potato_17_a cat_60)))) cat_89))))
