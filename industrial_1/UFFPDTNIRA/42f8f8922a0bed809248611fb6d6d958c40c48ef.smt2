...
(declare-const cat_247 potato_19)
(declare-const cat_248 potato_18)
...
(assert (= cat_247 (mk_potato_19 (mk_potato_18 cat_201 cat_202))))
(assert (= cat_248 (get_potato_20_a cat_85)))
(assert (= cat_249 (mk_potato_11 cat_206)))
(assert (= cat_250 (fp.mul RNE cat_181 cat_181)))
(assert (and (= cat_224 ((_ to_fp 11 53) RNE (fp.mul RNE cat_177 cat_177))) (spoon_2 ((_ to_fp 11 53) RNE (fp.mul RNE cat_177 cat_177)))))
(assert (= cat_251 (mk_potato_11 cat_204)))
(assert (= cat_252 cat_224))
(assert (and (= cat_225 ((_ to_fp 11 53) RNE (fp.mul RNE cat_179 cat_179))) (spoon_2 ((_ to_fp 11 53) RNE (fp.mul RNE cat_179 cat_179)))))
(assert (= cat_253 (mk_potato_11 cat_205)))
(assert (= cat_254 cat_225))
(assert (= cat_255 (mk_potato_11 cat_207)))
(assert (= cat_256 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_181)))
(assert (and (= cat_226 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_250)) (spoon_2 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_250))))
(assert (= cat_257 (mk_potato_11 cat_208)))
(assert (= cat_258 cat_226))
...
(assert (= cat_261 (mk_potato_11 cat_210)))
(assert (= cat_262 cat_232))
(assert (and (= cat_237 (fp.mul RNE cat_256 ((_ to_fp 11 53) RNE cat_179))) (spoon_2 (fp.mul RNE cat_256 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_238 (fp.mul RNE cat_237 cat_262)))
(assert (and (= cat_239 cat_238) (spoon_2 cat_238)))
(assert (and (= cat_233 (fp.sub RNE cat_258 cat_252)) (spoon_2 (fp.sub RNE cat_258 cat_252))))
(assert (= cat_234 (fp.sub RNE cat_233 cat_254)))
(assert (and (= cat_235 cat_234) (spoon_2 cat_234)))
(assert (= cat_236 (fp.mul RNE cat_235 cat_260)))
...
(assert (= cat_264 cat_242))
(assert (not (spoon_2 (fp.add RNE cat_258 cat_252))))
(check-sat)
(exit)
