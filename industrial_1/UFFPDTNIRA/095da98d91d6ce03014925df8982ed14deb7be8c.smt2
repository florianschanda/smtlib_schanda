...
(assert (= (mk_potato_11 cat_148) (mk_potato_11 cat_130)))
(assert (= cat_149 cat_143))
...
(assert (= (mk_potato_11 cat_150) (mk_potato_11 cat_131)))
(assert (= cat_151 cat_147))
(assert (not (spoon_3 (fp.mul RNE cat_149 (fp #b0 #b10000000100 #b1100101001011101110000001101000000111100111100100110)))))
(check-sat)
(exit)
