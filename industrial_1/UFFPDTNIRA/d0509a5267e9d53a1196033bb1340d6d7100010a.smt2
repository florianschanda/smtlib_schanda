...
(assert (= cat_215 cat_196))
(assert (and (= cat_197 (spoon_137 (spoon_60 (get_potato_18_a (get_potato_20_a cat_141))))) (spoon_87 cat_197)))
(assert (= cat_216 cat_182))
(assert (= cat_217 cat_197))
(assert (and (= cat_198 (spoon_103 cat_213)) (spoon_95 cat_198)))
(assert (= cat_199 ((_ to_fp 11 53) RNE cat_198)))
(assert (= cat_218 cat_183))
(assert (= cat_219 cat_199))
(assert (and (= cat_200 (spoon_105 cat_213)) (spoon_95 cat_200)))
(assert (= cat_201 ((_ to_fp 11 53) RNE cat_200)))
(assert (= cat_220 cat_184))
(assert (= cat_221 cat_201))
(assert (and (= cat_202 (spoon_103 cat_217)) (spoon_95 cat_202)))
(assert (= cat_203 ((_ to_fp 11 53) RNE cat_202)))
(assert (= cat_222 (mk_potato_11 cat_185)))
(assert (= cat_223 cat_203))
(assert (and (= cat_204 (spoon_105 cat_217)) (spoon_95 cat_204)))
(assert (= cat_205 ((_ to_fp 11 53) RNE cat_204)))
(assert (= cat_224 (mk_potato_11 cat_186)))
(assert (= cat_225 cat_205))
(assert (and (= cat_206 (spoon_103 cat_215)) (spoon_95 cat_206)))
(assert (= cat_207 ((_ to_fp 11 53) RNE cat_206)))
(assert (= cat_226 (mk_potato_11 cat_187)))
(assert (= cat_227 cat_207))
(assert (and (= cat_208 (spoon_105 cat_215)) (spoon_95 cat_208)))
(assert (= cat_209 ((_ to_fp 11 53) RNE cat_208)))
(assert (= cat_228 (mk_potato_11 cat_188)))
(assert (= cat_229 cat_209))
(assert (and (= cat_210 (fp.mul RNE cat_221 cat_225)) (spoon_2 (fp.mul RNE cat_221 cat_225))))
(assert (= cat_211 (fp.mul RNE cat_210 cat_229)))
(assert (not (spoon_2 cat_211)))
(check-sat)
(exit)
