...
(assert (= cat_208 cat_177))
(assert (= cat_209 cat_191))
...
(assert (= cat_210 cat_176))
(assert (= cat_211 cat_192))
(assert (and (= cat_193 (spoon_133 (spoon_56 (get_potato_18_a (get_potato_20_a cat_137))))) (spoon_83 cat_193)))
(assert (= cat_212 cat_178))
(assert (= cat_213 cat_193))
(assert (and (= cat_194 (spoon_99 cat_209)) (spoon_91 cat_194)))
(assert (= cat_195 ((_ to_fp 11 53) RNE cat_194)))
(assert (= cat_214 cat_179))
(assert (= cat_215 cat_195))
(assert (and (= cat_196 (spoon_101 cat_209)) (spoon_91 cat_196)))
(assert (= cat_197 ((_ to_fp 11 53) RNE cat_196)))
(assert (= cat_216 cat_180))
(assert (= cat_217 cat_197))
(assert (and (= cat_198 (spoon_99 cat_213)) (spoon_91 cat_198)))
(assert (= cat_199 ((_ to_fp 11 53) RNE cat_198)))
(assert (= cat_218 (mk_potato_11 cat_181)))
(assert (= cat_219 cat_199))
(assert (and (= cat_200 (spoon_101 cat_213)) (spoon_91 cat_200)))
(assert (= cat_201 ((_ to_fp 11 53) RNE cat_200)))
(assert (= cat_220 (mk_potato_11 cat_182)))
(assert (= cat_221 cat_201))
(assert (and (= cat_202 (spoon_99 cat_211)) (spoon_91 cat_202)))
(assert (= cat_203 ((_ to_fp 11 53) RNE cat_202)))
(assert (= cat_222 (mk_potato_11 cat_183)))
(assert (= cat_223 cat_203))
(assert (and (= cat_204 (spoon_101 cat_211)) (spoon_91 cat_204)))
(assert (= cat_205 ((_ to_fp 11 53) RNE cat_204)))
(assert (= cat_224 (mk_potato_11 cat_184)))
(assert (= cat_225 cat_205))
(assert (and (= cat_206 (fp.mul RNE cat_217 cat_221)) (spoon_2 (fp.mul RNE cat_217 cat_221))))
(assert (= cat_207 (fp.mul RNE cat_206 cat_225)))
(assert (not (spoon_2 cat_207)))
(check-sat)
(exit)
