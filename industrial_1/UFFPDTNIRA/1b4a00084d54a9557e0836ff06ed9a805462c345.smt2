...
(assert (and (= cat_212 (fp.mul RNE cat_243 cat_247)) (spoon_3 (fp.mul RNE cat_243 cat_247))))
(assert (= cat_213 (fp.mul RNE cat_212 cat_251)))
(assert (and (= cat_214 cat_213) (spoon_3 cat_213)))
(assert (and (= cat_210 (fp.mul RNE cat_241 cat_245)) (spoon_3 (fp.mul RNE cat_241 cat_245))))
...
(assert (and (= cat_218 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_145) cat_249)) (spoon_3 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_145) cat_249))))
...
(assert (=> (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_253) (and (= cat_221 (fp.div RNE cat_255 cat_253)) (spoon_3 (fp.div RNE cat_255 cat_253)))))
...
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_253)) (=> (= cat_258 true) (and (= cat_230 (fp.div RNE cat_255 cat_253)) (spoon_3 (fp.div RNE cat_255 cat_253))))))
...
(assert (and (= cat_231 (fp.mul RNE cat_241 cat_247)) (spoon_3 (fp.mul RNE cat_241 cat_247))))
(assert (= cat_266 (mk_potato_11 cat_189)))
(assert (= cat_267 cat_231))
(assert (and (= cat_232 (fp.mul RNE cat_243 cat_245)) (spoon_3 (fp.mul RNE cat_243 cat_245))))
