...
(assert (and (= cat_130 cat_113) (spoon_1 cat_113)))
(assert (and (= cat_131 (spoon_46 cat_130)) (spoon_56 cat_131)))
(assert (= cat_131 cat_119))
(assert (spoon_56 cat_119))
(assert (and (= cat_132 (fp.sub RNE (fp #b0 #b01111111 #b00000000000000000000000) cat_117)) (spoon_1 (fp.sub RNE (fp #b0 #b01111111 #b00000000000000000000000) cat_117))))
(assert (= cat_133 (fp.mul RNE cat_132 (fp.mul RNE cat_119 cat_119))))
(assert (and (= cat_134 cat_133) (spoon_1 cat_133)))
(assert (= cat_135 (fp.add RNE (fp #b0 #b01111111 #b00000000000000000000000) cat_134)))
(assert (not (spoon_1 cat_135)))
(check-sat)
(exit)
