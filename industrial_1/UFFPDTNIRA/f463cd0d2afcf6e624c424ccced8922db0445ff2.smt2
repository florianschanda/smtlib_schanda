...
(define-fun spoon_275 () potato_11 (mk_potato_11 cat_175))
...
(assert (= cat_237 cat_178))
(assert (= cat_238 cat_192))
...
(assert (= cat_239 cat_177))
(assert (= cat_240 cat_193))
(assert (and (= cat_194 (spoon_60 (spoon_86 (get_potato_22_a (get_potato_24_a cat_154))))) (spoon_42 cat_194)))
(assert (= cat_241 cat_179))
(assert (= cat_242 cat_194))
(assert (and (= cat_195 (spoon_40 cat_238)) (spoon_50 cat_195)))
(assert (= cat_196 ((_ to_fp 11 53) RNE cat_195)))
(assert (= cat_243 cat_180))
(assert (= cat_244 cat_196))
(assert (and (= cat_197 (spoon_58 cat_238)) (spoon_50 cat_197)))
(assert (= cat_198 ((_ to_fp 11 53) RNE cat_197)))
(assert (= cat_245 cat_181))
(assert (= cat_246 cat_198))
(assert (and (= cat_199 (spoon_40 cat_242)) (spoon_50 cat_199)))
(assert (= cat_200 ((_ to_fp 11 53) RNE cat_199)))
(assert (= cat_247 (mk_potato_11 cat_182)))
(assert (= cat_248 cat_200))
(assert (and (= cat_201 (spoon_58 cat_242)) (spoon_50 cat_201)))
(assert (= cat_202 ((_ to_fp 11 53) RNE cat_201)))
(assert (= cat_249 (mk_potato_11 cat_183)))
(assert (= cat_250 cat_202))
(assert (and (= cat_203 (spoon_40 cat_240)) (spoon_50 cat_203)))
(assert (= cat_204 ((_ to_fp 11 53) RNE cat_203)))
(assert (= cat_251 (mk_potato_11 cat_184)))
(assert (= cat_252 cat_204))
(assert (and (= cat_205 (spoon_58 cat_240)) (spoon_50 cat_205)))
(assert (= cat_206 ((_ to_fp 11 53) RNE cat_205)))
(assert (= cat_253 (mk_potato_11 cat_185)))
(assert (= cat_254 cat_206))
(assert (and (= cat_209 (fp.mul RNE cat_246 cat_250)) (spoon_3 (fp.mul RNE cat_246 cat_250))))
(assert (= cat_210 (fp.mul RNE cat_209 cat_254)))
(assert (and (= cat_211 cat_210) (spoon_3 cat_210)))
(assert (and (= cat_207 (fp.mul RNE cat_244 cat_248)) (spoon_3 (fp.mul RNE cat_244 cat_248))))
...
(assert (= cat_255 (mk_potato_11 cat_188)))
(assert (= cat_256 cat_214))
(assert (and (= cat_215 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_156) cat_252)) (spoon_3 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_156) cat_252))))
(assert (= cat_216 (fp.mul RNE cat_215 cat_246)))
(assert (and (= cat_217 cat_216) (spoon_3 cat_216)))
(assert (= cat_257 (mk_potato_11 cat_189)))
(assert (= cat_258 cat_217))
(assert (=> (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_256) (and (= cat_218 (fp.div RNE cat_258 cat_256)) (spoon_3 (fp.div RNE cat_258 cat_256)))))
(assert (=> (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_256) (= cat_259 spoon_275)))
(assert (=> (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_256) (= cat_260 cat_218)))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_256)) (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_256) (and (= cat_224 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_256)) (spoon_3 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_256))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_256)) (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_256) (= cat_225 (ite (fp.leq cat_258 cat_224) true false)))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_256)) (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_256) (and (= cat_223 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_256)) (spoon_3 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_256))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_256)) (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_256) (= cat_226 (ite (fp.leq cat_223 cat_258) true false)))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_256)) (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_256) (= cat_262 (ite (= cat_226 true) cat_225 false)))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_256)) (=> (not (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_256)) (= cat_262 false))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_256)) (=> (= cat_262 true) (= cat_261 true))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_256)) (=> (not (= cat_262 true)) (=> (fp.lt cat_256 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (and (= cat_220 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_256)) (spoon_3 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_256)))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_256)) (=> (not (= cat_262 true)) (=> (fp.lt cat_256 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_221 (ite (fp.leq cat_258 cat_220) true false))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_256)) (=> (not (= cat_262 true)) (=> (fp.lt cat_256 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (and (= cat_219 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_256)) (spoon_3 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_256)))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_256)) (=> (not (= cat_262 true)) (=> (fp.lt cat_256 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_222 (ite (fp.leq cat_219 cat_258) true false))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_256)) (=> (not (= cat_262 true)) (=> (fp.lt cat_256 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_261 (ite (= cat_222 true) cat_221 false))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_256)) (=> (not (= cat_262 true)) (=> (not (fp.lt cat_256 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))) (= cat_261 false)))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_256)) (=> (= cat_261 true) (and (= cat_227 (fp.div RNE cat_258 cat_256)) (spoon_3 (fp.div RNE cat_258 cat_256))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_256)) (=> (= cat_261 true) (= cat_263 spoon_275))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_256)) (=> (= cat_261 true) (= cat_264 cat_227))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_256)) (=> (not (= cat_261 true)) (=> (fp.lt cat_258 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_265 spoon_275)))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_256)) (=> (not (= cat_261 true)) (=> (fp.lt cat_258 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_266 (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_256)) (=> (not (= cat_261 true)) (=> (not (fp.lt cat_258 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))) (= cat_267 spoon_275)))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_256)) (=> (not (= cat_261 true)) (=> (not (fp.lt cat_258 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))) (= cat_268 (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_256)) (=> (not (= cat_261 true)) (=> (not (fp.lt cat_258 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))) (= cat_266 cat_268)))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_256)) (=> (not (= cat_261 true)) (= cat_264 cat_266))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_256)) (= cat_260 cat_264)))
(assert (and (= cat_228 (fp.mul RNE cat_244 cat_250)) (spoon_3 (fp.mul RNE cat_244 cat_250))))
(assert (= cat_269 (mk_potato_11 cat_186)))
(assert (= cat_270 cat_228))
(assert (and (= cat_229 (fp.mul RNE cat_246 cat_248)) (spoon_3 (fp.mul RNE cat_246 cat_248))))
(assert (= cat_230 (fp.mul RNE cat_229 cat_254)))
(assert (and (= cat_231 cat_230) (spoon_3 cat_230)))
(assert (= cat_271 (mk_potato_11 cat_187)))
(assert (= cat_272 cat_231))
(assert (and (= cat_232 (fp.sub RNE cat_270 cat_272)) (spoon_3 (fp.sub RNE cat_270 cat_272))))
...
(assert (= cat_273 (mk_potato_11 cat_190)))
(assert (= cat_274 cat_234))
(assert (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_256)))
(assert (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_256))
(assert (and (= cat_235 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_256)) (spoon_3 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_256))))
(assert (= cat_236 (ite (fp.leq cat_274 cat_235) true false)))
(assert (not (spoon_3 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_256))))
(check-sat)
(exit)
