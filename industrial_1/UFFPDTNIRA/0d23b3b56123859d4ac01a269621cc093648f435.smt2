...
(assert (and (= cat_72 (fp.mul RNE (fp.sub RNE (spoon_37 (get_potato_15_a (get_potato_17_a cat_62))) (spoon_37 (get_potato_15_a (get_potato_17_a cat_64)))) (fp.sub RNE (spoon_37 (get_potato_15_a (get_potato_17_a cat_62))) (spoon_37 (get_potato_15_a (get_potato_17_a cat_64)))))) (spoon_1 (fp.mul RNE (fp.sub RNE (spoon_37 (get_potato_15_a (get_potato_17_a cat_62))) (spoon_37 (get_potato_15_a (get_potato_17_a cat_64)))) (fp.sub RNE (spoon_37 (get_potato_15_a (get_potato_17_a cat_62))) (spoon_37 (get_potato_15_a (get_potato_17_a cat_64))))))))
(assert (= cat_72 cat_66))
(assert (spoon_1 cat_66))
(assert (not (spoon_1 (fp.mul RNE (fp.sub RNE (spoon_37 (get_potato_15_b (get_potato_17_a cat_62))) (spoon_37 (get_potato_15_b (get_potato_17_a cat_64)))) (fp.sub RNE (spoon_37 (get_potato_15_b (get_potato_17_a cat_62))) (spoon_37 (get_potato_15_b (get_potato_17_a cat_64))))))))
(check-sat)
(exit)
