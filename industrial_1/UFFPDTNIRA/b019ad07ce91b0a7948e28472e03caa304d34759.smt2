...
(declare-const cat_253 potato_7)
(declare-const cat_254 Bool)
(declare-const cat_255 potato_29)
(declare-const cat_256 potato_28)
...
(define-fun spoon_285 () potato_11 (mk_potato_11 cat_211))
...
(assert (= cat_253 (mk_potato_7 cat_203)))
(assert (= cat_254 (distinct 1 0)))
(assert (= cat_255 (mk_potato_29 (mk_potato_28 cat_201 cat_202))))
(assert (= cat_256 (get_potato_30_a cat_138)))
(assert (= cat_257 (mk_potato_11 cat_206)))
(assert (= cat_258 (fp.mul RNE cat_181 cat_181)))
(assert (and (= cat_224 ((_ to_fp 11 53) RNE (fp.mul RNE cat_177 cat_177))) (spoon_3 ((_ to_fp 11 53) RNE (fp.mul RNE cat_177 cat_177)))))
(assert (= cat_259 (mk_potato_11 cat_204)))
(assert (= cat_260 cat_224))
(assert (and (= cat_225 ((_ to_fp 11 53) RNE (fp.mul RNE cat_179 cat_179))) (spoon_3 ((_ to_fp 11 53) RNE (fp.mul RNE cat_179 cat_179)))))
(assert (= cat_261 (mk_potato_11 cat_205)))
(assert (= cat_262 cat_225))
(assert (= cat_263 (mk_potato_11 cat_207)))
(assert (= cat_264 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_181)))
(assert (and (= cat_226 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_258)) (spoon_3 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_258))))
(assert (= cat_265 (mk_potato_11 cat_208)))
(assert (= cat_266 cat_226))
...
(assert (= cat_267 (mk_potato_11 cat_209)))
(assert (= cat_268 cat_229))
...
(assert (= cat_270 cat_232))
(assert (and (= cat_237 (fp.mul RNE cat_264 ((_ to_fp 11 53) RNE cat_179))) (spoon_3 (fp.mul RNE cat_264 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_238 (fp.mul RNE cat_237 cat_270)))
(assert (and (= cat_239 cat_238) (spoon_3 cat_238)))
(assert (and (= cat_233 (fp.sub RNE cat_266 cat_260)) (spoon_3 (fp.sub RNE cat_266 cat_260))))
(assert (= cat_234 (fp.sub RNE cat_233 cat_262)))
(assert (and (= cat_235 cat_234) (spoon_3 cat_234)))
(assert (= cat_236 (fp.mul RNE cat_235 cat_268)))
...
(assert (= cat_271 (mk_potato_11 cat_213)))
(assert (= cat_272 cat_242))
(assert (and (= cat_243 (fp.add RNE cat_266 cat_260)) (spoon_3 (fp.add RNE cat_266 cat_260))))
(assert (= cat_244 (fp.add RNE cat_243 cat_262)))
(assert (and (= cat_245 cat_244) (spoon_3 cat_244)))
(assert (= cat_273 (mk_potato_11 cat_214)))
(assert (= cat_274 cat_245))
(assert (and (= cat_246 (fp.div RNE cat_272 cat_274)) (spoon_3 (fp.div RNE cat_272 cat_274))))
(assert (= cat_275 (mk_potato_11 cat_212)))
(assert (= cat_276 cat_246))
(assert (=> (fp.lt cat_276 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))) (= cat_277 spoon_285)))
(assert (=> (fp.lt cat_276 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))) (= cat_278 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))))
(assert (=> (not (fp.lt cat_276 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_276) (= cat_279 spoon_285))))
(assert (=> (not (fp.lt cat_276 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_276) (= cat_280 (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))))
(assert (=> (not (fp.lt cat_276 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_276)) (and (= cat_247 cat_276) (spoon_3 cat_276)))))
(assert (=> (not (fp.lt cat_276 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_276)) (= cat_281 spoon_285))))
(assert (=> (not (fp.lt cat_276 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_276)) (= cat_282 cat_247))))
(assert (=> (not (fp.lt cat_276 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_276)) (= cat_280 cat_282))))
(assert (=> (not (fp.lt cat_276 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (= cat_278 cat_280)))
(assert (and (= cat_248 (fp.mul RNE cat_264 ((_ to_fp 11 53) RNE cat_177))) (spoon_3 (fp.mul RNE cat_264 ((_ to_fp 11 53) RNE cat_177)))))
(assert (= cat_283 (mk_potato_11 cat_216)))
(assert (= cat_284 cat_248))
(assert (and (= cat_249 (fp.mul RNE cat_264 ((_ to_fp 11 53) RNE cat_179))) (spoon_3 (fp.mul RNE cat_264 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_250 (fp.mul RNE cat_249 cat_268)))
(assert (not (spoon_3 cat_250)))
(check-sat)
(exit)
