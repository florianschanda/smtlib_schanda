...
(assert (=> (=> (not (fp.lt cat_71 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_71)) (=> (not (fp.lt cat_72 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_72)))) (and (and (and (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) cat_73) (fp.leq cat_73 (fp #b0 #b10001011 #b00000000000000000000000))) (and (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) cat_74) (fp.leq cat_74 (fp #b0 #b10001011 #b00000000000000000000000)))) (and (spoon_60 cat_74) (spoon_60 cat_73)))))
(assert (=> (not (=> (not (fp.lt cat_71 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_71)) (=> (not (fp.lt cat_72 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_72))))) (= cat_74 cat_72)))
(assert (=> (not (=> (not (fp.lt cat_71 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_71)) (=> (not (fp.lt cat_72 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_72))))) (= cat_73 cat_71)))
