...
(declare-const cat_180 potato_31)
...
(assert (= cat_181 (fp.add RNE (fp.mul RNE (spoon_104 cat_178) (spoon_104 (get_potato_31_a cat_180))) (fp.mul RNE (spoon_104 cat_179) (spoon_104 (get_potato_31_b cat_180))))))
...
(assert (fp.lt (fp #b0 #b01110101 #b00000110001001001101111) cat_182))
(assert (fp.lt (fp #b0 #b01110101 #b00000110001001001101111) cat_183))
(assert (not (spoon_1 (fp.div RNE cat_181 (fp.mul RNE cat_182 cat_183)))))
(check-sat)
(exit)
