...
(define-fun spoon_50 ((kitten_35 Float32)) Bool (and (spoon_1 kitten_35) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_35) (fp.leq kitten_35 (fp #b0 #b01111111 #b00000000000000000000000)))))
...
(define-fun spoon_57 ((kitten_37 Float32) (kitten_38 Bool) (kitten_39 Bool) (kitten_40 Bool)) Bool (=> (or (= kitten_38 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b01111111 #b00000000000000000000000))) (spoon_50 kitten_37)))
...
(define-fun spoon_64 ((kitten_41 Float32) (kitten_42 Bool) (kitten_43 Bool) (kitten_44 Bool)) Bool (=> (or (= kitten_42 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_25 kitten_41)))
(declare-const cat_65 Float32)
(declare-const cat_66 Float32)
(declare-const cat_67 potato_11)
(assert (spoon_50 cat_62))
(assert (and (= cat_66 (fp.add RNE (fp.mul RNE (spoon_32 (get_potato_13_b (get_potato_15_a cat_58))) (fp.sub RNE (fp #b0 #b01111111 #b00000000000000000000000) cat_62)) (fp.mul RNE (spoon_32 (get_potato_13_b (get_potato_15_a cat_60))) cat_62))) (spoon_1 (fp.add RNE (fp.mul RNE (spoon_32 (get_potato_13_b (get_potato_15_a cat_58))) (fp.sub RNE (fp #b0 #b01111111 #b00000000000000000000000) cat_62)) (fp.mul RNE (spoon_32 (get_potato_13_b (get_potato_15_a cat_60))) cat_62)))))
(assert (= (spoon_32 cat_67) cat_66))
(assert (not (spoon_25 (fp.add RNE (fp.mul RNE (spoon_32 (get_potato_13_a (get_potato_15_a cat_58))) (fp.sub RNE (fp #b0 #b01111111 #b00000000000000000000000) cat_62)) (fp.mul RNE (spoon_32 (get_potato_13_a (get_potato_15_a cat_60))) cat_62)))))
(check-sat)
(exit)
