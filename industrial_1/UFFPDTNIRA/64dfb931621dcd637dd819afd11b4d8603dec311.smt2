...
(define-fun spoon_48 ((kitten_34 Float32)) Bool (and (spoon_1 kitten_34) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_34) (fp.leq kitten_34 (fp #b0 #b01111111 #b00000000000000000000000)))))
...
(define-fun spoon_55 ((kitten_36 Float32) (kitten_37 Bool) (kitten_38 Bool) (kitten_39 Bool)) Bool (=> (or (= kitten_37 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b01111111 #b00000000000000000000000))) (spoon_48 kitten_36)))
...
(define-fun spoon_62 ((kitten_40 Float32) (kitten_41 Bool) (kitten_42 Bool) (kitten_43 Bool)) Bool (=> (or (= kitten_41 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_23 kitten_40)))
(declare-const cat_63 Float32)
(declare-const cat_64 potato_11)
(assert (spoon_48 cat_60))
(assert (and (= cat_63 (fp.add RNE (fp.mul RNE (spoon_30 (get_potato_13_b (get_potato_15_a cat_56))) (fp.sub RNE (fp #b0 #b01111111 #b00000000000000000000000) cat_60)) (fp.mul RNE (spoon_30 (get_potato_13_b (get_potato_15_a cat_58))) cat_60))) (spoon_1 (fp.add RNE (fp.mul RNE (spoon_30 (get_potato_13_b (get_potato_15_a cat_56))) (fp.sub RNE (fp #b0 #b01111111 #b00000000000000000000000) cat_60)) (fp.mul RNE (spoon_30 (get_potato_13_b (get_potato_15_a cat_58))) cat_60)))))
(assert (= (spoon_30 cat_64) cat_63))
(assert (not (spoon_23 (fp.add RNE (fp.mul RNE (spoon_30 (get_potato_13_a (get_potato_15_a cat_56))) (fp.sub RNE (fp #b0 #b01111111 #b00000000000000000000000) cat_60)) (fp.mul RNE (spoon_30 (get_potato_13_a (get_potato_15_a cat_58))) cat_60)))))
(check-sat)
(exit)
