...
(declare-const cat_244 potato_29)
(declare-const cat_245 potato_28)
...
(assert (and (= cat_226 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_247)) (spoon_3 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_247))))
...
(assert (and (= cat_237 (fp.mul RNE cat_253 ((_ to_fp 11 53) RNE cat_179))) (spoon_3 (fp.mul RNE cat_253 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_238 (fp.mul RNE cat_237 cat_259)))
(assert (and (= cat_239 cat_238) (spoon_3 cat_238)))
(assert (and (= cat_233 (fp.sub RNE cat_255 cat_249)) (spoon_3 (fp.sub RNE cat_255 cat_249))))
