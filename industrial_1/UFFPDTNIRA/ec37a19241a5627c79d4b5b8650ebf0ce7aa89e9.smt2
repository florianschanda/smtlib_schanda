...
(declare-fun cat_242 () potato_7)
(declare-fun cat_243 () Bool)
(declare-fun cat_244 () potato_29)
(declare-fun cat_245 () potato_28)
...
(assert (= cat_243 (distinct 1 0)))
(assert (= cat_244 (mk_potato_29 (mk_potato_28 cat_201 cat_202))))
(assert (= cat_245 (get_potato_30_a cat_138)))
(assert (= cat_246 (mk_potato_11 cat_206)))
(assert (= cat_247 (fp.mul roundNearestTiesToEven cat_181 cat_181)))
...
(assert (= cat_253 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1025 11) (_ bv0 52)) cat_181)))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1025 11) (_ bv0 52)) cat_247))) (and (= cat_226 _let_0) (spoon_3 _let_0))))
...
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_253 ((_ to_fp 11 53) roundNearestTiesToEven cat_179)))) (and (= cat_237 _let_0) (spoon_3 _let_0))))
(assert (= cat_238 (fp.mul roundNearestTiesToEven cat_237 cat_259)))
(assert (and (= cat_239 cat_238) (spoon_3 cat_238)))
(assert (let ((_let_0 (fp.sub roundNearestTiesToEven cat_255 cat_249))) (and (= cat_233 _let_0) (spoon_3 _let_0))))
(assert (= cat_234 (fp.sub roundNearestTiesToEven cat_233 cat_251)))
(assert (and (= cat_235 cat_234) (spoon_3 cat_234)))
(assert (= cat_236 (fp.mul roundNearestTiesToEven cat_235 cat_257)))
