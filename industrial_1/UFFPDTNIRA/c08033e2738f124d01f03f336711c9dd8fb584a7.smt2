...
(declare-const cat_227 potato_28)
...
(assert (= cat_225 (ite (not (= cat_200 true)) true false)))
(assert (= cat_225 true))
(assert (=> (= cat_226 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_227))) (and (= cat_201 (spoon_76 (fp #b0 #b10000101 #b01100111111101011101000))) (spoon_86 cat_201)))))
(assert (=> (= cat_226 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_227))) (= cat_228 (mk_potato_10 cat_224)))))
(assert (=> (= cat_226 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_227))) (= cat_229 cat_201))))
(assert (=> (= cat_226 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_227)))) (=> (fp.lt (spoon_111 (get_potato_28_a cat_227)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (and (= cat_202 (spoon_76 (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (spoon_86 cat_202))))))
(assert (=> (= cat_226 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_227)))) (=> (fp.lt (spoon_111 (get_potato_28_a cat_227)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_230 (mk_potato_10 cat_224))))))
(assert (=> (= cat_226 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_227)))) (=> (fp.lt (spoon_111 (get_potato_28_a cat_227)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_231 cat_202)))))
(assert (=> (= cat_226 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_227)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_227)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_203 (spoon_111 (get_potato_28_a cat_227))) (spoon_1 (spoon_111 (get_potato_28_a cat_227))))))))
(assert (=> (= cat_226 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_227)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_227)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_204 (spoon_76 cat_203)) (spoon_86 cat_204))))))
(assert (=> (= cat_226 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_227)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_227)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_232 (mk_potato_10 cat_224))))))
(assert (=> (= cat_226 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_227)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_227)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_233 cat_204)))))
(assert (=> (= cat_226 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_227)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_227)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_231 cat_233)))))
(assert (=> (= cat_226 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_227)))) (= cat_229 cat_231))))
(assert (=> (= cat_226 true) (= cat_234 (mk_potato_10 cat_223))))
(assert (=> (= cat_226 true) (= cat_235 (fp.mul RNE cat_170 cat_170))))
(assert (=> (= cat_226 true) (= cat_236 (mk_potato_10 cat_220))))
(assert (=> (= cat_226 true) (= cat_237 ((_ to_fp 8 24) RNE (fp.sub RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) (fp.mul RNE cat_166 cat_166))))))
(assert (=> (= cat_226 true) (= cat_238 (mk_potato_10 cat_219))))
(assert (=> (= cat_226 true) (= cat_239 (fp.sqrt RNE cat_237))))
(assert (=> (not (= cat_226 true)) (= cat_229 cat_224)))
(assert (=> (not (= cat_226 true)) (= cat_235 cat_223)))
(assert (=> (not (= cat_226 true)) (= cat_237 cat_220)))
(assert (=> (not (= cat_226 true)) (= cat_239 cat_219)))
(assert (=> (= cat_226 true) (and (= cat_205 (fp.sub RNE cat_237 cat_235)) (spoon_1 (fp.sub RNE cat_237 cat_235)))))
(assert (=> (= cat_226 true) (= cat_206 (fp.add RNE cat_205 (fp.mul RNE cat_229 cat_229)))))
(assert (=> (= cat_226 true) (and (= cat_207 cat_206) (spoon_1 cat_206))))
(assert (=> (= cat_226 true) (= cat_240 (mk_potato_10 cat_222))))
(assert (=> (= cat_226 true) (= cat_241 cat_207)))
(assert (=> (= cat_226 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_241) (= cat_242 (mk_potato_10 cat_221)))))
(assert (=> (= cat_226 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_241) (= cat_243 (fp.sqrt RNE cat_241)))))
(assert (=> (= cat_226 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_241) (= cat_245 cat_226))))
(assert (=> (= cat_226 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_241)) (= cat_244 (mk_potato_7 cat_226)))))
(assert (=> (= cat_226 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_241)) (= cat_245 (distinct 0 0)))))
(assert (=> (= cat_226 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_241)) (= cat_243 cat_221))))
(assert (=> (not (= cat_226 true)) (= cat_241 cat_222)))
(assert (=> (not (= cat_226 true)) (= cat_243 cat_221)))
(assert (=> (not (= cat_226 true)) (= cat_245 cat_226)))
(assert (= cat_245 true))
(assert (= cat_210 (fp.mul RNE cat_243 cat_170)))
(assert (spoon_1 (fp.mul RNE cat_243 cat_170)))
(assert (= cat_208 (fp.mul RNE cat_239 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_166 cat_166)) cat_235))))
(assert (spoon_1 (fp.mul RNE cat_239 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_166 cat_166)) cat_235))))
(assert (= cat_209 (fp.mul RNE cat_208 cat_229)))
(assert (= cat_211 cat_209))
(assert (spoon_1 cat_209))
(assert (= cat_212 (fp.sub RNE cat_211 cat_210)))
(assert (spoon_1 cat_212))
(assert (= cat_213 (fp.mul RNE cat_243 cat_170)))
(assert (spoon_1 (fp.mul RNE cat_243 cat_170)))
(assert (= cat_214 (fp.mul RNE cat_213 cat_229)))
(assert (= cat_215 cat_214))
(assert (spoon_1 cat_214))
(assert (= cat_216 (fp.mul RNE cat_239 cat_241)))
(assert (spoon_1 (fp.mul RNE cat_239 cat_241)))
(assert (= cat_217 (fp.sub RNE cat_216 cat_215)))
(assert (= cat_218 cat_217))
(assert (= cat_246 cat_218))
(assert (spoon_1 cat_217))
(assert (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_246))
(assert (not (spoon_1 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_246))))
(check-sat)
(exit)
