...
(assert (= cat_149 (fp.sub RNE (spoon_48 (get_potato_17_a (get_potato_19_a cat_90))) (spoon_48 (get_potato_17_a (get_potato_19_a cat_88))))))
(assert (= cat_150 (fp.sub RNE (spoon_48 (get_potato_17_b (get_potato_19_a cat_90))) (spoon_48 (get_potato_17_b (get_potato_19_a cat_88))))))
(assert (= cat_151 (fp.add RNE (fp.mul RNE cat_149 cat_149) (fp.mul RNE cat_150 cat_150))))
(assert (not (fp.lt cat_151 (fp #b0 #b01110001 #b10100011011011100010111))))
(assert (= cat_152 (fp.add RNE (fp.mul RNE (fp.sub RNE (spoon_48 (get_potato_17_a (get_potato_19_a cat_86))) (spoon_48 (get_potato_17_a (get_potato_19_a cat_88)))) cat_149) (fp.mul RNE (fp.sub RNE (spoon_48 (get_potato_17_b (get_potato_19_a cat_86))) (spoon_48 (get_potato_17_b (get_potato_19_a cat_88)))) cat_150))))
(assert (= cat_143 (fp.div RNE cat_152 cat_151)))
(assert (spoon_1 (fp.div RNE cat_152 cat_151)))
(assert (= cat_144 cat_143))
(assert (= cat_153 cat_144))
(assert (spoon_1 cat_143))
(assert (not (fp.leq cat_153 (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (not (fp.leq (fp #b0 #b01111111 #b00000000000000000000000) cat_153)))
(assert (= cat_154 (fp.add RNE (fp.mul RNE (fp.sub RNE (spoon_48 (get_potato_17_a (get_potato_19_a cat_86))) (spoon_48 (get_potato_17_a (get_potato_19_a cat_88)))) (fp.neg cat_150)) (fp.mul RNE (fp.sub RNE (spoon_48 (get_potato_17_b (get_potato_19_a cat_86))) (spoon_48 (get_potato_17_b (get_potato_19_a cat_88)))) cat_149))))
(assert (= cat_145 cat_151))
(assert (spoon_1 cat_151))
(assert (= cat_146 (spoon_23 cat_145)))
(assert (spoon_33 cat_146))
(assert (= cat_147 cat_146))
(assert (= cat_155 cat_147))
(assert (spoon_1 cat_146))
(assert (= cat_148 (fp.div RNE (fp.abs cat_154) cat_155)))
(assert (spoon_1 (fp.div RNE (fp.abs cat_154) cat_155)))
(assert (not (spoon_70 cat_148)))
(check-sat)
(exit)
