...
(declare-const cat_173 potato_22)
...
(assert (= (spoon_63 cat_154) (fp.neg (fp.mul RNE (fp #b0 #b01111111 #b00000000000000000000000) (spoon_63 (get_potato_21_b cat_174))))))
...
(assert (and (= cat_169 (spoon_83 (mk_potato_23 cat_174) (mk_potato_23 cat_174))) (and (spoon_85 cat_169) (= cat_169 (fp.add RNE (fp.mul RNE (spoon_63 (get_potato_21_a cat_174)) (spoon_63 (get_potato_21_a cat_174))) (fp.mul RNE (spoon_63 (get_potato_21_b cat_174)) (spoon_63 (get_potato_21_b cat_174))))))))
(assert (= cat_181 (mk_potato_10 cat_143)))
(assert (= cat_182 cat_169))
(assert (and (= cat_170 (spoon_83 (mk_potato_23 cat_178) (mk_potato_23 cat_176))) (and (spoon_85 cat_170) (= cat_170 (fp.add RNE (fp.mul RNE (spoon_63 (get_potato_21_a cat_178)) (spoon_63 (get_potato_21_a cat_176))) (fp.mul RNE (spoon_63 (get_potato_21_b cat_178)) (spoon_63 (get_potato_21_b cat_176))))))))
(assert (and (= cat_171 (spoon_83 (mk_potato_23 cat_180) (mk_potato_23 cat_176))) (and (spoon_85 cat_171) (= cat_171 (fp.add RNE (fp.mul RNE (spoon_63 (get_potato_21_a cat_180)) (spoon_63 (get_potato_21_a cat_176))) (fp.mul RNE (spoon_63 (get_potato_21_b cat_180)) (spoon_63 (get_potato_21_b cat_176))))))))
(assert (= cat_172 (fp.sub RNE cat_171 cat_170)))
(assert (= cat_183 (mk_potato_10 cat_145)))
(assert (= cat_184 cat_172))
(assert (not (spoon_101 (fp.sqrt RNE cat_182))))
(check-sat)
(exit)
