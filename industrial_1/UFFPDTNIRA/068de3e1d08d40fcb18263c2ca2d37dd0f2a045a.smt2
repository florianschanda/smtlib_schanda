...
(assert (= cat_268 (mk_potato_7 cat_203)))
(assert (= cat_269 (spoon_37 1)))
(assert (= cat_270 (mk_potato_25 (mk_potato_24 cat_201 cat_202))))
(assert (= cat_271 (get_potato_26_a cat_111)))
(assert (= cat_225 (spoon_113 cat_167 cat_74)))
(assert (= cat_272 (ite (not (= cat_225 true)) true false)))
(assert (= cat_272 true))
(assert (=> (= cat_273 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_274))) (and (= cat_226 (spoon_149 (fp #b0 #b10000101 #b01100111111101011101000))) (spoon_129 cat_226)))))
(assert (=> (= cat_273 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_274))) (= cat_275 (mk_potato_10 cat_267)))))
(assert (=> (= cat_273 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_274))) (= cat_276 cat_226))))
(assert (=> (= cat_273 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_274)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_274)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (and (= cat_227 (spoon_149 (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (spoon_129 cat_227))))))
(assert (=> (= cat_273 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_274)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_274)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_277 (mk_potato_10 cat_267))))))
(assert (=> (= cat_273 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_274)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_274)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_278 cat_227)))))
(assert (=> (= cat_273 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_274)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_274)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_228 (spoon_84 (get_potato_24_a cat_274))) (spoon_1 (spoon_84 (get_potato_24_a cat_274))))))))
(assert (=> (= cat_273 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_274)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_274)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_229 (spoon_149 cat_228)) (spoon_129 cat_229))))))
(assert (=> (= cat_273 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_274)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_274)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_279 (mk_potato_10 cat_267))))))
(assert (=> (= cat_273 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_274)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_274)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_280 cat_229)))))
(assert (=> (= cat_273 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_274)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_274)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_278 cat_280)))))
(assert (=> (= cat_273 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_274)))) (= cat_276 cat_278))))
(assert (=> (= cat_273 true) (=> (spoon_189 cat_175) (and (= cat_230 (fp.mul RNE cat_175 cat_175)) (spoon_1 (fp.mul RNE cat_175 cat_175))))))
(assert (=> (= cat_273 true) (=> (spoon_189 cat_175) (= cat_281 (mk_potato_10 cat_265)))))
(assert (=> (= cat_273 true) (=> (spoon_189 cat_175) (= cat_282 cat_230))))
(assert (=> (= cat_273 true) (=> (spoon_189 cat_175) (= cat_284 cat_273))))
(assert (=> (= cat_273 true) (=> (not (spoon_189 cat_175)) (= cat_283 (mk_potato_7 cat_273)))))
(assert (=> (= cat_273 true) (=> (not (spoon_189 cat_175)) (= cat_284 (spoon_37 0)))))
(assert (=> (= cat_273 true) (=> (not (spoon_189 cat_175)) (= cat_282 cat_265))))
(assert (=> (= cat_273 true) (= cat_285 (mk_potato_10 cat_259))))
(assert (=> (= cat_273 true) (= cat_286 ((_ to_fp 8 24) RNE (fp.sub RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) (fp.mul RNE cat_171 cat_171))))))
(assert (=> (= cat_273 true) (and (= cat_231 cat_286) (spoon_1 cat_286))))
(assert (=> (= cat_273 true) (and (= cat_232 (spoon_146 cat_231)) (spoon_138 cat_232))))
(assert (=> (= cat_273 true) (= cat_287 (mk_potato_10 cat_257))))
(assert (=> (= cat_273 true) (= cat_288 cat_232)))
...
(assert (=> (= cat_284 true) (and (= cat_233 (fp.sub RNE cat_286 cat_282)) (spoon_1 (fp.sub RNE cat_286 cat_282)))))
(assert (=> (= cat_284 true) (= cat_234 (fp.add RNE cat_233 (fp.mul RNE cat_276 cat_276)))))
(assert (=> (= cat_284 true) (and (= cat_235 cat_234) (spoon_1 cat_234))))
(assert (=> (= cat_284 true) (= cat_289 (mk_potato_10 cat_263))))
(assert (=> (= cat_284 true) (= cat_290 cat_235)))
(assert (=> (= cat_284 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_290) (and (= cat_236 cat_290) (spoon_1 cat_290)))))
(assert (=> (= cat_284 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_290) (and (= cat_237 (spoon_146 cat_236)) (spoon_138 cat_237)))))
(assert (=> (= cat_284 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_290) (= cat_291 (mk_potato_10 cat_261)))))
(assert (=> (= cat_284 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_290) (= cat_292 cat_237))))
...
(assert (=> (= cat_284 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_290)) (= cat_294 (spoon_37 0)))))
...
(assert (= cat_294 true))
(assert (and (= cat_242 (fp.mul RNE cat_292 cat_175)) (spoon_1 (fp.mul RNE cat_292 cat_175))))
(assert (and (= cat_238 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_171 cat_171)) cat_282)) (spoon_1 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_171 cat_171)) cat_282))))
(assert (= cat_239 (fp.mul RNE cat_288 cat_238)))
(assert (and (= cat_240 cat_239) (spoon_1 cat_239)))
(assert (= cat_241 (fp.mul RNE cat_240 cat_276)))
...
(assert (= cat_295 (mk_potato_10 cat_211)))
(assert (= cat_296 cat_245))
(assert (and (= cat_246 (fp.mul RNE cat_292 cat_175)) (spoon_1 (fp.mul RNE cat_292 cat_175))))
(assert (= cat_247 (fp.mul RNE cat_246 cat_276)))
(assert (and (= cat_248 cat_247) (spoon_1 cat_247)))
(assert (and (= cat_249 (fp.mul RNE cat_288 cat_290)) (spoon_1 (fp.mul RNE cat_288 cat_290))))
(assert (= cat_250 (fp.sub RNE cat_249 cat_248)))
(assert (and (= cat_251 cat_250) (spoon_1 cat_250)))
(assert (= cat_297 (mk_potato_10 cat_212)))
(assert (= cat_298 cat_251))
(assert (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_298))
(assert (and (= cat_253 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_298)) (spoon_1 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_298))))
(assert (and (= cat_254 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_296)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_296))))
(assert (= cat_255 (ite (fp.leq cat_254 cat_253) true false)))
(assert (and (= cat_252 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_296)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_296))))
(assert (not (spoon_1 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_298))))
(check-sat)
(exit)
