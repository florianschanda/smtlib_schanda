...
(declare-const cat_228 potato_19)
(declare-const cat_229 potato_18)
...
(assert (= cat_227 (spoon_37 1)))
(assert (= cat_228 (mk_potato_19 (mk_potato_18 cat_201 cat_202))))
(assert (= cat_229 (get_potato_20_a cat_85)))
(assert (= cat_230 (mk_potato_11 cat_206)))
(assert (= cat_231 (fp.mul RNE cat_181 cat_181)))
(assert (not (spoon_159 ((_ to_fp 11 53) RNE (fp.mul RNE cat_177 cat_177)))))
(check-sat)
(exit)
