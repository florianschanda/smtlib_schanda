...
(declare-const cat_230 potato_7)
(declare-const cat_231 Bool)
(declare-const cat_232 potato_19)
(declare-const cat_233 potato_18)
...
(assert (= cat_230 (mk_potato_7 cat_207)))
(assert (= cat_231 (spoon_41 1)))
(assert (= cat_232 (mk_potato_19 (mk_potato_18 cat_205 cat_206))))
(assert (= cat_233 (get_potato_20_a cat_89)))
(assert (= cat_234 (mk_potato_11 cat_210)))
(assert (= cat_235 (fp.mul RNE cat_185 cat_185)))
(assert (not (spoon_163 ((_ to_fp 11 53) RNE (fp.mul RNE cat_181 cat_181)))))
(check-sat)
(exit)
