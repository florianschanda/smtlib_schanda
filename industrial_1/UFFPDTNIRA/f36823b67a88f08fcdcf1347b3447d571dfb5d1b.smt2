...
(assert (= cat_149 cat_145))
(assert (= cat_150 ((_ to_fp 8 24) roundNearestTiesToEven (fp.mul roundNearestTiesToEven cat_129 cat_129))))
(assert (= cat_146 (fp.mul roundNearestTiesToEven cat_150 cat_149)))
(assert (spoon_1 (fp.mul roundNearestTiesToEven cat_150 cat_149)))
(assert (spoon_1 cat_146))
(assert (= cat_147 (fp.mul roundNearestTiesToEven cat_150 (fp.mul roundNearestTiesToEven cat_149 cat_149))))
(assert (spoon_1 (fp.mul roundNearestTiesToEven cat_150 (fp.mul roundNearestTiesToEven cat_149 cat_149))))
(assert (= cat_148 (fp.sub roundNearestTiesToEven (fp (_ bv0 1) (_ bv127 8) (_ bv0 23)) cat_147)))
(assert (not (spoon_1 cat_148)))
(check-sat)
(exit)
