...
(assert (= cat_150 ((_ to_fp 8 24) RNE (fp.mul RNE cat_129 cat_129))))
(assert (= cat_146 (fp.mul RNE cat_150 cat_149)))
(assert (spoon_1 (fp.mul RNE cat_150 cat_149)))
(assert (spoon_1 cat_146))
(assert (= cat_147 (fp.mul RNE cat_150 (fp.mul RNE cat_149 cat_149))))
(assert (spoon_1 (fp.mul RNE cat_150 (fp.mul RNE cat_149 cat_149))))
