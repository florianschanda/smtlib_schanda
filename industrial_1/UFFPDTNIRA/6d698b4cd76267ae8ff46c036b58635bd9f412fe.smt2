...
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_248 cat_252))) (and (= cat_209 _let_0) (spoon_3 _let_0))))
(assert (= cat_210 (fp.mul roundNearestTiesToEven cat_209 cat_256)))
(assert (and (= cat_211 cat_210) (spoon_3 cat_210)))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_246 cat_250))) (and (= cat_207 _let_0) (spoon_3 _let_0))))
...
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1024 11) (_ bv0 52)) cat_156) cat_254))) (and (= cat_215 _let_0) (spoon_3 _let_0))))
(assert (= cat_216 (fp.mul roundNearestTiesToEven cat_215 cat_248)))
(assert (and (= cat_217 cat_216) (spoon_3 cat_216)))
(assert (= cat_259 (mk_potato_11 cat_189)))
(assert (= cat_260 cat_217))
(assert (let ((_let_0 (fp.div roundNearestTiesToEven cat_260 cat_258))) (=> (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_258) (and (= cat_218 _let_0) (spoon_3 _let_0)))))
(assert (=> (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_258) (= cat_261 spoon_278)))
(assert (=> (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_258) (= cat_262 cat_218)))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv2046 11) (_ bv4503599627370495 52)) cat_258))) (=> (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_258)) (=> (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_258) (and (= cat_224 _let_0) (spoon_3 _let_0))))))
(assert (=> (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_258)) (=> (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_258) (= cat_225 (ite (fp.leq cat_260 cat_224) true false)))))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp.neg (fp (_ bv0 1) (_ bv2046 11) (_ bv4503599627370495 52))) cat_258))) (=> (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_258)) (=> (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_258) (and (= cat_223 _let_0) (spoon_3 _let_0))))))
(assert (=> (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_258)) (=> (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_258) (= cat_226 (ite (fp.leq cat_223 cat_260) true false)))))
(assert (=> (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_258)) (=> (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_258) (= cat_264 (ite (= cat_226 true) cat_225 false)))))
(assert (=> (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_258)) (=> (not (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_258)) (= cat_264 false))))
(assert (=> (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_258)) (=> (= cat_264 true) (= cat_263 true))))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp.neg (fp (_ bv0 1) (_ bv2046 11) (_ bv4503599627370495 52))) cat_258))) (=> (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_258)) (=> (not (= cat_264 true)) (=> (fp.lt cat_258 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52))) (and (= cat_220 _let_0) (spoon_3 _let_0)))))))
(assert (=> (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_258)) (=> (not (= cat_264 true)) (=> (fp.lt cat_258 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52))) (= cat_221 (ite (fp.leq cat_260 cat_220) true false))))))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv2046 11) (_ bv4503599627370495 52)) cat_258))) (=> (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_258)) (=> (not (= cat_264 true)) (=> (fp.lt cat_258 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52))) (and (= cat_219 _let_0) (spoon_3 _let_0)))))))
(assert (=> (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_258)) (=> (not (= cat_264 true)) (=> (fp.lt cat_258 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52))) (= cat_222 (ite (fp.leq cat_219 cat_260) true false))))))
(assert (=> (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_258)) (=> (not (= cat_264 true)) (=> (fp.lt cat_258 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52))) (= cat_263 (ite (= cat_222 true) cat_221 false))))))
(assert (=> (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_258)) (=> (not (= cat_264 true)) (=> (not (fp.lt cat_258 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)))) (= cat_263 false)))))
(assert (let ((_let_0 (fp.div roundNearestTiesToEven cat_260 cat_258))) (=> (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_258)) (=> (= cat_263 true) (and (= cat_227 _let_0) (spoon_3 _let_0))))))
(assert (=> (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_258)) (=> (= cat_263 true) (= cat_265 spoon_278))))
(assert (=> (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_258)) (=> (= cat_263 true) (= cat_266 cat_227))))
(assert (=> (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_258)) (=> (not (= cat_263 true)) (=> (fp.lt cat_260 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52))) (= cat_267 spoon_278)))))
(assert (=> (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_258)) (=> (not (= cat_263 true)) (=> (fp.lt cat_260 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52))) (= cat_268 (fp.neg (fp (_ bv0 1) (_ bv2046 11) (_ bv4503599627370495 52))))))))
(assert (=> (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_258)) (=> (not (= cat_263 true)) (=> (not (fp.lt cat_260 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)))) (= cat_269 spoon_278)))))
(assert (=> (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_258)) (=> (not (= cat_263 true)) (=> (not (fp.lt cat_260 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)))) (= cat_270 (fp (_ bv0 1) (_ bv2046 11) (_ bv4503599627370495 52)))))))
(assert (=> (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_258)) (=> (not (= cat_263 true)) (=> (not (fp.lt cat_260 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)))) (= cat_268 cat_270)))))
(assert (=> (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_258)) (=> (not (= cat_263 true)) (= cat_266 cat_268))))
(assert (=> (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_258)) (= cat_262 cat_266)))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_246 cat_252))) (and (= cat_228 _let_0) (spoon_3 _let_0))))
(assert (= cat_271 (mk_potato_11 cat_186)))
(assert (= cat_272 cat_228))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_248 cat_250))) (and (= cat_229 _let_0) (spoon_3 _let_0))))
(assert (= cat_230 (fp.mul roundNearestTiesToEven cat_229 cat_256)))
(assert (and (= cat_231 cat_230) (spoon_3 cat_230)))
(assert (= cat_273 (mk_potato_11 cat_187)))
(assert (= cat_274 cat_231))
(assert (let ((_let_0 (fp.sub roundNearestTiesToEven cat_272 cat_274))) (and (= cat_232 _let_0) (spoon_3 _let_0))))
...
(assert (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_258)))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv2046 11) (_ bv4503599627370495 52)) cat_258))) (=> (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_258) (and (= cat_236 _let_0) (spoon_3 _let_0)))))
(assert (=> (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_258) (= cat_237 (ite (fp.leq cat_276 cat_236) true false))))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp.neg (fp (_ bv0 1) (_ bv2046 11) (_ bv4503599627370495 52))) cat_258))) (=> (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_258) (and (= cat_235 _let_0) (spoon_3 _let_0)))))
(assert (=> (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_258) (= cat_238 (ite (fp.leq cat_235 cat_276) true false))))
(assert (=> (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_258) (= cat_277 (ite (= cat_238 true) cat_237 false))))
(assert (=> (not (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_258)) (= cat_277 false)))
(assert (not (= cat_277 true)))
(assert (fp.lt cat_258 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52))))
(assert (not (spoon_3 (fp.mul roundNearestTiesToEven (fp.neg (fp (_ bv0 1) (_ bv2046 11) (_ bv4503599627370495 52))) cat_258))))
(check-sat)
(exit)
