...
(declare-const cat_273 potato_29)
(declare-const cat_274 potato_28)
...
(assert (and (= cat_226 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_276)) (spoon_3 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_276))))
...
(assert (and (= cat_237 (fp.mul RNE cat_282 ((_ to_fp 11 53) RNE cat_179))) (spoon_3 (fp.mul RNE cat_282 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_238 (fp.mul RNE cat_237 cat_288)))
(assert (and (= cat_239 cat_238) (spoon_3 cat_238)))
(assert (and (= cat_233 (fp.sub RNE cat_284 cat_278)) (spoon_3 (fp.sub RNE cat_284 cat_278))))
...
(assert (and (= cat_243 (fp.add RNE cat_284 cat_278)) (spoon_3 (fp.add RNE cat_284 cat_278))))
...
(assert (and (= cat_246 (fp.div RNE cat_290 cat_292)) (spoon_3 (fp.div RNE cat_290 cat_292))))
...
(assert (=> (not (fp.lt cat_294 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_294)) (and (= cat_247 cat_294) (spoon_3 cat_294)))))
...
(assert (and (= cat_248 (fp.mul RNE cat_282 ((_ to_fp 11 53) RNE cat_177))) (spoon_3 (fp.mul RNE cat_282 ((_ to_fp 11 53) RNE cat_177)))))
(assert (= cat_301 (mk_potato_11 cat_216)))
(assert (= cat_302 cat_248))
(assert (and (= cat_253 (fp.mul RNE cat_282 ((_ to_fp 11 53) RNE cat_179))) (spoon_3 (fp.mul RNE cat_282 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_254 (fp.mul RNE cat_253 cat_286)))
(assert (and (= cat_255 cat_254) (spoon_3 cat_254)))
(assert (and (= cat_249 (fp.sub RNE cat_284 cat_278)) (spoon_3 (fp.sub RNE cat_284 cat_278))))
...
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_304) (and (= cat_264 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_304)) (spoon_3 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_304)))))
...
(assert (= cat_305 true))
(assert (and (= cat_267 (fp.div RNE cat_302 cat_304)) (spoon_3 (fp.div RNE cat_302 cat_304))))
