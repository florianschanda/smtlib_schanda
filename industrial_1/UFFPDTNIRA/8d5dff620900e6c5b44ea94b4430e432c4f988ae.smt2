...
(assert (not (fp.lt cat_94 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))))
(assert (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_94))
(assert (= cat_94 cat_99))
(assert (= cat_100 (fp #b0 #b10001011 #b00000000000000000000000)))
