...
(assert (= cat_253 (mk_potato_25 (mk_potato_24 cat_201 cat_202))))
(assert (= cat_254 (get_potato_26_a cat_111)))
(assert (= cat_225 (spoon_113 cat_167 cat_74)))
(assert (= cat_255 (ite (not (= cat_225 true)) true false)))
(assert (= cat_255 true))
(assert (=> (= cat_256 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_257))) (and (= cat_226 (spoon_149 (fp #b0 #b10000101 #b01100111111101011101000))) (spoon_129 cat_226)))))
(assert (=> (= cat_256 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_257))) (= cat_258 (mk_potato_10 cat_250)))))
(assert (=> (= cat_256 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_257))) (= cat_259 cat_226))))
(assert (=> (= cat_256 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_257)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_257)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (and (= cat_227 (spoon_149 (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (spoon_129 cat_227))))))
(assert (=> (= cat_256 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_257)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_257)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_260 (mk_potato_10 cat_250))))))
(assert (=> (= cat_256 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_257)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_257)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_261 cat_227)))))
(assert (=> (= cat_256 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_257)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_257)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_228 (spoon_84 (get_potato_24_a cat_257))) (spoon_1 (spoon_84 (get_potato_24_a cat_257))))))))
(assert (=> (= cat_256 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_257)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_257)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_229 (spoon_149 cat_228)) (spoon_129 cat_229))))))
(assert (=> (= cat_256 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_257)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_257)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_262 (mk_potato_10 cat_250))))))
(assert (=> (= cat_256 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_257)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_257)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_263 cat_229)))))
(assert (=> (= cat_256 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_257)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_257)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_261 cat_263)))))
(assert (=> (= cat_256 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_257)))) (= cat_259 cat_261))))
(assert (=> (= cat_256 true) (=> (spoon_189 cat_175) (and (= cat_230 (fp.mul RNE cat_175 cat_175)) (spoon_1 (fp.mul RNE cat_175 cat_175))))))
(assert (=> (= cat_256 true) (=> (spoon_189 cat_175) (= cat_264 (mk_potato_10 cat_248)))))
(assert (=> (= cat_256 true) (=> (spoon_189 cat_175) (= cat_265 cat_230))))
(assert (=> (= cat_256 true) (=> (spoon_189 cat_175) (= cat_267 cat_256))))
(assert (=> (= cat_256 true) (=> (not (spoon_189 cat_175)) (= cat_266 (mk_potato_7 cat_256)))))
(assert (=> (= cat_256 true) (=> (not (spoon_189 cat_175)) (= cat_267 (spoon_37 0)))))
(assert (=> (= cat_256 true) (=> (not (spoon_189 cat_175)) (= cat_265 cat_248))))
(assert (=> (= cat_256 true) (= cat_268 (mk_potato_10 cat_242))))
(assert (=> (= cat_256 true) (= cat_269 ((_ to_fp 8 24) RNE (fp.sub RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) (fp.mul RNE cat_171 cat_171))))))
(assert (=> (= cat_256 true) (and (= cat_231 cat_269) (spoon_1 cat_269))))
(assert (=> (= cat_256 true) (and (= cat_232 (spoon_146 cat_231)) (spoon_138 cat_232))))
(assert (=> (= cat_256 true) (= cat_270 (mk_potato_10 cat_240))))
(assert (=> (= cat_256 true) (= cat_271 cat_232)))
...
(assert (=> (= cat_267 true) (and (= cat_233 (fp.sub RNE cat_269 cat_265)) (spoon_1 (fp.sub RNE cat_269 cat_265)))))
(assert (=> (= cat_267 true) (= cat_234 (fp.add RNE cat_233 (fp.mul RNE cat_259 cat_259)))))
(assert (=> (= cat_267 true) (and (= cat_235 cat_234) (spoon_1 cat_234))))
(assert (=> (= cat_267 true) (= cat_272 (mk_potato_10 cat_246))))
(assert (=> (= cat_267 true) (= cat_273 cat_235)))
(assert (=> (= cat_267 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_273) (and (= cat_236 cat_273) (spoon_1 cat_273)))))
(assert (=> (= cat_267 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_273) (and (= cat_237 (spoon_146 cat_236)) (spoon_138 cat_237)))))
(assert (=> (= cat_267 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_273) (= cat_274 (mk_potato_10 cat_244)))))
(assert (=> (= cat_267 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_273) (= cat_275 cat_237))))
(assert (=> (= cat_267 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_273) (= cat_277 cat_267))))
(assert (=> (= cat_267 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_273)) (= cat_276 (mk_potato_7 cat_267)))))
(assert (=> (= cat_267 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_273)) (= cat_277 (spoon_37 0)))))
(assert (=> (= cat_267 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_273)) (= cat_275 cat_244))))
(assert (=> (not (= cat_267 true)) (= cat_273 cat_246)))
(assert (=> (not (= cat_267 true)) (= cat_275 cat_244)))
(assert (=> (not (= cat_267 true)) (= cat_277 cat_267)))
(assert (= cat_277 true))
(assert (and (= cat_238 (fp.mul RNE cat_275 cat_175)) (spoon_1 (fp.mul RNE cat_275 cat_175))))
(assert (not (spoon_1 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_171 cat_171)) cat_265))))
(check-sat)
(exit)
