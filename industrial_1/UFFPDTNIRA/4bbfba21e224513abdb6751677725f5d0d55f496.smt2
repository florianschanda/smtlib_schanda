...
(assert (and (= cat_122 (fp.div RNE (spoon_77 cat_113) cat_114)) (spoon_1 (fp.div RNE (spoon_77 cat_113) cat_114))))
(assert (= cat_123 (fp.mul RNE cat_122 cat_115)))
(assert (and (= cat_124 cat_123) (spoon_1 cat_123)))
(assert (and (= cat_125 cat_124) (spoon_1 cat_124)))
(assert (= (spoon_77 cat_126) cat_125))
(assert (and (= cat_118 (fp.div RNE (spoon_77 cat_112) cat_114)) (spoon_1 (fp.div RNE (spoon_77 cat_112) cat_114))))
(assert (= cat_119 (fp.mul RNE cat_118 cat_115)))
...
(assert (= cat_132 cat_116))
(assert (= cat_133 cat_117))
(assert (= cat_134 (mk_potato_23 cat_130 cat_131)))
(assert (not (spoon_37 (fp.add RNE (spoon_44 (get_potato_15_b (get_potato_17_a cat_81))) (spoon_77 (get_potato_23_b cat_134))))))
(check-sat)
(exit)
