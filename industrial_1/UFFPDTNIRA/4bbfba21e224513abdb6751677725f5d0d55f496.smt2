...
(assert (and (= cat_122 (fp.div RNE (spoon_77 cat_112) cat_116)) (spoon_1 (fp.div RNE (spoon_77 cat_112) cat_116))))
(assert (= cat_123 (fp.mul RNE cat_122 cat_117)))
(assert (and (= cat_124 cat_123) (spoon_1 cat_123)))
(assert (and (= cat_125 cat_124) (spoon_1 cat_124)))
(assert (= (spoon_77 cat_131) cat_125))
(assert (= cat_131 cat_132))
(assert (= cat_130 cat_133))
(assert (= cat_134 cat_132))
(assert (= cat_135 cat_133))
(assert (= cat_156 cat_118))
(assert (= cat_157 cat_119))
(assert (= cat_158 (mk_potato_23 cat_134 cat_135)))
(assert (not (spoon_37 (fp.add RNE (spoon_44 (get_potato_15_b (get_potato_17_a cat_81))) (spoon_77 (get_potato_23_b cat_158))))))
(check-sat)
(exit)
