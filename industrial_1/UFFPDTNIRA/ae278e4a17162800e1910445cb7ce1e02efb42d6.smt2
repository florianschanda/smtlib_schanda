...
(assert (= (mk_potato_11 cat_146) (mk_potato_11 cat_128)))
(assert (= cat_147 cat_141))
...
(assert (= (mk_potato_11 cat_148) (mk_potato_11 cat_129)))
(assert (= cat_149 cat_145))
(assert (not (spoon_3 (fp.mul RNE cat_147 (fp #b0 #b10000000100 #b1100101001011101110000001101000000111100111100100110)))))
(check-sat)
(exit)
