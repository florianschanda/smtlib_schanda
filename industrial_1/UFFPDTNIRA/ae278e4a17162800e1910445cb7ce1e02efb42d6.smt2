...
(assert (= (mk_potato_11 cat_142) (mk_potato_11 cat_124)))
(assert (= cat_143 cat_137))
...
(assert (= (mk_potato_11 cat_144) (mk_potato_11 cat_125)))
(assert (= cat_145 cat_141))
(assert (not (spoon_2 (fp.mul RNE cat_143 (fp #b0 #b10000000100 #b1100101001011101110000001101000000111100111100100110)))))
(check-sat)
(exit)
