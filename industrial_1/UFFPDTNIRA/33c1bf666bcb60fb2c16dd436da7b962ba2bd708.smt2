...
(assert (= cat_270 (spoon_37 1)))
(assert (= cat_271 (mk_potato_19 (mk_potato_18 cat_201 cat_202))))
(assert (= cat_272 (get_potato_20_a cat_85)))
...
(assert (and (= cat_226 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_274)) (spoon_2 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_274))))
...
(assert (and (= cat_237 (fp.mul RNE cat_280 ((_ to_fp 11 53) RNE cat_179))) (spoon_2 (fp.mul RNE cat_280 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_238 (fp.mul RNE cat_237 cat_286)))
(assert (and (= cat_239 cat_238) (spoon_2 cat_238)))
(assert (and (= cat_233 (fp.sub RNE cat_282 cat_276)) (spoon_2 (fp.sub RNE cat_282 cat_276))))
...
(assert (and (= cat_243 (fp.add RNE cat_282 cat_276)) (spoon_2 (fp.add RNE cat_282 cat_276))))
...
(assert (and (= cat_246 (fp.div RNE cat_288 cat_290)) (spoon_2 (fp.div RNE cat_288 cat_290))))
...
(assert (=> (not (fp.lt cat_292 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_292)) (and (= cat_247 cat_292) (spoon_2 cat_292)))))
...
(assert (and (= cat_248 (fp.mul RNE cat_280 ((_ to_fp 11 53) RNE cat_177))) (spoon_2 (fp.mul RNE cat_280 ((_ to_fp 11 53) RNE cat_177)))))
(assert (= cat_299 (mk_potato_11 cat_216)))
(assert (= cat_300 cat_248))
(assert (and (= cat_253 (fp.mul RNE cat_280 ((_ to_fp 11 53) RNE cat_179))) (spoon_2 (fp.mul RNE cat_280 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_254 (fp.mul RNE cat_253 cat_284)))
(assert (and (= cat_255 cat_254) (spoon_2 cat_254)))
(assert (and (= cat_249 (fp.sub RNE cat_282 cat_276)) (spoon_2 (fp.sub RNE cat_282 cat_276))))
...
(assert (= cat_303 true))
(assert (not (spoon_2 (fp.div RNE cat_300 cat_302))))
(check-sat)
(exit)
