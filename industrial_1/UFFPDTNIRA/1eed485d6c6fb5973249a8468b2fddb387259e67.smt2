...
(declare-const cat_169 potato_28)
...
(assert (= cat_169 (mk_potato_28 (mk_potato_27 cat_137 cat_138))))
(assert (= cat_170 (mk_potato_27 cat_148 cat_149)))
(assert (= (spoon_77 cat_150) (fp.neg (fp.mul RNE (fp #b0 #b01111111 #b00000000000000000000000) (spoon_77 (get_potato_27_b cat_170))))))
(assert (= cat_150 cat_151))
(assert (= (get_potato_27_a cat_170) cat_152))
(assert (= cat_153 cat_151))
(assert (= cat_154 cat_152))
(assert (= cat_171 (mk_potato_28 (mk_potato_27 cat_135 cat_136))))
(assert (= cat_172 (mk_potato_27 cat_153 cat_154)))
...
(assert (= cat_173 (mk_potato_28 (mk_potato_27 cat_131 cat_132))))
(assert (= cat_174 (mk_potato_27 cat_159 cat_160)))
...
(assert (= cat_176 (get_potato_29_a cat_164)))
(assert (and (= cat_165 (spoon_117 (mk_potato_29 cat_170) (mk_potato_29 cat_170))) (and (spoon_109 cat_165) (= cat_165 (fp.add RNE (fp.mul RNE (spoon_77 (get_potato_27_a cat_170)) (spoon_77 (get_potato_27_a cat_170))) (fp.mul RNE (spoon_77 (get_potato_27_b cat_170)) (spoon_77 (get_potato_27_b cat_170))))))))
(assert (= cat_177 (mk_potato_10 cat_139)))
(assert (= cat_178 cat_165))
(assert (and (= cat_166 (spoon_117 (mk_potato_29 cat_174) (mk_potato_29 cat_172))) (and (spoon_109 cat_166) (= cat_166 (fp.add RNE (fp.mul RNE (spoon_77 (get_potato_27_a cat_174)) (spoon_77 (get_potato_27_a cat_172))) (fp.mul RNE (spoon_77 (get_potato_27_b cat_174)) (spoon_77 (get_potato_27_b cat_172))))))))
(assert (and (= cat_167 (spoon_117 (mk_potato_29 cat_176) (mk_potato_29 cat_172))) (and (spoon_109 cat_167) (= cat_167 (fp.add RNE (fp.mul RNE (spoon_77 (get_potato_27_a cat_176)) (spoon_77 (get_potato_27_a cat_172))) (fp.mul RNE (spoon_77 (get_potato_27_b cat_176)) (spoon_77 (get_potato_27_b cat_172))))))))
(assert (= cat_168 (fp.sub RNE cat_167 cat_166)))
(assert (= cat_179 (mk_potato_10 cat_141)))
(assert (= cat_180 cat_168))
(assert (not (spoon_62 (fp.sqrt RNE cat_178))))
(check-sat)
(exit)
