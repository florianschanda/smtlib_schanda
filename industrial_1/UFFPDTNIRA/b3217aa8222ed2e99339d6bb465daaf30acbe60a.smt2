...
(declare-const cat_242 potato_19)
(declare-const cat_243 potato_18)
...
(assert (= cat_240 (mk_potato_7 cat_203)))
(assert (= cat_241 (spoon_37 1)))
(assert (= cat_242 (mk_potato_19 (mk_potato_18 cat_201 cat_202))))
(assert (= cat_243 (get_potato_20_a cat_85)))
(assert (= cat_244 (mk_potato_11 cat_206)))
(assert (= cat_245 (fp.mul RNE cat_181 cat_181)))
(assert (and (= cat_224 ((_ to_fp 11 53) RNE (fp.mul RNE cat_177 cat_177))) (spoon_2 ((_ to_fp 11 53) RNE (fp.mul RNE cat_177 cat_177)))))
(assert (= cat_246 (mk_potato_11 cat_204)))
(assert (= cat_247 cat_224))
(assert (and (= cat_225 ((_ to_fp 11 53) RNE (fp.mul RNE cat_179 cat_179))) (spoon_2 ((_ to_fp 11 53) RNE (fp.mul RNE cat_179 cat_179)))))
(assert (= cat_248 (mk_potato_11 cat_205)))
(assert (= cat_249 cat_225))
(assert (= cat_250 (mk_potato_11 cat_207)))
(assert (= cat_251 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_181)))
(assert (and (= cat_226 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_245)) (spoon_2 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_245))))
(assert (= cat_252 (mk_potato_11 cat_208)))
(assert (= cat_253 cat_226))
...
(assert (= cat_254 (mk_potato_11 cat_209)))
(assert (= cat_255 cat_229))
...
(assert (= cat_256 (mk_potato_11 cat_210)))
(assert (= cat_257 cat_232))
(assert (and (= cat_235 (fp.mul RNE cat_251 ((_ to_fp 11 53) RNE cat_179))) (spoon_2 (fp.mul RNE cat_251 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_236 (fp.mul RNE cat_235 cat_257)))
(assert (and (= cat_237 cat_236) (spoon_2 cat_236)))
(assert (and (= cat_233 (fp.sub RNE cat_253 cat_247)) (spoon_2 (fp.sub RNE cat_253 cat_247))))
(assert (= cat_234 (fp.sub RNE cat_233 cat_249)))
(assert (not (spoon_2 cat_234)))
(check-sat)
(exit)
