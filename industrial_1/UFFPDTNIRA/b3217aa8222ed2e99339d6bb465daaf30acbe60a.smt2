...
(assert (and (= cat_230 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_249)) (spoon_2 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_249))))
...
(assert (and (= cat_239 (fp.mul RNE cat_255 ((_ to_fp 11 53) RNE cat_183))) (spoon_2 (fp.mul RNE cat_255 ((_ to_fp 11 53) RNE cat_183)))))
(assert (= cat_240 (fp.mul RNE cat_239 cat_261)))
(assert (and (= cat_241 cat_240) (spoon_2 cat_240)))
(assert (and (= cat_237 (fp.sub RNE cat_257 cat_251)) (spoon_2 (fp.sub RNE cat_257 cat_251))))
(assert (= cat_238 (fp.sub RNE cat_237 cat_253)))
(assert (not (spoon_2 cat_238)))
(check-sat)
(exit)
