...
(declare-const cat_244 potato_7)
(declare-const cat_245 Bool)
(declare-const cat_246 potato_19)
(declare-const cat_247 potato_18)
(declare-const cat_248 potato_11)
(declare-const cat_249 Float64)
(declare-const cat_250 potato_11)
...
(assert (= cat_244 (mk_potato_7 cat_207)))
(assert (= cat_245 (spoon_41 1)))
(assert (= cat_246 (mk_potato_19 (mk_potato_18 cat_205 cat_206))))
(assert (= cat_247 (get_potato_20_a cat_89)))
(assert (= cat_248 (mk_potato_11 cat_210)))
(assert (= cat_249 (fp.mul RNE cat_185 cat_185)))
(assert (and (= cat_228 ((_ to_fp 11 53) RNE (fp.mul RNE cat_181 cat_181))) (spoon_3 ((_ to_fp 11 53) RNE (fp.mul RNE cat_181 cat_181)))))
(assert (= cat_250 (mk_potato_11 cat_208)))
(assert (= cat_251 cat_228))
(assert (and (= cat_229 ((_ to_fp 11 53) RNE (fp.mul RNE cat_183 cat_183))) (spoon_3 ((_ to_fp 11 53) RNE (fp.mul RNE cat_183 cat_183)))))
(assert (= cat_252 (mk_potato_11 cat_209)))
(assert (= cat_253 cat_229))
(assert (= cat_254 (mk_potato_11 cat_211)))
(assert (= cat_255 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_185)))
(assert (and (= cat_230 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_249)) (spoon_3 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_249))))
(assert (= cat_256 (mk_potato_11 cat_212)))
(assert (= cat_257 cat_230))
...
(assert (= cat_258 (mk_potato_11 cat_213)))
(assert (= cat_259 cat_233))
...
(assert (= cat_260 (mk_potato_11 cat_214)))
(assert (= cat_261 cat_236))
(assert (and (= cat_239 (fp.mul RNE cat_255 ((_ to_fp 11 53) RNE cat_183))) (spoon_3 (fp.mul RNE cat_255 ((_ to_fp 11 53) RNE cat_183)))))
(assert (= cat_240 (fp.mul RNE cat_239 cat_261)))
(assert (and (= cat_241 cat_240) (spoon_3 cat_240)))
(assert (and (= cat_237 (fp.sub RNE cat_257 cat_251)) (spoon_3 (fp.sub RNE cat_257 cat_251))))
(assert (= cat_238 (fp.sub RNE cat_237 cat_253)))
