...
(declare-fun cat_65 () (_ FloatingPoint 8 24))
(declare-fun cat_66 () potato_11)
(assert (spoon_50 cat_62))
(assert (= cat_65 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (spoon_30 (get_potato_13_b (get_potato_15_a cat_58))) (fp.sub roundNearestTiesToEven (fp (_ bv0 1) (_ bv127 8) (_ bv0 23)) cat_62)) (fp.mul roundNearestTiesToEven (spoon_30 (get_potato_13_b (get_potato_15_a cat_60))) cat_62))))
(assert (= (spoon_30 cat_66) cat_65))
(assert (spoon_1 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (spoon_30 (get_potato_13_b (get_potato_15_a cat_58))) (fp.sub roundNearestTiesToEven (fp (_ bv0 1) (_ bv127 8) (_ bv0 23)) cat_62)) (fp.mul roundNearestTiesToEven (spoon_30 (get_potato_13_b (get_potato_15_a cat_60))) cat_62))))
(assert (not (spoon_23 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (spoon_30 (get_potato_13_a (get_potato_15_a cat_58))) (fp.sub roundNearestTiesToEven (fp (_ bv0 1) (_ bv127 8) (_ bv0 23)) cat_62)) (fp.mul roundNearestTiesToEven (spoon_30 (get_potato_13_a (get_potato_15_a cat_60))) cat_62)))))
(check-sat)
(exit)
