...
(assert (and (= cat_154 (fp.add RNE (spoon_44 (get_potato_15_b (get_potato_17_a cat_81))) (spoon_77 (get_potato_23_b cat_160)))) (spoon_1 (fp.add RNE (spoon_44 (get_potato_15_b (get_potato_17_a cat_81))) (spoon_77 (get_potato_23_b cat_160))))))
(assert (= (spoon_44 cat_155) cat_154))
(assert (not (spoon_37 (fp.add RNE (spoon_44 (get_potato_15_a (get_potato_17_a cat_81))) (spoon_77 (get_potato_23_a cat_160))))))
(check-sat)
(exit)
