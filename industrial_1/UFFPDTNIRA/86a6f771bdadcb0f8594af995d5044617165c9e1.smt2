...
(assert (= cat_132 (mk_potato_24 (mk_potato_23 cat_114 cat_115))))
(assert (= cat_133 (mk_potato_23 cat_128 cat_129)))
(assert (and (= cat_130 (fp.add RNE (spoon_42 (get_potato_15_b (get_potato_17_a cat_79))) (spoon_75 (get_potato_23_b cat_133)))) (spoon_1 (fp.add RNE (spoon_42 (get_potato_15_b (get_potato_17_a cat_79))) (spoon_75 (get_potato_23_b cat_133))))))
(assert (= (spoon_42 cat_131) cat_130))
(assert (not (spoon_35 (fp.add RNE (spoon_42 (get_potato_15_a (get_potato_17_a cat_79))) (spoon_75 (get_potato_23_a cat_133))))))
(check-sat)
(exit)
