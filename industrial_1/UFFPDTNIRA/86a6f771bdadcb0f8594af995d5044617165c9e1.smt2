...
(declare-const cat_134 potato_24)
...
(assert (= cat_134 (mk_potato_24 (mk_potato_23 cat_116 cat_117))))
(assert (= cat_135 (mk_potato_23 cat_130 cat_131)))
(assert (and (= cat_132 (fp.add RNE (spoon_44 (get_potato_15_b (get_potato_17_a cat_81))) (spoon_77 (get_potato_23_b cat_135)))) (spoon_1 (fp.add RNE (spoon_44 (get_potato_15_b (get_potato_17_a cat_81))) (spoon_77 (get_potato_23_b cat_135))))))
(assert (= (spoon_44 cat_133) cat_132))
(assert (not (spoon_37 (fp.add RNE (spoon_44 (get_potato_15_a (get_potato_17_a cat_81))) (spoon_77 (get_potato_23_a cat_135))))))
(check-sat)
(exit)
