...
(assert (= cat_111 (fp.sub RNE cat_110 cat_109)))
(assert (=> (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_111) (and (= cat_105 (fp.sub RNE cat_111 (fp #b0 #b10000111 #b01101000000000000000000))) (spoon_1 (fp.sub RNE cat_111 (fp #b0 #b10000111 #b01101000000000000000000))))))
(assert (=> (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_111) (= cat_112 cat_97)))
(assert (=> (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_111) (= cat_113 cat_105)))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_111)) (=> (fp.leq cat_111 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000))) (and (= cat_106 (fp.add RNE cat_111 (fp #b0 #b10000111 #b01101000000000000000000))) (spoon_1 (fp.add RNE cat_111 (fp #b0 #b10000111 #b01101000000000000000000)))))))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_111)) (=> (fp.leq cat_111 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000))) (= cat_114 cat_97))))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_111)) (=> (fp.leq cat_111 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000))) (= cat_115 cat_106))))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_111)) (=> (not (fp.leq cat_111 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)))) (and (= cat_107 cat_111) (spoon_1 cat_111)))))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_111)) (=> (not (fp.leq cat_111 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)))) (= cat_116 cat_97))))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_111)) (=> (not (fp.leq cat_111 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)))) (= cat_117 cat_107))))
...
(assert (= cat_118 (fp.div RNE (fp.sub RNE (fp #b0 #b10000110 #b01101000000000000000000) cat_113) (fp #b0 #b10000000 #b00000000000000000000000))))
(assert (= cat_108 (fp.add RNE cat_110 cat_118)))
(assert (= cat_119 cat_108))
(assert (spoon_1 (fp.add RNE cat_110 cat_118)))
(assert (fp.lt (fp #b0 #b10000111 #b01101000000000000000000) cat_119))
(assert (not (spoon_52 (fp.sub RNE cat_119 (fp #b0 #b10000111 #b01101000000000000000000)))))
(check-sat)
(exit)
