...
(declare-const cat_70 potato_11)
...
(assert (= cat_71 cat_66))
(assert (= cat_72 (fp.sub RNE (spoon_32 (get_potato_13_a (get_potato_15_a cat_50))) (spoon_32 (get_potato_13_a (get_potato_15_a cat_52))))))
(assert (= cat_73 cat_67))
(assert (= cat_74 (fp.sub RNE (spoon_32 (get_potato_13_b (get_potato_15_a cat_50))) (spoon_32 (get_potato_13_b (get_potato_15_a cat_52))))))
(assert (=> (fp.leq cat_72 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000))) (= cat_75 cat_72)))
(assert (=> (fp.leq cat_72 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000))) (= cat_76 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))))
(assert (=> (not (fp.leq cat_72 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (fp.leq (fp #b0 #b10001011 #b00000000000000000000000) cat_72) (= cat_77 cat_72))))
(assert (=> (not (fp.leq cat_72 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (fp.leq (fp #b0 #b10001011 #b00000000000000000000000) cat_72) (= cat_78 (fp #b0 #b10001011 #b00000000000000000000000)))))
(assert (=> (not (fp.leq cat_72 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.leq (fp #b0 #b10001011 #b00000000000000000000000) cat_72)) (= cat_78 cat_72))))
(assert (=> (not (fp.leq cat_72 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (= cat_76 cat_78)))
(assert (=> (fp.leq cat_74 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000))) (= cat_79 cat_74)))
(assert (=> (fp.leq cat_74 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000))) (= cat_80 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))))
(assert (=> (not (fp.leq cat_74 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (fp.leq (fp #b0 #b10001011 #b00000000000000000000000) cat_74) (= cat_81 cat_74))))
(assert (=> (not (fp.leq cat_74 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (fp.leq (fp #b0 #b10001011 #b00000000000000000000000) cat_74) (= cat_82 (fp #b0 #b10001011 #b00000000000000000000000)))))
(assert (=> (not (fp.leq cat_74 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.leq (fp #b0 #b10001011 #b00000000000000000000000) cat_74)) (= cat_82 cat_74))))
(assert (=> (not (fp.leq cat_74 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (= cat_80 cat_82)))
(assert (and (= cat_69 cat_80) (spoon_1 cat_80)))
(assert (= (spoon_32 cat_70) cat_69))
(assert (not (spoon_25 cat_76)))
(check-sat)
(exit)
