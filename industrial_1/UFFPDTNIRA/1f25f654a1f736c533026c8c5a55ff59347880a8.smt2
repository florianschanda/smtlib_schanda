...
(define-fun spoon_53 ((kitten_34 Float32)) Bool (and (spoon_1 kitten_34) (and (fp.leq (fp.neg (fp #b0 #b10001100 #b00000000000000000000000)) kitten_34) (fp.leq kitten_34 (fp #b0 #b10001100 #b00000000000000000000000)))))
...
(define-fun spoon_59 ((kitten_35 potato_18)) potato_17 (get_potato_18_a kitten_35))
(define-fun spoon_60 ((kitten_36 Float32) (kitten_37 Bool) (kitten_38 Bool) (kitten_39 Bool)) Bool (=> (or (= kitten_37 true) (fp.leq (fp.neg (fp #b0 #b10001100 #b00000000000000000000000)) (fp #b0 #b10001100 #b00000000000000000000000))) (spoon_53 kitten_36)))
(declare-const cat_61 Int)
(declare-const cat_62 Int)
(define-fun spoon_63 ((kitten_40 Float32) (kitten_41 Bool) (kitten_42 Bool) (kitten_43 Bool)) Bool (=> (or (= kitten_41 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_23 kitten_40)))
...
(assert (=> (fp.leq (fp.neg (fp #b0 #b10001100 #b00000000000000000000000)) (fp #b0 #b10001100 #b00000000000000000000000)) (spoon_53 cat_64)))
(assert (=> (fp.leq (fp.neg (fp #b0 #b10001100 #b00000000000000000000000)) (fp #b0 #b10001100 #b00000000000000000000000)) (spoon_53 cat_65)))
(assert (= cat_68 cat_64))
(assert (= cat_69 (fp.sub RNE (spoon_30 (get_potato_13_a (get_potato_15_a cat_48))) (spoon_30 (get_potato_13_a (get_potato_15_a cat_50))))))
(assert (= cat_70 cat_65))
(assert (= cat_71 (fp.sub RNE (spoon_30 (get_potato_13_b (get_potato_15_a cat_48))) (spoon_30 (get_potato_13_b (get_potato_15_a cat_50))))))
...
(assert (and (= cat_66 cat_77) (spoon_1 cat_77)))
(assert (= (spoon_30 cat_67) cat_66))
