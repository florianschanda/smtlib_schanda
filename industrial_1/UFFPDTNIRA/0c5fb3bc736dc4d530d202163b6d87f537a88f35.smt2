...
(assert (forall ((kitten_27 Float32) (kitten_28 Float32)) (! (=> (and (and (spoon_31 kitten_27 true true true) (spoon_31 kitten_28 true true true)) (and (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) kitten_28) (fp.leq (fp.abs kitten_27) (fp #b0 #b01111111 #b00000000000000000000000)))) (let ((kitten_29 (spoon_32 kitten_27 kitten_28))) (and (=> (fp.eq kitten_27 (fp #b0 #b00000000 #b00000000000000000000000)) (fp.eq kitten_29 (fp #b0 #b00000000 #b00000000000000000000000))) (spoon_31 kitten_29 true false true)))) :pattern ((spoon_32 kitten_27 kitten_28)))))
(declare-sort potato_13 0)
(define-fun spoon_34 ((kitten_30 Float32)) Bool (and (spoon_1 kitten_30) (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) kitten_30) (fp.leq kitten_30 (fp #b0 #b10000101 #b01101000000000000000000)))))
...
(define-fun spoon_52 ((kitten_38 Float32) (kitten_39 Bool) (kitten_40 Bool) (kitten_41 Bool)) Bool (=> (or (= kitten_39 true) (fp.leq (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) (fp #b0 #b10000101 #b01101000000000000000000))) (spoon_34 kitten_38)))
