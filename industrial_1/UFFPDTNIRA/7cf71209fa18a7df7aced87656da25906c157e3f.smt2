...
(assert (fp.lt (spoon_47 (get_potato_14_b cat_128)) (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
(assert (not (not (fp.isZero ((_ to_fp 11 53) roundNearestTiesToEven (spoon_47 (get_potato_14_b cat_128)))))))
(check-sat)
(exit)
