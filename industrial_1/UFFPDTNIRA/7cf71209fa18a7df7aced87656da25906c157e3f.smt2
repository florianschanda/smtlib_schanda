...
(assert (spoon_40 (fp.add RNE (spoon_47 (get_potato_14_a (get_potato_16_a cat_67))) (spoon_47 (get_potato_14_a cat_128)))))
(assert (= cat_135 (mk_potato_11 cat_100)))
(assert (= cat_136 ((_ to_fp 11 53) RNE (fp.add RNE (spoon_47 (get_potato_14_b (get_potato_16_a cat_67))) (spoon_47 (get_potato_14_b cat_128))))))
(assert (not (fp.lt (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000) cat_136)))
(assert (fp.lt cat_136 (fp.neg (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000))))
(assert (fp.lt (spoon_47 (get_potato_14_b cat_128)) (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (not (not (fp.isZero ((_ to_fp 11 53) RNE (spoon_47 (get_potato_14_b cat_128)))))))
(check-sat)
(exit)
