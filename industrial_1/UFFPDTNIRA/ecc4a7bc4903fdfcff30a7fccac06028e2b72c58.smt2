...
(assert (not (spoon_23 (fp.add RNE (fp.mul RNE (spoon_30 (get_potato_13_b (get_potato_15_a cat_56))) (fp.sub RNE (fp #b0 #b01111111 #b00000000000000000000000) cat_60)) (fp.mul RNE (spoon_30 (get_potato_13_b (get_potato_15_a cat_58))) cat_60)))))
(check-sat)
(exit)
