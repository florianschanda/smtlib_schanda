...
(assert (not (fp.lt cat_112 cat_111)))
(assert (and (= cat_113 (fp.div RNE (spoon_75 cat_110) cat_112)) (spoon_1 (fp.div RNE (spoon_75 cat_110) cat_112))))
(assert (= cat_114 (fp.mul RNE cat_113 cat_111)))
(assert (not (spoon_1 cat_114)))
(check-sat)
(exit)
