...
(assert (not (fp.lt cat_114 cat_113)))
(assert (and (= cat_115 (fp.div RNE (spoon_77 cat_112) cat_114)) (spoon_1 (fp.div RNE (spoon_77 cat_112) cat_114))))
(assert (= cat_116 (fp.mul RNE cat_115 cat_113)))
(assert (not (spoon_1 cat_116)))
(check-sat)
(exit)
