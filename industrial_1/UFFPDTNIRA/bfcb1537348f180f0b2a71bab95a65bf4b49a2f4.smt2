...
(declare-const cat_227 potato_11)
(declare-const cat_228 Float64)
(declare-const cat_229 potato_11)
...
(assert (= cat_217 cat_177))
(assert (= cat_218 cat_191))
...
(assert (= cat_219 cat_176))
(assert (= cat_220 cat_192))
(assert (and (= cat_193 (spoon_133 (spoon_56 (get_potato_18_a (get_potato_20_a cat_137))))) (spoon_83 cat_193)))
(assert (= cat_221 cat_178))
(assert (= cat_222 cat_193))
(assert (and (= cat_194 (spoon_99 cat_218)) (spoon_91 cat_194)))
(assert (= cat_195 ((_ to_fp 11 53) RNE cat_194)))
(assert (= cat_223 cat_179))
(assert (= cat_224 cat_195))
(assert (and (= cat_196 (spoon_101 cat_218)) (spoon_91 cat_196)))
(assert (= cat_197 ((_ to_fp 11 53) RNE cat_196)))
(assert (= cat_225 cat_180))
(assert (= cat_226 cat_197))
(assert (and (= cat_198 (spoon_99 cat_222)) (spoon_91 cat_198)))
(assert (= cat_199 ((_ to_fp 11 53) RNE cat_198)))
(assert (= cat_227 (mk_potato_11 cat_181)))
(assert (= cat_228 cat_199))
(assert (and (= cat_200 (spoon_101 cat_222)) (spoon_91 cat_200)))
(assert (= cat_201 ((_ to_fp 11 53) RNE cat_200)))
(assert (= cat_229 (mk_potato_11 cat_182)))
(assert (= cat_230 cat_201))
(assert (and (= cat_202 (spoon_99 cat_220)) (spoon_91 cat_202)))
(assert (= cat_203 ((_ to_fp 11 53) RNE cat_202)))
(assert (= cat_231 (mk_potato_11 cat_183)))
(assert (= cat_232 cat_203))
(assert (and (= cat_204 (spoon_101 cat_220)) (spoon_91 cat_204)))
(assert (= cat_205 ((_ to_fp 11 53) RNE cat_204)))
(assert (= cat_233 (mk_potato_11 cat_184)))
(assert (= cat_234 cat_205))
(assert (and (= cat_208 (fp.mul RNE cat_226 cat_230)) (spoon_2 (fp.mul RNE cat_226 cat_230))))
(assert (= cat_209 (fp.mul RNE cat_208 cat_234)))
(assert (and (= cat_210 cat_209) (spoon_2 cat_209)))
(assert (and (= cat_206 (fp.mul RNE cat_224 cat_228)) (spoon_2 (fp.mul RNE cat_224 cat_228))))
...
(assert (= cat_236 cat_213))
(assert (and (= cat_214 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_141) cat_232)) (spoon_2 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_141) cat_232))))
(assert (= cat_215 (fp.mul RNE cat_214 cat_226)))
(assert (and (= cat_216 cat_215) (spoon_2 cat_215)))
(assert (= cat_237 (mk_potato_11 cat_188)))
(assert (= cat_238 cat_216))
(assert (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_236))
(assert (not (spoon_2 (fp.div RNE cat_238 cat_236))))
(check-sat)
(exit)
