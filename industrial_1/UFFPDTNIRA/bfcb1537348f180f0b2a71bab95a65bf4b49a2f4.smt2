...
(declare-const cat_231 potato_11)
...
(assert (= cat_221 cat_181))
(assert (= cat_222 cat_195))
...
(assert (= cat_223 cat_180))
(assert (= cat_224 cat_196))
(assert (and (= cat_197 (spoon_137 (spoon_60 (get_potato_18_a (get_potato_20_a cat_141))))) (spoon_87 cat_197)))
(assert (= cat_225 cat_182))
(assert (= cat_226 cat_197))
(assert (and (= cat_198 (spoon_103 cat_222)) (spoon_95 cat_198)))
(assert (= cat_199 ((_ to_fp 11 53) RNE cat_198)))
(assert (= cat_227 cat_183))
(assert (= cat_228 cat_199))
(assert (and (= cat_200 (spoon_105 cat_222)) (spoon_95 cat_200)))
(assert (= cat_201 ((_ to_fp 11 53) RNE cat_200)))
(assert (= cat_229 cat_184))
(assert (= cat_230 cat_201))
(assert (and (= cat_202 (spoon_103 cat_226)) (spoon_95 cat_202)))
(assert (= cat_203 ((_ to_fp 11 53) RNE cat_202)))
(assert (= cat_231 (mk_potato_11 cat_185)))
(assert (= cat_232 cat_203))
(assert (and (= cat_204 (spoon_105 cat_226)) (spoon_95 cat_204)))
(assert (= cat_205 ((_ to_fp 11 53) RNE cat_204)))
(assert (= cat_233 (mk_potato_11 cat_186)))
(assert (= cat_234 cat_205))
(assert (and (= cat_206 (spoon_103 cat_224)) (spoon_95 cat_206)))
(assert (= cat_207 ((_ to_fp 11 53) RNE cat_206)))
(assert (= cat_235 (mk_potato_11 cat_187)))
(assert (= cat_236 cat_207))
(assert (and (= cat_208 (spoon_105 cat_224)) (spoon_95 cat_208)))
(assert (= cat_209 ((_ to_fp 11 53) RNE cat_208)))
(assert (= cat_237 (mk_potato_11 cat_188)))
(assert (= cat_238 cat_209))
(assert (and (= cat_212 (fp.mul RNE cat_230 cat_234)) (spoon_2 (fp.mul RNE cat_230 cat_234))))
(assert (= cat_213 (fp.mul RNE cat_212 cat_238)))
(assert (and (= cat_214 cat_213) (spoon_2 cat_213)))
(assert (and (= cat_210 (fp.mul RNE cat_228 cat_232)) (spoon_2 (fp.mul RNE cat_228 cat_232))))
...
(assert (= cat_239 (mk_potato_11 cat_191)))
(assert (= cat_240 cat_217))
(assert (and (= cat_218 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_145) cat_236)) (spoon_2 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_145) cat_236))))
(assert (= cat_219 (fp.mul RNE cat_218 cat_230)))
(assert (and (= cat_220 cat_219) (spoon_2 cat_219)))
(assert (= cat_241 (mk_potato_11 cat_192)))
(assert (= cat_242 cat_220))
(assert (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_240))
(assert (not (spoon_2 (fp.div RNE cat_242 cat_240))))
(check-sat)
(exit)
