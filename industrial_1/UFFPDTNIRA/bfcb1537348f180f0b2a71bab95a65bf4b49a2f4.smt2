...
(assert (and (= cat_212 (fp.mul RNE cat_230 cat_234)) (spoon_3 (fp.mul RNE cat_230 cat_234))))
(assert (= cat_213 (fp.mul RNE cat_212 cat_238)))
(assert (and (= cat_214 cat_213) (spoon_3 cat_213)))
(assert (and (= cat_210 (fp.mul RNE cat_228 cat_232)) (spoon_3 (fp.mul RNE cat_228 cat_232))))
...
(assert (and (= cat_218 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_145) cat_236)) (spoon_3 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_145) cat_236))))
...
(assert (not (spoon_3 (fp.div RNE cat_242 cat_240))))
(check-sat)
(exit)
