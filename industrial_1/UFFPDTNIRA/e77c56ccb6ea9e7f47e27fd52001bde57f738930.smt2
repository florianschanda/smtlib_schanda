...
(assert (= cat_225 cat_177))
(assert (= cat_226 cat_191))
...
(assert (= cat_227 cat_176))
(assert (= cat_228 cat_192))
(assert (and (= cat_193 (spoon_133 (spoon_56 (get_potato_18_a (get_potato_20_a cat_137))))) (spoon_83 cat_193)))
(assert (= cat_229 cat_178))
(assert (= cat_230 cat_193))
(assert (and (= cat_194 (spoon_99 cat_226)) (spoon_91 cat_194)))
(assert (= cat_195 ((_ to_fp 11 53) RNE cat_194)))
(assert (= cat_231 cat_179))
(assert (= cat_232 cat_195))
(assert (and (= cat_196 (spoon_101 cat_226)) (spoon_91 cat_196)))
(assert (= cat_197 ((_ to_fp 11 53) RNE cat_196)))
(assert (= cat_233 cat_180))
(assert (= cat_234 cat_197))
(assert (and (= cat_198 (spoon_99 cat_230)) (spoon_91 cat_198)))
(assert (= cat_199 ((_ to_fp 11 53) RNE cat_198)))
(assert (= cat_235 (mk_potato_11 cat_181)))
(assert (= cat_236 cat_199))
(assert (and (= cat_200 (spoon_101 cat_230)) (spoon_91 cat_200)))
(assert (= cat_201 ((_ to_fp 11 53) RNE cat_200)))
(assert (= cat_237 (mk_potato_11 cat_182)))
(assert (= cat_238 cat_201))
(assert (and (= cat_202 (spoon_99 cat_228)) (spoon_91 cat_202)))
(assert (= cat_203 ((_ to_fp 11 53) RNE cat_202)))
(assert (= cat_239 (mk_potato_11 cat_183)))
(assert (= cat_240 cat_203))
(assert (and (= cat_204 (spoon_101 cat_228)) (spoon_91 cat_204)))
(assert (= cat_205 ((_ to_fp 11 53) RNE cat_204)))
(assert (= cat_241 (mk_potato_11 cat_184)))
(assert (= cat_242 cat_205))
(assert (and (= cat_208 (fp.mul RNE cat_234 cat_238)) (spoon_2 (fp.mul RNE cat_234 cat_238))))
(assert (= cat_209 (fp.mul RNE cat_208 cat_242)))
(assert (and (= cat_210 cat_209) (spoon_2 cat_209)))
(assert (and (= cat_206 (fp.mul RNE cat_232 cat_236)) (spoon_2 (fp.mul RNE cat_232 cat_236))))
...
(assert (= cat_244 cat_213))
(assert (and (= cat_214 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_141) cat_240)) (spoon_2 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_141) cat_240))))
(assert (= cat_215 (fp.mul RNE cat_214 cat_234)))
(assert (and (= cat_216 cat_215) (spoon_2 cat_215)))
(assert (= cat_245 (mk_potato_11 cat_188)))
(assert (= cat_246 cat_216))
(assert (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_244)))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_244) (and (= cat_222 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_244)) (spoon_2 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_244)))))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_244) (= cat_223 (ite (fp.leq cat_246 cat_222) true false))))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_244) (and (= cat_221 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_244)) (spoon_2 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_244)))))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_244) (= cat_224 (ite (fp.leq cat_221 cat_246) true false))))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_244) (= cat_248 (ite (= cat_224 true) cat_223 false))))
(assert (=> (not (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_244)) (= cat_248 false)))
(assert (=> (= cat_248 true) (= cat_247 true)))
(assert (=> (not (= cat_248 true)) (=> (fp.lt cat_244 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (and (= cat_218 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_244)) (spoon_2 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_244))))))
(assert (=> (not (= cat_248 true)) (=> (fp.lt cat_244 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_219 (ite (fp.leq cat_246 cat_218) true false)))))
(assert (=> (not (= cat_248 true)) (=> (fp.lt cat_244 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (and (= cat_217 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_244)) (spoon_2 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_244))))))
(assert (=> (not (= cat_248 true)) (=> (fp.lt cat_244 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_220 (ite (fp.leq cat_217 cat_246) true false)))))
(assert (=> (not (= cat_248 true)) (=> (fp.lt cat_244 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_247 (ite (= cat_220 true) cat_219 false)))))
(assert (=> (not (= cat_248 true)) (=> (not (fp.lt cat_244 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))) (= cat_247 false))))
(assert (= cat_247 true))
(assert (not (not (fp.isZero cat_244))))
(check-sat)
(exit)
