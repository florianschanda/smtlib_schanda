...
(assert (and (= cat_212 (fp.mul RNE cat_238 cat_242)) (spoon_3 (fp.mul RNE cat_238 cat_242))))
(assert (= cat_213 (fp.mul RNE cat_212 cat_246)))
(assert (and (= cat_214 cat_213) (spoon_3 cat_213)))
(assert (and (= cat_210 (fp.mul RNE cat_236 cat_240)) (spoon_3 (fp.mul RNE cat_236 cat_240))))
...
(assert (and (= cat_218 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_145) cat_244)) (spoon_3 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_145) cat_244))))
...
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_248) (and (= cat_226 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_248)) (spoon_3 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_248)))))
