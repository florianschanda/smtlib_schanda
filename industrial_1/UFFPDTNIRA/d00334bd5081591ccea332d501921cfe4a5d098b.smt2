...
(declare-const cat_124 potato_21)
(declare-const cat_125 potato_21)
(declare-const cat_126 potato_21)
(declare-const cat_127 potato_21)
(declare-const cat_128 potato_21)
(declare-const cat_129 potato_21)
(declare-const cat_130 potato_23)
(assert (spoon_60 cat_114))
(assert (spoon_60 cat_115))
(assert (fp.lt (fp #b0 #b01110101 #b00000110001001001101111) cat_114))
(assert (fp.lt (fp #b0 #b01110101 #b00000110001001001101111) cat_115))
(assert (not (fp.lt cat_115 cat_114)))
(assert (= cat_120 (fp.div RNE (spoon_75 cat_113) cat_115)))
(assert (spoon_1 (fp.div RNE (spoon_75 cat_113) cat_115)))
(assert (= cat_121 (fp.mul RNE cat_120 cat_114)))
...
(assert (= cat_116 (fp.div RNE (spoon_75 cat_112) cat_115)))
(assert (spoon_1 (fp.div RNE (spoon_75 cat_112) cat_115)))
(assert (= cat_117 (fp.mul RNE cat_116 cat_114)))
...
(assert (not (spoon_33 (fp.add RNE (spoon_40 (get_potato_15_b (get_potato_17_a cat_79))) (spoon_75 (get_potato_23_b cat_130))))))
(check-sat)
(exit)
