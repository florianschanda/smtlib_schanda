...
(assert (= cat_120 (fp.div roundNearestTiesToEven (spoon_75 cat_113) cat_115)))
(assert (spoon_1 (fp.div roundNearestTiesToEven (spoon_75 cat_113) cat_115)))
(assert (= cat_121 (fp.mul roundNearestTiesToEven cat_120 cat_114)))
...
(assert (= cat_116 (fp.div roundNearestTiesToEven (spoon_75 cat_112) cat_115)))
(assert (spoon_1 (fp.div roundNearestTiesToEven (spoon_75 cat_112) cat_115)))
(assert (= cat_117 (fp.mul roundNearestTiesToEven cat_116 cat_114)))
