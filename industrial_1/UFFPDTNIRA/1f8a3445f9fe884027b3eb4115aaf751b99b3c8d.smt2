...
(assert (fp.lt (spoon_47 (get_potato_14_b cat_129)) (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (and (= cat_122 (fp.div RNE ((_ to_fp 11 53) RNE (fp.sub RNE (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (spoon_47 (get_potato_14_b (get_potato_16_a cat_67))))) ((_ to_fp 11 53) RNE (spoon_47 (get_potato_14_b cat_129))))) (spoon_3 (fp.div RNE ((_ to_fp 11 53) RNE (fp.sub RNE (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (spoon_47 (get_potato_14_b (get_potato_16_a cat_67))))) ((_ to_fp 11 53) RNE (spoon_47 (get_potato_14_b cat_129)))))))
