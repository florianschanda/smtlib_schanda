...
(assert (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_317))
(assert (and (= cat_264 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_317)) (spoon_1 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_317))))
(assert (and (= cat_265 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_315)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_315))))
(assert (= cat_266 (ite (fp.leq cat_265 cat_264) true false)))
