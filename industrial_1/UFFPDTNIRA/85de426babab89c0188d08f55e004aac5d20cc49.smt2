...
(assert (= cat_244 (mk_potato_25 (mk_potato_24 cat_205 cat_206))))
(assert (= cat_245 (get_potato_26_a cat_115)))
(assert (= cat_229 (spoon_117 cat_171 cat_78)))
(assert (= cat_246 (ite (not (= cat_229 true)) true false)))
(assert (= cat_246 true))
(assert (= cat_247 true))
(assert (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_248)))))
(assert (not (fp.lt (spoon_88 (get_potato_24_a cat_248)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))))
(assert (not (spoon_126 (spoon_88 (get_potato_24_a cat_248)))))
(check-sat)
(exit)
