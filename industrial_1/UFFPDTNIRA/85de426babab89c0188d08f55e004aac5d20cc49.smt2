...
(assert (= cat_291 true))
(assert (= cat_292 true))
(assert (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_293)))))
(assert (not (fp.lt (spoon_88 (get_potato_24_a cat_293)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))))
(assert (not (spoon_126 (spoon_88 (get_potato_24_a cat_293)))))
(check-sat)
(exit)
