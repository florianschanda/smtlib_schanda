...
(declare-const cat_240 potato_25)
(declare-const cat_241 potato_24)
(declare-const cat_242 Bool)
(declare-const cat_243 Bool)
(declare-const cat_244 potato_24)
...
(assert (= cat_240 (mk_potato_25 (mk_potato_24 cat_201 cat_202))))
(assert (= cat_241 (get_potato_26_a cat_111)))
(assert (= cat_225 (spoon_113 cat_167 cat_74)))
(assert (= cat_242 (ite (not (= cat_225 true)) true false)))
(assert (= cat_242 true))
(assert (= cat_243 true))
(assert (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_244)))))
(assert (not (fp.lt (spoon_84 (get_potato_24_a cat_244)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))))
(assert (not (spoon_122 (spoon_84 (get_potato_24_a cat_244)))))
(check-sat)
(exit)
