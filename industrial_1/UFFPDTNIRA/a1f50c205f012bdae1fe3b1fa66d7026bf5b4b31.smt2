...
(declare-const cat_238 potato_7)
(declare-const cat_239 Bool)
(declare-const cat_240 potato_29)
(declare-const cat_241 potato_28)
...
(assert (= cat_238 (mk_potato_7 cat_203)))
(assert (= cat_239 (distinct 1 0)))
(assert (= cat_240 (mk_potato_29 (mk_potato_28 cat_201 cat_202))))
(assert (= cat_241 (get_potato_30_a cat_138)))
(assert (= cat_242 (mk_potato_11 cat_206)))
(assert (= cat_243 (fp.mul RNE cat_181 cat_181)))
(assert (and (= cat_224 ((_ to_fp 11 53) RNE (fp.mul RNE cat_177 cat_177))) (spoon_3 ((_ to_fp 11 53) RNE (fp.mul RNE cat_177 cat_177)))))
(assert (= cat_244 (mk_potato_11 cat_204)))
(assert (= cat_245 cat_224))
(assert (and (= cat_225 ((_ to_fp 11 53) RNE (fp.mul RNE cat_179 cat_179))) (spoon_3 ((_ to_fp 11 53) RNE (fp.mul RNE cat_179 cat_179)))))
(assert (= cat_246 (mk_potato_11 cat_205)))
(assert (= cat_247 cat_225))
(assert (= cat_248 (mk_potato_11 cat_207)))
(assert (= cat_249 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_181)))
(assert (and (= cat_226 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_243)) (spoon_3 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_243))))
(assert (= cat_250 (mk_potato_11 cat_208)))
(assert (= cat_251 cat_226))
...
(assert (= cat_254 (mk_potato_11 cat_210)))
(assert (= cat_255 cat_232))
(assert (and (= cat_233 (fp.mul RNE cat_249 ((_ to_fp 11 53) RNE cat_179))) (spoon_3 (fp.mul RNE cat_249 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_234 (fp.mul RNE cat_233 cat_255)))
(assert (and (= cat_235 cat_234) (spoon_3 cat_234)))
(assert (not (spoon_3 (fp.sub RNE cat_251 cat_245))))
(check-sat)
(exit)
