...
(assert (= cat_151 cat_145))
(assert (= cat_152 ((_ to_fp 8 24) RNE (fp.mul RNE cat_129 cat_129))))
(assert (= cat_146 (fp.mul RNE cat_152 cat_151)))
(assert (spoon_1 (fp.mul RNE cat_152 cat_151)))
(assert (spoon_1 cat_146))
(assert (= cat_147 (fp.mul RNE cat_152 (fp.mul RNE cat_151 cat_151))))
(assert (spoon_1 (fp.mul RNE cat_152 (fp.mul RNE cat_151 cat_151))))
(assert (= cat_148 (fp.sub RNE (fp #b0 #b01111111 #b00000000000000000000000) cat_147)))
(assert (= cat_149 cat_148))
(assert (spoon_1 cat_148))
(assert (= cat_150 (fp.sqrt RNE cat_149)))
(assert (not (spoon_103 cat_150)))
(check-sat)
(exit)
