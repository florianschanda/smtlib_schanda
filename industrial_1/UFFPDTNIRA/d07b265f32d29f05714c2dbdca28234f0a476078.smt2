...
(assert (and (= cat_116 (fp.div RNE (spoon_75 cat_111) cat_113)) (spoon_1 (fp.div RNE (spoon_75 cat_111) cat_113))))
...
(assert (and (= cat_114 (fp.div RNE (spoon_75 cat_110) cat_113)) (spoon_1 (fp.div RNE (spoon_75 cat_110) cat_113))))
(assert (= cat_115 (fp.mul RNE cat_114 cat_112)))
(assert (not (spoon_1 cat_115)))
(check-sat)
(exit)
