...
(declare-const cat_245 potato_25)
(declare-const cat_246 potato_24)
...
(assert (= cat_243 (mk_potato_7 cat_203)))
(assert (= cat_244 (spoon_37 1)))
(assert (= cat_245 (mk_potato_25 (mk_potato_24 cat_201 cat_202))))
(assert (= cat_246 (get_potato_26_a cat_111)))
(assert (= cat_225 (spoon_113 cat_167 cat_74)))
(assert (= cat_247 (ite (not (= cat_225 true)) true false)))
(assert (= cat_247 true))
(assert (= cat_248 true))
(assert (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_249))) (and (= cat_226 (spoon_149 (fp #b0 #b10000101 #b01100111111101011101000))) (spoon_129 cat_226))))
(assert (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_249))) (= cat_250 (mk_potato_10 cat_242))))
(assert (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_249))) (= cat_251 cat_226)))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_249)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_249)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (and (= cat_227 (spoon_149 (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (spoon_129 cat_227)))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_249)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_249)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_252 (mk_potato_10 cat_242)))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_249)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_249)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_253 cat_227))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_249)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_249)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_228 (spoon_84 (get_potato_24_a cat_249))) (spoon_1 (spoon_84 (get_potato_24_a cat_249)))))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_249)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_249)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_229 (spoon_149 cat_228)) (spoon_129 cat_229)))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_249)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_249)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_254 (mk_potato_10 cat_242)))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_249)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_249)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_255 cat_229))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_249)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_249)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_253 cat_255))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_249)))) (= cat_251 cat_253)))
(assert (=> (spoon_189 cat_175) (and (= cat_230 (fp.mul RNE cat_175 cat_175)) (spoon_1 (fp.mul RNE cat_175 cat_175)))))
(assert (=> (spoon_189 cat_175) (= cat_256 (mk_potato_10 cat_240))))
(assert (=> (spoon_189 cat_175) (= cat_257 cat_230)))
(assert (=> (spoon_189 cat_175) (= cat_259 cat_248)))
(assert (=> (not (spoon_189 cat_175)) (= cat_258 (mk_potato_7 cat_248))))
(assert (=> (not (spoon_189 cat_175)) (= cat_259 (spoon_37 0))))
(assert (=> (not (spoon_189 cat_175)) (= cat_257 cat_240)))
(assert (= cat_260 (mk_potato_10 cat_234)))
(assert (= cat_261 ((_ to_fp 8 24) RNE (fp.sub RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) (fp.mul RNE cat_171 cat_171)))))
(assert (not (spoon_115 cat_261)))
(check-sat)
(exit)
