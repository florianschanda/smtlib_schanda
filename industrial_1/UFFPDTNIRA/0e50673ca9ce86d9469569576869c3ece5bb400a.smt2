...
(assert (=> (spoon_193 cat_179) (= cat_300 (mk_potato_10 cat_284))))
(assert (=> (spoon_193 cat_179) (= cat_301 cat_234)))
(assert (=> (spoon_193 cat_179) (= cat_303 cat_292)))
(assert (=> (not (spoon_193 cat_179)) (= cat_302 (mk_potato_7 cat_292))))
(assert (=> (not (spoon_193 cat_179)) (= cat_303 (spoon_41 0))))
(assert (=> (not (spoon_193 cat_179)) (= cat_301 cat_284)))
(assert (= cat_304 (mk_potato_10 cat_278)))
(assert (= cat_305 ((_ to_fp 8 24) RNE (fp.sub RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) (fp.mul RNE cat_175 cat_175)))))
(assert (not (spoon_119 cat_305)))
(check-sat)
(exit)
