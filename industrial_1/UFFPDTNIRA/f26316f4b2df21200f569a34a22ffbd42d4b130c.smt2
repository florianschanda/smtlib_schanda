...
(declare-fun cat_226 () potato_7)
(declare-fun cat_227 () Bool)
(declare-fun cat_228 () potato_29)
(declare-fun cat_229 () potato_28)
...
(assert (= cat_224 cat_215))
(assert (= cat_225 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
(assert (spoon_100 cat_225))
...
(assert (= cat_226 (mk_potato_7 cat_203)))
(assert (= cat_227 (distinct 1 0)))
(assert (= cat_228 (mk_potato_29 (mk_potato_28 cat_201 cat_202))))
(assert (= cat_229 (get_potato_30_a cat_138)))
(assert (= cat_230 (mk_potato_11 cat_206)))
(assert (= cat_231 (fp.mul roundNearestTiesToEven cat_181 cat_181)))
(assert (not (spoon_161 ((_ to_fp 11 53) roundNearestTiesToEven (fp.mul roundNearestTiesToEven cat_177 cat_177)))))
(check-sat)
(exit)
