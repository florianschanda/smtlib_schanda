...
(declare-const cat_226 potato_7)
(declare-const cat_227 Bool)
(declare-const cat_228 potato_29)
(declare-const cat_229 potato_28)
...
(assert (= cat_231 (fp.mul RNE cat_181 cat_181)))
(assert (not (spoon_161 ((_ to_fp 11 53) RNE (fp.mul RNE cat_177 cat_177)))))
(check-sat)
(exit)
