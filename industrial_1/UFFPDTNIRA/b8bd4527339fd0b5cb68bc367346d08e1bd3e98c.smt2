...
(assert (= cat_148 ((_ to_fp 8 24) RNE (fp.mul RNE cat_129 cat_129))))
(assert (= cat_146 (fp.mul RNE cat_148 cat_147)))
(assert (spoon_1 (fp.mul RNE cat_148 cat_147)))
(assert (not (spoon_119 cat_146)))
(check-sat)
(exit)
