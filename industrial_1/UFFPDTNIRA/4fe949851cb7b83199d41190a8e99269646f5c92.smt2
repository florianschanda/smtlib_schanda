...
(assert (and (= cat_212 (fp.mul RNE cat_226 cat_230)) (spoon_3 (fp.mul RNE cat_226 cat_230))))
(assert (= cat_213 (fp.mul RNE cat_212 cat_234)))
(assert (and (= cat_214 cat_213) (spoon_3 cat_213)))
(assert (and (= cat_210 (fp.mul RNE cat_224 cat_228)) (spoon_3 (fp.mul RNE cat_224 cat_228))))
