...
(assert (= cat_154 (mk_potato_11 cat_105)))
(assert (= cat_155 cat_118))
(assert (= (spoon_53 cat_120) ((_ to_fp 8 24) RNE (fp.mul RNE ((_ to_fp 11 53) RNE (spoon_53 (get_potato_14_b (get_potato_16_a cat_73)))) cat_155))))
