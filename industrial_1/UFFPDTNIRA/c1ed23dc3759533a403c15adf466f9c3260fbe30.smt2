...
(assert (= cat_106 ((_ to_fp 11 53) RNE (fp.add RNE (spoon_49 (get_potato_14_a (get_potato_16_a cat_67))) (spoon_49 (get_potato_14_a (get_potato_16_a cat_69)))))))
...
(assert (and (= cat_103 cat_102) (spoon_2 cat_102)))
(assert (= cat_107 (mk_potato_11 cat_101)))
(assert (= cat_108 cat_103))
(assert (= (spoon_49 cat_104) ((_ to_fp 8 24) RNE (fp.mul RNE ((_ to_fp 11 53) RNE (spoon_49 (get_potato_14_b (get_potato_16_a cat_69)))) cat_108))))
(assert (not (spoon_42 (fp.sub RNE (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (spoon_49 (get_potato_14_a (get_potato_16_a cat_67)))))))
(check-sat)
(exit)
