...
(declare-const cat_111 potato_11)
...
(assert (= cat_110 ((_ to_fp 11 53) RNE (fp.add RNE (spoon_53 (get_potato_14_a (get_potato_16_a cat_71))) (spoon_53 (get_potato_14_a (get_potato_16_a cat_73)))))))
(assert (not (fp.lt (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000) cat_110)))
(assert (fp.lt cat_110 (fp.neg (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000))))
...
(assert (and (= cat_107 cat_106) (spoon_3 cat_106)))
(assert (= cat_111 (mk_potato_11 cat_105)))
(assert (= cat_112 cat_107))
(assert (= (spoon_53 cat_108) ((_ to_fp 8 24) RNE (fp.mul RNE ((_ to_fp 11 53) RNE (spoon_53 (get_potato_14_b (get_potato_16_a cat_73)))) cat_112))))
(assert (not (spoon_46 (fp.sub RNE (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (spoon_53 (get_potato_14_a (get_potato_16_a cat_71)))))))
(check-sat)
(exit)
