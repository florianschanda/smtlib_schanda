...
(assert (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_116)))
(assert (not (fp.leq cat_116 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)))))
(assert (not (spoon_58 cat_116)))
(check-sat)
(exit)
