...
(assert (and (= cat_212 (fp.mul RNE cat_227 cat_231)) (spoon_3 (fp.mul RNE cat_227 cat_231))))
(assert (= cat_213 (fp.mul RNE cat_212 cat_235)))
(assert (and (= cat_214 cat_213) (spoon_3 cat_213)))
(assert (and (= cat_210 (fp.mul RNE cat_225 cat_229)) (spoon_3 (fp.mul RNE cat_225 cat_229))))
...
(assert (not (spoon_3 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_145) cat_233))))
(check-sat)
(exit)
