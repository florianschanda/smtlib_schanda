...
(assert (= cat_222 cat_182))
(assert (= cat_223 cat_197))
(assert (and (= cat_198 (spoon_103 cat_219)) (spoon_95 cat_198)))
(assert (= cat_199 ((_ to_fp 11 53) RNE cat_198)))
(assert (= cat_224 cat_183))
(assert (= cat_225 cat_199))
(assert (and (= cat_200 (spoon_105 cat_219)) (spoon_95 cat_200)))
(assert (= cat_201 ((_ to_fp 11 53) RNE cat_200)))
(assert (= cat_226 cat_184))
(assert (= cat_227 cat_201))
(assert (and (= cat_202 (spoon_103 cat_223)) (spoon_95 cat_202)))
(assert (= cat_203 ((_ to_fp 11 53) RNE cat_202)))
(assert (= cat_228 (mk_potato_11 cat_185)))
(assert (= cat_229 cat_203))
(assert (and (= cat_204 (spoon_105 cat_223)) (spoon_95 cat_204)))
(assert (= cat_205 ((_ to_fp 11 53) RNE cat_204)))
(assert (= cat_230 (mk_potato_11 cat_186)))
(assert (= cat_231 cat_205))
(assert (and (= cat_206 (spoon_103 cat_221)) (spoon_95 cat_206)))
(assert (= cat_207 ((_ to_fp 11 53) RNE cat_206)))
(assert (= cat_232 (mk_potato_11 cat_187)))
(assert (= cat_233 cat_207))
(assert (and (= cat_208 (spoon_105 cat_221)) (spoon_95 cat_208)))
(assert (= cat_209 ((_ to_fp 11 53) RNE cat_208)))
(assert (= cat_234 (mk_potato_11 cat_188)))
(assert (= cat_235 cat_209))
(assert (and (= cat_212 (fp.mul RNE cat_227 cat_231)) (spoon_2 (fp.mul RNE cat_227 cat_231))))
(assert (= cat_213 (fp.mul RNE cat_212 cat_235)))
(assert (and (= cat_214 cat_213) (spoon_2 cat_213)))
(assert (and (= cat_210 (fp.mul RNE cat_225 cat_229)) (spoon_2 (fp.mul RNE cat_225 cat_229))))
...
(assert (= cat_236 (mk_potato_11 cat_191)))
(assert (= cat_237 cat_217))
(assert (not (spoon_2 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_145) cat_233))))
(check-sat)
(exit)
