...
(assert (= cat_216 cat_176))
(assert (= cat_217 cat_192))
(assert (and (= cat_193 (spoon_133 (spoon_56 (get_potato_18_a (get_potato_20_a cat_137))))) (spoon_83 cat_193)))
(assert (= cat_218 cat_178))
(assert (= cat_219 cat_193))
(assert (and (= cat_194 (spoon_99 cat_215)) (spoon_91 cat_194)))
(assert (= cat_195 ((_ to_fp 11 53) RNE cat_194)))
(assert (= cat_220 cat_179))
(assert (= cat_221 cat_195))
(assert (and (= cat_196 (spoon_101 cat_215)) (spoon_91 cat_196)))
(assert (= cat_197 ((_ to_fp 11 53) RNE cat_196)))
(assert (= cat_222 cat_180))
(assert (= cat_223 cat_197))
(assert (and (= cat_198 (spoon_99 cat_219)) (spoon_91 cat_198)))
(assert (= cat_199 ((_ to_fp 11 53) RNE cat_198)))
(assert (= cat_224 (mk_potato_11 cat_181)))
(assert (= cat_225 cat_199))
(assert (and (= cat_200 (spoon_101 cat_219)) (spoon_91 cat_200)))
(assert (= cat_201 ((_ to_fp 11 53) RNE cat_200)))
(assert (= cat_226 (mk_potato_11 cat_182)))
(assert (= cat_227 cat_201))
(assert (and (= cat_202 (spoon_99 cat_217)) (spoon_91 cat_202)))
(assert (= cat_203 ((_ to_fp 11 53) RNE cat_202)))
(assert (= cat_228 (mk_potato_11 cat_183)))
(assert (= cat_229 cat_203))
(assert (and (= cat_204 (spoon_101 cat_217)) (spoon_91 cat_204)))
(assert (= cat_205 ((_ to_fp 11 53) RNE cat_204)))
(assert (= cat_230 (mk_potato_11 cat_184)))
(assert (= cat_231 cat_205))
(assert (and (= cat_208 (fp.mul RNE cat_223 cat_227)) (spoon_2 (fp.mul RNE cat_223 cat_227))))
(assert (= cat_209 (fp.mul RNE cat_208 cat_231)))
(assert (and (= cat_210 cat_209) (spoon_2 cat_209)))
(assert (and (= cat_206 (fp.mul RNE cat_221 cat_225)) (spoon_2 (fp.mul RNE cat_221 cat_225))))
...
(assert (= cat_233 cat_213))
(assert (not (spoon_2 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_141) cat_229))))
(check-sat)
(exit)
