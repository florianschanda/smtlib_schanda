...
(declare-fun cat_228 () potato_7)
(declare-fun cat_229 () Bool)
(declare-fun cat_230 () potato_29)
(declare-fun cat_231 () potato_28)
...
(assert (= cat_233 (fp.mul roundNearestTiesToEven cat_181 cat_181)))
...
(assert (= cat_239 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1025 11) (_ bv0 52)) cat_181)))
(assert (not (spoon_3 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1025 11) (_ bv0 52)) cat_233))))
(check-sat)
(exit)
