...
(declare-const cat_228 potato_7)
(declare-const cat_229 Bool)
(declare-const cat_230 potato_29)
(declare-const cat_231 potato_28)
(declare-const cat_232 potato_11)
(declare-const cat_233 Float64)
(declare-const cat_234 potato_11)
...
(assert (= cat_228 (mk_potato_7 cat_203)))
(assert (= cat_229 (distinct 1 0)))
(assert (= cat_230 (mk_potato_29 (mk_potato_28 cat_201 cat_202))))
(assert (= cat_231 (get_potato_30_a cat_138)))
(assert (= cat_232 (mk_potato_11 cat_206)))
(assert (= cat_233 (fp.mul RNE cat_181 cat_181)))
(assert (and (= cat_224 ((_ to_fp 11 53) RNE (fp.mul RNE cat_177 cat_177))) (spoon_3 ((_ to_fp 11 53) RNE (fp.mul RNE cat_177 cat_177)))))
(assert (= cat_234 (mk_potato_11 cat_204)))
(assert (= cat_235 cat_224))
(assert (and (= cat_225 ((_ to_fp 11 53) RNE (fp.mul RNE cat_179 cat_179))) (spoon_3 ((_ to_fp 11 53) RNE (fp.mul RNE cat_179 cat_179)))))
(assert (= cat_236 (mk_potato_11 cat_205)))
(assert (= cat_237 cat_225))
(assert (= cat_238 (mk_potato_11 cat_207)))
(assert (= cat_239 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_181)))
(assert (not (spoon_3 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_233))))
(check-sat)
(exit)
