...
(define-fun spoon_272 () potato_11 (mk_potato_11 cat_174))
...
(assert (= cat_234 cat_177))
(assert (= cat_235 cat_191))
...
(assert (= cat_236 cat_176))
(assert (= cat_237 cat_192))
(assert (and (= cat_193 (spoon_133 (spoon_56 (get_potato_18_a (get_potato_20_a cat_137))))) (spoon_83 cat_193)))
(assert (= cat_238 cat_178))
(assert (= cat_239 cat_193))
(assert (and (= cat_194 (spoon_99 cat_235)) (spoon_91 cat_194)))
(assert (= cat_195 ((_ to_fp 11 53) RNE cat_194)))
(assert (= cat_240 cat_179))
(assert (= cat_241 cat_195))
(assert (and (= cat_196 (spoon_101 cat_235)) (spoon_91 cat_196)))
(assert (= cat_197 ((_ to_fp 11 53) RNE cat_196)))
(assert (= cat_242 cat_180))
(assert (= cat_243 cat_197))
(assert (and (= cat_198 (spoon_99 cat_239)) (spoon_91 cat_198)))
(assert (= cat_199 ((_ to_fp 11 53) RNE cat_198)))
(assert (= cat_244 (mk_potato_11 cat_181)))
(assert (= cat_245 cat_199))
(assert (and (= cat_200 (spoon_101 cat_239)) (spoon_91 cat_200)))
(assert (= cat_201 ((_ to_fp 11 53) RNE cat_200)))
(assert (= cat_246 (mk_potato_11 cat_182)))
(assert (= cat_247 cat_201))
(assert (and (= cat_202 (spoon_99 cat_237)) (spoon_91 cat_202)))
(assert (= cat_203 ((_ to_fp 11 53) RNE cat_202)))
(assert (= cat_248 (mk_potato_11 cat_183)))
(assert (= cat_249 cat_203))
(assert (and (= cat_204 (spoon_101 cat_237)) (spoon_91 cat_204)))
(assert (= cat_205 ((_ to_fp 11 53) RNE cat_204)))
(assert (= cat_250 (mk_potato_11 cat_184)))
(assert (= cat_251 cat_205))
(assert (and (= cat_208 (fp.mul RNE cat_243 cat_247)) (spoon_2 (fp.mul RNE cat_243 cat_247))))
(assert (= cat_209 (fp.mul RNE cat_208 cat_251)))
(assert (and (= cat_210 cat_209) (spoon_2 cat_209)))
(assert (and (= cat_206 (fp.mul RNE cat_241 cat_245)) (spoon_2 (fp.mul RNE cat_241 cat_245))))
...
(assert (and (= cat_214 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_141) cat_249)) (spoon_2 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_141) cat_249))))
(assert (= cat_215 (fp.mul RNE cat_214 cat_243)))
(assert (and (= cat_216 cat_215) (spoon_2 cat_215)))
(assert (= cat_254 (mk_potato_11 cat_188)))
(assert (= cat_255 cat_216))
(assert (=> (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_253) (and (= cat_217 (fp.div RNE cat_255 cat_253)) (spoon_2 (fp.div RNE cat_255 cat_253)))))
(assert (=> (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_253) (= cat_256 spoon_272)))
(assert (=> (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_253) (= cat_257 cat_217)))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_253)) (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_253) (and (= cat_223 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_253)) (spoon_2 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_253))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_253)) (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_253) (= cat_224 (ite (fp.leq cat_255 cat_223) true false)))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_253)) (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_253) (and (= cat_222 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_253)) (spoon_2 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_253))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_253)) (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_253) (= cat_225 (ite (fp.leq cat_222 cat_255) true false)))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_253)) (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_253) (= cat_259 (ite (= cat_225 true) cat_224 false)))))
...
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_253)) (=> (not (= cat_259 true)) (=> (fp.lt cat_253 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_220 (ite (fp.leq cat_255 cat_219) true false))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_253)) (=> (not (= cat_259 true)) (=> (fp.lt cat_253 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (and (= cat_218 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_253)) (spoon_2 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_253)))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_253)) (=> (not (= cat_259 true)) (=> (fp.lt cat_253 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_221 (ite (fp.leq cat_218 cat_255) true false))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_253)) (=> (not (= cat_259 true)) (=> (fp.lt cat_253 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_258 (ite (= cat_221 true) cat_220 false))))))
...
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_253)) (=> (= cat_258 true) (and (= cat_226 (fp.div RNE cat_255 cat_253)) (spoon_2 (fp.div RNE cat_255 cat_253))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_253)) (=> (= cat_258 true) (= cat_260 spoon_272))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_253)) (=> (= cat_258 true) (= cat_261 cat_226))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_253)) (=> (not (= cat_258 true)) (=> (fp.lt cat_255 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_262 spoon_272)))))
...
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_253)) (=> (not (= cat_258 true)) (=> (not (fp.lt cat_255 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))) (= cat_264 spoon_272)))))
...
(assert (and (= cat_227 (fp.mul RNE cat_241 cat_247)) (spoon_2 (fp.mul RNE cat_241 cat_247))))
(assert (= cat_266 (mk_potato_11 cat_185)))
(assert (= cat_267 cat_227))
(assert (and (= cat_228 (fp.mul RNE cat_243 cat_245)) (spoon_2 (fp.mul RNE cat_243 cat_245))))
(assert (= cat_229 (fp.mul RNE cat_228 cat_251)))
(assert (and (= cat_230 cat_229) (spoon_2 cat_229)))
(assert (= cat_268 (mk_potato_11 cat_186)))
(assert (= cat_269 cat_230))
(assert (and (= cat_231 (fp.sub RNE cat_267 cat_269)) (spoon_2 (fp.sub RNE cat_267 cat_269))))
...
(assert (= cat_271 cat_233))
(assert (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_253))
(assert (not (not (fp.isZero cat_253))))
(check-sat)
(exit)
