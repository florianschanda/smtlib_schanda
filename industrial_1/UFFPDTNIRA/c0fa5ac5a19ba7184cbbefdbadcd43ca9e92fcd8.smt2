...
(define-fun spoon_276 () potato_11 (mk_potato_11 cat_178))
...
(assert (= cat_238 cat_181))
(assert (= cat_239 cat_195))
...
(assert (= cat_242 cat_182))
(assert (= cat_243 cat_197))
(assert (and (= cat_198 (spoon_103 cat_239)) (spoon_95 cat_198)))
(assert (= cat_199 ((_ to_fp 11 53) RNE cat_198)))
(assert (= cat_244 cat_183))
(assert (= cat_245 cat_199))
(assert (and (= cat_200 (spoon_105 cat_239)) (spoon_95 cat_200)))
(assert (= cat_201 ((_ to_fp 11 53) RNE cat_200)))
(assert (= cat_246 cat_184))
(assert (= cat_247 cat_201))
(assert (and (= cat_202 (spoon_103 cat_243)) (spoon_95 cat_202)))
(assert (= cat_203 ((_ to_fp 11 53) RNE cat_202)))
(assert (= cat_248 (mk_potato_11 cat_185)))
(assert (= cat_249 cat_203))
(assert (and (= cat_204 (spoon_105 cat_243)) (spoon_95 cat_204)))
(assert (= cat_205 ((_ to_fp 11 53) RNE cat_204)))
(assert (= cat_250 (mk_potato_11 cat_186)))
(assert (= cat_251 cat_205))
(assert (and (= cat_206 (spoon_103 cat_241)) (spoon_95 cat_206)))
(assert (= cat_207 ((_ to_fp 11 53) RNE cat_206)))
(assert (= cat_252 (mk_potato_11 cat_187)))
(assert (= cat_253 cat_207))
(assert (and (= cat_208 (spoon_105 cat_241)) (spoon_95 cat_208)))
(assert (= cat_209 ((_ to_fp 11 53) RNE cat_208)))
(assert (= cat_254 (mk_potato_11 cat_188)))
(assert (= cat_255 cat_209))
(assert (and (= cat_212 (fp.mul RNE cat_247 cat_251)) (spoon_3 (fp.mul RNE cat_247 cat_251))))
(assert (= cat_213 (fp.mul RNE cat_212 cat_255)))
(assert (and (= cat_214 cat_213) (spoon_3 cat_213)))
(assert (and (= cat_210 (fp.mul RNE cat_245 cat_249)) (spoon_3 (fp.mul RNE cat_245 cat_249))))
...
(assert (= cat_256 (mk_potato_11 cat_191)))
(assert (= cat_257 cat_217))
(assert (and (= cat_218 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_145) cat_253)) (spoon_3 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_145) cat_253))))
(assert (= cat_219 (fp.mul RNE cat_218 cat_247)))
(assert (and (= cat_220 cat_219) (spoon_3 cat_219)))
(assert (= cat_258 (mk_potato_11 cat_192)))
(assert (= cat_259 cat_220))
(assert (=> (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_257) (and (= cat_221 (fp.div RNE cat_259 cat_257)) (spoon_3 (fp.div RNE cat_259 cat_257)))))
(assert (=> (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_257) (= cat_260 spoon_276)))
(assert (=> (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_257) (= cat_261 cat_221)))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_257)) (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_257) (and (= cat_227 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_257)) (spoon_3 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_257))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_257)) (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_257) (= cat_228 (ite (fp.leq cat_259 cat_227) true false)))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_257)) (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_257) (and (= cat_226 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_257)) (spoon_3 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_257))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_257)) (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_257) (= cat_229 (ite (fp.leq cat_226 cat_259) true false)))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_257)) (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_257) (= cat_263 (ite (= cat_229 true) cat_228 false)))))
...
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_257)) (=> (not (= cat_263 true)) (=> (fp.lt cat_257 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (and (= cat_223 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_257)) (spoon_3 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_257)))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_257)) (=> (not (= cat_263 true)) (=> (fp.lt cat_257 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_224 (ite (fp.leq cat_259 cat_223) true false))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_257)) (=> (not (= cat_263 true)) (=> (fp.lt cat_257 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (and (= cat_222 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_257)) (spoon_3 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_257)))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_257)) (=> (not (= cat_263 true)) (=> (fp.lt cat_257 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_225 (ite (fp.leq cat_222 cat_259) true false))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_257)) (=> (not (= cat_263 true)) (=> (fp.lt cat_257 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_262 (ite (= cat_225 true) cat_224 false))))))
...
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_257)) (=> (= cat_262 true) (and (= cat_230 (fp.div RNE cat_259 cat_257)) (spoon_3 (fp.div RNE cat_259 cat_257))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_257)) (=> (= cat_262 true) (= cat_264 spoon_276))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_257)) (=> (= cat_262 true) (= cat_265 cat_230))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_257)) (=> (not (= cat_262 true)) (=> (fp.lt cat_259 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_266 spoon_276)))))
...
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_257)) (=> (not (= cat_262 true)) (=> (not (fp.lt cat_259 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))) (= cat_268 spoon_276)))))
...
(assert (and (= cat_231 (fp.mul RNE cat_245 cat_251)) (spoon_3 (fp.mul RNE cat_245 cat_251))))
(assert (= cat_270 (mk_potato_11 cat_189)))
(assert (= cat_271 cat_231))
(assert (and (= cat_232 (fp.mul RNE cat_247 cat_249)) (spoon_3 (fp.mul RNE cat_247 cat_249))))
(assert (= cat_233 (fp.mul RNE cat_232 cat_255)))
(assert (and (= cat_234 cat_233) (spoon_3 cat_233)))
(assert (= cat_272 (mk_potato_11 cat_190)))
(assert (= cat_273 cat_234))
(assert (and (= cat_235 (fp.sub RNE cat_271 cat_273)) (spoon_3 (fp.sub RNE cat_271 cat_273))))
...
(assert (= cat_274 (mk_potato_11 cat_193)))
(assert (= cat_275 cat_237))
(assert (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_257))
(assert (not (not (fp.isZero cat_257))))
(check-sat)
(exit)
