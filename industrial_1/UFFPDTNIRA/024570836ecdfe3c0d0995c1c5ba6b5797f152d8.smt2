...
(assert (and (= cat_230 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_259)) (spoon_3 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_259))))
...
(assert (and (= cat_241 (fp.mul RNE cat_265 ((_ to_fp 11 53) RNE cat_183))) (spoon_3 (fp.mul RNE cat_265 ((_ to_fp 11 53) RNE cat_183)))))
(assert (= cat_242 (fp.mul RNE cat_241 cat_271)))
(assert (and (= cat_243 cat_242) (spoon_3 cat_242)))
(assert (and (= cat_237 (fp.sub RNE cat_267 cat_261)) (spoon_3 (fp.sub RNE cat_267 cat_261))))
...
(assert (and (= cat_247 (fp.add RNE cat_267 cat_261)) (spoon_3 (fp.add RNE cat_267 cat_261))))
...
(assert (and (= cat_250 (fp.div RNE cat_273 cat_275)) (spoon_3 (fp.div RNE cat_273 cat_275))))
...
(assert (=> (not (fp.lt cat_277 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_277)) (and (= cat_251 cat_277) (spoon_3 cat_277)))))
...
(assert (not (spoon_3 (fp.mul RNE cat_265 ((_ to_fp 11 53) RNE cat_181)))))
(check-sat)
(exit)
