...
(declare-const cat_252 potato_19)
(declare-const cat_253 potato_18)
...
(assert (= cat_251 (spoon_37 1)))
(assert (= cat_252 (mk_potato_19 (mk_potato_18 cat_201 cat_202))))
(assert (= cat_253 (get_potato_20_a cat_85)))
...
(assert (and (= cat_226 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_255)) (spoon_2 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_255))))
...
(assert (and (= cat_237 (fp.mul RNE cat_261 ((_ to_fp 11 53) RNE cat_179))) (spoon_2 (fp.mul RNE cat_261 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_238 (fp.mul RNE cat_237 cat_267)))
(assert (and (= cat_239 cat_238) (spoon_2 cat_238)))
(assert (and (= cat_233 (fp.sub RNE cat_263 cat_257)) (spoon_2 (fp.sub RNE cat_263 cat_257))))
...
(assert (and (= cat_243 (fp.add RNE cat_263 cat_257)) (spoon_2 (fp.add RNE cat_263 cat_257))))
...
(assert (and (= cat_246 (fp.div RNE cat_269 cat_271)) (spoon_2 (fp.div RNE cat_269 cat_271))))
...
(assert (=> (not (fp.lt cat_273 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_273)) (and (= cat_247 cat_273) (spoon_2 cat_273)))))
...
(assert (not (spoon_2 (fp.mul RNE cat_261 ((_ to_fp 11 53) RNE cat_177)))))
(check-sat)
(exit)
