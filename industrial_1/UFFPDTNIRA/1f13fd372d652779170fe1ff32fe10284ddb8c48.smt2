...
(assert (and (= cat_146 (fp.mul RNE cat_150 (fp #b0 #b10000000100 #b1100101001011101110000001101000000111100111100100110))) (spoon_3 (fp.mul RNE cat_150 (fp #b0 #b10000000100 #b1100101001011101110000001101000000111100111100100110)))))
(assert (= cat_150 cat_153))
(assert (= cat_154 cat_146))
(assert (and (= cat_147 (fp.div RNE cat_154 cat_152)) (spoon_3 (fp.div RNE cat_154 cat_152))))
