...
(assert (= (mk_potato_11 cat_149) (mk_potato_11 cat_128)))
(assert (= cat_150 cat_141))
...
(assert (= (mk_potato_11 cat_151) (mk_potato_11 cat_129)))
(assert (= cat_152 cat_145))
(assert (and (= cat_146 (fp.mul RNE cat_150 (fp #b0 #b10000000100 #b1100101001011101110000001101000000111100111100100110))) (spoon_2 (fp.mul RNE cat_150 (fp #b0 #b10000000100 #b1100101001011101110000001101000000111100111100100110)))))
(assert (= cat_150 cat_153))
(assert (= cat_154 cat_146))
(assert (and (= cat_147 (fp.div RNE cat_154 cat_152)) (spoon_2 (fp.div RNE cat_154 cat_152))))
(assert (= cat_148 ((_ to_fp 8 24) RNE cat_147)))
(assert (not (spoon_53 cat_148)))
(check-sat)
(exit)
