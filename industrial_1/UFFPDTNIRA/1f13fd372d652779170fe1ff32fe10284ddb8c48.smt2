...
(assert (= (mk_potato_11 cat_145) (mk_potato_11 cat_124)))
(assert (= cat_146 cat_137))
...
(assert (= (mk_potato_11 cat_147) (mk_potato_11 cat_125)))
(assert (= cat_148 cat_141))
(assert (and (= cat_142 (fp.mul RNE cat_146 (fp #b0 #b10000000100 #b1100101001011101110000001101000000111100111100100110))) (spoon_2 (fp.mul RNE cat_146 (fp #b0 #b10000000100 #b1100101001011101110000001101000000111100111100100110)))))
(assert (= cat_146 cat_149))
(assert (= cat_150 cat_142))
(assert (and (= cat_143 (fp.div RNE cat_150 cat_148)) (spoon_2 (fp.div RNE cat_150 cat_148))))
(assert (= cat_144 ((_ to_fp 8 24) RNE cat_143)))
(assert (not (spoon_49 cat_144)))
(check-sat)
(exit)
