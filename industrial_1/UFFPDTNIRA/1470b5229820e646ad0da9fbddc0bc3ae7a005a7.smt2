...
(assert (= cat_71 (fp.sub roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv128 8) (_ bv0 23)) (spoon_34 (get_potato_13_a (get_potato_15_a cat_58)))) (spoon_34 (get_potato_13_a (get_potato_15_a cat_56))))))
(assert (= cat_72 (fp.sub roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv128 8) (_ bv0 23)) (spoon_34 (get_potato_13_b (get_potato_15_a cat_58)))) (spoon_34 (get_potato_13_b (get_potato_15_a cat_56))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv139 8) (_ bv0 23)))) (let ((_let_1 (fp.neg _let_0))) (=> (not (fp.lt cat_71 _let_1)) (=> (not (fp.lt _let_0 cat_71)) (=> (not (fp.lt cat_72 _let_1)) (fp.lt _let_0 cat_72)))))))
(assert (not (fp.eq cat_71 (fp.sub roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv128 8) (_ bv0 23)) (spoon_34 (get_potato_13_a (get_potato_15_a cat_58)))) (spoon_34 (get_potato_13_a (get_potato_15_a cat_56)))))))
(check-sat)
(exit)
