...
(declare-const cat_257 potato_7)
(declare-const cat_258 Bool)
(declare-const cat_259 potato_25)
(declare-const cat_260 potato_24)
(declare-const cat_261 Bool)
(declare-const cat_262 Bool)
(declare-const cat_263 potato_24)
...
(declare-const cat_272 potato_7)
...
(assert (= cat_257 (mk_potato_7 cat_203)))
(assert (= cat_258 (spoon_37 1)))
(assert (= cat_259 (mk_potato_25 (mk_potato_24 cat_201 cat_202))))
(assert (= cat_260 (get_potato_26_a cat_111)))
(assert (= cat_225 (spoon_113 cat_167 cat_74)))
(assert (= cat_261 (ite (not (= cat_225 true)) true false)))
(assert (= cat_261 true))
(assert (=> (= cat_262 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_263))) (and (= cat_226 (spoon_149 (fp #b0 #b10000101 #b01100111111101011101000))) (spoon_129 cat_226)))))
(assert (=> (= cat_262 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_263))) (= cat_264 (mk_potato_10 cat_256)))))
(assert (=> (= cat_262 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_263))) (= cat_265 cat_226))))
(assert (=> (= cat_262 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_263)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_263)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (and (= cat_227 (spoon_149 (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (spoon_129 cat_227))))))
(assert (=> (= cat_262 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_263)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_263)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_266 (mk_potato_10 cat_256))))))
(assert (=> (= cat_262 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_263)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_263)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_267 cat_227)))))
(assert (=> (= cat_262 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_263)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_263)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_228 (spoon_84 (get_potato_24_a cat_263))) (spoon_1 (spoon_84 (get_potato_24_a cat_263))))))))
(assert (=> (= cat_262 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_263)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_263)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_229 (spoon_149 cat_228)) (spoon_129 cat_229))))))
(assert (=> (= cat_262 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_263)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_263)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_268 (mk_potato_10 cat_256))))))
(assert (=> (= cat_262 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_263)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_263)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_269 cat_229)))))
(assert (=> (= cat_262 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_263)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_263)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_267 cat_269)))))
(assert (=> (= cat_262 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_263)))) (= cat_265 cat_267))))
(assert (=> (= cat_262 true) (=> (spoon_189 cat_175) (and (= cat_230 (fp.mul RNE cat_175 cat_175)) (spoon_1 (fp.mul RNE cat_175 cat_175))))))
(assert (=> (= cat_262 true) (=> (spoon_189 cat_175) (= cat_270 (mk_potato_10 cat_254)))))
(assert (=> (= cat_262 true) (=> (spoon_189 cat_175) (= cat_271 cat_230))))
(assert (=> (= cat_262 true) (=> (spoon_189 cat_175) (= cat_273 cat_262))))
(assert (=> (= cat_262 true) (=> (not (spoon_189 cat_175)) (= cat_272 (mk_potato_7 cat_262)))))
(assert (=> (= cat_262 true) (=> (not (spoon_189 cat_175)) (= cat_273 (spoon_37 0)))))
(assert (=> (= cat_262 true) (=> (not (spoon_189 cat_175)) (= cat_271 cat_254))))
(assert (=> (= cat_262 true) (= cat_274 (mk_potato_10 cat_248))))
(assert (=> (= cat_262 true) (= cat_275 ((_ to_fp 8 24) RNE (fp.sub RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) (fp.mul RNE cat_171 cat_171))))))
(assert (=> (= cat_262 true) (and (= cat_231 cat_275) (spoon_1 cat_275))))
(assert (=> (= cat_262 true) (and (= cat_232 (spoon_146 cat_231)) (spoon_138 cat_232))))
(assert (=> (= cat_262 true) (= cat_276 (mk_potato_10 cat_246))))
(assert (=> (= cat_262 true) (= cat_277 cat_232)))
(assert (=> (not (= cat_262 true)) (= cat_265 cat_256)))
(assert (=> (not (= cat_262 true)) (= cat_271 cat_254)))
(assert (=> (not (= cat_262 true)) (= cat_275 cat_248)))
(assert (=> (not (= cat_262 true)) (= cat_277 cat_246)))
(assert (=> (not (= cat_262 true)) (= cat_273 cat_262)))
(assert (=> (= cat_273 true) (and (= cat_233 (fp.sub RNE cat_275 cat_271)) (spoon_1 (fp.sub RNE cat_275 cat_271)))))
(assert (=> (= cat_273 true) (= cat_234 (fp.add RNE cat_233 (fp.mul RNE cat_265 cat_265)))))
(assert (=> (= cat_273 true) (and (= cat_235 cat_234) (spoon_1 cat_234))))
(assert (=> (= cat_273 true) (= cat_278 (mk_potato_10 cat_252))))
(assert (=> (= cat_273 true) (= cat_279 cat_235)))
(assert (=> (= cat_273 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_279) (and (= cat_236 cat_279) (spoon_1 cat_279)))))
(assert (=> (= cat_273 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_279) (and (= cat_237 (spoon_146 cat_236)) (spoon_138 cat_237)))))
(assert (=> (= cat_273 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_279) (= cat_280 (mk_potato_10 cat_250)))))
(assert (=> (= cat_273 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_279) (= cat_281 cat_237))))
(assert (=> (= cat_273 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_279) (= cat_283 cat_273))))
(assert (=> (= cat_273 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_279)) (= cat_282 (mk_potato_7 cat_273)))))
(assert (=> (= cat_273 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_279)) (= cat_283 (spoon_37 0)))))
(assert (=> (= cat_273 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_279)) (= cat_281 cat_250))))
(assert (=> (not (= cat_273 true)) (= cat_279 cat_252)))
(assert (=> (not (= cat_273 true)) (= cat_281 cat_250)))
(assert (=> (not (= cat_273 true)) (= cat_283 cat_273)))
(assert (= cat_283 true))
(assert (and (= cat_242 (fp.mul RNE cat_281 cat_175)) (spoon_1 (fp.mul RNE cat_281 cat_175))))
(assert (and (= cat_238 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_171 cat_171)) cat_271)) (spoon_1 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_171 cat_171)) cat_271))))
(assert (= cat_239 (fp.mul RNE cat_277 cat_238)))
(assert (and (= cat_240 cat_239) (spoon_1 cat_239)))
(assert (= cat_241 (fp.mul RNE cat_240 cat_265)))
(assert (and (= cat_243 cat_241) (spoon_1 cat_241)))
(assert (= cat_244 (fp.sub RNE cat_243 cat_242)))
(assert (not (spoon_1 cat_244)))
(check-sat)
(exit)
