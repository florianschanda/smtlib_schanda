...
(declare-const cat_182 potato_25)
(declare-const cat_183 potato_25)
...
(declare-const cat_188 potato_31)
...
(assert (= cat_180 cat_163))
(assert (= cat_181 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_69 cat_181))
...
(assert (= cat_182 cat_156))
(assert (= cat_183 cat_157))
(assert (= cat_170 cat_184))
(assert (= cat_171 cat_185))
...
(assert (= cat_188 (mk_potato_31 cat_176 cat_177)))
(assert (= cat_189 (mk_potato_10 cat_160)))
(assert (= cat_190 (fp.add RNE (fp.mul RNE (spoon_92 cat_184) (spoon_92 (get_potato_31_a cat_188))) (fp.mul RNE (spoon_92 cat_185) (spoon_92 (get_potato_31_b cat_188))))))
(assert (and (= cat_178 (spoon_104 cat_108 cat_106)) (spoon_61 cat_178)))
(assert (= cat_191 (mk_potato_10 cat_161)))
...
(assert (fp.lt (fp #b0 #b01110101 #b00000110001001001101111) cat_192))
(assert (fp.lt (fp #b0 #b01110101 #b00000110001001001101111) cat_194))
(assert (not (spoon_1 (fp.div RNE cat_190 (fp.mul RNE cat_192 cat_194)))))
(check-sat)
(exit)
