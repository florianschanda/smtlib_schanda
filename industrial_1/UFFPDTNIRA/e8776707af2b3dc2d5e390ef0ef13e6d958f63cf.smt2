...
(declare-const cat_267 potato_29)
(declare-const cat_268 potato_28)
...
(define-fun spoon_300 () potato_11 (mk_potato_11 cat_211))
...
(assert (= cat_265 (mk_potato_7 cat_203)))
(assert (= cat_266 (distinct 1 0)))
(assert (= cat_267 (mk_potato_29 (mk_potato_28 cat_201 cat_202))))
(assert (= cat_268 (get_potato_30_a cat_138)))
(assert (= cat_269 (mk_potato_11 cat_206)))
(assert (= cat_270 (fp.mul RNE cat_181 cat_181)))
(assert (and (= cat_224 ((_ to_fp 11 53) RNE (fp.mul RNE cat_177 cat_177))) (spoon_3 ((_ to_fp 11 53) RNE (fp.mul RNE cat_177 cat_177)))))
(assert (= cat_271 (mk_potato_11 cat_204)))
(assert (= cat_272 cat_224))
(assert (and (= cat_225 ((_ to_fp 11 53) RNE (fp.mul RNE cat_179 cat_179))) (spoon_3 ((_ to_fp 11 53) RNE (fp.mul RNE cat_179 cat_179)))))
(assert (= cat_273 (mk_potato_11 cat_205)))
(assert (= cat_274 cat_225))
(assert (= cat_275 (mk_potato_11 cat_207)))
(assert (= cat_276 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_181)))
(assert (and (= cat_226 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_270)) (spoon_3 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_270))))
(assert (= cat_277 (mk_potato_11 cat_208)))
(assert (= cat_278 cat_226))
...
(assert (= cat_281 (mk_potato_11 cat_210)))
(assert (= cat_282 cat_232))
(assert (and (= cat_237 (fp.mul RNE cat_276 ((_ to_fp 11 53) RNE cat_179))) (spoon_3 (fp.mul RNE cat_276 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_238 (fp.mul RNE cat_237 cat_282)))
(assert (and (= cat_239 cat_238) (spoon_3 cat_238)))
(assert (and (= cat_233 (fp.sub RNE cat_278 cat_272)) (spoon_3 (fp.sub RNE cat_278 cat_272))))
(assert (= cat_234 (fp.sub RNE cat_233 cat_274)))
(assert (and (= cat_235 cat_234) (spoon_3 cat_234)))
(assert (= cat_236 (fp.mul RNE cat_235 cat_280)))
...
(assert (= cat_283 (mk_potato_11 cat_213)))
(assert (= cat_284 cat_242))
(assert (and (= cat_243 (fp.add RNE cat_278 cat_272)) (spoon_3 (fp.add RNE cat_278 cat_272))))
(assert (= cat_244 (fp.add RNE cat_243 cat_274)))
(assert (and (= cat_245 cat_244) (spoon_3 cat_244)))
(assert (= cat_285 (mk_potato_11 cat_214)))
(assert (= cat_286 cat_245))
(assert (and (= cat_246 (fp.div RNE cat_284 cat_286)) (spoon_3 (fp.div RNE cat_284 cat_286))))
(assert (= cat_287 (mk_potato_11 cat_212)))
(assert (= cat_288 cat_246))
(assert (=> (fp.lt cat_288 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))) (= cat_289 spoon_300)))
...
(assert (=> (not (fp.lt cat_288 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_288) (= cat_291 spoon_300))))
...
(assert (=> (not (fp.lt cat_288 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_288)) (and (= cat_247 cat_288) (spoon_3 cat_288)))))
(assert (=> (not (fp.lt cat_288 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_288)) (= cat_293 spoon_300))))
(assert (=> (not (fp.lt cat_288 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_288)) (= cat_294 cat_247))))
...
(assert (and (= cat_248 (fp.mul RNE cat_276 ((_ to_fp 11 53) RNE cat_177))) (spoon_3 (fp.mul RNE cat_276 ((_ to_fp 11 53) RNE cat_177)))))
(assert (= cat_295 (mk_potato_11 cat_216)))
(assert (= cat_296 cat_248))
(assert (and (= cat_253 (fp.mul RNE cat_276 ((_ to_fp 11 53) RNE cat_179))) (spoon_3 (fp.mul RNE cat_276 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_254 (fp.mul RNE cat_253 cat_280)))
(assert (and (= cat_255 cat_254) (spoon_3 cat_254)))
(assert (and (= cat_249 (fp.sub RNE cat_278 cat_272)) (spoon_3 (fp.sub RNE cat_278 cat_272))))
(assert (= cat_250 (fp.sub RNE cat_249 cat_274)))
(assert (and (= cat_251 cat_250) (spoon_3 cat_250)))
(assert (= cat_252 (fp.mul RNE cat_251 cat_282)))
...
(assert (= cat_297 (mk_potato_11 cat_217)))
(assert (= cat_298 cat_258))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_298) (and (= cat_260 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_298)) (spoon_3 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_298)))))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_298) (= cat_261 (ite (fp.leq cat_296 cat_260) true false))))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_298) (and (= cat_259 (fp.mul RNE (fp.neg (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000)) cat_298)) (spoon_3 (fp.mul RNE (fp.neg (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000)) cat_298)))))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_298) (= cat_262 (ite (fp.leq cat_259 cat_296) true false))))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_298) (= cat_299 (ite (= cat_262 true) cat_261 false))))
(assert (=> (not (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_298)) (= cat_299 false)))
(assert (not (= cat_299 true)))
(assert (fp.lt cat_298 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)))
(assert (not (spoon_3 (fp.mul RNE (fp.neg (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000)) cat_298))))
(check-sat)
(exit)
