...
(assert (fp.lt (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000) cat_106))
...
(assert (not (spoon_40 (fp.sub RNE (fp #b0 #b10001011 #b00000000000000000000000) (spoon_47 (get_potato_14_a (get_potato_16_a cat_67)))))))
(check-sat)
(exit)
