...
(declare-fun cat_107 () (_ FloatingPoint 11 53))
...
(assert (fp.lt (fp (_ bv0 1) (_ bv1035 11) (_ bv0 52)) cat_106))
...
(assert (= (mk_potato_11 cat_107) (mk_potato_11 cat_101)))
...
(assert (not (spoon_40 (fp.sub roundNearestTiesToEven (fp (_ bv0 1) (_ bv139 8) (_ bv0 23)) (spoon_47 (get_potato_14_a (get_potato_16_a cat_67)))))))
(check-sat)
(exit)
