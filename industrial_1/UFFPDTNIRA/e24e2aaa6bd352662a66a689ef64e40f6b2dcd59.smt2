...
(assert (= cat_70 (fp.sub RNE (spoon_30 (get_potato_13_a (get_potato_15_a cat_50))) (spoon_30 (get_potato_13_a (get_potato_15_a cat_52))))))
(assert (= cat_71 (fp.sub RNE (spoon_30 (get_potato_13_b (get_potato_15_a cat_50))) (spoon_30 (get_potato_13_b (get_potato_15_a cat_52))))))
(assert (=> (fp.leq cat_70 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000))) (= cat_72 cat_70)))
(assert (=> (fp.leq cat_70 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000))) (= cat_73 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))))
(assert (=> (not (fp.leq cat_70 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (fp.leq (fp #b0 #b10001011 #b00000000000000000000000) cat_70) (= cat_74 cat_70))))
(assert (=> (not (fp.leq cat_70 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (fp.leq (fp #b0 #b10001011 #b00000000000000000000000) cat_70) (= cat_75 (fp #b0 #b10001011 #b00000000000000000000000)))))
(assert (=> (not (fp.leq cat_70 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.leq (fp #b0 #b10001011 #b00000000000000000000000) cat_70)) (= cat_75 cat_70))))
(assert (=> (not (fp.leq cat_70 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (= cat_73 cat_75)))
