...
(assert (= cat_150 (fp.sub RNE (spoon_32 (get_potato_13_a (get_potato_15_a cat_90))) (spoon_32 (get_potato_13_a (get_potato_15_a cat_88))))))
(assert (= cat_151 cat_136))
(assert (= cat_152 (fp.sub RNE (spoon_32 (get_potato_13_b (get_potato_15_a cat_90))) (spoon_32 (get_potato_13_b (get_potato_15_a cat_88))))))
(assert (= cat_153 cat_137))
(assert (= cat_154 (fp.add RNE (fp.mul RNE cat_150 cat_150) (fp.mul RNE cat_152 cat_152))))
(assert (not (fp.lt cat_154 (fp #b0 #b01110001 #b10100011011011100010111))))
(assert (= cat_155 cat_139))
(assert (= cat_156 (fp.add RNE (fp.mul RNE (fp.sub RNE (spoon_32 (get_potato_13_a (get_potato_15_a cat_86))) (spoon_32 (get_potato_13_a (get_potato_15_a cat_88)))) cat_150) (fp.mul RNE (fp.sub RNE (spoon_32 (get_potato_13_b (get_potato_15_a cat_86))) (spoon_32 (get_potato_13_b (get_potato_15_a cat_88)))) cat_152))))
(assert (and (= cat_143 (fp.div RNE cat_156 cat_154)) (spoon_1 (fp.div RNE cat_156 cat_154))))
(assert (and (= cat_144 cat_143) (spoon_1 cat_143)))
(assert (= cat_157 cat_141))
(assert (= cat_158 cat_144))
(assert (not (fp.leq cat_158 (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (not (fp.leq (fp #b0 #b01111111 #b00000000000000000000000) cat_158)))
(assert (= cat_159 cat_140))
(assert (= cat_160 (fp.add RNE (fp.mul RNE (fp.sub RNE (spoon_32 (get_potato_13_a (get_potato_15_a cat_86))) (spoon_32 (get_potato_13_a (get_potato_15_a cat_88)))) (fp.neg cat_152)) (fp.mul RNE (fp.sub RNE (spoon_32 (get_potato_13_b (get_potato_15_a cat_86))) (spoon_32 (get_potato_13_b (get_potato_15_a cat_88)))) cat_150))))
(assert (and (= cat_145 cat_154) (spoon_1 cat_154)))
(assert (and (= cat_146 (spoon_74 cat_145)) (spoon_66 cat_146)))
(assert (and (= cat_147 cat_146) (spoon_1 cat_146)))
(assert (= cat_161 cat_138))
(assert (= cat_162 cat_147))
(assert (and (= cat_148 (fp.div RNE (fp.abs cat_160) cat_162)) (spoon_1 (fp.div RNE (fp.abs cat_160) cat_162))))
