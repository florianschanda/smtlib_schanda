...
(assert (= cat_147 cat_133))
(assert (= cat_148 (fp.sub RNE (spoon_30 (get_potato_13_a (get_potato_15_a cat_88))) (spoon_30 (get_potato_13_a (get_potato_15_a cat_86))))))
(assert (= cat_149 cat_134))
(assert (= cat_150 (fp.sub RNE (spoon_30 (get_potato_13_b (get_potato_15_a cat_88))) (spoon_30 (get_potato_13_b (get_potato_15_a cat_86))))))
...
(assert (= cat_153 cat_137))
(assert (= cat_154 (fp.add RNE (fp.mul RNE (fp.sub RNE (spoon_30 (get_potato_13_a (get_potato_15_a cat_84))) (spoon_30 (get_potato_13_a (get_potato_15_a cat_86)))) cat_148) (fp.mul RNE (fp.sub RNE (spoon_30 (get_potato_13_b (get_potato_15_a cat_84))) (spoon_30 (get_potato_13_b (get_potato_15_a cat_86)))) cat_150))))
(assert (and (= cat_141 (fp.div RNE cat_154 cat_152)) (spoon_1 (fp.div RNE cat_154 cat_152))))
(assert (and (= cat_142 cat_141) (spoon_1 cat_141)))
(assert (= cat_155 cat_139))
(assert (= cat_156 cat_142))
...
(assert (= cat_157 cat_138))
(assert (= cat_158 (fp.add RNE (fp.mul RNE (fp.sub RNE (spoon_30 (get_potato_13_a (get_potato_15_a cat_84))) (spoon_30 (get_potato_13_a (get_potato_15_a cat_86)))) (fp.neg cat_150)) (fp.mul RNE (fp.sub RNE (spoon_30 (get_potato_13_b (get_potato_15_a cat_84))) (spoon_30 (get_potato_13_b (get_potato_15_a cat_86)))) cat_148))))
(assert (and (= cat_143 cat_152) (spoon_1 cat_152)))
(assert (and (= cat_144 (spoon_72 cat_143)) (spoon_64 cat_144)))
(assert (and (= cat_145 cat_144) (spoon_1 cat_144)))
(assert (= cat_159 cat_136))
(assert (= cat_160 cat_145))
(assert (and (= cat_146 (fp.div RNE (fp.abs cat_158) cat_160)) (spoon_1 (fp.div RNE (fp.abs cat_158) cat_160))))
(assert (not (spoon_48 cat_146)))
(check-sat)
(exit)
