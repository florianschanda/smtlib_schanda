...
(assert (and (= cat_209 (fp.mul RNE cat_224 cat_228)) (spoon_3 (fp.mul RNE cat_224 cat_228))))
(assert (= cat_210 (fp.mul RNE cat_209 cat_232)))
(assert (and (= cat_211 cat_210) (spoon_3 cat_210)))
(assert (and (= cat_207 (fp.mul RNE cat_222 cat_226)) (spoon_3 (fp.mul RNE cat_222 cat_226))))
...
(assert (not (spoon_3 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_156) cat_230))))
(check-sat)
(exit)
