...
(assert (= cat_215 true))
(assert (= cat_205 (fp.sub RNE cat_226 cat_224)))
(assert (spoon_1 (fp.sub RNE cat_226 cat_224)))
(assert (= cat_206 (fp.add RNE cat_205 (fp.mul RNE cat_218 cat_218))))
(assert (= cat_207 cat_206))
(assert (= cat_229 cat_207))
(assert (spoon_1 cat_206))
(assert (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_229))
(assert (not (or (fp.isZero cat_229) (fp.isPositive cat_229))))
(check-sat)
(exit)
