...
(assert (= cat_87 cat_83))
(assert (= cat_88 (fp.sub RNE (spoon_30 (get_potato_13_a (get_potato_15_a cat_76))) (spoon_30 (get_potato_13_a (get_potato_15_a cat_74))))))
(assert (= cat_89 cat_84))
(assert (= cat_90 (fp.sub RNE (spoon_30 (get_potato_13_b (get_potato_15_a cat_76))) (spoon_30 (get_potato_13_b (get_potato_15_a cat_74))))))
(assert (not (or (not (fp.eq cat_88 (fp #b0 #b00000000 #b00000000000000000000000))) (not (fp.eq cat_90 (fp #b0 #b00000000 #b00000000000000000000000))))))
(check-sat)
(exit)
