...
(assert (= cat_89 cat_85))
(assert (= cat_90 (fp.sub RNE (spoon_32 (get_potato_13_a (get_potato_15_a cat_78))) (spoon_32 (get_potato_13_a (get_potato_15_a cat_76))))))
(assert (= cat_91 cat_86))
(assert (= cat_92 (fp.sub RNE (spoon_32 (get_potato_13_b (get_potato_15_a cat_78))) (spoon_32 (get_potato_13_b (get_potato_15_a cat_76))))))
(assert (not (or (not (fp.eq cat_90 (fp #b0 #b00000000 #b00000000000000000000000))) (not (fp.eq cat_92 (fp #b0 #b00000000 #b00000000000000000000000))))))
(check-sat)
(exit)
