...
(declare-const cat_226 potato_28)
...
(declare-const cat_243 potato_7)
...
(assert (= cat_224 true))
(assert (=> (= cat_225 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_226))) (and (= cat_201 (spoon_76 (fp #b0 #b10000101 #b01100111111101011101000))) (spoon_86 cat_201)))))
(assert (=> (= cat_225 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_226))) (= cat_227 (mk_potato_10 cat_223)))))
(assert (=> (= cat_225 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_226))) (= cat_228 cat_201))))
(assert (=> (= cat_225 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_226)))) (=> (fp.lt (spoon_111 (get_potato_28_a cat_226)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (and (= cat_202 (spoon_76 (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (spoon_86 cat_202))))))
(assert (=> (= cat_225 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_226)))) (=> (fp.lt (spoon_111 (get_potato_28_a cat_226)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_229 (mk_potato_10 cat_223))))))
(assert (=> (= cat_225 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_226)))) (=> (fp.lt (spoon_111 (get_potato_28_a cat_226)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_230 cat_202)))))
(assert (=> (= cat_225 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_226)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_226)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_203 (spoon_111 (get_potato_28_a cat_226))) (spoon_1 (spoon_111 (get_potato_28_a cat_226))))))))
(assert (=> (= cat_225 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_226)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_226)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_204 (spoon_76 cat_203)) (spoon_86 cat_204))))))
(assert (=> (= cat_225 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_226)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_226)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_231 (mk_potato_10 cat_223))))))
(assert (=> (= cat_225 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_226)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_226)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_232 cat_204)))))
(assert (=> (= cat_225 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_226)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_226)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_230 cat_232)))))
(assert (=> (= cat_225 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_226)))) (= cat_228 cat_230))))
(assert (=> (= cat_225 true) (= cat_233 (mk_potato_10 cat_222))))
(assert (=> (= cat_225 true) (= cat_234 (fp.mul RNE cat_170 cat_170))))
(assert (=> (= cat_225 true) (= cat_235 (mk_potato_10 cat_219))))
(assert (=> (= cat_225 true) (= cat_236 ((_ to_fp 8 24) RNE (fp.sub RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) (fp.mul RNE cat_166 cat_166))))))
(assert (=> (= cat_225 true) (= cat_237 (mk_potato_10 cat_218))))
(assert (=> (= cat_225 true) (= cat_238 (fp.sqrt RNE cat_236))))
...
(assert (=> (= cat_225 true) (and (= cat_205 (fp.sub RNE cat_236 cat_234)) (spoon_1 (fp.sub RNE cat_236 cat_234)))))
(assert (=> (= cat_225 true) (= cat_206 (fp.add RNE cat_205 (fp.mul RNE cat_228 cat_228)))))
...
(assert (=> (= cat_225 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_240) (= cat_241 (mk_potato_10 cat_220)))))
(assert (=> (= cat_225 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_240) (= cat_242 (fp.sqrt RNE cat_240)))))
(assert (=> (= cat_225 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_240) (= cat_244 cat_225))))
(assert (=> (= cat_225 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_240)) (= cat_243 (mk_potato_7 cat_225)))))
(assert (=> (= cat_225 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_240)) (= cat_244 (distinct 0 0)))))
(assert (=> (= cat_225 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_240)) (= cat_242 cat_220))))
(assert (=> (not (= cat_225 true)) (= cat_240 cat_221)))
(assert (=> (not (= cat_225 true)) (= cat_242 cat_220)))
(assert (=> (not (= cat_225 true)) (= cat_244 cat_225)))
(assert (= cat_244 true))
(assert (= cat_210 (fp.mul RNE cat_242 cat_170)))
(assert (spoon_1 (fp.mul RNE cat_242 cat_170)))
(assert (= cat_208 (fp.mul RNE cat_238 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_166 cat_166)) cat_234))))
(assert (spoon_1 (fp.mul RNE cat_238 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_166 cat_166)) cat_234))))
(assert (= cat_209 (fp.mul RNE cat_208 cat_228)))
(assert (= cat_211 cat_209))
(assert (spoon_1 cat_209))
(assert (= cat_212 (fp.sub RNE cat_211 cat_210)))
(assert (spoon_1 cat_212))
(assert (= cat_213 (fp.mul RNE cat_242 cat_170)))
(assert (spoon_1 (fp.mul RNE cat_242 cat_170)))
(assert (= cat_214 (fp.mul RNE cat_213 cat_228)))
(assert (= cat_215 cat_214))
(assert (spoon_1 cat_214))
(assert (= cat_216 (fp.mul RNE cat_238 cat_240)))
(assert (spoon_1 (fp.mul RNE cat_238 cat_240)))
(assert (= cat_217 (fp.sub RNE cat_216 cat_215)))
