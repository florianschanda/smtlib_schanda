...
(assert (and (= cat_212 (fp.mul RNE cat_246 cat_250)) (spoon_3 (fp.mul RNE cat_246 cat_250))))
(assert (= cat_213 (fp.mul RNE cat_212 cat_254)))
(assert (and (= cat_214 cat_213) (spoon_3 cat_213)))
(assert (and (= cat_210 (fp.mul RNE cat_244 cat_248)) (spoon_3 (fp.mul RNE cat_244 cat_248))))
...
(assert (and (= cat_218 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_145) cat_252)) (spoon_3 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_145) cat_252))))
...
(assert (=> (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_256) (and (= cat_221 (fp.div RNE cat_258 cat_256)) (spoon_3 (fp.div RNE cat_258 cat_256)))))
...
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_256)) (=> (= cat_261 true) (and (= cat_230 (fp.div RNE cat_258 cat_256)) (spoon_3 (fp.div RNE cat_258 cat_256))))))
...
(assert (and (= cat_231 (fp.mul RNE cat_244 cat_250)) (spoon_3 (fp.mul RNE cat_244 cat_250))))
(assert (= cat_269 (mk_potato_11 cat_189)))
(assert (= cat_270 cat_231))
(assert (and (= cat_232 (fp.mul RNE cat_246 cat_248)) (spoon_3 (fp.mul RNE cat_246 cat_248))))
...
(assert (and (= cat_235 (fp.sub RNE cat_270 cat_272)) (spoon_3 (fp.sub RNE cat_270 cat_272))))
