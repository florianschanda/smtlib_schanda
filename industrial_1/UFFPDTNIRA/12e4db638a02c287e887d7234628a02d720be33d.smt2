...
(declare-const cat_189 potato_31)
...
(assert (= cat_181 cat_163))
(assert (= cat_182 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_69 cat_182))
...
(assert (= cat_183 cat_156))
(assert (= cat_184 cat_157))
(assert (= cat_170 cat_185))
(assert (= cat_171 cat_186))
...
(assert (= cat_189 (mk_potato_31 cat_176 cat_177)))
(assert (= cat_190 (mk_potato_10 cat_160)))
(assert (= cat_191 (fp.add RNE (fp.mul RNE (spoon_92 cat_185) (spoon_92 (get_potato_31_a cat_189))) (fp.mul RNE (spoon_92 cat_186) (spoon_92 (get_potato_31_b cat_189))))))
(assert (and (= cat_178 (spoon_104 cat_108 cat_106)) (spoon_61 cat_178)))
(assert (= cat_192 (mk_potato_10 cat_161)))
...
(assert (fp.lt (fp #b0 #b01110101 #b00000110001001001101111) cat_193))
(assert (fp.lt (fp #b0 #b01110101 #b00000110001001001101111) cat_195))
(assert (and (= cat_180 (fp.div RNE cat_191 (fp.mul RNE cat_193 cat_195))) (spoon_1 (fp.div RNE cat_191 (fp.mul RNE cat_193 cat_195)))))
(assert (not (spoon_144 cat_180)))
(check-sat)
(exit)
