...
(declare-const cat_255 potato_25)
(declare-const cat_256 potato_24)
(declare-const cat_257 Bool)
(declare-const cat_258 Bool)
(declare-const cat_259 potato_24)
...
(assert (= cat_254 (spoon_37 1)))
(assert (= cat_255 (mk_potato_25 (mk_potato_24 cat_201 cat_202))))
(assert (= cat_256 (get_potato_26_a cat_111)))
(assert (= cat_225 (spoon_113 cat_167 cat_74)))
(assert (= cat_257 (ite (not (= cat_225 true)) true false)))
(assert (= cat_257 true))
(assert (=> (= cat_258 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_259))) (and (= cat_226 (spoon_149 (fp #b0 #b10000101 #b01100111111101011101000))) (spoon_129 cat_226)))))
(assert (=> (= cat_258 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_259))) (= cat_260 (mk_potato_10 cat_252)))))
(assert (=> (= cat_258 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_259))) (= cat_261 cat_226))))
(assert (=> (= cat_258 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_259)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_259)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (and (= cat_227 (spoon_149 (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (spoon_129 cat_227))))))
(assert (=> (= cat_258 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_259)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_259)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_262 (mk_potato_10 cat_252))))))
(assert (=> (= cat_258 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_259)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_259)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_263 cat_227)))))
(assert (=> (= cat_258 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_259)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_259)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_228 (spoon_84 (get_potato_24_a cat_259))) (spoon_1 (spoon_84 (get_potato_24_a cat_259))))))))
(assert (=> (= cat_258 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_259)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_259)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_229 (spoon_149 cat_228)) (spoon_129 cat_229))))))
(assert (=> (= cat_258 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_259)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_259)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_264 (mk_potato_10 cat_252))))))
(assert (=> (= cat_258 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_259)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_259)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_265 cat_229)))))
(assert (=> (= cat_258 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_259)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_259)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_263 cat_265)))))
(assert (=> (= cat_258 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_259)))) (= cat_261 cat_263))))
(assert (=> (= cat_258 true) (=> (spoon_189 cat_175) (and (= cat_230 (fp.mul RNE cat_175 cat_175)) (spoon_1 (fp.mul RNE cat_175 cat_175))))))
(assert (=> (= cat_258 true) (=> (spoon_189 cat_175) (= cat_266 (mk_potato_10 cat_250)))))
(assert (=> (= cat_258 true) (=> (spoon_189 cat_175) (= cat_267 cat_230))))
(assert (=> (= cat_258 true) (=> (spoon_189 cat_175) (= cat_269 cat_258))))
(assert (=> (= cat_258 true) (=> (not (spoon_189 cat_175)) (= cat_268 (mk_potato_7 cat_258)))))
(assert (=> (= cat_258 true) (=> (not (spoon_189 cat_175)) (= cat_269 (spoon_37 0)))))
(assert (=> (= cat_258 true) (=> (not (spoon_189 cat_175)) (= cat_267 cat_250))))
(assert (=> (= cat_258 true) (= cat_270 (mk_potato_10 cat_244))))
(assert (=> (= cat_258 true) (= cat_271 ((_ to_fp 8 24) RNE (fp.sub RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) (fp.mul RNE cat_171 cat_171))))))
(assert (=> (= cat_258 true) (and (= cat_231 cat_271) (spoon_1 cat_271))))
(assert (=> (= cat_258 true) (and (= cat_232 (spoon_146 cat_231)) (spoon_138 cat_232))))
(assert (=> (= cat_258 true) (= cat_272 (mk_potato_10 cat_242))))
(assert (=> (= cat_258 true) (= cat_273 cat_232)))
(assert (=> (not (= cat_258 true)) (= cat_261 cat_252)))
(assert (=> (not (= cat_258 true)) (= cat_267 cat_250)))
(assert (=> (not (= cat_258 true)) (= cat_271 cat_244)))
(assert (=> (not (= cat_258 true)) (= cat_273 cat_242)))
(assert (=> (not (= cat_258 true)) (= cat_269 cat_258)))
(assert (=> (= cat_269 true) (and (= cat_233 (fp.sub RNE cat_271 cat_267)) (spoon_1 (fp.sub RNE cat_271 cat_267)))))
(assert (=> (= cat_269 true) (= cat_234 (fp.add RNE cat_233 (fp.mul RNE cat_261 cat_261)))))
(assert (=> (= cat_269 true) (and (= cat_235 cat_234) (spoon_1 cat_234))))
(assert (=> (= cat_269 true) (= cat_274 (mk_potato_10 cat_248))))
(assert (=> (= cat_269 true) (= cat_275 cat_235)))
(assert (=> (= cat_269 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_275) (and (= cat_236 cat_275) (spoon_1 cat_275)))))
(assert (=> (= cat_269 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_275) (and (= cat_237 (spoon_146 cat_236)) (spoon_138 cat_237)))))
(assert (=> (= cat_269 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_275) (= cat_276 (mk_potato_10 cat_246)))))
(assert (=> (= cat_269 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_275) (= cat_277 cat_237))))
(assert (=> (= cat_269 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_275) (= cat_279 cat_269))))
(assert (=> (= cat_269 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_275)) (= cat_278 (mk_potato_7 cat_269)))))
(assert (=> (= cat_269 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_275)) (= cat_279 (spoon_37 0)))))
(assert (=> (= cat_269 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_275)) (= cat_277 cat_246))))
(assert (=> (not (= cat_269 true)) (= cat_275 cat_248)))
(assert (=> (not (= cat_269 true)) (= cat_277 cat_246)))
(assert (=> (not (= cat_269 true)) (= cat_279 cat_269)))
(assert (= cat_279 true))
(assert (and (= cat_240 (fp.mul RNE cat_277 cat_175)) (spoon_1 (fp.mul RNE cat_277 cat_175))))
(assert (and (= cat_238 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_171 cat_171)) cat_267)) (spoon_1 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_171 cat_171)) cat_267))))
(assert (= cat_239 (fp.mul RNE cat_273 cat_238)))
(assert (not (spoon_1 cat_239)))
(check-sat)
(exit)
