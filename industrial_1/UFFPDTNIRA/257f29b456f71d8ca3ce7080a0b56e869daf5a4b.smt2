...
(define-fun spoon_139 () potato_15 (mk_potato_15 (mk_potato_14 cat_106 cat_107)))
(define-fun spoon_140 () potato_11 (mk_potato_11 cat_105))
...
(assert (=> (fp.lt (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000) cat_128) (= (mk_potato_11 cat_129) spoon_140)))
...
(assert (=> (fp.lt (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000) cat_128) (= cat_131 spoon_139)))
...
(assert (=> (not (fp.lt (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000) cat_128)) (=> (fp.lt cat_128 (fp.neg (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000))) (= cat_133 spoon_140))))
...
(assert (=> (not (fp.lt (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000) cat_128)) (=> (fp.lt cat_128 (fp.neg (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000))) (= cat_135 spoon_139))))
...
(assert (=> (not (fp.lt (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000) cat_128)) (=> (not (fp.lt cat_128 (fp.neg (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000)))) (= cat_137 spoon_139))))
...
(assert (not (spoon_46 (fp.add RNE (spoon_53 (get_potato_14_a (get_potato_16_a cat_71))) (spoon_53 (get_potato_14_a cat_132))))))
(check-sat)
(exit)
