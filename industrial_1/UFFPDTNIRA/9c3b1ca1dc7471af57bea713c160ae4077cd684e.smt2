...
(assert (forall ((kitten_29 (_ FloatingPoint 8 24)) (kitten_30 (_ FloatingPoint 8 24))) (! (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp (_ bv0 1) (_ bv127 8) (_ bv0 23)))) (let ((_let_2 (spoon_30 kitten_29 kitten_30))) (=> (and (and (spoon_29 kitten_29 true true true true) (spoon_29 kitten_30 true true true true)) (and (fp.lt _let_0 kitten_30) (fp.leq (fp.abs kitten_29) _let_1))) (and (=> (fp.eq kitten_29 _let_1) (fp.eq _let_2 _let_0)) (spoon_29 _let_2 true false true true)))))) :pattern ((spoon_30 kitten_29 kitten_30)))))
(declare-sort potato_13 0)
(define-fun spoon_32 ((kitten_32 (_ FloatingPoint 8 24))) Bool (and (spoon_1 kitten_32) (and (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) kitten_32) (fp.leq kitten_32 (fp (_ bv0 1) (_ bv134 8) (_ bv3407872 23))))))
...
(define-fun spoon_50 ((kitten_41 (_ FloatingPoint 8 24)) (kitten_42 Bool) (kitten_43 Bool) (kitten_44 Bool) (kitten_45 Bool)) Bool (=> (or (= kitten_42 true) (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) (fp (_ bv0 1) (_ bv134 8) (_ bv3407872 23)))) (spoon_32 kitten_41)))
...
(assert (=> (fp.eq cat_47 (fp (_ bv0 1) (_ bv127 8) (_ bv0 23))) (fp.eq cat_52 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))))
(assert (= cat_53 cat_52))
(assert (=> (fp.lt (fp (_ bv0 1) (_ bv134 8) (_ bv3407872 23)) cat_53) (= cat_54 cat_53)))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv134 8) (_ bv3407872 23)))) (=> (fp.lt _let_0 cat_53) (= cat_55 _let_0))))
(assert (=> (not (fp.lt (fp (_ bv0 1) (_ bv134 8) (_ bv3407872 23)) cat_53)) (=> (fp.lt cat_53 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))) (= cat_56 cat_53))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (not (fp.lt (fp (_ bv0 1) (_ bv134 8) (_ bv3407872 23)) cat_53)) (=> (fp.lt cat_53 _let_0) (= cat_57 _let_0)))))
(assert (=> (not (fp.lt (fp (_ bv0 1) (_ bv134 8) (_ bv3407872 23)) cat_53)) (=> (not (fp.lt cat_53 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (= cat_57 cat_53))))
(assert (=> (not (fp.lt (fp (_ bv0 1) (_ bv134 8) (_ bv3407872 23)) cat_53)) (= cat_55 cat_57)))
