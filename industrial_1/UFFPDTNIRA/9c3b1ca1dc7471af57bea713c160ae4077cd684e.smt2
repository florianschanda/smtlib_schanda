...
(assert (forall ((kitten_29 Float32) (kitten_30 Float32)) (! (=> (and (and (spoon_29 kitten_29 true true true true) (spoon_29 kitten_30 true true true true)) (and (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) kitten_30) (fp.leq (fp.abs kitten_29) (fp #b0 #b01111111 #b00000000000000000000000)))) (let ((kitten_31 (spoon_30 kitten_29 kitten_30))) (and (=> (fp.eq kitten_29 (fp #b0 #b01111111 #b00000000000000000000000)) (fp.eq kitten_31 (fp #b0 #b00000000 #b00000000000000000000000))) (spoon_29 kitten_31 true false true true)))) :pattern ((spoon_30 kitten_29 kitten_30)))))
(declare-sort potato_13 0)
(define-fun spoon_32 ((kitten_32 Float32)) Bool (and (spoon_1 kitten_32) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_32) (fp.leq kitten_32 (fp #b0 #b10000110 #b01101000000000000000000)))))
...
(define-fun spoon_50 ((kitten_41 Float32) (kitten_42 Bool) (kitten_43 Bool) (kitten_44 Bool) (kitten_45 Bool)) Bool (=> (or (= kitten_42 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000110 #b01101000000000000000000))) (spoon_32 kitten_41)))
...
(assert (=> (fp.eq cat_47 (fp #b0 #b01111111 #b00000000000000000000000)) (fp.eq cat_52 (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (= cat_53 cat_52))
(assert (=> (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) cat_53) (= cat_54 cat_53)))
(assert (=> (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) cat_53) (= cat_55 (fp #b0 #b10000110 #b01101000000000000000000))))
(assert (=> (not (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) cat_53)) (=> (fp.lt cat_53 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_56 cat_53))))
(assert (=> (not (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) cat_53)) (=> (fp.lt cat_53 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_57 (fp #b0 #b00000000 #b00000000000000000000000)))))
(assert (=> (not (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) cat_53)) (=> (not (fp.lt cat_53 (fp #b0 #b00000000 #b00000000000000000000000))) (= cat_57 cat_53))))
(assert (=> (not (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) cat_53)) (= cat_55 cat_57)))
