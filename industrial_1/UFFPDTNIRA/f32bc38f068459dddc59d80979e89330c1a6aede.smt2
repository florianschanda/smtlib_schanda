...
(assert (forall ((kitten_29 (_ FloatingPoint 8 24)) (kitten_30 (_ FloatingPoint 8 24))) (! (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.eq kitten_29 _let_0))) (let ((_let_2 (spoon_30 kitten_29 kitten_30))) (let ((_let_3 (fp (_ bv0 1) (_ bv127 8) (_ bv0 23)))) (let ((_let_4 (fp.eq _let_2 _let_3))) (=> (and (and (spoon_29 kitten_29 true true true true) (spoon_29 kitten_30 true true true true)) (and (=> _let_1 (fp.lt _let_0 kitten_30)) (fp.leq _let_0 kitten_29))) (and (and (fp.leq _let_0 _let_2) (and (=> (fp.eq kitten_30 _let_0) _let_4) (and (=> (fp.eq kitten_30 _let_3) (fp.eq _let_2 kitten_29)) (and (=> (fp.eq kitten_29 _let_3) _let_4) (=> _let_1 (fp.eq _let_2 _let_0)))))) (spoon_29 _let_2 true false true true)))))))) :pattern ((spoon_30 kitten_29 kitten_30)))))
(declare-sort potato_13 0)
(define-fun spoon_32 ((kitten_32 (_ FloatingPoint 8 24))) Bool (and (spoon_1 kitten_32) (and (fp.leq (fp (_ bv0 1) (_ bv117 8) (_ bv201284 23)) kitten_32) (fp.leq kitten_32 (fp (_ bv0 1) (_ bv146 8) (_ bv7611392 23))))))
...
(define-fun spoon_39 ((kitten_34 (_ FloatingPoint 8 24)) (kitten_35 Bool) (kitten_36 Bool) (kitten_37 Bool) (kitten_38 Bool)) Bool (=> (or (= kitten_35 true) (fp.leq (fp (_ bv0 1) (_ bv117 8) (_ bv201284 23)) (fp (_ bv0 1) (_ bv146 8) (_ bv7611392 23)))) (spoon_32 kitten_34)))
(declare-sort potato_15 0)
(define-fun spoon_40 ((kitten_39 (_ FloatingPoint 8 24))) Bool (and (spoon_1 kitten_39) (and (fp.leq (fp.neg (fp (_ bv0 1) (_ bv128 8) (_ bv2097152 23))) kitten_39) (fp.leq kitten_39 (fp (_ bv0 1) (_ bv129 8) (_ bv3145728 23))))))
...
(define-fun spoon_47 ((kitten_41 (_ FloatingPoint 8 24)) (kitten_42 Bool) (kitten_43 Bool) (kitten_44 Bool) (kitten_45 Bool)) Bool (=> (or (= kitten_42 true) (fp.leq (fp.neg (fp (_ bv0 1) (_ bv128 8) (_ bv2097152 23))) (fp (_ bv0 1) (_ bv129 8) (_ bv3145728 23)))) (spoon_40 kitten_41)))
(declare-sort potato_17 0)
(define-fun spoon_48 ((kitten_46 (_ FloatingPoint 8 24))) Bool (and (spoon_1 kitten_46) (and (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) kitten_46) (fp.leq kitten_46 (fp (_ bv0 1) (_ bv254 8) (_ bv8388607 23))))))
...
(declare-fun cat_53 () potato_17)
(declare-datatypes ((potato_18 0)) (((mk_potato_18 (get_potato_18_a potato_17)))))

(define-fun spoon_54 ((kitten_47 potato_18)) potato_17 (get_potato_18_a kitten_47))
(define-fun spoon_55 ((kitten_48 (_ FloatingPoint 8 24)) (kitten_49 Bool) (kitten_50 Bool) (kitten_51 Bool) (kitten_52 Bool)) Bool (=> (or (= kitten_49 true) (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) (fp (_ bv0 1) (_ bv254 8) (_ bv8388607 23)))) (spoon_48 kitten_48)))
...
(assert (= cat_60 (fp (_ bv0 1) (_ bv100 8) (_ bv2870391 23))))
(declare-fun cat_63 () (_ FloatingPoint 8 24))
(assert (spoon_32 cat_56))
(assert (spoon_40 cat_58))
(assert (spoon_40 cat_60))
(assert (=> (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) (fp (_ bv0 1) (_ bv254 8) (_ bv8388607 23))) (spoon_48 cat_63)))
(assert (not (fp.lt (fp.abs cat_58) cat_60)))
(assert (not (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) cat_56)))
(check-sat)
(exit)
