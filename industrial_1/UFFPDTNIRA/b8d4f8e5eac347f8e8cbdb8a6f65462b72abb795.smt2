...
(assert (=> (not (= cat_311 true)) (=> (fp.lt cat_309 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (and (= cat_264 (fp.mul RNE (fp.neg (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000)) cat_309)) (spoon_3 (fp.mul RNE (fp.neg (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000)) cat_309))))))
(assert (=> (not (= cat_311 true)) (=> (fp.lt cat_309 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_265 (ite (fp.leq cat_307 cat_264) true false)))))
(assert (=> (not (= cat_311 true)) (=> (fp.lt cat_309 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (and (= cat_263 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_309)) (spoon_3 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_309))))))
(assert (=> (not (= cat_311 true)) (=> (fp.lt cat_309 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_266 (ite (fp.leq cat_263 cat_307) true false)))))
(assert (=> (not (= cat_311 true)) (=> (fp.lt cat_309 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_310 (ite (= cat_266 true) cat_265 false)))))
(assert (=> (not (= cat_311 true)) (=> (not (fp.lt cat_309 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))) (= cat_310 false))))
(assert (= cat_310 true))
(assert (and (= cat_271 (fp.div RNE cat_307 cat_309)) (spoon_3 (fp.div RNE cat_307 cat_309))))
