...
(define-fun spoon_307 () potato_11 (mk_potato_11 cat_211))
...
(assert (= cat_271 (mk_potato_7 cat_203)))
(assert (= cat_272 (spoon_37 1)))
(assert (= cat_273 (mk_potato_19 (mk_potato_18 cat_201 cat_202))))
(assert (= cat_274 (get_potato_20_a cat_85)))
(assert (= cat_275 (mk_potato_11 cat_206)))
(assert (= cat_276 (fp.mul RNE cat_181 cat_181)))
(assert (and (= cat_224 ((_ to_fp 11 53) RNE (fp.mul RNE cat_177 cat_177))) (spoon_2 ((_ to_fp 11 53) RNE (fp.mul RNE cat_177 cat_177)))))
(assert (= cat_277 (mk_potato_11 cat_204)))
(assert (= cat_278 cat_224))
(assert (and (= cat_225 ((_ to_fp 11 53) RNE (fp.mul RNE cat_179 cat_179))) (spoon_2 ((_ to_fp 11 53) RNE (fp.mul RNE cat_179 cat_179)))))
(assert (= cat_279 (mk_potato_11 cat_205)))
(assert (= cat_280 cat_225))
(assert (= cat_281 (mk_potato_11 cat_207)))
(assert (= cat_282 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_181)))
(assert (and (= cat_226 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_276)) (spoon_2 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_276))))
(assert (= cat_283 (mk_potato_11 cat_208)))
(assert (= cat_284 cat_226))
...
(assert (= cat_285 (mk_potato_11 cat_209)))
(assert (= cat_286 cat_229))
...
(assert (= cat_287 (mk_potato_11 cat_210)))
(assert (= cat_288 cat_232))
(assert (and (= cat_237 (fp.mul RNE cat_282 ((_ to_fp 11 53) RNE cat_179))) (spoon_2 (fp.mul RNE cat_282 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_238 (fp.mul RNE cat_237 cat_288)))
(assert (and (= cat_239 cat_238) (spoon_2 cat_238)))
(assert (and (= cat_233 (fp.sub RNE cat_284 cat_278)) (spoon_2 (fp.sub RNE cat_284 cat_278))))
(assert (= cat_234 (fp.sub RNE cat_233 cat_280)))
(assert (and (= cat_235 cat_234) (spoon_2 cat_234)))
(assert (= cat_236 (fp.mul RNE cat_235 cat_286)))
...
(assert (= cat_290 cat_242))
(assert (and (= cat_243 (fp.add RNE cat_284 cat_278)) (spoon_2 (fp.add RNE cat_284 cat_278))))
(assert (= cat_244 (fp.add RNE cat_243 cat_280)))
(assert (and (= cat_245 cat_244) (spoon_2 cat_244)))
(assert (= cat_291 (mk_potato_11 cat_214)))
(assert (= cat_292 cat_245))
(assert (and (= cat_246 (fp.div RNE cat_290 cat_292)) (spoon_2 (fp.div RNE cat_290 cat_292))))
(assert (= cat_293 (mk_potato_11 cat_212)))
(assert (= cat_294 cat_246))
(assert (=> (fp.lt cat_294 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))) (= cat_295 spoon_307)))
...
(assert (=> (not (fp.lt cat_294 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_294) (= cat_297 spoon_307))))
...
(assert (=> (not (fp.lt cat_294 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_294)) (and (= cat_247 cat_294) (spoon_2 cat_294)))))
(assert (=> (not (fp.lt cat_294 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_294)) (= cat_299 spoon_307))))
(assert (=> (not (fp.lt cat_294 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_294)) (= cat_300 cat_247))))
...
(assert (and (= cat_248 (fp.mul RNE cat_282 ((_ to_fp 11 53) RNE cat_177))) (spoon_2 (fp.mul RNE cat_282 ((_ to_fp 11 53) RNE cat_177)))))
(assert (= cat_301 (mk_potato_11 cat_216)))
(assert (= cat_302 cat_248))
(assert (and (= cat_253 (fp.mul RNE cat_282 ((_ to_fp 11 53) RNE cat_179))) (spoon_2 (fp.mul RNE cat_282 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_254 (fp.mul RNE cat_253 cat_286)))
(assert (and (= cat_255 cat_254) (spoon_2 cat_254)))
(assert (and (= cat_249 (fp.sub RNE cat_284 cat_278)) (spoon_2 (fp.sub RNE cat_284 cat_278))))
(assert (= cat_250 (fp.sub RNE cat_249 cat_280)))
(assert (and (= cat_251 cat_250) (spoon_2 cat_250)))
(assert (= cat_252 (fp.mul RNE cat_251 cat_288)))
...
(assert (= cat_303 (mk_potato_11 cat_217)))
(assert (= cat_304 cat_258))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_304) (and (= cat_264 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_304)) (spoon_2 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_304)))))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_304) (= cat_265 (ite (fp.leq cat_302 cat_264) true false))))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_304) (and (= cat_263 (fp.mul RNE (fp.neg (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000)) cat_304)) (spoon_2 (fp.mul RNE (fp.neg (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000)) cat_304)))))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_304) (= cat_266 (ite (fp.leq cat_263 cat_302) true false))))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_304) (= cat_306 (ite (= cat_266 true) cat_265 false))))
(assert (=> (not (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_304)) (= cat_306 false)))
(assert (=> (= cat_306 true) (= cat_305 true)))
(assert (=> (not (= cat_306 true)) (=> (fp.lt cat_304 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (and (= cat_260 (fp.mul RNE (fp.neg (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000)) cat_304)) (spoon_2 (fp.mul RNE (fp.neg (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000)) cat_304))))))
(assert (=> (not (= cat_306 true)) (=> (fp.lt cat_304 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_261 (ite (fp.leq cat_302 cat_260) true false)))))
(assert (=> (not (= cat_306 true)) (=> (fp.lt cat_304 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (and (= cat_259 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_304)) (spoon_2 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_304))))))
(assert (=> (not (= cat_306 true)) (=> (fp.lt cat_304 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_262 (ite (fp.leq cat_259 cat_302) true false)))))
(assert (=> (not (= cat_306 true)) (=> (fp.lt cat_304 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_305 (ite (= cat_262 true) cat_261 false)))))
(assert (=> (not (= cat_306 true)) (=> (not (fp.lt cat_304 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))) (= cat_305 false))))
(assert (= cat_305 true))
(assert (and (= cat_267 (fp.div RNE cat_302 cat_304)) (spoon_2 (fp.div RNE cat_302 cat_304))))
(assert (= cat_268 ((_ to_fp 8 24) RNE cat_267)))
(assert (not (spoon_87 cat_268)))
(check-sat)
(exit)
