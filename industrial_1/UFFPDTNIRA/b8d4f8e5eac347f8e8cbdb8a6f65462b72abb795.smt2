...
(assert (and (= cat_230 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_280)) (spoon_3 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_280))))
...
(assert (and (= cat_241 (fp.mul RNE cat_286 ((_ to_fp 11 53) RNE cat_183))) (spoon_3 (fp.mul RNE cat_286 ((_ to_fp 11 53) RNE cat_183)))))
(assert (= cat_242 (fp.mul RNE cat_241 cat_292)))
(assert (and (= cat_243 cat_242) (spoon_3 cat_242)))
(assert (and (= cat_237 (fp.sub RNE cat_288 cat_282)) (spoon_3 (fp.sub RNE cat_288 cat_282))))
...
(assert (and (= cat_247 (fp.add RNE cat_288 cat_282)) (spoon_3 (fp.add RNE cat_288 cat_282))))
...
(assert (and (= cat_250 (fp.div RNE cat_294 cat_296)) (spoon_3 (fp.div RNE cat_294 cat_296))))
...
(assert (=> (not (fp.lt cat_298 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_298)) (and (= cat_251 cat_298) (spoon_3 cat_298)))))
...
(assert (and (= cat_252 (fp.mul RNE cat_286 ((_ to_fp 11 53) RNE cat_181))) (spoon_3 (fp.mul RNE cat_286 ((_ to_fp 11 53) RNE cat_181)))))
(assert (= cat_305 (mk_potato_11 cat_220)))
(assert (= cat_306 cat_252))
(assert (and (= cat_257 (fp.mul RNE cat_286 ((_ to_fp 11 53) RNE cat_183))) (spoon_3 (fp.mul RNE cat_286 ((_ to_fp 11 53) RNE cat_183)))))
(assert (= cat_258 (fp.mul RNE cat_257 cat_290)))
(assert (and (= cat_259 cat_258) (spoon_3 cat_258)))
(assert (and (= cat_253 (fp.sub RNE cat_288 cat_282)) (spoon_3 (fp.sub RNE cat_288 cat_282))))
...
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_308) (and (= cat_268 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_308)) (spoon_3 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_308)))))
...
(assert (= cat_309 true))
(assert (and (= cat_271 (fp.div RNE cat_306 cat_308)) (spoon_3 (fp.div RNE cat_306 cat_308))))
