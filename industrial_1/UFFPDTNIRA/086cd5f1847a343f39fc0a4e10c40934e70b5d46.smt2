...
(assert (and (= cat_126 cat_108) (spoon_1 cat_108)))
(assert (and (= cat_127 (spoon_81 cat_126)) (spoon_72 cat_127)))
...
(assert (and (= cat_128 (fp.sub RNE (fp #b0 #b01111111 #b00000000000000000000000) cat_114)) (spoon_1 (fp.sub RNE (fp #b0 #b01111111 #b00000000000000000000000) cat_114))))
(assert (= cat_129 (fp.mul RNE cat_128 (fp.mul RNE cat_112 cat_112))))
(assert (and (= cat_130 cat_129) (spoon_1 cat_129)))
(assert (= cat_131 (fp.add RNE (fp #b0 #b01111111 #b00000000000000000000000) cat_130)))
(assert (and (= cat_132 cat_131) (spoon_1 cat_131)))
(assert (and (= cat_133 cat_132) (spoon_1 cat_132)))
(assert (= cat_133 cat_116))
(assert (spoon_57 cat_116))
(assert (and (= cat_134 (fp.sqrt RNE cat_116)) (spoon_1 (fp.sqrt RNE cat_116))))
(assert (= cat_134 cat_118))
(assert (spoon_57 cat_118))
(assert (=> (fp.leq (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) (spoon_2 cat_124)))
(assert (=> (fp.leq (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) (spoon_2 cat_125)))
(assert (and (= cat_135 (fp.mul RNE cat_114 cat_112)) (spoon_1 (fp.mul RNE cat_114 cat_112))))
(assert (= cat_136 ((_ to_fp 11 53) RNE cat_135)))
(assert (= cat_137 (fp.sub RNE cat_136 (fp.mul RNE ((_ to_fp 11 53) RNE cat_106) ((_ to_fp 11 53) RNE cat_118)))))
(assert (= (mk_potato_11 cat_143) (mk_potato_11 cat_124)))
(assert (= cat_144 cat_137))
(assert (and (= cat_138 (fp.mul RNE cat_118 cat_112)) (spoon_1 (fp.mul RNE cat_118 cat_112))))
(assert (= cat_139 ((_ to_fp 11 53) RNE cat_138)))
(assert (= cat_140 (fp.mul RNE ((_ to_fp 11 53) RNE cat_106) cat_139)))
(assert (= cat_141 (fp.add RNE ((_ to_fp 11 53) RNE cat_116) cat_140)))
(assert (= (mk_potato_11 cat_145) (mk_potato_11 cat_125)))
(assert (= cat_146 cat_141))
(assert (and (= cat_142 (fp.mul RNE cat_144 (fp #b0 #b10000000100 #b1100101001011101110000001101000000111100111100100110))) (spoon_2 (fp.mul RNE cat_144 (fp #b0 #b10000000100 #b1100101001011101110000001101000000111100111100100110)))))
(assert (= cat_144 cat_147))
(assert (= cat_148 cat_142))
(assert (not (not (fp.isZero cat_146))))
(check-sat)
(exit)
