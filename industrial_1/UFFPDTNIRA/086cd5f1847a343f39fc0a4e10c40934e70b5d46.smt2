...
(assert (=> (fp.leq (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) (spoon_2 cat_128)))
(assert (=> (fp.leq (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) (spoon_2 cat_129)))
...
(assert (and (= cat_146 (fp.mul RNE cat_148 (fp #b0 #b10000000100 #b1100101001011101110000001101000000111100111100100110))) (spoon_2 (fp.mul RNE cat_148 (fp #b0 #b10000000100 #b1100101001011101110000001101000000111100111100100110)))))
