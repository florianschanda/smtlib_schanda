...
(assert (and (= cat_130 cat_112) (spoon_1 cat_112)))
(assert (and (= cat_131 (spoon_85 cat_130)) (spoon_76 cat_131)))
(assert (= cat_131 cat_116))
(assert (spoon_76 cat_116))
(assert (= ((_ to_fp 8 24) RNE (fp.mul RNE cat_108 cat_108)) cat_118))
(assert (spoon_61 cat_118))
(assert (and (= cat_132 (fp.sub RNE (fp #b0 #b01111111 #b00000000000000000000000) cat_118)) (spoon_1 (fp.sub RNE (fp #b0 #b01111111 #b00000000000000000000000) cat_118))))
(assert (= cat_133 (fp.mul RNE cat_132 (fp.mul RNE cat_116 cat_116))))
(assert (and (= cat_134 cat_133) (spoon_1 cat_133)))
(assert (= cat_135 (fp.add RNE (fp #b0 #b01111111 #b00000000000000000000000) cat_134)))
(assert (and (= cat_136 cat_135) (spoon_1 cat_135)))
(assert (and (= cat_137 cat_136) (spoon_1 cat_136)))
(assert (= cat_137 cat_120))
(assert (spoon_61 cat_120))
(assert (and (= cat_138 (fp.sqrt RNE cat_120)) (spoon_1 (fp.sqrt RNE cat_120))))
(assert (= cat_138 cat_122))
(assert (spoon_61 cat_122))
(assert (=> (fp.leq (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) (spoon_3 cat_128)))
(assert (=> (fp.leq (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) (spoon_3 cat_129)))
(assert (and (= cat_139 (fp.mul RNE cat_118 cat_116)) (spoon_1 (fp.mul RNE cat_118 cat_116))))
(assert (= cat_140 ((_ to_fp 11 53) RNE cat_139)))
(assert (= cat_141 (fp.sub RNE cat_140 (fp.mul RNE ((_ to_fp 11 53) RNE cat_110) ((_ to_fp 11 53) RNE cat_122)))))
(assert (= (mk_potato_11 cat_153) (mk_potato_11 cat_128)))
(assert (= cat_154 cat_141))
(assert (and (= cat_142 (fp.mul RNE cat_122 cat_116)) (spoon_1 (fp.mul RNE cat_122 cat_116))))
(assert (= cat_143 ((_ to_fp 11 53) RNE cat_142)))
(assert (= cat_144 (fp.mul RNE ((_ to_fp 11 53) RNE cat_110) cat_143)))
(assert (= cat_145 (fp.add RNE ((_ to_fp 11 53) RNE cat_120) cat_144)))
(assert (= (mk_potato_11 cat_155) (mk_potato_11 cat_129)))
(assert (= cat_156 cat_145))
(assert (and (= cat_146 (fp.mul RNE cat_154 (fp #b0 #b10000000100 #b1100101001011101110000001101000000111100111100100110))) (spoon_3 (fp.mul RNE cat_154 (fp #b0 #b10000000100 #b1100101001011101110000001101000000111100111100100110)))))
(assert (= cat_154 cat_157))
(assert (= cat_158 cat_146))
(assert (not (not (fp.isZero cat_156))))
(check-sat)
(exit)
