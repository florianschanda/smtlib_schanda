...
(assert (= (mk_potato_11 cat_147) (mk_potato_11 cat_128)))
(assert (= cat_148 cat_141))
...
(assert (= (mk_potato_11 cat_149) (mk_potato_11 cat_129)))
(assert (= cat_150 cat_145))
(assert (and (= cat_146 (fp.mul RNE cat_148 (fp #b0 #b10000000100 #b1100101001011101110000001101000000111100111100100110))) (spoon_3 (fp.mul RNE cat_148 (fp #b0 #b10000000100 #b1100101001011101110000001101000000111100111100100110)))))
(assert (= cat_148 cat_151))
(assert (= cat_152 cat_146))
(assert (not (not (fp.isZero cat_150))))
(check-sat)
(exit)
