...
(declare-const cat_232 Bool)
(declare-const cat_233 Bool)
(declare-const cat_234 potato_28)
...
(assert (= cat_226 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_1 cat_226))
(assert (= cat_227 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_1 cat_227))
(assert (= cat_228 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_1 cat_228))
(assert (= cat_229 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_1 cat_229))
(assert (= cat_230 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_154 cat_230))
(assert (= cat_231 (fp #b0 #b00000000 #b00000000000000000000000)))
...
(assert (= cat_232 true))
(assert (=> (= cat_233 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_234))) (and (= cat_201 (spoon_76 (fp #b0 #b10000101 #b01100111111101011101000))) (spoon_86 cat_201)))))
(assert (=> (= cat_233 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_234))) (= cat_235 (mk_potato_10 cat_231)))))
(assert (=> (= cat_233 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_234))) (= cat_236 cat_201))))
(assert (=> (= cat_233 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_234)))) (=> (fp.lt (spoon_111 (get_potato_28_a cat_234)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (and (= cat_202 (spoon_76 (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (spoon_86 cat_202))))))
(assert (=> (= cat_233 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_234)))) (=> (fp.lt (spoon_111 (get_potato_28_a cat_234)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_237 (mk_potato_10 cat_231))))))
(assert (=> (= cat_233 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_234)))) (=> (fp.lt (spoon_111 (get_potato_28_a cat_234)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_238 cat_202)))))
(assert (=> (= cat_233 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_234)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_234)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_203 (spoon_111 (get_potato_28_a cat_234))) (spoon_1 (spoon_111 (get_potato_28_a cat_234))))))))
(assert (=> (= cat_233 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_234)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_234)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_204 (spoon_76 cat_203)) (spoon_86 cat_204))))))
(assert (=> (= cat_233 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_234)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_234)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_239 (mk_potato_10 cat_231))))))
(assert (=> (= cat_233 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_234)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_234)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_240 cat_204)))))
(assert (=> (= cat_233 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_234)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_234)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_238 cat_240)))))
(assert (=> (= cat_233 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_234)))) (= cat_236 cat_238))))
(assert (=> (= cat_233 true) (= cat_241 (mk_potato_10 cat_230))))
(assert (=> (= cat_233 true) (= cat_242 (fp.mul RNE cat_170 cat_170))))
(assert (=> (= cat_233 true) (= cat_243 (mk_potato_10 cat_227))))
(assert (=> (= cat_233 true) (= cat_244 ((_ to_fp 8 24) RNE (fp.sub RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) (fp.mul RNE cat_166 cat_166))))))
(assert (=> (= cat_233 true) (= cat_245 (mk_potato_10 cat_226))))
(assert (=> (= cat_233 true) (= cat_246 (fp.sqrt RNE cat_244))))
...
(assert (=> (= cat_233 true) (and (= cat_205 (fp.sub RNE cat_244 cat_242)) (spoon_1 (fp.sub RNE cat_244 cat_242)))))
(assert (=> (= cat_233 true) (= cat_206 (fp.add RNE cat_205 (fp.mul RNE cat_236 cat_236)))))
...
(assert (=> (= cat_233 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_248) (= cat_249 (mk_potato_10 cat_228)))))
(assert (=> (= cat_233 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_248) (= cat_250 (fp.sqrt RNE cat_248)))))
(assert (=> (= cat_233 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_248) (= cat_252 cat_233))))
(assert (=> (= cat_233 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_248)) (= cat_251 (mk_potato_7 cat_233)))))
(assert (=> (= cat_233 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_248)) (= cat_252 (distinct 0 0)))))
(assert (=> (= cat_233 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_248)) (= cat_250 cat_228))))
(assert (=> (not (= cat_233 true)) (= cat_248 cat_229)))
(assert (=> (not (= cat_233 true)) (= cat_250 cat_228)))
(assert (=> (not (= cat_233 true)) (= cat_252 cat_233)))
(assert (= cat_252 true))
(assert (= cat_210 (fp.mul RNE cat_250 cat_170)))
(assert (spoon_1 (fp.mul RNE cat_250 cat_170)))
(assert (= cat_208 (fp.mul RNE cat_246 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_166 cat_166)) cat_242))))
(assert (spoon_1 (fp.mul RNE cat_246 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_166 cat_166)) cat_242))))
(assert (= cat_209 (fp.mul RNE cat_208 cat_236)))
...
(assert (= cat_214 (fp.mul RNE cat_250 cat_170)))
(assert (spoon_1 (fp.mul RNE cat_250 cat_170)))
(assert (= cat_215 (fp.mul RNE cat_214 cat_236)))
(assert (= cat_216 cat_215))
(assert (spoon_1 cat_215))
(assert (= cat_217 (fp.mul RNE cat_246 cat_248)))
(assert (spoon_1 (fp.mul RNE cat_246 cat_248)))
(assert (= cat_218 (fp.sub RNE cat_217 cat_216)))
(assert (= cat_219 cat_218))
(assert (= cat_254 cat_219))
(assert (spoon_1 cat_218))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_254) (and (= cat_222 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_254)) (spoon_1 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_254)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_254) (and (= cat_223 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_253)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_253)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_254) (= cat_224 (ite (fp.leq cat_223 cat_222) true false))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_254) (and (= cat_220 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_253)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_253)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_254) (and (= cat_221 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_254)) (spoon_1 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_254)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_254) (= cat_225 (ite (fp.leq cat_221 cat_220) true false))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_254) (= cat_255 (ite (= cat_225 true) cat_224 false))))
(assert (=> (not (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_254)) (= cat_255 false)))
(assert (not (= cat_255 true)))
(assert (fp.lt cat_254 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_1 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_254)))
(assert (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_253)))
(assert (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_253)))
(assert (not (spoon_1 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_254))))
(check-sat)
(exit)
