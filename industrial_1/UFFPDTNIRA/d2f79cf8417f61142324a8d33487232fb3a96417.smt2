...
(assert (and (= cat_209 (fp.mul RNE cat_221 cat_225)) (spoon_3 (fp.mul RNE cat_221 cat_225))))
(assert (= cat_210 (fp.mul RNE cat_209 cat_229)))
(assert (and (= cat_211 cat_210) (spoon_3 cat_210)))
(assert (and (= cat_207 (fp.mul RNE cat_219 cat_223)) (spoon_3 (fp.mul RNE cat_219 cat_223))))
