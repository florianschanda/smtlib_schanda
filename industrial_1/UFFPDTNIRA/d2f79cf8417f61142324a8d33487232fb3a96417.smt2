...
(declare-fun cat_222 () potato_11)
(declare-fun cat_223 () (_ FloatingPoint 11 53))
(declare-fun cat_224 () potato_11)
(declare-fun cat_225 () (_ FloatingPoint 11 53))
(declare-fun cat_226 () potato_11)
...
(assert (= cat_214 cat_177))
(assert (= cat_215 cat_193))
(assert (and (= cat_194 (spoon_60 (spoon_86 (get_potato_22_a (get_potato_24_a cat_154))))) (spoon_42 cat_194)))
(assert (= cat_216 cat_179))
(assert (= cat_217 cat_194))
(assert (and (= cat_195 (spoon_40 cat_213)) (spoon_50 cat_195)))
(assert (= cat_196 ((_ to_fp 11 53) roundNearestTiesToEven cat_195)))
(assert (= cat_218 cat_180))
(assert (= cat_219 cat_196))
(assert (and (= cat_197 (spoon_58 cat_213)) (spoon_50 cat_197)))
(assert (= cat_198 ((_ to_fp 11 53) roundNearestTiesToEven cat_197)))
(assert (= cat_220 cat_181))
(assert (= cat_221 cat_198))
(assert (and (= cat_199 (spoon_40 cat_217)) (spoon_50 cat_199)))
(assert (= cat_200 ((_ to_fp 11 53) roundNearestTiesToEven cat_199)))
(assert (= cat_222 (mk_potato_11 cat_182)))
(assert (= cat_223 cat_200))
(assert (and (= cat_201 (spoon_58 cat_217)) (spoon_50 cat_201)))
(assert (= cat_202 ((_ to_fp 11 53) roundNearestTiesToEven cat_201)))
(assert (= cat_224 (mk_potato_11 cat_183)))
(assert (= cat_225 cat_202))
(assert (and (= cat_203 (spoon_40 cat_215)) (spoon_50 cat_203)))
(assert (= cat_204 ((_ to_fp 11 53) roundNearestTiesToEven cat_203)))
(assert (= cat_226 (mk_potato_11 cat_184)))
(assert (= cat_227 cat_204))
(assert (and (= cat_205 (spoon_58 cat_215)) (spoon_50 cat_205)))
(assert (= cat_206 ((_ to_fp 11 53) roundNearestTiesToEven cat_205)))
(assert (= cat_228 (mk_potato_11 cat_185)))
(assert (= cat_229 cat_206))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_221 cat_225))) (and (= cat_209 _let_0) (spoon_3 _let_0))))
(assert (= cat_210 (fp.mul roundNearestTiesToEven cat_209 cat_229)))
(assert (and (= cat_211 cat_210) (spoon_3 cat_210)))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_219 cat_223))) (and (= cat_207 _let_0) (spoon_3 _let_0))))
