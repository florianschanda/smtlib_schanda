...
(declare-fun cat_58 () (_ FloatingPoint 8 24))
(declare-fun cat_59 () (_ FloatingPoint 8 24))
(declare-fun cat_60 () (_ FloatingPoint 8 24))
(declare-fun cat_61 () (_ FloatingPoint 8 24))
(assert (spoon_36 cat_51))
(assert (fp.lt (fp.neg (fp (_ bv0 1) (_ bv133 8) (_ bv3407872 23))) cat_51))
(assert (fp.lt cat_51 (fp (_ bv0 1) (_ bv133 8) (_ bv3407872 23))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv254 8) (_ bv8388607 23)))) (=> (fp.leq (fp.neg _let_0) _let_0) (spoon_1 cat_55))))
(assert (= cat_56 (spoon_34 cat_51 (fp (_ bv0 1) (_ bv135 8) (_ bv3407872 23)))))
(assert (spoon_1 cat_56))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (fp.eq cat_51 _let_0) (fp.eq cat_56 _let_0))))
(assert (= cat_57 cat_56))
(assert (=> (fp.lt (fp (_ bv0 1) (_ bv139 8) (_ bv3489792 23)) cat_57) (= cat_58 cat_57)))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv139 8) (_ bv3489792 23)))) (=> (fp.lt _let_0 cat_57) (= cat_59 _let_0))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv139 8) (_ bv3489792 23)))) (=> (not (fp.lt _let_0 cat_57)) (=> (fp.lt cat_57 (fp.neg _let_0)) (= cat_60 cat_57)))))
(assert (let ((_let_0 (fp.neg (fp (_ bv0 1) (_ bv139 8) (_ bv3489792 23))))) (=> (not (fp.lt (fp (_ bv0 1) (_ bv139 8) (_ bv3489792 23)) cat_57)) (=> (fp.lt cat_57 _let_0) (= cat_61 _let_0)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv139 8) (_ bv3489792 23)))) (=> (not (fp.lt _let_0 cat_57)) (=> (not (fp.lt cat_57 (fp.neg _let_0))) (= cat_61 cat_57)))))
(assert (=> (not (fp.lt (fp (_ bv0 1) (_ bv139 8) (_ bv3489792 23)) cat_57)) (= cat_59 cat_61)))
