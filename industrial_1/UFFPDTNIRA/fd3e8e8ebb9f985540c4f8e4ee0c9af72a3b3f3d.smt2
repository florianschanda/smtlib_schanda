...
(declare-fun spoon_34 (Float32 Float32) Float32)
(declare-fun spoon_35 (Float32 Float32 Float32) Bool)
(assert (forall ((kitten_30 Float32) (kitten_31 Float32)) (! (=> (and (and (spoon_33 kitten_30 true true true true) (spoon_33 kitten_31 true true true true)) (and (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) kitten_31) (not (fp.eq (fp.abs (fp.rem kitten_30 kitten_31)) (fp.mul RNE (fp #b0 #b01111101 #b00000000000000000000000) kitten_31))))) (let ((kitten_32 (spoon_34 kitten_30 kitten_31))) (and (=> (fp.eq kitten_30 (fp #b0 #b00000000 #b00000000000000000000000)) (fp.eq kitten_32 (fp #b0 #b00000000 #b00000000000000000000000))) (spoon_33 kitten_32 true false true true)))) :pattern ((spoon_34 kitten_30 kitten_31)))))
(declare-sort potato_13 0)
(define-fun spoon_36 ((kitten_33 Float32)) Bool (and (spoon_1 kitten_33) (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)) kitten_33) (fp.leq kitten_33 (fp #b0 #b10000101 #b01100111111101011101000)))))
...
(define-fun spoon_43 ((kitten_35 Float32) (kitten_36 Bool) (kitten_37 Bool) (kitten_38 Bool) (kitten_39 Bool)) Bool (=> (or (= kitten_36 true) (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)) (fp #b0 #b10000101 #b01100111111101011101000))) (spoon_36 kitten_35)))
(declare-sort potato_15 0)
(define-fun spoon_44 ((kitten_40 Float32)) Bool (and (spoon_1 kitten_40) (and (fp.leq (fp.neg (fp #b0 #b10001011 #b01101010100000000000000)) kitten_40) (fp.leq kitten_40 (fp #b0 #b10001011 #b01101010100000000000000)))))
...
(define-fun spoon_54 ((kitten_42 Float32) (kitten_43 Bool) (kitten_44 Bool) (kitten_45 Bool) (kitten_46 Bool)) Bool (=> (or (= kitten_43 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b01101010100000000000000)) (fp #b0 #b10001011 #b01101010100000000000000))) (spoon_44 kitten_42)))
...
(assert (fp.lt (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_51))
(assert (fp.lt cat_51 (fp #b0 #b10000101 #b01101000000000000000000)))
(assert (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)) (spoon_1 cat_55)))
(assert (= cat_56 (spoon_34 cat_51 (fp #b0 #b10000111 #b01101000000000000000000))))
(assert (spoon_1 cat_56))
(assert (=> (fp.eq cat_51 (fp #b0 #b00000000 #b00000000000000000000000)) (fp.eq cat_56 (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (= cat_57 cat_56))
(assert (=> (fp.lt (fp #b0 #b10001011 #b01101010100000000000000) cat_57) (= cat_58 cat_57)))
(assert (=> (fp.lt (fp #b0 #b10001011 #b01101010100000000000000) cat_57) (= cat_59 (fp #b0 #b10001011 #b01101010100000000000000))))
(assert (=> (not (fp.lt (fp #b0 #b10001011 #b01101010100000000000000) cat_57)) (=> (fp.lt cat_57 (fp.neg (fp #b0 #b10001011 #b01101010100000000000000))) (= cat_60 cat_57))))
(assert (=> (not (fp.lt (fp #b0 #b10001011 #b01101010100000000000000) cat_57)) (=> (fp.lt cat_57 (fp.neg (fp #b0 #b10001011 #b01101010100000000000000))) (= cat_61 (fp.neg (fp #b0 #b10001011 #b01101010100000000000000))))))
(assert (=> (not (fp.lt (fp #b0 #b10001011 #b01101010100000000000000) cat_57)) (=> (not (fp.lt cat_57 (fp.neg (fp #b0 #b10001011 #b01101010100000000000000)))) (= cat_61 cat_57))))
(assert (=> (not (fp.lt (fp #b0 #b10001011 #b01101010100000000000000) cat_57)) (= cat_59 cat_61)))
(assert (not (spoon_44 cat_59)))
(check-sat)
(exit)
