...
(assert (= cat_144 (fp.sub RNE (spoon_48 (get_potato_17_a (get_potato_19_a cat_90))) (spoon_48 (get_potato_17_a (get_potato_19_a cat_88))))))
(assert (= cat_145 (fp.sub RNE (spoon_48 (get_potato_17_b (get_potato_19_a cat_90))) (spoon_48 (get_potato_17_b (get_potato_19_a cat_88))))))
(assert (= cat_146 (fp.add RNE (fp.mul RNE cat_144 cat_144) (fp.mul RNE cat_145 cat_145))))
(assert (not (fp.lt cat_146 (fp #b0 #b01110001 #b10100011011011100010111))))
(assert (= cat_147 (fp.add RNE (fp.mul RNE (fp.sub RNE (spoon_48 (get_potato_17_a (get_potato_19_a cat_86))) (spoon_48 (get_potato_17_a (get_potato_19_a cat_88)))) cat_144) (fp.mul RNE (fp.sub RNE (spoon_48 (get_potato_17_b (get_potato_19_a cat_86))) (spoon_48 (get_potato_17_b (get_potato_19_a cat_88)))) cat_145))))
(assert (= cat_143 (fp.div RNE cat_147 cat_146)))
(assert (spoon_1 (fp.div RNE cat_147 cat_146)))
