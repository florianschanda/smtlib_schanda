...
(assert (=> (fp.lt (fp #b0 #b10000101 #b01101000000000000000000) cat_57) (= cat_58 cat_57)))
(assert (=> (fp.lt (fp #b0 #b10000101 #b01101000000000000000000) cat_57) (= cat_59 (fp #b0 #b10000101 #b01101000000000000000000))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01101000000000000000000) cat_57)) (=> (fp.lt cat_57 (fp.neg (fp #b0 #b10000101 #b01101000000000000000000))) (= cat_60 cat_57))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01101000000000000000000) cat_57)) (=> (fp.lt cat_57 (fp.neg (fp #b0 #b10000101 #b01101000000000000000000))) (= cat_61 (fp.neg (fp #b0 #b10000101 #b01101000000000000000000))))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01101000000000000000000) cat_57)) (=> (not (fp.lt cat_57 (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)))) (= cat_61 cat_57))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01101000000000000000000) cat_57)) (= cat_59 cat_61)))
