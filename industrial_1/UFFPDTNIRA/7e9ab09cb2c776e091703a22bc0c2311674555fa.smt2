...
(assert (and (= cat_54 (spoon_32 cat_49 (fp #b0 #b10000111 #b01101000000000000000000))) (and (spoon_1 cat_54) (=> (fp.eq cat_49 (fp #b0 #b00000000 #b00000000000000000000000)) (fp.eq cat_54 (fp #b0 #b00000000 #b00000000000000000000000))))))
(assert (= cat_55 cat_53))
(assert (= cat_56 cat_54))
(assert (=> (fp.lt (fp #b0 #b10000101 #b01101000000000000000000) cat_56) (= cat_57 cat_56)))
(assert (=> (fp.lt (fp #b0 #b10000101 #b01101000000000000000000) cat_56) (= cat_58 (fp #b0 #b10000101 #b01101000000000000000000))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01101000000000000000000) cat_56)) (=> (fp.lt cat_56 (fp.neg (fp #b0 #b10000101 #b01101000000000000000000))) (= cat_59 cat_56))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01101000000000000000000) cat_56)) (=> (fp.lt cat_56 (fp.neg (fp #b0 #b10000101 #b01101000000000000000000))) (= cat_60 (fp.neg (fp #b0 #b10000101 #b01101000000000000000000))))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01101000000000000000000) cat_56)) (=> (not (fp.lt cat_56 (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)))) (= cat_60 cat_56))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01101000000000000000000) cat_56)) (= cat_58 cat_60)))
