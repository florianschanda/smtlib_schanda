...
(assert (and (= cat_212 (fp.mul RNE cat_244 cat_248)) (spoon_3 (fp.mul RNE cat_244 cat_248))))
(assert (= cat_213 (fp.mul RNE cat_212 cat_252)))
(assert (and (= cat_214 cat_213) (spoon_3 cat_213)))
(assert (and (= cat_210 (fp.mul RNE cat_242 cat_246)) (spoon_3 (fp.mul RNE cat_242 cat_246))))
...
(assert (and (= cat_218 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_145) cat_250)) (spoon_3 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_145) cat_250))))
...
(assert (=> (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_254) (and (= cat_221 (fp.div RNE cat_256 cat_254)) (spoon_3 (fp.div RNE cat_256 cat_254)))))
...
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_254)) (=> (= cat_259 true) (and (= cat_230 (fp.div RNE cat_256 cat_254)) (spoon_3 (fp.div RNE cat_256 cat_254))))))
...
(assert (and (= cat_231 (fp.mul RNE cat_242 cat_248)) (spoon_3 (fp.mul RNE cat_242 cat_248))))
(assert (= cat_267 (mk_potato_11 cat_189)))
(assert (= cat_268 cat_231))
(assert (and (= cat_232 (fp.mul RNE cat_244 cat_246)) (spoon_3 (fp.mul RNE cat_244 cat_246))))
...
(assert (not (spoon_3 (fp.sub RNE cat_268 cat_270))))
(check-sat)
(exit)
