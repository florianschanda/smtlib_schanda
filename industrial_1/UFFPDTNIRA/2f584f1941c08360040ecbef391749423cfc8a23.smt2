...
(define-fun spoon_267 () potato_11 (mk_potato_11 cat_174))
...
(assert (= cat_233 cat_176))
(assert (= cat_234 cat_192))
(assert (and (= cat_193 (spoon_133 (spoon_56 (get_potato_18_a (get_potato_20_a cat_137))))) (spoon_83 cat_193)))
(assert (= cat_235 cat_178))
(assert (= cat_236 cat_193))
(assert (and (= cat_194 (spoon_99 cat_232)) (spoon_91 cat_194)))
(assert (= cat_195 ((_ to_fp 11 53) RNE cat_194)))
(assert (= cat_237 cat_179))
(assert (= cat_238 cat_195))
(assert (and (= cat_196 (spoon_101 cat_232)) (spoon_91 cat_196)))
(assert (= cat_197 ((_ to_fp 11 53) RNE cat_196)))
(assert (= cat_239 cat_180))
(assert (= cat_240 cat_197))
(assert (and (= cat_198 (spoon_99 cat_236)) (spoon_91 cat_198)))
(assert (= cat_199 ((_ to_fp 11 53) RNE cat_198)))
(assert (= cat_241 (mk_potato_11 cat_181)))
(assert (= cat_242 cat_199))
(assert (and (= cat_200 (spoon_101 cat_236)) (spoon_91 cat_200)))
(assert (= cat_201 ((_ to_fp 11 53) RNE cat_200)))
(assert (= cat_243 (mk_potato_11 cat_182)))
(assert (= cat_244 cat_201))
(assert (and (= cat_202 (spoon_99 cat_234)) (spoon_91 cat_202)))
(assert (= cat_203 ((_ to_fp 11 53) RNE cat_202)))
(assert (= cat_245 (mk_potato_11 cat_183)))
(assert (= cat_246 cat_203))
(assert (and (= cat_204 (spoon_101 cat_234)) (spoon_91 cat_204)))
(assert (= cat_205 ((_ to_fp 11 53) RNE cat_204)))
(assert (= cat_247 (mk_potato_11 cat_184)))
(assert (= cat_248 cat_205))
(assert (and (= cat_208 (fp.mul RNE cat_240 cat_244)) (spoon_2 (fp.mul RNE cat_240 cat_244))))
(assert (= cat_209 (fp.mul RNE cat_208 cat_248)))
(assert (and (= cat_210 cat_209) (spoon_2 cat_209)))
(assert (and (= cat_206 (fp.mul RNE cat_238 cat_242)) (spoon_2 (fp.mul RNE cat_238 cat_242))))
...
(assert (= cat_250 cat_213))
(assert (and (= cat_214 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_141) cat_246)) (spoon_2 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_141) cat_246))))
(assert (= cat_215 (fp.mul RNE cat_214 cat_240)))
(assert (and (= cat_216 cat_215) (spoon_2 cat_215)))
(assert (= cat_251 (mk_potato_11 cat_188)))
(assert (= cat_252 cat_216))
(assert (=> (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_250) (and (= cat_217 (fp.div RNE cat_252 cat_250)) (spoon_2 (fp.div RNE cat_252 cat_250)))))
(assert (=> (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_250) (= cat_253 spoon_267)))
(assert (=> (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_250) (= cat_254 cat_217)))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_250)) (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_250) (and (= cat_223 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_250)) (spoon_2 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_250))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_250)) (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_250) (= cat_224 (ite (fp.leq cat_252 cat_223) true false)))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_250)) (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_250) (and (= cat_222 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_250)) (spoon_2 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_250))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_250)) (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_250) (= cat_225 (ite (fp.leq cat_222 cat_252) true false)))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_250)) (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_250) (= cat_256 (ite (= cat_225 true) cat_224 false)))))
...
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_250)) (=> (not (= cat_256 true)) (=> (fp.lt cat_250 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_220 (ite (fp.leq cat_252 cat_219) true false))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_250)) (=> (not (= cat_256 true)) (=> (fp.lt cat_250 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (and (= cat_218 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_250)) (spoon_2 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_250)))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_250)) (=> (not (= cat_256 true)) (=> (fp.lt cat_250 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_221 (ite (fp.leq cat_218 cat_252) true false))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_250)) (=> (not (= cat_256 true)) (=> (fp.lt cat_250 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_255 (ite (= cat_221 true) cat_220 false))))))
...
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_250)) (=> (= cat_255 true) (and (= cat_226 (fp.div RNE cat_252 cat_250)) (spoon_2 (fp.div RNE cat_252 cat_250))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_250)) (=> (= cat_255 true) (= cat_257 spoon_267))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_250)) (=> (= cat_255 true) (= cat_258 cat_226))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_250)) (=> (not (= cat_255 true)) (=> (fp.lt cat_252 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_259 spoon_267)))))
...
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_250)) (=> (not (= cat_255 true)) (=> (not (fp.lt cat_252 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))) (= cat_261 spoon_267)))))
...
(assert (and (= cat_227 (fp.mul RNE cat_238 cat_244)) (spoon_2 (fp.mul RNE cat_238 cat_244))))
(assert (= cat_263 (mk_potato_11 cat_185)))
(assert (= cat_264 cat_227))
(assert (and (= cat_228 (fp.mul RNE cat_240 cat_242)) (spoon_2 (fp.mul RNE cat_240 cat_242))))
(assert (= cat_229 (fp.mul RNE cat_228 cat_248)))
(assert (and (= cat_230 cat_229) (spoon_2 cat_229)))
(assert (= cat_265 (mk_potato_11 cat_186)))
(assert (= cat_266 cat_230))
(assert (not (spoon_2 (fp.sub RNE cat_264 cat_266))))
(check-sat)
(exit)
