...
(define-fun spoon_48 ((kitten_42 Float32)) Bool (and (spoon_1 kitten_42) (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)) kitten_42) (fp.leq kitten_42 (fp #b0 #b10000101 #b01100111111101011101000)))))
...
(define-fun spoon_55 ((kitten_44 Float32) (kitten_45 Bool) (kitten_46 Bool) (kitten_47 Bool) (kitten_48 Bool)) Bool (=> (or (= kitten_45 true) (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)) (fp #b0 #b10000101 #b01100111111101011101000))) (spoon_48 kitten_44)))
(declare-sort potato_16 0)
(define-fun spoon_56 ((kitten_49 Float32)) Bool (and (spoon_1 kitten_49) (and (fp.leq (fp.neg (fp #b0 #b10001011 #b01101010100000000000000)) kitten_49) (fp.leq kitten_49 (fp #b0 #b10001011 #b01101010100000000000000)))))
...
(define-fun spoon_63 ((kitten_51 Float32) (kitten_52 Bool) (kitten_53 Bool) (kitten_54 Bool) (kitten_55 Bool)) Bool (=> (or (= kitten_52 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b01101010100000000000000)) (fp #b0 #b10001011 #b01101010100000000000000))) (spoon_56 kitten_51)))
...
(define-fun spoon_64 ((kitten_57 Float32)) Bool (and (spoon_1 kitten_57) (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) kitten_57) (fp.leq kitten_57 (fp #b0 #b10000101 #b01101000000000000000000)))))
...
(declare-const cat_69 potato_18)
...
(define-fun spoon_71 ((kitten_59 Float32) (kitten_60 Bool) (kitten_61 Bool) (kitten_62 Bool) (kitten_63 Bool)) Bool (=> (or (= kitten_60 true) (fp.leq (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) (fp #b0 #b10000101 #b01101000000000000000000))) (spoon_64 kitten_59)))
(declare-sort potato_20 0)
(define-fun spoon_72 ((kitten_64 Float32)) Bool (and (spoon_1 kitten_64) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_64) (fp.leq kitten_64 (fp #b0 #b11111110 #b11111111111111111111111)))))
...
(define-fun spoon_79 ((kitten_66 Float32) (kitten_67 Bool) (kitten_68 Bool) (kitten_69 Bool) (kitten_70 Bool)) Bool (=> (or (= kitten_67 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b11111110 #b11111111111111111111111))) (spoon_72 kitten_66)))
(declare-sort potato_22 0)
(declare-fun spoon_80 (potato_22 potato_22) Bool)
(declare-fun spoon_81 (Float64) potato_5)
(declare-fun spoon_82 (potato_5) Bool)
(declare-fun spoon_83 (potato_5) Float64)
(declare-const cat_84 potato_22)
...
(declare-fun spoon_87 (Float64) potato_5)
(declare-fun spoon_88 (potato_5) Bool)
(declare-fun spoon_89 (potato_5) Float64)
(declare-const cat_90 potato_24)
...
(define-fun spoon_92 ((kitten_73 Float64) (kitten_74 Bool) (kitten_75 Bool) (kitten_76 Bool) (kitten_77 Bool)) Bool (=> (or (= kitten_74 true) (fp.leq (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111))) (spoon_3 kitten_73)))
(declare-sort potato_26 0)
(define-fun spoon_93 ((kitten_78 Float64)) Bool (and (spoon_3 kitten_78) (and (fp.leq (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) kitten_78) (fp.leq kitten_78 (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))))
(declare-fun spoon_94 (potato_26 potato_26) Bool)
(declare-fun spoon_95 (Float64) potato_5)
(declare-fun spoon_96 (potato_5) Bool)
(declare-fun spoon_97 (potato_5) Float64)
(declare-const cat_98 potato_26)
...
(define-fun spoon_100 ((kitten_80 Float64) (kitten_81 Bool) (kitten_82 Bool) (kitten_83 Bool) (kitten_84 Bool)) Bool (=> (or (= kitten_81 true) (fp.leq (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))) (spoon_93 kitten_80)))
(declare-sort potato_28 0)
(define-fun spoon_101 ((kitten_85 Float32)) Bool (and (spoon_1 kitten_85) (and (fp.leq (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)) kitten_85) (fp.leq kitten_85 (fp #b0 #b01111111 #b00000000000000000000000)))))
...
(define-fun spoon_108 ((kitten_87 Float32) (kitten_88 Bool) (kitten_89 Bool) (kitten_90 Bool) (kitten_91 Bool)) Bool (=> (or (= kitten_88 true) (fp.leq (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)) (fp #b0 #b01111111 #b00000000000000000000000))) (spoon_101 kitten_87)))
...
(define-fun spoon_127 ((kitten_92 Float32) (kitten_93 Bool) (kitten_94 Bool) (kitten_95 Bool) (kitten_96 Bool)) Bool (=> (or (= kitten_93 true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111))) (spoon_1 kitten_92)))
(assert (= cat_117 ((_ to_fp 8 24) RNE (fp.mul RNE cat_109 cat_109))))
(assert (= cat_119 (spoon_46 cat_113)))
(assert (= cat_121 (fp.add RNE (fp #b0 #b01111111 #b00000000000000000000000) (fp.mul RNE (fp.sub RNE (fp #b0 #b01111111 #b00000000000000000000000) cat_117) (fp.mul RNE cat_119 cat_119)))))
(assert (= cat_123 (fp.sqrt RNE cat_121)))
...
(assert (and (and (fp.leq (fp #b0 #b01110101 #b00000110001001001101111) cat_111) (fp.leq cat_111 (fp #b0 #b01111000 #b01000111101011100001010))) (and (fp.leq (fp #b0 #b01111111000 #b0100011110101110000101000111101011100001010001111011) cat_109) (fp.leq cat_109 (fp #b0 #b01111111011 #b1001100110011001100110011001100110011001100110011010)))))
(assert (=> (fp.leq (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) (fp #b0 #b10000101 #b01101000000000000000000)) (spoon_64 cat_128)))
(assert (=> (fp.leq (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) (fp #b0 #b10000101 #b01101000000000000000000)) (spoon_64 cat_129)))
(assert (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011100001)) cat_113))
(assert (fp.leq cat_113 (fp #b0 #b10000101 #b01100111111101011100001)))
(assert (= ((_ to_fp 8 24) RNE (fp.mul RNE cat_109 cat_109)) cat_117))
...
(assert (and (= cat_134 (fp.sub RNE (fp #b0 #b01111111 #b00000000000000000000000) cat_117)) (spoon_1 (fp.sub RNE (fp #b0 #b01111111 #b00000000000000000000000) cat_117))))
(assert (= cat_135 (fp.mul RNE cat_134 (fp.mul RNE cat_119 cat_119))))
(assert (and (= cat_136 cat_135) (spoon_1 cat_135)))
(assert (= cat_137 (fp.add RNE (fp #b0 #b01111111 #b00000000000000000000000) cat_136)))
...
(assert (and (= cat_140 (fp.sqrt RNE cat_121)) (spoon_1 (fp.sqrt RNE cat_121))))
(assert (= cat_140 cat_123))
(assert (spoon_72 cat_123))
(assert (=> (fp.leq (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) (spoon_3 cat_130)))
(assert (=> (fp.leq (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) (spoon_3 cat_131)))
(assert (and (= cat_141 (fp.mul RNE cat_117 cat_119)) (spoon_1 (fp.mul RNE cat_117 cat_119))))
(assert (= cat_142 ((_ to_fp 11 53) RNE cat_141)))
(assert (= cat_143 (fp.sub RNE cat_142 (fp.mul RNE ((_ to_fp 11 53) RNE cat_111) ((_ to_fp 11 53) RNE cat_123)))))
(assert (= (mk_potato_11 cat_151) (mk_potato_11 cat_130)))
(assert (= cat_152 cat_143))
(assert (and (= cat_144 (fp.mul RNE cat_123 cat_119)) (spoon_1 (fp.mul RNE cat_123 cat_119))))
(assert (= cat_145 ((_ to_fp 11 53) RNE cat_144)))
(assert (= cat_146 (fp.mul RNE ((_ to_fp 11 53) RNE cat_111) cat_145)))
(assert (= cat_147 (fp.add RNE ((_ to_fp 11 53) RNE cat_121) cat_146)))
(assert (= (mk_potato_11 cat_153) (mk_potato_11 cat_131)))
(assert (= cat_154 cat_147))
(assert (and (= cat_148 (fp.mul RNE cat_152 (fp #b0 #b10000000100 #b1100101001011101110000001101000000111100111100100110))) (spoon_3 (fp.mul RNE cat_152 (fp #b0 #b10000000100 #b1100101001011101110000001101000000111100111100100110)))))
(assert (= cat_152 cat_155))
(assert (= cat_156 cat_148))
(assert (and (= cat_149 (fp.div RNE cat_156 cat_154)) (spoon_3 (fp.div RNE cat_156 cat_154))))
(assert (= cat_150 ((_ to_fp 8 24) RNE cat_149)))
(assert (not (spoon_64 cat_150)))
(check-sat)
(exit)
