...
(declare-fun cat_155 () (_ FloatingPoint 11 53))
...
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_152 (fp (_ bv0 1) (_ bv1028 11) (_ bv3560064250269478 52))))) (and (= cat_148 _let_0) (spoon_3 _let_0))))
(assert (= cat_152 cat_155))
(assert (= cat_156 cat_148))
(assert (let ((_let_0 (fp.div roundNearestTiesToEven cat_156 cat_154))) (and (= cat_149 _let_0) (spoon_3 _let_0))))
(assert (= cat_150 ((_ to_fp 8 24) roundNearestTiesToEven cat_149)))
