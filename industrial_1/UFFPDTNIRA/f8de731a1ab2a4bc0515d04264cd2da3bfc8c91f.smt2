...
(declare-const cat_237 potato_7)
(declare-const cat_238 Bool)
(declare-const cat_239 potato_29)
(declare-const cat_240 potato_28)
...
(assert (= cat_237 (mk_potato_7 cat_203)))
(assert (= cat_238 (distinct 1 0)))
(assert (= cat_239 (mk_potato_29 (mk_potato_28 cat_201 cat_202))))
(assert (= cat_240 (get_potato_30_a cat_138)))
(assert (= cat_241 (mk_potato_11 cat_206)))
(assert (= cat_242 (fp.mul RNE cat_181 cat_181)))
(assert (and (= cat_224 ((_ to_fp 11 53) RNE (fp.mul RNE cat_177 cat_177))) (spoon_3 ((_ to_fp 11 53) RNE (fp.mul RNE cat_177 cat_177)))))
(assert (= cat_243 (mk_potato_11 cat_204)))
(assert (= cat_244 cat_224))
(assert (and (= cat_225 ((_ to_fp 11 53) RNE (fp.mul RNE cat_179 cat_179))) (spoon_3 ((_ to_fp 11 53) RNE (fp.mul RNE cat_179 cat_179)))))
(assert (= cat_245 (mk_potato_11 cat_205)))
(assert (= cat_246 cat_225))
(assert (= cat_247 (mk_potato_11 cat_207)))
(assert (= cat_248 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_181)))
(assert (and (= cat_226 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_242)) (spoon_3 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_242))))
(assert (= cat_249 (mk_potato_11 cat_208)))
(assert (= cat_250 cat_226))
...
(assert (= cat_251 (mk_potato_11 cat_209)))
(assert (= cat_252 cat_229))
...
(assert (= cat_253 (mk_potato_11 cat_210)))
(assert (= cat_254 cat_232))
(assert (and (= cat_233 (fp.mul RNE cat_248 ((_ to_fp 11 53) RNE cat_179))) (spoon_3 (fp.mul RNE cat_248 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_234 (fp.mul RNE cat_233 cat_254)))
(assert (not (spoon_3 cat_234)))
(check-sat)
(exit)
