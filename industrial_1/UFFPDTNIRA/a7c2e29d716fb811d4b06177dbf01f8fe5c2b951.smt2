...
(assert (and (= cat_212 (fp.mul RNE cat_232 cat_236)) (spoon_3 (fp.mul RNE cat_232 cat_236))))
(assert (= cat_213 (fp.mul RNE cat_212 cat_240)))
(assert (and (= cat_214 cat_213) (spoon_3 cat_213)))
(assert (and (= cat_210 (fp.mul RNE cat_230 cat_234)) (spoon_3 (fp.mul RNE cat_230 cat_234))))
...
(assert (and (= cat_218 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_145) cat_238)) (spoon_3 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_145) cat_238))))
...
(assert (and (= cat_221 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_242)) (spoon_3 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_242))))
(assert (= cat_222 (ite (fp.leq cat_244 cat_221) true false)))
(assert (not (spoon_3 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_242))))
(check-sat)
(exit)
