...
(assert (and (= cat_227 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_267)) (spoon_3 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_267))))
(assert (= cat_228 (ite (fp.leq cat_269 cat_227) true false)))
