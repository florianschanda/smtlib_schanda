...
(assert (= cat_226 cat_196))
(assert (and (= cat_197 (spoon_137 (spoon_60 (get_potato_18_a (get_potato_20_a cat_141))))) (spoon_87 cat_197)))
(assert (= cat_227 cat_182))
(assert (= cat_228 cat_197))
(assert (and (= cat_198 (spoon_103 cat_224)) (spoon_95 cat_198)))
(assert (= cat_199 ((_ to_fp 11 53) RNE cat_198)))
(assert (= cat_229 cat_183))
(assert (= cat_230 cat_199))
(assert (and (= cat_200 (spoon_105 cat_224)) (spoon_95 cat_200)))
(assert (= cat_201 ((_ to_fp 11 53) RNE cat_200)))
(assert (= cat_231 cat_184))
(assert (= cat_232 cat_201))
(assert (and (= cat_202 (spoon_103 cat_228)) (spoon_95 cat_202)))
(assert (= cat_203 ((_ to_fp 11 53) RNE cat_202)))
(assert (= cat_233 (mk_potato_11 cat_185)))
(assert (= cat_234 cat_203))
(assert (and (= cat_204 (spoon_105 cat_228)) (spoon_95 cat_204)))
(assert (= cat_205 ((_ to_fp 11 53) RNE cat_204)))
(assert (= cat_235 (mk_potato_11 cat_186)))
(assert (= cat_236 cat_205))
(assert (and (= cat_206 (spoon_103 cat_226)) (spoon_95 cat_206)))
(assert (= cat_207 ((_ to_fp 11 53) RNE cat_206)))
(assert (= cat_237 (mk_potato_11 cat_187)))
(assert (= cat_238 cat_207))
(assert (and (= cat_208 (spoon_105 cat_226)) (spoon_95 cat_208)))
(assert (= cat_209 ((_ to_fp 11 53) RNE cat_208)))
(assert (= cat_239 (mk_potato_11 cat_188)))
(assert (= cat_240 cat_209))
(assert (and (= cat_212 (fp.mul RNE cat_232 cat_236)) (spoon_2 (fp.mul RNE cat_232 cat_236))))
(assert (= cat_213 (fp.mul RNE cat_212 cat_240)))
(assert (and (= cat_214 cat_213) (spoon_2 cat_213)))
(assert (and (= cat_210 (fp.mul RNE cat_230 cat_234)) (spoon_2 (fp.mul RNE cat_230 cat_234))))
...
(assert (= cat_241 (mk_potato_11 cat_191)))
(assert (= cat_242 cat_217))
(assert (and (= cat_218 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_145) cat_238)) (spoon_2 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_145) cat_238))))
(assert (= cat_219 (fp.mul RNE cat_218 cat_232)))
(assert (and (= cat_220 cat_219) (spoon_2 cat_219)))
(assert (= cat_243 (mk_potato_11 cat_192)))
(assert (= cat_244 cat_220))
(assert (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_242)))
(assert (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_242))
(assert (and (= cat_221 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_242)) (spoon_2 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_242))))
(assert (= cat_222 (ite (fp.leq cat_244 cat_221) true false)))
(assert (not (spoon_2 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_242))))
(check-sat)
(exit)
