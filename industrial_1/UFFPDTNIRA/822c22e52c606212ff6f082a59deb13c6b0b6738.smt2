...
(assert (and (= cat_212 (fp.mul RNE cat_241 cat_245)) (spoon_3 (fp.mul RNE cat_241 cat_245))))
(assert (= cat_213 (fp.mul RNE cat_212 cat_249)))
(assert (and (= cat_214 cat_213) (spoon_3 cat_213)))
(assert (and (= cat_210 (fp.mul RNE cat_239 cat_243)) (spoon_3 (fp.mul RNE cat_239 cat_243))))
...
(assert (and (= cat_218 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_145) cat_247)) (spoon_3 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_145) cat_247))))
...
(assert (=> (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_251) (and (= cat_221 (fp.div RNE cat_253 cat_251)) (spoon_3 (fp.div RNE cat_253 cat_251)))))
...
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_251)) (=> (= cat_256 true) (and (= cat_230 (fp.div RNE cat_253 cat_251)) (spoon_3 (fp.div RNE cat_253 cat_251))))))
...
(assert (and (= cat_231 (fp.mul RNE cat_239 cat_245)) (spoon_3 (fp.mul RNE cat_239 cat_245))))
(assert (= cat_264 (mk_potato_11 cat_189)))
(assert (= cat_265 cat_231))
(assert (not (spoon_3 (fp.mul RNE cat_241 cat_243))))
(check-sat)
(exit)
