...
(assert (and (= cat_146 cat_145) (spoon_1 cat_145)))
(assert (= (spoon_77 cat_147) cat_146))
(assert (and (= cat_139 (fp.div RNE (spoon_77 cat_114) cat_117)) (spoon_1 (fp.div RNE (spoon_77 cat_114) cat_117))))
(assert (= cat_140 (fp.mul RNE cat_139 cat_116)))
(assert (and (= cat_141 cat_140) (spoon_1 cat_140)))
(assert (and (= cat_142 cat_141) (spoon_1 cat_141)))
(assert (= (spoon_77 cat_148) cat_142))
(assert (= cat_148 cat_149))
(assert (= cat_147 cat_150))
(assert (= cat_151 cat_149))
(assert (= cat_152 cat_150))
(assert (= cat_159 (mk_potato_24 (mk_potato_23 cat_120 cat_121))))
(assert (= cat_160 (mk_potato_23 cat_151 cat_152)))
(assert (not (spoon_37 (fp.add RNE (spoon_44 (get_potato_15_b (get_potato_17_a cat_81))) (spoon_77 (get_potato_23_b cat_160))))))
(check-sat)
(exit)
