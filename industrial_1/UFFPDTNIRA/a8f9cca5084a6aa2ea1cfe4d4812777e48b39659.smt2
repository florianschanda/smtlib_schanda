...
(declare-const cat_130 potato_24)
...
(assert (and (= cat_120 (fp.div RNE (spoon_75 cat_111) cat_113)) (spoon_1 (fp.div RNE (spoon_75 cat_111) cat_113))))
(assert (= cat_121 (fp.mul RNE cat_120 cat_112)))
(assert (and (= cat_122 cat_121) (spoon_1 cat_121)))
(assert (and (= cat_123 cat_122) (spoon_1 cat_122)))
(assert (= (spoon_75 cat_124) cat_123))
(assert (and (= cat_116 (fp.div RNE (spoon_75 cat_110) cat_113)) (spoon_1 (fp.div RNE (spoon_75 cat_110) cat_113))))
(assert (= cat_117 (fp.mul RNE cat_116 cat_112)))
...
(assert (= cat_130 (mk_potato_24 (mk_potato_23 cat_114 cat_115))))
(assert (= cat_131 (mk_potato_23 cat_128 cat_129)))
(assert (not (spoon_35 (fp.add RNE (spoon_42 (get_potato_15_b (get_potato_17_a cat_79))) (spoon_75 (get_potato_23_b cat_131))))))
(check-sat)
(exit)
