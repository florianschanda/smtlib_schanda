...
(declare-const cat_116 potato_21)
...
(declare-const cat_132 potato_24)
...
(assert (and (= cat_122 (fp.div RNE (spoon_77 cat_113) cat_115)) (spoon_1 (fp.div RNE (spoon_77 cat_113) cat_115))))
(assert (= cat_123 (fp.mul RNE cat_122 cat_114)))
(assert (and (= cat_124 cat_123) (spoon_1 cat_123)))
(assert (and (= cat_125 cat_124) (spoon_1 cat_124)))
(assert (= (spoon_77 cat_126) cat_125))
(assert (and (= cat_118 (fp.div RNE (spoon_77 cat_112) cat_115)) (spoon_1 (fp.div RNE (spoon_77 cat_112) cat_115))))
(assert (= cat_119 (fp.mul RNE cat_118 cat_114)))
(assert (and (= cat_120 cat_119) (spoon_1 cat_119)))
(assert (and (= cat_121 cat_120) (spoon_1 cat_120)))
(assert (= (spoon_77 cat_127) cat_121))
(assert (= cat_127 cat_128))
(assert (= cat_126 cat_129))
(assert (= cat_130 cat_128))
(assert (= cat_131 cat_129))
(assert (= cat_132 (mk_potato_24 (mk_potato_23 cat_116 cat_117))))
(assert (= cat_133 (mk_potato_23 cat_130 cat_131)))
(assert (not (spoon_37 (fp.add RNE (spoon_44 (get_potato_15_b (get_potato_17_a cat_81))) (spoon_77 (get_potato_23_b cat_133))))))
(check-sat)
(exit)
