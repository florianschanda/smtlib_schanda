...
(assert (and (= cat_230 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_267)) (spoon_3 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_267))))
...
(assert (and (= cat_241 (fp.mul RNE cat_273 ((_ to_fp 11 53) RNE cat_183))) (spoon_3 (fp.mul RNE cat_273 ((_ to_fp 11 53) RNE cat_183)))))
(assert (= cat_242 (fp.mul RNE cat_241 cat_279)))
(assert (and (= cat_243 cat_242) (spoon_3 cat_242)))
(assert (and (= cat_237 (fp.sub RNE cat_275 cat_269)) (spoon_3 (fp.sub RNE cat_275 cat_269))))
...
(assert (and (= cat_247 (fp.add RNE cat_275 cat_269)) (spoon_3 (fp.add RNE cat_275 cat_269))))
...
(assert (and (= cat_250 (fp.div RNE cat_281 cat_283)) (spoon_3 (fp.div RNE cat_281 cat_283))))
...
(assert (=> (not (fp.lt cat_285 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_285)) (and (= cat_251 cat_285) (spoon_3 cat_285)))))
...
(assert (and (= cat_252 (fp.mul RNE cat_273 ((_ to_fp 11 53) RNE cat_181))) (spoon_3 (fp.mul RNE cat_273 ((_ to_fp 11 53) RNE cat_181)))))
(assert (= cat_292 (mk_potato_11 cat_220)))
(assert (= cat_293 cat_252))
(assert (and (= cat_257 (fp.mul RNE cat_273 ((_ to_fp 11 53) RNE cat_183))) (spoon_3 (fp.mul RNE cat_273 ((_ to_fp 11 53) RNE cat_183)))))
(assert (= cat_258 (fp.mul RNE cat_257 cat_277)))
(assert (and (= cat_259 cat_258) (spoon_3 cat_258)))
(assert (and (= cat_253 (fp.sub RNE cat_275 cat_269)) (spoon_3 (fp.sub RNE cat_275 cat_269))))
