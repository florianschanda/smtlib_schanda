...
(declare-const cat_260 potato_19)
(declare-const cat_261 potato_18)
...
(assert (= cat_260 (mk_potato_19 (mk_potato_18 cat_201 cat_202))))
(assert (= cat_261 (get_potato_20_a cat_85)))
(assert (= cat_262 (mk_potato_11 cat_206)))
(assert (= cat_263 (fp.mul RNE cat_181 cat_181)))
...
(assert (= cat_269 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_181)))
(assert (and (= cat_226 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_263)) (spoon_2 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_263))))
...
(assert (and (= cat_237 (fp.mul RNE cat_269 ((_ to_fp 11 53) RNE cat_179))) (spoon_2 (fp.mul RNE cat_269 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_238 (fp.mul RNE cat_237 cat_275)))
(assert (and (= cat_239 cat_238) (spoon_2 cat_238)))
(assert (and (= cat_233 (fp.sub RNE cat_271 cat_265)) (spoon_2 (fp.sub RNE cat_271 cat_265))))
(assert (= cat_234 (fp.sub RNE cat_233 cat_267)))
(assert (and (= cat_235 cat_234) (spoon_2 cat_234)))
(assert (= cat_236 (fp.mul RNE cat_235 cat_273)))
...
(assert (and (= cat_243 (fp.add RNE cat_271 cat_265)) (spoon_2 (fp.add RNE cat_271 cat_265))))
(assert (= cat_244 (fp.add RNE cat_243 cat_267)))
(assert (and (= cat_245 cat_244) (spoon_2 cat_244)))
(assert (= cat_278 (mk_potato_11 cat_214)))
(assert (= cat_279 cat_245))
(assert (and (= cat_246 (fp.div RNE cat_277 cat_279)) (spoon_2 (fp.div RNE cat_277 cat_279))))
(assert (= cat_280 (mk_potato_11 cat_212)))
(assert (= cat_281 cat_246))
(assert (=> (fp.lt cat_281 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))) (= cat_282 spoon_290)))
(assert (=> (fp.lt cat_281 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))) (= cat_283 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))))
(assert (=> (not (fp.lt cat_281 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_281) (= cat_284 spoon_290))))
(assert (=> (not (fp.lt cat_281 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_281) (= cat_285 (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))))
(assert (=> (not (fp.lt cat_281 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_281)) (and (= cat_247 cat_281) (spoon_2 cat_281)))))
(assert (=> (not (fp.lt cat_281 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_281)) (= cat_286 spoon_290))))
(assert (=> (not (fp.lt cat_281 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_281)) (= cat_287 cat_247))))
(assert (=> (not (fp.lt cat_281 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_281)) (= cat_285 cat_287))))
(assert (=> (not (fp.lt cat_281 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (= cat_283 cat_285)))
(assert (and (= cat_248 (fp.mul RNE cat_269 ((_ to_fp 11 53) RNE cat_177))) (spoon_2 (fp.mul RNE cat_269 ((_ to_fp 11 53) RNE cat_177)))))
(assert (= cat_288 (mk_potato_11 cat_216)))
(assert (= cat_289 cat_248))
(assert (and (= cat_253 (fp.mul RNE cat_269 ((_ to_fp 11 53) RNE cat_179))) (spoon_2 (fp.mul RNE cat_269 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_254 (fp.mul RNE cat_253 cat_273)))
(assert (and (= cat_255 cat_254) (spoon_2 cat_254)))
(assert (and (= cat_249 (fp.sub RNE cat_271 cat_265)) (spoon_2 (fp.sub RNE cat_271 cat_265))))
(assert (= cat_250 (fp.sub RNE cat_249 cat_267)))
(assert (and (= cat_251 cat_250) (spoon_2 cat_250)))
(assert (= cat_252 (fp.mul RNE cat_251 cat_275)))
(assert (not (spoon_2 cat_252)))
(check-sat)
(exit)
