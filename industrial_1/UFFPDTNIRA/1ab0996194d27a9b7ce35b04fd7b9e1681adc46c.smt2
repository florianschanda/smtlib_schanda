...
(declare-const cat_179 potato_28)
(declare-const cat_180 potato_27)
(declare-const cat_181 potato_28)
(declare-const cat_182 potato_27)
...
(assert (= cat_175 (mk_potato_28 (mk_potato_27 cat_139 cat_140))))
(assert (= cat_176 (mk_potato_27 cat_150 cat_151)))
(assert (= (spoon_79 cat_152) (fp.neg (fp.mul RNE (fp #b0 #b01111111 #b00000000000000000000000) (spoon_79 (get_potato_27_b cat_176))))))
(assert (= cat_152 cat_153))
(assert (= (get_potato_27_a cat_176) cat_154))
(assert (= cat_155 cat_153))
(assert (= cat_156 cat_154))
(assert (= cat_177 (mk_potato_28 (mk_potato_27 cat_137 cat_138))))
(assert (= cat_178 (mk_potato_27 cat_155 cat_156)))
...
(assert (= cat_179 (mk_potato_28 (mk_potato_27 cat_133 cat_134))))
(assert (= cat_180 (mk_potato_27 cat_161 cat_162)))
...
(assert (= cat_181 (mk_potato_28 (mk_potato_27 cat_135 cat_136))))
(assert (= cat_182 (get_potato_29_a cat_166)))
(assert (and (= cat_167 (spoon_119 (mk_potato_29 cat_176) (mk_potato_29 cat_176))) (and (spoon_111 cat_167) (= cat_167 (fp.add RNE (fp.mul RNE (spoon_79 (get_potato_27_a cat_176)) (spoon_79 (get_potato_27_a cat_176))) (fp.mul RNE (spoon_79 (get_potato_27_b cat_176)) (spoon_79 (get_potato_27_b cat_176))))))))
(assert (= cat_183 (mk_potato_10 cat_141)))
(assert (= cat_184 cat_167))
(assert (and (= cat_168 (spoon_119 (mk_potato_29 cat_180) (mk_potato_29 cat_178))) (and (spoon_111 cat_168) (= cat_168 (fp.add RNE (fp.mul RNE (spoon_79 (get_potato_27_a cat_180)) (spoon_79 (get_potato_27_a cat_178))) (fp.mul RNE (spoon_79 (get_potato_27_b cat_180)) (spoon_79 (get_potato_27_b cat_178))))))))
(assert (and (= cat_169 (spoon_119 (mk_potato_29 cat_182) (mk_potato_29 cat_178))) (and (spoon_111 cat_169) (= cat_169 (fp.add RNE (fp.mul RNE (spoon_79 (get_potato_27_a cat_182)) (spoon_79 (get_potato_27_a cat_178))) (fp.mul RNE (spoon_79 (get_potato_27_b cat_182)) (spoon_79 (get_potato_27_b cat_178))))))))
(assert (= cat_170 (fp.sub RNE cat_169 cat_168)))
(assert (= cat_185 (mk_potato_10 cat_143)))
(assert (= cat_186 cat_170))
(assert (and (= cat_171 (fp.sqrt RNE cat_184)) (spoon_1 (fp.sqrt RNE cat_184))))
(assert (= cat_187 (mk_potato_10 cat_144)))
(assert (= cat_188 cat_171))
(assert (not (fp.leq (fp.mul RNE (fp #b0 #b10110110 #b00000000000000000000000) cat_188) (fp.abs cat_186))))
(assert (and (= cat_172 (fp.div RNE (fp.abs cat_186) cat_188)) (spoon_1 (fp.div RNE (fp.abs cat_186) cat_188))))
(assert (not (spoon_87 cat_172)))
(check-sat)
(exit)
