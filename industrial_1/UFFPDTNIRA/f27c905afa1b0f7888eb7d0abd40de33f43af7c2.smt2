...
(assert (and (= cat_210 (fp.mul RNE cat_222 cat_226)) (spoon_3 (fp.mul RNE cat_222 cat_226))))
(assert (= cat_211 (fp.mul RNE cat_210 cat_230)))
(assert (and (= cat_212 cat_211) (spoon_3 cat_211)))
(assert (not (spoon_3 (fp.mul RNE cat_220 cat_224))))
(check-sat)
(exit)
