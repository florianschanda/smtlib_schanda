...
(assert (= cat_213 cat_181))
(assert (= cat_214 cat_195))
...
(assert (= cat_217 cat_182))
(assert (= cat_218 cat_197))
(assert (and (= cat_198 (spoon_103 cat_214)) (spoon_95 cat_198)))
(assert (= cat_199 ((_ to_fp 11 53) RNE cat_198)))
(assert (= cat_219 cat_183))
(assert (= cat_220 cat_199))
(assert (and (= cat_200 (spoon_105 cat_214)) (spoon_95 cat_200)))
(assert (= cat_201 ((_ to_fp 11 53) RNE cat_200)))
(assert (= cat_221 cat_184))
(assert (= cat_222 cat_201))
(assert (and (= cat_202 (spoon_103 cat_218)) (spoon_95 cat_202)))
(assert (= cat_203 ((_ to_fp 11 53) RNE cat_202)))
(assert (= cat_223 (mk_potato_11 cat_185)))
(assert (= cat_224 cat_203))
(assert (and (= cat_204 (spoon_105 cat_218)) (spoon_95 cat_204)))
(assert (= cat_205 ((_ to_fp 11 53) RNE cat_204)))
(assert (= cat_225 (mk_potato_11 cat_186)))
(assert (= cat_226 cat_205))
(assert (and (= cat_206 (spoon_103 cat_216)) (spoon_95 cat_206)))
(assert (= cat_207 ((_ to_fp 11 53) RNE cat_206)))
(assert (= cat_227 (mk_potato_11 cat_187)))
(assert (= cat_228 cat_207))
(assert (and (= cat_208 (spoon_105 cat_216)) (spoon_95 cat_208)))
(assert (= cat_209 ((_ to_fp 11 53) RNE cat_208)))
(assert (= cat_229 (mk_potato_11 cat_188)))
(assert (= cat_230 cat_209))
(assert (and (= cat_210 (fp.mul RNE cat_222 cat_226)) (spoon_2 (fp.mul RNE cat_222 cat_226))))
(assert (= cat_211 (fp.mul RNE cat_210 cat_230)))
(assert (and (= cat_212 cat_211) (spoon_2 cat_211)))
(assert (not (spoon_2 (fp.mul RNE cat_220 cat_224))))
(check-sat)
(exit)
