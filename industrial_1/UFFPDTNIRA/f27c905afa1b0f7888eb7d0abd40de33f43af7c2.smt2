...
(assert (= cat_211 cat_176))
(assert (= cat_212 cat_192))
(assert (and (= cat_193 (spoon_133 (spoon_56 (get_potato_18_a (get_potato_20_a cat_137))))) (spoon_83 cat_193)))
(assert (= cat_213 cat_178))
(assert (= cat_214 cat_193))
(assert (and (= cat_194 (spoon_99 cat_210)) (spoon_91 cat_194)))
(assert (= cat_195 ((_ to_fp 11 53) RNE cat_194)))
(assert (= cat_215 cat_179))
(assert (= cat_216 cat_195))
(assert (and (= cat_196 (spoon_101 cat_210)) (spoon_91 cat_196)))
(assert (= cat_197 ((_ to_fp 11 53) RNE cat_196)))
(assert (= cat_217 cat_180))
(assert (= cat_218 cat_197))
(assert (and (= cat_198 (spoon_99 cat_214)) (spoon_91 cat_198)))
(assert (= cat_199 ((_ to_fp 11 53) RNE cat_198)))
(assert (= cat_219 (mk_potato_11 cat_181)))
(assert (= cat_220 cat_199))
(assert (and (= cat_200 (spoon_101 cat_214)) (spoon_91 cat_200)))
(assert (= cat_201 ((_ to_fp 11 53) RNE cat_200)))
(assert (= cat_221 (mk_potato_11 cat_182)))
(assert (= cat_222 cat_201))
(assert (and (= cat_202 (spoon_99 cat_212)) (spoon_91 cat_202)))
(assert (= cat_203 ((_ to_fp 11 53) RNE cat_202)))
(assert (= cat_223 (mk_potato_11 cat_183)))
(assert (= cat_224 cat_203))
(assert (and (= cat_204 (spoon_101 cat_212)) (spoon_91 cat_204)))
(assert (= cat_205 ((_ to_fp 11 53) RNE cat_204)))
(assert (= cat_225 (mk_potato_11 cat_184)))
(assert (= cat_226 cat_205))
(assert (and (= cat_206 (fp.mul RNE cat_218 cat_222)) (spoon_2 (fp.mul RNE cat_218 cat_222))))
(assert (= cat_207 (fp.mul RNE cat_206 cat_226)))
(assert (and (= cat_208 cat_207) (spoon_2 cat_207)))
(assert (not (spoon_2 (fp.mul RNE cat_216 cat_220))))
(check-sat)
(exit)
