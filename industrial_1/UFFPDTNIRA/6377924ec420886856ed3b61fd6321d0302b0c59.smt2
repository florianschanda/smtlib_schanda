...
(define-fun spoon_103 () potato_10 (mk_potato_10 cat_80))
(define-fun spoon_104 () potato_10 (mk_potato_10 cat_79))
...
(assert (= (mk_potato_10 cat_91) (mk_potato_10 cat_81)))
(assert (= cat_92 cat_83))
(assert (=> (fp.lt cat_79 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000))) (= (mk_potato_10 cat_93) spoon_104)))
(assert (=> (fp.lt cat_79 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000))) (= cat_94 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))))
(assert (=> (fp.lt cat_79 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000))) (and (= cat_84 (fp.add RNE (fp.mul RNE cat_92 (fp.sub RNE cat_94 (spoon_44 (get_potato_15_a (get_potato_17_a cat_62))))) (spoon_44 (get_potato_15_b (get_potato_17_a cat_62))))) (spoon_1 (fp.add RNE (fp.mul RNE cat_92 (fp.sub RNE cat_94 (spoon_44 (get_potato_15_a (get_potato_17_a cat_62))))) (spoon_44 (get_potato_15_b (get_potato_17_a cat_62))))))))
(assert (=> (fp.lt cat_79 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000))) (= (mk_potato_10 cat_95) spoon_103)))
(assert (=> (fp.lt cat_79 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000))) (= cat_96 cat_84)))
(assert (=> (not (fp.lt cat_79 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_79) (= (mk_potato_10 cat_97) spoon_104))))
(assert (=> (not (fp.lt cat_79 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_79) (= cat_98 (fp #b0 #b10001011 #b00000000000000000000000)))))
(assert (=> (not (fp.lt cat_79 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_79) (and (= cat_85 (fp.add RNE (fp.mul RNE cat_92 (fp.sub RNE cat_98 (spoon_44 (get_potato_15_a (get_potato_17_a cat_62))))) (spoon_44 (get_potato_15_b (get_potato_17_a cat_62))))) (spoon_1 (fp.add RNE (fp.mul RNE cat_92 (fp.sub RNE cat_98 (spoon_44 (get_potato_15_a (get_potato_17_a cat_62))))) (spoon_44 (get_potato_15_b (get_potato_17_a cat_62)))))))))
(assert (=> (not (fp.lt cat_79 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_79) (= (mk_potato_10 cat_99) spoon_103))))
(assert (=> (not (fp.lt cat_79 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_79) (= cat_100 cat_85))))
(assert (=> (not (fp.lt cat_79 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_79)) (= cat_100 cat_80))))
(assert (=> (not (fp.lt cat_79 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_79)) (= cat_98 cat_79))))
(assert (=> (not (fp.lt cat_79 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_79)) (= cat_100 cat_90))))
(assert (=> (not (fp.lt cat_79 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_79)) (= cat_98 cat_89))))
(assert (=> (not (fp.lt cat_79 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (= cat_96 cat_100)))
(assert (=> (not (fp.lt cat_79 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (= cat_94 cat_98)))
(assert (fp.lt cat_96 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000))))
(assert (= cat_96 cat_101))
(assert (= cat_102 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000))))
(assert (and (= cat_86 (fp.div RNE (fp.sub RNE cat_102 (spoon_44 (get_potato_15_b (get_potato_17_a cat_62)))) cat_92)) (spoon_1 (fp.div RNE (fp.sub RNE cat_102 (spoon_44 (get_potato_15_b (get_potato_17_a cat_62)))) cat_92))))
(assert (= cat_87 (fp.add RNE cat_86 (spoon_44 (get_potato_15_a (get_potato_17_a cat_62))))))
(assert (and (= cat_88 cat_87) (spoon_1 cat_87)))
(assert (not (spoon_66 cat_88)))
(check-sat)
(exit)
