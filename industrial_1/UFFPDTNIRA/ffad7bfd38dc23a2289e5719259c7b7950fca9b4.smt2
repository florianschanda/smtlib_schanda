...
(assert (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_107)))
(assert (not (fp.leq cat_107 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)))))
(assert (not (spoon_60 cat_107)))
(check-sat)
(exit)
