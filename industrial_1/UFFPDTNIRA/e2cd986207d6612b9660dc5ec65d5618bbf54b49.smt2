...
(declare-const cat_260 potato_29)
(declare-const cat_261 potato_28)
...
(assert (and (= cat_226 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_263)) (spoon_3 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_263))))
...
(assert (and (= cat_237 (fp.mul RNE cat_269 ((_ to_fp 11 53) RNE cat_179))) (spoon_3 (fp.mul RNE cat_269 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_238 (fp.mul RNE cat_237 cat_275)))
(assert (and (= cat_239 cat_238) (spoon_3 cat_238)))
(assert (and (= cat_233 (fp.sub RNE cat_271 cat_265)) (spoon_3 (fp.sub RNE cat_271 cat_265))))
...
(assert (and (= cat_243 (fp.add RNE cat_271 cat_265)) (spoon_3 (fp.add RNE cat_271 cat_265))))
...
(assert (and (= cat_246 (fp.div RNE cat_277 cat_279)) (spoon_3 (fp.div RNE cat_277 cat_279))))
...
(assert (=> (not (fp.lt cat_281 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_281)) (and (= cat_247 cat_281) (spoon_3 cat_281)))))
...
(assert (and (= cat_248 (fp.mul RNE cat_269 ((_ to_fp 11 53) RNE cat_177))) (spoon_3 (fp.mul RNE cat_269 ((_ to_fp 11 53) RNE cat_177)))))
(assert (= cat_288 (mk_potato_11 cat_216)))
(assert (= cat_289 cat_248))
(assert (and (= cat_253 (fp.mul RNE cat_269 ((_ to_fp 11 53) RNE cat_179))) (spoon_3 (fp.mul RNE cat_269 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_254 (fp.mul RNE cat_253 cat_273)))
(assert (and (= cat_255 cat_254) (spoon_3 cat_254)))
(assert (and (= cat_249 (fp.sub RNE cat_271 cat_265)) (spoon_3 (fp.sub RNE cat_271 cat_265))))
