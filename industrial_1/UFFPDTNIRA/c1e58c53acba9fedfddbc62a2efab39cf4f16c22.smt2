...
(assert (and (= cat_212 (fp.mul RNE cat_240 cat_244)) (spoon_3 (fp.mul RNE cat_240 cat_244))))
(assert (= cat_213 (fp.mul RNE cat_212 cat_248)))
(assert (and (= cat_214 cat_213) (spoon_3 cat_213)))
(assert (and (= cat_210 (fp.mul RNE cat_238 cat_242)) (spoon_3 (fp.mul RNE cat_238 cat_242))))
...
(assert (and (= cat_218 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_145) cat_246)) (spoon_3 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_145) cat_246))))
...
(assert (=> (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_250) (and (= cat_221 (fp.div RNE cat_252 cat_250)) (spoon_3 (fp.div RNE cat_252 cat_250)))))
...
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_250)) (=> (= cat_255 true) (and (= cat_230 (fp.div RNE cat_252 cat_250)) (spoon_3 (fp.div RNE cat_252 cat_250))))))
...
(assert (not (spoon_3 (fp.mul RNE cat_238 cat_244))))
(check-sat)
(exit)
