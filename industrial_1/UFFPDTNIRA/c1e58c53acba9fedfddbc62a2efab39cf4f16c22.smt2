...
(define-fun spoon_259 () potato_11 (mk_potato_11 cat_174))
...
(assert (= cat_227 cat_177))
(assert (= cat_228 cat_191))
...
(assert (and (= cat_194 (spoon_99 cat_228)) (spoon_91 cat_194)))
(assert (= cat_195 ((_ to_fp 11 53) RNE cat_194)))
(assert (= cat_233 cat_179))
(assert (= cat_234 cat_195))
(assert (and (= cat_196 (spoon_101 cat_228)) (spoon_91 cat_196)))
(assert (= cat_197 ((_ to_fp 11 53) RNE cat_196)))
(assert (= cat_235 cat_180))
(assert (= cat_236 cat_197))
(assert (and (= cat_198 (spoon_99 cat_232)) (spoon_91 cat_198)))
(assert (= cat_199 ((_ to_fp 11 53) RNE cat_198)))
(assert (= cat_237 (mk_potato_11 cat_181)))
(assert (= cat_238 cat_199))
(assert (and (= cat_200 (spoon_101 cat_232)) (spoon_91 cat_200)))
(assert (= cat_201 ((_ to_fp 11 53) RNE cat_200)))
(assert (= cat_239 (mk_potato_11 cat_182)))
(assert (= cat_240 cat_201))
(assert (and (= cat_202 (spoon_99 cat_230)) (spoon_91 cat_202)))
(assert (= cat_203 ((_ to_fp 11 53) RNE cat_202)))
(assert (= cat_241 (mk_potato_11 cat_183)))
(assert (= cat_242 cat_203))
(assert (and (= cat_204 (spoon_101 cat_230)) (spoon_91 cat_204)))
(assert (= cat_205 ((_ to_fp 11 53) RNE cat_204)))
(assert (= cat_243 (mk_potato_11 cat_184)))
(assert (= cat_244 cat_205))
(assert (and (= cat_208 (fp.mul RNE cat_236 cat_240)) (spoon_2 (fp.mul RNE cat_236 cat_240))))
(assert (= cat_209 (fp.mul RNE cat_208 cat_244)))
(assert (and (= cat_210 cat_209) (spoon_2 cat_209)))
(assert (and (= cat_206 (fp.mul RNE cat_234 cat_238)) (spoon_2 (fp.mul RNE cat_234 cat_238))))
...
(assert (= cat_245 (mk_potato_11 cat_187)))
(assert (= cat_246 cat_213))
(assert (and (= cat_214 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_141) cat_242)) (spoon_2 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_141) cat_242))))
(assert (= cat_215 (fp.mul RNE cat_214 cat_236)))
(assert (and (= cat_216 cat_215) (spoon_2 cat_215)))
(assert (= cat_247 (mk_potato_11 cat_188)))
(assert (= cat_248 cat_216))
(assert (=> (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_246) (and (= cat_217 (fp.div RNE cat_248 cat_246)) (spoon_2 (fp.div RNE cat_248 cat_246)))))
(assert (=> (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_246) (= cat_249 spoon_259)))
(assert (=> (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_246) (= cat_250 cat_217)))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_246)) (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_246) (and (= cat_223 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_246)) (spoon_2 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_246))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_246)) (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_246) (= cat_224 (ite (fp.leq cat_248 cat_223) true false)))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_246)) (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_246) (and (= cat_222 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_246)) (spoon_2 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_246))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_246)) (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_246) (= cat_225 (ite (fp.leq cat_222 cat_248) true false)))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_246)) (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_246) (= cat_252 (ite (= cat_225 true) cat_224 false)))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_246)) (=> (not (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_246)) (= cat_252 false))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_246)) (=> (= cat_252 true) (= cat_251 true))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_246)) (=> (not (= cat_252 true)) (=> (fp.lt cat_246 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (and (= cat_219 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_246)) (spoon_2 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_246)))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_246)) (=> (not (= cat_252 true)) (=> (fp.lt cat_246 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_220 (ite (fp.leq cat_248 cat_219) true false))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_246)) (=> (not (= cat_252 true)) (=> (fp.lt cat_246 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (and (= cat_218 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_246)) (spoon_2 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_246)))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_246)) (=> (not (= cat_252 true)) (=> (fp.lt cat_246 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_221 (ite (fp.leq cat_218 cat_248) true false))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_246)) (=> (not (= cat_252 true)) (=> (fp.lt cat_246 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_251 (ite (= cat_221 true) cat_220 false))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_246)) (=> (not (= cat_252 true)) (=> (not (fp.lt cat_246 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))) (= cat_251 false)))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_246)) (=> (= cat_251 true) (and (= cat_226 (fp.div RNE cat_248 cat_246)) (spoon_2 (fp.div RNE cat_248 cat_246))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_246)) (=> (= cat_251 true) (= cat_253 spoon_259))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_246)) (=> (= cat_251 true) (= cat_254 cat_226))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_246)) (=> (not (= cat_251 true)) (=> (fp.lt cat_248 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_255 spoon_259)))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_246)) (=> (not (= cat_251 true)) (=> (fp.lt cat_248 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_256 (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_246)) (=> (not (= cat_251 true)) (=> (not (fp.lt cat_248 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))) (= cat_257 spoon_259)))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_246)) (=> (not (= cat_251 true)) (=> (not (fp.lt cat_248 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))) (= cat_258 (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_246)) (=> (not (= cat_251 true)) (=> (not (fp.lt cat_248 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))) (= cat_256 cat_258)))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_246)) (=> (not (= cat_251 true)) (= cat_254 cat_256))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_246)) (= cat_250 cat_254)))
(assert (not (spoon_2 (fp.mul RNE cat_234 cat_240))))
(check-sat)
(exit)
