...
(declare-const cat_265 potato_19)
(declare-const cat_266 potato_18)
...
(assert (= cat_265 (mk_potato_19 (mk_potato_18 cat_201 cat_202))))
(assert (= cat_266 (get_potato_20_a cat_85)))
(assert (= cat_267 (mk_potato_11 cat_206)))
(assert (= cat_268 (fp.mul RNE cat_181 cat_181)))
...
(assert (= cat_274 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_181)))
(assert (and (= cat_226 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_268)) (spoon_2 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_268))))
...
(assert (and (= cat_237 (fp.mul RNE cat_274 ((_ to_fp 11 53) RNE cat_179))) (spoon_2 (fp.mul RNE cat_274 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_238 (fp.mul RNE cat_237 cat_280)))
(assert (and (= cat_239 cat_238) (spoon_2 cat_238)))
(assert (and (= cat_233 (fp.sub RNE cat_276 cat_270)) (spoon_2 (fp.sub RNE cat_276 cat_270))))
(assert (= cat_234 (fp.sub RNE cat_233 cat_272)))
(assert (and (= cat_235 cat_234) (spoon_2 cat_234)))
(assert (= cat_236 (fp.mul RNE cat_235 cat_278)))
...
(assert (and (= cat_243 (fp.add RNE cat_276 cat_270)) (spoon_2 (fp.add RNE cat_276 cat_270))))
(assert (= cat_244 (fp.add RNE cat_243 cat_272)))
(assert (and (= cat_245 cat_244) (spoon_2 cat_244)))
(assert (= cat_283 (mk_potato_11 cat_214)))
(assert (= cat_284 cat_245))
(assert (and (= cat_246 (fp.div RNE cat_282 cat_284)) (spoon_2 (fp.div RNE cat_282 cat_284))))
(assert (= cat_285 (mk_potato_11 cat_212)))
(assert (= cat_286 cat_246))
(assert (=> (fp.lt cat_286 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))) (= cat_287 spoon_297)))
(assert (=> (fp.lt cat_286 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))) (= cat_288 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))))
(assert (=> (not (fp.lt cat_286 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_286) (= cat_289 spoon_297))))
(assert (=> (not (fp.lt cat_286 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_286) (= cat_290 (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))))
(assert (=> (not (fp.lt cat_286 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_286)) (and (= cat_247 cat_286) (spoon_2 cat_286)))))
(assert (=> (not (fp.lt cat_286 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_286)) (= cat_291 spoon_297))))
(assert (=> (not (fp.lt cat_286 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_286)) (= cat_292 cat_247))))
(assert (=> (not (fp.lt cat_286 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_286)) (= cat_290 cat_292))))
(assert (=> (not (fp.lt cat_286 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (= cat_288 cat_290)))
(assert (and (= cat_248 (fp.mul RNE cat_274 ((_ to_fp 11 53) RNE cat_177))) (spoon_2 (fp.mul RNE cat_274 ((_ to_fp 11 53) RNE cat_177)))))
(assert (= cat_293 (mk_potato_11 cat_216)))
(assert (= cat_294 cat_248))
(assert (and (= cat_253 (fp.mul RNE cat_274 ((_ to_fp 11 53) RNE cat_179))) (spoon_2 (fp.mul RNE cat_274 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_254 (fp.mul RNE cat_253 cat_278)))
(assert (and (= cat_255 cat_254) (spoon_2 cat_254)))
(assert (and (= cat_249 (fp.sub RNE cat_276 cat_270)) (spoon_2 (fp.sub RNE cat_276 cat_270))))
(assert (= cat_250 (fp.sub RNE cat_249 cat_272)))
(assert (and (= cat_251 cat_250) (spoon_2 cat_250)))
(assert (= cat_252 (fp.mul RNE cat_251 cat_280)))
...
(assert (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_296))
(assert (and (= cat_259 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_296)) (spoon_2 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_296))))
(assert (= cat_260 (ite (fp.leq cat_294 cat_259) true false)))
(assert (not (spoon_2 (fp.mul RNE (fp.neg (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000)) cat_296))))
(check-sat)
(exit)
