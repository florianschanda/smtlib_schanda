...
(assert (and (= cat_230 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_272)) (spoon_3 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_272))))
...
(assert (and (= cat_241 (fp.mul RNE cat_278 ((_ to_fp 11 53) RNE cat_183))) (spoon_3 (fp.mul RNE cat_278 ((_ to_fp 11 53) RNE cat_183)))))
(assert (= cat_242 (fp.mul RNE cat_241 cat_284)))
(assert (and (= cat_243 cat_242) (spoon_3 cat_242)))
(assert (and (= cat_237 (fp.sub RNE cat_280 cat_274)) (spoon_3 (fp.sub RNE cat_280 cat_274))))
...
(assert (and (= cat_247 (fp.add RNE cat_280 cat_274)) (spoon_3 (fp.add RNE cat_280 cat_274))))
...
(assert (and (= cat_250 (fp.div RNE cat_286 cat_288)) (spoon_3 (fp.div RNE cat_286 cat_288))))
...
(assert (=> (not (fp.lt cat_290 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_290)) (and (= cat_251 cat_290) (spoon_3 cat_290)))))
...
(assert (and (= cat_252 (fp.mul RNE cat_278 ((_ to_fp 11 53) RNE cat_181))) (spoon_3 (fp.mul RNE cat_278 ((_ to_fp 11 53) RNE cat_181)))))
(assert (= cat_297 (mk_potato_11 cat_220)))
(assert (= cat_298 cat_252))
(assert (and (= cat_257 (fp.mul RNE cat_278 ((_ to_fp 11 53) RNE cat_183))) (spoon_3 (fp.mul RNE cat_278 ((_ to_fp 11 53) RNE cat_183)))))
(assert (= cat_258 (fp.mul RNE cat_257 cat_282)))
(assert (and (= cat_259 cat_258) (spoon_3 cat_258)))
(assert (and (= cat_253 (fp.sub RNE cat_280 cat_274)) (spoon_3 (fp.sub RNE cat_280 cat_274))))
...
(assert (and (= cat_263 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_300)) (spoon_3 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_300))))
(assert (= cat_264 (ite (fp.leq cat_298 cat_263) true false)))
(assert (not (spoon_3 (fp.mul RNE (fp.neg (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000)) cat_300))))
(check-sat)
(exit)
