...
(define-fun spoon_301 () potato_11 (mk_potato_11 cat_215))
...
(assert (= cat_269 (mk_potato_19 (mk_potato_18 cat_205 cat_206))))
(assert (= cat_270 (get_potato_20_a cat_89)))
(assert (= cat_271 (mk_potato_11 cat_210)))
(assert (= cat_272 (fp.mul RNE cat_185 cat_185)))
(assert (and (= cat_228 ((_ to_fp 11 53) RNE (fp.mul RNE cat_181 cat_181))) (spoon_2 ((_ to_fp 11 53) RNE (fp.mul RNE cat_181 cat_181)))))
(assert (= cat_273 (mk_potato_11 cat_208)))
(assert (= cat_274 cat_228))
(assert (and (= cat_229 ((_ to_fp 11 53) RNE (fp.mul RNE cat_183 cat_183))) (spoon_2 ((_ to_fp 11 53) RNE (fp.mul RNE cat_183 cat_183)))))
(assert (= cat_275 (mk_potato_11 cat_209)))
(assert (= cat_276 cat_229))
(assert (= cat_277 (mk_potato_11 cat_211)))
(assert (= cat_278 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_185)))
(assert (and (= cat_230 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_272)) (spoon_2 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_272))))
(assert (= cat_279 (mk_potato_11 cat_212)))
(assert (= cat_280 cat_230))
...
(assert (= cat_284 cat_236))
(assert (and (= cat_241 (fp.mul RNE cat_278 ((_ to_fp 11 53) RNE cat_183))) (spoon_2 (fp.mul RNE cat_278 ((_ to_fp 11 53) RNE cat_183)))))
(assert (= cat_242 (fp.mul RNE cat_241 cat_284)))
(assert (and (= cat_243 cat_242) (spoon_2 cat_242)))
(assert (and (= cat_237 (fp.sub RNE cat_280 cat_274)) (spoon_2 (fp.sub RNE cat_280 cat_274))))
(assert (= cat_238 (fp.sub RNE cat_237 cat_276)))
(assert (and (= cat_239 cat_238) (spoon_2 cat_238)))
(assert (= cat_240 (fp.mul RNE cat_239 cat_282)))
...
(assert (= cat_285 (mk_potato_11 cat_217)))
(assert (= cat_286 cat_246))
(assert (and (= cat_247 (fp.add RNE cat_280 cat_274)) (spoon_2 (fp.add RNE cat_280 cat_274))))
(assert (= cat_248 (fp.add RNE cat_247 cat_276)))
(assert (and (= cat_249 cat_248) (spoon_2 cat_248)))
(assert (= cat_287 (mk_potato_11 cat_218)))
(assert (= cat_288 cat_249))
(assert (and (= cat_250 (fp.div RNE cat_286 cat_288)) (spoon_2 (fp.div RNE cat_286 cat_288))))
(assert (= cat_289 (mk_potato_11 cat_216)))
(assert (= cat_290 cat_250))
(assert (=> (fp.lt cat_290 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))) (= cat_291 spoon_301)))
...
(assert (=> (not (fp.lt cat_290 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_290) (= cat_293 spoon_301))))
...
(assert (=> (not (fp.lt cat_290 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_290)) (and (= cat_251 cat_290) (spoon_2 cat_290)))))
(assert (=> (not (fp.lt cat_290 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_290)) (= cat_295 spoon_301))))
(assert (=> (not (fp.lt cat_290 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_290)) (= cat_296 cat_251))))
...
(assert (and (= cat_252 (fp.mul RNE cat_278 ((_ to_fp 11 53) RNE cat_181))) (spoon_2 (fp.mul RNE cat_278 ((_ to_fp 11 53) RNE cat_181)))))
(assert (= cat_297 (mk_potato_11 cat_220)))
(assert (= cat_298 cat_252))
(assert (and (= cat_257 (fp.mul RNE cat_278 ((_ to_fp 11 53) RNE cat_183))) (spoon_2 (fp.mul RNE cat_278 ((_ to_fp 11 53) RNE cat_183)))))
(assert (= cat_258 (fp.mul RNE cat_257 cat_282)))
(assert (and (= cat_259 cat_258) (spoon_2 cat_258)))
(assert (and (= cat_253 (fp.sub RNE cat_280 cat_274)) (spoon_2 (fp.sub RNE cat_280 cat_274))))
(assert (= cat_254 (fp.sub RNE cat_253 cat_276)))
(assert (and (= cat_255 cat_254) (spoon_2 cat_254)))
(assert (= cat_256 (fp.mul RNE cat_255 cat_284)))
...
(assert (= cat_299 (mk_potato_11 cat_221)))
(assert (= cat_300 cat_262))
(assert (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_300))
(assert (and (= cat_263 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_300)) (spoon_2 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_300))))
(assert (= cat_264 (ite (fp.leq cat_298 cat_263) true false)))
(assert (not (spoon_2 (fp.mul RNE (fp.neg (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000)) cat_300))))
(check-sat)
(exit)
