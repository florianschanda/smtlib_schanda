...
(declare-const cat_117 potato_21)
(assert (spoon_60 cat_111))
(assert (spoon_60 cat_112))
(assert (and (fp.lt (fp #b0 #b01110101 #b00000110001001001101111) cat_111) (fp.lt (fp #b0 #b01110101 #b00000110001001001101111) cat_112)))
(assert (fp.lt cat_112 cat_111))
(assert (and (= cat_113 (fp.div RNE (spoon_75 cat_110) cat_111)) (spoon_1 (fp.div RNE (spoon_75 cat_110) cat_111))))
(assert (= cat_114 (fp.mul RNE cat_113 cat_112)))
(assert (and (= cat_115 cat_114) (spoon_1 cat_114)))
(assert (and (= cat_116 cat_115) (spoon_1 cat_115)))
(assert (= (spoon_75 cat_117) cat_116))
(assert (not (not (fp.isZero cat_111))))
(check-sat)
(exit)
