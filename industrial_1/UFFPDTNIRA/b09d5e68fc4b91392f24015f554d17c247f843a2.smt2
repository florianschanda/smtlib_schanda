...
(assert (spoon_62 cat_113))
(assert (spoon_62 cat_114))
(assert (and (fp.lt (fp #b0 #b01110101 #b00000110001001001101111) cat_113) (fp.lt (fp #b0 #b01110101 #b00000110001001001101111) cat_114)))
(assert (fp.lt cat_114 cat_113))
(assert (and (= cat_115 (fp.div RNE (spoon_77 cat_112) cat_113)) (spoon_1 (fp.div RNE (spoon_77 cat_112) cat_113))))
(assert (= cat_116 (fp.mul RNE cat_115 cat_114)))
(assert (and (= cat_117 cat_116) (spoon_1 cat_116)))
(assert (and (= cat_118 cat_117) (spoon_1 cat_117)))
(assert (= (spoon_77 cat_119) cat_118))
