...
(assert (let ((_let_0 (fp.sub roundNearestTiesToEven (spoon_37 (get_potato_15_a (get_potato_17_a cat_64))) (spoon_37 (get_potato_15_a (get_potato_17_a cat_66)))))) (= cat_74 (fp.mul roundNearestTiesToEven _let_0 _let_0))))
(assert (= cat_74 cat_68))
(assert (let ((_let_0 (fp.sub roundNearestTiesToEven (spoon_37 (get_potato_15_a (get_potato_17_a cat_64))) (spoon_37 (get_potato_15_a (get_potato_17_a cat_66)))))) (spoon_1 (fp.mul roundNearestTiesToEven _let_0 _let_0))))
(assert (spoon_1 cat_68))
(assert (let ((_let_0 (fp.sub roundNearestTiesToEven (spoon_37 (get_potato_15_b (get_potato_17_a cat_64))) (spoon_37 (get_potato_15_b (get_potato_17_a cat_66)))))) (= cat_75 (fp.mul roundNearestTiesToEven _let_0 _let_0))))
(assert (= cat_75 cat_70))
(assert (let ((_let_0 (fp.sub roundNearestTiesToEven (spoon_37 (get_potato_15_b (get_potato_17_a cat_64))) (spoon_37 (get_potato_15_b (get_potato_17_a cat_66)))))) (spoon_1 (fp.mul roundNearestTiesToEven _let_0 _let_0))))
(assert (spoon_1 cat_70))
(assert (= cat_76 (fp.add roundNearestTiesToEven cat_68 cat_70)))
(assert (spoon_1 (fp.add roundNearestTiesToEven cat_68 cat_70)))
(assert (= cat_77 (fp.sqrt roundNearestTiesToEven cat_76)))
