...
(assert (= cat_75 (fp.mul RNE (fp.sub RNE (spoon_37 (get_potato_15_b (get_potato_17_a cat_64))) (spoon_37 (get_potato_15_b (get_potato_17_a cat_66)))) (fp.sub RNE (spoon_37 (get_potato_15_b (get_potato_17_a cat_64))) (spoon_37 (get_potato_15_b (get_potato_17_a cat_66)))))))
(assert (= cat_75 cat_70))
(assert (spoon_1 (fp.mul RNE (fp.sub RNE (spoon_37 (get_potato_15_b (get_potato_17_a cat_64))) (spoon_37 (get_potato_15_b (get_potato_17_a cat_66)))) (fp.sub RNE (spoon_37 (get_potato_15_b (get_potato_17_a cat_64))) (spoon_37 (get_potato_15_b (get_potato_17_a cat_66)))))))
(assert (spoon_1 cat_70))
(assert (= cat_76 (fp.add RNE cat_68 cat_70)))
(assert (spoon_1 (fp.add RNE cat_68 cat_70)))
(assert (= cat_77 (fp.sqrt RNE cat_76)))
(assert (not (spoon_57 cat_77)))
(check-sat)
(exit)
