...
(declare-const cat_271 potato_19)
(declare-const cat_272 potato_18)
...
(define-fun spoon_304 () potato_11 (mk_potato_11 cat_215))
...
(assert (= cat_269 (mk_potato_7 cat_207)))
(assert (= cat_270 (spoon_41 1)))
(assert (= cat_271 (mk_potato_19 (mk_potato_18 cat_205 cat_206))))
(assert (= cat_272 (get_potato_20_a cat_89)))
(assert (= cat_273 (mk_potato_11 cat_210)))
(assert (= cat_274 (fp.mul RNE cat_185 cat_185)))
...
(assert (= cat_279 (mk_potato_11 cat_211)))
(assert (= cat_280 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_185)))
(assert (and (= cat_230 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_274)) (spoon_2 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_274))))
(assert (= cat_281 (mk_potato_11 cat_212)))
(assert (= cat_282 cat_230))
...
(assert (= cat_286 cat_236))
(assert (and (= cat_241 (fp.mul RNE cat_280 ((_ to_fp 11 53) RNE cat_183))) (spoon_2 (fp.mul RNE cat_280 ((_ to_fp 11 53) RNE cat_183)))))
(assert (= cat_242 (fp.mul RNE cat_241 cat_286)))
(assert (and (= cat_243 cat_242) (spoon_2 cat_242)))
(assert (and (= cat_237 (fp.sub RNE cat_282 cat_276)) (spoon_2 (fp.sub RNE cat_282 cat_276))))
(assert (= cat_238 (fp.sub RNE cat_237 cat_278)))
(assert (and (= cat_239 cat_238) (spoon_2 cat_238)))
(assert (= cat_240 (fp.mul RNE cat_239 cat_284)))
...
(assert (= cat_287 (mk_potato_11 cat_217)))
(assert (= cat_288 cat_246))
(assert (and (= cat_247 (fp.add RNE cat_282 cat_276)) (spoon_2 (fp.add RNE cat_282 cat_276))))
(assert (= cat_248 (fp.add RNE cat_247 cat_278)))
(assert (and (= cat_249 cat_248) (spoon_2 cat_248)))
(assert (= cat_289 (mk_potato_11 cat_218)))
(assert (= cat_290 cat_249))
(assert (and (= cat_250 (fp.div RNE cat_288 cat_290)) (spoon_2 (fp.div RNE cat_288 cat_290))))
(assert (= cat_291 (mk_potato_11 cat_216)))
(assert (= cat_292 cat_250))
(assert (=> (fp.lt cat_292 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))) (= cat_293 spoon_304)))
...
(assert (=> (not (fp.lt cat_292 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_292) (= cat_295 spoon_304))))
...
(assert (=> (not (fp.lt cat_292 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_292)) (and (= cat_251 cat_292) (spoon_2 cat_292)))))
(assert (=> (not (fp.lt cat_292 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_292)) (= cat_297 spoon_304))))
(assert (=> (not (fp.lt cat_292 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_292)) (= cat_298 cat_251))))
...
(assert (and (= cat_252 (fp.mul RNE cat_280 ((_ to_fp 11 53) RNE cat_181))) (spoon_2 (fp.mul RNE cat_280 ((_ to_fp 11 53) RNE cat_181)))))
(assert (= cat_299 (mk_potato_11 cat_220)))
(assert (= cat_300 cat_252))
(assert (and (= cat_257 (fp.mul RNE cat_280 ((_ to_fp 11 53) RNE cat_183))) (spoon_2 (fp.mul RNE cat_280 ((_ to_fp 11 53) RNE cat_183)))))
(assert (= cat_258 (fp.mul RNE cat_257 cat_284)))
(assert (and (= cat_259 cat_258) (spoon_2 cat_258)))
(assert (and (= cat_253 (fp.sub RNE cat_282 cat_276)) (spoon_2 (fp.sub RNE cat_282 cat_276))))
(assert (= cat_254 (fp.sub RNE cat_253 cat_278)))
(assert (and (= cat_255 cat_254) (spoon_2 cat_254)))
(assert (= cat_256 (fp.mul RNE cat_255 cat_286)))
...
(assert (= cat_301 (mk_potato_11 cat_221)))
(assert (= cat_302 cat_262))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_302) (and (= cat_264 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_302)) (spoon_2 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_302)))))
...
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_302) (= cat_303 (ite (= cat_266 true) cat_265 false))))
(assert (=> (not (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_302)) (= cat_303 false)))
(assert (not (= cat_303 true)))
(assert (fp.lt cat_302 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)))
(assert (not (spoon_2 (fp.mul RNE (fp.neg (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000)) cat_302))))
(check-sat)
(exit)
