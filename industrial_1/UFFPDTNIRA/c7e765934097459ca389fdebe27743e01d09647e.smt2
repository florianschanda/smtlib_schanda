...
(assert (= cat_266 (spoon_37 1)))
(assert (= cat_267 (mk_potato_19 (mk_potato_18 cat_201 cat_202))))
(assert (= cat_268 (get_potato_20_a cat_85)))
...
(assert (and (= cat_226 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_270)) (spoon_2 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_270))))
...
(assert (and (= cat_237 (fp.mul RNE cat_276 ((_ to_fp 11 53) RNE cat_179))) (spoon_2 (fp.mul RNE cat_276 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_238 (fp.mul RNE cat_237 cat_282)))
(assert (and (= cat_239 cat_238) (spoon_2 cat_238)))
(assert (and (= cat_233 (fp.sub RNE cat_278 cat_272)) (spoon_2 (fp.sub RNE cat_278 cat_272))))
...
(assert (and (= cat_243 (fp.add RNE cat_278 cat_272)) (spoon_2 (fp.add RNE cat_278 cat_272))))
...
(assert (and (= cat_246 (fp.div RNE cat_284 cat_286)) (spoon_2 (fp.div RNE cat_284 cat_286))))
...
(assert (=> (not (fp.lt cat_288 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_288)) (and (= cat_247 cat_288) (spoon_2 cat_288)))))
...
(assert (and (= cat_248 (fp.mul RNE cat_276 ((_ to_fp 11 53) RNE cat_177))) (spoon_2 (fp.mul RNE cat_276 ((_ to_fp 11 53) RNE cat_177)))))
(assert (= cat_295 (mk_potato_11 cat_216)))
(assert (= cat_296 cat_248))
(assert (and (= cat_253 (fp.mul RNE cat_276 ((_ to_fp 11 53) RNE cat_179))) (spoon_2 (fp.mul RNE cat_276 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_254 (fp.mul RNE cat_253 cat_280)))
(assert (and (= cat_255 cat_254) (spoon_2 cat_254)))
(assert (and (= cat_249 (fp.sub RNE cat_278 cat_272)) (spoon_2 (fp.sub RNE cat_278 cat_272))))
...
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_298) (and (= cat_260 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_298)) (spoon_2 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_298)))))
...
(assert (not (spoon_2 (fp.mul RNE (fp.neg (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000)) cat_298))))
(check-sat)
(exit)
