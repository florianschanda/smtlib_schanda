...
(assert (= cat_273 (mk_potato_7 cat_203)))
(assert (= cat_274 (spoon_37 1)))
(assert (= cat_275 (mk_potato_25 (mk_potato_24 cat_201 cat_202))))
(assert (= cat_276 (get_potato_26_a cat_111)))
(assert (= cat_225 (spoon_113 cat_167 cat_74)))
(assert (= cat_277 (ite (not (= cat_225 true)) true false)))
(assert (= cat_277 true))
(assert (=> (= cat_278 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_279))) (and (= cat_226 (spoon_149 (fp #b0 #b10000101 #b01100111111101011101000))) (spoon_129 cat_226)))))
(assert (=> (= cat_278 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_279))) (= cat_280 (mk_potato_10 cat_272)))))
(assert (=> (= cat_278 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_279))) (= cat_281 cat_226))))
(assert (=> (= cat_278 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_279)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_279)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (and (= cat_227 (spoon_149 (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (spoon_129 cat_227))))))
(assert (=> (= cat_278 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_279)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_279)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_282 (mk_potato_10 cat_272))))))
(assert (=> (= cat_278 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_279)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_279)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_283 cat_227)))))
(assert (=> (= cat_278 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_279)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_279)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_228 (spoon_84 (get_potato_24_a cat_279))) (spoon_1 (spoon_84 (get_potato_24_a cat_279))))))))
(assert (=> (= cat_278 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_279)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_279)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_229 (spoon_149 cat_228)) (spoon_129 cat_229))))))
(assert (=> (= cat_278 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_279)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_279)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_284 (mk_potato_10 cat_272))))))
(assert (=> (= cat_278 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_279)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_279)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_285 cat_229)))))
(assert (=> (= cat_278 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_279)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_279)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_283 cat_285)))))
(assert (=> (= cat_278 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_279)))) (= cat_281 cat_283))))
(assert (=> (= cat_278 true) (=> (spoon_189 cat_175) (and (= cat_230 (fp.mul RNE cat_175 cat_175)) (spoon_1 (fp.mul RNE cat_175 cat_175))))))
(assert (=> (= cat_278 true) (=> (spoon_189 cat_175) (= cat_286 (mk_potato_10 cat_270)))))
(assert (=> (= cat_278 true) (=> (spoon_189 cat_175) (= cat_287 cat_230))))
(assert (=> (= cat_278 true) (=> (spoon_189 cat_175) (= cat_289 cat_278))))
(assert (=> (= cat_278 true) (=> (not (spoon_189 cat_175)) (= cat_288 (mk_potato_7 cat_278)))))
(assert (=> (= cat_278 true) (=> (not (spoon_189 cat_175)) (= cat_289 (spoon_37 0)))))
(assert (=> (= cat_278 true) (=> (not (spoon_189 cat_175)) (= cat_287 cat_270))))
(assert (=> (= cat_278 true) (= cat_290 (mk_potato_10 cat_264))))
(assert (=> (= cat_278 true) (= cat_291 ((_ to_fp 8 24) RNE (fp.sub RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) (fp.mul RNE cat_171 cat_171))))))
(assert (=> (= cat_278 true) (and (= cat_231 cat_291) (spoon_1 cat_291))))
(assert (=> (= cat_278 true) (and (= cat_232 (spoon_146 cat_231)) (spoon_138 cat_232))))
(assert (=> (= cat_278 true) (= cat_292 (mk_potato_10 cat_262))))
(assert (=> (= cat_278 true) (= cat_293 cat_232)))
(assert (=> (not (= cat_278 true)) (= cat_281 cat_272)))
(assert (=> (not (= cat_278 true)) (= cat_287 cat_270)))
(assert (=> (not (= cat_278 true)) (= cat_291 cat_264)))
(assert (=> (not (= cat_278 true)) (= cat_293 cat_262)))
(assert (=> (not (= cat_278 true)) (= cat_289 cat_278)))
(assert (=> (= cat_289 true) (and (= cat_233 (fp.sub RNE cat_291 cat_287)) (spoon_1 (fp.sub RNE cat_291 cat_287)))))
(assert (=> (= cat_289 true) (= cat_234 (fp.add RNE cat_233 (fp.mul RNE cat_281 cat_281)))))
(assert (=> (= cat_289 true) (and (= cat_235 cat_234) (spoon_1 cat_234))))
(assert (=> (= cat_289 true) (= cat_294 (mk_potato_10 cat_268))))
(assert (=> (= cat_289 true) (= cat_295 cat_235)))
(assert (=> (= cat_289 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_295) (and (= cat_236 cat_295) (spoon_1 cat_295)))))
(assert (=> (= cat_289 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_295) (and (= cat_237 (spoon_146 cat_236)) (spoon_138 cat_237)))))
(assert (=> (= cat_289 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_295) (= cat_296 (mk_potato_10 cat_266)))))
(assert (=> (= cat_289 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_295) (= cat_297 cat_237))))
(assert (=> (= cat_289 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_295) (= cat_299 cat_289))))
(assert (=> (= cat_289 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_295)) (= cat_298 (mk_potato_7 cat_289)))))
(assert (=> (= cat_289 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_295)) (= cat_299 (spoon_37 0)))))
(assert (=> (= cat_289 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_295)) (= cat_297 cat_266))))
(assert (=> (not (= cat_289 true)) (= cat_295 cat_268)))
(assert (=> (not (= cat_289 true)) (= cat_297 cat_266)))
(assert (=> (not (= cat_289 true)) (= cat_299 cat_289)))
(assert (= cat_299 true))
(assert (and (= cat_242 (fp.mul RNE cat_297 cat_175)) (spoon_1 (fp.mul RNE cat_297 cat_175))))
(assert (and (= cat_238 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_171 cat_171)) cat_287)) (spoon_1 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_171 cat_171)) cat_287))))
(assert (= cat_239 (fp.mul RNE cat_293 cat_238)))
(assert (and (= cat_240 cat_239) (spoon_1 cat_239)))
(assert (= cat_241 (fp.mul RNE cat_240 cat_281)))
...
(assert (= cat_300 (mk_potato_10 cat_211)))
(assert (= cat_301 cat_245))
(assert (and (= cat_246 (fp.mul RNE cat_297 cat_175)) (spoon_1 (fp.mul RNE cat_297 cat_175))))
(assert (= cat_247 (fp.mul RNE cat_246 cat_281)))
(assert (and (= cat_248 cat_247) (spoon_1 cat_247)))
(assert (and (= cat_249 (fp.mul RNE cat_293 cat_295)) (spoon_1 (fp.mul RNE cat_293 cat_295))))
(assert (= cat_250 (fp.sub RNE cat_249 cat_248)))
(assert (and (= cat_251 cat_250) (spoon_1 cat_250)))
(assert (= cat_302 (mk_potato_10 cat_212)))
(assert (= cat_303 cat_251))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_303) (and (= cat_257 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_303)) (spoon_1 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_303)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_303) (and (= cat_258 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_301)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_301)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_303) (= cat_259 (ite (fp.leq cat_258 cat_257) true false))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_303) (and (= cat_255 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_301)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_301)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_303) (and (= cat_256 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_303)) (spoon_1 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_303)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_303) (= cat_260 (ite (fp.leq cat_256 cat_255) true false))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_303) (= cat_304 (ite (= cat_260 true) cat_259 false))))
(assert (=> (not (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_303)) (= cat_304 false)))
(assert (not (= cat_304 true)))
(assert (fp.lt cat_303 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (and (= cat_252 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_303)) (spoon_1 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_303))))
(assert (and (= cat_253 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_301)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_301))))
(assert (= cat_254 (ite (fp.leq cat_253 cat_252) true false)))
(assert (not (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_301))))
(check-sat)
(exit)
