...
(assert (and (= cat_258 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_317)) (spoon_1 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_317))))
(assert (and (= cat_259 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_315)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_315))))
(assert (= cat_260 (ite (fp.leq cat_259 cat_258) true false)))
(assert (not (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_315))))
(check-sat)
(exit)
