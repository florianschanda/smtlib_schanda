...
(declare-const cat_237 potato_19)
(declare-const cat_238 potato_18)
...
(assert (= cat_236 (spoon_37 1)))
(assert (= cat_237 (mk_potato_19 (mk_potato_18 cat_201 cat_202))))
(assert (= cat_238 (get_potato_20_a cat_85)))
...
(assert (and (= cat_226 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_240)) (spoon_2 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_240))))
...
(assert (not (spoon_2 (fp.mul RNE cat_246 ((_ to_fp 11 53) RNE cat_179)))))
(check-sat)
(exit)
