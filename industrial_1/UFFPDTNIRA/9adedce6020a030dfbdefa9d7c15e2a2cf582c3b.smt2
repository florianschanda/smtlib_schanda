...
(assert (= cat_145 (fp.sub RNE (spoon_48 (get_potato_17_a (get_potato_19_a cat_90))) (spoon_48 (get_potato_17_a (get_potato_19_a cat_88))))))
(assert (= cat_146 (fp.sub RNE (spoon_48 (get_potato_17_b (get_potato_19_a cat_90))) (spoon_48 (get_potato_17_b (get_potato_19_a cat_88))))))
(assert (= cat_147 (fp.add RNE (fp.mul RNE cat_145 cat_145) (fp.mul RNE cat_146 cat_146))))
(assert (not (fp.lt cat_147 (fp #b0 #b01110001 #b10100011011011100010111))))
(assert (= cat_148 (fp.add RNE (fp.mul RNE (fp.sub RNE (spoon_48 (get_potato_17_a (get_potato_19_a cat_86))) (spoon_48 (get_potato_17_a (get_potato_19_a cat_88)))) cat_145) (fp.mul RNE (fp.sub RNE (spoon_48 (get_potato_17_b (get_potato_19_a cat_86))) (spoon_48 (get_potato_17_b (get_potato_19_a cat_88)))) cat_146))))
(assert (= cat_143 (fp.div RNE cat_148 cat_147)))
(assert (spoon_1 (fp.div RNE cat_148 cat_147)))
(assert (= cat_144 cat_143))
(assert (= cat_149 cat_144))
(assert (spoon_1 cat_143))
(assert (not (fp.leq cat_149 (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (not (fp.leq (fp #b0 #b01111111 #b00000000000000000000000) cat_149)))
