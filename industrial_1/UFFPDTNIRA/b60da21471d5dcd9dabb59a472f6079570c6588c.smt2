...
(assert (let ((_let_0 (get_potato_17_a cat_62))) (let ((_let_1 (get_potato_17_a cat_60))) (not (spoon_1 (fp.div roundNearestTiesToEven (fp.sub roundNearestTiesToEven (spoon_40 (get_potato_15_b _let_0)) (spoon_40 (get_potato_15_b _let_1))) (fp.sub roundNearestTiesToEven (spoon_40 (get_potato_15_a _let_0)) (spoon_40 (get_potato_15_a _let_1)))))))))
(check-sat)
(exit)
