...
(assert (= cat_106 cat_99))
(assert (= cat_107 cat_101))
(assert (and (= cat_102 (spoon_64 cat_68 cat_70)) (spoon_48 cat_102)))
(assert (= cat_108 cat_100))
(assert (= cat_109 cat_102))
(assert (= cat_110 cat_98))
(assert (= cat_111 (fp.sub RNE cat_109 cat_107)))
(assert (=> (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_111) (and (= cat_103 (fp.sub RNE cat_111 (fp #b0 #b10000111 #b01101000000000000000000))) (spoon_1 (fp.sub RNE cat_111 (fp #b0 #b10000111 #b01101000000000000000000))))))
(assert (=> (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_111) (= cat_112 cat_95)))
(assert (=> (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_111) (= cat_113 cat_103)))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_111)) (=> (fp.leq cat_111 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000))) (and (= cat_104 (fp.add RNE cat_111 (fp #b0 #b10000111 #b01101000000000000000000))) (spoon_1 (fp.add RNE cat_111 (fp #b0 #b10000111 #b01101000000000000000000)))))))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_111)) (=> (fp.leq cat_111 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000))) (= cat_114 cat_95))))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_111)) (=> (fp.leq cat_111 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000))) (= cat_115 cat_104))))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_111)) (=> (not (fp.leq cat_111 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)))) (and (= cat_105 cat_111) (spoon_1 cat_111)))))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_111)) (=> (not (fp.leq cat_111 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)))) (= cat_116 cat_95))))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_111)) (=> (not (fp.leq cat_111 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)))) (= cat_117 cat_105))))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_111)) (=> (not (fp.leq cat_111 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)))) (= cat_115 cat_117))))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_111)) (= cat_113 cat_115)))
(assert (= cat_118 cat_97))
(assert (= cat_119 (fp.div RNE (fp.sub RNE (fp #b0 #b10000110 #b01101000000000000000000) cat_113) (fp #b0 #b10000000 #b00000000000000000000000))))
(assert (not (spoon_74 (fp.add RNE cat_109 cat_119))))
(check-sat)
(exit)
