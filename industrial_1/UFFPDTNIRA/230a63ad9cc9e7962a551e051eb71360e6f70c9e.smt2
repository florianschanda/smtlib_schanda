...
(assert (= cat_111 cat_104))
(assert (= cat_112 cat_100))
(assert (= cat_113 (fp.sub RNE cat_111 cat_109)))
(assert (=> (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_113) (and (= cat_105 (fp.sub RNE cat_113 (fp #b0 #b10000111 #b01101000000000000000000))) (spoon_1 (fp.sub RNE cat_113 (fp #b0 #b10000111 #b01101000000000000000000))))))
(assert (=> (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_113) (= cat_114 cat_97)))
(assert (=> (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_113) (= cat_115 cat_105)))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_113)) (=> (fp.leq cat_113 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000))) (and (= cat_106 (fp.add RNE cat_113 (fp #b0 #b10000111 #b01101000000000000000000))) (spoon_1 (fp.add RNE cat_113 (fp #b0 #b10000111 #b01101000000000000000000)))))))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_113)) (=> (fp.leq cat_113 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000))) (= cat_116 cat_97))))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_113)) (=> (fp.leq cat_113 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000))) (= cat_117 cat_106))))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_113)) (=> (not (fp.leq cat_113 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)))) (and (= cat_107 cat_113) (spoon_1 cat_113)))))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_113)) (=> (not (fp.leq cat_113 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)))) (= cat_118 cat_97))))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_113)) (=> (not (fp.leq cat_113 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)))) (= cat_119 cat_107))))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_113)) (=> (not (fp.leq cat_113 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)))) (= cat_117 cat_119))))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_113)) (= cat_115 cat_117)))
(assert (= cat_120 cat_99))
(assert (= cat_121 (fp.div RNE (fp.sub RNE (fp #b0 #b10000110 #b01101000000000000000000) cat_115) (fp #b0 #b10000000 #b00000000000000000000000))))
(assert (not (spoon_76 (fp.add RNE cat_111 cat_121))))
(check-sat)
(exit)
