...
(declare-const cat_228 potato_11)
(declare-const cat_229 Float64)
(declare-const cat_230 potato_11)
...
(assert (and (= cat_209 (fp.mul RNE cat_227 cat_231)) (spoon_3 (fp.mul RNE cat_227 cat_231))))
(assert (= cat_210 (fp.mul RNE cat_209 cat_235)))
(assert (and (= cat_211 cat_210) (spoon_3 cat_210)))
(assert (and (= cat_207 (fp.mul RNE cat_225 cat_229)) (spoon_3 (fp.mul RNE cat_225 cat_229))))
...
(assert (and (= cat_215 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_156) cat_233)) (spoon_3 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_156) cat_233))))
(assert (= cat_216 (fp.mul RNE cat_215 cat_227)))
(assert (and (= cat_217 cat_216) (spoon_3 cat_216)))
(assert (= cat_238 (mk_potato_11 cat_189)))
(assert (= cat_239 cat_217))
(assert (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_237)))
(assert (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_237))
(assert (not (spoon_3 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_237))))
(check-sat)
(exit)
