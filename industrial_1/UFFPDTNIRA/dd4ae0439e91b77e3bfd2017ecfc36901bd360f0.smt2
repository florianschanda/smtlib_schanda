...
(assert (not (fp.eq cat_72 (fp.sub RNE (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) (spoon_34 (get_potato_13_b (get_potato_15_a cat_58)))) (spoon_34 (get_potato_13_b (get_potato_15_a cat_56)))))))
(check-sat)
(exit)
