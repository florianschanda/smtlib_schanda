...
(assert (not (fp.eq cat_72 (fp.sub roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv128 8) (_ bv0 23)) (spoon_34 (get_potato_13_b (get_potato_15_a cat_58)))) (spoon_34 (get_potato_13_b (get_potato_15_a cat_56)))))))
(check-sat)
(exit)
