...
(assert (not (not (fp.eq (fp.abs (fp.rem cat_51 (fp #b0 #b10000111 #b01101000000000000000000))) (fp.mul RNE (fp #b0 #b01111101 #b00000000000000000000000) (fp #b0 #b10000111 #b01101000000000000000000))))))
(check-sat)
(exit)
