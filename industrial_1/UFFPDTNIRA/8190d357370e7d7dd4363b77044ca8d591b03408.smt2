...
(assert (and (= cat_119 (fp.div RNE (spoon_77 cat_113) cat_114)) (spoon_1 (fp.div RNE (spoon_77 cat_113) cat_114))))
...
(assert (= (spoon_77 cat_123) cat_122))
(assert (and (= cat_116 (fp.div RNE (spoon_77 cat_112) cat_114)) (spoon_1 (fp.div RNE (spoon_77 cat_112) cat_114))))
(assert (= cat_117 (fp.mul RNE cat_116 cat_115)))
(assert (and (= cat_118 cat_117) (spoon_1 cat_117)))
(assert (not (spoon_70 cat_118)))
(check-sat)
(exit)
