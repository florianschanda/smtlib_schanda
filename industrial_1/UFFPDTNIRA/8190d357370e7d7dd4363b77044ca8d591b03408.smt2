...
(assert (and (= cat_117 (fp.div RNE (spoon_75 cat_111) cat_112)) (spoon_1 (fp.div RNE (spoon_75 cat_111) cat_112))))
(assert (= cat_118 (fp.mul RNE cat_117 cat_113)))
(assert (and (= cat_119 cat_118) (spoon_1 cat_118)))
(assert (and (= cat_120 cat_119) (spoon_1 cat_119)))
(assert (= (spoon_75 cat_121) cat_120))
(assert (and (= cat_114 (fp.div RNE (spoon_75 cat_110) cat_112)) (spoon_1 (fp.div RNE (spoon_75 cat_110) cat_112))))
(assert (= cat_115 (fp.mul RNE cat_114 cat_113)))
(assert (and (= cat_116 cat_115) (spoon_1 cat_115)))
(assert (not (spoon_68 cat_116)))
(check-sat)
(exit)
