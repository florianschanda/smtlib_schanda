...
(assert (= cat_143 (fp.sub RNE (spoon_48 (get_potato_17_a (get_potato_19_a cat_90))) (spoon_48 (get_potato_17_a (get_potato_19_a cat_88))))))
(assert (= cat_144 (fp.sub RNE (spoon_48 (get_potato_17_b (get_potato_19_a cat_90))) (spoon_48 (get_potato_17_b (get_potato_19_a cat_88))))))
(assert (= cat_145 (fp.add RNE (fp.mul RNE cat_143 cat_143) (fp.mul RNE cat_144 cat_144))))
(assert (not (fp.lt cat_145 (fp #b0 #b01110001 #b10100011011011100010111))))
(assert (not (not (fp.isZero cat_145))))
(check-sat)
(exit)
