...
(define-fun spoon_56 ((kitten_38 Float32)) Bool (and (spoon_1 kitten_38) (and (fp.leq (fp.neg (fp #b0 #b10001100 #b00000000000000000000000)) kitten_38) (fp.leq kitten_38 (fp #b0 #b10001100 #b00000000000000000000000)))))
...
(assert (forall ((kitten_42 Float32)) (! (=> (spoon_56 kitten_42) (= (spoon_63 (spoon_64 kitten_42)) kitten_42)) :pattern ((spoon_63 (spoon_64 kitten_42))))))
...
(define-fun spoon_69 ((kitten_47 potato_23) (kitten_48 potato_23)) Bool (ite (and (= (spoon_63 (get_potato_21_a (get_potato_23_a kitten_47))) (spoon_63 (get_potato_21_a (get_potato_23_a kitten_48)))) (= (spoon_63 (get_potato_21_b (get_potato_23_a kitten_47))) (spoon_63 (get_potato_21_b (get_potato_23_a kitten_48))))) true false))
...
(declare-fun spoon_83 (potato_23 potato_23) Float32)
(declare-fun spoon_84 (Float32 potato_23 potato_23) Bool)
(declare-sort potato_25 0)
(define-fun spoon_85 ((kitten_52 Float32)) Bool (and (spoon_1 kitten_52) (and (fp.leq (fp.neg (fp #b0 #b10011010 #b00000000000000000000000)) kitten_52) (fp.leq kitten_52 (fp #b0 #b10011010 #b00000000000000000000000)))))
...
(define-fun spoon_92 ((kitten_54 Float32) (kitten_55 Bool) (kitten_56 Bool) (kitten_57 Bool) (kitten_58 Bool)) Bool (=> (or (= kitten_55 true) (fp.leq (fp.neg (fp #b0 #b10011010 #b00000000000000000000000)) (fp #b0 #b10011010 #b00000000000000000000000))) (spoon_85 kitten_54)))
...
(assert (forall ((kitten_61 potato_23) (kitten_62 potato_23)) (! (= (spoon_83 kitten_61 kitten_62) (fp.add RNE (fp.mul RNE (spoon_63 (get_potato_21_a (get_potato_23_a kitten_61))) (spoon_63 (get_potato_21_a (get_potato_23_a kitten_62)))) (fp.mul RNE (spoon_63 (get_potato_21_b (get_potato_23_a kitten_61))) (spoon_63 (get_potato_21_b (get_potato_23_a kitten_62)))))) :pattern ((spoon_83 kitten_61 kitten_62)))))
(declare-sort potato_27 0)
(define-fun spoon_93 ((kitten_63 Float32)) Bool (and (spoon_1 kitten_63) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_63) (fp.leq kitten_63 (fp #b0 #b10001100 #b01101010100000000000000)))))
...
(declare-const cat_98 potato_27)
...
(define-fun spoon_100 ((kitten_65 Float32) (kitten_66 Bool) (kitten_67 Bool) (kitten_68 Bool) (kitten_69 Bool)) Bool (=> (or (= kitten_66 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000))) (spoon_93 kitten_65)))
(declare-sort potato_29 0)
(define-fun spoon_101 ((kitten_70 Float32)) Bool (and (spoon_1 kitten_70) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_70) (fp.leq kitten_70 (fp #b0 #b10111111 #b00000000000000000110000)))))
(declare-fun spoon_102 (potato_29 potato_29) Bool)
(declare-fun spoon_103 (Float32) potato_5)
(declare-fun spoon_104 (potato_5) Bool)
(declare-fun spoon_105 (potato_5) Float32)
(declare-const cat_106 potato_29)
...
(define-fun spoon_108 ((kitten_72 Float32) (kitten_73 Bool) (kitten_74 Bool) (kitten_75 Bool) (kitten_76 Bool)) Bool (=> (or (= kitten_73 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10111111 #b00000000000000000110000))) (spoon_101 kitten_72)))
(declare-const cat_109 potato_17)
(declare-const cat_110 Int)
(declare-const cat_111 potato_17)
(declare-const cat_112 Int)
(declare-const cat_113 potato_17)
(declare-const cat_114 Int)
(declare-sort potato_31 0)
(define-fun spoon_115 ((kitten_77 Float32)) Bool (and (spoon_1 kitten_77) (and (fp.leq (fp.neg (fp #b0 #b10110110 #b00000000000000000000000)) kitten_77) (fp.leq kitten_77 (fp #b0 #b10110110 #b00000000000000000000000)))))
...
(declare-const cat_120 potato_31)
...
(define-fun spoon_122 ((kitten_79 Float32) (kitten_80 Bool) (kitten_81 Bool) (kitten_82 Bool) (kitten_83 Bool)) Bool (=> (or (= kitten_80 true) (fp.leq (fp.neg (fp #b0 #b10110110 #b00000000000000000000000)) (fp #b0 #b10110110 #b00000000000000000000000))) (spoon_115 kitten_79)))
...
(define-fun spoon_132 ((kitten_84 Float32) (kitten_85 Bool) (kitten_86 Bool) (kitten_87 Bool) (kitten_88 Bool)) Bool (=> (or (= kitten_85 true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111))) (spoon_1 kitten_84)))
(define-fun spoon_133 ((kitten_89 Float32) (kitten_90 Bool) (kitten_91 Bool) (kitten_92 Bool) (kitten_93 Bool)) Bool (=> (or (= kitten_90 true) (fp.leq (fp.neg (fp #b0 #b10001100 #b00000000000000000000000)) (fp #b0 #b10001100 #b00000000000000000000000))) (spoon_56 kitten_89)))
(define-fun spoon_134 ((kitten_94 Float32) (kitten_95 Bool) (kitten_96 Bool) (kitten_97 Bool) (kitten_98 Bool)) Bool (=> (or (= kitten_95 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_29 kitten_94)))
(declare-const cat_135 potato_19)
(declare-const cat_136 potato_19)
(declare-const cat_137 potato_19)
(declare-const cat_138 potato_19)
(declare-const cat_139 potato_19)
(declare-const cat_140 potato_19)
(declare-const cat_141 potato_19)
(declare-const cat_142 potato_19)
...
(declare-const cat_148 potato_19)
(declare-const cat_149 potato_19)
(declare-const cat_150 potato_19)
(declare-const cat_151 potato_19)
(declare-const cat_152 potato_19)
(declare-const cat_153 potato_19)
(declare-const cat_154 potato_19)
(declare-const cat_155 potato_19)
(declare-const cat_156 potato_19)
(declare-const cat_157 potato_19)
(declare-const cat_158 potato_19)
(declare-const cat_159 potato_19)
(declare-const cat_160 potato_19)
(declare-const cat_161 potato_19)
(declare-const cat_162 potato_19)
(declare-const cat_163 potato_19)
(declare-const cat_164 potato_19)
(declare-const cat_165 potato_19)
(declare-const cat_166 potato_19)
(declare-const cat_167 potato_21)
(declare-const cat_168 potato_23)
...
(declare-const cat_175 potato_22)
(declare-const cat_176 potato_21)
(declare-const cat_177 potato_22)
(declare-const cat_178 potato_21)
(declare-const cat_179 potato_22)
(declare-const cat_180 potato_21)
(declare-const cat_181 potato_22)
(declare-const cat_182 potato_21)
(declare-const cat_183 potato_10)
(declare-const cat_184 Float32)
(declare-const cat_185 potato_10)
(declare-const cat_186 Float32)
(declare-const cat_187 potato_10)
(declare-const cat_188 Float32)
(assert (fp.leq (fp #b0 #b01101111 #b10100011011011100010111) (fp.add RNE (fp.mul RNE (fp.sub RNE (spoon_36 (get_potato_15_a (get_potato_17_a cat_113))) (spoon_36 (get_potato_15_a (get_potato_17_a cat_111)))) (fp.sub RNE (spoon_36 (get_potato_15_a (get_potato_17_a cat_113))) (spoon_36 (get_potato_15_a (get_potato_17_a cat_111))))) (fp.mul RNE (fp.sub RNE (spoon_36 (get_potato_15_b (get_potato_17_a cat_113))) (spoon_36 (get_potato_15_b (get_potato_17_a cat_111)))) (fp.sub RNE (spoon_36 (get_potato_15_b (get_potato_17_a cat_113))) (spoon_36 (get_potato_15_b (get_potato_17_a cat_111))))))))
(assert (=> (fp.leq (fp.neg (fp #b0 #b10110110 #b00000000000000000000000)) (fp #b0 #b10110110 #b00000000000000000000000)) (spoon_115 cat_143)))
(assert (=> (fp.leq (fp.neg (fp #b0 #b10110110 #b00000000000000000000000)) (fp #b0 #b10110110 #b00000000000000000000000)) (spoon_115 cat_144)))
(assert (=> (fp.leq (fp.neg (fp #b0 #b10110110 #b00000000000000000000000)) (fp #b0 #b10110110 #b00000000000000000000000)) (spoon_115 cat_145)))
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10111111 #b00000000000000000110000)) (spoon_101 cat_146)))
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000)) (spoon_93 cat_147)))
(assert (= (spoon_63 cat_148) (fp.sub RNE (spoon_36 (get_potato_15_b (get_potato_17_a cat_113))) (spoon_36 (get_potato_15_b (get_potato_17_a cat_111))))))
(assert (= (spoon_63 cat_149) (fp.sub RNE (spoon_36 (get_potato_15_a (get_potato_17_a cat_113))) (spoon_36 (get_potato_15_a (get_potato_17_a cat_111))))))
(assert (= cat_149 cat_150))
(assert (= cat_148 cat_151))
(assert (= cat_152 cat_150))
(assert (= cat_153 cat_151))
(assert (= cat_175 (mk_potato_22 (mk_potato_21 cat_141 cat_142))))
(assert (= cat_176 (mk_potato_21 cat_152 cat_153)))
(assert (= (spoon_63 cat_154) (fp.neg (fp.mul RNE (fp #b0 #b01111111 #b00000000000000000000000) (spoon_63 (get_potato_21_b cat_176))))))
(assert (= cat_154 cat_155))
(assert (= (get_potato_21_a cat_176) cat_156))
(assert (= cat_157 cat_155))
(assert (= cat_158 cat_156))
(assert (= cat_177 (mk_potato_22 (mk_potato_21 cat_139 cat_140))))
(assert (= cat_178 (mk_potato_21 cat_157 cat_158)))
...
(assert (= cat_179 (mk_potato_22 (mk_potato_21 cat_135 cat_136))))
(assert (= cat_180 (mk_potato_21 cat_163 cat_164)))
...
(assert (= cat_181 (mk_potato_22 (mk_potato_21 cat_137 cat_138))))
(assert (= cat_182 (get_potato_23_a cat_168)))
(assert (and (= cat_169 (spoon_83 (mk_potato_23 cat_176) (mk_potato_23 cat_176))) (and (spoon_85 cat_169) (= cat_169 (fp.add RNE (fp.mul RNE (spoon_63 (get_potato_21_a cat_176)) (spoon_63 (get_potato_21_a cat_176))) (fp.mul RNE (spoon_63 (get_potato_21_b cat_176)) (spoon_63 (get_potato_21_b cat_176))))))))
(assert (= cat_183 (mk_potato_10 cat_143)))
(assert (= cat_184 cat_169))
(assert (and (= cat_170 (spoon_83 (mk_potato_23 cat_180) (mk_potato_23 cat_178))) (and (spoon_85 cat_170) (= cat_170 (fp.add RNE (fp.mul RNE (spoon_63 (get_potato_21_a cat_180)) (spoon_63 (get_potato_21_a cat_178))) (fp.mul RNE (spoon_63 (get_potato_21_b cat_180)) (spoon_63 (get_potato_21_b cat_178))))))))
(assert (and (= cat_171 (spoon_83 (mk_potato_23 cat_182) (mk_potato_23 cat_178))) (and (spoon_85 cat_171) (= cat_171 (fp.add RNE (fp.mul RNE (spoon_63 (get_potato_21_a cat_182)) (spoon_63 (get_potato_21_a cat_178))) (fp.mul RNE (spoon_63 (get_potato_21_b cat_182)) (spoon_63 (get_potato_21_b cat_178))))))))
(assert (= cat_172 (fp.sub RNE cat_171 cat_170)))
(assert (= cat_185 (mk_potato_10 cat_145)))
(assert (= cat_186 cat_172))
(assert (and (= cat_173 (fp.sqrt RNE cat_184)) (spoon_1 (fp.sqrt RNE cat_184))))
(assert (= cat_187 (mk_potato_10 cat_146)))
(assert (= cat_188 cat_173))
(assert (not (fp.leq (fp.mul RNE (fp #b0 #b10110110 #b00000000000000000000000) cat_188) (fp.abs cat_186))))
(assert (and (= cat_174 (fp.div RNE (fp.abs cat_186) cat_188)) (spoon_1 (fp.div RNE (fp.abs cat_186) cat_188))))
(assert (not (spoon_115 cat_174)))
(check-sat)
(exit)
