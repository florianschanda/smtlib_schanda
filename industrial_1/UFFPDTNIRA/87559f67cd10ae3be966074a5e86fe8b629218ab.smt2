...
(declare-fun cat_173 () (_ FloatingPoint 8 24))
...
(declare-fun cat_181 () potato_22)
(declare-fun cat_182 () potato_21)
(declare-fun cat_183 () potato_10)
(declare-fun cat_184 () (_ FloatingPoint 8 24))
(declare-fun cat_185 () potato_10)
(declare-fun cat_186 () (_ FloatingPoint 8 24))
(declare-fun cat_187 () potato_10)
...
(assert (= (spoon_63 cat_154) (fp.neg (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv127 8) (_ bv0 23)) (spoon_63 (get_potato_21_b cat_176))))))
...
(assert (let ((_let_0 (spoon_63 (get_potato_21_b cat_176)))) (let ((_let_1 (mk_potato_23 cat_176))) (let ((_let_2 (spoon_63 (get_potato_21_a cat_176)))) (and (= cat_169 (spoon_83 _let_1 _let_1)) (and (spoon_85 cat_169) (= cat_169 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven _let_2 _let_2) (fp.mul roundNearestTiesToEven _let_0 _let_0)))))))))
(assert (= cat_183 (mk_potato_10 cat_143)))
(assert (= cat_184 cat_169))
(assert (and (= cat_170 (spoon_83 (mk_potato_23 cat_180) (mk_potato_23 cat_178))) (and (spoon_85 cat_170) (= cat_170 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (spoon_63 (get_potato_21_a cat_180)) (spoon_63 (get_potato_21_a cat_178))) (fp.mul roundNearestTiesToEven (spoon_63 (get_potato_21_b cat_180)) (spoon_63 (get_potato_21_b cat_178))))))))
(assert (and (= cat_171 (spoon_83 (mk_potato_23 cat_182) (mk_potato_23 cat_178))) (and (spoon_85 cat_171) (= cat_171 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (spoon_63 (get_potato_21_a cat_182)) (spoon_63 (get_potato_21_a cat_178))) (fp.mul roundNearestTiesToEven (spoon_63 (get_potato_21_b cat_182)) (spoon_63 (get_potato_21_b cat_178))))))))
(assert (= cat_172 (fp.sub roundNearestTiesToEven cat_171 cat_170)))
(assert (= cat_185 (mk_potato_10 cat_145)))
(assert (= cat_186 cat_172))
(assert (let ((_let_0 (fp.sqrt roundNearestTiesToEven cat_184))) (and (= cat_173 _let_0) (spoon_1 _let_0))))
(assert (= cat_187 (mk_potato_10 cat_146)))
(assert (= cat_188 cat_173))
(assert (not (fp.leq (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv182 8) (_ bv0 23)) cat_188) (fp.abs cat_186))))
(assert (let ((_let_0 (fp.div roundNearestTiesToEven (fp.abs cat_186) cat_188))) (and (= cat_174 _let_0) (spoon_1 _let_0))))
