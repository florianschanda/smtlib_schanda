...
(define-fun spoon_64 ((kitten_43 Float32)) Bool (and (spoon_1 kitten_43) (and (fp.leq (fp.neg (fp #b0 #b10001100 #b00000000000000000000000)) kitten_43) (fp.leq kitten_43 (fp #b0 #b10001100 #b00000000000000000000000)))))
...
(assert (forall ((kitten_48 potato_15) (kitten_49 potato_15)) (! (spoon_63 (spoon_73 kitten_48 kitten_49) true false true) :pattern ((spoon_73 kitten_48 kitten_49)))))
...
(define-fun spoon_83 ((kitten_50 potato_22)) potato_21 (get_potato_22_a kitten_50))
(declare-datatypes () ((potato_23 (mk_potato_23 (get_potato_23_a potato_21)))))
(define-fun spoon_84 ((kitten_51 potato_23)) potato_21 (get_potato_23_a kitten_51))
(define-fun spoon_85 ((kitten_52 potato_23) (kitten_53 potato_23)) Bool (ite (and (= (spoon_71 (get_potato_21_a (get_potato_23_a kitten_52))) (spoon_71 (get_potato_21_a (get_potato_23_a kitten_53)))) (= (spoon_71 (get_potato_21_b (get_potato_23_a kitten_52))) (spoon_71 (get_potato_21_b (get_potato_23_a kitten_53))))) true false))
(declare-const cat_86 Int)
(declare-fun spoon_87 (potato_23) Int)
(declare-const cat_88 Int)
(declare-fun spoon_89 (potato_23) Int)
(assert (<= 0 cat_86))
(assert (forall ((kitten_54 potato_23)) (<= 0 (spoon_87 kitten_54))))
(assert (<= 0 cat_88))
(assert (forall ((kitten_55 potato_23)) (<= 0 (spoon_89 kitten_55))))
...
(define-fun spoon_98 ((kitten_56 potato_24)) potato_23 (get_potato_24_a kitten_56))
...
(define-fun spoon_106 ((kitten_57 Float32) (kitten_58 Bool) (kitten_59 Bool) (kitten_60 Bool)) Bool (=> (or (= kitten_58 true) (fp.leq (fp.neg (fp #b0 #b10001100 #b00000000000000000000000)) (fp #b0 #b10001100 #b00000000000000000000000))) (spoon_64 kitten_57)))
(define-fun spoon_107 ((kitten_61 Float32) (kitten_62 Bool) (kitten_63 Bool) (kitten_64 Bool)) Bool (=> (or (= kitten_62 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_31 kitten_61)))
