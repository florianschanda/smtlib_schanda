...
(declare-const cat_170 potato_28)
(declare-const cat_171 potato_27)
(declare-const cat_172 potato_28)
(declare-const cat_173 potato_27)
(declare-const cat_174 potato_28)
(declare-const cat_175 potato_27)
(declare-const cat_176 potato_28)
(declare-const cat_177 potato_27)
(declare-const cat_178 potato_10)
(declare-const cat_179 Float32)
(declare-const cat_180 potato_10)
...
(assert (= cat_170 (mk_potato_28 (mk_potato_27 cat_137 cat_138))))
(assert (= cat_171 (mk_potato_27 cat_148 cat_149)))
(assert (= (spoon_77 cat_150) (fp.neg (fp.mul RNE (fp #b0 #b01111111 #b00000000000000000000000) (spoon_77 (get_potato_27_b cat_171))))))
(assert (= cat_150 cat_151))
(assert (= (get_potato_27_a cat_171) cat_152))
(assert (= cat_153 cat_151))
(assert (= cat_154 cat_152))
(assert (= cat_172 (mk_potato_28 (mk_potato_27 cat_135 cat_136))))
(assert (= cat_173 (mk_potato_27 cat_153 cat_154)))
...
(assert (= cat_174 (mk_potato_28 (mk_potato_27 cat_131 cat_132))))
(assert (= cat_175 (mk_potato_27 cat_159 cat_160)))
...
(assert (= cat_176 (mk_potato_28 (mk_potato_27 cat_133 cat_134))))
(assert (= cat_177 (get_potato_29_a cat_164)))
(assert (and (= cat_165 (spoon_117 (mk_potato_29 cat_171) (mk_potato_29 cat_171))) (and (spoon_109 cat_165) (= cat_165 (fp.add RNE (fp.mul RNE (spoon_77 (get_potato_27_a cat_171)) (spoon_77 (get_potato_27_a cat_171))) (fp.mul RNE (spoon_77 (get_potato_27_b cat_171)) (spoon_77 (get_potato_27_b cat_171))))))))
(assert (= cat_178 (mk_potato_10 cat_139)))
(assert (= cat_179 cat_165))
(assert (and (= cat_166 (spoon_117 (mk_potato_29 cat_175) (mk_potato_29 cat_173))) (and (spoon_109 cat_166) (= cat_166 (fp.add RNE (fp.mul RNE (spoon_77 (get_potato_27_a cat_175)) (spoon_77 (get_potato_27_a cat_173))) (fp.mul RNE (spoon_77 (get_potato_27_b cat_175)) (spoon_77 (get_potato_27_b cat_173))))))))
(assert (and (= cat_167 (spoon_117 (mk_potato_29 cat_177) (mk_potato_29 cat_173))) (and (spoon_109 cat_167) (= cat_167 (fp.add RNE (fp.mul RNE (spoon_77 (get_potato_27_a cat_177)) (spoon_77 (get_potato_27_a cat_173))) (fp.mul RNE (spoon_77 (get_potato_27_b cat_177)) (spoon_77 (get_potato_27_b cat_173))))))))
(assert (= cat_168 (fp.sub RNE cat_167 cat_166)))
(assert (= cat_180 (mk_potato_10 cat_141)))
(assert (= cat_181 cat_168))
(assert (and (= cat_169 (fp.sqrt RNE cat_179)) (spoon_1 (fp.sqrt RNE cat_179))))
(assert (= cat_182 (mk_potato_10 cat_142)))
(assert (= cat_183 cat_169))
(assert (not (fp.leq (fp.mul RNE (fp #b0 #b10110110 #b00000000000000000000000) cat_183) (fp.abs cat_181))))
(assert (not (spoon_1 (fp.div RNE (fp.abs cat_181) cat_183))))
(check-sat)
(exit)
