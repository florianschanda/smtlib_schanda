...
(define-fun spoon_64 ((kitten_42 Float32)) Bool (and (spoon_1 kitten_42) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_42) (fp.leq kitten_42 (fp #b0 #b10111111 #b00000000000000000110000)))))
...
(define-fun spoon_71 ((kitten_44 Float32) (kitten_45 Bool) (kitten_46 Bool) (kitten_47 Bool)) Bool (=> (or (= kitten_45 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10111111 #b00000000000000000110000))) (spoon_64 kitten_44)))
(declare-sort potato_23 0)
(define-fun spoon_72 ((kitten_48 Float32)) Bool (and (spoon_1 kitten_48) (and (fp.leq (fp.neg (fp #b0 #b10001100 #b00000000000000000000000)) kitten_48) (fp.leq kitten_48 (fp #b0 #b10001100 #b00000000000000000000000)))))
...
(define-fun spoon_78 ((kitten_49 potato_24)) potato_23 (get_potato_24_a kitten_49))
(declare-fun spoon_79 (potato_23) Float32)
(declare-fun spoon_80 (Float32) potato_23)
(assert (forall ((kitten_50 potato_23)) (! (= (spoon_80 (spoon_79 kitten_50)) kitten_50) :pattern ((spoon_79 kitten_50)))))
(assert (forall ((kitten_51 potato_23)) (! (spoon_72 (spoon_79 kitten_51)) :pattern ((spoon_79 kitten_51)))))
(assert (forall ((kitten_52 Float32)) (! (=> (spoon_72 kitten_52) (= (spoon_79 (spoon_80 kitten_52)) kitten_52)) :pattern ((spoon_79 (spoon_80 kitten_52))))))
...
(define-fun spoon_87 ((kitten_53 Float32)) Bool (and (spoon_1 kitten_53) (and (fp.leq (fp.neg (fp #b0 #b10110110 #b00000000000000000000000)) kitten_53) (fp.leq kitten_53 (fp #b0 #b10110110 #b00000000000000000000000)))))
...
(define-fun spoon_93 ((kitten_54 potato_26)) potato_25 (get_potato_26_a kitten_54))
(define-fun spoon_94 ((kitten_55 Float32) (kitten_56 Bool) (kitten_57 Bool) (kitten_58 Bool)) Bool (=> (or (= kitten_56 true) (fp.leq (fp.neg (fp #b0 #b10110110 #b00000000000000000000000)) (fp #b0 #b10110110 #b00000000000000000000000))) (spoon_87 kitten_55)))
...
(define-fun spoon_95 ((kitten_59 potato_28)) potato_27 (get_potato_28_a kitten_59))
(declare-datatypes () ((potato_29 (mk_potato_29 (get_potato_29_a potato_27)))))
(define-fun spoon_96 ((kitten_60 potato_29)) potato_27 (get_potato_29_a kitten_60))
(define-fun spoon_97 ((kitten_61 potato_29) (kitten_62 potato_29)) Bool (ite (and (= (spoon_79 (get_potato_27_a (get_potato_29_a kitten_61))) (spoon_79 (get_potato_27_a (get_potato_29_a kitten_62)))) (= (spoon_79 (get_potato_27_b (get_potato_29_a kitten_61))) (spoon_79 (get_potato_27_b (get_potato_29_a kitten_62))))) true false))
...
(assert (<= 0 cat_100))
(assert (forall ((kitten_64 potato_29)) (<= 0 (spoon_101 kitten_64))))
...
(define-fun spoon_110 ((kitten_65 potato_30)) potato_29 (get_potato_30_a kitten_65))
(declare-sort potato_31 0)
(define-fun spoon_111 ((kitten_66 Float32)) Bool (and (spoon_1 kitten_66) (and (fp.leq (fp.neg (fp #b0 #b10011010 #b00000000000000000000000)) kitten_66) (fp.leq kitten_66 (fp #b0 #b10011010 #b00000000000000000000000)))))
...
(define-fun spoon_117 ((kitten_67 potato_32)) potato_31 (get_potato_32_a kitten_67))
(define-fun spoon_118 ((kitten_68 Float32) (kitten_69 Bool) (kitten_70 Bool) (kitten_71 Bool)) Bool (=> (or (= kitten_69 true) (fp.leq (fp.neg (fp #b0 #b10011010 #b00000000000000000000000)) (fp #b0 #b10011010 #b00000000000000000000000))) (spoon_111 kitten_68)))
(declare-fun spoon_119 (potato_29 potato_29) Float32)
(declare-fun spoon_120 (Float32 potato_29 potato_29) Bool)
(assert (forall ((kitten_72 potato_29) (kitten_73 potato_29)) (! (spoon_118 (spoon_119 kitten_72 kitten_73) true false true) :pattern ((spoon_119 kitten_72 kitten_73)))))
(assert (forall ((kitten_74 potato_29) (kitten_75 potato_29)) (! (= (spoon_119 kitten_74 kitten_75) (fp.add RNE (fp.mul RNE (spoon_79 (get_potato_27_a (get_potato_29_a kitten_74))) (spoon_79 (get_potato_27_a (get_potato_29_a kitten_75)))) (fp.mul RNE (spoon_79 (get_potato_27_b (get_potato_29_a kitten_74))) (spoon_79 (get_potato_27_b (get_potato_29_a kitten_75)))))) :pattern ((spoon_119 kitten_74 kitten_75)))))
...
(define-fun spoon_130 ((kitten_76 Float32) (kitten_77 Bool) (kitten_78 Bool) (kitten_79 Bool)) Bool (=> (or (= kitten_77 true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111))) (spoon_1 kitten_76)))
(define-fun spoon_131 ((kitten_80 Float32) (kitten_81 Bool) (kitten_82 Bool) (kitten_83 Bool)) Bool (=> (or (= kitten_81 true) (fp.leq (fp.neg (fp #b0 #b10001100 #b00000000000000000000000)) (fp #b0 #b10001100 #b00000000000000000000000))) (spoon_72 kitten_80)))
(define-fun spoon_132 ((kitten_84 Float32) (kitten_85 Bool) (kitten_86 Bool) (kitten_87 Bool)) Bool (=> (or (= kitten_85 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_31 kitten_84)))
...
(declare-const cat_178 potato_28)
...
(assert (= cat_172 (mk_potato_28 (mk_potato_27 cat_139 cat_140))))
(assert (= cat_173 (mk_potato_27 cat_150 cat_151)))
(assert (= (spoon_79 cat_152) (fp.neg (fp.mul RNE (fp #b0 #b01111111 #b00000000000000000000000) (spoon_79 (get_potato_27_b cat_173))))))
(assert (= cat_152 cat_153))
(assert (= (get_potato_27_a cat_173) cat_154))
(assert (= cat_155 cat_153))
(assert (= cat_156 cat_154))
(assert (= cat_174 (mk_potato_28 (mk_potato_27 cat_137 cat_138))))
(assert (= cat_175 (mk_potato_27 cat_155 cat_156)))
...
(assert (= cat_177 (mk_potato_27 cat_161 cat_162)))
...
(assert (= cat_178 (mk_potato_28 (mk_potato_27 cat_135 cat_136))))
(assert (= cat_179 (get_potato_29_a cat_166)))
(assert (and (= cat_167 (spoon_119 (mk_potato_29 cat_173) (mk_potato_29 cat_173))) (and (spoon_111 cat_167) (= cat_167 (fp.add RNE (fp.mul RNE (spoon_79 (get_potato_27_a cat_173)) (spoon_79 (get_potato_27_a cat_173))) (fp.mul RNE (spoon_79 (get_potato_27_b cat_173)) (spoon_79 (get_potato_27_b cat_173))))))))
(assert (= cat_180 (mk_potato_10 cat_141)))
(assert (= cat_181 cat_167))
(assert (and (= cat_168 (spoon_119 (mk_potato_29 cat_177) (mk_potato_29 cat_175))) (and (spoon_111 cat_168) (= cat_168 (fp.add RNE (fp.mul RNE (spoon_79 (get_potato_27_a cat_177)) (spoon_79 (get_potato_27_a cat_175))) (fp.mul RNE (spoon_79 (get_potato_27_b cat_177)) (spoon_79 (get_potato_27_b cat_175))))))))
(assert (and (= cat_169 (spoon_119 (mk_potato_29 cat_179) (mk_potato_29 cat_175))) (and (spoon_111 cat_169) (= cat_169 (fp.add RNE (fp.mul RNE (spoon_79 (get_potato_27_a cat_179)) (spoon_79 (get_potato_27_a cat_175))) (fp.mul RNE (spoon_79 (get_potato_27_b cat_179)) (spoon_79 (get_potato_27_b cat_175))))))))
(assert (= cat_170 (fp.sub RNE cat_169 cat_168)))
(assert (= cat_182 (mk_potato_10 cat_143)))
(assert (= cat_183 cat_170))
(assert (and (= cat_171 (fp.sqrt RNE cat_181)) (spoon_1 (fp.sqrt RNE cat_181))))
(assert (= cat_184 (mk_potato_10 cat_144)))
(assert (= cat_185 cat_171))
(assert (not (fp.leq (fp.mul RNE (fp #b0 #b10110110 #b00000000000000000000000) cat_185) (fp.abs cat_183))))
(assert (not (spoon_1 (fp.div RNE (fp.abs cat_183) cat_185))))
(check-sat)
(exit)
