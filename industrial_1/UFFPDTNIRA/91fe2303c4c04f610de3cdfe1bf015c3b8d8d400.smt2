...
(assert (= cat_141 cat_133))
(assert (= cat_142 (fp.sub RNE (spoon_30 (get_potato_13_a (get_potato_15_a cat_88))) (spoon_30 (get_potato_13_a (get_potato_15_a cat_86))))))
(assert (= cat_143 cat_134))
(assert (= cat_144 (fp.sub RNE (spoon_30 (get_potato_13_b (get_potato_15_a cat_88))) (spoon_30 (get_potato_13_b (get_potato_15_a cat_86))))))
(assert (= cat_145 cat_135))
(assert (= cat_146 (fp.add RNE (fp.mul RNE cat_142 cat_142) (fp.mul RNE cat_144 cat_144))))
(assert (not (fp.lt cat_146 (fp #b0 #b01110001 #b10100011011011100010111))))
(assert (= cat_147 cat_137))
(assert (= cat_148 (fp.add RNE (fp.mul RNE (fp.sub RNE (spoon_30 (get_potato_13_a (get_potato_15_a cat_84))) (spoon_30 (get_potato_13_a (get_potato_15_a cat_86)))) cat_142) (fp.mul RNE (fp.sub RNE (spoon_30 (get_potato_13_b (get_potato_15_a cat_84))) (spoon_30 (get_potato_13_b (get_potato_15_a cat_86)))) cat_144))))
