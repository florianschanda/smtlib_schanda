...
(assert (= cat_143 cat_135))
(assert (= cat_144 (fp.sub RNE (spoon_32 (get_potato_13_a (get_potato_15_a cat_90))) (spoon_32 (get_potato_13_a (get_potato_15_a cat_88))))))
(assert (= cat_145 cat_136))
(assert (= cat_146 (fp.sub RNE (spoon_32 (get_potato_13_b (get_potato_15_a cat_90))) (spoon_32 (get_potato_13_b (get_potato_15_a cat_88))))))
...
(assert (= cat_149 cat_139))
(assert (= cat_150 (fp.add RNE (fp.mul RNE (fp.sub RNE (spoon_32 (get_potato_13_a (get_potato_15_a cat_86))) (spoon_32 (get_potato_13_a (get_potato_15_a cat_88)))) cat_144) (fp.mul RNE (fp.sub RNE (spoon_32 (get_potato_13_b (get_potato_15_a cat_86))) (spoon_32 (get_potato_13_b (get_potato_15_a cat_88)))) cat_146))))
(assert (not (not (fp.isZero cat_148))))
(check-sat)
(exit)
