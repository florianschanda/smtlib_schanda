...
(declare-const cat_243 potato_28)
...
(assert (= cat_241 (ite (not (= cat_200 true)) true false)))
(assert (= cat_241 true))
(assert (=> (= cat_242 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_243))) (and (= cat_201 (spoon_76 (fp #b0 #b10000101 #b01100111111101011101000))) (spoon_86 cat_201)))))
(assert (=> (= cat_242 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_243))) (= cat_244 (mk_potato_10 cat_240)))))
(assert (=> (= cat_242 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_243))) (= cat_245 cat_201))))
(assert (=> (= cat_242 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_243)))) (=> (fp.lt (spoon_111 (get_potato_28_a cat_243)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (and (= cat_202 (spoon_76 (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (spoon_86 cat_202))))))
(assert (=> (= cat_242 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_243)))) (=> (fp.lt (spoon_111 (get_potato_28_a cat_243)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_246 (mk_potato_10 cat_240))))))
(assert (=> (= cat_242 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_243)))) (=> (fp.lt (spoon_111 (get_potato_28_a cat_243)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_247 cat_202)))))
(assert (=> (= cat_242 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_243)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_243)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_203 (spoon_111 (get_potato_28_a cat_243))) (spoon_1 (spoon_111 (get_potato_28_a cat_243))))))))
(assert (=> (= cat_242 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_243)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_243)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_204 (spoon_76 cat_203)) (spoon_86 cat_204))))))
(assert (=> (= cat_242 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_243)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_243)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_248 (mk_potato_10 cat_240))))))
(assert (=> (= cat_242 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_243)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_243)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_249 cat_204)))))
(assert (=> (= cat_242 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_243)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_243)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_247 cat_249)))))
(assert (=> (= cat_242 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_243)))) (= cat_245 cat_247))))
(assert (=> (= cat_242 true) (= cat_250 (mk_potato_10 cat_239))))
(assert (=> (= cat_242 true) (= cat_251 (fp.mul RNE cat_170 cat_170))))
(assert (=> (= cat_242 true) (= cat_252 (mk_potato_10 cat_236))))
(assert (=> (= cat_242 true) (= cat_253 ((_ to_fp 8 24) RNE (fp.sub RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) (fp.mul RNE cat_166 cat_166))))))
(assert (=> (= cat_242 true) (= cat_254 (mk_potato_10 cat_235))))
(assert (=> (= cat_242 true) (= cat_255 (fp.sqrt RNE cat_253))))
(assert (=> (not (= cat_242 true)) (= cat_245 cat_240)))
(assert (=> (not (= cat_242 true)) (= cat_251 cat_239)))
(assert (=> (not (= cat_242 true)) (= cat_253 cat_236)))
(assert (=> (not (= cat_242 true)) (= cat_255 cat_235)))
(assert (=> (= cat_242 true) (and (= cat_205 (fp.sub RNE cat_253 cat_251)) (spoon_1 (fp.sub RNE cat_253 cat_251)))))
(assert (=> (= cat_242 true) (= cat_206 (fp.add RNE cat_205 (fp.mul RNE cat_245 cat_245)))))
(assert (=> (= cat_242 true) (and (= cat_207 cat_206) (spoon_1 cat_206))))
(assert (=> (= cat_242 true) (= cat_256 (mk_potato_10 cat_238))))
(assert (=> (= cat_242 true) (= cat_257 cat_207)))
(assert (=> (= cat_242 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_257) (= cat_258 (mk_potato_10 cat_237)))))
(assert (=> (= cat_242 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_257) (= cat_259 (fp.sqrt RNE cat_257)))))
(assert (=> (= cat_242 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_257) (= cat_261 cat_242))))
(assert (=> (= cat_242 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_257)) (= cat_260 (mk_potato_7 cat_242)))))
(assert (=> (= cat_242 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_257)) (= cat_261 (distinct 0 0)))))
(assert (=> (= cat_242 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_257)) (= cat_259 cat_237))))
(assert (=> (not (= cat_242 true)) (= cat_257 cat_238)))
(assert (=> (not (= cat_242 true)) (= cat_259 cat_237)))
(assert (=> (not (= cat_242 true)) (= cat_261 cat_242)))
(assert (= cat_261 true))
(assert (= cat_210 (fp.mul RNE cat_259 cat_170)))
(assert (spoon_1 (fp.mul RNE cat_259 cat_170)))
(assert (= cat_208 (fp.mul RNE cat_255 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_166 cat_166)) cat_251))))
(assert (spoon_1 (fp.mul RNE cat_255 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_166 cat_166)) cat_251))))
...
(assert (= cat_262 cat_213))
(assert (spoon_1 cat_212))
(assert (= cat_214 (fp.mul RNE cat_259 cat_170)))
(assert (spoon_1 (fp.mul RNE cat_259 cat_170)))
(assert (= cat_215 (fp.mul RNE cat_214 cat_245)))
(assert (= cat_216 cat_215))
(assert (spoon_1 cat_215))
(assert (= cat_217 (fp.mul RNE cat_255 cat_257)))
(assert (spoon_1 (fp.mul RNE cat_255 cat_257)))
(assert (= cat_218 (fp.sub RNE cat_217 cat_216)))
(assert (= cat_219 cat_218))
(assert (= cat_263 cat_219))
(assert (spoon_1 cat_218))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_263) (and (= cat_228 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_263)) (spoon_1 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_263)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_263) (and (= cat_229 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_262)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_262)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_263) (= cat_230 (ite (fp.leq cat_229 cat_228) true false))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_263) (and (= cat_226 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_262)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_262)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_263) (and (= cat_227 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_263)) (spoon_1 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_263)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_263) (= cat_231 (ite (fp.leq cat_227 cat_226) true false))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_263) (= cat_265 (ite (= cat_231 true) cat_230 false))))
(assert (=> (not (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_263)) (= cat_265 false)))
(assert (=> (= cat_265 true) (= cat_264 true)))
(assert (=> (not (= cat_265 true)) (=> (fp.lt cat_263 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_222 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_263)) (spoon_1 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_263))))))
(assert (=> (not (= cat_265 true)) (=> (fp.lt cat_263 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_223 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_262)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_262))))))
(assert (=> (not (= cat_265 true)) (=> (fp.lt cat_263 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_224 (ite (fp.leq cat_223 cat_222) true false)))))
(assert (=> (not (= cat_265 true)) (=> (fp.lt cat_263 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_220 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_262)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_262))))))
(assert (=> (not (= cat_265 true)) (=> (fp.lt cat_263 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_221 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_263)) (spoon_1 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_263))))))
(assert (=> (not (= cat_265 true)) (=> (fp.lt cat_263 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_225 (ite (fp.leq cat_221 cat_220) true false)))))
(assert (=> (not (= cat_265 true)) (=> (fp.lt cat_263 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_264 (ite (= cat_225 true) cat_224 false)))))
(assert (=> (not (= cat_265 true)) (=> (not (fp.lt cat_263 (fp #b0 #b00000000 #b00000000000000000000000))) (= cat_264 false))))
(assert (= cat_264 true))
(assert (= cat_232 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_262)))
(assert (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_262)))
(assert (= cat_233 (fp.div RNE cat_232 cat_263)))
(assert (= cat_234 cat_233))
(assert (spoon_1 cat_233))
(assert (not (spoon_104 cat_234)))
(check-sat)
(exit)
