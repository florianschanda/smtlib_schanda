...
(declare-fun spoon_36 (Float32 Float32 Float32) Float32)
(declare-fun spoon_37 (Float32 Float32 Float32 Float32) Bool)
(assert (forall ((kitten_30 Float32) (kitten_31 Float32) (kitten_32 Float32)) (! (=> (and (and (and (spoon_35 kitten_30 true true true) (spoon_35 kitten_31 true true true)) (spoon_35 kitten_32 true true true)) (and (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) kitten_32) (or (not (fp.eq kitten_31 (fp #b0 #b00000000 #b00000000000000000000000))) (not (fp.eq kitten_30 (fp #b0 #b00000000 #b00000000000000000000000)))))) (let ((kitten_33 (spoon_36 kitten_30 kitten_31 kitten_32))) (and (=> (and (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) kitten_31) (fp.eq kitten_30 (fp #b0 #b00000000 #b00000000000000000000000))) (fp.eq kitten_33 (fp #b0 #b00000000 #b00000000000000000000000))) (spoon_35 kitten_33 true false true)))) :pattern ((spoon_36 kitten_30 kitten_31 kitten_32)))))
(declare-sort potato_13 0)
(define-fun spoon_38 ((kitten_34 Float32)) Bool (and (spoon_1 kitten_34) (and (fp.leq (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)) kitten_34) (fp.leq kitten_34 (fp #b0 #b10000110 #b01101000000000000000000)))))
...
(define-fun spoon_45 ((kitten_36 Float32)) Bool (and (spoon_1 kitten_36) (and (fp.leq (fp.neg (fp #b0 #b10001100 #b00000000000000000000000)) kitten_36) (fp.leq kitten_36 (fp #b0 #b10001100 #b00000000000000000000000)))))
(declare-fun spoon_46 (potato_15 potato_15) Bool)
...
(define-fun spoon_51 ((kitten_37 potato_16)) potato_15 (get_potato_16_a kitten_37))
(define-fun spoon_52 ((kitten_38 Float32) (kitten_39 Bool) (kitten_40 Bool) (kitten_41 Bool)) Bool (=> (or (= kitten_39 true) (fp.leq (fp.neg (fp #b0 #b10001100 #b00000000000000000000000)) (fp #b0 #b10001100 #b00000000000000000000000))) (spoon_45 kitten_38)))
...
(define-fun spoon_58 ((kitten_42 Float32) (kitten_43 Bool) (kitten_44 Bool) (kitten_45 Bool)) Bool (=> (or (= kitten_43 true) (fp.leq (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)) (fp #b0 #b10000110 #b01101000000000000000000))) (spoon_38 kitten_42)))
...
(assert (spoon_45 cat_53))
(assert (spoon_45 cat_55))
(assert (or (not (fp.eq cat_53 (fp #b0 #b00000000 #b00000000000000000000000))) (not (fp.eq cat_55 (fp #b0 #b00000000 #b00000000000000000000000)))))
(assert (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)) (spoon_1 cat_59)))
(assert (and (= cat_60 (spoon_36 cat_53 cat_55 (fp #b0 #b10000111 #b01101000000000000000000))) (and (spoon_1 cat_60) (=> (and (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_55) (fp.eq cat_53 (fp #b0 #b00000000 #b00000000000000000000000))) (fp.eq cat_60 (fp #b0 #b00000000 #b00000000000000000000000))))))
(assert (= cat_61 cat_59))
(assert (= cat_62 cat_60))
(assert (=> (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) cat_62) (= cat_63 cat_62)))
(assert (=> (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) cat_62) (= cat_64 (fp #b0 #b10000110 #b01101000000000000000000))))
(assert (=> (not (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) cat_62)) (=> (fp.lt cat_62 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000))) (= cat_65 cat_62))))
(assert (=> (not (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) cat_62)) (=> (fp.lt cat_62 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000))) (= cat_66 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000))))))
(assert (=> (not (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) cat_62)) (=> (not (fp.lt cat_62 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)))) (= cat_66 cat_62))))
(assert (=> (not (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) cat_62)) (= cat_64 cat_66)))
