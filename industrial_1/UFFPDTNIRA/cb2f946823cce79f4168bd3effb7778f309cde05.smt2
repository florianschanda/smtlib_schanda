...
(assert (= cat_64 cat_61))
(assert (= cat_65 cat_62))
(assert (=> (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) cat_65) (= cat_66 cat_65)))
(assert (=> (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) cat_65) (= cat_67 (fp #b0 #b10000110 #b01101000000000000000000))))
(assert (=> (not (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) cat_65)) (=> (fp.lt cat_65 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000))) (= cat_68 cat_65))))
(assert (=> (not (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) cat_65)) (=> (fp.lt cat_65 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000))) (= cat_69 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000))))))
(assert (=> (not (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) cat_65)) (=> (not (fp.lt cat_65 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)))) (= cat_69 cat_65))))
(assert (=> (not (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) cat_65)) (= cat_67 cat_69)))
(assert (not (spoon_40 cat_67)))
(check-sat)
(exit)
