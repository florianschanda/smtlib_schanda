...
(assert (= cat_107 (fp.sub roundNearestTiesToEven cat_106 cat_105)))
(assert (fp.leq (fp (_ bv0 1) (_ bv134 8) (_ bv3407872 23)) cat_107))
(assert (not (spoon_60 (fp.sub roundNearestTiesToEven cat_107 (fp (_ bv0 1) (_ bv135 8) (_ bv3407872 23))))))
(check-sat)
(exit)
