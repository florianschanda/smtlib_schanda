...
(assert (= cat_120 (fp.div RNE (spoon_75 cat_113) cat_114)))
(assert (spoon_1 (fp.div RNE (spoon_75 cat_113) cat_114)))
(assert (= cat_121 (fp.mul RNE cat_120 cat_115)))
...
(assert (= cat_130 (fp.add RNE (spoon_40 (get_potato_15_b (get_potato_17_a cat_79))) (spoon_75 (get_potato_23_b cat_132)))))
(assert (= (spoon_40 cat_131) cat_130))
(assert (spoon_1 (fp.add RNE (spoon_40 (get_potato_15_b (get_potato_17_a cat_79))) (spoon_75 (get_potato_23_b cat_132)))))
(assert (not (spoon_33 (fp.add RNE (spoon_40 (get_potato_15_a (get_potato_17_a cat_79))) (spoon_75 (get_potato_23_a cat_132))))))
(check-sat)
(exit)
