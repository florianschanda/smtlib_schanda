...
(declare-fun cat_267 () potato_7)
(declare-fun cat_268 () Bool)
(declare-fun cat_269 () potato_29)
(declare-fun cat_270 () potato_28)
...
(assert (= cat_266 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
(assert (spoon_100 cat_266))
...
(assert (= cat_268 (distinct 1 0)))
(assert (= cat_269 (mk_potato_29 (mk_potato_28 cat_201 cat_202))))
(assert (= cat_270 (get_potato_30_a cat_138)))
(assert (= cat_271 (mk_potato_11 cat_206)))
(assert (= cat_272 (fp.mul roundNearestTiesToEven cat_181 cat_181)))
...
(assert (= cat_278 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1025 11) (_ bv0 52)) cat_181)))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1025 11) (_ bv0 52)) cat_272))) (and (= cat_226 _let_0) (spoon_3 _let_0))))
...
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_278 ((_ to_fp 11 53) roundNearestTiesToEven cat_179)))) (and (= cat_237 _let_0) (spoon_3 _let_0))))
(assert (= cat_238 (fp.mul roundNearestTiesToEven cat_237 cat_284)))
(assert (and (= cat_239 cat_238) (spoon_3 cat_238)))
(assert (let ((_let_0 (fp.sub roundNearestTiesToEven cat_280 cat_274))) (and (= cat_233 _let_0) (spoon_3 _let_0))))
(assert (= cat_234 (fp.sub roundNearestTiesToEven cat_233 cat_276)))
(assert (and (= cat_235 cat_234) (spoon_3 cat_234)))
(assert (= cat_236 (fp.mul roundNearestTiesToEven cat_235 cat_282)))
...
(assert (let ((_let_0 (fp.add roundNearestTiesToEven cat_280 cat_274))) (and (= cat_243 _let_0) (spoon_3 _let_0))))
(assert (= cat_244 (fp.add roundNearestTiesToEven cat_243 cat_276)))
(assert (and (= cat_245 cat_244) (spoon_3 cat_244)))
(assert (= cat_287 (mk_potato_11 cat_214)))
(assert (= cat_288 cat_245))
(assert (let ((_let_0 (fp.div roundNearestTiesToEven cat_286 cat_288))) (and (= cat_246 _let_0) (spoon_3 _let_0))))
(assert (= cat_289 (mk_potato_11 cat_212)))
(assert (= cat_290 cat_246))
(assert (=> (fp.lt cat_290 (fp.neg (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (= cat_291 spoon_302)))
(assert (let ((_let_0 (fp.neg (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52))))) (=> (fp.lt cat_290 _let_0) (= cat_292 _let_0))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_290 (fp.neg _let_0))) (=> (fp.lt _let_0 cat_290) (= cat_293 spoon_302)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_290 (fp.neg _let_0))) (=> (fp.lt _let_0 cat_290) (= cat_294 _let_0)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_290 (fp.neg _let_0))) (=> (not (fp.lt _let_0 cat_290)) (and (= cat_247 cat_290) (spoon_3 cat_290))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_290 (fp.neg _let_0))) (=> (not (fp.lt _let_0 cat_290)) (= cat_295 spoon_302)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_290 (fp.neg _let_0))) (=> (not (fp.lt _let_0 cat_290)) (= cat_296 cat_247)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_290 (fp.neg _let_0))) (=> (not (fp.lt _let_0 cat_290)) (= cat_294 cat_296)))))
(assert (=> (not (fp.lt cat_290 (fp.neg (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52))))) (= cat_292 cat_294)))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_278 ((_ to_fp 11 53) roundNearestTiesToEven cat_177)))) (and (= cat_248 _let_0) (spoon_3 _let_0))))
(assert (= cat_297 (mk_potato_11 cat_216)))
(assert (= cat_298 cat_248))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_278 ((_ to_fp 11 53) roundNearestTiesToEven cat_179)))) (and (= cat_253 _let_0) (spoon_3 _let_0))))
(assert (= cat_254 (fp.mul roundNearestTiesToEven cat_253 cat_282)))
(assert (and (= cat_255 cat_254) (spoon_3 cat_254)))
(assert (let ((_let_0 (fp.sub roundNearestTiesToEven cat_280 cat_274))) (and (= cat_249 _let_0) (spoon_3 _let_0))))
(assert (= cat_250 (fp.sub roundNearestTiesToEven cat_249 cat_276)))
(assert (and (= cat_251 cat_250) (spoon_3 cat_250)))
(assert (= cat_252 (fp.mul roundNearestTiesToEven cat_251 cat_284)))
...
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1035 11) (_ bv1873567813730304 52)) cat_300))) (=> (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_300) (and (= cat_262 _let_0) (spoon_3 _let_0)))))
(assert (=> (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_300) (= cat_263 (ite (fp.leq cat_298 cat_262) true false))))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp.neg (fp (_ bv0 1) (_ bv1035 11) (_ bv1873567813730304 52))) cat_300))) (=> (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_300) (and (= cat_261 _let_0) (spoon_3 _let_0)))))
(assert (=> (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_300) (= cat_264 (ite (fp.leq cat_261 cat_298) true false))))
(assert (=> (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_300) (= cat_301 (ite (= cat_264 true) cat_263 false))))
(assert (=> (not (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_300)) (= cat_301 false)))
(assert (not (= cat_301 true)))
(assert (fp.lt cat_300 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52))))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp.neg (fp (_ bv0 1) (_ bv1035 11) (_ bv1873567813730304 52))) cat_300))) (and (= cat_259 _let_0) (spoon_3 _let_0))))
(assert (= cat_260 (ite (fp.leq cat_298 cat_259) true false)))
(assert (not (spoon_3 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1035 11) (_ bv1873567813730304 52)) cat_300))))
(check-sat)
(exit)
