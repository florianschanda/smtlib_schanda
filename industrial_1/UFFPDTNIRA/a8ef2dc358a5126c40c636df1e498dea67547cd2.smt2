...
(declare-const cat_269 potato_29)
(declare-const cat_270 potato_28)
...
(assert (and (= cat_226 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_272)) (spoon_3 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_272))))
...
(assert (and (= cat_237 (fp.mul RNE cat_278 ((_ to_fp 11 53) RNE cat_179))) (spoon_3 (fp.mul RNE cat_278 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_238 (fp.mul RNE cat_237 cat_284)))
(assert (and (= cat_239 cat_238) (spoon_3 cat_238)))
(assert (and (= cat_233 (fp.sub RNE cat_280 cat_274)) (spoon_3 (fp.sub RNE cat_280 cat_274))))
...
(assert (and (= cat_243 (fp.add RNE cat_280 cat_274)) (spoon_3 (fp.add RNE cat_280 cat_274))))
...
(assert (and (= cat_246 (fp.div RNE cat_286 cat_288)) (spoon_3 (fp.div RNE cat_286 cat_288))))
...
(assert (=> (not (fp.lt cat_290 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_290)) (and (= cat_247 cat_290) (spoon_3 cat_290)))))
...
(assert (and (= cat_248 (fp.mul RNE cat_278 ((_ to_fp 11 53) RNE cat_177))) (spoon_3 (fp.mul RNE cat_278 ((_ to_fp 11 53) RNE cat_177)))))
(assert (= cat_297 (mk_potato_11 cat_216)))
(assert (= cat_298 cat_248))
(assert (and (= cat_253 (fp.mul RNE cat_278 ((_ to_fp 11 53) RNE cat_179))) (spoon_3 (fp.mul RNE cat_278 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_254 (fp.mul RNE cat_253 cat_282)))
(assert (and (= cat_255 cat_254) (spoon_3 cat_254)))
(assert (and (= cat_249 (fp.sub RNE cat_280 cat_274)) (spoon_3 (fp.sub RNE cat_280 cat_274))))
...
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_300) (and (= cat_262 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_300)) (spoon_3 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_300)))))
...
(assert (and (= cat_259 (fp.mul RNE (fp.neg (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000)) cat_300)) (spoon_3 (fp.mul RNE (fp.neg (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000)) cat_300))))
(assert (= cat_260 (ite (fp.leq cat_298 cat_259) true false)))
(assert (not (spoon_3 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_300))))
(check-sat)
(exit)
