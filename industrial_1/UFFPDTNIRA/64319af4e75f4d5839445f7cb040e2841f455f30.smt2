...
(assert (=> (=> (not (fp.lt cat_72 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_72)) (=> (not (fp.lt cat_74 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_74)))) (and (and (and (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) cat_75) (fp.leq cat_75 (fp #b0 #b10001011 #b00000000000000000000000))) (and (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) cat_76) (fp.leq cat_76 (fp #b0 #b10001011 #b00000000000000000000000)))) (and (spoon_58 cat_75) (spoon_58 cat_76)))))
(assert (=> (not (=> (not (fp.lt cat_72 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_72)) (=> (not (fp.lt cat_74 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_74))))) (= cat_76 cat_74)))
(assert (=> (not (=> (not (fp.lt cat_72 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_72)) (=> (not (fp.lt cat_74 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_74))))) (= cat_75 cat_72)))
(assert (not (spoon_29 cat_76)))
(check-sat)
(exit)
