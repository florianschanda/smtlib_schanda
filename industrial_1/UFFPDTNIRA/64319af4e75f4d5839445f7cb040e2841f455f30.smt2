...
(assert (=> (=> (not (fp.lt cat_77 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_77)) (=> (not (fp.lt cat_79 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_79)))) (and (and (and (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) cat_80) (fp.leq cat_80 (fp #b0 #b10001011 #b00000000000000000000000))) (and (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) cat_81) (fp.leq cat_81 (fp #b0 #b10001011 #b00000000000000000000000)))) (and (spoon_60 cat_81) (spoon_60 cat_80)))))
(assert (=> (not (=> (not (fp.lt cat_77 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_77)) (=> (not (fp.lt cat_79 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_79))))) (= cat_81 cat_79)))
(assert (=> (not (=> (not (fp.lt cat_77 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_77)) (=> (not (fp.lt cat_79 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_79))))) (= cat_80 cat_77)))
(assert (not (spoon_31 cat_81)))
(check-sat)
(exit)
