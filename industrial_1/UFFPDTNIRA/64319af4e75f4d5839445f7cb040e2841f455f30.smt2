...
(assert (=> (=> (not (fp.lt cat_74 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_74)) (=> (not (fp.lt cat_76 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_76)))) (and (and (and (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) cat_77) (fp.leq cat_77 (fp #b0 #b10001011 #b00000000000000000000000))) (and (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) cat_78) (fp.leq cat_78 (fp #b0 #b10001011 #b00000000000000000000000)))) (and (spoon_60 cat_77) (spoon_60 cat_78)))))
(assert (=> (not (=> (not (fp.lt cat_74 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_74)) (=> (not (fp.lt cat_76 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_76))))) (= cat_78 cat_76)))
(assert (=> (not (=> (not (fp.lt cat_74 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_74)) (=> (not (fp.lt cat_76 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_76))))) (= cat_77 cat_74)))
(assert (not (spoon_31 cat_78)))
(check-sat)
(exit)
