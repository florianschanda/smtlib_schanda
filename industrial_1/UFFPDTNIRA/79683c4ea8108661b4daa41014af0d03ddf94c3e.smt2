...
(declare-const cat_271 potato_25)
(declare-const cat_272 potato_24)
(declare-const cat_273 Bool)
(declare-const cat_274 Bool)
(declare-const cat_275 potato_24)
...
(assert (= cat_271 (mk_potato_25 (mk_potato_24 cat_205 cat_206))))
(assert (= cat_272 (get_potato_26_a cat_115)))
(assert (= cat_229 (spoon_117 cat_171 cat_78)))
(assert (= cat_273 (ite (not (= cat_229 true)) true false)))
(assert (= cat_273 true))
(assert (=> (= cat_274 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_275))) (and (= cat_230 (spoon_153 (fp #b0 #b10000101 #b01100111111101011101000))) (spoon_133 cat_230)))))
(assert (=> (= cat_274 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_275))) (= cat_276 (mk_potato_10 cat_268)))))
(assert (=> (= cat_274 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_275))) (= cat_277 cat_230))))
(assert (=> (= cat_274 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_275)))) (=> (fp.lt (spoon_88 (get_potato_24_a cat_275)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (and (= cat_231 (spoon_153 (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (spoon_133 cat_231))))))
(assert (=> (= cat_274 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_275)))) (=> (fp.lt (spoon_88 (get_potato_24_a cat_275)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_278 (mk_potato_10 cat_268))))))
(assert (=> (= cat_274 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_275)))) (=> (fp.lt (spoon_88 (get_potato_24_a cat_275)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_279 cat_231)))))
(assert (=> (= cat_274 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_275)))) (=> (not (fp.lt (spoon_88 (get_potato_24_a cat_275)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_232 (spoon_88 (get_potato_24_a cat_275))) (spoon_1 (spoon_88 (get_potato_24_a cat_275))))))))
(assert (=> (= cat_274 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_275)))) (=> (not (fp.lt (spoon_88 (get_potato_24_a cat_275)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_233 (spoon_153 cat_232)) (spoon_133 cat_233))))))
(assert (=> (= cat_274 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_275)))) (=> (not (fp.lt (spoon_88 (get_potato_24_a cat_275)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_280 (mk_potato_10 cat_268))))))
(assert (=> (= cat_274 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_275)))) (=> (not (fp.lt (spoon_88 (get_potato_24_a cat_275)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_281 cat_233)))))
(assert (=> (= cat_274 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_275)))) (=> (not (fp.lt (spoon_88 (get_potato_24_a cat_275)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_279 cat_281)))))
(assert (=> (= cat_274 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_88 (get_potato_24_a cat_275)))) (= cat_277 cat_279))))
(assert (=> (= cat_274 true) (=> (spoon_193 cat_179) (and (= cat_234 (fp.mul RNE cat_179 cat_179)) (spoon_1 (fp.mul RNE cat_179 cat_179))))))
(assert (=> (= cat_274 true) (=> (spoon_193 cat_179) (= cat_282 (mk_potato_10 cat_266)))))
(assert (=> (= cat_274 true) (=> (spoon_193 cat_179) (= cat_283 cat_234))))
(assert (=> (= cat_274 true) (=> (spoon_193 cat_179) (= cat_285 cat_274))))
(assert (=> (= cat_274 true) (=> (not (spoon_193 cat_179)) (= cat_284 (mk_potato_7 cat_274)))))
(assert (=> (= cat_274 true) (=> (not (spoon_193 cat_179)) (= cat_285 (spoon_41 0)))))
(assert (=> (= cat_274 true) (=> (not (spoon_193 cat_179)) (= cat_283 cat_266))))
(assert (=> (= cat_274 true) (= cat_286 (mk_potato_10 cat_260))))
(assert (=> (= cat_274 true) (= cat_287 ((_ to_fp 8 24) RNE (fp.sub RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) (fp.mul RNE cat_175 cat_175))))))
(assert (=> (= cat_274 true) (and (= cat_235 cat_287) (spoon_1 cat_287))))
(assert (=> (= cat_274 true) (and (= cat_236 (spoon_150 cat_235)) (spoon_142 cat_236))))
(assert (=> (= cat_274 true) (= cat_288 (mk_potato_10 cat_258))))
(assert (=> (= cat_274 true) (= cat_289 cat_236)))
(assert (=> (not (= cat_274 true)) (= cat_277 cat_268)))
(assert (=> (not (= cat_274 true)) (= cat_283 cat_266)))
(assert (=> (not (= cat_274 true)) (= cat_287 cat_260)))
(assert (=> (not (= cat_274 true)) (= cat_289 cat_258)))
(assert (=> (not (= cat_274 true)) (= cat_285 cat_274)))
(assert (=> (= cat_285 true) (and (= cat_237 (fp.sub RNE cat_287 cat_283)) (spoon_1 (fp.sub RNE cat_287 cat_283)))))
(assert (=> (= cat_285 true) (= cat_238 (fp.add RNE cat_237 (fp.mul RNE cat_277 cat_277)))))
(assert (=> (= cat_285 true) (and (= cat_239 cat_238) (spoon_1 cat_238))))
(assert (=> (= cat_285 true) (= cat_290 (mk_potato_10 cat_264))))
(assert (=> (= cat_285 true) (= cat_291 cat_239)))
(assert (=> (= cat_285 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_291) (and (= cat_240 cat_291) (spoon_1 cat_291)))))
(assert (=> (= cat_285 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_291) (and (= cat_241 (spoon_150 cat_240)) (spoon_142 cat_241)))))
(assert (=> (= cat_285 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_291) (= cat_292 (mk_potato_10 cat_262)))))
(assert (=> (= cat_285 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_291) (= cat_293 cat_241))))
(assert (=> (= cat_285 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_291) (= cat_295 cat_285))))
(assert (=> (= cat_285 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_291)) (= cat_294 (mk_potato_7 cat_285)))))
(assert (=> (= cat_285 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_291)) (= cat_295 (spoon_41 0)))))
(assert (=> (= cat_285 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_291)) (= cat_293 cat_262))))
(assert (=> (not (= cat_285 true)) (= cat_291 cat_264)))
(assert (=> (not (= cat_285 true)) (= cat_293 cat_262)))
(assert (=> (not (= cat_285 true)) (= cat_295 cat_285)))
(assert (= cat_295 true))
(assert (and (= cat_246 (fp.mul RNE cat_293 cat_179)) (spoon_1 (fp.mul RNE cat_293 cat_179))))
(assert (and (= cat_242 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_175 cat_175)) cat_283)) (spoon_1 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_175 cat_175)) cat_283))))
(assert (= cat_243 (fp.mul RNE cat_289 cat_242)))
(assert (and (= cat_244 cat_243) (spoon_1 cat_243)))
(assert (= cat_245 (fp.mul RNE cat_244 cat_277)))
...
(assert (= cat_296 (mk_potato_10 cat_215)))
(assert (= cat_297 cat_249))
(assert (and (= cat_250 (fp.mul RNE cat_293 cat_179)) (spoon_1 (fp.mul RNE cat_293 cat_179))))
(assert (= cat_251 (fp.mul RNE cat_250 cat_277)))
(assert (and (= cat_252 cat_251) (spoon_1 cat_251)))
(assert (and (= cat_253 (fp.mul RNE cat_289 cat_291)) (spoon_1 (fp.mul RNE cat_289 cat_291))))
(assert (= cat_254 (fp.sub RNE cat_253 cat_252)))
(assert (and (= cat_255 cat_254) (spoon_1 cat_254)))
(assert (= cat_298 (mk_potato_10 cat_216)))
(assert (= cat_299 cat_255))
(assert (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_299))
(assert (and (= cat_256 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_299)) (spoon_1 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_299))))
(assert (not (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_297))))
(check-sat)
(exit)
