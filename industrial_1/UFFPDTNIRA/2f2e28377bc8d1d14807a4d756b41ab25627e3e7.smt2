...
(declare-fun spoon_34 (Float32 Float32 Float32) Float32)
(declare-fun spoon_35 (Float32 Float32 Float32 Float32) Bool)
(assert (forall ((kitten_30 Float32) (kitten_31 Float32) (kitten_32 Float32)) (! (=> (and (and (and (spoon_33 kitten_30 true true true true) (spoon_33 kitten_31 true true true true)) (spoon_33 kitten_32 true true true true)) (and (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) kitten_32) (or (not (fp.eq kitten_31 (fp #b0 #b00000000 #b00000000000000000000000))) (not (fp.eq kitten_30 (fp #b0 #b00000000 #b00000000000000000000000)))))) (let ((kitten_33 (spoon_34 kitten_30 kitten_31 kitten_32))) (and (=> (and (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) kitten_31) (fp.eq kitten_30 (fp #b0 #b00000000 #b00000000000000000000000))) (fp.eq kitten_33 (fp #b0 #b00000000 #b00000000000000000000000))) (spoon_33 kitten_33 true false true true)))) :pattern ((spoon_34 kitten_30 kitten_31 kitten_32)))))
(declare-sort potato_13 0)
(define-fun spoon_36 ((kitten_34 Float32)) Bool (and (spoon_1 kitten_34) (and (fp.leq (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)) kitten_34) (fp.leq kitten_34 (fp #b0 #b10000110 #b01101000000000000000000)))))
...
(define-fun spoon_43 ((kitten_36 Float32)) Bool (and (spoon_1 kitten_36) (and (fp.leq (fp.neg (fp #b0 #b10001100 #b00000000000000000000000)) kitten_36) (fp.leq kitten_36 (fp #b0 #b10001100 #b00000000000000000000000)))))
(declare-fun spoon_44 (potato_15 potato_15) Bool)
(declare-fun spoon_45 (Float32) potato_5)
(declare-fun spoon_46 (potato_5) Bool)
(declare-fun spoon_47 (potato_5) Float32)
...
(define-fun spoon_50 ((kitten_38 Float32) (kitten_39 Bool) (kitten_40 Bool) (kitten_41 Bool) (kitten_42 Bool)) Bool (=> (or (= kitten_39 true) (fp.leq (fp.neg (fp #b0 #b10001100 #b00000000000000000000000)) (fp #b0 #b10001100 #b00000000000000000000000))) (spoon_43 kitten_38)))
...
(define-fun spoon_56 ((kitten_43 Float32) (kitten_44 Bool) (kitten_45 Bool) (kitten_46 Bool) (kitten_47 Bool)) Bool (=> (or (= kitten_44 true) (fp.leq (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)) (fp #b0 #b10000110 #b01101000000000000000000))) (spoon_36 kitten_43)))
(declare-const cat_57 Float32)
(assert (spoon_43 cat_51))
(assert (spoon_43 cat_53))
(assert (or (not (fp.eq cat_51 (fp #b0 #b00000000 #b00000000000000000000000))) (not (fp.eq cat_53 (fp #b0 #b00000000 #b00000000000000000000000)))))
(assert (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)) (spoon_1 cat_57)))
(assert (not (or (not (fp.eq cat_53 (fp #b0 #b00000000 #b00000000000000000000000))) (not (fp.eq cat_51 (fp #b0 #b00000000 #b00000000000000000000000))))))
(check-sat)
(exit)
