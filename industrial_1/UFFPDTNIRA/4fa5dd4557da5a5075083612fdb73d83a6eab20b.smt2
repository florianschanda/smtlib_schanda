...
(assert (= cat_132 cat_114))
(assert (= cat_133 cat_115))
(assert (= cat_134 (mk_potato_23 cat_128 cat_129)))
(assert (and (= cat_130 (fp.add RNE (spoon_42 (get_potato_15_b (get_potato_17_a cat_79))) (spoon_75 (get_potato_23_b cat_134)))) (spoon_1 (fp.add RNE (spoon_42 (get_potato_15_b (get_potato_17_a cat_79))) (spoon_75 (get_potato_23_b cat_134))))))
(assert (= (spoon_42 cat_131) cat_130))
(assert (not (spoon_35 (fp.add RNE (spoon_42 (get_potato_15_a (get_potato_17_a cat_79))) (spoon_75 (get_potato_23_a cat_134))))))
(check-sat)
(exit)
