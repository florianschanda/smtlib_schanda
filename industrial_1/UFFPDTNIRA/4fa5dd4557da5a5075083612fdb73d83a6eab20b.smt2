...
(assert (and (= cat_137 (fp.add RNE (spoon_44 (get_potato_15_b (get_potato_17_a cat_81))) (spoon_77 (get_potato_23_b cat_158)))) (spoon_1 (fp.add RNE (spoon_44 (get_potato_15_b (get_potato_17_a cat_81))) (spoon_77 (get_potato_23_b cat_158))))))
(assert (= (spoon_44 cat_138) cat_137))
(assert (not (spoon_37 (fp.add RNE (spoon_44 (get_potato_15_a (get_potato_17_a cat_81))) (spoon_77 (get_potato_23_a cat_158))))))
(check-sat)
(exit)
