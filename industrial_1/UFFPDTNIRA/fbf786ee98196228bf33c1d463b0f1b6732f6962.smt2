...
(assert (= cat_146 (fp.sub RNE (spoon_30 (get_potato_13_a (get_potato_15_a cat_88))) (spoon_30 (get_potato_13_a (get_potato_15_a cat_86))))))
(assert (= cat_147 cat_134))
(assert (= cat_148 (fp.sub RNE (spoon_30 (get_potato_13_b (get_potato_15_a cat_88))) (spoon_30 (get_potato_13_b (get_potato_15_a cat_86))))))
(assert (= cat_149 cat_135))
(assert (= cat_150 (fp.add RNE (fp.mul RNE cat_146 cat_146) (fp.mul RNE cat_148 cat_148))))
(assert (not (fp.lt cat_150 (fp #b0 #b01110001 #b10100011011011100010111))))
(assert (= cat_151 cat_137))
(assert (= cat_152 (fp.add RNE (fp.mul RNE (fp.sub RNE (spoon_30 (get_potato_13_a (get_potato_15_a cat_84))) (spoon_30 (get_potato_13_a (get_potato_15_a cat_86)))) cat_146) (fp.mul RNE (fp.sub RNE (spoon_30 (get_potato_13_b (get_potato_15_a cat_84))) (spoon_30 (get_potato_13_b (get_potato_15_a cat_86)))) cat_148))))
(assert (and (= cat_141 (fp.div RNE cat_152 cat_150)) (spoon_1 (fp.div RNE cat_152 cat_150))))
(assert (and (= cat_142 cat_141) (spoon_1 cat_141)))
(assert (= cat_153 cat_139))
(assert (= cat_154 cat_142))
(assert (not (fp.leq cat_154 (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (not (fp.leq (fp #b0 #b01111111 #b00000000000000000000000) cat_154)))
(assert (= cat_155 cat_138))
(assert (= cat_156 (fp.add RNE (fp.mul RNE (fp.sub RNE (spoon_30 (get_potato_13_a (get_potato_15_a cat_84))) (spoon_30 (get_potato_13_a (get_potato_15_a cat_86)))) (fp.neg cat_148)) (fp.mul RNE (fp.sub RNE (spoon_30 (get_potato_13_b (get_potato_15_a cat_84))) (spoon_30 (get_potato_13_b (get_potato_15_a cat_86)))) cat_146))))
(assert (and (= cat_143 cat_150) (spoon_1 cat_150)))
(assert (and (= cat_144 (spoon_72 cat_143)) (spoon_64 cat_144)))
(assert (not (spoon_106 cat_144)))
(check-sat)
(exit)
