...
(assert (not (fp.eq cat_74 (fp.sub RNE (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) (spoon_36 (get_potato_13_b (get_potato_15_a cat_56)))) (spoon_36 (get_potato_13_b (get_potato_15_a cat_54)))))))
(check-sat)
(exit)
