...
(declare-const cat_260 potato_7)
(declare-const cat_261 Bool)
(declare-const cat_262 potato_19)
(declare-const cat_263 potato_18)
...
(define-fun spoon_292 () potato_11 (mk_potato_11 cat_211))
...
(assert (= cat_260 (mk_potato_7 cat_203)))
(assert (= cat_261 (spoon_37 1)))
(assert (= cat_262 (mk_potato_19 (mk_potato_18 cat_201 cat_202))))
(assert (= cat_263 (get_potato_20_a cat_85)))
(assert (= cat_264 (mk_potato_11 cat_206)))
(assert (= cat_265 (fp.mul RNE cat_181 cat_181)))
(assert (and (= cat_224 ((_ to_fp 11 53) RNE (fp.mul RNE cat_177 cat_177))) (spoon_2 ((_ to_fp 11 53) RNE (fp.mul RNE cat_177 cat_177)))))
(assert (= cat_266 (mk_potato_11 cat_204)))
(assert (= cat_267 cat_224))
(assert (and (= cat_225 ((_ to_fp 11 53) RNE (fp.mul RNE cat_179 cat_179))) (spoon_2 ((_ to_fp 11 53) RNE (fp.mul RNE cat_179 cat_179)))))
(assert (= cat_268 (mk_potato_11 cat_205)))
(assert (= cat_269 cat_225))
(assert (= cat_270 (mk_potato_11 cat_207)))
(assert (= cat_271 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_181)))
(assert (and (= cat_226 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_265)) (spoon_2 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_265))))
(assert (= cat_272 (mk_potato_11 cat_208)))
(assert (= cat_273 cat_226))
...
(assert (= cat_274 (mk_potato_11 cat_209)))
(assert (= cat_275 cat_229))
...
(assert (= cat_276 (mk_potato_11 cat_210)))
(assert (= cat_277 cat_232))
(assert (and (= cat_237 (fp.mul RNE cat_271 ((_ to_fp 11 53) RNE cat_179))) (spoon_2 (fp.mul RNE cat_271 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_238 (fp.mul RNE cat_237 cat_277)))
(assert (and (= cat_239 cat_238) (spoon_2 cat_238)))
(assert (and (= cat_233 (fp.sub RNE cat_273 cat_267)) (spoon_2 (fp.sub RNE cat_273 cat_267))))
(assert (= cat_234 (fp.sub RNE cat_233 cat_269)))
(assert (and (= cat_235 cat_234) (spoon_2 cat_234)))
(assert (= cat_236 (fp.mul RNE cat_235 cat_275)))
...
(assert (= cat_279 cat_242))
(assert (and (= cat_243 (fp.add RNE cat_273 cat_267)) (spoon_2 (fp.add RNE cat_273 cat_267))))
(assert (= cat_244 (fp.add RNE cat_243 cat_269)))
(assert (and (= cat_245 cat_244) (spoon_2 cat_244)))
(assert (= cat_280 (mk_potato_11 cat_214)))
(assert (= cat_281 cat_245))
(assert (and (= cat_246 (fp.div RNE cat_279 cat_281)) (spoon_2 (fp.div RNE cat_279 cat_281))))
(assert (= cat_282 (mk_potato_11 cat_212)))
(assert (= cat_283 cat_246))
(assert (=> (fp.lt cat_283 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))) (= cat_284 spoon_292)))
(assert (=> (fp.lt cat_283 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))) (= cat_285 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))))
(assert (=> (not (fp.lt cat_283 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_283) (= cat_286 spoon_292))))
(assert (=> (not (fp.lt cat_283 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_283) (= cat_287 (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))))
(assert (=> (not (fp.lt cat_283 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_283)) (and (= cat_247 cat_283) (spoon_2 cat_283)))))
(assert (=> (not (fp.lt cat_283 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_283)) (= cat_288 spoon_292))))
(assert (=> (not (fp.lt cat_283 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_283)) (= cat_289 cat_247))))
(assert (=> (not (fp.lt cat_283 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_283)) (= cat_287 cat_289))))
(assert (=> (not (fp.lt cat_283 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (= cat_285 cat_287)))
(assert (and (= cat_248 (fp.mul RNE cat_271 ((_ to_fp 11 53) RNE cat_177))) (spoon_2 (fp.mul RNE cat_271 ((_ to_fp 11 53) RNE cat_177)))))
(assert (= cat_290 (mk_potato_11 cat_216)))
(assert (= cat_291 cat_248))
(assert (and (= cat_253 (fp.mul RNE cat_271 ((_ to_fp 11 53) RNE cat_179))) (spoon_2 (fp.mul RNE cat_271 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_254 (fp.mul RNE cat_253 cat_275)))
(assert (and (= cat_255 cat_254) (spoon_2 cat_254)))
(assert (and (= cat_249 (fp.sub RNE cat_273 cat_267)) (spoon_2 (fp.sub RNE cat_273 cat_267))))
(assert (= cat_250 (fp.sub RNE cat_249 cat_269)))
(assert (and (= cat_251 cat_250) (spoon_2 cat_250)))
(assert (= cat_252 (fp.mul RNE cat_251 cat_277)))
(assert (and (= cat_256 cat_252) (spoon_2 cat_252)))
(assert (= cat_257 (fp.sub RNE cat_256 cat_255)))
(assert (not (spoon_2 cat_257)))
(check-sat)
(exit)
