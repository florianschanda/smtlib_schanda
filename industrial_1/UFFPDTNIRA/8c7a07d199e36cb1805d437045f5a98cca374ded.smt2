...
(declare-const cat_266 potato_19)
(declare-const cat_267 potato_18)
...
(define-fun spoon_296 () potato_11 (mk_potato_11 cat_215))
...
(assert (= cat_264 (mk_potato_7 cat_207)))
(assert (= cat_265 (spoon_41 1)))
(assert (= cat_266 (mk_potato_19 (mk_potato_18 cat_205 cat_206))))
(assert (= cat_267 (get_potato_20_a cat_89)))
(assert (= cat_268 (mk_potato_11 cat_210)))
(assert (= cat_269 (fp.mul RNE cat_185 cat_185)))
(assert (and (= cat_228 ((_ to_fp 11 53) RNE (fp.mul RNE cat_181 cat_181))) (spoon_3 ((_ to_fp 11 53) RNE (fp.mul RNE cat_181 cat_181)))))
(assert (= cat_270 (mk_potato_11 cat_208)))
(assert (= cat_271 cat_228))
(assert (and (= cat_229 ((_ to_fp 11 53) RNE (fp.mul RNE cat_183 cat_183))) (spoon_3 ((_ to_fp 11 53) RNE (fp.mul RNE cat_183 cat_183)))))
(assert (= cat_272 (mk_potato_11 cat_209)))
(assert (= cat_273 cat_229))
(assert (= cat_274 (mk_potato_11 cat_211)))
(assert (= cat_275 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_185)))
(assert (and (= cat_230 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_269)) (spoon_3 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_269))))
(assert (= cat_276 (mk_potato_11 cat_212)))
...
(assert (= cat_278 (mk_potato_11 cat_213)))
...
(assert (= cat_280 (mk_potato_11 cat_214)))
(assert (= cat_281 cat_236))
(assert (and (= cat_241 (fp.mul RNE cat_275 ((_ to_fp 11 53) RNE cat_183))) (spoon_3 (fp.mul RNE cat_275 ((_ to_fp 11 53) RNE cat_183)))))
(assert (= cat_242 (fp.mul RNE cat_241 cat_281)))
(assert (and (= cat_243 cat_242) (spoon_3 cat_242)))
(assert (and (= cat_237 (fp.sub RNE cat_277 cat_271)) (spoon_3 (fp.sub RNE cat_277 cat_271))))
(assert (= cat_238 (fp.sub RNE cat_237 cat_273)))
(assert (and (= cat_239 cat_238) (spoon_3 cat_238)))
(assert (= cat_240 (fp.mul RNE cat_239 cat_279)))
...
(assert (= cat_282 (mk_potato_11 cat_217)))
(assert (= cat_283 cat_246))
(assert (and (= cat_247 (fp.add RNE cat_277 cat_271)) (spoon_3 (fp.add RNE cat_277 cat_271))))
(assert (= cat_248 (fp.add RNE cat_247 cat_273)))
(assert (and (= cat_249 cat_248) (spoon_3 cat_248)))
(assert (= cat_284 (mk_potato_11 cat_218)))
(assert (= cat_285 cat_249))
(assert (and (= cat_250 (fp.div RNE cat_283 cat_285)) (spoon_3 (fp.div RNE cat_283 cat_285))))
(assert (= cat_286 (mk_potato_11 cat_216)))
(assert (= cat_287 cat_250))
(assert (=> (fp.lt cat_287 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))) (= cat_288 spoon_296)))
(assert (=> (fp.lt cat_287 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))) (= cat_289 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))))
(assert (=> (not (fp.lt cat_287 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_287) (= cat_290 spoon_296))))
(assert (=> (not (fp.lt cat_287 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_287) (= cat_291 (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))))
(assert (=> (not (fp.lt cat_287 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_287)) (and (= cat_251 cat_287) (spoon_3 cat_287)))))
(assert (=> (not (fp.lt cat_287 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_287)) (= cat_292 spoon_296))))
(assert (=> (not (fp.lt cat_287 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_287)) (= cat_293 cat_251))))
(assert (=> (not (fp.lt cat_287 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_287)) (= cat_291 cat_293))))
(assert (=> (not (fp.lt cat_287 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (= cat_289 cat_291)))
(assert (and (= cat_252 (fp.mul RNE cat_275 ((_ to_fp 11 53) RNE cat_181))) (spoon_3 (fp.mul RNE cat_275 ((_ to_fp 11 53) RNE cat_181)))))
(assert (= cat_294 (mk_potato_11 cat_220)))
(assert (= cat_295 cat_252))
(assert (and (= cat_257 (fp.mul RNE cat_275 ((_ to_fp 11 53) RNE cat_183))) (spoon_3 (fp.mul RNE cat_275 ((_ to_fp 11 53) RNE cat_183)))))
(assert (= cat_258 (fp.mul RNE cat_257 cat_279)))
(assert (and (= cat_259 cat_258) (spoon_3 cat_258)))
(assert (and (= cat_253 (fp.sub RNE cat_277 cat_271)) (spoon_3 (fp.sub RNE cat_277 cat_271))))
(assert (= cat_254 (fp.sub RNE cat_253 cat_273)))
(assert (and (= cat_255 cat_254) (spoon_3 cat_254)))
(assert (= cat_256 (fp.mul RNE cat_255 cat_281)))
