...
(define-fun spoon_253 () potato_10 (mk_potato_10 cat_160))
(define-fun spoon_254 () potato_10 (mk_potato_10 cat_158))
(define-fun spoon_255 () potato_10 (mk_potato_10 cat_144))
...
(assert (= cat_183 (mk_potato_30 (mk_potato_29 cat_147 cat_148))))
(assert (= cat_184 (get_potato_31_a cat_166)))
...
(assert (= cat_186 (get_potato_31_a cat_170)))
...
(assert (= cat_188 (get_potato_31_a cat_174)))
(assert (and (= cat_175 (spoon_124 (mk_potato_31 cat_184) (mk_potato_31 cat_184))) (and (spoon_92 cat_175) (= cat_175 (fp.add RNE (fp.mul RNE (spoon_69 (get_potato_29_a cat_184)) (spoon_69 (get_potato_29_a cat_184))) (fp.mul RNE (spoon_69 (get_potato_29_b cat_184)) (spoon_69 (get_potato_29_b cat_184))))))))
(assert (= cat_189 (mk_potato_10 cat_153)))
(assert (= cat_190 cat_175))
(assert (and (= cat_176 (spoon_124 (mk_potato_31 cat_184) (mk_potato_31 cat_186))) (and (spoon_92 cat_176) (= cat_176 (fp.add RNE (fp.mul RNE (spoon_69 (get_potato_29_a cat_184)) (spoon_69 (get_potato_29_a cat_186))) (fp.mul RNE (spoon_69 (get_potato_29_b cat_184)) (spoon_69 (get_potato_29_b cat_186))))))))
(assert (= cat_191 (mk_potato_10 cat_154)))
(assert (= cat_192 cat_176))
(assert (and (= cat_177 (spoon_124 (mk_potato_31 cat_186) (mk_potato_31 cat_186))) (and (spoon_92 cat_177) (= cat_177 (fp.add RNE (fp.mul RNE (spoon_69 (get_potato_29_a cat_186)) (spoon_69 (get_potato_29_a cat_186))) (fp.mul RNE (spoon_69 (get_potato_29_b cat_186)) (spoon_69 (get_potato_29_b cat_186))))))))
(assert (= cat_193 (mk_potato_10 cat_155)))
(assert (= cat_194 cat_177))
(assert (and (= cat_178 (spoon_124 (mk_potato_31 cat_184) (mk_potato_31 cat_188))) (and (spoon_92 cat_178) (= cat_178 (fp.add RNE (fp.mul RNE (spoon_69 (get_potato_29_a cat_184)) (spoon_69 (get_potato_29_a cat_188))) (fp.mul RNE (spoon_69 (get_potato_29_b cat_184)) (spoon_69 (get_potato_29_b cat_188))))))))
(assert (= cat_195 (mk_potato_10 cat_156)))
(assert (= cat_196 cat_178))
(assert (and (= cat_179 (spoon_124 (mk_potato_31 cat_186) (mk_potato_31 cat_188))) (and (spoon_92 cat_179) (= cat_179 (fp.add RNE (fp.mul RNE (spoon_69 (get_potato_29_a cat_186)) (spoon_69 (get_potato_29_a cat_188))) (fp.mul RNE (spoon_69 (get_potato_29_b cat_186)) (spoon_69 (get_potato_29_b cat_188))))))))
(assert (= cat_197 (mk_potato_10 cat_157)))
(assert (= cat_198 cat_179))
(assert (= cat_199 (mk_potato_10 cat_162)))
(assert (= cat_200 (fp.sub RNE (fp.mul RNE cat_190 cat_194) (fp.mul RNE cat_192 cat_192))))
(assert (= cat_201 (mk_potato_10 cat_159)))
(assert (= cat_202 cat_200))
(assert (= cat_203 (mk_potato_10 cat_161)))
(assert (= cat_204 cat_200))
(assert (=> (fp.lt cat_200 (fp #b0 #b01101011 #b00001100011011110111101)) (= cat_205 spoon_254)))
...
(assert (=> (fp.lt cat_200 (fp #b0 #b01101011 #b00001100011011110111101)) (= cat_209 spoon_253)))
...
(assert (=> (not (fp.lt cat_200 (fp #b0 #b01101011 #b00001100011011110111101))) (= cat_213 spoon_254)))
...
(assert (=> (not (fp.lt cat_200 (fp #b0 #b01101011 #b00001100011011110111101))) (= cat_215 spoon_253)))
...
(assert (=> (fp.lt cat_238 (fp #b0 #b01101011 #b00001100011011110111101)) (= cat_249 spoon_255)))
(assert (=> (fp.lt cat_238 (fp #b0 #b01101011 #b00001100011011110111101)) (= cat_250 (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (=> (not (fp.lt cat_238 (fp #b0 #b01101011 #b00001100011011110111101))) (and (= cat_180 (fp.div RNE cat_232 cat_238)) (spoon_1 (fp.div RNE cat_232 cat_238)))))
(assert (=> (not (fp.lt cat_238 (fp #b0 #b01101011 #b00001100011011110111101))) (and (= cat_181 cat_180) (spoon_1 cat_180))))
(assert (=> (not (fp.lt cat_238 (fp #b0 #b01101011 #b00001100011011110111101))) (= cat_251 spoon_255)))
(assert (=> (not (fp.lt cat_238 (fp #b0 #b01101011 #b00001100011011110111101))) (= cat_252 cat_181)))
(assert (=> (not (fp.lt cat_238 (fp #b0 #b01101011 #b00001100011011110111101))) (= cat_250 cat_252)))
(assert (not (fp.lt cat_212 (fp #b0 #b01101011 #b00001100011011110111101))))
(assert (and (= cat_182 (fp.div RNE cat_230 cat_212)) (spoon_1 (fp.div RNE cat_230 cat_212))))
(assert (not (spoon_71 cat_182)))
(check-sat)
(exit)
