...
(assert (= cat_224 cat_178))
(assert (= cat_225 cat_192))
...
(assert (= cat_226 cat_177))
(assert (= cat_227 cat_193))
(assert (and (= cat_194 (spoon_60 (spoon_86 (get_potato_22_a (get_potato_24_a cat_154))))) (spoon_42 cat_194)))
(assert (= cat_228 cat_179))
(assert (= cat_229 cat_194))
(assert (and (= cat_195 (spoon_40 cat_225)) (spoon_50 cat_195)))
(assert (= cat_196 ((_ to_fp 11 53) RNE cat_195)))
(assert (= cat_230 cat_180))
(assert (= cat_231 cat_196))
(assert (and (= cat_197 (spoon_58 cat_225)) (spoon_50 cat_197)))
(assert (= cat_198 ((_ to_fp 11 53) RNE cat_197)))
(assert (= cat_232 cat_181))
(assert (= cat_233 cat_198))
(assert (and (= cat_199 (spoon_40 cat_229)) (spoon_50 cat_199)))
(assert (= cat_200 ((_ to_fp 11 53) RNE cat_199)))
(assert (= cat_234 (mk_potato_11 cat_182)))
(assert (= cat_235 cat_200))
(assert (and (= cat_201 (spoon_58 cat_229)) (spoon_50 cat_201)))
(assert (= cat_202 ((_ to_fp 11 53) RNE cat_201)))
(assert (= cat_236 (mk_potato_11 cat_183)))
(assert (= cat_237 cat_202))
(assert (and (= cat_203 (spoon_40 cat_227)) (spoon_50 cat_203)))
(assert (= cat_204 ((_ to_fp 11 53) RNE cat_203)))
(assert (= cat_238 (mk_potato_11 cat_184)))
(assert (= cat_239 cat_204))
(assert (and (= cat_205 (spoon_58 cat_227)) (spoon_50 cat_205)))
(assert (= cat_206 ((_ to_fp 11 53) RNE cat_205)))
(assert (= cat_240 (mk_potato_11 cat_185)))
(assert (= cat_241 cat_206))
(assert (and (= cat_209 (fp.mul RNE cat_233 cat_237)) (spoon_3 (fp.mul RNE cat_233 cat_237))))
(assert (= cat_210 (fp.mul RNE cat_209 cat_241)))
(assert (and (= cat_211 cat_210) (spoon_3 cat_210)))
(assert (and (= cat_207 (fp.mul RNE cat_231 cat_235)) (spoon_3 (fp.mul RNE cat_231 cat_235))))
...
(assert (= cat_242 (mk_potato_11 cat_188)))
(assert (= cat_243 cat_214))
(assert (and (= cat_215 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_156) cat_239)) (spoon_3 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_156) cat_239))))
(assert (= cat_216 (fp.mul RNE cat_215 cat_233)))
(assert (and (= cat_217 cat_216) (spoon_3 cat_216)))
(assert (= cat_244 (mk_potato_11 cat_189)))
(assert (= cat_245 cat_217))
(assert (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_243)))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_243) (and (= cat_221 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_243)) (spoon_3 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_243)))))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_243) (= cat_222 (ite (fp.leq cat_245 cat_221) true false))))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_243) (and (= cat_220 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_243)) (spoon_3 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_243)))))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_243) (= cat_223 (ite (fp.leq cat_220 cat_245) true false))))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_243) (= cat_246 (ite (= cat_223 true) cat_222 false))))
(assert (=> (not (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_243)) (= cat_246 false)))
(assert (not (= cat_246 true)))
(assert (fp.lt cat_243 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)))
(assert (and (= cat_218 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_243)) (spoon_3 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_243))))
(assert (= cat_219 (ite (fp.leq cat_245 cat_218) true false)))
(assert (not (spoon_3 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_243))))
(check-sat)
(exit)
