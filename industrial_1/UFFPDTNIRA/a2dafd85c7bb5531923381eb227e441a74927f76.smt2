...
(declare-fun cat_248 () potato_7)
(declare-fun cat_249 () Bool)
(declare-fun cat_250 () potato_29)
(declare-fun cat_251 () potato_28)
...
(assert (= cat_247 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
(assert (spoon_100 cat_247))
...
(assert (= cat_249 (distinct 1 0)))
(assert (= cat_250 (mk_potato_29 (mk_potato_28 cat_201 cat_202))))
(assert (= cat_251 (get_potato_30_a cat_138)))
(assert (= cat_252 (mk_potato_11 cat_206)))
(assert (= cat_253 (fp.mul roundNearestTiesToEven cat_181 cat_181)))
...
(assert (= cat_259 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1025 11) (_ bv0 52)) cat_181)))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1025 11) (_ bv0 52)) cat_253))) (and (= cat_226 _let_0) (spoon_3 _let_0))))
...
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_259 ((_ to_fp 11 53) roundNearestTiesToEven cat_179)))) (and (= cat_237 _let_0) (spoon_3 _let_0))))
(assert (= cat_238 (fp.mul roundNearestTiesToEven cat_237 cat_265)))
(assert (and (= cat_239 cat_238) (spoon_3 cat_238)))
(assert (let ((_let_0 (fp.sub roundNearestTiesToEven cat_261 cat_255))) (and (= cat_233 _let_0) (spoon_3 _let_0))))
(assert (= cat_234 (fp.sub roundNearestTiesToEven cat_233 cat_257)))
(assert (and (= cat_235 cat_234) (spoon_3 cat_234)))
(assert (= cat_236 (fp.mul roundNearestTiesToEven cat_235 cat_263)))
...
(assert (let ((_let_0 (fp.add roundNearestTiesToEven cat_261 cat_255))) (and (= cat_243 _let_0) (spoon_3 _let_0))))
(assert (= cat_244 (fp.add roundNearestTiesToEven cat_243 cat_257)))
(assert (and (= cat_245 cat_244) (spoon_3 cat_244)))
(assert (= cat_268 (mk_potato_11 cat_214)))
(assert (= cat_269 cat_245))
(assert (not (spoon_3 (fp.div roundNearestTiesToEven cat_267 cat_269))))
(check-sat)
(exit)
