...
(declare-const cat_250 potato_29)
(declare-const cat_251 potato_28)
...
(assert (and (= cat_226 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_253)) (spoon_3 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_253))))
...
(assert (and (= cat_237 (fp.mul RNE cat_259 ((_ to_fp 11 53) RNE cat_179))) (spoon_3 (fp.mul RNE cat_259 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_238 (fp.mul RNE cat_237 cat_265)))
(assert (and (= cat_239 cat_238) (spoon_3 cat_238)))
(assert (and (= cat_233 (fp.sub RNE cat_261 cat_255)) (spoon_3 (fp.sub RNE cat_261 cat_255))))
...
(assert (and (= cat_243 (fp.add RNE cat_261 cat_255)) (spoon_3 (fp.add RNE cat_261 cat_255))))
...
(assert (not (spoon_3 (fp.div RNE cat_267 cat_269))))
(check-sat)
(exit)
