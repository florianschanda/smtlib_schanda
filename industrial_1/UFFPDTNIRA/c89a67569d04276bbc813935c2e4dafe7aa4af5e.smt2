...
(assert (= cat_74 (fp.sub RNE (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) (spoon_36 (get_potato_13_a (get_potato_15_a cat_56)))) (spoon_36 (get_potato_13_a (get_potato_15_a cat_54))))))
(assert (= cat_75 cat_70))
(assert (= cat_76 (fp.sub RNE (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) (spoon_36 (get_potato_13_b (get_potato_15_a cat_56)))) (spoon_36 (get_potato_13_b (get_potato_15_a cat_54))))))
(assert (=> (=> (not (fp.lt cat_74 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_74)) (=> (not (fp.lt cat_76 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_76)))) (and (and (and (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) cat_77) (fp.leq cat_77 (fp #b0 #b10001011 #b00000000000000000000000))) (and (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) cat_78) (fp.leq cat_78 (fp #b0 #b10001011 #b00000000000000000000000)))) (and (spoon_58 cat_77) (spoon_58 cat_78)))))
...
(assert (and (= cat_71 cat_78) (spoon_1 cat_78)))
(assert (= (spoon_36 cat_72) cat_71))
(assert (not (spoon_29 cat_77)))
(check-sat)
(exit)
