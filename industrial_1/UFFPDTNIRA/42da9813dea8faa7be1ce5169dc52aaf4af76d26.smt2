...
(assert (and (= cat_114 (fp.div RNE (spoon_75 cat_111) cat_113)) (spoon_1 (fp.div RNE (spoon_75 cat_111) cat_113))))
(assert (= cat_115 (fp.mul RNE cat_114 cat_112)))
(assert (and (= cat_116 cat_115) (spoon_1 cat_115)))
(assert (and (= cat_117 cat_116) (spoon_1 cat_116)))
(assert (= (spoon_75 cat_118) cat_117))
(assert (not (spoon_1 (fp.div RNE (spoon_75 cat_110) cat_113))))
(check-sat)
(exit)
