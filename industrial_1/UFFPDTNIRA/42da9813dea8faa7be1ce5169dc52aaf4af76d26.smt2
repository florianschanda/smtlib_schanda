...
(assert (and (= cat_116 (fp.div RNE (spoon_77 cat_113) cat_115)) (spoon_1 (fp.div RNE (spoon_77 cat_113) cat_115))))
...
(assert (not (spoon_1 (fp.div RNE (spoon_77 cat_112) cat_115))))
(check-sat)
(exit)
