...
(assert (fp.lt (fp #b0 #b10000101 #b01101000000000000000000) (fp.add RNE (spoon_111 (get_potato_28_a cat_244)) cat_267)))
(assert (not (spoon_104 (fp.sub RNE (fp #b0 #b10000110 #b01101000000000000000000) (fp.add RNE (spoon_111 (get_potato_28_a cat_244)) cat_267)))))
(check-sat)
(exit)
