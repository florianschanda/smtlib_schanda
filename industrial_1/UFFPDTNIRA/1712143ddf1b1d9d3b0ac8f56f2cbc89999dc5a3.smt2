...
(declare-const cat_270 potato_11)
(declare-const cat_271 Float64)
(declare-const cat_272 Bool)
(declare-const cat_273 Bool)
...
(declare-const cat_284 potato_11)
(declare-const cat_285 Float64)
(declare-const cat_286 Bool)
(declare-const cat_287 Bool)
...
(assert (= cat_248 cat_181))
(assert (= cat_249 cat_195))
...
(assert (= cat_250 cat_180))
(assert (= cat_251 cat_196))
(assert (and (= cat_197 (spoon_137 (spoon_60 (get_potato_18_a (get_potato_20_a cat_141))))) (spoon_87 cat_197)))
(assert (= cat_252 cat_182))
(assert (= cat_253 cat_197))
(assert (and (= cat_198 (spoon_103 cat_249)) (spoon_95 cat_198)))
(assert (= cat_199 ((_ to_fp 11 53) RNE cat_198)))
(assert (= cat_254 cat_183))
(assert (= cat_255 cat_199))
(assert (and (= cat_200 (spoon_105 cat_249)) (spoon_95 cat_200)))
(assert (= cat_201 ((_ to_fp 11 53) RNE cat_200)))
(assert (= cat_256 cat_184))
(assert (= cat_257 cat_201))
(assert (and (= cat_202 (spoon_103 cat_253)) (spoon_95 cat_202)))
(assert (= cat_203 ((_ to_fp 11 53) RNE cat_202)))
(assert (= cat_258 (mk_potato_11 cat_185)))
(assert (= cat_259 cat_203))
(assert (and (= cat_204 (spoon_105 cat_253)) (spoon_95 cat_204)))
(assert (= cat_205 ((_ to_fp 11 53) RNE cat_204)))
(assert (= cat_260 (mk_potato_11 cat_186)))
(assert (= cat_261 cat_205))
(assert (and (= cat_206 (spoon_103 cat_251)) (spoon_95 cat_206)))
(assert (= cat_207 ((_ to_fp 11 53) RNE cat_206)))
(assert (= cat_262 (mk_potato_11 cat_187)))
(assert (= cat_263 cat_207))
(assert (and (= cat_208 (spoon_105 cat_251)) (spoon_95 cat_208)))
(assert (= cat_209 ((_ to_fp 11 53) RNE cat_208)))
(assert (= cat_264 (mk_potato_11 cat_188)))
(assert (= cat_265 cat_209))
(assert (and (= cat_212 (fp.mul RNE cat_257 cat_261)) (spoon_3 (fp.mul RNE cat_257 cat_261))))
(assert (= cat_213 (fp.mul RNE cat_212 cat_265)))
(assert (and (= cat_214 cat_213) (spoon_3 cat_213)))
(assert (and (= cat_210 (fp.mul RNE cat_255 cat_259)) (spoon_3 (fp.mul RNE cat_255 cat_259))))
...
(assert (= cat_266 (mk_potato_11 cat_191)))
(assert (= cat_267 cat_217))
(assert (and (= cat_218 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_145) cat_263)) (spoon_3 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_145) cat_263))))
(assert (= cat_219 (fp.mul RNE cat_218 cat_257)))
(assert (and (= cat_220 cat_219) (spoon_3 cat_219)))
(assert (= cat_268 (mk_potato_11 cat_192)))
(assert (= cat_269 cat_220))
(assert (=> (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_267) (and (= cat_221 (fp.div RNE cat_269 cat_267)) (spoon_3 (fp.div RNE cat_269 cat_267)))))
(assert (=> (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_267) (= cat_270 (mk_potato_11 cat_178))))
(assert (=> (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_267) (= cat_271 cat_221)))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_267)) (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_267) (and (= cat_227 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_267)) (spoon_3 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_267))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_267)) (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_267) (= cat_228 (ite (fp.leq cat_269 cat_227) true false)))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_267)) (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_267) (and (= cat_226 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_267)) (spoon_3 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_267))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_267)) (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_267) (= cat_229 (ite (fp.leq cat_226 cat_269) true false)))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_267)) (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_267) (= cat_273 (ite (= cat_229 true) cat_228 false)))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_267)) (=> (not (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_267)) (= cat_273 false))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_267)) (=> (= cat_273 true) (= cat_272 true))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_267)) (=> (not (= cat_273 true)) (=> (fp.lt cat_267 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (and (= cat_223 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_267)) (spoon_3 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_267)))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_267)) (=> (not (= cat_273 true)) (=> (fp.lt cat_267 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_224 (ite (fp.leq cat_269 cat_223) true false))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_267)) (=> (not (= cat_273 true)) (=> (fp.lt cat_267 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (and (= cat_222 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_267)) (spoon_3 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_267)))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_267)) (=> (not (= cat_273 true)) (=> (fp.lt cat_267 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_225 (ite (fp.leq cat_222 cat_269) true false))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_267)) (=> (not (= cat_273 true)) (=> (fp.lt cat_267 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_272 (ite (= cat_225 true) cat_224 false))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_267)) (=> (not (= cat_273 true)) (=> (not (fp.lt cat_267 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))) (= cat_272 false)))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_267)) (=> (= cat_272 true) (and (= cat_230 (fp.div RNE cat_269 cat_267)) (spoon_3 (fp.div RNE cat_269 cat_267))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_267)) (=> (= cat_272 true) (= cat_274 (mk_potato_11 cat_178)))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_267)) (=> (= cat_272 true) (= cat_275 cat_230))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_267)) (=> (not (= cat_272 true)) (=> (fp.lt cat_269 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_276 (mk_potato_11 cat_178))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_267)) (=> (not (= cat_272 true)) (=> (fp.lt cat_269 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_277 (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_267)) (=> (not (= cat_272 true)) (=> (not (fp.lt cat_269 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))) (= cat_278 (mk_potato_11 cat_178))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_267)) (=> (not (= cat_272 true)) (=> (not (fp.lt cat_269 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))) (= cat_279 (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111))))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_267)) (=> (not (= cat_272 true)) (=> (not (fp.lt cat_269 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))) (= cat_277 cat_279)))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_267)) (=> (not (= cat_272 true)) (= cat_275 cat_277))))
(assert (=> (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_267)) (= cat_271 cat_275)))
(assert (and (= cat_231 (fp.mul RNE cat_255 cat_261)) (spoon_3 (fp.mul RNE cat_255 cat_261))))
(assert (= cat_280 (mk_potato_11 cat_189)))
(assert (= cat_281 cat_231))
(assert (and (= cat_232 (fp.mul RNE cat_257 cat_259)) (spoon_3 (fp.mul RNE cat_257 cat_259))))
(assert (= cat_233 (fp.mul RNE cat_232 cat_265)))
(assert (and (= cat_234 cat_233) (spoon_3 cat_233)))
(assert (= cat_282 (mk_potato_11 cat_190)))
(assert (= cat_283 cat_234))
(assert (and (= cat_235 (fp.sub RNE cat_281 cat_283)) (spoon_3 (fp.sub RNE cat_281 cat_283))))
...
(assert (and (= cat_237 cat_236) (spoon_3 cat_236)))
(assert (= cat_284 (mk_potato_11 cat_193)))
(assert (= cat_285 cat_237))
(assert (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_267)))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_267) (and (= cat_244 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_267)) (spoon_3 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_267)))))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_267) (= cat_245 (ite (fp.leq cat_285 cat_244) true false))))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_267) (and (= cat_243 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_267)) (spoon_3 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_267)))))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_267) (= cat_246 (ite (fp.leq cat_243 cat_285) true false))))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_267) (= cat_287 (ite (= cat_246 true) cat_245 false))))
(assert (=> (not (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_267)) (= cat_287 false)))
(assert (=> (= cat_287 true) (= cat_286 true)))
(assert (=> (not (= cat_287 true)) (=> (fp.lt cat_267 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (and (= cat_240 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_267)) (spoon_3 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_267))))))
(assert (=> (not (= cat_287 true)) (=> (fp.lt cat_267 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_241 (ite (fp.leq cat_285 cat_240) true false)))))
(assert (=> (not (= cat_287 true)) (=> (fp.lt cat_267 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (and (= cat_239 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_267)) (spoon_3 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_267))))))
(assert (=> (not (= cat_287 true)) (=> (fp.lt cat_267 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_242 (ite (fp.leq cat_239 cat_285) true false)))))
(assert (=> (not (= cat_287 true)) (=> (fp.lt cat_267 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_286 (ite (= cat_242 true) cat_241 false)))))
(assert (=> (not (= cat_287 true)) (=> (not (fp.lt cat_267 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))) (= cat_286 false))))
(assert (= cat_286 true))
(assert (not (not (fp.isZero cat_267))))
(check-sat)
(exit)
