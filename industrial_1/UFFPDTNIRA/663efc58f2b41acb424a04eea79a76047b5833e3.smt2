...
(declare-const cat_263 potato_7)
(declare-const cat_264 Bool)
(declare-const cat_265 potato_25)
(declare-const cat_266 potato_24)
(declare-const cat_267 Bool)
(declare-const cat_268 Bool)
(declare-const cat_269 potato_24)
...
(assert (= cat_251 cat_204))
(assert (= cat_252 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_1 cat_252))
(assert (= cat_253 (mk_potato_10 cat_205)))
(assert (= cat_254 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_1 cat_254))
(assert (= cat_255 (mk_potato_10 cat_206)))
(assert (= cat_256 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_1 cat_256))
(assert (= cat_257 (mk_potato_10 cat_207)))
(assert (= cat_258 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_1 cat_258))
(assert (= cat_259 (mk_potato_10 cat_208)))
(assert (= cat_260 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_1 cat_260))
(assert (= cat_261 (mk_potato_10 cat_209)))
(assert (= cat_262 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_129 cat_262))
...
(assert (= cat_264 (spoon_37 1)))
(assert (= cat_265 (mk_potato_25 (mk_potato_24 cat_201 cat_202))))
(assert (= cat_266 (get_potato_26_a cat_111)))
(assert (= cat_225 (spoon_113 cat_167 cat_74)))
(assert (= cat_267 (ite (not (= cat_225 true)) true false)))
(assert (= cat_267 true))
(assert (=> (= cat_268 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_269))) (and (= cat_226 (spoon_149 (fp #b0 #b10000101 #b01100111111101011101000))) (spoon_129 cat_226)))))
(assert (=> (= cat_268 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_269))) (= cat_270 (mk_potato_10 cat_262)))))
(assert (=> (= cat_268 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_269))) (= cat_271 cat_226))))
(assert (=> (= cat_268 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_269)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_269)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (and (= cat_227 (spoon_149 (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (spoon_129 cat_227))))))
(assert (=> (= cat_268 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_269)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_269)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_272 (mk_potato_10 cat_262))))))
(assert (=> (= cat_268 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_269)))) (=> (fp.lt (spoon_84 (get_potato_24_a cat_269)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_273 cat_227)))))
(assert (=> (= cat_268 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_269)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_269)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_228 (spoon_84 (get_potato_24_a cat_269))) (spoon_1 (spoon_84 (get_potato_24_a cat_269))))))))
(assert (=> (= cat_268 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_269)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_269)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_229 (spoon_149 cat_228)) (spoon_129 cat_229))))))
(assert (=> (= cat_268 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_269)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_269)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_274 (mk_potato_10 cat_262))))))
(assert (=> (= cat_268 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_269)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_269)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_275 cat_229)))))
(assert (=> (= cat_268 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_269)))) (=> (not (fp.lt (spoon_84 (get_potato_24_a cat_269)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_273 cat_275)))))
(assert (=> (= cat_268 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_84 (get_potato_24_a cat_269)))) (= cat_271 cat_273))))
(assert (=> (= cat_268 true) (=> (spoon_189 cat_175) (and (= cat_230 (fp.mul RNE cat_175 cat_175)) (spoon_1 (fp.mul RNE cat_175 cat_175))))))
(assert (=> (= cat_268 true) (=> (spoon_189 cat_175) (= cat_276 (mk_potato_10 cat_260)))))
(assert (=> (= cat_268 true) (=> (spoon_189 cat_175) (= cat_277 cat_230))))
(assert (=> (= cat_268 true) (=> (spoon_189 cat_175) (= cat_279 cat_268))))
(assert (=> (= cat_268 true) (=> (not (spoon_189 cat_175)) (= cat_278 (mk_potato_7 cat_268)))))
(assert (=> (= cat_268 true) (=> (not (spoon_189 cat_175)) (= cat_279 (spoon_37 0)))))
(assert (=> (= cat_268 true) (=> (not (spoon_189 cat_175)) (= cat_277 cat_260))))
(assert (=> (= cat_268 true) (= cat_280 (mk_potato_10 cat_254))))
(assert (=> (= cat_268 true) (= cat_281 ((_ to_fp 8 24) RNE (fp.sub RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) (fp.mul RNE cat_171 cat_171))))))
(assert (=> (= cat_268 true) (and (= cat_231 cat_281) (spoon_1 cat_281))))
(assert (=> (= cat_268 true) (and (= cat_232 (spoon_146 cat_231)) (spoon_138 cat_232))))
(assert (=> (= cat_268 true) (= cat_282 (mk_potato_10 cat_252))))
(assert (=> (= cat_268 true) (= cat_283 cat_232)))
(assert (=> (not (= cat_268 true)) (= cat_271 cat_262)))
(assert (=> (not (= cat_268 true)) (= cat_277 cat_260)))
(assert (=> (not (= cat_268 true)) (= cat_281 cat_254)))
(assert (=> (not (= cat_268 true)) (= cat_283 cat_252)))
(assert (=> (not (= cat_268 true)) (= cat_279 cat_268)))
(assert (=> (= cat_279 true) (and (= cat_233 (fp.sub RNE cat_281 cat_277)) (spoon_1 (fp.sub RNE cat_281 cat_277)))))
(assert (=> (= cat_279 true) (= cat_234 (fp.add RNE cat_233 (fp.mul RNE cat_271 cat_271)))))
(assert (=> (= cat_279 true) (and (= cat_235 cat_234) (spoon_1 cat_234))))
(assert (=> (= cat_279 true) (= cat_284 (mk_potato_10 cat_258))))
(assert (=> (= cat_279 true) (= cat_285 cat_235)))
(assert (=> (= cat_279 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_285) (and (= cat_236 cat_285) (spoon_1 cat_285)))))
(assert (=> (= cat_279 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_285) (and (= cat_237 (spoon_146 cat_236)) (spoon_138 cat_237)))))
(assert (=> (= cat_279 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_285) (= cat_286 (mk_potato_10 cat_256)))))
(assert (=> (= cat_279 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_285) (= cat_287 cat_237))))
(assert (=> (= cat_279 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_285) (= cat_289 cat_279))))
(assert (=> (= cat_279 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_285)) (= cat_288 (mk_potato_7 cat_279)))))
(assert (=> (= cat_279 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_285)) (= cat_289 (spoon_37 0)))))
(assert (=> (= cat_279 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_285)) (= cat_287 cat_256))))
(assert (=> (not (= cat_279 true)) (= cat_285 cat_258)))
(assert (=> (not (= cat_279 true)) (= cat_287 cat_256)))
(assert (=> (not (= cat_279 true)) (= cat_289 cat_279)))
(assert (= cat_289 true))
(assert (and (= cat_242 (fp.mul RNE cat_287 cat_175)) (spoon_1 (fp.mul RNE cat_287 cat_175))))
(assert (and (= cat_238 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_171 cat_171)) cat_277)) (spoon_1 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_171 cat_171)) cat_277))))
(assert (= cat_239 (fp.mul RNE cat_283 cat_238)))
(assert (and (= cat_240 cat_239) (spoon_1 cat_239)))
(assert (= cat_241 (fp.mul RNE cat_240 cat_271)))
...
(assert (= cat_290 (mk_potato_10 cat_211)))
(assert (= cat_291 cat_245))
(assert (and (= cat_246 (fp.mul RNE cat_287 cat_175)) (spoon_1 (fp.mul RNE cat_287 cat_175))))
(assert (= cat_247 (fp.mul RNE cat_246 cat_271)))
(assert (and (= cat_248 cat_247) (spoon_1 cat_247)))
(assert (and (= cat_249 (fp.mul RNE cat_283 cat_285)) (spoon_1 (fp.mul RNE cat_283 cat_285))))
(assert (= cat_250 (fp.sub RNE cat_249 cat_248)))
(assert (not (spoon_1 cat_250)))
(check-sat)
(exit)
