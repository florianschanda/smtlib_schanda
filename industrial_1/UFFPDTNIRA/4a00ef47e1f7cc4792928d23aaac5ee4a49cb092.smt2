...
(assert (fp.lt cat_114 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000))))
(assert (= cat_114 cat_119))
(assert (= cat_120 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000))))
(assert (and (= cat_86 (fp.div RNE (fp.sub RNE cat_120 (spoon_44 (get_potato_15_b (get_potato_17_a cat_62)))) cat_110)) (spoon_1 (fp.div RNE (fp.sub RNE cat_120 (spoon_44 (get_potato_15_b (get_potato_17_a cat_62)))) cat_110))))
