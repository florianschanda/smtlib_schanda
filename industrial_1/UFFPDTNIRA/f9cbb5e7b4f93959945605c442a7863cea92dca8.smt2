...
(declare-const cat_216 Bool)
(declare-const cat_217 Bool)
(declare-const cat_218 potato_28)
...
(declare-const cat_235 potato_7)
...
(assert (= cat_214 (fp #b0 #b00000000 #b00000000000000000000000)))
...
(assert (= cat_216 true))
(assert (=> (= cat_217 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_218))) (and (= cat_201 (spoon_76 (fp #b0 #b10000101 #b01100111111101011101000))) (spoon_86 cat_201)))))
(assert (=> (= cat_217 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_218))) (= cat_219 (mk_potato_10 cat_215)))))
(assert (=> (= cat_217 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_218))) (= cat_220 cat_201))))
(assert (=> (= cat_217 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_218)))) (=> (fp.lt (spoon_111 (get_potato_28_a cat_218)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (and (= cat_202 (spoon_76 (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (spoon_86 cat_202))))))
(assert (=> (= cat_217 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_218)))) (=> (fp.lt (spoon_111 (get_potato_28_a cat_218)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_221 (mk_potato_10 cat_215))))))
(assert (=> (= cat_217 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_218)))) (=> (fp.lt (spoon_111 (get_potato_28_a cat_218)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_222 cat_202)))))
(assert (=> (= cat_217 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_218)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_218)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_203 (spoon_111 (get_potato_28_a cat_218))) (spoon_1 (spoon_111 (get_potato_28_a cat_218))))))))
(assert (=> (= cat_217 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_218)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_218)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_204 (spoon_76 cat_203)) (spoon_86 cat_204))))))
(assert (=> (= cat_217 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_218)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_218)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_223 (mk_potato_10 cat_215))))))
(assert (=> (= cat_217 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_218)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_218)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_224 cat_204)))))
(assert (=> (= cat_217 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_218)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_218)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_222 cat_224)))))
(assert (=> (= cat_217 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_218)))) (= cat_220 cat_222))))
(assert (=> (= cat_217 true) (= cat_225 (mk_potato_10 cat_214))))
(assert (=> (= cat_217 true) (= cat_226 (fp.mul RNE cat_170 cat_170))))
(assert (=> (= cat_217 true) (= cat_227 (mk_potato_10 cat_211))))
(assert (=> (= cat_217 true) (= cat_228 ((_ to_fp 8 24) RNE (fp.sub RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) (fp.mul RNE cat_166 cat_166))))))
(assert (=> (= cat_217 true) (= cat_229 (mk_potato_10 cat_210))))
(assert (=> (= cat_217 true) (= cat_230 (fp.sqrt RNE cat_228))))
...
(assert (=> (= cat_217 true) (and (= cat_205 (fp.sub RNE cat_228 cat_226)) (spoon_1 (fp.sub RNE cat_228 cat_226)))))
(assert (=> (= cat_217 true) (= cat_206 (fp.add RNE cat_205 (fp.mul RNE cat_220 cat_220)))))
...
(assert (=> (= cat_217 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_232) (= cat_233 (mk_potato_10 cat_212)))))
(assert (=> (= cat_217 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_232) (= cat_234 (fp.sqrt RNE cat_232)))))
(assert (=> (= cat_217 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_232) (= cat_236 cat_217))))
(assert (=> (= cat_217 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_232)) (= cat_235 (mk_potato_7 cat_217)))))
(assert (=> (= cat_217 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_232)) (= cat_236 (distinct 0 0)))))
(assert (=> (= cat_217 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_232)) (= cat_234 cat_212))))
(assert (=> (not (= cat_217 true)) (= cat_232 cat_213)))
(assert (=> (not (= cat_217 true)) (= cat_234 cat_212)))
(assert (=> (not (= cat_217 true)) (= cat_236 cat_217)))
(assert (= cat_236 true))
(assert (spoon_1 (fp.mul RNE cat_234 cat_170)))
(assert (= cat_208 (fp.mul RNE cat_230 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_166 cat_166)) cat_226))))
(assert (spoon_1 (fp.mul RNE cat_230 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_166 cat_166)) cat_226))))
(assert (= cat_209 (fp.mul RNE cat_208 cat_220)))
