...
(assert (= cat_207 cat_178))
(assert (= cat_208 cat_192))
...
(assert (= cat_209 cat_177))
(assert (= cat_210 cat_193))
(assert (and (= cat_194 (spoon_60 (spoon_86 (get_potato_22_a (get_potato_24_a cat_154))))) (spoon_42 cat_194)))
(assert (= cat_211 cat_179))
(assert (= cat_212 cat_194))
(assert (and (= cat_195 (spoon_40 cat_208)) (spoon_50 cat_195)))
(assert (= cat_196 ((_ to_fp 11 53) roundNearestTiesToEven cat_195)))
(assert (= cat_213 cat_180))
(assert (= cat_214 cat_196))
(assert (and (= cat_197 (spoon_58 cat_208)) (spoon_50 cat_197)))
(assert (= cat_198 ((_ to_fp 11 53) roundNearestTiesToEven cat_197)))
(assert (= cat_215 cat_181))
(assert (= cat_216 cat_198))
(assert (and (= cat_199 (spoon_40 cat_212)) (spoon_50 cat_199)))
(assert (= cat_200 ((_ to_fp 11 53) roundNearestTiesToEven cat_199)))
(assert (= cat_217 (mk_potato_11 cat_182)))
(assert (= cat_218 cat_200))
(assert (and (= cat_201 (spoon_58 cat_212)) (spoon_50 cat_201)))
(assert (= cat_202 ((_ to_fp 11 53) roundNearestTiesToEven cat_201)))
(assert (= cat_219 (mk_potato_11 cat_183)))
(assert (= cat_220 cat_202))
(assert (and (= cat_203 (spoon_40 cat_210)) (spoon_50 cat_203)))
(assert (= cat_204 ((_ to_fp 11 53) roundNearestTiesToEven cat_203)))
(assert (= cat_221 (mk_potato_11 cat_184)))
(assert (= cat_222 cat_204))
(assert (and (= cat_205 (spoon_58 cat_210)) (spoon_50 cat_205)))
(assert (= cat_206 ((_ to_fp 11 53) roundNearestTiesToEven cat_205)))
(assert (= cat_223 (mk_potato_11 cat_185)))
(assert (= cat_224 cat_206))
(assert (not (spoon_3 (fp.mul roundNearestTiesToEven cat_216 cat_220))))
(check-sat)
(exit)
