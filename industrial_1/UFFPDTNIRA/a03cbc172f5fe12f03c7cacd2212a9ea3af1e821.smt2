...
(declare-const cat_214 Bool)
(declare-const cat_215 Bool)
(declare-const cat_216 potato_28)
...
(declare-const cat_233 potato_7)
(declare-const cat_234 Bool)
...
(assert (= cat_208 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_1 cat_208))
(assert (= cat_209 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_1 cat_209))
(assert (= cat_210 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_1 cat_210))
(assert (= cat_211 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_1 cat_211))
(assert (= cat_212 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_154 cat_212))
(assert (= cat_213 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (spoon_86 cat_213))
...
(assert (= cat_214 (ite (not (= cat_200 true)) true false)))
(assert (= cat_214 true))
(assert (=> (= cat_215 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_216))) (and (= cat_201 (spoon_76 (fp #b0 #b10000101 #b01100111111101011101000))) (spoon_86 cat_201)))))
(assert (=> (= cat_215 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_216))) (= cat_217 (mk_potato_10 cat_213)))))
(assert (=> (= cat_215 true) (=> (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_216))) (= cat_218 cat_201))))
(assert (=> (= cat_215 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_216)))) (=> (fp.lt (spoon_111 (get_potato_28_a cat_216)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (and (= cat_202 (spoon_76 (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (spoon_86 cat_202))))))
(assert (=> (= cat_215 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_216)))) (=> (fp.lt (spoon_111 (get_potato_28_a cat_216)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_219 (mk_potato_10 cat_213))))))
(assert (=> (= cat_215 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_216)))) (=> (fp.lt (spoon_111 (get_potato_28_a cat_216)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000))) (= cat_220 cat_202)))))
(assert (=> (= cat_215 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_216)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_216)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_203 (spoon_111 (get_potato_28_a cat_216))) (spoon_1 (spoon_111 (get_potato_28_a cat_216))))))))
(assert (=> (= cat_215 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_216)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_216)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (and (= cat_204 (spoon_76 cat_203)) (spoon_86 cat_204))))))
(assert (=> (= cat_215 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_216)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_216)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_221 (mk_potato_10 cat_213))))))
(assert (=> (= cat_215 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_216)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_216)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_222 cat_204)))))
(assert (=> (= cat_215 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_216)))) (=> (not (fp.lt (spoon_111 (get_potato_28_a cat_216)) (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)))) (= cat_220 cat_222)))))
(assert (=> (= cat_215 true) (=> (not (fp.lt (fp #b0 #b10000101 #b01100111111101011101000) (spoon_111 (get_potato_28_a cat_216)))) (= cat_218 cat_220))))
(assert (=> (= cat_215 true) (= cat_223 (mk_potato_10 cat_212))))
(assert (=> (= cat_215 true) (= cat_224 (fp.mul RNE cat_170 cat_170))))
(assert (=> (= cat_215 true) (= cat_225 (mk_potato_10 cat_209))))
(assert (=> (= cat_215 true) (= cat_226 ((_ to_fp 8 24) RNE (fp.sub RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) (fp.mul RNE cat_166 cat_166))))))
(assert (=> (= cat_215 true) (= cat_227 (mk_potato_10 cat_208))))
(assert (=> (= cat_215 true) (= cat_228 (fp.sqrt RNE cat_226))))
(assert (=> (not (= cat_215 true)) (= cat_218 cat_213)))
(assert (=> (not (= cat_215 true)) (= cat_224 cat_212)))
(assert (=> (not (= cat_215 true)) (= cat_226 cat_209)))
(assert (=> (not (= cat_215 true)) (= cat_228 cat_208)))
(assert (=> (= cat_215 true) (and (= cat_205 (fp.sub RNE cat_226 cat_224)) (spoon_1 (fp.sub RNE cat_226 cat_224)))))
(assert (=> (= cat_215 true) (= cat_206 (fp.add RNE cat_205 (fp.mul RNE cat_218 cat_218)))))
(assert (=> (= cat_215 true) (and (= cat_207 cat_206) (spoon_1 cat_206))))
(assert (=> (= cat_215 true) (= cat_229 (mk_potato_10 cat_211))))
(assert (=> (= cat_215 true) (= cat_230 cat_207)))
(assert (=> (= cat_215 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_230) (= cat_231 (mk_potato_10 cat_210)))))
(assert (=> (= cat_215 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_230) (= cat_232 (fp.sqrt RNE cat_230)))))
(assert (=> (= cat_215 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_230) (= cat_234 cat_215))))
(assert (=> (= cat_215 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_230)) (= cat_233 (mk_potato_7 cat_215)))))
(assert (=> (= cat_215 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_230)) (= cat_234 (distinct 0 0)))))
(assert (=> (= cat_215 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_230)) (= cat_232 cat_210))))
(assert (=> (not (= cat_215 true)) (= cat_230 cat_211)))
(assert (=> (not (= cat_215 true)) (= cat_232 cat_210)))
(assert (=> (not (= cat_215 true)) (= cat_234 cat_215)))
(assert (= cat_234 true))
(assert (not (spoon_1 (fp.mul RNE cat_232 cat_170))))
(check-sat)
(exit)
