...
(assert (and (= cat_209 (fp.mul RNE cat_226 cat_230)) (spoon_3 (fp.mul RNE cat_226 cat_230))))
(assert (= cat_210 (fp.mul RNE cat_209 cat_234)))
(assert (and (= cat_211 cat_210) (spoon_3 cat_210)))
(assert (and (= cat_207 (fp.mul RNE cat_224 cat_228)) (spoon_3 (fp.mul RNE cat_224 cat_228))))
...
(assert (and (= cat_215 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_156) cat_232)) (spoon_3 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_156) cat_232))))
(assert (= cat_216 (fp.mul RNE cat_215 cat_226)))
