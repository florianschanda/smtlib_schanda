...
(assert (= cat_146 (fp.sub RNE (spoon_32 (get_potato_13_a (get_potato_15_a cat_90))) (spoon_32 (get_potato_13_a (get_potato_15_a cat_88))))))
(assert (= cat_147 cat_136))
(assert (= cat_148 (fp.sub RNE (spoon_32 (get_potato_13_b (get_potato_15_a cat_90))) (spoon_32 (get_potato_13_b (get_potato_15_a cat_88))))))
...
(assert (= cat_152 (fp.add RNE (fp.mul RNE (fp.sub RNE (spoon_32 (get_potato_13_a (get_potato_15_a cat_86))) (spoon_32 (get_potato_13_a (get_potato_15_a cat_88)))) cat_146) (fp.mul RNE (fp.sub RNE (spoon_32 (get_potato_13_b (get_potato_15_a cat_86))) (spoon_32 (get_potato_13_b (get_potato_15_a cat_88)))) cat_148))))
(assert (and (= cat_143 (fp.div RNE cat_152 cat_150)) (spoon_1 (fp.div RNE cat_152 cat_150))))
(assert (and (= cat_144 cat_143) (spoon_1 cat_143)))
(assert (= cat_153 cat_141))
(assert (= cat_154 cat_144))
...
(assert (= cat_155 cat_140))
(assert (= cat_156 (fp.add RNE (fp.mul RNE (fp.sub RNE (spoon_32 (get_potato_13_a (get_potato_15_a cat_86))) (spoon_32 (get_potato_13_a (get_potato_15_a cat_88)))) (fp.neg cat_148)) (fp.mul RNE (fp.sub RNE (spoon_32 (get_potato_13_b (get_potato_15_a cat_86))) (spoon_32 (get_potato_13_b (get_potato_15_a cat_88)))) cat_146))))
(assert (not (spoon_58 cat_150)))
(check-sat)
(exit)
