...
(declare-fun spoon_38 (Float32 Float32) Float32)
(declare-fun spoon_39 (Float32 Float32 Float32) Bool)
(assert (forall ((kitten_31 Float32) (kitten_32 Float32)) (! (=> (and (and (spoon_37 kitten_31 true true true) (spoon_37 kitten_32 true true true)) (and (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) kitten_32) (not (fp.eq (fp.abs (fp.rem kitten_31 kitten_32)) (fp.mul RNE (fp #b0 #b01111101 #b00000000000000000000000) kitten_32))))) (let ((kitten_33 (spoon_38 kitten_31 kitten_32))) (and (=> (fp.eq kitten_31 (fp #b0 #b00000000 #b00000000000000000000000)) (fp.eq kitten_33 (fp #b0 #b00000000 #b00000000000000000000000))) (spoon_37 kitten_33 true false true)))) :pattern ((spoon_38 kitten_31 kitten_32)))))
(declare-sort potato_13 0)
(define-fun spoon_40 ((kitten_34 Float32)) Bool (and (spoon_1 kitten_34) (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)) kitten_34) (fp.leq kitten_34 (fp #b0 #b10000101 #b01100111111101011101000)))))
...
(define-fun spoon_46 ((kitten_35 potato_14)) potato_13 (get_potato_14_a kitten_35))
(define-fun spoon_47 ((kitten_36 Float32) (kitten_37 Bool) (kitten_38 Bool) (kitten_39 Bool)) Bool (=> (or (= kitten_37 true) (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)) (fp #b0 #b10000101 #b01100111111101011101000))) (spoon_40 kitten_36)))
(declare-sort potato_15 0)
(define-fun spoon_48 ((kitten_40 Float32)) Bool (and (spoon_1 kitten_40) (and (fp.leq (fp.neg (fp #b0 #b10001011 #b01101010100000000000000)) kitten_40) (fp.leq kitten_40 (fp #b0 #b10001011 #b01101010100000000000000)))))
(declare-fun spoon_49 (potato_15 potato_15) Bool)
...
(define-fun spoon_54 ((kitten_41 potato_16)) potato_15 (get_potato_16_a kitten_41))
(declare-const cat_55 Float32)
(declare-const cat_56 Int)
(declare-const cat_57 Int)
(define-fun spoon_58 ((kitten_42 Float32) (kitten_43 Bool) (kitten_44 Bool) (kitten_45 Bool)) Bool (=> (or (= kitten_43 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b01101010100000000000000)) (fp #b0 #b10001011 #b01101010100000000000000))) (spoon_48 kitten_42)))
(declare-const cat_59 Float32)
(assert (spoon_40 cat_55))
(assert (and (fp.lt (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_55) (fp.lt cat_55 (fp #b0 #b10000101 #b01101000000000000000000))))
(assert (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)) (spoon_1 cat_59)))
(assert (not (not (fp.eq (fp.abs (fp.rem cat_55 (fp #b0 #b10000111 #b01101000000000000000000))) (fp.mul RNE (fp #b0 #b01111101 #b00000000000000000000000) (fp #b0 #b10000111 #b01101000000000000000000))))))
(check-sat)
(exit)
