...
(assert (forall ((kitten_30 Float32) (kitten_31 Float32)) (! (=> (and (and (spoon_37 kitten_30 true true true) (spoon_37 kitten_31 true true true)) (and (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) kitten_31) (not (fp.eq (fp.abs (fp.rem kitten_30 kitten_31)) (fp.mul RNE (fp #b0 #b01111101 #b00000000000000000000000) kitten_31))))) (let ((kitten_32 (spoon_38 kitten_30 kitten_31))) (and (=> (fp.eq kitten_30 (fp #b0 #b00000000 #b00000000000000000000000)) (fp.eq kitten_32 (fp #b0 #b00000000 #b00000000000000000000000))) (spoon_37 kitten_32 true false true)))) :pattern ((spoon_38 kitten_30 kitten_31)))))
(declare-sort potato_13 0)
(define-fun spoon_40 ((kitten_33 Float32)) Bool (and (spoon_1 kitten_33) (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)) kitten_33) (fp.leq kitten_33 (fp #b0 #b10000101 #b01100111111101011101000)))))
...
(define-fun spoon_46 ((kitten_34 potato_14)) potato_13 (get_potato_14_a kitten_34))
(define-fun spoon_47 ((kitten_35 Float32) (kitten_36 Bool) (kitten_37 Bool) (kitten_38 Bool)) Bool (=> (or (= kitten_36 true) (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)) (fp #b0 #b10000101 #b01100111111101011101000))) (spoon_40 kitten_35)))
(declare-sort potato_15 0)
(define-fun spoon_48 ((kitten_39 Float32)) Bool (and (spoon_1 kitten_39) (and (fp.leq (fp.neg (fp #b0 #b10001011 #b01101010100000000000000)) kitten_39) (fp.leq kitten_39 (fp #b0 #b10001011 #b01101010100000000000000)))))
...
(define-fun spoon_58 ((kitten_41 Float32) (kitten_42 Bool) (kitten_43 Bool) (kitten_44 Bool)) Bool (=> (or (= kitten_42 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b01101010100000000000000)) (fp #b0 #b10001011 #b01101010100000000000000))) (spoon_48 kitten_41)))
