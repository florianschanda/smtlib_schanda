...
(assert (and (= cat_128 cat_112) (spoon_1 cat_112)))
(assert (and (= cat_129 (spoon_85 cat_128)) (spoon_76 cat_129)))
(assert (= cat_129 cat_116))
(assert (spoon_76 cat_116))
(assert (= ((_ to_fp 8 24) RNE (fp.mul RNE cat_108 cat_108)) cat_118))
(assert (spoon_61 cat_118))
(assert (and (= cat_130 (fp.sub RNE (fp #b0 #b01111111 #b00000000000000000000000) cat_118)) (spoon_1 (fp.sub RNE (fp #b0 #b01111111 #b00000000000000000000000) cat_118))))
(assert (= cat_131 (fp.mul RNE cat_130 (fp.mul RNE cat_116 cat_116))))
(assert (and (= cat_132 cat_131) (spoon_1 cat_131)))
(assert (= cat_133 (fp.add RNE (fp #b0 #b01111111 #b00000000000000000000000) cat_132)))
(assert (and (= cat_134 cat_133) (spoon_1 cat_133)))
(assert (and (= cat_135 cat_134) (spoon_1 cat_134)))
(assert (= cat_135 cat_120))
(assert (spoon_61 cat_120))
(assert (not (or (fp.isZero cat_120) (fp.isPositive cat_120))))
(check-sat)
(exit)
