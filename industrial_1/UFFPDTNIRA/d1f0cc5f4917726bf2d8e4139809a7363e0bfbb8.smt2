...
(assert (= cat_129 (fp.add RNE (fp #b0 #b01111111 #b00000000000000000000000) cat_128)))
(assert (and (= cat_130 cat_129) (spoon_1 cat_129)))
(assert (and (= cat_131 cat_130) (spoon_1 cat_130)))
(assert (= cat_131 cat_116))
(assert (spoon_57 cat_116))
(assert (not (or (fp.isZero cat_116) (fp.isPositive cat_116))))
(check-sat)
(exit)
