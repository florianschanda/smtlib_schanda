...
(define-fun spoon_29 ((kitten_23 Float32) (kitten_24 Bool) (kitten_25 Bool) (kitten_26 Bool)) Bool (=> (or (= kitten_24 true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111))) (spoon_1 kitten_23)))
(declare-sort potato_13 0)
(define-fun spoon_30 ((kitten_27 Float32)) Bool (and (spoon_1 kitten_27) (and (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) kitten_27) (fp.leq kitten_27 (fp #b0 #b10001011 #b00000000000000000000000)))))
...
(define-fun spoon_36 ((kitten_28 potato_14)) potato_13 (get_potato_14_a kitten_28))
(declare-fun spoon_37 (potato_13) Float32)
(declare-fun spoon_38 (Float32) potato_13)
(assert (forall ((kitten_29 potato_13)) (! (= (spoon_38 (spoon_37 kitten_29)) kitten_29) :pattern ((spoon_37 kitten_29)))))
(assert (forall ((kitten_30 potato_13)) (! (spoon_30 (spoon_37 kitten_30)) :pattern ((spoon_37 kitten_30)))))
(assert (forall ((kitten_31 Float32)) (! (=> (spoon_30 kitten_31) (= (spoon_37 (spoon_38 kitten_31)) kitten_31)) :pattern ((spoon_37 (spoon_38 kitten_31))))))
...
(define-fun spoon_39 ((kitten_32 potato_16)) potato_15 (get_potato_16_a kitten_32))
(declare-datatypes () ((potato_17 (mk_potato_17 (get_potato_17_a potato_15)))))
(define-fun spoon_40 ((kitten_33 potato_17)) potato_15 (get_potato_17_a kitten_33))
(define-fun spoon_41 ((kitten_34 potato_17) (kitten_35 potato_17)) Bool (ite (and (= (spoon_37 (get_potato_15_a (get_potato_17_a kitten_34))) (spoon_37 (get_potato_15_a (get_potato_17_a kitten_35)))) (= (spoon_37 (get_potato_15_b (get_potato_17_a kitten_34))) (spoon_37 (get_potato_15_b (get_potato_17_a kitten_35))))) true false))
(declare-const cat_42 Int)
(declare-fun spoon_43 (potato_17) Int)
(declare-const cat_44 Int)
(declare-fun spoon_45 (potato_17) Int)
(assert (<= 0 cat_42))
(assert (forall ((kitten_36 potato_17)) (<= 0 (spoon_43 kitten_36))))
(assert (<= 0 cat_44))
...
(assert (<= 0 cat_51))
(declare-fun spoon_52 (potato_17 potato_17) Bool)
(declare-const cat_53 potato_17)
(declare-datatypes () ((potato_18 (mk_potato_18 (get_potato_18_a potato_17)))))
(define-fun spoon_54 ((kitten_38 potato_18)) potato_17 (get_potato_18_a kitten_38))
(declare-sort potato_19 0)
(define-fun spoon_55 ((kitten_39 Float32)) Bool (and (spoon_1 kitten_39) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_39) (fp.leq kitten_39 (fp #b0 #b10001100 #b01101010100000000000000)))))
(declare-fun spoon_56 (potato_19 potato_19) Bool)
(declare-fun spoon_57 (Float32) potato_5)
(declare-fun spoon_58 (potato_5) Bool)
(declare-fun spoon_59 (potato_5) Float32)
(declare-const cat_60 potato_19)
(declare-datatypes () ((potato_20 (mk_potato_20 (get_potato_20_a potato_19)))))
(define-fun spoon_61 ((kitten_40 potato_20)) potato_19 (get_potato_20_a kitten_40))
...
(assert (= cat_66 (fp.mul RNE (fp.sub RNE (spoon_37 (get_potato_15_a (get_potato_17_a cat_62))) (spoon_37 (get_potato_15_a (get_potato_17_a cat_64)))) (fp.sub RNE (spoon_37 (get_potato_15_a (get_potato_17_a cat_62))) (spoon_37 (get_potato_15_a (get_potato_17_a cat_64)))))))
(assert (= cat_68 (fp.mul RNE (fp.sub RNE (spoon_37 (get_potato_15_b (get_potato_17_a cat_62))) (spoon_37 (get_potato_15_b (get_potato_17_a cat_64)))) (fp.sub RNE (spoon_37 (get_potato_15_b (get_potato_17_a cat_62))) (spoon_37 (get_potato_15_b (get_potato_17_a cat_64)))))))
(define-fun spoon_70 ((kitten_41 Float32) (kitten_42 Bool) (kitten_43 Bool) (kitten_44 Bool)) Bool (=> (or (= kitten_42 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_30 kitten_41)))
(define-fun spoon_71 ((kitten_45 Float32) (kitten_46 Bool) (kitten_47 Bool) (kitten_48 Bool)) Bool (=> (or (= kitten_46 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000))) (spoon_55 kitten_45)))
(assert (not (spoon_1 (fp.mul RNE (fp.sub RNE (spoon_37 (get_potato_15_a (get_potato_17_a cat_62))) (spoon_37 (get_potato_15_a (get_potato_17_a cat_64)))) (fp.sub RNE (spoon_37 (get_potato_15_a (get_potato_17_a cat_62))) (spoon_37 (get_potato_15_a (get_potato_17_a cat_64))))))))
(check-sat)
(exit)
