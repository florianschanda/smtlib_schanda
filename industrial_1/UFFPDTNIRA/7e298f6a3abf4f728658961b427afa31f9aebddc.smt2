...
(define-fun spoon_32 ((kitten_27 Float32)) Bool (and (spoon_1 kitten_27) (and (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) kitten_27) (fp.leq kitten_27 (fp #b0 #b10001011 #b00000000000000000000000)))))
...
(define-fun spoon_38 ((kitten_28 potato_14)) potato_13 (get_potato_14_a kitten_28))
(declare-fun spoon_39 (potato_13) Float32)
(declare-fun spoon_40 (Float32) potato_13)
(assert (forall ((kitten_29 potato_13)) (! (= (spoon_40 (spoon_39 kitten_29)) kitten_29) :pattern ((spoon_39 kitten_29)))))
(assert (forall ((kitten_30 potato_13)) (! (spoon_32 (spoon_39 kitten_30)) :pattern ((spoon_39 kitten_30)))))
(assert (forall ((kitten_31 Float32)) (! (=> (spoon_32 kitten_31) (= (spoon_39 (spoon_40 kitten_31)) kitten_31)) :pattern ((spoon_39 (spoon_40 kitten_31))))))
...
(define-fun spoon_41 ((kitten_32 potato_16)) potato_15 (get_potato_16_a kitten_32))
(declare-datatypes () ((potato_17 (mk_potato_17 (get_potato_17_a potato_15)))))
(define-fun spoon_42 ((kitten_33 potato_17)) potato_15 (get_potato_17_a kitten_33))
(define-fun spoon_43 ((kitten_34 potato_17) (kitten_35 potato_17)) Bool (ite (and (= (spoon_39 (get_potato_15_a (get_potato_17_a kitten_34))) (spoon_39 (get_potato_15_a (get_potato_17_a kitten_35)))) (= (spoon_39 (get_potato_15_b (get_potato_17_a kitten_34))) (spoon_39 (get_potato_15_b (get_potato_17_a kitten_35))))) true false))
(declare-const cat_44 Int)
(declare-fun spoon_45 (potato_17) Int)
(declare-const cat_46 Int)
(declare-fun spoon_47 (potato_17) Int)
(assert (<= 0 cat_44))
(assert (forall ((kitten_36 potato_17)) (<= 0 (spoon_45 kitten_36))))
(assert (<= 0 cat_46))
(assert (forall ((kitten_37 potato_17)) (<= 0 (spoon_47 kitten_37))))
...
(define-fun spoon_57 ((kitten_39 Float32)) Bool (and (spoon_1 kitten_39) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_39) (fp.leq kitten_39 (fp #b0 #b10001100 #b01101010100000000000000)))))
...
(define-fun spoon_63 ((kitten_40 potato_20)) potato_19 (get_potato_20_a kitten_40))
...
(define-fun spoon_72 ((kitten_41 Float32) (kitten_42 Bool) (kitten_43 Bool) (kitten_44 Bool)) Bool (=> (or (= kitten_42 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_32 kitten_41)))
(define-fun spoon_73 ((kitten_45 Float32) (kitten_46 Bool) (kitten_47 Bool) (kitten_48 Bool)) Bool (=> (or (= kitten_46 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000))) (spoon_57 kitten_45)))
(assert (not (spoon_1 (fp.mul RNE (fp.sub RNE (spoon_39 (get_potato_15_a (get_potato_17_a cat_64))) (spoon_39 (get_potato_15_a (get_potato_17_a cat_66)))) (fp.sub RNE (spoon_39 (get_potato_15_a (get_potato_17_a cat_64))) (spoon_39 (get_potato_15_a (get_potato_17_a cat_66))))))))
(check-sat)
(exit)
