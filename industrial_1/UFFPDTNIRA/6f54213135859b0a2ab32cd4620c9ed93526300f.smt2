...
(declare-const cat_180 potato_28)
...
(define-fun spoon_192 () potato_10 (mk_potato_10 cat_142))
...
(assert (= cat_174 (mk_potato_28 (mk_potato_27 cat_139 cat_140))))
(assert (= cat_175 (mk_potato_27 cat_150 cat_151)))
(assert (= (spoon_79 cat_152) (fp.neg (fp.mul RNE (fp #b0 #b01111111 #b00000000000000000000000) (spoon_79 (get_potato_27_b cat_175))))))
(assert (= cat_152 cat_153))
(assert (= (get_potato_27_a cat_175) cat_154))
(assert (= cat_155 cat_153))
(assert (= cat_156 cat_154))
(assert (= cat_176 (mk_potato_28 (mk_potato_27 cat_137 cat_138))))
(assert (= cat_177 (mk_potato_27 cat_155 cat_156)))
...
(assert (= cat_179 (mk_potato_27 cat_161 cat_162)))
...
(assert (= cat_180 (mk_potato_28 (mk_potato_27 cat_135 cat_136))))
(assert (= cat_181 (get_potato_29_a cat_166)))
(assert (and (= cat_167 (spoon_119 (mk_potato_29 cat_175) (mk_potato_29 cat_175))) (and (spoon_111 cat_167) (= cat_167 (fp.add RNE (fp.mul RNE (spoon_79 (get_potato_27_a cat_175)) (spoon_79 (get_potato_27_a cat_175))) (fp.mul RNE (spoon_79 (get_potato_27_b cat_175)) (spoon_79 (get_potato_27_b cat_175))))))))
(assert (= cat_182 (mk_potato_10 cat_141)))
(assert (= cat_183 cat_167))
(assert (and (= cat_168 (spoon_119 (mk_potato_29 cat_179) (mk_potato_29 cat_177))) (and (spoon_111 cat_168) (= cat_168 (fp.add RNE (fp.mul RNE (spoon_79 (get_potato_27_a cat_179)) (spoon_79 (get_potato_27_a cat_177))) (fp.mul RNE (spoon_79 (get_potato_27_b cat_179)) (spoon_79 (get_potato_27_b cat_177))))))))
(assert (and (= cat_169 (spoon_119 (mk_potato_29 cat_181) (mk_potato_29 cat_177))) (and (spoon_111 cat_169) (= cat_169 (fp.add RNE (fp.mul RNE (spoon_79 (get_potato_27_a cat_181)) (spoon_79 (get_potato_27_a cat_177))) (fp.mul RNE (spoon_79 (get_potato_27_b cat_181)) (spoon_79 (get_potato_27_b cat_177))))))))
(assert (= cat_170 (fp.sub RNE cat_169 cat_168)))
(assert (= cat_184 (mk_potato_10 cat_143)))
(assert (= cat_185 cat_170))
(assert (and (= cat_171 (fp.sqrt RNE cat_183)) (spoon_1 (fp.sqrt RNE cat_183))))
(assert (= cat_186 (mk_potato_10 cat_144)))
(assert (= cat_187 cat_171))
(assert (=> (fp.leq (fp.mul RNE (fp #b0 #b10110110 #b00000000000000000000000) cat_187) (fp.abs cat_185)) (= cat_188 spoon_192)))
(assert (=> (fp.leq (fp.mul RNE (fp #b0 #b10110110 #b00000000000000000000000) cat_187) (fp.abs cat_185)) (= cat_189 (fp #b0 #b10110110 #b00000000000000000000000))))
(assert (=> (not (fp.leq (fp.mul RNE (fp #b0 #b10110110 #b00000000000000000000000) cat_187) (fp.abs cat_185))) (and (= cat_172 (fp.div RNE (fp.abs cat_185) cat_187)) (spoon_1 (fp.div RNE (fp.abs cat_185) cat_187)))))
(assert (=> (not (fp.leq (fp.mul RNE (fp #b0 #b10110110 #b00000000000000000000000) cat_187) (fp.abs cat_185))) (and (= cat_173 cat_172) (spoon_1 cat_172))))
(assert (=> (not (fp.leq (fp.mul RNE (fp #b0 #b10110110 #b00000000000000000000000) cat_187) (fp.abs cat_185))) (= cat_190 spoon_192)))
(assert (=> (not (fp.leq (fp.mul RNE (fp #b0 #b10110110 #b00000000000000000000000) cat_187) (fp.abs cat_185))) (= cat_191 cat_173)))
(assert (=> (not (fp.leq (fp.mul RNE (fp #b0 #b10110110 #b00000000000000000000000) cat_187) (fp.abs cat_185))) (= cat_189 cat_191)))
(assert (not (fp.lt cat_189 (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (not (fp.lt (fp #b0 #b10001100 #b01101010100000000000000) cat_189)))
(assert (not (spoon_56 cat_189)))
(check-sat)
(exit)
