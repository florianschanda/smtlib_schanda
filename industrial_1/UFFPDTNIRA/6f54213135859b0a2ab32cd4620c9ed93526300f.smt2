...
(assert (=> (fp.leq (fp.mul RNE (fp #b0 #b10110110 #b00000000000000000000000) cat_188) (fp.abs cat_186)) (= cat_189 (mk_potato_10 cat_142))))
(assert (=> (fp.leq (fp.mul RNE (fp #b0 #b10110110 #b00000000000000000000000) cat_188) (fp.abs cat_186)) (= cat_190 (fp #b0 #b10110110 #b00000000000000000000000))))
(assert (=> (not (fp.leq (fp.mul RNE (fp #b0 #b10110110 #b00000000000000000000000) cat_188) (fp.abs cat_186))) (and (= cat_172 (fp.div RNE (fp.abs cat_186) cat_188)) (spoon_1 (fp.div RNE (fp.abs cat_186) cat_188)))))
(assert (=> (not (fp.leq (fp.mul RNE (fp #b0 #b10110110 #b00000000000000000000000) cat_188) (fp.abs cat_186))) (and (= cat_173 cat_172) (spoon_1 cat_172))))
(assert (=> (not (fp.leq (fp.mul RNE (fp #b0 #b10110110 #b00000000000000000000000) cat_188) (fp.abs cat_186))) (= cat_191 (mk_potato_10 cat_142))))
(assert (=> (not (fp.leq (fp.mul RNE (fp #b0 #b10110110 #b00000000000000000000000) cat_188) (fp.abs cat_186))) (= cat_192 cat_173)))
(assert (=> (not (fp.leq (fp.mul RNE (fp #b0 #b10110110 #b00000000000000000000000) cat_188) (fp.abs cat_186))) (= cat_190 cat_192)))
(assert (not (fp.lt cat_190 (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (not (fp.lt (fp #b0 #b10001100 #b01101010100000000000000) cat_190)))
(assert (not (spoon_56 cat_190)))
(check-sat)
(exit)
