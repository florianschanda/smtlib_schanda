...
(declare-fun cat_267 () Bool)
(declare-fun cat_268 () Bool)
...
(declare-fun cat_281 () Bool)
(declare-fun cat_282 () Bool)
...
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_252 cat_256))) (and (= cat_209 _let_0) (spoon_3 _let_0))))
(assert (= cat_210 (fp.mul roundNearestTiesToEven cat_209 cat_260)))
(assert (and (= cat_211 cat_210) (spoon_3 cat_210)))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_250 cat_254))) (and (= cat_207 _let_0) (spoon_3 _let_0))))
...
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1024 11) (_ bv0 52)) cat_156) cat_258))) (and (= cat_215 _let_0) (spoon_3 _let_0))))
(assert (= cat_216 (fp.mul roundNearestTiesToEven cat_215 cat_252)))
(assert (and (= cat_217 cat_216) (spoon_3 cat_216)))
(assert (= cat_263 (mk_potato_11 cat_189)))
(assert (= cat_264 cat_217))
(assert (let ((_let_0 (fp.div roundNearestTiesToEven cat_264 cat_262))) (=> (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_262) (and (= cat_218 _let_0) (spoon_3 _let_0)))))
(assert (=> (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_262) (= cat_265 spoon_283)))
(assert (=> (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_262) (= cat_266 cat_218)))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv2046 11) (_ bv4503599627370495 52)) cat_262))) (=> (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_262)) (=> (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_262) (and (= cat_224 _let_0) (spoon_3 _let_0))))))
(assert (=> (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_262)) (=> (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_262) (= cat_225 (ite (fp.leq cat_264 cat_224) true false)))))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp.neg (fp (_ bv0 1) (_ bv2046 11) (_ bv4503599627370495 52))) cat_262))) (=> (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_262)) (=> (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_262) (and (= cat_223 _let_0) (spoon_3 _let_0))))))
(assert (=> (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_262)) (=> (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_262) (= cat_226 (ite (fp.leq cat_223 cat_264) true false)))))
(assert (=> (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_262)) (=> (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_262) (= cat_268 (ite (= cat_226 true) cat_225 false)))))
(assert (=> (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_262)) (=> (not (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_262)) (= cat_268 false))))
(assert (=> (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_262)) (=> (= cat_268 true) (= cat_267 true))))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp.neg (fp (_ bv0 1) (_ bv2046 11) (_ bv4503599627370495 52))) cat_262))) (=> (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_262)) (=> (not (= cat_268 true)) (=> (fp.lt cat_262 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52))) (and (= cat_220 _let_0) (spoon_3 _let_0)))))))
(assert (=> (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_262)) (=> (not (= cat_268 true)) (=> (fp.lt cat_262 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52))) (= cat_221 (ite (fp.leq cat_264 cat_220) true false))))))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv2046 11) (_ bv4503599627370495 52)) cat_262))) (=> (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_262)) (=> (not (= cat_268 true)) (=> (fp.lt cat_262 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52))) (and (= cat_219 _let_0) (spoon_3 _let_0)))))))
(assert (=> (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_262)) (=> (not (= cat_268 true)) (=> (fp.lt cat_262 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52))) (= cat_222 (ite (fp.leq cat_219 cat_264) true false))))))
(assert (=> (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_262)) (=> (not (= cat_268 true)) (=> (fp.lt cat_262 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52))) (= cat_267 (ite (= cat_222 true) cat_221 false))))))
(assert (=> (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_262)) (=> (not (= cat_268 true)) (=> (not (fp.lt cat_262 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)))) (= cat_267 false)))))
(assert (let ((_let_0 (fp.div roundNearestTiesToEven cat_264 cat_262))) (=> (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_262)) (=> (= cat_267 true) (and (= cat_227 _let_0) (spoon_3 _let_0))))))
(assert (=> (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_262)) (=> (= cat_267 true) (= cat_269 spoon_283))))
(assert (=> (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_262)) (=> (= cat_267 true) (= cat_270 cat_227))))
(assert (=> (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_262)) (=> (not (= cat_267 true)) (=> (fp.lt cat_264 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52))) (= cat_271 spoon_283)))))
(assert (=> (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_262)) (=> (not (= cat_267 true)) (=> (fp.lt cat_264 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52))) (= cat_272 (fp.neg (fp (_ bv0 1) (_ bv2046 11) (_ bv4503599627370495 52))))))))
(assert (=> (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_262)) (=> (not (= cat_267 true)) (=> (not (fp.lt cat_264 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)))) (= cat_273 spoon_283)))))
(assert (=> (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_262)) (=> (not (= cat_267 true)) (=> (not (fp.lt cat_264 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)))) (= cat_274 (fp (_ bv0 1) (_ bv2046 11) (_ bv4503599627370495 52)))))))
(assert (=> (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_262)) (=> (not (= cat_267 true)) (=> (not (fp.lt cat_264 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)))) (= cat_272 cat_274)))))
(assert (=> (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_262)) (=> (not (= cat_267 true)) (= cat_270 cat_272))))
(assert (=> (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_262)) (= cat_266 cat_270)))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_250 cat_256))) (and (= cat_228 _let_0) (spoon_3 _let_0))))
(assert (= cat_275 (mk_potato_11 cat_186)))
(assert (= cat_276 cat_228))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_252 cat_254))) (and (= cat_229 _let_0) (spoon_3 _let_0))))
(assert (= cat_230 (fp.mul roundNearestTiesToEven cat_229 cat_260)))
(assert (and (= cat_231 cat_230) (spoon_3 cat_230)))
(assert (= cat_277 (mk_potato_11 cat_187)))
(assert (= cat_278 cat_231))
(assert (let ((_let_0 (fp.sub roundNearestTiesToEven cat_276 cat_278))) (and (= cat_232 _let_0) (spoon_3 _let_0))))
...
(assert (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_262)))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv2046 11) (_ bv4503599627370495 52)) cat_262))) (=> (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_262) (and (= cat_240 _let_0) (spoon_3 _let_0)))))
(assert (=> (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_262) (= cat_241 (ite (fp.leq cat_280 cat_240) true false))))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp.neg (fp (_ bv0 1) (_ bv2046 11) (_ bv4503599627370495 52))) cat_262))) (=> (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_262) (and (= cat_239 _let_0) (spoon_3 _let_0)))))
(assert (=> (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_262) (= cat_242 (ite (fp.leq cat_239 cat_280) true false))))
(assert (=> (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_262) (= cat_282 (ite (= cat_242 true) cat_241 false))))
(assert (=> (not (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_262)) (= cat_282 false)))
(assert (=> (= cat_282 true) (= cat_281 true)))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp.neg (fp (_ bv0 1) (_ bv2046 11) (_ bv4503599627370495 52))) cat_262))) (=> (not (= cat_282 true)) (=> (fp.lt cat_262 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52))) (and (= cat_236 _let_0) (spoon_3 _let_0))))))
(assert (=> (not (= cat_282 true)) (=> (fp.lt cat_262 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52))) (= cat_237 (ite (fp.leq cat_280 cat_236) true false)))))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv2046 11) (_ bv4503599627370495 52)) cat_262))) (=> (not (= cat_282 true)) (=> (fp.lt cat_262 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52))) (and (= cat_235 _let_0) (spoon_3 _let_0))))))
(assert (=> (not (= cat_282 true)) (=> (fp.lt cat_262 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52))) (= cat_238 (ite (fp.leq cat_235 cat_280) true false)))))
(assert (=> (not (= cat_282 true)) (=> (fp.lt cat_262 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52))) (= cat_281 (ite (= cat_238 true) cat_237 false)))))
(assert (=> (not (= cat_282 true)) (=> (not (fp.lt cat_262 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)))) (= cat_281 false))))
(assert (= cat_281 true))
(assert (not (spoon_3 (fp.div roundNearestTiesToEven cat_280 cat_262))))
(check-sat)
(exit)
