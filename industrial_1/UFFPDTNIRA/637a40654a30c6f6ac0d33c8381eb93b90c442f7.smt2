...
(assert (= cat_117 (fp.div roundNearestTiesToEven (fp.sub roundNearestTiesToEven (fp (_ bv0 1) (_ bv134 8) (_ bv3407872 23)) cat_112) (fp (_ bv0 1) (_ bv128 8) (_ bv0 23)))))
(assert (not (spoon_76 (fp.add roundNearestTiesToEven cat_109 cat_117))))
(check-sat)
(exit)
