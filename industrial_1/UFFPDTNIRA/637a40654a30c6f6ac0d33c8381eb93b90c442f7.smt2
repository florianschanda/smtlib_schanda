...
(assert (= cat_110 (fp.sub RNE cat_109 cat_108)))
(assert (=> (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_110) (and (= cat_105 (fp.sub RNE cat_110 (fp #b0 #b10000111 #b01101000000000000000000))) (spoon_1 (fp.sub RNE cat_110 (fp #b0 #b10000111 #b01101000000000000000000))))))
(assert (=> (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_110) (= cat_111 cat_97)))
(assert (=> (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_110) (= cat_112 cat_105)))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_110)) (=> (fp.leq cat_110 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000))) (and (= cat_106 (fp.add RNE cat_110 (fp #b0 #b10000111 #b01101000000000000000000))) (spoon_1 (fp.add RNE cat_110 (fp #b0 #b10000111 #b01101000000000000000000)))))))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_110)) (=> (fp.leq cat_110 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000))) (= cat_113 cat_97))))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_110)) (=> (fp.leq cat_110 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000))) (= cat_114 cat_106))))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_110)) (=> (not (fp.leq cat_110 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)))) (and (= cat_107 cat_110) (spoon_1 cat_110)))))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_110)) (=> (not (fp.leq cat_110 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)))) (= cat_115 cat_97))))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_110)) (=> (not (fp.leq cat_110 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)))) (= cat_116 cat_107))))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_110)) (=> (not (fp.leq cat_110 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)))) (= cat_114 cat_116))))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_110)) (= cat_112 cat_114)))
(assert (= cat_117 (fp.div RNE (fp.sub RNE (fp #b0 #b10000110 #b01101000000000000000000) cat_112) (fp #b0 #b10000000 #b00000000000000000000000))))
(assert (not (spoon_76 (fp.add RNE cat_109 cat_117))))
(check-sat)
(exit)
