...
(define-fun spoon_55 ((kitten_37 Float32)) Bool (and (spoon_1 kitten_37) (and (fp.leq (fp.neg (fp #b0 #b10001100 #b00000000000000000000000)) kitten_37) (fp.leq kitten_37 (fp #b0 #b10001100 #b00000000000000000000000)))))
...
(define-fun spoon_62 ((kitten_39 Float32) (kitten_40 Bool) (kitten_41 Bool) (kitten_42 Bool) (kitten_43 Bool)) Bool (=> (or (= kitten_40 true) (fp.leq (fp.neg (fp #b0 #b10001100 #b00000000000000000000000)) (fp #b0 #b10001100 #b00000000000000000000000))) (spoon_55 kitten_39)))
(declare-const cat_63 Int)
(declare-const cat_64 Int)
(define-fun spoon_65 ((kitten_44 Float32) (kitten_45 Bool) (kitten_46 Bool) (kitten_47 Bool) (kitten_48 Bool)) Bool (=> (or (= kitten_45 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_23 kitten_44)))
...
(assert (= cat_68 (fp.sub RNE (spoon_30 (get_potato_13_a (get_potato_15_a cat_50))) (spoon_30 (get_potato_13_a (get_potato_15_a cat_52))))))
(assert (= cat_69 (fp.sub RNE (spoon_30 (get_potato_13_b (get_potato_15_a cat_50))) (spoon_30 (get_potato_13_b (get_potato_15_a cat_52))))))
(assert (=> (fp.leq cat_68 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000))) (= cat_70 cat_68)))
(assert (=> (fp.leq cat_68 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000))) (= cat_71 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))))
(assert (=> (not (fp.leq cat_68 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (fp.leq (fp #b0 #b10001011 #b00000000000000000000000) cat_68) (= cat_72 cat_68))))
(assert (=> (not (fp.leq cat_68 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (fp.leq (fp #b0 #b10001011 #b00000000000000000000000) cat_68) (= cat_73 (fp #b0 #b10001011 #b00000000000000000000000)))))
(assert (=> (not (fp.leq cat_68 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.leq (fp #b0 #b10001011 #b00000000000000000000000) cat_68)) (= cat_73 cat_68))))
(assert (=> (not (fp.leq cat_68 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (= cat_71 cat_73)))
(assert (=> (fp.leq cat_69 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000))) (= cat_74 cat_69)))
(assert (=> (fp.leq cat_69 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000))) (= cat_75 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))))
(assert (=> (not (fp.leq cat_69 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (fp.leq (fp #b0 #b10001011 #b00000000000000000000000) cat_69) (= cat_76 cat_69))))
(assert (=> (not (fp.leq cat_69 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (fp.leq (fp #b0 #b10001011 #b00000000000000000000000) cat_69) (= cat_77 (fp #b0 #b10001011 #b00000000000000000000000)))))
(assert (=> (not (fp.leq cat_69 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.leq (fp #b0 #b10001011 #b00000000000000000000000) cat_69)) (= cat_77 cat_69))))
(assert (=> (not (fp.leq cat_69 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (= cat_75 cat_77)))
(assert (not (spoon_23 cat_75)))
(check-sat)
(exit)
