...
(declare-const cat_75 potato_11)
...
(assert (= cat_76 cat_71))
(assert (= cat_77 (fp.sub RNE (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) (spoon_38 (get_potato_13_a (get_potato_15_a cat_58)))) (spoon_38 (get_potato_13_a (get_potato_15_a cat_56))))))
(assert (= cat_78 cat_72))
(assert (= cat_79 (fp.sub RNE (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) (spoon_38 (get_potato_13_b (get_potato_15_a cat_58)))) (spoon_38 (get_potato_13_b (get_potato_15_a cat_56))))))
(assert (=> (not (fp.lt cat_77 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_77)) (=> (not (fp.lt cat_79 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_79)))))
(assert (not (fp.eq cat_77 (fp.sub RNE (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) (spoon_38 (get_potato_13_a (get_potato_15_a cat_58)))) (spoon_38 (get_potato_13_a (get_potato_15_a cat_56)))))))
(check-sat)
(exit)
