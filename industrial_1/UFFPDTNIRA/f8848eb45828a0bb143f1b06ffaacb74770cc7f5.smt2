...
(define-fun spoon_58 ((kitten_37 Float32)) Bool (and (spoon_1 kitten_37) (and (fp.leq (fp.neg (fp #b0 #b10011010 #b00000000000000000000000)) kitten_37) (fp.leq kitten_37 (fp #b0 #b10011010 #b00000000000000000000000)))))
...
(declare-const cat_63 potato_17)
(declare-datatypes () ((potato_18 (mk_potato_18 (get_potato_18_a potato_17)))))
(define-fun spoon_64 ((kitten_38 potato_18)) potato_17 (get_potato_18_a kitten_38))
(define-fun spoon_65 ((kitten_39 Float32) (kitten_40 Bool) (kitten_41 Bool) (kitten_42 Bool)) Bool (=> (or (= kitten_40 true) (fp.leq (fp.neg (fp #b0 #b10011010 #b00000000000000000000000)) (fp #b0 #b10011010 #b00000000000000000000000))) (spoon_58 kitten_39)))
(declare-const cat_66 Int)
(declare-const cat_67 Int)
(define-fun spoon_68 ((kitten_43 Float32) (kitten_44 Bool) (kitten_45 Bool) (kitten_46 Bool)) Bool (=> (or (= kitten_44 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_29 kitten_43)))
...
(assert (=> (fp.leq (fp.neg (fp #b0 #b10011010 #b00000000000000000000000)) (fp #b0 #b10011010 #b00000000000000000000000)) (spoon_58 cat_69)))
(assert (=> (fp.leq (fp.neg (fp #b0 #b10011010 #b00000000000000000000000)) (fp #b0 #b10011010 #b00000000000000000000000)) (spoon_58 cat_70)))
(assert (= cat_71 cat_69))
(assert (= cat_72 (fp.sub RNE (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) (spoon_36 (get_potato_13_a (get_potato_15_a cat_56)))) (spoon_36 (get_potato_13_a (get_potato_15_a cat_54))))))
(assert (= cat_73 cat_70))
(assert (= cat_74 (fp.sub RNE (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) (spoon_36 (get_potato_13_b (get_potato_15_a cat_56)))) (spoon_36 (get_potato_13_b (get_potato_15_a cat_54))))))
(assert (=> (not (fp.lt cat_72 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_72)) (=> (not (fp.lt cat_74 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_74)))))
(assert (not (fp.eq cat_72 (fp.sub RNE (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) (spoon_36 (get_potato_13_a (get_potato_15_a cat_56)))) (spoon_36 (get_potato_13_a (get_potato_15_a cat_54)))))))
(check-sat)
(exit)
