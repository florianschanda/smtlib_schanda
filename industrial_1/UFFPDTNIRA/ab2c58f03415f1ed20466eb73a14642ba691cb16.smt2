...
(assert (and (= cat_109 cat_108) (spoon_3 cat_108)))
(assert (= (mk_potato_11 cat_150) (mk_potato_11 cat_105)))
(assert (= cat_151 cat_109))
(assert (= (spoon_53 cat_111) ((_ to_fp 8 24) RNE (fp.mul RNE ((_ to_fp 11 53) RNE (spoon_53 (get_potato_14_b (get_potato_16_a cat_73)))) cat_151))))
(assert (not (spoon_46 (fp.sub RNE (fp #b0 #b10001011 #b00000000000000000000000) (spoon_53 (get_potato_14_a (get_potato_16_a cat_71)))))))
(check-sat)
(exit)
