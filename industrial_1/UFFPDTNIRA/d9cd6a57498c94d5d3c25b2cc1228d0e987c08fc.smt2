...
(assert (and (= cat_230 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_247)) (spoon_2 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_247))))
...
(assert (and (= cat_237 (fp.mul RNE cat_253 ((_ to_fp 11 53) RNE cat_183))) (spoon_2 (fp.mul RNE cat_253 ((_ to_fp 11 53) RNE cat_183)))))
(assert (= cat_238 (fp.mul RNE cat_237 cat_259)))
(assert (and (= cat_239 cat_238) (spoon_2 cat_238)))
(assert (not (spoon_2 (fp.sub RNE cat_255 cat_249))))
(check-sat)
(exit)
