...
(declare-const cat_240 potato_19)
(declare-const cat_241 potato_18)
...
(assert (= cat_239 (spoon_37 1)))
(assert (= cat_240 (mk_potato_19 (mk_potato_18 cat_201 cat_202))))
(assert (= cat_241 (get_potato_20_a cat_85)))
...
(assert (and (= cat_226 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_243)) (spoon_2 (fp.mul RNE (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) cat_243))))
...
(assert (and (= cat_233 (fp.mul RNE cat_249 ((_ to_fp 11 53) RNE cat_179))) (spoon_2 (fp.mul RNE cat_249 ((_ to_fp 11 53) RNE cat_179)))))
(assert (= cat_234 (fp.mul RNE cat_233 cat_255)))
(assert (and (= cat_235 cat_234) (spoon_2 cat_234)))
(assert (not (spoon_2 (fp.sub RNE cat_251 cat_245))))
(check-sat)
(exit)
