...
(assert (= cat_105 cat_101))
(assert (= cat_106 cat_103))
(assert (and (= cat_104 (spoon_66 cat_70 cat_72)) (spoon_50 cat_104)))
(assert (= cat_107 cat_102))
(assert (= cat_108 cat_104))
(assert (= cat_109 cat_100))
(assert (= cat_110 (fp.sub RNE cat_108 cat_106)))
(assert (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_110))
(assert (not (spoon_58 (fp.sub RNE cat_110 (fp #b0 #b10000111 #b01101000000000000000000)))))
(check-sat)
(exit)
