...
(define-fun spoon_14 ((kitten_7 Int) (kitten_8 Bool) (kitten_9 Bool) (kitten_10 Bool)) Bool (=> (or (= kitten_8 true) (<= 0 999)) (spoon_7 kitten_7)))
...
(assert (spoon_7 cat_15))
(assert (spoon_7 cat_17))
(assert (=> (<= 0 999) (spoon_7 cat_20)))
(assert (<= cat_15 (- 999 cat_17)))
(assert (not (spoon_7 (+ cat_15 cat_17))))
(check-sat)
(exit)
