...
(define-fun spoon_7 ((kitten_5 Int)) Bool (and (<= 0 kitten_5) (<= kitten_5 9007199254740991)))
...
(define-fun spoon_14 ((kitten_7 Int) (kitten_8 Bool) (kitten_9 Bool) (kitten_10 Bool)) Bool (=> (or (= kitten_8 true) (<= 0 9007199254740991)) (spoon_7 kitten_7)))
(declare-sort potato_12 0)
(define-fun spoon_15 ((kitten_11 Int)) Bool (and (<= 0 kitten_11) (<= kitten_11 9007199254740991)))
(declare-fun spoon_16 (Int) potato_5)
(declare-fun spoon_17 (potato_5) Bool)
(declare-fun spoon_18 (potato_5) Int)
(declare-fun spoon_19 (potato_12 potato_12) Bool)
(declare-const cat_20 potato_12)
(declare-datatypes () ((potato_13 (mk_potato_13 (get_potato_13_a potato_12)))))
(define-fun spoon_21 ((kitten_12 potato_13)) potato_12 (get_potato_13_a kitten_12))
(define-fun spoon_22 ((kitten_13 Int) (kitten_14 Bool) (kitten_15 Bool) (kitten_16 Bool)) Bool (=> (or (= kitten_14 true) (<= 0 9007199254740991)) (spoon_15 kitten_13)))
...
(assert (not (< (- cat_23 cat_25) 0)))
(assert (not (spoon_7 (- cat_23 cat_25))))
(check-sat)
(exit)
