...
(assert (forall ((kitten_6 potato_10)) (and (<= 0 (spoon_11 kitten_6)) (<= (spoon_11 kitten_6) 999))))
...
(declare-const cat_17 potato_10)
...
(define-fun spoon_25 ((kitten_17 potato_14) (kitten_18 potato_14)) Bool (ite (and (= (get_potato_12_a (get_potato_14_a kitten_17)) (get_potato_12_a (get_potato_14_a kitten_18))) (= (spoon_19 (get_potato_12_b (get_potato_14_a kitten_17))) (spoon_19 (get_potato_12_b (get_potato_14_a kitten_18))))) true false))
...
(declare-const cat_37 potato_14)
...
(declare-const cat_39 potato_14)
...
(declare-const cat_43 (Array Int Bool))
