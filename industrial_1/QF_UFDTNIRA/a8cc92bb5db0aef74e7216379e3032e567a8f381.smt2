...
(assert (= cat_38 cat_36))
(assert (and (= cat_33 (* cat_22 10)) (spoon_24 (* cat_22 10))))
(assert (and (= cat_34 cat_33) (spoon_7 cat_33)))
(assert (= (mk_potato_6 cat_35) (mk_potato_6 cat_32)))
(assert (= cat_36 cat_34))
(assert (= (mk_potato_6 cat_39) (mk_potato_6 cat_37)))
(assert (= cat_40 cat_38))
(assert (= cat_41 cat_39))
(assert (not (= cat_39 (* cat_22 10))))
(check-sat)
(exit)
