...
(define-fun spoon_7 ((kitten_5 Int)) Bool (and (<= 40 kitten_5) (<= kitten_5 660)))
...
(define-fun spoon_14 ((kitten_7 Int)) Bool (and (<= 4 kitten_7) (<= kitten_7 66)))
...
(define-fun spoon_21 ((kitten_9 Int) (kitten_10 Bool) (kitten_11 Bool) (kitten_12 Bool)) Bool (=> (or (= kitten_10 true) (<= 4 66)) (spoon_14 kitten_9)))
