...
(define-fun spoon_79 () potato_6 (mk_potato_6 cat_51))
...
(assert (= (mk_potato_6 cat_63) (mk_potato_6 cat_52)))
(assert (= cat_64 cat_59))
(assert (=> (< 990 cat_64) (= (mk_potato_6 cat_65) spoon_79)))
(assert (=> (< 990 cat_64) (= cat_66 990)))
(assert (=> (not (< 990 cat_64)) (and (= cat_60 cat_64) (spoon_13 cat_64))))
(assert (=> (not (< 990 cat_64)) (= (mk_potato_6 cat_67) spoon_79)))
(assert (=> (not (< 990 cat_64)) (= cat_68 cat_60)))
(assert (=> (not (< 990 cat_64)) (= cat_66 cat_68)))
(assert (= cat_70 cat_71))
(assert (= cat_72 cat_70))
(assert (= (mk_potato_6 cat_69) (mk_potato_6 cat_53)))
