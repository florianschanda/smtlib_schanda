...
(assert (= cat_51 (spoon_7 cat_50 10)))
(assert (= cat_52 (* cat_51 10)))
(assert (and (= cat_53 cat_52) (spoon_10 cat_52)))
(assert (and (= cat_54 cat_53) (spoon_37 cat_53)))
(assert (= (mk_potato_6 cat_55) (mk_potato_6 cat_48)))
(assert (= cat_56 cat_54))
(assert (not (< 990 cat_56)))
(assert (not (spoon_17 cat_56)))
(check-sat)
(exit)
