...
(declare-const cat_82 potato_16)
...
(declare-const cat_93 potato_10)
(declare-const cat_94 potato_10)
(define-fun spoon_95 () potato_12 (mk_potato_12 cat_89 cat_90))
(define-fun spoon_96 () potato_12 (mk_potato_12 cat_85 cat_86))
(assert (= cat_83 cat_69))
(assert (= cat_84 cat_70))
(assert (= spoon_96 (get_potato_14_a cat_64)))
(assert (=> (< 99801 (spoon_17 cat_85)) (= (spoon_17 cat_71) 99801)))
(assert (=> (< 99801 (spoon_17 cat_85)) (= cat_71 cat_72)))
(assert (=> (< 99801 (spoon_17 cat_85)) (= cat_86 cat_73)))
(assert (=> (< 99801 (spoon_17 cat_85)) (= cat_74 cat_72)))
(assert (=> (< 99801 (spoon_17 cat_85)) (= cat_75 cat_73)))
(assert (=> (< 99801 (spoon_17 cat_85)) (= cat_87 cat_85)))
(assert (=> (< 99801 (spoon_17 cat_85)) (= cat_88 cat_86)))
(assert (=> (< 99801 (spoon_17 cat_85)) (= cat_74 cat_89)))
(assert (=> (< 99801 (spoon_17 cat_85)) (= cat_75 cat_90)))
(assert (=> (not (< 99801 (spoon_17 cat_85))) (= spoon_95 spoon_96)))
(assert (=> (< 99900 (spoon_17 cat_90)) (= (spoon_17 cat_76) 99900)))
(assert (=> (< 99900 (spoon_17 cat_90)) (= cat_89 cat_77)))
(assert (=> (< 99900 (spoon_17 cat_90)) (= cat_76 cat_78)))
(assert (=> (< 99900 (spoon_17 cat_90)) (= cat_79 cat_77)))
(assert (=> (< 99900 (spoon_17 cat_90)) (= cat_80 cat_78)))
(assert (=> (< 99900 (spoon_17 cat_90)) (= cat_91 cat_89)))
(assert (=> (< 99900 (spoon_17 cat_90)) (= cat_92 cat_90)))
(assert (=> (< 99900 (spoon_17 cat_90)) (= cat_79 cat_93)))
(assert (=> (< 99900 (spoon_17 cat_90)) (= cat_80 cat_94)))
(assert (=> (not (< 99900 (spoon_17 cat_90))) (= (mk_potato_12 cat_93 cat_94) spoon_95)))
(assert (and (= cat_81 (spoon_7 (spoon_17 cat_94) 100)) (spoon_37 (spoon_7 (spoon_17 cat_94) 100))))
(assert (= (spoon_44 cat_82) cat_81))
(assert (not (spoon_37 (spoon_7 (+ (spoon_17 cat_93) 99) 100))))
(check-sat)
(exit)
