...
(declare-const cat_83 potato_16)
...
(declare-const cat_95 potato_10)
(assert (= cat_84 cat_69))
(assert (= cat_85 cat_70))
(assert (= (mk_potato_12 cat_86 cat_87) (get_potato_14_a cat_64)))
(assert (=> (< 99801 (spoon_17 cat_86)) (= (spoon_17 cat_71) 99801)))
(assert (=> (< 99801 (spoon_17 cat_86)) (= cat_71 cat_72)))
(assert (=> (< 99801 (spoon_17 cat_86)) (= cat_87 cat_73)))
(assert (=> (< 99801 (spoon_17 cat_86)) (= cat_74 cat_72)))
(assert (=> (< 99801 (spoon_17 cat_86)) (= cat_75 cat_73)))
(assert (=> (< 99801 (spoon_17 cat_86)) (= cat_88 cat_86)))
(assert (=> (< 99801 (spoon_17 cat_86)) (= cat_89 cat_87)))
(assert (=> (< 99801 (spoon_17 cat_86)) (= cat_74 cat_90)))
(assert (=> (< 99801 (spoon_17 cat_86)) (= cat_75 cat_91)))
(assert (=> (not (< 99801 (spoon_17 cat_86))) (= (mk_potato_12 cat_90 cat_91) (mk_potato_12 cat_86 cat_87))))
(assert (=> (< 99900 (spoon_17 cat_91)) (= (spoon_17 cat_76) 99900)))
(assert (=> (< 99900 (spoon_17 cat_91)) (= cat_90 cat_77)))
(assert (=> (< 99900 (spoon_17 cat_91)) (= cat_76 cat_78)))
(assert (=> (< 99900 (spoon_17 cat_91)) (= cat_79 cat_77)))
(assert (=> (< 99900 (spoon_17 cat_91)) (= cat_80 cat_78)))
(assert (=> (< 99900 (spoon_17 cat_91)) (= cat_92 cat_90)))
(assert (=> (< 99900 (spoon_17 cat_91)) (= cat_93 cat_91)))
(assert (=> (< 99900 (spoon_17 cat_91)) (= cat_79 cat_94)))
(assert (=> (< 99900 (spoon_17 cat_91)) (= cat_80 cat_95)))
(assert (=> (not (< 99900 (spoon_17 cat_91))) (= (mk_potato_12 cat_94 cat_95) (mk_potato_12 cat_90 cat_91))))
(assert (and (= cat_82 (spoon_7 (spoon_17 cat_95) 100)) (spoon_37 (spoon_7 (spoon_17 cat_95) 100))))
(assert (= (spoon_44 cat_83) cat_82))
(assert (not (spoon_37 (spoon_7 (+ (spoon_17 cat_94) 99) 100))))
(check-sat)
(exit)
