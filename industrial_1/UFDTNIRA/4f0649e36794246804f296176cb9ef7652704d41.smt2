...
(define-fun spoon_73 () potato_6 (mk_potato_6 cat_47))
...
(assert (= (mk_potato_6 cat_57) (mk_potato_6 cat_48)))
(assert (= cat_58 cat_55))
(assert (=> (< 990 cat_58) (= (mk_potato_6 cat_59) spoon_73)))
(assert (=> (< 990 cat_58) (= cat_60 990)))
(assert (=> (not (< 990 cat_58)) (and (= cat_56 cat_58) (spoon_17 cat_58))))
(assert (=> (not (< 990 cat_58)) (= (mk_potato_6 cat_61) spoon_73)))
(assert (=> (not (< 990 cat_58)) (= cat_62 cat_56)))
(assert (=> (not (< 990 cat_58)) (= cat_60 cat_62)))
(assert (= cat_64 cat_65))
(assert (= cat_66 cat_64))
(assert (= (mk_potato_6 cat_63) (mk_potato_6 cat_49)))
(assert (= cat_64 cat_60))
(assert (= (mk_potato_6 cat_69) (mk_potato_6 cat_65)))
(assert (= cat_58 cat_68))
(assert (= cat_60 cat_67))
(assert (= cat_72 cat_66))
(assert (= cat_71 cat_58))
(assert (= cat_70 cat_60))
