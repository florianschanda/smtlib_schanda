...
(assert (let ((_let_0 (* (spoon_1 (+ cat_27 5) 10) 10))) (=> (not (= (spoon_9 cat_27 10) 0)) (and (= cat_32 _let_0) (spoon_11 _let_0)))))
...
(assert (let ((_let_0 (* (spoon_1 (+ cat_27 5) 10) 10))) (=> (not (= (spoon_9 cat_27 10) 0)) (=> (not (= cat_37 true)) (and (= cat_33 _let_0) (spoon_11 _let_0))))))
