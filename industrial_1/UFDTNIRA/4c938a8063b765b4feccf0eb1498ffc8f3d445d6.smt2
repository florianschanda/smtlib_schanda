...
(declare-fun cat_34 () Bool)
(assert (spoon_19 cat_27))
(assert (=> (<= 0 999) (spoon_19 cat_30)))
(assert (= (mk_potato_6 cat_32) (mk_potato_6 cat_30)))
...
(assert (= cat_34 (ite (< 999 cat_31) true false)))
(assert (not (= cat_34 true)))
(assert (not (spoon_11 (* (spoon_1 (+ cat_27 5) 10) 10))))
(check-sat)
(exit)
