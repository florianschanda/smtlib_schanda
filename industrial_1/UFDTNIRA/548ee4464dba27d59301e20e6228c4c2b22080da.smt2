...
(assert (forall ((kitten_5 potato_10)) (and (<= (- 2147483648) (spoon_7 kitten_5)) (<= (spoon_7 kitten_5) 2147483647))))
...
(assert (forall ((kitten_8 potato_12)) (and (<= 0 (spoon_15 kitten_8)) (<= (spoon_15 kitten_8) 150000))))
...
(assert (forall ((kitten_11 potato_14)) (and (<= 0 (spoon_23 kitten_11)) (<= (spoon_23 kitten_11) 999))))
...
(assert (= cat_35 (* cat_32 100)))
(assert (spoon_8 (* cat_32 100)))
(assert (not (spoon_16 cat_35)))
(check-sat)
(exit)
