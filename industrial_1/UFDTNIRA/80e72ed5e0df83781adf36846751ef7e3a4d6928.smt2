...
(assert (forall ((kitten_11 potato_10)) (and (<= 40 (spoon_10 kitten_11)) (<= (spoon_10 kitten_11) 660))))
...
(assert (forall ((kitten_14 potato_12)) (and (<= 4000 (spoon_18 kitten_14)) (<= (spoon_18 kitten_14) 66000))))
