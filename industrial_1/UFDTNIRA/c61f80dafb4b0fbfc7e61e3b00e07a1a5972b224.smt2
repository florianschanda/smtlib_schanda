...
(assert (and (= cat_53 (spoon_10 cat_38)) (and (spoon_13 cat_53) (= cat_53 (spoon_1 cat_38 100)))))
(assert (= cat_54 (+ cat_53 5)))
(assert (= cat_55 (spoon_1 cat_54 10)))
(assert (= cat_56 (* cat_55 10)))
(assert (and (= cat_57 cat_56) (spoon_31 cat_56)))
(assert (not (spoon_41 cat_57)))
(check-sat)
(exit)
