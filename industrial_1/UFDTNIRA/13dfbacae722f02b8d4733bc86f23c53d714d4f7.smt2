...
(declare-fun cat_87 () potato_16)
(declare-fun cat_88 () potato_16)
...
(assert (let ((_let_0 (spoon_1 (spoon_46 cat_88) 100))) (and (= cat_75 _let_0) (spoon_11 _let_0))))
