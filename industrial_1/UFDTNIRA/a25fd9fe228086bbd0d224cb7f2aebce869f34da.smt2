...
(assert (= (mk_potato_6 cat_30) (mk_potato_6 cat_28)))
(assert (= cat_31 cat_25))
(assert (not (= (spoon_9 cat_25 10) 0)))
(assert (and (= cat_29 (* (spoon_7 (+ cat_25 5) 10) 10)) (spoon_10 (* (spoon_7 (+ cat_25 5) 10) 10))))
(assert (= cat_32 (ite (< 999 cat_29) true false)))
(assert (not (= cat_32 true)))
