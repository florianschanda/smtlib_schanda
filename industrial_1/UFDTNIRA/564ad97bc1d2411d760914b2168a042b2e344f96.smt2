...
(declare-fun cat_83 () Bool)
(define-fun spoon_84 () potato_6 (mk_potato_6 cat_51))
...
(assert (= (mk_potato_6 cat_67) (mk_potato_6 cat_52)))
(assert (= cat_68 cat_59))
(assert (=> (< 990 cat_68) (= (mk_potato_6 cat_69) spoon_84)))
(assert (=> (< 990 cat_68) (= cat_70 990)))
(assert (=> (not (< 990 cat_68)) (and (= cat_60 cat_68) (spoon_13 cat_68))))
(assert (=> (not (< 990 cat_68)) (= (mk_potato_6 cat_71) spoon_84)))
(assert (=> (not (< 990 cat_68)) (= cat_72 cat_60)))
(assert (=> (not (< 990 cat_68)) (= cat_70 cat_72)))
(assert (= cat_74 cat_75))
(assert (= cat_76 cat_74))
(assert (= (mk_potato_6 cat_73) (mk_potato_6 cat_53)))
(assert (= cat_74 cat_70))
(assert (= (mk_potato_6 cat_79) (mk_potato_6 cat_75)))
(assert (= cat_68 cat_78))
(assert (= cat_70 cat_77))
(assert (= cat_82 cat_76))
(assert (= cat_81 cat_68))
(assert (= cat_80 cat_70))
...
(assert (= cat_83 (ite (<= cat_64 990) true false)))
(assert (= cat_83 true))
(assert (let ((_let_0 (spoon_1 cat_38 100))) (and (= cat_65 _let_0) (spoon_13 _let_0))))
(assert (= cat_66 (+ cat_65 5)))
(assert (not (not (= 10 0))))
(check-sat)
(exit)
