...
(define-fun spoon_78 () potato_6 (mk_potato_6 cat_47))
...
(assert (= (mk_potato_6 cat_61) (mk_potato_6 cat_48)))
(assert (= cat_62 cat_55))
(assert (=> (< 990 cat_62) (= (mk_potato_6 cat_63) spoon_78)))
(assert (=> (< 990 cat_62) (= cat_64 990)))
(assert (=> (not (< 990 cat_62)) (and (= cat_56 cat_62) (spoon_17 cat_62))))
(assert (=> (not (< 990 cat_62)) (= (mk_potato_6 cat_65) spoon_78)))
(assert (=> (not (< 990 cat_62)) (= cat_66 cat_56)))
(assert (=> (not (< 990 cat_62)) (= cat_64 cat_66)))
(assert (= cat_68 cat_69))
(assert (= cat_70 cat_68))
(assert (= (mk_potato_6 cat_67) (mk_potato_6 cat_49)))
...
(assert (= cat_77 (ite (<= cat_60 990) true false)))
(assert (= cat_77 true))
