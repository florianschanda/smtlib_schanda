...
(define-fun spoon_10 ((kitten_35 Int)) Bool (and (<= 40 kitten_35) (<= kitten_35 660)))
...
(define-fun spoon_17 ((kitten_37 Int)) Bool (and (<= 4000 kitten_37) (<= kitten_37 66000)))
...
(define-fun spoon_24 ((kitten_39 Int) (kitten_40 Bool) (kitten_41 Bool) (kitten_42 Bool)) Bool (=> (or (= kitten_40 true) (<= 4000 66000)) (spoon_17 kitten_39)))
(declare-const cat_25 Int)
(declare-const cat_26 Int)
(define-fun spoon_27 ((kitten_43 Int) (kitten_44 Bool) (kitten_45 Bool) (kitten_46 Bool)) Bool (=> (or (= kitten_44 true) (<= 40 660)) (spoon_10 kitten_43)))
