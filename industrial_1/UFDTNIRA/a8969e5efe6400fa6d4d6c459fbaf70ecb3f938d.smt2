...
(define-fun spoon_17 ((kitten_37 Int) (kitten_38 Bool) (kitten_39 Bool) (kitten_40 Bool)) Bool (=> (or (= kitten_38 true) (<= 0 999)) (spoon_10 kitten_37)))
(declare-sort potato_12 0)
(define-fun spoon_18 ((kitten_41 Int)) Bool (and (<= 0 kitten_41) (<= kitten_41 99)))
(declare-fun spoon_19 (Int) potato_5)
(declare-fun spoon_20 (potato_5) Bool)
(declare-fun spoon_21 (potato_5) Int)
(declare-fun spoon_22 (potato_12 potato_12) Bool)
(declare-const cat_23 potato_12)
(declare-datatypes () ((potato_13 (mk_potato_13 (get_potato_13_a potato_12)))))
(define-fun spoon_24 ((kitten_42 potato_13)) potato_12 (get_potato_13_a kitten_42))
(declare-fun spoon_25 (Int) Int)
(declare-fun spoon_26 (Int Int) Bool)
(assert (forall ((kitten_43 Int)) (! (=> (spoon_17 kitten_43 true true true) (let ((kitten_44 (spoon_25 kitten_43))) (and (= (spoon_9 kitten_44 10) 0) (spoon_17 kitten_44 true false true)))) :pattern ((spoon_25 kitten_43)))))
