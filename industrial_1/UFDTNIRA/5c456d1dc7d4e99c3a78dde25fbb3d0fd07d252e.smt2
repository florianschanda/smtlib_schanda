...
(assert (and (= cat_58 cat_57) (spoon_41 cat_57)))
(assert (= (mk_potato_6 cat_59) (mk_potato_6 cat_52)))
(assert (= cat_60 cat_58))
(assert (not (< 990 cat_60)))
(assert (not (spoon_13 cat_60)))
(check-sat)
(exit)
