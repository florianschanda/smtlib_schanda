...
(define-fun spoon_75 () potato_6 (mk_potato_6 cat_47))
...
(assert (= (mk_potato_6 cat_59) (mk_potato_6 cat_48)))
(assert (= cat_60 cat_55))
(assert (=> (< 990 cat_60) (= (mk_potato_6 cat_61) spoon_75)))
(assert (=> (< 990 cat_60) (= cat_62 990)))
(assert (=> (not (< 990 cat_60)) (and (= cat_56 cat_60) (spoon_17 cat_60))))
(assert (=> (not (< 990 cat_60)) (= (mk_potato_6 cat_63) spoon_75)))
(assert (=> (not (< 990 cat_60)) (= cat_64 cat_56)))
(assert (=> (not (< 990 cat_60)) (= cat_62 cat_64)))
(assert (= cat_66 cat_67))
(assert (= cat_68 cat_66))
(assert (= (mk_potato_6 cat_65) (mk_potato_6 cat_49)))
(assert (= cat_66 cat_62))
(assert (= (mk_potato_6 cat_71) (mk_potato_6 cat_67)))
(assert (= cat_60 cat_70))
(assert (= cat_62 cat_69))
(assert (= cat_74 cat_68))
(assert (= cat_73 cat_60))
(assert (= cat_72 cat_62))
