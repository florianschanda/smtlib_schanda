...
(assert (forall ((kitten_5 potato_10)) (and (<= 0 (spoon_9 kitten_5)) (<= (spoon_9 kitten_5) 150000))))
...
(assert (forall ((kitten_13 potato_12)) (and (<= 0 (spoon_18 kitten_13)) (<= (spoon_18 kitten_13) 999))))
...
(assert (forall ((kitten_23 potato_14)) (and (<= (- 2147483648) (spoon_27 kitten_23)) (<= (spoon_27 kitten_23) 2147483647))))
...
(declare-const cat_33 potato_14)
...
(assert (forall ((kitten_26 potato_16)) (and (<= 0 (spoon_35 kitten_26)) (<= (spoon_35 kitten_26) 500000))))
