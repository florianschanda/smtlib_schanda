...
(define-fun spoon_80 () potato_6 (mk_potato_6 cat_47))
...
(assert (= (mk_potato_6 cat_63) (mk_potato_6 cat_48)))
(assert (= cat_64 cat_55))
(assert (=> (< 990 cat_64) (= (mk_potato_6 cat_65) spoon_80)))
(assert (=> (< 990 cat_64) (= cat_66 990)))
(assert (=> (not (< 990 cat_64)) (and (= cat_56 cat_64) (spoon_17 cat_64))))
(assert (=> (not (< 990 cat_64)) (= (mk_potato_6 cat_67) spoon_80)))
(assert (=> (not (< 990 cat_64)) (= cat_68 cat_56)))
(assert (=> (not (< 990 cat_64)) (= cat_66 cat_68)))
(assert (= cat_70 cat_71))
(assert (= cat_72 cat_70))
(assert (= (mk_potato_6 cat_69) (mk_potato_6 cat_49)))
(assert (= cat_70 cat_66))
(assert (= (mk_potato_6 cat_75) (mk_potato_6 cat_71)))
(assert (= cat_64 cat_74))
(assert (= cat_66 cat_73))
(assert (= cat_78 cat_72))
(assert (= cat_77 cat_64))
(assert (= cat_76 cat_66))
...
(assert (= cat_79 (ite (<= cat_60 990) true false)))
(assert (= cat_79 true))
(assert (and (= cat_61 (spoon_7 cat_35 100)) (spoon_17 (spoon_7 cat_35 100))))
