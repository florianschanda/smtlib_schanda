...
(assert (forall ((kitten_14 potato_12)) (let ((_let_0 (spoon_18 kitten_14))) (and (<= 0 _let_0) (<= _let_0 99900))) ))
(define-fun spoon_19 ((kitten_15 Int)) Bool (and (<= 0 kitten_15) (<= kitten_15 99900)))
...
(define-fun spoon_26 ((kitten_17 Int) (kitten_18 Bool) (kitten_19 Bool) (kitten_20 Bool) (kitten_21 Bool)) Bool (=> (or (= kitten_18 true) (<= 0 99900)) (spoon_19 kitten_17)))
(declare-fun cat_27 () Int)
(declare-fun cat_28 () Int)
(define-fun spoon_29 ((kitten_22 Int) (kitten_23 Bool) (kitten_24 Bool) (kitten_25 Bool) (kitten_26 Bool)) Bool (=> (or (= kitten_23 true) (<= 0 999)) (spoon_11 kitten_22)))
