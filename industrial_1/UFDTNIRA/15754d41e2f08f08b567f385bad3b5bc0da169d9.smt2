...
(assert (forall ((kitten_11 potato_10)) (and (<= 0 (spoon_10 kitten_11)) (<= (spoon_10 kitten_11) 999))))
...
(assert (forall ((kitten_14 potato_12)) (and (<= 0 (spoon_18 kitten_14)) (<= (spoon_18 kitten_14) 99900))))
