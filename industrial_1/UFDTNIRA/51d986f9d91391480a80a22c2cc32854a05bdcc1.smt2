...
(define-fun spoon_10 ((kitten_35 Int)) Bool (and (<= 0 kitten_35) (<= kitten_35 999)))
...
(define-fun spoon_17 ((kitten_37 Int)) Bool (and (<= 0 kitten_37) (<= kitten_37 99900)))
...
(define-fun spoon_24 ((kitten_39 Int) (kitten_40 Bool) (kitten_41 Bool) (kitten_42 Bool)) Bool (=> (or (= kitten_40 true) (<= 0 99900)) (spoon_17 kitten_39)))
(declare-const cat_25 Int)
(declare-const cat_26 Int)
(define-fun spoon_27 ((kitten_43 Int) (kitten_44 Bool) (kitten_45 Bool) (kitten_46 Bool)) Bool (=> (or (= kitten_44 true) (<= 0 999)) (spoon_10 kitten_43)))
(declare-const cat_28 Int)
(assert (spoon_17 cat_25))
(assert (not (spoon_10 (spoon_7 cat_25 100))))
(check-sat)
(exit)
