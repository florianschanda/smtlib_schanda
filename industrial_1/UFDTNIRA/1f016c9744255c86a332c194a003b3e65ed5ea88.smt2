...
(declare-fun cat_35 () Bool)
(assert (spoon_19 cat_27))
(assert (=> (<= 0 999) (spoon_19 cat_30)))
(assert (= (mk_potato_6 cat_33) (mk_potato_6 cat_30)))
(assert (= cat_34 cat_27))
(assert (not (= (spoon_9 cat_27 10) 0)))
(assert (let ((_let_0 (* (spoon_1 (+ cat_27 5) 10) 10))) (and (= cat_31 _let_0) (spoon_11 _let_0))))
(assert (= cat_35 (ite (< 999 cat_31) true false)))
(assert (not (= cat_35 true)))
(assert (let ((_let_0 (* (spoon_1 (+ cat_27 5) 10) 10))) (and (= cat_32 _let_0) (spoon_11 _let_0))))
(assert (not (spoon_19 cat_32)))
(check-sat)
(exit)
