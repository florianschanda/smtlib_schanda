...
(declare-const cat_33 Bool)
(assert (spoon_17 cat_25))
(assert (=> (<= 0 999) (spoon_17 cat_28)))
(assert (= (mk_potato_6 cat_31) (mk_potato_6 cat_28)))
...
(assert (= cat_33 (ite (< 999 cat_29) true false)))
(assert (not (= cat_33 true)))
(assert (and (= cat_30 (* (spoon_7 (+ cat_25 5) 10) 10)) (spoon_10 (* (spoon_7 (+ cat_25 5) 10) 10))))
(assert (not (spoon_17 cat_30)))
(check-sat)
(exit)
