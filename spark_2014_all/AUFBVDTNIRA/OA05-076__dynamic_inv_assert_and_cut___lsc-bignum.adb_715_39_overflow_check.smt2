...
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= temp___742 o27))))
...
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= o31 (mk_map__ref o30)))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= h10 (mk_int__ref h9)))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= aux3 (mk_map__ref o30)))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= a7 (mk_map__ref o29)))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= h11 h9))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= o32 o30))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= a8 o29))))
...
(assert (=> (= result2 true) (=> (not (and (<= 1 h8) (<= h8 r94b))) (= o33 (mk_map__ref o27)))))
(assert (=> (= result2 true) (=> (not (and (<= 1 h8) (<= h8 r94b))) (= h12 (mk_int__ref h8)))))
(assert (=> (= result2 true) (=> (not (and (<= 1 h8) (<= h8 r94b))) (= aux31 (mk_map__ref o27)))))
(assert (=> (= result2 true) (=> (not (and (<= 1 h8) (<= h8 r94b))) (= a9 (mk_map__ref a6)))))
(assert (=> (= result2 true) (=> (not (and (<= 1 h8) (<= h8 r94b))) (= h13 h8))))
(assert (=> (= result2 true) (=> (not (and (<= 1 h8) (<= h8 r94b))) (= o34 o27))))
...
(assert (=> (= result2 true) (= (oeq (num_of_big_int (mk___t (let ((subject a9)) o35) (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omod (omultiply (omultiply (num_of_big_int (mk___t (map__content aux31) (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ (- a_last a_first) 1)) (num_of_big_int (mk___t (map__content aux41) (mk (to_rep aux4__first) (to_rep aux4__last))) o15 (+ (- a_last a_first) 1))) (oexpon (inverse (num_of_big_int m m_first (+ (- a_last a_first) 1)) (base Tuple0)) (+ (- a_last a_first) 1))) (num_of_big_int m m_first (+ (- a_last a_first) 1)))) true)))
(assert (=> (= result2 true) (forall ((k1 Int)) (=> (and (<= (to_rep aux3__first) k1) (<= k1 (to_rep aux3__last))) (and (=> (and (<= aux3_first k1) (<= k1 (- (+ aux3_first a_last) a_first))) (= (to_rep1 (select (let ((subject aux31)) o36) k1)) (to_rep1 (select o35 (- (+ a_first k1) aux3_first))))) (=> (=> (<= aux3_first k1) (not (<= k1 (- (+ aux3_first a_last) a_first)))) (= (to_rep1 (select (let ((subject aux31)) o36) k1)) (to_rep1 (select (map__content aux31) k1)))))))))
(assert (=> (= result2 true) (= o39 (mk_map__ref o36))))
(assert (=> (= result2 true) (= h14 h12)))
(assert (=> (= result2 true) (= w9 w7)))
(assert (=> (= result2 true) (= s12 (mk_int__ref s10))))
(assert (=> (= result2 true) (= j10 j8)))
(assert (=> (= result2 true) (= aux32 (mk_map__ref o36))))
(assert (=> (= result2 true) (= a11 (mk_map__ref o35))))
(assert (=> (= result2 true) (= h15 h13)))
(assert (=> (= result2 true) (= w10 w8)))
(assert (=> (= result2 true) (= s13 s10)))
(assert (=> (= result2 true) (= j11 j9)))
(assert (=> (= result2 true) (= o40 o36)))
(assert (=> (= result2 true) (= a12 o35)))
(assert (=> (not (= result2 true)) (= result8 (mk_int__ref s1))))
(assert (=> (not (= result2 true)) (= s11 1)))
(assert (=> (not (= result2 true)) (= (oeq (num_of_big_int (mk___t o37 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omod (omultiply (omultiply (num_of_big_int (mk___t o27 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ (- a_last a_first) 1)) (num_of_big_int (mk___t o27 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ (- a_last a_first) 1))) (oexpon (inverse (num_of_big_int m m_first (+ (- a_last a_first) 1)) (base Tuple0)) (+ (- a_last a_first) 1))) (num_of_big_int m m_first (+ (- a_last a_first) 1)))) true)))
(assert (=> (not (= result2 true)) (forall ((k1 Int)) (=> (and (<= (to_rep aux3__first) k1) (<= k1 (to_rep aux3__last))) (and (=> (and (<= aux3_first k1) (<= k1 (- (+ aux3_first a_last) a_first))) (= (to_rep1 (select o38 k1)) (to_rep1 (select o37 (- (+ a_first k1) aux3_first))))) (=> (=> (<= aux3_first k1) (not (<= k1 (- (+ aux3_first a_last) a_first)))) (= (to_rep1 (select o38 k1)) (to_rep1 (select o27 k1)))))))))
(assert (=> (not (= result2 true)) (= o39 (mk_map__ref o38))))
...
(assert (=> (not (= result2 true)) (= aux32 (mk_map__ref o38))))
(assert (=> (not (= result2 true)) (= a11 (mk_map__ref o37))))
(assert (=> (not (= result2 true)) (= h15 h7)))
(assert (=> (not (= result2 true)) (= w10 w)))
(assert (=> (not (= result2 true)) (= s13 s11)))
(assert (=> (not (= result2 true)) (= j11 j1)))
(assert (=> (not (= result2 true)) (= o40 o38)))
(assert (=> (not (= result2 true)) (= a12 o37)))
