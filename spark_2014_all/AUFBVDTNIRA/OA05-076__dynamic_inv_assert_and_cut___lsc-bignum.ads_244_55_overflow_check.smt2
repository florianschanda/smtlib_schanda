...
(assert (= o68 (+ x_first o67)))
(assert (and (= o69 o68) (in_range1 o68)))
(assert (= o70 (ite (<= o69 (to_rep (last (rt x)))) true false)))
(assert (and (= o64 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o65 (+ x_first o64)))
(assert (and (= o66 o65) (in_range1 o65)))
(assert (= o71 (ite (<= (to_rep (first (rt x))) o66) true false)))
(assert (= result (ite (= o71 true) o70 false)))
(assert (= result true))
...
(assert (= o60 (+ m_first o59)))
(assert (and (= o61 o60) (in_range1 o60)))
(assert (= o62 (ite (<= o61 (to_rep (last (rt m)))) true false)))
(assert (and (= o56 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o57 (+ m_first o56)))
(assert (and (= o58 o57) (in_range1 o57)))
(assert (= o63 (ite (<= (to_rep (first (rt m))) o58) true false)))
(assert (= result1 (ite (= o63 true) o62 false)))
(assert (= result1 true))
...
(assert (= o52 (+ aux1_first o51)))
(assert (and (= o53 o52) (in_range1 o52)))
(assert (= o54 (ite (<= o53 (to_rep aux1__last)) true false)))
(assert (and (= o48 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o49 (+ aux1_first o48)))
(assert (and (= o50 o49) (in_range1 o49)))
(assert (= o55 (ite (<= (to_rep aux1__first) o50) true false)))
(assert (= result2 (ite (= o55 true) o54 false)))
(assert (= result2 true))
...
(assert (= o44 (+ aux2_first o43)))
(assert (and (= o45 o44) (in_range1 o44)))
(assert (= o46 (ite (<= o45 (to_rep aux2__last)) true false)))
(assert (and (= o40 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o41 (+ aux2_first o40)))
(assert (and (= o42 o41) (in_range1 o41)))
(assert (= o47 (ite (<= (to_rep aux2__first) o42) true false)))
(assert (= result3 (ite (= o47 true) o46 false)))
(assert (= result3 true))
...
(assert (= o36 (+ aux3_first o35)))
(assert (and (= o37 o36) (in_range1 o36)))
(assert (= o38 (ite (<= o37 (to_rep aux3__last)) true false)))
(assert (and (= o32 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o33 (+ aux3_first o32)))
(assert (and (= o34 o33) (in_range1 o33)))
(assert (= o39 (ite (<= (to_rep aux3__first) o34) true false)))
(assert (= result4 (ite (= o39 true) o38 false)))
(assert (= result4 true))
...
(assert (= o28 (+ aux4_first o27)))
(assert (and (= o29 o28) (in_range1 o28)))
(assert (= o30 (ite (<= o29 (to_rep aux4__last)) true false)))
