...
(define-fun dynamic_invariant1 ((temp___expr_201 Int) (temp___is_init_197 Bool) (temp___skip_constant_198 Bool) (temp___do_toplevel_199 Bool) (temp___do_typ_inv_200 Bool)) Bool (=> (or (= temp___is_init_197 true) (<= 0 65535)) (in_range1 temp___expr_201)))
...
(define-fun dynamic_invariant2 ((temp___expr_304 (_ BitVec 64)) (temp___is_init_300 Bool) (temp___skip_constant_301 Bool) (temp___do_toplevel_302 Bool) (temp___do_typ_inv_303 Bool)) Bool true)
(declare-sort target 0)
(declare-fun targetqtint (target) Int)
(assert (forall ((i target)) (and (<= (- 9223372036854775808) (targetqtint i)) (<= (targetqtint i) 9223372036854775807))))
...
(define-fun dynamic_invariant3 ((temp___expr_311 Int) (temp___is_init_307 Bool) (temp___skip_constant_308 Bool) (temp___do_toplevel_309 Bool) (temp___do_typ_inv_310 Bool)) Bool (=> (or (= temp___is_init_307 true) (<= (- 9223372036854775808) 9223372036854775807)) (in_range3 temp___expr_311)))
(assert (forall ((s (_ BitVec 64))) (! (=> (dynamic_invariant2 s true true true true) (dynamic_invariant3 (xdr_unsigned_to_hyper s) true false true true)) :pattern ((xdr_unsigned_to_hyper s)))))
(declare-sort xdr_hyper 0)
(declare-fun xdr_hyperqtint (xdr_hyper) Int)
(assert (forall ((i xdr_hyper)) (and (<= (- 9223372036854775808) (xdr_hyperqtint i)) (<= (xdr_hyperqtint i) 9223372036854775807))))
...
(declare-datatypes () ((xdr_hyper__ref (mk_xdr_hyper__ref (xdr_hyper__content xdr_hyper)))))
(define-fun xdr_hyper__ref___projection ((a xdr_hyper__ref)) xdr_hyper (xdr_hyper__content a))
(define-fun dynamic_invariant4 ((temp___expr_180 Int) (temp___is_init_176 Bool) (temp___skip_constant_177 Bool) (temp___do_toplevel_178 Bool) (temp___do_typ_inv_179 Bool)) Bool (=> (or (= temp___is_init_176 true) (<= (- 9223372036854775808) 9223372036854775807)) (in_range4 temp___expr_180)))
(define-fun dynamic_invariant5 ((temp___expr_222 us_t) (temp___is_init_218 Bool) (temp___skip_constant_219 Bool) (temp___do_toplevel_220 Bool) (temp___do_typ_inv_221 Bool)) Bool (=> (not (= temp___skip_constant_219 true)) (dynamic_property 0 65535 (first1 temp___expr_222) (last1 temp___expr_222))))
...
(define-fun dynamic_invariant7 ((temp___expr_194 (_ BitVec 8)) (temp___is_init_190 Bool) (temp___skip_constant_191 Bool) (temp___do_toplevel_192 Bool) (temp___do_typ_inv_193 Bool)) Bool true)
(declare-const value Int)
(declare-const last2 Int)
(assert (dynamic_invariant5 data true false true true))
(assert (in_range1 position))
(assert (=> (<= (- 9223372036854775808) 9223372036854775807) (in_range4 value)))
(assert (=> (<= 0 65535) (in_range1 last2)))
(assert (and (and (and (= (mod1 position 4) 0) (= (mod1 (length data) 4) 0)) (and (<= (to_rep (first (rt data))) position) (<= position (to_rep (last (rt data)))))) (<= (+ position 7) (to_rep (last (rt data))))))
