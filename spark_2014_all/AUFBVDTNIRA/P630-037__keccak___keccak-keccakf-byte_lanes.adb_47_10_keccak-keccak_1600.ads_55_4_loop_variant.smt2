...
(assert (= offset3 o104))
(assert (and (= o105 (- remaining_bits2 64)) (in_range2 (- remaining_bits2 64))))
(assert (= result29 (mk_int__ref remaining_bits2)))
(assert (= remaining_bits3 o105))
(assert (<= 64 remaining_bits3))
(assert (not (or (< temp___7282 offset3) (and (= offset3 temp___7282) (< remaining_bits3 temp___7272)))))
(check-sat)
(exit)
