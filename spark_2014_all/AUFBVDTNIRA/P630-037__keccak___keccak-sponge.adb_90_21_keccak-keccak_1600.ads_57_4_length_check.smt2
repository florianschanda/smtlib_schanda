...
(assert (not (= (ite (<= (to_rep1 (first8 (rt4 temp___817))) (to_rep1 (last8 (rt4 temp___817)))) (+ (- (to_rep1 (last8 (rt4 temp___817))) (to_rep1 (first8 (rt4 temp___817)))) 1) 0) (ite (<= r81s r82s) (+ (- r82s r81s) 1) 0))))
(check-sat)
(exit)
