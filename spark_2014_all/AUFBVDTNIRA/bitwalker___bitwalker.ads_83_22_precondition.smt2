...
(assert (= result2 (ite (<= 0 i) o14 false)))
(assert (= result2 true))
(assert (not (= i left)))
(assert (and (= o16 (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) i)) (= (= o16 true) (= (nth (to_rep1 (select addr (div1 i 8))) (- 7 (mod1 i 8))) true))))
