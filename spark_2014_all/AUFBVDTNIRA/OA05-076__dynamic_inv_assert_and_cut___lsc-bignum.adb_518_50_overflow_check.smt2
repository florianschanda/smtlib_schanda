...
(assert (= o251 (+ o250 1)))
(assert (and (= o252 o251) (in_range1 o251)))
(assert (and (= o253 o252) (in_range2 o252)))
(assert (and (= o248 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o249 (num_of_big_int x x_first o248)))
(assert (= o254 (oexpon o249 o253)))
(assert (= o258 (omultiply o254 o257)))
(assert (= o261 (omod o258 o260)))
(assert (and (= o247 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (and (= o241 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o242 (* n1 o241)))
(assert (and (= o243 o242) (in_range1 o242)))
(assert (= o244 (+ aux4_first o243)))
(assert (not (in_range1 o244)))
(check-sat)
(exit)
