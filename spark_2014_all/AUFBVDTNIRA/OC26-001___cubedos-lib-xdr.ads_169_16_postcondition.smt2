...
(define-fun dynamic_invariant1 ((temp___expr_201 Int) (temp___is_init_197 Bool) (temp___skip_constant_198 Bool) (temp___do_toplevel_199 Bool) (temp___do_typ_inv_200 Bool)) Bool (=> (or (= temp___is_init_197 true) (<= 0 65535)) (in_range4 temp___expr_201)))
...
(define-fun dynamic_invariant2 ((temp___expr_208 Int) (temp___is_init_204 Bool) (temp___skip_constant_205 Bool) (temp___do_toplevel_206 Bool) (temp___do_typ_inv_207 Bool)) Bool (=> (or (= temp___is_init_204 true) (<= (- 1) 65535)) (in_range5 temp___expr_208)))
...
(declare-fun temp___558 ((_ BitVec 8) Int Int) us_t3)
...
(declare-const temp___569 (Array Int octet))
...
(assert (= (to_rep1 (first6 (rt3 (temp___558 #x00 0 (- (length value) 1))))) 0))
(assert (= (to_rep1 (last6 (rt3 (temp___558 #x00 0 (- (length value) 1))))) (- (length value) 1)))
(assert (= (mk___t3 temp___565 temp___5651) (temp___558 #x00 0 (- (length value) 1))))
...
(assert (=> (and (<= (to_rep1 (first (rt value))) i1) (<= i1 (to_rep1 (last (rt value))))) (= temp___569 temporary_array1)))
...
(assert (=> (and (<= (to_rep1 (first (rt value))) i1) (<= i1 (to_rep1 (last (rt value))))) (and (= temp___567 (- i2 (to_rep1 (first (rt value))))) (in_range1 (- i2 (to_rep1 (first (rt value))))))))
(assert (=> (and (<= (to_rep1 (first (rt value))) i1) (<= i1 (to_rep1 (last (rt value))))) (and (<= (to_rep1 temporary_array__first) temp___567) (<= temp___567 (to_rep1 temporary_array__last)))))
(assert (=> (and (<= (to_rep1 (first (rt value))) i1) (<= i1 (to_rep1 (last (rt value))))) (= o4 temp___567)))
