...
(define-fun dynamic_invariant1 ((temp___expr_172 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= 0 65535)) (in_range4 temp___expr_172)))
...
(define-fun dynamic_invariant2 ((temp___expr_178 Int) (temp___is_init_175 Bool) (temp___skip_constant_176 Bool) (temp___do_toplevel_177 Bool)) Bool (=> (or (= temp___is_init_175 true) (<= (- 1) 65535)) (in_range5 temp___expr_178)))
...
(define-fun dynamic_invariant4 ((temp___expr_358 us_t2) (temp___is_init_355 Bool) (temp___skip_constant_356 Bool) (temp___do_toplevel_357 Bool)) Bool (=> (not (= temp___skip_constant_356 true)) (and (dynamic_property3 0 (- (length value) 1) (first5 temp___expr_358) (last5 temp___expr_358)) (and (= (first5 temp___expr_358) 0) (= (last5 temp___expr_358) (- (length value) 1))))))
...
(assert (forall ((temp___501 (_ BitVec 8))) (forall ((temp___502 Int) (temp___503 Int)) (let ((temp___500 (temp___499 temp___501 temp___502 temp___503))) (and (=> (dynamic_property1 0 65535 temp___502 temp___503) (and (= (first7 temp___500) temp___502) (= (last7 temp___500) temp___503))) (forall ((temp___504 Int)) (= (select (to_array3 temp___500) temp___504) (of_rep2 temp___501))))))))
...
(define-fun dynamic_invariant9 ((temp___expr_190 us_t1) (temp___is_init_187 Bool) (temp___skip_constant_188 Bool) (temp___do_toplevel_189 Bool)) Bool (=> (not (= temp___skip_constant_188 true)) (dynamic_property1 0 65535 (first3 temp___expr_190) (last3 temp___expr_190))))
...
(assert (and (and (and (dynamic_property3 0 (- (length value) 1) (to_rep1 temporary_array__first) (to_rep1 temporary_array__last)) (and (= (to_rep1 temporary_array__first) 0) (= (to_rep1 temporary_array__last) (- (length value) 1)))) (and (and (and (and (and (and (= (to_rep1 (first6 (rt3 (temp___499 ((_ int2bv 8) 0) 0 (- (length value) 1))))) 0) (and (= (to_rep1 (last6 (rt3 (temp___499 ((_ int2bv 8) 0) 0 (- (length value) 1))))) (- (length value) 1)) (= (mk___t3 temp___506 temp___5061) (temp___499 ((_ int2bv 8) 0) 0 (- (length value) 1))))) (and (= (ite (<= (to_rep1 (first6 temp___5061)) (to_rep1 (last6 temp___5061))) (+ (- (to_rep1 (last6 temp___5061)) (to_rep1 (first6 temp___5061))) 1) 0) (ite (<= 0 (- (length value) 1)) (+ (- (- (length value) 1) 0) 1) 0)) (and (= temp___506 temp___507) (= (mk2 (to_rep1 (first6 temp___5061)) (to_rep1 (last6 temp___5061))) temp___5071)))) (and (= (ite (<= (to_rep1 (first4 temp___5071)) (to_rep1 (last4 temp___5071))) (+ (- (to_rep1 (last4 temp___5071)) (to_rep1 (first4 temp___5071))) 1) 0) (ite (<= (to_rep1 temporary_array__first) (to_rep1 temporary_array__last)) (+ (- (to_rep1 temporary_array__last) (to_rep1 temporary_array__first)) 1) 0)) (= (mk___t2 o9 o10) (mk___t2 temp___507 temp___5071)))) (= o11 o9)) (and (= (mk_map__ref1 result3) (mk_map__ref1 temporary_array)) (= temporary_array1 o11))) (and (and (and (= (mk_int__ref result4) (mk_int__ref i)) (= i1 (to_rep1 (first (rt value))))) (ite (and (<= (to_rep1 (first (rt value))) i1) (<= i1 (to_rep1 (last (rt value))))) (and (and (and (= temp___510 temporary_array1) (and (and (<= (to_rep1 (first (rt value))) i2) (<= i2 (to_rep1 (last (rt value))))) (and (and (and (= (to_rep2 o12) ((_ int2bv 8) (to_rep (select (elts value) i2)))) (and (and (and (= temp___508 (- i2 (to_rep1 (first (rt value))))) (in_range1 (- i2 (to_rep1 (first (rt value)))))) (and (and (<= (to_rep1 temporary_array__first) temp___508) (<= temp___508 (to_rep1 temporary_array__last))) (= o13 temp___508))) (= o14 (store temporary_array2 o13 o12)))) (and (= temporary_array2 result5) (= temporary_array3 o14))) (= i2 (to_rep1 (last (rt value))))))) (and (and (= i2 i3) (= temporary_array3 temporary_array4)) (and (= i4 i2) (= temporary_array5 temporary_array3)))) (and (and (= (mk_int__ref i5) (mk_int__ref i3)) (= (mk_map__ref1 temporary_array6) (mk_map__ref1 temporary_array4))) (and (= i6 i4) (= temporary_array7 temporary_array5)))) (and (and (= i1 i5) (= temporary_array1 temporary_array6)) (and (= i6 i1) (= temporary_array7 temporary_array1))))) (and (= last9 (+ position (- (length_with_padding (length1 (mk___t1 temporary_array6 (mk1 (to_rep1 temporary_array__first) (to_rep1 temporary_array__last))))) 1))) (in_range5 last9))))) (and (and (= (mk_int__ref i7) (mk_int__ref i5)) (and (= (mk_map__ref1 temporary_array8) (mk_map__ref1 temporary_array6)) (and (= last9 last10) (= data data1)))) (and (= i8 i6) (and (= temporary_array9 temporary_array7) (and (= last11 last9) (= data2 data)))))))
