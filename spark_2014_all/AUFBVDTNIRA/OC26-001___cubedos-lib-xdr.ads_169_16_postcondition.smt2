...
(assert (= (to_rep1 (first6 (rt3 (temp___499 ((_ int2bv 8) 0) 0 (- (length value) 1))))) 0))
(assert (= (to_rep1 (last6 (rt3 (temp___499 ((_ int2bv 8) 0) 0 (- (length value) 1))))) (- (length value) 1)))
(assert (= (mk___t3 temp___506 temp___5061) (temp___499 ((_ int2bv 8) 0) 0 (- (length value) 1))))
(assert (= (ite (<= (to_rep1 (first6 temp___5061)) (to_rep1 (last6 temp___5061))) (+ (- (to_rep1 (last6 temp___5061)) (to_rep1 (first6 temp___5061))) 1) 0) (ite (<= 0 (- (length value) 1)) (+ (- (- (length value) 1) 0) 1) 0)))
(assert (= temp___506 temp___507))
(assert (= (mk2 (to_rep1 (first6 temp___5061)) (to_rep1 (last6 temp___5061))) temp___5071))
(assert (= (ite (<= (to_rep1 (first4 temp___5071)) (to_rep1 (last4 temp___5071))) (+ (- (to_rep1 (last4 temp___5071)) (to_rep1 (first4 temp___5071))) 1) 0) (ite (<= (to_rep1 temporary_array__first) (to_rep1 temporary_array__last)) (+ (- (to_rep1 temporary_array__last) (to_rep1 temporary_array__first)) 1) 0)))
...
(assert (=> (and (<= (to_rep1 (first (rt value))) i1) (<= i1 (to_rep1 (last (rt value))))) (= temp___510 temporary_array1)))
...
(assert (=> (and (<= (to_rep1 (first (rt value))) i1) (<= i1 (to_rep1 (last (rt value))))) (and (= temp___508 (- i2 (to_rep1 (first (rt value))))) (in_range1 (- i2 (to_rep1 (first (rt value))))))))
(assert (=> (and (<= (to_rep1 (first (rt value))) i1) (<= i1 (to_rep1 (last (rt value))))) (and (<= (to_rep1 temporary_array__first) temp___508) (<= temp___508 (to_rep1 temporary_array__last)))))
(assert (=> (and (<= (to_rep1 (first (rt value))) i1) (<= i1 (to_rep1 (last (rt value))))) (= o4 temp___508)))
...
(assert (and (= last9 (+ position (- (length_with_padding (length1 (mk___t1 temporary_array6 (mk1 (to_rep1 temporary_array__first) (to_rep1 temporary_array__last))))) 1))) (in_range5 last9)))
