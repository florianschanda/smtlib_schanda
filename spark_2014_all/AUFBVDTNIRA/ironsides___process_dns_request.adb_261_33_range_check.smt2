...
(assert (and (= o16 (* block2 32)) (in_range1 (* block2 32))))
(assert (and (= o17 o16) (in_range3 o16)))
(assert (= o18 (ite (<= dstbytes3 o17) true false)))
(assert (and (= o15 (* (- block2 1) 34)) (in_range1 (* (- block2 1) 34))))
(assert (not (in_range4 o15)))
(check-sat)
(exit)
