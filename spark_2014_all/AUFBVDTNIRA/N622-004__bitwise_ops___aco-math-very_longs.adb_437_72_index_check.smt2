...
(define-fun dynamic_invariant4 ((temp___expr_819 us_rep1) (temp___is_init_816 Bool) (temp___skip_constant_817 Bool) (temp___do_toplevel_818 Bool)) Bool (and (=> (not (= temp___skip_constant_817 true)) (in_range3 (+ (* 2 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 divisor)))) 1) (to_base temp___expr_819))) (and (dynamic_property4 1 (+ (* 2 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 divisor)))) 1) (first3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_819))) (last4 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_819)))) (and (= (first3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_819))) 1) (= (last4 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_819))) (+ (* 2 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 divisor)))) 1))))))
...
(define-fun dynamic_invariant6 ((temp___expr_219 (_ BitVec 8)) (temp___is_init_216 Bool) (temp___skip_constant_217 Bool) (temp___do_toplevel_218 Bool)) Bool true)
(declare-const n Int)
...
(assert (dynamic_invariant4 (mk___rep1 u__split_discrs (mk___split_fields1 (mk___t1 u__split_fields u__split_fields1))) true false true))
(assert (dynamic_invariant5 (mk___rep2 v__split_discrs (mk___split_fields2 (mk___t2 v__split_fields v__split_fields1))) true false true))
(assert (in_range2 j))
(assert (and (= o5 (+ j n)) (in_range1 (+ j n))))
(assert (= temp___1522 (- o5 2)))
(assert (and (<= (to_rep2 (first2 u__split_fields1)) temp___1522) (<= temp___1522 (to_rep2 (last3 u__split_fields1)))))
(assert (= o6 temp___1522))
(assert (= o7 (select u__split_fields o6)))
(assert (= o8 (to_rep o7)))
(assert (= o9 ((_ zero_extend 8) o8)))
(assert (and (= o (+ j n)) (in_range1 (+ j n))))
(assert (= temp___1520 (- o 1)))
(assert (and (<= (to_rep2 (first2 u__split_fields1)) temp___1520) (<= temp___1520 (to_rep2 (last3 u__split_fields1)))))
(assert (= o1 temp___1520))
(assert (= o2 (select u__split_fields o1)))
(assert (= o3 (to_rep o2)))
(assert (= o4 ((_ zero_extend 8) o3)))
(assert (= o10 (bvmul ((_ int2bv 16) 256) o4)))
...
(assert (= temp___1530 (- o26 3)))
(assert (and (<= (to_rep2 (first2 u__split_fields1)) temp___1530) (<= temp___1530 (to_rep2 (last3 u__split_fields1)))))
(assert (= o27 temp___1530))
(assert (= o28 (select u__split_fields o27)))
(assert (= o29 (to_rep o28)))
(assert (= o30 ((_ zero_extend 8) o29)))
(assert (= o31 (bvadd (bvmul ((_ int2bv 16) 256) r_hat1) o30)))
...
(assert (= result3 (ite (= q_hat1 ((_ int2bv 16) 256)) true o33)))
(assert (=> (= result3 true) (= q_hat1 result4)))
(assert (=> (= result3 true) (= q_hat2 (bvsub q_hat1 ((_ int2bv 16) 1)))))
...
(assert (bvult r_hat2 ((_ int2bv 16) 256)))
(assert (and (= o39 (+ j n)) (in_range1 (+ j n))))
(assert (= temp___1536 (- o39 3)))
(assert (and (<= (to_rep2 (first2 u__split_fields1)) temp___1536) (<= temp___1536 (to_rep2 (last3 u__split_fields1)))))
(assert (= o40 temp___1536))
(assert (= o41 (select u__split_fields o40)))
(assert (= o42 (to_rep o41)))
(assert (= o43 ((_ zero_extend 8) o42)))
(assert (= o44 (bvadd (bvmul ((_ int2bv 16) 256) r_hat2) o43)))
