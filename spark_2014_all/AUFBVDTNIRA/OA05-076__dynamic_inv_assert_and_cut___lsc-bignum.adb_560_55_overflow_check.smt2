...
(assert (= o84 (bvadd o83 ((_ int2bv 64) 1))))
(assert (= o85 (bvmul o84 ((_ int2bv 64) 32))))
...
(assert (= o70 (from_word32 ((_ int2bv 32) 2))))
...
(assert (= o21 (num_of_big_int (mk___t aux31 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first o20)))
