...
(assert (not (= (to_rep (rec__very_longs__very_long__octet_length u__split_discrs)) (+ (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 dividend))) 1))))
(check-sat)
(exit)
