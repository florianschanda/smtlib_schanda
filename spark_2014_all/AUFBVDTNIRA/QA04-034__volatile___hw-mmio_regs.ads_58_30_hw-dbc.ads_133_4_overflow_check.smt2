...
(define-fun dynamic_invariant1 ((temp___expr_844 (_ BitVec 32)) (temp___is_init_840 Bool) (temp___skip_constant_841 Bool) (temp___do_toplevel_842 Bool) (temp___do_typ_inv_843 Bool)) Bool true)
(define-fun dynamic_invariant2 ((temp___expr_348 (_ BitVec 32)) (temp___is_init_344 Bool) (temp___skip_constant_345 Bool) (temp___do_toplevel_346 Bool) (temp___do_typ_inv_347 Bool)) Bool true)
...
(assert (= o6 (ite (<= o5 32) true false)))
