...
(define-fun t__ref___2__projection ((a t__ref1)) us_rep (t__content1 a))
...
(declare-fun user_eq5 (word_t word_t) Bool)
(declare-const dummy5 word_t)
...
(define-fun dynamic_invariant3 ((temp___expr_746 (_ BitVec 32)) (temp___is_init_743 Bool) (temp___skip_constant_744 Bool) (temp___do_toplevel_745 Bool)) Bool true)
...
(assert (= o8 (ite (<= o7 32) true false)))
