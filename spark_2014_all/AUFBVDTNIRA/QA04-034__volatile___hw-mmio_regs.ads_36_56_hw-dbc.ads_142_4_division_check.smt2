...
(declare-fun user_eq2 (word8 word8) Bool)
(declare-const dummy2 word8)
...
(define-fun dynamic_invariant2 ((temp___expr_905 Int) (temp___is_init_901 Bool) (temp___skip_constant_902 Bool) (temp___do_toplevel_903 Bool) (temp___do_typ_inv_904 Bool)) Bool (=> (or (= temp___is_init_901 true) (<= 0 1)) (in_range3 temp___expr_905)))
...
(define-fun dynamic_invariant3 ((temp___expr_955 (_ BitVec 8)) (temp___is_init_951 Bool) (temp___skip_constant_952 Bool) (temp___do_toplevel_953 Bool) (temp___do_typ_inv_954 Bool)) Bool true)
