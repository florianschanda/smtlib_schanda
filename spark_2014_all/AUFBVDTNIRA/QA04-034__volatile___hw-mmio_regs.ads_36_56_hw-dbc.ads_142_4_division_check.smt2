...
(declare-fun user_eq3 (word_t word_t) Bool)
(declare-const dummy3 word_t)
(declare-datatypes () ((word_t__ref (mk_word_t__ref (word_t__content word_t)))))
(define-fun word_t__ref___17__projection ((a word_t__ref)) word_t (word_t__content a))
(define-fun dynamic_invariant1 ((temp___expr_955 (_ BitVec 8)) (temp___is_init_951 Bool) (temp___skip_constant_952 Bool) (temp___do_toplevel_953 Bool) (temp___do_typ_inv_954 Bool)) Bool true)
...
(define-fun dynamic_invariant2 ((temp___expr_334 (_ BitVec 8)) (temp___is_init_330 Bool) (temp___skip_constant_331 Bool) (temp___do_toplevel_332 Bool) (temp___do_typ_inv_333 Bool)) Bool true)
...
(define-fun dynamic_invariant3 ((temp___expr_905 Int) (temp___is_init_901 Bool) (temp___skip_constant_902 Bool) (temp___do_toplevel_903 Bool) (temp___do_typ_inv_904 Bool)) Bool (=> (or (= temp___is_init_901 true) (<= 0 1)) (in_range3 temp___expr_905)))
...
(assert (and (= o4 (- (to_rep (rec__hw__dbc__xcap_s_regs__t__msb (us_split_fields1 (select regs idx)))) (to_rep (rec__hw__dbc__xcap_s_regs__t__lsb (us_split_fields1 (select regs idx)))))) (in_range1 (- (to_rep (rec__hw__dbc__xcap_s_regs__t__msb (us_split_fields1 (select regs idx)))) (to_rep (rec__hw__dbc__xcap_s_regs__t__lsb (us_split_fields1 (select regs idx))))))))
(assert (= o5 (+ o4 1)))
(assert (and (= o6 o5) (in_range1 o5)))
(assert (= o7 (ite (<= o6 8) true false)))
(assert (and (= o1 (+ byte_offset (to_rep (rec__hw__dbc__xcap_s_regs__t__byte_offset (us_split_fields1 (select regs idx)))))) (in_range1 (+ byte_offset (to_rep (rec__hw__dbc__xcap_s_regs__t__byte_offset (us_split_fields1 (select regs idx))))))))
(assert (= o2 (div1 o1 4)))
(assert (= o3 (ite (<= o2 16383) true false)))
(assert (and (= o (+ byte_offset (to_rep (rec__hw__dbc__xcap_s_regs__t__byte_offset (us_split_fields1 (select regs idx)))))) (in_range1 (+ byte_offset (to_rep (rec__hw__dbc__xcap_s_regs__t__byte_offset (us_split_fields1 (select regs idx))))))))
(assert (not (not (= 4 0))))
(check-sat)
(exit)
