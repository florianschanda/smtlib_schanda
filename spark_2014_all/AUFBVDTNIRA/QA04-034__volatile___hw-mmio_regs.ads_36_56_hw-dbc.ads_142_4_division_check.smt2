...
(define-fun dynamic_invariant2 ((temp___expr_800 Int) (temp___is_init_797 Bool) (temp___skip_constant_798 Bool) (temp___do_toplevel_799 Bool)) Bool (=> (or (= temp___is_init_797 true) (<= 0 1)) (in_range3 temp___expr_800)))
...
(define-fun dynamic_invariant3 ((temp___expr_847 (_ BitVec 8)) (temp___is_init_844 Bool) (temp___skip_constant_845 Bool) (temp___do_toplevel_846 Bool)) Bool true)
...
(assert (and (= o2 (+ byte_offset (to_rep (rec__hw__dbc__xcap_s_regs__t__byte_offset (us_split_fields1 (select regs idx)))))) (in_range1 (+ byte_offset (to_rep (rec__hw__dbc__xcap_s_regs__t__byte_offset (us_split_fields1 (select regs idx))))))))
(assert (= o3 (div1 o2 4)))
