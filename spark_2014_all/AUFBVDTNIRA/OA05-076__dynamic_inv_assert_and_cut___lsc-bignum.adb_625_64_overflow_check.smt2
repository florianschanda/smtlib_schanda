...
(assert (and (= o28 o27) (uint_in_range1 o27)))
(assert (= o29 ((_ int2bv 64) o28)))
(assert (= o30 (bvadd o29 ((_ int2bv 64) 1))))
(assert (= o31 (bvmul o30 ((_ int2bv 64) 32))))
(assert (= o32 (ite (bvult i2 o31) true false)))
(assert (= o24 (from_word32 ((_ int2bv 32) 1))))
(assert (= o23 (from_word64 i2)))
(assert (= o25 (oadd o23 o24)))
(assert (= o22 (from_integer s10)))
(assert (= o26 (ole o22 o25)))
(assert (and (= o20 (+ k 1)) (in_range1 (+ k 1))))
(assert (= o21 (ite (<= s10 o20) true false)))
(assert (= o18 (from_word32 ((_ int2bv 32) 2))))
(assert (= o19 (oexpon o18 s10)))
(assert (= o14 (from_word32 ((_ int2bv 32) 1))))
(assert (= o13 (from_integer s10)))
(assert (= o15 (osubtract o13 o14)))
(assert (= o12 (from_word64 i2)))
(assert (= o16 (osubtract o12 o15)))
(assert (= o11 (from_word32 ((_ int2bv 32) 2))))
(assert (= o17 (oexpon__2 o11 o16)))
