...
(assert (and (= o1 (+ (to_rep (rec__hw__dbc__xcap_s_regs__t__msb (us_split_fields1 (select regs idx)))) 1)) (in_range1 (+ (to_rep (rec__hw__dbc__xcap_s_regs__t__msb (us_split_fields1 (select regs idx)))) 1))))
(assert (= o2 (- o1 (to_rep (rec__hw__dbc__xcap_s_regs__t__lsb (us_split_fields1 (select regs idx)))))))
(assert (and (= o3 o2) (in_range1 o2)))
(assert (and (= o4 o3) (in_range2 o3)))
(assert (= o5 (power 2 o4)))
(assert (and (= o6 o5) (in_range3 o5)))
(assert (and (= o7 o6) (uint_in_range1 o6)))
(assert (= o8 ((_ int2bv 64) o7)))
(assert (= o9 (ite (bvult ((_ zero_extend 56) value) o8) true false)))
(assert (and (= o 8) (in_range1 8)))
(assert (not (in_range1 (- (to_rep (rec__hw__dbc__xcap_s_regs__t__msb (us_split_fields1 (select regs idx)))) (to_rep (rec__hw__dbc__xcap_s_regs__t__lsb (us_split_fields1 (select regs idx))))))))
(check-sat)
(exit)
