...
(assert (= o50 (+ x_first o49)))
(assert (and (= o51 o50) (in_range1 o50)))
(assert (= o52 (ite (<= o51 (to_rep (last (rt x)))) true false)))
(assert (and (= o46 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o47 (+ x_first o46)))
(assert (and (= o48 o47) (in_range1 o47)))
(assert (= o53 (ite (<= (to_rep (first (rt x))) o48) true false)))
(assert (= result (ite (= o53 true) o52 false)))
(assert (= result true))
...
(assert (= o42 (+ m_first o41)))
(assert (and (= o43 o42) (in_range1 o42)))
(assert (= o44 (ite (<= o43 (to_rep (last (rt m)))) true false)))
(assert (and (= o38 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o39 (+ m_first o38)))
(assert (and (= o40 o39) (in_range1 o39)))
(assert (= o45 (ite (<= (to_rep (first (rt m))) o40) true false)))
(assert (= result1 (ite (= o45 true) o44 false)))
(assert (= result1 true))
...
(assert (= o34 (+ aux1_first o33)))
(assert (and (= o35 o34) (in_range1 o34)))
(assert (= o36 (ite (<= o35 (to_rep aux1__last)) true false)))
(assert (and (= o30 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o31 (+ aux1_first o30)))
(assert (and (= o32 o31) (in_range1 o31)))
(assert (= o37 (ite (<= (to_rep aux1__first) o32) true false)))
(assert (= result2 (ite (= o37 true) o36 false)))
(assert (= result2 true))
...
(assert (= o26 (+ aux2_first o25)))
(assert (and (= o27 o26) (in_range1 o26)))
(assert (= o28 (ite (<= o27 (to_rep aux2__last)) true false)))
(assert (and (= o22 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o23 (+ aux2_first o22)))
(assert (and (= o24 o23) (in_range1 o23)))
(assert (= o29 (ite (<= (to_rep aux2__first) o24) true false)))
(assert (= result3 (ite (= o29 true) o28 false)))
(assert (= result3 true))
...
(assert (= o18 (+ aux3_first o17)))
(assert (and (= o19 o18) (in_range1 o18)))
(assert (= o20 (ite (<= o19 (to_rep aux3__last)) true false)))
(assert (and (= o14 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o15 (+ aux3_first o14)))
(assert (and (= o16 o15) (in_range1 o15)))
(assert (= o21 (ite (<= (to_rep aux3__first) o16) true false)))
(assert (= result4 (ite (= o21 true) o20 false)))
(assert (= result4 true))
...
(assert (and (= o6 (power 2 k)) (in_range1 (power 2 k))))
(assert (= o7 (* o6 o5)))
...
(assert (= o13 (ite (<= o12 (to_rep aux4__last)) true false)))
