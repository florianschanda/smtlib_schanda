...
(assert (= o39 (+ x_first o38)))
(assert (and (= o40 o39) (in_range1 o39)))
(assert (= o41 (ite (<= o40 (to_rep (last (rt x)))) true false)))
(assert (and (= o35 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o36 (+ x_first o35)))
(assert (and (= o37 o36) (in_range1 o36)))
(assert (= o42 (ite (<= (to_rep (first (rt x))) o37) true false)))
(assert (= result (ite (= o42 true) o41 false)))
(assert (= result true))
...
(assert (= o31 (+ m_first o30)))
(assert (and (= o32 o31) (in_range1 o31)))
(assert (= o33 (ite (<= o32 (to_rep (last (rt m)))) true false)))
(assert (and (= o27 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o28 (+ m_first o27)))
(assert (and (= o29 o28) (in_range1 o28)))
(assert (= o34 (ite (<= (to_rep (first (rt m))) o29) true false)))
(assert (= result1 (ite (= o34 true) o33 false)))
(assert (= result1 true))
...
(assert (= o23 (+ aux1_first o22)))
(assert (and (= o24 o23) (in_range1 o23)))
(assert (= o25 (ite (<= o24 (to_rep aux1__last)) true false)))
(assert (and (= o19 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o20 (+ aux1_first o19)))
(assert (and (= o21 o20) (in_range1 o20)))
(assert (= o26 (ite (<= (to_rep aux1__first) o21) true false)))
...
(assert (= o15 (+ aux2_first o14)))
(assert (and (= o16 o15) (in_range1 o15)))
(assert (= o17 (ite (<= o16 (to_rep aux2__last)) true false)))
(assert (and (= o11 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o12 (+ aux2_first o11)))
(assert (and (= o13 o12) (in_range1 o12)))
(assert (= o18 (ite (<= (to_rep aux2__first) o13) true false)))
(assert (= result3 (ite (= o18 true) o17 false)))
(assert (= result3 true))
...
(assert (= o7 (+ aux3_first o6)))
(assert (and (= o8 o7) (in_range1 o7)))
(assert (= o9 (ite (<= o8 (to_rep aux3__last)) true false)))
(assert (and (= o3 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o4 (+ aux3_first o3)))
(assert (and (= o5 o4) (in_range1 o4)))
(assert (= o10 (ite (<= (to_rep aux3__first) o5) true false)))
