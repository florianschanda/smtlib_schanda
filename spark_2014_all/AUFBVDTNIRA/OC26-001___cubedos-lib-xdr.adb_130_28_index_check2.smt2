...
(assert (<= (to_rep1 (first (rt value))) i1))
(assert (<= i1 (to_rep1 (last (rt value)))))
(assert (and (<= (to_rep1 (first (rt value))) i2) (<= i2 (to_rep1 (last (rt value))))))
(assert (= (to_rep2 o3) ((_ int2bv 8) (to_rep (select (elts value) i2)))))
(assert (and (= temp___569 (- i2 (to_rep1 (first (rt value))))) (in_range1 (- i2 (to_rep1 (first (rt value)))))))
(assert (not (<= (to_rep1 temporary_array__first) temp___569)))
(check-sat)
(exit)
