...
(assert (= (to_rep2 o12) ((_ int2bv 8) (to_rep (select (elts value) i2)))))
(assert (and (= temp___508 (- i2 (to_rep1 (first (rt value))))) (in_range1 (- i2 (to_rep1 (first (rt value)))))))
(assert (not (<= (to_rep1 temporary_array__first) temp___508)))
(check-sat)
(exit)
