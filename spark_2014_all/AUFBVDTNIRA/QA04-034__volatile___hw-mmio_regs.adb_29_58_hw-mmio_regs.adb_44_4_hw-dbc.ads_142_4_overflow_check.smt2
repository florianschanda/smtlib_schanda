...
(define-fun word_t__ref___19__projection ((a word_t__ref)) word_t (word_t__content a))
(define-fun dynamic_invariant5 ((temp___expr_973 (_ BitVec 32)) (temp___is_init_969 Bool) (temp___skip_constant_970 Bool) (temp___do_toplevel_971 Bool) (temp___do_typ_inv_972 Bool)) Bool true)
...
(declare-const hw__dbc__xcap_regs__read_i__3__off__assume Int)
...
(assert (= o1 (div1 o 4)))
(assert (and (= hw__dbc__xcap_regs__read_i__3__off__assume o1) (in_range2 o1)))
(assert (= hw__dbc__xcap_regs__read_i__3__off__assume off))
...
(assert (= o3 (- o2 (to_rep (rec__hw__dbc__xcap_s_regs__t__lsb (us_split_fields1 (select regs idx)))))))
