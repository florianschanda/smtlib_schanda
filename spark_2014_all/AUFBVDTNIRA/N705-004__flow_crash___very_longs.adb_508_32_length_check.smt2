...
(assert (not (= (ite (<= (to_rep2 (first9 temp___10831)) (to_rep2 (last10 temp___10831))) (+ (- (to_rep2 (last10 temp___10831)) (to_rep2 (first9 temp___10831))) 1) 0) (ite (<= 1 r137b) (+ (- r137b 1) 1) 0))))
(check-sat)
(exit)
