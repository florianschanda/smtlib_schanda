...
(assert (and (= o4 (max_input_length (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1)))) (and (in_range4 o4) (= o4 (- (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1))) 2)))))
(assert (= result (ite (<= in_data_bit_length o4) true false)))
(assert (= result true))
(assert (and (= o1 (+ in_data_bit_length 7)) (in_range (+ in_data_bit_length 7))))
(assert (= o2 (div1 o1 8)))
