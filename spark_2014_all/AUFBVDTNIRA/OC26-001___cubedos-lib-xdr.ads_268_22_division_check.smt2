...
(assert (and (= o2 (length_with_padding o1)) (and (in_range4 o2) (= o2 (+ o1 (ite (= (mod1 o1 4) 0) 0 (- 4 (mod1 o1 4))))))))
(assert (= o3 (- o2 1)))
(assert (= o4 (+ position o3)))
(assert (= o5 (ite (<= o4 (to_rep (last (rt data)))) true false)))
(assert (not (not (= 4 0))))
(check-sat)
(exit)
