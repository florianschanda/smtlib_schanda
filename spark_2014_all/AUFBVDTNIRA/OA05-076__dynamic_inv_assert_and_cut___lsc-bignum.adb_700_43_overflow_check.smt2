...
(declare-const aux38 (Array Int word32))
...
(assert (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t aux1 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 ((_ int2bv 32) 1))) true)) (= (oeq (num_of_big_int (mk___t aux2 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t aux3 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (oexpon (base Tuple0) (+ l1 1)) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t aux4 (mk (to_rep aux4__first) (to_rep aux4__last))) aux4_first (+ l1 1)) (omod (omultiply (num_of_big_int x x_first (+ l1 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))
...
(assert (=> (and (<= 1 h1) (<= h1 temp___638)) (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t aux1 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 ((_ int2bv 32) 1))) true)) (= (oeq (num_of_big_int (mk___t aux2 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t aux3 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (oexpon (base Tuple0) (+ l1 1)) (num_of_big_int m m_first (+ l1 1)))) true)) (forall ((n1 Int)) (=> (and (<= 0 n1) (<= n1 (- h2 1))) (= (oeq (num_of_big_int (mk___t aux41 (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n1 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true))))))
(assert (=> (and (<= 1 h1) (<= h1 temp___638)) (and (=> (<= 1 (- (power 2 k) 1)) (dynamic_property1 1 (- (power 2 k) 1) h2)) (and (<= 1 h2) (<= h2 (- (power 2 k) 1))))))
(assert (=> (and (<= 1 h1) (<= h1 temp___638)) (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t aux1 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 ((_ int2bv 32) 1))) true)) (= (oeq (num_of_big_int (mk___t aux2 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t aux3 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (oexpon (base Tuple0) (+ l1 1)) (num_of_big_int m m_first (+ l1 1)))) true)) (forall ((n1 Int)) (=> (and (<= 0 n1) (<= n1 h2)) (= (oeq (num_of_big_int (mk___t aux42 (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n1 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true))))))
(assert (=> (and (<= 1 h1) (<= h1 temp___638)) (=> (<= 0 2147483647) (in_range2 l1))))
(assert (=> (and (<= 1 h1) (<= h1 temp___638)) (=> (<= 1 (- (power 2 k) 1)) (dynamic_property1 1 (- (power 2 k) 1) h2))))
...
(assert (=> (and (<= 1 h1) (<= h1 temp___638)) (= aux45 (mk_map__ref aux43))))
...
(assert (=> (not (and (<= 1 h1) (<= h1 temp___638))) (= h5 (mk_int__ref h1))))
(assert (=> (not (and (<= 1 h1) (<= h1 temp___638))) (= aux45 (mk_map__ref aux4))))
(assert (=> (not (and (<= 1 h1) (<= h1 temp___638))) (= a5 (mk_map__ref a))))
...
(assert (= i1 o7))
(assert (and (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t aux1 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 ((_ int2bv 32) 1))) true)) (= (oeq (num_of_big_int (mk___t aux2 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t aux31 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (omultiply (oexpon__2 (num_of_big_int x x_first (+ l1 1)) (odivide (num_of_big_int e e_first (+ (- e_last e_first) 1)) (oexpon__2 (from_word32 ((_ int2bv 32) 2)) (oadd (from_word64 i2) (from_word32 ((_ int2bv 32) 1)))))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (forall ((n1 Int)) (=> (and (<= 0 n1) (<= n1 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux45) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n1 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))) (bvult i2 (bvmul (bvadd ((_ int2bv 64) (- e_last e_first)) ((_ int2bv 64) 1)) ((_ int2bv 64) 32)))))
(assert (and (=> (<= 0 2147483647) (in_range2 j1)) (=> (<= 0 2147483647) (in_range2 s1))))
(assert (and (= result2 (bit_set e e_first i2)) (= (= result2 true) (not (= (bvand (to_rep1 (select (elts e) (+ e_first (bv2nat (bvudiv i2 ((_ int2bv 64) 32)))))) (let ((temp___455 (bv2nat (bvurem i2 ((_ int2bv 64) 32))))) (ite (< temp___455 4294967296) (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) temp___455)) ((_ int2bv 32) 0)))) ((_ int2bv 32) 0))))))
(assert (=> (= result2 true) (= result3 (mk_t__ref w))))
(assert (=> (= result2 true) (= w1 ((_ int2bv 32) 1))))
(assert (=> (= result2 true) (= result4 (mk_int__ref s1))))
(assert (=> (= result2 true) (= s2 0)))
(assert (=> (= result2 true) (= result5 (mk_int__ref j1))))
(assert (=> (= result2 true) (= j2 1)))
(assert (=> (= result2 true) (= temp___645 s2)))
(assert (=> (= result2 true) (= temp___644 j2)))
(assert (=> (= result2 true) (= temp___643 w1)))
(assert (=> (= result2 true) (and (and (and (and (and (and (and (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t aux1 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 ((_ int2bv 32) 1))) true)) (= (oeq (num_of_big_int (mk___t aux2 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t aux31 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (omultiply (oexpon__2 (num_of_big_int x x_first (+ l1 1)) (odivide (num_of_big_int e e_first (+ (- e_last e_first) 1)) (oexpon__2 (from_word32 ((_ int2bv 32) 2)) (oadd (from_word64 i2) (from_word32 ((_ int2bv 32) 1)))))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (forall ((n1 Int)) (=> (and (<= 0 n1) (<= n1 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux45) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n1 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))) (= (oeq (omultiply (from_word32 w2) (oexpon (from_word32 ((_ int2bv 32) 2)) (- (- j3 s3) 1))) (omod (odivide (num_of_big_int e e_first (+ (- e_last e_first) 1)) (oexpon__2 (from_word32 ((_ int2bv 32) 2)) (osubtract (from_word64 i2) (osubtract (from_integer j3) (from_word32 ((_ int2bv 32) 1)))))) (oexpon (from_word32 ((_ int2bv 32) 2)) j3))) true)) (= (bvurem w2 ((_ int2bv 32) 2)) ((_ int2bv 32) 1))) (<= 0 s3)) (< s3 j3)) (<= j3 (+ k 1))) (= (ole (from_integer j3) (oadd (from_word64 i2) (from_word32 ((_ int2bv 32) 1)))) true)) (bvult i2 (bvmul (bvadd ((_ int2bv 64) (- e_last e_first)) ((_ int2bv 64) 1)) ((_ int2bv 64) 32))))))
(assert (=> (= result2 true) (and (=> (<= 0 2147483647) (in_range2 j3)) (=> (<= 0 2147483647) (in_range2 s3)))))
(assert (=> (= result2 true) (= w3 (mk_t__ref w2))))
(assert (=> (= result2 true) (= s4 (mk_int__ref s3))))
(assert (=> (= result2 true) (= j4 (mk_int__ref j3))))
(assert (=> (= result2 true) (= w4 w2)))
(assert (=> (= result2 true) (= s5 s3)))
(assert (=> (= result2 true) (= j5 j3)))
(assert (=> (= result2 true) (not (and (<= j3 k) (bvule ((_ int2bv 64) j3) i2)))))
(assert (=> (= result2 true) (= w5 w3)))
(assert (=> (= result2 true) (= s6 s4)))
(assert (=> (= result2 true) (= j6 j4)))
(assert (=> (= result2 true) (= w6 w4)))
(assert (=> (= result2 true) (= s7 s5)))
(assert (=> (= result2 true) (= j7 j5)))
(assert (=> (= result2 true) (= w7 w5)))
(assert (=> (= result2 true) (= s8 s6)))
(assert (=> (= result2 true) (= j8 j6)))
(assert (=> (= result2 true) (= w8 w6)))
(assert (=> (= result2 true) (= s9 s7)))
(assert (=> (= result2 true) (= j9 j7)))
(assert (=> (= result2 true) (and (= o8 (+ (int__content s8) 1)) (in_range1 (+ (int__content s8) 1)))))
(assert (=> (= result2 true) (= result6 s8)))
(assert (=> (= result2 true) (= s10 o8)))
(assert (=> (= result2 true) (= s10 r94b)))
(assert (=> (= result2 true) (in_range2 r94b)))
(assert (=> (= result2 true) (= result7 (mk_int__ref h7))))
(assert (=> (= result2 true) (= h8 1)))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= temp___655 s10))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= temp___670 aux31))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= temp___668 a7))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= temp___675 s10))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= temp___666 h8))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (and (and (and (and (and (and (and (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t aux1 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 ((_ int2bv 32) 1))) true)) (= (oeq (num_of_big_int (mk___t aux2 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t aux32 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (omultiply (oexpon__2 (num_of_big_int x x_first (+ l1 1)) (omultiply (odivide (num_of_big_int e e_first (+ (- e_last e_first) 1)) (oexpon__2 (from_word32 ((_ int2bv 32) 2)) (oadd (from_word64 i2) (from_word32 ((_ int2bv 32) 1))))) (oexpon (from_word32 ((_ int2bv 32) 2)) (- h9 1)))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (forall ((n1 Int)) (=> (and (<= 0 n1) (<= n1 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux45) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n1 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))) (= (oeq (from_word32 (t__content w7)) (omod (odivide (num_of_big_int e e_first (+ (- e_last e_first) 1)) (oexpon__2 (from_word32 ((_ int2bv 32) 2)) (osubtract (from_word64 i2) (osubtract (from_integer s10) (from_word32 ((_ int2bv 32) 1)))))) (oexpon (from_word32 ((_ int2bv 32) 2)) s10))) true)) (= (bvurem (t__content w7) ((_ int2bv 32) 2)) ((_ int2bv 32) 1))) (<= 0 s10)) (<= s10 (+ k 1))) (= temp___675 s10)) (= (ole (from_integer s10) (oadd (from_word64 i2) (from_word32 ((_ int2bv 32) 1)))) true)) (bvult i2 (bvmul (bvadd ((_ int2bv 64) (- e_last e_first)) ((_ int2bv 64) 1)) ((_ int2bv 64) 32)))))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (and (=> (<= 1 r94b) (dynamic_property2 1 r94b h9)) (and (<= 1 h9) (<= h9 r94b))))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (and (and (and (and (and (and (and (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t aux1 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 ((_ int2bv 32) 1))) true)) (= (oeq (num_of_big_int (mk___t aux2 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t aux33 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (omultiply (oexpon__2 (num_of_big_int x x_first (+ l1 1)) (omultiply (odivide (num_of_big_int e e_first (+ (- e_last e_first) 1)) (oexpon__2 (from_word32 ((_ int2bv 32) 2)) (oadd (from_word64 i2) (from_word32 ((_ int2bv 32) 1))))) (oexpon (from_word32 ((_ int2bv 32) 2)) h9))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (forall ((n1 Int)) (=> (and (<= 0 n1) (<= n1 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux45) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n1 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))) (= (oeq (from_word32 (t__content w7)) (omod (odivide (num_of_big_int e e_first (+ (- e_last e_first) 1)) (oexpon__2 (from_word32 ((_ int2bv 32) 2)) (osubtract (from_word64 i2) (osubtract (from_integer s10) (from_word32 ((_ int2bv 32) 1)))))) (oexpon (from_word32 ((_ int2bv 32) 2)) s10))) true)) (= (bvurem (t__content w7) ((_ int2bv 32) 2)) ((_ int2bv 32) 1))) (<= 0 s10)) (<= s10 (+ k 1))) (= temp___655 s10)) (= (ole (from_integer s10) (oadd (from_word64 i2) (from_word32 ((_ int2bv 32) 1)))) true)) (bvult i2 (bvmul (bvadd ((_ int2bv 64) (- e_last e_first)) ((_ int2bv 64) 1)) ((_ int2bv 64) 32)))))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (=> (<= 0 2147483647) (in_range2 l1)))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (=> (<= 0 2147483647) (in_range2 s10)))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (=> (<= 1 r94b) (dynamic_property2 1 r94b h9)))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= h9 r94b))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= h10 (mk_int__ref h9)))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= aux34 (mk_map__ref aux33)))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= a9 (mk_map__ref a8)))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= h11 h9))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= aux35 aux33))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= a10 a8))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= h12 h10))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= aux36 aux34))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= a11 a9))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= h13 h11))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= aux37 aux35))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= a12 a10))))
(assert (=> (= result2 true) (=> (not (and (<= 1 h8) (<= h8 r94b))) (= h12 (mk_int__ref h8)))))
(assert (=> (= result2 true) (=> (not (and (<= 1 h8) (<= h8 r94b))) (= aux36 (mk_map__ref aux31)))))
(assert (=> (= result2 true) (=> (not (and (<= 1 h8) (<= h8 r94b))) (= a11 (mk_map__ref a7)))))
(assert (=> (= result2 true) (=> (not (and (<= 1 h8) (<= h8 r94b))) (= h13 h8))))
(assert (=> (= result2 true) (=> (not (and (<= 1 h8) (<= h8 r94b))) (= aux37 aux31))))
(assert (=> (= result2 true) (=> (not (and (<= 1 h8) (<= h8 r94b))) (= a12 a7))))
(assert (=> (= result2 true) (and (= o9 (+ l1 1)) (in_range1 (+ l1 1)))))
(assert (=> (= result2 true) (and (= o10 (bv2nat (bvlshr (t__content w7) ((_ int2bv 32) 1)))) (in_range2 (bv2nat (bvlshr (t__content w7) ((_ int2bv 32) 1)))))))
(assert (=> (= result2 true) (= o11 (* o10 o9))))
(assert (=> (= result2 true) (and (= o12 o11) (in_range1 o11))))
(assert (=> (= result2 true) (= o13 (+ aux4_first o12))))
(assert (=> (= result2 true) (and (= o14 o13) (in_range1 o13))))
(assert (=> (= result2 true) (and (= o15 o14) (in_range2 o14))))
(assert (=> (= result2 true) (= (oeq (num_of_big_int (mk___t a13 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omod (omultiply (omultiply (num_of_big_int (mk___t (map__content aux36) (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ (- a_last a_first) 1)) (num_of_big_int (mk___t (map__content aux45) (mk (to_rep aux4__first) (to_rep aux4__last))) o15 (+ (- a_last a_first) 1))) (oexpon (inverse (num_of_big_int m m_first (+ (- a_last a_first) 1)) (base Tuple0)) (+ (- a_last a_first) 1))) (num_of_big_int m m_first (+ (- a_last a_first) 1)))) true)))
(assert (=> (= result2 true) (forall ((k1 Int)) (=> (and (<= (to_rep aux3__first) k1) (<= k1 (to_rep aux3__last))) (and (=> (and (<= aux3_first k1) (<= k1 (- (+ aux3_first a_last) a_first))) (= (to_rep1 (select aux38 k1)) (to_rep1 (select a13 (- (+ a_first k1) aux3_first))))) (=> (=> (<= aux3_first k1) (not (<= k1 (- (+ aux3_first a_last) a_first)))) (= (to_rep1 (select aux38 k1)) (to_rep1 (select (map__content aux36) k1)))))))))
(assert (=> (= result2 true) (= h14 h12)))
(assert (=> (= result2 true) (= w9 w7)))
(assert (=> (= result2 true) (= s12 (mk_int__ref s10))))
(assert (=> (= result2 true) (= j10 j8)))
(assert (=> (= result2 true) (= aux310 (mk_map__ref aux38))))
(assert (=> (= result2 true) (= a15 (mk_map__ref a13))))
(assert (=> (= result2 true) (= h15 h13)))
(assert (=> (= result2 true) (= w10 w8)))
(assert (=> (= result2 true) (= s13 s10)))
(assert (=> (= result2 true) (= j11 j9)))
(assert (=> (= result2 true) (= aux311 aux38)))
(assert (=> (= result2 true) (= a16 a13)))
(assert (=> (not (= result2 true)) (= result8 (mk_int__ref s1))))
(assert (=> (not (= result2 true)) (= s11 1)))
(assert (=> (not (= result2 true)) (= (oeq (num_of_big_int (mk___t a14 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omod (omultiply (omultiply (num_of_big_int (mk___t aux31 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ (- a_last a_first) 1)) (num_of_big_int (mk___t aux31 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ (- a_last a_first) 1))) (oexpon (inverse (num_of_big_int m m_first (+ (- a_last a_first) 1)) (base Tuple0)) (+ (- a_last a_first) 1))) (num_of_big_int m m_first (+ (- a_last a_first) 1)))) true)))
(assert (=> (not (= result2 true)) (forall ((k1 Int)) (=> (and (<= (to_rep aux3__first) k1) (<= k1 (to_rep aux3__last))) (and (=> (and (<= aux3_first k1) (<= k1 (- (+ aux3_first a_last) a_first))) (= (to_rep1 (select aux39 k1)) (to_rep1 (select a14 (- (+ a_first k1) aux3_first))))) (=> (=> (<= aux3_first k1) (not (<= k1 (- (+ aux3_first a_last) a_first)))) (= (to_rep1 (select aux39 k1)) (to_rep1 (select aux31 k1)))))))))
(assert (=> (not (= result2 true)) (= h14 (mk_int__ref h7))))
(assert (=> (not (= result2 true)) (= w9 (mk_t__ref w))))
(assert (=> (not (= result2 true)) (= s12 (mk_int__ref s11))))
(assert (=> (not (= result2 true)) (= j10 (mk_int__ref j1))))
(assert (=> (not (= result2 true)) (= aux310 (mk_map__ref aux39))))
(assert (=> (not (= result2 true)) (= a15 (mk_map__ref a14))))
(assert (=> (not (= result2 true)) (= h15 h7)))
(assert (=> (not (= result2 true)) (= w10 w)))
(assert (=> (not (= result2 true)) (= s13 s11)))
(assert (=> (not (= result2 true)) (= j11 j1)))
(assert (=> (not (= result2 true)) (= aux311 aux39)))
(assert (=> (not (= result2 true)) (= a16 a14)))
(assert (and (= o52 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (and (= o53 o52) (uint_in_range1 o52)))
(assert (= o54 ((_ int2bv 64) o53)))
(assert (= o55 (bvadd o54 ((_ int2bv 64) 1))))
(assert (= o56 (bvmul o55 ((_ int2bv 64) 32))))
(assert (= o57 (ite (bvult i2 o56) true false)))
(assert (= o49 (from_word32 ((_ int2bv 32) 1))))
(assert (= o48 (from_word64 i2)))
(assert (= o50 (oadd o48 o49)))
(assert (= o47 (from_integer (int__content s12))))
(assert (= o51 (ole o47 o50)))
(assert (and (= o42 (power 2 k)) (in_range1 (power 2 k))))
(assert (= o43 (- o42 1)))
(assert (and (= o44 o43) (in_range1 o43)))
(assert (= o45 (ite (<= n o44) true false)))
(assert (= result9 (ite (<= 0 n) o45 false)))
(assert (= (= o46 true) (forall ((n1 Int)) (=> (and (<= 0 n1) (<= n1 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux45) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n1 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))))
(assert (and (= o38 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o39 (num_of_big_int m m_first o38)))
(assert (and (= o35 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (and (= o34 (base Tuple0)) (= o34 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o36 (oexpon o34 o35)))
(assert (= o29 (from_word32 ((_ int2bv 32) 1))))
(assert (= o27 (from_integer (int__content s12))))
(assert (= o26 (from_word64 i2)))
(assert (= o28 (osubtract o26 o27)))
(assert (= o30 (oadd o28 o29)))
(assert (= o25 (from_word32 ((_ int2bv 32) 2))))
(assert (= o31 (oexpon__2 o25 o30)))
(assert (and (= o20 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (= o21 (+ o20 1)))
(assert (and (= o22 o21) (in_range1 o21)))
(assert (and (= o23 o22) (in_range2 o22)))
(assert (= o24 (num_of_big_int e e_first o23)))
(assert (= o32 (odivide o24 o31)))
(assert (and (= o18 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o19 (num_of_big_int x x_first o18)))
(assert (= o33 (oexpon__2 o19 o32)))
(assert (= o37 (omultiply o33 o36)))
(assert (= o40 (omod o37 o39)))
(assert (and (= o16 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o17 (num_of_big_int (mk___t (map__content aux310) (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first o16)))
(assert (= o41 (oeq o17 o40)))
