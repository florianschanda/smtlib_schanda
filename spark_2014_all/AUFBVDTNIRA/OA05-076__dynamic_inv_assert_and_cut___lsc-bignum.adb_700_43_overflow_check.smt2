...
(define-fun dynamic_invariant2 ((temp___expr_223 (_ BitVec 64)) (temp___is_init_220 Bool) (temp___skip_constant_221 Bool) (temp___do_toplevel_222 Bool)) Bool true)
...
(define-fun dynamic_invariant4 ((temp___expr_289 us_t) (temp___is_init_286 Bool) (temp___skip_constant_287 Bool) (temp___do_toplevel_288 Bool)) Bool (=> (not (= temp___skip_constant_287 true)) (dynamic_property 0 2147483646 (first1 temp___expr_289) (last1 temp___expr_289))))
...
(assert (forall ((a us_t)) (forall ((a_first1 Int)) (forall ((i (_ BitVec 64))) (! (=> (and (and (and (dynamic_invariant4 a true true true) (dynamic_invariant a_first1 true true true)) (dynamic_invariant2 i true true true)) (and (and (<= (first1 a) a_first1) (<= a_first1 (last1 a))) (bvule (bvudiv i ((_ int2bv 64) 32)) ((_ int2bv 64) (- (last1 a) a_first1))))) (= (= (bit_set a a_first1 i) true) (not (= (bvand (to_rep1 (select (to_array a) (+ a_first1 (bv2nat (bvudiv i ((_ int2bv 64) 32)))))) (let ((temp___456 (bv2nat (bvurem i ((_ int2bv 64) 32))))) (ite (< temp___456 4294967296) (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) temp___456)) ((_ int2bv 32) 0)))) ((_ int2bv 32) 0))))) :pattern ((bit_set a a_first1 i)))))))
...
(define-fun dynamic_invariant5 ((temp___expr_283 Int) (temp___is_init_280 Bool) (temp___skip_constant_281 Bool) (temp___do_toplevel_282 Bool)) Bool (=> (or (= temp___is_init_280 true) (<= 0 2147483646)) (in_range3 temp___expr_283)))
(assert true)
...
(assert true)
(assert (and (and (<= (to_rep a__first) a_first) (<= a_first (to_rep a__last))) (and (and (<= (to_rep a__first) a_last) (<= a_last (to_rep a__last))) (and (< a_first a_last) (and (and (<= (to_rep (first (rt x))) x_first) (<= x_first (to_rep (last (rt x))))) (and (and (<= (to_rep (first (rt x))) (+ x_first (- a_last a_first))) (<= (+ x_first (- a_last a_first)) (to_rep (last (rt x))))) (and (and (<= (to_rep (first (rt e))) e_first) (<= e_first (to_rep (last (rt e))))) (and (and (<= (to_rep (first (rt e))) e_last) (<= e_last (to_rep (last (rt e))))) (and (<= e_first e_last) (and (and (<= (to_rep (first (rt m))) m_first) (<= m_first (to_rep (last (rt m))))) (and (and (<= (to_rep (first (rt m))) (+ m_first (- a_last a_first))) (<= (+ m_first (- a_last a_first)) (to_rep (last (rt m))))) (and (and (<= (to_rep aux1__first) aux1_first) (<= aux1_first (to_rep aux1__last))) (and (and (<= (to_rep aux1__first) (+ aux1_first (- a_last a_first))) (<= (+ aux1_first (- a_last a_first)) (to_rep aux1__last))) (and (and (<= (to_rep aux2__first) aux2_first) (<= aux2_first (to_rep aux2__last))) (and (and (<= (to_rep aux2__first) (+ aux2_first (- a_last a_first))) (<= (+ aux2_first (- a_last a_first)) (to_rep aux2__last))) (and (and (<= (to_rep aux3__first) aux3_first) (<= aux3_first (to_rep aux3__last))) (and (and (<= (to_rep aux3__first) (+ aux3_first (- a_last a_first))) (<= (+ aux3_first (- a_last a_first)) (to_rep aux3__last))) (and (and (<= (to_rep aux4__first) aux4_first) (<= aux4_first (to_rep aux4__last))) (and (and (<= (to_rep aux4__first) (+ aux4_first (- (* (power 2 k) (+ (- a_last a_first) 1)) 1))) (<= (+ aux4_first (- (* (power 2 k) (+ (- a_last a_first) 1)) 1)) (to_rep aux4__last))) (and (<= k 30) (and (and (<= (to_rep (first (rt r))) r_first) (<= r_first (to_rep (last (rt r))))) (and (and (<= (to_rep (first (rt r))) (+ r_first (- a_last a_first))) (<= (+ r_first (- a_last a_first)) (to_rep (last (rt r))))) (and (= (oeq (num_of_big_int r r_first (+ (- a_last a_first) 1)) (omod (oexpon__2 (base Tuple0) (omultiply (from_integer 2) (from_integer (+ (- a_last a_first) 1)))) (num_of_big_int m m_first (+ (- a_last a_first) 1)))) true) (and (= (olt (from_word32 ((_ int2bv 32) 1)) (num_of_big_int m m_first (+ (- a_last a_first) 1))) true) (= (bvadd ((_ int2bv 32) 1) (bvmul m_inv (to_rep1 (select (elts m) m_first)))) ((_ int2bv 32) 0))))))))))))))))))))))))))
(assert (=> (<= 0 2147483647) (in_range2 j)))
(assert (=> (<= 0 2147483647) (in_range2 l)))
(assert (=> (<= 0 2147483647) (in_range2 s)))
(assert true)
(assert true)
(assert (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t aux11 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 ((_ int2bv 32) 1))) true)) (= (oeq (num_of_big_int (mk___t aux2 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t aux3 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (oexpon (base Tuple0) (+ l1 1)) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t aux4 (mk (to_rep aux4__first) (to_rep aux4__last))) aux4_first (+ l1 1)) (omod (omultiply (num_of_big_int x x_first (+ l1 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))
(assert (=> (<= 0 2147483647) (in_range2 l1)))
(assert (and (= o147 (power 2 k)) (in_range1 (power 2 k))))
(assert (= o148 (- o147 1)))
(assert (and (= temp___638 o148) (in_range1 o148)))
(assert (= (mk_int__ref result11) (mk_int__ref h)))
(assert (= h1 1))
(assert (=> (and (<= 1 h1) (<= h1 temp___638)) (and (and (= temp___636 h1) (and (= temp___633 a) (and (= temp___631 aux4) (and (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t aux11 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 ((_ int2bv 32) 1))) true)) (= (oeq (num_of_big_int (mk___t aux2 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t aux3 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (oexpon (base Tuple0) (+ l1 1)) (num_of_big_int m m_first (+ l1 1)))) true)) (forall ((n7 Int)) (=> (and (<= 0 n7) (<= n7 (- h2 1))) (= (oeq (num_of_big_int (mk___t aux41 (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n7 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n7) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))) (and (and (=> (<= 1 (- (power 2 k) 1)) (dynamic_property1 1 (- (power 2 k) 1) h2)) (and (<= 1 h2) (<= h2 (- (power 2 k) 1)))) (and (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t aux11 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 ((_ int2bv 32) 1))) true)) (= (oeq (num_of_big_int (mk___t aux2 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t aux3 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (oexpon (base Tuple0) (+ l1 1)) (num_of_big_int m m_first (+ l1 1)))) true)) (forall ((n7 Int)) (=> (and (<= 0 n7) (<= n7 h2)) (= (oeq (num_of_big_int (mk___t aux42 (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n7 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n7) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))) (and (=> (<= 0 2147483647) (in_range2 l1)) (and (=> (<= 1 (- (power 2 k) 1)) (dynamic_property1 1 (- (power 2 k) 1) h2)) (= h2 temp___638))))))))) (and (and (= h6 (mk_int__ref h2)) (and (= aux42 aux45) (= a3 a6))) (and (= h7 h2) (and (= aux46 aux42) (= a7 a3)))))))
(assert (=> (and (<= 1 h1) (<= h1 temp___638)) (= h8 h6)))
(assert (=> (and (<= 1 h1) (<= h1 temp___638)) (= aux47 (mk_map__ref aux45))))
(assert (=> (and (<= 1 h1) (<= h1 temp___638)) (= a8 (mk_map__ref a6))))
(assert (=> (and (<= 1 h1) (<= h1 temp___638)) (= h9 h7)))
(assert (=> (and (<= 1 h1) (<= h1 temp___638)) (= aux48 aux46)))
(assert (=> (and (<= 1 h1) (<= h1 temp___638)) (= a9 a7)))
(assert (=> (not (and (<= 1 h1) (<= h1 temp___638))) (= h8 (mk_int__ref h1))))
(assert (=> (not (and (<= 1 h1) (<= h1 temp___638))) (= aux47 (mk_map__ref aux4))))
(assert (=> (not (and (<= 1 h1) (<= h1 temp___638))) (= a8 (mk_map__ref a))))
...
(assert (= result13 (mk_t__ref1 i)))
(assert (= i1 o268))
(assert (and (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t aux11 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 ((_ int2bv 32) 1))) true)) (= (oeq (num_of_big_int (mk___t aux2 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t aux31 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (omultiply (oexpon__2 (num_of_big_int x x_first (+ l1 1)) (odivide (num_of_big_int e e_first (+ (- e_last e_first) 1)) (oexpon__2 (from_word32 ((_ int2bv 32) 2)) (oadd (from_word64 i2) (from_word32 ((_ int2bv 32) 1)))))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (forall ((n7 Int)) (=> (and (<= 0 n7) (<= n7 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux47) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n7 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n7) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))) (bvult i2 (bvmul (bvadd ((_ int2bv 64) (- e_last e_first)) ((_ int2bv 64) 1)) ((_ int2bv 64) 32)))))
(assert (and (=> (<= 0 2147483647) (in_range2 j1)) (=> (<= 0 2147483647) (in_range2 s1))))
(assert (and (= result15 (bit_set e e_first i2)) (= (= result15 true) (not (= (bvand (to_rep1 (select (elts e) (+ e_first (bv2nat (bvudiv i2 ((_ int2bv 64) 32)))))) (let ((temp___455 (bv2nat (bvurem i2 ((_ int2bv 64) 32))))) (ite (< temp___455 4294967296) (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) temp___455)) ((_ int2bv 32) 0)))) ((_ int2bv 32) 0))))))
(assert (=> (= result15 true) (= result16 (mk_t__ref w1))))
(assert (=> (= result15 true) (= w2 ((_ int2bv 32) 1))))
(assert (=> (= result15 true) (= result17 (mk_int__ref s1))))
(assert (=> (= result15 true) (= s2 0)))
(assert (=> (= result15 true) (= result18 (mk_int__ref j1))))
(assert (=> (= result15 true) (= j2 1)))
(assert (=> (= result15 true) (and (and (= temp___645 s2) (and (= temp___644 j2) (and (= temp___643 w2) (and (and (and (and (and (and (and (and (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t aux11 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 ((_ int2bv 32) 1))) true)) (= (oeq (num_of_big_int (mk___t aux2 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t aux31 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (omultiply (oexpon__2 (num_of_big_int x x_first (+ l1 1)) (odivide (num_of_big_int e e_first (+ (- e_last e_first) 1)) (oexpon__2 (from_word32 ((_ int2bv 32) 2)) (oadd (from_word64 i2) (from_word32 ((_ int2bv 32) 1)))))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (forall ((n7 Int)) (=> (and (<= 0 n7) (<= n7 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux47) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n7 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n7) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))) (= (oeq (omultiply (from_word32 w3) (oexpon (from_word32 ((_ int2bv 32) 2)) (- (- j3 s3) 1))) (omod (odivide (num_of_big_int e e_first (+ (- e_last e_first) 1)) (oexpon__2 (from_word32 ((_ int2bv 32) 2)) (osubtract (from_word64 i2) (osubtract (from_integer j3) (from_word32 ((_ int2bv 32) 1)))))) (oexpon (from_word32 ((_ int2bv 32) 2)) j3))) true)) (= (bvurem w3 ((_ int2bv 32) 2)) ((_ int2bv 32) 1))) (<= 0 s3)) (< s3 j3)) (<= j3 (+ k 1))) (= (ole (from_integer j3) (oadd (from_word64 i2) (from_word32 ((_ int2bv 32) 1)))) true)) (bvult i2 (bvmul (bvadd ((_ int2bv 64) (- e_last e_first)) ((_ int2bv 64) 1)) ((_ int2bv 64) 32)))) (and (and (=> (<= 0 2147483647) (in_range2 j3)) (=> (<= 0 2147483647) (in_range2 s3))) (and (and (and (= w7 (mk_t__ref w3)) (and (= s7 (mk_int__ref s3)) (= j5 (mk_int__ref j3)))) (and (= w8 w3) (and (= s8 s3) (= j6 j3)))) (not (and (<= j3 k) (bvule ((_ int2bv 64) j3) i2))))))))) (and (and (= w13 w7) (and (= s13 s7) (= j11 j5))) (and (= w14 w8) (and (= s14 s8) (= j12 j6)))))))
(assert (=> (= result15 true) (= w15 w13)))
(assert (=> (= result15 true) (= s15 s13)))
(assert (=> (= result15 true) (= j13 j11)))
(assert (=> (= result15 true) (= w16 w14)))
(assert (=> (= result15 true) (= s16 s14)))
(assert (=> (= result15 true) (= j14 j12)))
(assert (=> (= result15 true) (and (= o463 (+ (int__content s15) 1)) (in_range1 (+ (int__content s15) 1)))))
(assert (=> (= result15 true) (= result24 s15)))
(assert (=> (= result15 true) (= s17 o463)))
(assert (=> (= result15 true) (= s17 r94b)))
(assert (=> (= result15 true) (in_range2 r94b)))
(assert (=> (= result15 true) (= result25 (mk_int__ref h10))))
(assert (=> (= result15 true) (= h11 1)))
(assert (=> (= result15 true) (=> (and (<= 1 h11) (<= h11 r94b)) (and (and (= temp___655 s17) (and (= temp___670 aux31) (and (= temp___668 a10) (and (= temp___675 s17) (and (= temp___666 h11) (and (and (and (and (and (and (and (and (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t aux11 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 ((_ int2bv 32) 1))) true)) (= (oeq (num_of_big_int (mk___t aux2 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t aux32 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (omultiply (oexpon__2 (num_of_big_int x x_first (+ l1 1)) (omultiply (odivide (num_of_big_int e e_first (+ (- e_last e_first) 1)) (oexpon__2 (from_word32 ((_ int2bv 32) 2)) (oadd (from_word64 i2) (from_word32 ((_ int2bv 32) 1))))) (oexpon (from_word32 ((_ int2bv 32) 2)) (- h12 1)))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (forall ((n7 Int)) (=> (and (<= 0 n7) (<= n7 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux47) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n7 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n7) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))) (= (oeq (from_word32 (t__content w15)) (omod (odivide (num_of_big_int e e_first (+ (- e_last e_first) 1)) (oexpon__2 (from_word32 ((_ int2bv 32) 2)) (osubtract (from_word64 i2) (osubtract (from_integer s17) (from_word32 ((_ int2bv 32) 1)))))) (oexpon (from_word32 ((_ int2bv 32) 2)) s17))) true)) (= (bvurem (t__content w15) ((_ int2bv 32) 2)) ((_ int2bv 32) 1))) (<= 0 s17)) (<= s17 (+ k 1))) (= temp___675 s17)) (= (ole (from_integer s17) (oadd (from_word64 i2) (from_word32 ((_ int2bv 32) 1)))) true)) (bvult i2 (bvmul (bvadd ((_ int2bv 64) (- e_last e_first)) ((_ int2bv 64) 1)) ((_ int2bv 64) 32)))) (and (and (=> (<= 1 r94b) (dynamic_property2 1 r94b h12)) (and (<= 1 h12) (<= h12 r94b))) (and (and (and (and (and (and (and (and (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t aux11 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 ((_ int2bv 32) 1))) true)) (= (oeq (num_of_big_int (mk___t aux2 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t aux33 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (omultiply (oexpon__2 (num_of_big_int x x_first (+ l1 1)) (omultiply (odivide (num_of_big_int e e_first (+ (- e_last e_first) 1)) (oexpon__2 (from_word32 ((_ int2bv 32) 2)) (oadd (from_word64 i2) (from_word32 ((_ int2bv 32) 1))))) (oexpon (from_word32 ((_ int2bv 32) 2)) h12))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (forall ((n7 Int)) (=> (and (<= 0 n7) (<= n7 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux47) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n7 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n7) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))) (= (oeq (from_word32 (t__content w15)) (omod (odivide (num_of_big_int e e_first (+ (- e_last e_first) 1)) (oexpon__2 (from_word32 ((_ int2bv 32) 2)) (osubtract (from_word64 i2) (osubtract (from_integer s17) (from_word32 ((_ int2bv 32) 1)))))) (oexpon (from_word32 ((_ int2bv 32) 2)) s17))) true)) (= (bvurem (t__content w15) ((_ int2bv 32) 2)) ((_ int2bv 32) 1))) (<= 0 s17)) (<= s17 (+ k 1))) (= temp___655 s17)) (= (ole (from_integer s17) (oadd (from_word64 i2) (from_word32 ((_ int2bv 32) 1)))) true)) (bvult i2 (bvmul (bvadd ((_ int2bv 64) (- e_last e_first)) ((_ int2bv 64) 1)) ((_ int2bv 64) 32)))) (and (=> (<= 0 2147483647) (in_range2 l1)) (and (=> (<= 0 2147483647) (in_range2 s17)) (and (=> (<= 1 r94b) (dynamic_property2 1 r94b h12)) (= h12 r94b)))))))))))) (and (and (= h18 (mk_int__ref h12)) (and (= aux38 (mk_map__ref aux33)) (= a17 (mk_map__ref a12)))) (and (= h19 h12) (and (= aux39 aux33) (= a18 a12))))))))
(assert (=> (= result15 true) (=> (and (<= 1 h11) (<= h11 r94b)) (= h20 h18))))
(assert (=> (= result15 true) (=> (and (<= 1 h11) (<= h11 r94b)) (= aux310 aux38))))
(assert (=> (= result15 true) (=> (and (<= 1 h11) (<= h11 r94b)) (= a19 a17))))
(assert (=> (= result15 true) (=> (and (<= 1 h11) (<= h11 r94b)) (= h21 h19))))
(assert (=> (= result15 true) (=> (and (<= 1 h11) (<= h11 r94b)) (= aux311 aux39))))
(assert (=> (= result15 true) (=> (and (<= 1 h11) (<= h11 r94b)) (= a20 a18))))
(assert (=> (= result15 true) (=> (not (and (<= 1 h11) (<= h11 r94b))) (= h20 (mk_int__ref h11)))))
(assert (=> (= result15 true) (=> (not (and (<= 1 h11) (<= h11 r94b))) (= aux310 (mk_map__ref aux31)))))
(assert (=> (= result15 true) (=> (not (and (<= 1 h11) (<= h11 r94b))) (= a19 (mk_map__ref a10)))))
(assert (=> (= result15 true) (=> (not (and (<= 1 h11) (<= h11 r94b))) (= h21 h11))))
(assert (=> (= result15 true) (=> (not (and (<= 1 h11) (<= h11 r94b))) (= aux311 aux31))))
(assert (=> (= result15 true) (=> (not (and (<= 1 h11) (<= h11 r94b))) (= a20 a10))))
(assert (=> (= result15 true) (and (= o676 (+ l1 1)) (in_range1 (+ l1 1)))))
(assert (=> (= result15 true) (and (= o677 (bv2nat (bvlshr (t__content w15) ((_ int2bv 32) 1)))) (in_range2 (bv2nat (bvlshr (t__content w15) ((_ int2bv 32) 1)))))))
(assert (=> (= result15 true) (= o678 (* o677 o676))))
(assert (=> (= result15 true) (and (= o679 o678) (in_range1 o678))))
(assert (=> (= result15 true) (= o680 (+ aux4_first o679))))
(assert (=> (= result15 true) (and (= o681 o680) (in_range1 o680))))
(assert (=> (= result15 true) (and (= o682 o681) (in_range2 o681))))
(assert (=> (= result15 true) (= (oeq (num_of_big_int (mk___t a21 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omod (omultiply (omultiply (num_of_big_int (mk___t (map__content aux310) (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ (- a_last a_first) 1)) (num_of_big_int (mk___t (map__content aux47) (mk (to_rep aux4__first) (to_rep aux4__last))) o682 (+ (- a_last a_first) 1))) (oexpon (inverse (num_of_big_int m m_first (+ (- a_last a_first) 1)) (base Tuple0)) (+ (- a_last a_first) 1))) (num_of_big_int m m_first (+ (- a_last a_first) 1)))) true)))
(assert (=> (= result15 true) (forall ((k1 Int)) (=> (and (<= (to_rep aux3__first) k1) (<= k1 (to_rep aux3__last))) (and (=> (and (<= aux3_first k1) (<= k1 (- (+ aux3_first a_last) a_first))) (= (to_rep1 (select aux312 k1)) (to_rep1 (select a21 (- (+ a_first k1) aux3_first))))) (=> (=> (<= aux3_first k1) (not (<= k1 (- (+ aux3_first a_last) a_first)))) (= (to_rep1 (select aux312 k1)) (to_rep1 (select (map__content aux310) k1)))))))))
(assert (=> (= result15 true) (= h22 h20)))
(assert (=> (= result15 true) (= w17 w15)))
(assert (=> (= result15 true) (= s19 (mk_int__ref s17))))
(assert (=> (= result15 true) (= j15 j13)))
(assert (=> (= result15 true) (= aux314 (mk_map__ref aux312))))
(assert (=> (= result15 true) (= a23 (mk_map__ref a21))))
(assert (=> (= result15 true) (= h23 h21)))
(assert (=> (= result15 true) (= w18 w16)))
(assert (=> (= result15 true) (= s20 s17)))
(assert (=> (= result15 true) (= j16 j14)))
(assert (=> (= result15 true) (= aux315 aux312)))
(assert (=> (= result15 true) (= a24 a21)))
(assert (=> (not (= result15 true)) (= result29 (mk_int__ref s1))))
(assert (=> (not (= result15 true)) (= s18 1)))
(assert (=> (not (= result15 true)) (= (oeq (num_of_big_int (mk___t a22 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omod (omultiply (omultiply (num_of_big_int (mk___t aux31 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ (- a_last a_first) 1)) (num_of_big_int (mk___t aux31 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ (- a_last a_first) 1))) (oexpon (inverse (num_of_big_int m m_first (+ (- a_last a_first) 1)) (base Tuple0)) (+ (- a_last a_first) 1))) (num_of_big_int m m_first (+ (- a_last a_first) 1)))) true)))
(assert (=> (not (= result15 true)) (forall ((k1 Int)) (=> (and (<= (to_rep aux3__first) k1) (<= k1 (to_rep aux3__last))) (and (=> (and (<= aux3_first k1) (<= k1 (- (+ aux3_first a_last) a_first))) (= (to_rep1 (select aux313 k1)) (to_rep1 (select a22 (- (+ a_first k1) aux3_first))))) (=> (=> (<= aux3_first k1) (not (<= k1 (- (+ aux3_first a_last) a_first)))) (= (to_rep1 (select aux313 k1)) (to_rep1 (select aux31 k1)))))))))
(assert (=> (not (= result15 true)) (= h22 (mk_int__ref h10))))
(assert (=> (not (= result15 true)) (= w17 (mk_t__ref w1))))
(assert (=> (not (= result15 true)) (= s19 (mk_int__ref s18))))
(assert (=> (not (= result15 true)) (= j15 (mk_int__ref j1))))
(assert (=> (not (= result15 true)) (= aux314 (mk_map__ref aux313))))
(assert (=> (not (= result15 true)) (= a23 (mk_map__ref a22))))
(assert (=> (not (= result15 true)) (= h23 h10)))
(assert (=> (not (= result15 true)) (= w18 w1)))
(assert (=> (not (= result15 true)) (= s20 s18)))
(assert (=> (not (= result15 true)) (= j16 j1)))
(assert (=> (not (= result15 true)) (= aux315 aux313)))
(assert (=> (not (= result15 true)) (= a24 a22)))
(assert (and (= o762 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (and (= o763 o762) (uint_in_range1 o762)))
(assert (= o764 ((_ int2bv 64) o763)))
(assert (= o765 (bvadd o764 ((_ int2bv 64) 1))))
(assert (= o766 (bvmul o765 ((_ int2bv 64) 32))))
(assert (= o767 (ite (bvult i2 o766) true false)))
(assert (= o759 (from_word32 ((_ int2bv 32) 1))))
(assert (= o758 (from_word64 i2)))
(assert (= o760 (oadd o758 o759)))
(assert (= o757 (from_integer (int__content s19))))
(assert (= o761 (ole o757 o760)))
(assert (and (= o731 (power 2 k)) (in_range1 (power 2 k))))
(assert (= o732 (- o731 1)))
(assert (and (= o733 o732) (in_range1 o732)))
(assert (= o734 (ite (<= n6 o733) true false)))
(assert (= result30 (ite (<= 0 n6) o734 false)))
(assert (= (= o756 true) (forall ((n7 Int)) (=> (and (<= 0 n7) (<= n7 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux47) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n7 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n7) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))))
(assert (and (= o725 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o726 (num_of_big_int m m_first o725)))
(assert (and (= o722 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (and (= o721 (base Tuple0)) (= o721 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o723 (oexpon o721 o722)))
(assert (= o716 (from_word32 ((_ int2bv 32) 1))))
(assert (= o714 (from_integer (int__content s19))))
(assert (= o713 (from_word64 i2)))
(assert (= o715 (osubtract o713 o714)))
(assert (= o717 (oadd o715 o716)))
(assert (= o712 (from_word32 ((_ int2bv 32) 2))))
(assert (= o718 (oexpon__2 o712 o717)))
(assert (and (= o707 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (= o708 (+ o707 1)))
(assert (and (= o709 o708) (in_range1 o708)))
(assert (and (= o710 o709) (in_range2 o709)))
(assert (= o711 (num_of_big_int e e_first o710)))
(assert (= o719 (odivide o711 o718)))
(assert (and (= o705 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o706 (num_of_big_int x x_first o705)))
(assert (= o720 (oexpon__2 o706 o719)))
(assert (= o724 (omultiply o720 o723)))
(assert (= o727 (omod o724 o726)))
(assert (and (= o703 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o704 (num_of_big_int (mk___t (map__content aux314) (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first o703)))
(assert (= o728 (oeq o704 o727)))
(assert (not (in_range1 (+ l1 1))))
(check-sat)
(exit)
