...
(declare-const o40 (Array Int unsigned_8))
...
(assert (=> (<= (to_rep addr__first) (to_rep addr__last)) (= o35 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))
(assert (=> (not (<= (to_rep addr__first) (to_rep addr__last))) (= o35 0)))
(assert (and (= o36 o35) (in_range1 o35)))
(assert (= o37 (* 8 o36)))
(assert (= o38 (ite (< o37 (+ start len)) true false)))
(assert (= o39 (ite o38 1 0)))
(assert (= result7 (ite (= (ite (ite (= (int__content result__9) (- 1)) true false) 1 0) o39) true false)))
(assert (= result7 true))
(assert (=> (<= (to_rep addr__first) (to_rep addr__last)) (= o28 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))
(assert (=> (not (<= (to_rep addr__first) (to_rep addr__last))) (= o28 0)))
(assert (and (= o29 o28) (in_range1 o28)))
(assert (= o30 (* 8 o29)))
(assert (= o31 (ite (<= (+ start len) o30) true false)))
(assert (and (= o27 (maxvalue len)) (= o27 (bvshl #x0000000000000001 ((_ int2bv 64) len)))))
(assert (= o32 (ite (bvule o27 value) true false)))
(assert (= o33 (ite (= o32 true) o31 false)))
(assert (= o34 (ite o33 1 0)))
(assert (= result8 (ite (= (ite (ite (= (int__content result__9) (- 2)) true false) 1 0) o34) true false)))
(assert (= result8 true))
(assert (=> (<= (to_rep addr__first) (to_rep addr__last)) (= o20 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))
(assert (=> (not (<= (to_rep addr__first) (to_rep addr__last))) (= o20 0)))
(assert (and (= o21 o20) (in_range1 o20)))
(assert (= o22 (* 8 o21)))
(assert (= o23 (ite (<= (+ start len) o22) true false)))
(assert (and (= o19 (maxvalue len)) (= o19 (bvshl #x0000000000000001 ((_ int2bv 64) len)))))
(assert (= o24 (ite (bvugt o19 value) true false)))
(assert (= o25 (ite (= o24 true) o23 false)))
(assert (= o26 (ite o25 1 0)))
(assert (= result9 (ite (= (ite (ite (= (int__content result__9) 0) true false) 1 0) o26) true false)))
(assert (= result9 true))
...
(assert (=> (= (int__content result__9) 0) (= (= result11 true) (forall ((i15 Int)) (=> (and (<= start i15) (<= i15 (- (+ start len) 1))) (= (= (nth8_stream (mk___t (map__content addr9) (mk (to_rep addr__first) (to_rep addr__last))) i15) true) (= (nth value (+ (- (- len i15) 1) start)) true)))))))
(assert (=> (not (= (int__content result__9) 0)) (= result11 (distinct 1 0))))
(assert (= result11 true))
(assert (= (int__content result__9) 0))
(assert (=> (<= (to_rep addr__first) (to_rep addr__last)) (= o10 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))
(assert (=> (not (<= (to_rep addr__first) (to_rep addr__last))) (= o10 0)))
(assert (and (= o11 o10) (in_range1 o10)))
(assert (= o12 (* 8 o11)))
(assert (= o13 (- o12 1)))
(assert (= o14 (ite (<= i1 o13) true false)))
(assert (= result12 (ite (<= (+ start len) i1) o14 false)))
(assert (= result12 true))
(assert (and (= o16 i1) (in_range2 i1)))
(assert (and (= o17 (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) o16)) (= (= o17 true) (= (nth1 (to_rep1 (select addr (div1 o16 8))) (- 7 (mod1 o16 8))) true))))
(assert (= o18 (ite o17 1 0)))
(assert (and (= o15 i1) (in_range2 i1)))
