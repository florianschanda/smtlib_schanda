...
(define-fun dynamic_invariant2 ((temp___expr_917 Int) (temp___is_init_914 Bool) (temp___skip_constant_915 Bool) (temp___do_toplevel_916 Bool)) Bool (=> (or (= temp___is_init_914 true) (<= 0 1)) (in_range4 temp___expr_917)))
...
(define-fun t__ref___4__projection ((a t__ref3)) us_rep (t__content3 a))
...
(assert true)
(assert (and (= o10 (+ (to_rep (rec__hw__dbc__legacy_support_s_regs__t__msb (us_split_fields1 (select regs idx)))) 1)) (in_range1 (+ (to_rep (rec__hw__dbc__legacy_support_s_regs__t__msb (us_split_fields1 (select regs idx)))) 1))))
(assert (= o11 (- o10 (to_rep (rec__hw__dbc__legacy_support_s_regs__t__lsb (us_split_fields1 (select regs idx)))))))
...
(assert (and (= o5 (- (to_rep (rec__hw__dbc__legacy_support_s_regs__t__msb (us_split_fields1 (select regs idx)))) (to_rep (rec__hw__dbc__legacy_support_s_regs__t__lsb (us_split_fields1 (select regs idx)))))) (in_range1 (- (to_rep (rec__hw__dbc__legacy_support_s_regs__t__msb (us_split_fields1 (select regs idx)))) (to_rep (rec__hw__dbc__legacy_support_s_regs__t__lsb (us_split_fields1 (select regs idx))))))))
(assert (= o6 (+ o5 1)))
(assert (and (= o8 o6) (in_range1 o6)))
(assert (= o9 (ite (<= o8 o7) true false)))
(assert (and (= o2 (+ byte_offset (to_rep (rec__hw__dbc__legacy_support_s_regs__t__byte_offset (us_split_fields1 (select regs idx)))))) (in_range1 (+ byte_offset (to_rep (rec__hw__dbc__legacy_support_s_regs__t__byte_offset (us_split_fields1 (select regs idx))))))))
(assert (= o3 (div1 o2 4)))
(assert (= o4 (ite (<= o3 16383) true false)))
(assert (and (= o (+ byte_offset (to_rep (rec__hw__dbc__legacy_support_s_regs__t__byte_offset (us_split_fields1 (select regs idx)))))) (in_range1 (+ byte_offset (to_rep (rec__hw__dbc__legacy_support_s_regs__t__byte_offset (us_split_fields1 (select regs idx))))))))
(assert (not (not (= 4 0))))
(check-sat)
(exit)
