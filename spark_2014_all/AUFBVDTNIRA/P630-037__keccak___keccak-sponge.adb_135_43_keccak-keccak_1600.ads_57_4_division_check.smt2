...
(assert (and (= o74 (rate_of (mk___rep (us_split_fields__content ctx__split_fields22)))) (and (in_range3 o74) (and (= o74 (* (to_rep4 (rec__keccak__keccak_1600__sponge__context__rate (us_split_fields__content ctx__split_fields22))) 8)) (< o74 1600)))))
(assert (= o75 (ite (= o74 initial_bit_rate1) true false)))
(assert (and (= o72 (rate_of (mk___rep (us_split_fields__content ctx__split_fields22)))) (and (in_range3 o72) (and (= o72 (* (to_rep4 (rec__keccak__keccak_1600__sponge__context__rate (us_split_fields__content ctx__split_fields22))) 8)) (< o72 1600)))))
(assert (= o73 (ite (< (int__content remaining_bits9) o72) true false)))
(assert (and (= o70 (state_of (mk___rep (us_split_fields__content ctx__split_fields22)))) (and (in_range5 o70) (= o70 (to_rep5 (rec__keccak__keccak_1600__sponge__context__curr_state (us_split_fields__content ctx__split_fields22)))))))
