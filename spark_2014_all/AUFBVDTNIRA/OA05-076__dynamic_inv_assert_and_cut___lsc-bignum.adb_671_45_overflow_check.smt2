...
(assert (forall ((k1 Int)) (=> (and (<= (to_rep aux3__first) k1) (<= k1 (to_rep aux3__last))) (and (=> (and (<= aux3_first k1) (<= k1 (- (+ aux3_first a_last) a_first))) (= (to_rep1 (select o23 k1)) (to_rep1 (select o22 (- (+ a_first k1) aux3_first))))) (=> (=> (<= aux3_first k1) (not (<= k1 (- (+ aux3_first a_last) a_first)))) (= (to_rep1 (select o23 k1)) (to_rep1 (select o21 k1))))))))
