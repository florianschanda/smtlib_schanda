...
(declare-const value8 (Array Int character))
(declare-const last8 Int)
(declare-const i7 Int)
(declare-const value9 (Array Int character))
...
(assert (= o8 (slide temp___551 (to_rep1 (first temp___5511)) (to_rep1 value__first))))
(assert (= (mk_map__ref result1) (mk_map__ref value)))
(assert (= value1 o8))
(assert (=> (<= (to_rep1 value__first) (to_rep1 value__last)) (= o9 (+ (- (to_rep1 value__last) (to_rep1 value__first)) 1))))
(assert (=> (not (<= (to_rep1 value__first) (to_rep1 value__last))) (= o9 0)))
(assert (and (= o10 o9) (in_range1 o9)))
(assert (= o11 (+ position o10)))
(assert (and (= o12 o11) (in_range1 o11)))
(assert (= temp___557 (- o12 1)))
...
(assert (=> (and (<= position i1) (<= i1 temp___557)) (= o15 i2)))
(assert (=> (and (<= position i1) (<= i1 temp___557)) (= o16 (select (elts1 data) o15))))
(assert (=> (and (<= position i1) (<= i1 temp___557)) (= o17 (to_rep2 o16))))
(assert (=> (and (<= position i1) (<= i1 temp___557)) (= o18 (bv2nat o17))))
(assert (=> (and (<= position i1) (<= i1 temp___557)) (= (to_rep o19) o18)))
(assert (=> (and (<= position i1) (<= i1 temp___557)) (and (= o13 (- i2 position)) (in_range1 (- i2 position)))))
(assert (=> (and (<= position i1) (<= i1 temp___557)) (= o14 (+ (to_rep1 value__first) o13))))
(assert (=> (and (<= position i1) (<= i1 temp___557)) (and (= temp___552 o14) (in_range1 o14))))
(assert (=> (and (<= position i1) (<= i1 temp___557)) (and (<= (to_rep1 value__first) temp___552) (<= temp___552 (to_rep1 value__last)))))
(assert (=> (and (<= position i1) (<= i1 temp___557)) (= o20 temp___552)))
(assert (=> (and (<= position i1) (<= i1 temp___557)) (= o21 (store value2 o20 o19))))
(assert (=> (and (<= position i1) (<= i1 temp___557)) (= value2 result3)))
(assert (=> (and (<= position i1) (<= i1 temp___557)) (= value3 o21)))
...
(assert (=> (<= (to_rep1 value__first) (to_rep1 value__last)) (= o22 (+ (- (to_rep1 value__last) (to_rep1 value__first)) 1))))
(assert (=> (not (<= (to_rep1 value__first) (to_rep1 value__last))) (= o22 0)))
(assert (not (in_range6 o22)))
(check-sat)
(exit)
