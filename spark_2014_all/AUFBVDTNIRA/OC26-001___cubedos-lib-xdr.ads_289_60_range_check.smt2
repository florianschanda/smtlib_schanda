...
(assert (=> (and (<= position i1) (<= i1 temp___557)) (= i9 (mk_int__ref i3))))
(assert (=> (and (<= position i1) (<= i1 temp___557)) (= value10 (mk_map__ref value4))))
...
(assert (and (= o19 o18) (in_range5 o18)))
