...
(define-fun value10 () map__ref (mk_map__ref value6))
...
(assert (=> (and (<= position i1) (<= i1 temp___612)) (= i9 (mk_int__ref i3))))
(assert (=> (and (<= position i1) (<= i1 temp___612)) (= value10 (mk_map__ref value4))))
...
(assert (and (= o16 (length_with_padding o15)) (and (in_range4 o16) (= o16 (+ o15 (ite (= (mod1 o15 4) 0) 0 (- 4 (mod1 o15 4))))))))
(assert (= o17 (- o16 1)))
(assert (= o18 (+ position o17)))
(assert (and (= o19 o18) (in_range6 o18)))
(assert (= (mk_int__ref result3) (mk_int__ref last6)))
(assert (= last7 o19))
(assert (= (mk_int__ref i7) i9))
(assert (= last7 last8))
(assert (= (mk_map__ref value8) value10))
(assert (= i8 i6))
(assert (= last9 last7))
(assert (= value9 value7))
(assert (=> (<= (to_rep1 value__first) (to_rep1 value__last)) (= o20 (+ (- (to_rep1 value__last) (to_rep1 value__first)) 1))))
(assert (=> (not (<= (to_rep1 value__first) (to_rep1 value__last))) (= o20 0)))
