...
(assert (and (= o24 (length_with_padding o23)) (and (in_range6 o24) (= o24 (+ o23 (ite (= (mod1 o23 4) 0) 0 (- 4 (mod1 o23 4))))))))
(assert (= o25 (- o24 1)))
(assert (= o26 (+ position o25)))
(assert (and (= o27 o26) (in_range5 o26)))
(assert (= (mk_int__ref result4) (mk_int__ref last6)))
(assert (= last7 o27))
(assert (= (mk_int__ref i7) (mk_int__ref i5)))
(assert (= last7 last8))
(assert (= (mk_map__ref value8) (mk_map__ref value6)))
(assert (= i8 i6))
(assert (= last9 last7))
(assert (= value9 value7))
(assert (=> (<= (to_rep1 value__first) (to_rep1 value__last)) (= o28 (+ (- (to_rep1 value__last) (to_rep1 value__first)) 1))))
(assert (=> (not (<= (to_rep1 value__first) (to_rep1 value__last))) (= o28 0)))
(assert (not (in_range6 o28)))
(check-sat)
(exit)
