...
(assert (and (= o7 (max_input_length (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1)))) (and (in_range4 o7) (= o7 (- (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1))) 2)))))
(assert (= result (ite (<= in_data_bit_length o7) true false)))
(assert (= result true))
(assert (and (= o4 (+ in_data_bit_length 7)) (in_range (+ in_data_bit_length 7))))
(assert (= o5 (div1 o4 8)))
(assert (and (= o6 (length in_data)) (in_range (length in_data))))
(assert (= result1 (ite (<= o5 o6) true false)))
(assert (= result1 true))
...
(assert (= result2 (ite (<= out_data_bit_length o3) true false)))
(assert (= result2 true))
