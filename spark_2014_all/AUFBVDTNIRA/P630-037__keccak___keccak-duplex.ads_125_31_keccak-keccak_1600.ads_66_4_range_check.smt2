...
(assert (and (= o8 (max_input_length (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1)))) (and (in_range4 o8) (= o8 (- (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1))) 2)))))
(assert (= result (ite (<= in_data_bit_length o8) true false)))
(assert (= result true))
(assert (and (= o5 (+ in_data_bit_length 7)) (in_range (+ in_data_bit_length 7))))
(assert (= o6 (div1 o5 8)))
(assert (and (= o7 (length in_data)) (in_range (length in_data))))
(assert (= result1 (ite (<= o6 o7) true false)))
(assert (= result1 true))
(assert (and (= o4 (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1)))) (and (in_range3 o4) (= o4 (to_rep3 ctx__split_fields1)))))
(assert (= result2 (ite (<= out_data_bit_length o4) true false)))
(assert (= result2 true))
(assert (and (= o1 (+ out_data_bit_length 7)) (in_range (+ out_data_bit_length 7))))
(assert (= o2 (div1 o1 8)))
(assert (=> (<= (to_rep out_data__first) (to_rep out_data__last)) (= o (+ (- (to_rep out_data__last) (to_rep out_data__first)) 1))))
(assert (=> (not (<= (to_rep out_data__first) (to_rep out_data__last))) (= o 0)))
