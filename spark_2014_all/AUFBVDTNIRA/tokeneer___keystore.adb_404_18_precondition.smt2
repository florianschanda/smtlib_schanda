...
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq3 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_172 Int)) (=> (and (<= a__first temp___idx_172) (<= temp___idx_172 a__last)) (= (to_rep5 (select a temp___idx_172)) (to_rep5 (select b (+ (- b__first a__first) temp___idx_172)))))))))))
...
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq5 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_173 Int)) (=> (and (<= a__first temp___idx_173) (<= temp___idx_173 a__last)) (= (to_rep8 (select a temp___idx_173)) (to_rep8 (select b (+ (- b__first a__first) temp___idx_173)))))))))))
...
(define-fun dynamic_invariant2 ((temp___expr_1276 us_rep2) (temp___is_init_1272 Bool) (temp___skip_constant_1273 Bool) (temp___do_toplevel_1274 Bool) (temp___do_typ_inv_1275 Bool)) Bool (=> (= temp___do_typ_inv_1275 true) (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1276))) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1276))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1276)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1276))) true)))
...
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq9 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_175 Int)) (=> (and (<= a__first temp___idx_175) (<= temp___idx_175 a__last)) (= (to_rep9 (select a temp___idx_175)) (to_rep9 (select b (+ (- b__first a__first) temp___idx_175)))))))))))
...
(declare-fun temp___String_Literal_1955 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1955 us_void_param) 1)) 67) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 2)) 114)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 3)) 121)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 4)) 112)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 5)) 116)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 6)) 111)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 7)) 32)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 8)) 76)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 9)) 105)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 10)) 98)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 11)) 114)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 12)) 97)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 13)) 114)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 14)) 121)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 16)) 69)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 17)) 114)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 18)) 114)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 19)) 111)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 20)) 114)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 21)) 32)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 22)) 58)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 23)) 32)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 24)) 76)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 25)) 105)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 26)) 98)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 27)) 114)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 28)) 97)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 29)) 114)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 30)) 121)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 31)) 32)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 32)) 104)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 33)) 111)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 34)) 108)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 35)) 100)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 36)) 115)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 37)) 32)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 38)) 109)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 39)) 111)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 40)) 114)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 41)) 101)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 42)) 32)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 43)) 116)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 44)) 104)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 45)) 97)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 46)) 110)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 47)) 32)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 48)) 111)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 49)) 110)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 50)) 101)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 51)) 32)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 52)) 112)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 53)) 117)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 54)) 98)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 55)) 108)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 56)) 105)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 57)) 99)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 58)) 32)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 59)) 107)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 60)) 101)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 61)) 121)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 62)) 32)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 63)) 102)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 64)) 111)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 65)) 114)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 66)) 32)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 67)) 97)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 68)) 110)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 69)) 32)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 70)) 73)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 71)) 115)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 72)) 115)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 73)) 117)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 74)) 101)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 75)) 114)) (= (to_rep (select (temp___String_Literal_1955 us_void_param) 76)) 46)) :pattern ((temp___String_Literal_1955 us_void_param)))))
...
(define-fun dynamic_invariant7 ((temp___expr_997 Int) (temp___is_init_993 Bool) (temp___skip_constant_994 Bool) (temp___do_toplevel_995 Bool) (temp___do_typ_inv_996 Bool)) Bool (=> (or (= temp___is_init_993 true) (<= 0 40)) (in_range6 temp___expr_997)))
(define-fun dynamic_invariant8 ((temp___expr_1021 Int) (temp___is_init_1017 Bool) (temp___skip_constant_1018 Bool) (temp___do_toplevel_1019 Bool) (temp___do_typ_inv_1020 Bool)) Bool (=> (or (= temp___is_init_1017 true) (<= 0 4294967295)) (in_range7 temp___expr_1021)))
(assert (= nouser (temp___String_Literal_158 Tuple0)))
(define-fun dynamic_invariant9 ((temp___expr_1214 Int) (temp___is_init_1210 Bool) (temp___skip_constant_1211 Bool) (temp___do_toplevel_1212 Bool) (temp___do_typ_inv_1213 Bool)) Bool (=> (or (= temp___is_init_1210 true) (<= 0 17)) (in_range10 temp___expr_1214)))
(define-fun dynamic_invariant10 ((temp___expr_1221 Int) (temp___is_init_1217 Bool) (temp___skip_constant_1218 Bool) (temp___do_toplevel_1219 Bool) (temp___do_typ_inv_1220 Bool)) Bool (=> (or (= temp___is_init_1217 true) (<= 1 17)) (in_range8 temp___expr_1221)))
(define-fun dynamic_invariant11 ((temp___expr_1347 Int) (temp___is_init_1343 Bool) (temp___skip_constant_1344 Bool) (temp___do_toplevel_1345 Bool) (temp___do_typ_inv_1346 Bool)) Bool (=> (or (= temp___is_init_1343 true) (<= 0 2)) (in_range12 temp___expr_1347)))
(define-fun dynamic_invariant12 ((temp___expr_1228 Int) (temp___is_init_1224 Bool) (temp___skip_constant_1225 Bool) (temp___do_toplevel_1226 Bool) (temp___do_typ_inv_1227 Bool)) Bool (=> (or (= temp___is_init_1224 true) (<= 0 17408)) (in_range9 temp___expr_1228)))
(define-fun dynamic_invariant13 ((temp___expr_1259 Int) (temp___is_init_1255 Bool) (temp___skip_constant_1256 Bool) (temp___do_toplevel_1257 Bool) (temp___do_typ_inv_1258 Bool)) Bool (=> (or (= temp___is_init_1255 true) (<= 0 1024)) (in_range11 temp___expr_1259)))
(assert true)
...
(assert (forall ((temp___1288 Int)) (=> (dynamic_invariant13 temp___1288 true true true true) (forall ((temp___1289 Int)) (= (to_rep8 (select (temp___1286 temp___1288) temp___1289)) temp___1288)))))
(define-fun dynamic_invariant14 ((temp___expr_1622 (_ BitVec 32)) (temp___is_init_1618 Bool) (temp___skip_constant_1619 Bool) (temp___do_toplevel_1620 Bool) (temp___do_typ_inv_1621 Bool)) Bool (=> (or (= temp___is_init_1618 true) (bvule #x00000000 #x0000000F)) (in_range13 temp___expr_1622)))
(assert (forall ((temp___1284 Int)) (=> (dynamic_invariant10 temp___1284 true true true true) (forall ((temp___1285 Int)) (= (to_rep5 (select (temp___1282 temp___1284) temp___1285)) temp___1284)))))
...
(declare-const temp___1954 maskt)
(declare-const temp___19541 issueridt)
(declare-const temp___19542 namecountt)
(declare-const temp___19543 (Array Int character))
(declare-const temp___19544 unsigned32t)
(declare-const temp___19545 unsigned32t)
(declare-const temp___19546 Bool)
...
(assert (= (to_rep2 o) 0))
(assert (= (to_rep2 o1) 0))
(assert (= (to_rep10 o2) #x00000009))
(assert (= o2 o3))
(assert (= issuer (mk___rep (mk___split_fields o4 o5 o6))))
(assert (= o1 o7))
(assert (= o o8))
(assert (= (distinct 1 0) o9))
(assert (= temp___1954 o3))
(assert (= temp___19541 o4))
(assert (= temp___19542 o5))
(assert (= temp___19543 o6))
(assert (= temp___19544 o7))
(assert (= temp___19545 o8))
(assert (= temp___19546 o9))
...
(assert (= issuertemplate__split_fields7 (mk___split_fields3 temp___1954 (mk___rep (mk___split_fields temp___19541 temp___19542 temp___19543)) temp___19544 temp___19545 temp___19546)))
(assert (and (and (in_range5 actualcount2) (in_range4 auditalarm1)) (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields7)) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields7)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields7)) true)))
