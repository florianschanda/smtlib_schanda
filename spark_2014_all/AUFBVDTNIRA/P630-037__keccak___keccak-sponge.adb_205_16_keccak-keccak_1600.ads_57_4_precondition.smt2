...
(assert (= o11 temp___954))
(assert (= (mk1 (to_rep1 (first (rt message))) r105s) temp___9541))
(assert (= temp___954 o12))
(assert (= (mk (to_rep1 (first2 temp___9541)) (to_rep1 (last2 temp___9541))) o13))
