...
(assert (< (to_rep1 (first (rt message))) message_last1))
(assert (= (- message_last1 1) r105s))
(assert (in_range1 r105s))
(assert (and (= o14 (- bit_length (mod2 bit_length 8))) (in_range1 (- bit_length (mod2 bit_length 8)))))
...
(assert (= o11 (elts message)))
(assert (= o11 temp___885))
(assert (= (mk1 (to_rep1 (first (rt message))) r105s) temp___8851))
(assert (= temp___885 o12))
(assert (= (mk (to_rep1 (first2 temp___8851)) (to_rep1 (last2 temp___8851))) o13))
