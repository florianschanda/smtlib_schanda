...
(assert (< (to_rep1 (first (rt message))) message_last2))
(assert (= (- message_last2 1) r105s))
(assert (in_range1 r105s))
(assert (and (= o22 (- bit_length (mod2 bit_length 8))) (in_range1 (- bit_length (mod2 bit_length 8)))))
(assert (and (= o23 o22) (in_range2 o22)))
(assert (=> (<= (to_rep1 (first (rt message))) r105s) (and (and (<= (to_rep1 (first (rt message))) (to_rep1 (first (rt message)))) (<= (to_rep1 (first (rt message))) (to_rep1 (last (rt message))))) (and (<= (to_rep1 (first (rt message))) r105s) (<= r105s (to_rep1 (last (rt message))))))))
(assert (= o19 (elts message)))
(assert (= o19 temp___885))
(assert (= (mk1 (to_rep1 (first (rt message))) r105s) temp___8851))
(assert (= temp___885 o20))
(assert (= (mk (to_rep1 (first2 temp___8851)) (to_rep1 (last2 temp___8851))) o21))
(assert (not (= (state_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5))) 0)))
(check-sat)
(exit)
