...
(assert (or (and (and (and (= i12 (mk_int__ref i)) (and (= flag8 (mk_bool__ref flag)) (and (= result__7 (mk_int__ref result__4)) (= (mk_map__ref addr8) (mk_map__ref addr))))) (and (= i13 i4) (and (= flag9 flag1) (and (= result__8 result__5) (= addr9 addr1))))) (and (and (and (and (and (ite (<= (to_rep addr__first) (to_rep addr__last)) (= o2 (+ (- (to_rep addr__last) (to_rep addr__first)) 1)) (= o2 0)) (and (= o3 o2) (in_range1 o2))) (= o4 (* o3 8))) (and (= o5 o4) (in_range1 o4))) (and (and (= o6 (+ start len)) (in_range1 (+ start len))) (= result (ite (< o5 o6) true false)))) (ite (= result true) (and (and (= result__2 result__4) (= result__5 result__2)) (and (= (mk_int__ref result1) (mk_int__ref result__)) (= result__2 (- 1)))) (and (and (= result__3 result__4) (= result__5 result__3)) (and (and (and (= o7 (maxvalue len)) (= o7 (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) len)))) (= result2 (ite (bvuge value o7) true false))) (and (= result2 true) (and (= (mk_int__ref result3) (mk_int__ref result__)) (= result__3 (- 2))))))))) (and (and (and (and (and (and (ite (<= (to_rep addr__first) (to_rep addr__last)) (= o2 (+ (- (to_rep addr__last) (to_rep addr__first)) 1)) (= o2 0)) (and (= o3 o2) (in_range1 o2))) (= o4 (* o3 8))) (and (= o5 o4) (in_range1 o4))) (and (and (= o6 (+ start len)) (in_range1 (+ start len))) (= result (ite (< o5 o6) true false)))) (and (not (= result true)) (and (and (and (and (= o7 (maxvalue len)) (= o7 (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) len)))) (= result2 (ite (bvuge value o7) true false))) (and (not (= result2 true)) (and (= result__3 result__) (= result__3 result__1)))) (= result__2 result__3)))) (and (and (and (= i12 (mk_int__ref i10)) (and (= flag8 (mk_bool__ref flag6)) (and (= result__7 (mk_int__ref result__6)) (= (mk_map__ref addr8) (mk_map__ref addr6))))) (and (= i13 i11) (and (= flag9 flag7) (and (= result__8 result__6) (= addr9 addr7))))) (and (and (and (= (mk_int__ref result4) (mk_int__ref i)) (= i5 0)) (ite (and (<= 0 i5) (<= i5 (- len 1))) (and (and (and (= temp___299 i5) (and (= temp___300 addr) (and (= temp___298 addr) (and (= temp___296 flag) (and (= temp___301 addr) (and (and (and (<= 0 i6) (<= i6 len)) (and (forall ((j3 Int)) (=> (and (<= 0 j3) (<= j3 (- start 1))) (= (= (nth8_stream (mk___t temp___300 (mk (to_rep addr__first) (to_rep addr__last))) j3) true) (= (nth8_stream (mk___t addr2 (mk (to_rep addr__first) (to_rep addr__last))) j3) true)))) (and (forall ((j3 Int)) (=> (and (<= start j3) (<= j3 (- (+ start i6) 1))) (= (= (nth8_stream (mk___t addr2 (mk (to_rep addr__first) (to_rep addr__last))) j3) true) (= (nth value (+ (- (- len j3) 1) start)) true)))) (forall ((j3 Int)) (=> (and (<= (+ start i6) j3) (<= j3 (- (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) 1))) (= (= (nth8_stream (mk___t addr2 (mk (to_rep addr__first) (to_rep addr__last))) j3) true) (= (nth8_stream (mk___t temp___301 (mk (to_rep addr__first) (to_rep addr__last))) j3) true))))))) (and (and (=> (<= 0 (- len 1)) (dynamic_property1 0 (- len 1) i6)) (and (<= 0 i6) (<= i6 (- len 1)))) (and (and (and (and (and (= o26 (+ (- 64 len) i6)) (in_range1 (+ (- 64 len) i6))) (and (= o27 o26) (in_range2 o26))) (and (= o28 (peekbit64 value o27)) (and (= (= o28 true) (not (= (bvand value (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) (- 63 o27)))) ((_ int2bv 64) 0)))) (= (= o28 true) (= (nth value (- 63 o27)) true))))) (and (= flag2 result6) (= flag3 o28))) (and (and (and (= o29 (+ start i6)) (in_range1 (+ start i6))) (and (forall ((i16 Int)) (=> (and (<= 0 i16) (<= i16 (- (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) 1))) (=> (not (= i16 o29)) (= (= (nth8_stream (mk___t addr3 (mk (to_rep addr__first) (to_rep addr__last))) i16) true) (= (nth8_stream (mk___t addr2 (mk (to_rep addr__first) (to_rep addr__last))) i16) true))))) (= (= (nth8_stream (mk___t addr3 (mk (to_rep addr__first) (to_rep addr__last))) o29) true) (= flag3 true)))) (and (= (= (nth8_stream (mk___t addr3 (mk (to_rep addr__first) (to_rep addr__last))) (+ start i6)) true) (= (nth value (- (- len i6) 1)) true)) (and (forall ((k1 Int)) (=> (and (<= start k1) (<= k1 (- (+ start i6) 1))) (and (and (not (= k1 (+ start i6))) (and (<= 0 k1) (<= k1 (- (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) 1)))) (= (= (nth8_stream (mk___t addr3 (mk (to_rep addr__first) (to_rep addr__last))) k1) true) (= (nth value (- (- (+ start len) k1) 1)) true))))) (= i6 (- len 1))))))))))))) (and (and (= i6 i8) (and (= flag3 flag4) (= addr3 addr4))) (and (= i9 i6) (and (= flag5 flag3) (= addr5 addr3))))) (and (and (= (mk_int__ref i10) (mk_int__ref i8)) (and (= (mk_bool__ref flag6) (mk_bool__ref flag4)) (= (mk_map__ref addr6) (mk_map__ref addr4)))) (and (= i11 i9) (and (= flag7 flag5) (= addr7 addr5))))) (and (and (= i5 i10) (and (= (mk_bool__ref flag6) (mk_bool__ref flag)) (= (mk_map__ref addr6) (mk_map__ref addr)))) (and (= i11 i5) (and (= flag7 flag1) (= addr7 addr1)))))) (and (= result__2 result9) (= result__6 0)))))))
(assert (= i14 i12))
(assert (= flag10 flag8))
(assert (= result__9 result__7))
(assert (= addr10 (mk_map__ref addr8)))
(assert (= i15 i13))
(assert (= flag11 flag9))
...
(assert (=> (<= (to_rep addr__first) (to_rep addr__last)) (= o78 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))
(assert (=> (not (<= (to_rep addr__first) (to_rep addr__last))) (= o78 0)))
(assert (and (= o79 o78) (in_range1 o78)))
(assert (= o80 (* 8 o79)))
(assert (= o81 (ite (< o80 (+ start len)) true false)))
(assert (= o82 (to_int2 o81)))
(assert (= result10 (ite (= (to_int2 (ite (= (int__content result__9) (- 1)) true false)) o82) true false)))
(assert (= result10 true))
(assert (=> (<= (to_rep addr__first) (to_rep addr__last)) (= o71 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))
(assert (=> (not (<= (to_rep addr__first) (to_rep addr__last))) (= o71 0)))
(assert (and (= o72 o71) (in_range1 o71)))
(assert (= o73 (* 8 o72)))
(assert (= o74 (ite (<= (+ start len) o73) true false)))
(assert (and (= o70 (maxvalue len)) (= o70 (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) len)))))
(assert (= o75 (ite (bvule o70 value) true false)))
(assert (= o76 (ite (= o75 true) o74 false)))
(assert (= o77 (to_int2 o76)))
(assert (= result11 (ite (= (to_int2 (ite (= (int__content result__9) (- 2)) true false)) o77) true false)))
(assert (= result11 true))
(assert (=> (<= (to_rep addr__first) (to_rep addr__last)) (= o63 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))
(assert (=> (not (<= (to_rep addr__first) (to_rep addr__last))) (= o63 0)))
(assert (and (= o64 o63) (in_range1 o63)))
(assert (= o65 (* 8 o64)))
(assert (= o66 (ite (<= (+ start len) o65) true false)))
(assert (and (= o62 (maxvalue len)) (= o62 (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) len)))))
(assert (= o67 (ite (bvugt o62 value) true false)))
(assert (= o68 (ite (= o67 true) o66 false)))
(assert (= o69 (to_int2 o68)))
(assert (= result12 (ite (= (to_int2 (ite (= (int__content result__9) 0) true false)) o69) true false)))
(assert (= result12 true))
(assert (=> (= (int__content result__9) 0) (= (= result13 true) (forall ((i16 Int)) (=> (and (<= 0 i16) (<= i16 (- start 1))) (= (= (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) i16) true) (= (nth8_stream (mk___t (map__content addr10) (mk (to_rep addr__first) (to_rep addr__last))) i16) true)))))))
(assert (=> (not (= (int__content result__9) 0)) (= result13 (of_int 1))))
(assert (= result13 true))
(assert (= (int__content result__9) 0))
(assert (<= start i2))
(assert (<= i2 (- (+ start len) 1)))
(assert (and (= o56 (+ (- (- len i2) 1) start)) (in_range2 (+ (- (- len i2) 1) start))))
(assert (= o57 (nth value o56)))
(assert (= o58 (to_int2 o57)))
(assert (not (in_range2 i2)))
(check-sat)
(exit)
