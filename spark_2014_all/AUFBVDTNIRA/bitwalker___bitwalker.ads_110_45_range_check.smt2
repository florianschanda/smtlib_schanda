...
(define-fun dynamic_invariant3 ((temp___expr_243 us_t) (temp___is_init_239 Bool) (temp___skip_constant_240 Bool) (temp___do_toplevel_241 Bool) (temp___do_typ_inv_242 Bool)) Bool (=> (not (= temp___skip_constant_240 true)) (dynamic_property 0 2147483646 (first1 temp___expr_243) (last1 temp___expr_243))))
(assert true)
...
(assert (forall ((value (_ BitVec 64))) (forall ((left Int)) (! (=> (and (and (dynamic_invariant2 value true true true true) (dynamic_invariant1 left true true true true)) (< left 64)) (= (= (peekbit64 value left) true) (= (nth value (- 63 left)) true))) :pattern ((peekbit64 value left))))))
...
(declare-const temp___339 (Array Int unsigned_8))
(declare-const temp___337 Bool)
(declare-const temp___342 (Array Int unsigned_8))
...
(assert (or (and (and (and (= i9 i14) (and (= flag8 flag13) (and (= result__7 (mk_int__ref result__4)) (= addr12 addr14)))) (and (= i10 i2) (and (= flag9 flag1) (and (= result__8 result__5) (= addr9 addr1))))) (and (and (and (and (and (ite (<= (to_rep addr__first) (to_rep addr__last)) (= o (+ (- (to_rep addr__last) (to_rep addr__first)) 1)) (= o 0)) (and (= o1 o) (in_range1 o))) (= o2 (* o1 8))) (and (= o3 o2) (in_range1 o2))) (and (and (= o4 (+ start len)) (in_range1 (+ start len))) (= result (ite (< o3 o4) true false)))) (ite (= result true) (and (and (= result__2 result__4) (= result__5 result__2)) (and (= (mk_int__ref result1) result__11) (= result__2 (- 1)))) (and (and (= result__3 result__4) (= result__5 result__3)) (and (and (and (= o5 (maxvalue len)) (= o5 (bvshl #x0000000000000001 ((_ int2bv 64) len)))) (= result2 (ite (bvuge value o5) true false))) (and (= result2 true) (and (= (mk_int__ref result3) result__11) (= result__3 (- 2))))))))) (and (and (and (and (and (and (ite (<= (to_rep addr__first) (to_rep addr__last)) (= o (+ (- (to_rep addr__last) (to_rep addr__first)) 1)) (= o 0)) (and (= o1 o) (in_range1 o))) (= o2 (* o1 8))) (and (= o3 o2) (in_range1 o2))) (and (and (= o4 (+ start len)) (in_range1 (+ start len))) (= result (ite (< o3 o4) true false)))) (and (not (= result true)) (and (and (and (and (= o5 (maxvalue len)) (= o5 (bvshl #x0000000000000001 ((_ int2bv 64) len)))) (= result2 (ite (bvuge value o5) true false))) (and (not (= result2 true)) (and (= result__3 result__) (= result__3 result__1)))) (= result__2 result__3)))) (and (and (and (= i9 i13) (and (= flag8 flag12) (and (= result__7 (mk_int__ref result__6)) (= addr12 addr13)))) (and (= i10 i8) (and (= flag9 flag7) (and (= result__8 result__6) (= addr9 addr7))))) (and (and (and (= (mk_int__ref result4) i14) (= i3 0)) (ite (and (<= 0 i3) (<= i3 (- len 1))) (and (and (and (= temp___340 i3) (and (= temp___341 addr) (and (= temp___339 addr) (and (= temp___337 flag) (and (= temp___342 addr) (and (and (and (<= 0 i4) (<= i4 len)) (and (forall ((j Int)) (=> (and (<= 0 j) (<= j (- start 1))) (= (= (nth8_stream (mk___t temp___341 (mk (to_rep addr__first) (to_rep addr__last))) j) true) (= (nth8_stream (mk___t addr2 (mk (to_rep addr__first) (to_rep addr__last))) j) true)))) (and (forall ((j Int)) (=> (and (<= start j) (<= j (- (+ start i4) 1))) (= (= (nth8_stream (mk___t addr2 (mk (to_rep addr__first) (to_rep addr__last))) j) true) (= (nth value (+ (- (- len j) 1) start)) true)))) (forall ((j Int)) (=> (and (<= (+ start i4) j) (<= j (- (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) 1))) (= (= (nth8_stream (mk___t addr2 (mk (to_rep addr__first) (to_rep addr__last))) j) true) (= (nth8_stream (mk___t temp___342 (mk (to_rep addr__first) (to_rep addr__last))) j) true))))))) (and (and (=> (<= 0 (- len 1)) (dynamic_property1 0 (- len 1) i4)) (and (<= 0 i4) (<= i4 (- len 1)))) (and (and (and (and (and (= o6 (+ (- 64 len) i4)) (in_range1 (+ (- 64 len) i4))) (and (= o7 o6) (in_range2 o6))) (and (= o8 (peekbit64 value o7)) (and (= (= o8 true) (not (= (bvand value (bvshl #x0000000000000001 ((_ int2bv 64) (- 63 o7)))) #x0000000000000000))) (= (= o8 true) (= (nth value (- 63 o7)) true))))) (and (= flag2 result5) (= flag3 o8))) (and (and (and (= o9 (+ start i4)) (in_range1 (+ start i4))) (and (forall ((i15 Int)) (=> (and (<= 0 i15) (<= i15 (- (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) 1))) (=> (not (= i15 o9)) (= (= (nth8_stream (mk___t addr3 (mk (to_rep addr__first) (to_rep addr__last))) i15) true) (= (nth8_stream (mk___t addr2 (mk (to_rep addr__first) (to_rep addr__last))) i15) true))))) (= (= (nth8_stream (mk___t addr3 (mk (to_rep addr__first) (to_rep addr__last))) o9) true) (= flag3 true)))) (and (= (= (nth8_stream (mk___t addr3 (mk (to_rep addr__first) (to_rep addr__last))) (+ start i4)) true) (= (nth value (- (- len i4) 1)) true)) (and (forall ((k Int)) (=> (and (<= start k) (<= k (- (+ start i4) 1))) (and (and (not (= k (+ start i4))) (and (<= 0 k) (<= k (- (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) 1)))) (= (= (nth8_stream (mk___t addr3 (mk (to_rep addr__first) (to_rep addr__last))) k) true) (= (nth value (- (- (+ start len) k) 1)) true))))) (= i4 (- len 1))))))))))))) (and (and (= i4 i5) (and (= flag3 flag4) (= addr3 addr4))) (and (= i6 i4) (and (= flag5 flag3) (= addr5 addr3))))) (and (and (= i13 (mk_int__ref i5)) (and (= flag12 (mk_bool__ref flag4)) (= addr13 (mk_map__ref addr4)))) (and (= i8 i6) (and (= flag7 flag5) (= addr7 addr5))))) (and (and (= i3 i7) (and (= flag12 flag13) (= addr13 addr14))) (and (= i8 i3) (and (= flag7 flag1) (= addr7 addr1)))))) (and (= result__2 result6) (= result__6 0)))))))
(assert (= i11 i9))
(assert (= flag10 flag8))
...
(assert (=> (<= (to_rep addr__first) (to_rep addr__last)) (= o29 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))
(assert (=> (not (<= (to_rep addr__first) (to_rep addr__last))) (= o29 0)))
(assert (and (= o30 o29) (in_range1 o29)))
(assert (= o31 (* 8 o30)))
(assert (= o32 (ite (< o31 (+ start len)) true false)))
(assert (= o33 (ite o32 1 0)))
(assert (= result7 (ite (= (ite (ite (= (int__content result__9) (- 1)) true false) 1 0) o33) true false)))
(assert (= result7 true))
(assert (=> (<= (to_rep addr__first) (to_rep addr__last)) (= o22 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))
(assert (=> (not (<= (to_rep addr__first) (to_rep addr__last))) (= o22 0)))
(assert (and (= o23 o22) (in_range1 o22)))
(assert (= o24 (* 8 o23)))
(assert (= o25 (ite (<= (+ start len) o24) true false)))
(assert (and (= o21 (maxvalue len)) (= o21 (bvshl #x0000000000000001 ((_ int2bv 64) len)))))
(assert (= o26 (ite (bvule o21 value) true false)))
(assert (= o27 (ite (= o26 true) o25 false)))
(assert (= o28 (ite o27 1 0)))
(assert (= result8 (ite (= (ite (ite (= (int__content result__9) (- 2)) true false) 1 0) o28) true false)))
(assert (= result8 true))
(assert (=> (<= (to_rep addr__first) (to_rep addr__last)) (= o14 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))
(assert (=> (not (<= (to_rep addr__first) (to_rep addr__last))) (= o14 0)))
(assert (and (= o15 o14) (in_range1 o14)))
(assert (= o16 (* 8 o15)))
(assert (= o17 (ite (<= (+ start len) o16) true false)))
(assert (and (= o13 (maxvalue len)) (= o13 (bvshl #x0000000000000001 ((_ int2bv 64) len)))))
(assert (= o18 (ite (bvugt o13 value) true false)))
(assert (= o19 (ite (= o18 true) o17 false)))
(assert (= o20 (ite o19 1 0)))
(assert (= result9 (ite (= (ite (ite (= (int__content result__9) 0) true false) 1 0) o20) true false)))
(assert (= result9 true))
(assert (=> (= (int__content result__9) 0) (= (= result10 true) (forall ((i15 Int)) (=> (and (<= 0 i15) (<= i15 (- start 1))) (= (= (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) i15) true) (= (nth8_stream (mk___t (map__content addr10) (mk (to_rep addr__first) (to_rep addr__last))) i15) true)))))))
(assert (=> (not (= (int__content result__9) 0)) (= result10 (distinct 1 0))))
(assert (= result10 true))
(assert (= (int__content result__9) 0))
(assert (<= start i1))
(assert (<= i1 (- (+ start len) 1)))
(assert (and (= o10 (+ (- (- len i1) 1) start)) (in_range2 (+ (- (- len i1) 1) start))))
(assert (= o11 (nth value o10)))
(assert (= o12 (ite o11 1 0)))
(assert (not (in_range2 i1)))
(check-sat)
(exit)
