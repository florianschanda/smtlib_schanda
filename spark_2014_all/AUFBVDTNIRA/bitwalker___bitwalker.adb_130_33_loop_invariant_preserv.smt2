...
(assert (forall ((k1 Int)) (=> (and (<= start k1) (<= k1 (- (+ start i6) 1))) (and (and (not (= k1 (+ start i6))) (and (<= 0 k1) (<= k1 (- (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) 1)))) (= (= (nth8_stream (mk___t addr3 (mk (to_rep addr__first) (to_rep addr__last))) k1) true) (= (nth value (- (- (+ start len) k1) 1)) true))))))
(assert (not (= i6 (- len 1))))
(assert (= result8 i6))
(assert (= i7 (+ i6 1)))
(assert (not (<= 0 i7)))
