...
(assert (=> (<= (to_rep addr__first) (to_rep addr__last)) (= o (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))
(assert (=> (not (<= (to_rep addr__first) (to_rep addr__last))) (= o 0)))
(assert (and (= o1 o) (in_range1 o)))
(assert (= o2 (* o1 8)))
(assert (and (= o3 o2) (in_range1 o2)))
(assert (and (= o4 (+ start len)) (in_range1 (+ start len))))
(assert (= result (ite (< o3 o4) true false)))
(assert (not (= result true)))
(assert (and (= o5 (maxvalue len)) (= o5 (bvshl #x0000000000000001 ((_ int2bv 64) len)))))
(assert (= result1 (ite (bvuge value o5) true false)))
...
(assert (forall ((j Int)) (=> (and (<= 0 j) (<= j (- start 1))) (= (= (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) j) true) (= (nth8_stream (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) j) true)))))
(assert (forall ((j Int)) (=> (and (<= start j) (<= j (- (+ start i2) 1))) (= (= (nth8_stream (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) j) true) (= (nth value (+ (- (- len j) 1) start)) true)))))
(assert (forall ((j Int)) (=> (and (<= (+ start i2) j) (<= j (- (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) 1))) (= (= (nth8_stream (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) j) true) (= (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) j) true)))))
(assert (and (=> (<= 0 (- len 1)) (dynamic_property1 0 (- len 1) i2)) (and (<= 0 i2) (<= i2 (- len 1)))))
(assert (and (= o6 (+ (- 64 len) i2)) (in_range1 (+ (- 64 len) i2))))
(assert (and (= o7 o6) (in_range2 o6)))
(assert (and (= o8 (peekbit64 value o7)) (and (= (= o8 true) (not (= (bvand value (bvshl #x0000000000000001 ((_ int2bv 64) (- 63 o7)))) #x0000000000000000))) (= (= o8 true) (= (nth value (- 63 o7)) true)))))
(assert (= flag result3))
(assert (= flag1 o8))
(assert (and (= o9 (+ start i2)) (in_range1 (+ start i2))))
(assert (and (forall ((i4 Int)) (=> (and (<= 0 i4) (<= i4 (- (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) 1))) (=> (not (= i4 o9)) (= (= (nth8_stream (mk___t addr2 (mk (to_rep addr__first) (to_rep addr__last))) i4) true) (= (nth8_stream (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) i4) true))))) (= (= (nth8_stream (mk___t addr2 (mk (to_rep addr__first) (to_rep addr__last))) o9) true) (= flag1 true))))
(assert (= (= (nth8_stream (mk___t addr2 (mk (to_rep addr__first) (to_rep addr__last))) (+ start i2)) true) (= (nth value (- (- len i2) 1)) true)))
(assert (forall ((k Int)) (=> (and (<= start k) (<= k (- (+ start i2) 1))) (and (and (not (= k (+ start i2))) (and (<= 0 k) (<= k (- (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) 1)))) (= (= (nth8_stream (mk___t addr2 (mk (to_rep addr__first) (to_rep addr__last))) k) true) (= (nth value (- (- (+ start len) k) 1)) true))))))
(assert (not (= i2 (- len 1))))
(assert (= result4 i2))
(assert (= i3 (+ i2 1)))
(assert (not (<= 0 i3)))
