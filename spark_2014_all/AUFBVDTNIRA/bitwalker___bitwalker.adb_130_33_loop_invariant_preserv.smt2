...
(assert (and (forall ((i4 Int)) (=> (and (<= 0 i4) (<= i4 (- (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) 1))) (=> (not (= i4 o9)) (= (= (nth8_stream (mk___t o10 (mk (to_rep addr__first) (to_rep addr__last))) i4) true) (= (nth8_stream (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) i4) true))))) (= (= (nth8_stream (mk___t o10 (mk (to_rep addr__first) (to_rep addr__last))) o9) true) (= flag1 true))))
(assert (= (= (nth8_stream (mk___t o10 (mk (to_rep addr__first) (to_rep addr__last))) (+ start i2)) true) (= (nth value (- (- len i2) 1)) true)))
(assert (forall ((k Int)) (=> (and (<= start k) (<= k (- (+ start i2) 1))) (and (and (not (= k (+ start i2))) (and (<= 0 k) (<= k (- (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) 1)))) (= (= (nth8_stream (mk___t o10 (mk (to_rep addr__first) (to_rep addr__last))) k) true) (= (nth value (- (- (+ start len) k) 1)) true))))))
(assert (not (= i2 (- len 1))))
(assert (= result4 i2))
(assert (= i3 (+ i2 1)))
(assert (not (<= i3 len)))
