...
(define-fun word_t__ref___18__projection ((a word_t__ref)) word_t (word_t__content a))
(define-fun dynamic_invariant5 ((temp___expr_855 (_ BitVec 16)) (temp___is_init_852 Bool) (temp___skip_constant_853 Bool) (temp___do_toplevel_854 Bool)) Bool true)
...
(declare-const hw__dbc__xcap_regs__read_i__2__off__assume Int)
...
(assert (= o1 (div1 o 4)))
(assert (and (= hw__dbc__xcap_regs__read_i__2__off__assume o1) (in_range2 o1)))
(assert (= hw__dbc__xcap_regs__read_i__2__off__assume off))
...
(assert (= o7 (bvshl ((_ int2bv 64) 1) o6)))
(assert (= o8 (bvsub o7 ((_ int2bv 64) 1))))
(assert (not true))
(check-sat)
(exit)
