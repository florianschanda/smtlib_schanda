...
(define-fun dynamic_invariant1 ((temp___expr_4409 us_rep1) (temp___is_init_4406 Bool) (temp___skip_constant_4407 Bool) (temp___do_toplevel_4408 Bool)) Bool (=> (= temp___do_toplevel_4408 true) (=> (= temp___is_init_4406 true) (ite (= (to_rep9 (rec__decadriver__rx_frame_type__error (us_split_fields3 temp___expr_4409))) 0) (< 0 (to_rep8 (rec__decadriver__rx_frame_type__size (us_split_fields3 temp___expr_4409)))) (= (to_rep8 (rec__decadriver__rx_frame_type__size (us_split_fields3 temp___expr_4409))) 0)))))
(define-fun dynamic_predicate ((temp___4420 us_rep1)) Bool (ite (= (to_rep9 (rec__decadriver__rx_frame_type__error (us_split_fields3 temp___4420))) 0) (< 0 (to_rep8 (rec__decadriver__rx_frame_type__size (us_split_fields3 temp___4420)))) (= (to_rep8 (rec__decadriver__rx_frame_type__size (us_split_fields3 temp___4420))) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_4427 (_ BitVec 8)) (temp___is_init_4424 Bool) (temp___skip_constant_4425 Bool) (temp___do_toplevel_4426 Bool)) Bool (=> (or (= temp___is_init_4424 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 1))) (in_range10 temp___expr_4427)))
...
(define-fun dynamic_invariant3 ((temp___expr_4459 us_rep2) (temp___is_init_4456 Bool) (temp___skip_constant_4457 Bool) (temp___do_toplevel_4458 Bool)) Bool (forall ((temp___4460 (_ BitVec 8))) (=> (and (bvule ((_ int2bv 8) 0) temp___4460) (bvule temp___4460 ((_ int2bv 8) 1))) (let ((temp___4461 (select (rec__decadriver__receiver_type__frame_queue (us_split_fields5 temp___expr_4459)) temp___4460))) (ite (= (to_rep9 (rec__decadriver__rx_frame_type__error (us_split_fields3 temp___4461))) 0) (< 0 (to_rep8 (rec__decadriver__rx_frame_type__size (us_split_fields3 temp___4461)))) (= (to_rep8 (rec__decadriver__rx_frame_type__size (us_split_fields3 temp___4461))) 0))))))
(define-fun default_initial_assumption ((temp___expr_4463 us_rep2) (temp___skip_top_level_4464 Bool)) Bool (and (and (and (and (= (rec__decadriver__receiver_type__frame_queue (us_split_fields5 temp___expr_4463)) (temp___4465 (mk___rep1 (mk___split_fields1 (of_rep8 0) (temp___4469 ((_ int2bv 8) 0)) (of_rep9 0) (of_int 0))))) (= (to_rep10 (rec__decadriver__receiver_type__queue_head (us_split_fields5 temp___expr_4463))) ((_ int2bv 8) 1))) (= (to_rep (rec__decadriver__receiver_type__rx_count (us_split_fields5 temp___expr_4463))) 0)) (= (rec__decadriver__receiver_type__overrun_occurred (us_split_fields5 temp___expr_4463)) (of_int 0))) (= (rec__decadriver__receiver_type__frame_ready (us_split_fields5 temp___expr_4463)) (of_int 0))))
...
(define-fun dynamic_invariant5 ((temp___expr_4397 Int) (temp___is_init_4394 Bool) (temp___skip_constant_4395 Bool) (temp___do_toplevel_4396 Bool)) Bool (=> (or (= temp___is_init_4394 true) (<= 0 1024)) (in_range8 temp___expr_4397)))
(define-fun dynamic_invariant6 ((temp___expr_4403 Int) (temp___is_init_4400 Bool) (temp___skip_constant_4401 Bool) (temp___do_toplevel_4402 Bool)) Bool (=> (or (= temp___is_init_4400 true) (<= 0 5)) (in_range9 temp___expr_4403)))
...
(declare-const temp___4563 frame_length)
(declare-const temp___45631 (Array Int bits_8))
(declare-const temp___45632 rx_errors)
(declare-const temp___45633 Bool)
...
(declare-const temp___4567 frame_length)
(declare-const temp___45671 (Array Int bits_8))
(declare-const temp___45672 rx_errors)
(declare-const temp___45673 Bool)
...
(declare-const temp___4571 us_rep1)
...
(assert (not (< 0 (ite (<= (to_rep1 o21) (to_rep1 o22)) (+ (- (to_rep1 o22) (to_rep1 o21)) 1) 0))))
(check-sat)
(exit)
