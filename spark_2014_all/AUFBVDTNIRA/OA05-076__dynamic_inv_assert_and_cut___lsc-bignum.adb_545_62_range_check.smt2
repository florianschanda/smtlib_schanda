...
(assert (and (= o21 o20) (uint_in_range1 o20)))
(assert (= o22 ((_ int2bv 64) o21)))
(assert (= o23 (bvadd o22 #x0000000000000001)))
(assert (= o24 (bvmul o23 #x0000000000000020)))
(assert (= o25 (ite (bvult i2 o24) true false)))
