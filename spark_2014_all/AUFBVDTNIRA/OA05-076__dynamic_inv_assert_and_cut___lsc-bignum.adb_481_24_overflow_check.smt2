...
(assert (and (= o150 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o151 (num_of_big_int (mk___t aux11 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first o150)))
(assert (= o153 (oeq o151 o152)))
