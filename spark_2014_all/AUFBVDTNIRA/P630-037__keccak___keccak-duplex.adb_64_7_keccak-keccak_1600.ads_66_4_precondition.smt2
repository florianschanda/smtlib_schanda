...
(assert (forall ((temp___1065 Int)) (ite (and (<= 0 temp___1065) (<= temp___1065 r176s)) (= (select o12 temp___1065) (select (slide keccak__padding__pad101_single_block__block (to_rep (first (mk (to_rep (first6 keccak__padding__pad101_single_block__block__compl1)) (to_rep (last6 keccak__padding__pad101_single_block__block__compl1))))) 0) temp___1065)) (= (select o12 temp___1065) (select block2 temp___1065)))))
