...
(assert (and (= o94 (rate_of (mk___rep (us_split_fields__content ctx__split_fields46)))) (and (in_range3 o94) (and (= o94 (* (to_rep6 (rec__keccak__keccak_1600__sponge__context__rate (us_split_fields__content ctx__split_fields46))) 8)) (< o94 1600)))))
(assert (and (= o95 (in_queue_bit_length (mk___rep (us_split_fields__content ctx__split_fields46)))) (and (in_range2 o95) (and (= o95 (to_rep5 (rec__keccak__keccak_1600__sponge__context__bits_absorbed (us_split_fields__content ctx__split_fields46)))) (< o95 1600)))))
(assert (= o96 (ite (< o95 o94) true false)))
(assert (and (= o91 (+ bit_length suffix_len)) (in_range1 (+ bit_length suffix_len))))
(assert (not (not (= 8 0))))
(check-sat)
(exit)
