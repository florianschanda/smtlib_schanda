...
(assert (and (<= (to_rep1 (first (rt addr))) (div1 left 8)) (<= (div1 left 8) (to_rep1 (last (rt addr))))))
(assert (= o1 (div1 left 8)))
(assert (= o2 (select (elts addr) o1)))
(assert (= o3 (to_rep o2)))
(assert (and (= o4 (peekbit8 o3 (mod1 left 8))) (= (= o4 true) (= (nth o3 (- 7 (mod1 left 8))) true))))
(assert (= (mk_bool__ref result) (mk_bool__ref bitwalker__peekbit8array__result)))
(assert (= bitwalker__peekbit8array__result1 o4))
...
(assert (not (= (to_rep1 (first (rt addr))) 0)))
(check-sat)
(exit)
