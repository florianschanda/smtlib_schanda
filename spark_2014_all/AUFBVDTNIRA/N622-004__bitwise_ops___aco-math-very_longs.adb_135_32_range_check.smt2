...
(assert (and (<= (to_rep1 (first (rt number))) temp___1065) (<= temp___1065 (to_rep1 (last (rt number))))))
...
(assert (= (to_rep2 o20) (bvadd (bvmul ((_ int2bv 8) 16) h_digit2) l_digit2)))
...
(assert (= o21 index2))
(assert (= o22 (store (elts1 (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)) o21 o20)))
(assert (= o22 o23))
(assert (= (rt1 (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)) o24))
(assert (= o25 (mk___split_fields (mk___t1 o23 o24))))
(assert (= temp___1068 (mk___rep result____split_discrs o25)))
