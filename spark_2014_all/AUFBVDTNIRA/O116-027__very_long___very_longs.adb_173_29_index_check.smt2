...
(assert (= (to_rep4 (first6 (rt3 (temp___886 #x00 1 r32b)))) 1))
(assert (= (to_rep4 (last6 (rt3 (temp___886 #x00 1 r32b)))) r32b))
(assert (= (mk___t3 temp___893 temp___8931) (temp___886 #x00 1 r32b)))
(assert (= (ite (<= (to_rep4 (first6 temp___8931)) (to_rep4 (last6 temp___8931))) (+ (- (to_rep4 (last6 temp___8931)) (to_rep4 (first6 temp___8931))) 1) 0) (ite (<= 1 r32b) (+ (- r32b 1) 1) 0)))
