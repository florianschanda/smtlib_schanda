...
(assert (= (to_rep4 (first6 (rt3 (temp___817 ((_ int2bv 8) 0) 1 r32b)))) 1))
(assert (= (to_rep4 (last6 (rt3 (temp___817 ((_ int2bv 8) 0) 1 r32b)))) r32b))
(assert (= (mk___t3 temp___824 temp___8241) (temp___817 ((_ int2bv 8) 0) 1 r32b)))
(assert (= (ite (<= (to_rep4 (first6 temp___8241)) (to_rep4 (last6 temp___8241))) (+ (- (to_rep4 (last6 temp___8241)) (to_rep4 (first6 temp___8241))) 1) 0) (ite (<= 1 r32b) (+ (- r32b 1) 1) 0)))
...
(assert (and (<= 1 index2) (<= index2 (to_rep4 (last2 (rt1 (rec__very_longs__very_long__long_digits result____split_fields3)))))))
(assert (and (and (dynamic_invariant4 (mk___rep result____split_discrs result____split_fields3) false true true) (=> (<= 1 65536) (in_range5 index2))) (=> (<= 1 2147483647) (in_range2 string_index2))))
(assert (and (<= (to_rep1 (first (rt number))) string_index2) (<= string_index2 (to_rep1 (last (rt number))))))
(assert (= o12 string_index2))
(assert (= o13 (select (elts number) o12)))
...
(assert (= o15 temp___830))
(assert (= o16 (select (elts number) o15)))
(assert (= o17 (to_rep o16)))
(assert true)
(assert (= (ite (= h_okay true) l_okay false) true))
(assert (= valid3 valid2))
(assert (= (to_rep4 (last2 (rt1 (rec__very_longs__very_long__long_digits result____split_fields3)))) r35b))
(assert (in_range4 r35b))
(assert (and (<= 1 index2) (<= index2 r35b)))
(assert (= (to_rep3 o18) (bvadd (bvmul ((_ int2bv 8) 16) h_digit2) l_digit2)))
(assert (not (<= (to_rep4 (first2 (rt1 (rec__very_longs__very_long__long_digits result____split_fields3)))) index2)))
(check-sat)
(exit)
