...
(assert (=> (not (= (mod1 (length value) 4) 0)) (forall ((temp___492 Int)) (ite (and (<= r12b temp___492) (<= temp___492 r13b)) (= (select o13 temp___492) (select temp___491 temp___492)) (= (select o13 temp___492) (select data1 temp___492))))))
