...
(assert (= (temp___String_Literal_1935 Tuple0) temp___1936))
(assert (= (mk1 1 16) temp___19361))
(assert (dynamic_predicate temp___19362))
(assert (= o5 temp___19362))
(assert (= o2 (convertretvaltotext retvalini1 o5)))
(assert (= o2 o3))
(assert (= (mk 1 150) o4))
