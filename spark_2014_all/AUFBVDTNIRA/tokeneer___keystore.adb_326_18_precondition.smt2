...
(assert (dynamic_predicate (mk___t1 temp___1762 temp___17621)))
(assert (= (mk___t1 o o1) (mk___t1 temp___1762 temp___17621)))
(assert (= o2 (convertretvaltotext retvalini1 (mk___t1 o o1))))
(assert (= o2 o3))
(assert (= (mk 1 150) o4))
