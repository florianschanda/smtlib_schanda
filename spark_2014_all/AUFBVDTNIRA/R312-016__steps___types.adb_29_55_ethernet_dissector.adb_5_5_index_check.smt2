...
(define-fun dynamic_invariant1 ((temp___expr_609 (_ BitVec 16)) (temp___is_init_605 Bool) (temp___skip_constant_606 Bool) (temp___do_toplevel_607 Bool) (temp___do_typ_inv_608 Bool)) Bool true)
...
(assert (and (= temp___743 (- (to_rep1 (last (rt buffer))) i1)) (in_range1 (- (to_rep1 (last (rt buffer))) i1))))
(assert (not (<= temp___743 (to_rep1 (last (rt buffer))))))
(check-sat)
(exit)
