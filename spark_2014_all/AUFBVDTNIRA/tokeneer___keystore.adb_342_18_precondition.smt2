...
(declare-const o9 t)
(declare-const temp___1940 us_t1)
...
(define-fun o13 () us_t1 (mk___t1 o5 o6))
(define-fun temp___19382 () us_t1 (mk___t1 temp___1938 temp___19381))
(define-fun o14 () us_t1 (mk___t1 o o1))
...
(assert (=> (= (select issystem retvalini1) true) (= o14 temp___19362)))
(assert (=> (= (select issystem retvalini1) true) (= o2 (convertretvaltotext retvalini1 o14))))
...
(assert (=> (= (select issystem retvaldo2) true) (= o13 temp___19382)))
(assert (=> (= (select issystem retvaldo2) true) (= o7 (convertretvaltotext retvaldo2 o13))))
...
(assert (= temp___1940 (mk___t1 (temp___String_Literal_1939 Tuple0) (mk1 1 17))))
(assert (dynamic_predicate temp___1940))
(assert (= o10 temp___1940))
(assert (= o11 (convertretvaltotext retvalfin2 o10)))
