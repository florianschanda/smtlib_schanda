...
(define-fun dynamic_invariant1 ((temp___expr_172 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= 0 65535)) (in_range2 temp___expr_172)))
...
(define-fun dynamic_invariant3 ((temp___expr_166 (_ BitVec 8)) (temp___is_init_163 Bool) (temp___skip_constant_164 Bool) (temp___do_toplevel_165 Bool)) Bool true)
(define-fun dynamic_invariant4 ((temp___expr_190 us_t) (temp___is_init_187 Bool) (temp___skip_constant_188 Bool) (temp___do_toplevel_189 Bool)) Bool (=> (not (= temp___skip_constant_188 true)) (dynamic_property 0 65535 (first1 temp___expr_190) (last1 temp___expr_190))))
...
(declare-const temporary_110 t__ref1)
(declare-const temporary_29 t__ref1)
(declare-const i9 int__ref)
(declare-const data10 (Array Int octet))
(declare-const last5 Int)
(declare-const temporary_111 (_ BitVec 64))
...
(assert (= i1 1))
(assert (not (not (= ((_ int2bv 64) 256) #x0000000000000000))))
(check-sat)
(exit)
