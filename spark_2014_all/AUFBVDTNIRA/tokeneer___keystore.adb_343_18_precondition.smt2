...
(assert (=> (= (select issystem retvalini1) true) (= o14 temp___19322)))
...
(assert (=> (= (select issystem retvaldo2) true) (= o13 temp___19342)))
...
(assert (dynamic_predicate temp___1936))
(assert (= o10 temp___1936))
