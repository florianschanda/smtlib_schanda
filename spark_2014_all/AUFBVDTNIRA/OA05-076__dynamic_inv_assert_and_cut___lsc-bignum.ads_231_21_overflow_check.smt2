...
(assert (= o14 (+ x_first o13)))
(assert (and (= o15 o14) (in_range1 o14)))
(assert (= o16 (ite (<= o15 (to_rep (last (rt x)))) true false)))
(assert (and (= o10 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o11 (+ x_first o10)))
(assert (and (= o12 o11) (in_range1 o11)))
(assert (= o17 (ite (<= (to_rep (first (rt x))) o12) true false)))
...
(assert (= o6 (+ m_first o5)))
(assert (and (= o7 o6) (in_range1 o6)))
(assert (= o8 (ite (<= o7 (to_rep (last (rt m)))) true false)))
(assert (and (= o2 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o3 (+ m_first o2)))
(assert (and (= o4 o3) (in_range1 o3)))
(assert (= o9 (ite (<= (to_rep (first (rt m))) o4) true false)))
