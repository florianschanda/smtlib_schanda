...
(assert (= o18 (+ x_first o17)))
(assert (and (= o19 o18) (in_range1 o18)))
(assert (= o20 (ite (<= o19 (to_rep (last (rt x)))) true false)))
(assert (and (= o14 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o15 (+ x_first o14)))
(assert (and (= o16 o15) (in_range1 o15)))
(assert (= o21 (ite (<= (to_rep (first (rt x))) o16) true false)))
(assert (= result (ite (= o21 true) o20 false)))
(assert (= result true))
...
(assert (= o10 (+ m_first o9)))
(assert (and (= o11 o10) (in_range1 o10)))
(assert (= o12 (ite (<= o11 (to_rep (last (rt m)))) true false)))
(assert (and (= o6 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o7 (+ m_first o6)))
(assert (and (= o8 o7) (in_range1 o7)))
(assert (= o13 (ite (<= (to_rep (first (rt m))) o8) true false)))
(assert (= result1 (ite (= o13 true) o12 false)))
(assert (= result1 true))
...
(assert (= o5 (ite (<= o4 (to_rep aux1__last)) true false)))
