...
(assert (not (= (ite (<= (to_rep (first temp___9031)) (to_rep (last temp___9031))) (+ (- (to_rep (last temp___9031)) (to_rep (first temp___9031))) 1) 0) (ite (<= (to_rep digest__first) (to_rep digest__last)) (+ (- (to_rep digest__last) (to_rep digest__first)) 1) 0))))
(check-sat)
(exit)
