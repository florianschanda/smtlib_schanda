...
(define-fun eq__logic ((a (_ BitVec 64)) (b (_ BitVec 64))) Bool (ite (eq_sub a b 0 64) true false))
...
(define-fun dynamic_invariant3 ((temp___expr_215 Int) (temp___is_init_212 Bool) (temp___skip_constant_213 Bool) (temp___do_toplevel_214 Bool)) Bool (=> (or (= temp___is_init_212 true) (<= 0 0)) (in_range4 temp___expr_215)))
(define-fun dynamic_invariant4 ((temp___expr_208 us_t) (temp___is_init_205 Bool) (temp___skip_constant_206 Bool) (temp___do_toplevel_207 Bool)) Bool (=> (not (= temp___skip_constant_206 true)) (dynamic_property 0 2147483646 (first1 temp___expr_208) (last1 temp___expr_208))))
...
(assert (forall ((start Int) (length1 Int)) (forall ((addr us_t)) (! (=> (and (and (and (dynamic_invariant1 start true true true) (dynamic_invariant1 length1 true true true)) (dynamic_invariant4 addr true true true)) (and (= (first1 addr) 0) (and (<= length1 64) (and (<= (+ start length1) 2147483647) (<= (* 8 (length addr)) 2147483647))))) (let ((result (peek start length1 addr))) (and (ite (< (* 8 (length addr)) (+ start length1)) (= result ((_ int2bv 64) 0)) (=> (<= (+ start length1) (* 8 (length addr))) (and (forall ((i Int)) (=> (and (<= 0 i) (<= i (- length1 1))) (= (= (nth8_stream addr (- (- (+ start length1) i) 1)) true) (= (nth result i) true)))) (forall ((i Int)) (=> (and (<= length1 i) (<= i 63)) (not (= (nth result i) true))))))) (dynamic_invariant2 result true false true)))) :pattern ((peek start length1 addr))))))
(declare-fun lemmafunction2 ((_ BitVec 64) Int) Int)
(declare-fun lemmafunction2__function_guard (Int (_ BitVec 64) Int) Bool)
(assert (forall ((x (_ BitVec 64))) (forall ((len Int)) (! (=> (and (and (dynamic_invariant2 x true true true) (dynamic_invariant len true true true)) (and (and (<= 0 len) (<= len 63)) (bvult x (maxvalue len)))) (let ((result (lemmafunction2 x len))) (and (and (= result 0) (forall ((i Int)) (=> (and (<= len i) (<= i 63)) (not (= (nth x i) true))))) (dynamic_invariant3 result true false true)))) :pattern ((lemmafunction2 x len))))))
...
(define-fun dynamic_invariant5 ((temp___expr_160 (_ BitVec 8)) (temp___is_init_157 Bool) (temp___skip_constant_158 Bool) (temp___do_toplevel_159 Bool)) Bool true)
(define-fun dynamic_invariant6 ((temp___expr_202 Int) (temp___is_init_199 Bool) (temp___skip_constant_200 Bool) (temp___do_toplevel_201 Bool)) Bool (=> (or (= temp___is_init_199 true) (<= 0 2147483646)) (in_range3 temp___expr_202)))
...
(assert true)
(assert true)
(assert (and (= (to_rep addr__first) 0) (and (< (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) 2147483647) (and (and (<= 0 len) (<= len 63)) (and (<= (+ start len) (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) (bvult value (maxvalue len)))))))
(assert (=> (<= (- 2147483648) 2147483647) (in_range1 pokeresult)))
(assert (=> (<= 0 0) (in_range4 v)))
(assert (and (= o5 (lemmafunction2 value len)) (and (in_range4 o5) (and (= o5 0) (forall ((i Int)) (=> (and (<= len i) (<= i 63)) (not (= (nth value i) true))))))))
(assert (= (mk_int__ref result1) (mk_int__ref v)))
(assert (= v1 o5))
(assert (and (and (and (<= (- 2) pokeresult1) (<= pokeresult1 0)) (and (= (= pokeresult1 (- 1)) (< (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) (+ start len))) (and (= (= pokeresult1 (- 2)) (and (bvule (maxvalue len) value) (<= (+ start len) (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0))))) (and (= (= pokeresult1 0) (and (bvugt (maxvalue len) value) (<= (+ start len) (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0))))) (and (=> (= pokeresult1 0) (forall ((i Int)) (=> (and (<= 0 i) (<= i (- start 1))) (= (= (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) i) true) (= (nth8_stream (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) i) true))))) (and (=> (= pokeresult1 0) (forall ((i Int)) (=> (and (<= start i) (<= i (- (+ start len) 1))) (= (= (nth8_stream (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) i) true) (= (nth value (+ (- (- len i) 1) start)) true))))) (=> (= pokeresult1 0) (forall ((i Int)) (=> (and (<= (+ start len) i) (<= i (- (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) 1))) (= (= (nth8_stream (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) i) true) (= (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) i) true))))))))))) (in_range1 pokeresult1)))
(assert (not (= pokeresult1 0)))
(check-sat)
(exit)
