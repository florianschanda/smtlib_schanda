...
(define-fun dynamic_invariant3 ((temp___expr_251 Int) (temp___is_init_247 Bool) (temp___skip_constant_248 Bool) (temp___do_toplevel_249 Bool) (temp___do_typ_inv_250 Bool)) Bool (=> (or (= temp___is_init_247 true) (<= 0 0)) (in_range4 temp___expr_251)))
(define-fun dynamic_invariant4 ((temp___expr_243 us_t) (temp___is_init_239 Bool) (temp___skip_constant_240 Bool) (temp___do_toplevel_241 Bool) (temp___do_typ_inv_242 Bool)) Bool (=> (not (= temp___skip_constant_240 true)) (dynamic_property 0 2147483646 (first1 temp___expr_243) (last1 temp___expr_243))))
...
(assert (forall ((start Int) (length1 Int)) (forall ((addr us_t)) (! (=> (and (and (and (dynamic_invariant1 start true true true true) (dynamic_invariant1 length1 true true true true)) (dynamic_invariant4 addr true true true true)) (and (= (first1 addr) 0) (and (<= length1 64) (and (<= (+ start length1) 2147483647) (<= (* 8 (length addr)) 2147483647))))) (let ((result (peek start length1 addr))) (and (ite (< (* 8 (length addr)) (+ start length1)) (= result #x0000000000000000) (=> (<= (+ start length1) (* 8 (length addr))) (and (forall ((i Int)) (=> (and (<= 0 i) (<= i (- length1 1))) (= (= (nth8_stream addr (- (- (+ start length1) i) 1)) true) (= (nth result i) true)))) (forall ((i Int)) (=> (and (<= length1 i) (<= i 63)) (not (= (nth result i) true))))))) (dynamic_invariant2 result true false true true)))) :pattern ((peek start length1 addr))))))
(declare-fun lemmafunction2 ((_ BitVec 64) Int) Int)
(declare-fun lemmafunction2__function_guard (Int (_ BitVec 64) Int) Bool)
(assert (forall ((x (_ BitVec 64))) (forall ((len Int)) (! (=> (and (and (dynamic_invariant2 x true true true true) (dynamic_invariant len true true true true)) (and (and (<= 0 len) (<= len 63)) (bvult x (maxvalue len)))) (let ((result (lemmafunction2 x len))) (and (and (= result 0) (forall ((i Int)) (=> (and (<= len i) (<= i 63)) (not (= (nth x i) true))))) (dynamic_invariant3 result true false true true)))) :pattern ((lemmafunction2 x len))))))
...
(assert (and (= o (lemmafunction2 value len)) (and (in_range4 o) (and (= o 0) (forall ((i Int)) (=> (and (<= len i) (<= i 63)) (not (= (nth value i) true))))))))
