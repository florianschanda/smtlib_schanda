...
(declare-const temp___812 Int)
(declare-const temp___809 digit_index_type)
(declare-const temp___8091 (Array Int octet))
(declare-const temp___8092 t1)
...
(assert (<= 1 index1))
(assert (<= index1 r27b))
(assert (and (and (and (dynamic_invariant2 (mk___rep1 result____split_discrs result____split_fields3) false true true) (forall ((temp___811 Int)) (=> (and (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))) temp___811) (<= temp___811 (to_rep2 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))))) (=> (<= index2 temp___811) (= (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields3)) temp___811) (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields2)) temp___811)))))) (=> (<= 0 2147483647) (in_range1 temp2))) (and (<= 1 index2) (<= index2 r27b))))
