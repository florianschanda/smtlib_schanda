...
(define-fun dynamic_invariant1 ((temp___expr_228 Int) (temp___is_init_224 Bool) (temp___skip_constant_225 Bool) (temp___do_toplevel_226 Bool) (temp___do_typ_inv_227 Bool)) Bool (=> (or (= temp___is_init_224 true) (<= 1 65536)) (in_range3 temp___expr_228)))
...
(declare-datatypes () ((tT24bP1__ref (mk_tT24bP1__ref (tT24bP1__content tdigit_count_typeB)))))
(define-fun tT24bP1__ref___projection ((a tT24bP1__ref)) tdigit_count_typeB (tT24bP1__content a))
(declare-sort t1 0)
...
(declare-datatypes () ((t24b__ref (mk_t24b__ref (t24b__content us_t1)))))
(define-fun t24b__ref___projection ((a t24b__ref)) us_t1 (t24b__content a))
...
(define-fun dynamic_invariant2 ((temp___expr_419 us_rep1) (temp___is_init_415 Bool) (temp___skip_constant_416 Bool) (temp___do_toplevel_417 Bool) (temp___do_typ_inv_418 Bool)) Bool (and (=> (not (= temp___skip_constant_416 true)) (in_range4 length1 (to_base temp___expr_419))) (and (dynamic_property3 1 length1 (first3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_419))) (last3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_419)))) (and (= (first3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_419))) 1) (= (last3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_419))) length1)))))
(define-fun default_initial_assumption ((temp___expr_422 us_rep1) (temp___skip_top_level_423 Bool)) Bool (= (to_rep (rec__very_longs__very_long__length (us_split_discrs2 temp___expr_422))) length1))
...
(declare-datatypes () ((t25b__ref (mk_t25b__ref (t25b__content tdigit_count_typeB)))))
(define-fun t25b__ref___projection ((a t25b__ref)) tdigit_count_typeB (t25b__content a))
(declare-sort t2 0)
...
(declare-datatypes () ((t26b__ref (mk_t26b__ref (t26b__content us_t2)))))
(define-fun t26b__ref___projection ((a t26b__ref)) us_t2 (t26b__content a))
(declare-const r27b Int)
(declare-const attr__ATTRIBUTE_ADDRESS4 Int)
(declare-const attr__ATTRIBUTE_ADDRESS5 Int)
(declare-fun temp___863 ((_ BitVec 8) Int Int) us_t2)
...
(assert (forall ((temp___865 (_ BitVec 8))) (forall ((temp___866 Int) (temp___867 Int)) (let ((temp___864 (temp___863 temp___865 temp___866 temp___867))) (=> (dynamic_invariant3 temp___865 true true true true) (and (=> (dynamic_property6 1 65536 temp___866 temp___867) (and (= (first5 temp___864) temp___866) (= (last5 temp___864) temp___867))) (forall ((temp___868 Int)) (= (to_rep1 (select (to_array2 temp___864) temp___868)) temp___865))))))))
...
(declare-const temp___870 (Array Int octet))
(declare-const temp___8701 t2)
(declare-const temp___871 (Array Int octet))
(declare-const temp___8711 t1)
(declare-const o (Array Int octet))
(declare-const o1 t1)
(declare-const o2 (Array Int octet))
(declare-const o3 t1)
(declare-const temp___874 digit_index_type)
(declare-const temp___8741 (Array Int octet))
(declare-const temp___8742 t1)
...
(assert (= (to_rep (rec__very_longs__very_long__length result____split_discrs)) length1))
(assert (= (to_rep2 (first4 (rt2 (temp___863 #x00 1 length1)))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___863 #x00 1 length1)))) length1))
(assert (= (mk___t2 temp___870 temp___8701) (temp___863 #x00 1 length1)))
(assert (= (ite (<= (to_rep2 (first4 temp___8701)) (to_rep2 (last4 temp___8701))) (+ (- (to_rep2 (last4 temp___8701)) (to_rep2 (first4 temp___8701))) 1) 0) (ite (<= 1 length1) (+ (- length1 1) 1) 0)))
(assert (= temp___870 temp___871))
(assert (= (mk1 (to_rep2 (first4 temp___8701)) (to_rep2 (last4 temp___8701))) temp___8711))
(assert (= (ite (<= (to_rep2 (first2 temp___8711)) (to_rep2 (last2 temp___8711))) (+ (- (to_rep2 (last2 temp___8711)) (to_rep2 (first2 temp___8711))) 1) 0) (ite (<= (to_rep2 (first2 result____split_fields1)) (to_rep2 (last2 result____split_fields1))) (+ (- (to_rep2 (last2 result____split_fields1)) (to_rep2 (first2 result____split_fields1))) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___871 temp___8711)))
(assert (= o2 o))
(assert (= o3 o1))
(assert (= result____split_discrs (mk___split_discrs temp___874)))
(assert (= temp___8741 o2))
(assert (= temp___8742 o3))
(assert (= result (mk___split_fields__ref1 (mk___split_fields1 (mk___t1 result____split_fields result____split_fields1)))))
(assert (= result____split_fields2 (mk___split_fields1 (mk___t1 temp___8741 temp___8742))))
(assert (= result____split_discrs (mk___split_discrs temp___874)))
(assert (= result1 (mk_int__ref temp)))
(assert (= temp1 number))
(assert (= (to_rep2 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields2)))) r27b))
(assert (in_range2 r27b))
(assert (= result2 (mk_int__ref index)))
(assert (= index1 1))
(assert (<= 1 index1))
(assert (<= index1 r27b))
(assert (and (and (and (dynamic_invariant2 (mk___rep1 result____split_discrs result____split_fields3) false true true true) (forall ((temp___880 Int)) (=> (and (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))) temp___880) (<= temp___880 (to_rep2 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))))) (=> (<= index2 temp___880) (= (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields3)) temp___880) (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields2)) temp___880)))))) (=> (<= 0 2147483647) (in_range1 temp2))) (and (<= 1 index2) (<= index2 r27b))))
