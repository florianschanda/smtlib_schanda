...
(assert (and (= result6 (bit_set e e_first (bvsub i2 ((_ int2bv 64) j3)))) (= (= result6 true) (not (= (bvand (to_rep1 (select (elts e) (+ e_first (bv2nat (bvudiv (bvsub i2 ((_ int2bv 64) j3)) #x0000000000000020))))) (let ((temp___515 (bv2nat (bvurem (bvsub i2 ((_ int2bv 64) j3)) #x0000000000000020)))) (ite (< temp___515 4294967296) (bvshl #x00000001 ((_ int2bv 32) temp___515)) #x00000000))) #x00000000)))))
(assert (= result6 true))
