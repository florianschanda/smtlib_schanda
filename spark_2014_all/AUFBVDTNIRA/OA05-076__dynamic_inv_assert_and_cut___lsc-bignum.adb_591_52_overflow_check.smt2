...
(assert (<= j3 k))
(assert (bvule ((_ int2bv 64) j3) i2))
(assert (and (= result20 (bit_set e e_first (bvsub i2 ((_ int2bv 64) j3)))) (= (= result20 true) (not (= (bvand (to_rep1 (select (elts e) (+ e_first (bv2nat (bvudiv (bvsub i2 ((_ int2bv 64) j3)) ((_ int2bv 64) 32)))))) (let ((temp___455 (bv2nat (bvurem (bvsub i2 ((_ int2bv 64) j3)) ((_ int2bv 64) 32))))) (ite (< temp___455 4294967296) (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) temp___455)) ((_ int2bv 32) 0)))) ((_ int2bv 32) 0))))))
(assert (= result20 true))
(assert (not (in_range1 (- j3 s3))))
(check-sat)
(exit)
