...
(define-fun word_t__ref___10__projection ((a word_t__ref)) word_t (word_t__content a))
(define-fun dynamic_invariant5 ((temp___expr_835 (_ BitVec 16)) (temp___is_init_831 Bool) (temp___skip_constant_832 Bool) (temp___do_toplevel_833 Bool) (temp___do_typ_inv_834 Bool)) Bool true)
...
(assert (= (naturalqtint rliteral2) 4))
(declare-const rliteral3 natural)
(assert (= (naturalqtint rliteral3) 11))
(assert (= op_reg_descs (hw__dbc__op_reg_descs__aggregate_def (mk___rep (mk___split_fields rliteral rliteral rliteral)) (mk___rep (mk___split_fields rliteral rliteral1 rliteral1)) (mk___rep (mk___split_fields rliteral2 rliteral rliteral)) (mk___rep (mk___split_fields rliteral2 rliteral3 rliteral3)))))
...
(declare-const hw__dbc__op_regs__read_i__2__off__assume Int)
...
(assert (= o1 (div1 o 4)))
(assert (and (= hw__dbc__op_regs__read_i__2__off__assume o1) (in_range2 o1)))
(assert (= hw__dbc__op_regs__read_i__2__off__assume off))
...
(assert (= o3 (- o2 (to_rep (rec__hw__dbc__op_s_regs__t__lsb (us_split_fields1 (select regs idx)))))))
(assert (and (= o4 o3) (in_range o3)))
(assert (and (= o5 o4) (in_range1 o4)))
(assert (= o6 ((_ int2bv 64) o5)))
(assert (= o7 (bvshl #x0000000000000001 o6)))
(assert (= o8 (bvsub o7 #x0000000000000001)))
(assert (= o9 o8))
(assert (= result mask))
(assert (= mask1 o9))
(assert (not (bvule ((_ zero_extend 48) #x0000) (bvand (bvlshr ((_ zero_extend 32) temp) ((_ int2bv 64) (to_rep (rec__hw__dbc__op_s_regs__t__lsb (us_split_fields1 (select regs idx)))))) mask1))))
(check-sat)
(exit)
