...
(assert (and (= o162 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (and (= o161 (base Tuple0)) (= o161 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o163 (oexpon o161 o162)))
(assert (and (= o158 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o159 (num_of_big_int x x_first o158)))
(assert (and (= o156 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o157 (num_of_big_int x x_first o156)))
(assert (= o160 (omultiply o157 o159)))
(assert (= o164 (omultiply o160 o163)))
(assert (= o167 (omod o164 o166)))
(assert (and (= o154 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o155 (num_of_big_int (mk___t aux2 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first o154)))
(assert (= o168 (oeq o155 o167)))
(assert (= o152 (from_word32 ((_ int2bv 32) 1))))
