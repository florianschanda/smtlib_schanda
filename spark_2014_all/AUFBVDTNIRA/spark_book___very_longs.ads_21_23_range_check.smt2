...
(assert (and (= o (* 2 (to_rep2 (rec__very_longs__very_long__length result____split_discrs)))) (in_range4 (* 2 (to_rep2 (rec__very_longs__very_long__length result____split_discrs))))))
(assert (not (in_range4 (length number))))
(check-sat)
(exit)
