...
(assert (= o3 (mk___t (elts3 temp___1297) (mk (to_rep2 (first7 (rt3 temp___1297))) (to_rep2 (last8 (rt3 temp___1297)))))))
(assert (= o4 (mk___split_fields o3)))
(assert (= temp___1299 (mk___rep quotient__split_discrs o4)))
...
(assert (= o5 (mk___t (elts5 temp___1310) (mk (to_rep2 (first11 (rt5 temp___1310))) (to_rep2 (last12 (rt5 temp___1310)))))))
(assert (= o6 (mk___split_fields o5)))
(assert (= temp___1312 (mk___rep remainder__split_discrs o6)))
...
(assert (and (= o7 (get_msd divisor)) (and (in_range2 o7) (and (not (= (to_rep (select (elts (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 divisor))) o7)) ((_ int2bv 8) 0))) (forall ((i Int)) (=> (and (<= (+ o7 1) i) (<= i (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 divisor))))))) (= (to_rep (select (elts (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 divisor))) i)) ((_ int2bv 8) 0))))))))
(assert (= o8 (+ o7 1)))
(assert (and (= temp___1313 o8) (in_range1 o8)))
(assert (and (= us4 temp___1313) (dynamic_property2 1 last2 temp___1313)))
(assert (= o9 temp___1313))
...
(assert (and (dynamic_invariant6 (mk___rep1 u__split_discrs u__split_fields5) true true true) (dynamic_invariant2 (mk___rep quotient__split_discrs quotient__split_fields4) true true true)))
