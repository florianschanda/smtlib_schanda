...
(define-fun word_t__ref___13__projection ((a word_t__ref)) word_t (word_t__content a))
(define-fun dynamic_invariant5 ((temp___expr_762 (_ BitVec 8)) (temp___is_init_759 Bool) (temp___skip_constant_760 Bool) (temp___do_toplevel_761 Bool)) Bool true)
...
(declare-const hw__dbc__op_regs__write_i__off__assume Int)
