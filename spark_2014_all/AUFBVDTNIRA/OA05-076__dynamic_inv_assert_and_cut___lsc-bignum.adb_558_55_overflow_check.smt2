...
(assert (= o25 (num_of_big_int (mk___t aux31 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first o24)))
...
(assert (= o10 (num_of_big_int (mk___t aux2 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first o9)))
(assert (= o23 (oeq o10 o22)))
(assert (= o8 (from_word32 #x00000001)))
