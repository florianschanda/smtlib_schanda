...
(define-fun dynamic_invariant1 ((temp___expr_166 (_ BitVec 32)) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool true)
...
(define-fun dynamic_invariant2 ((temp___expr_201 Int) (temp___is_init_197 Bool) (temp___skip_constant_198 Bool) (temp___do_toplevel_199 Bool) (temp___do_typ_inv_200 Bool)) Bool (=> (or (= temp___is_init_197 true) (<= 0 65535)) (in_range2 temp___expr_201)))
...
(define-fun dynamic_invariant4 ((temp___expr_276 (_ BitVec 32)) (temp___is_init_272 Bool) (temp___skip_constant_273 Bool) (temp___do_toplevel_274 Bool) (temp___do_typ_inv_275 Bool)) Bool true)
...
(define-fun dynamic_invariant5 ((temp___expr_283 Int) (temp___is_init_279 Bool) (temp___skip_constant_280 Bool) (temp___do_toplevel_281 Bool) (temp___do_typ_inv_282 Bool)) Bool (=> (or (= temp___is_init_279 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_283)))
...
(assert (forall ((s (_ BitVec 32))) (! (=> (dynamic_invariant4 s true true true true) (dynamic_invariant5 (xdr_unsigned_to_integer s) true false true true)) :pattern ((xdr_unsigned_to_integer s)))))
