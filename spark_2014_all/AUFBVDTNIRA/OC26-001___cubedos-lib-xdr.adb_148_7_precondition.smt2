...
(declare-fun user_eq (xdr_integer xdr_integer) Bool)
(declare-const dummy xdr_integer)
...
(define-fun dynamic_invariant1 ((temp___expr_142 (_ BitVec 32)) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool true)
...
(define-fun dynamic_invariant2 ((temp___expr_172 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= 0 65535)) (in_range2 temp___expr_172)))
...
(define-fun dynamic_invariant3 ((temp___expr_190 us_t) (temp___is_init_187 Bool) (temp___skip_constant_188 Bool) (temp___do_toplevel_189 Bool)) Bool (=> (not (= temp___skip_constant_188 true)) (dynamic_property 0 65535 (first1 temp___expr_190) (last1 temp___expr_190))))
...
(define-fun dynamic_invariant4 ((temp___expr_241 (_ BitVec 32)) (temp___is_init_238 Bool) (temp___skip_constant_239 Bool) (temp___do_toplevel_240 Bool)) Bool true)
...
(define-fun dynamic_invariant5 ((temp___expr_247 Int) (temp___is_init_244 Bool) (temp___skip_constant_245 Bool) (temp___do_toplevel_246 Bool)) Bool (=> (or (= temp___is_init_244 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_247)))
...
(assert (forall ((s (_ BitVec 32))) (! (=> (dynamic_invariant4 s true true true) (dynamic_invariant5 (xdr_unsigned_to_integer s) true false true)) :pattern ((xdr_unsigned_to_integer s)))))
...
(define-fun dynamic_invariant7 ((temp___expr_166 (_ BitVec 8)) (temp___is_init_163 Bool) (temp___skip_constant_164 Bool) (temp___do_toplevel_165 Bool)) Bool true)
