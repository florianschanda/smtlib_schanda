...
(define-fun dynamic_invariant4 ((temp___expr_704 us_rep1) (temp___is_init_701 Bool) (temp___skip_constant_702 Bool) (temp___do_toplevel_703 Bool)) Bool (and (=> (not (= temp___skip_constant_702 true)) (in_range3 (+ (* 2 (to_rep1 (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor)))) 1) (to_base temp___expr_704))) (and (dynamic_property4 1 (+ (* 2 (to_rep1 (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor)))) 1) (first3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_704))) (last4 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_704)))) (and (= (first3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_704))) 1) (= (last4 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_704))) (+ (* 2 (to_rep1 (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor)))) 1))))))
...
(define-fun dynamic_invariant5 ((temp___expr_716 us_rep2) (temp___is_init_713 Bool) (temp___skip_constant_714 Bool) (temp___do_toplevel_715 Bool)) Bool (and (=> (not (= temp___skip_constant_714 true)) (in_range4 (to_rep1 (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor))) (to_base1 temp___expr_716))) (and (dynamic_property6 1 (to_rep1 (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor))) (first5 (rec__very_longs__very_long__long_digits2 (us_split_fields5 temp___expr_716))) (last6 (rec__very_longs__very_long__long_digits2 (us_split_fields5 temp___expr_716)))) (and (= (first5 (rec__very_longs__very_long__long_digits2 (us_split_fields5 temp___expr_716))) 1) (= (last6 (rec__very_longs__very_long__long_digits2 (us_split_fields5 temp___expr_716))) (to_rep1 (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor))))))))
...
(define-fun dynamic_invariant6 ((temp___expr_206 (_ BitVec 8)) (temp___is_init_203 Bool) (temp___skip_constant_204 Bool) (temp___do_toplevel_205 Bool)) Bool true)
(declare-const n Int)
...
(assert (= temp___1285 (- o5 2)))
(assert (and (<= (to_rep2 (first2 u__split_fields1)) temp___1285) (<= temp___1285 (to_rep2 (last3 u__split_fields1)))))
(assert (= o6 temp___1285))
(assert (= o7 (select u__split_fields o6)))
(assert (= o8 (to_rep o7)))
(assert (= o9 ((_ zero_extend 8) o8)))
(assert (and (= o (+ j n)) (in_range1 (+ j n))))
(assert (= temp___1283 (- o 1)))
(assert (and (<= (to_rep2 (first2 u__split_fields1)) temp___1283) (<= temp___1283 (to_rep2 (last3 u__split_fields1)))))
(assert (= o1 temp___1283))
...
(assert (= temp___1293 (- o26 3)))
(assert (and (<= (to_rep2 (first2 u__split_fields1)) temp___1293) (<= temp___1293 (to_rep2 (last3 u__split_fields1)))))
(assert (= o27 temp___1293))
...
(assert (= temp___1299 (- o39 3)))
(assert (and (<= (to_rep2 (first2 u__split_fields1)) temp___1299) (<= temp___1299 (to_rep2 (last3 u__split_fields1)))))
(assert (= o40 temp___1299))
