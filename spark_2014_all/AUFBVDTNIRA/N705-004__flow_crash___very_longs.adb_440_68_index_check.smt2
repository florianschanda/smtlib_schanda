...
(define-fun in_range3 ((rec__very_longs__very_long__octet_length1 Int) (a us_rep)) Bool (= rec__very_longs__very_long__octet_length1 (to_rep1 (rec__very_longs__very_long__octet_length (us_split_discrs1 a)))))
...
(define-fun dynamic_invariant4 ((temp___expr_768 us_rep1) (temp___is_init_764 Bool) (temp___skip_constant_765 Bool) (temp___do_toplevel_766 Bool) (temp___do_typ_inv_767 Bool)) Bool (and (=> (not (= temp___skip_constant_765 true)) (in_range3 (+ (* 2 (to_rep1 (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor)))) 1) (to_base temp___expr_768))) (and (dynamic_property4 1 (+ (* 2 (to_rep1 (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor)))) 1) (first3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_768))) (last4 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_768)))) (and (= (first3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_768))) 1) (= (last4 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_768))) (+ (* 2 (to_rep1 (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor)))) 1))))))
...
(define-fun dynamic_invariant6 ((temp___expr_230 (_ BitVec 8)) (temp___is_init_226 Bool) (temp___skip_constant_227 Bool) (temp___do_toplevel_228 Bool) (temp___do_typ_inv_229 Bool)) Bool true)
(declare-const n Int)
...
(assert (= temp___1356 (- o5 2)))
(assert (and (<= (to_rep2 (first2 u__split_fields1)) temp___1356) (<= temp___1356 (to_rep2 (last3 u__split_fields1)))))
(assert (= o6 temp___1356))
(assert (= o7 (select u__split_fields o6)))
(assert (= o8 (to_rep o7)))
(assert (= o9 ((_ zero_extend 8) o8)))
(assert (and (= o (+ j n)) (in_range1 (+ j n))))
(assert (= temp___1354 (- o 1)))
(assert (and (<= (to_rep2 (first2 u__split_fields1)) temp___1354) (<= temp___1354 (to_rep2 (last3 u__split_fields1)))))
(assert (= o1 temp___1354))
...
(assert (= temp___1364 (- o26 3)))
(assert (and (<= (to_rep2 (first2 u__split_fields1)) temp___1364) (<= temp___1364 (to_rep2 (last3 u__split_fields1)))))
(assert (= o27 temp___1364))
...
(assert (= temp___1370 (- o39 3)))
(assert (and (<= (to_rep2 (first2 u__split_fields1)) temp___1370) (<= temp___1370 (to_rep2 (last3 u__split_fields1)))))
(assert (= o40 temp___1370))
