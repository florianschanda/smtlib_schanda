...
(define-fun dynamic_invariant3 ((temp___expr_1081 (_ BitVec 8)) (temp___is_init_1078 Bool) (temp___skip_constant_1079 Bool) (temp___do_toplevel_1080 Bool)) Bool true)
...
(assert (not (in_range1 (+ byte_offset (to_rep (rec__hw__dbc__s_regs__t__byte_offset (us_split_fields1 (select regs idx))))))))
(check-sat)
(exit)
