...
(assert (not (= (ite (<= (to_rep2 (first7 temp___10751)) (to_rep2 (last8 temp___10751))) (+ (- (to_rep2 (last8 temp___10751)) (to_rep2 (first7 temp___10751))) 1) 0) (ite (<= (to_rep2 (first quotient__split_fields1)) (to_rep2 (last quotient__split_fields1))) (+ (- (to_rep2 (last quotient__split_fields1)) (to_rep2 (first quotient__split_fields1))) 1) 0))))
(check-sat)
(exit)
