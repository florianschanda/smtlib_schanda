...
(declare-fun user_eq3 (word8 word8) Bool)
(declare-const dummy3 word8)
(declare-datatypes () ((word8__ref (mk_word8__ref (word8__content word8)))))
(define-fun word8__ref___projection ((a word8__ref)) word8 (word8__content a))
(define-fun dynamic_invariant1 ((temp___expr_296 (_ BitVec 8)) (temp___is_init_293 Bool) (temp___skip_constant_294 Bool) (temp___do_toplevel_295 Bool)) Bool true)
...
(assert (forall ((x word32)) (! (uint_in_range2 (to_int5 x)) :pattern ((to_int5 x)))))
...
(declare-fun user_eq6 (index_t index_t) Bool)
(declare-const dummy6 index_t)
(declare-datatypes () ((index_t__ref (mk_index_t__ref (index_t__content index_t)))))
(define-fun index_t__ref___3__projection ((a index_t__ref)) index_t (index_t__content a))
(define-fun dynamic_invariant2 ((temp___expr_683 Int) (temp___is_init_680 Bool) (temp___skip_constant_681 Bool) (temp___do_toplevel_682 Bool)) Bool (=> (or (= temp___is_init_680 true) (<= 0 3)) (in_range4 temp___expr_683)))
...
(define-fun t__ref___2__projection ((a t__ref3)) us_rep (t__content3 a))
...
(assert true)
(assert (and (= o10 (+ (to_rep (rec__hw__dbc__op_s_regs__t__msb (us_split_fields1 (select regs idx)))) 1)) (in_range1 (+ (to_rep (rec__hw__dbc__op_s_regs__t__msb (us_split_fields1 (select regs idx)))) 1))))
(assert (= o11 (- o10 (to_rep (rec__hw__dbc__op_s_regs__t__lsb (us_split_fields1 (select regs idx)))))))
...
(assert (= o18 (ite (bvult ((_ zero_extend 56) value) o17) true false)))
(assert (and (= o7 8) (in_range1 8)))
(assert (and (= o5 (- (to_rep (rec__hw__dbc__op_s_regs__t__msb (us_split_fields1 (select regs idx)))) (to_rep (rec__hw__dbc__op_s_regs__t__lsb (us_split_fields1 (select regs idx)))))) (in_range1 (- (to_rep (rec__hw__dbc__op_s_regs__t__msb (us_split_fields1 (select regs idx)))) (to_rep (rec__hw__dbc__op_s_regs__t__lsb (us_split_fields1 (select regs idx))))))))
(assert (= o6 (+ o5 1)))
(assert (and (= o8 o6) (in_range1 o6)))
(assert (= o9 (ite (<= o8 o7) true false)))
(assert (and (= o2 (+ byte_offset (to_rep (rec__hw__dbc__op_s_regs__t__byte_offset (us_split_fields1 (select regs idx)))))) (in_range1 (+ byte_offset (to_rep (rec__hw__dbc__op_s_regs__t__byte_offset (us_split_fields1 (select regs idx))))))))
(assert (= o3 (div1 o2 4)))
(assert (= o4 (ite (<= o3 16383) true false)))
(assert (and (= o (+ byte_offset (to_rep (rec__hw__dbc__op_s_regs__t__byte_offset (us_split_fields1 (select regs idx)))))) (in_range1 (+ byte_offset (to_rep (rec__hw__dbc__op_s_regs__t__byte_offset (us_split_fields1 (select regs idx))))))))
(assert (not (not (= 4 0))))
(check-sat)
(exit)
