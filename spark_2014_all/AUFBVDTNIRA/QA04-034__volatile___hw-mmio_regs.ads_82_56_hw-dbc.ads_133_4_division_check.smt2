...
(define-fun dynamic_invariant2 ((temp___expr_776 Int) (temp___is_init_772 Bool) (temp___skip_constant_773 Bool) (temp___do_toplevel_774 Bool) (temp___do_typ_inv_775 Bool)) Bool (=> (or (= temp___is_init_772 true) (<= 0 3)) (in_range4 temp___expr_776)))
...
(assert (and (= o9 (+ (to_rep (rec__hw__dbc__op_s_regs__t__msb (us_split_fields1 (select regs idx)))) 1)) (in_range1 (+ (to_rep (rec__hw__dbc__op_s_regs__t__msb (us_split_fields1 (select regs idx)))) 1))))
(assert (= o10 (- o9 (to_rep (rec__hw__dbc__op_s_regs__t__lsb (us_split_fields1 (select regs idx)))))))
(assert (and (= o11 o10) (in_range1 o10)))
(assert (and (= o12 o11) (in_range2 o11)))
(assert (= o13 (power 2 o12)))
(assert (and (= o14 o13) (in_range3 o13)))
(assert (and (= o15 o14) (uint_in_range1 o14)))
(assert (= o16 ((_ int2bv 64) o15)))
(assert (= o17 (ite (bvult ((_ zero_extend 56) value) o16) true false)))
(assert (and (= o6 8) (in_range1 8)))
(assert (and (= o4 (- (to_rep (rec__hw__dbc__op_s_regs__t__msb (us_split_fields1 (select regs idx)))) (to_rep (rec__hw__dbc__op_s_regs__t__lsb (us_split_fields1 (select regs idx)))))) (in_range1 (- (to_rep (rec__hw__dbc__op_s_regs__t__msb (us_split_fields1 (select regs idx)))) (to_rep (rec__hw__dbc__op_s_regs__t__lsb (us_split_fields1 (select regs idx))))))))
(assert (= o5 (+ o4 1)))
(assert (and (= o7 o5) (in_range1 o5)))
(assert (= o8 (ite (<= o7 o6) true false)))
(assert (and (= o1 (+ byte_offset (to_rep (rec__hw__dbc__op_s_regs__t__byte_offset (us_split_fields1 (select regs idx)))))) (in_range1 (+ byte_offset (to_rep (rec__hw__dbc__op_s_regs__t__byte_offset (us_split_fields1 (select regs idx))))))))
(assert (= o2 (div1 o1 4)))
