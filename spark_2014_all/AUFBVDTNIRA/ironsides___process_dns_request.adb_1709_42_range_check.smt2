...
(assert (not (in_range2 (ite (< 8192 (to_rep2 (rec__dns_types__edns_record__payload_size edns_rec__split_fields11))) 8192 (to_rep2 (rec__dns_types__edns_record__payload_size edns_rec__split_fields11))))))
(check-sat)
(exit)
