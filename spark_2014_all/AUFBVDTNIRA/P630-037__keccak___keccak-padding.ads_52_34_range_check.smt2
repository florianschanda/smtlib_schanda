...
(assert (=> (<= (to_rep next_block__first) (to_rep next_block__last)) (= o2 (+ (- (to_rep next_block__last) (to_rep next_block__first)) 1))))
(assert (=> (not (<= (to_rep next_block__first) (to_rep next_block__last))) (= o2 0)))
