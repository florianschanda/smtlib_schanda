...
(define-fun dynamic_invariant2 ((temp___expr_261 us_t) (temp___is_init_258 Bool) (temp___skip_constant_259 Bool) (temp___do_toplevel_260 Bool)) Bool (=> (not (= temp___skip_constant_259 true)) (dynamic_property 0 2147483647 (first1 temp___expr_261) (last1 temp___expr_261))))
...
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (and (= (bool_eq2 (rec__keccak__keccak_1600__duplex__context__state (us_split_fields1 a)) ((_ int2bv 8) 0) ((_ int2bv 8) 4) ((_ int2bv 8) 0) ((_ int2bv 8) 4) (rec__keccak__keccak_1600__duplex__context__state (us_split_fields1 b)) ((_ int2bv 8) 0) ((_ int2bv 8) 4) ((_ int2bv 8) 0) ((_ int2bv 8) 4)) true) (= (to_rep3 (rec__keccak__keccak_1600__duplex__context__rate (us_split_fields1 a))) (to_rep3 (rec__keccak__keccak_1600__duplex__context__rate (us_split_fields1 b))))) true false))
...
(define-fun dynamic_invariant3 ((temp___expr_511 Int) (temp___is_init_508 Bool) (temp___skip_constant_509 Bool) (temp___do_toplevel_510 Bool)) Bool (=> (or (= temp___is_init_508 true) (<= 3 1599)) (in_range3 temp___expr_511)))
(assert (forall ((ctx us_rep)) (! (dynamic_invariant3 (rate_of ctx) true false true) :pattern ((rate_of ctx)))))
...
(assert (forall ((ctx us_rep)) (! (dynamic_invariant4 (max_input_length ctx) true false true) :pattern ((max_input_length ctx)))))
...
(define-fun tTblockSP1__ref___3__projection ((a tTblockSP1__ref)) tTblockSP1 (tTblockSP1__content a))
...
(declare-datatypes () ((t194s__ref (mk_t194s__ref (t194s__content integer)))))
(define-fun t194s__ref___projection ((a t194s__ref)) integer (t194s__content a))
(declare-sort t1 0)
...
(declare-datatypes () ((t195s__ref (mk_t195s__ref (t195s__content us_t1)))))
(define-fun t195s__ref___projection ((a t195s__ref)) us_t1 (t195s__content a))
(declare-const r196s Int)
...
(declare-datatypes () ((t197s__ref (mk_t197s__ref (t197s__content integer)))))
(define-fun t197s__ref___projection ((a t197s__ref)) integer (t197s__content a))
(declare-sort t2 0)
...
(declare-datatypes () ((t198s__ref (mk_t198s__ref (t198s__content us_t2)))))
(define-fun t198s__ref___projection ((a t198s__ref)) us_t2 (t198s__content a))
(declare-const r199s Int)
...
(declare-datatypes () ((t200s__ref (mk_t200s__ref (t200s__content integer)))))
(define-fun t200s__ref___projection ((a t200s__ref)) integer (t200s__content a))
(declare-sort t3 0)
...
(declare-datatypes () ((t201s__ref (mk_t201s__ref (t201s__content us_t3)))))
(define-fun t201s__ref___projection ((a t201s__ref)) us_t3 (t201s__content a))
(declare-fun keccak__keccak_1600__duplex__duplex_mute__block__aggregate_def ((_ BitVec 8)) (Array Int byte))
(assert (forall ((temp___1101 (_ BitVec 8))) (forall ((temp___1102 Int)) (= (select (keccak__keccak_1600__duplex__duplex_mute__block__aggregate_def temp___1101) temp___1102) (of_rep1 temp___1101)))))
...
(define-fun dynamic_invariant6 ((temp___expr_255 Int) (temp___is_init_252 Bool) (temp___skip_constant_253 Bool) (temp___do_toplevel_254 Bool)) Bool (=> (or (= temp___is_init_252 true) (<= 0 2147483647)) (in_range2 temp___expr_255)))
...
(declare-const temp___1103 (Array Int byte))
(declare-const temp___11031 t1)
(declare-const o4 Int)
(declare-const temp___1105 Int)
(declare-const o5 (Array Int byte))
(declare-const temp___1106 (Array Int byte))
(declare-const temp___11061 t1)
(declare-const temp___1107 (Array Int byte))
(declare-const temp___11071 t1)
(declare-const o6 (Array Int byte))
(declare-const o7 Int)
(declare-const o8 Int)
(declare-const o9 Int)
(declare-const keccak__keccak_1600__duplex__duplex_mute__R196s__assume Int)
(declare-const o10 (Array Int byte))
(declare-const keccak__padding__pad101_single_block__block__compl (Array Int byte))
(declare-const keccak__padding__pad101_single_block__block__compl1 t2)
(declare-const o11 integer)
(declare-const o12 integer)
(declare-const o13 Int)
(declare-const o14 (Array Int byte))
(declare-const o15 (Array Int byte))
(declare-const temp___1114 (Array Int byte))
(declare-const temp___11141 t3)
(declare-const o16 (Array Int byte))
(declare-const o17 t)
...
(declare-const result5 rate_number)
...
(declare-const result7 rate_number)
...
(declare-const block4 (Array Int byte))
...
(assert (and (<= in_data_bit_length (max_input_length (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1)))) (<= (div1 (+ in_data_bit_length 7) 8) (length in_data))))
(assert (= (mk_map__ref result1) (mk_map__ref block)))
(assert (= block1 (keccak__keccak_1600__duplex__duplex_mute__block__aggregate_def ((_ int2bv 8) 0))))
(assert (= (ite (<= (to_rep (first (rt in_data))) (to_rep (last (rt in_data)))) (+ (- (to_rep (last (rt in_data))) (to_rep (first (rt in_data)))) 1) 0) (ite (<= 0 (- (length in_data) 1)) (+ (- (- (length in_data) 1) 0) 1) 0)))
(assert (= (slide (elts in_data) (to_rep (first (rt in_data))) 0) temp___1103))
(assert (= (mk1 0 (- (length in_data) 1)) temp___11031))
(assert (and (= o4 (length in_data)) (in_range (length in_data))))
(assert (= temp___1105 (- o4 1)))
(assert (=> (<= 0 temp___1105) (and (and (<= 0 0) (<= 0 199)) (and (<= 0 temp___1105) (<= temp___1105 199)))))
(assert (= o5 block1))
(assert (= o5 temp___1106))
(assert (= (mk1 0 temp___1105) temp___11061))
(assert (= (ite (<= (to_rep (first2 temp___11031)) (to_rep (last2 temp___11031))) (+ (- (to_rep (last2 temp___11031)) (to_rep (first2 temp___11031))) 1) 0) (ite (<= (to_rep (first2 temp___11061)) (to_rep (last2 temp___11061))) (+ (- (to_rep (last2 temp___11061)) (to_rep (first2 temp___11061))) 1) 0)))
(assert (= (mk___t1 temp___1107 temp___11071) (mk___t1 temp___1103 temp___11031)))
(assert (forall ((temp___1108 Int)) (ite (and (<= 0 temp___1108) (<= temp___1108 (- (length in_data) 1))) (= (select o6 temp___1108) (select temp___1107 temp___1108)) (= (select o6 temp___1108) (select block1 temp___1108)))))
(assert (= block1 result2))
(assert (= block2 o6))
(assert (and (= o7 (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1)))) (and (in_range3 o7) (= o7 (to_rep3 ctx__split_fields1)))))
(assert (= o8 (+ o7 7)))
(assert (= o9 (div1 o8 8)))
(assert (= keccak__keccak_1600__duplex__duplex_mute__R196s__assume (- o9 1)))
(assert (= keccak__keccak_1600__duplex__duplex_mute__R196s__assume r196s))
(assert (in_range r196s))
(assert (=> (<= 0 r196s) (and (and (<= 0 0) (<= 0 199)) (and (<= 0 r196s) (<= r196s 199)))))
(assert (= o10 block2))
(assert (= o10 keccak__padding__pad101_single_block__block__compl))
(assert (= (mk2 0 r196s) keccak__padding__pad101_single_block__block__compl1))
(assert (and (= o13 (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1)))) (and (in_range3 o13) (= o13 (to_rep3 ctx__split_fields1)))))
(assert (= (to_rep o12) (to_rep (last4 keccak__padding__pad101_single_block__block__compl1))))
(assert (= (to_rep o11) (to_rep (first4 keccak__padding__pad101_single_block__block__compl1))))
(assert true)
(assert (forall ((temp___1112 Int)) (ite (and (<= 0 temp___1112) (<= temp___1112 r196s)) (= (select o14 temp___1112) (select (slide keccak__padding__pad101_single_block__block (to_rep (first (mk (to_rep (first4 keccak__padding__pad101_single_block__block__compl1)) (to_rep (last4 keccak__padding__pad101_single_block__block__compl1))))) 0) temp___1112)) (= (select o14 temp___1112) (select block2 temp___1112)))))
(assert (= block2 result3))
(assert (= block3 o14))
(assert (= (- (div1 (+ (to_rep3 ctx__split_fields1) 7) 8) 1) r199s))
(assert (in_range r199s))
(assert (and (= o18 (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1)))) (and (in_range3 o18) (= o18 (to_rep3 ctx__split_fields1)))))
(assert (<= 0 r199s))
(assert (not (<= 0 0)))
(check-sat)
(exit)
