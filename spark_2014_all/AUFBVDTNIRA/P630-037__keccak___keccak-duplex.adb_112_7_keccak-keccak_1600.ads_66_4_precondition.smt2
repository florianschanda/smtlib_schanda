...
(assert (forall ((temp___1170 (_ BitVec 8))) (=> (dynamic_invariant5 temp___1170 true true true true) (forall ((temp___1171 Int)) (= (to_rep1 (select (keccak__keccak_1600__duplex__duplex_mute__block__aggregate_def temp___1170) temp___1171)) temp___1170)))))
(declare-const ctx__split_fields map1)
(declare-const ctx__split_fields1 rate_number)
(declare-const block (Array Int byte))
(declare-const temp___1172 (Array Int byte))
(declare-const temp___11721 t1)
(declare-const o Int)
(declare-const temp___1174 Int)
(declare-const o1 (Array Int byte))
(declare-const temp___1175 (Array Int byte))
(declare-const temp___11751 t1)
(declare-const temp___1176 (Array Int byte))
(declare-const temp___11761 t1)
...
(assert (= block1 (keccak__keccak_1600__duplex__duplex_mute__block__aggregate_def #x00)))
...
(assert (= (slide (elts in_data) (to_rep (first (rt in_data))) 0) temp___1172))
(assert (= (mk1 0 (- (length in_data) 1)) temp___11721))
(assert (and (= o (length in_data)) (in_range (length in_data))))
(assert (= temp___1174 (- o 1)))
(assert (=> (<= 0 temp___1174) (and (and (<= 0 0) (<= 0 199)) (and (<= 0 temp___1174) (<= temp___1174 199)))))
(assert (= o1 block1))
(assert (= o1 temp___1175))
(assert (= (mk1 0 temp___1174) temp___11751))
(assert (= (ite (<= (to_rep (first2 temp___11721)) (to_rep (last2 temp___11721))) (+ (- (to_rep (last2 temp___11721)) (to_rep (first2 temp___11721))) 1) 0) (ite (<= (to_rep (first2 temp___11751)) (to_rep (last2 temp___11751))) (+ (- (to_rep (last2 temp___11751)) (to_rep (first2 temp___11751))) 1) 0)))
(assert (= (mk___t1 temp___1176 temp___11761) (mk___t1 temp___1172 temp___11721)))
(assert (forall ((temp___1177 Int)) (ite (and (<= 0 temp___1177) (<= temp___1177 (- (length in_data) 1))) (= (select o2 temp___1177) (select temp___1176 temp___1177)) (= (select o2 temp___1177) (select block1 temp___1177)))))
...
(assert (forall ((temp___1181 Int)) (ite (and (<= 0 temp___1181) (<= temp___1181 r196s)) (= (select o10 temp___1181) (select (slide keccak__padding__pad101_single_block__block (to_rep (first (mk (to_rep (first4 keccak__padding__pad101_single_block__block__compl1)) (to_rep (last4 keccak__padding__pad101_single_block__block__compl1))))) 0) temp___1181)) (= (select o10 temp___1181) (select block2 temp___1181)))))
