...
(assert (and (<= 1 byte3) (<= byte3 32)))
(assert (= o16 byte3))
(assert (= o17 (select (select (rec__rr_type__nsec_record_type__nsecrecordtype__bitmaps (us_split_fields3 nsec_record)) block2) o16)))
(assert (= o18 (to_rep1 o17)))
(assert (= (to_rep1 o19) o18))
(assert (and (= o15 byte3) (in_range4 byte3)))
(assert (= temp___5885 (+ (+ blockoffset2 2) o15)))
(assert (and (<= 1 temp___5885) (<= temp___5885 8180)))
(assert (= o20 temp___5885))
(assert (= o21 (store bytes10 o20 o19)))
(assert (= result10 (mk_map__ref1 bytes10)))
(assert (= bytes11 o21))
(assert (not (= byte3 (to_rep4 (select (rec__rr_type__nsec_record_type__nsecrecordtype__blocklengths (us_split_fields3 nsec_record)) block2)))))
(assert (= result11 (mk_int__ref byte3)))
(assert (= byte4 (+ byte3 1)))
(assert (= byte5 (mk_int__ref byte4)))
(assert (= bytes12 (mk_map__ref1 bytes11)))
(assert (= byte6 byte4))
(assert (= bytes13 bytes11))
