...
(assert (= o45 (+ x_first o44)))
(assert (and (= o46 o45) (in_range1 o45)))
(assert (= o47 (ite (<= o46 (to_rep (last (rt x)))) true false)))
(assert (and (= o41 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o42 (+ x_first o41)))
(assert (and (= o43 o42) (in_range1 o42)))
(assert (= o48 (ite (<= (to_rep (first (rt x))) o43) true false)))
(assert (= result (ite (= o48 true) o47 false)))
(assert (= result true))
...
(assert (= o37 (+ m_first o36)))
(assert (and (= o38 o37) (in_range1 o37)))
(assert (= o39 (ite (<= o38 (to_rep (last (rt m)))) true false)))
(assert (and (= o33 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o34 (+ m_first o33)))
(assert (and (= o35 o34) (in_range1 o34)))
(assert (= o40 (ite (<= (to_rep (first (rt m))) o35) true false)))
(assert (= result1 (ite (= o40 true) o39 false)))
(assert (= result1 true))
...
(assert (= o29 (+ aux1_first o28)))
(assert (and (= o30 o29) (in_range1 o29)))
(assert (= o31 (ite (<= o30 (to_rep aux1__last)) true false)))
(assert (and (= o25 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o26 (+ aux1_first o25)))
(assert (and (= o27 o26) (in_range1 o26)))
(assert (= o32 (ite (<= (to_rep aux1__first) o27) true false)))
(assert (= result2 (ite (= o32 true) o31 false)))
(assert (= result2 true))
...
(assert (= o21 (+ aux2_first o20)))
(assert (and (= o22 o21) (in_range1 o21)))
(assert (= o23 (ite (<= o22 (to_rep aux2__last)) true false)))
(assert (and (= o17 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o18 (+ aux2_first o17)))
(assert (and (= o19 o18) (in_range1 o18)))
(assert (= o24 (ite (<= (to_rep aux2__first) o19) true false)))
(assert (= result3 (ite (= o24 true) o23 false)))
(assert (= result3 true))
...
(assert (= o13 (+ aux3_first o12)))
(assert (and (= o14 o13) (in_range1 o13)))
(assert (= o15 (ite (<= o14 (to_rep aux3__last)) true false)))
(assert (and (= o9 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o10 (+ aux3_first o9)))
(assert (and (= o11 o10) (in_range1 o10)))
(assert (= o16 (ite (<= (to_rep aux3__first) o11) true false)))
