...
(assert (<= start k))
(assert (<= k (- (+ start i6) 1)))
(assert (not (= k (+ start i6))))
(assert (=> (<= (to_rep addr__first) (to_rep addr__last)) (= o39 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))
(assert (=> (not (<= (to_rep addr__first) (to_rep addr__last))) (= o39 0)))
