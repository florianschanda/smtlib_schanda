...
(assert (and (= o36 (- j3 s3)) (in_range1 (- j3 s3))))
(assert (= o37 (- o36 1)))
...
(assert (= o34 (from_word32 w2)))
(assert (= o41 (omultiply o34 o40)))
...
(assert (= result6 (ite (<= 0 n) o32 false)))
(assert (= (= o33 true) (forall ((n1 Int)) (=> (and (<= 0 n1) (<= n1 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux45) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n1 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))))
