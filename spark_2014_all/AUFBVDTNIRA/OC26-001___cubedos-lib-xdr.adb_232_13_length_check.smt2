...
(assert (not (= (ite (<= (to_rep (first temp___5961)) (to_rep (last temp___5961))) (+ (- (to_rep (last temp___5961)) (to_rep (first temp___5961))) 1) 0) (ite (<= (to_rep value__first) (to_rep value__last)) (+ (- (to_rep value__last) (to_rep value__first)) 1) 0))))
(check-sat)
(exit)
