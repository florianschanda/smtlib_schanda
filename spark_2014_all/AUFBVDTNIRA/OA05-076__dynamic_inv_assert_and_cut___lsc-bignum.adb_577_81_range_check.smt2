...
(assert (= o29 (from_integer j3)))
(assert (= o33 (ole o29 o32)))
(assert (and (= o27 (+ k 1)) (in_range1 (+ k 1))))
(assert (= o28 (ite (<= j3 o27) true false)))
(assert (= o24 (from_word32 #x00000002)))
(assert (= o25 (oexpon o24 j3)))
(assert (= o19 (from_word32 #x00000001)))
(assert (= o18 (from_integer j3)))
(assert (= o20 (osubtract o18 o19)))
(assert (= o17 (from_word64 i2)))
(assert (= o21 (osubtract o17 o20)))
