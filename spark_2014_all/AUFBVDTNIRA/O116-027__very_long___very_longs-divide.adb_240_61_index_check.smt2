...
(declare-const temp___1171 us_rep1)
(declare-const temp___1170 us_rep)
...
(assert (= j1 r139b))
(assert (=> (and (<= 1 j1) (<= j1 r139b)) (= temp___1171 (mk___rep1 u__split_discrs u__split_fields2))))
(assert (=> (and (<= 1 j1) (<= j1 r139b)) (= temp___1170 (mk___rep quotient__split_discrs quotient__split_fields2))))
(assert (=> (and (<= 1 j1) (<= j1 r139b)) (= temp___1169 current_borrow)))
(assert (=> (and (<= 1 j1) (<= j1 r139b)) (= temp___1168 q_hat)))
(assert (=> (and (<= 1 j1) (<= j1 r139b)) (and (and (dynamic_invariant1 (mk___rep quotient__split_discrs quotient__split_fields3) false true true true) (dynamic_invariant7 (mk___rep1 u__split_discrs u__split_fields3) false true true true)) (and (<= 1 j2) (<= j2 r139b)))))
(assert (=> (and (<= 1 j1) (<= j1 r139b)) (and (= o10 j2) (in_range2 j2))))
(assert (=> (and (<= 1 j1) (<= j1 r139b)) (and (= o11 j2) (in_range2 j2))))
(assert (=> (and (<= 1 j1) (<= j1 r139b)) (dynamic_invariant7 (mk___rep1 u__split_discrs u__split_fields4) true true true true)))
(assert (=> (and (<= 1 j1) (<= j1 r139b)) (and (= o12 j2) (in_range2 j2))))
(assert (=> (and (<= 1 j1) (<= j1 r139b)) (and (dynamic_invariant1 (mk___rep quotient__split_discrs quotient__split_fields4) true true true true) (dynamic_invariant7 (mk___rep1 u__split_discrs u__split_fields5) true true true true))))
(assert (=> (and (<= 1 j1) (<= j1 r139b)) (= j2 1)))
(assert (=> (and (<= 1 j1) (<= j1 r139b)) (= j3 (mk_int__ref j2))))
(assert (=> (and (<= 1 j1) (<= j1 r139b)) (= current_borrow3 (mk_t__ref1 current_borrow2))))
(assert (=> (and (<= 1 j1) (<= j1 r139b)) (= q_hat3 (mk_t__ref1 q_hat2))))
(assert (=> (and (<= 1 j1) (<= j1 r139b)) (= u__split_fields6 (mk___split_fields__ref1 u__split_fields5))))
(assert (=> (and (<= 1 j1) (<= j1 r139b)) (= quotient__split_fields5 (mk___split_fields__ref quotient__split_fields4))))
(assert (=> (and (<= 1 j1) (<= j1 r139b)) (= j4 j2)))
(assert (=> (and (<= 1 j1) (<= j1 r139b)) (= current_borrow4 current_borrow2)))
(assert (=> (and (<= 1 j1) (<= j1 r139b)) (= q_hat4 q_hat2)))
(assert (=> (and (<= 1 j1) (<= j1 r139b)) (= u__split_fields7 u__split_fields5)))
(assert (=> (and (<= 1 j1) (<= j1 r139b)) (= quotient__split_fields6 quotient__split_fields4)))
(assert (=> (and (<= 1 j1) (<= j1 r139b)) (= j5 j3)))
(assert (=> (and (<= 1 j1) (<= j1 r139b)) (= current_borrow5 current_borrow3)))
(assert (=> (and (<= 1 j1) (<= j1 r139b)) (= q_hat5 q_hat3)))
(assert (=> (and (<= 1 j1) (<= j1 r139b)) (= u__split_fields8 u__split_fields6)))
(assert (=> (and (<= 1 j1) (<= j1 r139b)) (= quotient__split_fields7 quotient__split_fields5)))
(assert (=> (and (<= 1 j1) (<= j1 r139b)) (= j6 j4)))
(assert (=> (and (<= 1 j1) (<= j1 r139b)) (= current_borrow6 current_borrow4)))
(assert (=> (and (<= 1 j1) (<= j1 r139b)) (= q_hat6 q_hat4)))
(assert (=> (and (<= 1 j1) (<= j1 r139b)) (= u__split_fields9 u__split_fields7)))
(assert (=> (and (<= 1 j1) (<= j1 r139b)) (= quotient__split_fields8 quotient__split_fields6)))
(assert (=> (not (and (<= 1 j1) (<= j1 r139b))) (= j5 (mk_int__ref j1))))
(assert (=> (not (and (<= 1 j1) (<= j1 r139b))) (= current_borrow5 (mk_t__ref1 current_borrow))))
(assert (=> (not (and (<= 1 j1) (<= j1 r139b))) (= q_hat5 (mk_t__ref1 q_hat))))
(assert (=> (not (and (<= 1 j1) (<= j1 r139b))) (= u__split_fields8 (mk___split_fields__ref1 u__split_fields2))))
(assert (=> (not (and (<= 1 j1) (<= j1 r139b))) (= quotient__split_fields7 (mk___split_fields__ref quotient__split_fields2))))
(assert (=> (not (and (<= 1 j1) (<= j1 r139b))) (= j6 j1)))
(assert (=> (not (and (<= 1 j1) (<= j1 r139b))) (= current_borrow6 current_borrow1)))
(assert (=> (not (and (<= 1 j1) (<= j1 r139b))) (= q_hat6 q_hat1)))
(assert (=> (not (and (<= 1 j1) (<= j1 r139b))) (= u__split_fields9 u__split_fields2)))
(assert (=> (not (and (<= 1 j1) (<= j1 r139b))) (= quotient__split_fields8 quotient__split_fields2)))
(assert (= n1 r141b))
...
(assert (and (and (dynamic_invariant1 (mk___rep remainder__split_discrs remainder__split_fields3) false true true true) (forall ((temp___1180 Int)) (=> (and (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits remainder__split_fields3)))) temp___1180) (<= temp___1180 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits remainder__split_fields3)))))) (=> (<= divisor_index2 temp___1180) (= (select (elts (rec__very_longs__very_long__long_digits remainder__split_fields3)) temp___1180) (select (elts (rec__very_longs__very_long__long_digits remainder__split_fields2)) temp___1180)))))) (and (<= 1 divisor_index2) (<= divisor_index2 r141b))))
(assert (not (<= (to_rep2 (first3 (rt1 (rec__very_longs__very_long__long_digits1 (us_split_fields__content1 u__split_fields8))))) divisor_index2)))
(check-sat)
(exit)
