...
(declare-const temp___1173 us_rep1)
(declare-const temp___1172 us_rep)
(declare-const temp___1171 (_ BitVec 16))
...
(assert (= j1 r139b))
(assert (=> (and (<= 1 j1) (<= j1 r139b)) (= temp___1173 (mk___rep1 u__split_discrs u__split_fields2))))
(assert (=> (and (<= 1 j1) (<= j1 r139b)) (= temp___1172 (mk___rep quotient__split_discrs quotient__split_fields2))))
(assert (=> (and (<= 1 j1) (<= j1 r139b)) (= temp___1171 current_borrow)))
(assert (=> (and (<= 1 j1) (<= j1 r139b)) (= temp___1170 q_hat)))
(assert (=> (and (<= 1 j1) (<= j1 r139b)) (and (and (dynamic_invariant1 (mk___rep quotient__split_discrs quotient__split_fields3) false true true true) (dynamic_invariant5 (mk___rep1 u__split_discrs u__split_fields3) false true true true)) (and (<= 1 j2) (<= j2 r139b)))))
(assert (=> (and (<= 1 j1) (<= j1 r139b)) (and (= o10 j2) (in_range1 j2))))
(assert (=> (and (<= 1 j1) (<= j1 r139b)) (and (= o11 j2) (in_range1 j2))))
(assert (=> (and (<= 1 j1) (<= j1 r139b)) (dynamic_invariant5 (mk___rep1 u__split_discrs u__split_fields4) true true true true)))
(assert (=> (and (<= 1 j1) (<= j1 r139b)) (and (= o12 j2) (in_range1 j2))))
(assert (=> (and (<= 1 j1) (<= j1 r139b)) (and (dynamic_invariant1 (mk___rep quotient__split_discrs quotient__split_fields4) true true true true) (dynamic_invariant5 (mk___rep1 u__split_discrs u__split_fields5) true true true true))))
