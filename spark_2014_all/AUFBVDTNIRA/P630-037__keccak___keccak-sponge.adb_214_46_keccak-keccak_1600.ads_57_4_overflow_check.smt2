...
(assert (=> (< 1 message_byte_length1) (= (mk1 (to_rep1 (first (rt message))) r105s) temp___9541)))
(assert (=> (< 1 message_byte_length1) (= temp___954 o12)))
(assert (=> (< 1 message_byte_length1) (= (mk (to_rep1 (first2 temp___9541)) (to_rep1 (last2 temp___9541))) o13)))
