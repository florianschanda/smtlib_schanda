...
(assert (and (= o12 (+ bit_length 7)) (in_range1 (+ bit_length 7))))
(assert (= o13 (div1 o12 8)))
(assert (= o14 (- o13 1)))
(assert (= o15 (+ (to_rep1 (first (rt message))) o14)))
(assert (and (= o16 o15) (in_range1 o15)))
(assert (and (= o17 o16) (in_range4 o16)))
(assert (= (mk_int__ref result6) (mk_int__ref message_last)))
(assert (= message_last2 o17))
(assert (and (<= (to_rep1 (first (rt message))) message_last2) (<= message_last2 (to_rep1 (last (rt message))))))
(assert (and (= o18 (+ (mod2 bit_length 8) suffix_len)) (in_range1 (+ (mod2 bit_length 8) suffix_len))))
(assert (= result7 (ite (<= o18 8) true false)))
(assert (= result7 true))
(assert (=> (< 1 message_byte_length1) (< (to_rep1 (first (rt message))) message_last2)))
(assert (=> (< 1 message_byte_length1) (= (- message_last2 1) r105s)))
(assert (=> (< 1 message_byte_length1) (in_range1 r105s)))
(assert (=> (< 1 message_byte_length1) (and (= o22 (- bit_length (mod2 bit_length 8))) (in_range1 (- bit_length (mod2 bit_length 8))))))
(assert (=> (< 1 message_byte_length1) (and (= o23 o22) (in_range2 o22))))
(assert (=> (< 1 message_byte_length1) (=> (<= (to_rep1 (first (rt message))) r105s) (and (and (<= (to_rep1 (first (rt message))) (to_rep1 (first (rt message)))) (<= (to_rep1 (first (rt message))) (to_rep1 (last (rt message))))) (and (<= (to_rep1 (first (rt message))) r105s) (<= r105s (to_rep1 (last (rt message)))))))))
(assert (=> (< 1 message_byte_length1) (= o19 (elts message))))
(assert (=> (< 1 message_byte_length1) (= o19 temp___885)))
(assert (=> (< 1 message_byte_length1) (= (mk1 (to_rep1 (first (rt message))) r105s) temp___8851)))
(assert (=> (< 1 message_byte_length1) (= temp___885 o20)))
(assert (=> (< 1 message_byte_length1) (= (mk (to_rep1 (first2 temp___8851)) (to_rep1 (last2 temp___8851))) o21)))
(assert (=> (< 1 message_byte_length1) (and (and (and (= (state_of (mk___rep (mk___split_fields ctx__split_fields36 ctx__split_fields37 ctx__split_fields38 ctx__split_fields39 ctx__split_fields40 ctx__split_fields41))) 0) (= (rate_of (mk___rep (mk___split_fields ctx__split_fields36 ctx__split_fields37 ctx__split_fields38 ctx__split_fields39 ctx__split_fields40 ctx__split_fields41))) (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5))))) (= (mod2 (in_queue_bit_length (mk___rep (mk___split_fields ctx__split_fields36 ctx__split_fields37 ctx__split_fields38 ctx__split_fields39 ctx__split_fields40 ctx__split_fields41))) 8) (mod2 o23 8))) (< (in_queue_bit_length (mk___rep (mk___split_fields ctx__split_fields36 ctx__split_fields37 ctx__split_fields38 ctx__split_fields39 ctx__split_fields40 ctx__split_fields41))) (rate_of (mk___rep (mk___split_fields ctx__split_fields36 ctx__split_fields37 ctx__split_fields38 ctx__split_fields39 ctx__split_fields40 ctx__split_fields41)))))))
(assert (=> (not (< 1 message_byte_length1)) (= ctx__split_fields ctx__split_fields36)))
(assert (=> (not (< 1 message_byte_length1)) (= ctx__split_fields1 ctx__split_fields37)))
(assert (=> (not (< 1 message_byte_length1)) (= ctx__split_fields2 ctx__split_fields38)))
(assert (=> (not (< 1 message_byte_length1)) (= ctx__split_fields3 ctx__split_fields39)))
(assert (=> (not (< 1 message_byte_length1)) (= ctx__split_fields4 ctx__split_fields40)))
(assert (=> (not (< 1 message_byte_length1)) (= ctx__split_fields5 ctx__split_fields41)))
(assert (=> (not (< 1 message_byte_length1)) (= (mk___split_fields ctx__split_fields36 ctx__split_fields37 ctx__split_fields38 ctx__split_fields39 ctx__split_fields40 ctx__split_fields41) (mk___split_fields ctx__split_fields6 ctx__split_fields7 ctx__split_fields8 ctx__split_fields9 ctx__split_fields10 ctx__split_fields11))))
(assert (=> (< (mod2 bit_length 8) 8) (= o29 (bvshl suffix ((_ int2bv 8) (mod2 bit_length 8))))))
(assert (=> (not (< (mod2 bit_length 8) 8)) (= o29 ((_ int2bv 8) 0))))
(assert (=> (< (mod2 bit_length 8) 256) (= o26 (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) (mod2 bit_length 8))))))
(assert (=> (not (< (mod2 bit_length 8) 256)) (= o26 ((_ int2bv 8) 0))))
(assert (= o27 (bvsub o26 ((_ int2bv 8) 1))))
(assert (and (<= (to_rep1 (first (rt message))) message_last2) (<= message_last2 (to_rep1 (last (rt message))))))
(assert (= o24 message_last2))
(assert (= o25 (select (elts message) o24)))
(assert (= o28 (to_rep o25)))
(assert (= o30 (bvand o28 o27)))
(assert (= o31 (bvor o30 o29)))
(assert (= (to_rep o32) o31))
(assert (= o33 (store suffix_array1 0 o32)))
(assert (= result8 (mk_map__ref suffix_array1)))
(assert (= suffix_array3 o33))
(assert (not (in_range1 (+ (mod2 bit_length 8) suffix_len))))
(check-sat)
(exit)
