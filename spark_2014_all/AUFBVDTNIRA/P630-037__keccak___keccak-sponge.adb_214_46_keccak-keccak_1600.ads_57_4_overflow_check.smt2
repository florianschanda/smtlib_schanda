...
(assert (and (<= (to_rep1 (first (rt message))) message_last1) (<= message_last1 (to_rep1 (last (rt message))))))
(assert (and (= o10 (+ (mod2 bit_length 8) suffix_len)) (in_range1 (+ (mod2 bit_length 8) suffix_len))))
(assert (= result4 (ite (<= o10 8) true false)))
(assert (= result4 true))
(assert (=> (< 1 message_byte_length1) (< (to_rep1 (first (rt message))) message_last1)))
...
(assert (=> (< 1 message_byte_length1) (= o11 temp___885)))
(assert (=> (< 1 message_byte_length1) (= (mk1 (to_rep1 (first (rt message))) r105s) temp___8851)))
(assert (=> (< 1 message_byte_length1) (= temp___885 o12)))
(assert (=> (< 1 message_byte_length1) (= (mk (to_rep1 (first2 temp___8851)) (to_rep1 (last2 temp___8851))) o13)))
...
(assert (=> (not (< (mod2 bit_length 8) 8)) (= o21 ((_ int2bv 8) 0))))
(assert (=> (< (mod2 bit_length 8) 256) (= o18 (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) (mod2 bit_length 8))))))
(assert (=> (not (< (mod2 bit_length 8) 256)) (= o18 ((_ int2bv 8) 0))))
(assert (= o19 (bvsub o18 ((_ int2bv 8) 1))))
(assert (and (<= (to_rep1 (first (rt message))) message_last1) (<= message_last1 (to_rep1 (last (rt message))))))
(assert (= o16 message_last1))
(assert (= o17 (select (elts message) o16)))
(assert (= o20 (to_rep o17)))
(assert (= o22 (bvand o20 o19)))
(assert (= o23 (bvor o22 o21)))
(assert (= (to_rep o24) o23))
(assert (= o25 (store suffix_array1 0 o24)))
(assert (= result5 (mk_map__ref suffix_array1)))
