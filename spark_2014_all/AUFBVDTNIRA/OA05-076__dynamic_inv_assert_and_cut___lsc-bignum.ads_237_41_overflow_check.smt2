...
(assert (= o38 (ite (<= o37 (to_rep (last (rt x)))) true false)))
(assert (and (= o32 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o33 (+ x_first o32)))
(assert (and (= o34 o33) (in_range1 o33)))
(assert (= o39 (ite (<= (to_rep (first (rt x))) o34) true false)))
...
(assert (= o30 (ite (<= o29 (to_rep (last (rt m)))) true false)))
(assert (and (= o24 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o25 (+ m_first o24)))
(assert (and (= o26 o25) (in_range1 o25)))
(assert (= o31 (ite (<= (to_rep (first (rt m))) o26) true false)))
...
(assert (= o22 (ite (<= o21 (to_rep aux1__last)) true false)))
(assert (and (= o16 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o17 (+ aux1_first o16)))
(assert (and (= o18 o17) (in_range1 o17)))
(assert (= o23 (ite (<= (to_rep aux1__first) o18) true false)))
...
(assert (= o14 (ite (<= o13 (to_rep aux2__last)) true false)))
(assert (and (= o8 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o9 (+ aux2_first o8)))
(assert (and (= o10 o9) (in_range1 o9)))
(assert (= o15 (ite (<= (to_rep aux2__first) o10) true false)))
