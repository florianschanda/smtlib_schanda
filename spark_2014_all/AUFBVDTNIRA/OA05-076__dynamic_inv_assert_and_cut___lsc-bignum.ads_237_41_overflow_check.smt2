...
(assert (= o49 (ite (<= o48 (to_rep (last (rt x)))) true false)))
(assert (and (= o43 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o44 (+ x_first o43)))
(assert (and (= o45 o44) (in_range1 o44)))
(assert (= o50 (ite (<= (to_rep (first (rt x))) o45) true false)))
(assert (= result (ite (= o50 true) o49 false)))
(assert (= result true))
...
(assert (= o41 (ite (<= o40 (to_rep (last (rt m)))) true false)))
(assert (and (= o35 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o36 (+ m_first o35)))
(assert (and (= o37 o36) (in_range1 o36)))
(assert (= o42 (ite (<= (to_rep (first (rt m))) o37) true false)))
(assert (= result1 (ite (= o42 true) o41 false)))
(assert (= result1 true))
...
(assert (= o33 (ite (<= o32 (to_rep aux1__last)) true false)))
(assert (and (= o27 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o28 (+ aux1_first o27)))
(assert (and (= o29 o28) (in_range1 o28)))
(assert (= o34 (ite (<= (to_rep aux1__first) o29) true false)))
(assert (= result2 (ite (= o34 true) o33 false)))
(assert (= result2 true))
...
(assert (= o25 (ite (<= o24 (to_rep aux2__last)) true false)))
(assert (and (= o19 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o20 (+ aux2_first o19)))
(assert (and (= o21 o20) (in_range1 o20)))
(assert (= o26 (ite (<= (to_rep aux2__first) o21) true false)))
...
(assert (= o17 (ite (<= o16 (to_rep aux3__last)) true false)))
(assert (and (= o11 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o12 (+ aux3_first o11)))
(assert (and (= o13 o12) (in_range1 o12)))
(assert (= o18 (ite (<= (to_rep aux3__first) o13) true false)))
(assert (= result4 (ite (= o18 true) o17 false)))
(assert (= result4 true))
...
(assert (= o10 (ite (<= o9 (to_rep aux4__last)) true false)))
