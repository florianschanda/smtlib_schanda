...
(assert (and (= o8 (+ (to_rep (rec__hw__dbc__cap_s_regs__t__msb (us_split_fields1 (select regs idx)))) 1)) (in_range1 (+ (to_rep (rec__hw__dbc__cap_s_regs__t__msb (us_split_fields1 (select regs idx)))) 1))))
(assert (= o9 (- o8 (to_rep (rec__hw__dbc__cap_s_regs__t__lsb (us_split_fields1 (select regs idx)))))))
...
(assert (= o16 (ite (bvult ((_ zero_extend 32) value) o15) true false)))
(assert (and (= o5 32) (in_range1 32)))
