...
(assert (= o71 (+ x_first o70)))
(assert (and (= o72 o71) (in_range1 o71)))
(assert (= o73 (ite (<= o72 (to_rep (last (rt x)))) true false)))
(assert (and (= o67 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o68 (+ x_first o67)))
(assert (and (= o69 o68) (in_range1 o68)))
(assert (= o74 (ite (<= (to_rep (first (rt x))) o69) true false)))
(assert (= result (ite (= o74 true) o73 false)))
(assert (= result true))
...
(assert (= o63 (+ m_first o62)))
(assert (and (= o64 o63) (in_range1 o63)))
(assert (= o65 (ite (<= o64 (to_rep (last (rt m)))) true false)))
(assert (and (= o59 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o60 (+ m_first o59)))
(assert (and (= o61 o60) (in_range1 o60)))
(assert (= o66 (ite (<= (to_rep (first (rt m))) o61) true false)))
(assert (= result1 (ite (= o66 true) o65 false)))
(assert (= result1 true))
...
(assert (= o55 (+ aux1_first o54)))
(assert (and (= o56 o55) (in_range1 o55)))
(assert (= o57 (ite (<= o56 (to_rep aux1__last)) true false)))
(assert (and (= o51 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o52 (+ aux1_first o51)))
(assert (and (= o53 o52) (in_range1 o52)))
(assert (= o58 (ite (<= (to_rep aux1__first) o53) true false)))
(assert (= result2 (ite (= o58 true) o57 false)))
(assert (= result2 true))
...
(assert (= o47 (+ aux2_first o46)))
(assert (and (= o48 o47) (in_range1 o47)))
(assert (= o49 (ite (<= o48 (to_rep aux2__last)) true false)))
(assert (and (= o43 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o44 (+ aux2_first o43)))
(assert (and (= o45 o44) (in_range1 o44)))
(assert (= o50 (ite (<= (to_rep aux2__first) o45) true false)))
(assert (= result3 (ite (= o50 true) o49 false)))
(assert (= result3 true))
...
(assert (= o39 (+ aux3_first o38)))
(assert (and (= o40 o39) (in_range1 o39)))
(assert (= o41 (ite (<= o40 (to_rep aux3__last)) true false)))
(assert (and (= o35 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o36 (+ aux3_first o35)))
(assert (and (= o37 o36) (in_range1 o36)))
(assert (= o42 (ite (<= (to_rep aux3__first) o37) true false)))
(assert (= result4 (ite (= o42 true) o41 false)))
(assert (= result4 true))
...
(assert (and (= o26 (power 2 k)) (in_range1 (power 2 k))))
(assert (= o27 (* o26 o25)))
(assert (and (= o28 o27) (in_range1 o27)))
(assert (= o29 (- o28 1)))
(assert (and (= o30 o29) (in_range1 o29)))
(assert (= o31 (+ aux4_first o30)))
(assert (and (= o32 o31) (in_range1 o31)))
(assert (= o33 (ite (<= o32 (to_rep aux4__last)) true false)))
