...
(assert (< (to_rep6 (first (rt message))) message_last1))
(assert (= (- message_last1 1) r105s))
(assert (in_range1 r105s))
(assert (and (= o11 (- bit_length (mod2 bit_length 8))) (in_range1 (- bit_length (mod2 bit_length 8)))))
