...
(assert (= (= o11 true) (forall ((n Int)) (=> (and (<= 0 n) (<= n (- h2 1))) (= (oeq (num_of_big_int (mk___t aux41 (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))))
(assert (and (= o7 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o8 (num_of_big_int m m_first o7)))
(assert (and (= o5 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (and (= o4 (base Tuple0)) (= o4 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o6 (oexpon o4 o5)))
(assert (= o9 (omod o6 o8)))
(assert (and (= o2 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o3 (num_of_big_int (mk___t aux3 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first o2)))
(assert (= o10 (oeq o3 o9)))
