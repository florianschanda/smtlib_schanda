...
(define-fun dynamic_invariant2 ((temp___expr_566 Int) (temp___is_init_563 Bool) (temp___skip_constant_564 Bool) (temp___do_toplevel_565 Bool)) Bool (=> (or (= temp___is_init_563 true) (<= 0 1)) (in_range3 temp___expr_566)))
...
(define-fun dynamic_invariant3 ((temp___expr_637 (_ BitVec 64)) (temp___is_init_634 Bool) (temp___skip_constant_635 Bool) (temp___do_toplevel_636 Bool)) Bool true)
