...
(define-fun dynamic_invariant2 ((temp___expr_647 Int) (temp___is_init_643 Bool) (temp___skip_constant_644 Bool) (temp___do_toplevel_645 Bool) (temp___do_typ_inv_646 Bool)) Bool (=> (or (= temp___is_init_643 true) (<= 0 1)) (in_range3 temp___expr_647)))
...
(define-fun dynamic_invariant3 ((temp___expr_724 (_ BitVec 64)) (temp___is_init_720 Bool) (temp___skip_constant_721 Bool) (temp___do_toplevel_722 Bool) (temp___do_typ_inv_723 Bool)) Bool true)
