...
(define-fun word_t__ref___4__projection ((a word_t__ref)) word_t (word_t__content a))
(define-fun dynamic_invariant1 ((temp___expr_724 (_ BitVec 64)) (temp___is_init_720 Bool) (temp___skip_constant_721 Bool) (temp___do_toplevel_722 Bool) (temp___do_typ_inv_723 Bool)) Bool true)
...
(assert (not (in_range1 (- (to_rep (rec__hw__dbc__cap_s_regs__t__msb (us_split_fields1 (select regs idx)))) (to_rep (rec__hw__dbc__cap_s_regs__t__lsb (us_split_fields1 (select regs idx))))))))
(check-sat)
(exit)
