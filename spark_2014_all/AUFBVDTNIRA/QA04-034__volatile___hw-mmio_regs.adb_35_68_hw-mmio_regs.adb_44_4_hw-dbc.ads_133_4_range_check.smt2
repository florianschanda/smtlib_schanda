...
(assert (= o1 (div1 o 4)))
(assert (and (= hw__dbc__op_regs__read_i__3__off__assume o1) (in_range2 o1)))
(assert (= hw__dbc__op_regs__read_i__3__off__assume off))
...
(assert (= result mask))
(assert (= mask1 o9))
(assert (not (bvule ((_ zero_extend 32) #x00000000) (bvand (bvlshr ((_ zero_extend 32) temp) ((_ int2bv 64) (to_rep (rec__hw__dbc__op_s_regs__t__lsb (us_split_fields1 (select regs idx)))))) mask1))))
(check-sat)
(exit)
