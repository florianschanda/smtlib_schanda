...
(declare-fun temp___1138 ((_ BitVec 8) Int Int) us_t4)
(declare-fun temp___1151 ((_ BitVec 8) Int Int) us_t6)
(declare-sort t7 0)
...
(assert (forall ((temp___1140 (_ BitVec 8))) (forall ((temp___1141 Int) (temp___1142 Int)) (let ((temp___1139 (temp___1138 temp___1140 temp___1141 temp___1142))) (=> (dynamic_invariant9 temp___1140 true true true true) (and (=> (dynamic_property16 1 65536 temp___1141 temp___1142) (and (= (first10 temp___1139) temp___1141) (= (last11 temp___1139) temp___1142))) (forall ((temp___1143 Int)) (= (to_rep1 (select (to_array4 temp___1139) temp___1143)) temp___1140))))))))
(assert (forall ((temp___1153 (_ BitVec 8))) (forall ((temp___1154 Int) (temp___1155 Int)) (let ((temp___1152 (temp___1151 temp___1153 temp___1154 temp___1155))) (=> (dynamic_invariant9 temp___1153 true true true true) (and (=> (dynamic_property16 1 65536 temp___1154 temp___1155) (and (= (first14 temp___1152) temp___1154) (= (last15 temp___1152) temp___1155))) (forall ((temp___1156 Int)) (= (to_rep1 (select (to_array6 temp___1152) temp___1156)) temp___1153))))))))
...
(assert (= (to_rep2 (first9 (rt4 (temp___1138 #x00 1 r131b)))) 1))
(assert (= (to_rep2 (last10 (rt4 (temp___1138 #x00 1 r131b)))) r131b))
(assert (= (mk___t4 temp___1145 temp___11451) (temp___1138 #x00 1 r131b)))
(assert (= (ite (<= (to_rep2 (first9 temp___11451)) (to_rep2 (last10 temp___11451))) (+ (- (to_rep2 (last10 temp___11451)) (to_rep2 (first9 temp___11451))) 1) 0) (ite (<= 1 r131b) (+ (- r131b 1) 1) 0)))
(assert (= temp___1145 temp___1146))
(assert (= (mk3 (to_rep2 (first9 temp___11451)) (to_rep2 (last10 temp___11451))) temp___11461))
(assert (= (ite (<= (to_rep2 (first7 temp___11461)) (to_rep2 (last8 temp___11461))) (+ (- (to_rep2 (last8 temp___11461)) (to_rep2 (first7 temp___11461))) 1) 0) (ite (<= (to_rep2 (first quotient__split_fields1)) (to_rep2 (last quotient__split_fields1))) (+ (- (to_rep2 (last quotient__split_fields1)) (to_rep2 (first quotient__split_fields1))) 1) 0)))
(assert (= temp___1148 (mk___t3 temp___1146 temp___11461)))
(assert (= o (mk___t (elts3 temp___1148) (mk (to_rep2 (first7 (rt3 temp___1148))) (to_rep2 (last8 (rt3 temp___1148)))))))
...
(assert (= (to_rep2 (first13 (rt6 (temp___1151 #x00 1 r135b)))) 1))
(assert (= (to_rep2 (last14 (rt6 (temp___1151 #x00 1 r135b)))) r135b))
(assert (= temp___1158 (temp___1151 #x00 1 r135b)))
(assert (= (ite (<= (to_rep2 (first13 (rt6 temp___1158))) (to_rep2 (last14 (rt6 temp___1158)))) (+ (- (to_rep2 (last14 (rt6 temp___1158))) (to_rep2 (first13 (rt6 temp___1158)))) 1) 0) (ite (<= 1 r135b) (+ (- r135b 1) 1) 0)))
(assert (= temp___1159 (mk___t5 (elts6 temp___1158) (mk5 (to_rep2 (first13 (rt6 temp___1158))) (to_rep2 (last14 (rt6 temp___1158)))))))
(assert (= (ite (<= (to_rep2 (first11 (rt5 temp___1159))) (to_rep2 (last12 (rt5 temp___1159)))) (+ (- (to_rep2 (last12 (rt5 temp___1159))) (to_rep2 (first11 (rt5 temp___1159)))) 1) 0) (ite (<= (to_rep2 (first remainder__split_fields1)) (to_rep2 (last remainder__split_fields1))) (+ (- (to_rep2 (last remainder__split_fields1)) (to_rep2 (first remainder__split_fields1))) 1) 0)))
(assert (= temp___1161 temp___1159))
(assert (= o2 (mk___t (elts5 temp___1161) (mk (to_rep2 (first11 (rt5 temp___1161))) (to_rep2 (last12 (rt5 temp___1161)))))))
...
(assert (and (= temp___1164 (number_of_digits1 divisor)) (and (in_range3 temp___1164) (and (and (<= temp___1164 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 divisor)))) (=> (< 0 temp___1164) (not (= (to_rep1 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 divisor))) temp___1164)) #x00)))) (forall ((j Int)) (=> (and (<= (+ temp___1164 1) j) (<= j (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 divisor))))))) (= (to_rep1 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 divisor))) j)) #x00)))))))
(assert (and (= us4 temp___1164) (dynamic_property2 1 last2 temp___1164)))
...
(assert (= m1 o5))
(assert (not (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits (us_split_fields1 divisor))))) n1)))
(check-sat)
(exit)
