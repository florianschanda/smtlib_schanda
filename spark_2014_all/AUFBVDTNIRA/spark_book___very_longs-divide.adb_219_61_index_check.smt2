...
(assert (forall ((number us_rep)) (! (=> (dynamic_invariant1 number true true true) (let ((result (number_of_digits1 number))) (and (and (and (<= result (to_rep (rec__very_longs__very_long__length (us_split_discrs1 number)))) (=> (< 0 result) (not (= (to_rep1 (let ((temp___273 (rec__very_longs__very_long__long_digits (us_split_fields1 number)))) (select (to_array temp___273) result))) ((_ int2bv 8) 0))))) (forall ((j Int)) (=> (and (<= (+ result 1) j) (<= j (last1 (rec__very_longs__very_long__long_digits (us_split_fields1 number))))) (= (to_rep1 (let ((temp___274 (rec__very_longs__very_long__long_digits (us_split_fields1 number)))) (select (to_array temp___274) j))) ((_ int2bv 8) 0))))) (dynamic_invariant2 result true false true)))) :pattern ((number_of_digits1 number)))))
...
(assert (forall ((temp___1071 (_ BitVec 8))) (forall ((temp___1072 Int) (temp___1073 Int)) (let ((temp___1070 (temp___1069 temp___1071 temp___1072 temp___1073))) (and (=> (dynamic_property16 1 65536 temp___1072 temp___1073) (and (= (first10 temp___1070) temp___1072) (= (last11 temp___1070) temp___1073))) (forall ((temp___1074 Int)) (= (select (to_array4 temp___1070) temp___1074) (of_rep1 temp___1071))))))))
(declare-fun temp___1082 ((_ BitVec 8) Int Int) us_t6)
(assert (forall ((temp___1084 (_ BitVec 8))) (forall ((temp___1085 Int) (temp___1086 Int)) (let ((temp___1083 (temp___1082 temp___1084 temp___1085 temp___1086))) (and (=> (dynamic_property16 1 65536 temp___1085 temp___1086) (and (= (first14 temp___1083) temp___1085) (= (last15 temp___1083) temp___1086))) (forall ((temp___1087 Int)) (= (select (to_array6 temp___1083) temp___1087) (of_rep1 temp___1084))))))))
(define-fun dynamic_invariant10 ((temp___expr_773 us_t3) (temp___is_init_770 Bool) (temp___skip_constant_771 Bool) (temp___do_toplevel_772 Bool)) Bool (=> (not (= temp___skip_constant_771 true)) (and (dynamic_property9 1 r131b (first8 temp___expr_773) (last9 temp___expr_773)) (and (= (first8 temp___expr_773) 1) (= (last9 temp___expr_773) r131b)))))
(define-fun dynamic_invariant11 ((temp___expr_782 us_t5) (temp___is_init_779 Bool) (temp___skip_constant_780 Bool) (temp___do_toplevel_781 Bool)) Bool (=> (not (= temp___skip_constant_780 true)) (and (dynamic_property13 1 r135b (first12 temp___expr_782) (last13 temp___expr_782)) (and (= (first12 temp___expr_782) 1) (= (last13 temp___expr_782) r135b)))))
...
(declare-const temp___1076 (Array Int octet))
(declare-const temp___10761 t4)
(declare-const temp___1077 (Array Int octet))
(declare-const temp___10771 t3)
(declare-const temp___1079 us_t3)
(declare-const o us_t)
(declare-const o1 us_split_fields)
(declare-const temp___1081 us_rep)
(declare-const temp___1089 us_t6)
(declare-const temp___1090 us_t5)
(declare-const temp___1092 us_t5)
...
(assert (= (to_rep2 (first9 (rt4 (temp___1069 ((_ int2bv 8) 0) 1 r131b)))) 1))
(assert (= (to_rep2 (last10 (rt4 (temp___1069 ((_ int2bv 8) 0) 1 r131b)))) r131b))
(assert (= (mk___t4 temp___1076 temp___10761) (temp___1069 ((_ int2bv 8) 0) 1 r131b)))
(assert (= (ite (<= (to_rep2 (first9 temp___10761)) (to_rep2 (last10 temp___10761))) (+ (- (to_rep2 (last10 temp___10761)) (to_rep2 (first9 temp___10761))) 1) 0) (ite (<= 1 r131b) (+ (- r131b 1) 1) 0)))
(assert (= temp___1076 temp___1077))
(assert (= (mk3 (to_rep2 (first9 temp___10761)) (to_rep2 (last10 temp___10761))) temp___10771))
(assert (= (ite (<= (to_rep2 (first7 temp___10771)) (to_rep2 (last8 temp___10771))) (+ (- (to_rep2 (last8 temp___10771)) (to_rep2 (first7 temp___10771))) 1) 0) (ite (<= (to_rep2 (first quotient__split_fields1)) (to_rep2 (last quotient__split_fields1))) (+ (- (to_rep2 (last quotient__split_fields1)) (to_rep2 (first quotient__split_fields1))) 1) 0)))
(assert (= temp___1079 (mk___t3 temp___1077 temp___10771)))
(assert (= o (mk___t (elts3 temp___1079) (mk (to_rep2 (first7 (rt3 temp___1079))) (to_rep2 (last8 (rt3 temp___1079)))))))
...
(assert (= (to_rep2 (first13 (rt6 (temp___1082 ((_ int2bv 8) 0) 1 r135b)))) 1))
(assert (= (to_rep2 (last14 (rt6 (temp___1082 ((_ int2bv 8) 0) 1 r135b)))) r135b))
(assert (= temp___1089 (temp___1082 ((_ int2bv 8) 0) 1 r135b)))
(assert (= (ite (<= (to_rep2 (first13 (rt6 temp___1089))) (to_rep2 (last14 (rt6 temp___1089)))) (+ (- (to_rep2 (last14 (rt6 temp___1089))) (to_rep2 (first13 (rt6 temp___1089)))) 1) 0) (ite (<= 1 r135b) (+ (- r135b 1) 1) 0)))
(assert (= temp___1090 (mk___t5 (elts6 temp___1089) (mk5 (to_rep2 (first13 (rt6 temp___1089))) (to_rep2 (last14 (rt6 temp___1089)))))))
(assert (= (ite (<= (to_rep2 (first11 (rt5 temp___1090))) (to_rep2 (last12 (rt5 temp___1090)))) (+ (- (to_rep2 (last12 (rt5 temp___1090))) (to_rep2 (first11 (rt5 temp___1090)))) 1) 0) (ite (<= (to_rep2 (first remainder__split_fields1)) (to_rep2 (last remainder__split_fields1))) (+ (- (to_rep2 (last remainder__split_fields1)) (to_rep2 (first remainder__split_fields1))) 1) 0)))
(assert (= temp___1092 temp___1090))
(assert (= o2 (mk___t (elts5 temp___1092) (mk (to_rep2 (first11 (rt5 temp___1092))) (to_rep2 (last12 (rt5 temp___1092)))))))
...
(assert (and (= temp___1095 (number_of_digits1 divisor)) (and (in_range3 temp___1095) (and (and (<= temp___1095 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 divisor)))) (=> (< 0 temp___1095) (not (= (to_rep1 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 divisor))) temp___1095)) ((_ int2bv 8) 0))))) (forall ((j Int)) (=> (and (<= (+ temp___1095 1) j) (<= j (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 divisor))))))) (= (to_rep1 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 divisor))) j)) ((_ int2bv 8) 0))))))))
