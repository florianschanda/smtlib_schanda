...
(declare-const temp___1103 (_ BitVec 16))
(declare-const temp___1102 us_rep)
(declare-const temp___1101 us_rep1)
...
(assert (= o3 (mk___t (elts3 temp___1079) (mk (to_rep2 (first7 (rt3 temp___1079))) (to_rep2 (last8 (rt3 temp___1079)))))))
(assert (= o4 (mk___split_fields o3)))
(assert (= temp___1081 (mk___rep quotient__split_discrs o4)))
...
(assert (= o5 (mk___t (elts5 temp___1092) (mk (to_rep2 (first11 (rt5 temp___1092))) (to_rep2 (last12 (rt5 temp___1092)))))))
(assert (= o6 (mk___split_fields o5)))
(assert (= temp___1094 (mk___rep remainder__split_discrs o6)))
