...
(define-fun dynamic_invariant1 ((temp___expr_138 Int) (temp___is_init_135 Bool) (temp___skip_constant_136 Bool) (temp___do_toplevel_137 Bool)) Bool (=> (or (= temp___is_init_135 true) (<= 1 2147483647)) (in_range3 temp___expr_138)))
...
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (us_split_discrs2 a) (mk___split_fields (let ((temp___134 (rec__very_longs__very_long__long_digits1 (us_split_fields3 a)))) (of_array (to_array1 temp___134) (first3 temp___134) (last3 temp___134))))))
(define-fun of_base ((r us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r) (mk___split_fields1 (let ((temp___133 (rec__very_longs__very_long__long_digits (us_split_fields1 r)))) (of_array1 (to_array temp___133) (first1 temp___133) (last1 temp___133))))))
...
(define-fun dynamic_invariant2 ((temp___expr_177 us_rep1) (temp___is_init_174 Bool) (temp___skip_constant_175 Bool) (temp___do_toplevel_176 Bool)) Bool (and (=> (not (= temp___skip_constant_175 true)) (in_range4 digit_length (to_base temp___expr_177))) (and (dynamic_property3 1 digit_length (first3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_177))) (last3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_177)))) (and (= (first3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_177))) 1) (= (last3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_177))) digit_length)))))
(define-fun default_initial_assumption ((temp___expr_180 us_rep1) (temp___skip_top_level_181 Bool)) Bool (= (to_rep (rec__very_longs__very_long__digit_length (us_split_discrs2 temp___expr_180))) digit_length))
...
(declare-fun temp___192 ((_ BitVec 8) Int Int) us_t2)
(assert (forall ((temp___194 (_ BitVec 8))) (forall ((temp___195 Int) (temp___196 Int)) (let ((temp___193 (temp___192 temp___194 temp___195 temp___196))) (and (=> (dynamic_property6 1 2147483647 temp___195 temp___196) (and (= (first5 temp___193) temp___195) (= (last5 temp___193) temp___196))) (forall ((temp___197 Int)) (= (select (to_array2 temp___193) temp___197) (of_rep1 temp___194))))))))
(define-fun dynamic_invariant3 ((temp___expr_144 (_ BitVec 8)) (temp___is_init_141 Bool) (temp___skip_constant_142 Bool) (temp___do_toplevel_143 Bool)) Bool true)
(define-fun dynamic_invariant4 ((temp___expr_155 us_rep) (temp___is_init_152 Bool) (temp___skip_constant_153 Bool) (temp___do_toplevel_154 Bool)) Bool (let ((temp___156 (rec__very_longs__very_long__digit_length (us_split_discrs1 temp___expr_155)))) (and (dynamic_property1 1 (to_rep temp___156) (first1 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_155))) (last1 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_155)))) (and (= (first1 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_155))) 1) (= (last1 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_155))) (to_rep temp___156))))))
...
(declare-const temp___199 (Array Int octet))
(declare-const temp___1991 t2)
(declare-const temp___200 (Array Int octet))
(declare-const temp___2001 t1)
(declare-const o (Array Int octet))
(declare-const o1 t1)
(declare-const o2 (Array Int octet))
(declare-const o3 t1)
(declare-const temp___203 digit_index_type)
(declare-const temp___2031 (Array Int octet))
(declare-const temp___2032 t1)
(declare-const temp___208 digit_index_type)
(declare-const temp___2081 (Array Int octet))
(declare-const temp___2082 t1)
...
(assert (= (to_rep2 (first4 (rt2 (temp___192 ((_ int2bv 8) 0) 1 digit_length)))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___192 ((_ int2bv 8) 0) 1 digit_length)))) digit_length))
(assert (= (mk___t2 temp___199 temp___1991) (temp___192 ((_ int2bv 8) 0) 1 digit_length)))
(assert (= (ite (<= (to_rep2 (first4 temp___1991)) (to_rep2 (last4 temp___1991))) (+ (- (to_rep2 (last4 temp___1991)) (to_rep2 (first4 temp___1991))) 1) 0) (ite (<= 1 digit_length) (+ (- digit_length 1) 1) 0)))
(assert (= temp___199 temp___200))
(assert (= (mk1 (to_rep2 (first4 temp___1991)) (to_rep2 (last4 temp___1991))) temp___2001))
(assert (= (ite (<= (to_rep2 (first2 temp___2001)) (to_rep2 (last2 temp___2001))) (+ (- (to_rep2 (last2 temp___2001)) (to_rep2 (first2 temp___2001))) 1) 0) (ite (<= (to_rep2 (first2 result____split_fields1)) (to_rep2 (last2 result____split_fields1))) (+ (- (to_rep2 (last2 result____split_fields1)) (to_rep2 (first2 result____split_fields1))) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___200 temp___2001)))
(assert (= o2 o))
(assert (= o3 o1))
(assert (= result____split_discrs (mk___split_discrs temp___203)))
...
(assert (= result____split_fields2 (mk___split_fields1 (mk___t1 temp___2031 temp___2032))))
(assert (= result____split_discrs (mk___split_discrs temp___203)))
...
(assert (<= 1 index1))
(assert (<= index1 r4b))
(assert (and (and (and (=> (<= 0 2147483647) (in_range1 temp2)) (dynamic_invariant2 (mk___rep1 result____split_discrs result____split_fields3) false true true)) (forall ((temp___210 Int)) (=> (and (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))) temp___210) (<= temp___210 (to_rep2 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))))) (=> (<= index2 temp___210) (= (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields3)) temp___210) (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields2)) temp___210)))))) (and (<= 1 index2) (<= index2 r4b))))
