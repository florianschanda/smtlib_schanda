...
(define-fun dynamic_invariant1 ((temp___expr_161 Int) (temp___is_init_157 Bool) (temp___skip_constant_158 Bool) (temp___do_toplevel_159 Bool) (temp___do_typ_inv_160 Bool)) Bool (=> (or (= temp___is_init_157 true) (<= 1 2147483647)) (in_range3 temp___expr_161)))
...
(declare-datatypes () ((t4s__ref (mk_t4s__ref (t4s__content tdigit_index_typeB)))))
(define-fun t4s__ref___projection ((a t4s__ref)) tdigit_index_typeB (t4s__content a))
(declare-sort t 0)
...
(declare-datatypes () ((us_split_discrs (mk___split_discrs (rec__very_longs__very_long__digit_length digit_index_type)))))
(define-fun us_split_discrs___projection ((a us_split_discrs)) digit_index_type (rec__very_longs__very_long__digit_length a))
...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep (rec__very_longs__very_long__digit_length (us_split_discrs1 a))) (to_rep (rec__very_longs__very_long__digit_length (us_split_discrs1 b)))) (= (bool_eq1 (rec__very_longs__very_long__long_digits (us_split_fields1 a)) (rec__very_longs__very_long__long_digits (us_split_fields1 b))) true)) true false))
...
(assert (< very_longs__very_long__digit_length__first__bit very_longs__very_long__digit_length__last__bit))
...
(declare-datatypes () ((tT1bP1__ref (mk_tT1bP1__ref (tT1bP1__content tdigit_index_typeB)))))
(define-fun tT1bP1__ref___projection ((a tT1bP1__ref)) tdigit_index_typeB (tT1bP1__content a))
(declare-sort t1 0)
...
(declare-datatypes () ((t1b__ref (mk_t1b__ref (t1b__content us_t1)))))
(define-fun t1b__ref___projection ((a t1b__ref)) us_t1 (t1b__content a))
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__very_longs__very_long__long_digits1 us_t1)))))
(define-fun us_split_fields_Long_Digits__2__projection ((a us_split_fields2)) us_t1 (rec__very_longs__very_long__long_digits1 a))
...
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (us_split_discrs2 a) (mk___split_fields (let ((temp___156 (rec__very_longs__very_long__long_digits1 (us_split_fields3 a)))) (of_array (to_array1 temp___156) (first3 temp___156) (last3 temp___156))))))
(define-fun of_base ((r us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r) (mk___split_fields1 (let ((temp___155 (rec__very_longs__very_long__long_digits (us_split_fields1 r)))) (of_array1 (to_array temp___155) (first1 temp___155) (last1 temp___155))))))
(define-fun bool_eq4 ((a us_rep1) (b us_rep1)) Bool (ite (and (= (to_rep (rec__very_longs__very_long__digit_length (us_split_discrs2 a))) (to_rep (rec__very_longs__very_long__digit_length (us_split_discrs2 b)))) (= (bool_eq3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 a)) (rec__very_longs__very_long__long_digits1 (us_split_fields3 b))) true)) true false))
(define-fun in_range4 ((rec__very_longs__very_long__digit_length1 Int) (a us_rep)) Bool (= rec__very_longs__very_long__digit_length1 (to_rep (rec__very_longs__very_long__digit_length (us_split_discrs1 a)))))
...
(assert (< very_longs__very_long__digit_length__first__bit1 very_longs__very_long__digit_length__last__bit1))
...
(define-fun dynamic_invariant2 ((temp___expr_206 us_rep1) (temp___is_init_202 Bool) (temp___skip_constant_203 Bool) (temp___do_toplevel_204 Bool) (temp___do_typ_inv_205 Bool)) Bool (and (=> (not (= temp___skip_constant_203 true)) (in_range4 digit_length (to_base temp___expr_206))) (and (dynamic_property3 1 digit_length (first3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_206))) (last3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_206)))) (and (= (first3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_206))) 1) (= (last3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_206))) digit_length)))))
(define-fun default_initial_assumption ((temp___expr_209 us_rep1) (temp___skip_top_level_210 Bool)) Bool (= (to_rep (rec__very_longs__very_long__digit_length (us_split_discrs2 temp___expr_209))) digit_length))
...
(declare-datatypes () ((t2b__ref (mk_t2b__ref (t2b__content tdigit_index_typeB)))))
(define-fun t2b__ref___projection ((a t2b__ref)) tdigit_index_typeB (t2b__content a))
(declare-sort t2 0)
...
(declare-fun temp___221 ((_ BitVec 8) Int Int) us_t2)
(define-fun dynamic_invariant3 ((temp___expr_168 (_ BitVec 8)) (temp___is_init_164 Bool) (temp___skip_constant_165 Bool) (temp___do_toplevel_166 Bool) (temp___do_typ_inv_167 Bool)) Bool true)
(declare-sort t3 0)
...
(assert (forall ((temp___223 (_ BitVec 8))) (forall ((temp___224 Int) (temp___225 Int)) (let ((temp___222 (temp___221 temp___223 temp___224 temp___225))) (=> (dynamic_invariant3 temp___223 true true true true) (and (=> (dynamic_property6 1 2147483647 temp___224 temp___225) (and (= (first5 temp___222) temp___224) (= (last5 temp___222) temp___225))) (forall ((temp___226 Int)) (= (to_rep1 (select (to_array2 temp___222) temp___226)) temp___223))))))))
(define-fun dynamic_invariant4 ((temp___expr_175 us_t3) (temp___is_init_171 Bool) (temp___skip_constant_172 Bool) (temp___do_toplevel_173 Bool) (temp___do_typ_inv_174 Bool)) Bool (=> (not (= temp___skip_constant_172 true)) (dynamic_property6 1 2147483647 (first7 temp___expr_175) (last7 temp___expr_175))))
(define-fun dynamic_invariant5 ((temp___expr_181 us_rep) (temp___is_init_177 Bool) (temp___skip_constant_178 Bool) (temp___do_toplevel_179 Bool) (temp___do_typ_inv_180 Bool)) Bool (let ((temp___182 (rec__very_longs__very_long__digit_length (us_split_discrs1 temp___expr_181)))) (and (dynamic_property1 1 (to_rep temp___182) (first1 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_181))) (last1 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_181)))) (and (= (first1 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_181))) 1) (= (last1 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_181))) (to_rep temp___182))))))
...
(declare-const temp___228 (Array Int octet))
(declare-const temp___2281 t2)
(declare-const temp___229 (Array Int octet))
(declare-const temp___2291 t1)
(declare-const o (Array Int octet))
(declare-const o1 t1)
(declare-const o2 (Array Int octet))
(declare-const o3 t1)
(declare-const temp___232 digit_index_type)
(declare-const temp___2321 (Array Int octet))
(declare-const temp___2322 t1)
...
(assert (in_range3 digit_length))
(assert (and (= us digit_length) (in_range3 digit_length)))
(assert (= (to_rep (rec__very_longs__very_long__digit_length result____split_discrs)) digit_length))
...
(assert (= (to_rep2 (first4 (rt2 (temp___221 #x00 1 digit_length)))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___221 #x00 1 digit_length)))) digit_length))
(assert (= (mk___t2 temp___228 temp___2281) (temp___221 #x00 1 digit_length)))
(assert (= (ite (<= (to_rep2 (first4 temp___2281)) (to_rep2 (last4 temp___2281))) (+ (- (to_rep2 (last4 temp___2281)) (to_rep2 (first4 temp___2281))) 1) 0) (ite (<= 1 digit_length) (+ (- digit_length 1) 1) 0)))
(assert (= temp___228 temp___229))
(assert (= (mk1 (to_rep2 (first4 temp___2281)) (to_rep2 (last4 temp___2281))) temp___2291))
(assert (= (ite (<= (to_rep2 (first2 temp___2291)) (to_rep2 (last2 temp___2291))) (+ (- (to_rep2 (last2 temp___2291)) (to_rep2 (first2 temp___2291))) 1) 0) (ite (<= (to_rep2 (first2 result____split_fields1)) (to_rep2 (last2 result____split_fields1))) (+ (- (to_rep2 (last2 result____split_fields1)) (to_rep2 (first2 result____split_fields1))) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___229 temp___2291)))
(assert (= o2 o))
(assert (= o3 o1))
(assert (= result____split_discrs (mk___split_discrs temp___232)))
(assert (= temp___2321 o2))
(assert (= temp___2322 o3))
(assert (= result (mk___split_fields__ref1 (mk___split_fields1 (mk___t1 result____split_fields result____split_fields1)))))
(assert (= result____split_fields2 (mk___split_fields1 (mk___t1 temp___2321 temp___2322))))
(assert (= result____split_discrs (mk___split_discrs temp___232)))
(assert (= result1 (mk_int__ref temp)))
(assert (= temp1 number))
(assert (= (to_rep2 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields2)))) r4b))
(assert (in_range2 r4b))
(assert (= result2 (mk_int__ref index)))
(assert (= index1 1))
(assert (<= 1 index1))
(assert (<= index1 r4b))
(assert (and (and (and (=> (<= 0 2147483647) (in_range1 temp2)) (dynamic_invariant2 (mk___rep1 result____split_discrs result____split_fields3) false true true true)) (forall ((temp___239 Int)) (=> (and (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))) temp___239) (<= temp___239 (to_rep2 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))))) (=> (<= index2 temp___239) (= (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields3)) temp___239) (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields2)) temp___239)))))) (and (<= 1 index2) (<= index2 r4b))))
(assert (not (uint_in_range (mod1 temp2 256))))
(check-sat)
(exit)
