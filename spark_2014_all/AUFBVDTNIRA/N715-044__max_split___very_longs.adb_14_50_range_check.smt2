...
(assert (forall ((x tdigit_index_typeB)) (! (in_range3 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun dynamic_invariant1 ((temp___expr_161 Int) (temp___is_init_157 Bool) (temp___skip_constant_158 Bool) (temp___do_toplevel_159 Bool) (temp___do_typ_inv_160 Bool)) Bool (=> (or (= temp___is_init_157 true) (<= 1 2147483647)) (in_range2 temp___expr_161)))
...
(declare-fun temp_____aggregate_def_221 ((_ BitVec 8) Int Int) us_t2)
...
(assert (forall ((temp___223 (_ BitVec 8))) (forall ((temp___224 Int) (temp___225 Int)) (let ((temp___222 (temp_____aggregate_def_221 temp___223 temp___224 temp___225))) (=> (dynamic_invariant3 temp___223 true true true true) (and (=> (dynamic_property6 1 2147483647 temp___224 temp___225) (and (= (first5 temp___222) temp___224) (= (last5 temp___222) temp___225))) (forall ((temp___226 Int)) (= (to_rep2 (select (to_array2 temp___222) temp___226)) temp___223))))))))
...
(assert (in_range2 digit_length))
(assert (and (= us digit_length) (in_range2 digit_length)))
...
(assert (= (to_rep1 (first4 (rt2 (temp_____aggregate_def_221 #x00 1 digit_length)))) 1))
(assert (= (to_rep1 (last4 (rt2 (temp_____aggregate_def_221 #x00 1 digit_length)))) digit_length))
(assert (= (mk___t2 temp___228 temp___2281) (temp_____aggregate_def_221 #x00 1 digit_length)))
(assert (= (ite (<= (to_rep1 (first4 temp___2281)) (to_rep1 (last4 temp___2281))) (+ (- (to_rep1 (last4 temp___2281)) (to_rep1 (first4 temp___2281))) 1) 0) (ite (<= 1 digit_length) (+ (- digit_length 1) 1) 0)))
(assert (= temp___228 temp___229))
(assert (= (mk1 (to_rep1 (first4 temp___2281)) (to_rep1 (last4 temp___2281))) temp___2291))
(assert (= (ite (<= (to_rep1 (first2 temp___2291)) (to_rep1 (last2 temp___2291))) (+ (- (to_rep1 (last2 temp___2291)) (to_rep1 (first2 temp___2291))) 1) 0) (ite (<= (to_rep1 (first2 result____split_fields1)) (to_rep1 (last2 result____split_fields1))) (+ (- (to_rep1 (last2 result____split_fields1)) (to_rep1 (first2 result____split_fields1))) 1) 0)))
...
(assert (= temp1 number))
(assert (= (to_rep1 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields2)))) r4b))
(assert (in_range3 r4b))
(assert (= result2 (mk_int__ref index)))
(assert (= index1 1))
(assert (<= 1 index1))
(assert (<= index1 r4b))
(assert (and (and (and (=> (<= 0 2147483647) (in_range1 temp2)) (dynamic_invariant2 (mk___rep1 result____split_discrs result____split_fields3) false true true true)) (forall ((temp___241 Int)) (=> (and (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))) temp___241) (<= temp___241 (to_rep1 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))))) (=> (or (< r4b temp___241) (or (< temp___241 1) (<= index2 temp___241))) (= (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields3)) temp___241) (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields2)) temp___241)))))) (and (<= 1 index2) (<= index2 r4b))))
