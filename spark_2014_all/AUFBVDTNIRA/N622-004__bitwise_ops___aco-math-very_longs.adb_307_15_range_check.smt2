...
(assert (<= (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 divisor))) (- (* 2 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 divisor)))) 1)))
(assert (not (<= 1 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 divisor))))))
(check-sat)
(exit)
