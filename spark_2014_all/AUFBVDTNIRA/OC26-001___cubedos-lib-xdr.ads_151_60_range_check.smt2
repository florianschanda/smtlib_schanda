...
(assert (= data1 o10))
(assert (=> (not (= (mod1 (length value) 4) 0)) (and (= o11 (length value)) (in_range1 (length value)))))
(assert (=> (not (= (mod1 (length value) 4) 0)) (= o12 (+ position o11))))
(assert (=> (not (= (mod1 (length value) 4) 0)) (and (= o13 o12) (in_range2 o12))))
(assert (=> (not (= (mod1 (length value) 4) 0)) (= (mk_int__ref result3) (mk_int__ref padding_start))))
(assert (=> (not (= (mod1 (length value) 4) 0)) (= padding_start2 o13)))
(assert (=> (not (= (mod1 (length value) 4) 0)) (and (= o14 (length value)) (in_range1 (length value)))))
(assert (=> (not (= (mod1 (length value) 4) 0)) (= o15 (mod1 o14 4))))
(assert (=> (not (= (mod1 (length value) 4) 0)) (= o16 (- 3 o15))))
(assert (=> (not (= (mod1 (length value) 4) 0)) (= o17 (+ padding_start2 o16))))
(assert (=> (not (= (mod1 (length value) 4) 0)) (and (= o18 o17) (in_range2 o17))))
(assert (=> (not (= (mod1 (length value) 4) 0)) (= (mk_int__ref result4) (mk_int__ref padding_stop))))
(assert (=> (not (= (mod1 (length value) 4) 0)) (= padding_stop2 o18)))
...
(assert (=> (not (= (mod1 (length value) 4) 0)) (= (to_rep (first6 (rt3 (temp___481 ((_ int2bv 8) 0) r12b r13b)))) r12b)))
(assert (=> (not (= (mod1 (length value) 4) 0)) (= (to_rep (last6 (rt3 (temp___481 ((_ int2bv 8) 0) r12b r13b)))) r13b)))
(assert (=> (not (= (mod1 (length value) 4) 0)) (= (mk___t3 temp___488 temp___4881) (temp___481 ((_ int2bv 8) 0) r12b r13b))))
(assert (=> (not (= (mod1 (length value) 4) 0)) (= (ite (<= (to_rep (first6 temp___4881)) (to_rep (last6 temp___4881))) (+ (- (to_rep (last6 temp___4881)) (to_rep (first6 temp___4881))) 1) 0) (ite (<= r12b r13b) (+ (- r13b r12b) 1) 0))))
(assert (=> (not (= (mod1 (length value) 4) 0)) (= (slide temp___488 (to_rep (first6 temp___4881)) r12b) temp___489)))
(assert (=> (not (= (mod1 (length value) 4) 0)) (= (mk2 r12b r13b) temp___4891)))
...
(assert (=> (not (= (mod1 (length value) 4) 0)) (= o19 data1)))
(assert (=> (not (= (mod1 (length value) 4) 0)) (= o19 temp___490)))
(assert (=> (not (= (mod1 (length value) 4) 0)) (= (mk2 r12b r13b) temp___4901)))
(assert (=> (not (= (mod1 (length value) 4) 0)) (= (ite (<= (to_rep (first4 temp___4891)) (to_rep (last4 temp___4891))) (+ (- (to_rep (last4 temp___4891)) (to_rep (first4 temp___4891))) 1) 0) (ite (<= (to_rep (first4 temp___4901)) (to_rep (last4 temp___4901))) (+ (- (to_rep (last4 temp___4901)) (to_rep (first4 temp___4901))) 1) 0))))
(assert (=> (not (= (mod1 (length value) 4) 0)) (= (mk___t2 temp___491 temp___4911) (mk___t2 temp___489 temp___4891))))
(assert (=> (not (= (mod1 (length value) 4) 0)) (forall ((temp___492 Int)) (ite (and (<= r12b temp___492) (<= temp___492 r13b)) (= (select o20 temp___492) (select temp___491 temp___492)) (= (select o20 temp___492) (select data1 temp___492))))))
(assert (=> (not (= (mod1 (length value) 4) 0)) (= data1 result5)))
(assert (=> (not (= (mod1 (length value) 4) 0)) (= data2 o20)))
(assert (=> (= (mod1 (length value) 4) 0) (= padding_stop2 padding_stop)))
(assert (=> (= (mod1 (length value) 4) 0) (= padding_start2 padding_start)))
(assert (=> (= (mod1 (length value) 4) 0) (= data2 data1)))
(assert (=> (= (mod1 (length value) 4) 0) (= padding_stop2 padding_stop1)))
(assert (=> (= (mod1 (length value) 4) 0) (= padding_start2 padding_start1)))
(assert (=> (= (mod1 (length value) 4) 0) (= data2 data1)))
(assert (and (= o21 (length value)) (in_range4 (length value))))
(assert (and (= o22 (length_with_padding o21)) (and (in_range4 o22) (= o22 (+ o21 (ite (= (mod1 o21 4) 0) 0 (- 4 (mod1 o21 4))))))))
(assert (= o23 (- o22 1)))
(assert (= o24 (+ position o23)))
(assert (and (= o25 o24) (in_range3 o24)))
(assert (= (mk_int__ref result6) (mk_int__ref last8)))
(assert (= last9 o25))
