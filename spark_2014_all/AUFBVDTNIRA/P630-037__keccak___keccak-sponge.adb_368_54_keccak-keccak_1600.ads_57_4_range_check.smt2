...
(assert (= (slide temp___987 (to_rep (first8 temp___9871)) r140s) temp___988))
...
(assert (forall ((temp___991 Int)) (ite (and (<= r140s temp___991) (<= temp___991 r141s)) (= (select o28 temp___991) (select temp___990 temp___991)) (= (select o28 temp___991) (select digest1 temp___991)))))
