...
(assert (< 0 (to_rep3 (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields10))))
(assert (and (= o25 (- (to_rep4 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields10)) (to_rep3 (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields10)))) (in_range2 (- (to_rep4 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields10)) (to_rep3 (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields10))))))
(assert (= result8 (mk_int__ref bytes_to_squeeze)))
(assert (= bytes_to_squeeze2 o25))
(assert (in_range2 bytes_to_squeeze2))
(assert (=> (< remaining1 bytes_to_squeeze2) (= result9 (mk_int__ref bytes_to_squeeze2))))
(assert (=> (< remaining1 bytes_to_squeeze2) (= bytes_to_squeeze3 remaining1)))
(assert (=> (not (< remaining1 bytes_to_squeeze2)) (= bytes_to_squeeze3 bytes_to_squeeze2)))
...
(assert (and (= o26 (+ offset1 bytes_to_squeeze3)) (in_range1 (+ offset1 bytes_to_squeeze3))))
(assert (= o27 (- o26 1)))
(assert (= o28 (+ (to_rep digest__first) o27)))
(assert (and (= keccak__keccak_1600__sponge__squeeze__B_2__R141s__assume o28) (in_range1 o28)))
(assert (= keccak__keccak_1600__sponge__squeeze__B_2__R141s__assume r141s))
(assert (in_range1 r141s))
(assert (= (to_rep3 (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields10)) r144s))
(assert (in_range6 r144s))
(assert (and (= keccak__keccak_1600__sponge__squeeze__B_2__R145s__assume (+ (to_rep3 (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields10)) (- bytes_to_squeeze3 1))) (in_range1 (+ (to_rep3 (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields10)) (- bytes_to_squeeze3 1)))))
...
(assert (= o29 (rec__keccak__keccak_1600__sponge__context__block ctx__split_fields10)))
(assert (= o29 temp___918))
(assert (= (mk4 r144s r145s) temp___9181))
(assert (= (ite (<= (to_rep (first8 temp___9181)) (to_rep (last8 temp___9181))) (+ (- (to_rep (last8 temp___9181)) (to_rep (first8 temp___9181))) 1) 0) (ite (<= r140s r141s) (+ (- r141s r140s) 1) 0)))
(assert (= (slide temp___918 (to_rep (first8 temp___9181)) r140s) temp___919))
...
(assert (= (ite (<= (to_rep (first6 temp___9191)) (to_rep (last6 temp___9191))) (+ (- (to_rep (last6 temp___9191)) (to_rep (first6 temp___9191))) 1) 0) (ite (<= (to_rep (first6 temp___9201)) (to_rep (last6 temp___9201))) (+ (- (to_rep (last6 temp___9201)) (to_rep (first6 temp___9201))) 1) 0)))
(assert (= (mk___t3 temp___921 temp___9211) (mk___t3 temp___919 temp___9191)))
(assert (forall ((temp___922 Int)) (ite (and (<= r140s temp___922) (<= temp___922 r141s)) (= (select o31 temp___922) (select temp___921 temp___922)) (= (select o31 temp___922) (select digest1 temp___922)))))
(assert (= result10 (mk_map__ref digest1)))
(assert (= digest2 o31))
(assert (and (= o32 (+ (to_rep3 (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields10)) bytes_to_squeeze3)) (in_range1 (+ (to_rep3 (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields10)) bytes_to_squeeze3))))
(assert (not (in_range6 o32)))
(check-sat)
(exit)
