...
(assert (=> (= (select issystem retval1) true) (= retval1 c146b)))
(assert (=> (= (select issystem retval1) true) (in_range18 c146b)))
...
(assert (=> (= (select issystem retval1) true) (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE18 c146b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE18 c146b)))))) (= o4 (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE18 c146b))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE18 c146b)))))) 1)))))
(assert (=> (= (select issystem retval1) true) (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE18 c146b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE18 c146b))))))) (= o4 0))))
(assert (=> (= (select issystem retval1) true) (=> (<= 1 33) (= o5 (+ (- 33 1) 1)))))
(assert (=> (= (select issystem retval1) true) (=> (not (<= 1 33)) (= o5 0))))
(assert (=> (= (select issystem retval1) true) (= o6 (+ o5 o4))))
(assert (=> (= (select issystem retval1) true) (= o7 (+ 1 o6))))
(assert (=> (= (select issystem retval1) true) (= o8 (- o7 1))))
(assert (=> (= (select issystem retval1) true) (and (= o9 o8) (in_range2 o8))))
(assert (=> (= (select issystem retval1) true) (= keystore__addkey__B150b__thestring__assume (mk___t (concat1 (temp___String_Literal_1672 Tuple0) 1 33 (elts (to_string (attr__ATTRIBUTE_IMAGE18 c146b))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE18 c146b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE18 c146b)))))) (mk 1 o9)))))
(assert (=> (= (select issystem retval1) true) (= keystore__addkey__B150b__thestring__assume thestring)))
(assert (=> (= (select issystem retval1) true) (dynamic_invariant thestring true false true)))
(assert (=> (= (select issystem retval1) true) (and (= o10 (length thestring)) (in_range1 (length thestring)))))
(assert (=> (= (select issystem retval1) true) (= result4 (ite (<= o10 150) true false))))
...
(assert (=> (= (select issystem retval1) true) (=> (= result4 true) (= temp___1666 (mk___t1 (slide (elts thestring) (to_rep1 (first (rt thestring))) 1) (mk1 1 (length thestring)))))))
(assert (=> (= (select issystem retval1) true) (=> (= result4 true) (and (= temp___1668 (length thestring)) (in_range1 (length thestring))))))
(assert (=> (= (select issystem retval1) true) (=> (= result4 true) (=> (<= 1 temp___1668) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 temp___1668) (<= temp___1668 150)))))))
(assert (=> (= (select issystem retval1) true) (=> (= result4 true) (= o11 result__2))))
(assert (=> (= (select issystem retval1) true) (=> (= result4 true) (= temp___1669 (mk___t1 o11 (mk1 1 temp___1668))))))
(assert (=> (= (select issystem retval1) true) (=> (= result4 true) (= (ite (<= (to_rep1 (first2 (rt1 temp___1666))) (to_rep1 (last2 (rt1 temp___1666)))) (+ (- (to_rep1 (last2 (rt1 temp___1666))) (to_rep1 (first2 (rt1 temp___1666)))) 1) 0) (ite (<= (to_rep1 (first2 (rt1 temp___1669))) (to_rep1 (last2 (rt1 temp___1669)))) (+ (- (to_rep1 (last2 (rt1 temp___1669))) (to_rep1 (first2 (rt1 temp___1669)))) 1) 0)))))
(assert (=> (= (select issystem retval1) true) (=> (= result4 true) (= temp___1670 temp___1666))))
(assert (=> (= (select issystem retval1) true) (=> (= result4 true) (forall ((temp___1671 Int)) (ite (and (<= 1 temp___1671) (<= temp___1671 (length thestring))) (= (select o12 temp___1671) (select (elts1 temp___1670) temp___1671)) (= (select o12 temp___1671) (select result__2 temp___1671)))))))
(assert (=> (= (select issystem retval1) true) (=> (= result4 true) (= result5 (mk_map__ref result__2)))))
(assert (=> (= (select issystem retval1) true) (=> (= result4 true) (= result__3 o12))))
...
(assert (=> (= (select issystem retval1) true) (=> (not (= result4 true)) (= temp___1665 thestring))))
(assert (=> (= (select issystem retval1) true) (=> (not (= result4 true)) (= o13 (elts temp___1665)))))
(assert (=> (= (select issystem retval1) true) (=> (not (= result4 true)) (= result6 (mk_map__ref result__2)))))
(assert (=> (= (select issystem retval1) true) (=> (not (= result4 true)) (= result__4 o13))))
(assert (=> (= (select issystem retval1) true) (=> (not (= result4 true)) (= result__3 result__4))))
(assert (=> (= (select issystem retval1) true) (= result7 (mk_map__ref c148b))))
(assert (=> (= (select issystem retval1) true) (= c148b2 result__3)))
(assert (=> (= (select issystem retval1) true) (and (= (valid_numberlogentries (to_rep8 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8)) (to_rep9 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8)) true) (in_range4 auditalarm2))))
(assert (=> (not (= (select issystem retval1) true)) (= (let ((subject filestate)) (mk___private__ref filestate2)) filestate)))
(assert (=> (not (= (select issystem retval1) true)) (= state2 state)))
(assert (=> (not (= (select issystem retval1) true)) (= result__3 result__)))
(assert (=> (not (= (select issystem retval1) true)) (= c148b2 c148b)))
...
(assert (=> (not (= (select issystem retval1) true)) (= c148b2 c148b1)))
...
(assert (= store3 (let ((subject store1)) (mk___private__ref store2))))
...
(assert (= c148b3 (mk_map__ref c148b2)))
