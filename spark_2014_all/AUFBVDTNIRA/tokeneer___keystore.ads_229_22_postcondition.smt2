...
(assert (=> (= (select issystem retval1) true) (= temp___1690 (mk___t1 (temp___String_Literal_1689 Tuple0) (mk1 1 6)))))
(assert (=> (= (select issystem retval1) true) (dynamic_predicate temp___1690)))
(assert (=> (= (select issystem retval1) true) (= o4 temp___1690)))
