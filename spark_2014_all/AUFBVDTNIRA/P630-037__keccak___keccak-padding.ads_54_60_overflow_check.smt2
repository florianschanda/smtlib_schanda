...
(assert (=> (<= (to_rep first_block__first) (to_rep first_block__last)) (= o2 (+ (- (to_rep first_block__last) (to_rep first_block__first)) 1))))
(assert (=> (not (<= (to_rep first_block__first) (to_rep first_block__last))) (= o2 0)))
(assert (=> (<= (to_rep next_block__first) (to_rep next_block__last)) (= o3 (+ (- (to_rep next_block__last) (to_rep next_block__first)) 1))))
(assert (=> (not (<= (to_rep next_block__first) (to_rep next_block__last))) (= o3 0)))
