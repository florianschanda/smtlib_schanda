...
(assert (= (= o538 true) (forall ((n7 Int)) (=> (and (<= 0 n7) (<= n7 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux47) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n7 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n7) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))))
(assert (and (= o507 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o508 (num_of_big_int m m_first o507)))
(assert (and (= o504 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (and (= o503 (base Tuple0)) (= o503 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
...
(assert (= o485 (num_of_big_int (mk___t aux32 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first o484)))
(assert (= o510 (oeq o485 o509)))
(assert (and (= o480 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o481 (num_of_big_int m m_first o480)))
(assert (and (= o477 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (and (= o476 (base Tuple0)) (= o476 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o478 (oexpon o476 o477)))
(assert (and (= o473 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o474 (num_of_big_int x x_first o473)))
