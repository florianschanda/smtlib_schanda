...
(assert (=> (<= 8 remaining_bytes1) (and (= temp___817 o4) (in_range1 o4))))
(assert (=> (<= 8 remaining_bytes1) (and (<= (to_rep data__first) temp___817) (<= temp___817 (to_rep data__last)))))
(assert (=> (<= 8 remaining_bytes1) (= o13 temp___817)))
...
(assert (=> (<= 8 remaining_bytes1) (and (= temp___8171 o16) (in_range1 o16))))
(assert (=> (<= 8 remaining_bytes1) (and (<= (to_rep data__first) temp___8171) (<= temp___8171 (to_rep data__last)))))
(assert (=> (<= 8 remaining_bytes1) (= o25 temp___8171)))
...
(assert (=> (<= 8 remaining_bytes1) (and (= temp___8172 o28) (in_range1 o28))))
(assert (=> (<= 8 remaining_bytes1) (and (<= (to_rep data__first) temp___8172) (<= temp___8172 (to_rep data__last)))))
(assert (=> (<= 8 remaining_bytes1) (= o37 temp___8172)))
...
(assert (=> (<= 8 remaining_bytes1) (and (= temp___8173 o40) (in_range1 o40))))
(assert (=> (<= 8 remaining_bytes1) (and (<= (to_rep data__first) temp___8173) (<= temp___8173 (to_rep data__last)))))
(assert (=> (<= 8 remaining_bytes1) (= o49 temp___8173)))
...
(assert (=> (<= 8 remaining_bytes1) (and (= temp___8174 o52) (in_range1 o52))))
(assert (=> (<= 8 remaining_bytes1) (and (<= (to_rep data__first) temp___8174) (<= temp___8174 (to_rep data__last)))))
(assert (=> (<= 8 remaining_bytes1) (= o61 temp___8174)))
...
(assert (=> (<= 8 remaining_bytes1) (and (= temp___8175 o64) (in_range1 o64))))
(assert (=> (<= 8 remaining_bytes1) (and (<= (to_rep data__first) temp___8175) (<= temp___8175 (to_rep data__last)))))
(assert (=> (<= 8 remaining_bytes1) (= o73 temp___8175)))
...
(assert (=> (<= 8 remaining_bytes1) (and (= temp___8176 o76) (in_range1 o76))))
(assert (=> (<= 8 remaining_bytes1) (and (<= (to_rep data__first) temp___8176) (<= temp___8176 (to_rep data__last)))))
(assert (=> (<= 8 remaining_bytes1) (= o85 temp___8176)))
...
(assert (=> (<= 8 remaining_bytes1) (and (= temp___8177 o88) (in_range1 o88))))
(assert (=> (<= 8 remaining_bytes1) (and (<= (to_rep data__first) temp___8177) (<= temp___8177 (to_rep data__last)))))
(assert (=> (<= 8 remaining_bytes1) (= o97 temp___8177)))
...
(assert (= result31 (mk_int__ref temp___844)))
(assert (= temp___8441 offset8))
(assert (= result32 (mk_int__ref temp___843)))
(assert (= temp___8431 shift2))
(assert (= result33 (mk_int__ref temp___842)))
(assert (= temp___8421 remaining_bytes8))
(assert (= (to_rep1 o103) ((_ extract 7 0) (bvand (bvlshr lane8 ((_ int2bv 64) shift2)) #x00000000000000FF))))
(assert (and (= temp___835 (+ (to_rep data__first) offset8)) (in_range1 (+ (to_rep data__first) offset8))))
(assert (and (<= (to_rep data__first) temp___835) (<= temp___835 (to_rep data__last))))
(assert (= o104 temp___835))
...
(assert (not (or (< temp___8441 offset9) (and (= offset9 temp___8441) (or (< temp___8431 shift3) (and (= shift3 temp___8431) (< remaining_bytes9 temp___8421)))))))
(check-sat)
(exit)
