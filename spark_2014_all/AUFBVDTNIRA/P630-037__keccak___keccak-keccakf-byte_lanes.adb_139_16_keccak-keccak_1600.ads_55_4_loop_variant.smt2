...
(declare-const temp___759 (_ BitVec 8))
(declare-const temp___757 (Array Int byte))
...
(assert (in_range5 y1))
(assert (=> (<= (to_rep data__first) (to_rep data__last)) (= o2 (+ (- (to_rep data__last) (to_rep data__first)) 1))))
(assert (=> (not (<= (to_rep data__first) (to_rep data__last))) (= o2 0)))
(assert (and (= o3 o2) (in_range2 o2)))
(assert (= result2 remaining_bytes))
(assert (= remaining_bytes1 o3))
(assert (in_range2 remaining_bytes1))
(assert (= result3 offset))
(assert (= offset1 0))
(assert (in_range2 offset1))
(assert true)
(assert (= (to_rep (first2 (rt1 (temp___738 ((_ int2bv 8) 0) (to_rep data__first) (to_rep data__last))))) (to_rep data__first)))
(assert (= (to_rep (last2 (rt1 (temp___738 ((_ int2bv 8) 0) (to_rep data__first) (to_rep data__last))))) (to_rep data__last)))
(assert (= (mk___t1 temp___745 temp___7451) (temp___738 ((_ int2bv 8) 0) (to_rep data__first) (to_rep data__last))))
(assert (= temp___745 temp___746))
(assert (= (mk (to_rep (first2 temp___7451)) (to_rep (last2 temp___7451))) temp___7461))
(assert (= (ite (<= (to_rep (first temp___7461)) (to_rep (last temp___7461))) (+ (- (to_rep (last temp___7461)) (to_rep (first temp___7461))) 1) 0) (ite (<= (to_rep data__first) (to_rep data__last)) (+ (- (to_rep data__last) (to_rep data__first)) 1) 0)))
(assert (= (mk___t temp___747 temp___7471) (mk___t temp___746 temp___7461)))
(assert (= o4 (slide temp___747 (to_rep (first temp___7471)) (to_rep data__first))))
(assert (= result4 data))
(assert (= data1 o4))
(assert (=> (<= 8 remaining_bytes1) (and (and (= temp___763 lane) (and (= temp___762 offset1) (and (= temp___761 remaining_bytes1) (and (= temp___760 y1) (and (= temp___759 x1) (and (= temp___757 data1) (and (= 0 temp___765) (and (= 0 temp___764) (and (and (= (mod2 offset2 8) 0) (= (+ offset2 remaining_bytes2) (ite (<= (to_rep data__first) (to_rep data__last)) (+ (- (to_rep data__last) (to_rep data__first)) 1) 0))) (and (and (and (and (and (=> (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 4)) (in_range4 x2)) (=> (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 4)) (in_range5 y2))) (=> (<= 0 2147483647) (in_range2 remaining_bytes2))) (=> (<= 0 2147483647) (in_range2 offset2))) (<= 8 remaining_bytes2)) (and (and (= temp___7651 result5) (= temp___7652 offset2)) (and (and (= temp___7641 result6) (= temp___7642 remaining_bytes2)) (and (and (= result7 (mk_t__ref1 lane2)) (= lane3 (to_rep2 (get a x2 y2)))) (and (and (and (= result8 (mk_int__ref i2)) (= i3 0)) (and (and (and (and (and (and (and (and (and (and (and (= o11 (* i3 8)) (in_range1 (* i3 8))) (and (= o12 o11) (in_range2 o11))) (= o13 ((_ int2bv 64) o12))) (= o14 (bvlshr lane3 o13))) (= o15 (bvand o14 ((_ int2bv 64) 255)))) (= o16 o15)) (= o17 ((_ extract 7 0) o16))) (= (to_rep1 o18) o17)) (and (and (and (and (and (= o9 (+ (to_rep data__first) offset2)) (in_range1 (+ (to_rep data__first) offset2))) (= o10 (+ o9 i3))) (and (= temp___748 o10) (in_range1 o10))) (and (and (<= (to_rep data__first) temp___748) (<= temp___748 (to_rep data__last))) (= o19 temp___748))) (= o20 (store data2 o19 o18)))) (and (= result9 (mk_map__ref data2)) (= data3 o20))) (and (and (= result10 (mk_int__ref i3)) (= i4 1)) (and (and (and (and (and (and (and (and (and (and (and (= o23 (* i4 8)) (in_range1 (* i4 8))) (and (= o24 o23) (in_range2 o23))) (= o25 ((_ int2bv 64) o24))) (= o26 (bvlshr lane3 o25))) (= o27 (bvand o26 ((_ int2bv 64) 255)))) (= o28 o27)) (= o29 ((_ extract 7 0) o28))) (= (to_rep1 o30) o29)) (and (and (and (and (and (= o21 (+ (to_rep data__first) offset2)) (in_range1 (+ (to_rep data__first) offset2))) (= o22 (+ o21 i4))) (and (= temp___7481 o22) (in_range1 o22))) (and (and (<= (to_rep data__first) temp___7481) (<= temp___7481 (to_rep data__last))) (= o31 temp___7481))) (= o32 (store data3 o31 o30)))) (and (= result11 (mk_map__ref data3)) (= data4 o32))) (and (and (= result12 (mk_int__ref i4)) (= i5 2)) (and (and (and (and (and (and (and (and (and (and (and (= o35 (* i5 8)) (in_range1 (* i5 8))) (and (= o36 o35) (in_range2 o35))) (= o37 ((_ int2bv 64) o36))) (= o38 (bvlshr lane3 o37))) (= o39 (bvand o38 ((_ int2bv 64) 255)))) (= o40 o39)) (= o41 ((_ extract 7 0) o40))) (= (to_rep1 o42) o41)) (and (and (and (and (and (= o33 (+ (to_rep data__first) offset2)) (in_range1 (+ (to_rep data__first) offset2))) (= o34 (+ o33 i5))) (and (= temp___7482 o34) (in_range1 o34))) (and (and (<= (to_rep data__first) temp___7482) (<= temp___7482 (to_rep data__last))) (= o43 temp___7482))) (= o44 (store data4 o43 o42)))) (and (= result13 (mk_map__ref data4)) (= data5 o44))) (and (and (= result14 (mk_int__ref i5)) (= i6 3)) (and (and (and (and (and (and (and (and (and (and (and (= o47 (* i6 8)) (in_range1 (* i6 8))) (and (= o48 o47) (in_range2 o47))) (= o49 ((_ int2bv 64) o48))) (= o50 (bvlshr lane3 o49))) (= o51 (bvand o50 ((_ int2bv 64) 255)))) (= o52 o51)) (= o53 ((_ extract 7 0) o52))) (= (to_rep1 o54) o53)) (and (and (and (and (and (= o45 (+ (to_rep data__first) offset2)) (in_range1 (+ (to_rep data__first) offset2))) (= o46 (+ o45 i6))) (and (= temp___7483 o46) (in_range1 o46))) (and (and (<= (to_rep data__first) temp___7483) (<= temp___7483 (to_rep data__last))) (= o55 temp___7483))) (= o56 (store data5 o55 o54)))) (and (= result15 (mk_map__ref data5)) (= data6 o56))) (and (and (= result16 (mk_int__ref i6)) (= i7 4)) (and (and (and (and (and (and (and (and (and (and (and (= o59 (* i7 8)) (in_range1 (* i7 8))) (and (= o60 o59) (in_range2 o59))) (= o61 ((_ int2bv 64) o60))) (= o62 (bvlshr lane3 o61))) (= o63 (bvand o62 ((_ int2bv 64) 255)))) (= o64 o63)) (= o65 ((_ extract 7 0) o64))) (= (to_rep1 o66) o65)) (and (and (and (and (and (= o57 (+ (to_rep data__first) offset2)) (in_range1 (+ (to_rep data__first) offset2))) (= o58 (+ o57 i7))) (and (= temp___7484 o58) (in_range1 o58))) (and (and (<= (to_rep data__first) temp___7484) (<= temp___7484 (to_rep data__last))) (= o67 temp___7484))) (= o68 (store data6 o67 o66)))) (and (= result17 (mk_map__ref data6)) (= data7 o68))) (and (and (= result18 (mk_int__ref i7)) (= i8 5)) (and (and (and (and (and (and (and (and (and (and (and (= o71 (* i8 8)) (in_range1 (* i8 8))) (and (= o72 o71) (in_range2 o71))) (= o73 ((_ int2bv 64) o72))) (= o74 (bvlshr lane3 o73))) (= o75 (bvand o74 ((_ int2bv 64) 255)))) (= o76 o75)) (= o77 ((_ extract 7 0) o76))) (= (to_rep1 o78) o77)) (and (and (and (and (and (= o69 (+ (to_rep data__first) offset2)) (in_range1 (+ (to_rep data__first) offset2))) (= o70 (+ o69 i8))) (and (= temp___7485 o70) (in_range1 o70))) (and (and (<= (to_rep data__first) temp___7485) (<= temp___7485 (to_rep data__last))) (= o79 temp___7485))) (= o80 (store data7 o79 o78)))) (and (= result19 (mk_map__ref data7)) (= data8 o80))) (and (and (= result20 (mk_int__ref i8)) (= i9 6)) (and (and (and (and (and (and (and (and (and (and (and (= o83 (* i9 8)) (in_range1 (* i9 8))) (and (= o84 o83) (in_range2 o83))) (= o85 ((_ int2bv 64) o84))) (= o86 (bvlshr lane3 o85))) (= o87 (bvand o86 ((_ int2bv 64) 255)))) (= o88 o87)) (= o89 ((_ extract 7 0) o88))) (= (to_rep1 o90) o89)) (and (and (and (and (and (= o81 (+ (to_rep data__first) offset2)) (in_range1 (+ (to_rep data__first) offset2))) (= o82 (+ o81 i9))) (and (= temp___7486 o82) (in_range1 o82))) (and (and (<= (to_rep data__first) temp___7486) (<= temp___7486 (to_rep data__last))) (= o91 temp___7486))) (= o92 (store data8 o91 o90)))) (and (= result21 (mk_map__ref data8)) (= data9 o92))) (and (and (= result22 (mk_int__ref i9)) (= i10 7)) (and (and (and (and (and (and (and (and (and (and (= o95 (* i10 8)) (in_range1 (* i10 8))) (and (= o96 o95) (in_range2 o95))) (= o97 ((_ int2bv 64) o96))) (= o98 (bvlshr lane3 o97))) (= o99 (bvand o98 ((_ int2bv 64) 255)))) (= o100 o99)) (= o101 ((_ extract 7 0) o100))) (= (to_rep1 o102) o101)) (and (and (and (and (and (= o93 (+ (to_rep data__first) offset2)) (in_range1 (+ (to_rep data__first) offset2))) (= o94 (+ o93 i10))) (and (= temp___7487 o94) (in_range1 o94))) (and (and (<= (to_rep data__first) temp___7487) (<= temp___7487 (to_rep data__last))) (= o103 temp___7487))) (= o104 (store data9 o103 o102)))) (and (= result23 (mk_map__ref data9)) (= data10 o104)))))))))))))))))) (and (and (ite (bvule (bvsub ((_ int2bv 8) 5) x2) ((_ int2bv 8) 1)) (= o105 (bvsub (bvadd x2 ((_ int2bv 8) 1)) ((_ int2bv 8) 5))) (= o105 (bvadd x2 ((_ int2bv 8) 1)))) (and (= result24 (mk_t__ref x2)) (= x3 o105))) (and (ite (= x3 ((_ int2bv 8) 0)) (and (ite (bvule (bvsub ((_ int2bv 8) 5) y2) ((_ int2bv 8) 1)) (= o106 (bvsub (bvadd y2 ((_ int2bv 8) 1)) ((_ int2bv 8) 5))) (= o106 (bvadd y2 ((_ int2bv 8) 1)))) (and (= result25 (mk_t__ref y2)) (= y3 o106))) (= y3 y2)) (and (and (and (= o107 (- remaining_bytes2 8)) (in_range2 (- remaining_bytes2 8))) (and (= result26 (mk_int__ref remaining_bytes2)) (= remaining_bytes3 o107))) (and (and (and (= o108 (+ offset2 8)) (in_range1 (+ offset2 8))) (and (= result27 (mk_int__ref offset2)) (= offset3 o108))) (not (<= 8 remaining_bytes3)))))))))))))))))))) (and (and (= i13 (mk_int__ref i10)) (and (= lane6 (mk_t__ref1 lane3)) (and (= offset6 (mk_int__ref offset3)) (and (= remaining_bytes6 (mk_int__ref remaining_bytes3)) (and (= y6 (mk_t__ref y3)) (and (= x6 (mk_t__ref x3)) (= data13 (mk_map__ref data10)))))))) (and (= i14 i10) (and (= lane7 lane3) (and (= offset7 offset3) (and (= remaining_bytes7 remaining_bytes3) (and (= y7 y3) (and (= x7 x3) (= data14 data10)))))))))))
(assert (=> (<= 8 remaining_bytes1) (= i15 i13)))
(assert (=> (<= 8 remaining_bytes1) (= lane8 lane6)))
(assert (=> (<= 8 remaining_bytes1) (= offset8 offset6)))
(assert (=> (<= 8 remaining_bytes1) (= remaining_bytes8 remaining_bytes6)))
(assert (=> (<= 8 remaining_bytes1) (= y8 y6)))
(assert (=> (<= 8 remaining_bytes1) (= x8 x6)))
(assert (=> (<= 8 remaining_bytes1) (= data15 data13)))
(assert (=> (<= 8 remaining_bytes1) (= i16 i14)))
(assert (=> (<= 8 remaining_bytes1) (= lane9 lane7)))
(assert (=> (<= 8 remaining_bytes1) (= offset9 offset7)))
(assert (=> (<= 8 remaining_bytes1) (= remaining_bytes9 remaining_bytes7)))
(assert (=> (<= 8 remaining_bytes1) (= y9 y7)))
(assert (=> (<= 8 remaining_bytes1) (= x9 x7)))
(assert (=> (<= 8 remaining_bytes1) (= data16 data14)))
(assert (=> (not (<= 8 remaining_bytes1)) (= i15 (mk_int__ref i))))
(assert (=> (not (<= 8 remaining_bytes1)) (= lane8 (mk_t__ref1 lane))))
(assert (=> (not (<= 8 remaining_bytes1)) (= offset8 (mk_int__ref offset1))))
(assert (=> (not (<= 8 remaining_bytes1)) (= remaining_bytes8 (mk_int__ref remaining_bytes1))))
(assert (=> (not (<= 8 remaining_bytes1)) (= y8 (mk_t__ref y1))))
(assert (=> (not (<= 8 remaining_bytes1)) (= x8 (mk_t__ref x1))))
(assert (=> (not (<= 8 remaining_bytes1)) (= data15 (mk_map__ref data1))))
(assert (=> (not (<= 8 remaining_bytes1)) (= i16 i1)))
(assert (=> (not (<= 8 remaining_bytes1)) (= lane9 lane1)))
(assert (=> (not (<= 8 remaining_bytes1)) (= offset9 offset1)))
(assert (=> (not (<= 8 remaining_bytes1)) (= remaining_bytes9 remaining_bytes1)))
(assert (=> (not (<= 8 remaining_bytes1)) (= y9 y1)))
(assert (=> (not (<= 8 remaining_bytes1)) (= x9 x1)))
(assert (=> (not (<= 8 remaining_bytes1)) (= data16 data1)))
(assert (< 0 (int__content remaining_bytes8)))
(assert (= result28 lane8))
(assert (= lane10 (to_rep2 (get a (t__content x8) (t__content y8)))))
(assert (= result29 (mk_int__ref shift)))
(assert (= shift1 0))
(assert (in_range2 shift1))
(assert (= result30 (mk_int__ref initial_offset)))
(assert (= initial_offset1 (int__content offset8)))
(assert (in_range2 initial_offset1))
(assert (< 0 (int__content remaining_bytes8)))
(assert (and (and (= (+ offset10 remaining_bytes10) (ite (<= (to_rep data__first) (to_rep data__last)) (+ (- (to_rep data__last) (to_rep data__first)) 1) 0)) (= (mod2 shift2 8) 0)) (= shift2 (* (- offset10 initial_offset1) 8))))
(assert (and (and (and (=> (<= 0 2147483647) (in_range2 shift2)) (=> (<= 0 2147483647) (in_range2 remaining_bytes10))) (=> (<= 0 2147483647) (in_range2 offset10))) (< 0 remaining_bytes10)))
(assert (= result31 (mk_int__ref temp___775)))
(assert (= temp___7751 offset10))
(assert (= result32 (mk_int__ref temp___774)))
(assert (= temp___7741 shift2))
(assert (= result33 (mk_int__ref temp___773)))
(assert (= temp___7731 remaining_bytes10))
(assert (= (to_rep1 o116) ((_ extract 7 0) (bvand (bvlshr lane10 ((_ int2bv 64) shift2)) ((_ int2bv 64) 255)))))
(assert (and (= temp___766 (+ (to_rep data__first) offset10)) (in_range1 (+ (to_rep data__first) offset10))))
(assert (and (<= (to_rep data__first) temp___766) (<= temp___766 (to_rep data__last))))
(assert (= o117 temp___766))
(assert (= o118 (store data17 o117 o116)))
(assert (= result34 (mk_map__ref data17)))
(assert (= data18 o118))
(assert (and (= o119 (+ shift2 8)) (in_range1 (+ shift2 8))))
(assert (= result35 (mk_int__ref shift2)))
(assert (= shift3 o119))
(assert (and (= o120 (+ offset10 1)) (in_range1 (+ offset10 1))))
(assert (= result36 (mk_int__ref offset10)))
(assert (= offset11 o120))
(assert (and (= o121 (- remaining_bytes10 1)) (in_range2 (- remaining_bytes10 1))))
(assert (= result37 (mk_int__ref remaining_bytes10)))
(assert (= remaining_bytes11 o121))
(assert (< 0 remaining_bytes11))
(assert (not (or (< temp___7751 offset11) (and (= offset11 temp___7751) (or (< temp___7741 shift3) (and (= shift3 temp___7741) (< remaining_bytes11 temp___7731)))))))
(check-sat)
(exit)
