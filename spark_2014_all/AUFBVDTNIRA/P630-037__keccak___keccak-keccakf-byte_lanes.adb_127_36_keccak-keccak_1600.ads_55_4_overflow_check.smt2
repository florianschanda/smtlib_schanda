...
(assert (and (= (mod2 offset2 8) 0) (= (+ offset2 remaining_bytes2) (ite (<= (to_rep data__first) (to_rep data__last)) (+ (- (to_rep data__last) (to_rep data__first)) 1) 0))))
(assert (and (and (and (and (=> (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 4)) (in_range4 x2)) (=> (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 4)) (in_range5 y2))) (=> (<= 0 2147483647) (in_range2 remaining_bytes2))) (=> (<= 0 2147483647) (in_range2 offset2))) (<= 8 remaining_bytes2)))
(assert (= temp___7651 result5))
(assert (= temp___7652 offset2))
(assert (= temp___7641 result6))
(assert (= temp___7642 remaining_bytes2))
(assert (= result7 (mk_t__ref1 lane2)))
(assert (= lane3 (to_rep2 (get a x2 y2))))
(assert (= result8 (mk_int__ref i2)))
(assert (= i3 0))
(assert (and (= o11 (* i3 8)) (in_range1 (* i3 8))))
(assert (and (= o12 o11) (in_range2 o11)))
(assert (= o13 ((_ int2bv 64) o12)))
(assert (= o14 (bvlshr lane3 o13)))
(assert (= o15 (bvand o14 ((_ int2bv 64) 255))))
(assert (= o16 o15))
(assert (= o17 ((_ extract 7 0) o16)))
(assert (= (to_rep1 o18) o17))
(assert (and (= o9 (+ (to_rep data__first) offset2)) (in_range1 (+ (to_rep data__first) offset2))))
(assert (= o10 (+ o9 i3)))
(assert (and (= temp___748 o10) (in_range1 o10)))
(assert (and (<= (to_rep data__first) temp___748) (<= temp___748 (to_rep data__last))))
(assert (= o19 temp___748))
(assert (= o20 (store data2 o19 o18)))
(assert (= result9 (mk_map__ref data2)))
(assert (= data3 o20))
(assert (= result10 (mk_int__ref i3)))
(assert (= i4 1))
(assert (and (= o23 (* i4 8)) (in_range1 (* i4 8))))
(assert (and (= o24 o23) (in_range2 o23)))
(assert (= o25 ((_ int2bv 64) o24)))
(assert (= o26 (bvlshr lane3 o25)))
(assert (= o27 (bvand o26 ((_ int2bv 64) 255))))
(assert (= o28 o27))
(assert (= o29 ((_ extract 7 0) o28)))
(assert (= (to_rep1 o30) o29))
(assert (and (= o21 (+ (to_rep data__first) offset2)) (in_range1 (+ (to_rep data__first) offset2))))
(assert (= o22 (+ o21 i4)))
(assert (and (= temp___7481 o22) (in_range1 o22)))
(assert (and (<= (to_rep data__first) temp___7481) (<= temp___7481 (to_rep data__last))))
(assert (= o31 temp___7481))
(assert (= o32 (store data3 o31 o30)))
(assert (= result11 (mk_map__ref data3)))
(assert (= data4 o32))
(assert (= result12 (mk_int__ref i4)))
(assert (= i5 2))
(assert (and (= o35 (* i5 8)) (in_range1 (* i5 8))))
(assert (and (= o36 o35) (in_range2 o35)))
(assert (= o37 ((_ int2bv 64) o36)))
(assert (= o38 (bvlshr lane3 o37)))
(assert (= o39 (bvand o38 ((_ int2bv 64) 255))))
(assert (= o40 o39))
(assert (= o41 ((_ extract 7 0) o40)))
(assert (= (to_rep1 o42) o41))
(assert (and (= o33 (+ (to_rep data__first) offset2)) (in_range1 (+ (to_rep data__first) offset2))))
(assert (= o34 (+ o33 i5)))
(assert (and (= temp___7482 o34) (in_range1 o34)))
(assert (and (<= (to_rep data__first) temp___7482) (<= temp___7482 (to_rep data__last))))
(assert (= o43 temp___7482))
(assert (= o44 (store data4 o43 o42)))
(assert (= result13 (mk_map__ref data4)))
(assert (= data5 o44))
(assert (= result14 (mk_int__ref i5)))
(assert (= i6 3))
(assert (and (= o47 (* i6 8)) (in_range1 (* i6 8))))
(assert (and (= o48 o47) (in_range2 o47)))
(assert (= o49 ((_ int2bv 64) o48)))
(assert (= o50 (bvlshr lane3 o49)))
(assert (= o51 (bvand o50 ((_ int2bv 64) 255))))
(assert (= o52 o51))
(assert (= o53 ((_ extract 7 0) o52)))
(assert (= (to_rep1 o54) o53))
(assert (and (= o45 (+ (to_rep data__first) offset2)) (in_range1 (+ (to_rep data__first) offset2))))
(assert (= o46 (+ o45 i6)))
(assert (and (= temp___7483 o46) (in_range1 o46)))
(assert (and (<= (to_rep data__first) temp___7483) (<= temp___7483 (to_rep data__last))))
(assert (= o55 temp___7483))
(assert (= o56 (store data5 o55 o54)))
(assert (= result15 (mk_map__ref data5)))
(assert (= data6 o56))
(assert (= result16 (mk_int__ref i6)))
(assert (= i7 4))
(assert (and (= o59 (* i7 8)) (in_range1 (* i7 8))))
(assert (and (= o60 o59) (in_range2 o59)))
(assert (= o61 ((_ int2bv 64) o60)))
(assert (= o62 (bvlshr lane3 o61)))
(assert (= o63 (bvand o62 ((_ int2bv 64) 255))))
(assert (= o64 o63))
(assert (= o65 ((_ extract 7 0) o64)))
(assert (= (to_rep1 o66) o65))
(assert (and (= o57 (+ (to_rep data__first) offset2)) (in_range1 (+ (to_rep data__first) offset2))))
(assert (= o58 (+ o57 i7)))
(assert (and (= temp___7484 o58) (in_range1 o58)))
(assert (and (<= (to_rep data__first) temp___7484) (<= temp___7484 (to_rep data__last))))
(assert (= o67 temp___7484))
(assert (= o68 (store data6 o67 o66)))
(assert (= result17 (mk_map__ref data6)))
(assert (= data7 o68))
(assert (= result18 (mk_int__ref i7)))
(assert (= i8 5))
(assert (and (= o71 (* i8 8)) (in_range1 (* i8 8))))
(assert (and (= o72 o71) (in_range2 o71)))
(assert (= o73 ((_ int2bv 64) o72)))
(assert (= o74 (bvlshr lane3 o73)))
(assert (= o75 (bvand o74 ((_ int2bv 64) 255))))
(assert (= o76 o75))
(assert (= o77 ((_ extract 7 0) o76)))
(assert (= (to_rep1 o78) o77))
(assert (and (= o69 (+ (to_rep data__first) offset2)) (in_range1 (+ (to_rep data__first) offset2))))
(assert (= o70 (+ o69 i8)))
(assert (and (= temp___7485 o70) (in_range1 o70)))
(assert (and (<= (to_rep data__first) temp___7485) (<= temp___7485 (to_rep data__last))))
(assert (= o79 temp___7485))
(assert (= o80 (store data7 o79 o78)))
(assert (= result19 (mk_map__ref data7)))
(assert (= data8 o80))
(assert (= result20 (mk_int__ref i8)))
(assert (= i9 6))
(assert (and (= o83 (* i9 8)) (in_range1 (* i9 8))))
(assert (and (= o84 o83) (in_range2 o83)))
(assert (= o85 ((_ int2bv 64) o84)))
(assert (= o86 (bvlshr lane3 o85)))
(assert (= o87 (bvand o86 ((_ int2bv 64) 255))))
(assert (= o88 o87))
(assert (= o89 ((_ extract 7 0) o88)))
(assert (= (to_rep1 o90) o89))
(assert (and (= o81 (+ (to_rep data__first) offset2)) (in_range1 (+ (to_rep data__first) offset2))))
(assert (= o82 (+ o81 i9)))
(assert (and (= temp___7486 o82) (in_range1 o82)))
(assert (and (<= (to_rep data__first) temp___7486) (<= temp___7486 (to_rep data__last))))
(assert (= o91 temp___7486))
(assert (= o92 (store data8 o91 o90)))
(assert (= result21 (mk_map__ref data8)))
(assert (= data9 o92))
(assert (= result22 (mk_int__ref i9)))
(assert (= i10 7))
(assert (and (= o95 (* i10 8)) (in_range1 (* i10 8))))
(assert (and (= o96 o95) (in_range2 o95)))
(assert (= o97 ((_ int2bv 64) o96)))
(assert (= o98 (bvlshr lane3 o97)))
(assert (= o99 (bvand o98 ((_ int2bv 64) 255))))
(assert (= o100 o99))
(assert (= o101 ((_ extract 7 0) o100)))
(assert (= (to_rep1 o102) o101))
(assert (and (= o93 (+ (to_rep data__first) offset2)) (in_range1 (+ (to_rep data__first) offset2))))
(assert (= o94 (+ o93 i10)))
(assert (and (= temp___7487 o94) (in_range1 o94)))
(assert (and (<= (to_rep data__first) temp___7487) (<= temp___7487 (to_rep data__last))))
(assert (= o103 temp___7487))
(assert (= o104 (store data9 o103 o102)))
(assert (= result23 (mk_map__ref data9)))
(assert (= data10 o104))
(assert (=> (bvule (bvsub ((_ int2bv 8) 5) x2) ((_ int2bv 8) 1)) (= o105 (bvsub (bvadd x2 ((_ int2bv 8) 1)) ((_ int2bv 8) 5)))))
(assert (=> (not (bvule (bvsub ((_ int2bv 8) 5) x2) ((_ int2bv 8) 1))) (= o105 (bvadd x2 ((_ int2bv 8) 1)))))
(assert (= result24 (mk_t__ref x2)))
(assert (= x3 o105))
(assert (=> (= x3 ((_ int2bv 8) 0)) (=> (bvule (bvsub ((_ int2bv 8) 5) y2) ((_ int2bv 8) 1)) (= o106 (bvsub (bvadd y2 ((_ int2bv 8) 1)) ((_ int2bv 8) 5))))))
(assert (=> (= x3 ((_ int2bv 8) 0)) (=> (not (bvule (bvsub ((_ int2bv 8) 5) y2) ((_ int2bv 8) 1))) (= o106 (bvadd y2 ((_ int2bv 8) 1))))))
(assert (=> (= x3 ((_ int2bv 8) 0)) (= result25 (mk_t__ref y2))))
(assert (=> (= x3 ((_ int2bv 8) 0)) (= y3 o106)))
(assert (=> (not (= x3 ((_ int2bv 8) 0))) (= y3 y2)))
(assert (and (= o107 (- remaining_bytes2 8)) (in_range2 (- remaining_bytes2 8))))
(assert (= result26 (mk_int__ref remaining_bytes2)))
(assert (= remaining_bytes3 o107))
(assert (not (in_range1 (+ offset2 8))))
(check-sat)
(exit)
