...
(declare-fun temp___807 ((_ BitVec 8) Int Int) us_t1)
...
(assert (= (to_rep (first2 (rt1 (temp___807 #x00 (to_rep data__first) (to_rep data__last))))) (to_rep data__first)))
(assert (= (to_rep (last2 (rt1 (temp___807 #x00 (to_rep data__first) (to_rep data__last))))) (to_rep data__last)))
(assert (= (mk___t1 temp___814 temp___8141) (temp___807 #x00 (to_rep data__first) (to_rep data__last))))
...
(assert (and (and (and (and (=> (bvule #x00 #x04) (in_range4 x2)) (=> (bvule #x00 #x04) (in_range5 y2))) (=> (<= 0 2147483647) (in_range2 remaining_bytes2))) (=> (<= 0 2147483647) (in_range2 offset2))) (<= 8 remaining_bytes2)))
(assert (= temp___834 result5))
(assert (= temp___8341 offset2))
(assert (= temp___833 result6))
(assert (= temp___8331 remaining_bytes2))
...
(assert (= o9 (bvand o8 #x00000000000000FF)))
(assert (= o10 o9))
...
(assert (= o4 (+ o3 i1)))
(assert (and (= temp___817 o4) (in_range1 o4)))
(assert (and (<= (to_rep data__first) temp___817) (<= temp___817 (to_rep data__last))))
(assert (= o13 temp___817))
...
(assert (= o21 (bvand o20 #x00000000000000FF)))
(assert (= o22 o21))
...
(assert (= o16 (+ o15 i2)))
(assert (and (= temp___8171 o16) (in_range1 o16)))
(assert (and (<= (to_rep data__first) temp___8171) (<= temp___8171 (to_rep data__last))))
(assert (= o25 temp___8171))
...
(assert (= o33 (bvand o32 #x00000000000000FF)))
(assert (= o34 o33))
...
(assert (= o28 (+ o27 i3)))
(assert (and (= temp___8172 o28) (in_range1 o28)))
(assert (and (<= (to_rep data__first) temp___8172) (<= temp___8172 (to_rep data__last))))
(assert (= o37 temp___8172))
...
(assert (= o45 (bvand o44 #x00000000000000FF)))
(assert (= o46 o45))
...
(assert (= o40 (+ o39 i4)))
(assert (and (= temp___8173 o40) (in_range1 o40)))
(assert (and (<= (to_rep data__first) temp___8173) (<= temp___8173 (to_rep data__last))))
(assert (= o49 temp___8173))
...
(assert (= o57 (bvand o56 #x00000000000000FF)))
(assert (= o58 o57))
...
(assert (= o52 (+ o51 i5)))
(assert (and (= temp___8174 o52) (in_range1 o52)))
(assert (and (<= (to_rep data__first) temp___8174) (<= temp___8174 (to_rep data__last))))
(assert (= o61 temp___8174))
...
(assert (= o69 (bvand o68 #x00000000000000FF)))
(assert (= o70 o69))
...
(assert (= o64 (+ o63 i6)))
(assert (and (= temp___8175 o64) (in_range1 o64)))
(assert (and (<= (to_rep data__first) temp___8175) (<= temp___8175 (to_rep data__last))))
(assert (= o73 temp___8175))
...
(assert (= o81 (bvand o80 #x00000000000000FF)))
(assert (= o82 o81))
...
(assert (= o76 (+ o75 i7)))
(assert (and (= temp___8176 o76) (in_range1 o76)))
(assert (and (<= (to_rep data__first) temp___8176) (<= temp___8176 (to_rep data__last))))
(assert (= o85 temp___8176))
...
(assert (= o93 (bvand o92 #x00000000000000FF)))
(assert (= o94 o93))
...
(assert (= o88 (+ o87 i8)))
(assert (and (= temp___8177 o88) (in_range1 o88)))
(assert (and (<= (to_rep data__first) temp___8177) (<= temp___8177 (to_rep data__last))))
(assert (= o97 temp___8177))
(assert (= o98 (store data9 o97 o96)))
(assert (= result23 (mk_map__ref data9)))
(assert (= data10 o98))
(assert (=> (bvule (bvsub #x05 x2) #x01) (= o99 (bvsub (bvadd x2 #x01) #x05))))
(assert (=> (not (bvule (bvsub #x05 x2) #x01)) (= o99 (bvadd x2 #x01))))
(assert (= result24 (mk_t__ref x2)))
(assert (= x3 o99))
(assert (=> (= x3 #x00) (=> (bvule (bvsub #x05 y2) #x01) (= o100 (bvsub (bvadd y2 #x01) #x05)))))
(assert (=> (= x3 #x00) (=> (not (bvule (bvsub #x05 y2) #x01)) (= o100 (bvadd y2 #x01)))))
(assert (=> (= x3 #x00) (= result25 (mk_t__ref y2))))
(assert (=> (= x3 #x00) (= y3 o100)))
(assert (=> (not (= x3 #x00)) (= y3 y2)))
