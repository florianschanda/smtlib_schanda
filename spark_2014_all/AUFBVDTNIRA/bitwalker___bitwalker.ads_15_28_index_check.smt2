...
(define-fun bool_eq ((a (Array Int unsigned_8)) (a__first Int) (a__last Int) (b (Array Int unsigned_8)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_132 Int)) (=> (and (<= a__first temp___idx_132) (<= temp___idx_132 a__last)) (= (to_rep (select a temp___idx_132)) (to_rep (select b (+ (- b__first a__first) temp___idx_132))))))) true false))
...
(assert true)
(assert (forall ((stream us_t)) (forall ((pos Int)) (! (= (= (nth8_stream stream pos) true) (= (nth (to_rep (select (to_array stream) (div1 pos 8))) (- 7 (mod1 pos 8))) true)) :pattern ((nth8_stream stream pos))))))
...
(assert (forall ((byte (_ BitVec 8))) (forall ((left Int)) (! (=> (and (and (dynamic_invariant2 byte true true true) (dynamic_invariant left true true true)) (< left 8)) (= (= (peekbit8 byte left) true) (= (nth byte (- 7 left)) true))) :pattern ((peekbit8 byte left))))))
...
(assert (and (= (to_rep1 (first (rt addr))) 0) (< left (* 8 (length addr)))))
(assert (not (<= (to_rep1 (first (rt addr))) (div1 left 8))))
(check-sat)
(exit)
