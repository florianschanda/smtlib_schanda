...
(declare-const temp___595 (Array Int octet))
(declare-const temp___5951 t1)
(declare-const temp___596 (Array Int octet))
(declare-const temp___5961 t)
(declare-const temp___597 (Array Int octet))
(declare-const temp___5971 t)
...
(declare-const value2 (Array Int octet))
(declare-const last6 Int)
(declare-const value3 (Array Int octet))
...
(assert (= temp___594 (- o2 1)))
(assert (=> (<= position temp___594) (and (and (<= (to_rep (first (rt data))) position) (<= position (to_rep (last (rt data))))) (and (<= (to_rep (first (rt data))) temp___594) (<= temp___594 (to_rep (last (rt data))))))))
(assert (= o3 (elts data)))
(assert (= o3 temp___595))
(assert (= (mk1 position temp___594) temp___5951))
(assert (= temp___595 temp___596))
(assert (= (mk (to_rep (first2 temp___5951)) (to_rep (last2 temp___5951))) temp___5961))
(assert (= (ite (<= (to_rep (first temp___5961)) (to_rep (last temp___5961))) (+ (- (to_rep (last temp___5961)) (to_rep (first temp___5961))) 1) 0) (ite (<= (to_rep value__first) (to_rep value__last)) (+ (- (to_rep value__last) (to_rep value__first)) 1) 0)))
(assert (= (mk___t temp___597 temp___5971) (mk___t temp___596 temp___5961)))
(assert (= o4 (slide temp___597 (to_rep (first temp___5971)) (to_rep value__first))))
...
(assert (not (= last6 (+ position (- (length_with_padding (ite (<= (to_rep value__first) (to_rep value__last)) (+ (- (to_rep value__last) (to_rep value__first)) 1) 0)) 1)))))
(check-sat)
(exit)
