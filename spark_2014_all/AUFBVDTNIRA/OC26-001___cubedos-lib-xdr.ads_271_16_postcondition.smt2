...
(assert (=> (<= (to_rep value__first) (to_rep value__last)) (= o6 (+ (- (to_rep value__last) (to_rep value__first)) 1))))
(assert (=> (not (<= (to_rep value__first) (to_rep value__last))) (= o6 0)))
(assert (and (= o7 o6) (in_range1 o6)))
(assert (= o8 (+ position o7)))
(assert (= temp___535 (- o8 1)))
...
(assert (= o10 (slide temp___538 (to_rep (first temp___5381)) (to_rep value__first))))
(assert (= (mk_map__ref result) (mk_map__ref value)))
(assert (= value1 o10))
(assert (=> (<= (to_rep value__first) (to_rep value__last)) (= o11 (+ (- (to_rep value__last) (to_rep value__first)) 1))))
(assert (=> (not (<= (to_rep value__first) (to_rep value__last))) (= o11 0)))
(assert (and (= o12 o11) (in_range4 o11)))
(assert (and (= o13 (length_with_padding o12)) (and (in_range4 o13) (= o13 (+ o12 (ite (= (mod1 o12 4) 0) 0 (- 4 (mod1 o12 4))))))))
(assert (= o14 (- o13 1)))
(assert (= o15 (+ position o14)))
(assert (and (= o16 o15) (in_range3 o15)))
