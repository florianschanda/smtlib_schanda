...
(assert (= o22 (+ x_first o21)))
(assert (and (= o23 o22) (in_range1 o22)))
(assert (= o24 (ite (<= o23 (to_rep (last (rt x)))) true false)))
(assert (and (= o18 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o19 (+ x_first o18)))
(assert (and (= o20 o19) (in_range1 o19)))
(assert (= o25 (ite (<= (to_rep (first (rt x))) o20) true false)))
(assert (= result (ite (= o25 true) o24 false)))
(assert (= result true))
...
(assert (= o14 (+ m_first o13)))
(assert (and (= o15 o14) (in_range1 o14)))
(assert (= o16 (ite (<= o15 (to_rep (last (rt m)))) true false)))
(assert (and (= o10 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o11 (+ m_first o10)))
(assert (and (= o12 o11) (in_range1 o11)))
(assert (= o17 (ite (<= (to_rep (first (rt m))) o12) true false)))
(assert (= result1 (ite (= o17 true) o16 false)))
(assert (= result1 true))
...
(assert (= o6 (+ aux1_first o5)))
(assert (and (= o7 o6) (in_range1 o6)))
(assert (= o8 (ite (<= o7 (to_rep aux1__last)) true false)))
(assert (and (= o2 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o3 (+ aux1_first o2)))
(assert (and (= o4 o3) (in_range1 o3)))
(assert (= o9 (ite (<= (to_rep aux1__first) o4) true false)))
(assert (= result2 (ite (= o9 true) o8 false)))
(assert (= result2 true))
