...
(assert (= o26 (+ x_first o25)))
(assert (and (= o27 o26) (in_range1 o26)))
(assert (= o28 (ite (<= o27 (to_rep (last (rt x)))) true false)))
(assert (and (= o22 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o23 (+ x_first o22)))
(assert (and (= o24 o23) (in_range1 o23)))
(assert (= o29 (ite (<= (to_rep (first (rt x))) o24) true false)))
(assert (= result (ite (= o29 true) o28 false)))
(assert (= result true))
...
(assert (and (= o17 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o18 (+ m_first o17)))
(assert (and (= o19 o18) (in_range1 o18)))
(assert (= o20 (ite (<= o19 (to_rep (last (rt m)))) true false)))
(assert (and (= o14 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o15 (+ m_first o14)))
(assert (and (= o16 o15) (in_range1 o15)))
(assert (= o21 (ite (<= (to_rep (first (rt m))) o16) true false)))
...
(assert (= o10 (+ aux1_first o9)))
(assert (and (= o11 o10) (in_range1 o10)))
(assert (= o12 (ite (<= o11 (to_rep aux1__last)) true false)))
(assert (and (= o6 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o7 (+ aux1_first o6)))
(assert (and (= o8 o7) (in_range1 o7)))
(assert (= o13 (ite (<= (to_rep aux1__first) o8) true false)))
...
(assert (= o3 (+ aux2_first o2)))
(assert (and (= o4 o3) (in_range1 o3)))
(assert (= o5 (ite (<= o4 (to_rep aux2__last)) true false)))
