...
(define-fun dynamic_invariant3 ((temp___expr_1276 us_rep1) (temp___is_init_1272 Bool) (temp___skip_constant_1273 Bool) (temp___do_toplevel_1274 Bool) (temp___do_typ_inv_1275 Bool)) Bool (=> (= temp___do_typ_inv_1275 true) (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1276))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1276))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1276)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1276))) true)))
(define-fun default_initial_assumption ((temp___expr_1280 us_rep1) (temp___skip_top_level_1281 Bool)) Bool (and (and (and (= (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1280))) 1) (= (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1280))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1280)) (mk___rep (mk___split_fields (temp___1282 1) (of_rep2 1) (of_rep2 1) (of_rep4 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1280)) (temp___1286 0))))
(define-fun type_invariant ((temp___1290 us_rep1)) Bool (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___1290))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___1290))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___1290)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___1290))) true))
...
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq10 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_175 Int)) (=> (and (<= a__first temp___idx_175) (<= temp___idx_175 a__last)) (= (to_rep6 (select a temp___idx_175)) (to_rep6 (select b (+ (- b__first a__first) temp___idx_175)))))))))))
...
(declare-fun temp___1931 (Int) (Array Int unsigned32t))
(declare-fun temp___String_Literal_1935 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1935 us_void_param) 1)) 70) (= (to_rep (select (temp___String_Literal_1935 us_void_param) 2)) 105)) (= (to_rep (select (temp___String_Literal_1935 us_void_param) 3)) 110)) (= (to_rep (select (temp___String_Literal_1935 us_void_param) 4)) 100)) (= (to_rep (select (temp___String_Literal_1935 us_void_param) 5)) 79)) (= (to_rep (select (temp___String_Literal_1935 us_void_param) 6)) 98)) (= (to_rep (select (temp___String_Literal_1935 us_void_param) 7)) 106)) (= (to_rep (select (temp___String_Literal_1935 us_void_param) 8)) 101)) (= (to_rep (select (temp___String_Literal_1935 us_void_param) 9)) 99)) (= (to_rep (select (temp___String_Literal_1935 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_1935 us_void_param) 11)) 115)) (= (to_rep (select (temp___String_Literal_1935 us_void_param) 12)) 73)) (= (to_rep (select (temp___String_Literal_1935 us_void_param) 13)) 110)) (= (to_rep (select (temp___String_Literal_1935 us_void_param) 14)) 105)) (= (to_rep (select (temp___String_Literal_1935 us_void_param) 15)) 116)) (= (to_rep (select (temp___String_Literal_1935 us_void_param) 16)) 32)) :pattern ((temp___String_Literal_1935 us_void_param)))))
(declare-fun temp___String_Literal_1937 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1937 us_void_param) 1)) 70) (= (to_rep (select (temp___String_Literal_1937 us_void_param) 2)) 105)) (= (to_rep (select (temp___String_Literal_1937 us_void_param) 3)) 110)) (= (to_rep (select (temp___String_Literal_1937 us_void_param) 4)) 100)) (= (to_rep (select (temp___String_Literal_1937 us_void_param) 5)) 79)) (= (to_rep (select (temp___String_Literal_1937 us_void_param) 6)) 98)) (= (to_rep (select (temp___String_Literal_1937 us_void_param) 7)) 106)) (= (to_rep (select (temp___String_Literal_1937 us_void_param) 8)) 101)) (= (to_rep (select (temp___String_Literal_1937 us_void_param) 9)) 99)) (= (to_rep (select (temp___String_Literal_1937 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_1937 us_void_param) 11)) 115)) (= (to_rep (select (temp___String_Literal_1937 us_void_param) 12)) 32)) :pattern ((temp___String_Literal_1937 us_void_param)))))
(declare-fun temp___String_Literal_1939 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1939 us_void_param) 1)) 70) (= (to_rep (select (temp___String_Literal_1939 us_void_param) 2)) 105)) (= (to_rep (select (temp___String_Literal_1939 us_void_param) 3)) 110)) (= (to_rep (select (temp___String_Literal_1939 us_void_param) 4)) 100)) (= (to_rep (select (temp___String_Literal_1939 us_void_param) 5)) 79)) (= (to_rep (select (temp___String_Literal_1939 us_void_param) 6)) 98)) (= (to_rep (select (temp___String_Literal_1939 us_void_param) 7)) 106)) (= (to_rep (select (temp___String_Literal_1939 us_void_param) 8)) 101)) (= (to_rep (select (temp___String_Literal_1939 us_void_param) 9)) 99)) (= (to_rep (select (temp___String_Literal_1939 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_1939 us_void_param) 11)) 115)) (= (to_rep (select (temp___String_Literal_1939 us_void_param) 12)) 70)) (= (to_rep (select (temp___String_Literal_1939 us_void_param) 13)) 105)) (= (to_rep (select (temp___String_Literal_1939 us_void_param) 14)) 110)) (= (to_rep (select (temp___String_Literal_1939 us_void_param) 15)) 97)) (= (to_rep (select (temp___String_Literal_1939 us_void_param) 16)) 108)) (= (to_rep (select (temp___String_Literal_1939 us_void_param) 17)) 32)) :pattern ((temp___String_Literal_1939 us_void_param)))))
...
(assert (forall ((temp___1933 Int)) (=> (dynamic_invariant1 temp___1933 true true true true) (forall ((temp___1934 Int)) (= (to_rep7 (select (temp___1931 temp___1933) temp___1934)) temp___1933)))))
...
(define-fun dynamic_invariant10 ((temp___expr_997 Int) (temp___is_init_993 Bool) (temp___skip_constant_994 Bool) (temp___do_toplevel_995 Bool) (temp___do_typ_inv_996 Bool)) Bool (=> (or (= temp___is_init_993 true) (<= 0 40)) (in_range12 temp___expr_997)))
(define-fun dynamic_invariant11 ((temp___expr_1021 Int) (temp___is_init_1017 Bool) (temp___skip_constant_1018 Bool) (temp___do_toplevel_1019 Bool) (temp___do_typ_inv_1020 Bool)) Bool (=> (or (= temp___is_init_1017 true) (<= 0 4294967295)) (in_range13 temp___expr_1021)))
...
(define-fun dynamic_invariant13 ((temp___expr_1214 Int) (temp___is_init_1210 Bool) (temp___skip_constant_1211 Bool) (temp___do_toplevel_1212 Bool) (temp___do_typ_inv_1213 Bool)) Bool (=> (or (= temp___is_init_1210 true) (<= 0 17)) (in_range9 temp___expr_1214)))
(define-fun dynamic_invariant14 ((temp___expr_1221 Int) (temp___is_init_1217 Bool) (temp___skip_constant_1218 Bool) (temp___do_toplevel_1219 Bool) (temp___do_typ_inv_1220 Bool)) Bool (=> (or (= temp___is_init_1217 true) (<= 1 17)) (in_range7 temp___expr_1221)))
(define-fun dynamic_invariant15 ((temp___expr_1347 Int) (temp___is_init_1343 Bool) (temp___skip_constant_1344 Bool) (temp___do_toplevel_1345 Bool) (temp___do_typ_inv_1346 Bool)) Bool (=> (or (= temp___is_init_1343 true) (<= 0 2)) (in_range11 temp___expr_1347)))
(define-fun dynamic_invariant16 ((temp___expr_1228 Int) (temp___is_init_1224 Bool) (temp___skip_constant_1225 Bool) (temp___do_toplevel_1226 Bool) (temp___do_typ_inv_1227 Bool)) Bool (=> (or (= temp___is_init_1224 true) (<= 0 17408)) (in_range8 temp___expr_1228)))
(define-fun dynamic_invariant17 ((temp___expr_1259 Int) (temp___is_init_1255 Bool) (temp___skip_constant_1256 Bool) (temp___do_toplevel_1257 Bool) (temp___do_typ_inv_1258 Bool)) Bool (=> (or (= temp___is_init_1255 true) (<= 0 1024)) (in_range10 temp___expr_1259)))
(assert true)
...
(assert (forall ((temp___1288 Int)) (=> (dynamic_invariant17 temp___1288 true true true true) (forall ((temp___1289 Int)) (= (to_rep5 (select (temp___1286 temp___1288) temp___1289)) temp___1288)))))
...
(assert (forall ((temp___1284 Int)) (=> (dynamic_invariant14 temp___1284 true true true true) (forall ((temp___1285 Int)) (= (to_rep2 (select (temp___1282 temp___1284) temp___1285)) temp___1284)))))
...
(declare-const temp___1936 (Array Int character))
(declare-const temp___19361 t1)
(declare-const o (Array Int character))
(declare-const o1 t1)
(declare-const o2 (Array Int character))
(declare-const o3 (Array Int character))
(declare-const o4 t)
(declare-const temp___1938 (Array Int character))
(declare-const temp___19381 t1)
...
(define-fun temp___19382 () us_t1 (mk___t1 temp___1938 temp___19381))
(define-fun o11 () us_t1 (mk___t1 o o1))
(define-fun temp___19362 () us_t1 (mk___t1 temp___1936 temp___19361))
...
(assert (=> (= (select issystem retvalini1) true) (= (temp___String_Literal_1935 Tuple0) temp___1936)))
(assert (=> (= (select issystem retvalini1) true) (= (mk1 1 16) temp___19361)))
(assert (=> (= (select issystem retvalini1) true) (dynamic_predicate temp___19362)))
(assert (=> (= (select issystem retvalini1) true) (= o11 temp___19362)))
...
(assert (=> (= (select issystem retvalini1) true) (and (in_range4 auditalarm2) (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8)) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8)) true))))
...
(assert (=> (= (select issystem retvaldo2) true) (= (temp___String_Literal_1937 Tuple0) temp___1938)))
(assert (=> (= (select issystem retvaldo2) true) (= (mk1 1 12) temp___19381)))
(assert (=> (= (select issystem retvaldo2) true) (dynamic_predicate temp___19382)))
(assert (=> (= (select issystem retvaldo2) true) (= o10 temp___19382)))
