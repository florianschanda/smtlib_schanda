...
(assert (=> (= (select issystem retvalini1) true) (= (temp___String_Literal_1761 Tuple0) temp___1762)))
(assert (=> (= (select issystem retvalini1) true) (= (mk1 1 16) temp___17621)))
(assert (=> (= (select issystem retvalini1) true) (dynamic_predicate (mk___t1 temp___1762 temp___17621))))
(assert (=> (= (select issystem retvalini1) true) (= (mk___t1 o o1) (mk___t1 temp___1762 temp___17621))))
(assert (=> (= (select issystem retvalini1) true) (= o2 (convertretvaltotext retvalini1 (mk___t1 o o1)))))
...
(assert (=> (= (select issystem retvaldo2) true) (= (temp___String_Literal_1763 Tuple0) temp___1764)))
(assert (=> (= (select issystem retvaldo2) true) (= (mk1 1 12) temp___17641)))
(assert (=> (= (select issystem retvaldo2) true) (dynamic_predicate (mk___t1 temp___1764 temp___17641))))
(assert (=> (= (select issystem retvaldo2) true) (= (mk___t1 o5 o6) (mk___t1 temp___1764 temp___17641))))
(assert (=> (= (select issystem retvaldo2) true) (= o7 (convertretvaltotext retvaldo2 (mk___t1 o5 o6)))))
