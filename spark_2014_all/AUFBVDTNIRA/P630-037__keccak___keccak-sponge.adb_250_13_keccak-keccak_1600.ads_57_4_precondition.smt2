...
(assert (and (and (and (= (state_of (mk___rep ctx__split_fields6)) 0) (= (mod2 (in_queue_bit_length (mk___rep ctx__split_fields6)) 8) 0)) (< (in_queue_bit_length (mk___rep ctx__split_fields6)) (rate_of (mk___rep ctx__split_fields6)))) (= (rate_of (mk___rep ctx__split_fields6)) initial_rate1)))
(assert (=> (<= 1 2147483647) (in_range3 initial_rate1)))
(assert (=> (< (- 8 (mod2 bit_length 8)) 8) (= o11 (bvlshr suffix ((_ int2bv 8) (- 8 (mod2 bit_length 8)))))))
(assert (=> (not (< (- 8 (mod2 bit_length 8)) 8)) (= o11 #x00)))
(assert (= (to_rep3 o12) o11))
(assert (= o13 (store suffix_array2 0 o12)))
(assert (= result5 (mk_map__ref1 suffix_array2)))
(assert (= suffix_array3 o13))
(assert (and (= o14 (+ bit_length suffix_len)) (in_range1 (+ bit_length suffix_len))))
(assert (= o15 (mod2 o14 8)))
(assert (not (<= o15 2147483640)))
(check-sat)
(exit)
