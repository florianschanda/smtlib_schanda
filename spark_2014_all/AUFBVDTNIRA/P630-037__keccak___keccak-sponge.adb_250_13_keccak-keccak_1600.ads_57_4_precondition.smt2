...
(assert (and (and (and (= (state_of (mk___rep ctx__split_fields44)) 0) (= (mod2 (in_queue_bit_length (mk___rep ctx__split_fields44)) 8) 0)) (< (in_queue_bit_length (mk___rep ctx__split_fields44)) (rate_of (mk___rep ctx__split_fields44)))) (= (rate_of (mk___rep ctx__split_fields44)) initial_rate1)))
(assert (=> (<= 1 2147483647) (in_range3 initial_rate1)))
(assert (=> (< (- 8 (mod2 bit_length 8)) 8) (= o67 (bvlshr suffix ((_ int2bv 8) (- 8 (mod2 bit_length 8)))))))
(assert (=> (not (< (- 8 (mod2 bit_length 8)) 8)) (= o67 ((_ int2bv 8) 0))))
(assert (= (to_rep o68) o67))
(assert (= o69 (store suffix_array4 0 o68)))
(assert (= result10 (mk_map__ref suffix_array4)))
(assert (= suffix_array5 o69))
(assert (and (= o70 (+ bit_length suffix_len)) (in_range1 (+ bit_length suffix_len))))
(assert (= o71 (mod2 o70 8)))
(assert (not (= (state_of (mk___rep ctx__split_fields44)) 0)))
(check-sat)
(exit)
