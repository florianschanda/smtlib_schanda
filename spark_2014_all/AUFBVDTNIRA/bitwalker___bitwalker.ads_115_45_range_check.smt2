...
(declare-const o39 (Array Int unsigned_8))
...
(assert (=> (<= (to_rep addr__first) (to_rep addr__last)) (= o34 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))
...
(assert (= o38 (ite o37 1 0)))
(assert (= result7 (ite (= (ite (ite (= (int__content result__9) (- 1)) true false) 1 0) o38) true false)))
(assert (= result7 true))
...
(assert (and (= o26 (maxvalue len)) (= o26 (bvshl #x0000000000000001 ((_ int2bv 64) len)))))
(assert (= o31 (ite (bvule o26 value) true false)))
(assert (= o32 (ite (= o31 true) o30 false)))
(assert (= o33 (ite o32 1 0)))
(assert (= result8 (ite (= (ite (ite (= (int__content result__9) (- 2)) true false) 1 0) o33) true false)))
(assert (= result8 true))
...
(assert (= result9 (ite (= (ite (ite (= (int__content result__9) 0) true false) 1 0) o25) true false)))
(assert (= result9 true))
...
(assert (and (= o16 (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) o15)) (= (= o16 true) (= (nth1 (to_rep1 (select addr (div1 o15 8))) (- 7 (mod1 o15 8))) true))))
