...
(assert (= o32 (mk___split_fields (rec__keccak__keccak_1600__sponge__context__state ctx__split_fields10) (rec__keccak__keccak_1600__sponge__context__block ctx__split_fields10) (rec__keccak__keccak_1600__sponge__context__bits_absorbed ctx__split_fields10) o31 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields10) (rec__keccak__keccak_1600__sponge__context__curr_state ctx__split_fields10))))
(assert (= temp___993 (mk___rep o32)))
(assert (= result11 (mk___split_fields__ref ctx__split_fields10)))
(assert (= ctx__split_fields11 (us_split_fields1 temp___993)))
(assert (and (= o33 (+ offset1 bytes_to_squeeze2)) (in_range1 (+ offset1 bytes_to_squeeze2))))
(assert (= result12 (mk_int__ref offset1)))
(assert (= offset2 o33))
(assert (and (= o34 (- remaining1 bytes_to_squeeze2)) (in_range1 (- remaining1 bytes_to_squeeze2))))
(assert (and (= o35 o34) (in_range2 o34)))
(assert (= result13 (mk_int__ref remaining1)))
(assert (= remaining2 o35))
(assert (<= (to_rep4 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields11)) (to_rep3 (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields11))))
(assert (= result14 (mk___split_fields__ref ctx__split_fields11)))
(assert (= ctx__split_fields12 (mk___split_fields keccak__keccak_1600__keccakf_1600_permutation__permute__a1 (rec__keccak__keccak_1600__sponge__context__block ctx__split_fields11) (rec__keccak__keccak_1600__sponge__context__bits_absorbed ctx__split_fields11) (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields11) (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields11) (rec__keccak__keccak_1600__sponge__context__curr_state ctx__split_fields11))))
(assert (= (- (to_rep4 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields12)) 1) r148s))
