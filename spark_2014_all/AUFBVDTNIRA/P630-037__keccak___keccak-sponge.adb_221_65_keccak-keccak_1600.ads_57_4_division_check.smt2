...
(assert (= o38 (mod2 o37 8)))
(assert (and (= o36 (in_queue_bit_length (mk___rep ctx__split_fields42))) (and (in_range2 o36) (and (= o36 (to_rep5 (rec__keccak__keccak_1600__sponge__context__bits_absorbed ctx__split_fields42))) (< o36 1600)))))
(assert (not (not (= 8 0))))
(check-sat)
(exit)
