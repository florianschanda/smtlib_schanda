...
(assert (and (= o33 (rate_of (mk___rep ctx__split_fields18))) (and (in_range3 o33) (and (= o33 (* (to_rep5 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields18)) 8)) (< o33 1600)))))
(assert (= o34 (ite (= o33 initial_rate1) true false)))
(assert (and (= o30 (rate_of (mk___rep ctx__split_fields18))) (and (in_range3 o30) (and (= o30 (* (to_rep5 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields18)) 8)) (< o30 1600)))))
(assert (and (= o31 (in_queue_bit_length (mk___rep ctx__split_fields18))) (and (in_range2 o31) (and (= o31 (to_rep4 (rec__keccak__keccak_1600__sponge__context__bits_absorbed ctx__split_fields18))) (< o31 1600)))))
...
(assert (and (= o27 (in_queue_bit_length (mk___rep ctx__split_fields18))) (and (in_range2 o27) (and (= o27 (to_rep4 (rec__keccak__keccak_1600__sponge__context__bits_absorbed ctx__split_fields18))) (< o27 1600)))))
(assert (not (not (= 8 0))))
(check-sat)
(exit)
