...
(assert (= o74 (mod2 o73 8)))
(assert (and (= o72 (in_queue_bit_length (mk___rep ctx__split_fields45))) (and (in_range2 o72) (and (= o72 (to_rep5 (rec__keccak__keccak_1600__sponge__context__bits_absorbed ctx__split_fields45))) (< o72 1600)))))
(assert (not (not (= 8 0))))
(check-sat)
(exit)
