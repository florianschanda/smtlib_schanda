...
(assert (not (= (ite (<= (to_rep2 (first4 temp___1991)) (to_rep2 (last4 temp___1991))) (+ (- (to_rep2 (last4 temp___1991)) (to_rep2 (first4 temp___1991))) 1) 0) (ite (<= 1 digit_length) (+ (- digit_length 1) 1) 0))))
(check-sat)
(exit)
