...
(assert (=> (<= (to_rep1 value__first) (to_rep1 value__last)) (= o5 (+ (- (to_rep1 value__last) (to_rep1 value__first)) 1))))
(assert (=> (not (<= (to_rep1 value__first) (to_rep1 value__last))) (= o5 0)))
...
(assert (and (= o2 (length_with_padding o1)) (and (in_range6 o2) (= o2 (+ o1 (ite (= (mod1 o1 4) 0) 0 (- 4 (mod1 o1 4))))))))
(assert (= o3 (- o2 1)))
