...
(assert (and (= o44 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (and (= o45 o44) (uint_in_range1 o44)))
(assert (= o46 ((_ int2bv 64) o45)))
(assert (= o47 (bvadd o46 ((_ int2bv 64) 1))))
(assert (= o48 (bvmul o47 ((_ int2bv 64) 32))))
(assert (= o49 (ite (bvult i2 o48) true false)))
(assert (= o41 (from_word32 ((_ int2bv 32) 1))))
(assert (= o40 (from_word64 i2)))
(assert (= o42 (oadd o40 o41)))
(assert (= o39 (from_integer (int__content s12))))
(assert (= o43 (ole o39 o42)))
(assert (and (= o34 (power 2 k)) (in_range1 (power 2 k))))
(assert (= o35 (- o34 1)))
(assert (and (= o36 o35) (in_range1 o35)))
(assert (= o37 (ite (<= n o36) true false)))
(assert (= result9 (ite (<= 0 n) o37 false)))
(assert (= (= o38 true) (forall ((n1 Int)) (=> (and (<= 0 n1) (<= n1 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux45) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n1 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))))
(assert (and (= o32 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o33 (num_of_big_int m m_first o32)))
(assert (and (= o30 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (and (= o29 (base Tuple0)) (= o29 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o31 (oexpon o29 o30)))
(assert (= o25 (from_word32 ((_ int2bv 32) 1))))
(assert (= o23 (from_integer (int__content s12))))
(assert (= o22 (from_word64 i2)))
(assert (= o24 (osubtract o22 o23)))
(assert (= o26 (oadd o24 o25)))
(assert (= o21 (from_word32 ((_ int2bv 32) 2))))
(assert (= o27 (oexpon__2 o21 o26)))
(assert (and (= o16 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (= o17 (+ o16 1)))
(assert (and (= o18 o17) (in_range1 o17)))
(assert (and (= o19 o18) (in_range2 o18)))
(assert (= o20 (num_of_big_int e e_first o19)))
(assert (= o28 (odivide o20 o27)))
