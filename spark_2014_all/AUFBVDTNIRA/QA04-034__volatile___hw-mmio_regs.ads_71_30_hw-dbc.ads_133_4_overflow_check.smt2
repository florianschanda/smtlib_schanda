...
(define-fun dynamic_invariant3 ((temp___expr_754 (_ BitVec 64)) (temp___is_init_751 Bool) (temp___skip_constant_752 Bool) (temp___do_toplevel_753 Bool)) Bool true)
...
(assert (= o8 (ite (<= o7 64) true false)))
