...
(assert (not (= (ite (<= (to_rep (first6 temp___9191)) (to_rep (last6 temp___9191))) (+ (- (to_rep (last6 temp___9191)) (to_rep (first6 temp___9191))) 1) 0) (ite (<= (to_rep (first6 temp___9201)) (to_rep (last6 temp___9201))) (+ (- (to_rep (last6 temp___9201)) (to_rep (first6 temp___9201))) 1) 0))))
(check-sat)
(exit)
