...
(assert (= o15 (+ o14 i2)))
(assert (and (= temp___7851 o15) (in_range1 o15)))
(assert (and (<= (to_rep1 (first (rt data))) temp___7851) (<= temp___7851 (to_rep1 (last (rt data))))))
(assert (= o16 temp___7851))
...
(assert (= o26 (+ o25 i3)))
(assert (and (= temp___7852 o26) (in_range1 o26)))
(assert (and (<= (to_rep1 (first (rt data))) temp___7852) (<= temp___7852 (to_rep1 (last (rt data))))))
(assert (= o27 temp___7852))
...
(assert (= o37 (+ o36 i4)))
(assert (and (= temp___7853 o37) (in_range1 o37)))
(assert (and (<= (to_rep1 (first (rt data))) temp___7853) (<= temp___7853 (to_rep1 (last (rt data))))))
(assert (= o38 temp___7853))
...
(assert (= o48 (+ o47 i5)))
(assert (and (= temp___7854 o48) (in_range1 o48)))
(assert (and (<= (to_rep1 (first (rt data))) temp___7854) (<= temp___7854 (to_rep1 (last (rt data))))))
(assert (= o49 temp___7854))
...
(assert (= o59 (+ o58 i6)))
(assert (and (= temp___7855 o59) (in_range1 o59)))
(assert (and (<= (to_rep1 (first (rt data))) temp___7855) (<= temp___7855 (to_rep1 (last (rt data))))))
(assert (= o60 temp___7855))
...
(assert (= o70 (+ o69 i7)))
(assert (and (= temp___7856 o70) (in_range1 o70)))
(assert (and (<= (to_rep1 (first (rt data))) temp___7856) (<= temp___7856 (to_rep1 (last (rt data))))))
(assert (= o71 temp___7856))
...
(assert (= o81 (+ o80 i8)))
(assert (and (= temp___7857 o81) (in_range1 o81)))
(assert (and (<= (to_rep1 (first (rt data))) temp___7857) (<= temp___7857 (to_rep1 (last (rt data))))))
(assert (= o82 temp___7857))
