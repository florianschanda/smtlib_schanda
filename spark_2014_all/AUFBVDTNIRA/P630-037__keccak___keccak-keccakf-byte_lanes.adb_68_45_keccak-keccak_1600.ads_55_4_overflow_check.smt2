...
(assert (and (and (and (and (=> (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 4)) (in_range5 y2)) (=> (<= 0 2147483647) (in_range2 remaining_bits2))) (=> (<= 0 2147483647) (in_range2 offset2))) (=> (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 4)) (in_range4 x2))) (<= 64 remaining_bits2)))
...
(assert (= a1 o92))
(assert (=> (bvule (bvsub ((_ int2bv 8) 5) x2) ((_ int2bv 8) 1)) (= o93 (bvsub (bvadd x2 ((_ int2bv 8) 1)) ((_ int2bv 8) 5)))))
(assert (=> (not (bvule (bvsub ((_ int2bv 8) 5) x2) ((_ int2bv 8) 1))) (= o93 (bvadd x2 ((_ int2bv 8) 1)))))
(assert (= result25 (mk_t__ref x2)))
(assert (= x3 o93))
(assert (=> (= x3 ((_ int2bv 8) 0)) (=> (bvule (bvsub ((_ int2bv 8) 5) y2) ((_ int2bv 8) 1)) (= o94 (bvsub (bvadd y2 ((_ int2bv 8) 1)) ((_ int2bv 8) 5))))))
(assert (=> (= x3 ((_ int2bv 8) 0)) (=> (not (bvule (bvsub ((_ int2bv 8) 5) y2) ((_ int2bv 8) 1))) (= o94 (bvadd y2 ((_ int2bv 8) 1))))))
