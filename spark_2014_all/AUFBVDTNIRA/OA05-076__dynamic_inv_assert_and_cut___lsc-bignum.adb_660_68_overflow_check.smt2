...
(assert (<= 1 h8))
(assert (<= h8 r94b))
(assert (and (and (and (and (and (and (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t o51 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 #x00000001)) true)) (= (oeq (num_of_big_int (mk___t o54 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t o63 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (omultiply (oexpon__2 (num_of_big_int x x_first (+ l1 1)) (omultiply (odivide (num_of_big_int e e_first (+ (- e_last e_first) 1)) (oexpon__2 (from_word32 #x00000002) (oadd (from_word64 i2) (from_word32 #x00000001)))) (oexpon (from_word32 #x00000002) (- h9 1)))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (forall ((n1 Int)) (=> (and (<= 0 n1) (<= n1 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux41) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n1 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))) (= (oeq (from_word32 (t__content w7)) (omod (odivide (num_of_big_int e e_first (+ (- e_last e_first) 1)) (oexpon__2 (from_word32 #x00000002) (osubtract (from_word64 i2) (osubtract (from_integer s10) (from_word32 #x00000001))))) (oexpon (from_word32 #x00000002) s10))) true)) (= (bvurem (t__content w7) #x00000002) #x00000001)) (<= 0 s10)) (<= s10 (+ k 1))) (= (ole (from_integer s10) (oadd (from_word64 i2) (from_word32 #x00000001))) true)) (bvult i2 (bvmul (bvadd ((_ int2bv 64) (- e_last e_first)) #x0000000000000001) #x0000000000000020))))
(assert (and (=> (<= 1 r94b) (dynamic_property2 1 r94b h9)) (and (<= 1 h9) (<= h9 r94b))))
(assert (= (oeq (num_of_big_int (mk___t o64 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omod (omultiply (omultiply (num_of_big_int (mk___t o63 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ (- a_last a_first) 1)) (num_of_big_int (mk___t o63 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ (- a_last a_first) 1))) (oexpon (inverse (num_of_big_int m m_first (+ (- a_last a_first) 1)) (base Tuple0)) (+ (- a_last a_first) 1))) (num_of_big_int m m_first (+ (- a_last a_first) 1)))) true))
(assert (forall ((k1 Int)) (=> (and (<= (to_rep aux3__first) k1) (<= k1 (to_rep aux3__last))) (and (=> (and (<= aux3_first k1) (<= k1 (- (+ aux3_first a_last) a_first))) (= (to_rep1 (select o65 k1)) (to_rep1 (select o64 (- (+ a_first k1) aux3_first))))) (=> (=> (<= aux3_first k1) (not (<= k1 (- (+ aux3_first a_last) a_first)))) (= (to_rep1 (select o65 k1)) (to_rep1 (select o63 k1))))))))
...
(assert (and (= o38 (+ k 1)) (in_range1 (+ k 1))))
(assert (= o39 (ite (<= s10 o38) true false)))
(assert (= o34 (from_word32 #x00000002)))
(assert (= o35 (oexpon o34 s10)))
(assert (= o29 (from_word32 #x00000001)))
(assert (= o28 (from_integer s10)))
(assert (= o30 (osubtract o28 o29)))
(assert (= o27 (from_word64 i2)))
(assert (= o31 (osubtract o27 o30)))
(assert (= o26 (from_word32 #x00000002)))
(assert (= o32 (oexpon__2 o26 o31)))
(assert (and (= o21 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (= o22 (+ o21 1)))
(assert (and (= o23 o22) (in_range1 o22)))
(assert (and (= o24 o23) (in_range2 o23)))
(assert (= o25 (num_of_big_int e e_first o24)))
(assert (= o33 (odivide o25 o32)))
(assert (= o36 (omod o33 o35)))
(assert (= o20 (from_word32 (t__content w7))))
(assert (= o37 (oeq o20 o36)))
...
(assert (and (= o13 (* 2 n)) (in_range1 (* 2 n))))
(assert (= o14 (+ o13 1)))
