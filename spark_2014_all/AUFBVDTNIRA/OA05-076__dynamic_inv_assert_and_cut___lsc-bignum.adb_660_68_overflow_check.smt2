...
(assert (and (= o641 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o642 (num_of_big_int m m_first o641)))
(assert (and (= o638 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (and (= o637 (base Tuple0)) (= o637 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o639 (oexpon o637 o638)))
(assert (and (= o632 (* 2 n5)) (in_range1 (* 2 n5))))
(assert (= o633 (+ o632 1)))
(assert (not (in_range1 o633)))
(check-sat)
(exit)
