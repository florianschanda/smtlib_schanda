...
(define-fun dynamic_invariant2 ((temp___expr_1034 Int) (temp___is_init_1031 Bool) (temp___skip_constant_1032 Bool) (temp___do_toplevel_1033 Bool)) Bool (=> (or (= temp___is_init_1031 true) (<= 0 34)) (in_range3 temp___expr_1034)))
...
(define-fun dynamic_invariant3 ((temp___expr_1089 (_ BitVec 16)) (temp___is_init_1086 Bool) (temp___skip_constant_1087 Bool) (temp___do_toplevel_1088 Bool)) Bool true)
...
(assert (and (= o (+ byte_offset (to_rep (rec__hw__dbc__s_regs__t__byte_offset (us_split_fields1 (select regs idx)))))) (in_range1 (+ byte_offset (to_rep (rec__hw__dbc__s_regs__t__byte_offset (us_split_fields1 (select regs idx))))))))
(assert (not (not (= 4 0))))
(check-sat)
(exit)
