...
(define-fun dynamic_invariant1 ((temp___expr_1222 (_ BitVec 16)) (temp___is_init_1218 Bool) (temp___skip_constant_1219 Bool) (temp___do_toplevel_1220 Bool) (temp___do_typ_inv_1221 Bool)) Bool true)
...
(define-fun dynamic_invariant3 ((temp___expr_1163 Int) (temp___is_init_1159 Bool) (temp___skip_constant_1160 Bool) (temp___do_toplevel_1161 Bool) (temp___do_typ_inv_1162 Bool)) Bool (=> (or (= temp___is_init_1159 true) (<= 0 34)) (in_range3 temp___expr_1163)))
...
(assert (= o7 (ite (<= o6 16) true false)))
