...
(assert (<= (+ start i7) j3))
(assert (<= j3 (- (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) 1)))
(assert (= (nth8_stream (mk___t addr3 (mk (to_rep addr__first) (to_rep addr__last))) j3) true))
(assert (not (= (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) j3) true)))
(check-sat)
(exit)
