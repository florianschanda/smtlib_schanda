...
(assert (not (= (ite (<= (to_rep (first (rt value))) (to_rep (last (rt value)))) (+ (- (to_rep (last (rt value))) (to_rep (first (rt value)))) 1) 0) (ite (<= position (- (+ position (length value)) 1)) (+ (- (- (+ position (length value)) 1) position) 1) 0))))
(check-sat)
(exit)
