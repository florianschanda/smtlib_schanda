...
(assert (= o23 (num_of_big_int x x_first o22)))
(assert (= o27 (omultiply o23 o26)))
(assert (= o30 (omod o27 o29)))
(assert (and (= o20 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o21 (num_of_big_int (mk___t aux4 (mk (to_rep aux4__first) (to_rep aux4__last))) aux4_first o20)))
(assert (= o31 (oeq o21 o30)))
...
(assert (= o18 (omod o15 o17)))
(assert (and (= o11 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o12 (num_of_big_int (mk___t aux3 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first o11)))
(assert (= o19 (oeq o12 o18)))
