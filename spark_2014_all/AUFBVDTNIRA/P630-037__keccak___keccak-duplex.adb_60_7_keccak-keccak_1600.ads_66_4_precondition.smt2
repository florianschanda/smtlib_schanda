...
(assert (forall ((temp___1051 (_ BitVec 8))) (forall ((temp___1052 Int)) (= (select (keccak__keccak_1600__duplex__duplex__block__aggregate_def temp___1051) temp___1052) (of_rep1 temp___1051)))))
...
(declare-const result8 map1)
(declare-const result9 rate_number)
...
(assert (= (mk_map__ref result3) (mk_map__ref block)))
(assert (= block1 (keccak__keccak_1600__duplex__duplex__block__aggregate_def ((_ int2bv 8) 0))))
(assert (and (= o9 (+ in_data_bit_length 7)) (in_range (+ in_data_bit_length 7))))
(assert (= o10 (div1 o9 8)))
(assert (and (= keccak__keccak_1600__duplex__duplex__num_bytes__assume o10) (in_range1 o10)))
(assert (= keccak__keccak_1600__duplex__duplex__num_bytes__assume num_bytes))
(assert (in_range1 num_bytes))
(assert (=> (< 0 num_bytes) (and (= temp___1054 (+ (to_rep (first (rt in_data))) (- num_bytes 1))) (in_range (+ (to_rep (first (rt in_data))) (- num_bytes 1))))))
(assert (=> (< 0 num_bytes) (=> (<= (to_rep (first (rt in_data))) temp___1054) (and (and (<= (to_rep (first (rt in_data))) (to_rep (first (rt in_data)))) (<= (to_rep (first (rt in_data))) (to_rep (last (rt in_data))))) (and (<= (to_rep (first (rt in_data))) temp___1054) (<= temp___1054 (to_rep (last (rt in_data)))))))))
(assert (=> (< 0 num_bytes) (= o11 (elts in_data))))
(assert (=> (< 0 num_bytes) (= o11 temp___1055)))
(assert (=> (< 0 num_bytes) (= (mk2 (to_rep (first (rt in_data))) temp___1054) temp___10551)))
(assert (=> (< 0 num_bytes) (= (ite (<= (to_rep (first4 temp___10551)) (to_rep (last4 temp___10551))) (+ (- (to_rep (last4 temp___10551)) (to_rep (first4 temp___10551))) 1) 0) (ite (<= 0 (- num_bytes 1)) (+ (- (- num_bytes 1) 0) 1) 0))))
(assert (=> (< 0 num_bytes) (= (slide temp___1055 (to_rep (first4 temp___10551)) 0) temp___1056)))
...
(assert (=> (< 0 num_bytes) (= o12 block1)))
(assert (=> (< 0 num_bytes) (= o12 temp___1059)))
(assert (=> (< 0 num_bytes) (= (mk1 0 (- num_bytes 1)) temp___10591)))
(assert (=> (< 0 num_bytes) (= (ite (<= (to_rep (first2 temp___10561)) (to_rep (last2 temp___10561))) (+ (- (to_rep (last2 temp___10561)) (to_rep (first2 temp___10561))) 1) 0) (ite (<= (to_rep (first2 temp___10591)) (to_rep (last2 temp___10591))) (+ (- (to_rep (last2 temp___10591)) (to_rep (first2 temp___10591))) 1) 0))))
(assert (=> (< 0 num_bytes) (= (mk___t1 temp___1060 temp___10601) (mk___t1 temp___1056 temp___10561))))
(assert (=> (< 0 num_bytes) (forall ((temp___1061 Int)) (ite (and (<= 0 temp___1061) (<= temp___1061 (- num_bytes 1))) (= (select o13 temp___1061) (select temp___1060 temp___1061)) (= (select o13 temp___1061) (select block1 temp___1061))))))
(assert (=> (< 0 num_bytes) (= block1 result4)))
(assert (=> (< 0 num_bytes) (= block2 o13)))
(assert (=> (not (< 0 num_bytes)) (= block2 block1)))
(assert (and (= o14 (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1)))) (and (in_range3 o14) (= o14 (to_rep3 ctx__split_fields1)))))
(assert (= o15 (+ o14 7)))
(assert (= o16 (div1 o15 8)))
(assert (= keccak__keccak_1600__duplex__duplex__R176s__assume (- o16 1)))
...
(assert (= o17 block2))
(assert (= o17 keccak__padding__pad101_single_block__block__compl))
(assert (= (mk3 0 r176s) keccak__padding__pad101_single_block__block__compl1))
(assert (and (= o20 (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1)))) (and (in_range3 o20) (= o20 (to_rep3 ctx__split_fields1)))))
(assert (= (to_rep o19) (to_rep (last6 keccak__padding__pad101_single_block__block__compl1))))
(assert (= (to_rep o18) (to_rep (first6 keccak__padding__pad101_single_block__block__compl1))))
(assert (not (<= (ite (<= (to_rep o18) (to_rep o19)) (+ (- (to_rep o19) (to_rep o18)) 1) 0) 268435455)))
(check-sat)
(exit)
