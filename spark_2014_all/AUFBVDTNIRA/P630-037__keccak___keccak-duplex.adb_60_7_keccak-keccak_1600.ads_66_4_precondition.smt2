...
(assert (=> (< 0 num_bytes) (forall ((temp___1061 Int)) (ite (and (<= 0 temp___1061) (<= temp___1061 (- num_bytes 1))) (= (select o4 temp___1061) (select temp___1060 temp___1061)) (= (select o4 temp___1061) (select block1 temp___1061))))))
