...
(define-fun dynamic_invariant3 ((temp___expr_572 Int) (temp___is_init_568 Bool) (temp___skip_constant_569 Bool) (temp___do_toplevel_570 Bool) (temp___do_typ_inv_571 Bool)) Bool (=> (or (= temp___is_init_568 true) (<= 3 1599)) (in_range3 temp___expr_572)))
(assert (forall ((ctx us_rep)) (! (dynamic_invariant3 (rate_of ctx) true false true true) :pattern ((rate_of ctx)))))
...
(assert (forall ((ctx us_rep)) (! (dynamic_invariant4 (max_input_length ctx) true false true true) :pattern ((max_input_length ctx)))))
...
(assert (dynamic_invariant2 in_data true false true true))
...
(assert (not (<= (ite (<= (to_rep o9) (to_rep o10)) (+ (- (to_rep o10) (to_rep o9)) 1) 0) 268435455)))
(check-sat)
(exit)
