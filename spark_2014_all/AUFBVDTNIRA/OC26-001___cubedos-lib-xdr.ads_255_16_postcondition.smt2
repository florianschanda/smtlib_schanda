...
(assert (and (= o39 (+ position 7)) (in_range1 (+ position 7))))
(assert (= result36 (mk_int__ref last2)))
(assert (= last3 o39))
(assert (= i8 (mk_int__ref i7)))
(assert (= temporary_215 (mk_t__ref1 temporary_214)))
(assert (= temporary_19 (mk_t__ref1 temporary_18)))
(assert (= last4 (mk_int__ref last3)))
(assert (= value8 (mk_t__ref1 value7)))
(assert (= i9 i7))
(assert (= temporary_216 temporary_214))
(assert (= temporary_110 temporary_18))
(assert (= last5 last3))
