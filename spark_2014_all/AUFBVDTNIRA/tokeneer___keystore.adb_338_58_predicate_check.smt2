...
(assert (=> (= (select issystem retvalini1) true) (= o5 temp___19362)))
...
(assert (= (temp___String_Literal_1937 Tuple0) temp___1938))
(assert (= (mk1 1 12) temp___19381))
(assert (not (dynamic_predicate (mk___t1 temp___1938 temp___19381))))
(check-sat)
(exit)
