...
(assert (=> (<= (to_rep addr__first) (to_rep addr__last)) (= o31 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))
(assert (=> (not (<= (to_rep addr__first) (to_rep addr__last))) (= o31 0)))
(assert (and (= o32 o31) (in_range1 o31)))
(assert (= o33 (* 8 o32)))
(assert (= o34 (ite (< o33 (+ start len)) true false)))
(assert (= o35 (ite o34 1 0)))
(assert (= result7 (ite (= (ite (ite (= (int__content result__9) (- 1)) true false) 1 0) o35) true false)))
(assert (= result7 true))
(assert (=> (<= (to_rep addr__first) (to_rep addr__last)) (= o24 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))
(assert (=> (not (<= (to_rep addr__first) (to_rep addr__last))) (= o24 0)))
(assert (and (= o25 o24) (in_range1 o24)))
(assert (= o26 (* 8 o25)))
(assert (= o27 (ite (<= (+ start len) o26) true false)))
(assert (and (= o23 (maxvalue len)) (= o23 (bvshl #x0000000000000001 ((_ int2bv 64) len)))))
(assert (= o28 (ite (bvule o23 value) true false)))
(assert (= o29 (ite (= o28 true) o27 false)))
(assert (= o30 (ite o29 1 0)))
(assert (= result8 (ite (= (ite (ite (= (int__content result__9) (- 2)) true false) 1 0) o30) true false)))
(assert (= result8 true))
...
(assert (= o18 (* 8 o17)))
(assert (= o19 (ite (<= (+ start len) o18) true false)))
(assert (and (= o15 (maxvalue len)) (= o15 (bvshl #x0000000000000001 ((_ int2bv 64) len)))))
(assert (= o20 (ite (bvugt o15 value) true false)))
(assert (= o21 (ite (= o20 true) o19 false)))
(assert (= o22 (ite o21 1 0)))
(assert (= result9 (ite (= (ite (ite (= (int__content result__9) 0) true false) 1 0) o22) true false)))
(assert (= result9 true))
...
(assert (=> (= (int__content result__9) 0) (= (= result11 true) (forall ((i15 Int)) (=> (and (<= start i15) (<= i15 (- (+ start len) 1))) (= (= (nth8_stream (mk___t (map__content addr10) (mk (to_rep addr__first) (to_rep addr__last))) i15) true) (= (nth value (+ (- (- len i15) 1) start)) true)))))))
