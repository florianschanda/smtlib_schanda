...
(assert (=> (= (int__content result__9) 0) (= (= result14 true) (forall ((i16 Int)) (=> (and (<= start i16) (<= i16 (- (+ start len) 1))) (= (= (nth8_stream (mk___t (map__content addr10) (mk (to_rep addr__first) (to_rep addr__last))) i16) true) (= (nth value (+ (- (- len i16) 1) start)) true)))))))
(assert (=> (not (= (int__content result__9) 0)) (= result14 (of_int 1))))
(assert (= result14 true))
(assert (= (int__content result__9) 0))
(assert (=> (<= (to_rep addr__first) (to_rep addr__last)) (= o44 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))
(assert (=> (not (<= (to_rep addr__first) (to_rep addr__last))) (= o44 0)))
(assert (and (= o45 o44) (in_range1 o44)))
(assert (= o46 (* 8 o45)))
(assert (= o47 (- o46 1)))
(assert (= o48 (ite (<= i1 o47) true false)))
(assert (= result15 (ite (<= (+ start len) i1) o48 false)))
