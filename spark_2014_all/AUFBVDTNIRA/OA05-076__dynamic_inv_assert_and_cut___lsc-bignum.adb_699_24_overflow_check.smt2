...
(assert (= o49 (from_integer (int__content s12))))
...
(assert (= result9 (ite (<= 0 n) o47 false)))
(assert (= (= o48 true) (forall ((n1 Int)) (=> (and (<= 0 n1) (<= n1 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux45) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n1 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))))
(assert (and (= o40 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o41 (num_of_big_int m m_first o40)))
(assert (and (= o37 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (and (= o36 (base Tuple0)) (= o36 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o38 (oexpon o36 o37)))
(assert (= o31 (from_word32 ((_ int2bv 32) 1))))
(assert (= o29 (from_integer (int__content s12))))
(assert (= o28 (from_word64 i2)))
(assert (= o30 (osubtract o28 o29)))
(assert (= o32 (oadd o30 o31)))
(assert (= o27 (from_word32 ((_ int2bv 32) 2))))
(assert (= o33 (oexpon__2 o27 o32)))
(assert (and (= o22 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (= o23 (+ o22 1)))
(assert (and (= o24 o23) (in_range1 o23)))
(assert (and (= o25 o24) (in_range2 o24)))
(assert (= o26 (num_of_big_int e e_first o25)))
(assert (= o34 (odivide o26 o33)))
(assert (and (= o20 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o21 (num_of_big_int x x_first o20)))
(assert (= o35 (oexpon__2 o21 o34)))
(assert (= o39 (omultiply o35 o38)))
(assert (= o42 (omod o39 o41)))
(assert (and (= o18 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o19 (num_of_big_int (mk___t (map__content aux310) (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first o18)))
(assert (= o43 (oeq o19 o42)))
