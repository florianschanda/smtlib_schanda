...
(assert true)
(assert (not (bvule ((_ zero_extend 32) ((_ int2bv 32) 0)) (bvor (bvand ((_ zero_extend 32) temp1) (bvnot mask1)) (bvshl ((_ zero_extend 56) value) ((_ int2bv 64) (to_rep (rec__hw__dbc__s_regs__t__lsb (us_split_fields1 (select regs idx))))))))))
(check-sat)
(exit)
