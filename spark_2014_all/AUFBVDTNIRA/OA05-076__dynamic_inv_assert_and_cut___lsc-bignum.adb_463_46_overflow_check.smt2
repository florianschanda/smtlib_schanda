...
(assert (forall ((k1 Int)) (=> (and (<= aux1_first k1) (<= k1 o2)) (= (to_rep1 (select aux1 k1)) ((_ int2bv 32) 0)))))
(assert (= (to_rep1 o3) ((_ int2bv 32) 1)))
...
(assert (= (oeq (num_of_big_int (mk___t aux2 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ (- o8 aux2_first) 1)) (omod (omultiply (omultiply (num_of_big_int (mk___t aux4 (mk (to_rep aux4__first) (to_rep aux4__last))) aux4_first (+ (- o8 aux2_first) 1)) (num_of_big_int (mk___t aux4 (mk (to_rep aux4__first) (to_rep aux4__last))) aux4_first (+ (- o8 aux2_first) 1))) (oexpon (inverse (num_of_big_int m m_first (+ (- o8 aux2_first) 1)) (base Tuple0)) (+ (- o8 aux2_first) 1))) (num_of_big_int m m_first (+ (- o8 aux2_first) 1)))) true))
(assert (and (= o42 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o43 (num_of_big_int m m_first o42)))
(assert (and (= o39 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (and (= o38 (base Tuple0)) (= o38 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o40 (oexpon o38 o39)))
(assert (and (= o36 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o37 (num_of_big_int x x_first o36)))
(assert (= o41 (omultiply o37 o40)))
(assert (= o44 (omod o41 o43)))
(assert (and (= o34 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o35 (num_of_big_int (mk___t aux4 (mk (to_rep aux4__first) (to_rep aux4__last))) aux4_first o34)))
(assert (= o45 (oeq o35 o44)))
(assert (and (= o30 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o31 (num_of_big_int m m_first o30)))
(assert (and (= o28 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (and (= o27 (base Tuple0)) (= o27 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o29 (oexpon o27 o28)))
(assert (= o32 (omod o29 o31)))
(assert (and (= o25 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o26 (num_of_big_int (mk___t aux3 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first o25)))
(assert (= o33 (oeq o26 o32)))
(assert (and (= o21 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o22 (num_of_big_int m m_first o21)))
(assert (and (= o18 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (and (= o17 (base Tuple0)) (= o17 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o19 (oexpon o17 o18)))
...
(assert (= o16 (omultiply o13 o15)))
(assert (= o20 (omultiply o16 o19)))
(assert (= o23 (omod o20 o22)))
(assert (and (= o10 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o11 (num_of_big_int (mk___t aux2 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first o10)))
(assert (= o24 (oeq o11 o23)))
(assert (= o9 (from_word32 ((_ int2bv 32) 1))))
