...
(assert (and (= o14 (+ start i5)) (in_range1 (+ start i5))))
(assert (and (= o15 (peekbit8array addr o14)) (and (= (= o15 true) (= (peekbit8 (to_rep1 (select (elts addr) (div1 o14 8))) (mod1 o14 8)) true)) (= (= o15 true) (= (nth8_stream addr o14) true)))))
(assert (= flag2 result4))
(assert (= flag3 o15))
(assert (and (= o16 (+ (- 64 length1) i5)) (in_range1 (+ (- 64 length1) i5))))
