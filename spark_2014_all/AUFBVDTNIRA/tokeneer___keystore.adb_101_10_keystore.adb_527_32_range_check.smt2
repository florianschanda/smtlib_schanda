...
(assert (= temp___1551 (mk___t1 (slide (elts thestring) (to_rep1 (first (rt thestring))) 1) (mk1 1 (length thestring)))))
(assert (and (= temp___1553 (length thestring)) (in_range1 (length thestring))))
(assert (<= 1 temp___1553))
(assert (not (<= 1 1)))
(check-sat)
(exit)
