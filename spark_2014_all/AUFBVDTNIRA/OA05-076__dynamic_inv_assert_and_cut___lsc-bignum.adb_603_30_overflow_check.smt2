...
(assert (and (= o469 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o470 (num_of_big_int (mk___t aux2 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first o469)))
(assert (= o483 (oeq o470 o482)))
(assert (= o467 (from_word32 ((_ int2bv 32) 1))))
(assert (and (= o465 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o466 (num_of_big_int (mk___t aux11 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first o465)))
(assert (= o468 (oeq o466 o467)))
