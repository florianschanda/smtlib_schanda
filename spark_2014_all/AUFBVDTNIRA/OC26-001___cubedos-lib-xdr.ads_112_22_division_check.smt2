...
(define-fun dynamic_invariant ((temp___expr_180 Int) (temp___is_init_176 Bool) (temp___skip_constant_177 Bool) (temp___do_toplevel_178 Bool) (temp___do_typ_inv_179 Bool)) Bool (=> (or (= temp___is_init_176 true) (<= (- 9223372036854775808) 9223372036854775807)) (in_range2 temp___expr_180)))
...
(define-fun dynamic_invariant2 ((temp___expr_290 Int) (temp___is_init_286 Bool) (temp___skip_constant_287 Bool) (temp___do_toplevel_288 Bool) (temp___do_typ_inv_289 Bool)) Bool (=> (or (= temp___is_init_286 true) (<= (- 9223372036854775808) 9223372036854775807)) (in_range4 temp___expr_290)))
...
(define-fun dynamic_invariant3 ((temp___expr_297 (_ BitVec 64)) (temp___is_init_293 Bool) (temp___skip_constant_294 Bool) (temp___do_toplevel_295 Bool) (temp___do_typ_inv_296 Bool)) Bool true)
(declare-fun xdr_hyper_to_unsigned (Int) (_ BitVec 64))
(declare-fun xdr_hyper_to_unsigned__function_guard ((_ BitVec 64) Int) Bool)
(assert (forall ((s Int)) (! (=> (dynamic_invariant2 s true true true true) (dynamic_invariant3 (xdr_hyper_to_unsigned s) true false true true)) :pattern ((xdr_hyper_to_unsigned s)))))
