...
(define-fun dynamic_invariant ((temp___expr_154 Int) (temp___is_init_151 Bool) (temp___skip_constant_152 Bool) (temp___do_toplevel_153 Bool)) Bool (=> (or (= temp___is_init_151 true) (<= (- 9223372036854775808) 9223372036854775807)) (in_range2 temp___expr_154)))
...
(define-fun dynamic_invariant2 ((temp___expr_253 Int) (temp___is_init_250 Bool) (temp___skip_constant_251 Bool) (temp___do_toplevel_252 Bool)) Bool (=> (or (= temp___is_init_250 true) (<= (- 9223372036854775808) 9223372036854775807)) (in_range4 temp___expr_253)))
...
(define-fun dynamic_invariant3 ((temp___expr_259 (_ BitVec 64)) (temp___is_init_256 Bool) (temp___skip_constant_257 Bool) (temp___do_toplevel_258 Bool)) Bool true)
(declare-fun xdr_hyper_to_unsigned (Int) (_ BitVec 64))
(declare-fun xdr_hyper_to_unsigned__function_guard ((_ BitVec 64) Int) Bool)
(assert (forall ((s Int)) (! (=> (dynamic_invariant2 s true true true) (dynamic_invariant3 (xdr_hyper_to_unsigned s) true false true)) :pattern ((xdr_hyper_to_unsigned s)))))
