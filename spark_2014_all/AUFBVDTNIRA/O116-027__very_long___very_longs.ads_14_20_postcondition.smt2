...
(declare-const temp___878 digit_index_type)
(declare-const temp___8781 (Array Int octet))
(declare-const temp___8782 t1)
...
(assert (= index1 1))
(assert (=> (and (<= 1 index1) (<= index1 r27b)) (= temp___881 temp1)))
(assert (=> (and (<= 1 index1) (<= index1 r27b)) (and (= result____split_discrs (mk___split_discrs temp___878)) (= result____split_fields2 (mk___split_fields1 (mk___t1 temp___8781 temp___8782))))))
(assert (=> (and (<= 1 index1) (<= index1 r27b)) (and (and (and (dynamic_invariant2 (mk___rep1 result____split_discrs result____split_fields3) false true true true) (forall ((temp___880 Int)) (=> (and (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))) temp___880) (<= temp___880 (to_rep2 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))))) (=> (<= index2 temp___880) (= (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields3)) temp___880) (select temp___8781 temp___880)))))) (=> (<= 0 2147483647) (in_range1 temp2))) (and (<= 1 index2) (<= index2 r27b)))))
...
(assert (=> (and (<= 1 index1) (<= index1 r27b)) (= temp___877 (mk___rep1 result____split_discrs o10))))
(assert (=> (and (<= 1 index1) (<= index1 r27b)) (= result3 (mk___split_fields__ref1 result____split_fields3))))
(assert (=> (and (<= 1 index1) (<= index1 r27b)) (= result____split_fields4 (us_split_fields3 temp___877))))
(assert (=> (and (<= 1 index1) (<= index1 r27b)) (= result____split_discrs (us_split_discrs2 temp___877))))
