...
(assert (= index1 1))
(assert (=> (and (<= 1 index1) (<= index1 r27b)) (= temp___812 temp1)))
(assert (=> (and (<= 1 index1) (<= index1 r27b)) (and (= result____split_discrs (mk___split_discrs temp___809)) (= result____split_fields2 (mk___split_fields1 (mk___t1 temp___8091 temp___8092))))))
(assert (=> (and (<= 1 index1) (<= index1 r27b)) (and (and (and (dynamic_invariant2 (mk___rep1 result____split_discrs result____split_fields3) false true true) (forall ((temp___811 Int)) (=> (and (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))) temp___811) (<= temp___811 (to_rep2 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))))) (=> (<= index2 temp___811) (= (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields3)) temp___811) (select temp___8091 temp___811)))))) (=> (<= 0 2147483647) (in_range1 temp2))) (and (<= 1 index2) (<= index2 r27b)))))
(assert (=> (and (<= 1 index1) (<= index1 r27b)) (and (= o4 (mod1 temp2 256)) (uint_in_range (mod1 temp2 256)))))
(assert (=> (and (<= 1 index1) (<= index1 r27b)) (= o5 ((_ int2bv 8) o4))))
(assert (=> (and (<= 1 index1) (<= index1 r27b)) (= (to_rep1 o6) o5)))
(assert (=> (and (<= 1 index1) (<= index1 r27b)) (and (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))) index2) (<= index2 (to_rep2 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3))))))))
(assert (=> (and (<= 1 index1) (<= index1 r27b)) (= o7 index2)))
(assert (=> (and (<= 1 index1) (<= index1 r27b)) (= o8 (store (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields3)) o7 o6))))
(assert (=> (and (<= 1 index1) (<= index1 r27b)) (= o9 (mk___t1 o8 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3))))))
(assert (=> (and (<= 1 index1) (<= index1 r27b)) (= o10 (mk___split_fields1 o9))))
(assert (=> (and (<= 1 index1) (<= index1 r27b)) (= temp___808 (mk___rep1 result____split_discrs o10))))
(assert (=> (and (<= 1 index1) (<= index1 r27b)) (= result3 (mk___split_fields__ref1 result____split_fields3))))
(assert (=> (and (<= 1 index1) (<= index1 r27b)) (= result____split_fields4 (us_split_fields3 temp___808))))
(assert (=> (and (<= 1 index1) (<= index1 r27b)) (= result____split_discrs (us_split_discrs2 temp___808))))
(assert (=> (and (<= 1 index1) (<= index1 r27b)) (= result4 (mk_int__ref temp2))))
(assert (=> (and (<= 1 index1) (<= index1 r27b)) (= temp3 (div1 temp2 256))))
(assert (=> (and (<= 1 index1) (<= index1 r27b)) (= index2 r27b)))
(assert (=> (and (<= 1 index1) (<= index1 r27b)) (= index3 (mk_int__ref index2))))
(assert (=> (and (<= 1 index1) (<= index1 r27b)) (= temp4 (mk_int__ref temp3))))
(assert (=> (and (<= 1 index1) (<= index1 r27b)) (= result____split_fields5 (mk___split_fields__ref1 result____split_fields4))))
(assert (=> (and (<= 1 index1) (<= index1 r27b)) (= index4 index2)))
(assert (=> (and (<= 1 index1) (<= index1 r27b)) (= temp5 temp3)))
(assert (=> (and (<= 1 index1) (<= index1 r27b)) (= result____split_fields6 result____split_fields4)))
(assert (=> (and (<= 1 index1) (<= index1 r27b)) (= index5 index3)))
(assert (=> (and (<= 1 index1) (<= index1 r27b)) (= temp6 temp4)))
(assert (=> (and (<= 1 index1) (<= index1 r27b)) (= result____split_fields7 result____split_fields5)))
(assert (=> (and (<= 1 index1) (<= index1 r27b)) (= index6 index4)))
(assert (=> (and (<= 1 index1) (<= index1 r27b)) (= temp7 temp5)))
(assert (=> (and (<= 1 index1) (<= index1 r27b)) (= result____split_fields8 result____split_fields6)))
(assert (=> (not (and (<= 1 index1) (<= index1 r27b))) (= index5 (mk_int__ref index1))))
(assert (=> (not (and (<= 1 index1) (<= index1 r27b))) (= temp6 (mk_int__ref temp1))))
(assert (=> (not (and (<= 1 index1) (<= index1 r27b))) (= result____split_fields7 (mk___split_fields__ref1 result____split_fields2))))
(assert (=> (not (and (<= 1 index1) (<= index1 r27b))) (= index6 index1)))
(assert (=> (not (and (<= 1 index1) (<= index1 r27b))) (= temp7 temp1)))
(assert (=> (not (and (<= 1 index1) (<= index1 r27b))) (= result____split_fields8 result____split_fields2)))
