...
(declare-const o12 blocklengthvalue)
(declare-const o13 Int)
(declare-const o14 Bool)
(declare-const o15 Int)
(declare-const o16 blocklengthvalue)
...
(assert (and (<= 1 block2) (<= block2 32)))
(assert (= o15 block2))
(assert (= o16 (select (rec__rr_type__nsec_record_type__nsecrecordtype__blocklengths (us_split_fields3 nsec_record)) o15)))
(assert (= o17 (to_rep4 o16)))
(assert (= o18 (ite (<= o17 32) true false)))
(assert (and (<= 1 block2) (<= block2 32)))
(assert (= o11 block2))
(assert (= o12 (select (rec__rr_type__nsec_record_type__nsecrecordtype__blocklengths (us_split_fields3 nsec_record)) o11)))
(assert (= o13 (to_rep4 o12)))
(assert (= o14 (ite (<= 1 o13) true false)))
(assert (and (= o8 (* (- block2 1) 32)) (in_range1 (* (- block2 1) 32))))
(assert (and (= o9 o8) (in_range3 o8)))
(assert (= o10 (ite (<= dstbytes2 o9) true false)))
(assert (not (in_range1 (* (- block2 1) 34))))
(check-sat)
(exit)
