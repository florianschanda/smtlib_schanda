...
(define-fun index_t__ref___6__projection ((a index_t__ref1)) index_t1 (index_t__content1 a))
(define-fun dynamic_invariant4 ((temp___expr_1034 Int) (temp___is_init_1031 Bool) (temp___skip_constant_1032 Bool) (temp___do_toplevel_1033 Bool)) Bool (=> (or (= temp___is_init_1031 true) (<= 0 34)) (in_range3 temp___expr_1034)))
...
(define-fun word_t__ref___37__projection ((a word_t__ref)) word_t (word_t__content a))
(define-fun dynamic_invariant5 ((temp___expr_1113 (_ BitVec 8)) (temp___is_init_1110 Bool) (temp___skip_constant_1111 Bool) (temp___do_toplevel_1112 Bool)) Bool true)
...
(assert (forall ((temp___160 us_rep) (temp___161 us_rep) (temp___162 us_rep) (temp___163 us_rep) (temp___164 us_rep) (temp___165 us_rep) (temp___166 us_rep) (temp___167 us_rep) (temp___168 us_rep) (temp___169 us_rep) (temp___170 us_rep) (temp___171 us_rep) (temp___172 us_rep) (temp___173 us_rep) (temp___174 us_rep) (temp___175 us_rep) (temp___176 us_rep) (temp___177 us_rep) (temp___178 us_rep) (temp___179 us_rep) (temp___180 us_rep) (temp___181 us_rep) (temp___182 us_rep) (temp___183 us_rep) (temp___184 us_rep) (temp___185 us_rep) (temp___186 us_rep) (temp___187 us_rep) (temp___188 us_rep) (temp___189 us_rep) (temp___190 us_rep) (temp___191 us_rep) (temp___192 us_rep) (temp___193 us_rep) (temp___194 us_rep)) (let ((temp___159 (hw__dbc__reg_descs__aggregate_def temp___160 temp___161 temp___162 temp___163 temp___164 temp___165 temp___166 temp___167 temp___168 temp___169 temp___170 temp___171 temp___172 temp___173 temp___174 temp___175 temp___176 temp___177 temp___178 temp___179 temp___180 temp___181 temp___182 temp___183 temp___184 temp___185 temp___186 temp___187 temp___188 temp___189 temp___190 temp___191 temp___192 temp___193 temp___194))) (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (select temp___159 0) temp___160) (= (select temp___159 1) temp___161)) (= (select temp___159 2) temp___162)) (= (select temp___159 3) temp___163)) (= (select temp___159 4) temp___164)) (= (select temp___159 5) temp___165)) (= (select temp___159 6) temp___166)) (= (select temp___159 7) temp___167)) (= (select temp___159 8) temp___168)) (= (select temp___159 9) temp___169)) (= (select temp___159 10) temp___170)) (= (select temp___159 11) temp___171)) (= (select temp___159 12) temp___172)) (= (select temp___159 13) temp___173)) (= (select temp___159 14) temp___174)) (= (select temp___159 15) temp___175)) (= (select temp___159 16) temp___176)) (= (select temp___159 17) temp___177)) (= (select temp___159 18) temp___178)) (= (select temp___159 19) temp___179)) (= (select temp___159 20) temp___180)) (= (select temp___159 21) temp___181)) (= (select temp___159 22) temp___182)) (= (select temp___159 23) temp___183)) (= (select temp___159 24) temp___184)) (= (select temp___159 25) temp___185)) (= (select temp___159 26) temp___186)) (= (select temp___159 27) temp___187)) (= (select temp___159 28) temp___188)) (= (select temp___159 29) temp___189)) (= (select temp___159 30) temp___190)) (= (select temp___159 31) temp___191)) (= (select temp___159 32) temp___192)) (= (select temp___159 33) temp___193)) (= (select temp___159 34) temp___194)))))
...
(declare-const hw__dbc__regs__write_i__off__assume Int)
...
(assert true)
(assert (and (= o (+ byte_offset (to_rep (rec__hw__dbc__s_regs__t__byte_offset (us_split_fields1 (select regs idx)))))) (in_range (+ byte_offset (to_rep (rec__hw__dbc__s_regs__t__byte_offset (us_split_fields1 (select regs idx))))))))
(assert (= o1 (div1 o 4)))
(assert (and (= hw__dbc__regs__write_i__off__assume o1) (in_range2 o1)))
(assert (= hw__dbc__regs__write_i__off__assume off))
(assert (in_range2 off))
(assert (and (= o2 (+ (to_rep (rec__hw__dbc__s_regs__t__msb (us_split_fields1 (select regs idx)))) 1)) (in_range (+ (to_rep (rec__hw__dbc__s_regs__t__msb (us_split_fields1 (select regs idx)))) 1))))
(assert (= o3 ((_ int2bv 64) o2)))
(assert (= o4 (bvshl ((_ int2bv 64) 1) o3)))
(assert (= o5 (bvsub o4 (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) (to_rep (rec__hw__dbc__s_regs__t__lsb (us_split_fields1 (select regs idx)))))))))
(assert (= o6 o5))
(assert (= result mask))
(assert (= mask1 o6))
(assert true)
(assert true)
(assert (and (= o7 (- (to_rep (rec__hw__dbc__s_regs__t__msb (us_split_fields1 (select regs idx)))) (to_rep (rec__hw__dbc__s_regs__t__lsb (us_split_fields1 (select regs idx)))))) (in_range (- (to_rep (rec__hw__dbc__s_regs__t__msb (us_split_fields1 (select regs idx)))) (to_rep (rec__hw__dbc__s_regs__t__lsb (us_split_fields1 (select regs idx))))))))
(assert (= o8 (+ o7 1)))
