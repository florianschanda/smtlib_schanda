...
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (and (dynamic_invariant1 (mk___rep quotient__split_discrs quotient__split_fields4) true true true) (dynamic_invariant7 (mk___rep1 u__split_discrs u__split_fields5) true true true))))
