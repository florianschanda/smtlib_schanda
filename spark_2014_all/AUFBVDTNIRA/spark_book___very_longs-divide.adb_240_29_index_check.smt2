...
(assert (= j1 r138b))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (= temp___1104 current_borrow)))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (= temp___1103 q_hat)))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (= temp___1102 (mk___rep quotient__split_discrs quotient__split_fields2))))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (= temp___1101 (mk___rep1 u__split_discrs u__split_fields2))))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (and (and (dynamic_invariant7 (mk___rep1 u__split_discrs u__split_fields3) false true true) (dynamic_invariant1 (mk___rep quotient__split_discrs quotient__split_fields3) false true true)) (and (<= 1 j2) (<= j2 r138b)))))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (and (= o13 j2) (in_range2 j2))))
(assert true)
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (and (= o14 j2) (in_range2 j2))))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (dynamic_invariant7 (mk___rep1 u__split_discrs u__split_fields4) true true true)))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (and (= o15 j2) (in_range2 j2))))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (and (dynamic_invariant7 (mk___rep1 u__split_discrs u__split_fields5) true true true) (dynamic_invariant1 (mk___rep quotient__split_discrs quotient__split_fields4) true true true))))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (= j2 1)))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (= j3 (mk_int__ref j2))))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (= current_borrow4 (mk_t__ref1 current_borrow3))))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (= q_hat4 (mk_t__ref1 q_hat3))))
...
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (= current_borrow7 current_borrow5)))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (= q_hat7 q_hat5)))
...
(assert (=> (not (and (<= 1 j1) (<= j1 r138b))) (= current_borrow6 (mk_t__ref1 current_borrow))))
(assert (=> (not (and (<= 1 j1) (<= j1 r138b))) (= q_hat6 (mk_t__ref1 q_hat))))
...
(assert (=> (not (and (<= 1 j1) (<= j1 r138b))) (= current_borrow7 current_borrow1)))
(assert (=> (not (and (<= 1 j1) (<= j1 r138b))) (= q_hat7 q_hat1)))
...
(assert (and (and (dynamic_invariant1 (mk___rep remainder__split_discrs remainder__split_fields3) false true true) (forall ((temp___1113 Int)) (=> (and (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits remainder__split_fields3)))) temp___1113) (<= temp___1113 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits remainder__split_fields3)))))) (=> (<= divisor_index2 temp___1113) (= (select (elts (rec__very_longs__very_long__long_digits remainder__split_fields3)) temp___1113) (select (elts (rec__very_longs__very_long__long_digits remainder__split_fields2)) temp___1113)))))) (and (<= 1 divisor_index2) (<= divisor_index2 r140b))))
...
(assert (= o17 (select (elts1 (rec__very_longs__very_long__long_digits1 (us_split_fields__content1 u__split_fields8))) o16)))
