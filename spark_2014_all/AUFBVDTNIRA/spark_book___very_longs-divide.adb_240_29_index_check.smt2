...
(declare-const temp___1173 (_ BitVec 16))
(declare-const temp___1172 (_ BitVec 16))
(declare-const temp___1171 us_rep)
(declare-const temp___1170 us_rep1)
...
(assert (and (= very_longs__divide__L_7__R138b__assume (+ m1 1)) (in_range1 (+ m1 1))))
(assert (= very_longs__divide__L_7__R138b__assume r138b))
(assert (in_range1 r138b))
(assert (= result8 (mk_int__ref j)))
(assert (= j1 r138b))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (= temp___1173 current_borrow)))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (= temp___1172 q_hat)))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (= temp___1171 (mk___rep quotient__split_discrs quotient__split_fields2))))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (= temp___1170 (mk___rep1 u__split_discrs u__split_fields2))))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (and (and (dynamic_invariant7 (mk___rep1 u__split_discrs u__split_fields3) false true true true) (dynamic_invariant1 (mk___rep quotient__split_discrs quotient__split_fields3) false true true true)) (and (<= 1 j2) (<= j2 r138b)))))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (and (= o10 j2) (in_range2 j2))))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (and (= o11 j2) (in_range2 j2))))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (dynamic_invariant7 (mk___rep1 u__split_discrs u__split_fields4) true true true true)))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (and (= o12 j2) (in_range2 j2))))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (and (dynamic_invariant7 (mk___rep1 u__split_discrs u__split_fields5) true true true true) (dynamic_invariant1 (mk___rep quotient__split_discrs quotient__split_fields4) true true true true))))
...
(assert (and (and (dynamic_invariant1 (mk___rep remainder__split_discrs remainder__split_fields3) false true true true) (forall ((temp___1182 Int)) (=> (and (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits remainder__split_fields3)))) temp___1182) (<= temp___1182 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits remainder__split_fields3)))))) (=> (<= divisor_index2 temp___1182) (= (select (elts (rec__very_longs__very_long__long_digits remainder__split_fields3)) temp___1182) (select (elts (rec__very_longs__very_long__long_digits remainder__split_fields2)) temp___1182)))))) (and (<= 1 divisor_index2) (<= divisor_index2 r140b))))
(assert (and (<= (to_rep2 (first3 (rt1 (rec__very_longs__very_long__long_digits1 (us_split_fields__content1 u__split_fields8))))) divisor_index2) (<= divisor_index2 (to_rep2 (last4 (rt1 (rec__very_longs__very_long__long_digits1 (us_split_fields__content1 u__split_fields8))))))))
(assert (= o13 divisor_index2))
(assert (= o14 (select (elts1 (rec__very_longs__very_long__long_digits1 (us_split_fields__content1 u__split_fields8))) o13)))
(assert (= o15 (to_rep1 o14)))
(assert (= (to_rep1 o16) o15))
(assert (not (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits remainder__split_fields3)))) divisor_index2)))
(check-sat)
(exit)
