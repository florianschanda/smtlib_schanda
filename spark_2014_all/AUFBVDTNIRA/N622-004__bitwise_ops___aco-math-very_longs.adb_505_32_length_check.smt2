...
(assert (not (= (ite (<= (to_rep2 (first9 temp___12941)) (to_rep2 (last10 temp___12941))) (+ (- (to_rep2 (last10 temp___12941)) (to_rep2 (first9 temp___12941))) 1) 0) (ite (<= 1 r135b) (+ (- r135b 1) 1) 0))))
(check-sat)
(exit)
