...
(assert (<= 1 index1))
(assert (<= index1 r26b))
(assert (and (and (and (dynamic_invariant2 (mk___rep1 result____split_discrs result____split_fields3) false true true true) (forall ((temp___1131 Int)) (=> (and (<= (to_rep2 (first2 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields3)))) temp___1131) (<= temp___1131 (to_rep2 (last2 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields3)))))) (=> (<= index2 temp___1131) (= (select (elts1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields3)) temp___1131) (select (elts1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields2)) temp___1131)))))) (=> (<= 0 2147483647) (in_range1 temp2))) (and (<= 1 index2) (<= index2 r26b))))
(assert (and (= o4 (mod1 temp2 256)) (uint_in_range (mod1 temp2 256))))
(assert (= o5 ((_ int2bv 8) o4)))
(assert (= (to_rep o6) o5))
(assert (and (<= (to_rep2 (first2 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields3)))) index2) (<= index2 (to_rep2 (last2 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields3)))))))
(assert (= o7 index2))
(assert (= o8 (store (elts1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields3)) o7 o6)))
(assert (= o9 (mk___t1 o8 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields3)))))
(assert (= o10 (mk___split_fields1 o9)))
(assert (= temp___1128 (mk___rep1 result____split_discrs o10)))
(assert (= result3 (mk___split_fields__ref1 result____split_fields3)))
(assert (= result____split_fields4 (us_split_fields3 temp___1128)))
(assert (= result____split_discrs (us_split_discrs2 temp___1128)))
