...
(define-fun dynamic_invariant1 ((temp___expr_223 Int) (temp___is_init_219 Bool) (temp___skip_constant_220 Bool) (temp___do_toplevel_221 Bool) (temp___do_typ_inv_222 Bool)) Bool (=> (or (= temp___is_init_219 true) (<= 1 2147483647)) (in_range2 temp___expr_223)))
...
(declare-fun temp_____aggregate_def_889 ((_ BitVec 8) Int Int) us_t2)
...
(assert (= (to_rep1 (first4 (rt2 (temp_____aggregate_def_889 #x00 1 octet_length)))) 1))
(assert (= (to_rep1 (last4 (rt2 (temp_____aggregate_def_889 #x00 1 octet_length)))) octet_length))
(assert (= (mk___t2 temp___896 temp___8961) (temp_____aggregate_def_889 #x00 1 octet_length)))
(assert (= (ite (<= (to_rep1 (first4 temp___8961)) (to_rep1 (last4 temp___8961))) (+ (- (to_rep1 (last4 temp___8961)) (to_rep1 (first4 temp___8961))) 1) 0) (ite (<= 1 octet_length) (+ (- octet_length 1) 1) 0)))
(assert (= temp___896 temp___897))
(assert (= (mk1 (to_rep1 (first4 temp___8961)) (to_rep1 (last4 temp___8961))) temp___8971))
(assert (= (ite (<= (to_rep1 (first2 temp___8971)) (to_rep1 (last2 temp___8971))) (+ (- (to_rep1 (last2 temp___8971)) (to_rep1 (first2 temp___8971))) 1) 0) (ite (<= (to_rep1 (first2 result____split_fields1)) (to_rep1 (last2 result____split_fields1))) (+ (- (to_rep1 (last2 result____split_fields1)) (to_rep1 (first2 result____split_fields1))) 1) 0)))
...
(assert (= temp1 number))
(assert (= (to_rep1 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields2)))) r28b))
(assert (in_range3 r28b))
(assert (= result2 (mk_int__ref index)))
(assert (= index1 1))
(assert (<= 1 index1))
(assert (<= index1 r28b))
(assert (and (and (and (dynamic_invariant2 (mk___rep1 result____split_discrs result____split_fields3) false true true true) (forall ((temp___908 Int)) (=> (and (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))) temp___908) (<= temp___908 (to_rep1 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))))) (=> (or (< r28b temp___908) (or (< temp___908 1) (<= index2 temp___908))) (= (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields3)) temp___908) (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields2)) temp___908)))))) (=> (<= 0 2147483647) (in_range1 temp2))) (and (<= 1 index2) (<= index2 r28b))))
