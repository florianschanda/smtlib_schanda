...
(define-fun dynamic_invariant1 ((temp___expr_223 Int) (temp___is_init_219 Bool) (temp___skip_constant_220 Bool) (temp___do_toplevel_221 Bool) (temp___do_typ_inv_222 Bool)) Bool (=> (or (= temp___is_init_219 true) (<= 1 2147483647)) (in_range3 temp___expr_223)))
...
(declare-datatypes () ((tT25bP1__ref (mk_tT25bP1__ref (tT25bP1__content tdigit_index_typeB)))))
(define-fun tT25bP1__ref___projection ((a tT25bP1__ref)) tdigit_index_typeB (tT25bP1__content a))
(declare-sort t1 0)
...
(define-fun of_base ((r us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r) (mk___split_fields1 (let ((temp___163 (rec__very_longs__very_long__long_digits (us_split_fields1 r)))) (of_array1 (to_array temp___163) (first1 temp___163) (last1 temp___163))))))
...
(define-fun dynamic_invariant2 ((temp___expr_428 us_rep1) (temp___is_init_424 Bool) (temp___skip_constant_425 Bool) (temp___do_toplevel_426 Bool) (temp___do_typ_inv_427 Bool)) Bool (and (=> (not (= temp___skip_constant_425 true)) (in_range4 octet_length (to_base temp___expr_428))) (and (dynamic_property3 1 octet_length (first3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_428))) (last3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_428)))) (and (= (first3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_428))) 1) (= (last3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_428))) octet_length)))))
(define-fun default_initial_assumption ((temp___expr_431 us_rep1) (temp___skip_top_level_432 Bool)) Bool (= (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs2 temp___expr_431))) octet_length))
...
(declare-datatypes () ((t26b__ref (mk_t26b__ref (t26b__content tdigit_index_typeB)))))
(define-fun t26b__ref___projection ((a t26b__ref)) tdigit_index_typeB (t26b__content a))
(declare-sort t2 0)
...
(declare-fun temp___889 ((_ BitVec 8) Int Int) us_t2)
...
(assert (forall ((temp___891 (_ BitVec 8))) (forall ((temp___892 Int) (temp___893 Int)) (let ((temp___890 (temp___889 temp___891 temp___892 temp___893))) (=> (dynamic_invariant3 temp___891 true true true true) (and (=> (dynamic_property6 1 2147483647 temp___892 temp___893) (and (= (first5 temp___890) temp___892) (= (last5 temp___890) temp___893))) (forall ((temp___894 Int)) (= (to_rep1 (select (to_array2 temp___890) temp___894)) temp___891))))))))
(define-fun dynamic_invariant4 ((temp___expr_237 us_t3) (temp___is_init_233 Bool) (temp___skip_constant_234 Bool) (temp___do_toplevel_235 Bool) (temp___do_typ_inv_236 Bool)) Bool (=> (not (= temp___skip_constant_234 true)) (dynamic_property6 1 2147483647 (first7 temp___expr_237) (last7 temp___expr_237))))
(define-fun dynamic_invariant5 ((temp___expr_243 us_rep) (temp___is_init_239 Bool) (temp___skip_constant_240 Bool) (temp___do_toplevel_241 Bool) (temp___do_typ_inv_242 Bool)) Bool (let ((temp___244 (rec__very_longs__very_long__octet_length (us_split_discrs1 temp___expr_243)))) (and (dynamic_property1 1 (to_rep temp___244) (first1 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_243))) (last1 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_243)))) (and (= (first1 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_243))) 1) (= (last1 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_243))) (to_rep temp___244))))))
...
(declare-const temp___897 (Array Int octet))
(declare-const temp___8971 t1)
(declare-const o (Array Int octet))
(declare-const o1 t1)
(declare-const o2 (Array Int octet))
(declare-const o3 t1)
(declare-const temp___900 digit_index_type)
(declare-const temp___9001 (Array Int octet))
(declare-const temp___9002 t1)
...
(assert (in_range3 octet_length))
(assert (and (= us octet_length) (in_range3 octet_length)))
(assert (= (to_rep (rec__very_longs__very_long__octet_length result____split_discrs)) octet_length))
...
(assert (= (to_rep2 (first4 (rt2 (temp___889 #x00 1 octet_length)))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___889 #x00 1 octet_length)))) octet_length))
(assert (= (mk___t2 temp___896 temp___8961) (temp___889 #x00 1 octet_length)))
(assert (= (ite (<= (to_rep2 (first4 temp___8961)) (to_rep2 (last4 temp___8961))) (+ (- (to_rep2 (last4 temp___8961)) (to_rep2 (first4 temp___8961))) 1) 0) (ite (<= 1 octet_length) (+ (- octet_length 1) 1) 0)))
(assert (= temp___896 temp___897))
(assert (= (mk1 (to_rep2 (first4 temp___8961)) (to_rep2 (last4 temp___8961))) temp___8971))
(assert (= (ite (<= (to_rep2 (first2 temp___8971)) (to_rep2 (last2 temp___8971))) (+ (- (to_rep2 (last2 temp___8971)) (to_rep2 (first2 temp___8971))) 1) 0) (ite (<= (to_rep2 (first2 result____split_fields1)) (to_rep2 (last2 result____split_fields1))) (+ (- (to_rep2 (last2 result____split_fields1)) (to_rep2 (first2 result____split_fields1))) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___897 temp___8971)))
(assert (= o2 o))
(assert (= o3 o1))
(assert (= result____split_discrs (mk___split_discrs temp___900)))
(assert (= temp___9001 o2))
(assert (= temp___9002 o3))
(assert (= result (mk___split_fields__ref1 (mk___split_fields1 (mk___t1 result____split_fields result____split_fields1)))))
(assert (= result____split_fields2 (mk___split_fields1 (mk___t1 temp___9001 temp___9002))))
(assert (= result____split_discrs (mk___split_discrs temp___900)))
(assert (= result1 (mk_int__ref temp)))
(assert (= temp1 number))
(assert (= (to_rep2 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields2)))) r28b))
(assert (in_range2 r28b))
(assert (= result2 (mk_int__ref index)))
(assert (= index1 1))
(assert (<= 1 index1))
(assert (<= index1 r28b))
(assert (and (and (and (dynamic_invariant2 (mk___rep1 result____split_discrs result____split_fields3) false true true true) (forall ((temp___906 Int)) (=> (and (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))) temp___906) (<= temp___906 (to_rep2 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))))) (=> (<= index2 temp___906) (= (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields3)) temp___906) (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields2)) temp___906)))))) (=> (<= 0 2147483647) (in_range1 temp2))) (and (<= 1 index2) (<= index2 r28b))))
