...
(define-fun dynamic_invariant1 ((temp___expr_200 Int) (temp___is_init_197 Bool) (temp___skip_constant_198 Bool) (temp___do_toplevel_199 Bool)) Bool (=> (or (= temp___is_init_197 true) (<= 1 2147483647)) (in_range3 temp___expr_200)))
...
(define-fun dynamic_invariant2 ((temp___expr_392 us_rep1) (temp___is_init_389 Bool) (temp___skip_constant_390 Bool) (temp___do_toplevel_391 Bool)) Bool (and (=> (not (= temp___skip_constant_390 true)) (in_range4 octet_length (to_base temp___expr_392))) (and (dynamic_property3 1 octet_length (first3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_392))) (last3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_392)))) (and (= (first3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_392))) 1) (= (last3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_392))) octet_length)))))
(define-fun default_initial_assumption ((temp___expr_395 us_rep1) (temp___skip_top_level_396 Bool)) Bool (= (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs2 temp___expr_395))) octet_length))
...
(declare-fun temp___818 ((_ BitVec 8) Int Int) us_t2)
(assert (forall ((temp___820 (_ BitVec 8))) (forall ((temp___821 Int) (temp___822 Int)) (let ((temp___819 (temp___818 temp___820 temp___821 temp___822))) (and (=> (dynamic_property6 1 2147483647 temp___821 temp___822) (and (= (first5 temp___819) temp___821) (= (last5 temp___819) temp___822))) (forall ((temp___823 Int)) (= (select (to_array2 temp___819) temp___823) (of_rep1 temp___820))))))))
...
(define-fun dynamic_invariant4 ((temp___expr_217 us_rep) (temp___is_init_214 Bool) (temp___skip_constant_215 Bool) (temp___do_toplevel_216 Bool)) Bool (let ((temp___218 (rec__very_longs__very_long__octet_length (us_split_discrs1 temp___expr_217)))) (and (dynamic_property1 1 (to_rep temp___218) (first1 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_217))) (last1 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_217)))) (and (= (first1 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_217))) 1) (= (last1 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_217))) (to_rep temp___218))))))
...
(declare-const temp___826 (Array Int octet))
(declare-const temp___8261 t1)
...
(declare-const temp___836 Int)
(declare-const temp___833 digit_index_type)
(declare-const temp___8331 (Array Int octet))
(declare-const temp___8332 t1)
...
(declare-const temp___832 us_rep1)
...
(assert (= (to_rep2 (first4 (rt2 (temp___818 ((_ int2bv 8) 0) 1 octet_length)))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___818 ((_ int2bv 8) 0) 1 octet_length)))) octet_length))
(assert (= (mk___t2 temp___825 temp___8251) (temp___818 ((_ int2bv 8) 0) 1 octet_length)))
(assert (= (ite (<= (to_rep2 (first4 temp___8251)) (to_rep2 (last4 temp___8251))) (+ (- (to_rep2 (last4 temp___8251)) (to_rep2 (first4 temp___8251))) 1) 0) (ite (<= 1 octet_length) (+ (- octet_length 1) 1) 0)))
(assert (= temp___825 temp___826))
(assert (= (mk1 (to_rep2 (first4 temp___8251)) (to_rep2 (last4 temp___8251))) temp___8261))
(assert (= (ite (<= (to_rep2 (first2 temp___8261)) (to_rep2 (last2 temp___8261))) (+ (- (to_rep2 (last2 temp___8261)) (to_rep2 (first2 temp___8261))) 1) 0) (ite (<= (to_rep2 (first2 result____split_fields1)) (to_rep2 (last2 result____split_fields1))) (+ (- (to_rep2 (last2 result____split_fields1)) (to_rep2 (first2 result____split_fields1))) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___826 temp___8261)))
(assert (= o2 o))
(assert (= o3 o1))
...
(assert (= result____split_fields2 (mk___split_fields1 (mk___t1 temp___8291 temp___8292))))
(assert (= result____split_discrs (mk___split_discrs temp___829)))
...
(assert (<= 1 index1))
(assert (<= index1 r28b))
(assert (and (and (and (dynamic_invariant2 (mk___rep1 result____split_discrs result____split_fields3) false true true) (forall ((temp___835 Int)) (=> (and (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))) temp___835) (<= temp___835 (to_rep2 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))))) (=> (<= index2 temp___835) (= (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields3)) temp___835) (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields2)) temp___835)))))) (=> (<= 0 2147483647) (in_range1 temp2))) (and (<= 1 index2) (<= index2 r28b))))
