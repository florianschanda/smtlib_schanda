...
(assert (= (= result8 true) (forall ((i17 Int)) (=> (and (<= 0 i17) (<= i17 (- length1 1))) (= (= (nth8_stream addr (- (- (+ start length1) i17) 1)) true) (= (nth (t__content bitwalker__peek__result8) i17) true))))))
(assert (= result8 true))
(assert (<= length1 i1))
(assert (<= i1 63))
(assert (and (= o19 i1) (in_range2 i1)))
(assert (not true))
(check-sat)
(exit)
