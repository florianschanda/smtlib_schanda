...
(assert (and (= o3 (max_input_length (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1)))) (and (in_range4 o3) (= o3 (- (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1))) 2)))))
(assert (= result (ite (<= in_data_bit_length o3) true false)))
(assert (= result true))
(assert (and (= o (+ in_data_bit_length 7)) (in_range (+ in_data_bit_length 7))))
(assert (= o1 (div1 o 8)))
(assert (not (in_range (length in_data))))
(check-sat)
(exit)
