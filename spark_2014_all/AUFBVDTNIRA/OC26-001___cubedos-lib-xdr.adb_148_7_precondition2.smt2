...
(declare-fun xdr_unsigned_to_integer__function_guard (Int (_ BitVec 32)) Bool)
...
(define-fun dynamic_invariant2 ((temp___expr_276 (_ BitVec 32)) (temp___is_init_272 Bool) (temp___skip_constant_273 Bool) (temp___do_toplevel_274 Bool) (temp___do_typ_inv_275 Bool)) Bool true)
...
(define-fun dynamic_invariant3 ((temp___expr_283 Int) (temp___is_init_279 Bool) (temp___skip_constant_280 Bool) (temp___do_toplevel_281 Bool) (temp___do_typ_inv_282 Bool)) Bool (=> (or (= temp___is_init_279 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_283)))
(assert (forall ((s (_ BitVec 32))) (! (=> (dynamic_invariant2 s true true true true) (dynamic_invariant3 (xdr_unsigned_to_integer s) true false true true)) :pattern ((xdr_unsigned_to_integer s)))))
(declare-sort xdr_integer 0)
(declare-fun xdr_integerqtint (xdr_integer) Int)
(assert (forall ((i xdr_integer)) (and (<= (- 2147483648) (xdr_integerqtint i)) (<= (xdr_integerqtint i) 2147483647))))
...
(declare-datatypes () ((xdr_integer__ref (mk_xdr_integer__ref (xdr_integer__content xdr_integer)))))
(define-fun xdr_integer__ref___projection ((a xdr_integer__ref)) xdr_integer (xdr_integer__content a))
...
(assert (=> (<= (- 2147483648) 2147483647) (in_range4 value)))
(assert (=> (<= 0 65535) (in_range1 last2)))
(assert (and (and (and (= (mod1 position 4) 0) (= (mod1 (length data) 4) 0)) (and (<= (to_rep (first (rt data))) position) (<= position (to_rep (last (rt data)))))) (<= (+ position 3) (to_rep (last (rt data))))))
