...
(declare-const value2 (_ BitVec 16))
...
(assert (= o5 ((_ int2bv 16) o4)))
(assert (and (= temp___743 (- (to_rep1 (last (rt buffer))) i1)) (in_range1 (- (to_rep1 (last (rt buffer))) i1))))
(assert (and (<= (to_rep1 (first (rt buffer))) temp___743) (<= temp___743 (to_rep1 (last (rt buffer))))))
(assert (= o temp___743))
(assert (= o1 (select (elts buffer) o)))
(assert (= o2 (to_rep o1)))
(assert (= o6 ((_ zero_extend 8) o2)))
...
(assert (= result3 i1))
(assert (= i2 1))
(assert (not (in_range2 (power 256 i2))))
(check-sat)
(exit)
