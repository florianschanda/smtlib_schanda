...
(assert (<= 0 n))
(assert (<= n (- h2 1)))
(assert (and (= o196 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o197 (num_of_big_int m m_first o196)))
(assert (and (= o193 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (and (= o192 (base Tuple0)) (= o192 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o194 (oexpon o192 o193)))
(assert (and (= o187 (* 2 n)) (in_range1 (* 2 n))))
(assert (= o188 (+ o187 1)))
(assert (and (= o189 o188) (in_range1 o188)))
(assert (and (= o190 o189) (in_range2 o189)))
(assert (and (= o185 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o186 (num_of_big_int x x_first o185)))
(assert (= o191 (oexpon o186 o190)))
(assert (= o195 (omultiply o191 o194)))
(assert (= o198 (omod o195 o197)))
(assert (and (= o184 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (and (= o178 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o179 (* n o178)))
(assert (and (= o180 o179) (in_range1 o179)))
(assert (= o181 (+ aux4_first o180)))
(assert (and (= o182 o181) (in_range1 o181)))
(assert (not (in_range2 o182)))
(check-sat)
(exit)
