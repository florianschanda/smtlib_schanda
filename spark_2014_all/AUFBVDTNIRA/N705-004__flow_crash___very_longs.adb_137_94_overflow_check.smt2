...
(define-fun dynamic_invariant2 ((temp___expr_200 Int) (temp___is_init_197 Bool) (temp___skip_constant_198 Bool) (temp___do_toplevel_199 Bool)) Bool (=> (or (= temp___is_init_197 true) (<= 1 2147483647)) (in_range5 temp___expr_200)))
...
(define-fun dynamic_invariant4 ((temp___expr_217 us_rep) (temp___is_init_214 Bool) (temp___skip_constant_215 Bool) (temp___do_toplevel_216 Bool)) Bool (let ((temp___218 (rec__very_longs__very_long__octet_length (us_split_discrs1 temp___expr_217)))) (and (dynamic_property2 1 (to_rep2 temp___218) (first3 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_217))) (last3 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_217)))) (and (= (first3 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_217))) 1) (= (last3 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_217))) (to_rep2 temp___218))))))
...
(assert (forall ((temp___843 (_ BitVec 8))) (forall ((temp___844 Int) (temp___845 Int)) (let ((temp___842 (temp___841 temp___843 temp___844 temp___845))) (and (=> (dynamic_property7 1 2147483647 temp___844 temp___845) (and (= (first7 temp___842) temp___844) (= (last7 temp___842) temp___845))) (forall ((temp___846 Int)) (= (select (to_array3 temp___842) temp___846) (of_rep3 temp___843))))))))
...
(define-fun dynamic_invariant7 ((temp___expr_413 us_t2) (temp___is_init_410 Bool) (temp___skip_constant_411 Bool) (temp___do_toplevel_412 Bool)) Bool (=> (not (= temp___skip_constant_411 true)) (and (dynamic_property4 1 r33b (first5 temp___expr_413) (last5 temp___expr_413)) (and (= (first5 temp___expr_413) 1) (= (last5 temp___expr_413) r33b)))))
...
(assert (= (to_rep4 (first6 (rt3 (temp___841 ((_ int2bv 8) 0) 1 r33b)))) 1))
(assert (= (to_rep4 (last6 (rt3 (temp___841 ((_ int2bv 8) 0) 1 r33b)))) r33b))
(assert (= (mk___t3 temp___848 temp___8481) (temp___841 ((_ int2bv 8) 0) 1 r33b)))
(assert (= (ite (<= (to_rep4 (first6 temp___8481)) (to_rep4 (last6 temp___8481))) (+ (- (to_rep4 (last6 temp___8481)) (to_rep4 (first6 temp___8481))) 1) 0) (ite (<= 1 r33b) (+ (- r33b 1) 1) 0)))
(assert (= temp___848 temp___849))
(assert (= (mk2 (to_rep4 (first6 temp___8481)) (to_rep4 (last6 temp___8481))) temp___8491))
(assert (= (ite (<= (to_rep4 (first4 temp___8491)) (to_rep4 (last4 temp___8491))) (+ (- (to_rep4 (last4 temp___8491)) (to_rep4 (first4 temp___8491))) 1) 0) (ite (<= (to_rep4 (first2 result____split_fields1)) (to_rep4 (last2 result____split_fields1))) (+ (- (to_rep4 (last2 result____split_fields1)) (to_rep4 (first2 result____split_fields1))) 1) 0)))
(assert (= (mk___t2 temp___851 temp___8511) (mk___t2 temp___849 temp___8491)))
(assert (= temp___851 o2))
(assert (= (mk1 (to_rep4 (first4 temp___8511)) (to_rep4 (last4 temp___8511))) o3))
(assert (= o4 o2))
(assert (= o5 o3))
(assert (= result____split_discrs (mk___split_discrs temp___853)))
(assert (= temp___8531 o4))
(assert (= temp___8532 o5))
(assert (= result (mk___split_fields__ref (mk___split_fields (mk___t1 result____split_fields result____split_fields1)))))
(assert (= result____split_fields2 (mk___split_fields (mk___t1 temp___8531 temp___8532))))
(assert (= result____split_discrs (mk___split_discrs temp___853)))
(assert (= result1 (mk_bool__ref valid)))
(assert (= valid1 (of_int 1)))
(assert (and (= o6 (to_rep4 (last2 (rt1 (rec__very_longs__very_long__long_digits result____split_fields2))))) (in_range5 (to_rep4 (last2 (rt1 (rec__very_longs__very_long__long_digits result____split_fields2)))))))
...
(assert (and (= o8 (- (to_rep4 (last2 (rt1 (rec__very_longs__very_long__long_digits result____split_fields3)))) index2)) (in_range4 (- (to_rep4 (last2 (rt1 (rec__very_longs__very_long__long_digits result____split_fields3)))) index2))))
(assert (= o9 (* 2 o8)))
