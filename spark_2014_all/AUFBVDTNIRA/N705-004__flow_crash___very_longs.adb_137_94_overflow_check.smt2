...
(define-fun dynamic_invariant2 ((temp___expr_223 Int) (temp___is_init_219 Bool) (temp___skip_constant_220 Bool) (temp___do_toplevel_221 Bool) (temp___do_typ_inv_222 Bool)) Bool (=> (or (= temp___is_init_219 true) (<= 1 2147483647)) (in_range5 temp___expr_223)))
...
(declare-fun temp___912 ((_ BitVec 8) Int Int) us_t3)
...
(assert (forall ((temp___914 (_ BitVec 8))) (forall ((temp___915 Int) (temp___916 Int)) (let ((temp___913 (temp___912 temp___914 temp___915 temp___916))) (=> (dynamic_invariant3 temp___914 true true true true) (and (=> (dynamic_property7 1 2147483647 temp___915 temp___916) (and (= (first7 temp___913) temp___915) (= (last7 temp___913) temp___916))) (forall ((temp___917 Int)) (= (to_rep3 (select (to_array3 temp___913) temp___917)) temp___914))))))))
...
(assert (= (to_rep4 (first6 (rt3 (temp___912 #x00 1 r33b)))) 1))
(assert (= (to_rep4 (last6 (rt3 (temp___912 #x00 1 r33b)))) r33b))
(assert (= (mk___t3 temp___919 temp___9191) (temp___912 #x00 1 r33b)))
(assert (= (ite (<= (to_rep4 (first6 temp___9191)) (to_rep4 (last6 temp___9191))) (+ (- (to_rep4 (last6 temp___9191)) (to_rep4 (first6 temp___9191))) 1) 0) (ite (<= 1 r33b) (+ (- r33b 1) 1) 0)))
(assert (= temp___919 temp___920))
(assert (= (mk2 (to_rep4 (first6 temp___9191)) (to_rep4 (last6 temp___9191))) temp___9201))
(assert (= (ite (<= (to_rep4 (first4 temp___9201)) (to_rep4 (last4 temp___9201))) (+ (- (to_rep4 (last4 temp___9201)) (to_rep4 (first4 temp___9201))) 1) 0) (ite (<= (to_rep4 (first2 result____split_fields1)) (to_rep4 (last2 result____split_fields1))) (+ (- (to_rep4 (last2 result____split_fields1)) (to_rep4 (first2 result____split_fields1))) 1) 0)))
(assert (= (mk___t2 temp___922 temp___9221) (mk___t2 temp___920 temp___9201)))
(assert (= temp___922 o))
(assert (= (mk1 (to_rep4 (first4 temp___9221)) (to_rep4 (last4 temp___9221))) o1))
(assert (= o2 o))
(assert (= o3 o1))
...
(assert (and (= o4 (to_rep4 (last2 (rt1 (rec__very_longs__very_long__long_digits result____split_fields2))))) (in_range5 (to_rep4 (last2 (rt1 (rec__very_longs__very_long__long_digits result____split_fields2)))))))
...
(assert (= string_index2 (+ (* 2 (- (to_rep4 (last2 (rt1 (rec__very_longs__very_long__long_digits result____split_fields3)))) index2)) 1)))
...
(assert (and (= o6 (- (to_rep4 (last2 (rt1 (rec__very_longs__very_long__long_digits result____split_fields3)))) index2)) (in_range4 (- (to_rep4 (last2 (rt1 (rec__very_longs__very_long__long_digits result____split_fields3)))) index2))))
(assert (= o7 (* 2 o6)))
