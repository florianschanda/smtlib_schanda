...
(assert (and (= o19 (rate_of (mk___rep ctx__split_fields35))) (and (in_range3 o19) (and (= o19 (* (to_rep6 ctx__split_fields10) 8)) (< o19 1600)))))
(assert (= o20 (ite (= o19 initial_rate1) true false)))
(assert (and (= o16 (rate_of (mk___rep ctx__split_fields35))) (and (in_range3 o16) (and (= o16 (* (to_rep6 ctx__split_fields10) 8)) (< o16 1600)))))
(assert (and (= o17 (in_queue_bit_length (mk___rep ctx__split_fields35))) (and (in_range2 o17) (and (= o17 (to_rep5 ctx__split_fields8)) (< o17 1600)))))
...
(assert (and (= o13 (in_queue_bit_length (mk___rep ctx__split_fields35))) (and (in_range2 o13) (and (= o13 (to_rep5 ctx__split_fields8)) (< o13 1600)))))
(assert (not (not (= 8 0))))
(check-sat)
(exit)
