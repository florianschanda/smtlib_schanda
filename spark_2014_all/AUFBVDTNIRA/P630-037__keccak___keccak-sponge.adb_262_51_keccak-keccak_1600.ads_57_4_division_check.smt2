...
(assert (= o83 (mod2 o82 8)))
(assert (and (= o81 (in_queue_bit_length (mk___rep (mk___split_fields ctx__split_fields12 ctx__split_fields13 ctx__split_fields14 ctx__split_fields15 ctx__split_fields16 ctx__split_fields17)))) (and (in_range2 o81) (and (= o81 (to_rep5 ctx__split_fields14)) (< o81 1600)))))
(assert (not (not (= 8 0))))
(check-sat)
(exit)
