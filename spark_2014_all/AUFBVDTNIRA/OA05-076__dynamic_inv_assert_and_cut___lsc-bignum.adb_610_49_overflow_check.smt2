...
(assert (and (= o66 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (and (= o67 o66) (uint_in_range1 o66)))
(assert (= o68 ((_ int2bv 64) o67)))
(assert (= o69 (bvadd o68 ((_ int2bv 64) 1))))
(assert (= o70 (bvmul o69 ((_ int2bv 64) 32))))
(assert (= o71 (ite (bvult i2 o70) true false)))
(assert (= o63 (from_word32 ((_ int2bv 32) 1))))
(assert (= o62 (from_word64 i2)))
(assert (= o64 (oadd o62 o63)))
(assert (= o61 (from_integer s10)))
(assert (= o65 (ole o61 o64)))
(assert (and (= o59 (+ k 1)) (in_range1 (+ k 1))))
(assert (= o60 (ite (<= s10 o59) true false)))
(assert (= o55 (from_word32 ((_ int2bv 32) 2))))
(assert (= o56 (oexpon o55 s10)))
(assert (= o50 (from_word32 ((_ int2bv 32) 1))))
(assert (= o49 (from_integer s10)))
(assert (= o51 (osubtract o49 o50)))
(assert (= o48 (from_word64 i2)))
(assert (= o52 (osubtract o48 o51)))
(assert (= o47 (from_word32 ((_ int2bv 32) 2))))
(assert (= o53 (oexpon__2 o47 o52)))
(assert (and (= o42 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (= o43 (+ o42 1)))
(assert (and (= o44 o43) (in_range1 o43)))
(assert (and (= o45 o44) (in_range2 o44)))
(assert (= o46 (num_of_big_int e e_first o45)))
(assert (= o54 (odivide o46 o53)))
(assert (= o57 (omod o54 o56)))
(assert (= o41 (from_word32 (t__content w7))))
(assert (= o58 (oeq o41 o57)))
(assert (and (= o36 (power 2 k)) (in_range1 (power 2 k))))
(assert (= o37 (- o36 1)))
(assert (and (= o38 o37) (in_range1 o37)))
(assert (= o39 (ite (<= n o38) true false)))
(assert (= result8 (ite (<= 0 n) o39 false)))
(assert (= (= o40 true) (forall ((n1 Int)) (=> (and (<= 0 n1) (<= n1 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux45) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n1 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))))
(assert (and (= o32 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o33 (num_of_big_int m m_first o32)))
(assert (and (= o29 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (and (= o28 (base Tuple0)) (= o28 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o30 (oexpon o28 o29)))
(assert (= o24 (from_word32 ((_ int2bv 32) 2))))
(assert (= o25 (oexpon o24 (- h9 1))))
(assert (= o20 (from_word32 ((_ int2bv 32) 1))))
(assert (= o19 (from_word64 i2)))
(assert (= o21 (oadd o19 o20)))
(assert (= o18 (from_word32 ((_ int2bv 32) 2))))
(assert (= o22 (oexpon__2 o18 o21)))
(assert (and (= o13 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (= o14 (+ o13 1)))
(assert (and (= o15 o14) (in_range1 o14)))
(assert (and (= o16 o15) (in_range2 o15)))
(assert (= o17 (num_of_big_int e e_first o16)))
(assert (= o23 (odivide o17 o22)))
(assert (= o26 (omultiply o23 o25)))
(assert (and (= o11 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o12 (num_of_big_int x x_first o11)))
(assert (= o27 (oexpon__2 o12 o26)))
(assert (= o31 (omultiply o27 o30)))
(assert (= o34 (omod o31 o33)))
(assert (and (= o9 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o10 (num_of_big_int (mk___t aux32 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first o9)))
(assert (= o35 (oeq o10 o34)))
