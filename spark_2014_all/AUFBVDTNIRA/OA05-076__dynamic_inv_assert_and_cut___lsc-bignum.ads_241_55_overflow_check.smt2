...
(assert (= o84 (ite (<= o83 (to_rep (last (rt x)))) true false)))
(assert (and (= o78 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o79 (+ x_first o78)))
(assert (and (= o80 o79) (in_range1 o79)))
(assert (= o85 (ite (<= (to_rep (first (rt x))) o80) true false)))
(assert (= result (ite (= o85 true) o84 false)))
(assert (= result true))
...
(assert (= o76 (ite (<= o75 (to_rep (last (rt m)))) true false)))
(assert (and (= o70 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o71 (+ m_first o70)))
(assert (and (= o72 o71) (in_range1 o71)))
(assert (= o77 (ite (<= (to_rep (first (rt m))) o72) true false)))
(assert (= result1 (ite (= o77 true) o76 false)))
(assert (= result1 true))
...
(assert (= o68 (ite (<= o67 (to_rep aux1__last)) true false)))
(assert (and (= o62 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o63 (+ aux1_first o62)))
(assert (and (= o64 o63) (in_range1 o63)))
(assert (= o69 (ite (<= (to_rep aux1__first) o64) true false)))
(assert (= result2 (ite (= o69 true) o68 false)))
(assert (= result2 true))
...
(assert (= o60 (ite (<= o59 (to_rep aux2__last)) true false)))
(assert (and (= o54 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o55 (+ aux2_first o54)))
(assert (and (= o56 o55) (in_range1 o55)))
(assert (= o61 (ite (<= (to_rep aux2__first) o56) true false)))
(assert (= result3 (ite (= o61 true) o60 false)))
(assert (= result3 true))
...
(assert (= o52 (ite (<= o51 (to_rep aux3__last)) true false)))
(assert (and (= o46 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o47 (+ aux3_first o46)))
(assert (and (= o48 o47) (in_range1 o47)))
(assert (= o53 (ite (<= (to_rep aux3__first) o48) true false)))
(assert (= result4 (ite (= o53 true) o52 false)))
(assert (= result4 true))
...
(assert (= o42 (+ aux4_first o41)))
(assert (and (= o43 o42) (in_range1 o42)))
(assert (= o44 (ite (<= o43 (to_rep aux4__last)) true false)))
(assert (and (= o24 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o25 (+ o24 1)))
(assert (and (= o26 o25) (in_range1 o25)))
(assert (and (= o27 (power 2 k)) (in_range1 (power 2 k))))
(assert (= o28 (* o27 o26)))
(assert (and (= o29 o28) (in_range1 o28)))
(assert (= o30 (- o29 1)))
(assert (and (= o31 o30) (in_range1 o30)))
(assert (= o32 (+ aux4_first o31)))
(assert (and (= o33 o32) (in_range1 o32)))
(assert (= o45 (ite (<= (to_rep aux4__first) o33) true false)))
(assert (= result5 (ite (= o45 true) o44 false)))
(assert (= result5 true))
(assert (<= k 30))
...
(assert (= o22 (ite (<= o21 (to_rep (last (rt r)))) true false)))
(assert (and (= o16 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o17 (+ r_first o16)))
(assert (and (= o18 o17) (in_range1 o17)))
(assert (= o23 (ite (<= (to_rep (first (rt r))) o18) true false)))
...
(assert (= o7 (from_integer o6)))
(assert (= o3 (from_integer 2)))
(assert (= o8 (omultiply o3 o7)))
(assert (and (= o2 (base Tuple0)) (= o2 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o9 (oexpon__2 o2 o8)))
(assert (= o15 (omod o9 o14)))
