...
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= temp___742 o81))))
...
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= o85 (mk_map__ref o84)))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= h10 (mk_int__ref h9)))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= aux3 (mk_map__ref o84)))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= a7 (mk_map__ref o83)))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= h11 h9))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= o86 o84))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= a8 o83))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= o87 o85))))
...
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= o88 o86))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= a10 a8))))
(assert (=> (= result2 true) (=> (not (and (<= 1 h8) (<= h8 r94b))) (= o87 (mk_map__ref o81)))))
(assert (=> (= result2 true) (=> (not (and (<= 1 h8) (<= h8 r94b))) (= h12 (mk_int__ref h8)))))
(assert (=> (= result2 true) (=> (not (and (<= 1 h8) (<= h8 r94b))) (= aux31 (mk_map__ref o81)))))
(assert (=> (= result2 true) (=> (not (and (<= 1 h8) (<= h8 r94b))) (= a9 (mk_map__ref a6)))))
(assert (=> (= result2 true) (=> (not (and (<= 1 h8) (<= h8 r94b))) (= h13 h8))))
(assert (=> (= result2 true) (=> (not (and (<= 1 h8) (<= h8 r94b))) (= o88 o81))))
...
(assert (=> (not (= result2 true)) (= aux32 (mk_map__ref o92))))
(assert (=> (not (= result2 true)) (= a11 (mk_map__ref o91))))
(assert (=> (not (= result2 true)) (= h15 h7)))
(assert (=> (not (= result2 true)) (= w10 w)))
(assert (=> (not (= result2 true)) (= s13 s11)))
(assert (=> (not (= result2 true)) (= j11 j1)))
(assert (=> (not (= result2 true)) (= o94 o92)))
(assert (=> (not (= result2 true)) (= a12 o91)))
...
(assert (= o59 (from_integer (int__content s12))))
(assert (= o63 (ole o59 o62)))
(assert (and (= o54 (power 2 k)) (in_range1 (power 2 k))))
(assert (= o55 (- o54 1)))
(assert (and (= o56 o55) (in_range1 o55)))
(assert (= o57 (ite (<= n o56) true false)))
(assert (= result9 (ite (<= 0 n) o57 false)))
(assert (= (= o58 true) (forall ((n1 Int)) (=> (and (<= 0 n1) (<= n1 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux41) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n1 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))))
(assert (and (= o50 (+ l1 1)) (in_range1 (+ l1 1))))
...
(assert (= o44 (odivide o36 o43)))
(assert (and (= o30 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o31 (num_of_big_int x x_first o30)))
(assert (= o45 (oexpon__2 o31 o44)))
(assert (= o49 (omultiply o45 o48)))
(assert (= o52 (omod o49 o51)))
(assert (and (= o28 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o29 (num_of_big_int (mk___t (map__content aux32) (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first o28)))
(assert (= o53 (oeq o29 o52)))
