...
(define-fun dynamic_invariant3 ((temp___expr_706 (_ BitVec 16)) (temp___is_init_702 Bool) (temp___skip_constant_703 Bool) (temp___do_toplevel_704 Bool) (temp___do_typ_inv_705 Bool)) Bool true)
...
(assert (= o3 (ite (<= o2 16) true false)))
