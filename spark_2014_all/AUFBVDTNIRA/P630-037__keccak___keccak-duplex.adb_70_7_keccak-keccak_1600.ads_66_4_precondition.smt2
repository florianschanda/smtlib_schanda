...
(assert (= o22 block3))
(assert (= o22 temp___1067))
(assert (= (mk4 0 r179s) temp___10671))
(assert (= temp___1067 o23))
(assert (= (mk (to_rep (first8 temp___10671)) (to_rep (last8 temp___10671))) o24))
(assert true)
(assert (= (mk___split_fields__ref (mk___split_fields result6 result7)) (mk___split_fields__ref (mk___split_fields ctx__split_fields ctx__split_fields1))))
...
(assert (= result8 ctx__split_fields2))
(assert (= result9 ctx__split_fields3))
