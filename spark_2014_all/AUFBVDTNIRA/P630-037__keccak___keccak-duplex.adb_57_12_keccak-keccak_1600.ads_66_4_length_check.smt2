...
(assert (< 0 num_bytes))
(assert (and (= temp___1054 (+ (to_rep (first (rt in_data))) (- num_bytes 1))) (in_range (+ (to_rep (first (rt in_data))) (- num_bytes 1)))))
(assert (=> (<= (to_rep (first (rt in_data))) temp___1054) (and (and (<= (to_rep (first (rt in_data))) (to_rep (first (rt in_data)))) (<= (to_rep (first (rt in_data))) (to_rep (last (rt in_data))))) (and (<= (to_rep (first (rt in_data))) temp___1054) (<= temp___1054 (to_rep (last (rt in_data))))))))
(assert (= o11 (elts in_data)))
(assert (= o11 temp___1055))
(assert (= (mk2 (to_rep (first (rt in_data))) temp___1054) temp___10551))
(assert (= (ite (<= (to_rep (first4 temp___10551)) (to_rep (last4 temp___10551))) (+ (- (to_rep (last4 temp___10551)) (to_rep (first4 temp___10551))) 1) 0) (ite (<= 0 (- num_bytes 1)) (+ (- (- num_bytes 1) 0) 1) 0)))
(assert (= (slide temp___1055 (to_rep (first4 temp___10551)) 0) temp___1056))
(assert (= (mk1 0 (- num_bytes 1)) temp___10561))
(assert (=> (<= 0 (- num_bytes 1)) (and (and (<= 0 0) (<= 0 199)) (and (<= 0 (- num_bytes 1)) (<= (- num_bytes 1) 199)))))
(assert (= o12 block1))
(assert (= o12 temp___1059))
(assert (= (mk1 0 (- num_bytes 1)) temp___10591))
(assert (not (= (ite (<= (to_rep (first2 temp___10561)) (to_rep (last2 temp___10561))) (+ (- (to_rep (last2 temp___10561)) (to_rep (first2 temp___10561))) 1) 0) (ite (<= (to_rep (first2 temp___10591)) (to_rep (last2 temp___10591))) (+ (- (to_rep (last2 temp___10591)) (to_rep (first2 temp___10591))) 1) 0))))
(check-sat)
(exit)
