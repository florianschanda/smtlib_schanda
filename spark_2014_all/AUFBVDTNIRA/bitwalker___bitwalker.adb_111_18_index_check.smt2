...
(assert (and (= o3 (pokebit8 o2 (mod1 left 8) flag)) (and (forall ((i Int)) (=> (and (<= 0 i) (<= i 7)) (=> (not (= i (- 7 (mod1 left 8)))) (= (= (nth o3 i) true) (= (nth o2 i) true))))) (= (= (nth o3 (- 7 (mod1 left 8))) true) (= flag true)))))
(assert (= (to_rep1 o4) o3))
(assert (not (<= (div1 left 8) (to_rep addr__last))))
(check-sat)
(exit)
