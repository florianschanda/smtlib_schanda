...
(define-fun dynamic_invariant1 ((temp___expr_208 us_t) (temp___is_init_205 Bool) (temp___skip_constant_206 Bool) (temp___do_toplevel_207 Bool)) Bool (=> (not (= temp___skip_constant_206 true)) (dynamic_property 0 2147483646 (first1 temp___expr_208) (last1 temp___expr_208))))
(assert true)
...
(define-fun dynamic_invariant2 ((temp___expr_160 (_ BitVec 8)) (temp___is_init_157 Bool) (temp___skip_constant_158 Bool) (temp___do_toplevel_159 Bool)) Bool true)
...
(assert (forall ((byte (_ BitVec 8))) (forall ((left Int)) (forall ((flag Bool)) (! (=> (and (and (dynamic_invariant2 byte true true true) (dynamic_invariant left true true true)) (< left 8)) (let ((result (pokebit8 byte left flag))) (and (and (forall ((i Int)) (=> (and (<= 0 i) (<= i 7)) (=> (not (= i (- 7 left))) (= (= (nth result i) true) (= (nth byte i) true))))) (= (= (nth result (- 7 left)) true) (= flag true))) (dynamic_invariant2 result true false true)))) :pattern ((pokebit8 byte left flag)))))))
...
(declare-const o8 (Array Int unsigned_8))
...
(assert (and (<= (to_rep addr__first) (div1 left 8)) (<= (div1 left 8) (to_rep addr__last))))
(assert (= o2 (div1 left 8)))
(assert (= o3 (select addr o2)))
(assert (= o4 (to_rep1 o3)))
(assert (and (= o5 (pokebit8 o4 (mod1 left 8) flag)) (and (forall ((i1 Int)) (=> (and (<= 0 i1) (<= i1 7)) (=> (not (= i1 (- 7 (mod1 left 8)))) (= (= (nth o5 i1) true) (= (nth o4 i1) true))))) (= (= (nth o5 (- 7 (mod1 left 8))) true) (= flag true)))))
