...
(assert (and (and (and (= last3 (+ position 3)) (in_range2 last3)) (ite (not (= temporary1 ((_ int2bv 32) 0))) (and (= result value) (= value1 1)) (and (and (= result1 value) (= value2 0)) (= value1 value2)))) (and (and (= temporary1 temporary2) (and (= last3 last4) (= value1 value3))) (and (= temporary3 temporary1) (and (= last5 last3) (= value4 value1))))))
