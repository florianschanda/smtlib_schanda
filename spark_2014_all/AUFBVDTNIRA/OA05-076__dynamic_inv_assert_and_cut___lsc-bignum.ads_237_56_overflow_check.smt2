...
(assert (and (= o42 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o43 (+ x_first o42)))
(assert (and (= o44 o43) (in_range1 o43)))
(assert (= o45 (ite (<= o44 (to_rep (last (rt x)))) true false)))
(assert (and (= o39 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o40 (+ x_first o39)))
(assert (and (= o41 o40) (in_range1 o40)))
(assert (= o46 (ite (<= (to_rep (first (rt x))) o41) true false)))
(assert (= result (ite (= o46 true) o45 false)))
(assert (= result true))
...
(assert (and (= o34 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o35 (+ m_first o34)))
(assert (and (= o36 o35) (in_range1 o35)))
(assert (= o37 (ite (<= o36 (to_rep (last (rt m)))) true false)))
(assert (and (= o31 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o32 (+ m_first o31)))
(assert (and (= o33 o32) (in_range1 o32)))
(assert (= o38 (ite (<= (to_rep (first (rt m))) o33) true false)))
(assert (= result1 (ite (= o38 true) o37 false)))
(assert (= result1 true))
(assert (<= (to_rep aux1__first) aux1_first))
(assert (<= aux1_first (to_rep aux1__last)))
(assert (and (= o26 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o27 (+ aux1_first o26)))
(assert (and (= o28 o27) (in_range1 o27)))
(assert (= o29 (ite (<= o28 (to_rep aux1__last)) true false)))
(assert (and (= o23 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o24 (+ aux1_first o23)))
(assert (and (= o25 o24) (in_range1 o24)))
(assert (= o30 (ite (<= (to_rep aux1__first) o25) true false)))
(assert (= result2 (ite (= o30 true) o29 false)))
(assert (= result2 true))
...
(assert (= o19 (+ aux2_first o18)))
(assert (and (= o20 o19) (in_range1 o19)))
(assert (= o21 (ite (<= o20 (to_rep aux2__last)) true false)))
(assert (and (= o15 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o16 (+ aux2_first o15)))
(assert (and (= o17 o16) (in_range1 o16)))
(assert (= o22 (ite (<= (to_rep aux2__first) o17) true false)))
(assert (= result3 (ite (= o22 true) o21 false)))
(assert (= result3 true))
...
(assert (= o11 (+ aux3_first o10)))
(assert (and (= o12 o11) (in_range1 o11)))
(assert (= o13 (ite (<= o12 (to_rep aux3__last)) true false)))
(assert (and (= o7 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o8 (+ aux3_first o7)))
(assert (and (= o9 o8) (in_range1 o8)))
(assert (= o14 (ite (<= (to_rep aux3__first) o9) true false)))
...
(assert (and (= o3 (power 2 k)) (in_range1 (power 2 k))))
(assert (= o4 (* o3 o2)))
