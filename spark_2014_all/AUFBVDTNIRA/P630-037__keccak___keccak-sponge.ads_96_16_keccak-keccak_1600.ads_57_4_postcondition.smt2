...
(assert (forall ((x bit_absorption_number)) (! (in_range4 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(assert (forall ((x rate_number)) (! (in_range5 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(define-fun bool_eq1 ((a (Array Int byte)) (a__first Int) (a__last Int) (b (Array Int byte)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_132 Int)) (=> (and (<= a__first temp___idx_132) (<= temp___idx_132 a__last)) (= (to_rep5 (select a temp___idx_132)) (to_rep5 (select b (+ (- b__first a__first) temp___idx_132))))))) true false))
(assert (forall ((a (Array Int byte)) (b (Array Int byte))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq1 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_132 Int)) (=> (and (<= a__first temp___idx_132) (<= temp___idx_132 a__last)) (= (to_rep5 (select a temp___idx_132)) (to_rep5 (select b (+ (- b__first a__first) temp___idx_132)))))))))))
(declare-fun compare ((Array Int byte) Int Int (Array Int byte) Int Int) Int)
(assert (forall ((a (Array Int byte)) (b (Array Int byte))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare a a_first a_last b b_first b_last) 0) (= (bool_eq1 a a_first a_last b b_first b_last) true)) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int byte)) (b (Array Int byte))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq1 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (bvult (to_rep5 (select a (+ i 1))) (to_rep5 (select b (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int byte)) (b (Array Int byte))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq1 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (bvugt (to_rep5 (select a (+ j 1))) (to_rep5 (select b (+ i 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (and (and (and (and (= (bool_eq (rec__keccak__keccak_1600__sponge__context__state (us_split_fields1 a)) ((_ int2bv 8) 0) ((_ int2bv 8) 4) ((_ int2bv 8) 0) ((_ int2bv 8) 4) (rec__keccak__keccak_1600__sponge__context__state (us_split_fields1 b)) ((_ int2bv 8) 0) ((_ int2bv 8) 4) ((_ int2bv 8) 0) ((_ int2bv 8) 4)) true) (= (bool_eq1 (rec__keccak__keccak_1600__sponge__context__block (us_split_fields1 a)) 0 199 (rec__keccak__keccak_1600__sponge__context__block (us_split_fields1 b)) 0 199) true)) (= (to_rep3 (rec__keccak__keccak_1600__sponge__context__bits_absorbed (us_split_fields1 a))) (to_rep3 (rec__keccak__keccak_1600__sponge__context__bits_absorbed (us_split_fields1 b))))) (= (to_rep2 (rec__keccak__keccak_1600__sponge__context__bytes_squeezed (us_split_fields1 a))) (to_rep2 (rec__keccak__keccak_1600__sponge__context__bytes_squeezed (us_split_fields1 b))))) (= (to_rep4 (rec__keccak__keccak_1600__sponge__context__rate (us_split_fields1 a))) (to_rep4 (rec__keccak__keccak_1600__sponge__context__rate (us_split_fields1 b))))) (= (to_rep1 (rec__keccak__keccak_1600__sponge__context__curr_state (us_split_fields1 a))) (to_rep1 (rec__keccak__keccak_1600__sponge__context__curr_state (us_split_fields1 b))))) true false))
...
(define-fun dynamic_invariant1 ((temp___expr_364 Int) (temp___is_init_361 Bool) (temp___skip_constant_362 Bool) (temp___do_toplevel_363 Bool)) Bool (=> (or (= temp___is_init_361 true) (<= 0 1)) (in_range2 temp___expr_364)))
...
(assert (forall ((ctx us_rep)) (! (let ((result (rate_of ctx))) (and (< result 1600) (dynamic_invariant result true false true))) :pattern ((rate_of ctx)))))
...
(assert (forall ((ctx us_rep)) (! (let ((result (in_queue_bit_length ctx))) (and (< result 1600) (dynamic_invariant2 result true false true))) :pattern ((in_queue_bit_length ctx)))))
...
(assert (forall ((temp___801 (_ BitVec 8))) (forall ((temp___802 Int)) (= (select (temp___799 temp___801) temp___802) (of_rep5 temp___801)))))
...
(define-fun dynamic_invariant4 ((temp___expr_391 Int) (temp___is_init_388 Bool) (temp___skip_constant_389 Bool) (temp___do_toplevel_390 Bool)) Bool (=> (or (= temp___is_init_388 true) (<= 1 199)) (in_range5 temp___expr_391)))
(define-fun dynamic_invariant5 ((temp___expr_370 Int) (temp___is_init_367 Bool) (temp___skip_constant_368 Bool) (temp___do_toplevel_369 Bool)) Bool (=> (or (= temp___is_init_367 true) (<= 0 199)) (in_range3 temp___expr_370)))
(define-fun dynamic_invariant6 ((temp___expr_385 Int) (temp___is_init_382 Bool) (temp___skip_constant_383 Bool) (temp___do_toplevel_384 Bool)) Bool (=> (or (= temp___is_init_382 true) (<= 0 1599)) (in_range4 temp___expr_385)))
...
(declare-const temp___810 map1)
(declare-const temp___8101 (Array Int byte))
(declare-const temp___8102 bit_absorption_number)
(declare-const temp___8103 byte_absorption_number)
(declare-const temp___8104 rate_number)
(declare-const temp___8105 states)
(declare-const o22 states)
...
(declare-const temp___812 map1)
(declare-const temp___8121 (Array Int byte))
(declare-const temp___8122 bit_absorption_number)
(declare-const temp___8123 byte_absorption_number)
(declare-const temp___8124 rate_number)
(declare-const temp___8125 states)
...
(assert (= ctx__split_fields18 (mk___split_fields temp___806 temp___8061 temp___8062 temp___8063 temp___8064 temp___8065)))
(assert (= (to_rep2 o7) 0))
(assert (= (rec__keccak__keccak_1600__sponge__context__state ctx__split_fields18) o8))
(assert (= (rec__keccak__keccak_1600__sponge__context__block ctx__split_fields18) o9))
(assert (= (rec__keccak__keccak_1600__sponge__context__bits_absorbed ctx__split_fields18) o10))
(assert (= o7 o11))
(assert (= (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields18) o12))
(assert (= (rec__keccak__keccak_1600__sponge__context__curr_state ctx__split_fields18) o13))
...
(assert (= ctx__split_fields19 (mk___split_fields temp___808 temp___8081 temp___8082 temp___8083 temp___8084 temp___8085)))
(assert (and (= o14 (div1 (- 1600 capacity) 8)) (in_range5 (div1 (- 1600 capacity) 8))))
(assert (= (to_rep4 o15) o14))
(assert (= (rec__keccak__keccak_1600__sponge__context__state ctx__split_fields19) o16))
(assert (= (rec__keccak__keccak_1600__sponge__context__block ctx__split_fields19) o17))
(assert (= (rec__keccak__keccak_1600__sponge__context__bits_absorbed ctx__split_fields19) o18))
(assert (= (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields19) o19))
(assert (= o15 o20))
(assert (= (rec__keccak__keccak_1600__sponge__context__curr_state ctx__split_fields19) o21))
(assert (= temp___810 o16))
(assert (= temp___8101 o17))
(assert (= temp___8102 o18))
(assert (= temp___8103 o19))
(assert (= temp___8104 o20))
(assert (= temp___8105 o21))
(assert (= result19 (mk___split_fields__ref ctx__split_fields19)))
(assert (= ctx__split_fields20 (mk___split_fields temp___810 temp___8101 temp___8102 temp___8103 temp___8104 temp___8105)))
(assert (= (to_rep1 o22) 0))
(assert (= (rec__keccak__keccak_1600__sponge__context__state ctx__split_fields20) o23))
(assert (= (rec__keccak__keccak_1600__sponge__context__block ctx__split_fields20) o24))
(assert (= (rec__keccak__keccak_1600__sponge__context__bits_absorbed ctx__split_fields20) o25))
(assert (= (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields20) o26))
(assert (= (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields20) o27))
(assert (= o22 o28))
(assert (= temp___812 o23))
(assert (= temp___8121 o24))
(assert (= temp___8122 o25))
(assert (= temp___8123 o26))
(assert (= temp___8124 o27))
(assert (= temp___8125 o28))
(assert (= result20 (mk___split_fields__ref ctx__split_fields20)))
(assert (= ctx__split_fields21 (mk___split_fields temp___812 temp___8121 temp___8122 temp___8123 temp___8124 temp___8125)))
(assert (= ctx__split_fields22 (mk___split_fields__ref ctx__split_fields21)))
(assert (= ctx__split_fields23 ctx__split_fields21))
(assert (not (= (state_of (mk___rep (us_split_fields__content ctx__split_fields22))) 0)))
(check-sat)
(exit)
