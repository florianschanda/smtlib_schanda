...
(define-fun to_int4 ((x byte)) Int (bv2nat (to_rep5 x)))
...
(define-fun bool_eq1 ((a (Array Int byte)) (a__first Int) (a__last Int) (b (Array Int byte)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (to_rep5 (select a temp___idx_154)) (to_rep5 (select b (+ (- b__first a__first) temp___idx_154))))))) true false))
(assert (forall ((a (Array Int byte)) (b (Array Int byte))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq1 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (to_rep5 (select a temp___idx_154)) (to_rep5 (select b (+ (- b__first a__first) temp___idx_154)))))))))))
...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (and (and (and (and (= (bool_eq (rec__keccak__keccak_1600__sponge__context__state (us_split_fields1 a)) #x00 #x04 #x00 #x04 (rec__keccak__keccak_1600__sponge__context__state (us_split_fields1 b)) #x00 #x04 #x00 #x04) true) (= (bool_eq1 (rec__keccak__keccak_1600__sponge__context__block (us_split_fields1 a)) 0 199 (rec__keccak__keccak_1600__sponge__context__block (us_split_fields1 b)) 0 199) true)) (= (to_rep3 (rec__keccak__keccak_1600__sponge__context__bits_absorbed (us_split_fields1 a))) (to_rep3 (rec__keccak__keccak_1600__sponge__context__bits_absorbed (us_split_fields1 b))))) (= (to_rep2 (rec__keccak__keccak_1600__sponge__context__bytes_squeezed (us_split_fields1 a))) (to_rep2 (rec__keccak__keccak_1600__sponge__context__bytes_squeezed (us_split_fields1 b))))) (= (to_rep4 (rec__keccak__keccak_1600__sponge__context__rate (us_split_fields1 a))) (to_rep4 (rec__keccak__keccak_1600__sponge__context__rate (us_split_fields1 b))))) (= (to_rep1 (rec__keccak__keccak_1600__sponge__context__curr_state (us_split_fields1 a))) (to_rep1 (rec__keccak__keccak_1600__sponge__context__curr_state (us_split_fields1 b))))) true false))
...
(declare-fun temp___868 ((_ BitVec 8)) (Array Int byte))
...
(assert (forall ((temp___870 (_ BitVec 8))) (=> (dynamic_invariant3 temp___870 true true true true) (forall ((temp___871 Int)) (= (to_rep5 (select (temp___868 temp___870) temp___871)) temp___870)))))
...
(declare-const temp___875 map1)
(declare-const temp___8751 (Array Int byte))
(declare-const temp___8752 bit_absorption_number)
(declare-const temp___8753 byte_absorption_number)
(declare-const temp___8754 rate_number)
(declare-const temp___8755 states)
...
(declare-const temp___877 map1)
(declare-const temp___8771 (Array Int byte))
(declare-const temp___8772 bit_absorption_number)
(declare-const temp___8773 byte_absorption_number)
(declare-const temp___8774 rate_number)
(declare-const temp___8775 states)
...
(declare-const temp___8791 (Array Int byte))
(declare-const temp___8792 bit_absorption_number)
(declare-const temp___8793 byte_absorption_number)
(declare-const temp___8794 rate_number)
(declare-const temp___8795 states)
...
(declare-const temp___881 map1)
(declare-const temp___8811 (Array Int byte))
(declare-const temp___8812 bit_absorption_number)
(declare-const temp___8813 byte_absorption_number)
(declare-const temp___8814 rate_number)
(declare-const temp___8815 states)
...
(assert (= (temp___868 #x00) ctx__split_fields13))
...
(assert (= temp___875 o1))
(assert (= temp___8751 o2))
(assert (= temp___8752 o3))
(assert (= temp___8753 o4))
(assert (= temp___8754 o5))
(assert (= temp___8755 o6))
...
(assert (= ctx__split_fields18 (mk___split_fields temp___875 temp___8751 temp___8752 temp___8753 temp___8754 temp___8755)))
(assert (= (to_rep2 o7) 0))
...
(assert (= temp___877 o8))
(assert (= temp___8771 o9))
(assert (= temp___8772 o10))
(assert (= temp___8773 o11))
(assert (= temp___8774 o12))
(assert (= temp___8775 o13))
(assert (= result18 (mk___split_fields__ref ctx__split_fields18)))
(assert (= ctx__split_fields19 (mk___split_fields temp___877 temp___8771 temp___8772 temp___8773 temp___8774 temp___8775)))
...
(assert (= temp___879 o16))
(assert (= temp___8791 o17))
(assert (= temp___8792 o18))
(assert (= temp___8793 o19))
(assert (= temp___8794 o20))
(assert (= temp___8795 o21))
(assert (= result19 (mk___split_fields__ref ctx__split_fields19)))
(assert (= ctx__split_fields20 (mk___split_fields temp___879 temp___8791 temp___8792 temp___8793 temp___8794 temp___8795)))
...
(assert (= o22 o28))
(assert (= temp___881 o23))
(assert (= temp___8811 o24))
(assert (= temp___8812 o25))
(assert (= temp___8813 o26))
(assert (= temp___8814 o27))
(assert (= temp___8815 o28))
(assert (= result20 (mk___split_fields__ref ctx__split_fields20)))
(assert (= ctx__split_fields21 (mk___split_fields temp___881 temp___8811 temp___8812 temp___8813 temp___8814 temp___8815)))
