...
(assert (= j2 1))
(assert (and (and (= temp___645 s2) (and (= temp___644 j2) (and (= temp___643 w2) (and (and (and (and (and (and (and (and (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t aux11 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 ((_ int2bv 32) 1))) true)) (= (oeq (num_of_big_int (mk___t aux2 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t aux31 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (omultiply (oexpon__2 (num_of_big_int x x_first (+ l1 1)) (odivide (num_of_big_int e e_first (+ (- e_last e_first) 1)) (oexpon__2 (from_word32 ((_ int2bv 32) 2)) (oadd (from_word64 i2) (from_word32 ((_ int2bv 32) 1)))))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (forall ((n7 Int)) (=> (and (<= 0 n7) (<= n7 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux47) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n7 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n7) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))) (= (oeq (omultiply (from_word32 w3) (oexpon (from_word32 ((_ int2bv 32) 2)) (- (- j3 s3) 1))) (omod (odivide (num_of_big_int e e_first (+ (- e_last e_first) 1)) (oexpon__2 (from_word32 ((_ int2bv 32) 2)) (osubtract (from_word64 i2) (osubtract (from_integer j3) (from_word32 ((_ int2bv 32) 1)))))) (oexpon (from_word32 ((_ int2bv 32) 2)) j3))) true)) (= (bvurem w3 ((_ int2bv 32) 2)) ((_ int2bv 32) 1))) (<= 0 s3)) (< s3 j3)) (<= j3 (+ k 1))) (= (ole (from_integer j3) (oadd (from_word64 i2) (from_word32 ((_ int2bv 32) 1)))) true)) (bvult i2 (bvmul (bvadd ((_ int2bv 64) (- e_last e_first)) ((_ int2bv 64) 1)) ((_ int2bv 64) 32)))) (and (and (=> (<= 0 2147483647) (in_range2 j3)) (=> (<= 0 2147483647) (in_range2 s3))) (and (and (and (= w7 (mk_t__ref w3)) (and (= s7 (mk_int__ref s3)) (= j5 (mk_int__ref j3)))) (and (= w8 w3) (and (= s8 s3) (= j6 j3)))) (not (and (<= j3 k) (bvule ((_ int2bv 64) j3) i2))))))))) (and (and (= w13 w7) (and (= s13 s7) (= j11 j5))) (and (= w14 w8) (and (= s14 s8) (= j12 j6))))))
(assert (= w15 w13))
(assert (= s15 s13))
(assert (= j13 j11))
(assert (= w16 w14))
(assert (= s16 s14))
(assert (= j14 j12))
(assert (and (= o463 (+ (int__content s15) 1)) (in_range1 (+ (int__content s15) 1))))
(assert (= result24 s15))
(assert (= s17 o463))
(assert (= s17 r94b))
...
(assert (<= 1 h11))
(assert (<= h11 r94b))
(assert (and (and (and (and (and (and (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t aux11 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 ((_ int2bv 32) 1))) true)) (= (oeq (num_of_big_int (mk___t aux2 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t aux32 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (omultiply (oexpon__2 (num_of_big_int x x_first (+ l1 1)) (omultiply (odivide (num_of_big_int e e_first (+ (- e_last e_first) 1)) (oexpon__2 (from_word32 ((_ int2bv 32) 2)) (oadd (from_word64 i2) (from_word32 ((_ int2bv 32) 1))))) (oexpon (from_word32 ((_ int2bv 32) 2)) (- h12 1)))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (forall ((n7 Int)) (=> (and (<= 0 n7) (<= n7 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux47) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n7 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n7) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))) (= (oeq (from_word32 (t__content w15)) (omod (odivide (num_of_big_int e e_first (+ (- e_last e_first) 1)) (oexpon__2 (from_word32 ((_ int2bv 32) 2)) (osubtract (from_word64 i2) (osubtract (from_integer s17) (from_word32 ((_ int2bv 32) 1)))))) (oexpon (from_word32 ((_ int2bv 32) 2)) s17))) true)) (= (bvurem (t__content w15) ((_ int2bv 32) 2)) ((_ int2bv 32) 1))) (<= 0 s17)) (<= s17 (+ k 1))) (= (ole (from_integer s17) (oadd (from_word64 i2) (from_word32 ((_ int2bv 32) 1)))) true)) (bvult i2 (bvmul (bvadd ((_ int2bv 64) (- e_last e_first)) ((_ int2bv 64) 1)) ((_ int2bv 64) 32)))))
(assert (and (=> (<= 1 r94b) (dynamic_property2 1 r94b h12)) (and (<= 1 h12) (<= h12 r94b))))
(assert (= (oeq (num_of_big_int (mk___t a12 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omod (omultiply (omultiply (num_of_big_int (mk___t aux32 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ (- a_last a_first) 1)) (num_of_big_int (mk___t aux32 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ (- a_last a_first) 1))) (oexpon (inverse (num_of_big_int m m_first (+ (- a_last a_first) 1)) (base Tuple0)) (+ (- a_last a_first) 1))) (num_of_big_int m m_first (+ (- a_last a_first) 1)))) true))
(assert (forall ((k1 Int)) (=> (and (<= (to_rep aux3__first) k1) (<= k1 (to_rep aux3__last))) (and (=> (and (<= aux3_first k1) (<= k1 (- (+ aux3_first a_last) a_first))) (= (to_rep1 (select aux33 k1)) (to_rep1 (select a12 (- (+ a_first k1) aux3_first))))) (=> (=> (<= aux3_first k1) (not (<= k1 (- (+ aux3_first a_last) a_first)))) (= (to_rep1 (select aux33 k1)) (to_rep1 (select aux32 k1))))))))
(assert (and (= o670 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (and (= o671 o670) (uint_in_range1 o670)))
(assert (= o672 ((_ int2bv 64) o671)))
(assert (= o673 (bvadd o672 ((_ int2bv 64) 1))))
(assert (= o674 (bvmul o673 ((_ int2bv 64) 32))))
(assert (= o675 (ite (bvult i2 o674) true false)))
(assert (= o667 (from_word32 ((_ int2bv 32) 1))))
(assert (= o666 (from_word64 i2)))
(assert (= o668 (oadd o666 o667)))
(assert (= o665 (from_integer s17)))
(assert (= o669 (ole o665 o668)))
(assert (and (= o663 (+ k 1)) (in_range1 (+ k 1))))
(assert (= o664 (ite (<= s17 o663) true false)))
(assert (= o659 (from_word32 ((_ int2bv 32) 2))))
(assert (= o660 (oexpon o659 s17)))
(assert (= o654 (from_word32 ((_ int2bv 32) 1))))
(assert (= o653 (from_integer s17)))
(assert (= o655 (osubtract o653 o654)))
(assert (= o652 (from_word64 i2)))
(assert (= o656 (osubtract o652 o655)))
(assert (= o651 (from_word32 ((_ int2bv 32) 2))))
(assert (= o657 (oexpon__2 o651 o656)))
(assert (and (= o646 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (= o647 (+ o646 1)))
(assert (and (= o648 o647) (in_range1 o647)))
(assert (and (= o649 o648) (in_range2 o648)))
(assert (= o650 (num_of_big_int e e_first o649)))
(assert (= o658 (odivide o650 o657)))
(assert (= o661 (omod o658 o660)))
(assert (= o645 (from_word32 (t__content w15))))
(assert (= o662 (oeq o645 o661)))
(assert (and (= o619 (power 2 k)) (in_range1 (power 2 k))))
(assert (= o620 (- o619 1)))
(assert (and (= o621 o620) (in_range1 o620)))
(assert (= o622 (ite (<= n5 o621) true false)))
(assert (= result27 (ite (<= 0 n5) o622 false)))
(assert (= (= o644 true) (forall ((n7 Int)) (=> (and (<= 0 n7) (<= n7 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux47) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n7 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n7) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))))
(assert (and (= o613 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o614 (num_of_big_int m m_first o613)))
(assert (and (= o610 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (and (= o609 (base Tuple0)) (= o609 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o611 (oexpon o609 o610)))
(assert (= o605 (from_word32 ((_ int2bv 32) 2))))
(assert (= o606 (oexpon o605 h12)))
(assert (= o601 (from_word32 ((_ int2bv 32) 1))))
(assert (= o600 (from_word64 i2)))
(assert (= o602 (oadd o600 o601)))
(assert (= o599 (from_word32 ((_ int2bv 32) 2))))
(assert (= o603 (oexpon__2 o599 o602)))
(assert (and (= o594 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (= o595 (+ o594 1)))
(assert (and (= o596 o595) (in_range1 o595)))
(assert (and (= o597 o596) (in_range2 o596)))
(assert (= o598 (num_of_big_int e e_first o597)))
(assert (= o604 (odivide o598 o603)))
(assert (= o607 (omultiply o604 o606)))
(assert (and (= o592 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o593 (num_of_big_int x x_first o592)))
(assert (= o608 (oexpon__2 o593 o607)))
(assert (= o612 (omultiply o608 o611)))
(assert (= o615 (omod o612 o614)))
(assert (and (= o590 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o591 (num_of_big_int (mk___t aux33 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first o590)))
(assert (= o616 (oeq o591 o615)))
(assert (and (= o586 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o587 (num_of_big_int m m_first o586)))
(assert (and (= o583 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (and (= o582 (base Tuple0)) (= o582 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o584 (oexpon o582 o583)))
(assert (and (= o579 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o580 (num_of_big_int x x_first o579)))
