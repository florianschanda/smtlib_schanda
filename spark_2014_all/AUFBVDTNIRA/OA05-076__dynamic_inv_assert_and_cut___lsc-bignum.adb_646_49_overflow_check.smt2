...
(assert (and (= o73 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (and (= o74 o73) (uint_in_range1 o73)))
(assert (= o75 ((_ int2bv 64) o74)))
(assert (= o76 (bvadd o75 ((_ int2bv 64) 1))))
(assert (= o77 (bvmul o76 ((_ int2bv 64) 32))))
(assert (= o78 (ite (bvult i2 o77) true false)))
(assert (= o70 (from_word32 ((_ int2bv 32) 1))))
(assert (= o69 (from_word64 i2)))
(assert (= o71 (oadd o69 o70)))
(assert (= o68 (from_integer s10)))
(assert (= o72 (ole o68 o71)))
(assert (and (= o66 (+ k 1)) (in_range1 (+ k 1))))
(assert (= o67 (ite (<= s10 o66) true false)))
(assert (= o62 (from_word32 ((_ int2bv 32) 2))))
(assert (= o63 (oexpon o62 s10)))
(assert (= o57 (from_word32 ((_ int2bv 32) 1))))
(assert (= o56 (from_integer s10)))
(assert (= o58 (osubtract o56 o57)))
(assert (= o55 (from_word64 i2)))
(assert (= o59 (osubtract o55 o58)))
(assert (= o54 (from_word32 ((_ int2bv 32) 2))))
(assert (= o60 (oexpon__2 o54 o59)))
(assert (and (= o49 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (= o50 (+ o49 1)))
(assert (and (= o51 o50) (in_range1 o50)))
(assert (and (= o52 o51) (in_range2 o51)))
(assert (= o53 (num_of_big_int e e_first o52)))
(assert (= o61 (odivide o53 o60)))
(assert (= o64 (omod o61 o63)))
(assert (= o48 (from_word32 (t__content w7))))
(assert (= o65 (oeq o48 o64)))
(assert (and (= o43 (power 2 k)) (in_range1 (power 2 k))))
(assert (= o44 (- o43 1)))
(assert (and (= o45 o44) (in_range1 o44)))
(assert (= o46 (ite (<= n o45) true false)))
(assert (= result8 (ite (<= 0 n) o46 false)))
(assert (= (= o47 true) (forall ((n1 Int)) (=> (and (<= 0 n1) (<= n1 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux45) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n1 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))))
(assert (and (= o39 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o40 (num_of_big_int m m_first o39)))
(assert (and (= o36 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (and (= o35 (base Tuple0)) (= o35 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o37 (oexpon o35 o36)))
(assert (= o31 (from_word32 ((_ int2bv 32) 2))))
(assert (= o32 (oexpon o31 h9)))
(assert (= o27 (from_word32 ((_ int2bv 32) 1))))
(assert (= o26 (from_word64 i2)))
(assert (= o28 (oadd o26 o27)))
(assert (= o25 (from_word32 ((_ int2bv 32) 2))))
(assert (= o29 (oexpon__2 o25 o28)))
...
(assert (= o30 (odivide o24 o29)))
(assert (= o33 (omultiply o30 o32)))
(assert (and (= o18 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o19 (num_of_big_int x x_first o18)))
(assert (= o34 (oexpon__2 o19 o33)))
(assert (= o38 (omultiply o34 o37)))
(assert (= o41 (omod o38 o40)))
(assert (and (= o16 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o17 (num_of_big_int (mk___t aux33 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first o16)))
(assert (= o42 (oeq o17 o41)))
(assert (and (= o14 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o15 (num_of_big_int m m_first o14)))
(assert (and (= o12 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (and (= o11 (base Tuple0)) (= o11 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o13 (oexpon o11 o12)))
(assert (and (= o9 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o10 (num_of_big_int x x_first o9)))
