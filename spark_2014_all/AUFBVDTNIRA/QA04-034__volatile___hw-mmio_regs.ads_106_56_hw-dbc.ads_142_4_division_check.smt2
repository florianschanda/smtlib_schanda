...
(assert (and (= o9 (+ (to_rep (rec__hw__dbc__xcap_s_regs__t__msb (us_split_fields1 (select regs idx)))) 1)) (in_range1 (+ (to_rep (rec__hw__dbc__xcap_s_regs__t__msb (us_split_fields1 (select regs idx)))) 1))))
(assert (= o10 (- o9 (to_rep (rec__hw__dbc__xcap_s_regs__t__lsb (us_split_fields1 (select regs idx)))))))
...
(assert (= o17 (ite (bvult ((_ zero_extend 32) value) o16) true false)))
(assert (and (= o6 32) (in_range1 32)))
