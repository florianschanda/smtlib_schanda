...
(assert (and (= o18 (pokebit64 retval3 o17 flag3)) (and (forall ((i17 Int)) (=> (and (<= 0 i17) (<= i17 63)) (=> (not (= i17 (- 63 o17))) (= (= (nth o18 i17) true) (= (nth retval3 i17) true))))) (= (= flag3 true) (= (nth o18 (- 63 o17)) true)))))
(assert (= retval3 result5))
(assert (= retval4 o18))
(assert (not (= i5 (- length1 1))))
(assert (= result6 i5))
(assert (= i6 (+ i5 1)))
(declare-const j2 Int)
(assert (<= length1 j2))
(assert (<= j2 63))
(assert (not (not (= (nth retval4 j2) true))))
(check-sat)
(exit)
