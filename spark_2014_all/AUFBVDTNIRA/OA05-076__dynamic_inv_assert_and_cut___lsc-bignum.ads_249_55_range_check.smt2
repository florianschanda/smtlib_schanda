...
(assert (and (= o775 o774) (in_range2 o774)))
(assert (= o776 (num_of_big_int x x_first o775)))
(assert (= o782 (oexpon__2 o776 o781)))
(assert (= o788 (omod o782 o787)))
(assert (and (= o768 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o769 (+ o768 1)))
(assert (and (= o770 o769) (in_range1 o769)))
(assert (not (in_range2 o770)))
(check-sat)
(exit)
