...
(define-fun dynamic_invariant ((temp___expr_159 Int) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool) (temp___do_typ_inv_158 Bool)) Bool (=> (or (= temp___is_init_155 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_159)))
...
(define-fun dynamic_invariant3 ((temp___expr_269 (_ BitVec 32)) (temp___is_init_265 Bool) (temp___skip_constant_266 Bool) (temp___do_toplevel_267 Bool) (temp___do_typ_inv_268 Bool)) Bool true)
...
(assert (forall ((s Int)) (! (=> (dynamic_invariant2 s true true true true) (dynamic_invariant3 (xdr_integer_to_unsigned s) true false true true)) :pattern ((xdr_integer_to_unsigned s)))))
...
(define-fun dynamic_invariant6 ((temp___expr_222 us_t) (temp___is_init_218 Bool) (temp___skip_constant_219 Bool) (temp___do_toplevel_220 Bool) (temp___do_typ_inv_221 Bool)) Bool (=> (not (= temp___skip_constant_219 true)) (dynamic_property 0 65535 (first1 temp___expr_222) (last1 temp___expr_222))))
