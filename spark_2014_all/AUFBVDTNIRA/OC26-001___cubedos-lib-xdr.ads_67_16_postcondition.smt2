...
(declare-fun user_eq1 (xdr_integer xdr_integer) Bool)
(declare-const dummy1 xdr_integer)
...
(define-fun dynamic_invariant ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_136)))
...
(define-fun dynamic_invariant1 ((temp___expr_172 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= 0 65535)) (in_range3 temp___expr_172)))
...
(define-fun dynamic_invariant2 ((temp___expr_229 Int) (temp___is_init_226 Bool) (temp___skip_constant_227 Bool) (temp___do_toplevel_228 Bool)) Bool (=> (or (= temp___is_init_226 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_229)))
...
(define-fun dynamic_invariant3 ((temp___expr_235 (_ BitVec 32)) (temp___is_init_232 Bool) (temp___skip_constant_233 Bool) (temp___do_toplevel_234 Bool)) Bool true)
(declare-fun xdr_integer_to_unsigned (Int) (_ BitVec 32))
(declare-fun xdr_integer_to_unsigned__function_guard ((_ BitVec 32) Int) Bool)
(assert (forall ((s Int)) (! (=> (dynamic_invariant2 s true true true) (dynamic_invariant3 (xdr_integer_to_unsigned s) true false true)) :pattern ((xdr_integer_to_unsigned s)))))
...
(define-fun dynamic_invariant6 ((temp___expr_190 us_t) (temp___is_init_187 Bool) (temp___skip_constant_188 Bool) (temp___do_toplevel_189 Bool)) Bool (=> (not (= temp___skip_constant_188 true)) (dynamic_property 0 65535 (first1 temp___expr_190) (last1 temp___expr_190))))
...
(assert (and (and (and (= (mod1 position 4) 0) (= (mod1 (ite (<= (to_rep data__first) (to_rep data__last)) (+ (- (to_rep data__last) (to_rep data__first)) 1) 0) 4) 0)) (and (<= (to_rep data__first) position) (<= position (to_rep data__last)))) (<= (+ position 3) (to_rep data__last))))
(assert (and (and (= o3 (xdr_integer_to_unsigned value)) (and (= last3 (+ position 3)) (in_range3 last3))) (and (and (= last3 last4) (= data data1)) (and (= last5 last3) (= data2 data)))))
(assert (not (= last4 (+ position 3))))
(check-sat)
(exit)
