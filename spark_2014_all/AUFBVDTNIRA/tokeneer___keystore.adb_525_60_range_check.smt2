...
(define-fun dynamic_invariant1 ((temp___expr_244 Int) (temp___is_init_240 Bool) (temp___skip_constant_241 Bool) (temp___do_toplevel_242 Bool) (temp___do_typ_inv_243 Bool)) Bool (=> (or (= temp___is_init_240 true) (<= 0 4294967295)) (in_range5 temp___expr_244)))
...
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq5 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_172 Int)) (=> (and (<= a__first temp___idx_172) (<= temp___idx_172 a__last)) (= (to_rep5 (select a temp___idx_172)) (to_rep5 (select b (+ (- b__first a__first) temp___idx_172)))))))))))
...
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq7 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_173 Int)) (=> (and (<= a__first temp___idx_173) (<= temp___idx_173 a__last)) (= (to_rep8 (select a temp___idx_173)) (to_rep8 (select b (+ (- b__first a__first) temp___idx_173)))))))))))
...
(define-fun dynamic_invariant3 ((temp___expr_1276 us_rep2) (temp___is_init_1272 Bool) (temp___skip_constant_1273 Bool) (temp___do_toplevel_1274 Bool) (temp___do_typ_inv_1275 Bool)) Bool (=> (= temp___do_typ_inv_1275 true) (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1276))) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1276))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1276)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1276))) true)))
(define-fun default_initial_assumption ((temp___expr_1280 us_rep2) (temp___skip_top_level_1281 Bool)) Bool (and (and (and (= (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1280))) 1) (= (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1280))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1280)) (mk___rep1 (mk___split_fields1 (temp___1282 1) (of_rep5 1) (of_rep5 1) (of_rep7 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1280)) (temp___1286 0))))
(define-fun type_invariant ((temp___1290 us_rep2)) Bool (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___1290))) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___1290))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___1290)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___1290))) true))
...
(define-fun bool_eq10 ((a (Array Int us_rep3)) (a__first Int) (a__last Int) (b (Array Int us_rep3)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_174 Int)) (=> (and (<= a__first temp___idx_174) (<= temp___idx_174 a__last)) (= (bool_eq9 (select a temp___idx_174) (select b (+ (- b__first a__first) temp___idx_174))) true)))) true false))
(assert (forall ((a (Array Int us_rep3)) (b (Array Int us_rep3))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq10 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_174 Int)) (=> (and (<= a__first temp___idx_174) (<= temp___idx_174 a__last)) (= (bool_eq9 (select a temp___idx_174) (select b (+ (- b__first a__first) temp___idx_174))) true))))))))
...
(define-fun bool_eq11 ((a (Array Int filestatust)) (a__first Int) (a__last Int) (b (Array Int filestatust)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_175 Int)) (=> (and (<= a__first temp___idx_175) (<= temp___idx_175 a__last)) (= (to_rep9 (select a temp___idx_175)) (to_rep9 (select b (+ (- b__first a__first) temp___idx_175))))))) true false))
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq11 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_175 Int)) (=> (and (<= a__first temp___idx_175) (<= temp___idx_175 a__last)) (= (to_rep9 (select a temp___idx_175)) (to_rep9 (select b (+ (- b__first a__first) temp___idx_175)))))))))))
...
(define-fun dynamic_invariant4 ((temp___expr_1688 Int) (temp___is_init_1684 Bool) (temp___skip_constant_1685 Bool) (temp___do_toplevel_1686 Bool) (temp___do_typ_inv_1687 Bool)) Bool (=> (or (= temp___is_init_1684 true) (<= 0 28)) (in_range15 temp___expr_1688)))
...
(declare-fun temp___String_Literal_1784 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1784 us_void_param) 1)) 73) (= (to_rep (select (temp___String_Literal_1784 us_void_param) 2)) 110)) (= (to_rep (select (temp___String_Literal_1784 us_void_param) 3)) 105)) (= (to_rep (select (temp___String_Literal_1784 us_void_param) 4)) 116)) (= (to_rep (select (temp___String_Literal_1784 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_1784 us_void_param) 6)) 97)) (= (to_rep (select (temp___String_Literal_1784 us_void_param) 7)) 108)) (= (to_rep (select (temp___String_Literal_1784 us_void_param) 8)) 105)) (= (to_rep (select (temp___String_Literal_1784 us_void_param) 9)) 122)) (= (to_rep (select (temp___String_Literal_1784 us_void_param) 10)) 101)) :pattern ((temp___String_Literal_1784 us_void_param)))))
...
(define-fun dynamic_invariant12 ((temp___expr_471 Int) (temp___is_init_467 Bool) (temp___skip_constant_468 Bool) (temp___do_toplevel_469 Bool) (temp___do_typ_inv_470 Bool)) Bool (=> (or (= temp___is_init_467 true) (<= 1 150)) (in_range6 temp___expr_471)))
(assert (= nouser (temp___String_Literal_158 Tuple0)))
(define-fun dynamic_invariant13 ((temp___expr_1214 Int) (temp___is_init_1210 Bool) (temp___skip_constant_1211 Bool) (temp___do_toplevel_1212 Bool) (temp___do_typ_inv_1213 Bool)) Bool (=> (or (= temp___is_init_1210 true) (<= 0 17)) (in_range11 temp___expr_1214)))
(define-fun dynamic_invariant14 ((temp___expr_1221 Int) (temp___is_init_1217 Bool) (temp___skip_constant_1218 Bool) (temp___do_toplevel_1219 Bool) (temp___do_typ_inv_1220 Bool)) Bool (=> (or (= temp___is_init_1217 true) (<= 1 17)) (in_range9 temp___expr_1221)))
(define-fun dynamic_invariant15 ((temp___expr_1347 Int) (temp___is_init_1343 Bool) (temp___skip_constant_1344 Bool) (temp___do_toplevel_1345 Bool) (temp___do_typ_inv_1346 Bool)) Bool (=> (or (= temp___is_init_1343 true) (<= 0 2)) (in_range13 temp___expr_1347)))
(define-fun dynamic_invariant16 ((temp___expr_1228 Int) (temp___is_init_1224 Bool) (temp___skip_constant_1225 Bool) (temp___do_toplevel_1226 Bool) (temp___do_typ_inv_1227 Bool)) Bool (=> (or (= temp___is_init_1224 true) (<= 0 17408)) (in_range10 temp___expr_1228)))
(define-fun dynamic_invariant17 ((temp___expr_1259 Int) (temp___is_init_1255 Bool) (temp___skip_constant_1256 Bool) (temp___do_toplevel_1257 Bool) (temp___do_typ_inv_1258 Bool)) Bool (=> (or (= temp___is_init_1255 true) (<= 0 1024)) (in_range12 temp___expr_1259)))
(assert true)
...
(assert (forall ((temp___1288 Int)) (=> (dynamic_invariant17 temp___1288 true true true true) (forall ((temp___1289 Int)) (= (to_rep8 (select (temp___1286 temp___1288) temp___1289)) temp___1288)))))
(define-fun dynamic_invariant18 ((temp___expr_1622 (_ BitVec 32)) (temp___is_init_1618 Bool) (temp___skip_constant_1619 Bool) (temp___do_toplevel_1620 Bool) (temp___do_typ_inv_1621 Bool)) Bool (=> (or (= temp___is_init_1618 true) (bvule #x00000000 #x0000000F)) (in_range14 temp___expr_1622)))
(assert (forall ((temp___1284 Int)) (=> (dynamic_invariant14 temp___1284 true true true true) (forall ((temp___1285 Int)) (= (to_rep5 (select (temp___1282 temp___1284) temp___1285)) temp___1284)))))
...
(declare-const temp___1804 issueridt)
(declare-const temp___18041 namecountt)
(declare-const temp___18042 (Array Int character))
...
(assert (= o o3))
(assert (= blankname o4))
(assert (= temp___1804 o2))
(assert (= temp___18041 o3))
(assert (= temp___18042 o4))
(assert (= (mk___rep (mk___split_fields temp___1804 temp___18041 temp___18042)) nullissuer))
