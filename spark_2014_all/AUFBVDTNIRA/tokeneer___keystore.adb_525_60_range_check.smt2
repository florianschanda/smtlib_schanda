...
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq5 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_150 Int)) (=> (and (<= a__first temp___idx_150) (<= temp___idx_150 a__last)) (= (to_rep5 (select a temp___idx_150)) (to_rep5 (select b (+ (- b__first a__first) temp___idx_150)))))))))))
(declare-fun compare1 ((Array Int logfileindext) Int Int (Array Int logfileindext) Int Int) Int)
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare1 a a_first a_last b b_first b_last) 0) (= (bool_eq5 a a_first a_last b b_first b_last) true)) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare1 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq5 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep5 (select a (+ i 1))) (to_rep5 (select b (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare1 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq5 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep5 (select b (+ i 1))) (to_rep5 (select a (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
...
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq7 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_151 Int)) (=> (and (<= a__first temp___idx_151) (<= temp___idx_151 a__last)) (= (to_rep8 (select a temp___idx_151)) (to_rep8 (select b (+ (- b__first a__first) temp___idx_151)))))))))))
(declare-fun compare2 ((Array Int fileentrycountt) Int Int (Array Int fileentrycountt) Int Int) Int)
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare2 a a_first a_last b b_first b_last) 0) (= (bool_eq7 a a_first a_last b b_first b_last) true)) :pattern ((compare2 a a_first a_last b b_first b_last))))))
...
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare2 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq7 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep8 (select b (+ i 1))) (to_rep8 (select a (+ j 1))))))))))) :pattern ((compare2 a a_first a_last b b_first b_last))))))
...
(define-fun bool_eq8 ((a us_rep2) (b us_rep2)) Bool (ite (and (and (and (= (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 a))) (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 b)))) (= (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 a))) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 b))))) (= (bool_eq6 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 a)) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 b))) true)) (= (bool_eq7 (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 a)) 1 17 (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 b)) 1 17) true)) true false))
...
(assert (forall ((temp___1145 Int)) (forall ((temp___1146 Int)) (= (select (temp___1143 temp___1145) temp___1146) (of_rep5 temp___1145)))))
(declare-fun temp___1147 (Int) (Array Int fileentrycountt))
(assert (forall ((temp___1149 Int)) (forall ((temp___1150 Int)) (= (select (temp___1147 temp___1149) temp___1150) (of_rep8 temp___1149)))))
(define-fun dynamic_invariant3 ((temp___expr_1137 us_rep2) (temp___is_init_1134 Bool) (temp___skip_constant_1135 Bool) (temp___do_toplevel_1136 Bool)) Bool (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1137))) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1137))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1137)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1137))) true))
(define-fun default_initial_assumption ((temp___expr_1141 us_rep2) (temp___skip_top_level_1142 Bool)) Bool (and (and (and (= (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1141))) 1) (= (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1141))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1141)) (mk___rep1 (mk___split_fields1 (temp___1143 1) (of_rep5 1) (of_rep5 1) (of_rep7 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1141)) (temp___1147 0))))
(define-fun type_invariant ((temp___1151 us_rep2)) Bool (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___1151))) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___1151))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___1151)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___1151))) true))
...
(assert (forall ((a (Array Int us_rep3))) (forall ((first6 Int)) (! (= (slide3 a first6 first6) a) :pattern ((slide3 a first6 first6))))))
...
(define-fun bool_eq10 ((a (Array Int us_rep3)) (a__first Int) (a__last Int) (b (Array Int us_rep3)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_152 Int)) (=> (and (<= a__first temp___idx_152) (<= temp___idx_152 a__last)) (= (bool_eq9 (select a temp___idx_152) (select b (+ (- b__first a__first) temp___idx_152))) true)))) true false))
(assert (forall ((a (Array Int us_rep3)) (b (Array Int us_rep3))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq10 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_152 Int)) (=> (and (<= a__first temp___idx_152) (<= temp___idx_152 a__last)) (= (bool_eq9 (select a temp___idx_152) (select b (+ (- b__first a__first) temp___idx_152))) true))))))))
...
(assert (forall ((x filestatust)) (! (in_range13 (to_rep9 x)) :pattern ((to_rep9 x)))))
...
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq11 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_153 Int)) (=> (and (<= a__first temp___idx_153) (<= temp___idx_153 a__last)) (= (to_rep9 (select a temp___idx_153)) (to_rep9 (select b (+ (- b__first a__first) temp___idx_153)))))))))))
(declare-fun compare3 ((Array Int filestatust) Int Int (Array Int filestatust) Int Int) Int)
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare3 a a_first a_last b b_first b_last) 0) (= (bool_eq11 a a_first a_last b b_first b_last) true)) :pattern ((compare3 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare3 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq11 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep9 (select a (+ i 1))) (to_rep9 (select b (+ j 1))))))))))) :pattern ((compare3 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare3 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq11 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep9 (select b (+ i 1))) (to_rep9 (select a (+ j 1))))))))))) :pattern ((compare3 a a_first a_last b b_first b_last))))))
(declare-const attr__ATTRIBUTE_ADDRESS4 Int)
(declare-const attr__ATTRIBUTE_ADDRESS5 Int)
(declare-const attr__ATTRIBUTE_ADDRESS6 Int)
(declare-const attr__ATTRIBUTE_ADDRESS7 Int)
(declare-datatypes () ((us_split_fields6 (mk___split_fields3 (rec__keystore__optionalprivatekeyt__ispresent Bool) (rec__keystore__optionalprivatekeyt__owner us_rep)))))
(define-fun us_split_fields_IsPresent__projection ((a us_split_fields6)) Bool (rec__keystore__optionalprivatekeyt__ispresent a))
(define-fun us_split_fields_Owner__projection ((a us_split_fields6)) us_rep (rec__keystore__optionalprivatekeyt__owner a))
...
(define-fun bool_eq12 ((a us_rep4) (b us_rep4)) Bool (ite (and (= (rec__keystore__optionalprivatekeyt__ispresent (us_split_fields7 a)) (rec__keystore__optionalprivatekeyt__ispresent (us_split_fields7 b))) (= (bool_eq4 (rec__keystore__optionalprivatekeyt__owner (us_split_fields7 a)) (rec__keystore__optionalprivatekeyt__owner (us_split_fields7 b))) true)) true false))
...
(declare-fun user_eq24 (maskt maskt) Bool)
(declare-const dummy24 maskt)
...
(define-fun us_split_fields_Owner__2__projection ((a us_split_fields8)) us_rep (rec__keystore__interfac__keytemplatet__owner a))
...
(define-fun bool_eq13 ((a us_rep5) (b us_rep5)) Bool (ite (and (and (and (and (= (to_rep10 (rec__keystore__interfac__keytemplatet__attrmask (us_split_fields9 a))) (to_rep10 (rec__keystore__interfac__keytemplatet__attrmask (us_split_fields9 b)))) (= (bool_eq4 (rec__keystore__interfac__keytemplatet__owner (us_split_fields9 a)) (rec__keystore__interfac__keytemplatet__owner (us_split_fields9 b))) true)) (= (to_rep2 (rec__keystore__interfac__keytemplatet__keyid (us_split_fields9 a))) (to_rep2 (rec__keystore__interfac__keytemplatet__keyid (us_split_fields9 b))))) (= (to_rep2 (rec__keystore__interfac__keytemplatet__keylength (us_split_fields9 a))) (to_rep2 (rec__keystore__interfac__keytemplatet__keylength (us_split_fields9 b))))) (= (rec__keystore__interfac__keytemplatet__ispublic (us_split_fields9 a)) (rec__keystore__interfac__keytemplatet__ispublic (us_split_fields9 b)))) true false))
...
(declare-fun user_eq26 (returnvaluet returnvaluet) Bool)
(declare-const dummy26 returnvaluet)
...
(assert (forall ((a (Array Int Bool)) (b (Array Int Bool))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare4 a a_first a_last b b_first b_last) 0) (= (bool_eq14 a a_first a_last b b_first b_last) true)) :pattern ((compare4 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int Bool)) (b (Array Int Bool))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare4 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq14 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_int2 (select a (+ i 1))) (to_int2 (select b (+ j 1))))))))))) :pattern ((compare4 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int Bool)) (b (Array Int Bool))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare4 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq14 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_int2 (select b (+ i 1))) (to_int2 (select a (+ j 1))))))))))) :pattern ((compare4 a a_first a_last b b_first b_last))))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1610 us_void_param) 1)) 73) (= (to_rep (select (temp___String_Literal_1610 us_void_param) 2)) 110)) (= (to_rep (select (temp___String_Literal_1610 us_void_param) 3)) 105)) (= (to_rep (select (temp___String_Literal_1610 us_void_param) 4)) 116)) (= (to_rep (select (temp___String_Literal_1610 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_1610 us_void_param) 6)) 97)) (= (to_rep (select (temp___String_Literal_1610 us_void_param) 7)) 108)) (= (to_rep (select (temp___String_Literal_1610 us_void_param) 8)) 105)) (= (to_rep (select (temp___String_Literal_1610 us_void_param) 9)) 122)) (= (to_rep (select (temp___String_Literal_1610 us_void_param) 10)) 101)) :pattern ((temp___String_Literal_1610 us_void_param)))))
...
(define-fun dynamic_invariant10 ((temp___expr_889 Int) (temp___is_init_886 Bool) (temp___skip_constant_887 Bool) (temp___do_toplevel_888 Bool)) Bool (=> (or (= temp___is_init_886 true) (<= 0 40)) (in_range7 temp___expr_889)))
(declare-fun cryptotypes__blankname__aggregate_def (Int) (Array Int character))
(assert (forall ((temp___140 Int)) (forall ((temp___141 Int)) (= (select (cryptotypes__blankname__aggregate_def temp___140) temp___141) (of_rep temp___140)))))
(assert (= blankname (cryptotypes__blankname__aggregate_def 32)))
(define-fun dynamic_invariant11 ((temp___expr_910 Int) (temp___is_init_907 Bool) (temp___skip_constant_908 Bool) (temp___do_toplevel_909 Bool)) Bool (=> (or (= temp___is_init_907 true) (<= 0 4294967295)) (in_range8 temp___expr_910)))
...
(define-fun dynamic_invariant13 ((temp___expr_1103 Int) (temp___is_init_1100 Bool) (temp___skip_constant_1101 Bool) (temp___do_toplevel_1102 Bool)) Bool (=> (or (= temp___is_init_1100 true) (<= 0 17)) (in_range11 temp___expr_1103)))
(define-fun dynamic_invariant14 ((temp___expr_1082 Int) (temp___is_init_1079 Bool) (temp___skip_constant_1080 Bool) (temp___do_toplevel_1081 Bool)) Bool (=> (or (= temp___is_init_1079 true) (<= 1 17)) (in_range9 temp___expr_1082)))
(define-fun dynamic_invariant15 ((temp___expr_1207 Int) (temp___is_init_1204 Bool) (temp___skip_constant_1205 Bool) (temp___do_toplevel_1206 Bool)) Bool (=> (or (= temp___is_init_1204 true) (<= 0 2)) (in_range13 temp___expr_1207)))
(define-fun dynamic_invariant16 ((temp___expr_1088 Int) (temp___is_init_1085 Bool) (temp___skip_constant_1086 Bool) (temp___do_toplevel_1087 Bool)) Bool (=> (or (= temp___is_init_1085 true) (<= 0 17408)) (in_range10 temp___expr_1088)))
(define-fun dynamic_invariant17 ((temp___expr_1122 Int) (temp___is_init_1119 Bool) (temp___skip_constant_1120 Bool) (temp___do_toplevel_1121 Bool)) Bool (=> (or (= temp___is_init_1119 true) (<= 0 1024)) (in_range12 temp___expr_1122)))
(assert true)
...
(declare-const temp___1630 issueridt)
(declare-const temp___16301 namecountt)
(declare-const temp___16302 (Array Int character))
...
(declare-const keystore__init__theprivatekey__assume us_rep5)
(declare-const temp___1611 us_t1)
(declare-const o15 us_t1)
(declare-const o16 (Array Int character))
(declare-const o17 us_t)
(declare-const result us_split_fields__ref4)
(declare-const theprivatekey__split_fields7 us_split_fields8)
...
(assert (= o o3))
(assert (= blankname o4))
(assert (= temp___1630 o2))
(assert (= temp___16301 o3))
(assert (= temp___16302 o4))
(assert (= (mk___rep (mk___split_fields temp___1630 temp___16301 temp___16302)) nullissuer))
...
(assert (= (to_rep2 o5) 0))
(assert (= (to_rep2 o6) 0))
(assert (= (to_rep10 o7) ((_ int2bv 32) 1)))
(assert (= o7 o8))
(assert (= nullissuer (mk___rep (mk___split_fields o9 o10 o11))))
(assert (= o6 o12))
(assert (= o5 o13))
(assert (= (of_int 0) o14))
(assert (= keystore__init__theprivatekey__assume (mk___rep4 (mk___split_fields4 o8 (mk___rep (mk___split_fields o9 o10 o11)) o12 o13 o14))))
(assert (= result (mk___split_fields__ref4 (mk___split_fields4 theprivatekey__split_fields (mk___rep (mk___split_fields theprivatekey__split_fields1 theprivatekey__split_fields2 theprivatekey__split_fields3)) theprivatekey__split_fields4 theprivatekey__split_fields5 theprivatekey__split_fields6))))
(assert (= theprivatekey__split_fields7 (us_split_fields9 keystore__init__theprivatekey__assume)))
(assert (in_range15 retval1))
(assert (= (select issystem retval1) true))
(assert (not (dynamic_property1 1 2147483647 1 10)))
(check-sat)
(exit)
