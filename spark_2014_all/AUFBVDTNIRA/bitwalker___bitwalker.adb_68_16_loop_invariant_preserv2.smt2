...
(assert (<= 0 i1))
(assert (<= i1 (- length1 1)))
(assert (forall ((j Int)) (=> (and (<= (- length1 i2) j) (<= j (- length1 1))) (= (= (nth8_stream addr (- (- (+ start length1) j) 1)) true) (= (nth retval2 j) true)))))
(assert (forall ((j Int)) (=> (and (<= length1 j) (<= j 63)) (not (= (nth retval2 j) true)))))
(assert (and (=> (<= 0 (- length1 1)) (dynamic_property1 0 (- length1 1) i2)) (and (<= 0 i2) (<= i2 (- length1 1)))))
(assert (and (= o4 (+ start i2)) (in_range1 (+ start i2))))
(assert (and (= o5 (peekbit8array addr o4)) (and (= (= o5 true) (= (peekbit8 (to_rep1 (select (elts addr) (div1 o4 8))) (mod1 o4 8)) true)) (= (= o5 true) (= (nth8_stream addr o4) true)))))
(assert (= flag result3))
(assert (= flag1 o5))
(assert (and (= o6 (+ (- 64 length1) i2)) (in_range1 (+ (- 64 length1) i2))))
(assert (and (= o7 o6) (in_range2 o6)))
(assert (and (= o8 (pokebit64 retval2 o7 flag1)) (and (forall ((i4 Int)) (=> (and (<= 0 i4) (<= i4 63)) (=> (not (= i4 (- 63 o7))) (= (= (nth o8 i4) true) (= (nth retval2 i4) true))))) (= (= flag1 true) (= (nth o8 (- 63 o7)) true)))))
