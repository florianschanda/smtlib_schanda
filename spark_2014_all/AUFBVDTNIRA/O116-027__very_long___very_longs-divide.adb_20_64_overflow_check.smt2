...
(assert (and (= o1 (* 2 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 divisor))))) (in_range1 (* 2 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 divisor)))))))
(assert (= o2 (- o1 1)))
