...
(assert (<= divisor_index1 r134b))
(assert (and (dynamic_invariant6 (mk___rep1 u__split_discrs u__split_fields2) true true true true) (and (<= 1 divisor_index2) (<= divisor_index2 r134b))))
...
(assert (= temp___1418 (- o16 1)))
(assert (and (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields2)))) temp___1418) (<= temp___1418 (to_rep1 (last3 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields2)))))))
(assert (= o17 temp___1418))
...
(assert (= temp___1421 (- o27 1)))
(assert (not (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields2)))) temp___1421)))
(check-sat)
(exit)
