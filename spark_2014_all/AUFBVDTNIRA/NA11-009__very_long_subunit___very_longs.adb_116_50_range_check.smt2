...
(assert (forall ((x tdigit_count_typeB)) (! (in_range3 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun dynamic_invariant1 ((temp___expr_228 Int) (temp___is_init_224 Bool) (temp___skip_constant_225 Bool) (temp___do_toplevel_226 Bool) (temp___do_typ_inv_227 Bool)) Bool (=> (or (= temp___is_init_224 true) (<= 1 65536)) (in_range2 temp___expr_228)))
...
(declare-fun temp_____aggregate_def_863 ((_ BitVec 8) Int Int) us_t2)
...
(assert (forall ((temp___865 (_ BitVec 8))) (forall ((temp___866 Int) (temp___867 Int)) (let ((temp___864 (temp_____aggregate_def_863 temp___865 temp___866 temp___867))) (=> (dynamic_invariant3 temp___865 true true true true) (and (=> (dynamic_property6 1 65536 temp___866 temp___867) (and (= (first5 temp___864) temp___866) (= (last5 temp___864) temp___867))) (forall ((temp___868 Int)) (= (to_rep2 (select (to_array2 temp___864) temp___868)) temp___865))))))))
...
(assert (and (= us length1) (in_range2 length1)))
...
(assert (= (to_rep (rec__very_longs__very_long__length result____split_discrs)) length1))
(assert (= (to_rep1 (first4 (rt2 (temp_____aggregate_def_863 #x00 1 length1)))) 1))
(assert (= (to_rep1 (last4 (rt2 (temp_____aggregate_def_863 #x00 1 length1)))) length1))
(assert (= (mk___t2 temp___870 temp___8701) (temp_____aggregate_def_863 #x00 1 length1)))
(assert (= (ite (<= (to_rep1 (first4 temp___8701)) (to_rep1 (last4 temp___8701))) (+ (- (to_rep1 (last4 temp___8701)) (to_rep1 (first4 temp___8701))) 1) 0) (ite (<= 1 length1) (+ (- length1 1) 1) 0)))
(assert (= temp___870 temp___871))
(assert (= (mk1 (to_rep1 (first4 temp___8701)) (to_rep1 (last4 temp___8701))) temp___8711))
(assert (= (ite (<= (to_rep1 (first2 temp___8711)) (to_rep1 (last2 temp___8711))) (+ (- (to_rep1 (last2 temp___8711)) (to_rep1 (first2 temp___8711))) 1) 0) (ite (<= (to_rep1 (first2 result____split_fields1)) (to_rep1 (last2 result____split_fields1))) (+ (- (to_rep1 (last2 result____split_fields1)) (to_rep1 (first2 result____split_fields1))) 1) 0)))
...
(assert (= temp1 number))
(assert (= (to_rep1 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields2)))) r26b))
(assert (in_range3 r26b))
(assert (= result2 (mk_int__ref index)))
(assert (= index1 1))
(assert (<= 1 index1))
(assert (<= index1 r26b))
(assert (and (and (and (dynamic_invariant2 (mk___rep1 result____split_discrs result____split_fields3) false true true true) (forall ((temp___882 Int)) (=> (and (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))) temp___882) (<= temp___882 (to_rep1 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))))) (=> (or (< r26b temp___882) (or (< temp___882 1) (<= index2 temp___882))) (= (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields3)) temp___882) (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields2)) temp___882)))))) (=> (<= 0 2147483647) (in_range1 temp2))) (and (<= 1 index2) (<= index2 r26b))))
