...
(assert (= o48 (bvadd o47 #x0000000000000001)))
(assert (= o49 (bvmul o48 #x0000000000000020)))
(assert (= o50 (ite (bvult i2 o49) true false)))
(assert (= o42 (from_word32 #x00000001)))
...
(assert (and (= o33 (base Tuple0)) (= o33 (oexpon (from_word32 #x00000002) 32))))
