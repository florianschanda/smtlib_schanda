...
(assert (and (= o45 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (and (= o46 o45) (uint_in_range1 o45)))
(assert (= o47 ((_ int2bv 64) o46)))
(assert (= o48 (bvadd o47 ((_ int2bv 64) 1))))
(assert (= o49 (bvmul o48 ((_ int2bv 64) 32))))
(assert (= o50 (ite (bvult i2 o49) true false)))
(assert (= o42 (from_word32 ((_ int2bv 32) 1))))
(assert (= o41 (from_word64 i2)))
(assert (= o43 (oadd o41 o42)))
(assert (= o40 (from_integer (int__content s12))))
(assert (= o44 (ole o40 o43)))
(assert (and (= o16 (power 2 k)) (in_range1 (power 2 k))))
(assert (= o17 (- o16 1)))
(assert (and (= o18 o17) (in_range1 o17)))
(assert (= o19 (ite (<= n o18) true false)))
(assert (= result9 (ite (<= 0 n) o19 false)))
(assert (= result9 true))
(assert (and (= o37 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o38 (num_of_big_int m m_first o37)))
(assert (and (= o34 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (and (= o33 (base Tuple0)) (= o33 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o35 (oexpon o33 o34)))
(assert (and (= o28 (* 2 n)) (in_range1 (* 2 n))))
(assert (= o29 (+ o28 1)))
...
(assert (= o32 (oexpon o27 o31)))
(assert (= o36 (omultiply o32 o35)))
(assert (= o39 (omod o36 o38)))
(assert (and (= o25 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (and (= o20 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o21 (* n o20)))
(assert (and (= o22 o21) (in_range1 o21)))
(assert (= o23 (+ aux4_first o22)))
