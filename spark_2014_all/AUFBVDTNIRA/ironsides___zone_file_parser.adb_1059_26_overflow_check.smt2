...
(define-fun dynamic_invariant2 ((temp___expr_298 Int) (temp___is_init_294 Bool) (temp___skip_constant_295 Bool) (temp___do_toplevel_296 Bool) (temp___do_typ_inv_297 Bool)) Bool (=> (or (= temp___is_init_294 true) (<= 0 10)) (in_range4 temp___expr_298)))
...
(define-fun dynamic_invariant3 ((temp___expr_305 Int) (temp___is_init_301 Bool) (temp___skip_constant_302 Bool) (temp___do_toplevel_303 Bool) (temp___do_typ_inv_304 Bool)) Bool (=> (or (= temp___is_init_301 true) (<= 1 256)) (in_range5 temp___expr_305)))
...
(assert (and (and (and (and (<= begidx2 endidx1) (<= begidx2 zlength)) (<= endidx1 zlength)) (=> (= foundtype1 1) (forall ((i3 Int)) (=> (and (<= begidx2 i3) (<= i3 endidx1)) (and (<= 48 (to_rep (select zonefileline i3))) (<= (to_rep (select zonefileline i3)) 57)))))) (and (and (in_range5 begidx2) (in_range5 endidx1)) (in_range4 foundtype1))))
(assert (= foundtype1 1))
...
(assert (not (in_range2 (* 10 tmpval2))))
(check-sat)
(exit)
