...
(assert (in_range15 c70b))
(assert (= result3 (mk_map__ref result__)))
(assert (= result__5 nodescription))
(assert (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE15 c70b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE15 c70b)))))) (= o (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE15 c70b))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE15 c70b)))))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE15 c70b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE15 c70b))))))) (= o 0)))
...
(assert (= keystore__dofind__B74b__thestring__assume (mk___t (concat1 (temp___String_Literal_1775 Tuple0) 1 43 (elts (to_string (attr__ATTRIBUTE_IMAGE15 c70b))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE15 c70b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE15 c70b)))))) (mk 1 o5))))
(assert (= keystore__dofind__B74b__thestring__assume thestring))
...
(assert (=> (= result4 true) (= (ite (<= (to_rep1 (first (rt thestring))) (to_rep1 (last (rt thestring)))) (+ (- (to_rep1 (last (rt thestring))) (to_rep1 (first (rt thestring)))) 1) 0) (ite (<= 1 (length thestring)) (+ (- (length thestring) 1) 1) 0))))
(assert (=> (= result4 true) (= temp___1769 (mk___t1 (slide (elts thestring) (to_rep1 (first (rt thestring))) 1) (mk1 1 (length thestring))))))
(assert (=> (= result4 true) (and (= temp___1771 (length thestring)) (in_range1 (length thestring)))))
(assert (=> (= result4 true) (=> (<= 1 temp___1771) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 temp___1771) (<= temp___1771 150))))))
(assert (=> (= result4 true) (= o7 result__5)))
(assert (=> (= result4 true) (= temp___1772 (mk___t1 o7 (mk1 1 temp___1771)))))
(assert (=> (= result4 true) (= (ite (<= (to_rep1 (first2 (rt1 temp___1769))) (to_rep1 (last2 (rt1 temp___1769)))) (+ (- (to_rep1 (last2 (rt1 temp___1769))) (to_rep1 (first2 (rt1 temp___1769)))) 1) 0) (ite (<= (to_rep1 (first2 (rt1 temp___1772))) (to_rep1 (last2 (rt1 temp___1772)))) (+ (- (to_rep1 (last2 (rt1 temp___1772))) (to_rep1 (first2 (rt1 temp___1772)))) 1) 0))))
(assert (=> (= result4 true) (= temp___1773 temp___1769)))
(assert (=> (= result4 true) (forall ((temp___1774 Int)) (ite (and (<= 1 temp___1774) (<= temp___1774 (length thestring))) (= (select o8 temp___1774) (select (elts1 temp___1773) temp___1774)) (= (select o8 temp___1774) (select result__5 temp___1774))))))
(assert (=> (= result4 true) (= result5 (mk_map__ref result__5))))
(assert (=> (= result4 true) (= result__6 o8)))
(assert (=> (not (= result4 true)) (=> (<= 1 150) (and (and (<= (to_rep1 (first (rt thestring))) 1) (<= 1 (to_rep1 (last (rt thestring))))) (and (<= (to_rep1 (first (rt thestring))) 150) (<= 150 (to_rep1 (last (rt thestring)))))))))
(assert (=> (not (= result4 true)) (= temp___1768 thestring)))
(assert (=> (not (= result4 true)) (= o9 (elts temp___1768))))
(assert (=> (not (= result4 true)) (= result6 (mk_map__ref result__5))))
(assert (=> (not (= result4 true)) (= result__7 o9)))
(assert (=> (not (= result4 true)) (= result__6 result__7)))
(assert (= result7 (mk_map__ref c72b)))
(assert (= c72b2 result__6))
