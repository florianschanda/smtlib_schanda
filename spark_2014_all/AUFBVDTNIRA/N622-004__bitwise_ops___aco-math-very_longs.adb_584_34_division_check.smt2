...
(assert (forall ((x digit_index_type)) (! (in_range (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(assert (and (= us (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 number)))) (in_range (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 number))))))
