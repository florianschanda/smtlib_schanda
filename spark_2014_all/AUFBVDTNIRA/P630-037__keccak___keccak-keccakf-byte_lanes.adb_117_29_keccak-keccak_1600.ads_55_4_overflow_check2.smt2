...
(assert (= i1 0))
(assert (and (= o3 (* i1 8)) (in_range1 (* i1 8))))
(assert (and (= o4 o3) (in_range2 o3)))
(assert (= o5 ((_ int2bv 64) o4)))
(assert (= o6 (bvlshr lane1 o5)))
(assert (= o7 (bvand o6 #x00000000000000FF)))
(assert (= o8 o7))
(assert (= o9 ((_ extract 7 0) o8)))
(assert (= (to_rep1 o10) o9))
(assert (not (in_range1 (+ (to_rep data__first) offset2))))
(check-sat)
(exit)
