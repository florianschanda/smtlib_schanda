...
(assert (and (= o53 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (and (= o54 o53) (uint_in_range1 o53)))
(assert (= o55 ((_ int2bv 64) o54)))
(assert (= o56 (bvadd o55 ((_ int2bv 64) 1))))
(assert (= o57 (bvmul o56 ((_ int2bv 64) 32))))
(assert (= o58 (ite (bvult i2 o57) true false)))
(assert (= o50 (from_word32 ((_ int2bv 32) 1))))
(assert (= o49 (from_word64 i2)))
(assert (= o51 (oadd o49 o50)))
(assert (= o48 (from_integer j3)))
(assert (= o52 (ole o48 o51)))
(assert (and (= o46 (+ k 1)) (in_range1 (+ k 1))))
(assert (= o47 (ite (<= j3 o46) true false)))
(assert (= o42 (from_word32 ((_ int2bv 32) 2))))
(assert (= o43 (oexpon o42 j3)))
(assert (= o37 (from_word32 ((_ int2bv 32) 1))))
(assert (= o36 (from_integer j3)))
(assert (= o38 (osubtract o36 o37)))
(assert (= o35 (from_word64 i2)))
(assert (= o39 (osubtract o35 o38)))
(assert (= o34 (from_word32 ((_ int2bv 32) 2))))
(assert (= o40 (oexpon__2 o34 o39)))
(assert (and (= o29 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (= o30 (+ o29 1)))
(assert (and (= o31 o30) (in_range1 o30)))
(assert (and (= o32 o31) (in_range2 o31)))
(assert (= o33 (num_of_big_int e e_first o32)))
(assert (= o41 (odivide o33 o40)))
(assert (= o44 (omod o41 o43)))
(assert (and (= o23 (- j3 s3)) (in_range1 (- j3 s3))))
(assert (= o24 (- o23 1)))
(assert (and (= o25 o24) (in_range1 o24)))
(assert (and (= o26 o25) (in_range2 o25)))
(assert (= o22 (from_word32 ((_ int2bv 32) 2))))
(assert (= o27 (oexpon o22 o26)))
(assert (= o21 (from_word32 w2)))
(assert (= o28 (omultiply o21 o27)))
(assert (= o45 (oeq o28 o44)))
(assert (and (= o8 (power 2 k)) (in_range1 (power 2 k))))
(assert (= o9 (- o8 1)))
(assert (and (= o10 o9) (in_range1 o9)))
(assert (= o11 (ite (<= n o10) true false)))
(assert (= result6 (ite (<= 0 n) o11 false)))
(assert (= result6 true))
...
(assert (and (= o12 (* 2 n)) (in_range1 (* 2 n))))
(assert (= o13 (+ o12 1)))
