...
(define-fun ctx__split_fields12 () us_split_fields (mk___split_fields ctx__split_fields6 ctx__split_fields7 ctx__split_fields8 ctx__split_fields9 ctx__split_fields10 ctx__split_fields11))
...
(assert (= (mod2 bit_length 8) 0))
(assert (and (and (and (= (state_of (mk___rep ctx__split_fields12)) 0) (= (rate_of (mk___rep ctx__split_fields12)) (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5))))) (= (mod2 (in_queue_bit_length (mk___rep ctx__split_fields12)) 8) (mod2 bit_length 8))) (< (in_queue_bit_length (mk___rep ctx__split_fields12)) (rate_of (mk___rep ctx__split_fields12)))))
(assert (= (to_rep3 o4) suffix))
(assert (= o5 (store suffix_array1 0 o4)))
(assert (= suffix_array1 result3))
(assert (= suffix_array2 o5))
(assert (not (<= suffix_len 2147483640)))
(check-sat)
(exit)
