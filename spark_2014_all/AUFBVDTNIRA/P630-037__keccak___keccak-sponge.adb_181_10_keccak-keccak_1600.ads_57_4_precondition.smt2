...
(assert (= (to_rep o10) suffix))
(assert (= o11 (store suffix_array1 0 o10)))
(assert (= suffix_array1 result5))
(assert (= suffix_array2 o11))
(assert (not (= (state_of (mk___rep (mk___split_fields ctx__split_fields24 ctx__split_fields25 ctx__split_fields26 ctx__split_fields27 ctx__split_fields28 ctx__split_fields29))) 0)))
(check-sat)
(exit)
