...
(assert (and (= o72 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o73 (+ x_first o72)))
(assert (and (= o74 o73) (in_range1 o73)))
(assert (= o75 (ite (<= o74 (to_rep (last (rt x)))) true false)))
(assert (and (= o69 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o70 (+ x_first o69)))
(assert (and (= o71 o70) (in_range1 o70)))
(assert (= o76 (ite (<= (to_rep (first (rt x))) o71) true false)))
(assert (= result (ite (= o76 true) o75 false)))
(assert (= result true))
...
(assert (and (= o64 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o65 (+ m_first o64)))
(assert (and (= o66 o65) (in_range1 o65)))
(assert (= o67 (ite (<= o66 (to_rep (last (rt m)))) true false)))
(assert (and (= o61 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o62 (+ m_first o61)))
(assert (and (= o63 o62) (in_range1 o62)))
(assert (= o68 (ite (<= (to_rep (first (rt m))) o63) true false)))
(assert (= result1 (ite (= o68 true) o67 false)))
(assert (= result1 true))
(assert (<= (to_rep aux1__first) aux1_first))
(assert (<= aux1_first (to_rep aux1__last)))
(assert (and (= o56 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o57 (+ aux1_first o56)))
(assert (and (= o58 o57) (in_range1 o57)))
(assert (= o59 (ite (<= o58 (to_rep aux1__last)) true false)))
(assert (and (= o53 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o54 (+ aux1_first o53)))
(assert (and (= o55 o54) (in_range1 o54)))
(assert (= o60 (ite (<= (to_rep aux1__first) o55) true false)))
(assert (= result2 (ite (= o60 true) o59 false)))
(assert (= result2 true))
(assert (<= (to_rep aux2__first) aux2_first))
(assert (<= aux2_first (to_rep aux2__last)))
(assert (and (= o48 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o49 (+ aux2_first o48)))
(assert (and (= o50 o49) (in_range1 o49)))
(assert (= o51 (ite (<= o50 (to_rep aux2__last)) true false)))
(assert (and (= o45 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o46 (+ aux2_first o45)))
(assert (and (= o47 o46) (in_range1 o46)))
(assert (= o52 (ite (<= (to_rep aux2__first) o47) true false)))
(assert (= result3 (ite (= o52 true) o51 false)))
(assert (= result3 true))
...
(assert (= o41 (+ aux3_first o40)))
(assert (and (= o42 o41) (in_range1 o41)))
(assert (= o43 (ite (<= o42 (to_rep aux3__last)) true false)))
(assert (and (= o37 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o38 (+ aux3_first o37)))
(assert (and (= o39 o38) (in_range1 o38)))
(assert (= o44 (ite (<= (to_rep aux3__first) o39) true false)))
(assert (= result4 (ite (= o44 true) o43 false)))
(assert (= result4 true))
...
(assert (= o6 (num_of_big_int m m_first o5)))
