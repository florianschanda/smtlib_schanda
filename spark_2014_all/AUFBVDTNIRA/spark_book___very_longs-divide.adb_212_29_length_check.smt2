...
(assert (not (= (ite (<= (to_rep1 (first13 (rt6 temp___1158))) (to_rep1 (last14 (rt6 temp___1158)))) (+ (- (to_rep1 (last14 (rt6 temp___1158))) (to_rep1 (first13 (rt6 temp___1158)))) 1) 0) (ite (<= 1 r135b) (+ (- r135b 1) 1) 0))))
(check-sat)
(exit)
