...
(assert (not (= (ite (<= (to_rep2 (first13 (rt6 temp___1089))) (to_rep2 (last14 (rt6 temp___1089)))) (+ (- (to_rep2 (last14 (rt6 temp___1089))) (to_rep2 (first13 (rt6 temp___1089)))) 1) 0) (ite (<= 1 r135b) (+ (- r135b 1) 1) 0))))
(check-sat)
(exit)
