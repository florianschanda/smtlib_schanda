...
(assert (<= (to_rep4 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields7)) (to_rep3 (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields7))))
(assert (= result5 (mk___split_fields__ref ctx__split_fields7)))
(assert (= ctx__split_fields8 (mk___split_fields keccak__keccak_1600__keccakf_1600_permutation__permute__a (rec__keccak__keccak_1600__sponge__context__block ctx__split_fields7) (rec__keccak__keccak_1600__sponge__context__bits_absorbed ctx__split_fields7) (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields7) (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields7) (rec__keccak__keccak_1600__sponge__context__curr_state ctx__split_fields7))))
(assert (= (- (to_rep4 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields8)) 1) r137s))
(assert (in_range1 r137s))
(assert (=> (<= 0 r137s) (and (and (<= 0 0) (<= 0 199)) (and (<= 0 r137s) (<= r137s 199)))))
(assert (= o5 (rec__keccak__keccak_1600__sponge__context__block ctx__split_fields8)))
(assert (= o5 keccak__keccak_1600__keccakf_1600_lanes__extract_bytes__data__compl))
(assert (= (mk2 0 r137s) keccak__keccak_1600__keccakf_1600_lanes__extract_bytes__data__compl1))
(assert (= (to_rep o7) (to_rep (last4 keccak__keccak_1600__keccakf_1600_lanes__extract_bytes__data__compl1))))
(assert (= (to_rep o6) (to_rep (first4 keccak__keccak_1600__keccakf_1600_lanes__extract_bytes__data__compl1))))
(assert (not (<= (ite (<= (to_rep o6) (to_rep o7)) (+ (- (to_rep o7) (to_rep o6)) 1) 0) 200)))
(check-sat)
(exit)
