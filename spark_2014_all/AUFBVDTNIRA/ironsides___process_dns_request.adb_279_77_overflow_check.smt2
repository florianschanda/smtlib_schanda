...
(define-fun bytes20 () map__ref1 (mk_map__ref1 bytes5))
...
(assert (=> (and (<= 1 i1) (<= i1 r15b)) (= bytes20 (mk_map__ref1 bytes3))))
...
(assert (=> (not (and (<= 1 block1) (<= block1 (to_rep3 (rec__rr_type__nsec_record_type__nsecrecordtype__numberofblocks (us_split_fields3 nsec_record)))))) (= bytes18 bytes20)))
...
(assert (not (in_range1 (* (to_rep3 (rec__rr_type__nsec_record_type__nsecrecordtype__numberofblocks (us_split_fields3 nsec_record))) 2))))
(check-sat)
(exit)
