...
(declare-const temp___326 Int)
(declare-const temp___325 Bool)
(declare-const temp___324 (_ BitVec 64))
...
(assert (or (and (and (and (= bitwalker__peek__result6 (mk_t__ref bitwalker__peek__result2)) (and (= i10 i15) (and (= flag10 flag15) (= retval11 retval17)))) (and (= bitwalker__peek__result7 bitwalker__peek__result2) (and (= i11 i1) (and (= flag11 flag1) (= retval12 retval1))))) (and (and (and (and (and (= o (length addr)) (in_range1 (length addr))) (= o1 (* 8 o))) (and (= o2 o1) (in_range1 o1))) (and (and (= o3 (+ start length1)) (in_range1 (+ start length1))) (= result (ite (< o2 o3) true false)))) (and (= result true) (and (= result1 bitwalker__peek__result) (= bitwalker__peek__result2 #x0000000000000000))))) (and (and (and (and (and (and (= o (length addr)) (in_range1 (length addr))) (= o1 (* 8 o))) (and (= o2 o1) (in_range1 o1))) (and (and (= o3 (+ start length1)) (in_range1 (+ start length1))) (= result (ite (< o2 o3) true false)))) (and (not (= result true)) (and (= bitwalker__peek__result2 bitwalker__peek__result) (= bitwalker__peek__result2 bitwalker__peek__result1)))) (and (and (and (= bitwalker__peek__result6 bitwalker__peek__result4) (and (= i10 i8) (and (= flag10 flag8) (= retval11 retval15)))) (and (= bitwalker__peek__result7 bitwalker__peek__result5) (and (= i11 i9) (and (= flag11 flag9) (= retval12 retval10))))) (and (and (and (= bitwalker__peek__result4 (mk_t__ref bitwalker__peek__result3)) (and (= i8 i14) (and (= flag8 flag14) (= retval15 retval16)))) (and (= bitwalker__peek__result5 bitwalker__peek__result3) (and (= i9 i7) (and (= flag9 flag7) (= retval10 retval8))))) (and (and (= (mk_t__ref result2) retval17) (= retval2 #x0000000000000000)) (and (and (and (= (mk_int__ref result3) i15) (= i2 0)) (ite (and (<= 0 i2) (<= i2 (- length1 1))) (and (and (and (= temp___326 i2) (and (= temp___325 flag) (and (= temp___324 retval2) (and (and (forall ((j Int)) (=> (and (<= (- length1 i3) j) (<= j (- length1 1))) (= (= (nth8_stream addr (- (- (+ start length1) j) 1)) true) (= (nth retval3 j) true)))) (forall ((j Int)) (=> (and (<= length1 j) (<= j 63)) (not (= (nth retval3 j) true))))) (and (and (=> (<= 0 (- length1 1)) (dynamic_property1 0 (- length1 1) i3)) (and (<= 0 i3) (<= i3 (- length1 1)))) (and (and (and (and (= o4 (+ start i3)) (in_range1 (+ start i3))) (and (= o5 (peekbit8array addr o4)) (and (= (= o5 true) (= (peekbit8 (to_rep1 (select (elts addr) (div1 o4 8))) (mod1 o4 8)) true)) (= (= o5 true) (= (nth8_stream addr o4) true))))) (and (= flag2 result4) (= flag3 o5))) (and (and (and (and (and (= o6 (+ (- 64 length1) i3)) (in_range1 (+ (- 64 length1) i3))) (and (= o7 o6) (in_range2 o6))) (and (= o8 (pokebit64 retval3 o7 flag3)) (and (forall ((i16 Int)) (=> (and (<= 0 i16) (<= i16 63)) (=> (not (= i16 (- 63 o7))) (= (= (nth o8 i16) true) (= (nth retval3 i16) true))))) (= (= flag3 true) (= (nth o8 (- 63 o7)) true))))) (and (= retval3 result5) (= retval4 o8))) (= i3 (- length1 1))))))))) (and (and (= i3 i4) (and (= flag3 flag4) (= retval4 retval5))) (and (= i5 i3) (and (= flag5 flag3) (= retval6 retval4))))) (and (and (= i14 (mk_int__ref i4)) (and (= flag14 (mk_bool__ref flag4)) (= retval16 (mk_t__ref retval5)))) (and (= i7 i5) (and (= flag7 flag5) (= retval8 retval6))))) (and (and (= i2 i6) (and (= flag14 flag15) (= retval2 retval7))) (and (= i7 i2) (and (= flag7 flag1) (= retval8 retval2)))))) (and (= result6 bitwalker__peek__result2) (= bitwalker__peek__result3 retval7)))))))))
...
(assert (not (= (t__content bitwalker__peek__result8) #x0000000000000000)))
(check-sat)
(exit)
