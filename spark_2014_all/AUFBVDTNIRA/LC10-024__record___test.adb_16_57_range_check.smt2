...
(define-fun in_range1 ((x (_ BitVec 8))) Bool (and (bvule ((_ int2bv 8) 0) x) (bvule x ((_ int2bv 8) 4))))
...
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x ((_ int2bv 8) 5)))) (=> (in_range1 y) (= (to_rep1 (of_rep1 x)) y))) :pattern ((to_rep1 (of_rep1 x))))))
...
(define-fun bool_eq ((a (Array (_ BitVec 8) integer)) (a__first (_ BitVec 8)) (a__last (_ BitVec 8)) (b (Array (_ BitVec 8) integer)) (b__first (_ BitVec 8)) (b__last (_ BitVec 8))) Bool (ite (and (ite (bvule a__first a__last) (and (bvule b__first b__last) (= (bvsub a__last a__first) (bvsub b__last b__first))) (bvugt b__first b__last)) (forall ((temp___idx_132 (_ BitVec 8))) (=> (and (bvule a__first temp___idx_132) (bvule temp___idx_132 a__last)) (= (to_rep2 (select a temp___idx_132)) (to_rep2 (select b (bvadd (bvsub b__first a__first) temp___idx_132))))))) true false))
(assert (forall ((a (Array (_ BitVec 8) integer)) (b (Array (_ BitVec 8) integer))) (forall ((a__first (_ BitVec 8)) (a__last (_ BitVec 8)) (b__first (_ BitVec 8)) (b__last (_ BitVec 8))) (=> (= (bool_eq b b__first b__last a a__first a__last) true) (and (ite (bvule a__first a__last) (and (bvule b__first b__last) (= (bvsub a__last a__first) (bvsub b__last b__first))) (bvugt b__first b__last)) (forall ((temp___idx_132 (_ BitVec 8))) (=> (and (bvule a__first temp___idx_132) (bvule temp___idx_132 a__last)) (= (to_rep2 (select a temp___idx_132)) (to_rep2 (select b (bvadd (bvsub b__first a__first) temp___idx_132)))))))))))
...
(assert (forall ((a (Array (_ BitVec 8) integer)) (b (Array (_ BitVec 8) integer))) (forall ((a_first (_ BitVec 8)) (a_last (_ BitVec 8)) (b_first (_ BitVec 8)) (b_last (_ BitVec 8))) (! (= (< (compare a a_first a_last b b_first b_last) 0) (exists ((i (_ BitVec 8)) (j (_ BitVec 8))) (and (bvule i a_last) (and (bvult j b_last) (and (= (bool_eq a a_first i b b_first j) true) (or (= i a_last) (and (bvult i a_last) (< (to_rep2 (select a (bvadd i #x01))) (to_rep2 (select b (bvadd j #x01))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array (_ BitVec 8) integer)) (b (Array (_ BitVec 8) integer))) (forall ((a_first (_ BitVec 8)) (a_last (_ BitVec 8)) (b_first (_ BitVec 8)) (b_last (_ BitVec 8))) (! (= (< 0 (compare a a_first a_last b b_first b_last)) (exists ((i (_ BitVec 8)) (j (_ BitVec 8))) (and (bvule i b_last) (and (bvult j a_last) (and (= (bool_eq a a_first j b b_first i) true) (or (= i b_last) (and (bvult i b_last) (< (to_rep2 (select b (bvadd i #x01))) (to_rep2 (select a (bvadd j #x01))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
...
(define-fun bool_eq1 ((a us_rep) (b us_rep)) Bool (ite (and (and (= (to_rep (rec__test__t__remaining (us_split_fields1 a))) (to_rep (rec__test__t__remaining (us_split_fields1 b)))) (= (to_rep1 (rec__test__t__index (us_split_fields1 a))) (to_rep1 (rec__test__t__index (us_split_fields1 b))))) (= (bool_eq (rec__test__t__cards (us_split_fields1 a)) ((_ int2bv 8) 0) ((_ int2bv 8) 4) (rec__test__t__cards (us_split_fields1 b)) ((_ int2bv 8) 0) ((_ int2bv 8) 4)) true)) true false))
...
(assert (forall ((s us_rep)) (! (dynamic_invariant (get_remaining s) true false true) :pattern ((get_remaining s)))))
(assert (forall ((s us_rep)) (! (= (get_remaining s) (to_rep (rec__test__t__remaining (us_split_fields1 s)))) :pattern ((get_remaining s)))))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(define-fun dynamic_invariant1 ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= 0 5)) (in_range temp___expr_136)))
(define-fun dynamic_invariant2 ((temp___expr_142 (_ BitVec 8)) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 4))) (in_range1 temp___expr_142)))
...
(declare-const o1 entry_id)
(declare-const o2 length_type)
(declare-const o3 entry_id)
(declare-const o4 (Array (_ BitVec 8) integer))
(declare-const temp___176 length_type)
(declare-const temp___1761 entry_id)
(declare-const temp___1762 (Array (_ BitVec 8) integer))
(declare-const o5 Int)
(declare-const o6 (_ BitVec 8))
(declare-const temp___177 (_ BitVec 8))
...
(assert (=> (bvule (bvsub ((_ int2bv 8) 5) (to_rep1 s__split_fields1)) ((_ int2bv 8) 1)) (= o (bvsub (bvadd (to_rep1 s__split_fields1) ((_ int2bv 8) 1)) ((_ int2bv 8) 5)))))
(assert (=> (not (bvule (bvsub ((_ int2bv 8) 5) (to_rep1 s__split_fields1)) ((_ int2bv 8) 1))) (= o (bvadd (to_rep1 s__split_fields1) ((_ int2bv 8) 1)))))
(assert (= (to_rep1 o1) o))
(assert (= s__split_fields o2))
(assert (= o1 o3))
(assert (= s__split_fields2 o4))
(assert (= temp___176 o2))
(assert (= temp___1761 o3))
(assert (= temp___1762 o4))
...
(assert (= temp___176 s__split_fields3))
(assert (= temp___1761 s__split_fields4))
(assert (= temp___1762 s__split_fields5))
(assert (not (in_range_int (mod1 (to_rep s__split_fields3) 5))))
(check-sat)
(exit)
