...
(declare-const temp___202 length_type)
(declare-const temp___2021 entry_id)
(declare-const temp___2022 (Array (_ BitVec 8) integer))
...
(assert (=> (bvule (bvsub #x05 (to_rep1 s__split_fields1)) #x01) (= o (bvsub (bvadd (to_rep1 s__split_fields1) #x01) #x05))))
(assert (=> (not (bvule (bvsub #x05 (to_rep1 s__split_fields1)) #x01)) (= o (bvadd (to_rep1 s__split_fields1) #x01))))
(assert (= (to_rep1 o1) o))
