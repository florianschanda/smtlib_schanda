...
(assert (and (dynamic_invariant6 (mk___rep1 u__split_discrs u__split_fields2) true true true) (and (<= 1 divisor_index2) (<= divisor_index2 r132b))))
...
(assert (= temp___1582 (- o16 1)))
(assert (and (<= (to_rep1 (first2 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 u__split_fields2)))) temp___1582) (<= temp___1582 (to_rep1 (last3 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 u__split_fields2)))))))
(assert (= o17 temp___1582))
(assert (= o18 (select (elts1 (rec__aco__math__very_longs__very_long__long_digits1 u__split_fields2)) o17)))
...
(assert (= temp___1585 (- o27 1)))
(assert (not (<= (to_rep1 (first2 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 u__split_fields2)))) temp___1585)))
(check-sat)
(exit)
