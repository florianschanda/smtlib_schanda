...
(assert (and (and (=> (<= 1 65536) (in_range4 index2)) (=> (<= 1 2147483647) (in_range2 string_index2))) (dynamic_invariant4 (mk___rep result____split_discrs result____split_fields3) false true true true)))
(assert (and (<= (to_rep1 (first (rt number))) string_index2) (<= string_index2 (to_rep1 (last (rt number))))))
