...
(assert (forall ((number us_rep)) (! (=> (dynamic_invariant1 number true true true true) (let ((result (number_of_digits1 number))) (and (and (=> (< 0 result) (not (= (to_rep1 (let ((temp___300 (rec__very_longs__very_long__long_digits (us_split_fields1 number)))) (select (to_array temp___300) result))) #x00))) (forall ((i Int)) (=> (and (<= (+ result 1) i) (<= i (last1 (rec__very_longs__very_long__long_digits (us_split_fields1 number))))) (= (to_rep1 (let ((temp___301 (rec__very_longs__very_long__long_digits (us_split_fields1 number)))) (select (to_array temp___301) i))) #x00)))) (dynamic_invariant2 result true false true true)))) :pattern ((number_of_digits1 number)))))
...
(define-fun dynamic_invariant11 ((temp___expr_841 us_t3) (temp___is_init_837 Bool) (temp___skip_constant_838 Bool) (temp___do_toplevel_839 Bool) (temp___do_typ_inv_840 Bool)) Bool (=> (not (= temp___skip_constant_838 true)) (and (dynamic_property9 1 r130b (first8 temp___expr_841) (last9 temp___expr_841)) (and (= (first8 temp___expr_841) 1) (= (last9 temp___expr_841) r130b)))))
(define-fun dynamic_invariant12 ((temp___expr_851 us_t5) (temp___is_init_847 Bool) (temp___skip_constant_848 Bool) (temp___do_toplevel_849 Bool) (temp___do_typ_inv_850 Bool)) Bool (=> (not (= temp___skip_constant_848 true)) (and (dynamic_property13 1 r134b (first12 temp___expr_851) (last13 temp___expr_851)) (and (= (first12 temp___expr_851) 1) (= (last13 temp___expr_851) r134b)))))
...
(declare-const very_longs__divide__L_7__R137b__assume Int)
...
(assert (= (to_rep2 (first9 (rt4 (temp___1136 #x00 1 r130b)))) 1))
(assert (= (to_rep2 (last10 (rt4 (temp___1136 #x00 1 r130b)))) r130b))
(assert (= (mk___t4 temp___1143 temp___11431) (temp___1136 #x00 1 r130b)))
(assert (= (ite (<= (to_rep2 (first9 temp___11431)) (to_rep2 (last10 temp___11431))) (+ (- (to_rep2 (last10 temp___11431)) (to_rep2 (first9 temp___11431))) 1) 0) (ite (<= 1 r130b) (+ (- r130b 1) 1) 0)))
...
(assert (= (to_rep2 (first13 (rt6 (temp___1149 #x00 1 r134b)))) 1))
(assert (= (to_rep2 (last14 (rt6 (temp___1149 #x00 1 r134b)))) r134b))
(assert (= temp___1156 (temp___1149 #x00 1 r134b)))
(assert (= (ite (<= (to_rep2 (first13 (rt6 temp___1156))) (to_rep2 (last14 (rt6 temp___1156)))) (+ (- (to_rep2 (last14 (rt6 temp___1156))) (to_rep2 (first13 (rt6 temp___1156)))) 1) 0) (ite (<= 1 r134b) (+ (- r134b 1) 1) 0)))
...
(assert (and (= very_longs__divide__L_7__R137b__assume (+ m1 1)) (in_range1 (+ m1 1))))
(assert (= very_longs__divide__L_7__R137b__assume r137b))
(assert (in_range1 r137b))
(assert (= result8 (mk_int__ref j)))
(assert (= j1 r137b))
(assert (<= 1 j1))
(assert (<= j1 r137b))
(assert (and (and (dynamic_invariant7 (mk___rep1 u__split_discrs u__split_fields3) false true true true) (dynamic_invariant1 (mk___rep quotient__split_discrs quotient__split_fields3) false true true true)) (and (<= 1 j2) (<= j2 r137b))))
