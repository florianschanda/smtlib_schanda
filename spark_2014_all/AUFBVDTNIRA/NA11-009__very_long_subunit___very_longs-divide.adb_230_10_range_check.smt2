...
(assert (forall ((number us_rep)) (! (=> (dynamic_invariant1 number true true true true) (let ((result (number_of_digits1 number))) (and (and (=> (< 0 result) (not (= (to_rep2 (let ((temp___300 (rec__very_longs__very_long__long_digits (us_split_fields1 number)))) (select (to_array temp___300) result))) #x00))) (forall ((i Int)) (=> (and (<= (+ result 1) i) (<= i (last1 (rec__very_longs__very_long__long_digits (us_split_fields1 number))))) (= (to_rep2 (let ((temp___301 (rec__very_longs__very_long__long_digits (us_split_fields1 number)))) (select (to_array temp___301) i))) #x00)))) (dynamic_invariant result true false true true)))) :pattern ((number_of_digits1 number)))))
...
(declare-fun temp_____aggregate_def_1136 ((_ BitVec 8) Int Int) us_t4)
(declare-fun temp_____aggregate_def_1149 ((_ BitVec 8) Int Int) us_t6)
(declare-sort t7 0)
...
(assert (forall ((temp___1138 (_ BitVec 8))) (forall ((temp___1139 Int) (temp___1140 Int)) (let ((temp___1137 (temp_____aggregate_def_1136 temp___1138 temp___1139 temp___1140))) (=> (dynamic_invariant2 temp___1138 true true true true) (and (=> (dynamic_property16 1 65536 temp___1139 temp___1140) (and (= (first10 temp___1137) temp___1139) (= (last11 temp___1137) temp___1140))) (forall ((temp___1141 Int)) (= (to_rep2 (select (to_array4 temp___1137) temp___1141)) temp___1138))))))))
(assert (forall ((temp___1151 (_ BitVec 8))) (forall ((temp___1152 Int) (temp___1153 Int)) (let ((temp___1150 (temp_____aggregate_def_1149 temp___1151 temp___1152 temp___1153))) (=> (dynamic_invariant2 temp___1151 true true true true) (and (=> (dynamic_property16 1 65536 temp___1152 temp___1153) (and (= (first14 temp___1150) temp___1152) (= (last15 temp___1150) temp___1153))) (forall ((temp___1154 Int)) (= (to_rep2 (select (to_array6 temp___1150) temp___1154)) temp___1151))))))))
...
(assert (= (to_rep1 (first9 (rt4 (temp_____aggregate_def_1136 #x00 1 r130b)))) 1))
(assert (= (to_rep1 (last10 (rt4 (temp_____aggregate_def_1136 #x00 1 r130b)))) r130b))
(assert (= (mk___t4 temp___1143 temp___11431) (temp_____aggregate_def_1136 #x00 1 r130b)))
(assert (= (ite (<= (to_rep1 (first9 temp___11431)) (to_rep1 (last10 temp___11431))) (+ (- (to_rep1 (last10 temp___11431)) (to_rep1 (first9 temp___11431))) 1) 0) (ite (<= 1 r130b) (+ (- r130b 1) 1) 0)))
(assert (= temp___1143 temp___1144))
(assert (= (mk3 (to_rep1 (first9 temp___11431)) (to_rep1 (last10 temp___11431))) temp___11441))
(assert (= (ite (<= (to_rep1 (first7 temp___11441)) (to_rep1 (last8 temp___11441))) (+ (- (to_rep1 (last8 temp___11441)) (to_rep1 (first7 temp___11441))) 1) 0) (ite (<= (to_rep1 (first quotient__split_fields1)) (to_rep1 (last quotient__split_fields1))) (+ (- (to_rep1 (last quotient__split_fields1)) (to_rep1 (first quotient__split_fields1))) 1) 0)))
(assert (= temp___1146 (mk___t3 temp___1144 temp___11441)))
(assert (= o (mk___t (elts3 temp___1146) (mk (to_rep1 (first7 (rt3 temp___1146))) (to_rep1 (last8 (rt3 temp___1146)))))))
...
(assert (in_range1 r134b))
(assert (= (to_rep1 (first13 (rt6 (temp_____aggregate_def_1149 #x00 1 r134b)))) 1))
(assert (= (to_rep1 (last14 (rt6 (temp_____aggregate_def_1149 #x00 1 r134b)))) r134b))
(assert (= temp___1156 (temp_____aggregate_def_1149 #x00 1 r134b)))
(assert (= (ite (<= (to_rep1 (first13 (rt6 temp___1156))) (to_rep1 (last14 (rt6 temp___1156)))) (+ (- (to_rep1 (last14 (rt6 temp___1156))) (to_rep1 (first13 (rt6 temp___1156)))) 1) 0) (ite (<= 1 r134b) (+ (- r134b 1) 1) 0)))
(assert (= temp___1157 (mk___t5 (elts6 temp___1156) (mk5 (to_rep1 (first13 (rt6 temp___1156))) (to_rep1 (last14 (rt6 temp___1156)))))))
(assert (= (ite (<= (to_rep1 (first11 (rt5 temp___1157))) (to_rep1 (last12 (rt5 temp___1157)))) (+ (- (to_rep1 (last12 (rt5 temp___1157))) (to_rep1 (first11 (rt5 temp___1157)))) 1) 0) (ite (<= (to_rep1 (first remainder__split_fields1)) (to_rep1 (last remainder__split_fields1))) (+ (- (to_rep1 (last remainder__split_fields1)) (to_rep1 (first remainder__split_fields1))) 1) 0)))
(assert (= temp___1159 temp___1157))
(assert (= o2 (mk___t (elts5 temp___1159) (mk (to_rep1 (first11 (rt5 temp___1159))) (to_rep1 (last12 (rt5 temp___1159)))))))
...
(assert (and (= temp___1162 (number_of_digits1 divisor)) (and (in_range3 temp___1162) (and (=> (< 0 temp___1162) (not (= (to_rep2 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 divisor))) temp___1162)) #x00))) (forall ((i Int)) (=> (and (<= (+ temp___1162 1) i) (<= i (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 divisor))))))) (= (to_rep2 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 divisor))) i)) #x00)))))))
(assert (and (= us2 temp___1162) (dynamic_property6 1 last6 temp___1162)))
...
(assert (and (= very_longs__divide__L_7__R137b__assume (+ m1 1)) (in_range2 (+ m1 1))))
...
(assert (<= 1 j1))
(assert (<= j1 r137b))
(assert (and (and (dynamic_invariant5 (mk___rep1 u__split_discrs u__split_fields3) false true true true) (dynamic_invariant1 (mk___rep quotient__split_discrs quotient__split_fields3) false true true true)) (and (<= 1 j2) (<= j2 r137b))))
(assert (and (= o10 j2) (in_range1 j2)))
(assert (not (in_range1 j2)))
(check-sat)
(exit)
