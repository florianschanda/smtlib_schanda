...
(assert (not (or (< remaining_bytes4 temp___8441) (and (= remaining_bytes4 temp___8441) (or (< remaining_bits4 temp___8431) (and (= remaining_bits4 temp___8431) (< temp___8421 offset4)))))))
(check-sat)
(exit)
