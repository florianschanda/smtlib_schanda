...
(assert true)
(assert (= result23 (mk___split_fields__ref ctx__split_fields12)))
(assert (= ctx__split_fields13 (mk___split_fields keccak__keccak_1600__keccakf_1600_lanes__xor_bits_into_state__a1 (rec__keccak__keccak_1600__sponge__context__block ctx__split_fields12) (rec__keccak__keccak_1600__sponge__context__bits_absorbed ctx__split_fields12) (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields12) (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields12) (rec__keccak__keccak_1600__sponge__context__curr_state ctx__split_fields12))))
(assert (= result24 (mk___split_fields__ref ctx__split_fields13)))
(assert (= ctx__split_fields14 (mk___split_fields keccak__keccak_1600__keccakf_1600_permutation__permute__a1 (rec__keccak__keccak_1600__sponge__context__block ctx__split_fields13) (rec__keccak__keccak_1600__sponge__context__bits_absorbed ctx__split_fields13) (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields13) (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields13) (rec__keccak__keccak_1600__sponge__context__curr_state ctx__split_fields13))))
(assert (and (= o61 (+ offset3 (to_rep4 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields14)))) (in_range1 (+ offset3 (to_rep4 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields14))))))
(assert (= result25 (mk_int__ref offset3)))
(assert (= offset4 o61))
(assert (and (= o62 (- remaining_bytes3 (to_rep4 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields14)))) (in_range2 (- remaining_bytes3 (to_rep4 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields14))))))
(assert (= result26 (mk_int__ref remaining_bytes3)))
(assert (= remaining_bytes4 o62))
(assert (and (= o63 (- remaining_bits3 initial_bit_rate1)) (in_range2 (- remaining_bits3 initial_bit_rate1))))
(assert (= result27 (mk_int__ref remaining_bits3)))
(assert (= remaining_bits4 o63))
(assert (<= initial_bit_rate1 remaining_bits4))
(assert (not (or (< remaining_bytes4 temp___8442) (and (= remaining_bytes4 temp___8442) (or (< remaining_bits4 temp___8432) (and (= remaining_bits4 temp___8432) (< temp___8422 offset4)))))))
(check-sat)
(exit)
