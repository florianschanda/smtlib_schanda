...
(assert (and (= o25 (+ offset3 (to_rep4 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields12)))) (in_range1 (+ offset3 (to_rep4 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields12))))))
(assert (= result20 (mk_int__ref offset3)))
(assert (= offset4 o25))
(assert (and (= o26 (- remaining_bytes3 (to_rep4 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields12)))) (in_range2 (- remaining_bytes3 (to_rep4 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields12))))))
(assert (= result21 (mk_int__ref remaining_bytes3)))
(assert (= remaining_bytes4 o26))
(assert (and (= o27 (- remaining_bits3 initial_bit_rate1)) (in_range2 (- remaining_bits3 initial_bit_rate1))))
(assert (= result22 (mk_int__ref remaining_bits3)))
(assert (= remaining_bits4 o27))
(assert (<= initial_bit_rate1 remaining_bits4))
(assert (not (or (< remaining_bytes4 temp___9131) (and (= remaining_bytes4 temp___9131) (or (< remaining_bits4 temp___9121) (and (= remaining_bits4 temp___9121) (< temp___9111 offset4)))))))
(check-sat)
(exit)
