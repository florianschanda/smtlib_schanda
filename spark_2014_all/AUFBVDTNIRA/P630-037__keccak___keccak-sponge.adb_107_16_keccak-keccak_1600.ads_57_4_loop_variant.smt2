...
(assert (and (= o25 (+ offset3 (to_rep6 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields12)))) (in_range1 (+ offset3 (to_rep6 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields12))))))
(assert (= result20 (mk_int__ref offset3)))
(assert (= offset4 o25))
(assert (and (= o26 (- remaining_bytes3 (to_rep6 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields12)))) (in_range2 (- remaining_bytes3 (to_rep6 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields12))))))
