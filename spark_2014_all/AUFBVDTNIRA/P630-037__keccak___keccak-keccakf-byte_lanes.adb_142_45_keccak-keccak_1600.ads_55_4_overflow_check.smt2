...
(assert (= o115 (ite (= shift2 o114) true false)))
(assert (=> (<= (to_rep data__first) (to_rep data__last)) (= o109 (+ (- (to_rep data__last) (to_rep data__first)) 1))))
(assert (=> (not (<= (to_rep data__first) (to_rep data__last))) (= o109 0)))
(assert (and (= o110 o109) (in_range1 o109)))
(assert (not (in_range1 (+ offset10 remaining_bytes10))))
(check-sat)
(exit)
