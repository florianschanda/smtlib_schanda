...
(assert (=> (<= 1 temp___1797) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 temp___1797) (<= temp___1797 150)))))
(assert (= o27 result__11))
(assert (= temp___1798 (mk___t3 o27 (mk3 1 temp___1797))))
(assert (not (= (ite (<= (to_rep1 (first6 (rt3 temp___1795))) (to_rep1 (last6 (rt3 temp___1795)))) (+ (- (to_rep1 (last6 (rt3 temp___1795))) (to_rep1 (first6 (rt3 temp___1795)))) 1) 0) (ite (<= (to_rep1 (first6 (rt3 temp___1798))) (to_rep1 (last6 (rt3 temp___1798)))) (+ (- (to_rep1 (last6 (rt3 temp___1798))) (to_rep1 (first6 (rt3 temp___1798)))) 1) 0))))
(check-sat)
(exit)
