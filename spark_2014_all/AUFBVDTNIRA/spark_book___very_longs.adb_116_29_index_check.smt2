...
(assert (<= 1 index1))
(assert (<= index1 r26b))
(assert (and (and (and (=> (<= 0 2147483647) (in_range1 temp2)) (dynamic_invariant2 (mk___rep1 result____split_discrs result____split_fields3) false true true true)) (forall ((temp___881 Int)) (=> (and (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))) temp___881) (<= temp___881 (to_rep2 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))))) (=> (<= index2 temp___881) (= (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields3)) temp___881) (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields2)) temp___881)))))) (and (<= 1 index2) (<= index2 r26b))))
