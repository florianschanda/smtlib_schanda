...
(assert (and (= o354 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o355 (num_of_big_int x x_first o354)))
(assert (= o358 (omultiply o355 o357)))
(assert (= o362 (omultiply o358 o361)))
(assert (= o365 (omod o362 o364)))
(assert (and (= o352 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o353 (num_of_big_int (mk___t aux2 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first o352)))
(assert (= o366 (oeq o353 o365)))
(assert (= o350 (from_word32 ((_ int2bv 32) 1))))
(assert (and (= o348 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o349 (num_of_big_int (mk___t aux11 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first o348)))
(assert (= o351 (oeq o349 o350)))
