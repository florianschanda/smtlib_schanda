...
(declare-const o98 (Array Int word32))
...
(assert (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t o94 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 #x00000001)) true)) (= (oeq (num_of_big_int (mk___t o97 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t o95 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (oexpon (base Tuple0) (+ l1 1)) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t o96 (mk (to_rep aux4__first) (to_rep aux4__last))) aux4_first (+ l1 1)) (omod (omultiply (num_of_big_int x x_first (+ l1 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))
...
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (= temp___703 o96)))
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t o94 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 #x00000001)) true)) (= (oeq (num_of_big_int (mk___t o97 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t o95 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (oexpon (base Tuple0) (+ l1 1)) (num_of_big_int m m_first (+ l1 1)))) true)) (forall ((n1 Int)) (=> (and (<= 0 n1) (<= n1 (- h2 1))) (= (oeq (num_of_big_int (mk___t o98 (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n1 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true))))))
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (and (=> (<= 1 (- (power 2 k) 1)) (dynamic_property1 1 (- (power 2 k) 1) h2)) (and (<= 1 h2) (<= h2 (- (power 2 k) 1))))))
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t o94 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 #x00000001)) true)) (= (oeq (num_of_big_int (mk___t o97 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t o95 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (oexpon (base Tuple0) (+ l1 1)) (num_of_big_int m m_first (+ l1 1)))) true)) (forall ((n1 Int)) (=> (and (<= 0 n1) (<= n1 h2)) (= (oeq (num_of_big_int (mk___t o100 (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n1 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true))))))
...
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (= o101 (mk_map__ref o100))))
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (= h3 (mk_int__ref h2))))
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (= aux4 (mk_map__ref o100))))
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (= a2 (mk_map__ref o99))))
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (= h4 h2)))
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (= o102 o100)))
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (= a3 o99)))
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (= o103 o101)))
...
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (= o104 o102)))
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (= a5 a3)))
(assert (=> (not (and (<= 1 h1) (<= h1 temp___695))) (= o103 (mk_map__ref o96))))
(assert (=> (not (and (<= 1 h1) (<= h1 temp___695))) (= h5 (mk_int__ref h1))))
(assert (=> (not (and (<= 1 h1) (<= h1 temp___695))) (= aux41 (mk_map__ref o96))))
(assert (=> (not (and (<= 1 h1) (<= h1 temp___695))) (= a4 (mk_map__ref a))))
(assert (=> (not (and (<= 1 h1) (<= h1 temp___695))) (= h6 h1)))
(assert (=> (not (and (<= 1 h1) (<= h1 temp___695))) (= o104 o96)))
...
(assert (= i1 o7))
(assert (and (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t o94 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 #x00000001)) true)) (= (oeq (num_of_big_int (mk___t o97 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t o105 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (omultiply (oexpon__2 (num_of_big_int x x_first (+ l1 1)) (odivide (num_of_big_int e e_first (+ (- e_last e_first) 1)) (oexpon__2 (from_word32 #x00000002) (oadd (from_word64 i2) (from_word32 #x00000001))))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (forall ((n1 Int)) (=> (and (<= 0 n1) (<= n1 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux41) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n1 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))) (bvult i2 (bvmul (bvadd ((_ int2bv 64) (- e_last e_first)) #x0000000000000001) #x0000000000000020))))
...
(assert (= j2 1))
(assert (and (and (and (and (and (and (and (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t o94 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 #x00000001)) true)) (= (oeq (num_of_big_int (mk___t o97 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t o105 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (omultiply (oexpon__2 (num_of_big_int x x_first (+ l1 1)) (odivide (num_of_big_int e e_first (+ (- e_last e_first) 1)) (oexpon__2 (from_word32 #x00000002) (oadd (from_word64 i2) (from_word32 #x00000001))))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (forall ((n1 Int)) (=> (and (<= 0 n1) (<= n1 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux41) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n1 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))) (= (oeq (omultiply (from_word32 w2) (oexpon (from_word32 #x00000002) (- (- j3 s3) 1))) (omod (odivide (num_of_big_int e e_first (+ (- e_last e_first) 1)) (oexpon__2 (from_word32 #x00000002) (osubtract (from_word64 i2) (osubtract (from_integer j3) (from_word32 #x00000001))))) (oexpon (from_word32 #x00000002) j3))) true)) (= (bvurem w2 #x00000002) #x00000001)) (<= 0 s3)) (< s3 j3)) (<= j3 (+ k 1))) (= (ole (from_integer j3) (oadd (from_word64 i2) (from_word32 #x00000001))) true)) (bvult i2 (bvmul (bvadd ((_ int2bv 64) (- e_last e_first)) #x0000000000000001) #x0000000000000020))))
(assert (and (=> (<= 0 2147483647) (in_range2 j3)) (=> (<= 0 2147483647) (in_range2 s3))))
(assert (and (= o88 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (and (= o89 o88) (uint_in_range1 o88)))
(assert (= o90 ((_ int2bv 64) o89)))
(assert (= o91 (bvadd o90 #x0000000000000001)))
(assert (= o92 (bvmul o91 #x0000000000000020)))
(assert (= o93 (ite (bvult i2 o92) true false)))
(assert (= o85 (from_word32 #x00000001)))
(assert (= o84 (from_word64 i2)))
(assert (= o86 (oadd o84 o85)))
(assert (= o83 (from_integer j3)))
(assert (= o87 (ole o83 o86)))
(assert (and (= o81 (+ k 1)) (in_range1 (+ k 1))))
(assert (= o82 (ite (<= j3 o81) true false)))
(assert (= o77 (from_word32 #x00000002)))
(assert (= o78 (oexpon o77 j3)))
(assert (= o72 (from_word32 #x00000001)))
(assert (= o71 (from_integer j3)))
(assert (= o73 (osubtract o71 o72)))
(assert (= o70 (from_word64 i2)))
(assert (= o74 (osubtract o70 o73)))
(assert (= o69 (from_word32 #x00000002)))
(assert (= o75 (oexpon__2 o69 o74)))
(assert (and (= o64 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (= o65 (+ o64 1)))
(assert (and (= o66 o65) (in_range1 o65)))
(assert (and (= o67 o66) (in_range2 o66)))
(assert (= o68 (num_of_big_int e e_first o67)))
(assert (= o76 (odivide o68 o75)))
(assert (= o79 (omod o76 o78)))
(assert (and (= o58 (- j3 s3)) (in_range1 (- j3 s3))))
(assert (= o59 (- o58 1)))
(assert (and (= o60 o59) (in_range1 o59)))
(assert (and (= o61 o60) (in_range2 o60)))
(assert (= o57 (from_word32 #x00000002)))
(assert (= o62 (oexpon o57 o61)))
(assert (= o56 (from_word32 w2)))
(assert (= o63 (omultiply o56 o62)))
(assert (= o80 (oeq o63 o79)))
(assert (and (= o51 (power 2 k)) (in_range1 (power 2 k))))
(assert (= o52 (- o51 1)))
(assert (and (= o53 o52) (in_range1 o52)))
(assert (= o54 (ite (<= n o53) true false)))
(assert (= result6 (ite (<= 0 n) o54 false)))
(assert (= (= o55 true) (forall ((n1 Int)) (=> (and (<= 0 n1) (<= n1 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux41) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n1 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))))
(assert (and (= o47 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o48 (num_of_big_int m m_first o47)))
(assert (and (= o44 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (and (= o43 (base Tuple0)) (= o43 (oexpon (from_word32 #x00000002) 32))))
(assert (= o45 (oexpon o43 o44)))
(assert (= o38 (from_word32 #x00000001)))
(assert (= o37 (from_word64 i2)))
(assert (= o39 (oadd o37 o38)))
(assert (= o36 (from_word32 #x00000002)))
(assert (= o40 (oexpon__2 o36 o39)))
(assert (and (= o31 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (= o32 (+ o31 1)))
(assert (and (= o33 o32) (in_range1 o32)))
(assert (and (= o34 o33) (in_range2 o33)))
(assert (= o35 (num_of_big_int e e_first o34)))
(assert (= o41 (odivide o35 o40)))
(assert (and (= o29 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o30 (num_of_big_int x x_first o29)))
(assert (= o42 (oexpon__2 o30 o41)))
(assert (= o46 (omultiply o42 o45)))
(assert (= o49 (omod o46 o48)))
(assert (and (= o27 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o28 (num_of_big_int (mk___t o105 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first o27)))
(assert (= o50 (oeq o28 o49)))
...
(assert (= o13 (num_of_big_int (mk___t o97 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first o12)))
(assert (= o26 (oeq o13 o25)))
(assert (= o10 (from_word32 #x00000001)))
(assert (and (= o8 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o9 (num_of_big_int (mk___t o94 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first o8)))
(assert (= o11 (oeq o9 o10)))
