...
(assert (< bit_length free_bits_in_block2))
(assert (= result10 (mk_int__ref block_offset)))
(assert (= block_offset2 (div1 (to_rep3 ctx__split_fields2) 8)))
(assert (= block_offset2 r74s))
(assert (in_range2 r74s))
(assert (and (= o16 (+ block_offset2 remaining_bytes1)) (in_range1 (+ block_offset2 remaining_bytes1))))
(assert (= keccak__keccak_1600__sponge__absorb__R75s__assume (- o16 1)))
(assert (= keccak__keccak_1600__sponge__absorb__R75s__assume r75s))
(assert (in_range1 r75s))
(assert (= data_last2 r78s))
...
(assert (= o17 (elts data)))
(assert (= o17 temp___858))
...
(assert (= o18 ctx__split_fields1))
(assert (= o18 temp___861))
