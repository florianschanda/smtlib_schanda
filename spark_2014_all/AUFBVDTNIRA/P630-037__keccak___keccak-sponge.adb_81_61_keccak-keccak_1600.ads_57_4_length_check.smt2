...
(assert (= o11 temp___858))
(assert (= (mk2 (to_rep1 (first (rt data))) r78s) temp___8581))
(assert (= (ite (<= (to_rep1 (first4 temp___8581)) (to_rep1 (last4 temp___8581))) (+ (- (to_rep1 (last4 temp___8581)) (to_rep1 (first4 temp___8581))) 1) 0) (ite (<= r74s r75s) (+ (- r75s r74s) 1) 0)))
(assert (= (slide temp___858 (to_rep1 (first4 temp___8581)) r74s) temp___859))
(assert (= (mk1 r74s r75s) temp___8591))
(assert (=> (<= r74s r75s) (and (and (<= 0 r74s) (<= r74s 199)) (and (<= 0 r75s) (<= r75s 199)))))
(assert (= o12 ctx__split_fields1))
(assert (= o12 temp___861))
(assert (= (mk1 r74s r75s) temp___8611))
(assert (not (= (ite (<= (to_rep1 (first2 temp___8591)) (to_rep1 (last2 temp___8591))) (+ (- (to_rep1 (last2 temp___8591)) (to_rep1 (first2 temp___8591))) 1) 0) (ite (<= (to_rep1 (first2 temp___8611)) (to_rep1 (last2 temp___8611))) (+ (- (to_rep1 (last2 temp___8611)) (to_rep1 (first2 temp___8611))) 1) 0))))
(check-sat)
(exit)
