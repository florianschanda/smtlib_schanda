...
(assert (< bit_length free_bits_in_block1))
(assert (= result8 (mk_int__ref block_offset)))
(assert (= block_offset1 (div1 (to_rep3 ctx__split_fields2) 8)))
(assert (= block_offset1 r74s))
(assert (in_range2 r74s))
(assert (and (= o10 (+ block_offset1 remaining_bytes1)) (in_range1 (+ block_offset1 remaining_bytes1))))
(assert (= keccak__keccak_1600__sponge__absorb__R75s__assume (- o10 1)))
(assert (= keccak__keccak_1600__sponge__absorb__R75s__assume r75s))
(assert (in_range1 r75s))
(assert (= data_last1 r78s))
(assert (in_range4 r78s))
(assert (=> (<= (to_rep1 (first (rt data))) r78s) (and (and (<= (to_rep1 (first (rt data))) (to_rep1 (first (rt data)))) (<= (to_rep1 (first (rt data))) (to_rep1 (last (rt data))))) (and (<= (to_rep1 (first (rt data))) r78s) (<= r78s (to_rep1 (last (rt data))))))))
(assert (= o11 (elts data)))
(assert (= o11 temp___927))
(assert (= (mk2 (to_rep1 (first (rt data))) r78s) temp___9271))
(assert (= (ite (<= (to_rep1 (first4 temp___9271)) (to_rep1 (last4 temp___9271))) (+ (- (to_rep1 (last4 temp___9271)) (to_rep1 (first4 temp___9271))) 1) 0) (ite (<= r74s r75s) (+ (- r75s r74s) 1) 0)))
(assert (= (slide temp___927 (to_rep1 (first4 temp___9271)) r74s) temp___928))
(assert (= (mk1 r74s r75s) temp___9281))
(assert (=> (<= r74s r75s) (and (and (<= 0 r74s) (<= r74s 199)) (and (<= 0 r75s) (<= r75s 199)))))
(assert (= o12 ctx__split_fields1))
(assert (= o12 temp___930))
(assert (= (mk1 r74s r75s) temp___9301))
(assert (not (= (ite (<= (to_rep1 (first2 temp___9281)) (to_rep1 (last2 temp___9281))) (+ (- (to_rep1 (last2 temp___9281)) (to_rep1 (first2 temp___9281))) 1) 0) (ite (<= (to_rep1 (first2 temp___9301)) (to_rep1 (last2 temp___9301))) (+ (- (to_rep1 (last2 temp___9301)) (to_rep1 (first2 temp___9301))) 1) 0))))
(check-sat)
(exit)
