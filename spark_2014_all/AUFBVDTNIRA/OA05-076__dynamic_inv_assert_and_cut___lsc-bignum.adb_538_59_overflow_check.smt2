...
(assert (and (= o309 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o310 (num_of_big_int m m_first o309)))
(assert (and (= o306 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (and (= o305 (base Tuple0)) (= o305 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o307 (oexpon o305 o306)))
(assert (= o300 (from_word32 ((_ int2bv 32) 1))))
(assert (= o299 (from_word64 i2)))
(assert (= o301 (oadd o299 o300)))
(assert (= o298 (from_word32 ((_ int2bv 32) 2))))
(assert (= o302 (oexpon__2 o298 o301)))
(assert (and (= o293 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (= o294 (+ o293 1)))
(assert (not (in_range1 o294)))
(check-sat)
(exit)
