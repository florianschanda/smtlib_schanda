...
(define-fun dynamic_invariant2 ((temp___expr_776 Int) (temp___is_init_772 Bool) (temp___skip_constant_773 Bool) (temp___do_toplevel_774 Bool) (temp___do_typ_inv_775 Bool)) Bool (=> (or (= temp___is_init_772 true) (<= 0 3)) (in_range3 temp___expr_776)))
...
(define-fun dynamic_invariant3 ((temp___expr_826 (_ BitVec 8)) (temp___is_init_822 Bool) (temp___skip_constant_823 Bool) (temp___do_toplevel_824 Bool) (temp___do_typ_inv_825 Bool)) Bool true)
