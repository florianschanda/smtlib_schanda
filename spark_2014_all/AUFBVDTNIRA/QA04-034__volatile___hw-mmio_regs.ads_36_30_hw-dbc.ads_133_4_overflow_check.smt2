...
(define-fun dynamic_invariant2 ((temp___expr_683 Int) (temp___is_init_680 Bool) (temp___skip_constant_681 Bool) (temp___do_toplevel_682 Bool)) Bool (=> (or (= temp___is_init_680 true) (<= 0 3)) (in_range3 temp___expr_683)))
...
(define-fun dynamic_invariant3 ((temp___expr_730 (_ BitVec 8)) (temp___is_init_727 Bool) (temp___skip_constant_728 Bool) (temp___do_toplevel_729 Bool)) Bool true)
