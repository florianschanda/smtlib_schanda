...
(assert (not (= (ite (<= (to_rep2 (first13 (rt6 temp___1307))) (to_rep2 (last14 (rt6 temp___1307)))) (+ (- (to_rep2 (last14 (rt6 temp___1307))) (to_rep2 (first13 (rt6 temp___1307)))) 1) 0) (ite (<= 1 r139b) (+ (- r139b 1) 1) 0))))
(check-sat)
(exit)
