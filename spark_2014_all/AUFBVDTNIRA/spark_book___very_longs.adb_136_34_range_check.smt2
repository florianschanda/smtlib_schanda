...
(define-fun dynamic_invariant2 ((temp___expr_204 Int) (temp___is_init_201 Bool) (temp___skip_constant_202 Bool) (temp___do_toplevel_203 Bool)) Bool (=> (or (= temp___is_init_201 true) (<= 1 65536)) (in_range5 temp___expr_204)))
...
(assert (forall ((x tdigit_count_typeB)) (! (in_range4 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(assert (not (in_range5 (to_rep4 (last2 (rt1 (rec__very_longs__very_long__long_digits result____split_fields2)))))))
(check-sat)
(exit)
