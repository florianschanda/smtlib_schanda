...
(assert (= (mk___t2 o9 o10) (mk___t2 temp___507 temp___5071)))
(assert (= o11 o9))
(assert (= (mk_map__ref1 result3) (mk_map__ref1 temporary_array)))
(assert (= temporary_array1 o11))
...
(assert (=> (and (<= (to_rep1 (first (rt value))) i1) (<= i1 (to_rep1 (last (rt value))))) (= (to_rep2 o12) ((_ int2bv 8) (to_rep (select (elts value) i2))))))
...
(assert (=> (and (<= (to_rep1 (first (rt value))) i1) (<= i1 (to_rep1 (last (rt value))))) (= o13 temp___508)))
(assert (=> (and (<= (to_rep1 (first (rt value))) i1) (<= i1 (to_rep1 (last (rt value))))) (= o14 (store temporary_array2 o13 o12))))
(assert (=> (and (<= (to_rep1 (first (rt value))) i1) (<= i1 (to_rep1 (last (rt value))))) (= temporary_array2 result5)))
(assert (=> (and (<= (to_rep1 (first (rt value))) i1) (<= i1 (to_rep1 (last (rt value))))) (= temporary_array3 o14)))
