...
(assert (and (= o21 (+ offset3 (- (to_rep6 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields10)) 1))) (in_range1 (+ offset3 (- (to_rep6 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields10)) 1)))))
...
(assert (not (<= initial_bit_rate1 (* (length o24) 8))))
(check-sat)
(exit)
