...
(assert (and (and (and (and (= (+ offset3 remaining_bytes3) initial_data_len1) (= remaining_bytes3 (div1 (+ remaining_bits3 7) 8))) (= (mod2 bit_length 8) (mod2 remaining_bits3 8))) (= (state_of (mk___rep ctx__split_fields12)) 0)) (= (rate_of (mk___rep ctx__split_fields12)) initial_bit_rate1)))
(assert (and (and (and (and (and (and (and (= (rec__keccak__keccak_1600__sponge__context__block ctx__split_fields12) (rec__keccak__keccak_1600__sponge__context__block ctx__split_fields11)) (= (rec__keccak__keccak_1600__sponge__context__bits_absorbed ctx__split_fields12) (rec__keccak__keccak_1600__sponge__context__bits_absorbed ctx__split_fields11))) (= (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields12) (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields11))) (= (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields12) (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields11))) (= (rec__keccak__keccak_1600__sponge__context__curr_state ctx__split_fields12) (rec__keccak__keccak_1600__sponge__context__curr_state ctx__split_fields11))) (=> (<= 0 2147483647) (in_range2 offset3))) (=> (<= 0 2147483647) (in_range2 remaining_bits3))) (=> (<= 0 2147483647) (in_range2 remaining_bytes3))))
(assert (= result20 (mk_int__ref temp___8441)))
(assert (= temp___8442 remaining_bytes3))
(assert (= result21 (mk_int__ref temp___8431)))
(assert (= temp___8432 remaining_bits3))
(assert (= result22 (mk_int__ref temp___8421)))
(assert (= temp___8422 offset3))
...
(assert (and (= o57 (+ offset3 (- (to_rep4 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields12)) 1))) (in_range1 (+ offset3 (- (to_rep4 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields12)) 1)))))
(assert (= o58 (+ (to_rep1 (first (rt data))) o57)))
(assert (and (= keccak__keccak_1600__sponge__absorb__L_1__R92s__assume o58) (in_range1 o58)))
...
(assert (= o59 (elts data)))
(assert (= temp___833 (mk___t6 o59 (mk6 r91s r92s))))
(assert (= o60 (mk___t (elts6 temp___833) (mk (to_rep1 (first12 (rt6 temp___833))) (to_rep1 (last12 (rt6 temp___833)))))))
(assert (not (<= (length o60) 268435455)))
(check-sat)
(exit)
