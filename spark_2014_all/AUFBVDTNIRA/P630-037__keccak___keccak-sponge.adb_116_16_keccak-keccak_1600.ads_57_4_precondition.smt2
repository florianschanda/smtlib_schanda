...
(assert (<= initial_bit_rate1 remaining_bits2))
(assert (and (and (and (and (= (+ offset3 remaining_bytes3) initial_data_len1) (= remaining_bytes3 (div1 (+ remaining_bits3 7) 8))) (= (mod2 bit_length 8) (mod2 remaining_bits3 8))) (= (state_of (mk___rep ctx__split_fields10)) 0)) (= (rate_of (mk___rep ctx__split_fields10)) initial_bit_rate1)))
(assert (and (and (and (and (and (and (and (= (rec__keccak__keccak_1600__sponge__context__block ctx__split_fields10) (rec__keccak__keccak_1600__sponge__context__block ctx__split_fields9)) (= (rec__keccak__keccak_1600__sponge__context__bits_absorbed ctx__split_fields10) (rec__keccak__keccak_1600__sponge__context__bits_absorbed ctx__split_fields9))) (= (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields10) (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields9))) (= (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields10) (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields9))) (= (rec__keccak__keccak_1600__sponge__context__curr_state ctx__split_fields10) (rec__keccak__keccak_1600__sponge__context__curr_state ctx__split_fields9))) (=> (<= 0 2147483647) (in_range2 offset3))) (=> (<= 0 2147483647) (in_range2 remaining_bits3))) (=> (<= 0 2147483647) (in_range2 remaining_bytes3))))
(assert (= result15 (mk_int__ref temp___913)))
(assert (= temp___9131 remaining_bytes3))
(assert (= result16 (mk_int__ref temp___912)))
(assert (= temp___9121 remaining_bits3))
(assert (= result17 (mk_int__ref temp___911)))
(assert (= temp___9111 offset3))
(assert (and (= keccak__keccak_1600__sponge__absorb__L_1__R91s__assume (+ (to_rep1 (first (rt data))) offset3)) (in_range1 (+ (to_rep1 (first (rt data))) offset3))))
(assert (= keccak__keccak_1600__sponge__absorb__L_1__R91s__assume r91s))
(assert (in_range1 r91s))
(assert (and (= o21 (+ offset3 (- (to_rep4 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields10)) 1))) (in_range1 (+ offset3 (- (to_rep4 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields10)) 1)))))
(assert (= o22 (+ (to_rep1 (first (rt data))) o21)))
(assert (and (= keccak__keccak_1600__sponge__absorb__L_1__R92s__assume o22) (in_range1 o22)))
(assert (= keccak__keccak_1600__sponge__absorb__L_1__R92s__assume r92s))
(assert (in_range1 r92s))
(assert (=> (<= r91s r92s) (and (and (<= (to_rep1 (first (rt data))) r91s) (<= r91s (to_rep1 (last (rt data))))) (and (<= (to_rep1 (first (rt data))) r92s) (<= r92s (to_rep1 (last (rt data))))))))
(assert (= o23 (elts data)))
(assert (= temp___902 (mk___t6 o23 (mk6 r91s r92s))))
(assert (= o24 (mk___t (elts6 temp___902) (mk (to_rep1 (first12 (rt6 temp___902))) (to_rep1 (last12 (rt6 temp___902)))))))
(assert (not (<= (length o24) 268435455)))
(check-sat)
(exit)
