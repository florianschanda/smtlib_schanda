...
(assert (= result15 (mk_int__ref temp___844)))
(assert (= temp___8441 remaining_bytes3))
(assert (= result16 (mk_int__ref temp___843)))
(assert (= temp___8431 remaining_bits3))
(assert (= result17 (mk_int__ref temp___842)))
(assert (= temp___8421 offset3))
...
(assert (= temp___833 (mk___t6 o23 (mk6 r91s r92s))))
(assert (= o24 (mk___t (elts6 temp___833) (mk (to_rep1 (first12 (rt6 temp___833))) (to_rep1 (last12 (rt6 temp___833)))))))
