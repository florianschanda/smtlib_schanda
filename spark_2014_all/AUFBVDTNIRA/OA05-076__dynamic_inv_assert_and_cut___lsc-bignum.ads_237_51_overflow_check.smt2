...
(assert (= o51 (ite (<= o50 (to_rep (last (rt x)))) true false)))
(assert (and (= o45 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o46 (+ x_first o45)))
(assert (and (= o47 o46) (in_range1 o46)))
(assert (= o52 (ite (<= (to_rep (first (rt x))) o47) true false)))
(assert (= result (ite (= o52 true) o51 false)))
(assert (= result true))
...
(assert (= o43 (ite (<= o42 (to_rep (last (rt m)))) true false)))
(assert (and (= o37 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o38 (+ m_first o37)))
(assert (and (= o39 o38) (in_range1 o38)))
(assert (= o44 (ite (<= (to_rep (first (rt m))) o39) true false)))
(assert (= result1 (ite (= o44 true) o43 false)))
(assert (= result1 true))
...
(assert (= o35 (ite (<= o34 (to_rep aux1__last)) true false)))
(assert (and (= o29 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o30 (+ aux1_first o29)))
(assert (and (= o31 o30) (in_range1 o30)))
(assert (= o36 (ite (<= (to_rep aux1__first) o31) true false)))
(assert (= result2 (ite (= o36 true) o35 false)))
(assert (= result2 true))
...
(assert (= o27 (ite (<= o26 (to_rep aux2__last)) true false)))
(assert (and (= o21 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o22 (+ aux2_first o21)))
(assert (and (= o23 o22) (in_range1 o22)))
(assert (= o28 (ite (<= (to_rep aux2__first) o23) true false)))
(assert (= result3 (ite (= o28 true) o27 false)))
(assert (= result3 true))
...
(assert (= o19 (ite (<= o18 (to_rep aux3__last)) true false)))
(assert (and (= o13 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o14 (+ aux3_first o13)))
(assert (and (= o15 o14) (in_range1 o14)))
(assert (= o20 (ite (<= (to_rep aux3__first) o15) true false)))
(assert (= result4 (ite (= o20 true) o19 false)))
(assert (= result4 true))
...
(assert (= o12 (ite (<= o11 (to_rep aux4__last)) true false)))
