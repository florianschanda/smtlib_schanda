...
(define-fun dynamic_invariant5 ((temp___expr_724 (_ BitVec 64)) (temp___is_init_720 Bool) (temp___skip_constant_721 Bool) (temp___do_toplevel_722 Bool) (temp___do_typ_inv_723 Bool)) Bool true)
...
(declare-const hw__dbc__cap_regs__read_i__4__off__assume Int)
...
(assert (= o1 (div1 o 4)))
(assert (and (= hw__dbc__cap_regs__read_i__4__off__assume o1) (in_range2 o1)))
(assert (= hw__dbc__cap_regs__read_i__4__off__assume off))
