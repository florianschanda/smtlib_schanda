...
(assert (and (= o78 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (and (= o79 o78) (uint_in_range1 o78)))
(assert (= o80 ((_ int2bv 64) o79)))
(assert (= o81 (bvadd o80 #x0000000000000001)))
(assert (= o82 (bvmul o81 #x0000000000000020)))
(assert (= o83 (ite (bvult i2 o82) true false)))
(assert (= o75 (from_word32 #x00000001)))
(assert (= o74 (from_word64 i2)))
(assert (= o76 (oadd o74 o75)))
(assert (= o73 (from_integer s10)))
(assert (= o77 (ole o73 o76)))
(assert (and (= o71 (+ k 1)) (in_range1 (+ k 1))))
(assert (= o72 (ite (<= s10 o71) true false)))
(assert (= o67 (from_word32 #x00000002)))
(assert (= o68 (oexpon o67 s10)))
(assert (= o62 (from_word32 #x00000001)))
(assert (= o61 (from_integer s10)))
(assert (= o63 (osubtract o61 o62)))
(assert (= o60 (from_word64 i2)))
(assert (= o64 (osubtract o60 o63)))
(assert (= o59 (from_word32 #x00000002)))
(assert (= o65 (oexpon__2 o59 o64)))
(assert (and (= o54 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (= o55 (+ o54 1)))
(assert (and (= o56 o55) (in_range1 o55)))
(assert (and (= o57 o56) (in_range2 o56)))
(assert (= o58 (num_of_big_int e e_first o57)))
(assert (= o66 (odivide o58 o65)))
(assert (= o69 (omod o66 o68)))
(assert (= o53 (from_word32 (t__content w7))))
(assert (= o70 (oeq o53 o69)))
(assert (and (= o48 (power 2 k)) (in_range1 (power 2 k))))
(assert (= o49 (- o48 1)))
(assert (and (= o50 o49) (in_range1 o49)))
(assert (= o51 (ite (<= n o50) true false)))
(assert (= result8 (ite (<= 0 n) o51 false)))
(assert (= (= o52 true) (forall ((n1 Int)) (=> (and (<= 0 n1) (<= n1 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux45) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n1 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))))
...
(assert (= o37 (oexpon o36 h9)))
(assert (= o32 (from_word32 #x00000001)))
(assert (= o31 (from_word64 i2)))
(assert (= o33 (oadd o31 o32)))
(assert (= o30 (from_word32 #x00000002)))
(assert (= o34 (oexpon__2 o30 o33)))
(assert (and (= o25 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (= o26 (+ o25 1)))
(assert (and (= o27 o26) (in_range1 o26)))
(assert (and (= o28 o27) (in_range2 o27)))
(assert (= o29 (num_of_big_int e e_first o28)))
(assert (= o35 (odivide o29 o34)))
(assert (= o38 (omultiply o35 o37)))
(assert (and (= o23 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o24 (num_of_big_int x x_first o23)))
(assert (= o39 (oexpon__2 o24 o38)))
(assert (= o43 (omultiply o39 o42)))
(assert (= o46 (omod o43 o45)))
(assert (and (= o21 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o22 (num_of_big_int (mk___t aux33 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first o21)))
(assert (= o47 (oeq o22 o46)))
...
(assert (= o13 (omultiply o10 o12)))
(assert (= o17 (omultiply o13 o16)))
(assert (= o20 (omod o17 o19)))
