...
(assert (= o81 (bvadd o80 ((_ int2bv 64) 1))))
(assert (= o82 (bvmul o81 ((_ int2bv 64) 32))))
(assert (= o83 (ite (bvult i2 o82) true false)))
(assert (= o75 (from_word32 ((_ int2bv 32) 1))))
...
(assert (= o67 (from_word32 ((_ int2bv 32) 2))))
...
(assert (= o59 (from_word32 ((_ int2bv 32) 2))))
...
(assert (= o32 (from_word32 ((_ int2bv 32) 1))))
