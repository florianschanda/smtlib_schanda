...
(assert (<= 0 n1))
(assert (<= n1 h2))
(assert (and (= o259 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o260 (num_of_big_int m m_first o259)))
(assert (and (= o256 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (and (= o255 (base Tuple0)) (= o255 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o257 (oexpon o255 o256)))
(assert (and (= o250 (* 2 n1)) (in_range1 (* 2 n1))))
(assert (= o251 (+ o250 1)))
(assert (not (in_range1 o251)))
(check-sat)
(exit)
