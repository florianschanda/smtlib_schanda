...
(assert (not (= (ite (<= (to_rep2 (first9 temp___10741)) (to_rep2 (last10 temp___10741))) (+ (- (to_rep2 (last10 temp___10741)) (to_rep2 (first9 temp___10741))) 1) 0) (ite (<= 1 r130b) (+ (- r130b 1) 1) 0))))
(check-sat)
(exit)
