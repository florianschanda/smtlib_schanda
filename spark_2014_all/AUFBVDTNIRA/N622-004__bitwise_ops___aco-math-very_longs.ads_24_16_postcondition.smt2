...
(assert (and (and (and (= us octet_length) (in_range3 octet_length)) (and (= (to_rep1 (rec__aco__math__very_longs__very_long__octet_length result____split_discrs)) octet_length) (and (dynamic_invariant2 (mk___rep1 result____split_discrs (mk___split_fields1 (mk___t1 result____split_fields result____split_fields1))) false false true) (and (=> (<= 0 2147483647) (in_range1 temp)) (and (and (and (and (and (and (and (= (to_rep2 (first4 (rt2 (temp___1029 ((_ int2bv 8) 0) 1 octet_length)))) 1) (and (= (to_rep2 (last4 (rt2 (temp___1029 ((_ int2bv 8) 0) 1 octet_length)))) octet_length) (= (mk___t2 temp___1036 temp___10361) (temp___1029 ((_ int2bv 8) 0) 1 octet_length)))) (and (= (ite (<= (to_rep2 (first4 temp___10361)) (to_rep2 (last4 temp___10361))) (+ (- (to_rep2 (last4 temp___10361)) (to_rep2 (first4 temp___10361))) 1) 0) (ite (<= 1 octet_length) (+ (- octet_length 1) 1) 0)) (and (= temp___1036 temp___1037) (= (mk1 (to_rep2 (first4 temp___10361)) (to_rep2 (last4 temp___10361))) temp___10371)))) (and (= (ite (<= (to_rep2 (first2 temp___10371)) (to_rep2 (last2 temp___10371))) (+ (- (to_rep2 (last2 temp___10371)) (to_rep2 (first2 temp___10371))) 1) 0) (ite (<= (to_rep2 (first2 result____split_fields1)) (to_rep2 (last2 result____split_fields1))) (+ (- (to_rep2 (last2 result____split_fields1)) (to_rep2 (first2 result____split_fields1))) 1) 0)) (= (mk___t1 o o1) (mk___t1 temp___1037 temp___10371)))) (and (= o2 o) (= o3 o1))) (and (= result____split_discrs (mk___split_discrs temp___1040)) (and (= temp___10401 o2) (= temp___10402 o3)))) (and (and (= result (mk___split_fields__ref1 (mk___split_fields1 (mk___t1 result____split_fields result____split_fields1)))) (= result____split_fields2 (mk___split_fields1 (mk___t1 temp___10401 temp___10402)))) (= result____split_discrs (mk___split_discrs temp___1040)))) (and (and (= result1 (mk_int__ref temp)) (= temp1 number)) (and (and (= (to_rep2 (last2 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields2)))) r26b) (in_range2 r26b)) (and (and (and (= result2 (mk_int__ref index)) (= index1 1)) (ite (and (<= 1 index1) (<= index1 r26b)) (and (and (and (= temp___1047 temp1) (and (and (= result____split_discrs (mk___split_discrs temp___1044)) (= result____split_fields2 (mk___split_fields1 (mk___t1 temp___10441 temp___10442)))) (and (and (and (and (dynamic_invariant2 (mk___rep1 result____split_discrs result____split_fields3) false true true) (forall ((temp___1046 Int)) (=> (and (<= (to_rep2 (first2 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields3)))) temp___1046) (<= temp___1046 (to_rep2 (last2 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields3)))))) (=> (<= index2 temp___1046) (= (select (elts1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields3)) temp___1046) (select temp___10441 temp___1046)))))) (=> (<= 0 2147483647) (in_range1 temp2))) (and (<= 1 index2) (<= index2 r26b))) (and (and (and (and (and (and (and (and (and (= o4 (mod1 temp2 256)) (uint_in_range (mod1 temp2 256))) (= o5 ((_ int2bv 8) o4))) (= (to_rep o6) o5)) (and (and (and (<= (to_rep2 (first2 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields3)))) index2) (<= index2 (to_rep2 (last2 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields3)))))) (= o7 index2)) (= o8 (store (elts1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields3)) o7 o6)))) (= o9 (mk___t1 o8 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields3))))) (= o10 (mk___split_fields1 o9))) (= temp___1043 (mk___rep1 result____split_discrs o10))) (and (and (= result3 (mk___split_fields__ref1 result____split_fields3)) (= result____split_fields4 (us_split_fields3 temp___1043))) (= result____split_discrs (us_split_discrs2 temp___1043)))) (and (and (= result4 (mk_int__ref temp2)) (= temp3 (div1 temp2 256))) (= index2 r26b)))))) (and (and (= index3 (mk_int__ref index2)) (and (= temp4 (mk_int__ref temp3)) (= result____split_fields5 (mk___split_fields__ref1 result____split_fields4)))) (and (= index4 index2) (and (= temp5 temp3) (= result____split_fields6 result____split_fields4))))) (and (and (= index5 index3) (and (= temp6 temp4) (= result____split_fields7 result____split_fields5))) (and (= index6 index4) (and (= temp7 temp5) (= result____split_fields8 result____split_fields6))))) (and (and (= index5 (mk_int__ref index1)) (and (= temp6 (mk_int__ref temp1)) (= result____split_fields7 (mk___split_fields__ref1 result____split_fields2)))) (and (= index6 index1) (and (= temp7 temp1) (= result____split_fields8 result____split_fields2)))))) (and (and (= aco__math__very_longs__make_from_natural__result4 (mk_very_long__ref aco__math__very_longs__make_from_natural__result3)) (= aco__math__very_longs__make_from_natural__result5 aco__math__very_longs__make_from_natural__result3)) (and (= result5 (mk_very_long__ref (mk___rep (mk___split_discrs aco__math__very_longs__make_from_natural__result) (mk___split_fields (mk___t aco__math__very_longs__make_from_natural__result1 aco__math__very_longs__make_from_natural__result2))))) (= aco__math__very_longs__make_from_natural__result3 (to_base (mk___rep1 result____split_discrs (us_split_fields__content1 result____split_fields7)))))))))))))) (and (and (= aco__math__very_longs__make_from_natural__result6 aco__math__very_longs__make_from_natural__result4) (and (= index7 index5) (and (= temp8 temp6) (= result____split_fields9 result____split_fields7)))) (and (= aco__math__very_longs__make_from_natural__result7 aco__math__very_longs__make_from_natural__result5) (and (= index8 index6) (and (= temp9 temp7) (= result____split_fields10 result____split_fields8)))))))
