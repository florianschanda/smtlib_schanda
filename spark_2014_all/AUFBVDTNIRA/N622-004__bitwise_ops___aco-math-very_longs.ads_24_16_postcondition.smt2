...
(assert (= (ite (<= (to_rep2 (first4 temp___10361)) (to_rep2 (last4 temp___10361))) (+ (- (to_rep2 (last4 temp___10361)) (to_rep2 (first4 temp___10361))) 1) 0) (ite (<= 1 octet_length) (+ (- octet_length 1) 1) 0)))
(assert (= temp___1036 temp___1037))
(assert (= (mk1 (to_rep2 (first4 temp___10361)) (to_rep2 (last4 temp___10361))) temp___10371))
(assert (= (ite (<= (to_rep2 (first2 temp___10371)) (to_rep2 (last2 temp___10371))) (+ (- (to_rep2 (last2 temp___10371)) (to_rep2 (first2 temp___10371))) 1) 0) (ite (<= (to_rep2 (first2 result____split_fields1)) (to_rep2 (last2 result____split_fields1))) (+ (- (to_rep2 (last2 result____split_fields1)) (to_rep2 (first2 result____split_fields1))) 1) 0)))
...
(assert (= result____split_fields2 (mk___split_fields1 (mk___t1 temp___10401 temp___10402))))
(assert (= result____split_discrs (mk___split_discrs temp___1040)))
...
(assert (=> (and (<= 1 index1) (<= index1 r26b)) (and (= result____split_discrs (mk___split_discrs temp___1044)) (= result____split_fields2 (mk___split_fields1 (mk___t1 temp___10441 temp___10442))))))
(assert (=> (and (<= 1 index1) (<= index1 r26b)) (and (and (and (dynamic_invariant2 (mk___rep1 result____split_discrs result____split_fields3) false true true) (forall ((temp___1046 Int)) (=> (and (<= (to_rep2 (first2 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields3)))) temp___1046) (<= temp___1046 (to_rep2 (last2 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields3)))))) (=> (<= index2 temp___1046) (= (select (elts1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields3)) temp___1046) (select temp___10441 temp___1046)))))) (=> (<= 0 2147483647) (in_range1 temp2))) (and (<= 1 index2) (<= index2 r26b)))))
...
(assert (=> (and (<= 1 index1) (<= index1 r26b)) (= temp___1043 (mk___rep1 result____split_discrs o10))))
(assert (=> (and (<= 1 index1) (<= index1 r26b)) (= result3 (mk___split_fields__ref1 result____split_fields3))))
(assert (=> (and (<= 1 index1) (<= index1 r26b)) (= result____split_fields4 (us_split_fields3 temp___1043))))
(assert (=> (and (<= 1 index1) (<= index1 r26b)) (= result____split_discrs (us_split_discrs2 temp___1043))))
