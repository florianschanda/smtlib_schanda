...
(assert (and (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields2)))) temp___1345) (<= temp___1345 (to_rep1 (last3 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields2)))))))
...
(assert (not (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields2)))) temp___1348)))
(check-sat)
(exit)
