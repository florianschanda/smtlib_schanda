...
(assert (and (= o55 (rate_of (mk___rep ctx__split_fields12))) (and (in_range3 o55) (and (= o55 (* (to_rep4 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields12)) 8)) (< o55 1600)))))
(assert (= o56 (ite (= o55 initial_bit_rate1) true false)))
(assert (and (= o53 (state_of (mk___rep ctx__split_fields12))) (and (in_range5 o53) (= o53 (to_rep5 (rec__keccak__keccak_1600__sponge__context__curr_state ctx__split_fields12))))))
(assert (= o54 (ite (= o53 0) true false)))
(assert (and (= o50 (+ remaining_bits3 7)) (in_range1 (+ remaining_bits3 7))))
(assert (not (not (= 8 0))))
(check-sat)
(exit)
