...
(assert (and (= o24 (rate_of (mk___rep ctx__split_fields10))) (and (in_range3 o24) (and (= o24 (* (to_rep4 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields10)) 8)) (< o24 1600)))))
(assert (= o25 (ite (= o24 initial_bit_rate1) true false)))
(assert (and (= o22 (state_of (mk___rep ctx__split_fields10))) (and (in_range5 o22) (= o22 (to_rep5 (rec__keccak__keccak_1600__sponge__context__curr_state ctx__split_fields10))))))
