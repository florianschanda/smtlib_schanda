...
(declare-const o9 blocklengthvalue)
(declare-const o10 Int)
(declare-const o11 Bool)
(declare-const o12 Int)
(declare-const o13 blocklengthvalue)
...
(assert (= o12 block2))
(assert (= o13 (select (rec__rr_type__nsec_record_type__nsecrecordtype__blocklengths (us_split_fields3 nsec_record)) o12)))
(assert (= o14 (to_rep4 o13)))
(assert (= o15 (ite (<= o14 32) true false)))
(assert (and (<= 1 block2) (<= block2 32)))
(assert (= o8 block2))
(assert (= o9 (select (rec__rr_type__nsec_record_type__nsecrecordtype__blocklengths (us_split_fields3 nsec_record)) o8)))
(assert (= o10 (to_rep4 o9)))
(assert (= o11 (ite (<= 1 o10) true false)))
(assert (not (in_range1 (* (- block2 1) 32))))
(check-sat)
(exit)
