...
(assert (and (= o51 i1) (in_range2 i1)))
(assert (and (= o52 (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) o51)) (= (= o52 true) (= (nth1 (to_rep1 (select addr (div1 o51 8))) (- 7 (mod1 o51 8))) true))))
(assert (= o53 (to_int2 o52)))
(assert (and (= o49 i1) (in_range2 i1)))
