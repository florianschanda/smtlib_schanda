...
(define-fun dynamic_invariant1 ((temp___expr_184 (_ BitVec 64)) (temp___is_init_181 Bool) (temp___skip_constant_182 Bool) (temp___do_toplevel_183 Bool)) Bool true)
...
(define-fun dynamic_invariant2 ((temp___expr_208 us_t) (temp___is_init_205 Bool) (temp___skip_constant_206 Bool) (temp___do_toplevel_207 Bool)) Bool (=> (not (= temp___skip_constant_206 true)) (dynamic_property 0 2147483646 (first1 temp___expr_208) (last1 temp___expr_208))))
...
(assert (forall ((addr us_t)) (forall ((left Int)) (! (=> (and (and (dynamic_invariant2 addr true true true) (dynamic_invariant left true true true)) (and (= (first1 addr) 0) (< left (* 8 (length addr))))) (= (= (peekbit8array addr left) true) (= (nth8_stream addr left) true))) :pattern ((peekbit8array addr left))))))
...
(assert (forall ((value (_ BitVec 64))) (forall ((left Int)) (forall ((flag Bool)) (! (=> (and (and (dynamic_invariant1 value true true true) (dynamic_invariant left true true true)) (< left 64)) (let ((result (pokebit64 value left flag))) (and (and (forall ((i Int)) (=> (and (<= 0 i) (<= i 63)) (=> (not (= i (- 63 left))) (= (= (nth result i) true) (= (nth value i) true))))) (= (= flag true) (= (nth result (- 63 left)) true))) (dynamic_invariant1 result true false true)))) :pattern ((pokebit64 value left flag)))))))
...
(assert (forall ((byte (_ BitVec 8))) (forall ((left Int)) (! (=> (and (and (dynamic_invariant4 byte true true true) (dynamic_invariant left true true true)) (< left 8)) (= (= (peekbit8 byte left) true) (= (nth1 byte (- 7 left)) true))) :pattern ((peekbit8 byte left))))))
...
(declare-const temp___283 (_ BitVec 64))
(declare-const j Int)
...
(assert (or (and (and (and (= bitwalker__peek__result6 (mk_t__ref bitwalker__peek__result2)) (and (= i13 (mk_int__ref i)) (and (= flag10 (mk_bool__ref flag)) (= retval11 (mk_t__ref retval))))) (and (= bitwalker__peek__result7 bitwalker__peek__result2) (and (= i14 i3) (and (= flag11 flag1) (= retval12 retval1))))) (and (and (and (and (and (= o3 (length addr)) (in_range1 (length addr))) (= o4 (* 8 o3))) (and (= o5 o4) (in_range1 o4))) (and (and (= o6 (+ start length1)) (in_range1 (+ start length1))) (= result (ite (< o5 o6) true false)))) (and (= result true) (and (= result1 bitwalker__peek__result) (= bitwalker__peek__result2 ((_ int2bv 64) 0)))))) (and (and (and (and (and (and (= o3 (length addr)) (in_range1 (length addr))) (= o4 (* 8 o3))) (and (= o5 o4) (in_range1 o4))) (and (and (= o6 (+ start length1)) (in_range1 (+ start length1))) (= result (ite (< o5 o6) true false)))) (and (not (= result true)) (and (= bitwalker__peek__result2 bitwalker__peek__result) (= bitwalker__peek__result2 bitwalker__peek__result1)))) (and (and (and (= bitwalker__peek__result6 bitwalker__peek__result4) (and (= i13 i11) (and (= flag10 flag8) (= retval11 (mk_t__ref retval9))))) (and (= bitwalker__peek__result7 bitwalker__peek__result5) (and (= i14 i12) (and (= flag11 flag9) (= retval12 retval10))))) (and (and (and (= bitwalker__peek__result4 (mk_t__ref bitwalker__peek__result3)) (and (= i11 (mk_int__ref i9)) (and (= flag8 (mk_bool__ref flag6)) (= (mk_t__ref retval9) (mk_t__ref retval7))))) (and (= bitwalker__peek__result5 bitwalker__peek__result3) (and (= i12 i10) (and (= flag9 flag7) (= retval10 retval8))))) (and (and (= (mk_t__ref result2) (mk_t__ref retval)) (= retval2 ((_ int2bv 64) 0))) (and (and (and (= (mk_int__ref result3) (mk_int__ref i)) (= i4 0)) (ite (and (<= 0 i4) (<= i4 (- length1 1))) (and (and (and (= temp___285 i4) (and (= temp___284 flag) (and (= temp___283 retval2) (and (and (forall ((j2 Int)) (=> (and (<= (- length1 i5) j2) (<= j2 (- length1 1))) (= (= (nth8_stream addr (- (- (+ start length1) j2) 1)) true) (= (nth retval3 j2) true)))) (forall ((j2 Int)) (=> (and (<= length1 j2) (<= j2 63)) (not (= (nth retval3 j2) true))))) (and (and (=> (<= 0 (- length1 1)) (dynamic_property1 0 (- length1 1) i5)) (and (<= 0 i5) (<= i5 (- length1 1)))) (and (and (and (and (= o14 (+ start i5)) (in_range1 (+ start i5))) (and (= o15 (peekbit8array addr o14)) (and (= (= o15 true) (= (peekbit8 (to_rep1 (select (elts addr) (div1 o14 8))) (mod1 o14 8)) true)) (= (= o15 true) (= (nth8_stream addr o14) true))))) (and (= flag2 result4) (= flag3 o15))) (and (and (and (and (and (= o16 (+ (- 64 length1) i5)) (in_range1 (+ (- 64 length1) i5))) (and (= o17 o16) (in_range2 o16))) (and (= o18 (pokebit64 retval3 o17 flag3)) (and (forall ((i17 Int)) (=> (and (<= 0 i17) (<= i17 63)) (=> (not (= i17 (- 63 o17))) (= (= (nth o18 i17) true) (= (nth retval3 i17) true))))) (= (= flag3 true) (= (nth o18 (- 63 o17)) true))))) (and (= retval3 result5) (= retval4 o18))) (= i5 (- length1 1))))))))) (and (and (= i5 i7) (and (= flag3 flag4) (= retval4 retval5))) (and (= i8 i5) (and (= flag5 flag3) (= retval6 retval4))))) (and (and (= (mk_int__ref i9) (mk_int__ref i7)) (and (= (mk_bool__ref flag6) (mk_bool__ref flag4)) (= (mk_t__ref retval7) (mk_t__ref retval5)))) (and (= i10 i8) (and (= flag7 flag5) (= retval8 retval6))))) (and (and (= i4 i9) (and (= (mk_bool__ref flag6) (mk_bool__ref flag)) (= retval2 retval7))) (and (= i10 i4) (and (= flag7 flag1) (= retval8 retval2)))))) (and (= result7 bitwalker__peek__result2) (= bitwalker__peek__result3 retval7)))))))))
...
(assert (=> (= (> (+ start length1) (* 8 (length addr))) true) (= (t__content bitwalker__peek__result8) ((_ int2bv 64) 0))))
