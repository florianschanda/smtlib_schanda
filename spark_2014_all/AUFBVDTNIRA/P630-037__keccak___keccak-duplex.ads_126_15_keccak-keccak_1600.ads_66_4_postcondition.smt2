...
(assert (and (and (and (= (mk_map__ref result3) (mk_map__ref block)) (= block1 (keccak__keccak_1600__duplex__duplex__block__aggregate_def ((_ int2bv 8) 0)))) (and (and (and (and (and (= o9 (+ in_data_bit_length 7)) (in_range (+ in_data_bit_length 7))) (= o10 (div1 o9 8))) (and (= keccak__keccak_1600__duplex__duplex__num_bytes__assume o10) (in_range1 o10))) (= keccak__keccak_1600__duplex__duplex__num_bytes__assume num_bytes)) (and (in_range1 num_bytes) (and (ite (< 0 num_bytes) (and (and (and (and (and (and (= temp___1054 (+ (to_rep (first (rt in_data))) (- num_bytes 1))) (in_range (+ (to_rep (first (rt in_data))) (- num_bytes 1)))) (and (and (=> (<= (to_rep (first (rt in_data))) temp___1054) (and (and (<= (to_rep (first (rt in_data))) (to_rep (first (rt in_data)))) (<= (to_rep (first (rt in_data))) (to_rep (last (rt in_data))))) (and (<= (to_rep (first (rt in_data))) temp___1054) (<= temp___1054 (to_rep (last (rt in_data))))))) (= o11 (elts in_data))) (and (= o11 temp___1055) (= (mk2 (to_rep (first (rt in_data))) temp___1054) temp___10551)))) (and (= (ite (<= (to_rep (first4 temp___10551)) (to_rep (last4 temp___10551))) (+ (- (to_rep (last4 temp___10551)) (to_rep (first4 temp___10551))) 1) 0) (ite (<= 0 (- num_bytes 1)) (+ (- (- num_bytes 1) 0) 1) 0)) (and (= (slide temp___1055 (to_rep (first4 temp___10551)) 0) temp___1056) (= (mk1 0 (- num_bytes 1)) temp___10561)))) (and (and (and (=> (<= 0 (- num_bytes 1)) (and (and (<= 0 0) (<= 0 199)) (and (<= 0 (- num_bytes 1)) (<= (- num_bytes 1) 199)))) (= o12 block1)) (and (= o12 temp___1059) (= (mk1 0 (- num_bytes 1)) temp___10591))) (and (= (ite (<= (to_rep (first2 temp___10561)) (to_rep (last2 temp___10561))) (+ (- (to_rep (last2 temp___10561)) (to_rep (first2 temp___10561))) 1) 0) (ite (<= (to_rep (first2 temp___10591)) (to_rep (last2 temp___10591))) (+ (- (to_rep (last2 temp___10591)) (to_rep (first2 temp___10591))) 1) 0)) (= (mk___t1 temp___1060 temp___10601) (mk___t1 temp___1056 temp___10561))))) (forall ((temp___1061 Int)) (ite (and (<= 0 temp___1061) (<= temp___1061 (- num_bytes 1))) (= (select o13 temp___1061) (select temp___1060 temp___1061)) (= (select o13 temp___1061) (select block1 temp___1061))))) (and (= block1 result4) (= block2 o13))) (= block2 block1)) (and (and (and (and (and (and (and (= o14 (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1)))) (and (in_range3 o14) (= o14 (to_rep3 ctx__split_fields1)))) (= o15 (+ o14 7))) (= o16 (div1 o15 8))) (= keccak__keccak_1600__duplex__duplex__R176s__assume (- o16 1))) (= keccak__keccak_1600__duplex__duplex__R176s__assume r176s)) (in_range r176s)) (and (and (and (and (=> (<= 0 r176s) (and (and (<= 0 0) (<= 0 199)) (and (<= 0 r176s) (<= r176s 199)))) (= o17 block2)) (and (= o17 keccak__padding__pad101_single_block__block__compl) (= (mk3 0 r176s) keccak__padding__pad101_single_block__block__compl1))) (and (and (and (= o20 (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1)))) (and (in_range3 o20) (= o20 (to_rep3 ctx__split_fields1)))) (and (= (to_rep o19) (to_rep (last6 keccak__padding__pad101_single_block__block__compl1))) (= (to_rep o18) (to_rep (first6 keccak__padding__pad101_single_block__block__compl1))))) (and (forall ((temp___1065 Int)) (ite (and (<= 0 temp___1065) (<= temp___1065 r176s)) (= (select o21 temp___1065) (select (slide keccak__padding__pad101_single_block__block (to_rep (first (mk (to_rep (first6 keccak__padding__pad101_single_block__block__compl1)) (to_rep (last6 keccak__padding__pad101_single_block__block__compl1))))) 0) temp___1065)) (= (select o21 temp___1065) (select block2 temp___1065)))) (and (= block2 result5) (= block3 o21))))) (and (and (= (- (div1 (+ (to_rep3 ctx__split_fields1) 7) 8) 1) r179s) (in_range r179s)) (and (and (and (and (= o25 (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1)))) (and (in_range3 o25) (= o25 (to_rep3 ctx__split_fields1)))) (and (and (and (=> (<= 0 r179s) (and (and (<= 0 0) (<= 0 199)) (and (<= 0 r179s) (<= r179s 199)))) (= o22 block3)) (and (= o22 temp___1067) (= (mk4 0 r179s) temp___10671))) (and (= temp___1067 o23) (= (mk (to_rep (first8 temp___10671)) (to_rep (last8 temp___10671))) o24)))) (and (= (mk___split_fields__ref (mk___split_fields result6 result7)) (mk___split_fields__ref (mk___split_fields ctx__split_fields ctx__split_fields1))) (and (= keccak__keccak_1600__keccakf_1600_lanes__xor_bits_into_state__a ctx__split_fields2) (= ctx__split_fields1 ctx__split_fields3)))) (and (and (= result8 ctx__split_fields2) (= result9 ctx__split_fields3)) (and (= keccak__keccak_1600__keccakf_1600_permutation__permute__a ctx__split_fields4) (= ctx__split_fields3 ctx__split_fields5))))))))))) (and (and (= block4 (mk_map__ref block3)) (and (= out_data1 (mk_map__ref out_data)) (and (= ctx__split_fields6 ctx__split_fields4) (= ctx__split_fields7 ctx__split_fields5)))) (and (= block5 block3) (and (= out_data2 out_data) (= ctx__split_fields8 (mk___split_fields ctx__split_fields4 ctx__split_fields5)))))))
