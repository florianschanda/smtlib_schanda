...
(assert (and (= o41 (base Tuple0)) (= o41 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o43 (oexpon o41 o42)))
(assert (and (= o39 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o40 (num_of_big_int x x_first o39)))
(assert (= o44 (omultiply o40 o43)))
(assert (= o47 (omod o44 o46)))
(assert (and (= o37 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o38 (num_of_big_int (mk___t aux4 (mk (to_rep aux4__first) (to_rep aux4__last))) aux4_first o37)))
(assert (= o48 (oeq o38 o47)))
...
(assert (= o35 (omod o32 o34)))
(assert (and (= o28 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o29 (num_of_big_int (mk___t aux3 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first o28)))
(assert (= o36 (oeq o29 o35)))
...
(assert (= o16 (num_of_big_int x x_first o15)))
(assert (= o19 (omultiply o16 o18)))
(assert (= o23 (omultiply o19 o22)))
(assert (= o26 (omod o23 o25)))
(assert (and (= o13 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o14 (num_of_big_int (mk___t aux2 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first o13)))
(assert (= o27 (oeq o14 o26)))
(assert (= o11 (from_word32 ((_ int2bv 32) 1))))
(assert (and (= o9 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o10 (num_of_big_int (mk___t aux11 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first o9)))
(assert (= o12 (oeq o10 o11)))
