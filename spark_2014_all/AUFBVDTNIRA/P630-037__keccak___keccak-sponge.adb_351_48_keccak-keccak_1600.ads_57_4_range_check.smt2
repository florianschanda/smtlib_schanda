...
(assert (=> (<= (to_rep digest__first) (to_rep digest__last)) (= o22 (+ (- (to_rep digest__last) (to_rep digest__first)) 1))))
(assert (=> (not (<= (to_rep digest__first) (to_rep digest__last))) (= o22 0)))
