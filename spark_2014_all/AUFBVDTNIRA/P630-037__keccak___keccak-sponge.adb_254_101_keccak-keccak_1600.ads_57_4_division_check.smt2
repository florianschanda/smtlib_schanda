...
(assert (and (and (and (= (state_of (mk___rep ctx__split_fields7)) 0) (= (rate_of (mk___rep ctx__split_fields7)) (rate_of (mk___rep ctx__split_fields6)))) (= (mod2 (in_queue_bit_length (mk___rep ctx__split_fields7)) 8) (mod2 o15 8))) (< (in_queue_bit_length (mk___rep ctx__split_fields7)) (rate_of (mk___rep ctx__split_fields7)))))
(assert (and (= o20 (rate_of (mk___rep ctx__split_fields7))) (and (in_range3 o20) (and (= o20 (* (to_rep5 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields7)) 8)) (< o20 1600)))))
(assert (= o21 (ite (= o20 initial_rate1) true false)))
(assert (and (= o17 (rate_of (mk___rep ctx__split_fields7))) (and (in_range3 o17) (and (= o17 (* (to_rep5 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields7)) 8)) (< o17 1600)))))
(assert (and (= o18 (in_queue_bit_length (mk___rep ctx__split_fields7))) (and (in_range2 o18) (and (= o18 (to_rep4 (rec__keccak__keccak_1600__sponge__context__bits_absorbed ctx__split_fields7))) (< o18 1600)))))
(assert (= o19 (ite (< o18 o17) true false)))
(assert (and (= o16 (+ bit_length suffix_len)) (in_range1 (+ bit_length suffix_len))))
(assert (not (not (= 8 0))))
(check-sat)
(exit)
