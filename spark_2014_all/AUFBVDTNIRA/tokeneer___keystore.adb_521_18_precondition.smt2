...
(declare-const temp___1785 us_t1)
...
(assert (= temp___1785 (mk___t1 (temp___String_Literal_1784 Tuple0) (mk1 1 10))))
(assert (dynamic_predicate temp___1785))
(assert (= o15 temp___1785))
(assert (= o16 (convertretvaltotext retval1 o15)))
(assert (= o17 (mk___t o16 (mk 1 150))))
(assert (not (= (to_rep1 (first (rt o17))) 1)))
(check-sat)
(exit)
