...
(define-fun dynamic_invariant4 ((temp___expr_800 Int) (temp___is_init_797 Bool) (temp___skip_constant_798 Bool) (temp___do_toplevel_799 Bool)) Bool (=> (or (= temp___is_init_797 true) (<= 0 1)) (in_range3 temp___expr_800)))
...
(define-fun bool_eq2 ((a (Array Int us_rep)) (a__first Int) (a__last Int) (b (Array Int us_rep)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_148 Int)) (=> (and (<= a__first temp___idx_148) (<= temp___idx_148 a__last)) (= (bool_eq1 (select a temp___idx_148) (select b (+ (- b__first a__first) temp___idx_148))) true)))) true false))
(assert (forall ((a (Array Int us_rep)) (b (Array Int us_rep))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq2 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_148 Int)) (=> (and (<= a__first temp___idx_148) (<= temp___idx_148 a__last)) (= (bool_eq1 (select a temp___idx_148) (select b (+ (- b__first a__first) temp___idx_148))) true))))))))
...
(define-fun dynamic_invariant5 ((temp___expr_887 (_ BitVec 16)) (temp___is_init_884 Bool) (temp___skip_constant_885 Bool) (temp___do_toplevel_886 Bool)) Bool true)
...
(assert (forall ((temp___150 us_rep) (temp___151 us_rep)) (let ((temp___149 (hw__dbc__xcap_reg_descs__aggregate_def temp___150 temp___151))) (and (= (select temp___149 0) temp___150) (= (select temp___149 1) temp___151)))))
...
(assert (= o5 (bvsub o4 (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) (to_rep (rec__hw__dbc__xcap_s_regs__t__lsb (us_split_fields1 (select regs idx)))))))))
(assert (= o6 o5))
(assert (= result mask))
(assert (= mask1 o6))
(assert true)
...
(assert true)
(assert (not (bvule ((_ zero_extend 32) ((_ int2bv 32) 0)) (bvor (bvand ((_ zero_extend 32) temp1) (bvnot mask1)) (bvshl ((_ zero_extend 48) value) ((_ int2bv 64) (to_rep (rec__hw__dbc__xcap_s_regs__t__lsb (us_split_fields1 (select regs idx))))))))))
(check-sat)
(exit)
