...
(define-fun dynamic_invariant2 ((temp___expr_612 (_ BitVec 32)) (temp___is_init_608 Bool) (temp___skip_constant_609 Bool) (temp___do_toplevel_610 Bool) (temp___do_typ_inv_611 Bool)) Bool true)
...
(define-fun word_t__ref___22__projection ((a word_t__ref)) word_t (word_t__content a))
(define-fun dynamic_invariant5 ((temp___expr_1000 (_ BitVec 16)) (temp___is_init_996 Bool) (temp___skip_constant_997 Bool) (temp___do_toplevel_998 Bool) (temp___do_typ_inv_999 Bool)) Bool true)
...
(assert (= xcap_reg_descs (hw__dbc__xcap_reg_descs__aggregate_def (mk___rep (mk___split_fields (of_rep 0) (of_rep 7) (of_rep 0))) (mk___rep (mk___split_fields (of_rep 0) (of_rep 15) (of_rep 8))))))
...
(declare-const hw__dbc__xcap_regs__write_i__2__off__assume Int)
...
(assert (= o1 (div1 o 4)))
(assert (and (= hw__dbc__xcap_regs__write_i__2__off__assume o1) (in_range2 o1)))
(assert (= hw__dbc__xcap_regs__write_i__2__off__assume off))
...
(assert (not (bvule ((_ zero_extend 32) #x00000000) (bvor (bvand ((_ zero_extend 32) temp) (bvnot mask1)) (bvshl ((_ zero_extend 48) value) ((_ int2bv 64) (to_rep (rec__hw__dbc__xcap_s_regs__t__lsb (us_split_fields1 (select regs idx))))))))))
(check-sat)
(exit)
