...
(assert (and (= o13 (rate_of (mk___rep (us_split_fields__content ctx__split_fields32)))) (and (in_range3 o13) (and (= o13 (* (to_rep5 (rec__keccak__keccak_1600__sponge__context__rate (us_split_fields__content ctx__split_fields32))) 8)) (< o13 1600)))))
(assert (and (= o14 (in_queue_bit_length (mk___rep (us_split_fields__content ctx__split_fields32)))) (and (in_range2 o14) (and (= o14 (to_rep4 (rec__keccak__keccak_1600__sponge__context__bits_absorbed (us_split_fields__content ctx__split_fields32)))) (< o14 1600)))))
(assert (= o15 (ite (< o14 o13) true false)))
(assert (not (in_range1 (+ bit_length suffix_len))))
(check-sat)
(exit)
