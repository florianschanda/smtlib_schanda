...
(define-fun dynamic_invariant3 ((temp___expr_293 Int) (temp___is_init_289 Bool) (temp___skip_constant_290 Bool) (temp___do_toplevel_291 Bool) (temp___do_typ_inv_292 Bool)) Bool (=> (or (= temp___is_init_289 true) (<= 0 2147483647)) (in_range4 temp___expr_293)))
...
(define-fun dynamic_invariant5 ((temp___expr_413 Int) (temp___is_init_409 Bool) (temp___skip_constant_410 Bool) (temp___do_toplevel_411 Bool) (temp___do_typ_inv_412 Bool)) Bool (=> (or (= temp___is_init_409 true) (<= 0 1)) (in_range5 temp___expr_413)))
(assert (forall ((ctx us_rep)) (! (dynamic_invariant5 (state_of ctx) true false true true) :pattern ((state_of ctx)))))
...
(declare-const ctx__split_fields13 us_split_fields__ref)
...
(assert (dynamic_invariant4 data true false true true))
...
(assert (and (= o3 (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5)))) (and (in_range3 o3) (and (= o3 (* (to_rep4 ctx__split_fields4) 8)) (< o3 1600)))))
...
(assert (and (= o4 (+ (to_rep1 (first (rt data))) (- initial_data_len1 1))) (in_range1 (+ (to_rep1 (first (rt data))) (- initial_data_len1 1)))))
(assert (and (= o5 o4) (in_range4 o4)))
(assert (= result5 (mk_int__ref data_last)))
(assert (= data_last1 o5))
(assert (and (= o6 (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5)))) (and (in_range3 o6) (and (= o6 (* (to_rep4 ctx__split_fields4) 8)) (< o6 1600)))))
...
(assert (=> (< 0 free_bits_in_block1) (= result8 (mk_int__ref block_offset))))
(assert (=> (< 0 free_bits_in_block1) (= block_offset2 (div1 (to_rep3 ctx__split_fields2) 8))))
(assert (=> (< 0 free_bits_in_block1) (= block_offset2 r81s)))
(assert (=> (< 0 free_bits_in_block1) (in_range2 r81s)))
(assert (=> (< 0 free_bits_in_block1) (and (= keccak__keccak_1600__sponge__absorb__R82s__assume (+ block_offset2 (- free_bytes_in_block1 1))) (in_range1 (+ block_offset2 (- free_bytes_in_block1 1))))))
(assert (=> (< 0 free_bits_in_block1) (= keccak__keccak_1600__sponge__absorb__R82s__assume r82s)))
(assert (=> (< 0 free_bits_in_block1) (in_range1 r82s)))
(assert (=> (< 0 free_bits_in_block1) (and (= keccak__keccak_1600__sponge__absorb__R85s__assume (+ (to_rep1 (first (rt data))) (- free_bytes_in_block1 1))) (in_range1 (+ (to_rep1 (first (rt data))) (- free_bytes_in_block1 1))))))
(assert (=> (< 0 free_bits_in_block1) (= keccak__keccak_1600__sponge__absorb__R85s__assume r85s)))
(assert (=> (< 0 free_bits_in_block1) (in_range1 r85s)))
(assert (=> (< 0 free_bits_in_block1) (=> (<= (to_rep1 (first (rt data))) r85s) (and (and (<= (to_rep1 (first (rt data))) (to_rep1 (first (rt data)))) (<= (to_rep1 (first (rt data))) (to_rep1 (last (rt data))))) (and (<= (to_rep1 (first (rt data))) r85s) (<= r85s (to_rep1 (last (rt data)))))))))
(assert (=> (< 0 free_bits_in_block1) (= o10 (elts data))))
(assert (=> (< 0 free_bits_in_block1) (= temp___886 (mk___t4 o10 (mk4 (to_rep1 (first (rt data))) r85s)))))
(assert (=> (< 0 free_bits_in_block1) (= (ite (<= (to_rep1 (first8 (rt4 temp___886))) (to_rep1 (last8 (rt4 temp___886)))) (+ (- (to_rep1 (last8 (rt4 temp___886))) (to_rep1 (first8 (rt4 temp___886)))) 1) 0) (ite (<= r81s r82s) (+ (- r82s r81s) 1) 0))))
(assert (=> (< 0 free_bits_in_block1) (= temp___887 (mk___t3 (slide (elts4 temp___886) (to_rep1 (first8 (rt4 temp___886))) r81s) (mk3 r81s r82s)))))
(assert (=> (< 0 free_bits_in_block1) (=> (<= r81s r82s) (and (and (<= 0 r81s) (<= r81s 199)) (and (<= 0 r82s) (<= r82s 199))))))
(assert (=> (< 0 free_bits_in_block1) (= o11 ctx__split_fields1)))
(assert (=> (< 0 free_bits_in_block1) (= temp___889 (mk___t3 o11 (mk3 r81s r82s)))))
(assert (=> (< 0 free_bits_in_block1) (= (ite (<= (to_rep1 (first6 (rt3 temp___887))) (to_rep1 (last6 (rt3 temp___887)))) (+ (- (to_rep1 (last6 (rt3 temp___887))) (to_rep1 (first6 (rt3 temp___887)))) 1) 0) (ite (<= (to_rep1 (first6 (rt3 temp___889))) (to_rep1 (last6 (rt3 temp___889)))) (+ (- (to_rep1 (last6 (rt3 temp___889))) (to_rep1 (first6 (rt3 temp___889)))) 1) 0))))
(assert (=> (< 0 free_bits_in_block1) (= temp___891 temp___887)))
(assert (=> (< 0 free_bits_in_block1) (forall ((temp___892 Int)) (ite (and (<= r81s temp___892) (<= temp___892 r82s)) (= (select o12 temp___892) (select (elts3 temp___891) temp___892)) (= (select o12 temp___892) (select ctx__split_fields1 temp___892))))))
(assert (=> (< 0 free_bits_in_block1) (= o13 (mk___split_fields ctx__split_fields o12 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5))))
(assert (=> (< 0 free_bits_in_block1) (= temp___894 (mk___rep o13))))
(assert (=> (< 0 free_bits_in_block1) (= result9 (mk___split_fields__ref (mk___split_fields ctx__split_fields ctx__split_fields1 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5)))))
(assert (=> (< 0 free_bits_in_block1) (= ctx__split_fields7 (us_split_fields1 temp___894))))
(assert (=> (< 0 free_bits_in_block1) (and (= o14 (+ offset1 free_bytes_in_block1)) (in_range1 (+ offset1 free_bytes_in_block1)))))
(assert (=> (< 0 free_bits_in_block1) (= result10 (mk_int__ref offset1))))
(assert (=> (< 0 free_bits_in_block1) (= offset2 o14)))
(assert (=> (< 0 free_bits_in_block1) (and (= o15 (- remaining_bytes1 free_bytes_in_block1)) (in_range1 (- remaining_bytes1 free_bytes_in_block1)))))
(assert (=> (< 0 free_bits_in_block1) (and (= o16 o15) (in_range2 o15))))
(assert (=> (< 0 free_bits_in_block1) (= result11 (mk_int__ref remaining_bytes1))))
(assert (=> (< 0 free_bits_in_block1) (= remaining_bytes2 o16)))
(assert (=> (< 0 free_bits_in_block1) (and (= o17 (- remaining_bits1 free_bits_in_block1)) (in_range1 (- remaining_bits1 free_bits_in_block1)))))
(assert (=> (< 0 free_bits_in_block1) (and (= o18 o17) (in_range2 o17))))
(assert (=> (< 0 free_bits_in_block1) (= result12 (mk_int__ref remaining_bits1))))
(assert (=> (< 0 free_bits_in_block1) (= remaining_bits2 o18)))
(assert (=> (not (< 0 free_bits_in_block1)) (= block_offset2 block_offset)))
(assert (=> (not (< 0 free_bits_in_block1)) (= remaining_bytes2 remaining_bytes1)))
(assert (=> (not (< 0 free_bits_in_block1)) (= remaining_bits2 remaining_bits1)))
(assert (=> (not (< 0 free_bits_in_block1)) (= offset2 offset1)))
(assert (=> (not (< 0 free_bits_in_block1)) (= ctx__split_fields7 (mk___split_fields ctx__split_fields ctx__split_fields1 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5))))
(assert (=> (not (< 0 free_bits_in_block1)) (= block_offset2 block_offset1)))
(assert (=> (not (< 0 free_bits_in_block1)) (= remaining_bytes2 remaining_bytes1)))
(assert (=> (not (< 0 free_bits_in_block1)) (= remaining_bits2 remaining_bits1)))
(assert (=> (not (< 0 free_bits_in_block1)) (= offset2 offset1)))
(assert (=> (not (< 0 free_bits_in_block1)) (= ctx__split_fields7 ctx__split_fields6)))
(assert (= (- (to_rep4 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields7)) 1) r88s))
(assert (in_range1 r88s))
(assert (=> (<= 0 r88s) (and (and (<= 0 0) (<= 0 199)) (and (<= 0 r88s) (<= r88s 199)))))
(assert (= o19 (rec__keccak__keccak_1600__sponge__context__block ctx__split_fields7)))
(assert (= temp___897 (mk___t5 o19 (mk5 0 r88s))))
(assert (= o20 (mk___t (elts5 temp___897) (mk (to_rep1 (first10 (rt5 temp___897))) (to_rep1 (last10 (rt5 temp___897)))))))
(assert (= result13 (mk___split_fields__ref ctx__split_fields7)))
(assert (= ctx__split_fields8 (mk___split_fields keccak__keccak_1600__keccakf_1600_lanes__xor_bits_into_state__a (rec__keccak__keccak_1600__sponge__context__block ctx__split_fields7) (rec__keccak__keccak_1600__sponge__context__bits_absorbed ctx__split_fields7) (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields7) (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields7) (rec__keccak__keccak_1600__sponge__context__curr_state ctx__split_fields7))))
(assert (= result14 (mk___split_fields__ref ctx__split_fields8)))
(assert (= ctx__split_fields9 (mk___split_fields keccak__keccak_1600__keccakf_1600_permutation__permute__a (rec__keccak__keccak_1600__sponge__context__block ctx__split_fields8) (rec__keccak__keccak_1600__sponge__context__bits_absorbed ctx__split_fields8) (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields8) (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields8) (rec__keccak__keccak_1600__sponge__context__curr_state ctx__split_fields8))))
(assert (= (+ offset2 remaining_bytes2) initial_data_len1))
(assert (= remaining_bytes2 (div1 (+ remaining_bits2 7) 8)))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= temp___910 remaining_bytes2)))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= temp___909 remaining_bits2)))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= temp___908 offset2)))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= temp___907 (mk___rep ctx__split_fields9))))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= temp___913 (mk_int__ref 0))))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= temp___912 (mk_int__ref 0))))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= temp___911 (mk_int__ref 0))))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (and (and (and (and (= (+ offset3 remaining_bytes3) initial_data_len1) (= remaining_bytes3 (div1 (+ remaining_bits3 7) 8))) (= (mod2 bit_length 8) (mod2 remaining_bits3 8))) (= (state_of (mk___rep ctx__split_fields10)) 0)) (= (rate_of (mk___rep ctx__split_fields10)) initial_bit_rate1))))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (and (and (and (and (and (and (and (= (rec__keccak__keccak_1600__sponge__context__block ctx__split_fields10) (rec__keccak__keccak_1600__sponge__context__block (us_split_fields1 temp___907))) (= (rec__keccak__keccak_1600__sponge__context__bits_absorbed ctx__split_fields10) (rec__keccak__keccak_1600__sponge__context__bits_absorbed (us_split_fields1 temp___907)))) (= (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields10) (rec__keccak__keccak_1600__sponge__context__bytes_squeezed (us_split_fields1 temp___907)))) (= (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields10) (rec__keccak__keccak_1600__sponge__context__rate (us_split_fields1 temp___907)))) (= (rec__keccak__keccak_1600__sponge__context__curr_state ctx__split_fields10) (rec__keccak__keccak_1600__sponge__context__curr_state (us_split_fields1 temp___907)))) (=> (<= 0 2147483647) (in_range2 offset3))) (=> (<= 0 2147483647) (in_range2 remaining_bits3))) (=> (<= 0 2147483647) (in_range2 remaining_bytes3)))))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= result15 (let ((subject temp___913)) (mk_int__ref temp___9131)))))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= (let ((subject temp___913)) temp___9132) remaining_bytes3)))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= result16 (let ((subject temp___912)) (mk_int__ref temp___9121)))))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= (let ((subject temp___912)) temp___9122) remaining_bits3)))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= result17 (let ((subject temp___911)) (mk_int__ref temp___9111)))))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= (let ((subject temp___911)) temp___9112) offset3)))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (and (= keccak__keccak_1600__sponge__absorb__L_1__R91s__assume (+ (to_rep1 (first (rt data))) offset3)) (in_range1 (+ (to_rep1 (first (rt data))) offset3)))))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= keccak__keccak_1600__sponge__absorb__L_1__R91s__assume r91s)))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (in_range1 r91s)))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (and (= o21 (+ offset3 (- (to_rep4 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields10)) 1))) (in_range1 (+ offset3 (- (to_rep4 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields10)) 1))))))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= o22 (+ (to_rep1 (first (rt data))) o21))))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (and (= keccak__keccak_1600__sponge__absorb__L_1__R92s__assume o22) (in_range1 o22))))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= keccak__keccak_1600__sponge__absorb__L_1__R92s__assume r92s)))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (in_range1 r92s)))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (=> (<= r91s r92s) (and (and (<= (to_rep1 (first (rt data))) r91s) (<= r91s (to_rep1 (last (rt data))))) (and (<= (to_rep1 (first (rt data))) r92s) (<= r92s (to_rep1 (last (rt data)))))))))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= o23 (elts data))))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= temp___902 (mk___t6 o23 (mk6 r91s r92s)))))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= o24 (mk___t (elts6 temp___902) (mk (to_rep1 (first12 (rt6 temp___902))) (to_rep1 (last12 (rt6 temp___902))))))))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= result18 (mk___split_fields__ref ctx__split_fields10))))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= ctx__split_fields11 (mk___split_fields keccak__keccak_1600__keccakf_1600_lanes__xor_bits_into_state__a1 (rec__keccak__keccak_1600__sponge__context__block ctx__split_fields10) (rec__keccak__keccak_1600__sponge__context__bits_absorbed ctx__split_fields10) (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields10) (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields10) (rec__keccak__keccak_1600__sponge__context__curr_state ctx__split_fields10)))))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= result19 (mk___split_fields__ref ctx__split_fields11))))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= ctx__split_fields12 (mk___split_fields keccak__keccak_1600__keccakf_1600_permutation__permute__a1 (rec__keccak__keccak_1600__sponge__context__block ctx__split_fields11) (rec__keccak__keccak_1600__sponge__context__bits_absorbed ctx__split_fields11) (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields11) (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields11) (rec__keccak__keccak_1600__sponge__context__curr_state ctx__split_fields11)))))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (and (= o25 (+ offset3 (to_rep4 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields12)))) (in_range1 (+ offset3 (to_rep4 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields12)))))))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= result20 (mk_int__ref offset3))))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= offset4 o25)))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (and (= o26 (- remaining_bytes3 (to_rep4 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields12)))) (in_range2 (- remaining_bytes3 (to_rep4 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields12)))))))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= result21 (mk_int__ref remaining_bytes3))))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= remaining_bytes4 o26)))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (and (= o27 (- remaining_bits3 initial_bit_rate1)) (in_range2 (- remaining_bits3 initial_bit_rate1)))))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= result22 (mk_int__ref remaining_bits3))))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= remaining_bits4 o27)))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (not (<= initial_bit_rate1 remaining_bits4))))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= remaining_bytes5 (mk_int__ref remaining_bytes4))))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= remaining_bits5 (mk_int__ref remaining_bits4))))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= offset5 (mk_int__ref offset4))))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= ctx__split_fields13 (mk___split_fields__ref ctx__split_fields12))))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= remaining_bytes6 remaining_bytes4)))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= remaining_bits6 remaining_bits4)))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= offset6 offset4)))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= ctx__split_fields14 ctx__split_fields12)))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= remaining_bytes7 remaining_bytes5)))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= remaining_bits7 remaining_bits5)))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= offset7 offset5)))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= ctx__split_fields15 ctx__split_fields13)))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= remaining_bytes8 remaining_bytes6)))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= remaining_bits8 remaining_bits6)))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= offset8 offset6)))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= ctx__split_fields16 ctx__split_fields14)))
(assert (=> (not (<= initial_bit_rate1 remaining_bits2)) (= remaining_bytes7 (mk_int__ref remaining_bytes2))))
(assert (=> (not (<= initial_bit_rate1 remaining_bits2)) (= remaining_bits7 (mk_int__ref remaining_bits2))))
(assert (=> (not (<= initial_bit_rate1 remaining_bits2)) (= offset7 (mk_int__ref offset2))))
(assert (=> (not (<= initial_bit_rate1 remaining_bits2)) (= ctx__split_fields15 (mk___split_fields__ref ctx__split_fields9))))
(assert (=> (not (<= initial_bit_rate1 remaining_bits2)) (= remaining_bytes8 remaining_bytes2)))
(assert (=> (not (<= initial_bit_rate1 remaining_bits2)) (= remaining_bits8 remaining_bits2)))
(assert (=> (not (<= initial_bit_rate1 remaining_bits2)) (= offset8 offset2)))
(assert (=> (not (<= initial_bit_rate1 remaining_bits2)) (= ctx__split_fields16 ctx__split_fields9)))
(assert (=> (< 0 (int__content remaining_bits7)) (= (- (int__content remaining_bytes7) 1) r95s)))
(assert (=> (< 0 (int__content remaining_bits7)) (in_range1 r95s)))
(assert (=> (< 0 (int__content remaining_bits7)) (and (= keccak__keccak_1600__sponge__absorb__R98s__assume (+ (to_rep1 (first (rt data))) (int__content offset7))) (in_range1 (+ (to_rep1 (first (rt data))) (int__content offset7))))))
(assert (=> (< 0 (int__content remaining_bits7)) (= keccak__keccak_1600__sponge__absorb__R98s__assume r98s)))
(assert (=> (< 0 (int__content remaining_bits7)) (in_range1 r98s)))
(assert (=> (< 0 (int__content remaining_bits7)) (and (= o28 (+ (int__content offset7) (- (int__content remaining_bytes7) 1))) (in_range1 (+ (int__content offset7) (- (int__content remaining_bytes7) 1))))))
(assert (=> (< 0 (int__content remaining_bits7)) (= o29 (+ (to_rep1 (first (rt data))) o28))))
(assert (=> (< 0 (int__content remaining_bits7)) (and (= keccak__keccak_1600__sponge__absorb__R99s__assume o29) (in_range1 o29))))
(assert (=> (< 0 (int__content remaining_bits7)) (= keccak__keccak_1600__sponge__absorb__R99s__assume r99s)))
(assert (=> (< 0 (int__content remaining_bits7)) (in_range1 r99s)))
(assert (=> (< 0 (int__content remaining_bits7)) (=> (<= r98s r99s) (and (and (<= (to_rep1 (first (rt data))) r98s) (<= r98s (to_rep1 (last (rt data))))) (and (<= (to_rep1 (first (rt data))) r99s) (<= r99s (to_rep1 (last (rt data)))))))))
(assert (=> (< 0 (int__content remaining_bits7)) (= o30 (elts data))))
(assert (=> (< 0 (int__content remaining_bits7)) (= temp___914 (mk___t8 o30 (mk8 r98s r99s)))))
(assert (=> (< 0 (int__content remaining_bits7)) (= (ite (<= (to_rep1 (first16 (rt8 temp___914))) (to_rep1 (last16 (rt8 temp___914)))) (+ (- (to_rep1 (last16 (rt8 temp___914))) (to_rep1 (first16 (rt8 temp___914)))) 1) 0) (ite (<= 0 r95s) (+ (- r95s 0) 1) 0))))
(assert (=> (< 0 (int__content remaining_bits7)) (= temp___915 (mk___t7 (slide (elts8 temp___914) (to_rep1 (first16 (rt8 temp___914))) 0) (mk7 0 r95s)))))
(assert (=> (< 0 (int__content remaining_bits7)) (=> (<= 0 r95s) (and (and (<= 0 0) (<= 0 199)) (and (<= 0 r95s) (<= r95s 199))))))
(assert (=> (< 0 (int__content remaining_bits7)) (= o31 (rec__keccak__keccak_1600__sponge__context__block (us_split_fields__content ctx__split_fields15)))))
(assert (=> (< 0 (int__content remaining_bits7)) (= temp___918 (mk___t7 o31 (mk7 0 r95s)))))
(assert (=> (< 0 (int__content remaining_bits7)) (= (ite (<= (to_rep1 (first14 (rt7 temp___915))) (to_rep1 (last14 (rt7 temp___915)))) (+ (- (to_rep1 (last14 (rt7 temp___915))) (to_rep1 (first14 (rt7 temp___915)))) 1) 0) (ite (<= (to_rep1 (first14 (rt7 temp___918))) (to_rep1 (last14 (rt7 temp___918)))) (+ (- (to_rep1 (last14 (rt7 temp___918))) (to_rep1 (first14 (rt7 temp___918)))) 1) 0))))
(assert (=> (< 0 (int__content remaining_bits7)) (= temp___920 temp___915)))
(assert (=> (< 0 (int__content remaining_bits7)) (forall ((temp___921 Int)) (ite (and (<= 0 temp___921) (<= temp___921 r95s)) (= (select o32 temp___921) (select (elts7 temp___920) temp___921)) (= (select o32 temp___921) (select (rec__keccak__keccak_1600__sponge__context__block (us_split_fields__content ctx__split_fields15)) temp___921))))))
(assert (=> (< 0 (int__content remaining_bits7)) (= o33 (mk___split_fields (rec__keccak__keccak_1600__sponge__context__state (us_split_fields__content ctx__split_fields15)) o32 (rec__keccak__keccak_1600__sponge__context__bits_absorbed (us_split_fields__content ctx__split_fields15)) (rec__keccak__keccak_1600__sponge__context__bytes_squeezed (us_split_fields__content ctx__split_fields15)) (rec__keccak__keccak_1600__sponge__context__rate (us_split_fields__content ctx__split_fields15)) (rec__keccak__keccak_1600__sponge__context__curr_state (us_split_fields__content ctx__split_fields15))))))
(assert (=> (< 0 (int__content remaining_bits7)) (= temp___923 (mk___rep o33))))
(assert (=> (< 0 (int__content remaining_bits7)) (= result23 ctx__split_fields15)))
(assert (=> (< 0 (int__content remaining_bits7)) (= ctx__split_fields17 (us_split_fields1 temp___923))))
(assert (=> (< 0 (int__content remaining_bits7)) (= ctx__split_fields18 (mk___split_fields__ref ctx__split_fields17))))
(assert (=> (< 0 (int__content remaining_bits7)) (= ctx__split_fields19 ctx__split_fields17)))
(assert (=> (not (< 0 (int__content remaining_bits7))) (= ctx__split_fields18 ctx__split_fields15)))
(assert (=> (not (< 0 (int__content remaining_bits7))) (= ctx__split_fields19 ctx__split_fields16)))
(assert (and (and (and (= (mod2 (int__content remaining_bits7) 8) (mod2 bit_length 8)) (= (state_of (mk___rep (us_split_fields__content ctx__split_fields18))) 0)) (< (int__content remaining_bits7) (rate_of (mk___rep (us_split_fields__content ctx__split_fields18))))) (= (rate_of (mk___rep (us_split_fields__content ctx__split_fields18))) initial_bit_rate1)))
(assert (not (in_range7 (int__content remaining_bits7))))
(check-sat)
(exit)
