...
(assert (=> (< 0 free_bits_in_block1) (= temp___817 (mk___t4 o10 (mk4 (to_rep1 (first (rt data))) r85s)))))
(assert (=> (< 0 free_bits_in_block1) (= (ite (<= (to_rep1 (first8 (rt4 temp___817))) (to_rep1 (last8 (rt4 temp___817)))) (+ (- (to_rep1 (last8 (rt4 temp___817))) (to_rep1 (first8 (rt4 temp___817)))) 1) 0) (ite (<= r81s r82s) (+ (- r82s r81s) 1) 0))))
(assert (=> (< 0 free_bits_in_block1) (= temp___818 (mk___t3 (slide (elts4 temp___817) (to_rep1 (first8 (rt4 temp___817))) r81s) (mk3 r81s r82s)))))
...
(assert (=> (< 0 free_bits_in_block1) (= temp___820 (mk___t3 o11 (mk3 r81s r82s)))))
(assert (=> (< 0 free_bits_in_block1) (= (ite (<= (to_rep1 (first6 (rt3 temp___818))) (to_rep1 (last6 (rt3 temp___818)))) (+ (- (to_rep1 (last6 (rt3 temp___818))) (to_rep1 (first6 (rt3 temp___818)))) 1) 0) (ite (<= (to_rep1 (first6 (rt3 temp___820))) (to_rep1 (last6 (rt3 temp___820)))) (+ (- (to_rep1 (last6 (rt3 temp___820))) (to_rep1 (first6 (rt3 temp___820)))) 1) 0))))
(assert (=> (< 0 free_bits_in_block1) (= temp___822 temp___818)))
(assert (=> (< 0 free_bits_in_block1) (forall ((temp___823 Int)) (ite (and (<= r81s temp___823) (<= temp___823 r82s)) (= (select o12 temp___823) (select (elts3 temp___822) temp___823)) (= (select o12 temp___823) (select ctx__split_fields1 temp___823))))))
...
(assert (=> (< 0 free_bits_in_block1) (= temp___825 (mk___rep o13))))
...
(assert (=> (< 0 free_bits_in_block1) (= ctx__split_fields7 (us_split_fields1 temp___825))))
...
(assert (= temp___828 (mk___t5 o19 (mk5 0 r88s))))
(assert (= o20 (mk___t (elts5 temp___828) (mk (to_rep1 (first10 (rt5 temp___828))) (to_rep1 (last10 (rt5 temp___828)))))))
...
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= temp___841 remaining_bits2)))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= temp___840 offset2)))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= temp___839 remaining_bytes2)))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= temp___838 (mk___rep ctx__split_fields9))))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= temp___844 (mk_int__ref 0))))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= temp___843 (mk_int__ref 0))))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= temp___842 (mk_int__ref 0))))
...
(assert (=> (<= initial_bit_rate1 remaining_bits2) (and (and (and (and (and (and (and (= (rec__keccak__keccak_1600__sponge__context__block ctx__split_fields10) (rec__keccak__keccak_1600__sponge__context__block (us_split_fields1 temp___838))) (= (rec__keccak__keccak_1600__sponge__context__bits_absorbed ctx__split_fields10) (rec__keccak__keccak_1600__sponge__context__bits_absorbed (us_split_fields1 temp___838)))) (= (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields10) (rec__keccak__keccak_1600__sponge__context__bytes_squeezed (us_split_fields1 temp___838)))) (= (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields10) (rec__keccak__keccak_1600__sponge__context__rate (us_split_fields1 temp___838)))) (= (rec__keccak__keccak_1600__sponge__context__curr_state ctx__split_fields10) (rec__keccak__keccak_1600__sponge__context__curr_state (us_split_fields1 temp___838)))) (=> (<= 0 2147483647) (in_range2 remaining_bytes3))) (=> (<= 0 2147483647) (in_range2 offset3))) (=> (<= 0 2147483647) (in_range2 remaining_bits3)))))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= result15 (let ((subject temp___844)) (mk_int__ref temp___8441)))))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= (let ((subject temp___844)) temp___8442) remaining_bytes3)))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= result16 (let ((subject temp___843)) (mk_int__ref temp___8431)))))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= (let ((subject temp___843)) temp___8432) remaining_bits3)))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= result17 (let ((subject temp___842)) (mk_int__ref temp___8421)))))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= (let ((subject temp___842)) temp___8422) offset3)))
...
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= temp___833 (mk___t6 o23 (mk6 r91s r92s)))))
(assert (=> (<= initial_bit_rate1 remaining_bits2) (= o24 (mk___t (elts6 temp___833) (mk (to_rep1 (first12 (rt6 temp___833))) (to_rep1 (last12 (rt6 temp___833))))))))
...
(assert (=> (< 0 (int__content remaining_bits7)) (= temp___845 (mk___t8 o30 (mk8 r98s r99s)))))
(assert (=> (< 0 (int__content remaining_bits7)) (= (ite (<= (to_rep1 (first16 (rt8 temp___845))) (to_rep1 (last16 (rt8 temp___845)))) (+ (- (to_rep1 (last16 (rt8 temp___845))) (to_rep1 (first16 (rt8 temp___845)))) 1) 0) (ite (<= 0 r95s) (+ (- r95s 0) 1) 0))))
(assert (=> (< 0 (int__content remaining_bits7)) (= temp___846 (mk___t7 (slide (elts8 temp___845) (to_rep1 (first16 (rt8 temp___845))) 0) (mk7 0 r95s)))))
...
(assert (=> (< 0 (int__content remaining_bits7)) (= temp___849 (mk___t7 o31 (mk7 0 r95s)))))
(assert (=> (< 0 (int__content remaining_bits7)) (= (ite (<= (to_rep1 (first14 (rt7 temp___846))) (to_rep1 (last14 (rt7 temp___846)))) (+ (- (to_rep1 (last14 (rt7 temp___846))) (to_rep1 (first14 (rt7 temp___846)))) 1) 0) (ite (<= (to_rep1 (first14 (rt7 temp___849))) (to_rep1 (last14 (rt7 temp___849)))) (+ (- (to_rep1 (last14 (rt7 temp___849))) (to_rep1 (first14 (rt7 temp___849)))) 1) 0))))
(assert (=> (< 0 (int__content remaining_bits7)) (= temp___851 temp___846)))
(assert (=> (< 0 (int__content remaining_bits7)) (forall ((temp___852 Int)) (ite (and (<= 0 temp___852) (<= temp___852 r95s)) (= (select o32 temp___852) (select (elts7 temp___851) temp___852)) (= (select o32 temp___852) (select (rec__keccak__keccak_1600__sponge__context__block (us_split_fields__content ctx__split_fields15)) temp___852))))))
...
(assert (=> (< 0 (int__content remaining_bits7)) (= temp___854 (mk___rep o33))))
(assert (=> (< 0 (int__content remaining_bits7)) (= result23 ctx__split_fields15)))
(assert (=> (< 0 (int__content remaining_bits7)) (= ctx__split_fields17 (us_split_fields1 temp___854))))
