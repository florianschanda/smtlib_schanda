...
(assert (and (= o (max_input_length (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1)))) (and (in_range4 o) (= o (- (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1))) 2)))))
(assert (= result (ite (<= in_data_bit_length o) true false)))
(assert (= result true))
