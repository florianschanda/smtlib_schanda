...
(assert (not (= (ite (<= (to_rep (first8 temp___9181)) (to_rep (last8 temp___9181))) (+ (- (to_rep (last8 temp___9181)) (to_rep (first8 temp___9181))) 1) 0) (ite (<= r140s r141s) (+ (- r141s r140s) 1) 0))))
(check-sat)
(exit)
