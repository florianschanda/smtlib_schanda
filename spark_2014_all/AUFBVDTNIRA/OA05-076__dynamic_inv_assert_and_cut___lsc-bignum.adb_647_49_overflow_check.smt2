...
(assert (= o74 (bvadd o73 #x0000000000000001)))
(assert (= o75 (bvmul o74 #x0000000000000020)))
(assert (= o76 (ite (bvult i2 o75) true false)))
(assert (= o68 (from_word32 #x00000001)))
...
(assert (and (= o9 (base Tuple0)) (= o9 (oexpon (from_word32 #x00000002) 32))))
