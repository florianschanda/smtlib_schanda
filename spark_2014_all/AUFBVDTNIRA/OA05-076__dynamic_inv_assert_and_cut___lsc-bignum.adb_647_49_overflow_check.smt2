...
(assert (= j2 1))
(assert (= temp___645 s2))
(assert (= temp___644 j2))
(assert (= temp___643 w1))
(assert (and (and (and (and (and (and (and (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t aux1 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 ((_ int2bv 32) 1))) true)) (= (oeq (num_of_big_int (mk___t aux2 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t aux31 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (omultiply (oexpon__2 (num_of_big_int x x_first (+ l1 1)) (odivide (num_of_big_int e e_first (+ (- e_last e_first) 1)) (oexpon__2 (from_word32 ((_ int2bv 32) 2)) (oadd (from_word64 i2) (from_word32 ((_ int2bv 32) 1)))))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (forall ((n1 Int)) (=> (and (<= 0 n1) (<= n1 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux45) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n1 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))) (= (oeq (omultiply (from_word32 w2) (oexpon (from_word32 ((_ int2bv 32) 2)) (- (- j3 s3) 1))) (omod (odivide (num_of_big_int e e_first (+ (- e_last e_first) 1)) (oexpon__2 (from_word32 ((_ int2bv 32) 2)) (osubtract (from_word64 i2) (osubtract (from_integer j3) (from_word32 ((_ int2bv 32) 1)))))) (oexpon (from_word32 ((_ int2bv 32) 2)) j3))) true)) (= (bvurem w2 ((_ int2bv 32) 2)) ((_ int2bv 32) 1))) (<= 0 s3)) (< s3 j3)) (<= j3 (+ k 1))) (= (ole (from_integer j3) (oadd (from_word64 i2) (from_word32 ((_ int2bv 32) 1)))) true)) (bvult i2 (bvmul (bvadd ((_ int2bv 64) (- e_last e_first)) ((_ int2bv 64) 1)) ((_ int2bv 64) 32)))))
...
(assert (<= 1 h8))
(assert (<= h8 r94b))
(assert (and (and (and (and (and (and (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t aux1 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 ((_ int2bv 32) 1))) true)) (= (oeq (num_of_big_int (mk___t aux2 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t aux32 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (omultiply (oexpon__2 (num_of_big_int x x_first (+ l1 1)) (omultiply (odivide (num_of_big_int e e_first (+ (- e_last e_first) 1)) (oexpon__2 (from_word32 ((_ int2bv 32) 2)) (oadd (from_word64 i2) (from_word32 ((_ int2bv 32) 1))))) (oexpon (from_word32 ((_ int2bv 32) 2)) (- h9 1)))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (forall ((n1 Int)) (=> (and (<= 0 n1) (<= n1 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux45) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n1 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))) (= (oeq (from_word32 (t__content w7)) (omod (odivide (num_of_big_int e e_first (+ (- e_last e_first) 1)) (oexpon__2 (from_word32 ((_ int2bv 32) 2)) (osubtract (from_word64 i2) (osubtract (from_integer s10) (from_word32 ((_ int2bv 32) 1)))))) (oexpon (from_word32 ((_ int2bv 32) 2)) s10))) true)) (= (bvurem (t__content w7) ((_ int2bv 32) 2)) ((_ int2bv 32) 1))) (<= 0 s10)) (<= s10 (+ k 1))) (= (ole (from_integer s10) (oadd (from_word64 i2) (from_word32 ((_ int2bv 32) 1)))) true)) (bvult i2 (bvmul (bvadd ((_ int2bv 64) (- e_last e_first)) ((_ int2bv 64) 1)) ((_ int2bv 64) 32)))))
(assert (and (=> (<= 1 r94b) (dynamic_property2 1 r94b h9)) (and (<= 1 h9) (<= h9 r94b))))
(assert (= (oeq (num_of_big_int (mk___t a7 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omod (omultiply (omultiply (num_of_big_int (mk___t aux32 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ (- a_last a_first) 1)) (num_of_big_int (mk___t aux32 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ (- a_last a_first) 1))) (oexpon (inverse (num_of_big_int m m_first (+ (- a_last a_first) 1)) (base Tuple0)) (+ (- a_last a_first) 1))) (num_of_big_int m m_first (+ (- a_last a_first) 1)))) true))
(assert (forall ((k1 Int)) (=> (and (<= (to_rep aux3__first) k1) (<= k1 (to_rep aux3__last))) (and (=> (and (<= aux3_first k1) (<= k1 (- (+ aux3_first a_last) a_first))) (= (to_rep1 (select aux33 k1)) (to_rep1 (select a7 (- (+ a_first k1) aux3_first))))) (=> (=> (<= aux3_first k1) (not (<= k1 (- (+ aux3_first a_last) a_first)))) (= (to_rep1 (select aux33 k1)) (to_rep1 (select aux32 k1))))))))
(assert (and (= o71 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (and (= o72 o71) (uint_in_range1 o71)))
(assert (= o73 ((_ int2bv 64) o72)))
(assert (= o74 (bvadd o73 ((_ int2bv 64) 1))))
(assert (= o75 (bvmul o74 ((_ int2bv 64) 32))))
(assert (= o76 (ite (bvult i2 o75) true false)))
(assert (= o68 (from_word32 ((_ int2bv 32) 1))))
(assert (= o67 (from_word64 i2)))
(assert (= o69 (oadd o67 o68)))
(assert (= o66 (from_integer s10)))
(assert (= o70 (ole o66 o69)))
(assert (and (= o64 (+ k 1)) (in_range1 (+ k 1))))
(assert (= o65 (ite (<= s10 o64) true false)))
(assert (= o60 (from_word32 ((_ int2bv 32) 2))))
(assert (= o61 (oexpon o60 s10)))
(assert (= o55 (from_word32 ((_ int2bv 32) 1))))
(assert (= o54 (from_integer s10)))
(assert (= o56 (osubtract o54 o55)))
(assert (= o53 (from_word64 i2)))
(assert (= o57 (osubtract o53 o56)))
(assert (= o52 (from_word32 ((_ int2bv 32) 2))))
(assert (= o58 (oexpon__2 o52 o57)))
(assert (and (= o47 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (= o48 (+ o47 1)))
(assert (and (= o49 o48) (in_range1 o48)))
(assert (and (= o50 o49) (in_range2 o49)))
(assert (= o51 (num_of_big_int e e_first o50)))
(assert (= o59 (odivide o51 o58)))
(assert (= o62 (omod o59 o61)))
(assert (= o46 (from_word32 (t__content w7))))
(assert (= o63 (oeq o46 o62)))
(assert (and (= o41 (power 2 k)) (in_range1 (power 2 k))))
(assert (= o42 (- o41 1)))
(assert (and (= o43 o42) (in_range1 o42)))
(assert (= o44 (ite (<= n o43) true false)))
(assert (= result8 (ite (<= 0 n) o44 false)))
(assert (= (= o45 true) (forall ((n1 Int)) (=> (and (<= 0 n1) (<= n1 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux45) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n1 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))))
...
(assert (= o29 (from_word32 ((_ int2bv 32) 2))))
(assert (= o30 (oexpon o29 h9)))
(assert (= o25 (from_word32 ((_ int2bv 32) 1))))
(assert (= o24 (from_word64 i2)))
(assert (= o26 (oadd o24 o25)))
(assert (= o23 (from_word32 ((_ int2bv 32) 2))))
(assert (= o27 (oexpon__2 o23 o26)))
...
(assert (= o28 (odivide o22 o27)))
(assert (= o31 (omultiply o28 o30)))
(assert (and (= o16 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o17 (num_of_big_int x x_first o16)))
(assert (= o32 (oexpon__2 o17 o31)))
(assert (= o36 (omultiply o32 o35)))
(assert (= o39 (omod o36 o38)))
(assert (and (= o14 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o15 (num_of_big_int (mk___t aux33 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first o14)))
(assert (= o40 (oeq o15 o39)))
(assert (and (= o12 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o13 (num_of_big_int m m_first o12)))
(assert (and (= o10 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (and (= o9 (base Tuple0)) (= o9 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o11 (oexpon o9 o10)))
