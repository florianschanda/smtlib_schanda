...
(assert (and (= o30 (rate_of (mk___rep ctx__split_fields13))) (and (in_range3 o30) (and (= o30 (* (to_rep5 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields13)) 8)) (< o30 1600)))))
(assert (= o31 (ite (= o30 initial_rate1) true false)))
(assert (and (= o27 (rate_of (mk___rep ctx__split_fields13))) (and (in_range3 o27) (and (= o27 (* (to_rep5 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields13)) 8)) (< o27 1600)))))
(assert (and (= o28 (in_queue_bit_length (mk___rep ctx__split_fields13))) (and (in_range2 o28) (and (= o28 (to_rep4 (rec__keccak__keccak_1600__sponge__context__bits_absorbed ctx__split_fields13))) (< o28 1600)))))
(assert (= o29 (ite (< o28 o27) true false)))
(assert (and (= o26 (in_queue_bit_length (mk___rep ctx__split_fields13))) (and (in_range2 o26) (and (= o26 (to_rep4 (rec__keccak__keccak_1600__sponge__context__bits_absorbed ctx__split_fields13))) (< o26 1600)))))
(assert (not (not (= 8 0))))
(check-sat)
(exit)
