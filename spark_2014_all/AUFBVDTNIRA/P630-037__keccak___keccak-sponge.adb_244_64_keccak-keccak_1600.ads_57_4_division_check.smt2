...
(assert (=> (< (mod2 bit_length 8) 8) (= o55 (bvshl suffix ((_ int2bv 8) (mod2 bit_length 8))))))
(assert (=> (not (< (mod2 bit_length 8) 8)) (= o55 ((_ int2bv 8) 0))))
(assert (=> (< (mod2 bit_length 8) 256) (= o52 (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) (mod2 bit_length 8))))))
(assert (=> (not (< (mod2 bit_length 8) 256)) (= o52 ((_ int2bv 8) 0))))
(assert (= o53 (bvsub o52 ((_ int2bv 8) 1))))
(assert (and (<= (to_rep1 (first (rt message))) (to_rep1 (last (rt message)))) (<= (to_rep1 (last (rt message))) (to_rep1 (last (rt message))))))
(assert (= o50 (to_rep1 (last (rt message)))))
(assert (= o51 (select (elts message) o50)))
(assert (= o54 (to_rep o51)))
(assert (= o56 (bvand o54 o53)))
(assert (= o57 (bvor o56 o55)))
(assert (= (to_rep o58) o57))
(assert (= o59 (store suffix_array1 0 o58)))
(assert (= result9 (mk_map__ref suffix_array1)))
(assert (= suffix_array4 o59))
(assert (and (and (and (= (state_of (mk___rep ctx__split_fields44)) 0) (= (rate_of (mk___rep ctx__split_fields44)) (rate_of (mk___rep ctx__split_fields43)))) (= (mod2 (in_queue_bit_length (mk___rep ctx__split_fields44)) 8) (mod2 8 8))) (< (in_queue_bit_length (mk___rep ctx__split_fields44)) (rate_of (mk___rep ctx__split_fields44)))))
(assert (and (= o65 (rate_of (mk___rep ctx__split_fields44))) (and (in_range3 o65) (and (= o65 (* (to_rep6 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields44)) 8)) (< o65 1600)))))
(assert (= o66 (ite (= o65 initial_rate1) true false)))
(assert (and (= o62 (rate_of (mk___rep ctx__split_fields44))) (and (in_range3 o62) (and (= o62 (* (to_rep6 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields44)) 8)) (< o62 1600)))))
(assert (and (= o63 (in_queue_bit_length (mk___rep ctx__split_fields44))) (and (in_range2 o63) (and (= o63 (to_rep5 (rec__keccak__keccak_1600__sponge__context__bits_absorbed ctx__split_fields44))) (< o63 1600)))))
(assert (= o64 (ite (< o63 o62) true false)))
(assert (and (= o60 (in_queue_bit_length (mk___rep ctx__split_fields44))) (and (in_range2 o60) (and (= o60 (to_rep5 (rec__keccak__keccak_1600__sponge__context__bits_absorbed ctx__split_fields44))) (< o60 1600)))))
(assert (not (not (= 8 0))))
(check-sat)
(exit)
