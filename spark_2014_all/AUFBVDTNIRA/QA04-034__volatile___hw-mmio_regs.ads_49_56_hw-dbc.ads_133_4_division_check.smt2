...
(define-fun dynamic_invariant1 ((temp___expr_835 (_ BitVec 16)) (temp___is_init_831 Bool) (temp___skip_constant_832 Bool) (temp___do_toplevel_833 Bool) (temp___do_typ_inv_834 Bool)) Bool true)
...
(assert (= o4 (ite (<= o3 16) true false)))
