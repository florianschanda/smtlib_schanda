...
(assert (= o44 (bvadd o43 #x0000000000000001)))
(assert (= o45 (bvmul o44 #x0000000000000020)))
(assert (= o46 (ite (bvult i2 o45) true false)))
(assert (= o38 (from_word32 #x00000001)))
...
(assert (= o30 (from_word32 #x00000002)))
...
(assert (= o22 (from_word32 #x00000002)))
