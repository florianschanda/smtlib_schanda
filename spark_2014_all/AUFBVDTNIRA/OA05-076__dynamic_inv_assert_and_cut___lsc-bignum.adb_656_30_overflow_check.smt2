...
(assert (and (= o41 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (and (= o42 o41) (uint_in_range1 o41)))
(assert (= o43 ((_ int2bv 64) o42)))
(assert (= o44 (bvadd o43 ((_ int2bv 64) 1))))
(assert (= o45 (bvmul o44 ((_ int2bv 64) 32))))
(assert (= o46 (ite (bvult i2 o45) true false)))
(assert (= o38 (from_word32 ((_ int2bv 32) 1))))
(assert (= o37 (from_word64 i2)))
(assert (= o39 (oadd o37 o38)))
(assert (= o36 (from_integer s10)))
(assert (= o40 (ole o36 o39)))
(assert (and (= o34 (+ k 1)) (in_range1 (+ k 1))))
(assert (= o35 (ite (<= s10 o34) true false)))
(assert (= o30 (from_word32 ((_ int2bv 32) 2))))
(assert (= o31 (oexpon o30 s10)))
(assert (= o25 (from_word32 ((_ int2bv 32) 1))))
(assert (= o24 (from_integer s10)))
(assert (= o26 (osubtract o24 o25)))
(assert (= o23 (from_word64 i2)))
(assert (= o27 (osubtract o23 o26)))
(assert (= o22 (from_word32 ((_ int2bv 32) 2))))
(assert (= o28 (oexpon__2 o22 o27)))
(assert (and (= o17 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (= o18 (+ o17 1)))
(assert (and (= o19 o18) (in_range1 o18)))
(assert (and (= o20 o19) (in_range2 o19)))
(assert (= o21 (num_of_big_int e e_first o20)))
(assert (= o29 (odivide o21 o28)))
(assert (= o32 (omod o29 o31)))
(assert (= o16 (from_word32 (t__content w7))))
(assert (= o33 (oeq o16 o32)))
(assert (and (= o11 (power 2 k)) (in_range1 (power 2 k))))
(assert (= o12 (- o11 1)))
(assert (and (= o13 o12) (in_range1 o12)))
(assert (= o14 (ite (<= n o13) true false)))
(assert (= result8 (ite (<= 0 n) o14 false)))
(assert (= (= o15 true) (forall ((n1 Int)) (=> (and (<= 0 n1) (<= n1 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux45) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n1 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))))
