...
(assert (not (= (ite (<= (to_rep2 (first11 (rt5 temp___1168))) (to_rep2 (last12 (rt5 temp___1168)))) (+ (- (to_rep2 (last12 (rt5 temp___1168))) (to_rep2 (first11 (rt5 temp___1168)))) 1) 0) (ite (<= (to_rep2 (first remainder__split_fields1)) (to_rep2 (last remainder__split_fields1))) (+ (- (to_rep2 (last remainder__split_fields1)) (to_rep2 (first remainder__split_fields1))) 1) 0))))
(check-sat)
(exit)
