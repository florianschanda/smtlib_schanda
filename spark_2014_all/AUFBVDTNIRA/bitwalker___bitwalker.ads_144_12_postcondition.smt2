...
(assert (= v1 o1))
(assert (and (and (and (<= (- 2) result__1) (<= result__1 0)) (and (= (= result__1 (- 1)) (< (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) (+ start len))) (and (= (= result__1 (- 2)) (and (bvule (maxvalue len) value1) (<= (+ start len) (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0))))) (and (= (= result__1 0) (and (bvugt (maxvalue len) value1) (<= (+ start len) (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0))))) (and (=> (= result__1 0) (forall ((i Int)) (=> (and (<= 0 i) (<= i (- start 1))) (= (= (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) i) true) (= (nth8_stream (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) i) true))))) (and (=> (= result__1 0) (forall ((i Int)) (=> (and (<= start i) (<= i (- (+ start len) 1))) (= (= (nth8_stream (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) i) true) (= (nth value1 (+ (- (- len i) 1) start)) true))))) (=> (= result__1 0) (forall ((i Int)) (=> (and (<= (+ start len) i) (<= i (- (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) 1))) (= (= (nth8_stream (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) i) true) (= (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) i) true))))))))))) (in_range1 result__1)))
(assert (= result__1 0))
(assert (forall ((i Int)) (=> (and (<= start i) (<= i (- (+ start len) 1))) (= (= (nth8_stream (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) i) true) (= (nth8_stream addrold i) true)))))
(assert (= v1 v2))
