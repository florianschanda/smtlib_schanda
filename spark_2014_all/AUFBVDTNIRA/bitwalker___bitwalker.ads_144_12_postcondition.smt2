...
(declare-const i Int)
(assert (<= 0 i))
(assert (<= i (- (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) 1)))
(assert (= (nth8_stream (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) i) true))
(assert (not (= (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) i) true)))
(check-sat)
(exit)
