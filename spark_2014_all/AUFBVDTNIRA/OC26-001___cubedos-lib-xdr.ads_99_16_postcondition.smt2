...
(assert (and (and (ite (= value 0) (and (= (mk_t__ref result) (mk_t__ref temporary)) (= temporary1 ((_ int2bv 32) 0))) (and (and (= (mk_t__ref result1) (mk_t__ref temporary)) (= temporary2 ((_ int2bv 32) 1))) (= temporary1 temporary2))) (and (= last3 (+ position 3)) (in_range3 last3))) (and (and (= temporary1 temporary3) (and (= last3 last4) (= data data1))) (and (= temporary4 temporary1) (and (= last5 last3) (= data2 data))))))
