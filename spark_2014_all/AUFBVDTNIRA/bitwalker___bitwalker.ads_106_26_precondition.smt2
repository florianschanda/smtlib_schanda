...
(assert (<= 0 i3))
(assert (<= i3 (- start 1)))
(assert (and (= o60 (nth8_stream (mk___t (map__content addr10) (mk (to_rep addr__first) (to_rep addr__last))) i3)) (= (= o60 true) (= (nth1 (to_rep1 (select (map__content addr10) (div1 i3 8))) (- 7 (mod1 i3 8))) true))))
(assert (= o61 (to_int2 o60)))
