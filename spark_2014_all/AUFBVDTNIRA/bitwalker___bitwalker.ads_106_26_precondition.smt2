...
(declare-const o33 (Array Int unsigned_8))
...
(assert (= o32 (ite o31 1 0)))
(assert (= result7 (ite (= (ite (ite (= (int__content result__9) (- 1)) true false) 1 0) o32) true false)))
(assert (= result7 true))
(assert (=> (<= (to_rep addr__first) (to_rep addr__last)) (= o21 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))
...
(assert (and (= o20 (maxvalue len)) (= o20 (bvshl #x0000000000000001 ((_ int2bv 64) len)))))
(assert (= o25 (ite (bvule o20 value) true false)))
(assert (= o26 (ite (= o25 true) o24 false)))
(assert (= o27 (ite o26 1 0)))
(assert (= result8 (ite (= (ite (ite (= (int__content result__9) (- 2)) true false) 1 0) o27) true false)))
(assert (= result8 true))
(assert (=> (<= (to_rep addr__first) (to_rep addr__last)) (= o13 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))
...
(assert (and (= o12 (maxvalue len)) (= o12 (bvshl #x0000000000000001 ((_ int2bv 64) len)))))
(assert (= o17 (ite (bvugt o12 value) true false)))
(assert (= o18 (ite (= o17 true) o16 false)))
(assert (= o19 (ite o18 1 0)))
(assert (= result9 (ite (= (ite (ite (= (int__content result__9) 0) true false) 1 0) o19) true false)))
(assert (= result9 true))
(assert (= (int__content result__9) 0))
(assert (<= 0 i1))
(assert (<= i1 (- start 1)))
(assert (and (= o10 (nth8_stream (mk___t (map__content addr9) (mk (to_rep addr__first) (to_rep addr__last))) i1)) (= (= o10 true) (= (nth1 (to_rep1 (select (map__content addr9) (div1 i1 8))) (- 7 (mod1 i1 8))) true))))
(assert (= o11 (ite o10 1 0)))
(assert (not (<= (div1 i1 8) (to_rep (last (mk (to_rep addr__first) (to_rep addr__last)))))))
(check-sat)
(exit)
