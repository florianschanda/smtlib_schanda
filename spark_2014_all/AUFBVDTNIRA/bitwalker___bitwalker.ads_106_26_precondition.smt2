...
(assert (<= 0 i1))
(assert (<= i1 (- start 1)))
(assert (and (= o10 (nth8_stream (mk___t (map__content addr10) (mk (to_rep addr__first) (to_rep addr__last))) i1)) (= (= o10 true) (= (nth1 (to_rep1 (select (map__content addr10) (div1 i1 8))) (- 7 (mod1 i1 8))) true))))
