...
(assert (= i1 position))
(assert (<= position i1))
(assert (<= i1 temp___612))
(assert (and (<= position i2) (<= i2 (- (+ position (ite (<= (to_rep1 value__first) (to_rep1 value__last)) (+ (- (to_rep1 value__last) (to_rep1 value__first)) 1) 0)) 1))))
(assert (and (<= (to_rep1 (first2 (rt1 data))) i2) (<= i2 (to_rep1 (last2 (rt1 data))))))
(assert (= o7 i2))
(assert (= o8 (select (elts1 data) o7)))
(assert (= o9 (to_rep2 o8)))
(assert (= o10 (bv2nat o9)))
(assert (= (to_rep o11) o10))
(assert (and (= o5 (- i2 position)) (in_range1 (- i2 position))))
(assert (= o6 (+ (to_rep1 value__first) o5)))
(assert (and (= temp___613 o6) (in_range1 o6)))
(assert (not (<= temp___613 (to_rep1 value__last))))
(check-sat)
(exit)
