...
(assert (= o15 i2))
(assert (= o16 (select (elts1 data) o15)))
(assert (= o17 (to_rep2 o16)))
(assert (= o18 (bv2nat o17)))
(assert (= (to_rep o19) o18))
(assert (and (= o13 (- i2 position)) (in_range1 (- i2 position))))
(assert (= o14 (+ (to_rep1 value__first) o13)))
(assert (and (= temp___552 o14) (in_range1 o14)))
(assert (not (<= (to_rep1 value__first) temp___552)))
(check-sat)
(exit)
