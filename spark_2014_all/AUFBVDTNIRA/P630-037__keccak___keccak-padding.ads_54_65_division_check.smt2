...
(assert (=> (<= (to_rep next_block__first) (to_rep next_block__last)) (= o4 (+ (- (to_rep next_block__last) (to_rep next_block__first)) 1))))
(assert (=> (not (<= (to_rep next_block__first) (to_rep next_block__last))) (= o4 0)))
(assert (= result (ite (= o4 o3) true false)))
(assert (= result true))
(assert (=> (<= (to_rep first_block__first) (to_rep first_block__last)) (= o1 (+ (- (to_rep first_block__last) (to_rep first_block__first)) 1))))
(assert (=> (not (<= (to_rep first_block__first) (to_rep first_block__last))) (= o1 0)))
(assert (and (= o2 o1) (in_range o1)))
(assert (= result1 (ite (<= o2 268435455) true false)))
(assert (= result1 true))
