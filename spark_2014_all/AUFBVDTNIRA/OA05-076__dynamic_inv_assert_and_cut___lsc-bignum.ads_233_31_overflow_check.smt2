...
(assert (= o20 (+ x_first o19)))
(assert (and (= o21 o20) (in_range1 o20)))
(assert (= o22 (ite (<= o21 (to_rep (last (rt x)))) true false)))
(assert (and (= o16 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o17 (+ x_first o16)))
(assert (and (= o18 o17) (in_range1 o17)))
(assert (= o23 (ite (<= (to_rep (first (rt x))) o18) true false)))
...
(assert (= o12 (+ m_first o11)))
(assert (and (= o13 o12) (in_range1 o12)))
(assert (= o14 (ite (<= o13 (to_rep (last (rt m)))) true false)))
(assert (and (= o8 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o9 (+ m_first o8)))
(assert (and (= o10 o9) (in_range1 o9)))
(assert (= o15 (ite (<= (to_rep (first (rt m))) o10) true false)))
(assert (= result1 (ite (= o15 true) o14 false)))
(assert (= result1 true))
...
(assert (= o4 (+ aux1_first o3)))
(assert (and (= o5 o4) (in_range1 o4)))
(assert (= o6 (ite (<= o5 (to_rep aux1__last)) true false)))
(assert (and (= o (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o1 (+ aux1_first o)))
(assert (and (= o2 o1) (in_range1 o1)))
(assert (= o7 (ite (<= (to_rep aux1__first) o2) true false)))
