...
(assert (=> (< 1 message_byte_length1) (= (- message_last2 1) r108s)))
(assert (=> (< 1 message_byte_length1) (in_range1 r108s)))
(assert (=> (< 1 message_byte_length1) (and (= o48 (+ (- bit_length 8) (- 8 (mod2 bit_length 8)))) (in_range1 (+ (- bit_length 8) (- 8 (mod2 bit_length 8)))))))
(assert (=> (< 1 message_byte_length1) (and (= o49 o48) (in_range2 o48))))
(assert (=> (< 1 message_byte_length1) (=> (<= (to_rep1 (first (rt message))) r108s) (and (and (<= (to_rep1 (first (rt message))) (to_rep1 (first (rt message)))) (<= (to_rep1 (first (rt message))) (to_rep1 (last (rt message))))) (and (<= (to_rep1 (first (rt message))) r108s) (<= r108s (to_rep1 (last (rt message)))))))))
(assert (=> (< 1 message_byte_length1) (= o45 (elts message))))
(assert (=> (< 1 message_byte_length1) (= o45 temp___881)))
(assert (=> (< 1 message_byte_length1) (= (mk2 (to_rep1 (first (rt message))) r108s) temp___8811)))
(assert (=> (< 1 message_byte_length1) (= temp___881 o46)))
(assert (=> (< 1 message_byte_length1) (= (mk (to_rep1 (first4 temp___8811)) (to_rep1 (last4 temp___8811))) o47)))
(assert (=> (< 1 message_byte_length1) (and (and (and (= (state_of (mk___rep ctx__split_fields43)) 0) (= (rate_of (mk___rep ctx__split_fields43)) (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5))))) (= (mod2 (in_queue_bit_length (mk___rep ctx__split_fields43)) 8) (mod2 o49 8))) (< (in_queue_bit_length (mk___rep ctx__split_fields43)) (rate_of (mk___rep ctx__split_fields43))))))
(assert (=> (not (< 1 message_byte_length1)) (= ctx__split_fields43 (mk___split_fields ctx__split_fields ctx__split_fields1 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5))))
(assert (=> (not (< 1 message_byte_length1)) (= ctx__split_fields43 (mk___split_fields ctx__split_fields6 ctx__split_fields7 ctx__split_fields8 ctx__split_fields9 ctx__split_fields10 ctx__split_fields11))))
(assert (not (not (= 8 0))))
(check-sat)
(exit)
