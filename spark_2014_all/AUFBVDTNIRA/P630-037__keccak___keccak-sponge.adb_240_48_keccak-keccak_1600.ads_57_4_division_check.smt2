...
(assert (=> (< 1 message_byte_length1) (= (mk2 (to_rep1 (first (rt message))) r108s) temp___9501)))
(assert (=> (< 1 message_byte_length1) (= temp___950 o12)))
(assert (=> (< 1 message_byte_length1) (= (mk (to_rep1 (first4 temp___9501)) (to_rep1 (last4 temp___9501))) o13)))
