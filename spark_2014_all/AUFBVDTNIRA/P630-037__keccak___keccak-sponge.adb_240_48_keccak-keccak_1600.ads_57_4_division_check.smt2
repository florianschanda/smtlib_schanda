...
(assert (=> (< 1 message_byte_length1) (= o11 temp___881)))
(assert (=> (< 1 message_byte_length1) (= (mk2 (to_rep1 (first (rt message))) r108s) temp___8811)))
(assert (=> (< 1 message_byte_length1) (= temp___881 o12)))
(assert (=> (< 1 message_byte_length1) (= (mk (to_rep1 (first4 temp___8811)) (to_rep1 (last4 temp___8811))) o13)))
