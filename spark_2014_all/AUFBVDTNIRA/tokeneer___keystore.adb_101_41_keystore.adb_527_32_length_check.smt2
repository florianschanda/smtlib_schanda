...
(assert (=> (<= 1 temp___1553) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 temp___1553) (<= temp___1553 150)))))
(assert (= o16 result__1))
(assert (= temp___1554 (mk___t1 o16 (mk1 1 temp___1553))))
(assert (not (= (ite (<= (to_rep1 (first2 (rt1 temp___1551))) (to_rep1 (last2 (rt1 temp___1551)))) (+ (- (to_rep1 (last2 (rt1 temp___1551))) (to_rep1 (first2 (rt1 temp___1551)))) 1) 0) (ite (<= (to_rep1 (first2 (rt1 temp___1554))) (to_rep1 (last2 (rt1 temp___1554)))) (+ (- (to_rep1 (last2 (rt1 temp___1554))) (to_rep1 (first2 (rt1 temp___1554)))) 1) 0))))
(check-sat)
(exit)
