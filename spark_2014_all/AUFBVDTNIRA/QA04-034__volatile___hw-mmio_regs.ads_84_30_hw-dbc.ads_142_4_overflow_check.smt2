...
(declare-fun user_eq4 (word8 word8) Bool)
(declare-const dummy4 word8)
...
(define-fun dynamic_invariant1 ((temp___expr_334 (_ BitVec 8)) (temp___is_init_330 Bool) (temp___skip_constant_331 Bool) (temp___do_toplevel_332 Bool) (temp___do_typ_inv_333 Bool)) Bool true)
...
(define-fun index_t__ref___4__projection ((a index_t__ref)) index_t (index_t__content a))
(define-fun dynamic_invariant2 ((temp___expr_905 Int) (temp___is_init_901 Bool) (temp___skip_constant_902 Bool) (temp___do_toplevel_903 Bool) (temp___do_typ_inv_904 Bool)) Bool (=> (or (= temp___is_init_901 true) (<= 0 1)) (in_range4 temp___expr_905)))
...
(define-fun t__ref___3__projection ((a t__ref3)) us_rep (t__content3 a))
...
(define-fun dynamic_invariant6 ((temp___expr_355 (_ BitVec 64)) (temp___is_init_351 Bool) (temp___skip_constant_352 Bool) (temp___do_toplevel_353 Bool) (temp___do_typ_inv_354 Bool)) Bool true)
...
(assert (and (= o5 (+ (to_rep (rec__hw__dbc__xcap_s_regs__t__msb (us_split_fields1 (select regs idx)))) 1)) (in_range1 (+ (to_rep (rec__hw__dbc__xcap_s_regs__t__msb (us_split_fields1 (select regs idx)))) 1))))
(assert (= o6 (- o5 (to_rep (rec__hw__dbc__xcap_s_regs__t__lsb (us_split_fields1 (select regs idx)))))))
(assert (and (= o7 o6) (in_range1 o6)))
(assert (and (= o8 o7) (in_range2 o7)))
(assert (= o9 (power 2 o8)))
(assert (and (= o10 o9) (in_range3 o9)))
(assert (and (= o11 o10) (uint_in_range1 o10)))
(assert (= o12 ((_ int2bv 64) o11)))
(assert (= o13 (ite (bvult ((_ zero_extend 56) value) o12) true false)))
(assert (and (= o2 8) (in_range1 8)))
(assert (and (= o (- (to_rep (rec__hw__dbc__xcap_s_regs__t__msb (us_split_fields1 (select regs idx)))) (to_rep (rec__hw__dbc__xcap_s_regs__t__lsb (us_split_fields1 (select regs idx)))))) (in_range1 (- (to_rep (rec__hw__dbc__xcap_s_regs__t__msb (us_split_fields1 (select regs idx)))) (to_rep (rec__hw__dbc__xcap_s_regs__t__lsb (us_split_fields1 (select regs idx))))))))
(assert (= o1 (+ o 1)))
(assert (and (= o3 o1) (in_range1 o1)))
(assert (= o4 (ite (<= o3 o2) true false)))
(assert (not (in_range1 (+ byte_offset (to_rep (rec__hw__dbc__xcap_s_regs__t__byte_offset (us_split_fields1 (select regs idx))))))))
(check-sat)
(exit)
