...
(define-fun dynamic_invariant2 ((temp___expr_800 Int) (temp___is_init_797 Bool) (temp___skip_constant_798 Bool) (temp___do_toplevel_799 Bool)) Bool (=> (or (= temp___is_init_797 true) (<= 0 1)) (in_range4 temp___expr_800)))
...
(assert true)
(assert (and (= o10 (+ (to_rep (rec__hw__dbc__xcap_s_regs__t__msb (us_split_fields1 (select regs idx)))) 1)) (in_range1 (+ (to_rep (rec__hw__dbc__xcap_s_regs__t__msb (us_split_fields1 (select regs idx)))) 1))))
(assert (= o11 (- o10 (to_rep (rec__hw__dbc__xcap_s_regs__t__lsb (us_split_fields1 (select regs idx)))))))
