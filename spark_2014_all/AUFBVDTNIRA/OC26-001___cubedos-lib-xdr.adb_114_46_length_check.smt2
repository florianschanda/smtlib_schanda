...
(assert (in_range3 r12b))
(assert (= padding_stop1 r13b))
(assert (in_range3 r13b))
(assert (= (to_rep (first6 (rt3 (temp_____aggregate_def_540 #x00 r12b r13b)))) r12b))
(assert (= (to_rep (last6 (rt3 (temp_____aggregate_def_540 #x00 r12b r13b)))) r13b))
(assert (= (mk___t3 temp___547 temp___5471) (temp_____aggregate_def_540 #x00 r12b r13b)))
