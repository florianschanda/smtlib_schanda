...
(assert (forall ((temp___480 Int)) (ite (and (<= position temp___480) (<= temp___480 (- (+ position (length value)) 1))) (= (select o3 temp___480) (select temp___479 temp___480)) (= (select o3 temp___480) (select data temp___480)))))
