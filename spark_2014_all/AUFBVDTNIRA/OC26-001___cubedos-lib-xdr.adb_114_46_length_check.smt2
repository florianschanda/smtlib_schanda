...
(declare-fun user_eq3 (octet_array_extended_index octet_array_extended_index) Bool)
...
(assert (forall ((temp___483 (_ BitVec 8))) (forall ((temp___484 Int) (temp___485 Int)) (let ((temp___482 (temp___481 temp___483 temp___484 temp___485))) (and (=> (dynamic_property 0 65535 temp___484 temp___485) (and (= (first7 temp___482) temp___484) (= (last7 temp___482) temp___485))) (forall ((temp___486 Int)) (= (select (to_array3 temp___482) temp___486) (of_rep1 temp___483))))))))
...
(declare-const o10 (Array Int octet))
...
(assert (= (slide (elts value) (to_rep (first (rt value))) position) temp___476))
(assert (= (mk1 position (- (+ position (length value)) 1)) temp___4761))
(assert (and (= o7 (length value)) (in_range1 (length value))))
(assert (= o8 (+ position o7)))
(assert (= temp___477 (- o8 1)))
(assert (=> (<= position temp___477) (and (and (<= (to_rep data__first) position) (<= position (to_rep data__last))) (and (<= (to_rep data__first) temp___477) (<= temp___477 (to_rep data__last))))))
(assert (= o9 data))
(assert (= o9 temp___478))
(assert (= (mk1 position temp___477) temp___4781))
(assert (= (ite (<= (to_rep (first2 temp___4761)) (to_rep (last2 temp___4761))) (+ (- (to_rep (last2 temp___4761)) (to_rep (first2 temp___4761))) 1) 0) (ite (<= (to_rep (first2 temp___4781)) (to_rep (last2 temp___4781))) (+ (- (to_rep (last2 temp___4781)) (to_rep (first2 temp___4781))) 1) 0)))
(assert (= (mk___t1 temp___479 temp___4791) (mk___t1 temp___476 temp___4761)))
(assert (forall ((temp___480 Int)) (ite (and (<= position temp___480) (<= temp___480 (- (+ position (length value)) 1))) (= (select o10 temp___480) (select temp___479 temp___480)) (= (select o10 temp___480) (select data temp___480)))))
(assert (= (mk_map__ref result2) (mk_map__ref data)))
(assert (= data1 o10))
(assert (not (= (mod1 (length value) 4) 0)))
(assert (and (= o11 (length value)) (in_range1 (length value))))
(assert (= o12 (+ position o11)))
(assert (and (= o13 o12) (in_range2 o12)))
(assert (= (mk_int__ref result3) (mk_int__ref padding_start)))
(assert (= padding_start2 o13))
(assert (and (= o14 (length value)) (in_range1 (length value))))
(assert (= o15 (mod1 o14 4)))
(assert (= o16 (- 3 o15)))
(assert (= o17 (+ padding_start2 o16)))
(assert (and (= o18 o17) (in_range2 o17)))
(assert (= (mk_int__ref result4) (mk_int__ref padding_stop)))
(assert (= padding_stop2 o18))
(assert (= padding_start2 r12b))
(assert (in_range2 r12b))
(assert (= padding_stop2 r13b))
(assert (in_range2 r13b))
(assert (= (to_rep (first6 (rt3 (temp___481 ((_ int2bv 8) 0) r12b r13b)))) r12b))
(assert (= (to_rep (last6 (rt3 (temp___481 ((_ int2bv 8) 0) r12b r13b)))) r13b))
(assert (= (mk___t3 temp___488 temp___4881) (temp___481 ((_ int2bv 8) 0) r12b r13b)))
(assert (= (ite (<= (to_rep (first6 temp___4881)) (to_rep (last6 temp___4881))) (+ (- (to_rep (last6 temp___4881)) (to_rep (first6 temp___4881))) 1) 0) (ite (<= r12b r13b) (+ (- r13b r12b) 1) 0)))
(assert (= (slide temp___488 (to_rep (first6 temp___4881)) r12b) temp___489))
(assert (= (mk2 r12b r13b) temp___4891))
(assert (=> (<= r12b r13b) (and (and (<= (to_rep data__first) r12b) (<= r12b (to_rep data__last))) (and (<= (to_rep data__first) r13b) (<= r13b (to_rep data__last))))))
(assert (= o19 data1))
(assert (= o19 temp___490))
(assert (= (mk2 r12b r13b) temp___4901))
(assert (not (= (ite (<= (to_rep (first4 temp___4891)) (to_rep (last4 temp___4891))) (+ (- (to_rep (last4 temp___4891)) (to_rep (first4 temp___4891))) 1) 0) (ite (<= (to_rep (first4 temp___4901)) (to_rep (last4 temp___4901))) (+ (- (to_rep (last4 temp___4901)) (to_rep (first4 temp___4901))) 1) 0))))
(check-sat)
(exit)
