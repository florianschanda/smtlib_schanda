...
(define-fun dynamic_invariant ((temp___expr_201 Int) (temp___is_init_197 Bool) (temp___skip_constant_198 Bool) (temp___do_toplevel_199 Bool) (temp___do_typ_inv_200 Bool)) Bool (=> (or (= temp___is_init_197 true) (<= 0 65535)) (in_range2 temp___expr_201)))
...
(define-fun dynamic_invariant1 ((temp___expr_208 Int) (temp___is_init_204 Bool) (temp___skip_constant_205 Bool) (temp___do_toplevel_206 Bool) (temp___do_typ_inv_207 Bool)) Bool (=> (or (= temp___is_init_204 true) (<= (- 1) 65535)) (in_range3 temp___expr_208)))
...
(define-fun dynamic_invariant2 ((temp___expr_222 us_t) (temp___is_init_218 Bool) (temp___skip_constant_219 Bool) (temp___do_toplevel_220 Bool) (temp___do_typ_inv_221 Bool)) Bool (=> (not (= temp___skip_constant_219 true)) (dynamic_property 0 65535 (first1 temp___expr_222) (last1 temp___expr_222))))
(declare-fun length_with_padding (Int) Int)
(declare-fun length_with_padding__function_guard (Int Int) Bool)
(define-fun dynamic_invariant3 ((temp___expr_215 Int) (temp___is_init_211 Bool) (temp___skip_constant_212 Bool) (temp___do_toplevel_213 Bool) (temp___do_typ_inv_214 Bool)) Bool (=> (or (= temp___is_init_211 true) (<= 0 65536)) (in_range4 temp___expr_215)))
(assert (forall ((length1 Int)) (! (=> (dynamic_invariant3 length1 true true true true) (dynamic_invariant3 (length_with_padding length1) true false true true)) :pattern ((length_with_padding length1)))))
(assert (forall ((length1 Int)) (! (=> (dynamic_invariant3 length1 true true true true) (= (length_with_padding length1) (+ length1 (ite (= (mod1 length1 4) 0) 0 (- 4 (mod1 length1 4)))))) :pattern ((length_with_padding length1)))))
...
(declare-fun temp___540 ((_ BitVec 8) Int Int) us_t3)
...
(declare-const temp___547 (Array Int octet))
(declare-const temp___5471 t3)
(declare-const temp___548 (Array Int octet))
(declare-const temp___5481 t2)
(declare-const o12 (Array Int octet))
(declare-const temp___549 (Array Int octet))
...
(assert (dynamic_invariant2 value true false true true))
...
(assert (= o5 (+ position o4)))
(assert (and (= o6 o5) (in_range2 o5)))
(assert (= (mk_int__ref result1) (mk_int__ref padding_start)))
(assert (= padding_start1 o6))
(assert (and (= o7 (length value)) (in_range1 (length value))))
(assert (= o8 (mod1 o7 4)))
(assert (= o9 (- 3 o8)))
(assert (= o10 (+ padding_start1 o9)))
(assert (and (= o11 o10) (in_range2 o10)))
(assert (= (mk_int__ref result2) (mk_int__ref padding_stop)))
(assert (= padding_stop1 o11))
(assert (= padding_start1 r12b))
(assert (in_range2 r12b))
(assert (= padding_stop1 r13b))
(assert (in_range2 r13b))
(assert (= (to_rep (first6 (rt3 (temp___540 #x00 r12b r13b)))) r12b))
(assert (= (to_rep (last6 (rt3 (temp___540 #x00 r12b r13b)))) r13b))
(assert (= (mk___t3 temp___547 temp___5471) (temp___540 #x00 r12b r13b)))
(assert (= (ite (<= (to_rep (first6 temp___5471)) (to_rep (last6 temp___5471))) (+ (- (to_rep (last6 temp___5471)) (to_rep (first6 temp___5471))) 1) 0) (ite (<= r12b r13b) (+ (- r13b r12b) 1) 0)))
(assert (= (slide temp___547 (to_rep (first6 temp___5471)) r12b) temp___548))
(assert (= (mk2 r12b r13b) temp___5481))
...
(assert (= o12 data1))
(assert (= o12 temp___549))
(assert (= (mk2 r12b r13b) temp___5491))
(assert (not (= (ite (<= (to_rep (first4 temp___5481)) (to_rep (last4 temp___5481))) (+ (- (to_rep (last4 temp___5481)) (to_rep (first4 temp___5481))) 1) 0) (ite (<= (to_rep (first4 temp___5491)) (to_rep (last4 temp___5491))) (+ (- (to_rep (last4 temp___5491)) (to_rep (first4 temp___5491))) 1) 0))))
(check-sat)
(exit)
