...
(assert (= result9 true))
(assert (=> (= (int__content result__9) 0) (= (= result10 true) (forall ((i14 Int)) (=> (and (<= 0 i14) (<= i14 (- start 1))) (= (= (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) i14) true) (= (nth8_stream (mk___t (map__content addr10) (mk (to_rep addr__first) (to_rep addr__last))) i14) true)))))))
(assert (=> (not (= (int__content result__9) 0)) (= result10 (distinct 1 0))))
(assert (= result10 true))
(assert (=> (= (int__content result__9) 0) (= (= result11 true) (forall ((i14 Int)) (=> (and (<= start i14) (<= i14 (- (+ start len) 1))) (= (= (nth8_stream (mk___t (map__content addr10) (mk (to_rep addr__first) (to_rep addr__last))) i14) true) (= (nth value (+ (- (- len i14) 1) start)) true)))))))
