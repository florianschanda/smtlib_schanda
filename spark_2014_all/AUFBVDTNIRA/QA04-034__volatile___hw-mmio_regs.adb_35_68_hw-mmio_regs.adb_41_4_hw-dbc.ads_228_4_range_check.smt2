...
(define-fun dynamic_invariant5 ((temp___expr_1222 (_ BitVec 16)) (temp___is_init_1218 Bool) (temp___skip_constant_1219 Bool) (temp___do_toplevel_1220 Bool) (temp___do_typ_inv_1221 Bool)) Bool true)
...
(assert (= result mask))
(assert (= mask1 o9))
(assert (not (bvule ((_ zero_extend 48) #x0000) (bvand (bvlshr ((_ zero_extend 32) temp) ((_ int2bv 64) (to_rep (rec__hw__dbc__s_regs__t__lsb (us_split_fields1 (select regs idx)))))) mask1))))
(check-sat)
(exit)
