...
(define-fun t__ref___5__projection ((a t__ref3)) us_rep (t__content3 a))
...
(define-fun dynamic_invariant5 ((temp___expr_1089 (_ BitVec 16)) (temp___is_init_1086 Bool) (temp___skip_constant_1087 Bool) (temp___do_toplevel_1088 Bool)) Bool true)
...
(declare-const hw__dbc__regs__read_i__2__off__assume Int)
...
(assert (= o1 (div1 o 4)))
(assert (and (= hw__dbc__regs__read_i__2__off__assume o1) (in_range2 o1)))
(assert (= hw__dbc__regs__read_i__2__off__assume off))
...
(assert (= o3 (- o2 (to_rep (rec__hw__dbc__s_regs__t__lsb (us_split_fields1 (select regs idx)))))))
...
(assert true)
(assert true)
(assert (not (bvule ((_ zero_extend 48) ((_ int2bv 16) 0)) (bvand (bvlshr ((_ zero_extend 32) temp1) ((_ int2bv 64) (to_rep (rec__hw__dbc__s_regs__t__lsb (us_split_fields1 (select regs idx)))))) mask1))))
(check-sat)
(exit)
