...
(assert (not (= (ite (<= (to_rep1 (first temp___6091)) (to_rep1 (last temp___6091))) (+ (- (to_rep1 (last temp___6091)) (to_rep1 (first temp___6091))) 1) 0) (ite (<= (to_rep1 value__first) (to_rep1 value__last)) (+ (- (to_rep1 value__last) (to_rep1 value__first)) 1) 0))))
(check-sat)
(exit)
