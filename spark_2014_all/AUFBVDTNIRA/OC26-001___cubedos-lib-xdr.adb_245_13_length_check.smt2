...
(assert (not (= (ite (<= (to_rep1 (first temp___5501)) (to_rep1 (last temp___5501))) (+ (- (to_rep1 (last temp___5501)) (to_rep1 (first temp___5501))) 1) 0) (ite (<= (to_rep1 value__first) (to_rep1 value__last)) (+ (- (to_rep1 value__last) (to_rep1 value__first)) 1) 0))))
(check-sat)
(exit)
