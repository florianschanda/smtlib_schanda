...
(declare-const temp___550 (Array Int octet))
(declare-const temp___5501 t2)
...
(assert (= data1 o3))
(assert (=> (not (= (mod1 (length value) 4) 0)) (and (= o4 (length value)) (in_range1 (length value)))))
(assert (=> (not (= (mod1 (length value) 4) 0)) (= o5 (+ position o4))))
(assert (=> (not (= (mod1 (length value) 4) 0)) (and (= o6 o5) (in_range3 o5))))
(assert (=> (not (= (mod1 (length value) 4) 0)) (= (mk_int__ref result1) (mk_int__ref padding_start))))
(assert (=> (not (= (mod1 (length value) 4) 0)) (= padding_start2 o6)))
(assert (=> (not (= (mod1 (length value) 4) 0)) (and (= o7 (length value)) (in_range1 (length value)))))
(assert (=> (not (= (mod1 (length value) 4) 0)) (= o8 (mod1 o7 4))))
(assert (=> (not (= (mod1 (length value) 4) 0)) (= o9 (- 3 o8))))
(assert (=> (not (= (mod1 (length value) 4) 0)) (= o10 (+ padding_start2 o9))))
(assert (=> (not (= (mod1 (length value) 4) 0)) (and (= o11 o10) (in_range3 o10))))
(assert (=> (not (= (mod1 (length value) 4) 0)) (= (mk_int__ref result2) (mk_int__ref padding_stop))))
(assert (=> (not (= (mod1 (length value) 4) 0)) (= padding_stop2 o11)))
(assert (=> (not (= (mod1 (length value) 4) 0)) (= padding_start2 r12b)))
(assert (=> (not (= (mod1 (length value) 4) 0)) (in_range3 r12b)))
(assert (=> (not (= (mod1 (length value) 4) 0)) (= padding_stop2 r13b)))
(assert (=> (not (= (mod1 (length value) 4) 0)) (in_range3 r13b)))
(assert (=> (not (= (mod1 (length value) 4) 0)) (= (to_rep (first6 (rt3 (temp_____aggregate_def_540 #x00 r12b r13b)))) r12b)))
(assert (=> (not (= (mod1 (length value) 4) 0)) (= (to_rep (last6 (rt3 (temp_____aggregate_def_540 #x00 r12b r13b)))) r13b)))
(assert (=> (not (= (mod1 (length value) 4) 0)) (= (mk___t3 temp___547 temp___5471) (temp_____aggregate_def_540 #x00 r12b r13b))))
(assert (=> (not (= (mod1 (length value) 4) 0)) (= (ite (<= (to_rep (first6 temp___5471)) (to_rep (last6 temp___5471))) (+ (- (to_rep (last6 temp___5471)) (to_rep (first6 temp___5471))) 1) 0) (ite (<= r12b r13b) (+ (- r13b r12b) 1) 0))))
(assert (=> (not (= (mod1 (length value) 4) 0)) (= (slide temp___547 (to_rep (first6 temp___5471)) r12b) temp___548)))
(assert (=> (not (= (mod1 (length value) 4) 0)) (= (mk2 r12b r13b) temp___5481)))
(assert (=> (not (= (mod1 (length value) 4) 0)) (=> (<= r12b r13b) (and (and (<= (to_rep data__first) r12b) (<= r12b (to_rep data__last))) (and (<= (to_rep data__first) r13b) (<= r13b (to_rep data__last)))))))
(assert (=> (not (= (mod1 (length value) 4) 0)) (= o12 data1)))
(assert (=> (not (= (mod1 (length value) 4) 0)) (= o12 temp___549)))
(assert (=> (not (= (mod1 (length value) 4) 0)) (= (mk2 r12b r13b) temp___5491)))
(assert (=> (not (= (mod1 (length value) 4) 0)) (= (ite (<= (to_rep (first4 temp___5481)) (to_rep (last4 temp___5481))) (+ (- (to_rep (last4 temp___5481)) (to_rep (first4 temp___5481))) 1) 0) (ite (<= (to_rep (first4 temp___5491)) (to_rep (last4 temp___5491))) (+ (- (to_rep (last4 temp___5491)) (to_rep (first4 temp___5491))) 1) 0))))
(assert (=> (not (= (mod1 (length value) 4) 0)) (= (mk___t2 temp___550 temp___5501) (mk___t2 temp___548 temp___5481))))
(assert (=> (not (= (mod1 (length value) 4) 0)) (forall ((temp___551 Int)) (ite (and (<= r12b temp___551) (<= temp___551 r13b)) (= (select o13 temp___551) (select temp___550 temp___551)) (= (select o13 temp___551) (select data1 temp___551))))))
(assert (=> (not (= (mod1 (length value) 4) 0)) (= data1 result3)))
(assert (=> (not (= (mod1 (length value) 4) 0)) (= data2 o13)))
(assert (=> (not (not (= (mod1 (length value) 4) 0))) (= padding_stop2 padding_stop)))
(assert (=> (not (not (= (mod1 (length value) 4) 0))) (= padding_start2 padding_start)))
(assert (=> (not (not (= (mod1 (length value) 4) 0))) (= data2 data1)))
(assert (=> (not (not (= (mod1 (length value) 4) 0))) (= padding_stop2 padding_stop1)))
(assert (=> (not (not (= (mod1 (length value) 4) 0))) (= padding_start2 padding_start1)))
(assert (=> (not (not (= (mod1 (length value) 4) 0))) (= data2 data1)))
(assert (not (in_range2 (length value))))
(check-sat)
(exit)
