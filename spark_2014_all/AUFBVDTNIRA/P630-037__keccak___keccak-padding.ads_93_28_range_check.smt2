...
(assert (=> (<= (to_rep block__first) (to_rep block__last)) (= o4 (+ (- (to_rep block__last) (to_rep block__first)) 1))))
(assert (=> (not (<= (to_rep block__first) (to_rep block__last))) (= o4 0)))
(assert (and (= o5 o4) (in_range o4)))
(assert (= result (ite (<= o5 268435455) true false)))
(assert (= result true))
