...
(define-fun dynamic_invariant3 ((temp___expr_226 Int) (temp___is_init_223 Bool) (temp___skip_constant_224 Bool) (temp___do_toplevel_225 Bool)) Bool (=> (or (= temp___is_init_223 true) (<= 0 2147483647)) (in_range2 temp___expr_226)))
(define-fun dynamic_invariant4 ((temp___expr_232 us_t) (temp___is_init_229 Bool) (temp___skip_constant_230 Bool) (temp___do_toplevel_231 Bool)) Bool (=> (not (= temp___skip_constant_230 true)) (dynamic_property 0 2147483647 (first1 temp___expr_232) (last1 temp___expr_232))))
(declare-const o Int)
...
(assert (=> (<= (to_rep block__first) (to_rep block__last)) (= o3 (+ (- (to_rep block__last) (to_rep block__first)) 1))))
(assert (=> (not (<= (to_rep block__first) (to_rep block__last))) (= o3 0)))
(assert (and (= o4 o3) (in_range o3)))
(assert (= result (ite (<= o4 268435455) true false)))
(assert (= result true))
(assert (<= max_bit_length 2147483640))
(assert (and (= o1 (+ max_bit_length 7)) (in_range (+ max_bit_length 7))))
(assert (= o2 (div1 o1 8)))
