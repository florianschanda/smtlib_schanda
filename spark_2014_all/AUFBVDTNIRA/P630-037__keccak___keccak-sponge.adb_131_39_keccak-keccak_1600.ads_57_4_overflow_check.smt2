...
(assert (and (= keccak__keccak_1600__sponge__absorb__R98s__assume (+ (to_rep1 (first (rt data))) (int__content offset7))) (in_range1 (+ (to_rep1 (first (rt data))) (int__content offset7)))))
(assert (= keccak__keccak_1600__sponge__absorb__R98s__assume r98s))
(assert (in_range1 r98s))
(assert (and (= o28 (+ (int__content offset7) (- (int__content remaining_bytes7) 1))) (in_range1 (+ (int__content offset7) (- (int__content remaining_bytes7) 1)))))
(assert (= o29 (+ (to_rep1 (first (rt data))) o28)))
(assert (not (in_range1 o29)))
(check-sat)
(exit)
