...
(assert (< 0 (int__content remaining_bits9)))
(assert (= (- (int__content remaining_bytes9) 1) r95s))
(assert (in_range1 r95s))
(assert (and (= keccak__keccak_1600__sponge__absorb__R98s__assume (+ (to_rep1 (first (rt data))) (int__content offset9))) (in_range1 (+ (to_rep1 (first (rt data))) (int__content offset9)))))
(assert (= keccak__keccak_1600__sponge__absorb__R98s__assume r98s))
(assert (in_range1 r98s))
(assert (and (= o64 (+ (int__content offset9) (- (int__content remaining_bytes9) 1))) (in_range1 (+ (int__content offset9) (- (int__content remaining_bytes9) 1)))))
(assert (= o65 (+ (to_rep1 (first (rt data))) o64)))
