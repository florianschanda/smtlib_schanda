...
(assert (and (= o6 (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5)))) (and (in_range3 o6) (and (= o6 (* (to_rep6 ctx__split_fields4) 8)) (< o6 1600)))))
(assert (= o7 (- o6 (to_rep5 ctx__split_fields2))))
...
(assert (=> (< 0 free_bits_in_block1) (= block_offset2 (div1 (to_rep5 ctx__split_fields2) 8))))
...
(assert (=> (< 0 free_bits_in_block1) (= temp___887 (mk___t3 (slide1 (elts4 temp___886) (to_rep1 (first8 (rt4 temp___886))) r81s) (mk3 r81s r82s)))))
...
(assert (= (- (to_rep6 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields7)) 1) r88s))
...
(assert (=> (<= initial_bit_rate1 remaining_bits2) (and (= o21 (+ offset3 (- (to_rep6 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields10)) 1))) (in_range1 (+ offset3 (- (to_rep6 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields10)) 1))))))
...
(assert (=> (<= initial_bit_rate1 remaining_bits2) (and (= o25 (+ offset3 (to_rep6 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields12)))) (in_range1 (+ offset3 (to_rep6 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields12)))))))
...
(assert (=> (<= initial_bit_rate1 remaining_bits2) (and (= o26 (- remaining_bytes3 (to_rep6 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields12)))) (in_range2 (- remaining_bytes3 (to_rep6 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields12)))))))
