...
(assert (= o85 (bvadd o84 ((_ int2bv 64) 1))))
(assert (= o86 (bvmul o85 ((_ int2bv 64) 32))))
(assert (= o87 (ite (bvult i2 o86) true false)))
(assert (= o79 (from_word32 ((_ int2bv 32) 1))))
...
(assert (= o63 (from_word32 ((_ int2bv 32) 2))))
...
(assert (and (= o44 (base Tuple0)) (= o44 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
