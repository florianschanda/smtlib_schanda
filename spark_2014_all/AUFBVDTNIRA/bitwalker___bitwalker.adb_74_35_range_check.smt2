...
(assert (and (= o3 (length addr)) (in_range1 (length addr))))
(assert (= o4 (* 8 o3)))
(assert (and (= o5 o4) (in_range1 o4)))
(assert (and (= o6 (+ start length1)) (in_range1 (+ start length1))))
...
(assert (= (mk_t__ref result2) (mk_t__ref retval)))
(assert (= retval2 ((_ int2bv 64) 0)))
(assert true)
(assert (= (mk_int__ref result3) (mk_int__ref i)))
(assert (= i4 0))
(assert (<= 0 i4))
(assert (<= i4 (- length1 1)))
(assert (forall ((j2 Int)) (=> (and (<= (- length1 i5) j2) (<= j2 (- length1 1))) (= (= (nth8_stream addr (- (- (+ start length1) j2) 1)) true) (= (nth retval3 j2) true)))))
(assert (forall ((j2 Int)) (=> (and (<= length1 j2) (<= j2 63)) (not (= (nth retval3 j2) true)))))
(assert (and (=> (<= 0 (- length1 1)) (dynamic_property1 0 (- length1 1) i5)) (and (<= 0 i5) (<= i5 (- length1 1)))))
(assert (<= length1 j1))
(assert (<= j1 63))
(assert (not (in_range2 j1)))
(check-sat)
(exit)
