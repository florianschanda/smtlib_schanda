...
(assert (forall ((addr us_t)) (forall ((left Int)) (! (=> (and (and (dynamic_invariant2 addr true true true true) (dynamic_invariant left true true true true)) (and (= (first1 addr) 0) (< left (* 8 (length addr))))) (= (= (peekbit8array addr left) true) (= (nth8_stream addr left) true))) :pattern ((peekbit8array addr left))))))
...
(assert (forall ((value (_ BitVec 64))) (forall ((left Int)) (forall ((flag Bool)) (! (=> (and (and (dynamic_invariant1 value true true true true) (dynamic_invariant left true true true true)) (< left 64)) (let ((result (pokebit64 value left flag))) (and (and (forall ((i Int)) (=> (and (<= 0 i) (<= i 63)) (=> (not (= i (- 63 left))) (= (= (nth result i) true) (= (nth value i) true))))) (= (= flag true) (= (nth result (- 63 left)) true))) (dynamic_invariant1 result true false true true)))) :pattern ((pokebit64 value left flag)))))))
...
(assert (dynamic_invariant2 addr true false true true))
...
(assert (= retval1 #x0000000000000000))
(assert (= (mk_int__ref result2) (mk_int__ref i)))
(assert (= i1 0))
(assert (<= 0 i1))
(assert (<= i1 (- length1 1)))
(assert (forall ((j1 Int)) (=> (and (<= (- length1 i2) j1) (<= j1 (- length1 1))) (= (= (nth8_stream addr (- (- (+ start length1) j1) 1)) true) (= (nth retval2 j1) true)))))
(assert (forall ((j1 Int)) (=> (and (<= length1 j1) (<= j1 63)) (not (= (nth retval2 j1) true)))))
