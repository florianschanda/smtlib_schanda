...
(assert (and (= o68 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (and (= o69 o68) (uint_in_range1 o68)))
(assert (= o70 ((_ int2bv 64) o69)))
(assert (= o71 (bvadd o70 ((_ int2bv 64) 1))))
(assert (= o72 (bvmul o71 ((_ int2bv 64) 32))))
(assert (= o73 (ite (bvult i2 o72) true false)))
(assert (= o65 (from_word32 ((_ int2bv 32) 1))))
(assert (= o64 (from_word64 i2)))
(assert (= o66 (oadd o64 o65)))
(assert (= o63 (from_integer s10)))
(assert (= o67 (ole o63 o66)))
(assert (and (= o61 (+ k 1)) (in_range1 (+ k 1))))
(assert (= o62 (ite (<= s10 o61) true false)))
(assert (= o57 (from_word32 ((_ int2bv 32) 2))))
(assert (= o58 (oexpon o57 s10)))
(assert (= o52 (from_word32 ((_ int2bv 32) 1))))
(assert (= o51 (from_integer s10)))
(assert (= o53 (osubtract o51 o52)))
(assert (= o50 (from_word64 i2)))
(assert (= o54 (osubtract o50 o53)))
(assert (= o49 (from_word32 ((_ int2bv 32) 2))))
(assert (= o55 (oexpon__2 o49 o54)))
(assert (and (= o44 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (= o45 (+ o44 1)))
(assert (and (= o46 o45) (in_range1 o45)))
(assert (and (= o47 o46) (in_range2 o46)))
(assert (= o48 (num_of_big_int e e_first o47)))
(assert (= o56 (odivide o48 o55)))
(assert (= o59 (omod o56 o58)))
(assert (= o43 (from_word32 (t__content w7))))
(assert (= o60 (oeq o43 o59)))
(assert (and (= o38 (power 2 k)) (in_range1 (power 2 k))))
(assert (= o39 (- o38 1)))
(assert (and (= o40 o39) (in_range1 o39)))
(assert (= o41 (ite (<= n o40) true false)))
(assert (= result8 (ite (<= 0 n) o41 false)))
(assert (= (= o42 true) (forall ((n1 Int)) (=> (and (<= 0 n1) (<= n1 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux45) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n1 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))))
(assert (and (= o34 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o35 (num_of_big_int m m_first o34)))
(assert (and (= o31 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (and (= o30 (base Tuple0)) (= o30 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o32 (oexpon o30 o31)))
(assert (= o26 (from_word32 ((_ int2bv 32) 2))))
(assert (= o27 (oexpon o26 (- h9 1))))
(assert (= o22 (from_word32 ((_ int2bv 32) 1))))
(assert (= o21 (from_word64 i2)))
(assert (= o23 (oadd o21 o22)))
(assert (= o20 (from_word32 ((_ int2bv 32) 2))))
(assert (= o24 (oexpon__2 o20 o23)))
(assert (and (= o15 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (= o16 (+ o15 1)))
(assert (and (= o17 o16) (in_range1 o16)))
(assert (and (= o18 o17) (in_range2 o17)))
(assert (= o19 (num_of_big_int e e_first o18)))
(assert (= o25 (odivide o19 o24)))
(assert (= o28 (omultiply o25 o27)))
(assert (and (= o13 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o14 (num_of_big_int x x_first o13)))
(assert (= o29 (oexpon__2 o14 o28)))
(assert (= o33 (omultiply o29 o32)))
(assert (= o36 (omod o33 o35)))
(assert (and (= o11 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o12 (num_of_big_int (mk___t aux32 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first o11)))
(assert (= o37 (oeq o12 o36)))
(assert (and (= o9 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o10 (num_of_big_int m m_first o9)))
