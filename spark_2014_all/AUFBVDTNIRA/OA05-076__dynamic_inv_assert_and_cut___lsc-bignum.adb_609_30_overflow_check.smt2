...
(assert (= o71 (bvadd o70 #x0000000000000001)))
(assert (= o72 (bvmul o71 #x0000000000000020)))
(assert (= o73 (ite (bvult i2 o72) true false)))
(assert (= o65 (from_word32 #x00000001)))
...
(assert (and (= o30 (base Tuple0)) (= o30 (oexpon (from_word32 #x00000002) 32))))
(assert (= o32 (oexpon o30 o31)))
(assert (= o26 (from_word32 #x00000002)))
(assert (= o27 (oexpon o26 (- h9 1))))
(assert (= o22 (from_word32 #x00000001)))
(assert (= o21 (from_word64 i2)))
(assert (= o23 (oadd o21 o22)))
(assert (= o20 (from_word32 #x00000002)))
