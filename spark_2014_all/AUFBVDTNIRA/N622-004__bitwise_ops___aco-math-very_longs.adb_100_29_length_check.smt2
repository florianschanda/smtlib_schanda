...
(define-fun dynamic_invariant1 ((temp___expr_302 Int) (temp___is_init_298 Bool) (temp___skip_constant_299 Bool) (temp___do_toplevel_300 Bool) (temp___do_typ_inv_301 Bool)) Bool (=> (or (= temp___is_init_298 true) (<= 1 2147483647)) (in_range3 temp___expr_302)))
...
(define-fun default_initial_assumption ((temp___expr_552 us_rep1) (temp___skip_top_level_553 Bool)) Bool (= (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs2 temp___expr_552))) octet_length))
...
(declare-fun temp___1114 ((_ BitVec 8) Int Int) us_t2)
...
(assert (forall ((temp___1116 (_ BitVec 8))) (forall ((temp___1117 Int) (temp___1118 Int)) (let ((temp___1115 (temp___1114 temp___1116 temp___1117 temp___1118))) (=> (dynamic_invariant3 temp___1116 true true true true) (and (=> (dynamic_property6 1 2147483647 temp___1117 temp___1118) (and (= (first5 temp___1115) temp___1117) (= (last5 temp___1115) temp___1118))) (forall ((temp___1119 Int)) (= (to_rep (select (to_array2 temp___1115) temp___1119)) temp___1116))))))))
...
(assert (= (to_rep2 (first4 (rt2 (temp___1114 #x00 1 octet_length)))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___1114 #x00 1 octet_length)))) octet_length))
(assert (= (mk___t2 temp___1121 temp___11211) (temp___1114 #x00 1 octet_length)))
