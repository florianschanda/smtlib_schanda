...
(define-fun dynamic_invariant1 ((temp___expr_271 Int) (temp___is_init_268 Bool) (temp___skip_constant_269 Bool) (temp___do_toplevel_270 Bool)) Bool (=> (or (= temp___is_init_268 true) (<= 1 2147483647)) (in_range3 temp___expr_271)))
...
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (us_split_discrs2 a) (mk___split_fields (let ((temp___145 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 a)))) (of_array (to_array1 temp___145) (first3 temp___145) (last3 temp___145))))))
(define-fun of_base ((r us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r) (mk___split_fields1 (let ((temp___144 (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 r)))) (of_array1 (to_array temp___144) (first1 temp___144) (last1 temp___144))))))
...
(define-fun dynamic_invariant2 ((temp___expr_507 us_rep1) (temp___is_init_504 Bool) (temp___skip_constant_505 Bool) (temp___do_toplevel_506 Bool)) Bool (and (=> (not (= temp___skip_constant_505 true)) (in_range4 octet_length (to_base temp___expr_507))) (and (dynamic_property3 1 octet_length (first3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_507))) (last3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_507)))) (and (= (first3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_507))) 1) (= (last3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_507))) octet_length)))))
(define-fun default_initial_assumption ((temp___expr_510 us_rep1) (temp___skip_top_level_511 Bool)) Bool (= (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs2 temp___expr_510))) octet_length))
...
(assert (forall ((temp___1031 (_ BitVec 8))) (forall ((temp___1032 Int) (temp___1033 Int)) (let ((temp___1030 (temp___1029 temp___1031 temp___1032 temp___1033))) (and (=> (dynamic_property6 1 2147483647 temp___1032 temp___1033) (and (= (first5 temp___1030) temp___1032) (= (last5 temp___1030) temp___1033))) (forall ((temp___1034 Int)) (= (select (to_array2 temp___1030) temp___1034) (of_rep temp___1031))))))))
...
(define-fun dynamic_invariant4 ((temp___expr_219 (_ BitVec 8)) (temp___is_init_216 Bool) (temp___skip_constant_217 Bool) (temp___do_toplevel_218 Bool)) Bool true)
...
(assert (= (to_rep1 (rec__aco__math__very_longs__very_long__octet_length result____split_discrs)) octet_length))
...
(assert (= (to_rep2 (first4 (rt2 (temp___1029 ((_ int2bv 8) 0) 1 octet_length)))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___1029 ((_ int2bv 8) 0) 1 octet_length)))) octet_length))
(assert (= (mk___t2 temp___1036 temp___10361) (temp___1029 ((_ int2bv 8) 0) 1 octet_length)))
(assert (not (= (ite (<= (to_rep2 (first4 temp___10361)) (to_rep2 (last4 temp___10361))) (+ (- (to_rep2 (last4 temp___10361)) (to_rep2 (first4 temp___10361))) 1) 0) (ite (<= 1 octet_length) (+ (- octet_length 1) 1) 0))))
(check-sat)
(exit)
