...
(declare-datatypes () ((tT23bP1__ref (mk_tT23bP1__ref (tT23bP1__content tdigit_index_typeB)))))
(define-fun tT23bP1__ref___projection ((a tT23bP1__ref)) tdigit_index_typeB (tT23bP1__content a))
(declare-sort t1 0)
...
(define-fun us_split_fields_Long_Digits__6__projection ((a us_split_fields2)) us_t1 (rec__aco__math__very_longs__very_long__long_digits1 a))
...
(define-fun of_base ((r us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r) (mk___split_fields1 (let ((temp___166 (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 r)))) (of_array1 (to_array temp___166) (first1 temp___166) (last1 temp___166))))))
...
(define-fun dynamic_invariant2 ((temp___expr_549 us_rep1) (temp___is_init_545 Bool) (temp___skip_constant_546 Bool) (temp___do_toplevel_547 Bool) (temp___do_typ_inv_548 Bool)) Bool (and (=> (not (= temp___skip_constant_546 true)) (in_range4 octet_length (to_base temp___expr_549))) (and (dynamic_property3 1 octet_length (first3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_549))) (last3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_549)))) (and (= (first3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_549))) 1) (= (last3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_549))) octet_length)))))
(define-fun default_initial_assumption ((temp___expr_552 us_rep1) (temp___skip_top_level_553 Bool)) Bool (= (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs2 temp___expr_552))) octet_length))
...
(declare-datatypes () ((t24b__ref (mk_t24b__ref (t24b__content tdigit_index_typeB)))))
(define-fun t24b__ref___projection ((a t24b__ref)) tdigit_index_typeB (t24b__content a))
(declare-sort t2 0)
...
(declare-fun temp_____aggregate_def_1114 ((_ BitVec 8) Int Int) us_t2)
(define-fun dynamic_invariant3 ((temp___expr_242 (_ BitVec 8)) (temp___is_init_238 Bool) (temp___skip_constant_239 Bool) (temp___do_toplevel_240 Bool) (temp___do_typ_inv_241 Bool)) Bool true)
(declare-sort t3 0)
...
(assert (forall ((temp___1116 (_ BitVec 8))) (forall ((temp___1117 Int) (temp___1118 Int)) (let ((temp___1115 (temp_____aggregate_def_1114 temp___1116 temp___1117 temp___1118))) (=> (dynamic_invariant3 temp___1116 true true true true) (and (=> (dynamic_property6 1 2147483647 temp___1117 temp___1118) (and (= (first5 temp___1115) temp___1117) (= (last5 temp___1115) temp___1118))) (forall ((temp___1119 Int)) (= (to_rep1 (select (to_array2 temp___1115) temp___1119)) temp___1116))))))))
(define-fun dynamic_invariant4 ((temp___expr_309 us_t3) (temp___is_init_305 Bool) (temp___skip_constant_306 Bool) (temp___do_toplevel_307 Bool) (temp___do_typ_inv_308 Bool)) Bool (=> (not (= temp___skip_constant_306 true)) (dynamic_property6 1 2147483647 (first7 temp___expr_309) (last7 temp___expr_309))))
(define-fun dynamic_invariant5 ((temp___expr_315 us_rep) (temp___is_init_311 Bool) (temp___skip_constant_312 Bool) (temp___do_toplevel_313 Bool) (temp___do_typ_inv_314 Bool)) Bool (let ((temp___316 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 temp___expr_315)))) (and (dynamic_property1 1 (to_rep temp___316) (first1 (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 temp___expr_315))) (last1 (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 temp___expr_315)))) (and (= (first1 (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 temp___expr_315))) 1) (= (last1 (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 temp___expr_315))) (to_rep temp___316))))))
(declare-const result____split_fields (Array Int octet))
(declare-const result____split_fields1 t1)
(declare-const temp Int)
(declare-const us Int)
(declare-const temp___1121 (Array Int octet))
(declare-const temp___11211 t2)
(assert (in_range1 number))
(assert (in_range2 octet_length))
(assert (and (= us octet_length) (in_range2 octet_length)))
(assert (= (to_rep (rec__aco__math__very_longs__very_long__octet_length result____split_discrs)) octet_length))
...
(assert (= (to_rep2 (first4 (rt2 (temp_____aggregate_def_1114 #x00 1 octet_length)))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp_____aggregate_def_1114 #x00 1 octet_length)))) octet_length))
(assert (= (mk___t2 temp___1121 temp___11211) (temp_____aggregate_def_1114 #x00 1 octet_length)))
(assert (not (= (ite (<= (to_rep2 (first4 temp___11211)) (to_rep2 (last4 temp___11211))) (+ (- (to_rep2 (last4 temp___11211)) (to_rep2 (first4 temp___11211))) 1) 0) (ite (<= 1 octet_length) (+ (- octet_length 1) 1) 0))))
(check-sat)
(exit)
