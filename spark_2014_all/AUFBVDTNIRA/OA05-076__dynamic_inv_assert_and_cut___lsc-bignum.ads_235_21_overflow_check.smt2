...
(assert (= o30 (+ x_first o29)))
(assert (and (= o31 o30) (in_range1 o30)))
(assert (= o32 (ite (<= o31 (to_rep (last (rt x)))) true false)))
(assert (and (= o26 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o27 (+ x_first o26)))
(assert (and (= o28 o27) (in_range1 o27)))
(assert (= o33 (ite (<= (to_rep (first (rt x))) o28) true false)))
(assert (= result (ite (= o33 true) o32 false)))
(assert (= result true))
...
(assert (= o22 (+ m_first o21)))
(assert (and (= o23 o22) (in_range1 o22)))
(assert (= o24 (ite (<= o23 (to_rep (last (rt m)))) true false)))
(assert (and (= o18 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o19 (+ m_first o18)))
(assert (and (= o20 o19) (in_range1 o19)))
(assert (= o25 (ite (<= (to_rep (first (rt m))) o20) true false)))
(assert (= result1 (ite (= o25 true) o24 false)))
(assert (= result1 true))
...
(assert (= o14 (+ aux1_first o13)))
(assert (and (= o15 o14) (in_range1 o14)))
(assert (= o16 (ite (<= o15 (to_rep aux1__last)) true false)))
(assert (and (= o10 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o11 (+ aux1_first o10)))
(assert (and (= o12 o11) (in_range1 o11)))
(assert (= o17 (ite (<= (to_rep aux1__first) o12) true false)))
(assert (= result2 (ite (= o17 true) o16 false)))
(assert (= result2 true))
...
(assert (= o6 (+ aux2_first o5)))
(assert (and (= o7 o6) (in_range1 o6)))
(assert (= o8 (ite (<= o7 (to_rep aux2__last)) true false)))
(assert (and (= o2 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o3 (+ aux2_first o2)))
(assert (and (= o4 o3) (in_range1 o3)))
(assert (= o9 (ite (<= (to_rep aux2__first) o4) true false)))
(assert (= result3 (ite (= o9 true) o8 false)))
(assert (= result3 true))
