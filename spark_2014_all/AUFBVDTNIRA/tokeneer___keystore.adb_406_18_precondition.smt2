...
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq3 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_150 Int)) (=> (and (<= a__first temp___idx_150) (<= temp___idx_150 a__last)) (= (to_rep5 (select a temp___idx_150)) (to_rep5 (select b (+ (- b__first a__first) temp___idx_150)))))))))))
...
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare1 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq3 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep5 (select a (+ i 1))) (to_rep5 (select b (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare1 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq3 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep5 (select b (+ i 1))) (to_rep5 (select a (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
...
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare2 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq5 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep8 (select a (+ i 1))) (to_rep8 (select b (+ j 1))))))))))) :pattern ((compare2 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare2 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq5 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep8 (select b (+ i 1))) (to_rep8 (select a (+ j 1))))))))))) :pattern ((compare2 a a_first a_last b b_first b_last))))))
...
(define-fun bool_eq6 ((a us_rep2) (b us_rep2)) Bool (ite (and (and (and (= (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 a))) (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 b)))) (= (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 a))) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 b))))) (= (bool_eq4 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 a)) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 b))) true)) (= (bool_eq5 (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 a)) 1 17 (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 b)) 1 17) true)) true false))
...
(assert (forall ((temp___1089 Int)) (forall ((temp___1090 Int)) (= (select (temp___1087 temp___1089) temp___1090) (of_rep5 temp___1089)))))
(declare-fun temp___1091 (Int) (Array Int fileentrycountt))
(assert (forall ((temp___1093 Int)) (forall ((temp___1094 Int)) (= (select (temp___1091 temp___1093) temp___1094) (of_rep8 temp___1093)))))
(define-fun dynamic_invariant2 ((temp___expr_1081 us_rep2) (temp___is_init_1078 Bool) (temp___skip_constant_1079 Bool) (temp___do_toplevel_1080 Bool)) Bool (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1081))) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1081))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1081)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1081))) true))
(define-fun default_initial_assumption ((temp___expr_1085 us_rep2) (temp___skip_top_level_1086 Bool)) Bool (and (and (and (= (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1085))) 1) (= (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1085))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1085)) (mk___rep1 (mk___split_fields1 (temp___1087 1) (of_rep5 1) (of_rep5 1) (of_rep7 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1085)) (temp___1091 0))))
(define-fun type_invariant ((temp___1095 us_rep2)) Bool (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___1095))) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___1095))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___1095)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___1095))) true))
...
(assert (forall ((x filestatust)) (! (in_range12 (to_rep9 x)) :pattern ((to_rep9 x)))))
...
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq9 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_153 Int)) (=> (and (<= a__first temp___idx_153) (<= temp___idx_153 a__last)) (= (to_rep9 (select a temp___idx_153)) (to_rep9 (select b (+ (- b__first a__first) temp___idx_153)))))))))))
...
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare3 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq9 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep9 (select a (+ i 1))) (to_rep9 (select b (+ j 1))))))))))) :pattern ((compare3 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare3 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq9 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep9 (select b (+ i 1))) (to_rep9 (select a (+ j 1))))))))))) :pattern ((compare3 a a_first a_last b b_first b_last))))))
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(declare-const attr__ATTRIBUTE_ADDRESS3 Int)
(declare-const attr__ATTRIBUTE_ADDRESS4 Int)
(declare-const attr__ATTRIBUTE_ADDRESS5 Int)
(declare-sort maskt 0)
(define-fun in_range13 ((x (_ BitVec 32))) Bool (and (bvule ((_ int2bv 32) 0) x) (bvule x ((_ int2bv 32) 15))))
...
(assert (forall ((x (_ BitVec 32))) (! (let ((y (bvurem x ((_ int2bv 32) 16)))) (=> (in_range13 y) (= (to_rep10 (of_rep10 x)) y))) :pattern ((to_rep10 (of_rep10 x))))))
...
(define-fun us_split_fields_Owner__2__projection ((a us_split_fields6)) us_rep (rec__keystore__interfac__keytemplatet__owner a))
...
(define-fun bool_eq11 ((a (Array Int unsigned32t)) (a__first Int) (a__last Int) (b (Array Int unsigned32t)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_167 Int)) (=> (and (<= a__first temp___idx_167) (<= temp___idx_167 a__last)) (= (to_rep2 (select a temp___idx_167)) (to_rep2 (select b (+ (- b__first a__first) temp___idx_167))))))) true false))
(assert (forall ((a (Array Int unsigned32t)) (b (Array Int unsigned32t))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq11 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_167 Int)) (=> (and (<= a__first temp___idx_167) (<= temp___idx_167 a__last)) (= (to_rep2 (select a temp___idx_167)) (to_rep2 (select b (+ (- b__first a__first) temp___idx_167)))))))))))
...
(assert (forall ((a (Array Int unsigned32t)) (b (Array Int unsigned32t))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare4 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq11 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep2 (select a (+ i 1))) (to_rep2 (select b (+ j 1))))))))))) :pattern ((compare4 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int unsigned32t)) (b (Array Int unsigned32t))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare4 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq11 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep2 (select b (+ i 1))) (to_rep2 (select a (+ j 1))))))))))) :pattern ((compare4 a a_first a_last b b_first b_last))))))
...
(declare-fun temp___String_Literal_1819 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1819 us_void_param) 1)) 67) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 2)) 114)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 3)) 121)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 4)) 112)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 5)) 116)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 6)) 111)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 7)) 32)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 8)) 76)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 9)) 105)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 10)) 98)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 11)) 114)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 12)) 97)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 13)) 114)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 14)) 121)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 16)) 69)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 17)) 114)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 18)) 114)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 19)) 111)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 20)) 114)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 21)) 32)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 22)) 58)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 23)) 32)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 24)) 76)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 25)) 105)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 26)) 98)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 27)) 114)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 28)) 97)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 29)) 114)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 30)) 121)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 31)) 32)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 32)) 104)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 33)) 111)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 34)) 108)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 35)) 100)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 36)) 115)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 37)) 32)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 38)) 109)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 39)) 111)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 40)) 114)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 41)) 101)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 42)) 32)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 43)) 116)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 44)) 104)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 45)) 97)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 46)) 110)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 47)) 32)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 48)) 111)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 49)) 110)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 50)) 101)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 51)) 32)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 52)) 112)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 53)) 117)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 54)) 98)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 55)) 108)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 56)) 105)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 57)) 99)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 58)) 32)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 59)) 107)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 60)) 101)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 61)) 121)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 62)) 32)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 63)) 102)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 64)) 111)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 65)) 114)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 66)) 32)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 67)) 97)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 68)) 110)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 69)) 32)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 70)) 73)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 71)) 115)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 72)) 115)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 73)) 117)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 74)) 101)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 75)) 114)) (= (to_rep (select (temp___String_Literal_1819 us_void_param) 76)) 46)) :pattern ((temp___String_Literal_1819 us_void_param)))))
...
(define-fun dynamic_invariant7 ((temp___expr_841 Int) (temp___is_init_838 Bool) (temp___skip_constant_839 Bool) (temp___do_toplevel_840 Bool)) Bool (=> (or (= temp___is_init_838 true) (<= 0 40)) (in_range6 temp___expr_841)))
(define-fun dynamic_invariant8 ((temp___expr_862 Int) (temp___is_init_859 Bool) (temp___skip_constant_860 Bool) (temp___do_toplevel_861 Bool)) Bool (=> (or (= temp___is_init_859 true) (<= 0 4294967295)) (in_range7 temp___expr_862)))
(assert (= nouser (temp___String_Literal_136 Tuple0)))
(define-fun dynamic_invariant9 ((temp___expr_1047 Int) (temp___is_init_1044 Bool) (temp___skip_constant_1045 Bool) (temp___do_toplevel_1046 Bool)) Bool (=> (or (= temp___is_init_1044 true) (<= 0 17)) (in_range10 temp___expr_1047)))
(define-fun dynamic_invariant10 ((temp___expr_1026 Int) (temp___is_init_1023 Bool) (temp___skip_constant_1024 Bool) (temp___do_toplevel_1025 Bool)) Bool (=> (or (= temp___is_init_1023 true) (<= 1 17)) (in_range8 temp___expr_1026)))
(define-fun dynamic_invariant11 ((temp___expr_1151 Int) (temp___is_init_1148 Bool) (temp___skip_constant_1149 Bool) (temp___do_toplevel_1150 Bool)) Bool (=> (or (= temp___is_init_1148 true) (<= 0 2)) (in_range12 temp___expr_1151)))
(define-fun dynamic_invariant12 ((temp___expr_1032 Int) (temp___is_init_1029 Bool) (temp___skip_constant_1030 Bool) (temp___do_toplevel_1031 Bool)) Bool (=> (or (= temp___is_init_1029 true) (<= 0 17408)) (in_range9 temp___expr_1032)))
(define-fun dynamic_invariant13 ((temp___expr_1066 Int) (temp___is_init_1063 Bool) (temp___skip_constant_1064 Bool) (temp___do_toplevel_1065 Bool)) Bool (=> (or (= temp___is_init_1063 true) (<= 0 1024)) (in_range11 temp___expr_1066)))
(assert true)
...
(define-fun dynamic_invariant14 ((temp___expr_1404 (_ BitVec 32)) (temp___is_init_1401 Bool) (temp___skip_constant_1402 Bool) (temp___do_toplevel_1403 Bool)) Bool (=> (or (= temp___is_init_1401 true) (bvule ((_ int2bv 32) 0) ((_ int2bv 32) 15))) (in_range13 temp___expr_1404)))
...
(declare-const temp___1818 maskt)
(declare-const temp___18181 issueridt)
(declare-const temp___18182 namecountt)
(declare-const temp___18183 (Array Int character))
(declare-const temp___18184 unsigned32t)
(declare-const temp___18185 unsigned32t)
(declare-const temp___18186 Bool)
...
(assert (=> (<= 0 4294967295) (in_range5 issuerkey)))
...
(assert (in_range5 expectedcount))
(assert (= result (mk_int__ref actualcount)))
(assert (= actualcount1 1))
(assert (in_range5 actualcount1))
(assert (= (to_rep2 o) 0))
(assert (= (to_rep2 o1) 0))
(assert (= (to_rep10 o2) ((_ int2bv 32) 9)))
(assert (= o2 o3))
(assert (= issuer (mk___rep (mk___split_fields o4 o5 o6))))
(assert (= o1 o7))
(assert (= o o8))
(assert (= (of_int 1) o9))
(assert (= temp___1818 o3))
(assert (= temp___18181 o4))
(assert (= temp___18182 o5))
(assert (= temp___18183 o6))
(assert (= temp___18184 o7))
(assert (= temp___18185 o8))
(assert (= temp___18186 o9))
(assert (= result1 (mk___split_fields__ref3 (mk___split_fields3 issuertemplate__split_fields (mk___rep (mk___split_fields issuertemplate__split_fields1 issuertemplate__split_fields2 issuertemplate__split_fields3)) issuertemplate__split_fields4 issuertemplate__split_fields5 issuertemplate__split_fields6))))
(assert (= issuertemplate__split_fields7 (mk___split_fields3 temp___1818 (mk___rep (mk___split_fields temp___18181 temp___18182 temp___18183)) temp___18184 temp___18185 temp___18186)))
(assert (and (and (in_range5 actualcount2) (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields7)) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields7)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields7)) true)) (in_range4 auditalarm1)))
