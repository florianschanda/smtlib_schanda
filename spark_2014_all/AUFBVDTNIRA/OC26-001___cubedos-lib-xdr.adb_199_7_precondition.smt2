...
(define-fun dynamic_invariant ((temp___expr_154 Int) (temp___is_init_151 Bool) (temp___skip_constant_152 Bool) (temp___do_toplevel_153 Bool)) Bool (=> (or (= temp___is_init_151 true) (<= (- 9223372036854775808) 9223372036854775807)) (in_range1 temp___expr_154)))
...
(define-fun dynamic_invariant1 ((temp___expr_160 (_ BitVec 64)) (temp___is_init_157 Bool) (temp___skip_constant_158 Bool) (temp___do_toplevel_159 Bool)) Bool true)
...
(define-fun dynamic_invariant4 ((temp___expr_265 (_ BitVec 64)) (temp___is_init_262 Bool) (temp___skip_constant_263 Bool) (temp___do_toplevel_264 Bool)) Bool true)
...
(define-fun dynamic_invariant5 ((temp___expr_271 Int) (temp___is_init_268 Bool) (temp___skip_constant_269 Bool) (temp___do_toplevel_270 Bool)) Bool (=> (or (= temp___is_init_268 true) (<= (- 9223372036854775808) 9223372036854775807)) (in_range4 temp___expr_271)))
(declare-fun xdr_unsigned_to_hyper ((_ BitVec 64)) Int)
(declare-fun xdr_unsigned_to_hyper__function_guard (Int (_ BitVec 64)) Bool)
(assert (forall ((s (_ BitVec 64))) (! (=> (dynamic_invariant4 s true true true) (dynamic_invariant5 (xdr_unsigned_to_hyper s) true false true)) :pattern ((xdr_unsigned_to_hyper s)))))
