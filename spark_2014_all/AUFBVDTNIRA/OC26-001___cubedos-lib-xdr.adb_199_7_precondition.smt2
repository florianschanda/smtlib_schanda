...
(define-fun dynamic_invariant ((temp___expr_180 Int) (temp___is_init_176 Bool) (temp___skip_constant_177 Bool) (temp___do_toplevel_178 Bool) (temp___do_typ_inv_179 Bool)) Bool (=> (or (= temp___is_init_176 true) (<= (- 9223372036854775808) 9223372036854775807)) (in_range1 temp___expr_180)))
...
(define-fun dynamic_invariant1 ((temp___expr_187 (_ BitVec 64)) (temp___is_init_183 Bool) (temp___skip_constant_184 Bool) (temp___do_toplevel_185 Bool) (temp___do_typ_inv_186 Bool)) Bool true)
...
(define-fun dynamic_invariant4 ((temp___expr_304 (_ BitVec 64)) (temp___is_init_300 Bool) (temp___skip_constant_301 Bool) (temp___do_toplevel_302 Bool) (temp___do_typ_inv_303 Bool)) Bool true)
...
(define-fun dynamic_invariant5 ((temp___expr_311 Int) (temp___is_init_307 Bool) (temp___skip_constant_308 Bool) (temp___do_toplevel_309 Bool) (temp___do_typ_inv_310 Bool)) Bool (=> (or (= temp___is_init_307 true) (<= (- 9223372036854775808) 9223372036854775807)) (in_range4 temp___expr_311)))
(declare-fun xdr_unsigned_to_hyper ((_ BitVec 64)) Int)
(declare-fun xdr_unsigned_to_hyper__function_guard (Int (_ BitVec 64)) Bool)
(assert (forall ((s (_ BitVec 64))) (! (=> (dynamic_invariant4 s true true true true) (dynamic_invariant5 (xdr_unsigned_to_hyper s) true false true true)) :pattern ((xdr_unsigned_to_hyper s)))))
...
(assert (=> (<= (- 9223372036854775808) 9223372036854775807) (in_range1 value)))
