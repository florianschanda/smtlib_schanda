...
(define-fun index_t__ref___5__projection ((a index_t__ref1)) index_t1 (index_t__content1 a))
(define-fun dynamic_invariant4 ((temp___expr_917 Int) (temp___is_init_914 Bool) (temp___skip_constant_915 Bool) (temp___do_toplevel_916 Bool)) Bool (=> (or (= temp___is_init_914 true) (<= 0 1)) (in_range3 temp___expr_917)))
...
(define-fun bool_eq2 ((a (Array Int us_rep)) (a__first Int) (a__last Int) (b (Array Int us_rep)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_153 Int)) (=> (and (<= a__first temp___idx_153) (<= temp___idx_153 a__last)) (= (bool_eq1 (select a temp___idx_153) (select b (+ (- b__first a__first) temp___idx_153))) true)))) true false))
(assert (forall ((a (Array Int us_rep)) (b (Array Int us_rep))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq2 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_153 Int)) (=> (and (<= a__first temp___idx_153) (<= temp___idx_153 a__last)) (= (bool_eq1 (select a temp___idx_153) (select b (+ (- b__first a__first) temp___idx_153))) true))))))))
...
(define-fun word_t__ref___29__projection ((a word_t__ref)) word_t (word_t__content a))
(define-fun dynamic_invariant5 ((temp___expr_996 (_ BitVec 8)) (temp___is_init_993 Bool) (temp___skip_constant_994 Bool) (temp___do_toplevel_995 Bool)) Bool true)
...
(assert (forall ((temp___155 us_rep) (temp___156 us_rep)) (let ((temp___154 (hw__dbc__legacy_support_reg_descs__aggregate_def temp___155 temp___156))) (and (= (select temp___154 0) temp___155) (= (select temp___154 1) temp___156)))))
...
(declare-const hw__dbc__legacy_support_regs__write_i__off__assume Int)
...
(assert true)
(assert (and (= o (+ byte_offset (to_rep (rec__hw__dbc__legacy_support_s_regs__t__byte_offset (us_split_fields1 (select regs idx)))))) (in_range (+ byte_offset (to_rep (rec__hw__dbc__legacy_support_s_regs__t__byte_offset (us_split_fields1 (select regs idx))))))))
(assert (= o1 (div1 o 4)))
(assert (and (= hw__dbc__legacy_support_regs__write_i__off__assume o1) (in_range2 o1)))
(assert (= hw__dbc__legacy_support_regs__write_i__off__assume off))
(assert (in_range2 off))
(assert (and (= o2 (+ (to_rep (rec__hw__dbc__legacy_support_s_regs__t__msb (us_split_fields1 (select regs idx)))) 1)) (in_range (+ (to_rep (rec__hw__dbc__legacy_support_s_regs__t__msb (us_split_fields1 (select regs idx)))) 1))))
(assert (= o3 ((_ int2bv 64) o2)))
(assert (= o4 (bvshl ((_ int2bv 64) 1) o3)))
(assert (= o5 (bvsub o4 (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) (to_rep (rec__hw__dbc__legacy_support_s_regs__t__lsb (us_split_fields1 (select regs idx)))))))))
(assert (= o6 o5))
(assert (= result mask))
(assert (= mask1 o6))
(assert true)
(assert true)
(assert (and (= o7 (- (to_rep (rec__hw__dbc__legacy_support_s_regs__t__msb (us_split_fields1 (select regs idx)))) (to_rep (rec__hw__dbc__legacy_support_s_regs__t__lsb (us_split_fields1 (select regs idx)))))) (in_range (- (to_rep (rec__hw__dbc__legacy_support_s_regs__t__msb (us_split_fields1 (select regs idx)))) (to_rep (rec__hw__dbc__legacy_support_s_regs__t__lsb (us_split_fields1 (select regs idx))))))))
(assert (= o8 (+ o7 1)))
(assert (and (= o9 o8) (in_range o8)))
(assert (= result1 (ite (= o9 32) true false)))
(assert (not (= result1 true)))
(assert true)
(assert (not (bvule ((_ zero_extend 32) ((_ int2bv 32) 0)) (bvor (bvand ((_ zero_extend 32) temp1) (bvnot mask1)) (bvshl ((_ zero_extend 56) value) ((_ int2bv 64) (to_rep (rec__hw__dbc__legacy_support_s_regs__t__lsb (us_split_fields1 (select regs idx))))))))))
(check-sat)
(exit)
