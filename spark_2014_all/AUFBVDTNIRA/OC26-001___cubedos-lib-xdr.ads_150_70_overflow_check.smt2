...
(assert (=> (<= (to_rep data__first) (to_rep data__last)) (= o6 (+ (- (to_rep data__last) (to_rep data__first)) 1))))
(assert (=> (not (<= (to_rep data__first) (to_rep data__last))) (= o6 0)))
...
(assert (= result1 true))
(assert (<= (to_rep data__first) position))
(assert (<= position (to_rep data__last)))
(assert (and (= o1 (- (to_rep data__last) position)) (in_range1 (- (to_rep data__last) position))))
(assert (= o2 (+ o1 1)))
