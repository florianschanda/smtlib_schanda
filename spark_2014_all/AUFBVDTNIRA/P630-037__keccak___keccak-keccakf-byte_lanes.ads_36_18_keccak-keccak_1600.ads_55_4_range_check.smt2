...
(define-fun dynamic_invariant4 ((temp___expr_280 (_ BitVec 8)) (temp___is_init_277 Bool) (temp___skip_constant_278 Bool) (temp___do_toplevel_279 Bool)) Bool (=> (or (= temp___is_init_277 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 4))) (in_range4 temp___expr_280)))
...
(define-fun dynamic_invariant5 ((temp___expr_286 (_ BitVec 8)) (temp___is_init_283 Bool) (temp___skip_constant_284 Bool) (temp___do_toplevel_285 Bool)) Bool (=> (or (= temp___is_init_283 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 4))) (in_range5 temp___expr_286)))
(declare-sort map1 0)
...
(define-fun dynamic_invariant7 ((temp___expr_255 Int) (temp___is_init_252 Bool) (temp___skip_constant_253 Bool) (temp___do_toplevel_254 Bool)) Bool (=> (or (= temp___is_init_252 true) (<= 0 2147483647)) (in_range3 temp___expr_255)))
...
(declare-const o100 lane_type)
(declare-const o101 map1)
(declare-const o102 (_ BitVec 8))
(declare-const o103 (_ BitVec 8))
...
(declare-const temp___7283 int__ref)
(declare-const temp___7273 int__ref)
...
(declare-const temp___7284 Int)
(declare-const temp___7274 Int)
...
(assert (not (in_range1 (length data))))
(check-sat)
(exit)
