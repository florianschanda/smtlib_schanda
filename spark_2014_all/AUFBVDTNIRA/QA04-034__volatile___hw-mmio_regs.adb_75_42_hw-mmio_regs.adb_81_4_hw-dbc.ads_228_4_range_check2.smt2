...
(define-fun dynamic_invariant4 ((temp___expr_1163 Int) (temp___is_init_1159 Bool) (temp___skip_constant_1160 Bool) (temp___do_toplevel_1161 Bool) (temp___do_typ_inv_1162 Bool)) Bool (=> (or (= temp___is_init_1159 true) (<= 0 34)) (in_range3 temp___expr_1163)))
...
(define-fun dynamic_invariant5 ((temp___expr_1249 (_ BitVec 8)) (temp___is_init_1245 Bool) (temp___skip_constant_1246 Bool) (temp___do_toplevel_1247 Bool) (temp___do_typ_inv_1248 Bool)) Bool true)
...
(assert (= o5 (bvsub o4 (bvshl #x0000000000000001 ((_ int2bv 64) (to_rep (rec__hw__dbc__s_regs__t__lsb (us_split_fields1 (select regs idx)))))))))
(assert (= o6 o5))
(assert (= result mask))
(assert (= mask1 o6))
...
(assert (not (bvule ((_ zero_extend 32) #x00000000) (bvor (bvand ((_ zero_extend 32) temp) (bvnot mask1)) (bvshl ((_ zero_extend 56) value) ((_ int2bv 64) (to_rep (rec__hw__dbc__s_regs__t__lsb (us_split_fields1 (select regs idx))))))))))
(check-sat)
(exit)
