...
(define-fun word_t__ref___20__projection ((a word_t__ref)) word_t (word_t__content a))
(define-fun dynamic_invariant5 ((temp___expr_982 (_ BitVec 64)) (temp___is_init_978 Bool) (temp___skip_constant_979 Bool) (temp___do_toplevel_980 Bool) (temp___do_typ_inv_981 Bool)) Bool true)
...
(declare-const hw__dbc__xcap_regs__read_i__4__off__assume Int)
...
(assert (= o1 (div1 o 4)))
(assert (and (= hw__dbc__xcap_regs__read_i__4__off__assume o1) (in_range2 o1)))
(assert (= hw__dbc__xcap_regs__read_i__4__off__assume off))
(assert (in_range2 off))
(assert (not (in_range (+ (to_rep (rec__hw__dbc__xcap_s_regs__t__msb (us_split_fields1 (select regs idx)))) 1))))
(check-sat)
(exit)
