...
(assert (and (and (and (= last3 (+ position 7)) (in_range2 last3)) (and (and (= o (xdr_unsigned_to_hyper temporary1)) (in_range4 o)) (and (= result value) (= value1 o)))) (and (and (= temporary1 temporary2) (and (= last3 last4) (= value1 value2))) (and (= temporary3 temporary1) (and (= last5 last3) (= value3 value1))))))
