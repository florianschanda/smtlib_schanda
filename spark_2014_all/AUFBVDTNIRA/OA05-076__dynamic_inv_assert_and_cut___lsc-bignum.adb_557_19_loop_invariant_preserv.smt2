...
(assert (=> (= result20 true) (and (= o457 (- j3 s3)) (in_range1 (- j3 s3)))))
(assert (=> (= result20 true) (and (= o458 o457) (in_range2 o457))))
(assert (=> (= result20 true) (= o459 ((_ int2bv 32) o458))))
(assert (=> (= result20 true) (= o460 (bvshl w3 o459))))
(assert (=> (= result20 true) (= o461 (bvor o460 ((_ int2bv 32) 1)))))
(assert (=> (= result20 true) (= result21 (mk_t__ref w3))))
(assert (=> (= result20 true) (= w4 o461)))
(assert (=> (= result20 true) (= result22 (mk_int__ref s3))))
(assert (=> (= result20 true) (= s4 j3)))
(assert (=> (= result20 true) (= w5 (mk_t__ref w4))))
(assert (=> (= result20 true) (= s5 (mk_int__ref s4))))
(assert (=> (= result20 true) (= w6 w4)))
(assert (=> (= result20 true) (= s6 s4)))
(assert (=> (not (= result20 true)) (= w5 (mk_t__ref w3))))
(assert (=> (not (= result20 true)) (= s5 (mk_int__ref s3))))
(assert (=> (not (= result20 true)) (= w6 w3)))
(assert (=> (not (= result20 true)) (= s6 s3)))
(assert (and (= o462 (+ j3 1)) (in_range1 (+ j3 1))))
(assert (= result23 (mk_int__ref j3)))
(assert (= j4 o462))
(assert (= w9 w5))
(assert (= s9 s5))
(assert (= j7 (mk_int__ref j4)))
(assert (= w10 w6))
(assert (= s10 s6))
(assert (= j8 j4))
