...
(assert (=> (<= (to_rep1 data__first) (to_rep1 data__last)) (= o7 (+ (- (to_rep1 data__last) (to_rep1 data__first)) 1))))
(assert (=> (not (<= (to_rep1 data__first) (to_rep1 data__last))) (= o7 0)))
(assert (= result (ite (< 0 o7) true false)))
(assert (= result true))
(assert (=> (<= (to_rep1 data__first) (to_rep1 data__last)) (= o5 (+ (- (to_rep1 data__last) (to_rep1 data__first)) 1))))
(assert (=> (not (<= (to_rep1 data__first) (to_rep1 data__last))) (= o5 0)))
(assert (= o6 (mod1 o5 4)))
...
(assert (and (= o1 (- (to_rep1 data__last) position)) (in_range1 (- (to_rep1 data__last) position))))
(assert (= o2 (+ o1 1)))
