...
(assert (= o16 (+ o15 i2)))
(assert (and (= temp___8191 o16) (in_range1 o16)))
(assert (and (<= (to_rep data__first) temp___8191) (<= temp___8191 (to_rep data__last))))
(assert (= o25 temp___8191))
...
(assert (= o28 (+ o27 i3)))
(assert (and (= temp___8192 o28) (in_range1 o28)))
(assert (and (<= (to_rep data__first) temp___8192) (<= temp___8192 (to_rep data__last))))
(assert (= o37 temp___8192))
...
(assert (= o40 (+ o39 i4)))
(assert (and (= temp___8193 o40) (in_range1 o40)))
(assert (and (<= (to_rep data__first) temp___8193) (<= temp___8193 (to_rep data__last))))
(assert (= o49 temp___8193))
...
(assert (= o52 (+ o51 i5)))
(assert (and (= temp___8194 o52) (in_range1 o52)))
(assert (and (<= (to_rep data__first) temp___8194) (<= temp___8194 (to_rep data__last))))
(assert (= o61 temp___8194))
...
(assert (= o64 (+ o63 i6)))
(assert (and (= temp___8195 o64) (in_range1 o64)))
(assert (and (<= (to_rep data__first) temp___8195) (<= temp___8195 (to_rep data__last))))
(assert (= o73 temp___8195))
...
(assert (= o76 (+ o75 i7)))
(assert (and (= temp___8196 o76) (in_range1 o76)))
(assert (and (<= (to_rep data__first) temp___8196) (<= temp___8196 (to_rep data__last))))
(assert (= o85 temp___8196))
...
(assert (= o88 (+ o87 i8)))
(assert (and (= temp___8197 o88) (in_range1 o88)))
(assert (and (<= (to_rep data__first) temp___8197) (<= temp___8197 (to_rep data__last))))
(assert (= o97 temp___8197))
...
(assert (and (= o102 (+ offset2 8)) (in_range1 (+ offset2 8))))
(assert (= result27 (mk_int__ref offset2)))
(assert (= offset3 o102))
(assert (<= 8 remaining_bytes3))
(assert (not (or (< temp___8341 offset3) (and (= offset3 temp___8341) (< remaining_bytes3 temp___8331)))))
(check-sat)
(exit)
