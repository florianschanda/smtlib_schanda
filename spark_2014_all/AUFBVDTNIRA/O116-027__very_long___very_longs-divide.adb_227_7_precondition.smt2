...
(declare-const temp___1102 us_rep1)
(declare-const temp___1101 us_rep)
(declare-const temp___1100 (_ BitVec 16))
(declare-const temp___1099 (_ BitVec 16))
...
(assert (and (= o13 j2) (in_range2 j2)))
(assert (not (< 1 n1)))
(check-sat)
(exit)
