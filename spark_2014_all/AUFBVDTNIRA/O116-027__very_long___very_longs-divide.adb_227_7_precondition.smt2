...
(define-fun dynamic_invariant2 ((temp___expr_221 Int) (temp___is_init_217 Bool) (temp___skip_constant_218 Bool) (temp___do_toplevel_219 Bool) (temp___do_typ_inv_220 Bool)) Bool (=> (or (= temp___is_init_217 true) (<= 0 65536)) (in_range3 temp___expr_221)))
(assert (forall ((number us_rep)) (! (=> (dynamic_invariant1 number true true true true) (dynamic_invariant2 (number_of_digits number) true false true true)) :pattern ((number_of_digits number)))))
(assert (forall ((number us_rep)) (! (=> (dynamic_invariant1 number true true true true) (let ((result (number_of_digits1 number))) (and (and (=> (< 0 result) (not (= (to_rep1 (let ((temp___300 (rec__very_longs__very_long__long_digits (us_split_fields1 number)))) (select (to_array temp___300) result))) #x00))) (forall ((j Int)) (=> (and (<= (+ result 1) j) (<= j (last1 (rec__very_longs__very_long__long_digits (us_split_fields1 number))))) (= (to_rep1 (let ((temp___301 (rec__very_longs__very_long__long_digits (us_split_fields1 number)))) (select (to_array temp___301) j))) #x00)))) (dynamic_invariant2 result true false true true)))) :pattern ((number_of_digits1 number)))))
...
(define-fun dynamic_invariant3 ((temp___expr_340 (_ BitVec 16)) (temp___is_init_336 Bool) (temp___skip_constant_337 Bool) (temp___do_toplevel_338 Bool) (temp___do_typ_inv_339 Bool)) Bool true)
...
(define-fun dynamic_invariant5 ((temp___expr_758 Int) (temp___is_init_754 Bool) (temp___skip_constant_755 Bool) (temp___do_toplevel_756 Bool) (temp___do_typ_inv_757 Bool)) Bool (=> (or (= temp___is_init_754 true) (<= first2 last3)) (dynamic_property3 first2 last3 temp___expr_758)))
...
(define-fun dynamic_invariant6 ((temp___expr_765 Int) (temp___is_init_761 Bool) (temp___skip_constant_762 Bool) (temp___do_toplevel_763 Bool) (temp___do_typ_inv_764 Bool)) Bool (=> (or (= temp___is_init_761 true) (<= 0 7)) (in_range4 temp___expr_765)))
...
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (us_split_discrs2 a) (mk___split_fields (let ((temp___212 (rec__very_longs__very_long__long_digits1 (us_split_fields3 a)))) (of_array (to_array1 temp___212) (first4 temp___212) (last5 temp___212))))))
...
(define-fun dynamic_invariant7 ((temp___expr_772 us_rep1) (temp___is_init_768 Bool) (temp___skip_constant_769 Bool) (temp___do_toplevel_770 Bool) (temp___do_typ_inv_771 Bool)) Bool (and (=> (not (= temp___skip_constant_769 true)) (in_range5 (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 dividend))) 1) (to_base temp___expr_772))) (and (dynamic_property5 1 (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 dividend))) 1) (first4 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_772))) (last5 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_772)))) (and (= (first4 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_772))) 1) (= (last5 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_772))) (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 dividend))) 1))))))
...
(define-fun to_base1 ((a us_rep2)) us_rep (mk___rep (us_split_discrs3 a) (mk___split_fields (let ((temp___214 (rec__very_longs__very_long__long_digits2 (us_split_fields5 a)))) (of_array (to_array2 temp___214) (first6 temp___214) (last7 temp___214))))))
...
(define-fun dynamic_invariant9 ((temp___expr_235 (_ BitVec 8)) (temp___is_init_231 Bool) (temp___skip_constant_232 Bool) (temp___do_toplevel_233 Bool) (temp___do_typ_inv_234 Bool)) Bool true)
(declare-fun get_shift_distance ((_ BitVec 8)) Int)
(declare-fun get_shift_distance__function_guard (Int (_ BitVec 8)) Bool)
(assert (forall ((digit (_ BitVec 8))) (! (=> (and (dynamic_invariant9 digit true true true true) (not (= digit #x00))) (dynamic_invariant6 (get_shift_distance digit) true false true true)) :pattern ((get_shift_distance digit)))))
...
(declare-datatypes () ((tS131bP1__ref (mk_tS131bP1__ref (tS131bP1__content tdigit_count_typeB)))))
(define-fun tS131bP1__ref___projection ((a tS131bP1__ref)) tdigit_count_typeB (tS131bP1__content a))
(declare-sort t3 0)
...
(declare-datatypes () ((s131b__ref (mk_s131b__ref (s131b__content us_t3)))))
(define-fun s131b__ref___projection ((a s131b__ref)) us_t3 (s131b__content a))
...
(declare-datatypes () ((t133b__ref (mk_t133b__ref (t133b__content tdigit_count_typeB)))))
(define-fun t133b__ref___projection ((a t133b__ref)) tdigit_count_typeB (t133b__content a))
(declare-sort t4 0)
...
(declare-datatypes () ((t134b__ref (mk_t134b__ref (t134b__content us_t4)))))
(define-fun t134b__ref___projection ((a t134b__ref)) us_t4 (t134b__content a))
...
(declare-datatypes () ((tS135bP1__ref (mk_tS135bP1__ref (tS135bP1__content tdigit_count_typeB)))))
(define-fun tS135bP1__ref___projection ((a tS135bP1__ref)) tdigit_count_typeB (tS135bP1__content a))
(declare-sort t5 0)
...
(declare-datatypes () ((s135b__ref (mk_s135b__ref (s135b__content us_t5)))))
(define-fun s135b__ref___projection ((a s135b__ref)) us_t5 (s135b__content a))
...
(declare-datatypes () ((t137b__ref (mk_t137b__ref (t137b__content tdigit_count_typeB)))))
(define-fun t137b__ref___projection ((a t137b__ref)) tdigit_count_typeB (t137b__content a))
(declare-sort t6 0)
...
(declare-datatypes () ((t138b__ref (mk_t138b__ref (t138b__content us_t6)))))
(define-fun t138b__ref___projection ((a t138b__ref)) us_t6 (t138b__content a))
...
(declare-fun temp___1136 ((_ BitVec 8) Int Int) us_t4)
(declare-fun temp___1149 ((_ BitVec 8) Int Int) us_t6)
(declare-sort t7 0)
...
(assert (forall ((temp___1138 (_ BitVec 8))) (forall ((temp___1139 Int) (temp___1140 Int)) (let ((temp___1137 (temp___1136 temp___1138 temp___1139 temp___1140))) (=> (dynamic_invariant9 temp___1138 true true true true) (and (=> (dynamic_property16 1 65536 temp___1139 temp___1140) (and (= (first10 temp___1137) temp___1139) (= (last11 temp___1137) temp___1140))) (forall ((temp___1141 Int)) (= (to_rep1 (select (to_array4 temp___1137) temp___1141)) temp___1138))))))))
(assert (forall ((temp___1151 (_ BitVec 8))) (forall ((temp___1152 Int) (temp___1153 Int)) (let ((temp___1150 (temp___1149 temp___1151 temp___1152 temp___1153))) (=> (dynamic_invariant9 temp___1151 true true true true) (and (=> (dynamic_property16 1 65536 temp___1152 temp___1153) (and (= (first14 temp___1150) temp___1152) (= (last15 temp___1150) temp___1153))) (forall ((temp___1154 Int)) (= (to_rep1 (select (to_array6 temp___1150) temp___1154)) temp___1151))))))))
(define-fun dynamic_invariant11 ((temp___expr_841 us_t3) (temp___is_init_837 Bool) (temp___skip_constant_838 Bool) (temp___do_toplevel_839 Bool) (temp___do_typ_inv_840 Bool)) Bool (=> (not (= temp___skip_constant_838 true)) (and (dynamic_property9 1 r132b (first8 temp___expr_841) (last9 temp___expr_841)) (and (= (first8 temp___expr_841) 1) (= (last9 temp___expr_841) r132b)))))
(define-fun dynamic_invariant12 ((temp___expr_851 us_t5) (temp___is_init_847 Bool) (temp___skip_constant_848 Bool) (temp___do_toplevel_849 Bool) (temp___do_typ_inv_850 Bool)) Bool (=> (not (= temp___skip_constant_848 true)) (and (dynamic_property13 1 r136b (first12 temp___expr_851) (last13 temp___expr_851)) (and (= (first12 temp___expr_851) 1) (= (last13 temp___expr_851) r136b)))))
...
(declare-const temp___1143 (Array Int octet))
(declare-const temp___11431 t4)
(declare-const temp___1144 (Array Int octet))
(declare-const temp___11441 t3)
(declare-const temp___1146 us_t3)
(declare-const o us_t)
(declare-const o1 us_split_fields)
(declare-const temp___1148 us_rep)
(declare-const temp___1156 us_t6)
(declare-const temp___1157 us_t5)
(declare-const temp___1159 us_t5)
(declare-const o2 us_t)
(declare-const o3 us_split_fields)
(declare-const temp___1161 us_rep)
...
(declare-const very_longs__divide__L_7__R139b__assume Int)
...
(assert (and (= us2 (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 dividend))) 1)) (in_range2 (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 dividend))) 1))))
...
(assert (dynamic_invariant7 (mk___rep1 u__split_discrs (mk___split_fields1 (mk___t1 u__split_fields u__split_fields1))) false false true true))
(assert (and (= us3 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 divisor)))) (in_range2 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 divisor))))))
...
(assert (= (to_rep (rec__very_longs__very_long__length quotient__split_discrs)) r132b))
(assert (in_range2 r132b))
(assert (= (to_rep2 (first9 (rt4 (temp___1136 #x00 1 r132b)))) 1))
(assert (= (to_rep2 (last10 (rt4 (temp___1136 #x00 1 r132b)))) r132b))
(assert (= (mk___t4 temp___1143 temp___11431) (temp___1136 #x00 1 r132b)))
(assert (= (ite (<= (to_rep2 (first9 temp___11431)) (to_rep2 (last10 temp___11431))) (+ (- (to_rep2 (last10 temp___11431)) (to_rep2 (first9 temp___11431))) 1) 0) (ite (<= 1 r132b) (+ (- r132b 1) 1) 0)))
(assert (= temp___1143 temp___1144))
(assert (= (mk3 (to_rep2 (first9 temp___11431)) (to_rep2 (last10 temp___11431))) temp___11441))
(assert (= (ite (<= (to_rep2 (first7 temp___11441)) (to_rep2 (last8 temp___11441))) (+ (- (to_rep2 (last8 temp___11441)) (to_rep2 (first7 temp___11441))) 1) 0) (ite (<= (to_rep2 (first quotient__split_fields1)) (to_rep2 (last quotient__split_fields1))) (+ (- (to_rep2 (last quotient__split_fields1)) (to_rep2 (first quotient__split_fields1))) 1) 0)))
(assert (= temp___1146 (mk___t3 temp___1144 temp___11441)))
(assert (= o (mk___t (elts3 temp___1146) (mk (to_rep2 (first7 (rt3 temp___1146))) (to_rep2 (last8 (rt3 temp___1146)))))))
(assert (= o1 (mk___split_fields o)))
(assert (= temp___1148 (mk___rep quotient__split_discrs o1)))
(assert (= result (mk___split_fields__ref (mk___split_fields (mk___t quotient__split_fields quotient__split_fields1)))))
(assert (= quotient__split_fields2 (us_split_fields1 temp___1148)))
(assert (= quotient__split_discrs (us_split_discrs1 temp___1148)))
(assert (= (to_rep (rec__very_longs__very_long__length remainder__split_discrs)) r136b))
(assert (in_range2 r136b))
(assert (= (to_rep2 (first13 (rt6 (temp___1149 #x00 1 r136b)))) 1))
(assert (= (to_rep2 (last14 (rt6 (temp___1149 #x00 1 r136b)))) r136b))
(assert (= temp___1156 (temp___1149 #x00 1 r136b)))
(assert (= (ite (<= (to_rep2 (first13 (rt6 temp___1156))) (to_rep2 (last14 (rt6 temp___1156)))) (+ (- (to_rep2 (last14 (rt6 temp___1156))) (to_rep2 (first13 (rt6 temp___1156)))) 1) 0) (ite (<= 1 r136b) (+ (- r136b 1) 1) 0)))
(assert (= temp___1157 (mk___t5 (elts6 temp___1156) (mk5 (to_rep2 (first13 (rt6 temp___1156))) (to_rep2 (last14 (rt6 temp___1156)))))))
(assert (= (ite (<= (to_rep2 (first11 (rt5 temp___1157))) (to_rep2 (last12 (rt5 temp___1157)))) (+ (- (to_rep2 (last12 (rt5 temp___1157))) (to_rep2 (first11 (rt5 temp___1157)))) 1) 0) (ite (<= (to_rep2 (first remainder__split_fields1)) (to_rep2 (last remainder__split_fields1))) (+ (- (to_rep2 (last remainder__split_fields1)) (to_rep2 (first remainder__split_fields1))) 1) 0)))
(assert (= temp___1159 temp___1157))
(assert (= o2 (mk___t (elts5 temp___1159) (mk (to_rep2 (first11 (rt5 temp___1159))) (to_rep2 (last12 (rt5 temp___1159)))))))
(assert (= o3 (mk___split_fields o2)))
(assert (= temp___1161 (mk___rep remainder__split_discrs o3)))
(assert (= result1 (mk___split_fields__ref (mk___split_fields (mk___t remainder__split_fields remainder__split_fields1)))))
(assert (= remainder__split_fields2 (us_split_fields1 temp___1161)))
(assert (= remainder__split_discrs (us_split_discrs1 temp___1161)))
(assert (and (= temp___1162 (number_of_digits1 divisor)) (and (in_range3 temp___1162) (and (=> (< 0 temp___1162) (not (= (to_rep1 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 divisor))) temp___1162)) #x00))) (forall ((j3 Int)) (=> (and (<= (+ temp___1162 1) j3) (<= j3 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 divisor))))))) (= (to_rep1 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 divisor))) j3)) #x00)))))))
(assert (and (= us4 temp___1162) (dynamic_property2 1 last2 temp___1162)))
(assert (= o4 temp___1162))
(assert (= result2 (mk_int__ref n)))
(assert (= n1 o4))
(assert (and (= us5 (- (to_rep (rec__very_longs__very_long__length (us_split_discrs1 dividend))) n1)) (dynamic_property3 first2 last3 (- (to_rep (rec__very_longs__very_long__length (us_split_discrs1 dividend))) n1))))
(assert (= o5 (- (to_rep (rec__very_longs__very_long__length (us_split_discrs1 dividend))) n1)))
...
(assert (= o6 n1))
(assert (= o7 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 divisor))) o6)))
...
(assert (dynamic_invariant1 (mk___rep u__split_discrs very_longs__divide__full_left_shift__result__fields) true true true true))
...
(assert (dynamic_invariant1 (mk___rep v__split_discrs very_longs__divide__left_shift__number__fields) true true true true))
...
(assert (and (= very_longs__divide__L_7__R139b__assume (+ m1 1)) (in_range1 (+ m1 1))))
(assert (= very_longs__divide__L_7__R139b__assume r139b))
(assert (in_range1 r139b))
(assert (= result8 (mk_int__ref j)))
(assert (= j1 r139b))
(assert (<= 1 j1))
(assert (<= j1 r139b))
(assert (and (and (dynamic_invariant1 (mk___rep quotient__split_discrs quotient__split_fields3) false true true true) (dynamic_invariant7 (mk___rep1 u__split_discrs u__split_fields3) false true true true)) (and (<= 1 j2) (<= j2 r139b))))
