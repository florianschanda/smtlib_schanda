...
(assert (in_range15 c82b))
(assert (= result8 (mk_map__ref result__1)))
(assert (= result__8 nodescription))
(assert (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE15 c82b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE15 c82b)))))) (= o10 (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE15 c82b))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE15 c82b)))))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE15 c82b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE15 c82b))))))) (= o10 0)))
...
(assert (= keystore__dofind__B86b__thestring__assume (mk___t (concat1 (temp___String_Literal_1788 Tuple0) 1 39 (elts (to_string (attr__ATTRIBUTE_IMAGE15 c82b))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE15 c82b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE15 c82b)))))) (mk 1 o15))))
(assert (= keystore__dofind__B86b__thestring__assume thestring1))
...
(assert (= result9 true))
(assert (not (= (ite (<= (to_rep1 (first (rt thestring1))) (to_rep1 (last (rt thestring1)))) (+ (- (to_rep1 (last (rt thestring1))) (to_rep1 (first (rt thestring1)))) 1) 0) (ite (<= 1 (length thestring1)) (+ (- (length thestring1) 1) 1) 0))))
(check-sat)
(exit)
