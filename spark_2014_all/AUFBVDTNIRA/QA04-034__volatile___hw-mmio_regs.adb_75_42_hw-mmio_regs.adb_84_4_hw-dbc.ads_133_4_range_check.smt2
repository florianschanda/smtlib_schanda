...
(define-fun dynamic_invariant4 ((temp___expr_776 Int) (temp___is_init_772 Bool) (temp___skip_constant_773 Bool) (temp___do_toplevel_774 Bool) (temp___do_typ_inv_775 Bool)) Bool (=> (or (= temp___is_init_772 true) (<= 0 3)) (in_range3 temp___expr_776)))
...
(define-fun dynamic_invariant5 ((temp___expr_871 (_ BitVec 16)) (temp___is_init_867 Bool) (temp___skip_constant_868 Bool) (temp___do_toplevel_869 Bool) (temp___do_typ_inv_870 Bool)) Bool true)
...
(assert (forall ((temp___165 us_rep) (temp___166 us_rep) (temp___167 us_rep) (temp___168 us_rep)) (let ((temp___164 (hw__dbc__op_reg_descs__aggregate_def temp___165 temp___166 temp___167 temp___168))) (and (and (and (= (select temp___164 0) temp___165) (= (select temp___164 1) temp___166)) (= (select temp___164 2) temp___167)) (= (select temp___164 3) temp___168)))))
...
(assert (= o5 (bvsub o4 (bvshl #x0000000000000001 ((_ int2bv 64) (to_rep (rec__hw__dbc__op_s_regs__t__lsb (us_split_fields1 (select regs idx)))))))))
(assert (= o6 o5))
(assert (= result mask))
(assert (= mask1 o6))
...
(assert (not (bvule ((_ zero_extend 32) #x00000000) (bvor (bvand ((_ zero_extend 32) temp) (bvnot mask1)) (bvshl ((_ zero_extend 48) value) ((_ int2bv 64) (to_rep (rec__hw__dbc__op_s_regs__t__lsb (us_split_fields1 (select regs idx))))))))))
(check-sat)
(exit)
