...
(define-fun dynamic_invariant1 ((temp___expr_314 (_ BitVec 64)) (temp___is_init_311 Bool) (temp___skip_constant_312 Bool) (temp___do_toplevel_313 Bool)) Bool true)
...
(define-fun dynamic_invariant2 ((temp___expr_535 (_ BitVec 32)) (temp___is_init_532 Bool) (temp___skip_constant_533 Bool) (temp___do_toplevel_534 Bool)) Bool true)
...
(define-fun dynamic_invariant3 ((temp___expr_541 Int) (temp___is_init_538 Bool) (temp___skip_constant_539 Bool) (temp___do_toplevel_540 Bool)) Bool (=> (or (= temp___is_init_538 true) (<= 0 16383)) (in_range2 temp___expr_541)))
...
(define-fun index_t__ref___3__projection ((a index_t__ref1)) index_t1 (index_t__content1 a))
(define-fun dynamic_invariant4 ((temp___expr_683 Int) (temp___is_init_680 Bool) (temp___skip_constant_681 Bool) (temp___do_toplevel_682 Bool)) Bool (=> (or (= temp___is_init_680 true) (<= 0 3)) (in_range3 temp___expr_683)))
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__hw__dbc__op_s_regs__t__byte_offset natural) (rec__hw__dbc__op_s_regs__t__msb natural) (rec__hw__dbc__op_s_regs__t__lsb natural)))))
(define-fun us_split_fields_Byte_Offset__2__projection ((a us_split_fields)) natural (rec__hw__dbc__op_s_regs__t__byte_offset a))
(define-fun us_split_fields_MSB__2__projection ((a us_split_fields)) natural (rec__hw__dbc__op_s_regs__t__msb a))
(define-fun us_split_fields_LSB__2__projection ((a us_split_fields)) natural (rec__hw__dbc__op_s_regs__t__lsb a))
...
(define-fun bool_eq1 ((a us_rep) (b us_rep)) Bool (ite (and (and (= (to_rep (rec__hw__dbc__op_s_regs__t__byte_offset (us_split_fields1 a))) (to_rep (rec__hw__dbc__op_s_regs__t__byte_offset (us_split_fields1 b)))) (= (to_rep (rec__hw__dbc__op_s_regs__t__msb (us_split_fields1 a))) (to_rep (rec__hw__dbc__op_s_regs__t__msb (us_split_fields1 b))))) (= (to_rep (rec__hw__dbc__op_s_regs__t__lsb (us_split_fields1 a))) (to_rep (rec__hw__dbc__op_s_regs__t__lsb (us_split_fields1 b))))) true false))
...
(declare-const hw__dbc__op_s_regs__t__byte_offset__first__bit Int)
(declare-const hw__dbc__op_s_regs__t__byte_offset__last__bit Int)
(declare-const hw__dbc__op_s_regs__t__byte_offset__position Int)
(assert (<= 0 hw__dbc__op_s_regs__t__byte_offset__first__bit))
(assert (< hw__dbc__op_s_regs__t__byte_offset__first__bit hw__dbc__op_s_regs__t__byte_offset__last__bit))
(assert (<= 0 hw__dbc__op_s_regs__t__byte_offset__position))
(declare-const hw__dbc__op_s_regs__t__msb__first__bit Int)
(declare-const hw__dbc__op_s_regs__t__msb__last__bit Int)
(declare-const hw__dbc__op_s_regs__t__msb__position Int)
(assert (<= 0 hw__dbc__op_s_regs__t__msb__first__bit))
(assert (< hw__dbc__op_s_regs__t__msb__first__bit hw__dbc__op_s_regs__t__msb__last__bit))
(assert (<= 0 hw__dbc__op_s_regs__t__msb__position))
(declare-const hw__dbc__op_s_regs__t__lsb__first__bit Int)
(declare-const hw__dbc__op_s_regs__t__lsb__last__bit Int)
(declare-const hw__dbc__op_s_regs__t__lsb__position Int)
(assert (<= 0 hw__dbc__op_s_regs__t__lsb__first__bit))
(assert (< hw__dbc__op_s_regs__t__lsb__first__bit hw__dbc__op_s_regs__t__lsb__last__bit))
(assert (<= 0 hw__dbc__op_s_regs__t__lsb__position))
(declare-fun user_eq7 (us_rep us_rep) Bool)
(declare-const dummy7 us_rep)
(declare-datatypes () ((t__ref2 (mk_t__ref2 (t__content2 us_rep)))))
(define-fun t__ref___2__projection ((a t__ref2)) us_rep (t__content2 a))
...
(define-fun bool_eq2 ((a (Array Int us_rep)) (a__first Int) (a__last Int) (b (Array Int us_rep)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_141 Int)) (=> (and (<= a__first temp___idx_141) (<= temp___idx_141 a__last)) (= (bool_eq1 (select a temp___idx_141) (select b (+ (- b__first a__first) temp___idx_141))) true)))) true false))
(assert (forall ((a (Array Int us_rep)) (b (Array Int us_rep))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq2 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_141 Int)) (=> (and (<= a__first temp___idx_141) (<= temp___idx_141 a__last)) (= (bool_eq1 (select a temp___idx_141) (select b (+ (- b__first a__first) temp___idx_141))) true))))))))
(declare-const op_reg_descs (Array Int us_rep))
...
(define-fun word_t__ref___14__projection ((a word_t__ref)) word_t (word_t__content a))
(define-fun dynamic_invariant5 ((temp___expr_770 (_ BitVec 16)) (temp___is_init_767 Bool) (temp___skip_constant_768 Bool) (temp___do_toplevel_769 Bool)) Bool true)
...
(declare-fun hw__dbc__op_reg_descs__aggregate_def (us_rep us_rep us_rep us_rep) (Array Int us_rep))
(assert (forall ((temp___143 us_rep) (temp___144 us_rep) (temp___145 us_rep) (temp___146 us_rep)) (let ((temp___142 (hw__dbc__op_reg_descs__aggregate_def temp___143 temp___144 temp___145 temp___146))) (and (and (and (= (select temp___142 0) temp___143) (= (select temp___142 1) temp___144)) (= (select temp___142 2) temp___145)) (= (select temp___142 3) temp___146)))))
(assert (= op_reg_descs (hw__dbc__op_reg_descs__aggregate_def (mk___rep (mk___split_fields (of_rep 0) (of_rep 0) (of_rep 0))) (mk___rep (mk___split_fields (of_rep 0) (of_rep 1) (of_rep 1))) (mk___rep (mk___split_fields (of_rep 4) (of_rep 0) (of_rep 0))) (mk___rep (mk___split_fields (of_rep 4) (of_rep 11) (of_rep 11))))))
(define-fun dynamic_invariant7 ((temp___expr_308 (_ BitVec 32)) (temp___is_init_305 Bool) (temp___skip_constant_306 Bool) (temp___do_toplevel_307 Bool)) Bool true)
(assert (= regs op_reg_descs))
(declare-const byte_offset Int)
(declare-const mask (_ BitVec 64))
(declare-const temp (_ BitVec 32))
(declare-const o Int)
(declare-const o1 Int)
(declare-const hw__dbc__op_regs__write_i__2__off__assume Int)
...
(assert (= op_reg_descs regs))
(assert (in_range1 byte_offset))
(assert (in_range3 idx))
(assert true)
(assert (and (= o (+ byte_offset (to_rep (rec__hw__dbc__op_s_regs__t__byte_offset (us_split_fields1 (select regs idx)))))) (in_range (+ byte_offset (to_rep (rec__hw__dbc__op_s_regs__t__byte_offset (us_split_fields1 (select regs idx))))))))
(assert (= o1 (div1 o 4)))
(assert (and (= hw__dbc__op_regs__write_i__2__off__assume o1) (in_range2 o1)))
(assert (= hw__dbc__op_regs__write_i__2__off__assume off))
(assert (in_range2 off))
(assert (and (= o2 (+ (to_rep (rec__hw__dbc__op_s_regs__t__msb (us_split_fields1 (select regs idx)))) 1)) (in_range (+ (to_rep (rec__hw__dbc__op_s_regs__t__msb (us_split_fields1 (select regs idx)))) 1))))
(assert (= o3 ((_ int2bv 64) o2)))
(assert (= o4 (bvshl ((_ int2bv 64) 1) o3)))
(assert (= o5 (bvsub o4 (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) (to_rep (rec__hw__dbc__op_s_regs__t__lsb (us_split_fields1 (select regs idx)))))))))
(assert (= o6 o5))
(assert (= result mask))
(assert (= mask1 o6))
(assert true)
(assert true)
(assert (and (= o7 (- (to_rep (rec__hw__dbc__op_s_regs__t__msb (us_split_fields1 (select regs idx)))) (to_rep (rec__hw__dbc__op_s_regs__t__lsb (us_split_fields1 (select regs idx)))))) (in_range (- (to_rep (rec__hw__dbc__op_s_regs__t__msb (us_split_fields1 (select regs idx)))) (to_rep (rec__hw__dbc__op_s_regs__t__lsb (us_split_fields1 (select regs idx))))))))
(assert (= o8 (+ o7 1)))
(assert (and (= o9 o8) (in_range o8)))
(assert (= result1 (ite (= o9 32) true false)))
(assert (not (= result1 true)))
(assert true)
(assert (not (bvule ((_ zero_extend 32) ((_ int2bv 32) 0)) (bvor (bvand ((_ zero_extend 32) temp1) (bvnot mask1)) (bvshl ((_ zero_extend 48) value) ((_ int2bv 64) (to_rep (rec__hw__dbc__op_s_regs__t__lsb (us_split_fields1 (select regs idx))))))))))
(check-sat)
(exit)
