...
(assert (= (to_rep1 (first9 (rt4 (temp_____aggregate_def_1136 #x00 1 r132b)))) 1))
(assert (= (to_rep1 (last10 (rt4 (temp_____aggregate_def_1136 #x00 1 r132b)))) r132b))
(assert (= (mk___t4 temp___1143 temp___11431) (temp_____aggregate_def_1136 #x00 1 r132b)))
(assert (= (ite (<= (to_rep1 (first9 temp___11431)) (to_rep1 (last10 temp___11431))) (+ (- (to_rep1 (last10 temp___11431)) (to_rep1 (first9 temp___11431))) 1) 0) (ite (<= 1 r132b) (+ (- r132b 1) 1) 0)))
...
(assert (in_range1 r136b))
(assert (= (to_rep1 (first13 (rt6 (temp_____aggregate_def_1149 #x00 1 r136b)))) 1))
(assert (= (to_rep1 (last14 (rt6 (temp_____aggregate_def_1149 #x00 1 r136b)))) r136b))
(assert (= temp___1156 (temp_____aggregate_def_1149 #x00 1 r136b)))
(assert (= (ite (<= (to_rep1 (first13 (rt6 temp___1156))) (to_rep1 (last14 (rt6 temp___1156)))) (+ (- (to_rep1 (last14 (rt6 temp___1156))) (to_rep1 (first13 (rt6 temp___1156)))) 1) 0) (ite (<= 1 r136b) (+ (- r136b 1) 1) 0)))
...
(assert (and (= very_longs__divide__L_7__R139b__assume (+ m1 1)) (in_range2 (+ m1 1))))
...
(assert (<= 1 j1))
(assert (<= j1 r139b))
(assert (and (and (dynamic_invariant1 (mk___rep quotient__split_discrs quotient__split_fields3) false true true true) (dynamic_invariant5 (mk___rep1 u__split_discrs u__split_fields3) false true true true)) (and (<= 1 j2) (<= j2 r139b))))
