...
(assert (= (valid_configuration__2 cur_state cur_piece__split_fields4 cur_board) true))
(assert (= result4 (mk_bool__ref redraw_current_piece1)))
(assert (= redraw_current_piece2 (distinct 1 0)))
(assert (not (= success true)))
(assert (= result5 (mk_int__ref cur_state)))
(assert (= cur_state1 1))
(assert (and (and (= (get_state cur_state2) 2) (= (valid_configuration__2 cur_state2 cur_piece__split_fields4 cur_board1) true)) (in_range8 cur_state2)))
(assert (not (= (valid_configuration__2 cur_state2 cur_piece__split_fields4 cur_board1) true)))
(check-sat)
(exit)
