...
(assert (= cur_state1 1))
(assert (and (and (= (get_state cur_state2) 2) (= (valid_configuration__2 cur_state2 cur_piece__split_fields4 cur_board1) true)) (in_range9 cur_state2)))
(assert (not (= (get_state cur_state2) 2)))
(check-sat)
(exit)
