...
(declare-fun user_eq1 (index_number index_number) Bool)
(declare-const dummy1 index_number)
...
(declare-const dummy4 lane_type)
...
(assert (forall ((x states)) (! (in_range3 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(assert (forall ((x byte_absorption_number)) (! (in_range4 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(assert (forall ((x rate_number)) (! (in_range6 (to_rep6 x)) :pattern ((to_rep6 x)))))
...
(define-fun dynamic_invariant1 ((temp___expr_413 Int) (temp___is_init_409 Bool) (temp___skip_constant_410 Bool) (temp___do_toplevel_411 Bool) (temp___do_typ_inv_412 Bool)) Bool (=> (or (= temp___is_init_409 true) (<= 0 1)) (in_range3 temp___expr_413)))
...
(define-fun dynamic_invariant2 ((temp___expr_46 Int) (temp___is_init_42 Bool) (temp___skip_constant_43 Bool) (temp___do_toplevel_44 Bool) (temp___do_typ_inv_45 Bool)) Bool (=> (or (= temp___is_init_42 true) (<= 1 2147483647)) (in_range7 temp___expr_46)))
(assert (forall ((ctx us_rep)) (! (let ((result (rate_of ctx))) (and (< result 1600) (dynamic_invariant2 result true false true true))) :pattern ((rate_of ctx)))))
...
(assert (forall ((i tTnext_blockSP1)) (and (<= 0 (tTnext_blockSP1qtint i)) (<= (tTnext_blockSP1qtint i) 199))))
...
(declare-datatypes () ((tTnext_blockSP1__ref (mk_tTnext_blockSP1__ref (tTnext_blockSP1__content tTnext_blockSP1)))))
(define-fun tTnext_blockSP1__ref___projection ((a tTnext_blockSP1__ref)) tTnext_blockSP1 (tTnext_blockSP1__content a))
...
(declare-datatypes () ((t115s__ref (mk_t115s__ref (t115s__content integer)))))
(define-fun t115s__ref___projection ((a t115s__ref)) integer (t115s__content a))
(declare-sort t1 0)
...
(declare-const r119s Int)
(declare-const attr__ATTRIBUTE_ADDRESS4 Int)
(declare-const r122s Int)
...
(declare-datatypes () ((t120s__ref (mk_t120s__ref (t120s__content integer)))))
(define-fun t120s__ref___projection ((a t120s__ref)) integer (t120s__content a))
(declare-sort t2 0)
...
(declare-datatypes () ((t123s__ref (mk_t123s__ref (t123s__content integer)))))
(define-fun t123s__ref___projection ((a t123s__ref)) integer (t123s__content a))
(declare-sort t3 0)
...
(declare-datatypes () ((t126s__ref (mk_t126s__ref (t126s__content integer)))))
(define-fun t126s__ref___projection ((a t126s__ref)) integer (t126s__content a))
(declare-sort t4 0)
...
(declare-datatypes () ((t129s__ref (mk_t129s__ref (t129s__content integer)))))
(define-fun t129s__ref___projection ((a t129s__ref)) integer (t129s__content a))
(declare-sort t5 0)
...
(declare-datatypes () ((t132s__ref (mk_t132s__ref (t132s__content integer)))))
(define-fun t132s__ref___projection ((a t132s__ref)) integer (t132s__content a))
(declare-sort t6 0)
...
(declare-fun temp_____aggregate_def_1060 ((_ BitVec 8)) (Array Int byte))
...
(define-fun dynamic_invariant4 ((temp___expr_293 Int) (temp___is_init_289 Bool) (temp___skip_constant_290 Bool) (temp___do_toplevel_291 Bool) (temp___do_typ_inv_292 Bool)) Bool (=> (or (= temp___is_init_289 true) (<= 0 2147483647)) (in_range2 temp___expr_293)))
...
(define-fun dynamic_invariant6 ((temp___expr_444 Int) (temp___is_init_440 Bool) (temp___skip_constant_441 Bool) (temp___do_toplevel_442 Bool) (temp___do_typ_inv_443 Bool)) Bool (=> (or (= temp___is_init_440 true) (<= 1 199)) (in_range6 temp___expr_444)))
(define-fun dynamic_invariant7 ((temp___expr_420 Int) (temp___is_init_416 Bool) (temp___skip_constant_417 Bool) (temp___do_toplevel_418 Bool) (temp___do_typ_inv_419 Bool)) Bool (=> (or (= temp___is_init_416 true) (<= 0 199)) (in_range4 temp___expr_420)))
(define-fun dynamic_invariant8 ((temp___expr_437 Int) (temp___is_init_433 Bool) (temp___skip_constant_434 Bool) (temp___do_toplevel_435 Bool) (temp___do_typ_inv_436 Bool)) Bool (=> (or (= temp___is_init_433 true) (<= 0 1599)) (in_range5 temp___expr_437)))
(assert (forall ((temp___1051 (_ BitVec 8))) (=> (dynamic_invariant3 temp___1051 true true true true) (forall ((temp___1052 Int)) (= (to_rep1 (select (keccak__keccak_1600__sponge__finalize__next_block__aggregate_def temp___1051) temp___1052)) temp___1051)))))
(assert (forall ((temp___1062 (_ BitVec 8))) (=> (dynamic_invariant3 temp___1062 true true true true) (forall ((temp___1063 Int)) (= (to_rep1 (select (temp_____aggregate_def_1060 temp___1062) temp___1063)) temp___1062)))))
...
(declare-const next_block (Array Int byte))
(declare-const o Int)
(declare-const o1 (Array Int byte))
(declare-const temp___1055 (Array Int byte))
(declare-const temp___10551 t1)
(declare-const o2 (Array Int byte))
(declare-const o3 t)
(declare-const o4 Int)
(declare-const o5 (Array Int byte))
(declare-const keccak__padding__pad101_multi_blocks__next_block__compl (Array Int byte))
(declare-const keccak__padding__pad101_multi_blocks__next_block__compl1 t3)
(declare-const o6 (Array Int byte))
(declare-const keccak__padding__pad101_multi_blocks__first_block__compl (Array Int byte))
(declare-const keccak__padding__pad101_multi_blocks__first_block__compl1 t2)
...
(declare-const o15 bit_absorption_number)
(declare-const o16 byte_absorption_number)
(declare-const o17 rate_number)
(declare-const o18 states)
(declare-const temp___1075 map1)
(declare-const temp___10751 (Array Int byte))
(declare-const temp___10752 bit_absorption_number)
(declare-const temp___10753 byte_absorption_number)
(declare-const temp___10754 rate_number)
(declare-const temp___10755 states)
(declare-const o19 (Array Int byte))
(declare-const o20 (Array Int byte))
(declare-const temp___1082 (Array Int byte))
(declare-const temp___10821 t4)
(declare-const o21 (Array Int byte))
(declare-const o22 t)
(declare-const o23 Int)
(declare-const o24 (Array Int byte))
(declare-const temp___1088 (Array Int byte))
(declare-const temp___10881 t5)
(declare-const o25 (Array Int byte))
(declare-const o26 t)
...
(declare-const keccak__keccak_1600__keccakf_1600_lanes__extract_bytes__data__compl1 t6)
(declare-const o29 integer)
(declare-const o30 integer)
(declare-const o31 (Array Int byte))
(declare-const o32 map1)
(declare-const o33 (Array Int byte))
(declare-const o34 bit_absorption_number)
(declare-const o35 byte_absorption_number)
(declare-const o36 rate_number)
(declare-const o37 states)
(declare-const temp___1100 map1)
(declare-const temp___11001 (Array Int byte))
(declare-const temp___11002 bit_absorption_number)
(declare-const temp___11003 byte_absorption_number)
(declare-const temp___11004 rate_number)
(declare-const temp___11005 states)
(declare-const o38 states)
(declare-const o39 map1)
(declare-const o40 (Array Int byte))
(declare-const o41 bit_absorption_number)
(declare-const o42 byte_absorption_number)
(declare-const o43 rate_number)
(declare-const o44 states)
(declare-const temp___1106 map1)
(declare-const temp___11061 (Array Int byte))
(declare-const temp___11062 bit_absorption_number)
(declare-const temp___11063 byte_absorption_number)
(declare-const temp___11064 rate_number)
(declare-const temp___11065 states)
(declare-const ctx__split_fields6 us_split_fields)
(declare-const result map__ref)
(declare-const next_block1 (Array Int byte))
...
(declare-const spilled Bool)
(declare-const keccak__padding__pad101_multi_blocks__next_block (Array Int byte))
(declare-const keccak__padding__pad101_multi_blocks__first_block (Array Int byte))
...
(declare-const next_block2 (Array Int byte))
...
(declare-const keccak__keccak_1600__keccakf_1600_lanes__xor_bits_into_state__a2 map1)
...
(declare-const next_block3 map__ref)
(declare-const spilled1 bool__ref)
(declare-const ctx__split_fields21 us_split_fields)
(declare-const next_block4 (Array Int byte))
(declare-const spilled2 Bool)
(assert (= result (mk_map__ref next_block)))
(assert (= next_block1 (keccak__keccak_1600__sponge__finalize__next_block__aggregate_def #x00)))
(assert (and (= o (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5)))) (and (in_range7 o) (and (= o (* (to_rep6 ctx__split_fields4) 8)) (< o 1600)))))
...
(assert (=> (= result1 true) (and (= o4 (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5)))) (and (in_range7 o4) (and (= o4 (* (to_rep6 ctx__split_fields4) 8)) (< o4 1600))))))
(assert (=> (= result1 true) (=> (<= 0 r114s) (and (and (<= 0 0) (<= 0 199)) (and (<= 0 r114s) (<= r114s 199))))))
(assert (=> (= result1 true) (= o1 ctx__split_fields1)))
(assert (=> (= result1 true) (= o1 temp___1055)))
(assert (=> (= result1 true) (= (mk1 0 r114s) temp___10551)))
(assert (=> (= result1 true) (= temp___1055 o2)))
(assert (=> (= result1 true) (= (mk (to_rep (first2 temp___10551)) (to_rep (last2 temp___10551))) o3)))
(assert (=> (= result1 true) (= result2 (mk___split_fields__ref (mk___split_fields ctx__split_fields ctx__split_fields1 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5)))))
(assert (=> (= result1 true) (= ctx__split_fields7 (mk___split_fields keccak__keccak_1600__keccakf_1600_lanes__xor_bits_into_state__a ctx__split_fields1 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5))))
(assert (=> (= result1 true) (= result3 (mk___split_fields__ref ctx__split_fields7))))
(assert (=> (= result1 true) (= ctx__split_fields8 (mk___split_fields keccak__keccak_1600__keccakf_1600_permutation__permute__a (rec__keccak__keccak_1600__sponge__context__block ctx__split_fields7) (rec__keccak__keccak_1600__sponge__context__bits_absorbed ctx__split_fields7) (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields7) (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields7) (rec__keccak__keccak_1600__sponge__context__curr_state ctx__split_fields7)))))
(assert (=> (= result1 true) (= result4 (mk___split_fields__ref ctx__split_fields8))))
(assert (=> (= result1 true) (= ctx__split_fields9 (mk___split_fields (rec__keccak__keccak_1600__sponge__context__state ctx__split_fields8) (temp_____aggregate_def_1060 #x00) (rec__keccak__keccak_1600__sponge__context__bits_absorbed ctx__split_fields8) (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields8) (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields8) (rec__keccak__keccak_1600__sponge__context__curr_state ctx__split_fields8)))))
(assert (=> (= result1 true) (= result5 (mk___split_fields__ref ctx__split_fields9))))
(assert (=> (= result1 true) (= ctx__split_fields10 (mk___split_fields (rec__keccak__keccak_1600__sponge__context__state ctx__split_fields9) (rec__keccak__keccak_1600__sponge__context__block ctx__split_fields9) rliteral (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields9) (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields9) (rec__keccak__keccak_1600__sponge__context__curr_state ctx__split_fields9)))))
(assert (=> (not (= result1 true)) (= ctx__split_fields10 (mk___split_fields ctx__split_fields ctx__split_fields1 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5))))
(assert (=> (not (= result1 true)) (= ctx__split_fields10 ctx__split_fields6)))
(assert (= (- (to_rep6 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields10)) 1) r119s))
(assert (in_range1 r119s))
(assert (= (- (to_rep6 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields10)) 1) r122s))
(assert (in_range1 r122s))
(assert (=> (<= 0 r122s) (and (and (<= 0 0) (<= 0 199)) (and (<= 0 r122s) (<= r122s 199)))))
(assert (= o5 next_block1))
(assert (= o5 keccak__padding__pad101_multi_blocks__next_block__compl))
(assert (= (mk3 0 r122s) keccak__padding__pad101_multi_blocks__next_block__compl1))
(assert (=> (<= 0 r119s) (and (and (<= 0 0) (<= 0 199)) (and (<= 0 r119s) (<= r119s 199)))))
(assert (= o6 (rec__keccak__keccak_1600__sponge__context__block ctx__split_fields10)))
(assert (= o6 keccak__padding__pad101_multi_blocks__first_block__compl))
(assert (= (mk2 0 r119s) keccak__padding__pad101_multi_blocks__first_block__compl1))
(assert (= (to_rep o11) (to_rep (last6 keccak__padding__pad101_multi_blocks__next_block__compl1))))
(assert (= (to_rep o10) (to_rep (first6 keccak__padding__pad101_multi_blocks__next_block__compl1))))
(assert (and (= o9 (rate_of (mk___rep ctx__split_fields10))) (and (in_range7 o9) (and (= o9 (* (to_rep6 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields10)) 8)) (< o9 1600)))))
(assert (= (to_rep o8) (to_rep (last4 keccak__padding__pad101_multi_blocks__first_block__compl1))))
(assert (= (to_rep o7) (to_rep (first4 keccak__padding__pad101_multi_blocks__first_block__compl1))))
(assert (= (= spilled true) (< o9 (+ (to_rep5 (rec__keccak__keccak_1600__sponge__context__bits_absorbed ctx__split_fields10)) 2))))
(assert (forall ((temp___1073 Int)) (ite (and (<= 0 temp___1073) (<= temp___1073 r119s)) (= (select o12 temp___1073) (select (slide keccak__padding__pad101_multi_blocks__first_block (to_rep (first (mk (to_rep (first4 keccak__padding__pad101_multi_blocks__first_block__compl1)) (to_rep (last4 keccak__padding__pad101_multi_blocks__first_block__compl1))))) 0) temp___1073)) (= (select o12 temp___1073) (select (rec__keccak__keccak_1600__sponge__context__block ctx__split_fields10) temp___1073)))))
(assert (= (rec__keccak__keccak_1600__sponge__context__state ctx__split_fields10) o13))
(assert (= o12 o14))
(assert (= (rec__keccak__keccak_1600__sponge__context__bits_absorbed ctx__split_fields10) o15))
(assert (= (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields10) o16))
(assert (= (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields10) o17))
(assert (= (rec__keccak__keccak_1600__sponge__context__curr_state ctx__split_fields10) o18))
(assert (= temp___1075 o13))
(assert (= temp___10751 o14))
(assert (= temp___10752 o15))
(assert (= temp___10753 o16))
(assert (= temp___10754 o17))
(assert (= temp___10755 o18))
(assert (= result6 (mk___split_fields__ref ctx__split_fields10)))
(assert (= ctx__split_fields11 (mk___split_fields temp___1075 temp___10751 temp___10752 temp___10753 temp___10754 temp___10755)))
(assert (forall ((temp___1079 Int)) (ite (and (<= 0 temp___1079) (<= temp___1079 r122s)) (= (select o19 temp___1079) (select (slide keccak__padding__pad101_multi_blocks__next_block (to_rep (first (mk (to_rep (first6 keccak__padding__pad101_multi_blocks__next_block__compl1)) (to_rep (last6 keccak__padding__pad101_multi_blocks__next_block__compl1))))) 0) temp___1079)) (= (select o19 temp___1079) (select next_block1 temp___1079)))))
(assert (= result7 (mk_map__ref next_block1)))
(assert (= next_block2 o19))
(assert (= (- (to_rep6 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields11)) 1) r125s))
(assert (in_range1 r125s))
(assert (and (= o23 (rate_of (mk___rep ctx__split_fields11))) (and (in_range7 o23) (and (= o23 (* (to_rep6 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields11)) 8)) (< o23 1600)))))
(assert (=> (<= 0 r125s) (and (and (<= 0 0) (<= 0 199)) (and (<= 0 r125s) (<= r125s 199)))))
(assert (= o20 (rec__keccak__keccak_1600__sponge__context__block ctx__split_fields11)))
(assert (= o20 temp___1082))
(assert (= (mk4 0 r125s) temp___10821))
(assert (= temp___1082 o21))
(assert (= (mk (to_rep (first8 temp___10821)) (to_rep (last8 temp___10821))) o22))
(assert (= result8 (mk___split_fields__ref ctx__split_fields11)))
(assert (= ctx__split_fields12 (mk___split_fields keccak__keccak_1600__keccakf_1600_lanes__xor_bits_into_state__a1 (rec__keccak__keccak_1600__sponge__context__block ctx__split_fields11) (rec__keccak__keccak_1600__sponge__context__bits_absorbed ctx__split_fields11) (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields11) (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields11) (rec__keccak__keccak_1600__sponge__context__curr_state ctx__split_fields11))))
(assert (= result9 (mk___split_fields__ref ctx__split_fields12)))
(assert (= ctx__split_fields13 (mk___split_fields keccak__keccak_1600__keccakf_1600_permutation__permute__a1 (rec__keccak__keccak_1600__sponge__context__block ctx__split_fields12) (rec__keccak__keccak_1600__sponge__context__bits_absorbed ctx__split_fields12) (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields12) (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields12) (rec__keccak__keccak_1600__sponge__context__curr_state ctx__split_fields12))))
(assert (=> (= spilled true) (= (- (to_rep6 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields13)) 1) r128s)))
(assert (=> (= spilled true) (in_range1 r128s)))
(assert (=> (= spilled true) (and (= o27 (rate_of (mk___rep ctx__split_fields13))) (and (in_range7 o27) (and (= o27 (* (to_rep6 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields13)) 8)) (< o27 1600))))))
(assert (=> (= spilled true) (=> (<= 0 r128s) (and (and (<= 0 0) (<= 0 199)) (and (<= 0 r128s) (<= r128s 199))))))
(assert (=> (= spilled true) (= o24 next_block2)))
(assert (=> (= spilled true) (= o24 temp___1088)))
(assert (=> (= spilled true) (= (mk5 0 r128s) temp___10881)))
(assert (=> (= spilled true) (= temp___1088 o25)))
(assert (=> (= spilled true) (= (mk (to_rep (first10 temp___10881)) (to_rep (last10 temp___10881))) o26)))
(assert (=> (= spilled true) (= result10 (mk___split_fields__ref ctx__split_fields13))))
(assert (=> (= spilled true) (= ctx__split_fields14 (mk___split_fields keccak__keccak_1600__keccakf_1600_lanes__xor_bits_into_state__a2 (rec__keccak__keccak_1600__sponge__context__block ctx__split_fields13) (rec__keccak__keccak_1600__sponge__context__bits_absorbed ctx__split_fields13) (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields13) (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields13) (rec__keccak__keccak_1600__sponge__context__curr_state ctx__split_fields13)))))
(assert (=> (= spilled true) (= result11 (mk___split_fields__ref ctx__split_fields14))))
(assert (=> (= spilled true) (= ctx__split_fields15 (mk___split_fields keccak__keccak_1600__keccakf_1600_permutation__permute__a2 (rec__keccak__keccak_1600__sponge__context__block ctx__split_fields14) (rec__keccak__keccak_1600__sponge__context__bits_absorbed ctx__split_fields14) (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields14) (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields14) (rec__keccak__keccak_1600__sponge__context__curr_state ctx__split_fields14)))))
(assert (=> (not (= spilled true)) (= ctx__split_fields15 ctx__split_fields13)))
(assert (= (- (to_rep6 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields15)) 1) r131s))
(assert (in_range1 r131s))
(assert (=> (<= 0 r131s) (and (and (<= 0 0) (<= 0 199)) (and (<= 0 r131s) (<= r131s 199)))))
(assert (= o28 (rec__keccak__keccak_1600__sponge__context__block ctx__split_fields15)))
(assert (= o28 keccak__keccak_1600__keccakf_1600_lanes__extract_bytes__data__compl))
(assert (= (mk6 0 r131s) keccak__keccak_1600__keccakf_1600_lanes__extract_bytes__data__compl1))
(assert (= (to_rep o30) (to_rep (last12 keccak__keccak_1600__keccakf_1600_lanes__extract_bytes__data__compl1))))
(assert (= (to_rep o29) (to_rep (first12 keccak__keccak_1600__keccakf_1600_lanes__extract_bytes__data__compl1))))
(assert (forall ((temp___1098 Int)) (ite (and (<= 0 temp___1098) (<= temp___1098 r131s)) (= (select o31 temp___1098) (select (slide keccak__keccak_1600__keccakf_1600_lanes__extract_bytes__data (to_rep (first (mk (to_rep (first12 keccak__keccak_1600__keccakf_1600_lanes__extract_bytes__data__compl1)) (to_rep (last12 keccak__keccak_1600__keccakf_1600_lanes__extract_bytes__data__compl1))))) 0) temp___1098)) (= (select o31 temp___1098) (select (rec__keccak__keccak_1600__sponge__context__block ctx__split_fields15) temp___1098)))))
(assert (= (rec__keccak__keccak_1600__sponge__context__state ctx__split_fields15) o32))
(assert (= o31 o33))
(assert (= (rec__keccak__keccak_1600__sponge__context__bits_absorbed ctx__split_fields15) o34))
(assert (= (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields15) o35))
(assert (= (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields15) o36))
(assert (= (rec__keccak__keccak_1600__sponge__context__curr_state ctx__split_fields15) o37))
(assert (= temp___1100 o32))
(assert (= temp___11001 o33))
(assert (= temp___11002 o34))
(assert (= temp___11003 o35))
(assert (= temp___11004 o36))
(assert (= temp___11005 o37))
(assert (= result12 (mk___split_fields__ref ctx__split_fields15)))
(assert (= ctx__split_fields16 (mk___split_fields temp___1100 temp___11001 temp___11002 temp___11003 temp___11004 temp___11005)))
(assert (= result13 (mk___split_fields__ref ctx__split_fields16)))
(assert (= ctx__split_fields17 (mk___split_fields (rec__keccak__keccak_1600__sponge__context__state ctx__split_fields16) (rec__keccak__keccak_1600__sponge__context__block ctx__split_fields16) rliteral (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields16) (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields16) (rec__keccak__keccak_1600__sponge__context__curr_state ctx__split_fields16))))
(assert (= result14 (mk___split_fields__ref ctx__split_fields17)))
(assert (= ctx__split_fields18 (mk___split_fields (rec__keccak__keccak_1600__sponge__context__state ctx__split_fields17) (rec__keccak__keccak_1600__sponge__context__block ctx__split_fields17) (rec__keccak__keccak_1600__sponge__context__bits_absorbed ctx__split_fields17) rliteral1 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields17) (rec__keccak__keccak_1600__sponge__context__curr_state ctx__split_fields17))))
(assert (= (to_rep3 o38) 1))
(assert (= (rec__keccak__keccak_1600__sponge__context__state ctx__split_fields18) o39))
(assert (= (rec__keccak__keccak_1600__sponge__context__block ctx__split_fields18) o40))
(assert (= (rec__keccak__keccak_1600__sponge__context__bits_absorbed ctx__split_fields18) o41))
(assert (= (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields18) o42))
(assert (= (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields18) o43))
(assert (= o38 o44))
(assert (= temp___1106 o39))
(assert (= temp___11061 o40))
(assert (= temp___11062 o41))
(assert (= temp___11063 o42))
(assert (= temp___11064 o43))
(assert (= temp___11065 o44))
(assert (= result15 (mk___split_fields__ref ctx__split_fields18)))
(assert (= ctx__split_fields19 (mk___split_fields temp___1106 temp___11061 temp___11062 temp___11063 temp___11064 temp___11065)))
(assert (= spilled1 (mk_bool__ref spilled)))
(assert (= next_block3 (mk_map__ref next_block2)))
(assert (= ctx__split_fields20 (mk___split_fields__ref ctx__split_fields19)))
(assert (= spilled2 spilled))
(assert (= next_block4 next_block2))
(assert (= ctx__split_fields21 ctx__split_fields19))
(assert (not (= (state_of (mk___rep (us_split_fields__content ctx__split_fields20))) 1)))
(check-sat)
(exit)
