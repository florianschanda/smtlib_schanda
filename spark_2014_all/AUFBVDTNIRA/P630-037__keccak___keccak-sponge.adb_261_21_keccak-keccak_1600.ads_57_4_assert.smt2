...
(assert (not (= (state_of (mk___rep (mk___split_fields ctx__split_fields12 ctx__split_fields13 ctx__split_fields14 ctx__split_fields15 ctx__split_fields16 ctx__split_fields17))) 0)))
(check-sat)
(exit)
