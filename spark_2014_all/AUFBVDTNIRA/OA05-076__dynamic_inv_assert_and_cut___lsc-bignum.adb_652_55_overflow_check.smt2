...
(assert (and (= o51 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (and (= o52 o51) (uint_in_range1 o51)))
(assert (= o53 ((_ int2bv 64) o52)))
(assert (= o54 (bvadd o53 ((_ int2bv 64) 1))))
(assert (= o55 (bvmul o54 ((_ int2bv 64) 32))))
(assert (= o56 (ite (bvult i2 o55) true false)))
(assert (= o48 (from_word32 ((_ int2bv 32) 1))))
(assert (= o47 (from_word64 i2)))
(assert (= o49 (oadd o47 o48)))
(assert (= o46 (from_integer s10)))
(assert (= o50 (ole o46 o49)))
(assert (and (= o44 (+ k 1)) (in_range1 (+ k 1))))
(assert (= o45 (ite (<= s10 o44) true false)))
(assert (= o40 (from_word32 ((_ int2bv 32) 2))))
(assert (= o41 (oexpon o40 s10)))
(assert (= o35 (from_word32 ((_ int2bv 32) 1))))
(assert (= o34 (from_integer s10)))
(assert (= o36 (osubtract o34 o35)))
(assert (= o33 (from_word64 i2)))
(assert (= o37 (osubtract o33 o36)))
(assert (= o32 (from_word32 ((_ int2bv 32) 2))))
(assert (= o38 (oexpon__2 o32 o37)))
(assert (and (= o27 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (= o28 (+ o27 1)))
(assert (and (= o29 o28) (in_range1 o28)))
(assert (and (= o30 o29) (in_range2 o29)))
(assert (= o31 (num_of_big_int e e_first o30)))
(assert (= o39 (odivide o31 o38)))
(assert (= o42 (omod o39 o41)))
(assert (= o26 (from_word32 (t__content w7))))
(assert (= o43 (oeq o26 o42)))
(assert (and (= o21 (power 2 k)) (in_range1 (power 2 k))))
(assert (= o22 (- o21 1)))
(assert (and (= o23 o22) (in_range1 o22)))
(assert (= o24 (ite (<= n o23) true false)))
(assert (= result8 (ite (<= 0 n) o24 false)))
(assert (= (= o25 true) (forall ((n1 Int)) (=> (and (<= 0 n1) (<= n1 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux45) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n1 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))))
(assert (and (= o19 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o20 (num_of_big_int m m_first o19)))
(assert (and (= o17 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (and (= o16 (base Tuple0)) (= o16 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o18 (oexpon o16 o17)))
(assert (= o14 (from_word32 ((_ int2bv 32) 2))))
(assert (= o15 (oexpon o14 h9)))
(assert (= o11 (from_word32 ((_ int2bv 32) 1))))
(assert (= o10 (from_word64 i2)))
(assert (= o12 (oadd o10 o11)))
(assert (= o9 (from_word32 ((_ int2bv 32) 2))))
(assert (= o13 (oexpon__2 o9 o12)))
