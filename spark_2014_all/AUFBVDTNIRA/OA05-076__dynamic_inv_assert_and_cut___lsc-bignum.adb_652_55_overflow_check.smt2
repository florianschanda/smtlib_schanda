...
(assert (= o54 (bvadd o53 #x0000000000000001)))
(assert (= o55 (bvmul o54 #x0000000000000020)))
(assert (= o56 (ite (bvult i2 o55) true false)))
(assert (= o48 (from_word32 #x00000001)))
...
(assert (= o40 (from_word32 #x00000002)))
...
(assert (and (= o16 (base Tuple0)) (= o16 (oexpon (from_word32 #x00000002) 32))))
(assert (= o18 (oexpon o16 o17)))
(assert (= o14 (from_word32 #x00000002)))
(assert (= o15 (oexpon o14 h9)))
(assert (= o11 (from_word32 #x00000001)))
(assert (= o10 (from_word64 i2)))
(assert (= o12 (oadd o10 o11)))
(assert (= o9 (from_word32 #x00000002)))
