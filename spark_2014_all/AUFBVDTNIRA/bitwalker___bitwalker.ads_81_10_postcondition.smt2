...
(assert (and (<= (to_rep addr__first) (div1 left 8)) (<= (div1 left 8) (to_rep addr__last))))
(assert (= o7 (div1 left 8)))
(assert (= o8 (store addr o7 o6)))
...
(assert (<= 0 i1))
(assert (<= i1 (- (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) 1)))
(assert (not (= i1 left)))
(assert (= (nth8_stream (mk___t addr2 (mk (to_rep addr__first) (to_rep addr__last))) i1) true))
(assert (not (= (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) i1) true)))
(check-sat)
(exit)
