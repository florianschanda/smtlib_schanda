...
(assert (not (= i left)))
(assert (= (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) i) true))
(assert (not (= (nth8_stream (mk___t addr2 (mk (to_rep addr__first) (to_rep addr__last))) i) true)))
(check-sat)
(exit)
