...
(assert (and (= o8 (+ (to_rep (rec__hw__dbc__op_s_regs__t__msb (us_split_fields1 (select regs idx)))) 1)) (in_range1 (+ (to_rep (rec__hw__dbc__op_s_regs__t__msb (us_split_fields1 (select regs idx)))) 1))))
(assert (= o9 (- o8 (to_rep (rec__hw__dbc__op_s_regs__t__lsb (us_split_fields1 (select regs idx)))))))
(assert (and (= o10 o9) (in_range1 o9)))
(assert (and (= o11 o10) (in_range2 o10)))
(assert (= o12 (power 2 o11)))
(assert (and (= o13 o12) (in_range3 o12)))
(assert (and (= o14 o13) (uint_in_range1 o13)))
(assert (= o15 ((_ int2bv 64) o14)))
(assert (= o16 (ite (bvult ((_ zero_extend 48) value) o15) true false)))
(assert (and (= o5 16) (in_range1 16)))
(assert (and (= o3 (- (to_rep (rec__hw__dbc__op_s_regs__t__msb (us_split_fields1 (select regs idx)))) (to_rep (rec__hw__dbc__op_s_regs__t__lsb (us_split_fields1 (select regs idx)))))) (in_range1 (- (to_rep (rec__hw__dbc__op_s_regs__t__msb (us_split_fields1 (select regs idx)))) (to_rep (rec__hw__dbc__op_s_regs__t__lsb (us_split_fields1 (select regs idx))))))))
(assert (= o4 (+ o3 1)))
(assert (and (= o6 o4) (in_range1 o4)))
