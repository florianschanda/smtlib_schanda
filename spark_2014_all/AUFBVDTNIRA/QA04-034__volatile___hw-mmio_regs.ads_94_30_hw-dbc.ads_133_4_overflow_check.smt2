...
(declare-fun user_eq3 (word16 word16) Bool)
(declare-const dummy3 word16)
...
(define-fun dynamic_invariant1 ((temp___expr_302 (_ BitVec 16)) (temp___is_init_299 Bool) (temp___skip_constant_300 Bool) (temp___do_toplevel_301 Bool)) Bool true)
...
(assert (= o18 (ite (bvult ((_ zero_extend 48) value) o17) true false)))
(assert (and (= o7 16) (in_range1 16)))
...
(assert (not (in_range1 (+ byte_offset (to_rep (rec__hw__dbc__op_s_regs__t__byte_offset (us_split_fields1 (select regs idx))))))))
(check-sat)
(exit)
