...
(assert (and (and (=> (<= 1 65536) (in_range6 index2)) (=> (<= 1 2147483647) (in_range2 string_index2))) (dynamic_invariant4 (mk___rep result____split_discrs result____split_fields3) false true true)))
...
(assert true)
(assert (not (in_range1 (+ string_index2 1))))
(check-sat)
(exit)
