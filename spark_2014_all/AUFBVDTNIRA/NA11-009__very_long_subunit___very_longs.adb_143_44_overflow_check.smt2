...
(assert (and (and (=> (<= 1 65536) (in_range5 index2)) (=> (<= 1 2147483647) (in_range2 string_index2))) (dynamic_invariant4 (mk___rep result____split_discrs result____split_fields3) false true true true)))
