...
(assert (= o11 temp___950))
(assert (= (mk2 (to_rep1 (first (rt message))) r108s) temp___9501))
(assert (= temp___950 o12))
(assert (= (mk (to_rep1 (first4 temp___9501)) (to_rep1 (last4 temp___9501))) o13))
