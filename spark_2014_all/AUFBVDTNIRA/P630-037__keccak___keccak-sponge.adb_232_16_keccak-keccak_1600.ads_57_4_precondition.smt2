...
(assert (= (- message_last2 1) r108s))
(assert (in_range1 r108s))
(assert (and (= o48 (+ (- bit_length 8) (- 8 (mod2 bit_length 8)))) (in_range1 (+ (- bit_length 8) (- 8 (mod2 bit_length 8))))))
(assert (and (= o49 o48) (in_range2 o48)))
(assert (=> (<= (to_rep1 (first (rt message))) r108s) (and (and (<= (to_rep1 (first (rt message))) (to_rep1 (first (rt message)))) (<= (to_rep1 (first (rt message))) (to_rep1 (last (rt message))))) (and (<= (to_rep1 (first (rt message))) r108s) (<= r108s (to_rep1 (last (rt message))))))))
(assert (= o45 (elts message)))
(assert (= o45 temp___881))
(assert (= (mk2 (to_rep1 (first (rt message))) r108s) temp___8811))
(assert (= temp___881 o46))
(assert (= (mk (to_rep1 (first4 temp___8811)) (to_rep1 (last4 temp___8811))) o47))
