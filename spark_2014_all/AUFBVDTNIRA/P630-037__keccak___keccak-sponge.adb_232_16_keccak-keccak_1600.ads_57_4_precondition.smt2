...
(assert (and (= o14 (+ (- bit_length 8) (- 8 (mod2 bit_length 8)))) (in_range1 (+ (- bit_length 8) (- 8 (mod2 bit_length 8))))))
...
(assert (= o11 temp___881))
(assert (= (mk2 (to_rep1 (first (rt message))) r108s) temp___8811))
(assert (= temp___881 o12))
(assert (= (mk (to_rep1 (first4 temp___8811)) (to_rep1 (last4 temp___8811))) o13))
