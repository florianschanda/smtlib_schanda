...
(assert (=> (< bit_position1 8) (= o (bvshl #x01 ((_ int2bv 8) bit_position1)))))
(assert (=> (not (< bit_position1 8)) (= o #x00)))
(assert (= result2 mask))
(assert (= mask1 o))
(assert (not (<= (to_rep2 (first (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 number))))) digit_number1)))
(check-sat)
(exit)
