...
(assert (= byte2 1))
(assert (=> (and (<= 1 byte2) (<= byte2 (to_rep4 (select (rec__rr_type__nsec_record_type__nsecrecordtype__blocklengths (us_split_fields3 nsec_record)) block2)))) (= temp___5890 byte2)))
(assert (=> (and (<= 1 byte2) (<= byte2 (to_rep4 (select (rec__rr_type__nsec_record_type__nsecrecordtype__blocklengths (us_split_fields3 nsec_record)) block2)))) (= temp___5886 bytes9)))
(assert (=> (and (<= 1 byte2) (<= byte2 (to_rep4 (select (rec__rr_type__nsec_record_type__nsecrecordtype__blocklengths (us_split_fields3 nsec_record)) block2)))) (= temp___5891 block2)))
(assert (=> (and (<= 1 byte2) (<= byte2 (to_rep4 (select (rec__rr_type__nsec_record_type__nsecrecordtype__blocklengths (us_split_fields3 nsec_record)) block2)))) (and (and (and (and (and (and (and (and (<= start_byte (- 8174 current_name_length1)) (<= 1 current_name_length1)) (<= current_name_length1 129)) (<= 1 blockoffset2)) (<= blockoffset2 (+ (+ (- (+ start_byte 6) 1) current_name_length1) (* (- block2 1) 34)))) (<= dstbytes3 (* block2 32))) (<= 1 byte3)) (<= byte3 32)) (= block2 temp___5891))))
(assert (=> (and (<= 1 byte2) (<= byte2 (to_rep4 (select (rec__rr_type__nsec_record_type__nsecrecordtype__blocklengths (us_split_fields3 nsec_record)) block2)))) (and (=> (<= 1 (to_rep4 (select (rec__rr_type__nsec_record_type__nsecrecordtype__blocklengths (us_split_fields3 nsec_record)) block2))) (dynamic_property2 1 (to_rep4 (select (rec__rr_type__nsec_record_type__nsecrecordtype__blocklengths (us_split_fields3 nsec_record)) block2)) byte3)) (and (<= 1 byte3) (<= byte3 (to_rep4 (select (rec__rr_type__nsec_record_type__nsecrecordtype__blocklengths (us_split_fields3 nsec_record)) block2)))))))
(assert (=> (and (<= 1 byte2) (<= byte2 (to_rep4 (select (rec__rr_type__nsec_record_type__nsecrecordtype__blocklengths (us_split_fields3 nsec_record)) block2)))) (and (<= 1 byte3) (<= byte3 32))))
(assert (=> (and (<= 1 byte2) (<= byte2 (to_rep4 (select (rec__rr_type__nsec_record_type__nsecrecordtype__blocklengths (us_split_fields3 nsec_record)) block2)))) (= o16 byte3)))
(assert (=> (and (<= 1 byte2) (<= byte2 (to_rep4 (select (rec__rr_type__nsec_record_type__nsecrecordtype__blocklengths (us_split_fields3 nsec_record)) block2)))) (= o17 (select (select (rec__rr_type__nsec_record_type__nsecrecordtype__bitmaps (us_split_fields3 nsec_record)) block2) o16))))
(assert (=> (and (<= 1 byte2) (<= byte2 (to_rep4 (select (rec__rr_type__nsec_record_type__nsecrecordtype__blocklengths (us_split_fields3 nsec_record)) block2)))) (= o18 (to_rep1 o17))))
(assert (=> (and (<= 1 byte2) (<= byte2 (to_rep4 (select (rec__rr_type__nsec_record_type__nsecrecordtype__blocklengths (us_split_fields3 nsec_record)) block2)))) (= (to_rep1 o19) o18)))
(assert (=> (and (<= 1 byte2) (<= byte2 (to_rep4 (select (rec__rr_type__nsec_record_type__nsecrecordtype__blocklengths (us_split_fields3 nsec_record)) block2)))) (and (= o15 byte3) (in_range4 byte3))))
(assert (=> (and (<= 1 byte2) (<= byte2 (to_rep4 (select (rec__rr_type__nsec_record_type__nsecrecordtype__blocklengths (us_split_fields3 nsec_record)) block2)))) (= temp___5885 (+ (+ blockoffset2 2) o15))))
(assert (=> (and (<= 1 byte2) (<= byte2 (to_rep4 (select (rec__rr_type__nsec_record_type__nsecrecordtype__blocklengths (us_split_fields3 nsec_record)) block2)))) (and (<= 1 temp___5885) (<= temp___5885 8180))))
(assert (=> (and (<= 1 byte2) (<= byte2 (to_rep4 (select (rec__rr_type__nsec_record_type__nsecrecordtype__blocklengths (us_split_fields3 nsec_record)) block2)))) (= o20 temp___5885)))
(assert (=> (and (<= 1 byte2) (<= byte2 (to_rep4 (select (rec__rr_type__nsec_record_type__nsecrecordtype__blocklengths (us_split_fields3 nsec_record)) block2)))) (= o21 (store bytes10 o20 o19))))
(assert (=> (and (<= 1 byte2) (<= byte2 (to_rep4 (select (rec__rr_type__nsec_record_type__nsecrecordtype__blocklengths (us_split_fields3 nsec_record)) block2)))) (= result10 (mk_map__ref1 bytes10))))
(assert (=> (and (<= 1 byte2) (<= byte2 (to_rep4 (select (rec__rr_type__nsec_record_type__nsecrecordtype__blocklengths (us_split_fields3 nsec_record)) block2)))) (= bytes11 o21)))
(assert (=> (and (<= 1 byte2) (<= byte2 (to_rep4 (select (rec__rr_type__nsec_record_type__nsecrecordtype__blocklengths (us_split_fields3 nsec_record)) block2)))) (= byte3 (to_rep4 (select (rec__rr_type__nsec_record_type__nsecrecordtype__blocklengths (us_split_fields3 nsec_record)) block2)))))
(assert (=> (and (<= 1 byte2) (<= byte2 (to_rep4 (select (rec__rr_type__nsec_record_type__nsecrecordtype__blocklengths (us_split_fields3 nsec_record)) block2)))) (= byte4 (mk_int__ref byte3))))
(assert (=> (and (<= 1 byte2) (<= byte2 (to_rep4 (select (rec__rr_type__nsec_record_type__nsecrecordtype__blocklengths (us_split_fields3 nsec_record)) block2)))) (= bytes12 (mk_map__ref1 bytes11))))
(assert (=> (and (<= 1 byte2) (<= byte2 (to_rep4 (select (rec__rr_type__nsec_record_type__nsecrecordtype__blocklengths (us_split_fields3 nsec_record)) block2)))) (= byte5 byte3)))
(assert (=> (and (<= 1 byte2) (<= byte2 (to_rep4 (select (rec__rr_type__nsec_record_type__nsecrecordtype__blocklengths (us_split_fields3 nsec_record)) block2)))) (= bytes13 bytes11)))
(assert (=> (and (<= 1 byte2) (<= byte2 (to_rep4 (select (rec__rr_type__nsec_record_type__nsecrecordtype__blocklengths (us_split_fields3 nsec_record)) block2)))) (= byte6 byte4)))
(assert (=> (and (<= 1 byte2) (<= byte2 (to_rep4 (select (rec__rr_type__nsec_record_type__nsecrecordtype__blocklengths (us_split_fields3 nsec_record)) block2)))) (= bytes14 bytes12)))
(assert (=> (and (<= 1 byte2) (<= byte2 (to_rep4 (select (rec__rr_type__nsec_record_type__nsecrecordtype__blocklengths (us_split_fields3 nsec_record)) block2)))) (= byte7 byte5)))
(assert (=> (and (<= 1 byte2) (<= byte2 (to_rep4 (select (rec__rr_type__nsec_record_type__nsecrecordtype__blocklengths (us_split_fields3 nsec_record)) block2)))) (= bytes15 bytes13)))
(assert (=> (not (and (<= 1 byte2) (<= byte2 (to_rep4 (select (rec__rr_type__nsec_record_type__nsecrecordtype__blocklengths (us_split_fields3 nsec_record)) block2))))) (= byte6 (mk_int__ref byte2))))
(assert (=> (not (and (<= 1 byte2) (<= byte2 (to_rep4 (select (rec__rr_type__nsec_record_type__nsecrecordtype__blocklengths (us_split_fields3 nsec_record)) block2))))) (= bytes14 (mk_map__ref1 bytes9))))
(assert (=> (not (and (<= 1 byte2) (<= byte2 (to_rep4 (select (rec__rr_type__nsec_record_type__nsecrecordtype__blocklengths (us_split_fields3 nsec_record)) block2))))) (= byte7 byte2)))
(assert (=> (not (and (<= 1 byte2) (<= byte2 (to_rep4 (select (rec__rr_type__nsec_record_type__nsecrecordtype__blocklengths (us_split_fields3 nsec_record)) block2))))) (= bytes15 bytes9)))
(assert (and (= o22 (+ (+ blockoffset2 2) (to_rep4 (select (rec__rr_type__nsec_record_type__nsecrecordtype__blocklengths (us_split_fields3 nsec_record)) block2)))) (in_range4 (+ (+ blockoffset2 2) (to_rep4 (select (rec__rr_type__nsec_record_type__nsecrecordtype__blocklengths (us_split_fields3 nsec_record)) block2))))))
(assert (= result11 (mk_int__ref blockoffset2)))
(assert (= blockoffset3 o22))
(assert (not (= block2 (to_rep3 (rec__rr_type__nsec_record_type__nsecrecordtype__numberofblocks (us_split_fields3 nsec_record))))))
(assert (= result12 (mk_int__ref block2)))
(assert (= block3 (+ block2 1)))
(assert (= byte8 byte6))
(assert (= block4 (mk_int__ref block3)))
(assert (= blockoffset4 (mk_int__ref blockoffset3)))
(assert (= dstbytes4 (mk_int__ref dstbytes3)))
(assert (= bytes16 bytes14))
(assert (= byte9 byte7))
(assert (= block5 block3))
(assert (= blockoffset5 blockoffset3))
(assert (= dstbytes5 dstbytes3))
(assert (= bytes17 bytes15))
