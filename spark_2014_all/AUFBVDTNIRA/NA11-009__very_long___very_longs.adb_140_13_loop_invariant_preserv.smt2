...
(assert (not (= index2 1)))
(assert (and (= o26 (- index2 1)) (in_range6 (- index2 1))))
(assert (= result5 (mk_int__ref index2)))
(assert (= index3 o26))
(assert (and (= o27 (+ string_index2 2)) (in_range1 (+ string_index2 2))))
(assert (= result6 (mk_int__ref string_index2)))
(assert (= string_index3 o27))
(assert (not (= string_index3 (+ (* 2 (- (to_rep4 (last2 (rt1 (rec__very_longs__very_long__long_digits result____split_fields4)))) index3)) (to_rep1 (first (rt number)))))))
(check-sat)
(exit)
