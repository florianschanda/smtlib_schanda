...
(define-fun dynamic_invariant1 ((temp___expr_677 Int) (temp___is_init_673 Bool) (temp___skip_constant_674 Bool) (temp___do_toplevel_675 Bool) (temp___do_typ_inv_676 Bool)) Bool (=> (or (= temp___is_init_673 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_677)))
(declare-fun rand (tuple0) Int)
(declare-fun rand__function_guard (Int tuple0) Bool)
(assert (forall ((us_void_param tuple0)) (! (dynamic_invariant1 (rand us_void_param) true false true true) :pattern ((rand us_void_param)))))
(declare-sort score_t 0)
(define-fun in_range3 ((x (_ BitVec 32))) Bool (and (bvule #x00000000 x) (bvule x #x0001869F)))
...
(define-fun dynamic_invariant2 ((temp___expr_2080 (_ BitVec 32)) (temp___is_init_2076 Bool) (temp___skip_constant_2077 Bool) (temp___do_toplevel_2078 Bool) (temp___do_typ_inv_2079 Bool)) Bool (=> (or (= temp___is_init_2076 true) (bvule #x00000000 #x0001869F)) (in_range3 temp___expr_2080)))
...
(define-fun bool_eq ((a (Array Int cell)) (a__first Int) (a__last Int) (b (Array Int cell)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_161 Int)) (=> (and (<= a__first temp___idx_161) (<= temp___idx_161 a__last)) (= (to_rep1 (select a temp___idx_161)) (to_rep1 (select b (+ (- b__first a__first) temp___idx_161))))))) true false))
(assert (forall ((a (Array Int cell)) (b (Array Int cell))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_161 Int)) (=> (and (<= a__first temp___idx_161) (<= temp___idx_161 a__last)) (= (to_rep1 (select a temp___idx_161)) (to_rep1 (select b (+ (- b__first a__first) temp___idx_161)))))))))))
...
(define-fun dynamic_invariant4 ((temp___expr_18 Int) (temp___is_init_14 Bool) (temp___skip_constant_15 Bool) (temp___do_toplevel_16 Bool) (temp___do_typ_inv_17 Bool)) Bool (=> (or (= temp___is_init_14 true) (<= (- 2147483648) 2147483647)) (in_range10 temp___expr_18)))
(define-fun dynamic_invariant5 ((temp___expr_2087 Int) (temp___is_init_2083 Bool) (temp___skip_constant_2084 Bool) (temp___do_toplevel_2085 Bool) (temp___do_typ_inv_2086 Bool)) Bool (=> (or (= temp___is_init_2083 true) (<= 0 7)) (in_range5 temp___expr_2087)))
(define-fun dynamic_invariant6 ((temp___expr_2094 Int) (temp___is_init_2090 Bool) (temp___skip_constant_2091 Bool) (temp___do_toplevel_2092 Bool) (temp___do_typ_inv_2093 Bool)) Bool (=> (or (= temp___is_init_2090 true) (<= 1 7)) (in_range4 temp___expr_2094)))
...
(define-fun dynamic_invariant7 ((temp___expr_2108 Int) (temp___is_init_2104 Bool) (temp___skip_constant_2105 Bool) (temp___do_toplevel_2106 Bool) (temp___do_typ_inv_2107 Bool)) Bool (=> (or (= temp___is_init_2104 true) (<= 1 10)) (in_range11 temp___expr_2108)))
...
(define-fun dynamic_invariant8 ((temp___expr_2115 Int) (temp___is_init_2111 Bool) (temp___skip_constant_2112 Bool) (temp___do_toplevel_2113 Bool) (temp___do_typ_inv_2114 Bool)) Bool (=> (or (= temp___is_init_2111 true) (<= 1 20)) (in_range12 temp___expr_2115)))
(assert true)
...
(define-fun dynamic_invariant9 ((temp___expr_2153 Int) (temp___is_init_2149 Bool) (temp___skip_constant_2150 Bool) (temp___do_toplevel_2151 Bool) (temp___do_typ_inv_2152 Bool)) Bool (=> (or (= temp___is_init_2149 true) (<= (- 1) 9)) (in_range6 temp___expr_2153)))
(define-fun dynamic_invariant10 ((temp___expr_2160 Int) (temp___is_init_2156 Bool) (temp___skip_constant_2157 Bool) (temp___do_toplevel_2158 Bool) (temp___do_typ_inv_2159 Bool)) Bool (=> (or (= temp___is_init_2156 true) (<= (- 1) 19)) (in_range7 temp___expr_2160)))
(define-fun dynamic_invariant11 ((temp___expr_2167 Int) (temp___is_init_2163 Bool) (temp___skip_constant_2164 Bool) (temp___do_toplevel_2165 Bool) (temp___do_typ_inv_2166 Bool)) Bool (=> (or (= temp___is_init_2163 true) (<= 0 3)) (in_range8 temp___expr_2167)))
(assert true)
...
(assert true)
(assert (forall ((b (Array Int (Array Int cell)))) (forall ((y Int) (x Int)) (! (= (= (is_empty b y x) true) (and (and (in_range11 x) (in_range12 y)) (= (to_rep1 (let ((temp___2231 (select b y))) (select temp___2231 x))) 0))) :pattern ((is_empty b y x))))))
...
(assert (= redraw_board1 (distinct 0 0)))
(assert (= result1 (mk_bool__ref redraw_current_piece)))
(assert (= redraw_current_piece1 (distinct 0 0)))
(assert (= result2 (mk_bool__ref redraw_score)))
(assert (= redraw_score1 (distinct 0 0)))
(assert (= cur_state 0))
