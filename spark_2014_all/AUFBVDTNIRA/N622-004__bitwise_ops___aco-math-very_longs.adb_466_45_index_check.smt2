...
(assert (and (dynamic_invariant5 (mk___rep1 u__split_discrs u__split_fields3) true true true) (and (<= 1 divisor_index2) (<= divisor_index2 r130b))))
...
(assert (and (<= (to_rep2 (first2 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 u__split_fields3)))) temp___1543) (<= temp___1543 (to_rep2 (last3 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 u__split_fields3)))))))
(assert (= o8 temp___1543))
(assert (= o9 (select (elts1 (rec__aco__math__very_longs__very_long__long_digits1 u__split_fields3)) o8)))
...
(assert (and (<= (to_rep2 (first2 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 u__split_fields3)))) temp___1545) (<= temp___1545 (to_rep2 (last3 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 u__split_fields3)))))))
(assert (= o14 temp___1545))
(assert (= o15 (select (elts1 (rec__aco__math__very_longs__very_long__long_digits1 u__split_fields3)) o14)))
...
(assert (not (<= (to_rep2 (first2 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 u__split_fields3)))) temp___1547)))
(check-sat)
(exit)
