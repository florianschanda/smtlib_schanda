...
(assert (= temp___1628 (- o7 1)))
(assert (and (<= (to_rep2 (first2 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 u__split_fields2)))) temp___1628) (<= temp___1628 (to_rep2 (last3 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 u__split_fields2)))))))
(assert (= o8 temp___1628))
...
(assert (= temp___1632 (- o12 1)))
(assert (not (<= (to_rep2 (first2 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 u__split_fields2)))) temp___1632)))
(check-sat)
(exit)
