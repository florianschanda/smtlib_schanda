...
(declare-const o13 (Array Int unsigned_8))
...
(assert (and (forall ((i3 Int)) (=> (and (<= 0 i3) (<= i3 (- (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) 1))) (=> (not (= i3 o9)) (= (= (nth8_stream (mk___t o13 (mk (to_rep addr__first) (to_rep addr__last))) i3) true) (= (nth8_stream (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) i3) true))))) (= (= (nth8_stream (mk___t o13 (mk (to_rep addr__first) (to_rep addr__last))) o9) true) (= flag1 true))))
(assert (and (= o10 (- (- len i2) 1)) (in_range2 (- (- len i2) 1))))
(assert (= o11 (nth value o10)))
(assert (= o12 (ite o11 1 0)))
(assert (not (<= (div1 (+ start i2) 8) (to_rep (last (mk (to_rep addr__first) (to_rep addr__last)))))))
(check-sat)
(exit)
