...
(assert (and (= o5 (state_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5)))) (and (in_range5 o5) (= o5 (to_rep3 ctx__split_fields5)))))
(assert (= result (ite (= o5 0) true false)))
(assert (= result true))
(assert (<= suffix_len 8))
(assert (<= bit_length 2147483639))
(assert (and (= o3 (length message)) (in_range1 (length message))))
(assert (and (= o2 (+ bit_length 7)) (in_range1 (+ bit_length 7))))
(assert (= o4 (div1 o2 8)))
(assert (= result1 (ite (<= o4 o3) true false)))
(assert (= result1 true))
(assert (and (= o (in_queue_bit_length (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5)))) (and (in_range2 o) (and (= o (to_rep5 ctx__split_fields2)) (< o 1600)))))
(assert (not (not (= 8 0))))
(check-sat)
(exit)
