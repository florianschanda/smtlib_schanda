...
(assert (not (= (ite (<= (to_rep (first2 temp___4761)) (to_rep (last2 temp___4761))) (+ (- (to_rep (last2 temp___4761)) (to_rep (first2 temp___4761))) 1) 0) (ite (<= (to_rep (first2 temp___4781)) (to_rep (last2 temp___4781))) (+ (- (to_rep (last2 temp___4781)) (to_rep (first2 temp___4781))) 1) 0))))
(check-sat)
(exit)
