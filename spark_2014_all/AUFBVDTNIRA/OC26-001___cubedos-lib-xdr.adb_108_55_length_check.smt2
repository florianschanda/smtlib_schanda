...
(assert (not (= (ite (<= (to_rep (first2 temp___5351)) (to_rep (last2 temp___5351))) (+ (- (to_rep (last2 temp___5351)) (to_rep (first2 temp___5351))) 1) 0) (ite (<= (to_rep (first2 temp___5371)) (to_rep (last2 temp___5371))) (+ (- (to_rep (last2 temp___5371)) (to_rep (first2 temp___5371))) 1) 0))))
(check-sat)
(exit)
