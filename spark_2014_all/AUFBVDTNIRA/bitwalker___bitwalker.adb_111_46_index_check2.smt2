...
(declare-fun pokebit8__function_guard ((_ BitVec 8) (_ BitVec 8) Int Bool) Bool)
...
(assert (forall ((byte (_ BitVec 8))) (forall ((left Int)) (forall ((flag Bool)) (! (=> (and (and (dynamic_invariant2 byte true true true true) (dynamic_invariant left true true true true)) (< left 8)) (let ((result (pokebit8 byte left flag))) (and (and (forall ((i Int)) (=> (and (<= 0 i) (<= i 7)) (=> (not (= i (- 7 left))) (= (= (nth result i) true) (= (nth byte i) true))))) (= (= (nth result (- 7 left)) true) (= flag true))) (dynamic_invariant2 result true false true true)))) :pattern ((pokebit8 byte left flag)))))))
...
(assert (and (= (to_rep addr__first) 0) (< left (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)))))
(assert (not (<= (to_rep addr__first) (div1 left 8))))
(check-sat)
(exit)
