...
(assert (forall ((start Int) (length1 Int)) (forall ((addr us_t)) (! (=> (and (and (and (dynamic_invariant1 start true true true true) (dynamic_invariant1 length1 true true true true)) (dynamic_invariant3 addr true true true true)) (and (= (first1 addr) 0) (and (<= length1 64) (and (<= (+ start length1) 2147483647) (<= (* 8 (length addr)) 2147483647))))) (let ((result (peek start length1 addr))) (and (ite (< (* 8 (length addr)) (+ start length1)) (= result #x0000000000000000) (=> (<= (+ start length1) (* 8 (length addr))) (and (forall ((i Int)) (=> (and (<= 0 i) (<= i (- length1 1))) (= (= (nth8_stream addr (- (- (+ start length1) i) 1)) true) (= (nth result i) true)))) (forall ((i Int)) (=> (and (<= length1 i) (<= i 63)) (not (= (nth result i) true))))))) (dynamic_invariant2 result true false true true)))) :pattern ((peek start length1 addr))))))
...
(assert (forall ((len1 Int)) (! (=> (dynamic_invariant1 len1 true true true true) (dynamic_invariant2 (maxvalue len1) true false true true)) :pattern ((maxvalue len1)))))
...
(assert (dynamic_invariant3 addrold true false true true))
...
(assert (= v1 o1))
(assert (and (and (and (<= (- 2) result__1) (<= result__1 0)) (and (= (= result__1 (- 1)) (< (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) (+ start len))) (and (= (= result__1 (- 2)) (and (bvule (maxvalue len) value1) (<= (+ start len) (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0))))) (and (= (= result__1 0) (and (bvugt (maxvalue len) value1) (<= (+ start len) (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0))))) (and (=> (= result__1 0) (forall ((i1 Int)) (=> (and (<= 0 i1) (<= i1 (- start 1))) (= (= (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) i1) true) (= (nth8_stream (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) i1) true))))) (and (=> (= result__1 0) (forall ((i1 Int)) (=> (and (<= start i1) (<= i1 (- (+ start len) 1))) (= (= (nth8_stream (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) i1) true) (= (nth value1 (+ (- (- len i1) 1) start)) true))))) (=> (= result__1 0) (forall ((i1 Int)) (=> (and (<= (+ start len) i1) (<= i1 (- (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) 1))) (= (= (nth8_stream (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) i1) true) (= (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) i1) true))))))))))) (in_range1 result__1)))
(assert (= result__1 0))
(assert (<= start i))
