...
(define-fun dynamic_invariant4 ((temp___expr_215 Int) (temp___is_init_212 Bool) (temp___skip_constant_213 Bool) (temp___do_toplevel_214 Bool)) Bool (=> (or (= temp___is_init_212 true) (<= 0 0)) (in_range4 temp___expr_215)))
(declare-fun peek (Int Int us_t) (_ BitVec 64))
(declare-fun peek__function_guard ((_ BitVec 64) Int Int us_t) Bool)
(assert (forall ((start Int) (length1 Int)) (forall ((addr us_t)) (! (=> (and (and (and (dynamic_invariant1 start true true true) (dynamic_invariant1 length1 true true true)) (dynamic_invariant3 addr true true true)) (and (= (first1 addr) 0) (and (<= length1 64) (and (<= (+ start length1) 2147483647) (<= (* 8 (length addr)) 2147483647))))) (let ((result (peek start length1 addr))) (and (ite (< (* 8 (length addr)) (+ start length1)) (= result ((_ int2bv 64) 0)) (=> (<= (+ start length1) (* 8 (length addr))) (and (forall ((i Int)) (=> (and (<= 0 i) (<= i (- length1 1))) (= (= (nth8_stream addr (- (- (+ start length1) i) 1)) true) (= (nth result i) true)))) (forall ((i Int)) (=> (and (<= length1 i) (<= i 63)) (not (= (nth result i) true))))))) (dynamic_invariant2 result true false true)))) :pattern ((peek start length1 addr))))))
...
(assert (forall ((x (_ BitVec 64))) (forall ((len Int)) (! (=> (and (and (dynamic_invariant2 x true true true) (dynamic_invariant len true true true)) (and (and (<= 0 len) (<= len 63)) (forall ((i Int)) (=> (and (<= len i) (<= i 63)) (not (= (nth x i) true)))))) (let ((result (lemmafunction x len))) (and (and (= result 0) (bvult x (maxvalue len))) (dynamic_invariant4 result true false true)))) :pattern ((lemmafunction x len))))))
...
(assert (forall ((len1 Int)) (! (=> (dynamic_invariant1 len1 true true true) (dynamic_invariant2 (maxvalue len1) true false true)) :pattern ((maxvalue len1)))))
(assert (forall ((len1 Int)) (! (=> (dynamic_invariant1 len1 true true true) (= (maxvalue len1) (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) len1)))) :pattern ((maxvalue len1)))))
...
(assert (and (= o5 (peek start len (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))))) (ite (= (> (+ start len) (* 8 (length (mk___t addr (mk (to_rep addr__first) (to_rep addr__last)))))) true) (= o5 ((_ int2bv 64) 0)) (=> (= (<= (+ start len) (* 8 (length (mk___t addr (mk (to_rep addr__first) (to_rep addr__last)))))) true) (and (forall ((i2 Int)) (=> (and (<= 0 i2) (<= i2 (- len 1))) (= (= (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) (- (- (+ start len) i2) 1)) true) (= (nth o5 i2) true)))) (forall ((i2 Int)) (=> (and (<= len i2) (<= i2 63)) (not (= (nth o5 i2) true)))))))))
(assert (= (mk_t__ref result1) (mk_t__ref value)))
(assert (= value1 o5))
(assert (and (= o6 (lemmafunction value1 len)) (and (in_range4 o6) (and (= o6 0) (bvult value1 (maxvalue len))))))
(assert (= (mk_int__ref result2) (mk_int__ref v)))
(assert (= v1 o6))
(assert (and (and (and (<= (- 2) result__1) (<= result__1 0)) (and (= (= result__1 (- 1)) (< (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) (+ start len))) (and (= (= result__1 (- 2)) (and (bvule (maxvalue len) value1) (<= (+ start len) (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0))))) (and (= (= result__1 0) (and (bvugt (maxvalue len) value1) (<= (+ start len) (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0))))) (and (=> (= result__1 0) (forall ((i2 Int)) (=> (and (<= 0 i2) (<= i2 (- start 1))) (= (= (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) i2) true) (= (nth8_stream (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) i2) true))))) (and (=> (= result__1 0) (forall ((i2 Int)) (=> (and (<= start i2) (<= i2 (- (+ start len) 1))) (= (= (nth8_stream (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) i2) true) (= (nth value1 (+ (- (- len i2) 1) start)) true))))) (=> (= result__1 0) (forall ((i2 Int)) (=> (and (<= (+ start len) i2) (<= i2 (- (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) 1))) (= (= (nth8_stream (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) i2) true) (= (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) i2) true))))))))))) (in_range1 result__1)))
(assert (= result__1 0))
(assert (<= start i))
