...
(assert (not (= (state_of (mk___rep (mk___split_fields ctx__split_fields36 ctx__split_fields37 ctx__split_fields38 ctx__split_fields39 ctx__split_fields40 ctx__split_fields41))) 0)))
(check-sat)
(exit)
