...
(assert (and (= o27 (rate_of (mk___rep ctx__split_fields11))) (and (in_range7 o27) (and (= o27 (* (to_rep6 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields11)) 8)) (< o27 1600)))))
(assert (<= 0 r125s))
(assert (not (<= 0 0)))
(check-sat)
(exit)
