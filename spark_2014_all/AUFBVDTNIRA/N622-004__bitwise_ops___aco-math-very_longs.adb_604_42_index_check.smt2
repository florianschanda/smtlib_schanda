...
(define-fun dynamic_invariant1 ((temp___expr_302 Int) (temp___is_init_298 Bool) (temp___skip_constant_299 Bool) (temp___do_toplevel_300 Bool) (temp___do_typ_inv_301 Bool)) Bool (=> (or (= temp___is_init_298 true) (<= 1 2147483647)) (in_range temp___expr_302)))
...
(define-fun dynamic_invariant3 ((temp___expr_322 Int) (temp___is_init_318 Bool) (temp___skip_constant_319 Bool) (temp___do_toplevel_320 Bool) (temp___do_typ_inv_321 Bool)) Bool (=> (or (= temp___is_init_318 true) (<= 0 1)) (in_range2 temp___expr_322)))
...
(define-fun dynamic_invariant4 ((temp___expr_329 Int) (temp___is_init_325 Bool) (temp___skip_constant_326 Bool) (temp___do_toplevel_327 Bool) (temp___do_typ_inv_328 Bool)) Bool (=> (or (= temp___is_init_325 true) (<= 0 2147483647)) (in_range3 temp___expr_329)))
...
(declare-const bit_position1 Int)
...
(assert (not (<= digit_number1 (to_rep2 (last number__split_fields1)))))
(check-sat)
(exit)
