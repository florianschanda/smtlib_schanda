...
(declare-const temp___879 digit_index_type)
(declare-const temp___8791 (Array Int octet))
(declare-const temp___8792 t1)
...
(assert (= index1 1))
(assert (=> (and (<= 1 index1) (<= index1 r26b)) (and (= result____split_discrs (mk___split_discrs temp___879)) (= result____split_fields2 (mk___split_fields1 (mk___t1 temp___8791 temp___8792))))))
(assert (=> (and (<= 1 index1) (<= index1 r26b)) (= temp___878 temp1)))
(assert (=> (and (<= 1 index1) (<= index1 r26b)) (and (and (and (=> (<= 0 2147483647) (in_range1 temp2)) (dynamic_invariant2 (mk___rep1 result____split_discrs result____split_fields3) false true true true)) (forall ((temp___881 Int)) (=> (and (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))) temp___881) (<= temp___881 (to_rep2 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))))) (=> (<= index2 temp___881) (= (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields3)) temp___881) (select temp___8791 temp___881)))))) (and (<= 1 index2) (<= index2 r26b)))))
