...
(assert (= index1 1))
(assert (=> (and (<= 1 index1) (<= index1 r26b)) (and (= result____split_discrs (mk___split_discrs temp___810)) (= result____split_fields2 (mk___split_fields1 (mk___t1 temp___8101 temp___8102))))))
(assert (=> (and (<= 1 index1) (<= index1 r26b)) (= temp___809 temp1)))
(assert (=> (and (<= 1 index1) (<= index1 r26b)) (and (and (and (=> (<= 0 2147483647) (in_range1 temp2)) (dynamic_invariant2 (mk___rep1 result____split_discrs result____split_fields3) false true true)) (forall ((temp___812 Int)) (=> (and (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))) temp___812) (<= temp___812 (to_rep2 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))))) (=> (<= index2 temp___812) (= (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields3)) temp___812) (select temp___8101 temp___812)))))) (and (<= 1 index2) (<= index2 r26b)))))
