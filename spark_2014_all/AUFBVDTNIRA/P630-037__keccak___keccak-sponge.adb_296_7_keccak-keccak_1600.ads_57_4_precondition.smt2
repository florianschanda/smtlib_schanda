...
(declare-fun temp___1060 ((_ BitVec 8)) (Array Int byte))
...
(assert (forall ((temp___1062 (_ BitVec 8))) (=> (dynamic_invariant3 temp___1062 true true true true) (forall ((temp___1063 Int)) (= (to_rep1 (select (temp___1060 temp___1062) temp___1063)) temp___1062)))))
...
(declare-const temp___1067 map1)
(declare-const temp___10671 (Array Int byte))
(declare-const temp___10672 bit_absorption_number)
(declare-const temp___10673 byte_absorption_number)
(declare-const temp___10674 rate_number)
(declare-const temp___10675 states)
...
(assert (=> (= result1 true) (= temp___1067 o6)))
(assert (=> (= result1 true) (= temp___10671 o7)))
(assert (=> (= result1 true) (= temp___10672 o8)))
(assert (=> (= result1 true) (= temp___10673 o9)))
(assert (=> (= result1 true) (= temp___10674 o10)))
(assert (=> (= result1 true) (= temp___10675 o11)))
(assert (=> (= result1 true) (= result5 (mk___split_fields__ref ctx__split_fields9))))
(assert (=> (= result1 true) (= ctx__split_fields10 (mk___split_fields temp___1067 temp___10671 temp___10672 temp___10673 temp___10674 temp___10675))))
