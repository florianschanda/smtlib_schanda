...
(define-fun dynamic_invariant1 ((temp___expr_364 Int) (temp___is_init_361 Bool) (temp___skip_constant_362 Bool) (temp___do_toplevel_363 Bool)) Bool (=> (or (= temp___is_init_361 true) (<= 0 1)) (in_range3 temp___expr_364)))
(assert (forall ((ctx us_rep)) (! (dynamic_invariant1 (state_of ctx) true false true) :pattern ((state_of ctx)))))
...
(define-fun dynamic_invariant2 ((temp___expr_39 Int) (temp___is_init_36 Bool) (temp___skip_constant_37 Bool) (temp___do_toplevel_38 Bool)) Bool (=> (or (= temp___is_init_36 true) (<= 1 2147483647)) (in_range7 temp___expr_39)))
(assert (forall ((ctx us_rep)) (! (let ((result (rate_of ctx))) (and (< result 1600) (dynamic_invariant2 result true false true))) :pattern ((rate_of ctx)))))
...
(assert (forall ((temp___982 (_ BitVec 8))) (forall ((temp___983 Int)) (= (select (keccak__keccak_1600__sponge__finalize__next_block__aggregate_def temp___982) temp___983) (of_rep1 temp___982)))))
(declare-fun temp___991 ((_ BitVec 8)) (Array Int byte))
(assert (forall ((temp___993 (_ BitVec 8))) (forall ((temp___994 Int)) (= (select (temp___991 temp___993) temp___994) (of_rep1 temp___993)))))
...
(define-fun dynamic_invariant4 ((temp___expr_255 Int) (temp___is_init_252 Bool) (temp___skip_constant_253 Bool) (temp___do_toplevel_254 Bool)) Bool (=> (or (= temp___is_init_252 true) (<= 0 2147483647)) (in_range2 temp___expr_255)))
...
(define-fun dynamic_invariant6 ((temp___expr_391 Int) (temp___is_init_388 Bool) (temp___skip_constant_389 Bool) (temp___do_toplevel_390 Bool)) Bool (=> (or (= temp___is_init_388 true) (<= 1 199)) (in_range6 temp___expr_391)))
(define-fun dynamic_invariant7 ((temp___expr_370 Int) (temp___is_init_367 Bool) (temp___skip_constant_368 Bool) (temp___do_toplevel_369 Bool)) Bool (=> (or (= temp___is_init_367 true) (<= 0 199)) (in_range4 temp___expr_370)))
(define-fun dynamic_invariant8 ((temp___expr_385 Int) (temp___is_init_382 Bool) (temp___skip_constant_383 Bool) (temp___do_toplevel_384 Bool)) Bool (=> (or (= temp___is_init_382 true) (<= 0 1599)) (in_range5 temp___expr_385)))
...
(declare-const temp___986 (Array Int byte))
(declare-const temp___9861 t1)
(declare-const o2 (Array Int byte))
(declare-const o3 t)
(declare-const o4 Int)
(declare-const o5 bit_absorption_number)
(declare-const o6 map1)
(declare-const o7 (Array Int byte))
(declare-const o8 bit_absorption_number)
(declare-const o9 byte_absorption_number)
(declare-const o10 rate_number)
(declare-const o11 states)
(declare-const temp___998 map1)
(declare-const temp___9981 (Array Int byte))
(declare-const temp___9982 bit_absorption_number)
(declare-const temp___9983 byte_absorption_number)
(declare-const temp___9984 rate_number)
(declare-const temp___9985 states)
...
(declare-const temp___1006 map1)
(declare-const temp___10061 (Array Int byte))
(declare-const temp___10062 bit_absorption_number)
(declare-const temp___10063 byte_absorption_number)
(declare-const temp___10064 rate_number)
(declare-const temp___10065 states)
(declare-const o26 (Array Int byte))
(declare-const o27 (Array Int byte))
(declare-const temp___1013 (Array Int byte))
(declare-const temp___10131 t4)
(declare-const o28 (Array Int byte))
(declare-const o29 t)
(declare-const o30 Int)
(declare-const o31 (Array Int byte))
(declare-const temp___1019 (Array Int byte))
(declare-const temp___10191 t5)
...
(declare-const temp___1031 map1)
(declare-const temp___10311 (Array Int byte))
(declare-const temp___10312 bit_absorption_number)
(declare-const temp___10313 byte_absorption_number)
(declare-const temp___10314 rate_number)
(declare-const temp___10315 states)
(declare-const o45 bit_absorption_number)
(declare-const o46 us_split_fields)
(declare-const temp___1033 us_rep)
(declare-const o47 byte_absorption_number)
(declare-const o48 us_split_fields)
(declare-const temp___1035 us_rep)
(declare-const o49 states)
(declare-const o50 us_split_fields)
(declare-const temp___1037 us_rep)
...
(assert (= next_block1 (keccak__keccak_1600__sponge__finalize__next_block__aggregate_def ((_ int2bv 8) 0))))
...
(assert (=> (= result1 true) (= (mk (to_rep (first2 temp___9861)) (to_rep (last2 temp___9861))) o3)))
(assert true)
...
(assert (=> (= result1 true) (= ctx__split_fields9 (mk___split_fields (rec__keccak__keccak_1600__sponge__context__state ctx__split_fields8) (temp___991 ((_ int2bv 8) 0)) (rec__keccak__keccak_1600__sponge__context__bits_absorbed ctx__split_fields8) (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields8) (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields8) (rec__keccak__keccak_1600__sponge__context__curr_state ctx__split_fields8)))))
(assert (=> (= result1 true) (= (to_rep5 o5) 0)))
(assert (=> (= result1 true) (= (rec__keccak__keccak_1600__sponge__context__state ctx__split_fields9) o6)))
(assert (=> (= result1 true) (= (rec__keccak__keccak_1600__sponge__context__block ctx__split_fields9) o7)))
(assert (=> (= result1 true) (= o5 o8)))
(assert (=> (= result1 true) (= (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields9) o9)))
(assert (=> (= result1 true) (= (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields9) o10)))
(assert (=> (= result1 true) (= (rec__keccak__keccak_1600__sponge__context__curr_state ctx__split_fields9) o11)))
...
(assert (=> (= result1 true) (= ctx__split_fields10 (mk___split_fields temp___998 temp___9981 temp___9982 temp___9983 temp___9984 temp___9985))))
...
(assert (= o13 (rec__keccak__keccak_1600__sponge__context__block ctx__split_fields10)))
...
(assert (= (to_rep o18) (to_rep (last6 keccak__padding__pad101_multi_blocks__next_block__compl1))))
(assert (= (to_rep o17) (to_rep (first6 keccak__padding__pad101_multi_blocks__next_block__compl1))))
(assert (and (= o16 (rate_of (mk___rep ctx__split_fields10))) (and (in_range7 o16) (and (= o16 (* (to_rep6 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields10)) 8)) (< o16 1600)))))
(assert (= (to_rep o15) (to_rep (last4 keccak__padding__pad101_multi_blocks__first_block__compl1))))
(assert (= (to_rep o14) (to_rep (first4 keccak__padding__pad101_multi_blocks__first_block__compl1))))
(assert (not (= (ite (<= (to_rep o17) (to_rep o18)) (+ (- (to_rep o18) (to_rep o17)) 1) 0) (ite (<= (to_rep o14) (to_rep o15)) (+ (- (to_rep o15) (to_rep o14)) 1) 0))))
(check-sat)
(exit)
