...
(assert (= spilled true))
(assert (= (- (to_rep6 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields13)) 1) r128s))
(assert (in_range1 r128s))
(assert (and (= o24 (rate_of (mk___rep ctx__split_fields13))) (and (in_range7 o24) (and (= o24 (* (to_rep6 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields13)) 8)) (< o24 1600)))))
(assert (<= 0 r128s))
(assert (not (<= 0 0)))
(check-sat)
(exit)
