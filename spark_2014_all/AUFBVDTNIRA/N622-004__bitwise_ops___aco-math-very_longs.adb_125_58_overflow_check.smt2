...
(declare-fun user_eq6 (digit_index_type digit_index_type) Bool)
(declare-const dummy6 digit_index_type)
...
(define-fun dynamic_invariant3 ((temp___expr_302 Int) (temp___is_init_298 Bool) (temp___skip_constant_299 Bool) (temp___do_toplevel_300 Bool) (temp___do_typ_inv_301 Bool)) Bool (=> (or (= temp___is_init_298 true) (<= 1 2147483647)) (in_range5 temp___expr_302)))
(declare-fun to_rep3 (digit_index_type) Int)
(declare-fun of_rep3 (Int) digit_index_type)
(assert (forall ((x digit_index_type)) (! (= (of_rep3 (to_rep3 x)) x) :pattern ((to_rep3 x)))))
(assert (forall ((x digit_index_type)) (! (in_range5 (to_rep3 x)) :pattern ((to_rep3 x)))))
(assert (forall ((x Int)) (! (=> (in_range5 x) (= (to_rep3 (of_rep3 x)) x)) :pattern ((to_rep3 (of_rep3 x))))))
(declare-fun to_rep4 (tdigit_index_typeB) Int)
(declare-fun of_rep4 (Int) tdigit_index_typeB)
(assert (forall ((x tdigit_index_typeB)) (! (= (of_rep4 (to_rep4 x)) x) :pattern ((to_rep4 x)))))
(assert (forall ((x tdigit_index_typeB)) (! (in_range4 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range4 f) (=> (in_range4 l) (and (= (to_rep4 (first2 (mk1 f l))) f) (= (to_rep4 (last2 (mk1 f l))) l)))) :pattern ((mk1 f l)))))
(define-fun dynamic_property2 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range4 low) (and (in_range4 high) (=> (<= low high) (and (dynamic_property1 range_first range_last low) (dynamic_property1 range_first range_last high))))))
...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__aco__math__very_longs__very_long__long_digits us_t1)))))
(define-fun us_split_fields_Long_Digits__projection ((a us_split_fields)) us_t1 (rec__aco__math__very_longs__very_long__long_digits a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_discrs1 us_split_discrs) (us_split_fields1 us_split_fields)))))
(define-fun us_rep___projection ((a us_rep)) us_split_discrs (us_split_discrs1 a))
(define-fun us_rep___2__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq4 ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep3 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 a))) (to_rep3 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 b)))) (= (bool_eq3 (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 a)) (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 b))) true)) true false))
...
(define-fun dynamic_invariant4 ((temp___expr_315 us_rep) (temp___is_init_311 Bool) (temp___skip_constant_312 Bool) (temp___do_toplevel_313 Bool) (temp___do_typ_inv_314 Bool)) Bool (let ((temp___316 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 temp___expr_315)))) (and (dynamic_property2 1 (to_rep3 temp___316) (first3 (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 temp___expr_315))) (last3 (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 temp___expr_315)))) (and (= (first3 (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 temp___expr_315))) 1) (= (last3 (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 temp___expr_315))) (to_rep3 temp___316))))))
...
(declare-datatypes () ((tS30bP1__ref (mk_tS30bP1__ref (tS30bP1__content tdigit_index_typeB)))))
(define-fun tS30bP1__ref___projection ((a tS30bP1__ref)) tdigit_index_typeB (tS30bP1__content a))
(declare-sort t2 0)
(declare-fun first4 (t2) tdigit_index_typeB)
(declare-fun last4 (t2) tdigit_index_typeB)
(declare-fun mk2 (Int Int) t2)
(assert (forall ((f Int) (l Int)) (! (=> (in_range4 f) (=> (in_range4 l) (and (= (to_rep4 (first4 (mk2 f l))) f) (= (to_rep4 (last4 (mk2 f l))) l)))) :pattern ((mk2 f l)))))
(define-fun dynamic_property4 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range4 low) (and (in_range4 high) (=> (<= low high) (and (dynamic_property3 range_first range_last low) (dynamic_property3 range_first range_last high))))))
...
(define-fun bool_eq5 ((x us_t2) (y us_t2)) Bool (bool_eq2 (elts2 x) (to_rep4 (first4 (rt2 x))) (to_rep4 (last4 (rt2 x))) (elts2 y) (to_rep4 (first4 (rt2 y))) (to_rep4 (last4 (rt2 y)))))
...
(declare-datatypes () ((t32b__ref (mk_t32b__ref (t32b__content tdigit_index_typeB)))))
(define-fun t32b__ref___projection ((a t32b__ref)) tdigit_index_typeB (t32b__content a))
(declare-sort t3 0)
(declare-fun first6 (t3) tdigit_index_typeB)
(declare-fun last6 (t3) tdigit_index_typeB)
(declare-fun mk3 (Int Int) t3)
(assert (forall ((f Int) (l Int)) (! (=> (in_range4 f) (=> (in_range4 l) (and (= (to_rep4 (first6 (mk3 f l))) f) (= (to_rep4 (last6 (mk3 f l))) l)))) :pattern ((mk3 f l)))))
(define-fun dynamic_property6 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range4 low) (and (in_range4 high) (=> (<= low high) (and (dynamic_property5 range_first range_last low) (dynamic_property5 range_first range_last high))))))
...
(define-fun bool_eq6 ((x us_t3) (y us_t3)) Bool (bool_eq2 (elts3 x) (to_rep4 (first6 (rt3 x))) (to_rep4 (last6 (rt3 x))) (elts3 y) (to_rep4 (first6 (rt3 y))) (to_rep4 (last6 (rt3 y)))))
...
(declare-fun temp___1137 ((_ BitVec 8) Int Int) us_t3)
...
(declare-sort t4 0)
(declare-fun first8 (t4) tdigit_index_typeB)
(declare-fun last8 (t4) tdigit_index_typeB)
(declare-fun mk4 (Int Int) t4)
(assert (forall ((f Int) (l Int)) (! (=> (in_range4 f) (=> (in_range4 l) (and (= (to_rep4 (first8 (mk4 f l))) f) (= (to_rep4 (last8 (mk4 f l))) l)))) :pattern ((mk4 f l)))))
(define-fun dynamic_property7 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range4 low) (and (in_range4 high) (=> (<= low high) (and (in_range5 low) (in_range5 high))))))
...
(define-fun bool_eq7 ((x us_t4) (y us_t4)) Bool (bool_eq2 (elts4 x) (to_rep4 (first8 (rt4 x))) (to_rep4 (last8 (rt4 x))) (elts4 y) (to_rep4 (first8 (rt4 y))) (to_rep4 (last8 (rt4 y)))))
...
(assert (forall ((temp___1139 (_ BitVec 8))) (forall ((temp___1140 Int) (temp___1141 Int)) (let ((temp___1138 (temp___1137 temp___1139 temp___1140 temp___1141))) (=> (dynamic_invariant2 temp___1139 true true true true) (and (=> (dynamic_property7 1 2147483647 temp___1140 temp___1141) (and (= (first7 temp___1138) temp___1140) (= (last7 temp___1138) temp___1141))) (forall ((temp___1142 Int)) (= (to_rep2 (select (to_array3 temp___1138) temp___1142)) temp___1139))))))))
(define-fun dynamic_invariant7 ((temp___expr_309 us_t4) (temp___is_init_305 Bool) (temp___skip_constant_306 Bool) (temp___do_toplevel_307 Bool) (temp___do_typ_inv_308 Bool)) Bool (=> (not (= temp___skip_constant_306 true)) (dynamic_property7 1 2147483647 (first9 temp___expr_309) (last9 temp___expr_309))))
(define-fun dynamic_invariant8 ((temp___expr_572 us_t2) (temp___is_init_568 Bool) (temp___skip_constant_569 Bool) (temp___do_toplevel_570 Bool) (temp___do_typ_inv_571 Bool)) Bool (=> (not (= temp___skip_constant_569 true)) (and (dynamic_property4 1 r31b (first5 temp___expr_572) (last5 temp___expr_572)) (and (= (first5 temp___expr_572) 1) (= (last5 temp___expr_572) r31b)))))
...
(declare-const temp___11451 t2)
(declare-const temp___1147 (Array Int octet))
(declare-const temp___11471 t2)
(declare-const o (Array Int octet))
(declare-const o1 t1)
(declare-const o2 (Array Int octet))
(declare-const o3 t1)
(declare-const temp___1149 digit_index_type)
(declare-const temp___11491 (Array Int octet))
(declare-const temp___11492 t1)
...
(assert (= (length number) (* 2 (to_rep3 (rec__aco__math__very_longs__very_long__octet_length result____split_discrs)))))
(assert (=> (<= 1 2147483647) (in_range5 index)))
(assert (=> (<= 1 2147483647) (in_range2 string_index)))
(assert (= (to_rep3 (rec__aco__math__very_longs__very_long__octet_length result____split_discrs)) r31b))
(assert (in_range5 r31b))
(assert (= (to_rep4 (first6 (rt3 (temp___1137 #x00 1 r31b)))) 1))
(assert (= (to_rep4 (last6 (rt3 (temp___1137 #x00 1 r31b)))) r31b))
(assert (= (mk___t3 temp___1144 temp___11441) (temp___1137 #x00 1 r31b)))
(assert (= (ite (<= (to_rep4 (first6 temp___11441)) (to_rep4 (last6 temp___11441))) (+ (- (to_rep4 (last6 temp___11441)) (to_rep4 (first6 temp___11441))) 1) 0) (ite (<= 1 r31b) (+ (- r31b 1) 1) 0)))
(assert (= temp___1144 temp___1145))
(assert (= (mk2 (to_rep4 (first6 temp___11441)) (to_rep4 (last6 temp___11441))) temp___11451))
(assert (= (ite (<= (to_rep4 (first4 temp___11451)) (to_rep4 (last4 temp___11451))) (+ (- (to_rep4 (last4 temp___11451)) (to_rep4 (first4 temp___11451))) 1) 0) (ite (<= (to_rep4 (first2 result____split_fields1)) (to_rep4 (last2 result____split_fields1))) (+ (- (to_rep4 (last2 result____split_fields1)) (to_rep4 (first2 result____split_fields1))) 1) 0)))
(assert (= (mk___t2 temp___1147 temp___11471) (mk___t2 temp___1145 temp___11451)))
(assert (= temp___1147 o))
(assert (= (mk1 (to_rep4 (first4 temp___11471)) (to_rep4 (last4 temp___11471))) o1))
(assert (= o2 o))
(assert (= o3 o1))
(assert (= result____split_discrs (mk___split_discrs temp___1149)))
(assert (= temp___11491 o2))
(assert (= temp___11492 o3))
(assert (= result (mk___split_fields__ref (mk___split_fields (mk___t1 result____split_fields result____split_fields1)))))
(assert (= result____split_fields2 (mk___split_fields (mk___t1 temp___11491 temp___11492))))
(assert (= result____split_discrs (mk___split_discrs temp___1149)))
(assert (= result1 (mk_bool__ref valid)))
(assert (= valid1 (distinct 1 0)))
(assert (and (= o4 (to_rep4 (last2 (rt1 (rec__aco__math__very_longs__very_long__long_digits result____split_fields2))))) (in_range5 (to_rep4 (last2 (rt1 (rec__aco__math__very_longs__very_long__long_digits result____split_fields2)))))))
...
(assert (= string_index2 (+ (* 2 (- (to_rep4 (last2 (rt1 (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)))) index2)) 1)))
(assert (and (and (dynamic_invariant4 (mk___rep result____split_discrs result____split_fields3) false true true true) (=> (<= 1 2147483647) (in_range5 index2))) (=> (<= 1 2147483647) (in_range2 string_index2))))
(assert (and (= o6 (- (to_rep4 (last2 (rt1 (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)))) index2)) (in_range4 (- (to_rep4 (last2 (rt1 (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)))) index2))))
(assert (= o7 (* 2 o6)))
