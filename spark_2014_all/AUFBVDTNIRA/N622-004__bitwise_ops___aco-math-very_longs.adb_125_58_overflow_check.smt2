...
(define-fun dynamic_invariant3 ((temp___expr_271 Int) (temp___is_init_268 Bool) (temp___skip_constant_269 Bool) (temp___do_toplevel_270 Bool)) Bool (=> (or (= temp___is_init_268 true) (<= 1 2147483647)) (in_range5 temp___expr_271)))
...
(define-fun dynamic_invariant4 ((temp___expr_282 us_rep) (temp___is_init_279 Bool) (temp___skip_constant_280 Bool) (temp___do_toplevel_281 Bool)) Bool (let ((temp___283 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 temp___expr_282)))) (and (dynamic_property2 1 (to_rep3 temp___283) (first3 (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 temp___expr_282))) (last3 (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 temp___expr_282)))) (and (= (first3 (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 temp___expr_282))) 1) (= (last3 (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 temp___expr_282))) (to_rep3 temp___283))))))
...
(declare-fun temp___1052 ((_ BitVec 8) Int Int) us_t3)
(assert (forall ((temp___1054 (_ BitVec 8))) (forall ((temp___1055 Int) (temp___1056 Int)) (let ((temp___1053 (temp___1052 temp___1054 temp___1055 temp___1056))) (and (=> (dynamic_property7 1 2147483647 temp___1055 temp___1056) (and (= (first7 temp___1053) temp___1055) (= (last7 temp___1053) temp___1056))) (forall ((temp___1057 Int)) (= (select (to_array3 temp___1053) temp___1057) (of_rep2 temp___1054))))))))
...
(define-fun dynamic_invariant7 ((temp___expr_528 us_t2) (temp___is_init_525 Bool) (temp___skip_constant_526 Bool) (temp___do_toplevel_527 Bool)) Bool (=> (not (= temp___skip_constant_526 true)) (and (dynamic_property4 1 r31b (first5 temp___expr_528) (last5 temp___expr_528)) (and (= (first5 temp___expr_528) 1) (= (last5 temp___expr_528) r31b)))))
...
(declare-const temp___1059 (Array Int octet))
(declare-const temp___10591 t3)
(declare-const temp___1060 (Array Int octet))
(declare-const temp___10601 t2)
(declare-const temp___1062 (Array Int octet))
(declare-const temp___10621 t2)
(declare-const o2 (Array Int octet))
(declare-const o3 t1)
(declare-const o4 (Array Int octet))
(declare-const o5 t1)
(declare-const temp___1064 digit_index_type)
(declare-const temp___10641 (Array Int octet))
(declare-const temp___10642 t1)
...
(assert (dynamic_invariant4 (mk___rep result____split_discrs (mk___split_fields (mk___t1 result____split_fields result____split_fields1))) false false true))
...
(assert (= (to_rep4 (first6 (rt3 (temp___1052 ((_ int2bv 8) 0) 1 r31b)))) 1))
(assert (= (to_rep4 (last6 (rt3 (temp___1052 ((_ int2bv 8) 0) 1 r31b)))) r31b))
(assert (= (mk___t3 temp___1059 temp___10591) (temp___1052 ((_ int2bv 8) 0) 1 r31b)))
(assert (= (ite (<= (to_rep4 (first6 temp___10591)) (to_rep4 (last6 temp___10591))) (+ (- (to_rep4 (last6 temp___10591)) (to_rep4 (first6 temp___10591))) 1) 0) (ite (<= 1 r31b) (+ (- r31b 1) 1) 0)))
(assert (= temp___1059 temp___1060))
(assert (= (mk2 (to_rep4 (first6 temp___10591)) (to_rep4 (last6 temp___10591))) temp___10601))
(assert (= (ite (<= (to_rep4 (first4 temp___10601)) (to_rep4 (last4 temp___10601))) (+ (- (to_rep4 (last4 temp___10601)) (to_rep4 (first4 temp___10601))) 1) 0) (ite (<= (to_rep4 (first2 result____split_fields1)) (to_rep4 (last2 result____split_fields1))) (+ (- (to_rep4 (last2 result____split_fields1)) (to_rep4 (first2 result____split_fields1))) 1) 0)))
(assert (= (mk___t2 temp___1062 temp___10621) (mk___t2 temp___1060 temp___10601)))
(assert (= temp___1062 o2))
(assert (= (mk1 (to_rep4 (first4 temp___10621)) (to_rep4 (last4 temp___10621))) o3))
(assert (= o4 o2))
(assert (= o5 o3))
(assert (= result____split_discrs (mk___split_discrs temp___1064)))
(assert (= temp___10641 o4))
(assert (= temp___10642 o5))
(assert (= result (mk___split_fields__ref (mk___split_fields (mk___t1 result____split_fields result____split_fields1)))))
(assert (= result____split_fields2 (mk___split_fields (mk___t1 temp___10641 temp___10642))))
(assert (= result____split_discrs (mk___split_discrs temp___1064)))
(assert (= result1 (mk_bool__ref valid)))
(assert (= valid1 (of_int 1)))
(assert (and (= o6 (to_rep4 (last2 (rt1 (rec__aco__math__very_longs__very_long__long_digits result____split_fields2))))) (in_range5 (to_rep4 (last2 (rt1 (rec__aco__math__very_longs__very_long__long_digits result____split_fields2)))))))
(assert (= result2 (mk_int__ref index)))
(assert (= index1 o6))
(assert (and (= o7 (to_rep1 (first (rt number)))) (in_range2 (to_rep1 (first (rt number))))))
(assert (= result3 (mk_int__ref string_index)))
(assert (= string_index1 o7))
...
(assert (and (and (dynamic_invariant4 (mk___rep result____split_discrs result____split_fields3) false true true) (=> (<= 1 2147483647) (in_range5 index2))) (=> (<= 1 2147483647) (in_range2 string_index2))))
(assert (and (= o8 (- (to_rep4 (last2 (rt1 (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)))) index2)) (in_range4 (- (to_rep4 (last2 (rt1 (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)))) index2))))
(assert (= o9 (* 2 o8)))
(assert (not (in_range4 o9)))
(check-sat)
(exit)
