...
(assert (forall ((x octet)) (! (= (of_rep3 (to_rep3 x)) x) :pattern ((to_rep3 x)))))
(assert true)
(assert (forall ((x (_ BitVec 8))) (! (= (to_rep3 (of_rep3 x)) x) :pattern ((to_rep3 (of_rep3 x))))))
(define-fun to_int2 ((x octet)) Int (bv2nat (to_rep3 x)))
...
(define-fun bool_eq2 ((a (Array Int octet)) (a__first Int) (a__last Int) (b (Array Int octet)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (to_rep3 (select a temp___idx_154)) (to_rep3 (select b (+ (- b__first a__first) temp___idx_154))))))) true false))
...
(define-fun to_rep4 ((x tdigit_index_typeB)) Int (tdigit_index_typeBqtint x))
(declare-fun of_rep4 (Int) tdigit_index_typeB)
(assert (forall ((x tdigit_index_typeB)) (! (= (of_rep4 (to_rep4 x)) x) :pattern ((to_rep4 x)))))
(assert (forall ((x tdigit_index_typeB)) (! (in_range5 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(define-fun bool_eq4 ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep2 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 a))) (to_rep2 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 b)))) (= (bool_eq3 (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 a)) (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 b))) true)) true false))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range5 f) (=> (in_range5 l) (and (= (to_rep4 (first4 (mk2 f l))) f) (= (to_rep4 (last4 (mk2 f l))) l)))) :pattern ((mk2 f l)))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range5 f) (=> (in_range5 l) (and (= (to_rep4 (first6 (mk3 f l))) f) (= (to_rep4 (last6 (mk3 f l))) l)))) :pattern ((mk3 f l)))))
...
(declare-fun temp_____aggregate_def_1137 ((_ BitVec 8) Int Int) us_t3)
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range5 f) (=> (in_range5 l) (and (= (to_rep4 (first8 (mk4 f l))) f) (= (to_rep4 (last8 (mk4 f l))) l)))) :pattern ((mk4 f l)))))
...
(assert (forall ((temp___1139 (_ BitVec 8))) (forall ((temp___1140 Int) (temp___1141 Int)) (let ((temp___1138 (temp_____aggregate_def_1137 temp___1139 temp___1140 temp___1141))) (=> (dynamic_invariant2 temp___1139 true true true true) (and (=> (dynamic_property7 1 2147483647 temp___1140 temp___1141) (and (= (first7 temp___1138) temp___1140) (= (last7 temp___1138) temp___1141))) (forall ((temp___1142 Int)) (= (to_rep3 (select (to_array3 temp___1138) temp___1142)) temp___1139))))))))
...
(assert (= (length number) (* 2 (to_rep2 (rec__aco__math__very_longs__very_long__octet_length result____split_discrs)))))
(assert (=> (<= 1 2147483647) (in_range4 index)))
(assert (=> (<= 1 2147483647) (in_range2 string_index)))
(assert (= (to_rep2 (rec__aco__math__very_longs__very_long__octet_length result____split_discrs)) r31b))
(assert (in_range4 r31b))
(assert (= (to_rep4 (first6 (rt3 (temp_____aggregate_def_1137 #x00 1 r31b)))) 1))
(assert (= (to_rep4 (last6 (rt3 (temp_____aggregate_def_1137 #x00 1 r31b)))) r31b))
(assert (= (mk___t3 temp___1144 temp___11441) (temp_____aggregate_def_1137 #x00 1 r31b)))
...
(assert (and (= o4 (to_rep4 (last2 (rt1 (rec__aco__math__very_longs__very_long__long_digits result____split_fields2))))) (in_range4 (to_rep4 (last2 (rt1 (rec__aco__math__very_longs__very_long__long_digits result____split_fields2)))))))
...
(assert (and (and (dynamic_invariant4 (mk___rep result____split_discrs result____split_fields3) false true true true) (=> (<= 1 2147483647) (in_range4 index2))) (=> (<= 1 2147483647) (in_range2 string_index2))))
(assert (and (= o6 (- (to_rep4 (last2 (rt1 (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)))) index2)) (in_range5 (- (to_rep4 (last2 (rt1 (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)))) index2))))
(assert (= o7 (* 2 o6)))
