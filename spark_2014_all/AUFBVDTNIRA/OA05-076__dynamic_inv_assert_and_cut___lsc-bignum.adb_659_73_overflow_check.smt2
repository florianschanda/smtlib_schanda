...
(assert (and (= o630 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o631 (num_of_big_int x x_first o630)))
(assert (= o636 (oexpon o631 o635)))
(assert (= o640 (omultiply o636 o639)))
(assert (= o643 (omod o640 o642)))
