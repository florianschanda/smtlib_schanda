...
(assert (not (= (ite (<= (to_rep1 (first4 temp___9271)) (to_rep1 (last4 temp___9271))) (+ (- (to_rep1 (last4 temp___9271)) (to_rep1 (first4 temp___9271))) 1) 0) (ite (<= r74s r75s) (+ (- r75s r74s) 1) 0))))
(check-sat)
(exit)
