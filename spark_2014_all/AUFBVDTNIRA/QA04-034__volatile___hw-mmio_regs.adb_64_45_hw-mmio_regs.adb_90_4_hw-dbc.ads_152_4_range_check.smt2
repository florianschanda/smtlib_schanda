...
(define-fun word_t__ref___32__projection ((a word_t__ref)) word_t (word_t__content a))
(define-fun dynamic_invariant5 ((temp___expr_1020 (_ BitVec 64)) (temp___is_init_1017 Bool) (temp___skip_constant_1018 Bool) (temp___do_toplevel_1019 Bool)) Bool true)
...
(declare-const hw__dbc__legacy_support_regs__write_i__4__off__assume Int)
...
(assert (= o1 (div1 o 4)))
(assert (and (= hw__dbc__legacy_support_regs__write_i__4__off__assume o1) (in_range2 o1)))
(assert (= hw__dbc__legacy_support_regs__write_i__4__off__assume off))
