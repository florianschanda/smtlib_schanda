...
(assert (= temp___1769 (mk___t1 (slide (elts thestring) (to_rep1 (first (rt thestring))) 1) (mk1 1 (length thestring)))))
(assert (and (= temp___1771 (length thestring)) (in_range1 (length thestring))))
(assert (=> (<= 1 temp___1771) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 temp___1771) (<= temp___1771 150)))))
(assert (= o7 result__5))
(assert (= temp___1772 (mk___t1 o7 (mk1 1 temp___1771))))
(assert (not (= (ite (<= (to_rep1 (first2 (rt1 temp___1769))) (to_rep1 (last2 (rt1 temp___1769)))) (+ (- (to_rep1 (last2 (rt1 temp___1769))) (to_rep1 (first2 (rt1 temp___1769)))) 1) 0) (ite (<= (to_rep1 (first2 (rt1 temp___1772))) (to_rep1 (last2 (rt1 temp___1772)))) (+ (- (to_rep1 (last2 (rt1 temp___1772))) (to_rep1 (first2 (rt1 temp___1772)))) 1) 0))))
(check-sat)
(exit)
