...
(assert (not (= (ite (<= (to_rep1 (first4 temp___5661)) (to_rep1 (last4 temp___5661))) (+ (- (to_rep1 (last4 temp___5661)) (to_rep1 (first4 temp___5661))) 1) 0) (ite (<= (to_rep1 temporary_array__first) (to_rep1 temporary_array__last)) (+ (- (to_rep1 temporary_array__last) (to_rep1 temporary_array__first)) 1) 0))))
(check-sat)
(exit)
