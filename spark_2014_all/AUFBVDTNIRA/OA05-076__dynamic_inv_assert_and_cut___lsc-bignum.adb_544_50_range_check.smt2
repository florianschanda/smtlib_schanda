...
(assert (and (= o32 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (and (= o33 o32) (uint_in_range1 o32)))
(assert (= o34 ((_ int2bv 64) o33)))
(assert (= o35 (bvadd o34 ((_ int2bv 64) 1))))
(assert (= o36 (bvmul o35 ((_ int2bv 64) 32))))
(assert (= o37 (ite (bvult i2 o36) true false)))
...
(assert (and (= o25 (base Tuple0)) (= o25 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
