...
(assert (not (= (ite (<= (to_rep2 (first4 temp___8961)) (to_rep2 (last4 temp___8961))) (+ (- (to_rep2 (last4 temp___8961)) (to_rep2 (first4 temp___8961))) 1) 0) (ite (<= 1 octet_length) (+ (- octet_length 1) 1) 0))))
(check-sat)
(exit)
