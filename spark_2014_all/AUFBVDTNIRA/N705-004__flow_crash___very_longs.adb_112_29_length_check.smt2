...
(assert (not (= (ite (<= (to_rep1 (first4 temp___8961)) (to_rep1 (last4 temp___8961))) (+ (- (to_rep1 (last4 temp___8961)) (to_rep1 (first4 temp___8961))) 1) 0) (ite (<= 1 octet_length) (+ (- octet_length 1) 1) 0))))
(check-sat)
(exit)
