...
(assert (= o1 (div1 o 4)))
(assert (and (= hw__dbc__op_regs__write_i__off__assume o1) (in_range2 o1)))
(assert (= hw__dbc__op_regs__write_i__off__assume off))
...
(assert true)
(assert (not (bvule ((_ zero_extend 32) ((_ int2bv 32) 0)) (bvor (bvand ((_ zero_extend 32) temp1) (bvnot mask1)) (bvshl ((_ zero_extend 56) value) ((_ int2bv 64) (to_rep (rec__hw__dbc__op_s_regs__t__lsb (us_split_fields1 (select regs idx))))))))))
(check-sat)
(exit)
