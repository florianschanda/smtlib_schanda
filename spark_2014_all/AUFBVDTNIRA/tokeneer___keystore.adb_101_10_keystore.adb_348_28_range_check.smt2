...
(assert (= temp___1795 (mk___t3 (slide (elts thestring2) (to_rep1 (first (rt thestring2))) 1) (mk3 1 (length thestring2)))))
(assert (and (= temp___1797 (length thestring2)) (in_range1 (length thestring2))))
(assert (<= 1 temp___1797))
(assert (not (<= 1 1)))
(check-sat)
(exit)
