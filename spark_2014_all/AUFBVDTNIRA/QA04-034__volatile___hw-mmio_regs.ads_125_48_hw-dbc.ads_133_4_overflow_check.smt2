...
(assert (and (= o3 (+ (to_rep (rec__hw__dbc__op_s_regs__t__msb (us_split_fields1 (select regs idx)))) 1)) (in_range1 (+ (to_rep (rec__hw__dbc__op_s_regs__t__msb (us_split_fields1 (select regs idx)))) 1))))
(assert (= o4 (- o3 (to_rep (rec__hw__dbc__op_s_regs__t__lsb (us_split_fields1 (select regs idx)))))))
(assert (and (= o5 o4) (in_range1 o4)))
(assert (and (= o6 o5) (in_range2 o5)))
(assert (= o7 (power 2 o6)))
(assert (and (= o8 o7) (in_range3 o7)))
(assert (and (= o9 o8) (uint_in_range o8)))
(assert (= o10 ((_ int2bv 64) o9)))
(assert (= o11 (ite (bvult value o10) true false)))
