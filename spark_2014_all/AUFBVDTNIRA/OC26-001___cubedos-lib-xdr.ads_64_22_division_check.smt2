...
(define-fun dynamic_invariant2 ((temp___expr_269 (_ BitVec 32)) (temp___is_init_265 Bool) (temp___skip_constant_266 Bool) (temp___do_toplevel_267 Bool) (temp___do_typ_inv_268 Bool)) Bool true)
(assert (forall ((s Int)) (! (=> (dynamic_invariant1 s true true true true) (dynamic_invariant2 (xdr_integer_to_unsigned s) true false true true)) :pattern ((xdr_integer_to_unsigned s)))))
...
(define-fun dynamic_invariant3 ((temp___expr_159 Int) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool) (temp___do_typ_inv_158 Bool)) Bool (=> (or (= temp___is_init_155 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_159)))
