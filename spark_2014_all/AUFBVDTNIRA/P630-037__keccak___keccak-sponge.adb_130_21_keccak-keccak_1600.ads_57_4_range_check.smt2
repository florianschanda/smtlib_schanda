...
(assert (and (= keccak__keccak_1600__sponge__absorb__R99s__assume o29) (in_range1 o29)))
(assert (= keccak__keccak_1600__sponge__absorb__R99s__assume r99s))
(assert (in_range1 r99s))
(assert (<= r98s r99s))
(assert (not (<= (to_rep1 (first (rt data))) r98s)))
(check-sat)
(exit)
