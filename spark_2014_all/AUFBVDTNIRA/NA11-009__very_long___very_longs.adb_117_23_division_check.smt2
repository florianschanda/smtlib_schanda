...
(assert (= temp___808 (mk___rep1 result____split_discrs o10)))
(assert (= result3 (mk___split_fields__ref1 result____split_fields3)))
(assert (= result____split_fields4 (us_split_fields3 temp___808)))
(assert (= result____split_discrs (us_split_discrs2 temp___808)))
