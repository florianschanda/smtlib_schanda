...
(declare-const temp___879 us_rep1)
...
(assert (and (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))) index2) (<= index2 (to_rep1 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))))))
(assert (= o7 index2))
(assert (= o8 (store (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields3)) o7 o6)))
(assert (= o9 (mk___t1 o8 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))))
(assert (= o10 (mk___split_fields1 o9)))
(assert (= temp___879 (mk___rep1 result____split_discrs o10)))
(assert (= result3 (mk___split_fields__ref1 result____split_fields3)))
(assert (= result____split_fields4 (us_split_fields3 temp___879)))
(assert (= result____split_discrs (us_split_discrs2 temp___879)))
