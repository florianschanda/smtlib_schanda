...
(declare-const temp___1820 (_ BitVec 32))
...
(assert (and (and (and (and (<= begidx2 endidx1) (<= begidx2 zlength)) (<= endidx1 zlength)) (=> (= foundtype1 1) (forall ((i7 Int)) (=> (and (<= begidx2 i7) (<= i7 endidx1)) (and (<= 48 (to_rep (select zonefileline i7))) (<= (to_rep (select zonefileline i7)) 57)))))) (and (and (in_range5 begidx2) (in_range5 endidx1)) (in_range4 foundtype1))))
(assert (= foundtype1 1))
...
(assert (= i1 r72b))
(assert (=> (and (<= r72b i1) (<= i1 r73b)) (= temp___1821 tmpval1)))
(assert (=> (and (<= r72b i1) (<= i1 r73b)) (= temp___1820 digitval)))
(assert (=> (and (<= r72b i1) (<= i1 r73b)) (= temp___1819 i1)))
(assert (=> (and (<= r72b i1) (<= i1 r73b)) (and (and (<= 1 begidx2) (<= 0 tmpval2)) (<= tmpval2 4294967295))))
(assert (=> (and (<= r72b i1) (<= i1 r73b)) (and (and (=> (<= r72b r73b) (dynamic_property r72b r73b i2)) (=> (<= (- 9223372036854775808) 9223372036854775807) (in_range2 tmpval2))) (and (<= r72b i2) (<= i2 r73b)))))
(assert (=> (and (<= r72b i1) (<= i1 r73b)) (= digitval2 result4)))
(assert (=> (and (<= r72b i1) (<= i1 r73b)) (= digitval3 (bvsub ((_ int2bv 32) (to_rep (select zonefileline i2))) #x00000030))))
(assert (=> (and (<= r72b i1) (<= i1 r73b)) (and (= o (* 10 tmpval2)) (in_range2 (* 10 tmpval2)))))
(assert (=> (and (<= r72b i1) (<= i1 r73b)) (= o1 (+ o (bv2nat digitval3)))))
(assert (=> (and (<= r72b i1) (<= i1 r73b)) (and (= o2 o1) (in_range2 o1))))
(assert (=> (and (<= r72b i1) (<= i1 r73b)) (= tmpval2 result5)))
(assert (=> (and (<= r72b i1) (<= i1 r73b)) (= tmpval3 o2)))
(assert (=> (and (<= r72b i1) (<= i1 r73b)) (or (< 4294967295 tmpval3) (and (not (< 4294967295 tmpval3)) (= i2 r73b)))))
(assert (=> (and (<= r72b i1) (<= i1 r73b)) (= i2 i3)))
(assert (=> (and (<= r72b i1) (<= i1 r73b)) (= tmpval3 tmpval4)))
(assert (=> (and (<= r72b i1) (<= i1 r73b)) (= digitval3 digitval4)))
(assert (=> (and (<= r72b i1) (<= i1 r73b)) (= i4 i2)))
(assert (=> (and (<= r72b i1) (<= i1 r73b)) (= tmpval5 tmpval3)))
(assert (=> (and (<= r72b i1) (<= i1 r73b)) (= digitval5 digitval3)))
(assert (=> (and (<= r72b i1) (<= i1 r73b)) (= i5 (mk_int__ref i3))))
(assert (=> (and (<= r72b i1) (<= i1 r73b)) (= tmpval6 (mk_int__ref tmpval4))))
(assert (=> (and (<= r72b i1) (<= i1 r73b)) (= digitval8 (mk_t__ref digitval4))))
(assert (=> (and (<= r72b i1) (<= i1 r73b)) (= i6 i4)))
(assert (=> (and (<= r72b i1) (<= i1 r73b)) (= tmpval7 tmpval5)))
(assert (=> (and (<= r72b i1) (<= i1 r73b)) (= digitval7 digitval5)))
(assert (=> (not (and (<= r72b i1) (<= i1 r73b))) (= i5 (mk_int__ref i1))))
(assert (=> (not (and (<= r72b i1) (<= i1 r73b))) (= tmpval6 (mk_int__ref tmpval1))))
(assert (=> (not (and (<= r72b i1) (<= i1 r73b))) (= digitval8 (mk_t__ref digitval))))
(assert (=> (not (and (<= r72b i1) (<= i1 r73b))) (= i6 i1)))
(assert (=> (not (and (<= r72b i1) (<= i1 r73b))) (= tmpval7 tmpval1)))
(assert (=> (not (and (<= r72b i1) (<= i1 r73b))) (= digitval7 digitval1)))
(assert (not (< 4294967295 (int__content tmpval6))))
(assert (not (uint_in_range (int__content tmpval6))))
(check-sat)
(exit)
