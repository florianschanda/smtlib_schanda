...
(assert (= i1 r72b))
(assert (=> (and (<= r72b i1) (<= i1 r73b)) (and (and (= temp___1762 tmpval1) (and (= temp___1761 digitval) (and (= temp___1760 i1) (and (and (and (<= 1 begidx2) (<= 0 tmpval2)) (<= tmpval2 4294967295)) (and (and (and (=> (<= r72b r73b) (dynamic_property r72b r73b i2)) (=> (<= (- 9223372036854775808) 9223372036854775807) (in_range2 tmpval2))) (and (<= r72b i2) (<= i2 r73b))) (and (and (= digitval2 result4) (= digitval3 (bvsub ((_ int2bv 32) (to_rep (select zonefileline i2))) ((_ int2bv 32) 48)))) (and (and (and (and (and (= o (* 10 tmpval2)) (in_range2 (* 10 tmpval2))) (= o1 (+ o (bv2nat digitval3)))) (and (= o2 o1) (in_range2 o1))) (and (= tmpval2 result5) (= tmpval3 o2))) (or (< 4294967295 tmpval3) (and (not (< 4294967295 tmpval3)) (= i2 r73b)))))))))) (and (and (= i2 i6) (and (= tmpval3 tmpval6) (= digitval3 digitval6))) (and (= i7 i2) (and (= tmpval7 tmpval3) (= digitval7 digitval3)))))))
(assert (=> (and (<= r72b i1) (<= i1 r73b)) (= i8 (mk_int__ref i6))))
(assert (=> (and (<= r72b i1) (<= i1 r73b)) (= tmpval8 (mk_int__ref tmpval6))))
(assert (=> (and (<= r72b i1) (<= i1 r73b)) (= (mk_t__ref digitval8) (mk_t__ref digitval6))))
(assert (=> (and (<= r72b i1) (<= i1 r73b)) (= i9 i7)))
(assert (=> (and (<= r72b i1) (<= i1 r73b)) (= tmpval9 tmpval7)))
(assert (=> (and (<= r72b i1) (<= i1 r73b)) (= digitval9 digitval7)))
(assert (=> (not (and (<= r72b i1) (<= i1 r73b))) (= i8 (mk_int__ref i1))))
(assert (=> (not (and (<= r72b i1) (<= i1 r73b))) (= tmpval8 (mk_int__ref tmpval1))))
(assert (=> (not (and (<= r72b i1) (<= i1 r73b))) (= (mk_t__ref digitval8) (mk_t__ref digitval))))
(assert (=> (not (and (<= r72b i1) (<= i1 r73b))) (= i9 i1)))
(assert (=> (not (and (<= r72b i1) (<= i1 r73b))) (= tmpval9 tmpval1)))
(assert (=> (not (and (<= r72b i1) (<= i1 r73b))) (= digitval9 digitval1)))
(assert (not (< 4294967295 (int__content tmpval8))))
(assert (not (uint_in_range (int__content tmpval8))))
(check-sat)
(exit)
