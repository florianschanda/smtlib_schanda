...
(assert (and (= o42 (+ k 1)) (in_range1 (+ k 1))))
(assert (= o43 (ite (<= j3 o42) true false)))
(assert (= o38 (from_word32 #x00000002)))
(assert (= o39 (oexpon o38 j3)))
(assert (= o33 (from_word32 #x00000001)))
(assert (= o32 (from_integer j3)))
(assert (= o34 (osubtract o32 o33)))
(assert (= o31 (from_word64 i2)))
(assert (= o35 (osubtract o31 o34)))
(assert (= o30 (from_word32 #x00000002)))
(assert (= o36 (oexpon__2 o30 o35)))
...
(assert (= o37 (odivide o29 o36)))
(assert (= o40 (omod o37 o39)))
(assert (and (= o19 (- j3 s3)) (in_range1 (- j3 s3))))
(assert (= o20 (- o19 1)))
...
(assert (= o17 (from_word32 w2)))
(assert (= o24 (omultiply o17 o23)))
(assert (= o41 (oeq o24 o40)))
