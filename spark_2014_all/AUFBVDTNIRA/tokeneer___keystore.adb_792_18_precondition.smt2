...
(assert (=> (= result4 true) (= temp___1666 (mk___t1 (slide (elts thestring) (to_rep1 (first (rt thestring))) 1) (mk1 1 (length thestring))))))
(assert (=> (= result4 true) (and (= temp___1668 (length thestring)) (in_range1 (length thestring)))))
(assert (=> (= result4 true) (=> (<= 1 temp___1668) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 temp___1668) (<= temp___1668 150))))))
(assert (=> (= result4 true) (= o11 result__2)))
(assert (=> (= result4 true) (= temp___1669 (mk___t1 o11 (mk1 1 temp___1668)))))
(assert (=> (= result4 true) (= (ite (<= (to_rep1 (first2 (rt1 temp___1666))) (to_rep1 (last2 (rt1 temp___1666)))) (+ (- (to_rep1 (last2 (rt1 temp___1666))) (to_rep1 (first2 (rt1 temp___1666)))) 1) 0) (ite (<= (to_rep1 (first2 (rt1 temp___1669))) (to_rep1 (last2 (rt1 temp___1669)))) (+ (- (to_rep1 (last2 (rt1 temp___1669))) (to_rep1 (first2 (rt1 temp___1669)))) 1) 0))))
(assert (=> (= result4 true) (= temp___1670 temp___1666)))
(assert (=> (= result4 true) (forall ((temp___1671 Int)) (ite (and (<= 1 temp___1671) (<= temp___1671 (length thestring))) (= (select o12 temp___1671) (select (elts1 temp___1670) temp___1671)) (= (select o12 temp___1671) (select result__2 temp___1671))))))
(assert (=> (= result4 true) (= result5 (mk_map__ref result__2))))
(assert (=> (= result4 true) (= result__3 o12)))
...
(assert (=> (not (= result4 true)) (= temp___1665 thestring)))
(assert (=> (not (= result4 true)) (= o13 (elts temp___1665))))
(assert (=> (not (= result4 true)) (= result6 (mk_map__ref result__2))))
(assert (=> (not (= result4 true)) (= result__4 o13)))
(assert (=> (not (= result4 true)) (= result__3 result__4)))
(assert (= result7 (mk_map__ref c148b)))
(assert (= c148b2 result__3))
