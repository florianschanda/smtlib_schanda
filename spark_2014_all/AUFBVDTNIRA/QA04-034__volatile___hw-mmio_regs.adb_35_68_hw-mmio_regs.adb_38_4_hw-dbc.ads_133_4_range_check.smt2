...
(assert true)
(assert true)
(assert (not (bvule ((_ zero_extend 56) ((_ int2bv 8) 0)) (bvand (bvlshr ((_ zero_extend 32) temp1) ((_ int2bv 64) (to_rep (rec__hw__dbc__op_s_regs__t__lsb (us_split_fields1 (select regs idx)))))) mask1))))
(check-sat)
(exit)
