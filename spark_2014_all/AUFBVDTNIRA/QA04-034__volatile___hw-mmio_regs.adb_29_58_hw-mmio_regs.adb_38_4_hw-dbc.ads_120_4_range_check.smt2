...
(define-fun word_t__ref___projection ((a word_t__ref)) word_t (word_t__content a))
(define-fun dynamic_invariant5 ((temp___expr_697 (_ BitVec 8)) (temp___is_init_693 Bool) (temp___skip_constant_694 Bool) (temp___do_toplevel_695 Bool) (temp___do_typ_inv_696 Bool)) Bool true)
...
(declare-const hw__dbc__cap_regs__read_i__off__assume Int)
...
(assert (= o1 (div1 o 4)))
(assert (and (= hw__dbc__cap_regs__read_i__off__assume o1) (in_range2 o1)))
(assert (= hw__dbc__cap_regs__read_i__off__assume off))
