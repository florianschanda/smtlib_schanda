...
(assert (and (= o404 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o405 (num_of_big_int x x_first o404)))
(assert (= o410 (oexpon o405 o409)))
(assert (= o414 (omultiply o410 o413)))
(assert (= o417 (omod o414 o416)))
(assert (and (= o403 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (and (= o397 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o398 (* n3 o397)))
(assert (not (in_range1 o398)))
(check-sat)
(exit)
