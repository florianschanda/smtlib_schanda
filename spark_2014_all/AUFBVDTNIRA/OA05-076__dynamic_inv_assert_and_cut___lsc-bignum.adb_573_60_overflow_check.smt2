...
(assert (= o58 (from_word32 ((_ int2bv 32) 1))))
...
(assert (= o50 (from_word32 ((_ int2bv 32) 2))))
(assert (= o51 (oexpon o50 j3)))
(assert (= o45 (from_word32 ((_ int2bv 32) 1))))
...
(assert (and (= o22 (base Tuple0)) (= o22 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
