...
(assert (= (= o65 true) (forall ((n1 Int)) (=> (and (<= 0 n1) (<= n1 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux45) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n1 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))))
...
(assert (= o36 (num_of_big_int (mk___t (map__content aux310) (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first o35)))
...
(assert (= o21 (num_of_big_int (mk___t aux2 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first o20)))
(assert (= o34 (oeq o21 o33)))
(assert (= o18 (from_word32 ((_ int2bv 32) 1))))
(assert (and (= o16 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o17 (num_of_big_int (mk___t aux1 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first o16)))
