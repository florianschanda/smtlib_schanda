...
(define-fun dynamic_invariant6 ((temp___expr_413 Int) (temp___is_init_409 Bool) (temp___skip_constant_410 Bool) (temp___do_toplevel_411 Bool) (temp___do_typ_inv_412 Bool)) Bool (=> (or (= temp___is_init_409 true) (<= 0 1)) (in_range5 temp___expr_413)))
(assert (forall ((ctx us_rep)) (! (dynamic_invariant6 (state_of ctx) true false true true) :pattern ((state_of ctx)))))
...
(assert (forall ((temp___947 (_ BitVec 8))) (=> (dynamic_invariant3 temp___947 true true true true) (= (to_rep (select (keccak__keccak_1600__sponge__absorb_with_suffix__suffix_array__aggregate_def temp___947) 0)) temp___947))))
...
(assert (dynamic_invariant5 message true false true true))
