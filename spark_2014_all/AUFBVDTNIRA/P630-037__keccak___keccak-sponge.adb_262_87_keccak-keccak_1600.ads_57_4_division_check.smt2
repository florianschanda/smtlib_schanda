...
(assert (forall ((x states)) (! (in_range4 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(assert (forall ((x byte_absorption_number)) (! (in_range5 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(assert (forall ((x bit_absorption_number)) (! (in_range6 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(assert (forall ((x rate_number)) (! (in_range7 (to_rep5 x)) :pattern ((to_rep5 x)))))
...
(define-fun dynamic_invariant3 ((temp___expr_413 Int) (temp___is_init_409 Bool) (temp___skip_constant_410 Bool) (temp___do_toplevel_411 Bool) (temp___do_typ_inv_412 Bool)) Bool (=> (or (= temp___is_init_409 true) (<= 0 1)) (in_range4 temp___expr_413)))
...
(declare-fun user_eq12 (index_number index_number) Bool)
...
(define-fun dynamic_property ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range1 low) (and (in_range1 high) (=> (<= low high) (and (in_range8 low) (in_range8 high))))))
...
(define-fun bool_eq3 ((x us_t) (y us_t)) Bool (bool_eq1 (elts x) (to_rep6 (first (rt x))) (to_rep6 (last (rt x))) (elts y) (to_rep6 (first (rt y))) (to_rep6 (last (rt y)))))
...
(define-fun dynamic_invariant5 ((temp___expr_293 Int) (temp___is_init_289 Bool) (temp___skip_constant_290 Bool) (temp___do_toplevel_291 Bool) (temp___do_typ_inv_292 Bool)) Bool (=> (or (= temp___is_init_289 true) (<= 0 2147483647)) (in_range8 temp___expr_293)))
(define-fun dynamic_invariant6 ((temp___expr_300 us_t) (temp___is_init_296 Bool) (temp___skip_constant_297 Bool) (temp___do_toplevel_298 Bool) (temp___do_typ_inv_299 Bool)) Bool (=> (not (= temp___skip_constant_297 true)) (dynamic_property 0 2147483647 (first1 temp___expr_300) (last1 temp___expr_300))))
...
(assert (forall ((i tTsuffix_arraySP1)) (and (<= 0 (tTsuffix_arraySP1qtint i)) (<= (tTsuffix_arraySP1qtint i) 0))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range1 f) (=> (in_range1 l) (and (= (to_rep6 (first2 (mk1 f l))) f) (= (to_rep6 (last2 (mk1 f l))) l)))) :pattern ((mk1 f l)))))
...
(define-fun first3 ((a us_t1)) Int (to_rep6 (first2 (rt1 a))))
(define-fun last3 ((a us_t1)) Int (to_rep6 (last2 (rt1 a))))
...
(define-fun bool_eq4 ((x us_t1) (y us_t1)) Bool (bool_eq1 (elts1 x) (to_rep6 (first2 (rt1 x))) (to_rep6 (last2 (rt1 x))) (elts1 y) (to_rep6 (first2 (rt1 y))) (to_rep6 (last2 (rt1 y)))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range1 f) (=> (in_range1 l) (and (= (to_rep6 (first4 (mk2 f l))) f) (= (to_rep6 (last4 (mk2 f l))) l)))) :pattern ((mk2 f l)))))
...
(define-fun first5 ((a us_t2)) Int (to_rep6 (first4 (rt2 a))))
(define-fun last5 ((a us_t2)) Int (to_rep6 (last4 (rt2 a))))
...
(define-fun bool_eq5 ((x us_t2) (y us_t2)) Bool (bool_eq1 (elts2 x) (to_rep6 (first4 (rt2 x))) (to_rep6 (last4 (rt2 x))) (elts2 y) (to_rep6 (first4 (rt2 y))) (to_rep6 (last4 (rt2 y)))))
...
(define-fun dynamic_invariant7 ((temp___expr_444 Int) (temp___is_init_440 Bool) (temp___skip_constant_441 Bool) (temp___do_toplevel_442 Bool) (temp___do_typ_inv_443 Bool)) Bool (=> (or (= temp___is_init_440 true) (<= 1 199)) (in_range7 temp___expr_444)))
(define-fun dynamic_invariant8 ((temp___expr_420 Int) (temp___is_init_416 Bool) (temp___skip_constant_417 Bool) (temp___do_toplevel_418 Bool) (temp___do_typ_inv_419 Bool)) Bool (=> (or (= temp___is_init_416 true) (<= 0 199)) (in_range5 temp___expr_420)))
(define-fun dynamic_invariant9 ((temp___expr_437 Int) (temp___is_init_433 Bool) (temp___skip_constant_434 Bool) (temp___do_toplevel_435 Bool) (temp___do_typ_inv_436 Bool)) Bool (=> (or (= temp___is_init_433 true) (<= 0 1599)) (in_range6 temp___expr_437)))
(assert (forall ((temp___947 (_ BitVec 8))) (=> (dynamic_invariant4 temp___947 true true true true) (= (to_rep3 (select (keccak__keccak_1600__sponge__absorb_with_suffix__suffix_array__aggregate_def temp___947) 0)) temp___947))))
...
(declare-const result3 (Array Int byte))
...
(declare-const ctx__split_fields31 us_split_fields)
(define-fun ctx__split_fields32 () us_split_fields (mk___split_fields ctx__split_fields24 ctx__split_fields25 ctx__split_fields26 ctx__split_fields27 ctx__split_fields28 ctx__split_fields29))
(define-fun ctx__split_fields33 () us_split_fields (mk___split_fields ctx__split_fields18 ctx__split_fields19 ctx__split_fields20 ctx__split_fields21 ctx__split_fields22 ctx__split_fields23))
(define-fun ctx__split_fields34 () us_split_fields (mk___split_fields ctx__split_fields12 ctx__split_fields13 ctx__split_fields14 ctx__split_fields15 ctx__split_fields16 ctx__split_fields17))
(define-fun ctx__split_fields35 () us_split_fields (mk___split_fields ctx__split_fields6 ctx__split_fields7 ctx__split_fields8 ctx__split_fields9 ctx__split_fields10 ctx__split_fields11))
...
(assert (= (mk_map__ref1 result) (mk_map__ref1 suffix_array)))
...
(assert (=> (<= 0 2147483647) (in_range8 message_last)))
(assert (and (= o3 (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5)))) (and (in_range3 o3) (and (= o3 (* (to_rep5 ctx__split_fields4) 8)) (< o3 1600)))))
(assert (= (mk_int__ref result2) (mk_int__ref initial_rate)))
(assert (= initial_rate1 o3))
(assert (in_range3 initial_rate1))
(assert (=> (and (= bit_length 0) (< 0 suffix_len)) (and (and (and (= (state_of (mk___rep ctx__split_fields35)) 0) (= (rate_of (mk___rep ctx__split_fields35)) (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5))))) (= (mod2 (in_queue_bit_length (mk___rep ctx__split_fields35)) 8) (mod2 suffix_len 8))) (< (in_queue_bit_length (mk___rep ctx__split_fields35)) (rate_of (mk___rep ctx__split_fields35))))))
...
(assert (=> (and (= bit_length 0) (< 0 suffix_len)) (= suffix_array2 suffix_array1)))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (= suffix_len 0) (and (and (and (= (state_of (mk___rep ctx__split_fields34)) 0) (= (rate_of (mk___rep ctx__split_fields34)) (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5))))) (= (mod2 (in_queue_bit_length (mk___rep ctx__split_fields34)) 8) (mod2 bit_length 8))) (< (in_queue_bit_length (mk___rep ctx__split_fields34)) (rate_of (mk___rep ctx__split_fields34)))))))
...
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (= suffix_len 0) (= suffix_array2 suffix_array1))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (= (mod2 bit_length 8) 0) (and (and (and (= (state_of (mk___rep ctx__split_fields33)) 0) (= (rate_of (mk___rep ctx__split_fields33)) (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5))))) (= (mod2 (in_queue_bit_length (mk___rep ctx__split_fields33)) 8) (mod2 bit_length 8))) (< (in_queue_bit_length (mk___rep ctx__split_fields33)) (rate_of (mk___rep ctx__split_fields33))))))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (= (mod2 bit_length 8) 0) (= (to_rep3 o4) suffix)))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (= (mod2 bit_length 8) 0) (= o5 (store suffix_array1 0 o4))))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (= (mod2 bit_length 8) 0) (= suffix_array1 result3)))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (= (mod2 bit_length 8) 0) (= suffix_array2 o5)))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (= (mod2 bit_length 8) 0) (and (and (and (= (state_of (mk___rep ctx__split_fields32)) 0) (= (rate_of (mk___rep ctx__split_fields32)) (rate_of (mk___rep ctx__split_fields33)))) (= (mod2 (in_queue_bit_length (mk___rep ctx__split_fields32)) 8) (mod2 suffix_len 8))) (< (in_queue_bit_length (mk___rep ctx__split_fields32)) (rate_of (mk___rep ctx__split_fields32))))))))
...
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (not (= (mod2 bit_length 8) 0)) (and (= o6 (+ bit_length 7)) (in_range1 (+ bit_length 7)))))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (not (= (mod2 bit_length 8) 0)) (= o7 (div1 o6 8))))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (not (= (mod2 bit_length 8) 0)) (= o8 (- o7 1))))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (not (= (mod2 bit_length 8) 0)) (= o9 (+ (to_rep6 (first (rt message))) o8))))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (not (= (mod2 bit_length 8) 0)) (and (= o10 o9) (in_range1 o9))))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (not (= (mod2 bit_length 8) 0)) (and (= o11 o10) (in_range8 o10))))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (not (= (mod2 bit_length 8) 0)) (= (mk_int__ref result4) (mk_int__ref message_last))))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (not (= (mod2 bit_length 8) 0)) (= message_last2 o11)))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (not (= (mod2 bit_length 8) 0)) (and (<= (to_rep6 (first (rt message))) message_last2) (<= message_last2 (to_rep6 (last (rt message)))))))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (not (= (mod2 bit_length 8) 0)) (and (= o12 (+ (mod2 bit_length 8) suffix_len)) (in_range1 (+ (mod2 bit_length 8) suffix_len)))))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (not (= (mod2 bit_length 8) 0)) (= result5 (ite (<= o12 8) true false))))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (not (= (mod2 bit_length 8) 0)) (=> (= result5 true) (and (and (and (= (state_of (mk___rep ctx__split_fields30)) 0) (= (mod2 (in_queue_bit_length (mk___rep ctx__split_fields30)) 8) (mod2 (+ bit_length suffix_len) 8))) (< (in_queue_bit_length (mk___rep ctx__split_fields30)) (rate_of (mk___rep ctx__split_fields30)))) (= (rate_of (mk___rep ctx__split_fields30)) initial_rate1)))))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (not (= (mod2 bit_length 8) 0)) (=> (= result5 true) (=> (<= 1 2147483647) (in_range3 initial_rate1)))))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (not (= (mod2 bit_length 8) 0)) (=> (not (= result5 true)) (and (and (and (= (state_of (mk___rep ctx__split_fields31)) 0) (= (mod2 (in_queue_bit_length (mk___rep ctx__split_fields31)) 8) (mod2 (+ bit_length suffix_len) 8))) (< (in_queue_bit_length (mk___rep ctx__split_fields31)) (rate_of (mk___rep ctx__split_fields31)))) (= (rate_of (mk___rep ctx__split_fields31)) initial_rate1)))))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (not (= (mod2 bit_length 8) 0)) (=> (not (= result5 true)) (=> (<= 1 2147483647) (in_range3 initial_rate1)))))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (not (= (mod2 bit_length 8) 0)) (=> (not (= result5 true)) (= suffix_array3 suffix_array4))))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (not (= (mod2 bit_length 8) 0)) (=> (not (= result5 true)) (= ctx__split_fields30 ctx__split_fields31))))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (not (= (mod2 bit_length 8) 0)) (= suffix_array2 suffix_array3)))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (not (= (mod2 bit_length 8) 0)) (= ctx__split_fields32 ctx__split_fields30)))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (= ctx__split_fields34 ctx__split_fields32))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (= ctx__split_fields35 ctx__split_fields34)))
(assert (and (= o17 (rate_of (mk___rep ctx__split_fields35))) (and (in_range3 o17) (and (= o17 (* (to_rep5 ctx__split_fields10) 8)) (< o17 1600)))))
(assert (= o18 (ite (= o17 initial_rate1) true false)))
(assert (and (= o14 (rate_of (mk___rep ctx__split_fields35))) (and (in_range3 o14) (and (= o14 (* (to_rep5 ctx__split_fields10) 8)) (< o14 1600)))))
(assert (and (= o15 (in_queue_bit_length (mk___rep ctx__split_fields35))) (and (in_range2 o15) (and (= o15 (to_rep4 ctx__split_fields8)) (< o15 1600)))))
(assert (= o16 (ite (< o15 o14) true false)))
(assert (and (= o13 (+ bit_length suffix_len)) (in_range1 (+ bit_length suffix_len))))
(assert (not (not (= 8 0))))
(check-sat)
(exit)
