...
(define-fun dynamic_invariant3 ((temp___expr_249 (_ BitVec 8)) (temp___is_init_246 Bool) (temp___skip_constant_247 Bool) (temp___do_toplevel_248 Bool)) Bool true)
...
(define-fun dynamic_invariant4 ((temp___expr_255 Int) (temp___is_init_252 Bool) (temp___skip_constant_253 Bool) (temp___do_toplevel_254 Bool)) Bool (=> (or (= temp___is_init_252 true) (<= 0 2147483647)) (in_range4 temp___expr_255)))
...
(define-fun dynamic_invariant5 ((temp___expr_261 us_t) (temp___is_init_258 Bool) (temp___skip_constant_259 Bool) (temp___do_toplevel_260 Bool)) Bool (=> (not (= temp___skip_constant_259 true)) (dynamic_property 0 2147483647 (first1 temp___expr_261) (last1 temp___expr_261))))
...
(define-fun dynamic_invariant6 ((temp___expr_364 Int) (temp___is_init_361 Bool) (temp___skip_constant_362 Bool) (temp___do_toplevel_363 Bool)) Bool (=> (or (= temp___is_init_361 true) (<= 0 1)) (in_range5 temp___expr_364)))
(assert (forall ((ctx us_rep)) (! (dynamic_invariant6 (state_of ctx) true false true) :pattern ((state_of ctx)))))
...
(declare-datatypes () ((tTsuffix_arraySP1__ref (mk_tTsuffix_arraySP1__ref (tTsuffix_arraySP1__content tTsuffix_arraySP1)))))
(define-fun tTsuffix_arraySP1__ref___projection ((a tTsuffix_arraySP1__ref)) tTsuffix_arraySP1 (tTsuffix_arraySP1__content a))
...
(declare-datatypes () ((t106s__ref (mk_t106s__ref (t106s__content integer)))))
(define-fun t106s__ref___projection ((a t106s__ref)) integer (t106s__content a))
(declare-sort t1 0)
...
(declare-datatypes () ((t109s__ref (mk_t109s__ref (t109s__content integer)))))
(define-fun t109s__ref___projection ((a t109s__ref)) integer (t109s__content a))
(declare-sort t2 0)
...
(assert (forall ((temp___878 (_ BitVec 8))) (= (select (keccak__keccak_1600__sponge__absorb_with_suffix__suffix_array__aggregate_def temp___878) 0) (of_rep temp___878))))
...
(declare-const temp___885 (Array Int byte))
(declare-const temp___8851 t1)
...
(declare-const o45 (Array Int byte))
(declare-const temp___881 (Array Int byte))
(declare-const temp___8811 t2)
...
(declare-const o69 (Array Int byte))
...
(declare-const result5 (Array Int byte))
(declare-const suffix_array2 (Array Int byte))
(declare-const ctx__split_fields30 map1)
(declare-const ctx__split_fields31 (Array Int byte))
(declare-const ctx__split_fields32 bit_absorption_number)
(declare-const ctx__split_fields33 byte_absorption_number)
(declare-const ctx__split_fields34 rate_number)
(declare-const ctx__split_fields35 states)
(declare-const result6 Int)
(declare-const message_last2 Int)
(declare-const result7 Bool)
(declare-const ctx__split_fields36 map1)
(declare-const ctx__split_fields37 (Array Int byte))
(declare-const ctx__split_fields38 bit_absorption_number)
(declare-const ctx__split_fields39 byte_absorption_number)
(declare-const ctx__split_fields40 rate_number)
(declare-const ctx__split_fields41 states)
(declare-const result8 map__ref)
(declare-const suffix_array3 (Array Int byte))
(declare-const ctx__split_fields42 us_split_fields)
(declare-const ctx__split_fields43 us_split_fields)
(declare-const result9 map__ref)
(declare-const suffix_array4 (Array Int byte))
(declare-const ctx__split_fields44 us_split_fields)
(declare-const result10 map__ref)
(declare-const suffix_array5 (Array Int byte))
(declare-const ctx__split_fields45 us_split_fields)
(declare-const ctx__split_fields46 us_split_fields__ref)
(declare-const suffix_array6 map__ref)
(declare-const message_byte_length2 int__ref)
(declare-const message_last3 int__ref)
(declare-const initial_rate2 int__ref)
(declare-const ctx__split_fields47 us_split_fields)
(declare-const suffix_array7 (Array Int byte))
(declare-const message_byte_length3 Int)
(declare-const message_last4 Int)
...
(assert (and (= (state_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5))) 0) (and (<= suffix_len 8) (and (<= bit_length 2147483639) (and (<= (div1 (+ bit_length 7) 8) (length message)) (and (= (mod2 (in_queue_bit_length (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5))) 8) 0) (< (in_queue_bit_length (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5))) (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5))))))))))
(assert (= (mk_map__ref result2) (mk_map__ref suffix_array)))
(assert (= suffix_array1 (keccak__keccak_1600__sponge__absorb_with_suffix__suffix_array__aggregate_def suffix)))
(assert (and (= o6 (+ bit_length 7)) (in_range1 (+ bit_length 7))))
(assert (= o7 (div1 o6 8)))
(assert (and (= o8 o7) (in_range2 o7)))
(assert (= (mk_int__ref result3) (mk_int__ref message_byte_length)))
(assert (= message_byte_length1 o8))
(assert (in_range2 message_byte_length1))
(assert (=> (<= 0 2147483647) (in_range4 message_last)))
(assert (and (= o9 (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5)))) (and (in_range3 o9) (and (= o9 (* (to_rep6 ctx__split_fields4) 8)) (< o9 1600)))))
(assert (= (mk_int__ref result4) (mk_int__ref initial_rate)))
(assert (= initial_rate1 o9))
(assert (in_range3 initial_rate1))
(assert (=> (and (= bit_length 0) (< 0 suffix_len)) (and (and (and (= (state_of (mk___rep (mk___split_fields ctx__split_fields12 ctx__split_fields13 ctx__split_fields14 ctx__split_fields15 ctx__split_fields16 ctx__split_fields17))) 0) (= (rate_of (mk___rep (mk___split_fields ctx__split_fields12 ctx__split_fields13 ctx__split_fields14 ctx__split_fields15 ctx__split_fields16 ctx__split_fields17))) (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5))))) (= (mod2 (in_queue_bit_length (mk___rep (mk___split_fields ctx__split_fields12 ctx__split_fields13 ctx__split_fields14 ctx__split_fields15 ctx__split_fields16 ctx__split_fields17))) 8) (mod2 suffix_len 8))) (< (in_queue_bit_length (mk___rep (mk___split_fields ctx__split_fields12 ctx__split_fields13 ctx__split_fields14 ctx__split_fields15 ctx__split_fields16 ctx__split_fields17))) (rate_of (mk___rep (mk___split_fields ctx__split_fields12 ctx__split_fields13 ctx__split_fields14 ctx__split_fields15 ctx__split_fields16 ctx__split_fields17)))))))
(assert (=> (and (= bit_length 0) (< 0 suffix_len)) (= message_last2 message_last)))
(assert (=> (and (= bit_length 0) (< 0 suffix_len)) (= suffix_array2 suffix_array1)))
(assert (=> (and (= bit_length 0) (< 0 suffix_len)) (= message_last2 message_last1)))
(assert (=> (and (= bit_length 0) (< 0 suffix_len)) (= suffix_array2 suffix_array1)))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (= suffix_len 0) (and (and (and (= (state_of (mk___rep (mk___split_fields ctx__split_fields18 ctx__split_fields19 ctx__split_fields20 ctx__split_fields21 ctx__split_fields22 ctx__split_fields23))) 0) (= (rate_of (mk___rep (mk___split_fields ctx__split_fields18 ctx__split_fields19 ctx__split_fields20 ctx__split_fields21 ctx__split_fields22 ctx__split_fields23))) (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5))))) (= (mod2 (in_queue_bit_length (mk___rep (mk___split_fields ctx__split_fields18 ctx__split_fields19 ctx__split_fields20 ctx__split_fields21 ctx__split_fields22 ctx__split_fields23))) 8) (mod2 bit_length 8))) (< (in_queue_bit_length (mk___rep (mk___split_fields ctx__split_fields18 ctx__split_fields19 ctx__split_fields20 ctx__split_fields21 ctx__split_fields22 ctx__split_fields23))) (rate_of (mk___rep (mk___split_fields ctx__split_fields18 ctx__split_fields19 ctx__split_fields20 ctx__split_fields21 ctx__split_fields22 ctx__split_fields23))))))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (= suffix_len 0) (= message_last2 message_last))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (= suffix_len 0) (= suffix_array2 suffix_array1))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (= suffix_len 0) (= message_last2 message_last1))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (= suffix_len 0) (= suffix_array2 suffix_array1))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (= (mod2 bit_length 8) 0) (and (and (and (= (state_of (mk___rep (mk___split_fields ctx__split_fields24 ctx__split_fields25 ctx__split_fields26 ctx__split_fields27 ctx__split_fields28 ctx__split_fields29))) 0) (= (rate_of (mk___rep (mk___split_fields ctx__split_fields24 ctx__split_fields25 ctx__split_fields26 ctx__split_fields27 ctx__split_fields28 ctx__split_fields29))) (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5))))) (= (mod2 (in_queue_bit_length (mk___rep (mk___split_fields ctx__split_fields24 ctx__split_fields25 ctx__split_fields26 ctx__split_fields27 ctx__split_fields28 ctx__split_fields29))) 8) (mod2 bit_length 8))) (< (in_queue_bit_length (mk___rep (mk___split_fields ctx__split_fields24 ctx__split_fields25 ctx__split_fields26 ctx__split_fields27 ctx__split_fields28 ctx__split_fields29))) (rate_of (mk___rep (mk___split_fields ctx__split_fields24 ctx__split_fields25 ctx__split_fields26 ctx__split_fields27 ctx__split_fields28 ctx__split_fields29)))))))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (= (mod2 bit_length 8) 0) (= (to_rep o10) suffix)))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (= (mod2 bit_length 8) 0) (= o11 (store suffix_array1 0 o10))))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (= (mod2 bit_length 8) 0) (= suffix_array1 result5)))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (= (mod2 bit_length 8) 0) (= suffix_array2 o11)))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (= (mod2 bit_length 8) 0) (and (and (and (= (state_of (mk___rep (mk___split_fields ctx__split_fields30 ctx__split_fields31 ctx__split_fields32 ctx__split_fields33 ctx__split_fields34 ctx__split_fields35))) 0) (= (rate_of (mk___rep (mk___split_fields ctx__split_fields30 ctx__split_fields31 ctx__split_fields32 ctx__split_fields33 ctx__split_fields34 ctx__split_fields35))) (rate_of (mk___rep (mk___split_fields ctx__split_fields24 ctx__split_fields25 ctx__split_fields26 ctx__split_fields27 ctx__split_fields28 ctx__split_fields29))))) (= (mod2 (in_queue_bit_length (mk___rep (mk___split_fields ctx__split_fields30 ctx__split_fields31 ctx__split_fields32 ctx__split_fields33 ctx__split_fields34 ctx__split_fields35))) 8) (mod2 suffix_len 8))) (< (in_queue_bit_length (mk___rep (mk___split_fields ctx__split_fields30 ctx__split_fields31 ctx__split_fields32 ctx__split_fields33 ctx__split_fields34 ctx__split_fields35))) (rate_of (mk___rep (mk___split_fields ctx__split_fields30 ctx__split_fields31 ctx__split_fields32 ctx__split_fields33 ctx__split_fields34 ctx__split_fields35)))))))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (= (mod2 bit_length 8) 0) (= message_last2 message_last)))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (= (mod2 bit_length 8) 0) (= message_last2 message_last1)))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (not (= (mod2 bit_length 8) 0)) (and (= o12 (+ bit_length 7)) (in_range1 (+ bit_length 7)))))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (not (= (mod2 bit_length 8) 0)) (= o13 (div1 o12 8))))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (not (= (mod2 bit_length 8) 0)) (= o14 (- o13 1))))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (not (= (mod2 bit_length 8) 0)) (= o15 (+ (to_rep1 (first (rt message))) o14))))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (not (= (mod2 bit_length 8) 0)) (and (= o16 o15) (in_range1 o15))))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (not (= (mod2 bit_length 8) 0)) (and (= o17 o16) (in_range4 o16))))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (not (= (mod2 bit_length 8) 0)) (= (mk_int__ref result6) (mk_int__ref message_last))))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (not (= (mod2 bit_length 8) 0)) (= message_last2 o17)))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (not (= (mod2 bit_length 8) 0)) (and (<= (to_rep1 (first (rt message))) message_last2) (<= message_last2 (to_rep1 (last (rt message)))))))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (not (= (mod2 bit_length 8) 0)) (and (= o18 (+ (mod2 bit_length 8) suffix_len)) (in_range1 (+ (mod2 bit_length 8) suffix_len)))))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (not (= (mod2 bit_length 8) 0)) (= result7 (ite (<= o18 8) true false))))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (not (= (mod2 bit_length 8) 0)) (=> (= result7 true) (and (and (and (= (state_of (mk___rep ctx__split_fields42)) 0) (= (mod2 (in_queue_bit_length (mk___rep ctx__split_fields42)) 8) (mod2 (+ bit_length suffix_len) 8))) (< (in_queue_bit_length (mk___rep ctx__split_fields42)) (rate_of (mk___rep ctx__split_fields42)))) (= (rate_of (mk___rep ctx__split_fields42)) initial_rate1)))))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (not (= (mod2 bit_length 8) 0)) (=> (= result7 true) (=> (<= 1 2147483647) (in_range3 initial_rate1)))))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (not (= (mod2 bit_length 8) 0)) (=> (not (= result7 true)) (and (and (and (= (state_of (mk___rep ctx__split_fields45)) 0) (= (mod2 (in_queue_bit_length (mk___rep ctx__split_fields45)) 8) (mod2 (+ bit_length suffix_len) 8))) (< (in_queue_bit_length (mk___rep ctx__split_fields45)) (rate_of (mk___rep ctx__split_fields45)))) (= (rate_of (mk___rep ctx__split_fields45)) initial_rate1)))))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (not (= (mod2 bit_length 8) 0)) (=> (not (= result7 true)) (=> (<= 1 2147483647) (in_range3 initial_rate1)))))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (not (= (mod2 bit_length 8) 0)) (=> (not (= result7 true)) (= suffix_array3 suffix_array5))))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (not (= (mod2 bit_length 8) 0)) (=> (not (= result7 true)) (= ctx__split_fields42 ctx__split_fields45))))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (not (= (mod2 bit_length 8) 0)) (= suffix_array2 suffix_array3)))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (not (= (mod2 bit_length 8) 0)) (= (mk___split_fields ctx__split_fields30 ctx__split_fields31 ctx__split_fields32 ctx__split_fields33 ctx__split_fields34 ctx__split_fields35) ctx__split_fields42)))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (= (mk___split_fields ctx__split_fields18 ctx__split_fields19 ctx__split_fields20 ctx__split_fields21 ctx__split_fields22 ctx__split_fields23) (mk___split_fields ctx__split_fields30 ctx__split_fields31 ctx__split_fields32 ctx__split_fields33 ctx__split_fields34 ctx__split_fields35)))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (= (mk___split_fields ctx__split_fields12 ctx__split_fields13 ctx__split_fields14 ctx__split_fields15 ctx__split_fields16 ctx__split_fields17) (mk___split_fields ctx__split_fields18 ctx__split_fields19 ctx__split_fields20 ctx__split_fields21 ctx__split_fields22 ctx__split_fields23))))
(assert (and (= o88 (rate_of (mk___rep (mk___split_fields ctx__split_fields12 ctx__split_fields13 ctx__split_fields14 ctx__split_fields15 ctx__split_fields16 ctx__split_fields17)))) (and (in_range3 o88) (and (= o88 (* (to_rep6 ctx__split_fields16) 8)) (< o88 1600)))))
(assert (= o89 (ite (= o88 initial_rate1) true false)))
(assert (and (= o85 (rate_of (mk___rep (mk___split_fields ctx__split_fields12 ctx__split_fields13 ctx__split_fields14 ctx__split_fields15 ctx__split_fields16 ctx__split_fields17)))) (and (in_range3 o85) (and (= o85 (* (to_rep6 ctx__split_fields16) 8)) (< o85 1600)))))
(assert (and (= o86 (in_queue_bit_length (mk___rep (mk___split_fields ctx__split_fields12 ctx__split_fields13 ctx__split_fields14 ctx__split_fields15 ctx__split_fields16 ctx__split_fields17)))) (and (in_range2 o86) (and (= o86 (to_rep5 ctx__split_fields14)) (< o86 1600)))))
(assert (= o87 (ite (< o86 o85) true false)))
(assert (and (= o82 (+ bit_length suffix_len)) (in_range1 (+ bit_length suffix_len))))
(assert (not (not (= 8 0))))
(check-sat)
(exit)
