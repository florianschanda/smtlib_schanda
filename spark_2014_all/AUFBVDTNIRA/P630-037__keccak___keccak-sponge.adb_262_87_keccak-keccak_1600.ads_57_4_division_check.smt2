...
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (= (mod2 bit_length 8) 0) (= (to_rep o4) suffix)))))
...
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (not (= (mod2 bit_length 8) 0)) (= o9 (+ (to_rep1 (first (rt message))) o8))))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (not (= (mod2 bit_length 8) 0)) (and (= o10 o9) (in_range1 o9))))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (not (= (mod2 bit_length 8) 0)) (and (= o11 o10) (in_range4 o10))))))
...
(assert (and (= o17 (rate_of (mk___rep ctx__split_fields35))) (and (in_range3 o17) (and (= o17 (* (to_rep6 ctx__split_fields10) 8)) (< o17 1600)))))
(assert (= o18 (ite (= o17 initial_rate1) true false)))
(assert (and (= o14 (rate_of (mk___rep ctx__split_fields35))) (and (in_range3 o14) (and (= o14 (* (to_rep6 ctx__split_fields10) 8)) (< o14 1600)))))
(assert (and (= o15 (in_queue_bit_length (mk___rep ctx__split_fields35))) (and (in_range2 o15) (and (= o15 (to_rep5 ctx__split_fields8)) (< o15 1600)))))
