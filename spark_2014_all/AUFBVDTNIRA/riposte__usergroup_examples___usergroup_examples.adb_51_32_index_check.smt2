...
(define-fun dynamic_invariant ((temp___expr_165 (_ BitVec 64)) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool)) Bool true)
...
(define-fun dynamic_invariant2 ((temp___expr_171 Int) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool)) Bool (=> (or (= temp___is_init_168 true) (<= 1 256)) (in_range1 temp___expr_171)))
...
(assert true)
(assert (= result tmp))
(assert (= tmp1 (bvxor (bvmul ((_ int2bv 64) 5) salt) (bvmul ((_ int2bv 64) 7) hash))))
(assert (and (= o (bv2nat tmp1)) (in_range (bv2nat tmp1))))
(assert (= temp___221 (mod2 o 256)))
(assert (not (<= 1 temp___221)))
(check-sat)
(exit)
