...
(assert true)
(assert (forall ((number us_rep)) (! (= (= (is_zero number) true) (forall ((i Int)) (=> (and (<= 1 i) (<= i (last1 (rec__very_longs__very_long__long_digits (us_split_fields1 number))))) (= (to_rep1 (let ((temp___304 (rec__very_longs__very_long__long_digits (us_split_fields1 number)))) (select (to_array temp___304) i))) #x00)))) :pattern ((is_zero number)))))
...
(define-fun dynamic_invariant3 ((temp___expr_747 Int) (temp___is_init_743 Bool) (temp___skip_constant_744 Bool) (temp___do_toplevel_745 Bool) (temp___do_typ_inv_746 Bool)) Bool (=> (or (= temp___is_init_743 true) (<= 1 last2)) (dynamic_property2 1 last2 temp___expr_747)))
(assert (= last2 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor)))))
...
(define-fun dynamic_invariant4 ((temp___expr_754 Int) (temp___is_init_750 Bool) (temp___skip_constant_751 Bool) (temp___do_toplevel_752 Bool) (temp___do_typ_inv_753 Bool)) Bool (=> (or (= temp___is_init_750 true) (<= first2 last3)) (dynamic_property3 first2 last3 temp___expr_754)))
(assert (= first2 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor)))))
(assert (= last3 (- (* 2 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor)))) 1)))
...
(define-fun dynamic_invariant5 ((temp___expr_761 Int) (temp___is_init_757 Bool) (temp___skip_constant_758 Bool) (temp___do_toplevel_759 Bool) (temp___do_typ_inv_760 Bool)) Bool (=> (or (= temp___is_init_757 true) (<= 0 7)) (in_range3 temp___expr_761)))
...
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (us_split_discrs2 a) (mk___split_fields (let ((temp___210 (rec__very_longs__very_long__long_digits1 (us_split_fields3 a)))) (of_array (to_array1 temp___210) (first4 temp___210) (last5 temp___210))))))
...
(define-fun dynamic_invariant6 ((temp___expr_768 us_rep1) (temp___is_init_764 Bool) (temp___skip_constant_765 Bool) (temp___do_toplevel_766 Bool) (temp___do_typ_inv_767 Bool)) Bool (and (=> (not (= temp___skip_constant_765 true)) (in_range4 (+ (* 2 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor)))) 1) (to_base temp___expr_768))) (and (dynamic_property5 1 (+ (* 2 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor)))) 1) (first4 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_768))) (last5 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_768)))) (and (= (first4 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_768))) 1) (= (last5 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_768))) (+ (* 2 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor)))) 1))))))
(define-fun default_initial_assumption ((temp___expr_771 us_rep1) (temp___skip_top_level_772 Bool)) Bool (= (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs2 temp___expr_771))) (+ (* 2 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor)))) 1)))
...
(define-fun to_base1 ((a us_rep2)) us_rep (mk___rep (us_split_discrs3 a) (mk___split_fields (let ((temp___212 (rec__very_longs__very_long__long_digits2 (us_split_fields5 a)))) (of_array (to_array2 temp___212) (first6 temp___212) (last7 temp___212))))))
...
(define-fun bool_eq6 ((a us_rep2) (b us_rep2)) Bool (ite (and (= (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs3 a))) (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs3 b)))) (= (bool_eq5 (rec__very_longs__very_long__long_digits2 (us_split_fields5 a)) (rec__very_longs__very_long__long_digits2 (us_split_fields5 b))) true)) true false))
(define-fun in_range5 ((rec__very_longs__very_long__octet_length1 Int) (a us_rep)) Bool (= rec__very_longs__very_long__octet_length1 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 a)))))
...
(define-fun dynamic_invariant7 ((temp___expr_781 us_rep2) (temp___is_init_777 Bool) (temp___skip_constant_778 Bool) (temp___do_toplevel_779 Bool) (temp___do_typ_inv_780 Bool)) Bool (and (=> (not (= temp___skip_constant_778 true)) (in_range5 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor))) (to_base1 temp___expr_781))) (and (dynamic_property7 1 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor))) (first6 (rec__very_longs__very_long__long_digits2 (us_split_fields5 temp___expr_781))) (last7 (rec__very_longs__very_long__long_digits2 (us_split_fields5 temp___expr_781)))) (and (= (first6 (rec__very_longs__very_long__long_digits2 (us_split_fields5 temp___expr_781))) 1) (= (last7 (rec__very_longs__very_long__long_digits2 (us_split_fields5 temp___expr_781))) (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor))))))))
(define-fun default_initial_assumption1 ((temp___expr_784 us_rep2) (temp___skip_top_level_785 Bool)) Bool (= (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs3 temp___expr_784))) (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor)))))
...
(assert (forall ((number us_rep)) (! (=> (and (dynamic_invariant1 number true true true true) (not (= (is_zero number) true))) (let ((result (get_msd number))) (and (and (not (= (to_rep1 (let ((temp___792 (rec__very_longs__very_long__long_digits (us_split_fields1 number)))) (select (to_array temp___792) result))) #x00)) (forall ((i Int)) (=> (and (<= (+ result 1) i) (<= i (last1 (rec__very_longs__very_long__long_digits (us_split_fields1 number))))) (= (to_rep1 (let ((temp___793 (rec__very_longs__very_long__long_digits (us_split_fields1 number)))) (select (to_array temp___793) i))) #x00)))) (dynamic_invariant result true false true true)))) :pattern ((get_msd number)))))
(define-fun dynamic_invariant8 ((temp___expr_230 (_ BitVec 8)) (temp___is_init_226 Bool) (temp___skip_constant_227 Bool) (temp___do_toplevel_228 Bool) (temp___do_typ_inv_229 Bool)) Bool true)
...
(declare-datatypes () ((tS136bP1__ref (mk_tS136bP1__ref (tS136bP1__content tdigit_index_typeB)))))
(define-fun tS136bP1__ref___projection ((a tS136bP1__ref)) tdigit_index_typeB (tS136bP1__content a))
(declare-sort t3 0)
...
(declare-datatypes () ((t138b__ref (mk_t138b__ref (t138b__content tdigit_index_typeB)))))
(define-fun t138b__ref___projection ((a t138b__ref)) tdigit_index_typeB (t138b__content a))
(declare-sort t4 0)
...
(declare-datatypes () ((tS140bP1__ref (mk_tS140bP1__ref (tS140bP1__content tdigit_index_typeB)))))
(define-fun tS140bP1__ref___projection ((a tS140bP1__ref)) tdigit_index_typeB (tS140bP1__content a))
(declare-sort t5 0)
...
(declare-datatypes () ((t142b__ref (mk_t142b__ref (t142b__content tdigit_index_typeB)))))
(define-fun t142b__ref___projection ((a t142b__ref)) tdigit_index_typeB (t142b__content a))
(declare-sort t6 0)
...
(declare-fun temp___1147 ((_ BitVec 8) Int Int) us_t4)
(declare-fun temp___1160 ((_ BitVec 8) Int Int) us_t6)
(declare-sort t7 0)
...
(assert (forall ((temp___1149 (_ BitVec 8))) (forall ((temp___1150 Int) (temp___1151 Int)) (let ((temp___1148 (temp___1147 temp___1149 temp___1150 temp___1151))) (=> (dynamic_invariant8 temp___1149 true true true true) (and (=> (dynamic_property16 1 2147483647 temp___1150 temp___1151) (and (= (first10 temp___1148) temp___1150) (= (last11 temp___1148) temp___1151))) (forall ((temp___1152 Int)) (= (to_rep1 (select (to_array4 temp___1148) temp___1152)) temp___1149))))))))
(assert (forall ((temp___1162 (_ BitVec 8))) (forall ((temp___1163 Int) (temp___1164 Int)) (let ((temp___1161 (temp___1160 temp___1162 temp___1163 temp___1164))) (=> (dynamic_invariant8 temp___1162 true true true true) (and (=> (dynamic_property16 1 2147483647 temp___1163 temp___1164) (and (= (first14 temp___1161) temp___1163) (= (last15 temp___1161) temp___1164))) (forall ((temp___1165 Int)) (= (to_rep1 (select (to_array6 temp___1161) temp___1165)) temp___1162))))))))
(define-fun dynamic_invariant9 ((temp___expr_237 us_t7) (temp___is_init_233 Bool) (temp___skip_constant_234 Bool) (temp___do_toplevel_235 Bool) (temp___do_typ_inv_236 Bool)) Bool (=> (not (= temp___skip_constant_234 true)) (dynamic_property16 1 2147483647 (first16 temp___expr_237) (last17 temp___expr_237))))
(define-fun dynamic_invariant10 ((temp___expr_854 us_t3) (temp___is_init_850 Bool) (temp___skip_constant_851 Bool) (temp___do_toplevel_852 Bool) (temp___do_typ_inv_853 Bool)) Bool (=> (not (= temp___skip_constant_851 true)) (and (dynamic_property9 1 r137b (first8 temp___expr_854) (last9 temp___expr_854)) (and (= (first8 temp___expr_854) 1) (= (last9 temp___expr_854) r137b)))))
(define-fun dynamic_invariant11 ((temp___expr_864 us_t5) (temp___is_init_860 Bool) (temp___skip_constant_861 Bool) (temp___do_toplevel_862 Bool) (temp___do_typ_inv_863 Bool)) Bool (=> (not (= temp___skip_constant_861 true)) (and (dynamic_property13 1 r141b (first12 temp___expr_864) (last13 temp___expr_864)) (and (= (first12 temp___expr_864) 1) (= (last13 temp___expr_864) r141b)))))
...
(assert (dynamic_invariant1 (mk___rep quotient__split_discrs (mk___split_fields (mk___t quotient__split_fields quotient__split_fields1))) false false true true))
(assert (dynamic_invariant1 (mk___rep remainder__split_discrs (mk___split_fields (mk___t remainder__split_fields remainder__split_fields1))) false false true true))
(assert (and (and (and (not (= (is_zero divisor) true)) (= (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor))) (to_rep (rec__very_longs__very_long__octet_length remainder__split_discrs)))) (= (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 dividend))) (to_rep (rec__very_longs__very_long__octet_length quotient__split_discrs)))) (= (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 dividend))) (* 2 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor)))))))
(assert (and (= us (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor)))) (in_range2 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor))))))
(assert (not (in_range2 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 dividend))))))
(check-sat)
(exit)
