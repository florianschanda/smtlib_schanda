...
(define-fun dynamic_invariant1 ((temp___expr_217 us_rep) (temp___is_init_214 Bool) (temp___skip_constant_215 Bool) (temp___do_toplevel_216 Bool)) Bool (let ((temp___218 (rec__very_longs__very_long__octet_length (us_split_discrs1 temp___expr_217)))) (and (dynamic_property1 1 (to_rep temp___218) (first1 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_217))) (last1 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_217)))) (and (= (first1 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_217))) 1) (= (last1 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_217))) (to_rep temp___218))))))
(declare-fun is_zero (us_rep) Bool)
(declare-fun is_zero__function_guard (Bool us_rep) Bool)
(assert true)
(assert (forall ((number us_rep)) (! (= (= (is_zero number) true) (forall ((i Int)) (=> (and (<= 1 i) (<= i (last1 (rec__very_longs__very_long__long_digits (us_split_fields1 number))))) (= (to_rep1 (let ((temp___276 (rec__very_longs__very_long__long_digits (us_split_fields1 number)))) (select (to_array temp___276) i))) ((_ int2bv 8) 0))))) :pattern ((is_zero number)))))
...
(define-fun dynamic_invariant3 ((temp___expr_686 Int) (temp___is_init_683 Bool) (temp___skip_constant_684 Bool) (temp___do_toplevel_685 Bool)) Bool (=> (or (= temp___is_init_683 true) (<= 1 last2)) (dynamic_property2 1 last2 temp___expr_686)))
...
(define-fun dynamic_invariant4 ((temp___expr_692 Int) (temp___is_init_689 Bool) (temp___skip_constant_690 Bool) (temp___do_toplevel_691 Bool)) Bool (=> (or (= temp___is_init_689 true) (<= first2 last3)) (dynamic_property3 first2 last3 temp___expr_692)))
...
(define-fun dynamic_invariant5 ((temp___expr_698 Int) (temp___is_init_695 Bool) (temp___skip_constant_696 Bool) (temp___do_toplevel_697 Bool)) Bool (=> (or (= temp___is_init_695 true) (<= 0 7)) (in_range3 temp___expr_698)))
...
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (us_split_discrs2 a) (mk___split_fields (let ((temp___188 (rec__very_longs__very_long__long_digits1 (us_split_fields3 a)))) (of_array (to_array1 temp___188) (first4 temp___188) (last5 temp___188))))))
...
(define-fun dynamic_invariant6 ((temp___expr_704 us_rep1) (temp___is_init_701 Bool) (temp___skip_constant_702 Bool) (temp___do_toplevel_703 Bool)) Bool (and (=> (not (= temp___skip_constant_702 true)) (in_range4 (+ (* 2 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor)))) 1) (to_base temp___expr_704))) (and (dynamic_property5 1 (+ (* 2 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor)))) 1) (first4 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_704))) (last5 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_704)))) (and (= (first4 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_704))) 1) (= (last5 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_704))) (+ (* 2 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor)))) 1))))))
(define-fun default_initial_assumption ((temp___expr_707 us_rep1) (temp___skip_top_level_708 Bool)) Bool (= (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs2 temp___expr_707))) (+ (* 2 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor)))) 1)))
...
(define-fun to_base1 ((a us_rep2)) us_rep (mk___rep (us_split_discrs3 a) (mk___split_fields (let ((temp___190 (rec__very_longs__very_long__long_digits2 (us_split_fields5 a)))) (of_array (to_array2 temp___190) (first6 temp___190) (last7 temp___190))))))
...
(define-fun dynamic_invariant7 ((temp___expr_716 us_rep2) (temp___is_init_713 Bool) (temp___skip_constant_714 Bool) (temp___do_toplevel_715 Bool)) Bool (and (=> (not (= temp___skip_constant_714 true)) (in_range5 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor))) (to_base1 temp___expr_716))) (and (dynamic_property7 1 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor))) (first6 (rec__very_longs__very_long__long_digits2 (us_split_fields5 temp___expr_716))) (last7 (rec__very_longs__very_long__long_digits2 (us_split_fields5 temp___expr_716)))) (and (= (first6 (rec__very_longs__very_long__long_digits2 (us_split_fields5 temp___expr_716))) 1) (= (last7 (rec__very_longs__very_long__long_digits2 (us_split_fields5 temp___expr_716))) (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor))))))))
(define-fun default_initial_assumption1 ((temp___expr_719 us_rep2) (temp___skip_top_level_720 Bool)) Bool (= (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs3 temp___expr_719))) (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor)))))
...
(assert (forall ((number us_rep)) (! (=> (and (dynamic_invariant1 number true true true) (not (= (is_zero number) true))) (let ((result (get_msd number))) (and (and (not (= (to_rep1 (let ((temp___727 (rec__very_longs__very_long__long_digits (us_split_fields1 number)))) (select (to_array temp___727) result))) ((_ int2bv 8) 0))) (forall ((i Int)) (=> (and (<= (+ result 1) i) (<= i (last1 (rec__very_longs__very_long__long_digits (us_split_fields1 number))))) (= (to_rep1 (let ((temp___728 (rec__very_longs__very_long__long_digits (us_split_fields1 number)))) (select (to_array temp___728) i))) ((_ int2bv 8) 0))))) (dynamic_invariant result true false true)))) :pattern ((get_msd number)))))
(define-fun dynamic_invariant8 ((temp___expr_206 (_ BitVec 8)) (temp___is_init_203 Bool) (temp___skip_constant_204 Bool) (temp___do_toplevel_205 Bool)) Bool true)
...
(declare-fun temp___1076 ((_ BitVec 8) Int Int) us_t4)
(assert (forall ((temp___1078 (_ BitVec 8))) (forall ((temp___1079 Int) (temp___1080 Int)) (let ((temp___1077 (temp___1076 temp___1078 temp___1079 temp___1080))) (and (=> (dynamic_property16 1 2147483647 temp___1079 temp___1080) (and (= (first10 temp___1077) temp___1079) (= (last11 temp___1077) temp___1080))) (forall ((temp___1081 Int)) (= (select (to_array4 temp___1077) temp___1081) (of_rep1 temp___1078))))))))
(declare-fun temp___1089 ((_ BitVec 8) Int Int) us_t6)
(assert (forall ((temp___1091 (_ BitVec 8))) (forall ((temp___1092 Int) (temp___1093 Int)) (let ((temp___1090 (temp___1089 temp___1091 temp___1092 temp___1093))) (and (=> (dynamic_property16 1 2147483647 temp___1092 temp___1093) (and (= (first14 temp___1090) temp___1092) (= (last15 temp___1090) temp___1093))) (forall ((temp___1094 Int)) (= (select (to_array6 temp___1090) temp___1094) (of_rep1 temp___1091))))))))
(define-fun dynamic_invariant9 ((temp___expr_785 us_t3) (temp___is_init_782 Bool) (temp___skip_constant_783 Bool) (temp___do_toplevel_784 Bool)) Bool (=> (not (= temp___skip_constant_783 true)) (and (dynamic_property9 1 r137b (first8 temp___expr_785) (last9 temp___expr_785)) (and (= (first8 temp___expr_785) 1) (= (last9 temp___expr_785) r137b)))))
(define-fun dynamic_invariant10 ((temp___expr_794 us_t5) (temp___is_init_791 Bool) (temp___skip_constant_792 Bool) (temp___do_toplevel_793 Bool)) Bool (=> (not (= temp___skip_constant_792 true)) (and (dynamic_property13 1 r141b (first12 temp___expr_794) (last13 temp___expr_794)) (and (= (first12 temp___expr_794) 1) (= (last13 temp___expr_794) r141b)))))
...
(declare-const temp___1083 (Array Int octet))
(declare-const temp___10831 t4)
(declare-const temp___1084 (Array Int octet))
(declare-const temp___10841 t3)
(declare-const temp___1086 us_t3)
(declare-const o6 us_t)
(declare-const o7 us_split_fields)
(declare-const temp___1088 us_rep)
(declare-const temp___1096 us_t6)
(declare-const temp___1097 us_t5)
(declare-const temp___1099 us_t5)
...
(declare-const temp___1113 (_ BitVec 16))
(declare-const temp___1112 Int)
(declare-const temp___1111 us_rep)
(declare-const temp___1110 us_rep1)
