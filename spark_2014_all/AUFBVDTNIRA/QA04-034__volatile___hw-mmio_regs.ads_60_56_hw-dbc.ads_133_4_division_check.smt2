...
(assert (and (= o1 (- (to_rep (rec__hw__dbc__op_s_regs__t__msb (us_split_fields1 (select regs idx)))) (to_rep (rec__hw__dbc__op_s_regs__t__lsb (us_split_fields1 (select regs idx)))))) (in_range1 (- (to_rep (rec__hw__dbc__op_s_regs__t__msb (us_split_fields1 (select regs idx)))) (to_rep (rec__hw__dbc__op_s_regs__t__lsb (us_split_fields1 (select regs idx))))))))
(assert (= o2 (+ o1 1)))
(assert (and (= o3 o2) (in_range1 o2)))
(assert (= o4 (ite (<= o3 32) true false)))
