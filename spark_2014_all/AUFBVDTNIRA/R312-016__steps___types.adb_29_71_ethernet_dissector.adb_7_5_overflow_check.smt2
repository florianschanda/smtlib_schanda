...
(declare-sort uxx 0)
(define-fun in_range4 ((x (_ BitVec 64))) Bool (and (bvule #x0000000000000000 x) (bvule x #x0000FFFFFFFFFFFF)))
...
(define-fun uxx__ref___3__projection ((a uxx__ref)) uxx (uxx__content a))
(define-fun dynamic_invariant1 ((temp___expr_647 (_ BitVec 64)) (temp___is_init_643 Bool) (temp___skip_constant_644 Bool) (temp___do_toplevel_645 Bool) (temp___do_typ_inv_646 Bool)) Bool (=> (or (= temp___is_init_643 true) (bvule #x0000000000000000 #x0000FFFFFFFFFFFF)) (in_range4 temp___expr_647)))
...
(assert (= result value))
(assert (= value1 #x0000000000000000))
(assert (in_range4 value1))
(assert (= result1 i))
(assert (= i1 0))
(assert (and (= o3 (power 256 i1)) (in_range2 (power 256 i1))))
(assert (and (= o4 o3) (in_range_int o3)))
(assert (= o5 ((_ int2bv 64) o4)))
(assert (and (= temp___755 (- (to_rep1 (last (rt buffer))) i1)) (in_range1 (- (to_rep1 (last (rt buffer))) i1))))
(assert (and (<= (to_rep1 (first (rt buffer))) temp___755) (<= temp___755 (to_rep1 (last (rt buffer))))))
(assert (= o temp___755))
(assert (= o1 (select (elts buffer) o)))
(assert (= o2 (to_rep o1)))
(assert (= o6 ((_ zero_extend 56) o2)))
(assert (= o7 (bvmul o6 o5)))
(assert (= o8 (bvurem o7 #x0001000000000000)))
(assert (= o9 (bvadd value1 o8)))
(assert (= o10 (bvurem o9 #x0001000000000000)))
