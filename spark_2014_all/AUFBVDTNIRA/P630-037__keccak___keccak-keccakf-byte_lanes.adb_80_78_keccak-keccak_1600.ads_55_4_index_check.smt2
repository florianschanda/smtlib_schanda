...
(assert (=> (<= 64 remaining_bits1) (and (and (= temp___724 a) (and (= temp___723 offset1) (and (= temp___722 remaining_bits1) (and (= temp___721 y1) (and (= temp___720 x1) (and (= 0 temp___728) (and (= 0 temp___727) (and (and (= (mod2 offset2 8) 0) (= (+ offset2 (div1 (+ remaining_bits2 7) 8)) initial_byte_len1)) (and (and (and (and (and (=> (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 4)) (in_range4 x2)) (=> (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 4)) (in_range5 y2))) (=> (<= 0 2147483647) (in_range2 remaining_bits2))) (=> (<= 0 2147483647) (in_range2 offset2))) (<= 64 remaining_bits2)) (and (and (= temp___7281 result6) (= temp___7282 offset2)) (and (and (= temp___7271 result7) (= temp___7272 remaining_bits2)) (and (and (= lane2 result8) (= lane3 ((_ int2bv 64) 0))) (and (and (and (= result9 (mk_int__ref i3)) (= i4 0)) (and (and (and (and (and (and (and (= o17 (* i4 8)) (in_range1 (* i4 8))) (and (= o18 o17) (in_range2 o17))) (= o19 ((_ int2bv 64) o18))) (and (and (and (and (and (and (and (and (= o12 (+ (to_rep1 (first (rt data))) offset2)) (in_range1 (+ (to_rep1 (first (rt data))) offset2))) (= o13 (+ o12 i4))) (and (= temp___714 o13) (in_range1 o13))) (and (and (<= (to_rep1 (first (rt data))) temp___714) (<= temp___714 (to_rep1 (last (rt data))))) (= o14 temp___714))) (= o15 (select (elts data) o14))) (= o16 (to_rep o15))) (= o20 ((_ zero_extend 56) o16))) (= o21 (bvshl o20 o19)))) (= o22 (bvor lane3 o21))) (and (= result10 (mk_t__ref1 lane3)) (= lane4 o22))) (and (and (= result11 (mk_int__ref i4)) (= i5 1)) (and (and (and (and (and (and (and (= o28 (* i5 8)) (in_range1 (* i5 8))) (and (= o29 o28) (in_range2 o28))) (= o30 ((_ int2bv 64) o29))) (and (and (and (and (and (and (and (and (= o23 (+ (to_rep1 (first (rt data))) offset2)) (in_range1 (+ (to_rep1 (first (rt data))) offset2))) (= o24 (+ o23 i5))) (and (= temp___7141 o24) (in_range1 o24))) (and (and (<= (to_rep1 (first (rt data))) temp___7141) (<= temp___7141 (to_rep1 (last (rt data))))) (= o25 temp___7141))) (= o26 (select (elts data) o25))) (= o27 (to_rep o26))) (= o31 ((_ zero_extend 56) o27))) (= o32 (bvshl o31 o30)))) (= o33 (bvor lane4 o32))) (and (= result12 (mk_t__ref1 lane4)) (= lane5 o33))) (and (and (= result13 (mk_int__ref i5)) (= i6 2)) (and (and (and (and (and (and (and (= o39 (* i6 8)) (in_range1 (* i6 8))) (and (= o40 o39) (in_range2 o39))) (= o41 ((_ int2bv 64) o40))) (and (and (and (and (and (and (and (and (= o34 (+ (to_rep1 (first (rt data))) offset2)) (in_range1 (+ (to_rep1 (first (rt data))) offset2))) (= o35 (+ o34 i6))) (and (= temp___7142 o35) (in_range1 o35))) (and (and (<= (to_rep1 (first (rt data))) temp___7142) (<= temp___7142 (to_rep1 (last (rt data))))) (= o36 temp___7142))) (= o37 (select (elts data) o36))) (= o38 (to_rep o37))) (= o42 ((_ zero_extend 56) o38))) (= o43 (bvshl o42 o41)))) (= o44 (bvor lane5 o43))) (and (= result14 (mk_t__ref1 lane5)) (= lane6 o44))) (and (and (= result15 (mk_int__ref i6)) (= i7 3)) (and (and (and (and (and (and (and (= o50 (* i7 8)) (in_range1 (* i7 8))) (and (= o51 o50) (in_range2 o50))) (= o52 ((_ int2bv 64) o51))) (and (and (and (and (and (and (and (and (= o45 (+ (to_rep1 (first (rt data))) offset2)) (in_range1 (+ (to_rep1 (first (rt data))) offset2))) (= o46 (+ o45 i7))) (and (= temp___7143 o46) (in_range1 o46))) (and (and (<= (to_rep1 (first (rt data))) temp___7143) (<= temp___7143 (to_rep1 (last (rt data))))) (= o47 temp___7143))) (= o48 (select (elts data) o47))) (= o49 (to_rep o48))) (= o53 ((_ zero_extend 56) o49))) (= o54 (bvshl o53 o52)))) (= o55 (bvor lane6 o54))) (and (= result16 (mk_t__ref1 lane6)) (= lane7 o55))) (and (and (= result17 (mk_int__ref i7)) (= i8 4)) (and (and (and (and (and (and (and (= o61 (* i8 8)) (in_range1 (* i8 8))) (and (= o62 o61) (in_range2 o61))) (= o63 ((_ int2bv 64) o62))) (and (and (and (and (and (and (and (and (= o56 (+ (to_rep1 (first (rt data))) offset2)) (in_range1 (+ (to_rep1 (first (rt data))) offset2))) (= o57 (+ o56 i8))) (and (= temp___7144 o57) (in_range1 o57))) (and (and (<= (to_rep1 (first (rt data))) temp___7144) (<= temp___7144 (to_rep1 (last (rt data))))) (= o58 temp___7144))) (= o59 (select (elts data) o58))) (= o60 (to_rep o59))) (= o64 ((_ zero_extend 56) o60))) (= o65 (bvshl o64 o63)))) (= o66 (bvor lane7 o65))) (and (= result18 (mk_t__ref1 lane7)) (= lane8 o66))) (and (and (= result19 (mk_int__ref i8)) (= i9 5)) (and (and (and (and (and (and (and (= o72 (* i9 8)) (in_range1 (* i9 8))) (and (= o73 o72) (in_range2 o72))) (= o74 ((_ int2bv 64) o73))) (and (and (and (and (and (and (and (and (= o67 (+ (to_rep1 (first (rt data))) offset2)) (in_range1 (+ (to_rep1 (first (rt data))) offset2))) (= o68 (+ o67 i9))) (and (= temp___7145 o68) (in_range1 o68))) (and (and (<= (to_rep1 (first (rt data))) temp___7145) (<= temp___7145 (to_rep1 (last (rt data))))) (= o69 temp___7145))) (= o70 (select (elts data) o69))) (= o71 (to_rep o70))) (= o75 ((_ zero_extend 56) o71))) (= o76 (bvshl o75 o74)))) (= o77 (bvor lane8 o76))) (and (= result20 (mk_t__ref1 lane8)) (= lane9 o77))) (and (and (= result21 (mk_int__ref i9)) (= i10 6)) (and (and (and (and (and (and (and (= o83 (* i10 8)) (in_range1 (* i10 8))) (and (= o84 o83) (in_range2 o83))) (= o85 ((_ int2bv 64) o84))) (and (and (and (and (and (and (and (and (= o78 (+ (to_rep1 (first (rt data))) offset2)) (in_range1 (+ (to_rep1 (first (rt data))) offset2))) (= o79 (+ o78 i10))) (and (= temp___7146 o79) (in_range1 o79))) (and (and (<= (to_rep1 (first (rt data))) temp___7146) (<= temp___7146 (to_rep1 (last (rt data))))) (= o80 temp___7146))) (= o81 (select (elts data) o80))) (= o82 (to_rep o81))) (= o86 ((_ zero_extend 56) o82))) (= o87 (bvshl o86 o85)))) (= o88 (bvor lane9 o87))) (and (= result22 (mk_t__ref1 lane9)) (= lane10 o88))) (and (and (= result23 (mk_int__ref i10)) (= i11 7)) (and (and (and (and (and (and (= o94 (* i11 8)) (in_range1 (* i11 8))) (and (= o95 o94) (in_range2 o94))) (= o96 ((_ int2bv 64) o95))) (and (and (and (and (and (and (and (and (= o89 (+ (to_rep1 (first (rt data))) offset2)) (in_range1 (+ (to_rep1 (first (rt data))) offset2))) (= o90 (+ o89 i11))) (and (= temp___7147 o90) (in_range1 o90))) (and (and (<= (to_rep1 (first (rt data))) temp___7147) (<= temp___7147 (to_rep1 (last (rt data))))) (= o91 temp___7147))) (= o92 (select (elts data) o91))) (= o93 (to_rep o92))) (= o97 ((_ zero_extend 56) o93))) (= o98 (bvshl o97 o96)))) (= o99 (bvor lane10 o98))) (and (= result24 (mk_t__ref1 lane10)) (= lane11 o99)))))))))))))))))) (and (and (and (= (to_rep2 o100) (bvxor (to_rep2 (get a2 x2 y2)) lane11)) (= o101 (set a2 x2 y2 o100))) (and (= result25 (mk_map__ref1 a2)) (= a3 o101))) (and (and (ite (bvule (bvsub ((_ int2bv 8) 5) x2) ((_ int2bv 8) 1)) (= o102 (bvsub (bvadd x2 ((_ int2bv 8) 1)) ((_ int2bv 8) 5))) (= o102 (bvadd x2 ((_ int2bv 8) 1)))) (and (= result26 (mk_t__ref x2)) (= x3 o102))) (and (ite (= x3 ((_ int2bv 8) 0)) (and (ite (bvule (bvsub ((_ int2bv 8) 5) y2) ((_ int2bv 8) 1)) (= o103 (bvsub (bvadd y2 ((_ int2bv 8) 1)) ((_ int2bv 8) 5))) (= o103 (bvadd y2 ((_ int2bv 8) 1)))) (and (= result27 (mk_t__ref y2)) (= y3 o103))) (= y3 y2)) (and (and (and (= o104 (+ offset2 8)) (in_range1 (+ offset2 8))) (and (= result28 (mk_int__ref offset2)) (= offset3 o104))) (and (and (and (= o105 (- remaining_bits2 64)) (in_range2 (- remaining_bits2 64))) (and (= result29 (mk_int__ref remaining_bits2)) (= remaining_bits3 o105))) (not (<= 64 remaining_bits3)))))))))))))))))))) (and (and (= i14 (mk_int__ref i11)) (and (= lane14 (mk_t__ref1 lane11)) (and (= offset6 (mk_int__ref offset3)) (and (= remaining_bits6 (mk_int__ref remaining_bits3)) (and (= y6 (mk_t__ref y3)) (and (= x6 (mk_t__ref x3)) (= a6 (mk_map__ref1 a3)))))))) (and (= i15 i11) (and (= lane15 lane11) (and (= offset7 offset3) (and (= remaining_bits7 remaining_bits3) (and (= y7 y3) (and (= x7 x3) (= a7 a3)))))))))))
...
(assert (=> (not (<= 64 remaining_bits1)) (= offset8 (mk_int__ref offset1))))
(assert (=> (not (<= 64 remaining_bits1)) (= remaining_bits8 (mk_int__ref remaining_bits1))))
...
(assert (=> (not (<= 64 remaining_bits1)) (= remaining_bits9 remaining_bits1)))
...
(assert true)
(assert (and (= o106 (+ (int__content remaining_bits8) 7)) (in_range1 (+ (int__content remaining_bits8) 7))))
...
(assert (and (= o111 (* i19 8)) (in_range1 (* i19 8))))
(assert (and (= o112 o111) (in_range2 o111)))
(assert (= o113 ((_ int2bv 64) o112)))
(assert (and (= o109 (+ (to_rep1 (first (rt data))) (int__content offset8))) (in_range1 (+ (to_rep1 (first (rt data))) (int__content offset8)))))
(assert (= o110 (+ o109 i19)))
(assert (and (= temp___729 o110) (in_range1 o110)))
(assert (not (<= (to_rep1 (first (rt data))) temp___729)))
(check-sat)
(exit)
