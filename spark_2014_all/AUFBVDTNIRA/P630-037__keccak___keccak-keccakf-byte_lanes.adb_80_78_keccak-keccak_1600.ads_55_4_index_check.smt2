...
(assert (=> (<= 64 remaining_bits1) (and (= temp___783 o4) (in_range1 o4))))
(assert (=> (<= 64 remaining_bits1) (and (<= (to_rep1 (first (rt data))) temp___783) (<= temp___783 (to_rep1 (last (rt data)))))))
(assert (=> (<= 64 remaining_bits1) (= o5 temp___783)))
...
(assert (=> (<= 64 remaining_bits1) (and (= temp___7831 o15) (in_range1 o15))))
(assert (=> (<= 64 remaining_bits1) (and (<= (to_rep1 (first (rt data))) temp___7831) (<= temp___7831 (to_rep1 (last (rt data)))))))
(assert (=> (<= 64 remaining_bits1) (= o16 temp___7831)))
...
(assert (=> (<= 64 remaining_bits1) (and (= temp___7832 o26) (in_range1 o26))))
(assert (=> (<= 64 remaining_bits1) (and (<= (to_rep1 (first (rt data))) temp___7832) (<= temp___7832 (to_rep1 (last (rt data)))))))
(assert (=> (<= 64 remaining_bits1) (= o27 temp___7832)))
...
(assert (=> (<= 64 remaining_bits1) (and (= temp___7833 o37) (in_range1 o37))))
(assert (=> (<= 64 remaining_bits1) (and (<= (to_rep1 (first (rt data))) temp___7833) (<= temp___7833 (to_rep1 (last (rt data)))))))
(assert (=> (<= 64 remaining_bits1) (= o38 temp___7833)))
...
(assert (=> (<= 64 remaining_bits1) (and (= temp___7834 o48) (in_range1 o48))))
(assert (=> (<= 64 remaining_bits1) (and (<= (to_rep1 (first (rt data))) temp___7834) (<= temp___7834 (to_rep1 (last (rt data)))))))
(assert (=> (<= 64 remaining_bits1) (= o49 temp___7834)))
...
(assert (=> (<= 64 remaining_bits1) (and (= temp___7835 o59) (in_range1 o59))))
(assert (=> (<= 64 remaining_bits1) (and (<= (to_rep1 (first (rt data))) temp___7835) (<= temp___7835 (to_rep1 (last (rt data)))))))
(assert (=> (<= 64 remaining_bits1) (= o60 temp___7835)))
...
(assert (=> (<= 64 remaining_bits1) (and (= temp___7836 o70) (in_range1 o70))))
(assert (=> (<= 64 remaining_bits1) (and (<= (to_rep1 (first (rt data))) temp___7836) (<= temp___7836 (to_rep1 (last (rt data)))))))
(assert (=> (<= 64 remaining_bits1) (= o71 temp___7836)))
...
(assert (=> (<= 64 remaining_bits1) (and (= temp___7837 o81) (in_range1 o81))))
(assert (=> (<= 64 remaining_bits1) (and (<= (to_rep1 (first (rt data))) temp___7837) (<= temp___7837 (to_rep1 (last (rt data)))))))
(assert (=> (<= 64 remaining_bits1) (= o82 temp___7837)))
...
(assert (and (= temp___798 o101) (in_range1 o101)))
(assert (not (<= (to_rep1 (first (rt data))) temp___798)))
(check-sat)
(exit)
