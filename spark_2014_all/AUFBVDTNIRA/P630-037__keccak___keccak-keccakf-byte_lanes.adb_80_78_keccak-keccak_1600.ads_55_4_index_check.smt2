...
(declare-const temp___726 (_ BitVec 8))
(declare-const temp___723 map1)
...
(assert (=> (<= 64 remaining_bits1) (= temp___726 x1)))
(assert (=> (<= 64 remaining_bits1) (= temp___723 a)))
(assert (=> (<= 64 remaining_bits1) (= temp___722 offset1)))
(assert (=> (<= 64 remaining_bits1) (= temp___721 remaining_bits1)))
(assert (=> (<= 64 remaining_bits1) (= temp___720 y1)))
...
(assert (=> (<= 64 remaining_bits1) (and (and (and (and (=> (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 4)) (in_range5 y2)) (=> (<= 0 2147483647) (in_range2 remaining_bits2))) (=> (<= 0 2147483647) (in_range2 offset2))) (=> (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 4)) (in_range4 x2))) (<= 64 remaining_bits2))))
...
(assert (=> (<= 64 remaining_bits1) (and (= temp___714 o4) (in_range1 o4))))
(assert (=> (<= 64 remaining_bits1) (and (<= (to_rep1 (first (rt data))) temp___714) (<= temp___714 (to_rep1 (last (rt data)))))))
...
(assert (=> (<= 64 remaining_bits1) (and (= temp___7141 o15) (in_range1 o15))))
(assert (=> (<= 64 remaining_bits1) (and (<= (to_rep1 (first (rt data))) temp___7141) (<= temp___7141 (to_rep1 (last (rt data)))))))
...
(assert (=> (<= 64 remaining_bits1) (and (= temp___7142 o26) (in_range1 o26))))
(assert (=> (<= 64 remaining_bits1) (and (<= (to_rep1 (first (rt data))) temp___7142) (<= temp___7142 (to_rep1 (last (rt data)))))))
...
(assert (=> (<= 64 remaining_bits1) (and (= temp___7143 o37) (in_range1 o37))))
(assert (=> (<= 64 remaining_bits1) (and (<= (to_rep1 (first (rt data))) temp___7143) (<= temp___7143 (to_rep1 (last (rt data)))))))
...
(assert (=> (<= 64 remaining_bits1) (and (= temp___7144 o48) (in_range1 o48))))
(assert (=> (<= 64 remaining_bits1) (and (<= (to_rep1 (first (rt data))) temp___7144) (<= temp___7144 (to_rep1 (last (rt data)))))))
...
(assert (=> (<= 64 remaining_bits1) (and (= temp___7145 o59) (in_range1 o59))))
(assert (=> (<= 64 remaining_bits1) (and (<= (to_rep1 (first (rt data))) temp___7145) (<= temp___7145 (to_rep1 (last (rt data)))))))
...
(assert (=> (<= 64 remaining_bits1) (and (= temp___7146 o70) (in_range1 o70))))
(assert (=> (<= 64 remaining_bits1) (and (<= (to_rep1 (first (rt data))) temp___7146) (<= temp___7146 (to_rep1 (last (rt data)))))))
...
(assert (=> (<= 64 remaining_bits1) (and (= temp___7147 o81) (in_range1 o81))))
(assert (=> (<= 64 remaining_bits1) (and (<= (to_rep1 (first (rt data))) temp___7147) (<= temp___7147 (to_rep1 (last (rt data)))))))
...
(assert (=> (<= 64 remaining_bits1) (=> (bvule (bvsub ((_ int2bv 8) 5) x2) ((_ int2bv 8) 1)) (= o93 (bvsub (bvadd x2 ((_ int2bv 8) 1)) ((_ int2bv 8) 5))))))
(assert (=> (<= 64 remaining_bits1) (=> (not (bvule (bvsub ((_ int2bv 8) 5) x2) ((_ int2bv 8) 1))) (= o93 (bvadd x2 ((_ int2bv 8) 1))))))
(assert (=> (<= 64 remaining_bits1) (= result25 (mk_t__ref x2))))
(assert (=> (<= 64 remaining_bits1) (= x3 o93)))
(assert (=> (<= 64 remaining_bits1) (=> (= x3 ((_ int2bv 8) 0)) (=> (bvule (bvsub ((_ int2bv 8) 5) y2) ((_ int2bv 8) 1)) (= o94 (bvsub (bvadd y2 ((_ int2bv 8) 1)) ((_ int2bv 8) 5)))))))
(assert (=> (<= 64 remaining_bits1) (=> (= x3 ((_ int2bv 8) 0)) (=> (not (bvule (bvsub ((_ int2bv 8) 5) y2) ((_ int2bv 8) 1))) (= o94 (bvadd y2 ((_ int2bv 8) 1)))))))
(assert (=> (<= 64 remaining_bits1) (=> (= x3 ((_ int2bv 8) 0)) (= result26 (mk_t__ref y2)))))
(assert (=> (<= 64 remaining_bits1) (=> (= x3 ((_ int2bv 8) 0)) (= y3 o94))))
(assert (=> (<= 64 remaining_bits1) (=> (not (= x3 ((_ int2bv 8) 0))) (= y3 y2))))
...
(assert (and (= o102 (* i17 8)) (in_range1 (* i17 8))))
(assert (and (= o103 o102) (in_range2 o102)))
(assert (= o104 ((_ int2bv 64) o103)))
(assert (and (= o100 (+ (to_rep1 (first (rt data))) (int__content offset6))) (in_range1 (+ (to_rep1 (first (rt data))) (int__content offset6)))))
(assert (= o101 (+ o100 i17)))
(assert (and (= temp___729 o101) (in_range1 o101)))
