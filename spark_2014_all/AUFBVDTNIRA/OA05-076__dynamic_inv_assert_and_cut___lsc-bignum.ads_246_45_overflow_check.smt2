...
(assert (= o87 (ite (<= o86 (to_rep (last (rt x)))) true false)))
(assert (and (= o81 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o82 (+ x_first o81)))
(assert (and (= o83 o82) (in_range1 o82)))
(assert (= o88 (ite (<= (to_rep (first (rt x))) o83) true false)))
(assert (= result (ite (= o88 true) o87 false)))
(assert (= result true))
...
(assert (= o79 (ite (<= o78 (to_rep (last (rt m)))) true false)))
(assert (and (= o73 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o74 (+ m_first o73)))
(assert (and (= o75 o74) (in_range1 o74)))
(assert (= o80 (ite (<= (to_rep (first (rt m))) o75) true false)))
(assert (= result1 (ite (= o80 true) o79 false)))
(assert (= result1 true))
...
(assert (= o71 (ite (<= o70 (to_rep aux1__last)) true false)))
(assert (and (= o65 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o66 (+ aux1_first o65)))
(assert (and (= o67 o66) (in_range1 o66)))
(assert (= o72 (ite (<= (to_rep aux1__first) o67) true false)))
(assert (= result2 (ite (= o72 true) o71 false)))
(assert (= result2 true))
...
(assert (= o63 (ite (<= o62 (to_rep aux2__last)) true false)))
(assert (and (= o57 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o58 (+ aux2_first o57)))
(assert (and (= o59 o58) (in_range1 o58)))
(assert (= o64 (ite (<= (to_rep aux2__first) o59) true false)))
(assert (= result3 (ite (= o64 true) o63 false)))
(assert (= result3 true))
...
(assert (= o55 (ite (<= o54 (to_rep aux3__last)) true false)))
(assert (and (= o49 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o50 (+ aux3_first o49)))
(assert (and (= o51 o50) (in_range1 o50)))
(assert (= o56 (ite (<= (to_rep aux3__first) o51) true false)))
(assert (= result4 (ite (= o56 true) o55 false)))
(assert (= result4 true))
...
(assert (and (= o40 (power 2 k)) (in_range1 (power 2 k))))
(assert (= o41 (* o40 o39)))
(assert (and (= o42 o41) (in_range1 o41)))
(assert (= o43 (- o42 1)))
(assert (and (= o44 o43) (in_range1 o43)))
(assert (= o45 (+ aux4_first o44)))
(assert (and (= o46 o45) (in_range1 o45)))
(assert (= o47 (ite (<= o46 (to_rep aux4__last)) true false)))
...
(assert (= o35 (+ aux4_first o34)))
(assert (and (= o36 o35) (in_range1 o35)))
(assert (= o48 (ite (<= (to_rep aux4__first) o36) true false)))
(assert (= result5 (ite (= o48 true) o47 false)))
(assert (= result5 true))
(assert (<= k 30))
...
(assert (= o25 (ite (<= o24 (to_rep (last (rt r)))) true false)))
(assert (and (= o19 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o20 (+ r_first o19)))
(assert (and (= o21 o20) (in_range1 o20)))
(assert (= o26 (ite (<= (to_rep (first (rt r))) o21) true false)))
(assert (= result6 (ite (= o26 true) o25 false)))
(assert (= result6 true))
...
(assert (= o10 (from_integer o9)))
(assert (= o6 (from_integer 2)))
(assert (= o11 (omultiply o6 o10)))
(assert (and (= o5 (base Tuple0)) (= o5 (oexpon (from_word32 #x00000002) 32))))
(assert (= o12 (oexpon__2 o5 o11)))
(assert (= o18 (omod o12 o17)))
(assert (and (= o (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o1 (+ o 1)))
(assert (and (= o2 o1) (in_range1 o1)))
(assert (and (= o3 o2) (in_range2 o2)))
(assert (= o4 (num_of_big_int r r_first o3)))
(assert (= result7 (oeq o4 o18)))
(assert (= result7 true))
