...
(assert (= o92 (mod2 o91 8)))
(assert (and (= o90 (in_queue_bit_length (mk___rep (us_split_fields__content ctx__split_fields46)))) (and (in_range2 o90) (and (= o90 (to_rep5 (rec__keccak__keccak_1600__sponge__context__bits_absorbed (us_split_fields__content ctx__split_fields46)))) (< o90 1600)))))
(assert (not (not (= 8 0))))
(check-sat)
(exit)
