...
(assert (and (= o16 (rate_of (mk___rep (us_split_fields__content ctx__split_fields32)))) (and (in_range3 o16) (and (= o16 (* (to_rep6 (rec__keccak__keccak_1600__sponge__context__rate (us_split_fields__content ctx__split_fields32))) 8)) (< o16 1600)))))
(assert (and (= o17 (in_queue_bit_length (mk___rep (us_split_fields__content ctx__split_fields32)))) (and (in_range2 o17) (and (= o17 (to_rep5 (rec__keccak__keccak_1600__sponge__context__bits_absorbed (us_split_fields__content ctx__split_fields32)))) (< o17 1600)))))
...
(assert (and (= o13 (in_queue_bit_length (mk___rep (us_split_fields__content ctx__split_fields32)))) (and (in_range2 o13) (and (= o13 (to_rep5 (rec__keccak__keccak_1600__sponge__context__bits_absorbed (us_split_fields__content ctx__split_fields32)))) (< o13 1600)))))
(assert (not (not (= 8 0))))
(check-sat)
(exit)
