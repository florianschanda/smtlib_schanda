...
(assert (= o15 block3))
(assert (= o15 temp___1114))
(assert (= (mk3 0 r199s) temp___11141))
(assert (= temp___1114 o16))
(assert (= (mk (to_rep (first6 temp___11141)) (to_rep (last6 temp___11141))) o17))
(assert true)
(assert (= result4 ctx__split_fields))
(assert (= result5 ctx__split_fields1))
...
(assert (= result6 ctx__split_fields2))
(assert (= result7 ctx__split_fields3))
