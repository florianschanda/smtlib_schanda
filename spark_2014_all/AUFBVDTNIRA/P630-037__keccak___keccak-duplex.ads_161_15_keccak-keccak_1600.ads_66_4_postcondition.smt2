...
(declare-const temp___1183 (Array Int byte))
(declare-const temp___11831 t3)
...
(assert (=> (<= 0 r199s) (and (and (<= 0 0) (<= 0 199)) (and (<= 0 r199s) (<= r199s 199)))))
(assert (= o11 block3))
(assert (= o11 temp___1183))
(assert (= (mk3 0 r199s) temp___11831))
(assert (= temp___1183 o12))
(assert (= (mk (to_rep (first6 temp___11831)) (to_rep (last6 temp___11831))) o13))
(assert (= result3 ctx__split_fields))
(assert (= result4 ctx__split_fields1))
...
(assert (= ctx__split_fields8 (mk___split_fields ctx__split_fields4 ctx__split_fields5)))
