...
(declare-const temp___1168 us_rep1)
...
(assert (= j1 r137b))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (= temp___1171 current_borrow)))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (= temp___1170 q_hat)))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (= temp___1169 (mk___rep quotient__split_discrs quotient__split_fields2))))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (= temp___1168 (mk___rep1 u__split_discrs u__split_fields2))))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (and (and (dynamic_invariant7 (mk___rep1 u__split_discrs u__split_fields3) false true true true) (dynamic_invariant1 (mk___rep quotient__split_discrs quotient__split_fields3) false true true true)) (and (<= 1 j2) (<= j2 r137b)))))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (and (= o10 j2) (in_range2 j2))))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (and (= o11 j2) (in_range2 j2))))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (dynamic_invariant7 (mk___rep1 u__split_discrs u__split_fields4) true true true true)))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (and (= o12 j2) (in_range2 j2))))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (and (dynamic_invariant7 (mk___rep1 u__split_discrs u__split_fields5) true true true true) (dynamic_invariant1 (mk___rep quotient__split_discrs quotient__split_fields4) true true true true))))
