...
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (= temp___1100 (mk___rep quotient__split_discrs quotient__split_fields2))))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (= temp___1099 (mk___rep1 u__split_discrs u__split_fields2))))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (and (and (dynamic_invariant7 (mk___rep1 u__split_discrs u__split_fields3) false true true) (dynamic_invariant1 (mk___rep quotient__split_discrs quotient__split_fields3) false true true)) (and (<= 1 j2) (<= j2 r137b)))))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (and (= o13 j2) (in_range2 j2))))
(assert true)
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (and (= o14 j2) (in_range2 j2))))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (dynamic_invariant7 (mk___rep1 u__split_discrs u__split_fields4) true true true)))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (and (= o15 j2) (in_range2 j2))))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (and (dynamic_invariant7 (mk___rep1 u__split_discrs u__split_fields5) true true true) (dynamic_invariant1 (mk___rep quotient__split_discrs quotient__split_fields4) true true true))))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (= j2 1)))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (= j3 (mk_int__ref j2))))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (= current_borrow4 (mk_t__ref1 current_borrow3))))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (= q_hat4 (mk_t__ref1 q_hat3))))
...
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (= current_borrow7 current_borrow5)))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (= q_hat7 q_hat5)))
...
(assert (=> (not (and (<= 1 j1) (<= j1 r137b))) (= current_borrow6 (mk_t__ref1 current_borrow))))
(assert (=> (not (and (<= 1 j1) (<= j1 r137b))) (= q_hat6 (mk_t__ref1 q_hat))))
...
(assert (=> (not (and (<= 1 j1) (<= j1 r137b))) (= current_borrow7 current_borrow1)))
(assert (=> (not (and (<= 1 j1) (<= j1 r137b))) (= q_hat7 q_hat1)))
