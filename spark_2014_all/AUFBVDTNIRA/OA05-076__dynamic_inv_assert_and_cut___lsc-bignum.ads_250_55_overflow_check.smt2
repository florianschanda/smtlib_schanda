...
(assert (= o778 (+ o777 1)))
(assert (and (= o779 o778) (in_range1 o778)))
(assert (and (= o780 o779) (in_range2 o779)))
(assert (= o781 (num_of_big_int e e_first o780)))
(assert (and (= o772 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o773 (+ o772 1)))
(assert (not (in_range1 o773)))
(check-sat)
(exit)
