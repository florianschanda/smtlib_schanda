...
(assert (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 pokeresult)) (and (=> (<= 0 0) (in_range4 v)) (and (and (and (= o5 (lemmafunction2 value len)) (and (in_range4 o5) (and (= o5 0) (forall ((i Int)) (=> (and (<= len i) (<= i 63)) (not (= (nth value i) true))))))) (and (= (mk_int__ref result1) (mk_int__ref v)) (= v1 o5))) (and (and (and (and (<= (- 2) pokeresult1) (<= pokeresult1 0)) (and (= (= pokeresult1 (- 1)) (< (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) (+ start len))) (and (= (= pokeresult1 (- 2)) (and (bvule (maxvalue len) value) (<= (+ start len) (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0))))) (and (= (= pokeresult1 0) (and (bvugt (maxvalue len) value) (<= (+ start len) (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0))))) (and (=> (= pokeresult1 0) (forall ((i Int)) (=> (and (<= 0 i) (<= i (- start 1))) (= (= (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) i) true) (= (nth8_stream (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) i) true))))) (and (=> (= pokeresult1 0) (forall ((i Int)) (=> (and (<= start i) (<= i (- (+ start len) 1))) (= (= (nth8_stream (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) i) true) (= (nth value (+ (- (- len i) 1) start)) true))))) (=> (= pokeresult1 0) (forall ((i Int)) (=> (and (<= (+ start len) i) (<= i (- (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) 1))) (= (= (nth8_stream (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) i) true) (= (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) i) true))))))))))) (in_range1 pokeresult1)) (and (= pokeresult1 0) (and (and (and (= o6 (peek start len (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))))) (ite (= (> (+ start len) (* 8 (length (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last)))))) true) (= o6 ((_ int2bv 64) 0)) (=> (= (<= (+ start len) (* 8 (length (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last)))))) true) (and (forall ((i Int)) (=> (and (<= 0 i) (<= i (- len 1))) (= (= (nth8_stream (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) (- (- (+ start len) i) 1)) true) (= (nth o6 i) true)))) (forall ((i Int)) (=> (and (<= len i) (<= i 63)) (not (= (nth o6 i) true)))))))) (and (= (mk_t__ref result2) (mk_t__ref result__)) (= result__1 o6))) (= (eq__logic result__1 value) true))))))) (and (and (= v1 v2) (and (= pokeresult1 pokeresult2) (and (= result__1 result__2) (= addr1 addr2)))) (and (= v3 v1) (and (= pokeresult3 pokeresult1) (and (= result__3 result__1) (= addr3 addr1)))))))
