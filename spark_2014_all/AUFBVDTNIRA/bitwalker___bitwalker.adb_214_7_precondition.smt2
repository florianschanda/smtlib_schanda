...
(assert (forall ((x (_ BitVec 64))) (forall ((len Int)) (! (=> (and (and (dynamic_invariant2 x true true true true) (dynamic_invariant len true true true true)) (and (and (<= 0 len) (<= len 63)) (bvult x (maxvalue len)))) (let ((result (lemmafunction2 x len))) (and (and (= result 0) (forall ((i Int)) (=> (and (<= len i) (<= i 63)) (not (= (nth x i) true))))) (dynamic_invariant4 result true false true true)))) :pattern ((lemmafunction2 x len))))))
...
(assert (= v1 o))
(assert (not (<= (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) 2147483647)))
(check-sat)
(exit)
