...
(assert (=> (<= (to_rep addr__first) (to_rep addr__last)) (= o16 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))
(assert (=> (not (<= (to_rep addr__first) (to_rep addr__last))) (= o16 0)))
(assert (and (= o17 o16) (in_range1 o16)))
(assert (= o18 (* 8 o17)))
(assert (= o19 (- o18 1)))
(assert (= o20 (ite (<= j2 o19) true false)))
(assert (= result5 (ite (<= (+ start i6) j2) o20 false)))
(assert (= result5 true))
(assert (and (= o23 j2) (in_range2 j2)))
(assert (and (= o24 (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) o23)) (= (= o24 true) (= (nth1 (to_rep1 (select addr (div1 o23 8))) (- 7 (mod1 o23 8))) true))))
