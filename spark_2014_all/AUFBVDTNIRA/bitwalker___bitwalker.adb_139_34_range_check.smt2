...
(assert (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 (- start 1))) (= (= (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) j1) true) (= (nth8_stream (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) j1) true)))))
(assert (forall ((j1 Int)) (=> (and (<= start j1) (<= j1 (- (+ start i2) 1))) (= (= (nth8_stream (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) j1) true) (= (nth value (+ (- (- len j1) 1) start)) true)))))
(assert (forall ((j1 Int)) (=> (and (<= (+ start i2) j1) (<= j1 (- (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) 1))) (= (= (nth8_stream (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) j1) true) (= (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) j1) true)))))
(assert (and (=> (<= 0 (- len 1)) (dynamic_property1 0 (- len 1) i2)) (and (<= 0 i2) (<= i2 (- len 1)))))
(assert (=> (<= (to_rep addr__first) (to_rep addr__last)) (= o6 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))
(assert (=> (not (<= (to_rep addr__first) (to_rep addr__last))) (= o6 0)))
(assert (and (= o7 o6) (in_range1 o6)))
(assert (= o8 (* 8 o7)))
(assert (= o9 (- o8 1)))
(assert (= o10 (ite (<= j o9) true false)))
(assert (= result3 (ite (<= (+ start i2) j) o10 false)))
(assert (= result3 true))
(assert (and (= o11 j) (in_range2 j)))
(assert (and (= o12 (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) o11)) (= (= o12 true) (= (nth1 (to_rep1 (select addr (div1 o11 8))) (- 7 (mod1 o11 8))) true))))
