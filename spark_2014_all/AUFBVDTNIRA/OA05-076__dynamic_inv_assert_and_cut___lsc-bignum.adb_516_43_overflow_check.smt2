...
(assert (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t o15 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 #x00000001)) true)) (= (oeq (num_of_big_int (mk___t o18 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t o16 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (oexpon (base Tuple0) (+ l1 1)) (num_of_big_int m m_first (+ l1 1)))) true)) (forall ((n Int)) (=> (and (<= 0 n) (<= n (- h2 1))) (= (oeq (num_of_big_int (mk___t o19 (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))))
...
(assert (= (oeq (num_of_big_int (mk___t o20 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omod (omultiply (omultiply (num_of_big_int (mk___t o19 (mk (to_rep aux4__first) (to_rep aux4__last))) o7 (+ (- a_last a_first) 1)) (num_of_big_int (mk___t o18 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ (- a_last a_first) 1))) (oexpon (inverse (num_of_big_int m m_first (+ (- a_last a_first) 1)) (base Tuple0)) (+ (- a_last a_first) 1))) (num_of_big_int m m_first (+ (- a_last a_first) 1)))) true))
...
(assert (forall ((k1 Int)) (=> (and (<= (to_rep aux4__first) k1) (<= k1 (to_rep aux4__last))) (and (=> (and (<= o13 k1) (<= k1 (- (+ o13 a_last) a_first))) (= (to_rep1 (select o21 k1)) (to_rep1 (select o20 (- (+ a_first k1) o13))))) (=> (=> (<= o13 k1) (not (<= k1 (- (+ o13 a_last) a_first)))) (= (to_rep1 (select o21 k1)) (to_rep1 (select o19 k1))))))))
(assert (= (= o14 true) (forall ((n Int)) (=> (and (<= 0 n) (<= n h2)) (= (oeq (num_of_big_int (mk___t o21 (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))))
