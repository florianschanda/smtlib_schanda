...
(assert (not (= (ite (<= (to_rep1 (first6 temp___5651)) (to_rep1 (last6 temp___5651))) (+ (- (to_rep1 (last6 temp___5651)) (to_rep1 (first6 temp___5651))) 1) 0) (ite (<= 0 (- (length value) 1)) (+ (- (- (length value) 1) 0) 1) 0))))
(check-sat)
(exit)
