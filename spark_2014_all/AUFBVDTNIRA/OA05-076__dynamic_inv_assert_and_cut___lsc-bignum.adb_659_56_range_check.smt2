...
(assert (and (= o629 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (and (= o623 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o624 (* n5 o623)))
(assert (and (= o625 o624) (in_range1 o624)))
(assert (= o626 (+ aux4_first o625)))
(assert (and (= o627 o626) (in_range1 o626)))
(assert (not (in_range2 o627)))
(check-sat)
(exit)
