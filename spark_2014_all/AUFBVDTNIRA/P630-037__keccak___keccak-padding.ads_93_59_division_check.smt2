...
(assert (=> (<= (to_rep block__first) (to_rep block__last)) (= o1 (+ (- (to_rep block__last) (to_rep block__first)) 1))))
(assert (=> (not (<= (to_rep block__first) (to_rep block__last))) (= o1 0)))
(assert (and (= o2 o1) (in_range o1)))
(assert (= result (ite (<= o2 268435455) true false)))
(assert (= result true))
(assert (<= max_bit_length 2147483640))
(assert (and (= o (+ max_bit_length 7)) (in_range (+ max_bit_length 7))))
(assert (not (not (= 8 0))))
(check-sat)
(exit)
