...
(define-fun word_t__ref___26__projection ((a word_t__ref)) word_t (word_t__content a))
(define-fun dynamic_invariant5 ((temp___expr_972 (_ BitVec 16)) (temp___is_init_969 Bool) (temp___skip_constant_970 Bool) (temp___do_toplevel_971 Bool)) Bool true)
...
(declare-const hw__dbc__legacy_support_regs__read_i__2__off__assume Int)
...
(assert (= o1 (div1 o 4)))
(assert (and (= hw__dbc__legacy_support_regs__read_i__2__off__assume o1) (in_range2 o1)))
(assert (= hw__dbc__legacy_support_regs__read_i__2__off__assume off))
...
(assert (= o3 (- o2 (to_rep (rec__hw__dbc__legacy_support_s_regs__t__lsb (us_split_fields1 (select regs idx)))))))
