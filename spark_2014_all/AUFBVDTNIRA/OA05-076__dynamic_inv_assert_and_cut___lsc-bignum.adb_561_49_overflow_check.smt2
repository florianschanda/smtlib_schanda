...
(assert (= o79 (bvadd o78 #x0000000000000001)))
(assert (= o80 (bvmul o79 #x0000000000000020)))
(assert (= o81 (ite (bvult i2 o80) true false)))
(assert (= o73 (from_word32 #x00000001)))
...
(assert (= o65 (from_word32 #x00000002)))
(assert (= o66 (oexpon o65 j3)))
(assert (= o60 (from_word32 #x00000001)))
...
(assert (= o45 (from_word32 #x00000002)))
...
(assert (and (= o31 (base Tuple0)) (= o31 (oexpon (from_word32 #x00000002) 32))))
(assert (= o33 (oexpon o31 o32)))
(assert (= o26 (from_word32 #x00000001)))
...
(assert (and (= o10 (base Tuple0)) (= o10 (oexpon (from_word32 #x00000002) 32))))
