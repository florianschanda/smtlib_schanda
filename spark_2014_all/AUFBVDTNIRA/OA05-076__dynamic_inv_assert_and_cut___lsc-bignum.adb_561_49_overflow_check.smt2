...
(assert (and (= o76 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (and (= o77 o76) (uint_in_range1 o76)))
(assert (= o78 ((_ int2bv 64) o77)))
(assert (= o79 (bvadd o78 ((_ int2bv 64) 1))))
(assert (= o80 (bvmul o79 ((_ int2bv 64) 32))))
(assert (= o81 (ite (bvult i2 o80) true false)))
(assert (= o73 (from_word32 ((_ int2bv 32) 1))))
(assert (= o72 (from_word64 i2)))
(assert (= o74 (oadd o72 o73)))
(assert (= o71 (from_integer j3)))
(assert (= o75 (ole o71 o74)))
(assert (and (= o69 (+ k 1)) (in_range1 (+ k 1))))
(assert (= o70 (ite (<= j3 o69) true false)))
(assert (= o65 (from_word32 ((_ int2bv 32) 2))))
(assert (= o66 (oexpon o65 j3)))
(assert (= o60 (from_word32 ((_ int2bv 32) 1))))
(assert (= o59 (from_integer j3)))
(assert (= o61 (osubtract o59 o60)))
(assert (= o58 (from_word64 i2)))
(assert (= o62 (osubtract o58 o61)))
(assert (= o57 (from_word32 ((_ int2bv 32) 2))))
(assert (= o63 (oexpon__2 o57 o62)))
(assert (and (= o52 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (= o53 (+ o52 1)))
(assert (and (= o54 o53) (in_range1 o53)))
(assert (and (= o55 o54) (in_range2 o54)))
(assert (= o56 (num_of_big_int e e_first o55)))
(assert (= o64 (odivide o56 o63)))
(assert (= o67 (omod o64 o66)))
(assert (and (= o46 (- j3 s3)) (in_range1 (- j3 s3))))
(assert (= o47 (- o46 1)))
(assert (and (= o48 o47) (in_range1 o47)))
(assert (and (= o49 o48) (in_range2 o48)))
(assert (= o45 (from_word32 ((_ int2bv 32) 2))))
(assert (= o50 (oexpon o45 o49)))
(assert (= o44 (from_word32 w2)))
(assert (= o51 (omultiply o44 o50)))
(assert (= o68 (oeq o51 o67)))
(assert (and (= o39 (power 2 k)) (in_range1 (power 2 k))))
(assert (= o40 (- o39 1)))
(assert (and (= o41 o40) (in_range1 o40)))
(assert (= o42 (ite (<= n o41) true false)))
(assert (= result6 (ite (<= 0 n) o42 false)))
(assert (= (= o43 true) (forall ((n1 Int)) (=> (and (<= 0 n1) (<= n1 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux45) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n1 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))))
(assert (and (= o35 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o36 (num_of_big_int m m_first o35)))
(assert (and (= o32 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (and (= o31 (base Tuple0)) (= o31 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o33 (oexpon o31 o32)))
(assert (= o26 (from_word32 ((_ int2bv 32) 1))))
(assert (= o25 (from_word64 i2)))
(assert (= o27 (oadd o25 o26)))
(assert (= o24 (from_word32 ((_ int2bv 32) 2))))
(assert (= o28 (oexpon__2 o24 o27)))
(assert (and (= o19 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (= o20 (+ o19 1)))
(assert (and (= o21 o20) (in_range1 o20)))
(assert (and (= o22 o21) (in_range2 o21)))
(assert (= o23 (num_of_big_int e e_first o22)))
(assert (= o29 (odivide o23 o28)))
(assert (and (= o17 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o18 (num_of_big_int x x_first o17)))
(assert (= o30 (oexpon__2 o18 o29)))
(assert (= o34 (omultiply o30 o33)))
(assert (= o37 (omod o34 o36)))
(assert (and (= o15 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o16 (num_of_big_int (mk___t aux31 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first o15)))
(assert (= o38 (oeq o16 o37)))
(assert (and (= o13 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o14 (num_of_big_int m m_first o13)))
(assert (and (= o11 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (and (= o10 (base Tuple0)) (= o10 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o12 (oexpon o10 o11)))
(assert (and (= o8 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o9 (num_of_big_int x x_first o8)))
