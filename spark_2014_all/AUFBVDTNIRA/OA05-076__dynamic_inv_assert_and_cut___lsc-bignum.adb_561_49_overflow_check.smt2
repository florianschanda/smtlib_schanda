...
(assert (= j2 1))
(assert (and (and (and (and (and (and (and (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t aux11 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 ((_ int2bv 32) 1))) true)) (= (oeq (num_of_big_int (mk___t aux2 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t aux31 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (omultiply (oexpon__2 (num_of_big_int x x_first (+ l1 1)) (odivide (num_of_big_int e e_first (+ (- e_last e_first) 1)) (oexpon__2 (from_word32 ((_ int2bv 32) 2)) (oadd (from_word64 i2) (from_word32 ((_ int2bv 32) 1)))))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (forall ((n7 Int)) (=> (and (<= 0 n7) (<= n7 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux47) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n7 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n7) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))) (= (oeq (omultiply (from_word32 w3) (oexpon (from_word32 ((_ int2bv 32) 2)) (- (- j3 s3) 1))) (omod (odivide (num_of_big_int e e_first (+ (- e_last e_first) 1)) (oexpon__2 (from_word32 ((_ int2bv 32) 2)) (osubtract (from_word64 i2) (osubtract (from_integer j3) (from_word32 ((_ int2bv 32) 1)))))) (oexpon (from_word32 ((_ int2bv 32) 2)) j3))) true)) (= (bvurem w3 ((_ int2bv 32) 2)) ((_ int2bv 32) 1))) (<= 0 s3)) (< s3 j3)) (<= j3 (+ k 1))) (= (ole (from_integer j3) (oadd (from_word64 i2) (from_word32 ((_ int2bv 32) 1)))) true)) (bvult i2 (bvmul (bvadd ((_ int2bv 64) (- e_last e_first)) ((_ int2bv 64) 1)) ((_ int2bv 64) 32)))))
(assert (and (=> (<= 0 2147483647) (in_range2 j3)) (=> (<= 0 2147483647) (in_range2 s3))))
(assert (and (= o451 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (and (= o452 o451) (uint_in_range1 o451)))
(assert (= o453 ((_ int2bv 64) o452)))
(assert (= o454 (bvadd o453 ((_ int2bv 64) 1))))
(assert (= o455 (bvmul o454 ((_ int2bv 64) 32))))
(assert (= o456 (ite (bvult i2 o455) true false)))
(assert (= o448 (from_word32 ((_ int2bv 32) 1))))
(assert (= o447 (from_word64 i2)))
(assert (= o449 (oadd o447 o448)))
(assert (= o446 (from_integer j3)))
(assert (= o450 (ole o446 o449)))
(assert (and (= o444 (+ k 1)) (in_range1 (+ k 1))))
(assert (= o445 (ite (<= j3 o444) true false)))
(assert (= o440 (from_word32 ((_ int2bv 32) 2))))
(assert (= o441 (oexpon o440 j3)))
(assert (= o435 (from_word32 ((_ int2bv 32) 1))))
(assert (= o434 (from_integer j3)))
(assert (= o436 (osubtract o434 o435)))
(assert (= o433 (from_word64 i2)))
(assert (= o437 (osubtract o433 o436)))
(assert (= o432 (from_word32 ((_ int2bv 32) 2))))
(assert (= o438 (oexpon__2 o432 o437)))
(assert (and (= o427 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (= o428 (+ o427 1)))
(assert (and (= o429 o428) (in_range1 o428)))
(assert (and (= o430 o429) (in_range2 o429)))
(assert (= o431 (num_of_big_int e e_first o430)))
(assert (= o439 (odivide o431 o438)))
(assert (= o442 (omod o439 o441)))
(assert (and (= o421 (- j3 s3)) (in_range1 (- j3 s3))))
(assert (= o422 (- o421 1)))
(assert (and (= o423 o422) (in_range1 o422)))
(assert (and (= o424 o423) (in_range2 o423)))
(assert (= o420 (from_word32 ((_ int2bv 32) 2))))
(assert (= o425 (oexpon o420 o424)))
(assert (= o419 (from_word32 w3)))
(assert (= o426 (omultiply o419 o425)))
(assert (= o443 (oeq o426 o442)))
(assert (and (= o393 (power 2 k)) (in_range1 (power 2 k))))
(assert (= o394 (- o393 1)))
(assert (and (= o395 o394) (in_range1 o394)))
(assert (= o396 (ite (<= n3 o395) true false)))
(assert (= result19 (ite (<= 0 n3) o396 false)))
(assert (= (= o418 true) (forall ((n7 Int)) (=> (and (<= 0 n7) (<= n7 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux47) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n7 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n7) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))))
(assert (and (= o387 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o388 (num_of_big_int m m_first o387)))
(assert (and (= o384 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (and (= o383 (base Tuple0)) (= o383 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o385 (oexpon o383 o384)))
(assert (= o378 (from_word32 ((_ int2bv 32) 1))))
(assert (= o377 (from_word64 i2)))
(assert (= o379 (oadd o377 o378)))
(assert (= o376 (from_word32 ((_ int2bv 32) 2))))
(assert (= o380 (oexpon__2 o376 o379)))
(assert (and (= o371 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (= o372 (+ o371 1)))
(assert (and (= o373 o372) (in_range1 o372)))
(assert (and (= o374 o373) (in_range2 o373)))
(assert (= o375 (num_of_big_int e e_first o374)))
(assert (= o381 (odivide o375 o380)))
(assert (and (= o369 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o370 (num_of_big_int x x_first o369)))
(assert (= o382 (oexpon__2 o370 o381)))
(assert (= o386 (omultiply o382 o385)))
(assert (= o389 (omod o386 o388)))
(assert (and (= o367 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o368 (num_of_big_int (mk___t aux31 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first o367)))
(assert (= o390 (oeq o368 o389)))
(assert (and (= o363 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o364 (num_of_big_int m m_first o363)))
(assert (and (= o360 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (and (= o359 (base Tuple0)) (= o359 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o361 (oexpon o359 o360)))
(assert (and (= o356 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o357 (num_of_big_int x x_first o356)))
