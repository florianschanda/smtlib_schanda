...
(assert (and (= o26 (rate_of (mk___rep ctx__split_fields10))) (and (in_range3 o26) (and (= o26 (* (to_rep4 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields10)) 8)) (< o26 1600)))))
(assert (= o27 (ite (= o26 initial_bit_rate1) true false)))
(assert (and (= o24 (state_of (mk___rep ctx__split_fields10))) (and (in_range5 o24) (= o24 (to_rep5 (rec__keccak__keccak_1600__sponge__context__curr_state ctx__split_fields10))))))
...
(assert (not (in_range1 (+ offset3 remaining_bytes3))))
(check-sat)
(exit)
