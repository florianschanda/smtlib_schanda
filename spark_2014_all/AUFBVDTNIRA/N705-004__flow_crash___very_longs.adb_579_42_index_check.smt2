...
(define-fun dynamic_invariant2 ((temp___expr_243 us_rep) (temp___is_init_239 Bool) (temp___skip_constant_240 Bool) (temp___do_toplevel_241 Bool) (temp___do_typ_inv_242 Bool)) Bool (let ((temp___244 (rec__very_longs__very_long__octet_length (us_split_discrs1 temp___expr_243)))) (and (dynamic_property1 1 (to_rep2 temp___244) (first1 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_243))) (last1 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_243)))) (and (= (first1 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_243))) 1) (= (last1 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_243))) (to_rep2 temp___244))))))
(declare-sort bit 0)
