...
(define-fun in_range6 ((x Int)) Bool (and (<= 1 x) (<= x 65536)))
...
(define-fun dynamic_invariant2 ((temp___expr_204 Int) (temp___is_init_201 Bool) (temp___skip_constant_202 Bool) (temp___do_toplevel_203 Bool)) Bool (=> (or (= temp___is_init_201 true) (<= 1 65536)) (in_range6 temp___expr_204)))
...
(assert (forall ((x digit_index_type)) (! (in_range6 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(define-fun bool_eq2 ((a (Array Int octet)) (a__first Int) (a__last Int) (b (Array Int octet)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_132 Int)) (=> (and (<= a__first temp___idx_132) (<= temp___idx_132 a__last)) (= (to_rep3 (select a temp___idx_132)) (to_rep3 (select b (+ (- b__first a__first) temp___idx_132))))))) true false))
...
(assert (forall ((a (Array Int octet)) (b (Array Int octet))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare1 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq2 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (bvult (to_rep3 (select a (+ i 1))) (to_rep3 (select b (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int octet)) (b (Array Int octet))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare1 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq2 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (bvugt (to_rep3 (select a (+ j 1))) (to_rep3 (select b (+ i 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(declare-fun to_rep4 (tdigit_count_typeB) Int)
(declare-fun of_rep4 (Int) tdigit_count_typeB)
(assert (forall ((x tdigit_count_typeB)) (! (= (of_rep4 (to_rep4 x)) x) :pattern ((to_rep4 x)))))
(assert (forall ((x tdigit_count_typeB)) (! (in_range5 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(define-fun dynamic_invariant4 ((temp___expr_221 us_rep) (temp___is_init_218 Bool) (temp___skip_constant_219 Bool) (temp___do_toplevel_220 Bool)) Bool (let ((temp___222 (rec__very_longs__very_long__length (us_split_discrs1 temp___expr_221)))) (and (dynamic_property2 1 (to_rep2 temp___222) (first3 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_221))) (last3 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_221)))) (and (= (first3 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_221))) 1) (= (last3 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_221))) (to_rep2 temp___222))))))
...
(define-fun dynamic_property7 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range5 low) (and (in_range5 high) (=> (<= low high) (and (in_range6 low) (in_range6 high))))))
...
(assert (forall ((temp___819 (_ BitVec 8))) (forall ((temp___820 Int) (temp___821 Int)) (let ((temp___818 (temp___817 temp___819 temp___820 temp___821))) (and (=> (dynamic_property7 1 65536 temp___820 temp___821) (and (= (first7 temp___818) temp___820) (= (last7 temp___818) temp___821))) (forall ((temp___822 Int)) (= (select (to_array3 temp___818) temp___822) (of_rep3 temp___819))))))))
(define-fun dynamic_invariant5 ((temp___expr_33 Int) (temp___is_init_30 Bool) (temp___skip_constant_31 Bool) (temp___do_toplevel_32 Bool)) Bool (=> (or (= temp___is_init_30 true) (<= 0 2147483647)) (in_range4 temp___expr_33)))
...
(define-fun dynamic_invariant8 ((temp___expr_405 us_t2) (temp___is_init_402 Bool) (temp___skip_constant_403 Bool) (temp___do_toplevel_404 Bool)) Bool (=> (not (= temp___skip_constant_403 true)) (and (dynamic_property4 1 r31b (first5 temp___expr_405) (last5 temp___expr_405)) (and (= (first5 temp___expr_405) 1) (= (last5 temp___expr_405) r31b)))))
...
(assert (=> (<= 1 65536) (in_range6 index)))
...
(assert (= (to_rep4 (first6 (rt3 (temp___817 ((_ int2bv 8) 0) 1 r31b)))) 1))
(assert (= (to_rep4 (last6 (rt3 (temp___817 ((_ int2bv 8) 0) 1 r31b)))) r31b))
(assert (= (mk___t3 temp___824 temp___8241) (temp___817 ((_ int2bv 8) 0) 1 r31b)))
(assert (= (ite (<= (to_rep4 (first6 temp___8241)) (to_rep4 (last6 temp___8241))) (+ (- (to_rep4 (last6 temp___8241)) (to_rep4 (first6 temp___8241))) 1) 0) (ite (<= 1 r31b) (+ (- r31b 1) 1) 0)))
(assert (= temp___824 temp___825))
(assert (= (mk2 (to_rep4 (first6 temp___8241)) (to_rep4 (last6 temp___8241))) temp___8251))
(assert (= (ite (<= (to_rep4 (first4 temp___8251)) (to_rep4 (last4 temp___8251))) (+ (- (to_rep4 (last4 temp___8251)) (to_rep4 (first4 temp___8251))) 1) 0) (ite (<= (to_rep4 (first2 result____split_fields1)) (to_rep4 (last2 result____split_fields1))) (+ (- (to_rep4 (last2 result____split_fields1)) (to_rep4 (first2 result____split_fields1))) 1) 0)))
(assert (= (mk___t2 temp___827 temp___8271) (mk___t2 temp___825 temp___8251)))
(assert (= temp___827 o2))
(assert (= (mk1 (to_rep4 (first4 temp___8271)) (to_rep4 (last4 temp___8271))) o3))
(assert (= o4 o2))
(assert (= o5 o3))
(assert (= result____split_discrs (mk___split_discrs temp___829)))
(assert (= temp___8291 o4))
(assert (= temp___8292 o5))
(assert (= result (mk___split_fields__ref (mk___split_fields (mk___t1 result____split_fields result____split_fields1)))))
(assert (= result____split_fields2 (mk___split_fields (mk___t1 temp___8291 temp___8292))))
(assert (= result____split_discrs (mk___split_discrs temp___829)))
(assert (= result1 (mk_bool__ref valid)))
(assert (= valid1 (of_int 1)))
(assert (and (= o6 (to_rep4 (last2 (rt1 (rec__very_longs__very_long__long_digits result____split_fields2))))) (in_range6 (to_rep4 (last2 (rt1 (rec__very_longs__very_long__long_digits result____split_fields2)))))))
...
(assert (= string_index2 (+ (* 2 (- (to_rep4 (last2 (rt1 (rec__very_longs__very_long__long_digits result____split_fields3)))) index2)) (to_rep1 (first (rt number))))))
(assert (and (and (dynamic_invariant4 (mk___rep result____split_discrs result____split_fields3) false true true) (=> (<= 1 65536) (in_range6 index2))) (=> (<= 1 2147483647) (in_range2 string_index2))))
(assert (and (<= (to_rep1 (first (rt number))) string_index2) (<= string_index2 (to_rep1 (last (rt number))))))
(assert (= o14 string_index2))
(assert (= o15 (select (elts number) o14)))
(assert (= o16 (to_rep o15)))
(assert true)
(assert (and (= temp___830 (+ string_index2 1)) (in_range1 (+ string_index2 1))))
(assert (and (<= (to_rep1 (first (rt number))) temp___830) (<= temp___830 (to_rep1 (last (rt number))))))
(assert (= o17 temp___830))
(assert (= o18 (select (elts number) o17)))
(assert (= o19 (to_rep o18)))
(assert true)
(assert (= (ite (= h_okay true) l_okay false) true))
(assert (= valid3 valid2))
(assert (= (to_rep3 o20) (bvadd (bvmul ((_ int2bv 8) 16) h_digit2) l_digit2)))
(assert (and (<= (to_rep4 (first2 (rt1 (rec__very_longs__very_long__long_digits result____split_fields3)))) index2) (<= index2 (to_rep4 (last2 (rt1 (rec__very_longs__very_long__long_digits result____split_fields3)))))))
(assert (= o21 index2))
(assert (= o22 (store (elts1 (rec__very_longs__very_long__long_digits result____split_fields3)) o21 o20)))
(assert (= o22 o23))
(assert (= (rt1 (rec__very_longs__very_long__long_digits result____split_fields3)) o24))
(assert (= o25 (mk___split_fields (mk___t1 o23 o24))))
(assert (= temp___833 (mk___rep result____split_discrs o25)))
