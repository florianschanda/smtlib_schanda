...
(define-fun dynamic_invariant2 ((temp___expr_228 Int) (temp___is_init_224 Bool) (temp___skip_constant_225 Bool) (temp___do_toplevel_226 Bool) (temp___do_typ_inv_227 Bool)) Bool (=> (or (= temp___is_init_224 true) (<= 1 65536)) (in_range6 temp___expr_228)))
...
(declare-fun temp___886 ((_ BitVec 8) Int Int) us_t3)
...
(assert (forall ((temp___888 (_ BitVec 8))) (forall ((temp___889 Int) (temp___890 Int)) (let ((temp___887 (temp___886 temp___888 temp___889 temp___890))) (=> (dynamic_invariant3 temp___888 true true true true) (and (=> (dynamic_property7 1 65536 temp___889 temp___890) (and (= (first7 temp___887) temp___889) (= (last7 temp___887) temp___890))) (forall ((temp___891 Int)) (= (to_rep3 (select (to_array3 temp___887) temp___891)) temp___888))))))))
...
(declare-const temp___902 us_rep)
...
(assert (= (to_rep4 (first6 (rt3 (temp___886 #x00 1 r31b)))) 1))
(assert (= (to_rep4 (last6 (rt3 (temp___886 #x00 1 r31b)))) r31b))
(assert (= (mk___t3 temp___893 temp___8931) (temp___886 #x00 1 r31b)))
(assert (= (ite (<= (to_rep4 (first6 temp___8931)) (to_rep4 (last6 temp___8931))) (+ (- (to_rep4 (last6 temp___8931)) (to_rep4 (first6 temp___8931))) 1) 0) (ite (<= 1 r31b) (+ (- r31b 1) 1) 0)))
(assert (= temp___893 temp___894))
(assert (= (mk2 (to_rep4 (first6 temp___8931)) (to_rep4 (last6 temp___8931))) temp___8941))
(assert (= (ite (<= (to_rep4 (first4 temp___8941)) (to_rep4 (last4 temp___8941))) (+ (- (to_rep4 (last4 temp___8941)) (to_rep4 (first4 temp___8941))) 1) 0) (ite (<= (to_rep4 (first2 result____split_fields1)) (to_rep4 (last2 result____split_fields1))) (+ (- (to_rep4 (last2 result____split_fields1)) (to_rep4 (first2 result____split_fields1))) 1) 0)))
(assert (= (mk___t2 temp___896 temp___8961) (mk___t2 temp___894 temp___8941)))
(assert (= temp___896 o))
(assert (= (mk1 (to_rep4 (first4 temp___8961)) (to_rep4 (last4 temp___8961))) o1))
(assert (= o2 o))
(assert (= o3 o1))
...
(assert (and (and (dynamic_invariant4 (mk___rep result____split_discrs result____split_fields3) false true true true) (=> (<= 1 65536) (in_range6 index2))) (=> (<= 1 2147483647) (in_range2 string_index2))))
...
(assert (= o8 (to_rep o7)))
(assert (and (= temp___899 (+ string_index2 1)) (in_range1 (+ string_index2 1))))
(assert (and (<= (to_rep1 (first (rt number))) temp___899) (<= temp___899 (to_rep1 (last (rt number))))))
(assert (= o9 temp___899))
(assert (= o10 (select (elts number) o9)))
(assert (= o11 (to_rep o10)))
(assert (= (ite (= h_okay true) l_okay false) true))
(assert (= valid3 valid2))
(assert (= (to_rep3 o12) (bvadd (bvmul #x10 h_digit) l_digit)))
...
(assert (= temp___902 (mk___rep result____split_discrs o17)))
(assert (= result4 (mk___split_fields__ref result____split_fields3)))
(assert (= result____split_fields4 (us_split_fields1 temp___902)))
(assert (= result____split_discrs (us_split_discrs1 temp___902)))
(assert (not (= index2 1)))
