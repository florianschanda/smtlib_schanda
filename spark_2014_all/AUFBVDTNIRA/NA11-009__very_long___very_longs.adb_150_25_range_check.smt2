...
(assert (= temp___827 o))
(assert (= (mk1 (to_rep4 (first4 temp___8271)) (to_rep4 (last4 temp___8271))) o1))
(assert (= o2 o))
(assert (= o3 o1))
...
(assert (and (= o4 (to_rep4 (last2 (rt1 (rec__very_longs__very_long__long_digits result____split_fields2))))) (in_range6 (to_rep4 (last2 (rt1 (rec__very_longs__very_long__long_digits result____split_fields2)))))))
...
(assert (= (to_rep3 o12) (bvadd (bvmul ((_ int2bv 8) 16) h_digit) l_digit)))
...
(assert (= o13 index2))
(assert (= o14 (store (elts1 (rec__very_longs__very_long__long_digits result____split_fields3)) o13 o12)))
(assert (= o14 o15))
(assert (= (rt1 (rec__very_longs__very_long__long_digits result____split_fields3)) o16))
