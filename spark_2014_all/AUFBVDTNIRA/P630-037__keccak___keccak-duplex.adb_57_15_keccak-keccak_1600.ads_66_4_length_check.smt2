...
(assert (not (= (ite (<= (to_rep (first4 temp___10551)) (to_rep (last4 temp___10551))) (+ (- (to_rep (last4 temp___10551)) (to_rep (first4 temp___10551))) 1) 0) (ite (<= 0 (- num_bytes 1)) (+ (- (- num_bytes 1) 0) 1) 0))))
(check-sat)
(exit)
