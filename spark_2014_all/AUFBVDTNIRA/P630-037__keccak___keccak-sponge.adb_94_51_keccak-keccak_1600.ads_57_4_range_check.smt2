...
(assert (= temp___817 (mk___t4 o10 (mk4 (to_rep1 (first (rt data))) r85s))))
...
(assert (= temp___820 (mk___t3 o11 (mk3 r81s r82s))))
...
(assert (forall ((temp___823 Int)) (ite (and (<= r81s temp___823) (<= temp___823 r82s)) (= (select o12 temp___823) (select (elts3 temp___822) temp___823)) (= (select o12 temp___823) (select ctx__split_fields1 temp___823)))))
...
(assert (= temp___825 (mk___rep o13)))
...
(assert (= remaining_bytes2 o16))
(assert (and (= o17 (- remaining_bits1 free_bits_in_block1)) (in_range1 (- remaining_bits1 free_bits_in_block1))))
(assert (not (in_range2 o17)))
(check-sat)
(exit)
