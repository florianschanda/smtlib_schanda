...
(assert (< 0 free_bits_in_block2))
(assert (= result13 (mk_int__ref block_offset)))
(assert (= block_offset3 (div1 (to_rep3 ctx__split_fields2) 8)))
(assert (= block_offset3 r81s))
(assert (in_range2 r81s))
(assert (and (= keccak__keccak_1600__sponge__absorb__R82s__assume (+ block_offset3 (- free_bytes_in_block2 1))) (in_range1 (+ block_offset3 (- free_bytes_in_block2 1)))))
(assert (= keccak__keccak_1600__sponge__absorb__R82s__assume r82s))
(assert (in_range1 r82s))
(assert (and (= keccak__keccak_1600__sponge__absorb__R85s__assume (+ (to_rep1 (first (rt data))) (- free_bytes_in_block2 1))) (in_range1 (+ (to_rep1 (first (rt data))) (- free_bytes_in_block2 1)))))
...
(assert (= o35 (elts data)))
(assert (= temp___817 (mk___t4 o35 (mk4 (to_rep1 (first (rt data))) r85s))))
(assert (= (ite (<= (to_rep1 (first8 (rt4 temp___817))) (to_rep1 (last8 (rt4 temp___817)))) (+ (- (to_rep1 (last8 (rt4 temp___817))) (to_rep1 (first8 (rt4 temp___817)))) 1) 0) (ite (<= r81s r82s) (+ (- r82s r81s) 1) 0)))
(assert (= temp___818 (mk___t3 (slide (elts4 temp___817) (to_rep1 (first8 (rt4 temp___817))) r81s) (mk3 r81s r82s))))
(assert (=> (<= r81s r82s) (and (and (<= 0 r81s) (<= r81s 199)) (and (<= 0 r82s) (<= r82s 199)))))
(assert (= o36 ctx__split_fields1))
(assert (= temp___820 (mk___t3 o36 (mk3 r81s r82s))))
(assert (= (ite (<= (to_rep1 (first6 (rt3 temp___818))) (to_rep1 (last6 (rt3 temp___818)))) (+ (- (to_rep1 (last6 (rt3 temp___818))) (to_rep1 (first6 (rt3 temp___818)))) 1) 0) (ite (<= (to_rep1 (first6 (rt3 temp___820))) (to_rep1 (last6 (rt3 temp___820)))) (+ (- (to_rep1 (last6 (rt3 temp___820))) (to_rep1 (first6 (rt3 temp___820)))) 1) 0)))
(assert (= temp___822 temp___818))
(assert (forall ((temp___823 Int)) (ite (and (<= r81s temp___823) (<= temp___823 r82s)) (= (select o37 temp___823) (select (elts3 temp___822) temp___823)) (= (select o37 temp___823) (select ctx__split_fields1 temp___823)))))
(assert (= o38 (mk___split_fields ctx__split_fields o37 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5)))
(assert (= temp___825 (mk___rep o38)))
(assert (= result14 (mk___split_fields__ref (mk___split_fields ctx__split_fields ctx__split_fields1 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5))))
(assert (= ctx__split_fields9 (us_split_fields1 temp___825)))
(assert (and (= o39 (+ offset1 free_bytes_in_block2)) (in_range1 (+ offset1 free_bytes_in_block2))))
(assert (= result15 (mk_int__ref offset1)))
(assert (= offset2 o39))
(assert (and (= o40 (- remaining_bytes1 free_bytes_in_block2)) (in_range1 (- remaining_bytes1 free_bytes_in_block2))))
(assert (and (= o41 o40) (in_range2 o40)))
(assert (= result16 (mk_int__ref remaining_bytes1)))
(assert (= remaining_bytes2 o41))
(assert (and (= o42 (- remaining_bits1 free_bits_in_block2)) (in_range1 (- remaining_bits1 free_bits_in_block2))))
