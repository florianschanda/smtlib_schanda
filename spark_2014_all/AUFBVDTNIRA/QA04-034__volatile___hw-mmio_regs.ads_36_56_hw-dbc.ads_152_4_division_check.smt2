...
(define-fun dynamic_invariant2 ((temp___expr_917 Int) (temp___is_init_914 Bool) (temp___skip_constant_915 Bool) (temp___do_toplevel_916 Bool)) Bool (=> (or (= temp___is_init_914 true) (<= 0 1)) (in_range3 temp___expr_917)))
...
(define-fun word_t__ref___25__projection ((a word_t__ref)) word_t (word_t__content a))
(define-fun dynamic_invariant3 ((temp___expr_964 (_ BitVec 8)) (temp___is_init_961 Bool) (temp___skip_constant_962 Bool) (temp___do_toplevel_963 Bool)) Bool true)
