...
(assert (= temporary_13 (bvudiv temporary_12 #x00000100)))
(assert (= i2 result9))
(assert (= i3 3))
(assert (= temporary_22 result10))
(assert (= temporary_23 (bvurem temporary_13 #x00000100)))
(assert (= (to_rep1 o6) ((_ extract 7 0) temporary_23)))
(assert (and (<= (to_rep data__first) (+ position (- 4 i3))) (<= (+ position (- 4 i3)) (to_rep data__last))))
(assert (= o7 (+ position (- 4 i3))))
(assert (= o8 (store data2 o7 o6)))
(assert (= data2 result11))
(assert (= data3 o8))
(assert (= temporary_13 result12))
(assert (= temporary_14 (bvudiv temporary_13 #x00000100)))
(assert (= i3 result13))
(assert (= i4 4))
(assert (= temporary_23 result14))
(assert (= temporary_24 (bvurem temporary_14 #x00000100)))
(assert (= (to_rep1 o9) ((_ extract 7 0) temporary_24)))
(assert (and (<= (to_rep data__first) (+ position (- 4 i4))) (<= (+ position (- 4 i4)) (to_rep data__last))))
(assert (= o10 (+ position (- 4 i4))))
(assert (= o11 (store data3 o10 o9)))
(assert (= data3 result15))
(assert (= data4 o11))
(assert (= result16 (mk_t__ref1 temporary_14)))
(assert (= temporary_15 (bvudiv temporary_14 #x00000100)))
(assert (not (in_range2 (+ position 3))))
(check-sat)
(exit)
