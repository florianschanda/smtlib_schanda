...
(assert (and (= o1 (peek start len (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))))) (ite (= (> (+ start len) (* 8 (length (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last)))))) true) (= o1 #x0000000000000000) (=> (= (<= (+ start len) (* 8 (length (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last)))))) true) (and (forall ((i Int)) (=> (and (<= 0 i) (<= i (- len 1))) (= (= (nth8_stream (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) (- (- (+ start len) i) 1)) true) (= (nth o1 i) true)))) (forall ((i Int)) (=> (and (<= len i) (<= i 63)) (not (= (nth o1 i) true)))))))))
(assert (= (mk_t__ref result1) (mk_t__ref result__)))
(assert (= result__1 o1))
(assert (not (= (eq__logic result__1 value) true)))
(check-sat)
(exit)
