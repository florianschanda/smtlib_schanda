...
(assert (and (= o6 (peek start len (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))))) (ite (= (> (+ start len) (* 8 (length (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last)))))) true) (= o6 ((_ int2bv 64) 0)) (=> (= (<= (+ start len) (* 8 (length (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last)))))) true) (and (forall ((i Int)) (=> (and (<= 0 i) (<= i (- len 1))) (= (= (nth8_stream (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) (- (- (+ start len) i) 1)) true) (= (nth o6 i) true)))) (forall ((i Int)) (=> (and (<= len i) (<= i 63)) (not (= (nth o6 i) true)))))))))
