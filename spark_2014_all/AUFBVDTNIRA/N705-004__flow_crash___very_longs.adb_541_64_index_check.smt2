...
(assert (= temp___1111 (mk___rep quotient__split_discrs quotient__split_fields2)))
(assert (= temp___1110 (mk___rep1 u__split_discrs u__split_fields2)))
(assert (= temp___1109 current_borrow))
(assert (and (and (dynamic_invariant6 (mk___rep1 u__split_discrs u__split_fields3) false true true) (dynamic_invariant1 (mk___rep quotient__split_discrs quotient__split_fields3) false true true)) (=> (<= 1 2147483647) (in_range2 j2))))
(assert (dynamic_invariant6 (mk___rep1 u__split_discrs u__split_fields4) true true true))
(assert (and (dynamic_invariant1 (mk___rep quotient__split_discrs quotient__split_fields4) true true true) (dynamic_invariant6 (mk___rep1 u__split_discrs u__split_fields5) true true true)))
...
(assert (and (and (dynamic_invariant1 (mk___rep remainder__split_discrs remainder__split_fields3) false true true) (forall ((temp___1120 Int)) (=> (and (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits remainder__split_fields3)))) temp___1120) (<= temp___1120 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits remainder__split_fields3)))))) (=> (<= divisor_index2 temp___1120) (= (select (elts (rec__very_longs__very_long__long_digits remainder__split_fields3)) temp___1120) (select (elts (rec__very_longs__very_long__long_digits remainder__split_fields2)) temp___1120)))))) (and (<= 1 divisor_index2) (<= divisor_index2 r144b))))
