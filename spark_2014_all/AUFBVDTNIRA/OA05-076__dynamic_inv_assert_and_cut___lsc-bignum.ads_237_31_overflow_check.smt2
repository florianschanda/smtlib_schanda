...
(assert (= o52 (+ x_first o51)))
(assert (and (= o53 o52) (in_range1 o52)))
(assert (= o54 (ite (<= o53 (to_rep (last (rt x)))) true false)))
(assert (and (= o48 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o49 (+ x_first o48)))
(assert (and (= o50 o49) (in_range1 o49)))
(assert (= o55 (ite (<= (to_rep (first (rt x))) o50) true false)))
(assert (= result (ite (= o55 true) o54 false)))
(assert (= result true))
...
(assert (= o44 (+ m_first o43)))
(assert (and (= o45 o44) (in_range1 o44)))
(assert (= o46 (ite (<= o45 (to_rep (last (rt m)))) true false)))
(assert (and (= o40 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o41 (+ m_first o40)))
(assert (and (= o42 o41) (in_range1 o41)))
(assert (= o47 (ite (<= (to_rep (first (rt m))) o42) true false)))
(assert (= result1 (ite (= o47 true) o46 false)))
(assert (= result1 true))
...
(assert (= o36 (+ aux1_first o35)))
(assert (and (= o37 o36) (in_range1 o36)))
(assert (= o38 (ite (<= o37 (to_rep aux1__last)) true false)))
(assert (and (= o32 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o33 (+ aux1_first o32)))
(assert (and (= o34 o33) (in_range1 o33)))
(assert (= o39 (ite (<= (to_rep aux1__first) o34) true false)))
(assert (= result2 (ite (= o39 true) o38 false)))
(assert (= result2 true))
...
(assert (= o28 (+ aux2_first o27)))
(assert (and (= o29 o28) (in_range1 o28)))
(assert (= o30 (ite (<= o29 (to_rep aux2__last)) true false)))
(assert (and (= o24 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o25 (+ aux2_first o24)))
(assert (and (= o26 o25) (in_range1 o25)))
(assert (= o31 (ite (<= (to_rep aux2__first) o26) true false)))
(assert (= result3 (ite (= o31 true) o30 false)))
(assert (= result3 true))
...
(assert (= o20 (+ aux3_first o19)))
(assert (and (= o21 o20) (in_range1 o20)))
(assert (= o22 (ite (<= o21 (to_rep aux3__last)) true false)))
(assert (and (= o16 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o17 (+ aux3_first o16)))
(assert (and (= o18 o17) (in_range1 o17)))
(assert (= o23 (ite (<= (to_rep aux3__first) o18) true false)))
(assert (= result4 (ite (= o23 true) o22 false)))
(assert (= result4 true))
...
(assert (= o15 (ite (<= o14 (to_rep aux4__last)) true false)))
