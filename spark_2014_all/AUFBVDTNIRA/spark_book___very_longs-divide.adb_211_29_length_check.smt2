...
(assert (not (= (ite (<= (to_rep2 (first9 temp___10761)) (to_rep2 (last10 temp___10761))) (+ (- (to_rep2 (last10 temp___10761)) (to_rep2 (first9 temp___10761))) 1) 0) (ite (<= 1 r131b) (+ (- r131b 1) 1) 0))))
(check-sat)
(exit)
