...
(define-fun dynamic_invariant3 ((temp___expr_1081 us_rep2) (temp___is_init_1078 Bool) (temp___skip_constant_1079 Bool) (temp___do_toplevel_1080 Bool)) Bool (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1081))) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1081))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1081)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1081))) true))
...
(define-fun bool_eq10 ((a us_rep4) (b us_rep4)) Bool (ite (and (= (rec__keystore__optionalprivatekeyt__ispresent (us_split_fields7 a)) (rec__keystore__optionalprivatekeyt__ispresent (us_split_fields7 b))) (= (bool_eq2 (rec__keystore__optionalprivatekeyt__owner (us_split_fields7 a)) (rec__keystore__optionalprivatekeyt__owner (us_split_fields7 b))) true)) true false))
...
(assert (forall ((a (Array Int Bool)) (b (Array Int Bool))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare4 a a_first a_last b b_first b_last) 0) (= (bool_eq12 a a_first a_last b b_first b_last) true)) :pattern ((compare4 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int Bool)) (b (Array Int Bool))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare4 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq12 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_int2 (select a (+ i 1))) (to_int2 (select b (+ j 1))))))))))) :pattern ((compare4 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int Bool)) (b (Array Int Bool))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare4 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq12 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_int2 (select b (+ i 1))) (to_int2 (select a (+ j 1))))))))))) :pattern ((compare4 a a_first a_last b b_first b_last))))))
...
(declare-fun user_eq26 (us_t1 us_t1) Bool)
(declare-const dummy26 us_t1)
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1547 us_void_param) 1)) 73) (= (to_rep (select (temp___String_Literal_1547 us_void_param) 2)) 110)) (= (to_rep (select (temp___String_Literal_1547 us_void_param) 3)) 105)) (= (to_rep (select (temp___String_Literal_1547 us_void_param) 4)) 116)) (= (to_rep (select (temp___String_Literal_1547 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_1547 us_void_param) 6)) 97)) (= (to_rep (select (temp___String_Literal_1547 us_void_param) 7)) 108)) (= (to_rep (select (temp___String_Literal_1547 us_void_param) 8)) 105)) (= (to_rep (select (temp___String_Literal_1547 us_void_param) 9)) 122)) (= (to_rep (select (temp___String_Literal_1547 us_void_param) 10)) 101)) :pattern ((temp___String_Literal_1547 us_void_param)))))
(declare-fun temp___String_Literal_1557 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1557 us_void_param) 1)) 67) (= (to_rep (select (temp___String_Literal_1557 us_void_param) 2)) 114)) (= (to_rep (select (temp___String_Literal_1557 us_void_param) 3)) 121)) (= (to_rep (select (temp___String_Literal_1557 us_void_param) 4)) 112)) (= (to_rep (select (temp___String_Literal_1557 us_void_param) 5)) 116)) (= (to_rep (select (temp___String_Literal_1557 us_void_param) 6)) 111)) (= (to_rep (select (temp___String_Literal_1557 us_void_param) 7)) 32)) (= (to_rep (select (temp___String_Literal_1557 us_void_param) 8)) 76)) (= (to_rep (select (temp___String_Literal_1557 us_void_param) 9)) 105)) (= (to_rep (select (temp___String_Literal_1557 us_void_param) 10)) 98)) (= (to_rep (select (temp___String_Literal_1557 us_void_param) 11)) 114)) (= (to_rep (select (temp___String_Literal_1557 us_void_param) 12)) 97)) (= (to_rep (select (temp___String_Literal_1557 us_void_param) 13)) 114)) (= (to_rep (select (temp___String_Literal_1557 us_void_param) 14)) 121)) (= (to_rep (select (temp___String_Literal_1557 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_1557 us_void_param) 16)) 69)) (= (to_rep (select (temp___String_Literal_1557 us_void_param) 17)) 114)) (= (to_rep (select (temp___String_Literal_1557 us_void_param) 18)) 114)) (= (to_rep (select (temp___String_Literal_1557 us_void_param) 19)) 111)) (= (to_rep (select (temp___String_Literal_1557 us_void_param) 20)) 114)) (= (to_rep (select (temp___String_Literal_1557 us_void_param) 21)) 32)) (= (to_rep (select (temp___String_Literal_1557 us_void_param) 22)) 105)) (= (to_rep (select (temp___String_Literal_1557 us_void_param) 23)) 110)) (= (to_rep (select (temp___String_Literal_1557 us_void_param) 24)) 32)) (= (to_rep (select (temp___String_Literal_1557 us_void_param) 25)) 73)) (= (to_rep (select (temp___String_Literal_1557 us_void_param) 26)) 110)) (= (to_rep (select (temp___String_Literal_1557 us_void_param) 27)) 105)) (= (to_rep (select (temp___String_Literal_1557 us_void_param) 28)) 116)) (= (to_rep (select (temp___String_Literal_1557 us_void_param) 29)) 105)) (= (to_rep (select (temp___String_Literal_1557 us_void_param) 30)) 97)) (= (to_rep (select (temp___String_Literal_1557 us_void_param) 31)) 108)) (= (to_rep (select (temp___String_Literal_1557 us_void_param) 32)) 105)) (= (to_rep (select (temp___String_Literal_1557 us_void_param) 33)) 122)) (= (to_rep (select (temp___String_Literal_1557 us_void_param) 34)) 101)) (= (to_rep (select (temp___String_Literal_1557 us_void_param) 35)) 32)) (= (to_rep (select (temp___String_Literal_1557 us_void_param) 36)) 58)) (= (to_rep (select (temp___String_Literal_1557 us_void_param) 37)) 32)) :pattern ((temp___String_Literal_1557 us_void_param)))))
...
(define-fun dynamic_invariant11 ((temp___expr_1047 Int) (temp___is_init_1044 Bool) (temp___skip_constant_1045 Bool) (temp___do_toplevel_1046 Bool)) Bool (=> (or (= temp___is_init_1044 true) (<= 0 17)) (in_range11 temp___expr_1047)))
(define-fun dynamic_invariant12 ((temp___expr_1026 Int) (temp___is_init_1023 Bool) (temp___skip_constant_1024 Bool) (temp___do_toplevel_1025 Bool)) Bool (=> (or (= temp___is_init_1023 true) (<= 1 17)) (in_range9 temp___expr_1026)))
(define-fun dynamic_invariant13 ((temp___expr_1151 Int) (temp___is_init_1148 Bool) (temp___skip_constant_1149 Bool) (temp___do_toplevel_1150 Bool)) Bool (=> (or (= temp___is_init_1148 true) (<= 0 2)) (in_range13 temp___expr_1151)))
(define-fun dynamic_invariant14 ((temp___expr_1032 Int) (temp___is_init_1029 Bool) (temp___skip_constant_1030 Bool) (temp___do_toplevel_1031 Bool)) Bool (=> (or (= temp___is_init_1029 true) (<= 0 17408)) (in_range10 temp___expr_1032)))
(define-fun dynamic_invariant15 ((temp___expr_1066 Int) (temp___is_init_1063 Bool) (temp___skip_constant_1064 Bool) (temp___do_toplevel_1065 Bool)) Bool (=> (or (= temp___is_init_1063 true) (<= 0 1024)) (in_range12 temp___expr_1066)))
(assert true)
...
(declare-const c110b (Array Int character))
...
(declare-const temp___1578 issueridt)
(declare-const temp___15781 namecountt)
(declare-const temp___15782 (Array Int character))
...
(declare-const temp___1551 us_t1)
(declare-const temp___1553 Int)
(declare-const o16 (Array Int character))
(declare-const temp___1554 us_t1)
(declare-const temp___1555 us_t1)
(declare-const o17 (Array Int character))
(declare-const temp___1550 us_t)
...
(declare-const c110b1 (Array Int character))
...
(assert (= o o3))
(assert (= blankname o4))
(assert (= temp___1578 o2))
(assert (= temp___15781 o3))
(assert (= temp___15782 o4))
(assert (= (mk___rep (mk___split_fields temp___1578 temp___15781 temp___15782)) nullissuer))
...
(assert (= o8 (mk___split_fields4 o7 nullissuer o6 o5 (of_int 0))))
(assert (= keystore__init__theprivatekey__assume (mk___rep4 o8)))
...
(assert (in_range15 c108b))
(assert (= result1 (mk_map__ref result__)))
(assert (= result__1 nodescription))
(assert (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE15 c108b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE15 c108b)))))) (= o9 (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE15 c108b))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE15 c108b)))))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE15 c108b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE15 c108b))))))) (= o9 0)))
...
(assert (= keystore__init__B112b__thestring__assume (mk___t (concat1 (temp___String_Literal_1557 Tuple0) 1 37 (elts (to_string (attr__ATTRIBUTE_IMAGE15 c108b))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE15 c108b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE15 c108b)))))) (mk 1 o14))))
...
(assert (= result2 (ite (<= o15 150) true false)))
...
(assert (=> (= result2 true) (= temp___1551 (mk___t1 (slide (elts thestring) (to_rep1 (first (rt thestring))) 1) (mk1 1 (length thestring))))))
(assert (=> (= result2 true) (and (= temp___1553 (length thestring)) (in_range1 (length thestring)))))
(assert (=> (= result2 true) (=> (<= 1 temp___1553) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 temp___1553) (<= temp___1553 150))))))
(assert (=> (= result2 true) (= o16 result__1)))
(assert (=> (= result2 true) (= temp___1554 (mk___t1 o16 (mk1 1 temp___1553)))))
(assert (=> (= result2 true) (= (ite (<= (to_rep1 (first2 (rt1 temp___1551))) (to_rep1 (last2 (rt1 temp___1551)))) (+ (- (to_rep1 (last2 (rt1 temp___1551))) (to_rep1 (first2 (rt1 temp___1551)))) 1) 0) (ite (<= (to_rep1 (first2 (rt1 temp___1554))) (to_rep1 (last2 (rt1 temp___1554)))) (+ (- (to_rep1 (last2 (rt1 temp___1554))) (to_rep1 (first2 (rt1 temp___1554)))) 1) 0))))
(assert (=> (= result2 true) (= temp___1555 temp___1551)))
(assert (=> (= result2 true) (forall ((temp___1556 Int)) (ite (and (<= 1 temp___1556) (<= temp___1556 (length thestring))) (= (select o17 temp___1556) (select (elts1 temp___1555) temp___1556)) (= (select o17 temp___1556) (select result__1 temp___1556))))))
(assert (=> (= result2 true) (= result3 (mk_map__ref result__1))))
(assert (=> (= result2 true) (= result__2 o17)))
...
(assert (=> (not (= result2 true)) (= temp___1550 thestring)))
(assert (=> (not (= result2 true)) (= o18 (elts temp___1550))))
(assert (=> (not (= result2 true)) (= result4 (mk_map__ref result__1))))
(assert (=> (not (= result2 true)) (= result__3 o18)))
