...
(declare-const j2 int__ref)
(declare-const s2 int__ref)
(declare-const w1 t__ref)
(declare-const h7 int__ref)
...
(assert (= temp___700 s))
(assert (= temp___699 j))
(assert (= temp___698 aux3))
(assert (= temp___696 w))
(assert (= temp___695 i1))
(assert (= temp___694 (map__content a5)))
...
(assert (and (and (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t aux1 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 ((_ int2bv 32) 1))) true)) (= (oeq (num_of_big_int (mk___t aux2 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t (map__content aux32) (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (omultiply (oexpon__2 (num_of_big_int x x_first (+ l1 1)) (odivide (num_of_big_int e e_first (+ (- e_last e_first) 1)) (oexpon__2 (from_word32 ((_ int2bv 32) 2)) (oadd (osubtract (from_word64 i2) (from_integer (int__content s2))) (from_word32 ((_ int2bv 32) 1)))))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (forall ((n Int)) (=> (and (<= 0 n) (<= n (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux45) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))) (= (ole (from_integer (int__content s2)) (oadd (from_word64 i2) (from_word32 ((_ int2bv 32) 1)))) true)) (bvult i2 (bvmul (bvadd ((_ int2bv 64) (- e_last e_first)) ((_ int2bv 64) 1)) ((_ int2bv 64) 32)))))
(assert (=> (<= 0 2147483647) (in_range2 l1)))
(assert (=> (<= 0 2147483647) (in_range2 (int__content s2))))
(assert (= i3 (mk_t__ref1 i2)))
(assert (= i4 i2))
(assert (bvult i2 ((_ int2bv 64) (int__content s2))))
(assert (= h9 h7))
(assert (= w3 w1))
(assert (= i5 i3))
(assert (= s4 s2))
...
(assert (= aux37 aux35))
(assert (= a12 a10))
(assert (= (oeq (num_of_big_int (mk___t a13 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omod (omultiply (omultiply (num_of_big_int (mk___t (map__content aux36) (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ (- a_last a_first) 1)) (num_of_big_int (mk___t aux1 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ (- a_last a_first) 1))) (oexpon (inverse (num_of_big_int m m_first (+ (- a_last a_first) 1)) (base Tuple0)) (+ (- a_last a_first) 1))) (num_of_big_int m m_first (+ (- a_last a_first) 1)))) true))
(assert (= h14 h11))
(assert (= h13 h5))
(assert (= w7 w5))
(assert (= i9 i7))
(assert (= s8 s6))
(assert (= l2 (mk_int__ref l1)))
(assert (= j8 j6))
(assert (= aux47 aux45))
(assert (= aux38 aux36))
(assert (= aux21 (mk_map__ref aux2)))
(assert (= aux11 (mk_map__ref aux1)))
(assert (= a14 (mk_map__ref a13)))
(assert (= h16 h12))
(assert (= h15 h6))
(assert (= w8 w6))
(assert (= i10 i8))
...
(assert (and (= o8 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (= o9 (+ o8 1)))
