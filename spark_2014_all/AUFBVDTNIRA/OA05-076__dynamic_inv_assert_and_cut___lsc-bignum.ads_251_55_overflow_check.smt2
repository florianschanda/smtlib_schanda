...
(assert (and (and (=> (<= 0 2147483647) (in_range2 j)) (and (=> (<= 0 2147483647) (in_range2 l)) (and (=> (<= 0 2147483647) (in_range2 s)) (and (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t aux11 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 ((_ int2bv 32) 1))) true)) (= (oeq (num_of_big_int (mk___t aux2 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t aux3 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (oexpon (base Tuple0) (+ l1 1)) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t aux4 (mk (to_rep aux4__first) (to_rep aux4__last))) aux4_first (+ l1 1)) (omod (omultiply (num_of_big_int x x_first (+ l1 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (and (=> (<= 0 2147483647) (in_range2 l1)) (and (and (and (and (and (= o147 (power 2 k)) (in_range1 (power 2 k))) (= o148 (- o147 1))) (and (= temp___638 o148) (in_range1 o148))) (and (and (= (mk_int__ref result11) (mk_int__ref h)) (= h1 1)) (ite (and (<= 1 h1) (<= h1 temp___638)) (and (and (and (= temp___636 h1) (and (= temp___633 a) (and (= temp___631 aux4) (and (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t aux11 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 ((_ int2bv 32) 1))) true)) (= (oeq (num_of_big_int (mk___t aux2 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t aux3 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (oexpon (base Tuple0) (+ l1 1)) (num_of_big_int m m_first (+ l1 1)))) true)) (forall ((n7 Int)) (=> (and (<= 0 n7) (<= n7 (- h2 1))) (= (oeq (num_of_big_int (mk___t aux41 (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n7 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n7) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))) (and (and (=> (<= 1 (- (power 2 k) 1)) (dynamic_property1 1 (- (power 2 k) 1) h2)) (and (<= 1 h2) (<= h2 (- (power 2 k) 1)))) (and (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t aux11 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 ((_ int2bv 32) 1))) true)) (= (oeq (num_of_big_int (mk___t aux2 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t aux3 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (oexpon (base Tuple0) (+ l1 1)) (num_of_big_int m m_first (+ l1 1)))) true)) (forall ((n7 Int)) (=> (and (<= 0 n7) (<= n7 h2)) (= (oeq (num_of_big_int (mk___t aux42 (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n7 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n7) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))) (and (=> (<= 0 2147483647) (in_range2 l1)) (and (=> (<= 1 (- (power 2 k) 1)) (dynamic_property1 1 (- (power 2 k) 1) h2)) (= h2 temp___638))))))))) (and (and (= h6 (mk_int__ref h2)) (and (= aux42 aux45) (= a3 a6))) (and (= h7 h2) (and (= aux46 aux42) (= a7 a3))))) (and (and (= h8 h6) (and (= aux47 (mk_map__ref aux45)) (= a8 (mk_map__ref a6)))) (and (= h9 h7) (and (= aux48 aux46) (= a9 a7))))) (and (and (= h8 (mk_int__ref h1)) (and (= aux47 (mk_map__ref aux4)) (= a8 (mk_map__ref a)))) (and (= h9 h1) (and (= aux48 aux4) (= a9 a1))))))) (and (and (and (and (and (and (and (and (= o263 (- e_last e_first)) (in_range1 (- e_last e_first))) (and (= o264 o263) (uint_in_range1 o263))) (= o265 ((_ int2bv 64) o264))) (= o266 (bvadd o265 ((_ int2bv 64) 1)))) (= o267 (bvmul o266 ((_ int2bv 64) 32)))) (= o268 (bvsub o267 ((_ int2bv 64) 1)))) (and (= result13 (mk_t__ref1 i)) (= i1 o268))) (and (and (and (and (= temp___700 s) (and (= temp___699 j) (and (= temp___698 aux3) (and (= temp___696 w) (and (= temp___695 i1) (and (= temp___694 (map__content a8)) (and (and (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t aux11 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 ((_ int2bv 32) 1))) true)) (= (oeq (num_of_big_int (mk___t aux2 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t aux31 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (omultiply (oexpon__2 (num_of_big_int x x_first (+ l1 1)) (odivide (num_of_big_int e e_first (+ (- e_last e_first) 1)) (oexpon__2 (from_word32 ((_ int2bv 32) 2)) (oadd (from_word64 i2) (from_word32 ((_ int2bv 32) 1)))))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (forall ((n7 Int)) (=> (and (<= 0 n7) (<= n7 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux47) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n7 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n7) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))) (bvult i2 (bvmul (bvadd ((_ int2bv 64) (- e_last e_first)) ((_ int2bv 64) 1)) ((_ int2bv 64) 32)))) (and (and (=> (<= 0 2147483647) (in_range2 j1)) (=> (<= 0 2147483647) (in_range2 s1))) (and (and (and (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t aux11 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 ((_ int2bv 32) 1))) true)) (= (oeq (num_of_big_int (mk___t aux2 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t (map__content aux314) (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (omultiply (oexpon__2 (num_of_big_int x x_first (+ l1 1)) (odivide (num_of_big_int e e_first (+ (- e_last e_first) 1)) (oexpon__2 (from_word32 ((_ int2bv 32) 2)) (oadd (osubtract (from_word64 i2) (from_integer (int__content s19))) (from_word32 ((_ int2bv 32) 1)))))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (forall ((n7 Int)) (=> (and (<= 0 n7) (<= n7 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux47) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n7 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n7) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))) (= (ole (from_integer (int__content s19)) (oadd (from_word64 i2) (from_word32 ((_ int2bv 32) 1)))) true)) (bvult i2 (bvmul (bvadd ((_ int2bv 64) (- e_last e_first)) ((_ int2bv 64) 1)) ((_ int2bv 64) 32)))) (and (=> (<= 0 2147483647) (in_range2 l1)) (and (=> (<= 0 2147483647) (in_range2 (int__content s19))) (and (and (= i4 (mk_t__ref1 i2)) (= i5 i2)) (bvult i2 ((_ int2bv 64) (int__content s19))))))))))))))) (and (and (= h28 h22) (and (= w23 w17) (and (= i10 i4) (and (= s25 s19) (and (= j21 j15) (and (= aux320 aux314) (= a29 a23))))))) (and (= h29 h23) (and (= w24 w18) (and (= i11 i5) (and (= s26 s20) (and (= j22 j16) (and (= aux321 aux315) (= a30 a24))))))))) (and (and (= h30 h28) (and (= w25 w23) (and (= i12 i10) (and (= s27 s25) (and (= j23 j21) (and (= aux322 aux320) (= a31 a29))))))) (and (= h31 h29) (and (= w26 w24) (and (= i13 i11) (and (= s28 s26) (and (= j24 j22) (and (= aux323 aux321) (= a32 a30))))))))) (= (oeq (num_of_big_int (mk___t a33 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omod (omultiply (omultiply (num_of_big_int (mk___t (map__content aux322) (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ (- a_last a_first) 1)) (num_of_big_int (mk___t aux11 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ (- a_last a_first) 1))) (oexpon (inverse (num_of_big_int m m_first (+ (- a_last a_first) 1)) (base Tuple0)) (+ (- a_last a_first) 1))) (num_of_big_int m m_first (+ (- a_last a_first) 1)))) true))))))))) (and (and (= h33 h30) (and (= h32 h8) (and (= w27 w25) (and (= i14 i12) (and (= s29 s27) (and (= l2 (mk_int__ref l1)) (and (= j25 j23) (and (= aux49 aux47) (and (= aux324 aux322) (and (= aux21 (mk_map__ref aux2)) (and (= aux12 (mk_map__ref aux11)) (= a34 (mk_map__ref a33))))))))))))) (and (= h35 h31) (and (= h34 h9) (and (= w28 w26) (and (= i15 i13) (and (= s30 s28) (and (= l3 l1) (and (= j26 j24) (and (= aux410 aux48) (and (= aux325 aux323) (and (= aux22 aux2) (and (= aux13 aux11) (= a35 a33)))))))))))))))
(assert (and (= o783 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o784 (+ o783 1)))
(assert (and (= o785 o784) (in_range1 o784)))
(assert (and (= o786 o785) (in_range2 o785)))
(assert (= o787 (num_of_big_int m m_first o786)))
(assert (and (= o777 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (= o778 (+ o777 1)))
(assert (not (in_range1 o778)))
(check-sat)
(exit)
