...
(declare-const o19 (Array Int unsigned_8))
...
(assert (and (forall ((i3 Int)) (=> (and (<= 0 i3) (<= i3 (- (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) 1))) (=> (not (= i3 o9)) (= (= (nth8_stream (mk___t o19 (mk (to_rep addr__first) (to_rep addr__last))) i3) true) (= (nth8_stream (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) i3) true))))) (= (= (nth8_stream (mk___t o19 (mk (to_rep addr__first) (to_rep addr__last))) o9) true) (= flag1 true))))
(assert (= (= (nth8_stream (mk___t o19 (mk (to_rep addr__first) (to_rep addr__last))) (+ start i2)) true) (= (nth value (- (- len i2) 1)) true)))
(assert (<= start k))
(assert (<= k (- (+ start i2) 1)))
(assert (=> (not (= k (+ start i2))) (=> (<= (to_rep addr__first) (to_rep addr__last)) (= o14 (+ (- (to_rep addr__last) (to_rep addr__first)) 1)))))
(assert (=> (not (= k (+ start i2))) (=> (not (<= (to_rep addr__first) (to_rep addr__last))) (= o14 0))))
(assert (=> (not (= k (+ start i2))) (and (= o15 o14) (in_range1 o14))))
(assert (=> (not (= k (+ start i2))) (= o16 (* 8 o15))))
(assert (=> (not (= k (+ start i2))) (= o17 (- o16 1))))
(assert (=> (not (= k (+ start i2))) (= o18 (ite (<= k o17) true false))))
(assert (=> (not (= k (+ start i2))) (= result4 (ite (<= 0 k) o18 false))))
(assert (=> (not (not (= k (+ start i2)))) (= result4 false)))
(assert (= result4 true))
(assert (and (= o11 (- (- (+ start len) k) 1)) (in_range2 (- (- (+ start len) k) 1))))
(assert (= o12 (nth value o11)))
(assert (= o13 (ite o12 1 0)))
(assert (and (= o10 k) (in_range2 k)))
