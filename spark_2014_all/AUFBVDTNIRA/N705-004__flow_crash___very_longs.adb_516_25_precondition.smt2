...
(assert (and (= o3 (* 2 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor))))) (in_range1 (* 2 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor)))))))
(assert (= o4 (+ o3 1)))
...
(assert (and (= us4 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor)))) (in_range2 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor))))))
...
(assert (= (to_rep2 (first9 (rt4 (temp___1076 ((_ int2bv 8) 0) 1 r137b)))) 1))
(assert (= (to_rep2 (last10 (rt4 (temp___1076 ((_ int2bv 8) 0) 1 r137b)))) r137b))
(assert (= (mk___t4 temp___1083 temp___10831) (temp___1076 ((_ int2bv 8) 0) 1 r137b)))
(assert (= (ite (<= (to_rep2 (first9 temp___10831)) (to_rep2 (last10 temp___10831))) (+ (- (to_rep2 (last10 temp___10831)) (to_rep2 (first9 temp___10831))) 1) 0) (ite (<= 1 r137b) (+ (- r137b 1) 1) 0)))
(assert (= temp___1083 temp___1084))
(assert (= (mk3 (to_rep2 (first9 temp___10831)) (to_rep2 (last10 temp___10831))) temp___10841))
(assert (= (ite (<= (to_rep2 (first7 temp___10841)) (to_rep2 (last8 temp___10841))) (+ (- (to_rep2 (last8 temp___10841)) (to_rep2 (first7 temp___10841))) 1) 0) (ite (<= (to_rep2 (first quotient__split_fields1)) (to_rep2 (last quotient__split_fields1))) (+ (- (to_rep2 (last quotient__split_fields1)) (to_rep2 (first quotient__split_fields1))) 1) 0)))
(assert (= temp___1086 (mk___t3 temp___1084 temp___10841)))
(assert (= o6 (mk___t (elts3 temp___1086) (mk (to_rep2 (first7 (rt3 temp___1086))) (to_rep2 (last8 (rt3 temp___1086)))))))
(assert (= o7 (mk___split_fields o6)))
(assert (= temp___1088 (mk___rep quotient__split_discrs o7)))
...
(assert (= (to_rep2 (first13 (rt6 (temp___1089 ((_ int2bv 8) 0) 1 r141b)))) 1))
(assert (= (to_rep2 (last14 (rt6 (temp___1089 ((_ int2bv 8) 0) 1 r141b)))) r141b))
(assert (= temp___1096 (temp___1089 ((_ int2bv 8) 0) 1 r141b)))
(assert (= (ite (<= (to_rep2 (first13 (rt6 temp___1096))) (to_rep2 (last14 (rt6 temp___1096)))) (+ (- (to_rep2 (last14 (rt6 temp___1096))) (to_rep2 (first13 (rt6 temp___1096)))) 1) 0) (ite (<= 1 r141b) (+ (- r141b 1) 1) 0)))
(assert (= temp___1097 (mk___t5 (elts6 temp___1096) (mk5 (to_rep2 (first13 (rt6 temp___1096))) (to_rep2 (last14 (rt6 temp___1096)))))))
(assert (= (ite (<= (to_rep2 (first11 (rt5 temp___1097))) (to_rep2 (last12 (rt5 temp___1097)))) (+ (- (to_rep2 (last12 (rt5 temp___1097))) (to_rep2 (first11 (rt5 temp___1097)))) 1) 0) (ite (<= (to_rep2 (first remainder__split_fields1)) (to_rep2 (last remainder__split_fields1))) (+ (- (to_rep2 (last remainder__split_fields1)) (to_rep2 (first remainder__split_fields1))) 1) 0)))
(assert (= temp___1099 temp___1097))
(assert (= o8 (mk___t (elts5 temp___1099) (mk (to_rep2 (first11 (rt5 temp___1099))) (to_rep2 (last12 (rt5 temp___1099)))))))
(assert (= o9 (mk___split_fields o8)))
(assert (= temp___1101 (mk___rep remainder__split_discrs o9)))
...
(assert (and (= o10 (get_msd divisor)) (and (in_range2 o10) (and (not (= (to_rep1 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 divisor))) o10)) ((_ int2bv 8) 0))) (forall ((i Int)) (=> (and (<= (+ o10 1) i) (<= i (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 divisor))))))) (= (to_rep1 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 divisor))) i)) ((_ int2bv 8) 0))))))))
(assert (= o11 (+ o10 1)))
(assert (and (= temp___1102 o11) (in_range1 o11)))
(assert (and (= us5 temp___1102) (dynamic_property2 1 last2 temp___1102)))
(assert (= o12 temp___1102))
...
(assert (= o14 (- n1 1)))
(assert (= o15 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 divisor))) o14)))
(assert (= o16 (to_rep1 o15)))
(assert (not (not (= o16 ((_ int2bv 8) 0)))))
(check-sat)
(exit)
