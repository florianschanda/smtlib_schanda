...
(declare-const temp___1154 (Array Int octet))
(declare-const temp___11541 t4)
(declare-const temp___1155 (Array Int octet))
(declare-const temp___11551 t3)
(declare-const temp___1157 us_t3)
(declare-const o3 us_t)
(declare-const o4 us_split_fields)
(declare-const temp___1159 us_rep)
(declare-const temp___1167 us_t6)
(declare-const temp___1168 us_t5)
(declare-const temp___1170 us_t5)
(declare-const o5 us_t)
(declare-const o6 us_split_fields)
(declare-const temp___1172 us_rep)
...
(assert (and (= us1 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 dividend)))) (in_range2 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 dividend))))))
...
(assert (and (= o (* 2 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor))))) (in_range1 (* 2 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor)))))))
(assert (= o1 (+ o 1)))
(assert (and (= o2 o1) (in_range1 o1)))
(assert (and (= us2 o2) (in_range2 o2)))
(assert (= (to_rep (rec__very_longs__very_long__octet_length u__split_discrs)) (+ (* 2 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor)))) 1)))
...
(assert (and (= us3 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor)))) (in_range2 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor))))))
(assert (= (to_rep (rec__very_longs__very_long__octet_length v__split_discrs)) (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor)))))
...
(assert (= (to_rep (rec__very_longs__very_long__octet_length quotient__split_discrs)) r137b))
(assert (in_range2 r137b))
(assert (= (to_rep2 (first9 (rt4 (temp___1147 #x00 1 r137b)))) 1))
(assert (= (to_rep2 (last10 (rt4 (temp___1147 #x00 1 r137b)))) r137b))
(assert (= (mk___t4 temp___1154 temp___11541) (temp___1147 #x00 1 r137b)))
(assert (= (ite (<= (to_rep2 (first9 temp___11541)) (to_rep2 (last10 temp___11541))) (+ (- (to_rep2 (last10 temp___11541)) (to_rep2 (first9 temp___11541))) 1) 0) (ite (<= 1 r137b) (+ (- r137b 1) 1) 0)))
(assert (= temp___1154 temp___1155))
(assert (= (mk3 (to_rep2 (first9 temp___11541)) (to_rep2 (last10 temp___11541))) temp___11551))
(assert (= (ite (<= (to_rep2 (first7 temp___11551)) (to_rep2 (last8 temp___11551))) (+ (- (to_rep2 (last8 temp___11551)) (to_rep2 (first7 temp___11551))) 1) 0) (ite (<= (to_rep2 (first quotient__split_fields1)) (to_rep2 (last quotient__split_fields1))) (+ (- (to_rep2 (last quotient__split_fields1)) (to_rep2 (first quotient__split_fields1))) 1) 0)))
(assert (= temp___1157 (mk___t3 temp___1155 temp___11551)))
(assert (= o3 (mk___t (elts3 temp___1157) (mk (to_rep2 (first7 (rt3 temp___1157))) (to_rep2 (last8 (rt3 temp___1157)))))))
(assert (= o4 (mk___split_fields o3)))
(assert (= temp___1159 (mk___rep quotient__split_discrs o4)))
(assert (= result (mk___split_fields__ref (mk___split_fields (mk___t quotient__split_fields quotient__split_fields1)))))
(assert (= quotient__split_fields2 (us_split_fields1 temp___1159)))
(assert (= quotient__split_discrs (us_split_discrs1 temp___1159)))
(assert (= (to_rep (rec__very_longs__very_long__octet_length remainder__split_discrs)) r141b))
(assert (in_range2 r141b))
(assert (= (to_rep2 (first13 (rt6 (temp___1160 #x00 1 r141b)))) 1))
(assert (= (to_rep2 (last14 (rt6 (temp___1160 #x00 1 r141b)))) r141b))
(assert (= temp___1167 (temp___1160 #x00 1 r141b)))
(assert (= (ite (<= (to_rep2 (first13 (rt6 temp___1167))) (to_rep2 (last14 (rt6 temp___1167)))) (+ (- (to_rep2 (last14 (rt6 temp___1167))) (to_rep2 (first13 (rt6 temp___1167)))) 1) 0) (ite (<= 1 r141b) (+ (- r141b 1) 1) 0)))
(assert (= temp___1168 (mk___t5 (elts6 temp___1167) (mk5 (to_rep2 (first13 (rt6 temp___1167))) (to_rep2 (last14 (rt6 temp___1167)))))))
(assert (= (ite (<= (to_rep2 (first11 (rt5 temp___1168))) (to_rep2 (last12 (rt5 temp___1168)))) (+ (- (to_rep2 (last12 (rt5 temp___1168))) (to_rep2 (first11 (rt5 temp___1168)))) 1) 0) (ite (<= (to_rep2 (first remainder__split_fields1)) (to_rep2 (last remainder__split_fields1))) (+ (- (to_rep2 (last remainder__split_fields1)) (to_rep2 (first remainder__split_fields1))) 1) 0)))
(assert (= temp___1170 temp___1168))
(assert (= o5 (mk___t (elts5 temp___1170) (mk (to_rep2 (first11 (rt5 temp___1170))) (to_rep2 (last12 (rt5 temp___1170)))))))
(assert (= o6 (mk___split_fields o5)))
(assert (= temp___1172 (mk___rep remainder__split_discrs o6)))
(assert (= result1 (mk___split_fields__ref (mk___split_fields (mk___t remainder__split_fields remainder__split_fields1)))))
(assert (= remainder__split_fields2 (us_split_fields1 temp___1172)))
(assert (= remainder__split_discrs (us_split_discrs1 temp___1172)))
(assert (and (= o7 (get_msd divisor)) (and (in_range2 o7) (and (not (= (to_rep1 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 divisor))) o7)) #x00)) (forall ((i Int)) (=> (and (<= (+ o7 1) i) (<= i (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 divisor))))))) (= (to_rep1 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 divisor))) i)) #x00)))))))
(assert (= o8 (+ o7 1)))
(assert (and (= temp___1173 o8) (in_range1 o8)))
(assert (and (= us4 temp___1173) (dynamic_property2 1 last2 temp___1173)))
(assert (= o9 temp___1173))
...
(assert (= m1 o10))
(assert (and (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits (us_split_fields1 divisor))))) (- n1 1)) (<= (- n1 1) (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 divisor))))))))
(assert (= o11 (- n1 1)))
(assert (= o12 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 divisor))) o11)))
(assert (= o13 (to_rep1 o12)))
(assert (not (not (= o13 #x00))))
(check-sat)
(exit)
