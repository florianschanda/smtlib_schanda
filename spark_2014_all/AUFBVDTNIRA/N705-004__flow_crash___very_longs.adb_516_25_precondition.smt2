...
(assert (= o3 (mk___t (elts3 temp___1086) (mk (to_rep2 (first7 (rt3 temp___1086))) (to_rep2 (last8 (rt3 temp___1086)))))))
...
(assert (= o5 (mk___t (elts5 temp___1099) (mk (to_rep2 (first11 (rt5 temp___1099))) (to_rep2 (last12 (rt5 temp___1099)))))))
...
(assert (and (= o7 (get_msd divisor)) (and (in_range2 o7) (and (not (= (to_rep1 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 divisor))) o7)) ((_ int2bv 8) 0))) (forall ((i Int)) (=> (and (<= (+ o7 1) i) (<= i (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 divisor))))))) (= (to_rep1 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 divisor))) i)) ((_ int2bv 8) 0))))))))
(assert (= o8 (+ o7 1)))
(assert (and (= temp___1102 o8) (in_range1 o8)))
(assert (and (= us4 temp___1102) (dynamic_property2 1 last2 temp___1102)))
(assert (= o9 temp___1102))
...
(assert (not (not (= o13 ((_ int2bv 8) 0)))))
(check-sat)
(exit)
