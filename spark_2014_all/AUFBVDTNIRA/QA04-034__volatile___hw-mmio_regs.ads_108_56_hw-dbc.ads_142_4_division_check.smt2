...
(assert (and (= o6 (+ (to_rep (rec__hw__dbc__xcap_s_regs__t__msb (us_split_fields1 (select regs idx)))) 1)) (in_range1 (+ (to_rep (rec__hw__dbc__xcap_s_regs__t__msb (us_split_fields1 (select regs idx)))) 1))))
(assert (= o7 (- o6 (to_rep (rec__hw__dbc__xcap_s_regs__t__lsb (us_split_fields1 (select regs idx)))))))
(assert (and (= o8 o7) (in_range1 o7)))
(assert (and (= o9 o8) (in_range2 o8)))
(assert (= o10 (power 2 o9)))
(assert (and (= o11 o10) (in_range3 o10)))
(assert (and (= o12 o11) (uint_in_range1 o11)))
(assert (= o13 ((_ int2bv 64) o12)))
(assert (= o14 (ite (bvult ((_ zero_extend 32) value) o13) true false)))
(assert (and (= o3 32) (in_range1 32)))
(assert (and (= o1 (- (to_rep (rec__hw__dbc__xcap_s_regs__t__msb (us_split_fields1 (select regs idx)))) (to_rep (rec__hw__dbc__xcap_s_regs__t__lsb (us_split_fields1 (select regs idx)))))) (in_range1 (- (to_rep (rec__hw__dbc__xcap_s_regs__t__msb (us_split_fields1 (select regs idx)))) (to_rep (rec__hw__dbc__xcap_s_regs__t__lsb (us_split_fields1 (select regs idx))))))))
(assert (= o2 (+ o1 1)))
(assert (and (= o4 o2) (in_range1 o2)))
(assert (= o5 (ite (<= o4 o3) true false)))
