...
(assert (= temp___928 (mk___rep result____split_discrs o17)))
(assert (= result4 (mk___split_fields__ref result____split_fields3)))
(assert (= result____split_fields4 (us_split_fields1 temp___928)))
(assert (= result____split_discrs (us_split_discrs1 temp___928)))
(assert (not (= index2 1)))
...
(assert (not (= string_index3 (+ (* 2 (- (to_rep4 (last2 (rt1 (rec__very_longs__very_long__long_digits result____split_fields4)))) index3)) 1))))
(check-sat)
(exit)
