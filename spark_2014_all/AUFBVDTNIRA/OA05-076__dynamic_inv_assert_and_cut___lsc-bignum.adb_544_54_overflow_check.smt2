...
(assert (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t o35 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 #x00000001)) true)) (= (oeq (num_of_big_int (mk___t o38 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t o36 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (oexpon (base Tuple0) (+ l1 1)) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t o37 (mk (to_rep aux4__first) (to_rep aux4__last))) aux4_first (+ l1 1)) (omod (omultiply (num_of_big_int x x_first (+ l1 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))
...
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (= temp___703 o37)))
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t o35 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 #x00000001)) true)) (= (oeq (num_of_big_int (mk___t o38 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t o36 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (oexpon (base Tuple0) (+ l1 1)) (num_of_big_int m m_first (+ l1 1)))) true)) (forall ((n1 Int)) (=> (and (<= 0 n1) (<= n1 (- h2 1))) (= (oeq (num_of_big_int (mk___t o39 (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n1 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true))))))
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (and (=> (<= 1 (- (power 2 k) 1)) (dynamic_property1 1 (- (power 2 k) 1) h2)) (and (<= 1 h2) (<= h2 (- (power 2 k) 1))))))
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t o35 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 #x00000001)) true)) (= (oeq (num_of_big_int (mk___t o38 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t o36 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (oexpon (base Tuple0) (+ l1 1)) (num_of_big_int m m_first (+ l1 1)))) true)) (forall ((n1 Int)) (=> (and (<= 0 n1) (<= n1 h2)) (= (oeq (num_of_big_int (mk___t o41 (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n1 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true))))))
...
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (= o42 (mk_map__ref o41))))
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (= h3 (mk_int__ref h2))))
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (= aux4 (mk_map__ref o41))))
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (= a2 (mk_map__ref o40))))
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (= h4 h2)))
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (= o43 o41)))
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (= a3 o40)))
...
(assert (=> (not (and (<= 1 h1) (<= h1 temp___695))) (= o44 (mk_map__ref o37))))
(assert (=> (not (and (<= 1 h1) (<= h1 temp___695))) (= h5 (mk_int__ref h1))))
(assert (=> (not (and (<= 1 h1) (<= h1 temp___695))) (= aux41 (mk_map__ref o37))))
(assert (=> (not (and (<= 1 h1) (<= h1 temp___695))) (= a4 (mk_map__ref a))))
(assert (=> (not (and (<= 1 h1) (<= h1 temp___695))) (= h6 h1)))
(assert (=> (not (and (<= 1 h1) (<= h1 temp___695))) (= o45 o37)))
...
(assert (= i1 o7))
(assert (and (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t o35 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 #x00000001)) true)) (= (oeq (num_of_big_int (mk___t o38 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t o46 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (omultiply (oexpon__2 (num_of_big_int x x_first (+ l1 1)) (odivide (num_of_big_int e e_first (+ (- e_last e_first) 1)) (oexpon__2 (from_word32 #x00000002) (oadd (from_word64 i2) (from_word32 #x00000001))))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (forall ((n1 Int)) (=> (and (<= 0 n1) (<= n1 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux41) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n1 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))) (bvult i2 (bvmul (bvadd ((_ int2bv 64) (- e_last e_first)) #x0000000000000001) #x0000000000000020))))
...
(assert (= o32 (bvadd o31 #x0000000000000001)))
(assert (= o33 (bvmul o32 #x0000000000000020)))
