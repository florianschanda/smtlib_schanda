...
(assert (and (= o14 o13) (uint_in_range1 o13)))
(assert (= o15 ((_ int2bv 64) o14)))
(assert (= o16 (bvadd o15 ((_ int2bv 64) 1))))
(assert (= o17 (bvmul o16 ((_ int2bv 64) 32))))
(assert (= o18 (ite (bvult i2 o17) true false)))
(assert (and (= o8 (power 2 k)) (in_range1 (power 2 k))))
(assert (= o9 (- o8 1)))
(assert (and (= o10 o9) (in_range1 o9)))
(assert (= o11 (ite (<= n o10) true false)))
(assert (= result2 (ite (<= 0 n) o11 false)))
(assert (= (= o12 true) (forall ((n1 Int)) (=> (and (<= 0 n1) (<= n1 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux45) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n1 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))))
