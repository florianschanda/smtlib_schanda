...
(assert (= (= o340 true) (forall ((n7 Int)) (=> (and (<= 0 n7) (<= n7 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux47) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n7 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n7) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))))
