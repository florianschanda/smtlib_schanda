...
(define-fun dynamic_invariant5 ((temp___expr_847 (_ BitVec 8)) (temp___is_init_844 Bool) (temp___skip_constant_845 Bool) (temp___do_toplevel_846 Bool)) Bool true)
...
(declare-const hw__dbc__xcap_regs__read_i__off__assume Int)
...
(assert (= o1 (div1 o 4)))
(assert (and (= hw__dbc__xcap_regs__read_i__off__assume o1) (in_range2 o1)))
(assert (= hw__dbc__xcap_regs__read_i__off__assume off))
