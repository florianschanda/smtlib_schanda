...
(assert (= o64 (+ x_first o63)))
(assert (and (= o65 o64) (in_range1 o64)))
(assert (= o66 (ite (<= o65 (to_rep (last (rt x)))) true false)))
(assert (and (= o60 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o61 (+ x_first o60)))
(assert (and (= o62 o61) (in_range1 o61)))
(assert (= o67 (ite (<= (to_rep (first (rt x))) o62) true false)))
(assert (= result (ite (= o67 true) o66 false)))
(assert (= result true))
...
(assert (= o56 (+ m_first o55)))
(assert (and (= o57 o56) (in_range1 o56)))
(assert (= o58 (ite (<= o57 (to_rep (last (rt m)))) true false)))
(assert (and (= o52 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o53 (+ m_first o52)))
(assert (and (= o54 o53) (in_range1 o53)))
(assert (= o59 (ite (<= (to_rep (first (rt m))) o54) true false)))
(assert (= result1 (ite (= o59 true) o58 false)))
(assert (= result1 true))
...
(assert (= o48 (+ aux1_first o47)))
(assert (and (= o49 o48) (in_range1 o48)))
(assert (= o50 (ite (<= o49 (to_rep aux1__last)) true false)))
(assert (and (= o44 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o45 (+ aux1_first o44)))
(assert (and (= o46 o45) (in_range1 o45)))
(assert (= o51 (ite (<= (to_rep aux1__first) o46) true false)))
(assert (= result2 (ite (= o51 true) o50 false)))
(assert (= result2 true))
...
(assert (= o40 (+ aux2_first o39)))
(assert (and (= o41 o40) (in_range1 o40)))
(assert (= o42 (ite (<= o41 (to_rep aux2__last)) true false)))
(assert (and (= o36 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o37 (+ aux2_first o36)))
(assert (and (= o38 o37) (in_range1 o37)))
(assert (= o43 (ite (<= (to_rep aux2__first) o38) true false)))
(assert (= result3 (ite (= o43 true) o42 false)))
(assert (= result3 true))
...
(assert (= o32 (+ aux3_first o31)))
(assert (and (= o33 o32) (in_range1 o32)))
(assert (= o34 (ite (<= o33 (to_rep aux3__last)) true false)))
(assert (and (= o28 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o29 (+ aux3_first o28)))
(assert (and (= o30 o29) (in_range1 o29)))
(assert (= o35 (ite (<= (to_rep aux3__first) o30) true false)))
(assert (= result4 (ite (= o35 true) o34 false)))
(assert (= result4 true))
...
(assert (and (= o19 (power 2 k)) (in_range1 (power 2 k))))
(assert (= o20 (* o19 o18)))
(assert (and (= o21 o20) (in_range1 o20)))
(assert (= o22 (- o21 1)))
(assert (and (= o23 o22) (in_range1 o22)))
(assert (= o24 (+ aux4_first o23)))
(assert (and (= o25 o24) (in_range1 o24)))
(assert (= o26 (ite (<= o25 (to_rep aux4__last)) true false)))
...
(assert (= o14 (+ aux4_first o13)))
(assert (and (= o15 o14) (in_range1 o14)))
(assert (= o27 (ite (<= (to_rep aux4__first) o15) true false)))
(assert (= result5 (ite (= o27 true) o26 false)))
(assert (= result5 true))
(assert (<= k 30))
...
(assert (= o5 (ite (<= o4 (to_rep (last (rt r)))) true false)))
