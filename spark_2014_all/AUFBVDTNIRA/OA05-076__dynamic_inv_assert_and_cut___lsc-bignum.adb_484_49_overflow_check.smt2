...
(assert (= (= o23 true) (forall ((n Int)) (=> (and (<= 0 n) (<= n (- h2 1))) (= (oeq (num_of_big_int (mk___t aux41 (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))))
...
(assert (= o15 (num_of_big_int (mk___t aux3 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first o14)))
...
(assert (and (= o7 (base Tuple0)) (= o7 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o9 (oexpon o7 o8)))
(assert (and (= o4 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o5 (num_of_big_int x x_first o4)))
(assert (and (= o2 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o3 (num_of_big_int x x_first o2)))
(assert (= o6 (omultiply o3 o5)))
(assert (= o10 (omultiply o6 o9)))
(assert (= o13 (omod o10 o12)))
