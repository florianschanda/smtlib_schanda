...
(assert (dynamic_predicate (mk___t1 temp___1764 temp___17641)))
(assert (= (mk___t1 o5 o6) (mk___t1 temp___1764 temp___17641)))
(assert (= o7 (convertretvaltotext retvaldo2 (mk___t1 o5 o6))))
(assert (= o7 o8))
(assert (= (mk 1 150) o9))
