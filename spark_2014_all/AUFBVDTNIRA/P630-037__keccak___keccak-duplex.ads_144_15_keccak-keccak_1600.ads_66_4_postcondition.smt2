...
(assert (and (and (and (= (mk_map__ref result1) (mk_map__ref block)) (= block1 (keccak__keccak_1600__duplex__duplex_blank__block__aggregate_def ((_ int2bv 8) 0)))) (and (and (and (and (and (and (and (= o5 (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1)))) (and (in_range3 o5) (= o5 (to_rep3 ctx__split_fields1)))) (= o6 (+ o5 7))) (= o7 (div1 o6 8))) (= keccak__keccak_1600__duplex__duplex_blank__R185s__assume (- o7 1))) (= keccak__keccak_1600__duplex__duplex_blank__R185s__assume r185s)) (in_range r185s)) (and (and (and (and (=> (<= 0 r185s) (and (and (<= 0 0) (<= 0 199)) (and (<= 0 r185s) (<= r185s 199)))) (= o8 block1)) (and (= o8 keccak__padding__pad101_single_block__block__compl) (= (mk1 0 r185s) keccak__padding__pad101_single_block__block__compl1))) (and (and (and (= o11 (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1)))) (and (in_range3 o11) (= o11 (to_rep3 ctx__split_fields1)))) (and (= (to_rep o10) (to_rep (last2 keccak__padding__pad101_single_block__block__compl1))) (= (to_rep o9) (to_rep (first2 keccak__padding__pad101_single_block__block__compl1))))) (and (forall ((temp___1086 Int)) (ite (and (<= 0 temp___1086) (<= temp___1086 r185s)) (= (select o12 temp___1086) (select (slide keccak__padding__pad101_single_block__block (to_rep (first (mk (to_rep (first2 keccak__padding__pad101_single_block__block__compl1)) (to_rep (last2 keccak__padding__pad101_single_block__block__compl1))))) 0) temp___1086)) (= (select o12 temp___1086) (select block1 temp___1086)))) (and (= block1 result2) (= block2 o12))))) (and (and (= (- (div1 (+ (to_rep3 ctx__split_fields1) 7) 8) 1) r188s) (in_range r188s)) (and (and (and (and (= o16 (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1)))) (and (in_range3 o16) (= o16 (to_rep3 ctx__split_fields1)))) (and (and (and (=> (<= 0 r188s) (and (and (<= 0 0) (<= 0 199)) (and (<= 0 r188s) (<= r188s 199)))) (= o13 block2)) (and (= o13 temp___1088) (= (mk2 0 r188s) temp___10881))) (and (= temp___1088 o14) (= (mk (to_rep (first4 temp___10881)) (to_rep (last4 temp___10881))) o15)))) (and (= (mk___split_fields__ref (mk___split_fields result3 result4)) (mk___split_fields__ref (mk___split_fields ctx__split_fields ctx__split_fields1))) (and (= keccak__keccak_1600__keccakf_1600_lanes__xor_bits_into_state__a ctx__split_fields2) (= ctx__split_fields1 ctx__split_fields3)))) (and (and (= result5 ctx__split_fields2) (= result6 ctx__split_fields3)) (and (= keccak__keccak_1600__keccakf_1600_permutation__permute__a ctx__split_fields4) (= ctx__split_fields3 ctx__split_fields5)))))))) (and (and (= block2 block3) (and (= out_data out_data1) (and (= ctx__split_fields6 ctx__split_fields4) (= ctx__split_fields7 ctx__split_fields5)))) (and (= block4 block2) (and (= out_data2 out_data) (= (mk___split_fields ctx__split_fields8 ctx__split_fields9) (mk___split_fields ctx__split_fields4 ctx__split_fields5)))))))
(assert (not (= (rate_of (mk___rep (mk___split_fields ctx__split_fields6 ctx__split_fields7))) (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1))))))
(check-sat)
(exit)
