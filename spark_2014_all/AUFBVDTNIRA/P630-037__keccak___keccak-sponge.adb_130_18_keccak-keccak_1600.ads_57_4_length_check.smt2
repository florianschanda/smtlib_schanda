...
(assert (= o66 (elts data)))
(assert (= temp___845 (mk___t8 o66 (mk8 r98s r99s))))
...
(assert (= o67 (rec__keccak__keccak_1600__sponge__context__block (us_split_fields__content ctx__split_fields19))))
(assert (= temp___849 (mk___t7 o67 (mk7 0 r95s))))
