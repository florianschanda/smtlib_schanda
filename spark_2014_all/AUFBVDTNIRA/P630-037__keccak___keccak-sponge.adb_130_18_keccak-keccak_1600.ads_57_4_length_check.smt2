...
(assert (=> (<= r98s r99s) (and (and (<= (to_rep1 (first (rt data))) r98s) (<= r98s (to_rep1 (last (rt data))))) (and (<= (to_rep1 (first (rt data))) r99s) (<= r99s (to_rep1 (last (rt data))))))))
(assert (= o30 (elts data)))
(assert (= temp___914 (mk___t8 o30 (mk8 r98s r99s))))
(assert (= (ite (<= (to_rep1 (first16 (rt8 temp___914))) (to_rep1 (last16 (rt8 temp___914)))) (+ (- (to_rep1 (last16 (rt8 temp___914))) (to_rep1 (first16 (rt8 temp___914)))) 1) 0) (ite (<= 0 r95s) (+ (- r95s 0) 1) 0)))
(assert (= temp___915 (mk___t7 (slide1 (elts8 temp___914) (to_rep1 (first16 (rt8 temp___914))) 0) (mk7 0 r95s))))
(assert (=> (<= 0 r95s) (and (and (<= 0 0) (<= 0 199)) (and (<= 0 r95s) (<= r95s 199)))))
(assert (= o31 (rec__keccak__keccak_1600__sponge__context__block (us_split_fields__content ctx__split_fields15))))
(assert (= temp___918 (mk___t7 o31 (mk7 0 r95s))))
(assert (not (= (ite (<= (to_rep1 (first14 (rt7 temp___915))) (to_rep1 (last14 (rt7 temp___915)))) (+ (- (to_rep1 (last14 (rt7 temp___915))) (to_rep1 (first14 (rt7 temp___915)))) 1) 0) (ite (<= (to_rep1 (first14 (rt7 temp___918))) (to_rep1 (last14 (rt7 temp___918)))) (+ (- (to_rep1 (last14 (rt7 temp___918))) (to_rep1 (first14 (rt7 temp___918)))) 1) 0))))
(check-sat)
(exit)
