...
(assert (and (= o699 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o700 (num_of_big_int m m_first o699)))
(assert (and (= o696 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (and (= o695 (base Tuple0)) (= o695 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o697 (oexpon o695 o696)))
(assert (and (= o692 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o693 (num_of_big_int x x_first o692)))
