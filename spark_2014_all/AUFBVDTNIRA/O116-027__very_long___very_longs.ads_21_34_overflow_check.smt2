...
(define-fun dynamic_invariant7 ((temp___expr_405 us_t2) (temp___is_init_402 Bool) (temp___skip_constant_403 Bool) (temp___do_toplevel_404 Bool)) Bool (=> (not (= temp___skip_constant_403 true)) (and (dynamic_property4 1 r32b (first5 temp___expr_405) (last5 temp___expr_405)) (and (= (first5 temp___expr_405) 1) (= (last5 temp___expr_405) r32b)))))
...
(assert (not (in_range4 (* 2 (to_rep2 (rec__very_longs__very_long__length result____split_discrs))))))
(check-sat)
(exit)
