...
(assert (=> (< (mod2 bit_len 8) 256) (= o6 (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) (mod2 bit_len 8))))))
(assert (=> (not (< (mod2 bit_len 8) 256)) (= o6 ((_ int2bv 8) 0))))
(assert (= o7 (bvsub o6 ((_ int2bv 8) 1))))
(assert (and (<= (to_rep data__first) (to_rep data__last)) (<= (to_rep data__last) (to_rep data__last))))
(assert (= o4 (to_rep data__last)))
(assert (= o5 (select data o4)))
(assert (= o8 (to_rep1 o5)))
