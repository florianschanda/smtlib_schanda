...
(assert (=> (< (mod2 bit_len 8) 256) (= o2 (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) (mod2 bit_len 8))))))
(assert (=> (not (< (mod2 bit_len 8) 256)) (= o2 ((_ int2bv 8) 0))))
(assert (= o3 (bvsub o2 ((_ int2bv 8) 1))))
(assert (and (<= (to_rep data__first) (to_rep data__last)) (<= (to_rep data__last) (to_rep data__last))))
(assert (= o (to_rep data__last)))
(assert (= o1 (select data o)))
