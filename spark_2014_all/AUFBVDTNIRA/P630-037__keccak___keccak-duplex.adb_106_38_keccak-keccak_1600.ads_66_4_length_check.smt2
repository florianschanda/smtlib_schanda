...
(assert (not (= (ite (<= (to_rep (first2 temp___11031)) (to_rep (last2 temp___11031))) (+ (- (to_rep (last2 temp___11031)) (to_rep (first2 temp___11031))) 1) 0) (ite (<= (to_rep (first2 temp___11061)) (to_rep (last2 temp___11061))) (+ (- (to_rep (last2 temp___11061)) (to_rep (first2 temp___11061))) 1) 0))))
(check-sat)
(exit)
