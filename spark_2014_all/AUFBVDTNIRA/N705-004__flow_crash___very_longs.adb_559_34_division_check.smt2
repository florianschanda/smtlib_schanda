...
(assert (and (= us (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 number)))) (in_range (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 number))))))
