...
(assert (= h1 1))
(assert (<= 1 h1))
(assert (<= h1 temp___638))
(assert (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t aux11 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 ((_ int2bv 32) 1))) true)) (= (oeq (num_of_big_int (mk___t aux2 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t aux3 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (oexpon (base Tuple0) (+ l1 1)) (num_of_big_int m m_first (+ l1 1)))) true)) (forall ((n7 Int)) (=> (and (<= 0 n7) (<= n7 (- h2 1))) (= (oeq (num_of_big_int (mk___t aux41 (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n7 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n7) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))))
(assert (and (=> (<= 1 (- (power 2 k) 1)) (dynamic_property1 1 (- (power 2 k) 1) h2)) (and (<= 1 h2) (<= h2 (- (power 2 k) 1)))))
(assert (and (= o200 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o201 (* (- h2 1) o200)))
(assert (and (= o202 o201) (in_range1 o201)))
(assert (= o203 (+ aux4_first o202)))
(assert (and (= o204 o203) (in_range1 o203)))
(assert (and (= o205 o204) (in_range2 o204)))
(assert (= (oeq (num_of_big_int (mk___t a3 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omod (omultiply (omultiply (num_of_big_int (mk___t aux41 (mk (to_rep aux4__first) (to_rep aux4__last))) o205 (+ (- a_last a_first) 1)) (num_of_big_int (mk___t aux2 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ (- a_last a_first) 1))) (oexpon (inverse (num_of_big_int m m_first (+ (- a_last a_first) 1)) (base Tuple0)) (+ (- a_last a_first) 1))) (num_of_big_int m m_first (+ (- a_last a_first) 1)))) true))
(assert (and (= o206 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o207 (* h2 o206)))
(assert (and (= o208 o207) (in_range1 o207)))
(assert (= o209 (+ aux4_first o208)))
(assert (and (= o210 o209) (in_range1 o209)))
(assert (and (= o211 o210) (in_range2 o210)))
(assert (forall ((k1 Int)) (=> (and (<= (to_rep aux4__first) k1) (<= k1 (to_rep aux4__last))) (and (=> (and (<= o211 k1) (<= k1 (- (+ o211 a_last) a_first))) (= (to_rep1 (select aux42 k1)) (to_rep1 (select a3 (- (+ a_first k1) o211))))) (=> (=> (<= o211 k1) (not (<= k1 (- (+ o211 a_last) a_first)))) (= (to_rep1 (select aux42 k1)) (to_rep1 (select aux41 k1))))))))
(assert (= (= o262 true) (forall ((n7 Int)) (=> (and (<= 0 n7) (<= n7 h2)) (= (oeq (num_of_big_int (mk___t aux42 (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n7 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n7) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))))
(assert (and (= o237 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o238 (num_of_big_int m m_first o237)))
(assert (and (= o235 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (and (= o234 (base Tuple0)) (= o234 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o236 (oexpon o234 o235)))
(assert (= o239 (omod o236 o238)))
(assert (and (= o232 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o233 (num_of_big_int (mk___t aux3 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first o232)))
(assert (= o240 (oeq o233 o239)))
(assert (and (= o228 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o229 (num_of_big_int m m_first o228)))
(assert (and (= o225 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (and (= o224 (base Tuple0)) (= o224 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o226 (oexpon o224 o225)))
(assert (and (= o221 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o222 (num_of_big_int x x_first o221)))
(assert (and (= o219 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o220 (num_of_big_int x x_first o219)))
(assert (= o223 (omultiply o220 o222)))
(assert (= o227 (omultiply o223 o226)))
(assert (= o230 (omod o227 o229)))
