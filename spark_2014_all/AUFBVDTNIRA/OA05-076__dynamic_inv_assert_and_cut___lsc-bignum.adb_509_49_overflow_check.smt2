...
(assert (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t aux1 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 ((_ int2bv 32) 1))) true)) (= (oeq (num_of_big_int (mk___t aux2 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t aux3 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (oexpon (base Tuple0) (+ l1 1)) (num_of_big_int m m_first (+ l1 1)))) true)) (forall ((n Int)) (=> (and (<= 0 n) (<= n (- h2 1))) (= (oeq (num_of_big_int (mk___t aux41 (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))))
(assert (and (=> (<= 1 (- (power 2 k) 1)) (dynamic_property1 1 (- (power 2 k) 1) h2)) (and (<= 1 h2) (<= h2 (- (power 2 k) 1)))))
(assert (and (= o2 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o3 (* (- h2 1) o2)))
(assert (and (= o4 o3) (in_range1 o3)))
(assert (= o5 (+ aux4_first o4)))
(assert (and (= o6 o5) (in_range1 o5)))
(assert (and (= o7 o6) (in_range2 o6)))
(assert (= (oeq (num_of_big_int (mk___t a (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omod (omultiply (omultiply (num_of_big_int (mk___t aux41 (mk (to_rep aux4__first) (to_rep aux4__last))) o7 (+ (- a_last a_first) 1)) (num_of_big_int (mk___t aux2 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ (- a_last a_first) 1))) (oexpon (inverse (num_of_big_int m m_first (+ (- a_last a_first) 1)) (base Tuple0)) (+ (- a_last a_first) 1))) (num_of_big_int m m_first (+ (- a_last a_first) 1)))) true))
(assert (and (= o8 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o9 (* h2 o8)))
(assert (and (= o10 o9) (in_range1 o9)))
(assert (= o11 (+ aux4_first o10)))
(assert (and (= o12 o11) (in_range1 o11)))
(assert (and (= o13 o12) (in_range2 o12)))
(assert (forall ((k1 Int)) (=> (and (<= (to_rep aux4__first) k1) (<= k1 (to_rep aux4__last))) (and (=> (and (<= o13 k1) (<= k1 (- (+ o13 a_last) a_first))) (= (to_rep1 (select aux42 k1)) (to_rep1 (select a (- (+ a_first k1) o13))))) (=> (=> (<= o13 k1) (not (<= k1 (- (+ o13 a_last) a_first)))) (= (to_rep1 (select aux42 k1)) (to_rep1 (select aux41 k1))))))))
(assert (= (= o35 true) (forall ((n Int)) (=> (and (<= 0 n) (<= n h2)) (= (oeq (num_of_big_int (mk___t aux42 (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))))
(assert (and (= o31 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o32 (num_of_big_int m m_first o31)))
...
(assert (= o33 (omod o30 o32)))
(assert (and (= o26 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o27 (num_of_big_int (mk___t aux3 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first o26)))
(assert (= o34 (oeq o27 o33)))
(assert (and (= o23 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o24 (num_of_big_int m m_first o23)))
...
(assert (= o15 (num_of_big_int x x_first o14)))
(assert (= o18 (omultiply o15 o17)))
(assert (= o22 (omultiply o18 o21)))
