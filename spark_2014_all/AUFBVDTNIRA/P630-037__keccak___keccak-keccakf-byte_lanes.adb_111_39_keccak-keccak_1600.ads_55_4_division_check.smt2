...
(assert (=> (<= (to_rep data__first) (to_rep data__last)) (= o3 (+ (- (to_rep data__last) (to_rep data__first)) 1))))
(assert (=> (not (<= (to_rep data__first) (to_rep data__last))) (= o3 0)))
(assert (and (= o4 o3) (in_range1 o3)))
(assert (and (= o5 (+ offset2 remaining_bytes2)) (in_range1 (+ offset2 remaining_bytes2))))
