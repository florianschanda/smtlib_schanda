...
(assert (=> (<= (to_rep data__first) (to_rep data__last)) (= o5 (+ (- (to_rep data__last) (to_rep data__first)) 1))))
(assert (=> (not (<= (to_rep data__first) (to_rep data__last))) (= o5 0)))
(assert (and (= o6 o5) (in_range1 o5)))
(assert (and (= o7 (+ offset2 remaining_bytes2)) (in_range1 (+ offset2 remaining_bytes2))))
