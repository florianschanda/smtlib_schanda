...
(assert (=> (= result9 true) (= (ite (<= (to_rep1 (first (rt thestring1))) (to_rep1 (last (rt thestring1)))) (+ (- (to_rep1 (last (rt thestring1))) (to_rep1 (first (rt thestring1)))) 1) 0) (ite (<= 1 (length thestring1)) (+ (- (length thestring1) 1) 1) 0))))
(assert (=> (= result9 true) (= temp___1782 (mk___t2 (slide (elts thestring1) (to_rep1 (first (rt thestring1))) 1) (mk2 1 (length thestring1))))))
(assert (=> (= result9 true) (and (= temp___1784 (length thestring1)) (in_range1 (length thestring1)))))
(assert (=> (= result9 true) (=> (<= 1 temp___1784) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 temp___1784) (<= temp___1784 150))))))
(assert (=> (= result9 true) (= o17 result__8)))
(assert (=> (= result9 true) (= temp___1785 (mk___t2 o17 (mk2 1 temp___1784)))))
(assert (=> (= result9 true) (= (ite (<= (to_rep1 (first4 (rt2 temp___1782))) (to_rep1 (last4 (rt2 temp___1782)))) (+ (- (to_rep1 (last4 (rt2 temp___1782))) (to_rep1 (first4 (rt2 temp___1782)))) 1) 0) (ite (<= (to_rep1 (first4 (rt2 temp___1785))) (to_rep1 (last4 (rt2 temp___1785)))) (+ (- (to_rep1 (last4 (rt2 temp___1785))) (to_rep1 (first4 (rt2 temp___1785)))) 1) 0))))
(assert (=> (= result9 true) (= temp___1786 temp___1782)))
(assert (=> (= result9 true) (forall ((temp___1787 Int)) (ite (and (<= 1 temp___1787) (<= temp___1787 (length thestring1))) (= (select o18 temp___1787) (select (elts2 temp___1786) temp___1787)) (= (select o18 temp___1787) (select result__8 temp___1787))))))
(assert (=> (= result9 true) (= result10 (mk_map__ref result__8))))
(assert (=> (= result9 true) (= result__9 o18)))
(assert (=> (not (= result9 true)) (=> (<= 1 150) (and (and (<= (to_rep1 (first (rt thestring1))) 1) (<= 1 (to_rep1 (last (rt thestring1))))) (and (<= (to_rep1 (first (rt thestring1))) 150) (<= 150 (to_rep1 (last (rt thestring1)))))))))
(assert (=> (not (= result9 true)) (= temp___1781 thestring1)))
(assert (=> (not (= result9 true)) (= o19 (elts temp___1781))))
(assert (=> (not (= result9 true)) (= result11 (mk_map__ref result__8))))
(assert (=> (not (= result9 true)) (= result__10 o19)))
(assert (=> (not (= result9 true)) (= result__9 result__10)))
(assert (= result12 (mk_map__ref c84b)))
(assert (= c84b2 result__9))
