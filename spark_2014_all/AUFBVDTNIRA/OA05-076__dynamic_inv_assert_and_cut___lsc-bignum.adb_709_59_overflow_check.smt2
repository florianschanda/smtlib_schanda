...
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= temp___742 o57))))
...
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= o61 (mk_map__ref o60)))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= h10 (mk_int__ref h9)))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= aux3 (mk_map__ref o60)))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= a7 (mk_map__ref o59)))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= h11 h9))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= o62 o60))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= a8 o59))))
...
(assert (=> (= result2 true) (=> (not (and (<= 1 h8) (<= h8 r94b))) (= o63 (mk_map__ref o57)))))
(assert (=> (= result2 true) (=> (not (and (<= 1 h8) (<= h8 r94b))) (= h12 (mk_int__ref h8)))))
(assert (=> (= result2 true) (=> (not (and (<= 1 h8) (<= h8 r94b))) (= aux31 (mk_map__ref o57)))))
(assert (=> (= result2 true) (=> (not (and (<= 1 h8) (<= h8 r94b))) (= a9 (mk_map__ref a6)))))
(assert (=> (= result2 true) (=> (not (and (<= 1 h8) (<= h8 r94b))) (= h13 h8))))
(assert (=> (= result2 true) (=> (not (and (<= 1 h8) (<= h8 r94b))) (= o64 o57))))
...
(assert (=> (not (= result2 true)) (= aux32 (mk_map__ref o68))))
(assert (=> (not (= result2 true)) (= a11 (mk_map__ref o67))))
(assert (=> (not (= result2 true)) (= h15 h7)))
(assert (=> (not (= result2 true)) (= w10 w)))
(assert (=> (not (= result2 true)) (= s13 s11)))
(assert (=> (not (= result2 true)) (= j11 j1)))
(assert (=> (not (= result2 true)) (= o70 o68)))
(assert (=> (not (= result2 true)) (= a12 o67)))
...
(assert (and (= o23 (* 2 n)) (in_range1 (* 2 n))))
(assert (= o24 (+ o23 1)))
