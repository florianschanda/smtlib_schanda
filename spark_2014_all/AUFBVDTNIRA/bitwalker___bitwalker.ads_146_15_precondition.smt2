...
(assert (and (and (= (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) addrold) (and (dynamic_invariant3 addrold true false true) (and (=> (<= 0 0) (in_range4 v)) (and (and (and (= o5 (peek start len (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))))) (ite (= (> (+ start len) (* 8 (length (mk___t addr (mk (to_rep addr__first) (to_rep addr__last)))))) true) (= o5 ((_ int2bv 64) 0)) (=> (= (<= (+ start len) (* 8 (length (mk___t addr (mk (to_rep addr__first) (to_rep addr__last)))))) true) (and (forall ((i2 Int)) (=> (and (<= 0 i2) (<= i2 (- len 1))) (= (= (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) (- (- (+ start len) i2) 1)) true) (= (nth o5 i2) true)))) (forall ((i2 Int)) (=> (and (<= len i2) (<= i2 63)) (not (= (nth o5 i2) true)))))))) (and (= (mk_t__ref result1) (mk_t__ref value)) (= value1 o5))) (and (and (and (= o6 (lemmafunction value1 len)) (and (in_range4 o6) (and (= o6 0) (bvult value1 (maxvalue len))))) (and (= (mk_int__ref result2) (mk_int__ref v)) (= v1 o6))) (and (and (and (and (<= (- 2) result__1) (<= result__1 0)) (and (= (= result__1 (- 1)) (< (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) (+ start len))) (and (= (= result__1 (- 2)) (and (bvule (maxvalue len) value1) (<= (+ start len) (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0))))) (and (= (= result__1 0) (and (bvugt (maxvalue len) value1) (<= (+ start len) (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0))))) (and (=> (= result__1 0) (forall ((i2 Int)) (=> (and (<= 0 i2) (<= i2 (- start 1))) (= (= (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) i2) true) (= (nth8_stream (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) i2) true))))) (and (=> (= result__1 0) (forall ((i2 Int)) (=> (and (<= start i2) (<= i2 (- (+ start len) 1))) (= (= (nth8_stream (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) i2) true) (= (nth value1 (+ (- (- len i2) 1) start)) true))))) (=> (= result__1 0) (forall ((i2 Int)) (=> (and (<= (+ start len) i2) (<= i2 (- (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) 1))) (= (= (nth8_stream (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) i2) true) (= (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) i2) true))))))))))) (in_range1 result__1)) (and (= result__1 0) (forall ((i2 Int)) (=> (and (<= start i2) (<= i2 (- (+ start len) 1))) (= (= (nth8_stream (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) i2) true) (= (nth8_stream addrold i2) true))))))))))) (and (and (= v1 v2) (and (= value1 value2) (and (= result__1 result__2) (= addr1 addr2)))) (and (= v3 v1) (and (= value3 value1) (and (= result__3 result__1) (= addr3 addr1)))))))
(assert (= result__2 0))
(assert (=> (<= (to_rep addr__first) (to_rep addr__last)) (= o12 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))
(assert (=> (not (<= (to_rep addr__first) (to_rep addr__last))) (= o12 0)))
(assert (and (= o13 o12) (in_range1 o12)))
(assert (= o14 (* 8 o13)))
(assert (= o15 (- o14 1)))
(assert (= o16 (ite (<= i1 o15) true false)))
(assert (= result3 (ite (<= 0 i1) o16 false)))
(assert (= result3 true))
(assert (and (= o18 (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) i1)) (= (= o18 true) (= (nth1 (to_rep1 (select addr (div1 i1 8))) (- 7 (mod1 i1 8))) true))))
