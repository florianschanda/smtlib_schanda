...
(assert (and (dynamic_invariant5 (mk___rep1 u__split_discrs u__split_fields3) true true true) (and (<= 1 divisor_index2) (<= divisor_index2 r132b))))
...
(assert (and (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields3)))) temp___1306) (<= temp___1306 (to_rep2 (last3 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields3)))))))
...
(assert (= temp___1308 (- o13 1)))
(assert (and (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields3)))) temp___1308) (<= temp___1308 (to_rep2 (last3 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields3)))))))
(assert (= o14 temp___1308))
