...
(assert (and (dynamic_invariant5 (mk___rep1 u__split_discrs u__split_fields2) true true true true) (and (<= 1 divisor_index2) (<= divisor_index2 r132b))))
...
(assert (= temp___1379 (- o7 1)))
(assert (and (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields2)))) temp___1379) (<= temp___1379 (to_rep2 (last3 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields2)))))))
(assert (= o8 temp___1379))
(assert (= o9 (select (elts1 (rec__very_longs__very_long__long_digits1 u__split_fields2)) o8)))
...
(assert (= temp___1381 (- o12 1)))
(assert (and (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields2)))) temp___1381) (<= temp___1381 (to_rep2 (last3 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields2)))))))
(assert (= o13 temp___1381))
(assert (= o14 (select (elts1 (rec__very_longs__very_long__long_digits1 u__split_fields2)) o13)))
(assert (= o15 (to_rep o14)))
(assert (= o16 ((_ zero_extend 8) o15)))
(assert (= o17 (bvsub o16 temporary_digit1)))
(assert (= o18 (bvsub o17 current_borrow2)))
(assert (= o19 (bvand o18 #x00FF)))
(assert (= o20 o19))
(assert (= o21 ((_ extract 7 0) o20)))
