...
(assert (= result3 (mk_t__ref1 product)))
(assert (= product1 o5))
(assert (and (= o6 (shift_right product1 8)) (= o6 (bvudiv product1 (ite (< 8 65536) (bvshl #x0001 ((_ int2bv 16) 8)) #x0000)))))
(assert (= result4 (mk_t__ref1 carry2)))
(assert (= carry3 o6))
(assert (= result5 (mk_t__ref1 temporary_digit)))
(assert (= temporary_digit1 (bvand product1 #x00FF)))
(assert (and (= o7 (+ j divisor_index2)) (in_range1 (+ j divisor_index2))))
(assert (= temp___1377 (- o7 1)))
(assert (and (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields2)))) temp___1377) (<= temp___1377 (to_rep2 (last3 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields2)))))))
(assert (= o8 temp___1377))
...
(assert (not (in_range1 (+ j divisor_index2))))
(check-sat)
(exit)
