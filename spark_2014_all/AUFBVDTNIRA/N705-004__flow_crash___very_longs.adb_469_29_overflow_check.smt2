...
(assert (and (dynamic_invariant5 (mk___rep1 u__split_discrs u__split_fields2) true true true) (and (<= 1 divisor_index2) (<= divisor_index2 r132b))))
...
(assert (= product1 o5))
(assert (and (= o6 (shift_right product1 8)) (= o6 (bvudiv product1 (ite (< 8 65536) (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) 8)) ((_ int2bv 16) 0))))))
(assert (= result4 (mk_t__ref1 carry2)))
(assert (= carry3 o6))
(assert (= result5 (mk_t__ref1 temporary_digit)))
(assert (= temporary_digit1 (bvand product1 ((_ int2bv 16) 255))))
(assert (and (= o7 (+ j divisor_index2)) (in_range1 (+ j divisor_index2))))
(assert (= temp___1306 (- o7 1)))
(assert (and (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields2)))) temp___1306) (<= temp___1306 (to_rep2 (last3 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields2)))))))
(assert (= o8 temp___1306))
...
(assert (=> (= result6 true) (= future_borrow1 ((_ int2bv 16) 0))))
(assert (=> (not (= result6 true)) (= result8 (mk_t__ref1 future_borrow))))
(assert (=> (not (= result6 true)) (= future_borrow2 ((_ int2bv 16) 1))))
(assert (=> (not (= result6 true)) (= future_borrow1 future_borrow2)))
(assert (and (= o12 (+ j divisor_index2)) (in_range1 (+ j divisor_index2))))
(assert (= temp___1308 (- o12 1)))
(assert (and (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields2)))) temp___1308) (<= temp___1308 (to_rep2 (last3 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields2)))))))
(assert (= o13 temp___1308))
...
(assert (= o19 (bvand o18 ((_ int2bv 16) 255))))
(assert (= o20 o19))
