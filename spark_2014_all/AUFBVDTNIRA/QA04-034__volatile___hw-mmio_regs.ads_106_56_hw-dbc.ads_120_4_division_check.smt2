...
(define-fun dynamic_invariant2 ((temp___expr_647 Int) (temp___is_init_643 Bool) (temp___skip_constant_644 Bool) (temp___do_toplevel_645 Bool) (temp___do_typ_inv_646 Bool)) Bool (=> (or (= temp___is_init_643 true) (<= 0 1)) (in_range4 temp___expr_647)))
...
(assert (and (= o9 (+ (to_rep (rec__hw__dbc__cap_s_regs__t__msb (us_split_fields1 (select regs idx)))) 1)) (in_range1 (+ (to_rep (rec__hw__dbc__cap_s_regs__t__msb (us_split_fields1 (select regs idx)))) 1))))
(assert (= o10 (- o9 (to_rep (rec__hw__dbc__cap_s_regs__t__lsb (us_split_fields1 (select regs idx)))))))
...
(assert (and (= o4 (- (to_rep (rec__hw__dbc__cap_s_regs__t__msb (us_split_fields1 (select regs idx)))) (to_rep (rec__hw__dbc__cap_s_regs__t__lsb (us_split_fields1 (select regs idx)))))) (in_range1 (- (to_rep (rec__hw__dbc__cap_s_regs__t__msb (us_split_fields1 (select regs idx)))) (to_rep (rec__hw__dbc__cap_s_regs__t__lsb (us_split_fields1 (select regs idx))))))))
(assert (= o5 (+ o4 1)))
(assert (and (= o7 o5) (in_range1 o5)))
(assert (= o8 (ite (<= o7 o6) true false)))
(assert (and (= o1 (+ byte_offset (to_rep (rec__hw__dbc__cap_s_regs__t__byte_offset (us_split_fields1 (select regs idx)))))) (in_range1 (+ byte_offset (to_rep (rec__hw__dbc__cap_s_regs__t__byte_offset (us_split_fields1 (select regs idx))))))))
(assert (= o2 (div1 o1 4)))
(assert (= o3 (ite (<= o2 16383) true false)))
(assert (and (= o (+ byte_offset (to_rep (rec__hw__dbc__cap_s_regs__t__byte_offset (us_split_fields1 (select regs idx)))))) (in_range1 (+ byte_offset (to_rep (rec__hw__dbc__cap_s_regs__t__byte_offset (us_split_fields1 (select regs idx))))))))
(assert (not (not (= 4 0))))
(check-sat)
(exit)
