...
(assert (and (= o2 (+ byte_offset (to_rep (rec__hw__dbc__cap_s_regs__t__byte_offset (us_split_fields1 (select regs idx)))))) (in_range1 (+ byte_offset (to_rep (rec__hw__dbc__cap_s_regs__t__byte_offset (us_split_fields1 (select regs idx))))))))
(assert (= o3 (div1 o2 4)))
