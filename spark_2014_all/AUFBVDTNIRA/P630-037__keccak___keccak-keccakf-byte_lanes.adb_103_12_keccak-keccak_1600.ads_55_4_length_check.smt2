...
(assert (not (= (ite (<= (to_rep (first temp___7461)) (to_rep (last temp___7461))) (+ (- (to_rep (last temp___7461)) (to_rep (first temp___7461))) 1) 0) (ite (<= (to_rep data__first) (to_rep data__last)) (+ (- (to_rep data__last) (to_rep data__first)) 1) 0))))
(check-sat)
(exit)
