...
(assert (= index1 1))
(assert (=> (and (<= 1 index1) (<= index1 r28b)) (= temp___836 temp1)))
(assert (=> (and (<= 1 index1) (<= index1 r28b)) (and (= result____split_discrs (mk___split_discrs temp___833)) (= result____split_fields2 (mk___split_fields1 (mk___t1 temp___8331 temp___8332))))))
(assert (=> (and (<= 1 index1) (<= index1 r28b)) (and (and (and (dynamic_invariant2 (mk___rep1 result____split_discrs result____split_fields3) false true true) (forall ((temp___835 Int)) (=> (and (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))) temp___835) (<= temp___835 (to_rep2 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))))) (=> (<= index2 temp___835) (= (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields3)) temp___835) (select temp___8331 temp___835)))))) (=> (<= 0 2147483647) (in_range1 temp2))) (and (<= 1 index2) (<= index2 r28b)))))
...
(assert (=> (and (<= 1 index1) (<= index1 r28b)) (= temp___832 (mk___rep1 result____split_discrs o10))))
(assert (=> (and (<= 1 index1) (<= index1 r28b)) (= result3 (mk___split_fields__ref1 result____split_fields3))))
(assert (=> (and (<= 1 index1) (<= index1 r28b)) (= result____split_fields4 (us_split_fields3 temp___832))))
(assert (=> (and (<= 1 index1) (<= index1 r28b)) (= result____split_discrs (us_split_discrs2 temp___832))))
