...
(assert (and (and (and (= us octet_length) (in_range3 octet_length)) (and (= (to_rep (rec__very_longs__very_long__octet_length result____split_discrs)) octet_length) (and (dynamic_invariant2 (mk___rep1 result____split_discrs (mk___split_fields1 (mk___t1 result____split_fields result____split_fields1))) false false true) (and (=> (<= 0 2147483647) (in_range1 temp)) (and (and (and (and (and (and (and (= (to_rep2 (first4 (rt2 (temp___818 ((_ int2bv 8) 0) 1 octet_length)))) 1) (and (= (to_rep2 (last4 (rt2 (temp___818 ((_ int2bv 8) 0) 1 octet_length)))) octet_length) (= (mk___t2 temp___825 temp___8251) (temp___818 ((_ int2bv 8) 0) 1 octet_length)))) (and (= (ite (<= (to_rep2 (first4 temp___8251)) (to_rep2 (last4 temp___8251))) (+ (- (to_rep2 (last4 temp___8251)) (to_rep2 (first4 temp___8251))) 1) 0) (ite (<= 1 octet_length) (+ (- octet_length 1) 1) 0)) (and (= temp___825 temp___826) (= (mk1 (to_rep2 (first4 temp___8251)) (to_rep2 (last4 temp___8251))) temp___8261)))) (and (= (ite (<= (to_rep2 (first2 temp___8261)) (to_rep2 (last2 temp___8261))) (+ (- (to_rep2 (last2 temp___8261)) (to_rep2 (first2 temp___8261))) 1) 0) (ite (<= (to_rep2 (first2 result____split_fields1)) (to_rep2 (last2 result____split_fields1))) (+ (- (to_rep2 (last2 result____split_fields1)) (to_rep2 (first2 result____split_fields1))) 1) 0)) (= (mk___t1 o o1) (mk___t1 temp___826 temp___8261)))) (and (= o2 o) (= o3 o1))) (and (= result____split_discrs (mk___split_discrs temp___829)) (and (= temp___8291 o2) (= temp___8292 o3)))) (and (and (= result (mk___split_fields__ref1 (mk___split_fields1 (mk___t1 result____split_fields result____split_fields1)))) (= result____split_fields2 (mk___split_fields1 (mk___t1 temp___8291 temp___8292)))) (= result____split_discrs (mk___split_discrs temp___829)))) (and (and (= result1 (mk_int__ref temp)) (= temp1 number)) (and (and (= (to_rep2 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields2)))) r28b) (in_range2 r28b)) (and (and (and (= result2 (mk_int__ref index)) (= index1 1)) (ite (and (<= 1 index1) (<= index1 r28b)) (and (and (and (= temp___836 temp1) (and (and (= result____split_discrs (mk___split_discrs temp___833)) (= result____split_fields2 (mk___split_fields1 (mk___t1 temp___8331 temp___8332)))) (and (and (and (and (dynamic_invariant2 (mk___rep1 result____split_discrs result____split_fields3) false true true) (forall ((temp___835 Int)) (=> (and (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))) temp___835) (<= temp___835 (to_rep2 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))))) (=> (<= index2 temp___835) (= (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields3)) temp___835) (select temp___8331 temp___835)))))) (=> (<= 0 2147483647) (in_range1 temp2))) (and (<= 1 index2) (<= index2 r28b))) (and (and (and (and (and (and (and (and (and (= o4 (mod1 temp2 256)) (uint_in_range (mod1 temp2 256))) (= o5 ((_ int2bv 8) o4))) (= (to_rep1 o6) o5)) (and (and (and (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))) index2) (<= index2 (to_rep2 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))))) (= o7 index2)) (= o8 (store (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields3)) o7 o6)))) (= o9 (mk___t1 o8 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3))))) (= o10 (mk___split_fields1 o9))) (= temp___832 (mk___rep1 result____split_discrs o10))) (and (and (= result3 (mk___split_fields__ref1 result____split_fields3)) (= result____split_fields4 (us_split_fields3 temp___832))) (= result____split_discrs (us_split_discrs2 temp___832)))) (and (and (= result4 (mk_int__ref temp2)) (= temp3 (div1 temp2 256))) (= index2 r28b)))))) (and (and (= index3 (mk_int__ref index2)) (and (= temp4 (mk_int__ref temp3)) (= result____split_fields5 (mk___split_fields__ref1 result____split_fields4)))) (and (= index4 index2) (and (= temp5 temp3) (= result____split_fields6 result____split_fields4))))) (and (and (= index5 index3) (and (= temp6 temp4) (= result____split_fields7 result____split_fields5))) (and (= index6 index4) (and (= temp7 temp5) (= result____split_fields8 result____split_fields6))))) (and (and (= index5 (mk_int__ref index1)) (and (= temp6 (mk_int__ref temp1)) (= result____split_fields7 (mk___split_fields__ref1 result____split_fields2)))) (and (= index6 index1) (and (= temp7 temp1) (= result____split_fields8 result____split_fields2)))))) (and (and (= very_longs__make_from_natural__result4 (mk_very_long__ref very_longs__make_from_natural__result3)) (= very_longs__make_from_natural__result5 very_longs__make_from_natural__result3)) (and (= result5 (mk_very_long__ref (mk___rep (mk___split_discrs very_longs__make_from_natural__result) (mk___split_fields (mk___t very_longs__make_from_natural__result1 very_longs__make_from_natural__result2))))) (= very_longs__make_from_natural__result3 (to_base (mk___rep1 result____split_discrs (us_split_fields__content1 result____split_fields7)))))))))))))) (and (and (= very_longs__make_from_natural__result6 very_longs__make_from_natural__result4) (and (= index7 index5) (and (= temp8 temp6) (= result____split_fields9 result____split_fields7)))) (and (= very_longs__make_from_natural__result7 very_longs__make_from_natural__result5) (and (= index8 index6) (and (= temp9 temp7) (= result____split_fields10 result____split_fields8)))))))
...
(assert (not (= (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 (very_long__content very_longs__make_from_natural__result6)))) octet_length)))
(check-sat)
(exit)
