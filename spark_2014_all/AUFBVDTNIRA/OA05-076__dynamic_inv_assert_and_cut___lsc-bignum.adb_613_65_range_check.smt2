...
(assert (= o57 (bvadd o56 #x0000000000000001)))
(assert (= o58 (bvmul o57 #x0000000000000020)))
(assert (= o59 (ite (bvult i2 o58) true false)))
(assert (= o51 (from_word32 #x00000001)))
...
(assert (= o43 (from_word32 #x00000002)))
...
(assert (= o35 (from_word32 #x00000002)))
...
(assert (and (= o19 (base Tuple0)) (= o19 (oexpon (from_word32 #x00000002) 32))))
(assert (= o21 (oexpon o19 o20)))
(assert (= o17 (from_word32 #x00000002)))
(assert (= o18 (oexpon o17 (- h9 1))))
(assert (= o14 (from_word32 #x00000001)))
(assert (= o13 (from_word64 i2)))
(assert (= o15 (oadd o13 o14)))
(assert (= o12 (from_word32 #x00000002)))
