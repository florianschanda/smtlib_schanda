...
(assert (and (= o54 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (and (= o55 o54) (uint_in_range1 o54)))
(assert (= o56 ((_ int2bv 64) o55)))
(assert (= o57 (bvadd o56 ((_ int2bv 64) 1))))
(assert (= o58 (bvmul o57 ((_ int2bv 64) 32))))
(assert (= o59 (ite (bvult i2 o58) true false)))
(assert (= o51 (from_word32 ((_ int2bv 32) 1))))
(assert (= o50 (from_word64 i2)))
(assert (= o52 (oadd o50 o51)))
(assert (= o49 (from_integer s10)))
(assert (= o53 (ole o49 o52)))
(assert (and (= o47 (+ k 1)) (in_range1 (+ k 1))))
(assert (= o48 (ite (<= s10 o47) true false)))
(assert (= o43 (from_word32 ((_ int2bv 32) 2))))
(assert (= o44 (oexpon o43 s10)))
(assert (= o38 (from_word32 ((_ int2bv 32) 1))))
(assert (= o37 (from_integer s10)))
(assert (= o39 (osubtract o37 o38)))
(assert (= o36 (from_word64 i2)))
(assert (= o40 (osubtract o36 o39)))
(assert (= o35 (from_word32 ((_ int2bv 32) 2))))
(assert (= o41 (oexpon__2 o35 o40)))
(assert (and (= o30 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (= o31 (+ o30 1)))
(assert (and (= o32 o31) (in_range1 o31)))
(assert (and (= o33 o32) (in_range2 o32)))
(assert (= o34 (num_of_big_int e e_first o33)))
(assert (= o42 (odivide o34 o41)))
(assert (= o45 (omod o42 o44)))
(assert (= o29 (from_word32 (t__content w7))))
(assert (= o46 (oeq o29 o45)))
(assert (and (= o24 (power 2 k)) (in_range1 (power 2 k))))
(assert (= o25 (- o24 1)))
(assert (and (= o26 o25) (in_range1 o25)))
(assert (= o27 (ite (<= n o26) true false)))
(assert (= result8 (ite (<= 0 n) o27 false)))
(assert (= (= o28 true) (forall ((n1 Int)) (=> (and (<= 0 n1) (<= n1 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux45) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n1 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))))
(assert (and (= o22 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o23 (num_of_big_int m m_first o22)))
(assert (and (= o20 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (and (= o19 (base Tuple0)) (= o19 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o21 (oexpon o19 o20)))
(assert (= o17 (from_word32 ((_ int2bv 32) 2))))
(assert (= o18 (oexpon o17 (- h9 1))))
(assert (= o14 (from_word32 ((_ int2bv 32) 1))))
(assert (= o13 (from_word64 i2)))
(assert (= o15 (oadd o13 o14)))
(assert (= o12 (from_word32 ((_ int2bv 32) 2))))
(assert (= o16 (oexpon__2 o12 o15)))
(assert (and (= o9 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (= o10 (+ o9 1)))
(assert (and (= o11 o10) (in_range1 o10)))
(assert (not (in_range2 o11)))
(check-sat)
(exit)
