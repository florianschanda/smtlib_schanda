...
(assert (= digit1 o2))
(assert (=> (= bit_value 1) (=> (< bit_position1 8) (= o3 (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) bit_position1))))))
(assert (=> (= bit_value 1) (=> (not (< bit_position1 8)) (= o3 ((_ int2bv 8) 0)))))
(assert (=> (= bit_value 1) (= o4 (bvor digit1 o3))))
(assert (=> (= bit_value 1) (= result3 digit1)))
(assert (=> (= bit_value 1) (= digit2 o4)))
(assert (=> (not (= bit_value 1)) (=> (< bit_position1 8) (= o5 (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) bit_position1))))))
(assert (=> (not (= bit_value 1)) (=> (not (< bit_position1 8)) (= o5 ((_ int2bv 8) 0)))))
