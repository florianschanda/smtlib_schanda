...
(assert (and (and (= o3 (xdr_hyper_to_unsigned value)) (and (= last3 (+ position 7)) (in_range3 last3))) (and (and (= last3 last4) (= data data1)) (and (= last5 last3) (= data2 data)))))
(assert (not (= last4 (+ position 7))))
(check-sat)
(exit)
