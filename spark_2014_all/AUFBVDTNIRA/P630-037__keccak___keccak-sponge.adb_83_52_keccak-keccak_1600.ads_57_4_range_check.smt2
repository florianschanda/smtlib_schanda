...
(assert (forall ((temp___864 Int)) (ite (and (<= r74s temp___864) (<= temp___864 r75s)) (= (select o13 temp___864) (select temp___863 temp___864)) (= (select o13 temp___864) (select ctx__split_fields1 temp___864)))))
...
(assert (= ctx__split_fields6 (mk___split_fields temp___866 temp___8661 temp___8662 temp___8663 temp___8664 temp___8665)))
