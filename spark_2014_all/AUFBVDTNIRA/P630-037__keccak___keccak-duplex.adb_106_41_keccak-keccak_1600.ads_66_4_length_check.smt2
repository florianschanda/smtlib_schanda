...
(assert (not (= (ite (<= (to_rep (first (rt in_data))) (to_rep (last (rt in_data)))) (+ (- (to_rep (last (rt in_data))) (to_rep (first (rt in_data)))) 1) 0) (ite (<= 0 (- (length in_data) 1)) (+ (- (- (length in_data) 1) 0) 1) 0))))
(check-sat)
(exit)
