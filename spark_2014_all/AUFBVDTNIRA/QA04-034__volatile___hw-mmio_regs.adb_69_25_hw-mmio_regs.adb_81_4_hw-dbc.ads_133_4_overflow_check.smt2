...
(assert true)
(assert true)
(assert (not (in_range (- (to_rep (rec__hw__dbc__op_s_regs__t__msb (us_split_fields1 (select regs idx)))) (to_rep (rec__hw__dbc__op_s_regs__t__lsb (us_split_fields1 (select regs idx))))))))
(check-sat)
(exit)
