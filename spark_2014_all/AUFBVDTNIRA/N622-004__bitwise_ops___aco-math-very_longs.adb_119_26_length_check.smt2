...
(assert (not (= (ite (<= (to_rep4 (first4 temp___10601)) (to_rep4 (last4 temp___10601))) (+ (- (to_rep4 (last4 temp___10601)) (to_rep4 (first4 temp___10601))) 1) 0) (ite (<= (to_rep4 (first2 result____split_fields1)) (to_rep4 (last2 result____split_fields1))) (+ (- (to_rep4 (last2 result____split_fields1)) (to_rep4 (first2 result____split_fields1))) 1) 0))))
(check-sat)
(exit)
