...
(assert (=> (<= (to_rep first_block__first) (to_rep first_block__last)) (= o6 (+ (- (to_rep first_block__last) (to_rep first_block__first)) 1))))
(assert (=> (not (<= (to_rep first_block__first) (to_rep first_block__last))) (= o6 0)))
(assert (=> (<= (to_rep next_block__first) (to_rep next_block__last)) (= o7 (+ (- (to_rep next_block__last) (to_rep next_block__first)) 1))))
(assert (=> (not (<= (to_rep next_block__first) (to_rep next_block__last))) (= o7 0)))
(assert (= result (ite (= o7 o6) true false)))
(assert (= result true))
(assert (=> (<= (to_rep first_block__first) (to_rep first_block__last)) (= o4 (+ (- (to_rep first_block__last) (to_rep first_block__first)) 1))))
(assert (=> (not (<= (to_rep first_block__first) (to_rep first_block__last))) (= o4 0)))
(assert (and (= o5 o4) (in_range o4)))
(assert (= result1 (ite (<= o5 268435455) true false)))
(assert (= result1 true))
