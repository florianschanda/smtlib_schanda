...
(assert (dynamic_property 0 2147483647 (to_rep first_block__first) (to_rep first_block__last)))
(assert (in_range1 num_used_bits))
(assert (in_range1 max_bit_length))
(assert (dynamic_property 0 2147483647 (to_rep next_block__first) (to_rep next_block__last)))
(assert (=> (<= (to_rep first_block__first) (to_rep first_block__last)) (= o5 (+ (- (to_rep first_block__last) (to_rep first_block__first)) 1))))
(assert (=> (not (<= (to_rep first_block__first) (to_rep first_block__last))) (= o5 0)))
(assert (=> (<= (to_rep next_block__first) (to_rep next_block__last)) (= o6 (+ (- (to_rep next_block__last) (to_rep next_block__first)) 1))))
(assert (=> (not (<= (to_rep next_block__first) (to_rep next_block__last))) (= o6 0)))
(assert (= result (ite (= o6 o5) true false)))
(assert (= result true))
(assert (=> (<= (to_rep first_block__first) (to_rep first_block__last)) (= o3 (+ (- (to_rep first_block__last) (to_rep first_block__first)) 1))))
(assert (=> (not (<= (to_rep first_block__first) (to_rep first_block__last))) (= o3 0)))
(assert (and (= o4 o3) (in_range o3)))
(assert (= result1 (ite (<= o4 268435455) true false)))
(assert (= result1 true))
(assert (<= max_bit_length 2147483640))
(assert (and (= o1 (+ max_bit_length 7)) (in_range (+ max_bit_length 7))))
(assert (= o2 (div1 o1 8)))
(assert (=> (<= (to_rep first_block__first) (to_rep first_block__last)) (= o (+ (- (to_rep first_block__last) (to_rep first_block__first)) 1))))
(assert (=> (not (<= (to_rep first_block__first) (to_rep first_block__last))) (= o 0)))
