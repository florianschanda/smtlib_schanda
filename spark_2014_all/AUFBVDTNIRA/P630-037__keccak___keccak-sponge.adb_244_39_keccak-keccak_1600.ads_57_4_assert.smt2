...
(declare-const temp___950 (Array Int byte))
(declare-const temp___9501 t2)
...
(assert (=> (< 1 message_byte_length1) (= (- message_last1 1) r108s)))
(assert (=> (< 1 message_byte_length1) (in_range1 r108s)))
(assert (=> (< 1 message_byte_length1) (and (= o14 (+ (- bit_length 8) (- 8 (mod2 bit_length 8)))) (in_range1 (+ (- bit_length 8) (- 8 (mod2 bit_length 8)))))))
(assert (=> (< 1 message_byte_length1) (and (= o15 o14) (in_range2 o14))))
(assert (=> (< 1 message_byte_length1) (=> (<= (to_rep6 (first (rt message))) r108s) (and (and (<= (to_rep6 (first (rt message))) (to_rep6 (first (rt message)))) (<= (to_rep6 (first (rt message))) (to_rep6 (last (rt message))))) (and (<= (to_rep6 (first (rt message))) r108s) (<= r108s (to_rep6 (last (rt message)))))))))
(assert (=> (< 1 message_byte_length1) (= o11 (elts message))))
(assert (=> (< 1 message_byte_length1) (= o11 temp___950)))
(assert (=> (< 1 message_byte_length1) (= (mk2 (to_rep6 (first (rt message))) r108s) temp___9501)))
(assert (=> (< 1 message_byte_length1) (= temp___950 o12)))
(assert (=> (< 1 message_byte_length1) (= (mk (to_rep6 (first4 temp___9501)) (to_rep6 (last4 temp___9501))) o13)))
(assert (=> (< 1 message_byte_length1) (and (and (and (= (state_of (mk___rep ctx__split_fields12)) 0) (= (rate_of (mk___rep ctx__split_fields12)) (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5))))) (= (mod2 (in_queue_bit_length (mk___rep ctx__split_fields12)) 8) (mod2 o15 8))) (< (in_queue_bit_length (mk___rep ctx__split_fields12)) (rate_of (mk___rep ctx__split_fields12))))))
(assert (=> (not (< 1 message_byte_length1)) (= ctx__split_fields12 (mk___split_fields ctx__split_fields ctx__split_fields1 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5))))
(assert (=> (not (< 1 message_byte_length1)) (= ctx__split_fields12 (mk___split_fields ctx__split_fields6 ctx__split_fields7 ctx__split_fields8 ctx__split_fields9 ctx__split_fields10 ctx__split_fields11))))
...
(assert (and (<= (to_rep6 (first (rt message))) (to_rep6 (last (rt message)))) (<= (to_rep6 (last (rt message))) (to_rep6 (last (rt message))))))
(assert (= o16 (to_rep6 (last (rt message)))))
...
(assert (and (and (and (= (state_of (mk___rep ctx__split_fields13)) 0) (= (rate_of (mk___rep ctx__split_fields13)) (rate_of (mk___rep ctx__split_fields12)))) (= (mod2 (in_queue_bit_length (mk___rep ctx__split_fields13)) 8) (mod2 8 8))) (< (in_queue_bit_length (mk___rep ctx__split_fields13)) (rate_of (mk___rep ctx__split_fields13)))))
(assert (not (= (mod2 (in_queue_bit_length (mk___rep ctx__split_fields13)) 8) 0)))
(check-sat)
(exit)
