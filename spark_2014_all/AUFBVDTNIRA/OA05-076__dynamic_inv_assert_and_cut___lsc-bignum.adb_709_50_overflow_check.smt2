...
(assert (= result9 true))
(assert (and (= o36 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o37 (num_of_big_int m m_first o36)))
(assert (and (= o33 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (and (= o32 (base Tuple0)) (= o32 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o34 (oexpon o32 o33)))
(assert (and (= o27 (* 2 n)) (in_range1 (* 2 n))))
(assert (= o28 (+ o27 1)))
(assert (and (= o29 o28) (in_range1 o28)))
(assert (and (= o30 o29) (in_range2 o29)))
(assert (and (= o25 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o26 (num_of_big_int x x_first o25)))
(assert (= o31 (oexpon o26 o30)))
(assert (= o35 (omultiply o31 o34)))
(assert (= o38 (omod o35 o37)))
