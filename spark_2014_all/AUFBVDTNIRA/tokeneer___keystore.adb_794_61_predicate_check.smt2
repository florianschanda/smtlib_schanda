...
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq6 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_150 Int)) (=> (and (<= a__first temp___idx_150) (<= temp___idx_150 a__last)) (= (to_rep8 (select a temp___idx_150)) (to_rep8 (select b (+ (- b__first a__first) temp___idx_150)))))))))))
(declare-fun compare1 ((Array Int logfileindext) Int Int (Array Int logfileindext) Int Int) Int)
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare1 a a_first a_last b b_first b_last) 0) (= (bool_eq6 a a_first a_last b b_first b_last) true)) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare1 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq6 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep8 (select a (+ i 1))) (to_rep8 (select b (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare1 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq6 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep8 (select b (+ i 1))) (to_rep8 (select a (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
...
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare2 a a_first a_last b b_first b_last) 0) (= (bool_eq8 a a_first a_last b b_first b_last) true)) :pattern ((compare2 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare2 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq8 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep11 (select a (+ i 1))) (to_rep11 (select b (+ j 1))))))))))) :pattern ((compare2 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare2 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq8 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep11 (select b (+ i 1))) (to_rep11 (select a (+ j 1))))))))))) :pattern ((compare2 a a_first a_last b b_first b_last))))))
...
(assert (forall ((temp___1145 Int)) (forall ((temp___1146 Int)) (= (select (temp___1143 temp___1145) temp___1146) (of_rep8 temp___1145)))))
(declare-fun temp___1147 (Int) (Array Int fileentrycountt))
(assert (forall ((temp___1149 Int)) (forall ((temp___1150 Int)) (= (select (temp___1147 temp___1149) temp___1150) (of_rep11 temp___1149)))))
(define-fun dynamic_invariant2 ((temp___expr_1137 us_rep3) (temp___is_init_1134 Bool) (temp___skip_constant_1135 Bool) (temp___do_toplevel_1136 Bool)) Bool (= (valid_numberlogentries (to_rep8 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___expr_1137))) (to_rep9 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___expr_1137))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___expr_1137)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___expr_1137))) true))
(define-fun default_initial_assumption ((temp___expr_1141 us_rep3) (temp___skip_top_level_1142 Bool)) Bool (and (and (and (= (to_rep8 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___expr_1141))) 1) (= (to_rep9 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___expr_1141))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___expr_1141)) (mk___rep2 (mk___split_fields2 (temp___1143 1) (of_rep8 1) (of_rep8 1) (of_rep10 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___expr_1141)) (temp___1147 0))))
(define-fun type_invariant ((temp___1151 us_rep3)) Bool (= (valid_numberlogentries (to_rep8 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___1151))) (to_rep9 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___1151))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___1151)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___1151))) true))
...
(define-fun bool_eq11 ((a (Array Int us_rep4)) (a__first Int) (a__last Int) (b (Array Int us_rep4)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_152 Int)) (=> (and (<= a__first temp___idx_152) (<= temp___idx_152 a__last)) (= (bool_eq10 (select a temp___idx_152) (select b (+ (- b__first a__first) temp___idx_152))) true)))) true false))
...
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq12 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_153 Int)) (=> (and (<= a__first temp___idx_153) (<= temp___idx_153 a__last)) (= (to_rep12 (select a temp___idx_153)) (to_rep12 (select b (+ (- b__first a__first) temp___idx_153)))))))))))
...
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare3 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq12 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep12 (select a (+ i 1))) (to_rep12 (select b (+ j 1))))))))))) :pattern ((compare3 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare3 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq12 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep12 (select b (+ i 1))) (to_rep12 (select a (+ j 1))))))))))) :pattern ((compare3 a a_first a_last b b_first b_last))))))
...
(define-fun dynamic_invariant3 ((temp___expr_1519 Int) (temp___is_init_1516 Bool) (temp___skip_constant_1517 Bool) (temp___do_toplevel_1518 Bool)) Bool (=> (or (= temp___is_init_1516 true) (<= 0 28)) (in_range18 temp___expr_1519)))
...
(assert (forall ((a (Array Int Bool)) (b (Array Int Bool))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq15 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_172 Int)) (=> (and (<= a__first temp___idx_172) (<= temp___idx_172 a__last)) (= (select a temp___idx_172) (select b (+ (- b__first a__first) temp___idx_172))))))))))
(declare-fun compare4 ((Array Int Bool) Int Int (Array Int Bool) Int Int) Int)
(assert (forall ((a (Array Int Bool)) (b (Array Int Bool))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare4 a a_first a_last b b_first b_last) 0) (= (bool_eq15 a a_first a_last b b_first b_last) true)) :pattern ((compare4 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int Bool)) (b (Array Int Bool))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare4 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq15 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_int2 (select a (+ i 1))) (to_int2 (select b (+ j 1))))))))))) :pattern ((compare4 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int Bool)) (b (Array Int Bool))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare4 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq15 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_int2 (select b (+ i 1))) (to_int2 (select a (+ j 1))))))))))) :pattern ((compare4 a a_first a_last b b_first b_last))))))
...
(declare-fun temp___String_Literal_1689 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1689 us_void_param) 1)) 65) (= (to_rep (select (temp___String_Literal_1689 us_void_param) 2)) 100)) (= (to_rep (select (temp___String_Literal_1689 us_void_param) 3)) 100)) (= (to_rep (select (temp___String_Literal_1689 us_void_param) 4)) 75)) (= (to_rep (select (temp___String_Literal_1689 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_1689 us_void_param) 6)) 121)) :pattern ((temp___String_Literal_1689 us_void_param)))))
...
(define-fun dynamic_invariant8 ((temp___expr_220 Int) (temp___is_init_217 Bool) (temp___skip_constant_218 Bool) (temp___do_toplevel_219 Bool)) Bool (=> (or (= temp___is_init_217 true) (<= 0 4294967295)) (in_range5 temp___expr_220)))
...
(define-fun dynamic_invariant12 ((temp___expr_932 Int) (temp___is_init_929 Bool) (temp___skip_constant_930 Bool) (temp___do_toplevel_931 Bool)) Bool (=> (or (= temp___is_init_929 true) (<= 0 10)) (in_range11 temp___expr_932)))
(define-fun dynamic_invariant13 ((temp___expr_944 Int) (temp___is_init_941 Bool) (temp___skip_constant_942 Bool) (temp___do_toplevel_943 Bool)) Bool (=> (or (= temp___is_init_941 true) (<= 0 4294967295)) (in_range9 temp___expr_944)))
(define-fun dynamic_invariant14 ((temp___expr_950 Int) (temp___is_init_947 Bool) (temp___skip_constant_948 Bool) (temp___do_toplevel_949 Bool)) Bool (=> (or (= temp___is_init_947 true) (<= 0 128)) (in_range10 temp___expr_950)))
(define-fun dynamic_invariant15 ((temp___expr_425 Int) (temp___is_init_422 Bool) (temp___skip_constant_423 Bool) (temp___do_toplevel_424 Bool)) Bool (=> (or (= temp___is_init_422 true) (<= 1 150)) (in_range6 temp___expr_425)))
(assert (= nouser (temp___String_Literal_136 Tuple0)))
(define-fun dynamic_invariant16 ((temp___expr_1103 Int) (temp___is_init_1100 Bool) (temp___skip_constant_1101 Bool) (temp___do_toplevel_1102 Bool)) Bool (=> (or (= temp___is_init_1100 true) (<= 0 17)) (in_range14 temp___expr_1103)))
(define-fun dynamic_invariant17 ((temp___expr_1082 Int) (temp___is_init_1079 Bool) (temp___skip_constant_1080 Bool) (temp___do_toplevel_1081 Bool)) Bool (=> (or (= temp___is_init_1079 true) (<= 1 17)) (in_range12 temp___expr_1082)))
(define-fun dynamic_invariant18 ((temp___expr_1207 Int) (temp___is_init_1204 Bool) (temp___skip_constant_1205 Bool) (temp___do_toplevel_1206 Bool)) Bool (=> (or (= temp___is_init_1204 true) (<= 0 2)) (in_range16 temp___expr_1207)))
(define-fun dynamic_invariant19 ((temp___expr_1088 Int) (temp___is_init_1085 Bool) (temp___skip_constant_1086 Bool) (temp___do_toplevel_1087 Bool)) Bool (=> (or (= temp___is_init_1085 true) (<= 0 17408)) (in_range13 temp___expr_1088)))
(define-fun dynamic_invariant20 ((temp___expr_1122 Int) (temp___is_init_1119 Bool) (temp___skip_constant_1120 Bool) (temp___do_toplevel_1121 Bool)) Bool (=> (or (= temp___is_init_1119 true) (<= 0 1024)) (in_range15 temp___expr_1122)))
(assert true)
...
(define-fun dynamic_invariant21 ((temp___expr_1460 (_ BitVec 32)) (temp___is_init_1457 Bool) (temp___skip_constant_1458 Bool) (temp___do_toplevel_1459 Bool)) Bool (=> (or (= temp___is_init_1457 true) (bvule ((_ int2bv 32) 0) ((_ int2bv 32) 15))) (in_range17 temp___expr_1460)))
...
(declare-const temp___1687 us_rep6)
(declare-const temp___1690 us_t1)
...
(assert (= temp___1687 (mk___rep5 o3)))
...
(assert (= thekeytemplate__split_fields7 (us_split_fields11 temp___1687)))
...
(assert (= temp___1690 (mk___t1 (temp___String_Literal_1689 Tuple0) (mk1 1 6))))
(assert (not (dynamic_predicate temp___1690)))
(check-sat)
(exit)
