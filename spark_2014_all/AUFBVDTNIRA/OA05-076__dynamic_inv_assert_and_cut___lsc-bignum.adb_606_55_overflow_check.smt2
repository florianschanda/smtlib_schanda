...
(assert (and (= o471 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o472 (num_of_big_int x x_first o471)))
(assert (= o475 (omultiply o472 o474)))
(assert (= o479 (omultiply o475 o478)))
(assert (= o482 (omod o479 o481)))
