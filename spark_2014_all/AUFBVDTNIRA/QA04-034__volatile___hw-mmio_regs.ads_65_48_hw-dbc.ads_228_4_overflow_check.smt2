...
(define-fun dynamic_invariant1 ((temp___expr_1231 (_ BitVec 32)) (temp___is_init_1227 Bool) (temp___skip_constant_1228 Bool) (temp___do_toplevel_1229 Bool) (temp___do_typ_inv_1230 Bool)) Bool true)
...
(define-fun t__ref___5__projection ((a t__ref1)) us_rep (t__content1 a))
