...
(assert (<= 0 j))
(assert (<= j (- start 1)))
(assert (and (= o9 (nth8_stream (mk___t addr2 (mk (to_rep addr__first) (to_rep addr__last))) j)) (= (= o9 true) (= (nth1 (to_rep1 (select addr2 (div1 j 8))) (- 7 (mod1 j 8))) true))))
(assert (= o10 (to_int2 o9)))
