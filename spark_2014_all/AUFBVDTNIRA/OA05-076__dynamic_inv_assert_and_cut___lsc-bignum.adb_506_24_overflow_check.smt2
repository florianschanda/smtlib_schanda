...
(assert (and (= o213 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o214 (num_of_big_int (mk___t aux11 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first o213)))
(assert (= o216 (oeq o214 o215)))
