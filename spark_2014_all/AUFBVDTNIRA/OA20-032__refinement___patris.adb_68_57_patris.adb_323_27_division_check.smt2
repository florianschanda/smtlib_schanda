...
(assert (=> (= (to_rep next_piece__split_fields) 0) (= temp___2471 o9)))
(assert (=> (= (to_rep next_piece__split_fields) 0) (= temp___24711 o10)))
(assert (=> (= (to_rep next_piece__split_fields) 0) (= temp___24712 o11)))
(assert (=> (= (to_rep next_piece__split_fields) 0) (= temp___24713 o12)))
...
(assert (=> (= (to_rep next_piece__split_fields) 0) (= next_piece__split_fields5 (mk___split_fields temp___2471 temp___24711 temp___24712 temp___24713))))
