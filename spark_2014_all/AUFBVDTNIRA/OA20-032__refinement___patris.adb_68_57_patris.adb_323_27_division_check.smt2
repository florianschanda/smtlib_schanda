...
(assert (=> (= (to_rep next_piece__split_fields) 0) (and (= o3 (rand Tuple0)) (in_range2 o3))))
(assert (=> (= (to_rep next_piece__split_fields) 0) (= o4 (mod2 o3 4))))
(assert (=> (= (to_rep next_piece__split_fields) 0) (= (to_rep3 o5) o4)))
(assert (=> (= (to_rep next_piece__split_fields) 0) (and (= o (rand Tuple0)) (in_range2 o))))
(assert (=> (= (to_rep next_piece__split_fields) 0) (= o1 (mod2 o 7))))
(assert (=> (= (to_rep next_piece__split_fields) 0) (= o2 (+ 1 o1))))
(assert (=> (= (to_rep next_piece__split_fields) 0) (= (to_rep o6) o2)))
(assert (=> (= (to_rep next_piece__split_fields) 0) (= o6 o7)))
(assert (=> (= (to_rep next_piece__split_fields) 0) (= o5 o8)))
(assert (=> (= (to_rep next_piece__split_fields) 0) (= rliteral o9)))
(assert (=> (= (to_rep next_piece__split_fields) 0) (= rliteral1 o10)))
(assert (=> (= (to_rep next_piece__split_fields) 0) (= temp___2478 o7)))
(assert (=> (= (to_rep next_piece__split_fields) 0) (= temp___24781 o8)))
(assert (=> (= (to_rep next_piece__split_fields) 0) (= temp___24782 o9)))
(assert (=> (= (to_rep next_piece__split_fields) 0) (= temp___24783 o10)))
(assert (=> (= (to_rep next_piece__split_fields) 0) (= result4 (mk___split_fields__ref (mk___split_fields next_piece__split_fields next_piece__split_fields1 next_piece__split_fields2 next_piece__split_fields3)))))
(assert (=> (= (to_rep next_piece__split_fields) 0) (= next_piece__split_fields5 (mk___split_fields temp___2478 temp___24781 temp___24782 temp___24783))))
(assert (=> (not (= (to_rep next_piece__split_fields) 0)) (= next_piece__split_fields5 (mk___split_fields next_piece__split_fields next_piece__split_fields1 next_piece__split_fields2 next_piece__split_fields3))))
(assert (=> (not (= (to_rep next_piece__split_fields) 0)) (= next_piece__split_fields5 next_piece__split_fields4)))
(assert (and (= o11 (no_overlap cur_board (mk___rep next_piece__split_fields5))) (= (= o11 true) (ite (= (to_rep (rec__patris__piece__s next_piece__split_fields5)) 2) (and (and (and (= (is_empty cur_board (to_rep2 (rec__patris__piece__y next_piece__split_fields5)) (to_rep1 (rec__patris__piece__x next_piece__split_fields5))) true) (= (is_empty cur_board (to_rep2 (rec__patris__piece__y next_piece__split_fields5)) (+ (to_rep1 (rec__patris__piece__x next_piece__split_fields5)) 1)) true)) (= (is_empty cur_board (+ (to_rep2 (rec__patris__piece__y next_piece__split_fields5)) 1) (to_rep1 (rec__patris__piece__x next_piece__split_fields5))) true)) (= (is_empty cur_board (+ (to_rep2 (rec__patris__piece__y next_piece__split_fields5)) 1) (+ (to_rep1 (rec__patris__piece__x next_piece__split_fields5)) 1)) true)) (ite (= (to_rep (rec__patris__piece__s next_piece__split_fields5)) 1) (forall ((y Int)) (=> (and (<= 0 y) (<= y 3)) (forall ((x Int)) (=> (and (<= 0 x) (<= x 3)) (=> (= (get (select possible_i_shapes (to_rep3 (rec__patris__piece__d next_piece__split_fields5))) y x) true) (= (is_empty cur_board (+ (to_rep2 (rec__patris__piece__y next_piece__split_fields5)) y) (+ (to_rep1 (rec__patris__piece__x next_piece__split_fields5)) x)) true)))))) (forall ((y Int)) (=> (and (<= 0 y) (<= y 2)) (forall ((x Int)) (=> (and (<= 0 x) (<= x 2)) (=> (= (get (get1 possible_three_shapes (to_rep (rec__patris__piece__s next_piece__split_fields5)) (to_rep3 (rec__patris__piece__d next_piece__split_fields5))) y x) true) (= (is_empty cur_board (+ (to_rep2 (rec__patris__piece__y next_piece__split_fields5)) y) (+ (to_rep1 (rec__patris__piece__x next_piece__split_fields5)) x)) true)))))))))))
(assert (= result5 (ite (not (= o11 true)) true false)))
(assert (not (= result5 true)))
(assert (= result6 (mk___split_fields__ref (mk___split_fields cur_piece__split_fields cur_piece__split_fields1 cur_piece__split_fields2 cur_piece__split_fields3))))
(assert (= cur_piece__split_fields4 next_piece__split_fields5))
(assert (and (= o12 (rand Tuple0)) (in_range2 o12)))
(assert (not (not (= 4 0))))
(check-sat)
(exit)
