...
(assert (= aux12 aux1))
(assert (= a15 a13))
(assert (not (= (oeq (num_of_big_int (mk___t (map__content a14) (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omod (oexpon__2 (num_of_big_int x x_first (+ (- a_last a_first) 1)) (num_of_big_int e e_first (+ (- e_last e_first) 1))) (num_of_big_int m m_first (+ (- a_last a_first) 1)))) true)))
(check-sat)
(exit)
