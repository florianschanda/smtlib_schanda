...
(assert (< 0 num_bytes))
(assert (and (= temp___1123 (+ (to_rep (first (rt in_data))) (- num_bytes 1))) (in_range (+ (to_rep (first (rt in_data))) (- num_bytes 1)))))
(assert (<= (to_rep (first (rt in_data))) temp___1123))
(assert (not (<= (to_rep (first (rt in_data))) (to_rep (first (rt in_data))))))
(check-sat)
(exit)
