...
(define-fun dynamic_invariant3 ((temp___expr_1081 us_rep1) (temp___is_init_1078 Bool) (temp___skip_constant_1079 Bool) (temp___do_toplevel_1080 Bool)) Bool (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1081))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1081))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1081)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1081))) true))
...
(declare-fun user_eq17 (namecountt namecountt) Bool)
(declare-const dummy17 namecountt)
...
(declare-fun user_eq19 (issueridt issueridt) Bool)
(declare-const dummy19 issueridt)
...
(declare-fun user_eq21 (maskt maskt) Bool)
(declare-const dummy21 maskt)
...
(assert (forall ((a (Array Int unsigned32t)) (b (Array Int unsigned32t))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq11 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_167 Int)) (=> (and (<= a__first temp___idx_167) (<= temp___idx_167 a__last)) (= (to_rep7 (select a temp___idx_167)) (to_rep7 (select b (+ (- b__first a__first) temp___idx_167)))))))))))
(declare-fun compare4 ((Array Int unsigned32t) Int Int (Array Int unsigned32t) Int Int) Int)
(assert (forall ((a (Array Int unsigned32t)) (b (Array Int unsigned32t))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare4 a a_first a_last b b_first b_last) 0) (= (bool_eq11 a a_first a_last b b_first b_last) true)) :pattern ((compare4 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int unsigned32t)) (b (Array Int unsigned32t))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare4 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq11 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep7 (select a (+ i 1))) (to_rep7 (select b (+ j 1))))))))))) :pattern ((compare4 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int unsigned32t)) (b (Array Int unsigned32t))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare4 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq11 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep7 (select b (+ i 1))) (to_rep7 (select a (+ j 1))))))))))) :pattern ((compare4 a a_first a_last b b_first b_last))))))
...
(define-fun dynamic_invariant4 ((temp___expr_1463 Int) (temp___is_init_1460 Bool) (temp___skip_constant_1461 Bool) (temp___do_toplevel_1462 Bool)) Bool (=> (or (= temp___is_init_1460 true) (<= 0 28)) (in_range15 temp___expr_1463)))
...
(declare-fun user_eq25 (us_t1 us_t1) Bool)
(declare-const dummy25 us_t1)
...
(declare-fun user_eq27 (us_t2 us_t2) Bool)
(declare-const dummy27 us_t2)
...
(declare-fun user_eq29 (us_t3 us_t3) Bool)
(declare-const dummy29 us_t3)
...
(declare-fun temp___1761 (Int) (Array Int unsigned32t))
(assert (forall ((temp___1763 Int)) (forall ((temp___1764 Int)) (= (select (temp___1761 temp___1763) temp___1764) (of_rep7 temp___1763)))))
(declare-fun temp___String_Literal_1765 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1765 us_void_param) 1)) 70) (= (to_rep (select (temp___String_Literal_1765 us_void_param) 2)) 105)) (= (to_rep (select (temp___String_Literal_1765 us_void_param) 3)) 110)) (= (to_rep (select (temp___String_Literal_1765 us_void_param) 4)) 100)) (= (to_rep (select (temp___String_Literal_1765 us_void_param) 5)) 79)) (= (to_rep (select (temp___String_Literal_1765 us_void_param) 6)) 98)) (= (to_rep (select (temp___String_Literal_1765 us_void_param) 7)) 106)) (= (to_rep (select (temp___String_Literal_1765 us_void_param) 8)) 101)) (= (to_rep (select (temp___String_Literal_1765 us_void_param) 9)) 99)) (= (to_rep (select (temp___String_Literal_1765 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_1765 us_void_param) 11)) 115)) (= (to_rep (select (temp___String_Literal_1765 us_void_param) 12)) 73)) (= (to_rep (select (temp___String_Literal_1765 us_void_param) 13)) 110)) (= (to_rep (select (temp___String_Literal_1765 us_void_param) 14)) 105)) (= (to_rep (select (temp___String_Literal_1765 us_void_param) 15)) 116)) (= (to_rep (select (temp___String_Literal_1765 us_void_param) 16)) 32)) :pattern ((temp___String_Literal_1765 us_void_param)))))
(declare-fun temp___String_Literal_1775 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1775 us_void_param) 1)) 67) (= (to_rep (select (temp___String_Literal_1775 us_void_param) 2)) 114)) (= (to_rep (select (temp___String_Literal_1775 us_void_param) 3)) 121)) (= (to_rep (select (temp___String_Literal_1775 us_void_param) 4)) 112)) (= (to_rep (select (temp___String_Literal_1775 us_void_param) 5)) 116)) (= (to_rep (select (temp___String_Literal_1775 us_void_param) 6)) 111)) (= (to_rep (select (temp___String_Literal_1775 us_void_param) 7)) 32)) (= (to_rep (select (temp___String_Literal_1775 us_void_param) 8)) 76)) (= (to_rep (select (temp___String_Literal_1775 us_void_param) 9)) 105)) (= (to_rep (select (temp___String_Literal_1775 us_void_param) 10)) 98)) (= (to_rep (select (temp___String_Literal_1775 us_void_param) 11)) 114)) (= (to_rep (select (temp___String_Literal_1775 us_void_param) 12)) 97)) (= (to_rep (select (temp___String_Literal_1775 us_void_param) 13)) 114)) (= (to_rep (select (temp___String_Literal_1775 us_void_param) 14)) 121)) (= (to_rep (select (temp___String_Literal_1775 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_1775 us_void_param) 16)) 69)) (= (to_rep (select (temp___String_Literal_1775 us_void_param) 17)) 114)) (= (to_rep (select (temp___String_Literal_1775 us_void_param) 18)) 114)) (= (to_rep (select (temp___String_Literal_1775 us_void_param) 19)) 111)) (= (to_rep (select (temp___String_Literal_1775 us_void_param) 20)) 114)) (= (to_rep (select (temp___String_Literal_1775 us_void_param) 21)) 32)) (= (to_rep (select (temp___String_Literal_1775 us_void_param) 22)) 105)) (= (to_rep (select (temp___String_Literal_1775 us_void_param) 23)) 110)) (= (to_rep (select (temp___String_Literal_1775 us_void_param) 24)) 32)) (= (to_rep (select (temp___String_Literal_1775 us_void_param) 25)) 70)) (= (to_rep (select (temp___String_Literal_1775 us_void_param) 26)) 105)) (= (to_rep (select (temp___String_Literal_1775 us_void_param) 27)) 110)) (= (to_rep (select (temp___String_Literal_1775 us_void_param) 28)) 100)) (= (to_rep (select (temp___String_Literal_1775 us_void_param) 29)) 79)) (= (to_rep (select (temp___String_Literal_1775 us_void_param) 30)) 98)) (= (to_rep (select (temp___String_Literal_1775 us_void_param) 31)) 106)) (= (to_rep (select (temp___String_Literal_1775 us_void_param) 32)) 101)) (= (to_rep (select (temp___String_Literal_1775 us_void_param) 33)) 99)) (= (to_rep (select (temp___String_Literal_1775 us_void_param) 34)) 116)) (= (to_rep (select (temp___String_Literal_1775 us_void_param) 35)) 115)) (= (to_rep (select (temp___String_Literal_1775 us_void_param) 36)) 73)) (= (to_rep (select (temp___String_Literal_1775 us_void_param) 37)) 110)) (= (to_rep (select (temp___String_Literal_1775 us_void_param) 38)) 105)) (= (to_rep (select (temp___String_Literal_1775 us_void_param) 39)) 116)) (= (to_rep (select (temp___String_Literal_1775 us_void_param) 40)) 32)) (= (to_rep (select (temp___String_Literal_1775 us_void_param) 41)) 32)) (= (to_rep (select (temp___String_Literal_1775 us_void_param) 42)) 58)) (= (to_rep (select (temp___String_Literal_1775 us_void_param) 43)) 32)) :pattern ((temp___String_Literal_1775 us_void_param)))))
(declare-fun temp___String_Literal_1778 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1778 us_void_param) 1)) 70) (= (to_rep (select (temp___String_Literal_1778 us_void_param) 2)) 105)) (= (to_rep (select (temp___String_Literal_1778 us_void_param) 3)) 110)) (= (to_rep (select (temp___String_Literal_1778 us_void_param) 4)) 100)) (= (to_rep (select (temp___String_Literal_1778 us_void_param) 5)) 79)) (= (to_rep (select (temp___String_Literal_1778 us_void_param) 6)) 98)) (= (to_rep (select (temp___String_Literal_1778 us_void_param) 7)) 106)) (= (to_rep (select (temp___String_Literal_1778 us_void_param) 8)) 101)) (= (to_rep (select (temp___String_Literal_1778 us_void_param) 9)) 99)) (= (to_rep (select (temp___String_Literal_1778 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_1778 us_void_param) 11)) 115)) (= (to_rep (select (temp___String_Literal_1778 us_void_param) 12)) 32)) :pattern ((temp___String_Literal_1778 us_void_param)))))
(declare-fun temp___String_Literal_1788 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1788 us_void_param) 1)) 67) (= (to_rep (select (temp___String_Literal_1788 us_void_param) 2)) 114)) (= (to_rep (select (temp___String_Literal_1788 us_void_param) 3)) 121)) (= (to_rep (select (temp___String_Literal_1788 us_void_param) 4)) 112)) (= (to_rep (select (temp___String_Literal_1788 us_void_param) 5)) 116)) (= (to_rep (select (temp___String_Literal_1788 us_void_param) 6)) 111)) (= (to_rep (select (temp___String_Literal_1788 us_void_param) 7)) 32)) (= (to_rep (select (temp___String_Literal_1788 us_void_param) 8)) 76)) (= (to_rep (select (temp___String_Literal_1788 us_void_param) 9)) 105)) (= (to_rep (select (temp___String_Literal_1788 us_void_param) 10)) 98)) (= (to_rep (select (temp___String_Literal_1788 us_void_param) 11)) 114)) (= (to_rep (select (temp___String_Literal_1788 us_void_param) 12)) 97)) (= (to_rep (select (temp___String_Literal_1788 us_void_param) 13)) 114)) (= (to_rep (select (temp___String_Literal_1788 us_void_param) 14)) 121)) (= (to_rep (select (temp___String_Literal_1788 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_1788 us_void_param) 16)) 69)) (= (to_rep (select (temp___String_Literal_1788 us_void_param) 17)) 114)) (= (to_rep (select (temp___String_Literal_1788 us_void_param) 18)) 114)) (= (to_rep (select (temp___String_Literal_1788 us_void_param) 19)) 111)) (= (to_rep (select (temp___String_Literal_1788 us_void_param) 20)) 114)) (= (to_rep (select (temp___String_Literal_1788 us_void_param) 21)) 32)) (= (to_rep (select (temp___String_Literal_1788 us_void_param) 22)) 105)) (= (to_rep (select (temp___String_Literal_1788 us_void_param) 23)) 110)) (= (to_rep (select (temp___String_Literal_1788 us_void_param) 24)) 32)) (= (to_rep (select (temp___String_Literal_1788 us_void_param) 25)) 70)) (= (to_rep (select (temp___String_Literal_1788 us_void_param) 26)) 105)) (= (to_rep (select (temp___String_Literal_1788 us_void_param) 27)) 110)) (= (to_rep (select (temp___String_Literal_1788 us_void_param) 28)) 100)) (= (to_rep (select (temp___String_Literal_1788 us_void_param) 29)) 79)) (= (to_rep (select (temp___String_Literal_1788 us_void_param) 30)) 98)) (= (to_rep (select (temp___String_Literal_1788 us_void_param) 31)) 106)) (= (to_rep (select (temp___String_Literal_1788 us_void_param) 32)) 101)) (= (to_rep (select (temp___String_Literal_1788 us_void_param) 33)) 99)) (= (to_rep (select (temp___String_Literal_1788 us_void_param) 34)) 116)) (= (to_rep (select (temp___String_Literal_1788 us_void_param) 35)) 115)) (= (to_rep (select (temp___String_Literal_1788 us_void_param) 36)) 32)) (= (to_rep (select (temp___String_Literal_1788 us_void_param) 37)) 32)) (= (to_rep (select (temp___String_Literal_1788 us_void_param) 38)) 58)) (= (to_rep (select (temp___String_Literal_1788 us_void_param) 39)) 32)) :pattern ((temp___String_Literal_1788 us_void_param)))))
(declare-fun temp___String_Literal_1791 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1791 us_void_param) 1)) 70) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 2)) 105)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 3)) 110)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 4)) 100)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 5)) 79)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 6)) 98)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 7)) 106)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 8)) 101)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 9)) 99)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 11)) 115)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 12)) 70)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 13)) 105)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 14)) 110)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 15)) 97)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 16)) 108)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 17)) 32)) :pattern ((temp___String_Literal_1791 us_void_param)))))
(declare-fun temp___String_Literal_1801 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1801 us_void_param) 1)) 67) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 2)) 114)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 3)) 121)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 4)) 112)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 5)) 116)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 6)) 111)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 7)) 32)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 8)) 76)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 9)) 105)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 10)) 98)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 11)) 114)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 12)) 97)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 13)) 114)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 14)) 121)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 16)) 69)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 17)) 114)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 18)) 114)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 19)) 111)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 20)) 114)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 21)) 32)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 22)) 105)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 23)) 110)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 24)) 32)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 25)) 70)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 26)) 105)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 27)) 110)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 28)) 100)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 29)) 79)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 30)) 98)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 31)) 106)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 32)) 101)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 33)) 99)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 34)) 116)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 35)) 115)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 36)) 70)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 37)) 105)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 38)) 110)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 39)) 97)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 40)) 108)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 41)) 32)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 42)) 32)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 43)) 58)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 44)) 32)) :pattern ((temp___String_Literal_1801 us_void_param)))))
...
(define-fun dynamic_invariant8 ((temp___expr_841 Int) (temp___is_init_838 Bool) (temp___skip_constant_839 Bool) (temp___do_toplevel_840 Bool)) Bool (=> (or (= temp___is_init_838 true) (<= 0 40)) (in_range12 temp___expr_841)))
(define-fun dynamic_invariant9 ((temp___expr_862 Int) (temp___is_init_859 Bool) (temp___skip_constant_860 Bool) (temp___do_toplevel_861 Bool)) Bool (=> (or (= temp___is_init_859 true) (<= 0 4294967295)) (in_range13 temp___expr_862)))
(define-fun dynamic_invariant10 ((temp___expr_385 Int) (temp___is_init_382 Bool) (temp___skip_constant_383 Bool) (temp___do_toplevel_384 Bool)) Bool (=> (or (= temp___is_init_382 true) (<= 1 150)) (in_range6 temp___expr_385)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(assert (= nouser (temp___String_Literal_136 Tuple0)))
(define-fun dynamic_invariant11 ((temp___expr_1047 Int) (temp___is_init_1044 Bool) (temp___skip_constant_1045 Bool) (temp___do_toplevel_1046 Bool)) Bool (=> (or (= temp___is_init_1044 true) (<= 0 17)) (in_range9 temp___expr_1047)))
(define-fun dynamic_invariant12 ((temp___expr_1026 Int) (temp___is_init_1023 Bool) (temp___skip_constant_1024 Bool) (temp___do_toplevel_1025 Bool)) Bool (=> (or (= temp___is_init_1023 true) (<= 1 17)) (in_range7 temp___expr_1026)))
(define-fun dynamic_invariant13 ((temp___expr_1151 Int) (temp___is_init_1148 Bool) (temp___skip_constant_1149 Bool) (temp___do_toplevel_1150 Bool)) Bool (=> (or (= temp___is_init_1148 true) (<= 0 2)) (in_range11 temp___expr_1151)))
(define-fun dynamic_invariant14 ((temp___expr_1032 Int) (temp___is_init_1029 Bool) (temp___skip_constant_1030 Bool) (temp___do_toplevel_1031 Bool)) Bool (=> (or (= temp___is_init_1029 true) (<= 0 17408)) (in_range8 temp___expr_1032)))
(define-fun dynamic_invariant15 ((temp___expr_1066 Int) (temp___is_init_1063 Bool) (temp___skip_constant_1064 Bool) (temp___do_toplevel_1065 Bool)) Bool (=> (or (= temp___is_init_1063 true) (<= 0 1024)) (in_range10 temp___expr_1066)))
(assert true)
...
(define-fun dynamic_invariant16 ((temp___expr_1404 (_ BitVec 32)) (temp___is_init_1401 Bool) (temp___skip_constant_1402 Bool) (temp___do_toplevel_1403 Bool)) Bool (=> (or (= temp___is_init_1401 true) (bvule ((_ int2bv 32) 0) ((_ int2bv 32) 15))) (in_range14 temp___expr_1404)))
...
(declare-const c84b (Array Int character))
(declare-const result__1 (Array Int character))
(declare-const c96b (Array Int character))
...
(declare-const keystore__dofind__B74b__thestring__assume us_t)
(declare-const o6 Int)
(declare-const temp___1769 us_t1)
(declare-const temp___1771 Int)
(declare-const o7 (Array Int character))
(declare-const temp___1772 us_t1)
(declare-const temp___1773 us_t1)
(declare-const o8 (Array Int character))
(declare-const temp___1768 us_t)
...
(declare-const keystore__dofind__B86b__thestring__assume us_t)
(declare-const o16 Int)
(declare-const temp___1782 us_t2)
(declare-const temp___1784 Int)
(declare-const o17 (Array Int character))
(declare-const temp___1785 us_t2)
(declare-const temp___1786 us_t2)
(declare-const o18 (Array Int character))
(declare-const temp___1781 us_t)
...
(declare-const keystore__dofind__B98b__thestring__assume us_t)
(declare-const o26 Int)
(declare-const temp___1795 us_t3)
(declare-const temp___1797 Int)
(declare-const o27 (Array Int character))
(declare-const temp___1798 us_t3)
(declare-const temp___1799 us_t3)
(declare-const o28 (Array Int character))
(declare-const temp___1794 us_t)
...
(declare-const c72b1 (Array Int character))
(declare-const result__3 (Array Int character))
(declare-const c84b1 (Array Int character))
...
(declare-const c72b2 (Array Int character))
...
(declare-const c84b2 (Array Int character))
...
(declare-const c96b1 (Array Int character))
...
(assert (=> (= (select issystem retvalini1) true) (= retvalini1 c70b)))
(assert (=> (= (select issystem retvalini1) true) (in_range15 c70b)))
(assert (=> (= (select issystem retvalini1) true) (= result3 (mk_map__ref result__))))
(assert (=> (= (select issystem retvalini1) true) (= result__5 nodescription)))
(assert (=> (= (select issystem retvalini1) true) (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE15 c70b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE15 c70b)))))) (= o (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE15 c70b))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE15 c70b)))))) 1)))))
(assert (=> (= (select issystem retvalini1) true) (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE15 c70b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE15 c70b))))))) (= o 0))))
(assert (=> (= (select issystem retvalini1) true) (=> (<= 1 43) (= o1 (+ (- 43 1) 1)))))
(assert (=> (= (select issystem retvalini1) true) (=> (not (<= 1 43)) (= o1 0))))
(assert (=> (= (select issystem retvalini1) true) (= o2 (+ o1 o))))
(assert (=> (= (select issystem retvalini1) true) (= o3 (+ 1 o2))))
(assert (=> (= (select issystem retvalini1) true) (= o4 (- o3 1))))
(assert (=> (= (select issystem retvalini1) true) (and (= o5 o4) (in_range2 o4))))
(assert (=> (= (select issystem retvalini1) true) (= keystore__dofind__B74b__thestring__assume (mk___t (concat1 (temp___String_Literal_1775 Tuple0) 1 43 (elts (to_string (attr__ATTRIBUTE_IMAGE15 c70b))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE15 c70b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE15 c70b)))))) (mk 1 o5)))))
(assert (=> (= (select issystem retvalini1) true) (= keystore__dofind__B74b__thestring__assume thestring)))
(assert (=> (= (select issystem retvalini1) true) (dynamic_invariant thestring true false true)))
(assert (=> (= (select issystem retvalini1) true) (and (= o6 (length thestring)) (in_range1 (length thestring)))))
(assert (=> (= (select issystem retvalini1) true) (= result4 (ite (<= o6 150) true false))))
(assert (=> (= (select issystem retvalini1) true) (=> (= result4 true) (= (ite (<= (to_rep1 (first (rt thestring))) (to_rep1 (last (rt thestring)))) (+ (- (to_rep1 (last (rt thestring))) (to_rep1 (first (rt thestring)))) 1) 0) (ite (<= 1 (length thestring)) (+ (- (length thestring) 1) 1) 0)))))
(assert (=> (= (select issystem retvalini1) true) (=> (= result4 true) (= temp___1769 (mk___t1 (slide (elts thestring) (to_rep1 (first (rt thestring))) 1) (mk1 1 (length thestring)))))))
(assert (=> (= (select issystem retvalini1) true) (=> (= result4 true) (and (= temp___1771 (length thestring)) (in_range1 (length thestring))))))
(assert (=> (= (select issystem retvalini1) true) (=> (= result4 true) (=> (<= 1 temp___1771) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 temp___1771) (<= temp___1771 150)))))))
(assert (=> (= (select issystem retvalini1) true) (=> (= result4 true) (= o7 result__5))))
(assert (=> (= (select issystem retvalini1) true) (=> (= result4 true) (= temp___1772 (mk___t1 o7 (mk1 1 temp___1771))))))
(assert (=> (= (select issystem retvalini1) true) (=> (= result4 true) (= (ite (<= (to_rep1 (first2 (rt1 temp___1769))) (to_rep1 (last2 (rt1 temp___1769)))) (+ (- (to_rep1 (last2 (rt1 temp___1769))) (to_rep1 (first2 (rt1 temp___1769)))) 1) 0) (ite (<= (to_rep1 (first2 (rt1 temp___1772))) (to_rep1 (last2 (rt1 temp___1772)))) (+ (- (to_rep1 (last2 (rt1 temp___1772))) (to_rep1 (first2 (rt1 temp___1772)))) 1) 0)))))
(assert (=> (= (select issystem retvalini1) true) (=> (= result4 true) (= temp___1773 temp___1769))))
(assert (=> (= (select issystem retvalini1) true) (=> (= result4 true) (forall ((temp___1774 Int)) (ite (and (<= 1 temp___1774) (<= temp___1774 (length thestring))) (= (select o8 temp___1774) (select (elts1 temp___1773) temp___1774)) (= (select o8 temp___1774) (select result__5 temp___1774)))))))
(assert (=> (= (select issystem retvalini1) true) (=> (= result4 true) (= result5 (mk_map__ref result__5)))))
(assert (=> (= (select issystem retvalini1) true) (=> (= result4 true) (= result__6 o8))))
(assert (=> (= (select issystem retvalini1) true) (=> (not (= result4 true)) (=> (<= 1 150) (and (and (<= (to_rep1 (first (rt thestring))) 1) (<= 1 (to_rep1 (last (rt thestring))))) (and (<= (to_rep1 (first (rt thestring))) 150) (<= 150 (to_rep1 (last (rt thestring))))))))))
(assert (=> (= (select issystem retvalini1) true) (=> (not (= result4 true)) (= temp___1768 thestring))))
(assert (=> (= (select issystem retvalini1) true) (=> (not (= result4 true)) (= o9 (elts temp___1768)))))
(assert (=> (= (select issystem retvalini1) true) (=> (not (= result4 true)) (= result6 (mk_map__ref result__5)))))
(assert (=> (= (select issystem retvalini1) true) (=> (not (= result4 true)) (= result__7 o9))))
(assert (=> (= (select issystem retvalini1) true) (=> (not (= result4 true)) (= result__6 result__7))))
(assert (=> (= (select issystem retvalini1) true) (= result7 (mk_map__ref c72b))))
(assert (=> (= (select issystem retvalini1) true) (= c72b2 result__6)))
(assert (=> (= (select issystem retvalini1) true) (and (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8)) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8)) true) (in_range4 auditalarm2))))
(assert (=> (not (= (select issystem retvalini1) true)) (= filestate2 filestate)))
(assert (=> (not (= (select issystem retvalini1) true)) (= state2 state)))
(assert (=> (not (= (select issystem retvalini1) true)) (= result__6 result__)))
(assert (=> (not (= (select issystem retvalini1) true)) (= c72b2 c72b)))
(assert (=> (not (= (select issystem retvalini1) true)) (= auditsystemfault2 auditsystemfault)))
(assert (=> (not (= (select issystem retvalini1) true)) (= auditalarm2 auditalarm)))
(assert (=> (not (= (select issystem retvalini1) true)) (= logfilestate__split_fields8 (mk___split_fields1 logfilestate__split_fields logfilestate__split_fields1 (mk___rep (mk___split_fields logfilestate__split_fields2 logfilestate__split_fields3 logfilestate__split_fields4 logfilestate__split_fields5)) logfilestate__split_fields6))))
(assert (=> (not (= (select issystem retvalini1) true)) (= logfilesstatus2 logfilesstatus)))
(assert (=> (not (= (select issystem retvalini1) true)) (= logfiles2 logfiles)))
(assert (=> (not (= (select issystem retvalini1) true)) (= filestate2 filestate1)))
(assert (=> (not (= (select issystem retvalini1) true)) (= state2 state1)))
(assert (=> (not (= (select issystem retvalini1) true)) (= result__6 result__3)))
(assert (=> (not (= (select issystem retvalini1) true)) (= c72b2 c72b1)))
(assert (=> (not (= (select issystem retvalini1) true)) (= auditsystemfault2 auditsystemfault1)))
(assert (=> (not (= (select issystem retvalini1) true)) (= auditalarm2 auditalarm1)))
(assert (=> (not (= (select issystem retvalini1) true)) (= logfilestate__split_fields8 logfilestate__split_fields7)))
(assert (=> (not (= (select issystem retvalini1) true)) (= logfilesstatus2 logfilesstatus1)))
(assert (=> (not (= (select issystem retvalini1) true)) (= logfiles2 logfiles1)))
(assert (=> (= (select issystem retvaldo2) true) (= retvaldo2 c82b)))
(assert (=> (= (select issystem retvaldo2) true) (in_range15 c82b)))
(assert (=> (= (select issystem retvaldo2) true) (= result8 (mk_map__ref result__1))))
(assert (=> (= (select issystem retvaldo2) true) (= result__8 nodescription)))
(assert (=> (= (select issystem retvaldo2) true) (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE15 c82b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE15 c82b)))))) (= o10 (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE15 c82b))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE15 c82b)))))) 1)))))
(assert (=> (= (select issystem retvaldo2) true) (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE15 c82b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE15 c82b))))))) (= o10 0))))
(assert (=> (= (select issystem retvaldo2) true) (=> (<= 1 39) (= o11 (+ (- 39 1) 1)))))
(assert (=> (= (select issystem retvaldo2) true) (=> (not (<= 1 39)) (= o11 0))))
(assert (=> (= (select issystem retvaldo2) true) (= o12 (+ o11 o10))))
(assert (=> (= (select issystem retvaldo2) true) (= o13 (+ 1 o12))))
(assert (=> (= (select issystem retvaldo2) true) (= o14 (- o13 1))))
(assert (=> (= (select issystem retvaldo2) true) (and (= o15 o14) (in_range2 o14))))
(assert (=> (= (select issystem retvaldo2) true) (= keystore__dofind__B86b__thestring__assume (mk___t (concat1 (temp___String_Literal_1788 Tuple0) 1 39 (elts (to_string (attr__ATTRIBUTE_IMAGE15 c82b))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE15 c82b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE15 c82b)))))) (mk 1 o15)))))
(assert (=> (= (select issystem retvaldo2) true) (= keystore__dofind__B86b__thestring__assume thestring1)))
(assert (=> (= (select issystem retvaldo2) true) (dynamic_invariant thestring1 true false true)))
(assert (=> (= (select issystem retvaldo2) true) (and (= o16 (length thestring1)) (in_range1 (length thestring1)))))
(assert (=> (= (select issystem retvaldo2) true) (= result9 (ite (<= o16 150) true false))))
(assert (=> (= (select issystem retvaldo2) true) (=> (= result9 true) (= (ite (<= (to_rep1 (first (rt thestring1))) (to_rep1 (last (rt thestring1)))) (+ (- (to_rep1 (last (rt thestring1))) (to_rep1 (first (rt thestring1)))) 1) 0) (ite (<= 1 (length thestring1)) (+ (- (length thestring1) 1) 1) 0)))))
(assert (=> (= (select issystem retvaldo2) true) (=> (= result9 true) (= temp___1782 (mk___t2 (slide (elts thestring1) (to_rep1 (first (rt thestring1))) 1) (mk2 1 (length thestring1)))))))
(assert (=> (= (select issystem retvaldo2) true) (=> (= result9 true) (and (= temp___1784 (length thestring1)) (in_range1 (length thestring1))))))
(assert (=> (= (select issystem retvaldo2) true) (=> (= result9 true) (=> (<= 1 temp___1784) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 temp___1784) (<= temp___1784 150)))))))
(assert (=> (= (select issystem retvaldo2) true) (=> (= result9 true) (= o17 result__8))))
(assert (=> (= (select issystem retvaldo2) true) (=> (= result9 true) (= temp___1785 (mk___t2 o17 (mk2 1 temp___1784))))))
(assert (=> (= (select issystem retvaldo2) true) (=> (= result9 true) (= (ite (<= (to_rep1 (first4 (rt2 temp___1782))) (to_rep1 (last4 (rt2 temp___1782)))) (+ (- (to_rep1 (last4 (rt2 temp___1782))) (to_rep1 (first4 (rt2 temp___1782)))) 1) 0) (ite (<= (to_rep1 (first4 (rt2 temp___1785))) (to_rep1 (last4 (rt2 temp___1785)))) (+ (- (to_rep1 (last4 (rt2 temp___1785))) (to_rep1 (first4 (rt2 temp___1785)))) 1) 0)))))
(assert (=> (= (select issystem retvaldo2) true) (=> (= result9 true) (= temp___1786 temp___1782))))
(assert (=> (= (select issystem retvaldo2) true) (=> (= result9 true) (forall ((temp___1787 Int)) (ite (and (<= 1 temp___1787) (<= temp___1787 (length thestring1))) (= (select o18 temp___1787) (select (elts2 temp___1786) temp___1787)) (= (select o18 temp___1787) (select result__8 temp___1787)))))))
(assert (=> (= (select issystem retvaldo2) true) (=> (= result9 true) (= result10 (mk_map__ref result__8)))))
(assert (=> (= (select issystem retvaldo2) true) (=> (= result9 true) (= result__9 o18))))
(assert (=> (= (select issystem retvaldo2) true) (=> (not (= result9 true)) (=> (<= 1 150) (and (and (<= (to_rep1 (first (rt thestring1))) 1) (<= 1 (to_rep1 (last (rt thestring1))))) (and (<= (to_rep1 (first (rt thestring1))) 150) (<= 150 (to_rep1 (last (rt thestring1))))))))))
(assert (=> (= (select issystem retvaldo2) true) (=> (not (= result9 true)) (= temp___1781 thestring1))))
(assert (=> (= (select issystem retvaldo2) true) (=> (not (= result9 true)) (= o19 (elts temp___1781)))))
(assert (=> (= (select issystem retvaldo2) true) (=> (not (= result9 true)) (= result11 (mk_map__ref result__8)))))
(assert (=> (= (select issystem retvaldo2) true) (=> (not (= result9 true)) (= result__10 o19))))
(assert (=> (= (select issystem retvaldo2) true) (=> (not (= result9 true)) (= result__9 result__10))))
(assert (=> (= (select issystem retvaldo2) true) (= result12 (mk_map__ref c84b))))
(assert (=> (= (select issystem retvaldo2) true) (= c84b2 result__9)))
(assert (=> (= (select issystem retvaldo2) true) (and (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields9)) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields9)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields9)) true) (in_range4 auditalarm3))))
(assert (=> (not (= (select issystem retvaldo2) true)) (= filestate3 filestate2)))
(assert (=> (not (= (select issystem retvaldo2) true)) (= state3 state2)))
(assert (=> (not (= (select issystem retvaldo2) true)) (= result__9 result__1)))
(assert (=> (not (= (select issystem retvaldo2) true)) (= c84b2 c84b)))
(assert (=> (not (= (select issystem retvaldo2) true)) (= auditsystemfault3 auditsystemfault2)))
(assert (=> (not (= (select issystem retvaldo2) true)) (= auditalarm3 auditalarm2)))
(assert (=> (not (= (select issystem retvaldo2) true)) (= logfilestate__split_fields9 logfilestate__split_fields8)))
(assert (=> (not (= (select issystem retvaldo2) true)) (= logfilesstatus3 logfilesstatus2)))
(assert (=> (not (= (select issystem retvaldo2) true)) (= logfiles3 logfiles2)))
(assert (=> (not (= (select issystem retvaldo2) true)) (= filestate3 filestate2)))
(assert (=> (not (= (select issystem retvaldo2) true)) (= state3 state2)))
(assert (=> (not (= (select issystem retvaldo2) true)) (= result__9 result__4)))
(assert (=> (not (= (select issystem retvaldo2) true)) (= c84b2 c84b1)))
(assert (=> (not (= (select issystem retvaldo2) true)) (= auditsystemfault3 auditsystemfault2)))
(assert (=> (not (= (select issystem retvaldo2) true)) (= auditalarm3 auditalarm2)))
(assert (=> (not (= (select issystem retvaldo2) true)) (= logfilestate__split_fields9 logfilestate__split_fields8)))
(assert (=> (not (= (select issystem retvaldo2) true)) (= logfilesstatus3 logfilesstatus2)))
(assert (=> (not (= (select issystem retvaldo2) true)) (= logfiles3 logfiles2)))
(assert (= (select issystem retvalfin2) true))
(assert (= retvalfin2 c94b))
(assert (in_range15 c94b))
(assert (= result13 (mk_map__ref result__2)))
(assert (= result__11 nodescription))
(assert (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE15 c94b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE15 c94b)))))) (= o20 (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE15 c94b))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE15 c94b)))))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE15 c94b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE15 c94b))))))) (= o20 0)))
(assert (=> (<= 1 44) (= o21 (+ (- 44 1) 1))))
(assert (=> (not (<= 1 44)) (= o21 0)))
(assert (= o22 (+ o21 o20)))
(assert (= o23 (+ 1 o22)))
(assert (= o24 (- o23 1)))
(assert (and (= o25 o24) (in_range2 o24)))
(assert (= keystore__dofind__B98b__thestring__assume (mk___t (concat1 (temp___String_Literal_1801 Tuple0) 1 44 (elts (to_string (attr__ATTRIBUTE_IMAGE15 c94b))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE15 c94b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE15 c94b)))))) (mk 1 o25))))
(assert (= keystore__dofind__B98b__thestring__assume thestring2))
(assert (dynamic_invariant thestring2 true false true))
(assert (and (= o26 (length thestring2)) (in_range1 (length thestring2))))
(assert (= result14 (ite (<= o26 150) true false)))
(assert (=> (= result14 true) (= (ite (<= (to_rep1 (first (rt thestring2))) (to_rep1 (last (rt thestring2)))) (+ (- (to_rep1 (last (rt thestring2))) (to_rep1 (first (rt thestring2)))) 1) 0) (ite (<= 1 (length thestring2)) (+ (- (length thestring2) 1) 1) 0))))
(assert (=> (= result14 true) (= temp___1795 (mk___t3 (slide (elts thestring2) (to_rep1 (first (rt thestring2))) 1) (mk3 1 (length thestring2))))))
(assert (=> (= result14 true) (and (= temp___1797 (length thestring2)) (in_range1 (length thestring2)))))
(assert (=> (= result14 true) (=> (<= 1 temp___1797) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 temp___1797) (<= temp___1797 150))))))
(assert (=> (= result14 true) (= o27 result__11)))
(assert (=> (= result14 true) (= temp___1798 (mk___t3 o27 (mk3 1 temp___1797)))))
(assert (=> (= result14 true) (= (ite (<= (to_rep1 (first6 (rt3 temp___1795))) (to_rep1 (last6 (rt3 temp___1795)))) (+ (- (to_rep1 (last6 (rt3 temp___1795))) (to_rep1 (first6 (rt3 temp___1795)))) 1) 0) (ite (<= (to_rep1 (first6 (rt3 temp___1798))) (to_rep1 (last6 (rt3 temp___1798)))) (+ (- (to_rep1 (last6 (rt3 temp___1798))) (to_rep1 (first6 (rt3 temp___1798)))) 1) 0))))
(assert (=> (= result14 true) (= temp___1799 temp___1795)))
(assert (=> (= result14 true) (forall ((temp___1800 Int)) (ite (and (<= 1 temp___1800) (<= temp___1800 (length thestring2))) (= (select o28 temp___1800) (select (elts3 temp___1799) temp___1800)) (= (select o28 temp___1800) (select result__11 temp___1800))))))
(assert (=> (= result14 true) (= result15 (mk_map__ref result__11))))
(assert (=> (= result14 true) (= result__12 o28)))
(assert (=> (not (= result14 true)) (=> (<= 1 150) (and (and (<= (to_rep1 (first (rt thestring2))) 1) (<= 1 (to_rep1 (last (rt thestring2))))) (and (<= (to_rep1 (first (rt thestring2))) 150) (<= 150 (to_rep1 (last (rt thestring2)))))))))
(assert (=> (not (= result14 true)) (= temp___1794 thestring2)))
(assert (=> (not (= result14 true)) (= o29 (elts temp___1794))))
(assert (=> (not (= result14 true)) (= result16 (mk_map__ref result__11))))
(assert (=> (not (= result14 true)) (= result__13 o29)))
(assert (=> (not (= result14 true)) (= result__12 result__13)))
(assert (= result17 (mk_map__ref c96b)))
(assert (= c96b1 result__12))
