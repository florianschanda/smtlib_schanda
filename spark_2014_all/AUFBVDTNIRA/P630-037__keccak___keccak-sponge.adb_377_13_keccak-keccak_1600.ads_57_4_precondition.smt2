...
(assert (= o39 (rec__keccak__keccak_1600__sponge__context__block ctx__split_fields12)))
(assert (= keccak__keccak_1600__keccakf_1600_lanes__extract_bytes__data__compl2 (mk___t5 o39 (mk5 0 r148s))))
(assert (= (to_rep o41) (to_rep (last10 (rt5 keccak__keccak_1600__keccakf_1600_lanes__extract_bytes__data__compl2)))))
(assert (= (to_rep o40) (to_rep (first10 (rt5 keccak__keccak_1600__keccakf_1600_lanes__extract_bytes__data__compl2)))))
(assert (not (<= (ite (<= (to_rep o40) (to_rep o41)) (+ (- (to_rep o41) (to_rep o40)) 1) 0) 200)))
(check-sat)
(exit)
