...
(assert (= (= o13 true) (forall ((n Int)) (=> (and (<= 0 n) (<= n (- h2 1))) (= (oeq (num_of_big_int (mk___t o18 (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))))
(assert (and (= o9 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o10 (num_of_big_int m m_first o9)))
(assert (and (= o7 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (and (= o6 (base Tuple0)) (= o6 (oexpon (from_word32 #x00000002) 32))))
(assert (= o8 (oexpon o6 o7)))
(assert (= o11 (omod o8 o10)))
(assert (and (= o4 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o5 (num_of_big_int (mk___t o15 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first o4)))
