...
(define-fun word_t__ref___11__projection ((a word_t__ref)) word_t (word_t__content a))
(define-fun dynamic_invariant5 ((temp___expr_746 (_ BitVec 32)) (temp___is_init_743 Bool) (temp___skip_constant_744 Bool) (temp___do_toplevel_745 Bool)) Bool true)
...
(declare-const hw__dbc__op_regs__read_i__3__off__assume Int)
