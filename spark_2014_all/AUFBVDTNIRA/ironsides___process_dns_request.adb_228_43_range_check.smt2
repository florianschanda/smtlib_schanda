...
(declare-const o17 blocklengthvalue)
...
(assert (= o16 block2))
(assert (= o17 (select (rec__rr_type__nsec_record_type__nsecrecordtype__blocklengths (us_split_fields3 nsec_record)) o16)))
(assert (= o18 (to_rep4 o17)))
(assert (= o19 (ite (<= o18 32) true false)))
(assert (and (<= 1 block2) (<= block2 32)))
(assert (= o12 block2))
...
(assert (= o15 (ite (<= 1 o14) true false)))
(assert (and (= o9 (* (- block2 1) 32)) (in_range1 (* (- block2 1) 32))))
(assert (and (= o10 o9) (in_range3 o9)))
(assert (= o11 (ite (<= dstbytes2 o10) true false)))
(assert (and (= o8 (* (- block2 1) 34)) (in_range1 (* (- block2 1) 34))))
