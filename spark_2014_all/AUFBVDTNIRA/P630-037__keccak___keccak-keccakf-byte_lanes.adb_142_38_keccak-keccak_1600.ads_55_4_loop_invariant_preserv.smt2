...
(assert (= temp___7732 (mk_int__ref temp___7731)))
(assert (= temp___7742 (mk_int__ref temp___7741)))
(assert (= temp___7752 (mk_int__ref temp___7751)))
(assert (= shift4 (mk_int__ref shift3)))
(assert (= offset12 (mk_int__ref offset11)))
(assert (= remaining_bytes12 (mk_int__ref remaining_bytes11)))
(assert (= data19 (mk_map__ref data18)))
(assert (= temp___7733 temp___7731))
(assert (= temp___7743 temp___7741))
(assert (= temp___7753 temp___7751))
(assert (= shift5 shift3))
(assert (= offset13 offset11))
(assert (= remaining_bytes13 remaining_bytes11))
(assert (= data20 data18))
(assert (not (= (+ (int__content offset12) (int__content remaining_bytes12)) (ite (<= (to_rep data__first) (to_rep data__last)) (+ (- (to_rep data__last) (to_rep data__first)) 1) 0))))
(check-sat)
(exit)
