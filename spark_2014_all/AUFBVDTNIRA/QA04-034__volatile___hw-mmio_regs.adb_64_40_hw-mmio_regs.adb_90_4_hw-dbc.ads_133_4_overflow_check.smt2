...
(define-fun word_t__ref___16__projection ((a word_t__ref)) word_t (word_t__content a))
(define-fun dynamic_invariant5 ((temp___expr_889 (_ BitVec 64)) (temp___is_init_885 Bool) (temp___skip_constant_886 Bool) (temp___do_toplevel_887 Bool) (temp___do_typ_inv_888 Bool)) Bool true)
...
(declare-const hw__dbc__op_regs__write_i__4__off__assume Int)
...
(assert (= o1 (div1 o 4)))
(assert (and (= hw__dbc__op_regs__write_i__4__off__assume o1) (in_range2 o1)))
(assert (= hw__dbc__op_regs__write_i__4__off__assume off))
