...
(assert (and (= o8 (- (to_rep4 (last2 (rt1 (rec__very_longs__very_long__long_digits result____split_fields3)))) index2)) (in_range5 (- (to_rep4 (last2 (rt1 (rec__very_longs__very_long__long_digits result____split_fields3)))) index2))))
(assert (= o9 (* 2 o8)))
