...
(define-fun word_t__ref___36__projection ((a word_t__ref)) word_t (word_t__content a))
(define-fun dynamic_invariant5 ((temp___expr_1105 (_ BitVec 64)) (temp___is_init_1102 Bool) (temp___skip_constant_1103 Bool) (temp___do_toplevel_1104 Bool)) Bool true)
...
(declare-const hw__dbc__regs__read_i__4__off__assume Int)
