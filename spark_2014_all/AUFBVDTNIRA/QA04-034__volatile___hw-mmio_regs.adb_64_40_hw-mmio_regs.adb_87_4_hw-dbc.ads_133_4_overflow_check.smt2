...
(define-fun word_t__ref___15__projection ((a word_t__ref)) word_t (word_t__content a))
(define-fun dynamic_invariant5 ((temp___expr_778 (_ BitVec 32)) (temp___is_init_775 Bool) (temp___skip_constant_776 Bool) (temp___do_toplevel_777 Bool)) Bool true)
...
(declare-const hw__dbc__op_regs__write_i__3__off__assume Int)
...
(assert (= o1 (div1 o 4)))
(assert (and (= hw__dbc__op_regs__write_i__3__off__assume o1) (in_range2 o1)))
(assert (= hw__dbc__op_regs__write_i__3__off__assume off))
(assert (in_range2 off))
(assert (not (in_range (+ (to_rep (rec__hw__dbc__op_s_regs__t__msb (us_split_fields1 (select regs idx)))) 1))))
(check-sat)
(exit)
