...
(assert true)
(assert (<= (to_rep a__first) a_first))
(assert (<= a_first (to_rep a__last)))
(assert (<= (to_rep a__first) a_last))
(assert (<= a_last (to_rep a__last)))
(assert (< a_first a_last))
(assert (<= (to_rep (first (rt x))) x_first))
(assert (<= x_first (to_rep (last (rt x)))))
(assert (and (= o90 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o91 (+ x_first o90)))
(assert (and (= o92 o91) (in_range1 o91)))
(assert (= o93 (ite (<= o92 (to_rep (last (rt x)))) true false)))
(assert (and (= o87 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o88 (+ x_first o87)))
(assert (and (= o89 o88) (in_range1 o88)))
(assert (= o94 (ite (<= (to_rep (first (rt x))) o89) true false)))
(assert (= result (ite (= o94 true) o93 false)))
(assert (= result true))
(assert (<= (to_rep (first (rt e))) e_first))
(assert (<= e_first (to_rep (last (rt e)))))
(assert (<= (to_rep (first (rt e))) e_last))
(assert (<= e_last (to_rep (last (rt e)))))
(assert (<= e_first e_last))
(assert (<= (to_rep (first (rt m))) m_first))
(assert (<= m_first (to_rep (last (rt m)))))
(assert (and (= o82 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o83 (+ m_first o82)))
(assert (and (= o84 o83) (in_range1 o83)))
(assert (= o85 (ite (<= o84 (to_rep (last (rt m)))) true false)))
(assert (and (= o79 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o80 (+ m_first o79)))
(assert (and (= o81 o80) (in_range1 o80)))
(assert (= o86 (ite (<= (to_rep (first (rt m))) o81) true false)))
(assert (= result1 (ite (= o86 true) o85 false)))
(assert (= result1 true))
(assert (<= (to_rep aux1__first) aux1_first))
(assert (<= aux1_first (to_rep aux1__last)))
(assert (and (= o74 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o75 (+ aux1_first o74)))
(assert (and (= o76 o75) (in_range1 o75)))
(assert (= o77 (ite (<= o76 (to_rep aux1__last)) true false)))
(assert (and (= o71 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o72 (+ aux1_first o71)))
(assert (and (= o73 o72) (in_range1 o72)))
(assert (= o78 (ite (<= (to_rep aux1__first) o73) true false)))
(assert (= result2 (ite (= o78 true) o77 false)))
(assert (= result2 true))
(assert (<= (to_rep aux2__first) aux2_first))
(assert (<= aux2_first (to_rep aux2__last)))
(assert (and (= o66 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o67 (+ aux2_first o66)))
(assert (and (= o68 o67) (in_range1 o67)))
(assert (= o69 (ite (<= o68 (to_rep aux2__last)) true false)))
(assert (and (= o63 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o64 (+ aux2_first o63)))
(assert (and (= o65 o64) (in_range1 o64)))
(assert (= o70 (ite (<= (to_rep aux2__first) o65) true false)))
(assert (= result3 (ite (= o70 true) o69 false)))
(assert (= result3 true))
(assert (<= (to_rep aux3__first) aux3_first))
(assert (<= aux3_first (to_rep aux3__last)))
(assert (and (= o58 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o59 (+ aux3_first o58)))
(assert (and (= o60 o59) (in_range1 o59)))
(assert (= o61 (ite (<= o60 (to_rep aux3__last)) true false)))
(assert (and (= o55 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o56 (+ aux3_first o55)))
(assert (and (= o57 o56) (in_range1 o56)))
(assert (= o62 (ite (<= (to_rep aux3__first) o57) true false)))
(assert (= result4 (ite (= o62 true) o61 false)))
(assert (= result4 true))
(assert (<= (to_rep aux4__first) aux4_first))
(assert (<= aux4_first (to_rep aux4__last)))
(assert (and (= o43 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o44 (+ o43 1)))
(assert (and (= o45 o44) (in_range1 o44)))
(assert (and (= o46 (power 2 k)) (in_range1 (power 2 k))))
(assert (= o47 (* o46 o45)))
(assert (and (= o48 o47) (in_range1 o47)))
(assert (= o49 (- o48 1)))
(assert (and (= o50 o49) (in_range1 o49)))
(assert (= o51 (+ aux4_first o50)))
(assert (and (= o52 o51) (in_range1 o51)))
(assert (= o53 (ite (<= o52 (to_rep aux4__last)) true false)))
...
(assert (= o41 (+ aux4_first o40)))
(assert (and (= o42 o41) (in_range1 o41)))
(assert (= o54 (ite (<= (to_rep aux4__first) o42) true false)))
(assert (= result5 (ite (= o54 true) o53 false)))
(assert (= result5 true))
(assert (<= k 30))
(assert (<= (to_rep (first (rt r))) r_first))
(assert (<= r_first (to_rep (last (rt r)))))
(assert (and (= o28 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o29 (+ r_first o28)))
(assert (and (= o30 o29) (in_range1 o29)))
(assert (= o31 (ite (<= o30 (to_rep (last (rt r)))) true false)))
(assert (and (= o25 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o26 (+ r_first o25)))
(assert (and (= o27 o26) (in_range1 o26)))
(assert (= o32 (ite (<= (to_rep (first (rt r))) o27) true false)))
(assert (= result6 (ite (= o32 true) o31 false)))
(assert (= result6 true))
(assert (and (= o19 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o20 (+ o19 1)))
...
(assert (= o16 (from_integer o15)))
(assert (= o12 (from_integer 2)))
(assert (= o17 (omultiply o12 o16)))
(assert (and (= o11 (base Tuple0)) (= o11 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o18 (oexpon__2 o11 o17)))
(assert (= o24 (omod o18 o23)))
(assert (and (= o6 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o7 (+ o6 1)))
(assert (and (= o8 o7) (in_range1 o7)))
(assert (and (= o9 o8) (in_range2 o8)))
(assert (= o10 (num_of_big_int r r_first o9)))
(assert (= result7 (oeq o10 o24)))
(assert (= result7 true))
