...
(assert (= o90 (ite (<= o89 (to_rep (last (rt x)))) true false)))
(assert (and (= o84 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o85 (+ x_first o84)))
(assert (and (= o86 o85) (in_range1 o85)))
(assert (= o91 (ite (<= (to_rep (first (rt x))) o86) true false)))
(assert (= result (ite (= o91 true) o90 false)))
(assert (= result true))
...
(assert (= o82 (ite (<= o81 (to_rep (last (rt m)))) true false)))
(assert (and (= o76 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o77 (+ m_first o76)))
(assert (and (= o78 o77) (in_range1 o77)))
(assert (= o83 (ite (<= (to_rep (first (rt m))) o78) true false)))
(assert (= result1 (ite (= o83 true) o82 false)))
(assert (= result1 true))
...
(assert (= o74 (ite (<= o73 (to_rep aux1__last)) true false)))
(assert (and (= o68 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o69 (+ aux1_first o68)))
(assert (and (= o70 o69) (in_range1 o69)))
(assert (= o75 (ite (<= (to_rep aux1__first) o70) true false)))
(assert (= result2 (ite (= o75 true) o74 false)))
(assert (= result2 true))
...
(assert (= o66 (ite (<= o65 (to_rep aux2__last)) true false)))
(assert (and (= o60 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o61 (+ aux2_first o60)))
(assert (and (= o62 o61) (in_range1 o61)))
(assert (= o67 (ite (<= (to_rep aux2__first) o62) true false)))
(assert (= result3 (ite (= o67 true) o66 false)))
(assert (= result3 true))
...
(assert (= o58 (ite (<= o57 (to_rep aux3__last)) true false)))
(assert (and (= o52 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o53 (+ aux3_first o52)))
(assert (and (= o54 o53) (in_range1 o53)))
(assert (= o59 (ite (<= (to_rep aux3__first) o54) true false)))
(assert (= result4 (ite (= o59 true) o58 false)))
(assert (= result4 true))
...
(assert (= o48 (+ aux4_first o47)))
(assert (and (= o49 o48) (in_range1 o48)))
(assert (= o50 (ite (<= o49 (to_rep aux4__last)) true false)))
(assert (and (= o30 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o31 (+ o30 1)))
(assert (and (= o32 o31) (in_range1 o31)))
(assert (and (= o33 (power 2 k)) (in_range1 (power 2 k))))
(assert (= o34 (* o33 o32)))
(assert (and (= o35 o34) (in_range1 o34)))
(assert (= o36 (- o35 1)))
(assert (and (= o37 o36) (in_range1 o36)))
(assert (= o38 (+ aux4_first o37)))
(assert (and (= o39 o38) (in_range1 o38)))
(assert (= o51 (ite (<= (to_rep aux4__first) o39) true false)))
(assert (= result5 (ite (= o51 true) o50 false)))
(assert (= result5 true))
(assert (<= k 30))
...
(assert (= o28 (ite (<= o27 (to_rep (last (rt r)))) true false)))
(assert (and (= o22 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o23 (+ r_first o22)))
(assert (and (= o24 o23) (in_range1 o23)))
(assert (= o29 (ite (<= (to_rep (first (rt r))) o24) true false)))
...
(assert (= o13 (from_integer o12)))
(assert (= o9 (from_integer 2)))
(assert (= o14 (omultiply o9 o13)))
(assert (and (= o8 (base Tuple0)) (= o8 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o15 (oexpon__2 o8 o14)))
(assert (= o21 (omod o15 o20)))
(assert (and (= o3 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o4 (+ o3 1)))
(assert (and (= o5 o4) (in_range1 o4)))
(assert (and (= o6 o5) (in_range2 o5)))
(assert (= o7 (num_of_big_int r r_first o6)))
(assert (= result7 (oeq o7 o21)))
(assert (= result7 true))
