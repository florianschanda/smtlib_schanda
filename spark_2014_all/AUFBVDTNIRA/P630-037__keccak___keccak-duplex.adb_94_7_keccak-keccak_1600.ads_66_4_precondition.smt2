...
(define-fun dynamic_invariant2 ((temp___expr_511 Int) (temp___is_init_508 Bool) (temp___skip_constant_509 Bool) (temp___do_toplevel_510 Bool)) Bool (=> (or (= temp___is_init_508 true) (<= 3 1599)) (in_range3 temp___expr_511)))
(assert (forall ((ctx us_rep)) (! (dynamic_invariant2 (rate_of ctx) true false true) :pattern ((rate_of ctx)))))
...
(define-fun tTblockSP1__ref___2__projection ((a tTblockSP1__ref)) tTblockSP1 (tTblockSP1__content a))
(declare-const attr__ATTRIBUTE_ADDRESS3 Int)
(declare-const r185s Int)
...
(declare-datatypes () ((t186s__ref (mk_t186s__ref (t186s__content integer)))))
(define-fun t186s__ref___projection ((a t186s__ref)) integer (t186s__content a))
(declare-sort t1 0)
...
(declare-datatypes () ((t187s__ref (mk_t187s__ref (t187s__content us_t1)))))
(define-fun t187s__ref___projection ((a t187s__ref)) us_t1 (t187s__content a))
(declare-const r188s Int)
...
(declare-datatypes () ((t189s__ref (mk_t189s__ref (t189s__content integer)))))
(define-fun t189s__ref___projection ((a t189s__ref)) integer (t189s__content a))
(declare-sort t2 0)
...
(declare-datatypes () ((t190s__ref (mk_t190s__ref (t190s__content us_t2)))))
(define-fun t190s__ref___projection ((a t190s__ref)) us_t2 (t190s__content a))
(declare-fun keccak__keccak_1600__duplex__duplex_blank__block__aggregate_def ((_ BitVec 8)) (Array Int byte))
(assert (forall ((temp___1081 (_ BitVec 8))) (forall ((temp___1082 Int)) (= (select (keccak__keccak_1600__duplex__duplex_blank__block__aggregate_def temp___1081) temp___1082) (of_rep1 temp___1081)))))
...
(declare-const keccak__keccak_1600__duplex__duplex_blank__R185s__assume Int)
(declare-const o3 (Array Int byte))
(declare-const keccak__padding__pad101_single_block__block__compl (Array Int byte))
(declare-const keccak__padding__pad101_single_block__block__compl1 t1)
...
(assert (and (<= out_data_bit_length (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1)))) (= (ite (<= (to_rep out_data__first) (to_rep out_data__last)) (+ (- (to_rep out_data__last) (to_rep out_data__first)) 1) 0) (div1 (+ out_data_bit_length 7) 8))))
(assert (= (mk_map__ref result) (mk_map__ref block)))
(assert (= block1 (keccak__keccak_1600__duplex__duplex_blank__block__aggregate_def ((_ int2bv 8) 0))))
(assert (and (= o (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1)))) (and (in_range3 o) (= o (to_rep3 ctx__split_fields1)))))
(assert (= o1 (+ o 7)))
(assert (= o2 (div1 o1 8)))
(assert (= keccak__keccak_1600__duplex__duplex_blank__R185s__assume (- o2 1)))
(assert (= keccak__keccak_1600__duplex__duplex_blank__R185s__assume r185s))
(assert (in_range r185s))
(assert (=> (<= 0 r185s) (and (and (<= 0 0) (<= 0 199)) (and (<= 0 r185s) (<= r185s 199)))))
(assert (= o3 block1))
(assert (= o3 keccak__padding__pad101_single_block__block__compl))
(assert (= (mk1 0 r185s) keccak__padding__pad101_single_block__block__compl1))
(assert (and (= o6 (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1)))) (and (in_range3 o6) (= o6 (to_rep3 ctx__split_fields1)))))
(assert (= (to_rep o5) (to_rep (last2 keccak__padding__pad101_single_block__block__compl1))))
(assert (= (to_rep o4) (to_rep (first2 keccak__padding__pad101_single_block__block__compl1))))
(assert (forall ((temp___1086 Int)) (ite (and (<= 0 temp___1086) (<= temp___1086 r185s)) (= (select o7 temp___1086) (select (slide keccak__padding__pad101_single_block__block (to_rep (first (mk (to_rep (first2 keccak__padding__pad101_single_block__block__compl1)) (to_rep (last2 keccak__padding__pad101_single_block__block__compl1))))) 0) temp___1086)) (= (select o7 temp___1086) (select block1 temp___1086)))))
(assert (= block1 result1))
(assert (= block2 o7))
(assert (= (- (div1 (+ (to_rep3 ctx__split_fields1) 7) 8) 1) r188s))
(assert (in_range r188s))
...
(assert (=> (<= 0 r188s) (and (and (<= 0 0) (<= 0 199)) (and (<= 0 r188s) (<= r188s 199)))))
(assert (= o8 block2))
(assert (= o8 temp___1088))
(assert (= (mk2 0 r188s) temp___10881))
(assert (= temp___1088 o9))
(assert (= (mk (to_rep (first4 temp___10881)) (to_rep (last4 temp___10881))) o10))
(assert (= (mk___split_fields__ref (mk___split_fields result2 result3)) (mk___split_fields__ref (mk___split_fields ctx__split_fields ctx__split_fields1))))
...
(assert (= result4 ctx__split_fields2))
(assert (= result5 ctx__split_fields3))
