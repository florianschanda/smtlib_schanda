...
(assert (forall ((temp___1150 (_ BitVec 8))) (=> (dynamic_invariant3 temp___1150 true true true true) (forall ((temp___1151 Int)) (= (to_rep1 (select (keccak__keccak_1600__duplex__duplex_blank__block__aggregate_def temp___1150) temp___1151)) temp___1150)))))
...
(declare-const temp___1157 (Array Int byte))
(declare-const temp___11571 t2)
...
(assert (= block1 (keccak__keccak_1600__duplex__duplex_blank__block__aggregate_def #x00)))
...
(assert (forall ((temp___1155 Int)) (ite (and (<= 0 temp___1155) (<= temp___1155 r185s)) (= (select o7 temp___1155) (select (slide keccak__padding__pad101_single_block__block (to_rep (first (mk (to_rep (first2 keccak__padding__pad101_single_block__block__compl1)) (to_rep (last2 keccak__padding__pad101_single_block__block__compl1))))) 0) temp___1155)) (= (select o7 temp___1155) (select block1 temp___1155)))))
...
(assert (= o8 block2))
(assert (= o8 temp___1157))
(assert (= (mk2 0 r188s) temp___11571))
(assert (= temp___1157 o9))
(assert (= (mk (to_rep (first4 temp___11571)) (to_rep (last4 temp___11571))) o10))
...
(assert (not (= (ite (<= (to_rep out_data__first) (to_rep out_data__last)) (+ (- (to_rep out_data__last) (to_rep out_data__first)) 1) 0) (div1 (+ out_data_bit_length 7) 8))))
(check-sat)
(exit)
