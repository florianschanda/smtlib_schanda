...
(assert (and (= o34 (rate_of (mk___rep ctx__split_fields13))) (and (in_range7 o34) (and (= o34 (* (to_rep6 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields13)) 8)) (< o34 1600)))))
(assert (<= 0 r128s))
(assert (not (<= 0 0)))
(check-sat)
(exit)
