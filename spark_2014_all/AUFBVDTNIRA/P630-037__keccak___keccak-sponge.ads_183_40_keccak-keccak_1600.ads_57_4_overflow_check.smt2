...
(assert (and (= o1 (state_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5)))) (and (in_range5 o1) (= o1 (to_rep3 ctx__split_fields5)))))
(assert (= result (ite (= o1 0) true false)))
(assert (= result true))
(assert (<= suffix_len 8))
(assert (<= bit_length 2147483639))
(assert (and (= o (length message)) (in_range1 (length message))))
