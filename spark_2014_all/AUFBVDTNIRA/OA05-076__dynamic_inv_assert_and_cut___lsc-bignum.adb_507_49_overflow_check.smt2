...
(assert (and (= o217 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o218 (num_of_big_int (mk___t aux2 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first o217)))
(assert (= o231 (oeq o218 o230)))
(assert (= o215 (from_word32 ((_ int2bv 32) 1))))
