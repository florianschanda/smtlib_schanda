...
(define-fun dynamic_invariant5 ((temp___expr_1213 (_ BitVec 8)) (temp___is_init_1209 Bool) (temp___skip_constant_1210 Bool) (temp___do_toplevel_1211 Bool) (temp___do_typ_inv_1212 Bool)) Bool true)
...
(assert (= o1 (div1 o 4)))
(assert (and (= hw__dbc__regs__read_i__off__assume o1) (in_range2 o1)))
(assert (= hw__dbc__regs__read_i__off__assume off))
...
(assert (= result mask))
(assert (= mask1 o9))
(assert (not (bvule ((_ zero_extend 56) #x00) (bvand (bvlshr ((_ zero_extend 32) temp) ((_ int2bv 64) (to_rep (rec__hw__dbc__s_regs__t__lsb (us_split_fields1 (select regs idx)))))) mask1))))
(check-sat)
(exit)
