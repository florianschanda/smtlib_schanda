...
(assert (=> (< 0 initial_data_len1) (=> (< bit_length free_bits_in_block2) (= (slide temp___927 (to_rep1 (first4 temp___9271)) r74s) temp___928))))
...
(assert (=> (< 0 initial_data_len1) (=> (not (< bit_length free_bits_in_block2)) (=> (< 0 free_bits_in_block2) (= temp___887 (mk___t3 (slide (elts4 temp___886) (to_rep1 (first8 (rt4 temp___886))) r81s) (mk3 r81s r82s)))))))
...
(assert (=> (< 0 initial_data_len1) (=> (not (< bit_length free_bits_in_block2)) (=> (< 0 (int__content remaining_bits7)) (= temp___915 (mk___t7 (slide (elts8 temp___914) (to_rep1 (first16 (rt8 temp___914))) 0) (mk7 0 r95s)))))))
