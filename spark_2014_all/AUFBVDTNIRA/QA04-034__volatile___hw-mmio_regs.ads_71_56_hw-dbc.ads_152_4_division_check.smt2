...
(define-fun dynamic_invariant3 ((temp___expr_1111 (_ BitVec 64)) (temp___is_init_1107 Bool) (temp___skip_constant_1108 Bool) (temp___do_toplevel_1109 Bool) (temp___do_typ_inv_1110 Bool)) Bool true)
...
(assert (= o4 (ite (<= o3 64) true false)))
