...
(define-fun word_t__ref___28__projection ((a word_t__ref)) word_t (word_t__content a))
(define-fun dynamic_invariant3 ((temp___expr_988 (_ BitVec 64)) (temp___is_init_985 Bool) (temp___skip_constant_986 Bool) (temp___do_toplevel_987 Bool)) Bool true)
