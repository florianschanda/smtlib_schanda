...
(assert (= o8 (to_rep o7)))
(assert (and (= temp___925 (+ string_index2 1)) (in_range1 (+ string_index2 1))))
(assert (and (<= (to_rep1 (first (rt number))) temp___925) (<= temp___925 (to_rep1 (last (rt number))))))
(assert (= o9 temp___925))
