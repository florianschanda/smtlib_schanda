...
(assert true)
(assert (and (= temp___854 (+ string_index2 1)) (in_range1 (+ string_index2 1))))
(assert (and (<= (to_rep1 (first (rt number))) temp___854) (<= temp___854 (to_rep1 (last (rt number))))))
(assert (= o17 temp___854))
