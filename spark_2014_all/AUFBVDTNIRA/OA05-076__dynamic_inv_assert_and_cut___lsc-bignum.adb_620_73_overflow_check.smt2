...
(assert (and (= o535 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o536 (num_of_big_int m m_first o535)))
(assert (and (= o532 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (and (= o531 (base Tuple0)) (= o531 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o533 (oexpon o531 o532)))
(assert (and (= o526 (* 2 n4)) (in_range1 (* 2 n4))))
(assert (= o527 (+ o526 1)))
(assert (and (= o528 o527) (in_range1 o527)))
(assert (and (= o529 o528) (in_range2 o528)))
(assert (and (= o524 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o525 (num_of_big_int x x_first o524)))
(assert (= o530 (oexpon o525 o529)))
(assert (= o534 (omultiply o530 o533)))
(assert (= o537 (omod o534 o536)))
