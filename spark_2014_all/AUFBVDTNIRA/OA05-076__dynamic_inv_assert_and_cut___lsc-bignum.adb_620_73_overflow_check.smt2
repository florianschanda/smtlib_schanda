...
(assert (= o47 (from_integer s10)))
(assert (= o51 (ole o47 o50)))
(assert (and (= o45 (+ k 1)) (in_range1 (+ k 1))))
(assert (= o46 (ite (<= s10 o45) true false)))
(assert (= o41 (from_word32 ((_ int2bv 32) 2))))
(assert (= o42 (oexpon o41 s10)))
(assert (= o36 (from_word32 ((_ int2bv 32) 1))))
(assert (= o35 (from_integer s10)))
(assert (= o37 (osubtract o35 o36)))
(assert (= o34 (from_word64 i2)))
(assert (= o38 (osubtract o34 o37)))
(assert (= o33 (from_word32 ((_ int2bv 32) 2))))
(assert (= o39 (oexpon__2 o33 o38)))
...
(assert (= o40 (odivide o32 o39)))
(assert (= o43 (omod o40 o42)))
(assert (= o27 (from_word32 (t__content w7))))
(assert (= o44 (oeq o27 o43)))
...
(assert (= o25 (num_of_big_int m m_first o24)))
(assert (and (= o21 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (and (= o20 (base Tuple0)) (= o20 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o22 (oexpon o20 o21)))
(assert (and (= o15 (* 2 n)) (in_range1 (* 2 n))))
(assert (= o16 (+ o15 1)))
...
(assert (= o19 (oexpon o14 o18)))
(assert (= o23 (omultiply o19 o22)))
(assert (= o26 (omod o23 o25)))
