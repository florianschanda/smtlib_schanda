...
(assert (and (and (=> (<= 1 65536) (in_range5 index2)) (=> (<= 1 2147483647) (in_range2 string_index2))) (dynamic_invariant4 (mk___rep result____split_discrs result____split_fields3) false true true)))
(assert (and (<= (to_rep1 (first (rt number))) string_index2) (<= string_index2 (to_rep1 (last (rt number))))))
...
(assert (= (to_rep4 (last2 (rt1 (rec__very_longs__very_long__long_digits result____split_fields3)))) r34b))
...
(assert (= o19 index2))
(assert (= o20 (store (elts1 (rec__very_longs__very_long__long_digits result____split_fields3)) o19 o18)))
(assert (= o20 o21))
(assert (= (rt1 (rec__very_longs__very_long__long_digits result____split_fields3)) o22))
(assert (= o23 (mk___split_fields (mk___t1 o21 o22))))
(assert (= temp___833 (mk___rep result____split_discrs o23)))
...
(assert (not (= index2 1)))
(assert (and (= o24 (- index2 1)) (in_range5 (- index2 1))))
