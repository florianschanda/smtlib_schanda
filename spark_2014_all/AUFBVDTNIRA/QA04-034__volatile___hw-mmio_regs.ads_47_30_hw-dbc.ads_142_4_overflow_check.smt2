...
(define-fun dynamic_invariant3 ((temp___expr_855 (_ BitVec 16)) (temp___is_init_852 Bool) (temp___skip_constant_853 Bool) (temp___do_toplevel_854 Bool)) Bool true)
...
(assert (= o8 (ite (<= o7 16) true false)))
