...
(define-fun dynamic_invariant1 ((temp___expr_964 (_ BitVec 16)) (temp___is_init_960 Bool) (temp___skip_constant_961 Bool) (temp___do_toplevel_962 Bool) (temp___do_typ_inv_963 Bool)) Bool true)
...
(declare-fun user_eq4 (word16 word16) Bool)
(declare-const dummy4 word16)
...
(define-fun dynamic_invariant2 ((temp___expr_341 (_ BitVec 16)) (temp___is_init_337 Bool) (temp___skip_constant_338 Bool) (temp___do_toplevel_339 Bool) (temp___do_typ_inv_340 Bool)) Bool true)
...
(assert (= o1 (div1 o 4)))
(assert (= o2 (ite (<= o1 16383) true false)))
