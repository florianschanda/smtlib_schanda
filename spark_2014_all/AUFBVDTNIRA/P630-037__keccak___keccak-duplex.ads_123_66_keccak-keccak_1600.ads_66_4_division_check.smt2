...
(assert (and (= o1 (max_input_length (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1)))) (and (in_range4 o1) (= o1 (- (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1))) 2)))))
(assert (= result (ite (<= in_data_bit_length o1) true false)))
(assert (= result true))
