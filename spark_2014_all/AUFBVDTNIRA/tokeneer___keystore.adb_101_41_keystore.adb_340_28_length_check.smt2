...
(assert (=> (<= 1 temp___1784) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 temp___1784) (<= temp___1784 150)))))
(assert (= o17 result__8))
(assert (= temp___1785 (mk___t2 o17 (mk2 1 temp___1784))))
(assert (not (= (ite (<= (to_rep1 (first4 (rt2 temp___1782))) (to_rep1 (last4 (rt2 temp___1782)))) (+ (- (to_rep1 (last4 (rt2 temp___1782))) (to_rep1 (first4 (rt2 temp___1782)))) 1) 0) (ite (<= (to_rep1 (first4 (rt2 temp___1785))) (to_rep1 (last4 (rt2 temp___1785)))) (+ (- (to_rep1 (last4 (rt2 temp___1785))) (to_rep1 (first4 (rt2 temp___1785)))) 1) 0))))
(check-sat)
(exit)
