...
(assert (not (= (ite (<= (to_rep2 (first13 (rt6 temp___1087))) (to_rep2 (last14 (rt6 temp___1087)))) (+ (- (to_rep2 (last14 (rt6 temp___1087))) (to_rep2 (first13 (rt6 temp___1087)))) 1) 0) (ite (<= 1 r134b) (+ (- r134b 1) 1) 0))))
(check-sat)
(exit)
