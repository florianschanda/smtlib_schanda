...
(assert (=> (and (<= 1 index1) (<= index1 r26b)) (and (= result____split_discrs (mk___split_discrs temp___809)) (= result____split_fields2 (mk___split_fields1 (mk___t1 temp___8091 temp___8092))))))
(assert (=> (and (<= 1 index1) (<= index1 r26b)) (and (and (and (dynamic_invariant2 (mk___rep1 result____split_discrs result____split_fields3) false true true) (forall ((temp___811 Int)) (=> (and (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))) temp___811) (<= temp___811 (to_rep2 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))))) (=> (<= index2 temp___811) (= (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields3)) temp___811) (select temp___8091 temp___811)))))) (=> (<= 0 2147483647) (in_range1 temp2))) (and (<= 1 index2) (<= index2 r26b)))))
...
(assert (=> (and (<= 1 index1) (<= index1 r26b)) (and (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))) index2) (<= index2 (to_rep2 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3))))))))
...
(assert (=> (and (<= 1 index1) (<= index1 r26b)) (= temp___808 (mk___rep1 result____split_discrs o10))))
(assert (=> (and (<= 1 index1) (<= index1 r26b)) (= result3 (mk___split_fields__ref1 result____split_fields3))))
(assert (=> (and (<= 1 index1) (<= index1 r26b)) (= result____split_fields4 (us_split_fields3 temp___808))))
(assert (=> (and (<= 1 index1) (<= index1 r26b)) (= result____split_discrs (us_split_discrs2 temp___808))))
