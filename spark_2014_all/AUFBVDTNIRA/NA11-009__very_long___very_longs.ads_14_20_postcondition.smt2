...
(declare-const temp___880 digit_index_type)
(declare-const temp___8801 (Array Int octet))
(declare-const temp___8802 t1)
...
(assert (= index1 1))
(assert (=> (and (<= 1 index1) (<= index1 r26b)) (= temp___883 temp1)))
(assert (=> (and (<= 1 index1) (<= index1 r26b)) (and (= result____split_discrs (mk___split_discrs temp___880)) (= result____split_fields2 (mk___split_fields1 (mk___t1 temp___8801 temp___8802))))))
(assert (=> (and (<= 1 index1) (<= index1 r26b)) (and (and (and (dynamic_invariant2 (mk___rep1 result____split_discrs result____split_fields3) false true true true) (forall ((temp___882 Int)) (=> (and (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))) temp___882) (<= temp___882 (to_rep1 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))))) (=> (or (< r26b temp___882) (or (< temp___882 1) (<= index2 temp___882))) (= (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields3)) temp___882) (select temp___8801 temp___882)))))) (=> (<= 0 2147483647) (in_range1 temp2))) (and (<= 1 index2) (<= index2 r26b)))))
