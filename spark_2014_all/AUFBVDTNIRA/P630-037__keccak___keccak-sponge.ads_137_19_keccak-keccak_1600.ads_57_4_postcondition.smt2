...
(declare-fun to_rep (rate_number) Int)
...
(define-fun bool_eq1 ((a (Array Int byte)) (a__first Int) (a__last Int) (b (Array Int byte)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_132 Int)) (=> (and (<= a__first temp___idx_132) (<= temp___idx_132 a__last)) (= (to_rep4 (select a temp___idx_132)) (to_rep4 (select b (+ (- b__first a__first) temp___idx_132))))))) true false))
...
(assert (forall ((a (Array Int byte)) (b (Array Int byte))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq1 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (bvult (to_rep4 (select a (+ i 1))) (to_rep4 (select b (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int byte)) (b (Array Int byte))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq1 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (bvugt (to_rep4 (select a (+ j 1))) (to_rep4 (select b (+ i 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
...
(define-fun dynamic_invariant3 ((temp___expr_364 Int) (temp___is_init_361 Bool) (temp___skip_constant_362 Bool) (temp___do_toplevel_363 Bool)) Bool (=> (or (= temp___is_init_361 true) (<= 0 1)) (in_range3 temp___expr_364)))
(define-fun dynamic_invariant4 ((temp___expr_391 Int) (temp___is_init_388 Bool) (temp___skip_constant_389 Bool) (temp___do_toplevel_390 Bool)) Bool (=> (or (= temp___is_init_388 true) (<= 1 199)) (in_range2 temp___expr_391)))
(define-fun dynamic_invariant5 ((temp___expr_370 Int) (temp___is_init_367 Bool) (temp___skip_constant_368 Bool) (temp___do_toplevel_369 Bool)) Bool (=> (or (= temp___is_init_367 true) (<= 0 199)) (in_range4 temp___expr_370)))
(define-fun dynamic_invariant6 ((temp___expr_385 Int) (temp___is_init_382 Bool) (temp___skip_constant_383 Bool) (temp___do_toplevel_384 Bool)) Bool (=> (or (= temp___is_init_382 true) (<= 0 1599)) (in_range5 temp___expr_385)))
(declare-const keccak__keccak_1600__sponge__rate_of__result Int)
(declare-const o Int)
(declare-const o1 Int)
(declare-const result Int)
(declare-const keccak__keccak_1600__sponge__rate_of__result1 Int)
(declare-const keccak__keccak_1600__sponge__rate_of__result2 Int)
(declare-const keccak__keccak_1600__sponge__rate_of__result3 Int)
(declare-const keccak__keccak_1600__sponge__rate_of__result4 Int)
(declare-const keccak__keccak_1600__sponge__rate_of__result5 Int)
(declare-const result1 Int)
(assert (= keccak__keccak_1600__sponge__rate_of__result1 keccak__keccak_1600__sponge__rate_of__result2))
(assert (= keccak__keccak_1600__sponge__rate_of__result3 keccak__keccak_1600__sponge__rate_of__result1))
(assert (and (= o (* (to_rep (rec__keccak__keccak_1600__sponge__context__rate (us_split_fields1 ctx))) 8)) (in_range (* (to_rep (rec__keccak__keccak_1600__sponge__context__rate (us_split_fields1 ctx))) 8))))
(assert (and (= o1 o) (in_range1 o)))
(assert (= result keccak__keccak_1600__sponge__rate_of__result))
(assert (= keccak__keccak_1600__sponge__rate_of__result1 o1))
(assert (= (mk_int__ref keccak__keccak_1600__sponge__rate_of__result4) (mk_int__ref keccak__keccak_1600__sponge__rate_of__result2)))
(assert (= keccak__keccak_1600__sponge__rate_of__result5 keccak__keccak_1600__sponge__rate_of__result3))
(assert (= result1 keccak__keccak_1600__sponge__rate_of__result4))
(assert (not (< keccak__keccak_1600__sponge__rate_of__result4 1600)))
(check-sat)
(exit)
