...
(assert (and (= o270 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o271 (num_of_big_int (mk___t aux11 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first o270)))
(assert (= o273 (oeq o271 o272)))
