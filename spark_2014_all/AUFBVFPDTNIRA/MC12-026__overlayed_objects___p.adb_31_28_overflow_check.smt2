...
(define-fun dynamic_invariant2 ((temp___expr_190 (_ BitVec 8)) (temp___is_init_186 Bool) (temp___skip_constant_187 Bool) (temp___do_toplevel_188 Bool) (temp___do_typ_inv_189 Bool)) Bool true)
(declare-const full_s__split_fields integer)
(assert (in_range x))
(assert (fp.isFinite32 y))
(assert (not (in_range (+ (to_rep full_s__split_fields) x))))
(check-sat)
(exit)
