...
(assert (= (= result5 true) (forall ((s16 (_ BitVec 8))) (=> (and (bvule ((_ int2bv 8) 0) s16) (bvule s16 current_time)) (fp.lt (to_rep (select battery_level_at s16)) (fp #b0 #b01111100 #b10011001100110011001101))))))
(assert (= result5 true))
