...
(assert (= (= result5 true) (forall ((s3 (_ BitVec 8))) (=> (and (bvule #x00 s3) (bvule s3 current_time)) (fp.lt (to_rep (select battery_level_at s3)) (fp #b0 #b01111100 #b10011001100110011001101))))))
(assert (= result5 true))
