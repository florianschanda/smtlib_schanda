...
(assert (=> (and (<= 1 j1) (<= j1 49)) (and (and (= (is_valid failsafe_state3 battery_level_at3 current_time3) true) (and (= current_time3 (let ((temp___236 (bvadd current_time2 ((_ int2bv 8) 1)))) (ite (bvule (bvsub ((_ int2bv 8) 50) current_time2) ((_ int2bv 8) 1)) (bvsub temp___236 ((_ int2bv 8) 50)) temp___236))) (fp.eq (to_rep (select battery_level_at3 current_time3)) (fp #b0 #b01111011 #b10011001100110011001101)))) (in_range1 current_time3))))
(assert (=> (and (<= 1 j1) (<= j1 49)) (= j2 49)))
(assert (=> (and (<= 1 j1) (<= j1 49)) (= failsafe_state3 failsafe_state4)))
(assert (=> (and (<= 1 j1) (<= j1 49)) (= j2 j3)))
(assert (=> (and (<= 1 j1) (<= j1 49)) (= current_time3 current_time4)))
(assert (=> (and (<= 1 j1) (<= j1 49)) (= battery_level_at3 battery_level_at4)))
(assert (=> (and (<= 1 j1) (<= j1 49)) (= failsafe_state5 failsafe_state3)))
(assert (=> (and (<= 1 j1) (<= j1 49)) (= j4 j2)))
(assert (=> (and (<= 1 j1) (<= j1 49)) (= current_time5 current_time3)))
(assert (=> (and (<= 1 j1) (<= j1 49)) (= battery_level_at5 battery_level_at3)))
(assert (=> (and (<= 1 j1) (<= j1 49)) (= (mk___private__ref failsafe_state6) (mk___private__ref failsafe_state4))))
(assert (=> (and (<= 1 j1) (<= j1 49)) (= (mk_int__ref j5) (mk_int__ref j3))))
(assert (=> (and (<= 1 j1) (<= j1 49)) (= (mk_t__ref current_time6) (mk_t__ref current_time4))))
(assert (=> (and (<= 1 j1) (<= j1 49)) (= (mk_map__ref battery_level_at6) (mk_map__ref battery_level_at4))))
(assert (=> (and (<= 1 j1) (<= j1 49)) (= failsafe_state7 failsafe_state5)))
(assert (=> (and (<= 1 j1) (<= j1 49)) (= j6 j4)))
(assert (=> (and (<= 1 j1) (<= j1 49)) (= current_time7 current_time5)))
(assert (=> (and (<= 1 j1) (<= j1 49)) (= battery_level_at7 battery_level_at5)))
(assert (=> (not (and (<= 1 j1) (<= j1 49))) (= (mk___private__ref failsafe_state6) (mk___private__ref failsafe_state))))
(assert (=> (not (and (<= 1 j1) (<= j1 49))) (= j1 j5)))
(assert (=> (not (and (<= 1 j1) (<= j1 49))) (= (mk_t__ref current_time6) (mk_t__ref current_time))))
(assert (=> (not (and (<= 1 j1) (<= j1 49))) (= (mk_map__ref battery_level_at6) (mk_map__ref battery_level_at))))
(assert (=> (not (and (<= 1 j1) (<= j1 49))) (= failsafe_state7 failsafe_state1)))
(assert (=> (not (and (<= 1 j1) (<= j1 49))) (= j6 j1)))
(assert (=> (not (and (<= 1 j1) (<= j1 49))) (= current_time7 current_time1)))
(assert (=> (not (and (<= 1 j1) (<= j1 49))) (= battery_level_at7 battery_level_at1)))
(assert (not (= (is_raised failsafe_state6 battery_level_at6 current_time6) true)))
(assert (and (and (= (is_valid failsafe_state8 battery_level_at8 current_time8) true) (and (= current_time8 (let ((temp___236 (bvadd current_time6 ((_ int2bv 8) 1)))) (ite (bvule (bvsub ((_ int2bv 8) 50) current_time6) ((_ int2bv 8) 1)) (bvsub temp___236 ((_ int2bv 8) 50)) temp___236))) (fp.eq (to_rep (select battery_level_at8 current_time8)) (fp #b0 #b01111011 #b10011001100110011001101)))) (in_range1 current_time8)))
(assert (= (is_raised failsafe_state8 battery_level_at8 current_time8) true))
(assert (and (and (= (is_valid failsafe_state9 battery_level_at9 current_time9) true) (and (= current_time9 (let ((temp___236 (bvadd current_time8 ((_ int2bv 8) 1)))) (ite (bvule (bvsub ((_ int2bv 8) 50) current_time8) ((_ int2bv 8) 1)) (bvsub temp___236 ((_ int2bv 8) 50)) temp___236))) (fp.eq (to_rep (select battery_level_at9 current_time9)) (fp #b0 #b01111011 #b10011001100110011001101)))) (in_range1 current_time9)))
(assert (not (= (is_valid failsafe_state9 battery_level_at9 current_time9) true)))
(check-sat)
(exit)
