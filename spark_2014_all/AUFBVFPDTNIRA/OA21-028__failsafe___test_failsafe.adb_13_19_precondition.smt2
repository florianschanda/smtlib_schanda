...
(declare-const temp___322 (Array (_ BitVec 8) battery_level_type))
...
(assert (=> (and (<= 1 j1) (<= j1 49)) (= temp___322 battery_level_at)))
...
(assert (and (and (= (is_valid failsafe_state7 battery_level_at7 current_time8) true) (and (= current_time8 (let ((temp___273 (bvadd current_time6 #x01))) (ite (bvule (bvsub #x32 current_time6) #x01) (bvsub temp___273 #x32) temp___273))) (fp.eq (to_rep (select battery_level_at7 current_time8)) (fp #b0 #b01111011 #b10011001100110011001101)))) (in_range1 current_time8)))
(assert (= (is_raised failsafe_state7 battery_level_at7 current_time8) true))
(assert (and (and (= (is_valid failsafe_state8 battery_level_at8 current_time9) true) (and (= current_time9 (let ((temp___273 (bvadd current_time8 #x01))) (ite (bvule (bvsub #x32 current_time8) #x01) (bvsub temp___273 #x32) temp___273))) (fp.eq (to_rep (select battery_level_at8 current_time9)) (fp #b0 #b01111011 #b10011001100110011001101)))) (in_range1 current_time9)))
