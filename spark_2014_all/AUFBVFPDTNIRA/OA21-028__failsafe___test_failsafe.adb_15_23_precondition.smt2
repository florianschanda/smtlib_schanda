...
(assert (and (and (= (is_valid failsafe_state9 battery_level_at9 current_time10) true) (and (= current_time10 (let ((temp___273 (bvadd current_time9 #x01))) (ite (bvule (bvsub #x32 current_time9) #x01) (bvsub temp___273 #x32) temp___273))) (fp.eq (to_rep (select battery_level_at9 current_time10)) (fp #b0 #b01111111 #b00000000000000000000000)))) (in_range1 current_time10)))
