...
(define-fun dynamic_invariant2 ((temp___expr_243 (_ BitVec 8)) (temp___is_init_239 Bool) (temp___skip_constant_240 Bool) (temp___do_toplevel_241 Bool) (temp___do_typ_inv_242 Bool)) Bool (=> (or (= temp___is_init_239 true) (bvule #x00 #x31)) (in_range1 temp___expr_243)))
...
(define-fun dynamic_invariant4 ((temp___expr_282 (_ BitVec 8)) (temp___is_init_278 Bool) (temp___skip_constant_279 Bool) (temp___do_toplevel_280 Bool) (temp___do_typ_inv_281 Bool)) Bool (=> (or (= temp___is_init_278 true) (bvule #x00 #x32)) (in_range3 temp___expr_282)))
(assert true)
...
(assert (=> (forall ((s (_ BitVec 8))) (=> (and (bvule #x00 s) (bvule s #x31)) (fp.lt (to_rep (select battery_level_at s)) (fp #b0 #b01111100 #b10011001100110011001101)))) (= counter #x32)))
(assert (=> (forall ((s (_ BitVec 8))) (=> (and (bvule #x00 s) (bvule s #x31)) (=> (not (= s (let ((temp___315 (bvadd current_time #x01))) (ite (bvule (bvsub #x32 current_time) #x01) (bvsub temp___315 #x32) temp___315)))) (fp.lt (to_rep (select battery_level_at s)) (fp #b0 #b01111100 #b10011001100110011001101))))) (bvuge counter #x31)))
...
(assert (= counter1 o3))
(assert (=> (fp.leq (fp #b0 #b01111100 #b10011001100110011001101) (to_rep (select battery_level_at1 current_time1))) (= counter1 #x00)))
(assert (=> (= c #x32) (= counter1 #x32)))
(assert (=> (and (not (= c #x32)) (forall ((s (_ BitVec 8))) (=> (and (bvule #x00 s) (bvule s #x31)) (fp.lt (to_rep (select battery_level_at1 s)) (fp #b0 #b01111100 #b10011001100110011001101))))) (= c #x31)))
(assert (=> (and (not (= c #x32)) (forall ((s (_ BitVec 8))) (=> (and (bvule #x00 s) (bvule s #x31)) (fp.lt (to_rep (select battery_level_at1 s)) (fp #b0 #b01111100 #b10011001100110011001101))))) (= counter1 #x32)))
(assert (= (= o4 true) (forall ((s (_ BitVec 8))) (=> (and (bvule #x00 s) (bvule s #x31)) (fp.lt (to_rep (select battery_level_at1 s)) (fp #b0 #b01111100 #b10011001100110011001101))))))
...
(assert (= temp___317 (bvsub current_time1 o7)))
(assert (and (= o8 counter1) (in_range1 counter1)))
(assert (= result5 (ite (bvult current_time1 o8) true false)))
(assert (=> (= result5 true) (= o9 (bvadd temp___317 #x32))))
(assert (=> (not (= result5 true)) (= o9 temp___317)))
...
(assert (= result4 true))
(assert (and (= o6 (bvsub counter1 #x01)) (in_range1 (bvsub counter1 #x01))))
(assert (= result6 (ite (bvuge current_time1 o6) true false)))
(assert (= result6 true))
(assert (not (in_range1 (bvsub counter1 #x01))))
(check-sat)
(exit)
