...
(assert (=> (fp.lt battery_level (fp #b0 #b01111100 #b10011001100110011001101)) (and (= o3 (bv_min (bvadd counter #x01) #x32)) (in_range3 (bv_min (bvadd counter #x01) #x32)))))
...
(assert (=> (fp.lt battery_level (fp #b0 #b01111100 #b10011001100110011001101)) (=> (fp.leq (fp #b0 #b01111100 #b10011001100110011001101) (to_rep (select battery_level_at1 current_time1))) (= counter1 #x00))))
(assert (=> (fp.lt battery_level (fp #b0 #b01111100 #b10011001100110011001101)) (=> (= c #x32) (= counter1 #x32))))
(assert (=> (fp.lt battery_level (fp #b0 #b01111100 #b10011001100110011001101)) (=> (and (not (= c #x32)) (forall ((s (_ BitVec 8))) (=> (and (bvule #x00 s) (bvule s #x31)) (fp.lt (to_rep (select battery_level_at1 s)) (fp #b0 #b01111100 #b10011001100110011001101))))) (= c #x31))))
(assert (=> (fp.lt battery_level (fp #b0 #b01111100 #b10011001100110011001101)) (=> (and (not (= c #x32)) (forall ((s (_ BitVec 8))) (=> (and (bvule #x00 s) (bvule s #x31)) (fp.lt (to_rep (select battery_level_at1 s)) (fp #b0 #b01111100 #b10011001100110011001101))))) (= counter1 #x32))))
(assert (=> (fp.lt battery_level (fp #b0 #b01111100 #b10011001100110011001101)) (=> (and (fp.lt (to_rep (select battery_level_at1 current_time1)) (fp #b0 #b01111100 #b10011001100110011001101)) (not (forall ((s (_ BitVec 8))) (=> (and (bvule #x00 s) (bvule s #x31)) (fp.lt (to_rep (select battery_level_at1 s)) (fp #b0 #b01111100 #b10011001100110011001101)))))) (and (fp.leq (fp #b0 #b01111100 #b10011001100110011001101) (to_rep (select battery_level_at1 (let ((temp___322 (bvsub current_time1 counter1))) (ite (bvult current_time1 counter1) (bvadd temp___322 #x32) temp___322))))) (ite (bvuge current_time1 (bvsub counter1 #x01)) (forall ((s (_ BitVec 8))) (=> (and (bvule (let ((temp___323 (bvsub current_time1 (bvsub counter1 #x01)))) (ite (bvult current_time1 (bvsub counter1 #x01)) (bvadd temp___323 #x32) temp___323)) s) (bvule s current_time1)) (fp.lt (to_rep (select battery_level_at1 s)) (fp #b0 #b01111100 #b10011001100110011001101)))) (and (forall ((s (_ BitVec 8))) (=> (and (bvule #x00 s) (bvule s current_time1)) (fp.lt (to_rep (select battery_level_at1 s)) (fp #b0 #b01111100 #b10011001100110011001101)))) (forall ((s (_ BitVec 8))) (=> (and (bvule (let ((temp___324 (bvsub current_time1 (bvsub counter1 #x01)))) (ite (bvult current_time1 (bvsub counter1 #x01)) (bvadd temp___324 #x32) temp___324)) s) (bvule s #x31)) (fp.lt (to_rep (select battery_level_at1 s)) (fp #b0 #b01111100 #b10011001100110011001101))))))))))
...
(assert (=> (not (fp.lt battery_level (fp #b0 #b01111100 #b10011001100110011001101))) (= counter2 #x00)))
