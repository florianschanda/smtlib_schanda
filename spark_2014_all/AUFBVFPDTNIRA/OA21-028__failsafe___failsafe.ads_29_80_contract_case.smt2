...
(assert (forall ((s16 (_ BitVec 8))) (=> (and (bvule ((_ int2bv 8) 0) s16) (bvule s16 ((_ int2bv 8) 49))) (fp.lt (to_rep (select battery_level_at s16)) (fp #b0 #b01111100 #b10011001100110011001101)))))
(assert (not (= (t__content failsafe__model__time_below_threshold__result4) ((_ int2bv 8) 50))))
(check-sat)
(exit)
