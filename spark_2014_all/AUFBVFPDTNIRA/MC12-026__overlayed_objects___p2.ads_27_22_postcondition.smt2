...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep (rec__p2__r__a (us_split_fields1 a))) (to_rep (rec__p2__r__a (us_split_fields1 b)))) (= (to_rep1 (rec__p2__r__b (us_split_fields1 a))) (to_rep1 (rec__p2__r__b (us_split_fields1 b))))) true false))
...
(assert (forall ((temp___134 (_ BitVec 8))) (forall ((temp___135 Int)) (= (select (p2__null_raw_r__aggregate_def temp___134) temp___135) (of_rep2 temp___134)))))
...
(define-fun dynamic_invariant2 ((temp___expr_249 Int) (temp___is_init_246 Bool) (temp___skip_constant_247 Bool) (temp___do_toplevel_248 Bool)) Bool (=> (or (= temp___is_init_246 true) (<= 1 8)) (in_range2 temp___expr_249)))
(assert (= null_r (mk___rep (mk___split_fields (of_rep 0) (of_rep1 (fp #b0 #b00000000 #b00000000000000000000000))))))
(assert (= null_raw_r (p2__null_raw_r__aggregate_def ((_ int2bv 8) 0))))
(define-fun dynamic_invariant3 ((temp___expr_163 (_ BitVec 8)) (temp___is_init_160 Bool) (temp___skip_constant_161 Bool) (temp___do_toplevel_162 Bool)) Bool true)
...
(declare-const temp___2671 float)
