...
(assert (ite (bvuge current_time (bvsub res3 #x01)) (forall ((s3 (_ BitVec 8))) (=> (and (bvule (let ((temp___301 (bvsub current_time (bvsub res3 #x01)))) (ite (bvult current_time (bvsub res3 #x01)) (bvadd temp___301 #x32) temp___301)) s3) (bvule s3 current_time)) (fp.lt (to_rep (select battery_level_at s3)) battery_threshold))) (and (forall ((s3 (_ BitVec 8))) (=> (and (bvule #x00 s3) (bvule s3 current_time)) (fp.lt (to_rep (select battery_level_at s3)) battery_threshold))) (forall ((s3 (_ BitVec 8))) (=> (and (bvule (let ((temp___302 (bvsub current_time (bvsub res3 #x01)))) (ite (bvult current_time (bvsub res3 #x01)) (bvadd temp___302 #x32) temp___302)) s3) (bvule s3 #x31)) (fp.lt (to_rep (select battery_level_at s3)) battery_threshold))))))
(assert (= res3 (bvadd s2 #x01)))
(assert (and (and (=> (bvule #x00 #x31) (in_range1 s2)) (=> (bvule #x00 #x32) (in_range2 res3))) (and (bvule #x00 s2) (bvule s2 #x31))))
...
(assert (= (= result5 true) (forall ((s3 (_ BitVec 8))) (=> (and (bvule #x00 s3) (bvule s3 current_time)) (fp.lt (to_rep (select battery_level_at s3)) battery_threshold)))))
(assert (= result5 true))
(assert (not (in_range1 (bvsub res3 #x01))))
(check-sat)
(exit)
