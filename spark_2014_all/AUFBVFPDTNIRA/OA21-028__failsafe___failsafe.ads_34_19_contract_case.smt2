...
(assert (=> (and (bvule ((_ int2bv 8) 0) s1) (bvule s1 ((_ int2bv 8) 49))) (and (and (= temp___256 res1) (and (= temp___255 s1) (or (and (and (and (= s1 s8) (= res1 res7)) (and (= s9 s1) (= res8 res1))) (and (and (and (and (ite (bvult current_time s1) (= o (bvadd (bvsub current_time s1) ((_ int2bv 8) 50))) (= o (bvsub current_time s1))) (= o1 (select battery_level_at o))) (= o2 (to_rep o1))) (= result2 (ite (fp.lt o2 (fp #b0 #b01111100 #b10011001100110011001101)) true false))) (not (= result2 true)))) (and (and (and (and (and (ite (bvult current_time s1) (= o (bvadd (bvsub current_time s1) ((_ int2bv 8) 50))) (= o (bvsub current_time s1))) (= o1 (select battery_level_at o))) (= o2 (to_rep o1))) (= result2 (ite (fp.lt o2 (fp #b0 #b01111100 #b10011001100110011001101)) true false))) (and (= result2 true) (and (and (= o3 (bvadd res1 ((_ int2bv 8) 1))) (in_range2 (bvadd res1 ((_ int2bv 8) 1)))) (and (= res1 result3) (= res2 o3))))) (and (and (and (= (mk_t__ref s8) (mk_t__ref s4)) (= res3 res7)) (and (= s9 s5) (= res8 res3))) (and (and (bvule ((_ int2bv 8) 1) res2) (bvule res2 ((_ int2bv 8) 50))) (and (and (ite (bvuge current_time (bvsub res3 ((_ int2bv 8) 1))) (forall ((s16 (_ BitVec 8))) (=> (and (bvule (let ((temp___261 (bvsub current_time (bvsub res3 ((_ int2bv 8) 1))))) (ite (bvult current_time (bvsub res3 ((_ int2bv 8) 1))) (bvadd temp___261 ((_ int2bv 8) 50)) temp___261)) s16) (bvule s16 current_time)) (fp.lt (to_rep (select battery_level_at s16)) (fp #b0 #b01111100 #b10011001100110011001101)))) (and (forall ((s16 (_ BitVec 8))) (=> (and (bvule ((_ int2bv 8) 0) s16) (bvule s16 current_time)) (fp.lt (to_rep (select battery_level_at s16)) (fp #b0 #b01111100 #b10011001100110011001101)))) (forall ((s16 (_ BitVec 8))) (=> (and (bvule (let ((temp___262 (bvsub current_time (bvsub res3 ((_ int2bv 8) 1))))) (ite (bvult current_time (bvsub res3 ((_ int2bv 8) 1))) (bvadd temp___262 ((_ int2bv 8) 50)) temp___262)) s16) (bvule s16 ((_ int2bv 8) 49))) (fp.lt (to_rep (select battery_level_at s16)) (fp #b0 #b01111100 #b10011001100110011001101)))))) (= res3 (bvadd s2 ((_ int2bv 8) 1)))) (and (and (and (=> (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 49)) (in_range1 s2)) (=> (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 50)) (in_range2 res3))) (and (bvule ((_ int2bv 8) 0) s2) (bvule s2 ((_ int2bv 8) 49)))) (or (and (and (= s2 s4) (= s5 s2)) (= s2 ((_ int2bv 8) 49))) (and (not (= s2 ((_ int2bv 8) 49))) (and (and (= s3 s4) (= s5 s3)) (and (and (= s2 result6) (= s3 (bvadd s2 ((_ int2bv 8) 1)))) (and (and (and (and (ite (bvult current_time s3) (= o9 (bvadd (bvsub current_time s3) ((_ int2bv 8) 50))) (= o9 (bvsub current_time s3))) (= o10 (select battery_level_at o9))) (= o11 (to_rep o10))) (= result7 (ite (fp.lt o11 (fp #b0 #b01111100 #b10011001100110011001101)) true false))) (not (= result7 true))))))))))))))) (and (and (= (mk_t__ref s10) (mk_t__ref s8)) (= (mk_t__ref res9) (mk_t__ref res7))) (and (= s11 s9) (= res10 res8))))))
(assert (=> (and (bvule ((_ int2bv 8) 0) s1) (bvule s1 ((_ int2bv 8) 49))) (= (mk_t__ref s12) (mk_t__ref s10))))
(assert (=> (and (bvule ((_ int2bv 8) 0) s1) (bvule s1 ((_ int2bv 8) 49))) (= (mk_t__ref res11) (mk_t__ref res9))))
(assert (=> (and (bvule ((_ int2bv 8) 0) s1) (bvule s1 ((_ int2bv 8) 49))) (= s13 s11)))
(assert (=> (and (bvule ((_ int2bv 8) 0) s1) (bvule s1 ((_ int2bv 8) 49))) (= res12 res10)))
(assert (=> (not (and (bvule ((_ int2bv 8) 0) s1) (bvule s1 ((_ int2bv 8) 49)))) (= s1 s12)))
(assert (=> (not (and (bvule ((_ int2bv 8) 0) s1) (bvule s1 ((_ int2bv 8) 49)))) (= res1 res11)))
(assert (=> (not (and (bvule ((_ int2bv 8) 0) s1) (bvule s1 ((_ int2bv 8) 49)))) (= s13 s1)))
(assert (=> (not (and (bvule ((_ int2bv 8) 0) s1) (bvule s1 ((_ int2bv 8) 49)))) (= res12 res1)))
...
(assert (= s14 (mk_t__ref s12)))
(assert (= res13 (mk_t__ref res11)))
(assert (= failsafe__model__time_below_threshold__result5 failsafe__model__time_below_threshold__result3))
(assert (= s15 s13))
(assert (= res14 res12))
(assert (=> (= (fp.geq (to_rep (select battery_level_at current_time)) (fp #b0 #b01111100 #b10011001100110011001101)) true) (= (t__content failsafe__model__time_below_threshold__result4) ((_ int2bv 8) 0))))
(assert (=> (forall ((s16 (_ BitVec 8))) (=> (and (bvule ((_ int2bv 8) 0) s16) (bvule s16 ((_ int2bv 8) 49))) (fp.lt (to_rep (select battery_level_at s16)) (fp #b0 #b01111100 #b10011001100110011001101)))) (= (t__content failsafe__model__time_below_threshold__result4) ((_ int2bv 8) 50))))
(assert (not (ite (= (fp.geq (to_rep (select battery_level_at current_time)) (fp #b0 #b01111100 #b10011001100110011001101)) false) (forall ((s16 (_ BitVec 8))) (=> (and (bvule ((_ int2bv 8) 0) s16) (bvule s16 ((_ int2bv 8) 49))) (fp.lt (to_rep (select battery_level_at s16)) (fp #b0 #b01111100 #b10011001100110011001101)))) false)))
(assert (not (ite (= (fp.geq (to_rep (select battery_level_at current_time)) (fp #b0 #b01111100 #b10011001100110011001101)) false) false true)))
(assert (not (bvult (t__content failsafe__model__time_below_threshold__result4) ((_ int2bv 8) 50))))
(check-sat)
(exit)
