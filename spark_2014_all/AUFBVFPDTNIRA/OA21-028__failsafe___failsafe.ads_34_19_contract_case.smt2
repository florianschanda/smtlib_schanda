...
(assert (= s13 s11))
(assert (= res11 res9))
(assert (=> (= (fp.geq (to_rep (select battery_level_at current_time)) (fp #b0 #b01111100 #b10011001100110011001101)) true) (= (t__content failsafe__model__time_below_threshold__result4) #x00)))
(assert (=> (forall ((s17 (_ BitVec 8))) (=> (and (bvule #x00 s17) (bvule s17 #x31)) (fp.lt (to_rep (select battery_level_at s17)) (fp #b0 #b01111100 #b10011001100110011001101)))) (= (t__content failsafe__model__time_below_threshold__result4) #x32)))
(assert (not (ite (= (fp.geq (to_rep (select battery_level_at current_time)) (fp #b0 #b01111100 #b10011001100110011001101)) false) (forall ((s17 (_ BitVec 8))) (=> (and (bvule #x00 s17) (bvule s17 #x31)) (fp.lt (to_rep (select battery_level_at s17)) (fp #b0 #b01111100 #b10011001100110011001101)))) false)))
...
(assert (not (bvult (t__content failsafe__model__time_below_threshold__result4) #x32)))
(check-sat)
(exit)
