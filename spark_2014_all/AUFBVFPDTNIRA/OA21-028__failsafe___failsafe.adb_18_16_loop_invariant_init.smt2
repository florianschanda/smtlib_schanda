...
(assert (bvule (let ((temp___261 (bvsub current_time (bvsub res2 ((_ int2bv 8) 1))))) (ite (bvult current_time (bvsub res2 ((_ int2bv 8) 1))) (bvadd temp___261 ((_ int2bv 8) 50)) temp___261)) s2))
(assert (bvule s2 current_time))
(assert (not (fp.lt (to_rep (select battery_level_at s2)) (fp #b0 #b01111100 #b10011001100110011001101))))
(check-sat)
(exit)
