...
(assert (bvule (let ((temp___261 (bvsub current_time (bvsub res2 ((_ int2bv 8) 1))))) (ite (bvult current_time (bvsub res2 ((_ int2bv 8) 1))) (bvadd temp___261 ((_ int2bv 8) 50)) temp___261)) s16))
