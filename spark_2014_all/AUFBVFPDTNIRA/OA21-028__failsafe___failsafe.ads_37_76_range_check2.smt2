...
(assert (bvult (t__content failsafe__model__time_below_threshold__result4) #x32))
(assert (not (in_range1 (t__content failsafe__model__time_below_threshold__result4))))
(check-sat)
(exit)
