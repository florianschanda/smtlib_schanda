...
(assert (forall ((s (_ BitVec 8))) (=> (and (bvule #x00 s) (bvule s #x31)) (=> (not (= s (let ((temp___315 (bvadd current_time #x01))) (ite (bvule (bvsub #x32 current_time) #x01) (bvsub temp___315 #x32) temp___315)))) (fp.lt (to_rep (select battery_level_at s)) (fp #b0 #b01111100 #b10011001100110011001101))))))
(assert (not (bvuge counter #x31)))
(check-sat)
(exit)
