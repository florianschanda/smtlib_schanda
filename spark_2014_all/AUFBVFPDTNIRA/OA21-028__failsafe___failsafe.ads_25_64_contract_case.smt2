...
(assert (= s15 s13))
(assert (= res14 res12))
(assert (= (fp.geq (to_rep (select battery_level_at current_time)) (fp #b0 #b01111100 #b10011001100110011001101)) true))
(assert (not (= (t__content failsafe__model__time_below_threshold__result4) ((_ int2bv 8) 0))))
(check-sat)
(exit)
