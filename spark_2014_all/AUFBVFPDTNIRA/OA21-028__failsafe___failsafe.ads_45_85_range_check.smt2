...
(assert (=> (bvult (t__content failsafe__model__time_below_threshold__result4) #x32) (= result7 (ite (fp.leq (fp #b0 #b01111100 #b10011001100110011001101) o12) true false))))
...
(assert (= (= result10 true) (forall ((s17 (_ BitVec 8))) (=> (and (bvule #x00 s17) (bvule s17 current_time)) (fp.lt (to_rep (select battery_level_at s17)) (fp #b0 #b01111100 #b10011001100110011001101))))))
