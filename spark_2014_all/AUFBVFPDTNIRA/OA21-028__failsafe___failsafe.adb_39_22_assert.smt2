...
(assert (forall ((s (_ BitVec 8))) (=> (and (bvule ((_ int2bv 8) 0) s) (bvule s ((_ int2bv 8) 49))) (fp.lt (to_rep (select battery_level_at s)) (fp #b0 #b01111100 #b10011001100110011001101)))))
(assert (not (= counter ((_ int2bv 8) 50))))
(check-sat)
(exit)
