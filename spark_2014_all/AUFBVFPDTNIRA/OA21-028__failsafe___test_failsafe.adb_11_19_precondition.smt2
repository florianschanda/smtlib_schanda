...
(define-fun failsafe_state8 () us_private__ref (mk___private__ref failsafe_state5))
(define-fun current_time9 () t__ref (mk_t__ref current_time6))
(define-fun battery_level_at8 () map__ref (mk_map__ref battery_level_at5))
...
(assert (=> (and (<= 1 j1) (<= j1 49)) (= failsafe_state8 (mk___private__ref failsafe_state3))))
(assert (=> (and (<= 1 j1) (<= j1 49)) (= (mk_int__ref j5) (mk_int__ref j3))))
(assert (=> (and (<= 1 j1) (<= j1 49)) (= current_time9 (mk_t__ref current_time4))))
(assert (=> (and (<= 1 j1) (<= j1 49)) (= battery_level_at8 (mk_map__ref battery_level_at3))))
...
(assert (=> (not (and (<= 1 j1) (<= j1 49))) (= failsafe_state8 (mk___private__ref failsafe_state))))
(assert (=> (not (and (<= 1 j1) (<= j1 49))) (= j1 j5)))
(assert (=> (not (and (<= 1 j1) (<= j1 49))) (= current_time9 (mk_t__ref current_time))))
(assert (=> (not (and (<= 1 j1) (<= j1 49))) (= battery_level_at8 (mk_map__ref battery_level_at))))
...
(assert (not (= (is_valid failsafe_state7 battery_level_at7 current_time8) true)))
(check-sat)
(exit)
