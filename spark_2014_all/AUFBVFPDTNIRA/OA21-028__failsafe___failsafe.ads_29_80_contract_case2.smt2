...
(assert (forall ((s17 (_ BitVec 8))) (=> (and (bvule #x00 s17) (bvule s17 #x31)) (fp.lt (to_rep (select battery_level_at s17)) battery_threshold))))
(assert (not (= (t__content failsafe__model__time_below_threshold__result4) #x32)))
(check-sat)
(exit)
