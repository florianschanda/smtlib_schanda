...
(assert (= (= result7 true) (forall ((s (_ BitVec 8))) (=> (and (bvule #x00 s) (bvule s current_time1)) (fp.lt (to_rep (select battery_level_at1 s)) (fp #b0 #b01111100 #b10011001100110011001101))))))
(assert (= result7 true))
