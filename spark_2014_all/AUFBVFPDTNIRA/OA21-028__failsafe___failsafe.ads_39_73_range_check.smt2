...
(assert (=> (bvult (t__content failsafe__model__time_below_threshold__result4) #x32) (and (= o7 (t__content failsafe__model__time_below_threshold__result4)) (in_range1 (t__content failsafe__model__time_below_threshold__result4)))))
(assert (=> (bvult (t__content failsafe__model__time_below_threshold__result4) #x32) (= temp___303 (bvsub current_time o7))))
...
(assert (=> (bvult (t__content failsafe__model__time_below_threshold__result4) #x32) (= result8 (ite (bvult current_time o8) true false))))
(assert (=> (bvult (t__content failsafe__model__time_below_threshold__result4) #x32) (=> (= result8 true) (= o9 (bvadd temp___303 #x32)))))
(assert (=> (bvult (t__content failsafe__model__time_below_threshold__result4) #x32) (=> (not (= result8 true)) (= o9 temp___303))))
(assert (=> (bvult (t__content failsafe__model__time_below_threshold__result4) #x32) (= o10 (select battery_level_at o9))))
(assert (=> (bvult (t__content failsafe__model__time_below_threshold__result4) #x32) (= o11 (to_rep o10))))
(assert (=> (bvult (t__content failsafe__model__time_below_threshold__result4) #x32) (= result7 (ite (fp.leq (fp #b0 #b01111100 #b10011001100110011001101) o11) true false))))
