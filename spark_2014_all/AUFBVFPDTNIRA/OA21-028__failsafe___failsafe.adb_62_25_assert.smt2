...
(assert (not (forall ((s (_ BitVec 8))) (=> (and (bvule #x00 s) (bvule s #x31)) (fp.lt (to_rep (select battery_level_at1 s)) (fp #b0 #b01111100 #b10011001100110011001101))))))
(assert (not (fp.leq (fp #b0 #b01111100 #b10011001100110011001101) (to_rep (select battery_level_at1 (let ((temp___322 (bvsub current_time1 counter1))) (ite (bvult current_time1 counter1) (bvadd temp___322 #x32) temp___322)))))))
(check-sat)
(exit)
