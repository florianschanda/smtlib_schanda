...
(define-fun dynamic_invariant1 ((temp___expr_250 (_ BitVec 8)) (temp___is_init_246 Bool) (temp___skip_constant_247 Bool) (temp___do_toplevel_248 Bool) (temp___do_typ_inv_249 Bool)) Bool (=> (or (= temp___is_init_246 true) (bvule #x00 #x32)) (in_range2 temp___expr_250)))
(assert (forall ((failsafe__model__battery_level_at (Array (_ BitVec 8) battery_level_type))) (forall ((failsafe__model__current_time (_ BitVec 8))) (! (=> (dynamic_invariant failsafe__model__current_time true true true true) (let ((result (time_below_threshold failsafe__model__battery_level_at failsafe__model__current_time))) (and (ite (fp.leq battery_threshold (to_rep (select failsafe__model__battery_level_at failsafe__model__current_time))) (= result #x00) (ite (forall ((s (_ BitVec 8))) (=> (and (bvule #x00 s) (bvule s #x31)) (fp.lt (to_rep (select failsafe__model__battery_level_at s)) battery_threshold))) (= result #x32) (and (and (bvult result #x32) (fp.leq battery_threshold (to_rep (select failsafe__model__battery_level_at (let ((temp___267 (bvsub failsafe__model__current_time result))) (ite (bvult failsafe__model__current_time result) (bvadd temp___267 #x32) temp___267)))))) (ite (bvuge failsafe__model__current_time (bvsub result #x01)) (forall ((s (_ BitVec 8))) (=> (and (bvule (let ((temp___268 (bvsub failsafe__model__current_time (bvsub result #x01)))) (ite (bvult failsafe__model__current_time (bvsub result #x01)) (bvadd temp___268 #x32) temp___268)) s) (bvule s failsafe__model__current_time)) (fp.lt (to_rep (select failsafe__model__battery_level_at s)) battery_threshold))) (and (forall ((s (_ BitVec 8))) (=> (and (bvule #x00 s) (bvule s failsafe__model__current_time)) (fp.lt (to_rep (select failsafe__model__battery_level_at s)) battery_threshold))) (forall ((s (_ BitVec 8))) (=> (and (bvule (let ((temp___269 (bvsub failsafe__model__current_time (bvsub result #x01)))) (ite (bvult failsafe__model__current_time (bvsub result #x01)) (bvadd temp___269 #x32) temp___269)) s) (bvule s #x31)) (fp.lt (to_rep (select failsafe__model__battery_level_at s)) battery_threshold)))))))) (dynamic_invariant1 result true false true true)))) :pattern ((time_below_threshold failsafe__model__battery_level_at failsafe__model__current_time))))))
(declare-const attr__ATTRIBUTE_ADDRESS3 Int)
(declare-fun is_valid ((Array (_ BitVec 8) battery_level_type) (_ BitVec 8) (_ BitVec 8)) Bool)
(declare-fun is_valid__function_guard (Bool (Array (_ BitVec 8) battery_level_type) (_ BitVec 8) (_ BitVec 8)) Bool)
(declare-sort tcounterS 0)
(declare-const attr__ATTRIBUTE_MODULUS1 (_ BitVec 8))
(define-fun in_range3 ((x (_ BitVec 8))) Bool (and (bvule #x00 x) (bvule x #x32)))
...
(declare-datatypes () ((tcounterS__ref (mk_tcounterS__ref (tcounterS__content tcounterS)))))
(define-fun tcounterS__ref___projection ((a tcounterS__ref)) tcounterS (tcounterS__content a))
(define-fun dynamic_invariant2 ((temp___expr_282 (_ BitVec 8)) (temp___is_init_278 Bool) (temp___skip_constant_279 Bool) (temp___do_toplevel_280 Bool) (temp___do_typ_inv_281 Bool)) Bool (=> (or (= temp___is_init_278 true) (bvule #x00 #x32)) (in_range3 temp___expr_282)))
(assert true)
(assert (forall ((failsafe__model__battery_level_at (Array (_ BitVec 8) battery_level_type))) (forall ((failsafe__model__current_time (_ BitVec 8)) (failsafe__counter (_ BitVec 8))) (! (= (= (is_valid failsafe__model__battery_level_at failsafe__model__current_time failsafe__counter) true) (= failsafe__counter (time_below_threshold failsafe__model__battery_level_at failsafe__model__current_time))) :pattern ((is_valid failsafe__model__battery_level_at failsafe__model__current_time failsafe__counter))))))
...
(define-fun dynamic_invariant3 ((temp___expr_187 (_ BitVec 8)) (temp___is_init_183 Bool) (temp___skip_constant_184 Bool) (temp___do_toplevel_185 Bool) (temp___do_typ_inv_186 Bool)) Bool true)
(define-fun dynamic_invariant4 ((temp___expr_236 Float32) (temp___is_init_232 Bool) (temp___skip_constant_233 Bool) (temp___do_toplevel_234 Bool) (temp___do_typ_inv_235 Bool)) Bool (=> (or (= temp___is_init_232 true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111))) (fp.isFinite32 temp___expr_236)))
...
(assert (=> (forall ((s (_ BitVec 8))) (=> (and (bvule #x00 s) (bvule s #x31)) (fp.lt (to_rep (select battery_level_at s)) battery_threshold))) (= counter #x32)))
(assert (=> (forall ((s (_ BitVec 8))) (=> (and (bvule #x00 s) (bvule s #x31)) (=> (not (= s (let ((temp___316 (bvadd current_time #x01))) (ite (bvule (bvsub #x32 current_time) #x01) (bvsub temp___316 #x32) temp___316)))) (fp.lt (to_rep (select battery_level_at s)) battery_threshold)))) (bvuge counter #x31)))
(assert (=> (bvule (bvsub #x32 current_time) #x01) (= o (bvsub (bvadd current_time #x01) #x32))))
(assert (=> (not (bvule (bvsub #x32 current_time) #x01)) (= o (bvadd current_time #x01))))
...
(assert (and (= o3 (bv_min (bvadd counter #x01) #x32)) (in_range3 (bv_min (bvadd counter #x01) #x32))))
(assert (= (mk_t__ref result2) (mk_t__ref counter)))
(assert (= counter1 o3))
(assert (=> (fp.leq battery_threshold (to_rep (select battery_level_at1 current_time1))) (= counter1 #x00)))
(assert (=> (= c #x32) (= counter1 #x32)))
(assert (not (= c #x32)))
(assert (forall ((s (_ BitVec 8))) (=> (and (bvule #x00 s) (bvule s #x31)) (fp.lt (to_rep (select battery_level_at1 s)) battery_threshold))))
(assert (not (= c #x31)))
(check-sat)
(exit)
