...
(assert (ite (bvuge current_time (bvsub res3 #x01)) (forall ((s3 (_ BitVec 8))) (=> (and (bvule (let ((temp___299 (bvsub current_time (bvsub res3 #x01)))) (ite (bvult current_time (bvsub res3 #x01)) (bvadd temp___299 #x32) temp___299)) s3) (bvule s3 current_time)) (fp.lt (to_rep (select battery_level_at s3)) (fp #b0 #b01111100 #b10011001100110011001101)))) (and (forall ((s3 (_ BitVec 8))) (=> (and (bvule #x00 s3) (bvule s3 current_time)) (fp.lt (to_rep (select battery_level_at s3)) (fp #b0 #b01111100 #b10011001100110011001101)))) (forall ((s3 (_ BitVec 8))) (=> (and (bvule (let ((temp___300 (bvsub current_time (bvsub res3 #x01)))) (ite (bvult current_time (bvsub res3 #x01)) (bvadd temp___300 #x32) temp___300)) s3) (bvule s3 #x31)) (fp.lt (to_rep (select battery_level_at s3)) (fp #b0 #b01111100 #b10011001100110011001101)))))))
