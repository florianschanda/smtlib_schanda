...
(assert (ite (bvuge current_time (bvsub res3 ((_ int2bv 8) 1))) (forall ((s3 (_ BitVec 8))) (=> (and (bvule (let ((temp___261 (bvsub current_time (bvsub res3 ((_ int2bv 8) 1))))) (ite (bvult current_time (bvsub res3 ((_ int2bv 8) 1))) (bvadd temp___261 ((_ int2bv 8) 50)) temp___261)) s3) (bvule s3 current_time)) (fp.lt (to_rep (select battery_level_at s3)) (fp #b0 #b01111100 #b10011001100110011001101)))) (and (forall ((s3 (_ BitVec 8))) (=> (and (bvule ((_ int2bv 8) 0) s3) (bvule s3 current_time)) (fp.lt (to_rep (select battery_level_at s3)) (fp #b0 #b01111100 #b10011001100110011001101)))) (forall ((s3 (_ BitVec 8))) (=> (and (bvule (let ((temp___262 (bvsub current_time (bvsub res3 ((_ int2bv 8) 1))))) (ite (bvult current_time (bvsub res3 ((_ int2bv 8) 1))) (bvadd temp___262 ((_ int2bv 8) 50)) temp___262)) s3) (bvule s3 ((_ int2bv 8) 49))) (fp.lt (to_rep (select battery_level_at s3)) (fp #b0 #b01111100 #b10011001100110011001101)))))))
(assert (= res3 (bvadd s2 ((_ int2bv 8) 1))))
(assert (and (and (=> (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 49)) (in_range1 s2)) (=> (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 50)) (in_range2 res3))) (and (bvule ((_ int2bv 8) 0) s2) (bvule s2 ((_ int2bv 8) 49)))))
(assert (and (= o4 (bvsub res3 ((_ int2bv 8) 1))) (in_range1 (bvsub res3 ((_ int2bv 8) 1)))))
(assert (= result4 (ite (bvuge current_time o4) true false)))
(assert (= result4 true))
(assert (not (in_range1 (bvsub res3 ((_ int2bv 8) 1)))))
(check-sat)
(exit)
