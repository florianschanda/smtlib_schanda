...
(assert (not (<= (+ (+ 0 (ite (= (fp.geq (to_rep (select battery_level_at current_time)) (fp #b0 #b01111100 #b10011001100110011001101)) true) 1 0)) (ite (forall ((s (_ BitVec 8))) (=> (and (bvule #x00 s) (bvule s #x31)) (fp.lt (to_rep (select battery_level_at s)) (fp #b0 #b01111100 #b10011001100110011001101)))) 1 0)) 1)))
(check-sat)
(exit)
