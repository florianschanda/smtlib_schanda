...
(assert (=> (bvult current_time s3) (= o9 (bvadd (bvsub current_time s3) ((_ int2bv 8) 50)))))
(assert (=> (not (bvult current_time s3)) (= o9 (bvsub current_time s3))))
(assert (= o10 (select battery_level_at o9)))
(assert (= o11 (to_rep o10)))
(assert (= result7 (ite (fp.lt o11 (fp #b0 #b01111100 #b10011001100110011001101)) true false)))
(assert (= result7 true))
(assert (and (= o12 (bvadd res3 ((_ int2bv 8) 1))) (in_range2 (bvadd res3 ((_ int2bv 8) 1)))))
(assert (= res3 result8))
(assert (= res4 o12))
...
(assert (bvule (let ((temp___261 (bvsub current_time (bvsub res4 ((_ int2bv 8) 1))))) (ite (bvult current_time (bvsub res4 ((_ int2bv 8) 1))) (bvadd temp___261 ((_ int2bv 8) 50)) temp___261)) s16))
(assert (bvule s16 current_time))
(assert (not (fp.lt (to_rep (select battery_level_at s16)) (fp #b0 #b01111100 #b10011001100110011001101))))
(check-sat)
(exit)
