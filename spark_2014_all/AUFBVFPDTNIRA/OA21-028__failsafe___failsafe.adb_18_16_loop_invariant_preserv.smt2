...
(assert (ite (bvuge current_time (bvsub res3 #x01)) (forall ((s4 (_ BitVec 8))) (=> (and (bvule (let ((temp___301 (bvsub current_time (bvsub res3 #x01)))) (ite (bvult current_time (bvsub res3 #x01)) (bvadd temp___301 #x32) temp___301)) s4) (bvule s4 current_time)) (fp.lt (to_rep (select battery_level_at s4)) battery_threshold))) (and (forall ((s4 (_ BitVec 8))) (=> (and (bvule #x00 s4) (bvule s4 current_time)) (fp.lt (to_rep (select battery_level_at s4)) battery_threshold))) (forall ((s4 (_ BitVec 8))) (=> (and (bvule (let ((temp___302 (bvsub current_time (bvsub res3 #x01)))) (ite (bvult current_time (bvsub res3 #x01)) (bvadd temp___302 #x32) temp___302)) s4) (bvule s4 #x31)) (fp.lt (to_rep (select battery_level_at s4)) battery_threshold))))))
...
(assert (not (fp.lt (to_rep (select battery_level_at s4)) battery_threshold)))
(check-sat)
(exit)
