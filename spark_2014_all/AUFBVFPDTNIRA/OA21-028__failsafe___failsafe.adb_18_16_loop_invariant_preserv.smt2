...
(assert (ite (bvuge current_time (bvsub res3 #x01)) (forall ((s4 (_ BitVec 8))) (=> (and (bvule (let ((temp___299 (bvsub current_time (bvsub res3 #x01)))) (ite (bvult current_time (bvsub res3 #x01)) (bvadd temp___299 #x32) temp___299)) s4) (bvule s4 current_time)) (fp.lt (to_rep (select battery_level_at s4)) (fp #b0 #b01111100 #b10011001100110011001101)))) (and (forall ((s4 (_ BitVec 8))) (=> (and (bvule #x00 s4) (bvule s4 current_time)) (fp.lt (to_rep (select battery_level_at s4)) (fp #b0 #b01111100 #b10011001100110011001101)))) (forall ((s4 (_ BitVec 8))) (=> (and (bvule (let ((temp___300 (bvsub current_time (bvsub res3 #x01)))) (ite (bvult current_time (bvsub res3 #x01)) (bvadd temp___300 #x32) temp___300)) s4) (bvule s4 #x31)) (fp.lt (to_rep (select battery_level_at s4)) (fp #b0 #b01111100 #b10011001100110011001101)))))))
...
(assert (=> (bvult current_time s3) (= o4 (bvadd (bvsub current_time s3) #x32))))
...
(assert (bvule (let ((temp___299 (bvsub current_time (bvsub res4 #x01)))) (ite (bvult current_time (bvsub res4 #x01)) (bvadd temp___299 #x32) temp___299)) s4))
