...
(assert (ite (bvuge current_time (bvsub res3 ((_ int2bv 8) 1))) (forall ((s4 (_ BitVec 8))) (=> (and (bvule (let ((temp___261 (bvsub current_time (bvsub res3 ((_ int2bv 8) 1))))) (ite (bvult current_time (bvsub res3 ((_ int2bv 8) 1))) (bvadd temp___261 ((_ int2bv 8) 50)) temp___261)) s4) (bvule s4 current_time)) (fp.lt (to_rep (select battery_level_at s4)) (fp #b0 #b01111100 #b10011001100110011001101)))) (and (forall ((s4 (_ BitVec 8))) (=> (and (bvule ((_ int2bv 8) 0) s4) (bvule s4 current_time)) (fp.lt (to_rep (select battery_level_at s4)) (fp #b0 #b01111100 #b10011001100110011001101)))) (forall ((s4 (_ BitVec 8))) (=> (and (bvule (let ((temp___262 (bvsub current_time (bvsub res3 ((_ int2bv 8) 1))))) (ite (bvult current_time (bvsub res3 ((_ int2bv 8) 1))) (bvadd temp___262 ((_ int2bv 8) 50)) temp___262)) s4) (bvule s4 ((_ int2bv 8) 49))) (fp.lt (to_rep (select battery_level_at s4)) (fp #b0 #b01111100 #b10011001100110011001101)))))))
...
(assert (=> (bvult current_time s3) (= o4 (bvadd (bvsub current_time s3) ((_ int2bv 8) 50)))))
(assert (=> (not (bvult current_time s3)) (= o4 (bvsub current_time s3))))
(assert (= o5 (select battery_level_at o4)))
(assert (= o6 (to_rep o5)))
(assert (= result5 (ite (fp.lt o6 (fp #b0 #b01111100 #b10011001100110011001101)) true false)))
(assert (= result5 true))
(assert (and (= o7 (bvadd res3 ((_ int2bv 8) 1))) (in_range2 (bvadd res3 ((_ int2bv 8) 1)))))
(assert (= res3 result6))
(assert (= res4 o7))
...
(assert (bvule (let ((temp___261 (bvsub current_time (bvsub res4 ((_ int2bv 8) 1))))) (ite (bvult current_time (bvsub res4 ((_ int2bv 8) 1))) (bvadd temp___261 ((_ int2bv 8) 50)) temp___261)) s4))
(assert (bvule s4 current_time))
(assert (not (fp.lt (to_rep (select battery_level_at s4)) (fp #b0 #b01111100 #b10011001100110011001101))))
(check-sat)
(exit)
