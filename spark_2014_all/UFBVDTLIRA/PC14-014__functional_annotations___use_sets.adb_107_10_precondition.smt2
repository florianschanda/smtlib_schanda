...
(assert (not (or (< (length (mk___rep s2__split_discrs (mk___split_fields s2__split_fields2))) (to_rep1 (rec__use_sets__my_sets__set__capacity s2__split_discrs))) (= (contains (model__ (mk___rep s2__split_discrs (mk___split_fields s2__split_fields2))) o15) true))))
(check-sat)
(exit)
