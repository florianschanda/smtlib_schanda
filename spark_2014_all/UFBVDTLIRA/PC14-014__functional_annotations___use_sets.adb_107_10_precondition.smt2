...
(assert (and (= o (element (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)) (mk___rep1 cu__split_fields3))) (and (in_range7 o) (= o (get (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (get1 (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (mk___rep1 cu__split_fields3)))))))
(assert (not (or (< (length (mk___rep s2__split_discrs s2__split_fields3)) (to_rep1 (rec__use_sets__my_sets__set__capacity s2__split_discrs))) (= (contains (model__ (mk___rep s2__split_discrs s2__split_fields3)) o) true))))
(check-sat)
(exit)
