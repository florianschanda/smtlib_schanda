...
(define-fun dynamic_invariant1 ((temp___expr_385 Int) (temp___is_init_382 Bool) (temp___skip_constant_383 Bool) (temp___do_toplevel_384 Bool)) Bool (=> (or (= temp___is_init_382 true) (<= 0 2147483647)) (in_range2 temp___expr_385)))
...
(define-fun default_initial_assumption ((temp___expr_392 us_rep2) (temp___skip_top_level_393 Bool)) Bool (=> (not (= temp___skip_top_level_393 true)) (= (length temp___expr_392) 0)))
...
(define-fun set__ref___2__projection ((a set__ref1)) us_rep3 (set__content1 a))
...
(assert (forall ((container us_rep)) (! (let ((result (elements container))) (and (and (and (and (= (length result) (length1 container)) (forall ((temp___429 Int)) (=> (and (in_range2 temp___429) (= (iter_has_element result temp___429) true)) (= (contains (model__ container) (get result temp___429)) true)))) (forall ((item Int)) (=> (and (in_range4 item) (= (contains (model__ container) item) true)) (and (< 0 (find result item)) (= (get result (find result item)) item))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length1 container))) (= (find result (get result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length1 container))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length1 container))) (=> (= (get result i) (get result j)) (= i j)))))))) :pattern ((elements container)))))
...
(define-fun dynamic_invariant2 ((temp___expr_325 Int) (temp___is_init_322 Bool) (temp___skip_constant_323 Bool) (temp___do_toplevel_324 Bool)) Bool (=> (or (= temp___is_init_322 true) (<= 0 2147483647)) (in_range5 temp___expr_325)))
...
(assert (forall ((container us_rep)) (! (let ((result (length1 container))) (and (<= result (to_rep1 (rec__use_sets__my_sets__set__capacity (us_split_discrs1 container)))) (dynamic_invariant5 result true false true))) :pattern ((length1 container)))))
(assert (forall ((attr__tag Int)) (forall ((container us_rep)) (! (dynamic_invariant5 (length2 attr__tag container) true false true) :pattern ((length2 attr__tag container))))))
(assert (forall ((container us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant2 item true true true) (let ((result (find container item))) (and (=> (< 0 result) (and (<= result (length container)) (= item (get container result)))) (dynamic_invariant5 result true false true)))) :pattern ((find container item))))))
...
(define-fun default_initial_assumption1 ((temp___expr_361 us_rep3) (temp___skip_top_level_362 Bool)) Bool (=> (not (= temp___skip_top_level_362 true)) (= (is_empty temp___expr_361) true)))
(declare-fun length3 (us_rep3) Int)
(declare-fun length__function_guard3 (Int us_rep3) Bool)
(assert (forall ((container us_rep)) (! (= (length3 (model__ container)) (length1 container)) :pattern ((model__ container)))))
...
(assert (forall ((left us_rep) (right us_rep)) (! (let ((result (oeq left right))) (and (= (= result true) (and (= (length1 left) (length1 right)) (= (e_elements_included (elements left) (elements right)) true))) (= (= result true) (and (= (e_elements_included (elements left) (elements right)) true) (= (e_elements_included (elements right) (elements left)) true))))) :pattern ((oeq left right)))))
(assert true)
(define-fun dynamic_invariant6 ((temp___expr_354 Int) (temp___is_init_351 Bool) (temp___skip_constant_352 Bool) (temp___do_toplevel_353 Bool)) Bool (=> (or (= temp___is_init_351 true) (<= 0 2147483647)) (in_range4 temp___expr_354)))
(assert (forall ((container us_rep3)) (forall ((item Int)) (! (=> (dynamic_invariant6 item true true true) (=> (= (of_int 1) true) (=> (exists ((e Int)) (and (and (in_range4 e) (= (contains container e) true)) (= e item))) (= (contains container item) true)))) :pattern ((contains container item))))))
(assert (forall ((container us_rep3)) (! (dynamic_invariant5 (length3 container) true false true) :pattern ((length3 container)))))
(assert (forall ((container us_rep3)) (! (let ((result (is_empty container))) (and (= (= result true) (forall ((item Int)) (not (and (in_range4 item) (= (contains container item) true))))) (= (= result true) (= (length3 container) 0)))) :pattern ((is_empty container)))))
...
(assert (forall ((container us_rep4)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant5 witness1 true true true) (= (has_witness container witness1) true)) (dynamic_invariant7 (w_get container witness1) true false true)) :pattern ((w_get container witness1))))))
(declare-const cu count_type)
(declare-const o Bool)
(declare-const o1 Bool)
(declare-const o2 Int)
(declare-const temp___1009 us_rep2)
