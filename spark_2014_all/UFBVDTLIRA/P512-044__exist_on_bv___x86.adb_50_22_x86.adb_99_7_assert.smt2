...
(assert (bvule n6 (bvadd var1_range_size var2_range_size)))
(assert (= var1 (bvadd (bvsub var2 var1_range_size) n6)))
(assert true)
(assert true)
(assert (=> (bvugt n6 var1_range_size) (= (mk_t__ref result1) (mk_t__ref n1))))
(assert (=> (bvugt n6 var1_range_size) (= n14 ((_ int2bv 64) 0))))
(assert (=> (bvugt n6 var1_range_size) (= (mk_t__ref result2) (mk_t__ref n2))))
(assert (=> (bvugt n6 var1_range_size) (= n24 (bvsub n6 var1_range_size))))
(assert (=> (bvugt n6 var1_range_size) (bvule n24 var2_range_size)))
(assert (=> (not (bvugt n6 var1_range_size)) (=> (bvult n6 var2_range_size) (= (mk_t__ref result3) (mk_t__ref n1)))))
(assert (=> (not (bvugt n6 var1_range_size)) (=> (bvult n6 var2_range_size) (= n15 var1_range_size))))
(assert (=> (not (bvugt n6 var1_range_size)) (=> (bvult n6 var2_range_size) (= (mk_t__ref result4) (mk_t__ref n2)))))
(assert (=> (not (bvugt n6 var1_range_size)) (=> (bvult n6 var2_range_size) (= n25 n6))))
(assert (=> (not (bvugt n6 var1_range_size)) (=> (not (bvult n6 var2_range_size)) (= (mk_t__ref result5) (mk_t__ref n1)))))
(assert (=> (not (bvugt n6 var1_range_size)) (=> (not (bvult n6 var2_range_size)) (= n16 (bvsub var1_range_size n6)))))
(assert (=> (not (bvugt n6 var1_range_size)) (=> (not (bvult n6 var2_range_size)) (= (mk_t__ref result6) (mk_t__ref n2)))))
(assert (=> (not (bvugt n6 var1_range_size)) (=> (not (bvult n6 var2_range_size)) (= n26 ((_ int2bv 64) 0)))))
(assert (=> (not (bvugt n6 var1_range_size)) (=> (not (bvult n6 var2_range_size)) (= n25 n26))))
(assert (=> (not (bvugt n6 var1_range_size)) (=> (not (bvult n6 var2_range_size)) (= n15 n16))))
(assert (=> (not (bvugt n6 var1_range_size)) (= n24 n25)))
(assert (=> (not (bvugt n6 var1_range_size)) (= n14 n15)))
(assert (and (and (and (bvule ((_ int2bv 64) 0) n14) (bvule n14 var1_range_size)) (and (bvule ((_ int2bv 64) 0) n24) (bvule n24 var2_range_size))) (= (bvadd var1 n14) (bvadd var2 n24))))
