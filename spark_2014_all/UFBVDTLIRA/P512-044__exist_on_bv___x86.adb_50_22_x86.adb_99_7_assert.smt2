...
(assert (=> (not (bvugt n3 var1_range_size)) (=> (bvult n3 var2_range_size) (= (mk_t__ref result3) n14))))
(assert (=> (not (bvugt n3 var1_range_size)) (=> (bvult n3 var2_range_size) (= n12 var1_range_size))))
(assert (=> (not (bvugt n3 var1_range_size)) (=> (bvult n3 var2_range_size) (= (mk_t__ref result4) n24))))
(assert (=> (not (bvugt n3 var1_range_size)) (=> (bvult n3 var2_range_size) (= n22 n3))))
(assert (=> (not (bvugt n3 var1_range_size)) (=> (not (bvult n3 var2_range_size)) (= (mk_t__ref result5) n14))))
(assert (=> (not (bvugt n3 var1_range_size)) (=> (not (bvult n3 var2_range_size)) (= n13 (bvsub var1_range_size n3)))))
(assert (=> (not (bvugt n3 var1_range_size)) (=> (not (bvult n3 var2_range_size)) (= (mk_t__ref result6) n24))))
(assert (=> (not (bvugt n3 var1_range_size)) (=> (not (bvult n3 var2_range_size)) (= n23 ((_ int2bv 64) 0)))))
(assert (=> (not (bvugt n3 var1_range_size)) (=> (not (bvult n3 var2_range_size)) (= n22 n23))))
(assert (=> (not (bvugt n3 var1_range_size)) (=> (not (bvult n3 var2_range_size)) (= n12 n13))))
(assert (=> (not (bvugt n3 var1_range_size)) (= n21 n22)))
(assert (=> (not (bvugt n3 var1_range_size)) (= n11 n12)))
(assert (and (and (and (bvule ((_ int2bv 64) 0) n11) (bvule n11 var1_range_size)) (and (bvule ((_ int2bv 64) 0) n21) (bvule n21 var2_range_size))) (= (bvadd var1 n11) (bvadd var2 n21))))
