...
(assert (=> (bvugt n3 var1_range_size) (= n11 #x0000000000000000)))
...
(assert (=> (not (bvugt n3 var1_range_size)) (=> (not (bvult n3 var2_range_size)) (= n23 #x0000000000000000))))
...
(assert (and (and (and (bvule #x0000000000000000 n11) (bvule n11 var1_range_size)) (and (bvule #x0000000000000000 n21) (bvule n21 var2_range_size))) (= (bvadd var1 n11) (bvadd var2 n21))))
