...
(define-fun dynamic_invariant ((temp___expr_346 Int) (temp___is_init_342 Bool) (temp___skip_constant_343 Bool) (temp___do_toplevel_344 Bool) (temp___do_typ_inv_345 Bool)) Bool (=> (or (= temp___is_init_342 true) (<= 1 100)) (in_range temp___expr_346)))
...
(define-fun dynamic_invariant1 ((temp___expr_692 Int) (temp___is_init_688 Bool) (temp___skip_constant_689 Bool) (temp___do_toplevel_690 Bool) (temp___do_typ_inv_691 Bool)) Bool (=> (or (= temp___is_init_688 true) (<= 1 100)) (in_range2 temp___expr_692)))
...
(define-fun dynamic_invariant2 ((temp___expr_699 Int) (temp___is_init_695 Bool) (temp___skip_constant_696 Bool) (temp___do_toplevel_697 Bool) (temp___do_typ_inv_698 Bool)) Bool (=> (or (= temp___is_init_695 true) (<= 1 100)) (in_range4 temp___expr_699)))
(assert (forall ((container us_rep)) (forall ((key1 Int)) (! (=> (dynamic_invariant2 key1 true true true true) (= (= (contains container key1) true) (exists ((e Int)) (and (and (in_range3 e) (= (contains1 (model__ container) e) true)) (= (my_eq key1 (key e)) true))))) :pattern ((contains container key1))))))
...
(define-fun dynamic_invariant3 ((temp___expr_353 Int) (temp___is_init_349 Bool) (temp___skip_constant_350 Bool) (temp___do_toplevel_351 Bool) (temp___do_typ_inv_352 Bool)) Bool (=> (or (= temp___is_init_349 true) (<= 1 100)) (in_range5 temp___expr_353)))
...
(assert (forall ((i Int)) (! (=> (dynamic_invariant i true true true true) (dynamic_invariant1 (key i) true false true true)) :pattern ((key i)))))
(assert (forall ((i Int)) (! (=> (dynamic_invariant i true true true true) (= (key i) i)) :pattern ((key i)))))
...
(define-fun dynamic_invariant5 ((temp___expr_197 Int) (temp___is_init_193 Bool) (temp___skip_constant_194 Bool) (temp___do_toplevel_195 Bool) (temp___do_typ_inv_196 Bool)) Bool (=> (or (= temp___is_init_193 true) (<= 0 2147483647)) (in_range1 temp___expr_197)))
(declare-const no_element us_rep3)
(declare-const attr__ATTRIBUTE_ADDRESS3 Int)
(assert (= no_element (mk___rep1 (mk___split_fields1 (of_rep1 0)))))
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep1 (rec__p__my_sets__set__capacity (us_split_discrs1 container)))) (dynamic_invariant5 result true false true true))) :pattern ((length container)))))
...
(assert (forall ((container us_rep1)) (forall ((item Int)) (! (=> (dynamic_invariant3 item true true true true) (let ((result (find container item))) (and (=> (< 0 result) (and (<= result (length2 container)) (= (my_eq item (get container result)) true))) (dynamic_invariant5 result true false true true)))) :pattern ((find container item))))))
...
(define-fun default_initial_assumption1 ((temp___expr_453 us_rep4) (temp___skip_top_level_454 Bool)) Bool (=> (not (= temp___skip_top_level_454 true)) (and (= (is_empty temp___expr_453) true) (= (length3 temp___expr_453) 0))))
...
(define-fun default_initial_assumption2 ((temp___expr_394 us_rep2) (temp___skip_top_level_395 Bool)) Bool (=> (not (= temp___skip_top_level_395 true)) (= (is_empty1 temp___expr_394) true)))
...
(assert (forall ((container us_rep)) (! (let ((result (elements container))) (and (and (and (and (= (length2 result) (length container)) (forall ((temp___471 Int)) (=> (and (in_range7 temp___471) (= (iter_has_element result temp___471) true)) (= (contains1 (model__ container) (get result temp___471)) true)))) (forall ((item Int)) (=> (and (in_range3 item) (= (contains1 (model__ container) item) true)) (and (< 0 (find result item)) (= (my_eq (get result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (= (find result (get result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length container))) (=> (= (my_eq (get result i) (get result j)) true) (= i j)))))))) :pattern ((elements container)))))
...
(assert (forall ((attr__tag Int)) (forall ((container us_rep)) (forall ((position us_rep3)) (! (dynamic_invariant3 (element1 attr__tag container position) true false true true) :pattern ((element1 attr__tag container position)))))))
(assert true)
(define-fun dynamic_invariant6 ((temp___expr_386 Int) (temp___is_init_382 Bool) (temp___skip_constant_383 Bool) (temp___do_toplevel_384 Bool) (temp___do_typ_inv_385 Bool)) Bool (=> (or (= temp___is_init_382 true) (<= 1 100)) (in_range3 temp___expr_386)))
(assert (forall ((container us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant6 item true true true true) (=> (= (distinct 1 0) true) (=> (exists ((e Int)) (and (and (in_range3 e) (= (contains1 container e) true)) (= (my_eq e item) true))) (= (contains1 container item) true)))) :pattern ((contains1 container item))))))
...
(assert (forall ((left us_rep2) (right us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant6 item true true true true) (= (= (included_except left right item) true) (forall ((e Int)) (=> (and (in_range3 e) (= (contains1 left e) true)) (or (= (contains1 right e) true) (= (my_eq e item) true)))))) :pattern ((included_except left right item))))))
(define-fun dynamic_invariant7 ((temp___expr_422 Int) (temp___is_init_418 Bool) (temp___skip_constant_419 Bool) (temp___do_toplevel_420 Bool) (temp___do_typ_inv_421 Bool)) Bool (=> (or (= temp___is_init_418 true) (<= 0 2147483647)) (in_range7 temp___expr_422)))
(assert (forall ((container us_rep1)) (! (let ((result (length2 container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant5 result true false true true))) :pattern ((length2 container)))))
...
(define-fun dynamic_invariant8 ((temp___expr_415 Int) (temp___is_init_411 Bool) (temp___skip_constant_412 Bool) (temp___do_toplevel_413 Bool) (temp___do_typ_inv_414 Bool)) Bool (=> (or (= temp___is_init_411 true) (<= 1 100)) (in_range8 temp___expr_415)))
...
(assert (forall ((container us_rep4)) (forall ((key1 us_rep3)) (! (=> (= (distinct 0 0) true) (=> (exists ((k1 us_rep3)) (and (= (has_key container k1) true) (= (bool_eq3 k1 key1) true))) (= (has_key container key1) true))) :pattern ((has_key container key1))))))
...
(define-fun dynamic_invariant9 ((temp___expr_445 Int) (temp___is_init_441 Bool) (temp___skip_constant_442 Bool) (temp___do_toplevel_443 Bool) (temp___do_typ_inv_444 Bool)) Bool (=> (or (= temp___is_init_441 true) (<= 1 2147483647)) (in_range9 temp___expr_445)))
...
(assert (forall ((container us_rep4)) (forall ((key1 us_rep3)) (! (=> (= (has_key container key1) true) (let ((result (get1 container key1))) (and (=> (= (distinct 0 0) true) (and (= result (w_get container (witness container key1))) (forall ((k1 us_rep3)) (=> (= (has_key container k1) true) (= (= (bool_eq3 k1 key1) true) (= (witness container key1) (witness container k1))))))) (dynamic_invariant9 result true false true true)))) :pattern ((get1 container key1))))))
(assert (forall ((container us_rep4)) (! (dynamic_invariant5 (length3 container) true false true true) :pattern ((length3 container)))))
...
(assert true)
(assert (forall ((container us_rep4)) (forall ((key1 us_rep3)) (! (=> (= (has_key container key1) true) (let ((result (witness container key1))) (and (= (has_witness container result) true) (dynamic_invariant5 result true false true true)))) :pattern ((witness container key1))))))
(assert (forall ((container us_rep4)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant5 witness1 true true true true) (= (has_witness container witness1) true)) (dynamic_invariant9 (w_get container witness1) true false true true)) :pattern ((w_get container witness1))))))
(assert (forall ((left us_rep2) (right us_rep2)) (forall ((key1 Int)) (! (=> (dynamic_invariant2 key1 true true true true) (= (= (m_included_except left right key1) true) (forall ((e Int)) (=> (and (in_range3 e) (= (contains1 left e) true)) (or (= (contains1 right e) true) (= (my_eq (key e) key1) true)))))) :pattern ((m_included_except left right key1))))))
