...
(define-fun l__split_fields4 () us_split_fields (mk___split_fields l__split_fields1))
(assert (in_range2 k))
(assert (= (contains (mk___rep l__split_discrs (mk___split_fields l__split_fields)) k) true))
(assert (and (= o (element2 (mk___rep l__split_discrs (mk___split_fields l__split_fields)) k)) (and (in_range5 o) (= o (element (mk___rep l__split_discrs (mk___split_fields l__split_fields)) (find1 (mk___rep l__split_discrs (mk___split_fields l__split_fields)) k))))))
(assert (= (mk_int__ref result) (mk_int__ref e)))
(assert (= e1 o))
(assert (in_range e1))
(assert (and (and (and (and (and (and (= (length (mk___rep l__split_discrs l__split_fields4)) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (= (element2 (mk___rep l__split_discrs l__split_fields4) k) e1)) (= (contains1 (model__ (mk___rep l__split_discrs l__split_fields4)) e1) true)) (= (m_included_except (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (model__ (mk___rep l__split_discrs l__split_fields4)) k) true)) (= (included_except (model__ (mk___rep l__split_discrs l__split_fields4)) (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) e1) true)) (= (mapping_preserved_except (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (elements (mk___rep l__split_discrs l__split_fields4)) (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (positions (mk___rep l__split_discrs l__split_fields4)) (find1 (mk___rep l__split_discrs l__split_fields4) k)) true)) (= (oeq2 (positions (mk___rep l__split_discrs l__split_fields4)) (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true)))
(assert (= e1 e2))
