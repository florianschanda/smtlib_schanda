...
(assert (= result1 bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline__result4))
(assert (not (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline__result4 (bvand (shift_right value from) (make_mask (+ (- to__ from) 1))))))
(check-sat)
(exit)
