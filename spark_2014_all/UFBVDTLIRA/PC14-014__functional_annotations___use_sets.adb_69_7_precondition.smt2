...
(assert (forall ((container us_rep)) (! (let ((result (elements container))) (and (and (and (and (= (length2 result) (length container)) (forall ((temp___471 Int)) (=> (and (in_range3 temp___471) (= (iter_has_element result temp___471) true)) (= (contains (model__ container) (get result temp___471)) true)))) (forall ((item Int)) (=> (and (in_range5 item) (= (contains (model__ container) item) true)) (and (< 0 (find result item)) (= (get result (find result item)) item))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (= (find result (get result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length container))) (=> (= (get result i) (get result j)) (= i j)))))))) :pattern ((elements container)))))
...
(define-fun dynamic_invariant3 ((temp___expr_346 Int) (temp___is_init_342 Bool) (temp___skip_constant_343 Bool) (temp___do_toplevel_344 Bool) (temp___do_typ_inv_345 Bool)) Bool (=> (or (= temp___is_init_342 true) (<= 0 2147483647)) (in_range6 temp___expr_346)))
(assert true)
...
(assert (forall ((container us_rep1)) (forall ((item Int)) (! (=> (dynamic_invariant5 item true true true true) (let ((result (find container item))) (and (=> (< 0 result) (and (<= result (length2 container)) (= item (get container result)))) (dynamic_invariant result true false true true)))) :pattern ((find container item))))))
...
(assert (forall ((container us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant6 item true true true true) (=> (= (distinct 1 0) true) (=> (exists ((e Int)) (and (and (in_range5 e) (= (contains container e) true)) (= e item))) (= (contains container item) true)))) :pattern ((contains container item))))))
...
(assert (and (and (let ((temp___974 (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))))) (forall ((temp___973 Int)) (=> (and (in_range3 temp___973) (= (iter_has_element temp___974 temp___973) true)) (= (prop__ (get temp___974 temp___973)) true)))) (let ((temp___976 (elements s2))) (forall ((temp___975 Int)) (=> (and (in_range3 temp___975) (= (iter_has_element temp___976 temp___975) true)) (= (prop__ (get temp___976 temp___975)) true))))) (< (length s2) (- (capacity (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))))))
