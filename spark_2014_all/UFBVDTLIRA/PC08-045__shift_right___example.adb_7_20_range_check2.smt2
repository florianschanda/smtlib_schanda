...
(define-fun dynamic_invariant1 ((temp___expr_165 (_ BitVec 16)) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool) (temp___do_typ_inv_164 Bool)) Bool true)
...
(define-fun dynamic_invariant2 ((temp___expr_158 (_ BitVec 8)) (temp___is_init_154 Bool) (temp___skip_constant_155 Bool) (temp___do_toplevel_156 Bool) (temp___do_typ_inv_157 Bool)) Bool true)
(declare-const o (_ BitVec 16))
(assert (and (= o (shift_right value 8)) (= o (bvudiv value (ite (< 8 65536) (bvshl #x0001 ((_ int2bv 16) 8)) #x0000)))))
