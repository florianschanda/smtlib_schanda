...
(define-fun dynamic_invariant1 ((temp___expr_445 Int) (temp___is_init_441 Bool) (temp___skip_constant_442 Bool) (temp___do_toplevel_443 Bool) (temp___do_typ_inv_444 Bool)) Bool (=> (or (= temp___is_init_441 true) (<= 1 2147483647)) (in_range2 temp___expr_445)))
(declare-fun length1 (us_rep2) Int)
(declare-fun length__function_guard1 (Int us_rep2) Bool)
(declare-fun is_empty (us_rep2) Bool)
(declare-fun is_empty__function_guard (Bool us_rep2) Bool)
(define-fun default_initial_assumption ((temp___expr_453 us_rep2) (temp___skip_top_level_454 Bool)) Bool (=> (not (= temp___skip_top_level_454 true)) (and (= (is_empty temp___expr_453) true) (= (length1 temp___expr_453) 0))))
...
(define-fun dynamic_invariant4 ((temp___expr_353 Int) (temp___is_init_349 Bool) (temp___skip_constant_350 Bool) (temp___do_toplevel_351 Bool) (temp___do_typ_inv_352 Bool)) Bool (=> (or (= temp___is_init_349 true) (<= 1 100)) (in_range4 temp___expr_353)))
...
(assert (forall ((container1 us_rep3)) (forall ((item Int)) (! (=> (dynamic_invariant4 item true true true true) (let ((result (find container1 item))) (and (=> (< 0 result) (and (<= result (length2 container1)) (= (my_eq item (get1 container1 result)) true))) (dynamic_invariant result true false true true)))) :pattern ((find container1 item))))))
...
(assert (forall ((container1 us_rep)) (! (= (length3 (model__ container1)) (length container1)) :pattern ((model__ container1)))))
(declare-fun contains (us_rep4 Int) Bool)
(declare-fun contains__function_guard (Bool us_rep4 Int) Bool)
(define-fun iter_has_element ((container1 us_rep3) (position1 Int)) Bool (and (ite (<= 1 position1) true false) (ite (<= position1 (last container1)) true false)))
...
(assert (forall ((container1 us_rep)) (! (let ((result (elements container1))) (and (and (and (and (= (length2 result) (length container1)) (forall ((temp___471 Int)) (=> (and (in_range6 temp___471) (= (iter_has_element result temp___471) true)) (= (contains (model__ container1) (get1 result temp___471)) true)))) (forall ((item Int)) (=> (and (in_range5 item) (= (contains (model__ container1) item) true)) (and (< 0 (find result item)) (= (my_eq (get1 result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (= (find result (get1 result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length container1))) (=> (= (my_eq (get1 result i) (get1 result j)) true) (= i j)))))))) :pattern ((elements container1)))))
...
(define-fun dynamic_invariant5 ((temp___expr_386 Int) (temp___is_init_382 Bool) (temp___skip_constant_383 Bool) (temp___do_toplevel_384 Bool) (temp___do_typ_inv_385 Bool)) Bool (=> (or (= temp___is_init_382 true) (<= 1 100)) (in_range5 temp___expr_386)))
(assert (forall ((container1 us_rep4)) (forall ((item Int)) (! (=> (dynamic_invariant5 item true true true true) (=> (= (distinct 1 0) true) (=> (exists ((e Int)) (and (and (in_range5 e) (= (contains container1 e) true)) (= (my_eq e item) true))) (= (contains container1 item) true)))) :pattern ((contains container1 item))))))
(assert (forall ((container1 us_rep4)) (! (dynamic_invariant (length3 container1) true false true true) :pattern ((length3 container1)))))
(assert (forall ((container1 us_rep4)) (! (let ((result (is_empty1 container1))) (and (= (= result true) (forall ((item Int)) (not (and (in_range5 item) (= (contains container1 item) true))))) (= (= result true) (= (length3 container1) 0)))) :pattern ((is_empty1 container1)))))
(define-fun dynamic_invariant6 ((temp___expr_422 Int) (temp___is_init_418 Bool) (temp___skip_constant_419 Bool) (temp___do_toplevel_420 Bool) (temp___do_typ_inv_421 Bool)) Bool (=> (or (= temp___is_init_418 true) (<= 0 2147483647)) (in_range6 temp___expr_422)))
(assert (forall ((container1 us_rep3)) (! (let ((result (length2 container1))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant result true false true true))) :pattern ((length2 container1)))))
(declare-sort element_type4 0)
(declare-fun element_typeqtint4 (element_type4) Int)
(assert (forall ((i element_type4)) (and (<= 1 (element_typeqtint4 i)) (<= (element_typeqtint4 i) 100))))
...
(define-fun element_type__ref___4__projection ((a element_type__ref4)) element_type4 (element_type__content4 a))
(define-fun dynamic_invariant7 ((temp___expr_415 Int) (temp___is_init_411 Bool) (temp___skip_constant_412 Bool) (temp___do_toplevel_413 Bool) (temp___do_typ_inv_414 Bool)) Bool (=> (or (= temp___is_init_411 true) (<= 1 100)) (in_range7 temp___expr_415)))
(assert (forall ((container1 us_rep3)) (forall ((position1 Int)) (! (=> (and (dynamic_invariant6 position1 true true true true) (and (<= 1 position1) (<= position1 (last container1)))) (dynamic_invariant7 (get1 container1 position1) true false true true)) :pattern ((get1 container1 position1))))))
...
(assert true)
(assert (forall ((container1 us_rep2)) (forall ((key us_rep1)) (! (=> (= (has_key container1 key) true) (let ((result (witness container1 key))) (and (= (has_witness container1 result) true) (dynamic_invariant result true false true true)))) :pattern ((witness container1 key))))))
(assert (forall ((container1 us_rep2)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant witness1 true true true true) (= (has_witness container1 witness1) true)) (dynamic_invariant1 (w_get container1 witness1) true false true true)) :pattern ((w_get container1 witness1))))))
...
(assert (and (= o1 (length container)) (and (in_range1 o1) (<= o1 (to_rep1 (rec__p__my_sets__set__capacity (us_split_discrs1 container)))))))
...
(assert (not (= (has_key o position) true)))
(check-sat)
(exit)
