...
(assert (<= 1 i1))
(assert (<= i1 amount))
(assert (=> (< (- i1 1) 65536) (= o (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) (- i1 1))))))
(assert (=> (not (< (- i1 1) 65536)) (= o ((_ int2bv 16) 0))))
(assert (= o1 (bvadd result__1 o)))
(assert (= result__1 result2))
(assert (= result__2 o1))
(assert (= (bvand result__3 (let ((temp___432 (- i2 1))) (ite (< temp___432 65536) (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) temp___432)) ((_ int2bv 16) 0)))) (let ((temp___433 (- i2 1))) (ite (< temp___433 65536) (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) temp___433)) ((_ int2bv 16) 0)))))
(assert (and (=> (<= 1 amount) (dynamic_property 1 amount i2)) (and (<= 1 i2) (<= i2 amount))))
(assert (not (= i2 amount)))
(assert (= result3 i2))
(assert (= i3 (+ i2 1)))
(assert (=> (< (- i3 1) 65536) (= o2 (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) (- i3 1))))))
(assert (=> (not (< (- i3 1) 65536)) (= o2 ((_ int2bv 16) 0))))
(assert (= o3 (bvadd result__3 o2)))
(assert (= result4 result__3))
(assert (= result__4 o3))
(assert (not (= (bvand result__4 (let ((temp___432 (- i3 1))) (ite (< temp___432 65536) (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) temp___432)) ((_ int2bv 16) 0)))) (let ((temp___433 (- i3 1))) (ite (< temp___433 65536) (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) temp___433)) ((_ int2bv 16) 0))))))
(check-sat)
(exit)
