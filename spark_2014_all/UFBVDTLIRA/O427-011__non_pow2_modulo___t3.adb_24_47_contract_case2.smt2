...
(declare-sort m 0)
(define-fun in_range1 ((x (_ BitVec 64))) Bool (and (bvule #x0000000000000000 x) (bvule x #x00000000000000E5)))
...
(define-fun dynamic_invariant ((temp___expr_207 (_ BitVec 64)) (temp___is_init_203 Bool) (temp___skip_constant_204 Bool) (temp___do_toplevel_205 Bool) (temp___do_typ_inv_206 Bool)) Bool (=> (or (= temp___is_init_203 true) (bvule #x0000000000000000 #x00000000000000E5)) (in_range1 temp___expr_207)))
...
(assert (=> (bvult x y) (= o (bvadd (bvsub x y) #x00000000000000E6))))
...
(assert (=> (= (ite (= (= x #x0000000000000000) true) (= y #x0000000000000000) false) true) (= t3__msub__result4 #x0000000000000000)))
(assert (= (ite (= (not (= x #x0000000000000000)) true) (= y #x0000000000000000) false) true))
(assert (not (= t3__msub__result4 x)))
(check-sat)
(exit)
