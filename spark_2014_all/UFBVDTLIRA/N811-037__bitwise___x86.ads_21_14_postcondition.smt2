...
(assert (forall ((x86__rdx (_ BitVec 64))) (! (=> (dynamic_invariant x86__rdx true true true true) (let ((result (dl x86__rdx))) (and (= result ((_ extract 7 0) (bvand x86__rdx #x00000000000000FF))) (dynamic_invariant1 result true false true true)))) :pattern ((dl x86__rdx)))))
...
(assert (=> (= carryflag true) (= rdx1 (bvor (bvand rdx #xFFFFFFFFFFFFFF00) ((_ zero_extend 56) #x01)))))
(assert (=> (not (= carryflag true)) (= rdx2 (bvor (bvand rdx #xFFFFFFFFFFFFFF00) ((_ zero_extend 56) #x00)))))
(assert (=> (not (= carryflag true)) (= rdx1 rdx2)))
(assert (= rdx1 rdx3))
(assert (= rdx4 rdx1))
(assert (not (= carryflag true)))
(assert (not (= (dl rdx3) #x00)))
(check-sat)
(exit)
