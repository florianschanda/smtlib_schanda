...
(assert (forall ((x86__rdx (_ BitVec 64))) (! (=> (dynamic_invariant x86__rdx true true true) (let ((result (dl x86__rdx))) (and (= result ((_ extract 7 0) (bvand x86__rdx ((_ int2bv 64) 255)))) (dynamic_invariant1 result true false true)))) :pattern ((dl x86__rdx)))))
...
(assert (=> (= carryflag true) (= rdx1 (bvor (bvand rdx ((_ int2bv 64) 18446744073709551360)) ((_ zero_extend 56) ((_ int2bv 8) 1))))))
(assert (=> (not (= carryflag true)) (= rdx2 (bvor (bvand rdx ((_ int2bv 64) 18446744073709551360)) ((_ zero_extend 56) ((_ int2bv 8) 0))))))
(assert (=> (not (= carryflag true)) (= rdx1 rdx2)))
(assert (= rdx1 rdx3))
(assert (= rdx4 rdx1))
(assert (= carryflag true))
(assert (not (= (dl rdx3) ((_ int2bv 8) 1))))
(check-sat)
(exit)
