...
(define-fun dynamic_invariant1 ((temp___expr_270 Int) (temp___is_init_266 Bool) (temp___skip_constant_267 Bool) (temp___do_toplevel_268 Bool) (temp___do_typ_inv_269 Bool)) Bool (=> (or (= temp___is_init_266 true) (<= 0 7)) (in_range1 temp___expr_270)))
...
(assert (= i1 0))
(assert (=> (and (<= 0 i1) (<= i1 7)) (= temp___455 result__)))
(assert (=> (and (<= 0 i1) (<= i1 7)) (= temp___454 i1)))
