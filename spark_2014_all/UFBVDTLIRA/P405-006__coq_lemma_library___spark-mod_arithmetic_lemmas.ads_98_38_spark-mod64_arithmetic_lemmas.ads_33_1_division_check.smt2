...
(assert true)
(assert true)
(assert (in_range scale_denom))
(assert true)
(assert (bvule scale_num scale_denom))
(assert (=> (= scale_num ((_ int2bv 64) 0)) (= result true)))
(assert (=> (not (= scale_num ((_ int2bv 64) 0))) (= result (ite (bvule val__ (bvudiv ((_ int2bv 64) 18446744073709551615) scale_num)) true false))))
(assert (= result true))
(assert (not (not (= scale_denom #x0000000000000000))))
(check-sat)
(exit)
