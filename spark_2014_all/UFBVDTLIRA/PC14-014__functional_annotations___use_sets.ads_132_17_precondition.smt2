...
(assert (and (= temp___1009 (elements s)) (and (and (and (and (= (length temp___1009) (length1 s)) (forall ((temp___425 Int)) (=> (and (in_range2 temp___425) (= (iter_has_element temp___1009 temp___425) true)) (= (contains (model__ s) (get temp___1009 temp___425)) true)))) (forall ((item Int)) (=> (and (in_range4 item) (= (contains (model__ s) item) true)) (and (< 0 (find temp___1009 item)) (= (get temp___1009 (find temp___1009 item)) item))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length1 s))) (= (find temp___1009 (get temp___1009 i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length1 s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length1 s))) (=> (= (get temp___1009 i) (get temp___1009 j)) (= i j)))))))))
(assert (not true))
(check-sat)
(exit)
