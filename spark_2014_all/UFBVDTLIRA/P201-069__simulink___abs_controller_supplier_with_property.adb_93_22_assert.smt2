...
(assert (=> (bvugt vehicle_speed ((_ int2bv 32) 0)) (and (= o (bv2nat (bvmul ((_ int2bv 32) 8) vehicle_speed))) (in_range3 (bv2nat (bvmul ((_ int2bv 32) 8) vehicle_speed))))))
(assert (=> (bvugt vehicle_speed ((_ int2bv 32) 0)) (and (= o1 (bv2nat (bvmul ((_ int2bv 32) 10) wheel_speed))) (in_range3 (bv2nat (bvmul ((_ int2bv 32) 10) wheel_speed))))))
(assert (=> (bvugt vehicle_speed ((_ int2bv 32) 0)) (= o2 (- o1 o))))
(assert (=> (bvugt vehicle_speed ((_ int2bv 32) 0)) (and (= o3 o2) (in_range2 o2))))
(assert (=> (bvugt vehicle_speed ((_ int2bv 32) 0)) (= (mk_int__ref result) (mk_int__ref sum_out1))))
(assert (=> (bvugt vehicle_speed ((_ int2bv 32) 0)) (= sum_out12 o3)))
(assert (=> (bvugt vehicle_speed ((_ int2bv 32) 0)) (and (= o4 (boolean_to_integer_8 (ite (< sum_out12 0) true false))) (in_range1 o4))))
(assert (=> (bvugt vehicle_speed ((_ int2bv 32) 0)) (and (= o5 (boolean_to_integer_8 (ite (< 0 sum_out12) true false))) (in_range1 o5))))
(assert (=> (bvugt vehicle_speed ((_ int2bv 32) 0)) (= o6 (- o5 o4))))
(assert (=> (bvugt vehicle_speed ((_ int2bv 32) 0)) (and (= o7 o6) (in_range o6))))
(assert (=> (bvugt vehicle_speed ((_ int2bv 32) 0)) (= (mk_int__ref result1) (mk_int__ref sum_1_out1_sat))))
(assert (=> (bvugt vehicle_speed ((_ int2bv 32) 0)) (= sum_1_out1_sat2 o7)))
(assert (=> (bvugt vehicle_speed ((_ int2bv 32) 0)) (=> (< 127 sum_1_out1_sat2) (= result2 sum_1_out1))))
(assert (=> (bvugt vehicle_speed ((_ int2bv 32) 0)) (=> (< 127 sum_1_out1_sat2) (= sum_1_out12 127))))
(assert (=> (bvugt vehicle_speed ((_ int2bv 32) 0)) (=> (not (< 127 sum_1_out1_sat2)) (=> (< sum_1_out1_sat2 (- 128)) (= result3 sum_1_out1)))))
(assert (=> (bvugt vehicle_speed ((_ int2bv 32) 0)) (=> (not (< 127 sum_1_out1_sat2)) (=> (< sum_1_out1_sat2 (- 128)) (= sum_1_out13 (- 128))))))
(assert (=> (bvugt vehicle_speed ((_ int2bv 32) 0)) (=> (not (< 127 sum_1_out1_sat2)) (=> (not (< sum_1_out1_sat2 (- 128))) (and (= o8 sum_1_out1_sat2) (in_range1 sum_1_out1_sat2))))))
(assert (=> (bvugt vehicle_speed ((_ int2bv 32) 0)) (=> (not (< 127 sum_1_out1_sat2)) (=> (not (< sum_1_out1_sat2 (- 128))) (= result4 sum_1_out1)))))
(assert (=> (bvugt vehicle_speed ((_ int2bv 32) 0)) (=> (not (< 127 sum_1_out1_sat2)) (=> (not (< sum_1_out1_sat2 (- 128))) (= sum_1_out14 o8)))))
(assert (=> (bvugt vehicle_speed ((_ int2bv 32) 0)) (=> (not (< 127 sum_1_out1_sat2)) (=> (not (< sum_1_out1_sat2 (- 128))) (= sum_1_out13 sum_1_out14)))))
(assert (=> (bvugt vehicle_speed ((_ int2bv 32) 0)) (=> (not (< 127 sum_1_out1_sat2)) (= sum_1_out12 sum_1_out13))))
(assert (=> (bvugt vehicle_speed ((_ int2bv 32) 0)) (= result5 at_rest_switch_out1)))
(assert (=> (bvugt vehicle_speed ((_ int2bv 32) 0)) (= at_rest_switch_out11 sum_1_out12)))
(assert (=> (not (bvugt vehicle_speed ((_ int2bv 32) 0))) (= result6 at_rest_switch_out1)))
(assert (=> (not (bvugt vehicle_speed ((_ int2bv 32) 0))) (= at_rest_switch_out12 1)))
(assert (=> (not (bvugt vehicle_speed ((_ int2bv 32) 0))) (= sum_1_out1_sat2 sum_1_out1_sat)))
(assert (=> (not (bvugt vehicle_speed ((_ int2bv 32) 0))) (= at_rest_switch_out11 at_rest_switch_out12)))
(assert (=> (not (bvugt vehicle_speed ((_ int2bv 32) 0))) (= sum_1_out12 sum_1_out1)))
(assert (=> (not (bvugt vehicle_speed ((_ int2bv 32) 0))) (= sum_out12 sum_out1)))
(assert (=> (not (bvugt vehicle_speed ((_ int2bv 32) 0))) (= sum_1_out1_sat2 sum_1_out1_sat1)))
(assert (=> (not (bvugt vehicle_speed ((_ int2bv 32) 0))) (= at_rest_switch_out11 at_rest_switch_out12)))
(assert (=> (not (bvugt vehicle_speed ((_ int2bv 32) 0))) (= sum_1_out12 sum_1_out11)))
(assert (=> (not (bvugt vehicle_speed ((_ int2bv 32) 0))) (= sum_out12 sum_out11)))
(assert (not (or (not (= vehicle_speed ((_ int2bv 32) 0))) (= at_rest_switch_out11 1))))
(check-sat)
(exit)
