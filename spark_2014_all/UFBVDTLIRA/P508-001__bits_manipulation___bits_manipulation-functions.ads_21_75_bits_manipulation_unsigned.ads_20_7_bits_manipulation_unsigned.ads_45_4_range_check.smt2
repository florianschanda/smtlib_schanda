...
(assert (and (= o6 (make_mask o5)) (= o6 (shift_right ((_ int2bv 64) 18446744073709551615) (- 64 o5)))))
(assert (and (= o7 (shift_right value from)) (= o7 (ite (and (<= 1 64) (<= 64 8)) ((_ zero_extend 56) (ite (< from 8) (bvlshr ((_ extract 7 0) value) ((_ int2bv 8) from)) ((_ int2bv 8) 0))) (ite (and (<= 9 64) (<= 64 16)) ((_ zero_extend 48) (ite (< from 16) (bvlshr ((_ extract 15 0) value) ((_ int2bv 16) from)) ((_ int2bv 16) 0))) (ite (and (<= 17 64) (<= 64 32)) ((_ zero_extend 32) (bvlshr ((_ extract 31 0) value) ((_ int2bv 32) from))) (bvlshr value ((_ int2bv 64) from))))))))
(assert (= o8 (bvand o7 o6)))
(assert (= result4 (ite (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits__result4 o8) true false)))
(assert (= result4 true))
(assert (and (= o3 (+ (- to__ from) 1)) (in_range1 (+ (- to__ from) 1))))
(assert (and (= o4 (make_mask o3)) (= o4 (shift_right ((_ int2bv 64) 18446744073709551615) (- 64 o3)))))
(assert (= result5 (ite (bvule bits_manipulation_unsigned__unsigned_64__functions__extract_bits__result4 o4) true false)))
(assert (= result5 true))
