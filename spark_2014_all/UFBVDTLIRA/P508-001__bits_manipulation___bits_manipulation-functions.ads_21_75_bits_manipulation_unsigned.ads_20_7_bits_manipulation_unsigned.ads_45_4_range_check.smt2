...
(define-fun dynamic_invariant1 ((temp___expr_414 Int) (temp___is_init_410 Bool) (temp___skip_constant_411 Bool) (temp___do_toplevel_412 Bool) (temp___do_typ_inv_413 Bool)) Bool (=> (or (= temp___is_init_410 true) (<= 0 63)) (in_range temp___expr_414)))
...
(assert (forall ((v (_ BitVec 64))) (forall ((amount Int)) (! (=> (and (dynamic_invariant v true true true true) (dynamic_invariant2 amount true true true true)) (dynamic_invariant (shift_left v amount) true false true true)) :pattern ((shift_left v amount))))))
(assert (forall ((v (_ BitVec 64))) (forall ((amount Int)) (! (=> (and (dynamic_invariant v true true true true) (dynamic_invariant2 amount true true true true)) (= (shift_left v amount) (ite (and (<= 1 64) (<= 64 8)) ((_ zero_extend 56) (ite (< amount 8) (bvshl ((_ extract 7 0) v) ((_ int2bv 8) amount)) #x00)) (ite (and (<= 9 64) (<= 64 16)) ((_ zero_extend 48) (ite (< amount 16) (bvshl ((_ extract 15 0) v) ((_ int2bv 16) amount)) #x0000)) (ite (and (<= 17 64) (<= 64 32)) ((_ zero_extend 32) (bvshl ((_ extract 31 0) v) ((_ int2bv 32) amount))) (bvshl v ((_ int2bv 64) amount))))))) :pattern ((shift_left v amount))))))
(declare-fun make_mask (Int) (_ BitVec 64))
(declare-fun make_mask__function_guard ((_ BitVec 64) Int) Bool)
(define-fun dynamic_invariant3 ((temp___expr_421 Int) (temp___is_init_417 Bool) (temp___skip_constant_418 Bool) (temp___do_toplevel_419 Bool) (temp___do_typ_inv_420 Bool)) Bool (=> (or (= temp___is_init_417 true) (<= 1 64)) (in_range1 temp___expr_421)))
...
(assert (forall ((num_bits Int)) (! (=> (dynamic_invariant3 num_bits true true true true) (= (make_mask num_bits) (shift_right #xFFFFFFFFFFFFFFFF (- 64 num_bits)))) :pattern ((make_mask num_bits)))))
...
(assert (forall ((value1 (_ BitVec 64))) (forall ((from1 Int) (to__1 Int)) (! (=> (and (and (and (dynamic_invariant value1 true true true true) (dynamic_invariant1 from1 true true true true)) (dynamic_invariant1 to__1 true true true true)) (<= from1 to__1)) (let ((result (extract_bits_inline_always value1 from1 to__1))) (and (and (= result (bvand (shift_right value1 from1) (make_mask (+ (- to__1 from1) 1)))) (and (bvule result (make_mask (+ (- to__1 from1) 1))) (= (shift_left result from1) (bvand value1 (shift_left (make_mask (+ (- to__1 from1) 1)) from1))))) (dynamic_invariant result true false true true)))) :pattern ((extract_bits_inline_always value1 from1 to__1))))))
...
(assert (forall ((value1 (_ BitVec 64))) (forall ((from1 Int) (to__1 Int)) (! (=> (and (and (and (dynamic_invariant value1 true true true true) (dynamic_invariant1 from1 true true true true)) (dynamic_invariant1 to__1 true true true true)) (<= from1 to__1)) (let ((result (extract_bits_inline value1 from1 to__1))) (and (and (= result (bvand (shift_right value1 from1) (make_mask (+ (- to__1 from1) 1)))) (and (bvule result (make_mask (+ (- to__1 from1) 1))) (= (shift_left result from1) (bvand value1 (shift_left (make_mask (+ (- to__1 from1) 1)) from1))))) (dynamic_invariant result true false true true)))) :pattern ((extract_bits_inline value1 from1 to__1))))))
(assert (forall ((value1 (_ BitVec 64))) (forall ((from1 Int) (to__1 Int)) (! (=> (and (and (dynamic_invariant value1 true true true true) (dynamic_invariant1 from1 true true true true)) (dynamic_invariant1 to__1 true true true true)) (= (extract_bits_inline value1 from1 to__1) (extract_bits_inline_always value1 from1 to__1))) :pattern ((extract_bits_inline value1 from1 to__1))))))
...
(assert (forall ((value1 (_ BitVec 64))) (forall ((from1 Int) (to__1 Int)) (! (=> (and (and (and (dynamic_invariant value1 true true true true) (dynamic_invariant1 from1 true true true true)) (dynamic_invariant1 to__1 true true true true)) (<= from1 to__1)) (let ((result (extract_bits_not_inline value1 from1 to__1))) (and (and (= result (bvand (shift_right value1 from1) (make_mask (+ (- to__1 from1) 1)))) (and (bvule result (make_mask (+ (- to__1 from1) 1))) (= (shift_left result from1) (bvand value1 (shift_left (make_mask (+ (- to__1 from1) 1)) from1))))) (dynamic_invariant result true false true true)))) :pattern ((extract_bits_not_inline value1 from1 to__1))))))
(assert (forall ((value1 (_ BitVec 64))) (forall ((from1 Int) (to__1 Int)) (! (=> (and (and (dynamic_invariant value1 true true true true) (dynamic_invariant1 from1 true true true true)) (dynamic_invariant1 to__1 true true true true)) (= (extract_bits_not_inline value1 from1 to__1) (extract_bits_inline_always value1 from1 to__1))) :pattern ((extract_bits_not_inline value1 from1 to__1))))))
