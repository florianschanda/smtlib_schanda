...
(define-fun dynamic_invariant1 ((temp___expr_407 (_ BitVec 64)) (temp___is_init_403 Bool) (temp___skip_constant_404 Bool) (temp___do_toplevel_405 Bool) (temp___do_typ_inv_406 Bool)) Bool true)
(assert (forall ((v (_ BitVec 64))) (forall ((amount Int)) (! (=> (and (dynamic_invariant1 v true true true true) (dynamic_invariant amount true true true true)) (dynamic_invariant1 (shift_right v amount) true false true true)) :pattern ((shift_right v amount))))))
(assert (forall ((v (_ BitVec 64))) (forall ((amount Int)) (! (=> (and (dynamic_invariant1 v true true true true) (dynamic_invariant amount true true true true)) (= (shift_right v amount) (ite (and (<= 1 64) (<= 64 8)) ((_ zero_extend 56) (ite (< amount 8) (bvlshr ((_ extract 7 0) v) ((_ int2bv 8) amount)) #x00)) (ite (and (<= 9 64) (<= 64 16)) ((_ zero_extend 48) (ite (< amount 16) (bvlshr ((_ extract 15 0) v) ((_ int2bv 16) amount)) #x0000)) (ite (and (<= 17 64) (<= 64 32)) ((_ zero_extend 32) (bvlshr ((_ extract 31 0) v) ((_ int2bv 32) amount))) (bvlshr v ((_ int2bv 64) amount))))))) :pattern ((shift_right v amount))))))
...
(assert (forall ((v (_ BitVec 64))) (forall ((amount Int)) (! (=> (and (dynamic_invariant1 v true true true true) (dynamic_invariant amount true true true true)) (dynamic_invariant1 (shift_left v amount) true false true true)) :pattern ((shift_left v amount))))))
(assert (forall ((v (_ BitVec 64))) (forall ((amount Int)) (! (=> (and (dynamic_invariant1 v true true true true) (dynamic_invariant amount true true true true)) (= (shift_left v amount) (ite (and (<= 1 64) (<= 64 8)) ((_ zero_extend 56) (ite (< amount 8) (bvshl ((_ extract 7 0) v) ((_ int2bv 8) amount)) #x00)) (ite (and (<= 9 64) (<= 64 16)) ((_ zero_extend 48) (ite (< amount 16) (bvshl ((_ extract 15 0) v) ((_ int2bv 16) amount)) #x0000)) (ite (and (<= 17 64) (<= 64 32)) ((_ zero_extend 32) (bvshl ((_ extract 31 0) v) ((_ int2bv 32) amount))) (bvshl v ((_ int2bv 64) amount))))))) :pattern ((shift_left v amount))))))
...
(define-fun dynamic_invariant2 ((temp___expr_421 Int) (temp___is_init_417 Bool) (temp___skip_constant_418 Bool) (temp___do_toplevel_419 Bool) (temp___do_typ_inv_420 Bool)) Bool (=> (or (= temp___is_init_417 true) (<= 1 64)) (in_range1 temp___expr_421)))
...
(assert (forall ((num_bits Int)) (! (=> (dynamic_invariant2 num_bits true true true true) (= (make_mask num_bits) (shift_right #xFFFFFFFFFFFFFFFF (- 64 num_bits)))) :pattern ((make_mask num_bits)))))
...
(assert (forall ((i bit_position)) (and (<= 0 (bit_positionqtint i)) (<= (bit_positionqtint i) 63))))
...
(define-fun dynamic_invariant3 ((temp___expr_414 Int) (temp___is_init_410 Bool) (temp___skip_constant_411 Bool) (temp___do_toplevel_412 Bool) (temp___do_typ_inv_413 Bool)) Bool (=> (or (= temp___is_init_410 true) (<= 0 63)) (in_range2 temp___expr_414)))
(assert (forall ((value (_ BitVec 64))) (forall ((from Int) (to__ Int)) (! (=> (and (and (and (dynamic_invariant1 value true true true true) (dynamic_invariant3 from true true true true)) (dynamic_invariant3 to__ true true true true)) (<= from to__)) (let ((result (extract_bits_inline_always value from to__))) (and (and (= result (bvand (shift_right value from) (make_mask (+ (- to__ from) 1)))) (and (bvule result (make_mask (+ (- to__ from) 1))) (= (shift_left result from) (bvand value (shift_left (make_mask (+ (- to__ from) 1)) from))))) (dynamic_invariant1 result true false true true)))) :pattern ((extract_bits_inline_always value from to__))))))
...
(assert (forall ((value (_ BitVec 64))) (forall ((from Int) (to__ Int)) (! (=> (and (and (and (dynamic_invariant1 value true true true true) (dynamic_invariant3 from true true true true)) (dynamic_invariant3 to__ true true true true)) (<= from to__)) (let ((result (extract_bits_inline value from to__))) (and (and (= result (bvand (shift_right value from) (make_mask (+ (- to__ from) 1)))) (and (bvule result (make_mask (+ (- to__ from) 1))) (= (shift_left result from) (bvand value (shift_left (make_mask (+ (- to__ from) 1)) from))))) (dynamic_invariant1 result true false true true)))) :pattern ((extract_bits_inline value from to__))))))
(assert (forall ((value (_ BitVec 64))) (forall ((from Int) (to__ Int)) (! (=> (and (and (dynamic_invariant1 value true true true true) (dynamic_invariant3 from true true true true)) (dynamic_invariant3 to__ true true true true)) (= (extract_bits_inline value from to__) (extract_bits_inline_always value from to__))) :pattern ((extract_bits_inline value from to__))))))
...
(assert (forall ((value (_ BitVec 64))) (forall ((from Int) (to__ Int)) (! (=> (and (and (and (dynamic_invariant1 value true true true true) (dynamic_invariant3 from true true true true)) (dynamic_invariant3 to__ true true true true)) (<= from to__)) (let ((result (extract_bits_not_inline value from to__))) (and (and (= result (bvand (shift_right value from) (make_mask (+ (- to__ from) 1)))) (and (bvule result (make_mask (+ (- to__ from) 1))) (= (shift_left result from) (bvand value (shift_left (make_mask (+ (- to__ from) 1)) from))))) (dynamic_invariant1 result true false true true)))) :pattern ((extract_bits_not_inline value from to__))))))
(assert (forall ((value (_ BitVec 64))) (forall ((from Int) (to__ Int)) (! (=> (and (and (dynamic_invariant1 value true true true true) (dynamic_invariant3 from true true true true)) (dynamic_invariant3 to__ true true true true)) (= (extract_bits_not_inline value from to__) (extract_bits_inline_always value from to__))) :pattern ((extract_bits_not_inline value from to__))))))
...
(assert (and (= o6 (make_mask o5)) (= o6 (shift_right #xFFFFFFFFFFFFFFFF (- 64 o5)))))
(assert (and (= o7 (shift_right value from)) (= o7 (ite (and (<= 1 64) (<= 64 8)) ((_ zero_extend 56) (ite (< from 8) (bvlshr ((_ extract 7 0) value) ((_ int2bv 8) from)) #x00)) (ite (and (<= 9 64) (<= 64 16)) ((_ zero_extend 48) (ite (< from 16) (bvlshr ((_ extract 15 0) value) ((_ int2bv 16) from)) #x0000)) (ite (and (<= 17 64) (<= 64 32)) ((_ zero_extend 32) (bvlshr ((_ extract 31 0) value) ((_ int2bv 32) from))) (bvlshr value ((_ int2bv 64) from))))))))
...
(assert (and (= o4 (make_mask o3)) (= o4 (shift_right #xFFFFFFFFFFFFFFFF (- 64 o3)))))
