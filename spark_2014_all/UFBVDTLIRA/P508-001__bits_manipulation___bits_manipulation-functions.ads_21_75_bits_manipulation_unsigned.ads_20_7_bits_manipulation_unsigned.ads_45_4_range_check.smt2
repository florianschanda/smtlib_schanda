...
(define-fun dynamic_invariant ((temp___expr_351 (_ BitVec 64)) (temp___is_init_348 Bool) (temp___skip_constant_349 Bool) (temp___do_toplevel_350 Bool)) Bool true)
...
(define-fun dynamic_invariant1 ((temp___expr_357 Int) (temp___is_init_354 Bool) (temp___skip_constant_355 Bool) (temp___do_toplevel_356 Bool)) Bool (=> (or (= temp___is_init_354 true) (<= 0 63)) (in_range temp___expr_357)))
...
(assert (forall ((v (_ BitVec 64))) (forall ((amount Int)) (! (=> (and (dynamic_invariant v true true true) (dynamic_invariant2 amount true true true)) (dynamic_invariant (shift_right v amount) true false true)) :pattern ((shift_right v amount))))))
(assert (forall ((v (_ BitVec 64))) (forall ((amount Int)) (! (=> (and (dynamic_invariant v true true true) (dynamic_invariant2 amount true true true)) (= (shift_right v amount) (ite (and (<= 1 64) (<= 64 8)) ((_ zero_extend 56) (ite (< amount 8) (bvlshr ((_ extract 7 0) v) ((_ int2bv 8) amount)) ((_ int2bv 8) 0))) (ite (and (<= 9 64) (<= 64 16)) ((_ zero_extend 48) (ite (< amount 16) (bvlshr ((_ extract 15 0) v) ((_ int2bv 16) amount)) ((_ int2bv 16) 0))) (ite (and (<= 17 64) (<= 64 32)) ((_ zero_extend 32) (bvlshr ((_ extract 31 0) v) ((_ int2bv 32) amount))) (bvlshr v ((_ int2bv 64) amount))))))) :pattern ((shift_right v amount))))))
(declare-fun shift_left ((_ BitVec 64) Int) (_ BitVec 64))
(declare-fun shift_left__function_guard ((_ BitVec 64) (_ BitVec 64) Int) Bool)
(assert (forall ((v (_ BitVec 64))) (forall ((amount Int)) (! (=> (and (dynamic_invariant v true true true) (dynamic_invariant2 amount true true true)) (dynamic_invariant (shift_left v amount) true false true)) :pattern ((shift_left v amount))))))
(assert (forall ((v (_ BitVec 64))) (forall ((amount Int)) (! (=> (and (dynamic_invariant v true true true) (dynamic_invariant2 amount true true true)) (= (shift_left v amount) (ite (and (<= 1 64) (<= 64 8)) ((_ zero_extend 56) (ite (< amount 8) (bvshl ((_ extract 7 0) v) ((_ int2bv 8) amount)) ((_ int2bv 8) 0))) (ite (and (<= 9 64) (<= 64 16)) ((_ zero_extend 48) (ite (< amount 16) (bvshl ((_ extract 15 0) v) ((_ int2bv 16) amount)) ((_ int2bv 16) 0))) (ite (and (<= 17 64) (<= 64 32)) ((_ zero_extend 32) (bvshl ((_ extract 31 0) v) ((_ int2bv 32) amount))) (bvshl v ((_ int2bv 64) amount))))))) :pattern ((shift_left v amount))))))
(declare-fun make_mask (Int) (_ BitVec 64))
(declare-fun make_mask__function_guard ((_ BitVec 64) Int) Bool)
(define-fun dynamic_invariant3 ((temp___expr_363 Int) (temp___is_init_360 Bool) (temp___skip_constant_361 Bool) (temp___do_toplevel_362 Bool)) Bool (=> (or (= temp___is_init_360 true) (<= 1 64)) (in_range1 temp___expr_363)))
(assert (forall ((num_bits Int)) (! (=> (dynamic_invariant3 num_bits true true true) (dynamic_invariant (make_mask num_bits) true false true)) :pattern ((make_mask num_bits)))))
(assert (forall ((num_bits Int)) (! (=> (dynamic_invariant3 num_bits true true true) (= (make_mask num_bits) (shift_right ((_ int2bv 64) 18446744073709551615) (- 64 num_bits)))) :pattern ((make_mask num_bits)))))
...
(declare-fun extract_bits_inline_always ((_ BitVec 64) Int Int) (_ BitVec 64))
(declare-fun extract_bits_inline_always__function_guard ((_ BitVec 64) (_ BitVec 64) Int Int) Bool)
(assert (forall ((value1 (_ BitVec 64))) (forall ((from1 Int) (to__1 Int)) (! (=> (and (and (and (dynamic_invariant value1 true true true) (dynamic_invariant1 from1 true true true)) (dynamic_invariant1 to__1 true true true)) (<= from1 to__1)) (let ((result (extract_bits_inline_always value1 from1 to__1))) (and (and (= result (bvand (shift_right value1 from1) (make_mask (+ (- to__1 from1) 1)))) (and (bvule result (make_mask (+ (- to__1 from1) 1))) (= (shift_left result from1) (bvand value1 (shift_left (make_mask (+ (- to__1 from1) 1)) from1))))) (dynamic_invariant result true false true)))) :pattern ((extract_bits_inline_always value1 from1 to__1))))))
(declare-fun extract_bits_inline ((_ BitVec 64) Int Int) (_ BitVec 64))
(declare-fun extract_bits_inline__function_guard ((_ BitVec 64) (_ BitVec 64) Int Int) Bool)
(assert (forall ((value1 (_ BitVec 64))) (forall ((from1 Int) (to__1 Int)) (! (=> (and (and (and (dynamic_invariant value1 true true true) (dynamic_invariant1 from1 true true true)) (dynamic_invariant1 to__1 true true true)) (<= from1 to__1)) (let ((result (extract_bits_inline value1 from1 to__1))) (and (and (= result (bvand (shift_right value1 from1) (make_mask (+ (- to__1 from1) 1)))) (and (bvule result (make_mask (+ (- to__1 from1) 1))) (= (shift_left result from1) (bvand value1 (shift_left (make_mask (+ (- to__1 from1) 1)) from1))))) (dynamic_invariant result true false true)))) :pattern ((extract_bits_inline value1 from1 to__1))))))
(assert (forall ((value1 (_ BitVec 64))) (forall ((from1 Int) (to__1 Int)) (! (=> (and (and (dynamic_invariant value1 true true true) (dynamic_invariant1 from1 true true true)) (dynamic_invariant1 to__1 true true true)) (= (extract_bits_inline value1 from1 to__1) (extract_bits_inline_always value1 from1 to__1))) :pattern ((extract_bits_inline value1 from1 to__1))))))
(declare-fun extract_bits_not_inline ((_ BitVec 64) Int Int) (_ BitVec 64))
(declare-fun extract_bits_not_inline__function_guard ((_ BitVec 64) (_ BitVec 64) Int Int) Bool)
(assert (forall ((value1 (_ BitVec 64))) (forall ((from1 Int) (to__1 Int)) (! (=> (and (and (and (dynamic_invariant value1 true true true) (dynamic_invariant1 from1 true true true)) (dynamic_invariant1 to__1 true true true)) (<= from1 to__1)) (let ((result (extract_bits_not_inline value1 from1 to__1))) (and (and (= result (bvand (shift_right value1 from1) (make_mask (+ (- to__1 from1) 1)))) (and (bvule result (make_mask (+ (- to__1 from1) 1))) (= (shift_left result from1) (bvand value1 (shift_left (make_mask (+ (- to__1 from1) 1)) from1))))) (dynamic_invariant result true false true)))) :pattern ((extract_bits_not_inline value1 from1 to__1))))))
(assert (forall ((value1 (_ BitVec 64))) (forall ((from1 Int) (to__1 Int)) (! (=> (and (and (dynamic_invariant value1 true true true) (dynamic_invariant1 from1 true true true)) (dynamic_invariant1 to__1 true true true)) (= (extract_bits_not_inline value1 from1 to__1) (extract_bits_inline_always value1 from1 to__1))) :pattern ((extract_bits_not_inline value1 from1 to__1))))))
(declare-const attr__ATTRIBUTE_ADDRESS3 Int)
(declare-const result__ (_ BitVec 64))
(declare-const bits_manipulation_unsigned__unsigned_64__functions__extract_bits__result (_ BitVec 64))
...
(declare-const bits_manipulation_unsigned__unsigned_64__functions__extract_bits__result1 (_ BitVec 64))
(declare-const result__4 (_ BitVec 64))
(declare-const bits_manipulation_unsigned__unsigned_64__functions__extract_bits__result2 (_ BitVec 64))
(declare-const result__5 (_ BitVec 64))
(declare-const bits_manipulation_unsigned__unsigned_64__functions__extract_bits__result3 (_ BitVec 64))
(declare-const result__6 (_ BitVec 64))
(declare-const bits_manipulation_unsigned__unsigned_64__functions__extract_bits__result4 (_ BitVec 64))
(declare-const result__7 (_ BitVec 64))
(declare-const bits_manipulation_unsigned__unsigned_64__functions__extract_bits__result5 (_ BitVec 64))
...
(assert (<= from to__))
(assert (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits__result1 bits_manipulation_unsigned__unsigned_64__functions__extract_bits__result2))
(assert (= result__1 result__4))
(assert (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits__result3 bits_manipulation_unsigned__unsigned_64__functions__extract_bits__result1))
...
(assert (=> (= 2 0) (= (mk_t__ref result) (mk_t__ref result__))))
...
(assert (=> (not (= 2 0)) (=> (= 2 1) (= (mk_t__ref result1) (mk_t__ref result__)))))
...
(assert (=> (not (= 2 0)) (=> (not (= 2 1)) (= (mk_t__ref result2) (mk_t__ref result__)))))
(assert (=> (not (= 2 0)) (=> (not (= 2 1)) (= result__3 o2))))
(assert (=> (not (= 2 0)) (=> (not (= 2 1)) (= result__2 result__3))))
(assert (=> (not (= 2 0)) (= result__1 result__2)))
(assert (= (mk_t__ref result3) (mk_t__ref bits_manipulation_unsigned__unsigned_64__functions__extract_bits__result)))
(assert (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits__result1 result__1))
(assert (= (mk_t__ref bits_manipulation_unsigned__unsigned_64__functions__extract_bits__result4) (mk_t__ref bits_manipulation_unsigned__unsigned_64__functions__extract_bits__result2)))
(assert (= (mk_t__ref result__6) (mk_t__ref result__4)))
(assert (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits__result5 bits_manipulation_unsigned__unsigned_64__functions__extract_bits__result3))
(assert (= result__7 result__5))
(assert (and (= o6 (+ (- to__ from) 1)) (in_range1 (+ (- to__ from) 1))))
(assert (and (= o7 (make_mask o6)) (= o7 (shift_right ((_ int2bv 64) 18446744073709551615) (- 64 o6)))))
(assert (and (= o8 (shift_right value from)) (= o8 (ite (and (<= 1 64) (<= 64 8)) ((_ zero_extend 56) (ite (< from 8) (bvlshr ((_ extract 7 0) value) ((_ int2bv 8) from)) ((_ int2bv 8) 0))) (ite (and (<= 9 64) (<= 64 16)) ((_ zero_extend 48) (ite (< from 16) (bvlshr ((_ extract 15 0) value) ((_ int2bv 16) from)) ((_ int2bv 16) 0))) (ite (and (<= 17 64) (<= 64 32)) ((_ zero_extend 32) (bvlshr ((_ extract 31 0) value) ((_ int2bv 32) from))) (bvlshr value ((_ int2bv 64) from))))))))
(assert (= o9 (bvand o8 o7)))
(assert (= result4 (ite (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits__result4 o9) true false)))
(assert (= result4 true))
(assert (and (= o4 (+ (- to__ from) 1)) (in_range1 (+ (- to__ from) 1))))
(assert (and (= o5 (make_mask o4)) (= o5 (shift_right ((_ int2bv 64) 18446744073709551615) (- 64 o4)))))
(assert (= result5 (ite (bvule bits_manipulation_unsigned__unsigned_64__functions__extract_bits__result4 o5) true false)))
(assert (= result5 true))
