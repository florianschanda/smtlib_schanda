...
(assert (= result2 true))
(assert (and (= o4 (keys s1)) (and (and (and (and (= (length1 o4) (length3 s1)) (forall ((temp___431 Int)) (=> (and (in_range3 temp___431) (= (iter_has_element o4 temp___431) true)) (= (has_key (model__ s1) (get o4 temp___431)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ s1) key2) true)) (and (< 0 (find o4 key2)) (= (get o4 (find o4 key2)) key2))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length3 s1))) (= (find o4 (get o4 i1)) i1)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length3 s1))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length3 s1))) (=> (= (get o4 i1) (get o4 j)) (= i1 j)))))))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
