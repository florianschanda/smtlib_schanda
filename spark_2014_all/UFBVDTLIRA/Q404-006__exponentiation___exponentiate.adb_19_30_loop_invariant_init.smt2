...
(define-fun dynamic_invariant1 ((temp___expr_207 (_ BitVec 32)) (temp___is_init_203 Bool) (temp___skip_constant_204 Bool) (temp___do_toplevel_205 Bool) (temp___do_typ_inv_206 Bool)) Bool true)
...
(define-fun dynamic_invariant2 ((temp___expr_235 Int) (temp___is_init_231 Bool) (temp___skip_constant_232 Bool) (temp___do_toplevel_233 Bool) (temp___do_typ_inv_234 Bool)) Bool (=> (or (= temp___is_init_231 true) (<= 0 31)) (in_range1 temp___expr_235)))
(declare-const attr__ATTRIBUTE_ADDRESS5 Int)
(declare-fun pow21 (Int) (_ BitVec 32))
(declare-fun pow2__function_guard ((_ BitVec 32) Int) Bool)
(assert (forall ((i Int)) (! (=> (dynamic_invariant i true true true true) (dynamic_invariant1 (pow21 i) true false true true)) :pattern ((pow21 i)))))
(assert (forall ((i Int)) (! (=> (dynamic_invariant i true true true true) (= (pow21 i) (ite (< i 4294967296) (bvshl #x00000001 ((_ int2bv 32) i)) #x00000000))) :pattern ((pow21 i)))))
...
(assert (not (= cur_exp1 #x00000000)))
(assert (not (= cur_exp1 (bvudiv cur_exp1 (pow21 iter1)))))
(check-sat)
(exit)
