...
(assert (=> (= res true) (=> (and (bvule #x0000000000000000 n6) (bvule n6 (bvadd var1_range_size var2_range_size))) (= temp___245 n6))))
...
(assert (=> (not (= res true)) (=> (and (bvule #x0000000000000000 n112) (bvule n112 var1_range_size)) (= temp___242 n112))))
...
(assert (=> (not (= res true)) (=> (and (bvule #x0000000000000000 n112) (bvule n112 var1_range_size)) (=> (and (bvule #x0000000000000000 n213) (bvule n213 var2_range_size)) (= temp___239 n30)))))
(assert (=> (not (= res true)) (=> (and (bvule #x0000000000000000 n112) (bvule n112 var1_range_size)) (=> (and (bvule #x0000000000000000 n213) (bvule n213 var2_range_size)) (= temp___238 n213)))))
