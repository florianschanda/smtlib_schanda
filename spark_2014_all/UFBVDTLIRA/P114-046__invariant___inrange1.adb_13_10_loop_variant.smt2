...
(assert (= (= matched2 true) (and (bvugt i2 ((_ int2bv 64) 0)) (exists ((n (_ BitVec 64))) (and (and (bvule ((_ int2bv 64) 0) n) (bvule n (bvsub i2 ((_ int2bv 64) 1)))) (= var (bvadd bottom n)))))))
(assert (not (= matched2 true)))
(assert (and (bvult i2 range_size) (not (= matched2 true))))
(assert (= temp___2061 result2))
(assert (= temp___2062 i2))
...
(assert (not (bvugt i3 temp___2062)))
(check-sat)
(exit)
