...
(assert (and (and (= (contains (model__ (mk___rep s__split_discrs s__split_fields2)) 1) true) (= (element (mk___rep s__split_discrs s__split_fields2) (find1 (mk___rep s__split_discrs s__split_fields2) 1)) 1)) (ite (= (contains (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) 1) true) (and (and (= (oeq2 (model__ (mk___rep s__split_discrs s__split_fields2)) (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields)))) true) (= (oeq3 (positions (mk___rep s__split_discrs s__split_fields2)) (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields)))) true)) (= (equal_except (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (elements (mk___rep s__split_discrs s__split_fields2)) (get1 (positions (mk___rep s__split_discrs s__split_fields2)) (find1 (mk___rep s__split_discrs s__split_fields2) 1))) true)) (and (and (and (and (= (length (mk___rep s__split_discrs s__split_fields2)) (+ (length (mk___rep s__split_discrs (mk___split_fields s__split_fields))) 1)) (= (ole (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (model__ (mk___rep s__split_discrs s__split_fields2))) true)) (= (included_except (model__ (mk___rep s__split_discrs s__split_fields2)) (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) 1) true)) (= (mapping_preserved (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (elements (mk___rep s__split_discrs s__split_fields2)) (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (positions (mk___rep s__split_discrs s__split_fields2))) true)) (= (keys_included_except (positions (mk___rep s__split_discrs s__split_fields2)) (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (find1 (mk___rep s__split_discrs s__split_fields2) 1)) true)))))
(assert (not (or (< (length (mk___rep s__split_discrs s__split_fields2)) (to_rep1 (rec__use_sets__my_sets__set__capacity s__split_discrs))) (= (contains (model__ (mk___rep s__split_discrs s__split_fields2)) 2) true))))
(check-sat)
(exit)
