...
(assert (<= 0 n))
(assert (<= n 63))
(assert (and (= o (shift_right val__ n)) (= o (ite (and (<= 1 64) (<= 64 8)) ((_ zero_extend 56) (ite (< n 8) (bvlshr ((_ extract 7 0) val__) ((_ int2bv 8) n)) #x00)) (ite (and (<= 9 64) (<= 64 16)) ((_ zero_extend 48) (ite (< n 16) (bvlshr ((_ extract 15 0) val__) ((_ int2bv 16) n)) #x0000)) (ite (and (<= 17 64) (<= 64 32)) ((_ zero_extend 32) (bvlshr ((_ extract 31 0) val__) ((_ int2bv 32) n))) (bvlshr val__ ((_ int2bv 64) n))))))))
(assert (= result1 (ite (= o #x0000000000000001) true false)))
(assert (=> (= result1 true) (= (= result true) (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 n)) (bvuge (shift_right val__ j1) #x0000000000000001))))))
