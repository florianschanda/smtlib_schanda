...
(assert (not (= var (bvadd bottom i1))))
(assert (= matched2 matched1))
(assert (= i1 result3))
(assert (= i2 (bvadd i1 ((_ int2bv 64) 1))))
(assert (= (= matched3 true) (exists ((n (_ BitVec 64))) (and (and (bvule ((_ int2bv 64) 0) n) (bvule n (bvsub i3 ((_ int2bv 64) 1)))) (= var (bvadd bottom n))))))
(assert (not (= matched3 true)))
(assert true)
(assert (bvule ((_ int2bv 64) 0) (bvsub i3 ((_ int2bv 64) 1))))
