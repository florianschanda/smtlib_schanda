...
(assert (forall ((v (_ BitVec 32))) (forall ((amount Int)) (! (=> (and (dynamic_invariant v true true true true) (dynamic_invariant1 amount true true true true)) (dynamic_invariant (shift_right v amount) true false true true)) :pattern ((shift_right v amount))))))
(assert (forall ((v (_ BitVec 32))) (forall ((amount Int)) (! (=> (and (dynamic_invariant v true true true true) (dynamic_invariant1 amount true true true true)) (= (shift_right v amount) (ite (and (<= 1 32) (<= 32 8)) ((_ zero_extend 24) (ite (< amount 8) (bvlshr ((_ extract 7 0) v) ((_ int2bv 8) amount)) #x00)) (ite (and (<= 9 32) (<= 32 16)) ((_ zero_extend 16) (ite (< amount 16) (bvlshr ((_ extract 15 0) v) ((_ int2bv 16) amount)) #x0000)) (ite (and (<= 17 32) (<= 32 32)) (bvlshr v ((_ int2bv 32) amount)) ((_ extract 31 0) (bvlshr ((_ zero_extend 32) v) ((_ int2bv 64) amount)))))))) :pattern ((shift_right v amount))))))
...
(define-fun dynamic_invariant2 ((temp___expr_366 Int) (temp___is_init_362 Bool) (temp___skip_constant_363 Bool) (temp___do_toplevel_364 Bool) (temp___do_typ_inv_365 Bool)) Bool (=> (or (= temp___is_init_362 true) (<= 0 31)) (in_range1 temp___expr_366)))
(declare-fun msb_index_fast_inline_always ((_ BitVec 32)) Int)
(declare-fun msb_index_fast_inline_always__function_guard (Int (_ BitVec 32)) Bool)
(declare-const value (_ BitVec 32))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const bits_manipulation_unsigned__unsigned_32__functions__msb_index_fast_inline__result Int)
(declare-const o Int)
(declare-const result Int)
(declare-const bits_manipulation_unsigned__unsigned_32__functions__msb_index_fast_inline__result1 Int)
(declare-const bits_manipulation_unsigned__unsigned_32__functions__msb_index_fast_inline__result2 Int)
(declare-const bits_manipulation_unsigned__unsigned_32__functions__msb_index_fast_inline__result3 Int)
(declare-const bits_manipulation_unsigned__unsigned_32__functions__msb_index_fast_inline__result4 Int)
(declare-const bits_manipulation_unsigned__unsigned_32__functions__msb_index_fast_inline__result5 Int)
(declare-const result1 Int)
(assert (not (= value #x00000000)))
(assert (= bits_manipulation_unsigned__unsigned_32__functions__msb_index_fast_inline__result1 bits_manipulation_unsigned__unsigned_32__functions__msb_index_fast_inline__result2))
(assert (= bits_manipulation_unsigned__unsigned_32__functions__msb_index_fast_inline__result3 bits_manipulation_unsigned__unsigned_32__functions__msb_index_fast_inline__result1))
(assert (and (= o (msb_index_fast_inline_always value)) (and (in_range1 o) (= (shift_right value o) #x00000001))))
(assert (= result bits_manipulation_unsigned__unsigned_32__functions__msb_index_fast_inline__result))
(assert (= bits_manipulation_unsigned__unsigned_32__functions__msb_index_fast_inline__result1 o))
(assert (= (mk_int__ref bits_manipulation_unsigned__unsigned_32__functions__msb_index_fast_inline__result4) (mk_int__ref bits_manipulation_unsigned__unsigned_32__functions__msb_index_fast_inline__result2)))
(assert (= bits_manipulation_unsigned__unsigned_32__functions__msb_index_fast_inline__result5 bits_manipulation_unsigned__unsigned_32__functions__msb_index_fast_inline__result3))
(assert (= result1 bits_manipulation_unsigned__unsigned_32__functions__msb_index_fast_inline__result4))
(assert (not (= (shift_right value bits_manipulation_unsigned__unsigned_32__functions__msb_index_fast_inline__result4) #x00000001)))
(check-sat)
(exit)
