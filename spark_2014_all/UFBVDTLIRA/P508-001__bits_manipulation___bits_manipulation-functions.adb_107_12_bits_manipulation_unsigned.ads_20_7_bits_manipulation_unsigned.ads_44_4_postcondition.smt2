...
(assert (forall ((v (_ BitVec 32))) (forall ((amount Int)) (! (=> (and (dynamic_invariant v true true true) (dynamic_invariant1 amount true true true)) (dynamic_invariant (shift_right v amount) true false true)) :pattern ((shift_right v amount))))))
(assert (forall ((v (_ BitVec 32))) (forall ((amount Int)) (! (=> (and (dynamic_invariant v true true true) (dynamic_invariant1 amount true true true)) (= (shift_right v amount) (ite (and (<= 1 32) (<= 32 8)) ((_ zero_extend 24) (ite (< amount 8) (bvlshr ((_ extract 7 0) v) ((_ int2bv 8) amount)) ((_ int2bv 8) 0))) (ite (and (<= 9 32) (<= 32 16)) ((_ zero_extend 16) (ite (< amount 16) (bvlshr ((_ extract 15 0) v) ((_ int2bv 16) amount)) ((_ int2bv 16) 0))) (ite (and (<= 17 32) (<= 32 32)) (bvlshr v ((_ int2bv 32) amount)) ((_ extract 31 0) (bvlshr ((_ zero_extend 32) v) ((_ int2bv 64) amount)))))))) :pattern ((shift_right v amount))))))
...
(define-fun dynamic_invariant2 ((temp___expr_315 Int) (temp___is_init_312 Bool) (temp___skip_constant_313 Bool) (temp___do_toplevel_314 Bool)) Bool (=> (or (= temp___is_init_312 true) (<= 0 31)) (in_range1 temp___expr_315)))
...
(assert (and (= o (msb_index_fast_inline_always value)) (and (in_range1 o) (= (shift_right value o) ((_ int2bv 32) 1)))))
...
(assert (not (= (shift_right value bits_manipulation_unsigned__unsigned_32__functions__msb_index_fast_inline__result4) ((_ int2bv 32) 1))))
(check-sat)
(exit)
