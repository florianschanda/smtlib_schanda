...
(declare-const t3__mmin__result1 (_ BitVec 64))
(declare-const t3__mmin__result2 (_ BitVec 64))
(declare-const t3__mmin__result3 (_ BitVec 64))
(declare-const t3__mmin__result4 (_ BitVec 64))
(declare-const t3__mmin__result5 (_ BitVec 64))
...
(assert (= t3__mmin__result1 (bvurem (bvsub ((_ int2bv 64) 230) x) ((_ int2bv 64) 230))))
...
(assert (not (= t3__mmin__result4 (let ((temp___187 (bvadd (let ((temp___186 (bvsub ((_ int2bv 64) 229) x))) (ite (bvult ((_ int2bv 64) 229) x) (bvadd temp___186 ((_ int2bv 64) 230)) temp___186)) ((_ int2bv 64) 1)))) (ite (bvule (bvsub ((_ int2bv 64) 230) (let ((temp___186 (bvsub ((_ int2bv 64) 229) x))) (ite (bvult ((_ int2bv 64) 229) x) (bvadd temp___186 ((_ int2bv 64) 230)) temp___186))) ((_ int2bv 64) 1)) (bvsub temp___187 ((_ int2bv 64) 230)) temp___187)))))
(check-sat)
(exit)
