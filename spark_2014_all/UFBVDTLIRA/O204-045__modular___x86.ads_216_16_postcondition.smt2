...
(assert (= result rsp))
(assert (= rsp1 (bvor (bvand rsp ((_ int2bv 64) 18446744069414584320)) ((_ zero_extend 32) val__))))
(assert (= rsp1 rsp2))
(assert (= rsp3 rsp1))
(assert (not (= rsp2 (bvor (bvand rsp ((_ int2bv 64) 18446744069414584320)) ((_ zero_extend 32) val__)))))
(check-sat)
(exit)
