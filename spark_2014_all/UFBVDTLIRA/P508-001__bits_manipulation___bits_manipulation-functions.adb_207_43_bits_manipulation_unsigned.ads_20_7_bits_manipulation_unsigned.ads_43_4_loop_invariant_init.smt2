...
(assert (= result__2 o1))
(assert (not (= (bvand result__2 (let ((temp___432 (- i1 1))) (ite (< temp___432 65536) (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) temp___432)) ((_ int2bv 16) 0)))) (let ((temp___433 (- i1 1))) (ite (< temp___433 65536) (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) temp___433)) ((_ int2bv 16) 0))))))
(check-sat)
(exit)
