...
(assert (= result__2 o1))
(assert (not (= (bvand result__2 (let ((temp___492 (- i1 1))) (ite (< temp___492 65536) (bvshl #x0001 ((_ int2bv 16) temp___492)) #x0000))) (let ((temp___493 (- i1 1))) (ite (< temp___493 65536) (bvshl #x0001 ((_ int2bv 16) temp___493)) #x0000)))))
(check-sat)
(exit)
