...
(assert true)
(assert (= result r10))
(assert (= r101 (bvor (bvand r10 ((_ int2bv 64) 18446744073709551360)) ((_ zero_extend 56) val__))))
(assert (= r101 r102))
(assert (= r103 r101))
(assert (not (= r102 (bvor (bvand r10 ((_ int2bv 64) 18446744073709551360)) ((_ zero_extend 56) val__)))))
(check-sat)
(exit)
