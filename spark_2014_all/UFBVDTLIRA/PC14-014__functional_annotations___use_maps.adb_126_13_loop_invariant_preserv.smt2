...
(define-fun temp___913 () us_rep3 (keys (mk___rep s1__split_discrs s1__split_fields3)))
(declare-const temp___912 Int)
(assert (in_range5 temp___912))
(assert (= (iter_has_element temp___913 temp___912) true))
(assert (not (= (prop__ (get (model__ (mk___rep s1__split_discrs s1__split_fields3)) (get1 temp___913 temp___912))) true)))
(check-sat)
(exit)
