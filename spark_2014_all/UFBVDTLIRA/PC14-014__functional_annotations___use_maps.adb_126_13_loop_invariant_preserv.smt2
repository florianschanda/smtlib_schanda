...
(assert (= (iter_has_element (keys (mk___rep s1__split_discrs (mk___split_fields s1__split_fields3))) temp___912) true))
(assert (not (= (prop__ (get (model__ (mk___rep s1__split_discrs (mk___split_fields s1__split_fields3))) (get1 (keys (mk___rep s1__split_discrs (mk___split_fields s1__split_fields3))) temp___912))) true)))
(check-sat)
(exit)
