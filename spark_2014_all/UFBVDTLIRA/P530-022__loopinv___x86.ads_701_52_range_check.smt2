...
(assert true)
(assert true)
(assert (=> (bvugt val__ ((_ int2bv 16) 32767)) (= (mk_t__ref1 result) (mk_t__ref1 retval))))
(assert (=> (bvugt val__ ((_ int2bv 16) 32767)) (= retval1 (bvor ((_ int2bv 32) 4294901760) ((_ zero_extend 16) val__)))))
(assert (=> (not (bvugt val__ ((_ int2bv 16) 32767))) (= (mk_t__ref1 result1) (mk_t__ref1 retval))))
(assert (=> (not (bvugt val__ ((_ int2bv 16) 32767))) (= retval2 ((_ zero_extend 16) val__))))
...
(assert (not (bvule ((_ zero_extend 16) ((_ int2bv 16) 0)) (bvand x86__signextend16to32__result4 ((_ int2bv 32) 65535)))))
(check-sat)
(exit)
