...
(assert (forall ((regold (_ BitVec 64)) (regnew (_ BitVec 64))) (forall ((val__ (_ BitVec 8))) (! (=> (and (and (dynamic_invariant regold true true true true) (dynamic_invariant regnew true true true true)) (dynamic_invariant1 val__ true true true true)) (= (= (writereglow8post regold regnew val__) true) (and (= (readreglow8 regnew) val__) (= (bvand regnew #xFFFFFFFFFFFFFF00) (bvand regold #xFFFFFFFFFFFFFF00))))) :pattern ((writereglow8post regold regnew val__))))))
(assert (forall ((regold (_ BitVec 64)) (regnew (_ BitVec 64))) (forall ((val__ (_ BitVec 8))) (! (= (= (writereglow8post regold regnew val__) true) (and (= (readreglow8 regnew) val__) (= (bvand regnew #xFFFFFFFFFFFFFF00) (bvand regold #xFFFFFFFFFFFFFF00)))) :pattern ((writereglow8post regold regnew val__))))))
...
(assert (= result rdx))
(assert (= rdx1 (bvor (bvand rdx #xFFFFFFFFFFFFFF00) ((_ zero_extend 56) val__))))
(assert (= rdx1 rdx2))
(assert (= rdx3 rdx1))
