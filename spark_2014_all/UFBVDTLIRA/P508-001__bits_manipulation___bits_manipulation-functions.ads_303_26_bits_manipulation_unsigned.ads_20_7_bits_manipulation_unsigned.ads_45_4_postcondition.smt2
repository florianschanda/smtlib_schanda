...
(assert (and (and (= (lemma8 Tuple0) true) (and (= (make_mask 1) ((_ int2bv 64) 1)) (and (and (and (= (mk_int__ref result) (mk_int__ref i)) (= i1 2)) (ite (and (<= 2 i1) (<= i1 63)) (and (and (and (= temp___474 i1) (and (= (make_mask i1) (bvsub (ite (< i1 18446744073709551616) (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) i1)) ((_ int2bv 64) 0)) ((_ int2bv 64) 1))) (and (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- i2 1))) (= (make_mask j1) (bvsub (ite (< j1 18446744073709551616) (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) j1)) ((_ int2bv 64) 0)) ((_ int2bv 64) 1))))) (and (and (=> (<= 2 63) (in_range2 i2)) (and (<= 2 i2) (<= i2 63))) (= i2 63))))) (and (= i2 i6) (= i7 i2))) (and (= (mk_int__ref i8) (mk_int__ref i6)) (= i9 i7))) (and (= i1 i8) (= i9 i1)))) (and (forall ((size Int)) (=> (and (<= 1 size) (<= size 63)) (= (make_mask size) (bvsub (ite (< size 18446744073709551616) (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) size)) ((_ int2bv 64) 0)) ((_ int2bv 64) 1))))) (and (and (= bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__result1 bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__result2) (= bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__result3 bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__result1)) (and (= o3 (lemma2_goal Tuple0)) (and (= result2 bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__result) (= bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__result1 o3)))))))) (and (and (= (mk_bool__ref bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__result4) (mk_bool__ref bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__result2)) (= (mk_int__ref i10) (mk_int__ref i8))) (and (= bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__result5 bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__result3) (= i11 i9)))))
(assert (= result3 bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__result4))
