...
(assert (= i1 2))
(assert (=> (and (<= 2 i1) (<= i1 63)) (= temp___474 i1)))
(assert (=> (and (<= 2 i1) (<= i1 63)) (= (make_mask i1) (bvsub (ite (< i1 18446744073709551616) (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) i1)) ((_ int2bv 64) 0)) ((_ int2bv 64) 1)))))
(assert (=> (and (<= 2 i1) (<= i1 63)) (forall ((j Int)) (=> (and (<= 1 j) (<= j (- i2 1))) (= (make_mask j) (bvsub (ite (< j 18446744073709551616) (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) j)) ((_ int2bv 64) 0)) ((_ int2bv 64) 1)))))))
...
(assert (forall ((size Int)) (=> (and (<= 1 size) (<= size 63)) (= (make_mask size) (bvsub (ite (< size 18446744073709551616) (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) size)) ((_ int2bv 64) 0)) ((_ int2bv 64) 1))))))
(assert (= bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__result1 bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__result2))
(assert (= bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__result3 bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__result1))
(assert (= o (lemma2_goal Tuple0)))
(assert (= result1 bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__result))
(assert (= bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__result1 o))
(assert (= (mk_bool__ref bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__result4) (mk_bool__ref bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__result2)))
(assert (= (mk_int__ref i7) i9))
(assert (= bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__result5 bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__result3))
(assert (= i8 i6))
(assert (= result2 bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__result4))
(assert (= bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__result4 true))
