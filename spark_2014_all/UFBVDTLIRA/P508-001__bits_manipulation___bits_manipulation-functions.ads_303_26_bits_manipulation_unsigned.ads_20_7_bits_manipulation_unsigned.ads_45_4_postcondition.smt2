...
(assert (= i1 2))
(assert (=> (and (<= 2 i1) (<= i1 63)) (= temp___534 i1)))
...
(assert (forall ((size Int)) (=> (and (<= 1 size) (<= size 63)) (= (make_mask size) (bvsub (ite (< size 18446744073709551616) (bvshl #x0000000000000001 ((_ int2bv 64) size)) #x0000000000000000) #x0000000000000001)))))
