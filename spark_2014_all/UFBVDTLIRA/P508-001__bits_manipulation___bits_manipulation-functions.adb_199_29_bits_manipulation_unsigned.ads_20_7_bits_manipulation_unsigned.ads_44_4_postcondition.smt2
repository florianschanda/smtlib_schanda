...
(declare-const temp___519 (_ BitVec 32))
...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 amount)) (= temp___520 i1)))
(assert (=> (and (<= 1 i1) (<= i1 amount)) (= temp___519 result__1)))
...
(assert (=> (and (<= 1 i1) (<= i1 amount)) (= (bvand result__3 (let ((temp___523 (- i2 1))) (ite (< temp___523 4294967296) (bvshl #x00000001 ((_ int2bv 32) temp___523)) #x00000000))) (let ((temp___524 (- i2 1))) (ite (< temp___524 4294967296) (bvshl #x00000001 ((_ int2bv 32) temp___524)) #x00000000)))))
