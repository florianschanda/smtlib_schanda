...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 amount)) (= temp___458 i1)))
(assert (=> (and (<= 1 i1) (<= i1 amount)) (= temp___457 result__1)))
(assert (=> (and (<= 1 i1) (<= i1 amount)) (=> (< (- i1 1) 4294967296) (= o (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) (- i1 1)))))))
(assert (=> (and (<= 1 i1) (<= i1 amount)) (=> (not (< (- i1 1) 4294967296)) (= o ((_ int2bv 32) 0)))))
...
(assert (=> (and (<= 1 i1) (<= i1 amount)) (= (bvand result__3 (let ((temp___461 (- i2 1))) (ite (< temp___461 4294967296) (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) temp___461)) ((_ int2bv 32) 0)))) (let ((temp___462 (- i2 1))) (ite (< temp___462 4294967296) (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) temp___462)) ((_ int2bv 32) 0))))))
...
(assert (<= 1 i9))
(assert (<= i9 amount))
(assert (not (= (bvand bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma2__ones__result4 (let ((temp___469 (- i9 1))) (ite (< temp___469 4294967296) (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) temp___469)) ((_ int2bv 32) 0)))) (let ((temp___470 (- i9 1))) (ite (< temp___470 4294967296) (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) temp___470)) ((_ int2bv 32) 0))))))
(check-sat)
(exit)
