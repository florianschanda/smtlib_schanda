...
(assert (forall ((us_void_param tuple0)) (! (=> (= (axiom__ us_void_param) true) (forall ((v (_ BitVec 32))) (=> (and (bvule ((_ int2bv 32) 0) v) (bvule v ((_ int2bv 32) 4294967295))) (forall ((n Int)) (=> (and (<= 0 n) (<= n 31)) (=> (= (bvand v (ite (< n 4294967296) (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) n)) ((_ int2bv 32) 0))) ((_ int2bv 32) 0)) (= (bvand (bvadd v (ite (< n 4294967296) (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) n)) ((_ int2bv 32) 0))) (ite (< n 4294967296) (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) n)) ((_ int2bv 32) 0))) (ite (< n 4294967296) (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) n)) ((_ int2bv 32) 0))))))))) :pattern ((axiom__ us_void_param)))))
...
(declare-const temp___457 (_ BitVec 32))
...
(declare-const result__10 (_ BitVec 32))
...
(declare-const result__12 (_ BitVec 32))
...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 amount)) (and (and (= temp___458 i1) (and (= temp___457 result__1) (and (and (and (ite (< (- i1 1) 4294967296) (= o (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) (- i1 1)))) (= o ((_ int2bv 32) 0))) (= o1 (bvadd result__1 o))) (and (= result__1 result2) (= result__2 o1))) (and (= (bvand result__3 (let ((temp___461 (- i2 1))) (ite (< temp___461 4294967296) (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) temp___461)) ((_ int2bv 32) 0)))) (let ((temp___462 (- i2 1))) (ite (< temp___462 4294967296) (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) temp___462)) ((_ int2bv 32) 0)))) (and (and (=> (<= 1 amount) (dynamic_property 1 amount i2)) (and (<= 1 i2) (<= i2 amount))) (= i2 amount)))))) (and (and (= i2 i6) (= result__3 result__7)) (and (= i7 i2) (= result__8 result__3))))))
...
(assert (= result5 bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma2__ones__result))
(assert (= bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma2__ones__result1 result__9))
...
(assert (= result6 bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma2__ones__result4))
(declare-const i12 Int)
(assert (<= 1 i12))
(assert (<= i12 amount))
(assert (not (= (bvand bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma2__ones__result4 (let ((temp___469 (- i12 1))) (ite (< temp___469 4294967296) (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) temp___469)) ((_ int2bv 32) 0)))) (let ((temp___470 (- i12 1))) (ite (< temp___470 4294967296) (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) temp___470)) ((_ int2bv 32) 0))))))
(check-sat)
(exit)
