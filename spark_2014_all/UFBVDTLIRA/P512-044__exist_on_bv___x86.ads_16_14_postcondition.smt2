...
(declare-const x86__inrange64__result Bool)
(declare-const o Bool)
(declare-const result Bool)
(declare-const x86__inrange64__result1 Bool)
(declare-const x86__inrange64__result2 Bool)
(declare-const x86__inrange64__result3 Bool)
(declare-const x86__inrange64__result4 Bool)
(declare-const x86__inrange64__result5 Bool)
...
(assert (=> (bvule bottom (bvsub ((_ int2bv 64) 18446744073709551615) range_size)) (= o (ite (bvule bottom var) (ite (bvule var (bvadd bottom range_size)) true false) false))))
(assert (=> (not (bvule bottom (bvsub ((_ int2bv 64) 18446744073709551615) range_size))) (= o (ite (= (ite (bvule bottom var) (of_int 1) false) false) (ite (bvule var (bvsub (bvsub range_size (bvsub ((_ int2bv 64) 18446744073709551615) bottom)) ((_ int2bv 64) 1))) true false) true))))
...
(assert (not (exists ((n (_ BitVec 64))) (and (and (bvule ((_ int2bv 64) 0) n) (bvule n range_size)) (= var (bvadd bottom n))))))
(check-sat)
(exit)
