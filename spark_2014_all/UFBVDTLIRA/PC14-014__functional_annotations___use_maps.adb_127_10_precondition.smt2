...
(assert (not (or (< (length (mk___rep s1__split_discrs s1__split_fields2)) (to_rep (rec__use_maps__my_maps__map__capacity s1__split_discrs))) (= (has_key (model__ (mk___rep s1__split_discrs s1__split_fields2)) o) true))))
(check-sat)
(exit)
