...
(assert (= result rbp))
(assert (= rbp1 (bvor (bvand rbp ((_ int2bv 64) 18446744073709486080)) ((_ zero_extend 48) val__))))
(assert (= rbp1 rbp2))
(assert (= rbp3 rbp1))
(assert (not (= rbp2 (bvor (bvand rbp ((_ int2bv 64) 18446744073709486080)) ((_ zero_extend 48) val__)))))
(check-sat)
(exit)
