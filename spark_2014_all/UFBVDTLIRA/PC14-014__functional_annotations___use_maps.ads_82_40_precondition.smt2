...
(assert (=> (= result3 true) (and (= s1__split_discrs (mk___split_discrs temp___906 temp___9061)) (= s1__split_fields temp___9062))))
(assert (=> (= result3 true) (= temp___907 (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))))))
(assert (=> (= result3 true) (= temp___905 cu__split_fields1)))
(assert (=> (= result3 true) (< (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields2))) (+ temp___907 (get2 (positions s2) (mk___rep1 (mk___split_fields1 cu__split_fields2)))))))
(assert (=> (= result3 true) (let ((temp___913 (keys (mk___rep s1__split_discrs (mk___split_fields s1__split_fields2))))) (forall ((temp___912 Int)) (=> (and (in_range5 temp___912) (= (iter_has_element temp___913 temp___912) true)) (= (prop__ (get (model__ (mk___rep s1__split_discrs (mk___split_fields s1__split_fields2))) (get1 temp___913 temp___912))) true))))))
...
(assert (=> (= result3 true) (= cu__split_fields3 (mk___split_fields1 temp___904))))
...
(assert (and (= o23 (iter_has_element temp___917 temp___916)) (= (= o23 true) (and (<= 1 temp___916) (<= temp___916 (last temp___917))))))
(assert (= (= o24 true) (in_range5 temp___916)))
(assert (= result7 (ite (= o24 true) o23 false)))
(assert (= result7 true))
(assert (and (= k3 (get1 temp___917 temp___916)) (in_range6 k3)))
(assert (not (= (has_key (model__ (mk___rep s1__split_discrs (us_split_fields__content s1__split_fields8))) k3) true)))
(check-sat)
(exit)
