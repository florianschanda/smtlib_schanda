...
(assert (=> (= result1 true) (and (= s1__split_discrs (mk___split_discrs temp___906 temp___9061)) (= s1__split_fields temp___9062))))
(assert (=> (= result1 true) (= temp___907 (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))))))
(assert (=> (= result1 true) (= temp___905 cu__split_fields1)))
(assert (=> (= result1 true) (< (length (mk___rep s1__split_discrs s1__split_fields11)) (+ temp___907 (get2 (positions s2) (mk___rep1 cu__split_fields10))))))
(assert (=> (= result1 true) (let ((temp___913 (keys (mk___rep s1__split_discrs s1__split_fields11)))) (forall ((temp___912 Int)) (=> (and (in_range5 temp___912) (= (iter_has_element temp___913 temp___912) true)) (= (prop__ (get (model__ (mk___rep s1__split_discrs s1__split_fields11)) (get1 temp___913 temp___912))) true))))))
...
(assert (=> (= result1 true) (and (= temp___9041 (next s2 (mk___rep1 cu__split_fields10))) (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields10) no_element) false) (= (get2 (positions s2) (mk___rep1 cu__split_fields10)) (length s2)) true) true) (= (bool_eq1 temp___9041 no_element) true) (and (= (has_key1 (positions s2) temp___9041) true) (= (get2 (positions s2) temp___9041) (+ (get2 (positions s2) (mk___rep1 cu__split_fields10)) 1)))))))
(assert (=> (= result1 true) (= result2 cu__split_fields2)))
(assert (=> (= result1 true) (= cu__split_fields3 (mk___split_fields1 temp___904))))
...
(assert (and (= temp___917 (keys (mk___rep s1__split_discrs (us_split_fields__content s1__split_fields8)))) (and (and (and (and (= (length3 temp___917) (length (mk___rep s1__split_discrs (us_split_fields__content s1__split_fields8)))) (forall ((temp___431 Int)) (=> (and (in_range5 temp___431) (= (iter_has_element temp___917 temp___431) true)) (= (has_key (model__ (mk___rep s1__split_discrs (us_split_fields__content s1__split_fields8))) (get1 temp___917 temp___431)) true)))) (forall ((key2 Int)) (=> (and (in_range3 key2) (= (has_key (model__ (mk___rep s1__split_discrs (us_split_fields__content s1__split_fields8))) key2) true)) (and (< 0 (find temp___917 key2)) (= (get1 temp___917 (find temp___917 key2)) key2))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep s1__split_discrs (us_split_fields__content s1__split_fields8))))) (= (find temp___917 (get1 temp___917 i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep s1__split_discrs (us_split_fields__content s1__split_fields8))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (mk___rep s1__split_discrs (us_split_fields__content s1__split_fields8))))) (=> (= (get1 temp___917 i) (get1 temp___917 j)) (= i j)))))))))
(assert (and (= o3 (iter_has_element temp___917 temp___916)) (= (= o3 true) (and (<= 1 temp___916) (<= temp___916 (last temp___917))))))
