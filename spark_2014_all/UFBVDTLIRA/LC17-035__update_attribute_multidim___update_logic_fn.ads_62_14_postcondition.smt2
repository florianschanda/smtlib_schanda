...
(define-fun dynamic_invariant1 ((temp___expr_149 Int) (temp___is_init_146 Bool) (temp___skip_constant_147 Bool) (temp___do_toplevel_148 Bool)) Bool (=> (or (= temp___is_init_146 true) (<= 1 10)) (in_range1 temp___expr_149)))
(declare-sort m 0)
...
(define-fun dynamic_invariant2 ((temp___expr_155 (_ BitVec 8)) (temp___is_init_152 Bool) (temp___skip_constant_153 Bool) (temp___do_toplevel_154 Bool)) Bool (=> (or (= temp___is_init_152 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 7))) (in_range2 temp___expr_155)))
(declare-sort e 0)
...
(define-fun dynamic_invariant3 ((temp___expr_161 Int) (temp___is_init_158 Bool) (temp___skip_constant_159 Bool) (temp___do_toplevel_160 Bool)) Bool (=> (or (= temp___is_init_158 true) (<= 0 2)) (in_range3 temp___expr_161)))
(declare-sort map1 0)
...
(declare-fun temp___230 (map1 Int (_ BitVec 8) Int Int Int (_ BitVec 8) Int Int) map1)
(assert (forall ((temp___232 map1)) (forall ((temp___233 Int) (temp___235 Int) (temp___236 Int) (temp___237 Int) (temp___239 Int) (temp___240 Int)) (forall ((temp___234 (_ BitVec 8)) (temp___238 (_ BitVec 8))) (let ((temp___231 (temp___230 temp___232 temp___233 temp___234 temp___235 temp___236 temp___237 temp___238 temp___239 temp___240))) (forall ((temp___241 Int) (temp___243 Int)) (forall ((temp___242 (_ BitVec 8))) (ite (and (and (= temp___241 temp___237) (= temp___242 temp___238)) (= temp___243 temp___239)) (= (get temp___231 temp___241 temp___242 temp___243) (of_rep temp___240)) (ite (and (and (= temp___241 temp___233) (= temp___242 temp___234)) (= temp___243 temp___235)) (= (get temp___231 temp___241 temp___242 temp___243) (of_rep temp___236)) (= (get temp___231 temp___241 temp___242 temp___243) (get temp___232 temp___241 temp___242 temp___243)))))))))))
(declare-fun temp___244 (Int) map1)
(assert (forall ((temp___246 Int)) (forall ((temp___247 Int) (temp___249 Int)) (forall ((temp___248 (_ BitVec 8))) (= (get (temp___244 temp___246) temp___247 temp___248 temp___249) (of_rep temp___246))))))
...
(assert (= a3 a4))
(assert (= a5 a3))
(assert (not (= (bool_eq a4 1 10 ((_ int2bv 8) 0) ((_ int2bv 8) 7) 0 2 (temp___230 (temp___244 1000) 5 ((_ int2bv 8) 7) 1 v1 x y z v2) 1 10 ((_ int2bv 8) 0) ((_ int2bv 8) 7) 0 2) true)))
(check-sat)
(exit)
