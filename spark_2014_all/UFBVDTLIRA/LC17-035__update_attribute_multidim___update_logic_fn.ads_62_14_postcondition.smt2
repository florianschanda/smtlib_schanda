...
(declare-fun temp_____aggregate_def_257 (map1 Int (_ BitVec 8) Int Int Int (_ BitVec 8) Int Int) map1)
(declare-fun temp_____aggregate_def_271 (Int) map1)
...
(assert (= a3 a4))
(assert (= a5 a3))
(assert (not (= (bool_eq a4 1 10 #x00 #x07 0 2 (temp_____aggregate_def_257 (temp_____aggregate_def_271 1000) 5 #x07 1 v1 x y z v2) 1 10 #x00 #x07 0 2) true)))
(check-sat)
(exit)
