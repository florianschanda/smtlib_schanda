...
(define-fun dynamic_invariant1 ((temp___expr_172 Int) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool) (temp___do_typ_inv_171 Bool)) Bool (=> (or (= temp___is_init_168 true) (<= 1 10)) (in_range1 temp___expr_172)))
(declare-sort m 0)
...
(define-fun dynamic_invariant2 ((temp___expr_179 (_ BitVec 8)) (temp___is_init_175 Bool) (temp___skip_constant_176 Bool) (temp___do_toplevel_177 Bool) (temp___do_typ_inv_178 Bool)) Bool (=> (or (= temp___is_init_175 true) (bvule #x00 #x07)) (in_range2 temp___expr_179)))
(declare-sort e 0)
...
(define-fun dynamic_invariant3 ((temp___expr_186 Int) (temp___is_init_182 Bool) (temp___skip_constant_183 Bool) (temp___do_toplevel_184 Bool) (temp___do_typ_inv_185 Bool)) Bool (=> (or (= temp___is_init_182 true) (<= 0 2)) (in_range3 temp___expr_186)))
(declare-sort map1 0)
...
(declare-fun temp___257 (map1 Int (_ BitVec 8) Int Int Int (_ BitVec 8) Int Int) map1)
(declare-fun temp___271 (Int) map1)
(assert (= a_3d_arr (update_logic_fn__a_3d_arr__aggregate_def 1000)))
(assert (forall ((temp___164 Int)) (=> (dynamic_invariant temp___164 true true true true) (forall ((temp___165 Int) (temp___167 Int)) (forall ((temp___166 (_ BitVec 8))) (= (to_rep (get (update_logic_fn__a_3d_arr__aggregate_def temp___164) temp___165 temp___166 temp___167)) temp___164))))))
(assert (forall ((temp___273 Int)) (=> (dynamic_invariant temp___273 true true true true) (forall ((temp___274 Int) (temp___276 Int)) (forall ((temp___275 (_ BitVec 8))) (= (to_rep (get (temp___271 temp___273) temp___274 temp___275 temp___276)) temp___273))))))
(assert (forall ((temp___259 map1)) (forall ((temp___260 Int) (temp___262 Int) (temp___263 Int) (temp___264 Int) (temp___266 Int) (temp___267 Int)) (forall ((temp___261 (_ BitVec 8)) (temp___265 (_ BitVec 8))) (let ((temp___258 (temp___257 temp___259 temp___260 temp___261 temp___262 temp___263 temp___264 temp___265 temp___266 temp___267))) (=> (and (and (and (and (and (and (and (dynamic_invariant1 temp___260 true true true true) (dynamic_invariant2 temp___261 true true true true)) (dynamic_invariant3 temp___262 true true true true)) (dynamic_invariant temp___263 true true true true)) (dynamic_invariant1 temp___264 true true true true)) (dynamic_invariant2 temp___265 true true true true)) (dynamic_invariant3 temp___266 true true true true)) (dynamic_invariant temp___267 true true true true)) (forall ((temp___268 Int) (temp___270 Int)) (forall ((temp___269 (_ BitVec 8))) (ite (and (and (= temp___268 temp___264) (= temp___269 temp___265)) (= temp___270 temp___266)) (= (to_rep (get temp___258 temp___268 temp___269 temp___270)) temp___267) (ite (and (and (= temp___268 temp___260) (= temp___269 temp___261)) (= temp___270 temp___262)) (= (to_rep (get temp___258 temp___268 temp___269 temp___270)) temp___263) (= (get temp___258 temp___268 temp___269 temp___270) (get temp___259 temp___268 temp___269 temp___270))))))))))))
...
(assert (= a3 a4))
(assert (= a5 a3))
(assert (not (= (bool_eq a4 1 10 #x00 #x07 0 2 (temp___257 (temp___271 1000) 5 #x07 1 v1 x y z v2) 1 10 #x00 #x07 0 2) true)))
(check-sat)
(exit)
