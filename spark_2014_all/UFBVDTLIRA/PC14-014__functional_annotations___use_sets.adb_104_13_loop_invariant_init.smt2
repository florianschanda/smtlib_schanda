...
(assert (= result1 true))
(define-fun temp___963 () us_rep3 (elements (mk___rep s2__split_discrs s2__split_fields2)))
(declare-const temp___962 Int)
(assert (in_range3 temp___962))
(assert (= (iter_has_element temp___963 temp___962) true))
(assert (not (exists ((i Int)) (and (and (<= 1 i) (<= i (length (mk___rep s2__split_discrs s2__split_fields2)))) (= (get (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) i) (get temp___963 temp___962))))))
(check-sat)
(exit)
