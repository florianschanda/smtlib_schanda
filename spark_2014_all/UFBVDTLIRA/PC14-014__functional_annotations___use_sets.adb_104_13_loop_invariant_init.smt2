...
(assert (= (iter_has_element (elements (mk___rep s2__split_discrs (mk___split_fields s2__split_fields1))) temp___962) true))
(assert (not (exists ((i2 Int)) (and (and (<= 1 i2) (<= i2 (length (mk___rep s2__split_discrs (mk___split_fields s2__split_fields1))))) (= (get (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) i2) (get (elements (mk___rep s2__split_discrs (mk___split_fields s2__split_fields1))) temp___962))))))
(check-sat)
(exit)
