...
(assert (= m2 (let ((temp___272 (bv2nat (bvsub #x0000000000000020 (bvmul #x0000000000000002 i3))))) (ite (< temp___272 18446744073709551616) (bvshl #x0000000000000001 ((_ int2bv 64) temp___272)) #x0000000000000000))))
(assert (= (bvurem y4 m2) #x0000000000000000))
(assert (bvult left_y2 (let ((temp___274 (bv2nat i3))) (ite (< temp___274 18446744073709551616) (bvshl #x0000000000000001 ((_ int2bv 64) temp___274)) #x0000000000000000))))
...
(assert (bvugt (bvmul (bvadd left_y2 #x0000000000000001) (bvadd left_y2 #x0000000000000001)) left_x2))
...
(assert (= result15 (mk_t__ref b2)))
(assert (= b3 (bvor y4 m3)))
(assert (= result16 (mk_t__ref y4)))
(assert (= y5 (bvudiv y4 #x0000000000000002)))
(assert (=> (bvuge ux3 b3) (= result17 (mk_t__ref ux3))))
(assert (=> (bvuge ux3 b3) (= ux4 (bvsub ux3 b3))))
(assert (=> (bvuge ux3 b3) (= result18 (mk_t__ref y5))))
(assert (=> (bvuge ux3 b3) (= y6 (bvor y5 m3))))
(assert (=> (not (bvuge ux3 b3)) (= y6 y5)))
(assert (=> (not (bvuge ux3 b3)) (= ux4 ux3)))
(assert (= o13 (bvsub #x0000000000000020 (bvmul #x0000000000000002 i4))))
(assert (= result19 (mk_t__ref bits2)))
(assert (= bits3 o13))
(assert (and (= o14 (bv2nat bits3)) (in_range1 (bv2nat bits3))))
(assert (= o15 ((_ int2bv 64) o14)))
(assert (= o16 (bvlshr ((_ int2bv 64) x) o15)))
(assert (= o17 o16))
(assert (= result20 (mk_t__ref left_x2)))
(assert (= left_x3 o17))
(assert (and (= o18 (bv2nat bits3)) (in_range1 (bv2nat bits3))))
(assert (= o19 ((_ int2bv 64) o18)))
(assert (= o20 (bvlshr y6 o19)))
(assert (= o21 o20))
(assert (= result21 (mk_t__ref left_y2)))
(assert (= left_y3 o21))
(assert (and (= o22 (bv2nat bits3)) (in_range1 (bv2nat bits3))))
(assert (= o23 ((_ int2bv 64) o22)))
(assert (= o24 (bvlshr ux4 o23)))
(assert (= o25 o24))
(assert (= result22 (mk_t__ref left_ux2)))
(assert (= left_ux3 o25))
(assert (not (bvult left_y3 (let ((temp___274 (bv2nat i4))) (ite (< temp___274 18446744073709551616) (bvshl #x0000000000000001 ((_ int2bv 64) temp___274)) #x0000000000000000)))))
(check-sat)
(exit)
