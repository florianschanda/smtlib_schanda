...
(assert (= left_ux4 o25))
(assert true)
(assert (not (= m3 (let ((temp___235 (bv2nat (bvsub ((_ int2bv 64) 32) (bvmul ((_ int2bv 64) 2) i4))))) (ite (< temp___235 18446744073709551616) (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) temp___235)) ((_ int2bv 64) 0))))))
(check-sat)
(exit)
