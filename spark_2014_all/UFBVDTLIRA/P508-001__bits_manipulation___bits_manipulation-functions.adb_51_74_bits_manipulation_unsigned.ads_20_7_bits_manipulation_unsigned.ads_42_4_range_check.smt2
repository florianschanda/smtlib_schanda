...
(assert (= result1 (ite (= bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline__result4 o7) true false)))
(assert (= result1 true))
(assert (and (= o2 (+ (- to__ from) 1)) (in_range1 (+ (- to__ from) 1))))
(assert (and (= o3 (make_mask o2)) (= o3 (shift_right ((_ int2bv 8) 255) (- 8 o2)))))
(assert (= result2 (ite (bvule bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline__result4 o3) true false)))
(assert (= result2 true))
