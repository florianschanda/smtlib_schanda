...
(assert (and (= temp___909 (keys (mk___rep s1__split_discrs s1__split_fields2))) (and (and (and (and (= (length3 temp___909) (length (mk___rep s1__split_discrs s1__split_fields2))) (forall ((temp___431 Int)) (=> (and (in_range5 temp___431) (= (iter_has_element temp___909 temp___431) true)) (= (has_key (model__ (mk___rep s1__split_discrs s1__split_fields2)) (get1 temp___909 temp___431)) true)))) (forall ((key2 Int)) (=> (and (in_range3 key2) (= (has_key (model__ (mk___rep s1__split_discrs s1__split_fields2)) key2) true)) (and (< 0 (find temp___909 key2)) (= (get1 temp___909 (find temp___909 key2)) key2))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep s1__split_discrs s1__split_fields2)))) (= (find temp___909 (get1 temp___909 i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep s1__split_discrs s1__split_fields2)))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (mk___rep s1__split_discrs s1__split_fields2)))) (=> (= (get1 temp___909 i) (get1 temp___909 j)) (= i j)))))))))
