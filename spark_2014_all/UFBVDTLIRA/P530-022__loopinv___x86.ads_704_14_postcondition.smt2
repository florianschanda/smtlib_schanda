...
(assert (=> (bvugt val__ #x7FFFFFFF) (= (mk_t__ref1 result) retval5)))
(assert (=> (bvugt val__ #x7FFFFFFF) (= retval1 (bvor #xFFFFFFFF00000000 ((_ zero_extend 32) val__)))))
(assert (=> (not (bvugt val__ #x7FFFFFFF)) (= (mk_t__ref1 result1) retval5)))
(assert (=> (not (bvugt val__ #x7FFFFFFF)) (= retval2 ((_ zero_extend 32) val__))))
(assert (=> (not (bvugt val__ #x7FFFFFFF)) (= retval1 retval2)))
...
(assert (not (bvugt val__ #x7FFFFFFF)))
(assert (not (= x86__signextend32to64__result4 ((_ zero_extend 32) val__))))
(check-sat)
(exit)
