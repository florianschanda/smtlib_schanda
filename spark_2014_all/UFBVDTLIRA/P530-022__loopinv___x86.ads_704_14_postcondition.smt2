...
(assert true)
(assert true)
(assert (=> (bvugt val__ ((_ int2bv 32) 2147483647)) (= (mk_t__ref1 result) (mk_t__ref1 retval))))
(assert (=> (bvugt val__ ((_ int2bv 32) 2147483647)) (= retval1 (bvor ((_ int2bv 64) 18446744069414584320) ((_ zero_extend 32) val__)))))
(assert (=> (not (bvugt val__ ((_ int2bv 32) 2147483647))) (= (mk_t__ref1 result1) (mk_t__ref1 retval))))
(assert (=> (not (bvugt val__ ((_ int2bv 32) 2147483647))) (= retval2 ((_ zero_extend 32) val__))))
(assert (=> (not (bvugt val__ ((_ int2bv 32) 2147483647))) (= retval1 retval2)))
...
(assert (= (mk_t__ref1 result2) (mk_t__ref1 x86__signextend32to64__result)))
(assert (= x86__signextend32to64__result1 retval1))
(assert (= (mk_t__ref1 x86__signextend32to64__result4) (mk_t__ref1 x86__signextend32to64__result2)))
(assert (= retval1 retval3))
(assert (= x86__signextend32to64__result5 x86__signextend32to64__result3))
(assert (= retval4 retval1))
(assert (= result3 x86__signextend32to64__result4))
(assert (bvugt val__ ((_ int2bv 32) 2147483647)))
(assert (not (= x86__signextend32to64__result4 (bvor ((_ int2bv 64) 18446744069414584320) ((_ zero_extend 32) val__)))))
(check-sat)
(exit)
