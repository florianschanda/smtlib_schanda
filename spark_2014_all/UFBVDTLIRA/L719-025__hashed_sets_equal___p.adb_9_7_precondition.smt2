...
(assert (and (and (and (= (contains (model__ (mk___rep l__split_discrs l__split_fields2)) e) true) (= (has_key (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 cu__split_fields1)) true)) (= (my_eq (element (mk___rep l__split_discrs l__split_fields2) (mk___rep1 cu__split_fields1)) e) true)) (ite (= (contains (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) e) true) (and (and (and (not (= i true)) (= (oeq1 (model__ (mk___rep l__split_discrs l__split_fields2)) (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true)) (= (oeq2 (elements (mk___rep l__split_discrs l__split_fields2)) (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true)) (= (oeq3 (positions (mk___rep l__split_discrs l__split_fields2)) (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true)) (and (and (and (and (and (and (= i true) (= (length (mk___rep l__split_discrs l__split_fields2)) (+ (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 1))) (= (element (mk___rep l__split_discrs l__split_fields2) (mk___rep1 cu__split_fields1)) e)) (= (ole (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (model__ (mk___rep l__split_discrs l__split_fields2))) true)) (= (included_except (model__ (mk___rep l__split_discrs l__split_fields2)) (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) e) true)) (= (mapping_preserved (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (elements (mk___rep l__split_discrs l__split_fields2)) (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (positions (mk___rep l__split_discrs l__split_fields2))) true)) (= (keys_included_except (positions (mk___rep l__split_discrs l__split_fields2)) (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 cu__split_fields1)) true)))))
(assert (= i true))
