...
(define-fun dynamic_invariant ((temp___expr_267 (_ BitVec 16)) (temp___is_init_264 Bool) (temp___skip_constant_265 Bool) (temp___do_toplevel_266 Bool)) Bool true)
(declare-sort bit_position 0)
(define-fun in_range ((x Int)) Bool (and (<= 0 x) (<= x 15)))
...
(define-fun dynamic_invariant1 ((temp___expr_273 Int) (temp___is_init_270 Bool) (temp___skip_constant_271 Bool) (temp___do_toplevel_272 Bool)) Bool (=> (or (= temp___is_init_270 true) (<= 0 15)) (in_range temp___expr_273)))
...
(assert (forall ((v (_ BitVec 16))) (forall ((amount Int)) (! (=> (and (dynamic_invariant v true true true) (dynamic_invariant2 amount true true true)) (dynamic_invariant (shift_right v amount) true false true)) :pattern ((shift_right v amount))))))
(assert (forall ((v (_ BitVec 16))) (forall ((amount Int)) (! (=> (and (dynamic_invariant v true true true) (dynamic_invariant2 amount true true true)) (= (shift_right v amount) (ite (and (<= 1 16) (<= 16 8)) ((_ zero_extend 8) (ite (< amount 8) (bvlshr ((_ extract 7 0) v) ((_ int2bv 8) amount)) ((_ int2bv 8) 0))) (ite (and (<= 9 16) (<= 16 16)) (ite (< amount 16) (bvlshr v ((_ int2bv 16) amount)) ((_ int2bv 16) 0)) (ite (and (<= 17 16) (<= 16 32)) ((_ extract 15 0) (bvlshr ((_ zero_extend 16) v) ((_ int2bv 32) amount))) ((_ extract 15 0) (bvlshr ((_ zero_extend 48) v) ((_ int2bv 64) amount)))))))) :pattern ((shift_right v amount))))))
...
(assert (forall ((v (_ BitVec 16))) (forall ((amount Int)) (! (=> (and (dynamic_invariant v true true true) (dynamic_invariant2 amount true true true)) (dynamic_invariant (shift_left v amount) true false true)) :pattern ((shift_left v amount))))))
(assert (forall ((v (_ BitVec 16))) (forall ((amount Int)) (! (=> (and (dynamic_invariant v true true true) (dynamic_invariant2 amount true true true)) (= (shift_left v amount) (ite (and (<= 1 16) (<= 16 8)) ((_ zero_extend 8) (ite (< amount 8) (bvshl ((_ extract 7 0) v) ((_ int2bv 8) amount)) ((_ int2bv 8) 0))) (ite (and (<= 9 16) (<= 16 16)) (ite (< amount 16) (bvshl v ((_ int2bv 16) amount)) ((_ int2bv 16) 0)) (ite (and (<= 17 16) (<= 16 32)) ((_ extract 15 0) (bvurem (bvshl ((_ zero_extend 16) v) ((_ int2bv 32) amount)) ((_ int2bv 32) 65536))) ((_ extract 15 0) (bvurem (bvshl ((_ zero_extend 48) v) ((_ int2bv 64) amount)) ((_ int2bv 64) 65536)))))))) :pattern ((shift_left v amount))))))
(declare-fun make_mask (Int) (_ BitVec 16))
(declare-fun make_mask__function_guard ((_ BitVec 16) Int) Bool)
(define-fun dynamic_invariant3 ((temp___expr_279 Int) (temp___is_init_276 Bool) (temp___skip_constant_277 Bool) (temp___do_toplevel_278 Bool)) Bool (=> (or (= temp___is_init_276 true) (<= 1 16)) (in_range1 temp___expr_279)))
...
(assert (forall ((num_bits Int)) (! (=> (dynamic_invariant3 num_bits true true true) (= (make_mask num_bits) (shift_right ((_ int2bv 16) 65535) (- 16 num_bits)))) :pattern ((make_mask num_bits)))))
...
(declare-fun extract_bits_not_inline__function_guard ((_ BitVec 16) (_ BitVec 16) Int Int) Bool)
...
(declare-const bits_manipulation_unsigned__unsigned_16__functions__extract_bits__result (_ BitVec 16))
...
(declare-const bits_manipulation_unsigned__unsigned_16__functions__extract_bits__result1 (_ BitVec 16))
(declare-const result__4 (_ BitVec 16))
(declare-const bits_manipulation_unsigned__unsigned_16__functions__extract_bits__result2 (_ BitVec 16))
(declare-const result__5 (_ BitVec 16))
(declare-const bits_manipulation_unsigned__unsigned_16__functions__extract_bits__result3 (_ BitVec 16))
(declare-const result__6 (_ BitVec 16))
(declare-const bits_manipulation_unsigned__unsigned_16__functions__extract_bits__result4 (_ BitVec 16))
(declare-const result__7 (_ BitVec 16))
(declare-const bits_manipulation_unsigned__unsigned_16__functions__extract_bits__result5 (_ BitVec 16))
