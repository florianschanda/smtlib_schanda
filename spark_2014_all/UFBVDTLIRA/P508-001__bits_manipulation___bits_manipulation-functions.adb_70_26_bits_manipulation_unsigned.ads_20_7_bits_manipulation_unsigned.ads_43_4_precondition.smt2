...
(define-fun dynamic_invariant ((temp___expr_311 (_ BitVec 16)) (temp___is_init_307 Bool) (temp___skip_constant_308 Bool) (temp___do_toplevel_309 Bool) (temp___do_typ_inv_310 Bool)) Bool true)
...
(define-fun dynamic_invariant1 ((temp___expr_318 Int) (temp___is_init_314 Bool) (temp___skip_constant_315 Bool) (temp___do_toplevel_316 Bool) (temp___do_typ_inv_317 Bool)) Bool (=> (or (= temp___is_init_314 true) (<= 0 15)) (in_range temp___expr_318)))
...
(assert (forall ((v (_ BitVec 16))) (forall ((amount Int)) (! (=> (and (dynamic_invariant v true true true true) (dynamic_invariant2 amount true true true true)) (dynamic_invariant (shift_left v amount) true false true true)) :pattern ((shift_left v amount))))))
(assert (forall ((v (_ BitVec 16))) (forall ((amount Int)) (! (=> (and (dynamic_invariant v true true true true) (dynamic_invariant2 amount true true true true)) (= (shift_left v amount) (ite (and (<= 1 16) (<= 16 8)) ((_ zero_extend 8) (ite (< amount 8) (bvshl ((_ extract 7 0) v) ((_ int2bv 8) amount)) #x00)) (ite (and (<= 9 16) (<= 16 16)) (ite (< amount 16) (bvshl v ((_ int2bv 16) amount)) #x0000) (ite (and (<= 17 16) (<= 16 32)) ((_ extract 15 0) (bvurem (bvshl ((_ zero_extend 16) v) ((_ int2bv 32) amount)) ((_ int2bv 32) 65536))) ((_ extract 15 0) (bvurem (bvshl ((_ zero_extend 48) v) ((_ int2bv 64) amount)) ((_ int2bv 64) 65536)))))))) :pattern ((shift_left v amount))))))
(declare-fun make_mask (Int) (_ BitVec 16))
(declare-fun make_mask__function_guard ((_ BitVec 16) Int) Bool)
(define-fun dynamic_invariant3 ((temp___expr_325 Int) (temp___is_init_321 Bool) (temp___skip_constant_322 Bool) (temp___do_toplevel_323 Bool) (temp___do_typ_inv_324 Bool)) Bool (=> (or (= temp___is_init_321 true) (<= 1 16)) (in_range1 temp___expr_325)))
...
(assert (forall ((num_bits Int)) (! (=> (dynamic_invariant3 num_bits true true true true) (= (make_mask num_bits) (shift_right #xFFFF (- 16 num_bits)))) :pattern ((make_mask num_bits)))))
