...
(assert (let ((temp___480 (elements s))) (forall ((temp___479 Int)) (=> (and (in_range3 temp___479) (= (iter_has_element temp___480 temp___479) true)) (exists ((i us_rep1)) (and (= (has_key (positions s) i) true) (= (get (elements s) (get1 (positions s) i)) (get temp___480 temp___479))))))))
(declare-const i Int)
(assert (<= 1 i))
(assert (<= i (length s)))
