...
(assert (let ((temp___438 (elements s))) (forall ((temp___437 Int)) (=> (and (in_range3 temp___437) (= (iter_has_element temp___438 temp___437) true)) (exists ((i1 us_rep1)) (and (= (has_key (positions s) i1) true) (= (get (elements s) (get1 (positions s) i1)) (get temp___438 temp___437))))))))
