...
(assert (<= 0 n))
(assert (<= n 31))
(assert (and (= o (shift_right val__ n)) (= o (ite (and (<= 1 32) (<= 32 8)) ((_ zero_extend 24) (ite (< n 8) (bvlshr ((_ extract 7 0) val__) ((_ int2bv 8) n)) #x00)) (ite (and (<= 9 32) (<= 32 16)) ((_ zero_extend 16) (ite (< n 16) (bvlshr ((_ extract 15 0) val__) ((_ int2bv 16) n)) #x0000)) (ite (and (<= 17 32) (<= 32 32)) (bvlshr val__ ((_ int2bv 32) n)) ((_ extract 31 0) (bvlshr ((_ zero_extend 32) val__) ((_ int2bv 64) n)))))))))
(assert (= result1 (ite (= o #x00000001) true false)))
(assert (=> (= result1 true) (= (= result true) (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 n)) (bvuge (shift_right val__ j1) #x00000001))))))
