...
(assert (= result2 (ite (= o #x0001) true false)))
(assert (not (= result2 true)))
(assert (forall ((j Int)) (=> (and (<= 0 j) (<= j i2)) (bvugt (shift_right value j) #x0001))))
(assert (and (and (=> (<= 0 15) (in_range2 i2)) (=> (<= 0 15) (in_range2 result__2))) (and (<= 0 i2) (<= i2 15))))
(assert (not (= i2 15)))
(assert (= i2 result3))
(assert (= i3 (+ i2 1)))
...
(assert (= result5 (ite (= o1 #x0001) true false)))
(assert (not (= result5 true)))
(declare-const j Int)
(assert (<= 0 j))
(assert (<= j i3))
(assert (not (bvugt (shift_right value j) #x0001)))
(check-sat)
(exit)
