...
(assert (and (= temp___895 (keys s2)) (and (and (and (and (= (length1 temp___895) (length3 s2)) (forall ((temp___431 Int)) (=> (and (in_range3 temp___431) (= (iter_has_element temp___895 temp___431) true)) (= (has_key (model__ s2) (get temp___895 temp___431)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ s2) key2) true)) (and (< 0 (find temp___895 key2)) (= (get temp___895 (find temp___895 key2)) key2))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length3 s2))) (= (find temp___895 (get temp___895 i1)) i1)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length3 s2))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length3 s2))) (=> (= (get temp___895 i1) (get temp___895 j)) (= i1 j)))))))))
(assert (not true))
(check-sat)
(exit)
