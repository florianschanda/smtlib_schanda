...
(declare-fun temp___254 (map1 Int (_ BitVec 8) Int Int Int (_ BitVec 8) Int Int) map1)
(assert (forall ((temp___256 map1)) (forall ((temp___257 Int) (temp___259 Int) (temp___260 Int) (temp___261 Int) (temp___263 Int) (temp___264 Int)) (forall ((temp___258 (_ BitVec 8)) (temp___262 (_ BitVec 8))) (let ((temp___255 (temp___254 temp___256 temp___257 temp___258 temp___259 temp___260 temp___261 temp___262 temp___263 temp___264))) (forall ((temp___265 Int) (temp___267 Int)) (forall ((temp___266 (_ BitVec 8))) (ite (and (and (= temp___265 temp___261) (= temp___266 temp___262)) (= temp___267 temp___263)) (= (get temp___255 temp___265 temp___266 temp___267) (of_rep temp___264)) (ite (and (and (= temp___265 temp___257) (= temp___266 temp___258)) (= temp___267 temp___259)) (= (get temp___255 temp___265 temp___266 temp___267) (of_rep temp___260)) (= (get temp___255 temp___265 temp___266 temp___267) (get temp___256 temp___265 temp___266 temp___267)))))))))))
(declare-fun temp___268 (Int) map1)
(assert (forall ((temp___270 Int)) (forall ((temp___271 Int) (temp___273 Int)) (forall ((temp___272 (_ BitVec 8))) (= (get (temp___268 temp___270) temp___271 temp___272 temp___273) (of_rep temp___270))))))
...
(assert (= a3 a4))
(assert (= a5 a3))
(assert (not (= (bool_eq a4 1 10 ((_ int2bv 8) 0) ((_ int2bv 8) 7) 0 2 (temp___254 (temp___268 1000) 5 ((_ int2bv 8) 7) 1 v1 x y 2 v2) 1 10 ((_ int2bv 8) 0) ((_ int2bv 8) 7) 0 2) true)))
(check-sat)
(exit)
