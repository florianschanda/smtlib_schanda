...
(assert (forall ((x86__rcx (_ BitVec 64))) (! (=> (dynamic_invariant x86__rcx true true true) (let ((result (ecx x86__rcx))) (and (= result ((_ extract 31 0) (bvand x86__rcx ((_ int2bv 64) 4294967295)))) (dynamic_invariant1 result true false true)))) :pattern ((ecx x86__rcx)))))
