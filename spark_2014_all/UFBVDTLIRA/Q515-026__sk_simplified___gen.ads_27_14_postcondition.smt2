...
(assert (not (not (and (and (and (and (= gen__get_val__result1 gen__get_val__result2) (= gen__get_val__result3 gen__get_val__result1)) (and (= result gen__get_val__result) (= gen__get_val__result1 0))) (and (= (mk_int__ref gen__get_val__result4) (mk_int__ref gen__get_val__result2)) (= gen__get_val__result5 gen__get_val__result3))) (= result1 gen__get_val__result4)))))
(check-sat)
(exit)
