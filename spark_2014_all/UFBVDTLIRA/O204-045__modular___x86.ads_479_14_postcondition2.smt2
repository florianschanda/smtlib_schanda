...
(declare-fun signedlt_32__function_guard (Bool (_ BitVec 32) (_ BitVec 32)) Bool)
...
(assert (forall ((val1 (_ BitVec 32)) (val2 (_ BitVec 32))) (! (=> (and (dynamic_invariant val1 true true true true) (dynamic_invariant val2 true true true true)) (= (= (signedlt_32 val1 val2) true) (bvugt (bvadd ((_ zero_extend 32) val1) ((_ zero_extend 32) val2)) ((_ zero_extend 32) (bvadd val1 val2))))) :pattern ((signedlt_32 val1 val2)))))
...
(assert (= (mk_bool__ref x86__signedlte_32__result4) (mk_bool__ref x86__signedlte_32__result2)))
...
(assert (not (or (= val1 val2) (= (signedlt_32 val1 val2) true))))
(check-sat)
(exit)
