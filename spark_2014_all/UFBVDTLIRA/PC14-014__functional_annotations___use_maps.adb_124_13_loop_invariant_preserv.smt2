...
(define-fun temp___9041 () us_rep1 (mk___rep1 (mk___split_fields1 temp___904)))
...
(assert (and (= result1 (has_key1 (positions s2) (mk___rep1 cu__split_fields5))) (= (= result1 true) (= (has_key1 (positions s2) (mk___rep1 cu__split_fields5)) true))))
(assert (= result1 true))
(assert (< (length (mk___rep s1__split_discrs s1__split_fields4)) (+ (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (get2 (positions s2) (mk___rep1 cu__split_fields4)))))
(assert (let ((temp___913 (keys (mk___rep s1__split_discrs s1__split_fields4)))) (forall ((temp___912 Int)) (=> (and (in_range5 temp___912) (= (iter_has_element temp___913 temp___912) true)) (= (prop__ (get (model__ (mk___rep s1__split_discrs s1__split_fields4)) (get1 temp___913 temp___912))) true)))))
(assert (and (= o1 (element s2 (mk___rep1 cu__split_fields4))) (and (in_range9 o1) (= o1 (get (model__ s2) (key s2 (mk___rep1 cu__split_fields4)))))))
(assert (and (= o (key s2 (mk___rep1 cu__split_fields4))) (and (in_range8 o) (= o (get1 (keys s2) (get2 (positions s2) (mk___rep1 cu__split_fields4)))))))
(assert (and (and (= (has_key (model__ (mk___rep s1__split_discrs s1__split_fields3)) o) true) (= (get (model__ (mk___rep s1__split_discrs s1__split_fields3)) o) o1)) (ite (= (has_key (model__ (mk___rep s1__split_discrs s1__split_fields4)) o) true) (and (and (and (and (= (oeq3 (positions (mk___rep s1__split_discrs s1__split_fields3)) (positions (mk___rep s1__split_discrs s1__split_fields4))) true) (= (get1 (keys (mk___rep s1__split_discrs s1__split_fields3)) (get2 (positions (mk___rep s1__split_discrs s1__split_fields3)) (find1 (mk___rep s1__split_discrs s1__split_fields3) o))) o)) (= (equal_except (keys (mk___rep s1__split_discrs s1__split_fields4)) (keys (mk___rep s1__split_discrs s1__split_fields3)) (get2 (positions (mk___rep s1__split_discrs s1__split_fields3)) (find1 (mk___rep s1__split_discrs s1__split_fields3) o))) true)) (= (same_keys (model__ (mk___rep s1__split_discrs s1__split_fields3)) (model__ (mk___rep s1__split_discrs s1__split_fields4))) true)) (= (elements_equal_except (model__ (mk___rep s1__split_discrs s1__split_fields3)) (model__ (mk___rep s1__split_discrs s1__split_fields4)) o) true)) (and (and (and (and (and (= (length (mk___rep s1__split_discrs s1__split_fields3)) (+ (length (mk___rep s1__split_discrs s1__split_fields4)) 1)) (= (ole (model__ (mk___rep s1__split_discrs s1__split_fields4)) (model__ (mk___rep s1__split_discrs s1__split_fields3))) true)) (= (keys_included_except (model__ (mk___rep s1__split_discrs s1__split_fields3)) (model__ (mk___rep s1__split_discrs s1__split_fields4)) o) true)) (= (get1 (keys (mk___rep s1__split_discrs s1__split_fields3)) (get2 (positions (mk___rep s1__split_discrs s1__split_fields3)) (find1 (mk___rep s1__split_discrs s1__split_fields3) o))) o)) (= (mapping_preserved (keys (mk___rep s1__split_discrs s1__split_fields4)) (keys (mk___rep s1__split_discrs s1__split_fields3)) (positions (mk___rep s1__split_discrs s1__split_fields4)) (positions (mk___rep s1__split_discrs s1__split_fields3))) true)) (= (keys_included_except1 (positions (mk___rep s1__split_discrs s1__split_fields3)) (positions (mk___rep s1__split_discrs s1__split_fields4)) (find1 (mk___rep s1__split_discrs s1__split_fields3) o)) true)))))
(assert (and (= temp___9041 (next s2 (mk___rep1 cu__split_fields4))) (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields4) no_element) false) (= (get2 (positions s2) (mk___rep1 cu__split_fields4)) (length s2)) true) true) (= (bool_eq1 temp___9041 no_element) true) (and (= (has_key1 (positions s2) temp___9041) true) (= (get2 (positions s2) temp___9041) (+ (get2 (positions s2) (mk___rep1 cu__split_fields4)) 1))))))
(assert (= result2 cu__split_fields2))
(assert (= cu__split_fields3 (mk___split_fields1 temp___904)))
(assert (and (= o2 (has_key1 (positions s2) (mk___rep1 cu__split_fields3))) (= (= o2 true) (= (has_key1 (positions s2) (mk___rep1 cu__split_fields3)) true))))
(assert (= result3 (ite (not (= o2 true)) true false)))
(assert (not (= result3 true)))
(assert (not (< (length (mk___rep s1__split_discrs s1__split_fields3)) (+ (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (get2 (positions s2) (mk___rep1 cu__split_fields3))))))
(check-sat)
(exit)
