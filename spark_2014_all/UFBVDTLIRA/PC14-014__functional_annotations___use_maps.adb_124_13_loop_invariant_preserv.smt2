...
(define-fun temp___9471 () us_rep1 (mk___rep1 (mk___split_fields1 temp___947)))
...
(assert (let ((temp___956 (keys (mk___rep s1__split_discrs s1__split_fields4)))) (forall ((temp___955 Int)) (=> (and (in_range5 temp___955) (= (iter_has_element temp___956 temp___955) true)) (= (prop__ (get (model__ (mk___rep s1__split_discrs s1__split_fields4)) (get1 temp___956 temp___955))) true)))))
...
(assert (and (= temp___9471 (next s2 (mk___rep1 cu__split_fields4))) (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields4) no_element) false) (= (get2 (positions s2) (mk___rep1 cu__split_fields4)) (length s2)) true) true) (= (bool_eq1 temp___9471 no_element) true) (and (= (has_key1 (positions s2) temp___9471) true) (= (get2 (positions s2) temp___9471) (+ (get2 (positions s2) (mk___rep1 cu__split_fields4)) 1))))))
(assert (= result2 cu__split_fields2))
(assert (= cu__split_fields3 (mk___split_fields1 temp___947)))
