...
(assert true)
(assert true)
(assert (= (bvmul (bvadd x y) (bvadd x y)) (bvadd (bvmul x x) (bvmul y (bvadd (bvmul ((_ int2bv 64) 2) x) y)))))
(assert (not (= (sqr (bvadd x y)) (bvadd (sqr x) (bvmul y (bvadd (bvmul ((_ int2bv 64) 2) x) y))))))
(check-sat)
(exit)
