...
(define-fun dynamic_invariant ((temp___expr_183 (_ BitVec 8)) (temp___is_init_180 Bool) (temp___skip_constant_181 Bool) (temp___do_toplevel_182 Bool)) Bool true)
...
(define-fun dynamic_invariant1 ((temp___expr_361 us_rep) (temp___is_init_358 Bool) (temp___skip_constant_359 Bool) (temp___do_toplevel_360 Bool)) Bool (=> (not (= temp___skip_constant_359 true)) (in_range2 5 temp___expr_361)))
(define-fun default_initial_assumption ((temp___expr_363 us_rep) (temp___skip_top_level_364 Bool)) Bool (and (= (to_rep (rec__foo__lists__list__capacity (us_split_discrs1 temp___expr_363))) 5) (=> (not (= temp___skip_top_level_364 true)) (= (is_empty temp___expr_363) true))))
(declare-const l__split_discrs us_split_discrs)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(define-fun dynamic_invariant2 ((temp___expr_141 Int) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool (=> (or (= temp___is_init_138 true) (<= 0 2147483647)) (in_range temp___expr_141)))
(define-fun default_initial_assumption1 ((temp___expr_201 us_rep1) (temp___skip_top_level_202 Bool)) Bool (= (to_rep (rec__foo__lists__cursor__node (us_split_fields3 temp___expr_201))) 0))
(declare-const no_element us_rep1)
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(assert (= no_element (mk___rep1 (mk___split_fields1 (of_rep 0)))))
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__foo__lists__list__capacity (us_split_discrs1 container)))) (dynamic_invariant2 result true false true))) :pattern ((length container)))))
...
(define-fun default_initial_assumption2 ((temp___expr_233 us_rep2) (temp___skip_top_level_234 Bool)) Bool (=> (not (= temp___skip_top_level_234 true)) (= (length1 temp___expr_233) 0)))
...
(define-fun default_initial_assumption3 ((temp___expr_252 us_rep3) (temp___skip_top_level_253 Bool)) Bool (=> (not (= temp___skip_top_level_253 true)) (and (= (is_empty1 temp___expr_252) true) (= (length2 temp___expr_252) 0))))
(declare-fun has_key (us_rep3 us_rep1) Bool)
(declare-fun has_key__function_guard (Bool us_rep3 us_rep1) Bool)
(define-fun default_initial_assumption4 ((temp___expr_240 us_rep1) (temp___skip_top_level_241 Bool)) Bool (= (to_rep (rec__foo__lists__cursor__node (us_split_fields3 temp___expr_240))) 0))
...
(define-fun dynamic_invariant3 ((temp___expr_226 Int) (temp___is_init_223 Bool) (temp___skip_constant_224 Bool) (temp___do_toplevel_225 Bool)) Bool (=> (or (= temp___is_init_223 true) (<= 0 2147483647)) (in_range3 temp___expr_226)))
(assert (forall ((container us_rep2)) (! (let ((result (length1 container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant2 result true false true))) :pattern ((length1 container)))))
...
(assert (forall ((container us_rep2)) (forall ((position Int)) (! (=> (and (dynamic_invariant3 position true true true) (and (<= 1 position) (<= position (last container)))) (dynamic_invariant4 (get container position) true false true)) :pattern ((get container position))))))
...
(define-fun dynamic_invariant5 ((temp___expr_245 Int) (temp___is_init_242 Bool) (temp___skip_constant_243 Bool) (temp___do_toplevel_244 Bool)) Bool (=> (or (= temp___is_init_242 true) (<= 1 2147483647)) (in_range4 temp___expr_245)))
...
(assert (forall ((container us_rep3)) (forall ((key us_rep1)) (! (=> (= (has_key container key) true) (let ((result (get1 container key))) (and (=> (= (of_int 0) true) (and (= result (w_get container (witness container key))) (forall ((k us_rep1)) (=> (= (has_key container k) true) (= (= (bool_eq1 k key) true) (= (witness container key) (witness container k))))))) (dynamic_invariant5 result true false true)))) :pattern ((get1 container key))))))
(assert (forall ((container us_rep3)) (! (dynamic_invariant2 (length2 container) true false true) :pattern ((length2 container)))))
...
(assert true)
(assert (forall ((container us_rep3)) (forall ((key us_rep1)) (! (=> (= (has_key container key) true) (let ((result (witness container key))) (and (= (has_witness container result) true) (dynamic_invariant2 result true false true)))) :pattern ((witness container key))))))
(assert (forall ((container us_rep3)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant2 witness1 true true true) (= (has_witness container witness1) true)) (dynamic_invariant5 (w_get container witness1) true false true)) :pattern ((w_get container witness1))))))
