...
(define-fun default_initial_assumption1 ((temp___expr_235 us_rep2) (temp___skip_top_level_236 Bool)) Bool (= (to_rep (rec__foo__lists__cursor__node (us_split_fields3 temp___expr_235))) 0))
...
(define-fun default_initial_assumption4 ((temp___expr_280 us_rep2) (temp___skip_top_level_281 Bool)) Bool (= (to_rep (rec__foo__lists__cursor__node (us_split_fields3 temp___expr_280))) 0))
...
(assert (forall ((container us_rep1)) (forall ((position Int)) (! (=> (and (dynamic_invariant3 position true true true true) (and (<= 1 position) (<= position (last container)))) (dynamic_invariant4 (get container position) true false true true)) :pattern ((get container position))))))
...
(assert (forall ((i element_type1)) (and (<= 1 (element_typeqtint i)) (<= (element_typeqtint i) 2147483647))))
...
(assert (forall ((container us_rep3)) (forall ((key us_rep2)) (! (=> (= (has_key container key) true) (let ((result (get1 container key))) (and (=> (= (distinct 0 0) true) (and (= result (w_get container (witness container key))) (forall ((k us_rep2)) (=> (= (has_key container k) true) (= (= (bool_eq2 k key) true) (= (witness container key) (witness container k))))))) (dynamic_invariant5 result true false true true)))) :pattern ((get1 container key))))))
