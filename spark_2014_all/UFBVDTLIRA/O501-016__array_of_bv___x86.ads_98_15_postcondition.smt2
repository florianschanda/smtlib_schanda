...
(assert (forall ((x86__rcx (_ BitVec 64))) (! (=> (dynamic_invariant x86__rcx true true true) (let ((result (ch x86__rcx))) (and (= result ((_ extract 7 0) (bvurem (bvudiv (bvand x86__rcx ((_ int2bv 64) 65280)) ((_ int2bv 64) 256)) ((_ int2bv 64) 256)))) (dynamic_invariant1 result true false true)))) :pattern ((ch x86__rcx)))))
