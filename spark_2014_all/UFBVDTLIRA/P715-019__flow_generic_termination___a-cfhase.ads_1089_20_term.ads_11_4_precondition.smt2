...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (= (to_rep1 (rec__term__tset__cursor__node (us_split_fields3 a))) (to_rep1 (rec__term__tset__cursor__node (us_split_fields3 b)))) true false))
...
(define-fun default_initial_assumption2 ((temp___expr_430 us_rep3) (temp___skip_top_level_431 Bool)) Bool (=> (not (= temp___skip_top_level_431 true)) (= (length2 temp___expr_430) 0)))
...
(assert (and (= o1 (length container)) (and (in_range1 o1) (<= o1 (to_rep1 (rec__term__tset__set__capacity (us_split_discrs1 container)))))))
