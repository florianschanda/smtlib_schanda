...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__term__tset__cursor__node count_type)))))
(define-fun us_split_fields_Node__projection ((a us_split_fields2)) count_type (rec__term__tset__cursor__node a))
...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (= (to_rep (rec__term__tset__cursor__node (us_split_fields3 a))) (to_rep (rec__term__tset__cursor__node (us_split_fields3 b)))) true false))
...
(assert (< term__tset__cursor__node__first__bit term__tset__cursor__node__last__bit))
...
(define-fun default_initial_assumption1 ((temp___expr_394 us_rep4) (temp___skip_top_level_395 Bool)) Bool (=> (not (= temp___skip_top_level_395 true)) (= (is_empty1 temp___expr_394) true)))
...
(define-fun default_initial_assumption2 ((temp___expr_430 us_rep3) (temp___skip_top_level_431 Bool)) Bool (=> (not (= temp___skip_top_level_431 true)) (= (length3 temp___expr_430) 0)))
...
(define-fun dynamic_invariant3 ((temp___expr_386 Int) (temp___is_init_382 Bool) (temp___skip_constant_383 Bool) (temp___do_toplevel_384 Bool) (temp___do_typ_inv_385 Bool)) Bool (=> (or (= temp___is_init_382 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_386)))
(define-fun dynamic_invariant4 ((temp___expr_422 Int) (temp___is_init_418 Bool) (temp___skip_constant_419 Bool) (temp___do_toplevel_420 Bool) (temp___do_typ_inv_421 Bool)) Bool (=> (or (= temp___is_init_418 true) (<= 0 2147483647)) (in_range4 temp___expr_422)))
...
(define-fun dynamic_invariant5 ((temp___expr_415 Int) (temp___is_init_411 Bool) (temp___skip_constant_412 Bool) (temp___do_toplevel_413 Bool) (temp___do_typ_inv_414 Bool)) Bool (=> (or (= temp___is_init_411 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_415)))
...
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___751 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___751)) no_element))
...
(assert (and (= o3 (length container)) (and (in_range1 o3) (<= o3 (to_rep (rec__term__tset__set__capacity (us_split_discrs1 container)))))))
