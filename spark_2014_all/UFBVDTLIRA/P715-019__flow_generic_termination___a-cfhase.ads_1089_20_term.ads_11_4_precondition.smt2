...
(define-fun default_initial_assumption1 ((temp___expr_361 us_rep4) (temp___skip_top_level_362 Bool)) Bool (=> (not (= temp___skip_top_level_362 true)) (= (is_empty1 temp___expr_361) true)))
...
(define-fun default_initial_assumption2 ((temp___expr_392 us_rep3) (temp___skip_top_level_393 Bool)) Bool (=> (not (= temp___skip_top_level_393 true)) (= (length3 temp___expr_392) 0)))
...
(define-fun dynamic_invariant4 ((temp___expr_385 Int) (temp___is_init_382 Bool) (temp___skip_constant_383 Bool) (temp___do_toplevel_384 Bool)) Bool (=> (or (= temp___is_init_382 true) (<= 0 2147483647)) (in_range4 temp___expr_385)))
...
(define-fun dynamic_invariant5 ((temp___expr_379 Int) (temp___is_init_376 Bool) (temp___skip_constant_377 Bool) (temp___do_toplevel_378 Bool)) Bool (=> (or (= temp___is_init_376 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_379)))
