...
(define-fun dynamic_invariant ((temp___expr_385 Int) (temp___is_init_382 Bool) (temp___skip_constant_383 Bool) (temp___do_toplevel_384 Bool)) Bool (=> (or (= temp___is_init_382 true) (<= 1 2147483647)) (in_range3 temp___expr_385)))
(define-fun dynamic_invariant1 ((temp___expr_391 Int) (temp___is_init_388 Bool) (temp___skip_constant_389 Bool) (temp___do_toplevel_390 Bool)) Bool (=> (or (= temp___is_init_388 true) (<= 0 2147483647)) (in_range2 temp___expr_391)))
...
(define-fun default_initial_assumption ((temp___expr_398 us_rep2) (temp___skip_top_level_399 Bool)) Bool (=> (not (= temp___skip_top_level_399 true)) (= (length temp___expr_398) 0)))
...
(assert (forall ((container us_rep)) (! (let ((result (keys container))) (and (and (and (and (= (length result) (length1 container)) (forall ((temp___435 Int)) (=> (and (in_range2 temp___435) (= (iter_has_element result temp___435) true)) (= (has_key (model__ container) (get result temp___435)) true)))) (forall ((key Int)) (=> (and (in_range4 key) (= (has_key (model__ container) key) true)) (and (< 0 (find result key)) (= (get result (find result key)) key))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length1 container))) (= (find result (get result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length1 container))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length1 container))) (=> (= (get result i) (get result j)) (= i j)))))))) :pattern ((keys container)))))
...
(define-fun dynamic_invariant2 ((temp___expr_325 Int) (temp___is_init_322 Bool) (temp___skip_constant_323 Bool) (temp___do_toplevel_324 Bool)) Bool (=> (or (= temp___is_init_322 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_325)))
...
(define-fun dynamic_invariant3 ((temp___expr_319 Int) (temp___is_init_316 Bool) (temp___skip_constant_317 Bool) (temp___do_toplevel_318 Bool)) Bool (=> (or (= temp___is_init_316 true) (<= 1 2147483647)) (in_range6 temp___expr_319)))
...
(assert (forall ((container us_rep)) (! (let ((result (length1 container))) (and (<= result (to_rep1 (rec__use_maps__my_maps__map__capacity (us_split_discrs1 container)))) (dynamic_invariant6 result true false true))) :pattern ((length1 container)))))
(assert (forall ((attr__tag Int)) (forall ((container us_rep)) (! (dynamic_invariant6 (length2 attr__tag container) true false true) :pattern ((length2 attr__tag container))))))
(assert (forall ((container us_rep2)) (forall ((key2 Int)) (! (=> (dynamic_invariant3 key2 true true true) (let ((result (find container key2))) (and (=> (< 0 result) (and (<= result (length container)) (= key2 (get container result)))) (dynamic_invariant6 result true false true)))) :pattern ((find container key2))))))
...
(assert (forall ((container us_rep3)) (! (dynamic_invariant6 (length3 container) true false true) :pattern ((length3 container)))))
...
(assert true)
(assert (forall ((container us_rep3)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant7 key2 true true true) (= (has_key container key2) true)) (let ((result (witness container key2))) (and (= (has_witness container result) true) (dynamic_invariant6 result true false true)))) :pattern ((witness container key2))))))
(assert (forall ((container us_rep3)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant6 witness1 true true true) (= (has_witness container witness1) true)) (dynamic_invariant8 (w_get container witness1) true false true)) :pattern ((w_get container witness1))))))
...
(assert true)
(assert (forall ((container us_rep4)) (forall ((key2 us_rep1)) (! (=> (= (has_key1 container key2) true) (let ((result (witness1 container key2))) (and (= (has_witness1 container result) true) (dynamic_invariant6 result true false true)))) :pattern ((witness1 container key2))))))
(assert (forall ((container us_rep4)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant6 witness2 true true true) (= (has_witness1 container witness2) true)) (dynamic_invariant9 (w_get1 container witness2) true false true)) :pattern ((w_get1 container witness2))))))
...
(assert (let ((temp___444 (keys s))) (forall ((temp___443 Int)) (=> (and (in_range2 temp___443) (= (iter_has_element temp___444 temp___443) true)) (exists ((i us_rep1)) (and (= (has_key1 (positions s) i) true) (= (get (keys s) (get1 (positions s) i)) (get temp___444 temp___443))))))))
(assert (and (= temp___980 (keys s)) (and (and (and (and (= (length temp___980) (length1 s)) (forall ((temp___431 Int)) (=> (and (in_range2 temp___431) (= (iter_has_element temp___980 temp___431) true)) (= (has_key (model__ s) (get temp___980 temp___431)) true)))) (forall ((key2 Int)) (=> (and (in_range4 key2) (= (has_key (model__ s) key2) true)) (and (< 0 (find temp___980 key2)) (= (get temp___980 (find temp___980 key2)) key2))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length1 s))) (= (find temp___980 (get temp___980 i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length1 s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length1 s))) (=> (= (get temp___980 i) (get temp___980 j)) (= i j)))))))))
(assert (and (= o3 (iter_has_element temp___980 temp___979)) (= (= o3 true) (and (<= 1 temp___979) (<= temp___979 (last temp___980))))))
(assert (= (= o4 true) (in_range2 temp___979)))
