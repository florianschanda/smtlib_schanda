...
(define-fun dynamic_invariant ((temp___expr_422 Int) (temp___is_init_418 Bool) (temp___skip_constant_419 Bool) (temp___do_toplevel_420 Bool) (temp___do_typ_inv_421 Bool)) Bool (=> (or (= temp___is_init_418 true) (<= 1 2147483647)) (in_range3 temp___expr_422)))
...
(define-fun default_initial_assumption ((temp___expr_437 us_rep2) (temp___skip_top_level_438 Bool)) Bool (=> (not (= temp___skip_top_level_438 true)) (= (length temp___expr_437) 0)))
...
(define-fun dynamic_invariant3 ((temp___expr_346 Int) (temp___is_init_342 Bool) (temp___skip_constant_343 Bool) (temp___do_toplevel_344 Bool) (temp___do_typ_inv_345 Bool)) Bool (=> (or (= temp___is_init_342 true) (<= 1 2147483647)) (in_range6 temp___expr_346)))
...
(assert (forall ((container us_rep)) (! (let ((result (length1 container))) (and (<= result (to_rep1 (rec__use_maps__my_maps__map__capacity (us_split_discrs1 container)))) (dynamic_invariant6 result true false true true))) :pattern ((length1 container)))))
(assert (forall ((attr__tag Int)) (forall ((container us_rep)) (! (dynamic_invariant6 (length2 attr__tag container) true false true true) :pattern ((length2 attr__tag container))))))
(assert (forall ((container us_rep2)) (forall ((key2 Int)) (! (=> (dynamic_invariant3 key2 true true true true) (let ((result (find container key2))) (and (=> (< 0 result) (and (<= result (length container)) (= key2 (get container result)))) (dynamic_invariant6 result true false true true)))) :pattern ((find container key2))))))
...
(assert (forall ((container us_rep3)) (! (dynamic_invariant6 (length3 container) true false true true) :pattern ((length3 container)))))
...
(assert true)
(assert (forall ((container us_rep3)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant7 key2 true true true true) (= (has_key container key2) true)) (let ((result (witness container key2))) (and (= (has_witness container result) true) (dynamic_invariant6 result true false true true)))) :pattern ((witness container key2))))))
(assert (forall ((container us_rep3)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant6 witness1 true true true true) (= (has_witness container witness1) true)) (dynamic_invariant8 (w_get container witness1) true false true true)) :pattern ((w_get container witness1))))))
...
(assert true)
(assert (forall ((container us_rep4)) (forall ((key2 us_rep1)) (! (=> (= (has_key1 container key2) true) (let ((result (witness1 container key2))) (and (= (has_witness1 container result) true) (dynamic_invariant6 result true false true true)))) :pattern ((witness1 container key2))))))
(assert (forall ((container us_rep4)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant6 witness2 true true true true) (= (has_witness1 container witness2) true)) (dynamic_invariant9 (w_get1 container witness2) true false true true)) :pattern ((w_get1 container witness2))))))
(declare-const temp___1023 us_rep2)
...
(assert (let ((temp___487 (keys s))) (forall ((temp___486 Int)) (=> (and (in_range2 temp___486) (= (iter_has_element temp___487 temp___486) true)) (exists ((i us_rep1)) (and (= (has_key1 (positions s) i) true) (= (get (keys s) (get1 (positions s) i)) (get temp___487 temp___486))))))))
(assert (and (= temp___1023 (keys s)) (and (and (and (and (= (length temp___1023) (length1 s)) (forall ((temp___474 Int)) (=> (and (in_range2 temp___474) (= (iter_has_element temp___1023 temp___474) true)) (= (has_key (model__ s) (get temp___1023 temp___474)) true)))) (forall ((key2 Int)) (=> (and (in_range4 key2) (= (has_key (model__ s) key2) true)) (and (< 0 (find temp___1023 key2)) (= (get temp___1023 (find temp___1023 key2)) key2))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length1 s))) (= (find temp___1023 (get temp___1023 i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length1 s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length1 s))) (=> (= (get temp___1023 i) (get temp___1023 j)) (= i j)))))))))
...
(assert (= result true))
(assert (and (= k (get temp___1023 temp___1022)) (in_range3 k)))
