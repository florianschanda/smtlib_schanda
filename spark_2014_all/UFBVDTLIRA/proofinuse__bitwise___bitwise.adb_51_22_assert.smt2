...
(assert true)
(assert (= result res))
(assert (= res1 (bvor (bvor (bvor ((_ zero_extend 24) val1) (bvshl ((_ zero_extend 24) val2) ((_ int2bv 32) 8))) (bvshl ((_ zero_extend 24) val3) ((_ int2bv 32) 16))) (bvshl ((_ zero_extend 24) val4) ((_ int2bv 32) 24)))))
(assert (not (= res1 (bvor ((_ zero_extend 16) (bvor ((_ zero_extend 8) val1) (ite (< 8 16) (bvshl ((_ zero_extend 8) val2) ((_ int2bv 16) 8)) ((_ int2bv 16) 0)))) (bvshl ((_ zero_extend 16) (bvor ((_ zero_extend 8) val3) (ite (< 8 16) (bvshl ((_ zero_extend 8) val4) ((_ int2bv 16) 8)) ((_ int2bv 16) 0)))) ((_ int2bv 32) 16))))))
(check-sat)
(exit)
