...
(assert (= result x86__ch__result))
(assert (= x86__ch__result1 ((_ extract 7 0) (bvudiv (bvand rcx #x000000000000FF00) #x0000000000000100))))
(assert (= (mk_t__ref x86__ch__result4) (mk_t__ref x86__ch__result2)))
(assert (= x86__ch__result5 x86__ch__result3))
(assert (= result1 x86__ch__result4))
(assert (not (= x86__ch__result4 (readreghigh8 rcx))))
(check-sat)
(exit)
