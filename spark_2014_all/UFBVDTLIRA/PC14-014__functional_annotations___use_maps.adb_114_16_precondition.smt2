...
(assert (and (= o6 (key s1 (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range6 o6) (= o6 (get (keys s1) (get1 (positions s1) (mk___rep1 (mk___split_fields1 cu__split_fields2))))))))
(assert (and (= result3 (has_key (model__ s2) o6)) (= (= result3 true) (= (has_key (model__ s2) o6) true))))
(assert (not (= result3 true)))
(assert (= use_maps__are_disjoint__result3 use_maps__are_disjoint__result2))
(assert (not (or (= (has_key1 (positions s1) (mk___rep1 (mk___split_fields1 cu__split_fields2))) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields2)) no_element) true))))
(check-sat)
(exit)
