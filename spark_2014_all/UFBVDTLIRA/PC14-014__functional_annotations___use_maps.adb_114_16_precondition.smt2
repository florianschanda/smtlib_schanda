...
(assert (and (= o (key s1 (mk___rep1 cu__split_fields3))) (and (in_range6 o) (= o (get (keys s1) (get1 (positions s1) (mk___rep1 cu__split_fields3)))))))
(assert (and (= result2 (has_key (model__ s2) o)) (= (= result2 true) (= (has_key (model__ s2) o) true))))
(assert (not (= result2 true)))
(assert (= use_maps__are_disjoint__result1 use_maps__are_disjoint__result))
(assert (not (or (= (has_key1 (positions s1) (mk___rep1 cu__split_fields3)) true) (= (bool_eq1 (mk___rep1 cu__split_fields3) no_element) true))))
(check-sat)
(exit)
