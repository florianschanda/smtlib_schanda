...
(assert (and (= result1 (has_key1 (positions s1) (mk___rep cu__split_fields4))) (= (= result1 true) (= (has_key1 (positions s1) (mk___rep cu__split_fields4)) true))))
(assert (= result1 true))
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions s1) (mk___rep cu__split_fields3)) 1))) (not (= (has_key (model__ s2) (get (keys s1) i)) true)))))
(assert (= (has_key1 (positions s1) (mk___rep cu__split_fields3)) true))
(assert (and (= o (key s1 (mk___rep cu__split_fields3))) (and (in_range6 o) (= o (get (keys s1) (get1 (positions s1) (mk___rep cu__split_fields3)))))))
...
(assert (not (or (= (has_key1 (positions s1) (mk___rep cu__split_fields3)) true) (= (bool_eq2 (mk___rep cu__split_fields3) no_element) true))))
(check-sat)
(exit)
