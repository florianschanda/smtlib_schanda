...
(assert (forall ((container us_rep3)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant7 key2 true true true true) (= (has_key container key2) true)) (let ((result (get2 container key2))) (and (=> (= (distinct 1 0) true) (and (= result (w_get container (witness container key2))) (forall ((k Int)) (=> (and (in_range4 k) (= (has_key container k) true)) (= (= k key2) (= (witness container key2) (witness container k))))))) (dynamic_invariant8 result true false true true)))) :pattern ((get2 container key2))))))
...
(assert (forall ((cu us_rep1)) (=> (= (has_key1 (positions s) cu) true) (= (q (element s cu)) true))))
(assert (let ((temp___487 (keys s))) (forall ((temp___486 Int)) (=> (and (in_range3 temp___486) (= (iter_has_element temp___487 temp___486) true)) (exists ((i us_rep1)) (and (= (has_key1 (positions s) i) true) (= (get (keys s) (get1 (positions s) i)) (get temp___487 temp___486))))))))
(declare-const i Int)
(assert (<= 1 i))
(assert (<= i (length s)))
(assert (not (= (q (get2 (model__ s) (get (keys s) i))) true)))
(check-sat)
(exit)
