...
(assert (let ((temp___487 (keys s))) (forall ((temp___486 Int)) (=> (and (in_range3 temp___486) (= (iter_has_element temp___487 temp___486) true)) (exists ((i us_rep3)) (and (= (has_key1 (positions s) i) true) (= (get (keys s) (get1 (positions s) i)) (get temp___487 temp___486))))))))
(declare-const i Int)
(assert (<= 1 i))
(assert (<= i (length s)))
