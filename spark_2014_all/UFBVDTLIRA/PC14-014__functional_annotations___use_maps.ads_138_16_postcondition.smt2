...
(assert (forall ((container us_rep3)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant7 key2 true true true) (= (has_key container key2) true)) (let ((result (get2 container key2))) (and (=> (= (of_int 1) true) (and (= result (w_get container (witness container key2))) (forall ((k Int)) (=> (and (in_range4 k) (= (has_key container k) true)) (= (= k key2) (= (witness container key2) (witness container k))))))) (dynamic_invariant8 result true false true)))) :pattern ((get2 container key2))))))
...
(assert (forall ((cu1 us_rep1)) (=> (= (has_key1 (positions s) cu1) true) (= (q (element s cu1)) true))))
(assert (let ((temp___444 (keys s))) (forall ((temp___443 Int)) (=> (and (in_range3 temp___443) (= (iter_has_element temp___444 temp___443) true)) (exists ((i1 us_rep1)) (and (= (has_key1 (positions s) i1) true) (= (get (keys s) (get1 (positions s) i1)) (get temp___444 temp___443))))))))
(declare-const i1 Int)
(assert (<= 1 i1))
(assert (<= i1 (length s)))
(assert (not (= (q (get2 (model__ s) (get (keys s) i1))) true)))
(check-sat)
(exit)
