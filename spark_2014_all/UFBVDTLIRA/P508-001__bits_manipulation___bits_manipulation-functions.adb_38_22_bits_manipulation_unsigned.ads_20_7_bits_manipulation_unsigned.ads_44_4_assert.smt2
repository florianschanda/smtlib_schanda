...
(define-fun dynamic_invariant3 ((temp___expr_321 Int) (temp___is_init_318 Bool) (temp___skip_constant_319 Bool) (temp___do_toplevel_320 Bool)) Bool (=> (or (= temp___is_init_318 true) (<= 1 32)) (in_range2 temp___expr_321)))
...
(assert (and (= bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__mask__assume (make_mask o)) (= bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__mask__assume (shift_right ((_ int2bv 32) 4294967295) (- 32 o)))))
(assert (= bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__mask__assume mask))
(assert true)
(assert true)
(assert (and (= o1 (shift_right value from)) (= o1 (ite (and (<= 1 32) (<= 32 8)) ((_ zero_extend 24) (ite (< from 8) (bvlshr ((_ extract 7 0) value) ((_ int2bv 8) from)) ((_ int2bv 8) 0))) (ite (and (<= 9 32) (<= 32 16)) ((_ zero_extend 16) (ite (< from 16) (bvlshr ((_ extract 15 0) value) ((_ int2bv 16) from)) ((_ int2bv 16) 0))) (ite (and (<= 17 32) (<= 32 32)) (bvlshr value ((_ int2bv 32) from)) ((_ extract 31 0) (bvlshr ((_ zero_extend 32) value) ((_ int2bv 64) from)))))))))
(assert (= o2 (bvand o1 mask)))
(assert (= (mk_t__ref result) (mk_t__ref result__)))
(assert (= result__1 o2))
(assert (not (bvule result__1 mask)))
(check-sat)
(exit)
