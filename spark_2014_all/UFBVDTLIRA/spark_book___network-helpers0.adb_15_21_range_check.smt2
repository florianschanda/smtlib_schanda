...
(define-fun dynamic_invariant1 ((temp___expr_141 (_ BitVec 16)) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool true)
(declare-const value (_ BitVec 16))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(declare-const msb (_ BitVec 8))
(declare-const lsb (_ BitVec 8))
(declare-const o (_ BitVec 16))
(declare-const o1 (_ BitVec 16))
(declare-const result (_ BitVec 8))
(declare-const msb1 (_ BitVec 8))
(assert true)
(assert true)
(assert true)
(assert (= result msb))
(assert (= msb1 ((_ extract 7 0) (bvand value ((_ int2bv 16) 255)))))
