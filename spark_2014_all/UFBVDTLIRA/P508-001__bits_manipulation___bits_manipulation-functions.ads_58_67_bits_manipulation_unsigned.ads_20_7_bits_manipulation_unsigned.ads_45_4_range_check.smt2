...
(assert (bvule ((_ int2bv 64) 0) val__))
(assert (bvule val__ ((_ int2bv 64) 18446744073709551615)))
(assert (not (= val__ ((_ int2bv 64) 0))))
(assert (<= 0 n))
(assert (<= n 63))
(assert (= (= result true) (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 n)) (bvuge (shift_right val__ j1) ((_ int2bv 64) 1))))))
(assert (= result true))
(assert (<= n j))
(assert (<= j 63))
