...
(assert (bvule #x0000000000000000 val__))
(assert (bvule val__ #xFFFFFFFFFFFFFFFF))
(assert (not (= val__ #x0000000000000000)))
(assert (<= 0 n))
(assert (<= n 63))
(assert (= (= result true) (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 n)) (bvuge (shift_right val__ j1) #x0000000000000001)))))
(assert (= result true))
(assert (<= n j))
(assert (<= j 63))
