...
(assert (= result2 (ite (= bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__result4 o8) true false)))
(assert (= result2 true))
(assert (and (= o3 (+ (- to__ from) 1)) (in_range2 (+ (- to__ from) 1))))
(assert (and (= o4 (make_mask o3)) (= o4 (shift_right #xFFFFFFFF (- 32 o3)))))
(assert (= result3 (ite (bvule bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__result4 o4) true false)))
(assert (= result3 true))
