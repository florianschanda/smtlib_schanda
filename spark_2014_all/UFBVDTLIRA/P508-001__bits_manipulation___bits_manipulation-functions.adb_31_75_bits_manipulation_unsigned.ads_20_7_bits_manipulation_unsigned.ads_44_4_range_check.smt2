...
(assert (<= from to__))
(assert (and (and (and (and (= bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__len__assume (+ (- to__ from) 1)) (in_range (+ (- to__ from) 1))) (= bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__len__assume len)) (and (in_range len) (and (and (and (and (= o len) (in_range2 len)) (and (= bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__mask__assume (make_mask o)) (= bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__mask__assume (shift_right ((_ int2bv 32) 4294967295) (- 32 o))))) (= bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__mask__assume mask)) (and (and (and (and (= o1 (shift_right value from)) (= o1 (ite (and (<= 1 32) (<= 32 8)) ((_ zero_extend 24) (ite (< from 8) (bvlshr ((_ extract 7 0) value) ((_ int2bv 8) from)) ((_ int2bv 8) 0))) (ite (and (<= 9 32) (<= 32 16)) ((_ zero_extend 16) (ite (< from 16) (bvlshr ((_ extract 15 0) value) ((_ int2bv 16) from)) ((_ int2bv 16) 0))) (ite (and (<= 17 32) (<= 32 32)) (bvlshr value ((_ int2bv 32) from)) ((_ extract 31 0) (bvlshr ((_ zero_extend 32) value) ((_ int2bv 64) from)))))))) (= o2 (bvand o1 mask))) (and (= (mk_t__ref result) (mk_t__ref result__)) (= result__1 o2))) (and (bvule result__1 mask) (and (and (= bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__result1 bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__result2) (= bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__result3 bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__result1)) (and (= (mk_t__ref result1) (mk_t__ref bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__result)) (= bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__result1 result__1)))))))) (and (and (= (mk_t__ref bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__result4) (mk_t__ref bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__result2)) (= result__1 result__2)) (and (= bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__result5 bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__result3) (= result__3 result__1)))))
...
(assert (= result2 (ite (= bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__result4 o9) true false)))
(assert (= result2 true))
(assert (and (= o4 (+ (- to__ from) 1)) (in_range2 (+ (- to__ from) 1))))
(assert (and (= o5 (make_mask o4)) (= o5 (shift_right ((_ int2bv 32) 4294967295) (- 32 o4)))))
(assert (= result3 (ite (bvule bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__result4 o5) true false)))
(assert (= result3 true))
