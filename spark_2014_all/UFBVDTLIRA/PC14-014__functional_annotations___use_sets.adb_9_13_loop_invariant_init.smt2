...
(define-fun dynamic_invariant ((temp___expr_319 Int) (temp___is_init_316 Bool) (temp___skip_constant_317 Bool) (temp___do_toplevel_318 Bool)) Bool (=> (or (= temp___is_init_316 true) (<= 0 2147483647)) (in_range2 temp___expr_319)))
...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (= (to_rep (rec__use_sets__my_sets__cursor__node (us_split_fields3 a))) (to_rep (rec__use_sets__my_sets__cursor__node (us_split_fields3 b)))) true false))
...
(define-fun default_initial_assumption1 ((temp___expr_412 us_rep3) (temp___skip_top_level_413 Bool)) Bool (=> (not (= temp___skip_top_level_413 true)) (and (= (is_empty temp___expr_412) true) (= (length1 temp___expr_412) 0))))
...
(assert (forall ((container us_rep)) (! (let ((result (elements container))) (and (and (and (and (= (length result) (length2 container)) (forall ((temp___429 Int)) (=> (and (in_range4 temp___429) (= (iter_has_element result temp___429) true)) (= (contains (model__ container) (get result temp___429)) true)))) (forall ((item Int)) (=> (and (in_range6 item) (= (contains (model__ container) item) true)) (and (< 0 (find result item)) (= (get result (find result item)) item))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length2 container))) (= (find result (get result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length2 container))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length2 container))) (=> (= (get result i) (get result j)) (= i j)))))))) :pattern ((elements container)))))
...
(assert (forall ((container us_rep)) (! (let ((result (length2 container))) (and (<= result (to_rep (rec__use_sets__my_sets__set__capacity (us_split_discrs1 container)))) (dynamic_invariant6 result true false true))) :pattern ((length2 container)))))
...
(assert (forall ((container us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant4 item true true true) (let ((result (find container item))) (and (=> (< 0 result) (and (<= result (length container)) (= item (get container result)))) (dynamic_invariant6 result true false true)))) :pattern ((find container item))))))
...
(assert true)
(define-fun dynamic_invariant7 ((temp___expr_354 Int) (temp___is_init_351 Bool) (temp___skip_constant_352 Bool) (temp___do_toplevel_353 Bool)) Bool (=> (or (= temp___is_init_351 true) (<= 0 2147483647)) (in_range6 temp___expr_354)))
(assert (forall ((container us_rep4)) (forall ((item Int)) (! (=> (dynamic_invariant7 item true true true) (=> (= (of_int 1) true) (=> (exists ((e1 Int)) (and (and (in_range6 e1) (= (contains container e1) true)) (= e1 item))) (= (contains container item) true)))) :pattern ((contains container item))))))
(assert (forall ((container us_rep4)) (! (dynamic_invariant6 (length4 container) true false true) :pattern ((length4 container)))))
...
(assert (forall ((container us_rep2)) (! (let ((result (length container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant6 result true false true))) :pattern ((length container)))))
...
(assert (forall ((container us_rep3)) (! (dynamic_invariant6 (length1 container) true false true) :pattern ((length1 container)))))
...
(assert true)
(assert (forall ((container us_rep3)) (forall ((key us_rep1)) (! (=> (= (has_key container key) true) (let ((result (witness container key))) (and (= (has_witness container result) true) (dynamic_invariant6 result true false true)))) :pattern ((witness container key))))))
(assert (forall ((container us_rep3)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant6 witness1 true true true) (= (has_witness container witness1) true)) (dynamic_invariant3 (w_get container witness1) true false true)) :pattern ((w_get container witness1))))))
(declare-const cu__split_fields count_type)
(declare-const use_sets__my_find__result count_type)
...
(declare-const temp___859 count_type)
(declare-const i Int)
...
(declare-const temp___858 count_type)
(declare-const o9 Bool)
(declare-const use_sets__my_find__result1 count_type)
(declare-const result count_type)
(declare-const cu__split_fields1 count_type)
(declare-const result1 Bool)
(declare-const cu__split_fields2 count_type)
(declare-const use_sets__my_find__result2 count_type)
(declare-const result2 Bool)
(declare-const result3 Bool)
(declare-const result4 cursor__ref)
(declare-const use_sets__my_find__result3 us_rep1)
...
(declare-const use_sets__my_find__result4 cursor__ref)
(declare-const cu__split_fields5 us_split_fields2)
(declare-const use_sets__my_find__result5 us_rep1)
(declare-const cu__split_fields6 us_split_fields__ref1)
(declare-const use_sets__my_find__result6 cursor__ref)
(declare-const cu__split_fields7 us_split_fields2)
(declare-const use_sets__my_find__result7 us_rep1)
(declare-const cu__split_fields8 us_split_fields__ref1)
(declare-const use_sets__my_find__result8 cursor__ref)
(declare-const cu__split_fields9 us_split_fields2)
(declare-const use_sets__my_find__result9 us_rep1)
(declare-const result7 cursor__ref)
(declare-const use_sets__my_find__result10 us_rep1)
(declare-const use_sets__my_find__result11 cursor__ref)
(declare-const use_sets__my_find__result12 us_rep1)
(declare-const cu__split_fields10 us_split_fields__ref1)
(declare-const use_sets__my_find__result13 cursor__ref)
(declare-const cu__split_fields11 us_split_fields2)
(declare-const use_sets__my_find__result14 us_rep1)
(declare-const cu__split_fields12 us_split_fields__ref1)
(declare-const use_sets__my_find__result15 cursor__ref)
(declare-const cu__split_fields13 us_split_fields2)
(declare-const use_sets__my_find__result16 us_rep1)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___862 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___862)) no_element))
(assert (in_range2 e))
(assert (and (= (mk___rep1 (mk___split_fields1 use_sets__my_find__cu__assume)) (first s)) (ite (= (= (length2 s) 0) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 use_sets__my_find__cu__assume)) no_element) true) (and (= (has_key (positions s) (mk___rep1 (mk___split_fields1 use_sets__my_find__cu__assume))) true) (= (get1 (positions s) (mk___rep1 (mk___split_fields1 use_sets__my_find__cu__assume))) 1)))))
...
(assert (<= 1 i1))
(assert (<= i1 (- (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields1))) 1)))
(assert (not (not (= (get (elements s) i1) e))))
(check-sat)
(exit)
