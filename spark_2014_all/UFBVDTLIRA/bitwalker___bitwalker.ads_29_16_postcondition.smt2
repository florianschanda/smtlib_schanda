...
(assert (= bitwalker__pokebit64__result1 bitwalker__pokebit64__result2))
(assert (= bitwalker__pokebit64__result3 bitwalker__pokebit64__result1))
(assert (and (= o (- 63 left)) (in_range1 (- 63 left))))
(assert (= o1 ((_ int2bv 64) o)))
(assert (= bitwalker__pokebit64__B_1__mask__assume (bvshl #x0000000000000001 o1)))
(assert (= bitwalker__pokebit64__B_1__mask__assume mask))
(assert (=> (= flag true) (= bitwalker__pokebit64__B_1__r__assume (bvor value mask))))
(assert (=> (not (= flag true)) (= bitwalker__pokebit64__B_1__r__assume (bvand value (bvnot mask)))))
(assert (= bitwalker__pokebit64__B_1__r__assume r))
(assert (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i #x000000000000003F)) (=> (not (= i (bvsub #x000000000000003F left_bv))) (= (= (nth_bv r i) true) (= (nth_bv value i) true))))))
(assert (forall ((i Int)) (=> (and (<= 0 i) (<= i 63)) (and (bvule #x0000000000000000 ((_ int2bv 64) i)) (bvule ((_ int2bv 64) i) #x000000000000003F)))))
(assert (= (= flag true) (= (nth_bv r (bvsub #x000000000000003F left_bv)) true)))
(assert (= (mk_t__ref result) (mk_t__ref bitwalker__pokebit64__result)))
(assert (= bitwalker__pokebit64__result1 r))
(assert (= (mk_t__ref bitwalker__pokebit64__result4) (mk_t__ref bitwalker__pokebit64__result2)))
(assert (= bitwalker__pokebit64__result5 bitwalker__pokebit64__result3))
(assert (= result1 bitwalker__pokebit64__result4))
(declare-const i Int)
(assert (<= 0 i))
(assert (<= i 63))
(assert (not (= i (- 63 left))))
(assert (= (nth value i) true))
(assert (not (= (nth bitwalker__pokebit64__result4 i) true)))
(check-sat)
(exit)
