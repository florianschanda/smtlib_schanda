...
(define-fun dynamic_invariant ((temp___expr_699 Int) (temp___is_init_695 Bool) (temp___skip_constant_696 Bool) (temp___do_toplevel_697 Bool) (temp___do_typ_inv_698 Bool)) Bool (=> (or (= temp___is_init_695 true) (<= 1 100)) (in_range2 temp___expr_699)))
(assert (forall ((container us_rep)) (forall ((key1 Int)) (! (=> (dynamic_invariant key1 true true true true) (= (= (contains container key1) true) (exists ((e Int)) (and (and (in_range1 e) (= (contains1 (model__ container) e) true)) (= (my_eq key1 (key e)) true))))) :pattern ((contains container key1))))))
...
(define-fun key_type__ref___projection ((a key_type__ref1)) us_rep3 (key_type__content1 a))
...
(define-fun element1 ((container us_rep) (key1 Int)) Int (element container (find1 container key1)))
...
(define-fun dynamic_invariant3 ((temp___expr_692 Int) (temp___is_init_688 Bool) (temp___skip_constant_689 Bool) (temp___do_toplevel_690 Bool) (temp___do_typ_inv_691 Bool)) Bool (=> (or (= temp___is_init_688 true) (<= 1 100)) (in_range5 temp___expr_692)))
...
(define-fun dynamic_invariant5 ((temp___expr_197 Int) (temp___is_init_193 Bool) (temp___skip_constant_194 Bool) (temp___do_toplevel_195 Bool) (temp___do_typ_inv_196 Bool)) Bool (=> (or (= temp___is_init_193 true) (<= 0 2147483647)) (in_range temp___expr_197)))
...
(assert (forall ((container us_rep1)) (forall ((item Int)) (! (=> (dynamic_invariant1 item true true true true) (let ((result (find container item))) (and (=> (< 0 result) (and (<= result (length1 container)) (= (my_eq item (get container result)) true))) (dynamic_invariant5 result true false true true)))) :pattern ((find container item))))))
...
(define-fun default_initial_assumption1 ((temp___expr_453 us_rep4) (temp___skip_top_level_454 Bool)) Bool (=> (not (= temp___skip_top_level_454 true)) (and (= (is_empty temp___expr_453) true) (= (length2 temp___expr_453) 0))))
...
(assert (forall ((container us_rep)) (! (let ((result (elements container))) (and (and (and (and (= (length1 result) (length container)) (forall ((temp___471 Int)) (=> (and (in_range7 temp___471) (= (iter_has_element result temp___471) true)) (= (contains1 (model__ container) (get result temp___471)) true)))) (forall ((item Int)) (=> (and (in_range1 item) (= (contains1 (model__ container) item) true)) (and (< 0 (find result item)) (= (my_eq (get result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (= (find result (get result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length container))) (=> (= (my_eq (get result i) (get result j)) true) (= i j)))))))) :pattern ((elements container)))))
...
(define-fun dynamic_invariant6 ((temp___expr_386 Int) (temp___is_init_382 Bool) (temp___skip_constant_383 Bool) (temp___do_toplevel_384 Bool) (temp___do_typ_inv_385 Bool)) Bool (=> (or (= temp___is_init_382 true) (<= 1 100)) (in_range1 temp___expr_386)))
(assert (forall ((container us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant6 item true true true true) (=> (= (distinct 1 0) true) (=> (exists ((e Int)) (and (and (in_range1 e) (= (contains1 container e) true)) (= (my_eq e item) true))) (= (contains1 container item) true)))) :pattern ((contains1 container item))))))
(assert (forall ((container us_rep2)) (! (dynamic_invariant5 (length3 container) true false true true) :pattern ((length3 container)))))
(assert (forall ((container us_rep2)) (! (let ((result (is_empty1 container))) (and (= (= result true) (forall ((item Int)) (not (and (in_range1 item) (= (contains1 container item) true))))) (= (= result true) (= (length3 container) 0)))) :pattern ((is_empty1 container)))))
(assert (forall ((left us_rep2) (right us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant6 item true true true true) (= (= (included_except left right item) true) (forall ((e Int)) (=> (and (in_range1 e) (= (contains1 left e) true)) (or (= (contains1 right e) true) (= (my_eq e item) true)))))) :pattern ((included_except left right item))))))
...
(assert (forall ((left us_rep4) (right us_rep4)) (! (= (= (oeq1 left right) true) (and (forall ((key1 us_rep3)) (=> (= (has_key left key1) true) (and (= (has_key right key1) true) (= (get1 right key1) (get1 left key1))))) (forall ((key1 us_rep3)) (=> (= (has_key right key1) true) (= (has_key left key1) true))))) :pattern ((oeq1 left right)))))
...
(assert (forall ((left us_rep2) (right us_rep2)) (forall ((key1 Int)) (! (=> (dynamic_invariant key1 true true true true) (= (= (m_included_except left right key1) true) (forall ((e Int)) (=> (and (in_range1 e) (= (contains1 left e) true)) (or (= (contains1 right e) true) (= (my_eq (key e) key1) true)))))) :pattern ((m_included_except left right key1))))))
...
(assert (forall ((container us_rep)) (forall ((key1 Int)) (! (=> (dynamic_invariant key1 true true true true) (let ((result (find1 container key1))) (ite (forall ((e Int)) (=> (and (in_range1 e) (= (contains1 (model__ container) e) true)) (not (= (my_eq key1 (key e)) true)))) (= (bool_eq3 result no_element) true) (and (= (has_key (positions container) result) true) (= (my_eq (key__2 container result) key1) true))))) :pattern ((find1 container key1))))))
...
(assert (and (= o (element1 (mk___rep l__split_discrs (mk___split_fields l__split_fields)) k)) (and (in_range3 o) (= o (element (mk___rep l__split_discrs (mk___split_fields l__split_fields)) (find1 (mk___rep l__split_discrs (mk___split_fields l__split_fields)) k))))))
