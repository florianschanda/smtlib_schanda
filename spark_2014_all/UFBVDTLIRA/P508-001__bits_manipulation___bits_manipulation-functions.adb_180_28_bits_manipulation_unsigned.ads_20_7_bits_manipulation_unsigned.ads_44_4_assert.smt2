...
(assert true)
(assert (forall ((us_void_param tuple0)) (! (= (= (lemma1 us_void_param) true) (forall ((size Int)) (=> (and (<= 1 size) (<= size 31)) (bvult (make_mask size) (ite (< size 4294967296) (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) size)) ((_ int2bv 32) 0)))))) :pattern ((lemma1 us_void_param)))))
...
(declare-const bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma1__result Bool)
(declare-const o Bool)
(declare-const result Bool)
(declare-const bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma1__result1 Bool)
(declare-const bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma1__result2 Bool)
(declare-const bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma1__result3 Bool)
(declare-const bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma1__result4 Bool)
(declare-const bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma1__result5 Bool)
(assert (= (lemma8 Tuple0) true))
(declare-const size Int)
(assert (<= 1 size))
(assert (<= size 31))
(assert (not (bvult (make_mask size) (ite (< size 4294967296) (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) size)) ((_ int2bv 32) 0)))))
(check-sat)
(exit)
