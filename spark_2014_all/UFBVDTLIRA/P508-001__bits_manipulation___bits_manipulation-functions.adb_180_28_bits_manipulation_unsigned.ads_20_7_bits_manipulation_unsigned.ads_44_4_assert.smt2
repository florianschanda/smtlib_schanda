...
(assert true)
(assert (forall ((us_void_param tuple0)) (! (= (= (lemma1 us_void_param) true) (forall ((size Int)) (=> (and (<= 1 size) (<= size 31)) (bvult (make_mask size) (ite (< size 4294967296) (bvshl #x00000001 ((_ int2bv 32) size)) #x00000000))))) :pattern ((lemma1 us_void_param)))))
...
(assert (<= 1 size))
(assert (<= size 31))
(assert (not (bvult (make_mask size) (ite (< size 4294967296) (bvshl #x00000001 ((_ int2bv 32) size)) #x00000000))))
(check-sat)
(exit)
