...
(define-fun default_initial_assumption ((temp___expr_423 us_rep1) (temp___skip_top_level_424 Bool)) Bool (=> (not (= temp___skip_top_level_424 true)) (= (length1 temp___expr_423) 0)))
...
(define-fun default_initial_assumption1 ((temp___expr_387 us_rep2) (temp___skip_top_level_388 Bool)) Bool (=> (not (= temp___skip_top_level_388 true)) (= (is_empty temp___expr_387) true)))
...
(assert (and (= o (length right)) (and (in_range o) (<= o (to_rep1 (rec__my_sets__m__set__capacity (us_split_discrs1 right)))))))
