...
(declare-fun ch ((_ BitVec 64)) (_ BitVec 8))
(declare-fun ch__function_guard ((_ BitVec 8) (_ BitVec 64)) Bool)
...
(assert (forall ((x86__rcx (_ BitVec 64))) (! (=> (dynamic_invariant x86__rcx true true true true) (let ((result (ch x86__rcx))) (and (= result ((_ extract 7 0) (bvurem (bvudiv (bvand x86__rcx #x000000000000FF00) #x0000000000000100) ((_ int2bv 64) 256)))) (dynamic_invariant1 result true false true true)))) :pattern ((ch x86__rcx)))))
...
(assert (= result rcx))
(assert (= rcx1 (bvor (bvand rcx #xFFFFFFFFFFFF00FF) ((_ zero_extend 48) (bvmul ((_ zero_extend 8) val__) #x0100)))))
(assert (= rcx1 rcx2))
(assert (= rcx3 rcx1))
(assert (not (= (bvand rcx2 #xFFFFFFFFFFFF00FF) (bvand rcx #xFFFFFFFFFFFF00FF))))
(check-sat)
(exit)
