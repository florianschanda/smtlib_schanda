...
(assert (forall ((value1 (_ BitVec 32))) (! (=> (dynamic_invariant value1 true true true true) (= (msb_index_fast_inline value1) (msb_index_fast_inline_always value1))) :pattern ((msb_index_fast_inline value1)))))
(declare-fun msb_index_fast_not_inline ((_ BitVec 32)) Int)
(declare-fun msb_index_fast_not_inline__function_guard (Int (_ BitVec 32)) Bool)
(assert (forall ((value1 (_ BitVec 32))) (! (=> (dynamic_invariant value1 true true true true) (= (msb_index_fast_not_inline value1) (msb_index_fast_inline_always value1))) :pattern ((msb_index_fast_not_inline value1)))))
...
(assert (forall ((value1 (_ BitVec 32))) (! (=> (and (dynamic_invariant value1 true true true true) (not (= value1 #x00000000))) (let ((result (msb_index_slow_inline_always value1))) (and (= (shift_right value1 result) #x00000001) (dynamic_invariant1 result true false true true)))) :pattern ((msb_index_slow_inline_always value1)))))
(declare-fun msb_index_slow_inline ((_ BitVec 32)) Int)
(declare-fun msb_index_slow_inline__function_guard (Int (_ BitVec 32)) Bool)
(assert (forall ((value1 (_ BitVec 32))) (! (=> (and (dynamic_invariant value1 true true true true) (not (= value1 #x00000000))) (let ((result (msb_index_slow_inline value1))) (and (= (shift_right value1 result) #x00000001) (dynamic_invariant1 result true false true true)))) :pattern ((msb_index_slow_inline value1)))))
(assert (forall ((value1 (_ BitVec 32))) (! (=> (dynamic_invariant value1 true true true true) (= (msb_index_slow_inline value1) (msb_index_slow_inline_always value1))) :pattern ((msb_index_slow_inline value1)))))
(declare-fun msb_index_slow_not_inline ((_ BitVec 32)) Int)
(declare-fun msb_index_slow_not_inline__function_guard (Int (_ BitVec 32)) Bool)
(assert (forall ((value1 (_ BitVec 32))) (! (=> (and (dynamic_invariant value1 true true true true) (not (= value1 #x00000000))) (let ((result (msb_index_slow_not_inline value1))) (and (= (shift_right value1 result) #x00000001) (dynamic_invariant1 result true false true true)))) :pattern ((msb_index_slow_not_inline value1)))))
(assert (forall ((value1 (_ BitVec 32))) (! (=> (dynamic_invariant value1 true true true true) (= (msb_index_slow_not_inline value1) (msb_index_slow_inline_always value1))) :pattern ((msb_index_slow_not_inline value1)))))
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const result__ Int)
(assert (not (= value #x00000000)))
(assert (=> (<= 0 31) (in_range result__)))
(assert (not (= 2 0)))
(assert (not (not (= value #x00000000))))
(check-sat)
(exit)
