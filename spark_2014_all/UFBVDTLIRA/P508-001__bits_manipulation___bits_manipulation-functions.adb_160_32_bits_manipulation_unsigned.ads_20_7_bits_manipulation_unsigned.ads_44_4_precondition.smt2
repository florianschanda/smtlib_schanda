...
(assert (forall ((value1 (_ BitVec 32))) (! (=> (dynamic_invariant value1 true true true) (= (msb_index_fast_inline value1) (msb_index_fast_inline_always value1))) :pattern ((msb_index_fast_inline value1)))))
...
(assert (forall ((value1 (_ BitVec 32))) (! (=> (dynamic_invariant value1 true true true) (= (msb_index_fast_not_inline value1) (msb_index_fast_inline_always value1))) :pattern ((msb_index_fast_not_inline value1)))))
...
(assert (forall ((value1 (_ BitVec 32))) (! (=> (and (dynamic_invariant value1 true true true) (not (= value1 ((_ int2bv 32) 0)))) (let ((result (msb_index_slow_inline_always value1))) (and (= (shift_right value1 result) ((_ int2bv 32) 1)) (dynamic_invariant1 result true false true)))) :pattern ((msb_index_slow_inline_always value1)))))
(declare-fun msb_index_slow_inline ((_ BitVec 32)) Int)
(declare-fun msb_index_slow_inline__function_guard (Int (_ BitVec 32)) Bool)
(assert (forall ((value1 (_ BitVec 32))) (! (=> (and (dynamic_invariant value1 true true true) (not (= value1 ((_ int2bv 32) 0)))) (let ((result (msb_index_slow_inline value1))) (and (= (shift_right value1 result) ((_ int2bv 32) 1)) (dynamic_invariant1 result true false true)))) :pattern ((msb_index_slow_inline value1)))))
(assert (forall ((value1 (_ BitVec 32))) (! (=> (dynamic_invariant value1 true true true) (= (msb_index_slow_inline value1) (msb_index_slow_inline_always value1))) :pattern ((msb_index_slow_inline value1)))))
...
(assert (forall ((value1 (_ BitVec 32))) (! (=> (and (dynamic_invariant value1 true true true) (not (= value1 ((_ int2bv 32) 0)))) (let ((result (msb_index_slow_not_inline value1))) (and (= (shift_right value1 result) ((_ int2bv 32) 1)) (dynamic_invariant1 result true false true)))) :pattern ((msb_index_slow_not_inline value1)))))
(assert (forall ((value1 (_ BitVec 32))) (! (=> (dynamic_invariant value1 true true true) (= (msb_index_slow_not_inline value1) (msb_index_slow_inline_always value1))) :pattern ((msb_index_slow_not_inline value1)))))
...
(assert (not (= 2 0)))
(assert (not (not (= value ((_ int2bv 32) 0)))))
(check-sat)
(exit)
