...
(assert (not (or (< (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (to_rep1 (rec__p__my_sets__set__capacity l__split_discrs))) (= (contains (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) e) true))))
(check-sat)
(exit)
