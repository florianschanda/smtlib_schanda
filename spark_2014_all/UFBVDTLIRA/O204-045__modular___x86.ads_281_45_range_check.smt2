...
(assert (= x86__edi__result1 ((_ extract 31 0) (bvand rdi ((_ int2bv 64) 4294967295)))))
(assert (= (mk_t__ref x86__edi__result4) (mk_t__ref x86__edi__result2)))
(assert (= x86__edi__result5 x86__edi__result3))
(assert (not (bvule ((_ zero_extend 32) ((_ int2bv 32) 0)) (bvand rdi ((_ int2bv 64) 4294967295)))))
(check-sat)
(exit)
