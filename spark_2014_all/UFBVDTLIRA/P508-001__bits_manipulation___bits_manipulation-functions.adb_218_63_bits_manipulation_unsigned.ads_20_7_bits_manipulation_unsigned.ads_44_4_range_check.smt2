...
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- i2 1))) (= (make_mask j1) (bvsub (ite (< j1 4294967296) (bvshl #x00000001 ((_ int2bv 32) j1)) #x00000000) #x00000001)))))
(assert (and (=> (<= 2 31) (in_range2 i2)) (and (<= 2 i2) (<= i2 31))))
(assert (<= 1 j))
(assert (<= j (- i2 1)))
(assert (=> (< j 4294967296) (= o (bvshl #x00000001 ((_ int2bv 32) j)))))
(assert (=> (not (< j 4294967296)) (= o #x00000000)))
(assert (= o1 (bvsub o #x00000001)))
