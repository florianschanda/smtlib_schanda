...
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- i2 1))) (= (make_mask j1) (bvsub (ite (< j1 4294967296) (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) j1)) ((_ int2bv 32) 0)) ((_ int2bv 32) 1))))))
(assert (and (=> (<= 2 31) (in_range2 i2)) (and (<= 2 i2) (<= i2 31))))
(assert (<= 1 j))
(assert (<= j (- i2 1)))
(assert (=> (< j 4294967296) (= o1 (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) j)))))
(assert (=> (not (< j 4294967296)) (= o1 ((_ int2bv 32) 0))))
(assert (= o2 (bvsub o1 ((_ int2bv 32) 1))))
