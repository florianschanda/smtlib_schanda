...
(assert (and (= o (readreglow8 regnew)) (= o ((_ extract 7 0) (bvand regnew ((_ int2bv 64) 255))))))
(assert (= o1 (ite (= o val__) true false)))
(assert (= o2 (ite (= o1 true) (ite (= (bvand regnew ((_ int2bv 64) 18446744073709551360)) (bvand regold ((_ int2bv 64) 18446744073709551360))) true false) false)))
...
(assert (not (= (readreglow8 regnew) val__)))
(check-sat)
(exit)
