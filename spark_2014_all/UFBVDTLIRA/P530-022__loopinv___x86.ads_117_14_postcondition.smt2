...
(assert (and (= o (readreglow8 regnew)) (= o ((_ extract 7 0) (bvand regnew #x00000000000000FF)))))
(assert (= o1 (ite (= o val__) true false)))
(assert (= o2 (ite (= o1 true) (ite (= (bvand regnew #xFFFFFFFFFFFFFF00) (bvand regold #xFFFFFFFFFFFFFF00)) true false) false)))
(assert (= result x86__writereglow8post__result))
(assert (= x86__writereglow8post__result1 o2))
(assert (= (mk_bool__ref x86__writereglow8post__result4) (mk_bool__ref x86__writereglow8post__result2)))
...
(assert (not (= (bvand regnew #xFFFFFFFFFFFFFF00) (bvand regold #xFFFFFFFFFFFFFF00))))
(check-sat)
(exit)
