...
(declare-const x86__r10l__result (_ BitVec 8))
(declare-const result (_ BitVec 8))
(declare-const x86__r10l__result1 (_ BitVec 8))
(declare-const x86__r10l__result2 (_ BitVec 8))
(declare-const x86__r10l__result3 (_ BitVec 8))
(declare-const x86__r10l__result4 (_ BitVec 8))
(declare-const x86__r10l__result5 (_ BitVec 8))
(declare-const result1 (_ BitVec 8))
(assert (= x86__r10l__result1 x86__r10l__result2))
(assert (= x86__r10l__result3 x86__r10l__result1))
(assert (= result x86__r10l__result))
(assert (= x86__r10l__result1 ((_ extract 7 0) (bvand r10 ((_ int2bv 64) 255)))))
(assert (= (mk_t__ref x86__r10l__result4) (mk_t__ref x86__r10l__result2)))
(assert (= x86__r10l__result5 x86__r10l__result3))
(assert (= result1 x86__r10l__result4))
(assert (not (= x86__r10l__result4 (readreglow8 r10))))
(check-sat)
(exit)
