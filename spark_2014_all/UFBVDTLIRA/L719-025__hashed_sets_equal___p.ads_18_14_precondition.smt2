...
(assert (and (= (mk___rep1 (mk___split_fields1 o)) (find (mk___rep l__split_discrs (mk___split_fields l__split_fields3)) e)) (ite (ite (= (contains (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) e) false) true false) (= (bool_eq1 (mk___rep1 (mk___split_fields1 o)) no_element) true) (and (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (mk___rep1 (mk___split_fields1 o))) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (mk___rep1 (mk___split_fields1 o))) (find2 (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) e))) (= (my_eq (element (mk___rep l__split_discrs (mk___split_fields l__split_fields3)) (mk___rep1 (mk___split_fields1 o))) e) true)))))
