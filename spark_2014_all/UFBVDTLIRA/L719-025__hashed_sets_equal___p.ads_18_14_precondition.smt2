...
(assert (and (= o1 (find (mk___rep l__split_discrs (mk___split_fields l__split_fields3)) e)) (ite (ite (= (contains (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) e) false) true false) (= (bool_eq1 o1 no_element) true) (and (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) o1) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) o1) (find2 (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) e))) (= (my_eq (element (mk___rep l__split_discrs (mk___split_fields l__split_fields3)) o1) e) true)))))
