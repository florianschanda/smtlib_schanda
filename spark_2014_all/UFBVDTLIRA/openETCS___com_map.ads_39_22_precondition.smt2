...
(define-fun dynamic_invariant ((temp___expr_288 Int) (temp___is_init_285 Bool) (temp___skip_constant_286 Bool) (temp___do_toplevel_287 Bool)) Bool (=> (or (= temp___is_init_285 true) (<= 1 10000)) (in_range temp___expr_288)))
...
(define-fun dynamic_invariant1 ((temp___expr_337 Int) (temp___is_init_334 Bool) (temp___skip_constant_335 Bool) (temp___do_toplevel_336 Bool)) Bool (=> (or (= temp___is_init_334 true) (<= 1 10000)) (in_range2 temp___expr_337)))
...
(define-fun default_initial_assumption ((temp___expr_373 us_rep1) (temp___skip_top_level_374 Bool)) Bool (=> (not (= temp___skip_top_level_374 true)) (and (= (is_empty temp___expr_373) true) (= (length temp___expr_373) 0))))
(assert true)
...
(define-fun dynamic_invariant4 ((temp___expr_366 Int) (temp___is_init_363 Bool) (temp___skip_constant_364 Bool) (temp___do_toplevel_365 Bool)) Bool (=> (or (= temp___is_init_363 true) (<= 1 10000)) (in_range4 temp___expr_366)))
(assert (forall ((container us_rep1)) (forall ((key Int)) (! (=> (dynamic_invariant4 key true true true) (=> (= (of_int 1) true) (=> (exists ((k Int)) (and (and (in_range4 k) (= (has_key container k) true)) (= k key))) (= (has_key container key) true)))) :pattern ((has_key container key))))))
...
(assert (forall ((container us_rep1)) (forall ((key Int)) (! (=> (and (dynamic_invariant4 key true true true) (= (has_key container key) true)) (=> (= (of_int 1) true) (and (= (= (get container key) true) (= (w_get container (witness container key)) true)) (forall ((k Int)) (=> (and (in_range4 k) (= (has_key container k) true)) (= (= k key) (= (witness container key) (witness container k)))))))) :pattern ((get container key))))))
(assert (forall ((container us_rep1)) (! (dynamic_invariant3 (length container) true false true) :pattern ((length container)))))
...
(assert true)
(assert (forall ((container us_rep1)) (forall ((key Int)) (! (=> (and (dynamic_invariant4 key true true true) (= (has_key container key) true)) (let ((result (witness container key))) (and (= (has_witness container result) true) (dynamic_invariant3 result true false true)))) :pattern ((witness container key))))))
(assert true)
