...
(declare-const dummy rbc_riu_id_t)
...
(define-fun dynamic_invariant ((temp___expr_315 Int) (temp___is_init_311 Bool) (temp___skip_constant_312 Bool) (temp___do_toplevel_313 Bool) (temp___do_typ_inv_314 Bool)) Bool (=> (or (= temp___is_init_311 true) (<= 1 10000)) (in_range temp___expr_315)))
...
(define-fun dynamic_invariant1 ((temp___expr_367 Int) (temp___is_init_363 Bool) (temp___skip_constant_364 Bool) (temp___do_toplevel_365 Bool) (temp___do_typ_inv_366 Bool)) Bool (=> (or (= temp___is_init_363 true) (<= 1 10000)) (in_range2 temp___expr_367)))
...
(define-fun default_initial_assumption ((temp___expr_408 us_rep1) (temp___skip_top_level_409 Bool)) Bool (=> (not (= temp___skip_top_level_409 true)) (and (= (is_empty temp___expr_408) true) (= (length temp___expr_408) 0))))
(assert true)
...
(define-fun dynamic_invariant4 ((temp___expr_400 Int) (temp___is_init_396 Bool) (temp___skip_constant_397 Bool) (temp___do_toplevel_398 Bool) (temp___do_typ_inv_399 Bool)) Bool (=> (or (= temp___is_init_396 true) (<= 1 10000)) (in_range4 temp___expr_400)))
(assert (forall ((container us_rep1)) (forall ((key Int)) (! (=> (dynamic_invariant4 key true true true true) (=> (= (distinct 1 0) true) (=> (exists ((k Int)) (and (and (in_range4 k) (= (has_key container k) true)) (= k key))) (= (has_key container key) true)))) :pattern ((has_key container key))))))
...
(assert (forall ((container us_rep1)) (forall ((key Int)) (! (=> (and (dynamic_invariant4 key true true true true) (= (has_key container key) true)) (=> (= (distinct 1 0) true) (and (= (= (get container key) true) (= (w_get container (witness container key)) true)) (forall ((k Int)) (=> (and (in_range4 k) (= (has_key container k) true)) (= (= k key) (= (witness container key) (witness container k)))))))) :pattern ((get container key))))))
(assert (forall ((container us_rep1)) (! (dynamic_invariant3 (length container) true false true true) :pattern ((length container)))))
(assert (forall ((left us_rep1) (right us_rep1)) (! (= (= (oeq2 left right) true) (and (forall ((key Int)) (=> (and (in_range4 key) (= (has_key left key) true)) (and (= (has_key right key) true) (= (= (get right key) true) (= (get left key) true))))) (forall ((key Int)) (=> (and (in_range4 key) (= (has_key right key) true)) (= (has_key left key) true))))) :pattern ((oeq2 left right)))))
(assert (forall ((container us_rep1)) (! (= (= (is_empty container) true) (forall ((key Int)) (not (and (in_range4 key) (= (has_key container key) true))))) :pattern ((is_empty container)))))
(declare-fun has_witness (us_rep1 Int) Bool)
(declare-fun has_witness__function_guard (Bool us_rep1 Int) Bool)
(assert true)
(assert (forall ((container us_rep1)) (forall ((key Int)) (! (=> (and (dynamic_invariant4 key true true true true) (= (has_key container key) true)) (let ((result (witness container key))) (and (= (has_witness container result) true) (dynamic_invariant3 result true false true true)))) :pattern ((witness container key))))))
(assert true)
(declare-const result Bool)
(assert (in_range id))
(assert (and (= result (has_key (model__ map1) id)) (= (= result true) (= (has_key (model__ map1) id) true))))
(assert (= result true))
(assert (not (= (has_key (model__ map1) id) true)))
(check-sat)
(exit)
