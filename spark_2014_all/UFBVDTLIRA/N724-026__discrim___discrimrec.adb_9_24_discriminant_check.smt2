...
(assert (= (to_rep1 o1) ((_ extract 31 0) (bvurem (to_rep (rec__discrimrec__register_type__value_64 (us_split_fields1 reg))) #x0000000100000000))))
(assert (= (to_rep1 o2) #x00000000))
(assert (= dummy o3))
(assert (= o2 o4))
(assert (= o1 o5))
(assert (= dummy1 o6))
...
(assert (= o24 o12))
(assert (= true o25))
(assert (= (mk___rep (mk___split_discrs o26) (mk___split_fields o27 o28 o29 o30 o31 o32 o33 o34 o35 o36) o37) (mk___rep (mk___split_discrs o14) (mk___split_fields o15 o16 o17 o18 o19 o20 o21 o22 o23 o24) o25)))
(assert (not (= 1 (to_rep2 o26))))
(check-sat)
(exit)
