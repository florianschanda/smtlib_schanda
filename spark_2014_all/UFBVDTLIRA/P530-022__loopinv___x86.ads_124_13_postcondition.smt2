...
(assert (forall ((regold (_ BitVec 64)) (regnew (_ BitVec 64))) (forall ((val__1 (_ BitVec 8))) (! (=> (and (and (dynamic_invariant regold true true true) (dynamic_invariant regnew true true true)) (dynamic_invariant1 val__1 true true true)) (= (= (writereghigh8post regold regnew val__1) true) (and (= (readreghigh8 regnew) val__1) (= (bvand regnew ((_ int2bv 64) 18446744073709486335)) (bvand regold ((_ int2bv 64) 18446744073709486335)))))) :pattern ((writereghigh8post regold regnew val__1))))))
(assert (forall ((regold (_ BitVec 64)) (regnew (_ BitVec 64))) (forall ((val__1 (_ BitVec 8))) (! (= (= (writereghigh8post regold regnew val__1) true) (and (= (readreghigh8 regnew) val__1) (= (bvand regnew ((_ int2bv 64) 18446744073709486335)) (bvand regold ((_ int2bv 64) 18446744073709486335))))) :pattern ((writereghigh8post regold regnew val__1))))))
