...
(assert (forall ((regold (_ BitVec 64)) (regnew (_ BitVec 64))) (forall ((val__ (_ BitVec 8))) (! (=> (and (and (dynamic_invariant regold true true true true) (dynamic_invariant regnew true true true true)) (dynamic_invariant1 val__ true true true true)) (= (= (writereghigh8post regold regnew val__) true) (and (= (readreghigh8 regnew) val__) (= (bvand regnew #xFFFFFFFFFFFF00FF) (bvand regold #xFFFFFFFFFFFF00FF))))) :pattern ((writereghigh8post regold regnew val__))))))
(assert (forall ((regold (_ BitVec 64)) (regnew (_ BitVec 64))) (forall ((val__ (_ BitVec 8))) (! (= (= (writereghigh8post regold regnew val__) true) (and (= (readreghigh8 regnew) val__) (= (bvand regnew #xFFFFFFFFFFFF00FF) (bvand regold #xFFFFFFFFFFFF00FF)))) :pattern ((writereghigh8post regold regnew val__))))))
