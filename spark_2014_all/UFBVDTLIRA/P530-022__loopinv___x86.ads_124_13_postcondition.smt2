...
(declare-fun writereghigh8post ((_ BitVec 64) (_ BitVec 64) (_ BitVec 8)) Bool)
(declare-fun writereghigh8post__function_guard (Bool (_ BitVec 64) (_ BitVec 64) (_ BitVec 8)) Bool)
(declare-fun readreghigh8 ((_ BitVec 64)) (_ BitVec 8))
(declare-fun readreghigh8__function_guard ((_ BitVec 8) (_ BitVec 64)) Bool)
(assert (forall ((regold (_ BitVec 64)) (regnew (_ BitVec 64))) (forall ((val__1 (_ BitVec 8))) (! (=> (and (and (dynamic_invariant regold true true true true) (dynamic_invariant regnew true true true true)) (dynamic_invariant1 val__1 true true true true)) (= (= (writereghigh8post regold regnew val__1) true) (and (= (readreghigh8 regnew) val__1) (= (bvand regnew #xFFFFFFFFFFFF00FF) (bvand regold #xFFFFFFFFFFFF00FF))))) :pattern ((writereghigh8post regold regnew val__1))))))
(assert (forall ((regold (_ BitVec 64)) (regnew (_ BitVec 64))) (forall ((val__1 (_ BitVec 8))) (! (= (= (writereghigh8post regold regnew val__1) true) (and (= (readreghigh8 regnew) val__1) (= (bvand regnew #xFFFFFFFFFFFF00FF) (bvand regold #xFFFFFFFFFFFF00FF)))) :pattern ((writereghigh8post regold regnew val__1))))))
...
(assert (= result reg))
(assert (= reg1 (bvor (bvand reg #xFFFFFFFFFFFF00FF) ((_ zero_extend 48) (bvmul ((_ zero_extend 8) val__) #x0100)))))
(assert (= reg1 reg2))
(assert (= reg3 reg1))
(assert (not (= (writereghigh8post reg reg2 val__) true)))
(check-sat)
(exit)
