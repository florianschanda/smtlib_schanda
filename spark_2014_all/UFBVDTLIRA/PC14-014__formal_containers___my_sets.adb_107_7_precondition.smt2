...
(assert (= o4 o2))
(assert (= o5 o3))
(assert (and (and (and (and (and (and (= (length (mk___rep1 l__split_discrs my_sets__n__insert__2__container__fields)) (+ (length (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) 1)) (= (contains (model__ (mk___rep1 l__split_discrs my_sets__n__insert__2__container__fields)) o33) true)) (= (bool_eq (element (mk___rep1 l__split_discrs my_sets__n__insert__2__container__fields) (find1 (mk___rep1 l__split_discrs my_sets__n__insert__2__container__fields) o33)) o33) true)) (= (ole (model__ (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) (model__ (mk___rep1 l__split_discrs my_sets__n__insert__2__container__fields))) true)) (= (included_except (model__ (mk___rep1 l__split_discrs my_sets__n__insert__2__container__fields)) (model__ (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) o33) true)) (= (mapping_preserved (elements (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) (elements (mk___rep1 l__split_discrs my_sets__n__insert__2__container__fields)) (positions (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) (positions (mk___rep1 l__split_discrs my_sets__n__insert__2__container__fields))) true)) (= (keys_included_except (positions (mk___rep1 l__split_discrs my_sets__n__insert__2__container__fields)) (positions (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) (find1 (mk___rep1 l__split_discrs my_sets__n__insert__2__container__fields) o33)) true)))
...
(assert (= o10 o8))
(assert (= o11 o9))
(assert (and (and (and (and (and (and (= (length (mk___rep1 l__split_discrs my_sets__n__insert__2__container__fields1)) (+ (length (mk___rep1 l__split_discrs l__split_fields1)) 1)) (= (contains (model__ (mk___rep1 l__split_discrs my_sets__n__insert__2__container__fields1)) o32) true)) (= (bool_eq (element (mk___rep1 l__split_discrs my_sets__n__insert__2__container__fields1) (find1 (mk___rep1 l__split_discrs my_sets__n__insert__2__container__fields1) o32)) o32) true)) (= (ole (model__ (mk___rep1 l__split_discrs l__split_fields1)) (model__ (mk___rep1 l__split_discrs my_sets__n__insert__2__container__fields1))) true)) (= (included_except (model__ (mk___rep1 l__split_discrs my_sets__n__insert__2__container__fields1)) (model__ (mk___rep1 l__split_discrs l__split_fields1)) o32) true)) (= (mapping_preserved (elements (mk___rep1 l__split_discrs l__split_fields1)) (elements (mk___rep1 l__split_discrs my_sets__n__insert__2__container__fields1)) (positions (mk___rep1 l__split_discrs l__split_fields1)) (positions (mk___rep1 l__split_discrs my_sets__n__insert__2__container__fields1))) true)) (= (keys_included_except (positions (mk___rep1 l__split_discrs my_sets__n__insert__2__container__fields1)) (positions (mk___rep1 l__split_discrs l__split_fields1)) (find1 (mk___rep1 l__split_discrs my_sets__n__insert__2__container__fields1) o32)) true)))
...
(assert (not (or (< (length (mk___rep1 l__split_discrs l__split_fields6)) (to_rep3 (rec__my_sets__n__set__capacity l__split_discrs))) (= (contains (model__ (mk___rep1 l__split_discrs l__split_fields6)) o30) true))))
(check-sat)
(exit)
