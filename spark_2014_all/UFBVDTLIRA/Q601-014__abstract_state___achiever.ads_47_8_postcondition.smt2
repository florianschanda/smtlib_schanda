...
(assert (=> (ite (= (read (get_state_item (mk___split_fields1 (mk___rep (mk___split_fields state_item__split_fields state_item__split_fields1))))) false) true false) (and (= (prf_do_something st 0 (get_internal_state my_internal_state) (get_internal_state my_internal_state)) true) (= (read (get_state_item (mk___split_fields1 (mk___rep (mk___split_fields state_item__split_fields6 state_item__split_fields7))))) true))))
(assert (=> (= (read (get_state_item (mk___split_fields1 (mk___rep (mk___split_fields state_item__split_fields state_item__split_fields1))))) true) (= (bool_eq1 (get_state_item (mk___split_fields1 (mk___rep (mk___split_fields state_item__split_fields6 state_item__split_fields7)))) (get_state_item (mk___split_fields1 (mk___rep (mk___split_fields state_item__split_fields state_item__split_fields1))))) true)))
(assert (not (= (prf_do_stuff st (get_internal_state my_internal_state) (get_internal_state my_internal_state)) true)))
(check-sat)
(exit)
