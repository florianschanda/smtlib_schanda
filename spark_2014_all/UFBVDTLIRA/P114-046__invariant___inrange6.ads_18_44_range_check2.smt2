...
(declare-const inrange6__inrange64__result1 Bool)
(declare-const inrange6__inrange64__result2 Bool)
(declare-const inrange6__inrange64__result3 Bool)
(declare-const i2 (_ BitVec 64))
(declare-const matched3 Bool)
(declare-const inrange6__inrange64__result4 Bool)
(declare-const i3 (_ BitVec 64))
(declare-const matched4 Bool)
(declare-const inrange6__inrange64__result5 Bool)
(define-fun matched5 () bool__ref (mk_bool__ref matched))
...
(assert (=> (bvule bottom (bvadd (bvsub #xFFFFFFFFFFFFFFFF range_size) #x0000000000000001)) (= (mk_bool__ref result1) matched5)))
(assert (=> (bvule bottom (bvadd (bvsub #xFFFFFFFFFFFFFFFF range_size) #x0000000000000001)) (= matched1 (ite (bvule bottom var) (ite (bvule var (bvsub (bvadd bottom range_size) #x0000000000000001)) true false) false))))
(assert (=> (not (bvule bottom (bvadd (bvsub #xFFFFFFFFFFFFFFFF range_size) #x0000000000000001))) (= (mk_bool__ref result2) matched5)))
(assert (=> (not (bvule bottom (bvadd (bvsub #xFFFFFFFFFFFFFFFF range_size) #x0000000000000001))) (= matched2 (ite (= (ite (bvule bottom var) (distinct 1 0) false) false) (ite (bvult var (bvsub (bvsub range_size (bvsub #xFFFFFFFFFFFFFFFF bottom)) #x0000000000000001)) true false) true))))
(assert (=> (not (bvule bottom (bvadd (bvsub #xFFFFFFFFFFFFFFFF range_size) #x0000000000000001))) (= matched1 matched2)))
(assert (= inrange6__inrange64__result1 inrange6__inrange64__result2))
(assert (= inrange6__inrange64__result3 inrange6__inrange64__result1))
(assert (= (mk_bool__ref result3) (mk_bool__ref inrange6__inrange64__result)))
(assert (= inrange6__inrange64__result1 matched1))
(assert (= (mk_bool__ref inrange6__inrange64__result4) (mk_bool__ref inrange6__inrange64__result2)))
(assert (= matched1 matched3))
(assert (= i1 i2))
(assert (= inrange6__inrange64__result5 inrange6__inrange64__result3))
