...
(assert (= (= matched2 true) (and (bvugt i2 #x0000000000000000) (exists ((n (_ BitVec 64))) (and (and (bvule #x0000000000000000 n) (bvule n (bvsub i2 #x0000000000000001))) (= var (bvadd bottom n)))))))
(assert (not (= matched2 true)))
(assert (and (bvult i2 range_size) (not (= matched2 true))))
(assert (= temp___240 result2))
(assert (= temp___2401 i2))
