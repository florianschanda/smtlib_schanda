...
(assert (forall ((value (_ BitVec 8))) (forall ((from Int) (to__ Int)) (! (=> (and (and (and (dynamic_invariant1 value true true true true) (dynamic_invariant3 from true true true true)) (dynamic_invariant3 to__ true true true true)) (<= from to__)) (let ((result (extract_bits_inline_always value from to__))) (and (and (= result (bvand (shift_right value from) (make_mask (+ (- to__ from) 1)))) (and (bvule result (make_mask (+ (- to__ from) 1))) (= (shift_left result from) (bvand value (shift_left (make_mask (+ (- to__ from) 1)) from))))) (dynamic_invariant1 result true false true true)))) :pattern ((extract_bits_inline_always value from to__))))))
...
(declare-const bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline__result (_ BitVec 8))
(declare-const o (_ BitVec 8))
(declare-const result (_ BitVec 8))
(declare-const bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline__result1 (_ BitVec 8))
(declare-const bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline__result2 (_ BitVec 8))
(declare-const bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline__result3 (_ BitVec 8))
(declare-const bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline__result4 (_ BitVec 8))
(declare-const bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline__result5 (_ BitVec 8))
(declare-const result1 (_ BitVec 8))
(assert (in_range2 from))
(assert (in_range2 to__))
(assert (<= from to__))
(assert (= bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline__result1 bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline__result2))
(assert (= bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline__result3 bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline__result1))
...
(assert (= (mk_t__ref result) (mk_t__ref bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline__result)))
(assert (= bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline__result1 o))
(assert (= (mk_t__ref bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline__result4) (mk_t__ref bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline__result2)))
(assert (= bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline__result5 bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline__result3))
(assert (= result1 bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline__result4))
(assert (not (= bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline__result4 (bvand (shift_right value from) (make_mask (+ (- to__ from) 1))))))
(check-sat)
(exit)
