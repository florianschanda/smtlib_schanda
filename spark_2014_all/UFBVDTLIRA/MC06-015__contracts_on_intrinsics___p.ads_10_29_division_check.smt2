...
(assert (forall ((value (_ BitVec 32))) (forall ((amount Int)) (! (=> (and (and (dynamic_invariant value true true true) (dynamic_invariant1 amount true true true)) (<= amount 16)) (let ((result (shift_right value amount))) (and (= result (bvudiv value (ite (< amount 4294967296) (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) amount)) ((_ int2bv 32) 0)))) (dynamic_invariant result true false true)))) :pattern ((shift_right value amount))))))
...
(assert (and (= o (shift_right a 2)) (= o (bvudiv a (ite (< 2 4294967296) (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) 2)) ((_ int2bv 32) 0))))))
(assert (= (mk_t__ref result) (mk_t__ref a)))
(assert (= a1 o))
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (not (= ((_ int2bv 32) 4) #x00000000))))
(check-sat)
(exit)
