...
(define-fun dynamic_invariant1 ((temp___expr_158 (_ BitVec 32)) (temp___is_init_154 Bool) (temp___skip_constant_155 Bool) (temp___do_toplevel_156 Bool) (temp___do_typ_inv_157 Bool)) Bool true)
(assert (forall ((value (_ BitVec 32))) (forall ((amount Int)) (! (=> (and (and (dynamic_invariant1 value true true true true) (dynamic_invariant amount true true true true)) (<= amount 16)) (let ((result (shift_right value amount))) (and (= result (bvudiv value (ite (< amount 4294967296) (bvshl #x00000001 ((_ int2bv 32) amount)) #x00000000))) (dynamic_invariant1 result true false true true)))) :pattern ((shift_right value amount))))))
