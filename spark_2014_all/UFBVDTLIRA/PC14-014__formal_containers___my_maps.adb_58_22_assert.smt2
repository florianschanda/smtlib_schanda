...
(define-fun dynamic_invariant3 ((temp___expr_907 us_rep) (temp___is_init_903 Bool) (temp___skip_constant_904 Bool) (temp___do_toplevel_905 Bool) (temp___do_typ_inv_906 Bool)) Bool (=> (not (= temp___skip_constant_904 true)) (in_range6 10 r9b temp___expr_907)))
(define-fun default_initial_assumption ((temp___expr_910 us_rep) (temp___skip_top_level_911 Bool)) Bool (and (and (= (to_rep1 (rec__my_maps__n__map__capacity (us_split_discrs1 temp___expr_910))) 10) (= (to_rep (rec__my_maps__n__map__modulus (us_split_discrs1 temp___expr_910))) r9b)) (=> (not (= temp___skip_top_level_911 true)) (= (is_empty temp___expr_910) true))))
...
(define-fun dynamic_invariant4 ((temp___expr_919 us_rep) (temp___is_init_915 Bool) (temp___skip_constant_916 Bool) (temp___do_toplevel_917 Bool) (temp___do_typ_inv_918 Bool)) Bool (=> (not (= temp___skip_constant_916 true)) (in_range7 10 r12b temp___expr_919)))
(define-fun default_initial_assumption1 ((temp___expr_922 us_rep) (temp___skip_top_level_923 Bool)) Bool (and (and (= (to_rep1 (rec__my_maps__n__map__capacity (us_split_discrs1 temp___expr_922))) 10) (= (to_rep (rec__my_maps__n__map__modulus (us_split_discrs1 temp___expr_922))) r12b)) (=> (not (= temp___skip_top_level_923 true)) (= (is_empty temp___expr_922) true))))
...
(assert (= (integerqtint rliteral5) 4))
(declare-const rliteral6 positive)
(assert (= (positiveqtint rliteral6) 3))
...
(define-fun temp___11691 () us_rep3 (mk___rep2 (mk___split_fields2 temp___1169)))
...
(assert (and (= 10 (to_rep1 (rec__my_maps__n__map__capacity l__split_discrs))) (= r9b (to_rep (rec__my_maps__n__map__modulus l__split_discrs)))))
...
(assert (and (= 10 (to_rep1 (rec__my_maps__n__map__capacity k__split_discrs))) (= r12b (to_rep (rec__my_maps__n__map__modulus k__split_discrs)))))
(assert (= (is_empty (mk___rep l__split_discrs (mk___split_fields l__split_fields))) true))
(assert (and (= temp___11691 (first (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (ite (= (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 0) true) (= (bool_eq3 temp___11691 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) temp___11691) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) temp___11691) 1)))))
(assert (= result c__split_fields))
(assert (= temp___1169 c__split_fields1))
(assert (and (= temp___11701 (next (mk___rep l__split_discrs (mk___split_fields l__split_fields)) (mk___rep2 c__split_fields4))) (ite (= (ite (= (bool_eq3 (mk___rep2 c__split_fields4) no_element) false) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep2 c__split_fields4)) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true) true) (= (bool_eq3 temp___11701 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) temp___11701) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) temp___11701) (+ (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep2 c__split_fields4)) 1))))))
(assert (= result1 c__split_fields1))
(assert (= c__split_fields2 temp___1170))
...
(assert (= (get2 (model__ (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 (mk___split_fields1 rliteral3 rliteral5))) 2))
(assert (and (and (and (= (has_key1 (model__ (mk___rep l__split_discrs my_maps__n__insert__container__fields)) (mk___rep1 (mk___split_fields1 rliteral1 rliteral2))) true) (= (has_key (positions (mk___rep l__split_discrs my_maps__n__insert__container__fields)) (mk___rep2 c__split_fields3)) true)) (= (= (to_rep3 (rec__my_maps__my_rec__f (us_split_fields3 (key (mk___rep l__split_discrs my_maps__n__insert__container__fields) (mk___rep2 c__split_fields3))))) (to_rep3 rliteral1)) true)) (ite (= (has_key1 (model__ (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 (mk___split_fields1 rliteral1 rliteral2))) true) (and (and (and (not (= b true)) (= (oeq1 (model__ (mk___rep l__split_discrs my_maps__n__insert__container__fields)) (model__ (mk___rep l__split_discrs l__split_fields2))) true)) (= (oeq2 (keys (mk___rep l__split_discrs my_maps__n__insert__container__fields)) (keys (mk___rep l__split_discrs l__split_fields2))) true)) (= (oeq3 (positions (mk___rep l__split_discrs my_maps__n__insert__container__fields)) (positions (mk___rep l__split_discrs l__split_fields2))) true)) (and (and (and (and (and (and (and (= b true) (= (length (mk___rep l__split_discrs my_maps__n__insert__container__fields)) (+ (length (mk___rep l__split_discrs l__split_fields2)) 1))) (= (bool_eq1 (key (mk___rep l__split_discrs my_maps__n__insert__container__fields) (mk___rep2 c__split_fields3)) (mk___rep1 (mk___split_fields1 rliteral1 rliteral2))) true)) (= (get2 (model__ (mk___rep l__split_discrs my_maps__n__insert__container__fields)) (mk___rep1 (mk___split_fields1 rliteral1 rliteral2))) 3)) (= (ole (model__ (mk___rep l__split_discrs l__split_fields2)) (model__ (mk___rep l__split_discrs my_maps__n__insert__container__fields))) true)) (= (keys_included_except (model__ (mk___rep l__split_discrs my_maps__n__insert__container__fields)) (model__ (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 (mk___split_fields1 rliteral1 rliteral2))) true)) (= (mapping_preserved (keys (mk___rep l__split_discrs l__split_fields2)) (keys (mk___rep l__split_discrs my_maps__n__insert__container__fields)) (positions (mk___rep l__split_discrs l__split_fields2)) (positions (mk___rep l__split_discrs my_maps__n__insert__container__fields))) true)) (= (keys_included_except1 (positions (mk___rep l__split_discrs my_maps__n__insert__container__fields)) (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep2 c__split_fields3)) true)))))
(assert (= result4 (mk___split_fields__ref l__split_fields2)))
(assert (= l__split_fields3 my_maps__n__insert__container__fields))
(assert (not (not (= (has_key1 (model__ (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 (mk___split_fields1 rliteral6 rliteral5))) true))))
(check-sat)
(exit)
