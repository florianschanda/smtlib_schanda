...
(define-fun default_initial_assumption ((temp___expr_386 us_rep2) (temp___skip_top_level_387 Bool)) Bool (=> (not (= temp___skip_top_level_387 true)) (= (length2 temp___expr_386) 0)))
...
(define-fun default_initial_assumption1 ((temp___expr_355 us_rep1) (temp___skip_top_level_356 Bool)) Bool (=> (not (= temp___skip_top_level_356 true)) (= (is_empty temp___expr_355) true)))
