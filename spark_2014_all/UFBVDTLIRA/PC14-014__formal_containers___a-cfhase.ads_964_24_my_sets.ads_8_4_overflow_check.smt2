...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__my_sets__m__set__capacity (us_split_discrs1 container)))) (dynamic_invariant result true false true true))) :pattern ((length container)))))
...
(define-fun default_initial_assumption ((temp___expr_423 us_rep2) (temp___skip_top_level_424 Bool)) Bool (=> (not (= temp___skip_top_level_424 true)) (= (length2 temp___expr_423) 0)))
...
(assert (forall ((container us_rep)) (! (let ((result (elements container))) (and (and (and (and (= (length2 result) (length container)) (forall ((temp___464 Int)) (=> (and (in_range5 temp___464) (= (iter_has_element result temp___464) true)) (= (contains (model__ container) (get result temp___464)) true)))) (forall ((item Int)) (=> (and (in_range4 item) (= (contains (model__ container) item) true)) (and (< 0 (find result item)) (= (get result (find result item)) item))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (= (find result (get result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length container))) (=> (= (get result i) (get result j)) (= i j)))))))) :pattern ((elements container)))))
...
(assert (and (= o6 (length (mk___rep target__split_discrs (mk___split_fields target__split_fields)))) (and (in_range1 o6) (<= o6 (to_rep (rec__my_sets__m__set__capacity target__split_discrs))))))
(assert (= o7 (- (to_rep (rec__my_sets__m__set__capacity target__split_discrs)) o6)))
...
(assert (and (= o4 (length source)) (and (in_range1 o4) (<= o4 (to_rep (rec__my_sets__m__set__capacity (us_split_discrs1 source)))))))
(assert (= o5 (- o4 o3)))
