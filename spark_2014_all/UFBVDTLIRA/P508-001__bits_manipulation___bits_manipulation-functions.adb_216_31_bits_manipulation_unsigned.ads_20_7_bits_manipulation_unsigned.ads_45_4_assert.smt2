...
(assert (forall ((j Int)) (=> (and (<= 1 j) (<= j (- i2 1))) (= (make_mask j) (bvsub (ite (< j 18446744073709551616) (bvshl #x0000000000000001 ((_ int2bv 64) j)) #x0000000000000000) #x0000000000000001)))))
(assert (and (=> (<= 2 63) (in_range2 i2)) (and (<= 2 i2) (<= i2 63))))
(assert (not (= i2 63)))
(assert (= i2 result1))
(assert (= i3 (+ i2 1)))
(assert (not (= (make_mask i3) (bvsub (ite (< i3 18446744073709551616) (bvshl #x0000000000000001 ((_ int2bv 64) i3)) #x0000000000000000) #x0000000000000001))))
(check-sat)
(exit)
