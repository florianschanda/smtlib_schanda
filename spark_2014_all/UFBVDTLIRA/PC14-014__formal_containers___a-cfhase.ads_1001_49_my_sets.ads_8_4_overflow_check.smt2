...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep1 (rec__my_sets__m__set__capacity (us_split_discrs1 container)))) (dynamic_invariant result true false true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant2 ((temp___expr_319 Int) (temp___is_init_316 Bool) (temp___skip_constant_317 Bool) (temp___do_toplevel_318 Bool)) Bool (=> (or (= temp___is_init_316 true) (<= 1 2147483647)) (in_range2 temp___expr_319)))
...
(define-fun default_initial_assumption ((temp___expr_386 us_rep1) (temp___skip_top_level_387 Bool)) Bool (=> (not (= temp___skip_top_level_387 true)) (= (length2 temp___expr_386) 0)))
...
(define-fun default_initial_assumption1 ((temp___expr_355 us_rep2) (temp___skip_top_level_356 Bool)) Bool (=> (not (= temp___skip_top_level_356 true)) (= (is_empty temp___expr_355) true)))
...
(assert (forall ((container us_rep)) (! (let ((result (elements container))) (and (and (and (and (= (length2 result) (length container)) (forall ((temp___423 Int)) (=> (and (in_range5 temp___423) (= (iter_has_element result temp___423) true)) (= (contains (model__ container) (get result temp___423)) true)))) (forall ((item Int)) (=> (and (in_range4 item) (= (contains (model__ container) item) true)) (and (< 0 (find result item)) (= (get result (find result item)) item))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (= (find result (get result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length container))) (=> (= (get result i) (get result j)) (= i j)))))))) :pattern ((elements container)))))
...
(assert true)
(define-fun dynamic_invariant3 ((temp___expr_348 Int) (temp___is_init_345 Bool) (temp___skip_constant_346 Bool) (temp___do_toplevel_347 Bool)) Bool (=> (or (= temp___is_init_345 true) (<= 1 2147483647)) (in_range4 temp___expr_348)))
...
(define-fun dynamic_invariant4 ((temp___expr_379 Int) (temp___is_init_376 Bool) (temp___skip_constant_377 Bool) (temp___do_toplevel_378 Bool)) Bool (=> (or (= temp___is_init_376 true) (<= 0 2147483647)) (in_range5 temp___expr_379)))
...
(define-fun dynamic_invariant5 ((temp___expr_373 Int) (temp___is_init_370 Bool) (temp___skip_constant_371 Bool) (temp___do_toplevel_372 Bool)) Bool (=> (or (= temp___is_init_370 true) (<= 1 2147483647)) (in_range6 temp___expr_373)))
