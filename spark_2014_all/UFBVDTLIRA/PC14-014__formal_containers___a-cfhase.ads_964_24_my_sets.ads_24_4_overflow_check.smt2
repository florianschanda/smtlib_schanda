...
(assert (and (= o6 (length (mk___rep target__split_discrs (mk___split_fields target__split_fields)))) (and (in_range o6) (<= o6 (to_rep1 (rec__my_sets__n__set__capacity target__split_discrs))))))
(assert (= o7 (- (to_rep1 (rec__my_sets__n__set__capacity target__split_discrs)) o6)))
(assert (and (= o12 o7) (in_range3 o7)))
(assert (= o13 (+ o12 o11)))
...
(assert (and (= o4 (length source)) (and (in_range o4) (<= o4 (to_rep1 (rec__my_sets__n__set__capacity (us_split_discrs1 source)))))))
(assert (= o5 (- o4 o3)))
