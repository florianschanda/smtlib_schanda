...
(define-fun dynamic_invariant3 ((temp___expr_353 Int) (temp___is_init_349 Bool) (temp___skip_constant_350 Bool) (temp___do_toplevel_351 Bool) (temp___do_typ_inv_352 Bool)) Bool (=> (or (= temp___is_init_349 true) (<= 0 2147483647)) (in_range3 temp___expr_353)))
...
(assert (forall ((container1 us_rep3)) (forall ((item Int)) (! (=> (dynamic_invariant3 item true true true true) (let ((result (find container1 item))) (and (=> (< 0 result) (and (<= result (length3 container1)) (= item (get1 container1 result)))) (dynamic_invariant result true false true true)))) :pattern ((find container1 item))))))
...
(assert (forall ((container1 us_rep)) (! (let ((result (elements container1))) (and (and (and (and (= (length3 result) (length container1)) (forall ((temp___471 Int)) (=> (and (in_range5 temp___471) (= (iter_has_element result temp___471) true)) (= (contains (model__ container1) (get1 result temp___471)) true)))) (forall ((item Int)) (=> (and (in_range4 item) (= (contains (model__ container1) item) true)) (and (< 0 (find result item)) (= (get1 result (find result item)) item))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (= (find result (get1 result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length container1))) (=> (= (get1 result i) (get1 result j)) (= i j)))))))) :pattern ((elements container1)))))
...
(assert true)
(define-fun dynamic_invariant4 ((temp___expr_386 Int) (temp___is_init_382 Bool) (temp___skip_constant_383 Bool) (temp___do_toplevel_384 Bool) (temp___do_typ_inv_385 Bool)) Bool (=> (or (= temp___is_init_382 true) (<= 0 2147483647)) (in_range4 temp___expr_386)))
...
(assert (and (= o3 (length container)) (and (in_range1 o3) (<= o3 (to_rep (rec__use_sets__my_sets__set__capacity (us_split_discrs1 container)))))))
