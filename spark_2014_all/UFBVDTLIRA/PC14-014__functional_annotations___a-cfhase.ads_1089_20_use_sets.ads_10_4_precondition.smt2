...
(define-fun dynamic_invariant3 ((temp___expr_325 Int) (temp___is_init_322 Bool) (temp___skip_constant_323 Bool) (temp___do_toplevel_324 Bool)) Bool (=> (or (= temp___is_init_322 true) (<= 0 2147483647)) (in_range3 temp___expr_325)))
...
(assert (forall ((container1 us_rep)) (! (let ((result (elements container1))) (and (and (and (and (= (length3 result) (length container1)) (forall ((temp___429 Int)) (=> (and (in_range5 temp___429) (= (iter_has_element result temp___429) true)) (= (contains (model__ container1) (get1 result temp___429)) true)))) (forall ((item Int)) (=> (and (in_range4 item) (= (contains (model__ container1) item) true)) (and (< 0 (find result item)) (= (get1 result (find result item)) item))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (= (find result (get1 result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length container1))) (=> (= (get1 result i) (get1 result j)) (= i j)))))))) :pattern ((elements container1)))))
...
(assert true)
(define-fun dynamic_invariant4 ((temp___expr_354 Int) (temp___is_init_351 Bool) (temp___skip_constant_352 Bool) (temp___do_toplevel_353 Bool)) Bool (=> (or (= temp___is_init_351 true) (<= 0 2147483647)) (in_range4 temp___expr_354)))
...
(declare-const temp___854 count_type)
(declare-const o2 us_rep2)
(declare-const o3 Int)
(declare-const o4 Int)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___854 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___854)) no_element))
