...
(assert (forall ((v (_ BitVec 8))) (forall ((amount Int)) (! (=> (and (dynamic_invariant1 v true true true) (dynamic_invariant amount true true true)) (dynamic_invariant1 (shift_left v amount) true false true)) :pattern ((shift_left v amount))))))
(assert (forall ((v (_ BitVec 8))) (forall ((amount Int)) (! (=> (and (dynamic_invariant1 v true true true) (dynamic_invariant amount true true true)) (= (shift_left v amount) (ite (and (<= 1 8) (<= 8 8)) (ite (< amount 8) (bvshl v ((_ int2bv 8) amount)) ((_ int2bv 8) 0)) (ite (and (<= 9 8) (<= 8 16)) ((_ extract 7 0) (bvurem (ite (< amount 16) (bvshl ((_ zero_extend 8) v) ((_ int2bv 16) amount)) ((_ int2bv 16) 0)) ((_ int2bv 16) 256))) (ite (and (<= 17 8) (<= 8 32)) ((_ extract 7 0) (bvurem (bvshl ((_ zero_extend 24) v) ((_ int2bv 32) amount)) ((_ int2bv 32) 256))) ((_ extract 7 0) (bvurem (bvshl ((_ zero_extend 56) v) ((_ int2bv 64) amount)) ((_ int2bv 64) 256)))))))) :pattern ((shift_left v amount))))))
(declare-fun make_mask (Int) (_ BitVec 8))
(declare-fun make_mask__function_guard ((_ BitVec 8) Int) Bool)
(define-fun dynamic_invariant3 ((temp___expr_237 Int) (temp___is_init_234 Bool) (temp___skip_constant_235 Bool) (temp___do_toplevel_236 Bool)) Bool (=> (or (= temp___is_init_234 true) (<= 1 8)) (in_range2 temp___expr_237)))
...
(assert (and (= bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__mask__assume (make_mask o)) (= bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__mask__assume (shift_right ((_ int2bv 8) 255) (- 8 o)))))
(assert (= bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__mask__assume mask))
(assert (and (= o1 (shift_right value from)) (= o1 (ite (and (<= 1 8) (<= 8 8)) (ite (< from 8) (bvlshr value ((_ int2bv 8) from)) ((_ int2bv 8) 0)) (ite (and (<= 9 8) (<= 8 16)) ((_ extract 7 0) (ite (< from 16) (bvlshr ((_ zero_extend 8) value) ((_ int2bv 16) from)) ((_ int2bv 16) 0))) (ite (and (<= 17 8) (<= 8 32)) ((_ extract 7 0) (bvlshr ((_ zero_extend 24) value) ((_ int2bv 32) from))) ((_ extract 7 0) (bvlshr ((_ zero_extend 56) value) ((_ int2bv 64) from)))))))))
