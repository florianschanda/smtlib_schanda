...
(assert (forall ((value (_ BitVec 64))) (! (=> (and (dynamic_invariant value true true true) (not (= value ((_ int2bv 64) 0)))) (let ((result (msb_index_slow_inline_always value))) (and (= (shift_right value result) ((_ int2bv 64) 1)) (dynamic_invariant2 result true false true)))) :pattern ((msb_index_slow_inline_always value)))))
