...
(assert (<= from to__))
(assert (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_not_inline__result1 bits_manipulation_unsigned__unsigned_64__functions__extract_bits_not_inline__result2))
(assert (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_not_inline__result3 bits_manipulation_unsigned__unsigned_64__functions__extract_bits_not_inline__result1))
...
(assert (= (mk_t__ref result) (mk_t__ref bits_manipulation_unsigned__unsigned_64__functions__extract_bits_not_inline__result)))
(assert (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_not_inline__result1 o))
(assert (= (mk_t__ref bits_manipulation_unsigned__unsigned_64__functions__extract_bits_not_inline__result4) (mk_t__ref bits_manipulation_unsigned__unsigned_64__functions__extract_bits_not_inline__result2)))
(assert (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_not_inline__result5 bits_manipulation_unsigned__unsigned_64__functions__extract_bits_not_inline__result3))
