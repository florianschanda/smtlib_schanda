...
(assert (and (= o (readreg16 regnew)) (= o ((_ extract 15 0) (bvand regnew ((_ int2bv 64) 65535))))))
(assert (= o1 (ite (= o val__) true false)))
(assert (= o2 (ite (= o1 true) (ite (= (bvand regnew ((_ int2bv 64) 18446744073709486080)) (bvand regold ((_ int2bv 64) 18446744073709486080))) true false) false)))
...
(assert (not (= (readreg16 regnew) val__)))
(check-sat)
(exit)
