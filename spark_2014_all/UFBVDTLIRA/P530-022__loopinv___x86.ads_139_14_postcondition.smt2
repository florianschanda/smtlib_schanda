...
(declare-const x86__writereg16post__result Bool)
(declare-const o (_ BitVec 16))
(declare-const o1 Bool)
(declare-const o2 Bool)
(declare-const result Bool)
(declare-const x86__writereg16post__result1 Bool)
(declare-const x86__writereg16post__result2 Bool)
(declare-const x86__writereg16post__result3 Bool)
(declare-const x86__writereg16post__result4 Bool)
(declare-const x86__writereg16post__result5 Bool)
(declare-const result1 Bool)
(assert (= x86__writereg16post__result1 x86__writereg16post__result2))
(assert (= x86__writereg16post__result3 x86__writereg16post__result1))
(assert (and (= o (readreg16 regnew)) (= o ((_ extract 15 0) (bvand regnew #x000000000000FFFF)))))
(assert (= o1 (ite (= o val__) true false)))
(assert (= o2 (ite (= o1 true) (ite (= (bvand regnew #xFFFFFFFFFFFF0000) (bvand regold #xFFFFFFFFFFFF0000)) true false) false)))
(assert (= result x86__writereg16post__result))
(assert (= x86__writereg16post__result1 o2))
(assert (= (mk_bool__ref x86__writereg16post__result4) (mk_bool__ref x86__writereg16post__result2)))
(assert (= x86__writereg16post__result5 x86__writereg16post__result3))
(assert (= result1 x86__writereg16post__result4))
(assert (= x86__writereg16post__result4 true))
(assert (not (= (bvand regnew #xFFFFFFFFFFFF0000) (bvand regold #xFFFFFFFFFFFF0000))))
(check-sat)
(exit)
