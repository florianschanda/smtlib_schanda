...
(assert (forall ((value (_ BitVec 16))) (! (=> (and (dynamic_invariant value true true true) (not (= value ((_ int2bv 16) 0)))) (let ((result (msb_index_slow_inline_always value))) (and (= (shift_right value result) ((_ int2bv 16) 1)) (dynamic_invariant2 result true false true)))) :pattern ((msb_index_slow_inline_always value)))))
(declare-const value (_ BitVec 16))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline__result Int)
(declare-const o Int)
(declare-const result Int)
(declare-const bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline__result1 Int)
(declare-const bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline__result2 Int)
(declare-const bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline__result3 Int)
(declare-const bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline__result4 Int)
(declare-const bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline__result5 Int)
(declare-const result1 Int)
(assert true)
(assert (not (= value ((_ int2bv 16) 0))))
(assert (= bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline__result1 bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline__result2))
(assert (= bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline__result3 bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline__result1))
(assert (and (= o (msb_index_slow_inline_always value)) (and (in_range1 o) (= (shift_right value o) ((_ int2bv 16) 1)))))
(assert (= result bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline__result))
(assert (= bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline__result1 o))
(assert (= (mk_int__ref bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline__result4) (mk_int__ref bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline__result2)))
(assert (= bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline__result5 bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline__result3))
(assert (= result1 bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline__result4))
(assert (not (= (shift_right value bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline__result4) ((_ int2bv 16) 1))))
(check-sat)
(exit)
