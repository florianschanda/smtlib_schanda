...
(assert (forall ((value (_ BitVec 16))) (! (=> (and (dynamic_invariant value true true true true) (not (= value #x0000))) (let ((result (msb_index_slow_inline_always value))) (and (= (shift_right value result) #x0001) (dynamic_invariant2 result true false true true)))) :pattern ((msb_index_slow_inline_always value)))))
...
(assert (and (= o (msb_index_slow_inline_always value)) (and (in_range1 o) (= (shift_right value o) #x0001))))
...
(assert (not (= (shift_right value bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline__result4) #x0001)))
(check-sat)
(exit)
