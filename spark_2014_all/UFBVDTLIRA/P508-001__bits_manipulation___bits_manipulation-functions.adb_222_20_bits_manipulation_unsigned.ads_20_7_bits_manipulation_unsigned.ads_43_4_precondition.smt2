...
(define-fun dynamic_invariant1 ((temp___expr_279 Int) (temp___is_init_276 Bool) (temp___skip_constant_277 Bool) (temp___do_toplevel_278 Bool)) Bool (=> (or (= temp___is_init_276 true) (<= 1 16)) (in_range1 temp___expr_279)))
...
(assert (forall ((num_bits Int)) (! (=> (dynamic_invariant1 num_bits true true true) (= (make_mask num_bits) (shift_right ((_ int2bv 16) 65535) (- 16 num_bits)))) :pattern ((make_mask num_bits)))))
...
(assert true)
(assert (forall ((us_void_param tuple0)) (! (= (= (lemma2 us_void_param) true) (forall ((size Int)) (=> (and (<= 1 size) (<= size 15)) (= (make_mask size) (bvsub (ite (< size 65536) (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) size)) ((_ int2bv 16) 0)) ((_ int2bv 16) 1)))))) :pattern ((lemma2 us_void_param)))))
(declare-fun lemma2_goal (tuple0) Bool)
(declare-fun lemma2_goal__function_guard (Bool tuple0) Bool)
(assert true)
(declare-sort t647s 0)
(define-fun in_range2 ((x Int)) Bool (and (<= 2 x) (<= x 15)))
(declare-fun attr__ATTRIBUTE_IMAGE3 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check3 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE3 (us_image) Int)
(declare-fun user_eq2 (t647s t647s) Bool)
(declare-const dummy2 t647s)
(declare-datatypes () ((t647s__ref (mk_t647s__ref (t647s__content t647s)))))
(define-fun t647s__ref___projection ((a t647s__ref)) t647s (t647s__content a))
...
(assert true)
(assert (forall ((us_void_param tuple0)) (! (= (= (lemma81 us_void_param) true) (forall ((val__ (_ BitVec 16))) (=> (and (bvule ((_ int2bv 16) 0) val__) (bvule val__ ((_ int2bv 16) 65535))) (forall ((n Int)) (=> (and (<= 1 n) (<= n 15)) (bvult (shift_right val__ (- 16 n)) (ite (< n 65536) (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) n)) ((_ int2bv 16) 0)))))))) :pattern ((lemma81 us_void_param)))))
(declare-const i Int)
(declare-const bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__result Bool)
(declare-const temp___416 Int)
(declare-const j Int)
(declare-const o Int)
...
(declare-const bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__result1 Bool)
(declare-const bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__result2 Bool)
(declare-const bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__result3 Bool)
(declare-const i10 Int)
(declare-const bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__result4 Bool)
(declare-const i11 Int)
(declare-const bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__result5 Bool)
(assert (= (lemma8 Tuple0) true))
(assert (= (make_mask 1) ((_ int2bv 16) 1)))
(assert (= (mk_int__ref result) (mk_int__ref i)))
(assert (= i1 2))
(assert (=> (and (<= 2 i1) (<= i1 15)) (and (and (= temp___416 i1) (and (= (make_mask i1) (bvsub (ite (< i1 65536) (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) i1)) ((_ int2bv 16) 0)) ((_ int2bv 16) 1))) (and (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- i2 1))) (= (make_mask j1) (bvsub (ite (< j1 65536) (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) j1)) ((_ int2bv 16) 0)) ((_ int2bv 16) 1))))) (and (and (=> (<= 2 15) (in_range2 i2)) (and (<= 2 i2) (<= i2 15))) (= i2 15))))) (and (= i2 i6) (= i7 i2)))))
(assert (=> (and (<= 2 i1) (<= i1 15)) (= (mk_int__ref i8) (mk_int__ref i6))))
(assert (=> (and (<= 2 i1) (<= i1 15)) (= i9 i7)))
(assert (=> (not (and (<= 2 i1) (<= i1 15))) (= i1 i8)))
(assert (=> (not (and (<= 2 i1) (<= i1 15))) (= i9 i1)))
(assert (forall ((size Int)) (=> (and (<= 1 size) (<= size 15)) (= (make_mask size) (bvsub (ite (< size 65536) (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) size)) ((_ int2bv 16) 0)) ((_ int2bv 16) 1))))))
(assert (not (= (lemma2 Tuple0) true)))
(check-sat)
(exit)
