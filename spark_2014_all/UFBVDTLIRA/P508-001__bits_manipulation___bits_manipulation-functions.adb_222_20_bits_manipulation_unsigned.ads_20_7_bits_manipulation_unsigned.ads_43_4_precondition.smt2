...
(assert (= i1 2))
(assert (=> (and (<= 2 i1) (<= i1 15)) (= temp___416 i1)))
(assert (=> (and (<= 2 i1) (<= i1 15)) (= (make_mask i1) (bvsub (ite (< i1 65536) (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) i1)) ((_ int2bv 16) 0)) ((_ int2bv 16) 1)))))
(assert (=> (and (<= 2 i1) (<= i1 15)) (forall ((j Int)) (=> (and (<= 1 j) (<= j (- i2 1))) (= (make_mask j) (bvsub (ite (< j 65536) (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) j)) ((_ int2bv 16) 0)) ((_ int2bv 16) 1)))))))
(assert (=> (and (<= 2 i1) (<= i1 15)) (and (=> (<= 2 15) (in_range2 i2)) (and (<= 2 i2) (<= i2 15)))))
(assert (=> (and (<= 2 i1) (<= i1 15)) (= i2 15)))
(assert (=> (and (<= 2 i1) (<= i1 15)) (= i2 i3)))
(assert (=> (and (<= 2 i1) (<= i1 15)) (= i4 i2)))
(assert (=> (and (<= 2 i1) (<= i1 15)) (= (mk_int__ref i5) (mk_int__ref i3))))
(assert (=> (and (<= 2 i1) (<= i1 15)) (= i6 i4)))
(assert (=> (not (and (<= 2 i1) (<= i1 15))) (= i1 i5)))
(assert (=> (not (and (<= 2 i1) (<= i1 15))) (= i6 i1)))
