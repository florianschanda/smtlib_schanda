...
(assert true)
(assert (forall ((us_void_param tuple0)) (! (= (= (lemma2 us_void_param) true) (forall ((size Int)) (=> (and (<= 1 size) (<= size 15)) (= (make_mask size) (bvsub (ite (< size 65536) (bvshl #x0001 ((_ int2bv 16) size)) #x0000) #x0001))))) :pattern ((lemma2 us_void_param)))))
(declare-fun lemma2_goal (tuple0) Bool)
(declare-fun lemma2_goal__function_guard (Bool tuple0) Bool)
(assert true)
(declare-sort t647s 0)
(declare-fun t647sqtint (t647s) Int)
(assert (forall ((i t647s)) (and (<= 2 (t647sqtint i)) (<= (t647sqtint i) 15))))
...
(assert (= (make_mask 1) #x0001))
(assert (= (mk_int__ref result) (mk_int__ref i)))
(assert (= i1 2))
(assert (=> (and (<= 2 i1) (<= i1 15)) (= temp___478 i1)))
(assert (=> (and (<= 2 i1) (<= i1 15)) (= (make_mask i1) (bvsub (ite (< i1 65536) (bvshl #x0001 ((_ int2bv 16) i1)) #x0000) #x0001))))
(assert (=> (and (<= 2 i1) (<= i1 15)) (forall ((j Int)) (=> (and (<= 1 j) (<= j (- i2 1))) (= (make_mask j) (bvsub (ite (< j 65536) (bvshl #x0001 ((_ int2bv 16) j)) #x0000) #x0001))))))
...
(assert (forall ((size Int)) (=> (and (<= 1 size) (<= size 15)) (= (make_mask size) (bvsub (ite (< size 65536) (bvshl #x0001 ((_ int2bv 16) size)) #x0000) #x0001)))))
