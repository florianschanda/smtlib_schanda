...
(define-fun dynamic_invariant ((temp___expr_208 (_ BitVec 32)) (temp___is_init_205 Bool) (temp___skip_constant_206 Bool) (temp___do_toplevel_207 Bool)) Bool true)
...
(assert (= x86__signedlt_32__result1 (ite (bvugt (bvadd ((_ zero_extend 32) val1) ((_ zero_extend 32) val2)) ((_ zero_extend 32) (bvadd val1 val2))) true false)))
(assert (= (mk_bool__ref x86__signedlt_32__result4) (mk_bool__ref x86__signedlt_32__result2)))
...
(assert (not (bvugt (bvadd ((_ zero_extend 32) val1) ((_ zero_extend 32) val2)) ((_ zero_extend 32) (bvadd val1 val2)))))
(check-sat)
(exit)
