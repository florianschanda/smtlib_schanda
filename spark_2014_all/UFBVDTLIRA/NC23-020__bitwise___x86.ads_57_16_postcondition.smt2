...
(assert (forall ((x86__rax (_ BitVec 64))) (! (=> (dynamic_invariant x86__rax true true true) (let ((result (al x86__rax))) (and (= result ((_ extract 7 0) (bvand x86__rax ((_ int2bv 64) 255)))) (dynamic_invariant1 result true false true)))) :pattern ((al x86__rax)))))
...
(assert (= rax1 rax2))
(assert (= rax3 rax1))
(assert (not (= (al rax2) ((_ int2bv 8) 1))))
(check-sat)
(exit)
