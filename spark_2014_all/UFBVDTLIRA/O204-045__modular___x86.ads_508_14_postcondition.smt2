...
(assert (forall ((x86__rcx (_ BitVec 64))) (! (=> (dynamic_invariant x86__rcx true true true) (let ((result (cl x86__rcx))) (and (= result ((_ extract 7 0) (bvand x86__rcx ((_ int2bv 64) 255)))) (dynamic_invariant1 result true false true)))) :pattern ((cl x86__rcx)))))
...
(assert (not (= (cl rcx3) ((_ int2bv 8) 1))))
(check-sat)
(exit)
