...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (= (to_rep1 (rec__my_maps__m__cursor__node (us_split_fields3 a))) (to_rep1 (rec__my_maps__m__cursor__node (us_split_fields3 b)))) true false))
...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep1 (rec__my_maps__m__map__capacity (us_split_discrs1 container)))) (dynamic_invariant1 result true false true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant2 ((temp___expr_325 Int) (temp___is_init_322 Bool) (temp___skip_constant_323 Bool) (temp___do_toplevel_324 Bool)) Bool (=> (or (= temp___is_init_322 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_325)))
...
(define-fun oeq3 ((left us_rep2) (right us_rep2)) Bool (and (= (length2 left) (length2 right)) (ite (forall ((n Int)) (=> (and (<= 1 n) (<= n (last left))) (= (get left n) (get right n)))) true false)))
...
(define-fun dynamic_invariant3 ((temp___expr_319 Int) (temp___is_init_316 Bool) (temp___skip_constant_317 Bool) (temp___do_toplevel_318 Bool)) Bool (=> (or (= temp___is_init_316 true) (<= 1 2147483647)) (in_range4 temp___expr_319)))
(assert true)
...
(assert (forall ((container us_rep)) (forall ((key2 Int)) (! (=> (dynamic_invariant3 key2 true true true) (let ((result (find1 container key2))) (ite (not (= (has_key1 (model__ container) key2) true)) (= (bool_eq1 result no_element) true) (and (and (= (has_key (positions container) result) true) (= (get1 (positions container) result) (find (keys container) key2))) (= (key container result) key2))))) :pattern ((find1 container key2))))))
(assert true)
...
(define-fun dynamic_invariant4 ((temp___expr_821 us_rep) (temp___is_init_818 Bool) (temp___skip_constant_819 Bool) (temp___do_toplevel_820 Bool)) Bool (=> (not (= temp___skip_constant_819 true)) (in_range5 10 r2b temp___expr_821)))
(define-fun default_initial_assumption ((temp___expr_824 us_rep) (temp___skip_top_level_825 Bool)) Bool (and (and (= (to_rep1 (rec__my_maps__m__map__capacity (us_split_discrs1 temp___expr_824))) 10) (= (to_rep (rec__my_maps__m__map__modulus (us_split_discrs1 temp___expr_824))) r2b)) (=> (not (= temp___skip_top_level_825 true)) (= (is_empty temp___expr_824) true))))
...
(define-fun dynamic_invariant5 ((temp___expr_832 us_rep) (temp___is_init_829 Bool) (temp___skip_constant_830 Bool) (temp___do_toplevel_831 Bool)) Bool (=> (not (= temp___skip_constant_830 true)) (in_range6 10 r5b temp___expr_832)))
(define-fun default_initial_assumption1 ((temp___expr_835 us_rep) (temp___skip_top_level_836 Bool)) Bool (and (and (= (to_rep1 (rec__my_maps__m__map__capacity (us_split_discrs1 temp___expr_835))) 10) (= (to_rep (rec__my_maps__m__map__modulus (us_split_discrs1 temp___expr_835))) r5b)) (=> (not (= temp___skip_top_level_836 true)) (= (is_empty temp___expr_835) true))))
...
(assert (forall ((a us_rep2) (b us_rep2)) (! (= (user_eq5 a b) (oeq3 a b)) :pattern ((user_eq5 a b)))))
(define-fun default_initial_assumption2 ((temp___expr_398 us_rep2) (temp___skip_top_level_399 Bool)) Bool (=> (not (= temp___skip_top_level_399 true)) (= (length2 temp___expr_398) 0)))
(assert (forall ((container us_rep2)) (forall ((key2 Int)) (! (=> (dynamic_invariant3 key2 true true true) (let ((result (find container key2))) (and (=> (< 0 result) (and (<= result (length2 container)) (= key2 (get container result)))) (dynamic_invariant1 result true false true)))) :pattern ((find container key2))))))
...
(define-fun default_initial_assumption3 ((temp___expr_418 us_rep3) (temp___skip_top_level_419 Bool)) Bool (=> (not (= temp___skip_top_level_419 true)) (and (= (is_empty2 temp___expr_418) true) (= (length3 temp___expr_418) 0))))
(declare-fun keys_included1 (us_rep3 us_rep3) Bool)
(declare-fun keys_included__function_guard1 (Bool us_rep3 us_rep3) Bool)
(assert (forall ((k_left us_rep2) (k_right us_rep2)) (forall ((p_left us_rep3) (p_right us_rep3)) (! (=> (= (mapping_preserved k_left k_right p_left p_right) true) (and (and (= (keys_included1 p_left p_right) true) (= (k_keys_included k_left k_right) true)) (forall ((c us_rep1)) (=> (= (has_key p_left c) true) (= (get k_left (get1 p_left c)) (get k_right (get1 p_right c))))))) :pattern ((mapping_preserved k_left k_right p_left p_right))))))
...
(define-fun default_initial_assumption4 ((temp___expr_367 us_rep4) (temp___skip_top_level_368 Bool)) Bool (=> (not (= temp___skip_top_level_368 true)) (and (= (is_empty3 temp___expr_367) true) (= (length4 temp___expr_367) 0))))
(assert true)
...
(assert (forall ((container us_rep)) (! (let ((result (keys container))) (and (and (and (and (= (length2 result) (length container)) (forall ((temp___435 Int)) (=> (and (in_range2 temp___435) (= (iter_has_element result temp___435) true)) (= (has_key1 (model__ container) (get result temp___435)) true)))) (forall ((key2 Int)) (=> (and (in_range7 key2) (= (has_key1 (model__ container) key2) true)) (and (< 0 (find result key2)) (= (get result (find result key2)) key2))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (= (find result (get result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length container))) (=> (= (get result i) (get result j)) (= i j)))))))) :pattern ((keys container)))))
...
(assert true)
(define-fun dynamic_invariant6 ((temp___expr_354 Int) (temp___is_init_351 Bool) (temp___skip_constant_352 Bool) (temp___do_toplevel_353 Bool)) Bool (=> (or (= temp___is_init_351 true) (<= 1 2147483647)) (in_range7 temp___expr_354)))
(assert (forall ((container us_rep4)) (forall ((key2 Int)) (! (=> (dynamic_invariant6 key2 true true true) (=> (= (of_int 1) true) (=> (exists ((k Int)) (and (and (in_range7 k) (= (has_key1 container k) true)) (= k key2))) (= (has_key1 container key2) true)))) :pattern ((has_key1 container key2))))))
...
(define-fun dynamic_invariant7 ((temp___expr_360 Int) (temp___is_init_357 Bool) (temp___skip_constant_358 Bool) (temp___do_toplevel_359 Bool)) Bool (=> (or (= temp___is_init_357 true) (<= (- 2147483648) 2147483647)) (in_range8 temp___expr_360)))
...
(assert (forall ((container us_rep4)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant6 key2 true true true) (= (has_key1 container key2) true)) (let ((result (get2 container key2))) (and (=> (= (of_int 1) true) (and (= result (w_get container (witness container key2))) (forall ((k Int)) (=> (and (in_range7 k) (= (has_key1 container k) true)) (= (= k key2) (= (witness container key2) (witness container k))))))) (dynamic_invariant7 result true false true)))) :pattern ((get2 container key2))))))
(assert (forall ((container us_rep4)) (! (dynamic_invariant1 (length4 container) true false true) :pattern ((length4 container)))))
(assert (forall ((left us_rep4) (right us_rep4)) (! (= (= (ole left right) true) (forall ((key2 Int)) (=> (and (in_range7 key2) (= (has_key1 left key2) true)) (and (= (has_key1 right key2) true) (= (get2 right key2) (get2 left key2)))))) :pattern ((ole left right)))))
(assert (forall ((left us_rep4) (right us_rep4)) (! (= (= (oeq2 left right) true) (and (forall ((key2 Int)) (=> (and (in_range7 key2) (= (has_key1 left key2) true)) (and (= (has_key1 right key2) true) (= (get2 right key2) (get2 left key2))))) (forall ((key2 Int)) (=> (and (in_range7 key2) (= (has_key1 right key2) true)) (= (has_key1 left key2) true))))) :pattern ((oeq2 left right)))))
(assert (forall ((container us_rep4)) (! (= (= (is_empty3 container) true) (forall ((key2 Int)) (not (and (in_range7 key2) (= (has_key1 container key2) true))))) :pattern ((is_empty3 container)))))
(assert (forall ((left us_rep4) (right us_rep4)) (! (= (= (keys_included left right) true) (forall ((key2 Int)) (=> (and (in_range7 key2) (= (has_key1 left key2) true)) (= (has_key1 right key2) true)))) :pattern ((keys_included left right)))))
(assert (forall ((left us_rep4) (right us_rep4)) (forall ((new_key Int)) (! (=> (dynamic_invariant6 new_key true true true) (= (= (keys_included_except left right new_key) true) (forall ((key2 Int)) (=> (and (in_range7 key2) (= (has_key1 left key2) true)) (=> (not (= key2 new_key)) (= (has_key1 right key2) true)))))) :pattern ((keys_included_except left right new_key))))))
(assert (forall ((left us_rep4) (right us_rep4)) (forall ((new_key Int)) (! (=> (dynamic_invariant6 new_key true true true) (= (= (elements_equal_except left right new_key) true) (forall ((key2 Int)) (=> (and (in_range7 key2) (= (has_key1 left key2) true)) (=> (not (= key2 new_key)) (and (= (has_key1 right key2) true) (= (get2 left key2) (get2 right key2)))))))) :pattern ((elements_equal_except left right new_key))))))
(declare-fun has_witness (us_rep4 Int) Bool)
(declare-fun has_witness__function_guard (Bool us_rep4 Int) Bool)
(assert true)
(assert (forall ((container us_rep4)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant6 key2 true true true) (= (has_key1 container key2) true)) (let ((result (witness container key2))) (and (= (has_witness container result) true) (dynamic_invariant1 result true false true)))) :pattern ((witness container key2))))))
...
(define-fun dynamic_invariant8 ((temp___expr_391 Int) (temp___is_init_388 Bool) (temp___skip_constant_389 Bool) (temp___do_toplevel_390 Bool)) Bool (=> (or (= temp___is_init_388 true) (<= 0 2147483647)) (in_range2 temp___expr_391)))
...
(define-fun dynamic_invariant9 ((temp___expr_385 Int) (temp___is_init_382 Bool) (temp___skip_constant_383 Bool) (temp___do_toplevel_384 Bool)) Bool (=> (or (= temp___is_init_382 true) (<= 1 2147483647)) (in_range9 temp___expr_385)))
...
(assert (forall ((container us_rep3)) (forall ((key2 us_rep1)) (! (=> (= (of_int 0) true) (=> (exists ((k us_rep1)) (and (= (has_key container k) true) (= (bool_eq1 k key2) true))) (= (has_key container key2) true))) :pattern ((has_key container key2))))))
...
(define-fun dynamic_invariant10 ((temp___expr_411 Int) (temp___is_init_408 Bool) (temp___skip_constant_409 Bool) (temp___do_toplevel_410 Bool)) Bool (=> (or (= temp___is_init_408 true) (<= 1 2147483647)) (in_range10 temp___expr_411)))
...
(assert (forall ((container us_rep3)) (forall ((key2 us_rep1)) (! (=> (= (has_key container key2) true) (let ((result (get1 container key2))) (and (=> (= (of_int 0) true) (and (= result (w_get1 container (witness1 container key2))) (forall ((k us_rep1)) (=> (= (has_key container k) true) (= (= (bool_eq1 k key2) true) (= (witness1 container key2) (witness1 container k))))))) (dynamic_invariant10 result true false true)))) :pattern ((get1 container key2))))))
(assert (forall ((container us_rep3)) (! (dynamic_invariant1 (length3 container) true false true) :pattern ((length3 container)))))
(assert (forall ((left us_rep3) (right us_rep3)) (! (= (= (oeq4 left right) true) (and (forall ((key2 us_rep1)) (=> (= (has_key left key2) true) (and (= (has_key right key2) true) (= (get1 right key2) (get1 left key2))))) (forall ((key2 us_rep1)) (=> (= (has_key right key2) true) (= (has_key left key2) true))))) :pattern ((oeq4 left right)))))
(assert (forall ((container us_rep3)) (! (= (= (is_empty2 container) true) (forall ((key2 us_rep1)) (not (= (has_key container key2) true)))) :pattern ((is_empty2 container)))))
(assert (forall ((left us_rep3) (right us_rep3)) (! (= (= (keys_included1 left right) true) (forall ((key2 us_rep1)) (=> (= (has_key left key2) true) (= (has_key right key2) true)))) :pattern ((keys_included1 left right)))))
...
(assert true)
(assert (forall ((container us_rep3)) (forall ((key2 us_rep1)) (! (=> (= (has_key container key2) true) (let ((result (witness1 container key2))) (and (= (has_witness1 container result) true) (dynamic_invariant1 result true false true)))) :pattern ((witness1 container key2))))))
(assert (forall ((container us_rep3)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant1 witness2 true true true) (= (has_witness1 container witness2) true)) (dynamic_invariant10 (w_get1 container witness2) true false true)) :pattern ((w_get1 container witness2))))))
...
(declare-const o Int)
(declare-const temp___1087 count_type)
(declare-const temp___1089 count_type)
...
(declare-const my_maps__m__delete__container__fields us_split_fields)
...
(declare-const my_maps__m__delete__2__container__fields us_split_fields)
...
(declare-const my_maps__m__exclude__container__fields us_split_fields)
(declare-const result16 us_split_fields__ref)
(declare-const l__split_fields11 us_split_fields)
(declare-const my_maps__m__exclude__container__fields1 us_split_fields)
...
(assert (not (= (is_empty (mk___rep l__split_discrs (mk___split_fields l__split_fields))) true)))
(check-sat)
(exit)
