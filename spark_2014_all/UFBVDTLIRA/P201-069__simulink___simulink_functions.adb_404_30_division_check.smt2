...
(define-fun dynamic_invariant ((temp___expr_171 (_ BitVec 8)) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool)) Bool true)
(declare-const left (_ BitVec 8))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const right (_ BitVec 8))
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(assert (not (= right ((_ int2bv 8) 0))))
(assert (not (not (= right #x00))))
(check-sat)
(exit)
