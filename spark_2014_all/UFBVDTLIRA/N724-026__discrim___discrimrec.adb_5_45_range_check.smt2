...
(define-fun default_initial_assumption ((temp___expr_185 us_rep) (temp___skip_top_level_186 Bool)) Bool (and (= (attr__constrained temp___expr_185) true) (= (to_rep4 (rec__discrimrec__register_type__option (us_split_discrs1 temp___expr_185))) 0)))
(declare-const rax__split_discrs us_split_discrs)
(declare-const rax__attr__constrained Bool)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(define-fun dynamic_invariant1 ((temp___expr_135 (_ BitVec 64)) (temp___is_init_132 Bool) (temp___skip_constant_133 Bool) (temp___do_toplevel_134 Bool)) Bool true)
(define-fun dynamic_invariant2 ((temp___expr_141 (_ BitVec 32)) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool true)
(define-fun dynamic_invariant3 ((temp___expr_147 (_ BitVec 16)) (temp___is_init_144 Bool) (temp___skip_constant_145 Bool) (temp___do_toplevel_146 Bool)) Bool true)
(define-fun dynamic_invariant4 ((temp___expr_153 (_ BitVec 8)) (temp___is_init_150 Bool) (temp___skip_constant_151 Bool) (temp___do_toplevel_152 Bool)) Bool true)
(define-fun dynamic_invariant5 ((temp___expr_159 Int) (temp___is_init_156 Bool) (temp___skip_constant_157 Bool) (temp___do_toplevel_158 Bool)) Bool (=> (or (= temp___is_init_156 true) (<= 0 3)) (in_range temp___expr_159)))
(define-fun default_initial_assumption1 ((temp___expr_167 us_rep) (temp___skip_top_level_168 Bool)) Bool (and (= (attr__constrained temp___expr_167) false) (= (to_rep4 (rec__discrimrec__register_type__option (us_split_discrs1 temp___expr_167))) 0)))
