...
(declare-fun exponentiate__function_guard ((_ BitVec 32) (_ BitVec 32) Int) Bool)
...
(declare-const val__1 (_ BitVec 32))
(declare-const result1 Int)
(declare-const exp2 Int)
(declare-const exp3 Int)
(assert (= result val__))
(assert (= val__1 #x00003029))
(assert (= result1 exp1))
(assert (= exp2 1))
(assert (<= 1 exp2))
(assert (<= exp2 100))
(assert (and (<= 1 exp3) (<= exp3 100)))
(assert (not (= (exponentiate val__1 exp3) (power val__1 exp3))))
(check-sat)
(exit)
