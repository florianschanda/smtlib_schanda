...
(define-fun n27 () t__ref (mk_t__ref n2))
(define-fun n17 () t__ref (mk_t__ref n1))
...
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n3)) (=> (bvugt n3 var1_range_size) (= (mk_t__ref result1) n17))))
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n3)) (=> (bvugt n3 var1_range_size) (= n12 #x0000000000000000))))
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n3)) (=> (bvugt n3 var1_range_size) (= (mk_t__ref result2) n27))))
...
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n3)) (=> (not (bvugt n3 var1_range_size)) (=> (bvult n3 var2_range_size) (= (mk_t__ref result3) n17)))))
...
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n3)) (=> (not (bvugt n3 var1_range_size)) (=> (bvult n3 var2_range_size) (= (mk_t__ref result4) n27)))))
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n3)) (=> (not (bvugt n3 var1_range_size)) (=> (bvult n3 var2_range_size) (= n23 n3)))))
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n3)) (=> (not (bvugt n3 var1_range_size)) (=> (not (bvult n3 var2_range_size)) (= (mk_t__ref result5) n17)))))
...
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n3)) (=> (not (bvugt n3 var1_range_size)) (=> (not (bvult n3 var2_range_size)) (= (mk_t__ref result6) n27)))))
...
(assert (bvugt n5 var1_range_size))
(assert (= n15 result8))
(assert (= n16 #x0000000000000000))
(assert (= n25 result9))
(assert (= n26 (bvsub n5 var1_range_size)))
(assert (not (bvule n26 var2_range_size)))
(check-sat)
(exit)
