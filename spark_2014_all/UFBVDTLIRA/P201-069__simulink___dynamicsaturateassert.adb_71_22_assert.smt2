...
(assert (=> (not (bvult value min)) (=> (bvugt value max) (= result1 saturation_dynamic_out1))))
(assert (=> (not (bvult value min)) (=> (bvugt value max) (= saturation_dynamic_out12 max))))
(assert (=> (not (bvult value min)) (=> (not (bvugt value max)) (= result2 saturation_dynamic_out1))))
(assert (=> (not (bvult value min)) (=> (not (bvugt value max)) (= saturation_dynamic_out13 value))))
(assert (=> (not (bvult value min)) (=> (not (bvugt value max)) (= saturation_dynamic_out12 saturation_dynamic_out13))))
(assert (=> (not (bvult value min)) (= saturation_dynamic_out11 saturation_dynamic_out12)))
(assert (= result3 saturated_value))
(assert (= saturated_value1 saturation_dynamic_out11))
(assert (and (bvule saturation_dynamic_out11 max) (bvuge saturation_dynamic_out11 min)))
(assert (not (bvuge max min)))
(check-sat)
(exit)
