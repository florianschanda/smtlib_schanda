...
(assert (= e1 o))
(assert (in_range1 e1))
(assert (and (and (and (and (and (and (and (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields1)) no_element) true) (= (length (mk___rep l__split_discrs l__split_fields2)) (- (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 1))) (not (= (contains (model__ (mk___rep l__split_discrs l__split_fields2)) (element (mk___rep l__split_discrs (mk___split_fields l__split_fields)) (mk___rep1 (mk___split_fields1 cu__split_fields)))) true))) (not (= (has_key (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 (mk___split_fields1 cu__split_fields))) true))) (= (ole (model__ (mk___rep l__split_discrs l__split_fields2)) (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true)) (= (included_except (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (model__ (mk___rep l__split_discrs l__split_fields2)) (element (mk___rep l__split_discrs (mk___split_fields l__split_fields)) (mk___rep1 (mk___split_fields1 cu__split_fields)))) true)) (= (mapping_preserved (elements (mk___rep l__split_discrs l__split_fields2)) (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (positions (mk___rep l__split_discrs l__split_fields2)) (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true)) (= (keys_included_except (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 (mk___split_fields1 cu__split_fields))) true)))
(assert (not (or (< (length (mk___rep l__split_discrs l__split_fields2)) (to_rep1 (rec__p__my_sets__set__capacity l__split_discrs))) (= (contains (model__ (mk___rep l__split_discrs l__split_fields2)) e1) true))))
(check-sat)
(exit)
