...
(assert (forall ((value (_ BitVec 64))) (! (=> (and (dynamic_invariant value true true true true) (not (= value #x0000000000000000))) (let ((result (msb_index_slow_inline_always value))) (and (= (shift_right value result) #x0000000000000001) (dynamic_invariant2 result true false true true)))) :pattern ((msb_index_slow_inline_always value)))))
