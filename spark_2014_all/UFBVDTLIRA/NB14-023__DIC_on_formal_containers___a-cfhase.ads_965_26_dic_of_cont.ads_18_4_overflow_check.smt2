...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__dic_of_cont__my_hase__set__capacity (us_split_discrs1 container)))) (dynamic_invariant result true false true))) :pattern ((length container)))))
...
(define-fun default_initial_assumption ((temp___expr_808 us_rep2) (temp___skip_top_level_809 Bool)) Bool (=> (not (= temp___skip_top_level_809 true)) (= (length2 temp___expr_808) 0)))
...
(define-fun default_initial_assumption1 ((temp___expr_777 us_rep1) (temp___skip_top_level_778 Bool)) Bool (=> (not (= temp___skip_top_level_778 true)) (= (is_empty temp___expr_777) true)))
