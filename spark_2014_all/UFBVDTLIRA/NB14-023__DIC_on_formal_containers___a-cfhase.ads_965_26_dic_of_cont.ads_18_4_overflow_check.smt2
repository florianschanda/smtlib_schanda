...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (and (= (to_rep (rec__dic_of_cont__my_hase__set__capacity (us_split_discrs1 a))) (to_rep (rec__dic_of_cont__my_hase__set__capacity (us_split_discrs1 b)))) (= (to_rep1 (rec__dic_of_cont__my_hase__set__modulus (us_split_discrs1 a))) (to_rep1 (rec__dic_of_cont__my_hase__set__modulus (us_split_discrs1 b))))) (= (us_main_eq (rec__dic_of_cont__my_hase__set (us_split_fields1 a)) (rec__dic_of_cont__my_hase__set (us_split_fields1 b))) true)) true false))
...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__dic_of_cont__my_hase__set__capacity (us_split_discrs1 container)))) (dynamic_invariant result true false true true))) :pattern ((length container)))))
...
(define-fun default_initial_assumption ((temp___expr_875 us_rep2) (temp___skip_top_level_876 Bool)) Bool (=> (not (= temp___skip_top_level_876 true)) (= (length2 temp___expr_875) 0)))
...
(assert (forall ((container us_rep)) (! (let ((result (elements container))) (and (and (and (and (= (length2 result) (length container)) (forall ((temp___916 Int)) (=> (and (in_range5 temp___916) (= (iter_has_element result temp___916) true)) (= (contains (model__ container) (get result temp___916)) true)))) (forall ((item Int)) (=> (and (in_range4 item) (= (contains (model__ container) item) true)) (and (< 0 (find result item)) (= (get result (find result item)) item))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (= (find result (get result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length container))) (=> (= (get result i) (get result j)) (= i j)))))))) :pattern ((elements container)))))
...
(assert (and (= o (length (mk___rep target__split_discrs (mk___split_fields target__split_fields)))) (and (in_range1 o) (<= o (to_rep (rec__dic_of_cont__my_hase__set__capacity target__split_discrs))))))
(assert (= o1 (- (to_rep (rec__dic_of_cont__my_hase__set__capacity target__split_discrs)) o)))
