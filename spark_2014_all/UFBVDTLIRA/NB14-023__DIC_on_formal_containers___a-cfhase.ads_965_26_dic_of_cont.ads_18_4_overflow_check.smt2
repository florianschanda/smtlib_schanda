...
(assert (and (= o6 (length (mk___rep target__split_discrs (mk___split_fields target__split_fields)))) (and (in_range1 o6) (<= o6 (to_rep (rec__dic_of_cont__my_hase__set__capacity target__split_discrs))))))
(assert (= o7 (- (to_rep (rec__dic_of_cont__my_hase__set__capacity target__split_discrs)) o6)))
