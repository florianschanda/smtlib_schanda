...
(assert (= x86__readreglow8__result1 ((_ extract 7 0) (bvand reg ((_ int2bv 64) 255)))))
...
(assert (= result1 x86__readreglow8__result4))
(assert (not (= x86__readreglow8__result4 ((_ extract 7 0) (bvand reg ((_ int2bv 64) 255))))))
(check-sat)
(exit)
