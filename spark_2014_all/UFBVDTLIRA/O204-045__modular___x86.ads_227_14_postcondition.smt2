...
(assert (= (mk_t__ref result) (mk_t__ref x86__bp__result)))
(assert (= x86__bp__result1 ((_ extract 15 0) (bvand rbp #x000000000000FFFF))))
...
(assert (not (= x86__bp__result4 ((_ extract 15 0) (bvand rbp #x000000000000FFFF)))))
(check-sat)
(exit)
