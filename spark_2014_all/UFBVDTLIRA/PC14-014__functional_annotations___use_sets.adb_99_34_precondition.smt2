...
(assert (let ((temp___963 (elements (mk___rep s2__split_discrs s2__split_fields3)))) (forall ((temp___962 Int)) (=> (and (in_range3 temp___962) (= (iter_has_element temp___963 temp___962) true)) (exists ((i Int)) (and (and (<= 1 i) (<= i (length (mk___rep s2__split_discrs s2__split_fields3)))) (= (get (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) i) (get temp___963 temp___962))))))))
(assert (and (= o1 (length (mk___rep s2__split_discrs s2__split_fields3))) (and (in_range2 o1) (<= o1 (to_rep1 (rec__use_sets__my_sets__set__capacity s2__split_discrs))))))
(assert (= o2 (+ o1 1)))
(assert (and (= o3 o2) (in_range1 o2)))
(assert (and (= o (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (and (not (= (has_key o no_element) true)) (forall ((i us_rep1)) (=> (= (has_key o i) true) (and (and (<= 1 (get1 o i)) (<= (get1 o i) (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))))) (forall ((j us_rep1)) (=> (= (has_key o j) true) (=> (= (get1 o i) (get1 o j)) (= (bool_eq1 i j) true))))))))))
