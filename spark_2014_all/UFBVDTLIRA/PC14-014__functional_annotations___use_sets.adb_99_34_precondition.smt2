...
(assert (and (= o1 (length (mk___rep s2__split_discrs (mk___split_fields s2__split_fields2)))) (and (in_range2 o1) (<= o1 (to_rep1 (rec__use_sets__my_sets__set__capacity s2__split_discrs))))))
(assert (= o2 (+ o1 1)))
(assert (and (= o3 o2) (in_range1 o2)))
(assert (and (= o (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (and (not (= (has_key o no_element) true)) (forall ((i2 us_rep1)) (=> (= (has_key o i2) true) (and (and (<= 1 (get1 o i2)) (<= (get1 o i2) (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))))) (forall ((j us_rep1)) (=> (= (has_key o j) true) (=> (= (get1 o i2) (get1 o j)) (= (bool_eq1 i2 j) true))))))))))
(assert (not (= (has_key o (mk___rep1 (mk___split_fields1 cu__split_fields2))) true)))
(check-sat)
(exit)
