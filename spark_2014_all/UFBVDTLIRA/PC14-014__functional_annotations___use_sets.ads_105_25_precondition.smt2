...
(assert (= result true))
(assert (and (= o2 (elements s)) (and (and (and (and (= (length2 o2) (length s)) (forall ((temp___425 Int)) (=> (and (in_range3 temp___425) (= (iter_has_element o2 temp___425) true)) (= (contains (model__ s) (get o2 temp___425)) true)))) (forall ((item Int)) (=> (and (in_range4 item) (= (contains (model__ s) item) true)) (and (< 0 (find o2 item)) (= (get o2 (find o2 item)) item))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (= (find o2 (get o2 i1)) i1)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length s))) (=> (= (get o2 i1) (get o2 j)) (= i1 j)))))))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
