...
(assert (=> (= (ite (= (= x ((_ int2bv 64) 0)) true) (= y ((_ int2bv 64) 0)) false) true) (= t3__msub__result4 ((_ int2bv 64) 0))))
(assert (=> (= (ite (= (not (= x ((_ int2bv 64) 0))) true) (= y ((_ int2bv 64) 0)) false) true) (= t3__msub__result4 x)))
(assert (=> (= (ite (= (= x ((_ int2bv 64) 0)) true) (not (= y ((_ int2bv 64) 0))) false) true) (= t3__msub__result4 (bvurem (bvsub ((_ int2bv 64) 230) y) ((_ int2bv 64) 230)))))
(assert (= (ite (= (= x ((_ int2bv 64) 2)) true) (= y ((_ int2bv 64) 4)) false) true))
(assert (not (= t3__msub__result4 ((_ int2bv 64) 228))))
(check-sat)
(exit)
