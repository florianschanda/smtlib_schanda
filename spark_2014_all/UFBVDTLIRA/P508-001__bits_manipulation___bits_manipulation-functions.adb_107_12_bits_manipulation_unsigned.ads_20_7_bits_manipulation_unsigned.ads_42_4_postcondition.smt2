...
(assert (= bits_manipulation_unsigned__unsigned_8__functions__msb_index_fast_inline__result1 bits_manipulation_unsigned__unsigned_8__functions__msb_index_fast_inline__result2))
(assert (= bits_manipulation_unsigned__unsigned_8__functions__msb_index_fast_inline__result3 bits_manipulation_unsigned__unsigned_8__functions__msb_index_fast_inline__result1))
(assert (and (= o (msb_index_fast_inline_always value)) (and (in_range1 o) (= (shift_right value o) #x01))))
(assert (= result bits_manipulation_unsigned__unsigned_8__functions__msb_index_fast_inline__result))
(assert (= bits_manipulation_unsigned__unsigned_8__functions__msb_index_fast_inline__result1 o))
(assert (= (mk_int__ref bits_manipulation_unsigned__unsigned_8__functions__msb_index_fast_inline__result4) (mk_int__ref bits_manipulation_unsigned__unsigned_8__functions__msb_index_fast_inline__result2)))
(assert (= bits_manipulation_unsigned__unsigned_8__functions__msb_index_fast_inline__result5 bits_manipulation_unsigned__unsigned_8__functions__msb_index_fast_inline__result3))
(assert (= result1 bits_manipulation_unsigned__unsigned_8__functions__msb_index_fast_inline__result4))
(assert (not (= (shift_right value bits_manipulation_unsigned__unsigned_8__functions__msb_index_fast_inline__result4) #x01)))
(check-sat)
(exit)
