...
(declare-const temp___2392 (_ BitVec 64))
...
(assert (or (and (and (and (= inrange3__inrange64__result3 inrange3__inrange64__result11) (= i2 i8)) (and (= inrange3__inrange64__result12 inrange3__inrange64__result3) (= i9 i2))) (and (bvult i1 range_size) (and (= temp___238 i1) (and (= #x0000000000000000 temp___239) (and (and (and (bvule #x0000000000000000 i2) (bvule i2 (bvsub range_size #x0000000000000001))) (or (= i2 #x0000000000000000) (forall ((n (_ BitVec 64))) (=> (and (bvule #x0000000000000000 n) (bvule n (bvsub i2 #x0000000000000001))) (not (= var (bvadd bottom n))))))) (and (bvult i2 range_size) (and (and (= temp___2391 result1) (= temp___2392 i2)) (and (= var (bvadd bottom i2)) (and (= inrange3__inrange64__result2 result2) (= inrange3__inrange64__result3 (distinct 1 0))))))))))) (and (ite (bvult i1 range_size) (and (and (and (= temp___238 i1) (and (= #x0000000000000000 temp___239) (and (and (and (bvule #x0000000000000000 i2) (bvule i2 (bvsub range_size #x0000000000000001))) (or (= i2 #x0000000000000000) (forall ((n (_ BitVec 64))) (=> (and (bvule #x0000000000000000 n) (bvule n (bvsub i2 #x0000000000000001))) (not (= var (bvadd bottom n))))))) (and (bvult i2 range_size) (and (and (= temp___2391 result1) (= temp___2392 i2)) (and (and (not (= var (bvadd bottom i2))) (= inrange3__inrange64__result3 inrange3__inrange64__result2)) (and (and (= i2 result3) (= i3 (bvadd i2 #x0000000000000001))) (not (bvult i3 range_size))))))))) (and (and (= inrange3__inrange64__result3 inrange3__inrange64__result4) (= i3 i4)) (and (= inrange3__inrange64__result5 inrange3__inrange64__result3) (= i5 i3)))) (and (and (= inrange3__inrange64__result16 (mk_bool__ref inrange3__inrange64__result4)) (= i13 (mk_t__ref i4))) (and (= inrange3__inrange64__result7 inrange3__inrange64__result5) (= i7 i5)))) (and (and (= inrange3__inrange64__result16 (mk_bool__ref inrange3__inrange64__result)) (= i1 i6)) (and (= inrange3__inrange64__result7 inrange3__inrange64__result1) (= i7 i1)))) (and (and (and (= inrange3__inrange64__result15 (mk_bool__ref inrange3__inrange64__result9)) (= i12 i13)) (and (= inrange3__inrange64__result12 inrange3__inrange64__result10) (= i9 i7))) (and (and (= inrange3__inrange64__result8 inrange3__inrange64__result9) (= inrange3__inrange64__result10 inrange3__inrange64__result8)) (and (= (mk_bool__ref result4) inrange3__inrange64__result16) (= inrange3__inrange64__result8 (distinct 0 0))))))))
