...
(assert (=> (not (= result true)) (= (mk___split_fields1 (mk___rep (mk___split_fields state_item__split_fields4 state_item__split_fields5))) (mk___split_fields1 (mk___rep (mk___split_fields state_item__split_fields2 state_item__split_fields3))))))
(assert (= state_item__split_fields6 state_item__split_fields4))
(assert (= state_item__split_fields7 state_item__split_fields5))
(assert (= (mk___split_fields1 (mk___rep (mk___split_fields state_item__split_fields8 state_item__split_fields9))) (mk___split_fields1 (mk___rep (mk___split_fields state_item__split_fields4 state_item__split_fields5)))))
