...
(define-fun default_initial_assumption ((temp___expr_875 us_rep1) (temp___skip_top_level_876 Bool)) Bool (=> (not (= temp___skip_top_level_876 true)) (= (length2 temp___expr_875) 0)))
...
(define-fun default_initial_assumption1 ((temp___expr_839 us_rep2) (temp___skip_top_level_840 Bool)) Bool (=> (not (= temp___skip_top_level_840 true)) (= (is_empty temp___expr_839) true)))
