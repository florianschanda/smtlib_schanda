...
(assert (<= 1 i2))
(assert (<= i2 (length (mk___rep s2__split_discrs (mk___split_fields s2__split_fields1)))))
(assert (not (= (contains (model__ (mk___rep s2__split_discrs (mk___split_fields s2__split_fields1))) (get (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) i2)) true)))
(check-sat)
(exit)
