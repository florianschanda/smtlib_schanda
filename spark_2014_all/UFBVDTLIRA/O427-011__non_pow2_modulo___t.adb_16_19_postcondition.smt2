...
(assert (=> (bvule (bvsub ((_ int2bv 8) 230) x) y) (= o (bvsub (bvadd x y) ((_ int2bv 8) 230)))))
(assert (=> (not (bvule (bvsub ((_ int2bv 8) 230) x) y)) (= o (bvadd x y))))
...
(assert (not (= ((_ zero_extend 8) t__madd__result4) (bvurem (bvadd ((_ zero_extend 8) x) ((_ zero_extend 8) y)) ((_ int2bv 16) 230)))))
(check-sat)
(exit)
