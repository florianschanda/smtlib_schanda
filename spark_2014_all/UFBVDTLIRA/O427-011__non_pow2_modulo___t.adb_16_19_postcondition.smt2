...
(declare-sort m 0)
(define-fun in_range ((x (_ BitVec 8))) Bool (and (bvule #x00 x) (bvule x #xE5)))
...
(define-fun dynamic_invariant ((temp___expr_207 (_ BitVec 8)) (temp___is_init_203 Bool) (temp___skip_constant_204 Bool) (temp___do_toplevel_205 Bool) (temp___do_typ_inv_206 Bool)) Bool (=> (or (= temp___is_init_203 true) (bvule #x00 #xE5)) (in_range temp___expr_207)))
...
(declare-const t__madd__result1 (_ BitVec 8))
(declare-const t__madd__result2 (_ BitVec 8))
(declare-const t__madd__result3 (_ BitVec 8))
(declare-const t__madd__result4 (_ BitVec 8))
(declare-const t__madd__result5 (_ BitVec 8))
(declare-const result1 (_ BitVec 8))
(assert (in_range x))
(assert (in_range y))
(assert (= t__madd__result1 t__madd__result2))
(assert (= t__madd__result3 t__madd__result1))
(assert (=> (bvule (bvsub #xE6 x) y) (= o (bvsub (bvadd x y) #xE6))))
(assert (=> (not (bvule (bvsub #xE6 x) y)) (= o (bvadd x y))))
(assert (= (mk_t__ref result) (mk_t__ref t__madd__result)))
(assert (= t__madd__result1 o))
(assert (= (mk_t__ref t__madd__result4) (mk_t__ref t__madd__result2)))
(assert (= t__madd__result5 t__madd__result3))
(assert (= result1 t__madd__result4))
(assert (not (= ((_ zero_extend 8) t__madd__result4) (bvurem (bvadd ((_ zero_extend 8) x) ((_ zero_extend 8) y)) #x00E6))))
(check-sat)
(exit)
