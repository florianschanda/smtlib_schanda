...
(assert (=> (= range_size #x0000000000000000) (= o (distinct 0 0))))
(assert (=> (not (= range_size #x0000000000000000)) (=> (bvule bottom (bvsub #xFFFFFFFFFFFFFFFF (bvsub range_size #x0000000000000001))) (= o (ite (bvule bottom var) (ite (bvule var (bvadd bottom (bvsub range_size #x0000000000000001))) true false) false)))))
(assert (=> (not (= range_size #x0000000000000000)) (=> (not (bvule bottom (bvsub #xFFFFFFFFFFFFFFFF (bvsub range_size #x0000000000000001)))) (= o (ite (= (ite (bvule bottom var) (distinct 1 0) false) false) (ite (bvule var (bvsub (bvsub range_size (bvsub #xFFFFFFFFFFFFFFFF bottom)) #x0000000000000002)) true false) true)))))
