...
(assert (=> (= range_size ((_ int2bv 64) 0)) (= o (of_int 0))))
(assert (=> (not (= range_size ((_ int2bv 64) 0))) (=> (bvule bottom (bvsub ((_ int2bv 64) 18446744073709551615) (bvsub range_size ((_ int2bv 64) 1)))) (= o (ite (bvule bottom var) (ite (bvule var (bvadd bottom (bvsub range_size ((_ int2bv 64) 1)))) true false) false)))))
(assert (=> (not (= range_size ((_ int2bv 64) 0))) (=> (not (bvule bottom (bvsub ((_ int2bv 64) 18446744073709551615) (bvsub range_size ((_ int2bv 64) 1))))) (= o (ite (= (ite (bvule bottom var) (of_int 1) false) false) (ite (bvule var (bvsub (bvsub range_size (bvsub ((_ int2bv 64) 18446744073709551615) bottom)) ((_ int2bv 64) 2))) true false) true)))))
(assert (= result x86__inrange64__result))
...
(assert (not (not (= range_size ((_ int2bv 64) 0)))))
(check-sat)
(exit)
