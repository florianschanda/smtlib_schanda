...
(assert (not (= (t__content estimatedgroundvelocity5) (bvudiv (bvmul (distancesincelastclickbeforelastupdate prevtime prevcount currtime thistime thiscount) ((_ int2bv 16) 3600)) (timesincelastclickbeforelastupdate prevtime currtime thistime)))))
(check-sat)
(exit)
