...
(assert (=> (= result true) (and (= o1 (- 7 left)) (in_range1 (- 7 left)))))
(assert (=> (= result true) (= o2 ((_ int2bv 8) o1))))
(assert (=> (= result true) (= bitwalker__pokebit8__mask__assume (bvshl ((_ int2bv 8) 1) o2))))
(assert (=> (not (= result true)) (= bitwalker__pokebit8__mask__assume ((_ int2bv 8) 0))))
(assert (= bitwalker__pokebit8__mask__assume mask))
(assert true)
(assert (=> (= flag true) (= bitwalker__pokebit8__r__assume (bvor byte mask))))
(assert (=> (not (= flag true)) (= bitwalker__pokebit8__r__assume (bvand byte (bvnot mask)))))
...
(assert (forall ((i2 (_ BitVec 8))) (=> (and (bvule ((_ int2bv 8) 0) i2) (bvule i2 ((_ int2bv 8) 7))) (=> (not (= i2 (bvsub ((_ int2bv 8) 7) left_bv))) (= (= (nth_bv r i2) true) (= (nth_bv byte i2) true))))))
(assert (not true))
(check-sat)
(exit)
