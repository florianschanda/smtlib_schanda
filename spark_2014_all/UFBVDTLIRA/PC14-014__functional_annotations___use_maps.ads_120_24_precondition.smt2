...
(define-fun dynamic_invariant4 ((temp___expr_353 Int) (temp___is_init_349 Bool) (temp___skip_constant_350 Bool) (temp___do_toplevel_351 Bool) (temp___do_typ_inv_352 Bool)) Bool (=> (or (= temp___is_init_349 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_353)))
...
(define-fun dynamic_invariant7 ((temp___expr_346 Int) (temp___is_init_342 Bool) (temp___skip_constant_343 Bool) (temp___do_toplevel_344 Bool) (temp___do_typ_inv_345 Bool)) Bool (=> (or (= temp___is_init_342 true) (<= 1 2147483647)) (in_range7 temp___expr_346)))
(assert (forall ((container us_rep2)) (forall ((key Int)) (! (=> (dynamic_invariant7 key true true true true) (let ((result (find container key))) (and (=> (< 0 result) (and (<= result (length2 container)) (= key (get container result)))) (dynamic_invariant result true false true true)))) :pattern ((find container key))))))
...
(assert (forall ((left us_rep1) (right us_rep1)) (! (= (= (oeq2 left right) true) (and (forall ((key Int)) (=> (and (in_range2 key) (= (has_key left key) true)) (and (= (has_key right key) true) (= (get1 right key) (get1 left key))))) (forall ((key Int)) (=> (and (in_range2 key) (= (has_key right key) true)) (= (has_key left key) true))))) :pattern ((oeq2 left right)))))
