...
(assert (forall ((container us_rep1)) (forall ((key Int)) (! (=> (dynamic_invariant1 key true true true) (=> (= (of_int 1) true) (=> (exists ((k Int)) (and (and (in_range2 k) (= (has_key container k) true)) (= k key))) (= (has_key container key) true)))) :pattern ((has_key container key))))))
...
(define-fun dynamic_invariant2 ((temp___expr_385 Int) (temp___is_init_382 Bool) (temp___skip_constant_383 Bool) (temp___do_toplevel_384 Bool)) Bool (=> (or (= temp___is_init_382 true) (<= 1 2147483647)) (in_range3 temp___expr_385)))
...
(define-fun dynamic_invariant3 ((temp___expr_391 Int) (temp___is_init_388 Bool) (temp___skip_constant_389 Bool) (temp___do_toplevel_390 Bool)) Bool (=> (or (= temp___is_init_388 true) (<= 0 2147483647)) (in_range4 temp___expr_391)))
...
(assert (forall ((container us_rep)) (! (let ((result (keys container))) (and (and (and (and (= (length3 result) (length container)) (forall ((temp___435 Int)) (=> (and (in_range4 temp___435) (= (iter_has_element result temp___435) true)) (= (has_key (model__ container) (get result temp___435)) true)))) (forall ((key Int)) (=> (and (in_range2 key) (= (has_key (model__ container) key) true)) (and (< 0 (find result key)) (= (get result (find result key)) key))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (= (find result (get result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length container))) (=> (= (get result i) (get result j)) (= i j)))))))) :pattern ((keys container)))))
...
(define-fun dynamic_invariant4 ((temp___expr_319 Int) (temp___is_init_316 Bool) (temp___skip_constant_317 Bool) (temp___do_toplevel_318 Bool)) Bool (=> (or (= temp___is_init_316 true) (<= 1 2147483647)) (in_range5 temp___expr_319)))
...
(define-fun dynamic_invariant5 ((temp___expr_325 Int) (temp___is_init_322 Bool) (temp___skip_constant_323 Bool) (temp___do_toplevel_324 Bool)) Bool (=> (or (= temp___is_init_322 true) (<= (- 2147483648) 2147483647)) (in_range6 temp___expr_325)))
...
(assert (forall ((attr__tag Int) (key Int)) (forall ((container us_rep)) (! (=> (dynamic_invariant4 key true true true) (dynamic_invariant5 (element__21 attr__tag container key) true false true)) :pattern ((element__21 attr__tag container key))))))
...
(define-fun dynamic_invariant6 ((temp___expr_15 Int) (temp___is_init_12 Bool) (temp___skip_constant_13 Bool) (temp___do_toplevel_14 Bool)) Bool (=> (or (= temp___is_init_12 true) (<= (- 2147483648) 2147483647)) (in_range7 temp___expr_15)))
(assert true)
...
(assert (forall ((container us_rep2)) (forall ((key Int)) (! (=> (dynamic_invariant4 key true true true) (let ((result (find container key))) (and (=> (< 0 result) (and (<= result (length3 container)) (= key (get container result)))) (dynamic_invariant result true false true)))) :pattern ((find container key))))))
...
(assert (forall ((container us_rep1)) (forall ((key Int)) (! (=> (and (dynamic_invariant1 key true true true) (= (has_key container key) true)) (let ((result (get1 container key))) (and (=> (= (of_int 1) true) (and (= result (w_get container (witness container key))) (forall ((k Int)) (=> (and (in_range2 k) (= (has_key container k) true)) (= (= k key) (= (witness container key) (witness container k))))))) (dynamic_invariant8 result true false true)))) :pattern ((get1 container key))))))
...
(assert (forall ((container us_rep1)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant witness1 true true true) (= (has_witness container witness1) true)) (dynamic_invariant8 (w_get container witness1) true false true)) :pattern ((w_get container witness1))))))
...
(declare-const temp___967 us_rep1)
(declare-const k Int)
...
(assert (forall ((k1 Int)) (=> (and (in_range2 k1) (= (has_key (model__ s) k1) true)) (= (q (get1 (model__ s) k1)) true))))
(assert (and (= o3 (length s)) (and (in_range1 o3) (<= o3 (to_rep1 (rec__use_maps__my_maps__map__capacity (us_split_discrs1 s)))))))
(assert (= o4 (ite (<= i o3) true false)))
(assert (= result1 (ite (<= 1 i) o4 false)))
(assert (= result1 true))
(assert (and (= o5 (keys s)) (and (and (and (and (= (length3 o5) (length s)) (forall ((temp___431 Int)) (=> (and (in_range4 temp___431) (= (iter_has_element o5 temp___431) true)) (= (has_key (model__ s) (get o5 temp___431)) true)))) (forall ((key Int)) (=> (and (in_range2 key) (= (has_key (model__ s) key) true)) (and (< 0 (find o5 key)) (= (get o5 (find o5 key)) key))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (= (find o5 (get o5 i1)) i1)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length s))) (=> (= (get o5 i1) (get o5 j)) (= i1 j)))))))))
(assert (and (= o6 (get o5 i)) (in_range3 o6)))
(assert (not (= (has_key (model__ s) o6) true)))
(check-sat)
(exit)
