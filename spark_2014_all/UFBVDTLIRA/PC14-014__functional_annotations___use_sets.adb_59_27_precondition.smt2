...
(define-fun dynamic_invariant ((temp___expr_386 Int) (temp___is_init_382 Bool) (temp___skip_constant_383 Bool) (temp___do_toplevel_384 Bool) (temp___do_typ_inv_385 Bool)) Bool (=> (or (= temp___is_init_382 true) (<= 0 2147483647)) (in_range2 temp___expr_386)))
...
(assert (forall ((container us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant item true true true true) (=> (= (distinct 1 0) true) (=> (exists ((e Int)) (and (and (in_range2 e) (= (contains container e) true)) (= e item))) (= (contains container item) true)))) :pattern ((contains container item))))))
...
(define-fun dynamic_invariant2 ((temp___expr_422 Int) (temp___is_init_418 Bool) (temp___skip_constant_419 Bool) (temp___do_toplevel_420 Bool) (temp___do_typ_inv_421 Bool)) Bool (=> (or (= temp___is_init_418 true) (<= 0 2147483647)) (in_range4 temp___expr_422)))
...
(define-fun default_initial_assumption1 ((temp___expr_430 us_rep3) (temp___skip_top_level_431 Bool)) Bool (=> (not (= temp___skip_top_level_431 true)) (= (length temp___expr_430) 0)))
...
(define-fun default_initial_assumption2 ((temp___expr_453 us_rep4) (temp___skip_top_level_454 Bool)) Bool (=> (not (= temp___skip_top_level_454 true)) (and (= (is_empty1 temp___expr_453) true) (= (length1 temp___expr_453) 0))))
...
(assert (forall ((container us_rep)) (! (let ((result (elements container))) (and (and (and (and (= (length result) (length2 container)) (forall ((temp___471 Int)) (=> (and (in_range4 temp___471) (= (iter_has_element result temp___471) true)) (= (contains (model__ container) (get result temp___471)) true)))) (forall ((item Int)) (=> (and (in_range2 item) (= (contains (model__ container) item) true)) (and (< 0 (find result item)) (= (get result (find result item)) item))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length2 container))) (= (find result (get result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length2 container))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length2 container))) (=> (= (get result i) (get result j)) (= i j)))))))) :pattern ((elements container)))))
...
(assert (forall ((container us_rep)) (! (let ((result (length2 container))) (and (<= result (to_rep1 (rec__use_sets__my_sets__set__capacity (us_split_discrs1 container)))) (dynamic_invariant6 result true false true true))) :pattern ((length2 container)))))
(assert (forall ((attr__tag Int)) (forall ((container us_rep)) (! (dynamic_invariant6 (length3 attr__tag container) true false true true) :pattern ((length3 attr__tag container))))))
(assert (forall ((container us_rep3)) (forall ((item Int)) (! (=> (dynamic_invariant4 item true true true true) (let ((result (find container item))) (and (=> (< 0 result) (and (<= result (length container)) (= item (get container result)))) (dynamic_invariant6 result true false true true)))) :pattern ((find container item))))))
...
(assert true)
(assert (forall ((container us_rep2)) (! (dynamic_invariant6 (length4 container) true false true true) :pattern ((length4 container)))))
...
(assert (forall ((container us_rep4)) (! (dynamic_invariant6 (length1 container) true false true true) :pattern ((length1 container)))))
...
(assert true)
(assert (forall ((container us_rep4)) (forall ((key us_rep1)) (! (=> (= (has_key container key) true) (let ((result (witness container key))) (and (= (has_witness container result) true) (dynamic_invariant6 result true false true true)))) :pattern ((witness container key))))))
(assert (forall ((container us_rep4)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant6 witness1 true true true true) (= (has_witness container witness1) true)) (dynamic_invariant3 (w_get container witness1) true false true true)) :pattern ((w_get container witness1))))))
...
(define-fun use_sets__are_disjoint_2__cu__assume1 () us_rep1 (mk___rep1 (mk___split_fields1 use_sets__are_disjoint_2__cu__assume)))
(assert (and (= use_sets__are_disjoint_2__cu__assume1 (first s1)) (ite (= (= (length2 s1) 0) true) (= (bool_eq1 use_sets__are_disjoint_2__cu__assume1 no_element) true) (and (= (has_key (positions s1) use_sets__are_disjoint_2__cu__assume1) true) (= (get1 (positions s1) use_sets__are_disjoint_2__cu__assume1) 1)))))
...
(assert (not (= (has_key (positions s1) (mk___rep1 cu__split_fields3)) true)))
(check-sat)
(exit)
