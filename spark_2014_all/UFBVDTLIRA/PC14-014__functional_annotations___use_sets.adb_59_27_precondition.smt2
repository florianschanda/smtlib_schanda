...
(define-fun dynamic_invariant ((temp___expr_354 Int) (temp___is_init_351 Bool) (temp___skip_constant_352 Bool) (temp___do_toplevel_353 Bool)) Bool (=> (or (= temp___is_init_351 true) (<= 0 2147483647)) (in_range2 temp___expr_354)))
...
(assert (forall ((container us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant item true true true) (=> (= (of_int 1) true) (=> (exists ((e Int)) (and (and (in_range2 e) (= (contains container e) true)) (= e item))) (= (contains container item) true)))) :pattern ((contains container item))))))
...
(define-fun dynamic_invariant2 ((temp___expr_385 Int) (temp___is_init_382 Bool) (temp___skip_constant_383 Bool) (temp___do_toplevel_384 Bool)) Bool (=> (or (= temp___is_init_382 true) (<= 0 2147483647)) (in_range4 temp___expr_385)))
...
(define-fun default_initial_assumption1 ((temp___expr_392 us_rep3) (temp___skip_top_level_393 Bool)) Bool (=> (not (= temp___skip_top_level_393 true)) (= (length temp___expr_392) 0)))
...
(define-fun default_initial_assumption2 ((temp___expr_412 us_rep4) (temp___skip_top_level_413 Bool)) Bool (=> (not (= temp___skip_top_level_413 true)) (and (= (is_empty1 temp___expr_412) true) (= (length1 temp___expr_412) 0))))
...
(assert (forall ((container us_rep)) (! (let ((result (elements container))) (and (and (and (and (= (length result) (length2 container)) (forall ((temp___429 Int)) (=> (and (in_range4 temp___429) (= (iter_has_element result temp___429) true)) (= (contains (model__ container) (get result temp___429)) true)))) (forall ((item Int)) (=> (and (in_range2 item) (= (contains (model__ container) item) true)) (and (< 0 (find result item)) (= (get result (find result item)) item))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length2 container))) (= (find result (get result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length2 container))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length2 container))) (=> (= (get result i) (get result j)) (= i j)))))))) :pattern ((elements container)))))
...
(assert (forall ((container us_rep)) (! (let ((result (length2 container))) (and (<= result (to_rep1 (rec__use_sets__my_sets__set__capacity (us_split_discrs1 container)))) (dynamic_invariant6 result true false true))) :pattern ((length2 container)))))
(assert (forall ((attr__tag Int)) (forall ((container us_rep)) (! (dynamic_invariant6 (length3 attr__tag container) true false true) :pattern ((length3 attr__tag container))))))
(assert (forall ((container us_rep3)) (forall ((item Int)) (! (=> (dynamic_invariant4 item true true true) (let ((result (find container item))) (and (=> (< 0 result) (and (<= result (length container)) (= item (get container result)))) (dynamic_invariant6 result true false true)))) :pattern ((find container item))))))
...
(assert (forall ((left us_rep) (right us_rep)) (! (let ((result (oeq left right))) (and (= (= result true) (and (= (length2 left) (length2 right)) (= (e_elements_included (elements left) (elements right)) true))) (= (= result true) (and (= (e_elements_included (elements left) (elements right)) true) (= (e_elements_included (elements right) (elements left)) true))))) :pattern ((oeq left right)))))
(assert true)
(assert (forall ((container us_rep2)) (! (dynamic_invariant6 (length4 container) true false true) :pattern ((length4 container)))))
...
(assert (forall ((container us_rep3)) (! (let ((result (length container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant6 result true false true))) :pattern ((length container)))))
...
(assert (forall ((container us_rep4)) (! (dynamic_invariant6 (length1 container) true false true) :pattern ((length1 container)))))
...
(assert true)
(assert (forall ((container us_rep4)) (forall ((key us_rep1)) (! (=> (= (has_key container key) true) (let ((result (witness container key))) (and (= (has_witness container result) true) (dynamic_invariant6 result true false true)))) :pattern ((witness container key))))))
(assert (forall ((container us_rep4)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant6 witness1 true true true) (= (has_witness container witness1) true)) (dynamic_invariant3 (w_get container witness1) true false true)) :pattern ((w_get container witness1))))))
...
(declare-const temp___906 us_rep2)
(declare-const e Int)
...
(declare-const use_sets__are_disjoint_2__result4 Bool)
...
(declare-const use_sets__are_disjoint_2__result8 bool__ref)
(declare-const cu__split_fields9 us_split_fields2)
(declare-const use_sets__are_disjoint_2__result9 Bool)
...
(declare-const use_sets__are_disjoint_2__result15 bool__ref)
(declare-const cu__split_fields13 us_split_fields2)
(declare-const use_sets__are_disjoint_2__result16 Bool)
(assert (and (= (mk___rep1 (mk___split_fields1 use_sets__are_disjoint_2__cu__assume)) (first s1)) (ite (= (= (length2 s1) 0) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 use_sets__are_disjoint_2__cu__assume)) no_element) true) (and (= (has_key (positions s1) (mk___rep1 (mk___split_fields1 use_sets__are_disjoint_2__cu__assume))) true) (= (get1 (positions s1) (mk___rep1 (mk___split_fields1 use_sets__are_disjoint_2__cu__assume))) 1)))))
...
(assert (not (= (has_key (positions s1) (mk___rep1 (mk___split_fields1 cu__split_fields2))) true)))
(check-sat)
(exit)
