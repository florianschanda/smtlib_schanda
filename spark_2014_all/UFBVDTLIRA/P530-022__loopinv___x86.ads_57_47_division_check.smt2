...
(assert (not (= divisor #x0000000000000000)))
...
(assert (= (mk_t__ref result) (mk_t__ref x86__safedivision64__result)))
(assert (= x86__safedivision64__result1 (bvudiv dividend divisor)))
(assert (= (mk_t__ref x86__safedivision64__result4) (mk_t__ref x86__safedivision64__result2)))
(assert (= x86__safedivision64__result5 x86__safedivision64__result3))
(assert (not (not (= divisor #x0000000000000000))))
(check-sat)
(exit)
