...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__term__tset__set us_main_type)))))
(define-fun us_split_fields_Set__projection ((a us_split_fields)) us_main_type (rec__term__tset__set a))
...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (and (= (to_rep (rec__term__tset__set__capacity (us_split_discrs1 a))) (to_rep (rec__term__tset__set__capacity (us_split_discrs1 b)))) (= (to_rep1 (rec__term__tset__set__modulus (us_split_discrs1 a))) (to_rep1 (rec__term__tset__set__modulus (us_split_discrs1 b))))) (= (us_main_eq (rec__term__tset__set (us_split_fields1 a)) (rec__term__tset__set (us_split_fields1 b))) true)) true false))
...
(define-fun dynamic_invariant2 ((temp___expr_354 Int) (temp___is_init_351 Bool) (temp___skip_constant_352 Bool) (temp___do_toplevel_353 Bool)) Bool (=> (or (= temp___is_init_351 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_354)))
(define-fun dynamic_invariant3 ((temp___expr_385 Int) (temp___is_init_382 Bool) (temp___skip_constant_383 Bool) (temp___do_toplevel_384 Bool)) Bool (=> (or (= temp___is_init_382 true) (<= 0 2147483647)) (in_range3 temp___expr_385)))
...
(assert (and (= o6 (length (mk___rep target__split_discrs (mk___split_fields target__split_fields)))) (and (in_range1 o6) (<= o6 (to_rep (rec__term__tset__set__capacity target__split_discrs))))))
(assert (= o7 (- (to_rep (rec__term__tset__set__capacity target__split_discrs)) o6)))
(assert (and (= o12 o7) (in_range o7)))
(assert (= o13 (+ o12 o11)))
(assert (and (= o14 o13) (in_range o13)))
(assert (and (= (mk___rep (mk___split_discrs o o1) (mk___split_fields o2)) (intersection__2 (mk___rep target__split_discrs (mk___split_fields target__split_fields)) source)) (and (and (and (and (and (= (length (mk___rep (mk___split_discrs o o1) (mk___split_fields o2))) (num_overlaps (model__ (mk___rep target__split_discrs (mk___split_fields target__split_fields))) (model__ source))) (= (ole (model__ (mk___rep (mk___split_discrs o o1) (mk___split_fields o2))) (model__ (mk___rep target__split_discrs (mk___split_fields target__split_fields)))) true)) (= (ole (model__ (mk___rep (mk___split_discrs o o1) (mk___split_fields o2))) (model__ source)) true)) (= (includes_intersection (model__ (mk___rep (mk___split_discrs o o1) (mk___split_fields o2))) (model__ (mk___rep target__split_discrs (mk___split_fields target__split_fields))) (model__ source)) true)) (= (e_elements_included (elements (mk___rep (mk___split_discrs o o1) (mk___split_fields o2))) (elements (mk___rep target__split_discrs (mk___split_fields target__split_fields)))) true)) (= (e_elements_included__2 (elements (mk___rep target__split_discrs (mk___split_fields target__split_fields))) (model__ source) (elements (mk___rep (mk___split_discrs o o1) (mk___split_fields o2)))) true))))
(assert (and (= o3 (length (mk___rep (mk___split_discrs o o1) (mk___split_fields o2)))) (and (in_range1 o3) (<= o3 (to_rep o)))))
(assert (and (= o4 (length source)) (and (in_range1 o4) (<= o4 (to_rep (rec__term__tset__set__capacity (us_split_discrs1 source)))))))
(assert (= o5 (- o4 o3)))
(assert (not (in_range o5)))
(check-sat)
(exit)
