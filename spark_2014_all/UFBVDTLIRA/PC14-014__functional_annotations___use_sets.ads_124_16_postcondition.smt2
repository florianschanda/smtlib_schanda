...
(define-fun dynamic_invariant1 ((temp___expr_325 Int) (temp___is_init_322 Bool) (temp___skip_constant_323 Bool) (temp___do_toplevel_324 Bool)) Bool (=> (or (= temp___is_init_322 true) (<= 0 2147483647)) (in_range3 temp___expr_325)))
...
(define-fun dynamic_invariant2 ((temp___expr_319 Int) (temp___is_init_316 Bool) (temp___skip_constant_317 Bool) (temp___do_toplevel_318 Bool)) Bool (=> (or (= temp___is_init_316 true) (<= 0 2147483647)) (in_range4 temp___expr_319)))
(assert true)
...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep1 (rec__use_sets__my_sets__set__capacity (us_split_discrs1 container)))) (dynamic_invariant4 result true false true))) :pattern ((length container)))))
(assert (forall ((attr__tag Int)) (forall ((container us_rep)) (! (dynamic_invariant4 (length1 attr__tag container) true false true) :pattern ((length1 attr__tag container))))))
...
(assert (forall ((a us_rep4) (b us_rep4)) (! (= (user_eq7 a b) (oeq2 a b)) :pattern ((user_eq7 a b)))))
...
(assert (forall ((container us_rep4)) (forall ((item Int)) (! (=> (dynamic_invariant1 item true true true) (let ((result (find container item))) (and (=> (< 0 result) (and (<= result (length3 container)) (= item (get container result)))) (dynamic_invariant4 result true false true)))) :pattern ((find container item))))))
...
(assert (forall ((container us_rep)) (! (let ((result (elements container))) (and (and (and (and (= (length3 result) (length container)) (forall ((temp___429 Int)) (=> (and (in_range5 temp___429) (= (iter_has_element result temp___429) true)) (= (contains (model__ container) (get result temp___429)) true)))) (forall ((item Int)) (=> (and (in_range2 item) (= (contains (model__ container) item) true)) (and (< 0 (find result item)) (= (get result (find result item)) item))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (= (find result (get result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length container))) (=> (= (get result i) (get result j)) (= i j)))))))) :pattern ((elements container)))))
...
(assert true)
(assert (forall ((container us_rep2)) (! (dynamic_invariant4 (length2 container) true false true) :pattern ((length2 container)))))
...
(assert (forall ((container us_rep4)) (! (let ((result (length3 container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant4 result true false true))) :pattern ((length3 container)))))
...
(define-fun dynamic_invariant6 ((temp___expr_379 Int) (temp___is_init_376 Bool) (temp___skip_constant_377 Bool) (temp___do_toplevel_378 Bool)) Bool (=> (or (= temp___is_init_376 true) (<= 0 2147483647)) (in_range6 temp___expr_379)))
(assert (forall ((container us_rep4)) (forall ((position Int)) (! (=> (and (dynamic_invariant5 position true true true) (and (<= 1 position) (<= position (last container)))) (dynamic_invariant6 (get container position) true false true)) :pattern ((get container position))))))
...
(assert (forall ((container us_rep3)) (! (dynamic_invariant4 (length4 container) true false true) :pattern ((length4 container)))))
...
(assert (forall ((container us_rep3)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant4 witness1 true true true) (= (has_witness container witness1) true)) (dynamic_invariant7 (w_get container witness1) true false true)) :pattern ((w_get container witness1))))))
...
(assert (= (has_key (positions s) cu1) true))
(assert (not (= (q (element s cu1)) true)))
(check-sat)
(exit)
