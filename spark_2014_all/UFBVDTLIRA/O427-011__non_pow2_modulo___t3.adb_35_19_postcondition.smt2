...
(declare-sort m 0)
(define-fun in_range ((x (_ BitVec 64))) Bool (and (bvule ((_ int2bv 64) 0) x) (bvule x ((_ int2bv 64) 229))))
...
(define-fun dynamic_invariant ((temp___expr_177 (_ BitVec 64)) (temp___is_init_174 Bool) (temp___skip_constant_175 Bool) (temp___do_toplevel_176 Bool)) Bool (=> (or (= temp___is_init_174 true) (bvule ((_ int2bv 64) 0) ((_ int2bv 64) 229))) (in_range temp___expr_177)))
...
(assert (not (= ((_ extract 15 0) t3__mmul__result4) (bvurem (bvmul ((_ extract 15 0) x) ((_ extract 15 0) y)) ((_ int2bv 16) 230)))))
(check-sat)
(exit)
