...
(assert (forall ((container1 us_rep3)) (forall ((position1 Int)) (! (=> (and (dynamic_invariant5 position1 true true true) (and (<= 1 position1) (<= position1 (last container1)))) (dynamic_invariant6 (get1 container1 position1) true false true)) :pattern ((get1 container1 position1))))))
...
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___849 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___849)) no_element))
