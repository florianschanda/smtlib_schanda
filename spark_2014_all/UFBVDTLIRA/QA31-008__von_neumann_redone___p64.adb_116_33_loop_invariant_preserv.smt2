...
(assert (forall ((x1 (_ BitVec 64))) (! (=> (and (dynamic_invariant x1 true true true true) (bvule x1 #x0000000000000040)) (dynamic_invariant (pow21 x1) true false true true)) :pattern ((pow21 x1)))))
(assert (forall ((x1 (_ BitVec 64))) (! (=> (dynamic_invariant x1 true true true true) (= (pow21 x1) (bvshl #x0000000000000001 ((_ int2bv 64) (bv2nat x1))))) :pattern ((pow21 x1)))))
...
(assert (not (= bits1 #x0000000000000000)))
(assert (not (= bits1 #x0000000000000000)))
(assert (= (sqr (bvadd res_g1 bits_g1)) (bvadd (sqr res_g1) (bvmul bits_g1 (bvadd (bvmul #x0000000000000002 res_g1) bits_g1)))))
(assert (not (= bits1 #x0000000000000000)))
(assert (not (= bits_g1 #x0000000000000000)))
(assert (not (= m1 #x0000000000000000)))
(assert (= i1 result7))
(assert (= i2 (bvadd i1 #x0000000000000001)))
(assert (= m1 result8))
(assert (= m2 (bvsub m1 #x0000000000000001)))
(assert (= res1 (bvmul res_g1 (pow21 (bvadd m2 #x0000000000000001)))))
(assert (= bits_g1 (pow21 m2)))
(assert (= (mk_t__ref result9) (mk_t__ref b)))
(assert (= b1 (bvor res1 bits1)))
(assert (= b1 (bvadd res1 bits1)))
(assert (= b1 (bvmul (bvadd (bvmul #x0000000000000002 res_g1) bits_g1) (pow21 m2))))
(assert (= res1 result10))
(assert (= res2 (bvlshr res1 ((_ int2bv 64) 1))))
(assert (= res2 (bvmul res_g1 (pow21 m2))))
(assert (=> (bvuge num1 b1) (= result11 (mk_t__ref num1))))
(assert (=> (bvuge num1 b1) (= num2 (bvsub num1 b1))))
(assert (=> (bvuge num1 b1) (= result12 (mk_t__ref res2))))
(assert (=> (bvuge num1 b1) (= res3 (bvor res2 bits1))))
(assert (=> (bvuge num1 b1) (= res3 (bvmul (bvadd res_g1 bits_g1) (pow21 m2)))))
(assert (=> (bvuge num1 b1) (= result13 (mk_t__ref res_g1))))
(assert (=> (bvuge num1 b1) (= res_g2 (bvadd res_g1 bits_g1))))
(assert (=> (not (bvuge num1 b1)) (= res_g2 res_g1)))
(assert (=> (not (bvuge num1 b1)) (= res3 res2)))
(assert (=> (not (bvuge num1 b1)) (= num2 num1)))
(assert (= result14 (mk_t__ref bits1)))
(assert (= bits2 (bvudiv bits1 #x0000000000000004)))
(assert (= result15 (mk_t__ref bits_g1)))
(assert (= bits_g2 (bvlshr bits_g1 ((_ int2bv 64) 1))))
(assert (= (sqr (bvadd res_g2 bits_g2)) (bvadd (sqr res_g2) (bvmul bits_g2 (bvadd (bvmul #x0000000000000002 res_g2) bits_g2)))))
(assert (bvule m3 #x0000000000000020))
(assert (= bits_g3 (ite (= m3 #x0000000000000000) #x0000000000000000 (pow21 (bvsub m3 #x0000000000000001)))))
(assert (= bits3 (sqr bits_g3)))
(assert (= (bvand res_g3 (bvsub (pow21 m3) #x0000000000000001)) #x0000000000000000))
(assert (bvult res_g3 #x0000000100000000))
(assert (= res4 (bvmul res_g3 (pow21 m3))))
(assert (bvule num3 x))
(assert (= (sqr (bvadd res_g3 bits_g3)) (bvadd (sqr res_g3) (bvmul bits_g3 (bvadd (bvmul #x0000000000000002 res_g3) bits_g3)))))
(assert (=> (not (= m3 #x0000000000000000)) (= (bvor res4 bits3) (bvmul (bvadd (bvmul #x0000000000000002 res_g3) bits_g3) (pow21 (bvsub m3 #x0000000000000001))))))
(assert (=> (not (= m3 #x0000000000000000)) (= bits_g3 (pow21 (bvsub m3 #x0000000000000001)))))
(assert (= (bvsub x num3) (sqr res_g3)))
(assert (bvule (bvadd res_g3 (pow21 m3)) #x0000000100000000))
(assert (bvule x (bvsub (sqr (bvadd res_g3 (pow21 m3))) #x0000000000000001)))
(assert (= result16 (mk_t__ref temp___260)))
(assert (= temp___2601 bits3))
(assert (not (= bits3 #x0000000000000000)))
(assert (not (= bits3 #x0000000000000000)))
(assert (= (sqr (bvadd res_g3 bits_g3)) (bvadd (sqr res_g3) (bvmul bits_g3 (bvadd (bvmul #x0000000000000002 res_g3) bits_g3)))))
(assert (not (= bits3 #x0000000000000000)))
(assert (not (= bits_g3 #x0000000000000000)))
(assert (not (= m3 #x0000000000000000)))
(assert (= result17 (mk_t__ref i3)))
(assert (= i4 (bvadd i3 #x0000000000000001)))
(assert (= result18 (mk_t__ref m3)))
(assert (= m4 (bvsub m3 #x0000000000000001)))
(assert (= res4 (bvmul res_g3 (pow21 (bvadd m4 #x0000000000000001)))))
(assert (= bits_g3 (pow21 m4)))
(assert (= result19 (mk_t__ref b2)))
(assert (= b3 (bvor res4 bits3)))
(assert (= b3 (bvadd res4 bits3)))
(assert (= b3 (bvmul (bvadd (bvmul #x0000000000000002 res_g3) bits_g3) (pow21 m4))))
(assert (= result20 (mk_t__ref res4)))
(assert (= res5 (bvlshr res4 ((_ int2bv 64) 1))))
(assert (= res5 (bvmul res_g3 (pow21 m4))))
(assert (=> (bvuge num3 b3) (= result21 (mk_t__ref num3))))
(assert (=> (bvuge num3 b3) (= num4 (bvsub num3 b3))))
(assert (=> (bvuge num3 b3) (= result22 (mk_t__ref res5))))
(assert (=> (bvuge num3 b3) (= res6 (bvor res5 bits3))))
(assert (=> (bvuge num3 b3) (= res6 (bvmul (bvadd res_g3 bits_g3) (pow21 m4)))))
(assert (=> (bvuge num3 b3) (= result23 (mk_t__ref res_g3))))
(assert (=> (bvuge num3 b3) (= res_g4 (bvadd res_g3 bits_g3))))
(assert (=> (not (bvuge num3 b3)) (= res_g4 res_g3)))
(assert (=> (not (bvuge num3 b3)) (= res6 res5)))
(assert (=> (not (bvuge num3 b3)) (= num4 num3)))
(assert (= result24 (mk_t__ref bits3)))
(assert (= bits4 (bvudiv bits3 #x0000000000000004)))
(assert (= result25 (mk_t__ref bits_g3)))
(assert (= bits_g4 (bvlshr bits_g3 ((_ int2bv 64) 1))))
(assert (= (sqr (bvadd res_g4 bits_g4)) (bvadd (sqr res_g4) (bvmul bits_g4 (bvadd (bvmul #x0000000000000002 res_g4) bits_g4)))))
(assert (not (= (bvsub x num4) (sqr res_g4))))
(check-sat)
(exit)
