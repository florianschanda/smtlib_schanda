...
(define-fun dynamic_invariant ((temp___expr_142 (_ BitVec 32)) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool true)
