...
(declare-const num9 (_ BitVec 64))
...
(declare-const bits_g9 (_ BitVec 64))
(declare-const res_g9 (_ BitVec 64))
(declare-const p64__sqrt_von_neumann_aux64__result5 (_ BitVec 64))
(define-fun b10 () t__ref (mk_t__ref b))
(declare-const result18 (_ BitVec 64))
...
(assert (=> (not (= bits1 #x0000000000000000)) (= (mk_t__ref result9) b10)))
...
(assert (=> (not (not (= bits1 #x0000000000000000))) (= b6 b10)))
...
(assert (bvuge (bvsub (bvmul (bvadd (t__content res7) #x0000000000000001) (bvadd (t__content res7) #x0000000000000001)) #x0000000000000001) x))
(assert (= (sqr (bvadd (t__content res7) #x0000000000000001)) (bvadd (sqr (t__content res7)) (bvmul #x0000000000000001 (bvadd (bvmul #x0000000000000002 (t__content res7)) #x0000000000000001)))))
(assert (= p64__sqrt_von_neumann_aux64__result2 (mk_t__ref p64__sqrt_von_neumann_aux64__result1)))
(assert (= p64__sqrt_von_neumann_aux64__result3 p64__sqrt_von_neumann_aux64__result1))
(assert (= result17 (mk_t__ref p64__sqrt_von_neumann_aux64__result)))
(assert (= p64__sqrt_von_neumann_aux64__result1 (t__content res7)))
(assert (= p64__sqrt_von_neumann_aux64__result4 p64__sqrt_von_neumann_aux64__result2))
...
(assert (= bits8 bits6))
(assert (= num8 num6))
(assert (= p64__sqrt_von_neumann_aux64__result5 p64__sqrt_von_neumann_aux64__result3))
...
(assert (= bits9 bits7))
(assert (= num9 num7))
(assert (= result18 (t__content p64__sqrt_von_neumann_aux64__result4)))
(assert (not (bvuge (bvsub (bvmul (bvadd (t__content p64__sqrt_von_neumann_aux64__result4) #x0000000000000001) (bvadd (t__content p64__sqrt_von_neumann_aux64__result4) #x0000000000000001)) #x0000000000000001) x)))
(check-sat)
(exit)
