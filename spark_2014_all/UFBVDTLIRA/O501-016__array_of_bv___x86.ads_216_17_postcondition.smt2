...
(assert (forall ((x86__rsp (_ BitVec 64))) (! (=> (dynamic_invariant x86__rsp true true true) (let ((result (esp x86__rsp))) (and (= result ((_ extract 31 0) (bvand x86__rsp ((_ int2bv 64) 4294967295)))) (dynamic_invariant1 result true false true)))) :pattern ((esp x86__rsp)))))
