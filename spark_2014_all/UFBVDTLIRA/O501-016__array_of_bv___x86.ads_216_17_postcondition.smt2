...
(assert (forall ((x86__rsp (_ BitVec 64))) (! (=> (dynamic_invariant x86__rsp true true true true) (let ((result (esp x86__rsp))) (and (= result ((_ extract 31 0) (bvand x86__rsp #x00000000FFFFFFFF))) (dynamic_invariant1 result true false true true)))) :pattern ((esp x86__rsp)))))
