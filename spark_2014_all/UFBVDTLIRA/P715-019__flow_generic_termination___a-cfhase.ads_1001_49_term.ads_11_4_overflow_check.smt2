...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (and (= (to_rep1 (rec__term__tset__set__capacity (us_split_discrs1 a))) (to_rep1 (rec__term__tset__set__capacity (us_split_discrs1 b)))) (= (to_rep (rec__term__tset__set__modulus (us_split_discrs1 a))) (to_rep (rec__term__tset__set__modulus (us_split_discrs1 b))))) (= (us_main_eq (rec__term__tset__set (us_split_fields1 a)) (rec__term__tset__set (us_split_fields1 b))) true)) true false))
...
(define-fun default_initial_assumption1 ((temp___expr_430 us_rep1) (temp___skip_top_level_431 Bool)) Bool (=> (not (= temp___skip_top_level_431 true)) (= (length2 temp___expr_430) 0)))
