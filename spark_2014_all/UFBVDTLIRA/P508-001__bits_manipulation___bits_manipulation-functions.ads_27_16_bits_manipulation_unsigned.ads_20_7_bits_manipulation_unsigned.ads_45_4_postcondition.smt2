...
(assert (=> (= 2 0) (and (= o (msb_index_slow_inline_always value)) (and (in_range o) (= (shift_right value o) #x0000000000000001)))))
(assert (=> (= 2 0) (= result result__)))
(assert (=> (= 2 0) (= result__1 o)))
(assert (=> (not (= 2 0)) (and (= o1 (msb_index_fast_inline_always value)) (and (in_range o1) (= (shift_right value o1) #x0000000000000001)))))
