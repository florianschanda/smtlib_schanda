...
(assert (=> (= 2 0) (and (= o (msb_index_slow_inline_always value)) (and (in_range o) (= (shift_right value o) ((_ int2bv 64) 1))))))
(assert (=> (= 2 0) (= result result__)))
(assert (=> (= 2 0) (= result__1 o)))
(assert (=> (not (= 2 0)) (and (= o1 (msb_index_fast_inline_always value)) (and (in_range o1) (= (shift_right value o1) ((_ int2bv 64) 1))))))
...
(assert (not (= (shift_right value bits_manipulation_unsigned__unsigned_64__functions__msb_index__result4) ((_ int2bv 64) 1))))
(check-sat)
(exit)
