...
(assert (= result r9))
(assert (= r91 (bvor (bvand r9 ((_ int2bv 64) 18446744073709551360)) ((_ zero_extend 56) val__))))
(assert (= r91 r92))
(assert (= r93 r91))
(assert (not (= r92 (bvor (bvand r9 ((_ int2bv 64) 18446744073709551360)) ((_ zero_extend 56) val__)))))
(check-sat)
(exit)
