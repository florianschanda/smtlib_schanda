...
(assert (=> (= 2 0) (and (= o (msb_index_slow_inline_always value)) (and (in_range1 o) (= (shift_right value o) #x0001)))))
(assert (=> (= 2 0) (= result result__)))
(assert (=> (= 2 0) (= result__1 o)))
(assert (=> (not (= 2 0)) (and (= o1 (msb_index_fast_inline_always value)) (and (in_range1 o1) (= (shift_right value o1) #x0001)))))
...
(assert (not (= (shift_right value bits_manipulation_unsigned__unsigned_16__functions__msb_index__result4) #x0001)))
(check-sat)
(exit)
