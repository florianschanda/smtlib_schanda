...
(assert (and (= temp___9351 (next s1 (mk___rep cu__split_fields5))) (ite (= (ite (= (bool_eq2 (mk___rep cu__split_fields5) no_element) false) (= (get1 (positions s1) (mk___rep cu__split_fields5)) (length3 s1)) true) true) (= (bool_eq2 temp___9351 no_element) true) (and (= (has_key1 (positions s1) temp___9351) true) (= (get1 (positions s1) temp___9351) (+ (get1 (positions s1) (mk___rep cu__split_fields5)) 1))))))
