...
(assert (forall ((x86__rsi (_ BitVec 64))) (! (=> (dynamic_invariant x86__rsi true true true) (let ((result (esi x86__rsi))) (and (= result ((_ extract 31 0) (bvand x86__rsi ((_ int2bv 64) 4294967295)))) (dynamic_invariant1 result true false true)))) :pattern ((esi x86__rsi)))))
...
(assert (= result rsi))
(assert (= rsi1 (bvor (bvand rsi ((_ int2bv 64) 18446744069414584320)) ((_ zero_extend 32) val__))))
(assert (= rsi1 rsi2))
(assert (= rsi3 rsi1))
