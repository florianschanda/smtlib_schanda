...
(define-fun dynamic_invariant1 ((temp___expr_405 Int) (temp___is_init_402 Bool) (temp___skip_constant_403 Bool) (temp___do_toplevel_404 Bool)) Bool (=> (or (= temp___is_init_402 true) (<= 1 2147483647)) (in_range2 temp___expr_405)))
...
(define-fun default_initial_assumption ((temp___expr_412 us_rep2) (temp___skip_top_level_413 Bool)) Bool (=> (not (= temp___skip_top_level_413 true)) (and (= (is_empty temp___expr_412) true) (= (length2 temp___expr_412) 0))))
...
(define-fun dynamic_invariant2 ((temp___expr_319 Int) (temp___is_init_316 Bool) (temp___skip_constant_317 Bool) (temp___do_toplevel_318 Bool)) Bool (=> (or (= temp___is_init_316 true) (<= 1 100)) (in_range3 temp___expr_319)))
...
(define-fun dynamic_invariant4 ((temp___expr_325 Int) (temp___is_init_322 Bool) (temp___skip_constant_323 Bool) (temp___do_toplevel_324 Bool)) Bool (=> (or (= temp___is_init_322 true) (<= 1 100)) (in_range4 temp___expr_325)))
...
(define-fun default_initial_assumption1 ((temp___expr_392 us_rep3) (temp___skip_top_level_393 Bool)) Bool (=> (not (= temp___skip_top_level_393 true)) (= (length3 temp___expr_392) 0)))
(declare-fun find (us_rep3 Int) Int)
(declare-fun find__function_guard (Int us_rep3 Int) Bool)
(assert (forall ((container1 us_rep3)) (forall ((item Int)) (! (=> (dynamic_invariant4 item true true true) (let ((result (find container1 item))) (and (=> (< 0 result) (and (<= result (length3 container1)) (= (my_eq item (get1 container1 result)) true))) (dynamic_invariant result true false true)))) :pattern ((find container1 item))))))
...
(assert (forall ((container1 us_rep)) (! (let ((result (elements container1))) (and (and (and (and (= (length3 result) (length container1)) (forall ((temp___429 Int)) (=> (and (in_range6 temp___429) (= (iter_has_element result temp___429) true)) (= (contains (model__ container1) (get1 result temp___429)) true)))) (forall ((item Int)) (=> (and (in_range5 item) (= (contains (model__ container1) item) true)) (and (< 0 (find result item)) (= (my_eq (get1 result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (= (find result (get1 result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length container1))) (=> (= (my_eq (get1 result i) (get1 result j)) true) (= i j)))))))) :pattern ((elements container1)))))
...
(assert true)
(define-fun dynamic_invariant5 ((temp___expr_354 Int) (temp___is_init_351 Bool) (temp___skip_constant_352 Bool) (temp___do_toplevel_353 Bool)) Bool (=> (or (= temp___is_init_351 true) (<= 1 100)) (in_range5 temp___expr_354)))
(assert (forall ((container1 us_rep4)) (forall ((item Int)) (! (=> (dynamic_invariant5 item true true true) (=> (= (of_int 1) true) (=> (exists ((e Int)) (and (and (in_range5 e) (= (contains container1 e) true)) (= (my_eq e item) true))) (= (contains container1 item) true)))) :pattern ((contains container1 item))))))
...
(define-fun dynamic_invariant6 ((temp___expr_385 Int) (temp___is_init_382 Bool) (temp___skip_constant_383 Bool) (temp___do_toplevel_384 Bool)) Bool (=> (or (= temp___is_init_382 true) (<= 0 2147483647)) (in_range6 temp___expr_385)))
...
(define-fun dynamic_invariant7 ((temp___expr_379 Int) (temp___is_init_376 Bool) (temp___skip_constant_377 Bool) (temp___do_toplevel_378 Bool)) Bool (=> (or (= temp___is_init_376 true) (<= 1 100)) (in_range7 temp___expr_379)))
(assert (forall ((container1 us_rep3)) (forall ((position1 Int)) (! (=> (and (dynamic_invariant6 position1 true true true) (and (<= 1 position1) (<= position1 (last container1)))) (dynamic_invariant7 (get1 container1 position1) true false true)) :pattern ((get1 container1 position1))))))
...
(declare-const temp___818 count_type)
(declare-const o2 us_rep2)
(declare-const o3 Int)
(declare-const o4 Int)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___818 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___818)) no_element))
