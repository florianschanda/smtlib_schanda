...
(assert (bvule x (bvsub (sqr (bvadd (t__content res_g9) ((_ int2bv 64) 1))) ((_ int2bv 64) 1))))
(assert (bvule x (bvsub (sqr (bvadd (t__content res11) ((_ int2bv 64) 1))) ((_ int2bv 64) 1))))
(assert (= (bvsub x (t__content num9)) (sqr (t__content res_g9))))
(assert (bvuge (t__content num9) ((_ int2bv 64) 0)))
(assert (= (bvsub x (t__content num9)) (bvmul (t__content res_g9) (t__content res_g9))))
(assert (not (= (bvsub x (t__content num9)) (bvmul (t__content res11) (t__content res11)))))
(check-sat)
(exit)
