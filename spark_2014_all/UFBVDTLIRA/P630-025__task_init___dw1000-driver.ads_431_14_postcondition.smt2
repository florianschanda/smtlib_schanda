...
(define-fun to_int6 ((x bits_7)) Int (bv2nat (to_rep2 x)))
(assert (forall ((x bits_7)) (! (in_range_int2 (to_int6 x)) :pattern ((to_int6 x)))))
(declare-sort bits_14 0)
(define-fun in_range4 ((x (_ BitVec 16))) Bool (and (bvule ((_ int2bv 16) 0) x) (bvule x ((_ int2bv 16) 16383))))
...
(assert (forall ((x (_ BitVec 16))) (! (let ((y (bvurem x ((_ int2bv 16) 16384)))) (=> (in_range4 y) (= (to_rep3 (of_rep3 x)) y))) :pattern ((to_rep3 (of_rep3 x))))))
(define-fun to_int7 ((x bits_14)) Int (bv2nat (to_rep3 x)))
...
(define-fun dynamic_invariant ((temp___expr_3008 Int) (temp___is_init_3005 Bool) (temp___skip_constant_3006 Bool) (temp___do_toplevel_3007 Bool)) Bool (=> (or (= temp___is_init_3005 true) (<= 0 1)) (in_range6 temp___expr_3008)))
(declare-const delayed Bool)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(declare-const attr__ATTRIBUTE_ADDRESS3 Int)
(define-fun dynamic_invariant1 ((temp___expr_274 (_ BitVec 8)) (temp___is_init_271 Bool) (temp___skip_constant_272 Bool) (temp___do_toplevel_273 Bool)) Bool (=> (or (= temp___is_init_271 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 1))) (in_range1 temp___expr_274)))
(define-fun dynamic_invariant2 ((temp___expr_280 (_ BitVec 8)) (temp___is_init_277 Bool) (temp___skip_constant_278 Bool) (temp___do_toplevel_279 Bool)) Bool (=> (or (= temp___is_init_277 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 3))) (in_range2 temp___expr_280)))
(define-fun dynamic_invariant3 ((temp___expr_298 (_ BitVec 8)) (temp___is_init_295 Bool) (temp___skip_constant_296 Bool) (temp___do_toplevel_297 Bool)) Bool (=> (or (= temp___is_init_295 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 31))) (in_range5 temp___expr_298)))
(define-fun dynamic_invariant4 ((temp___expr_310 (_ BitVec 8)) (temp___is_init_307 Bool) (temp___skip_constant_308 Bool) (temp___do_toplevel_309 Bool)) Bool (=> (or (= temp___is_init_307 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 127))) (in_range3 temp___expr_310)))
(define-fun dynamic_invariant5 ((temp___expr_352 (_ BitVec 16)) (temp___is_init_349 Bool) (temp___skip_constant_350 Bool) (temp___do_toplevel_351 Bool)) Bool (=> (or (= temp___is_init_349 true) (bvule ((_ int2bv 16) 0) ((_ int2bv 16) 16383))) (in_range4 temp___expr_352)))
...
(define-fun sys_ctrl_reg__split_fields39 () us_split_fields (mk___split_fields sys_ctrl_reg__split_fields24 sys_ctrl_reg__split_fields25 sys_ctrl_reg__split_fields26 sys_ctrl_reg__split_fields27 sys_ctrl_reg__split_fields28 sys_ctrl_reg__split_fields29 sys_ctrl_reg__split_fields30 sys_ctrl_reg__split_fields31 sys_ctrl_reg__split_fields32 sys_ctrl_reg__split_fields33 sys_ctrl_reg__split_fields34 sys_ctrl_reg__split_fields35))
...
(assert (=> (= delayed true) (= temp___33171 sys_ctrl_reg__split_fields25)))
(assert (=> (= delayed true) (= temp___33172 sys_ctrl_reg__split_fields26)))
(assert (=> (= delayed true) (= temp___33173 sys_ctrl_reg__split_fields27)))
(assert (=> (= delayed true) (= temp___33174 sys_ctrl_reg__split_fields28)))
(assert (=> (= delayed true) (= temp___33175 sys_ctrl_reg__split_fields29)))
(assert (=> (= delayed true) (= temp___33176 sys_ctrl_reg__split_fields30)))
(assert (=> (= delayed true) (= temp___33177 sys_ctrl_reg__split_fields31)))
(assert (=> (= delayed true) (= temp___33178 sys_ctrl_reg__split_fields32)))
(assert (=> (= delayed true) (= temp___33179 sys_ctrl_reg__split_fields33)))
(assert (=> (= delayed true) (= temp___331710 sys_ctrl_reg__split_fields34)))
(assert (=> (= delayed true) (= temp___331711 sys_ctrl_reg__split_fields35)))
(assert (=> (not (= delayed true)) (= sys_ctrl_reg__split_fields39 (mk___split_fields sys_ctrl_reg__split_fields12 sys_ctrl_reg__split_fields13 sys_ctrl_reg__split_fields14 sys_ctrl_reg__split_fields15 sys_ctrl_reg__split_fields16 sys_ctrl_reg__split_fields17 sys_ctrl_reg__split_fields18 sys_ctrl_reg__split_fields19 sys_ctrl_reg__split_fields20 sys_ctrl_reg__split_fields21 sys_ctrl_reg__split_fields22 sys_ctrl_reg__split_fields23))))
(assert (=> (= delayed true) (= result24 sys_status_reg__split_fields)))
(assert (=> (= delayed true) (= (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields2) dw1000__registers__sys_status__read__reg__fields)))
(assert (=> (= delayed true) (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__hpdwarn (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields2))) ((_ int2bv 8) 1)) (= (to_rep o37) ((_ int2bv 8) 0)))))
(assert (=> (= delayed true) (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__hpdwarn (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields2))) ((_ int2bv 8) 1)) (= sys_ctrl_reg__split_fields24 o38))))
(assert (=> (= delayed true) (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__hpdwarn (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields2))) ((_ int2bv 8) 1)) (= sys_ctrl_reg__split_fields25 o39))))
(assert (=> (= delayed true) (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__hpdwarn (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields2))) ((_ int2bv 8) 1)) (= sys_ctrl_reg__split_fields26 o40))))
(assert (=> (= delayed true) (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__hpdwarn (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields2))) ((_ int2bv 8) 1)) (= sys_ctrl_reg__split_fields27 o41))))
(assert (=> (= delayed true) (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__hpdwarn (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields2))) ((_ int2bv 8) 1)) (= sys_ctrl_reg__split_fields28 o42))))
(assert (=> (= delayed true) (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__hpdwarn (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields2))) ((_ int2bv 8) 1)) (= sys_ctrl_reg__split_fields29 o43))))
(assert (=> (= delayed true) (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__hpdwarn (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields2))) ((_ int2bv 8) 1)) (= sys_ctrl_reg__split_fields30 o44))))
(assert (=> (= delayed true) (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__hpdwarn (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields2))) ((_ int2bv 8) 1)) (= o37 o45))))
(assert (=> (= delayed true) (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__hpdwarn (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields2))) ((_ int2bv 8) 1)) (= sys_ctrl_reg__split_fields32 o46))))
(assert (=> (= delayed true) (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__hpdwarn (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields2))) ((_ int2bv 8) 1)) (= sys_ctrl_reg__split_fields33 o47))))
(assert (=> (= delayed true) (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__hpdwarn (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields2))) ((_ int2bv 8) 1)) (= sys_ctrl_reg__split_fields34 o48))))
(assert (=> (= delayed true) (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__hpdwarn (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields2))) ((_ int2bv 8) 1)) (= sys_ctrl_reg__split_fields35 o49))))
(assert (=> (= delayed true) (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__hpdwarn (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields2))) ((_ int2bv 8) 1)) (= temp___3320 o38))))
(assert (=> (= delayed true) (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__hpdwarn (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields2))) ((_ int2bv 8) 1)) (= temp___33201 o39))))
(assert (=> (= delayed true) (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__hpdwarn (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields2))) ((_ int2bv 8) 1)) (= temp___33202 o40))))
(assert (=> (= delayed true) (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__hpdwarn (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields2))) ((_ int2bv 8) 1)) (= temp___33203 o41))))
(assert (=> (= delayed true) (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__hpdwarn (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields2))) ((_ int2bv 8) 1)) (= temp___33204 o42))))
(assert (=> (= delayed true) (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__hpdwarn (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields2))) ((_ int2bv 8) 1)) (= temp___33205 o43))))
(assert (=> (= delayed true) (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__hpdwarn (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields2))) ((_ int2bv 8) 1)) (= temp___33206 o44))))
(assert (=> (= delayed true) (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__hpdwarn (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields2))) ((_ int2bv 8) 1)) (= temp___33207 o45))))
(assert (=> (= delayed true) (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__hpdwarn (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields2))) ((_ int2bv 8) 1)) (= temp___33208 o46))))
(assert (=> (= delayed true) (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__hpdwarn (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields2))) ((_ int2bv 8) 1)) (= temp___33209 o47))))
(assert (=> (= delayed true) (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__hpdwarn (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields2))) ((_ int2bv 8) 1)) (= temp___332010 o48))))
(assert (=> (= delayed true) (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__hpdwarn (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields2))) ((_ int2bv 8) 1)) (= temp___332011 o49))))
(assert (=> (= delayed true) (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__hpdwarn (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields2))) ((_ int2bv 8) 1)) (= result25 sys_ctrl_reg__split_fields24))))
(assert (=> (= delayed true) (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__hpdwarn (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields2))) ((_ int2bv 8) 1)) (= result26 sys_ctrl_reg__split_fields25))))
(assert (=> (= delayed true) (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__hpdwarn (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields2))) ((_ int2bv 8) 1)) (= result27 sys_ctrl_reg__split_fields26))))
(assert (=> (= delayed true) (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__hpdwarn (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields2))) ((_ int2bv 8) 1)) (= result28 sys_ctrl_reg__split_fields27))))
(assert (=> (= delayed true) (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__hpdwarn (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields2))) ((_ int2bv 8) 1)) (= result29 sys_ctrl_reg__split_fields28))))
(assert (=> (= delayed true) (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__hpdwarn (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields2))) ((_ int2bv 8) 1)) (= result30 sys_ctrl_reg__split_fields29))))
(assert (=> (= delayed true) (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__hpdwarn (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields2))) ((_ int2bv 8) 1)) (= result31 sys_ctrl_reg__split_fields30))))
(assert (=> (= delayed true) (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__hpdwarn (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields2))) ((_ int2bv 8) 1)) (= result32 sys_ctrl_reg__split_fields31))))
(assert (=> (= delayed true) (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__hpdwarn (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields2))) ((_ int2bv 8) 1)) (= result33 sys_ctrl_reg__split_fields32))))
(assert (=> (= delayed true) (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__hpdwarn (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields2))) ((_ int2bv 8) 1)) (= result34 sys_ctrl_reg__split_fields33))))
(assert (=> (= delayed true) (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__hpdwarn (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields2))) ((_ int2bv 8) 1)) (= result35 sys_ctrl_reg__split_fields34))))
(assert (=> (= delayed true) (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__hpdwarn (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields2))) ((_ int2bv 8) 1)) (= result36 sys_ctrl_reg__split_fields35))))
(assert (=> (= delayed true) (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__hpdwarn (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields2))) ((_ int2bv 8) 1)) (= sys_ctrl_reg__split_fields36 (mk___split_fields temp___3320 temp___33201 temp___33202 temp___33203 temp___33204 temp___33205 temp___33206 temp___33207 temp___33208 temp___33209 temp___332010 temp___332011)))))
(assert (=> (= delayed true) (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__hpdwarn (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields2))) ((_ int2bv 8) 1)) (= result37 result__6))))
(assert (=> (= delayed true) (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__hpdwarn (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields2))) ((_ int2bv 8) 1)) (= result__1 1))))
(assert (=> (= delayed true) (=> (not (= (to_rep (rec__dw1000__register_types__sys_status_type__hpdwarn (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields2))) ((_ int2bv 8) 1))) (= result38 result__6))))
(assert (=> (= delayed true) (=> (not (= (to_rep (rec__dw1000__register_types__sys_status_type__hpdwarn (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields2))) ((_ int2bv 8) 1))) (= result__2 0))))
(assert (=> (= delayed true) (=> (not (= (to_rep (rec__dw1000__register_types__sys_status_type__hpdwarn (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields2))) ((_ int2bv 8) 1))) (= device_state2 device_state1))))
(assert (=> (= delayed true) (=> (not (= (to_rep (rec__dw1000__register_types__sys_status_type__hpdwarn (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields2))) ((_ int2bv 8) 1))) (= sys_ctrl_reg__split_fields36 sys_ctrl_reg__split_fields39))))
(assert (=> (= delayed true) (=> (not (= (to_rep (rec__dw1000__register_types__sys_status_type__hpdwarn (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields2))) ((_ int2bv 8) 1))) (= result__1 result__2))))
...
(assert (=> (not (= delayed true)) (= (let ((subject sys_status_reg__split_fields)) (mk___split_fields__ref1 sys_status_reg__split_fields2)) sys_status_reg__split_fields)))
(assert (=> (not (= delayed true)) (= sys_ctrl_reg__split_fields36 sys_ctrl_reg__split_fields39)))
(assert (=> (not (= delayed true)) (= result__1 result__3)))
(assert (=> (not (= delayed true)) (= device_state2 device_state)))
(assert (=> (not (= delayed true)) (= sys_status_reg__split_fields2 sys_status_reg__split_fields1)))
(assert (=> (not (= delayed true)) (= sys_ctrl_reg__split_fields36 sys_ctrl_reg__split_fields39)))
(assert (=> (not (= delayed true)) (= result__1 result__3)))
(assert (= device_state3 (mk___private__ref device_state2)))
(assert (= sys_status_reg__split_fields3 (let ((subject sys_status_reg__split_fields)) (mk___split_fields__ref1 sys_status_reg__split_fields2))))
(assert (= sys_ctrl_reg__split_fields37 (mk___split_fields__ref sys_ctrl_reg__split_fields36)))
...
(assert (not (= (int__content result__4) 0)))
(check-sat)
(exit)
