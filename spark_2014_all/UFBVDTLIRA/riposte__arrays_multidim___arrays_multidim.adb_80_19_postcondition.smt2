...
(define-fun dynamic_invariant ((temp___expr_165 (_ BitVec 8)) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool) (temp___do_typ_inv_164 Bool)) Bool true)
(declare-sort map1 0)
...
(assert (not (= arrays_multidim__tuple_test__result4 true)))
(check-sat)
(exit)
