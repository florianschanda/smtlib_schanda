...
(assert (forall ((ng_v2__prevtime (_ BitVec 16)) (ng_v2__currtime (_ BitVec 16)) (ng_v2__thistime (_ BitVec 16))) (! (=> (and (and (dynamic_invariant ng_v2__prevtime true true true) (dynamic_invariant ng_v2__currtime true true true)) (dynamic_invariant ng_v2__thistime true true true)) (dynamic_invariant (timesincelastclickbeforelastupdate ng_v2__prevtime ng_v2__currtime ng_v2__thistime) true false true)) :pattern ((timesincelastclickbeforelastupdate ng_v2__prevtime ng_v2__currtime ng_v2__thistime)))))
(assert (forall ((ng_v2__prevtime (_ BitVec 16)) (ng_v2__currtime (_ BitVec 16)) (ng_v2__thistime (_ BitVec 16))) (! (=> (and (and (dynamic_invariant ng_v2__prevtime true true true) (dynamic_invariant ng_v2__currtime true true true)) (dynamic_invariant ng_v2__thistime true true true)) (= (timesincelastclickbeforelastupdate ng_v2__prevtime ng_v2__currtime ng_v2__thistime) (bvadd (timefromlastclicktolastupdate ng_v2__prevtime ng_v2__thistime) (timesincelastupdate ng_v2__currtime ng_v2__thistime)))) :pattern ((timesincelastclickbeforelastupdate ng_v2__prevtime ng_v2__currtime ng_v2__thistime)))))
...
(assert (= (mk_t__ref result1) (mk_t__ref t1)))
(assert (= t12 o))
(assert (and (= o1 (timesincelastupdate currtime thistime)) (= o1 (bvsub currtime thistime))))
(assert (= (mk_t__ref result2) (mk_t__ref t2)))
(assert (= t22 o1))
(assert (and (= o2 (distancefromlastclicktolastupdate prevcount thiscount)) (= o2 (bvmul ((_ int2bv 16) 207) (bvsub thiscount prevcount)))))
(assert (= (mk_t__ref result3) (mk_t__ref d1)))
(assert (= d12 o2))
(assert (and (= o3 (distancesincelastupdate prevtime prevcount currtime thistime thiscount)) (= o3 (bvudiv (bvmul (distancefromlastclicktolastupdate prevcount thiscount) (timesincelastupdate currtime thistime)) (timefromlastclicktolastupdate prevtime thistime)))))
(assert (= (mk_t__ref result4) (mk_t__ref d2)))
(assert (= d22 o3))
(assert (= estimatedgroundvelocityisavailable2 result5))
(assert (= estimatedgroundvelocityisavailable3 (of_int 1)))
(assert (not (not (= (bvadd t12 t22) #x0000))))
(check-sat)
(exit)
