...
(declare-fun writereglow8post ((_ BitVec 64) (_ BitVec 64) (_ BitVec 8)) Bool)
(declare-fun writereglow8post__function_guard (Bool (_ BitVec 64) (_ BitVec 64) (_ BitVec 8)) Bool)
(declare-fun readreglow8 ((_ BitVec 64)) (_ BitVec 8))
(declare-fun readreglow8__function_guard ((_ BitVec 8) (_ BitVec 64)) Bool)
(assert (forall ((regold (_ BitVec 64)) (regnew (_ BitVec 64))) (forall ((val__ (_ BitVec 8))) (! (=> (and (and (dynamic_invariant regold true true true) (dynamic_invariant regnew true true true)) (dynamic_invariant1 val__ true true true)) (= (= (writereglow8post regold regnew val__) true) (and (= (readreglow8 regnew) val__) (= (bvand regnew ((_ int2bv 64) 18446744073709551360)) (bvand regold ((_ int2bv 64) 18446744073709551360)))))) :pattern ((writereglow8post regold regnew val__))))))
(assert (forall ((regold (_ BitVec 64)) (regnew (_ BitVec 64))) (forall ((val__ (_ BitVec 8))) (! (= (= (writereglow8post regold regnew val__) true) (and (= (readreglow8 regnew) val__) (= (bvand regnew ((_ int2bv 64) 18446744073709551360)) (bvand regold ((_ int2bv 64) 18446744073709551360))))) :pattern ((writereglow8post regold regnew val__))))))
...
(assert (= result r15))
(assert (= r151 (bvor (bvand r15 ((_ int2bv 64) 18446744073709551360)) ((_ zero_extend 56) val__))))
(assert (= r151 r152))
(assert (= r153 r151))
(assert (not (= (writereglow8post r15 r152 val__) true)))
(check-sat)
(exit)
