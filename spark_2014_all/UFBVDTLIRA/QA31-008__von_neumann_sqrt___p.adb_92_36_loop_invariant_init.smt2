...
(assert (= left_ux1 o12))
(assert (not (= m1 (let ((temp___272 (bv2nat (bvsub #x0000000000000020 (bvmul #x0000000000000002 i2))))) (ite (< temp___272 18446744073709551616) (bvshl #x0000000000000001 ((_ int2bv 64) temp___272)) #x0000000000000000)))))
(check-sat)
(exit)
