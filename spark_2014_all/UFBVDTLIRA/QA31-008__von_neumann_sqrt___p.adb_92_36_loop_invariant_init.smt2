...
(assert (= left_ux2 o12))
(assert true)
(assert (not (= m1 (let ((temp___235 (bv2nat (bvsub ((_ int2bv 64) 32) (bvmul ((_ int2bv 64) 2) i2))))) (ite (< temp___235 18446744073709551616) (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) temp___235)) ((_ int2bv 64) 0))))))
(check-sat)
(exit)
