...
(assert (and (= o3 (timefromlastclicktolastupdate prevtime thistime)) (= o3 (bvsub thistime prevtime))))
(assert (and (= o (timesincelastupdate currtime thistime)) (= o (bvsub currtime thistime))))
(assert (and (= o1 (distancefromlastclicktolastupdate prevcount thiscount)) (= o1 (bvmul #x00CF (bvsub thiscount prevcount)))))
(assert (= o2 (bvmul o1 o)))
(assert (not (not (= o3 #x0000))))
(check-sat)
(exit)
