...
(define-fun dynamic_invariant1 ((temp___expr_354 Int) (temp___is_init_351 Bool) (temp___skip_constant_352 Bool) (temp___do_toplevel_353 Bool)) Bool (=> (or (= temp___is_init_351 true) (<= 1 100)) (in_range3 temp___expr_354)))
...
(assert (forall ((container us_rep1)) (forall ((item Int)) (! (=> (dynamic_invariant1 item true true true) (=> (= (of_int 1) true) (=> (exists ((e Int)) (and (and (in_range3 e) (= (contains container e) true)) (= (my_eq e item) true))) (= (contains container item) true)))) :pattern ((contains container item))))))
...
(define-fun dynamic_invariant2 ((temp___expr_649 Int) (temp___is_init_646 Bool) (temp___skip_constant_647 Bool) (temp___do_toplevel_648 Bool)) Bool (=> (or (= temp___is_init_646 true) (<= 1 100)) (in_range4 temp___expr_649)))
(assert (forall ((i Int)) (! (=> (dynamic_invariant i true true true) (dynamic_invariant2 (key i) true false true)) :pattern ((key i)))))
...
(define-fun dynamic_invariant3 ((temp___expr_655 Int) (temp___is_init_652 Bool) (temp___skip_constant_653 Bool) (temp___do_toplevel_654 Bool)) Bool (=> (or (= temp___is_init_652 true) (<= 1 100)) (in_range5 temp___expr_655)))
...
(define-fun dynamic_invariant5 ((temp___expr_173 Int) (temp___is_init_170 Bool) (temp___skip_constant_171 Bool) (temp___do_toplevel_172 Bool)) Bool (=> (or (= temp___is_init_170 true) (<= 0 2147483647)) (in_range2 temp___expr_173)))
(assert (forall ((container1 us_rep)) (! (let ((result (length container1))) (and (<= result (to_rep1 (rec__p__my_sets__set__capacity (us_split_discrs1 container1)))) (dynamic_invariant5 result true false true))) :pattern ((length container1)))))
(assert (forall ((attr__tag Int)) (forall ((container1 us_rep)) (! (dynamic_invariant5 (length1 attr__tag container1) true false true) :pattern ((length1 attr__tag container1))))))
...
(define-fun dynamic_invariant6 ((temp___expr_325 Int) (temp___is_init_322 Bool) (temp___skip_constant_323 Bool) (temp___do_toplevel_324 Bool)) Bool (=> (or (= temp___is_init_322 true) (<= 1 100)) (in_range6 temp___expr_325)))
...
(define-fun last ((container1 us_rep2)) Int (+ 0 (length3 container1)))
...
(define-fun default_initial_assumption1 ((temp___expr_392 us_rep2) (temp___skip_top_level_393 Bool)) Bool (=> (not (= temp___skip_top_level_393 true)) (= (length3 temp___expr_392) 0)))
(declare-fun find (us_rep2 Int) Int)
(declare-fun find__function_guard (Int us_rep2 Int) Bool)
(assert (forall ((container1 us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant6 item true true true) (let ((result (find container1 item))) (and (=> (< 0 result) (and (<= result (length3 container1)) (= (my_eq item (get container1 result)) true))) (dynamic_invariant5 result true false true)))) :pattern ((find container1 item))))))
(define-fun e_elements_included ((left us_rep2) (right us_rep2)) Bool (ite (forall ((i Int)) (=> (and (<= 1 i) (<= i (length3 left))) (and (< 0 (find right (get left i))) (= (get right (find right (get left i))) (get left i))))) true false))
...
(assert (forall ((container1 us_rep)) (! (let ((result (elements container1))) (and (and (and (and (= (length3 result) (length container1)) (forall ((temp___429 Int)) (=> (and (in_range7 temp___429) (= (iter_has_element result temp___429) true)) (= (contains (model__ container1) (get result temp___429)) true)))) (forall ((item Int)) (=> (and (in_range3 item) (= (contains (model__ container1) item) true)) (and (< 0 (find result item)) (= (my_eq (get result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (= (find result (get result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length container1))) (=> (= (my_eq (get result i) (get result j)) true) (= i j)))))))) :pattern ((elements container1)))))
...
(assert true)
(assert (forall ((container1 us_rep1)) (! (dynamic_invariant5 (length2 container1) true false true) :pattern ((length2 container1)))))
(assert (forall ((container1 us_rep1)) (! (let ((result (is_empty container1))) (and (= (= result true) (forall ((item Int)) (not (and (in_range3 item) (= (contains container1 item) true))))) (= (= result true) (= (length2 container1) 0)))) :pattern ((is_empty container1)))))
...
(assert (forall ((container1 us_rep2)) (! (let ((result (length3 container1))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant5 result true false true))) :pattern ((length3 container1)))))
...
(assert (forall ((container1 us_rep2)) (forall ((position Int)) (! (=> (and (dynamic_invariant7 position true true true) (and (<= 1 position) (<= position (last container1)))) (dynamic_invariant8 (get container1 position) true false true)) :pattern ((get container1 position))))))
(declare-const temp___830 us_rep1)
(declare-const e Int)
(declare-const o Bool)
(assert (in_range5 key1))
(assert (and (= temp___830 (model__ container)) (= (length2 temp___830) (length container))))
(assert (not true))
(check-sat)
(exit)
