...
(define-fun dynamic_invariant1 ((temp___expr_386 Int) (temp___is_init_382 Bool) (temp___skip_constant_383 Bool) (temp___do_toplevel_384 Bool) (temp___do_typ_inv_385 Bool)) Bool (=> (or (= temp___is_init_382 true) (<= 1 100)) (in_range3 temp___expr_386)))
...
(assert (forall ((container us_rep1)) (forall ((item Int)) (! (=> (dynamic_invariant1 item true true true true) (=> (= (distinct 1 0) true) (=> (exists ((e Int)) (and (and (in_range3 e) (= (contains container e) true)) (= (my_eq e item) true))) (= (contains container item) true)))) :pattern ((contains container item))))))
...
(define-fun dynamic_invariant2 ((temp___expr_692 Int) (temp___is_init_688 Bool) (temp___skip_constant_689 Bool) (temp___do_toplevel_690 Bool) (temp___do_typ_inv_691 Bool)) Bool (=> (or (= temp___is_init_688 true) (<= 1 100)) (in_range4 temp___expr_692)))
(assert (forall ((i Int)) (! (=> (dynamic_invariant i true true true true) (dynamic_invariant2 (key i) true false true true)) :pattern ((key i)))))
...
(define-fun dynamic_invariant3 ((temp___expr_699 Int) (temp___is_init_695 Bool) (temp___skip_constant_696 Bool) (temp___do_toplevel_697 Bool) (temp___do_typ_inv_698 Bool)) Bool (=> (or (= temp___is_init_695 true) (<= 1 100)) (in_range5 temp___expr_699)))
...
(define-fun dynamic_invariant5 ((temp___expr_197 Int) (temp___is_init_193 Bool) (temp___skip_constant_194 Bool) (temp___do_toplevel_195 Bool) (temp___do_typ_inv_196 Bool)) Bool (=> (or (= temp___is_init_193 true) (<= 0 2147483647)) (in_range2 temp___expr_197)))
(assert (forall ((container1 us_rep)) (! (let ((result (length container1))) (and (<= result (to_rep1 (rec__p__my_sets__set__capacity (us_split_discrs1 container1)))) (dynamic_invariant5 result true false true true))) :pattern ((length container1)))))
(assert (forall ((attr__tag Int)) (forall ((container1 us_rep)) (! (dynamic_invariant5 (length1 attr__tag container1) true false true true) :pattern ((length1 attr__tag container1))))))
...
(define-fun dynamic_invariant6 ((temp___expr_353 Int) (temp___is_init_349 Bool) (temp___skip_constant_350 Bool) (temp___do_toplevel_351 Bool) (temp___do_typ_inv_352 Bool)) Bool (=> (or (= temp___is_init_349 true) (<= 1 100)) (in_range6 temp___expr_353)))
...
(assert (forall ((container1 us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant6 item true true true true) (let ((result (find container1 item))) (and (=> (< 0 result) (and (<= result (length3 container1)) (= (my_eq item (get container1 result)) true))) (dynamic_invariant5 result true false true true)))) :pattern ((find container1 item))))))
...
(assert (forall ((container1 us_rep)) (! (let ((result (elements container1))) (and (and (and (and (= (length3 result) (length container1)) (forall ((temp___471 Int)) (=> (and (in_range7 temp___471) (= (iter_has_element result temp___471) true)) (= (contains (model__ container1) (get result temp___471)) true)))) (forall ((item Int)) (=> (and (in_range3 item) (= (contains (model__ container1) item) true)) (and (< 0 (find result item)) (= (my_eq (get result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (= (find result (get result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length container1))) (=> (= (my_eq (get result i) (get result j)) true) (= i j)))))))) :pattern ((elements container1)))))
...
(assert true)
(assert (forall ((container1 us_rep1)) (! (dynamic_invariant5 (length2 container1) true false true true) :pattern ((length2 container1)))))
...
(assert (forall ((container1 us_rep2)) (! (let ((result (length3 container1))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant5 result true false true true))) :pattern ((length3 container1)))))
...
(assert (forall ((container1 us_rep2)) (forall ((position Int)) (! (=> (and (dynamic_invariant7 position true true true true) (and (<= 1 position) (<= position (last container1)))) (dynamic_invariant8 (get container1 position) true false true true)) :pattern ((get container1 position))))))
(assert (not true))
(check-sat)
(exit)
