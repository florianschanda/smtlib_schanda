...
(assert (forall ((len Int)) (! (=> (dynamic_invariant2 len true true true) (dynamic_invariant1 (maxvalue len) true false true)) :pattern ((maxvalue len)))))
(assert (forall ((len Int)) (! (=> (dynamic_invariant2 len true true true) (= (maxvalue len) (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) len)))) :pattern ((maxvalue len)))))
...
(declare-const bitwalker__lemmafunction__result Int)
(declare-const i Int)
(declare-const o Int)
...
(declare-const bitwalker__lemmafunction__result1 Int)
(declare-const bitwalker__lemmafunction__result2 Int)
(declare-const bitwalker__lemmafunction__result3 Int)
(declare-const bitwalker__lemmafunction__result4 Int)
(declare-const bitwalker__lemmafunction__result5 Int)
(assert true)
(assert (in_range1 len))
(assert (and (and (<= 0 len) (<= len 63)) (forall ((i1 Int)) (=> (and (<= len i1) (<= i1 63)) (not (= (nth x i1) true))))))
(assert (and (and (and (and (and (= o2 len) (uint_in_range len)) (= bitwalker__lemmafunction__len_bv__assume ((_ int2bv 64) o2))) (= bitwalker__lemmafunction__len_bv__assume len_bv)) (and (= (bvand x (bvsub (maxvalue len) ((_ int2bv 64) 1))) x) (and (and (bvule ((_ int2bv 64) 0) ((_ int2bv 64) len)) (bvule ((_ int2bv 64) len) ((_ int2bv 64) 63))) (and (and (= bitwalker__lemmafunction__result1 bitwalker__lemmafunction__result2) (= bitwalker__lemmafunction__result3 bitwalker__lemmafunction__result1)) (and (= (mk_int__ref result) (mk_int__ref bitwalker__lemmafunction__result)) (= bitwalker__lemmafunction__result1 0)))))) (and (= (mk_int__ref bitwalker__lemmafunction__result4) (mk_int__ref bitwalker__lemmafunction__result2)) (= bitwalker__lemmafunction__result5 bitwalker__lemmafunction__result3))))
(assert (= bitwalker__lemmafunction__result4 0))
