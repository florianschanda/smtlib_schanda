...
(assert (forall ((len Int)) (! (=> (dynamic_invariant2 len true true true true) (dynamic_invariant1 (maxvalue len) true false true true)) :pattern ((maxvalue len)))))
(assert (forall ((len Int)) (! (=> (dynamic_invariant2 len true true true true) (= (maxvalue len) (bvshl #x0000000000000001 ((_ int2bv 64) len)))) :pattern ((maxvalue len)))))
...
(assert (= (bvand x (bvsub (maxvalue len) #x0000000000000001)) x))
(assert (and (bvule #x0000000000000000 ((_ int2bv 64) len)) (bvule ((_ int2bv 64) len) #x000000000000003F)))
(assert (= bitwalker__lemmafunction__result1 bitwalker__lemmafunction__result2))
(assert (= bitwalker__lemmafunction__result3 bitwalker__lemmafunction__result1))
(assert (= (mk_int__ref result) (mk_int__ref bitwalker__lemmafunction__result)))
(assert (= bitwalker__lemmafunction__result1 0))
(assert (= (mk_int__ref bitwalker__lemmafunction__result4) (mk_int__ref bitwalker__lemmafunction__result2)))
(assert (= bitwalker__lemmafunction__result5 bitwalker__lemmafunction__result3))
