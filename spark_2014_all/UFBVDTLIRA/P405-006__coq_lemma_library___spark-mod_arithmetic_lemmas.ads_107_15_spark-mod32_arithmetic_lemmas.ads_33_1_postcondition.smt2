...
(define-fun dynamic_invariant ((temp___expr_201 (_ BitVec 32)) (temp___is_init_198 Bool) (temp___skip_constant_199 Bool) (temp___do_toplevel_200 Bool)) Bool true)
(declare-sort pos 0)
(declare-const attr__ATTRIBUTE_MODULUS1 (_ BitVec 32))
(define-fun in_range ((x (_ BitVec 32))) Bool (and (bvule ((_ int2bv 32) 1) x) (bvule x ((_ int2bv 32) 4294967295))))
...
(define-fun dynamic_invariant1 ((temp___expr_207 (_ BitVec 32)) (temp___is_init_204 Bool) (temp___skip_constant_205 Bool) (temp___do_toplevel_206 Bool)) Bool (=> (or (= temp___is_init_204 true) (bvule ((_ int2bv 32) 1) ((_ int2bv 32) 4294967295))) (in_range temp___expr_207)))
...
(assert (bvule arg1 (bvudiv ((_ int2bv 32) 4294967295) arg2)))
