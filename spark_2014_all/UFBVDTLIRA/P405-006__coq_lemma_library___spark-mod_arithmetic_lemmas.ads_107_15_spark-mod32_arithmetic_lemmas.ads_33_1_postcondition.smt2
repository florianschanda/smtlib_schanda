...
(define-fun dynamic_invariant ((temp___expr_235 (_ BitVec 32)) (temp___is_init_231 Bool) (temp___skip_constant_232 Bool) (temp___do_toplevel_233 Bool) (temp___do_typ_inv_234 Bool)) Bool true)
(declare-sort pos 0)
(declare-const attr__ATTRIBUTE_MODULUS1 (_ BitVec 32))
(define-fun in_range ((x (_ BitVec 32))) Bool (and (bvule #x00000001 x) (bvule x #xFFFFFFFF)))
...
(define-fun dynamic_invariant1 ((temp___expr_242 (_ BitVec 32)) (temp___is_init_238 Bool) (temp___skip_constant_239 Bool) (temp___do_toplevel_240 Bool) (temp___do_typ_inv_241 Bool)) Bool (=> (or (= temp___is_init_238 true) (bvule #x00000001 #xFFFFFFFF)) (in_range temp___expr_242)))
(declare-const arg1 (_ BitVec 32))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const arg2 (_ BitVec 32))
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(assert (in_range arg2))
(assert (bvule arg1 (bvudiv #xFFFFFFFF arg2)))
(assert (not (= (bvudiv (bvmul arg1 arg2) arg2) arg1)))
(check-sat)
(exit)
