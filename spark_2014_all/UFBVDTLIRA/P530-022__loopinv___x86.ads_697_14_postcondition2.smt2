...
(declare-const x86__signextend16to32__result (_ BitVec 32))
(declare-const result (_ BitVec 32))
(declare-const retval1 (_ BitVec 32))
(declare-const result1 (_ BitVec 32))
(declare-const retval2 (_ BitVec 32))
(declare-const result2 (_ BitVec 32))
(declare-const x86__signextend16to32__result1 (_ BitVec 32))
(declare-const x86__signextend16to32__result2 (_ BitVec 32))
(declare-const x86__signextend16to32__result3 (_ BitVec 32))
(declare-const retval3 (_ BitVec 32))
(declare-const x86__signextend16to32__result4 (_ BitVec 32))
(declare-const retval4 (_ BitVec 32))
(declare-const x86__signextend16to32__result5 (_ BitVec 32))
(define-fun retval5 () t__ref1 (mk_t__ref1 retval))
(declare-const result3 (_ BitVec 32))
(assert (=> (bvugt val__ #x7FFF) (= (mk_t__ref1 result) retval5)))
(assert (=> (bvugt val__ #x7FFF) (= retval1 (bvor #xFFFF0000 ((_ zero_extend 16) val__)))))
(assert (=> (not (bvugt val__ #x7FFF)) (= (mk_t__ref1 result1) retval5)))
(assert (=> (not (bvugt val__ #x7FFF)) (= retval2 ((_ zero_extend 16) val__))))
(assert (=> (not (bvugt val__ #x7FFF)) (= retval1 retval2)))
(assert (= x86__signextend16to32__result1 x86__signextend16to32__result2))
(assert (= x86__signextend16to32__result3 x86__signextend16to32__result1))
(assert (= (mk_t__ref1 result2) (mk_t__ref1 x86__signextend16to32__result)))
(assert (= x86__signextend16to32__result1 retval1))
(assert (= (mk_t__ref1 x86__signextend16to32__result4) (mk_t__ref1 x86__signextend16to32__result2)))
(assert (= retval1 retval3))
(assert (= x86__signextend16to32__result5 x86__signextend16to32__result3))
(assert (= retval4 retval1))
(assert (= result3 x86__signextend16to32__result4))
(assert (bvugt val__ #x7FFF))
(assert (not (= x86__signextend16to32__result4 (bvor #xFFFF0000 ((_ zero_extend 16) val__)))))
(check-sat)
(exit)
