...
(assert (forall ((regold (_ BitVec 64)) (regnew (_ BitVec 64))) (forall ((val__1 (_ BitVec 16))) (! (=> (and (and (dynamic_invariant regold true true true true) (dynamic_invariant regnew true true true true)) (dynamic_invariant1 val__1 true true true true)) (= (= (writereg16post regold regnew val__1) true) (and (= (readreg16 regnew) val__1) (= (bvand regnew #xFFFFFFFFFFFF0000) (bvand regold #xFFFFFFFFFFFF0000))))) :pattern ((writereg16post regold regnew val__1))))))
(assert (forall ((regold (_ BitVec 64)) (regnew (_ BitVec 64))) (forall ((val__1 (_ BitVec 16))) (! (= (= (writereg16post regold regnew val__1) true) (and (= (readreg16 regnew) val__1) (= (bvand regnew #xFFFFFFFFFFFF0000) (bvand regold #xFFFFFFFFFFFF0000)))) :pattern ((writereg16post regold regnew val__1))))))
...
(assert (= result reg))
(assert (= reg1 (bvor (bvand reg #xFFFFFFFFFFFF0000) ((_ zero_extend 48) val__))))
(assert (= reg1 reg2))
(assert (= reg3 reg1))
