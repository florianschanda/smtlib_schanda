...
(declare-const x86__ebp__result (_ BitVec 32))
(declare-const result (_ BitVec 32))
(declare-const x86__ebp__result1 (_ BitVec 32))
(declare-const x86__ebp__result2 (_ BitVec 32))
(declare-const x86__ebp__result3 (_ BitVec 32))
(declare-const x86__ebp__result4 (_ BitVec 32))
(declare-const x86__ebp__result5 (_ BitVec 32))
(assert (= x86__ebp__result1 x86__ebp__result2))
(assert (= x86__ebp__result3 x86__ebp__result1))
(assert (= (mk_t__ref result) (mk_t__ref x86__ebp__result)))
(assert (= x86__ebp__result1 ((_ extract 31 0) (bvand rbp ((_ int2bv 64) 4294967295)))))
(assert (= (mk_t__ref x86__ebp__result4) (mk_t__ref x86__ebp__result2)))
(assert (= x86__ebp__result5 x86__ebp__result3))
(assert (not (bvule ((_ zero_extend 32) ((_ int2bv 32) 0)) (bvand rbp ((_ int2bv 64) 4294967295)))))
(check-sat)
(exit)
