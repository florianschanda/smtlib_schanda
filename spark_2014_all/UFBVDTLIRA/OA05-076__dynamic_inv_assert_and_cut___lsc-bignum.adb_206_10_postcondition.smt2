...
(define-fun dynamic_invariant ((temp___expr_217 (_ BitVec 32)) (temp___is_init_214 Bool) (temp___skip_constant_215 Bool) (temp___do_toplevel_216 Bool)) Bool true)
...
(assert (= temp1 (bvadd (bvadd (bvadd ((_ zero_extend 32) a) ((_ zero_extend 32) carry1)) (bvand mult11 ((_ int2bv 64) 4294967295))) (bvand mult21 ((_ int2bv 64) 4294967295)))))
...
(assert (= carry11 ((_ extract 31 0) (bvand temp2 ((_ int2bv 64) 4294967295)))))
...
(assert (= a3 a1))
(assert (not (= (oeq (oadd (oadd (oadd (oadd (from_word32 a) (omultiply (from_word32 v) (from_word32 w))) (omultiply (from_word32 x) (from_word32 y))) (from_word32 carry1)) (omultiply (base Tuple0) (from_word32 carry2))) (oadd (from_word32 a2) (omultiply (base Tuple0) (oadd (from_word32 carry12) (omultiply (base Tuple0) (from_word32 carry22)))))) true)))
(check-sat)
(exit)
