...
(assert (not (= bits2 ((_ int2bv 16) 0))))
(assert (not (= bits_g2 ((_ int2bv 16) 0))))
(assert (not (= m2 ((_ int2bv 16) 0))))
(assert (= i2 result8))
(assert (= i3 (bvadd i2 ((_ int2bv 16) 1))))
(assert (= m2 result9))
(assert (= m3 (bvsub m2 ((_ int2bv 16) 1))))
(assert (= res2 (bvmul res_g2 (pow21 (bvadd m3 ((_ int2bv 16) 1))))))
(assert (= bits_g2 (pow21 m3)))
(assert (= b2 result10))
(assert (= b3 (bvor res2 bits2)))
(assert (= b3 (bvadd res2 bits2)))
(assert (= b3 (bvmul (bvadd (bvmul ((_ int2bv 16) 2) res_g2) bits_g2) (pow21 m3))))
(assert (=> (< 1 16) (= o (bvlshr res2 ((_ int2bv 16) 1)))))
(assert (=> (not (< 1 16)) (= o ((_ int2bv 16) 0))))
(assert (= result11 (mk_t__ref res2)))
(assert (= res3 o))
(assert (=> (bvuge num2 b3) (= result12 (mk_t__ref num2))))
(assert (=> (bvuge num2 b3) (= num3 (bvsub num2 b3))))
(assert (=> (bvuge num2 b3) (= result13 (mk_t__ref res3))))
(assert (=> (bvuge num2 b3) (= res4 (bvor res3 bits2))))
(assert (=> (bvuge num2 b3) (= result14 (mk_t__ref res_g2))))
(assert (=> (bvuge num2 b3) (= res_g3 (bvadd res_g2 bits_g2))))
(assert (=> (not (bvuge num2 b3)) (= res_g3 res_g2)))
(assert (=> (not (bvuge num2 b3)) (= res4 res3)))
(assert (=> (not (bvuge num2 b3)) (= num3 num2)))
(assert (= result15 (mk_t__ref bits2)))
(assert (= bits3 (bvudiv bits2 ((_ int2bv 16) 4))))
(assert (=> (< 1 16) (= o1 (bvlshr bits_g2 ((_ int2bv 16) 1)))))
(assert (=> (not (< 1 16)) (= o1 ((_ int2bv 16) 0))))
(assert (= result16 (mk_t__ref bits_g2)))
(assert (= bits_g3 o1))
(assert (not (= bits3 ((_ int2bv 16) 0))))
(assert (not (= bits3 ((_ int2bv 16) 0))))
(assert (not (bvult bits3 temp___2362)))
(check-sat)
(exit)
