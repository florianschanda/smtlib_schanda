...
(assert (= b1 (bvadd res2 bits2)))
(assert (= b1 (bvmul (bvadd (bvmul #x0002 res_g2) bits_g2) (pow21 m3))))
(assert (=> (< 1 16) (= o (bvlshr res2 ((_ int2bv 16) 1)))))
(assert (=> (not (< 1 16)) (= o #x0000)))
(assert (= result11 (mk_t__ref res2)))
(assert (= res3 o))
(assert (=> (bvuge num2 b1) (= result12 (mk_t__ref num2))))
(assert (=> (bvuge num2 b1) (= num3 (bvsub num2 b1))))
(assert (=> (bvuge num2 b1) (= result13 (mk_t__ref res3))))
(assert (=> (bvuge num2 b1) (= res4 (bvor res3 bits2))))
(assert (=> (bvuge num2 b1) (= result14 (mk_t__ref res_g2))))
(assert (=> (bvuge num2 b1) (= res_g3 (bvadd res_g2 bits_g2))))
(assert (=> (not (bvuge num2 b1)) (= res_g3 res_g2)))
(assert (=> (not (bvuge num2 b1)) (= res4 res3)))
(assert (=> (not (bvuge num2 b1)) (= num3 num2)))
(assert (= result15 (mk_t__ref bits2)))
(assert (= bits3 (bvudiv bits2 #x0004)))
(assert (=> (< 1 16) (= o1 (bvlshr bits_g2 ((_ int2bv 16) 1)))))
(assert (=> (not (< 1 16)) (= o1 #x0000)))
(assert (= result16 (mk_t__ref bits_g2)))
(assert (= bits_g3 o1))
(assert (not (= bits3 #x0000)))
(assert (not (= bits3 #x0000)))
(assert (not (bvult bits3 temp___2741)))
(check-sat)
(exit)
