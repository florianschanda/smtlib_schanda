...
(define-fun default_initial_assumption3 ((temp___expr_1776 us_rep3) (temp___skip_top_level_1777 Bool)) Bool (and (= (to_rep (rec__dic_of_cont__my_orma__map__capacity (us_split_discrs7 temp___expr_1776))) capacity) (=> (not (= temp___skip_top_level_1777 true)) (= (is_empty5 temp___expr_1776) true))))
...
(define-fun default_initial_assumption4 ((temp___expr_1786 us_rep4) (temp___skip_top_level_1787 Bool)) Bool (and (= (to_rep (rec__dic_of_cont__my_orse__set__capacity (us_split_discrs9 temp___expr_1786))) capacity) (=> (not (= temp___skip_top_level_1787 true)) (= (is_empty7 temp___expr_1786) true))))
...
(define-fun default_initial_assumption5 ((temp___expr_1796 us_rep5) (temp___skip_top_level_1797 Bool)) Bool (and (= (to_rep2 (rec__dic_of_cont__my_fove__vector__capacity (us_split_discrs11 temp___expr_1796))) capacity) (=> (not (= temp___skip_top_level_1797 true)) (= (is_empty9 temp___expr_1796) true))))
...
(assert (forall ((attr__tag Int)) (forall ((container us_rep1)) (! (dynamic_invariant1 (length2 attr__tag container) true false true true) :pattern ((length2 attr__tag container))))))
...
(define-fun default_initial_assumption6 ((temp___expr_592 us_rep6) (temp___skip_top_level_593 Bool)) Bool (=> (not (= temp___skip_top_level_593 true)) (and (= (is_empty10 temp___expr_592) true) (= (length10 temp___expr_592) 0))))
...
(assert (forall ((container us_rep6)) (! (dynamic_invariant1 (length10 container) true false true true) :pattern ((length10 container)))))
...
(assert (forall ((container us_rep2)) (! (let ((result (length3 container))) (and (<= result (to_rep (rec__dic_of_cont__my_hase__set__capacity (us_split_discrs5 container)))) (dynamic_invariant1 result true false true true))) :pattern ((length3 container)))))
(assert (forall ((attr__tag Int)) (forall ((container us_rep2)) (! (dynamic_invariant1 (length4 attr__tag container) true false true true) :pattern ((length4 attr__tag container))))))
...
(define-fun default_initial_assumption7 ((temp___expr_875 us_rep7) (temp___skip_top_level_876 Bool)) Bool (=> (not (= temp___skip_top_level_876 true)) (= (length11 temp___expr_875) 0)))
(declare-fun find (us_rep7 Int) Int)
(declare-fun find__function_guard (Int us_rep7 Int) Bool)
(assert (forall ((container us_rep7)) (forall ((item Int)) (! (=> (dynamic_invariant10 item true true true true) (let ((result (find container item))) (and (=> (< 0 result) (and (<= result (length11 container)) (= item (get1 container result)))) (dynamic_invariant1 result true false true true)))) :pattern ((find container item))))))
...
(define-fun default_initial_assumption8 ((temp___expr_839 us_rep8) (temp___skip_top_level_840 Bool)) Bool (=> (not (= temp___skip_top_level_840 true)) (= (is_empty11 temp___expr_839) true)))
...
(assert (forall ((container us_rep2)) (! (let ((result (elements container))) (and (and (and (and (= (length11 result) (length3 container)) (forall ((temp___916 Int)) (=> (and (in_range13 temp___916) (= (iter_has_element result temp___916) true)) (= (contains (model__1 container) (get1 result temp___916)) true)))) (forall ((item Int)) (=> (and (in_range12 item) (= (contains (model__1 container) item) true)) (and (< 0 (find result item)) (= (get1 result (find result item)) item))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length3 container))) (= (find result (get1 result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length3 container))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length3 container))) (=> (= (get1 result i) (get1 result j)) (= i j)))))))) :pattern ((elements container)))))
...
(assert (forall ((container us_rep8)) (! (dynamic_invariant1 (length12 container) true false true true) :pattern ((length12 container)))))
...
(assert (forall ((container us_rep7)) (! (let ((result (length11 container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant1 result true false true true))) :pattern ((length11 container)))))
...
(assert (forall ((container us_rep3)) (! (let ((result (length5 container))) (and (<= result (to_rep (rec__dic_of_cont__my_orma__map__capacity (us_split_discrs7 container)))) (dynamic_invariant1 result true false true true))) :pattern ((length5 container)))))
(assert (forall ((attr__tag Int)) (forall ((container us_rep3)) (! (dynamic_invariant1 (length6 attr__tag container) true false true true) :pattern ((length6 attr__tag container))))))
...
(define-fun default_initial_assumption9 ((temp___expr_1189 us_rep9) (temp___skip_top_level_1190 Bool)) Bool (=> (not (= temp___skip_top_level_1190 true)) (and (= (is_empty12 temp___expr_1189) true) (= (length13 temp___expr_1189) 0))))
...
(assert (forall ((container us_rep9)) (! (dynamic_invariant1 (length13 container) true false true true) :pattern ((length13 container)))))
...
(assert (forall ((container us_rep4)) (! (let ((result (length7 container))) (and (<= result (to_rep (rec__dic_of_cont__my_orse__set__capacity (us_split_discrs9 container)))) (dynamic_invariant1 result true false true true))) :pattern ((length7 container)))))
(assert (forall ((attr__tag Int)) (forall ((container us_rep4)) (! (dynamic_invariant1 (length8 attr__tag container) true false true true) :pattern ((length8 attr__tag container))))))
...
(define-fun e_is_find ((container us_rep10) (item Int) (position Int)) Bool (and (ite (< 0 position) (e_bigger_than_range container 1 (- position 1) item) (distinct 1 0)) (ite (< position (length14 container)) (e_smaller_than_range container (+ position 1) (length14 container) item) (distinct 1 0))))
...
(define-fun default_initial_assumption10 ((temp___expr_1423 us_rep10) (temp___skip_top_level_1424 Bool)) Bool (=> (not (= temp___skip_top_level_1424 true)) (= (length14 temp___expr_1423) 0)))
(declare-fun find1 (us_rep10 Int) Int)
(declare-fun find__function_guard1 (Int us_rep10 Int) Bool)
(assert (forall ((container us_rep10)) (forall ((item Int)) (! (=> (dynamic_invariant16 item true true true true) (let ((result (find1 container item))) (and (=> (< 0 result) (and (<= result (length14 container)) (= (equivalent_elements item (get3 container result)) true))) (dynamic_invariant1 result true false true true)))) :pattern ((find1 container item))))))
...
(define-fun default_initial_assumption11 ((temp___expr_1387 us_rep11) (temp___skip_top_level_1388 Bool)) Bool (=> (not (= temp___skip_top_level_1388 true)) (= (is_empty13 temp___expr_1387) true)))
...
(assert (forall ((container us_rep4)) (! (let ((result (elements1 container))) (and (and (and (= (length14 result) (length7 container)) (forall ((temp___1461 Int)) (=> (and (in_range19 temp___1461) (= (iter_has_element1 result temp___1461) true)) (= (contains1 (model__3 container) (get3 result temp___1461)) true)))) (forall ((item Int)) (=> (and (in_range18 item) (= (contains1 (model__3 container) item) true)) (and (< 0 (find1 result item)) (= (equivalent_elements (get3 result (find1 result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length7 container))) (and (= (find1 result (get3 result i)) i) (= (e_is_find result (get3 result i) i) true)))))) :pattern ((elements1 container)))))
...
(assert (forall ((container us_rep11)) (! (dynamic_invariant1 (length15 container) true false true true) :pattern ((length15 container)))))
...
(assert (forall ((container us_rep10)) (! (let ((result (length14 container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant1 result true false true true))) :pattern ((length14 container)))))
...
(assert (forall ((container us_rep5)) (! (let ((result (length9 container))) (and (<= result (capacity1 container)) (dynamic_invariant20 result true false true true))) :pattern ((length9 container)))))
...
(assert (not (= (to_rep (rec__dic_of_cont__my_hase__set__capacity dhase__split_discrs)) capacity)))
(check-sat)
(exit)
