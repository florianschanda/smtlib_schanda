...
(assert (= x86__bh__result1 ((_ extract 7 0) (bvudiv (bvand rbx ((_ int2bv 64) 65280)) ((_ int2bv 64) 256)))))
...
(assert (not (= x86__bh__result4 ((_ extract 7 0) (bvurem (bvudiv (bvand rbx ((_ int2bv 64) 65280)) ((_ int2bv 64) 256)) ((_ int2bv 64) 256))))))
(check-sat)
(exit)
