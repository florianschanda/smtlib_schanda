...
(assert (= x86__writereghigh8post__result1 x86__writereghigh8post__result2))
(assert (= x86__writereghigh8post__result3 x86__writereghigh8post__result1))
(assert (and (= o (readreghigh8 regnew)) (= o ((_ extract 7 0) (bvurem (bvudiv (bvand regnew #x000000000000FF00) #x0000000000000100) ((_ int2bv 64) 256))))))
(assert (= o1 (ite (= o val__) true false)))
(assert (= o2 (ite (= o1 true) (ite (= (bvand regnew #xFFFFFFFFFFFF00FF) (bvand regold #xFFFFFFFFFFFF00FF)) true false) false)))
(assert (= result x86__writereghigh8post__result))
(assert (= x86__writereghigh8post__result1 o2))
(assert (= (mk_bool__ref x86__writereghigh8post__result4) (mk_bool__ref x86__writereghigh8post__result2)))
(assert (= x86__writereghigh8post__result5 x86__writereghigh8post__result3))
(assert (= result1 x86__writereghigh8post__result4))
(assert (= x86__writereghigh8post__result4 true))
(assert (not (= (readreghigh8 regnew) val__)))
(check-sat)
(exit)
