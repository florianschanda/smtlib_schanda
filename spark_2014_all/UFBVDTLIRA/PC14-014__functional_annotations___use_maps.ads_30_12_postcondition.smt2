...
(define-fun dynamic_invariant1 ((temp___expr_346 Int) (temp___is_init_342 Bool) (temp___skip_constant_343 Bool) (temp___do_toplevel_344 Bool) (temp___do_typ_inv_345 Bool)) Bool (=> (or (= temp___is_init_342 true) (<= 1 2147483647)) (in_range2 temp___expr_346)))
...
(assert (forall ((s us_rep)) (forall ((k Int)) (! (=> (dynamic_invariant k true true true true) (let ((result (my_find s k))) (ite (not (= (bool_eq1 result no_element) true)) (and (= (has_element s result) true) (= (key s result) k)) (not (= (has_key (model__ s) k) true))))) :pattern ((my_find s k))))))
...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__use_maps__my_maps__map__capacity (us_split_discrs1 container)))) (dynamic_invariant3 result true false true true))) :pattern ((length container)))))
...
(define-fun default_initial_assumption ((temp___expr_437 us_rep4) (temp___skip_top_level_438 Bool)) Bool (=> (not (= temp___skip_top_level_438 true)) (= (length2 temp___expr_437) 0)))
(declare-fun find (us_rep4 Int) Int)
(declare-fun find__function_guard (Int us_rep4 Int) Bool)
(assert (forall ((container us_rep4)) (forall ((key2 Int)) (! (=> (dynamic_invariant1 key2 true true true true) (let ((result (find container key2))) (and (=> (< 0 result) (and (<= result (length2 container)) (= key2 (get container result)))) (dynamic_invariant3 result true false true true)))) :pattern ((find container key2))))))
...
(assert (forall ((container us_rep2)) (forall ((key2 Int)) (! (=> (dynamic_invariant4 key2 true true true true) (=> (= (distinct 1 0) true) (=> (exists ((k1 Int)) (and (and (in_range4 k1) (= (has_key container k1) true)) (= k1 key2))) (= (has_key container key2) true)))) :pattern ((has_key container key2))))))
...
(assert (forall ((container us_rep2)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant4 key2 true true true true) (= (has_key container key2) true)) (let ((result (get2 container key2))) (and (=> (= (distinct 1 0) true) (and (= result (w_get container (witness container key2))) (forall ((k1 Int)) (=> (and (in_range4 k1) (= (has_key container k1) true)) (= (= k1 key2) (= (witness container key2) (witness container k1))))))) (dynamic_invariant5 result true false true true)))) :pattern ((get2 container key2))))))
(assert (forall ((container us_rep2)) (! (dynamic_invariant3 (length3 container) true false true true) :pattern ((length3 container)))))
...
(assert true)
(assert (forall ((container us_rep2)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant4 key2 true true true true) (= (has_key container key2) true)) (let ((result (witness container key2))) (and (= (has_witness container result) true) (dynamic_invariant3 result true false true true)))) :pattern ((witness container key2))))))
(assert (forall ((container us_rep2)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant3 witness1 true true true true) (= (has_witness container witness1) true)) (dynamic_invariant5 (w_get container witness1) true false true true)) :pattern ((w_get container witness1))))))
...
(assert (forall ((container us_rep4)) (! (let ((result (length2 container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant3 result true false true true))) :pattern ((length2 container)))))
...
(assert (forall ((container us_rep3)) (forall ((key2 us_rep1)) (! (=> (= (distinct 0 0) true) (=> (exists ((k1 us_rep1)) (and (= (has_key1 container k1) true) (= (bool_eq1 k1 key2) true))) (= (has_key1 container key2) true))) :pattern ((has_key1 container key2))))))
...
(assert (forall ((container us_rep3)) (forall ((key2 us_rep1)) (! (=> (= (has_key1 container key2) true) (let ((result (get1 container key2))) (and (=> (= (distinct 0 0) true) (and (= result (w_get1 container (witness1 container key2))) (forall ((k1 us_rep1)) (=> (= (has_key1 container k1) true) (= (= (bool_eq1 k1 key2) true) (= (witness1 container key2) (witness1 container k1))))))) (dynamic_invariant8 result true false true true)))) :pattern ((get1 container key2))))))
...
(assert true)
(assert (forall ((container us_rep3)) (forall ((key2 us_rep1)) (! (=> (= (has_key1 container key2) true) (let ((result (witness1 container key2))) (and (= (has_witness1 container result) true) (dynamic_invariant3 result true false true true)))) :pattern ((witness1 container key2))))))
(assert (forall ((container us_rep3)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant3 witness2 true true true true) (= (has_witness1 container witness2) true)) (dynamic_invariant8 (w_get1 container witness2) true false true true)) :pattern ((w_get1 container witness2))))))
(declare-const use_maps__my_contains__result Bool)
(declare-const o count_type)
(declare-const o1 count_type)
(declare-const temp___795 count_type)
...
(assert (= (mk___rep1 (mk___split_fields1 temp___795)) no_element))
(assert (in_range k))
