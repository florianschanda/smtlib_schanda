...
(define-fun dynamic_invariant1 ((temp___expr_319 Int) (temp___is_init_316 Bool) (temp___skip_constant_317 Bool) (temp___do_toplevel_318 Bool)) Bool (=> (or (= temp___is_init_316 true) (<= 1 2147483647)) (in_range2 temp___expr_319)))
...
(assert (forall ((s us_rep)) (forall ((k Int)) (! (=> (dynamic_invariant k true true true) (let ((result (my_find s k))) (ite (not (= (bool_eq1 result no_element) true)) (and (= (has_element s result) true) (= (key s result) k)) (not (= (has_key (model__ s) k) true))))) :pattern ((my_find s k))))))
...
(define-fun dynamic_invariant3 ((temp___expr_173 Int) (temp___is_init_170 Bool) (temp___skip_constant_171 Bool) (temp___do_toplevel_172 Bool)) Bool (=> (or (= temp___is_init_170 true) (<= 0 2147483647)) (in_range1 temp___expr_173)))
...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__use_maps__my_maps__map__capacity (us_split_discrs1 container)))) (dynamic_invariant3 result true false true))) :pattern ((length container)))))
...
(define-fun oeq2 ((left us_rep4) (right us_rep4)) Bool (and (= (length2 left) (length2 right)) (ite (forall ((n Int)) (=> (and (<= 1 n) (<= n (last left))) (= (get left n) (get right n)))) true false)))
...
(define-fun default_initial_assumption ((temp___expr_398 us_rep4) (temp___skip_top_level_399 Bool)) Bool (=> (not (= temp___skip_top_level_399 true)) (= (length2 temp___expr_398) 0)))
(declare-fun find (us_rep4 Int) Int)
(declare-fun find__function_guard (Int us_rep4 Int) Bool)
(assert (forall ((container us_rep4)) (forall ((key2 Int)) (! (=> (dynamic_invariant1 key2 true true true) (let ((result (find container key2))) (and (=> (< 0 result) (and (<= result (length2 container)) (= key2 (get container result)))) (dynamic_invariant3 result true false true)))) :pattern ((find container key2))))))
...
(assert (forall ((container us_rep)) (! (let ((result (keys container))) (and (and (and (and (= (length2 result) (length container)) (forall ((temp___435 Int)) (=> (and (in_range5 temp___435) (= (iter_has_element result temp___435) true)) (= (has_key (model__ container) (get result temp___435)) true)))) (forall ((key2 Int)) (=> (and (in_range4 key2) (= (has_key (model__ container) key2) true)) (and (< 0 (find result key2)) (= (get result (find result key2)) key2))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (= (find result (get result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length container))) (=> (= (get result i) (get result j)) (= i j)))))))) :pattern ((keys container)))))
...
(define-fun default_initial_assumption2 ((temp___expr_418 us_rep3) (temp___skip_top_level_419 Bool)) Bool (=> (not (= temp___skip_top_level_419 true)) (and (= (is_empty1 temp___expr_418) true) (= (length4 temp___expr_418) 0))))
...
(assert true)
(define-fun dynamic_invariant4 ((temp___expr_354 Int) (temp___is_init_351 Bool) (temp___skip_constant_352 Bool) (temp___do_toplevel_353 Bool)) Bool (=> (or (= temp___is_init_351 true) (<= 1 2147483647)) (in_range4 temp___expr_354)))
(assert (forall ((container us_rep2)) (forall ((key2 Int)) (! (=> (dynamic_invariant4 key2 true true true) (=> (= (of_int 1) true) (=> (exists ((k1 Int)) (and (and (in_range4 k1) (= (has_key container k1) true)) (= k1 key2))) (= (has_key container key2) true)))) :pattern ((has_key container key2))))))
...
(define-fun dynamic_invariant5 ((temp___expr_360 Int) (temp___is_init_357 Bool) (temp___skip_constant_358 Bool) (temp___do_toplevel_359 Bool)) Bool (=> (or (= temp___is_init_357 true) (<= (- 2147483648) 2147483647)) (in_range6 temp___expr_360)))
...
(assert (forall ((container us_rep2)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant4 key2 true true true) (= (has_key container key2) true)) (let ((result (get2 container key2))) (and (=> (= (of_int 1) true) (and (= result (w_get container (witness container key2))) (forall ((k1 Int)) (=> (and (in_range4 k1) (= (has_key container k1) true)) (= (= k1 key2) (= (witness container key2) (witness container k1))))))) (dynamic_invariant5 result true false true)))) :pattern ((get2 container key2))))))
(assert (forall ((container us_rep2)) (! (dynamic_invariant3 (length3 container) true false true) :pattern ((length3 container)))))
(assert (forall ((left us_rep2) (right us_rep2)) (! (= (= (oeq3 left right) true) (and (forall ((key2 Int)) (=> (and (in_range4 key2) (= (has_key left key2) true)) (and (= (has_key right key2) true) (= (get2 right key2) (get2 left key2))))) (forall ((key2 Int)) (=> (and (in_range4 key2) (= (has_key right key2) true)) (= (has_key left key2) true))))) :pattern ((oeq3 left right)))))
...
(assert true)
(assert (forall ((container us_rep2)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant4 key2 true true true) (= (has_key container key2) true)) (let ((result (witness container key2))) (and (= (has_witness container result) true) (dynamic_invariant3 result true false true)))) :pattern ((witness container key2))))))
(assert (forall ((container us_rep2)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant3 witness1 true true true) (= (has_witness container witness1) true)) (dynamic_invariant5 (w_get container witness1) true false true)) :pattern ((w_get container witness1))))))
(define-fun dynamic_invariant6 ((temp___expr_391 Int) (temp___is_init_388 Bool) (temp___skip_constant_389 Bool) (temp___do_toplevel_390 Bool)) Bool (=> (or (= temp___is_init_388 true) (<= 0 2147483647)) (in_range5 temp___expr_391)))
(assert (forall ((container us_rep4)) (! (let ((result (length2 container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant3 result true false true))) :pattern ((length2 container)))))
...
(define-fun dynamic_invariant7 ((temp___expr_385 Int) (temp___is_init_382 Bool) (temp___skip_constant_383 Bool) (temp___do_toplevel_384 Bool)) Bool (=> (or (= temp___is_init_382 true) (<= 1 2147483647)) (in_range7 temp___expr_385)))
(assert (forall ((container us_rep4)) (forall ((position Int)) (! (=> (and (dynamic_invariant6 position true true true) (and (<= 1 position) (<= position (last container)))) (dynamic_invariant7 (get container position) true false true)) :pattern ((get container position))))))
(assert (forall ((container us_rep3)) (forall ((key2 us_rep1)) (! (=> (= (of_int 0) true) (=> (exists ((k1 us_rep1)) (and (= (has_key1 container k1) true) (= (bool_eq1 k1 key2) true))) (= (has_key1 container key2) true))) :pattern ((has_key1 container key2))))))
...
(define-fun dynamic_invariant8 ((temp___expr_411 Int) (temp___is_init_408 Bool) (temp___skip_constant_409 Bool) (temp___do_toplevel_410 Bool)) Bool (=> (or (= temp___is_init_408 true) (<= 1 2147483647)) (in_range8 temp___expr_411)))
...
(assert (forall ((container us_rep3)) (forall ((key2 us_rep1)) (! (=> (= (has_key1 container key2) true) (let ((result (get1 container key2))) (and (=> (= (of_int 0) true) (and (= result (w_get1 container (witness1 container key2))) (forall ((k1 us_rep1)) (=> (= (has_key1 container k1) true) (= (= (bool_eq1 k1 key2) true) (= (witness1 container key2) (witness1 container k1))))))) (dynamic_invariant8 result true false true)))) :pattern ((get1 container key2))))))
(assert (forall ((container us_rep3)) (! (dynamic_invariant3 (length4 container) true false true) :pattern ((length4 container)))))
(assert (forall ((container us_rep3)) (! (= (= (is_empty1 container) true) (forall ((key2 us_rep1)) (not (= (has_key1 container key2) true)))) :pattern ((is_empty1 container)))))
(declare-fun has_witness1 (us_rep3 Int) Bool)
(declare-fun has_witness__function_guard1 (Bool us_rep3 Int) Bool)
(assert true)
(assert (forall ((container us_rep3)) (forall ((key2 us_rep1)) (! (=> (= (has_key1 container key2) true) (let ((result (witness1 container key2))) (and (= (has_witness1 container result) true) (dynamic_invariant3 result true false true)))) :pattern ((witness1 container key2))))))
(assert (forall ((container us_rep3)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant3 witness2 true true true) (= (has_witness1 container witness2) true)) (dynamic_invariant8 (w_get1 container witness2) true false true)) :pattern ((w_get1 container witness2))))))
...
(assert (and (= o2 (has_key (model__ s) k)) (= (= o2 true) (= (has_key (model__ s) k) true))))
...
(assert (not (not (= (bool_eq1 (my_find s k) no_element) true))))
(check-sat)
(exit)
