...
(define-fun dynamic_invariant1 ((temp___expr_423 Int) (temp___is_init_420 Bool) (temp___skip_constant_421 Bool) (temp___do_toplevel_422 Bool)) Bool (=> (or (= temp___is_init_420 true) (<= 1 2147483647)) (in_range2 temp___expr_423)))
...
(define-fun default_initial_assumption ((temp___expr_430 us_rep2) (temp___skip_top_level_431 Bool)) Bool (=> (not (= temp___skip_top_level_431 true)) (and (= (is_empty temp___expr_430) true) (= (length2 temp___expr_430) 0))))
...
(define-fun default_initial_assumption1 ((temp___expr_379 us_rep3) (temp___skip_top_level_380 Bool)) Bool (=> (not (= temp___skip_top_level_380 true)) (and (= (is_empty1 temp___expr_379) true) (= (length3 temp___expr_379) 0))))
...
(define-fun dynamic_invariant4 ((temp___expr_366 Int) (temp___is_init_363 Bool) (temp___skip_constant_364 Bool) (temp___do_toplevel_365 Bool)) Bool (=> (or (= temp___is_init_363 true) (<= 1 100)) (in_range4 temp___expr_366)))
(declare-fun has_key1 (us_rep3 Int) Bool)
(declare-fun has_key__function_guard1 (Bool us_rep3 Int) Bool)
(assert (forall ((container1 us_rep3)) (forall ((key Int)) (! (=> (dynamic_invariant4 key true true true) (=> (= (of_int 1) true) (=> (exists ((k Int)) (and (and (in_range4 k) (= (has_key1 container1 k) true)) (= (my_eq k key) true))) (= (has_key1 container1 key) true)))) :pattern ((has_key1 container1 key))))))
...
(define-fun dynamic_invariant5 ((temp___expr_372 Int) (temp___is_init_369 Bool) (temp___skip_constant_370 Bool) (temp___do_toplevel_371 Bool)) Bool (=> (or (= temp___is_init_369 true) (<= 1 100)) (in_range5 temp___expr_372)))
...
(assert (forall ((container1 us_rep3)) (forall ((key Int)) (! (=> (and (dynamic_invariant4 key true true true) (= (has_key1 container1 key) true)) (let ((result (get1 container1 key))) (and (=> (= (of_int 1) true) (and (= result (w_get1 container1 (witness1 container1 key))) (forall ((k Int)) (=> (and (in_range4 k) (= (has_key1 container1 k) true)) (= (= (my_eq k key) true) (= (witness1 container1 key) (witness1 container1 k))))))) (dynamic_invariant5 result true false true)))) :pattern ((get1 container1 key))))))
(assert (forall ((container1 us_rep3)) (! (dynamic_invariant (length3 container1) true false true) :pattern ((length3 container1)))))
(assert (forall ((left us_rep3) (right us_rep3)) (! (= (= (oeq2 left right) true) (and (forall ((key Int)) (=> (and (in_range4 key) (= (has_key1 left key) true)) (and (= (has_key1 right key) true) (= (get1 right key) (get1 left key))))) (forall ((key Int)) (=> (and (in_range4 key) (= (has_key1 right key) true)) (= (has_key1 left key) true))))) :pattern ((oeq2 left right)))))
...
(assert true)
(assert (forall ((container1 us_rep3)) (forall ((key Int)) (! (=> (and (dynamic_invariant4 key true true true) (= (has_key1 container1 key) true)) (let ((result (witness1 container1 key))) (and (= (has_witness container1 result) true) (dynamic_invariant result true false true)))) :pattern ((witness1 container1 key))))))
(assert (forall ((container1 us_rep3)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant witness2 true true true) (= (has_witness container1 witness2) true)) (dynamic_invariant5 (w_get1 container1 witness2) true false true)) :pattern ((w_get1 container1 witness2))))))
