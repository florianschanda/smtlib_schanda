...
(define-fun default_initial_assumption ((temp___expr_474 us_rep2) (temp___skip_top_level_475 Bool)) Bool (=> (not (= temp___skip_top_level_475 true)) (and (= (is_empty temp___expr_474) true) (= (length2 temp___expr_474) 0))))
...
(define-fun default_initial_assumption1 ((temp___expr_415 us_rep3) (temp___skip_top_level_416 Bool)) Bool (=> (not (= temp___skip_top_level_416 true)) (and (= (is_empty1 temp___expr_415) true) (= (length3 temp___expr_415) 0))))
...
(define-fun dynamic_invariant4 ((temp___expr_400 Int) (temp___is_init_396 Bool) (temp___skip_constant_397 Bool) (temp___do_toplevel_398 Bool) (temp___do_typ_inv_399 Bool)) Bool (=> (or (= temp___is_init_396 true) (<= 1 100)) (in_range4 temp___expr_400)))
(declare-fun has_key1 (us_rep3 Int) Bool)
(declare-fun has_key__function_guard1 (Bool us_rep3 Int) Bool)
(assert (forall ((container1 us_rep3)) (forall ((key Int)) (! (=> (dynamic_invariant4 key true true true true) (=> (= (distinct 1 0) true) (=> (exists ((k Int)) (and (and (in_range4 k) (= (has_key1 container1 k) true)) (= (my_eq k key) true))) (= (has_key1 container1 key) true)))) :pattern ((has_key1 container1 key))))))
...
(assert (forall ((container1 us_rep3)) (forall ((key Int)) (! (=> (and (dynamic_invariant4 key true true true true) (= (has_key1 container1 key) true)) (let ((result (get1 container1 key))) (and (=> (= (distinct 1 0) true) (and (= result (w_get1 container1 (witness1 container1 key))) (forall ((k Int)) (=> (and (in_range4 k) (= (has_key1 container1 k) true)) (= (= (my_eq k key) true) (= (witness1 container1 key) (witness1 container1 k))))))) (dynamic_invariant5 result true false true true)))) :pattern ((get1 container1 key))))))
...
(declare-const temp___722 count_type)
(declare-const o2 us_rep2)
(declare-const o3 Int)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___722 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___722)) no_element))
