...
(declare-sort t2 0)
(define-fun in_range1 ((x (_ BitVec 8))) Bool (and (bvule ((_ int2bv 8) 0) x) (bvule x ((_ int2bv 8) 7))))
...
(define-fun dynamic_invariant2 ((temp___expr_177 (_ BitVec 8)) (temp___is_init_174 Bool) (temp___skip_constant_175 Bool) (temp___do_toplevel_176 Bool)) Bool (=> (or (= temp___is_init_174 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 7))) (in_range1 temp___expr_177)))
