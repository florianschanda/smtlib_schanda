...
(assert (forall ((left us_rep1) (right us_rep1)) (! (= (= (oeq1 left right) true) (and (forall ((key Int)) (=> (and (in_range3 key) (= (has_key left key) true)) (and (= (has_key right key) true) (= (= (get right key) true) (= (get left key) true))))) (forall ((key Int)) (=> (and (in_range3 key) (= (has_key right key) true)) (= (has_key left key) true))))) :pattern ((oeq1 left right)))))
(assert (forall ((container us_rep1)) (! (= (= (is_empty1 container) true) (forall ((key Int)) (not (and (in_range3 key) (= (has_key container key) true))))) :pattern ((is_empty1 container)))))
