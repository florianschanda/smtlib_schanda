...
(define-fun dynamic_invariant ((temp___expr_165 (_ BitVec 32)) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool)) Bool true)
...
(define-fun dynamic_invariant1 ((temp___expr_171 Int) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool)) Bool (=> (or (= temp___is_init_168 true) (<= 0 2147483647)) (in_range temp___expr_171)))
...
(define-fun dynamic_invariant2 ((temp___expr_510 us_rep) (temp___is_init_507 Bool) (temp___skip_constant_508 Bool) (temp___do_toplevel_509 Bool)) Bool (=> (not (= temp___skip_constant_508 true)) (in_range1 10 r1s temp___expr_510)))
(define-fun default_initial_assumption ((temp___expr_513 us_rep) (temp___skip_top_level_514 Bool)) Bool (and (and (= (to_rep1 (rec__com_map__com_to_rbc_map__map__capacity (us_split_discrs1 temp___expr_513))) 10) (= (to_rep (rec__com_map__com_to_rbc_map__map__modulus (us_split_discrs1 temp___expr_513))) r1s)) (=> (not (= temp___skip_top_level_514 true)) (= (is_empty temp___expr_513) true))))
...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep1 (rec__com_map__com_to_rbc_map__map__capacity (us_split_discrs1 container)))) (dynamic_invariant1 result true false true))) :pattern ((length container)))))
...
(define-fun default_initial_assumption1 ((temp___expr_310 us_rep1) (temp___skip_top_level_311 Bool)) Bool (=> (not (= temp___skip_top_level_311 true)) (and (= (is_empty2 temp___expr_310) true) (= (length2 temp___expr_310) 0))))
...
(define-fun dynamic_invariant3 ((temp___expr_303 Int) (temp___is_init_300 Bool) (temp___skip_constant_301 Bool) (temp___do_toplevel_302 Bool)) Bool (=> (or (= temp___is_init_300 true) (<= 1 10000)) (in_range3 temp___expr_303)))
(declare-fun has_key (us_rep1 Int) Bool)
(declare-fun has_key__function_guard (Bool us_rep1 Int) Bool)
(assert (forall ((container us_rep1)) (forall ((key Int)) (! (=> (dynamic_invariant3 key true true true) (=> (= (of_int 1) true) (=> (exists ((k Int)) (and (and (in_range3 k) (= (has_key container k) true)) (= k key))) (= (has_key container key) true)))) :pattern ((has_key container key))))))
...
(assert (forall ((container us_rep1)) (forall ((key Int)) (! (=> (and (dynamic_invariant3 key true true true) (= (has_key container key) true)) (=> (= (of_int 1) true) (and (= (= (get container key) true) (= (w_get container (witness container key)) true)) (forall ((k Int)) (=> (and (in_range3 k) (= (has_key container k) true)) (= (= k key) (= (witness container key) (witness container k)))))))) :pattern ((get container key))))))
(assert (forall ((container us_rep1)) (! (dynamic_invariant1 (length2 container) true false true) :pattern ((length2 container)))))
...
(assert true)
(assert (forall ((container us_rep1)) (forall ((key Int)) (! (=> (and (dynamic_invariant3 key true true true) (= (has_key container key) true)) (let ((result (witness container key))) (and (= (has_witness container result) true) (dynamic_invariant1 result true false true)))) :pattern ((witness container key))))))
(assert true)
(declare-const section_3_5_3__R1s__assume (_ BitVec 32))
