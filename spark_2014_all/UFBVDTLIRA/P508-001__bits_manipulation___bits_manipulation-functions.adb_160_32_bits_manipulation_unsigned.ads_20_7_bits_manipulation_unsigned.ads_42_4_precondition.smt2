...
(assert (forall ((value1 (_ BitVec 8))) (! (=> (dynamic_invariant value1 true true true true) (= (msb_index_fast_inline value1) (msb_index_fast_inline_always value1))) :pattern ((msb_index_fast_inline value1)))))
...
(assert (forall ((value1 (_ BitVec 8))) (! (=> (dynamic_invariant value1 true true true true) (= (msb_index_fast_not_inline value1) (msb_index_fast_inline_always value1))) :pattern ((msb_index_fast_not_inline value1)))))
...
(assert (forall ((value1 (_ BitVec 8))) (! (=> (and (dynamic_invariant value1 true true true true) (not (= value1 #x00))) (let ((result (msb_index_slow_inline_always value1))) (and (= (shift_right value1 result) #x01) (dynamic_invariant1 result true false true true)))) :pattern ((msb_index_slow_inline_always value1)))))
(declare-fun msb_index_slow_inline ((_ BitVec 8)) Int)
(declare-fun msb_index_slow_inline__function_guard (Int (_ BitVec 8)) Bool)
(assert (forall ((value1 (_ BitVec 8))) (! (=> (and (dynamic_invariant value1 true true true true) (not (= value1 #x00))) (let ((result (msb_index_slow_inline value1))) (and (= (shift_right value1 result) #x01) (dynamic_invariant1 result true false true true)))) :pattern ((msb_index_slow_inline value1)))))
(assert (forall ((value1 (_ BitVec 8))) (! (=> (dynamic_invariant value1 true true true true) (= (msb_index_slow_inline value1) (msb_index_slow_inline_always value1))) :pattern ((msb_index_slow_inline value1)))))
...
(assert (forall ((value1 (_ BitVec 8))) (! (=> (and (dynamic_invariant value1 true true true true) (not (= value1 #x00))) (let ((result (msb_index_slow_not_inline value1))) (and (= (shift_right value1 result) #x01) (dynamic_invariant1 result true false true true)))) :pattern ((msb_index_slow_not_inline value1)))))
(assert (forall ((value1 (_ BitVec 8))) (! (=> (dynamic_invariant value1 true true true true) (= (msb_index_slow_not_inline value1) (msb_index_slow_inline_always value1))) :pattern ((msb_index_slow_not_inline value1)))))
