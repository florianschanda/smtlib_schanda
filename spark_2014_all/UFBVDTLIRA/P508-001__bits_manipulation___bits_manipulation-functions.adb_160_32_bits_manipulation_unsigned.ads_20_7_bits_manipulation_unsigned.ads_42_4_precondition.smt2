...
(assert (forall ((value1 (_ BitVec 8))) (! (=> (dynamic_invariant value1 true true true) (= (msb_index_fast_inline value1) (msb_index_fast_inline_always value1))) :pattern ((msb_index_fast_inline value1)))))
(declare-fun msb_index_fast_not_inline ((_ BitVec 8)) Int)
(declare-fun msb_index_fast_not_inline__function_guard (Int (_ BitVec 8)) Bool)
(assert (forall ((value1 (_ BitVec 8))) (! (=> (dynamic_invariant value1 true true true) (= (msb_index_fast_not_inline value1) (msb_index_fast_inline_always value1))) :pattern ((msb_index_fast_not_inline value1)))))
...
(assert (forall ((value1 (_ BitVec 8))) (! (=> (and (dynamic_invariant value1 true true true) (not (= value1 ((_ int2bv 8) 0)))) (let ((result (msb_index_slow_inline_always value1))) (and (= (shift_right value1 result) ((_ int2bv 8) 1)) (dynamic_invariant1 result true false true)))) :pattern ((msb_index_slow_inline_always value1)))))
(declare-fun msb_index_slow_inline ((_ BitVec 8)) Int)
(declare-fun msb_index_slow_inline__function_guard (Int (_ BitVec 8)) Bool)
(assert (forall ((value1 (_ BitVec 8))) (! (=> (and (dynamic_invariant value1 true true true) (not (= value1 ((_ int2bv 8) 0)))) (let ((result (msb_index_slow_inline value1))) (and (= (shift_right value1 result) ((_ int2bv 8) 1)) (dynamic_invariant1 result true false true)))) :pattern ((msb_index_slow_inline value1)))))
(assert (forall ((value1 (_ BitVec 8))) (! (=> (dynamic_invariant value1 true true true) (= (msb_index_slow_inline value1) (msb_index_slow_inline_always value1))) :pattern ((msb_index_slow_inline value1)))))
(declare-fun msb_index_slow_not_inline ((_ BitVec 8)) Int)
(declare-fun msb_index_slow_not_inline__function_guard (Int (_ BitVec 8)) Bool)
(assert (forall ((value1 (_ BitVec 8))) (! (=> (and (dynamic_invariant value1 true true true) (not (= value1 ((_ int2bv 8) 0)))) (let ((result (msb_index_slow_not_inline value1))) (and (= (shift_right value1 result) ((_ int2bv 8) 1)) (dynamic_invariant1 result true false true)))) :pattern ((msb_index_slow_not_inline value1)))))
(assert (forall ((value1 (_ BitVec 8))) (! (=> (dynamic_invariant value1 true true true) (= (msb_index_slow_not_inline value1) (msb_index_slow_inline_always value1))) :pattern ((msb_index_slow_not_inline value1)))))
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const result__ Int)
(declare-const bits_manipulation_unsigned__unsigned_8__functions__msb_index__result Int)
(declare-const o Int)
...
(declare-const bits_manipulation_unsigned__unsigned_8__functions__msb_index__result1 Int)
(declare-const result__3 Int)
(declare-const bits_manipulation_unsigned__unsigned_8__functions__msb_index__result2 Int)
(declare-const result__4 Int)
(declare-const bits_manipulation_unsigned__unsigned_8__functions__msb_index__result3 Int)
(declare-const result__5 Int)
(declare-const bits_manipulation_unsigned__unsigned_8__functions__msb_index__result4 Int)
(declare-const result__6 Int)
(declare-const bits_manipulation_unsigned__unsigned_8__functions__msb_index__result5 Int)
(assert true)
