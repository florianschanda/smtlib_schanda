...
(assert true)
(assert (= result rcx))
(assert (= rcx1 (bvor (bvand rcx ((_ int2bv 64) 65280)) ((_ zero_extend 48) (bvmul ((_ zero_extend 8) val__) ((_ int2bv 16) 256))))))
(assert (= rcx1 rcx2))
(assert (= rcx3 rcx1))
(assert (not (= rcx2 (bvor (bvand rcx ((_ int2bv 64) 65280)) ((_ zero_extend 48) (bvmul ((_ zero_extend 8) val__) ((_ int2bv 16) 256)))))))
(check-sat)
(exit)
