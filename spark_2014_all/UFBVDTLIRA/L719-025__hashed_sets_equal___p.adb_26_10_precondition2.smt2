...
(assert (forall ((container us_rep1)) (forall ((item Int)) (! (=> (dynamic_invariant1 item true true true true) (let ((result (find1 container item))) (and (=> (< 0 result) (and (<= result (length1 container)) (= (my_eq item (get container result)) true))) (dynamic_invariant result true false true true)))) :pattern ((find1 container item))))))
(define-fun e_elements_included ((left us_rep1) (right us_rep1)) Bool (ite (forall ((i Int)) (=> (and (<= 1 i) (<= i (length1 left))) (and (< 0 (find1 right (get left i))) (= (get right (find1 right (get left i))) (get left i))))) true false))
...
(assert (forall ((container us_rep)) (! (let ((result (elements container))) (and (and (and (and (= (length1 result) (length container)) (forall ((temp___471 Int)) (=> (and (in_range5 temp___471) (= (iter_has_element result temp___471) true)) (= (contains (model__ container) (get result temp___471)) true)))) (forall ((item Int)) (=> (and (in_range4 item) (= (contains (model__ container) item) true)) (and (< 0 (find1 result item)) (= (my_eq (get result (find1 result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (= (find1 result (get result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length container))) (=> (= (my_eq (get result i) (get result j)) true) (= i j)))))))) :pattern ((elements container)))))
...
(assert (in_range3 e))
(assert (or (= (contains (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) e) true) (< (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (to_rep1 (rec__p__my_sets__set__capacity l__split_discrs)))))
...
(assert (not (< (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (to_rep1 (rec__p__my_sets__set__capacity l__split_discrs)))))
(check-sat)
(exit)
