...
(declare-sort m 0)
(define-fun in_range1 ((x1 (_ BitVec 8))) Bool (and (bvule ((_ int2bv 8) 0) x1) (bvule x1 ((_ int2bv 8) 15))))
...
(define-fun dynamic_invariant1 ((temp___expr_135 (_ BitVec 8)) (temp___is_init_132 Bool) (temp___skip_constant_133 Bool) (temp___do_toplevel_134 Bool)) Bool (=> (or (= temp___is_init_132 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 15))) (in_range1 temp___expr_135)))
(declare-sort n 0)
...
(define-fun dynamic_invariant2 ((temp___expr_141 Int) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool (=> (or (= temp___is_init_138 true) (<= 0 32)) (in_range2 temp___expr_141)))
(declare-sort s 0)
(define-fun in_range3 ((x1 (_ BitVec 8))) Bool (and (bvule ((_ int2bv 8) 0) x1) (bvule x1 ((_ int2bv 8) 15))))
...
(define-fun dynamic_invariant3 ((temp___expr_147 (_ BitVec 8)) (temp___is_init_144 Bool) (temp___skip_constant_145 Bool) (temp___do_toplevel_146 Bool)) Bool (=> (or (= temp___is_init_144 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 15))) (in_range3 temp___expr_147)))
...
(assert (in_range x))
(assert (in_range y))
(assert (and (= o x) (in_range_int x)))
(assert (= p__u__assume ((_ int2bv 8) o)))
(assert (= p__u__assume u))
(assert (in_range1 u))
(assert (and (= o1 y) (in_range_int y)))
(assert (= p__v__assume ((_ int2bv 8) o1)))
(assert (= p__v__assume v))
(assert (in_range1 v))
(assert (= (bv2nat (bvurem (bvsub u v) ((_ int2bv 8) 16))) w))
(assert (in_range2 w))
(assert (and (= p__xs__assume (bvurem (bvsub u v) ((_ int2bv 8) 16))) (in_range3 (bvurem (bvsub u v) ((_ int2bv 8) 16)))))
(assert (= p__xs__assume xs))
(assert (in_range3 xs))
(assert (not (in_range3 u)))
(check-sat)
(exit)
