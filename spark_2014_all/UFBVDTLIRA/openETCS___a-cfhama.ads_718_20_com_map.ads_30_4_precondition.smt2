...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__com_map__com_to_rbc_map__map__capacity (us_split_discrs1 container)))) (dynamic_invariant result true false true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant1 ((temp___expr_417 Int) (temp___is_init_414 Bool) (temp___skip_constant_415 Bool) (temp___do_toplevel_416 Bool)) Bool (=> (or (= temp___is_init_414 true) (<= 1 2147483647)) (in_range2 temp___expr_417)))
...
(define-fun default_initial_assumption ((temp___expr_424 us_rep2) (temp___skip_top_level_425 Bool)) Bool (=> (not (= temp___skip_top_level_425 true)) (and (= (is_empty temp___expr_424) true) (= (length2 temp___expr_424) 0))))
...
(define-fun default_initial_assumption1 ((temp___expr_373 us_rep3) (temp___skip_top_level_374 Bool)) Bool (=> (not (= temp___skip_top_level_374 true)) (and (= (is_empty1 temp___expr_373) true) (= (length3 temp___expr_373) 0))))
...
(define-fun dynamic_invariant3 ((temp___expr_366 Int) (temp___is_init_363 Bool) (temp___skip_constant_364 Bool) (temp___do_toplevel_365 Bool)) Bool (=> (or (= temp___is_init_363 true) (<= 1 10000)) (in_range3 temp___expr_366)))
...
(assert (forall ((container1 us_rep3)) (forall ((key Int)) (! (=> (and (dynamic_invariant3 key true true true) (= (has_key1 container1 key) true)) (=> (= (of_int 1) true) (and (= (= (get1 container1 key) true) (= (w_get1 container1 (witness1 container1 key)) true)) (forall ((k Int)) (=> (and (in_range3 k) (= (has_key1 container1 k) true)) (= (= k key) (= (witness1 container1 key) (witness1 container1 k)))))))) :pattern ((get1 container1 key))))))
