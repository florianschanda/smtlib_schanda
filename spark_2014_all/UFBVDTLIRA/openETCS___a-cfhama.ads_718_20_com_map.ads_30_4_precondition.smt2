...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (and (= (to_rep (rec__com_map__com_to_rbc_map__map__capacity (us_split_discrs1 a))) (to_rep (rec__com_map__com_to_rbc_map__map__capacity (us_split_discrs1 b)))) (= (to_rep1 (rec__com_map__com_to_rbc_map__map__modulus (us_split_discrs1 a))) (to_rep1 (rec__com_map__com_to_rbc_map__map__modulus (us_split_discrs1 b))))) (= (us_main_eq (rec__com_map__com_to_rbc_map__map (us_split_fields1 a)) (rec__com_map__com_to_rbc_map__map (us_split_fields1 b))) true)) true false))
...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (= (to_rep (rec__com_map__com_to_rbc_map__cursor__node (us_split_fields3 a))) (to_rep (rec__com_map__com_to_rbc_map__cursor__node (us_split_fields3 b)))) true false))
...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__com_map__com_to_rbc_map__map__capacity (us_split_discrs1 container)))) (dynamic_invariant result true false true true))) :pattern ((length container)))))
...
(define-fun default_initial_assumption ((temp___expr_467 us_rep2) (temp___skip_top_level_468 Bool)) Bool (=> (not (= temp___skip_top_level_468 true)) (and (= (is_empty temp___expr_467) true) (= (length2 temp___expr_467) 0))))
...
(define-fun default_initial_assumption1 ((temp___expr_408 us_rep3) (temp___skip_top_level_409 Bool)) Bool (=> (not (= temp___skip_top_level_409 true)) (and (= (is_empty1 temp___expr_408) true) (= (length3 temp___expr_408) 0))))
...
(assert (forall ((left us_rep3) (right us_rep3)) (! (= (= (oeq2 left right) true) (and (forall ((key Int)) (=> (and (in_range3 key) (= (has_key1 left key) true)) (and (= (has_key1 right key) true) (= (= (get1 right key) true) (= (get1 left key) true))))) (forall ((key Int)) (=> (and (in_range3 key) (= (has_key1 right key) true)) (= (has_key1 left key) true))))) :pattern ((oeq2 left right)))))
...
(assert (and (= o3 (length container)) (and (in_range1 o3) (<= o3 (to_rep (rec__com_map__com_to_rbc_map__map__capacity (us_split_discrs1 container)))))))
