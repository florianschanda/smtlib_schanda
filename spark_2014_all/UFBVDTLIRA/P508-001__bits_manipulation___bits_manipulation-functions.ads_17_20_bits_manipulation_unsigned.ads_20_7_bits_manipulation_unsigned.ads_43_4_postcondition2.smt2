...
(assert (forall ((value (_ BitVec 16))) (forall ((from Int) (to__ Int)) (! (=> (and (and (and (dynamic_invariant1 value true true true true) (dynamic_invariant3 from true true true true)) (dynamic_invariant3 to__ true true true true)) (<= from to__)) (let ((result (extract_bits_inline_always value from to__))) (and (and (= result (bvand (shift_right value from) (make_mask (+ (- to__ from) 1)))) (and (bvule result (make_mask (+ (- to__ from) 1))) (= (shift_left result from) (bvand value (shift_left (make_mask (+ (- to__ from) 1)) from))))) (dynamic_invariant1 result true false true true)))) :pattern ((extract_bits_inline_always value from to__))))))
...
(assert (forall ((value (_ BitVec 16))) (forall ((from Int) (to__ Int)) (! (=> (and (and (and (dynamic_invariant1 value true true true true) (dynamic_invariant3 from true true true true)) (dynamic_invariant3 to__ true true true true)) (<= from to__)) (let ((result (extract_bits_inline value from to__))) (and (and (= result (bvand (shift_right value from) (make_mask (+ (- to__ from) 1)))) (and (bvule result (make_mask (+ (- to__ from) 1))) (= (shift_left result from) (bvand value (shift_left (make_mask (+ (- to__ from) 1)) from))))) (dynamic_invariant1 result true false true true)))) :pattern ((extract_bits_inline value from to__))))))
(assert (forall ((value (_ BitVec 16))) (forall ((from Int) (to__ Int)) (! (=> (and (and (dynamic_invariant1 value true true true true) (dynamic_invariant3 from true true true true)) (dynamic_invariant3 to__ true true true true)) (= (extract_bits_inline value from to__) (extract_bits_inline_always value from to__))) :pattern ((extract_bits_inline value from to__))))))
...
(assert (forall ((value (_ BitVec 16))) (forall ((from Int) (to__ Int)) (! (=> (and (and (and (dynamic_invariant1 value true true true true) (dynamic_invariant3 from true true true true)) (dynamic_invariant3 to__ true true true true)) (<= from to__)) (let ((result (extract_bits_not_inline value from to__))) (and (and (= result (bvand (shift_right value from) (make_mask (+ (- to__ from) 1)))) (and (bvule result (make_mask (+ (- to__ from) 1))) (= (shift_left result from) (bvand value (shift_left (make_mask (+ (- to__ from) 1)) from))))) (dynamic_invariant1 result true false true true)))) :pattern ((extract_bits_not_inline value from to__))))))
(assert (forall ((value (_ BitVec 16))) (forall ((from Int) (to__ Int)) (! (=> (and (and (dynamic_invariant1 value true true true true) (dynamic_invariant3 from true true true true)) (dynamic_invariant3 to__ true true true true)) (= (extract_bits_not_inline value from to__) (extract_bits_inline_always value from to__))) :pattern ((extract_bits_not_inline value from to__))))))
...
(assert (<= from to__))
(assert (= bits_manipulation_unsigned__unsigned_16__functions__extract_bits__result1 bits_manipulation_unsigned__unsigned_16__functions__extract_bits__result2))
(assert (= result__1 result__4))
(assert (= bits_manipulation_unsigned__unsigned_16__functions__extract_bits__result3 bits_manipulation_unsigned__unsigned_16__functions__extract_bits__result1))
...
(assert (= (mk_t__ref result3) (mk_t__ref bits_manipulation_unsigned__unsigned_16__functions__extract_bits__result)))
(assert (= bits_manipulation_unsigned__unsigned_16__functions__extract_bits__result1 result__1))
(assert (= (mk_t__ref bits_manipulation_unsigned__unsigned_16__functions__extract_bits__result4) (mk_t__ref bits_manipulation_unsigned__unsigned_16__functions__extract_bits__result2)))
(assert (= (mk_t__ref result__6) (mk_t__ref result__4)))
(assert (= bits_manipulation_unsigned__unsigned_16__functions__extract_bits__result5 bits_manipulation_unsigned__unsigned_16__functions__extract_bits__result3))
(assert (= result__7 result__5))
(assert (= result4 bits_manipulation_unsigned__unsigned_16__functions__extract_bits__result4))
(assert (not (= bits_manipulation_unsigned__unsigned_16__functions__extract_bits__result4 (bvand (shift_right value from) (make_mask (+ (- to__ from) 1))))))
(check-sat)
(exit)
