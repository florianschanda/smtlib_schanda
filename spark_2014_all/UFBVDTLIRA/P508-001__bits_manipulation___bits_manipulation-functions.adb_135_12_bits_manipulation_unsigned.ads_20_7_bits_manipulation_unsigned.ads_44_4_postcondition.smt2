...
(assert (forall ((value (_ BitVec 32))) (! (=> (and (dynamic_invariant value true true true true) (not (= value #x00000000))) (let ((result (msb_index_slow_inline_always value))) (and (= (shift_right value result) #x00000001) (dynamic_invariant2 result true false true true)))) :pattern ((msb_index_slow_inline_always value)))))
...
(assert (not (= (shift_right value bits_manipulation_unsigned__unsigned_32__functions__msb_index_slow_inline__result4) #x00000001)))
(check-sat)
(exit)
