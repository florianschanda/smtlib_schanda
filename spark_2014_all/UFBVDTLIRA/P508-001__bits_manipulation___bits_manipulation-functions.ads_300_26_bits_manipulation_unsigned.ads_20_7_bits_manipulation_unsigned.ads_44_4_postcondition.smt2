...
(assert (and (and (= (lemma8 Tuple0) true) (and (forall ((size Int)) (=> (and (<= 1 size) (<= size 31)) (bvult (make_mask size) (ite (< size 4294967296) (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) size)) ((_ int2bv 32) 0))))) (and (and (= bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma1__result1 bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma1__result2) (= bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma1__result3 bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma1__result1)) (and (= o (lemma1_goal Tuple0)) (and (= result bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma1__result) (= bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma1__result1 o)))))) (and (= (mk_bool__ref bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma1__result4) (mk_bool__ref bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma1__result2)) (= bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma1__result5 bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma1__result3))))
