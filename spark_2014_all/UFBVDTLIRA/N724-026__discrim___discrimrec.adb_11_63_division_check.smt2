...
(define-fun dynamic_invariant ((temp___expr_202 us_rep) (temp___is_init_199 Bool) (temp___skip_constant_200 Bool) (temp___do_toplevel_201 Bool)) Bool (and (=> (not (= temp___skip_constant_200 true)) (in_range1 0 temp___expr_202)) (= (attr__constrained temp___expr_202) true)))
(define-fun default_initial_assumption ((temp___expr_204 us_rep) (temp___skip_top_level_205 Bool)) Bool (and (= (attr__constrained temp___expr_204) true) (= (to_rep2 (rec__discrimrec__register_type__option (us_split_discrs1 temp___expr_204))) 0)))
...
(define-fun dynamic_invariant1 ((temp___expr_220 us_rep) (temp___is_init_217 Bool) (temp___skip_constant_218 Bool) (temp___do_toplevel_219 Bool)) Bool (and (=> (not (= temp___skip_constant_218 true)) (in_range2 1 temp___expr_220)) (= (attr__constrained temp___expr_220) true)))
(define-fun default_initial_assumption1 ((temp___expr_222 us_rep) (temp___skip_top_level_223 Bool)) Bool (and (= (attr__constrained temp___expr_222) true) (= (to_rep2 (rec__discrimrec__register_type__option (us_split_discrs1 temp___expr_222))) 1)))
(define-fun dynamic_invariant2 ((temp___expr_135 (_ BitVec 64)) (temp___is_init_132 Bool) (temp___skip_constant_133 Bool) (temp___do_toplevel_134 Bool)) Bool true)
(define-fun dynamic_invariant3 ((temp___expr_141 (_ BitVec 32)) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool true)
(define-fun dynamic_invariant4 ((temp___expr_147 (_ BitVec 16)) (temp___is_init_144 Bool) (temp___skip_constant_145 Bool) (temp___do_toplevel_146 Bool)) Bool true)
(define-fun dynamic_invariant5 ((temp___expr_153 (_ BitVec 8)) (temp___is_init_150 Bool) (temp___skip_constant_151 Bool) (temp___do_toplevel_152 Bool)) Bool true)
(define-fun dynamic_invariant6 ((temp___expr_159 Int) (temp___is_init_156 Bool) (temp___skip_constant_157 Bool) (temp___do_toplevel_158 Bool)) Bool (=> (or (= temp___is_init_156 true) (<= 0 3)) (in_range temp___expr_159)))
(define-fun default_initial_assumption2 ((temp___expr_167 us_rep) (temp___skip_top_level_168 Bool)) Bool (and (= (attr__constrained temp___expr_167) false) (= (to_rep2 (rec__discrimrec__register_type__option (us_split_discrs1 temp___expr_167))) 0)))
...
(declare-const o38 register_option)
(declare-const o39 unsigned_64)
(declare-const o40 unsigned_32)
(declare-const o41 unsigned_32)
(declare-const o42 unsigned_32)
(declare-const o43 unsigned_16)
(declare-const o44 unsigned_16)
(declare-const o45 unsigned_32)
(declare-const o46 unsigned_16)
(declare-const o47 unsigned_8)
(declare-const o48 unsigned_8)
...
(assert (not (not (= ((_ int2bv 64) 4294967296) #x0000000000000000))))
(check-sat)
(exit)
