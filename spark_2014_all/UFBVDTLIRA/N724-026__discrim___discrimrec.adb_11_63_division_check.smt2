...
(define-fun dynamic_invariant ((temp___expr_232 us_rep) (temp___is_init_228 Bool) (temp___skip_constant_229 Bool) (temp___do_toplevel_230 Bool) (temp___do_typ_inv_231 Bool)) Bool (and (=> (not (= temp___skip_constant_229 true)) (in_range1 0 temp___expr_232)) (= (attr__constrained temp___expr_232) true)))
(define-fun default_initial_assumption ((temp___expr_234 us_rep) (temp___skip_top_level_235 Bool)) Bool (and (= (attr__constrained temp___expr_234) true) (= (to_rep2 (rec__discrimrec__register_type__option (us_split_discrs1 temp___expr_234))) 0)))
...
(define-fun dynamic_invariant1 ((temp___expr_251 us_rep) (temp___is_init_247 Bool) (temp___skip_constant_248 Bool) (temp___do_toplevel_249 Bool) (temp___do_typ_inv_250 Bool)) Bool (and (=> (not (= temp___skip_constant_248 true)) (in_range2 1 temp___expr_251)) (= (attr__constrained temp___expr_251) true)))
(define-fun default_initial_assumption1 ((temp___expr_253 us_rep) (temp___skip_top_level_254 Bool)) Bool (and (= (attr__constrained temp___expr_253) true) (= (to_rep2 (rec__discrimrec__register_type__option (us_split_discrs1 temp___expr_253))) 1)))
(define-fun dynamic_invariant2 ((temp___expr_158 (_ BitVec 64)) (temp___is_init_154 Bool) (temp___skip_constant_155 Bool) (temp___do_toplevel_156 Bool) (temp___do_typ_inv_157 Bool)) Bool true)
(define-fun dynamic_invariant3 ((temp___expr_165 (_ BitVec 32)) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool) (temp___do_typ_inv_164 Bool)) Bool true)
(define-fun dynamic_invariant4 ((temp___expr_172 (_ BitVec 16)) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool) (temp___do_typ_inv_171 Bool)) Bool true)
(define-fun dynamic_invariant5 ((temp___expr_179 (_ BitVec 8)) (temp___is_init_175 Bool) (temp___skip_constant_176 Bool) (temp___do_toplevel_177 Bool) (temp___do_typ_inv_178 Bool)) Bool true)
(define-fun dynamic_invariant6 ((temp___expr_186 Int) (temp___is_init_182 Bool) (temp___skip_constant_183 Bool) (temp___do_toplevel_184 Bool) (temp___do_typ_inv_185 Bool)) Bool (=> (or (= temp___is_init_182 true) (<= 0 3)) (in_range temp___expr_186)))
(define-fun default_initial_assumption2 ((temp___expr_195 us_rep) (temp___skip_top_level_196 Bool)) Bool (and (= (attr__constrained temp___expr_195) false) (= (to_rep2 (rec__discrimrec__register_type__option (us_split_discrs1 temp___expr_195))) 0)))
(assert (and (= 0 (to_rep2 (rec__discrimrec__register_type__option (us_split_discrs1 reg)))) (= (attr__constrained reg) true)))
(assert (not (not (= #x0000000100000000 #x0000000000000000))))
(check-sat)
(exit)
