...
(define-fun dynamic_invariant1 ((temp___expr_231 Int) (temp___is_init_228 Bool) (temp___skip_constant_229 Bool) (temp___do_toplevel_230 Bool)) Bool (=> (or (= temp___is_init_228 true) (<= 0 7)) (in_range temp___expr_231)))
...
(assert (forall ((v (_ BitVec 8))) (forall ((amount Int)) (! (=> (and (dynamic_invariant v true true true) (dynamic_invariant2 amount true true true)) (dynamic_invariant (shift_left v amount) true false true)) :pattern ((shift_left v amount))))))
(assert (forall ((v (_ BitVec 8))) (forall ((amount Int)) (! (=> (and (dynamic_invariant v true true true) (dynamic_invariant2 amount true true true)) (= (shift_left v amount) (ite (and (<= 1 8) (<= 8 8)) (ite (< amount 8) (bvshl v ((_ int2bv 8) amount)) ((_ int2bv 8) 0)) (ite (and (<= 9 8) (<= 8 16)) ((_ extract 7 0) (bvurem (ite (< amount 16) (bvshl ((_ zero_extend 8) v) ((_ int2bv 16) amount)) ((_ int2bv 16) 0)) ((_ int2bv 16) 256))) (ite (and (<= 17 8) (<= 8 32)) ((_ extract 7 0) (bvurem (bvshl ((_ zero_extend 24) v) ((_ int2bv 32) amount)) ((_ int2bv 32) 256))) ((_ extract 7 0) (bvurem (bvshl ((_ zero_extend 56) v) ((_ int2bv 64) amount)) ((_ int2bv 64) 256)))))))) :pattern ((shift_left v amount))))))
(declare-fun make_mask (Int) (_ BitVec 8))
(declare-fun make_mask__function_guard ((_ BitVec 8) Int) Bool)
(define-fun dynamic_invariant3 ((temp___expr_237 Int) (temp___is_init_234 Bool) (temp___skip_constant_235 Bool) (temp___do_toplevel_236 Bool)) Bool (=> (or (= temp___is_init_234 true) (<= 1 8)) (in_range1 temp___expr_237)))
...
(assert (forall ((num_bits Int)) (! (=> (dynamic_invariant3 num_bits true true true) (= (make_mask num_bits) (shift_right ((_ int2bv 8) 255) (- 8 num_bits)))) :pattern ((make_mask num_bits)))))
...
(declare-fun extract_bits_not_inline__function_guard ((_ BitVec 8) (_ BitVec 8) Int Int) Bool)
...
(assert (<= from to__))
(assert (= bits_manipulation_unsigned__unsigned_8__functions__extract_bits__result1 bits_manipulation_unsigned__unsigned_8__functions__extract_bits__result2))
(assert (= result__1 result__4))
(assert (= bits_manipulation_unsigned__unsigned_8__functions__extract_bits__result3 bits_manipulation_unsigned__unsigned_8__functions__extract_bits__result1))
...
(assert (= (mk_t__ref result3) (mk_t__ref bits_manipulation_unsigned__unsigned_8__functions__extract_bits__result)))
(assert (= bits_manipulation_unsigned__unsigned_8__functions__extract_bits__result1 result__1))
(assert (= (mk_t__ref bits_manipulation_unsigned__unsigned_8__functions__extract_bits__result4) (mk_t__ref bits_manipulation_unsigned__unsigned_8__functions__extract_bits__result2)))
(assert (= (mk_t__ref result__6) (mk_t__ref result__4)))
(assert (= bits_manipulation_unsigned__unsigned_8__functions__extract_bits__result5 bits_manipulation_unsigned__unsigned_8__functions__extract_bits__result3))
