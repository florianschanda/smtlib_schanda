...
(define-fun dynamic_invariant1 ((temp___expr_147 (_ BitVec 8)) (temp___is_init_144 Bool) (temp___skip_constant_145 Bool) (temp___do_toplevel_146 Bool)) Bool true)
...
(define-fun dynamic_invariant3 ((temp___expr_183 Int) (temp___is_init_180 Bool) (temp___skip_constant_181 Bool) (temp___do_toplevel_182 Bool)) Bool (=> (or (= temp___is_init_180 true) (<= 0 2)) (in_range2 temp___expr_183)))
(declare-fun c3 ((_ BitVec 8)) Int)
(declare-fun c3__function_guard (Int (_ BitVec 8)) Bool)
(assert (forall ((s (_ BitVec 8))) (! (=> (dynamic_invariant2 s true true true) (dynamic_invariant3 (c3 s) true false true)) :pattern ((c3 s)))))
