...
(assert (=> (= result true) (and (and (and (and (= (oeq1 (model__ (mk___rep l__split_discrs l__split_fields6)) (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true) (= (contains (model__ (mk___rep l__split_discrs l__split_fields6)) e) true)) (= (oeq2 (positions (mk___rep l__split_discrs l__split_fields6)) (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true)) (= (element (mk___rep l__split_discrs l__split_fields6) (find (mk___rep l__split_discrs l__split_fields6) e)) e)) (= (equal_except (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (elements (mk___rep l__split_discrs l__split_fields6)) (get1 (positions (mk___rep l__split_discrs l__split_fields6)) (find (mk___rep l__split_discrs l__split_fields6) e))) true))))
