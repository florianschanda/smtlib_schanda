...
(assert (=> (= result true) (and (and (and (and (= (oeq2 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true) (= (contains (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) e) true)) (= (oeq3 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true)) (= (element (mk___rep l__split_discrs (mk___split_fields l__split_fields1)) (find (mk___rep l__split_discrs (mk___split_fields l__split_fields1)) e)) e)) (= (equal_except (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) (find (mk___rep l__split_discrs (mk___split_fields l__split_fields1)) e))) true))))
(assert (=> (not (= result true)) (and (and (and (and (and (and (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (+ (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 1)) (= (contains (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) e) true)) (= (element (mk___rep l__split_discrs (mk___split_fields l__split_fields2)) (find (mk___rep l__split_discrs (mk___split_fields l__split_fields2)) e)) e)) (= (ole (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2)))) true)) (= (included_except (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) e) true)) (= (mapping_preserved (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2)))) true)) (= (keys_included_except (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (find (mk___rep l__split_discrs (mk___split_fields l__split_fields2)) e)) true))))
