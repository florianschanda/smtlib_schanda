...
(assert (=> (= (ite (= (not (= x #x0000000000000000)) true) (= y #x0000000000000000) false) true) (= t3__msub__result4 x)))
(assert (=> (= (ite (= (= x #x0000000000000000) true) (not (= y #x0000000000000000)) false) true) (= t3__msub__result4 (bvurem (bvsub #x00000000000000E6 y) #x00000000000000E6))))
(assert (= (ite (= (= x #x0000000000000002) true) (= y #x0000000000000004) false) true))
(assert (not (= t3__msub__result4 #x00000000000000E4)))
(check-sat)
(exit)
