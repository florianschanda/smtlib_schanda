...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__dic_of_cont__my_hase__cursor__node count_type)))))
(define-fun us_split_fields_Node__3__projection ((a us_split_fields2)) count_type (rec__dic_of_cont__my_hase__cursor__node a))
...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (= (to_rep (rec__dic_of_cont__my_hase__cursor__node (us_split_fields3 a))) (to_rep (rec__dic_of_cont__my_hase__cursor__node (us_split_fields3 b)))) true false))
...
(assert (< dic_of_cont__my_hase__cursor__node__first__bit dic_of_cont__my_hase__cursor__node__last__bit))
...
(define-fun cursor__ref___3__projection ((a cursor__ref)) us_rep1 (cursor__content a))
...
(define-fun key_type__ref___5__projection ((a key_type__ref)) us_rep1 (key_type__content a))
...
(define-fun element_type__ref___11__projection ((a element_type__ref)) element_type (element_type__content a))
(define-fun dynamic_invariant1 ((temp___expr_890 Int) (temp___is_init_886 Bool) (temp___skip_constant_887 Bool) (temp___do_toplevel_888 Bool) (temp___do_typ_inv_889 Bool)) Bool (=> (or (= temp___is_init_886 true) (<= 1 2147483647)) (in_range2 temp___expr_890)))
...
(define-fun default_initial_assumption ((temp___expr_898 us_rep2) (temp___skip_top_level_899 Bool)) Bool (=> (not (= temp___skip_top_level_899 true)) (and (= (is_empty temp___expr_898) true) (= (length2 temp___expr_898) 0))))
...
(define-fun dynamic_invariant3 ((temp___expr_798 Int) (temp___is_init_794 Bool) (temp___skip_constant_795 Bool) (temp___do_toplevel_796 Bool) (temp___do_typ_inv_797 Bool)) Bool (=> (or (= temp___is_init_794 true) (<= 0 2147483647)) (in_range3 temp___expr_798)))
...
(define-fun sequence__ref___3__projection ((a sequence__ref)) us_rep3 (sequence__content a))
...
(define-fun default_initial_assumption1 ((temp___expr_875 us_rep3) (temp___skip_top_level_876 Bool)) Bool (=> (not (= temp___skip_top_level_876 true)) (= (length3 temp___expr_875) 0)))
...
(define-fun default_initial_assumption2 ((temp___expr_839 us_rep4) (temp___skip_top_level_840 Bool)) Bool (=> (not (= temp___skip_top_level_840 true)) (= (is_empty1 temp___expr_839) true)))
...
(assert (forall ((container1 us_rep)) (! (let ((result (elements container1))) (and (and (and (and (= (length3 result) (length container1)) (forall ((temp___916 Int)) (=> (and (in_range5 temp___916) (= (iter_has_element result temp___916) true)) (= (contains (model__ container1) (get1 result temp___916)) true)))) (forall ((item Int)) (=> (and (in_range4 item) (= (contains (model__ container1) item) true)) (and (< 0 (find result item)) (= (get1 result (find result item)) item))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (= (find result (get1 result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length container1))) (=> (= (get1 result i) (get1 result j)) (= i j)))))))) :pattern ((elements container1)))))
...
(assert true)
(define-fun dynamic_invariant4 ((temp___expr_831 Int) (temp___is_init_827 Bool) (temp___skip_constant_828 Bool) (temp___do_toplevel_829 Bool) (temp___do_typ_inv_830 Bool)) Bool (=> (or (= temp___is_init_827 true) (<= 0 2147483647)) (in_range4 temp___expr_831)))
...
(define-fun dynamic_invariant5 ((temp___expr_867 Int) (temp___is_init_863 Bool) (temp___skip_constant_864 Bool) (temp___do_toplevel_865 Bool) (temp___do_typ_inv_866 Bool)) Bool (=> (or (= temp___is_init_863 true) (<= 0 2147483647)) (in_range5 temp___expr_867)))
...
(define-fun dynamic_invariant6 ((temp___expr_860 Int) (temp___is_init_856 Bool) (temp___skip_constant_857 Bool) (temp___do_toplevel_858 Bool) (temp___do_typ_inv_859 Bool)) Bool (=> (or (= temp___is_init_856 true) (<= 0 2147483647)) (in_range6 temp___expr_860)))
...
(declare-const temp___2114 count_type)
(declare-const o2 us_rep2)
(declare-const o3 Int)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___2114 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___2114)) no_element))
...
(assert (and (= o3 (length container)) (and (in_range1 o3) (<= o3 (to_rep (rec__dic_of_cont__my_hase__set__capacity (us_split_discrs1 container)))))))
