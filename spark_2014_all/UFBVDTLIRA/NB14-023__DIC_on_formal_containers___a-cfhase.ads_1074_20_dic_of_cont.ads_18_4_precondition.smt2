...
(define-fun dynamic_invariant1 ((temp___expr_821 Int) (temp___is_init_818 Bool) (temp___skip_constant_819 Bool) (temp___do_toplevel_820 Bool)) Bool (=> (or (= temp___is_init_818 true) (<= 1 2147483647)) (in_range2 temp___expr_821)))
...
(define-fun default_initial_assumption ((temp___expr_828 us_rep2) (temp___skip_top_level_829 Bool)) Bool (=> (not (= temp___skip_top_level_829 true)) (and (= (is_empty temp___expr_828) true) (= (length2 temp___expr_828) 0))))
...
(define-fun dynamic_invariant3 ((temp___expr_741 Int) (temp___is_init_738 Bool) (temp___skip_constant_739 Bool) (temp___do_toplevel_740 Bool)) Bool (=> (or (= temp___is_init_738 true) (<= 0 2147483647)) (in_range3 temp___expr_741)))
...
(define-fun default_initial_assumption1 ((temp___expr_808 us_rep3) (temp___skip_top_level_809 Bool)) Bool (=> (not (= temp___skip_top_level_809 true)) (= (length3 temp___expr_808) 0)))
...
(define-fun default_initial_assumption2 ((temp___expr_777 us_rep4) (temp___skip_top_level_778 Bool)) Bool (=> (not (= temp___skip_top_level_778 true)) (= (is_empty1 temp___expr_777) true)))
...
(assert (forall ((container1 us_rep)) (! (let ((result (elements container1))) (and (and (and (and (= (length3 result) (length container1)) (forall ((temp___845 Int)) (=> (and (in_range5 temp___845) (= (iter_has_element result temp___845) true)) (= (contains (model__ container1) (get1 result temp___845)) true)))) (forall ((item Int)) (=> (and (in_range4 item) (= (contains (model__ container1) item) true)) (and (< 0 (find result item)) (= (get1 result (find result item)) item))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (= (find result (get1 result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length container1))) (=> (= (get1 result i) (get1 result j)) (= i j)))))))) :pattern ((elements container1)))))
...
(assert true)
(define-fun dynamic_invariant4 ((temp___expr_770 Int) (temp___is_init_767 Bool) (temp___skip_constant_768 Bool) (temp___do_toplevel_769 Bool)) Bool (=> (or (= temp___is_init_767 true) (<= 0 2147483647)) (in_range4 temp___expr_770)))
...
(define-fun dynamic_invariant5 ((temp___expr_801 Int) (temp___is_init_798 Bool) (temp___skip_constant_799 Bool) (temp___do_toplevel_800 Bool)) Bool (=> (or (= temp___is_init_798 true) (<= 0 2147483647)) (in_range5 temp___expr_801)))
...
(define-fun dynamic_invariant6 ((temp___expr_795 Int) (temp___is_init_792 Bool) (temp___skip_constant_793 Bool) (temp___do_toplevel_794 Bool)) Bool (=> (or (= temp___is_init_792 true) (<= 0 2147483647)) (in_range6 temp___expr_795)))
