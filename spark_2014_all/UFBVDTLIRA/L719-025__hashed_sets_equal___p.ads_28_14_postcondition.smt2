...
(define-fun bool_eq2 ((a us_rep2) (b us_rep2)) Bool (ite (= (to_rep1 (rec__p__my_sets__cursor__node (us_split_fields3 a))) (to_rep1 (rec__p__my_sets__cursor__node (us_split_fields3 b)))) true false))
...
(define-fun dynamic_invariant1 ((temp___expr_346 Int) (temp___is_init_342 Bool) (temp___skip_constant_343 Bool) (temp___do_toplevel_344 Bool) (temp___do_typ_inv_345 Bool)) Bool (=> (or (= temp___is_init_342 true) (<= 1 100)) (in_range3 temp___expr_346)))
...
(define-fun dynamic_invariant3 ((temp___expr_197 Int) (temp___is_init_193 Bool) (temp___skip_constant_194 Bool) (temp___do_toplevel_195 Bool) (temp___do_typ_inv_196 Bool)) Bool (=> (or (= temp___is_init_193 true) (<= 0 2147483647)) (in_range1 temp___expr_197)))
...
(assert (forall ((container us_rep1)) (forall ((item Int)) (! (=> (dynamic_invariant item true true true true) (let ((result (find container item))) (and (=> (< 0 result) (and (<= result (length1 container)) (= (my_eq item (get container result)) true))) (dynamic_invariant3 result true false true true)))) :pattern ((find container item))))))
...
(assert (forall ((container us_rep)) (! (let ((result (elements container))) (and (and (and (and (= (length1 result) (length container)) (forall ((temp___471 Int)) (=> (and (in_range5 temp___471) (= (iter_has_element result temp___471) true)) (= (contains (model__ container) (get result temp___471)) true)))) (forall ((item Int)) (=> (and (in_range4 item) (= (contains (model__ container) item) true)) (and (< 0 (find result item)) (= (my_eq (get result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (= (find result (get result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length container))) (=> (= (my_eq (get result i) (get result j)) true) (= i j)))))))) :pattern ((elements container)))))
...
(assert (forall ((container us_rep4)) (! (dynamic_invariant3 (length3 container) true false true true) :pattern ((length3 container)))))
...
(assert (forall ((container us_rep4)) (! (let ((result (is_empty1 container))) (and (= (= result true) (forall ((item Int)) (not (and (in_range4 item) (= (contains container item) true))))) (= (= result true) (= (length3 container) 0)))) :pattern ((is_empty1 container)))))
...
(assert (= (bool_eq2 (mk___rep1 (mk___split_fields1 cu__split_fields3)) (mk___rep1 (mk___split_fields1 cu__split_fields))) true))
(declare-const c us_rep2)
(assert (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) c) true))
(assert (not (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) c) true)))
(check-sat)
(exit)
