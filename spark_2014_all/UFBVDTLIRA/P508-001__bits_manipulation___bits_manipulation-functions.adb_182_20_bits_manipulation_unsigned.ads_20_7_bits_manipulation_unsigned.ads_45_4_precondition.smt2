...
(assert true)
(assert (forall ((us_void_param tuple0)) (! (= (= (lemma1 us_void_param) true) (forall ((size Int)) (=> (and (<= 1 size) (<= size 63)) (bvult (make_mask size) (ite (< size 18446744073709551616) (bvshl #x0000000000000001 ((_ int2bv 64) size)) #x0000000000000000))))) :pattern ((lemma1 us_void_param)))))
...
(assert (forall ((size Int)) (=> (and (<= 1 size) (<= size 63)) (bvult (make_mask size) (ite (< size 18446744073709551616) (bvshl #x0000000000000001 ((_ int2bv 64) size)) #x0000000000000000)))))
