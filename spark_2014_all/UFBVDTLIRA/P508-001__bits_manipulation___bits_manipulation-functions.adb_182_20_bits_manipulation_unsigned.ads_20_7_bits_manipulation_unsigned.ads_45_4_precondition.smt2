...
(assert true)
(assert (forall ((us_void_param tuple0)) (! (= (= (lemma1 us_void_param) true) (forall ((size Int)) (=> (and (<= 1 size) (<= size 63)) (bvult (make_mask size) (ite (< size 18446744073709551616) (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) size)) ((_ int2bv 64) 0)))))) :pattern ((lemma1 us_void_param)))))
...
(declare-const bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma1__result Bool)
(declare-const o Bool)
(declare-const result Bool)
(declare-const bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma1__result1 Bool)
(declare-const bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma1__result2 Bool)
(declare-const bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma1__result3 Bool)
(declare-const bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma1__result4 Bool)
(declare-const bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma1__result5 Bool)
(assert (= (lemma8 Tuple0) true))
(assert (forall ((size Int)) (=> (and (<= 1 size) (<= size 63)) (bvult (make_mask size) (ite (< size 18446744073709551616) (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) size)) ((_ int2bv 64) 0))))))
