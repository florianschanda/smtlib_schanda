...
(declare-const x86__readreg32__result (_ BitVec 32))
(declare-const result (_ BitVec 32))
(declare-const x86__readreg32__result1 (_ BitVec 32))
(declare-const x86__readreg32__result2 (_ BitVec 32))
(declare-const x86__readreg32__result3 (_ BitVec 32))
(declare-const x86__readreg32__result4 (_ BitVec 32))
(declare-const x86__readreg32__result5 (_ BitVec 32))
(declare-const result1 (_ BitVec 32))
(assert (= x86__readreg32__result1 x86__readreg32__result2))
(assert (= x86__readreg32__result3 x86__readreg32__result1))
(assert (= (mk_t__ref result) (mk_t__ref x86__readreg32__result)))
(assert (= x86__readreg32__result1 ((_ extract 31 0) (bvand reg ((_ int2bv 64) 4294967295)))))
(assert (= (mk_t__ref x86__readreg32__result4) (mk_t__ref x86__readreg32__result2)))
(assert (= x86__readreg32__result5 x86__readreg32__result3))
(assert (= result1 x86__readreg32__result4))
(assert (not (= x86__readreg32__result4 ((_ extract 31 0) (bvand reg ((_ int2bv 64) 4294967295))))))
(check-sat)
(exit)
