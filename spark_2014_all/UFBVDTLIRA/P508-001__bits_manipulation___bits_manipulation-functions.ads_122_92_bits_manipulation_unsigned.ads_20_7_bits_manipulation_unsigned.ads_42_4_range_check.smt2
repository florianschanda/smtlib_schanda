...
(define-fun dynamic_invariant2 ((temp___expr_237 Int) (temp___is_init_234 Bool) (temp___skip_constant_235 Bool) (temp___do_toplevel_236 Bool)) Bool (=> (or (= temp___is_init_234 true) (<= 1 8)) (in_range1 temp___expr_237)))
...
(assert (forall ((num_bits Int)) (! (=> (dynamic_invariant2 num_bits true true true) (= (make_mask num_bits) (shift_right ((_ int2bv 8) 255) (- 8 num_bits)))) :pattern ((make_mask num_bits)))))
