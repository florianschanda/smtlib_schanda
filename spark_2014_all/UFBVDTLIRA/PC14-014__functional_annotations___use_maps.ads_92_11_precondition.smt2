...
(assert (and (= temp___993 (keys (mk___rep m__split_discrs (mk___split_fields m__split_fields)))) (and (and (and (and (= (length3 temp___993) (length (mk___rep m__split_discrs (mk___split_fields m__split_fields)))) (forall ((temp___474 Int)) (=> (and (in_range5 temp___474) (= (iter_has_element temp___993 temp___474) true)) (= (has_key (model__ (mk___rep m__split_discrs (mk___split_fields m__split_fields))) (get1 temp___993 temp___474)) true)))) (forall ((key2 Int)) (=> (and (in_range3 key2) (= (has_key (model__ (mk___rep m__split_discrs (mk___split_fields m__split_fields))) key2) true)) (and (< 0 (find temp___993 key2)) (= (get1 temp___993 (find temp___993 key2)) key2))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep m__split_discrs (mk___split_fields m__split_fields))))) (= (find temp___993 (get1 temp___993 i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep m__split_discrs (mk___split_fields m__split_fields))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (mk___rep m__split_discrs (mk___split_fields m__split_fields))))) (=> (= (get1 temp___993 i) (get1 temp___993 j)) (= i j)))))))))
