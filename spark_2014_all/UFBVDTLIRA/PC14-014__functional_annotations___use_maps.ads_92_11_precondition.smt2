...
(assert (and (= temp___950 (keys (mk___rep m__split_discrs (mk___split_fields m__split_fields)))) (and (and (and (and (= (length3 temp___950) (length (mk___rep m__split_discrs (mk___split_fields m__split_fields)))) (forall ((temp___431 Int)) (=> (and (in_range5 temp___431) (= (iter_has_element temp___950 temp___431) true)) (= (has_key (model__ (mk___rep m__split_discrs (mk___split_fields m__split_fields))) (get1 temp___950 temp___431)) true)))) (forall ((key2 Int)) (=> (and (in_range3 key2) (= (has_key (model__ (mk___rep m__split_discrs (mk___split_fields m__split_fields))) key2) true)) (and (< 0 (find temp___950 key2)) (= (get1 temp___950 (find temp___950 key2)) key2))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep m__split_discrs (mk___split_fields m__split_fields))))) (= (find temp___950 (get1 temp___950 i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep m__split_discrs (mk___split_fields m__split_fields))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (mk___rep m__split_discrs (mk___split_fields m__split_fields))))) (=> (= (get1 temp___950 i) (get1 temp___950 j)) (= i j)))))))))
(assert (and (= o (iter_has_element temp___950 temp___949)) (= (= o true) (and (<= 1 temp___949) (<= temp___949 (last temp___950))))))
(assert (= (= o1 true) (in_range5 temp___949)))
(assert (= result (ite (= o1 true) o false)))
(assert (= result true))
(assert (not (<= 1 temp___949)))
(check-sat)
(exit)
