...
(assert (not (or (< (length (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (to_rep1 (rec__use_sets__my_sets__set__capacity s__split_discrs))) (= (contains (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) 1) true))))
(check-sat)
(exit)
