...
(assert (<= 2 i1))
(assert (<= i1 15))
(assert (= (make_mask i1) (bvsub (ite (< i1 65536) (bvshl #x0001 ((_ int2bv 16) i1)) #x0000) #x0001)))
(declare-const j Int)
(assert (<= 1 j))
(assert (<= j (- i1 1)))
(assert (not (= (make_mask j) (bvsub (ite (< j 65536) (bvshl #x0001 ((_ int2bv 16) j)) #x0000) #x0001))))
(check-sat)
(exit)
