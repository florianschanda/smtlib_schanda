...
(assert (<= 2 i1))
(assert (<= i1 15))
(assert (= (make_mask i1) (bvsub (ite (< i1 65536) (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) i1)) ((_ int2bv 16) 0)) ((_ int2bv 16) 1))))
(declare-const j1 Int)
(assert (<= 1 j1))
(assert (<= j1 (- i1 1)))
(assert (not (= (make_mask j1) (bvsub (ite (< j1 65536) (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) j1)) ((_ int2bv 16) 0)) ((_ int2bv 16) 1)))))
(check-sat)
(exit)
