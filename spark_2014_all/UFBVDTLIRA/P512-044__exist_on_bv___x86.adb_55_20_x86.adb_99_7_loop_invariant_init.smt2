...
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n3)) (=> (bvugt n3 var1_range_size) (= (mk_t__ref result1) n15))))
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n3)) (=> (bvugt n3 var1_range_size) (= n12 ((_ int2bv 64) 0)))))
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n3)) (=> (bvugt n3 var1_range_size) (= (mk_t__ref result2) n25))))
...
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n3)) (=> (not (bvugt n3 var1_range_size)) (=> (bvult n3 var2_range_size) (= (mk_t__ref result3) n15)))))
...
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n3)) (=> (not (bvugt n3 var1_range_size)) (=> (bvult n3 var2_range_size) (= (mk_t__ref result4) n25)))))
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n3)) (=> (not (bvugt n3 var1_range_size)) (=> (bvult n3 var2_range_size) (= n23 n3)))))
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n3)) (=> (not (bvugt n3 var1_range_size)) (=> (not (bvult n3 var2_range_size)) (= (mk_t__ref result5) n15)))))
...
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n3)) (=> (not (bvugt n3 var1_range_size)) (=> (not (bvult n3 var2_range_size)) (= (mk_t__ref result6) n25)))))
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n3)) (=> (not (bvugt n3 var1_range_size)) (=> (not (bvult n3 var2_range_size)) (= n24 ((_ int2bv 64) 0))))))
...
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n3)) (and (and (and (bvule ((_ int2bv 64) 0) n12) (bvule n12 var1_range_size)) (and (bvule ((_ int2bv 64) 0) n22) (bvule n22 var2_range_size))) (= (bvadd var1 n12) (bvadd var2 n22)))))
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n3)) (exists ((i (_ BitVec 64))) (and (and (bvule ((_ int2bv 64) 0) i) (bvule i var1_range_size)) (exists ((j (_ BitVec 64))) (and (and (bvule ((_ int2bv 64) 0) j) (bvule j var2_range_size)) (= (bvadd var1 i) (bvadd var2 j))))))))
...
(assert (not (or (forall ((m (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) m) (bvule m n3)) (not (= var1 (bvadd (bvsub var2 var1_range_size) m))))) (exists ((i (_ BitVec 64))) (and (and (bvule ((_ int2bv 64) 0) i) (bvule i var1_range_size)) (exists ((j (_ BitVec 64))) (and (and (bvule ((_ int2bv 64) 0) j) (bvule j var2_range_size)) (= (bvadd var1 i) (bvadd var2 j)))))))))
(check-sat)
(exit)
