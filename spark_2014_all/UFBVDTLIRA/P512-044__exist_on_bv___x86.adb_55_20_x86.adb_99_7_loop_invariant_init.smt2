...
(assert (not (or (forall ((m (_ BitVec 64))) (=> (and (bvule #x0000000000000000 m) (bvule m n3)) (not (= var1 (bvadd (bvsub var2 var1_range_size) m))))) (exists ((i (_ BitVec 64))) (and (and (bvule #x0000000000000000 i) (bvule i var1_range_size)) (exists ((j (_ BitVec 64))) (and (and (bvule #x0000000000000000 j) (bvule j var2_range_size)) (= (bvadd var1 i) (bvadd var2 j)))))))))
(check-sat)
(exit)
