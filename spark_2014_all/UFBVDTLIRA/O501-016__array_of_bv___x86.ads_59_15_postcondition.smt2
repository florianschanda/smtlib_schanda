...
(assert (forall ((x86__rax (_ BitVec 64))) (! (=> (dynamic_invariant x86__rax true true true) (let ((result (ah x86__rax))) (and (= result ((_ extract 7 0) (bvurem (bvudiv (bvand x86__rax ((_ int2bv 64) 65280)) ((_ int2bv 64) 256)) ((_ int2bv 64) 256)))) (dynamic_invariant1 result true false true)))) :pattern ((ah x86__rax)))))
...
(assert true)
(assert (= result rax))
(assert (= rax1 (bvor (bvand rax ((_ int2bv 64) 18446744073709486335)) ((_ zero_extend 48) (bvmul ((_ zero_extend 8) val__) ((_ int2bv 16) 256))))))
(assert (= rax1 rax2))
(assert (= rax3 rax1))
