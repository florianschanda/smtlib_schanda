...
(define-fun temp___1035 () us_rep1 (elements s))
(declare-const temp___1034 Int)
(assert (in_range2 temp___1034))
(assert (= (iter_has_element temp___1035 temp___1034) true))
(assert (not (= (q (get temp___1035 temp___1034)) true)))
(check-sat)
(exit)
