...
(define-fun dynamic_invariant1 ((temp___expr_168 (_ BitVec 32)) (temp___is_init_165 Bool) (temp___skip_constant_166 Bool) (temp___do_toplevel_167 Bool)) Bool true)
...
(define-fun dynamic_invariant2 ((temp___expr_174 Int) (temp___is_init_171 Bool) (temp___skip_constant_172 Bool) (temp___do_toplevel_173 Bool)) Bool (=> (or (= temp___is_init_171 true) (<= 0 2147483647)) (in_range1 temp___expr_174)))
(declare-fun default_modulus (Int) (_ BitVec 32))
(declare-fun default_modulus__function_guard ((_ BitVec 32) Int) Bool)
(assert (forall ((capacity Int)) (! (=> (dynamic_invariant2 capacity true true true) (dynamic_invariant1 (default_modulus capacity) true false true)) :pattern ((default_modulus capacity)))))
