...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep1 (rec__my_sets__n__set__capacity (us_split_discrs1 container)))) (dynamic_invariant result true false true))) :pattern ((length container)))))
...
(assert (forall ((container us_rep2)) (forall ((item us_rep1)) (! (let ((result (find container item))) (and (=> (< 0 result) (and (<= result (length2 container)) (= (my_eq item (get container result)) true))) (dynamic_invariant result true false true))) :pattern ((find container item))))))
...
(define-fun default_initial_assumption1 ((temp___expr_691 us_rep3) (temp___skip_top_level_692 Bool)) Bool (=> (not (= temp___skip_top_level_692 true)) (= (is_empty temp___expr_691) true)))
...
(assert (forall ((container us_rep)) (! (let ((result (elements container))) (and (and (and (and (= (length2 result) (length container)) (forall ((temp___761 Int)) (=> (and (in_range5 temp___761) (= (iter_has_element result temp___761) true)) (= (contains (model__ container) (get result temp___761)) true)))) (forall ((item us_rep1)) (=> (= (contains (model__ container) item) true) (and (< 0 (find result item)) (= (my_eq (get result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (= (find result (get result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length container))) (=> (= (my_eq (get result i) (get result j)) true) (= i j)))))))) :pattern ((elements container)))))
...
(assert true)
(assert (forall ((container us_rep3)) (forall ((item us_rep1)) (! (=> (= (of_int 1) true) (=> (exists ((e us_rep1)) (and (= (contains container e) true) (= (my_eq e item) true))) (= (contains container item) true))) :pattern ((contains container item))))))
...
(assert (and (= o (length right)) (and (in_range1 o) (<= o (to_rep1 (rec__my_sets__n__set__capacity (us_split_discrs1 right)))))))
