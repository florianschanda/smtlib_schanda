...
(assert (forall ((container us_rep)) (! (let ((result (elements container))) (and (and (and (and (= (length1 result) (length container)) (forall ((temp___818 Int)) (=> (and (in_range5 temp___818) (= (iter_has_element result temp___818) true)) (= (contains (model__ container) (get result temp___818)) true)))) (forall ((item us_rep1)) (=> (= (contains (model__ container) item) true) (and (< 0 (find result item)) (= (my_eq (get result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (= (find result (get result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length container))) (=> (= (my_eq (get result i) (get result j)) true) (= i j)))))))) :pattern ((elements container)))))
...
(assert (and (= o (length right)) (and (in_range o) (<= o (to_rep1 (rec__my_sets__n__set__capacity (us_split_discrs1 right)))))))
