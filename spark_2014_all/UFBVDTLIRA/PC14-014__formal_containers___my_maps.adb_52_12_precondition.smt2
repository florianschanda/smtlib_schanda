...
(assert (not (or (= (has_key (positions (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) (mk___rep2 c__split_fields1)) true) (= (bool_eq2 (mk___rep2 c__split_fields1) no_element) true))))
(check-sat)
(exit)
