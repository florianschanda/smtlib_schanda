...
(assert (=> (and (<= 1 i1) (<= i1 amount)) (=> (< (- i1 1) 256) (= o (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) (- i1 1)))))))
(assert (=> (and (<= 1 i1) (<= i1 amount)) (=> (not (< (- i1 1) 256)) (= o ((_ int2bv 8) 0)))))
...
(assert (=> (and (<= 1 i1) (<= i1 amount)) (= (bvand result__3 (let ((temp___403 (- i2 1))) (ite (< temp___403 256) (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) temp___403)) ((_ int2bv 8) 0)))) (let ((temp___404 (- i2 1))) (ite (< temp___404 256) (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) temp___404)) ((_ int2bv 8) 0))))))
...
(assert (<= 1 i9))
(assert (<= i9 amount))
(assert (not (= (bvand bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma2__ones__result4 (let ((temp___411 (- i9 1))) (ite (< temp___411 256) (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) temp___411)) ((_ int2bv 8) 0)))) (let ((temp___412 (- i9 1))) (ite (< temp___412 256) (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) temp___412)) ((_ int2bv 8) 0))))))
(check-sat)
(exit)
