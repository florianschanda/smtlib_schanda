...
(declare-const temp___459 (_ BitVec 8))
...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 amount)) (= temp___460 i1)))
(assert (=> (and (<= 1 i1) (<= i1 amount)) (= temp___459 result__1)))
...
(assert (=> (and (<= 1 i1) (<= i1 amount)) (= (bvand result__3 (let ((temp___463 (- i2 1))) (ite (< temp___463 256) (bvshl #x01 ((_ int2bv 8) temp___463)) #x00))) (let ((temp___464 (- i2 1))) (ite (< temp___464 256) (bvshl #x01 ((_ int2bv 8) temp___464)) #x00)))))
