...
(declare-const bitwalker__peekbit64__result1 Bool)
(declare-const bitwalker__peekbit64__result2 Bool)
(declare-const bitwalker__peekbit64__result3 Bool)
(declare-const bitwalker__peekbit64__result4 Bool)
(declare-const bitwalker__peekbit64__result5 Bool)
(assert true)
(assert (in_range1 left))
(assert (< left 64))
(assert (= bitwalker__peekbit64__result1 bitwalker__peekbit64__result2))
(assert (= bitwalker__peekbit64__result3 bitwalker__peekbit64__result1))
(assert (and (= o (- 63 left)) (in_range1 (- 63 left))))
(assert (= o1 ((_ int2bv 64) o)))
(assert (= o2 (bvshl ((_ int2bv 64) 1) o1)))
(assert (= o3 (bvand value o2)))
(assert (= o4 (ite (= o3 ((_ int2bv 64) 0)) true false)))
(assert (= o5 (ite (not (= o4 true)) true false)))
(assert (= (mk_bool__ref result) (mk_bool__ref bitwalker__peekbit64__result)))
(assert (= bitwalker__peekbit64__result1 o5))
(assert (= (mk_bool__ref bitwalker__peekbit64__result4) (mk_bool__ref bitwalker__peekbit64__result2)))
(assert (= bitwalker__peekbit64__result5 bitwalker__peekbit64__result3))
(assert (and (= o6 (- 63 left)) (in_range1 (- 63 left))))
(assert (not true))
(check-sat)
(exit)
