...
(assert (= bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__result1 bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__result2))
(assert (= bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__result3 bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__result1))
(assert (= o (lemma2_goal Tuple0)))
(assert (= result1 bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__result))
(assert (= bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__result1 o))
(assert (= (mk_bool__ref bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__result4) (mk_bool__ref bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__result2)))
(assert (= (mk_int__ref i7) i9))
(assert (= bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__result5 bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__result3))
(assert (= i8 i6))
(assert (= result2 bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__result4))
