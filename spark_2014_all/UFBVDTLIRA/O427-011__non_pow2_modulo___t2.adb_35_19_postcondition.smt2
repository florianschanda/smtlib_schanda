...
(declare-sort m 0)
(define-fun in_range ((x (_ BitVec 8))) Bool (and (bvule ((_ int2bv 8) 0) x) (bvule x ((_ int2bv 8) 229))))
...
(define-fun dynamic_invariant ((temp___expr_177 (_ BitVec 8)) (temp___is_init_174 Bool) (temp___skip_constant_175 Bool) (temp___do_toplevel_176 Bool)) Bool (=> (or (= temp___is_init_174 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 229))) (in_range temp___expr_177)))
(declare-const x (_ BitVec 8))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const y (_ BitVec 8))
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const t2__mmul__result (_ BitVec 8))
(declare-const result (_ BitVec 8))
(declare-const t2__mmul__result1 (_ BitVec 8))
(declare-const t2__mmul__result2 (_ BitVec 8))
(declare-const t2__mmul__result3 (_ BitVec 8))
(declare-const t2__mmul__result4 (_ BitVec 8))
(declare-const t2__mmul__result5 (_ BitVec 8))
(declare-const result1 (_ BitVec 8))
(assert (in_range x))
(assert (in_range y))
(assert (= t2__mmul__result1 t2__mmul__result2))
(assert (= t2__mmul__result3 t2__mmul__result1))
(assert (= (mk_t__ref result) (mk_t__ref t2__mmul__result)))
(assert (= t2__mmul__result1 ((_ extract 7 0) (bvurem (bvmul ((_ zero_extend 8) x) ((_ zero_extend 8) y)) ((_ int2bv 16) 230)))))
(assert (= (mk_t__ref t2__mmul__result4) (mk_t__ref t2__mmul__result2)))
(assert (= t2__mmul__result5 t2__mmul__result3))
(assert (= result1 t2__mmul__result4))
(assert (not (= ((_ zero_extend 56) t2__mmul__result4) (bvurem (bvurem (bvmul ((_ zero_extend 56) x) ((_ zero_extend 56) y)) ((_ int2bv 64) 65536)) ((_ int2bv 64) 230)))))
(check-sat)
(exit)
