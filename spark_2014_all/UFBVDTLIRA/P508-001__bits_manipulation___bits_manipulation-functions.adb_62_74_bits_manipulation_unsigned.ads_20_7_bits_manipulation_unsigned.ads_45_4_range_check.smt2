...
(assert (= result1 (ite (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_not_inline__result4 o7) true false)))
(assert (= result1 true))
...
(assert (= result2 (ite (bvule bits_manipulation_unsigned__unsigned_64__functions__extract_bits_not_inline__result4 o3) true false)))
(assert (= result2 true))
