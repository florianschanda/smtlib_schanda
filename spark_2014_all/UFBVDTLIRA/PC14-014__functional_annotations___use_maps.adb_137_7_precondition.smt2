...
(assert (forall ((container us_rep1)) (forall ((key Int)) (! (=> (dynamic_invariant1 key true true true true) (=> (= (distinct 1 0) true) (=> (exists ((k Int)) (and (and (in_range3 k) (= (has_key container k) true)) (= k key))) (= (has_key container key) true)))) :pattern ((has_key container key))))))
...
(assert (forall ((container us_rep1)) (forall ((key Int)) (! (=> (and (dynamic_invariant1 key true true true true) (= (has_key container key) true)) (let ((result (get container key))) (and (=> (= (distinct 1 0) true) (and (= result (w_get container (witness container key))) (forall ((k Int)) (=> (and (in_range3 k) (= (has_key container k) true)) (= (= k key) (= (witness container key) (witness container k))))))) (dynamic_invariant2 result true false true true)))) :pattern ((get container key))))))
...
(define-fun dynamic_invariant6 ((temp___expr_353 Int) (temp___is_init_349 Bool) (temp___skip_constant_350 Bool) (temp___do_toplevel_351 Bool) (temp___do_typ_inv_352 Bool)) Bool (=> (or (= temp___is_init_349 true) (<= (- 2147483648) 2147483647)) (in_range8 temp___expr_353)))
...
(assert (forall ((container us_rep2)) (forall ((key2 Int)) (! (=> (dynamic_invariant5 key2 true true true true) (let ((result (find container key2))) (and (=> (< 0 result) (and (<= result (length3 container)) (= key2 (get1 container result)))) (dynamic_invariant result true false true true)))) :pattern ((find container key2))))))
...
(assert (forall ((attr__tag Int)) (forall ((container us_rep)) (forall ((position us_rep3)) (! (dynamic_invariant5 (key1 attr__tag container position) true false true true) :pattern ((key1 attr__tag container position)))))))
(assert (forall ((container us_rep)) (forall ((key2 Int)) (! (=> (dynamic_invariant5 key2 true true true true) (let ((result (find1 container key2))) (ite (not (= (has_key (model__ container) key2) true)) (= (bool_eq3 result no_element) true) (and (and (= (has_key1 (positions container) result) true) (= (get2 (positions container) result) (find (keys container) key2))) (= (key container result) key2))))) :pattern ((find1 container key2))))))
(assert true)
(assert true)
(assert true)
...
(assert (forall ((left us_rep1) (right us_rep1)) (forall ((new_key Int)) (! (=> (dynamic_invariant1 new_key true true true true) (= (= (keys_included_except left right new_key) true) (forall ((key2 Int)) (=> (and (in_range3 key2) (= (has_key left key2) true)) (=> (not (= key2 new_key)) (= (has_key right key2) true)))))) :pattern ((keys_included_except left right new_key))))))
(declare-fun has_witness (us_rep1 Int) Bool)
(declare-fun has_witness__function_guard (Bool us_rep1 Int) Bool)
(assert true)
(assert (forall ((container us_rep1)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant1 key2 true true true true) (= (has_key container key2) true)) (let ((result (witness container key2))) (and (= (has_witness container result) true) (dynamic_invariant result true false true true)))) :pattern ((witness container key2))))))
...
(assert (forall ((container us_rep4)) (forall ((key2 us_rep3)) (! (=> (= (distinct 0 0) true) (=> (exists ((k us_rep3)) (and (= (has_key1 container k) true) (= (bool_eq3 k key2) true))) (= (has_key1 container key2) true))) :pattern ((has_key1 container key2))))))
...
(define-fun dynamic_invariant8 ((temp___expr_452 Int) (temp___is_init_448 Bool) (temp___skip_constant_449 Bool) (temp___do_toplevel_450 Bool) (temp___do_typ_inv_451 Bool)) Bool (=> (or (= temp___is_init_448 true) (<= 1 2147483647)) (in_range9 temp___expr_452)))
...
(assert (forall ((container us_rep4)) (forall ((key2 us_rep3)) (! (=> (= (has_key1 container key2) true) (let ((result (get2 container key2))) (and (=> (= (distinct 0 0) true) (and (= result (w_get1 container (witness1 container key2))) (forall ((k us_rep3)) (=> (= (has_key1 container k) true) (= (= (bool_eq3 k key2) true) (= (witness1 container key2) (witness1 container k))))))) (dynamic_invariant8 result true false true true)))) :pattern ((get2 container key2))))))
...
(assert true)
(assert (forall ((container us_rep4)) (forall ((key2 us_rep3)) (! (=> (= (has_key1 container key2) true) (let ((result (witness1 container key2))) (and (= (has_witness1 container result) true) (dynamic_invariant result true false true true)))) :pattern ((witness1 container key2))))))
...
(define-fun m__split_fields4 () us_split_fields (mk___split_fields m__split_fields3))
(define-fun m__split_fields5 () us_split_fields (mk___split_fields m__split_fields2))
(define-fun m__split_fields6 () us_split_fields (mk___split_fields m__split_fields1))
(assert (and (< (length (mk___rep m__split_discrs (mk___split_fields m__split_fields))) (- (to_rep (rec__use_maps__my_maps__map__capacity m__split_discrs)) 5)) (let ((temp___997 (keys (mk___rep m__split_discrs (mk___split_fields m__split_fields))))) (forall ((temp___996 Int)) (=> (and (in_range5 temp___996) (= (iter_has_element temp___997 temp___996) true)) (< 5 (get1 temp___997 temp___996)))))))
(assert (and (and (and (and (and (and (and (= (length (mk___rep m__split_discrs m__split_fields6)) (+ (length (mk___rep m__split_discrs (mk___split_fields m__split_fields))) 1)) (= (has_key (model__ (mk___rep m__split_discrs m__split_fields6)) 1) true)) (= (key (mk___rep m__split_discrs m__split_fields6) (find1 (mk___rep m__split_discrs m__split_fields6) 1)) 1)) (= (get (model__ (mk___rep m__split_discrs m__split_fields6)) 1) 0)) (= (ole (model__ (mk___rep m__split_discrs (mk___split_fields m__split_fields))) (model__ (mk___rep m__split_discrs m__split_fields6))) true)) (= (keys_included_except (model__ (mk___rep m__split_discrs m__split_fields6)) (model__ (mk___rep m__split_discrs (mk___split_fields m__split_fields))) 1) true)) (= (mapping_preserved (keys (mk___rep m__split_discrs (mk___split_fields m__split_fields))) (keys (mk___rep m__split_discrs m__split_fields6)) (positions (mk___rep m__split_discrs (mk___split_fields m__split_fields))) (positions (mk___rep m__split_discrs m__split_fields6))) true)) (= (keys_included_except1 (positions (mk___rep m__split_discrs m__split_fields6)) (positions (mk___rep m__split_discrs (mk___split_fields m__split_fields))) (find1 (mk___rep m__split_discrs m__split_fields6) 1)) true)))
(assert (and (and (and (and (and (and (and (= (length (mk___rep m__split_discrs m__split_fields5)) (+ (length (mk___rep m__split_discrs m__split_fields6)) 1)) (= (has_key (model__ (mk___rep m__split_discrs m__split_fields5)) 2) true)) (= (key (mk___rep m__split_discrs m__split_fields5) (find1 (mk___rep m__split_discrs m__split_fields5) 2)) 2)) (= (get (model__ (mk___rep m__split_discrs m__split_fields5)) 2) 0)) (= (ole (model__ (mk___rep m__split_discrs m__split_fields6)) (model__ (mk___rep m__split_discrs m__split_fields5))) true)) (= (keys_included_except (model__ (mk___rep m__split_discrs m__split_fields5)) (model__ (mk___rep m__split_discrs m__split_fields6)) 2) true)) (= (mapping_preserved (keys (mk___rep m__split_discrs m__split_fields6)) (keys (mk___rep m__split_discrs m__split_fields5)) (positions (mk___rep m__split_discrs m__split_fields6)) (positions (mk___rep m__split_discrs m__split_fields5))) true)) (= (keys_included_except1 (positions (mk___rep m__split_discrs m__split_fields5)) (positions (mk___rep m__split_discrs m__split_fields6)) (find1 (mk___rep m__split_discrs m__split_fields5) 2)) true)))
(assert (and (and (and (and (and (and (and (= (length (mk___rep m__split_discrs m__split_fields4)) (+ (length (mk___rep m__split_discrs m__split_fields5)) 1)) (= (has_key (model__ (mk___rep m__split_discrs m__split_fields4)) 3) true)) (= (key (mk___rep m__split_discrs m__split_fields4) (find1 (mk___rep m__split_discrs m__split_fields4) 3)) 3)) (= (get (model__ (mk___rep m__split_discrs m__split_fields4)) 3) 0)) (= (ole (model__ (mk___rep m__split_discrs m__split_fields5)) (model__ (mk___rep m__split_discrs m__split_fields4))) true)) (= (keys_included_except (model__ (mk___rep m__split_discrs m__split_fields4)) (model__ (mk___rep m__split_discrs m__split_fields5)) 3) true)) (= (mapping_preserved (keys (mk___rep m__split_discrs m__split_fields5)) (keys (mk___rep m__split_discrs m__split_fields4)) (positions (mk___rep m__split_discrs m__split_fields5)) (positions (mk___rep m__split_discrs m__split_fields4))) true)) (= (keys_included_except1 (positions (mk___rep m__split_discrs m__split_fields4)) (positions (mk___rep m__split_discrs m__split_fields5)) (find1 (mk___rep m__split_discrs m__split_fields4) 3)) true)))
(assert (not (< (length (mk___rep m__split_discrs m__split_fields4)) (to_rep (rec__use_maps__my_maps__map__capacity m__split_discrs)))))
(check-sat)
(exit)
