...
(assert (forall ((x86__rdx (_ BitVec 64))) (! (=> (dynamic_invariant x86__rdx true true true) (let ((result (dh x86__rdx))) (and (= result ((_ extract 7 0) (bvurem (bvudiv (bvand x86__rdx ((_ int2bv 64) 65280)) ((_ int2bv 64) 256)) ((_ int2bv 64) 256)))) (dynamic_invariant1 result true false true)))) :pattern ((dh x86__rdx)))))
