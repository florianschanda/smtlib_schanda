...
(define-fun temp___937 () us_rep3 (keys (mk___rep s1__split_discrs (us_split_fields__content s1__split_fields8))))
(declare-const temp___936 Int)
(assert (in_range5 temp___936))
(assert (= (iter_has_element temp___937 temp___936) true))
(assert (not (= (prop__ (get (model__ (mk___rep s1__split_discrs (us_split_fields__content s1__split_fields8))) (get1 temp___937 temp___936))) true)))
(check-sat)
(exit)
