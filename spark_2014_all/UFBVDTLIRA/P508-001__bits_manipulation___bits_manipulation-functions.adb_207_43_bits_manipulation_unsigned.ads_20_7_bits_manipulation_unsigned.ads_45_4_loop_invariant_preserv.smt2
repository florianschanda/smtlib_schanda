...
(assert (<= 1 i1))
(assert (<= i1 amount))
(assert (=> (< (- i1 1) 18446744073709551616) (= o (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) (- i1 1))))))
(assert (=> (not (< (- i1 1) 18446744073709551616)) (= o ((_ int2bv 64) 0))))
(assert (= o1 (bvadd result__1 o)))
(assert (= result__1 result2))
(assert (= result__2 o1))
(assert (= (bvand result__3 (let ((temp___490 (- i2 1))) (ite (< temp___490 18446744073709551616) (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) temp___490)) ((_ int2bv 64) 0)))) (let ((temp___491 (- i2 1))) (ite (< temp___491 18446744073709551616) (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) temp___491)) ((_ int2bv 64) 0)))))
(assert (and (=> (<= 1 amount) (dynamic_property 1 amount i2)) (and (<= 1 i2) (<= i2 amount))))
(assert (not (= i2 amount)))
(assert (= result3 i2))
(assert (= i3 (+ i2 1)))
(assert (=> (< (- i3 1) 18446744073709551616) (= o2 (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) (- i3 1))))))
(assert (=> (not (< (- i3 1) 18446744073709551616)) (= o2 ((_ int2bv 64) 0))))
(assert (= o3 (bvadd result__3 o2)))
(assert (= result4 result__3))
(assert (= result__4 o3))
(assert (not (= (bvand result__4 (let ((temp___490 (- i3 1))) (ite (< temp___490 18446744073709551616) (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) temp___490)) ((_ int2bv 64) 0)))) (let ((temp___491 (- i3 1))) (ite (< temp___491 18446744073709551616) (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) temp___491)) ((_ int2bv 64) 0))))))
(check-sat)
(exit)
