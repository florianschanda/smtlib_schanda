...
(assert (= result__2 o1))
(assert (= (bvand result__3 (let ((temp___550 (- i2 1))) (ite (< temp___550 18446744073709551616) (bvshl #x0000000000000001 ((_ int2bv 64) temp___550)) #x0000000000000000))) (let ((temp___551 (- i2 1))) (ite (< temp___551 18446744073709551616) (bvshl #x0000000000000001 ((_ int2bv 64) temp___551)) #x0000000000000000))))
...
(assert (= result__4 o3))
(assert (not (= (bvand result__4 (let ((temp___550 (- i3 1))) (ite (< temp___550 18446744073709551616) (bvshl #x0000000000000001 ((_ int2bv 64) temp___550)) #x0000000000000000))) (let ((temp___551 (- i3 1))) (ite (< temp___551 18446744073709551616) (bvshl #x0000000000000001 ((_ int2bv 64) temp___551)) #x0000000000000000)))))
(check-sat)
(exit)
