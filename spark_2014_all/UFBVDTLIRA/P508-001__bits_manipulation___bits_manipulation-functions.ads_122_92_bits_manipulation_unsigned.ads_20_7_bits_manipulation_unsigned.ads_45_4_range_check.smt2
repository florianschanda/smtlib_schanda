...
(define-fun dynamic_invariant2 ((temp___expr_363 Int) (temp___is_init_360 Bool) (temp___skip_constant_361 Bool) (temp___do_toplevel_362 Bool)) Bool (=> (or (= temp___is_init_360 true) (<= 1 64)) (in_range1 temp___expr_363)))
...
(assert (forall ((num_bits Int)) (! (=> (dynamic_invariant2 num_bits true true true) (= (make_mask num_bits) (shift_right ((_ int2bv 64) 18446744073709551615) (- 64 num_bits)))) :pattern ((make_mask num_bits)))))
