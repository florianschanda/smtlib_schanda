...
(define-fun in_range1 ((x (_ BitVec 8))) Bool (and (bvule ((_ int2bv 8) 0) x) (bvule x ((_ int2bv 8) 63))))
...
(define-fun dynamic_invariant ((temp___expr_233 (_ BitVec 8)) (temp___is_init_230 Bool) (temp___skip_constant_231 Bool) (temp___do_toplevel_232 Bool)) Bool (=> (or (= temp___is_init_230 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 63))) (in_range1 temp___expr_233)))
...
(define-fun dynamic_invariant1 ((temp___expr_287 (_ BitVec 16)) (temp___is_init_284 Bool) (temp___skip_constant_285 Bool) (temp___do_toplevel_286 Bool)) Bool (=> (or (= temp___is_init_284 true) (bvule ((_ int2bv 16) 0) ((_ int2bv 16) 32767))) (in_range2 temp___expr_287)))
...
(assert (= register_id ((_ int2bv 8) 46)))
(assert (= sub_register ((_ int2bv 16) 4098)))
