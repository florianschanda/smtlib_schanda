...
(define-fun dynamic_invariant ((temp___expr_177 (_ BitVec 8)) (temp___is_init_173 Bool) (temp___skip_constant_174 Bool) (temp___do_toplevel_175 Bool) (temp___do_typ_inv_176 Bool)) Bool (=> (or (= temp___is_init_173 true) (bvule #x00 #x0F)) (in_range1 temp___expr_177)))
...
(define-fun dynamic_invariant1 ((temp___expr_184 Int) (temp___is_init_180 Bool) (temp___skip_constant_181 Bool) (temp___do_toplevel_182 Bool) (temp___do_typ_inv_183 Bool)) Bool (=> (or (= temp___is_init_180 true) (<= 0 3)) (in_range2 temp___expr_184)))
...
(define-fun dynamic_invariant2 ((temp___expr_191 Int) (temp___is_init_187 Bool) (temp___skip_constant_188 Bool) (temp___do_toplevel_189 Bool) (temp___do_typ_inv_190 Bool)) Bool (=> (or (= temp___is_init_187 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_191)))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-fun get_internal_state (Int) Int)
(declare-fun get_internal_state__function_guard (Int Int) Bool)
(assert (forall ((achiever__my_internal_state Int)) (! (=> (dynamic_invariant2 achiever__my_internal_state true true true true) (dynamic_invariant2 (get_internal_state achiever__my_internal_state) true false true true)) :pattern ((get_internal_state achiever__my_internal_state)))))
(assert (forall ((achiever__my_internal_state Int)) (! (=> (dynamic_invariant2 achiever__my_internal_state true true true true) (= (get_internal_state achiever__my_internal_state) achiever__my_internal_state)) :pattern ((get_internal_state achiever__my_internal_state)))))
...
(assert (not (<= (+ (+ 0 (ite (ite (= (read (get_state_item (mk___split_fields1 (mk___rep (mk___split_fields state_item__split_fields state_item__split_fields1))))) false) true false) 1 0)) (ite (= (read (get_state_item (mk___split_fields1 (mk___rep (mk___split_fields state_item__split_fields state_item__split_fields1))))) true) 1 0)) 1)))
(check-sat)
(exit)
