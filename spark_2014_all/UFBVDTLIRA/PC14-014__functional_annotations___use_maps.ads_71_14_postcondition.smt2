...
(define-fun dynamic_invariant ((temp___expr_386 Int) (temp___is_init_382 Bool) (temp___skip_constant_383 Bool) (temp___do_toplevel_384 Bool) (temp___do_typ_inv_385 Bool)) Bool (=> (or (= temp___is_init_382 true) (<= 1 2147483647)) (in_range2 temp___expr_386)))
...
(define-fun default_initial_assumption ((temp___expr_401 us_rep2) (temp___skip_top_level_402 Bool)) Bool (=> (not (= temp___skip_top_level_402 true)) (and (= (is_empty temp___expr_401) true) (= (length temp___expr_401) 0))))
(assert (forall ((container us_rep2)) (forall ((key Int)) (! (=> (dynamic_invariant key true true true true) (=> (= (distinct 1 0) true) (=> (exists ((k Int)) (and (and (in_range2 k) (= (has_key container k) true)) (= k key))) (= (has_key container key) true)))) :pattern ((has_key container key))))))
...
(define-fun dynamic_invariant1 ((temp___expr_422 Int) (temp___is_init_418 Bool) (temp___skip_constant_419 Bool) (temp___do_toplevel_420 Bool) (temp___do_typ_inv_421 Bool)) Bool (=> (or (= temp___is_init_418 true) (<= 1 2147483647)) (in_range4 temp___expr_422)))
(define-fun dynamic_invariant2 ((temp___expr_429 Int) (temp___is_init_425 Bool) (temp___skip_constant_426 Bool) (temp___do_toplevel_427 Bool) (temp___do_typ_inv_428 Bool)) Bool (=> (or (= temp___is_init_425 true) (<= 0 2147483647)) (in_range3 temp___expr_429)))
...
(define-fun default_initial_assumption1 ((temp___expr_437 us_rep3) (temp___skip_top_level_438 Bool)) Bool (=> (not (= temp___skip_top_level_438 true)) (= (length1 temp___expr_437) 0)))
...
(define-fun dynamic_invariant3 ((temp___expr_452 Int) (temp___is_init_448 Bool) (temp___skip_constant_449 Bool) (temp___do_toplevel_450 Bool) (temp___do_typ_inv_451 Bool)) Bool (=> (or (= temp___is_init_448 true) (<= 1 2147483647)) (in_range5 temp___expr_452)))
...
(define-fun default_initial_assumption2 ((temp___expr_460 us_rep4) (temp___skip_top_level_461 Bool)) Bool (=> (not (= temp___skip_top_level_461 true)) (and (= (is_empty1 temp___expr_460) true) (= (length2 temp___expr_460) 0))))
...
(assert (forall ((container us_rep)) (! (let ((result (keys container))) (and (and (and (and (= (length1 result) (length3 container)) (forall ((temp___478 Int)) (=> (and (in_range3 temp___478) (= (iter_has_element result temp___478) true)) (= (has_key (model__ container) (get result temp___478)) true)))) (forall ((key Int)) (=> (and (in_range2 key) (= (has_key (model__ container) key) true)) (and (< 0 (find result key)) (= (get result (find result key)) key))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length3 container))) (= (find result (get result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length3 container))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length3 container))) (=> (= (get result i) (get result j)) (= i j)))))))) :pattern ((keys container)))))
...
(define-fun dynamic_invariant4 ((temp___expr_346 Int) (temp___is_init_342 Bool) (temp___skip_constant_343 Bool) (temp___do_toplevel_344 Bool) (temp___do_typ_inv_345 Bool)) Bool (=> (or (= temp___is_init_342 true) (<= 1 2147483647)) (in_range6 temp___expr_346)))
...
(define-fun dynamic_invariant6 ((temp___expr_197 Int) (temp___is_init_193 Bool) (temp___skip_constant_194 Bool) (temp___do_toplevel_195 Bool) (temp___do_typ_inv_196 Bool)) Bool (=> (or (= temp___is_init_193 true) (<= 0 2147483647)) (in_range1 temp___expr_197)))
(assert (= no_element (mk___rep1 (mk___split_fields1 (of_rep1 0)))))
(assert (forall ((container us_rep)) (! (let ((result (length3 container))) (and (<= result (to_rep1 (rec__use_maps__my_maps__map__capacity (us_split_discrs1 container)))) (dynamic_invariant6 result true false true true))) :pattern ((length3 container)))))
...
(assert (forall ((container us_rep3)) (forall ((key2 Int)) (! (=> (dynamic_invariant4 key2 true true true true) (let ((result (find container key2))) (and (=> (< 0 result) (and (<= result (length1 container)) (= key2 (get container result)))) (dynamic_invariant6 result true false true true)))) :pattern ((find container key2))))))
...
(define-fun dynamic_invariant7 ((temp___expr_393 Int) (temp___is_init_389 Bool) (temp___skip_constant_390 Bool) (temp___do_toplevel_391 Bool) (temp___do_typ_inv_392 Bool)) Bool (=> (or (= temp___is_init_389 true) (<= (- 2147483648) 2147483647)) (in_range7 temp___expr_393)))
...
(assert (forall ((container us_rep2)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant key2 true true true true) (= (has_key container key2) true)) (let ((result (get2 container key2))) (and (=> (= (distinct 1 0) true) (and (= result (w_get1 container (witness1 container key2))) (forall ((k Int)) (=> (and (in_range2 k) (= (has_key container k) true)) (= (= k key2) (= (witness1 container key2) (witness1 container k))))))) (dynamic_invariant7 result true false true true)))) :pattern ((get2 container key2))))))
...
(assert true)
(assert (forall ((container us_rep2)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant key2 true true true true) (= (has_key container key2) true)) (let ((result (witness1 container key2))) (and (= (has_witness container result) true) (dynamic_invariant6 result true false true true)))) :pattern ((witness1 container key2))))))
...
(assert (forall ((container us_rep4)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant6 witness2 true true true true) (= (has_witness1 container witness2) true)) (dynamic_invariant3 (w_get container witness2) true false true true)) :pattern ((w_get container witness2))))))
...
(declare-const temp___936 count_type)
(declare-const o Int)
(declare-const temp___935 count_type)
...
(define-fun cu__split_fields12 () us_split_fields2 (mk___split_fields1 cu__split_fields3))
(define-fun cu__split_fields13 () us_split_fields2 (mk___split_fields1 cu__split_fields2))
(define-fun cu__split_fields14 () us_split_fields2 (mk___split_fields1 cu__split_fields1))
(define-fun temp___9351 () us_rep1 (mk___rep1 (mk___split_fields1 temp___935)))
(define-fun use_maps__are_disjoint__cu__assume1 () us_rep1 (mk___rep1 (mk___split_fields1 use_maps__are_disjoint__cu__assume)))
(declare-const result7 Bool)
(assert (and (= use_maps__are_disjoint__cu__assume1 (first s1)) (ite (= (= (length3 s1) 0) true) (= (bool_eq1 use_maps__are_disjoint__cu__assume1 no_element) true) (and (= (has_key1 (positions s1) use_maps__are_disjoint__cu__assume1) true) (= (get1 (positions s1) use_maps__are_disjoint__cu__assume1) 1)))))
...
(assert (or (and (and (and (= use_maps__are_disjoint__result11 (mk_bool__ref use_maps__are_disjoint__result3)) (= cu__split_fields8 (mk___split_fields__ref1 cu__split_fields13))) (and (= use_maps__are_disjoint__result12 use_maps__are_disjoint__result3) (= cu__split_fields9 cu__split_fields13))) (and (and (= result1 (has_key1 (positions s1) (mk___rep1 cu__split_fields14))) (= (= result1 true) (= (has_key1 (positions s1) (mk___rep1 cu__split_fields14)) true))) (and (= result1 true) (and (= temp___936 cu__split_fields1) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions s1) (mk___rep1 cu__split_fields13)) 1))) (not (= (has_key (model__ s2) (get (keys s1) i)) true)))) (and (= (has_key1 (positions s1) (mk___rep1 cu__split_fields13)) true) (and (and (and (= o (key s1 (mk___rep1 cu__split_fields13))) (and (in_range6 o) (= o (get (keys s1) (get1 (positions s1) (mk___rep1 cu__split_fields13)))))) (and (= result2 (has_key (model__ s2) o)) (= (= result2 true) (= (has_key (model__ s2) o) true)))) (and (= result2 true) (and (= use_maps__are_disjoint__result2 result3) (= use_maps__are_disjoint__result3 (distinct 0 0))))))))))) (and (and (and (= result1 (has_key1 (positions s1) (mk___rep1 cu__split_fields14))) (= (= result1 true) (= (has_key1 (positions s1) (mk___rep1 cu__split_fields14)) true))) (ite (= result1 true) (and (and (and (= temp___936 cu__split_fields1) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions s1) (mk___rep1 cu__split_fields13)) 1))) (not (= (has_key (model__ s2) (get (keys s1) i)) true)))) (and (= (has_key1 (positions s1) (mk___rep1 cu__split_fields13)) true) (and (and (and (and (= o (key s1 (mk___rep1 cu__split_fields13))) (and (in_range6 o) (= o (get (keys s1) (get1 (positions s1) (mk___rep1 cu__split_fields13)))))) (and (= result2 (has_key (model__ s2) o)) (= (= result2 true) (= (has_key (model__ s2) o) true)))) (and (not (= result2 true)) (= use_maps__are_disjoint__result3 use_maps__are_disjoint__result2))) (and (and (and (= temp___9351 (next s1 (mk___rep1 cu__split_fields13))) (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields13) no_element) false) (= (get1 (positions s1) (mk___rep1 cu__split_fields13)) (length3 s1)) true) true) (= (bool_eq1 temp___9351 no_element) true) (and (= (has_key1 (positions s1) temp___9351) true) (= (get1 (positions s1) temp___9351) (+ (get1 (positions s1) (mk___rep1 cu__split_fields13)) 1))))) (and (= result4 cu__split_fields2) (= temp___935 cu__split_fields3))) (and (and (and (= o1 (has_key1 (positions s1) (mk___rep1 cu__split_fields12))) (= (= o1 true) (= (has_key1 (positions s1) (mk___rep1 cu__split_fields12)) true))) (= result5 (ite (not (= o1 true)) true false))) (= result5 true))))))) (and (and (= use_maps__are_disjoint__result4 (mk_bool__ref use_maps__are_disjoint__result3)) (= cu__split_fields4 (mk___split_fields__ref1 cu__split_fields12))) (and (= use_maps__are_disjoint__result5 use_maps__are_disjoint__result3) (= cu__split_fields5 cu__split_fields12)))) (and (and (= use_maps__are_disjoint__result6 use_maps__are_disjoint__result4) (= cu__split_fields6 cu__split_fields4)) (and (= use_maps__are_disjoint__result7 use_maps__are_disjoint__result5) (= cu__split_fields7 cu__split_fields5)))) (and (and (= use_maps__are_disjoint__result6 (mk_bool__ref use_maps__are_disjoint__result)) (= cu__split_fields6 (mk___split_fields__ref1 cu__split_fields14))) (and (= use_maps__are_disjoint__result7 use_maps__are_disjoint__result1) (= cu__split_fields7 cu__split_fields14))))) (and (and (and (= use_maps__are_disjoint__result11 use_maps__are_disjoint__result9) (= cu__split_fields8 cu__split_fields6)) (and (= use_maps__are_disjoint__result12 use_maps__are_disjoint__result10) (= cu__split_fields9 cu__split_fields7))) (and (and (= use_maps__are_disjoint__result9 (mk_bool__ref use_maps__are_disjoint__result8)) (= use_maps__are_disjoint__result10 use_maps__are_disjoint__result8)) (and (= result6 use_maps__are_disjoint__result6) (= use_maps__are_disjoint__result8 (distinct 1 0))))))))
(assert (= use_maps__are_disjoint__result13 use_maps__are_disjoint__result11))
(assert (= cu__split_fields10 cu__split_fields8))
(assert (= use_maps__are_disjoint__result14 use_maps__are_disjoint__result12))
...
(define-fun temp___946 () us_rep3 (keys s2))
(declare-const temp___945 Int)
(assert (in_range3 temp___945))
(assert (= (iter_has_element temp___946 temp___945) true))
(assert (not (not (= (has_key (model__ s1) (get temp___946 temp___945)) true))))
(check-sat)
(exit)
