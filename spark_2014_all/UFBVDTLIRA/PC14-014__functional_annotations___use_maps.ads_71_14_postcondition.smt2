...
(define-fun dynamic_invariant ((temp___expr_354 Int) (temp___is_init_351 Bool) (temp___skip_constant_352 Bool) (temp___do_toplevel_353 Bool)) Bool (=> (or (= temp___is_init_351 true) (<= 1 2147483647)) (in_range2 temp___expr_354)))
...
(define-fun default_initial_assumption ((temp___expr_367 us_rep2) (temp___skip_top_level_368 Bool)) Bool (=> (not (= temp___skip_top_level_368 true)) (and (= (is_empty temp___expr_367) true) (= (length temp___expr_367) 0))))
(assert (forall ((container us_rep2)) (forall ((key Int)) (! (=> (dynamic_invariant key true true true) (=> (= (of_int 1) true) (=> (exists ((k Int)) (and (and (in_range2 k) (= (has_key container k) true)) (= k key))) (= (has_key container key) true)))) :pattern ((has_key container key))))))
...
(define-fun dynamic_invariant1 ((temp___expr_385 Int) (temp___is_init_382 Bool) (temp___skip_constant_383 Bool) (temp___do_toplevel_384 Bool)) Bool (=> (or (= temp___is_init_382 true) (<= 1 2147483647)) (in_range4 temp___expr_385)))
(define-fun dynamic_invariant2 ((temp___expr_391 Int) (temp___is_init_388 Bool) (temp___skip_constant_389 Bool) (temp___do_toplevel_390 Bool)) Bool (=> (or (= temp___is_init_388 true) (<= 0 2147483647)) (in_range3 temp___expr_391)))
...
(define-fun default_initial_assumption1 ((temp___expr_398 us_rep3) (temp___skip_top_level_399 Bool)) Bool (=> (not (= temp___skip_top_level_399 true)) (= (length1 temp___expr_398) 0)))
...
(define-fun dynamic_invariant3 ((temp___expr_411 Int) (temp___is_init_408 Bool) (temp___skip_constant_409 Bool) (temp___do_toplevel_410 Bool)) Bool (=> (or (= temp___is_init_408 true) (<= 1 2147483647)) (in_range5 temp___expr_411)))
...
(define-fun default_initial_assumption2 ((temp___expr_418 us_rep4) (temp___skip_top_level_419 Bool)) Bool (=> (not (= temp___skip_top_level_419 true)) (and (= (is_empty1 temp___expr_418) true) (= (length2 temp___expr_418) 0))))
...
(assert (forall ((container us_rep)) (! (let ((result (keys container))) (and (and (and (and (= (length1 result) (length3 container)) (forall ((temp___435 Int)) (=> (and (in_range3 temp___435) (= (iter_has_element result temp___435) true)) (= (has_key (model__ container) (get result temp___435)) true)))) (forall ((key Int)) (=> (and (in_range2 key) (= (has_key (model__ container) key) true)) (and (< 0 (find result key)) (= (get result (find result key)) key))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length3 container))) (= (find result (get result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length3 container))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length3 container))) (=> (= (get result i) (get result j)) (= i j)))))))) :pattern ((keys container)))))
...
(define-fun dynamic_invariant4 ((temp___expr_319 Int) (temp___is_init_316 Bool) (temp___skip_constant_317 Bool) (temp___do_toplevel_318 Bool)) Bool (=> (or (= temp___is_init_316 true) (<= 1 2147483647)) (in_range6 temp___expr_319)))
...
(assert (forall ((attr__tag Int)) (forall ((container us_rep)) (forall ((position us_rep1)) (! (dynamic_invariant4 (key1 attr__tag container position) true false true) :pattern ((key1 attr__tag container position)))))))
...
(define-fun dynamic_invariant6 ((temp___expr_173 Int) (temp___is_init_170 Bool) (temp___skip_constant_171 Bool) (temp___do_toplevel_172 Bool)) Bool (=> (or (= temp___is_init_170 true) (<= 0 2147483647)) (in_range1 temp___expr_173)))
(assert (= no_element (mk___rep1 (mk___split_fields1 (of_rep1 0)))))
(assert (forall ((container us_rep)) (! (let ((result (length3 container))) (and (<= result (to_rep1 (rec__use_maps__my_maps__map__capacity (us_split_discrs1 container)))) (dynamic_invariant6 result true false true))) :pattern ((length3 container)))))
...
(assert (forall ((container us_rep3)) (forall ((key2 Int)) (! (=> (dynamic_invariant4 key2 true true true) (let ((result (find container key2))) (and (=> (< 0 result) (and (<= result (length1 container)) (= key2 (get container result)))) (dynamic_invariant6 result true false true)))) :pattern ((find container key2))))))
...
(define-fun dynamic_invariant7 ((temp___expr_360 Int) (temp___is_init_357 Bool) (temp___skip_constant_358 Bool) (temp___do_toplevel_359 Bool)) Bool (=> (or (= temp___is_init_357 true) (<= (- 2147483648) 2147483647)) (in_range7 temp___expr_360)))
...
(assert (forall ((container us_rep2)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant key2 true true true) (= (has_key container key2) true)) (let ((result (get2 container key2))) (and (=> (= (of_int 1) true) (and (= result (w_get1 container (witness1 container key2))) (forall ((k Int)) (=> (and (in_range2 k) (= (has_key container k) true)) (= (= k key2) (= (witness1 container key2) (witness1 container k))))))) (dynamic_invariant7 result true false true)))) :pattern ((get2 container key2))))))
...
(assert true)
(assert (forall ((container us_rep2)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant key2 true true true) (= (has_key container key2) true)) (let ((result (witness1 container key2))) (and (= (has_witness container result) true) (dynamic_invariant6 result true false true)))) :pattern ((witness1 container key2))))))
...
(assert (forall ((container us_rep4)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant6 witness2 true true true) (= (has_witness1 container witness2) true)) (dynamic_invariant3 (w_get container witness2) true false true)) :pattern ((w_get container witness2))))))
...
(declare-const temp___895 us_rep3)
...
(declare-const use_maps__are_disjoint__result4 Bool)
...
(declare-const use_maps__are_disjoint__result8 bool__ref)
(declare-const cu__split_fields9 us_split_fields2)
(declare-const use_maps__are_disjoint__result9 Bool)
...
(declare-const use_maps__are_disjoint__result15 bool__ref)
(declare-const cu__split_fields13 us_split_fields2)
(declare-const use_maps__are_disjoint__result16 Bool)
(declare-const result8 Bool)
(declare-const result9 Bool)
(assert (and (= (mk___rep1 (mk___split_fields1 use_maps__are_disjoint__cu__assume)) (first s1)) (ite (= (= (length3 s1) 0) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 use_maps__are_disjoint__cu__assume)) no_element) true) (and (= (has_key1 (positions s1) (mk___rep1 (mk___split_fields1 use_maps__are_disjoint__cu__assume))) true) (= (get1 (positions s1) (mk___rep1 (mk___split_fields1 use_maps__are_disjoint__cu__assume))) 1)))))
...
(assert (or (and (and (and (= use_maps__are_disjoint__result13 (mk_bool__ref use_maps__are_disjoint__result3)) (= cu__split_fields10 (mk___split_fields__ref1 (mk___split_fields1 cu__split_fields2)))) (and (= use_maps__are_disjoint__result14 use_maps__are_disjoint__result3) (= cu__split_fields11 (mk___split_fields1 cu__split_fields2)))) (and (and (= result1 (has_key1 (positions s1) (mk___rep1 (mk___split_fields1 cu__split_fields1)))) (= (= result1 true) (= (has_key1 (positions s1) (mk___rep1 (mk___split_fields1 cu__split_fields1))) true))) (and (= result1 true) (and (= temp___893 cu__split_fields1) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (- (get1 (positions s1) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))) (not (= (has_key (model__ s2) (get (keys s1) i1)) true)))) (and (= (has_key1 (positions s1) (mk___rep1 (mk___split_fields1 cu__split_fields2))) true) (and (and (and (= o6 (key s1 (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range6 o6) (= o6 (get (keys s1) (get1 (positions s1) (mk___rep1 (mk___split_fields1 cu__split_fields2))))))) (and (= result3 (has_key (model__ s2) o6)) (= (= result3 true) (= (has_key (model__ s2) o6) true)))) (and (= result3 true) (and (= use_maps__are_disjoint__result2 result4) (= use_maps__are_disjoint__result3 (of_int 0))))))))))) (and (and (and (= result1 (has_key1 (positions s1) (mk___rep1 (mk___split_fields1 cu__split_fields1)))) (= (= result1 true) (= (has_key1 (positions s1) (mk___rep1 (mk___split_fields1 cu__split_fields1))) true))) (ite (= result1 true) (and (and (and (= temp___893 cu__split_fields1) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (- (get1 (positions s1) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))) (not (= (has_key (model__ s2) (get (keys s1) i1)) true)))) (and (= (has_key1 (positions s1) (mk___rep1 (mk___split_fields1 cu__split_fields2))) true) (and (and (and (and (= o6 (key s1 (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range6 o6) (= o6 (get (keys s1) (get1 (positions s1) (mk___rep1 (mk___split_fields1 cu__split_fields2))))))) (and (= result3 (has_key (model__ s2) o6)) (= (= result3 true) (= (has_key (model__ s2) o6) true)))) (and (not (= result3 true)) (= use_maps__are_disjoint__result3 use_maps__are_disjoint__result2))) (and (and (and (= (mk___rep1 (mk___split_fields1 temp___892)) (next s1 (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (ite (= (ite (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields2)) no_element) false) (= (get1 (positions s1) (mk___rep1 (mk___split_fields1 cu__split_fields2))) (length3 s1)) true) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 temp___892)) no_element) true) (and (= (has_key1 (positions s1) (mk___rep1 (mk___split_fields1 temp___892))) true) (= (get1 (positions s1) (mk___rep1 (mk___split_fields1 temp___892))) (+ (get1 (positions s1) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))))) (and (= result5 cu__split_fields2) (= temp___892 cu__split_fields3))) (and (and (and (= o7 (has_key1 (positions s1) (mk___rep1 (mk___split_fields1 cu__split_fields3)))) (= (= o7 true) (= (has_key1 (positions s1) (mk___rep1 (mk___split_fields1 cu__split_fields3))) true))) (= result6 (ite (not (= o7 true)) true false))) (= result6 true))))))) (and (and (= use_maps__are_disjoint__result6 (mk_bool__ref use_maps__are_disjoint__result3)) (= cu__split_fields6 (mk___split_fields__ref1 (mk___split_fields1 cu__split_fields3)))) (and (= use_maps__are_disjoint__result7 use_maps__are_disjoint__result3) (= cu__split_fields7 (mk___split_fields1 cu__split_fields3))))) (and (and (= use_maps__are_disjoint__result8 use_maps__are_disjoint__result6) (= cu__split_fields8 cu__split_fields6)) (and (= use_maps__are_disjoint__result9 use_maps__are_disjoint__result7) (= cu__split_fields9 cu__split_fields7)))) (and (and (= use_maps__are_disjoint__result8 (mk_bool__ref use_maps__are_disjoint__result)) (= cu__split_fields8 (mk___split_fields__ref1 (mk___split_fields1 cu__split_fields1)))) (and (= use_maps__are_disjoint__result9 use_maps__are_disjoint__result1) (= cu__split_fields9 (mk___split_fields1 cu__split_fields1)))))) (and (and (and (= use_maps__are_disjoint__result13 use_maps__are_disjoint__result11) (= cu__split_fields10 cu__split_fields8)) (and (= use_maps__are_disjoint__result14 use_maps__are_disjoint__result12) (= cu__split_fields11 cu__split_fields9))) (and (and (= use_maps__are_disjoint__result11 (mk_bool__ref use_maps__are_disjoint__result10)) (= use_maps__are_disjoint__result12 use_maps__are_disjoint__result10)) (and (= result7 use_maps__are_disjoint__result8) (= use_maps__are_disjoint__result10 (of_int 1))))))))
(assert (= use_maps__are_disjoint__result15 use_maps__are_disjoint__result13))
(assert (= cu__split_fields12 cu__split_fields10))
(assert (= use_maps__are_disjoint__result16 use_maps__are_disjoint__result14))
(assert (= cu__split_fields13 cu__split_fields11))
(assert (= result9 (bool__content use_maps__are_disjoint__result15)))
(assert (= (bool__content use_maps__are_disjoint__result15) true))
(declare-const temp___902 Int)
(assert (in_range3 temp___902))
(assert (= (iter_has_element (keys s2) temp___902) true))
(assert (not (not (= (has_key (model__ s1) (get (keys s2) temp___902)) true))))
(check-sat)
(exit)
