...
(assert true)
(assert (= result rax))
(assert (= rax1 (bvor (bvand rax ((_ int2bv 64) 18446744069414584320)) ((_ zero_extend 32) val__))))
(assert (= rax1 rax2))
(assert (= rax3 rax1))
(assert (not (= rax2 (bvor (bvand rax ((_ int2bv 64) 18446744069414584320)) ((_ zero_extend 32) val__)))))
(check-sat)
(exit)
