...
(define-fun dynamic_invariant1 ((temp___expr_309 (_ BitVec 32)) (temp___is_init_306 Bool) (temp___skip_constant_307 Bool) (temp___do_toplevel_308 Bool)) Bool true)
(assert (forall ((v (_ BitVec 32))) (forall ((amount Int)) (! (=> (and (dynamic_invariant1 v true true true) (dynamic_invariant amount true true true)) (dynamic_invariant1 (shift_right v amount) true false true)) :pattern ((shift_right v amount))))))
(assert (forall ((v (_ BitVec 32))) (forall ((amount Int)) (! (=> (and (dynamic_invariant1 v true true true) (dynamic_invariant amount true true true)) (= (shift_right v amount) (ite (and (<= 1 32) (<= 32 8)) ((_ zero_extend 24) (ite (< amount 8) (bvlshr ((_ extract 7 0) v) ((_ int2bv 8) amount)) ((_ int2bv 8) 0))) (ite (and (<= 9 32) (<= 32 16)) ((_ zero_extend 16) (ite (< amount 16) (bvlshr ((_ extract 15 0) v) ((_ int2bv 16) amount)) ((_ int2bv 16) 0))) (ite (and (<= 17 32) (<= 32 32)) (bvlshr v ((_ int2bv 32) amount)) ((_ extract 31 0) (bvlshr ((_ zero_extend 32) v) ((_ int2bv 64) amount)))))))) :pattern ((shift_right v amount))))))
...
(assert (forall ((v (_ BitVec 32))) (forall ((amount Int)) (! (=> (and (dynamic_invariant1 v true true true) (dynamic_invariant amount true true true)) (dynamic_invariant1 (shift_left v amount) true false true)) :pattern ((shift_left v amount))))))
(assert (forall ((v (_ BitVec 32))) (forall ((amount Int)) (! (=> (and (dynamic_invariant1 v true true true) (dynamic_invariant amount true true true)) (= (shift_left v amount) (ite (and (<= 1 32) (<= 32 8)) ((_ zero_extend 24) (ite (< amount 8) (bvshl ((_ extract 7 0) v) ((_ int2bv 8) amount)) ((_ int2bv 8) 0))) (ite (and (<= 9 32) (<= 32 16)) ((_ zero_extend 16) (ite (< amount 16) (bvshl ((_ extract 15 0) v) ((_ int2bv 16) amount)) ((_ int2bv 16) 0))) (ite (and (<= 17 32) (<= 32 32)) (bvshl v ((_ int2bv 32) amount)) ((_ extract 31 0) (bvurem (bvshl ((_ zero_extend 32) v) ((_ int2bv 64) amount)) ((_ int2bv 64) 4294967296)))))))) :pattern ((shift_left v amount))))))
(declare-fun make_mask (Int) (_ BitVec 32))
(declare-fun make_mask__function_guard ((_ BitVec 32) Int) Bool)
(define-fun dynamic_invariant2 ((temp___expr_321 Int) (temp___is_init_318 Bool) (temp___skip_constant_319 Bool) (temp___do_toplevel_320 Bool)) Bool (=> (or (= temp___is_init_318 true) (<= 1 32)) (in_range1 temp___expr_321)))
(assert (forall ((num_bits Int)) (! (=> (dynamic_invariant2 num_bits true true true) (dynamic_invariant1 (make_mask num_bits) true false true)) :pattern ((make_mask num_bits)))))
(assert (forall ((num_bits Int)) (! (=> (dynamic_invariant2 num_bits true true true) (= (make_mask num_bits) (shift_right ((_ int2bv 32) 4294967295) (- 32 num_bits)))) :pattern ((make_mask num_bits)))))
(declare-const value (_ BitVec 32))
(declare-const n Int)
(declare-const o Int)
(assert (bvule ((_ int2bv 32) 0) value))
(assert (bvule value ((_ int2bv 32) 4294967295)))
(assert (<= 0 n))
(assert (<= n 31))
(assert (not (in_range1 (- 31 n))))
(check-sat)
(exit)
