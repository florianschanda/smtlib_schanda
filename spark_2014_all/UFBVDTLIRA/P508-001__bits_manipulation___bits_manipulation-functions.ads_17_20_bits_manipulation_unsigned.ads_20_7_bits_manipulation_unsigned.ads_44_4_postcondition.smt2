...
(define-fun in_range ((x Int)) Bool (and (<= 0 x) (<= x 31)))
...
(define-fun dynamic_invariant1 ((temp___expr_315 Int) (temp___is_init_312 Bool) (temp___skip_constant_313 Bool) (temp___do_toplevel_314 Bool)) Bool (=> (or (= temp___is_init_312 true) (<= 0 31)) (in_range temp___expr_315)))
...
(assert (forall ((v (_ BitVec 32))) (forall ((amount Int)) (! (=> (and (dynamic_invariant v true true true) (dynamic_invariant2 amount true true true)) (dynamic_invariant (shift_left v amount) true false true)) :pattern ((shift_left v amount))))))
(assert (forall ((v (_ BitVec 32))) (forall ((amount Int)) (! (=> (and (dynamic_invariant v true true true) (dynamic_invariant2 amount true true true)) (= (shift_left v amount) (ite (and (<= 1 32) (<= 32 8)) ((_ zero_extend 24) (ite (< amount 8) (bvshl ((_ extract 7 0) v) ((_ int2bv 8) amount)) ((_ int2bv 8) 0))) (ite (and (<= 9 32) (<= 32 16)) ((_ zero_extend 16) (ite (< amount 16) (bvshl ((_ extract 15 0) v) ((_ int2bv 16) amount)) ((_ int2bv 16) 0))) (ite (and (<= 17 32) (<= 32 32)) (bvshl v ((_ int2bv 32) amount)) ((_ extract 31 0) (bvurem (bvshl ((_ zero_extend 32) v) ((_ int2bv 64) amount)) ((_ int2bv 64) 4294967296)))))))) :pattern ((shift_left v amount))))))
(declare-fun make_mask (Int) (_ BitVec 32))
(declare-fun make_mask__function_guard ((_ BitVec 32) Int) Bool)
(define-fun dynamic_invariant3 ((temp___expr_321 Int) (temp___is_init_318 Bool) (temp___skip_constant_319 Bool) (temp___do_toplevel_320 Bool)) Bool (=> (or (= temp___is_init_318 true) (<= 1 32)) (in_range1 temp___expr_321)))
...
(assert (forall ((num_bits Int)) (! (=> (dynamic_invariant3 num_bits true true true) (= (make_mask num_bits) (shift_right ((_ int2bv 32) 4294967295) (- 32 num_bits)))) :pattern ((make_mask num_bits)))))
...
(assert (= result6 bits_manipulation_unsigned__unsigned_32__functions__extract_bits__result4))
(assert (not (= bits_manipulation_unsigned__unsigned_32__functions__extract_bits__result4 (bvand (shift_right value from) (make_mask (+ (- to__ from) 1))))))
(check-sat)
(exit)
