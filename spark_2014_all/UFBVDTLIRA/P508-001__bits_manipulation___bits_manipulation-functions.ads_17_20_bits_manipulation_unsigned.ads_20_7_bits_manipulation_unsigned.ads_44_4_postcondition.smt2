...
(define-fun dynamic_invariant1 ((temp___expr_366 Int) (temp___is_init_362 Bool) (temp___skip_constant_363 Bool) (temp___do_toplevel_364 Bool) (temp___do_typ_inv_365 Bool)) Bool (=> (or (= temp___is_init_362 true) (<= 0 31)) (in_range temp___expr_366)))
...
(assert (forall ((v (_ BitVec 32))) (forall ((amount Int)) (! (=> (and (dynamic_invariant v true true true true) (dynamic_invariant2 amount true true true true)) (dynamic_invariant (shift_left v amount) true false true true)) :pattern ((shift_left v amount))))))
(assert (forall ((v (_ BitVec 32))) (forall ((amount Int)) (! (=> (and (dynamic_invariant v true true true true) (dynamic_invariant2 amount true true true true)) (= (shift_left v amount) (ite (and (<= 1 32) (<= 32 8)) ((_ zero_extend 24) (ite (< amount 8) (bvshl ((_ extract 7 0) v) ((_ int2bv 8) amount)) #x00)) (ite (and (<= 9 32) (<= 32 16)) ((_ zero_extend 16) (ite (< amount 16) (bvshl ((_ extract 15 0) v) ((_ int2bv 16) amount)) #x0000)) (ite (and (<= 17 32) (<= 32 32)) (bvshl v ((_ int2bv 32) amount)) ((_ extract 31 0) (bvurem (bvshl ((_ zero_extend 32) v) ((_ int2bv 64) amount)) ((_ int2bv 64) 4294967296)))))))) :pattern ((shift_left v amount))))))
(declare-fun make_mask (Int) (_ BitVec 32))
(declare-fun make_mask__function_guard ((_ BitVec 32) Int) Bool)
(define-fun dynamic_invariant3 ((temp___expr_373 Int) (temp___is_init_369 Bool) (temp___skip_constant_370 Bool) (temp___do_toplevel_371 Bool) (temp___do_typ_inv_372 Bool)) Bool (=> (or (= temp___is_init_369 true) (<= 1 32)) (in_range1 temp___expr_373)))
...
(assert (forall ((num_bits Int)) (! (=> (dynamic_invariant3 num_bits true true true true) (= (make_mask num_bits) (shift_right #xFFFFFFFF (- 32 num_bits)))) :pattern ((make_mask num_bits)))))
