...
(define-fun temp___7871 () us_rep1 (mk___rep1 (mk___split_fields1 temp___787)))
...
(assert (or (and (and (and (= use_maps__my_find__result11 (mk_cursor__ref use_maps__my_find__result3)) (= cu__split_fields8 (mk___split_fields__ref1 cu__split_fields12))) (and (= use_maps__my_find__result12 use_maps__my_find__result3) (= cu__split_fields9 cu__split_fields12))) (and (and (= result1 (has_key1 (positions s) (mk___rep1 cu__split_fields13))) (= (= result1 true) (= (has_key1 (positions s) (mk___rep1 cu__split_fields13)) true))) (and (= result1 true) (and (= temp___788 cu__split_fields1) (and (= 0 temp___789) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields12)) 1))) (not (= (get (keys s) i) k)))) (and (= (has_key1 (positions s) (mk___rep1 cu__split_fields12)) true) (and (and (= result2 (mk_int__ref temp___7891)) (= temp___7892 (get1 (positions s) (mk___rep1 cu__split_fields12)))) (and (and (and (= o2 (key s (mk___rep1 cu__split_fields12))) (and (in_range7 o2) (= o2 (get (keys s) (get1 (positions s) (mk___rep1 cu__split_fields12)))))) (= result3 (ite (= o2 k) true false))) (and (= result3 true) (and (= result4 (mk_cursor__ref use_maps__my_find__result2)) (= use_maps__my_find__result3 (mk___rep1 cu__split_fields12))))))))))))) (and (and (and (= result1 (has_key1 (positions s) (mk___rep1 cu__split_fields13))) (= (= result1 true) (= (has_key1 (positions s) (mk___rep1 cu__split_fields13)) true))) (ite (= result1 true) (and (and (and (= temp___788 cu__split_fields1) (and (= 0 temp___789) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields12)) 1))) (not (= (get (keys s) i) k)))) (and (= (has_key1 (positions s) (mk___rep1 cu__split_fields12)) true) (and (and (= result2 (mk_int__ref temp___7891)) (= temp___7892 (get1 (positions s) (mk___rep1 cu__split_fields12)))) (and (and (and (and (= o2 (key s (mk___rep1 cu__split_fields12))) (and (in_range7 o2) (= o2 (get (keys s) (get1 (positions s) (mk___rep1 cu__split_fields12)))))) (= result3 (ite (= o2 k) true false))) (and (not (= result3 true)) (= use_maps__my_find__result3 use_maps__my_find__result2))) (and (and (and (= temp___7871 (next s (mk___rep1 cu__split_fields12))) (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields12) no_element) false) (= (get1 (positions s) (mk___rep1 cu__split_fields12)) (length3 s)) true) true) (= (bool_eq1 temp___7871 no_element) true) (and (= (has_key1 (positions s) temp___7871) true) (= (get1 (positions s) temp___7871) (+ (get1 (positions s) (mk___rep1 cu__split_fields12)) 1))))) (and (= result5 (mk___split_fields__ref1 cu__split_fields12)) (= cu__split_fields3 (mk___split_fields1 temp___787)))) (and (and (and (= o3 (has_key1 (positions s) (mk___rep1 cu__split_fields3))) (= (= o3 true) (= (has_key1 (positions s) (mk___rep1 cu__split_fields3)) true))) (= result6 (ite (not (= o3 true)) true false))) (= result6 true))))))))) (and (and (= use_maps__my_find__result4 (mk_cursor__ref use_maps__my_find__result3)) (= cu__split_fields4 (mk___split_fields__ref1 cu__split_fields3))) (and (= use_maps__my_find__result5 use_maps__my_find__result3) (= cu__split_fields5 cu__split_fields3)))) (and (and (= use_maps__my_find__result6 use_maps__my_find__result4) (= cu__split_fields6 cu__split_fields4)) (and (= use_maps__my_find__result7 use_maps__my_find__result5) (= cu__split_fields7 cu__split_fields5)))) (and (and (= use_maps__my_find__result6 (mk_cursor__ref (mk___rep1 (mk___split_fields1 use_maps__my_find__result)))) (= cu__split_fields6 (mk___split_fields__ref1 cu__split_fields13))) (and (= use_maps__my_find__result7 (mk___rep1 (mk___split_fields1 use_maps__my_find__result1))) (= cu__split_fields7 cu__split_fields13))))) (and (and (and (= use_maps__my_find__result11 use_maps__my_find__result9) (= cu__split_fields8 cu__split_fields6)) (and (= use_maps__my_find__result12 use_maps__my_find__result10) (= cu__split_fields9 cu__split_fields7))) (and (and (= use_maps__my_find__result9 (mk_cursor__ref use_maps__my_find__result8)) (= use_maps__my_find__result10 use_maps__my_find__result8)) (and (= result7 use_maps__my_find__result6) (= use_maps__my_find__result8 no_element)))))))
...
(assert (not (= (bool_eq1 (cursor__content use_maps__my_find__result13) no_element) true)))
(assert (and (= result8 (has_key1 (positions s) (cursor__content use_maps__my_find__result13))) (= (= result8 true) (= (has_key1 (positions s) (cursor__content use_maps__my_find__result13)) true))))
(assert (= result8 true))
(assert (not (= (has_key1 (positions s) (cursor__content use_maps__my_find__result13)) true)))
(check-sat)
(exit)
