...
(assert (or (and (and (and (= use_maps__my_find__result13 (mk_cursor__ref use_maps__my_find__result3)) (= cu__split_fields10 (mk___split_fields__ref1 (mk___split_fields1 cu__split_fields2)))) (and (= use_maps__my_find__result14 use_maps__my_find__result3) (= cu__split_fields11 (mk___split_fields1 cu__split_fields2)))) (and (and (= result1 (has_key1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields1)))) (= (= result1 true) (= (has_key1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields1))) true))) (and (= result1 true) (and (= temp___745 cu__split_fields1) (and (= 0 temp___746) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (- (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))) (not (= (get (keys s) i1) k)))) (and (= (has_key1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) true) (and (and (= result3 (mk_int__ref temp___7461)) (= temp___7462 (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))))) (and (and (and (= o8 (key s (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range7 o8) (= o8 (get (keys s) (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))))))) (= result4 (ite (= o8 k) true false))) (and (= result4 true) (and (= result5 (mk_cursor__ref use_maps__my_find__result2)) (= use_maps__my_find__result3 (mk___rep1 (mk___split_fields1 cu__split_fields2)))))))))))))) (and (and (and (= result1 (has_key1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields1)))) (= (= result1 true) (= (has_key1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields1))) true))) (ite (= result1 true) (and (and (and (= temp___745 cu__split_fields1) (and (= 0 temp___746) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (- (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))) (not (= (get (keys s) i1) k)))) (and (= (has_key1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) true) (and (and (= result3 (mk_int__ref temp___7461)) (= temp___7462 (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))))) (and (and (and (and (= o8 (key s (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range7 o8) (= o8 (get (keys s) (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))))))) (= result4 (ite (= o8 k) true false))) (and (not (= result4 true)) (= use_maps__my_find__result3 use_maps__my_find__result2))) (and (and (and (= (mk___rep1 (mk___split_fields1 temp___744)) (next s (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (ite (= (ite (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields2)) no_element) false) (= (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) (length3 s)) true) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 temp___744)) no_element) true) (and (= (has_key1 (positions s) (mk___rep1 (mk___split_fields1 temp___744))) true) (= (get1 (positions s) (mk___rep1 (mk___split_fields1 temp___744))) (+ (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))))) (and (= result6 (mk___split_fields__ref1 (mk___split_fields1 cu__split_fields2))) (= cu__split_fields3 (mk___split_fields1 temp___744)))) (and (and (and (= o9 (has_key1 (positions s) (mk___rep1 cu__split_fields3))) (= (= o9 true) (= (has_key1 (positions s) (mk___rep1 cu__split_fields3)) true))) (= result7 (ite (not (= o9 true)) true false))) (= result7 true))))))))) (and (and (= use_maps__my_find__result6 (mk_cursor__ref use_maps__my_find__result3)) (= cu__split_fields6 (mk___split_fields__ref1 cu__split_fields3))) (and (= use_maps__my_find__result7 use_maps__my_find__result3) (= cu__split_fields7 cu__split_fields3)))) (and (and (= use_maps__my_find__result8 use_maps__my_find__result6) (= cu__split_fields8 cu__split_fields6)) (and (= use_maps__my_find__result9 use_maps__my_find__result7) (= cu__split_fields9 cu__split_fields7)))) (and (and (= use_maps__my_find__result8 (mk_cursor__ref (mk___rep1 (mk___split_fields1 use_maps__my_find__result)))) (= cu__split_fields8 (mk___split_fields__ref1 (mk___split_fields1 cu__split_fields1)))) (and (= use_maps__my_find__result9 (mk___rep1 (mk___split_fields1 use_maps__my_find__result1))) (= cu__split_fields9 (mk___split_fields1 cu__split_fields1)))))) (and (and (and (= use_maps__my_find__result13 use_maps__my_find__result11) (= cu__split_fields10 cu__split_fields8)) (and (= use_maps__my_find__result14 use_maps__my_find__result12) (= cu__split_fields11 cu__split_fields9))) (and (and (= use_maps__my_find__result11 (mk_cursor__ref use_maps__my_find__result10)) (= use_maps__my_find__result12 use_maps__my_find__result10)) (and (= result8 use_maps__my_find__result8) (= use_maps__my_find__result10 no_element)))))))
(assert (= use_maps__my_find__result15 use_maps__my_find__result13))
(assert (= cu__split_fields12 cu__split_fields10))
(assert (= use_maps__my_find__result16 use_maps__my_find__result14))
(assert (= cu__split_fields13 cu__split_fields11))
(assert (not (= (bool_eq1 (cursor__content use_maps__my_find__result15) no_element) true)))
(assert (and (= result9 (has_key1 (positions s) (cursor__content use_maps__my_find__result15))) (= (= result9 true) (= (has_key1 (positions s) (cursor__content use_maps__my_find__result15)) true))))
(assert (= result9 true))
(assert (not (= (has_key1 (positions s) (cursor__content use_maps__my_find__result15)) true)))
(check-sat)
(exit)
