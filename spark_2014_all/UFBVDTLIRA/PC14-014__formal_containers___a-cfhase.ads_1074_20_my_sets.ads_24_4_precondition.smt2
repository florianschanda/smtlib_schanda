...
(define-fun default_initial_assumption ((temp___expr_800 us_rep2) (temp___skip_top_level_801 Bool)) Bool (=> (not (= temp___skip_top_level_801 true)) (and (= (is_empty temp___expr_800) true) (= (length2 temp___expr_800) 0))))
...
(define-fun default_initial_assumption1 ((temp___expr_777 us_rep4) (temp___skip_top_level_778 Bool)) Bool (=> (not (= temp___skip_top_level_778 true)) (= (length3 temp___expr_777) 0)))
(declare-fun find (us_rep4 us_rep3) Int)
(declare-fun find__function_guard (Int us_rep4 us_rep3) Bool)
(assert (forall ((container1 us_rep4)) (forall ((item us_rep3)) (! (let ((result (find container1 item))) (and (=> (< 0 result) (and (<= result (length3 container1)) (= (my_eq item (get1 container1 result)) true))) (dynamic_invariant result true false true true))) :pattern ((find container1 item))))))
...
(assert (forall ((container1 us_rep)) (! (let ((result (elements container1))) (and (and (and (and (= (length3 result) (length container1)) (forall ((temp___818 Int)) (=> (and (in_range5 temp___818) (= (iter_has_element result temp___818) true)) (= (contains (model__ container1) (get1 result temp___818)) true)))) (forall ((item us_rep3)) (=> (= (contains (model__ container1) item) true) (and (< 0 (find result item)) (= (my_eq (get1 result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (= (find result (get1 result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length container1))) (=> (= (my_eq (get1 result i) (get1 result j)) true) (= i j)))))))) :pattern ((elements container1)))))
...
(declare-const temp___1400 count_type)
(declare-const o2 us_rep2)
(declare-const o3 Int)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___1400 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___1400)) no_element))
