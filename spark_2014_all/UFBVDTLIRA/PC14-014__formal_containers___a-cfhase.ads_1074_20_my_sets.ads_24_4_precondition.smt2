...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (= (to_rep (rec__my_sets__n__cursor__node (us_split_fields3 a))) (to_rep (rec__my_sets__n__cursor__node (us_split_fields3 b)))) true false))
...
(define-fun dynamic_invariant1 ((temp___expr_737 Int) (temp___is_init_734 Bool) (temp___skip_constant_735 Bool) (temp___do_toplevel_736 Bool)) Bool (=> (or (= temp___is_init_734 true) (<= 1 2147483647)) (in_range2 temp___expr_737)))
...
(define-fun default_initial_assumption ((temp___expr_744 us_rep2) (temp___skip_top_level_745 Bool)) Bool (=> (not (= temp___skip_top_level_745 true)) (and (= (is_empty temp___expr_744) true) (= (length2 temp___expr_744) 0))))
...
(assert (forall ((a us_rep4) (b us_rep4)) (! (= (user_eq9 a b) (oeq2 a b)) :pattern ((user_eq9 a b)))))
(define-fun default_initial_assumption1 ((temp___expr_724 us_rep4) (temp___skip_top_level_725 Bool)) Bool (=> (not (= temp___skip_top_level_725 true)) (= (length3 temp___expr_724) 0)))
(declare-fun find (us_rep4 us_rep3) Int)
(declare-fun find__function_guard (Int us_rep4 us_rep3) Bool)
(assert (forall ((container1 us_rep4)) (forall ((item us_rep3)) (! (let ((result (find container1 item))) (and (=> (< 0 result) (and (<= result (length3 container1)) (= (my_eq item (get1 container1 result)) true))) (dynamic_invariant result true false true))) :pattern ((find container1 item))))))
...
(define-fun default_initial_assumption2 ((temp___expr_691 us_rep5) (temp___skip_top_level_692 Bool)) Bool (=> (not (= temp___skip_top_level_692 true)) (= (is_empty1 temp___expr_691) true)))
...
(assert (forall ((container1 us_rep)) (! (let ((result (elements container1))) (and (and (and (and (= (length3 result) (length container1)) (forall ((temp___761 Int)) (=> (and (in_range5 temp___761) (= (iter_has_element result temp___761) true)) (= (contains (model__ container1) (get1 result temp___761)) true)))) (forall ((item us_rep3)) (=> (= (contains (model__ container1) item) true) (and (< 0 (find result item)) (= (my_eq (get1 result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (= (find result (get1 result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length container1))) (=> (= (my_eq (get1 result i) (get1 result j)) true) (= i j)))))))) :pattern ((elements container1)))))
...
(assert true)
(assert (forall ((container1 us_rep5)) (forall ((item us_rep3)) (! (=> (= (of_int 1) true) (=> (exists ((e us_rep3)) (and (= (contains container1 e) true) (= (my_eq e item) true))) (= (contains container1 item) true))) :pattern ((contains container1 item))))))
...
(assert (and (= o3 (length container)) (and (in_range1 o3) (<= o3 (to_rep (rec__my_sets__n__set__capacity (us_split_discrs1 container)))))))
