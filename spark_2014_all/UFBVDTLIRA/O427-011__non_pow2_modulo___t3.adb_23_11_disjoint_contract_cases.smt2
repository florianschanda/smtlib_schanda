...
(declare-sort m 0)
(define-fun in_range1 ((x (_ BitVec 64))) Bool (and (bvule ((_ int2bv 64) 0) x) (bvule x ((_ int2bv 64) 229))))
...
(define-fun dynamic_invariant ((temp___expr_177 (_ BitVec 64)) (temp___is_init_174 Bool) (temp___skip_constant_175 Bool) (temp___do_toplevel_176 Bool)) Bool (=> (or (= temp___is_init_174 true) (bvule ((_ int2bv 64) 0) ((_ int2bv 64) 229))) (in_range1 temp___expr_177)))
(declare-const x (_ BitVec 64))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const y (_ BitVec 64))
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const t3__msub__result (_ BitVec 64))
(declare-const o (_ BitVec 64))
(declare-const result (_ BitVec 64))
(declare-const t3__msub__result1 (_ BitVec 64))
(declare-const t3__msub__result2 (_ BitVec 64))
(declare-const t3__msub__result3 (_ BitVec 64))
(declare-const t3__msub__result4 (_ BitVec 64))
(declare-const t3__msub__result5 (_ BitVec 64))
(assert (in_range1 x))
(assert (in_range1 y))
(assert (not (<= (+ (+ (+ (+ (+ 0 (ite (= (ite (= (= x ((_ int2bv 64) 0)) true) (= y ((_ int2bv 64) 0)) false) true) 1 0)) (ite (= (ite (= (not (= x ((_ int2bv 64) 0))) true) (= y ((_ int2bv 64) 0)) false) true) 1 0)) (ite (= (ite (= (= x ((_ int2bv 64) 0)) true) (not (= y ((_ int2bv 64) 0))) false) true) 1 0)) (ite (= (ite (= (= x ((_ int2bv 64) 2)) true) (= y ((_ int2bv 64) 4)) false) true) 1 0)) (ite (= (ite (= (= x ((_ int2bv 64) 4)) true) (= y ((_ int2bv 64) 2)) false) true) 1 0)) 1)))
(check-sat)
(exit)
