...
(assert (and (= temp___1029 (elements s)) (and (and (and (and (= (length1 temp___1029) (length s)) (forall ((temp___467 Int)) (=> (and (in_range3 temp___467) (= (iter_has_element temp___1029 temp___467) true)) (= (contains (model__ s) (get temp___1029 temp___467)) true)))) (forall ((item Int)) (=> (and (in_range4 item) (= (contains (model__ s) item) true)) (and (< 0 (find temp___1029 item)) (= (get temp___1029 (find temp___1029 item)) item))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length s))) (= (find temp___1029 (get temp___1029 i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length s))) (=> (= (get temp___1029 i) (get temp___1029 j)) (= i j)))))))))
(assert (and (= o (iter_has_element temp___1029 temp___1028)) (= (= o true) (and (<= 1 temp___1028) (<= temp___1028 (last temp___1029))))))
(assert (= (= o1 true) (in_range3 temp___1028)))
