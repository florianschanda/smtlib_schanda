...
(assert (forall ((x unsigned_32)) (! (uint_in_range (to_int6 x)) :pattern ((to_int6 x)))))
...
(assert (forall ((x unsigned_16)) (! (uint_in_range3 (to_int7 x)) :pattern ((to_int7 x)))))
...
(assert (forall ((x unsigned_8)) (! (uint_in_range2 (to_int8 x)) :pattern ((to_int8 x)))))
...
(define-fun in_range2 ((rec__discrimrec__register_type__option1 Int) (a us_rep)) Bool (= rec__discrimrec__register_type__option1 (to_rep4 (rec__discrimrec__register_type__option (us_split_discrs1 a)))))
...
(define-fun dynamic_invariant ((temp___expr_232 us_rep) (temp___is_init_228 Bool) (temp___skip_constant_229 Bool) (temp___do_toplevel_230 Bool) (temp___do_typ_inv_231 Bool)) Bool (and (=> (not (= temp___skip_constant_229 true)) (in_range2 0 temp___expr_232)) (= (attr__constrained temp___expr_232) true)))
(define-fun default_initial_assumption ((temp___expr_234 us_rep) (temp___skip_top_level_235 Bool)) Bool (and (= (attr__constrained temp___expr_234) true) (= (to_rep4 (rec__discrimrec__register_type__option (us_split_discrs1 temp___expr_234))) 0)))
(define-fun dynamic_invariant1 ((temp___expr_251 us_rep) (temp___is_init_247 Bool) (temp___skip_constant_248 Bool) (temp___do_toplevel_249 Bool) (temp___do_typ_inv_250 Bool)) Bool (and (=> (not (= temp___skip_constant_248 true)) (in_range1 1 temp___expr_251)) (= (attr__constrained temp___expr_251) true)))
(define-fun default_initial_assumption1 ((temp___expr_253 us_rep) (temp___skip_top_level_254 Bool)) Bool (and (= (attr__constrained temp___expr_253) true) (= (to_rep4 (rec__discrimrec__register_type__option (us_split_discrs1 temp___expr_253))) 1)))
(define-fun in_range3 ((rec__discrimrec__register_type__option1 Int) (a us_rep)) Bool (= rec__discrimrec__register_type__option1 (to_rep4 (rec__discrimrec__register_type__option (us_split_discrs1 a)))))
...
(assert (forall ((reg us_rep)) (! (=> (dynamic_invariant reg true true true true) (dynamic_invariant1 (convert_bit_64_to_bit_32 reg) true false true true)) :pattern ((convert_bit_64_to_bit_32 reg)))))
(assert (forall ((reg us_rep)) (! (=> (dynamic_invariant reg true true true true) (= (convert_bit_64_to_bit_32 reg) (mk___rep (mk___split_discrs (of_rep4 1)) (mk___split_fields dummy (of_rep1 #x00000000) (of_rep1 ((_ extract 31 0) (bvurem (to_rep (rec__discrimrec__register_type__value_64 (us_split_fields1 reg))) #x0000000100000000))) dummy1 dummy2 dummy2 dummy1 dummy2 dummy3 dummy3) true))) :pattern ((convert_bit_64_to_bit_32 reg)))))
(define-fun in_range4 ((rec__discrimrec__register_type__option1 Int) (a us_rep)) Bool (= rec__discrimrec__register_type__option1 (to_rep4 (rec__discrimrec__register_type__option (us_split_discrs1 a)))))
...
(define-fun dynamic_invariant2 ((temp___expr_212 us_rep) (temp___is_init_208 Bool) (temp___skip_constant_209 Bool) (temp___do_toplevel_210 Bool) (temp___do_typ_inv_211 Bool)) Bool (and (=> (not (= temp___skip_constant_209 true)) (in_range4 0 temp___expr_212)) (= (attr__constrained temp___expr_212) true)))
(define-fun default_initial_assumption2 ((temp___expr_214 us_rep) (temp___skip_top_level_215 Bool)) Bool (and (= (attr__constrained temp___expr_214) true) (= (to_rep4 (rec__discrimrec__register_type__option (us_split_discrs1 temp___expr_214))) 0)))
(declare-const rax__split_discrs us_split_discrs)
(declare-const rax__attr__constrained Bool)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(define-fun in_range5 ((rec__discrimrec__register_type__option1 Int) (a us_rep)) Bool (= rec__discrimrec__register_type__option1 (to_rep4 (rec__discrimrec__register_type__option (us_split_discrs1 a)))))
...
(define-fun default_initial_assumption3 ((temp___expr_272 us_rep) (temp___skip_top_level_273 Bool)) Bool (and (= (attr__constrained temp___expr_272) true) (= (to_rep4 (rec__discrimrec__register_type__option (us_split_discrs1 temp___expr_272))) 1)))
(declare-const eax__split_discrs us_split_discrs)
(declare-const eax__attr__constrained Bool)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(define-fun in_range6 ((rec__discrimrec__register_type__option1 Int) (a us_rep)) Bool (= rec__discrimrec__register_type__option1 (to_rep4 (rec__discrimrec__register_type__option (us_split_discrs1 a)))))
...
(define-fun in_range7 ((rec__discrimrec__register_type__option1 Int) (a us_rep)) Bool (= rec__discrimrec__register_type__option1 (to_rep4 (rec__discrimrec__register_type__option (us_split_discrs1 a)))))
...
(define-fun default_initial_assumption4 ((temp___expr_195 us_rep) (temp___skip_top_level_196 Bool)) Bool (and (= (attr__constrained temp___expr_195) false) (= (to_rep4 (rec__discrimrec__register_type__option (us_split_discrs1 temp___expr_195))) 0)))
...
(assert (and (= eax__attr__constrained true) (= (to_rep4 (rec__discrimrec__register_type__option eax__split_discrs)) 1)))
(assert (and (= 1 (to_rep4 (rec__discrimrec__register_type__option eax__split_discrs))) (= eax__attr__constrained true)))
...
(assert (= (to_rep4 o63) 0))
(assert (= o66 (mk___split_discrs o63)))
(assert (= o67 (mk___rep o66 o65 true)))
(assert (= o68 o67))
(assert (not (= 0 (to_rep4 (rec__discrimrec__register_type__option (us_split_discrs1 o68))))))
(check-sat)
(exit)
