...
(define-fun dynamic_invariant ((temp___expr_183 us_rep) (temp___is_init_180 Bool) (temp___skip_constant_181 Bool) (temp___do_toplevel_182 Bool)) Bool (and (=> (not (= temp___skip_constant_181 true)) (in_range1 0 temp___expr_183)) (= (attr__constrained temp___expr_183) true)))
(define-fun default_initial_assumption ((temp___expr_185 us_rep) (temp___skip_top_level_186 Bool)) Bool (and (= (attr__constrained temp___expr_185) true) (= (to_rep2 (rec__discrimrec__register_type__option (us_split_discrs1 temp___expr_185))) 0)))
...
(define-fun dynamic_invariant1 ((temp___expr_202 us_rep) (temp___is_init_199 Bool) (temp___skip_constant_200 Bool) (temp___do_toplevel_201 Bool)) Bool (and (=> (not (= temp___skip_constant_200 true)) (in_range2 0 temp___expr_202)) (= (attr__constrained temp___expr_202) true)))
(define-fun default_initial_assumption1 ((temp___expr_204 us_rep) (temp___skip_top_level_205 Bool)) Bool (and (= (attr__constrained temp___expr_204) true) (= (to_rep2 (rec__discrimrec__register_type__option (us_split_discrs1 temp___expr_204))) 0)))
(define-fun dynamic_invariant2 ((temp___expr_220 us_rep) (temp___is_init_217 Bool) (temp___skip_constant_218 Bool) (temp___do_toplevel_219 Bool)) Bool (and (=> (not (= temp___skip_constant_218 true)) (in_range3 1 temp___expr_220)) (= (attr__constrained temp___expr_220) true)))
(define-fun default_initial_assumption2 ((temp___expr_222 us_rep) (temp___skip_top_level_223 Bool)) Bool (and (= (attr__constrained temp___expr_222) true) (= (to_rep2 (rec__discrimrec__register_type__option (us_split_discrs1 temp___expr_222))) 1)))
...
(assert (forall ((reg us_rep)) (! (=> (dynamic_invariant1 reg true true true) (dynamic_invariant2 (convert_bit_64_to_bit_32 reg) true false true)) :pattern ((convert_bit_64_to_bit_32 reg)))))
(assert (forall ((reg us_rep)) (! (=> (dynamic_invariant1 reg true true true) (= (convert_bit_64_to_bit_32 reg) (mk___rep (mk___split_discrs (of_rep2 1)) (mk___split_fields dummy (of_rep1 ((_ int2bv 32) 0)) (of_rep1 ((_ extract 31 0) (bvurem (to_rep (rec__discrimrec__register_type__value_64 (us_split_fields1 reg))) ((_ int2bv 64) 4294967296)))) dummy1 dummy2 dummy2 dummy1 dummy2 dummy3 dummy3) true))) :pattern ((convert_bit_64_to_bit_32 reg)))))
...
(define-fun dynamic_invariant3 ((temp___expr_238 us_rep) (temp___is_init_235 Bool) (temp___skip_constant_236 Bool) (temp___do_toplevel_237 Bool)) Bool (and (=> (not (= temp___skip_constant_236 true)) (in_range5 1 temp___expr_238)) (= (attr__constrained temp___expr_238) true)))
(define-fun default_initial_assumption3 ((temp___expr_240 us_rep) (temp___skip_top_level_241 Bool)) Bool (and (= (attr__constrained temp___expr_240) true) (= (to_rep2 (rec__discrimrec__register_type__option (us_split_discrs1 temp___expr_240))) 1)))
...
(define-fun dynamic_invariant4 ((temp___expr_135 (_ BitVec 64)) (temp___is_init_132 Bool) (temp___skip_constant_133 Bool) (temp___do_toplevel_134 Bool)) Bool true)
(define-fun dynamic_invariant5 ((temp___expr_141 (_ BitVec 32)) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool true)
(define-fun dynamic_invariant6 ((temp___expr_147 (_ BitVec 16)) (temp___is_init_144 Bool) (temp___skip_constant_145 Bool) (temp___do_toplevel_146 Bool)) Bool true)
(define-fun dynamic_invariant7 ((temp___expr_153 (_ BitVec 8)) (temp___is_init_150 Bool) (temp___skip_constant_151 Bool) (temp___do_toplevel_152 Bool)) Bool true)
(define-fun dynamic_invariant8 ((temp___expr_159 Int) (temp___is_init_156 Bool) (temp___skip_constant_157 Bool) (temp___do_toplevel_158 Bool)) Bool (=> (or (= temp___is_init_156 true) (<= 0 3)) (in_range temp___expr_159)))
(define-fun default_initial_assumption4 ((temp___expr_167 us_rep) (temp___skip_top_level_168 Bool)) Bool (and (= (attr__constrained temp___expr_167) false) (= (to_rep2 (rec__discrimrec__register_type__option (us_split_discrs1 temp___expr_167))) 0)))
...
(declare-const temp___261 us_rep)
...
(declare-const temp___262 us_rep)
...
(declare-const rax__split_fields11 us_split_fields)
(declare-const rax__split_fields12 us_split_fields__ref)
(declare-const eax__split_fields11 us_split_fields__ref)
(declare-const rax__split_fields13 us_split_fields)
(declare-const eax__split_fields12 us_split_fields)
...
(assert (= o23 o11))
(assert (= true o24))
(assert (= (mk___rep (mk___split_discrs o25) (mk___split_fields o26 o27 o28 o29 o30 o31 o32 o33 o34 o35) o36) (mk___rep (mk___split_discrs o13) (mk___split_fields o14 o15 o16 o17 o18 o19 o20 o21 o22 o23) o24)))
(assert (= (mk___rep (mk___split_discrs o37) (mk___split_fields o38 o39 o40 o41 o42 o43 o44 o45 o46 o47) o48) (mk___rep (mk___split_discrs o25) (mk___split_fields o26 o27 o28 o29 o30 o31 o32 o33 o34 o35) o36)))
(assert (= (mk___rep (mk___split_discrs temp___260) (mk___split_fields temp___2601 temp___2602 temp___2603 temp___2604 temp___2605 temp___2606 temp___2607 temp___2608 temp___2609 temp___26010) temp___26011) (mk___rep (mk___split_discrs o37) (mk___split_fields o38 o39 o40 o41 o42 o43 o44 o45 o46 o47) o48)))
...
(assert (= rax__split_fields10 (mk___split_fields temp___2601 temp___2602 temp___2603 temp___2604 temp___2605 temp___2606 temp___2607 temp___2608 temp___2609 temp___26010)))
(assert (= rax__split_discrs (mk___split_discrs temp___260)))
(assert (and (= (mk___rep (mk___split_discrs o49) (mk___split_fields o50 o51 o52 o53 o54 o55 o56 o57 o58 o59) o60) (convert_bit_64_to_bit_32 (mk___rep rax__split_discrs rax__split_fields10 rax__attr__constrained))) (and (and (= 1 (to_rep2 o49)) (= o60 true)) (and (= (of_rep2 1) o49) (and (and (= dummy o50) (and (= (of_rep1 ((_ int2bv 32) 0)) o51) (and (= (of_rep1 ((_ extract 31 0) (bvurem (to_rep (rec__discrimrec__register_type__value_64 rax__split_fields10)) ((_ int2bv 64) 4294967296)))) o52) (and (= dummy1 o53) (and (= dummy2 o54) (and (= dummy2 o55) (and (= dummy1 o56) (and (= dummy2 o57) (and (= dummy3 o58) (= dummy3 o59)))))))))) (= true o60))))))
(assert (= o61 (mk___rep (mk___split_discrs o49) (mk___split_fields o50 o51 o52 o53 o54 o55 o56 o57 o58 o59) o60)))
(assert (= o62 o61))
...
(assert (= (to_rep1 (rec__discrimrec__register_type__value_32 eax__split_fields10)) ((_ int2bv 32) 16)))
(assert (= (to_rep o64) ((_ int2bv 64) 32)))
