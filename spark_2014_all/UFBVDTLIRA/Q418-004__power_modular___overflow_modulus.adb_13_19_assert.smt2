...
(assert (and (= temp___181 (id 3)) (and (in_range temp___181) (= temp___181 3))))
(assert (=> (< temp___181 256) (= o1 (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) temp___181)))))
(assert (=> (not (< temp___181 256)) (= o1 ((_ int2bv 8) 0))))
(assert (= o2 (bvurem o1 ((_ int2bv 8) 8))))
(assert (= result1 y))
(assert (= y1 o2))
(assert (not (= y1 ((_ int2bv 8) 0))))
(check-sat)
(exit)
