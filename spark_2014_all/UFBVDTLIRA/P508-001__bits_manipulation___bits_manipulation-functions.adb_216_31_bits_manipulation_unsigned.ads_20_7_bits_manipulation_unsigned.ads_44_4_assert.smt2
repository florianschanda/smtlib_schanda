...
(assert (<= 2 i1))
(assert (<= i1 31))
(assert (= (make_mask i1) (bvsub (ite (< i1 4294967296) (bvshl #x00000001 ((_ int2bv 32) i1)) #x00000000) #x00000001)))
(assert (forall ((j Int)) (=> (and (<= 1 j) (<= j (- i2 1))) (= (make_mask j) (bvsub (ite (< j 4294967296) (bvshl #x00000001 ((_ int2bv 32) j)) #x00000000) #x00000001)))))
(assert (and (=> (<= 2 31) (in_range2 i2)) (and (<= 2 i2) (<= i2 31))))
(assert (not (= i2 31)))
(assert (= i2 result1))
(assert (= i3 (+ i2 1)))
(assert (not (= (make_mask i3) (bvsub (ite (< i3 4294967296) (bvshl #x00000001 ((_ int2bv 32) i3)) #x00000000) #x00000001))))
(check-sat)
(exit)
