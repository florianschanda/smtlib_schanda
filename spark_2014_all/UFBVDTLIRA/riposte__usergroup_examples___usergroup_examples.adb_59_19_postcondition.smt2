...
(assert (= usergroup_examples__example_5__result1 (bvxor ((_ int2bv 64) 73) (bvmul a b))))
(assert (= (mk_t__ref usergroup_examples__example_5__result4) (mk_t__ref usergroup_examples__example_5__result2)))
(assert (= usergroup_examples__example_5__result5 usergroup_examples__example_5__result3))
(assert (= result1 usergroup_examples__example_5__result4))
(assert (not (bvugt usergroup_examples__example_5__result4 ((_ int2bv 64) 0))))
(check-sat)
(exit)
