...
(declare-const x86__bl__result (_ BitVec 8))
(declare-const result (_ BitVec 8))
(declare-const x86__bl__result1 (_ BitVec 8))
(declare-const x86__bl__result2 (_ BitVec 8))
(declare-const x86__bl__result3 (_ BitVec 8))
(declare-const x86__bl__result4 (_ BitVec 8))
(declare-const x86__bl__result5 (_ BitVec 8))
(declare-const result1 (_ BitVec 8))
(assert true)
(assert (= x86__bl__result1 x86__bl__result2))
(assert (= x86__bl__result3 x86__bl__result1))
(assert (= (mk_t__ref result) (mk_t__ref x86__bl__result)))
(assert (= x86__bl__result1 ((_ extract 7 0) (bvand rbx ((_ int2bv 64) 255)))))
(assert (= (mk_t__ref x86__bl__result4) (mk_t__ref x86__bl__result2)))
(assert (= x86__bl__result5 x86__bl__result3))
(assert (= result1 x86__bl__result4))
(assert (not (= x86__bl__result4 ((_ extract 7 0) (bvand rbx ((_ int2bv 64) 255))))))
(check-sat)
(exit)
