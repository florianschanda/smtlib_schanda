...
(assert (forall ((x86__rax (_ BitVec 64))) (! (=> (dynamic_invariant x86__rax true true true) (let ((result (ax x86__rax))) (and (= result ((_ extract 15 0) (bvand x86__rax ((_ int2bv 64) 65535)))) (dynamic_invariant1 result true false true)))) :pattern ((ax x86__rax)))))
