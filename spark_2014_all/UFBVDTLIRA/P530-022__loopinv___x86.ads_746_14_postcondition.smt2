...
(assert (forall ((x86__rdx (_ BitVec 64))) (! (=> (dynamic_invariant x86__rdx true true true) (let ((result (dl x86__rdx))) (and (= result (readreglow8 x86__rdx)) (dynamic_invariant1 result true false true)))) :pattern ((dl x86__rdx)))))
