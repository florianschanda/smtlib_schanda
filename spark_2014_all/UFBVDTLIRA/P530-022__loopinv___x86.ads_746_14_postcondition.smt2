...
(assert (forall ((x86__rdx (_ BitVec 64))) (! (=> (dynamic_invariant x86__rdx true true true true) (let ((result (dl x86__rdx))) (and (= result (readreglow8 x86__rdx)) (dynamic_invariant1 result true false true true)))) :pattern ((dl x86__rdx)))))
...
(assert (=> (= carryflag true) (= (writereglow8post rdx rdx1 #x01) true)))
(assert (=> (not (= carryflag true)) (= (writereglow8post rdx rdx2 #x00) true)))
