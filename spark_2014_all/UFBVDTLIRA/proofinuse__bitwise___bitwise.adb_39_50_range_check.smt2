...
(define-fun dynamic_invariant ((temp___expr_173 (_ BitVec 16)) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool) (temp___do_typ_inv_172 Bool)) Bool true)
...
(define-fun dynamic_invariant1 ((temp___expr_180 (_ BitVec 8)) (temp___is_init_176 Bool) (temp___skip_constant_177 Bool) (temp___do_toplevel_178 Bool) (temp___do_typ_inv_179 Bool)) Bool true)
...
(assert (= fsthalf1 ((_ extract 7 0) (bvand val__ #x00FF))))
