...
(assert (and (= temp___1001 (keys s)) (and (and (and (and (= (length2 temp___1001) (length s)) (forall ((temp___474 Int)) (=> (and (in_range2 temp___474) (= (iter_has_element temp___1001 temp___474) true)) (= (has_key (model__ s) (get temp___1001 temp___474)) true)))) (forall ((key Int)) (=> (and (in_range4 key) (= (has_key (model__ s) key) true)) (and (< 0 (find temp___1001 key)) (= (get temp___1001 (find temp___1001 key)) key))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length s))) (= (find temp___1001 (get temp___1001 i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length s))) (=> (= (get temp___1001 i) (get temp___1001 j)) (= i j)))))))))
(assert (and (= o (iter_has_element temp___1001 temp___1000)) (= (= o true) (and (<= 1 temp___1000) (<= temp___1000 (last temp___1001))))))
(assert (= (= o1 true) (in_range2 temp___1000)))
(assert (= result (ite (= o1 true) o false)))
(assert (= result true))
(assert (and (= k (get temp___1001 temp___1000)) (in_range3 k)))
