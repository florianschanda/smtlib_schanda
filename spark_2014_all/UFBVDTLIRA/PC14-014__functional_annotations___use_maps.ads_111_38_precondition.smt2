...
(assert (and (= temp___958 (keys s)) (and (and (and (and (= (length2 temp___958) (length s)) (forall ((temp___431 Int)) (=> (and (in_range2 temp___431) (= (iter_has_element temp___958 temp___431) true)) (= (has_key (model__ s) (get temp___958 temp___431)) true)))) (forall ((key Int)) (=> (and (in_range4 key) (= (has_key (model__ s) key) true)) (and (< 0 (find temp___958 key)) (= (get temp___958 (find temp___958 key)) key))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (= (find temp___958 (get temp___958 i1)) i1)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length s))) (=> (= (get temp___958 i1) (get temp___958 j)) (= i1 j)))))))))
(assert (and (= o5 (iter_has_element temp___958 temp___957)) (= (= o5 true) (and (<= 1 temp___957) (<= temp___957 (last temp___958))))))
(assert (= (= o6 true) (in_range2 temp___957)))
