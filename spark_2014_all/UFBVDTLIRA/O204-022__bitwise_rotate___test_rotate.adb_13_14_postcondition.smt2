...
(declare-datatypes () ((longword_t__ref (mk_longword_t__ref (longword_t__content longword_t)))))
(define-fun longword_t__ref___projection ((a longword_t__ref)) longword_t (longword_t__content a))
...
(declare-const test_rotate__r__result (_ BitVec 64))
(declare-const o Int)
(declare-const o1 (_ BitVec 64))
(declare-const o2 (_ BitVec 64))
(declare-const result (_ BitVec 64))
(declare-const test_rotate__r__result1 (_ BitVec 64))
(declare-const test_rotate__r__result2 (_ BitVec 64))
(declare-const test_rotate__r__result3 (_ BitVec 64))
...
(assert (and (bvule a #xFFFFFFFFFFFFFFFF) (and (not (= a #x0000000000000000)) (bvule b #x000000007FFFFFFF))))
(assert (= test_rotate__r__result1 test_rotate__r__result2))
(assert (= test_rotate__r__result3 test_rotate__r__result1))
(assert (and (= o (bv2nat b)) (in_range (bv2nat b))))
(assert (= o1 ((_ int2bv 64) o)))
(assert (= o2 (bvor (bvshl a (bvurem o1 (_ bv64 64))) (bvlshr a (bvsub (_ bv64 64) (bvurem o1 (_ bv64 64)))))))
(assert (= result test_rotate__r__result))
(assert (= test_rotate__r__result1 o2))
(assert (= (mk_t__ref test_rotate__r__result4) (mk_t__ref test_rotate__r__result2)))
(assert (= test_rotate__r__result5 test_rotate__r__result3))
(assert (= result1 test_rotate__r__result4))
(assert (not (not (= test_rotate__r__result4 #x0000000000000000))))
(check-sat)
(exit)
