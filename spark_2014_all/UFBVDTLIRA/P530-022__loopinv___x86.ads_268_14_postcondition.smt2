...
(assert (forall ((regold (_ BitVec 64)) (regnew (_ BitVec 64))) (forall ((val__ (_ BitVec 8))) (! (=> (and (and (dynamic_invariant regold true true true) (dynamic_invariant regnew true true true)) (dynamic_invariant1 val__ true true true)) (= (= (writereghigh8post regold regnew val__) true) (and (= (readreghigh8 regnew) val__) (= (bvand regnew ((_ int2bv 64) 18446744073709486335)) (bvand regold ((_ int2bv 64) 18446744073709486335)))))) :pattern ((writereghigh8post regold regnew val__))))))
(assert (forall ((regold (_ BitVec 64)) (regnew (_ BitVec 64))) (forall ((val__ (_ BitVec 8))) (! (= (= (writereghigh8post regold regnew val__) true) (and (= (readreghigh8 regnew) val__) (= (bvand regnew ((_ int2bv 64) 18446744073709486335)) (bvand regold ((_ int2bv 64) 18446744073709486335))))) :pattern ((writereghigh8post regold regnew val__))))))
...
(assert true)
(assert (= result rdx))
(assert (= rdx1 (bvor (bvand rdx ((_ int2bv 64) 18446744073709486335)) ((_ zero_extend 48) (bvmul ((_ zero_extend 8) val__) ((_ int2bv 16) 256))))))
(assert (= rdx1 rdx2))
(assert (= rdx3 rdx1))
(assert (not (= (writereghigh8post rdx rdx2 val__) true)))
(check-sat)
(exit)
