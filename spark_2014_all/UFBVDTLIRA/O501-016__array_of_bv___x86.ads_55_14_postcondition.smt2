...
(assert (= (mk_t__ref result) (mk_t__ref x86__ah__result)))
(assert (= x86__ah__result1 ((_ extract 7 0) (bvudiv (bvand rax ((_ int2bv 64) 65280)) ((_ int2bv 64) 256)))))
...
(assert (not (= x86__ah__result4 ((_ extract 7 0) (bvurem (bvudiv (bvand rax ((_ int2bv 64) 65280)) ((_ int2bv 64) 256)) ((_ int2bv 64) 256))))))
(check-sat)
(exit)
