...
(assert (forall ((us_void_param tuple0)) (! (=> (= (axiom__ us_void_param) true) (forall ((v (_ BitVec 16))) (=> (and (bvule #x0000 v) (bvule v #xFFFF)) (forall ((n Int)) (=> (and (<= 0 n) (<= n 15)) (=> (= (bvand v (ite (< n 65536) (bvshl #x0001 ((_ int2bv 16) n)) #x0000)) #x0000) (= (bvand (bvadd v (ite (< n 65536) (bvshl #x0001 ((_ int2bv 16) n)) #x0000)) (ite (< n 65536) (bvshl #x0001 ((_ int2bv 16) n)) #x0000)) (ite (< n 65536) (bvshl #x0001 ((_ int2bv 16) n)) #x0000)))))))) :pattern ((axiom__ us_void_param)))))
...
(declare-const temp___488 (_ BitVec 16))
...
(assert (= result__1 #x0000))
(assert (= (axiom__ Tuple0) true))
(assert (= (mk_int__ref result1) (mk_int__ref i)))
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 amount)) (= temp___489 i1)))
(assert (=> (and (<= 1 i1) (<= i1 amount)) (= temp___488 result__1)))
(assert (=> (and (<= 1 i1) (<= i1 amount)) (=> (< (- i1 1) 65536) (= o (bvshl #x0001 ((_ int2bv 16) (- i1 1)))))))
(assert (=> (and (<= 1 i1) (<= i1 amount)) (=> (not (< (- i1 1) 65536)) (= o #x0000))))
...
(assert (=> (and (<= 1 i1) (<= i1 amount)) (= (bvand result__3 (let ((temp___492 (- i2 1))) (ite (< temp___492 65536) (bvshl #x0001 ((_ int2bv 16) temp___492)) #x0000))) (let ((temp___493 (- i2 1))) (ite (< temp___493 65536) (bvshl #x0001 ((_ int2bv 16) temp___493)) #x0000)))))
...
(assert (<= 1 i9))
(assert (<= i9 amount))
(assert (not (= (bvand bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__ones__result4 (let ((temp___500 (- i9 1))) (ite (< temp___500 65536) (bvshl #x0001 ((_ int2bv 16) temp___500)) #x0000))) (let ((temp___501 (- i9 1))) (ite (< temp___501 65536) (bvshl #x0001 ((_ int2bv 16) temp___501)) #x0000)))))
(check-sat)
(exit)
