...
(declare-const temp___429 (_ BitVec 16))
...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 amount)) (= temp___429 result__1)))
(assert (=> (and (<= 1 i1) (<= i1 amount)) (= temp___428 i1)))
(assert (=> (and (<= 1 i1) (<= i1 amount)) (=> (< (- i1 1) 65536) (= o (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) (- i1 1)))))))
(assert (=> (and (<= 1 i1) (<= i1 amount)) (=> (not (< (- i1 1) 65536)) (= o ((_ int2bv 16) 0)))))
...
(assert (=> (and (<= 1 i1) (<= i1 amount)) (= (bvand result__3 (let ((temp___432 (- i2 1))) (ite (< temp___432 65536) (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) temp___432)) ((_ int2bv 16) 0)))) (let ((temp___433 (- i2 1))) (ite (< temp___433 65536) (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) temp___433)) ((_ int2bv 16) 0))))))
...
(assert (= result3 bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__ones__result))
(assert (= bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__ones__result1 result__6))
...
(assert (= result4 bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__ones__result4))
(declare-const i9 Int)
(assert (<= 1 i9))
(assert (<= i9 amount))
(assert (not (= (bvand bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__ones__result4 (let ((temp___440 (- i9 1))) (ite (< temp___440 65536) (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) temp___440)) ((_ int2bv 16) 0)))) (let ((temp___441 (- i9 1))) (ite (< temp___441 65536) (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) temp___441)) ((_ int2bv 16) 0))))))
(check-sat)
(exit)
