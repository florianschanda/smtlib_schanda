...
(assert (= x86__insaferegion64__result1 (ite (bvuge var (bvadd rsp #x0000000000000008)) (ite (bvult var #xCFFFFFFFFFFFFFFF) true (ite (bvule var #x3FFFFFFFFFFFFFFF) (distinct 1 0) false)) (ite (bvule var #x3FFFFFFFFFFFFFFF) (distinct 1 0) false))))
...
(assert (or (and (bvuge var (bvadd rsp #x0000000000000008)) (bvult var #xCFFFFFFFFFFFFFFF)) (and (bvule var #x3FFFFFFFFFFFFFFF) (bvuge var #x0000000000000000))))
(assert (not (= x86__insaferegion64__result4 true)))
(check-sat)
(exit)
