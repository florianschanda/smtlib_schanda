...
(assert (= x86__insaferegion64__result1 (ite (bvuge var (bvadd rsp ((_ int2bv 64) 8))) (ite (bvult var ((_ int2bv 64) 14987979559889010687)) true (ite (bvule var ((_ int2bv 64) 4611686018427387903)) (of_int 1) false)) (ite (bvule var ((_ int2bv 64) 4611686018427387903)) (of_int 1) false))))
(assert (= (mk_bool__ref x86__insaferegion64__result4) (mk_bool__ref x86__insaferegion64__result2)))
...
(assert (not (or (and (bvuge var (bvadd rsp ((_ int2bv 64) 8))) (bvult var ((_ int2bv 64) 14987979559889010687))) (and (bvule var ((_ int2bv 64) 4611686018427387903)) (bvuge var ((_ int2bv 64) 0))))))
(check-sat)
(exit)
