...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__my_maps__m__map__capacity (us_split_discrs1 container)))) (dynamic_invariant result true false true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant1 ((temp___expr_411 Int) (temp___is_init_408 Bool) (temp___skip_constant_409 Bool) (temp___do_toplevel_410 Bool)) Bool (=> (or (= temp___is_init_408 true) (<= 1 2147483647)) (in_range2 temp___expr_411)))
...
(define-fun default_initial_assumption ((temp___expr_418 us_rep2) (temp___skip_top_level_419 Bool)) Bool (=> (not (= temp___skip_top_level_419 true)) (and (= (is_empty temp___expr_418) true) (= (length2 temp___expr_418) 0))))
...
(define-fun default_initial_assumption1 ((temp___expr_367 us_rep3) (temp___skip_top_level_368 Bool)) Bool (=> (not (= temp___skip_top_level_368 true)) (and (= (is_empty1 temp___expr_367) true) (= (length3 temp___expr_367) 0))))
...
(define-fun dynamic_invariant3 ((temp___expr_354 Int) (temp___is_init_351 Bool) (temp___skip_constant_352 Bool) (temp___do_toplevel_353 Bool)) Bool (=> (or (= temp___is_init_351 true) (<= 1 2147483647)) (in_range3 temp___expr_354)))
(declare-fun has_key1 (us_rep3 Int) Bool)
(declare-fun has_key__function_guard1 (Bool us_rep3 Int) Bool)
(assert (forall ((container1 us_rep3)) (forall ((key Int)) (! (=> (dynamic_invariant3 key true true true) (=> (= (of_int 1) true) (=> (exists ((k Int)) (and (and (in_range3 k) (= (has_key1 container1 k) true)) (= k key))) (= (has_key1 container1 key) true)))) :pattern ((has_key1 container1 key))))))
...
(define-fun dynamic_invariant4 ((temp___expr_360 Int) (temp___is_init_357 Bool) (temp___skip_constant_358 Bool) (temp___do_toplevel_359 Bool)) Bool (=> (or (= temp___is_init_357 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_360)))
...
(assert (forall ((container1 us_rep3)) (forall ((key Int)) (! (=> (and (dynamic_invariant3 key true true true) (= (has_key1 container1 key) true)) (let ((result (get1 container1 key))) (and (=> (= (of_int 1) true) (and (= result (w_get1 container1 (witness1 container1 key))) (forall ((k Int)) (=> (and (in_range3 k) (= (has_key1 container1 k) true)) (= (= k key) (= (witness1 container1 key) (witness1 container1 k))))))) (dynamic_invariant4 result true false true)))) :pattern ((get1 container1 key))))))
...
(assert true)
(assert (forall ((container1 us_rep3)) (forall ((key Int)) (! (=> (and (dynamic_invariant3 key true true true) (= (has_key1 container1 key) true)) (let ((result (witness1 container1 key))) (and (= (has_witness container1 result) true) (dynamic_invariant result true false true)))) :pattern ((witness1 container1 key))))))
(assert (forall ((container1 us_rep3)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant witness2 true true true) (= (has_witness container1 witness2) true)) (dynamic_invariant4 (w_get1 container1 witness2) true false true)) :pattern ((w_get1 container1 witness2))))))
