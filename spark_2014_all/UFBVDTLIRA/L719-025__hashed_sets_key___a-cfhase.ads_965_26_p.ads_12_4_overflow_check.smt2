...
(define-fun dynamic_invariant1 ((temp___expr_319 Int) (temp___is_init_316 Bool) (temp___skip_constant_317 Bool) (temp___do_toplevel_318 Bool)) Bool (=> (or (= temp___is_init_316 true) (<= 1 100)) (in_range2 temp___expr_319)))
...
(define-fun dynamic_invariant3 ((temp___expr_325 Int) (temp___is_init_322 Bool) (temp___skip_constant_323 Bool) (temp___do_toplevel_324 Bool)) Bool (=> (or (= temp___is_init_322 true) (<= 1 100)) (in_range3 temp___expr_325)))
...
(assert (forall ((container us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant3 item true true true) (let ((result (find container item))) (and (=> (< 0 result) (and (<= result (length2 container)) (= (my_eq item (get container result)) true))) (dynamic_invariant result true false true)))) :pattern ((find container item))))))
...
(assert (forall ((container us_rep)) (! (let ((result (elements container))) (and (and (and (and (= (length2 result) (length container)) (forall ((temp___429 Int)) (=> (and (in_range6 temp___429) (= (iter_has_element result temp___429) true)) (= (contains (model__ container) (get result temp___429)) true)))) (forall ((item Int)) (=> (and (in_range5 item) (= (contains (model__ container) item) true)) (and (< 0 (find result item)) (= (my_eq (get result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (= (find result (get result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length container))) (=> (= (my_eq (get result i) (get result j)) true) (= i j)))))))) :pattern ((elements container)))))
...
(assert true)
(define-fun dynamic_invariant4 ((temp___expr_354 Int) (temp___is_init_351 Bool) (temp___skip_constant_352 Bool) (temp___do_toplevel_353 Bool)) Bool (=> (or (= temp___is_init_351 true) (<= 1 100)) (in_range5 temp___expr_354)))
(assert (forall ((container us_rep1)) (forall ((item Int)) (! (=> (dynamic_invariant4 item true true true) (=> (= (of_int 1) true) (=> (exists ((e Int)) (and (and (in_range5 e) (= (contains container e) true)) (= (my_eq e item) true))) (= (contains container item) true)))) :pattern ((contains container item))))))
...
(define-fun dynamic_invariant5 ((temp___expr_385 Int) (temp___is_init_382 Bool) (temp___skip_constant_383 Bool) (temp___do_toplevel_384 Bool)) Bool (=> (or (= temp___is_init_382 true) (<= 0 2147483647)) (in_range6 temp___expr_385)))
...
(define-fun dynamic_invariant6 ((temp___expr_379 Int) (temp___is_init_376 Bool) (temp___skip_constant_377 Bool) (temp___do_toplevel_378 Bool)) Bool (=> (or (= temp___is_init_376 true) (<= 1 100)) (in_range7 temp___expr_379)))
...
(declare-const o1 hash_type)
(declare-const o2 us_main_type)
...
(assert (and (= (mk___rep (mk___split_discrs o8 o9) (mk___split_fields o10)) (intersection__2 (mk___rep target__split_discrs (mk___split_fields target__split_fields)) source)) (and (and (and (and (and (= (length (mk___rep (mk___split_discrs o8 o9) (mk___split_fields o10))) (num_overlaps (model__ (mk___rep target__split_discrs (mk___split_fields target__split_fields))) (model__ source))) (= (ole (model__ (mk___rep (mk___split_discrs o8 o9) (mk___split_fields o10))) (model__ (mk___rep target__split_discrs (mk___split_fields target__split_fields)))) true)) (= (ole (model__ (mk___rep (mk___split_discrs o8 o9) (mk___split_fields o10))) (model__ source)) true)) (= (includes_intersection (model__ (mk___rep (mk___split_discrs o8 o9) (mk___split_fields o10))) (model__ (mk___rep target__split_discrs (mk___split_fields target__split_fields))) (model__ source)) true)) (= (e_elements_included (elements (mk___rep (mk___split_discrs o8 o9) (mk___split_fields o10))) (elements (mk___rep target__split_discrs (mk___split_fields target__split_fields)))) true)) (= (e_elements_included__2 (elements (mk___rep target__split_discrs (mk___split_fields target__split_fields))) (model__ source) (elements (mk___rep (mk___split_discrs o8 o9) (mk___split_fields o10)))) true))))
(assert (and (= o11 (length (mk___rep (mk___split_discrs o8 o9) (mk___split_fields o10)))) (and (in_range1 o11) (<= o11 (to_rep o8)))))
(assert (and (= o6 (length (mk___rep target__split_discrs (mk___split_fields target__split_fields)))) (and (in_range1 o6) (<= o6 (to_rep (rec__p__my_sets__set__capacity target__split_discrs))))))
(assert (= o7 (- (to_rep (rec__p__my_sets__set__capacity target__split_discrs)) o6)))
(assert (not (in_range o7)))
(check-sat)
(exit)
