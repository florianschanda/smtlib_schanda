...
(define-fun o6 () us_rep (mk___rep (mk___split_discrs o2 o3) (mk___split_fields o4)))
(assert (and (= o6 (intersection__2 (mk___rep target__split_discrs (mk___split_fields target__split_fields)) source)) (and (and (and (and (and (= (length o6) (num_overlaps (model__ (mk___rep target__split_discrs (mk___split_fields target__split_fields))) (model__ source))) (= (ole (model__ o6) (model__ (mk___rep target__split_discrs (mk___split_fields target__split_fields)))) true)) (= (ole (model__ o6) (model__ source)) true)) (= (includes_intersection (model__ o6) (model__ (mk___rep target__split_discrs (mk___split_fields target__split_fields))) (model__ source)) true)) (= (e_elements_included (elements o6) (elements (mk___rep target__split_discrs (mk___split_fields target__split_fields)))) true)) (= (e_elements_included__2 (elements (mk___rep target__split_discrs (mk___split_fields target__split_fields))) (model__ source) (elements o6)) true))))
(assert (and (= o5 (length o6)) (and (in_range1 o5) (<= o5 (to_rep o2)))))
(assert (and (= o (length (mk___rep target__split_discrs (mk___split_fields target__split_fields)))) (and (in_range1 o) (<= o (to_rep (rec__p__my_sets__set__capacity target__split_discrs))))))
(assert (= o1 (- (to_rep (rec__p__my_sets__set__capacity target__split_discrs)) o)))
