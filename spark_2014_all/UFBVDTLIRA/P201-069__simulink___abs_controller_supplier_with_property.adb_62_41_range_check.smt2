...
(declare-datatypes () ((tinteger_8B__ref (mk_tinteger_8B__ref (tinteger_8B__content tinteger_8B)))))
(define-fun tinteger_8B__ref___projection ((a tinteger_8B__ref)) tinteger_8B (tinteger_8B__content a))
...
(declare-datatypes () ((integer_8__ref (mk_integer_8__ref (integer_8__content integer_8)))))
(define-fun integer_8__ref___2__projection ((a integer_8__ref)) integer_8 (integer_8__content a))
(define-fun dynamic_invariant ((temp___expr_147 Int) (temp___is_init_144 Bool) (temp___skip_constant_145 Bool) (temp___do_toplevel_146 Bool)) Bool (=> (or (= temp___is_init_144 true) (<= (- 128) 127)) (in_range1 temp___expr_147)))
...
(define-fun dynamic_invariant1 ((temp___expr_159 Int) (temp___is_init_156 Bool) (temp___skip_constant_157 Bool) (temp___do_toplevel_158 Bool)) Bool (=> (or (= temp___is_init_156 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_159)))
...
(define-fun dynamic_invariant2 ((temp___expr_189 (_ BitVec 32)) (temp___is_init_186 Bool) (temp___skip_constant_187 Bool) (temp___do_toplevel_188 Bool)) Bool true)
(declare-fun boolean_to_integer_8 (Bool) Int)
(declare-fun boolean_to_integer_8__function_guard (Int Bool) Bool)
(assert (forall ((b Bool)) (! (dynamic_invariant (boolean_to_integer_8 b) true false true) :pattern ((boolean_to_integer_8 b)))))
...
(assert (=> (<= (- 2147483648) 2147483647) (in_range3 at_rest_switch_out1)))
(assert (=> (<= (- 2147483648) 2147483647) (in_range3 sum_1_out1_sat)))
(assert (bvugt vehicle_speed ((_ int2bv 32) 0)))
(assert (and (= o (bv2nat (bvmul ((_ int2bv 32) 8) vehicle_speed))) (in_range3 (bv2nat (bvmul ((_ int2bv 32) 8) vehicle_speed)))))
(assert (and (= o1 (bv2nat (bvmul ((_ int2bv 32) 10) wheel_speed))) (in_range3 (bv2nat (bvmul ((_ int2bv 32) 10) wheel_speed)))))
(assert (= o2 (- o1 o)))
(assert (and (= o3 o2) (in_range2 o2)))
(assert (= (mk_int__ref result) (mk_int__ref sum_out1)))
(assert (= sum_out11 o3))
(assert (and (= o4 (boolean_to_integer_8 (ite (< sum_out11 0) true false))) (in_range1 o4)))
(assert (and (= o5 (boolean_to_integer_8 (ite (< 0 sum_out11) true false))) (in_range1 o5)))
(assert (= o6 (- o5 o4)))
(assert (and (= o7 o6) (in_range o6)))
(assert (= (mk_int__ref result1) (mk_int__ref sum_1_out1_sat)))
(assert (= sum_1_out1_sat1 o7))
(assert (not (< 127 sum_1_out1_sat1)))
(assert (not (< sum_1_out1_sat1 (- 128))))
(assert (not (in_range1 sum_1_out1_sat1)))
(check-sat)
(exit)
