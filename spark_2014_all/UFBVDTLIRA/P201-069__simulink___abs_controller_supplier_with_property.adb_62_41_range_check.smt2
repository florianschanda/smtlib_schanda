...
(define-fun dynamic_invariant ((temp___expr_172 Int) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool) (temp___do_typ_inv_171 Bool)) Bool (=> (or (= temp___is_init_168 true) (<= (- 128) 127)) (in_range1 temp___expr_172)))
...
(define-fun dynamic_invariant1 ((temp___expr_186 Int) (temp___is_init_182 Bool) (temp___skip_constant_183 Bool) (temp___do_toplevel_184 Bool) (temp___do_typ_inv_185 Bool)) Bool (=> (or (= temp___is_init_182 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_186)))
...
(assert (forall ((b Bool)) (! (dynamic_invariant (boolean_to_integer_8 b) true false true true) :pattern ((boolean_to_integer_8 b)))))
...
(assert (bvugt vehicle_speed #x00000000))
(assert (and (= o (bv2nat (bvmul #x00000008 vehicle_speed))) (in_range3 (bv2nat (bvmul #x00000008 vehicle_speed)))))
(assert (and (= o1 (bv2nat (bvmul #x0000000A wheel_speed))) (in_range3 (bv2nat (bvmul #x0000000A wheel_speed)))))
(assert (= o2 (- o1 o)))
