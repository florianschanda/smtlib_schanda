...
(assert (= sum_out12 o3))
(assert (and (= o4 (boolean_to_integer_8 (ite (< sum_out12 0) true false))) (in_range1 o4)))
(assert (and (= o5 (boolean_to_integer_8 (ite (< 0 sum_out12) true false))) (in_range1 o5)))
(assert (= o6 (- o5 o4)))
(assert (and (= o7 o6) (in_range o6)))
(assert (= (mk_int__ref result1) (mk_int__ref sum_1_out1_sat)))
(assert (= sum_1_out1_sat2 o7))
(assert (not (< 127 sum_1_out1_sat2)))
(assert (not (< sum_1_out1_sat2 (- 128))))
(assert (not (in_range1 sum_1_out1_sat2)))
(check-sat)
(exit)
