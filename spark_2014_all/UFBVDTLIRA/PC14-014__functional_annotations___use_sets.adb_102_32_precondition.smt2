...
(assert (and (= o5 (length (mk___rep s2__split_discrs (mk___split_fields s2__split_fields2)))) (and (in_range2 o5) (<= o5 (to_rep1 (rec__use_sets__my_sets__set__capacity s2__split_discrs))))))
(assert (= o6 (ite (<= i o5) true false)))
(assert (= result2 (ite (<= 1 i) o6 false)))
(assert (= result2 true))
(assert (and (= o7 (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (and (and (and (and (= (length2 o7) (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (forall ((temp___425 Int)) (=> (and (in_range3 temp___425) (= (iter_has_element o7 temp___425) true)) (= (contains (model__ (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (get o7 temp___425)) true)))) (forall ((item Int)) (=> (and (in_range6 item) (= (contains (model__ (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) item) true)) (and (< 0 (find o7 item)) (= (get o7 (find o7 item)) item))))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))))) (= (find o7 (get o7 i2)) i2)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))))) (=> (= (get o7 i2) (get o7 j)) (= i2 j)))))))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
