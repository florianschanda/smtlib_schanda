...
(define-fun default_initial_assumption ((temp___expr_437 us_rep2) (temp___skip_top_level_438 Bool)) Bool (=> (not (= temp___skip_top_level_438 true)) (= (length2 temp___expr_437) 0)))
...
(assert (forall ((container us_rep)) (! (let ((result (keys container))) (and (and (and (and (= (length2 result) (length container)) (forall ((temp___478 Int)) (=> (and (in_range3 temp___478) (= (iter_has_element result temp___478) true)) (= (has_key (model__ container) (get result temp___478)) true)))) (forall ((key Int)) (=> (and (in_range4 key) (= (has_key (model__ container) key) true)) (and (< 0 (find result key)) (= (get result (find result key)) key))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (= (find result (get result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length container))) (=> (= (get result i) (get result j)) (= i j)))))))) :pattern ((keys container)))))
...
(define-fun dynamic_invariant3 ((temp___expr_353 Int) (temp___is_init_349 Bool) (temp___skip_constant_350 Bool) (temp___do_toplevel_351 Bool) (temp___do_typ_inv_352 Bool)) Bool (=> (or (= temp___is_init_349 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_353)))
...
(assert (forall ((attr__tag Int) (key2 Int)) (forall ((container us_rep)) (! (=> (dynamic_invariant4 key2 true true true true) (dynamic_invariant3 (element__21 attr__tag container key2) true false true true)) :pattern ((element__21 attr__tag container key2))))))
...
(define-fun dynamic_invariant5 ((temp___expr_18 Int) (temp___is_init_14 Bool) (temp___skip_constant_15 Bool) (temp___do_toplevel_16 Bool) (temp___do_typ_inv_17 Bool)) Bool (=> (or (= temp___is_init_14 true) (<= (- 2147483648) 2147483647)) (in_range7 temp___expr_18)))
(assert true)
...
(assert (forall ((container us_rep2)) (forall ((key2 Int)) (! (=> (dynamic_invariant4 key2 true true true true) (let ((result (find container key2))) (and (=> (< 0 result) (and (<= result (length2 container)) (= key2 (get container result)))) (dynamic_invariant result true false true true)))) :pattern ((find container key2))))))
...
(define-fun default_initial_assumption1 ((temp___expr_401 us_rep3) (temp___skip_top_level_402 Bool)) Bool (=> (not (= temp___skip_top_level_402 true)) (and (= (is_empty temp___expr_401) true) (= (length3 temp___expr_401) 0))))
(assert true)
...
(assert true)
(define-fun dynamic_invariant7 ((temp___expr_386 Int) (temp___is_init_382 Bool) (temp___skip_constant_383 Bool) (temp___do_toplevel_384 Bool) (temp___do_typ_inv_385 Bool)) Bool (=> (or (= temp___is_init_382 true) (<= 1 2147483647)) (in_range4 temp___expr_386)))
(assert (forall ((container us_rep3)) (forall ((key2 Int)) (! (=> (dynamic_invariant7 key2 true true true true) (=> (= (distinct 1 0) true) (=> (exists ((k Int)) (and (and (in_range4 k) (= (has_key container k) true)) (= k key2))) (= (has_key container key2) true)))) :pattern ((has_key container key2))))))
...
(assert (forall ((container us_rep3)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant7 key2 true true true true) (= (has_key container key2) true)) (let ((result (get1 container key2))) (and (=> (= (distinct 1 0) true) (and (= result (w_get container (witness container key2))) (forall ((k Int)) (=> (and (in_range4 k) (= (has_key container k) true)) (= (= k key2) (= (witness container key2) (witness container k))))))) (dynamic_invariant8 result true false true true)))) :pattern ((get1 container key2))))))
...
(assert true)
(assert (forall ((container us_rep3)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant7 key2 true true true true) (= (has_key container key2) true)) (let ((result (witness container key2))) (and (= (has_witness container result) true) (dynamic_invariant result true false true true)))) :pattern ((witness container key2))))))
...
(define-fun dynamic_invariant9 ((temp___expr_452 Int) (temp___is_init_448 Bool) (temp___skip_constant_449 Bool) (temp___do_toplevel_450 Bool) (temp___do_typ_inv_451 Bool)) Bool (=> (or (= temp___is_init_448 true) (<= 1 2147483647)) (in_range9 temp___expr_452)))
