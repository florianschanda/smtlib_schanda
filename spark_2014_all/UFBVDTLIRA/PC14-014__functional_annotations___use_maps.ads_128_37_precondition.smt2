...
(define-fun dynamic_invariant1 ((temp___expr_385 Int) (temp___is_init_382 Bool) (temp___skip_constant_383 Bool) (temp___do_toplevel_384 Bool)) Bool (=> (or (= temp___is_init_382 true) (<= 1 2147483647)) (in_range2 temp___expr_385)))
...
(define-fun default_initial_assumption ((temp___expr_398 us_rep2) (temp___skip_top_level_399 Bool)) Bool (=> (not (= temp___skip_top_level_399 true)) (= (length2 temp___expr_398) 0)))
...
(assert (forall ((container us_rep)) (! (let ((result (keys container))) (and (and (and (and (= (length2 result) (length container)) (forall ((temp___435 Int)) (=> (and (in_range3 temp___435) (= (iter_has_element result temp___435) true)) (= (has_key (model__ container) (get result temp___435)) true)))) (forall ((key Int)) (=> (and (in_range4 key) (= (has_key (model__ container) key) true)) (and (< 0 (find result key)) (= (get result (find result key)) key))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (= (find result (get result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length container))) (=> (= (get result i) (get result j)) (= i j)))))))) :pattern ((keys container)))))
...
(define-fun key ((container us_rep) (position us_rep1)) Int (get (keys container) (get2 (positions container) position)))
...
(define-fun element ((container us_rep) (position us_rep1)) Int (get1 (model__ container) (key container position)))
...
(define-fun dynamic_invariant3 ((temp___expr_325 Int) (temp___is_init_322 Bool) (temp___skip_constant_323 Bool) (temp___do_toplevel_324 Bool)) Bool (=> (or (= temp___is_init_322 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_325)))
...
(define-fun element__2 ((container us_rep) (key2 Int)) Int (get1 (model__ container) key2))
...
(assert (forall ((container us_rep2)) (forall ((key2 Int)) (! (=> (dynamic_invariant4 key2 true true true) (let ((result (find container key2))) (and (=> (< 0 result) (and (<= result (length2 container)) (= key2 (get container result)))) (dynamic_invariant result true false true)))) :pattern ((find container key2))))))
...
(define-fun default_initial_assumption1 ((temp___expr_367 us_rep3) (temp___skip_top_level_368 Bool)) Bool (=> (not (= temp___skip_top_level_368 true)) (and (= (is_empty temp___expr_367) true) (= (length3 temp___expr_367) 0))))
(assert true)
...
(assert true)
(define-fun dynamic_invariant7 ((temp___expr_354 Int) (temp___is_init_351 Bool) (temp___skip_constant_352 Bool) (temp___do_toplevel_353 Bool)) Bool (=> (or (= temp___is_init_351 true) (<= 1 2147483647)) (in_range4 temp___expr_354)))
(assert (forall ((container us_rep3)) (forall ((key2 Int)) (! (=> (dynamic_invariant7 key2 true true true) (=> (= (of_int 1) true) (=> (exists ((k Int)) (and (and (in_range4 k) (= (has_key container k) true)) (= k key2))) (= (has_key container key2) true)))) :pattern ((has_key container key2))))))
...
(define-fun dynamic_invariant8 ((temp___expr_360 Int) (temp___is_init_357 Bool) (temp___skip_constant_358 Bool) (temp___do_toplevel_359 Bool)) Bool (=> (or (= temp___is_init_357 true) (<= (- 2147483648) 2147483647)) (in_range8 temp___expr_360)))
...
(assert (forall ((container us_rep3)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant7 key2 true true true) (= (has_key container key2) true)) (let ((result (get1 container key2))) (and (=> (= (of_int 1) true) (and (= result (w_get container (witness container key2))) (forall ((k Int)) (=> (and (in_range4 k) (= (has_key container k) true)) (= (= k key2) (= (witness container key2) (witness container k))))))) (dynamic_invariant8 result true false true)))) :pattern ((get1 container key2))))))
(assert (forall ((container us_rep3)) (! (dynamic_invariant (length3 container) true false true) :pattern ((length3 container)))))
(assert (forall ((left us_rep3) (right us_rep3)) (! (= (= (oeq3 left right) true) (and (forall ((key2 Int)) (=> (and (in_range4 key2) (= (has_key left key2) true)) (and (= (has_key right key2) true) (= (get1 right key2) (get1 left key2))))) (forall ((key2 Int)) (=> (and (in_range4 key2) (= (has_key right key2) true)) (= (has_key left key2) true))))) :pattern ((oeq3 left right)))))
...
(assert true)
(assert (forall ((container us_rep3)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant7 key2 true true true) (= (has_key container key2) true)) (let ((result (witness container key2))) (and (= (has_witness container result) true) (dynamic_invariant result true false true)))) :pattern ((witness container key2))))))
(assert (forall ((container us_rep3)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant witness1 true true true) (= (has_witness container witness1) true)) (dynamic_invariant8 (w_get container witness1) true false true)) :pattern ((w_get container witness1))))))
...
(define-fun dynamic_invariant9 ((temp___expr_411 Int) (temp___is_init_408 Bool) (temp___skip_constant_409 Bool) (temp___do_toplevel_410 Bool)) Bool (=> (or (= temp___is_init_408 true) (<= 1 2147483647)) (in_range9 temp___expr_411)))
...
(assert (forall ((container us_rep4)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant witness2 true true true) (= (has_witness1 container witness2) true)) (dynamic_invariant9 (w_get1 container witness2) true false true)) :pattern ((w_get1 container witness2))))))
(declare-const i Int)
(declare-const o Int)
...
(assert (= result true))
(assert (and (= o2 (keys s)) (and (and (and (and (= (length2 o2) (length s)) (forall ((temp___431 Int)) (=> (and (in_range3 temp___431) (= (iter_has_element o2 temp___431) true)) (= (has_key (model__ s) (get o2 temp___431)) true)))) (forall ((key2 Int)) (=> (and (in_range4 key2) (= (has_key (model__ s) key2) true)) (and (< 0 (find o2 key2)) (= (get o2 (find o2 key2)) key2))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (= (find o2 (get o2 i1)) i1)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length s))) (=> (= (get o2 i1) (get o2 j)) (= i1 j)))))))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
