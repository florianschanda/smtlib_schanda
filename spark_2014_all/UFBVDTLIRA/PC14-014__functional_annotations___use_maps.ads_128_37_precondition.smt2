...
(define-fun default_initial_assumption ((temp___expr_437 us_rep1) (temp___skip_top_level_438 Bool)) Bool (=> (not (= temp___skip_top_level_438 true)) (= (length1 temp___expr_437) 0)))
...
(define-fun key ((container us_rep) (position us_rep3)) Int (get (keys container) (get2 (positions container) position)))
(declare-fun key__function_guard (Int us_rep us_rep3) Bool)
(define-fun element ((container us_rep) (position us_rep3)) Int (get1 (model__ container) (key container position)))
...
(define-fun element__2 ((container us_rep) (key1 Int)) Int (get1 (model__ container) key1))
...
(assert (forall ((container us_rep1)) (forall ((key1 Int)) (! (=> (dynamic_invariant6 key1 true true true true) (let ((result (find container key1))) (and (=> (< 0 result) (and (<= result (length1 container)) (= key1 (get container result)))) (dynamic_invariant result true false true true)))) :pattern ((find container key1))))))
...
(assert (forall ((container us_rep2)) (forall ((key1 Int)) (! (=> (and (dynamic_invariant7 key1 true true true true) (= (has_key container key1) true)) (let ((result (get1 container key1))) (and (=> (= (distinct 1 0) true) (and (= result (w_get container (witness container key1))) (forall ((k Int)) (=> (and (in_range4 k) (= (has_key container k) true)) (= (= k key1) (= (witness container key1) (witness container k))))))) (dynamic_invariant8 result true false true true)))) :pattern ((get1 container key1))))))
(assert (forall ((container us_rep2)) (! (dynamic_invariant (length2 container) true false true true) :pattern ((length2 container)))))
(assert (forall ((left us_rep2) (right us_rep2)) (! (= (= (oeq2 left right) true) (and (forall ((key1 Int)) (=> (and (in_range4 key1) (= (has_key left key1) true)) (and (= (has_key right key1) true) (= (get1 right key1) (get1 left key1))))) (forall ((key1 Int)) (=> (and (in_range4 key1) (= (has_key right key1) true)) (= (has_key left key1) true))))) :pattern ((oeq2 left right)))))
...
(assert true)
(assert (forall ((container us_rep2)) (forall ((key1 Int)) (! (=> (and (dynamic_invariant7 key1 true true true true) (= (has_key container key1) true)) (let ((result (witness container key1))) (and (= (has_witness container result) true) (dynamic_invariant result true false true true)))) :pattern ((witness container key1))))))
(assert (forall ((container us_rep2)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant witness1 true true true true) (= (has_witness container witness1) true)) (dynamic_invariant8 (w_get container witness1) true false true true)) :pattern ((w_get container witness1))))))
...
(assert (= result true))
(assert (and (= o2 (keys s)) (and (and (and (and (= (length1 o2) (length s)) (forall ((temp___474 Int)) (=> (and (in_range3 temp___474) (= (iter_has_element o2 temp___474) true)) (= (has_key (model__ s) (get o2 temp___474)) true)))) (forall ((key1 Int)) (=> (and (in_range4 key1) (= (has_key (model__ s) key1) true)) (and (< 0 (find o2 key1)) (= (get o2 (find o2 key1)) key1))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (= (find o2 (get o2 i1)) i1)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length s))) (=> (= (get o2 i1) (get o2 j)) (= i1 j)))))))))
