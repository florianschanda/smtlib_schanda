...
(define-fun dynamic_invariant1 ((temp___expr_267 (_ BitVec 16)) (temp___is_init_264 Bool) (temp___skip_constant_265 Bool) (temp___do_toplevel_266 Bool)) Bool true)
...
(define-fun dynamic_invariant2 ((temp___expr_273 Int) (temp___is_init_270 Bool) (temp___skip_constant_271 Bool) (temp___do_toplevel_272 Bool)) Bool (=> (or (= temp___is_init_270 true) (<= 0 15)) (in_range1 temp___expr_273)))
...
(assert (forall ((v (_ BitVec 16))) (forall ((amount Int)) (! (=> (and (dynamic_invariant1 v true true true) (dynamic_invariant amount true true true)) (dynamic_invariant1 (shift_right v amount) true false true)) :pattern ((shift_right v amount))))))
(assert (forall ((v (_ BitVec 16))) (forall ((amount Int)) (! (=> (and (dynamic_invariant1 v true true true) (dynamic_invariant amount true true true)) (= (shift_right v amount) (ite (and (<= 1 16) (<= 16 8)) ((_ zero_extend 8) (ite (< amount 8) (bvlshr ((_ extract 7 0) v) ((_ int2bv 8) amount)) ((_ int2bv 8) 0))) (ite (and (<= 9 16) (<= 16 16)) (ite (< amount 16) (bvlshr v ((_ int2bv 16) amount)) ((_ int2bv 16) 0)) (ite (and (<= 17 16) (<= 16 32)) ((_ extract 15 0) (bvlshr ((_ zero_extend 16) v) ((_ int2bv 32) amount))) ((_ extract 15 0) (bvlshr ((_ zero_extend 48) v) ((_ int2bv 64) amount)))))))) :pattern ((shift_right v amount))))))
...
(assert (forall ((v (_ BitVec 16))) (forall ((amount Int)) (! (=> (and (dynamic_invariant1 v true true true) (dynamic_invariant amount true true true)) (dynamic_invariant1 (shift_left v amount) true false true)) :pattern ((shift_left v amount))))))
(assert (forall ((v (_ BitVec 16))) (forall ((amount Int)) (! (=> (and (dynamic_invariant1 v true true true) (dynamic_invariant amount true true true)) (= (shift_left v amount) (ite (and (<= 1 16) (<= 16 8)) ((_ zero_extend 8) (ite (< amount 8) (bvshl ((_ extract 7 0) v) ((_ int2bv 8) amount)) ((_ int2bv 8) 0))) (ite (and (<= 9 16) (<= 16 16)) (ite (< amount 16) (bvshl v ((_ int2bv 16) amount)) ((_ int2bv 16) 0)) (ite (and (<= 17 16) (<= 16 32)) ((_ extract 15 0) (bvurem (bvshl ((_ zero_extend 16) v) ((_ int2bv 32) amount)) ((_ int2bv 32) 65536))) ((_ extract 15 0) (bvurem (bvshl ((_ zero_extend 48) v) ((_ int2bv 64) amount)) ((_ int2bv 64) 65536)))))))) :pattern ((shift_left v amount))))))
(declare-fun make_mask (Int) (_ BitVec 16))
(declare-fun make_mask__function_guard ((_ BitVec 16) Int) Bool)
(define-fun dynamic_invariant3 ((temp___expr_279 Int) (temp___is_init_276 Bool) (temp___skip_constant_277 Bool) (temp___do_toplevel_278 Bool)) Bool (=> (or (= temp___is_init_276 true) (<= 1 16)) (in_range2 temp___expr_279)))
...
(assert (<= from to__))
(assert (and (and (and (and (= bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline_always__len__assume (+ (- to__ from) 1)) (in_range (+ (- to__ from) 1))) (= bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline_always__len__assume len)) (and (in_range len) (and (and (and (and (= o len) (in_range2 len)) (and (= bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline_always__mask__assume (make_mask o)) (= bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline_always__mask__assume (shift_right ((_ int2bv 16) 65535) (- 16 o))))) (= bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline_always__mask__assume mask)) (and (and (and (and (= o1 (shift_right value from)) (= o1 (ite (and (<= 1 16) (<= 16 8)) ((_ zero_extend 8) (ite (< from 8) (bvlshr ((_ extract 7 0) value) ((_ int2bv 8) from)) ((_ int2bv 8) 0))) (ite (and (<= 9 16) (<= 16 16)) (ite (< from 16) (bvlshr value ((_ int2bv 16) from)) ((_ int2bv 16) 0)) (ite (and (<= 17 16) (<= 16 32)) ((_ extract 15 0) (bvlshr ((_ zero_extend 16) value) ((_ int2bv 32) from))) ((_ extract 15 0) (bvlshr ((_ zero_extend 48) value) ((_ int2bv 64) from)))))))) (= o2 (bvand o1 mask))) (and (= (mk_t__ref result) (mk_t__ref result__)) (= result__1 o2))) (and (bvule result__1 mask) (and (and (= bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline_always__result1 bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline_always__result2) (= bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline_always__result3 bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline_always__result1)) (and (= (mk_t__ref result1) (mk_t__ref bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline_always__result)) (= bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline_always__result1 result__1)))))))) (and (and (= (mk_t__ref bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline_always__result4) (mk_t__ref bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline_always__result2)) (= result__1 result__2)) (and (= bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline_always__result5 bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline_always__result3) (= result__3 result__1)))))
(assert (and (= o6 (+ (- to__ from) 1)) (in_range2 (+ (- to__ from) 1))))
(assert (and (= o7 (make_mask o6)) (= o7 (shift_right ((_ int2bv 16) 65535) (- 16 o6)))))
(assert (and (= o8 (shift_right value from)) (= o8 (ite (and (<= 1 16) (<= 16 8)) ((_ zero_extend 8) (ite (< from 8) (bvlshr ((_ extract 7 0) value) ((_ int2bv 8) from)) ((_ int2bv 8) 0))) (ite (and (<= 9 16) (<= 16 16)) (ite (< from 16) (bvlshr value ((_ int2bv 16) from)) ((_ int2bv 16) 0)) (ite (and (<= 17 16) (<= 16 32)) ((_ extract 15 0) (bvlshr ((_ zero_extend 16) value) ((_ int2bv 32) from))) ((_ extract 15 0) (bvlshr ((_ zero_extend 48) value) ((_ int2bv 64) from)))))))))
(assert (= o9 (bvand o8 o7)))
(assert (= result2 (ite (= bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline_always__result4 o9) true false)))
(assert (= result2 true))
(assert (and (= o4 (+ (- to__ from) 1)) (in_range2 (+ (- to__ from) 1))))
(assert (and (= o5 (make_mask o4)) (= o5 (shift_right ((_ int2bv 16) 65535) (- 16 o4)))))
(assert (= result3 (ite (bvule bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline_always__result4 o5) true false)))
(assert (= result3 true))
