...
(assert (and (= bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline_always__mask__assume (make_mask o)) (= bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline_always__mask__assume (shift_right ((_ int2bv 16) 65535) (- 16 o)))))
...
(assert (and (= o6 (make_mask o5)) (= o6 (shift_right ((_ int2bv 16) 65535) (- 16 o5)))))
(assert (and (= o7 (shift_right value from)) (= o7 (ite (and (<= 1 16) (<= 16 8)) ((_ zero_extend 8) (ite (< from 8) (bvlshr ((_ extract 7 0) value) ((_ int2bv 8) from)) ((_ int2bv 8) 0))) (ite (and (<= 9 16) (<= 16 16)) (ite (< from 16) (bvlshr value ((_ int2bv 16) from)) ((_ int2bv 16) 0)) (ite (and (<= 17 16) (<= 16 32)) ((_ extract 15 0) (bvlshr ((_ zero_extend 16) value) ((_ int2bv 32) from))) ((_ extract 15 0) (bvlshr ((_ zero_extend 48) value) ((_ int2bv 64) from)))))))))
(assert (= o8 (bvand o7 o6)))
(assert (= result2 (ite (= bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline_always__result4 o8) true false)))
(assert (= result2 true))
(assert (and (= o3 (+ (- to__ from) 1)) (in_range2 (+ (- to__ from) 1))))
(assert (and (= o4 (make_mask o3)) (= o4 (shift_right ((_ int2bv 16) 65535) (- 16 o3)))))
(assert (= result3 (ite (bvule bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline_always__result4 o4) true false)))
(assert (= result3 true))
