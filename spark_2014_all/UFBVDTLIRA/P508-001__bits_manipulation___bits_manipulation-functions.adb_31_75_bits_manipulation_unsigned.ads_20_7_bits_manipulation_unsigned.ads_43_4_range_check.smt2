...
(define-fun dynamic_invariant2 ((temp___expr_318 Int) (temp___is_init_314 Bool) (temp___skip_constant_315 Bool) (temp___do_toplevel_316 Bool) (temp___do_typ_inv_317 Bool)) Bool (=> (or (= temp___is_init_314 true) (<= 0 15)) (in_range1 temp___expr_318)))
...
(define-fun dynamic_invariant3 ((temp___expr_325 Int) (temp___is_init_321 Bool) (temp___skip_constant_322 Bool) (temp___do_toplevel_323 Bool) (temp___do_typ_inv_324 Bool)) Bool (=> (or (= temp___is_init_321 true) (<= 1 16)) (in_range2 temp___expr_325)))
...
(assert (and (= o6 (make_mask o5)) (= o6 (shift_right #xFFFF (- 16 o5)))))
...
(assert (and (= o4 (make_mask o3)) (= o4 (shift_right #xFFFF (- 16 o3)))))
