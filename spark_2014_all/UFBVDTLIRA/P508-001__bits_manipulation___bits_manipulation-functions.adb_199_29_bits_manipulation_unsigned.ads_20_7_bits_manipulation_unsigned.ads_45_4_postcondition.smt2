...
(assert (=> (and (<= 1 i1) (<= i1 amount)) (=> (< (- i1 1) 18446744073709551616) (= o (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) (- i1 1)))))))
(assert (=> (and (<= 1 i1) (<= i1 amount)) (=> (not (< (- i1 1) 18446744073709551616)) (= o ((_ int2bv 64) 0)))))
...
(assert (=> (and (<= 1 i1) (<= i1 amount)) (= (bvand result__3 (let ((temp___490 (- i2 1))) (ite (< temp___490 18446744073709551616) (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) temp___490)) ((_ int2bv 64) 0)))) (let ((temp___491 (- i2 1))) (ite (< temp___491 18446744073709551616) (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) temp___491)) ((_ int2bv 64) 0))))))
...
(assert (= result3 bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__ones__result))
(assert (= bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__ones__result1 result__6))
...
(assert (= result4 bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__ones__result4))
(declare-const i9 Int)
(assert (<= 1 i9))
(assert (<= i9 amount))
(assert (not (= (bvand bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__ones__result4 (let ((temp___498 (- i9 1))) (ite (< temp___498 18446744073709551616) (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) temp___498)) ((_ int2bv 64) 0)))) (let ((temp___499 (- i9 1))) (ite (< temp___499 18446744073709551616) (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) temp___499)) ((_ int2bv 64) 0))))))
(check-sat)
(exit)
