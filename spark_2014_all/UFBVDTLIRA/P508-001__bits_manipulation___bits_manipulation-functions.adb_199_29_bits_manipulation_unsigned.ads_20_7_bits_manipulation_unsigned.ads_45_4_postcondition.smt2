...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 amount)) (= temp___547 i1)))
(assert (=> (and (<= 1 i1) (<= i1 amount)) (= temp___546 result__1)))
...
(assert (=> (and (<= 1 i1) (<= i1 amount)) (= (bvand result__3 (let ((temp___550 (- i2 1))) (ite (< temp___550 18446744073709551616) (bvshl #x0000000000000001 ((_ int2bv 64) temp___550)) #x0000000000000000))) (let ((temp___551 (- i2 1))) (ite (< temp___551 18446744073709551616) (bvshl #x0000000000000001 ((_ int2bv 64) temp___551)) #x0000000000000000)))))
