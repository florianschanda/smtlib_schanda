...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 amount)) (= temp___549 i1)))
(assert (=> (and (<= 1 i1) (<= i1 amount)) (= temp___548 result__1)))
(assert (=> (and (<= 1 i1) (<= i1 amount)) (=> (< (- i1 1) 18446744073709551616) (= o (bvshl #x0000000000000001 ((_ int2bv 64) (- i1 1)))))))
(assert (=> (and (<= 1 i1) (<= i1 amount)) (=> (not (< (- i1 1) 18446744073709551616)) (= o #x0000000000000000))))
...
(assert (=> (and (<= 1 i1) (<= i1 amount)) (= (bvand result__3 (let ((temp___552 (- i2 1))) (ite (< temp___552 18446744073709551616) (bvshl #x0000000000000001 ((_ int2bv 64) temp___552)) #x0000000000000000))) (let ((temp___553 (- i2 1))) (ite (< temp___553 18446744073709551616) (bvshl #x0000000000000001 ((_ int2bv 64) temp___553)) #x0000000000000000)))))
...
(assert (<= 1 i9))
(assert (<= i9 amount))
(assert (not (= (bvand bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__ones__result4 (let ((temp___558 (- i9 1))) (ite (< temp___558 18446744073709551616) (bvshl #x0000000000000001 ((_ int2bv 64) temp___558)) #x0000000000000000))) (let ((temp___559 (- i9 1))) (ite (< temp___559 18446744073709551616) (bvshl #x0000000000000001 ((_ int2bv 64) temp___559)) #x0000000000000000)))))
(check-sat)
(exit)
