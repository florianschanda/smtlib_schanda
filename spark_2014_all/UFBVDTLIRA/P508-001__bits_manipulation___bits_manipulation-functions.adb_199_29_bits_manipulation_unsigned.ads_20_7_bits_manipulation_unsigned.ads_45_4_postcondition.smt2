...
(assert (forall ((us_void_param tuple0)) (! (=> (= (axiom__ us_void_param) true) (forall ((v (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) v) (bvule v ((_ int2bv 64) 18446744073709551615))) (forall ((n Int)) (=> (and (<= 0 n) (<= n 63)) (=> (= (bvand v (ite (< n 18446744073709551616) (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) n)) ((_ int2bv 64) 0))) ((_ int2bv 64) 0)) (= (bvand (bvadd v (ite (< n 18446744073709551616) (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) n)) ((_ int2bv 64) 0))) (ite (< n 18446744073709551616) (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) n)) ((_ int2bv 64) 0))) (ite (< n 18446744073709551616) (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) n)) ((_ int2bv 64) 0))))))))) :pattern ((axiom__ us_void_param)))))
...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 amount)) (and (and (= temp___487 i1) (and (= temp___486 result__1) (and (and (and (ite (< (- i1 1) 18446744073709551616) (= o (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) (- i1 1)))) (= o ((_ int2bv 64) 0))) (= o1 (bvadd result__1 o))) (and (= result__1 result2) (= result__2 o1))) (and (= (bvand result__3 (let ((temp___490 (- i2 1))) (ite (< temp___490 18446744073709551616) (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) temp___490)) ((_ int2bv 64) 0)))) (let ((temp___491 (- i2 1))) (ite (< temp___491 18446744073709551616) (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) temp___491)) ((_ int2bv 64) 0)))) (and (and (=> (<= 1 amount) (dynamic_property 1 amount i2)) (and (<= 1 i2) (<= i2 amount))) (= i2 amount)))))) (and (and (= i2 i6) (= result__3 result__7)) (and (= i7 i2) (= result__8 result__3))))))
...
(assert (= bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__ones__result1 bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__ones__result2))
(assert (= bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__ones__result3 bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__ones__result1))
(assert (= result5 bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__ones__result))
(assert (= bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__ones__result1 result__9))
(assert (= (mk_t__ref bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__ones__result4) (mk_t__ref bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__ones__result2)))
(assert (= i10 i8))
(assert (= result__11 result__9))
(assert (= bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__ones__result5 bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__ones__result3))
(assert (= i11 i9))
(assert (= result__12 result__10))
(assert (= result6 bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__ones__result4))
(declare-const i12 Int)
(assert (<= 1 i12))
(assert (<= i12 amount))
(assert (not (= (bvand bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__ones__result4 (let ((temp___498 (- i12 1))) (ite (< temp___498 18446744073709551616) (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) temp___498)) ((_ int2bv 64) 0)))) (let ((temp___499 (- i12 1))) (ite (< temp___499 18446744073709551616) (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) temp___499)) ((_ int2bv 64) 0))))))
(check-sat)
(exit)
