...
(assert (forall ((regold (_ BitVec 64)) (regnew (_ BitVec 64))) (forall ((val__ (_ BitVec 16))) (! (= (= (writereg16post regold regnew val__) true) (and (= (readreg16 regnew) val__) (= (bvand regnew ((_ int2bv 64) 18446744073709486080)) (bvand regold ((_ int2bv 64) 18446744073709486080))))) :pattern ((writereg16post regold regnew val__))))))
...
(assert true)
(assert (= result rcx))
(assert (= rcx1 (bvor (bvand rcx ((_ int2bv 64) 18446744073709486080)) ((_ zero_extend 48) val__))))
(assert (= rcx1 rcx2))
(assert (= rcx3 rcx1))
