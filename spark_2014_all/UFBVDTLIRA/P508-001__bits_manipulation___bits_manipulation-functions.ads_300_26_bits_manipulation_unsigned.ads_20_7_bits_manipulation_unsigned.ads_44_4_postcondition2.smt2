...
(assert (forall ((size Int)) (=> (and (<= 1 size) (<= size 31)) (bvult (make_mask size) (ite (< size 4294967296) (bvshl #x00000001 ((_ int2bv 32) size)) #x00000000)))))
(assert (= bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma1__result1 bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma1__result2))
(assert (= bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma1__result3 bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma1__result1))
(assert (= o (lemma1_goal Tuple0)))
(assert (= result bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma1__result))
(assert (= bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma1__result1 o))
(assert (= (mk_bool__ref bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma1__result4) (mk_bool__ref bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma1__result2)))
(assert (= bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma1__result5 bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma1__result3))
(assert (= result1 bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma1__result4))
(assert (= bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma1__result4 true))
