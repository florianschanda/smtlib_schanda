...
(assert (not (= (t__content estimatedgroundvelocity5) (bvudiv (bvmul (bvadd (bvmul #x00CF (bvsub thiscount prevcount)) (bvudiv (bvmul (bvmul #x00CF (bvsub thiscount prevcount)) (bvsub currtime thistime)) (bvsub thistime prevtime))) #x0E10) (bvsub currtime prevtime)))))
(check-sat)
(exit)
