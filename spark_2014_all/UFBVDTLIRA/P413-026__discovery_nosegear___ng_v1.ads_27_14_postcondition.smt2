...
(assert true)
(assert true)
(assert (or (and (and (and (= d23 (mk_t__ref d2)) (and (= d13 (mk_t__ref d1)) (and (= t23 (mk_t__ref t2)) (and (= (mk_t__ref t13) (mk_t__ref t1)) (and (= (mk_t__ref estimatedgroundvelocity3) (mk_t__ref estimatedgroundvelocity)) (= estimatedgroundvelocityisavailable2 estimatedgroundvelocityisavailable4)))))) (and (= d24 d21) (and (= d14 d11) (and (= t24 t21) (and (= t14 t11) (and (= estimatedgroundvelocity4 estimatedgroundvelocity1) (= estimatedgroundvelocityisavailable5 estimatedgroundvelocityisavailable2))))))) (and (= thistime prevtime) (and (= (mk_bool__ref result) (mk_bool__ref estimatedgroundvelocityisavailable)) (= estimatedgroundvelocityisavailable2 (of_int 0))))) (and (and (not (= thistime prevtime)) (and (= estimatedgroundvelocityisavailable2 estimatedgroundvelocityisavailable) (= estimatedgroundvelocityisavailable2 estimatedgroundvelocityisavailable1))) (and (and (and (= d23 (mk_t__ref d22)) (and (= d13 (mk_t__ref d12)) (and (= t23 (mk_t__ref t22)) (and (= t12 t13) (and (= estimatedgroundvelocity2 estimatedgroundvelocity3) (= estimatedgroundvelocityisavailable3 estimatedgroundvelocityisavailable4)))))) (and (= d24 d22) (and (= d14 d12) (and (= t24 t22) (and (= t14 t12) (and (= estimatedgroundvelocity4 estimatedgroundvelocity2) (= estimatedgroundvelocityisavailable5 estimatedgroundvelocityisavailable3))))))) (and (and (= (mk_t__ref result1) (mk_t__ref t1)) (= t12 (bvsub thistime prevtime))) (and (and (= (mk_t__ref result2) (mk_t__ref t2)) (= t22 (bvsub currtime thistime))) (and (and (= (mk_t__ref result3) (mk_t__ref d1)) (= d12 (bvmul ((_ int2bv 16) 207) (bvsub thiscount prevcount)))) (and (and (= (mk_t__ref result4) (mk_t__ref d2)) (= d22 (bvudiv (bvmul d12 t22) t12))) (and (and (= estimatedgroundvelocityisavailable2 result5) (= estimatedgroundvelocityisavailable3 (of_int 1))) (and (= (mk_t__ref result6) (mk_t__ref estimatedgroundvelocity)) (= estimatedgroundvelocity2 (bvudiv (bvmul (bvadd d12 d22) ((_ int2bv 16) 3600)) (bvadd t12 t22)))))))))))))
(assert (= d25 d23))
(assert (= d15 d13))
(assert (= t25 t23))
(assert (= t15 (mk_t__ref t13)))
(assert (= estimatedgroundvelocity5 (mk_t__ref estimatedgroundvelocity3)))
...
(assert (not (= (t__content estimatedgroundvelocity5) (bvudiv (bvmul (bvadd (bvmul ((_ int2bv 16) 207) (bvsub thiscount prevcount)) (bvudiv (bvmul (bvmul ((_ int2bv 16) 207) (bvsub thiscount prevcount)) (bvsub currtime thistime)) (bvsub thistime prevtime))) ((_ int2bv 16) 3600)) (bvsub currtime prevtime)))))
(check-sat)
(exit)
