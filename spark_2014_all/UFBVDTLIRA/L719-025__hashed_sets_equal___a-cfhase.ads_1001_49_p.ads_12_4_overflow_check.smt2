...
(assert (forall ((a us_rep1) (b us_rep1)) (! (= (user_eq6 a b) (oeq2 a b)) :pattern ((user_eq6 a b)))))
...
(assert (forall ((container us_rep1)) (forall ((item Int)) (! (=> (dynamic_invariant3 item true true true true) (let ((result (find container item))) (and (=> (< 0 result) (and (<= result (length2 container)) (= (my_eq item (get container result)) true))) (dynamic_invariant result true false true true)))) :pattern ((find container item))))))
...
(assert (and (= o (length right)) (and (in_range1 o) (<= o (to_rep1 (rec__p__my_sets__set__capacity (us_split_discrs1 right)))))))
