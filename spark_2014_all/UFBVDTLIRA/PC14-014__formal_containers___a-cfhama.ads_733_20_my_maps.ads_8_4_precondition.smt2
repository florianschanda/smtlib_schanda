...
(define-fun dynamic_invariant1 ((temp___expr_452 Int) (temp___is_init_448 Bool) (temp___skip_constant_449 Bool) (temp___do_toplevel_450 Bool) (temp___do_typ_inv_451 Bool)) Bool (=> (or (= temp___is_init_448 true) (<= 1 2147483647)) (in_range2 temp___expr_452)))
(declare-fun length1 (us_rep2) Int)
(declare-fun length__function_guard1 (Int us_rep2) Bool)
(declare-fun is_empty (us_rep2) Bool)
(declare-fun is_empty__function_guard (Bool us_rep2) Bool)
(define-fun default_initial_assumption ((temp___expr_460 us_rep2) (temp___skip_top_level_461 Bool)) Bool (=> (not (= temp___skip_top_level_461 true)) (and (= (is_empty temp___expr_460) true) (= (length1 temp___expr_460) 0))))
...
(define-fun default_initial_assumption1 ((temp___expr_401 us_rep3) (temp___skip_top_level_402 Bool)) Bool (=> (not (= temp___skip_top_level_402 true)) (and (= (is_empty1 temp___expr_401) true) (= (length2 temp___expr_401) 0))))
(assert true)
...
(define-fun dynamic_invariant3 ((temp___expr_386 Int) (temp___is_init_382 Bool) (temp___skip_constant_383 Bool) (temp___do_toplevel_384 Bool) (temp___do_typ_inv_385 Bool)) Bool (=> (or (= temp___is_init_382 true) (<= 1 2147483647)) (in_range3 temp___expr_386)))
(assert (forall ((container1 us_rep3)) (forall ((key Int)) (! (=> (dynamic_invariant3 key true true true true) (=> (= (distinct 1 0) true) (=> (exists ((k Int)) (and (and (in_range3 k) (= (has_key1 container1 k) true)) (= k key))) (= (has_key1 container1 key) true)))) :pattern ((has_key1 container1 key))))))
...
(define-fun dynamic_invariant4 ((temp___expr_393 Int) (temp___is_init_389 Bool) (temp___skip_constant_390 Bool) (temp___do_toplevel_391 Bool) (temp___do_typ_inv_392 Bool)) Bool (=> (or (= temp___is_init_389 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_393)))
(assert (forall ((container1 us_rep3)) (forall ((key Int)) (! (=> (and (dynamic_invariant3 key true true true true) (= (has_key1 container1 key) true)) (let ((result (get1 container1 key))) (and (=> (= (distinct 1 0) true) (and (= result (w_get1 container1 (witness1 container1 key))) (forall ((k Int)) (=> (and (in_range3 k) (= (has_key1 container1 k) true)) (= (= k key) (= (witness1 container1 key) (witness1 container1 k))))))) (dynamic_invariant4 result true false true true)))) :pattern ((get1 container1 key))))))
...
(assert true)
(assert (forall ((container1 us_rep3)) (forall ((key Int)) (! (=> (and (dynamic_invariant3 key true true true true) (= (has_key1 container1 key) true)) (let ((result (witness1 container1 key))) (and (= (has_witness container1 result) true) (dynamic_invariant result true false true true)))) :pattern ((witness1 container1 key))))))
(assert (forall ((container1 us_rep3)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant witness2 true true true true) (= (has_witness container1 witness2) true)) (dynamic_invariant4 (w_get1 container1 witness2) true false true true)) :pattern ((w_get1 container1 witness2))))))
...
(assert (and (= o1 (length container)) (and (in_range1 o1) (<= o1 (to_rep1 (rec__my_maps__m__map__capacity (us_split_discrs1 container)))))))
