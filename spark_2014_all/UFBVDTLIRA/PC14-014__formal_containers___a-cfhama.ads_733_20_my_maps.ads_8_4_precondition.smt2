...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (and (= (to_rep (rec__my_maps__m__map__capacity (us_split_discrs1 a))) (to_rep (rec__my_maps__m__map__capacity (us_split_discrs1 b)))) (= (to_rep1 (rec__my_maps__m__map__modulus (us_split_discrs1 a))) (to_rep1 (rec__my_maps__m__map__modulus (us_split_discrs1 b))))) (= (us_main_eq (rec__my_maps__m__map (us_split_fields1 a)) (rec__my_maps__m__map (us_split_fields1 b))) true)) true false))
...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (= (to_rep (rec__my_maps__m__cursor__node (us_split_fields3 a))) (to_rep (rec__my_maps__m__cursor__node (us_split_fields3 b)))) true false))
...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__my_maps__m__map__capacity (us_split_discrs1 container)))) (dynamic_invariant result true false true true))) :pattern ((length container)))))
...
(define-fun default_initial_assumption ((temp___expr_460 us_rep2) (temp___skip_top_level_461 Bool)) Bool (=> (not (= temp___skip_top_level_461 true)) (and (= (is_empty temp___expr_460) true) (= (length2 temp___expr_460) 0))))
...
(define-fun default_initial_assumption1 ((temp___expr_401 us_rep3) (temp___skip_top_level_402 Bool)) Bool (=> (not (= temp___skip_top_level_402 true)) (and (= (is_empty1 temp___expr_401) true) (= (length3 temp___expr_401) 0))))
...
(declare-const temp___1040 count_type)
(declare-const o2 us_rep2)
(declare-const o3 Int)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___1040 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___1040)) no_element))
...
(assert (and (= o3 (length container)) (and (in_range1 o3) (<= o3 (to_rep (rec__my_maps__m__map__capacity (us_split_discrs1 container)))))))
