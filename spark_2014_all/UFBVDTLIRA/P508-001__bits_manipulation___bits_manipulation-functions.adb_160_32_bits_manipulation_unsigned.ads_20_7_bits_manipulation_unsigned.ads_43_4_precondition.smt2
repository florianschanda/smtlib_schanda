...
(assert (forall ((value (_ BitVec 16))) (! (=> (dynamic_invariant1 value true true true true) (= (msb_index_fast_inline value) (msb_index_fast_inline_always value))) :pattern ((msb_index_fast_inline value)))))
...
(assert (forall ((value (_ BitVec 16))) (! (=> (dynamic_invariant1 value true true true true) (= (msb_index_fast_not_inline value) (msb_index_fast_inline_always value))) :pattern ((msb_index_fast_not_inline value)))))
...
(assert (forall ((value (_ BitVec 16))) (! (=> (and (dynamic_invariant1 value true true true true) (not (= value #x0000))) (let ((result (msb_index_slow_inline_always value))) (and (= (shift_right value result) #x0001) (dynamic_invariant2 result true false true true)))) :pattern ((msb_index_slow_inline_always value)))))
(declare-fun msb_index_slow_inline ((_ BitVec 16)) Int)
(declare-fun msb_index_slow_inline__function_guard (Int (_ BitVec 16)) Bool)
(assert (forall ((value (_ BitVec 16))) (! (=> (and (dynamic_invariant1 value true true true true) (not (= value #x0000))) (let ((result (msb_index_slow_inline value))) (and (= (shift_right value result) #x0001) (dynamic_invariant2 result true false true true)))) :pattern ((msb_index_slow_inline value)))))
(assert (forall ((value (_ BitVec 16))) (! (=> (dynamic_invariant1 value true true true true) (= (msb_index_slow_inline value) (msb_index_slow_inline_always value))) :pattern ((msb_index_slow_inline value)))))
...
(assert (forall ((value (_ BitVec 16))) (! (=> (and (dynamic_invariant1 value true true true true) (not (= value #x0000))) (let ((result (msb_index_slow_not_inline value))) (and (= (shift_right value result) #x0001) (dynamic_invariant2 result true false true true)))) :pattern ((msb_index_slow_not_inline value)))))
(assert (forall ((value (_ BitVec 16))) (! (=> (dynamic_invariant1 value true true true true) (= (msb_index_slow_not_inline value) (msb_index_slow_inline_always value))) :pattern ((msb_index_slow_not_inline value)))))
