...
(assert (<= from to__))
(assert (= bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline__result1 bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline__result2))
(assert (= bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline__result3 bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline__result1))
...
(assert (= (mk_t__ref result) (mk_t__ref bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline__result)))
(assert (= bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline__result1 o))
(assert (= (mk_t__ref bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline__result4) (mk_t__ref bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline__result2)))
(assert (= bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline__result5 bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline__result3))
(assert (and (= o4 (+ (- to__ from) 1)) (in_range1 (+ (- to__ from) 1))))
(assert (and (= o5 (make_mask o4)) (= o5 (shift_right ((_ int2bv 32) 4294967295) (- 32 o4)))))
(assert (and (= o6 (shift_right value from)) (= o6 (ite (and (<= 1 32) (<= 32 8)) ((_ zero_extend 24) (ite (< from 8) (bvlshr ((_ extract 7 0) value) ((_ int2bv 8) from)) ((_ int2bv 8) 0))) (ite (and (<= 9 32) (<= 32 16)) ((_ zero_extend 16) (ite (< from 16) (bvlshr ((_ extract 15 0) value) ((_ int2bv 16) from)) ((_ int2bv 16) 0))) (ite (and (<= 17 32) (<= 32 32)) (bvlshr value ((_ int2bv 32) from)) ((_ extract 31 0) (bvlshr ((_ zero_extend 32) value) ((_ int2bv 64) from)))))))))
(assert (= o7 (bvand o6 o5)))
(assert (= result1 (ite (= bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline__result4 o7) true false)))
(assert (= result1 true))
(assert (and (= o2 (+ (- to__ from) 1)) (in_range1 (+ (- to__ from) 1))))
(assert (and (= o3 (make_mask o2)) (= o3 (shift_right ((_ int2bv 32) 4294967295) (- 32 o2)))))
(assert (= result2 (ite (bvule bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline__result4 o3) true false)))
(assert (= result2 true))
