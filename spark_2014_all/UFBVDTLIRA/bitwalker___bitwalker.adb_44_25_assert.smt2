...
(assert (= (bvsub ((_ int2bv 64) 63) left_bv) ((_ int2bv 64) (- 63 left))))
(assert (and (= o1 (- 63 left)) (in_range1 (- 63 left))))
(assert (= o2 ((_ int2bv 64) o1)))
(assert (= bitwalker__pokebit64__B_1__mask__assume (bvshl ((_ int2bv 64) 1) o2)))
...
(assert true)
(assert (forall ((i2 (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i2) (bvule i2 ((_ int2bv 64) 63))) (=> (not (= i2 (bvsub ((_ int2bv 64) 63) left_bv))) (= (= (nth_bv r i2) true) (= (nth_bv value i2) true))))))
(assert (forall ((i2 Int)) (=> (and (<= 0 i2) (<= i2 63)) (and (bvule ((_ int2bv 64) 0) ((_ int2bv 64) i2)) (bvule ((_ int2bv 64) i2) ((_ int2bv 64) 63))))))
(assert (= flag true))
(assert (not (= (nth_bv r (bvsub ((_ int2bv 64) 63) left_bv)) true)))
(check-sat)
(exit)
