...
(declare-const temp___938 us_rep1)
...
(assert (and (= temp___938 (keys s2)) (and (and (and (and (= (length1 temp___938) (length3 s2)) (forall ((temp___474 Int)) (=> (and (in_range3 temp___474) (= (iter_has_element temp___938 temp___474) true)) (= (has_key (model__ s2) (get temp___938 temp___474)) true)))) (forall ((key1 Int)) (=> (and (in_range1 key1) (= (has_key (model__ s2) key1) true)) (and (< 0 (find temp___938 key1)) (= (get temp___938 (find temp___938 key1)) key1))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length3 s2))) (= (find temp___938 (get temp___938 i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length3 s2))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length3 s2))) (=> (= (get temp___938 i) (get temp___938 j)) (= i j)))))))))
(assert (and (= o2 (iter_has_element temp___938 temp___937)) (= (= o2 true) (and (<= 1 temp___937) (<= temp___937 (last temp___938))))))
(assert (= (= o3 true) (in_range3 temp___937)))
(assert (= result7 (ite (= o3 true) o2 false)))
(assert (= result7 true))
(assert (not (<= 1 temp___937)))
(check-sat)
(exit)
