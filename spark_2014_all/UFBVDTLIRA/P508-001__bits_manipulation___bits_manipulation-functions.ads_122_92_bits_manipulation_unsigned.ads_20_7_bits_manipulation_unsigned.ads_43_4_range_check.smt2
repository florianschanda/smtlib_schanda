...
(define-fun dynamic_invariant2 ((temp___expr_279 Int) (temp___is_init_276 Bool) (temp___skip_constant_277 Bool) (temp___do_toplevel_278 Bool)) Bool (=> (or (= temp___is_init_276 true) (<= 1 16)) (in_range1 temp___expr_279)))
