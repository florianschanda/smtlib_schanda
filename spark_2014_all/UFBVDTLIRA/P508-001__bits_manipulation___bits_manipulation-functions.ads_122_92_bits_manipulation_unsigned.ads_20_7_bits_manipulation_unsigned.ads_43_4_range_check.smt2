...
(define-fun dynamic_invariant2 ((temp___expr_325 Int) (temp___is_init_321 Bool) (temp___skip_constant_322 Bool) (temp___do_toplevel_323 Bool) (temp___do_typ_inv_324 Bool)) Bool (=> (or (= temp___is_init_321 true) (<= 1 16)) (in_range2 temp___expr_325)))
...
(declare-const n Int)
(assert (bvule #x0000 value))
(assert (bvule value #xFFFF))
(assert (<= 0 n))
(assert (<= n 15))
(assert (not (in_range2 (- 15 n))))
(check-sat)
(exit)
