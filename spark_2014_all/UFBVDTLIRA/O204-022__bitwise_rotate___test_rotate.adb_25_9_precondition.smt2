...
(declare-fun user_eq (longword_t longword_t) Bool)
(declare-const dummy longword_t)
...
(declare-fun r ((_ BitVec 64) (_ BitVec 64)) (_ BitVec 64))
(declare-fun r__function_guard ((_ BitVec 64) (_ BitVec 64) (_ BitVec 64)) Bool)
(assert (forall ((a (_ BitVec 64)) (b (_ BitVec 64))) (! (=> (and (and (dynamic_invariant a true true true) (dynamic_invariant b true true true)) (and (bvule a ((_ int2bv 64) 18446744073709551615)) (and (not (= a ((_ int2bv 64) 0))) (bvule b ((_ int2bv 64) 2147483647))))) (let ((result (r a b))) (and (not (= result ((_ int2bv 64) 0))) (dynamic_invariant result true false true)))) :pattern ((r a b)))))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const x (_ BitVec 64))
(declare-const o (_ BitVec 64))
(assert true)
(assert (not (bvule ((_ int2bv 64) 1) ((_ int2bv 64) 18446744073709551615))))
(check-sat)
(exit)
