...
(assert (forall ((a (_ BitVec 64)) (b (_ BitVec 64))) (! (=> (and (and (dynamic_invariant a true true true true) (dynamic_invariant b true true true true)) (and (bvule a #xFFFFFFFFFFFFFFFF) (and (not (= a #x0000000000000000)) (bvule b #x000000007FFFFFFF)))) (let ((result (r a b))) (and (not (= result #x0000000000000000)) (dynamic_invariant result true false true true)))) :pattern ((r a b)))))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(assert (not (bvule #x0000000000000001 #xFFFFFFFFFFFFFFFF)))
(check-sat)
(exit)
