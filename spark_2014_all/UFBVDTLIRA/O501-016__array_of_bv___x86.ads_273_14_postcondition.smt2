...
(declare-const x86__di__result (_ BitVec 16))
(declare-const result (_ BitVec 16))
(declare-const x86__di__result1 (_ BitVec 16))
(declare-const x86__di__result2 (_ BitVec 16))
(declare-const x86__di__result3 (_ BitVec 16))
(declare-const x86__di__result4 (_ BitVec 16))
(declare-const x86__di__result5 (_ BitVec 16))
(declare-const result1 (_ BitVec 16))
(assert (= x86__di__result1 x86__di__result2))
(assert (= x86__di__result3 x86__di__result1))
(assert (= (mk_t__ref result) (mk_t__ref x86__di__result)))
(assert (= x86__di__result1 ((_ extract 15 0) (bvand rdi ((_ int2bv 64) 65535)))))
(assert (= (mk_t__ref x86__di__result4) (mk_t__ref x86__di__result2)))
(assert (= x86__di__result5 x86__di__result3))
(assert (= result1 x86__di__result4))
(assert (not (= x86__di__result4 ((_ extract 15 0) (bvand rdi ((_ int2bv 64) 65535))))))
(check-sat)
(exit)
