...
(declare-const pack__next__result (_ BitVec 8))
(declare-const result (_ BitVec 8))
(declare-const pack__next__result1 (_ BitVec 8))
(declare-const pack__next__result2 (_ BitVec 8))
(declare-const pack__next__result3 (_ BitVec 8))
...
(assert (= pack__next__result1 (bvadd m #x01)))
(assert (= (mk_t__ref pack__next__result4) (mk_t__ref pack__next__result2)))
(assert (= pack__next__result5 pack__next__result3))
(assert (= result1 pack__next__result4))
(assert (not (= pack__next__result4 (bvadd m #x01))))
(check-sat)
(exit)
