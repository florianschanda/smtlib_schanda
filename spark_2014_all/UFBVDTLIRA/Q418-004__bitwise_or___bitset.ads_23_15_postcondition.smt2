...
(define-fun dynamic_invariant ((temp___expr_135 (_ BitVec 64)) (temp___is_init_132 Bool) (temp___skip_constant_133 Bool) (temp___do_toplevel_134 Bool)) Bool true)
(declare-sort word64_pos 0)
(declare-const attr__ATTRIBUTE_MODULUS1 (_ BitVec 64))
(define-fun in_range1 ((x (_ BitVec 64))) Bool (and (bvule ((_ int2bv 64) 0) x) (bvule x ((_ int2bv 64) 63))))
...
(define-fun dynamic_invariant1 ((temp___expr_141 (_ BitVec 64)) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool (=> (or (= temp___is_init_138 true) (bvule ((_ int2bv 64) 0) ((_ int2bv 64) 63))) (in_range1 temp___expr_141)))
(declare-fun bit_test ((_ BitVec 64) (_ BitVec 64)) Bool)
(declare-fun bit_test__function_guard (Bool (_ BitVec 64) (_ BitVec 64)) Bool)
(assert (forall ((value (_ BitVec 64)) (pos (_ BitVec 64))) (! (=> (and (dynamic_invariant value true true true) (dynamic_invariant1 pos true true true)) (= (= (bit_test value pos) true) (not (= (bvand value (let ((temp___145 (bv2nat pos))) (ite (< temp___145 18446744073709551616) (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) temp___145)) ((_ int2bv 64) 0)))) ((_ int2bv 64) 0))))) :pattern ((bit_test value pos)))))
...
(declare-const bitset__bit_set__result1 (_ BitVec 64))
(declare-const bitset__bit_set__result2 (_ BitVec 64))
(declare-const bitset__bit_set__result3 (_ BitVec 64))
(declare-const res3 (_ BitVec 64))
(declare-const bitset__bit_set__result4 (_ BitVec 64))
(declare-const res4 (_ BitVec 64))
(declare-const bitset__bit_set__result5 (_ BitVec 64))
...
(assert (= res1 value))
(assert true)
(assert (=> (< (bv2nat pos) 18446744073709551616) (= o (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) (bv2nat pos))))))
(assert (=> (not (< (bv2nat pos) 18446744073709551616)) (= o ((_ int2bv 64) 0))))
(assert (= o1 (bvor res1 o)))
(assert (= result1 res1))
(assert (= res2 o1))
(assert (= bitset__bit_set__result1 bitset__bit_set__result2))
(assert (= bitset__bit_set__result3 bitset__bit_set__result1))
(assert (= result2 bitset__bit_set__result))
(assert (= bitset__bit_set__result1 res2))
(assert (= (mk_t__ref bitset__bit_set__result4) (mk_t__ref bitset__bit_set__result2)))
(assert (= res3 res2))
(assert (= bitset__bit_set__result5 bitset__bit_set__result3))
(assert (= res4 res2))
(assert (= result3 bitset__bit_set__result4))
(assert (= (bit_test bitset__bit_set__result4 pos) true))
(assert (not true))
(check-sat)
(exit)
