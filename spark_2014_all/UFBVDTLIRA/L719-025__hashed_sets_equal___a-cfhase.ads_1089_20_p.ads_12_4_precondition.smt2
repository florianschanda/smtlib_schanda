...
(assert (forall ((container1 us_rep3)) (forall ((position Int)) (! (=> (and (dynamic_invariant6 position true true true true) (and (<= 1 position) (<= position (last container1)))) (dynamic_invariant7 (get1 container1 position) true false true true)) :pattern ((get1 container1 position))))))
