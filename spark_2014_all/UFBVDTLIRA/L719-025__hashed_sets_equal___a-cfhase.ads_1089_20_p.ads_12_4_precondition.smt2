...
(assert (forall ((container1 us_rep3)) (forall ((position Int)) (! (=> (and (dynamic_invariant6 position true true true) (and (<= 1 position) (<= position (last container1)))) (dynamic_invariant7 (get1 container1 position) true false true)) :pattern ((get1 container1 position))))))
...
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___789 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___789)) no_element))
