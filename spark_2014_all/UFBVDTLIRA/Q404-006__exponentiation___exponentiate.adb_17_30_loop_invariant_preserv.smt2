...
(assert (=> (= (bvurem cur_exp2 ((_ int2bv 32) 2)) ((_ int2bv 32) 1)) (= result__2 result5)))
...
(assert (= cur_exp2 result6))
(assert (= cur_exp3 (bvudiv cur_exp2 ((_ int2bv 32) 2))))
(assert (= cur_val2 result7))
(assert (= cur_val3 (bvmul cur_val2 cur_val2)))
(assert (and (= o9 (+ iter2 1)) (in_range1 (+ iter2 1))))
(assert (= iter2 result8))
(assert (= iter3 o9))
