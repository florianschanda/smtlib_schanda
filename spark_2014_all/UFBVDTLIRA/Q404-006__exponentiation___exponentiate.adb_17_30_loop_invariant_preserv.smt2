...
(assert (=> (= (bvurem cur_exp2 #x00000002) #x00000001) (= result__2 result4)))
(assert (=> (= (bvurem cur_exp2 #x00000002) #x00000001) (= result__3 (bvmul result__2 cur_val2))))
(assert (=> (not (= (bvurem cur_exp2 #x00000002) #x00000001)) (= result__3 result__2)))
(assert (= cur_exp2 result5))
(assert (= cur_exp3 (bvudiv cur_exp2 #x00000002)))
(assert (= cur_val2 result6))
(assert (= cur_val3 (bvmul cur_val2 cur_val2)))
(assert (and (= o (+ iter2 1)) (in_range1 (+ iter2 1))))
(assert (= iter2 result7))
(assert (= iter3 o))
(assert (not (= cur_exp3 #x00000000)))
(assert (not (= result__3 (power val__ (bv2nat (bvurem ((_ int2bv 32) exp1) (pow21 iter3)))))))
(check-sat)
(exit)
