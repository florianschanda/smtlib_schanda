...
(assert (forall ((j Int)) (=> (and (<= 0 j) (<= j i2)) (bvugt (shift_right value j) ((_ int2bv 32) 1)))))
(assert (and (and (=> (<= 0 31) (in_range1 i2)) (=> (<= 0 31) (in_range1 result__3))) (and (<= 0 i2) (<= i2 31))))
(assert (not (= i2 31)))
(assert (= i2 result3))
(assert (= i3 (+ i2 1)))
(assert (= result__3 result4))
(assert (= result__4 i3))
(assert (and (= o1 (shift_right value i3)) (= o1 (ite (and (<= 1 32) (<= 32 8)) ((_ zero_extend 24) (ite (< i3 8) (bvlshr ((_ extract 7 0) value) ((_ int2bv 8) i3)) ((_ int2bv 8) 0))) (ite (and (<= 9 32) (<= 32 16)) ((_ zero_extend 16) (ite (< i3 16) (bvlshr ((_ extract 15 0) value) ((_ int2bv 16) i3)) ((_ int2bv 16) 0))) (ite (and (<= 17 32) (<= 32 32)) (bvlshr value ((_ int2bv 32) i3)) ((_ extract 31 0) (bvlshr ((_ zero_extend 32) value) ((_ int2bv 64) i3)))))))))
