...
(define-fun dynamic_invariant ((temp___expr_346 Int) (temp___is_init_342 Bool) (temp___skip_constant_343 Bool) (temp___do_toplevel_344 Bool) (temp___do_typ_inv_345 Bool)) Bool (=> (or (= temp___is_init_342 true) (<= 0 2147483647)) (in_range2 temp___expr_346)))
...
(define-fun default_initial_assumption ((temp___expr_430 us_rep2) (temp___skip_top_level_431 Bool)) Bool (=> (not (= temp___skip_top_level_431 true)) (= (length temp___expr_430) 0)))
...
(define-fun default_initial_assumption1 ((temp___expr_453 us_rep3) (temp___skip_top_level_454 Bool)) Bool (=> (not (= temp___skip_top_level_454 true)) (and (= (is_empty temp___expr_453) true) (= (length1 temp___expr_453) 0))))
...
(assert (forall ((container us_rep)) (! (let ((result (elements container))) (and (and (and (and (= (length result) (length2 container)) (forall ((temp___471 Int)) (=> (and (in_range4 temp___471) (= (iter_has_element result temp___471) true)) (= (contains (model__ container) (get result temp___471)) true)))) (forall ((item Int)) (=> (and (in_range6 item) (= (contains (model__ container) item) true)) (and (< 0 (find result item)) (= (get result (find result item)) item))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length2 container))) (= (find result (get result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length2 container))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length2 container))) (=> (= (get result i) (get result j)) (= i j)))))))) :pattern ((elements container)))))
...
(assert (forall ((container us_rep)) (! (let ((result (length2 container))) (and (<= result (to_rep (rec__use_sets__my_sets__set__capacity (us_split_discrs1 container)))) (dynamic_invariant6 result true false true true))) :pattern ((length2 container)))))
...
(assert (forall ((container us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant4 item true true true true) (let ((result (find container item))) (and (=> (< 0 result) (and (<= result (length container)) (= item (get container result)))) (dynamic_invariant6 result true false true true)))) :pattern ((find container item))))))
...
(assert true)
(define-fun dynamic_invariant7 ((temp___expr_386 Int) (temp___is_init_382 Bool) (temp___skip_constant_383 Bool) (temp___do_toplevel_384 Bool) (temp___do_typ_inv_385 Bool)) Bool (=> (or (= temp___is_init_382 true) (<= 0 2147483647)) (in_range6 temp___expr_386)))
(assert (forall ((container us_rep4)) (forall ((item Int)) (! (=> (dynamic_invariant7 item true true true true) (=> (= (distinct 1 0) true) (=> (exists ((e1 Int)) (and (and (in_range6 e1) (= (contains container e1) true)) (= e1 item))) (= (contains container item) true)))) :pattern ((contains container item))))))
(assert (forall ((container us_rep4)) (! (dynamic_invariant6 (length4 container) true false true true) :pattern ((length4 container)))))
...
(assert (forall ((container us_rep2)) (! (let ((result (length container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant6 result true false true true))) :pattern ((length container)))))
...
(assert true)
(assert (forall ((container us_rep3)) (forall ((key us_rep1)) (! (=> (= (has_key container key) true) (let ((result (witness container key))) (and (= (has_witness container result) true) (dynamic_invariant6 result true false true true)))) :pattern ((witness container key))))))
...
(declare-const use_sets__my_find__result1 us_rep1)
...
(define-fun use_sets__my_find__cu__assume1 () us_rep1 (mk___rep1 (mk___split_fields1 use_sets__my_find__cu__assume)))
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___904 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___904)) no_element))
(assert (in_range2 e))
...
(assert (= use_sets__my_find__result1 (mk___rep1 (mk___split_fields1 use_sets__my_find__result))))
