...
(define-fun default_initial_assumption ((temp___expr_446 us_rep2) (temp___skip_top_level_447 Bool)) Bool (=> (not (= temp___skip_top_level_447 true)) (and (= (is_empty temp___expr_446) true) (= (length2 temp___expr_446) 0))))
...
(define-fun default_initial_assumption1 ((temp___expr_423 us_rep3) (temp___skip_top_level_424 Bool)) Bool (=> (not (= temp___skip_top_level_424 true)) (= (length3 temp___expr_423) 0)))
...
(assert (forall ((container1 us_rep)) (! (let ((result (elements container1))) (and (and (and (and (= (length3 result) (length container1)) (forall ((temp___464 Int)) (=> (and (in_range5 temp___464) (= (iter_has_element result temp___464) true)) (= (contains (model__ container1) (get1 result temp___464)) true)))) (forall ((item Int)) (=> (and (in_range4 item) (= (contains (model__ container1) item) true)) (and (< 0 (find result item)) (= (get1 result (find result item)) item))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (= (find result (get1 result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length container1))) (=> (= (get1 result i) (get1 result j)) (= i j)))))))) :pattern ((elements container1)))))
...
(declare-const temp___1275 count_type)
(declare-const o2 us_rep2)
(declare-const o3 Int)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___1275 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___1275)) no_element))
