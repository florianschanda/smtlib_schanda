...
(assert (= result__2 o1))
(assert (not (= (bvand result__2 (let ((temp___521 (- i1 1))) (ite (< temp___521 4294967296) (bvshl #x00000001 ((_ int2bv 32) temp___521)) #x00000000))) (let ((temp___522 (- i1 1))) (ite (< temp___522 4294967296) (bvshl #x00000001 ((_ int2bv 32) temp___522)) #x00000000)))))
(check-sat)
(exit)
