...
(assert (<= 1 i1))
(assert (<= i1 amount))
(assert (=> (< (- i1 1) 4294967296) (= o (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) (- i1 1))))))
(assert (=> (not (< (- i1 1) 4294967296)) (= o ((_ int2bv 32) 0))))
(assert (= o1 (bvadd result__1 o)))
(assert (= result__1 result2))
(assert (= result__2 o1))
(assert (not (= (bvand result__2 (let ((temp___461 (- i1 1))) (ite (< temp___461 4294967296) (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) temp___461)) ((_ int2bv 32) 0)))) (let ((temp___462 (- i1 1))) (ite (< temp___462 4294967296) (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) temp___462)) ((_ int2bv 32) 0))))))
(check-sat)
(exit)
