...
(assert true)
(assert (= result r11))
(assert (= r111 (bvor (bvand r11 ((_ int2bv 64) 18446744073709551360)) ((_ zero_extend 56) val__))))
(assert (= r111 r112))
(assert (= r113 r111))
(assert (not (= r112 (bvor (bvand r11 ((_ int2bv 64) 18446744073709551360)) ((_ zero_extend 56) val__)))))
(check-sat)
(exit)
