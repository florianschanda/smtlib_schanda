...
(define-fun in_range1 ((x (_ BitVec 8))) Bool (and (bvule #x00 x) (bvule x #x3F)))
...
(define-fun dynamic_invariant ((temp___expr_272 (_ BitVec 8)) (temp___is_init_268 Bool) (temp___skip_constant_269 Bool) (temp___do_toplevel_270 Bool) (temp___do_typ_inv_271 Bool)) Bool (=> (or (= temp___is_init_268 true) (bvule #x00 #x3F)) (in_range1 temp___expr_272)))
...
(define-fun dynamic_invariant1 ((temp___expr_335 (_ BitVec 16)) (temp___is_init_331 Bool) (temp___skip_constant_332 Bool) (temp___do_toplevel_333 Bool) (temp___do_typ_inv_334 Bool)) Bool (=> (or (= temp___is_init_331 true) (bvule #x0000 #x7FFF)) (in_range2 temp___expr_335)))
...
(assert (= register_id #x23))
(assert (= sub_register #x001E))
(assert (in_range1 register_id))
(assert (in_range2 sub_register))
(assert (<= 1 3))
(assert (not (<= 3 2147483647)))
(check-sat)
(exit)
