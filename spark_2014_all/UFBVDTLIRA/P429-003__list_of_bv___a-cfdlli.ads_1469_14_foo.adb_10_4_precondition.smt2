...
(define-fun dynamic_invariant ((temp___expr_221 (_ BitVec 8)) (temp___is_init_217 Bool) (temp___skip_constant_218 Bool) (temp___do_toplevel_219 Bool) (temp___do_typ_inv_220 Bool)) Bool true)
...
(define-fun default_initial_assumption ((temp___expr_235 us_rep1) (temp___skip_top_level_236 Bool)) Bool (= (to_rep (rec__foo__lists__cursor__node (us_split_fields3 temp___expr_235))) 0))
...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__foo__lists__list__capacity (us_split_discrs1 container)))) (dynamic_invariant1 result true false true true))) :pattern ((length container)))))
...
(define-fun contains ((container us_rep2) (fst Int) (lst Int) (item (_ BitVec 8))) Bool (ite (exists ((i Int)) (and (and (<= fst i) (<= i lst)) (= (get container i) item))) true false))
(declare-fun contains__function_guard (Bool us_rep2 Int Int (_ BitVec 8)) Bool)
...
(define-fun dynamic_invariant2 ((temp___expr_286 Int) (temp___is_init_282 Bool) (temp___skip_constant_283 Bool) (temp___do_toplevel_284 Bool) (temp___do_typ_inv_285 Bool)) Bool (=> (or (= temp___is_init_282 true) (<= 1 2147483647)) (in_range2 temp___expr_286)))
...
(define-fun default_initial_assumption2 ((temp___expr_280 us_rep1) (temp___skip_top_level_281 Bool)) Bool (= (to_rep (rec__foo__lists__cursor__node (us_split_fields3 temp___expr_280))) 0))
...
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___509 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___509)) no_element))
(assert (or (= (has_key (positions container) position) true) (= (bool_eq1 position no_element) true)))
(assert (=> (= (bool_eq1 position no_element) true) (and (= o4 (length container)) (and (in_range1 o4) (<= o4 (to_rep (rec__foo__lists__list__capacity (us_split_discrs1 container))))))))
...
(assert (=> (not (= (bool_eq1 position no_element) true)) (and (= o4 (get1 o3 position)) (and (in_range2 o4) (=> (= (distinct 0 0) true) (and (= o4 (w_get o3 (witness o3 position))) (forall ((k us_rep1)) (=> (= (has_key o3 k) true) (= (= (bool_eq1 k position) true) (= (witness o3 position) (witness o3 k)))))))))))
