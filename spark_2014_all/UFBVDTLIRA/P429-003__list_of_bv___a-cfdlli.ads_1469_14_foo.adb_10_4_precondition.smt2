...
(define-fun dynamic_invariant ((temp___expr_189 (_ BitVec 8)) (temp___is_init_186 Bool) (temp___skip_constant_187 Bool) (temp___do_toplevel_188 Bool)) Bool true)
...
(define-fun default_initial_assumption ((temp___expr_201 us_rep1) (temp___skip_top_level_202 Bool)) Bool (= (to_rep (rec__foo__lists__cursor__node (us_split_fields3 temp___expr_201))) 0))
...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__foo__lists__list__capacity (us_split_discrs1 container)))) (dynamic_invariant1 result true false true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant2 ((temp___expr_245 Int) (temp___is_init_242 Bool) (temp___skip_constant_243 Bool) (temp___do_toplevel_244 Bool)) Bool (=> (or (= temp___is_init_242 true) (<= 1 2147483647)) (in_range2 temp___expr_245)))
...
(define-fun default_initial_assumption2 ((temp___expr_240 us_rep1) (temp___skip_top_level_241 Bool)) Bool (= (to_rep (rec__foo__lists__cursor__node (us_split_fields3 temp___expr_240))) 0))
...
(declare-const temp___465 count_type)
...
(assert (= (mk___rep1 (mk___split_fields1 temp___465)) no_element))
...
(assert (=> (not (= (bool_eq1 position no_element) true)) (and (= o4 (get1 o3 position)) (and (in_range2 o4) (=> (= (of_int 0) true) (and (= o4 (w_get o3 (witness o3 position))) (forall ((k us_rep1)) (=> (= (has_key o3 k) true) (= (= (bool_eq1 k position) true) (= (witness o3 position) (witness o3 k)))))))))))
