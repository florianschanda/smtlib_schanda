...
(assert (forall ((value (_ BitVec 8))) (! (=> (and (dynamic_invariant1 value true true true true) (not (= value #x00))) (let ((result (msb_index_slow_inline_always value))) (and (= (shift_right value result) #x01) (dynamic_invariant2 result true false true true)))) :pattern ((msb_index_slow_inline_always value)))))
