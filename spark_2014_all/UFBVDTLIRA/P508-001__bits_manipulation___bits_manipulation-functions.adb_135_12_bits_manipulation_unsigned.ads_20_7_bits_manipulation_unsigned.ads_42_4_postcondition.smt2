...
(assert (forall ((v (_ BitVec 8))) (forall ((amount Int)) (! (=> (and (dynamic_invariant v true true true true) (dynamic_invariant1 amount true true true true)) (dynamic_invariant (shift_right v amount) true false true true)) :pattern ((shift_right v amount))))))
(assert (forall ((v (_ BitVec 8))) (forall ((amount Int)) (! (=> (and (dynamic_invariant v true true true true) (dynamic_invariant1 amount true true true true)) (= (shift_right v amount) (ite (and (<= 1 8) (<= 8 8)) (ite (< amount 8) (bvlshr v ((_ int2bv 8) amount)) #x00) (ite (and (<= 9 8) (<= 8 16)) ((_ extract 7 0) (ite (< amount 16) (bvlshr ((_ zero_extend 8) v) ((_ int2bv 16) amount)) #x0000)) (ite (and (<= 17 8) (<= 8 32)) ((_ extract 7 0) (bvlshr ((_ zero_extend 24) v) ((_ int2bv 32) amount))) ((_ extract 7 0) (bvlshr ((_ zero_extend 56) v) ((_ int2bv 64) amount)))))))) :pattern ((shift_right v amount))))))
...
(define-fun dynamic_invariant2 ((temp___expr_270 Int) (temp___is_init_266 Bool) (temp___skip_constant_267 Bool) (temp___do_toplevel_268 Bool) (temp___do_typ_inv_269 Bool)) Bool (=> (or (= temp___is_init_266 true) (<= 0 7)) (in_range1 temp___expr_270)))
(declare-fun msb_index_slow_inline_always ((_ BitVec 8)) Int)
(declare-fun msb_index_slow_inline_always__function_guard (Int (_ BitVec 8)) Bool)
(assert (forall ((value (_ BitVec 8))) (! (=> (and (dynamic_invariant value true true true true) (not (= value #x00))) (let ((result (msb_index_slow_inline_always value))) (and (= (shift_right value result) #x01) (dynamic_invariant2 result true false true true)))) :pattern ((msb_index_slow_inline_always value)))))
...
(assert (= bits_manipulation_unsigned__unsigned_8__functions__msb_index_slow_inline__result1 bits_manipulation_unsigned__unsigned_8__functions__msb_index_slow_inline__result2))
(assert (= bits_manipulation_unsigned__unsigned_8__functions__msb_index_slow_inline__result3 bits_manipulation_unsigned__unsigned_8__functions__msb_index_slow_inline__result1))
(assert (and (= o (msb_index_slow_inline_always value)) (and (in_range1 o) (= (shift_right value o) #x01))))
(assert (= result bits_manipulation_unsigned__unsigned_8__functions__msb_index_slow_inline__result))
(assert (= bits_manipulation_unsigned__unsigned_8__functions__msb_index_slow_inline__result1 o))
(assert (= (mk_int__ref bits_manipulation_unsigned__unsigned_8__functions__msb_index_slow_inline__result4) (mk_int__ref bits_manipulation_unsigned__unsigned_8__functions__msb_index_slow_inline__result2)))
(assert (= bits_manipulation_unsigned__unsigned_8__functions__msb_index_slow_inline__result5 bits_manipulation_unsigned__unsigned_8__functions__msb_index_slow_inline__result3))
(assert (= result1 bits_manipulation_unsigned__unsigned_8__functions__msb_index_slow_inline__result4))
(assert (not (= (shift_right value bits_manipulation_unsigned__unsigned_8__functions__msb_index_slow_inline__result4) #x01)))
(check-sat)
(exit)
