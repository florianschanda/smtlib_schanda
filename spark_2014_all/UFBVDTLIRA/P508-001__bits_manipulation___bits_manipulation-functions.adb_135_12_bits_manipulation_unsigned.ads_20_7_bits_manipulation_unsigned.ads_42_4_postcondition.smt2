...
(assert (forall ((v (_ BitVec 8))) (forall ((amount Int)) (! (=> (and (dynamic_invariant v true true true) (dynamic_invariant1 amount true true true)) (dynamic_invariant (shift_right v amount) true false true)) :pattern ((shift_right v amount))))))
(assert (forall ((v (_ BitVec 8))) (forall ((amount Int)) (! (=> (and (dynamic_invariant v true true true) (dynamic_invariant1 amount true true true)) (= (shift_right v amount) (ite (and (<= 1 8) (<= 8 8)) (ite (< amount 8) (bvlshr v ((_ int2bv 8) amount)) ((_ int2bv 8) 0)) (ite (and (<= 9 8) (<= 8 16)) ((_ extract 7 0) (ite (< amount 16) (bvlshr ((_ zero_extend 8) v) ((_ int2bv 16) amount)) ((_ int2bv 16) 0))) (ite (and (<= 17 8) (<= 8 32)) ((_ extract 7 0) (bvlshr ((_ zero_extend 24) v) ((_ int2bv 32) amount))) ((_ extract 7 0) (bvlshr ((_ zero_extend 56) v) ((_ int2bv 64) amount)))))))) :pattern ((shift_right v amount))))))
...
(define-fun dynamic_invariant2 ((temp___expr_231 Int) (temp___is_init_228 Bool) (temp___skip_constant_229 Bool) (temp___do_toplevel_230 Bool)) Bool (=> (or (= temp___is_init_228 true) (<= 0 7)) (in_range1 temp___expr_231)))
...
(assert (forall ((value (_ BitVec 8))) (! (=> (and (dynamic_invariant value true true true) (not (= value ((_ int2bv 8) 0)))) (let ((result (msb_index_slow_inline_always value))) (and (= (shift_right value result) ((_ int2bv 8) 1)) (dynamic_invariant2 result true false true)))) :pattern ((msb_index_slow_inline_always value)))))
...
(assert (and (= o (msb_index_slow_inline_always value)) (and (in_range1 o) (= (shift_right value o) ((_ int2bv 8) 1)))))
...
(assert (not (= (shift_right value bits_manipulation_unsigned__unsigned_8__functions__msb_index_slow_inline__result4) ((_ int2bv 8) 1))))
(check-sat)
(exit)
