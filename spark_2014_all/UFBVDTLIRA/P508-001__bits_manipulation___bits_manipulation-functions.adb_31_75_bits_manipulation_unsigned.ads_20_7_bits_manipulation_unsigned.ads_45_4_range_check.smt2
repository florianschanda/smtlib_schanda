...
(assert (<= from to__))
(assert (and (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__len__assume (+ (- to__ from) 1)) (in_range (+ (- to__ from) 1))))
(assert (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__len__assume len))
(assert (in_range len))
(assert (and (= o len) (in_range2 len)))
(assert (and (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__mask__assume (make_mask o)) (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__mask__assume (shift_right ((_ int2bv 64) 18446744073709551615) (- 64 o)))))
(assert (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__mask__assume mask))
(assert (and (= o1 (shift_right value from)) (= o1 (ite (and (<= 1 64) (<= 64 8)) ((_ zero_extend 56) (ite (< from 8) (bvlshr ((_ extract 7 0) value) ((_ int2bv 8) from)) ((_ int2bv 8) 0))) (ite (and (<= 9 64) (<= 64 16)) ((_ zero_extend 48) (ite (< from 16) (bvlshr ((_ extract 15 0) value) ((_ int2bv 16) from)) ((_ int2bv 16) 0))) (ite (and (<= 17 64) (<= 64 32)) ((_ zero_extend 32) (bvlshr ((_ extract 31 0) value) ((_ int2bv 32) from))) (bvlshr value ((_ int2bv 64) from))))))))
(assert (= o2 (bvand o1 mask)))
(assert (= (mk_t__ref result) (mk_t__ref result__)))
(assert (= result__1 o2))
(assert (bvule result__1 mask))
(assert (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__result1 bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__result2))
(assert (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__result3 bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__result1))
(assert (= (mk_t__ref result1) (mk_t__ref bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__result)))
(assert (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__result1 result__1))
(assert (= (mk_t__ref bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__result4) (mk_t__ref bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__result2)))
(assert (= result__1 result__2))
(assert (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__result5 bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__result3))
(assert (= result__3 result__1))
(assert (and (= o5 (+ (- to__ from) 1)) (in_range2 (+ (- to__ from) 1))))
...
(assert (= result2 (ite (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__result4 o8) true false)))
(assert (= result2 true))
(assert (and (= o3 (+ (- to__ from) 1)) (in_range2 (+ (- to__ from) 1))))
(assert (and (= o4 (make_mask o3)) (= o4 (shift_right ((_ int2bv 64) 18446744073709551615) (- 64 o3)))))
(assert (= result3 (ite (bvule bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__result4 o4) true false)))
(assert (= result3 true))
