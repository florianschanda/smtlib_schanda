...
(define-fun dynamic_invariant1 ((temp___expr_351 (_ BitVec 64)) (temp___is_init_348 Bool) (temp___skip_constant_349 Bool) (temp___do_toplevel_350 Bool)) Bool true)
...
(define-fun dynamic_invariant2 ((temp___expr_357 Int) (temp___is_init_354 Bool) (temp___skip_constant_355 Bool) (temp___do_toplevel_356 Bool)) Bool (=> (or (= temp___is_init_354 true) (<= 0 63)) (in_range1 temp___expr_357)))
...
(assert (forall ((v (_ BitVec 64))) (forall ((amount Int)) (! (=> (and (dynamic_invariant1 v true true true) (dynamic_invariant amount true true true)) (dynamic_invariant1 (shift_right v amount) true false true)) :pattern ((shift_right v amount))))))
(assert (forall ((v (_ BitVec 64))) (forall ((amount Int)) (! (=> (and (dynamic_invariant1 v true true true) (dynamic_invariant amount true true true)) (= (shift_right v amount) (ite (and (<= 1 64) (<= 64 8)) ((_ zero_extend 56) (ite (< amount 8) (bvlshr ((_ extract 7 0) v) ((_ int2bv 8) amount)) ((_ int2bv 8) 0))) (ite (and (<= 9 64) (<= 64 16)) ((_ zero_extend 48) (ite (< amount 16) (bvlshr ((_ extract 15 0) v) ((_ int2bv 16) amount)) ((_ int2bv 16) 0))) (ite (and (<= 17 64) (<= 64 32)) ((_ zero_extend 32) (bvlshr ((_ extract 31 0) v) ((_ int2bv 32) amount))) (bvlshr v ((_ int2bv 64) amount))))))) :pattern ((shift_right v amount))))))
...
(assert (forall ((v (_ BitVec 64))) (forall ((amount Int)) (! (=> (and (dynamic_invariant1 v true true true) (dynamic_invariant amount true true true)) (dynamic_invariant1 (shift_left v amount) true false true)) :pattern ((shift_left v amount))))))
(assert (forall ((v (_ BitVec 64))) (forall ((amount Int)) (! (=> (and (dynamic_invariant1 v true true true) (dynamic_invariant amount true true true)) (= (shift_left v amount) (ite (and (<= 1 64) (<= 64 8)) ((_ zero_extend 56) (ite (< amount 8) (bvshl ((_ extract 7 0) v) ((_ int2bv 8) amount)) ((_ int2bv 8) 0))) (ite (and (<= 9 64) (<= 64 16)) ((_ zero_extend 48) (ite (< amount 16) (bvshl ((_ extract 15 0) v) ((_ int2bv 16) amount)) ((_ int2bv 16) 0))) (ite (and (<= 17 64) (<= 64 32)) ((_ zero_extend 32) (bvshl ((_ extract 31 0) v) ((_ int2bv 32) amount))) (bvshl v ((_ int2bv 64) amount))))))) :pattern ((shift_left v amount))))))
(declare-fun make_mask (Int) (_ BitVec 64))
(declare-fun make_mask__function_guard ((_ BitVec 64) Int) Bool)
(define-fun dynamic_invariant3 ((temp___expr_363 Int) (temp___is_init_360 Bool) (temp___skip_constant_361 Bool) (temp___do_toplevel_362 Bool)) Bool (=> (or (= temp___is_init_360 true) (<= 1 64)) (in_range2 temp___expr_363)))
(assert (forall ((num_bits Int)) (! (=> (dynamic_invariant3 num_bits true true true) (dynamic_invariant1 (make_mask num_bits) true false true)) :pattern ((make_mask num_bits)))))
...
(assert (<= from to__))
(assert (and (and (and (and (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__len__assume (+ (- to__ from) 1)) (in_range (+ (- to__ from) 1))) (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__len__assume len)) (and (in_range len) (and (and (and (and (= o len) (in_range2 len)) (and (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__mask__assume (make_mask o)) (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__mask__assume (shift_right ((_ int2bv 64) 18446744073709551615) (- 64 o))))) (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__mask__assume mask)) (and (and (and (and (= o1 (shift_right value from)) (= o1 (ite (and (<= 1 64) (<= 64 8)) ((_ zero_extend 56) (ite (< from 8) (bvlshr ((_ extract 7 0) value) ((_ int2bv 8) from)) ((_ int2bv 8) 0))) (ite (and (<= 9 64) (<= 64 16)) ((_ zero_extend 48) (ite (< from 16) (bvlshr ((_ extract 15 0) value) ((_ int2bv 16) from)) ((_ int2bv 16) 0))) (ite (and (<= 17 64) (<= 64 32)) ((_ zero_extend 32) (bvlshr ((_ extract 31 0) value) ((_ int2bv 32) from))) (bvlshr value ((_ int2bv 64) from))))))) (= o2 (bvand o1 mask))) (and (= (mk_t__ref result) (mk_t__ref result__)) (= result__1 o2))) (and (bvule result__1 mask) (and (and (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__result1 bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__result2) (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__result3 bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__result1)) (and (= (mk_t__ref result1) (mk_t__ref bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__result)) (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__result1 result__1)))))))) (and (and (= (mk_t__ref bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__result4) (mk_t__ref bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__result2)) (= result__1 result__2)) (and (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__result5 bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__result3) (= result__3 result__1)))))
(assert (and (= o6 (+ (- to__ from) 1)) (in_range2 (+ (- to__ from) 1))))
...
(assert (= result2 (ite (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__result4 o9) true false)))
(assert (= result2 true))
(assert (and (= o4 (+ (- to__ from) 1)) (in_range2 (+ (- to__ from) 1))))
(assert (and (= o5 (make_mask o4)) (= o5 (shift_right ((_ int2bv 64) 18446744073709551615) (- 64 o4)))))
(assert (= result3 (ite (bvule bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__result4 o5) true false)))
(assert (= result3 true))
(assert (not (in_range2 (+ (- to__ from) 1))))
(check-sat)
(exit)
