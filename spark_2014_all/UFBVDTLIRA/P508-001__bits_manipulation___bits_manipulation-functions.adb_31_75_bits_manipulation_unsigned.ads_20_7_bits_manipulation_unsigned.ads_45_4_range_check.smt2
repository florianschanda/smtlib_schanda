...
(define-fun dynamic_invariant2 ((temp___expr_414 Int) (temp___is_init_410 Bool) (temp___skip_constant_411 Bool) (temp___do_toplevel_412 Bool) (temp___do_typ_inv_413 Bool)) Bool (=> (or (= temp___is_init_410 true) (<= 0 63)) (in_range1 temp___expr_414)))
...
(define-fun dynamic_invariant3 ((temp___expr_421 Int) (temp___is_init_417 Bool) (temp___skip_constant_418 Bool) (temp___do_toplevel_419 Bool) (temp___do_typ_inv_420 Bool)) Bool (=> (or (= temp___is_init_417 true) (<= 1 64)) (in_range2 temp___expr_421)))
(assert (forall ((num_bits Int)) (! (=> (dynamic_invariant3 num_bits true true true true) (dynamic_invariant1 (make_mask num_bits) true false true true)) :pattern ((make_mask num_bits)))))
...
(assert (and (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__mask__assume (make_mask o)) (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__mask__assume (shift_right #xFFFFFFFFFFFFFFFF (- 64 o)))))
(assert (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__mask__assume mask))
(assert (and (= o1 (shift_right value from)) (= o1 (ite (and (<= 1 64) (<= 64 8)) ((_ zero_extend 56) (ite (< from 8) (bvlshr ((_ extract 7 0) value) ((_ int2bv 8) from)) #x00)) (ite (and (<= 9 64) (<= 64 16)) ((_ zero_extend 48) (ite (< from 16) (bvlshr ((_ extract 15 0) value) ((_ int2bv 16) from)) #x0000)) (ite (and (<= 17 64) (<= 64 32)) ((_ zero_extend 32) (bvlshr ((_ extract 31 0) value) ((_ int2bv 32) from))) (bvlshr value ((_ int2bv 64) from))))))))
