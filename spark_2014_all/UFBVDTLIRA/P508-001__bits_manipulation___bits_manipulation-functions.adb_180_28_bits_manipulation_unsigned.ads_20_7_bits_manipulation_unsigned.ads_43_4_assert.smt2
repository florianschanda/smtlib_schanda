...
(assert true)
(assert (forall ((us_void_param tuple0)) (! (= (= (lemma1 us_void_param) true) (forall ((size Int)) (=> (and (<= 1 size) (<= size 15)) (bvult (make_mask size) (ite (< size 65536) (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) size)) ((_ int2bv 16) 0)))))) :pattern ((lemma1 us_void_param)))))
...
(assert (<= 1 size))
(assert (<= size 15))
(assert (not (bvult (make_mask size) (ite (< size 65536) (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) size)) ((_ int2bv 16) 0)))))
(check-sat)
(exit)
