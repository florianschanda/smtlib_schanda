...
(assert (=> (and (bvult i1 range_size) (not (= matched1 true))) (= (= matched2 true) (and (bvugt i2 ((_ int2bv 64) 0)) (exists ((n (_ BitVec 64))) (and (and (bvule ((_ int2bv 64) 0) n) (bvule n (bvsub i2 ((_ int2bv 64) 1)))) (= var (bvadd bottom n))))))))
...
(assert (=> (and (bvult i1 range_size) (not (= matched1 true))) (= temp___2061 result2)))
(assert (=> (and (bvult i1 range_size) (not (= matched1 true))) (= temp___2062 i2)))
(assert (=> (and (bvult i1 range_size) (not (= matched1 true))) (or (and (and (and (= i2 i4) (= matched3 matched4)) (and (= i5 i2) (= matched5 matched3))) (and (= var (bvadd bottom i2)) (and (= matched2 result3) (= matched3 (of_int 1))))) (and (and (not (= var (bvadd bottom i2))) (= matched3 matched2)) (and (and (and (= i3 i4) (= matched3 matched4)) (and (= i5 i3) (= matched5 matched3))) (and (and (= i2 result4) (= i3 (bvadd i2 ((_ int2bv 64) 1)))) (not (and (bvult i3 range_size) (not (= matched3 true))))))))))
(assert (=> (and (bvult i1 range_size) (not (= matched1 true))) (= (mk_t__ref i6) (mk_t__ref i4))))
(assert (=> (and (bvult i1 range_size) (not (= matched1 true))) (= (mk_bool__ref matched6) (mk_bool__ref matched4))))
(assert (=> (and (bvult i1 range_size) (not (= matched1 true))) (= i7 i5)))
(assert (=> (and (bvult i1 range_size) (not (= matched1 true))) (= matched7 matched5)))
(assert (=> (and (bvult i1 range_size) (not (= matched1 true))) (= (mk_t__ref i8) (mk_t__ref i6))))
(assert (=> (and (bvult i1 range_size) (not (= matched1 true))) (= (mk_bool__ref matched8) (mk_bool__ref matched6))))
...
(assert (= i10 (mk_t__ref i8)))
(assert (= (mk_bool__ref matched10) (mk_bool__ref matched8)))
