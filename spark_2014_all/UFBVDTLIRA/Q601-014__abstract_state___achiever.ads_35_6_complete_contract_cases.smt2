...
(assert (forall ((i internal_state)) (and (<= (- 2147483648) (internal_stateqtint i)) (<= (internal_stateqtint i) 2147483647))))
...
(define-fun dynamic_invariant ((temp___expr_191 Int) (temp___is_init_187 Bool) (temp___skip_constant_188 Bool) (temp___do_toplevel_189 Bool) (temp___do_typ_inv_190 Bool)) Bool (=> (or (= temp___is_init_187 true) (<= (- 2147483648) 2147483647)) (in_range1 temp___expr_191)))
(assert (forall ((achiever__my_internal_state Int)) (! (=> (dynamic_invariant achiever__my_internal_state true true true true) (dynamic_invariant (get_internal_state achiever__my_internal_state) true false true true)) :pattern ((get_internal_state achiever__my_internal_state)))))
(assert (forall ((achiever__my_internal_state Int)) (! (=> (dynamic_invariant achiever__my_internal_state true true true true) (= (get_internal_state achiever__my_internal_state) achiever__my_internal_state)) :pattern ((get_internal_state achiever__my_internal_state)))))
...
(define-fun dynamic_invariant1 ((temp___expr_177 (_ BitVec 8)) (temp___is_init_173 Bool) (temp___skip_constant_174 Bool) (temp___do_toplevel_175 Bool) (temp___do_typ_inv_176 Bool)) Bool (=> (or (= temp___is_init_173 true) (bvule #x00 #x0F)) (in_range2 temp___expr_177)))
...
(define-fun dynamic_invariant2 ((temp___expr_184 Int) (temp___is_init_180 Bool) (temp___skip_constant_181 Bool) (temp___do_toplevel_182 Bool) (temp___do_typ_inv_183 Bool)) Bool (=> (or (= temp___is_init_180 true) (<= 0 3)) (in_range3 temp___expr_184)))
(assert true)
...
(assert (in_range2 st))
(assert (in_range1 my_internal_state))
