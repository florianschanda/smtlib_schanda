...
(assert (and (= o6 (make_mask o5)) (= o6 (shift_right ((_ int2bv 8) 255) (- 8 o5)))))
(assert (and (= o7 (shift_right value from)) (= o7 (ite (and (<= 1 8) (<= 8 8)) (ite (< from 8) (bvlshr value ((_ int2bv 8) from)) ((_ int2bv 8) 0)) (ite (and (<= 9 8) (<= 8 16)) ((_ extract 7 0) (ite (< from 16) (bvlshr ((_ zero_extend 8) value) ((_ int2bv 16) from)) ((_ int2bv 16) 0))) (ite (and (<= 17 8) (<= 8 32)) ((_ extract 7 0) (bvlshr ((_ zero_extend 24) value) ((_ int2bv 32) from))) ((_ extract 7 0) (bvlshr ((_ zero_extend 56) value) ((_ int2bv 64) from)))))))))
