...
(define-fun dynamic_invariant ((temp___expr_214 (_ BitVec 16)) (temp___is_init_211 Bool) (temp___skip_constant_212 Bool) (temp___do_toplevel_213 Bool)) Bool true)
...
(assert true)
(assert true)
(assert (=> (bvugt val__ ((_ int2bv 8) 127)) (= (mk_t__ref1 result) (mk_t__ref1 retval))))
(assert (=> (bvugt val__ ((_ int2bv 8) 127)) (= retval1 (bvor ((_ int2bv 16) 65280) ((_ zero_extend 8) val__)))))
(assert (=> (not (bvugt val__ ((_ int2bv 8) 127))) (= (mk_t__ref1 result1) (mk_t__ref1 retval))))
(assert (=> (not (bvugt val__ ((_ int2bv 8) 127))) (= retval2 ((_ zero_extend 8) val__))))
...
(assert (not (= x86__signextend8to16__result4 (bvor ((_ int2bv 16) 65280) ((_ zero_extend 8) val__)))))
(check-sat)
(exit)
