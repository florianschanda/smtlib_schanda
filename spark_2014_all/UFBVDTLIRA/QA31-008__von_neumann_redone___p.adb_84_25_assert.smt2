...
(assert (bvule m2 #x0008))
(assert (= bits_g2 (ite (= m2 #x0000) #x0000 (pow21 (bvsub m2 #x0001)))))
(assert (= bits2 (sqr bits_g2)))
(assert (= (bvand res_g2 (bvsub (pow21 m2) #x0001)) #x0000))
(assert (bvult res_g2 (pow21 #x0008)))
(assert (= res2 (bvmul res_g2 (pow21 m2))))
(assert (bvule num2 x))
(assert (= (bvsub x num2) (sqr res_g2)))
(assert (bvule x (bvsub (sqr (bvadd res_g2 (pow21 m2))) #x0001)))
(assert (= temp___274 result7))
(assert (= temp___2741 bits2))
(assert (not (not (= bits2 #x0000))))
(check-sat)
(exit)
