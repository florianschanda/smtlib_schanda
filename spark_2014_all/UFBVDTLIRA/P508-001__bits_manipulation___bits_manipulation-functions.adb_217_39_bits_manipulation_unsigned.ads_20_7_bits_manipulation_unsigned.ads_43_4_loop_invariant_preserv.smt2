...
(assert (forall ((j Int)) (=> (and (<= 1 j) (<= j (- i2 1))) (= (make_mask j) (bvsub (ite (< j 65536) (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) j)) ((_ int2bv 16) 0)) ((_ int2bv 16) 1))))))
(assert (and (=> (<= 2 15) (in_range2 i2)) (and (<= 2 i2) (<= i2 15))))
(assert (not (= i2 15)))
(assert (= i2 result1))
(assert (= i3 (+ i2 1)))
(assert (= (make_mask i3) (bvsub (ite (< i3 65536) (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) i3)) ((_ int2bv 16) 0)) ((_ int2bv 16) 1))))
(declare-const j Int)
(assert (<= 1 j))
(assert (<= j (- i3 1)))
