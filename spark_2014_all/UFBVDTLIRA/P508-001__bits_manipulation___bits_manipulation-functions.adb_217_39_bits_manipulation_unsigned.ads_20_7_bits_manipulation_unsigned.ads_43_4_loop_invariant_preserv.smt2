...
(assert (forall ((j Int)) (=> (and (<= 1 j) (<= j (- i2 1))) (= (make_mask j) (bvsub (ite (< j 65536) (bvshl #x0001 ((_ int2bv 16) j)) #x0000) #x0001)))))
(assert (and (=> (<= 2 15) (in_range2 i2)) (and (<= 2 i2) (<= i2 15))))
(assert (not (= i2 15)))
(assert (= i2 result1))
(assert (= i3 (+ i2 1)))
(assert (= (make_mask i3) (bvsub (ite (< i3 65536) (bvshl #x0001 ((_ int2bv 16) i3)) #x0000) #x0001)))
(declare-const j Int)
(assert (<= 1 j))
(assert (<= j (- i3 1)))
