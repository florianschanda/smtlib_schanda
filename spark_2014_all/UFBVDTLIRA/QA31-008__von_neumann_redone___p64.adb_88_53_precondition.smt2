...
(assert (bvuge num3 b3))
(assert (= result21 (mk_t__ref num3)))
(assert (= num4 (bvsub num3 b3)))
(assert (= result22 (mk_t__ref res5)))
(assert (= res6 (bvor res5 bits3)))
(assert (not (bvule m4 #x0000000000000040)))
(check-sat)
(exit)
