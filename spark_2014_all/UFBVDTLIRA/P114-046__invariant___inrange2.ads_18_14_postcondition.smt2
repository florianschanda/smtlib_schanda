...
(assert (exists ((n (_ BitVec 64))) (and (and (bvule #x0000000000000000 n) (bvule n (bvsub range_size #x0000000000000001))) (= var (bvadd bottom n)))))
(assert (not (= (bool__content inrange2__inrange64__result4) true)))
(check-sat)
(exit)
