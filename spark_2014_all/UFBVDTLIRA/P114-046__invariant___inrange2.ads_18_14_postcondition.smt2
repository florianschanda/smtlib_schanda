...
(assert (=> (and (bvult i1 range_size) (not (= matched1 true))) (or (and (and (and (= (mk_t__ref temp___2064) (mk_t__ref temp___206)) (and (= i1 i4) (= matched2 matched7))) (and (= temp___2065 temp___2061) (and (= i5 i1) (= matched8 matched2)))) (and (= var (bvadd bottom i1)) (and (= matched1 result2) (= matched2 (of_int 1))))) (and (and (not (= var (bvadd bottom i1))) (= matched2 matched1)) (and (and (and (= temp___2063 temp___2064) (and (= i3 i4) (= matched17 (mk_bool__ref matched5)))) (and (= temp___2065 temp___2063) (and (= i5 i3) (= matched8 matched6)))) (and (and (= i1 result3) (= i2 (bvadd i1 ((_ int2bv 64) 1)))) (and (and (= (= matched3 true) (exists ((n (_ BitVec 64))) (and (and (bvule ((_ int2bv 64) 0) n) (bvule n (bvsub i3 ((_ int2bv 64) 1)))) (= var (bvadd bottom n))))) (not (= matched3 true))) (and (and (= temp___2062 result4) (= temp___2063 i3)) (or (and (and (= matched3 matched5) (= matched6 matched3)) (not (and (bvult i3 range_size) (not (= matched3 true))))) (and (and (bvult i3 range_size) (not (= matched3 true))) (and (and (= matched4 matched5) (= matched6 matched4)) (and (= var (bvadd bottom i3)) (and (= matched3 result5) (= matched4 (of_int 1)))))))))))))))
...
(assert (= result7 (bool__content inrange2__inrange64__result4)))
