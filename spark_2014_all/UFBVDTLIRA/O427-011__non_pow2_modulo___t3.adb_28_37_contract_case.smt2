...
(assert (=> (= (ite (= (= x ((_ int2bv 64) 2)) true) (= y ((_ int2bv 64) 4)) false) true) (= t3__msub__result4 ((_ int2bv 64) 228))))
(assert (=> (= (ite (= (= x ((_ int2bv 64) 4)) true) (= y ((_ int2bv 64) 2)) false) true) (= t3__msub__result4 ((_ int2bv 64) 2))))
(assert (not (= (ite (= (ite (= (ite (= (ite (= (ite (= (= x ((_ int2bv 64) 0)) true) (= y ((_ int2bv 64) 0)) false) false) (ite (= (not (= x ((_ int2bv 64) 0))) true) (= y ((_ int2bv 64) 0)) false) true) false) (ite (= (= x ((_ int2bv 64) 0)) true) (not (= y ((_ int2bv 64) 0))) false) true) false) (ite (= (= x ((_ int2bv 64) 2)) true) (= y ((_ int2bv 64) 4)) false) true) false) (ite (= (= x ((_ int2bv 64) 4)) true) (= y ((_ int2bv 64) 2)) false) true) true)))
(assert (not true))
(check-sat)
(exit)
