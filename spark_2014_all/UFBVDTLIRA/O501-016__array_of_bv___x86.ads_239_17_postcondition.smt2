...
(assert (forall ((x86__rbp (_ BitVec 64))) (! (=> (dynamic_invariant x86__rbp true true true) (let ((result (ebp x86__rbp))) (and (= result ((_ extract 31 0) (bvand x86__rbp ((_ int2bv 64) 4294967295)))) (dynamic_invariant1 result true false true)))) :pattern ((ebp x86__rbp)))))
