...
(assert (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields3)) (mk___rep1 (mk___split_fields1 cu__split_fields))) true))
(assert (and (= o1 (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (mk___rep1 (mk___split_fields1 c)))) (= (= o1 true) (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (mk___rep1 (mk___split_fields1 c))) true))))
(assert (= o2 true))
(assert (= result1 (ite (= o2 true) o1 false)))
(assert (= result1 true))
(assert (not (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 c))) true)))
(check-sat)
(exit)
