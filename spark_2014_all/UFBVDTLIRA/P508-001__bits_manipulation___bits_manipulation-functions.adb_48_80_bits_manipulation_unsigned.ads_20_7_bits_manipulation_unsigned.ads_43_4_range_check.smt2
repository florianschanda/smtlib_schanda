...
(assert (forall ((value (_ BitVec 16))) (forall ((from Int) (to__ Int)) (! (=> (and (and (and (dynamic_invariant value true true true) (dynamic_invariant1 from true true true)) (dynamic_invariant1 to__ true true true)) (<= from to__)) (let ((result (extract_bits_inline_always value from to__))) (and (and (= result (bvand (shift_right value from) (make_mask (+ (- to__ from) 1)))) (and (bvule result (make_mask (+ (- to__ from) 1))) (= (shift_left result from) (bvand value (shift_left (make_mask (+ (- to__ from) 1)) from))))) (dynamic_invariant result true false true)))) :pattern ((extract_bits_inline_always value from to__))))))
...
(declare-const bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline__result (_ BitVec 16))
(declare-const o (_ BitVec 16))
(declare-const result (_ BitVec 16))
(declare-const bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline__result1 (_ BitVec 16))
(declare-const bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline__result2 (_ BitVec 16))
(declare-const bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline__result3 (_ BitVec 16))
(declare-const bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline__result4 (_ BitVec 16))
(declare-const bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline__result5 (_ BitVec 16))
(assert (in_range from))
(assert (in_range to__))
(assert (<= from to__))
(assert (= bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline__result1 bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline__result2))
(assert (= bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline__result3 bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline__result1))
...
(assert (= (mk_t__ref result) (mk_t__ref bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline__result)))
(assert (= bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline__result1 o))
(assert (= (mk_t__ref bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline__result4) (mk_t__ref bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline__result2)))
(assert (= bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline__result5 bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline__result3))
