...
(assert (and (= o5 (shift_right value from)) (= o5 (ite (and (<= 1 64) (<= 64 8)) ((_ zero_extend 56) (ite (< from 8) (bvlshr ((_ extract 7 0) value) ((_ int2bv 8) from)) ((_ int2bv 8) 0))) (ite (and (<= 9 64) (<= 64 16)) ((_ zero_extend 48) (ite (< from 16) (bvlshr ((_ extract 15 0) value) ((_ int2bv 16) from)) ((_ int2bv 16) 0))) (ite (and (<= 17 64) (<= 64 32)) ((_ zero_extend 32) (bvlshr ((_ extract 31 0) value) ((_ int2bv 32) from))) (bvlshr value ((_ int2bv 64) from))))))))
(assert (= o6 (bvand o5 o4)))
(assert (= result1 (ite (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline__result4 o6) true false)))
(assert (= result1 true))
(assert (and (= o1 (+ (- to__ from) 1)) (in_range1 (+ (- to__ from) 1))))
(assert (and (= o2 (make_mask o1)) (= o2 (shift_right ((_ int2bv 64) 18446744073709551615) (- 64 o1)))))
(assert (= result2 (ite (bvule bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline__result4 o2) true false)))
(assert (= result2 true))
