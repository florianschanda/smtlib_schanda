...
(assert (= (read (get_state_item (mk___split_fields1 (mk___rep (mk___split_fields state_item__split_fields state_item__split_fields1))))) true))
(assert (not (= (bool_eq1 (get_state_item (mk___split_fields1 (mk___rep (mk___split_fields state_item__split_fields6 state_item__split_fields7)))) (get_state_item (mk___split_fields1 (mk___rep (mk___split_fields state_item__split_fields state_item__split_fields1))))) true)))
(check-sat)
(exit)
