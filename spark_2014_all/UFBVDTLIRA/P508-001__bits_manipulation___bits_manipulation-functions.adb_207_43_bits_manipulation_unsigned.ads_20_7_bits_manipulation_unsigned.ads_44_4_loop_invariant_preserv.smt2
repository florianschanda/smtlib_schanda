...
(assert (= result__2 o1))
(assert (= (bvand result__3 (let ((temp___523 (- i2 1))) (ite (< temp___523 4294967296) (bvshl #x00000001 ((_ int2bv 32) temp___523)) #x00000000))) (let ((temp___524 (- i2 1))) (ite (< temp___524 4294967296) (bvshl #x00000001 ((_ int2bv 32) temp___524)) #x00000000))))
(assert (and (=> (<= 1 amount) (dynamic_property 1 amount i2)) (and (<= 1 i2) (<= i2 amount))))
(assert (not (= i2 amount)))
(assert (= result3 i2))
(assert (= i3 (+ i2 1)))
(assert (=> (< (- i3 1) 4294967296) (= o2 (bvshl #x00000001 ((_ int2bv 32) (- i3 1))))))
(assert (=> (not (< (- i3 1) 4294967296)) (= o2 #x00000000)))
(assert (= o3 (bvadd result__3 o2)))
(assert (= result4 result__3))
(assert (= result__4 o3))
(assert (not (= (bvand result__4 (let ((temp___523 (- i3 1))) (ite (< temp___523 4294967296) (bvshl #x00000001 ((_ int2bv 32) temp___523)) #x00000000))) (let ((temp___524 (- i3 1))) (ite (< temp___524 4294967296) (bvshl #x00000001 ((_ int2bv 32) temp___524)) #x00000000)))))
(check-sat)
(exit)
