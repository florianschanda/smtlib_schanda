...
(assert (= result__2 o1))
(assert (= (bvand result__3 (let ((temp___521 (- i2 1))) (ite (< temp___521 4294967296) (bvshl #x00000001 ((_ int2bv 32) temp___521)) #x00000000))) (let ((temp___522 (- i2 1))) (ite (< temp___522 4294967296) (bvshl #x00000001 ((_ int2bv 32) temp___522)) #x00000000))))
...
(assert (= result__4 o3))
(assert (not (= (bvand result__4 (let ((temp___521 (- i3 1))) (ite (< temp___521 4294967296) (bvshl #x00000001 ((_ int2bv 32) temp___521)) #x00000000))) (let ((temp___522 (- i3 1))) (ite (< temp___522 4294967296) (bvshl #x00000001 ((_ int2bv 32) temp___522)) #x00000000)))))
(check-sat)
(exit)
