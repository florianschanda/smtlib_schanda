...
(assert (= result__2 o1))
(assert (= (bvand result__3 (let ((temp___461 (- i2 1))) (ite (< temp___461 4294967296) (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) temp___461)) ((_ int2bv 32) 0)))) (let ((temp___462 (- i2 1))) (ite (< temp___462 4294967296) (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) temp___462)) ((_ int2bv 32) 0)))))
(assert (and (=> (<= 1 amount) (dynamic_property 1 amount i2)) (and (<= 1 i2) (<= i2 amount))))
(assert (not (= i2 amount)))
(assert (= result3 i2))
(assert (= i3 (+ i2 1)))
(assert (=> (< (- i3 1) 4294967296) (= o2 (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) (- i3 1))))))
(assert (=> (not (< (- i3 1) 4294967296)) (= o2 ((_ int2bv 32) 0))))
(assert (= o3 (bvadd result__3 o2)))
(assert (= result4 result__3))
(assert (= result__4 o3))
(assert (not (= (bvand result__4 (let ((temp___461 (- i3 1))) (ite (< temp___461 4294967296) (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) temp___461)) ((_ int2bv 32) 0)))) (let ((temp___462 (- i3 1))) (ite (< temp___462 4294967296) (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) temp___462)) ((_ int2bv 32) 0))))))
(check-sat)
(exit)
