...
(assert (= result r8))
(assert (= r81 (bvor (bvand r8 ((_ int2bv 64) 18446744073709551360)) ((_ zero_extend 56) val__))))
(assert (= r81 r82))
(assert (= r83 r81))
(assert (not (= r82 (bvor (bvand r8 ((_ int2bv 64) 18446744073709551360)) ((_ zero_extend 56) val__)))))
(check-sat)
(exit)
