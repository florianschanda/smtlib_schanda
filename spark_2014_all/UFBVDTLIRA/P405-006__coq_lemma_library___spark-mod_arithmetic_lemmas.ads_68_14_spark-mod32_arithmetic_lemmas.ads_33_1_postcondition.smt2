...
(assert true)
(assert true)
(assert (and (bvule val1 val2) (or (= factor ((_ int2bv 32) 0)) (bvule val2 (bvudiv ((_ int2bv 32) 4294967295) factor)))))
(assert (not (bvule (bvmul val1 factor) (bvmul val2 factor))))
(check-sat)
(exit)
