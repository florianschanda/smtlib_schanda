...
(assert (= result__1 i1))
(assert (and (= o (shift_right value i1)) (= o (ite (and (<= 1 8) (<= 8 8)) (ite (< i1 8) (bvlshr value ((_ int2bv 8) i1)) ((_ int2bv 8) 0)) (ite (and (<= 9 8) (<= 8 16)) ((_ extract 7 0) (ite (< i1 16) (bvlshr ((_ zero_extend 8) value) ((_ int2bv 16) i1)) ((_ int2bv 16) 0))) (ite (and (<= 17 8) (<= 8 32)) ((_ extract 7 0) (bvlshr ((_ zero_extend 24) value) ((_ int2bv 32) i1))) ((_ extract 7 0) (bvlshr ((_ zero_extend 56) value) ((_ int2bv 64) i1)))))))))
(assert (= result2 (ite (= o ((_ int2bv 8) 1)) true false)))
(assert (not (= result2 true)))
(assert (forall ((j Int)) (=> (and (<= 0 j) (<= j i2)) (bvugt (shift_right value j) ((_ int2bv 8) 1)))))
...
(assert (= result__3 i3))
(assert (and (= o1 (shift_right value i3)) (= o1 (ite (and (<= 1 8) (<= 8 8)) (ite (< i3 8) (bvlshr value ((_ int2bv 8) i3)) ((_ int2bv 8) 0)) (ite (and (<= 9 8) (<= 8 16)) ((_ extract 7 0) (ite (< i3 16) (bvlshr ((_ zero_extend 8) value) ((_ int2bv 16) i3)) ((_ int2bv 16) 0))) (ite (and (<= 17 8) (<= 8 32)) ((_ extract 7 0) (bvlshr ((_ zero_extend 24) value) ((_ int2bv 32) i3))) ((_ extract 7 0) (bvlshr ((_ zero_extend 56) value) ((_ int2bv 64) i3)))))))))
(assert (= result5 (ite (= o1 ((_ int2bv 8) 1)) true false)))
(assert (not (= result5 true)))
(declare-const j Int)
(assert (<= 0 j))
(assert (<= j i3))
(assert (not (bvugt (shift_right value j) ((_ int2bv 8) 1))))
(check-sat)
(exit)
