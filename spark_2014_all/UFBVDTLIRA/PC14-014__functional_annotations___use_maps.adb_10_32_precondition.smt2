...
(assert (and (= o (positions s)) (and (not (= (has_key1 o no_element) true)) (forall ((i us_rep2)) (=> (= (has_key1 o i) true) (and (and (<= 1 (get1 o i)) (<= (get1 o i) (length3 s))) (forall ((j us_rep2)) (=> (= (has_key1 o j) true) (=> (= (get1 o i) (get1 o j)) (= (bool_eq2 i j) true))))))))))
