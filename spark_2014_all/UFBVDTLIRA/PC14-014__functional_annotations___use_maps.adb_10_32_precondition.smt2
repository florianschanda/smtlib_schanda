...
(assert (forall ((container us_rep2)) (forall ((key Int)) (! (=> (dynamic_invariant1 key true true true) (=> (= (of_int 1) true) (=> (exists ((k Int)) (and (and (in_range3 k) (= (has_key container k) true)) (= k key))) (= (has_key container key) true)))) :pattern ((has_key container key))))))
...
(define-fun dynamic_invariant3 ((temp___expr_391 Int) (temp___is_init_388 Bool) (temp___skip_constant_389 Bool) (temp___do_toplevel_390 Bool)) Bool (=> (or (= temp___is_init_388 true) (<= 0 2147483647)) (in_range5 temp___expr_391)))
...
(define-fun dynamic_invariant4 ((temp___expr_411 Int) (temp___is_init_408 Bool) (temp___skip_constant_409 Bool) (temp___do_toplevel_410 Bool)) Bool (=> (or (= temp___is_init_408 true) (<= 1 2147483647)) (in_range6 temp___expr_411)))
...
(assert (forall ((container us_rep)) (! (let ((result (keys container))) (and (and (and (and (= (length1 result) (length3 container)) (forall ((temp___435 Int)) (=> (and (in_range5 temp___435) (= (iter_has_element result temp___435) true)) (= (has_key (model__ container) (get result temp___435)) true)))) (forall ((key Int)) (=> (and (in_range3 key) (= (has_key (model__ container) key) true)) (and (< 0 (find result key)) (= (get result (find result key)) key))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length3 container))) (= (find result (get result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length3 container))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length3 container))) (=> (= (get result i) (get result j)) (= i j)))))))) :pattern ((keys container)))))
...
(define-fun dynamic_invariant7 ((temp___expr_173 Int) (temp___is_init_170 Bool) (temp___skip_constant_171 Bool) (temp___do_toplevel_172 Bool)) Bool (=> (or (= temp___is_init_170 true) (<= 0 2147483647)) (in_range2 temp___expr_173)))
(assert (= no_element (mk___rep1 (mk___split_fields1 (of_rep 0)))))
(assert (forall ((container us_rep)) (! (let ((result (length3 container))) (and (<= result (to_rep (rec__use_maps__my_maps__map__capacity (us_split_discrs1 container)))) (dynamic_invariant7 result true false true))) :pattern ((length3 container)))))
...
(assert (forall ((container us_rep3)) (forall ((key2 Int)) (! (=> (dynamic_invariant5 key2 true true true) (let ((result (find container key2))) (and (=> (< 0 result) (and (<= result (length1 container)) (= key2 (get container result)))) (dynamic_invariant7 result true false true)))) :pattern ((find container key2))))))
...
(assert (forall ((container us_rep2)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant1 key2 true true true) (= (has_key container key2) true)) (let ((result (get2 container key2))) (and (=> (= (of_int 1) true) (and (= result (w_get1 container (witness1 container key2))) (forall ((k1 Int)) (=> (and (in_range3 k1) (= (has_key container k1) true)) (= (= k1 key2) (= (witness1 container key2) (witness1 container k1))))))) (dynamic_invariant8 result true false true)))) :pattern ((get2 container key2))))))
(assert (forall ((container us_rep2)) (! (dynamic_invariant7 (length container) true false true) :pattern ((length container)))))
...
(assert true)
(assert (forall ((container us_rep2)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant1 key2 true true true) (= (has_key container key2) true)) (let ((result (witness1 container key2))) (and (= (has_witness container result) true) (dynamic_invariant7 result true false true)))) :pattern ((witness1 container key2))))))
(assert (forall ((container us_rep2)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant7 witness2 true true true) (= (has_witness container witness2) true)) (dynamic_invariant8 (w_get1 container witness2) true false true)) :pattern ((w_get1 container witness2))))))
(assert (forall ((container us_rep3)) (! (let ((result (length1 container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant7 result true false true))) :pattern ((length1 container)))))
...
(assert (forall ((container us_rep4)) (! (dynamic_invariant7 (length2 container) true false true) :pattern ((length2 container)))))
...
(assert true)
(assert (forall ((container us_rep4)) (forall ((key2 us_rep1)) (! (=> (= (has_key1 container key2) true) (let ((result (witness container key2))) (and (= (has_witness1 container result) true) (dynamic_invariant7 result true false true)))) :pattern ((witness container key2))))))
(assert (forall ((container us_rep4)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant7 witness2 true true true) (= (has_witness1 container witness2) true)) (dynamic_invariant4 (w_get container witness2) true false true)) :pattern ((w_get container witness2))))))
...
(declare-const use_maps__my_find__result4 cursor__ref)
(declare-const temp___7463 int__ref)
(declare-const cu__split_fields5 us_split_fields2)
(declare-const use_maps__my_find__result5 us_rep1)
(declare-const temp___7464 Int)
(declare-const cu__split_fields6 us_split_fields__ref1)
(declare-const use_maps__my_find__result6 cursor__ref)
(declare-const cu__split_fields7 us_split_fields2)
(declare-const use_maps__my_find__result7 us_rep1)
(declare-const cu__split_fields8 us_split_fields__ref1)
(declare-const use_maps__my_find__result8 cursor__ref)
(declare-const cu__split_fields9 us_split_fields2)
(declare-const use_maps__my_find__result9 us_rep1)
(declare-const result8 cursor__ref)
(declare-const use_maps__my_find__result10 us_rep1)
(declare-const use_maps__my_find__result11 cursor__ref)
(declare-const use_maps__my_find__result12 us_rep1)
(declare-const cu__split_fields10 us_split_fields__ref1)
(declare-const use_maps__my_find__result13 cursor__ref)
(declare-const cu__split_fields11 us_split_fields2)
(declare-const use_maps__my_find__result14 us_rep1)
(declare-const cu__split_fields12 us_split_fields__ref1)
(declare-const use_maps__my_find__result15 cursor__ref)
(declare-const cu__split_fields13 us_split_fields2)
(declare-const use_maps__my_find__result16 us_rep1)
...
(assert (in_range1 k))
(assert (and (= (mk___rep1 (mk___split_fields1 use_maps__my_find__cu__assume)) (first s)) (ite (= (= (length3 s) 0) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 use_maps__my_find__cu__assume)) no_element) true) (and (= (has_key1 (positions s) (mk___rep1 (mk___split_fields1 use_maps__my_find__cu__assume))) true) (= (get1 (positions s) (mk___rep1 (mk___split_fields1 use_maps__my_find__cu__assume))) 1)))))
