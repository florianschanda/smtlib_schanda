...
(assert (forall ((container us_rep2)) (forall ((key Int)) (! (=> (dynamic_invariant1 key true true true true) (=> (= (distinct 1 0) true) (=> (exists ((k Int)) (and (and (in_range3 k) (= (has_key container k) true)) (= k key))) (= (has_key container key) true)))) :pattern ((has_key container key))))))
...
(define-fun dynamic_invariant3 ((temp___expr_429 Int) (temp___is_init_425 Bool) (temp___skip_constant_426 Bool) (temp___do_toplevel_427 Bool) (temp___do_typ_inv_428 Bool)) Bool (=> (or (= temp___is_init_425 true) (<= 0 2147483647)) (in_range5 temp___expr_429)))
...
(assert (forall ((container us_rep)) (! (let ((result (keys container))) (and (and (and (and (= (length1 result) (length3 container)) (forall ((temp___478 Int)) (=> (and (in_range5 temp___478) (= (iter_has_element result temp___478) true)) (= (has_key (model__ container) (get result temp___478)) true)))) (forall ((key Int)) (=> (and (in_range3 key) (= (has_key (model__ container) key) true)) (and (< 0 (find result key)) (= (get result (find result key)) key))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length3 container))) (= (find result (get result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length3 container))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length3 container))) (=> (= (get result i) (get result j)) (= i j)))))))) :pattern ((keys container)))))
...
(define-fun dynamic_invariant7 ((temp___expr_197 Int) (temp___is_init_193 Bool) (temp___skip_constant_194 Bool) (temp___do_toplevel_195 Bool) (temp___do_typ_inv_196 Bool)) Bool (=> (or (= temp___is_init_193 true) (<= 0 2147483647)) (in_range2 temp___expr_197)))
(assert (= no_element (mk___rep1 (mk___split_fields1 (of_rep 0)))))
(assert (forall ((container us_rep)) (! (let ((result (length3 container))) (and (<= result (to_rep (rec__use_maps__my_maps__map__capacity (us_split_discrs1 container)))) (dynamic_invariant7 result true false true true))) :pattern ((length3 container)))))
...
(assert (forall ((container us_rep3)) (forall ((key2 Int)) (! (=> (dynamic_invariant5 key2 true true true true) (let ((result (find container key2))) (and (=> (< 0 result) (and (<= result (length1 container)) (= key2 (get container result)))) (dynamic_invariant7 result true false true true)))) :pattern ((find container key2))))))
...
(assert (forall ((container us_rep2)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant1 key2 true true true true) (= (has_key container key2) true)) (let ((result (get2 container key2))) (and (=> (= (distinct 1 0) true) (and (= result (w_get1 container (witness1 container key2))) (forall ((k1 Int)) (=> (and (in_range3 k1) (= (has_key container k1) true)) (= (= k1 key2) (= (witness1 container key2) (witness1 container k1))))))) (dynamic_invariant8 result true false true true)))) :pattern ((get2 container key2))))))
(assert (forall ((container us_rep2)) (! (dynamic_invariant7 (length container) true false true true) :pattern ((length container)))))
...
(assert true)
(assert (forall ((container us_rep2)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant1 key2 true true true true) (= (has_key container key2) true)) (let ((result (witness1 container key2))) (and (= (has_witness container result) true) (dynamic_invariant7 result true false true true)))) :pattern ((witness1 container key2))))))
(assert (forall ((container us_rep2)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant7 witness2 true true true true) (= (has_witness container witness2) true)) (dynamic_invariant8 (w_get1 container witness2) true false true true)) :pattern ((w_get1 container witness2))))))
(assert (forall ((container us_rep3)) (! (let ((result (length1 container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant7 result true false true true))) :pattern ((length1 container)))))
...
(assert (forall ((container us_rep4)) (! (dynamic_invariant7 (length2 container) true false true true) :pattern ((length2 container)))))
...
(assert true)
(assert (forall ((container us_rep4)) (forall ((key2 us_rep1)) (! (=> (= (has_key1 container key2) true) (let ((result (witness container key2))) (and (= (has_witness1 container result) true) (dynamic_invariant7 result true false true true)))) :pattern ((witness container key2))))))
(assert (forall ((container us_rep4)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant7 witness2 true true true true) (= (has_witness1 container witness2) true)) (dynamic_invariant4 (w_get container witness2) true false true true)) :pattern ((w_get container witness2))))))
...
(define-fun use_maps__my_find__cu__assume1 () us_rep1 (mk___rep1 (mk___split_fields1 use_maps__my_find__cu__assume)))
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___792 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___792)) no_element))
(assert (in_range1 k))
(assert (and (= use_maps__my_find__cu__assume1 (first s)) (ite (= (= (length3 s) 0) true) (= (bool_eq1 use_maps__my_find__cu__assume1 no_element) true) (and (= (has_key1 (positions s) use_maps__my_find__cu__assume1) true) (= (get1 (positions s) use_maps__my_find__cu__assume1) 1)))))
