...
(assert (and (= o7 (make_mask o6)) (= o7 (shift_right ((_ int2bv 32) 4294967295) (- 32 o6)))))
(assert (and (= o8 (shift_right value from)) (= o8 (ite (and (<= 1 32) (<= 32 8)) ((_ zero_extend 24) (ite (< from 8) (bvlshr ((_ extract 7 0) value) ((_ int2bv 8) from)) ((_ int2bv 8) 0))) (ite (and (<= 9 32) (<= 32 16)) ((_ zero_extend 16) (ite (< from 16) (bvlshr ((_ extract 15 0) value) ((_ int2bv 16) from)) ((_ int2bv 16) 0))) (ite (and (<= 17 32) (<= 32 32)) (bvlshr value ((_ int2bv 32) from)) ((_ extract 31 0) (bvlshr ((_ zero_extend 32) value) ((_ int2bv 64) from)))))))))
(assert (= o9 (bvand o8 o7)))
(assert (= result4 (ite (= bits_manipulation_unsigned__unsigned_32__functions__extract_bits__result4 o9) true false)))
(assert (= result4 true))
(assert (and (= o4 (+ (- to__ from) 1)) (in_range1 (+ (- to__ from) 1))))
(assert (and (= o5 (make_mask o4)) (= o5 (shift_right ((_ int2bv 32) 4294967295) (- 32 o4)))))
(assert (= result5 (ite (bvule bits_manipulation_unsigned__unsigned_32__functions__extract_bits__result4 o5) true false)))
(assert (= result5 true))
