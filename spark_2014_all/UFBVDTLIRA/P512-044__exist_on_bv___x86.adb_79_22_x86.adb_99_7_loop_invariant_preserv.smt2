...
(assert (not (= res true)))
(assert (= result14 (mk_t__ref n11)))
(assert (= n117 ((_ int2bv 64) 0)))
(assert (bvule ((_ int2bv 64) 0) n117))
(assert (bvule n117 var1_range_size))
(assert (=> (not (= n118 ((_ int2bv 64) 0))) (forall ((i (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i (bvsub n118 ((_ int2bv 64) 1)))) (forall ((j (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) j) (bvule j var2_range_size)) (not (= (bvadd var1 i) (bvadd var2 j)))))))))
(assert (and (=> (bvule ((_ int2bv 64) 0) var1_range_size) (dynamic_property1 ((_ int2bv 64) 0) var1_range_size n118)) (and (bvule ((_ int2bv 64) 0) n118) (bvule n118 var1_range_size))))
(assert (= result15 (mk_t__ref n217)))
(assert (= n218 ((_ int2bv 64) 0)))
(assert (bvule ((_ int2bv 64) 0) n218))
(assert (bvule n218 var2_range_size))
(assert (= o (bvadd n218 (bvsub var1_range_size n118))))
(assert (= result16 (mk_t__ref n33)))
(assert (= n34 o))
(assert true)
(assert (and (bvule ((_ int2bv 64) 0) n34) (bvule n34 (bvadd var1_range_size var2_range_size))))
(assert (not (= var1 (bvadd (bvsub var2 var1_range_size) n34))))
(assert (not (= (bvadd var1 n118) (bvadd var2 n218))))
(assert (forall ((j (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) j) (bvule j n219)) (not (= (bvadd var1 n118) (bvadd var2 j))))))
(assert (and (=> (bvule ((_ int2bv 64) 0) var2_range_size) (dynamic_property2 ((_ int2bv 64) 0) var2_range_size n219)) (and (bvule ((_ int2bv 64) 0) n219) (bvule n219 var2_range_size))))
(assert (not (= n219 var2_range_size)))
(assert (= result17 (mk_t__ref n219)))
(assert (= n220 (bvadd n219 ((_ int2bv 64) 1))))
(assert (= o1 (bvadd n220 (bvsub var1_range_size n118))))
(assert (= result18 (mk_t__ref n35)))
(assert (= n36 o1))
(assert true)
(assert (and (bvule ((_ int2bv 64) 0) n36) (bvule n36 (bvadd var1_range_size var2_range_size))))
(assert (not (= var1 (bvadd (bvsub var2 var1_range_size) n36))))
(assert (not (= (bvadd var1 n118) (bvadd var2 n220))))
(declare-const j (_ BitVec 64))
(assert (bvule ((_ int2bv 64) 0) j))
(assert (bvule j n220))
(assert (not (not (= (bvadd var1 n118) (bvadd var2 j)))))
(check-sat)
(exit)
