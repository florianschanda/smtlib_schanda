...
(assert (bvule #x0000000000000000 n21))
(assert (bvule n21 var2_range_size))
(assert (= o (bvadd n21 (bvsub var1_range_size n12))))
(assert (= result2 (mk_t__ref n)))
(assert (= n3 o))
(assert (and (bvule #x0000000000000000 n3) (bvule n3 (bvadd var1_range_size var2_range_size))))
(assert (not (= var1 (bvadd (bvsub var2 var1_range_size) n3))))
(assert (not (= (bvadd var1 n12) (bvadd var2 n21))))
(assert (forall ((j (_ BitVec 64))) (=> (and (bvule #x0000000000000000 j) (bvule j n22)) (not (= (bvadd var1 n12) (bvadd var2 j))))))
(assert (and (=> (bvule #x0000000000000000 var2_range_size) (dynamic_property2 #x0000000000000000 var2_range_size n22)) (and (bvule #x0000000000000000 n22) (bvule n22 var2_range_size))))
(assert (not (= n22 var2_range_size)))
(assert (= result3 (mk_t__ref n22)))
(assert (= n23 (bvadd n22 #x0000000000000001)))
(assert (= o1 (bvadd n23 (bvsub var1_range_size n12))))
(assert (= result4 (mk_t__ref n4)))
(assert (= n5 o1))
(assert (and (bvule #x0000000000000000 n5) (bvule n5 (bvadd var1_range_size var2_range_size))))
