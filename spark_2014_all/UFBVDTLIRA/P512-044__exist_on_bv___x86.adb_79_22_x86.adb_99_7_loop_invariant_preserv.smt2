...
(assert (=> (not (= n12 ((_ int2bv 64) 0))) (forall ((i (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i (bvsub n12 ((_ int2bv 64) 1)))) (forall ((j (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) j) (bvule j var2_range_size)) (not (= (bvadd var1 i) (bvadd var2 j)))))))))
(assert (and (=> (bvule ((_ int2bv 64) 0) var1_range_size) (dynamic_property1 ((_ int2bv 64) 0) var1_range_size n12)) (and (bvule ((_ int2bv 64) 0) n12) (bvule n12 var1_range_size))))
(assert (= result1 (mk_t__ref n2)))
(assert (= n21 ((_ int2bv 64) 0)))
(assert (bvule ((_ int2bv 64) 0) n21))
(assert (bvule n21 var2_range_size))
(assert (= o (bvadd n21 (bvsub var1_range_size n12))))
(assert (= result2 (mk_t__ref n)))
(assert (= n3 o))
(assert (and (bvule ((_ int2bv 64) 0) n3) (bvule n3 (bvadd var1_range_size var2_range_size))))
(assert (not (= var1 (bvadd (bvsub var2 var1_range_size) n3))))
(assert (not (= (bvadd var1 n12) (bvadd var2 n21))))
(assert (forall ((j (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) j) (bvule j n22)) (not (= (bvadd var1 n12) (bvadd var2 j))))))
(assert (and (=> (bvule ((_ int2bv 64) 0) var2_range_size) (dynamic_property2 ((_ int2bv 64) 0) var2_range_size n22)) (and (bvule ((_ int2bv 64) 0) n22) (bvule n22 var2_range_size))))
(assert (not (= n22 var2_range_size)))
(assert (= result3 (mk_t__ref n22)))
(assert (= n23 (bvadd n22 ((_ int2bv 64) 1))))
(assert (= o1 (bvadd n23 (bvsub var1_range_size n12))))
(assert (= result4 (mk_t__ref n4)))
(assert (= n5 o1))
(assert (and (bvule ((_ int2bv 64) 0) n5) (bvule n5 (bvadd var1_range_size var2_range_size))))
(assert (not (= var1 (bvadd (bvsub var2 var1_range_size) n5))))
(assert (not (= (bvadd var1 n12) (bvadd var2 n23))))
(declare-const j (_ BitVec 64))
(assert (bvule ((_ int2bv 64) 0) j))
(assert (bvule j n23))
(assert (not (not (= (bvadd var1 n12) (bvadd var2 j)))))
(check-sat)
(exit)
