...
(assert (= result__2 o1))
(assert (not (= (bvand result__2 (let ((temp___490 (- i1 1))) (ite (< temp___490 18446744073709551616) (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) temp___490)) ((_ int2bv 64) 0)))) (let ((temp___491 (- i1 1))) (ite (< temp___491 18446744073709551616) (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) temp___491)) ((_ int2bv 64) 0))))))
(check-sat)
(exit)
