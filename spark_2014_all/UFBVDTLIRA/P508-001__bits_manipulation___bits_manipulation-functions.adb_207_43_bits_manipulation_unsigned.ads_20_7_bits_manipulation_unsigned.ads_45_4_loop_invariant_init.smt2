...
(assert (= result__2 o1))
(assert (not (= (bvand result__2 (let ((temp___550 (- i1 1))) (ite (< temp___550 18446744073709551616) (bvshl #x0000000000000001 ((_ int2bv 64) temp___550)) #x0000000000000000))) (let ((temp___551 (- i1 1))) (ite (< temp___551 18446744073709551616) (bvshl #x0000000000000001 ((_ int2bv 64) temp___551)) #x0000000000000000)))))
(check-sat)
(exit)
