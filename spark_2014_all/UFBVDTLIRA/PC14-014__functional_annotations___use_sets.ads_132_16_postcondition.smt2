...
(assert (let ((temp___438 (elements s))) (forall ((temp___437 Int)) (=> (and (in_range2 temp___437) (= (iter_has_element temp___438 temp___437) true)) (exists ((i us_rep1)) (and (= (has_key (positions s) i) true) (= (get (elements s) (get1 (positions s) i)) (get temp___438 temp___437))))))))
(declare-const temp___1014 Int)
(assert (in_range2 temp___1014))
(assert (= (iter_has_element (elements s) temp___1014) true))
(assert (not (= (q (get (elements s) temp___1014)) true)))
(check-sat)
(exit)
