...
(declare-const bits_manipulation_unsigned__unsigned_32__functions__extract_bits_not_inline__result (_ BitVec 32))
(declare-const o (_ BitVec 32))
(declare-const result (_ BitVec 32))
(declare-const bits_manipulation_unsigned__unsigned_32__functions__extract_bits_not_inline__result1 (_ BitVec 32))
(declare-const bits_manipulation_unsigned__unsigned_32__functions__extract_bits_not_inline__result2 (_ BitVec 32))
(declare-const bits_manipulation_unsigned__unsigned_32__functions__extract_bits_not_inline__result3 (_ BitVec 32))
(declare-const bits_manipulation_unsigned__unsigned_32__functions__extract_bits_not_inline__result4 (_ BitVec 32))
(declare-const bits_manipulation_unsigned__unsigned_32__functions__extract_bits_not_inline__result5 (_ BitVec 32))
(declare-const result1 (_ BitVec 32))
(assert (in_range from))
(assert (in_range to__))
(assert (<= from to__))
(assert (= bits_manipulation_unsigned__unsigned_32__functions__extract_bits_not_inline__result1 bits_manipulation_unsigned__unsigned_32__functions__extract_bits_not_inline__result2))
(assert (= bits_manipulation_unsigned__unsigned_32__functions__extract_bits_not_inline__result3 bits_manipulation_unsigned__unsigned_32__functions__extract_bits_not_inline__result1))
...
(assert (= (mk_t__ref result) (mk_t__ref bits_manipulation_unsigned__unsigned_32__functions__extract_bits_not_inline__result)))
(assert (= bits_manipulation_unsigned__unsigned_32__functions__extract_bits_not_inline__result1 o))
(assert (= (mk_t__ref bits_manipulation_unsigned__unsigned_32__functions__extract_bits_not_inline__result4) (mk_t__ref bits_manipulation_unsigned__unsigned_32__functions__extract_bits_not_inline__result2)))
(assert (= bits_manipulation_unsigned__unsigned_32__functions__extract_bits_not_inline__result5 bits_manipulation_unsigned__unsigned_32__functions__extract_bits_not_inline__result3))
(assert (= result1 bits_manipulation_unsigned__unsigned_32__functions__extract_bits_not_inline__result4))
(assert (not (= bits_manipulation_unsigned__unsigned_32__functions__extract_bits_not_inline__result4 (bvand (shift_right value from) (make_mask (+ (- to__ from) 1))))))
(check-sat)
(exit)
