...
(declare-datatypes () ((size64_type__ref (mk_size64_type__ref (size64_type__content size64_type)))))
(define-fun size64_type__ref___projection ((a size64_type__ref)) size64_type (size64_type__content a))
...
(declare-datatypes () ((size32_type__ref (mk_size32_type__ref (size32_type__content size32_type)))))
(define-fun size32_type__ref___projection ((a size32_type__ref)) size32_type (size32_type__content a))
(define-fun dynamic_invariant1 ((temp___expr_141 (_ BitVec 32)) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool true)
(declare-const whole (_ BitVec 64))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(declare-const msw (_ BitVec 32))
(declare-const lsw (_ BitVec 32))
(declare-const result (_ BitVec 32))
(declare-const msw1 (_ BitVec 32))
(assert true)
(assert true)
(assert true)
(assert (not (bvule ((_ zero_extend 32) ((_ int2bv 32) 0)) (bvlshr whole ((_ int2bv 64) 32)))))
(check-sat)
(exit)
