...
(assert (= result__2 i1))
(assert (and (= o (shift_right value i1)) (= o (ite (and (<= 1 32) (<= 32 8)) ((_ zero_extend 24) (ite (< i1 8) (bvlshr ((_ extract 7 0) value) ((_ int2bv 8) i1)) ((_ int2bv 8) 0))) (ite (and (<= 9 32) (<= 32 16)) ((_ zero_extend 16) (ite (< i1 16) (bvlshr ((_ extract 15 0) value) ((_ int2bv 16) i1)) ((_ int2bv 16) 0))) (ite (and (<= 17 32) (<= 32 32)) (bvlshr value ((_ int2bv 32) i1)) ((_ extract 31 0) (bvlshr ((_ zero_extend 32) value) ((_ int2bv 64) i1)))))))))
(assert (= result2 (ite (= o ((_ int2bv 32) 1)) true false)))
(assert (not (= result2 true)))
(declare-const j Int)
(assert (<= 0 j))
(assert (<= j i1))
(assert (not (bvugt (shift_right value j) ((_ int2bv 32) 1))))
(check-sat)
(exit)
