...
(declare-const temp___2391 (_ BitVec 64))
...
(assert (and (and (bvule #x0000000000000000 i2) (bvule i2 (bvsub range_size #x0000000000000001))) (or (= i2 #x0000000000000000) (forall ((n (_ BitVec 64))) (=> (and (bvule #x0000000000000000 n) (bvule n (bvsub i2 #x0000000000000001))) (not (= var (bvadd bottom n))))))))
(assert (bvult i2 range_size))
(assert (= temp___239 result1))
(assert (= temp___2391 i2))
