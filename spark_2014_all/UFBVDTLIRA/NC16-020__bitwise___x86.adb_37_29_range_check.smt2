...
(define-fun dynamic_invariant1 ((temp___expr_207 (_ BitVec 32)) (temp___is_init_204 Bool) (temp___skip_constant_205 Bool) (temp___do_toplevel_206 Bool)) Bool true)
...
(assert true)
(assert (not (bvule ((_ zero_extend 32) ((_ int2bv 32) 0)) (bvand rax ((_ int2bv 64) 4294967295)))))
(check-sat)
(exit)
