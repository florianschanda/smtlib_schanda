...
(assert (= alpha_launch_examples__example_3__result1 (bvxor ((_ int2bv 64) 73) (bvmul a b))))
...
(assert (not (bvugt alpha_launch_examples__example_3__result4 ((_ int2bv 64) 0))))
(check-sat)
(exit)
