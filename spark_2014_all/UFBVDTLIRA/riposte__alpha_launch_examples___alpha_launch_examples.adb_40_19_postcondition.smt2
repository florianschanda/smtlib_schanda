...
(assert (= alpha_launch_examples__example_3__result1 (bvxor #x0000000000000049 (bvmul a b))))
(assert (= (mk_t__ref alpha_launch_examples__example_3__result4) (mk_t__ref alpha_launch_examples__example_3__result2)))
(assert (= alpha_launch_examples__example_3__result5 alpha_launch_examples__example_3__result3))
(assert (= result1 alpha_launch_examples__example_3__result4))
(assert (not (bvugt alpha_launch_examples__example_3__result4 #x0000000000000000)))
(check-sat)
(exit)
