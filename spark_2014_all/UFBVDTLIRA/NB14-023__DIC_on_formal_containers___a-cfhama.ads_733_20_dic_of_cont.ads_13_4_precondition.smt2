...
(declare-datatypes () ((us_split_discrs (mk___split_discrs (rec__dic_of_cont__my_hama__map__capacity count_type) (rec__dic_of_cont__my_hama__map__modulus hash_type)))))
(define-fun us_split_discrs___2__projection ((a us_split_discrs)) count_type (rec__dic_of_cont__my_hama__map__capacity a))
(define-fun us_split_discrs___3__projection ((a us_split_discrs)) hash_type (rec__dic_of_cont__my_hama__map__modulus a))
...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dic_of_cont__my_hama__map us_main_type)))))
(define-fun us_split_fields_Map__projection ((a us_split_fields)) us_main_type (rec__dic_of_cont__my_hama__map a))
...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (and (= (to_rep1 (rec__dic_of_cont__my_hama__map__capacity (us_split_discrs1 a))) (to_rep1 (rec__dic_of_cont__my_hama__map__capacity (us_split_discrs1 b)))) (= (to_rep (rec__dic_of_cont__my_hama__map__modulus (us_split_discrs1 a))) (to_rep (rec__dic_of_cont__my_hama__map__modulus (us_split_discrs1 b))))) (= (us_main_eq (rec__dic_of_cont__my_hama__map (us_split_fields1 a)) (rec__dic_of_cont__my_hama__map (us_split_fields1 b))) true)) true false))
...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep1 (rec__dic_of_cont__my_hama__map__capacity (us_split_discrs1 container)))) (dynamic_invariant result true false true true))) :pattern ((length container)))))
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__dic_of_cont__my_hama__cursor__node count_type)))))
(define-fun us_split_fields_Node__2__projection ((a us_split_fields2)) count_type (rec__dic_of_cont__my_hama__cursor__node a))
...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (= (to_rep1 (rec__dic_of_cont__my_hama__cursor__node (us_split_fields3 a))) (to_rep1 (rec__dic_of_cont__my_hama__cursor__node (us_split_fields3 b)))) true false))
...
(assert (< dic_of_cont__my_hama__cursor__node__first__bit dic_of_cont__my_hama__cursor__node__last__bit))
...
(define-fun element_type__ref___7__projection ((a element_type__ref)) element_type (element_type__content a))
(define-fun dynamic_invariant1 ((temp___expr_643 Int) (temp___is_init_639 Bool) (temp___skip_constant_640 Bool) (temp___do_toplevel_641 Bool) (temp___do_typ_inv_642 Bool)) Bool (=> (or (= temp___is_init_639 true) (<= 1 2147483647)) (in_range2 temp___expr_643)))
(declare-fun length1 (us_rep2) Int)
(declare-fun length__function_guard1 (Int us_rep2) Bool)
(declare-fun is_empty (us_rep2) Bool)
(declare-fun is_empty__function_guard (Bool us_rep2) Bool)
(define-fun default_initial_assumption ((temp___expr_651 us_rep2) (temp___skip_top_level_652 Bool)) Bool (=> (not (= temp___skip_top_level_652 true)) (and (= (is_empty temp___expr_651) true) (= (length1 temp___expr_651) 0))))
...
(define-fun default_initial_assumption1 ((temp___expr_592 us_rep3) (temp___skip_top_level_593 Bool)) Bool (=> (not (= temp___skip_top_level_593 true)) (and (= (is_empty1 temp___expr_592) true) (= (length2 temp___expr_592) 0))))
(assert true)
...
(define-fun dynamic_invariant3 ((temp___expr_577 Int) (temp___is_init_573 Bool) (temp___skip_constant_574 Bool) (temp___do_toplevel_575 Bool) (temp___do_typ_inv_576 Bool)) Bool (=> (or (= temp___is_init_573 true) (<= 0 2147483647)) (in_range3 temp___expr_577)))
...
(define-fun dynamic_invariant4 ((temp___expr_584 Int) (temp___is_init_580 Bool) (temp___skip_constant_581 Bool) (temp___do_toplevel_582 Bool) (temp___do_typ_inv_583 Bool)) Bool (=> (or (= temp___is_init_580 true) (<= 0 2147483647)) (in_range4 temp___expr_584)))
...
(assert (and (= o1 (length container)) (and (in_range1 o1) (<= o1 (to_rep1 (rec__dic_of_cont__my_hama__map__capacity (us_split_discrs1 container)))))))
