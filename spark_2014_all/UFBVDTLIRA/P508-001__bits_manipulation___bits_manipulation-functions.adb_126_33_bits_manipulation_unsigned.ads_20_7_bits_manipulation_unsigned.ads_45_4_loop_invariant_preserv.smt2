...
(assert (= result__2 i1))
(assert (and (= o (shift_right value i1)) (= o (ite (and (<= 1 64) (<= 64 8)) ((_ zero_extend 56) (ite (< i1 8) (bvlshr ((_ extract 7 0) value) ((_ int2bv 8) i1)) ((_ int2bv 8) 0))) (ite (and (<= 9 64) (<= 64 16)) ((_ zero_extend 48) (ite (< i1 16) (bvlshr ((_ extract 15 0) value) ((_ int2bv 16) i1)) ((_ int2bv 16) 0))) (ite (and (<= 17 64) (<= 64 32)) ((_ zero_extend 32) (bvlshr ((_ extract 31 0) value) ((_ int2bv 32) i1))) (bvlshr value ((_ int2bv 64) i1))))))))
(assert (= result2 (ite (= o ((_ int2bv 64) 1)) true false)))
(assert (not (= result2 true)))
(assert (forall ((j Int)) (=> (and (<= 0 j) (<= j i2)) (bvugt (shift_right value j) ((_ int2bv 64) 1)))))
(assert (and (and (=> (<= 0 63) (in_range1 i2)) (=> (<= 0 63) (in_range1 result__3))) (and (<= 0 i2) (<= i2 63))))
(assert (not (= i2 63)))
(assert (= i2 result3))
(assert (= i3 (+ i2 1)))
(assert (= result__3 result4))
(assert (= result__4 i3))
(assert (and (= o1 (shift_right value i3)) (= o1 (ite (and (<= 1 64) (<= 64 8)) ((_ zero_extend 56) (ite (< i3 8) (bvlshr ((_ extract 7 0) value) ((_ int2bv 8) i3)) ((_ int2bv 8) 0))) (ite (and (<= 9 64) (<= 64 16)) ((_ zero_extend 48) (ite (< i3 16) (bvlshr ((_ extract 15 0) value) ((_ int2bv 16) i3)) ((_ int2bv 16) 0))) (ite (and (<= 17 64) (<= 64 32)) ((_ zero_extend 32) (bvlshr ((_ extract 31 0) value) ((_ int2bv 32) i3))) (bvlshr value ((_ int2bv 64) i3))))))))
(assert (= result5 (ite (= o1 ((_ int2bv 64) 1)) true false)))
(assert (not (= result5 true)))
(declare-const j Int)
(assert (<= 0 j))
(assert (<= j i3))
(assert (not (bvugt (shift_right value j) ((_ int2bv 64) 1))))
(check-sat)
(exit)
