...
(assert (= result rcx))
(assert (= rcx1 (bvor (bvand rcx ((_ int2bv 64) 18446744069414584320)) ((_ zero_extend 32) val__))))
(assert (= rcx1 rcx2))
(assert (= rcx3 rcx1))
(assert (not (= rcx2 (bvor (bvand rcx ((_ int2bv 64) 18446744069414584320)) ((_ zero_extend 32) val__)))))
(check-sat)
(exit)
