...
(assert (and (= o8 (length s2)) (and (in_range2 o8) (<= o8 (to_rep1 (rec__use_sets__my_sets__set__capacity (us_split_discrs1 s2)))))))
(assert (and (= o5 (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (and (in_range2 o5) (<= o5 (to_rep1 (rec__use_sets__my_sets__set__capacity s1__split_discrs))))))
(assert (and (= o6 (capacity (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (and (in_range2 o6) (= o6 (to_rep1 (rec__use_sets__my_sets__set__capacity s1__split_discrs))))))
(assert (= o7 (- o6 o5)))
