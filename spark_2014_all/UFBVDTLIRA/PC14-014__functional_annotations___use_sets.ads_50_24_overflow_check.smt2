...
(assert (and (= o3 (length s2)) (and (in_range2 o3) (<= o3 (to_rep1 (rec__use_sets__my_sets__set__capacity (us_split_discrs1 s2)))))))
(assert (and (= o (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (and (in_range2 o) (<= o (to_rep1 (rec__use_sets__my_sets__set__capacity s1__split_discrs))))))
(assert (and (= o1 (capacity (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (and (in_range2 o1) (= o1 (to_rep1 (rec__use_sets__my_sets__set__capacity s1__split_discrs))))))
(assert (= o2 (- o1 o)))
