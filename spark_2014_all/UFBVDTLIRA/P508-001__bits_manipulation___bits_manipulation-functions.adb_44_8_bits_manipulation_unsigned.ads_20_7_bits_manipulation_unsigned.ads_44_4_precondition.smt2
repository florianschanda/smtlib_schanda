...
(declare-const bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline__result (_ BitVec 32))
...
(declare-const bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline__result1 (_ BitVec 32))
(declare-const bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline__result2 (_ BitVec 32))
(declare-const bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline__result3 (_ BitVec 32))
(declare-const bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline__result4 (_ BitVec 32))
(declare-const bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline__result5 (_ BitVec 32))
