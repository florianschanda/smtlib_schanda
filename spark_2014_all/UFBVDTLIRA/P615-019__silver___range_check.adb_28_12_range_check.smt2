...
(define-fun in_range ((x (_ BitVec 32))) Bool (and (bvule #x00000000 x) (bvule x #x0000000A)))
...
(declare-datatypes () ((small_unsigned__ref (mk_small_unsigned__ref (small_unsigned__content small_unsigned)))))
(define-fun small_unsigned__ref___projection ((a small_unsigned__ref)) small_unsigned (small_unsigned__content a))
(define-fun dynamic_invariant1 ((temp___expr_221 (_ BitVec 32)) (temp___is_init_217 Bool) (temp___skip_constant_218 Bool) (temp___do_toplevel_219 Bool) (temp___do_typ_inv_220 Bool)) Bool (=> (or (= temp___is_init_217 true) (bvule #x00000000 #x0000000A)) (in_range temp___expr_221)))
(declare-const x (_ BitVec 32))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const u (_ BitVec 32))
(assert (=> (bvule #x00000000 #x0000000A) (in_range u)))
