...
(define-fun in_range ((x (_ BitVec 32))) Bool (and (bvule ((_ int2bv 32) 0) x) (bvule x ((_ int2bv 32) 10))))
...
(define-fun dynamic_invariant1 ((temp___expr_189 (_ BitVec 32)) (temp___is_init_186 Bool) (temp___skip_constant_187 Bool) (temp___do_toplevel_188 Bool)) Bool (=> (or (= temp___is_init_186 true) (bvule ((_ int2bv 32) 0) ((_ int2bv 32) 10))) (in_range temp___expr_189)))
