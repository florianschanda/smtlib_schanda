...
(assert (= bitset__bit_test__result1 (ite (not (= (bvand value mask1) ((_ int2bv 64) 0))) true false)))
...
(assert (not (not (= (bvand value (let ((temp___148 (bv2nat pos))) (ite (< temp___148 18446744073709551616) (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) temp___148)) ((_ int2bv 64) 0)))) ((_ int2bv 64) 0)))))
(check-sat)
(exit)
