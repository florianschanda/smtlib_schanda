...
(assert (= bitset__bit_test__result1 (ite (not (= (bvand value mask1) #x0000000000000000)) true false)))
(assert (= (mk_bool__ref bitset__bit_test__result4) (mk_bool__ref bitset__bit_test__result2)))
(assert (= mask2 mask1))
(assert (= bitset__bit_test__result5 bitset__bit_test__result3))
(assert (= mask3 mask1))
(assert (= result2 bitset__bit_test__result4))
(assert (not (= (bvand value (let ((temp___172 (bv2nat pos))) (ite (< temp___172 18446744073709551616) (bvshl #x0000000000000001 ((_ int2bv 64) temp___172)) #x0000000000000000))) #x0000000000000000)))
(assert (not (= bitset__bit_test__result4 true)))
(check-sat)
(exit)
