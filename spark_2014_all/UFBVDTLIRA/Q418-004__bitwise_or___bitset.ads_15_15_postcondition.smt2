...
(assert (not (not (= (bvand value (let ((temp___172 (bv2nat pos))) (ite (< temp___172 18446744073709551616) (bvshl #x0000000000000001 ((_ int2bv 64) temp___172)) #x0000000000000000))) #x0000000000000000))))
(check-sat)
(exit)
