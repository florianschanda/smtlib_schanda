...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (= (to_rep1 (rec__dic_of_cont__my_hase__cursor__node (us_split_fields3 a))) (to_rep1 (rec__dic_of_cont__my_hase__cursor__node (us_split_fields3 b)))) true false))
...
(define-fun default_initial_assumption ((temp___expr_898 us_rep2) (temp___skip_top_level_899 Bool)) Bool (=> (not (= temp___skip_top_level_899 true)) (and (= (is_empty temp___expr_898) true) (= (length1 temp___expr_898) 0))))
...
(define-fun default_initial_assumption1 ((temp___expr_875 us_rep3) (temp___skip_top_level_876 Bool)) Bool (=> (not (= temp___skip_top_level_876 true)) (= (length2 temp___expr_875) 0)))
...
(assert (forall ((container1 us_rep)) (! (let ((result (elements container1))) (and (and (and (and (= (length2 result) (length container1)) (forall ((temp___916 Int)) (=> (and (in_range5 temp___916) (= (iter_has_element result temp___916) true)) (= (contains (model__ container1) (get1 result temp___916)) true)))) (forall ((item Int)) (=> (and (in_range4 item) (= (contains (model__ container1) item) true)) (and (< 0 (find result item)) (= (get1 result (find result item)) item))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (= (find result (get1 result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length container1))) (=> (= (get1 result i) (get1 result j)) (= i j)))))))) :pattern ((elements container1)))))
...
(assert (and (= o1 (length container)) (and (in_range1 o1) (<= o1 (to_rep1 (rec__dic_of_cont__my_hase__set__capacity (us_split_discrs1 container)))))))
