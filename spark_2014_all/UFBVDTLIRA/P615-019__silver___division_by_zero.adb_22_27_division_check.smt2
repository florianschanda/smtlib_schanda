...
(declare-datatypes () ((unsigned__ref (mk_unsigned__ref (unsigned__content unsigned)))))
(define-fun unsigned__ref___projection ((a unsigned__ref)) unsigned (unsigned__content a))
