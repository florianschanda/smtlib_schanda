...
(assert (= i2 result1))
(assert (= i3 (+ i2 1)))
(assert (= (make_mask i3) (bvsub (ite (< i3 4294967296) (bvshl #x00000001 ((_ int2bv 32) i3)) #x00000000) #x00000001)))
(declare-const j Int)
(assert (<= 1 j))
(assert (<= j (- i3 1)))
(assert (not (= (make_mask j) (bvsub (ite (< j 4294967296) (bvshl #x00000001 ((_ int2bv 32) j)) #x00000000) #x00000001))))
(check-sat)
(exit)
