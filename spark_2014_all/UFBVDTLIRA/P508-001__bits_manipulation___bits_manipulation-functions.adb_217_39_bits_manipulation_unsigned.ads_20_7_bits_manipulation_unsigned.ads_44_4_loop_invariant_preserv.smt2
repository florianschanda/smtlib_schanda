...
(assert (forall ((j Int)) (=> (and (<= 1 j) (<= j (- i2 1))) (= (make_mask j) (bvsub (ite (< j 4294967296) (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) j)) ((_ int2bv 32) 0)) ((_ int2bv 32) 1))))))
(assert (and (=> (<= 2 31) (in_range2 i2)) (and (<= 2 i2) (<= i2 31))))
(assert (not (= i2 31)))
(assert (= i2 result1))
(assert (= i3 (+ i2 1)))
(assert (= (make_mask i3) (bvsub (ite (< i3 4294967296) (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) i3)) ((_ int2bv 32) 0)) ((_ int2bv 32) 1))))
(declare-const j Int)
(assert (<= 1 j))
(assert (<= j (- i3 1)))
(assert (not (= (make_mask j) (bvsub (ite (< j 4294967296) (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) j)) ((_ int2bv 32) 0)) ((_ int2bv 32) 1)))))
(check-sat)
(exit)
