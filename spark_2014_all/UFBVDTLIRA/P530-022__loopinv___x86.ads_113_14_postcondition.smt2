...
(assert (forall ((regold (_ BitVec 64)) (regnew (_ BitVec 64))) (forall ((val__1 (_ BitVec 8))) (! (=> (and (and (dynamic_invariant regold true true true true) (dynamic_invariant regnew true true true true)) (dynamic_invariant1 val__1 true true true true)) (= (= (writereglow8post regold regnew val__1) true) (and (= (readreglow8 regnew) val__1) (= (bvand regnew #xFFFFFFFFFFFFFF00) (bvand regold #xFFFFFFFFFFFFFF00))))) :pattern ((writereglow8post regold regnew val__1))))))
(assert (forall ((regold (_ BitVec 64)) (regnew (_ BitVec 64))) (forall ((val__1 (_ BitVec 8))) (! (= (= (writereglow8post regold regnew val__1) true) (and (= (readreglow8 regnew) val__1) (= (bvand regnew #xFFFFFFFFFFFFFF00) (bvand regold #xFFFFFFFFFFFFFF00)))) :pattern ((writereglow8post regold regnew val__1))))))
