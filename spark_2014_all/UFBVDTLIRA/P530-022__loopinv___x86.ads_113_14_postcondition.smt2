...
(assert (forall ((regold (_ BitVec 64)) (regnew (_ BitVec 64))) (forall ((val__1 (_ BitVec 8))) (! (=> (and (and (dynamic_invariant regold true true true) (dynamic_invariant regnew true true true)) (dynamic_invariant1 val__1 true true true)) (= (= (writereglow8post regold regnew val__1) true) (and (= (readreglow8 regnew) val__1) (= (bvand regnew ((_ int2bv 64) 18446744073709551360)) (bvand regold ((_ int2bv 64) 18446744073709551360)))))) :pattern ((writereglow8post regold regnew val__1))))))
(assert (forall ((regold (_ BitVec 64)) (regnew (_ BitVec 64))) (forall ((val__1 (_ BitVec 8))) (! (= (= (writereglow8post regold regnew val__1) true) (and (= (readreglow8 regnew) val__1) (= (bvand regnew ((_ int2bv 64) 18446744073709551360)) (bvand regold ((_ int2bv 64) 18446744073709551360))))) :pattern ((writereglow8post regold regnew val__1))))))
...
(assert true)
(assert (= result reg))
(assert (= reg1 (bvor (bvand reg ((_ int2bv 64) 18446744073709551360)) ((_ zero_extend 56) val__))))
(assert (= reg1 reg2))
(assert (= reg3 reg1))
