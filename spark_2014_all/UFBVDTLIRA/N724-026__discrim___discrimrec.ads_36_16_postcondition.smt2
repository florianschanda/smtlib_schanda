...
(assert (and (and (and (= us 1) (in_range 1)) (and (and (= eax__attr__constrained true) (= (to_rep2 (rec__discrimrec__register_type__option eax__split_discrs)) 1)) (and (and (= 1 (to_rep2 (rec__discrimrec__register_type__option eax__split_discrs))) (= eax__attr__constrained true)) (and (and (and (and (and (and (and (= (to_rep o1) ((_ int2bv 64) 16)) (and (= o1 o2) (and (= dummy1 o3) (and (= dummy1 o4) (and (= dummy1 o5) (and (= dummy2 o6) (and (= dummy2 o7) (and (= dummy1 o8) (and (= dummy2 o9) (and (= dummy3 o10) (= dummy3 o11))))))))))) (and (and (= (to_rep2 o) 0) (= o o12)) (and (= o13 o12) (and (and (= o14 o2) (and (= o15 o3) (and (= o16 o4) (and (= o17 o5) (and (= o18 o6) (and (= o19 o7) (and (= o20 o8) (and (= o21 o9) (and (= o22 o10) (= o23 o11)))))))))) (= true o24))))) (= (mk___rep (mk___split_discrs o25) (mk___split_fields o26 o27 o28 o29 o30 o31 o32 o33 o34 o35) o36) (mk___rep (mk___split_discrs o13) (mk___split_fields o14 o15 o16 o17 o18 o19 o20 o21 o22 o23) o24))) (= (mk___rep (mk___split_discrs o37) (mk___split_fields o38 o39 o40 o41 o42 o43 o44 o45 o46 o47) o48) (mk___rep (mk___split_discrs o25) (mk___split_fields o26 o27 o28 o29 o30 o31 o32 o33 o34 o35) o36))) (= (mk___rep (mk___split_discrs temp___260) (mk___split_fields temp___2601 temp___2602 temp___2603 temp___2604 temp___2605 temp___2606 temp___2607 temp___2608 temp___2609 temp___26010) temp___26011) (mk___rep (mk___split_discrs o37) (mk___split_fields o38 o39 o40 o41 o42 o43 o44 o45 o46 o47) o48))) (and (and (= result (mk___split_fields__ref (mk___split_fields rax__split_fields rax__split_fields1 rax__split_fields2 rax__split_fields3 rax__split_fields4 rax__split_fields5 rax__split_fields6 rax__split_fields7 rax__split_fields8 rax__split_fields9))) (= rax__split_fields10 (mk___split_fields temp___2601 temp___2602 temp___2603 temp___2604 temp___2605 temp___2606 temp___2607 temp___2608 temp___2609 temp___26010))) (= rax__split_discrs (mk___split_discrs temp___260)))) (and (and (and (and (and (and (= (mk___rep (mk___split_discrs o49) (mk___split_fields o50 o51 o52 o53 o54 o55 o56 o57 o58 o59) o60) (convert_bit_64_to_bit_32 (mk___rep rax__split_discrs rax__split_fields10 rax__attr__constrained))) (and (and (= 1 (to_rep2 o49)) (= o60 true)) (and (= (of_rep2 1) o49) (and (and (= dummy o50) (and (= (of_rep1 ((_ int2bv 32) 0)) o51) (and (= (of_rep1 ((_ extract 31 0) (bvurem (to_rep (rec__discrimrec__register_type__value_64 rax__split_fields10)) ((_ int2bv 64) 4294967296)))) o52) (and (= dummy1 o53) (and (= dummy2 o54) (and (= dummy2 o55) (and (= dummy1 o56) (and (= dummy2 o57) (and (= dummy3 o58) (= dummy3 o59)))))))))) (= true o60))))) (= o61 (mk___rep (mk___split_discrs o49) (mk___split_fields o50 o51 o52 o53 o54 o55 o56 o57 o58 o59) o60))) (= o62 o61)) (= temp___261 o62)) (and (and (= result1 (mk___split_fields__ref (mk___split_fields eax__split_fields eax__split_fields1 eax__split_fields2 eax__split_fields3 eax__split_fields4 eax__split_fields5 eax__split_fields6 eax__split_fields7 eax__split_fields8 eax__split_fields9))) (= eax__split_fields10 (us_split_fields1 temp___261))) (= eax__split_discrs (us_split_discrs1 temp___261)))) (ite (= (to_rep1 (rec__discrimrec__register_type__value_32 eax__split_fields10)) ((_ int2bv 32) 16)) (and (and (and (and (and (and (= (to_rep o64) ((_ int2bv 64) 32)) (= o65 (mk___split_fields o64 dummy1 dummy1 dummy1 dummy2 dummy2 dummy1 dummy2 dummy3 dummy3))) (and (and (= (to_rep2 o63) 0) (= o66 (mk___split_discrs o63))) (= o67 (mk___rep o66 o65 true)))) (= o68 o67)) (= o69 o68)) (= temp___262 o69)) (and (and (= result2 (mk___split_fields__ref rax__split_fields10)) (= rax__split_fields11 (us_split_fields1 temp___262))) (= rax__split_discrs (us_split_discrs1 temp___262)))) (= rax__split_fields11 rax__split_fields10))))))) (and (and (= eax__split_fields11 (mk___split_fields__ref eax__split_fields10)) (= rax__split_fields12 (mk___split_fields__ref rax__split_fields11))) (and (= eax__split_fields12 eax__split_fields10) (= rax__split_fields13 rax__split_fields11)))))
(assert (not (= (to_rep (rec__discrimrec__register_type__value_64 (us_split_fields__content rax__split_fields12))) ((_ int2bv 64) 32))))
(check-sat)
(exit)
