...
(define-fun o70 () us_rep (mk___rep (mk___split_discrs o49) (mk___split_fields o50 o51 o52 o53 o54 o55 o56 o57 o58 o59) o60))
(define-fun o71 () us_rep (mk___rep (mk___split_discrs o37) (mk___split_fields o38 o39 o40 o41 o42 o43 o44 o45 o46 o47) o48))
(define-fun o72 () us_rep (mk___rep (mk___split_discrs o25) (mk___split_fields o26 o27 o28 o29 o30 o31 o32 o33 o34 o35) o36))
...
(assert (= o23 o11))
(assert (= true o24))
(assert (= o72 (mk___rep (mk___split_discrs o13) (mk___split_fields o14 o15 o16 o17 o18 o19 o20 o21 o22 o23) o24)))
(assert (= o71 o72))
(assert (= (mk___rep (mk___split_discrs temp___260) (mk___split_fields temp___2601 temp___2602 temp___2603 temp___2604 temp___2605 temp___2606 temp___2607 temp___2608 temp___2609 temp___26010) temp___26011) o71))
...
(assert (=> (= (to_rep1 (rec__discrimrec__register_type__value_32 eax__split_fields10)) ((_ int2bv 32) 16)) (= (to_rep o64) ((_ int2bv 64) 32))))
(assert (=> (= (to_rep1 (rec__discrimrec__register_type__value_32 eax__split_fields10)) ((_ int2bv 32) 16)) (= o65 (mk___split_fields o64 dummy1 dummy1 dummy1 dummy2 dummy2 dummy1 dummy2 dummy3 dummy3))))
(assert (=> (= (to_rep1 (rec__discrimrec__register_type__value_32 eax__split_fields10)) ((_ int2bv 32) 16)) (= (to_rep2 o63) 0)))
(assert (=> (= (to_rep1 (rec__discrimrec__register_type__value_32 eax__split_fields10)) ((_ int2bv 32) 16)) (= o66 (mk___split_discrs o63))))
(assert (=> (= (to_rep1 (rec__discrimrec__register_type__value_32 eax__split_fields10)) ((_ int2bv 32) 16)) (= o67 (mk___rep o66 o65 true))))
(assert (=> (= (to_rep1 (rec__discrimrec__register_type__value_32 eax__split_fields10)) ((_ int2bv 32) 16)) (= o68 o67)))
(assert (=> (= (to_rep1 (rec__discrimrec__register_type__value_32 eax__split_fields10)) ((_ int2bv 32) 16)) (= o69 o68)))
(assert (=> (= (to_rep1 (rec__discrimrec__register_type__value_32 eax__split_fields10)) ((_ int2bv 32) 16)) (= temp___262 o69)))
(assert (=> (= (to_rep1 (rec__discrimrec__register_type__value_32 eax__split_fields10)) ((_ int2bv 32) 16)) (= result2 (mk___split_fields__ref rax__split_fields10))))
(assert (=> (= (to_rep1 (rec__discrimrec__register_type__value_32 eax__split_fields10)) ((_ int2bv 32) 16)) (= rax__split_fields11 (us_split_fields1 temp___262))))
(assert (=> (= (to_rep1 (rec__discrimrec__register_type__value_32 eax__split_fields10)) ((_ int2bv 32) 16)) (= rax__split_discrs (us_split_discrs1 temp___262))))
(assert (=> (not (= (to_rep1 (rec__discrimrec__register_type__value_32 eax__split_fields10)) ((_ int2bv 32) 16))) (= rax__split_fields11 rax__split_fields10)))
(assert (= eax__split_fields11 (mk___split_fields__ref eax__split_fields10)))
(assert (= rax__split_fields12 (mk___split_fields__ref rax__split_fields11)))
