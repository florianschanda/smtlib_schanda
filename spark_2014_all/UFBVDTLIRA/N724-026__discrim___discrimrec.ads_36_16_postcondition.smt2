...
(declare-const temp___294 us_rep)
...
(assert (= o71 o72))
(assert (= (mk___rep (mk___split_discrs temp___292) (mk___split_fields temp___2921 temp___2922 temp___2923 temp___2924 temp___2925 temp___2926 temp___2927 temp___2928 temp___2929 temp___29210) temp___29211) o71))
...
(assert (=> (= (to_rep1 (rec__discrimrec__register_type__value_32 eax__split_fields10)) #x00000010) (= (to_rep o64) #x0000000000000020)))
(assert (=> (= (to_rep1 (rec__discrimrec__register_type__value_32 eax__split_fields10)) #x00000010) (= o65 (mk___split_fields o64 dummy1 dummy1 dummy1 dummy2 dummy2 dummy1 dummy2 dummy3 dummy3))))
(assert (=> (= (to_rep1 (rec__discrimrec__register_type__value_32 eax__split_fields10)) #x00000010) (= (to_rep2 o63) 0)))
(assert (=> (= (to_rep1 (rec__discrimrec__register_type__value_32 eax__split_fields10)) #x00000010) (= o66 (mk___split_discrs o63))))
(assert (=> (= (to_rep1 (rec__discrimrec__register_type__value_32 eax__split_fields10)) #x00000010) (= o67 (mk___rep o66 o65 true))))
(assert (=> (= (to_rep1 (rec__discrimrec__register_type__value_32 eax__split_fields10)) #x00000010) (= o68 o67)))
(assert (=> (= (to_rep1 (rec__discrimrec__register_type__value_32 eax__split_fields10)) #x00000010) (= o69 o68)))
(assert (=> (= (to_rep1 (rec__discrimrec__register_type__value_32 eax__split_fields10)) #x00000010) (= temp___294 o69)))
(assert (=> (= (to_rep1 (rec__discrimrec__register_type__value_32 eax__split_fields10)) #x00000010) (= result2 (mk___split_fields__ref rax__split_fields10))))
(assert (=> (= (to_rep1 (rec__discrimrec__register_type__value_32 eax__split_fields10)) #x00000010) (= rax__split_fields11 (us_split_fields1 temp___294))))
(assert (=> (= (to_rep1 (rec__discrimrec__register_type__value_32 eax__split_fields10)) #x00000010) (= rax__split_discrs (us_split_discrs1 temp___294))))
(assert (=> (not (= (to_rep1 (rec__discrimrec__register_type__value_32 eax__split_fields10)) #x00000010)) (= rax__split_fields11 rax__split_fields10)))
...
(assert (not (= (to_rep (rec__discrimrec__register_type__value_64 (us_split_fields__content rax__split_fields12))) #x0000000000000020)))
(check-sat)
(exit)
