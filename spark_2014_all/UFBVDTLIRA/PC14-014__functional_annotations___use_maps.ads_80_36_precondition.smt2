...
(assert (and (= o4 (length s2)) (and (in_range1 o4) (<= o4 (to_rep1 (rec__use_maps__my_maps__map__capacity (us_split_discrs1 s2)))))))
(assert (and (= o2 (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (and (in_range1 o2) (<= o2 (to_rep1 (rec__use_maps__my_maps__map__capacity s1__split_discrs))))))
(assert (= o3 (- (to_rep1 (rec__use_maps__my_maps__map__capacity s1__split_discrs)) o2)))
(assert (and (= o5 o3) (in_range10 o3)))
...
(assert (and (= o (iter_has_element temp___972 temp___971)) (= (= o true) (and (<= 1 temp___971) (<= temp___971 (last temp___972))))))
(assert (= (= o1 true) (in_range5 temp___971)))
(assert (= result (ite (= o1 true) o false)))
(assert (= result true))
(assert (and (= k (get1 temp___972 temp___971)) (in_range4 k)))
(assert (not (= (has_key (model__ s2) k) true)))
(check-sat)
(exit)
