...
(assert (and (= o4 (length s2)) (and (in_range2 o4) (<= o4 (to_rep (rec__use_maps__my_maps__map__capacity (us_split_discrs1 s2)))))))
(assert (and (= o2 (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (and (in_range2 o2) (<= o2 (to_rep (rec__use_maps__my_maps__map__capacity s1__split_discrs))))))
(assert (= o3 (- (to_rep (rec__use_maps__my_maps__map__capacity s1__split_discrs)) o2)))
...
(assert (= result true))
(assert (and (= k (get1 temp___972 temp___971)) (in_range6 k)))
