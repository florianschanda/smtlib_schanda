...
(assert (forall ((x rate_number)) (! (= (of_rep1 (to_rep1 x)) x) :pattern ((to_rep1 x)))))
(assert (forall ((x rate_number)) (! (in_range1 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun bool_eq1 ((a us_rep) (b us_rep)) Bool (ite (and (= (bool_eq (rec__keccak__keccak_1600__duplex__context__state (us_split_fields1 a)) #x00 #x04 #x00 #x04 (rec__keccak__keccak_1600__duplex__context__state (us_split_fields1 b)) #x00 #x04 #x00 #x04) true) (= (to_rep1 (rec__keccak__keccak_1600__duplex__context__rate (us_split_fields1 a))) (to_rep1 (rec__keccak__keccak_1600__duplex__context__rate (us_split_fields1 b))))) true false))
...
(define-fun dynamic_invariant1 ((temp___expr_572 Int) (temp___is_init_568 Bool) (temp___skip_constant_569 Bool) (temp___do_toplevel_570 Bool) (temp___do_typ_inv_571 Bool)) Bool (=> (or (= temp___is_init_568 true) (<= 3 1599)) (in_range1 temp___expr_572)))
(assert (forall ((ctx us_rep)) (! (dynamic_invariant1 (rate_of ctx) true false true true) :pattern ((rate_of ctx)))))
(assert (forall ((ctx us_rep)) (! (= (rate_of ctx) (to_rep1 (rec__keccak__keccak_1600__duplex__context__rate (us_split_fields1 ctx)))) :pattern ((rate_of ctx)))))
...
(declare-const temp___1114 map1)
(declare-const temp___11141 rate_number)
...
(assert (= (mk___split_fields__ref (mk___split_fields result result1)) (mk___split_fields__ref (mk___split_fields ctx__split_fields ctx__split_fields1))))
...
(assert (= o1 o3))
(assert (= temp___1114 o2))
(assert (= temp___11141 o3))
(assert (= result2 ctx__split_fields2))
(assert (= result3 ctx__split_fields3))
(assert (= temp___1114 ctx__split_fields4))
(assert (= temp___11141 ctx__split_fields5))
...
(assert (not (= (rate_of (mk___rep (mk___split_fields ctx__split_fields6 ctx__split_fields7))) (- 1600 capacity))))
(check-sat)
(exit)
