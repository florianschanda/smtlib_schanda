...
(define-fun bool_eq1 ((a us_rep) (b us_rep)) Bool (ite (and (= (bool_eq (rec__keccak__keccak_1600__duplex__context__state (us_split_fields1 a)) ((_ int2bv 8) 0) ((_ int2bv 8) 4) ((_ int2bv 8) 0) ((_ int2bv 8) 4) (rec__keccak__keccak_1600__duplex__context__state (us_split_fields1 b)) ((_ int2bv 8) 0) ((_ int2bv 8) 4) ((_ int2bv 8) 0) ((_ int2bv 8) 4)) true) (= (to_rep1 (rec__keccak__keccak_1600__duplex__context__rate (us_split_fields1 a))) (to_rep1 (rec__keccak__keccak_1600__duplex__context__rate (us_split_fields1 b))))) true false))
...
(define-fun dynamic_invariant1 ((temp___expr_511 Int) (temp___is_init_508 Bool) (temp___skip_constant_509 Bool) (temp___do_toplevel_510 Bool)) Bool (=> (or (= temp___is_init_508 true) (<= 3 1599)) (in_range1 temp___expr_511)))
(assert (forall ((ctx us_rep)) (! (dynamic_invariant1 (rate_of ctx) true false true) :pattern ((rate_of ctx)))))
