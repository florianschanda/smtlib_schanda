...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (and (= (to_rep (rec__my_sets__n__set__capacity (us_split_discrs1 a))) (to_rep (rec__my_sets__n__set__capacity (us_split_discrs1 b)))) (= (to_rep1 (rec__my_sets__n__set__modulus (us_split_discrs1 a))) (to_rep1 (rec__my_sets__n__set__modulus (us_split_discrs1 b))))) (= (us_main_eq (rec__my_sets__n__set (us_split_fields1 a)) (rec__my_sets__n__set (us_split_fields1 b))) true)) true false))
...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__my_sets__n__set__capacity (us_split_discrs1 container)))) (dynamic_invariant result true false true))) :pattern ((length container)))))
...
(define-fun default_initial_assumption ((temp___expr_724 us_rep2) (temp___skip_top_level_725 Bool)) Bool (=> (not (= temp___skip_top_level_725 true)) (= (length2 temp___expr_724) 0)))
(assert (forall ((container us_rep2)) (forall ((item us_rep3)) (! (let ((result (find container item))) (and (=> (< 0 result) (and (<= result (length2 container)) (= (my_eq item (get container result)) true))) (dynamic_invariant result true false true))) :pattern ((find container item))))))
(declare-fun is_empty (us_rep1) Bool)
(declare-fun is_empty__function_guard (Bool us_rep1) Bool)
(define-fun default_initial_assumption1 ((temp___expr_691 us_rep1) (temp___skip_top_level_692 Bool)) Bool (=> (not (= temp___skip_top_level_692 true)) (= (is_empty temp___expr_691) true)))
...
(assert (forall ((container us_rep)) (! (let ((result (elements container))) (and (and (and (and (= (length2 result) (length container)) (forall ((temp___761 Int)) (=> (and (in_range5 temp___761) (= (iter_has_element result temp___761) true)) (= (contains (model__ container) (get result temp___761)) true)))) (forall ((item us_rep3)) (=> (= (contains (model__ container) item) true) (and (< 0 (find result item)) (= (my_eq (get result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (= (find result (get result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length container))) (=> (= (my_eq (get result i) (get result j)) true) (= i j)))))))) :pattern ((elements container)))))
...
(assert true)
(assert (forall ((container us_rep1)) (forall ((item us_rep3)) (! (=> (= (of_int 1) true) (=> (exists ((e us_rep3)) (and (= (contains container e) true) (= (my_eq e item) true))) (= (contains container item) true))) :pattern ((contains container item))))))
...
(define-fun dynamic_invariant4 ((temp___expr_717 Int) (temp___is_init_714 Bool) (temp___skip_constant_715 Bool) (temp___do_toplevel_716 Bool)) Bool (=> (or (= temp___is_init_714 true) (<= 0 2147483647)) (in_range5 temp___expr_717)))
...
(assert (and (= o6 (length (mk___rep target__split_discrs (mk___split_fields target__split_fields)))) (and (in_range1 o6) (<= o6 (to_rep (rec__my_sets__n__set__capacity target__split_discrs))))))
(assert (= o7 (- (to_rep (rec__my_sets__n__set__capacity target__split_discrs)) o6)))
(assert (and (= o12 o7) (in_range o7)))
(assert (= o13 (+ o12 o11)))
(assert (not (in_range o13)))
(check-sat)
(exit)
