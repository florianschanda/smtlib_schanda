...
(define-fun default_initial_assumption ((temp___expr_739 us_rep2) (temp___skip_top_level_740 Bool)) Bool (=> (not (= temp___skip_top_level_740 true)) (= (is_empty temp___expr_739) true)))
(assert (forall ((container us_rep2)) (forall ((item us_rep1)) (! (=> (= (distinct 1 0) true) (=> (exists ((e us_rep1)) (and (= (contains container e) true) (= (my_eq e item) true))) (= (contains container item) true))) :pattern ((contains container item))))))
...
(define-fun dynamic_invariant4 ((temp___expr_197 Int) (temp___is_init_193 Bool) (temp___skip_constant_194 Bool) (temp___do_toplevel_195 Bool) (temp___do_typ_inv_196 Bool)) Bool (=> (or (= temp___is_init_193 true) (<= 0 2147483647)) (in_range1 temp___expr_197)))
(assert (forall ((container1 us_rep)) (! (let ((result (length container1))) (and (<= result (to_rep1 (rec__my_sets__n__set__capacity (us_split_discrs1 container1)))) (dynamic_invariant4 result true false true true))) :pattern ((length container1)))))
...
(define-fun default_initial_assumption1 ((temp___expr_777 us_rep3) (temp___skip_top_level_778 Bool)) Bool (=> (not (= temp___skip_top_level_778 true)) (= (length3 temp___expr_777) 0)))
(declare-fun find (us_rep3 us_rep1) Int)
(declare-fun find__function_guard (Int us_rep3 us_rep1) Bool)
(assert (forall ((container1 us_rep3)) (forall ((item us_rep1)) (! (let ((result (find container1 item))) (and (=> (< 0 result) (and (<= result (length3 container1)) (= (my_eq item (get container1 result)) true))) (dynamic_invariant4 result true false true true))) :pattern ((find container1 item))))))
...
(assert (forall ((container1 us_rep)) (! (let ((result (elements container1))) (and (and (and (and (= (length3 result) (length container1)) (forall ((temp___818 Int)) (=> (and (in_range5 temp___818) (= (iter_has_element result temp___818) true)) (= (contains (model__ container1) (get result temp___818)) true)))) (forall ((item us_rep1)) (=> (= (contains (model__ container1) item) true) (and (< 0 (find result item)) (= (my_eq (get result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (= (find result (get result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length container1))) (=> (= (my_eq (get result i) (get result j)) true) (= i j)))))))) :pattern ((elements container1)))))
