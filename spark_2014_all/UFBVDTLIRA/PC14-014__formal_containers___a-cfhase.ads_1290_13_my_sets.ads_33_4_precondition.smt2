...
(define-fun default_initial_assumption ((temp___expr_691 us_rep2) (temp___skip_top_level_692 Bool)) Bool (=> (not (= temp___skip_top_level_692 true)) (= (is_empty temp___expr_691) true)))
(assert (forall ((container us_rep2)) (forall ((item us_rep1)) (! (=> (= (of_int 1) true) (=> (exists ((e us_rep1)) (and (= (contains container e) true) (= (my_eq e item) true))) (= (contains container item) true))) :pattern ((contains container item))))))
...
(define-fun dynamic_invariant1 ((temp___expr_981 Int) (temp___is_init_978 Bool) (temp___skip_constant_979 Bool) (temp___do_toplevel_980 Bool)) Bool (=> (or (= temp___is_init_978 true) (<= 1 2147483647)) (in_range4 temp___expr_981)))
...
(define-fun dynamic_invariant4 ((temp___expr_173 Int) (temp___is_init_170 Bool) (temp___skip_constant_171 Bool) (temp___do_toplevel_172 Bool)) Bool (=> (or (= temp___is_init_170 true) (<= 0 2147483647)) (in_range1 temp___expr_173)))
(assert (forall ((container1 us_rep)) (! (let ((result (length container1))) (and (<= result (to_rep1 (rec__my_sets__n__set__capacity (us_split_discrs1 container1)))) (dynamic_invariant4 result true false true))) :pattern ((length container1)))))
...
(define-fun default_initial_assumption1 ((temp___expr_724 us_rep3) (temp___skip_top_level_725 Bool)) Bool (=> (not (= temp___skip_top_level_725 true)) (= (length3 temp___expr_724) 0)))
(declare-fun find (us_rep3 us_rep1) Int)
(declare-fun find__function_guard (Int us_rep3 us_rep1) Bool)
(assert (forall ((container1 us_rep3)) (forall ((item us_rep1)) (! (let ((result (find container1 item))) (and (=> (< 0 result) (and (<= result (length3 container1)) (= (my_eq item (get container1 result)) true))) (dynamic_invariant4 result true false true))) :pattern ((find container1 item))))))
...
(assert (forall ((container1 us_rep)) (! (let ((result (elements container1))) (and (and (and (and (= (length3 result) (length container1)) (forall ((temp___761 Int)) (=> (and (in_range5 temp___761) (= (iter_has_element result temp___761) true)) (= (contains (model__ container1) (get result temp___761)) true)))) (forall ((item us_rep1)) (=> (= (contains (model__ container1) item) true) (and (< 0 (find result item)) (= (my_eq (get result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (= (find result (get result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length container1))) (=> (= (my_eq (get result i) (get result j)) true) (= i j)))))))) :pattern ((elements container1)))))
...
(define-fun dynamic_invariant5 ((temp___expr_717 Int) (temp___is_init_714 Bool) (temp___skip_constant_715 Bool) (temp___do_toplevel_716 Bool)) Bool (=> (or (= temp___is_init_714 true) (<= 0 2147483647)) (in_range5 temp___expr_717)))
...
(assert true)
(declare-const temp___1348 us_rep2)
(declare-const e positive)
(declare-const e1 integer)
(declare-const o Bool)
(assert (in_range4 key))
(assert (and (= temp___1348 (model__ container)) (= (length2 temp___1348) (length container))))
(assert (not true))
(check-sat)
(exit)
