...
(assert (= left_ux1 o12))
(assert (not (bvult left_y1 (let ((temp___274 (bv2nat i2))) (ite (< temp___274 18446744073709551616) (bvshl #x0000000000000001 ((_ int2bv 64) temp___274)) #x0000000000000000)))))
(check-sat)
(exit)
