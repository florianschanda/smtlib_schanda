...
(define-fun dynamic_invariant1 ((temp___expr_141 (_ BitVec 8)) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool true)
(declare-const rdx (_ BitVec 64))
(declare-const x86__dl__result (_ BitVec 8))
(declare-const result (_ BitVec 8))
(declare-const x86__dl__result1 (_ BitVec 8))
(declare-const x86__dl__result2 (_ BitVec 8))
(declare-const x86__dl__result3 (_ BitVec 8))
(declare-const x86__dl__result4 (_ BitVec 8))
(declare-const x86__dl__result5 (_ BitVec 8))
(assert true)
(assert (= x86__dl__result1 x86__dl__result2))
(assert (= x86__dl__result3 x86__dl__result1))
(assert (= (mk_t__ref result) (mk_t__ref x86__dl__result)))
(assert (= x86__dl__result1 ((_ extract 7 0) (bvand rdx ((_ int2bv 64) 255)))))
(assert (= (mk_t__ref x86__dl__result4) (mk_t__ref x86__dl__result2)))
(assert (= x86__dl__result5 x86__dl__result3))
(assert (not (bvule ((_ zero_extend 56) ((_ int2bv 8) 0)) (bvand rdx ((_ int2bv 64) 255)))))
(check-sat)
(exit)
