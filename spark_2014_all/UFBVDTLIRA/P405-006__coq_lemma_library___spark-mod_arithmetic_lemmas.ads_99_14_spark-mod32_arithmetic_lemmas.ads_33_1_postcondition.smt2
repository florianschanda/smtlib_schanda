...
(assert true)
(assert (and (bvule scale_num scale_denom) (and (or (= scale_num ((_ int2bv 32) 0)) (bvule val__ (bvudiv ((_ int2bv 32) 4294967295) scale_num))) (= res (bvudiv (bvmul val__ scale_num) scale_denom)))))
