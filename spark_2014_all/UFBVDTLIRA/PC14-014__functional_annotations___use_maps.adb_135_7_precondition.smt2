...
(assert (and (and (and (and (and (and (and (= (length (mk___rep m__split_discrs m__split_fields2)) (+ (length (mk___rep m__split_discrs (mk___split_fields m__split_fields))) 1)) (= (has_key (model__ (mk___rep m__split_discrs m__split_fields2)) 1) true)) (= (key (mk___rep m__split_discrs m__split_fields2) (find1 (mk___rep m__split_discrs m__split_fields2) 1)) 1)) (= (get (model__ (mk___rep m__split_discrs m__split_fields2)) 1) 0)) (= (ole (model__ (mk___rep m__split_discrs (mk___split_fields m__split_fields))) (model__ (mk___rep m__split_discrs m__split_fields2))) true)) (= (keys_included_except (model__ (mk___rep m__split_discrs m__split_fields2)) (model__ (mk___rep m__split_discrs (mk___split_fields m__split_fields))) 1) true)) (= (mapping_preserved (keys (mk___rep m__split_discrs (mk___split_fields m__split_fields))) (keys (mk___rep m__split_discrs m__split_fields2)) (positions (mk___rep m__split_discrs (mk___split_fields m__split_fields))) (positions (mk___rep m__split_discrs m__split_fields2))) true)) (= (keys_included_except1 (positions (mk___rep m__split_discrs m__split_fields2)) (positions (mk___rep m__split_discrs (mk___split_fields m__split_fields))) (find1 (mk___rep m__split_discrs m__split_fields2) 1)) true)))
(assert (not (< (length (mk___rep m__split_discrs m__split_fields2)) (to_rep (rec__use_maps__my_maps__map__capacity m__split_discrs)))))
(check-sat)
(exit)
