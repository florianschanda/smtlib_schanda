...
(assert true)
(assert (= result rdi))
(assert (= rdi1 (bvor (bvand rdi ((_ int2bv 64) 18446744069414584320)) ((_ zero_extend 32) val__))))
(assert (= rdi1 rdi2))
(assert (= rdi3 rdi1))
(assert (not (= rdi2 (bvor (bvand rdi ((_ int2bv 64) 18446744069414584320)) ((_ zero_extend 32) val__)))))
(check-sat)
(exit)
