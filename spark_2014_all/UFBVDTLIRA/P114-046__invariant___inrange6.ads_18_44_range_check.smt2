...
(assert true)
(assert (=> (bvule bottom (bvadd (bvsub ((_ int2bv 64) 18446744073709551615) range_size) ((_ int2bv 64) 1))) (= (mk_bool__ref result1) (mk_bool__ref matched))))
(assert (=> (bvule bottom (bvadd (bvsub ((_ int2bv 64) 18446744073709551615) range_size) ((_ int2bv 64) 1))) (= matched1 (ite (bvule bottom var) (ite (bvule var (bvsub (bvadd bottom range_size) ((_ int2bv 64) 1))) true false) false))))
(assert (=> (not (bvule bottom (bvadd (bvsub ((_ int2bv 64) 18446744073709551615) range_size) ((_ int2bv 64) 1)))) (= (mk_bool__ref result2) (mk_bool__ref matched))))
(assert (=> (not (bvule bottom (bvadd (bvsub ((_ int2bv 64) 18446744073709551615) range_size) ((_ int2bv 64) 1)))) (= matched2 (ite (= (ite (bvule bottom var) (of_int 1) false) false) (ite (bvult var (bvsub (bvsub range_size (bvsub ((_ int2bv 64) 18446744073709551615) bottom)) ((_ int2bv 64) 1))) true false) true))))
(assert (=> (not (bvule bottom (bvadd (bvsub ((_ int2bv 64) 18446744073709551615) range_size) ((_ int2bv 64) 1)))) (= matched1 matched2)))
