...
(assert (=> (bvule bottom (bvadd (bvsub ((_ int2bv 64) 18446744073709551615) range_size) ((_ int2bv 64) 1))) (= (mk_bool__ref result1) matched5)))
...
(assert (=> (not (bvule bottom (bvadd (bvsub ((_ int2bv 64) 18446744073709551615) range_size) ((_ int2bv 64) 1)))) (= (mk_bool__ref result2) matched5)))
