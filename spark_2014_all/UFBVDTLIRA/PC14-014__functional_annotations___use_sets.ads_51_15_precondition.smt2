...
(assert (and (and (and (and (and (and (and (= (length (mk___rep s1__split_discrs s1__split_fields4)) (+ (- (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (num_overlaps (model__ (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (model__ s2))) (length s2))) (= (ole (model__ (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (model__ (mk___rep s1__split_discrs s1__split_fields4))) true)) (= (ole (model__ s2) (model__ (mk___rep s1__split_discrs s1__split_fields4))) true)) (= (included_in_union (model__ (mk___rep s1__split_discrs s1__split_fields4)) (model__ s2) (model__ (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) true)) (= (e_elements_included__3 (elements (mk___rep s1__split_discrs s1__split_fields4)) (model__ (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (elements s2)) true)) (= (e_elements_included__2 (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (model__ (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (elements (mk___rep s1__split_discrs s1__split_fields4))) true)) (= (e_elements_included__3 (elements s2) (model__ (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (elements s2) (elements (mk___rep s1__split_discrs s1__split_fields4))) true)) (= (mapping_preserved (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (elements (mk___rep s1__split_discrs s1__split_fields4)) (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (positions (mk___rep s1__split_discrs s1__split_fields4))) true)))
(assert (= s1__split_fields2 s1__split_fields1))
(assert (= (mk___split_fields s1__split_fields3) s1__split_fields4))
(assert (and (= temp___958 (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields2)))) (and (and (and (and (= (length1 temp___958) (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields2)))) (forall ((temp___467 Int)) (=> (and (in_range3 temp___467) (= (iter_has_element temp___958 temp___467) true)) (= (contains (model__ (mk___rep s1__split_discrs (mk___split_fields s1__split_fields2))) (get temp___958 temp___467)) true)))) (forall ((item Int)) (=> (and (in_range4 item) (= (contains (model__ (mk___rep s1__split_discrs (mk___split_fields s1__split_fields2))) item) true)) (and (< 0 (find temp___958 item)) (= (get temp___958 (find temp___958 item)) item))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields2))))) (= (find temp___958 (get temp___958 i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields2))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields2))))) (=> (= (get temp___958 i) (get temp___958 j)) (= i j)))))))))
(assert (and (= o (iter_has_element temp___958 temp___957)) (= (= o true) (and (<= 1 temp___957) (<= temp___957 (last temp___958))))))
(assert (= (= o1 true) (in_range3 temp___957)))
(assert (= result (ite (= o1 true) o false)))
(assert (= result true))
(assert (not (<= temp___957 (last temp___958))))
(check-sat)
(exit)
