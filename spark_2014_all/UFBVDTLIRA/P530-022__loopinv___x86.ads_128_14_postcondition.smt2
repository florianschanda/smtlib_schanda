...
(assert (and (= o (readreghigh8 regnew)) (= o ((_ extract 7 0) (bvurem (bvudiv (bvand regnew ((_ int2bv 64) 65280)) ((_ int2bv 64) 256)) ((_ int2bv 64) 256))))))
(assert (= o1 (ite (= o val__) true false)))
(assert (= o2 (ite (= o1 true) (ite (= (bvand regnew ((_ int2bv 64) 18446744073709486335)) (bvand regold ((_ int2bv 64) 18446744073709486335))) true false) false)))
