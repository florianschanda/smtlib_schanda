...
(assert (=> (= b true) (= result__1 #x00000001)))
(assert (=> (not (= b true)) (= result1 result__)))
(assert (=> (not (= b true)) (= result__2 #x00000000)))
(assert (=> (not (= b true)) (= result__1 result__2)))
(assert (= lsc__bignum__word_of_boolean__result1 lsc__bignum__word_of_boolean__result2))
(assert (= lsc__bignum__word_of_boolean__result3 lsc__bignum__word_of_boolean__result1))
(assert (= result2 lsc__bignum__word_of_boolean__result))
(assert (= lsc__bignum__word_of_boolean__result1 result__1))
(assert (= (mk_t__ref lsc__bignum__word_of_boolean__result4) (mk_t__ref lsc__bignum__word_of_boolean__result2)))
(assert (= result__3 result__1))
(assert (= lsc__bignum__word_of_boolean__result5 lsc__bignum__word_of_boolean__result3))
(assert (= result__4 result__1))
(assert (= result3 lsc__bignum__word_of_boolean__result4))
(assert (not (= (oeq (from_word32 lsc__bignum__word_of_boolean__result4) (num_of_boolean b)) true)))
(check-sat)
(exit)
