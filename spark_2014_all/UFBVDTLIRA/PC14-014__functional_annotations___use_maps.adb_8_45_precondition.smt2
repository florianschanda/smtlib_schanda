...
(assert (= result3 (mk_int__ref temp___7461)))
(assert (= temp___7462 (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2)))))
...
(assert (= use_maps__my_find__result3 use_maps__my_find__result2))
(assert (and (= (mk___rep1 (mk___split_fields1 temp___744)) (next s (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (ite (= (ite (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields2)) no_element) false) (= (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) (length3 s)) true) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 temp___744)) no_element) true) (and (= (has_key1 (positions s) (mk___rep1 (mk___split_fields1 temp___744))) true) (= (get1 (positions s) (mk___rep1 (mk___split_fields1 temp___744))) (+ (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))))))
...
(assert (and (= o10 (positions s)) (and (not (= (has_key1 o10 no_element) true)) (forall ((i1 us_rep1)) (=> (= (has_key1 o10 i1) true) (and (and (<= 1 (get1 o10 i1)) (<= (get1 o10 i1) (length3 s))) (forall ((j us_rep1)) (=> (= (has_key1 o10 j) true) (=> (= (get1 o10 i1) (get1 o10 j)) (= (bool_eq1 i1 j) true))))))))))
(assert (not (= (has_key1 o10 (mk___rep1 cu__split_fields3)) true)))
(check-sat)
(exit)
