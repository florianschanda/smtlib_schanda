...
(assert (= result2 (mk_int__ref temp___789)))
(assert (= temp___7891 (get1 (positions s) (mk___rep1 cu__split_fields4))))
...
(assert (and (= temp___7871 (next s (mk___rep1 cu__split_fields4))) (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields4) no_element) false) (= (get1 (positions s) (mk___rep1 cu__split_fields4)) (length3 s)) true) true) (= (bool_eq1 temp___7871 no_element) true) (and (= (has_key1 (positions s) temp___7871) true) (= (get1 (positions s) temp___7871) (+ (get1 (positions s) (mk___rep1 cu__split_fields4)) 1))))))
(assert (= result4 (mk___split_fields__ref1 cu__split_fields4)))
(assert (= cu__split_fields3 (mk___split_fields1 temp___787)))
...
(assert (and (= o4 (positions s)) (and (not (= (has_key1 o4 no_element) true)) (forall ((i us_rep1)) (=> (= (has_key1 o4 i) true) (and (and (<= 1 (get1 o4 i)) (<= (get1 o4 i) (length3 s))) (forall ((j us_rep1)) (=> (= (has_key1 o4 j) true) (=> (= (get1 o4 i) (get1 o4 j)) (= (bool_eq1 i j) true))))))))))
(assert (not (= (has_key1 o4 (mk___rep1 cu__split_fields3)) true)))
(check-sat)
(exit)
