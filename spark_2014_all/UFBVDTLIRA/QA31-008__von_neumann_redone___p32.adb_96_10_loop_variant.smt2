...
(assert (= b1 (bvmul (bvadd (bvmul #x00000002 res_g1) bits_g1) (pow21 m2))))
...
(assert (= bits2 (bvudiv bits1 #x00000004)))
(assert (= result15 (mk_t__ref bits_g1)))
(assert (= bits_g2 (bvlshr bits_g1 ((_ int2bv 32) 1))))
(assert (= (sqr (bvadd res_g2 bits_g2)) (bvadd (sqr res_g2) (bvmul bits_g2 (bvadd (bvmul #x00000002 res_g2) bits_g2)))))
(assert (bvule m3 #x00000010))
(assert (= bits_g3 (ite (= m3 #x00000000) #x00000000 (pow21 (bvsub m3 #x00000001)))))
(assert (= bits3 (sqr bits_g3)))
(assert (= (bvand res_g3 (bvsub (pow21 m3) #x00000001)) #x00000000))
(assert (bvult res_g3 #x00010000))
(assert (= res4 (bvmul res_g3 (pow21 m3))))
(assert (bvule num3 x))
(assert (= (sqr (bvadd res_g3 bits_g3)) (bvadd (sqr res_g3) (bvmul bits_g3 (bvadd (bvmul #x00000002 res_g3) bits_g3)))))
(assert (=> (not (= m3 #x00000000)) (= (bvor res4 bits3) (bvmul (bvadd (bvmul #x00000002 res_g3) bits_g3) (pow21 (bvsub m3 #x00000001))))))
(assert (=> (not (= m3 #x00000000)) (= bits_g3 (pow21 (bvsub m3 #x00000001)))))
(assert (= (bvsub x num3) (sqr res_g3)))
(assert (bvule (bvadd res_g3 (pow21 m3)) #x00010000))
(assert (bvule x (bvsub (sqr (bvadd res_g3 (pow21 m3))) #x00000001)))
(assert (= result16 (mk_t__ref temp___260)))
(assert (= temp___2601 bits3))
(assert (not (= bits3 #x00000000)))
(assert (not (= bits3 #x00000000)))
(assert (= (sqr (bvadd res_g3 bits_g3)) (bvadd (sqr res_g3) (bvmul bits_g3 (bvadd (bvmul #x00000002 res_g3) bits_g3)))))
(assert (not (= bits3 #x00000000)))
(assert (not (= bits_g3 #x00000000)))
(assert (not (= m3 #x00000000)))
(assert (= result17 (mk_t__ref i3)))
(assert (= i4 (bvadd i3 #x00000001)))
(assert (= result18 (mk_t__ref m3)))
(assert (= m4 (bvsub m3 #x00000001)))
(assert (= res4 (bvmul res_g3 (pow21 (bvadd m4 #x00000001)))))
(assert (= bits_g3 (pow21 m4)))
(assert (= result19 (mk_t__ref b2)))
(assert (= b3 (bvor res4 bits3)))
(assert (= b3 (bvadd res4 bits3)))
(assert (= b3 (bvmul (bvadd (bvmul #x00000002 res_g3) bits_g3) (pow21 m4))))
(assert (= result20 (mk_t__ref res4)))
(assert (= res5 (bvlshr res4 ((_ int2bv 32) 1))))
...
(assert (= bits4 (bvudiv bits3 #x00000004)))
(assert (= result25 (mk_t__ref bits_g3)))
(assert (= bits_g4 (bvlshr bits_g3 ((_ int2bv 32) 1))))
(assert (= (sqr (bvadd res_g4 bits_g4)) (bvadd (sqr res_g4) (bvmul bits_g4 (bvadd (bvmul #x00000002 res_g4) bits_g4)))))
(assert (not (bvult bits4 temp___2601)))
(check-sat)
(exit)
