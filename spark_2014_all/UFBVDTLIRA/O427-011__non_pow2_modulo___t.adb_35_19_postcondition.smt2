...
(assert (= t__mmul__result1 ((_ extract 7 0) (bvurem (bvmul ((_ zero_extend 8) x) ((_ zero_extend 8) y)) ((_ int2bv 16) 230)))))
...
(assert (not (= ((_ zero_extend 8) t__mmul__result4) (bvurem (bvmul ((_ zero_extend 8) x) ((_ zero_extend 8) y)) ((_ int2bv 16) 230)))))
(check-sat)
(exit)
