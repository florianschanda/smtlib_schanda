...
(assert (let ((temp___913 (keys (mk___rep s1__split_discrs s1__split_fields2)))) (forall ((temp___912 Int)) (=> (and (in_range5 temp___912) (= (iter_has_element temp___913 temp___912) true)) (= (prop__ (get (model__ (mk___rep s1__split_discrs s1__split_fields2)) (get1 temp___913 temp___912))) true)))))
