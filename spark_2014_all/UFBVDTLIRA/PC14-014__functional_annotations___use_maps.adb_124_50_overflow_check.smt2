...
(define-fun dynamic_invariant5 ((temp___expr_411 Int) (temp___is_init_408 Bool) (temp___skip_constant_409 Bool) (temp___do_toplevel_410 Bool)) Bool (=> (or (= temp___is_init_408 true) (<= 1 2147483647)) (in_range7 temp___expr_411)))
...
(define-fun dynamic_invariant6 ((temp___expr_319 Int) (temp___is_init_316 Bool) (temp___skip_constant_317 Bool) (temp___do_toplevel_318 Bool)) Bool (=> (or (= temp___is_init_316 true) (<= 1 2147483647)) (in_range8 temp___expr_319)))
...
(define-fun dynamic_invariant7 ((temp___expr_325 Int) (temp___is_init_322 Bool) (temp___skip_constant_323 Bool) (temp___do_toplevel_324 Bool)) Bool (=> (or (= temp___is_init_322 true) (<= (- 2147483648) 2147483647)) (in_range9 temp___expr_325)))
...
(assert true)
(assert true)
(assert (forall ((container us_rep2)) (forall ((key2 Int)) (! (=> (dynamic_invariant1 key2 true true true) (=> (= (of_int 1) true) (=> (exists ((k Int)) (and (and (in_range3 k) (= (has_key container k) true)) (= k key2))) (= (has_key container key2) true)))) :pattern ((has_key container key2))))))
...
(assert (forall ((left us_rep2) (right us_rep2)) (forall ((new_key Int)) (! (=> (dynamic_invariant1 new_key true true true) (= (= (keys_included_except left right new_key) true) (forall ((key2 Int)) (=> (and (in_range3 key2) (= (has_key left key2) true)) (=> (not (= key2 new_key)) (= (has_key right key2) true)))))) :pattern ((keys_included_except left right new_key))))))
...
(declare-const temp___925 us_rep3)
...
(declare-const temp___9061 hash_type)
(declare-const temp___9062 us_main_type)
...
(declare-const temp___909 us_rep3)
...
(declare-const temp___904 count_type)
(declare-const o22 Bool)
(declare-const temp___917 us_rep3)
...
(assert (and (and (let ((temp___933 (keys (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))))) (forall ((temp___932 Int)) (=> (and (in_range5 temp___932) (= (iter_has_element temp___933 temp___932) true)) (= (prop__ (get (model__ (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (get1 temp___933 temp___932))) true)))) (let ((temp___935 (keys s2))) (forall ((temp___934 Int)) (=> (and (in_range5 temp___934) (= (iter_has_element temp___935 temp___934) true)) (= (prop__ (get (model__ s2) (get1 temp___935 temp___934))) true))))) (< (length s2) (- (to_rep (rec__use_maps__my_maps__map__capacity s1__split_discrs)) (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))))))
(assert (and (= (mk___rep1 (mk___split_fields1 use_maps__union_prop__cu__assume)) (first s2)) (ite (= (= (length s2) 0) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 use_maps__union_prop__cu__assume)) no_element) true) (and (= (has_key1 (positions s2) (mk___rep1 (mk___split_fields1 use_maps__union_prop__cu__assume))) true) (= (get2 (positions s2) (mk___rep1 (mk___split_fields1 use_maps__union_prop__cu__assume))) 1)))))
...
(assert (let ((temp___913 (keys (mk___rep s1__split_discrs (mk___split_fields s1__split_fields2))))) (forall ((temp___912 Int)) (=> (and (in_range5 temp___912) (= (iter_has_element temp___913 temp___912) true)) (= (prop__ (get (model__ (mk___rep s1__split_discrs (mk___split_fields s1__split_fields2))) (get1 temp___913 temp___912))) true)))))
