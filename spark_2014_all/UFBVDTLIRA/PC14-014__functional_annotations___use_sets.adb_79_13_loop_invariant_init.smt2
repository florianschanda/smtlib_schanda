...
(assert (= result1 true))
(assert (not (= (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (- (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (length (mk___rep s2__split_discrs s2__split_fields1))))))
(check-sat)
(exit)
