...
(declare-fun temp___330 (map1 Int (_ BitVec 8) Int Int (_ BitVec 8) Int Int Int (_ BitVec 8) Int Int) map1)
...
(assert (= #x02 y2))
(assert (= 2 z2))
(assert (not (= (bool_eq a4 1 10 #x00 #x07 0 2 (temp___330 a_3d_arr 1 #x02 2 x1 y1 z1 v1 x2 y2 z2 v2) 1 10 #x00 #x07 0 2) true)))
(check-sat)
(exit)
