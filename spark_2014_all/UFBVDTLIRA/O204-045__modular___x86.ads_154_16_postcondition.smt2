...
(assert true)
(assert (= result rdx))
(assert (= rdx1 (bvor (bvand rdx ((_ int2bv 64) 18446744069414584320)) ((_ zero_extend 32) val__))))
(assert (= rdx1 rdx2))
(assert (= rdx3 rdx1))
(assert (not (= rdx2 (bvor (bvand rdx ((_ int2bv 64) 18446744069414584320)) ((_ zero_extend 32) val__)))))
(check-sat)
(exit)
