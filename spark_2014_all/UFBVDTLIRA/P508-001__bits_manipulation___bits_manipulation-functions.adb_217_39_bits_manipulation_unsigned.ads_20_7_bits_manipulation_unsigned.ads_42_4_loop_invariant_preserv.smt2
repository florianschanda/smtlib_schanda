...
(assert (forall ((j Int)) (=> (and (<= 1 j) (<= j (- i2 1))) (= (make_mask j) (bvsub (ite (< j 256) (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) j)) ((_ int2bv 8) 0)) ((_ int2bv 8) 1))))))
...
(assert (<= 1 j))
(assert (<= j (- i3 1)))
(assert (not (= (make_mask j) (bvsub (ite (< j 256) (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) j)) ((_ int2bv 8) 0)) ((_ int2bv 8) 1)))))
(check-sat)
(exit)
