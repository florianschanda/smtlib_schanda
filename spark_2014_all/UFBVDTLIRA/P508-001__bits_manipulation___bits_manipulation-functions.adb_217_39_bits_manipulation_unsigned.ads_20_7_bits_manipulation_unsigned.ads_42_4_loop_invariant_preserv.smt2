...
(assert (forall ((num_bits Int)) (! (=> (dynamic_invariant1 num_bits true true true) (= (make_mask num_bits) (shift_right ((_ int2bv 8) 255) (- 8 num_bits)))) :pattern ((make_mask num_bits)))))
...
(assert true)
(assert (forall ((us_void_param tuple0)) (! (= (= (lemma2 us_void_param) true) (forall ((size Int)) (=> (and (<= 1 size) (<= size 7)) (= (make_mask size) (bvsub (ite (< size 256) (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) size)) ((_ int2bv 8) 0)) ((_ int2bv 8) 1)))))) :pattern ((lemma2 us_void_param)))))
...
(assert true)
(assert (forall ((us_void_param tuple0)) (! (= (= (lemma81 us_void_param) true) (forall ((val__ (_ BitVec 8))) (=> (and (bvule ((_ int2bv 8) 0) val__) (bvule val__ ((_ int2bv 8) 255))) (forall ((n Int)) (=> (and (<= 1 n) (<= n 7)) (bvult (shift_right val__ (- 8 n)) (ite (< n 256) (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) n)) ((_ int2bv 8) 0)))))))) :pattern ((lemma81 us_void_param)))))
(declare-const i Int)
(declare-const bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma2__result Bool)
...
(declare-const bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma2__result1 Bool)
(declare-const bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma2__result2 Bool)
(declare-const bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma2__result3 Bool)
(declare-const i10 Int)
(declare-const bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma2__result4 Bool)
(declare-const i11 Int)
(declare-const bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma2__result5 Bool)
...
(assert (<= 2 i1))
(assert (<= i1 7))
(assert (= (make_mask i1) (bvsub (ite (< i1 256) (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) i1)) ((_ int2bv 8) 0)) ((_ int2bv 8) 1))))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- i2 1))) (= (make_mask j1) (bvsub (ite (< j1 256) (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) j1)) ((_ int2bv 8) 0)) ((_ int2bv 8) 1))))))
(assert (and (=> (<= 2 7) (in_range2 i2)) (and (<= 2 i2) (<= i2 7))))
(assert (not (= i2 7)))
(assert (= i2 result1))
(assert (= i3 (+ i2 1)))
(assert (= (make_mask i3) (bvsub (ite (< i3 256) (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) i3)) ((_ int2bv 8) 0)) ((_ int2bv 8) 1))))
(declare-const j1 Int)
(assert (<= 1 j1))
(assert (<= j1 (- i3 1)))
(assert (not (= (make_mask j1) (bvsub (ite (< j1 256) (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) j1)) ((_ int2bv 8) 0)) ((_ int2bv 8) 1)))))
(check-sat)
(exit)
