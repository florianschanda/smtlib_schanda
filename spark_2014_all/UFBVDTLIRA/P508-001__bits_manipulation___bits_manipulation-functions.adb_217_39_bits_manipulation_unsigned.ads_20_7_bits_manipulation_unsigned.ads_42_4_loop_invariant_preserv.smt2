...
(assert (= (make_mask 1) #x01))
(assert (= (mk_int__ref result) (mk_int__ref i)))
(assert (= i1 2))
(assert (<= 2 i1))
(assert (<= i1 7))
(assert (= (make_mask i1) (bvsub (ite (< i1 256) (bvshl #x01 ((_ int2bv 8) i1)) #x00) #x01)))
(assert (forall ((j Int)) (=> (and (<= 1 j) (<= j (- i2 1))) (= (make_mask j) (bvsub (ite (< j 256) (bvshl #x01 ((_ int2bv 8) j)) #x00) #x01)))))
(assert (and (=> (<= 2 7) (in_range2 i2)) (and (<= 2 i2) (<= i2 7))))
(assert (not (= i2 7)))
(assert (= i2 result1))
(assert (= i3 (+ i2 1)))
(assert (= (make_mask i3) (bvsub (ite (< i3 256) (bvshl #x01 ((_ int2bv 8) i3)) #x00) #x01)))
(declare-const j Int)
(assert (<= 1 j))
(assert (<= j (- i3 1)))
(assert (not (= (make_mask j) (bvsub (ite (< j 256) (bvshl #x01 ((_ int2bv 8) j)) #x00) #x01))))
(check-sat)
(exit)
