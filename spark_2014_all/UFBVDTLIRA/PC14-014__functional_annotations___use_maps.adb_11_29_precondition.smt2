...
(assert (and (= o3 (get1 o2 (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range6 o3) (=> (= (of_int 0) true) (and (= o3 (w_get o2 (witness o2 (mk___rep1 (mk___split_fields1 cu__split_fields2))))) (forall ((k1 us_rep1)) (=> (= (has_key1 o2 k1) true) (= (= (bool_eq1 k1 (mk___rep1 (mk___split_fields1 cu__split_fields2))) true) (= (witness o2 (mk___rep1 (mk___split_fields1 cu__split_fields2))) (witness o2 k1))))))))))
(assert (= o4 (- o3 1)))
(assert (= o5 (ite (<= i o4) true false)))
(assert (= result2 (ite (<= 1 i) o5 false)))
(assert (= result2 true))
(assert (and (= o6 (keys s)) (and (and (and (and (= (length1 o6) (length3 s)) (forall ((temp___431 Int)) (=> (and (in_range5 temp___431) (= (iter_has_element o6 temp___431) true)) (= (has_key (model__ s) (get o6 temp___431)) true)))) (forall ((key2 Int)) (=> (and (in_range3 key2) (= (has_key (model__ s) key2) true)) (and (< 0 (find o6 key2)) (= (get o6 (find o6 key2)) key2))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length3 s))) (= (find o6 (get o6 i1)) i1)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length3 s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length3 s))) (=> (= (get o6 i1) (get o6 j)) (= i1 j)))))))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
