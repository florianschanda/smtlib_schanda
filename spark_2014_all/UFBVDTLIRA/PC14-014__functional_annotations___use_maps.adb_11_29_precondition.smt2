...
(assert (= result1 true))
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (- (get1 (positions s) (mk___rep cu__split_fields3)) 1))) (not (= (get (keys s) i1) k)))))
(assert (= (has_key1 (positions s) (mk___rep cu__split_fields3)) true))
(assert (and (= o (positions s)) (and (not (= (has_key1 o no_element) true)) (forall ((i1 us_rep2)) (=> (= (has_key1 o i1) true) (and (and (<= 1 (get1 o i1)) (<= (get1 o i1) (length3 s))) (forall ((j us_rep2)) (=> (= (has_key1 o j) true) (=> (= (get1 o i1) (get1 o j)) (= (bool_eq2 i1 j) true))))))))))
(assert (and (= o1 (get1 o (mk___rep cu__split_fields3))) (and (in_range6 o1) (=> (= (distinct 0 0) true) (and (= o1 (w_get o (witness o (mk___rep cu__split_fields3)))) (forall ((k1 us_rep2)) (=> (= (has_key1 o k1) true) (= (= (bool_eq2 k1 (mk___rep cu__split_fields3)) true) (= (witness o (mk___rep cu__split_fields3)) (witness o k1))))))))))
(assert (= o2 (- o1 1)))
(assert (= o3 (ite (<= i o2) true false)))
(assert (= result2 (ite (<= 1 i) o3 false)))
(assert (= result2 true))
(assert (and (= o4 (keys s)) (and (and (and (and (= (length1 o4) (length3 s)) (forall ((temp___474 Int)) (=> (and (in_range4 temp___474) (= (iter_has_element o4 temp___474) true)) (= (has_key (model__ s) (get o4 temp___474)) true)))) (forall ((key1 Int)) (=> (and (in_range2 key1) (= (has_key (model__ s) key1) true)) (and (< 0 (find o4 key1)) (= (get o4 (find o4 key1)) key1))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length3 s))) (= (find o4 (get o4 i1)) i1)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length3 s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length3 s))) (=> (= (get o4 i1) (get o4 j)) (= i1 j)))))))))
