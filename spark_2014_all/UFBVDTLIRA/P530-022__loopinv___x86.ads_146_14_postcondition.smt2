...
(assert (forall ((regnew (_ BitVec 64))) (forall ((val__1 (_ BitVec 32))) (! (=> (and (dynamic_invariant regnew true true true) (dynamic_invariant1 val__1 true true true)) (= (= (writereg32post regnew val__1) true) (and (= (readreg32 regnew) val__1) (= (bvand regnew ((_ int2bv 64) 18446744069414584320)) ((_ int2bv 64) 0))))) :pattern ((writereg32post regnew val__1))))))
(assert (forall ((regnew (_ BitVec 64))) (forall ((val__1 (_ BitVec 32))) (! (= (= (writereg32post regnew val__1) true) (and (= (readreg32 regnew) val__1) (= (bvand regnew ((_ int2bv 64) 18446744069414584320)) ((_ int2bv 64) 0)))) :pattern ((writereg32post regnew val__1))))))
