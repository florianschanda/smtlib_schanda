...
(assert (not (= n11 #x0000000000000000)))
(declare-const i (_ BitVec 64))
(assert (bvule #x0000000000000000 i))
(assert (bvule i (bvsub n11 #x0000000000000001)))
