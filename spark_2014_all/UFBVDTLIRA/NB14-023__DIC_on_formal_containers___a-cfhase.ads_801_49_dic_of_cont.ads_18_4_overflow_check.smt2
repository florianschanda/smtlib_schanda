...
(declare-datatypes () ((us_split_discrs (mk___split_discrs (rec__dic_of_cont__my_hase__set__capacity count_type) (rec__dic_of_cont__my_hase__set__modulus hash_type)))))
(define-fun us_split_discrs___4__projection ((a us_split_discrs)) count_type (rec__dic_of_cont__my_hase__set__capacity a))
(define-fun us_split_discrs___5__projection ((a us_split_discrs)) hash_type (rec__dic_of_cont__my_hase__set__modulus a))
...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dic_of_cont__my_hase__set us_main_type)))))
(define-fun us_split_fields_Set__projection ((a us_split_fields)) us_main_type (rec__dic_of_cont__my_hase__set a))
...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (and (= (to_rep1 (rec__dic_of_cont__my_hase__set__capacity (us_split_discrs1 a))) (to_rep1 (rec__dic_of_cont__my_hase__set__capacity (us_split_discrs1 b)))) (= (to_rep (rec__dic_of_cont__my_hase__set__modulus (us_split_discrs1 a))) (to_rep (rec__dic_of_cont__my_hase__set__modulus (us_split_discrs1 b))))) (= (us_main_eq (rec__dic_of_cont__my_hase__set (us_split_fields1 a)) (rec__dic_of_cont__my_hase__set (us_split_fields1 b))) true)) true false))
...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep1 (rec__dic_of_cont__my_hase__set__capacity (us_split_discrs1 container)))) (dynamic_invariant result true false true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant1 ((temp___expr_167 (_ BitVec 32)) (temp___is_init_164 Bool) (temp___skip_constant_165 Bool) (temp___do_toplevel_166 Bool)) Bool true)
...
(define-fun dynamic_invariant2 ((temp___expr_741 Int) (temp___is_init_738 Bool) (temp___skip_constant_739 Bool) (temp___do_toplevel_740 Bool)) Bool (=> (or (= temp___is_init_738 true) (<= 0 2147483647)) (in_range2 temp___expr_741)))
...
(define-fun sequence__ref___3__projection ((a sequence__ref)) us_rep1 (sequence__content a))
...
(define-fun default_initial_assumption ((temp___expr_808 us_rep1) (temp___skip_top_level_809 Bool)) Bool (=> (not (= temp___skip_top_level_809 true)) (= (length2 temp___expr_808) 0)))
(declare-fun find (us_rep1 Int) Int)
(declare-fun find__function_guard (Int us_rep1 Int) Bool)
(assert (forall ((container us_rep1)) (forall ((item Int)) (! (=> (dynamic_invariant2 item true true true) (let ((result (find container item))) (and (=> (< 0 result) (and (<= result (length2 container)) (= item (get container result)))) (dynamic_invariant result true false true)))) :pattern ((find container item))))))
...
(define-fun default_initial_assumption1 ((temp___expr_777 us_rep2) (temp___skip_top_level_778 Bool)) Bool (=> (not (= temp___skip_top_level_778 true)) (= (is_empty temp___expr_777) true)))
...
(define-fun element_type__ref___9__projection ((a element_type__ref1)) element_type1 (element_type__content1 a))
...
(assert (forall ((container us_rep)) (! (let ((result (elements container))) (and (and (and (and (= (length2 result) (length container)) (forall ((temp___845 Int)) (=> (and (in_range5 temp___845) (= (iter_has_element result temp___845) true)) (= (contains (model__ container) (get result temp___845)) true)))) (forall ((item Int)) (=> (and (in_range4 item) (= (contains (model__ container) item) true)) (and (< 0 (find result item)) (= (get result (find result item)) item))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (= (find result (get result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length container))) (=> (= (get result i) (get result j)) (= i j)))))))) :pattern ((elements container)))))
...
(assert true)
(define-fun dynamic_invariant3 ((temp___expr_770 Int) (temp___is_init_767 Bool) (temp___skip_constant_768 Bool) (temp___do_toplevel_769 Bool)) Bool (=> (or (= temp___is_init_767 true) (<= 0 2147483647)) (in_range4 temp___expr_770)))
(assert (forall ((container us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant3 item true true true) (=> (= (of_int 1) true) (=> (exists ((e Int)) (and (and (in_range4 e) (= (contains container e) true)) (= e item))) (= (contains container item) true)))) :pattern ((contains container item))))))
...
(define-fun dynamic_invariant4 ((temp___expr_801 Int) (temp___is_init_798 Bool) (temp___skip_constant_799 Bool) (temp___do_toplevel_800 Bool)) Bool (=> (or (= temp___is_init_798 true) (<= 0 2147483647)) (in_range5 temp___expr_801)))
...
(define-fun element_type__ref___10__projection ((a element_type__ref2)) element_type2 (element_type__content2 a))
(define-fun dynamic_invariant5 ((temp___expr_795 Int) (temp___is_init_792 Bool) (temp___skip_constant_793 Bool) (temp___do_toplevel_794 Bool)) Bool (=> (or (= temp___is_init_792 true) (<= 0 2147483647)) (in_range6 temp___expr_795)))
...
(assert (and (= o (length right)) (and (in_range1 o) (<= o (to_rep1 (rec__dic_of_cont__my_hase__set__capacity (us_split_discrs1 right)))))))
