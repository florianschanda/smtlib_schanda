...
(declare-const x86__bp__result (_ BitVec 16))
(declare-const result (_ BitVec 16))
(declare-const x86__bp__result1 (_ BitVec 16))
(declare-const x86__bp__result2 (_ BitVec 16))
(declare-const x86__bp__result3 (_ BitVec 16))
(declare-const x86__bp__result4 (_ BitVec 16))
(declare-const x86__bp__result5 (_ BitVec 16))
(assert true)
(assert (not (bvule ((_ zero_extend 48) ((_ int2bv 16) 0)) (bvand rbp ((_ int2bv 64) 65535)))))
(check-sat)
(exit)
