...
(assert (and (= o9 (length s2)) (and (in_range2 o9) (<= o9 (to_rep (rec__use_maps__my_maps__map__capacity (us_split_discrs1 s2)))))))
(assert (and (= o7 (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (and (in_range2 o7) (<= o7 (to_rep (rec__use_maps__my_maps__map__capacity s1__split_discrs))))))
(assert (= o8 (- (to_rep (rec__use_maps__my_maps__map__capacity s1__split_discrs)) o7)))
(assert (and (= o10 o8) (in_range1 o8)))
(assert (= o11 (ite (< o9 o10) true false)))
(assert (and (= temp___929 (keys s2)) (and (and (and (and (= (length3 temp___929) (length s2)) (forall ((temp___431 Int)) (=> (and (in_range5 temp___431) (= (iter_has_element temp___929 temp___431) true)) (= (has_key (model__ s2) (get1 temp___929 temp___431)) true)))) (forall ((key2 Int)) (=> (and (in_range3 key2) (= (has_key (model__ s2) key2) true)) (and (< 0 (find temp___929 key2)) (= (get1 temp___929 (find temp___929 key2)) key2))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length s2))) (= (find temp___929 (get1 temp___929 i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length s2))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length s2))) (=> (= (get1 temp___929 i) (get1 temp___929 j)) (= i j)))))))))
(assert (and (= o3 (iter_has_element temp___929 temp___928)) (= (= o3 true) (and (<= 1 temp___928) (<= temp___928 (last temp___929))))))
(assert (= (= o4 true) (in_range5 temp___928)))
(assert (= result (ite (= o4 true) o3 false)))
(assert (= (= o6 true) (let ((temp___931 (keys s2))) (forall ((temp___930 Int)) (=> (and (in_range5 temp___930) (= (iter_has_element temp___931 temp___930) true)) (= (prop__ (get (model__ s2) (get1 temp___931 temp___930))) true))))))
(assert (and (= temp___925 (keys (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (and (and (and (and (= (length3 temp___925) (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (forall ((temp___431 Int)) (=> (and (in_range5 temp___431) (= (iter_has_element temp___925 temp___431) true)) (= (has_key (model__ (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (get1 temp___925 temp___431)) true)))) (forall ((key2 Int)) (=> (and (in_range3 key2) (= (has_key (model__ (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) key2) true)) (and (< 0 (find temp___925 key2)) (= (get1 temp___925 (find temp___925 key2)) key2))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))))) (= (find temp___925 (get1 temp___925 i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))))) (=> (= (get1 temp___925 i) (get1 temp___925 j)) (= i j)))))))))
(assert (and (= o (iter_has_element temp___925 temp___924)) (= (= o true) (and (<= 1 temp___924) (<= temp___924 (last temp___925))))))
(assert (= (= o1 true) (in_range5 temp___924)))
(assert (= result1 (ite (= o1 true) o false)))
(assert (= result1 true))
(assert (and (= k (get1 temp___925 temp___924)) (in_range6 k)))
