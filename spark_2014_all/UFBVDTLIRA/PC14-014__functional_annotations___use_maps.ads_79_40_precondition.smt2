...
(declare-const temp___968 us_rep3)
(declare-const temp___967 Int)
(declare-const o Bool)
(declare-const o1 Bool)
(declare-const k Int)
(declare-const temp___972 us_rep3)
...
(assert (and (= temp___972 (keys s2)) (and (and (and (and (= (length3 temp___972) (length s2)) (forall ((temp___474 Int)) (=> (and (in_range5 temp___474) (= (iter_has_element temp___972 temp___474) true)) (= (has_key (model__ s2) (get1 temp___972 temp___474)) true)))) (forall ((key2 Int)) (=> (and (in_range3 key2) (= (has_key (model__ s2) key2) true)) (and (< 0 (find temp___972 key2)) (= (get1 temp___972 (find temp___972 key2)) key2))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length s2))) (= (find temp___972 (get1 temp___972 i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length s2))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length s2))) (=> (= (get1 temp___972 i) (get1 temp___972 j)) (= i j)))))))))
...
(assert (= result1 true))
(assert (and (= k (get1 temp___968 temp___967)) (in_range6 k)))
