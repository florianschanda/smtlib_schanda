...
(assert (and (= o7 (length s2)) (and (in_range2 o7) (<= o7 (to_rep (rec__use_maps__my_maps__map__capacity (us_split_discrs1 s2)))))))
(assert (and (= o5 (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (and (in_range2 o5) (<= o5 (to_rep (rec__use_maps__my_maps__map__capacity s1__split_discrs))))))
(assert (= o6 (- (to_rep (rec__use_maps__my_maps__map__capacity s1__split_discrs)) o5)))
...
(assert (and (= o2 (iter_has_element temp___929 temp___928)) (= (= o2 true) (and (<= 1 temp___928) (<= temp___928 (last temp___929))))))
(assert (= (= o3 true) (in_range5 temp___928)))
(assert (= result (ite (= o3 true) o2 false)))
(assert (= (= o4 true) (let ((temp___931 (keys s2))) (forall ((temp___930 Int)) (=> (and (in_range5 temp___930) (= (iter_has_element temp___931 temp___930) true)) (= (prop__ (get (model__ s2) (get1 temp___931 temp___930))) true))))))
