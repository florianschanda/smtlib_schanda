...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__dic_of_cont__my_hama__map__capacity (us_split_discrs1 container)))) (dynamic_invariant result true false true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant1 ((temp___expr_589 Int) (temp___is_init_586 Bool) (temp___skip_constant_587 Bool) (temp___do_toplevel_588 Bool)) Bool (=> (or (= temp___is_init_586 true) (<= 1 2147483647)) (in_range2 temp___expr_589)))
...
(define-fun default_initial_assumption ((temp___expr_596 us_rep2) (temp___skip_top_level_597 Bool)) Bool (=> (not (= temp___skip_top_level_597 true)) (and (= (is_empty temp___expr_596) true) (= (length2 temp___expr_596) 0))))
...
(define-fun default_initial_assumption1 ((temp___expr_545 us_rep3) (temp___skip_top_level_546 Bool)) Bool (=> (not (= temp___skip_top_level_546 true)) (and (= (is_empty1 temp___expr_545) true) (= (length3 temp___expr_545) 0))))
...
(define-fun dynamic_invariant3 ((temp___expr_532 Int) (temp___is_init_529 Bool) (temp___skip_constant_530 Bool) (temp___do_toplevel_531 Bool)) Bool (=> (or (= temp___is_init_529 true) (<= 0 2147483647)) (in_range3 temp___expr_532)))
...
(define-fun dynamic_invariant4 ((temp___expr_538 Int) (temp___is_init_535 Bool) (temp___skip_constant_536 Bool) (temp___do_toplevel_537 Bool)) Bool (=> (or (= temp___is_init_535 true) (<= 0 2147483647)) (in_range4 temp___expr_538)))
...
(declare-const temp___1866 count_type)
(declare-const o2 us_rep2)
(declare-const o3 Int)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___1866 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___1866)) no_element))
