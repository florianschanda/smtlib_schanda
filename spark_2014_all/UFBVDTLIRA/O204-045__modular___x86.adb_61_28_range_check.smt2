...
(declare-const x86__cl__result (_ BitVec 8))
(declare-const result (_ BitVec 8))
(declare-const x86__cl__result1 (_ BitVec 8))
(declare-const x86__cl__result2 (_ BitVec 8))
(declare-const x86__cl__result3 (_ BitVec 8))
(declare-const x86__cl__result4 (_ BitVec 8))
(declare-const x86__cl__result5 (_ BitVec 8))
(assert true)
(assert (not (bvule ((_ zero_extend 56) ((_ int2bv 8) 0)) (bvand rcx ((_ int2bv 64) 255)))))
(check-sat)
(exit)
