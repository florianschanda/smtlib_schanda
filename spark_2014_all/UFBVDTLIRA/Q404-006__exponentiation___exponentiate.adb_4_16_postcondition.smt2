...
(declare-const temp___241 (_ BitVec 32))
(declare-const temp___242 (_ BitVec 32))
(declare-const temp___240 (_ BitVec 32))
(declare-const temp___239 (_ BitVec 32))
...
(assert (or (and (and (and (= exponentiate__result6 (mk_t__ref exponentiate__result2)) (and (= iter8 (mk_int__ref iter1)) (and (= result__8 (mk_t__ref result__1)) (and (= cur_val8 (mk_t__ref cur_val1)) (= cur_exp8 (mk_t__ref cur_exp1)))))) (and (= exponentiate__result7 exponentiate__result2) (and (= iter9 iter1) (and (= result__9 result__1) (and (= cur_val9 cur_val1) (= cur_exp9 cur_exp1)))))) (and (= exp1 0) (and (= result4 exponentiate__result) (= exponentiate__result2 #x00000001)))) (and (and (not (= exp1 0)) (and (= exponentiate__result2 exponentiate__result) (= exponentiate__result2 exponentiate__result1))) (and (and (and (= exponentiate__result6 exponentiate__result4) (and (= iter8 iter6) (and (= result__8 result__6) (and (= cur_val8 cur_val6) (= cur_exp8 cur_exp6))))) (and (= exponentiate__result7 exponentiate__result5) (and (= iter9 iter7) (and (= result__9 result__7) (and (= cur_val9 cur_val7) (= cur_exp9 cur_exp7)))))) (and (ite (not (= cur_exp1 #x00000000)) (and (and (and (= temp___241 result__1) (and (= temp___242 cur_exp1) (and (= temp___240 cur_val1) (and (= temp___239 cur_exp1) (and (= temp___238 iter1) (and (and (= result__2 (power val__ (bv2nat (bvurem ((_ int2bv 32) exp1) (pow21 iter2))))) (and (= cur_val2 (power val__ (bv2nat (pow21 iter2)))) (= cur_exp2 (bvudiv temp___242 (pow21 iter2))))) (and (=> (<= 0 31) (in_range1 iter2)) (and (ite (= (bvurem cur_exp2 #x00000002) #x00000001) (and (= result__2 result5) (= result__3 (bvmul result__2 cur_val2))) (= result__3 result__2)) (and (and (= cur_exp2 result6) (= cur_exp3 (bvudiv cur_exp2 #x00000002))) (and (and (= cur_val2 result7) (= cur_val3 (bvmul cur_val2 cur_val2))) (and (and (and (= o (+ iter2 1)) (in_range1 (+ iter2 1))) (and (= iter2 result8) (= iter3 o))) (= cur_exp3 #x00000000)))))))))))) (and (and (= iter4 (mk_int__ref iter3)) (and (= result__3 result__4) (and (= cur_val3 cur_val4) (= cur_exp3 cur_exp4)))) (and (= iter5 iter3) (and (= result__5 result__3) (and (= cur_val5 cur_val3) (= cur_exp5 cur_exp3)))))) (and (and (= iter6 iter4) (and (= result__6 (mk_t__ref result__4)) (and (= cur_val6 (mk_t__ref cur_val4)) (= cur_exp6 (mk_t__ref cur_exp4))))) (and (= iter7 iter5) (and (= result__7 result__5) (and (= cur_val7 cur_val5) (= cur_exp7 cur_exp5)))))) (and (and (= iter6 (mk_int__ref iter1)) (and (= result__6 (mk_t__ref result__1)) (and (= cur_val6 (mk_t__ref cur_val1)) (= cur_exp6 (mk_t__ref cur_exp1))))) (and (= iter7 iter1) (and (= result__7 result__1) (and (= cur_val7 cur_val1) (= cur_exp7 cur_exp1)))))) (and (and (= exponentiate__result4 (mk_t__ref exponentiate__result3)) (= exponentiate__result5 exponentiate__result3)) (and (= result9 (mk_t__ref exponentiate__result2)) (= exponentiate__result3 (t__content result__6)))))))))
...
(assert (not (= (t__content exponentiate__result8) (power val__ exp1))))
(check-sat)
(exit)
