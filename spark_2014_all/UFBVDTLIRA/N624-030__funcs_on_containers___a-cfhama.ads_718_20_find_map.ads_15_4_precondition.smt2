...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (and (= (to_rep (rec__find_map__index_maps__map__capacity (us_split_discrs1 a))) (to_rep (rec__find_map__index_maps__map__capacity (us_split_discrs1 b)))) (= (to_rep1 (rec__find_map__index_maps__map__modulus (us_split_discrs1 a))) (to_rep1 (rec__find_map__index_maps__map__modulus (us_split_discrs1 b))))) (= (us_main_eq (rec__find_map__index_maps__map (us_split_fields1 a)) (rec__find_map__index_maps__map (us_split_fields1 b))) true)) true false))
...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (= (to_rep (rec__find_map__index_maps__cursor__node (us_split_fields3 a))) (to_rep (rec__find_map__index_maps__cursor__node (us_split_fields3 b)))) true false))
...
(define-fun dynamic_invariant ((temp___expr_174 Int) (temp___is_init_171 Bool) (temp___skip_constant_172 Bool) (temp___do_toplevel_173 Bool)) Bool (=> (or (= temp___is_init_171 true) (<= 0 2147483647)) (in_range1 temp___expr_174)))
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__find_map__index_maps__map__capacity (us_split_discrs1 container)))) (dynamic_invariant result true false true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant3 ((temp___expr_168 (_ BitVec 32)) (temp___is_init_165 Bool) (temp___skip_constant_166 Bool) (temp___do_toplevel_167 Bool)) Bool true)
...
(define-fun dynamic_invariant4 ((temp___expr_366 Int) (temp___is_init_363 Bool) (temp___skip_constant_364 Bool) (temp___do_toplevel_365 Bool)) Bool (=> (or (= temp___is_init_363 true) (<= 0 2147483647)) (in_range4 temp___expr_366)))
(declare-fun has_key1 (us_rep3 Int) Bool)
(declare-fun has_key__function_guard1 (Bool us_rep3 Int) Bool)
(assert (forall ((container1 us_rep3)) (forall ((key Int)) (! (=> (dynamic_invariant4 key true true true) (=> (= (of_int 1) true) (=> (exists ((k Int)) (and (and (in_range4 k) (= (has_key1 container1 k) true)) (= (equivalent_keys k key) true))) (= (has_key1 container1 key) true)))) :pattern ((has_key1 container1 key))))))
...
(assert (forall ((container1 us_rep3)) (forall ((key Int)) (! (=> (and (dynamic_invariant4 key true true true) (= (has_key1 container1 key) true)) (let ((result (get1 container1 key))) (and (=> (= (of_int 1) true) (and (= result (w_get1 container1 (witness1 container1 key))) (forall ((k Int)) (=> (and (in_range4 k) (= (has_key1 container1 k) true)) (= (= (equivalent_keys k key) true) (= (witness1 container1 key) (witness1 container1 k))))))) (dynamic_invariant5 result true false true)))) :pattern ((get1 container1 key))))))
...
(declare-const temp___693 count_type)
(declare-const o2 us_rep2)
(declare-const o3 Int)
(declare-const o4 Int)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___693 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___693)) no_element))
...
(assert (and (= o3 (length container)) (and (in_range1 o3) (<= o3 (to_rep (rec__find_map__index_maps__map__capacity (us_split_discrs1 container)))))))
