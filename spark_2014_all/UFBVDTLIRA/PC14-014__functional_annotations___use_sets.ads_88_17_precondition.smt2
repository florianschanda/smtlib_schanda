...
(assert (forall ((container us_rep)) (! (let ((result (elements container))) (and (and (and (and (= (length2 result) (length container)) (forall ((temp___471 Int)) (=> (and (in_range2 temp___471) (= (iter_has_element result temp___471) true)) (= (contains (model__ container) (get result temp___471)) true)))) (forall ((item Int)) (=> (and (in_range4 item) (= (contains (model__ container) item) true)) (and (< 0 (find result item)) (= (get result (find result item)) item))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (= (find result (get result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length container))) (=> (= (get result i) (get result j)) (= i j)))))))) :pattern ((elements container)))))
...
(declare-const temp___1029 us_rep1)
(declare-const temp___1028 Int)
(declare-const o Bool)
(declare-const o1 Bool)
(declare-const result Bool)
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i (length s))) (= (q (get (elements s) i)) true))))
(assert (and (= temp___1029 (elements s)) (and (and (and (and (= (length2 temp___1029) (length s)) (forall ((temp___467 Int)) (=> (and (in_range2 temp___467) (= (iter_has_element temp___1029 temp___467) true)) (= (contains (model__ s) (get temp___1029 temp___467)) true)))) (forall ((item Int)) (=> (and (in_range4 item) (= (contains (model__ s) item) true)) (and (< 0 (find temp___1029 item)) (= (get temp___1029 (find temp___1029 item)) item))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length s))) (= (find temp___1029 (get temp___1029 i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length s))) (=> (= (get temp___1029 i) (get temp___1029 j)) (= i j)))))))))
(assert (and (= o (iter_has_element temp___1029 temp___1028)) (= (= o true) (and (<= 1 temp___1028) (<= temp___1028 (last temp___1029))))))
(assert (= (= o1 true) (in_range2 temp___1028)))
(assert (= result (ite (= o1 true) o false)))
(assert (= result true))
(assert (not (<= 1 temp___1028)))
(check-sat)
(exit)
