...
(assert (forall ((container us_rep)) (! (let ((result (elements container))) (and (and (and (and (= (length2 result) (length container)) (forall ((temp___429 Int)) (=> (and (in_range2 temp___429) (= (iter_has_element result temp___429) true)) (= (contains (model__ container) (get result temp___429)) true)))) (forall ((item Int)) (=> (and (in_range4 item) (= (contains (model__ container) item) true)) (and (< 0 (find result item)) (= (get result (find result item)) item))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (= (find result (get result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length container))) (=> (= (get result i) (get result j)) (= i j)))))))) :pattern ((elements container)))))
...
(define-fun dynamic_invariant3 ((temp___expr_319 Int) (temp___is_init_316 Bool) (temp___skip_constant_317 Bool) (temp___do_toplevel_318 Bool)) Bool (=> (or (= temp___is_init_316 true) (<= 0 2147483647)) (in_range5 temp___expr_319)))
(assert true)
...
(define-fun dynamic_invariant5 ((temp___expr_325 Int) (temp___is_init_322 Bool) (temp___skip_constant_323 Bool) (temp___do_toplevel_324 Bool)) Bool (=> (or (= temp___is_init_322 true) (<= 0 2147483647)) (in_range6 temp___expr_325)))
...
(assert (forall ((container us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant6 item true true true) (=> (= (of_int 1) true) (=> (exists ((e Int)) (and (and (in_range4 e) (= (contains container e) true)) (= e item))) (= (contains container item) true)))) :pattern ((contains container item))))))
...
(declare-const temp___987 us_rep1)
...
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (= (q (get (elements s) i1)) true))))
(assert (and (= temp___987 (elements s)) (and (and (and (and (= (length2 temp___987) (length s)) (forall ((temp___425 Int)) (=> (and (in_range2 temp___425) (= (iter_has_element temp___987 temp___425) true)) (= (contains (model__ s) (get temp___987 temp___425)) true)))) (forall ((item Int)) (=> (and (in_range4 item) (= (contains (model__ s) item) true)) (and (< 0 (find temp___987 item)) (= (get temp___987 (find temp___987 item)) item))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (= (find temp___987 (get temp___987 i1)) i1)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length s))) (=> (= (get temp___987 i1) (get temp___987 j)) (= i1 j)))))))))
(assert (and (= o4 (iter_has_element temp___987 temp___986)) (= (= o4 true) (and (<= 1 temp___986) (<= temp___986 (last temp___987))))))
(assert (= (= o5 true) (in_range2 temp___986)))
(assert (= result1 (ite (= o5 true) o4 false)))
(assert (= result1 true))
(assert (not (<= 1 temp___986)))
(check-sat)
(exit)
