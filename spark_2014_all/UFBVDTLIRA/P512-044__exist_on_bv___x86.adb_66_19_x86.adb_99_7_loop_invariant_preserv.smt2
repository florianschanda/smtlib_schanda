...
(declare-const n14 t__ref)
(declare-const n27 t__ref)
...
(assert (and (= x86__rangesintersect__B100b__res__assume (inrange64 var1 (bvsub var2 var1_range_size) (bvadd var1_range_size var2_range_size))) (= (= x86__rangesintersect__B100b__res__assume true) (exists ((n16 (_ BitVec 64))) (and (and (bvule ((_ int2bv 64) 0) n16) (bvule n16 (bvadd var1_range_size var2_range_size))) (= var1 (bvadd (bvsub var2 var1_range_size) n16)))))))
...
(assert (=> (and (bvule ((_ int2bv 64) 0) n21) (bvule n21 var2_range_size)) (= temp___205 n)))
(assert (=> (and (bvule ((_ int2bv 64) 0) n21) (bvule n21 var2_range_size)) (= temp___204 n21)))
(assert (=> (and (bvule ((_ int2bv 64) 0) n21) (bvule n21 var2_range_size)) (= o (bvadd n21 (bvsub var1_range_size n12)))))
(assert (=> (and (bvule ((_ int2bv 64) 0) n21) (bvule n21 var2_range_size)) (= result2 (mk_t__ref n))))
(assert (=> (and (bvule ((_ int2bv 64) 0) n21) (bvule n21 var2_range_size)) (= n3 o)))
(assert (=> (and (bvule ((_ int2bv 64) 0) n21) (bvule n21 var2_range_size)) (and (bvule ((_ int2bv 64) 0) n3) (bvule n3 (bvadd var1_range_size var2_range_size)))))
(assert (=> (and (bvule ((_ int2bv 64) 0) n21) (bvule n21 var2_range_size)) (not (= var1 (bvadd (bvsub var2 var1_range_size) n3)))))
(assert (=> (and (bvule ((_ int2bv 64) 0) n21) (bvule n21 var2_range_size)) (not (= (bvadd var1 n12) (bvadd var2 n21)))))
(assert (=> (and (bvule ((_ int2bv 64) 0) n21) (bvule n21 var2_range_size)) (forall ((j (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) j) (bvule j n22)) (not (= (bvadd var1 n12) (bvadd var2 j)))))))
(assert (=> (and (bvule ((_ int2bv 64) 0) n21) (bvule n21 var2_range_size)) (and (=> (bvule ((_ int2bv 64) 0) var2_range_size) (dynamic_property2 ((_ int2bv 64) 0) var2_range_size n22)) (and (bvule ((_ int2bv 64) 0) n22) (bvule n22 var2_range_size)))))
(assert (=> (and (bvule ((_ int2bv 64) 0) n21) (bvule n21 var2_range_size)) (= n22 var2_range_size)))
(assert (=> (and (bvule ((_ int2bv 64) 0) n21) (bvule n21 var2_range_size)) (= n5 (mk_t__ref n4))))
(assert (=> (and (bvule ((_ int2bv 64) 0) n21) (bvule n21 var2_range_size)) (= n23 (mk_t__ref n22))))
(assert (=> (and (bvule ((_ int2bv 64) 0) n21) (bvule n21 var2_range_size)) (= n6 n4)))
(assert (=> (and (bvule ((_ int2bv 64) 0) n21) (bvule n21 var2_range_size)) (= n24 n22)))
(assert (=> (and (bvule ((_ int2bv 64) 0) n21) (bvule n21 var2_range_size)) (= n7 n5)))
(assert (=> (and (bvule ((_ int2bv 64) 0) n21) (bvule n21 var2_range_size)) (= n25 n23)))
(assert (=> (and (bvule ((_ int2bv 64) 0) n21) (bvule n21 var2_range_size)) (= n8 n6)))
(assert (=> (and (bvule ((_ int2bv 64) 0) n21) (bvule n21 var2_range_size)) (= n26 n24)))
(assert (=> (not (and (bvule ((_ int2bv 64) 0) n21) (bvule n21 var2_range_size))) (= n7 (mk_t__ref n))))
(assert (=> (not (and (bvule ((_ int2bv 64) 0) n21) (bvule n21 var2_range_size))) (= n25 (mk_t__ref n21))))
(assert (=> (not (and (bvule ((_ int2bv 64) 0) n21) (bvule n21 var2_range_size))) (= n8 n)))
(assert (=> (not (and (bvule ((_ int2bv 64) 0) n21) (bvule n21 var2_range_size))) (= n26 n21)))
(assert (forall ((j (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) j) (bvule j var2_range_size)) (not (= (bvadd var1 n12) (bvadd var2 j))))))
(assert (=> (not (= n12 ((_ int2bv 64) 0))) (forall ((i (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i n12)) (forall ((j (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) j) (bvule j var2_range_size)) (not (= (bvadd var1 i) (bvadd var2 j)))))))))
(assert (forall ((i (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i n12)) (forall ((j (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) j) (bvule j var2_range_size)) (not (= (bvadd var1 i) (bvadd var2 j))))))))
(assert (not (= n12 var1_range_size)))
(assert (= result3 (mk_t__ref n12)))
(assert (= n13 (bvadd n12 ((_ int2bv 64) 1))))
(assert (= n9 n7))
(assert (= n27 n25))
(assert (= n14 (mk_t__ref n13)))
(assert (= n10 n8))
(assert (= n28 n26))
(assert (= n15 n13))
(assert (not (= (t__content n14) ((_ int2bv 64) 0))))
(declare-const i (_ BitVec 64))
(assert (bvule ((_ int2bv 64) 0) i))
(assert (bvule i (bvsub (t__content n14) ((_ int2bv 64) 1))))
