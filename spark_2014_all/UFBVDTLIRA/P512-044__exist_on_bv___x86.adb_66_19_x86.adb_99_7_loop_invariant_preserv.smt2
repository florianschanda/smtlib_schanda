...
(assert (=> (not (= n12 #x0000000000000000)) (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i n12)) (forall ((j (_ BitVec 64))) (=> (and (bvule #x0000000000000000 j) (bvule j var2_range_size)) (not (= (bvadd var1 i) (bvadd var2 j)))))))))
(assert (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i n12)) (forall ((j (_ BitVec 64))) (=> (and (bvule #x0000000000000000 j) (bvule j var2_range_size)) (not (= (bvadd var1 i) (bvadd var2 j))))))))
(assert (not (= n12 var1_range_size)))
(assert (= result3 (mk_t__ref n12)))
(assert (= n13 (bvadd n12 #x0000000000000001)))
(assert (= n9 n7))
(assert (= n27 n25))
...
(assert (= n28 n26))
(assert (= n15 n13))
(assert (not (= (t__content n14) #x0000000000000000)))
(declare-const i (_ BitVec 64))
(assert (bvule #x0000000000000000 i))
(assert (bvule i (bvsub (t__content n14) #x0000000000000001)))
