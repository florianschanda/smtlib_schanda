...
(assert (= i1 2))
(assert (=> (and (<= 2 i1) (<= i1 7)) (and (and (= temp___387 i1) (and (= (make_mask i1) (bvsub (ite (< i1 256) (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) i1)) ((_ int2bv 8) 0)) ((_ int2bv 8) 1))) (and (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- i2 1))) (= (make_mask j1) (bvsub (ite (< j1 256) (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) j1)) ((_ int2bv 8) 0)) ((_ int2bv 8) 1))))) (and (and (=> (<= 2 7) (in_range2 i2)) (and (<= 2 i2) (<= i2 7))) (= i2 7))))) (and (= i2 i6) (= i7 i2)))))
(assert (=> (and (<= 2 i1) (<= i1 7)) (= (mk_int__ref i8) (mk_int__ref i6))))
(assert (=> (and (<= 2 i1) (<= i1 7)) (= i9 i7)))
(assert (=> (not (and (<= 2 i1) (<= i1 7))) (= i1 i8)))
(assert (=> (not (and (<= 2 i1) (<= i1 7))) (= i9 i1)))
(declare-const size Int)
(assert (<= 1 size))
(assert (<= size 7))
(assert (not (= (make_mask size) (bvsub (ite (< size 256) (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) size)) ((_ int2bv 8) 0)) ((_ int2bv 8) 1)))))
(check-sat)
(exit)
