...
(assert (=> (and (<= 2 i1) (<= i1 7)) (= (make_mask i1) (bvsub (ite (< i1 256) (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) i1)) ((_ int2bv 8) 0)) ((_ int2bv 8) 1)))))
(assert (=> (and (<= 2 i1) (<= i1 7)) (forall ((j Int)) (=> (and (<= 1 j) (<= j (- i2 1))) (= (make_mask j) (bvsub (ite (< j 256) (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) j)) ((_ int2bv 8) 0)) ((_ int2bv 8) 1)))))))
...
(assert (=> (and (<= 2 i1) (<= i1 7)) (= (mk_int__ref i5) (mk_int__ref i3))))
