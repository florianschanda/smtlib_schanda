...
(define-fun dynamic_invariant ((temp___expr_141 (_ BitVec 32)) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool true)
(declare-sort s1 0)
...
(define-fun dynamic_invariant1 ((temp___expr_153 Int) (temp___is_init_150 Bool) (temp___skip_constant_151 Bool) (temp___do_toplevel_152 Bool)) Bool (=> (or (= temp___is_init_150 true) (<= 0 17)) (in_range1 temp___expr_153)))
...
(define-fun dynamic_invariant2 ((temp___expr_159 (_ BitVec 32)) (temp___is_init_156 Bool) (temp___skip_constant_157 Bool) (temp___do_toplevel_158 Bool)) Bool true)
...
(define-fun dynamic_invariant3 ((temp___expr_165 Int) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool)) Bool (=> (or (= temp___is_init_162 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_165)))
(declare-fun c ((_ BitVec 32)) Int)
(declare-fun c__function_guard (Int (_ BitVec 32)) Bool)
(assert (forall ((s (_ BitVec 32))) (! (=> (dynamic_invariant2 s true true true) (dynamic_invariant3 (c s) true false true)) :pattern ((c s)))))
...
(declare-const v1raw1 (_ BitVec 32))
...
(declare-const v1raw2 (_ BitVec 32))
(declare-const x2 Int)
(declare-const t2 Int)
(declare-const tmp2 (_ BitVec 32))
(declare-const v1raw3 (_ BitVec 32))
(declare-const x3 Int)
(declare-const t3 Int)
(declare-const tmp3 (_ BitVec 32))
(assert true)
