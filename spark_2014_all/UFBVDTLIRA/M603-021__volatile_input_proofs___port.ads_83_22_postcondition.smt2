...
(define-fun dynamic_invariant ((temp___expr_165 (_ BitVec 32)) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool) (temp___do_typ_inv_164 Bool)) Bool true)
(declare-sort s1 0)
...
(define-fun dynamic_invariant1 ((temp___expr_179 Int) (temp___is_init_175 Bool) (temp___skip_constant_176 Bool) (temp___do_toplevel_177 Bool) (temp___do_typ_inv_178 Bool)) Bool (=> (or (= temp___is_init_175 true) (<= 0 17)) (in_range1 temp___expr_179)))
...
(define-fun dynamic_invariant2 ((temp___expr_186 (_ BitVec 32)) (temp___is_init_182 Bool) (temp___skip_constant_183 Bool) (temp___do_toplevel_184 Bool) (temp___do_typ_inv_185 Bool)) Bool true)
...
(define-fun dynamic_invariant3 ((temp___expr_193 Int) (temp___is_init_189 Bool) (temp___skip_constant_190 Bool) (temp___do_toplevel_191 Bool) (temp___do_typ_inv_192 Bool)) Bool (=> (or (= temp___is_init_189 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_193)))
(declare-fun c ((_ BitVec 32)) Int)
(declare-fun c__function_guard (Int (_ BitVec 32)) Bool)
(assert (forall ((s (_ BitVec 32))) (! (=> (dynamic_invariant2 s true true true true) (dynamic_invariant3 (c s) true false true true)) :pattern ((c s)))))
