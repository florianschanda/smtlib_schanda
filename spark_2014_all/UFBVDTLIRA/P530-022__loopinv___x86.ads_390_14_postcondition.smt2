...
(assert (forall ((regnew (_ BitVec 64))) (forall ((val__ (_ BitVec 32))) (! (= (= (writereg32post regnew val__) true) (and (= (readreg32 regnew) val__) (= (bvand regnew ((_ int2bv 64) 18446744069414584320)) ((_ int2bv 64) 0)))) :pattern ((writereg32post regnew val__))))))
...
(assert (= result rbp))
(assert (= rbp1 ((_ zero_extend 32) val__)))
(assert (= rbp1 rbp2))
(assert (= rbp3 rbp1))
(assert (not (= (writereg32post rbp2 val__) true)))
(check-sat)
(exit)
