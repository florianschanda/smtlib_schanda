...
(assert (= x86__readreg16__result1 ((_ extract 15 0) (bvand reg ((_ int2bv 64) 65535)))))
...
(assert (not (= x86__readreg16__result4 ((_ extract 15 0) (bvand reg ((_ int2bv 64) 65535))))))
(check-sat)
(exit)
