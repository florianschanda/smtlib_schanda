...
(assert (= result rbx))
(assert (= rbx1 (bvor (bvand rbx ((_ int2bv 64) 65280)) ((_ zero_extend 48) (bvmul ((_ zero_extend 8) val__) ((_ int2bv 16) 256))))))
(assert (= rbx1 rbx2))
(assert (= rbx3 rbx1))
(assert (not (= rbx2 (bvor (bvand rbx ((_ int2bv 64) 65280)) ((_ zero_extend 48) (bvmul ((_ zero_extend 8) val__) ((_ int2bv 16) 256)))))))
(check-sat)
(exit)
