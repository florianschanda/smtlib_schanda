...
(assert (= result rdx))
(assert (= rdx1 (bvor (bvand rdx ((_ int2bv 64) 18446744073709486080)) ((_ zero_extend 48) val__))))
(assert (= rdx1 rdx2))
(assert (= rdx3 rdx1))
(assert (not (= rdx2 (bvor (bvand rdx ((_ int2bv 64) 18446744073709486080)) ((_ zero_extend 48) val__)))))
(check-sat)
(exit)
