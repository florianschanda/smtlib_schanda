...
(assert (and (= o3 (length s)) (and (in_range1 o3) (<= o3 (to_rep1 (rec__use_sets__my_sets__set__capacity (us_split_discrs1 s)))))))
(assert (= o4 (ite (<= i o3) true false)))
(assert (= result1 (ite (<= 1 i) o4 false)))
(assert (= result1 true))
(assert (and (= o5 (elements s)) (and (and (and (and (= (length2 o5) (length s)) (forall ((temp___425 Int)) (=> (and (in_range3 temp___425) (= (iter_has_element o5 temp___425) true)) (= (contains (model__ s) (get o5 temp___425)) true)))) (forall ((item Int)) (=> (and (in_range4 item) (= (contains (model__ s) item) true)) (and (< 0 (find o5 item)) (= (get o5 (find o5 item)) item))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (= (find o5 (get o5 i1)) i1)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length s))) (=> (= (get o5 i1) (get o5 j)) (= i1 j)))))))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
