...
(assert (= result r13))
(assert (= r131 (bvor (bvand r13 ((_ int2bv 64) 18446744073709551360)) ((_ zero_extend 56) val__))))
(assert (= r131 r132))
(assert (= r133 r131))
(assert (not (= r132 (bvor (bvand r13 ((_ int2bv 64) 18446744073709551360)) ((_ zero_extend 56) val__)))))
(check-sat)
(exit)
