...
(define-fun dynamic_invariant1 ((temp___expr_363 Int) (temp___is_init_360 Bool) (temp___skip_constant_361 Bool) (temp___do_toplevel_362 Bool)) Bool (=> (or (= temp___is_init_360 true) (<= 1 64)) (in_range1 temp___expr_363)))
...
(assert (forall ((num_bits Int)) (! (=> (dynamic_invariant1 num_bits true true true) (= (make_mask num_bits) (shift_right ((_ int2bv 64) 18446744073709551615) (- 64 num_bits)))) :pattern ((make_mask num_bits)))))
...
(assert true)
(assert (forall ((us_void_param tuple0)) (! (= (= (lemma2 us_void_param) true) (forall ((size Int)) (=> (and (<= 1 size) (<= size 63)) (= (make_mask size) (bvsub (ite (< size 18446744073709551616) (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) size)) ((_ int2bv 64) 0)) ((_ int2bv 64) 1)))))) :pattern ((lemma2 us_void_param)))))
(declare-fun lemma2_goal (tuple0) Bool)
(declare-fun lemma2_goal__function_guard (Bool tuple0) Bool)
(assert true)
(declare-sort t773s 0)
(define-fun in_range2 ((x Int)) Bool (and (<= 2 x) (<= x 63)))
(declare-fun attr__ATTRIBUTE_IMAGE3 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check3 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE3 (us_image) Int)
(declare-fun user_eq2 (t773s t773s) Bool)
(declare-const dummy2 t773s)
(declare-datatypes () ((t773s__ref (mk_t773s__ref (t773s__content t773s)))))
(define-fun t773s__ref___projection ((a t773s__ref)) t773s (t773s__content a))
...
(assert true)
(assert (forall ((us_void_param tuple0)) (! (= (= (lemma81 us_void_param) true) (forall ((val__ (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) val__) (bvule val__ ((_ int2bv 64) 18446744073709551615))) (forall ((n Int)) (=> (and (<= 1 n) (<= n 63)) (bvult (shift_right val__ (- 64 n)) (ite (< n 18446744073709551616) (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) n)) ((_ int2bv 64) 0)))))))) :pattern ((lemma81 us_void_param)))))
(declare-const i Int)
(declare-const bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__result Bool)
...
(declare-const bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__result1 Bool)
(declare-const bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__result2 Bool)
(declare-const bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__result3 Bool)
(declare-const i10 Int)
(declare-const bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__result4 Bool)
(declare-const i11 Int)
(declare-const bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__result5 Bool)
...
(assert (<= 2 i1))
(assert (<= i1 63))
(assert (= (make_mask i1) (bvsub (ite (< i1 18446744073709551616) (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) i1)) ((_ int2bv 64) 0)) ((_ int2bv 64) 1))))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- i2 1))) (= (make_mask j1) (bvsub (ite (< j1 18446744073709551616) (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) j1)) ((_ int2bv 64) 0)) ((_ int2bv 64) 1))))))
(assert (and (=> (<= 2 63) (in_range2 i2)) (and (<= 2 i2) (<= i2 63))))
(assert (<= 1 j))
(assert (<= j (- i2 1)))
(assert (=> (< j 18446744073709551616) (= o1 (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) j)))))
(assert (=> (not (< j 18446744073709551616)) (= o1 ((_ int2bv 64) 0))))
(assert (= o2 (bvsub o1 ((_ int2bv 64) 1))))
