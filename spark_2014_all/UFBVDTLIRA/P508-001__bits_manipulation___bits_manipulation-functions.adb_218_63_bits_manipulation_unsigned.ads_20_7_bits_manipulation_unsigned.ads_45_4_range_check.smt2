...
(assert (<= 2 i1))
(assert (<= i1 63))
(assert (= (make_mask i1) (bvsub (ite (< i1 18446744073709551616) (bvshl #x0000000000000001 ((_ int2bv 64) i1)) #x0000000000000000) #x0000000000000001)))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- i2 1))) (= (make_mask j1) (bvsub (ite (< j1 18446744073709551616) (bvshl #x0000000000000001 ((_ int2bv 64) j1)) #x0000000000000000) #x0000000000000001)))))
(assert (and (=> (<= 2 63) (in_range2 i2)) (and (<= 2 i2) (<= i2 63))))
(assert (<= 1 j))
(assert (<= j (- i2 1)))
(assert (=> (< j 18446744073709551616) (= o (bvshl #x0000000000000001 ((_ int2bv 64) j)))))
(assert (=> (not (< j 18446744073709551616)) (= o #x0000000000000000)))
(assert (= o1 (bvsub o #x0000000000000001)))
