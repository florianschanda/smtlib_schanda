...
(assert (= result rax))
(assert (= rax1 (bvor (bvand rax ((_ int2bv 64) 65280)) ((_ zero_extend 48) (bvmul ((_ zero_extend 8) val__) ((_ int2bv 16) 256))))))
(assert (= rax1 rax2))
(assert (= rax3 rax1))
(assert (not (= rax2 (bvor (bvand rax ((_ int2bv 64) 65280)) ((_ zero_extend 48) (bvmul ((_ zero_extend 8) val__) ((_ int2bv 16) 256)))))))
(check-sat)
(exit)
