...
(declare-const x86__r8l__result (_ BitVec 8))
(declare-const result (_ BitVec 8))
(declare-const x86__r8l__result1 (_ BitVec 8))
(declare-const x86__r8l__result2 (_ BitVec 8))
(declare-const x86__r8l__result3 (_ BitVec 8))
(declare-const x86__r8l__result4 (_ BitVec 8))
(declare-const x86__r8l__result5 (_ BitVec 8))
(assert true)
(assert (= x86__r8l__result1 x86__r8l__result2))
(assert (= x86__r8l__result3 x86__r8l__result1))
(assert (= (mk_t__ref result) (mk_t__ref x86__r8l__result)))
(assert (= x86__r8l__result1 ((_ extract 7 0) (bvand r8 ((_ int2bv 64) 255)))))
(assert (= (mk_t__ref x86__r8l__result4) (mk_t__ref x86__r8l__result2)))
(assert (= x86__r8l__result5 x86__r8l__result3))
(assert (not (bvule ((_ zero_extend 56) ((_ int2bv 8) 0)) (bvand r8 ((_ int2bv 64) 255)))))
(check-sat)
(exit)
