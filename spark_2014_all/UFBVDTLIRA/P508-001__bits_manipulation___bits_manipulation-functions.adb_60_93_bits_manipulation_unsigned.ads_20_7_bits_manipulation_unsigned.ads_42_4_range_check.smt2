...
(assert (and (= o2 (make_mask o1)) (= o2 (shift_right ((_ int2bv 8) 255) (- 8 o1)))))
(assert (and (= o3 (shift_right value from)) (= o3 (ite (and (<= 1 8) (<= 8 8)) (ite (< from 8) (bvlshr value ((_ int2bv 8) from)) ((_ int2bv 8) 0)) (ite (and (<= 9 8) (<= 8 16)) ((_ extract 7 0) (ite (< from 16) (bvlshr ((_ zero_extend 8) value) ((_ int2bv 16) from)) ((_ int2bv 16) 0))) (ite (and (<= 17 8) (<= 8 32)) ((_ extract 7 0) (bvlshr ((_ zero_extend 24) value) ((_ int2bv 32) from))) ((_ extract 7 0) (bvlshr ((_ zero_extend 56) value) ((_ int2bv 64) from)))))))))
(assert (= o4 (bvand o3 o2)))
(assert (= result1 (ite (= bits_manipulation_unsigned__unsigned_8__functions__extract_bits_not_inline__result4 o4) true false)))
(assert (= result1 true))
