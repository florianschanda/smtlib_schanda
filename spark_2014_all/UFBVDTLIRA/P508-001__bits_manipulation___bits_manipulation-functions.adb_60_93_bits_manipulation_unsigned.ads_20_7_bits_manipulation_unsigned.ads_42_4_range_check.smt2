...
(assert (and (= o6 (shift_right value from)) (= o6 (ite (and (<= 1 8) (<= 8 8)) (ite (< from 8) (bvlshr value ((_ int2bv 8) from)) ((_ int2bv 8) 0)) (ite (and (<= 9 8) (<= 8 16)) ((_ extract 7 0) (ite (< from 16) (bvlshr ((_ zero_extend 8) value) ((_ int2bv 16) from)) ((_ int2bv 16) 0))) (ite (and (<= 17 8) (<= 8 32)) ((_ extract 7 0) (bvlshr ((_ zero_extend 24) value) ((_ int2bv 32) from))) ((_ extract 7 0) (bvlshr ((_ zero_extend 56) value) ((_ int2bv 64) from)))))))))
(assert (= o7 (bvand o6 o5)))
(assert (= result1 (ite (= bits_manipulation_unsigned__unsigned_8__functions__extract_bits_not_inline__result4 o7) true false)))
(assert (= result1 true))
