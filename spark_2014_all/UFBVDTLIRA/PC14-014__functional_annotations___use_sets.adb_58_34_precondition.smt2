...
(assert (= result2 true))
(assert (and (= o4 (elements s1)) (and (and (and (and (= (length o4) (length2 s1)) (forall ((temp___467 Int)) (=> (and (in_range4 temp___467) (= (iter_has_element o4 temp___467) true)) (= (contains (model__ s1) (get o4 temp___467)) true)))) (forall ((item Int)) (=> (and (in_range2 item) (= (contains (model__ s1) item) true)) (and (< 0 (find o4 item)) (= (get o4 (find o4 item)) item))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length2 s1))) (= (find o4 (get o4 i1)) i1)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length2 s1))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length2 s1))) (=> (= (get o4 i1) (get o4 j)) (= i1 j)))))))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
