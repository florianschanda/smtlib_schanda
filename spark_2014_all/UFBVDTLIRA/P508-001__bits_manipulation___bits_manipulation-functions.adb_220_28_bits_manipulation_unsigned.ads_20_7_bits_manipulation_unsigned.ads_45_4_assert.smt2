...
(assert (= i1 2))
(assert (=> (and (<= 2 i1) (<= i1 63)) (and (and (= temp___474 i1) (and (= (make_mask i1) (bvsub (ite (< i1 18446744073709551616) (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) i1)) ((_ int2bv 64) 0)) ((_ int2bv 64) 1))) (and (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- i2 1))) (= (make_mask j1) (bvsub (ite (< j1 18446744073709551616) (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) j1)) ((_ int2bv 64) 0)) ((_ int2bv 64) 1))))) (and (and (=> (<= 2 63) (in_range2 i2)) (and (<= 2 i2) (<= i2 63))) (= i2 63))))) (and (= i2 i6) (= i7 i2)))))
(assert (=> (and (<= 2 i1) (<= i1 63)) (= (mk_int__ref i8) (mk_int__ref i6))))
(assert (=> (and (<= 2 i1) (<= i1 63)) (= i9 i7)))
(assert (=> (not (and (<= 2 i1) (<= i1 63))) (= i1 i8)))
(assert (=> (not (and (<= 2 i1) (<= i1 63))) (= i9 i1)))
(declare-const size Int)
(assert (<= 1 size))
(assert (<= size 63))
(assert (not (= (make_mask size) (bvsub (ite (< size 18446744073709551616) (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) size)) ((_ int2bv 64) 0)) ((_ int2bv 64) 1)))))
(check-sat)
(exit)
