...
(assert (= i1 2))
(assert (=> (and (<= 2 i1) (<= i1 31)) (and (and (= temp___445 i1) (and (= (make_mask i1) (bvsub (ite (< i1 4294967296) (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) i1)) ((_ int2bv 32) 0)) ((_ int2bv 32) 1))) (and (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- i2 1))) (= (make_mask j1) (bvsub (ite (< j1 4294967296) (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) j1)) ((_ int2bv 32) 0)) ((_ int2bv 32) 1))))) (and (and (=> (<= 2 31) (in_range2 i2)) (and (<= 2 i2) (<= i2 31))) (= i2 31))))) (and (= i2 i6) (= i7 i2)))))
(assert (=> (and (<= 2 i1) (<= i1 31)) (= (mk_int__ref i8) (mk_int__ref i6))))
(assert (=> (and (<= 2 i1) (<= i1 31)) (= i9 i7)))
(assert (=> (not (and (<= 2 i1) (<= i1 31))) (= i1 i8)))
(assert (=> (not (and (<= 2 i1) (<= i1 31))) (= i9 i1)))
(declare-const size Int)
(assert (<= 1 size))
(assert (<= size 31))
(assert (not (= (make_mask size) (bvsub (ite (< size 4294967296) (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) size)) ((_ int2bv 32) 0)) ((_ int2bv 32) 1)))))
(check-sat)
(exit)
