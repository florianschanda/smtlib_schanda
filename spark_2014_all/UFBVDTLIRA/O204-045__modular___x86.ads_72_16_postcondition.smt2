...
(declare-const x86__eax__result (_ BitVec 32))
(declare-const result (_ BitVec 32))
(declare-const x86__eax__result1 (_ BitVec 32))
(declare-const x86__eax__result2 (_ BitVec 32))
(declare-const x86__eax__result3 (_ BitVec 32))
(declare-const x86__eax__result4 (_ BitVec 32))
(declare-const x86__eax__result5 (_ BitVec 32))
(declare-const result1 (_ BitVec 32))
(assert true)
(assert (= x86__eax__result1 x86__eax__result2))
(assert (= x86__eax__result3 x86__eax__result1))
(assert (= (mk_t__ref result) (mk_t__ref x86__eax__result)))
(assert (= x86__eax__result1 ((_ extract 31 0) (bvand rax ((_ int2bv 64) 4294967295)))))
(assert (= (mk_t__ref x86__eax__result4) (mk_t__ref x86__eax__result2)))
(assert (= x86__eax__result5 x86__eax__result3))
(assert (= result1 x86__eax__result4))
(assert (not (= x86__eax__result4 ((_ extract 31 0) (bvand rax ((_ int2bv 64) 4294967295))))))
(check-sat)
(exit)
