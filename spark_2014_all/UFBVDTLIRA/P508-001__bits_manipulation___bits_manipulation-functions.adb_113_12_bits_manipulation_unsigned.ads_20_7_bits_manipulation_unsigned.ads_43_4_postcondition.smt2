...
(assert (and (= o (msb_index_fast_inline_always value)) (and (in_range1 o) (= (shift_right value o) ((_ int2bv 16) 1)))))
...
(assert (not (= (shift_right value bits_manipulation_unsigned__unsigned_16__functions__msb_index_fast_not_inline__result4) ((_ int2bv 16) 1))))
(check-sat)
(exit)
