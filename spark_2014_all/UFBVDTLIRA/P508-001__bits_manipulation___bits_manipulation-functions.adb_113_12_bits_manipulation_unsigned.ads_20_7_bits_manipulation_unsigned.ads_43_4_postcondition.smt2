...
(declare-fun msb_index_fast_inline_always__function_guard (Int (_ BitVec 16)) Bool)
(declare-const value (_ BitVec 16))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const bits_manipulation_unsigned__unsigned_16__functions__msb_index_fast_not_inline__result Int)
(declare-const o Int)
(declare-const result Int)
(declare-const bits_manipulation_unsigned__unsigned_16__functions__msb_index_fast_not_inline__result1 Int)
(declare-const bits_manipulation_unsigned__unsigned_16__functions__msb_index_fast_not_inline__result2 Int)
(declare-const bits_manipulation_unsigned__unsigned_16__functions__msb_index_fast_not_inline__result3 Int)
(declare-const bits_manipulation_unsigned__unsigned_16__functions__msb_index_fast_not_inline__result4 Int)
(declare-const bits_manipulation_unsigned__unsigned_16__functions__msb_index_fast_not_inline__result5 Int)
(declare-const result1 Int)
(assert (not (= value #x0000)))
(assert (= bits_manipulation_unsigned__unsigned_16__functions__msb_index_fast_not_inline__result1 bits_manipulation_unsigned__unsigned_16__functions__msb_index_fast_not_inline__result2))
(assert (= bits_manipulation_unsigned__unsigned_16__functions__msb_index_fast_not_inline__result3 bits_manipulation_unsigned__unsigned_16__functions__msb_index_fast_not_inline__result1))
(assert (and (= o (msb_index_fast_inline_always value)) (and (in_range1 o) (= (shift_right value o) #x0001))))
(assert (= result bits_manipulation_unsigned__unsigned_16__functions__msb_index_fast_not_inline__result))
(assert (= bits_manipulation_unsigned__unsigned_16__functions__msb_index_fast_not_inline__result1 o))
(assert (= (mk_int__ref bits_manipulation_unsigned__unsigned_16__functions__msb_index_fast_not_inline__result4) (mk_int__ref bits_manipulation_unsigned__unsigned_16__functions__msb_index_fast_not_inline__result2)))
(assert (= bits_manipulation_unsigned__unsigned_16__functions__msb_index_fast_not_inline__result5 bits_manipulation_unsigned__unsigned_16__functions__msb_index_fast_not_inline__result3))
(assert (= result1 bits_manipulation_unsigned__unsigned_16__functions__msb_index_fast_not_inline__result4))
(assert (not (= (shift_right value bits_manipulation_unsigned__unsigned_16__functions__msb_index_fast_not_inline__result4) #x0001)))
(check-sat)
(exit)
