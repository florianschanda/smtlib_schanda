...
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- i2 1))) (= (make_mask j1) (bvsub (ite (< j1 65536) (bvshl #x0001 ((_ int2bv 16) j1)) #x0000) #x0001)))))
(assert (and (=> (<= 2 15) (in_range2 i2)) (and (<= 2 i2) (<= i2 15))))
(assert (<= 1 j))
(assert (<= j (- i2 1)))
(assert (=> (< j 65536) (= o (bvshl #x0001 ((_ int2bv 16) j)))))
(assert (=> (not (< j 65536)) (= o #x0000)))
(assert (= o1 (bvsub o #x0001)))
