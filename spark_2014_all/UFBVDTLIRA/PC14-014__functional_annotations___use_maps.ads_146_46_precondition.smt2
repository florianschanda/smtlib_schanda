...
(assert (forall ((attr__tag Int) (key2 Int)) (forall ((container us_rep)) (! (=> (dynamic_invariant2 key2 true true true true) (dynamic_invariant1 (element__21 attr__tag container key2) true false true true)) :pattern ((element__21 attr__tag container key2))))))
...
(assert (forall ((container us_rep)) (! (let ((result (length1 container))) (and (<= result (to_rep1 (rec__use_maps__my_maps__map__capacity (us_split_discrs1 container)))) (dynamic_invariant5 result true false true true))) :pattern ((length1 container)))))
(assert (forall ((attr__tag Int)) (forall ((container us_rep)) (! (dynamic_invariant5 (length2 attr__tag container) true false true true) :pattern ((length2 attr__tag container))))))
...
(define-fun oeq2 ((left us_rep4) (right us_rep4)) Bool (and (= (length3 left) (length3 right)) (ite (forall ((n Int)) (=> (and (<= 1 n) (<= n (last left))) (= (get1 left n) (get1 right n)))) true false)))
...
(define-fun default_initial_assumption1 ((temp___expr_437 us_rep4) (temp___skip_top_level_438 Bool)) Bool (=> (not (= temp___skip_top_level_438 true)) (= (length3 temp___expr_437) 0)))
(declare-fun find (us_rep4 Int) Int)
(declare-fun find__function_guard (Int us_rep4 Int) Bool)
(assert (forall ((container us_rep4)) (forall ((key2 Int)) (! (=> (dynamic_invariant2 key2 true true true true) (let ((result (find container key2))) (and (=> (< 0 result) (and (<= result (length3 container)) (= key2 (get1 container result)))) (dynamic_invariant5 result true false true true)))) :pattern ((find container key2))))))
...
(assert (forall ((container us_rep)) (! (let ((result (keys container))) (and (and (and (and (= (length3 result) (length1 container)) (forall ((temp___478 Int)) (=> (and (in_range6 temp___478) (= (iter_has_element result temp___478) true)) (= (has_key (model__ container) (get1 result temp___478)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ container) key2) true)) (and (< 0 (find result key2)) (= (get1 result (find result key2)) key2))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length1 container))) (= (find result (get1 result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length1 container))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length1 container))) (=> (= (get1 result i) (get1 result j)) (= i j)))))))) :pattern ((keys container)))))
...
(define-fun default_initial_assumption2 ((temp___expr_460 us_rep3) (temp___skip_top_level_461 Bool)) Bool (=> (not (= temp___skip_top_level_461 true)) (and (= (is_empty1 temp___expr_460) true) (= (length4 temp___expr_460) 0))))
(assert (forall ((container us_rep)) (! (let ((result (positions container))) (and (not (= (has_key1 result no_element) true)) (forall ((i us_rep1)) (=> (= (has_key1 result i) true) (and (and (<= 1 (get2 result i)) (<= (get2 result i) (length1 container))) (forall ((j us_rep1)) (=> (= (has_key1 result j) true) (=> (= (get2 result i) (get2 result j)) (= (bool_eq1 i j) true))))))))) :pattern ((positions container)))))
...
(define-fun dynamic_invariant6 ((temp___expr_393 Int) (temp___is_init_389 Bool) (temp___skip_constant_390 Bool) (temp___do_toplevel_391 Bool) (temp___do_typ_inv_392 Bool)) Bool (=> (or (= temp___is_init_389 true) (<= (- 2147483648) 2147483647)) (in_range7 temp___expr_393)))
...
(assert (forall ((container us_rep2)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant key2 true true true true) (= (has_key container key2) true)) (let ((result (get container key2))) (and (=> (= (distinct 1 0) true) (and (= result (w_get container (witness container key2))) (forall ((k Int)) (=> (and (in_range2 k) (= (has_key container k) true)) (= (= k key2) (= (witness container key2) (witness container k))))))) (dynamic_invariant6 result true false true true)))) :pattern ((get container key2))))))
(assert (forall ((container us_rep2)) (! (dynamic_invariant5 (length container) true false true true) :pattern ((length container)))))
(assert (forall ((left us_rep2) (right us_rep2)) (! (= (= (oeq3 left right) true) (and (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key left key2) true)) (and (= (has_key right key2) true) (= (get right key2) (get left key2))))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key right key2) true)) (= (has_key left key2) true))))) :pattern ((oeq3 left right)))))
...
(assert true)
(assert (forall ((container us_rep2)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant key2 true true true true) (= (has_key container key2) true)) (let ((result (witness container key2))) (and (= (has_witness container result) true) (dynamic_invariant5 result true false true true)))) :pattern ((witness container key2))))))
(assert (forall ((container us_rep2)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant5 witness1 true true true true) (= (has_witness container witness1) true)) (dynamic_invariant6 (w_get container witness1) true false true true)) :pattern ((w_get container witness1))))))
(define-fun dynamic_invariant7 ((temp___expr_429 Int) (temp___is_init_425 Bool) (temp___skip_constant_426 Bool) (temp___do_toplevel_427 Bool) (temp___do_typ_inv_428 Bool)) Bool (=> (or (= temp___is_init_425 true) (<= 0 2147483647)) (in_range6 temp___expr_429)))
(assert (forall ((container us_rep4)) (! (let ((result (length3 container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant5 result true false true true))) :pattern ((length3 container)))))
...
(define-fun dynamic_invariant8 ((temp___expr_422 Int) (temp___is_init_418 Bool) (temp___skip_constant_419 Bool) (temp___do_toplevel_420 Bool) (temp___do_typ_inv_421 Bool)) Bool (=> (or (= temp___is_init_418 true) (<= 1 2147483647)) (in_range8 temp___expr_422)))
...
(assert (forall ((container us_rep3)) (forall ((key2 us_rep1)) (! (=> (= (distinct 0 0) true) (=> (exists ((k us_rep1)) (and (= (has_key1 container k) true) (= (bool_eq1 k key2) true))) (= (has_key1 container key2) true))) :pattern ((has_key1 container key2))))))
...
(assert (forall ((container us_rep3)) (! (dynamic_invariant5 (length4 container) true false true true) :pattern ((length4 container)))))
...
(assert true)
(assert (forall ((container us_rep3)) (forall ((key2 us_rep1)) (! (=> (= (has_key1 container key2) true) (let ((result (witness1 container key2))) (and (= (has_witness1 container result) true) (dynamic_invariant5 result true false true true)))) :pattern ((witness1 container key2))))))
(assert (forall ((container us_rep3)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant5 witness2 true true true true) (= (has_witness1 container witness2) true)) (dynamic_invariant9 (w_get1 container witness2) true false true true)) :pattern ((w_get1 container witness2))))))
(declare-const temp___1019 us_rep2)
(declare-const k Int)
(declare-const o Bool)
(declare-const o1 Bool)
(declare-const result Bool)
(assert (= temp___1019 (model__ s)))
(assert (and (= o (has_key temp___1019 k)) (=> (= (distinct 1 0) true) (=> (exists ((k1 Int)) (and (and (in_range2 k1) (= (has_key temp___1019 k1) true)) (= k1 k))) (= o true)))))
(assert (= (= o1 true) (in_range2 k)))
