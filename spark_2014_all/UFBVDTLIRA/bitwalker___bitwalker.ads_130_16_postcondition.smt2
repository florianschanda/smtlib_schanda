...
(assert (= (eq_sub_bv__logic x #x0000000000000000 len_bv (bvsub #x0000000000000040 len_bv)) true))
(assert (= (eq_sub__logic x #x0000000000000000 (bv2nat len_bv) (bv2nat (bvsub #x0000000000000040 len_bv))) true))
(assert (forall ((j Int)) (=> (and (<= len j) (<= j (- (+ len (- 64 len)) 1))) (= (= (nth x j) true) (= (nth #x0000000000000000 j) true)))))
(assert (= bitwalker__lemmafunction2__result1 bitwalker__lemmafunction2__result2))
(assert (= bitwalker__lemmafunction2__result3 bitwalker__lemmafunction2__result1))
(assert (= (mk_int__ref result) (mk_int__ref bitwalker__lemmafunction2__result)))
(assert (= bitwalker__lemmafunction2__result1 0))
(assert (= (mk_int__ref bitwalker__lemmafunction2__result4) (mk_int__ref bitwalker__lemmafunction2__result2)))
(assert (= bitwalker__lemmafunction2__result5 bitwalker__lemmafunction2__result3))
