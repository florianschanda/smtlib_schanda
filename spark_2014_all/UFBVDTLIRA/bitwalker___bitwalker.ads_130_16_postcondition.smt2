...
(assert (and (and (and (and (and (= o1 len) (uint_in_range len)) (= bitwalker__lemmafunction2__len_bv__assume ((_ int2bv 64) o1))) (= bitwalker__lemmafunction2__len_bv__assume len_bv)) (and (= (bvand x (bvsub (maxvalue len) ((_ int2bv 64) 1))) x) (and (= (eq_sub_bv__logic x ((_ int2bv 64) 0) len_bv (bvsub ((_ int2bv 64) 64) len_bv)) true) (and (= (eq_sub__logic x ((_ int2bv 64) 0) (bv2nat len_bv) (bv2nat (bvsub ((_ int2bv 64) 64) len_bv))) true) (and (forall ((j1 Int)) (=> (and (<= len j1) (<= j1 (- (+ len (- 64 len)) 1))) (= (= (nth x j1) true) (= (nth ((_ int2bv 64) 0) j1) true)))) (and (and (= bitwalker__lemmafunction2__result1 bitwalker__lemmafunction2__result2) (= bitwalker__lemmafunction2__result3 bitwalker__lemmafunction2__result1)) (and (= (mk_int__ref result) (mk_int__ref bitwalker__lemmafunction2__result)) (= bitwalker__lemmafunction2__result1 0)))))))) (and (= (mk_int__ref bitwalker__lemmafunction2__result4) (mk_int__ref bitwalker__lemmafunction2__result2)) (= bitwalker__lemmafunction2__result5 bitwalker__lemmafunction2__result3))))
(assert (= result1 bitwalker__lemmafunction2__result4))
(assert (not (= bitwalker__lemmafunction2__result4 0)))
(check-sat)
(exit)
