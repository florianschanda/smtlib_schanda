...
(declare-const x86__edx__result1 (_ BitVec 32))
(declare-const x86__edx__result2 (_ BitVec 32))
(declare-const x86__edx__result3 (_ BitVec 32))
(declare-const x86__edx__result4 (_ BitVec 32))
(declare-const x86__edx__result5 (_ BitVec 32))
(declare-const result1 (_ BitVec 32))
(assert (= x86__edx__result1 x86__edx__result2))
(assert (= x86__edx__result3 x86__edx__result1))
(assert (= result x86__edx__result))
(assert (= x86__edx__result1 ((_ extract 31 0) (bvand rdx ((_ int2bv 64) 4294967295)))))
(assert (= (mk_t__ref x86__edx__result4) (mk_t__ref x86__edx__result2)))
(assert (= x86__edx__result5 x86__edx__result3))
(assert (= result1 x86__edx__result4))
(assert (not (= x86__edx__result4 (readreg32 rdx))))
(check-sat)
(exit)
