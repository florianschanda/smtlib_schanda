...
(assert (forall ((reg (_ BitVec 64))) (! (=> (dynamic_invariant reg true true true) (let ((result (readreghigh8 reg))) (and (= result ((_ extract 7 0) (bvurem (bvudiv (bvand reg ((_ int2bv 64) 65280)) ((_ int2bv 64) 256)) ((_ int2bv 64) 256)))) (dynamic_invariant1 result true false true)))) :pattern ((readreghigh8 reg)))))
...
(assert (= x86__dh__result1 ((_ extract 7 0) (bvudiv (bvand rdx ((_ int2bv 64) 65280)) ((_ int2bv 64) 256)))))
