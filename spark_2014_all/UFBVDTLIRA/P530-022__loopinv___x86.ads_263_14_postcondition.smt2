...
(assert (forall ((reg (_ BitVec 64))) (! (=> (dynamic_invariant reg true true true true) (let ((result (readreghigh8 reg))) (and (= result ((_ extract 7 0) (bvurem (bvudiv (bvand reg #x000000000000FF00) #x0000000000000100) ((_ int2bv 64) 256)))) (dynamic_invariant1 result true false true true)))) :pattern ((readreghigh8 reg)))))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const rdx (_ BitVec 64))
(declare-const x86__dh__result (_ BitVec 8))
(declare-const result (_ BitVec 8))
(declare-const x86__dh__result1 (_ BitVec 8))
(declare-const x86__dh__result2 (_ BitVec 8))
(declare-const x86__dh__result3 (_ BitVec 8))
(declare-const x86__dh__result4 (_ BitVec 8))
(declare-const x86__dh__result5 (_ BitVec 8))
(declare-const result1 (_ BitVec 8))
(assert (= x86__dh__result1 x86__dh__result2))
(assert (= x86__dh__result3 x86__dh__result1))
(assert (= result x86__dh__result))
(assert (= x86__dh__result1 ((_ extract 7 0) (bvudiv (bvand rdx #x000000000000FF00) #x0000000000000100))))
(assert (= (mk_t__ref x86__dh__result4) (mk_t__ref x86__dh__result2)))
(assert (= x86__dh__result5 x86__dh__result3))
(assert (= result1 x86__dh__result4))
(assert (not (= x86__dh__result4 (readreghigh8 rdx))))
(check-sat)
(exit)
