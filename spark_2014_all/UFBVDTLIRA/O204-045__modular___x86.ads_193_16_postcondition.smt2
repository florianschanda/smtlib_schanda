...
(assert (= result rbx))
(assert (= rbx1 (bvor (bvand rbx ((_ int2bv 64) 18446744069414584320)) ((_ zero_extend 32) val__))))
(assert (= rbx1 rbx2))
(assert (= rbx3 rbx1))
(assert (not (= rbx2 (bvor (bvand rbx ((_ int2bv 64) 18446744069414584320)) ((_ zero_extend 32) val__)))))
(check-sat)
(exit)
