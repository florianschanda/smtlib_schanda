...
(assert (= (is_empty5 (mk___rep3 dorma__split_discrs (mk___split_fields3 dorma__split_fields))) true))
(assert (= (to_rep (rec__dic_of_cont__my_orma__map__capacity dorma__split_discrs)) capacity))
(assert (= (is_empty7 (mk___rep4 dorse__split_discrs (mk___split_fields4 dorse__split_fields))) true))
