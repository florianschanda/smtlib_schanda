...
(declare-const temp___993 us_rep2)
(declare-const temp___992 Int)
(declare-const o Bool)
(declare-const o1 Bool)
(declare-const result Bool)
(assert (and (= temp___993 (keys (mk___rep m__split_discrs (mk___split_fields m__split_fields)))) (and (and (and (and (= (length2 temp___993) (length (mk___rep m__split_discrs (mk___split_fields m__split_fields)))) (forall ((temp___474 Int)) (=> (and (in_range5 temp___474) (= (iter_has_element temp___993 temp___474) true)) (= (has_key (model__ (mk___rep m__split_discrs (mk___split_fields m__split_fields))) (get1 temp___993 temp___474)) true)))) (forall ((key1 Int)) (=> (and (in_range2 key1) (= (has_key (model__ (mk___rep m__split_discrs (mk___split_fields m__split_fields))) key1) true)) (and (< 0 (find temp___993 key1)) (= (get1 temp___993 (find temp___993 key1)) key1))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep m__split_discrs (mk___split_fields m__split_fields))))) (= (find temp___993 (get1 temp___993 i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep m__split_discrs (mk___split_fields m__split_fields))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (mk___rep m__split_discrs (mk___split_fields m__split_fields))))) (=> (= (get1 temp___993 i) (get1 temp___993 j)) (= i j)))))))))
(assert (and (= o (iter_has_element temp___993 temp___992)) (= (= o true) (and (<= 1 temp___992) (<= temp___992 (last temp___993))))))
(assert (= (= o1 true) (in_range5 temp___992)))
(assert (= result (ite (= o1 true) o false)))
(assert (= result true))
(assert (not (<= temp___992 (last temp___993))))
(check-sat)
(exit)
