...
(assert (= result4 (ite (= bits_manipulation_unsigned__unsigned_16__functions__extract_bits__result4 o9) true false)))
(assert (= result4 true))
(assert (and (= o4 (+ (- to__ from) 1)) (in_range1 (+ (- to__ from) 1))))
(assert (and (= o5 (make_mask o4)) (= o5 (shift_right ((_ int2bv 16) 65535) (- 16 o4)))))
(assert (= result5 (ite (bvule bits_manipulation_unsigned__unsigned_16__functions__extract_bits__result4 o5) true false)))
(assert (= result5 true))
