...
(assert (= result4 (ite (= bits_manipulation_unsigned__unsigned_16__functions__extract_bits__result4 o8) true false)))
(assert (= result4 true))
(assert (and (= o3 (+ (- to__ from) 1)) (in_range1 (+ (- to__ from) 1))))
(assert (and (= o4 (make_mask o3)) (= o4 (shift_right #xFFFF (- 16 o3)))))
(assert (= result5 (ite (bvule bits_manipulation_unsigned__unsigned_16__functions__extract_bits__result4 o4) true false)))
(assert (= result5 true))
