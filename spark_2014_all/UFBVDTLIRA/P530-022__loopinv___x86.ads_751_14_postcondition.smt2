...
(assert (forall ((x86__rcx (_ BitVec 64))) (! (=> (dynamic_invariant x86__rcx true true true true) (let ((result (cl x86__rcx))) (and (= result (readreglow8 x86__rcx)) (dynamic_invariant1 result true false true true)))) :pattern ((cl x86__rcx)))))
...
(assert (=> (and (not (= carryflag true)) (not (= zeroflag true))) (= (writereglow8post rcx rcx1 #x01) true)))
(assert (=> (not (and (not (= carryflag true)) (not (= zeroflag true)))) (= (writereglow8post rcx rcx2 #x00) true)))
(assert (=> (not (and (not (= carryflag true)) (not (= zeroflag true)))) (= rcx1 rcx2)))
(assert (= rcx1 rcx3))
(assert (= rcx4 rcx1))
(assert (not (and (not (= carryflag true)) (not (= zeroflag true)))))
