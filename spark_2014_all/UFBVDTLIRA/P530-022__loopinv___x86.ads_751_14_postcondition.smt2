...
(assert (forall ((x86__rcx (_ BitVec 64))) (! (=> (dynamic_invariant x86__rcx true true true) (let ((result (cl x86__rcx))) (and (= result (readreglow8 x86__rcx)) (dynamic_invariant1 result true false true)))) :pattern ((cl x86__rcx)))))
...
(assert true)
(assert (=> (and (not (= carryflag true)) (not (= zeroflag true))) (= (writereglow8post rcx rcx1 ((_ int2bv 8) 1)) true)))
(assert (=> (not (and (not (= carryflag true)) (not (= zeroflag true)))) (= (writereglow8post rcx rcx2 ((_ int2bv 8) 0)) true)))
