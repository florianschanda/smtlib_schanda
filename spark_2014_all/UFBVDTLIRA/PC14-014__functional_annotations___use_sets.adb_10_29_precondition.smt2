...
(assert (= result2 true))
(assert (and (= o6 (elements s)) (and (and (and (and (= (length o6) (length2 s)) (forall ((temp___425 Int)) (=> (and (in_range4 temp___425) (= (iter_has_element o6 temp___425) true)) (= (contains (model__ s) (get o6 temp___425)) true)))) (forall ((item Int)) (=> (and (in_range6 item) (= (contains (model__ s) item) true)) (and (< 0 (find o6 item)) (= (get o6 (find o6 item)) item))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length2 s))) (= (find o6 (get o6 i1)) i1)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length2 s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length2 s))) (=> (= (get o6 i1) (get o6 j)) (= i1 j)))))))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
