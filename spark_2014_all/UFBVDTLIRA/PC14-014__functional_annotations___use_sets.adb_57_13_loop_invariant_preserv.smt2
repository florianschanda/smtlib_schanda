...
(assert (and (= (mk___rep1 (mk___split_fields1 temp___904)) (next s1 (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (ite (= (ite (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields2)) no_element) false) (= (get1 (positions s1) (mk___rep1 (mk___split_fields1 cu__split_fields2))) (length2 s1)) true) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 temp___904)) no_element) true) (and (= (has_key (positions s1) (mk___rep1 (mk___split_fields1 temp___904))) true) (= (get1 (positions s1) (mk___rep1 (mk___split_fields1 temp___904))) (+ (get1 (positions s1) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))))))
(assert (= result5 cu__split_fields2))
(assert (= temp___904 cu__split_fields3))
