...
(assert true)
(assert (forall ((us_void_param tuple0)) (! (= (= (lemma1 us_void_param) true) (forall ((size Int)) (=> (and (<= 1 size) (<= size 7)) (bvult (make_mask size) (ite (< size 256) (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) size)) ((_ int2bv 8) 0)))))) :pattern ((lemma1 us_void_param)))))
...
(assert (<= 1 size))
(assert (<= size 7))
(assert (not (bvult (make_mask size) (ite (< size 256) (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) size)) ((_ int2bv 8) 0)))))
(check-sat)
(exit)
