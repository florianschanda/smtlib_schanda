...
(assert true)
(assert (and (bvule scale_num scale_denom) (and (or (= scale_num ((_ int2bv 64) 0)) (bvule val__ (bvudiv ((_ int2bv 64) 18446744073709551615) scale_num))) (= res (bvudiv (bvmul val__ scale_num) scale_denom)))))
(assert (not (bvule res val__)))
(check-sat)
(exit)
