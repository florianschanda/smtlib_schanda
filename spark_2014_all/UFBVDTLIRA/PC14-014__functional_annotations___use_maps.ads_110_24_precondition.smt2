...
(define-fun dynamic_invariant1 ((temp___expr_422 Int) (temp___is_init_418 Bool) (temp___skip_constant_419 Bool) (temp___do_toplevel_420 Bool) (temp___do_typ_inv_421 Bool)) Bool (=> (or (= temp___is_init_418 true) (<= 1 2147483647)) (in_range3 temp___expr_422)))
(define-fun dynamic_invariant2 ((temp___expr_429 Int) (temp___is_init_425 Bool) (temp___skip_constant_426 Bool) (temp___do_toplevel_427 Bool) (temp___do_typ_inv_428 Bool)) Bool (=> (or (= temp___is_init_425 true) (<= 0 2147483647)) (in_range2 temp___expr_429)))
...
(define-fun default_initial_assumption ((temp___expr_437 us_rep1) (temp___skip_top_level_438 Bool)) Bool (=> (not (= temp___skip_top_level_438 true)) (= (length2 temp___expr_437) 0)))
...
(define-fun dynamic_invariant3 ((temp___expr_346 Int) (temp___is_init_342 Bool) (temp___skip_constant_343 Bool) (temp___do_toplevel_344 Bool) (temp___do_typ_inv_345 Bool)) Bool (=> (or (= temp___is_init_342 true) (<= 1 2147483647)) (in_range5 temp___expr_346)))
...
(define-fun dynamic_invariant4 ((temp___expr_353 Int) (temp___is_init_349 Bool) (temp___skip_constant_350 Bool) (temp___do_toplevel_351 Bool) (temp___do_typ_inv_352 Bool)) Bool (=> (or (= temp___is_init_349 true) (<= (- 2147483648) 2147483647)) (in_range6 temp___expr_353)))
...
(assert (forall ((container us_rep1)) (forall ((key Int)) (! (=> (dynamic_invariant3 key true true true true) (let ((result (find container key))) (and (=> (< 0 result) (and (<= result (length2 container)) (= key (get container result)))) (dynamic_invariant result true false true true)))) :pattern ((find container key))))))
...
(define-fun default_initial_assumption1 ((temp___expr_401 us_rep2) (temp___skip_top_level_402 Bool)) Bool (=> (not (= temp___skip_top_level_402 true)) (and (= (is_empty temp___expr_401) true) (= (length3 temp___expr_401) 0))))
(assert true)
...
(assert (= result true))
(assert (and (= o2 (keys s)) (and (and (and (and (= (length2 o2) (length s)) (forall ((temp___474 Int)) (=> (and (in_range2 temp___474) (= (iter_has_element o2 temp___474) true)) (= (has_key (model__ s) (get o2 temp___474)) true)))) (forall ((key Int)) (=> (and (in_range4 key) (= (has_key (model__ s) key) true)) (and (< 0 (find o2 key)) (= (get o2 (find o2 key)) key))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (= (find o2 (get o2 i1)) i1)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length s))) (=> (= (get o2 i1) (get o2 j)) (= i1 j)))))))))
