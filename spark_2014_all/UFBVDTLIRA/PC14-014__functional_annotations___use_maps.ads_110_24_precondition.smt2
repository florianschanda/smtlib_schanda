...
(define-fun dynamic_invariant1 ((temp___expr_385 Int) (temp___is_init_382 Bool) (temp___skip_constant_383 Bool) (temp___do_toplevel_384 Bool)) Bool (=> (or (= temp___is_init_382 true) (<= 1 2147483647)) (in_range3 temp___expr_385)))
(define-fun dynamic_invariant2 ((temp___expr_391 Int) (temp___is_init_388 Bool) (temp___skip_constant_389 Bool) (temp___do_toplevel_390 Bool)) Bool (=> (or (= temp___is_init_388 true) (<= 0 2147483647)) (in_range2 temp___expr_391)))
...
(define-fun default_initial_assumption ((temp___expr_398 us_rep1) (temp___skip_top_level_399 Bool)) Bool (=> (not (= temp___skip_top_level_399 true)) (= (length2 temp___expr_398) 0)))
...
(assert (forall ((container us_rep)) (! (let ((result (keys container))) (and (and (and (and (= (length2 result) (length container)) (forall ((temp___435 Int)) (=> (and (in_range2 temp___435) (= (iter_has_element result temp___435) true)) (= (has_key (model__ container) (get result temp___435)) true)))) (forall ((key Int)) (=> (and (in_range4 key) (= (has_key (model__ container) key) true)) (and (< 0 (find result key)) (= (get result (find result key)) key))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (= (find result (get result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length container))) (=> (= (get result i) (get result j)) (= i j)))))))) :pattern ((keys container)))))
...
(define-fun dynamic_invariant3 ((temp___expr_319 Int) (temp___is_init_316 Bool) (temp___skip_constant_317 Bool) (temp___do_toplevel_318 Bool)) Bool (=> (or (= temp___is_init_316 true) (<= 1 2147483647)) (in_range5 temp___expr_319)))
...
(define-fun dynamic_invariant4 ((temp___expr_325 Int) (temp___is_init_322 Bool) (temp___skip_constant_323 Bool) (temp___do_toplevel_324 Bool)) Bool (=> (or (= temp___is_init_322 true) (<= (- 2147483648) 2147483647)) (in_range6 temp___expr_325)))
...
(assert (forall ((container us_rep1)) (forall ((key Int)) (! (=> (dynamic_invariant3 key true true true) (let ((result (find container key))) (and (=> (< 0 result) (and (<= result (length2 container)) (= key (get container result)))) (dynamic_invariant result true false true)))) :pattern ((find container key))))))
...
(define-fun default_initial_assumption1 ((temp___expr_367 us_rep2) (temp___skip_top_level_368 Bool)) Bool (=> (not (= temp___skip_top_level_368 true)) (and (= (is_empty temp___expr_367) true) (= (length3 temp___expr_367) 0))))
(assert true)
...
(assert (forall ((container us_rep2)) (forall ((key Int)) (! (=> (dynamic_invariant7 key true true true) (=> (= (of_int 1) true) (=> (exists ((k Int)) (and (and (in_range4 k) (= (has_key container k) true)) (= k key))) (= (has_key container key) true)))) :pattern ((has_key container key))))))
...
(assert (forall ((container us_rep2)) (forall ((key Int)) (! (=> (and (dynamic_invariant7 key true true true) (= (has_key container key) true)) (let ((result (get1 container key))) (and (=> (= (of_int 1) true) (and (= result (w_get container (witness container key))) (forall ((k Int)) (=> (and (in_range4 k) (= (has_key container k) true)) (= (= k key) (= (witness container key) (witness container k))))))) (dynamic_invariant8 result true false true)))) :pattern ((get1 container key))))))
...
(assert true)
(assert (forall ((container us_rep2)) (forall ((key Int)) (! (=> (and (dynamic_invariant7 key true true true) (= (has_key container key) true)) (let ((result (witness container key))) (and (= (has_witness container result) true) (dynamic_invariant result true false true)))) :pattern ((witness container key))))))
(assert (forall ((container us_rep2)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant witness1 true true true) (= (has_witness container witness1) true)) (dynamic_invariant8 (w_get container witness1) true false true)) :pattern ((w_get container witness1))))))
