...
(assert (and (= x86__rangesintersect__B100b__res__assume (inrange64 var1 (bvsub var2 var1_range_size) (bvadd var1_range_size var2_range_size))) (= (= x86__rangesintersect__B100b__res__assume true) (exists ((n4 (_ BitVec 64))) (and (and (bvule ((_ int2bv 64) 0) n4) (bvule n4 (bvadd var1_range_size var2_range_size))) (= var1 (bvadd (bvsub var2 var1_range_size) n4)))))))
...
(assert (not (not (= (bvadd var1 n12) (bvadd var2 n21)))))
(check-sat)
(exit)
