...
(declare-fun msb_index_fast_inline_always__function_guard (Int (_ BitVec 8)) Bool)
(declare-const value (_ BitVec 8))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const bits_manipulation_unsigned__unsigned_8__functions__msb_index_fast_inline__result Int)
(declare-const o Int)
(declare-const result Int)
(declare-const bits_manipulation_unsigned__unsigned_8__functions__msb_index_fast_inline__result1 Int)
(declare-const bits_manipulation_unsigned__unsigned_8__functions__msb_index_fast_inline__result2 Int)
(declare-const bits_manipulation_unsigned__unsigned_8__functions__msb_index_fast_inline__result3 Int)
(declare-const bits_manipulation_unsigned__unsigned_8__functions__msb_index_fast_inline__result4 Int)
(declare-const bits_manipulation_unsigned__unsigned_8__functions__msb_index_fast_inline__result5 Int)
(assert true)
