...
(define-fun e_elements_included ((left1 us_rep2) (right1 us_rep2)) Bool (ite (forall ((i Int)) (=> (and (<= 1 i) (<= i (length2 left1))) (and (< 0 (find right1 (get left1 i))) (= (get right1 (find right1 (get left1 i))) (get left1 i))))) true false))
...
(define-fun oeq1 ((left1 us_rep2) (right1 us_rep2)) Bool (and (= (length2 left1) (length2 right1)) (ite (forall ((n Int)) (=> (and (<= 1 n) (<= n (last left1))) (= (get left1 n) (get right1 n)))) true false)))
...
(define-fun dynamic_invariant2 ((temp___expr_386 Int) (temp___is_init_382 Bool) (temp___skip_constant_383 Bool) (temp___do_toplevel_384 Bool) (temp___do_typ_inv_385 Bool)) Bool (=> (or (= temp___is_init_382 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_386)))
