...
(assert (=> (= scale_num ((_ int2bv 32) 0)) (= result true)))
(assert (=> (not (= scale_num ((_ int2bv 32) 0))) (= result (ite (bvule val__ (bvudiv ((_ int2bv 32) 4294967295) scale_num)) true false))))
(assert (= result true))
