...
(assert (let ((temp___487 (keys s))) (forall ((temp___486 Int)) (=> (and (in_range3 temp___486) (= (iter_has_element temp___487 temp___486) true)) (exists ((i1 us_rep1)) (and (= (has_key1 (positions s) i1) true) (= (get (keys s) (get1 (positions s) i1)) (get temp___487 temp___486))))))))
