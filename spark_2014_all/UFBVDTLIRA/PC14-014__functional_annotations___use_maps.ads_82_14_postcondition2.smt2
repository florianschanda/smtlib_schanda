...
(assert (= result3 true))
(assert (and (= s1__split_discrs (mk___split_discrs temp___906 temp___9061)) (= s1__split_fields temp___9062)))
(assert (= temp___907 (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))))
(assert (= temp___905 cu__split_fields1))
(assert (< (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields2))) (+ temp___907 (get2 (positions s2) (mk___rep1 (mk___split_fields1 cu__split_fields2))))))
...
(assert (in_range5 temp___936))
(assert (= (iter_has_element (keys (mk___rep s1__split_discrs (us_split_fields__content s1__split_fields8))) temp___936) true))
(assert (not (= (prop__ (get (model__ (mk___rep s1__split_discrs (us_split_fields__content s1__split_fields8))) (get1 (keys (mk___rep s1__split_discrs (us_split_fields__content s1__split_fields8))) temp___936))) true)))
(check-sat)
(exit)
