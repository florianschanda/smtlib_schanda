...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__my_maps__n__map__capacity (us_split_discrs1 container)))) (dynamic_invariant result true false true true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant1 ((temp___expr_728 Int) (temp___is_init_724 Bool) (temp___skip_constant_725 Bool) (temp___do_toplevel_726 Bool) (temp___do_typ_inv_727 Bool)) Bool (=> (or (= temp___is_init_724 true) (<= 1 2147483647)) (in_range2 temp___expr_728)))
...
(define-fun default_initial_assumption ((temp___expr_736 us_rep2) (temp___skip_top_level_737 Bool)) Bool (=> (not (= temp___skip_top_level_737 true)) (and (= (is_empty temp___expr_736) true) (= (length2 temp___expr_736) 0))))
...
(define-fun default_initial_assumption1 ((temp___expr_675 us_rep4) (temp___skip_top_level_676 Bool)) Bool (=> (not (= temp___skip_top_level_676 true)) (and (= (is_empty1 temp___expr_675) true) (= (length3 temp___expr_675) 0))))
...
(assert (forall ((container1 us_rep4)) (forall ((key us_rep3)) (! (=> (= (distinct 1 0) true) (=> (exists ((k us_rep3)) (and (= (has_key1 container1 k) true) (= (my_eq k key) true))) (= (has_key1 container1 key) true))) :pattern ((has_key1 container1 key))))))
...
(define-fun dynamic_invariant5 ((temp___expr_667 Int) (temp___is_init_663 Bool) (temp___skip_constant_664 Bool) (temp___do_toplevel_665 Bool) (temp___do_typ_inv_666 Bool)) Bool (=> (or (= temp___is_init_663 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_667)))
...
(assert (forall ((container1 us_rep4)) (forall ((key us_rep3)) (! (=> (= (has_key1 container1 key) true) (let ((result (get1 container1 key))) (and (=> (= (distinct 1 0) true) (and (= result (w_get1 container1 (witness1 container1 key))) (forall ((k us_rep3)) (=> (= (has_key1 container1 k) true) (= (= (my_eq k key) true) (= (witness1 container1 key) (witness1 container1 k))))))) (dynamic_invariant5 result true false true true)))) :pattern ((get1 container1 key))))))
...
(assert (forall ((container1 us_rep4)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant witness2 true true true true) (= (has_witness container1 witness2) true)) (dynamic_invariant5 (w_get1 container1 witness2) true false true true)) :pattern ((w_get1 container1 witness2))))))
...
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___1125 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___1125)) no_element))
