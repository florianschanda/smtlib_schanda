...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (and (= (to_rep (rec__my_maps__n__map__capacity (us_split_discrs1 a))) (to_rep (rec__my_maps__n__map__capacity (us_split_discrs1 b)))) (= (to_rep1 (rec__my_maps__n__map__modulus (us_split_discrs1 a))) (to_rep1 (rec__my_maps__n__map__modulus (us_split_discrs1 b))))) (= (us_main_eq (rec__my_maps__n__map (us_split_fields1 a)) (rec__my_maps__n__map (us_split_fields1 b))) true)) true false))
...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__my_maps__n__cursor__node count_type)))))
(define-fun us_split_fields_Node__2__projection ((a us_split_fields2)) count_type (rec__my_maps__n__cursor__node a))
...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (= (to_rep (rec__my_maps__n__cursor__node (us_split_fields3 a))) (to_rep (rec__my_maps__n__cursor__node (us_split_fields3 b)))) true false))
...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__my_maps__n__map__capacity (us_split_discrs1 container)))) (dynamic_invariant result true false true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant1 ((temp___expr_669 Int) (temp___is_init_666 Bool) (temp___skip_constant_667 Bool) (temp___do_toplevel_668 Bool)) Bool (=> (or (= temp___is_init_666 true) (<= 1 2147483647)) (in_range2 temp___expr_669)))
...
(define-fun default_initial_assumption ((temp___expr_676 us_rep2) (temp___skip_top_level_677 Bool)) Bool (=> (not (= temp___skip_top_level_677 true)) (and (= (is_empty temp___expr_676) true) (= (length2 temp___expr_676) 0))))
...
(declare-datatypes () ((us_split_fields4 (mk___split_fields2 (rec__my_maps__my_rec__f positive) (rec__my_maps__my_rec__g integer)))))
(define-fun us_split_fields_F__projection ((a us_split_fields4)) positive (rec__my_maps__my_rec__f a))
(define-fun us_split_fields_G__projection ((a us_split_fields4)) integer (rec__my_maps__my_rec__g a))
...
(define-fun bool_eq3 ((a us_rep3) (b us_rep3)) Bool (ite (and (= (to_rep3 (rec__my_maps__my_rec__f (us_split_fields5 a))) (to_rep3 (rec__my_maps__my_rec__f (us_split_fields5 b)))) (= (to_rep2 (rec__my_maps__my_rec__g (us_split_fields5 a))) (to_rep2 (rec__my_maps__my_rec__g (us_split_fields5 b))))) true false))
...
(define-fun my_eq ((x us_rep3) (y us_rep3)) Bool (= (to_rep3 (rec__my_maps__my_rec__f (us_split_fields5 x))) (to_rep3 (rec__my_maps__my_rec__f (us_split_fields5 y)))))
...
(define-fun default_initial_assumption1 ((temp___expr_623 us_rep4) (temp___skip_top_level_624 Bool)) Bool (=> (not (= temp___skip_top_level_624 true)) (and (= (is_empty1 temp___expr_623) true) (= (length3 temp___expr_623) 0))))
...
(define-fun key_type__ref___5__projection ((a key_type__ref1)) us_rep3 (key_type__content1 a))
(declare-fun has_key1 (us_rep4 us_rep3) Bool)
(declare-fun has_key__function_guard1 (Bool us_rep4 us_rep3) Bool)
(assert (forall ((container1 us_rep4)) (forall ((key us_rep3)) (! (=> (= (of_int 1) true) (=> (exists ((k us_rep3)) (and (= (has_key1 container1 k) true) (= (my_eq k key) true))) (= (has_key1 container1 key) true))) :pattern ((has_key1 container1 key))))))
...
(define-fun dynamic_invariant5 ((temp___expr_616 Int) (temp___is_init_613 Bool) (temp___skip_constant_614 Bool) (temp___do_toplevel_615 Bool)) Bool (=> (or (= temp___is_init_613 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_616)))
...
(assert (forall ((container1 us_rep4)) (forall ((key us_rep3)) (! (=> (= (has_key1 container1 key) true) (let ((result (get1 container1 key))) (and (=> (= (of_int 1) true) (and (= result (w_get1 container1 (witness1 container1 key))) (forall ((k us_rep3)) (=> (= (has_key1 container1 k) true) (= (= (my_eq k key) true) (= (witness1 container1 key) (witness1 container1 k))))))) (dynamic_invariant5 result true false true)))) :pattern ((get1 container1 key))))))
...
(assert (forall ((container1 us_rep4)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant witness2 true true true) (= (has_witness container1 witness2) true)) (dynamic_invariant5 (w_get1 container1 witness2) true false true)) :pattern ((w_get1 container1 witness2))))))
...
(assert (and (= o3 (length container)) (and (in_range1 o3) (<= o3 (to_rep (rec__my_maps__n__map__capacity (us_split_discrs1 container)))))))
