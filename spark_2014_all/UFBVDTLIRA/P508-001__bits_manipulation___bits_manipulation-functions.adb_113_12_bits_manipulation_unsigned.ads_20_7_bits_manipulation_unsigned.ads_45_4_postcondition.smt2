...
(assert (forall ((v (_ BitVec 64))) (forall ((amount Int)) (! (=> (and (dynamic_invariant v true true true) (dynamic_invariant1 amount true true true)) (dynamic_invariant (shift_right v amount) true false true)) :pattern ((shift_right v amount))))))
(assert (forall ((v (_ BitVec 64))) (forall ((amount Int)) (! (=> (and (dynamic_invariant v true true true) (dynamic_invariant1 amount true true true)) (= (shift_right v amount) (ite (and (<= 1 64) (<= 64 8)) ((_ zero_extend 56) (ite (< amount 8) (bvlshr ((_ extract 7 0) v) ((_ int2bv 8) amount)) ((_ int2bv 8) 0))) (ite (and (<= 9 64) (<= 64 16)) ((_ zero_extend 48) (ite (< amount 16) (bvlshr ((_ extract 15 0) v) ((_ int2bv 16) amount)) ((_ int2bv 16) 0))) (ite (and (<= 17 64) (<= 64 32)) ((_ zero_extend 32) (bvlshr ((_ extract 31 0) v) ((_ int2bv 32) amount))) (bvlshr v ((_ int2bv 64) amount))))))) :pattern ((shift_right v amount))))))
...
(assert (and (= o (msb_index_fast_inline_always value)) (and (in_range1 o) (= (shift_right value o) ((_ int2bv 64) 1)))))
...
(assert (not (= (shift_right value bits_manipulation_unsigned__unsigned_64__functions__msb_index_fast_not_inline__result4) ((_ int2bv 64) 1))))
(check-sat)
(exit)
