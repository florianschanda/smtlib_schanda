...
(assert (forall ((v (_ BitVec 64))) (forall ((amount Int)) (! (=> (and (dynamic_invariant v true true true true) (dynamic_invariant1 amount true true true true)) (dynamic_invariant (shift_right v amount) true false true true)) :pattern ((shift_right v amount))))))
(assert (forall ((v (_ BitVec 64))) (forall ((amount Int)) (! (=> (and (dynamic_invariant v true true true true) (dynamic_invariant1 amount true true true true)) (= (shift_right v amount) (ite (and (<= 1 64) (<= 64 8)) ((_ zero_extend 56) (ite (< amount 8) (bvlshr ((_ extract 7 0) v) ((_ int2bv 8) amount)) #x00)) (ite (and (<= 9 64) (<= 64 16)) ((_ zero_extend 48) (ite (< amount 16) (bvlshr ((_ extract 15 0) v) ((_ int2bv 16) amount)) #x0000)) (ite (and (<= 17 64) (<= 64 32)) ((_ zero_extend 32) (bvlshr ((_ extract 31 0) v) ((_ int2bv 32) amount))) (bvlshr v ((_ int2bv 64) amount))))))) :pattern ((shift_right v amount))))))
...
(declare-const bits_manipulation_unsigned__unsigned_64__functions__msb_index_fast_not_inline__result Int)
(declare-const o Int)
(declare-const result Int)
(declare-const bits_manipulation_unsigned__unsigned_64__functions__msb_index_fast_not_inline__result1 Int)
(declare-const bits_manipulation_unsigned__unsigned_64__functions__msb_index_fast_not_inline__result2 Int)
(declare-const bits_manipulation_unsigned__unsigned_64__functions__msb_index_fast_not_inline__result3 Int)
(declare-const bits_manipulation_unsigned__unsigned_64__functions__msb_index_fast_not_inline__result4 Int)
(declare-const bits_manipulation_unsigned__unsigned_64__functions__msb_index_fast_not_inline__result5 Int)
(declare-const result1 Int)
(assert (not (= value #x0000000000000000)))
(assert (= bits_manipulation_unsigned__unsigned_64__functions__msb_index_fast_not_inline__result1 bits_manipulation_unsigned__unsigned_64__functions__msb_index_fast_not_inline__result2))
(assert (= bits_manipulation_unsigned__unsigned_64__functions__msb_index_fast_not_inline__result3 bits_manipulation_unsigned__unsigned_64__functions__msb_index_fast_not_inline__result1))
(assert (and (= o (msb_index_fast_inline_always value)) (and (in_range1 o) (= (shift_right value o) #x0000000000000001))))
(assert (= result bits_manipulation_unsigned__unsigned_64__functions__msb_index_fast_not_inline__result))
(assert (= bits_manipulation_unsigned__unsigned_64__functions__msb_index_fast_not_inline__result1 o))
(assert (= (mk_int__ref bits_manipulation_unsigned__unsigned_64__functions__msb_index_fast_not_inline__result4) (mk_int__ref bits_manipulation_unsigned__unsigned_64__functions__msb_index_fast_not_inline__result2)))
(assert (= bits_manipulation_unsigned__unsigned_64__functions__msb_index_fast_not_inline__result5 bits_manipulation_unsigned__unsigned_64__functions__msb_index_fast_not_inline__result3))
(assert (= result1 bits_manipulation_unsigned__unsigned_64__functions__msb_index_fast_not_inline__result4))
(assert (not (= (shift_right value bits_manipulation_unsigned__unsigned_64__functions__msb_index_fast_not_inline__result4) #x0000000000000001)))
(check-sat)
(exit)
