...
(define-fun dynamic_invariant3 ((temp___expr_161 Int) (temp___is_init_158 Bool) (temp___skip_constant_159 Bool) (temp___do_toplevel_160 Bool)) Bool (=> (or (= temp___is_init_158 true) (<= 0 2)) (in_range4 temp___expr_161)))
(declare-sort map1 0)
...
(declare-fun temp___324 (map1 Int (_ BitVec 8) Int Int (_ BitVec 8) Int Int Int (_ BitVec 8) Int Int) map1)
(assert (forall ((temp___326 map1)) (forall ((temp___327 Int) (temp___329 Int) (temp___330 Int) (temp___332 Int) (temp___333 Int) (temp___334 Int) (temp___336 Int) (temp___337 Int)) (forall ((temp___328 (_ BitVec 8)) (temp___331 (_ BitVec 8)) (temp___335 (_ BitVec 8))) (let ((temp___325 (temp___324 temp___326 temp___327 temp___328 temp___329 temp___330 temp___331 temp___332 temp___333 temp___334 temp___335 temp___336 temp___337))) (forall ((temp___338 Int) (temp___340 Int)) (forall ((temp___339 (_ BitVec 8))) (ite (and (and (= temp___338 temp___334) (= temp___339 temp___335)) (= temp___340 temp___336)) (= (get temp___325 temp___338 temp___339 temp___340) (of_rep temp___337)) (ite (or (and (and (= temp___338 temp___327) (= temp___339 temp___328)) (= temp___340 temp___329)) (and (and (= temp___338 temp___330) (= temp___339 temp___331)) (= temp___340 temp___332))) (= (get temp___325 temp___338 temp___339 temp___340) (of_rep temp___333)) (= (get temp___325 temp___338 temp___339 temp___340) (get temp___326 temp___338 temp___339 temp___340)))))))))))
...
(assert (= 2 z2))
(assert (not (= (bool_eq a4 1 10 ((_ int2bv 8) 0) ((_ int2bv 8) 7) 0 2 (temp___324 a_3d_arr 1 ((_ int2bv 8) 2) 2 x1 y1 z1 v1 x2 y2 z2 v2) 1 10 ((_ int2bv 8) 0) ((_ int2bv 8) 7) 0 2) true)))
(check-sat)
(exit)
