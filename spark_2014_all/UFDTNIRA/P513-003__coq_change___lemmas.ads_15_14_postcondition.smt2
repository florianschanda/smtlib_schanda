...
(define-fun dynamic_invariant1 ((temp___expr_147 Int) (temp___is_init_144 Bool) (temp___skip_constant_145 Bool) (temp___do_toplevel_146 Bool)) Bool (=> (or (= temp___is_init_144 true) (<= 1 2147483647)) (in_range1 temp___expr_147)))
...
(assert (in_range1 denom))
(assert (<= val1 val2))
(assert (not (<= (div1 val1 denom) (div1 val2 denom))))
(check-sat)
(exit)
