...
(define-fun dynamic_invariant1 ((temp___expr_155 Int) (temp___is_init_152 Bool) (temp___skip_constant_153 Bool) (temp___do_toplevel_154 Bool)) Bool (=> (or (= temp___is_init_152 true) (<= 0 2)) (in_range2 temp___expr_155)))
...
(assert (and (= o7 (* min_distance min_distance)) (in_range (* min_distance min_distance))))
