...
(assert (and (= o5 (* (+ (int__content p2__sqrt__result4) 1) (+ (int__content p2__sqrt__result4) 1))) (in_range1 (* (+ (int__content p2__sqrt__result4) 1) (+ (int__content p2__sqrt__result4) 1)))))
(assert (= o6 (ite (< n o5) true false)))
(assert (not (in_range1 (* (int__content p2__sqrt__result4) (int__content p2__sqrt__result4)))))
(check-sat)
(exit)
