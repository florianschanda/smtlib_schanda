...
(define-fun dynamic_invariant1 ((temp___expr_141 Int) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool (=> (or (= temp___is_init_138 true) (<= 0 9223372036854775807)) (in_range1 temp___expr_141)))
(declare-sort pos 0)
...
(define-fun dynamic_invariant2 ((temp___expr_147 Int) (temp___is_init_144 Bool) (temp___skip_constant_145 Bool) (temp___do_toplevel_146 Bool)) Bool (=> (or (= temp___is_init_144 true) (<= 1 9223372036854775807)) (in_range2 temp___expr_147)))
...
(assert (in_range res))
(assert (<= scale_num scale_denom))
(assert (not (not (= scale_denom 0))))
(check-sat)
(exit)
