...
(declare-const temp___681 us_rep2)
...
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (let ((temp___687 (keys (mk___rep r__split_discrs r__split_fields2)))) (exists ((temp___686 Int)) (and (and (in_range4 temp___686) (= (iter_has_element temp___687 temp___686) true)) (= (get2 (model__ (mk___rep r__split_discrs r__split_fields2)) (get temp___687 temp___686)) (f (get2 (model__ s) (get (keys s) i1))))))))))
(assert (let ((temp___693 (keys (mk___rep r__split_discrs r__split_fields2)))) (forall ((temp___692 Int)) (=> (and (in_range4 temp___692) (= (iter_has_element temp___693 temp___692) true)) (exists ((i1 Int)) (and (and (<= 1 i1) (<= i1 (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (= (get2 (model__ (mk___rep r__split_discrs r__split_fields2)) (get temp___693 temp___692)) (f (get2 (model__ s) (get (keys s) i1))))))))))
(assert (forall ((i1 Int)) (=> (and (<= (get1 (positions s) (mk___rep1 cu__split_fields3)) i1) (<= i1 (length s))) (not (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2)) (get (keys s) i1)) true)))))
(assert (and (= o (positions s)) (and (not (= (has_key1 o no_element) true)) (forall ((i1 us_rep3)) (=> (= (has_key1 o i1) true) (and (and (<= 1 (get1 o i1)) (<= (get1 o i1) (length s))) (forall ((j us_rep3)) (=> (= (has_key1 o j) true) (=> (= (get1 o i1) (get1 o j)) (= (bool_eq3 i1 j) true))))))))))
(assert (and (= o1 (get1 o (mk___rep1 cu__split_fields3))) (and (in_range5 o1) (=> (= (distinct 0 0) true) (and (= o1 (w_get o (witness o (mk___rep1 cu__split_fields3)))) (forall ((k us_rep3)) (=> (= (has_key1 o k) true) (= (= (bool_eq3 k (mk___rep1 cu__split_fields3)) true) (= (witness o (mk___rep1 cu__split_fields3)) (witness o k))))))))))
(assert (= o2 (- o1 1)))
(assert (= o3 (ite (<= i o2) true false)))
(assert (= result2 (ite (<= 1 i) o3 false)))
(assert (= result2 true))
(assert (and (= temp___681 (keys (mk___rep r__split_discrs r__split_fields2))) (and (and (and (= (length2 temp___681) (length (mk___rep r__split_discrs r__split_fields2))) (forall ((temp___439 Int)) (=> (and (in_range4 temp___439) (= (iter_has_element temp___681 temp___439) true)) (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2)) (get temp___681 temp___439)) true)))) (forall ((key1 Int)) (=> (and (in_range2 key1) (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2)) key1) true)) (and (< 0 (find temp___681 key1)) (= (equivalent_keys (get temp___681 (find temp___681 key1)) key1) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep r__split_discrs r__split_fields2)))) (and (= (find temp___681 (get temp___681 i1)) i1) (= (k_is_find temp___681 (get temp___681 i1) i1) true)))))))
(assert (and (= o4 (iter_has_element temp___681 temp___680)) (= (= o4 true) (and (<= 1 temp___680) (<= temp___680 (last temp___681))))))
(assert (= (= o5 true) (in_range4 temp___680)))
(assert (= result3 (ite (= o5 true) o4 false)))
(assert (= result3 true))
(assert (not (<= temp___680 (last temp___681))))
(check-sat)
(exit)
