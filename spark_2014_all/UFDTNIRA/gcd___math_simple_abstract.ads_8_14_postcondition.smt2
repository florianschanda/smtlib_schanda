...
(assert (=> (< 1 c1) (or (and (and (= c1 c4) (= c5 c1)) (and (= (mod2 a c1) 0) (= (mod2 b c1) 0))) (and (not (and (= (mod2 a c1) 0) (= (mod2 b c1) 0))) (and (and (= c3 c4) (= c5 c3)) (and (ite (not (= (mod2 a c1) 0)) (not (= (divides c1 a) true)) (not (= (divides c1 b) true))) (and (forall ((x Int)) (=> (and (<= c2 x) (<= x (ite (< a b) a b))) (not (and (= (divides x a) true) (= (divides x b) true))))) (and (=> (<= 1 2147483647) (in_range1 c2)) (and (and (and (= o1 (- c2 1)) (in_range1 (- c2 1))) (and (= c2 result1) (= c3 o1))) (or (not (< 1 c3)) (and (< 1 c3) (and (= (mod2 a c3) 0) (= (mod2 b c3) 0)))))))))))))
...
(assert (= math_simple_abstract__gcd__result1 math_simple_abstract__gcd__result2))
(assert (= math_simple_abstract__gcd__result3 math_simple_abstract__gcd__result1))
(assert (= (mk_int__ref result2) (mk_int__ref math_simple_abstract__gcd__result)))
(assert (= math_simple_abstract__gcd__result1 c8))
(assert (= (mk_int__ref math_simple_abstract__gcd__result4) (mk_int__ref math_simple_abstract__gcd__result2)))
(assert (= (mk_int__ref c10) c12))
(assert (= math_simple_abstract__gcd__result5 math_simple_abstract__gcd__result3))
(assert (= c11 c9))
