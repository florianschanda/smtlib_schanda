...
(define-fun dynamic_invariant1 ((temp___expr_1518 Int) (temp___is_init_1515 Bool) (temp___skip_constant_1516 Bool) (temp___do_toplevel_1517 Bool)) Bool (=> (or (= temp___is_init_1515 true) (<= 0 63)) (in_range temp___expr_1518)))
