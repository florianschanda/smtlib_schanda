...
(declare-const temp___685 us_rep2)
(declare-const g Int)
...
(declare-const temp___690 us_rep3)
(declare-const temp___689 Int)
...
(assert (and (= (mk___rep1 (mk___split_fields1 use_ordered_sets__apply_f__cu__assume)) (first s)) (ite (= (= (length s) 0) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 use_ordered_sets__apply_f__cu__assume)) no_element) true) (and (= (has_key (positions s) (mk___rep1 (mk___split_fields1 use_ordered_sets__apply_f__cu__assume))) true) (= (get1 (positions s) (mk___rep1 (mk___split_fields1 use_ordered_sets__apply_f__cu__assume))) 1)))))
...
(assert (and (= result1 (has_key (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields1)))) (= (= result1 true) (= (has_key (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields1))) true))))
...
(assert (=> (= result1 true) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (- (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))) (= (contains (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) (f (get (elements s) i2))) true)))))
(assert (=> (= result1 true) (forall ((g2 Int)) (=> (and (in_range2 g2) (= (contains (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) g2) true)) (exists ((i2 Int)) (and (and (<= 1 i2) (<= i2 (- (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))) (= g2 (f (get (elements s) i2)))))))))
(assert (=> (= result1 true) (and (= o16 (element s (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range6 o16) (= o16 (get (elements s) (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2)))))))))
(assert (=> (= result1 true) (and (= o17 (f o16)) (and (in_range7 o17) (= o17 (ite (and (<= (- 100) o16) (<= o16 100)) (* o16 2) o16))))))
(assert (=> (= result1 true) (and (= (contains (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) o17) true) (ite (= (contains (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) o17) true) (and (and (and (= (oeq3 (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields2)))) true) (= (oeq4 (positions (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) (positions (mk___rep r__split_discrs (mk___split_fields r__split_fields1)))) true)) (= (get (elements (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) (find (elements (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) o17)) o17)) (= (equal_except (elements (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) (elements (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) (find (elements (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) o17)) true)) (and (and (and (and (and (and (= (length (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) (+ (length (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) 1)) (= (ole (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields2)))) true)) (= (included_except (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) o17) true)) (= (get (elements (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) (find (elements (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) o17)) o17)) (= (range_equal (elements (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) (elements (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) 1 (- (find (elements (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) o17) 1)) true)) (= (range_shifted (elements (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) (elements (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) (find (elements (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) o17) (length (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) 1) true)) (= (p_positions_shifted (positions (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) (positions (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) (find (elements (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) o17) 1) true))))))
(assert (=> (= result1 true) (and (= (mk___rep1 (mk___split_fields1 temp___682)) (next s (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (ite (= (ite (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields2)) no_element) false) (= (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) (length s)) true) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 temp___682)) no_element) true) (and (= (has_key (positions s) (mk___rep1 (mk___split_fields1 temp___682))) true) (= (get1 (positions s) (mk___rep1 (mk___split_fields1 temp___682))) (+ (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1)))))))
(assert (=> (= result1 true) (= result5 cu__split_fields2)))
(assert (=> (= result1 true) (= cu__split_fields3 (mk___split_fields1 temp___682))))
(assert (=> (= result1 true) (and (= o18 (has_key (positions s) (mk___rep1 cu__split_fields3))) (= (= o18 true) (= (has_key (positions s) (mk___rep1 cu__split_fields3)) true)))))
(assert (=> (= result1 true) (= result6 (ite (not (= o18 true)) true false))))
...
(assert (and (= temp___694 (elements (mk___rep r__split_discrs (us_split_fields__content r__split_fields7)))) (and (and (and (= (length2 temp___694) (length (mk___rep r__split_discrs (us_split_fields__content r__split_fields7)))) (forall ((temp___390 Int)) (=> (and (in_range3 temp___390) (= (iter_has_element temp___694 temp___390) true)) (= (contains (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) (get temp___694 temp___390)) true)))) (forall ((item Int)) (=> (and (in_range2 item) (= (contains (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) item) true)) (and (< 0 (find temp___694 item)) (= (equivalent_elements (get temp___694 (find temp___694 item)) item) true))))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))))) (and (= (find temp___694 (get temp___694 i2)) i2) (= (e_is_find temp___694 (get temp___694 i2) i2) true)))))))
(assert (and (= o21 (iter_has_element temp___694 temp___693)) (= (= o21 true) (and (<= 1 temp___693) (<= temp___693 (last temp___694))))))
(assert (= (= o22 true) (in_range3 temp___693)))
(assert (= result7 (ite (= o22 true) o21 false)))
(assert (= result7 true))
(assert (and (= g1 (get temp___694 temp___693)) (in_range4 g1)))
(assert (and (= temp___696 (elements s)) (and (and (and (= (length2 temp___696) (length s)) (forall ((temp___390 Int)) (=> (and (in_range3 temp___390) (= (iter_has_element temp___696 temp___390) true)) (= (contains (model__ s) (get temp___696 temp___390)) true)))) (forall ((item Int)) (=> (and (in_range2 item) (= (contains (model__ s) item) true)) (and (< 0 (find temp___696 item)) (= (equivalent_elements (get temp___696 (find temp___696 item)) item) true))))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length s))) (and (= (find temp___696 (get temp___696 i2)) i2) (= (e_is_find temp___696 (get temp___696 i2) i2) true)))))))
(assert (and (= o23 (iter_has_element temp___696 temp___695)) (= (= o23 true) (and (<= 1 temp___695) (<= temp___695 (last temp___696))))))
(assert (= (= o24 true) (in_range3 temp___695)))
(assert (= result8 (ite (= o24 true) o23 false)))
(assert (= result8 true))
