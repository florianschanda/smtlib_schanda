...
(assert (not (= x3 2147483647)))
(assert (= x3 result11))
(assert (= x4 (+ x3 1)))
(assert (and (= result14 (divides x4 a)) (= (= result14 true) (= (mod2 a x4) 0))))
(assert (=> (= result14 true) (and (= result13 (divides x4 b)) (= (= result13 true) (= (mod2 b x4) 0)))))
(assert (=> (not (= result14 true)) (= result13 false)))
(assert (=> (= result13 true) (and (= o4 (divides b a)) (= (= o4 true) (= (mod2 a b) 0)))))
(assert (=> (= result13 true) (= result12 (ite (not (= o4 true)) true false))))
(assert (=> (not (= result13 true)) (= result12 false)))
(assert (=> (= result12 true) (= (divides x4 (mod2 a b)) true)))
(assert (and (= result16 (divides b a)) (= (= result16 true) (= (mod2 a b) 0))))
(assert (=> (= result16 true) (and (= result15 (divides x4 b)) (= (= result15 true) (= (mod2 b x4) 0)))))
(assert (=> (not (= result16 true)) (= result15 false)))
(assert (=> (= result15 true) (= (divides x4 a) true)))
(assert (and (= o6 (divides b a)) (= (= o6 true) (= (mod2 a b) 0))))
(assert (= result19 (ite (not (= o6 true)) true false)))
(assert (=> (= result19 true) (and (= o5 (mod2 a b)) (in_range1 (mod2 a b)))))
(assert (=> (= result19 true) (and (= result18 (divides x4 o5)) (= (= result18 true) (= (mod2 o5 x4) 0)))))
(assert (=> (not (= result19 true)) (= result18 false)))
(assert (=> (= result18 true) (and (= result17 (divides x4 b)) (= (= result17 true) (= (mod2 b x4) 0)))))
(assert (=> (not (= result18 true)) (= result17 false)))
(assert (=> (= result17 true) (= (divides x4 a) true)))
