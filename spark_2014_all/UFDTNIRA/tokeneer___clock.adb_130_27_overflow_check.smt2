...
(define-fun dynamic_invariant ((temp___expr_159 Int) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool) (temp___do_typ_inv_158 Bool)) Bool (=> (or (= temp___is_init_155 true) (<= 0 4294967295)) (in_range1 temp___expr_159)))
...
(define-fun dynamic_invariant1 ((temp___expr_368 Int) (temp___is_init_364 Bool) (temp___skip_constant_365 Bool) (temp___do_toplevel_366 Bool) (temp___do_typ_inv_367 Bool)) Bool (=> (or (= temp___is_init_364 true) (<= 1901 2099)) (in_range2 temp___expr_368)))
(define-fun dynamic_invariant2 ((temp___expr_375 Int) (temp___is_init_371 Bool) (temp___skip_constant_372 Bool) (temp___do_toplevel_373 Bool) (temp___do_typ_inv_374 Bool)) Bool (=> (or (= temp___is_init_371 true) (<= 1 12)) (in_range3 temp___expr_375)))
(define-fun dynamic_invariant3 ((temp___expr_382 Int) (temp___is_init_378 Bool) (temp___skip_constant_379 Bool) (temp___do_toplevel_380 Bool) (temp___do_typ_inv_381 Bool)) Bool (=> (or (= temp___is_init_378 true) (<= 1 31)) (in_range4 temp___expr_382)))
(define-fun dynamic_invariant4 ((temp___expr_414 Int) (temp___is_init_410 Bool) (temp___skip_constant_411 Bool) (temp___do_toplevel_412 Bool) (temp___do_typ_inv_413 Bool)) Bool (=> (or (= temp___is_init_410 true) (<= 0 86399999)) (in_range6 temp___expr_414)))
...
(declare-const temp___484 yearst)
(declare-const temp___4841 monthst)
(declare-const temp___4842 dayst)
(declare-const temp___4843 millisecst)
...
(assert (= o1 o6))
(assert (= o o7))
(assert (= temp___484 o4))
(assert (= temp___4841 o5))
(assert (= temp___4842 o6))
(assert (= temp___4843 o7))
(assert (= (mk___rep (mk___split_fields temp___484 temp___4841 temp___4842 temp___4843)) zerotime))
...
(assert (<= 0 min))
(assert (<= min 59))
(assert (and (= o10 min) (in_range6 min)))
(assert (= o11 (* o10 60000)))
(assert (and (= o12 o11) (in_range5 o11)))
(assert (and (= o8 hour) (in_range6 hour)))
(assert (= o9 (* o8 3600000)))
(assert (and (= o13 o9) (in_range5 o9)))
(assert (= o14 (+ o13 o12)))
(assert (not (in_range5 o14)))
(check-sat)
(exit)
