...
(define-fun dynamic_invariant1 ((temp___expr_285 Int) (temp___is_init_282 Bool) (temp___skip_constant_283 Bool) (temp___do_toplevel_284 Bool)) Bool (=> (or (= temp___is_init_282 true) (<= 1901 2099)) (in_range2 temp___expr_285)))
(define-fun dynamic_invariant2 ((temp___expr_291 Int) (temp___is_init_288 Bool) (temp___skip_constant_289 Bool) (temp___do_toplevel_290 Bool)) Bool (=> (or (= temp___is_init_288 true) (<= 1 12)) (in_range3 temp___expr_291)))
(define-fun dynamic_invariant3 ((temp___expr_297 Int) (temp___is_init_294 Bool) (temp___skip_constant_295 Bool) (temp___do_toplevel_296 Bool)) Bool (=> (or (= temp___is_init_294 true) (<= 1 31)) (in_range4 temp___expr_297)))
(define-fun dynamic_invariant4 ((temp___expr_321 Int) (temp___is_init_318 Bool) (temp___skip_constant_319 Bool) (temp___do_toplevel_320 Bool)) Bool (=> (or (= temp___is_init_318 true) (<= 0 86399999)) (in_range6 temp___expr_321)))
...
(declare-const temp___382 yearst)
(declare-const temp___3821 monthst)
(declare-const temp___3822 dayst)
(declare-const temp___3823 millisecst)
...
(assert (= o1 o6))
(assert (= o o7))
(assert (= temp___382 o4))
(assert (= temp___3821 o5))
(assert (= temp___3822 o6))
(assert (= temp___3823 o7))
(assert (= (mk___rep (mk___split_fields temp___382 temp___3821 temp___3822 temp___3823)) zerotime))
...
(assert (and (= o11 hour) (in_range6 hour)))
(assert (= o12 (* o11 3600000)))
(assert (and (= o16 o12) (in_range5 o12)))
(assert (= o17 (+ o16 o15)))
(assert (not (in_range5 o17)))
(check-sat)
(exit)
