...
(assert (forall ((i natural_32)) (and (<= 0 (natural_32qtint i)) (<= (natural_32qtint i) 2147483647))))
...
(assert (forall ((i positive_32)) (and (<= 1 (positive_32qtint i)) (<= (positive_32qtint i) 2147483647))))
...
(declare-datatypes () ((positive_32__ref (mk_positive_32__ref (positive_32__content positive_32)))))
(define-fun positive_32__ref___projection ((a positive_32__ref)) positive_32 (positive_32__content a))
(define-fun dynamic_invariant1 ((temp___expr_194 Int) (temp___is_init_190 Bool) (temp___skip_constant_191 Bool) (temp___do_toplevel_192 Bool) (temp___do_typ_inv_193 Bool)) Bool (=> (or (= temp___is_init_190 true) (<= 1 2147483647)) (in_range2 temp___expr_194)))
(declare-const x Int)
