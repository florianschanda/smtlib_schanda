...
(assert (not (not (= (contains (model__ (mk___rep s__split_discrs s__split_fields1)) (+ (element (mk___rep s__split_discrs s__split_fields1) (mk___rep1 cu__split_fields2)) 1)) true))))
(check-sat)
(exit)
