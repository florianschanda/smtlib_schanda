...
(assert (= result2 true))
(assert (and (= o7 (keys s)) (and (and (and (= (length3 o7) (length s)) (forall ((temp___396 Int)) (=> (and (in_range3 temp___396) (= (iter_has_element o7 temp___396) true)) (= (has_key (model__ s) (get o7 temp___396)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true)) (and (< 0 (find o7 key2)) (= (equivalent_keys (get o7 (find o7 key2)) key2) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (and (= (find o7 (get o7 i1)) i1) (= (k_is_find o7 (get o7 i1) i1) true)))))))
(assert (and (= o8 (get o7 i)) (in_range4 o8)))
(assert (= o6 (model__ (mk___rep r__split_discrs r__split_fields2))))
(assert (and (= result3 (has_key o6 o8)) (=> (= (of_int 1) true) (=> (exists ((k Int)) (and (and (in_range2 k) (= (has_key o6 k) true)) (= (equivalent_keys k o8) true))) (= result3 true)))))
(assert (= result3 true))
