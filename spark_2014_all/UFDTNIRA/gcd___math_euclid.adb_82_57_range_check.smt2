...
(assert (=> (not (= bn1 0)) (forall ((x1 Int)) (=> (and (<= 1 x1) (<= x1 2147483647)) (= (and (= (divides x1 c2) true) (= (divides x1 an2) true)) (and (= (divides x1 an2) true) (or (= (divides an2 c2) true) (= (divides x1 (mod2 c2 an2)) true))))))))
(assert (=> (not (= bn1 0)) (forall ((x1 Int)) (=> (and (<= 1 x1) (<= x1 2147483647)) (= (and (= (divides x1 a) true) (= (divides x1 b) true)) (and (= (divides x1 an3) true) (or (= bn3 0) (= (divides x1 bn3) true))))))))
