...
(assert (=> (not (= bn1 0)) (and (and (= temp___134 c) (and (= temp___133 bn1) (and (= temp___132 an1) (and (and (= (mk_int__ref result2) (mk_int__ref c)) (= c2 an1)) (and (and (and (= o1 bn1) (in_range2 bn1)) (and (= an1 result3) (= an2 o1))) (and (and (and (= o2 (mod2 c2 bn1)) (in_range1 (mod2 c2 bn1))) (and (= bn1 result4) (= bn2 o2))) (and (forall ((x3 Int)) (=> (and (<= 1 x3) (<= x3 2147483647)) (= (and (= (divides x3 c2) true) (= (divides x3 an2) true)) (and (= (divides x3 an2) true) (or (= (divides an2 c2) true) (= (divides x3 (mod2 c2 an2)) true)))))) (and (forall ((x3 Int)) (=> (and (<= 1 x3) (<= x3 2147483647)) (= (and (= (divides x3 a) true) (= (divides x3 b) true)) (and (= (divides x3 an3) true) (or (= bn3 0) (= (divides x3 bn3) true)))))) (and (and (and (=> (<= 1 2147483647) (in_range2 an3)) (=> (<= 0 2147483647) (in_range1 bn3))) (=> (<= 1 2147483647) (in_range2 c3))) (= bn3 0)))))))))) (and (and (= c3 c7) (and (= bn3 bn7) (= an3 an7))) (and (= c8 c3) (and (= bn8 bn3) (= an8 an3)))))))
(assert (=> (not (= bn1 0)) (= (mk_int__ref c9) (mk_int__ref c7))))
(assert (=> (not (= bn1 0)) (= (mk_int__ref bn9) (mk_int__ref bn7))))
(assert (=> (not (= bn1 0)) (= (mk_int__ref an9) (mk_int__ref an7))))
(assert (=> (not (= bn1 0)) (= c10 c8)))
(assert (=> (not (= bn1 0)) (= bn10 bn8)))
(assert (=> (not (= bn1 0)) (= an10 an8)))
(assert (=> (= bn1 0) (= (mk_int__ref c9) (mk_int__ref c))))
(assert (=> (= bn1 0) (= bn1 bn9)))
(assert (=> (= bn1 0) (= an1 an9)))
(assert (=> (= bn1 0) (= c10 c1)))
(assert (=> (= bn1 0) (= bn10 bn1)))
(assert (=> (= bn1 0) (= an10 an1)))
(assert (= (divides an9 an9) true))
(assert (= (divides an9 a) true))
(assert (= (divides an9 b) true))
(assert (<= (+ an9 1) x1))
(assert (<= x1 (ite (< a b) a b)))
(assert (not (in_range2 x1)))
(check-sat)
(exit)
