...
(declare-const arithmetic__test_mod_b__result1 Int)
(declare-const arithmetic__test_mod_b__result2 Int)
(declare-const arithmetic__test_mod_b__result3 Int)
(declare-const arithmetic__test_mod_b__result4 Int)
(declare-const arithmetic__test_mod_b__result5 Int)
(assert (in_range n))
(assert (not (not (= (- 10) 0))))
(check-sat)
(exit)
