...
(assert (and (= o10 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2)))) (and (not (= (has_key o10 no_element) true)) (forall ((i12 us_rep1)) (=> (= (has_key o10 i12) true) (and (and (<= 1 (get1 o10 i12)) (<= (get1 o10 i12) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields2))))) (forall ((j1 us_rep1)) (=> (= (has_key o10 j1) true) (=> (= (get1 o10 i12) (get1 o10 j1)) (= (bool_eq1 i12 j1) true))))))))))
