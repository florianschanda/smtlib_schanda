...
(assert (and (= o1 (positions (mk___rep l__split_discrs l__split_fields2))) (and (not (= (has_key o1 no_element) true)) (forall ((i3 us_rep2)) (=> (= (has_key o1 i3) true) (and (and (<= 1 (get1 o1 i3)) (<= (get1 o1 i3) (length (mk___rep l__split_discrs l__split_fields2)))) (forall ((j us_rep2)) (=> (= (has_key o1 j) true) (=> (= (get1 o1 i3) (get1 o1 j)) (= (bool_eq2 i3 j) true))))))))))
(assert (not (= (has_key o1 (mk___rep1 cu__split_fields3)) true)))
(check-sat)
(exit)
