...
(assert (and (= o8 (* 2 i)) (in_range1 (* 2 i))))
(assert (= o9 (- o8 1)))
(assert (and (= o10 o9) (in_range1 o9)))
(assert (and (= o11 o10) (in_range3 o10)))
(assert (and (= o7 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2)))) (= (length1 o7) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields2))))))
(assert (and (= o13 (get o7 o11)) (in_range4 o13)))
(assert (= o14 (ite (= o13 o12) true false)))
(assert (and (= o5 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i)) (in_range4 o5)))
