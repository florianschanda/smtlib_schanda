...
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 n2)) (and (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) (* 2 i1)) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i1)) (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) (- (* 2 i1) 1)) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i1))))))
(assert (forall ((i1 Int)) (=> (and (<= (+ n2 1) i1) (<= i1 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))) (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) (+ i1 n2)) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i1)))))
...
(assert (<= 1 i))
(assert (<= i n2))
(assert (and (= o7 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i)) (in_range4 o7)))
(assert (and (= o3 (* 2 i)) (in_range1 (* 2 i))))
(assert (= o4 (- o3 1)))
(assert (and (= o5 o4) (in_range1 o4)))
(assert (and (= o6 o5) (in_range3 o5)))
(assert (and (= o2 (model__ (mk___rep l__split_discrs l__split_fields2))) (= (length1 o2) (length (mk___rep l__split_discrs l__split_fields2)))))
(assert (and (= o8 (get o2 o6)) (in_range4 o8)))
(assert (= o9 (ite (= o8 o7) true false)))
(assert (and (= o1 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i)) (in_range4 o1)))
(assert (and (= o (* 2 i)) (in_range1 (* 2 i))))
