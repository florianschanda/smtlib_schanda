...
(assert (<= 1 i9))
(assert (<= i9 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))))
(assert (not (= (get (model__ (mk___rep l__split_discrs (us_split_fields__content l__split_fields8))) i9) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i9))))
(check-sat)
(exit)
