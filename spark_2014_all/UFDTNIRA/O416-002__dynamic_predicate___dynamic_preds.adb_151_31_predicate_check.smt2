...
(assert (dynamic_invariant2 (mk___rep (mk___split_fields dynamic_preds__update_even_close_pair__x__fields dynamic_preds__update_even_close_pair__x__fields1)) true true true))
(assert (= result x__split_fields))
(assert (= result1 x__split_fields1))
(assert (= (mk___split_fields x__split_fields2 x__split_fields3) (mk___split_fields dynamic_preds__update_even_close_pair__x__fields dynamic_preds__update_even_close_pair__x__fields1)))
