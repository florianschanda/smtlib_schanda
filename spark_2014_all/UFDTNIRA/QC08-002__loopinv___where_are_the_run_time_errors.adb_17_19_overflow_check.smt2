...
(assert (= result2 y))
(assert (= y1 o))
(assert (=> (< x1 10) (= temp___156 y1)))
(assert (=> (< x1 10) (= temp___155 y1)))
(assert (=> (< x1 10) (= temp___154 x1)))
...
(assert (=> (< x1 10) (= x2 o2)))
(assert (=> (< x1 10) (= y3 (+ temp___156 (* 3 (- x3 2))))))
(assert (=> (< x1 10) (<= 3 x3)))
...
(assert (=> (< x1 10) (= y5 y3)))
(assert (=> (< x1 10) (= x5 x3)))
(assert (=> (< x1 10) (= (mk_int__ref y6) (mk_int__ref y4))))
(assert (=> (< x1 10) (= (mk_int__ref x6) (mk_int__ref x4))))
(assert (=> (< x1 10) (= y7 y5)))
(assert (=> (< x1 10) (= x7 x5)))
(assert (=> (not (< x1 10)) (= y1 y6)))
(assert (=> (not (< x1 10)) (= x1 x6)))
(assert (=> (not (< x1 10)) (= y7 y1)))
(assert (=> (not (< x1 10)) (= x7 x1)))
(assert (and (= o3 (* 3 k1)) (in_range (* 3 k1))))
(assert (= o4 (+ o3 100)))
(assert (and (= o5 o4) (in_range o4)))
(assert (= result5 (ite (< 43 o5) true false)))
(assert (= result5 true))
(assert (and (= o6 (+ y6 1)) (in_range (+ y6 1))))
(assert (= result6 y6))
(assert (= y8 o6))
(assert (not (in_range (- x6 y8))))
(check-sat)
(exit)
