...
(assert (= (mk___rep (mk___split_fields result10 result11)) (engine_values__content flight_manager__set_engine_speed__result5)))
(assert (not (< (- (+ position_x (to_rep (rec__flight_manager__engine_values__x_speed (us_split_fields1 (engine_values__content flight_manager__set_engine_speed__result5))))) target_x) (+ position_x (to_rep (rec__flight_manager__engine_values__x_speed (us_split_fields1 (engine_values__content flight_manager__set_engine_speed__result5))))))))
(check-sat)
(exit)
