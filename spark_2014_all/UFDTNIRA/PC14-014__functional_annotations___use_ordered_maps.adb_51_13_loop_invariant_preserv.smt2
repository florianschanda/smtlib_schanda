...
(define-fun temp___7251 () us_rep1 (mk___rep1 (mk___split_fields1 temp___725)))
...
(assert (let ((temp___733 (keys (mk___rep r__split_discrs r__split_fields4)))) (forall ((temp___732 Int)) (=> (and (in_range3 temp___732) (= (iter_has_element temp___733 temp___732) true)) (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields4)) 1))) (= (get temp___733 temp___732) (get (keys s) i))))))))
