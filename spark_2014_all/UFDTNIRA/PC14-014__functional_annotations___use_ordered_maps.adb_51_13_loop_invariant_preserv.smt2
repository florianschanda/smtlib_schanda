...
(assert (<= 1 i2))
(assert (<= i2 (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1)))
(assert (not (= (has_key (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) (get (keys s) i2)) true)))
(check-sat)
(exit)
