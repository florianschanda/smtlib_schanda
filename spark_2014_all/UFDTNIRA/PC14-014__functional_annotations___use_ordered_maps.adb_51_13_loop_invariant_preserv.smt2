...
(assert (let ((temp___690 (keys (mk___rep r__split_discrs r__split_fields4)))) (forall ((temp___689 Int)) (=> (and (in_range3 temp___689) (= (iter_has_element temp___690 temp___689) true)) (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields4)) 1))) (= (get temp___690 temp___689) (get (keys s) i))))))))
...
(assert (and (= temp___6821 (next s (mk___rep1 cu__split_fields4))) (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields4) no_element) false) (= (get1 (positions s) (mk___rep1 cu__split_fields4)) (length s)) true) true) (= (bool_eq1 temp___6821 no_element) true) (and (= (has_key1 (positions s) temp___6821) true) (= (get1 (positions s) temp___6821) (+ (get1 (positions s) (mk___rep1 cu__split_fields4)) 1))))))
