...
(assert (=> (= (mod1 k22 2) 0) (= (* p22 (power (* b22 b22) (div1 k22 2))) (power a2 n2))))
(assert (=> (= (mod1 k22 2) 0) (= result12 (mk_int__ref k22))))
(assert (=> (= (mod1 k22 2) 0) (= k23 (div1 k22 2))))
(assert (=> (= (mod1 k22 2) 0) (and (= o4 (* b22 b22)) (in_range1 (* b22 b22)))))
(assert (=> (= (mod1 k22 2) 0) (= result13 (mk_int__ref b22))))
(assert (=> (= (mod1 k22 2) 0) (= b23 o4)))
...
(assert (=> (not (= (mod1 k22 2) 0)) (and (= (* (* p22 b22) (power b22 (- k22 1))) (power a2 n2)) (<= 1 k22))))
(assert (=> (not (= (mod1 k22 2) 0)) (and (= o6 (- k22 1)) (in_range2 (- k22 1)))))
(assert (=> (not (= (mod1 k22 2) 0)) (= result14 (mk_int__ref k22))))
(assert (=> (not (= (mod1 k22 2) 0)) (= k24 o6)))
(assert (=> (not (= (mod1 k22 2) 0)) (and (= o7 (* b22 p22)) (in_range1 (* b22 p22)))))
(assert (=> (not (= (mod1 k22 2) 0)) (= result15 (mk_int__ref p22))))
(assert (=> (not (= (mod1 k22 2) 0)) (= p23 o7)))
...
(assert (= temp___1943 (mk_int__ref temp___1942)))
(assert (= k27 k25))
(assert (= b26 b24))
(assert (= p26 p24))
(assert (= temp___1944 temp___1942))
(assert (= k28 k26))
(assert (= b27 b25))
(assert (= p27 p25))
(assert (not (= (power a2 n2) (* (int__content p26) (power (int__content b26) (int__content k27))))))
(check-sat)
(exit)
