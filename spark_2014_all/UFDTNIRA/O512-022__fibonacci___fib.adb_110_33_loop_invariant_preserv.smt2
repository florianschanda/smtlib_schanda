...
(assert (=> (= (mod1 k22 2) 0) (and (= o3 (* b22 b22)) (in_range1 (* b22 b22)))))
...
(assert (=> (not (= (mod1 k22 2) 0)) (and (= o4 (- k22 1)) (in_range2 (- k22 1)))))
(assert (=> (not (= (mod1 k22 2) 0)) (= result14 (mk_int__ref k22))))
(assert (=> (not (= (mod1 k22 2) 0)) (= k24 o4)))
(assert (=> (not (= (mod1 k22 2) 0)) (and (= o5 (* b22 p22)) (in_range1 (* b22 p22)))))
