...
(assert (=> (= result2 true) (forall ((i Int)) (=> (and (<= 1 i) (<= i n2)) (and (= (get (elements (mk___rep s__split_discrs s__split_fields2)) (* 2 i)) (+ (get temp___794 i) 1)) (= (get (elements (mk___rep s__split_discrs s__split_fields2)) (- (* 2 i) 1)) (get temp___795 i)))))))
(assert (=> (= result2 true) (forall ((i Int)) (=> (and (<= (+ (* 2 n2) 1) i) (<= i (length (mk___rep s__split_discrs s__split_fields2)))) (= (get (elements (mk___rep s__split_discrs s__split_fields2)) i) (get temp___796 (- i n2)))))))
(assert (=> (= result2 true) (forall ((i Int)) (=> (and (<= (+ n2 1) i) (<= i temp___797)) (= (get (elements (mk___rep s__split_discrs s__split_fields2)) (+ i n2)) (get temp___798 i))))))
...
(assert (=> (= result2 true) (and (= o7 (next (mk___rep s__split_discrs s__split_fields3) (mk___rep1 cu__split_fields2))) (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields2) no_element) false) (= (get1 (positions (mk___rep s__split_discrs s__split_fields3)) (mk___rep1 cu__split_fields2)) (length (mk___rep s__split_discrs s__split_fields3))) true) true) (= (bool_eq1 o7 no_element) true) (and (= (has_key (positions (mk___rep s__split_discrs s__split_fields3)) o7) true) (= (get1 (positions (mk___rep s__split_discrs s__split_fields3)) o7) (+ (get1 (positions (mk___rep s__split_discrs s__split_fields3)) (mk___rep1 cu__split_fields2)) 1)))))))
(assert (=> (= result2 true) (and (= temp___7891 (next (mk___rep s__split_discrs s__split_fields3) o7)) (ite (= (ite (= (bool_eq1 o7 no_element) false) (= (get1 (positions (mk___rep s__split_discrs s__split_fields3)) o7) (length (mk___rep s__split_discrs s__split_fields3))) true) true) (= (bool_eq1 temp___7891 no_element) true) (and (= (has_key (positions (mk___rep s__split_discrs s__split_fields3)) temp___7891) true) (= (get1 (positions (mk___rep s__split_discrs s__split_fields3)) temp___7891) (+ (get1 (positions (mk___rep s__split_discrs s__split_fields3)) o7) 1)))))))
...
(assert (not (in_range1 (* 2 (length (mk___rep s__split_discrs (mk___split_fields s__split_fields)))))))
(check-sat)
(exit)
