...
(assert (= (= o70 true) (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 (length (mk___rep s__split_discrs (mk___split_fields s__split_fields))))) (and (= (get (elements (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))) (- (* 2 i4) 1)) (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) i4)) (= (get (elements (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))) (* 2 i4)) (+ (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) i4) 1)))))))
