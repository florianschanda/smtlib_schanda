...
(assert (not (= bn1 0)))
(assert (and (and (and (not (= an2 (- 2147483648))) (not (= bn2 (- 2147483648)))) (or (<= (abs an2) (abs a)) (<= (abs an2) (abs b)))) (or (<= (abs bn2) (abs a)) (<= (abs bn2) (abs b)))))
(assert (and (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 ao2)) (=> (<= (- 2147483648) 2147483647) (in_range1 an2))) (=> (<= (- 2147483648) 2147483647) (in_range1 bn2))) (not (= bn2 0))))
(assert (=> (and (not (= an2 (- 2147483648))) (not (= bn2 (- 2147483648)))) (and (= o6 (abs a)) (in_range1 (abs a)))))
(assert (=> (and (not (= an2 (- 2147483648))) (not (= bn2 (- 2147483648)))) (and (= o7 (abs an2)) (in_range1 (abs an2)))))
(assert (=> (and (not (= an2 (- 2147483648))) (not (= bn2 (- 2147483648)))) (= result3 (ite (<= o7 o6) true false))))
(assert (=> (and (not (= an2 (- 2147483648))) (not (= bn2 (- 2147483648)))) (=> (= result3 true) (= result2 true))))
(assert (=> (and (not (= an2 (- 2147483648))) (not (= bn2 (- 2147483648)))) (=> (not (= result3 true)) (and (= o4 (abs b)) (in_range1 (abs b))))))
(assert (=> (and (not (= an2 (- 2147483648))) (not (= bn2 (- 2147483648)))) (=> (not (= result3 true)) (and (= o5 (abs an2)) (in_range1 (abs an2))))))
(assert (=> (and (not (= an2 (- 2147483648))) (not (= bn2 (- 2147483648)))) (=> (not (= result3 true)) (= result2 (ite (<= o5 o4) true false)))))
(assert (=> (not (and (not (= an2 (- 2147483648))) (not (= bn2 (- 2147483648))))) (= result2 false)))
(assert (= result2 true))
(assert (not (in_range1 (abs a))))
(check-sat)
(exit)
