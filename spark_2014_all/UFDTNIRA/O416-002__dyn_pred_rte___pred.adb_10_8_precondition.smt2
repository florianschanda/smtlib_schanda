...
(define-fun dynamic_invariant2 ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (and (=> (or (= temp___is_init_133 true) (<= first last)) (dynamic_property first last temp___expr_136)) (=> (= temp___do_toplevel_135 true) (=> (= temp___is_init_133 true) (= (prop__ temp___expr_136) true)))))
