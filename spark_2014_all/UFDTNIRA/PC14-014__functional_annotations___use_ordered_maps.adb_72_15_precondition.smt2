...
(assert (and (= o1 (get2 o (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range6 o1) (=> (= (of_int 0) true) (and (= o1 (w_get1 o (witness1 o (mk___rep1 (mk___split_fields1 cu__split_fields2))))) (forall ((k2 us_rep1)) (=> (= (has_key1 o k2) true) (= (= (bool_eq1 k2 (mk___rep1 (mk___split_fields1 cu__split_fields2))) true) (= (witness1 o (mk___rep1 (mk___split_fields1 cu__split_fields2))) (witness1 o k2))))))))))
(assert (= o2 (- o1 1)))
(assert (= o3 (ite (<= i o2) true false)))
(assert (= result2 (ite (<= 1 i) o3 false)))
(assert (= result2 true))
(assert (and (= o6 (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields2)))) (and (and (and (= (length3 o6) (length (mk___rep s__split_discrs (mk___split_fields s__split_fields2)))) (forall ((temp___396 Int)) (=> (and (in_range4 temp___396) (= (iter_has_element o6 temp___396) true)) (= (has_key (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) (get1 o6 temp___396)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) key2) true)) (and (< 0 (find o6 key2)) (= (equivalent_keys (get1 o6 (find o6 key2)) key2) true))))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length (mk___rep s__split_discrs (mk___split_fields s__split_fields2))))) (and (= (find o6 (get1 o6 i2)) i2) (= (k_is_find o6 (get1 o6 i2) i2) true)))))))
(assert (and (= o7 (get1 o6 i)) (in_range5 o7)))
(assert (and (= o8 (get (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) o7)) (and (in_range3 o8) (=> (= (of_int 1) true) (and (= o8 (w_get (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (witness (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) o7))) (forall ((k2 Int)) (=> (and (in_range2 k2) (= (has_key (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) k2) true)) (= (= (equivalent_keys k2 o7) true) (= (witness (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) o7) (witness (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) k2))))))))))
(assert (and (= o9 (f o8)) (and (in_range9 o9) (= o9 (ite (and (<= (- 100) o8) (<= o8 100)) (* o8 2) o8)))))
(assert (and (= o4 (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields2)))) (and (and (and (= (length3 o4) (length (mk___rep s__split_discrs (mk___split_fields s__split_fields2)))) (forall ((temp___396 Int)) (=> (and (in_range4 temp___396) (= (iter_has_element o4 temp___396) true)) (= (has_key (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) (get1 o4 temp___396)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) key2) true)) (and (< 0 (find o4 key2)) (= (equivalent_keys (get1 o4 (find o4 key2)) key2) true))))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length (mk___rep s__split_discrs (mk___split_fields s__split_fields2))))) (and (= (find o4 (get1 o4 i2)) i2) (= (k_is_find o4 (get1 o4 i2) i2) true)))))))
(assert (and (= o5 (get1 o4 i)) (in_range5 o5)))
(assert (not (= (has_key (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) o5) true)))
(check-sat)
(exit)
