...
(assert (and (= temp___697 (keys s)) (and (and (and (= (length3 temp___697) (length s)) (forall ((temp___396 Int)) (=> (and (in_range3 temp___396) (= (iter_has_element temp___697 temp___396) true)) (= (has_key (model__ s) (get temp___697 temp___396)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true)) (and (< 0 (find temp___697 key2)) (= (equivalent_keys (get temp___697 (find temp___697 key2)) key2) true))))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length s))) (and (= (find temp___697 (get temp___697 i2)) i2) (= (k_is_find temp___697 (get temp___697 i2) i2) true)))))))
(assert (and (= o30 (iter_has_element temp___697 temp___696)) (= (= o30 true) (and (<= 1 temp___696) (<= temp___696 (last temp___697))))))
(assert (= (= o31 true) (in_range3 temp___696)))
(assert (= result8 (ite (= o31 true) o30 false)))
(assert (= result8 true))
(assert (and (= k2 (get temp___697 temp___696)) (in_range4 k2)))
(assert (= o35 (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7)))))
(assert (and (= result9 (has_key o35 k2)) (=> (= (of_int 1) true) (=> (exists ((k3 Int)) (and (and (in_range2 k3) (= (has_key o35 k3) true)) (= (equivalent_keys k3 k2) true))) (= result9 true)))))
(assert (= result9 true))
