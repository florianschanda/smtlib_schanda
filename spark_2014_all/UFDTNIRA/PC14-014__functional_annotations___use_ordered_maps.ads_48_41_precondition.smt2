...
(assert (=> (= result1 true) (let ((temp___690 (keys (mk___rep r__split_discrs r__split_fields10)))) (forall ((temp___689 Int)) (=> (and (in_range3 temp___689) (= (iter_has_element temp___690 temp___689) true)) (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields10)) 1))) (= (get temp___690 temp___689) (get (keys s) i)))))))))
...
(assert (=> (= result1 true) (and (= temp___6821 (next s (mk___rep1 cu__split_fields10))) (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields10) no_element) false) (= (get1 (positions s) (mk___rep1 cu__split_fields10)) (length s)) true) true) (= (bool_eq1 temp___6821 no_element) true) (and (= (has_key1 (positions s) temp___6821) true) (= (get1 (positions s) temp___6821) (+ (get1 (positions s) (mk___rep1 cu__split_fields10)) 1)))))))
...
(assert (and (= temp___697 (keys s)) (and (and (and (= (length3 temp___697) (length s)) (forall ((temp___396 Int)) (=> (and (in_range3 temp___396) (= (iter_has_element temp___697 temp___396) true)) (= (has_key (model__ s) (get temp___697 temp___396)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true)) (and (< 0 (find temp___697 key2)) (= (equivalent_keys (get temp___697 (find temp___697 key2)) key2) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length s))) (and (= (find temp___697 (get temp___697 i)) i) (= (k_is_find temp___697 (get temp___697 i) i) true)))))))
(assert (and (= o4 (iter_has_element temp___697 temp___696)) (= (= o4 true) (and (<= 1 temp___696) (<= temp___696 (last temp___697))))))
...
(assert (and (= result5 (has_key o6 k)) (=> (= (of_int 1) true) (=> (exists ((k1 Int)) (and (and (in_range2 k1) (= (has_key o6 k1) true)) (= (equivalent_keys k1 k) true))) (= result5 true)))))
(assert (= result5 true))
