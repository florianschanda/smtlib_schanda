...
(assert (= delta_y1 o3))
(assert (and (= o7 (* (to_rep1 (rec__shapes4__circle__radius (us_split_fields1 c))) (to_rep1 (rec__shapes4__circle__radius (us_split_fields1 c))))) (in_range (* (to_rep1 (rec__shapes4__circle__radius (us_split_fields1 c))) (to_rep1 (rec__shapes4__circle__radius (us_split_fields1 c)))))))
(assert (and (= o8 o7) (in_range3 o7)))
(assert (and (= o4 (* delta_y1 delta_y1)) (in_range (* delta_y1 delta_y1))))
(assert (and (= o5 (* delta_x1 delta_x1)) (in_range (* delta_x1 delta_x1))))
(assert (= o6 (+ o5 o4)))
