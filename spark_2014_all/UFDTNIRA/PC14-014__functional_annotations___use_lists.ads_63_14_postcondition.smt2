...
(assert (not (= (get (model__ (mk___rep l__split_discrs (us_split_fields__content l__split_fields8))) (- (* 2 i) 1)) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i))))
(check-sat)
(exit)
