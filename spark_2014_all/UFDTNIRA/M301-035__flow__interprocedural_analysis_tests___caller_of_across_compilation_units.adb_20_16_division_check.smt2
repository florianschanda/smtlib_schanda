...
(assert (forall ((x Int) (y Int)) (! (=> (and (dynamic_invariant x true true true) (dynamic_invariant y true true true)) (dynamic_invariant (min x y) true false true)) :pattern ((min x y)))))
(declare-const x Int)
