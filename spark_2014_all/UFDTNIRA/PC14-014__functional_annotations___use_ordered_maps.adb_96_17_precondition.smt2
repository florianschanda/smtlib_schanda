...
(define-fun s__split_fields2 () us_split_fields (mk___split_fields s__split_fields1))
(define-fun cu__split_fields4 () us_split_fields2 (mk___split_fields1 cu__split_fields1))
(define-fun use_ordered_maps__apply_f_4__cu__assume1 () us_rep1 (mk___rep1 (mk___split_fields1 use_ordered_maps__apply_f_4__cu__assume)))
(assert (and (= use_ordered_maps__apply_f_4__cu__assume1 (first (mk___rep s__split_discrs (mk___split_fields s__split_fields)))) (ite (= (= (length (mk___rep s__split_discrs (mk___split_fields s__split_fields))) 0) true) (= (bool_eq1 use_ordered_maps__apply_f_4__cu__assume1 no_element) true) (and (= (has_key1 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields))) use_ordered_maps__apply_f_4__cu__assume1) true) (= (get2 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields))) use_ordered_maps__apply_f_4__cu__assume1) 1)))))
...
(assert (and (= result1 (has_key1 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (mk___rep1 cu__split_fields4))) (= (= result1 true) (= (has_key1 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (mk___rep1 cu__split_fields4)) true))))
(assert (= result1 true))
(assert (= (oeq3 (positions (mk___rep s__split_discrs s__split_fields2)) (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields)))) true))
(assert (= (oeq2 (keys (mk___rep s__split_discrs s__split_fields2)) (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields)))) true))
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (- (get2 (positions (mk___rep s__split_discrs s__split_fields2)) (mk___rep1 cu__split_fields3)) 1))) (= (get (model__ (mk___rep s__split_discrs s__split_fields2)) (get1 (keys (mk___rep s__split_discrs s__split_fields2)) i1)) (f (get (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (get1 (keys (mk___rep s__split_discrs s__split_fields2)) i1)))))))
(assert (forall ((i1 Int)) (=> (and (<= (get2 (positions (mk___rep s__split_discrs s__split_fields2)) (mk___rep1 cu__split_fields3)) i1) (<= i1 (length (mk___rep s__split_discrs s__split_fields2)))) (= (get (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (get1 (keys (mk___rep s__split_discrs s__split_fields2)) i1)) (get (model__ (mk___rep s__split_discrs s__split_fields2)) (get1 (keys (mk___rep s__split_discrs s__split_fields2)) i1))))))
(assert (and (= o2 (length (mk___rep s__split_discrs s__split_fields2))) (and (in_range1 o2) (<= o2 (to_rep (rec__use_ordered_maps__my_maps__map__capacity s__split_discrs))))))
(assert (= o3 (ite (<= i o2) true false)))
(assert (and (= o (positions (mk___rep s__split_discrs s__split_fields2))) (and (not (= (has_key1 o no_element) true)) (forall ((i1 us_rep1)) (=> (= (has_key1 o i1) true) (and (and (<= 1 (get2 o i1)) (<= (get2 o i1) (length (mk___rep s__split_discrs s__split_fields2)))) (forall ((j us_rep1)) (=> (= (has_key1 o j) true) (=> (= (get2 o i1) (get2 o j)) (= (bool_eq1 i1 j) true))))))))))
(assert (and (= o1 (get2 o (mk___rep1 cu__split_fields3))) (and (in_range6 o1) (=> (= (of_int 0) true) (and (= o1 (w_get1 o (witness1 o (mk___rep1 cu__split_fields3)))) (forall ((k us_rep1)) (=> (= (has_key1 o k) true) (= (= (bool_eq1 k (mk___rep1 cu__split_fields3)) true) (= (witness1 o (mk___rep1 cu__split_fields3)) (witness1 o k))))))))))
(assert (= o4 (ite (<= o1 i) true false)))
(assert (= result2 (ite (= o4 true) o3 false)))
(assert (= result2 true))
(assert (and (= o6 i) (in_range4 i)))
(assert (and (= o5 (keys (mk___rep s__split_discrs s__split_fields2))) (and (and (and (= (length3 o5) (length (mk___rep s__split_discrs s__split_fields2))) (forall ((temp___396 Int)) (=> (and (in_range4 temp___396) (= (iter_has_element o5 temp___396) true)) (= (has_key (model__ (mk___rep s__split_discrs s__split_fields2)) (get1 o5 temp___396)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ (mk___rep s__split_discrs s__split_fields2)) key2) true)) (and (< 0 (find o5 key2)) (= (equivalent_keys (get1 o5 (find o5 key2)) key2) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep s__split_discrs s__split_fields2)))) (and (= (find o5 (get1 o5 i1)) i1) (= (k_is_find o5 (get1 o5 i1) i1) true)))))))
(assert (and (= o7 (get1 o5 o6)) (in_range5 o7)))
(assert (not (= (has_key (model__ (mk___rep s__split_discrs s__split_fields2)) o7) true)))
(check-sat)
(exit)
