...
(assert (and (= o13 (length (mk___rep s__split_discrs (mk___split_fields s__split_fields2)))) (and (in_range1 o13) (<= o13 (to_rep (rec__use_ordered_maps__my_maps__map__capacity s__split_discrs))))))
(assert (= o14 (ite (<= i1 o13) true false)))
(assert (and (= o11 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields2)))) (and (not (= (has_key1 o11 no_element) true)) (forall ((i2 us_rep1)) (=> (= (has_key1 o11 i2) true) (and (and (<= 1 (get2 o11 i2)) (<= (get2 o11 i2) (length (mk___rep s__split_discrs (mk___split_fields s__split_fields2))))) (forall ((j us_rep1)) (=> (= (has_key1 o11 j) true) (=> (= (get2 o11 i2) (get2 o11 j)) (= (bool_eq1 i2 j) true))))))))))
(assert (and (= o12 (get2 o11 (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range6 o12) (=> (= (of_int 0) true) (and (= o12 (w_get1 o11 (witness1 o11 (mk___rep1 (mk___split_fields1 cu__split_fields2))))) (forall ((k1 us_rep1)) (=> (= (has_key1 o11 k1) true) (= (= (bool_eq1 k1 (mk___rep1 (mk___split_fields1 cu__split_fields2))) true) (= (witness1 o11 (mk___rep1 (mk___split_fields1 cu__split_fields2))) (witness1 o11 k1))))))))))
(assert (= o15 (ite (<= o12 i1) true false)))
(assert (= result3 (ite (= o15 true) o14 false)))
(assert (= result3 true))
(assert (and (= o20 i1) (in_range4 i1)))
(assert (and (= o19 (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields2)))) (and (and (and (= (length3 o19) (length (mk___rep s__split_discrs (mk___split_fields s__split_fields2)))) (forall ((temp___396 Int)) (=> (and (in_range4 temp___396) (= (iter_has_element o19 temp___396) true)) (= (has_key (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) (get1 o19 temp___396)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) key2) true)) (and (< 0 (find o19 key2)) (= (equivalent_keys (get1 o19 (find o19 key2)) key2) true))))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length (mk___rep s__split_discrs (mk___split_fields s__split_fields2))))) (and (= (find o19 (get1 o19 i2)) i2) (= (k_is_find o19 (get1 o19 i2) i2) true)))))))
(assert (and (= o21 (get1 o19 o20)) (in_range5 o21)))
(assert (not (= (has_key (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) o21) true)))
(check-sat)
(exit)
