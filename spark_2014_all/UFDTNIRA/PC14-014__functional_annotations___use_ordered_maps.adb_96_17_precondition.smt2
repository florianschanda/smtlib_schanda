...
(assert (forall ((container us_rep2)) (forall ((key Int)) (! (=> (and (dynamic_invariant1 key true true true true) (= (has_key container key) true)) (let ((result (get container key))) (and (=> (= (distinct 1 0) true) (and (= result (w_get container (witness container key))) (forall ((k Int)) (=> (and (in_range2 k) (= (has_key container k) true)) (= (= (equivalent_keys k key) true) (= (witness container key) (witness container k))))))) (dynamic_invariant2 result true false true true)))) :pattern ((get container key))))))
...
(define-fun dynamic_invariant3 ((temp___expr_389 Int) (temp___is_init_385 Bool) (temp___skip_constant_386 Bool) (temp___do_toplevel_387 Bool) (temp___do_typ_inv_388 Bool)) Bool (=> (or (= temp___is_init_385 true) (<= 1 2147483647)) (in_range5 temp___expr_389)))
(define-fun dynamic_invariant4 ((temp___expr_396 Int) (temp___is_init_392 Bool) (temp___skip_constant_393 Bool) (temp___do_toplevel_394 Bool) (temp___do_typ_inv_395 Bool)) Bool (=> (or (= temp___is_init_392 true) (<= 0 2147483647)) (in_range4 temp___expr_396)))
...
(assert (forall ((container us_rep)) (! (let ((result (keys container))) (and (and (and (= (length3 result) (length container)) (forall ((temp___442 Int)) (=> (and (in_range4 temp___442) (= (iter_has_element result temp___442) true)) (= (has_key (model__ container) (get1 result temp___442)) true)))) (forall ((key Int)) (=> (and (in_range2 key) (= (has_key (model__ container) key) true)) (and (< 0 (find result key)) (= (equivalent_keys (get1 result (find result key)) key) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (and (= (find result (get1 result i)) i) (= (k_is_find result (get1 result i) i) true)))))) :pattern ((keys container)))))
...
(assert true)
(assert true)
(assert (forall ((container us_rep2)) (forall ((key2 Int)) (! (=> (dynamic_invariant1 key2 true true true true) (=> (= (distinct 1 0) true) (=> (exists ((k Int)) (and (and (in_range2 k) (= (has_key container k) true)) (= (equivalent_keys k key2) true))) (= (has_key container key2) true)))) :pattern ((has_key container key2))))))
...
(assert (and (= o1 (get2 o (mk___rep1 cu__split_fields3))) (and (in_range6 o1) (=> (= (distinct 0 0) true) (and (= o1 (w_get1 o (witness1 o (mk___rep1 cu__split_fields3)))) (forall ((k us_rep1)) (=> (= (has_key1 o k) true) (= (= (bool_eq1 k (mk___rep1 cu__split_fields3)) true) (= (witness1 o (mk___rep1 cu__split_fields3)) (witness1 o k))))))))))
(assert (= o4 (ite (<= o1 i) true false)))
(assert (= result2 (ite (= o4 true) o3 false)))
(assert (= result2 true))
(assert (and (= o6 i) (in_range4 i)))
(assert (and (= o5 (keys (mk___rep s__split_discrs s__split_fields2))) (and (and (and (= (length3 o5) (length (mk___rep s__split_discrs s__split_fields2))) (forall ((temp___439 Int)) (=> (and (in_range4 temp___439) (= (iter_has_element o5 temp___439) true)) (= (has_key (model__ (mk___rep s__split_discrs s__split_fields2)) (get1 o5 temp___439)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ (mk___rep s__split_discrs s__split_fields2)) key2) true)) (and (< 0 (find o5 key2)) (= (equivalent_keys (get1 o5 (find o5 key2)) key2) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep s__split_discrs s__split_fields2)))) (and (= (find o5 (get1 o5 i1)) i1) (= (k_is_find o5 (get1 o5 i1) i1) true)))))))
