...
(assert (in_range3 sc))
(assert (and (= o5 (* 3 9223372036)) (in_range2 (* 3 9223372036))))
(assert (= o6 (ite (<= sc o5) true false)))
(assert (and (= o4 (* 3 (- 9223372036))) (in_range2 (* 3 (- 9223372036)))))
(assert (= o7 (ite (<= o4 sc) true false)))
(assert (= result (ite (= o7 true) o6 false)))
(assert (= result true))
(assert (and (= o1 (+ 9223372036 1)) (in_range2 (+ 9223372036 1))))
(assert (and (= o2 (result_sc sc ts)) (and (in_range3 o2) (= o2 (+ sc (ts_sc ts))))))
