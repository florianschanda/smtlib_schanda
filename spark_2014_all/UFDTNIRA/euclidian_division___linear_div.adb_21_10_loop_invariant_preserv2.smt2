...
(assert (and (and (<= 0 remainder2) (<= 0 quotient2)) (= (+ (* divisor quotient2) remainder2) dividend)))
(assert (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 quotient2)) (=> (<= (- 2147483648) 2147483647) (in_range1 remainder2))) (<= divisor remainder2)))
(assert (and (= o (+ quotient2 1)) (in_range1 (+ quotient2 1))))
(assert (= quotient2 result2))
(assert (= quotient3 o))
(assert (and (= o1 (- remainder2 divisor)) (in_range1 (- remainder2 divisor))))
(assert (= remainder2 result3))
(assert (= remainder3 o1))
(assert (<= divisor remainder3))
(assert (not (<= 0 remainder3)))
(check-sat)
(exit)
