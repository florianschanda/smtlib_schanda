...
(assert (not (or (< (length (mk___rep s__split_discrs s__split_fields2)) (to_rep (rec__use_ordered_sets__my_sets__set__capacity s__split_discrs))) (= (contains (model__ (mk___rep s__split_discrs s__split_fields2)) o50) true))))
(check-sat)
(exit)
