...
(assert (and (= temp___284 (+ above 1)) (in_range (+ above 1))))
(assert (= (mod2 temp___284 2) 0))
(assert (= o4 temp___284))
(assert (= (to_rep o5) o4))
(assert (= o5 o6))
(assert (= result____split_fields1 o7))
(assert (= temp___287 o6))
(assert (= temp___2871 o7))
(assert (not (= (to_rep temp___2871) (+ (to_rep temp___287) 2))))
(check-sat)
(exit)
