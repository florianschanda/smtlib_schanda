...
(assert (= o17 (+ o16 o15)))
(assert (and (= o18 o17) (in_range5 o17)))
(assert (and (= o19 o18) (in_range6 o18)))
(assert (= (to_rep3 o20) o19))
(assert (and (= o10 day) (in_range4 day)))
(assert (= (to_rep2 o21) o10))
(assert (and (= o9 month) (in_range3 month)))
(assert (= (to_rep1 o22) o9))
