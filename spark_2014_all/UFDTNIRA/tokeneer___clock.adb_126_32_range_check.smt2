...
(declare-const o11 millisecst)
(declare-const o12 dayst)
(declare-const o13 monthst)
...
(assert (<= 0 min))
(assert (<= min 59))
(assert (and (= o4 min) (in_range4 min)))
(assert (= o5 (* o4 60000)))
(assert (and (= o6 o5) (in_range6 o5)))
(assert (and (= o2 hour) (in_range4 hour)))
(assert (= o3 (* o2 3600000)))
(assert (and (= o7 o3) (in_range6 o3)))
(assert (= o8 (+ o7 o6)))
(assert (and (= o9 o8) (in_range6 o8)))
(assert (and (= o10 o9) (in_range4 o9)))
(assert (= (to_rep3 o11) o10))
(assert (and (= o1 day) (in_range3 day)))
(assert (= (to_rep2 o12) o1))
(assert (and (= o month) (in_range2 month)))
(assert (= (to_rep1 o13) o))
(assert (not (in_range1 year)))
(check-sat)
(exit)
