...
(declare-const o19 millisecst)
(declare-const o20 dayst)
(declare-const o21 monthst)
(assert (= (to_rep3 o) 0))
(assert (= (to_rep2 o1) 1))
(assert (= (to_rep1 o2) 1))
...
(assert (<= 0 min))
(assert (<= min 59))
(assert (and (= o12 min) (in_range6 min)))
(assert (= o13 (* o12 60000)))
(assert (and (= o14 o13) (in_range5 o13)))
(assert (and (= o10 hour) (in_range6 hour)))
(assert (= o11 (* o10 3600000)))
(assert (and (= o15 o11) (in_range5 o11)))
(assert (= o16 (+ o15 o14)))
(assert (and (= o17 o16) (in_range5 o16)))
(assert (and (= o18 o17) (in_range6 o17)))
(assert (= (to_rep3 o19) o18))
(assert (and (= o9 day) (in_range4 day)))
(assert (= (to_rep2 o20) o9))
(assert (and (= o8 month) (in_range3 month)))
(assert (= (to_rep1 o21) o8))
(assert (not (in_range2 year)))
(check-sat)
(exit)
