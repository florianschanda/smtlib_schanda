...
(assert (<= first i1))
(assert (<= i1 r17b))
(assert (= (length (mk___rep v__split_discrs v__split_fields4)) (+ (length (mk___rep v__split_discrs (mk___split_fields v__split_fields))) (- i2 first))))
(assert (forall ((j Int)) (=> (and (<= first j) (<= j (last5 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields)))))) (= (get (model__ (mk___rep v__split_discrs v__split_fields4)) j) (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) j)))))
(assert (forall ((j Int)) (=> (and (<= first j) (<= j (- i2 1))) (= (get (model__ (mk___rep v__split_discrs v__split_fields4)) (+ j (length (mk___rep v__split_discrs (mk___split_fields v__split_fields))))) (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) j)))))
(assert (and (and (dynamic_property2 0 last2 (to_rep1 (rec__use_vectors__my_vectors__vector__capacity v__split_discrs))) (=> (<= first r17b) (dynamic_property6 first r17b i2))) (and (<= first i2) (<= i2 r17b))))
(assert (and (= us i2) (dynamic_property1 first1 last1 i2)))
(assert (= o1 i2))
(assert (and (= o2 (get (model__ (mk___rep v__split_discrs v__split_fields4)) o1)) (and (in_range4 o2) (= o2 (get (model__ (mk___rep v__split_discrs v__split_fields4)) o1)))))
(assert (and (and (and (= (length (mk___rep v__split_discrs v__split_fields3)) (+ (length (mk___rep v__split_discrs v__split_fields4)) 1)) (= (olt (model__ (mk___rep v__split_discrs v__split_fields4)) (model__ (mk___rep v__split_discrs v__split_fields3))) true)) (= (get (model__ (mk___rep v__split_discrs v__split_fields3)) (+ (last5 (model__ (mk___rep v__split_discrs v__split_fields4))) 1)) o2)) (dynamic_property2 0 last2 (to_rep1 (rec__use_vectors__my_vectors__vector__capacity v__split_discrs)))))
(assert (not (= i2 r17b)))
(assert (= result2 i2))
(assert (= i3 (+ i2 1)))
(declare-const j Int)
...
(assert (not (= (get (model__ (mk___rep v__split_discrs v__split_fields3)) j) (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) j))))
(check-sat)
(exit)
