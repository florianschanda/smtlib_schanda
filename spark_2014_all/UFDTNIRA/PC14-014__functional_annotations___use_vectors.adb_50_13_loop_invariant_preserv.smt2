...
(assert (and (= us4 i3) (dynamic_property1 first1 last1 i3)))
(assert (= o17 i3))
(assert (and (= o18 (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields2))) o17)) (and (in_range4 o18) (= o18 (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields2))) o17)))))
...
(assert (<= first j2))
(assert (<= j2 (last5 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))))))
(assert (not (= (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields3))) j2) (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) j2))))
(check-sat)
(exit)
