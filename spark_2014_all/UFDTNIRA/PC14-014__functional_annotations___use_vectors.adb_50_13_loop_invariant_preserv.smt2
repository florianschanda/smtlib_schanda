...
(assert (<= first4 i1))
(assert (<= i1 r17b))
(assert (= (length (mk___rep v__split_discrs v__split_fields4)) (+ (length (mk___rep v__split_discrs (mk___split_fields v__split_fields))) (- i2 first4))))
(assert (forall ((j Int)) (=> (and (<= first4 j) (<= j (last2 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields)))))) (= (get (model__ (mk___rep v__split_discrs v__split_fields4)) j) (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) j)))))
(assert (forall ((j Int)) (=> (and (<= first4 j) (<= j (- i2 1))) (= (get (model__ (mk___rep v__split_discrs v__split_fields4)) (+ j (length (mk___rep v__split_discrs (mk___split_fields v__split_fields))))) (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) j)))))
...
(assert (and (= us i2) (dynamic_property3 first2 last4 i2)))
(assert (= o1 i2))
