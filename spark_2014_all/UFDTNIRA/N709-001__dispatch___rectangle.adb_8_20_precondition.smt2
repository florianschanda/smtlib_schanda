...
(assert (=> (= result true) (and (= (has_stored_area (mk___rep (mk___split_fields object__set_area__obj__fields object__set_area__obj__fields1 object__set_area__obj__fields2 object__set_area__obj__fields3) rec____attr__tag)) true) (= o2 (get_stored_area (mk___rep (mk___split_fields object__set_area__obj__fields object__set_area__obj__fields1 object__set_area__obj__fields2 object__set_area__obj__fields3) rec____attr__tag))))))
...
(assert (=> (= result true) (= (mk___split_fields1 rec____split_fields12 rec____split_fields13 rec____split_fields14 rec____split_fields15 rec____split_fields16 rec____split_fields17) (us_split_fields3 (of_base (mk___rep (mk___split_fields object__set_area__obj__fields object__set_area__obj__fields1 object__set_area__obj__fields2 object__set_area__obj__fields3) rec____attr__tag))))))
...
(assert (=> (not (= result true)) (= (mk___split_fields1 rec____split_fields12 rec____split_fields13 rec____split_fields14 rec____split_fields15 rec____split_fields16 rec____split_fields17) (mk___split_fields1 rec____split_fields6 rec____split_fields7 rec____split_fields8 rec____split_fields9 rec____split_fields10 rec____split_fields11))))
