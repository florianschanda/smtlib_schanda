...
(assert (and (= temp___806 (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields)))) (and (and (and (= (length2 temp___806) (length (mk___rep s__split_discrs (mk___split_fields s__split_fields)))) (forall ((temp___390 Int)) (=> (and (in_range4 temp___390) (= (iter_has_element temp___806 temp___390) true)) (= (contains (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (get temp___806 temp___390)) true)))) (forall ((item Int)) (=> (and (in_range7 item) (= (contains (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) item) true)) (and (< 0 (find temp___806 item)) (= (equivalent_elements (get temp___806 (find temp___806 item)) item) true))))) (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 (length (mk___rep s__split_discrs (mk___split_fields s__split_fields))))) (and (= (find temp___806 (get temp___806 i4)) i4) (= (e_is_find temp___806 (get temp___806 i4) i4) true)))))))
(assert (and (= o1 (iter_has_element temp___806 temp___805)) (= (= o1 true) (and (<= 1 temp___805) (<= temp___805 (last temp___806))))))
(assert (= (= o2 true) (in_range4 temp___805)))
