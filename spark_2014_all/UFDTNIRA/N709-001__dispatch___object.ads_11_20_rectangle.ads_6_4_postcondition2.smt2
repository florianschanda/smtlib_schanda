...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (and (= (to_rep1 (rec__object__t__area (us_split_fields1 a))) (to_rep1 (rec__object__t__area (us_split_fields1 b)))) (= (to_rep1 (rec__object__t__max_width (us_split_fields1 a))) (to_rep1 (rec__object__t__max_width (us_split_fields1 b))))) (= (to_rep1 (rec__object__t__max_height (us_split_fields1 a))) (to_rep1 (rec__object__t__max_height (us_split_fields1 b))))) true false))
...
(define-fun default_initial_assumption ((temp___expr_159 us_rep) (temp___skip_top_level_160 Bool)) Bool (and (= (attr__tag temp___expr_159) us_tag) (and (and (= (to_rep1 (rec__object__t__area (us_split_fields1 temp___expr_159))) (- 1)) (= (to_rep1 (rec__object__t__max_width (us_split_fields1 temp___expr_159))) (- 1))) (= (to_rep1 (rec__object__t__max_height (us_split_fields1 temp___expr_159))) (- 1)))))
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__rectangle__t__width natural) (rec__rectangle__t__height natural) (rec__object__t__area1 integer) (rec__object__t__max_width1 integer) (rec__object__t__max_height1 integer) (rec__ext__1 us_private)))))
...
(define-fun of_base ((r us_rep)) us_rep1 (mk___rep1 (mk___split_fields1 (extract__width (rec__ext__ (us_split_fields1 r))) (extract__height (rec__ext__ (us_split_fields1 r))) (rec__object__t__area (us_split_fields1 r)) (rec__object__t__max_width (us_split_fields1 r)) (rec__object__t__max_height (us_split_fields1 r)) (extract__ext__ (rec__ext__ (us_split_fields1 r)))) (attr__tag r)))
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (and (and (and (and (= (to_rep (rec__rectangle__t__width (us_split_fields3 a))) (to_rep (rec__rectangle__t__width (us_split_fields3 b)))) (= (to_rep (rec__rectangle__t__height (us_split_fields3 a))) (to_rep (rec__rectangle__t__height (us_split_fields3 b))))) (= (to_rep1 (rec__object__t__area1 (us_split_fields3 a))) (to_rep1 (rec__object__t__area1 (us_split_fields3 b))))) (= (to_rep1 (rec__object__t__max_width1 (us_split_fields3 a))) (to_rep1 (rec__object__t__max_width1 (us_split_fields3 b))))) (= (to_rep1 (rec__object__t__max_height1 (us_split_fields3 a))) (to_rep1 (rec__object__t__max_height1 (us_split_fields3 b))))) true false))
...
(assert (forall ((obj us_rep)) (! (= (= (has_stored_area obj) true) (in_range1 (to_rep1 (rec__object__t__area (us_split_fields1 obj))))) :pattern ((has_stored_area obj)))))
...
(assert (forall ((obj us_rep)) (! (= (get_stored_area obj) (to_rep1 (rec__object__t__area (us_split_fields1 obj)))) :pattern ((get_stored_area obj)))))
(declare-fun set_area__specific_post (Int us_split_fields Int Int us_split_fields) Bool)
(assert (forall ((object__set_area__obj__fields us_split_fields) (object__set_area__obj__old__fields us_split_fields)) (forall ((obj__attr__tag Int) (value Int)) (! (=> (set_area__specific_post us_tag1 object__set_area__obj__fields obj__attr__tag value object__set_area__obj__old__fields) (and (= (has_stored_area (mk___rep object__set_area__obj__fields obj__attr__tag)) true) (= value (get_stored_area (mk___rep object__set_area__obj__fields obj__attr__tag))))) :pattern ((set_area__specific_post us_tag1 object__set_area__obj__fields obj__attr__tag value object__set_area__obj__old__fields))))))
(assert (forall ((object__set_area__obj__fields us_split_fields) (object__set_area__obj__old__fields us_split_fields)) (forall ((obj__attr__tag Int) (value Int)) (! (=> (set_area__specific_post us_tag object__set_area__obj__fields obj__attr__tag value object__set_area__obj__old__fields) (and (= (has_stored_area (mk___rep object__set_area__obj__fields obj__attr__tag)) true) (= value (get_stored_area (mk___rep object__set_area__obj__fields obj__attr__tag))))) :pattern ((set_area__specific_post us_tag object__set_area__obj__fields obj__attr__tag value object__set_area__obj__old__fields))))))
(define-fun default_initial_assumption1 ((temp___expr_174 us_rep1) (temp___skip_top_level_175 Bool)) Bool (and (= (attr__tag1 temp___expr_174) us_tag1) (and (and (= (to_rep1 (rec__object__t__area1 (us_split_fields3 temp___expr_174))) (- 1)) (= (to_rep1 (rec__object__t__max_width1 (us_split_fields3 temp___expr_174))) (- 1))) (= (to_rep1 (rec__object__t__max_height1 (us_split_fields3 temp___expr_174))) (- 1)))))
...
(declare-const rec____split_fields natural)
(declare-const rec____split_fields1 natural)
...
(declare-const rec____split_fields5 us_private)
...
(declare-const rec____split_fields8 integer)
(declare-const rec____split_fields9 integer)
(declare-const rec____split_fields10 integer)
(declare-const rec____split_fields11 us_private)
(declare-const result Bool)
(declare-const object__set_area__obj__fields integer)
(declare-const object__set_area__obj__fields1 integer)
(declare-const object__set_area__obj__fields2 integer)
(declare-const object__set_area__obj__fields3 us_private)
...
(declare-const rec____split_fields14 integer)
(declare-const rec____split_fields15 integer)
(declare-const rec____split_fields16 integer)
(declare-const rec____split_fields17 us_private)
(declare-const result7 Int)
(declare-const result__1 Int)
(declare-const rec____split_fields18 natural)
(declare-const rec____split_fields19 natural)
(declare-const rec____split_fields20 integer)
(declare-const rec____split_fields21 integer)
(declare-const rec____split_fields22 integer)
(declare-const rec____split_fields23 us_private)
(declare-const result__2 Int)
(declare-const rec____split_fields24 natural)
(declare-const rec____split_fields25 natural)
(declare-const rec____split_fields26 integer)
(declare-const rec____split_fields27 integer)
(declare-const rec____split_fields28 integer)
(declare-const rec____split_fields29 us_private)
(declare-const result__3 Int)
(define-fun rec____split_fields30 () us_split_fields2 (mk___split_fields1 rec____split_fields12 rec____split_fields13 rec____split_fields14 rec____split_fields15 rec____split_fields16 rec____split_fields17))
(define-fun object__set_area__obj__fields4 () us_split_fields (mk___split_fields object__set_area__obj__fields object__set_area__obj__fields1 object__set_area__obj__fields2 object__set_area__obj__fields3))
(assert (=> (<= 0 2147483647) (in_range1 result__)))
(assert (and (= o (has_stored_area (mk___rep (mk___split_fields rec____split_fields2 rec____split_fields3 rec____split_fields4 (hide_ext__ rec____split_fields rec____split_fields1 rec____split_fields5)) rec____attr__tag))) (= (= o true) (in_range1 (to_rep1 rec____split_fields2)))))
(assert (= result (ite (not (= o true)) true false)))
(assert (=> (= result true) (and (= o1 (* (to_rep rec____split_fields) (to_rep rec____split_fields1))) (in_range (* (to_rep rec____split_fields) (to_rep rec____split_fields1))))))
(assert (=> (= result true) (and (= o2 o1) (in_range1 o1))))
(assert (=> (= result true) (and (= (has_stored_area (mk___rep object__set_area__obj__fields4 rec____attr__tag)) true) (= o2 (get_stored_area (mk___rep object__set_area__obj__fields4 rec____attr__tag))))))
(assert (=> (= result true) (= (mk___split_fields__ref1 (mk___split_fields1 result1 result2 result3 result4 result5 result6)) (mk___split_fields__ref1 (mk___split_fields1 rec____split_fields rec____split_fields1 rec____split_fields2 rec____split_fields3 rec____split_fields4 rec____split_fields5)))))
(assert (=> (= result true) (= rec____split_fields30 (us_split_fields3 (of_base (mk___rep object__set_area__obj__fields4 rec____attr__tag))))))
(assert (=> (not (= result true)) (= rec____split_fields rec____split_fields12)))
(assert (=> (not (= result true)) (= rec____split_fields1 rec____split_fields13)))
(assert (=> (not (= result true)) (= rec____split_fields2 rec____split_fields14)))
(assert (=> (not (= result true)) (= rec____split_fields3 rec____split_fields15)))
(assert (=> (not (= result true)) (= rec____split_fields4 rec____split_fields16)))
(assert (=> (not (= result true)) (= rec____split_fields5 rec____split_fields17)))
(assert (=> (not (= result true)) (= rec____split_fields30 (mk___split_fields1 rec____split_fields6 rec____split_fields7 rec____split_fields8 rec____split_fields9 rec____split_fields10 rec____split_fields11))))
(assert (and (= o3 (get_stored_area (mk___rep (mk___split_fields rec____split_fields14 rec____split_fields15 rec____split_fields16 (hide_ext__ rec____split_fields12 rec____split_fields13 rec____split_fields17)) rec____attr__tag))) (and (in_range1 o3) (= o3 (to_rep1 rec____split_fields14)))))
...
(assert (= rec____split_fields21 rec____split_fields15))
(assert (= rec____split_fields22 rec____split_fields16))
(assert (= rec____split_fields23 rec____split_fields17))
(assert (= result__3 result__1))
(assert (= rec____split_fields24 rec____split_fields12))
(assert (= rec____split_fields25 rec____split_fields13))
(assert (= rec____split_fields26 rec____split_fields14))
(assert (= rec____split_fields27 rec____split_fields15))
(assert (= rec____split_fields28 rec____split_fields16))
(assert (= rec____split_fields29 rec____split_fields17))
(assert (not (= result__2 (get_stored_area (mk___rep (mk___split_fields rec____split_fields20 rec____split_fields21 rec____split_fields22 (hide_ext__ rec____split_fields18 rec____split_fields19 rec____split_fields23)) rec____attr__tag)))))
(check-sat)
(exit)
