...
(declare-sort t 0)
(define-fun in_range2 ((x Int)) Bool (and (<= (- 25) x) (<= x 25)))
...
(assert (= result z))
(assert (= z1 o))
(assert (ite (< 0 (to_fixed1 x)) (< (to_fixed1 x) (to_fixed1 z1)) (ite (< (to_fixed1 x) 0) (< (to_fixed1 z1) (to_fixed1 x)) (= (to_fixed1 z1) (to_fixed1 x)))))
(assert (not (in_range2 (+ (to_fixed1 x) (to_fixed1 y)))))
(check-sat)
(exit)
