...
(assert (=> (not (= a__ppcm__result4 0)) (and (= o8 (* a b)) (in_range1 (* a b)))))
(assert (=> (not (= a__ppcm__result4 0)) (= o9 (abs o8))))
(assert (=> (not (= a__ppcm__result4 0)) (and (= o10 o9) (in_range1 o9))))
(assert (=> (not (= a__ppcm__result4 0)) (= o11 (ite (<= a__ppcm__result4 o10) true false))))
(assert (=> (not (= a__ppcm__result4 0)) (and (= o7 (abs a)) (in_range1 (abs a)))))
(assert (=> (not (= a__ppcm__result4 0)) (= o12 (ite (<= o7 a__ppcm__result4) true false))))
(assert (=> (not (= a__ppcm__result4 0)) (= result3 (ite (= o12 true) o11 false))))
