...
(assert (= (to_fixed1 o21) (fxp_div (to_fixed1 num1) (to_fixed1 (let ((subject den)) den1)))))
(assert (= result22 res))
(assert (= (let ((subject res)) res1) o21))
(assert (= (to_fixed1 (let ((subject res)) res1)) 3293842))
(assert (= pi_compute__shanks_fixed__result2 (let ((subject pi_compute__shanks_fixed__result)) (mk_fixed__ref pi_compute__shanks_fixed__result1))))
(assert (= pi_compute__shanks_fixed__result3 pi_compute__shanks_fixed__result1))
(assert (= result23 pi_compute__shanks_fixed__result))
(assert (= (let ((subject pi_compute__shanks_fixed__result)) pi_compute__shanks_fixed__result1) (let ((subject res)) res1)))
(assert (= pi_compute__shanks_fixed__result4 pi_compute__shanks_fixed__result2))
(assert (= res2 (let ((subject res)) (mk_fixed__ref res1))))
(assert (= den2 (let ((subject den)) (mk_fixed__ref den1))))
(assert (= num2 (mk_fixed__ref num1)))
(assert (= a102 (mk_fixed__ref a101)))
(assert (= a92 (mk_fixed__ref a91)))
(assert (= a82 (mk_fixed__ref a81)))
(assert (= a72 (mk_fixed__ref a71)))
(assert (= a62 (mk_fixed__ref a61)))
(assert (= a52 (mk_fixed__ref a51)))
(assert (= a42 (mk_fixed__ref a41)))
(assert (= a32 (mk_fixed__ref a31)))
(assert (= a22 (mk_fixed__ref a21)))
(assert (= a12 (mk_fixed__ref a11)))
...
(assert (= pi_compute__shanks_fixed__result5 pi_compute__shanks_fixed__result3))
(assert (= res3 res1))
(assert (= den3 den1))
(assert (= num3 num1))
(assert (= a103 a101))
