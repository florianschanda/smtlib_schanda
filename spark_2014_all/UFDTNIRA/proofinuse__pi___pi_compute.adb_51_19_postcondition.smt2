...
(declare-const result24 fixed)
(assert (and (and (and (= (to_fixed1 o) 1048576) (and (= result (mk_fixed__ref t1)) (= t11 o))) (and (and (= (to_fixed1 o1) 349525) (and (= result1 (mk_fixed__ref t2)) (= t21 o1))) (and (and (= (to_fixed1 o2) 209715) (and (= result2 (mk_fixed__ref t3)) (= t31 o2))) (and (and (= (to_fixed1 o3) 149796) (and (= result3 (mk_fixed__ref t4)) (= t41 o3))) (and (and (= (to_fixed1 o4) 116508) (and (= result4 (mk_fixed__ref t5)) (= t51 o4))) (and (and (= (to_fixed1 o5) 95325) (and (= result5 (mk_fixed__ref t6)) (= t61 o5))) (and (and (= (to_fixed1 o6) 80659) (and (= result6 (mk_fixed__ref t7)) (= t71 o6))) (and (and (= (to_fixed1 o7) 69905) (and (= result7 (mk_fixed__ref t8)) (= t81 o7))) (and (and (= (to_fixed1 o8) 61680) (and (= result8 (mk_fixed__ref t9)) (= t91 o8))) (and (and (= (to_fixed1 o9) 55188) (and (= result9 (mk_fixed__ref t10)) (= t101 o9))) (and (and (= result10 (mk_fixed__ref a1)) (= a11 t11)) (and (and (= (to_fixed1 o10) (- (to_fixed1 a11) (to_fixed1 t21))) (and (= result11 (mk_fixed__ref a2)) (= a21 o10))) (and (and (= (to_fixed1 o11) (+ (to_fixed1 a21) (to_fixed1 t31))) (and (= result12 (mk_fixed__ref a3)) (= a31 o11))) (and (and (= (to_fixed1 o12) (- (to_fixed1 a31) (to_fixed1 t41))) (and (= result13 (mk_fixed__ref a4)) (= a41 o12))) (and (and (= (to_fixed1 o13) (+ (to_fixed1 a41) (to_fixed1 t51))) (and (= result14 (mk_fixed__ref a5)) (= a51 o13))) (and (and (= (to_fixed1 o14) (- (to_fixed1 a51) (to_fixed1 t61))) (and (= result15 (mk_fixed__ref a6)) (= a61 o14))) (and (and (= (to_fixed1 o15) (+ (to_fixed1 a61) (to_fixed1 t71))) (and (= result16 (mk_fixed__ref a7)) (= a71 o15))) (and (and (= (to_fixed1 o16) (- (to_fixed1 a71) (to_fixed1 t81))) (and (= result17 (mk_fixed__ref a8)) (= a81 o16))) (and (and (= (to_fixed1 o17) (+ (to_fixed1 a81) (to_fixed1 t91))) (and (= result18 (mk_fixed__ref a9)) (= a91 o17))) (and (and (= (to_fixed1 o18) (- (to_fixed1 a91) (to_fixed1 t101))) (and (= result19 (mk_fixed__ref a10)) (= a101 o18))) (and (and (= (to_fixed1 o19) (* (- (fxp_mult (to_fixed1 a101) (to_fixed1 a81)) (fxp_mult (to_fixed1 a91) (to_fixed1 a91))) 4)) (and (= result20 (mk_fixed__ref num)) (= num1 o19))) (and (and (= (to_fixed1 o20) (+ (- (to_fixed1 a101) (* (to_fixed1 a91) 2)) (to_fixed1 a81))) (and (= result21 den) (= (let ((subject den)) den1) o20))) (and (and (= (to_fixed1 o21) (fxp_div (to_fixed1 num1) (to_fixed1 (let ((subject den)) den1)))) (and (= result22 res) (= (let ((subject res)) res1) o21))) (and (= (to_fixed1 (let ((subject res)) res1)) 3293842) (and (and (= pi_compute__shanks_fixed__result2 (let ((subject pi_compute__shanks_fixed__result)) (mk_fixed__ref pi_compute__shanks_fixed__result1))) (= pi_compute__shanks_fixed__result3 pi_compute__shanks_fixed__result1)) (and (= result23 pi_compute__shanks_fixed__result) (= (let ((subject pi_compute__shanks_fixed__result)) pi_compute__shanks_fixed__result1) (let ((subject res)) res1)))))))))))))))))))))))))))) (and (and (= pi_compute__shanks_fixed__result4 pi_compute__shanks_fixed__result2) (and (= res2 (let ((subject res)) (mk_fixed__ref res1))) (and (= den2 (let ((subject den)) (mk_fixed__ref den1))) (and (= num2 (mk_fixed__ref num1)) (and (= a102 (mk_fixed__ref a101)) (and (= a92 (mk_fixed__ref a91)) (and (= a82 (mk_fixed__ref a81)) (and (= a72 (mk_fixed__ref a71)) (and (= a62 (mk_fixed__ref a61)) (and (= a52 (mk_fixed__ref a51)) (and (= a42 (mk_fixed__ref a41)) (and (= a32 (mk_fixed__ref a31)) (and (= a22 (mk_fixed__ref a21)) (and (= a12 (mk_fixed__ref a11)) (and (= t102 (mk_fixed__ref t101)) (and (= t92 (mk_fixed__ref t91)) (and (= t82 (mk_fixed__ref t81)) (and (= t72 (mk_fixed__ref t71)) (and (= t62 (mk_fixed__ref t61)) (and (= t52 (mk_fixed__ref t51)) (and (= t42 (mk_fixed__ref t41)) (and (= t32 (mk_fixed__ref t31)) (and (= t22 (mk_fixed__ref t21)) (= t12 (mk_fixed__ref t11))))))))))))))))))))))))) (and (= pi_compute__shanks_fixed__result5 pi_compute__shanks_fixed__result3) (and (= res3 res1) (and (= den3 den1) (and (= num3 num1) (and (= a103 a101) (and (= a93 a91) (and (= a83 a81) (and (= a73 a71) (and (= a63 a61) (and (= a53 a51) (and (= a43 a41) (and (= a33 a31) (and (= a23 a21) (and (= a13 a11) (and (= t103 t101) (and (= t93 t91) (and (= t83 t81) (and (= t73 t71) (and (= t63 t61) (and (= t53 t51) (and (= t43 t41) (and (= t33 t31) (and (= t23 t21) (= t13 t11)))))))))))))))))))))))))))
(assert (= result24 (fixed__content pi_compute__shanks_fixed__result4)))
(assert (not (= (to_fixed1 (fixed__content pi_compute__shanks_fixed__result4)) 3293842)))
(check-sat)
(exit)
