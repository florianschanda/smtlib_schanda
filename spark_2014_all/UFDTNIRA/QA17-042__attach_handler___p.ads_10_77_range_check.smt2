...
(declare-fun user_eq1 (interrupt_id interrupt_id) Bool)
(declare-const dummy1 interrupt_id)
...
(define-fun dynamic_invariant1 ((temp___expr_1762 Int) (temp___is_init_1758 Bool) (temp___skip_constant_1759 Bool) (temp___do_toplevel_1760 Bool) (temp___do_typ_inv_1761 Bool)) Bool (=> (or (= temp___is_init_1758 true) (<= 0 63)) (in_range1 temp___expr_1762)))
