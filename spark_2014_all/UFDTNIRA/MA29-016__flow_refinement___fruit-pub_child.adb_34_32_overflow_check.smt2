...
(assert (and (= o6 (+ apples_in_fruit_salad oranges_in_fruit_salad)) (in_range (+ apples_in_fruit_salad oranges_in_fruit_salad))))
(assert (and (= o7 (get_price_of_orange price_of_orange)) (and (in_range1 o7) (= o7 price_of_orange))))
(assert (= o8 (* o7 o6)))
