...
(define-fun default_initial_assumption ((temp___expr_172 us_rep) (temp___skip_top_level_173 Bool)) Bool (= (to_rep (rec__protected_sequence__data (us_split_fields1 temp___expr_172))) 0))
...
(assert (=> (<= (- 2147483648) 2147483647) (in_range local2)))
(assert (not (in_range (+ local2 1))))
(check-sat)
(exit)
