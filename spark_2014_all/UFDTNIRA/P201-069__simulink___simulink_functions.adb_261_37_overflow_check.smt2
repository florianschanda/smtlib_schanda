...
(define-fun dynamic_invariant ((temp___expr_153 Int) (temp___is_init_150 Bool) (temp___skip_constant_151 Bool) (temp___do_toplevel_152 Bool)) Bool (=> (or (= temp___is_init_150 true) (<= (- 32768) 32767)) (in_range2 temp___expr_153)))
...
(assert (and (= o12 (div1 left right)) (in_range1 (div1 left right))))
(assert (= o13 (* o12 right)))
