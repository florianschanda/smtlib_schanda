...
(assert (forall ((x Int)) (! (ite (= x 0) (= (to_int2 x) 0) (ite (< 0 x) (pos_div_relation (to_int2 x) x 16) (pos_div_relation (- (to_int2 x)) (- x) 16))) :pattern ((to_int2 x)))))
...
(assert (forall ((x Int)) (! (ite (= x 0) (= (to_int3 x) 0) (ite (< 0 x) (pos_div_relation1 (to_int3 x) x 16) (pos_div_relation1 (- (to_int3 x)) (- x) 16))) :pattern ((to_int3 x)))))
...
(assert (not (in_range1 (+ (to_fixed1 x) 80))))
(check-sat)
(exit)
