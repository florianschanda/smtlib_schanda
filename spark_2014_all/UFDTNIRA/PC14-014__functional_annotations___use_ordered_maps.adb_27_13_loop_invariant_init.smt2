...
(define-fun temp___644 () us_rep3 (keys (mk___rep r__split_discrs r__split_fields1)))
(assert (not (exists ((temp___643 Int)) (and (and (in_range3 temp___643) (= (iter_has_element temp___644 temp___643) true)) (= (get2 (model__ (mk___rep r__split_discrs r__split_fields1)) (get temp___644 temp___643)) (f (get2 (model__ s) (get (keys s) i))))))))
(check-sat)
(exit)
