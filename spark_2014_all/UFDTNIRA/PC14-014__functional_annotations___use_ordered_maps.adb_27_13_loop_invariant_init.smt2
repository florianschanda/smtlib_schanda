...
(assert (<= 1 i3))
(assert (<= i3 (- (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields1))) 1)))
(assert (not (exists ((temp___643 Int)) (and (and (in_range3 temp___643) (= (iter_has_element (keys (mk___rep r__split_discrs (mk___split_fields r__split_fields))) temp___643) true)) (= (get2 (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields))) (get (keys (mk___rep r__split_discrs (mk___split_fields r__split_fields))) temp___643)) (f (get2 (model__ s) (get (keys s) i3))))))))
(check-sat)
(exit)
