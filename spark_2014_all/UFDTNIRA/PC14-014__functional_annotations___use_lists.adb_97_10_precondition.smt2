...
(assert (forall ((j Int)) (=> (and (<= 1 j) (<= j (- i2 1))) (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) (+ j (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) j)))))
...
(assert (and (= o1 (element (mk___rep l__split_discrs l__split_fields2) (mk___rep1 cu__split_fields3))) (and (in_range5 o1) (= o1 (get (model__ (mk___rep l__split_discrs l__split_fields2)) (get1 (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 cu__split_fields3)))))))
(assert (not (< (length (mk___rep l__split_discrs l__split_fields2)) (to_rep (rec__use_lists__my_lists__list__capacity l__split_discrs)))))
(check-sat)
(exit)
