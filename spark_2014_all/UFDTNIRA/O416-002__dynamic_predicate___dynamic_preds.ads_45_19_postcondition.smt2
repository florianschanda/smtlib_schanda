...
(declare-const temp___340 even)
(declare-const temp___3401 even)
...
(assert (= o4 2))
(assert (= (to_rep o5) o4))
(assert (= x__split_fields2 o6))
(assert (= o5 o7))
(assert (= temp___340 o6))
(assert (= temp___3401 o7))
(assert (= result2 x__split_fields2))
(assert (= result3 x__split_fields3))
(assert (= temp___340 x__split_fields4))
(assert (= temp___3401 x__split_fields5))
(assert (= x__split_fields6 x__split_fields4))
(assert (= x__split_fields7 x__split_fields5))
(assert (= x__split_fields8 x__split_fields4))
(assert (= x__split_fields9 x__split_fields5))
(assert (not (= (to_rep x__split_fields6) 0)))
(check-sat)
(exit)
