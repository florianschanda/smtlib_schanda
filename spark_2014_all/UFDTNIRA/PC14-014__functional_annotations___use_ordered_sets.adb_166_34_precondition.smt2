...
(assert (and (= o40 (positions (mk___rep s__split_discrs s__split_fields2))) (and (not (= (has_key o40 no_element) true)) (forall ((i4 us_rep1)) (=> (= (has_key o40 i4) true) (and (and (<= 1 (get1 o40 i4)) (<= (get1 o40 i4) (length (mk___rep s__split_discrs s__split_fields2)))) (forall ((j us_rep1)) (=> (= (has_key o40 j) true) (=> (= (get1 o40 i4) (get1 o40 j)) (= (bool_eq1 i4 j) true))))))))))
(assert (not (= (has_key o40 (mk___rep1 cu__split_fields2)) true)))
(check-sat)
(exit)
