...
(declare-const l Int)
(declare-const temp___708 us_rep3)
...
(assert (= (= o5 true) (in_range3 temp___705)))
(assert (= result4 (ite (= o5 true) o4 false)))
(assert (= result4 true))
(assert (and (= l (get temp___706 temp___705)) (in_range4 l)))
(assert (and (= temp___708 (keys s)) (and (and (and (= (length3 temp___708) (length s)) (forall ((temp___439 Int)) (=> (and (in_range3 temp___439) (= (iter_has_element temp___708 temp___439) true)) (= (has_key (model__ s) (get temp___708 temp___439)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true)) (and (< 0 (find temp___708 key2)) (= (equivalent_keys (get temp___708 (find temp___708 key2)) key2) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length s))) (and (= (find temp___708 (get temp___708 i)) i) (= (k_is_find temp___708 (get temp___708 i) i) true)))))))
(assert (and (= o6 (iter_has_element temp___708 temp___707)) (= (= o6 true) (and (<= 1 temp___707) (<= temp___707 (last temp___708))))))
(assert (= (= o7 true) (in_range3 temp___707)))
(assert (= result5 (ite (= o7 true) o6 false)))
(assert (= result5 true))
(assert (and (= k (get temp___708 temp___707)) (in_range4 k)))
