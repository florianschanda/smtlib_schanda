...
(assert (and (= o4 (iter_has_element temp___663 temp___662)) (= (= o4 true) (and (<= 1 temp___662) (<= temp___662 (last temp___663))))))
(assert (= (= o5 true) (in_range3 temp___662)))
(assert (= result4 (ite (= o5 true) o4 false)))
(assert (= result4 true))
(assert (and (= l (get temp___663 temp___662)) (in_range4 l)))
(assert (and (= temp___665 (keys s)) (and (and (and (= (length3 temp___665) (length s)) (forall ((temp___396 Int)) (=> (and (in_range3 temp___396) (= (iter_has_element temp___665 temp___396) true)) (= (has_key (model__ s) (get temp___665 temp___396)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true)) (and (< 0 (find temp___665 key2)) (= (equivalent_keys (get temp___665 (find temp___665 key2)) key2) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length s))) (and (= (find temp___665 (get temp___665 i)) i) (= (k_is_find temp___665 (get temp___665 i) i) true)))))))
(assert (and (= o6 (iter_has_element temp___665 temp___664)) (= (= o6 true) (and (<= 1 temp___664) (<= temp___664 (last temp___665))))))
