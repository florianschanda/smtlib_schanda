...
(assert (= result9 true))
(assert (and (= l1 (get temp___663 temp___662)) (in_range4 l1)))
(assert (and (= temp___665 (keys s)) (and (and (and (= (length3 temp___665) (length s)) (forall ((temp___396 Int)) (=> (and (in_range3 temp___396) (= (iter_has_element temp___665 temp___396) true)) (= (has_key (model__ s) (get temp___665 temp___396)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true)) (and (< 0 (find temp___665 key2)) (= (equivalent_keys (get temp___665 (find temp___665 key2)) key2) true))))) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 (length s))) (and (= (find temp___665 (get temp___665 i3)) i3) (= (k_is_find temp___665 (get temp___665 i3) i3) true)))))))
(assert (and (= o45 (iter_has_element temp___665 temp___664)) (= (= o45 true) (and (<= 1 temp___664) (<= temp___664 (last temp___665))))))
(assert (= (= o46 true) (in_range3 temp___664)))
(assert (= result10 (ite (= o46 true) o45 false)))
(assert (= result10 true))
(assert (and (= k3 (get temp___665 temp___664)) (in_range4 k3)))
(assert (and (= o47 (get2 (model__ s) k3)) (and (in_range7 o47) (= o47 (get2 (model__ s) k3)))))
(assert (and (= o48 (f o47)) (and (in_range8 o48) (= o48 (ite (and (<= (- 100) o47) (<= o47 100)) (* o47 2) o47)))))
(assert (not (= (has_key (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) l1) true)))
(check-sat)
(exit)
