...
(assert (and (= o2 (length (mk___rep s__split_discrs s__split_fields1))) (and (in_range1 o2) (<= o2 (to_rep (rec__use_ordered_sets__my_sets__set__capacity s__split_discrs))))))
