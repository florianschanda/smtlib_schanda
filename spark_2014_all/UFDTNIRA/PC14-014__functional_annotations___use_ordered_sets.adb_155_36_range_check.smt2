...
(assert (and (= o4 (elements (mk___rep s__split_discrs s__split_fields1))) (and (and (and (= (length2 o4) (length (mk___rep s__split_discrs s__split_fields1))) (forall ((temp___390 Int)) (=> (and (in_range4 temp___390) (= (iter_has_element o4 temp___390) true)) (= (contains (model__ (mk___rep s__split_discrs s__split_fields1)) (get o4 temp___390)) true)))) (forall ((item Int)) (=> (and (in_range7 item) (= (contains (model__ (mk___rep s__split_discrs s__split_fields1)) item) true)) (and (< 0 (find o4 item)) (= (equivalent_elements (get o4 (find o4 item)) item) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep s__split_discrs s__split_fields1)))) (and (= (find o4 (get o4 i1)) i1) (= (e_is_find o4 (get o4 i1) i1) true)))))))
(assert (and (= o10 (get o4 o8)) (in_range5 o10)))
(assert (= o11 (ite (= o10 o9) true false)))
(assert (and (= o1 (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) i)) (in_range5 o1)))
(assert (= o2 (+ o1 1)))
