...
(assert (in_range3 sc))
(assert (and (= o8 (* 3 9223372036)) (in_range2 (* 3 9223372036))))
(assert (= o9 (ite (<= sc o8) true false)))
(assert (and (= o7 (* 3 (- 9223372036))) (in_range2 (* 3 (- 9223372036)))))
(assert (= o10 (ite (<= o7 sc) true false)))
(assert (= result (ite (= o10 true) o9 false)))
(assert (= result true))
(assert (and (= o3 (+ 9223372036 1)) (in_range2 (+ 9223372036 1))))
(assert (and (= o4 (result_sc sc ts)) (and (in_range3 o4) (= o4 (+ sc (ts_sc ts))))))
(assert (= o5 (ite (<= o4 o3) true false)))
(assert (and (= o1 (result_sc sc ts)) (and (in_range3 o1) (= o1 (+ sc (ts_sc ts))))))
(assert (and (= o2 (- (- 9223372036) 1)) (in_range2 (- (- 9223372036) 1))))
