...
(declare-const i Int)
(declare-const o Int)
(declare-const temp___493 us_rep1)
(declare-const temp___492 Int)
(declare-const temp___490 Int)
(declare-const temp___496 us_rep1)
(declare-const temp___489 tcount_typeB)
(declare-const temp___4891 us_main_type)
(declare-const temp___494 Int)
(declare-const temp___491 Int)
...
(assert (= i2 first4))
(assert (=> (and (<= first4 i2) (<= i2 r17b)) (= temp___493 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))))))
(assert (=> (and (<= first4 i2) (<= i2 r17b)) (= temp___492 (last2 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields)))))))
(assert (=> (and (<= first4 i2) (<= i2 r17b)) (= temp___490 i2)))
(assert (=> (and (<= first4 i2) (<= i2 r17b)) (= temp___496 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))))))
(assert (=> (and (<= first4 i2) (<= i2 r17b)) (and (= v__split_discrs (mk___split_discrs temp___489)) (= v__split_fields temp___4891))))
(assert (=> (and (<= first4 i2) (<= i2 r17b)) (= temp___494 (length (mk___rep v__split_discrs (mk___split_fields v__split_fields))))))
(assert (=> (and (<= first4 i2) (<= i2 r17b)) (= temp___491 (length (mk___rep v__split_discrs (mk___split_fields v__split_fields))))))
(assert (=> (and (<= first4 i2) (<= i2 r17b)) (= (length (mk___rep v__split_discrs v__split_fields12)) (+ temp___491 (- i3 first4)))))
(assert (=> (and (<= first4 i2) (<= i2 r17b)) (forall ((j Int)) (=> (and (<= first4 j) (<= j temp___492)) (= (get (model__ (mk___rep v__split_discrs v__split_fields12)) j) (get temp___493 j))))))
(assert (=> (and (<= first4 i2) (<= i2 r17b)) (forall ((j Int)) (=> (and (<= first4 j) (<= j (- i3 1))) (= (get (model__ (mk___rep v__split_discrs v__split_fields12)) (+ j temp___494)) (get temp___496 j))))))
(assert (=> (and (<= first4 i2) (<= i2 r17b)) (and (and (dynamic_property 0 last (to_rep (rec__use_vectors__my_vectors__vector__capacity v__split_discrs))) (=> (<= first4 r17b) (dynamic_property6 first4 r17b i3))) (and (<= first4 i3) (<= i3 r17b)))))
(assert (=> (and (<= first4 i2) (<= i2 r17b)) (and (= us i3) (dynamic_property3 first2 last4 i3))))
(assert (=> (and (<= first4 i2) (<= i2 r17b)) (= o1 i3)))
(assert (=> (and (<= first4 i2) (<= i2 r17b)) (and (= o2 (get (model__ (mk___rep v__split_discrs v__split_fields12)) o1)) (and (in_range4 o2) (= o2 (get (model__ (mk___rep v__split_discrs v__split_fields12)) o1))))))
(assert (=> (and (<= first4 i2) (<= i2 r17b)) (and (and (and (= (length (mk___rep v__split_discrs v__split_fields11)) (+ (length (mk___rep v__split_discrs v__split_fields12)) 1)) (= (olt (model__ (mk___rep v__split_discrs v__split_fields12)) (model__ (mk___rep v__split_discrs v__split_fields11))) true)) (= (get (model__ (mk___rep v__split_discrs v__split_fields11)) (+ (last2 (model__ (mk___rep v__split_discrs v__split_fields12))) 1)) o2)) (dynamic_property 0 last (to_rep (rec__use_vectors__my_vectors__vector__capacity v__split_discrs))))))
(assert (=> (and (<= first4 i2) (<= i2 r17b)) (= i3 r17b)))
(assert (=> (and (<= first4 i2) (<= i2 r17b)) (= i3 i4)))
(assert (=> (and (<= first4 i2) (<= i2 r17b)) (= v__split_fields4 v__split_fields3)))
(assert (=> (and (<= first4 i2) (<= i2 r17b)) (= i5 i3)))
(assert (=> (and (<= first4 i2) (<= i2 r17b)) (= v__split_fields10 v__split_fields11)))
(assert (=> (and (<= first4 i2) (<= i2 r17b)) (= i6 (mk_int__ref i4))))
(assert (=> (and (<= first4 i2) (<= i2 r17b)) (= v__split_fields6 (mk___split_fields__ref (mk___split_fields v__split_fields4)))))
(assert (=> (and (<= first4 i2) (<= i2 r17b)) (= i7 i5)))
(assert (=> (and (<= first4 i2) (<= i2 r17b)) (= v__split_fields7 v__split_fields10)))
(assert (=> (not (and (<= first4 i2) (<= i2 r17b))) (= i6 (mk_int__ref i2))))
(assert (=> (not (and (<= first4 i2) (<= i2 r17b))) (= v__split_fields6 (mk___split_fields__ref (mk___split_fields v__split_fields)))))
(assert (=> (not (and (<= first4 i2) (<= i2 r17b))) (= i7 i2)))
(assert (=> (not (and (<= first4 i2) (<= i2 r17b))) (= v__split_fields7 (mk___split_fields v__split_fields1))))
(assert (= i8 i6))
...
(assert (<= first4 i1))
(assert (<= i1 (last2 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))))))
(assert (and (= us2 i1) (dynamic_property2 first1 last3 i1)))
(assert (= o4 i1))
...
(assert (and (= us1 temp___502) (dynamic_property3 first2 last4 temp___502)))
(assert (= o3 temp___502))
(assert (not (<= o3 (last2 (model__ (mk___rep v__split_discrs (us_split_fields__content v__split_fields8)))))))
(check-sat)
(exit)
