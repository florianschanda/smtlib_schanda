...
(define-fun dynamic_invariant7 ((temp___expr_228 Int) (temp___is_init_224 Bool) (temp___skip_constant_225 Bool) (temp___do_toplevel_226 Bool) (temp___do_typ_inv_227 Bool)) Bool (=> (or (= temp___is_init_224 true) (<= first last)) (dynamic_property first last temp___expr_228)))
(assert (= first fst))
(assert (= last lst))
...
(assert (= first1 fst))
(assert (= last1 lst))
(assert (forall ((container us_rep1)) (! (let ((result (length1 container))) (and (<= (+ (- first3 1) result) last4) (dynamic_invariant8 result true false true true))) :pattern ((length1 container)))))
(define-fun dynamic_invariant10 ((temp___expr_280 Int) (temp___is_init_276 Bool) (temp___skip_constant_277 Bool) (temp___do_toplevel_278 Bool) (temp___do_typ_inv_279 Bool)) Bool (=> (or (= temp___is_init_276 true) (<= first3 last4)) (dynamic_property4 first3 last4 temp___expr_280)))
(assert (= first3 fst))
(assert (= last4 lst))
...
(declare-const i Int)
(declare-const o Int)
(declare-const temp___491 us_rep1)
(declare-const temp___490 Int)
(declare-const temp___488 Int)
(declare-const temp___494 us_rep1)
(declare-const temp___487 tcount_typeB)
(declare-const temp___4871 us_main_type)
(declare-const temp___492 Int)
(declare-const temp___489 Int)
...
(assert (= i2 first))
(assert (=> (and (<= first i2) (<= i2 r17b)) (= temp___491 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))))))
(assert (=> (and (<= first i2) (<= i2 r17b)) (= temp___490 (last5 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields)))))))
(assert (=> (and (<= first i2) (<= i2 r17b)) (= temp___488 i2)))
(assert (=> (and (<= first i2) (<= i2 r17b)) (= temp___494 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))))))
(assert (=> (and (<= first i2) (<= i2 r17b)) (and (= v__split_discrs (mk___split_discrs temp___487)) (= v__split_fields temp___4871))))
(assert (=> (and (<= first i2) (<= i2 r17b)) (= temp___492 (length (mk___rep v__split_discrs (mk___split_fields v__split_fields))))))
(assert (=> (and (<= first i2) (<= i2 r17b)) (= temp___489 (length (mk___rep v__split_discrs (mk___split_fields v__split_fields))))))
(assert (=> (and (<= first i2) (<= i2 r17b)) (= (length (mk___rep v__split_discrs v__split_fields12)) (+ temp___489 (- i3 first)))))
(assert (=> (and (<= first i2) (<= i2 r17b)) (forall ((j Int)) (=> (and (<= first j) (<= j temp___490)) (= (get (model__ (mk___rep v__split_discrs v__split_fields12)) j) (get temp___491 j))))))
(assert (=> (and (<= first i2) (<= i2 r17b)) (forall ((j Int)) (=> (and (<= first j) (<= j (- i3 1))) (= (get (model__ (mk___rep v__split_discrs v__split_fields12)) (+ j temp___492)) (get temp___494 j))))))
(assert (=> (and (<= first i2) (<= i2 r17b)) (and (and (dynamic_property2 0 last2 (to_rep1 (rec__use_vectors__my_vectors__vector__capacity v__split_discrs))) (=> (<= first r17b) (dynamic_property6 first r17b i3))) (and (<= first i3) (<= i3 r17b)))))
(assert (=> (and (<= first i2) (<= i2 r17b)) (and (= us i3) (dynamic_property1 first1 last1 i3))))
(assert (=> (and (<= first i2) (<= i2 r17b)) (= o1 i3)))
(assert (=> (and (<= first i2) (<= i2 r17b)) (and (= o2 (get (model__ (mk___rep v__split_discrs v__split_fields12)) o1)) (and (in_range4 o2) (= o2 (get (model__ (mk___rep v__split_discrs v__split_fields12)) o1))))))
(assert (=> (and (<= first i2) (<= i2 r17b)) (and (and (and (= (length (mk___rep v__split_discrs v__split_fields11)) (+ (length (mk___rep v__split_discrs v__split_fields12)) 1)) (= (olt (model__ (mk___rep v__split_discrs v__split_fields12)) (model__ (mk___rep v__split_discrs v__split_fields11))) true)) (= (get (model__ (mk___rep v__split_discrs v__split_fields11)) (+ (last5 (model__ (mk___rep v__split_discrs v__split_fields12))) 1)) o2)) (dynamic_property2 0 last2 (to_rep1 (rec__use_vectors__my_vectors__vector__capacity v__split_discrs))))))
(assert (=> (and (<= first i2) (<= i2 r17b)) (= i3 r17b)))
(assert (=> (and (<= first i2) (<= i2 r17b)) (= i3 i4)))
(assert (=> (and (<= first i2) (<= i2 r17b)) (= v__split_fields4 v__split_fields3)))
(assert (=> (and (<= first i2) (<= i2 r17b)) (= i5 i3)))
(assert (=> (and (<= first i2) (<= i2 r17b)) (= v__split_fields10 v__split_fields11)))
(assert (=> (and (<= first i2) (<= i2 r17b)) (= i6 (mk_int__ref i4))))
(assert (=> (and (<= first i2) (<= i2 r17b)) (= v__split_fields6 (mk___split_fields__ref (mk___split_fields v__split_fields4)))))
(assert (=> (and (<= first i2) (<= i2 r17b)) (= i7 i5)))
(assert (=> (and (<= first i2) (<= i2 r17b)) (= v__split_fields7 v__split_fields10)))
(assert (=> (not (and (<= first i2) (<= i2 r17b))) (= i6 (mk_int__ref i2))))
(assert (=> (not (and (<= first i2) (<= i2 r17b))) (= v__split_fields6 (mk___split_fields__ref (mk___split_fields v__split_fields)))))
(assert (=> (not (and (<= first i2) (<= i2 r17b))) (= i7 i2)))
(assert (=> (not (and (<= first i2) (<= i2 r17b))) (= v__split_fields7 (mk___split_fields v__split_fields1))))
(assert (= i8 i6))
...
(assert (<= first i1))
(assert (<= i1 (last5 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))))))
(assert (and (= us2 i1) (dynamic_property3 first2 last3 i1)))
(assert (= o4 i1))
(assert (and (= o5 (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) o4)) (in_range3 o5)))
(assert (and (= temp___502 (+ i1 (length (mk___rep v__split_discrs (mk___split_fields v__split_fields))))) (in_range1 (+ i1 (length (mk___rep v__split_discrs (mk___split_fields v__split_fields)))))))
(assert (and (= us1 temp___502) (dynamic_property1 first1 last1 temp___502)))
(assert (= o3 temp___502))
(assert (not (<= first1 o3)))
(check-sat)
(exit)
