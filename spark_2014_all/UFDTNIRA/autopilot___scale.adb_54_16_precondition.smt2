...
(assert (and (< 0 gap4) (<= gap4 100)))
(assert (=> (<= (- 2147483648) 2147483647) (in_range1 gap4)))
(assert (and (= o (inverse mach 20)) (in_range5 o)))
(assert (= (mk_int__ref result4) (mk_int__ref k1)))
(assert (= k12 o))
(assert (and (= o1 gap4) (in_range4 gap4)))
(assert (not (<= 0 o1)))
(check-sat)
(exit)
