...
(assert (=> (= result2 true) (and (= temp___7891 (next (mk___rep s__split_discrs s__split_fields3) o18)) (ite (= (ite (= (bool_eq1 o18 no_element) false) (= (get1 (positions (mk___rep s__split_discrs s__split_fields3)) o18) (length (mk___rep s__split_discrs s__split_fields3))) true) true) (= (bool_eq1 temp___7891 no_element) true) (and (= (has_key (positions (mk___rep s__split_discrs s__split_fields3)) temp___7891) true) (= (get1 (positions (mk___rep s__split_discrs s__split_fields3)) temp___7891) (+ (get1 (positions (mk___rep s__split_discrs s__split_fields3)) o18) 1)))))))
