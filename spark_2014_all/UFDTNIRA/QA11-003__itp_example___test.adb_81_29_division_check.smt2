...
(define-fun dynamic_invariant ((temp___expr_21 Int) (temp___is_init_18 Bool) (temp___skip_constant_19 Bool) (temp___do_toplevel_20 Bool)) Bool (=> (or (= temp___is_init_18 true) (<= (- 9223372036854775808) 9223372036854775807)) (in_range1 temp___expr_21)))
(declare-const x Int)
