...
(define-fun dynamic_invariant ((temp___expr_172 tmoneyB) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool) (temp___do_typ_inv_171 Bool)) Bool (=> (or (= temp___is_init_168 true) (<= first 9999999999)) (dynamic_property first 9999999999 (to_fixed2 temp___expr_172))))
...
(assert (= default_v1 o))
(assert (<= (to_fixed1 (of_fixed1 (of_real1 (- (/ 9999999999.0 100.0))))) 9999999999))
(assert (not (<= (- 999999999999999) (to_fixed1 (of_fixed1 (of_real1 (- (/ 9999999999.0 100.0))))))))
(check-sat)
(exit)
