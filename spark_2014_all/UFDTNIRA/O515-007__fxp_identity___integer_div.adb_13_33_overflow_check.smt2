...
(assert (forall ((ts Int)) (! (=> (dynamic_invariant ts true true true) (dynamic_invariant (id ts) true false true)) :pattern ((id ts)))))
(assert (forall ((ts Int)) (! (=> (dynamic_invariant ts true true true) (= (id ts) ts)) :pattern ((id ts)))))
