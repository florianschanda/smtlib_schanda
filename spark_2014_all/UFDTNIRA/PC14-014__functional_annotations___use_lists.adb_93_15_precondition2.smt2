...
(assert (= (length (mk___rep l__split_discrs l__split_fields2)) (- (+ (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i2) 1)))
(assert (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))) (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) i3) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i3)))))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- i2 1))) (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) (+ j1 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) j1)))))
(assert (= (get1 (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 cu__split_fields3)) i2))
(assert (and (=> (<= 1 r27b) (dynamic_property 1 r27b i2)) (and (<= 1 i2) (<= i2 r27b))))
(assert (<= 1 j))
(assert (<= j (- i2 1)))
(assert (and (= o3 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) j)) (in_range2 o3)))
(assert (and (= o2 (+ j (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))) (in_range6 (+ j (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))))))
(assert (and (= o1 (model__ (mk___rep l__split_discrs l__split_fields2))) (= (length1 o1) (length (mk___rep l__split_discrs l__split_fields2)))))
(assert (not (<= 1 o2)))
(check-sat)
(exit)
