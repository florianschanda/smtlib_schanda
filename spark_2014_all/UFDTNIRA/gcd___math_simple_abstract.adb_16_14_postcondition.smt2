...
(assert (= j1 1))
(assert (=> (and (<= 1 j1) (<= j1 2147483647)) (and (and (= temp___133 j1) (and (= (div1 (* j1 arg2) arg2) j1) (and (not (= (* arg2 j1) arg1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k j2)) (not (= (* arg2 k) arg1)))) (and (and (=> (<= 1 2147483647) (in_range1 j2)) (and (<= 1 j2) (<= j2 2147483647))) (= j2 2147483647)))))) (and (= j2 j6) (= j7 j2)))))
(assert (=> (and (<= 1 j1) (<= j1 2147483647)) (= (mk_int__ref j8) (mk_int__ref j6))))
(assert (=> (and (<= 1 j1) (<= j1 2147483647)) (= j9 j7)))
(assert (=> (not (and (<= 1 j1) (<= j1 2147483647))) (= j1 j8)))
(assert (=> (not (and (<= 1 j1) (<= j1 2147483647))) (= j9 j1)))
(assert (= j10 j8))
(assert (= j11 j9))
(assert (not (not (= (divides arg2 arg1) true))))
(check-sat)
(exit)
