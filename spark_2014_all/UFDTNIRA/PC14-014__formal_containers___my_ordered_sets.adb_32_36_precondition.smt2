...
(assert (and (= o6 (floor (mk___rep l__split_discrs l__split_fields8) 3)) (ite (= (ite (= (= (length (mk___rep l__split_discrs l__split_fields8)) 0) false) (< 3 (first_element (mk___rep l__split_discrs l__split_fields8))) true) true) (= (bool_eq1 o6 no_element) true) (and (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields8)) o6) true) (not (< 3 (get1 (elements (mk___rep l__split_discrs l__split_fields8)) (get (positions (mk___rep l__split_discrs l__split_fields8)) o6))))) (= (e_is_find (elements (mk___rep l__split_discrs l__split_fields8)) 3 (get (positions (mk___rep l__split_discrs l__split_fields8)) o6)) true)))))
(assert (and (= o5 (positions (mk___rep l__split_discrs l__split_fields8))) (and (not (= (has_key o5 no_element) true)) (forall ((i us_rep1)) (=> (= (has_key o5 i) true) (and (and (<= 1 (get o5 i)) (<= (get o5 i) (length (mk___rep l__split_discrs l__split_fields8)))) (forall ((j us_rep1)) (=> (= (has_key o5 j) true) (=> (= (get o5 i) (get o5 j)) (= (bool_eq1 i j) true))))))))))
(assert (not (= (has_key o5 o6) true)))
(check-sat)
(exit)
