...
(assert (and (and (and (and (=> (<= 0 2147483647) (in_range2 b2)) (=> (<= 0 2147483647) (in_range2 t1))) (=> (<= 2 n) (dynamic_property 2 n i2))) (=> (<= 0 2147483647) (in_range2 a2))) (and (<= 2 i2) (<= i2 n))))
(assert (= t1 result3))
(assert (= t2 a2))
(assert (not (in_range1 (+ a2 b2))))
(check-sat)
(exit)
