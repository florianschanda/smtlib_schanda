...
(assert (and (= o19 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i2)) (in_range3 o19)))
(assert (and (= o18 (+ i2 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))) (in_range1 (+ i2 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))))))
(assert (and (= o17 (model__ (mk___rep l__split_discrs (us_split_fields__content l__split_fields8)))) (= (length1 o17) (length (mk___rep l__split_discrs (us_split_fields__content l__split_fields8))))))
(assert (not (<= 1 o18)))
(check-sat)
(exit)
