...
(assert (= i2 1))
(assert (=> (and (<= 1 i2) (<= i2 r27b)) (= temp___553 i2)))
(assert (=> (and (<= 1 i2) (<= i2 r27b)) (= temp___555 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
...
(assert (=> (and (<= 1 i2) (<= i2 r27b)) (= temp___554 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (=> (and (<= 1 i2) (<= i2 r27b)) (= temp___552 cu__split_fields1)))
(assert (=> (and (<= 1 i2) (<= i2 r27b)) (and (= l__split_discrs (mk___split_discrs temp___551)) (= l__split_fields temp___5511))))
(assert (=> (and (<= 1 i2) (<= i2 r27b)) (= temp___556 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (=> (and (<= 1 i2) (<= i2 r27b)) (= (has_key (positions (mk___rep l__split_discrs l__split_fields10)) (mk___rep1 cu__split_fields10)) true)))
(assert (=> (and (<= 1 i2) (<= i2 r27b)) (= (length (mk___rep l__split_discrs l__split_fields10)) (- (+ temp___554 i3) 1))))
(assert (=> (and (<= 1 i2) (<= i2 r27b)) (forall ((i10 Int)) (=> (and (<= 1 i10) (<= i10 temp___555)) (= (get (model__ (mk___rep l__split_discrs l__split_fields10)) i10) (get temp___556 i10))))))
(assert (=> (and (<= 1 i2) (<= i2 r27b)) (forall ((j Int)) (=> (and (<= 1 j) (<= j (- i3 1))) (= (get (model__ (mk___rep l__split_discrs l__split_fields10)) (+ j temp___557)) (get temp___558 j))))))
...
(assert (=> (and (<= 1 i2) (<= i2 r27b)) (and (= o1 (element (mk___rep l__split_discrs l__split_fields10) (mk___rep1 cu__split_fields10))) (and (in_range6 o1) (= o1 (get (model__ (mk___rep l__split_discrs l__split_fields10)) (get1 (positions (mk___rep l__split_discrs l__split_fields10)) (mk___rep1 cu__split_fields10))))))))
...
(assert (=> (and (<= 1 i2) (<= i2 r27b)) (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields10) no_element) false) (= (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields10)) (length (mk___rep l__split_discrs l__split_fields3))) true) true) (= (bool_eq1 (mk___rep1 cu__split_fields3) no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields3)) true) (= (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields3)) (+ (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields10)) 1))))))
...
(assert (and (= o4 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i1)) (in_range3 o4)))
(assert (and (= o3 (+ i1 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))) (in_range1 (+ i1 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))))))
