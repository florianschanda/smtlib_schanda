...
(assert (and (and (in_range5 k12) (< 0 k23)) (<= k12 k23)))
(assert (=> (<= (- 2147483648) 2147483647) (in_range1 k12)))
(assert (=> (<= (- 2147483648) 2147483647) (in_range1 k23)))
(assert (and (= o6 (* max k12)) (in_range1 (* max k12))))
(assert (= o7 (div1 o6 k23)))
