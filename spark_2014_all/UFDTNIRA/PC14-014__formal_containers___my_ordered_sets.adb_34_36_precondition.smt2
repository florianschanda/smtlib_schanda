...
(assert (and (= o9 (ceiling (mk___rep l__split_discrs l__split_fields8) 1)) (ite (= (ite (= (= (length (mk___rep l__split_discrs l__split_fields8)) 0) false) (< (last_element (mk___rep l__split_discrs l__split_fields8)) 1) true) true) (= (bool_eq1 o9 no_element) true) (and (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields8)) o9) true) (not (< (get1 (elements (mk___rep l__split_discrs l__split_fields8)) (get (positions (mk___rep l__split_discrs l__split_fields8)) o9)) 1))) (= (e_is_find (elements (mk___rep l__split_discrs l__split_fields8)) 1 (get (positions (mk___rep l__split_discrs l__split_fields8)) o9)) true)))))
(assert (and (= o8 (positions (mk___rep l__split_discrs l__split_fields8))) (and (not (= (has_key o8 no_element) true)) (forall ((i us_rep1)) (=> (= (has_key o8 i) true) (and (and (<= 1 (get o8 i)) (<= (get o8 i) (length (mk___rep l__split_discrs l__split_fields8)))) (forall ((j us_rep1)) (=> (= (has_key o8 j) true) (=> (= (get o8 i) (get o8 j)) (= (bool_eq1 i j) true))))))))))
(assert (not (= (has_key o8 o9) true)))
(check-sat)
(exit)
