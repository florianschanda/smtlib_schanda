...
(assert (and (= o3 (elements (mk___rep s__split_discrs s__split_fields1))) (and (and (and (= (length2 o3) (length (mk___rep s__split_discrs s__split_fields1))) (forall ((temp___390 Int)) (=> (and (in_range4 temp___390) (= (iter_has_element o3 temp___390) true)) (= (contains (model__ (mk___rep s__split_discrs s__split_fields1)) (get o3 temp___390)) true)))) (forall ((item Int)) (=> (and (in_range7 item) (= (contains (model__ (mk___rep s__split_discrs s__split_fields1)) item) true)) (and (< 0 (find o3 item)) (= (equivalent_elements (get o3 (find o3 item)) item) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep s__split_discrs s__split_fields1)))) (and (= (find o3 (get o3 i1)) i1) (= (e_is_find o3 (get o3 i1) i1) true)))))))
