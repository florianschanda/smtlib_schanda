...
(assert (= result3 y))
(assert (= y1 1))
(assert (=> (not (= d1 1)) (= temp___183 w)))
(assert (=> (not (= d1 1)) (= temp___182 r)))
(assert (=> (not (= d1 1)) (= temp___181 q)))
(assert (=> (not (= d1 1)) (= temp___180 d1)))
(assert (=> (not (= d1 1)) (= temp___179 c1)))
(assert (=> (not (= d1 1)) (= temp___178 y1)))
(assert (=> (not (= d1 1)) (= temp___177 x1)))
