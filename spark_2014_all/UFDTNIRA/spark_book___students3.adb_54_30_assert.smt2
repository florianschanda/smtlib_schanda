...
(assert (and (and (<= 0 (to_fixed2 tuition)) (<= (to_fixed2 tuition) 3000000)) (and (<= 0 (to_fixed2 insurance2)) (<= (to_fixed2 insurance2) 100000))))
(assert (=> (= (rec__students3__student_record__part_time (us_split_fields3 student)) true) (= (to_fixed2 o2) 10000)))
...
(assert (=> (not (= (rec__students3__student_record__part_time (us_split_fields3 student)) true)) (= (to_fixed2 o3) 50000)))
...
(assert (=> (= (rec__students3__student_record__resident (us_split_fields3 student)) true) (= (to_fixed2 o4) (+ (to_fixed2 fees1) 400000))))
...
(assert (=> (= (rec__students3__student_record__resident (us_split_fields3 student)) true) (=> (not (= (to_rep1 (rec__students3__student_record__meal_plan (us_split_fields3 student))) 0)) (=> (= (to_rep1 (rec__students3__student_record__meal_plan (us_split_fields3 student))) 1) (= (to_fixed2 o5) (+ (to_fixed2 fees3) 10000))))))
...
(assert (=> (not (= (rec__students3__student_record__resident (us_split_fields3 student)) true)) (=> (not (= (to_rep1 (rec__students3__student_record__meal_plan (us_split_fields3 student))) 0)) (=> (= (to_rep1 (rec__students3__student_record__meal_plan (us_split_fields3 student))) 1) (= (to_fixed2 o8) (+ (to_fixed2 fees1) 20000))))))
...
(assert (not (<= 0 (to_fixed2 tuition))))
(check-sat)
(exit)
