...
(define-fun dynamic_invariant1 ((temp___expr_158 Int) (temp___is_init_154 Bool) (temp___skip_constant_155 Bool) (temp___do_toplevel_156 Bool) (temp___do_typ_inv_157 Bool)) Bool (=> (or (= temp___is_init_154 true) (<= (- 45) 45)) (in_range2 temp___expr_158)))
...
(define-fun dynamic_invariant2 ((temp___expr_200 Int) (temp___is_init_196 Bool) (temp___skip_constant_197 Bool) (temp___do_toplevel_198 Bool) (temp___do_typ_inv_199 Bool)) Bool (=> (or (= temp___is_init_196 true) (<= 0 100)) (in_range3 temp___expr_200)))
...
(define-fun dynamic_invariant3 ((temp___expr_221 Int) (temp___is_init_217 Bool) (temp___skip_constant_218 Bool) (temp___do_toplevel_219 Bool) (temp___do_typ_inv_220 Bool)) Bool (=> (or (= temp___is_init_217 true) (<= (- 100) 100)) (in_range4 temp___expr_221)))
...
(define-fun dynamic_invariant4 ((temp___expr_235 Int) (temp___is_init_231 Bool) (temp___skip_constant_232 Bool) (temp___do_toplevel_233 Bool) (temp___do_typ_inv_234 Bool)) Bool (=> (or (= temp___is_init_231 true) (<= 0 100)) (in_range5 temp___expr_235)))
(declare-fun inverse (Int Int) Int)
(declare-fun inverse__function_guard (Int Int Int) Bool)
(assert (forall ((val__ Int) (flatness Int)) (! (=> (and (and (dynamic_invariant3 val__ true true true true) (dynamic_invariant flatness true true true true)) (and (and (<= 0 val__) (< 0 flatness)) (<= flatness 100))) (dynamic_invariant4 (inverse val__ flatness) true false true true)) :pattern ((inverse val__ flatness)))))
