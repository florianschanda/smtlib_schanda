...
(assert (= delta_y1 o3))
(assert (and (= o4 (* (to_rep1 (rec__shapes5__circle__radius (us_split_fields1 c))) (to_rep1 (rec__shapes5__circle__radius (us_split_fields1 c))))) (in_range (* (to_rep1 (rec__shapes5__circle__radius (us_split_fields1 c))) (to_rep1 (rec__shapes5__circle__radius (us_split_fields1 c)))))))
