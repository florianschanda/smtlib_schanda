...
(assert (and (= o21 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) o20)) (in_range4 o21)))
(assert (and (= o18 (+ i1 n2)) (in_range1 (+ i1 n2))))
(assert (and (= o19 o18) (in_range3 o18)))
(assert (and (= o17 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2)))) (= (length1 o17) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields2))))))
(assert (not (<= 1 o19)))
(check-sat)
(exit)
