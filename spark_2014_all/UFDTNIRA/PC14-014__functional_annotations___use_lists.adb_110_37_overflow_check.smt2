...
(assert (and (= o2 (* 2 i)) (in_range6 (* 2 i))))
(assert (= o3 (- o2 1)))
...
(assert (and (= o7 (get o1 o5)) (in_range2 o7)))
(assert (= o8 (ite (= o7 o6) true false)))
(assert (and (= o (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i)) (in_range2 o)))
