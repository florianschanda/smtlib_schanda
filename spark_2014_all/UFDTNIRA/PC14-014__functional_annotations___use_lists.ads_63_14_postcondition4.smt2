...
(assert (= result2 true))
(assert (= temp___527 cu__split_fields1))
(assert (= temp___528 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))))
(assert (= temp___530 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))))
(assert (= temp___532 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))))
(assert (= temp___529 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))))
(assert (and (= l__split_discrs (mk___split_discrs temp___526)) (= l__split_fields temp___5261)))
(assert (= temp___525 n1))
(assert (= temp___531 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))))
(assert (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (+ temp___528 n2)))
(assert (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 n2)) (and (= (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (* 2 i3)) (get temp___529 i3)) (= (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (- (* 2 i3) 1)) (get temp___530 i3))))))
(assert (forall ((i3 Int)) (=> (and (<= (+ n2 1) i3) (<= i3 temp___531)) (= (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (+ i3 n2)) (get temp___532 i3)))))
...
(assert (= cu__split_fields4 (mk___split_fields__ref1 (mk___split_fields1 cu__split_fields3))))
(assert (= l__split_fields4 (mk___split_fields__ref (mk___split_fields l__split_fields3))))
(assert (= n5 n3))
(assert (= cu__split_fields5 (mk___split_fields1 cu__split_fields3)))
(assert (= l__split_fields5 (mk___split_fields l__split_fields3)))
(assert (= n6 n4))
(assert (= cu__split_fields6 cu__split_fields4))
(assert (= l__split_fields6 l__split_fields4))
(assert (= n7 n5))
(assert (= cu__split_fields7 cu__split_fields5))
(assert (= l__split_fields7 l__split_fields5))
(assert (= n8 n6))
