...
(define-fun default_initial_assumption ((temp___expr_413 us_rep2) (temp___skip_top_level_414 Bool)) Bool (=> (not (= temp___skip_top_level_414 true)) (and (= (is_empty temp___expr_413) true) (= (length1 temp___expr_413) 0))))
...
(assert (forall ((left us_rep) (right us_rep)) (! (= (= (equivalent_sets left right) true) (= (oeq2 (model__ left) (model__ right)) true)) :pattern ((equivalent_sets left right)))))
...
(define-fun e_elements_included__2 ((left us_rep3) (model__1 us_rep4) (right us_rep3)) Bool (ite (forall ((i Int)) (=> (and (<= 1 i) (<= i (length2 left))) (=> (= (contains model__1 (get1 left i)) true) (and (< 0 (find right (get1 left i))) (= (get1 right (find right (get1 left i))) (get1 left i)))))) true false))
...
(define-fun e_elements_included__3 ((container us_rep3) (model__1 us_rep4) (left us_rep3) (right us_rep3)) Bool (ite (forall ((i Int)) (=> (and (<= 1 i) (<= i (length2 container))) (ite (= (contains model__1 (get1 container i)) true) (and (< 0 (find left (get1 container i))) (= (get1 left (find left (get1 container i))) (get1 container i))) (and (< 0 (find right (get1 container i))) (= (get1 right (find right (get1 container i))) (get1 container i)))))) true false))
...
(define-fun default_initial_assumption3 ((temp___expr_390 us_rep3) (temp___skip_top_level_391 Bool)) Bool (=> (not (= temp___skip_top_level_391 true)) (= (length2 temp___expr_390) 0)))
(assert (forall ((container us_rep3)) (forall ((item Int)) (! (=> (dynamic_invariant2 item true true true true) (let ((result (find container item))) (and (=> (< 0 result) (and (<= result (length2 container)) (= (equivalent_elements item (get1 container result)) true))) (dynamic_invariant result true false true true)))) :pattern ((find container item))))))
...
(define-fun default_initial_assumption4 ((temp___expr_354 us_rep4) (temp___skip_top_level_355 Bool)) Bool (=> (not (= temp___skip_top_level_355 true)) (= (is_empty2 temp___expr_354) true)))
...
(assert (forall ((container us_rep4)) (! (let ((result (is_empty2 container))) (and (= (= result true) (forall ((item Int)) (not (and (in_range8 item) (= (contains container item) true))))) (= (= result true) (= (length3 container) 0)))) :pattern ((is_empty2 container)))))
...
(assert (forall ((left us_rep2) (right us_rep2)) (! (= (= (oeq3 left right) true) (and (forall ((key us_rep1)) (=> (= (has_key left key) true) (and (= (has_key right key) true) (= (get right key) (get left key))))) (forall ((key us_rep1)) (=> (= (has_key right key) true) (= (has_key left key) true))))) :pattern ((oeq3 left right)))))
...
(declare-const temp___1140 us_rep1)
(declare-const temp___1142 us_rep1)
...
(assert (and (= temp___1140 (find1 (mk___rep l__split_discrs l__split_fields13) 3)) (ite (ite (= (contains (model__ (mk___rep l__split_discrs l__split_fields13)) 3) false) true false) (and (not (= (has_key (positions (mk___rep l__split_discrs l__split_fields13)) temp___1140) true)) (= (bool_eq1 temp___1140 no_element) true)) (and (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields13)) temp___1140) true) (= (get (positions (mk___rep l__split_discrs l__split_fields13)) temp___1140) (find (elements (mk___rep l__split_discrs l__split_fields13)) 3))) (= (equivalent_elements (element (mk___rep l__split_discrs l__split_fields13) temp___1140) 3) true)))))
(assert (= result22 (mk___split_fields__ref1 c__split_fields3)))
(assert (= c__split_fields4 (us_split_fields3 temp___1140)))
