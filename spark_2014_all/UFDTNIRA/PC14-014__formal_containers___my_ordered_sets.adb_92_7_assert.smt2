...
(define-fun temp___10591 () us_rep1 (mk___rep1 (mk___split_fields1 temp___1059)))
(define-fun temp___10581 () us_rep1 (mk___rep1 (mk___split_fields1 temp___1058)))
(assert (= (to_rep o) 0))
(assert (= o o1))
...
(assert (and (= temp___10581 (first (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (ite (= (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 0) true) (= (bool_eq1 temp___10581 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) temp___10581) true) (= (get (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) temp___10581) 1)))))
...
(assert (and (= temp___10591 (next (mk___rep l__split_discrs (mk___split_fields l__split_fields)) (mk___rep1 c__split_fields1))) (ite (= (ite (= (bool_eq1 (mk___rep1 c__split_fields1) no_element) false) (= (get (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 c__split_fields1)) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true) true) (= (bool_eq1 temp___10591 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) temp___10591) true) (= (get (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) temp___10591) (+ (get (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 c__split_fields1)) 1))))))
...
(assert (not (not (= (length (mk___rep l__split_discrs l__split_fields16)) 0))))
(check-sat)
(exit)
