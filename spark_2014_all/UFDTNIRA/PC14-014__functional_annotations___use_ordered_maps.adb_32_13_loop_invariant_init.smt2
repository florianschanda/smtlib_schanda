...
(assert (= (iter_has_element (keys (mk___rep r__split_discrs (mk___split_fields r__split_fields))) temp___649) true))
(assert (not (exists ((i3 Int)) (and (and (<= 1 i3) (<= i3 (- (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields1))) 1))) (= (get2 (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields))) (get (keys (mk___rep r__split_discrs (mk___split_fields r__split_fields))) temp___649)) (f (get2 (model__ s) (get (keys s) i3))))))))
(check-sat)
(exit)
