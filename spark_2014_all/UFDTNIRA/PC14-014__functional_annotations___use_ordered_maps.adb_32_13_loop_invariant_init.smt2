...
(assert (= result1 true))
(define-fun temp___693 () us_rep3 (keys (mk___rep r__split_discrs r__split_fields1)))
(declare-const temp___692 Int)
(assert (in_range3 temp___692))
(assert (= (iter_has_element temp___693 temp___692) true))
(assert (not (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields2)) 1))) (= (get2 (model__ (mk___rep r__split_discrs r__split_fields1)) (get temp___693 temp___692)) (f (get2 (model__ s) (get (keys s) i))))))))
(check-sat)
(exit)
