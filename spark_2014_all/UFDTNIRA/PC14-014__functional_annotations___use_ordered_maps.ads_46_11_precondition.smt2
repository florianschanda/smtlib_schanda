...
(assert (= (= o36 true) (let ((temp___699 (keys s))) (forall ((temp___698 Int)) (=> (and (in_range3 temp___698) (= (iter_has_element temp___699 temp___698) true)) (let ((k3 (get temp___699 temp___698))) (and (= (has_key (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) k3) true) (= (get2 (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) k3) (f (get2 (model__ s) k3))))))))))
(assert (not true))
(check-sat)
(exit)
