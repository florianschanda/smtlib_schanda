...
(assert (and (= o1 (element (mk___rep l__split_discrs l__split_fields3) (mk___rep1 cu__split_fields4))) (and (in_range6 o1) (= o1 (get (model__ (mk___rep l__split_discrs l__split_fields3)) (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields4)))))))
...
(assert (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields4) no_element) false) (= (get1 (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 cu__split_fields4)) (length (mk___rep l__split_discrs l__split_fields2))) true) true) (= (bool_eq1 (mk___rep1 cu__split_fields3) no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 cu__split_fields3)) true) (= (get1 (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 cu__split_fields3)) (+ (get1 (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 cu__split_fields4)) 1)))))
(assert (not (= i2 r27b)))
