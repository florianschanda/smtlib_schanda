...
(assert (<= 1 i3))
(assert (<= i3 r27b))
(assert (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (mk___rep1 (mk___split_fields1 cu__split_fields2))) true))
(assert (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (- (+ (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i4) 1)))
(assert (forall ((i12 Int)) (=> (and (<= 1 i12) (<= i12 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))) (= (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) i12) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i12)))))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- i4 1))) (= (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (+ j1 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) j1)))))
(assert (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (mk___rep1 (mk___split_fields1 cu__split_fields2))) i4))
(assert (and (=> (<= 1 r27b) (dynamic_property 1 r27b i4)) (and (<= 1 i4) (<= i4 r27b))))
(assert (and (= o12 (element (mk___rep l__split_discrs (mk___split_fields l__split_fields2)) (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range6 o12) (= o12 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (mk___rep1 (mk___split_fields1 cu__split_fields2))))))))
(assert (and (and (and (and (and (= (length (mk___rep l__split_discrs l__split_fields3)) (+ (length (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) 1)) (= (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (last1 (mk___rep l__split_discrs l__split_fields3))) (length (mk___rep l__split_discrs l__split_fields3)))) (= (keys_included_except (positions (mk___rep l__split_discrs l__split_fields3)) (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (last1 (mk___rep l__split_discrs l__split_fields3))) true)) (= (ole1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (positions (mk___rep l__split_discrs l__split_fields3))) true)) (= (get (model__ (mk___rep l__split_discrs l__split_fields3)) (length (mk___rep l__split_discrs l__split_fields3))) o12)) (= (ole (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (model__ (mk___rep l__split_discrs l__split_fields3))) true)))
(assert (ite (= (ite (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields2)) no_element) false) (= (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 (mk___split_fields1 cu__split_fields2))) (length (mk___rep l__split_discrs l__split_fields3))) true) true) (= (bool_eq1 (mk___rep1 cu__split_fields3) no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields3)) true) (= (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields3)) (+ (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1)))))
(assert (not (= i4 r27b)))
...
(assert (<= 1 j1))
(assert (<= j1 (- i5 1)))
(assert (not (= (get (model__ (mk___rep l__split_discrs l__split_fields3)) (+ j1 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) j1))))
(check-sat)
(exit)
