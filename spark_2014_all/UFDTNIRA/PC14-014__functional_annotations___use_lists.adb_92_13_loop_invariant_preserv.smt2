...
(assert (<= 1 i1))
(assert (<= i1 r27b))
(assert (= (has_key (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields4)) true))
(assert (= (length (mk___rep l__split_discrs l__split_fields3)) (- (+ (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i2) 1)))
(assert (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))) (= (get (model__ (mk___rep l__split_discrs l__split_fields3)) i4) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i4)))))
(assert (forall ((j Int)) (=> (and (<= 1 j) (<= j (- i2 1))) (= (get (model__ (mk___rep l__split_discrs l__split_fields3)) (+ j (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) j)))))
(assert (= (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields4)) i2))
(assert (and (=> (<= 1 r27b) (dynamic_property 1 r27b i2)) (and (<= 1 i2) (<= i2 r27b))))
(assert (and (= o1 (element (mk___rep l__split_discrs l__split_fields3) (mk___rep1 cu__split_fields4))) (and (in_range5 o1) (= o1 (get (model__ (mk___rep l__split_discrs l__split_fields3)) (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields4)))))))
(assert (and (and (and (and (and (= (length (mk___rep l__split_discrs l__split_fields2)) (+ (length (mk___rep l__split_discrs l__split_fields3)) 1)) (= (get1 (positions (mk___rep l__split_discrs l__split_fields2)) (last1 (mk___rep l__split_discrs l__split_fields2))) (length (mk___rep l__split_discrs l__split_fields2)))) (= (keys_included_except (positions (mk___rep l__split_discrs l__split_fields2)) (positions (mk___rep l__split_discrs l__split_fields3)) (last1 (mk___rep l__split_discrs l__split_fields2))) true)) (= (ole1 (positions (mk___rep l__split_discrs l__split_fields3)) (positions (mk___rep l__split_discrs l__split_fields2))) true)) (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) (length (mk___rep l__split_discrs l__split_fields2))) o1)) (= (ole (model__ (mk___rep l__split_discrs l__split_fields3)) (model__ (mk___rep l__split_discrs l__split_fields2))) true)))
(assert (ite (= (ite (= (bool_eq2 (mk___rep1 cu__split_fields4) no_element) false) (= (get1 (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 cu__split_fields4)) (length (mk___rep l__split_discrs l__split_fields2))) true) true) (= (bool_eq2 (mk___rep1 cu__split_fields3) no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 cu__split_fields3)) true) (= (get1 (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 cu__split_fields3)) (+ (get1 (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 cu__split_fields4)) 1)))))
(assert (not (= i2 r27b)))
...
(assert (<= 1 j))
(assert (<= j (- i3 1)))
(assert (not (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) (+ j (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) j))))
(check-sat)
(exit)
