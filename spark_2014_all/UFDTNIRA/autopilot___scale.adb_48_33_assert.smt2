...
(assert (=> (< present target) (= result1 gap)))
(assert (=> (< present target) (= gap2 (- target present))))
(assert (=> (not (< present target)) (= result2 gap)))
(assert (=> (not (< present target)) (= gap3 (- present target))))
(assert (=> (not (< present target)) (= gap2 gap3)))
(assert (=> (< 100 gap2) (= result3 gap2)))
(assert (=> (< 100 gap2) (= gap4 100)))
(assert (=> (not (< 100 gap2)) (= gap4 gap2)))
(assert (not (< 0 gap4)))
(check-sat)
(exit)
