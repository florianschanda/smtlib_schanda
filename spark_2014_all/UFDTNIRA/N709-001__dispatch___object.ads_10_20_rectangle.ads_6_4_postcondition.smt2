...
(assert (not (= (has_stored_area (mk___rep (mk___split_fields rec____split_fields20 rec____split_fields21 rec____split_fields22 (hide_ext__ rec____split_fields18 rec____split_fields19 rec____split_fields23)) rec____attr__tag)) true)))
(check-sat)
(exit)
