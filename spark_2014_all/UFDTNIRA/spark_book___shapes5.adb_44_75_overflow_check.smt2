...
(assert true)
(define-fun dynamic_invariant1 ((temp___expr_158 Int) (temp___is_init_154 Bool) (temp___skip_constant_155 Bool) (temp___do_toplevel_156 Bool) (temp___do_typ_inv_157 Bool)) Bool (=> (or (= temp___is_init_154 true) (<= (- 100) 100)) (in_range1 temp___expr_158)))
(declare-const x Int)
...
(define-fun dynamic_invariant2 ((temp___expr_182 Int) (temp___is_init_178 Bool) (temp___skip_constant_179 Bool) (temp___do_toplevel_180 Bool) (temp___do_typ_inv_181 Bool)) Bool (=> (or (= temp___is_init_178 true) (<= 0 200)) (in_range3 temp___expr_182)))
...
(assert (and (= o (abs (- x (to_rep (rec__shapes5__circle__center_x (us_split_fields1 c)))))) (in_range (abs (- x (to_rep (rec__shapes5__circle__center_x (us_split_fields1 c))))))))
(assert (and (= o1 o) (in_range3 o)))
(assert (= result delta_x))
(assert (= delta_x1 o1))
(assert (and (= o2 (abs (- y (to_rep (rec__shapes5__circle__center_y (us_split_fields1 c)))))) (in_range (abs (- y (to_rep (rec__shapes5__circle__center_y (us_split_fields1 c))))))))
(assert (and (= o3 o2) (in_range3 o2)))
(assert (= result1 delta_y))
(assert (= delta_y1 o3))
(assert (not (in_range (* (to_rep1 (rec__shapes5__circle__radius (us_split_fields1 c))) (to_rep1 (rec__shapes5__circle__radius (us_split_fields1 c)))))))
(check-sat)
(exit)
