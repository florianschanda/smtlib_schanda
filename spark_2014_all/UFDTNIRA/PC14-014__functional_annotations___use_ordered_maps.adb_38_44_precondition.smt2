...
(assert (and (= o29 (keys s)) (and (and (and (= (length3 o29) (length s)) (forall ((temp___396 Int)) (=> (and (in_range3 temp___396) (= (iter_has_element o29 temp___396) true)) (= (has_key (model__ s) (get o29 temp___396)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true)) (and (< 0 (find o29 key2)) (= (equivalent_keys (get o29 (find o29 key2)) key2) true))))) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 (length s))) (and (= (find o29 (get o29 i3)) i3) (= (k_is_find o29 (get o29 i3) i3) true)))))))
(assert (not (<= 1 o30)))
(check-sat)
(exit)
