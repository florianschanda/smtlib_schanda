...
(assert (= p__ident__4__result1 p__ident__4__result2))
(assert (= p__ident__4__result3 p__ident__4__result1))
(assert (= (to_fixed1 o) (- (+ (to_fixed1 m) 1) 1)))
(assert (= result p__ident__4__result))
(assert (= p__ident__4__result1 o))
(assert (= (mk_money__ref p__ident__4__result4) (mk_money__ref p__ident__4__result2)))
(assert (= p__ident__4__result5 p__ident__4__result3))
(assert (= result1 p__ident__4__result4))
(assert (not (= (to_fixed1 p__ident__4__result4) (to_fixed1 m))))
(check-sat)
(exit)
