...
(declare-sort fp1 0)
(define-fun in_range1 ((x Int)) Bool (and (<= (- 30) x) (<= x 30)))
...
(declare-const dummy fp1)
(declare-fun attr__ATTRIBUTE_IMAGE1 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check1 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE1 (us_image) Int)
(declare-fun to_fixed (fp1) Int)
(declare-fun of_fixed (Int) fp1)
(declare-fun user_eq (fp1 fp1) Bool)
...
(assert (forall ((x fp1)) (! (= (of_fixed (to_fixed x)) x) :pattern ((to_fixed x)))))
(assert (forall ((x fp1)) (in_range1 (to_fixed x))))
...
(declare-sort fp2 0)
(define-fun in_range2 ((x Int)) Bool (and (<= (- 50) x) (<= x 50)))
(declare-const dummy1 fp2)
(declare-fun attr__ATTRIBUTE_IMAGE2 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check2 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE2 (us_image) Int)
(declare-fun to_fixed1 (fp2) Int)
(declare-fun of_fixed1 (Int) fp2)
(declare-fun user_eq1 (fp2 fp2) Bool)
...
(assert (forall ((x Int)) (! (ite (= x 0) (= (to_int2 x) 0) (ite (< 0 x) (pos_div_relation (to_int2 x) (* x 1) 5) (pos_div_relation (- (to_int2 x)) (* (- x) 1) 5))) :pattern ((to_int2 x)))))
(declare-fun of_int1 (Int) Int)
(assert (forall ((x Int)) (! (ite (= x 0) (= (of_int1 x) 0) (ite (< 0 x) (pos_div_relation (of_int1 x) (* x 5) 1) (pos_div_relation (- (of_int1 x)) (* (- x) 5) 1))) :pattern ((of_int1 x)))))
(assert (forall ((x fp2)) (! (= (of_fixed1 (to_fixed1 x)) x) :pattern ((to_fixed1 x)))))
(assert (forall ((x fp2)) (in_range2 (to_fixed1 x))))
...
(declare-const dummy2 tfp3B)
(declare-fun attr__ATTRIBUTE_IMAGE3 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check3 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE3 (us_image) Int)
(declare-fun to_fixed2 (tfp3B) Int)
(declare-fun of_fixed2 (Int) tfp3B)
(declare-fun user_eq2 (tfp3B tfp3B) Bool)
...
(assert (forall ((x Int)) (! (ite (= x 0) (= (to_int3 x) 0) (ite (< 0 x) (pos_div_relation (to_int3 x) (* x 1) 15) (pos_div_relation (- (to_int3 x)) (* (- x) 1) 15))) :pattern ((to_int3 x)))))
(declare-fun of_int2 (Int) Int)
(assert (forall ((x Int)) (! (ite (= x 0) (= (of_int2 x) 0) (ite (< 0 x) (pos_div_relation (of_int2 x) (* x 15) 1) (pos_div_relation (- (of_int2 x)) (* (- x) 15) 1))) :pattern ((of_int2 x)))))
(assert (forall ((x tfp3B)) (! (= (of_fixed2 (to_fixed2 x)) x) :pattern ((to_fixed2 x)))))
(assert (forall ((x tfp3B)) (in_range3 (to_fixed2 x))))
...
(declare-sort fp3 0)
(define-fun in_range4 ((x Int)) Bool (and (<= (- 150) x) (<= x 150)))
(declare-const dummy3 fp3)
(declare-fun attr__ATTRIBUTE_IMAGE4 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check4 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE4 (us_image) Int)
(declare-fun to_fixed3 (fp3) Int)
(declare-fun of_fixed3 (Int) fp3)
(declare-fun user_eq3 (fp3 fp3) Bool)
...
(assert (forall ((x Int)) (! (ite (= x 0) (= (to_int4 x) 0) (ite (< 0 x) (pos_div_relation (to_int4 x) (* x 1) 15) (pos_div_relation (- (to_int4 x)) (* (- x) 1) 15))) :pattern ((to_int4 x)))))
(declare-fun of_int3 (Int) Int)
(assert (forall ((x Int)) (! (ite (= x 0) (= (of_int3 x) 0) (ite (< 0 x) (pos_div_relation (of_int3 x) (* x 15) 1) (pos_div_relation (- (of_int3 x)) (* (- x) 15) 1))) :pattern ((of_int3 x)))))
(assert (forall ((x fp3)) (! (= (of_fixed3 (to_fixed3 x)) x) :pattern ((to_fixed3 x)))))
(assert (forall ((x fp3)) (in_range4 (to_fixed3 x))))
...
(declare-const dummy4 tfp4B)
(declare-fun attr__ATTRIBUTE_IMAGE5 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check5 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE5 (us_image) Int)
(declare-fun to_fixed4 (tfp4B) Int)
(declare-fun of_fixed4 (Int) tfp4B)
(declare-fun user_eq4 (tfp4B tfp4B) Bool)
...
(assert (forall ((x Int)) (! (ite (= x 0) (= (to_int5 x) 0) (ite (< 0 x) (pos_div_relation (to_int5 x) (* x 1) 30) (pos_div_relation (- (to_int5 x)) (* (- x) 1) 30))) :pattern ((to_int5 x)))))
(declare-fun of_int4 (Int) Int)
(assert (forall ((x Int)) (! (ite (= x 0) (= (of_int4 x) 0) (ite (< 0 x) (pos_div_relation (of_int4 x) (* x 30) 1) (pos_div_relation (- (of_int4 x)) (* (- x) 30) 1))) :pattern ((of_int4 x)))))
(assert (forall ((x tfp4B)) (! (= (of_fixed4 (to_fixed4 x)) x) :pattern ((to_fixed4 x)))))
(assert (forall ((x tfp4B)) (in_range5 (to_fixed4 x))))
...
(declare-sort fp4 0)
(define-fun in_range6 ((x Int)) Bool (and (<= (- 300) x) (<= x 300)))
(declare-const dummy5 fp4)
(declare-fun attr__ATTRIBUTE_IMAGE6 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check6 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE6 (us_image) Int)
(declare-fun to_fixed5 (fp4) Int)
(declare-fun of_fixed5 (Int) fp4)
(declare-fun user_eq5 (fp4 fp4) Bool)
...
(assert (forall ((x Int)) (! (ite (= x 0) (= (to_int6 x) 0) (ite (< 0 x) (pos_div_relation (to_int6 x) (* x 1) 30) (pos_div_relation (- (to_int6 x)) (* (- x) 1) 30))) :pattern ((to_int6 x)))))
(declare-fun of_int5 (Int) Int)
(assert (forall ((x Int)) (! (ite (= x 0) (= (of_int5 x) 0) (ite (< 0 x) (pos_div_relation (of_int5 x) (* x 30) 1) (pos_div_relation (- (of_int5 x)) (* (- x) 30) 1))) :pattern ((of_int5 x)))))
(assert (forall ((x fp4)) (! (= (of_fixed5 (to_fixed5 x)) x) :pattern ((to_fixed5 x)))))
(assert (forall ((x fp4)) (in_range6 (to_fixed5 x))))
...
(declare-const u fp3)
(declare-const o fp3)
(declare-const result fp3)
(declare-const u1 fp3)
(assert (and (= (to_fixed x) 3) (= (to_fixed1 y) 5)))
(assert (= (to_fixed3 o) (fxp_mult (to_fixed x) (to_fixed1 y))))
(assert (= (mk_fp3__ref result) (mk_fp3__ref u)))
(assert (= u1 o))
(assert (not (in_range6 (fxp_mult1 (to_fixed x) (to_fixed1 y)))))
(check-sat)
(exit)
