...
(assert (<= 1 i4))
(assert (<= i4 n1))
(assert (not (= (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (* 2 i4)) (+ (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) i4) 1))))
(check-sat)
(exit)
