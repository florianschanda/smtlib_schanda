...
(assert (<= 1 i))
(assert (<= i n1))
(assert (not (= (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (- (* 2 i) 1)) (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) i))))
(check-sat)
(exit)
