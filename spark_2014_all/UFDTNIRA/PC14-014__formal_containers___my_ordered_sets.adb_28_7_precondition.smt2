...
(assert (not (or (< (length (mk___rep l__split_discrs l__split_fields6)) (to_rep (rec__my_ordered_sets__m__set__capacity l__split_discrs))) (= (contains (model__ (mk___rep l__split_discrs l__split_fields6)) 1) true))))
(check-sat)
(exit)
