...
(assert (forall ((a Int) (b Int)) (! (=> (and (and (dynamic_invariant a true true true) (dynamic_invariant b true true true)) (and (not (= a (- 2147483648))) (not (= b (- 2147483648))))) (let ((result (pgcd a b))) (and (or (or (= result 0) (and (<= 1 result) (<= result (abs a)))) (and (<= 1 result) (<= result (abs b)))) (dynamic_invariant result true false true)))) :pattern ((pgcd a b)))))
(declare-const a Int)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const b Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(define-fun dynamic_invariant1 ((temp___expr_27 Int) (temp___is_init_24 Bool) (temp___skip_constant_25 Bool) (temp___do_toplevel_26 Bool)) Bool (=> (or (= temp___is_init_24 true) (<= (- 9223372036854775808) 9223372036854775807)) (in_range2 temp___expr_27)))
(declare-const r Int)
...
(assert (and (= o3 (pgcd a b)) (and (in_range1 o3) (or (or (= o3 0) (and (<= 1 o3) (<= o3 (abs a)))) (and (<= 1 o3) (<= o3 (abs b)))))))
(assert (= (mk_int__ref result) (mk_int__ref r)))
(assert (= r1 o3))
(assert (in_range1 r1))
(assert (=> (not (= r1 0)) (and (= o4 (* a b)) (in_range1 (* a b)))))
(assert (=> (not (= r1 0)) (= o5 (div1 o4 r1))))
(assert (=> (not (= r1 0)) (and (= o6 o5) (in_range1 o5))))
(assert (=> (not (= r1 0)) (= r1 result1)))
(assert (=> (not (= r1 0)) (= r2 o6)))
(assert (=> (= r1 0) (= r2 r1)))
(assert (= a__ppcm__result1 a__ppcm__result2))
(assert (= a__ppcm__result3 a__ppcm__result1))
(assert (and (= o7 (abs r2)) (in_range1 (abs r2))))
(assert (= (mk_int__ref result2) (mk_int__ref a__ppcm__result)))
(assert (= a__ppcm__result1 o7))
...
(assert (and (= o14 (* a b)) (in_range1 (* a b))))
(assert (= o15 (abs o14)))
(assert (and (= o16 o15) (in_range1 o15)))
(assert (= o17 (ite (<= a__ppcm__result4 o16) true false)))
