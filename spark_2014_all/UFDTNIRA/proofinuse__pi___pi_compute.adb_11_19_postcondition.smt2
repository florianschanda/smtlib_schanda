...
(assert (and (and (and (= (to_fixed1 o) 1048576) (and (= (mk_fixed__ref result) (mk_fixed__ref t1)) (= t11 o))) (and (and (= (to_fixed1 o1) 349525) (and (= (mk_fixed__ref result1) (mk_fixed__ref t2)) (= t21 o1))) (and (and (= (to_fixed1 o2) 209715) (and (= (mk_fixed__ref result2) (mk_fixed__ref t3)) (= t31 o2))) (and (and (= (to_fixed1 o3) 149796) (and (= (mk_fixed__ref result3) (mk_fixed__ref t4)) (= t41 o3))) (and (and (= (to_fixed1 o4) 116508) (and (= (mk_fixed__ref result4) (mk_fixed__ref t5)) (= t51 o4))) (and (and (= (to_fixed1 o5) 95325) (and (= (mk_fixed__ref result5) (mk_fixed__ref t6)) (= t61 o5))) (and (and (= (to_fixed1 o6) 80659) (and (= (mk_fixed__ref result6) (mk_fixed__ref t7)) (= t71 o6))) (and (and (= (to_fixed1 o7) 69905) (and (= (mk_fixed__ref result7) (mk_fixed__ref t8)) (= t81 o7))) (and (and (= (to_fixed1 o8) 61680) (and (= (mk_fixed__ref result8) (mk_fixed__ref t9)) (= t91 o8))) (and (and (= (to_fixed1 o9) 55188) (and (= result9 (mk_fixed__ref t10)) (= t101 o9))) (and (and (= (to_fixed1 o10) (* (- (+ (- (+ (- (+ (- (+ (- (to_fixed1 t11) (to_fixed1 t21)) (to_fixed1 t31)) (to_fixed1 t41)) (to_fixed1 t51)) (to_fixed1 t61)) (to_fixed1 t71)) (to_fixed1 t81)) (to_fixed1 t91)) (to_fixed1 t101)) 4)) (and (= result10 (mk_fixed__ref res)) (= res1 o10))) (and (= (to_fixed1 res1) 3189596) (and (and (= pi_compute__leibniz_fixed__result2 (mk_fixed__ref pi_compute__leibniz_fixed__result1)) (= pi_compute__leibniz_fixed__result3 pi_compute__leibniz_fixed__result1)) (and (= result11 (mk_fixed__ref pi_compute__leibniz_fixed__result)) (= pi_compute__leibniz_fixed__result1 res1))))))))))))))) (and (and (= pi_compute__leibniz_fixed__result4 pi_compute__leibniz_fixed__result2) (and (= res2 (mk_fixed__ref res1)) (and (= t102 (mk_fixed__ref t101)) (and (= t92 (mk_fixed__ref t91)) (and (= t82 (mk_fixed__ref t81)) (and (= t72 (mk_fixed__ref t71)) (and (= t62 (mk_fixed__ref t61)) (and (= t52 (mk_fixed__ref t51)) (and (= t42 (mk_fixed__ref t41)) (and (= t32 (mk_fixed__ref t31)) (and (= t22 (mk_fixed__ref t21)) (= t12 (mk_fixed__ref t11))))))))))))) (and (= pi_compute__leibniz_fixed__result5 pi_compute__leibniz_fixed__result3) (and (= res3 res1) (and (= t103 t101) (and (= t93 t91) (and (= t83 t81) (and (= t73 t71) (and (= t63 t61) (and (= t53 t51) (and (= t43 t41) (and (= t33 t31) (and (= t23 t21) (= t13 t11)))))))))))))))
(assert (= result12 (fixed__content pi_compute__leibniz_fixed__result4)))
(assert (not (= (to_fixed1 (fixed__content pi_compute__leibniz_fixed__result4)) 3189596)))
(check-sat)
(exit)
