...
(define-fun dynamic_invariant ((temp___expr_158 Int) (temp___is_init_154 Bool) (temp___skip_constant_155 Bool) (temp___do_toplevel_156 Bool) (temp___do_typ_inv_157 Bool)) Bool (and (=> (or (= temp___is_init_154 true) (<= (- 2147483648) 2147483647)) (in_range1 temp___expr_158)) (=> (= temp___do_toplevel_156 true) (=> (= temp___is_init_154 true) (= (mod2 temp___expr_158 2) 0)))))
(define-fun dynamic_predicate ((temp___162 Int)) Bool (= (mod2 temp___162 2) 0))
...
(define-fun dynamic_predicate1 ((temp___208 us_rep)) Bool (= (to_rep (rec__dynamic_preds__even_pair__b (us_split_fields1 temp___208))) (+ (to_rep (rec__dynamic_preds__even_pair__a (us_split_fields1 temp___208))) 2)))
...
(assert (dynamic_invariant1 i11s true false false true))
