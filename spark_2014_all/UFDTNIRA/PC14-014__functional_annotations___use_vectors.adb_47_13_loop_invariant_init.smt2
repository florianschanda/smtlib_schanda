...
(assert (<= first i1))
(assert (<= i1 r17b))
(assert (not (= (length (mk___rep v__split_discrs (mk___split_fields v__split_fields))) (+ (length (mk___rep v__split_discrs (mk___split_fields v__split_fields))) (- i1 first)))))
(check-sat)
(exit)
