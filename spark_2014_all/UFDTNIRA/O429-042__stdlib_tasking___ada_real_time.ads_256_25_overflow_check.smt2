...
(define-fun dynamic_invariant ((temp___expr_179 Int) (temp___is_init_175 Bool) (temp___skip_constant_176 Bool) (temp___do_toplevel_177 Bool) (temp___do_typ_inv_178 Bool)) Bool (=> (or (= temp___is_init_175 true) (<= (- 9223372036854775808) 9223372036854775807)) (in_range1 temp___expr_179)))
(declare-fun ts_sc (us_rep) Int)
(declare-fun ts_sc__function_guard (Int us_rep) Bool)
(assert (forall ((ts us_rep)) (! (= (ts_sc ts) (to_int1 (to_fixed (to_duration__2 ts)))) :pattern ((ts_sc ts)))))
