...
(assert (<= 1 i4))
(assert (<= i4 (length (mk___rep s__split_discrs (mk___split_fields s__split_fields)))))
(assert (not (= (get (elements (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))) (- (* 2 i4) 1)) (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) i4))))
(check-sat)
(exit)
