...
(assert (forall ((x Int)) (forall ((y Int)) (! (ite (or (= x 0) (= y 0)) (= (fxp_mult3 x y) 0) (ite (or (and (< 0 x) (< 0 y)) (and (< x 0) (< y 0))) (pos_div_relation3 (fxp_mult3 x y) (* x y) 1000000000) (pos_div_relation3 (- (fxp_mult3 x y)) (- (* x y)) 1000000000))) :pattern ((fxp_mult3 x y))))))
(declare-fun fxp_div3 (Int Int) Int)
(assert (forall ((x Int)) (forall ((y Int)) (! (ite (= x 0) (= (fxp_div3 x y) 0) (ite (and (< 0 x) (< 0 y)) (pos_div_relation3 (fxp_div3 x y) (* x 1000000000) y) (ite (and (< x 0) (< y 0)) (pos_div_relation3 (fxp_div3 x y) (* (- x) 1000000000) (- y)) (ite (and (< x 0) (< 0 y)) (pos_div_relation3 (- (fxp_div3 x y)) (* (- x) 1000000000) y) (=> (and (< 0 x) (< y 0)) (pos_div_relation3 (- (fxp_div3 x y)) (* x 1000000000) (- y))))))) :pattern ((fxp_div3 x y))))))
...
(assert (forall ((x Int)) (! (ite (= x 0) (= (to_int4 x) 0) (ite (< 0 x) (pos_div_relation3 (to_int4 x) x 1000000000) (pos_div_relation3 (- (to_int4 x)) (- x) 1000000000))) :pattern ((to_int4 x)))))
