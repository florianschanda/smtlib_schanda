...
(assert (= n1 0))
(assert (in_range1 n1))
(assert (and (= result2 (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 cu__split_fields4))) (= (= result2 true) (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 cu__split_fields4)) true))))
(assert (= result2 true))
(assert (= (length (mk___rep l__split_discrs l__split_fields2)) (+ (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) n2)))
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i n2)) (and (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) (* 2 i)) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i)) (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) (- (* 2 i) 1)) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i))))))
(assert (forall ((i Int)) (=> (and (<= (+ n2 1) i) (<= i (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))) (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) (+ i n2)) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i)))))
(assert (= (get1 (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 cu__split_fields3)) (+ (* 2 n2) 1)))
(assert (=> (<= 0 2147483647) (in_range1 n2)))
(assert (and (= o (element (mk___rep l__split_discrs l__split_fields2) (mk___rep1 cu__split_fields3))) (and (in_range5 o) (= o (get (model__ (mk___rep l__split_discrs l__split_fields2)) (get1 (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 cu__split_fields3)))))))
(assert (not (or (= (has_key (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 cu__split_fields3)) true) (= (bool_eq2 (mk___rep1 cu__split_fields3) no_element) true))))
(check-sat)
(exit)
