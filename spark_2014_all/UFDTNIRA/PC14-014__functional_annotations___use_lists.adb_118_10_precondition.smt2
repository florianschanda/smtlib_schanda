...
(assert (and (= o (element (mk___rep l__split_discrs l__split_fields2) (mk___rep1 cu__split_fields3))) (and (in_range6 o) (= o (get (model__ (mk___rep l__split_discrs l__split_fields2)) (get1 (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 cu__split_fields3)))))))
