...
(assert (= o5 i1))
(assert (and (= o6 (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) o5)) (in_range3 o6)))
...
(assert (= o4 temp___502))
(assert (and (= o7 (get (model__ (mk___rep v__split_discrs (us_split_fields__content v__split_fields8))) o4)) (and (in_range4 o7) (= o7 (get (model__ (mk___rep v__split_discrs (us_split_fields__content v__split_fields8))) o4)))))
