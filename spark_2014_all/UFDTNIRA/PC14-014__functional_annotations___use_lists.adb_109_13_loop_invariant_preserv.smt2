...
(assert (<= 1 i))
(assert (<= i n3))
(assert (not (= (get (model__ (mk___rep l__split_discrs l__split_fields3)) (* 2 i)) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i))))
(check-sat)
(exit)
