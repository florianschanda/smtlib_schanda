...
(assert (= result2 true))
(assert (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (+ (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) n2)))
(assert (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 n2)) (and (= (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (* 2 i3)) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i3)) (= (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (- (* 2 i3) 1)) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i3))))))
(assert (forall ((i3 Int)) (=> (and (<= (+ n2 1) i3) (<= i3 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))) (= (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (+ i3 n2)) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i3)))))
(assert (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (mk___rep1 (mk___split_fields1 cu__split_fields2))) (+ (* 2 n2) 1)))
(assert (=> (<= 0 2147483647) (in_range2 n2)))
(assert (and (= o28 (element (mk___rep l__split_discrs (mk___split_fields l__split_fields2)) (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range6 o28) (= o28 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (mk___rep1 (mk___split_fields1 cu__split_fields2))))))))
...
(assert (ite (= (ite (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields2)) no_element) false) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (mk___rep1 (mk___split_fields1 cu__split_fields2))) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields3)))) true) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields3)) no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (mk___rep1 (mk___split_fields1 cu__split_fields3))) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (mk___rep1 (mk___split_fields1 cu__split_fields3))) (+ (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1)))))
(assert (and (= o29 (+ n2 1)) (in_range1 (+ n2 1))))
(assert (= result4 (mk_int__ref n2)))
(assert (= n3 o29))
(assert (and (= o30 (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (mk___rep1 (mk___split_fields1 cu__split_fields3)))) (= (= o30 true) (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (mk___rep1 (mk___split_fields1 cu__split_fields3))) true))))
(assert (= result5 (ite (not (= o30 true)) true false)))
(assert (not (= result5 true)))
(declare-const i3 Int)
(assert (<= 1 i3))
(assert (<= i3 n3))
(assert (not (= (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (* 2 i3)) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i3))))
(check-sat)
(exit)
