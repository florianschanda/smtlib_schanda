...
(define-fun cu__split_fields4 () us_split_fields2 (mk___split_fields1 cu__split_fields3))
(define-fun l__split_fields3 () us_split_fields (mk___split_fields l__split_fields2))
...
(define-fun cu__split_fields6 () us_split_fields2 (mk___split_fields1 cu__split_fields1))
...
(assert (= n1 0))
(assert (in_range1 n1))
(assert (and (= result2 (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 cu__split_fields6))) (= (= result2 true) (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 cu__split_fields6)) true))))
(assert (= result2 true))
(assert (= (length (mk___rep l__split_discrs l__split_fields4)) (+ (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) n2)))
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i n2)) (and (= (get (model__ (mk___rep l__split_discrs l__split_fields4)) (* 2 i)) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i)) (= (get (model__ (mk___rep l__split_discrs l__split_fields4)) (- (* 2 i) 1)) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i))))))
(assert (forall ((i Int)) (=> (and (<= (+ n2 1) i) (<= i (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))) (= (get (model__ (mk___rep l__split_discrs l__split_fields4)) (+ i n2)) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i)))))
(assert (= (get1 (positions (mk___rep l__split_discrs l__split_fields4)) (mk___rep1 cu__split_fields5)) (+ (* 2 n2) 1)))
(assert (=> (<= 0 2147483647) (in_range1 n2)))
(assert (and (= o (element (mk___rep l__split_discrs l__split_fields4) (mk___rep1 cu__split_fields5))) (and (in_range5 o) (= o (get (model__ (mk___rep l__split_discrs l__split_fields4)) (get1 (positions (mk___rep l__split_discrs l__split_fields4)) (mk___rep1 cu__split_fields5)))))))
(assert (and (= (length (mk___rep l__split_discrs l__split_fields3)) (+ (length (mk___rep l__split_discrs l__split_fields4)) 1)) (ite (= (bool_eq2 (mk___rep1 cu__split_fields5) no_element) true) (and (and (and (and (= (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (last1 (mk___rep l__split_discrs l__split_fields3))) (length (mk___rep l__split_discrs l__split_fields3))) (= (keys_included_except (positions (mk___rep l__split_discrs l__split_fields3)) (positions (mk___rep l__split_discrs l__split_fields4)) (last1 (mk___rep l__split_discrs l__split_fields3))) true)) (= (ole1 (positions (mk___rep l__split_discrs l__split_fields4)) (positions (mk___rep l__split_discrs l__split_fields3))) true)) (= (get (model__ (mk___rep l__split_discrs l__split_fields3)) (length (mk___rep l__split_discrs l__split_fields3))) o)) (= (ole (model__ (mk___rep l__split_discrs l__split_fields4)) (model__ (mk___rep l__split_discrs l__split_fields3))) true)) (and (and (and (= (range_equal (model__ (mk___rep l__split_discrs l__split_fields4)) (model__ (mk___rep l__split_discrs l__split_fields3)) 1 (- (get1 (positions (mk___rep l__split_discrs l__split_fields4)) (mk___rep1 cu__split_fields5)) 1)) true) (= (range_shifted (model__ (mk___rep l__split_discrs l__split_fields4)) (model__ (mk___rep l__split_discrs l__split_fields3)) (get1 (positions (mk___rep l__split_discrs l__split_fields4)) (mk___rep1 cu__split_fields5)) (length (mk___rep l__split_discrs l__split_fields4)) 1) true)) (= (get (model__ (mk___rep l__split_discrs l__split_fields3)) (get1 (positions (mk___rep l__split_discrs l__split_fields4)) (mk___rep1 cu__split_fields5))) o)) (= (p_positions_shifted (positions (mk___rep l__split_discrs l__split_fields4)) (positions (mk___rep l__split_discrs l__split_fields3)) (get1 (positions (mk___rep l__split_discrs l__split_fields4)) (mk___rep1 cu__split_fields5)) 1) true)))))
(assert (ite (= (ite (= (bool_eq2 (mk___rep1 cu__split_fields5) no_element) false) (= (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields5)) (length (mk___rep l__split_discrs l__split_fields3))) true) true) (= (bool_eq2 (mk___rep1 cu__split_fields4) no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields4)) true) (= (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields4)) (+ (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields5)) 1)))))
(assert (and (= o1 (+ n2 1)) (in_range6 (+ n2 1))))
(assert (= result3 (mk_int__ref n2)))
(assert (= n3 o1))
(assert (and (= o2 (has_key (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields4))) (= (= o2 true) (= (has_key (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields4)) true))))
(assert (= result4 (ite (not (= o2 true)) true false)))
(assert (not (= result4 true)))
(declare-const i Int)
(assert (<= 1 i))
(assert (<= i n3))
(assert (not (= (get (model__ (mk___rep l__split_discrs l__split_fields3)) (- (* 2 i) 1)) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i))))
(check-sat)
(exit)
