...
(declare-sort t 0)
(define-fun in_range3 ((x Int)) Bool (and (<= (- 25) x) (<= x 25)))
...
(assert (forall ((x Int)) (! (ite (= x 0) (= (to_int2 x) 0) (ite (< 0 x) (pos_div_relation (to_int2 x) (* x 2) 5) (pos_div_relation (- (to_int2 x)) (* (- x) 2) 5))) :pattern ((to_int2 x)))))
(declare-fun of_int1 (Int) Int)
(assert (forall ((x Int)) (! (ite (= x 0) (= (of_int1 x) 0) (ite (< 0 x) (pos_div_relation (of_int1 x) (* x 5) 2) (pos_div_relation (- (of_int1 x)) (* (- x) 5) 2))) :pattern ((of_int1 x)))))
...
(declare-fun to_fixed2 (ttintB) Int)
(declare-fun of_fixed2 (Int) ttintB)
...
(assert (forall ((x ttintB)) (! (= (of_fixed2 (to_fixed2 x)) x) :pattern ((to_fixed2 x)))))
(assert (forall ((x ttintB)) (in_range4 (to_fixed2 x))))
(assert (forall ((x Int)) (! (=> (in_range4 x) (= (to_fixed2 (of_fixed2 x)) x)) :pattern ((to_fixed2 (of_fixed2 x))))))
(declare-datatypes () ((ttintB__ref (mk_ttintB__ref (ttintB__content ttintB)))))
(define-fun ttintB__ref___projection ((a ttintB__ref)) ttintB (ttintB__content a))
(declare-sort tint 0)
(define-fun in_range5 ((x Int)) Bool (and (<= (- 10) x) (<= x 10)))
(declare-const dummy4 tint)
(declare-fun attr__ATTRIBUTE_IMAGE5 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check5 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE5 (us_image) Int)
(declare-fun to_fixed3 (tint) Int)
(declare-fun of_fixed3 (Int) tint)
...
(assert (forall ((x Int)) (! (ite (= x 0) (= (to_int4 x) 0) (ite (< 0 x) (pos_div_relation (to_int4 x) (* x 1) 1) (pos_div_relation (- (to_int4 x)) (* (- x) 1) 1))) :pattern ((to_int4 x)))))
(declare-fun of_int3 (Int) Int)
(assert (forall ((x Int)) (! (ite (= x 0) (= (of_int3 x) 0) (ite (< 0 x) (pos_div_relation (of_int3 x) (* x 1) 1) (pos_div_relation (- (of_int3 x)) (* (- x) 1) 1))) :pattern ((of_int3 x)))))
(assert (forall ((x tint)) (! (= (of_fixed3 (to_fixed3 x)) x) :pattern ((to_fixed3 x)))))
(assert (forall ((x tint)) (in_range5 (to_fixed3 x))))
(assert (forall ((x Int)) (! (=> (in_range5 x) (= (to_fixed3 (of_fixed3 x)) x)) :pattern ((to_fixed3 (of_fixed3 x))))))
(declare-datatypes () ((tint__ref (mk_tint__ref (tint__content tint)))))
(define-fun tint__ref___projection ((a tint__ref)) tint (tint__content a))
(declare-const x t)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const y t)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const inv_y t)
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(declare-const attr__ATTRIBUTE_ADDRESS3 Int)
(declare-const attr__ATTRIBUTE_ADDRESS4 Int)
(declare-const attr__ATTRIBUTE_ADDRESS5 Int)
(declare-fun fxp_mult (Int Int) Int)
(assert (forall ((x1 Int)) (forall ((y1 Int)) (! (ite (or (= x1 0) (= y1 0)) (= (fxp_mult x1 y1) 0) (ite (or (and (< 0 x1) (< 0 y1)) (and (< x1 0) (< y1 0))) (pos_div_relation (fxp_mult x1 y1) (* (* (* (* x1 y1) 2) 2) 1) (* (* 5 5) 1)) (pos_div_relation (- (fxp_mult x1 y1)) (- (* (* (* (* x1 y1) 2) 2) 1)) (* (* 5 5) 1)))) :pattern ((fxp_mult x1 y1))))))
(declare-fun fxp_div (Int Int) Int)
(assert (forall ((x1 Int)) (forall ((y1 Int)) (! (ite (= x1 0) (= (fxp_div x1 y1) 0) (ite (and (< 0 x1) (< 0 y1)) (pos_div_relation (fxp_div x1 y1) (* (* (* x1 2) 5) 1) (* (* (* y1 5) 2) 1)) (ite (and (< x1 0) (< y1 0)) (pos_div_relation (fxp_div x1 y1) (* (* (* (- x1) 2) 5) 1) (* (* (* (- y1) 5) 2) 1)) (ite (and (< x1 0) (< 0 y1)) (pos_div_relation (- (fxp_div x1 y1)) (* (* (* (- x1) 2) 5) 1) (* (* (* y1 5) 2) 1)) (=> (and (< 0 x1) (< y1 0)) (pos_div_relation (- (fxp_div x1 y1)) (* (* (* x1 2) 5) 1) (* (* (* (- y1) 5) 2) 1))))))) :pattern ((fxp_div x1 y1))))))
(assert (= y (of_fixed1 1)))
(assert (= inv_y (of_fixed1 5)))
(declare-const two Int)
(declare-const z t)
(declare-const zint tint)
(declare-const o tint)
(declare-const o1 tint)
(declare-const o2 t)
(declare-const o3 t)
(declare-const zint1 tint)
(declare-const result Int)
(declare-const two1 Int)
(declare-const result1 tint)
(declare-const zint2 tint)
(declare-const result2 tint)
(declare-const zint3 tint)
(declare-const result3 t)
(declare-const z1 t)
(declare-const result4 t)
(declare-const z2 t)
(assert (and (<= (- 12) (to_fixed1 x)) (<= (to_fixed1 x) 12)))
(assert (= result two))
(assert (= two1 2))
(assert (in_range1 two1))
(assert (=> (not (= (to_fixed1 x) 0)) (= (to_fixed3 o) (fxp_div (to_fixed1 x) (to_fixed1 x)))))
(assert (=> (not (= (to_fixed1 x) 0)) (= (mk_tint__ref result1) (mk_tint__ref zint))))
(assert (=> (not (= (to_fixed1 x) 0)) (= zint2 o)))
(assert (=> (not (= (to_fixed1 x) 0)) (= (to_fixed3 zint2) 1)))
(assert (=> (not (not (= (to_fixed1 x) 0))) (= zint2 zint)))
(assert (=> (not (not (= (to_fixed1 x) 0))) (= zint2 zint1)))
(assert (= (to_fixed3 o1) (fxp_div (to_fixed1 x) 10)))
(assert (= result2 zint2))
(assert (= zint3 o1))
(assert (= (to_fixed1 o2) (fxp_div_int (to_fixed1 x) 2)))
(assert (= result3 z))
(assert (= z1 o2))
(assert (and (<= (- (* (to_fixed1 z1) 2) 1) (to_fixed1 x)) (<= (to_fixed1 x) (+ (* (to_fixed1 z1) 2) 1))))
(assert (= (to_fixed1 o3) (fxp_div_int (to_fixed1 x) two1)))
(assert (= result4 z1))
(assert (= z2 o3))
(assert (not (<= (- (* (to_fixed1 z2) 2) 1) (to_fixed1 x))))
(check-sat)
(exit)
