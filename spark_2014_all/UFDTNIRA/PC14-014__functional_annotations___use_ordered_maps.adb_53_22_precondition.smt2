...
(assert (and (= o6 (keys s)) (and (and (and (= (length3 o6) (length s)) (forall ((temp___396 Int)) (=> (and (in_range3 temp___396) (= (iter_has_element o6 temp___396) true)) (= (has_key (model__ s) (get o6 temp___396)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true)) (and (< 0 (find o6 key2)) (= (equivalent_keys (get o6 (find o6 key2)) key2) true))))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length s))) (and (= (find o6 (get o6 i2)) i2) (= (k_is_find o6 (get o6 i2) i2) true)))))))
(assert (and (= o7 (get o6 i)) (in_range4 o7)))
(assert (not (= (has_key (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) o7) true)))
(check-sat)
(exit)
