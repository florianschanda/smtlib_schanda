...
(assert (= result2 true))
(assert (and (= o11 (keys s)) (and (and (and (= (length3 o11) (length s)) (forall ((temp___439 Int)) (=> (and (in_range3 temp___439) (= (iter_has_element o11 temp___439) true)) (= (has_key (model__ s) (get o11 temp___439)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true)) (and (< 0 (find o11 key2)) (= (equivalent_keys (get o11 (find o11 key2)) key2) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (and (= (find o11 (get o11 i1)) i1) (= (k_is_find o11 (get o11 i1) i1) true)))))))
