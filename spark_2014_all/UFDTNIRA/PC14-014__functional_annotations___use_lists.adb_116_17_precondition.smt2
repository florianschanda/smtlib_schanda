...
(assert (and (= o15 (+ n2 1)) (in_range1 (+ n2 1))))
(assert (= o16 (ite (<= o15 i1) true false)))
(assert (= result3 (ite (= o16 true) (ite (<= i1 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true false) false)))
(assert (= result3 true))
