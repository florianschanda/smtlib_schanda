...
(assert (= result x))
(assert (= x1 o))
(assert (not (in_range (ite (< (to_fixed x1) (ite (< (to_fixed x1) (to_fixed x1)) (to_fixed x1) (to_fixed x1))) (to_fixed x1) (ite (< (to_fixed x1) (to_fixed x1)) (to_fixed x1) (to_fixed x1))))))
(check-sat)
(exit)
