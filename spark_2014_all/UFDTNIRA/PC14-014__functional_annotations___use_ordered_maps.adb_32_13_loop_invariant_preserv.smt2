...
(define-fun temp___650 () us_rep3 (keys (mk___rep r__split_discrs r__split_fields3)))
(declare-const temp___649 Int)
(assert (in_range3 temp___649))
(assert (= (iter_has_element temp___650 temp___649) true))
(assert (not (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (= (get2 (model__ (mk___rep r__split_discrs r__split_fields3)) (get temp___650 temp___649)) (f (get2 (model__ s) (get (keys s) i))))))))
(check-sat)
(exit)
