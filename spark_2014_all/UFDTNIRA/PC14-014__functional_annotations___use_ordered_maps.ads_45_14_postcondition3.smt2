...
(declare-const temp___684 count_type)
(declare-const temp___683 count_type)
...
(declare-const temp___686 us_rep3)
...
(declare-const temp___682 count_type)
(declare-const o27 Bool)
(declare-const temp___693 us_rep3)
(declare-const temp___692 Int)
(declare-const o28 Bool)
(declare-const o29 Bool)
(declare-const k1 Int)
(declare-const temp___697 us_rep3)
(declare-const temp___696 Int)
...
(declare-const result6 count_type)
...
(assert (and (= (mk___rep1 (mk___split_fields1 use_ordered_maps__apply_f_2__cu__assume)) (first s)) (ite (= (= (length s) 0) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 use_ordered_maps__apply_f_2__cu__assume)) no_element) true) (and (= (has_key1 (positions s) (mk___rep1 (mk___split_fields1 use_ordered_maps__apply_f_2__cu__assume))) true) (= (get1 (positions s) (mk___rep1 (mk___split_fields1 use_ordered_maps__apply_f_2__cu__assume))) 1)))))
...
(assert (=> (= result1 true) (= temp___684 cu__split_fields1)))
(assert (=> (= result1 true) (and (= r__split_discrs (mk___split_discrs temp___683)) (= temp___6831 r__split_fields))))
(assert (=> (= result1 true) (= (length (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) (- (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))))
(assert (=> (= result1 true) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (- (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))) (and (= (has_key (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) (get (keys s) i2)) true) (= (get2 (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) (get (keys s) i2)) (f (get2 (model__ s) (get (keys s) i2)))))))))
(assert (=> (= result1 true) (let ((temp___690 (keys (mk___rep r__split_discrs (mk___split_fields r__split_fields1))))) (forall ((temp___689 Int)) (=> (and (in_range3 temp___689) (= (iter_has_element temp___690 temp___689) true)) (exists ((i2 Int)) (and (and (<= 1 i2) (<= i2 (- (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))) (= (get temp___690 temp___689) (get (keys s) i2)))))))))
(assert (=> (= result1 true) (and (= o25 (element s (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range7 o25) (= o25 (get2 (model__ s) (key s (mk___rep1 (mk___split_fields1 cu__split_fields2)))))))))
(assert (=> (= result1 true) (and (= o26 (f o25)) (and (in_range8 o26) (= o26 (ite (and (<= (- 100) o25) (<= o25 100)) (* o25 2) o25))))))
(assert (=> (= result1 true) (and (= o24 (key s (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range6 o24) (= o24 (get (keys s) (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2)))))))))
(assert (=> (= result1 true) (and (and (= (has_key (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) o24) true) (= (get2 (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) o24) o26)) (ite (= (has_key (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) o24) true) (and (and (and (and (= (oeq3 (positions (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) (positions (mk___rep r__split_discrs (mk___split_fields r__split_fields1)))) true) (= (get (keys (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) (find (keys (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) o24)) o24)) (= (equal_except (keys (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) (keys (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) (find (keys (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) o24)) true)) (= (same_keys (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields1)))) true)) (= (elements_equal_except (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) o24) true)) (and (and (and (and (and (and (= (length (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) (+ (length (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) 1)) (= (ole (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields2)))) true)) (= (keys_included_except (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) o24) true)) (= (get (keys (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) (find (keys (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) o24)) o24)) (= (range_equal (keys (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) (keys (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) 1 (- (find (keys (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) o24) 1)) true)) (= (range_shifted (keys (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) (keys (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) (find (keys (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) o24) (length (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) 1) true)) (= (p_positions_shifted (positions (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) (positions (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) (find (keys (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) o24) 1) true))))))
(assert (=> (= result1 true) (and (= (mk___rep1 (mk___split_fields1 temp___682)) (next s (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (ite (= (ite (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields2)) no_element) false) (= (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) (length s)) true) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 temp___682)) no_element) true) (and (= (has_key1 (positions s) (mk___rep1 (mk___split_fields1 temp___682))) true) (= (get1 (positions s) (mk___rep1 (mk___split_fields1 temp___682))) (+ (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1)))))))
(assert (=> (= result1 true) (= result6 cu__split_fields2)))
(assert (=> (= result1 true) (= cu__split_fields3 (mk___split_fields1 temp___682))))
(assert (=> (= result1 true) (and (= o27 (has_key1 (positions s) (mk___rep1 cu__split_fields3))) (= (= o27 true) (= (has_key1 (positions s) (mk___rep1 cu__split_fields3)) true)))))
(assert (=> (= result1 true) (= result7 (ite (not (= o27 true)) true false))))
(assert (=> (= result1 true) (= result7 true)))
(assert (=> (= result1 true) (= cu__split_fields4 (mk___split_fields__ref1 cu__split_fields3))))
(assert (=> (= result1 true) (= r__split_fields3 (mk___split_fields__ref (mk___split_fields r__split_fields2)))))
(assert (=> (= result1 true) (= cu__split_fields5 cu__split_fields3)))
(assert (=> (= result1 true) (= r__split_fields4 (mk___split_fields r__split_fields2))))
...
(assert (=> (not (= result1 true)) (= r__split_fields5 (mk___split_fields__ref (mk___split_fields r__split_fields)))))
(assert (=> (not (= result1 true)) (= cu__split_fields7 (mk___split_fields1 cu__split_fields1))))
(assert (=> (not (= result1 true)) (= r__split_fields6 (mk___split_fields r__split_fields))))
...
(assert (in_range3 temp___704))
(assert (= (iter_has_element (keys s) temp___704) true))
(assert (not (= (has_key (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) (get (keys s) temp___704)) true)))
(check-sat)
(exit)
