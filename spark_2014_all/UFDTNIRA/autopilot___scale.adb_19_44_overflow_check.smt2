...
(define-fun dynamic_invariant1 ((temp___expr_189 Int) (temp___is_init_186 Bool) (temp___skip_constant_187 Bool) (temp___do_toplevel_188 Bool)) Bool (=> (or (= temp___is_init_186 true) (<= (- 100) 100)) (in_range2 temp___expr_189)))
...
(define-fun dynamic_invariant2 ((temp___expr_201 Int) (temp___is_init_198 Bool) (temp___skip_constant_199 Bool) (temp___do_toplevel_200 Bool)) Bool (=> (or (= temp___is_init_198 true) (<= 0 100)) (in_range3 temp___expr_201)))
...
(assert (in_range1 flatness))
(assert (and (and (<= 0 val__) (< 0 flatness)) (<= flatness 100)))
(assert (=> (<= (- 2147483648) 2147483647) (in_range1 calc)))
(assert (=> (<= 0 100) (in_range3 ans)))
(assert (not (in_range1 (+ flatness val__))))
(check-sat)
(exit)
