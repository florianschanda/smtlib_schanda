...
(assert (=> (= result2 true) (and (= o6 (next (mk___rep s__split_discrs s__split_fields3) (mk___rep1 cu__split_fields2))) (ite (= (ite (= (bool_eq2 (mk___rep1 cu__split_fields2) no_element) false) (= (get1 (positions (mk___rep s__split_discrs s__split_fields3)) (mk___rep1 cu__split_fields2)) (length (mk___rep s__split_discrs s__split_fields3))) true) true) (= (bool_eq2 o6 no_element) true) (and (= (has_key (positions (mk___rep s__split_discrs s__split_fields3)) o6) true) (= (get1 (positions (mk___rep s__split_discrs s__split_fields3)) o6) (+ (get1 (positions (mk___rep s__split_discrs s__split_fields3)) (mk___rep1 cu__split_fields2)) 1)))))))
(assert (=> (= result2 true) (and (= temp___8311 (next (mk___rep s__split_discrs s__split_fields3) o6)) (ite (= (ite (= (bool_eq2 o6 no_element) false) (= (get1 (positions (mk___rep s__split_discrs s__split_fields3)) o6) (length (mk___rep s__split_discrs s__split_fields3))) true) true) (= (bool_eq2 temp___8311 no_element) true) (and (= (has_key (positions (mk___rep s__split_discrs s__split_fields3)) temp___8311) true) (= (get1 (positions (mk___rep s__split_discrs s__split_fields3)) temp___8311) (+ (get1 (positions (mk___rep s__split_discrs s__split_fields3)) o6) 1)))))))
