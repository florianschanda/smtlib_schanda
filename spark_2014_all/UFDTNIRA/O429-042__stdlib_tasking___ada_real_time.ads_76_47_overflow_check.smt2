...
(declare-const time_span_first us_rep1)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const time_span_last us_rep1)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const time_span_zero us_rep1)
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(declare-fun olt__2 (us_rep1 us_rep1) Bool)
(declare-fun olt__2__function_guard (Bool us_rep1 us_rep1) Bool)
(assert true)
(declare-fun to_duration (us_rep) duration)
(declare-fun to_duration__function_guard (duration us_rep) Bool)
(declare-fun to_duration__2 (us_rep1) duration)
(declare-fun to_duration__2__function_guard (duration us_rep1) Bool)
(declare-fun ogt__2 (us_rep1 us_rep1) Bool)
(declare-fun ogt__2__function_guard (Bool us_rep1 us_rep1) Bool)
(assert true)
...
(assert (= result (olt__2 left time_span_zero)))
(assert (not (= result true)))
(assert (= result1 (ogt__2 left time_span_zero)))
(assert (= result1 true))
(assert (= o7 (to_duration__2 left)))
(assert (= o8 (to_fixed o7)))
(assert (= o6 (to_duration__2 time_span_last)))
(assert (= o9 (to_fixed o6)))
(assert (= o10 (- o9 o8)))
