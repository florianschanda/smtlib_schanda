...
(define-fun dynamic_invariant2 ((temp___expr_169 Int) (temp___is_init_165 Bool) (temp___skip_constant_166 Bool) (temp___do_toplevel_167 Bool) (temp___do_typ_inv_168 Bool)) Bool (and (=> (or (= temp___is_init_165 true) (<= 0 2147483647)) (in_range2 temp___expr_169)) (=> (= temp___do_toplevel_167 true) (=> (= temp___is_init_165 true) (< (* temp___expr_169 temp___expr_169) 100000)))))
...
(declare-const temp___235 small)
(declare-const temp___2351 very_small)
...
(assert (dynamic_invariant3 (mk___rep (mk___split_fields x__split_fields x__split_fields1)) false false true true))
(assert (in_range y))
(assert (and (= temp___232 y) (in_range1 y)))
(assert (< (* 2 temp___232) 100000))
(assert (= o temp___232))
(assert (= (to_rep o1) o))
(assert (= o1 o2))
...
(assert (= x__split_fields2 temp___235))
(assert (= x__split_fields3 temp___2351))
