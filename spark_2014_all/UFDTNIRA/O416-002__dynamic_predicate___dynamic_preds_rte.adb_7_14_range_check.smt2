...
(define-fun dynamic_invariant2 ((temp___expr_145 Int) (temp___is_init_142 Bool) (temp___skip_constant_143 Bool) (temp___do_toplevel_144 Bool)) Bool (and (=> (or (= temp___is_init_142 true) (<= 0 2147483647)) (in_range2 temp___expr_145)) (=> (= temp___do_toplevel_144 true) (=> (= temp___is_init_142 true) (< (* temp___expr_145 temp___expr_145) 100000)))))
...
(define-fun dynamic_invariant3 ((temp___expr_154 us_rep) (temp___is_init_151 Bool) (temp___skip_constant_152 Bool) (temp___do_toplevel_153 Bool)) Bool (and (=> (= temp___is_init_151 true) (< (* 2 (to_rep (rec__dynamic_preds_rte__small_pair__a (us_split_fields1 temp___expr_154)))) 100000)) (=> (= temp___is_init_151 true) (let ((temp___156 (rec__dynamic_preds_rte__small_pair__b (us_split_fields1 temp___expr_154)))) (< (* (to_rep1 temp___156) (to_rep1 temp___156)) 100000)))))
...
(assert (dynamic_invariant3 (mk___rep (mk___split_fields x__split_fields x__split_fields1)) false false true))
(assert (in_range y))
