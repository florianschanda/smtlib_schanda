...
(define-fun dynamic_invariant ((temp___expr_153 Int) (temp___is_init_150 Bool) (temp___skip_constant_151 Bool) (temp___do_toplevel_152 Bool)) Bool (=> (or (= temp___is_init_150 true) (<= (- 9223372036854775808) 9223372036854775807)) (in_range3 temp___expr_153)))
...
(assert (forall ((sc Int)) (forall ((ts us_rep)) (! (=> (dynamic_invariant sc true true true) (= (result_sc sc ts) (+ sc (ts_sc ts)))) :pattern ((result_sc sc ts))))))
(declare-const sc Int)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const ts us_rep)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(assert (forall ((ts1 us_rep)) (! (= (ts_sc ts1) (to_int2 (to_fixed (to_duration__2 ts1)))) :pattern ((ts_sc ts1)))))
(declare-const o Int)
...
(declare-const o6 duration)
(declare-const o7 duration)
...
(declare-const o17 duration)
(declare-const o18 duration)
...
(assert (in_range3 sc))
(assert (and (= o30 (* 3 9223372036)) (in_range2 (* 3 9223372036))))
(assert (= o31 (ite (<= sc o30) true false)))
(assert (and (= o29 (* 3 (- 9223372036))) (in_range2 (* 3 (- 9223372036)))))
(assert (= o32 (ite (<= o29 sc) true false)))
(assert (= result (ite (= o32 true) o31 false)))
(assert (= result true))
(assert (and (= o25 (+ 9223372036 1)) (in_range2 (+ 9223372036 1))))
(assert (and (= o26 (result_sc sc ts)) (and (in_range3 o26) (= o26 (+ sc (ts_sc ts))))))
(assert (= o27 (ite (<= o26 o25) true false)))
(assert (and (= o23 (result_sc sc ts)) (and (in_range3 o23) (= o23 (+ sc (ts_sc ts))))))
(assert (and (= o24 (- (- 9223372036) 1)) (in_range2 (- (- 9223372036) 1))))
(assert (= o28 (ite (<= o24 o23) true false)))
(assert (= result1 (ite (= o28 true) o27 false)))
(assert (= result1 true))
(assert (and (= o (result_sc sc ts)) (and (in_range3 o) (= o (+ sc (ts_sc ts))))))
(assert (= result2 (ite (< 0 o) true false)))
(assert (= result2 true))
(assert (and (= o7 (ts_fraction ts)) (= o7 (of_fixed (- (to_fixed (to_duration__2 ts)) (to_fixed (of_fixed (* (ts_sc ts) 1000000000))))))))
(assert (= o8 (to_fixed o7)))
