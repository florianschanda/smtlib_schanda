...
(assert (not (< 0 right)))
(assert (< right 0))
(assert (= result2 (ogt__2 left time_span_zero)))
(assert (= result2 true))
(assert (not (= right (- 1))))
(assert (= o29 (to_duration__2 time_span_first)))
(assert (= o30 (to_fixed o29)))
(assert (= o31 (fxp_div_result_int o30 1)))
(assert (and (= o32 o31) (in_range3 o31)))
(assert (and (= o33 o32) (in_range4 o32)))
(assert (= o34 (div1 o33 right)))
(assert (and (= o35 o34) (in_range3 o34)))
(assert (= o25 (to_duration__2 left)))
(assert (= o26 (to_fixed o25)))
(assert (= o27 (fxp_div_result_int o26 1)))
(assert (and (= o28 o27) (in_range3 o27)))
(assert (not (in_range4 o28)))
(check-sat)
(exit)
