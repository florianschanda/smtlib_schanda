...
(assert (and (= temp___646 (keys (mk___rep r__split_discrs (mk___split_fields r__split_fields1)))) (and (and (and (= (length3 temp___646) (length (mk___rep r__split_discrs (mk___split_fields r__split_fields1)))) (forall ((temp___396 Int)) (=> (and (in_range3 temp___396) (= (iter_has_element temp___646 temp___396) true)) (= (has_key (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) (get temp___646 temp___396)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) key2) true)) (and (< 0 (find temp___646 key2)) (= (equivalent_keys (get temp___646 (find temp___646 key2)) key2) true))))) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 (length (mk___rep r__split_discrs (mk___split_fields r__split_fields1))))) (and (= (find temp___646 (get temp___646 i3)) i3) (= (k_is_find temp___646 (get temp___646 i3) i3) true)))))))
(assert (and (= o13 (iter_has_element temp___646 temp___645)) (= (= o13 true) (and (<= 1 temp___645) (<= temp___645 (last temp___646))))))
(assert (= (= o14 true) (in_range3 temp___645)))
(assert (= result4 (ite (= o14 true) o13 false)))
(assert (= result4 true))
