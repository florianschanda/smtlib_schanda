...
(declare-const temp___689 us_rep3)
(declare-const temp___688 Int)
...
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (let ((temp___687 (keys (mk___rep r__split_discrs r__split_fields2)))) (exists ((temp___686 Int)) (and (and (in_range3 temp___686) (= (iter_has_element temp___687 temp___686) true)) (= (get2 (model__ (mk___rep r__split_discrs r__split_fields2)) (get temp___687 temp___686)) (f (get2 (model__ s) (get (keys s) i))))))))))
(assert (let ((temp___693 (keys (mk___rep r__split_discrs r__split_fields2)))) (forall ((temp___692 Int)) (=> (and (in_range3 temp___692) (= (iter_has_element temp___693 temp___692) true)) (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (= (get2 (model__ (mk___rep r__split_discrs r__split_fields2)) (get temp___693 temp___692)) (f (get2 (model__ s) (get (keys s) i))))))))))
(assert (forall ((i Int)) (=> (and (<= (get1 (positions s) (mk___rep1 cu__split_fields3)) i) (<= i (length s))) (not (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2)) (get (keys s) i)) true)))))
(assert (and (= temp___689 (keys (mk___rep r__split_discrs r__split_fields2))) (and (and (and (= (length3 temp___689) (length (mk___rep r__split_discrs r__split_fields2))) (forall ((temp___439 Int)) (=> (and (in_range3 temp___439) (= (iter_has_element temp___689 temp___439) true)) (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2)) (get temp___689 temp___439)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2)) key2) true)) (and (< 0 (find temp___689 key2)) (= (equivalent_keys (get temp___689 (find temp___689 key2)) key2) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep r__split_discrs r__split_fields2)))) (and (= (find temp___689 (get temp___689 i)) i) (= (k_is_find temp___689 (get temp___689 i) i) true)))))))
(assert (and (= o (iter_has_element temp___689 temp___688)) (= (= o true) (and (<= 1 temp___688) (<= temp___688 (last temp___689))))))
(assert (= (= o1 true) (in_range3 temp___688)))
(assert (= result2 (ite (= o1 true) o false)))
(assert (= result2 true))
(assert (not (<= 1 temp___688)))
(check-sat)
(exit)
