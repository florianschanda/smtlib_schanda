...
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (let ((temp___644 (keys (mk___rep r__split_discrs r__split_fields2)))) (exists ((temp___643 Int)) (and (and (in_range3 temp___643) (= (iter_has_element temp___644 temp___643) true)) (= (get2 (model__ (mk___rep r__split_discrs r__split_fields2)) (get temp___644 temp___643)) (f (get2 (model__ s) (get (keys s) i))))))))))
(assert (let ((temp___650 (keys (mk___rep r__split_discrs r__split_fields2)))) (forall ((temp___649 Int)) (=> (and (in_range3 temp___649) (= (iter_has_element temp___650 temp___649) true)) (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (= (get2 (model__ (mk___rep r__split_discrs r__split_fields2)) (get temp___650 temp___649)) (f (get2 (model__ s) (get (keys s) i))))))))))
...
(assert (and (= temp___646 (keys (mk___rep r__split_discrs r__split_fields2))) (and (and (and (= (length3 temp___646) (length (mk___rep r__split_discrs r__split_fields2))) (forall ((temp___396 Int)) (=> (and (in_range3 temp___396) (= (iter_has_element temp___646 temp___396) true)) (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2)) (get temp___646 temp___396)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2)) key2) true)) (and (< 0 (find temp___646 key2)) (= (equivalent_keys (get temp___646 (find temp___646 key2)) key2) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep r__split_discrs r__split_fields2)))) (and (= (find temp___646 (get temp___646 i)) i) (= (k_is_find temp___646 (get temp___646 i) i) true)))))))
(assert (and (= o (iter_has_element temp___646 temp___645)) (= (= o true) (and (<= 1 temp___645) (<= temp___645 (last temp___646))))))
(assert (= (= o1 true) (in_range3 temp___645)))
(assert (= result2 (ite (= o1 true) o false)))
(assert (= result2 true))
(assert (not (<= 1 temp___645)))
(check-sat)
(exit)
