...
(assert (= i1 first4))
(assert (=> (and (<= first4 i1) (<= i1 r17b)) (= temp___493 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))))))
(assert (=> (and (<= first4 i1) (<= i1 r17b)) (= temp___492 (last2 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields)))))))
(assert (=> (and (<= first4 i1) (<= i1 r17b)) (= temp___490 i1)))
(assert (=> (and (<= first4 i1) (<= i1 r17b)) (= temp___496 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))))))
(assert (=> (and (<= first4 i1) (<= i1 r17b)) (and (= v__split_discrs (mk___split_discrs temp___489)) (= v__split_fields temp___4891))))
(assert (=> (and (<= first4 i1) (<= i1 r17b)) (= temp___494 (length (mk___rep v__split_discrs (mk___split_fields v__split_fields))))))
(assert (=> (and (<= first4 i1) (<= i1 r17b)) (= temp___491 (length (mk___rep v__split_discrs (mk___split_fields v__split_fields))))))
(assert (=> (and (<= first4 i1) (<= i1 r17b)) (= (length (mk___rep v__split_discrs v__split_fields12)) (+ temp___491 (- i2 first4)))))
(assert (=> (and (<= first4 i1) (<= i1 r17b)) (forall ((j Int)) (=> (and (<= first4 j) (<= j temp___492)) (= (get (model__ (mk___rep v__split_discrs v__split_fields12)) j) (get temp___493 j))))))
(assert (=> (and (<= first4 i1) (<= i1 r17b)) (forall ((j Int)) (=> (and (<= first4 j) (<= j (- i2 1))) (= (get (model__ (mk___rep v__split_discrs v__split_fields12)) (+ j temp___494)) (get temp___496 j))))))
(assert (=> (and (<= first4 i1) (<= i1 r17b)) (and (and (dynamic_property 0 last (to_rep (rec__use_vectors__my_vectors__vector__capacity v__split_discrs))) (=> (<= first4 r17b) (dynamic_property6 first4 r17b i2))) (and (<= first4 i2) (<= i2 r17b)))))
(assert (=> (and (<= first4 i1) (<= i1 r17b)) (and (= us i2) (dynamic_property3 first2 last4 i2))))
(assert (=> (and (<= first4 i1) (<= i1 r17b)) (= o1 i2)))
(assert (=> (and (<= first4 i1) (<= i1 r17b)) (and (= o2 (get (model__ (mk___rep v__split_discrs v__split_fields12)) o1)) (and (in_range4 o2) (= o2 (get (model__ (mk___rep v__split_discrs v__split_fields12)) o1))))))
(assert (=> (and (<= first4 i1) (<= i1 r17b)) (and (and (and (= (length (mk___rep v__split_discrs v__split_fields11)) (+ (length (mk___rep v__split_discrs v__split_fields12)) 1)) (= (olt (model__ (mk___rep v__split_discrs v__split_fields12)) (model__ (mk___rep v__split_discrs v__split_fields11))) true)) (= (get (model__ (mk___rep v__split_discrs v__split_fields11)) (+ (last2 (model__ (mk___rep v__split_discrs v__split_fields12))) 1)) o2)) (dynamic_property 0 last (to_rep (rec__use_vectors__my_vectors__vector__capacity v__split_discrs))))))
(assert (=> (and (<= first4 i1) (<= i1 r17b)) (= i2 r17b)))
(assert (=> (and (<= first4 i1) (<= i1 r17b)) (= i2 i3)))
(assert (=> (and (<= first4 i1) (<= i1 r17b)) (= v__split_fields4 v__split_fields3)))
(assert (=> (and (<= first4 i1) (<= i1 r17b)) (= i4 i2)))
(assert (=> (and (<= first4 i1) (<= i1 r17b)) (= v__split_fields10 v__split_fields11)))
(assert (=> (and (<= first4 i1) (<= i1 r17b)) (= i5 (mk_int__ref i3))))
(assert (=> (and (<= first4 i1) (<= i1 r17b)) (= v__split_fields6 (mk___split_fields__ref (mk___split_fields v__split_fields4)))))
(assert (=> (and (<= first4 i1) (<= i1 r17b)) (= i6 i4)))
(assert (=> (and (<= first4 i1) (<= i1 r17b)) (= v__split_fields7 v__split_fields10)))
(assert (=> (not (and (<= first4 i1) (<= i1 r17b))) (= i5 (mk_int__ref i1))))
(assert (=> (not (and (<= first4 i1) (<= i1 r17b))) (= v__split_fields6 (mk___split_fields__ref (mk___split_fields v__split_fields)))))
(assert (=> (not (and (<= first4 i1) (<= i1 r17b))) (= i6 i1)))
(assert (=> (not (and (<= first4 i1) (<= i1 r17b))) (= v__split_fields7 (mk___split_fields v__split_fields1))))
(assert (= i7 i5))
...
(assert (not (= (length (mk___rep v__split_discrs (us_split_fields__content v__split_fields8))) (* 2 (length (mk___rep v__split_discrs (mk___split_fields v__split_fields)))))))
(check-sat)
(exit)
