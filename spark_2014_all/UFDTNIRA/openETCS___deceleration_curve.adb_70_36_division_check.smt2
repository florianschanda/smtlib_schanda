...
(declare-const dummy distance_t)
...
(define-fun dynamic_invariant ((temp___expr_203 Int) (temp___is_init_199 Bool) (temp___skip_constant_200 Bool) (temp___do_toplevel_201 Bool) (temp___do_typ_inv_202 Bool)) Bool (=> (or (= temp___is_init_199 true) (<= 0 2147483647)) (in_range temp___expr_203)))
...
(declare-const dummy1 braking_curve_range)
...
(define-fun dynamic_invariant1 ((temp___expr_362 Int) (temp___is_init_358 Bool) (temp___skip_constant_359 Bool) (temp___do_toplevel_360 Bool) (temp___do_typ_inv_361 Bool)) Bool (=> (or (= temp___is_init_358 true) (<= 0 1000)) (in_range1 temp___expr_362)))
(assert (in_range d))
(assert (<= d 5000))
(assert (not (not (= 5 0))))
(check-sat)
