...
(assert (dynamic_invariant2 (mk___rep (mk___split_fields x__split_fields x__split_fields1)) false false true true))
(assert (in_range a))
(assert (in_range b))
(assert (and (= temp___242 b) (in_range1 b)))
(assert (not (= (mod2 temp___242 2) 0)))
(check-sat)
(exit)
