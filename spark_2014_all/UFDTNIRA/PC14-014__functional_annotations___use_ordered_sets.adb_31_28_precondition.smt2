...
(declare-const temp___727 us_rep2)
(declare-const g Int)
...
(assert (and (= temp___727 (model__ (mk___rep r__split_discrs r__split_fields2))) (= (length4 temp___727) (length (mk___rep r__split_discrs r__split_fields2)))))
