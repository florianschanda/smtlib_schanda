...
(assert (and (= o8 (contains temp___685 g)) (=> (= (of_int 1) true) (=> (exists ((e2 Int)) (and (and (in_range2 e2) (= (contains temp___685 e2) true)) (= (equivalent_elements e2 g) true))) (= o8 true)))))
(assert (= (= o9 true) (in_range2 g)))
...
(assert (and (= o11 (get1 o10 (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range5 o11) (=> (= (of_int 0) true) (and (= o11 (w_get o10 (witness o10 (mk___rep1 (mk___split_fields1 cu__split_fields2))))) (forall ((k us_rep1)) (=> (= (has_key o10 k) true) (= (= (bool_eq1 k (mk___rep1 (mk___split_fields1 cu__split_fields2))) true) (= (witness o10 (mk___rep1 (mk___split_fields1 cu__split_fields2))) (witness o10 k))))))))))
(assert (= o12 (- o11 1)))
(assert (= o13 (ite (<= i1 o12) true false)))
(assert (= result4 (ite (<= 1 i1) o13 false)))
(assert (= result4 true))
(assert (and (= o14 (elements s)) (and (and (and (= (length2 o14) (length s)) (forall ((temp___390 Int)) (=> (and (in_range3 temp___390) (= (iter_has_element o14 temp___390) true)) (= (contains (model__ s) (get o14 temp___390)) true)))) (forall ((item Int)) (=> (and (in_range2 item) (= (contains (model__ s) item) true)) (and (< 0 (find o14 item)) (= (equivalent_elements (get o14 (find o14 item)) item) true))))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length s))) (and (= (find o14 (get o14 i2)) i2) (= (e_is_find o14 (get o14 i2) i2) true)))))))
(assert (not (<= 1 i1)))
(check-sat)
(exit)
