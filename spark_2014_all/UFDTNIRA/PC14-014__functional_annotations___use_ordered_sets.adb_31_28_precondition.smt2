...
(assert (and (= temp___685 (model__ (mk___rep r__split_discrs r__split_fields2))) (= (length4 temp___685) (length (mk___rep r__split_discrs r__split_fields2)))))
(assert (and (= o (contains temp___685 g)) (=> (= (of_int 1) true) (=> (exists ((e Int)) (and (and (in_range2 e) (= (contains temp___685 e) true)) (= (equivalent_elements e g) true))) (= o true)))))
...
(assert (and (= o3 (get1 o2 (mk___rep1 cu__split_fields3))) (and (in_range5 o3) (=> (= (of_int 0) true) (and (= o3 (w_get o2 (witness o2 (mk___rep1 cu__split_fields3)))) (forall ((k us_rep1)) (=> (= (has_key o2 k) true) (= (= (bool_eq1 k (mk___rep1 cu__split_fields3)) true) (= (witness o2 (mk___rep1 cu__split_fields3)) (witness o2 k))))))))))
(assert (= o4 (- o3 1)))
(assert (= o5 (ite (<= i o4) true false)))
(assert (= result3 (ite (<= 1 i) o5 false)))
(assert (= result3 true))
(assert (and (= o6 (elements s)) (and (and (and (= (length2 o6) (length s)) (forall ((temp___390 Int)) (=> (and (in_range3 temp___390) (= (iter_has_element o6 temp___390) true)) (= (contains (model__ s) (get o6 temp___390)) true)))) (forall ((item Int)) (=> (and (in_range2 item) (= (contains (model__ s) item) true)) (and (< 0 (find o6 item)) (= (equivalent_elements (get o6 (find o6 item)) item) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (and (= (find o6 (get o6 i1)) i1) (= (e_is_find o6 (get o6 i1) i1) true)))))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
