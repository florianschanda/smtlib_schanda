...
(assert (and (= o32 (+ n2 1)) (in_range1 (+ n2 1))))
(assert (= o33 (ite (<= o32 i2) true false)))
(assert (= result5 (ite (= o33 true) (ite (<= i2 (length (mk___rep s__split_discrs (mk___split_fields s__split_fields)))) true false) false)))
(assert (= result5 true))
(assert (and (= o37 i2) (in_range4 i2)))
(assert (and (= o38 (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) o37)) (in_range5 o38)))
(assert (and (= o35 (+ i2 n2)) (in_range1 (+ i2 n2))))
(assert (not (in_range4 o35)))
(check-sat)
(exit)
