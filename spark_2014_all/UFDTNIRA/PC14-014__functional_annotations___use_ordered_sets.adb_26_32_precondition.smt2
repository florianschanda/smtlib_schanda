...
(assert (and (= o (positions s)) (and (not (= (has_key o no_element) true)) (forall ((i us_rep3)) (=> (= (has_key o i) true) (and (and (<= 1 (get1 o i)) (<= (get1 o i) (length s))) (forall ((j us_rep3)) (=> (= (has_key o j) true) (=> (= (get1 o i) (get1 o j)) (= (bool_eq3 i j) true))))))))))
