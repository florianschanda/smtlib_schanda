...
(assert (=> (= (rec__students__student_record__in_state (us_split_fields3 student)) true) (= tuition2 tuition1)))
...
(assert (=> (= (rec__students__student_record__self_insured (us_split_fields3 student)) true) (= insurance2 insurance1)))
...
(assert (=> (= (rec__students__student_record__resident (us_split_fields3 student)) true) (= (to_fixed2 o6) (+ (to_fixed2 fees1) 400000))))
...
(assert (=> (= (rec__students__student_record__resident (us_split_fields3 student)) true) (=> (not (= (to_rep1 (rec__students__student_record__meal_plan (us_split_fields3 student))) 0)) (=> (= (to_rep1 (rec__students__student_record__meal_plan (us_split_fields3 student))) 1) (= (to_fixed2 o7) (+ (to_fixed2 fees3) 10000))))))
...
(assert (=> (= (rec__students__student_record__resident (us_split_fields3 student)) true) (=> (not (= (to_rep1 (rec__students__student_record__meal_plan (us_split_fields3 student))) 0)) (=> (not (= (to_rep1 (rec__students__student_record__meal_plan (us_split_fields3 student))) 1)) (=> (= (to_rep1 (rec__students__student_record__meal_plan (us_split_fields3 student))) 2) (= (to_fixed2 o8) (+ (to_fixed2 fees3) 100000)))))))
...
(assert (=> (= (rec__students__student_record__resident (us_split_fields3 student)) true) (=> (not (= (to_rep1 (rec__students__student_record__meal_plan (us_split_fields3 student))) 0)) (=> (not (= (to_rep1 (rec__students__student_record__meal_plan (us_split_fields3 student))) 1)) (=> (not (= (to_rep1 (rec__students__student_record__meal_plan (us_split_fields3 student))) 2)) (= (to_fixed2 o9) (+ (to_fixed2 fees3) 300000)))))))
...
(assert (=> (not (= (rec__students__student_record__resident (us_split_fields3 student)) true)) (=> (not (= (to_rep1 (rec__students__student_record__meal_plan (us_split_fields3 student))) 0)) (=> (= (to_rep1 (rec__students__student_record__meal_plan (us_split_fields3 student))) 1) (= (to_fixed2 o10) (+ (to_fixed2 fees1) 20000))))))
...
(assert (=> (not (= (rec__students__student_record__resident (us_split_fields3 student)) true)) (=> (not (= (to_rep1 (rec__students__student_record__meal_plan (us_split_fields3 student))) 0)) (=> (not (= (to_rep1 (rec__students__student_record__meal_plan (us_split_fields3 student))) 1)) (=> (= (to_rep1 (rec__students__student_record__meal_plan (us_split_fields3 student))) 2) (= (to_fixed2 o11) (+ (to_fixed2 fees1) 150000)))))))
...
(assert (=> (not (= (rec__students__student_record__resident (us_split_fields3 student)) true)) (=> (not (= (to_rep1 (rec__students__student_record__meal_plan (us_split_fields3 student))) 0)) (=> (not (= (to_rep1 (rec__students__student_record__meal_plan (us_split_fields3 student))) 1)) (=> (not (= (to_rep1 (rec__students__student_record__meal_plan (us_split_fields3 student))) 2)) (= (to_fixed2 o12) (+ (to_fixed2 fees1) 450000)))))))
...
(assert (=> (<= 384 (to_fixed (rec__students__student_record__gpa (us_split_fields3 student)))) (= (to_fixed2 o13) (+ (to_fixed2 grants1) 25000))))
(assert (=> (<= 384 (to_fixed (rec__students__student_record__gpa (us_split_fields3 student)))) (= grants1 result14)))
(assert (=> (<= 384 (to_fixed (rec__students__student_record__gpa (us_split_fields3 student)))) (= grants2 o13)))
(assert (=> (<= 384 (to_fixed (rec__students__student_record__gpa (us_split_fields3 student)))) (=> (and (<= 480 (to_fixed (rec__students__student_record__gpa (us_split_fields3 student)))) (= (to_rep (rec__students__student_record__gender (us_split_fields3 student))) 1)) (= (to_fixed2 o14) (+ (to_fixed2 grants2) 25000)))))
(assert (=> (<= 384 (to_fixed (rec__students__student_record__gpa (us_split_fields3 student)))) (=> (and (<= 480 (to_fixed (rec__students__student_record__gpa (us_split_fields3 student)))) (= (to_rep (rec__students__student_record__gender (us_split_fields3 student))) 1)) (= result15 grants2))))
(assert (=> (<= 384 (to_fixed (rec__students__student_record__gpa (us_split_fields3 student)))) (=> (and (<= 480 (to_fixed (rec__students__student_record__gpa (us_split_fields3 student)))) (= (to_rep (rec__students__student_record__gender (us_split_fields3 student))) 1)) (= grants3 o14))))
(assert (=> (<= 384 (to_fixed (rec__students__student_record__gpa (us_split_fields3 student)))) (=> (not (and (<= 480 (to_fixed (rec__students__student_record__gpa (us_split_fields3 student)))) (= (to_rep (rec__students__student_record__gender (us_split_fields3 student))) 1))) (= grants3 grants2))))
(assert (=> (not (<= 384 (to_fixed (rec__students__student_record__gpa (us_split_fields3 student))))) (= grants3 grants1)))
(assert (not (in_range4 (- (+ (to_fixed2 tuition2) (to_fixed2 fees4)) (to_fixed2 grants3)))))
(check-sat)
(exit)
