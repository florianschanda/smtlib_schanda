...
(assert (and (= o24 (* 2 n2)) (in_range1 (* 2 n2))))
(assert (= o25 (+ o24 1)))
(assert (and (= o26 o25) (in_range1 o25)))
(assert (and (= o23 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2)))) (and (not (= (has_key o23 no_element) true)) (forall ((i3 us_rep1)) (=> (= (has_key o23 i3) true) (and (and (<= 1 (get1 o23 i3)) (<= (get1 o23 i3) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields2))))) (forall ((j us_rep1)) (=> (= (has_key o23 j) true) (=> (= (get1 o23 i3) (get1 o23 j)) (= (bool_eq1 i3 j) true))))))))))
(assert (not (= (has_key o23 (mk___rep1 (mk___split_fields1 cu__split_fields2))) true)))
(check-sat)
(exit)
