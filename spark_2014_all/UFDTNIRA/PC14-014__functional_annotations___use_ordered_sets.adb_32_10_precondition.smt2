...
(assert (not (or (< (length (mk___rep r__split_discrs r__split_fields2)) (to_rep (rec__use_ordered_sets__my_sets__set__capacity r__split_discrs))) (= (contains (model__ (mk___rep r__split_discrs r__split_fields2)) o1) true))))
(check-sat)
(exit)
