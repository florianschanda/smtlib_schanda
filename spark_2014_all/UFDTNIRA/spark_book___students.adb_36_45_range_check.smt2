...
(assert (= (to_fixed o6) (+ (to_fixed fees1) 400000)))
...
(assert (= (to_rep1 (rec__students__student_record__meal_plan (us_split_fields3 student))) 2))
(assert (not (in_range1 (+ (to_fixed fees3) 100000))))
(check-sat)
(exit)
