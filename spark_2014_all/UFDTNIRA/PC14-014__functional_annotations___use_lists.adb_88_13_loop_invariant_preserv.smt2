...
(assert (<= 1 i12))
(assert (<= i12 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))))
(assert (not (= (get (model__ (mk___rep l__split_discrs l__split_fields3)) i12) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i12))))
(check-sat)
(exit)
