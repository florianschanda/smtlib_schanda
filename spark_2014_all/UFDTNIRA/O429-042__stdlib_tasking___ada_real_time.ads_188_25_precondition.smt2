...
(define-fun dynamic_invariant ((temp___expr_135 Int) (temp___is_init_132 Bool) (temp___skip_constant_133 Bool) (temp___do_toplevel_134 Bool)) Bool (=> (or (= temp___is_init_132 true) (<= (- 9223372036854775808) 9223372036854775807)) (in_range3 temp___expr_135)))
...
(declare-const o9 duration)
(declare-const o10 Int)
(declare-const o11 duration)
...
(assert (not (not (= (bool_eq time_span_unit time_span_first) true))))
(check-sat)
(exit)
