...
(assert (forall ((x1 Int)) (=> (and (<= (+ an6 1) x1) (<= x1 (ite (< a b) a b))) (not (and (= (divides x1 a) true) (= (divides x1 b) true))))))
...
(assert (= bn9 bn7))
(assert (= an9 an7))
(assert (and (= result6 (divides (int__content math_euclid__gcd__result4) a)) (= (= result6 true) (= (mod2 a (int__content math_euclid__gcd__result4)) 0))))
(assert (= result6 true))
(assert (and (= result7 (divides (int__content math_euclid__gcd__result4) b)) (= (= result7 true) (= (mod2 b (int__content math_euclid__gcd__result4)) 0))))
(assert (= result7 true))
