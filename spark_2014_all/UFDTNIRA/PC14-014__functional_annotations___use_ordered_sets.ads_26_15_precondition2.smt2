...
(assert (and (= o5 (iter_has_element temp___736 temp___735)) (= (= o5 true) (and (<= 1 temp___735) (<= temp___735 (last temp___736))))))
(assert (= (= o6 true) (in_range4 temp___735)))
(assert (= result4 (ite (= o6 true) o5 false)))
(assert (= (= o7 true) (let ((temp___742 (elements (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))))) (forall ((temp___741 Int)) (=> (and (in_range4 temp___741) (= (iter_has_element temp___742 temp___741) true)) (let ((temp___744 (elements s))) (exists ((temp___743 Int)) (and (and (in_range4 temp___743) (= (iter_has_element temp___744 temp___743) true)) (= (get temp___742 temp___741) (f (get temp___744 temp___743)))))))))))
(assert (and (= temp___732 (elements s)) (and (and (and (= (length1 temp___732) (length s)) (forall ((temp___432 Int)) (=> (and (in_range4 temp___432) (= (iter_has_element temp___732 temp___432) true)) (= (contains (model__ s) (get temp___732 temp___432)) true)))) (forall ((item Int)) (=> (and (in_range2 item) (= (contains (model__ s) item) true)) (and (< 0 (find temp___732 item)) (= (equivalent_elements (get temp___732 (find temp___732 item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length s))) (and (= (find temp___732 (get temp___732 i)) i) (= (e_is_find temp___732 (get temp___732 i) i) true)))))))
(assert (and (= o3 (iter_has_element temp___732 temp___731)) (= (= o3 true) (and (<= 1 temp___731) (<= temp___731 (last temp___732))))))
(assert (= (= o4 true) (in_range4 temp___731)))
(assert (= result5 (ite (= o4 true) o3 false)))
(assert (= result5 true))
(assert (not (<= 1 temp___731)))
(check-sat)
(exit)
