...
(assert (= result5 true))
(assert (and (= o19 (keys s)) (and (and (and (= (length3 o19) (length s)) (forall ((temp___396 Int)) (=> (and (in_range3 temp___396) (= (iter_has_element o19 temp___396) true)) (= (has_key (model__ s) (get o19 temp___396)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true)) (and (< 0 (find o19 key2)) (= (equivalent_keys (get o19 (find o19 key2)) key2) true))))) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 (length s))) (and (= (find o19 (get o19 i3)) i3) (= (k_is_find o19 (get o19 i3) i3) true)))))))
(assert (and (= o20 (get o19 i1)) (in_range4 o20)))
(assert (not (= (has_key (model__ s) o20) true)))
(check-sat)
(exit)
