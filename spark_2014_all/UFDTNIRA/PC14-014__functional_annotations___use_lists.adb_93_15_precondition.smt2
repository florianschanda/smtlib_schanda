...
(assert (<= 1 j))
(assert (<= j (- i2 1)))
(assert (and (= o3 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) j)) (in_range3 o3)))
(assert (and (= o2 (+ j (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))) (in_range1 (+ j (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))))))
