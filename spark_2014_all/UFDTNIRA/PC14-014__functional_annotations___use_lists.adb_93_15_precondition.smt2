...
(assert (<= 1 j))
(assert (<= j (- i4 1)))
(assert (and (= o8 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) j)) (in_range3 o8)))
(assert (and (= o7 (+ j (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))) (in_range1 (+ j (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))))))
(assert (and (= o6 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2)))) (= (length1 o6) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields2))))))
(assert (not (<= 1 o7)))
(check-sat)
(exit)
