...
(assert (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (- (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))) (= (contains (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) (f (get (elements s) i2))) true))))
(assert (forall ((g2 Int)) (=> (and (in_range2 g2) (= (contains (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) g2) true)) (exists ((i2 Int)) (and (and (<= 1 i2) (<= i2 (- (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))) (= g2 (f (get (elements s) i2))))))))
(assert (and (= o16 (element s (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range6 o16) (= o16 (get (elements s) (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))))))))
(assert (and (= o17 (f o16)) (and (in_range7 o17) (= o17 (ite (and (<= (- 100) o16) (<= o16 100)) (* o16 2) o16)))))
