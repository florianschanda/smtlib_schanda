...
(assert (= result1 true))
(assert (<= (length (mk___rep r__split_discrs r__split_fields4)) (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1)))
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (= (contains (model__ (mk___rep r__split_discrs r__split_fields4)) (f (get (elements s) i))) true))))
(assert (forall ((g Int)) (=> (and (in_range2 g) (= (contains (model__ (mk___rep r__split_discrs r__split_fields4)) g) true)) (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (= g (f (get (elements s) i))))))))
(assert (and (= o (element s (mk___rep1 cu__split_fields3))) (and (in_range6 o) (= o (get (elements s) (get1 (positions s) (mk___rep1 cu__split_fields3)))))))
(assert (and (= o1 (f o)) (and (in_range7 o1) (= o1 (ite (and (<= (- 100) o) (<= o 100)) (* o 2) o)))))
(assert (and (= (contains (model__ (mk___rep r__split_discrs r__split_fields3)) o1) true) (ite (= (contains (model__ (mk___rep r__split_discrs r__split_fields4)) o1) true) (and (and (and (= (oeq3 (model__ (mk___rep r__split_discrs r__split_fields4)) (model__ (mk___rep r__split_discrs r__split_fields3))) true) (= (oeq4 (positions (mk___rep r__split_discrs r__split_fields3)) (positions (mk___rep r__split_discrs r__split_fields4))) true)) (= (get (elements (mk___rep r__split_discrs r__split_fields3)) (find (elements (mk___rep r__split_discrs r__split_fields3)) o1)) o1)) (= (equal_except (elements (mk___rep r__split_discrs r__split_fields4)) (elements (mk___rep r__split_discrs r__split_fields3)) (find (elements (mk___rep r__split_discrs r__split_fields3)) o1)) true)) (and (and (and (and (and (and (= (length (mk___rep r__split_discrs r__split_fields3)) (+ (length (mk___rep r__split_discrs r__split_fields4)) 1)) (= (ole (model__ (mk___rep r__split_discrs r__split_fields4)) (model__ (mk___rep r__split_discrs r__split_fields3))) true)) (= (included_except (model__ (mk___rep r__split_discrs r__split_fields3)) (model__ (mk___rep r__split_discrs r__split_fields4)) o1) true)) (= (get (elements (mk___rep r__split_discrs r__split_fields3)) (find (elements (mk___rep r__split_discrs r__split_fields3)) o1)) o1)) (= (range_equal (elements (mk___rep r__split_discrs r__split_fields4)) (elements (mk___rep r__split_discrs r__split_fields3)) 1 (- (find (elements (mk___rep r__split_discrs r__split_fields3)) o1) 1)) true)) (= (range_shifted (elements (mk___rep r__split_discrs r__split_fields4)) (elements (mk___rep r__split_discrs r__split_fields3)) (find (elements (mk___rep r__split_discrs r__split_fields3)) o1) (length (mk___rep r__split_discrs r__split_fields4)) 1) true)) (= (p_positions_shifted (positions (mk___rep r__split_discrs r__split_fields4)) (positions (mk___rep r__split_discrs r__split_fields3)) (find (elements (mk___rep r__split_discrs r__split_fields3)) o1) 1) true)))))
