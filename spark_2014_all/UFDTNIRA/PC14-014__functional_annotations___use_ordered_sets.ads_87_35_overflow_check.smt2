...
(assert (and (= o68 (get o62 o64)) (in_range5 o68)))
(assert (= o69 (ite (= o68 o67) true false)))
(assert (and (= o60 (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) i3)) (in_range5 o60)))
(assert (and (= o56 (* 2 i3)) (in_range1 (* 2 i3))))
(assert (= o57 (- o56 1)))
