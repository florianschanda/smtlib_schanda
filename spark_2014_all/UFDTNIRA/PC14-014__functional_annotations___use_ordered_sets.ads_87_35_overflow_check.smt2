...
(define-fun o17 () us_rep2 (mk___rep1 (mk___split_fields1 o3)))
...
(assert (=> (= result2 true) (and (= o17 (next (mk___rep s__split_discrs s__split_fields3) (mk___rep1 cu__split_fields2))) (ite (= (ite (= (bool_eq2 (mk___rep1 cu__split_fields2) no_element) false) (= (get1 (positions (mk___rep s__split_discrs s__split_fields3)) (mk___rep1 cu__split_fields2)) (length (mk___rep s__split_discrs s__split_fields3))) true) true) (= (bool_eq2 o17 no_element) true) (and (= (has_key (positions (mk___rep s__split_discrs s__split_fields3)) o17) true) (= (get1 (positions (mk___rep s__split_discrs s__split_fields3)) o17) (+ (get1 (positions (mk___rep s__split_discrs s__split_fields3)) (mk___rep1 cu__split_fields2)) 1)))))))
(assert (=> (= result2 true) (and (= temp___8311 (next (mk___rep s__split_discrs s__split_fields3) o17)) (ite (= (ite (= (bool_eq2 o17 no_element) false) (= (get1 (positions (mk___rep s__split_discrs s__split_fields3)) o17) (length (mk___rep s__split_discrs s__split_fields3))) true) true) (= (bool_eq2 temp___8311 no_element) true) (and (= (has_key (positions (mk___rep s__split_discrs s__split_fields3)) temp___8311) true) (= (get1 (positions (mk___rep s__split_discrs s__split_fields3)) temp___8311) (+ (get1 (positions (mk___rep s__split_discrs s__split_fields3)) o17) 1)))))))
...
(assert (and (= o12 (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) i)) (in_range2 o12)))
(assert (= o13 (+ o12 1)))
(assert (and (= o14 o13) (in_range8 o13)))
(assert (and (= o10 (* 2 i)) (in_range7 (* 2 i))))
(assert (and (= o11 o10) (in_range3 o10)))
(assert (and (= o9 (elements (mk___rep s__split_discrs (us_split_fields__content s__split_fields8)))) (and (and (and (= (length1 o9) (length (mk___rep s__split_discrs (us_split_fields__content s__split_fields8)))) (forall ((temp___432 Int)) (=> (and (in_range3 temp___432) (= (iter_has_element o9 temp___432) true)) (= (contains (model__ (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))) (get o9 temp___432)) true)))) (forall ((item Int)) (=> (and (in_range5 item) (= (contains (model__ (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))) item) true)) (and (< 0 (find o9 item)) (= (equivalent_elements (get o9 (find o9 item)) item) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))))) (and (= (find o9 (get o9 i1)) i1) (= (e_is_find o9 (get o9 i1) i1) true)))))))
(assert (and (= o15 (get o9 o11)) (in_range2 o15)))
(assert (= o16 (ite (= o15 o14) true false)))
(assert (and (= o8 (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) i)) (in_range2 o8)))
(assert (and (= o6 (* 2 i)) (in_range7 (* 2 i))))
(assert (= o7 (- o6 1)))
