...
(assert (=> (< 1 c1) (or (and (and (= c1 c4) (= c5 c1)) (and (= (mod2 a c1) 0) (= (mod2 b c1) 0))) (and (not (and (= (mod2 a c1) 0) (= (mod2 b c1) 0))) (and (and (= c3 c4) (= c5 c3)) (and (ite (not (= (mod2 a c1) 0)) (not (= (divides c1 a) true)) (not (= (divides c1 b) true))) (and (forall ((x1 Int)) (=> (and (<= c2 x1) (<= x1 (ite (< a b) a b))) (not (and (= (divides x1 a) true) (= (divides x1 b) true))))) (and (=> (<= 1 2147483647) (in_range1 c2)) (and (and (and (= o1 (- c2 1)) (in_range1 (- c2 1))) (and (= c2 result1) (= c3 o1))) (or (not (< 1 c3)) (and (< 1 c3) (and (= (mod2 a c3) 0) (= (mod2 b c3) 0)))))))))))))
...
(assert (= c11 c9))
(assert (and (= result3 (divides math_simple_abstract__gcd__result4 a)) (= (= result3 true) (exists ((c14 Int)) (and (and (<= 1 c14) (<= c14 2147483647)) (= (* math_simple_abstract__gcd__result4 c14) a))))))
(assert (= result3 true))
(assert (and (= result4 (divides math_simple_abstract__gcd__result4 b)) (= (= result4 true) (exists ((c14 Int)) (and (and (<= 1 c14) (<= c14 2147483647)) (= (* math_simple_abstract__gcd__result4 c14) b))))))
(assert (= result4 true))
