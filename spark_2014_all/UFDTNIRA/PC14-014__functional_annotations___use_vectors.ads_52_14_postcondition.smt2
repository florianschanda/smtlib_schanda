...
(assert (= i1 first))
(assert (=> (and (<= first i1) (<= i1 r17b)) (= temp___491 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))))))
(assert (=> (and (<= first i1) (<= i1 r17b)) (= temp___490 (last5 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields)))))))
(assert (=> (and (<= first i1) (<= i1 r17b)) (= temp___488 i1)))
(assert (=> (and (<= first i1) (<= i1 r17b)) (= temp___494 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))))))
(assert (=> (and (<= first i1) (<= i1 r17b)) (and (= v__split_discrs (mk___split_discrs temp___487)) (= v__split_fields temp___4871))))
(assert (=> (and (<= first i1) (<= i1 r17b)) (= temp___492 (length (mk___rep v__split_discrs (mk___split_fields v__split_fields))))))
(assert (=> (and (<= first i1) (<= i1 r17b)) (= temp___489 (length (mk___rep v__split_discrs (mk___split_fields v__split_fields))))))
(assert (=> (and (<= first i1) (<= i1 r17b)) (= (length (mk___rep v__split_discrs v__split_fields12)) (+ temp___489 (- i2 first)))))
(assert (=> (and (<= first i1) (<= i1 r17b)) (forall ((j Int)) (=> (and (<= first j) (<= j temp___490)) (= (get (model__ (mk___rep v__split_discrs v__split_fields12)) j) (get temp___491 j))))))
(assert (=> (and (<= first i1) (<= i1 r17b)) (forall ((j Int)) (=> (and (<= first j) (<= j (- i2 1))) (= (get (model__ (mk___rep v__split_discrs v__split_fields12)) (+ j temp___492)) (get temp___494 j))))))
(assert (=> (and (<= first i1) (<= i1 r17b)) (and (and (dynamic_property2 0 last2 (to_rep1 (rec__use_vectors__my_vectors__vector__capacity v__split_discrs))) (=> (<= first r17b) (dynamic_property6 first r17b i2))) (and (<= first i2) (<= i2 r17b)))))
(assert (=> (and (<= first i1) (<= i1 r17b)) (and (= us i2) (dynamic_property1 first1 last1 i2))))
(assert (=> (and (<= first i1) (<= i1 r17b)) (= o1 i2)))
(assert (=> (and (<= first i1) (<= i1 r17b)) (and (= o2 (get (model__ (mk___rep v__split_discrs v__split_fields12)) o1)) (and (in_range4 o2) (= o2 (get (model__ (mk___rep v__split_discrs v__split_fields12)) o1))))))
(assert (=> (and (<= first i1) (<= i1 r17b)) (and (and (and (= (length (mk___rep v__split_discrs v__split_fields11)) (+ (length (mk___rep v__split_discrs v__split_fields12)) 1)) (= (olt (model__ (mk___rep v__split_discrs v__split_fields12)) (model__ (mk___rep v__split_discrs v__split_fields11))) true)) (= (get (model__ (mk___rep v__split_discrs v__split_fields11)) (+ (last5 (model__ (mk___rep v__split_discrs v__split_fields12))) 1)) o2)) (dynamic_property2 0 last2 (to_rep1 (rec__use_vectors__my_vectors__vector__capacity v__split_discrs))))))
(assert (=> (and (<= first i1) (<= i1 r17b)) (= i2 r17b)))
(assert (=> (and (<= first i1) (<= i1 r17b)) (= i2 i3)))
(assert (=> (and (<= first i1) (<= i1 r17b)) (= v__split_fields4 v__split_fields3)))
(assert (=> (and (<= first i1) (<= i1 r17b)) (= i4 i2)))
(assert (=> (and (<= first i1) (<= i1 r17b)) (= v__split_fields10 v__split_fields11)))
(assert (=> (and (<= first i1) (<= i1 r17b)) (= i5 (mk_int__ref i3))))
(assert (=> (and (<= first i1) (<= i1 r17b)) (= v__split_fields6 (mk___split_fields__ref (mk___split_fields v__split_fields4)))))
(assert (=> (and (<= first i1) (<= i1 r17b)) (= i6 i4)))
(assert (=> (and (<= first i1) (<= i1 r17b)) (= v__split_fields7 v__split_fields10)))
(assert (=> (not (and (<= first i1) (<= i1 r17b))) (= i5 (mk_int__ref i1))))
(assert (=> (not (and (<= first i1) (<= i1 r17b))) (= v__split_fields6 (mk___split_fields__ref (mk___split_fields v__split_fields)))))
(assert (=> (not (and (<= first i1) (<= i1 r17b))) (= i6 i1)))
(assert (=> (not (and (<= first i1) (<= i1 r17b))) (= v__split_fields7 (mk___split_fields v__split_fields1))))
(assert (= i7 i5))
