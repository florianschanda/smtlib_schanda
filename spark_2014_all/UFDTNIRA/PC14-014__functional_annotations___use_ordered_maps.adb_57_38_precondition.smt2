...
(assert (and (= temp___686 (keys (mk___rep r__split_discrs (mk___split_fields r__split_fields1)))) (and (and (and (= (length3 temp___686) (length (mk___rep r__split_discrs (mk___split_fields r__split_fields1)))) (forall ((temp___396 Int)) (=> (and (in_range3 temp___396) (= (iter_has_element temp___686 temp___396) true)) (= (has_key (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) (get temp___686 temp___396)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) key2) true)) (and (< 0 (find temp___686 key2)) (= (equivalent_keys (get temp___686 (find temp___686 key2)) key2) true))))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length (mk___rep r__split_discrs (mk___split_fields r__split_fields1))))) (and (= (find temp___686 (get temp___686 i2)) i2) (= (k_is_find temp___686 (get temp___686 i2) i2) true)))))))
(assert (and (= o16 (iter_has_element temp___686 temp___685)) (= (= o16 true) (and (<= 1 temp___685) (<= temp___685 (last temp___686))))))
(assert (= (= o17 true) (in_range3 temp___685)))
(assert (= result4 (ite (= o17 true) o16 false)))
(assert (= result4 true))
(assert (and (= k (get temp___686 temp___685)) (in_range4 k)))
(assert (and (= o18 (positions s)) (and (not (= (has_key1 o18 no_element) true)) (forall ((i2 us_rep1)) (=> (= (has_key1 o18 i2) true) (and (and (<= 1 (get1 o18 i2)) (<= (get1 o18 i2) (length s))) (forall ((j us_rep1)) (=> (= (has_key1 o18 j) true) (=> (= (get1 o18 i2) (get1 o18 j)) (= (bool_eq1 i2 j) true))))))))))
(assert (not (= (has_key1 o18 (mk___rep1 (mk___split_fields1 cu__split_fields2))) true)))
(check-sat)
(exit)
