...
(assert (let ((temp___690 (keys (mk___rep r__split_discrs r__split_fields2)))) (forall ((temp___689 Int)) (=> (and (in_range3 temp___689) (= (iter_has_element temp___690 temp___689) true)) (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (= (get temp___690 temp___689) (get (keys s) i))))))))
(assert (and (= temp___686 (keys (mk___rep r__split_discrs r__split_fields2))) (and (and (and (= (length3 temp___686) (length (mk___rep r__split_discrs r__split_fields2))) (forall ((temp___396 Int)) (=> (and (in_range3 temp___396) (= (iter_has_element temp___686 temp___396) true)) (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2)) (get temp___686 temp___396)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2)) key2) true)) (and (< 0 (find temp___686 key2)) (= (equivalent_keys (get temp___686 (find temp___686 key2)) key2) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep r__split_discrs r__split_fields2)))) (and (= (find temp___686 (get temp___686 i)) i) (= (k_is_find temp___686 (get temp___686 i) i) true)))))))
(assert (and (= o (iter_has_element temp___686 temp___685)) (= (= o true) (and (<= 1 temp___685) (<= temp___685 (last temp___686))))))
(assert (= (= o1 true) (in_range3 temp___685)))
(assert (= result2 (ite (= o1 true) o false)))
(assert (= result2 true))
(assert (and (= k (get temp___686 temp___685)) (in_range4 k)))
