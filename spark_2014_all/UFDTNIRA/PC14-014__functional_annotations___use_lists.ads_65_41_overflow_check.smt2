...
(assert (and (= o9 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i)) (in_range4 o9)))
(assert (and (= o7 (* 2 i)) (in_range1 (* 2 i))))
(assert (and (= o8 o7) (in_range3 o7)))
(assert (and (= o6 (model__ (mk___rep l__split_discrs (us_split_fields__content l__split_fields8)))) (= (length1 o6) (length (mk___rep l__split_discrs (us_split_fields__content l__split_fields8))))))
(assert (and (= o10 (get o6 o8)) (in_range4 o10)))
