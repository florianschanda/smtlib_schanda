...
(assert (= y1 o))
(assert (< x1 10))
(assert (and (= o1 (+ y1 3)) (in_range (+ y1 3))))
(assert (= y1 result3))
(assert (= y2 o1))
(assert (and (= o2 (+ x1 1)) (in_range (+ x1 1))))
(assert (= x1 result4))
(assert (= x2 o2))
(assert (= y3 (+ y1 (* 3 (- x3 2)))))
(assert (<= 3 x3))
(assert (and (=> (<= (- 2147483648) 2147483647) (in_range x3)) (=> (<= (- 2147483648) 2147483647) (in_range y3))))
(assert (< x3 10))
(assert (and (= o8 (+ y3 3)) (in_range (+ y3 3))))
(assert (= y3 result5))
(assert (= y4 o8))
(assert (and (= o9 (+ x3 1)) (in_range (+ x3 1))))
(assert (= result6 x3))
(assert (= x4 o9))
(assert (not (= y4 (+ y1 (* 3 (- x4 2))))))
(check-sat)
(exit)
