...
(assert (in_range3 temp___678))
(assert (= (iter_has_element (keys (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) temp___678) true))
(assert (not (exists ((temp___680 Int)) (and (and (in_range3 temp___680) (= (iter_has_element (keys s) temp___680) true)) (= (get2 (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) (get (keys (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) temp___678)) (f (get2 (model__ s) (get (keys s) temp___680))))))))
(check-sat)
(exit)
