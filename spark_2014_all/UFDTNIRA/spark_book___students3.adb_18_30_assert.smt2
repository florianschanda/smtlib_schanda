...
(assert (=> (not (= (rec__students3__student_record__in_state (us_split_fields3 student)) true)) (= (to_fixed o2) (+ (to_fixed tuition1) (fxp_div_int2 (to_fixed tuition1) 2)))))
(assert (=> (not (= (rec__students3__student_record__in_state (us_split_fields3 student)) true)) (= result3 tuition1)))
(assert (=> (not (= (rec__students3__student_record__in_state (us_split_fields3 student)) true)) (= tuition2 o2)))
(assert (=> (not (not (= (rec__students3__student_record__in_state (us_split_fields3 student)) true))) (= tuition2 tuition1)))
(assert (not (<= (to_fixed tuition2) 3000000)))
(check-sat)
(exit)
