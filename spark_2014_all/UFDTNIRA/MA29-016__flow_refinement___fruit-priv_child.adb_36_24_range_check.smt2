...
(assert (forall ((fruit__apples Int) (fruit__oranges Int) (fruit__price_of_apple Int) (fruit__price_of_orange Int) (fruit__pub_child__apples_in_fruit_salad Int) (fruit__pub_child__oranges_in_fruit_salad Int) (fruit__priv_child__extra_cost Int)) (forall ((fruit__fruits us_private) (fruit__pub_child__fruit_salad us_private)) (! (=> (and (and (and (and (and (and (dynamic_invariant fruit__apples true true true true) (dynamic_invariant fruit__oranges true true true true)) (dynamic_invariant fruit__price_of_apple true true true true)) (dynamic_invariant fruit__price_of_orange true true true true)) (dynamic_invariant fruit__pub_child__apples_in_fruit_salad true true true true)) (dynamic_invariant fruit__pub_child__oranges_in_fruit_salad true true true true)) (dynamic_invariant fruit__priv_child__extra_cost true true true true)) (dynamic_invariant (price_of_fruit_salad fruit__apples fruit__fruits fruit__oranges fruit__price_of_apple fruit__price_of_orange fruit__pub_child__apples_in_fruit_salad fruit__pub_child__fruit_salad fruit__pub_child__oranges_in_fruit_salad fruit__priv_child__extra_cost) true false true true)) :pattern ((price_of_fruit_salad fruit__apples fruit__fruits fruit__oranges fruit__price_of_apple fruit__price_of_orange fruit__pub_child__apples_in_fruit_salad fruit__pub_child__fruit_salad fruit__pub_child__oranges_in_fruit_salad fruit__priv_child__extra_cost))))))
(declare-fun get_price_of_apple (Int) Int)
(declare-fun get_price_of_apple__function_guard (Int Int) Bool)
(assert (forall ((fruit__price_of_apple Int)) (! (=> (dynamic_invariant fruit__price_of_apple true true true true) (dynamic_invariant (get_price_of_apple fruit__price_of_apple) true false true true)) :pattern ((get_price_of_apple fruit__price_of_apple)))))
(assert (forall ((fruit__price_of_apple Int)) (! (=> (dynamic_invariant fruit__price_of_apple true true true true) (= (get_price_of_apple fruit__price_of_apple) fruit__price_of_apple)) :pattern ((get_price_of_apple fruit__price_of_apple)))))
(declare-fun get_price_of_orange (Int) Int)
(declare-fun get_price_of_orange__function_guard (Int Int) Bool)
(assert (forall ((fruit__price_of_orange Int)) (! (=> (dynamic_invariant fruit__price_of_orange true true true true) (dynamic_invariant (get_price_of_orange fruit__price_of_orange) true false true true)) :pattern ((get_price_of_orange fruit__price_of_orange)))))
(assert (forall ((fruit__price_of_orange Int)) (! (=> (dynamic_invariant fruit__price_of_orange true true true true) (= (get_price_of_orange fruit__price_of_orange) fruit__price_of_orange)) :pattern ((get_price_of_orange fruit__price_of_orange)))))
...
(assert (and (and (and (and (and (in_range1 fruit_salads1) (in_range1 apples1)) (in_range1 oranges1)) (in_range1 price_of_apple1)) (in_range1 extra_cost1)) (in_range1 price_of_orange1)))
