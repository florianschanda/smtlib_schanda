...
(assert (forall ((d1 duration) (d2 duration)) (! (=> (not (= (to_fixed d2) 0)) (dynamic_invariant (div2 d1 d2) true false true)) :pattern ((div2 d1 d2)))))
...
(assert (= result1 d2))
(assert (= d21 o1))
(assert (and (= o2 (fxp_div_result_int (to_fixed d11) 1)) (in_range (fxp_div_result_int (to_fixed d11) 1))))
(assert (and (= o3 o2) (in_range o2)))
(assert (= result2 r))
(assert (= r1 o3))
(assert (= r1 4))
(assert (not (not (= (to_fixed d21) 0))))
(check-sat)
(exit)
