...
(declare-const temp___834 count_type)
(declare-const temp___837 us_rep1)
(declare-const temp___835 Int)
(declare-const temp___838 us_rep1)
(declare-const temp___840 us_rep1)
(declare-const temp___836 us_rep1)
(declare-const temp___833 count_type)
(declare-const temp___8331 us_main_type)
(declare-const temp___832 Int)
(declare-const o Int)
...
(define-fun o20 () us_rep2 (mk___rep1 (mk___split_fields1 o3)))
...
(assert (=> (= result2 true) (= temp___839 (length (mk___rep s__split_discrs (mk___split_fields s__split_fields))))))
(assert (=> (= result2 true) (= temp___834 cu__split_fields1)))
(assert (=> (= result2 true) (= temp___837 (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))))))
(assert (=> (= result2 true) (= temp___835 (length (mk___rep s__split_discrs (mk___split_fields s__split_fields))))))
(assert (=> (= result2 true) (= temp___838 (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))))))
(assert (=> (= result2 true) (= temp___840 (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))))))
(assert (=> (= result2 true) (= temp___836 (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))))))
(assert (=> (= result2 true) (and (= s__split_discrs (mk___split_discrs temp___833)) (= s__split_fields temp___8331))))
(assert (=> (= result2 true) (= temp___832 n1)))
(assert (=> (= result2 true) (= (length (mk___rep s__split_discrs s__split_fields2)) (+ temp___835 n2))))
(assert (=> (= result2 true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 n2)) (and (= (get (elements (mk___rep s__split_discrs s__split_fields2)) (* 2 i1)) (+ (get temp___836 i1) 1)) (= (get (elements (mk___rep s__split_discrs s__split_fields2)) (- (* 2 i1) 1)) (get temp___837 i1)))))))
(assert (=> (= result2 true) (forall ((i1 Int)) (=> (and (<= (+ (* 2 n2) 1) i1) (<= i1 (length (mk___rep s__split_discrs s__split_fields2)))) (= (get (elements (mk___rep s__split_discrs s__split_fields2)) i1) (get temp___838 (- i1 n2)))))))
(assert (=> (= result2 true) (forall ((i1 Int)) (=> (and (<= (+ n2 1) i1) (<= i1 temp___839)) (= (get (elements (mk___rep s__split_discrs s__split_fields2)) (+ i1 n2)) (get temp___840 i1))))))
(assert (=> (= result2 true) (= (get1 (positions (mk___rep s__split_discrs s__split_fields2)) (mk___rep1 cu__split_fields2)) (+ (* 2 n2) 1))))
(assert (=> (= result2 true) (=> (<= 0 2147483647) (in_range1 n2))))
...
(assert (=> (= result2 true) (and (= o (element (mk___rep s__split_discrs s__split_fields2) (mk___rep1 cu__split_fields2))) (and (in_range6 o) (= o (get (elements (mk___rep s__split_discrs s__split_fields2)) (get1 (positions (mk___rep s__split_discrs s__split_fields2)) (mk___rep1 cu__split_fields2))))))))
(assert (=> (= result2 true) (= o1 (+ o 1))))
(assert (=> (= result2 true) (and (= o2 o1) (in_range8 o1))))
(assert (=> (= result2 true) (and (= (contains (model__ (mk___rep s__split_discrs s__split_fields3)) o2) true) (ite (= (contains (model__ (mk___rep s__split_discrs s__split_fields2)) o2) true) (and (and (and (= (oeq2 (model__ (mk___rep s__split_discrs s__split_fields2)) (model__ (mk___rep s__split_discrs s__split_fields3))) true) (= (oeq3 (positions (mk___rep s__split_discrs s__split_fields3)) (positions (mk___rep s__split_discrs s__split_fields2))) true)) (= (get (elements (mk___rep s__split_discrs s__split_fields3)) (find (elements (mk___rep s__split_discrs s__split_fields3)) o2)) o2)) (= (equal_except (elements (mk___rep s__split_discrs s__split_fields2)) (elements (mk___rep s__split_discrs s__split_fields3)) (find (elements (mk___rep s__split_discrs s__split_fields3)) o2)) true)) (and (and (and (and (and (and (= (length (mk___rep s__split_discrs s__split_fields3)) (+ (length (mk___rep s__split_discrs s__split_fields2)) 1)) (= (ole (model__ (mk___rep s__split_discrs s__split_fields2)) (model__ (mk___rep s__split_discrs s__split_fields3))) true)) (= (included_except (model__ (mk___rep s__split_discrs s__split_fields3)) (model__ (mk___rep s__split_discrs s__split_fields2)) o2) true)) (= (get (elements (mk___rep s__split_discrs s__split_fields3)) (find (elements (mk___rep s__split_discrs s__split_fields3)) o2)) o2)) (= (range_equal (elements (mk___rep s__split_discrs s__split_fields2)) (elements (mk___rep s__split_discrs s__split_fields3)) 1 (- (find (elements (mk___rep s__split_discrs s__split_fields3)) o2) 1)) true)) (= (range_shifted (elements (mk___rep s__split_discrs s__split_fields2)) (elements (mk___rep s__split_discrs s__split_fields3)) (find (elements (mk___rep s__split_discrs s__split_fields3)) o2) (length (mk___rep s__split_discrs s__split_fields2)) 1) true)) (= (p_positions_shifted (positions (mk___rep s__split_discrs s__split_fields2)) (positions (mk___rep s__split_discrs s__split_fields3)) (find (elements (mk___rep s__split_discrs s__split_fields3)) o2) 1) true))))))
(assert (=> (= result2 true) (and (= o20 (next (mk___rep s__split_discrs s__split_fields3) (mk___rep1 cu__split_fields2))) (ite (= (ite (= (bool_eq2 (mk___rep1 cu__split_fields2) no_element) false) (= (get1 (positions (mk___rep s__split_discrs s__split_fields3)) (mk___rep1 cu__split_fields2)) (length (mk___rep s__split_discrs s__split_fields3))) true) true) (= (bool_eq2 o20 no_element) true) (and (= (has_key (positions (mk___rep s__split_discrs s__split_fields3)) o20) true) (= (get1 (positions (mk___rep s__split_discrs s__split_fields3)) o20) (+ (get1 (positions (mk___rep s__split_discrs s__split_fields3)) (mk___rep1 cu__split_fields2)) 1)))))))
(assert (=> (= result2 true) (and (= temp___8311 (next (mk___rep s__split_discrs s__split_fields3) o20)) (ite (= (ite (= (bool_eq2 o20 no_element) false) (= (get1 (positions (mk___rep s__split_discrs s__split_fields3)) o20) (length (mk___rep s__split_discrs s__split_fields3))) true) true) (= (bool_eq2 temp___8311 no_element) true) (and (= (has_key (positions (mk___rep s__split_discrs s__split_fields3)) temp___8311) true) (= (get1 (positions (mk___rep s__split_discrs s__split_fields3)) temp___8311) (+ (get1 (positions (mk___rep s__split_discrs s__split_fields3)) o20) 1)))))))
(assert (=> (= result2 true) (= result3 (mk___split_fields__ref1 cu__split_fields2))))
(assert (=> (= result2 true) (= cu__split_fields3 (mk___split_fields1 temp___831))))
(assert (=> (= result2 true) (and (= o4 (+ n2 1)) (in_range7 (+ n2 1)))))
...
(assert (and (= o15 (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) i)) (in_range2 o15)))
(assert (= o16 (+ o15 1)))
(assert (and (= o17 o16) (in_range8 o16)))
(assert (and (= o13 (* 2 i)) (in_range7 (* 2 i))))
(assert (and (= o14 o13) (in_range3 o13)))
(assert (and (= o12 (elements (mk___rep s__split_discrs (us_split_fields__content s__split_fields8)))) (and (and (and (= (length1 o12) (length (mk___rep s__split_discrs (us_split_fields__content s__split_fields8)))) (forall ((temp___432 Int)) (=> (and (in_range3 temp___432) (= (iter_has_element o12 temp___432) true)) (= (contains (model__ (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))) (get o12 temp___432)) true)))) (forall ((item Int)) (=> (and (in_range5 item) (= (contains (model__ (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))) item) true)) (and (< 0 (find o12 item)) (= (equivalent_elements (get o12 (find o12 item)) item) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))))) (and (= (find o12 (get o12 i1)) i1) (= (e_is_find o12 (get o12 i1) i1) true)))))))
(assert (and (= o18 (get o12 o14)) (in_range2 o18)))
(assert (= o19 (ite (= o18 o17) true false)))
(assert (and (= o11 (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) i)) (in_range2 o11)))
(assert (and (= o7 (* 2 i)) (in_range7 (* 2 i))))
(assert (= o8 (- o7 1)))
(assert (and (= o9 o8) (in_range7 o8)))
(assert (and (= o10 o9) (in_range3 o9)))
(assert (and (= o6 (elements (mk___rep s__split_discrs (us_split_fields__content s__split_fields8)))) (and (and (and (= (length1 o6) (length (mk___rep s__split_discrs (us_split_fields__content s__split_fields8)))) (forall ((temp___432 Int)) (=> (and (in_range3 temp___432) (= (iter_has_element o6 temp___432) true)) (= (contains (model__ (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))) (get o6 temp___432)) true)))) (forall ((item Int)) (=> (and (in_range5 item) (= (contains (model__ (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))) item) true)) (and (< 0 (find o6 item)) (= (equivalent_elements (get o6 (find o6 item)) item) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))))) (and (= (find o6 (get o6 i1)) i1) (= (e_is_find o6 (get o6 i1) i1) true)))))))
(assert (not (<= 1 o10)))
(check-sat)
(exit)
