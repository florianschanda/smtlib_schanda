...
(declare-const res fixed)
(declare-const pi_compute__leibniz_fixed__result fixed)
...
(declare-const pi_compute__leibniz_fixed__result1 fixed)
(declare-const pi_compute__leibniz_fixed__result2 fixed__ref)
(declare-const pi_compute__leibniz_fixed__result3 fixed)
...
(declare-const pi_compute__leibniz_fixed__result4 fixed__ref)
...
(declare-const pi_compute__leibniz_fixed__result5 fixed)
...
(assert (= t101 o9))
(assert (= (to_fixed1 o10) (* (- (+ (- (+ (- (+ (- (+ (- (to_fixed1 t11) (to_fixed1 t21)) (to_fixed1 t31)) (to_fixed1 t41)) (to_fixed1 t51)) (to_fixed1 t61)) (to_fixed1 t71)) (to_fixed1 t81)) (to_fixed1 t91)) (to_fixed1 t101)) 4)))
(assert (= result10 (mk_fixed__ref res)))
(assert (= res1 o10))
(assert (not (= (to_fixed1 res1) 3189596)))
(check-sat)
(exit)
