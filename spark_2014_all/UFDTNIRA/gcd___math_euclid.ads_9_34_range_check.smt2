...
(assert (and (= result9 (divides (int__content math_euclid__gcd__result4) a)) (= (= result9 true) (= (mod2 a (int__content math_euclid__gcd__result4)) 0))))
(assert (= result9 true))
(assert (and (= result10 (divides (int__content math_euclid__gcd__result4) b)) (= (= result10 true) (= (mod2 b (int__content math_euclid__gcd__result4)) 0))))
(assert (= result10 true))
(assert (<= (+ (int__content math_euclid__gcd__result4) 1) x2))
(assert (<= x2 (ite (< a b) a b)))
(assert (and (= o10 x2) (in_range2 x2)))
(assert (and (= o11 (divides o10 b)) (= (= o11 true) (= (mod2 b o10) 0))))
