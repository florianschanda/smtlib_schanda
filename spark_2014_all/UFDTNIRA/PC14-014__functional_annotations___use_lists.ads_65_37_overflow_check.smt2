...
(assert (and (= o7 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i)) (in_range2 o7)))
...
(assert (and (= o8 (get o4 o6)) (in_range2 o8)))
