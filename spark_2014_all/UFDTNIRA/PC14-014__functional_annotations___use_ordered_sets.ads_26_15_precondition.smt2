...
(assert (= (= o25 true) (let ((temp___700 (elements (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))))) (forall ((temp___699 Int)) (=> (and (in_range3 temp___699) (= (iter_has_element temp___700 temp___699) true)) (let ((temp___702 (elements s))) (exists ((temp___701 Int)) (and (and (in_range3 temp___701) (= (iter_has_element temp___702 temp___701) true)) (= (get temp___700 temp___699) (f (get temp___702 temp___701)))))))))))
(assert (not true))
(check-sat)
(exit)
