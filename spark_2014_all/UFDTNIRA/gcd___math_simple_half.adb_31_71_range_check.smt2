...
(assert (= j1 r4b))
(assert (=> (and (<= r4b j1) (<= j1 (- (ite (< a b) a b) 1))) (= temp___154 j1)))
...
(assert (=> (and (<= r4b j1) (<= j1 (- (ite (< a b) a b) 1))) (forall ((x1 Int)) (=> (and (<= (+ c2 1) x1) (<= x1 j2)) (not (= (divides x1 (ite (< a b) a b)) true))))))
...
(assert (< 1 c3))
(assert (forall ((x1 Int)) (=> (and (<= c3 x1) (<= x1 (ite (< a b) a b))) (not (and (= (divides x1 a) true) (= (divides x1 b) true))))))
