...
(assert (<= (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields1))) i3))
(assert (<= i3 (length s)))
(assert (not (not (= (has_key (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields))) (get (keys s) i3)) true))))
(check-sat)
(exit)
