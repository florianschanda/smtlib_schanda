...
(assert (= an11 an9))
(assert (= ao11 ao9))
(assert (=> (= (int__content a__pgcd__result4) 0) (= result10 true)))
(assert (=> (not (= (int__content a__pgcd__result4) 0)) (and (= o10 (abs a)) (in_range1 (abs a)))))
(assert (=> (not (= (int__content a__pgcd__result4) 0)) (= o11 (ite (<= (int__content a__pgcd__result4) o10) true false))))
(assert (=> (not (= (int__content a__pgcd__result4) 0)) (= result10 (ite (<= 1 (int__content a__pgcd__result4)) o11 false))))
