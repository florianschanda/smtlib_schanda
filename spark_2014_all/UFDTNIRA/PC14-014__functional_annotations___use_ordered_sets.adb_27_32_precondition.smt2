...
(assert (= result2 true))
(assert (and (= o4 (elements s)) (and (and (and (= (length2 o4) (length s)) (forall ((temp___390 Int)) (=> (and (in_range3 temp___390) (= (iter_has_element o4 temp___390) true)) (= (contains (model__ s) (get o4 temp___390)) true)))) (forall ((item Int)) (=> (and (in_range2 item) (= (contains (model__ s) item) true)) (and (< 0 (find o4 item)) (= (equivalent_elements (get o4 (find o4 item)) item) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (and (= (find o4 (get o4 i1)) i1) (= (e_is_find o4 (get o4 i1) i1) true)))))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
