...
(define-fun dynamic_invariant ((temp___expr_158 Int) (temp___is_init_154 Bool) (temp___skip_constant_155 Bool) (temp___do_toplevel_156 Bool) (temp___do_typ_inv_157 Bool)) Bool (=> (or (= temp___is_init_154 true) (<= 0 1000)) (in_range temp___expr_158)))
...
(assert (forall ((x Int)) (! (=> (dynamic_invariant1 x true true true true) (dynamic_invariant1 (f x) true false true true)) :pattern ((f x)))))
(declare-const x Int)
