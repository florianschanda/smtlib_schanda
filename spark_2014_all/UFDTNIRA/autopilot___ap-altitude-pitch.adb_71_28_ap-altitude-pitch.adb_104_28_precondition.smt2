...
(assert (=> (not (< 10 result__1)) (=> (< result__1 (- 10)) (= result3 result__1))))
(assert (=> (not (< 10 result__1)) (=> (< result__1 (- 10)) (= result__3 (- 10)))))
(assert (=> (not (< 10 result__1)) (=> (not (< result__1 (- 10))) (= result__3 result__1))))
