...
(declare-const temp___328 even)
(declare-const temp___3281 even)
...
(assert (= temp___328 o2))
(assert (= temp___3281 o3))
(assert (= result x__split_fields))
(assert (= result1 x__split_fields1))
(assert (= x__split_fields2 temp___328))
(assert (= x__split_fields3 temp___3281))
