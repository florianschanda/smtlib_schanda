...
(assert (=> (<= 384 (to_fixed (rec__students3__student_record__gpa (us_split_fields3 student)))) (= (to_fixed2 o2) (+ (to_fixed2 grants1) 25000))))
(assert (=> (<= 384 (to_fixed (rec__students3__student_record__gpa (us_split_fields3 student)))) (= grants1 result2)))
(assert (=> (<= 384 (to_fixed (rec__students3__student_record__gpa (us_split_fields3 student)))) (= grants2 o2)))
(assert (=> (<= 384 (to_fixed (rec__students3__student_record__gpa (us_split_fields3 student)))) (=> (and (<= 480 (to_fixed (rec__students3__student_record__gpa (us_split_fields3 student)))) (= (to_rep (rec__students3__student_record__gender (us_split_fields3 student))) 1)) (= (to_fixed2 o3) (+ (to_fixed2 grants2) 25000)))))
(assert (=> (<= 384 (to_fixed (rec__students3__student_record__gpa (us_split_fields3 student)))) (=> (and (<= 480 (to_fixed (rec__students3__student_record__gpa (us_split_fields3 student)))) (= (to_rep (rec__students3__student_record__gender (us_split_fields3 student))) 1)) (= result3 grants2))))
(assert (=> (<= 384 (to_fixed (rec__students3__student_record__gpa (us_split_fields3 student)))) (=> (and (<= 480 (to_fixed (rec__students3__student_record__gpa (us_split_fields3 student)))) (= (to_rep (rec__students3__student_record__gender (us_split_fields3 student))) 1)) (= grants3 o3))))
