...
(declare-const temp___681 us_rep3)
...
(assert (let ((temp___693 (keys (mk___rep r__split_discrs r__split_fields2)))) (forall ((temp___692 Int)) (=> (and (in_range3 temp___692) (= (iter_has_element temp___693 temp___692) true)) (exists ((i1 Int)) (and (and (<= 1 i1) (<= i1 (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (= (get2 (model__ (mk___rep r__split_discrs r__split_fields2)) (get temp___693 temp___692)) (f (get2 (model__ s) (get (keys s) i1))))))))))
...
(assert (= result2 true))
(assert (and (= temp___681 (keys (mk___rep r__split_discrs r__split_fields2))) (and (and (and (= (length3 temp___681) (length (mk___rep r__split_discrs r__split_fields2))) (forall ((temp___439 Int)) (=> (and (in_range3 temp___439) (= (iter_has_element temp___681 temp___439) true)) (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2)) (get temp___681 temp___439)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2)) key2) true)) (and (< 0 (find temp___681 key2)) (= (equivalent_keys (get temp___681 (find temp___681 key2)) key2) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep r__split_discrs r__split_fields2)))) (and (= (find temp___681 (get temp___681 i1)) i1) (= (k_is_find temp___681 (get temp___681 i1) i1) true)))))))
(assert (and (= o4 (iter_has_element temp___681 temp___680)) (= (= o4 true) (and (<= 1 temp___680) (<= temp___680 (last temp___681))))))
(assert (= (= o5 true) (in_range3 temp___680)))
(assert (= result3 (ite (= o5 true) o4 false)))
(assert (= result3 true))
(assert (not (<= 1 temp___680)))
(check-sat)
(exit)
