...
(assert (= result2 true))
(assert (and (= temp___638 (keys (mk___rep r__split_discrs r__split_fields2))) (and (and (and (= (length3 temp___638) (length (mk___rep r__split_discrs r__split_fields2))) (forall ((temp___396 Int)) (=> (and (in_range3 temp___396) (= (iter_has_element temp___638 temp___396) true)) (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2)) (get temp___638 temp___396)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2)) key2) true)) (and (< 0 (find temp___638 key2)) (= (equivalent_keys (get temp___638 (find temp___638 key2)) key2) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep r__split_discrs r__split_fields2)))) (and (= (find temp___638 (get temp___638 i1)) i1) (= (k_is_find temp___638 (get temp___638 i1) i1) true)))))))
(assert (and (= o4 (iter_has_element temp___638 temp___637)) (= (= o4 true) (and (<= 1 temp___637) (<= temp___637 (last temp___638))))))
(assert (= (= o5 true) (in_range3 temp___637)))
(assert (= result3 (ite (= o5 true) o4 false)))
(assert (= result3 true))
(assert (not (<= 1 temp___637)))
(check-sat)
(exit)
