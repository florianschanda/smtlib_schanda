...
(define-fun o15 () us_rep1 (mk___rep1 (mk___split_fields1 o3)))
...
(assert (=> (= result2 true) (and (= o15 (next (mk___rep s__split_discrs s__split_fields3) (mk___rep1 cu__split_fields2))) (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields2) no_element) false) (= (get1 (positions (mk___rep s__split_discrs s__split_fields3)) (mk___rep1 cu__split_fields2)) (length (mk___rep s__split_discrs s__split_fields3))) true) true) (= (bool_eq1 o15 no_element) true) (and (= (has_key (positions (mk___rep s__split_discrs s__split_fields3)) o15) true) (= (get1 (positions (mk___rep s__split_discrs s__split_fields3)) o15) (+ (get1 (positions (mk___rep s__split_discrs s__split_fields3)) (mk___rep1 cu__split_fields2)) 1)))))))
(assert (=> (= result2 true) (and (= temp___7891 (next (mk___rep s__split_discrs s__split_fields3) o15)) (ite (= (ite (= (bool_eq1 o15 no_element) false) (= (get1 (positions (mk___rep s__split_discrs s__split_fields3)) o15) (length (mk___rep s__split_discrs s__split_fields3))) true) true) (= (bool_eq1 temp___7891 no_element) true) (and (= (has_key (positions (mk___rep s__split_discrs s__split_fields3)) temp___7891) true) (= (get1 (positions (mk___rep s__split_discrs s__split_fields3)) temp___7891) (+ (get1 (positions (mk___rep s__split_discrs s__split_fields3)) o15) 1)))))))
...
(assert (and (= o10 (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) i)) (in_range5 o10)))
(assert (= o11 (+ o10 1)))
(assert (and (= o12 o11) (in_range3 o11)))
(assert (and (= o8 (* 2 i)) (in_range1 (* 2 i))))
(assert (and (= o9 o8) (in_range4 o8)))
(assert (and (= o7 (elements (mk___rep s__split_discrs (us_split_fields__content s__split_fields8)))) (and (and (and (= (length2 o7) (length (mk___rep s__split_discrs (us_split_fields__content s__split_fields8)))) (forall ((temp___390 Int)) (=> (and (in_range4 temp___390) (= (iter_has_element o7 temp___390) true)) (= (contains (model__ (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))) (get o7 temp___390)) true)))) (forall ((item Int)) (=> (and (in_range7 item) (= (contains (model__ (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))) item) true)) (and (< 0 (find o7 item)) (= (equivalent_elements (get o7 (find o7 item)) item) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))))) (and (= (find o7 (get o7 i1)) i1) (= (e_is_find o7 (get o7 i1) i1) true)))))))
(assert (and (= o13 (get o7 o9)) (in_range5 o13)))
