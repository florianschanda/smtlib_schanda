...
(assert (= c11b c16b))
(assert (in_range1 c16b))
(assert (= c12b c17b))
(assert (in_range1 c17b))
(assert (=> (<= (- 6000) 6000) (in_range2 result__1)))
(assert (and (= o (div1 (- c17b c16b) 10)) (in_range2 (div1 (- c17b c16b) 10))))
(assert (= (mk_int__ref result1) (mk_int__ref result__1)))
(assert (= result__2 o))
(assert (=> (< 1000 result__2) (= result__2 result2)))
(assert (=> (< 1000 result__2) (= result__3 1000)))
(assert (=> (not (< 1000 result__2)) (=> (< result__2 (- 1000)) (= result__2 result3))))
(assert (=> (not (< 1000 result__2)) (=> (< result__2 (- 1000)) (= result__4 (- 1000)))))
(assert (=> (not (< 1000 result__2)) (=> (not (< result__2 (- 1000))) (= result__4 result__2))))
(assert (=> (not (< 1000 result__2)) (= result__3 result__4)))
(assert (and (= o1 result__3) (in_range8 result__3)))
(assert (= (mk_int__ref result4) (mk_int__ref target_climb_rate)))
(assert (= target_climb_rate1 o1))
(assert (not (< 1000 c13b)))
(assert (not (< c13b (- 1000))))
(assert (not (in_range8 c13b)))
(check-sat)
(exit)
