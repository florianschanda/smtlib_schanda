...
(assert (and (and (and (<= 0 (to_fixed2 tuition2)) (<= (to_fixed2 tuition2) 3000000)) (and (<= 0 (to_fixed2 insurance2)) (<= (to_fixed2 insurance2) 100000))) (and (<= 10000 (to_fixed2 fees4)) (<= (to_fixed2 fees4) 750000))))
(assert (<= 384 (to_fixed (rec__students3__student_record__gpa (us_split_fields3 student)))))
(assert (= (to_fixed2 o13) (+ (to_fixed2 grants1) 25000)))
(assert (= grants1 result14))
(assert (= grants2 o13))
(assert (<= 480 (to_fixed (rec__students3__student_record__gpa (us_split_fields3 student)))))
(assert (= (to_rep (rec__students3__student_record__gender (us_split_fields3 student))) 1))
(assert (not (in_range5 (+ (to_fixed2 grants2) 25000))))
(check-sat)
(exit)
