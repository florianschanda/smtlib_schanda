...
(assert (forall ((i taS)) (and (<= 1 (taSqtint i)) (<= (taSqtint i) 2147483647))))
...
(define-fun dynamic_invariant1 ((temp___expr_239 Int) (temp___is_init_235 Bool) (temp___skip_constant_236 Bool) (temp___do_toplevel_237 Bool) (temp___do_typ_inv_238 Bool)) Bool (=> (or (= temp___is_init_235 true) (<= 1 2147483647)) (in_range2 temp___expr_239)))
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(declare-sort tbS 0)
(declare-fun tbSqtint (tbS) Int)
(assert (forall ((i tbS)) (and (<= 1 (tbSqtint i)) (<= (tbSqtint i) 2147483647))))
...
(define-fun dynamic_invariant2 ((temp___expr_246 Int) (temp___is_init_242 Bool) (temp___skip_constant_243 Bool) (temp___do_toplevel_244 Bool) (temp___do_typ_inv_245 Bool)) Bool (=> (or (= temp___is_init_242 true) (<= 1 2147483647)) (in_range3 temp___expr_246)))
(declare-const attr__ATTRIBUTE_ADDRESS3 Int)
(declare-sort trS 0)
(declare-fun trSqtint (trS) Int)
(assert (forall ((i trS)) (and (<= 0 (trSqtint i)) (<= (trSqtint i) 2147483647))))
...
(define-fun dynamic_invariant3 ((temp___expr_253 Int) (temp___is_init_249 Bool) (temp___skip_constant_250 Bool) (temp___do_toplevel_251 Bool) (temp___do_typ_inv_252 Bool)) Bool (=> (or (= temp___is_init_249 true) (<= 0 2147483647)) (in_range4 temp___expr_253)))
...
(assert (= b1 o1))
(assert (= temp___284 r))
(assert (= temp___283 b1))
(assert (= temp___282 a1))
(assert (and (< 0 a2) (< 0 b2)))
(assert (not (and (= a2 1) (= b2 1))))
(assert (= (= (are_coprime a2 b2) true) (= (are_coprime left right) true)))
(assert (and (and (=> (<= 1 2147483647) (in_range2 a2)) (=> (<= 1 2147483647) (in_range3 b2))) (=> (<= 0 2147483647) (in_range4 r1))))
