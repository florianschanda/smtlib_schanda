...
(declare-const test_prime_and_coprime_numbers__p__initialize_coprime_list__euclid__result4 Int)
(declare-const test_prime_and_coprime_numbers__p__initialize_coprime_list__euclid__result5 Int)
...
(declare-const b9 int__ref)
(declare-const r6 int__ref)
(declare-const a10 Int)
(declare-const b10 Int)
(declare-const r7 Int)
(declare-const result7 int__ref)
(declare-const test_prime_and_coprime_numbers__p__initialize_coprime_list__euclid__result6 Int)
(declare-const test_prime_and_coprime_numbers__p__initialize_coprime_list__euclid__result7 int__ref)
(declare-const test_prime_and_coprime_numbers__p__initialize_coprime_list__euclid__result8 Int)
(declare-const a11 int__ref)
(declare-const b11 int__ref)
(declare-const r8 int__ref)
(declare-const test_prime_and_coprime_numbers__p__initialize_coprime_list__euclid__result9 int__ref)
(declare-const a12 Int)
(declare-const b12 Int)
(declare-const r9 Int)
(declare-const test_prime_and_coprime_numbers__p__initialize_coprime_list__euclid__result10 Int)
(declare-const a13 int__ref)
(declare-const b13 int__ref)
(declare-const r10 int__ref)
(declare-const test_prime_and_coprime_numbers__p__initialize_coprime_list__euclid__result11 int__ref)
(declare-const a14 Int)
(declare-const b14 Int)
(declare-const r11 Int)
(declare-const test_prime_and_coprime_numbers__p__initialize_coprime_list__euclid__result12 Int)
...
(assert (= (mk_int__ref result2) (mk_int__ref a)))
(assert (= a2 o))
(assert (and (= o1 right) (in_range3 right)))
(assert (= (mk_int__ref result3) (mk_int__ref b)))
(assert (= b2 o1))
(assert (= temp___249 a2))
(assert (= temp___248 r))
(assert (= temp___247 b2))
(assert (and (< 0 a3) (< 0 b3)))
(assert (not (and (= a3 1) (= b3 1))))
(assert (= (= (are_coprime a3 b3) true) (= (are_coprime left right) true)))
(assert (and (and (=> (<= 1 2147483647) (in_range3 b3)) (=> (<= 0 2147483647) (in_range4 r2))) (=> (<= 1 2147483647) (in_range2 a3))))
(assert (and (= o2 (mod2 a3 b3)) (in_range4 (mod2 a3 b3))))
(assert (= r2 result4))
(assert (= r3 o2))
(assert (= b3 b5))
(assert (= a3 a5))
...
(assert (= r3 0))
(assert (= r3 r4))
(assert (= (mk_int__ref b7) (mk_int__ref b5)))
(assert (= (mk_int__ref a7) (mk_int__ref a5)))
(assert (= r5 r3))
(assert (= b8 b6))
(assert (= a8 a6))
(assert (= r6 (mk_int__ref r4)))
(assert (= b9 (mk_int__ref b7)))
(assert (= (mk_int__ref a9) (mk_int__ref a7)))
(assert (= r7 r5))
(assert (= b10 b8))
(assert (= a10 a8))
(assert (not (not (and (= a9 1) (< 0 (int__content b9))))))
(check-sat)
(exit)
