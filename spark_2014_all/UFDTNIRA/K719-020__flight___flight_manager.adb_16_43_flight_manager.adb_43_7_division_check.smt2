...
(assert (< c7b 10))
(assert (and (= o19 (* (to_rep (rec__flight_manager__engine_values__y_speed result____split_fields7)) c7b)) (in_range1 (* (to_rep (rec__flight_manager__engine_values__y_speed result____split_fields7)) c7b))))
(assert (not (not (= 10 0))))
(check-sat)
(exit)
