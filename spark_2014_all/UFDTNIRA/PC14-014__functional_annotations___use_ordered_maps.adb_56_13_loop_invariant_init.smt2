...
(assert (= result1 true))
(define-fun temp___690 () us_rep3 (keys (mk___rep r__split_discrs r__split_fields1)))
(declare-const temp___689 Int)
(assert (in_range3 temp___689))
(assert (= (iter_has_element temp___690 temp___689) true))
(assert (not (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields2)) 1))) (= (get temp___690 temp___689) (get (keys s) i))))))
(check-sat)
(exit)
