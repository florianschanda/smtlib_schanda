...
(declare-const temp___840 us_rep2)
...
(assert (=> (= result2 true) (and (= temp___8311 (next (mk___rep s__split_discrs s__split_fields3) o12)) (ite (= (ite (= (bool_eq1 o12 no_element) false) (= (get1 (positions (mk___rep s__split_discrs s__split_fields3)) o12) (length (mk___rep s__split_discrs s__split_fields3))) true) true) (= (bool_eq1 temp___8311 no_element) true) (and (= (has_key (positions (mk___rep s__split_discrs s__split_fields3)) temp___8311) true) (= (get1 (positions (mk___rep s__split_discrs s__split_fields3)) temp___8311) (+ (get1 (positions (mk___rep s__split_discrs s__split_fields3)) o12) 1)))))))
