...
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get2 (positions (mk___rep s__split_discrs s__split_fields2)) (mk___rep1 cu__split_fields3)) 1))) (= (get (model__ (mk___rep s__split_discrs s__split_fields2)) (get1 (keys (mk___rep s__split_discrs s__split_fields2)) i)) (f (get (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (get1 (keys (mk___rep s__split_discrs s__split_fields2)) i)))))))
(assert (forall ((i Int)) (=> (and (<= (get2 (positions (mk___rep s__split_discrs s__split_fields2)) (mk___rep1 cu__split_fields3)) i) (<= i (length (mk___rep s__split_discrs s__split_fields2)))) (= (get (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (get1 (keys (mk___rep s__split_discrs s__split_fields2)) i)) (get (model__ (mk___rep s__split_discrs s__split_fields2)) (get1 (keys (mk___rep s__split_discrs s__split_fields2)) i))))))
(assert (and (= o (element (mk___rep s__split_discrs s__split_fields2) (mk___rep1 cu__split_fields3))) (and (in_range8 o) (= o (get (model__ (mk___rep s__split_discrs s__split_fields2)) (key (mk___rep s__split_discrs s__split_fields2) (mk___rep1 cu__split_fields3)))))))
(assert (and (= o1 (f o)) (and (in_range9 o1) (= o1 (ite (and (<= (- 100) o) (<= o 100)) (* o 2) o)))))
(assert (not (= (has_key1 (positions (mk___rep s__split_discrs s__split_fields2)) (mk___rep1 cu__split_fields3)) true)))
(check-sat)
(exit)
