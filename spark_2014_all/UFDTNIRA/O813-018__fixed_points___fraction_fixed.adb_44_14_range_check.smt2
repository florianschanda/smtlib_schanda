...
(declare-fun to_fixed2 (tt2B) Int)
(declare-fun of_fixed2 (Int) tt2B)
...
(assert (forall ((x Int)) (! (ite (= x 0) (= (to_int3 x) 0) (ite (< 0 x) (pos_div_relation (to_int3 x) (* x 1) 25) (pos_div_relation (- (to_int3 x)) (* (- x) 1) 25))) :pattern ((to_int3 x)))))
(declare-fun of_int2 (Int) Int)
(assert (forall ((x Int)) (! (ite (= x 0) (= (of_int2 x) 0) (ite (< 0 x) (pos_div_relation (of_int2 x) (* x 25) 1) (pos_div_relation (- (of_int2 x)) (* (- x) 25) 1))) :pattern ((of_int2 x)))))
(assert (forall ((x tt2B)) (! (= (of_fixed2 (to_fixed2 x)) x) :pattern ((to_fixed2 x)))))
(assert (forall ((x tt2B)) (in_range4 (to_fixed2 x))))
...
(declare-sort t2 0)
(define-fun in_range5 ((x Int)) Bool (and (<= (- 250) x) (<= x 250)))
(declare-const dummy4 t2)
(declare-fun attr__ATTRIBUTE_IMAGE5 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check5 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE5 (us_image) Int)
(declare-fun to_fixed3 (t2) Int)
(declare-fun of_fixed3 (Int) t2)
...
(assert (forall ((x Int)) (! (ite (= x 0) (= (to_int4 x) 0) (ite (< 0 x) (pos_div_relation (to_int4 x) (* x 1) 25) (pos_div_relation (- (to_int4 x)) (* (- x) 1) 25))) :pattern ((to_int4 x)))))
(declare-fun of_int3 (Int) Int)
(assert (forall ((x Int)) (! (ite (= x 0) (= (of_int3 x) 0) (ite (< 0 x) (pos_div_relation (of_int3 x) (* x 25) 1) (pos_div_relation (- (of_int3 x)) (* (- x) 25) 1))) :pattern ((of_int3 x)))))
(assert (forall ((x t2)) (! (= (of_fixed3 (to_fixed3 x)) x) :pattern ((to_fixed3 x)))))
(assert (forall ((x t2)) (in_range5 (to_fixed3 x))))
...
(assert (forall ((x1 Int)) (forall ((y1 Int)) (! (ite (or (= x1 0) (= y1 0)) (= (fxp_mult x1 y1) 0) (ite (or (and (< 0 x1) (< 0 y1)) (and (< x1 0) (< y1 0))) (pos_div_relation (fxp_mult x1 y1) (* (* (* (* x1 y1) 2) 2) 25) (* (* 5 5) 1)) (pos_div_relation (- (fxp_mult x1 y1)) (- (* (* (* (* x1 y1) 2) 2) 25)) (* (* 5 5) 1)))) :pattern ((fxp_mult x1 y1))))))
(declare-fun fxp_div (Int Int) Int)
(assert (forall ((x1 Int)) (forall ((y1 Int)) (! (ite (= x1 0) (= (fxp_div x1 y1) 0) (ite (and (< 0 x1) (< 0 y1)) (pos_div_relation (fxp_div x1 y1) (* (* (* x1 2) 5) 25) (* (* (* y1 5) 2) 1)) (ite (and (< x1 0) (< y1 0)) (pos_div_relation (fxp_div x1 y1) (* (* (* (- x1) 2) 5) 25) (* (* (* (- y1) 5) 2) 1)) (ite (and (< x1 0) (< 0 y1)) (pos_div_relation (- (fxp_div x1 y1)) (* (* (* (- x1) 2) 5) 25) (* (* (* y1 5) 2) 1)) (=> (and (< 0 x1) (< y1 0)) (pos_div_relation (- (fxp_div x1 y1)) (* (* (* x1 2) 5) 25) (* (* (* (- y1) 5) 2) 1))))))) :pattern ((fxp_div x1 y1))))))
(assert (= y (of_fixed1 5)))
...
(assert (not (in_range3 (* (to_fixed1 x) 2))))
(check-sat)
(exit)
