...
(assert (and (= o2 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2)))) (= (length1 o2) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields2))))))
(assert (not (<= 1 o4)))
(check-sat)
(exit)
