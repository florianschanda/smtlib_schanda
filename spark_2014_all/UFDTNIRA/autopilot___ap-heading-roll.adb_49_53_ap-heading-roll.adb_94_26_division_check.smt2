...
(assert (= offset1 o))
(assert (=> (and (< 40 offset1) (<= offset1 180)) (= (mk_int__ref result2) (mk_int__ref result__1))))
(assert (=> (and (< 40 offset1) (<= offset1 180)) (= result__2 40)))
(assert (=> (not (and (< 40 offset1) (<= offset1 180))) (=> (and (< 180 offset1) (< offset1 320)) (= (mk_int__ref result3) (mk_int__ref result__1)))))
...
(assert (=> (not (and (< 40 offset1) (<= offset1 180))) (=> (not (and (< 180 offset1) (< offset1 320))) (=> (<= offset1 40) (= (mk_int__ref result4) (mk_int__ref result__1))))))
...
(assert (=> (not (and (< 40 offset1) (<= offset1 180))) (=> (not (and (< 180 offset1) (< offset1 320))) (=> (not (<= offset1 40)) (= (mk_int__ref result5) (mk_int__ref result__1))))))
