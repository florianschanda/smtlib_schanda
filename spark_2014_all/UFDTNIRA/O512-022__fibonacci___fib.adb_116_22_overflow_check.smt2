...
(assert (= k21 n2))
(assert (< 0 k21))
(assert (and (and (and (= (power a2 n2) (* p22 (power b22 k22))) (<= 0 (int__content k17))) (<= p22 (power a2 n2))) (<= b22 (power a2 n2))))
...
(assert (= result11 (mk_int__ref temp___194)))
(assert (= temp___1941 k22))
(assert (= (mod1 k22 2) 0))
(assert (= (* p22 (power (* b22 b22) (div1 k22 2))) (power a2 n2)))
(assert (= result12 (mk_int__ref k22)))
(assert (= k23 (div1 k22 2)))
(assert (not (in_range1 (* b22 b22))))
(check-sat)
(exit)
