...
(assert (< c4b 10))
(assert (and (= o13 (* (to_rep (rec__flight_manager__engine_values__x_speed result____split_fields5)) c4b)) (in_range1 (* (to_rep (rec__flight_manager__engine_values__x_speed result____split_fields5)) c4b))))
(assert (not (not (= 10 0))))
(check-sat)
(exit)
