...
(declare-fun id (duration) duration)
(declare-fun id__function_guard (duration duration) Bool)
(assert true)
(assert (forall ((ts duration)) (! (= (to_fixed (id ts)) (to_fixed ts)) :pattern ((id ts)))))
...
(assert (= o3 (fxp_div_int o2 right)))
