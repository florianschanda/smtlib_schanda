...
(assert (= result2 true))
(assert (and (= o10 (keys s)) (and (and (and (= (length3 o10) (length s)) (forall ((temp___396 Int)) (=> (and (in_range3 temp___396) (= (iter_has_element o10 temp___396) true)) (= (has_key (model__ s) (get o10 temp___396)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true)) (and (< 0 (find o10 key2)) (= (equivalent_keys (get o10 (find o10 key2)) key2) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (and (= (find o10 (get o10 i1)) i1) (= (k_is_find o10 (get o10 i1) i1) true)))))))
(assert (and (= o11 (get o10 i)) (in_range4 o11)))
(assert (= o9 (model__ (mk___rep r__split_discrs r__split_fields2))))
(assert (and (= result3 (has_key o9 o11)) (=> (= (of_int 1) true) (=> (exists ((k Int)) (and (and (in_range2 k) (= (has_key o9 k) true)) (= (equivalent_keys k o11) true))) (= result3 true)))))
(assert (= result3 true))
(assert (and (= o5 (keys s)) (and (and (and (= (length3 o5) (length s)) (forall ((temp___396 Int)) (=> (and (in_range3 temp___396) (= (iter_has_element o5 temp___396) true)) (= (has_key (model__ s) (get o5 temp___396)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true)) (and (< 0 (find o5 key2)) (= (equivalent_keys (get o5 (find o5 key2)) key2) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (and (= (find o5 (get o5 i1)) i1) (= (k_is_find o5 (get o5 i1) i1) true)))))))
