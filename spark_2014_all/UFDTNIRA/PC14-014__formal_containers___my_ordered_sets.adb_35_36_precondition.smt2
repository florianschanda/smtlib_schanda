...
(assert (and (= o12 (ceiling (mk___rep l__split_discrs l__split_fields8) 3)) (ite (= (ite (= (= (length (mk___rep l__split_discrs l__split_fields8)) 0) false) (< (last_element (mk___rep l__split_discrs l__split_fields8)) 3) true) true) (= (bool_eq1 o12 no_element) true) (and (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields8)) o12) true) (not (< (get1 (elements (mk___rep l__split_discrs l__split_fields8)) (get (positions (mk___rep l__split_discrs l__split_fields8)) o12)) 3))) (= (e_is_find (elements (mk___rep l__split_discrs l__split_fields8)) 3 (get (positions (mk___rep l__split_discrs l__split_fields8)) o12)) true)))))
(assert (and (= o11 (positions (mk___rep l__split_discrs l__split_fields8))) (and (not (= (has_key o11 no_element) true)) (forall ((i us_rep1)) (=> (= (has_key o11 i) true) (and (and (<= 1 (get o11 i)) (<= (get o11 i) (length (mk___rep l__split_discrs l__split_fields8)))) (forall ((j us_rep1)) (=> (= (has_key o11 j) true) (=> (= (get o11 i) (get o11 j)) (= (bool_eq1 i j) true))))))))))
(assert (not (= (has_key o11 o12) true)))
(check-sat)
(exit)
