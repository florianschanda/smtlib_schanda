...
(assert (and (= o3 (ceiling (mk___rep l__split_discrs l__split_fields8) 3)) (ite (= (ite (= (= (length (mk___rep l__split_discrs l__split_fields8)) 0) false) (< (last_element (mk___rep l__split_discrs l__split_fields8)) 3) true) true) (= (bool_eq1 o3 no_element) true) (and (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields8)) o3) true) (not (< (get1 (elements (mk___rep l__split_discrs l__split_fields8)) (get (positions (mk___rep l__split_discrs l__split_fields8)) o3)) 3))) (= (e_is_find (elements (mk___rep l__split_discrs l__split_fields8)) 3 (get (positions (mk___rep l__split_discrs l__split_fields8)) o3)) true)))))
