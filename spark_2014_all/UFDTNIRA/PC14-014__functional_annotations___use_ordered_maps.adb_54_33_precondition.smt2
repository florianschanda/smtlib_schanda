...
(assert (let ((temp___733 (keys (mk___rep r__split_discrs r__split_fields2)))) (forall ((temp___732 Int)) (=> (and (in_range4 temp___732) (= (iter_has_element temp___733 temp___732) true)) (exists ((i1 Int)) (and (and (<= 1 i1) (<= i1 (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (= (get temp___733 temp___732) (get (keys s) i1))))))))
...
(assert (= result2 true))
(assert (and (= o6 (keys s)) (and (and (and (= (length2 o6) (length s)) (forall ((temp___439 Int)) (=> (and (in_range4 temp___439) (= (iter_has_element o6 temp___439) true)) (= (has_key (model__ s) (get o6 temp___439)) true)))) (forall ((key1 Int)) (=> (and (in_range2 key1) (= (has_key (model__ s) key1) true)) (and (< 0 (find o6 key1)) (= (equivalent_keys (get o6 (find o6 key1)) key1) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (and (= (find o6 (get o6 i1)) i1) (= (k_is_find o6 (get o6 i1) i1) true)))))))
(assert (and (= o7 (get o6 i)) (in_range3 o7)))
...
(assert (= result3 true))
(assert (and (= o4 (keys s)) (and (and (and (= (length2 o4) (length s)) (forall ((temp___439 Int)) (=> (and (in_range4 temp___439) (= (iter_has_element o4 temp___439) true)) (= (has_key (model__ s) (get o4 temp___439)) true)))) (forall ((key1 Int)) (=> (and (in_range2 key1) (= (has_key (model__ s) key1) true)) (and (< 0 (find o4 key1)) (= (equivalent_keys (get o4 (find o4 key1)) key1) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (and (= (find o4 (get o4 i1)) i1) (= (k_is_find o4 (get o4 i1) i1) true)))))))
(assert (not (<= i (last o4))))
(check-sat)
(exit)
