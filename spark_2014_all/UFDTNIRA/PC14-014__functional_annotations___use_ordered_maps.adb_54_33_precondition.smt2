...
(assert (let ((temp___690 (keys (mk___rep r__split_discrs r__split_fields2)))) (forall ((temp___689 Int)) (=> (and (in_range3 temp___689) (= (iter_has_element temp___690 temp___689) true)) (exists ((i1 Int)) (and (and (<= 1 i1) (<= i1 (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (= (get temp___690 temp___689) (get (keys s) i1))))))))
...
(assert (and (= o1 (get1 o (mk___rep1 cu__split_fields3))) (and (in_range5 o1) (=> (= (of_int 0) true) (and (= o1 (w_get o (witness o (mk___rep1 cu__split_fields3)))) (forall ((k us_rep1)) (=> (= (has_key1 o k) true) (= (= (bool_eq1 k (mk___rep1 cu__split_fields3)) true) (= (witness o (mk___rep1 cu__split_fields3)) (witness o k))))))))))
(assert (= o2 (- o1 1)))
(assert (= o3 (ite (<= i o2) true false)))
(assert (= result2 (ite (<= 1 i) o3 false)))
(assert (= result2 true))
(assert (and (= o6 (keys s)) (and (and (and (= (length3 o6) (length s)) (forall ((temp___396 Int)) (=> (and (in_range3 temp___396) (= (iter_has_element o6 temp___396) true)) (= (has_key (model__ s) (get o6 temp___396)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true)) (and (< 0 (find o6 key2)) (= (equivalent_keys (get o6 (find o6 key2)) key2) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (and (= (find o6 (get o6 i1)) i1) (= (k_is_find o6 (get o6 i1) i1) true)))))))
(assert (and (= o7 (get o6 i)) (in_range4 o7)))
(assert (= o5 (model__ (mk___rep r__split_discrs r__split_fields2))))
(assert (and (= result3 (has_key o5 o7)) (=> (= (of_int 1) true) (=> (exists ((k Int)) (and (and (in_range2 k) (= (has_key o5 k) true)) (= (equivalent_keys k o7) true))) (= result3 true)))))
(assert (= result3 true))
(assert (and (= o4 (keys s)) (and (and (and (= (length3 o4) (length s)) (forall ((temp___396 Int)) (=> (and (in_range3 temp___396) (= (iter_has_element o4 temp___396) true)) (= (has_key (model__ s) (get o4 temp___396)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true)) (and (< 0 (find o4 key2)) (= (equivalent_keys (get o4 (find o4 key2)) key2) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (and (= (find o4 (get o4 i1)) i1) (= (k_is_find o4 (get o4 i1) i1) true)))))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
