...
(assert (and (= o2 (positions s)) (and (not (= (has_key1 o2 no_element) true)) (forall ((i2 us_rep1)) (=> (= (has_key1 o2 i2) true) (and (and (<= 1 (get1 o2 i2)) (<= (get1 o2 i2) (length s))) (forall ((j us_rep1)) (=> (= (has_key1 o2 j) true) (=> (= (get1 o2 i2) (get1 o2 j)) (= (bool_eq1 i2 j) true))))))))))
(assert (and (= o3 (get1 o2 (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range5 o3) (=> (= (of_int 0) true) (and (= o3 (w_get o2 (witness o2 (mk___rep1 (mk___split_fields1 cu__split_fields2))))) (forall ((k3 us_rep1)) (=> (= (has_key1 o2 k3) true) (= (= (bool_eq1 k3 (mk___rep1 (mk___split_fields1 cu__split_fields2))) true) (= (witness o2 (mk___rep1 (mk___split_fields1 cu__split_fields2))) (witness o2 k3))))))))))
(assert (= o4 (- o3 1)))
(assert (= o5 (ite (<= i o4) true false)))
(assert (= result2 (ite (<= 1 i) o5 false)))
(assert (= result2 true))
(assert (and (= o14 (keys s)) (and (and (and (= (length3 o14) (length s)) (forall ((temp___396 Int)) (=> (and (in_range3 temp___396) (= (iter_has_element o14 temp___396) true)) (= (has_key (model__ s) (get o14 temp___396)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true)) (and (< 0 (find o14 key2)) (= (equivalent_keys (get o14 (find o14 key2)) key2) true))))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length s))) (and (= (find o14 (get o14 i2)) i2) (= (k_is_find o14 (get o14 i2) i2) true)))))))
(assert (and (= o15 (get o14 i)) (in_range4 o15)))
(assert (= o13 (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields1)))))
(assert (and (= result3 (has_key o13 o15)) (=> (= (of_int 1) true) (=> (exists ((k3 Int)) (and (and (in_range2 k3) (= (has_key o13 k3) true)) (= (equivalent_keys k3 o15) true))) (= result3 true)))))
(assert (= result3 true))
(assert (and (= o8 (keys s)) (and (and (and (= (length3 o8) (length s)) (forall ((temp___396 Int)) (=> (and (in_range3 temp___396) (= (iter_has_element o8 temp___396) true)) (= (has_key (model__ s) (get o8 temp___396)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true)) (and (< 0 (find o8 key2)) (= (equivalent_keys (get o8 (find o8 key2)) key2) true))))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length s))) (and (= (find o8 (get o8 i2)) i2) (= (k_is_find o8 (get o8 i2) i2) true)))))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
