...
(declare-const use_ordered_maps__apply_f_2__cu__assume count_type)
(declare-const i Int)
...
(define-fun r__split_fields2 () us_split_fields (mk___split_fields r__split_fields1))
(define-fun r__split_fields3 () us_split_fields (mk___split_fields r__split_fields))
(define-fun cu__split_fields4 () us_split_fields2 (mk___split_fields1 cu__split_fields1))
(define-fun use_ordered_maps__apply_f_2__cu__assume1 () us_rep1 (mk___rep1 (mk___split_fields1 use_ordered_maps__apply_f_2__cu__assume)))
(assert (<= (length s) (to_rep (rec__use_ordered_maps__my_maps__map__capacity r__split_discrs))))
(assert (and (= use_ordered_maps__apply_f_2__cu__assume1 (first s)) (ite (= (= (length s) 0) true) (= (bool_eq1 use_ordered_maps__apply_f_2__cu__assume1 no_element) true) (and (= (has_key1 (positions s) use_ordered_maps__apply_f_2__cu__assume1) true) (= (get1 (positions s) use_ordered_maps__apply_f_2__cu__assume1) 1)))))
(assert (= (mk___split_fields__ref1 (mk___split_fields1 result)) (mk___split_fields__ref1 (mk___split_fields1 cu__split_fields))))
(assert (= use_ordered_maps__apply_f_2__cu__assume cu__split_fields1))
(assert (and (= (length (mk___rep r__split_discrs r__split_fields3)) 0) (= (is_empty (model__ (mk___rep r__split_discrs r__split_fields3))) true)))
(assert (and (= result1 (has_key1 (positions s) (mk___rep1 cu__split_fields4))) (= (= result1 true) (= (has_key1 (positions s) (mk___rep1 cu__split_fields4)) true))))
(assert (= result1 true))
(assert (= (length (mk___rep r__split_discrs r__split_fields2)) (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1)))
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (and (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2)) (get (keys s) i1)) true) (= (get2 (model__ (mk___rep r__split_discrs r__split_fields2)) (get (keys s) i1)) (f (get2 (model__ s) (get (keys s) i1))))))))
(assert (let ((temp___733 (keys (mk___rep r__split_discrs r__split_fields2)))) (forall ((temp___732 Int)) (=> (and (in_range3 temp___732) (= (iter_has_element temp___733 temp___732) true)) (exists ((i1 Int)) (and (and (<= 1 i1) (<= i1 (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (= (get temp___733 temp___732) (get (keys s) i1))))))))
(assert (and (= o (positions s)) (and (not (= (has_key1 o no_element) true)) (forall ((i1 us_rep1)) (=> (= (has_key1 o i1) true) (and (and (<= 1 (get1 o i1)) (<= (get1 o i1) (length s))) (forall ((j us_rep1)) (=> (= (has_key1 o j) true) (=> (= (get1 o i1) (get1 o j)) (= (bool_eq1 i1 j) true))))))))))
(assert (and (= o1 (get1 o (mk___rep1 cu__split_fields3))) (and (in_range5 o1) (=> (= (distinct 0 0) true) (and (= o1 (w_get o (witness o (mk___rep1 cu__split_fields3)))) (forall ((k us_rep1)) (=> (= (has_key1 o k) true) (= (= (bool_eq1 k (mk___rep1 cu__split_fields3)) true) (= (witness o (mk___rep1 cu__split_fields3)) (witness o k))))))))))
(assert (= o2 (- o1 1)))
(assert (= o3 (ite (<= i o2) true false)))
(assert (= result2 (ite (<= 1 i) o3 false)))
(assert (= result2 true))
(assert (and (= o6 (keys s)) (and (and (and (= (length3 o6) (length s)) (forall ((temp___439 Int)) (=> (and (in_range3 temp___439) (= (iter_has_element o6 temp___439) true)) (= (has_key (model__ s) (get o6 temp___439)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true)) (and (< 0 (find o6 key2)) (= (equivalent_keys (get o6 (find o6 key2)) key2) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (and (= (find o6 (get o6 i1)) i1) (= (k_is_find o6 (get o6 i1) i1) true)))))))
(assert (and (= o7 (get o6 i)) (in_range4 o7)))
(assert (= o5 (model__ (mk___rep r__split_discrs r__split_fields2))))
(assert (and (= result3 (has_key o5 o7)) (=> (= (distinct 1 0) true) (=> (exists ((k Int)) (and (and (in_range2 k) (= (has_key o5 k) true)) (= (equivalent_keys k o7) true))) (= result3 true)))))
(assert (= result3 true))
(assert (and (= o4 (keys s)) (and (and (and (= (length3 o4) (length s)) (forall ((temp___439 Int)) (=> (and (in_range3 temp___439) (= (iter_has_element o4 temp___439) true)) (= (has_key (model__ s) (get o4 temp___439)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true)) (and (< 0 (find o4 key2)) (= (equivalent_keys (get o4 (find o4 key2)) key2) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (and (= (find o4 (get o4 i1)) i1) (= (k_is_find o4 (get o4 i1) i1) true)))))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
