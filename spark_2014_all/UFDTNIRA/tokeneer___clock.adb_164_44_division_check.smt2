...
(define-fun dynamic_invariant ((temp___expr_325 Int) (temp___is_init_322 Bool) (temp___skip_constant_323 Bool) (temp___do_toplevel_324 Bool)) Bool (=> (or (= temp___is_init_322 true) (<= 1901 2099)) (in_range temp___expr_325)))
...
(define-fun dynamic_invariant1 ((temp___expr_331 Int) (temp___is_init_328 Bool) (temp___skip_constant_329 Bool) (temp___do_toplevel_330 Bool)) Bool (=> (or (= temp___is_init_328 true) (<= 1 12)) (in_range1 temp___expr_331)))
...
(define-fun dynamic_invariant2 ((temp___expr_337 Int) (temp___is_init_334 Bool) (temp___skip_constant_335 Bool) (temp___do_toplevel_336 Bool)) Bool (=> (or (= temp___is_init_334 true) (<= 1 31)) (in_range2 temp___expr_337)))
...
(define-fun dynamic_invariant3 ((temp___expr_343 Int) (temp___is_init_340 Bool) (temp___skip_constant_341 Bool) (temp___do_toplevel_342 Bool)) Bool (=> (or (= temp___is_init_340 true) (<= 0 23)) (in_range3 temp___expr_343)))
...
(define-fun dynamic_invariant4 ((temp___expr_349 Int) (temp___is_init_346 Bool) (temp___skip_constant_347 Bool) (temp___do_toplevel_348 Bool)) Bool (=> (or (= temp___is_init_346 true) (<= 0 59)) (in_range4 temp___expr_349)))
...
(define-fun dynamic_invariant5 ((temp___expr_365 Int) (temp___is_init_362 Bool) (temp___skip_constant_363 Bool) (temp___do_toplevel_364 Bool)) Bool (=> (or (= temp___is_init_362 true) (<= 0 86399999)) (in_range5 temp___expr_365)))
