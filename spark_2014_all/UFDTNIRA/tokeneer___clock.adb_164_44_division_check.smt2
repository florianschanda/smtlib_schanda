...
(define-fun dynamic_invariant ((temp___expr_285 Int) (temp___is_init_282 Bool) (temp___skip_constant_283 Bool) (temp___do_toplevel_284 Bool)) Bool (=> (or (= temp___is_init_282 true) (<= 1901 2099)) (in_range temp___expr_285)))
...
(define-fun dynamic_invariant1 ((temp___expr_291 Int) (temp___is_init_288 Bool) (temp___skip_constant_289 Bool) (temp___do_toplevel_290 Bool)) Bool (=> (or (= temp___is_init_288 true) (<= 1 12)) (in_range1 temp___expr_291)))
...
(define-fun dynamic_invariant2 ((temp___expr_297 Int) (temp___is_init_294 Bool) (temp___skip_constant_295 Bool) (temp___do_toplevel_296 Bool)) Bool (=> (or (= temp___is_init_294 true) (<= 1 31)) (in_range2 temp___expr_297)))
...
(define-fun dynamic_invariant3 ((temp___expr_303 Int) (temp___is_init_300 Bool) (temp___skip_constant_301 Bool) (temp___do_toplevel_302 Bool)) Bool (=> (or (= temp___is_init_300 true) (<= 0 23)) (in_range3 temp___expr_303)))
...
(define-fun dynamic_invariant4 ((temp___expr_309 Int) (temp___is_init_306 Bool) (temp___skip_constant_307 Bool) (temp___do_toplevel_308 Bool)) Bool (=> (or (= temp___is_init_306 true) (<= 0 59)) (in_range4 temp___expr_309)))
...
(define-fun dynamic_invariant5 ((temp___expr_321 Int) (temp___is_init_318 Bool) (temp___skip_constant_319 Bool) (temp___do_toplevel_320 Bool)) Bool (=> (or (= temp___is_init_318 true) (<= 0 86399999)) (in_range5 temp___expr_321)))
