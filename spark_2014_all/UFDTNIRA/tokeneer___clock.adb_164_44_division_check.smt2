...
(define-fun in_range3 ((x Int)) Bool (and (<= 0 x) (<= x 23)))
(declare-fun attr__ATTRIBUTE_IMAGE3 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check3 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE3 (us_image) Int)
(declare-fun user_eq3 (hourst hourst) Bool)
(declare-const dummy3 hourst)
...
(define-fun dynamic_invariant3 ((temp___expr_389 Int) (temp___is_init_385 Bool) (temp___skip_constant_386 Bool) (temp___do_toplevel_387 Bool) (temp___do_typ_inv_388 Bool)) Bool (=> (or (= temp___is_init_385 true) (<= 0 23)) (in_range3 temp___expr_389)))
(declare-sort minutest 0)
(define-fun in_range4 ((x Int)) Bool (and (<= 0 x) (<= x 59)))
(declare-fun attr__ATTRIBUTE_IMAGE4 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check4 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE4 (us_image) Int)
(declare-fun user_eq4 (minutest minutest) Bool)
(declare-const dummy4 minutest)
...
(define-fun dynamic_invariant4 ((temp___expr_396 Int) (temp___is_init_392 Bool) (temp___skip_constant_393 Bool) (temp___do_toplevel_394 Bool) (temp___do_typ_inv_395 Bool)) Bool (=> (or (= temp___is_init_392 true) (<= 0 59)) (in_range4 temp___expr_396)))
...
(define-fun dynamic_invariant5 ((temp___expr_414 Int) (temp___is_init_410 Bool) (temp___skip_constant_411 Bool) (temp___do_toplevel_412 Bool) (temp___do_typ_inv_413 Bool)) Bool (=> (or (= temp___is_init_410 true) (<= 0 86399999)) (in_range5 temp___expr_414)))
...
(assert (=> (<= 0 23) (in_range3 hour)))
(assert (=> (<= 0 59) (in_range4 min)))
(assert (= result year))
...
(assert (and (= o (div1 (to_rep3 (rec__clock__timet__millisec (us_split_fields1 thetime))) 3600000)) (in_range3 (div1 (to_rep3 (rec__clock__timet__millisec (us_split_fields1 thetime))) 3600000))))
(assert (= result3 hour))
(assert (= hour1 o))
