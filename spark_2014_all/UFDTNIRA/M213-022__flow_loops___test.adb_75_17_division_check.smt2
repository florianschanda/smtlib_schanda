...
(assert (= y1 1))
(assert (not (= d1 1)))
(assert (and (and (and (and (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 y2)) (=> (<= (- 2147483648) 2147483647) (in_range1 c2))) (=> (<= (- 2147483648) 2147483647) (in_range1 d2))) (=> (<= (- 2147483648) 2147483647) (in_range1 q2))) (=> (<= (- 2147483648) 2147483647) (in_range1 w2))) (=> (<= (- 2147483648) 2147483647) (in_range1 x2))) (not (= d2 1))))
(assert (not (not (= d2 0))))
(check-sat)
(exit)
