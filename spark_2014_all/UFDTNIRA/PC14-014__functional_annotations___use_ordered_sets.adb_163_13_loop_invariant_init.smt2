...
(assert (not (= (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (+ i n1)) (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) i))))
(check-sat)
(exit)
