...
(assert (= result__1 x))
(assert (=> (< i1 n) (and (and (= temp___506 result__1) (and (= temp___505 i1) (and (and (= result__2 (power x i2)) (<= 1 i2)) (and (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 i2)) (=> (<= (- 2147483648) 2147483647) (in_range1 result__2))) (< i2 n)) (and (and (and (= o1 (* result__2 x)) (in_range1 (* result__2 x))) (and (= result__2 result2) (= result__3 o1))) (and (and (and (= o2 (+ i2 1)) (in_range1 (+ i2 1))) (and (= i2 result3) (= i3 o2))) (not (< i3 n)))))))) (and (and (= i3 i6) (= result__3 result__6)) (and (= i7 i3) (= result__7 result__3))))))
(assert (=> (< i1 n) (= (mk_int__ref i8) (mk_int__ref i6))))
(assert (=> (< i1 n) (= (mk_int__ref result__8) (mk_int__ref result__6))))
(assert (=> (< i1 n) (= i9 i7)))
(assert (=> (< i1 n) (= result__9 result__7)))
(assert (=> (not (< i1 n)) (= i1 i8)))
(assert (=> (not (< i1 n)) (= result__1 result__8)))
(assert (=> (not (< i1 n)) (= i9 i1)))
(assert (=> (not (< i1 n)) (= result__9 result__1)))
(assert (= i10 i8))
(assert (= (mk_int__ref result__10) (mk_int__ref result__8)))
(assert (= i11 i9))
(assert (= result__11 result__9))
(assert (not (= (power x n) result__10)))
(check-sat)
(exit)
