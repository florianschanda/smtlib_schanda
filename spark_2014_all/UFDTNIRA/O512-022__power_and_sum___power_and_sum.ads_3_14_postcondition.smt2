...
(assert (= result__1 x))
(assert (=> (< i1 n) (= temp___576 result__1)))
(assert (=> (< i1 n) (= temp___575 i1)))
(assert (=> (< i1 n) (and (= result__2 (power x i2)) (<= 1 i2))))
(assert (=> (< i1 n) (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 i2)) (=> (<= (- 2147483648) 2147483647) (in_range1 result__2))) (< i2 n))))
(assert (=> (< i1 n) (and (= o (* result__2 x)) (in_range1 (* result__2 x)))))
...
(assert (not (= (power x n) result__8)))
(check-sat)
(exit)
