...
(assert (and (= result1 (has_key (positions s) (mk___rep1 cu__split_fields5))) (= (= result1 true) (= (has_key (positions s) (mk___rep1 cu__split_fields5)) true))))
(assert (= result1 true))
(assert (<= (length (mk___rep r__split_discrs r__split_fields4)) (- (get1 (positions s) (mk___rep1 cu__split_fields4)) 1)))
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields4)) 1))) (= (contains (model__ (mk___rep r__split_discrs r__split_fields4)) (f (get (elements s) i))) true))))
(assert (forall ((g Int)) (=> (and (in_range2 g) (= (contains (model__ (mk___rep r__split_discrs r__split_fields4)) g) true)) (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields4)) 1))) (= g (f (get (elements s) i))))))))
(assert (and (= o (element s (mk___rep1 cu__split_fields4))) (and (in_range6 o) (= o (get (elements s) (get1 (positions s) (mk___rep1 cu__split_fields4)))))))
...
(assert (and (= temp___7241 (next s (mk___rep1 cu__split_fields4))) (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields4) no_element) false) (= (get1 (positions s) (mk___rep1 cu__split_fields4)) (length s)) true) true) (= (bool_eq1 temp___7241 no_element) true) (and (= (has_key (positions s) temp___7241) true) (= (get1 (positions s) temp___7241) (+ (get1 (positions s) (mk___rep1 cu__split_fields4)) 1))))))
(assert (= result2 cu__split_fields2))
(assert (= cu__split_fields3 (mk___split_fields1 temp___724)))
(assert (and (= o2 (has_key (positions s) (mk___rep1 cu__split_fields3))) (= (= o2 true) (= (has_key (positions s) (mk___rep1 cu__split_fields3)) true))))
(assert (= result3 (ite (not (= o2 true)) true false)))
(assert (not (= result3 true)))
(declare-const g Int)
(assert (in_range2 g))
(assert (= (contains (model__ (mk___rep r__split_discrs r__split_fields3)) g) true))
(assert (not (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (= g (f (get (elements s) i)))))))
(check-sat)
(exit)
