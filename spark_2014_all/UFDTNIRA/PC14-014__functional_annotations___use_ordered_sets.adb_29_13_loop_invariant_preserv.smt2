...
(assert (and (= o18 (has_key (positions s) (mk___rep1 cu__split_fields3))) (= (= o18 true) (= (has_key (positions s) (mk___rep1 cu__split_fields3)) true))))
(assert (= result6 (ite (not (= o18 true)) true false)))
(assert (not (= result6 true)))
(declare-const g2 Int)
(assert (in_range2 g2))
(assert (= (contains (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) g2) true))
(assert (not (exists ((i2 Int)) (and (and (<= 1 i2) (<= i2 (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (= g2 (f (get (elements s) i2)))))))
(check-sat)
(exit)
