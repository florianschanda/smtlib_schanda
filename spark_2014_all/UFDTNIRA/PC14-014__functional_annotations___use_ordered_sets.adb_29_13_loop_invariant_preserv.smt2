...
(assert (and (= temp___6821 (next s (mk___rep1 cu__split_fields4))) (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields4) no_element) false) (= (get1 (positions s) (mk___rep1 cu__split_fields4)) (length s)) true) true) (= (bool_eq1 temp___6821 no_element) true) (and (= (has_key (positions s) temp___6821) true) (= (get1 (positions s) temp___6821) (+ (get1 (positions s) (mk___rep1 cu__split_fields4)) 1))))))
