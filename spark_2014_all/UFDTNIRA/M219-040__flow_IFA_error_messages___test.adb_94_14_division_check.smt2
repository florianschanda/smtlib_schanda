...
(assert (=> (and (<= r11b i1) (<= i1 r12b)) (= (mk_int__ref b6) (mk_int__ref b4))))
(assert (=> (and (<= r11b i1) (<= i1 r12b)) (= (mk_int__ref a6) (mk_int__ref a4))))
...
(assert (=> (not (and (<= r11b i1) (<= i1 r12b))) (= (mk_int__ref b6) (mk_int__ref b))))
(assert (=> (not (and (<= r11b i1) (<= i1 r12b))) (= (mk_int__ref a6) (mk_int__ref a))))
