...
(assert (= result1 true))
(assert (not (= (oeq3 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields)))) true)))
(check-sat)
(exit)
