...
(define-fun dynamic_invariant1 ((temp___expr_149 Int) (temp___is_init_146 Bool) (temp___skip_constant_147 Bool) (temp___do_toplevel_148 Bool)) Bool (=> (or (= temp___is_init_146 true) (<= 0 200)) (in_range2 temp___expr_149)))
...
(define-fun dynamic_invariant2 ((temp___expr_158 Int) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool)) Bool (=> (or (= temp___is_init_155 true) (<= 0 3)) (in_range3 temp___expr_158)))
...
(assert (=> (or (= op 0) (= op 3)) (<= (- 1073741823) (to_rep v1__split_fields))))
(assert (=> (or (= op 0) (= op 3)) (<= (to_rep v1__split_fields) 1073741822)))
(assert (=> (or (= op 0) (= op 3)) (<= (- 1073741823) (to_rep v2__split_fields))))
(assert (=> (or (= op 0) (= op 3)) (<= (to_rep v2__split_fields) 1073741822)))
(assert (=> (not (or (= op 0) (= op 3))) (=> (= op 1) (not (= (to_rep v2__split_fields) 0)))))
(assert (not (= op 0)))
(assert (not (= op 1)))
(assert (not (= op 2)))
(assert (not (in_range1 (- (to_rep v1__split_fields) (to_rep v2__split_fields)))))
(check-sat)
(exit)
