...
(assert (not (<= (- (length (mk___rep l__split_discrs l__split_fields11)) (length (intersection__2 (mk___rep m__split_discrs1 m__split_fields8) (mk___rep l__split_discrs l__split_fields11)))) (- (to_rep (rec__my_ordered_sets__m__set__capacity m__split_discrs1)) (length (mk___rep m__split_discrs1 m__split_fields8))))))
(check-sat)
(exit)
