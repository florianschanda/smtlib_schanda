...
(assert (= (oeq (union__2 (mk___rep m__split_discrs1 m__split_fields6) (mk___rep l__split_discrs l__split_fields11)) (union__2 (mk___rep k__split_discrs k__split_fields3) (mk___rep l__split_discrs l__split_fields11))) true))
(assert (= (equivalent_sets (intersection__2 (mk___rep m__split_discrs1 m__split_fields6) (mk___rep l__split_discrs l__split_fields11)) (intersection__2 (mk___rep k__split_discrs k__split_fields3) (mk___rep l__split_discrs l__split_fields11))) true))
(assert (not (<= (- (length (mk___rep l__split_discrs l__split_fields11)) (length (intersection__2 (mk___rep m__split_discrs1 m__split_fields6) (mk___rep l__split_discrs l__split_fields11)))) (- (to_rep (rec__my_ordered_sets__m__set__capacity m__split_discrs1)) (length (mk___rep m__split_discrs1 m__split_fields6))))))
(check-sat)
(exit)
