...
(assert (= (= o3 true) (forall ((i9 Int)) (=> (and (<= first i9) (<= i9 (last5 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields)))))) (and (= (get (model__ (mk___rep v__split_discrs (us_split_fields__content v__split_fields8))) i9) (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) i9)) (= (get (model__ (mk___rep v__split_discrs (us_split_fields__content v__split_fields8))) (+ i9 (length (mk___rep v__split_discrs (mk___split_fields v__split_fields))))) (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) i9)))))))
