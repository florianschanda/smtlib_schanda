...
(assert (and (= o (capacity (mk___rep v__split_discrs (mk___split_fields v__split_fields)))) (and (dynamic_property2 0 last2 o) (= o (ite (= (of_int 0) true) (to_rep1 (rec__use_vectors__my_vectors__vector__capacity v__split_discrs)) last2)))))
(assert (not (not (= 2 0))))
(check-sat)
(exit)
