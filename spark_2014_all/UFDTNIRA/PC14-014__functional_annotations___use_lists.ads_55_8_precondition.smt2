...
(assert (and (= o6 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i1)) (in_range3 o6)))
(assert (and (= o5 (+ i1 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))) (in_range1 (+ i1 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))))))
...
(assert (and (= o3 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i1)) (in_range3 o3)))
