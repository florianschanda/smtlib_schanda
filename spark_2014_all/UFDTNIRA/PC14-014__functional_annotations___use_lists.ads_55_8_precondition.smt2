...
(assert (and (= o20 (get o17 o18)) (in_range3 o20)))
(assert (= o21 (ite (= o20 o19) true false)))
(assert (and (= o15 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i2)) (in_range3 o15)))
(assert (and (= o14 (model__ (mk___rep l__split_discrs (us_split_fields__content l__split_fields8)))) (= (length1 o14) (length (mk___rep l__split_discrs (us_split_fields__content l__split_fields8))))))
(assert (not (<= 1 i2)))
(check-sat)
(exit)
