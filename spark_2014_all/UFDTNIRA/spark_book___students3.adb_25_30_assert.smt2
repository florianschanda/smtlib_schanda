...
(assert (and (<= 0 (to_fixed tuition)) (<= (to_fixed tuition) 3000000)))
(assert (=> (not (= (rec__students3__student_record__self_insured (us_split_fields3 student)) true)) (= (to_fixed o2) 100000)))
