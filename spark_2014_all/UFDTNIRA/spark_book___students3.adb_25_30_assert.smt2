...
(assert (and (<= 0 (to_fixed2 tuition)) (<= (to_fixed2 tuition) 3000000)))
(assert (=> (not (= (rec__students3__student_record__self_insured (us_split_fields3 student)) true)) (= (to_fixed2 o2) 100000)))
(assert (=> (not (= (rec__students3__student_record__self_insured (us_split_fields3 student)) true)) (= result2 insurance1)))
(assert (=> (not (= (rec__students3__student_record__self_insured (us_split_fields3 student)) true)) (= insurance2 o2)))
(assert (=> (not (not (= (rec__students3__student_record__self_insured (us_split_fields3 student)) true))) (= insurance2 insurance1)))
