...
(assert (=> (not (= (rec__students3__student_record__self_insured (us_split_fields3 student)) true)) (= (to_fixed2 o3) 100000)))
(assert (=> (not (= (rec__students3__student_record__self_insured (us_split_fields3 student)) true)) (= result4 insurance1)))
(assert (=> (not (= (rec__students3__student_record__self_insured (us_split_fields3 student)) true)) (= insurance2 o3)))
(assert (=> (= (rec__students3__student_record__self_insured (us_split_fields3 student)) true) (= insurance2 insurance1)))
