...
(assert (= result x))
(assert (= x1 o))
(assert (and (and (in_range dynamic_preds_array__init_ok_even__x) (= (mod2 dynamic_preds_array__init_ok_even__x 2) 0)) (in_range1 dynamic_preds_array__init_ok_even__x)))
