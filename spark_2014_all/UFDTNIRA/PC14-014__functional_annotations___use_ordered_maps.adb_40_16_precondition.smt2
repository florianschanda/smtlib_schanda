...
(assert (let ((temp___693 (keys (mk___rep r__split_discrs r__split_fields4)))) (forall ((temp___692 Int)) (=> (and (in_range3 temp___692) (= (iter_has_element temp___693 temp___692) true)) (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (= (get2 (model__ (mk___rep r__split_discrs r__split_fields4)) (get temp___693 temp___692)) (f (get2 (model__ s) (get (keys s) i))))))))))
