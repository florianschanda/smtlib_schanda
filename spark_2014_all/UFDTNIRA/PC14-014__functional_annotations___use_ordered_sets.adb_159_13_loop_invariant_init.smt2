...
(assert (not (= (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) i4) (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (- i4 n1)))))
(check-sat)
(exit)
