...
(assert (forall ((x1 Int)) (forall ((y1 Int)) (! (ite (or (= x1 0) (= y1 0)) (= (fxp_mult x1 y1) 0) (ite (or (and (< 0 x1) (< 0 y1)) (and (< x1 0) (< y1 0))) (pos_div_relation (fxp_mult x1 y1) (* (* (* (* x1 y1) 1) 1) 16) (* (* 16 16) 1)) (pos_div_relation (- (fxp_mult x1 y1)) (- (* (* (* (* x1 y1) 1) 1) 16)) (* (* 16 16) 1)))) :pattern ((fxp_mult x1 y1))))))
(declare-fun fxp_div (Int Int) Int)
(assert (forall ((x1 Int)) (forall ((y1 Int)) (! (ite (= x1 0) (= (fxp_div x1 y1) 0) (ite (and (< 0 x1) (< 0 y1)) (pos_div_relation (fxp_div x1 y1) (* (* (* x1 1) 16) 16) (* (* (* y1 16) 1) 1)) (ite (and (< x1 0) (< y1 0)) (pos_div_relation (fxp_div x1 y1) (* (* (* (- x1) 1) 16) 16) (* (* (* (- y1) 16) 1) 1)) (ite (and (< x1 0) (< 0 y1)) (pos_div_relation (- (fxp_div x1 y1)) (* (* (* (- x1) 1) 16) 16) (* (* (* y1 16) 1) 1)) (=> (and (< 0 x1) (< y1 0)) (pos_div_relation (- (fxp_div x1 y1)) (* (* (* x1 1) 16) 16) (* (* (* (- y1) 16) 1) 1))))))) :pattern ((fxp_div x1 y1))))))
(assert (= y (of_fixed1 8)))
(assert (= inv_y (of_fixed1 32)))
...
(assert (=> (not (= (to_fixed1 x) 0)) (= (to_fixed1 z2) 16)))
