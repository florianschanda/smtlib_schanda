...
(assert (forall ((ts us_rep)) (! (= (ts_fraction ts) (of_fixed (- (to_fixed (to_duration__2 ts)) (to_fixed (of_fixed (of_int (ts_sc ts))))))) :pattern ((ts_fraction ts)))))
...
(assert (forall ((i seconds_count)) (and (<= (- 9223372036854775808) (seconds_countqtint i)) (<= (seconds_countqtint i) 9223372036854775807))))
(define-fun in_range2 ((x Int)) Bool (and (<= (- 9223372036854775808) x) (<= x 9223372036854775807)))
(declare-fun attr__ATTRIBUTE_IMAGE2 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check2 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE2 (us_image) Int)
(declare-fun user_eq2 (seconds_count seconds_count) Bool)
(declare-const dummy2 seconds_count)
...
(define-fun dynamic_invariant ((temp___expr_179 Int) (temp___is_init_175 Bool) (temp___skip_constant_176 Bool) (temp___do_toplevel_177 Bool) (temp___do_typ_inv_178 Bool)) Bool (=> (or (= temp___is_init_175 true) (<= (- 9223372036854775808) 9223372036854775807)) (in_range2 temp___expr_179)))
...
(assert (forall ((i tseconds_countB)) (and (<= (- 9223372036854775808) (tseconds_countBqtint i)) (<= (tseconds_countBqtint i) 9223372036854775807))))
(define-fun in_range3 ((x Int)) Bool (and (<= (- 9223372036854775808) x) (<= x 9223372036854775807)))
(declare-fun attr__ATTRIBUTE_IMAGE3 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check3 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE3 (us_image) Int)
(declare-fun user_eq3 (tseconds_countB tseconds_countB) Bool)
(declare-const dummy3 tseconds_countB)
...
(assert (in_range2 sc))
(assert (and (= o8 (* 3 9223372036)) (in_range3 (* 3 9223372036))))
(assert (= o9 (ite (<= sc o8) true false)))
(assert (and (= o7 (* 3 (- 9223372036))) (in_range3 (* 3 (- 9223372036)))))
(assert (= o10 (ite (<= o7 sc) true false)))
(assert (= result (ite (= o10 true) o9 false)))
(assert (= result true))
(assert (and (= o3 (+ 9223372036 1)) (in_range3 (+ 9223372036 1))))
(assert (and (= o4 (result_sc sc ts)) (and (in_range2 o4) (= o4 (+ sc (ts_sc ts))))))
(assert (= o5 (ite (<= o4 o3) true false)))
(assert (and (= o1 (result_sc sc ts)) (and (in_range2 o1) (= o1 (+ sc (ts_sc ts))))))
(assert (and (= o2 (- (- 9223372036) 1)) (in_range3 (- (- 9223372036) 1))))
(assert (= o6 (ite (<= o2 o1) true false)))
(assert (= result1 (ite (= o6 true) o5 false)))
(assert (= result1 true))
(assert (and (= o (result_sc sc ts)) (and (in_range2 o) (= o (+ sc (ts_sc ts))))))
(assert (= result2 (ite (< 0 o) true false)))
(assert (not (= result2 true)))
(assert (not (in_range1 (+ (- 9223372036854775808) (to_fixed fudged)))))
(check-sat)
(exit)
