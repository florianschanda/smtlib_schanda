...
(assert (forall ((us_void_param tuple0)) (! (let ((result (get_constant_even_pair us_void_param))) (and (and (= (to_rep (rec__dynamic_preds__even_pair__a (us_split_fields1 result))) 0) (= (to_rep (rec__dynamic_preds__even_pair__b (us_split_fields1 result))) 0)) (dynamic_invariant2 result true false true))) :pattern ((get_constant_even_pair us_void_param)))))
...
(assert (and (= (mk___rep (mk___split_fields o o1)) (get_constant_even_pair Tuple0)) (and (dynamic_invariant2 (mk___rep (mk___split_fields o o1)) true false true) (and (= (to_rep o) 0) (= (to_rep o1) 0)))))
(assert (= (mk___rep (mk___split_fields temp___224 temp___2241)) (mk___rep (mk___split_fields o o1))))
(assert (not (= (to_rep temp___2241) (+ (to_rep temp___224) 2))))
(check-sat)
(exit)
