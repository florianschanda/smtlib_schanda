...
(assert (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 result__3)) (=> (<= 2 x) (dynamic_property 2 x i2))) (and (<= 2 i2) (<= i2 x))))
(assert (not (= i2 x)))
(assert (= i2 result3))
(assert (= i3 (+ i2 1)))
(assert (and (= o2 (* result__3 i3)) (in_range1 (* result__3 i3))))
(assert (= result4 result__3))
(assert (= result__4 o2))
(assert (not (= result__4 (mathematical_factorial i3))))
(check-sat)
(exit)
