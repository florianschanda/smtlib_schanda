...
(assert (= o12 (mk___rep x__split_discrs x__split_fields11)))
(assert (= o13 (rec__formals_rec_split_pred__rec__h (us_split_fields1 o12))))
(assert (= o14 (to_rep1 o13)))
(assert (not (= (to_rep1 (rec__formals_rec_split_pred__rec__h x__split_fields11)) 0)))
(assert (= o9 (mk___rep x__split_discrs x__split_fields11)))
(assert (= o10 (rec__formals_rec_split_pred__rec__g (us_split_fields1 o9))))
