...
(declare-const y31 t3)
(declare-const result3 t3)
(declare-const y32 t3)
(declare-const result4 t4)
(declare-const y41 t4)
(declare-const result5 t4)
(declare-const y42 t4)
...
(assert (=> (= (to_fixed2 x3) 4) (= (to_fixed1 y21) 100)))
(assert (= (to_fixed2 o2) (fxp_mult2 (to_fixed1 x2) 1)))
(assert (= result2 y3))
(assert (= y31 o2))
(assert (=> (= (to_fixed1 x2) (- 250)) (= (to_fixed2 y31) (- 10))))
(assert (=> (= (to_fixed1 x2) 50) (= (to_fixed2 y31) 2)))
(assert (=> (= (to_fixed1 x2) 100) (= (to_fixed2 y31) 4)))
(assert (= (to_fixed2 o3) (fxp_mult3 (to_fixed3 x4) 1)))
(assert (= result3 y31))
(assert (= y32 o3))
(assert (=> (= (to_fixed3 x4) (- 5)) (= (to_fixed2 y32) (- 10))))
(assert (=> (= (to_fixed3 x4) 1) (= (to_fixed2 y32) 2)))
(assert (=> (= (to_fixed3 x4) 2) (= (to_fixed2 y32) 4)))
(assert (= (to_fixed3 o4) (fxp_mult4 (to_fixed x) 1)))
(assert (= result4 y4))
(assert (= y41 o4))
(assert (=> (= (to_fixed x) (- 25)) (= (to_fixed3 y41) (- 5))))
(assert (=> (= (to_fixed x) 5) (= (to_fixed3 y41) 1)))
(assert (=> (= (to_fixed x) 10) (= (to_fixed3 y41) 2)))
(assert (= (to_fixed3 o5) (fxp_mult5 (to_fixed2 x3) 1)))
(assert (= result5 y41))
(assert (= y42 o5))
(assert (=> (= (to_fixed2 x3) (- 10)) (= (to_fixed3 y42) (- 5))))
(assert (= (to_fixed2 x3) 2))
(assert (not (= (to_fixed3 y42) 1)))
(check-sat)
(exit)
