...
(assert (= result3 i3))
(assert (= i4 (+ i3 1)))
(assert (not (= (length (mk___rep v__split_discrs (mk___split_fields v__split_fields3))) (+ (length (mk___rep v__split_discrs (mk___split_fields v__split_fields))) (- i4 first)))))
(check-sat)
(exit)
