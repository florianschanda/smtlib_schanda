...
(assert (<= (+ (* 2 n3) 1) i4))
(assert (<= i4 (length (mk___rep s__split_discrs s__split_fields3))))
(assert (not (= (get (elements (mk___rep s__split_discrs s__split_fields3)) i4) (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (- i4 n3)))))
(check-sat)
(exit)
