...
(define-fun fees4 () money_type__ref (mk_money_type__ref fees))
...
(assert (=> (= (rec__students3__student_record__part_time (us_split_fields3 student)) true) (= (mk_money_type__ref result2) fees4)))
...
(assert (=> (not (= (rec__students3__student_record__part_time (us_split_fields3 student)) true)) (= (mk_money_type__ref result3) fees4)))
...
(assert (= (rec__students3__student_record__resident (us_split_fields3 student)) true))
(assert (= (to_fixed2 o4) (+ (to_fixed2 fees1) 400000)))
(assert (= fees1 result4))
(assert (= fees3 o4))
(assert (not (= (to_rep1 (rec__students3__student_record__meal_plan (us_split_fields3 student))) 0)))
(assert (not (= (to_rep1 (rec__students3__student_record__meal_plan (us_split_fields3 student))) 1)))
(assert (not (= (to_rep1 (rec__students3__student_record__meal_plan (us_split_fields3 student))) 2)))
(assert (not (in_range5 (+ (to_fixed2 fees3) 300000))))
(check-sat)
(exit)
