...
(assert (and (= o (positions (mk___rep s__split_discrs s__split_fields2))) (and (not (= (has_key1 o no_element) true)) (forall ((i us_rep1)) (=> (= (has_key1 o i) true) (and (and (<= 1 (get2 o i)) (<= (get2 o i) (length (mk___rep s__split_discrs s__split_fields2)))) (forall ((j us_rep1)) (=> (= (has_key1 o j) true) (=> (= (get2 o i) (get2 o j)) (= (bool_eq1 i j) true))))))))))
