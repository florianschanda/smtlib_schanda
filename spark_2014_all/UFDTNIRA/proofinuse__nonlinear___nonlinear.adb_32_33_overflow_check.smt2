...
(define-fun dynamic_invariant2 ((temp___expr_129 Int) (temp___is_init_126 Bool) (temp___skip_constant_127 Bool) (temp___do_toplevel_128 Bool)) Bool (=> (or (= temp___is_init_126 true) (<= (- 9223372036854775808) 9223372036854775807)) (in_range3 temp___expr_129)))
(declare-const o Int)
...
(assert (in_range2 x))
(assert (and (<= 2 x) (<= x 29)))
(assert (and (= o2 (+ x 1)) (in_range1 (+ x 1))))
(assert (= o3 (power 2 o2)))
