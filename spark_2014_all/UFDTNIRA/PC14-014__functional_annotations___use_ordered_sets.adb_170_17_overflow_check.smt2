...
(assert (and (= o4 (next (mk___rep s__split_discrs s__split_fields2) (mk___rep1 cu__split_fields2))) (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields2) no_element) false) (= (get1 (positions (mk___rep s__split_discrs s__split_fields2)) (mk___rep1 cu__split_fields2)) (length (mk___rep s__split_discrs s__split_fields2))) true) true) (= (bool_eq1 o4 no_element) true) (and (= (has_key (positions (mk___rep s__split_discrs s__split_fields2)) o4) true) (= (get1 (positions (mk___rep s__split_discrs s__split_fields2)) o4) (+ (get1 (positions (mk___rep s__split_discrs s__split_fields2)) (mk___rep1 cu__split_fields2)) 1))))))
(assert (and (= temp___8311 (next (mk___rep s__split_discrs s__split_fields2) o4)) (ite (= (ite (= (bool_eq1 o4 no_element) false) (= (get1 (positions (mk___rep s__split_discrs s__split_fields2)) o4) (length (mk___rep s__split_discrs s__split_fields2))) true) true) (= (bool_eq1 temp___8311 no_element) true) (and (= (has_key (positions (mk___rep s__split_discrs s__split_fields2)) temp___8311) true) (= (get1 (positions (mk___rep s__split_discrs s__split_fields2)) temp___8311) (+ (get1 (positions (mk___rep s__split_discrs s__split_fields2)) o4) 1))))))
(assert (= result3 (mk___split_fields__ref1 cu__split_fields2)))
(assert (= cu__split_fields3 (mk___split_fields1 temp___831)))
(assert (not (in_range1 (+ n2 1))))
(check-sat)
(exit)
