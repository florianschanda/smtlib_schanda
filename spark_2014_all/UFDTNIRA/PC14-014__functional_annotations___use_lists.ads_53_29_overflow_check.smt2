...
(assert (forall ((x tcount_typeB)) (! (in_range1 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(declare-const temp___558 us_rep2)
(declare-const temp___557 Int)
(declare-const temp___554 Int)
(declare-const temp___552 count_type)
(declare-const temp___551 count_type)
(declare-const temp___5511 us_main_type)
(declare-const temp___556 us_rep2)
...
(define-fun use_lists__double_size__cu__assume1 () us_rep1 (mk___rep1 (mk___split_fields1 use_lists__double_size__cu__assume)))
...
(assert (and (= use_lists__double_size__cu__assume1 (first (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (ite (= (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 0) true) (= (bool_eq1 use_lists__double_size__cu__assume1 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) use_lists__double_size__cu__assume1) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) use_lists__double_size__cu__assume1) 1)))))
...
(assert (and (= o (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (and (in_range2 o) (<= o (to_rep (rec__use_lists__my_lists__list__capacity l__split_discrs))))))
(assert (= (mk_int__ref result1) (mk_int__ref lgth)))
(assert (= lgth1 o))
(assert (in_range2 lgth1))
(assert (= lgth1 r27b))
(assert (in_range2 r27b))
(assert (= (mk_int__ref result2) (mk_int__ref i)))
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 r27b)) (= temp___553 i1)))
(assert (=> (and (<= 1 i1) (<= i1 r27b)) (= temp___555 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
...
(assert (=> (and (<= 1 i1) (<= i1 r27b)) (= temp___554 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (=> (and (<= 1 i1) (<= i1 r27b)) (= temp___552 cu__split_fields1)))
(assert (=> (and (<= 1 i1) (<= i1 r27b)) (and (= l__split_discrs (mk___split_discrs temp___551)) (= l__split_fields temp___5511))))
(assert (=> (and (<= 1 i1) (<= i1 r27b)) (= temp___556 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (=> (and (<= 1 i1) (<= i1 r27b)) (= (has_key (positions (mk___rep l__split_discrs l__split_fields10)) (mk___rep1 cu__split_fields10)) true)))
(assert (=> (and (<= 1 i1) (<= i1 r27b)) (= (length (mk___rep l__split_discrs l__split_fields10)) (- (+ temp___554 i2) 1))))
(assert (=> (and (<= 1 i1) (<= i1 r27b)) (forall ((i9 Int)) (=> (and (<= 1 i9) (<= i9 temp___555)) (= (get (model__ (mk___rep l__split_discrs l__split_fields10)) i9) (get temp___556 i9))))))
(assert (=> (and (<= 1 i1) (<= i1 r27b)) (forall ((j Int)) (=> (and (<= 1 j) (<= j (- i2 1))) (= (get (model__ (mk___rep l__split_discrs l__split_fields10)) (+ j temp___557)) (get temp___558 j))))))
...
(assert (=> (and (<= 1 i1) (<= i1 r27b)) (and (= o1 (element (mk___rep l__split_discrs l__split_fields10) (mk___rep1 cu__split_fields10))) (and (in_range6 o1) (= o1 (get (model__ (mk___rep l__split_discrs l__split_fields10)) (get1 (positions (mk___rep l__split_discrs l__split_fields10)) (mk___rep1 cu__split_fields10))))))))
...
(assert (=> (and (<= 1 i1) (<= i1 r27b)) (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields10) no_element) false) (= (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields10)) (length (mk___rep l__split_discrs l__split_fields3))) true) true) (= (bool_eq1 (mk___rep1 cu__split_fields3) no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields3)) true) (= (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields3)) (+ (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields10)) 1))))))
...
(assert (not (in_range1 (* 2 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))))))
(check-sat)
(exit)
