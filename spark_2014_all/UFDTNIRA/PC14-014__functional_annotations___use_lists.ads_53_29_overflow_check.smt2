...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 r27b)) (= temp___555 i1)))
(assert (=> (and (<= 1 i1) (<= i1 r27b)) (= temp___557 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (=> (and (<= 1 i1) (<= i1 r27b)) (= temp___560 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (=> (and (<= 1 i1) (<= i1 r27b)) (= temp___559 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (=> (and (<= 1 i1) (<= i1 r27b)) (= temp___556 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (=> (and (<= 1 i1) (<= i1 r27b)) (= temp___554 cu__split_fields1)))
(assert (=> (and (<= 1 i1) (<= i1 r27b)) (and (= l__split_discrs (mk___split_discrs temp___553)) (= l__split_fields temp___5531))))
(assert (=> (and (<= 1 i1) (<= i1 r27b)) (= temp___558 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (=> (and (<= 1 i1) (<= i1 r27b)) (= (has_key (positions (mk___rep l__split_discrs l__split_fields10)) (mk___rep1 cu__split_fields10)) true)))
(assert (=> (and (<= 1 i1) (<= i1 r27b)) (= (length (mk___rep l__split_discrs l__split_fields10)) (- (+ temp___556 i2) 1))))
(assert (=> (and (<= 1 i1) (<= i1 r27b)) (forall ((i9 Int)) (=> (and (<= 1 i9) (<= i9 temp___557)) (= (get (model__ (mk___rep l__split_discrs l__split_fields10)) i9) (get temp___558 i9))))))
(assert (=> (and (<= 1 i1) (<= i1 r27b)) (forall ((j Int)) (=> (and (<= 1 j) (<= j (- i2 1))) (= (get (model__ (mk___rep l__split_discrs l__split_fields10)) (+ j temp___559)) (get temp___560 j))))))
(assert (=> (and (<= 1 i1) (<= i1 r27b)) (= (get1 (positions (mk___rep l__split_discrs l__split_fields10)) (mk___rep1 cu__split_fields10)) i2)))
(assert (=> (and (<= 1 i1) (<= i1 r27b)) (and (=> (<= 1 r27b) (dynamic_property 1 r27b i2)) (and (<= 1 i2) (<= i2 r27b)))))
(assert (=> (and (<= 1 i1) (<= i1 r27b)) (and (= o1 (element (mk___rep l__split_discrs l__split_fields10) (mk___rep1 cu__split_fields10))) (and (in_range5 o1) (= o1 (get (model__ (mk___rep l__split_discrs l__split_fields10)) (get1 (positions (mk___rep l__split_discrs l__split_fields10)) (mk___rep1 cu__split_fields10))))))))
(assert (=> (and (<= 1 i1) (<= i1 r27b)) (and (and (and (and (and (= (length (mk___rep l__split_discrs l__split_fields3)) (+ (length (mk___rep l__split_discrs l__split_fields10)) 1)) (= (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (last1 (mk___rep l__split_discrs l__split_fields3))) (length (mk___rep l__split_discrs l__split_fields3)))) (= (keys_included_except (positions (mk___rep l__split_discrs l__split_fields3)) (positions (mk___rep l__split_discrs l__split_fields10)) (last1 (mk___rep l__split_discrs l__split_fields3))) true)) (= (ole1 (positions (mk___rep l__split_discrs l__split_fields10)) (positions (mk___rep l__split_discrs l__split_fields3))) true)) (= (get (model__ (mk___rep l__split_discrs l__split_fields3)) (length (mk___rep l__split_discrs l__split_fields3))) o1)) (= (ole (model__ (mk___rep l__split_discrs l__split_fields10)) (model__ (mk___rep l__split_discrs l__split_fields3))) true))))
(assert (=> (and (<= 1 i1) (<= i1 r27b)) (ite (= (ite (= (bool_eq2 (mk___rep1 cu__split_fields10) no_element) false) (= (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields10)) (length (mk___rep l__split_discrs l__split_fields3))) true) true) (= (bool_eq2 (mk___rep1 cu__split_fields3) no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields3)) true) (= (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields3)) (+ (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields10)) 1))))))
(assert (=> (and (<= 1 i1) (<= i1 r27b)) (= i2 r27b)))
(assert (=> (and (<= 1 i1) (<= i1 r27b)) (= i3 (mk_int__ref i2))))
(assert (=> (and (<= 1 i1) (<= i1 r27b)) (= cu__split_fields4 (mk___split_fields__ref1 cu__split_fields3))))
(assert (=> (and (<= 1 i1) (<= i1 r27b)) (= l__split_fields4 (mk___split_fields__ref l__split_fields3))))
(assert (=> (and (<= 1 i1) (<= i1 r27b)) (= i4 i2)))
(assert (=> (and (<= 1 i1) (<= i1 r27b)) (= cu__split_fields5 cu__split_fields3)))
(assert (=> (and (<= 1 i1) (<= i1 r27b)) (= l__split_fields5 l__split_fields3)))
(assert (=> (and (<= 1 i1) (<= i1 r27b)) (= i5 i3)))
(assert (=> (and (<= 1 i1) (<= i1 r27b)) (= cu__split_fields6 cu__split_fields4)))
(assert (=> (and (<= 1 i1) (<= i1 r27b)) (= l__split_fields6 l__split_fields4)))
(assert (=> (and (<= 1 i1) (<= i1 r27b)) (= i6 i4)))
(assert (=> (and (<= 1 i1) (<= i1 r27b)) (= cu__split_fields7 cu__split_fields5)))
(assert (=> (and (<= 1 i1) (<= i1 r27b)) (= l__split_fields7 l__split_fields5)))
(assert (=> (not (and (<= 1 i1) (<= i1 r27b))) (= i5 (mk_int__ref i1))))
(assert (=> (not (and (<= 1 i1) (<= i1 r27b))) (= cu__split_fields6 (mk___split_fields__ref1 cu__split_fields11))))
(assert (=> (not (and (<= 1 i1) (<= i1 r27b))) (= l__split_fields6 (mk___split_fields__ref (mk___split_fields l__split_fields)))))
(assert (=> (not (and (<= 1 i1) (<= i1 r27b))) (= i6 i1)))
(assert (=> (not (and (<= 1 i1) (<= i1 r27b))) (= cu__split_fields7 cu__split_fields11)))
(assert (=> (not (and (<= 1 i1) (<= i1 r27b))) (= l__split_fields7 (mk___split_fields l__split_fields1))))
(assert (= i7 i5))
...
(assert (= (= o2 true) (forall ((i9 Int)) (=> (and (<= 1 i9) (<= i9 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))) (and (= (get (model__ (mk___rep l__split_discrs (us_split_fields__content l__split_fields8))) i9) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i9)) (= (get (model__ (mk___rep l__split_discrs (us_split_fields__content l__split_fields8))) (+ i9 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i9)))))))
(assert (not (in_range6 (* 2 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))))))
(check-sat)
(exit)
