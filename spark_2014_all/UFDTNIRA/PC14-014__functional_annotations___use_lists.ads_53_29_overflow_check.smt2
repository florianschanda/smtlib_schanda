...
(declare-const temp___515 us_rep2)
(declare-const temp___514 Int)
(declare-const temp___511 Int)
(declare-const temp___509 count_type)
(declare-const temp___508 count_type)
(declare-const temp___5081 us_main_type)
(declare-const temp___513 us_rep2)
...
(assert (and (= (mk___rep1 (mk___split_fields1 use_lists__double_size__cu__assume)) (first (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (ite (= (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 0) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 use_lists__double_size__cu__assume)) no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 use_lists__double_size__cu__assume))) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 use_lists__double_size__cu__assume))) 1)))))
...
(assert (and (= o1 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (and (in_range2 o1) (<= o1 (to_rep (rec__use_lists__my_lists__list__capacity l__split_discrs))))))
...
(assert (= i3 1))
(assert (=> (and (<= 1 i3) (<= i3 r27b)) (= temp___510 i3)))
(assert (=> (and (<= 1 i3) (<= i3 r27b)) (= temp___512 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (=> (and (<= 1 i3) (<= i3 r27b)) (= temp___515 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (=> (and (<= 1 i3) (<= i3 r27b)) (= temp___514 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (=> (and (<= 1 i3) (<= i3 r27b)) (= temp___511 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (=> (and (<= 1 i3) (<= i3 r27b)) (= temp___509 cu__split_fields1)))
(assert (=> (and (<= 1 i3) (<= i3 r27b)) (and (= l__split_discrs (mk___split_discrs temp___508)) (= l__split_fields temp___5081))))
(assert (=> (and (<= 1 i3) (<= i3 r27b)) (= temp___513 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (=> (and (<= 1 i3) (<= i3 r27b)) (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (mk___rep1 (mk___split_fields1 cu__split_fields2))) true)))
(assert (=> (and (<= 1 i3) (<= i3 r27b)) (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (- (+ temp___511 i4) 1))))
(assert (=> (and (<= 1 i3) (<= i3 r27b)) (forall ((i12 Int)) (=> (and (<= 1 i12) (<= i12 temp___512)) (= (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) i12) (get temp___513 i12))))))
(assert (=> (and (<= 1 i3) (<= i3 r27b)) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- i4 1))) (= (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (+ j1 temp___514)) (get temp___515 j1))))))
(assert (=> (and (<= 1 i3) (<= i3 r27b)) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (mk___rep1 (mk___split_fields1 cu__split_fields2))) i4)))
(assert (=> (and (<= 1 i3) (<= i3 r27b)) (and (=> (<= 1 r27b) (dynamic_property 1 r27b i4)) (and (<= 1 i4) (<= i4 r27b)))))
(assert (=> (and (<= 1 i3) (<= i3 r27b)) (and (= o12 (element (mk___rep l__split_discrs (mk___split_fields l__split_fields2)) (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range6 o12) (= o12 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (mk___rep1 (mk___split_fields1 cu__split_fields2)))))))))
(assert (=> (and (<= 1 i3) (<= i3 r27b)) (and (and (and (and (and (= (length (mk___rep l__split_discrs l__split_fields3)) (+ (length (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) 1)) (= (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (last1 (mk___rep l__split_discrs l__split_fields3))) (length (mk___rep l__split_discrs l__split_fields3)))) (= (keys_included_except (positions (mk___rep l__split_discrs l__split_fields3)) (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (last1 (mk___rep l__split_discrs l__split_fields3))) true)) (= (ole1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (positions (mk___rep l__split_discrs l__split_fields3))) true)) (= (get (model__ (mk___rep l__split_discrs l__split_fields3)) (length (mk___rep l__split_discrs l__split_fields3))) o12)) (= (ole (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (model__ (mk___rep l__split_discrs l__split_fields3))) true))))
(assert (=> (and (<= 1 i3) (<= i3 r27b)) (ite (= (ite (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields2)) no_element) false) (= (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 (mk___split_fields1 cu__split_fields2))) (length (mk___rep l__split_discrs l__split_fields3))) true) true) (= (bool_eq1 (mk___rep1 cu__split_fields3) no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields3)) true) (= (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields3)) (+ (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))))))
(assert (=> (and (<= 1 i3) (<= i3 r27b)) (= i4 r27b)))
(assert (=> (and (<= 1 i3) (<= i3 r27b)) (= i6 (mk_int__ref i4))))
(assert (=> (and (<= 1 i3) (<= i3 r27b)) (= cu__split_fields4 (mk___split_fields__ref1 cu__split_fields3))))
(assert (=> (and (<= 1 i3) (<= i3 r27b)) (= l__split_fields4 (mk___split_fields__ref l__split_fields3))))
(assert (=> (and (<= 1 i3) (<= i3 r27b)) (= i7 i4)))
(assert (=> (and (<= 1 i3) (<= i3 r27b)) (= cu__split_fields5 cu__split_fields3)))
(assert (=> (and (<= 1 i3) (<= i3 r27b)) (= l__split_fields5 l__split_fields3)))
(assert (=> (and (<= 1 i3) (<= i3 r27b)) (= i8 i6)))
(assert (=> (and (<= 1 i3) (<= i3 r27b)) (= cu__split_fields6 cu__split_fields4)))
(assert (=> (and (<= 1 i3) (<= i3 r27b)) (= l__split_fields6 l__split_fields4)))
(assert (=> (and (<= 1 i3) (<= i3 r27b)) (= i9 i7)))
(assert (=> (and (<= 1 i3) (<= i3 r27b)) (= cu__split_fields7 cu__split_fields5)))
(assert (=> (and (<= 1 i3) (<= i3 r27b)) (= l__split_fields7 l__split_fields5)))
(assert (=> (not (and (<= 1 i3) (<= i3 r27b))) (= i8 (mk_int__ref i3))))
(assert (=> (not (and (<= 1 i3) (<= i3 r27b))) (= cu__split_fields6 (mk___split_fields__ref1 (mk___split_fields1 cu__split_fields1)))))
(assert (=> (not (and (<= 1 i3) (<= i3 r27b))) (= l__split_fields6 (mk___split_fields__ref (mk___split_fields l__split_fields)))))
(assert (=> (not (and (<= 1 i3) (<= i3 r27b))) (= i9 i3)))
(assert (=> (not (and (<= 1 i3) (<= i3 r27b))) (= cu__split_fields7 (mk___split_fields1 cu__split_fields1))))
(assert (=> (not (and (<= 1 i3) (<= i3 r27b))) (= l__split_fields7 (mk___split_fields l__split_fields1))))
(assert (= i10 i8))
...
(assert (= (= o22 true) (forall ((i12 Int)) (=> (and (<= 1 i12) (<= i12 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))) (and (= (get (model__ (mk___rep l__split_discrs (us_split_fields__content l__split_fields8))) i12) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i12)) (= (get (model__ (mk___rep l__split_discrs (us_split_fields__content l__split_fields8))) (+ i12 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i12)))))))
