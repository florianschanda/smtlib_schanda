...
(assert (and (= o23 (length (mk___rep s__split_discrs s__split_fields2))) (and (in_range2 o23) (<= o23 (to_rep (rec__use_ordered_sets__my_sets__set__capacity s__split_discrs))))))
(assert (= o24 (ite (<= i1 o23) true false)))
(assert (and (= o20 (* 2 n2)) (in_range1 (* 2 n2))))
(assert (= o21 (+ o20 1)))
(assert (and (= o22 o21) (in_range1 o21)))
(assert (= o25 (ite (<= o22 i1) true false)))
(assert (= result4 (ite (= o25 true) o24 false)))
(assert (= result4 true))
(assert (and (= o28 (- i1 n2)) (in_range1 (- i1 n2))))
(assert (and (= o29 o28) (in_range4 o28)))
(assert (and (= o30 (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) o29)) (in_range5 o30)))
(assert (not (in_range4 i1)))
(check-sat)
(exit)
