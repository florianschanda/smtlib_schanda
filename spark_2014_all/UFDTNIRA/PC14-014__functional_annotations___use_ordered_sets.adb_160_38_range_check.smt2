...
(assert (and (= o3 (length (mk___rep s__split_discrs s__split_fields1))) (and (in_range2 o3) (<= o3 (to_rep (rec__use_ordered_sets__my_sets__set__capacity s__split_discrs))))))
...
(assert (and (= o8 (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) o7)) (in_range5 o8)))
