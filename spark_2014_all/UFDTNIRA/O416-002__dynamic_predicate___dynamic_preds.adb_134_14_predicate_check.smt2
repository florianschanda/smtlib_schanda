...
(declare-const temp___310 even)
(declare-const temp___3101 even)
...
(declare-const x__split_fields6 even)
(declare-const x__split_fields7 even)
(declare-const x__split_fields8 even)
(declare-const x__split_fields9 even)
...
(assert (= temp___310 x__split_fields2))
(assert (= temp___3101 x__split_fields3))
