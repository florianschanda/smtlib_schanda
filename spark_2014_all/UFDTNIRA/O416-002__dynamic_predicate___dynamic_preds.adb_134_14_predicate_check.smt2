...
(declare-const temp___336 even)
(declare-const temp___3361 even)
...
(assert (= temp___336 o2))
(assert (= temp___3361 o3))
...
(assert (= temp___336 x__split_fields2))
(assert (= temp___3361 x__split_fields3))
