...
(assert (<= first j2))
(assert (<= j2 (- i4 1)))
(assert (not (= (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields3))) (+ j2 (length (mk___rep v__split_discrs (mk___split_fields v__split_fields))))) (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) j2))))
(check-sat)
(exit)
