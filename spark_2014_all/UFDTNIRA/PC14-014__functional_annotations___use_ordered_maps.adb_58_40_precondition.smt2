...
(assert (and (= o19 (get1 o18 (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range5 o19) (=> (= (of_int 0) true) (and (= o19 (w_get o18 (witness o18 (mk___rep1 (mk___split_fields1 cu__split_fields2))))) (forall ((k3 us_rep1)) (=> (= (has_key1 o18 k3) true) (= (= (bool_eq1 k3 (mk___rep1 (mk___split_fields1 cu__split_fields2))) true) (= (witness o18 (mk___rep1 (mk___split_fields1 cu__split_fields2))) (witness o18 k3))))))))))
(assert (= o20 (- o19 1)))
(assert (= o21 (ite (<= i1 o20) true false)))
(assert (= result5 (ite (<= 1 i1) o21 false)))
(assert (= result5 true))
(assert (and (= o22 (keys s)) (and (and (and (= (length3 o22) (length s)) (forall ((temp___396 Int)) (=> (and (in_range3 temp___396) (= (iter_has_element o22 temp___396) true)) (= (has_key (model__ s) (get o22 temp___396)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true)) (and (< 0 (find o22 key2)) (= (equivalent_keys (get o22 (find o22 key2)) key2) true))))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length s))) (and (= (find o22 (get o22 i2)) i2) (= (k_is_find o22 (get o22 i2) i2) true)))))))
(assert (not (<= 1 i1)))
(check-sat)
(exit)
