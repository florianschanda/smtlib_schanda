...
(declare-sort fp1 0)
(define-fun in_range ((x Int)) Bool (and (<= (- 30) x) (<= x 30)))
...
(assert (forall ((x fp1)) (in_range (to_fixed x))))
...
(declare-sort fp2 0)
(define-fun in_range1 ((x Int)) Bool (and (<= (- 50) x) (<= x 50)))
...
(assert (forall ((x fp2)) (in_range1 (to_fixed1 x))))
...
(assert (forall ((x tfp3B)) (in_range2 (to_fixed2 x))))
...
(declare-sort fp3 0)
(define-fun in_range3 ((x Int)) Bool (and (<= (- 150) x) (<= x 150)))
...
(assert (forall ((x fp3)) (in_range3 (to_fixed3 x))))
...
(assert (forall ((x tfp4B)) (in_range4 (to_fixed4 x))))
(assert (forall ((x Int)) (! (=> (in_range4 x) (= (to_fixed4 (of_fixed4 x)) x)) :pattern ((to_fixed4 (of_fixed4 x))))))
...
(declare-sort fp4 0)
(define-fun in_range5 ((x Int)) Bool (and (<= (- 300) x) (<= x 300)))
...
(assert (forall ((x fp4)) (in_range5 (to_fixed5 x))))
(assert (forall ((x Int)) (! (=> (in_range5 x) (= (to_fixed5 (of_fixed5 x)) x)) :pattern ((to_fixed5 (of_fixed5 x))))))
...
(assert (not (in_range2 (fxp_mult (to_fixed x) (to_fixed1 y)))))
(check-sat)
(exit)
