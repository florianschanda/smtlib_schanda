...
(assert (=> (= result6 true) (= (divides x2 a) true)))
(assert (forall ((y1 Int)) (=> (and (<= 1 y1) (<= y1 x3)) (= (and (= (divides y1 a) true) (= (divides y1 b) true)) (and (= (divides y1 b) true) (or (= (divides b a) true) (= (divides y1 (mod2 a b)) true)))))))
(assert (and (=> (<= 1 2147483647) (in_range1 x3)) (and (<= 1 x3) (<= x3 2147483647))))
(assert (<= 1 y))
(assert (<= y x3))
(assert (and (= result9 (divides y b)) (= (= result9 true) (= (mod2 b y) 0))))
(assert (= result9 true))
(assert (and (= result10 (divides b a)) (= (= result10 true) (= (mod2 a b) 0))))
