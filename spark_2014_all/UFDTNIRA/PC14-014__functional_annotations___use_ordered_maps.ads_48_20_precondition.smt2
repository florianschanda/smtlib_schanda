...
(declare-const temp___740 us_rep3)
...
(assert (=> (= result1 true) (let ((temp___733 (keys (mk___rep r__split_discrs r__split_fields10)))) (forall ((temp___732 Int)) (=> (and (in_range3 temp___732) (= (iter_has_element temp___733 temp___732) true)) (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields10)) 1))) (= (get temp___733 temp___732) (get (keys s) i)))))))))
...
(assert (=> (= result1 true) (and (= temp___7251 (next s (mk___rep1 cu__split_fields10))) (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields10) no_element) false) (= (get1 (positions s) (mk___rep1 cu__split_fields10)) (length s)) true) true) (= (bool_eq1 temp___7251 no_element) true) (and (= (has_key1 (positions s) temp___7251) true) (= (get1 (positions s) temp___7251) (+ (get1 (positions s) (mk___rep1 cu__split_fields10)) 1)))))))
...
(assert (and (= temp___740 (keys s)) (and (and (and (= (length3 temp___740) (length s)) (forall ((temp___439 Int)) (=> (and (in_range3 temp___439) (= (iter_has_element temp___740 temp___439) true)) (= (has_key (model__ s) (get temp___740 temp___439)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true)) (and (< 0 (find temp___740 key2)) (= (equivalent_keys (get temp___740 (find temp___740 key2)) key2) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length s))) (and (= (find temp___740 (get temp___740 i)) i) (= (k_is_find temp___740 (get temp___740 i) i) true)))))))
(assert (and (= o4 (iter_has_element temp___740 temp___739)) (= (= o4 true) (and (<= 1 temp___739) (<= temp___739 (last temp___740))))))
(assert (= (= o5 true) (in_range3 temp___739)))
(assert (= result4 (ite (= o5 true) o4 false)))
(assert (= result4 true))
(assert (and (= k (get temp___740 temp___739)) (in_range4 k)))
(assert (= o8 (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7)))))
(assert (and (= result5 (has_key o8 k)) (=> (= (distinct 1 0) true) (=> (exists ((k1 Int)) (and (and (in_range2 k1) (= (has_key o8 k1) true)) (= (equivalent_keys k1 k) true))) (= result5 true)))))
(assert (= result5 true))
