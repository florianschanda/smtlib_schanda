...
(assert (=> (< target_x position_x) (= temp___168 o1)))
(assert (=> (< target_x position_x) (= temp___1681 o2)))
(assert (=> (< target_x position_x) (= result result____split_fields7)))
(assert (=> (< target_x position_x) (= result____split_fields3 (mk___split_fields temp___168 temp___1681))))
...
(assert (=> (not (< target_x position_x)) (=> (< position_x target_x) (= temp___166 o4))))
(assert (=> (not (< target_x position_x)) (=> (< position_x target_x) (= temp___1661 o5))))
(assert (=> (not (< target_x position_x)) (=> (< position_x target_x) (= result1 result____split_fields7))))
(assert (=> (not (< target_x position_x)) (=> (< position_x target_x) (= result____split_fields4 (mk___split_fields temp___166 temp___1661)))))
...
(assert (=> (< target_y position_y) (= temp___172 o7)))
(assert (=> (< target_y position_y) (= temp___1721 o8)))
(assert (=> (< target_y position_y) (= result2 (mk___split_fields__ref result____split_fields3))))
(assert (=> (< target_y position_y) (= result____split_fields5 (mk___split_fields temp___172 temp___1721))))
...
(assert (=> (not (< target_y position_y)) (=> (< position_y target_y) (= temp___170 o10))))
(assert (=> (not (< target_y position_y)) (=> (< position_y target_y) (= temp___1701 o11))))
(assert (=> (not (< target_y position_y)) (=> (< position_y target_y) (= result3 (mk___split_fields__ref result____split_fields3)))))
(assert (=> (not (< target_y position_y)) (=> (< position_y target_y) (= result____split_fields6 (mk___split_fields temp___170 temp___1701)))))
...
(assert (< c4b 10))
(assert (not (in_range1 (* (to_rep (rec__flight_manager__engine_values__x_speed result____split_fields5)) c4b))))
(check-sat)
(exit)
