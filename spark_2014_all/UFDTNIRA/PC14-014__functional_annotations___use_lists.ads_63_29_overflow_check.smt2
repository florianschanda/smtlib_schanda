...
(assert (=> (= result2 true) (forall ((i Int)) (=> (and (<= 1 i) (<= i n2)) (and (= (get (model__ (mk___rep l__split_discrs l__split_fields11)) (* 2 i)) (get temp___572 i)) (= (get (model__ (mk___rep l__split_discrs l__split_fields11)) (- (* 2 i) 1)) (get temp___573 i)))))))
(assert (=> (= result2 true) (forall ((i Int)) (=> (and (<= (+ n2 1) i) (<= i temp___574)) (= (get (model__ (mk___rep l__split_discrs l__split_fields11)) (+ i n2)) (get temp___575 i))))))
...
(assert (= (= o3 true) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))) (and (= (get (model__ (mk___rep l__split_discrs (us_split_fields__content l__split_fields8))) (- (* 2 i) 1)) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i)) (= (get (model__ (mk___rep l__split_discrs (us_split_fields__content l__split_fields8))) (* 2 i)) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i)))))))
