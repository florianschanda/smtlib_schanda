...
(assert (= (= o45 true) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))) (and (= (get (model__ (mk___rep l__split_discrs (us_split_fields__content l__split_fields8))) (- (* 2 i3) 1)) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i3)) (= (get (model__ (mk___rep l__split_discrs (us_split_fields__content l__split_fields8))) (* 2 i3)) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i3)))))))
