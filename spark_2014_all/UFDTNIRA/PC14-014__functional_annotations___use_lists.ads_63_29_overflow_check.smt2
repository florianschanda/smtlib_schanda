...
(assert (=> (= result2 true) (forall ((i Int)) (=> (and (<= 1 i) (<= i n2)) (and (= (get (model__ (mk___rep l__split_discrs l__split_fields11)) (* 2 i)) (get temp___529 i)) (= (get (model__ (mk___rep l__split_discrs l__split_fields11)) (- (* 2 i) 1)) (get temp___530 i)))))))
(assert (=> (= result2 true) (forall ((i Int)) (=> (and (<= (+ n2 1) i) (<= i temp___531)) (= (get (model__ (mk___rep l__split_discrs l__split_fields11)) (+ i n2)) (get temp___532 i))))))
