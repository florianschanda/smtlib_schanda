...
(assert (and (= o36 o35) (in_range4 o35)))
(assert (and (= o34 (elements (mk___rep s__split_discrs s__split_fields2))) (and (and (and (= (length2 o34) (length (mk___rep s__split_discrs s__split_fields2))) (forall ((temp___390 Int)) (=> (and (in_range4 temp___390) (= (iter_has_element o34 temp___390) true)) (= (contains (model__ (mk___rep s__split_discrs s__split_fields2)) (get o34 temp___390)) true)))) (forall ((item Int)) (=> (and (in_range7 item) (= (contains (model__ (mk___rep s__split_discrs s__split_fields2)) item) true)) (and (< 0 (find o34 item)) (= (equivalent_elements (get o34 (find o34 item)) item) true))))) (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 (length (mk___rep s__split_discrs s__split_fields2)))) (and (= (find o34 (get o34 i4)) i4) (= (e_is_find o34 (get o34 i4) i4) true)))))))
(assert (not (<= 1 o36)))
(check-sat)
(exit)
