...
(assert (= result1 true))
(assert (= o16 (to_duration__2 time_span_first)))
(assert (= o17 (to_fixed o16)))
(assert (= o18 (fxp_div_result_int o17 1)))
(assert (and (= o19 o18) (in_range3 o18)))
(assert (and (= o20 o19) (in_range4 o19)))
(assert (= o21 (div1 o20 left)))
(assert (and (= o22 o21) (in_range3 o21)))
(assert (= o12 (to_duration__2 right)))
(assert (= o13 (to_fixed o12)))
(assert (not (not (= 1 0))))
(check-sat)
(exit)
