...
(declare-const pi_compute__shanks_fixed__result fixed__ref)
...
(declare-const result23 fixed__ref)
(declare-const pi_compute__shanks_fixed__result1 fixed)
(declare-const pi_compute__shanks_fixed__result2 fixed__ref)
(declare-const pi_compute__shanks_fixed__result3 fixed)
(declare-const t12 fixed__ref)
(declare-const t22 fixed__ref)
(declare-const t32 fixed__ref)
(declare-const t42 fixed__ref)
(declare-const t52 fixed__ref)
(declare-const t62 fixed__ref)
(declare-const t72 fixed__ref)
(declare-const t82 fixed__ref)
(declare-const t92 fixed__ref)
(declare-const t102 fixed__ref)
(declare-const a12 fixed__ref)
(declare-const a22 fixed__ref)
(declare-const a32 fixed__ref)
(declare-const a42 fixed__ref)
(declare-const a52 fixed__ref)
(declare-const a62 fixed__ref)
(declare-const a72 fixed__ref)
(declare-const a82 fixed__ref)
(declare-const a92 fixed__ref)
(declare-const a102 fixed__ref)
(declare-const num2 fixed__ref)
(declare-const den2 fixed__ref)
(declare-const res2 fixed__ref)
(declare-const pi_compute__shanks_fixed__result4 fixed__ref)
(declare-const t13 fixed)
(declare-const t23 fixed)
(declare-const t33 fixed)
(declare-const t43 fixed)
(declare-const t53 fixed)
(declare-const t63 fixed)
(declare-const t73 fixed)
(declare-const t83 fixed)
(declare-const t93 fixed)
(declare-const t103 fixed)
(declare-const a13 fixed)
(declare-const a23 fixed)
(declare-const a33 fixed)
(declare-const a43 fixed)
(declare-const a53 fixed)
(declare-const a63 fixed)
(declare-const a73 fixed)
(declare-const a83 fixed)
(declare-const a93 fixed)
(declare-const a103 fixed)
(declare-const num3 fixed)
(declare-const den3 fixed)
(declare-const res3 fixed)
(declare-const pi_compute__shanks_fixed__result5 fixed)
...
(assert (= a91 o17))
(assert (= (to_fixed1 o18) (- (to_fixed1 a91) (to_fixed1 t101))))
(assert (= result19 (mk_fixed__ref a10)))
(assert (= a101 o18))
(assert (= (to_fixed1 o19) (* (- (fxp_mult (to_fixed1 a101) (to_fixed1 a81)) (fxp_mult (to_fixed1 a91) (to_fixed1 a91))) 4)))
(assert (= result20 (mk_fixed__ref num)))
(assert (= num1 o19))
(assert (= (to_fixed1 o20) (+ (- (to_fixed1 a101) (* (to_fixed1 a91) 2)) (to_fixed1 a81))))
(assert (= result21 den))
(assert (= (let ((subject den)) den1) o20))
(assert (not (not (= (to_fixed1 (let ((subject den)) den1)) 0))))
(check-sat)
(exit)
