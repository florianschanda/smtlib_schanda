...
(assert (and (= o8 (keys s)) (and (and (and (= (length3 o8) (length s)) (forall ((temp___396 Int)) (=> (and (in_range3 temp___396) (= (iter_has_element o8 temp___396) true)) (= (has_key (model__ s) (get o8 temp___396)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true)) (and (< 0 (find o8 key2)) (= (equivalent_keys (get o8 (find o8 key2)) key2) true))))) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 (length s))) (and (= (find o8 (get o8 i3)) i3) (= (k_is_find o8 (get o8 i3) i3) true)))))))
