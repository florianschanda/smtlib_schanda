...
(assert (forall ((x Int)) (forall ((y Int)) (! (ite (or (= x 0) (= y 0)) (= (fxp_mult x y) 0) (ite (or (and (< 0 x) (< 0 y)) (and (< x 0) (< y 0))) (pos_div_relation (fxp_mult x y) (* x y) 100) (pos_div_relation (- (fxp_mult x y)) (- (* x y)) 100))) :pattern ((fxp_mult x y))))))
(declare-fun fxp_div (Int Int) Int)
(assert (forall ((x Int)) (forall ((y Int)) (! (ite (= x 0) (= (fxp_div x y) 0) (ite (and (< 0 x) (< 0 y)) (pos_div_relation (fxp_div x y) (* x 100) y) (ite (and (< x 0) (< y 0)) (pos_div_relation (fxp_div x y) (* (- x) 100) (- y)) (ite (and (< x 0) (< 0 y)) (pos_div_relation (- (fxp_div x y)) (* (- x) 100) y) (=> (and (< 0 x) (< y 0)) (pos_div_relation (- (fxp_div x y)) (* x 100) (- y))))))) :pattern ((fxp_div x y))))))
...
(assert (forall ((x Int)) (! (ite (= x 0) (= (to_int1 x) 0) (ite (< 0 x) (pos_div_relation (to_int1 x) x 100) (pos_div_relation (- (to_int1 x)) (- x) 100))) :pattern ((to_int1 x)))))
(declare-fun of_real (Real) Int)
(assert (forall ((x tmoneyB)) (! (= (of_fixed (to_fixed x)) x) :pattern ((to_fixed x)))))
...
(assert (forall ((x salary)) (! (= (of_fixed2 (to_fixed2 x)) x) :pattern ((to_fixed2 x)))))
...
(declare-datatypes () ((salary__ref (mk_salary__ref (salary__content salary)))))
(define-fun salary__ref___projection ((a salary__ref)) salary (salary__content a))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const s salary)
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(declare-const stash money)
(declare-const pocket money)
(declare-const o money)
(declare-const o1 Int)
(declare-const o2 money)
(declare-const o3 money)
(declare-const stash1 money)
(declare-const pocket1 money)
(declare-const result Bool)
(declare-const result1 money)
(declare-const stash2 money)
(declare-const result2 money)
(declare-const pocket2 money)
(declare-const stash3 money)
(declare-const pocket3 money)
(declare-const stash4 money)
(declare-const pocket4 money)
...
(assert (= stash2 o2))
(assert (not (in_range (+ (to_fixed1 pocket) (to_fixed2 s)))))
(check-sat)
(exit)
