...
(assert (and (= o (element s (mk___rep1 cu__split_fields3))) (and (in_range7 o) (= o (get2 (model__ s) (key s (mk___rep1 cu__split_fields3)))))))
(assert (and (= o1 (f o)) (and (in_range8 o1) (= o1 (ite (and (<= (- 100) o) (<= o 100)) (* o 2) o)))))
