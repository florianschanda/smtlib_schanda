...
(assert (and (and (and (and (<= 0 (to_fixed2 tuition)) (<= (to_fixed2 tuition) 3000000)) (and (<= 0 (to_fixed2 insurance2)) (<= (to_fixed2 insurance2) 100000))) (and (<= 10000 (to_fixed2 fees)) (<= (to_fixed2 fees) 750000))) (and (<= 0 (to_fixed2 grants2)) (<= (to_fixed2 grants2) 50000))))
(assert (not (in_range4 (+ (to_fixed2 tuition) (to_fixed2 fees)))))
(check-sat)
(exit)
