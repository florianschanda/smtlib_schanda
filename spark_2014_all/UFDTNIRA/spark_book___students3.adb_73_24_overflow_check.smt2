...
(assert (and (and (and (and (<= 0 (to_fixed tuition)) (<= (to_fixed tuition) 3000000)) (and (<= 0 (to_fixed insurance2)) (<= (to_fixed insurance2) 100000))) (and (<= 10000 (to_fixed fees)) (<= (to_fixed fees) 750000))) (and (<= 0 (to_fixed grants2)) (<= (to_fixed grants2) 50000))))
(assert (not (in_range5 (+ (to_fixed tuition) (to_fixed fees)))))
(check-sat)
(exit)
