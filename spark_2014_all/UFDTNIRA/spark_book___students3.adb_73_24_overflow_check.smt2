...
(assert (and (and (and (and (<= 0 (to_fixed2 tuition2)) (<= (to_fixed2 tuition2) 3000000)) (and (<= 0 (to_fixed2 insurance2)) (<= (to_fixed2 insurance2) 100000))) (and (<= 10000 (to_fixed2 fees4)) (<= (to_fixed2 fees4) 750000))) (and (<= 0 (to_fixed2 grants3)) (<= (to_fixed2 grants3) 50000))))
(assert (not (in_range4 (+ (to_fixed2 tuition2) (to_fixed2 fees4)))))
(check-sat)
(exit)
