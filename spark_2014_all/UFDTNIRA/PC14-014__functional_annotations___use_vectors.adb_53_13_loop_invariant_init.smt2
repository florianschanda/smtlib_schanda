...
(assert (<= first4 j))
(assert (<= j (- i1 1)))
(assert (not (= (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) (+ j (length (mk___rep v__split_discrs (mk___split_fields v__split_fields))))) (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) j))))
(check-sat)
(exit)
