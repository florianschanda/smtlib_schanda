...
(assert (forall ((i Int)) (! (=> (dynamic_invariant i true true true) (let ((result (prf_public i))) (and (= result (div1 i 2)) (dynamic_invariant result true false true)))) :pattern ((prf_public i)))))
(assert (forall ((i Int)) (! (=> (dynamic_invariant i true true true) (let ((result (prf_public1 i))) (and (= result (div1 i 2)) (dynamic_invariant result true false true)))) :pattern ((prf_public1 i)))))
...
(assert (forall ((i Int)) (! (=> (dynamic_invariant i true true true) (dynamic_invariant (prf_hidden i) true false true)) :pattern ((prf_hidden i)))))
(assert (forall ((i Int)) (! (=> (dynamic_invariant i true true true) (let ((result (prf_hidden1 i))) (and (= result (div1 i 2)) (dynamic_invariant result true false true)))) :pattern ((prf_hidden1 i)))))
(declare-const a Int)
