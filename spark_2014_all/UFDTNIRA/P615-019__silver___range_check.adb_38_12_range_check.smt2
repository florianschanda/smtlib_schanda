...
(define-fun in_range1 ((x Int)) Bool (and (<= 0 x) (<= x 127)))
(declare-const dummy1 natural_fixed)
(declare-fun attr__ATTRIBUTE_IMAGE1 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check1 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE1 (us_image) Int)
(declare-fun to_fixed1 (natural_fixed) Int)
(declare-fun of_fixed1 (Int) natural_fixed)
...
(assert (forall ((x natural_fixed)) (! (= (of_fixed1 (to_fixed1 x)) x) :pattern ((to_fixed1 x)))))
(assert (forall ((x natural_fixed)) (in_range1 (to_fixed1 x))))
(assert (forall ((x Int)) (! (=> (in_range1 x) (= (to_fixed1 (of_fixed1 x)) x)) :pattern ((to_fixed1 (of_fixed1 x))))))
(declare-datatypes () ((natural_fixed__ref (mk_natural_fixed__ref (natural_fixed__content natural_fixed)))))
(define-fun natural_fixed__ref___projection ((a natural_fixed__ref)) natural_fixed (natural_fixed__content a))
(declare-const x fixed)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(assert (not (in_range1 (to_fixed x))))
(check-sat)
(exit)
