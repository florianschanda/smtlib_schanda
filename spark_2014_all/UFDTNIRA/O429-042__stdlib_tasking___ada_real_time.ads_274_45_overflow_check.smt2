...
(assert (and (= o18 (ts_fraction ts)) (= o18 (of_fixed (- (to_fixed (to_duration__2 ts)) (to_fixed (of_fixed (* (ts_sc ts) 1000000000))))))))
(assert (= o19 (to_fixed o18)))
(assert (and (= o12 (result_sc sc ts)) (and (in_range3 o12) (= o12 (+ sc (ts_sc ts))))))
(assert (= o13 (+ o12 10)))
