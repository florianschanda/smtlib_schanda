...
(assert (and (= temp___663 (keys (mk___rep r__split_discrs (us_split_fields__content r__split_fields7)))) (and (and (and (= (length3 temp___663) (length (mk___rep r__split_discrs (us_split_fields__content r__split_fields7)))) (forall ((temp___396 Int)) (=> (and (in_range3 temp___396) (= (iter_has_element temp___663 temp___396) true)) (= (has_key (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) (get temp___663 temp___396)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) key2) true)) (and (< 0 (find temp___663 key2)) (= (equivalent_keys (get temp___663 (find temp___663 key2)) key2) true))))) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 (length (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))))) (and (= (find temp___663 (get temp___663 i3)) i3) (= (k_is_find temp___663 (get temp___663 i3) i3) true)))))))
(assert (and (= o43 (iter_has_element temp___663 temp___662)) (= (= o43 true) (and (<= 1 temp___662) (<= temp___662 (last temp___663))))))
(assert (= (= o44 true) (in_range3 temp___662)))
(assert (= result9 (ite (= o44 true) o43 false)))
(assert (= (= o50 true) (let ((temp___669 (keys (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))))) (forall ((temp___668 Int)) (=> (and (in_range3 temp___668) (= (iter_has_element temp___669 temp___668) true)) (let ((temp___671 (keys s))) (exists ((temp___670 Int)) (and (and (in_range3 temp___670) (= (iter_has_element temp___671 temp___670) true)) (= (get2 (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) (get temp___669 temp___668)) (f (get2 (model__ s) (get temp___671 temp___670))))))))))))
(assert (and (= temp___653 (keys s)) (and (and (and (= (length3 temp___653) (length s)) (forall ((temp___396 Int)) (=> (and (in_range3 temp___396) (= (iter_has_element temp___653 temp___396) true)) (= (has_key (model__ s) (get temp___653 temp___396)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true)) (and (< 0 (find temp___653 key2)) (= (equivalent_keys (get temp___653 (find temp___653 key2)) key2) true))))) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 (length s))) (and (= (find temp___653 (get temp___653 i3)) i3) (= (k_is_find temp___653 (get temp___653 i3) i3) true)))))))
(assert (and (= o36 (iter_has_element temp___653 temp___652)) (= (= o36 true) (and (<= 1 temp___652) (<= temp___652 (last temp___653))))))
(assert (= (= o37 true) (in_range3 temp___652)))
(assert (= result11 (ite (= o37 true) o36 false)))
(assert (= result11 true))
(assert (and (= k2 (get temp___653 temp___652)) (in_range4 k2)))
(assert (and (= temp___655 (keys (mk___rep r__split_discrs (us_split_fields__content r__split_fields7)))) (and (and (and (= (length3 temp___655) (length (mk___rep r__split_discrs (us_split_fields__content r__split_fields7)))) (forall ((temp___396 Int)) (=> (and (in_range3 temp___396) (= (iter_has_element temp___655 temp___396) true)) (= (has_key (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) (get temp___655 temp___396)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) key2) true)) (and (< 0 (find temp___655 key2)) (= (equivalent_keys (get temp___655 (find temp___655 key2)) key2) true))))) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 (length (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))))) (and (= (find temp___655 (get temp___655 i3)) i3) (= (k_is_find temp___655 (get temp___655 i3) i3) true)))))))
(assert (and (= o38 (iter_has_element temp___655 temp___654)) (= (= o38 true) (and (<= 1 temp___654) (<= temp___654 (last temp___655))))))
(assert (= (= o39 true) (in_range3 temp___654)))
(assert (= result12 (ite (= o39 true) o38 false)))
(assert (= result12 true))
(assert (and (= l (get temp___655 temp___654)) (in_range4 l)))
(assert (not (= (has_key (model__ s) k2) true)))
(check-sat)
(exit)
