...
(assert (= (to_fixed2 o6) (+ (to_fixed2 fees1) 512000)))
(assert (= fees1 result7))
(assert (= fees3 o6))
(assert (not (= (to_rep1 (rec__students__student_record__meal_plan (us_split_fields1 student))) 0)))
(assert (not (= (to_rep1 (rec__students__student_record__meal_plan (us_split_fields1 student))) 1)))
(assert (not (= (to_rep1 (rec__students__student_record__meal_plan (us_split_fields1 student))) 2)))
(assert (not (in_range5 (+ (to_fixed2 fees3) 384000))))
(check-sat)
(exit)
