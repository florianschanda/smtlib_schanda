...
(assert (=> (not (and (= (mod2 a c1) 0) (= (mod2 b c1) 0))) (=> (and (<= r4b j2) (<= j2 (- (ite (< a b) a b) 1))) (forall ((x Int)) (=> (and (<= (+ c2 1) x) (<= x j3)) (not (= (divides x (ite (< a b) a b)) true)))))))
...
(assert (=> (not (and (= (mod2 a c1) 0) (= (mod2 b c1) 0))) (=> (< 1 c2) (or (and (and (= c2 c5) (= c6 c2)) (and (= (mod2 a c2) 0) (= (mod2 b c2) 0))) (and (not (and (= (mod2 a c2) 0) (= (mod2 b c2) 0))) (and (and (= c4 c5) (= c6 c4)) (and (and (< 1 c3) (forall ((x Int)) (=> (and (<= c3 x) (<= x (ite (< a b) a b))) (not (and (= (divides x a) true) (= (divides x b) true)))))) (and (=> (<= 1 2147483647) (in_range1 c3)) (and (and (and (= o4 (- c3 1)) (in_range1 (- c3 1))) (and (= c3 result4) (= c4 o4))) (or (not (< 1 c4)) (and (< 1 c4) (and (= (mod2 a c4) 0) (= (mod2 b c4) 0)))))))))))))
...
(assert (not (= (divides (int__content math_simple_half__gcd__result7) a) true)))
(check-sat)
(exit)
