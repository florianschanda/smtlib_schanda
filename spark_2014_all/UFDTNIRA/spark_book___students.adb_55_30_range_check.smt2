...
(assert (= grants2 o13))
(assert (<= 480 (to_fixed (rec__students__student_record__gpa (us_split_fields3 student)))))
(assert (= (to_rep (rec__students__student_record__gender (us_split_fields3 student))) 1))
