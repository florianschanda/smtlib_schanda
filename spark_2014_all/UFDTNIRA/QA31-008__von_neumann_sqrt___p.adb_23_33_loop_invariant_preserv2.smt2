...
(assert (forall ((i upper_guess)) (and (<= 0 (upper_guessqtint i)) (<= (upper_guessqtint i) 46341))))
...
(assert (and (= o (* middle2 middle2)) (in_range1 (* middle2 middle2))))
(assert (= result3 (ite (< x o) true false)))
(assert (=> (= result3 true) (= upper2 result4)))
(assert (=> (= result3 true) (= upper3 middle2)))
(assert (=> (= result3 true) (= lower3 lower2)))
(assert (=> (not (= result3 true)) (= lower2 result5)))
(assert (=> (not (= result3 true)) (= lower3 middle2)))
(assert (=> (not (= result3 true)) (= upper3 upper2)))
(assert (not (<= (* lower3 lower3) x)))
(check-sat)
(exit)
