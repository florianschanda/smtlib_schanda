...
(assert (and (= o27 i1) (in_range4 i1)))
(assert (and (= o26 (elements (mk___rep s__split_discrs s__split_fields2))) (and (and (and (= (length2 o26) (length (mk___rep s__split_discrs s__split_fields2))) (forall ((temp___390 Int)) (=> (and (in_range4 temp___390) (= (iter_has_element o26 temp___390) true)) (= (contains (model__ (mk___rep s__split_discrs s__split_fields2)) (get o26 temp___390)) true)))) (forall ((item Int)) (=> (and (in_range7 item) (= (contains (model__ (mk___rep s__split_discrs s__split_fields2)) item) true)) (and (< 0 (find o26 item)) (= (equivalent_elements (get o26 (find o26 item)) item) true))))) (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 (length (mk___rep s__split_discrs s__split_fields2)))) (and (= (find o26 (get o26 i4)) i4) (= (e_is_find o26 (get o26 i4) i4) true)))))))
(assert (not (<= 1 o27)))
(check-sat)
(exit)
