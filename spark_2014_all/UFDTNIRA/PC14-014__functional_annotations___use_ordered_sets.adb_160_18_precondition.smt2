...
(assert (and (= o10 (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) o9)) (in_range5 o10)))
(assert (and (= o7 i) (in_range4 i)))
(assert (and (= o6 (elements (mk___rep s__split_discrs s__split_fields1))) (and (and (and (= (length2 o6) (length (mk___rep s__split_discrs s__split_fields1))) (forall ((temp___390 Int)) (=> (and (in_range4 temp___390) (= (iter_has_element o6 temp___390) true)) (= (contains (model__ (mk___rep s__split_discrs s__split_fields1)) (get o6 temp___390)) true)))) (forall ((item Int)) (=> (and (in_range7 item) (= (contains (model__ (mk___rep s__split_discrs s__split_fields1)) item) true)) (and (< 0 (find o6 item)) (= (equivalent_elements (get o6 (find o6 item)) item) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep s__split_discrs s__split_fields1)))) (and (= (find o6 (get o6 i1)) i1) (= (e_is_find o6 (get o6 i1) i1) true)))))))
(assert (not (<= 1 o7)))
(check-sat)
(exit)
