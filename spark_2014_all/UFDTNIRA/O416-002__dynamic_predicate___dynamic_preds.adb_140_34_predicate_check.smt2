...
(assert (dynamic_invariant2 (mk___rep (mk___split_fields dynamic_preds__update_even_pair__x__fields dynamic_preds__update_even_pair__x__fields1)) true true true))
...
(assert (= (mk___split_fields x__split_fields2 x__split_fields3) (mk___split_fields dynamic_preds__update_even_pair__x__fields dynamic_preds__update_even_pair__x__fields1)))
(assert (= (to_rep x__split_fields3) (+ (to_rep x__split_fields2) 2)))
(assert (and (and (= (to_rep dynamic_preds__update_constant_even_pair__x__fields) 0) (= (to_rep dynamic_preds__update_constant_even_pair__x__fields1) 2)) (dynamic_invariant2 (mk___rep (mk___split_fields dynamic_preds__update_constant_even_pair__x__fields dynamic_preds__update_constant_even_pair__x__fields1)) true true true)))
(assert (= result2 x__split_fields2))
(assert (= result3 x__split_fields3))
(assert (= (mk___split_fields x__split_fields4 x__split_fields5) (mk___split_fields dynamic_preds__update_constant_even_pair__x__fields dynamic_preds__update_constant_even_pair__x__fields1)))
