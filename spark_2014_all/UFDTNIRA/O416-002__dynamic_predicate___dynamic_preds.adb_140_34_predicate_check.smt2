...
(declare-const dynamic_preds__update_even_pair__x__fields even)
(declare-const dynamic_preds__update_even_pair__x__fields1 even)
...
(declare-const dynamic_preds__update_constant_even_pair__x__fields even)
(declare-const dynamic_preds__update_constant_even_pair__x__fields1 even)
(declare-const result2 even)
(declare-const result3 even)
(declare-const x__split_fields4 even)
(declare-const x__split_fields5 even)
(define-fun dynamic_preds__update_constant_even_pair__x__fields2 () us_split_fields (mk___split_fields dynamic_preds__update_constant_even_pair__x__fields dynamic_preds__update_constant_even_pair__x__fields1))
(define-fun dynamic_preds__update_even_pair__x__fields2 () us_split_fields (mk___split_fields dynamic_preds__update_even_pair__x__fields dynamic_preds__update_even_pair__x__fields1))
(assert (dynamic_invariant i7s true false true))
(assert (dynamic_invariant1 i11s true false true))
(assert (dynamic_invariant1 (mk___rep (mk___split_fields x__split_fields x__split_fields1)) true false true))
(assert (dynamic_invariant2 (mk___rep dynamic_preds__update_even_pair__x__fields2) true true true))
(assert (= (mk___split_fields__ref (mk___split_fields result result1)) (mk___split_fields__ref (mk___split_fields x__split_fields x__split_fields1))))
(assert (= (mk___split_fields x__split_fields2 x__split_fields3) dynamic_preds__update_even_pair__x__fields2))
(assert (= (to_rep x__split_fields3) (+ (to_rep x__split_fields2) 2)))
(assert (and (and (= (to_rep dynamic_preds__update_constant_even_pair__x__fields) 0) (= (to_rep dynamic_preds__update_constant_even_pair__x__fields1) 2)) (dynamic_invariant2 (mk___rep dynamic_preds__update_constant_even_pair__x__fields2) true true true)))
(assert (= result2 x__split_fields2))
(assert (= result3 x__split_fields3))
(assert (= (mk___split_fields x__split_fields4 x__split_fields5) dynamic_preds__update_constant_even_pair__x__fields2))
(assert (not (= (to_rep x__split_fields5) (+ (to_rep x__split_fields4) 2))))
(check-sat)
(exit)
