...
(assert (forall ((j Int)) (=> (and (<= first j) (<= j (last5 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields)))))) (= (get (model__ (mk___rep v__split_discrs v__split_fields2)) j) (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) j)))))
(assert (forall ((j Int)) (=> (and (<= first j) (<= j (- i2 1))) (= (get (model__ (mk___rep v__split_discrs v__split_fields2)) (+ j (length (mk___rep v__split_discrs (mk___split_fields v__split_fields))))) (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) j)))))
...
(assert (= o2 (+ (length (mk___rep v__split_discrs (mk___split_fields v__split_fields))) o1)))
