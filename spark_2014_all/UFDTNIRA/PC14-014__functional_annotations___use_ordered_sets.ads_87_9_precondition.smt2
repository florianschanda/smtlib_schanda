...
(assert (and (= o59 o58) (in_range4 o58)))
(assert (and (= o55 (elements (mk___rep s__split_discrs (us_split_fields__content s__split_fields8)))) (and (and (and (= (length2 o55) (length (mk___rep s__split_discrs (us_split_fields__content s__split_fields8)))) (forall ((temp___390 Int)) (=> (and (in_range4 temp___390) (= (iter_has_element o55 temp___390) true)) (= (contains (model__ (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))) (get o55 temp___390)) true)))) (forall ((item Int)) (=> (and (in_range7 item) (= (contains (model__ (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))) item) true)) (and (< 0 (find o55 item)) (= (equivalent_elements (get o55 (find o55 item)) item) true))))) (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 (length (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))))) (and (= (find o55 (get o55 i4)) i4) (= (e_is_find o55 (get o55 i4) i4) true)))))))
(assert (not (<= 1 o59)))
(check-sat)
(exit)
