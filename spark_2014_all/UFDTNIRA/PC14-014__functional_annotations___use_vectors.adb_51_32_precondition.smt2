...
(assert (<= first i1))
(assert (<= i1 r17b))
(assert (= (length (mk___rep v__split_discrs v__split_fields2)) (+ (length (mk___rep v__split_discrs (mk___split_fields v__split_fields))) (- i2 first))))
(assert (forall ((j1 Int)) (=> (and (<= first j1) (<= j1 (last5 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields)))))) (= (get (model__ (mk___rep v__split_discrs v__split_fields2)) j1) (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) j1)))))
(assert (forall ((j1 Int)) (=> (and (<= first j1) (<= j1 (- i2 1))) (= (get (model__ (mk___rep v__split_discrs v__split_fields2)) (+ j1 (length (mk___rep v__split_discrs (mk___split_fields v__split_fields))))) (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) j1)))))
...
(assert (and (= us j) (dynamic_property3 first2 last3 j)))
(assert (= o1 j))
(assert (not (<= first3 o1)))
(check-sat)
(exit)
