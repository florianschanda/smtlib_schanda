...
(define-fun result____split_fields8 () us_split_fields__ref (mk___split_fields__ref (mk___split_fields result____split_fields result____split_fields1)))
...
(assert (=> (not (< target_x position_x)) (=> (< position_x target_x) (= result1 result____split_fields8))))
