...
(declare-const o18 millisecst)
(declare-const o19 dayst)
(assert (= (to_rep3 o) 0))
(assert (= (to_rep2 o1) 1))
(assert (= (to_rep1 o2) 1))
...
(assert (<= 0 min))
(assert (<= min 59))
(assert (and (= o11 min) (in_range6 min)))
(assert (= o12 (* o11 60000)))
(assert (and (= o13 o12) (in_range5 o12)))
(assert (and (= o9 hour) (in_range6 hour)))
(assert (= o10 (* o9 3600000)))
(assert (and (= o14 o10) (in_range5 o10)))
(assert (= o15 (+ o14 o13)))
(assert (and (= o16 o15) (in_range5 o15)))
(assert (and (= o17 o16) (in_range6 o16)))
(assert (= (to_rep3 o18) o17))
(assert (and (= o8 day) (in_range4 day)))
(assert (= (to_rep2 o19) o8))
(assert (not (in_range3 month)))
(check-sat)
(exit)
