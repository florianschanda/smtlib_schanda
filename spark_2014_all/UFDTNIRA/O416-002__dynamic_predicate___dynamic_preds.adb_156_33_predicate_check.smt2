...
(declare-fun get_even_close_pair__2 (us_rep) us_rep)
(declare-fun get_even_close_pair__2__function_guard (us_rep us_rep) Bool)
...
(define-fun dynamic_invariant ((temp___expr_200 us_rep) (temp___is_init_196 Bool) (temp___skip_constant_197 Bool) (temp___do_toplevel_198 Bool) (temp___do_typ_inv_199 Bool)) Bool (and (=> (= temp___do_toplevel_198 true) (=> (= temp___is_init_196 true) (= (to_rep (rec__dynamic_preds__even_pair__b (us_split_fields1 temp___expr_200))) (+ (to_rep (rec__dynamic_preds__even_pair__a (us_split_fields1 temp___expr_200))) 2)))) (and (=> (= temp___is_init_196 true) (= (mod2 (to_rep (rec__dynamic_preds__even_pair__a (us_split_fields1 temp___expr_200))) 2) 0)) (=> (= temp___is_init_196 true) (= (mod2 (to_rep (rec__dynamic_preds__even_pair__b (us_split_fields1 temp___expr_200))) 2) 0)))))
...
(assert (forall ((x us_rep)) (! (=> (dynamic_invariant x true true true true) (dynamic_invariant (get_even_close_pair__2 x) true false true true)) :pattern ((get_even_close_pair__2 x)))))
...
(assert (not (= (to_rep x__split_fields1) (+ (to_rep x__split_fields) 2))))
(check-sat)
(exit)
