...
(assert (forall ((x us_rep)) (! (=> (dynamic_invariant2 x true true true true) (dynamic_invariant2 (get_even_close_pair__2 x) true false true true)) :pattern ((get_even_close_pair__2 x)))))
