...
(assert (forall ((x us_rep)) (! (=> (dynamic_invariant2 x true true true) (dynamic_invariant2 (get_even_close_pair__2 x) true false true)) :pattern ((get_even_close_pair__2 x)))))
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const x__split_fields even)
(declare-const x__split_fields1 even)
(declare-const o even)
(declare-const o1 even)
(declare-const temp___322 even)
(declare-const temp___3221 even)
