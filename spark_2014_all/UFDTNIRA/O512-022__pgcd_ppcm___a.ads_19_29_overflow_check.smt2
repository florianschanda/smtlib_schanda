...
(assert (=> (not (= a__ppcm__result4 0)) (and (= o14 (* a b)) (in_range1 (* a b)))))
(assert (=> (not (= a__ppcm__result4 0)) (= o15 (abs o14))))
(assert (=> (not (= a__ppcm__result4 0)) (and (= o16 o15) (in_range1 o15))))
(assert (=> (not (= a__ppcm__result4 0)) (= o17 (ite (<= a__ppcm__result4 o16) true false))))
(assert (=> (not (= a__ppcm__result4 0)) (and (= o13 (abs a)) (in_range1 (abs a)))))
(assert (=> (not (= a__ppcm__result4 0)) (= o18 (ite (<= o13 a__ppcm__result4) true false))))
(assert (=> (not (= a__ppcm__result4 0)) (= result3 (ite (= o18 true) o17 false))))
(assert (not (= result3 true)))
(assert (and (= o9 (* a b)) (in_range1 (* a b))))
(assert (= o10 (abs o9)))
(assert (and (= o11 o10) (in_range1 o10)))
(assert (= o12 (ite (<= a__ppcm__result4 o11) true false)))
