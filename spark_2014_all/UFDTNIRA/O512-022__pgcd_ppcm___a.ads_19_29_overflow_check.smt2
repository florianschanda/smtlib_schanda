...
(assert (=> (not (= a__ppcm__result4 0)) (and (= o10 (* a b)) (in_range1 (* a b)))))
(assert (=> (not (= a__ppcm__result4 0)) (= o11 (abs o10))))
(assert (=> (not (= a__ppcm__result4 0)) (and (= o12 o11) (in_range1 o11))))
(assert (=> (not (= a__ppcm__result4 0)) (= o13 (ite (<= a__ppcm__result4 o12) true false))))
(assert (=> (not (= a__ppcm__result4 0)) (and (= o9 (abs a)) (in_range1 (abs a)))))
(assert (=> (not (= a__ppcm__result4 0)) (= o14 (ite (<= o9 a__ppcm__result4) true false))))
(assert (=> (not (= a__ppcm__result4 0)) (= result3 (ite (= o14 true) o13 false))))
