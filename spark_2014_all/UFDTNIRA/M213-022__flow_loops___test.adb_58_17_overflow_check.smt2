...
(assert (= y1 1))
(assert (not (= d1 1)))
(assert (and (and (and (and (and (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 x2)) (=> (<= (- 2147483648) 2147483647) (in_range1 y2))) (=> (<= (- 2147483648) 2147483647) (in_range1 c2))) (=> (<= (- 2147483648) 2147483647) (in_range1 d2))) (=> (<= (- 2147483648) 2147483647) (in_range1 q1))) (=> (<= (- 2147483648) 2147483647) (in_range1 r1))) (=> (<= (- 2147483648) 2147483647) (in_range1 w1))) (not (= d2 1))))
(assert (and (= o (div1 c2 d2)) (in_range1 (div1 c2 d2))))
(assert (= q1 result4))
(assert (= q2 o))
(assert (= r1 result5))
(assert (= r2 (mod2 c2 d2)))
