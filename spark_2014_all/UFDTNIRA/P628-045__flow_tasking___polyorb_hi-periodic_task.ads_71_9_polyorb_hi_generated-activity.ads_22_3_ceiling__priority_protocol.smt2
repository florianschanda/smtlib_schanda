...
(define-fun dynamic_invariant ((temp___expr_202 Int) (temp___is_init_199 Bool) (temp___skip_constant_200 Bool) (temp___do_toplevel_201 Bool)) Bool (=> (or (= temp___is_init_199 true) (<= 0 1)) (in_range1 temp___expr_202)))
...
(assert (forall ((us_void_param tuple0)) (! (dynamic_invariant (rmaaadl_task1_job us_void_param) true false true) :pattern ((rmaaadl_task1_job us_void_param)))))
...
(assert true)
(assert true)
(define-fun dynamic_invariant2 ((temp___expr_319 Int) (temp___is_init_316 Bool) (temp___skip_constant_317 Bool) (temp___do_toplevel_318 Bool)) Bool (=> (or (= temp___is_init_316 true) (<= 0 97)) (in_range2 temp___expr_319)))
(assert (= dispatch_offset (to_time_span (of_fixed 0))))
(assert (= task_period (milliseconds 1000)))
(declare-const o duration)
(declare-const temp___1638 us_rep1)
(assert (= (to_fixed o) 0))
(assert (= temp___1638 (to_time_span o)))
(assert (= temp___1638 dispatch_offset))
