...
(define-fun dynamic_invariant1 ((temp___expr_353 Int) (temp___is_init_349 Bool) (temp___skip_constant_350 Bool) (temp___do_toplevel_351 Bool) (temp___do_typ_inv_352 Bool)) Bool (=> (or (= temp___is_init_349 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_353)))
...
(assert (forall ((container us_rep1)) (forall ((item Int)) (! (=> (dynamic_invariant1 item true true true true) (=> (= (distinct 1 0) true) (=> (exists ((e Int)) (and (and (in_range2 e) (= (contains container e) true)) (= (equivalent_elements e item) true))) (= (contains container item) true)))) :pattern ((contains container item))))))
...
(define-fun dynamic_invariant2 ((temp___expr_382 Int) (temp___is_init_378 Bool) (temp___skip_constant_379 Bool) (temp___do_toplevel_380 Bool) (temp___do_typ_inv_381 Bool)) Bool (=> (or (= temp___is_init_378 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_382)))
...
(define-fun oeq1 ((left us_rep2) (right us_rep2)) Bool (and (= (length1 left) (length1 right)) (ite (forall ((n Int)) (=> (and (<= 1 n) (<= n (last left))) (= (get left n) (get right n)))) true false)))
...
(define-fun default_initial_assumption1 ((temp___expr_397 us_rep2) (temp___skip_top_level_398 Bool)) Bool (=> (not (= temp___skip_top_level_398 true)) (= (length1 temp___expr_397) 0)))
...
(define-fun bool_eq3 ((a us_rep3) (b us_rep3)) Bool (ite (= (to_rep (rec__use_ordered_sets__my_sets__cursor__node (us_split_fields3 a))) (to_rep (rec__use_ordered_sets__my_sets__cursor__node (us_split_fields3 b)))) true false))
...
(define-fun dynamic_invariant4 ((temp___expr_412 Int) (temp___is_init_408 Bool) (temp___skip_constant_409 Bool) (temp___do_toplevel_410 Bool) (temp___do_typ_inv_411 Bool)) Bool (=> (or (= temp___is_init_408 true) (<= 1 2147483647)) (in_range5 temp___expr_412)))
...
(define-fun default_initial_assumption2 ((temp___expr_420 us_rep4) (temp___skip_top_level_421 Bool)) Bool (=> (not (= temp___skip_top_level_421 true)) (and (= (is_empty1 temp___expr_420) true) (= (length2 temp___expr_420) 0))))
(assert (forall ((container us_rep4)) (forall ((key us_rep3)) (! (=> (= (has_key container key) true) (let ((result (get1 container key))) (and (=> (= (distinct 0 0) true) (and (= result (w_get container (witness container key))) (forall ((k us_rep3)) (=> (= (has_key container k) true) (= (= (bool_eq3 k key) true) (= (witness container key) (witness container k))))))) (dynamic_invariant4 result true false true true)))) :pattern ((get1 container key))))))
...
(define-fun e_is_find ((container us_rep2) (item Int) (position Int)) Bool (and (ite (< 0 position) (e_bigger_than_range container 1 (- position 1) item) (distinct 1 0)) (ite (< position (length1 container)) (e_smaller_than_range container (+ position 1) (length1 container) item) (distinct 1 0))))
...
(assert (forall ((container us_rep)) (! (let ((result (elements container))) (and (and (and (= (length1 result) (length container)) (forall ((temp___435 Int)) (=> (and (in_range4 temp___435) (= (iter_has_element result temp___435) true)) (= (contains (model__ container) (get result temp___435)) true)))) (forall ((item Int)) (=> (and (in_range2 item) (= (contains (model__ container) item) true)) (and (< 0 (find result item)) (= (equivalent_elements (get result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (and (= (find result (get result i)) i) (= (e_is_find result (get result i) i) true)))))) :pattern ((elements container)))))
...
(define-fun dynamic_invariant5 ((temp___expr_323 Int) (temp___is_init_319 Bool) (temp___skip_constant_320 Bool) (temp___do_toplevel_321 Bool) (temp___do_typ_inv_322 Bool)) Bool (=> (or (= temp___is_init_319 true) (<= (- 2147483648) 2147483647)) (in_range6 temp___expr_323)))
...
(assert (forall ((i element_type4)) (and (<= (- 2147483648) (element_typeqtint4 i)) (<= (element_typeqtint4 i) 2147483647))))
...
(define-fun element_type__ref___projection ((a element_type__ref4)) element_type4 (element_type__content4 a))
(define-fun dynamic_invariant6 ((temp___expr_316 Int) (temp___is_init_312 Bool) (temp___skip_constant_313 Bool) (temp___do_toplevel_314 Bool) (temp___do_typ_inv_315 Bool)) Bool (=> (or (= temp___is_init_312 true) (<= (- 2147483648) 2147483647)) (in_range7 temp___expr_316)))
(assert (forall ((e Int)) (! (=> (dynamic_invariant6 e true true true true) (dynamic_invariant6 (f e) true false true true)) :pattern ((f e)))))
(assert (forall ((e Int)) (! (=> (dynamic_invariant6 e true true true true) (= (f e) (ite (and (<= (- 100) e) (<= e 100)) (* e 2) e))) :pattern ((f e)))))
...
(define-fun dynamic_invariant7 ((temp___expr_346 Int) (temp___is_init_342 Bool) (temp___skip_constant_343 Bool) (temp___do_toplevel_344 Bool) (temp___do_typ_inv_345 Bool)) Bool (=> (or (= temp___is_init_342 true) (<= 1 2147483647)) (in_range8 temp___expr_346)))
(assert (forall ((container us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant5 item true true true true) (let ((result (find container item))) (and (=> (< 0 result) (and (<= result (length1 container)) (= (equivalent_elements item (get container result)) true))) (dynamic_invariant result true false true true)))) :pattern ((find container item))))))
(define-fun e_elements_included ((left us_rep2) (right us_rep2)) Bool (ite (forall ((i Int)) (=> (and (<= 1 i) (<= i (length1 left))) (and (< 0 (find right (get left i))) (= (get right (find right (get left i))) (get left i))))) true false))
...
(assert (forall ((left us_rep1) (right us_rep1)) (! (= (= (ole left right) true) (forall ((item Int)) (=> (and (in_range2 item) (= (contains left item) true)) (= (contains right item) true)))) :pattern ((ole left right)))))
...
(assert (forall ((container us_rep1)) (! (let ((result (is_empty container))) (and (= (= result true) (forall ((item Int)) (not (and (in_range2 item) (= (contains container item) true))))) (= (= result true) (= (length3 container) 0)))) :pattern ((is_empty container)))))
(assert (forall ((left us_rep1) (right us_rep1)) (forall ((item Int)) (! (=> (dynamic_invariant1 item true true true true) (= (= (included_except left right item) true) (forall ((e Int)) (=> (and (in_range2 e) (= (contains left e) true)) (or (= (contains right e) true) (= (equivalent_elements e item) true)))))) :pattern ((included_except left right item))))))
...
(assert (forall ((container us_rep4)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant witness1 true true true true) (= (has_witness container witness1) true)) (dynamic_invariant4 (w_get container witness1) true false true true)) :pattern ((w_get container witness1))))))
(declare-const cu__split_fields count_type)
(declare-const use_ordered_sets__apply_f__cu__assume count_type)
(declare-const temp___726 count_type)
(declare-const temp___7261 us_main_type)
(declare-const temp___725 count_type)
(declare-const o Int)
(declare-const o1 Int)
(declare-const temp___724 count_type)
(declare-const o2 Bool)
(declare-const temp___736 us_rep2)
(declare-const temp___735 Int)
(declare-const o3 Bool)
(declare-const o4 Bool)
(declare-const g Int)
(declare-const temp___738 us_rep2)
(declare-const temp___737 Int)
...
(define-fun temp___7241 () us_rep3 (mk___rep1 (mk___split_fields1 temp___724)))
(define-fun use_ordered_sets__apply_f__cu__assume1 () us_rep3 (mk___rep1 (mk___split_fields1 use_ordered_sets__apply_f__cu__assume)))
(assert (<= (length s) (to_rep (rec__use_ordered_sets__my_sets__set__capacity r__split_discrs))))
(assert (and (= use_ordered_sets__apply_f__cu__assume1 (first s)) (ite (= (= (length s) 0) true) (= (bool_eq3 use_ordered_sets__apply_f__cu__assume1 no_element) true) (and (= (has_key (positions s) use_ordered_sets__apply_f__cu__assume1) true) (= (get1 (positions s) use_ordered_sets__apply_f__cu__assume1) 1)))))
...
(assert (and (= result1 (has_key (positions s) (mk___rep1 cu__split_fields11))) (= (= result1 true) (= (has_key (positions s) (mk___rep1 cu__split_fields11)) true))))
(assert (=> (= result1 true) (and (= r__split_discrs (mk___split_discrs temp___726)) (= temp___7261 r__split_fields))))
(assert (=> (= result1 true) (= temp___725 cu__split_fields1)))
(assert (=> (= result1 true) (<= (length (mk___rep r__split_discrs r__split_fields10)) (- (get1 (positions s) (mk___rep1 cu__split_fields10)) 1))))
(assert (=> (= result1 true) (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields10)) 1))) (= (contains (model__ (mk___rep r__split_discrs r__split_fields10)) (f (get (elements s) i))) true)))))
(assert (=> (= result1 true) (forall ((g1 Int)) (=> (and (in_range2 g1) (= (contains (model__ (mk___rep r__split_discrs r__split_fields10)) g1) true)) (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields10)) 1))) (= g1 (f (get (elements s) i)))))))))
(assert (=> (= result1 true) (and (= o (element s (mk___rep1 cu__split_fields10))) (and (in_range6 o) (= o (get (elements s) (get1 (positions s) (mk___rep1 cu__split_fields10))))))))
(assert (=> (= result1 true) (and (= o1 (f o)) (and (in_range7 o1) (= o1 (ite (and (<= (- 100) o) (<= o 100)) (* o 2) o))))))
(assert (=> (= result1 true) (and (= (contains (model__ (mk___rep r__split_discrs r__split_fields9)) o1) true) (ite (= (contains (model__ (mk___rep r__split_discrs r__split_fields10)) o1) true) (and (and (and (= (oeq2 (model__ (mk___rep r__split_discrs r__split_fields10)) (model__ (mk___rep r__split_discrs r__split_fields9))) true) (= (oeq3 (positions (mk___rep r__split_discrs r__split_fields9)) (positions (mk___rep r__split_discrs r__split_fields10))) true)) (= (get (elements (mk___rep r__split_discrs r__split_fields9)) (find (elements (mk___rep r__split_discrs r__split_fields9)) o1)) o1)) (= (equal_except (elements (mk___rep r__split_discrs r__split_fields10)) (elements (mk___rep r__split_discrs r__split_fields9)) (find (elements (mk___rep r__split_discrs r__split_fields9)) o1)) true)) (and (and (and (and (and (and (= (length (mk___rep r__split_discrs r__split_fields9)) (+ (length (mk___rep r__split_discrs r__split_fields10)) 1)) (= (ole (model__ (mk___rep r__split_discrs r__split_fields10)) (model__ (mk___rep r__split_discrs r__split_fields9))) true)) (= (included_except (model__ (mk___rep r__split_discrs r__split_fields9)) (model__ (mk___rep r__split_discrs r__split_fields10)) o1) true)) (= (get (elements (mk___rep r__split_discrs r__split_fields9)) (find (elements (mk___rep r__split_discrs r__split_fields9)) o1)) o1)) (= (range_equal (elements (mk___rep r__split_discrs r__split_fields10)) (elements (mk___rep r__split_discrs r__split_fields9)) 1 (- (find (elements (mk___rep r__split_discrs r__split_fields9)) o1) 1)) true)) (= (range_shifted (elements (mk___rep r__split_discrs r__split_fields10)) (elements (mk___rep r__split_discrs r__split_fields9)) (find (elements (mk___rep r__split_discrs r__split_fields9)) o1) (length (mk___rep r__split_discrs r__split_fields10)) 1) true)) (= (p_positions_shifted (positions (mk___rep r__split_discrs r__split_fields10)) (positions (mk___rep r__split_discrs r__split_fields9)) (find (elements (mk___rep r__split_discrs r__split_fields9)) o1) 1) true))))))
(assert (=> (= result1 true) (and (= temp___7241 (next s (mk___rep1 cu__split_fields10))) (ite (= (ite (= (bool_eq3 (mk___rep1 cu__split_fields10) no_element) false) (= (get1 (positions s) (mk___rep1 cu__split_fields10)) (length s)) true) true) (= (bool_eq3 temp___7241 no_element) true) (and (= (has_key (positions s) temp___7241) true) (= (get1 (positions s) temp___7241) (+ (get1 (positions s) (mk___rep1 cu__split_fields10)) 1)))))))
(assert (=> (= result1 true) (= result2 cu__split_fields2)))
(assert (=> (= result1 true) (= cu__split_fields3 (mk___split_fields1 temp___724))))
(assert (=> (= result1 true) (and (= o2 (has_key (positions s) (mk___rep1 cu__split_fields3))) (= (= o2 true) (= (has_key (positions s) (mk___rep1 cu__split_fields3)) true)))))
...
(assert (and (= temp___736 (elements (mk___rep r__split_discrs (us_split_fields__content r__split_fields7)))) (and (and (and (= (length1 temp___736) (length (mk___rep r__split_discrs (us_split_fields__content r__split_fields7)))) (forall ((temp___432 Int)) (=> (and (in_range4 temp___432) (= (iter_has_element temp___736 temp___432) true)) (= (contains (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) (get temp___736 temp___432)) true)))) (forall ((item Int)) (=> (and (in_range2 item) (= (contains (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) item) true)) (and (< 0 (find temp___736 item)) (= (equivalent_elements (get temp___736 (find temp___736 item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))))) (and (= (find temp___736 (get temp___736 i)) i) (= (e_is_find temp___736 (get temp___736 i) i) true)))))))
(assert (and (= o3 (iter_has_element temp___736 temp___735)) (= (= o3 true) (and (<= 1 temp___735) (<= temp___735 (last temp___736))))))
(assert (= (= o4 true) (in_range4 temp___735)))
(assert (= result4 (ite (= o4 true) o3 false)))
(assert (= result4 true))
(assert (and (= g (get temp___736 temp___735)) (in_range3 g)))
(assert (and (= temp___738 (elements s)) (and (and (and (= (length1 temp___738) (length s)) (forall ((temp___432 Int)) (=> (and (in_range4 temp___432) (= (iter_has_element temp___738 temp___432) true)) (= (contains (model__ s) (get temp___738 temp___432)) true)))) (forall ((item Int)) (=> (and (in_range2 item) (= (contains (model__ s) item) true)) (and (< 0 (find temp___738 item)) (= (equivalent_elements (get temp___738 (find temp___738 item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length s))) (and (= (find temp___738 (get temp___738 i)) i) (= (e_is_find temp___738 (get temp___738 i) i) true)))))))
(assert (and (= o5 (iter_has_element temp___738 temp___737)) (= (= o5 true) (and (<= 1 temp___737) (<= temp___737 (last temp___738))))))
(assert (= (= o6 true) (in_range4 temp___737)))
(assert (= result5 (ite (= o6 true) o5 false)))
(assert (= result5 true))
(assert (not (<= temp___737 (last temp___738))))
(check-sat)
(exit)
