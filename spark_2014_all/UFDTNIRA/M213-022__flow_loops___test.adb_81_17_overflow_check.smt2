...
(assert (=> (= d1 1) (= y6 (mk_int__ref y1))))
(assert (=> (= d1 1) (= x6 (mk_int__ref x1))))
(assert (=> (= d1 1) (= w6 (mk_int__ref w))))
(assert (=> (= d1 1) (= q6 (mk_int__ref q))))
(assert (=> (= d1 1) (= d6 (mk_int__ref d1))))
(assert (=> (= d1 1) (= c6 (mk_int__ref c1))))
(assert (=> (= d1 1) (= y7 y1)))
(assert (=> (= d1 1) (= x7 x1)))
(assert (=> (= d1 1) (= w7 w1)))
(assert (=> (= d1 1) (= q7 q1)))
