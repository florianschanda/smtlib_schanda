...
(declare-fun user_eq1 (advancemodes advancemodes) Bool)
(declare-const dummy1 advancemodes)
...
(define-fun dynamic_invariant1 ((temp___expr_177 Int) (temp___is_init_174 Bool) (temp___skip_constant_175 Bool) (temp___do_toplevel_176 Bool)) Bool (=> (or (= temp___is_init_174 true) (<= 0 1)) (in_range1 temp___expr_177)))
