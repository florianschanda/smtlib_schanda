...
(define-fun dynamic_invariant1 ((temp___expr_135 Int) (temp___is_init_132 Bool) (temp___skip_constant_133 Bool) (temp___do_toplevel_134 Bool)) Bool (and (=> (or (= temp___is_init_132 true) (<= (- 2147483648) 2147483647)) (in_range1 temp___expr_135)) (=> (= temp___do_toplevel_134 true) (=> (= temp___is_init_132 true) (= (mod2 temp___expr_135 2) 0)))))
(define-fun dynamic_predicate ((temp___139 Int)) Bool (= (mod2 temp___139 2) 0))
...
(declare-const x__split_fields2 even)
(declare-const x__split_fields3 even)
(assert (dynamic_invariant1 i7s true false true))
(assert (dynamic_invariant2 (mk___rep (mk___split_fields x__split_fields x__split_fields1)) true false true))
(assert (in_range a))
(assert (in_range b))
(assert (not (= (mod2 a 2) 0)))
(check-sat)
(exit)
