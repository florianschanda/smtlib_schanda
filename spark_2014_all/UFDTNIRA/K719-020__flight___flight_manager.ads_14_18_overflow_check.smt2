...
(assert (=> (not (< target_x position_x)) (=> (< position_x target_x) (= result1 result____split_fields11))))
...
(assert (=> (< c4b 10) (= temp___174 o16)))
(assert (=> (< c4b 10) (= temp___1741 o17)))
(assert (=> (< c4b 10) (= result4 (mk___split_fields__ref result____split_fields5))))
(assert (=> (< c4b 10) (= result____split_fields7 (mk___split_fields temp___174 temp___1741))))
...
(assert (=> (< c7b 10) (and (= o19 (* (to_rep (rec__flight_manager__engine_values__y_speed result____split_fields7)) c7b)) (in_range1 (* (to_rep (rec__flight_manager__engine_values__y_speed result____split_fields7)) c7b)))))
(assert (=> (< c7b 10) (= o20 (div1 o19 10))))
(assert (=> (< c7b 10) (= (to_rep o21) o20)))
(assert (=> (< c7b 10) (= (rec__flight_manager__engine_values__x_speed result____split_fields7) o22)))
(assert (=> (< c7b 10) (= o21 o23)))
(assert (=> (< c7b 10) (= temp___176 (mk___rep (mk___split_fields o22 o23)))))
(assert (=> (< c7b 10) (= result5 (mk___split_fields__ref result____split_fields7))))
(assert (=> (< c7b 10) (= result____split_fields8 (us_split_fields1 temp___176))))
(assert (=> (not (< c7b 10)) (= result____split_fields8 result____split_fields7)))
...
(assert (not (in_range1 (+ position_y (to_rep (rec__flight_manager__engine_values__y_speed (us_split_fields1 (engine_values__content flight_manager__set_engine_speed__result5))))))))
(check-sat)
(exit)
