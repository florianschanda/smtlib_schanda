...
(assert (and (= o26 (length s)) (and (in_range1 o26) (<= o26 (to_rep (rec__use_ordered_maps__my_maps__map__capacity (us_split_discrs1 s)))))))
...
(assert (and (= o25 (get1 o24 (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range5 o25) (=> (= (of_int 0) true) (and (= o25 (w_get o24 (witness o24 (mk___rep1 (mk___split_fields1 cu__split_fields2))))) (forall ((k4 us_rep1)) (=> (= (has_key1 o24 k4) true) (= (= (bool_eq1 k4 (mk___rep1 (mk___split_fields1 cu__split_fields2))) true) (= (witness o24 (mk___rep1 (mk___split_fields1 cu__split_fields2))) (witness o24 k4))))))))))
(assert (= o28 (ite (<= o25 i2) true false)))
(assert (= result6 (ite (= o28 true) o27 false)))
(assert (= result6 true))
(assert (not (in_range3 i2)))
(check-sat)
(exit)
