...
(declare-const temp___1353 int__ref)
...
(declare-const lower8 int__ref)
(declare-const upper9 int__ref)
(declare-const middle7 int__ref)
(declare-const lower9 Int)
(declare-const upper10 Int)
(declare-const middle8 Int)
(declare-const lower10 int__ref)
(declare-const upper11 int__ref)
(declare-const middle9 int__ref)
(declare-const lower11 Int)
(declare-const upper12 Int)
...
(assert (= lower1 0))
(assert (=> (<= 46341 n) (= (mk_int__ref result1) (mk_int__ref upper))))
(assert (=> (<= 46341 n) (= upper1 46341)))
(assert (=> (not (<= 46341 n)) (and (= o (+ n 1)) (in_range1 (+ n 1)))))
(assert (=> (not (<= 46341 n)) (= (mk_int__ref result2) (mk_int__ref upper))))
(assert (=> (not (<= 46341 n)) (= upper2 o)))
(assert (=> (not (<= 46341 n)) (= upper1 upper2)))
(assert (and (and (= temp___134 upper1) (and (= temp___133 lower1) (and (= temp___132 middle) (and (= 0 temp___136) (and (= 0 temp___135) (and (and (and (and (and (<= 0 lower2) (<= upper3 46341)) (< lower2 upper3)) (< n (* upper3 upper3))) (<= (* lower2 lower2) n)) (and (and (and (=> (<= 0 2147483647) (in_range2 middle1)) (=> (<= 0 2147483647) (in_range2 lower2))) (=> (<= 0 2147483647) (in_range2 upper3))) (and (and (= temp___1361 result3) (= temp___1362 lower2)) (and (and (= temp___1351 result4) (= temp___1352 upper3)) (and (and (and (= middle1 middle3) (and (= upper3 upper5) (= lower2 lower4))) (and (= middle4 middle1) (and (= upper6 upper3) (= lower5 lower2)))) (and (and (and (= o4 (+ lower2 1)) (in_range1 (+ lower2 1))) (= result5 (ite (= o4 upper3) true false))) (= result5 true)))))))))))) (and (and (= middle7 (mk_int__ref middle3)) (and (= upper9 (mk_int__ref upper5)) (= lower8 (mk_int__ref lower4)))) (and (= middle8 middle4) (and (= upper10 upper6) (= lower9 lower5))))))
(assert (= middle9 middle7))
(assert (= upper11 upper9))
(assert (= lower10 lower8))
(assert (= middle10 middle8))
(assert (= upper12 upper10))
...
(assert (= result10 (mk_int__ref loop_tutorial__isqrt__result)))
(assert (= loop_tutorial__isqrt__result1 (int__content lower10)))
(assert (= loop_tutorial__isqrt__result4 loop_tutorial__isqrt__result2))
(assert (= middle11 middle9))
(assert (= upper13 upper11))
(assert (= lower12 lower10))
(assert (= loop_tutorial__isqrt__result5 loop_tutorial__isqrt__result3))
(assert (= middle12 middle10))
(assert (= upper14 upper12))
(assert (= lower13 lower11))
(assert (and (= o9 (+ (int__content loop_tutorial__isqrt__result4) 1)) (in_range1 (+ (int__content loop_tutorial__isqrt__result4) 1))))
(assert (and (= o10 (+ (int__content loop_tutorial__isqrt__result4) 1)) (in_range1 (+ (int__content loop_tutorial__isqrt__result4) 1))))
(assert (= o11 (* o10 o9)))
