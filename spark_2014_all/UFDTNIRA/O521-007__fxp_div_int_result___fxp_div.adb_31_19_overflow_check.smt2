...
(assert (and (< 0 right) (and (< (to_fixed time_span_zero) (to_fixed left)) (<= (fxp_div_result_int (to_fixed left) 1) (div1 9223372036854775807 right)))))
(assert (not (in_range1 (* (to_fixed left) right))))
(check-sat)
(exit)
