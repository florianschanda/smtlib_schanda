...
(assert (forall ((x even)) (! (in_range2 (to_rep x)) :pattern ((to_rep x)))))
...
(define-fun dynamic_invariant2 ((temp___expr_135 Int) (temp___is_init_132 Bool) (temp___skip_constant_133 Bool) (temp___do_toplevel_134 Bool)) Bool (and (=> (or (= temp___is_init_132 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_135)) (=> (= temp___do_toplevel_134 true) (=> (= temp___is_init_132 true) (= (mod2 temp___expr_135 2) 0)))))
...
(declare-const temp___231 even)
(declare-const temp___2311 even)
...
(assert (in_range1 a))
(assert (in_range1 b))
(assert (and (in_range2 a) (= (mod2 a 2) 0)))
