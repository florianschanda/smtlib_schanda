...
(define-fun default_initial_assumption ((temp___expr_136 us_rep) (temp___skip_top_level_137 Bool)) Bool (and (= (attr__tag temp___expr_136) us_tag) (and (and (= (to_rep1 (rec__object__t__area (us_split_fields1 temp___expr_136))) (- 1)) (= (to_rep1 (rec__object__t__max_width (us_split_fields1 temp___expr_136))) (- 1))) (= (to_rep1 (rec__object__t__max_height (us_split_fields1 temp___expr_136))) (- 1)))))
...
(define-fun default_initial_assumption1 ((temp___expr_149 us_rep1) (temp___skip_top_level_150 Bool)) Bool (and (= (attr__tag1 temp___expr_149) us_tag1) (and (and (= (to_rep1 (rec__object__t__area1 (us_split_fields3 temp___expr_149))) (- 1)) (= (to_rep1 (rec__object__t__max_width1 (us_split_fields3 temp___expr_149))) (- 1))) (= (to_rep1 (rec__object__t__max_height1 (us_split_fields3 temp___expr_149))) (- 1)))))
...
(assert (= result true))
(assert (not (in_range (* (to_rep rec____split_fields) (to_rep rec____split_fields1)))))
(check-sat)
(exit)
