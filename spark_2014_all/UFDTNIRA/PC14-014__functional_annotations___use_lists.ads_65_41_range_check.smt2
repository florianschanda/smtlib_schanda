...
(assert (and (= o10 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i)) (in_range4 o10)))
...
(assert (and (= o11 (get o7 o9)) (in_range4 o11)))
(assert (= o12 (ite (= o11 o10) true false)))
(assert (and (= o6 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i)) (in_range4 o6)))
