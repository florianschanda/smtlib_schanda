...
(assert (and (= o10 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i)) (in_range2 o10)))
(assert (and (= o8 (* 2 i)) (in_range6 (* 2 i))))
...
(assert (and (= o11 (get o7 o9)) (in_range2 o11)))
