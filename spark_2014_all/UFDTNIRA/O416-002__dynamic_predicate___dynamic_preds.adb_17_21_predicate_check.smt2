...
(define-fun dynamic_invariant1 ((temp___expr_158 Int) (temp___is_init_154 Bool) (temp___skip_constant_155 Bool) (temp___do_toplevel_156 Bool) (temp___do_typ_inv_157 Bool)) Bool (and (=> (or (= temp___is_init_154 true) (<= (- 2147483648) 2147483647)) (in_range1 temp___expr_158)) (=> (= temp___do_toplevel_156 true) (=> (= temp___is_init_154 true) (= (mod2 temp___expr_158 2) 0)))))
...
(assert (= result x))
(assert (= x1 o))
(assert (and (and (in_range1 dynamic_preds__init_ok_even__x) (= (mod2 dynamic_preds__init_ok_even__x 2) 0)) (in_range dynamic_preds__init_ok_even__x)))
