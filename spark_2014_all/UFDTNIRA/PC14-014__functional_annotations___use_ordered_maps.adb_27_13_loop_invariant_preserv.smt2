...
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields4)) 1))) (let ((temp___687 (keys (mk___rep r__split_discrs r__split_fields4)))) (exists ((temp___686 Int)) (and (and (in_range3 temp___686) (= (iter_has_element temp___687 temp___686) true)) (= (get2 (model__ (mk___rep r__split_discrs r__split_fields4)) (get temp___687 temp___686)) (f (get2 (model__ s) (get (keys s) i))))))))))
(assert (let ((temp___693 (keys (mk___rep r__split_discrs r__split_fields4)))) (forall ((temp___692 Int)) (=> (and (in_range3 temp___692) (= (iter_has_element temp___693 temp___692) true)) (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields4)) 1))) (= (get2 (model__ (mk___rep r__split_discrs r__split_fields4)) (get temp___693 temp___692)) (f (get2 (model__ s) (get (keys s) i))))))))))
...
(assert (and (= temp___6771 (next s (mk___rep1 cu__split_fields4))) (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields4) no_element) false) (= (get1 (positions s) (mk___rep1 cu__split_fields4)) (length s)) true) true) (= (bool_eq1 temp___6771 no_element) true) (and (= (has_key1 (positions s) temp___6771) true) (= (get1 (positions s) temp___6771) (+ (get1 (positions s) (mk___rep1 cu__split_fields4)) 1))))))
(assert (= result2 cu__split_fields2))
(assert (= cu__split_fields3 (mk___split_fields1 temp___677)))
...
(define-fun temp___687 () us_rep3 (keys (mk___rep r__split_discrs r__split_fields3)))
(assert (not (exists ((temp___686 Int)) (and (and (in_range3 temp___686) (= (iter_has_element temp___687 temp___686) true)) (= (get2 (model__ (mk___rep r__split_discrs r__split_fields3)) (get temp___687 temp___686)) (f (get2 (model__ s) (get (keys s) i))))))))
(check-sat)
(exit)
