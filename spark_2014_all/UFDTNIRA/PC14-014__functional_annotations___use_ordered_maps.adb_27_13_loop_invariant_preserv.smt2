...
(assert (and (= o33 (element s (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range7 o33) (= o33 (get2 (model__ s) (key s (mk___rep1 (mk___split_fields1 cu__split_fields2))))))))
(assert (and (= o34 (f o33)) (and (in_range8 o34) (= o34 (ite (and (<= (- 100) o33) (<= o33 100)) (* o33 2) o33)))))
(assert (and (= o32 (key s (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range6 o32) (= o32 (get (keys s) (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))))))))
...
(assert (= result7 cu__split_fields2))
(assert (= cu__split_fields3 (mk___split_fields1 temp___634)))
(assert (and (= o35 (has_key1 (positions s) (mk___rep1 cu__split_fields3))) (= (= o35 true) (= (has_key1 (positions s) (mk___rep1 cu__split_fields3)) true))))
(assert (= result8 (ite (not (= o35 true)) true false)))
(assert (not (= result8 true)))
(declare-const i3 Int)
(assert (<= 1 i3))
(assert (<= i3 (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1)))
(assert (not (exists ((temp___643 Int)) (and (and (in_range3 temp___643) (= (iter_has_element (keys (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) temp___643) true)) (= (get2 (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) (get (keys (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) temp___643)) (f (get2 (model__ s) (get (keys s) i3))))))))
(check-sat)
(exit)
