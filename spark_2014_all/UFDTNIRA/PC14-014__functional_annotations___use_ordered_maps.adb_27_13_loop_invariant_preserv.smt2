...
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields4)) 1))) (let ((temp___644 (keys (mk___rep r__split_discrs r__split_fields4)))) (exists ((temp___643 Int)) (and (and (in_range3 temp___643) (= (iter_has_element temp___644 temp___643) true)) (= (get2 (model__ (mk___rep r__split_discrs r__split_fields4)) (get temp___644 temp___643)) (f (get2 (model__ s) (get (keys s) i))))))))))
(assert (let ((temp___650 (keys (mk___rep r__split_discrs r__split_fields4)))) (forall ((temp___649 Int)) (=> (and (in_range3 temp___649) (= (iter_has_element temp___650 temp___649) true)) (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields4)) 1))) (= (get2 (model__ (mk___rep r__split_discrs r__split_fields4)) (get temp___650 temp___649)) (f (get2 (model__ s) (get (keys s) i))))))))))
...
(define-fun temp___644 () us_rep3 (keys (mk___rep r__split_discrs r__split_fields3)))
(assert (not (exists ((temp___643 Int)) (and (and (in_range3 temp___643) (= (iter_has_element temp___644 temp___643) true)) (= (get2 (model__ (mk___rep r__split_discrs r__split_fields3)) (get temp___644 temp___643)) (f (get2 (model__ s) (get (keys s) i))))))))
(check-sat)
(exit)
