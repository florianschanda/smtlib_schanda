...
(assert (in_range2 sc))
(assert (and (= o1 (* 3 9223372036)) (in_range3 (* 3 9223372036))))
(assert (= o2 (ite (<= sc o1) true false)))
(assert (and (= o (* 3 (- 9223372036))) (in_range3 (* 3 (- 9223372036)))))
(assert (= o3 (ite (<= o sc) true false)))
(assert (= result (ite (= o3 true) o2 false)))
(assert (= result true))
(assert (not (in_range3 (+ 9223372036 1))))
(check-sat)
(exit)
