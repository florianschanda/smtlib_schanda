...
(declare-const a__split_fields1 natural)
(declare-const o integer)
(declare-const o1 integer)
(declare-const o2 integer)
(declare-const o3 natural)
(declare-const temp___277 Bool)
(declare-const temp___2771 integer)
(declare-const temp___2772 integer)
(declare-const temp___2773 natural)
(assert (and (= (distinct 1 0) (rec__formals_rec_split_pred__rec__d (us_split_discrs1 i3b))) (not (= (to_rep1 (rec__formals_rec_split_pred__rec__h (us_split_fields1 i3b))) 0))))
(assert (and (= (distinct 1 0) (rec__formals_rec_split_pred__rec__d a__split_discrs)) (not (= (to_rep1 a__split_fields1) 0))))
(assert (= (to_rep o) (div1 (to_rep a__split_fields) (to_rep1 a__split_fields1))))
(assert (= o o1))
(assert (= a__split_fields o2))
(assert (= a__split_fields1 o3))
(assert (= a__split_discrs (mk___split_discrs temp___277)))
(assert (= temp___2771 o1))
(assert (= temp___2772 o2))
(assert (= temp___2773 o3))
(assert (not (not (= (to_rep1 temp___2773) 0))))
(check-sat)
(exit)
