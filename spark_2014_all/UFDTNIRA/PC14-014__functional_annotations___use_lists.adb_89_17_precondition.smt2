...
(assert (and (= o3 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2)))) (= (length1 o3) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields2))))))
(assert (not (<= 1 i1)))
(check-sat)
(exit)
