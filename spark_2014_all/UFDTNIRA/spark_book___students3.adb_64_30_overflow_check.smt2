...
(assert (and (and (and (<= 0 (to_fixed tuition)) (<= (to_fixed tuition) 3000000)) (and (<= 0 (to_fixed insurance2)) (<= (to_fixed insurance2) 100000))) (and (<= 10000 (to_fixed fees)) (<= (to_fixed fees) 750000))))
(assert (<= 384 (to_fixed1 (rec__students3__student_record__gpa (us_split_fields3 student)))))
(assert (= (to_fixed o2) (+ (to_fixed grants1) 25000)))
(assert (= grants1 result2))
(assert (= grants2 o2))
(assert (<= 480 (to_fixed1 (rec__students3__student_record__gpa (us_split_fields3 student)))))
(assert (= (to_rep (rec__students3__student_record__gender (us_split_fields3 student))) 1))
(assert (not (in_range5 (+ (to_fixed grants2) 25000))))
(check-sat)
(exit)
