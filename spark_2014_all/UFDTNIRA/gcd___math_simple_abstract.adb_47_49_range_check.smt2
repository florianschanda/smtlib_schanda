...
(assert (forall ((x1 Int)) (=> (and (<= c2 x1) (<= x1 (ite (< a b) a b))) (not (and (= (divides x1 a) true) (= (divides x1 b) true))))))
(assert (=> (<= 1 2147483647) (in_range1 c2)))
(assert (<= c2 x))
(assert (<= x (ite (< a b) a b)))
(assert (and (= o1 x) (in_range1 x)))
(assert (and (= o2 (divides o1 b)) (= (= o2 true) (exists ((c3 Int)) (and (and (<= 1 c3) (<= c3 2147483647)) (= (* o1 c3) b))))))
