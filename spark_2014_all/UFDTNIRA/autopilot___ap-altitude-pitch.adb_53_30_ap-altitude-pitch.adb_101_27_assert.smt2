...
(assert (=> (not (< 1000 c13b)) (=> (< c13b (- 1000)) (= result6 floor_climb_rate))))
(assert (=> (not (< 1000 c13b)) (=> (< c13b (- 1000)) (= floor_climb_rate2 (- 1000)))))
(assert (=> (not (< 1000 c13b)) (=> (not (< c13b (- 1000))) (and (= o2 c13b) (in_range8 c13b)))))
(assert (=> (not (< 1000 c13b)) (=> (not (< c13b (- 1000))) (= result7 floor_climb_rate))))
(assert (=> (not (< 1000 c13b)) (=> (not (< c13b (- 1000))) (= floor_climb_rate3 o2))))
(assert (=> (not (< 1000 c13b)) (=> (not (< c13b (- 1000))) (= floor_climb_rate2 floor_climb_rate3))))
(assert (=> (not (< 1000 c13b)) (= floor_climb_rate1 floor_climb_rate2)))
(assert (not (in_range8 floor_climb_rate1)))
(check-sat)
(exit)
