...
(assert (= result3 true))
(assert (= temp___797 (length (mk___rep s__split_discrs (mk___split_fields s__split_fields)))))
(assert (= temp___792 cu__split_fields1))
(assert (= temp___795 (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields)))))
(assert (= temp___793 (length (mk___rep s__split_discrs (mk___split_fields s__split_fields)))))
(assert (= temp___796 (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields)))))
(assert (= temp___798 (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields)))))
(assert (= temp___794 (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields)))))
(assert (and (= s__split_discrs (mk___split_discrs temp___791)) (= s__split_fields temp___7911)))
(assert (= temp___790 n1))
(assert (= (length (mk___rep s__split_discrs s__split_fields2)) (+ temp___793 n2)))
(assert (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 n2)) (and (= (get (elements (mk___rep s__split_discrs s__split_fields2)) (* 2 i4)) (+ (get temp___794 i4) 1)) (= (get (elements (mk___rep s__split_discrs s__split_fields2)) (- (* 2 i4) 1)) (get temp___795 i4))))))
(assert (forall ((i4 Int)) (=> (and (<= (+ (* 2 n2) 1) i4) (<= i4 (length (mk___rep s__split_discrs s__split_fields2)))) (= (get (elements (mk___rep s__split_discrs s__split_fields2)) i4) (get temp___796 (- i4 n2))))))
(assert (forall ((i4 Int)) (=> (and (<= (+ n2 1) i4) (<= i4 temp___797)) (= (get (elements (mk___rep s__split_discrs s__split_fields2)) (+ i4 n2)) (get temp___798 i4)))))
...
(assert (= s__split_fields4 (mk___split_fields__ref s__split_fields3)))
(assert (= n5 n3))
