...
(assert (= temp___1881 result3))
(assert (= temp___1882 k12))
...
(assert (=> (not (= (mod1 k12 2) 0)) (and (= o2 (- k12 1)) (in_range2 (- k12 1)))))
(assert (=> (not (= (mod1 k12 2) 0)) (= k12 result6)))
(assert (=> (not (= (mod1 k12 2) 0)) (= k14 o2)))
(assert (=> (not (= (mod1 k12 2) 0)) (and (= o3 (* b12 p12)) (in_range1 (* b12 p12)))))
(assert (=> (not (= (mod1 k12 2) 0)) (= p12 result7)))
(assert (=> (not (= (mod1 k12 2) 0)) (= p13 o3)))
(assert (=> (not (= (mod1 k12 2) 0)) (= k13 k14)))
(assert (=> (not (= (mod1 k12 2) 0)) (= b13 b12)))
(assert (< 0 k13))
(assert (not (< k13 temp___1882)))
(check-sat)
(exit)
