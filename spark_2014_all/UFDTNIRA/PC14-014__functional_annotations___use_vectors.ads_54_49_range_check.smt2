...
(assert (and (= o6 (get (model__ (mk___rep v__split_discrs (us_split_fields__content v__split_fields8))) o3)) (and (in_range4 o6) (= o6 (get (model__ (mk___rep v__split_discrs (us_split_fields__content v__split_fields8))) o3)))))
