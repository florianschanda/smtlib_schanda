...
(assert (forall ((x Int)) (! (ite (= x 0) (= (to_int3 x) 0) (ite (< 0 x) (pos_div_relation1 (to_int3 x) x 1000000000) (pos_div_relation1 (- (to_int3 x)) (- x) 1000000000))) :pattern ((to_int3 x)))))
...
(define-fun in_range3 ((x Int)) Bool (and (<= (- 10000000000) x) (<= x 10000000000)))
...
(assert (forall ((x Int)) (forall ((y Int)) (! (ite (or (= x 0) (= y 0)) (= (fxp_mult2 x y) 0) (ite (or (and (< 0 x) (< 0 y)) (and (< x 0) (< y 0))) (pos_div_relation2 (fxp_mult2 x y) (* x y) 1000000000) (pos_div_relation2 (- (fxp_mult2 x y)) (- (* x y)) 1000000000))) :pattern ((fxp_mult2 x y))))))
(declare-fun fxp_div2 (Int Int) Int)
(assert (forall ((x Int)) (forall ((y Int)) (! (ite (= x 0) (= (fxp_div2 x y) 0) (ite (and (< 0 x) (< 0 y)) (pos_div_relation2 (fxp_div2 x y) (* x 1000000000) y) (ite (and (< x 0) (< y 0)) (pos_div_relation2 (fxp_div2 x y) (* (- x) 1000000000) (- y)) (ite (and (< x 0) (< 0 y)) (pos_div_relation2 (- (fxp_div2 x y)) (* (- x) 1000000000) y) (=> (and (< 0 x) (< y 0)) (pos_div_relation2 (- (fxp_div2 x y)) (* x 1000000000) (- y))))))) :pattern ((fxp_div2 x y))))))
...
(assert (forall ((x Int)) (! (ite (= x 0) (= (to_int4 x) 0) (ite (< 0 x) (pos_div_relation2 (to_int4 x) x 1000000000) (pos_div_relation2 (- (to_int4 x)) (- x) 1000000000))) :pattern ((to_int4 x)))))
...
(declare-const o1 my_subduration)
(declare-const result my_duration)
(declare-const md1 my_duration)
(declare-const result1 my_subduration)
...
(assert (= result1 ms))
(assert (= ms1 o1))
(assert (not (or (< (to_fixed (of_fixed (to_fixed1 md1))) 0) (< (to_fixed (of_fixed (to_fixed2 ms1))) 0))))
(check-sat)
(exit)
