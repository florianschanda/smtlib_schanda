...
(declare-const temp___527 count_type)
(declare-const temp___528 Int)
(declare-const temp___530 us_rep2)
(declare-const temp___532 us_rep2)
(declare-const temp___529 us_rep2)
(declare-const temp___526 count_type)
(declare-const temp___5261 us_main_type)
...
(assert (and (= (mk___rep1 (mk___split_fields1 use_lists__double_size_2__cu__assume)) (first (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (ite (= (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 0) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 use_lists__double_size_2__cu__assume)) no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 use_lists__double_size_2__cu__assume))) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 use_lists__double_size_2__cu__assume))) 1)))))
...
(assert (= n1 0))
(assert (in_range2 n1))
(assert (and (= result2 (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 cu__split_fields1)))) (= (= result2 true) (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 cu__split_fields1))) true))))
(assert (=> (= result2 true) (= temp___527 cu__split_fields1)))
(assert (=> (= result2 true) (= temp___528 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (=> (= result2 true) (= temp___530 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (=> (= result2 true) (= temp___532 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (=> (= result2 true) (= temp___529 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (=> (= result2 true) (and (= l__split_discrs (mk___split_discrs temp___526)) (= l__split_fields temp___5261))))
(assert (=> (= result2 true) (= temp___525 n1)))
(assert (=> (= result2 true) (= temp___531 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (=> (= result2 true) (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (+ temp___528 n2))))
(assert (=> (= result2 true) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 n2)) (and (= (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (* 2 i3)) (get temp___529 i3)) (= (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (- (* 2 i3) 1)) (get temp___530 i3)))))))
(assert (=> (= result2 true) (forall ((i3 Int)) (=> (and (<= (+ n2 1) i3) (<= i3 temp___531)) (= (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (+ i3 n2)) (get temp___532 i3))))))
(assert (=> (= result2 true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (mk___rep1 (mk___split_fields1 cu__split_fields2))) (+ (* 2 n2) 1))))
(assert (=> (= result2 true) (=> (<= 0 2147483647) (in_range2 n2))))
(assert (=> (= result2 true) (and (= o28 (element (mk___rep l__split_discrs (mk___split_fields l__split_fields2)) (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range6 o28) (= o28 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (mk___rep1 (mk___split_fields1 cu__split_fields2)))))))))
(assert (=> (= result2 true) (and (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (+ (length (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) 1)) (ite (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields2)) no_element) true) (and (and (and (and (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (last1 (mk___rep l__split_discrs (mk___split_fields l__split_fields3)))) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields3)))) (= (keys_included_except (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (last1 (mk___rep l__split_discrs (mk___split_fields l__split_fields3)))) true)) (= (ole1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3)))) true)) (= (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields3)))) o28)) (= (ole (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields3)))) true)) (and (and (and (= (range_equal (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) 1 (- (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1)) true) (= (range_shifted (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (mk___rep1 (mk___split_fields1 cu__split_fields2))) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) 1) true)) (= (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (mk___rep1 (mk___split_fields1 cu__split_fields2)))) o28)) (= (p_positions_shifted (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1) true))))))
(assert (=> (= result2 true) (ite (= (ite (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields2)) no_element) false) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (mk___rep1 (mk___split_fields1 cu__split_fields2))) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields3)))) true) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields3)) no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (mk___rep1 (mk___split_fields1 cu__split_fields3))) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (mk___rep1 (mk___split_fields1 cu__split_fields3))) (+ (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))))))
(assert (=> (= result2 true) (and (= o29 (+ n2 1)) (in_range1 (+ n2 1)))))
(assert (=> (= result2 true) (= result4 (mk_int__ref n2))))
(assert (=> (= result2 true) (= n3 o29)))
(assert (=> (= result2 true) (and (= o30 (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (mk___rep1 (mk___split_fields1 cu__split_fields3)))) (= (= o30 true) (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (mk___rep1 (mk___split_fields1 cu__split_fields3))) true)))))
(assert (=> (= result2 true) (= result5 (ite (not (= o30 true)) true false))))
(assert (=> (= result2 true) (= result5 true)))
(assert (=> (= result2 true) (= n4 (mk_int__ref n3))))
(assert (=> (= result2 true) (= cu__split_fields4 (mk___split_fields__ref1 (mk___split_fields1 cu__split_fields3)))))
(assert (=> (= result2 true) (= l__split_fields4 (mk___split_fields__ref (mk___split_fields l__split_fields3)))))
(assert (=> (= result2 true) (= n5 n3)))
(assert (=> (= result2 true) (= cu__split_fields5 (mk___split_fields1 cu__split_fields3))))
(assert (=> (= result2 true) (= l__split_fields5 (mk___split_fields l__split_fields3))))
...
(assert (=> (not (= result2 true)) (= cu__split_fields6 (mk___split_fields__ref1 (mk___split_fields1 cu__split_fields1)))))
...
(assert (=> (not (= result2 true)) (= cu__split_fields7 (mk___split_fields1 cu__split_fields1))))
...
(assert (<= 1 i2))
(assert (<= i2 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))))
(assert (and (= o42 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i2)) (in_range4 o42)))
(assert (and (= o40 (* 2 i2)) (in_range1 (* 2 i2))))
(assert (and (= o41 o40) (in_range3 o40)))
(assert (and (= o39 (model__ (mk___rep l__split_discrs (us_split_fields__content l__split_fields8)))) (= (length1 o39) (length (mk___rep l__split_discrs (us_split_fields__content l__split_fields8))))))
(assert (and (= o43 (get o39 o41)) (in_range4 o43)))
(assert (= o44 (ite (= o43 o42) true false)))
(assert (and (= o37 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i2)) (in_range4 o37)))
(assert (and (= o33 (* 2 i2)) (in_range1 (* 2 i2))))
(assert (= o34 (- o33 1)))
(assert (and (= o35 o34) (in_range1 o34)))
(assert (and (= o36 o35) (in_range3 o35)))
(assert (and (= o32 (model__ (mk___rep l__split_discrs (us_split_fields__content l__split_fields8)))) (= (length1 o32) (length (mk___rep l__split_discrs (us_split_fields__content l__split_fields8))))))
(assert (not (<= 1 o36)))
(check-sat)
(exit)
