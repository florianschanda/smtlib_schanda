...
(assert (=> (= result2 true) (= (length (mk___rep l__split_discrs l__split_fields11)) (+ temp___528 n2))))
(assert (=> (= result2 true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 n2)) (and (= (get (model__ (mk___rep l__split_discrs l__split_fields11)) (* 2 i1)) (get temp___529 i1)) (= (get (model__ (mk___rep l__split_discrs l__split_fields11)) (- (* 2 i1) 1)) (get temp___530 i1)))))))
(assert (=> (= result2 true) (forall ((i1 Int)) (=> (and (<= (+ n2 1) i1) (<= i1 temp___531)) (= (get (model__ (mk___rep l__split_discrs l__split_fields11)) (+ i1 n2)) (get temp___532 i1))))))
