...
(declare-const temp___573 us_rep2)
(declare-const temp___575 us_rep2)
(declare-const temp___572 us_rep2)
...
(assert (=> (= result2 true) (and (= o (element (mk___rep l__split_discrs l__split_fields11) (mk___rep1 cu__split_fields11))) (and (in_range6 o) (= o (get (model__ (mk___rep l__split_discrs l__split_fields11)) (get1 (positions (mk___rep l__split_discrs l__split_fields11)) (mk___rep1 cu__split_fields11))))))))
(assert (=> (= result2 true) (and (= (length (mk___rep l__split_discrs l__split_fields10)) (+ (length (mk___rep l__split_discrs l__split_fields11)) 1)) (ite (= (bool_eq1 (mk___rep1 cu__split_fields11) no_element) true) (and (and (and (and (= (get1 (positions (mk___rep l__split_discrs l__split_fields10)) (last1 (mk___rep l__split_discrs l__split_fields10))) (length (mk___rep l__split_discrs l__split_fields10))) (= (keys_included_except (positions (mk___rep l__split_discrs l__split_fields10)) (positions (mk___rep l__split_discrs l__split_fields11)) (last1 (mk___rep l__split_discrs l__split_fields10))) true)) (= (ole1 (positions (mk___rep l__split_discrs l__split_fields11)) (positions (mk___rep l__split_discrs l__split_fields10))) true)) (= (get (model__ (mk___rep l__split_discrs l__split_fields10)) (length (mk___rep l__split_discrs l__split_fields10))) o)) (= (ole (model__ (mk___rep l__split_discrs l__split_fields11)) (model__ (mk___rep l__split_discrs l__split_fields10))) true)) (and (and (and (= (range_equal (model__ (mk___rep l__split_discrs l__split_fields11)) (model__ (mk___rep l__split_discrs l__split_fields10)) 1 (- (get1 (positions (mk___rep l__split_discrs l__split_fields11)) (mk___rep1 cu__split_fields11)) 1)) true) (= (range_shifted (model__ (mk___rep l__split_discrs l__split_fields11)) (model__ (mk___rep l__split_discrs l__split_fields10)) (get1 (positions (mk___rep l__split_discrs l__split_fields11)) (mk___rep1 cu__split_fields11)) (length (mk___rep l__split_discrs l__split_fields11)) 1) true)) (= (get (model__ (mk___rep l__split_discrs l__split_fields10)) (get1 (positions (mk___rep l__split_discrs l__split_fields11)) (mk___rep1 cu__split_fields11))) o)) (= (p_positions_shifted (positions (mk___rep l__split_discrs l__split_fields11)) (positions (mk___rep l__split_discrs l__split_fields10)) (get1 (positions (mk___rep l__split_discrs l__split_fields11)) (mk___rep1 cu__split_fields11)) 1) true))))))
(assert (=> (= result2 true) (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields11) no_element) false) (= (get1 (positions (mk___rep l__split_discrs l__split_fields10)) (mk___rep1 cu__split_fields11)) (length (mk___rep l__split_discrs l__split_fields10))) true) true) (= (bool_eq1 (mk___rep1 cu__split_fields10) no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields10)) (mk___rep1 cu__split_fields10)) true) (= (get1 (positions (mk___rep l__split_discrs l__split_fields10)) (mk___rep1 cu__split_fields10)) (+ (get1 (positions (mk___rep l__split_discrs l__split_fields10)) (mk___rep1 cu__split_fields11)) 1))))))
(assert (=> (= result2 true) (and (= o1 (+ n2 1)) (in_range1 (+ n2 1)))))
...
(assert (and (= o12 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i)) (in_range4 o12)))
(assert (and (= o10 (* 2 i)) (in_range1 (* 2 i))))
...
(assert (and (= o13 (get o9 o11)) (in_range4 o13)))
(assert (= o14 (ite (= o13 o12) true false)))
(assert (and (= o8 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i)) (in_range4 o8)))
(assert (and (= o4 (* 2 i)) (in_range1 (* 2 i))))
(assert (= o5 (- o4 1)))
