...
(define-fun temp___750 () us_rep2 (elements (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))))
(declare-const temp___749 Int)
(assert (in_range4 temp___749))
(assert (= (iter_has_element temp___750 temp___749) true))
(define-fun temp___752 () us_rep2 (elements s))
(assert (not (exists ((temp___751 Int)) (and (and (in_range4 temp___751) (= (iter_has_element temp___752 temp___751) true)) (= (get temp___750 temp___749) (f (get temp___752 temp___751)))))))
(check-sat)
(exit)
