...
(assert (= (iter_has_element (elements s) temp___705) true))
(assert (not (= (contains (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) (f (get (elements s) temp___705))) true)))
(check-sat)
(exit)
