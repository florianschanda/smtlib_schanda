...
(define-fun temp___748 () us_rep3 (elements s))
(declare-const temp___747 Int)
(assert (in_range3 temp___747))
(assert (= (iter_has_element temp___748 temp___747) true))
(assert (not (= (contains (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) (f (get temp___748 temp___747))) true)))
(check-sat)
(exit)
