...
(assert (<= 1 i1))
(assert (<= i1 r27b))
(assert (= (has_key (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields3)) true))
...
(assert (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))) (= (get (model__ (mk___rep l__split_discrs l__split_fields3)) i3) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i3)))))
...
(assert (= (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields3)) i2))
(assert (and (=> (<= 1 r27b) (dynamic_property 1 r27b i2)) (and (<= 1 i2) (<= i2 r27b))))
(assert (and (= o1 (element (mk___rep l__split_discrs l__split_fields3) (mk___rep1 cu__split_fields3))) (and (in_range6 o1) (= o1 (get (model__ (mk___rep l__split_discrs l__split_fields3)) (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields3)))))))
...
(assert (not (or (= (has_key (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 cu__split_fields3)) true) (= (bool_eq1 (mk___rep1 cu__split_fields3) no_element) true))))
(check-sat)
(exit)
