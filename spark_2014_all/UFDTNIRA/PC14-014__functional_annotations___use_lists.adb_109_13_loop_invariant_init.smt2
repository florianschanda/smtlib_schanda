...
(assert (<= 1 i3))
(assert (<= i3 n1))
(assert (not (= (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (* 2 i3)) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i3))))
(check-sat)
(exit)
