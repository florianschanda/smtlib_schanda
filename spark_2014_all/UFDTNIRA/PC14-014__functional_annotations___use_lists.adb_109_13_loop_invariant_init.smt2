...
(assert (<= 1 i))
(assert (<= i n1))
(assert (not (= (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (- (* 2 i) 1)) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i))))
(check-sat)
(exit)
