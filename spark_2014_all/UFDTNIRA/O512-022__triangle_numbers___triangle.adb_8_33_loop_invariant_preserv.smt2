...
(assert (and (and (=> (<= 0 2147483647) (in_range2 tmp3)) (=> (<= 1 n) (dynamic_property 1 n i2))) (and (<= 1 i2) (<= i2 n))))
(assert (not (= i2 n)))
(assert (= i2 result3))
(assert (= i3 (+ i2 1)))
(assert (and (= o1 (+ tmp3 i3)) (in_range1 (+ tmp3 i3))))
(assert (= result4 tmp3))
(assert (= tmp4 o1))
(assert (not (= tmp4 (div1 (* i3 (+ i3 1)) 2))))
(check-sat)
(exit)
