...
(define-fun dynamic_invariant ((temp___expr_135 Int) (temp___is_init_132 Bool) (temp___skip_constant_133 Bool) (temp___do_toplevel_134 Bool)) Bool (=> (or (= temp___is_init_132 true) (<= 0 1000000)) (in_range temp___expr_135)))
...
(define-fun dynamic_invariant1 ((temp___expr_141 Int) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool (=> (or (= temp___is_init_138 true) (<= 0 1000)) (in_range1 temp___expr_141)))
(declare-const q Int)
(declare-const r Int)
...
(assert (=> (< 0 q1) (<= q2 r3)))
(assert (=> (< 0 q1) (= r3 r4)))
(assert (=> (< 0 q1) (= (mk_int__ref q5) (mk_int__ref q3))))
(assert (=> (< 0 q1) (= r5 r3)))
(assert (=> (< 0 q1) (= q6 q4)))
(assert (=> (< 0 q1) (= (mk_int__ref r6) (mk_int__ref r4))))
(assert (=> (< 0 q1) (= (mk_int__ref q7) (mk_int__ref q5))))
(assert (=> (< 0 q1) (= r7 r5)))
(assert (=> (< 0 q1) (= q8 q6)))
(assert (=> (< 0 q1) (= (mk_int__ref r8) (mk_int__ref r6))))
(assert (=> (< 0 q1) (= (mk_int__ref q9) (mk_int__ref q7))))
(assert (=> (< 0 q1) (= r9 r7)))
(assert (=> (< 0 q1) (= q10 q8)))
(assert (=> (not (< 0 q1)) (= (mk_int__ref r8) (mk_int__ref r))))
