...
(assert (= t101 o9))
(assert (not (in_range1 (* (- (+ (- (+ (- (+ (- (+ (- (to_fixed1 t11) (to_fixed1 t21)) (to_fixed1 t31)) (to_fixed1 t41)) (to_fixed1 t51)) (to_fixed1 t61)) (to_fixed1 t71)) (to_fixed1 t81)) (to_fixed1 t91)) (to_fixed1 t101)) 4))))
(check-sat)
(exit)
