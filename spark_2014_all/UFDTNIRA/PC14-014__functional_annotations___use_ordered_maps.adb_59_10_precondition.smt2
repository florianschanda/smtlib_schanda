...
(assert (and (= o1 (element s (mk___rep1 cu__split_fields3))) (and (in_range7 o1) (= o1 (get2 (model__ s) (key s (mk___rep1 cu__split_fields3)))))))
(assert (and (= o2 (f o1)) (and (in_range8 o2) (= o2 (ite (and (<= (- 100) o1) (<= o1 100)) (* o1 2) o1)))))
(assert (and (= o (key s (mk___rep1 cu__split_fields3))) (and (in_range6 o) (= o (get (keys s) (get1 (positions s) (mk___rep1 cu__split_fields3)))))))
(assert (not (or (< (length (mk___rep r__split_discrs r__split_fields2)) (to_rep (rec__use_ordered_maps__my_maps__map__capacity r__split_discrs))) (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2)) o) true))))
(check-sat)
(exit)
