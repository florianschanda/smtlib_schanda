...
(declare-const n Int)
(declare-const o Int)
(declare-const temp___806 us_rep2)
(declare-const temp___805 Int)
...
(assert (and (= (mk___rep1 (mk___split_fields1 use_ordered_sets__double_size__cu__assume)) (first (mk___rep s__split_discrs (mk___split_fields s__split_fields)))) (ite (= (= (length (mk___rep s__split_discrs (mk___split_fields s__split_fields))) 0) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 use_ordered_sets__double_size__cu__assume)) no_element) true) (and (= (has_key (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (mk___rep1 (mk___split_fields1 use_ordered_sets__double_size__cu__assume))) true) (= (get1 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (mk___rep1 (mk___split_fields1 use_ordered_sets__double_size__cu__assume))) 1)))))
(assert (= (mk___split_fields__ref1 (mk___split_fields1 result1)) (mk___split_fields__ref1 (mk___split_fields1 cu__split_fields))))
(assert (= use_ordered_sets__double_size__cu__assume cu__split_fields1))
(assert (= (mk_int__ref result2) (mk_int__ref n)))
(assert (= n1 0))
(assert (in_range2 n1))
(assert (and (= result3 (has_key (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (mk___rep1 (mk___split_fields1 cu__split_fields1)))) (= (= result3 true) (= (has_key (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (mk___rep1 (mk___split_fields1 cu__split_fields1))) true))))
(assert (= result3 true))
(assert (= (length (mk___rep s__split_discrs s__split_fields2)) (+ (length (mk___rep s__split_discrs (mk___split_fields s__split_fields))) n2)))
(assert (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 n2)) (and (= (get (elements (mk___rep s__split_discrs s__split_fields2)) (* 2 i4)) (+ (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) i4) 1)) (= (get (elements (mk___rep s__split_discrs s__split_fields2)) (- (* 2 i4) 1)) (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) i4))))))
(assert (forall ((i4 Int)) (=> (and (<= (+ (* 2 n2) 1) i4) (<= i4 (length (mk___rep s__split_discrs s__split_fields2)))) (= (get (elements (mk___rep s__split_discrs s__split_fields2)) i4) (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (- i4 n2))))))
(assert (forall ((i4 Int)) (=> (and (<= (+ n2 1) i4) (<= i4 (length (mk___rep s__split_discrs (mk___split_fields s__split_fields))))) (= (get (elements (mk___rep s__split_discrs s__split_fields2)) (+ i4 n2)) (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) i4)))))
(assert (= (get1 (positions (mk___rep s__split_discrs s__split_fields2)) (mk___rep1 cu__split_fields2)) (+ (* 2 n2) 1)))
(assert (=> (<= 0 2147483647) (in_range2 n2)))
(assert (not (= (contains (model__ (mk___rep s__split_discrs s__split_fields2)) (+ (element (mk___rep s__split_discrs s__split_fields2) (mk___rep1 cu__split_fields2)) 1)) true)))
(assert (and (= o48 (element (mk___rep s__split_discrs s__split_fields2) (mk___rep1 cu__split_fields2))) (and (in_range8 o48) (= o48 (get (elements (mk___rep s__split_discrs s__split_fields2)) (get1 (positions (mk___rep s__split_discrs s__split_fields2)) (mk___rep1 cu__split_fields2)))))))
(assert (= o49 (+ o48 1)))
(assert (and (= o50 o49) (in_range3 o49)))
(assert (and (= (contains (model__ (mk___rep s__split_discrs s__split_fields3)) o50) true) (ite (= (contains (model__ (mk___rep s__split_discrs s__split_fields2)) o50) true) (and (and (and (= (oeq3 (model__ (mk___rep s__split_discrs s__split_fields2)) (model__ (mk___rep s__split_discrs s__split_fields3))) true) (= (oeq4 (positions (mk___rep s__split_discrs s__split_fields3)) (positions (mk___rep s__split_discrs s__split_fields2))) true)) (= (get (elements (mk___rep s__split_discrs s__split_fields3)) (find (elements (mk___rep s__split_discrs s__split_fields3)) o50)) o50)) (= (equal_except (elements (mk___rep s__split_discrs s__split_fields2)) (elements (mk___rep s__split_discrs s__split_fields3)) (find (elements (mk___rep s__split_discrs s__split_fields3)) o50)) true)) (and (and (and (and (and (and (= (length (mk___rep s__split_discrs s__split_fields3)) (+ (length (mk___rep s__split_discrs s__split_fields2)) 1)) (= (ole (model__ (mk___rep s__split_discrs s__split_fields2)) (model__ (mk___rep s__split_discrs s__split_fields3))) true)) (= (included_except (model__ (mk___rep s__split_discrs s__split_fields3)) (model__ (mk___rep s__split_discrs s__split_fields2)) o50) true)) (= (get (elements (mk___rep s__split_discrs s__split_fields3)) (find (elements (mk___rep s__split_discrs s__split_fields3)) o50)) o50)) (= (range_equal (elements (mk___rep s__split_discrs s__split_fields2)) (elements (mk___rep s__split_discrs s__split_fields3)) 1 (- (find (elements (mk___rep s__split_discrs s__split_fields3)) o50) 1)) true)) (= (range_shifted (elements (mk___rep s__split_discrs s__split_fields2)) (elements (mk___rep s__split_discrs s__split_fields3)) (find (elements (mk___rep s__split_discrs s__split_fields3)) o50) (length (mk___rep s__split_discrs s__split_fields2)) 1) true)) (= (p_positions_shifted (positions (mk___rep s__split_discrs s__split_fields2)) (positions (mk___rep s__split_discrs s__split_fields3)) (find (elements (mk___rep s__split_discrs s__split_fields3)) o50) 1) true)))))
(assert (and (= (mk___rep1 (mk___split_fields1 o51)) (next (mk___rep s__split_discrs s__split_fields3) (mk___rep1 cu__split_fields2))) (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields2) no_element) false) (= (get1 (positions (mk___rep s__split_discrs s__split_fields3)) (mk___rep1 cu__split_fields2)) (length (mk___rep s__split_discrs s__split_fields3))) true) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 o51)) no_element) true) (and (= (has_key (positions (mk___rep s__split_discrs s__split_fields3)) (mk___rep1 (mk___split_fields1 o51))) true) (= (get1 (positions (mk___rep s__split_discrs s__split_fields3)) (mk___rep1 (mk___split_fields1 o51))) (+ (get1 (positions (mk___rep s__split_discrs s__split_fields3)) (mk___rep1 cu__split_fields2)) 1))))))
(assert (and (= (mk___rep1 (mk___split_fields1 temp___789)) (next (mk___rep s__split_discrs s__split_fields3) (mk___rep1 (mk___split_fields1 o51)))) (ite (= (ite (= (bool_eq1 (mk___rep1 (mk___split_fields1 o51)) no_element) false) (= (get1 (positions (mk___rep s__split_discrs s__split_fields3)) (mk___rep1 (mk___split_fields1 o51))) (length (mk___rep s__split_discrs s__split_fields3))) true) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 temp___789)) no_element) true) (and (= (has_key (positions (mk___rep s__split_discrs s__split_fields3)) (mk___rep1 (mk___split_fields1 temp___789))) true) (= (get1 (positions (mk___rep s__split_discrs s__split_fields3)) (mk___rep1 (mk___split_fields1 temp___789))) (+ (get1 (positions (mk___rep s__split_discrs s__split_fields3)) (mk___rep1 (mk___split_fields1 o51))) 1))))))
(assert (= result6 (mk___split_fields__ref1 cu__split_fields2)))
(assert (= cu__split_fields3 (mk___split_fields1 temp___789)))
(assert (and (= o52 (+ n2 1)) (in_range1 (+ n2 1))))
(assert (= result7 (mk_int__ref n2)))
(assert (= n3 o52))
(assert (and (= o53 (has_key (positions (mk___rep s__split_discrs s__split_fields3)) (mk___rep1 cu__split_fields3))) (= (= o53 true) (= (has_key (positions (mk___rep s__split_discrs s__split_fields3)) (mk___rep1 cu__split_fields3)) true))))
(assert (= result8 (ite (not (= o53 true)) true false)))
(assert (not (= result8 true)))
(declare-const i4 Int)
(assert (<= 1 i4))
(assert (<= i4 n3))
(assert (not (= (get (elements (mk___rep s__split_discrs s__split_fields3)) (* 2 i4)) (+ (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) i4) 1))))
(check-sat)
(exit)
