...
(define-fun dynamic_invariant1 ((temp___expr_382 Int) (temp___is_init_378 Bool) (temp___skip_constant_379 Bool) (temp___do_toplevel_380 Bool) (temp___do_typ_inv_381 Bool)) Bool (=> (or (= temp___is_init_378 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_382)))
(define-fun dynamic_invariant2 ((temp___expr_389 Int) (temp___is_init_385 Bool) (temp___skip_constant_386 Bool) (temp___do_toplevel_387 Bool) (temp___do_typ_inv_388 Bool)) Bool (=> (or (= temp___is_init_385 true) (<= 0 2147483647)) (in_range4 temp___expr_389)))
...
(define-fun default_initial_assumption ((temp___expr_397 us_rep2) (temp___skip_top_level_398 Bool)) Bool (=> (not (= temp___skip_top_level_398 true)) (= (length2 temp___expr_397) 0)))
...
(define-fun dynamic_invariant3 ((temp___expr_412 Int) (temp___is_init_408 Bool) (temp___skip_constant_409 Bool) (temp___do_toplevel_410 Bool) (temp___do_typ_inv_411 Bool)) Bool (=> (or (= temp___is_init_408 true) (<= 1 2147483647)) (in_range6 temp___expr_412)))
...
(define-fun default_initial_assumption1 ((temp___expr_420 us_rep3) (temp___skip_top_level_421 Bool)) Bool (=> (not (= temp___skip_top_level_421 true)) (and (= (is_empty temp___expr_420) true) (= (length3 temp___expr_420) 0))))
...
(assert (forall ((container us_rep)) (! (let ((result (elements container))) (and (and (and (= (length2 result) (length container)) (forall ((temp___435 Int)) (=> (and (in_range4 temp___435) (= (iter_has_element result temp___435) true)) (= (contains (model__ container) (get result temp___435)) true)))) (forall ((item Int)) (=> (and (in_range7 item) (= (contains (model__ container) item) true)) (and (< 0 (find result item)) (= (equivalent_elements (get result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (and (= (find result (get result i)) i) (= (e_is_find result (get result i) i) true)))))) :pattern ((elements container)))))
...
(define-fun dynamic_invariant4 ((temp___expr_323 Int) (temp___is_init_319 Bool) (temp___skip_constant_320 Bool) (temp___do_toplevel_321 Bool) (temp___do_typ_inv_322 Bool)) Bool (=> (or (= temp___is_init_319 true) (<= (- 2147483648) 2147483647)) (in_range8 temp___expr_323)))
...
(assert (forall ((container us_rep4)) (forall ((item Int)) (! (=> (dynamic_invariant6 item true true true true) (=> (= (distinct 1 0) true) (=> (exists ((e Int)) (and (and (in_range7 e) (= (contains container e) true)) (= (equivalent_elements e item) true))) (= (contains container item) true)))) :pattern ((contains container item))))))
...
(assert (forall ((left us_rep4) (right us_rep4)) (forall ((item Int)) (! (=> (dynamic_invariant6 item true true true true) (= (= (included_except left right item) true) (forall ((e Int)) (=> (and (in_range7 e) (= (contains left e) true)) (or (= (contains right e) true) (= (equivalent_elements e item) true)))))) :pattern ((included_except left right item))))))
...
(define-fun o6 () us_rep1 (mk___rep1 (mk___split_fields1 o3)))
...
(assert (=> (<= 0 2147483647) (in_range2 n2)))
...
(assert (and (= o (element (mk___rep s__split_discrs s__split_fields1) (mk___rep1 cu__split_fields2))) (and (in_range8 o) (= o (get (elements (mk___rep s__split_discrs s__split_fields1)) (get1 (positions (mk___rep s__split_discrs s__split_fields1)) (mk___rep1 cu__split_fields2)))))))
(assert (= o1 (+ o 1)))
(assert (and (= o2 o1) (in_range3 o1)))
(assert (and (= (contains (model__ (mk___rep s__split_discrs s__split_fields2)) o2) true) (ite (= (contains (model__ (mk___rep s__split_discrs s__split_fields1)) o2) true) (and (and (and (= (oeq3 (model__ (mk___rep s__split_discrs s__split_fields1)) (model__ (mk___rep s__split_discrs s__split_fields2))) true) (= (oeq4 (positions (mk___rep s__split_discrs s__split_fields2)) (positions (mk___rep s__split_discrs s__split_fields1))) true)) (= (get (elements (mk___rep s__split_discrs s__split_fields2)) (find (elements (mk___rep s__split_discrs s__split_fields2)) o2)) o2)) (= (equal_except (elements (mk___rep s__split_discrs s__split_fields1)) (elements (mk___rep s__split_discrs s__split_fields2)) (find (elements (mk___rep s__split_discrs s__split_fields2)) o2)) true)) (and (and (and (and (and (and (= (length (mk___rep s__split_discrs s__split_fields2)) (+ (length (mk___rep s__split_discrs s__split_fields1)) 1)) (= (ole (model__ (mk___rep s__split_discrs s__split_fields1)) (model__ (mk___rep s__split_discrs s__split_fields2))) true)) (= (included_except (model__ (mk___rep s__split_discrs s__split_fields2)) (model__ (mk___rep s__split_discrs s__split_fields1)) o2) true)) (= (get (elements (mk___rep s__split_discrs s__split_fields2)) (find (elements (mk___rep s__split_discrs s__split_fields2)) o2)) o2)) (= (range_equal (elements (mk___rep s__split_discrs s__split_fields1)) (elements (mk___rep s__split_discrs s__split_fields2)) 1 (- (find (elements (mk___rep s__split_discrs s__split_fields2)) o2) 1)) true)) (= (range_shifted (elements (mk___rep s__split_discrs s__split_fields1)) (elements (mk___rep s__split_discrs s__split_fields2)) (find (elements (mk___rep s__split_discrs s__split_fields2)) o2) (length (mk___rep s__split_discrs s__split_fields1)) 1) true)) (= (p_positions_shifted (positions (mk___rep s__split_discrs s__split_fields1)) (positions (mk___rep s__split_discrs s__split_fields2)) (find (elements (mk___rep s__split_discrs s__split_fields2)) o2) 1) true)))))
(assert (and (= o6 (next (mk___rep s__split_discrs s__split_fields2) (mk___rep1 cu__split_fields2))) (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields2) no_element) false) (= (get1 (positions (mk___rep s__split_discrs s__split_fields2)) (mk___rep1 cu__split_fields2)) (length (mk___rep s__split_discrs s__split_fields2))) true) true) (= (bool_eq1 o6 no_element) true) (and (= (has_key (positions (mk___rep s__split_discrs s__split_fields2)) o6) true) (= (get1 (positions (mk___rep s__split_discrs s__split_fields2)) o6) (+ (get1 (positions (mk___rep s__split_discrs s__split_fields2)) (mk___rep1 cu__split_fields2)) 1))))))
(assert (and (= temp___8311 (next (mk___rep s__split_discrs s__split_fields2) o6)) (ite (= (ite (= (bool_eq1 o6 no_element) false) (= (get1 (positions (mk___rep s__split_discrs s__split_fields2)) o6) (length (mk___rep s__split_discrs s__split_fields2))) true) true) (= (bool_eq1 temp___8311 no_element) true) (and (= (has_key (positions (mk___rep s__split_discrs s__split_fields2)) temp___8311) true) (= (get1 (positions (mk___rep s__split_discrs s__split_fields2)) temp___8311) (+ (get1 (positions (mk___rep s__split_discrs s__split_fields2)) o6) 1))))))
(assert (= result3 (mk___split_fields__ref1 cu__split_fields2)))
(assert (= cu__split_fields3 (mk___split_fields1 temp___831)))
(assert (and (= o4 (+ n2 1)) (in_range1 (+ n2 1))))
...
(assert (<= 1 i))
(assert (<= i n3))
(assert (not (= (get (elements (mk___rep s__split_discrs s__split_fields2)) (* 2 i)) (+ (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) i) 1))))
(check-sat)
(exit)
