...
(define-fun e_bigger_than_range ((container us_rep1) (fst Int) (lst Int) (item Int)) Bool (ite (forall ((i Int)) (=> (and (<= fst i) (<= i lst)) (< (get container i) item))) true false))
...
(declare-fun user_eq12 (telement_typeB telement_typeB) Bool)
(declare-const dummy12 telement_typeB)
...
(define-fun dynamic_invariant5 ((temp___expr_346 Int) (temp___is_init_342 Bool) (temp___skip_constant_343 Bool) (temp___do_toplevel_344 Bool) (temp___do_typ_inv_345 Bool)) Bool (=> (or (= temp___is_init_342 true) (<= 1 2147483647)) (in_range9 temp___expr_346)))
(assert (forall ((container us_rep1)) (forall ((item Int)) (! (=> (dynamic_invariant4 item true true true true) (let ((result (find container item))) (and (=> (< 0 result) (and (<= result (length1 container)) (= (equivalent_elements item (get container result)) true))) (dynamic_invariant result true false true true)))) :pattern ((find container item))))))
...
(assert (forall ((container us_rep4)) (forall ((item Int)) (! (=> (dynamic_invariant6 item true true true true) (=> (= (distinct 1 0) true) (=> (exists ((e Int)) (and (and (in_range5 e) (= (contains container e) true)) (= (equivalent_elements e item) true))) (= (contains container item) true)))) :pattern ((contains container item))))))
...
(assert (forall ((left us_rep4) (right us_rep4)) (forall ((item Int)) (! (=> (dynamic_invariant6 item true true true true) (= (= (included_except left right item) true) (forall ((e Int)) (=> (and (in_range5 e) (= (contains left e) true)) (or (= (contains right e) true) (= (equivalent_elements e item) true)))))) :pattern ((included_except left right item))))))
...
(define-fun temp___8311 () us_rep2 (mk___rep1 (mk___split_fields1 temp___831)))
(define-fun o6 () us_rep2 (mk___rep1 (mk___split_fields1 o3)))
(define-fun use_ordered_sets__double_size__cu__assume1 () us_rep2 (mk___rep1 (mk___split_fields1 use_ordered_sets__double_size__cu__assume)))
(assert (and (<= (length (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (div1 (to_rep (rec__use_ordered_sets__my_sets__set__capacity s__split_discrs)) 2)) (let ((temp___852 (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))))) (forall ((temp___851 Int)) (=> (and (in_range3 temp___851) (= (iter_has_element temp___852 temp___851) true)) (= (mod2 (get temp___852 temp___851) 2) 0))))))
(assert (and (= use_ordered_sets__double_size__cu__assume1 (first (mk___rep s__split_discrs (mk___split_fields s__split_fields)))) (ite (= (= (length (mk___rep s__split_discrs (mk___split_fields s__split_fields))) 0) true) (= (bool_eq2 use_ordered_sets__double_size__cu__assume1 no_element) true) (and (= (has_key (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields))) use_ordered_sets__double_size__cu__assume1) true) (= (get1 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields))) use_ordered_sets__double_size__cu__assume1) 1)))))
...
(assert (= n1 0))
(assert (in_range1 n1))
(assert (and (= result2 (has_key (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (mk___rep1 cu__split_fields4))) (= (= result2 true) (= (has_key (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (mk___rep1 cu__split_fields4)) true))))
(assert (= result2 true))
(assert (= (length (mk___rep s__split_discrs s__split_fields1)) (+ (length (mk___rep s__split_discrs (mk___split_fields s__split_fields))) n2)))
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i n2)) (and (= (get (elements (mk___rep s__split_discrs s__split_fields1)) (* 2 i)) (+ (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) i) 1)) (= (get (elements (mk___rep s__split_discrs s__split_fields1)) (- (* 2 i) 1)) (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) i))))))
(assert (forall ((i Int)) (=> (and (<= (+ (* 2 n2) 1) i) (<= i (length (mk___rep s__split_discrs s__split_fields1)))) (= (get (elements (mk___rep s__split_discrs s__split_fields1)) i) (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (- i n2))))))
(assert (forall ((i Int)) (=> (and (<= (+ n2 1) i) (<= i (length (mk___rep s__split_discrs (mk___split_fields s__split_fields))))) (= (get (elements (mk___rep s__split_discrs s__split_fields1)) (+ i n2)) (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) i)))))
(assert (= (get1 (positions (mk___rep s__split_discrs s__split_fields1)) (mk___rep1 cu__split_fields2)) (+ (* 2 n2) 1)))
(assert (=> (<= 0 2147483647) (in_range1 n2)))
(assert (not (= (contains (model__ (mk___rep s__split_discrs s__split_fields1)) (+ (element (mk___rep s__split_discrs s__split_fields1) (mk___rep1 cu__split_fields2)) 1)) true)))
(assert (and (= o (element (mk___rep s__split_discrs s__split_fields1) (mk___rep1 cu__split_fields2))) (and (in_range6 o) (= o (get (elements (mk___rep s__split_discrs s__split_fields1)) (get1 (positions (mk___rep s__split_discrs s__split_fields1)) (mk___rep1 cu__split_fields2)))))))
(assert (= o1 (+ o 1)))
(assert (and (= o2 o1) (in_range8 o1)))
(assert (and (= (contains (model__ (mk___rep s__split_discrs s__split_fields2)) o2) true) (ite (= (contains (model__ (mk___rep s__split_discrs s__split_fields1)) o2) true) (and (and (and (= (oeq2 (model__ (mk___rep s__split_discrs s__split_fields1)) (model__ (mk___rep s__split_discrs s__split_fields2))) true) (= (oeq3 (positions (mk___rep s__split_discrs s__split_fields2)) (positions (mk___rep s__split_discrs s__split_fields1))) true)) (= (get (elements (mk___rep s__split_discrs s__split_fields2)) (find (elements (mk___rep s__split_discrs s__split_fields2)) o2)) o2)) (= (equal_except (elements (mk___rep s__split_discrs s__split_fields1)) (elements (mk___rep s__split_discrs s__split_fields2)) (find (elements (mk___rep s__split_discrs s__split_fields2)) o2)) true)) (and (and (and (and (and (and (= (length (mk___rep s__split_discrs s__split_fields2)) (+ (length (mk___rep s__split_discrs s__split_fields1)) 1)) (= (ole (model__ (mk___rep s__split_discrs s__split_fields1)) (model__ (mk___rep s__split_discrs s__split_fields2))) true)) (= (included_except (model__ (mk___rep s__split_discrs s__split_fields2)) (model__ (mk___rep s__split_discrs s__split_fields1)) o2) true)) (= (get (elements (mk___rep s__split_discrs s__split_fields2)) (find (elements (mk___rep s__split_discrs s__split_fields2)) o2)) o2)) (= (range_equal (elements (mk___rep s__split_discrs s__split_fields1)) (elements (mk___rep s__split_discrs s__split_fields2)) 1 (- (find (elements (mk___rep s__split_discrs s__split_fields2)) o2) 1)) true)) (= (range_shifted (elements (mk___rep s__split_discrs s__split_fields1)) (elements (mk___rep s__split_discrs s__split_fields2)) (find (elements (mk___rep s__split_discrs s__split_fields2)) o2) (length (mk___rep s__split_discrs s__split_fields1)) 1) true)) (= (p_positions_shifted (positions (mk___rep s__split_discrs s__split_fields1)) (positions (mk___rep s__split_discrs s__split_fields2)) (find (elements (mk___rep s__split_discrs s__split_fields2)) o2) 1) true)))))
(assert (and (= o6 (next (mk___rep s__split_discrs s__split_fields2) (mk___rep1 cu__split_fields2))) (ite (= (ite (= (bool_eq2 (mk___rep1 cu__split_fields2) no_element) false) (= (get1 (positions (mk___rep s__split_discrs s__split_fields2)) (mk___rep1 cu__split_fields2)) (length (mk___rep s__split_discrs s__split_fields2))) true) true) (= (bool_eq2 o6 no_element) true) (and (= (has_key (positions (mk___rep s__split_discrs s__split_fields2)) o6) true) (= (get1 (positions (mk___rep s__split_discrs s__split_fields2)) o6) (+ (get1 (positions (mk___rep s__split_discrs s__split_fields2)) (mk___rep1 cu__split_fields2)) 1))))))
(assert (and (= temp___8311 (next (mk___rep s__split_discrs s__split_fields2) o6)) (ite (= (ite (= (bool_eq2 o6 no_element) false) (= (get1 (positions (mk___rep s__split_discrs s__split_fields2)) o6) (length (mk___rep s__split_discrs s__split_fields2))) true) true) (= (bool_eq2 temp___8311 no_element) true) (and (= (has_key (positions (mk___rep s__split_discrs s__split_fields2)) temp___8311) true) (= (get1 (positions (mk___rep s__split_discrs s__split_fields2)) temp___8311) (+ (get1 (positions (mk___rep s__split_discrs s__split_fields2)) o6) 1))))))
(assert (= result3 (mk___split_fields__ref1 cu__split_fields2)))
(assert (= cu__split_fields3 (mk___split_fields1 temp___831)))
(assert (and (= o4 (+ n2 1)) (in_range7 (+ n2 1))))
(assert (= result4 (mk_int__ref n2)))
(assert (= n3 o4))
(assert (and (= o5 (has_key (positions (mk___rep s__split_discrs s__split_fields2)) (mk___rep1 cu__split_fields3))) (= (= o5 true) (= (has_key (positions (mk___rep s__split_discrs s__split_fields2)) (mk___rep1 cu__split_fields3)) true))))
(assert (= result5 (ite (not (= o5 true)) true false)))
(assert (not (= result5 true)))
(declare-const i Int)
(assert (<= 1 i))
(assert (<= i n3))
(assert (not (= (get (elements (mk___rep s__split_discrs s__split_fields2)) (- (* 2 i) 1)) (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) i))))
(check-sat)
(exit)
