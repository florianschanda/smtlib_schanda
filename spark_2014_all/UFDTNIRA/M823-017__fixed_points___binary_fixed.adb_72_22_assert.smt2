...
(assert (forall ((x Int)) (! (ite (= x 0) (= (to_int2 x) 0) (ite (< 0 x) (pos_div_relation (to_int2 x) x 256) (pos_div_relation (- (to_int2 x)) (- x) 256))) :pattern ((to_int2 x)))))
...
(assert (forall ((x Int)) (! (ite (= x 0) (= (to_int3 x) 0) (ite (< 0 x) (pos_div_relation1 (to_int3 x) x 256) (pos_div_relation1 (- (to_int3 x)) (- x) 256))) :pattern ((to_int3 x)))))
...
(assert (= y (of_fixed1 128)))
(assert (= inv_y (of_fixed1 512)))
...
(assert (=> (not (= (to_fixed1 x) 0)) (= (to_fixed1 o) (fxp_div (to_fixed1 x) (to_fixed1 x)))))
(assert (=> (not (= (to_fixed1 x) 0)) (= (mk_t__ref result1) (mk_t__ref z))))
(assert (=> (not (= (to_fixed1 x) 0)) (= z2 o)))
(assert (=> (not (= (to_fixed1 x) 0)) (= (to_fixed1 z2) 256)))
(assert (=> (not (not (= (to_fixed1 x) 0))) (= z2 z)))
(assert (=> (not (not (= (to_fixed1 x) 0))) (= z2 z1)))
(assert (= (to_fixed1 o1) (fxp_div (to_fixed1 x) 128)))
(assert (= result2 z2))
(assert (= z3 o1))
(assert (= (to_fixed1 z3) (fxp_mult 512 (to_fixed1 x))))
(assert (= (to_fixed1 o2) (fxp_div_int (to_fixed1 x) 2)))
(assert (= result3 z3))
(assert (= z4 o2))
(assert (and (<= (- (* (to_fixed1 z4) 2) 1) (to_fixed1 x)) (<= (to_fixed1 x) (+ (* (to_fixed1 z4) 2) 1))))
(assert (= (to_fixed1 o3) (fxp_div_int (to_fixed1 x) two1)))
(assert (= result4 z4))
(assert (= z5 o3))
(assert (not (<= (- (* (to_fixed1 z5) 2) 1) (to_fixed1 x))))
(check-sat)
(exit)
