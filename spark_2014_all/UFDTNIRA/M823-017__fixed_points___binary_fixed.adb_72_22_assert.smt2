...
(assert (forall ((x Int)) (! (ite (= x 0) (= (to_int1 x) 0) (ite (< 0 x) (pos_div_relation (to_int1 x) x 256) (pos_div_relation (- (to_int1 x)) (- x) 256))) :pattern ((to_int1 x)))))
...
(assert (forall ((x Int)) (! (ite (= x 0) (= (to_int2 x) 0) (ite (< 0 x) (pos_div_relation1 (to_int2 x) x 256) (pos_div_relation1 (- (to_int2 x)) (- x) 256))) :pattern ((to_int2 x)))))
