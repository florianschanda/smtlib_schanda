...
(assert (forall ((x Int)) (! (ite (= x 0) (= (to_int1 x) 0) (ite (< 0 x) (pos_div_relation (to_int1 x) (* x 1) 256) (pos_div_relation (- (to_int1 x)) (* (- x) 1) 256))) :pattern ((to_int1 x)))))
(declare-fun of_int (Int) Int)
(assert (forall ((x Int)) (! (ite (= x 0) (= (of_int x) 0) (ite (< 0 x) (pos_div_relation (of_int x) (* x 256) 1) (pos_div_relation (- (of_int x)) (* (- x) 256) 1))) :pattern ((of_int x)))))
...
(assert (forall ((x Int)) (! (ite (= x 0) (= (to_int2 x) 0) (ite (< 0 x) (pos_div_relation (to_int2 x) (* x 1) 256) (pos_div_relation (- (to_int2 x)) (* (- x) 1) 256))) :pattern ((to_int2 x)))))
(declare-fun of_int1 (Int) Int)
(assert (forall ((x Int)) (! (ite (= x 0) (= (of_int1 x) 0) (ite (< 0 x) (pos_div_relation (of_int1 x) (* x 256) 1) (pos_div_relation (- (of_int1 x)) (* (- x) 256) 1))) :pattern ((of_int1 x)))))
...
(assert (forall ((x1 Int)) (forall ((y1 Int)) (! (ite (or (= x1 0) (= y1 0)) (= (fxp_mult x1 y1) 0) (ite (or (and (< 0 x1) (< 0 y1)) (and (< x1 0) (< y1 0))) (pos_div_relation (fxp_mult x1 y1) (* (* (* (* x1 y1) 1) 1) 256) (* (* 256 256) 1)) (pos_div_relation (- (fxp_mult x1 y1)) (- (* (* (* (* x1 y1) 1) 1) 256)) (* (* 256 256) 1)))) :pattern ((fxp_mult x1 y1))))))
(declare-fun fxp_div (Int Int) Int)
(assert (forall ((x1 Int)) (forall ((y1 Int)) (! (ite (= x1 0) (= (fxp_div x1 y1) 0) (ite (and (< 0 x1) (< 0 y1)) (pos_div_relation (fxp_div x1 y1) (* (* (* x1 1) 256) 256) (* (* (* y1 256) 1) 1)) (ite (and (< x1 0) (< y1 0)) (pos_div_relation (fxp_div x1 y1) (* (* (* (- x1) 1) 256) 256) (* (* (* (- y1) 256) 1) 1)) (ite (and (< x1 0) (< 0 y1)) (pos_div_relation (- (fxp_div x1 y1)) (* (* (* (- x1) 1) 256) 256) (* (* (* y1 256) 1) 1)) (=> (and (< 0 x1) (< y1 0)) (pos_div_relation (- (fxp_div x1 y1)) (* (* (* x1 1) 256) 256) (* (* (* (- y1) 256) 1) 1))))))) :pattern ((fxp_div x1 y1))))))
...
(assert (= (to_fixed1 o1) (fxp_div (to_fixed1 x) (to_fixed1 y))))
(assert (= result2 z2))
(assert (= z3 o1))
(assert (= (to_fixed1 z3) (fxp_mult (to_fixed1 inv_y) (to_fixed1 x))))
...
(assert (= result4 z4))
(assert (= z5 o3))
(assert (not (<= (to_fixed1 x) (+ (* (to_fixed1 z5) 2) 1))))
(check-sat)
(exit)
