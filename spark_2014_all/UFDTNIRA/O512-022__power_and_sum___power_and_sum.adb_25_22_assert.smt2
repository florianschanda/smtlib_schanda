...
(assert (=> (<= i1 n) (= temp___571 totalsum1)))
(assert (=> (<= i1 n) (= temp___570 i1)))
(assert (=> (<= i1 n) (= (* 2 totalsum2) (* i2 (- i2 1)))))
(assert (=> (<= i1 n) (and (and (=> (<= 1 2147483647) (in_range3 i2)) (=> (<= 0 2147483647) (in_range2 totalsum2))) (<= i2 n))))
(assert (=> (<= i1 n) (and (= o (+ totalsum2 i2)) (in_range1 (+ totalsum2 i2)))))
