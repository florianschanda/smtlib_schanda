...
(assert (= result3 (olt__2 left time_span_zero)))
(assert (= result3 true))
(assert (= o41 (to_duration__2 time_span_last)))
(assert (= o42 (to_fixed o41)))
(assert (= o43 (fxp_div_result_int o42 1)))
(assert (and (= o44 o43) (in_range3 o43)))
(assert (and (= o45 o44) (in_range4 o44)))
(assert (= o46 (div1 o45 right)))
(assert (not (in_range3 o46)))
(check-sat)
(exit)
