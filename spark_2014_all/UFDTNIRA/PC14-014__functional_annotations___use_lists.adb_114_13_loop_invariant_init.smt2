...
(assert (not (= (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (+ i3 n1)) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i3))))
(check-sat)
(exit)
