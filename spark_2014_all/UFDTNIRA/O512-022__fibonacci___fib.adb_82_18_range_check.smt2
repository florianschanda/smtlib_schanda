...
(assert (= i2 2))
(assert (=> (and (<= 2 i2) (<= i2 n1)) (and (and (= temp___176 i2) (and (= temp___175 p11) (and (= p12 (factorial (- i3 1))) (and (and (and (=> (<= 0 2147483647) (in_range2 p12)) (=> (<= 2 n1) (dynamic_property 2 n1 i3))) (and (<= 2 i3) (<= i3 n1))) (and (and (and (and (= o1 (* i3 p12)) (in_range1 (* i3 p12))) (and (= o2 o1) (in_range2 o1))) (and (= p12 result2) (= p13 o2))) (= i3 n1)))))) (and (and (= i3 i7) (= p13 p16)) (and (= i8 i3) (= p17 p13))))))
(assert (=> (and (<= 2 i2) (<= i2 n1)) (= (mk_int__ref i9) (mk_int__ref i7))))
(assert (=> (and (<= 2 i2) (<= i2 n1)) (= (mk_int__ref p18) (mk_int__ref p16))))
(assert (=> (and (<= 2 i2) (<= i2 n1)) (= i10 i8)))
(assert (=> (and (<= 2 i2) (<= i2 n1)) (= p19 p17)))
(assert (=> (not (and (<= 2 i2) (<= i2 n1))) (= i2 i9)))
(assert (=> (not (and (<= 2 i2) (<= i2 n1))) (= p11 p18)))
(assert (=> (not (and (<= 2 i2) (<= i2 n1))) (= i10 i2)))
(assert (=> (not (and (<= 2 i2) (<= i2 n1))) (= p19 p11)))
(assert (= (mk_int__ref result4) (mk_int__ref p2)))
(assert (= p21 1))
(assert (= (mk_int__ref result5) (mk_int__ref i1)))
(assert (= i11 2))
(assert (<= 2 i11))
(assert (<= i11 n2))
(assert (= p22 (factorial (- i12 1))))
(assert (and (and (=> (<= 2 n2) (dynamic_property1 2 n2 i12)) (=> (<= 0 2147483647) (in_range2 p22))) (and (<= 2 i12) (<= i12 n2))))
(assert (and (= o4 (* i12 p22)) (in_range1 (* i12 p22))))
