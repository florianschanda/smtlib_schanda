...
(assert (forall ((x signal_type)) (in_range (to_fixed x))))
...
(declare-const dummy1 tsignal_typeB)
(declare-fun attr__ATTRIBUTE_IMAGE1 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check1 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE1 (us_image) Int)
(declare-fun to_fixed1 (tsignal_typeB) Int)
(declare-fun of_fixed1 (Int) tsignal_typeB)
(declare-fun user_eq1 (tsignal_typeB tsignal_typeB) Bool)
...
(assert (forall ((x tsignal_typeB)) (! (= (of_fixed1 (to_fixed1 x)) x) :pattern ((to_fixed1 x)))))
(assert (forall ((x tsignal_typeB)) (in_range1 (to_fixed1 x))))
...
(assert (< 0 (+ (to_fixed a) (to_fixed b))))
(assert (not (in_range1 (+ (to_fixed a) (to_fixed b)))))
(check-sat)
(exit)
