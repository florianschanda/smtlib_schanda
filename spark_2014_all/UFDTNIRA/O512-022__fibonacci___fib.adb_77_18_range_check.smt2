...
(assert (forall ((n Int)) (! (=> (and (dynamic_invariant n true true true) (<= n 7)) (dynamic_invariant (factorial n) true false true)) :pattern ((factorial n)))))
...
(assert (<= 2 i2))
(assert (<= i2 n1))
(assert (= p12 (factorial (- i3 1))))
(assert (and (and (=> (<= 0 2147483647) (in_range2 p12)) (=> (<= 2 n1) (dynamic_property 2 n1 i3))) (and (<= 2 i3) (<= i3 n1))))
(assert (and (= o1 (* i3 p12)) (in_range1 (* i3 p12))))
