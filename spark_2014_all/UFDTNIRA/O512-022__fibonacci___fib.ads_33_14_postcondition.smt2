...
(assert (= k21 n2))
(assert (=> (< 0 k21) (and (and (= temp___193 k21) (and (= temp___192 b21) (and (= temp___191 p21) (and (= 0 temp___194) (and (and (and (and (= (power a2 n2) (* p22 (power b22 k22))) (<= 0 (int__content k19))) (<= p22 (power a2 n2))) (<= b22 (power a2 n2))) (and (and (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 p22)) (=> (<= (- 2147483648) 2147483647) (in_range1 b22))) (=> (<= 0 2147483647) (in_range2 k22))) (< 0 k22)) (and (and (= result11 (mk_int__ref temp___1941)) (= temp___1942 k22)) (and (ite (= (mod1 k22 2) 0) (and (and (= (* p22 (power (* b22 b22) (div1 k22 2))) (power a2 n2)) (and (and (= result12 (mk_int__ref k22)) (= k23 (div1 k22 2))) (and (and (= o4 (* b22 b22)) (in_range1 (* b22 b22))) (and (= result13 (mk_int__ref b22)) (= b23 o4))))) (and (and (= k25 (mk_int__ref k23)) (and (= b24 (mk_int__ref b23)) (= p24 (mk_int__ref p22)))) (and (= k26 k23) (and (= b25 b23) (= p25 p22))))) (and (and (and (= (* (* p22 b22) (power b22 (- k22 1))) (power a2 n2)) (<= 1 k22)) (and (and (and (= o6 (- k22 1)) (in_range2 (- k22 1))) (and (= result14 (mk_int__ref k22)) (= k24 o6))) (and (and (= o7 (* b22 p22)) (in_range1 (* b22 p22))) (and (= result15 (mk_int__ref p22)) (= p23 o7))))) (and (and (= k25 (mk_int__ref k24)) (and (= b24 (mk_int__ref b22)) (= p24 (mk_int__ref p23)))) (and (= k26 k24) (and (= b25 b22) (= p25 p23)))))) (not (< 0 (int__content k25))))))))))) (and (and (= k211 k25) (and (= b210 b24) (= p210 p24))) (and (= k212 k26) (and (= b211 b25) (= p211 p25)))))))
(assert (=> (< 0 k21) (= k213 k211)))
(assert (=> (< 0 k21) (= b212 b210)))
(assert (=> (< 0 k21) (= p212 p210)))
(assert (=> (< 0 k21) (= k214 k212)))
(assert (=> (< 0 k21) (= b213 b211)))
(assert (=> (< 0 k21) (= p213 p211)))
(assert (=> (not (< 0 k21)) (= k213 (mk_int__ref k21))))
(assert (=> (not (< 0 k21)) (= b212 (mk_int__ref b21))))
(assert (=> (not (< 0 k21)) (= p212 (mk_int__ref p21))))
(assert (=> (not (< 0 k21)) (= k214 k21)))
(assert (=> (not (< 0 k21)) (= b213 b21)))
(assert (=> (not (< 0 k21)) (= p213 p21)))
(assert (= k215 k213))
(assert (= k111 k19))
(assert (= b214 b212))
(assert (= b110 b18))
...
(assert (= p215 p213))
(assert (= p111 p19))
(assert (not (= (int__content p110) (int__content p214))))
(check-sat)
(exit)
