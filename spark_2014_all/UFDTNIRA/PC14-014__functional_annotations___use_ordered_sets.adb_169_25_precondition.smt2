...
(assert (not (or (= (has_key (positions (mk___rep s__split_discrs s__split_fields3)) (mk___rep1 cu__split_fields2)) true) (= (bool_eq1 (mk___rep1 cu__split_fields2) no_element) true))))
(check-sat)
(exit)
