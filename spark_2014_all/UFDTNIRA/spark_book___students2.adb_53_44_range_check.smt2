...
(assert (= fees3 o6))
(assert (not (= (to_rep1 (rec__students2__student_record__meal_plan (us_split_fields3 student))) 0)))
(assert (not (= (to_rep1 (rec__students2__student_record__meal_plan (us_split_fields3 student))) 1)))
(assert (= (to_rep1 (rec__students2__student_record__meal_plan (us_split_fields3 student))) 2))
(assert (not (in_range5 (+ (to_fixed2 fees3) 100000))))
(check-sat)
(exit)
