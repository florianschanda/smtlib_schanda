...
(assert (in_range3 temp___707))
(assert (= (iter_has_element (elements (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) temp___707) true))
(assert (not (exists ((temp___709 Int)) (and (and (in_range3 temp___709) (= (iter_has_element (elements s) temp___709) true)) (= (get (elements (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) temp___707) (f (get (elements s) temp___709)))))))
(check-sat)
(exit)
