...
(define-fun dynamic_invariant1 ((temp___expr_137 Int) (temp___is_init_134 Bool) (temp___skip_constant_135 Bool) (temp___do_toplevel_136 Bool)) Bool (and (=> (or (= temp___is_init_134 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_137)) (=> (= temp___do_toplevel_136 true) (=> (= temp___is_init_134 true) (= (mod2 temp___expr_137 2) 0)))))
