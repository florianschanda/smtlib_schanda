...
(assert (<= 1 i3))
(assert (<= i3 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))))
(assert (not (= (get (model__ (mk___rep l__split_discrs (us_split_fields__content l__split_fields8))) (- (* 2 i3) 1)) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i3))))
(check-sat)
(exit)
