...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 n)) (and (and (= temp___133 i1) (and (= temp___132 tmp1) (and (and (and (= o (+ tmp1 i1)) (in_range1 (+ tmp1 i1))) (and (= tmp1 result2) (= tmp2 o))) (and (= tmp3 (div1 (* i2 (+ i2 1)) 2)) (and (and (and (=> (<= 0 2147483647) (in_range2 tmp3)) (=> (<= 1 n) (dynamic_property 1 n i2))) (and (<= 1 i2) (<= i2 n))) (= i2 n)))))) (and (and (= i2 i6) (= tmp3 tmp7)) (and (= i7 i2) (= tmp8 tmp3))))))
(assert (=> (and (<= 1 i1) (<= i1 n)) (= (mk_int__ref i8) (mk_int__ref i6))))
(assert (=> (and (<= 1 i1) (<= i1 n)) (= (mk_int__ref tmp9) (mk_int__ref tmp7))))
(assert (=> (and (<= 1 i1) (<= i1 n)) (= i9 i7)))
(assert (=> (and (<= 1 i1) (<= i1 n)) (= tmp10 tmp8)))
(assert (=> (not (and (<= 1 i1) (<= i1 n))) (= i1 i8)))
(assert (=> (not (and (<= 1 i1) (<= i1 n))) (= tmp1 tmp9)))
(assert (=> (not (and (<= 1 i1) (<= i1 n))) (= i9 i1)))
(assert (=> (not (and (<= 1 i1) (<= i1 n))) (= tmp10 tmp1)))
...
(assert (= (mk_int__ref result5) (mk_int__ref triangle__sum_up_to__result)))
(assert (= triangle__sum_up_to__result1 tmp9))
...
(assert (= (mk_int__ref tmp11) (mk_int__ref tmp9)))
(assert (= triangle__sum_up_to__result5 triangle__sum_up_to__result3))
(assert (= i11 i9))
(assert (= tmp12 tmp10))
(assert (and (= o6 (+ n 1)) (in_range1 (+ n 1))))
(assert (= o7 (* n o6)))
