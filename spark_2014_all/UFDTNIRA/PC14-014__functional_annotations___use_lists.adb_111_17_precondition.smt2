...
(assert (and (= o1 (* 2 i)) (in_range6 (* 2 i))))
(assert (= o2 (- o1 1)))
(assert (and (= o3 o2) (in_range6 o2)))
(assert (and (= o4 o3) (in_range3 o3)))
(assert (and (= o (model__ (mk___rep l__split_discrs l__split_fields2))) (= (length1 o) (length (mk___rep l__split_discrs l__split_fields2)))))
(assert (not (<= o4 (last o))))
(check-sat)
(exit)
