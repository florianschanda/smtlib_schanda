...
(assert (and (= result1 (has_key (positions s) (mk___rep1 cu__split_fields2))) (= (= result1 true) (= (has_key (positions s) (mk___rep1 cu__split_fields2)) true))))
(assert (= result1 true))
(declare-const g Int)
(assert (in_range2 g))
(assert (= (contains (model__ (mk___rep r__split_discrs r__split_fields1)) g) true))
(assert (not (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields2)) 1))) (= g (f (get (elements s) i)))))))
(check-sat)
(exit)
