...
(assert (in_range2 g2))
(assert (= (contains (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields))) g2) true))
(assert (not (exists ((i2 Int)) (and (and (<= 1 i2) (<= i2 (- (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields1))) 1))) (= g2 (f (get (elements s) i2)))))))
(check-sat)
(exit)
