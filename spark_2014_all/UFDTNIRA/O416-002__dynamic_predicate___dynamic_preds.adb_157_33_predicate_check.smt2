...
(define-fun temp___3222 () us_rep (mk___rep (mk___split_fields temp___322 temp___3221)))
...
(assert (and (= temp___3222 (get_even_close_pair__2 (mk___rep (mk___split_fields o o1)))) (dynamic_invariant2 temp___3222 true false true)))
