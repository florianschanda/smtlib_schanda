...
(declare-const temp___348 even)
(declare-const temp___3481 even)
...
(define-fun temp___3482 () us_rep (mk___rep (mk___split_fields temp___348 temp___3481)))
...
(assert (= x__split_fields o))
(assert (= x__split_fields1 o1))
(assert (and (= temp___3482 (get_even_close_pair__2 (mk___rep (mk___split_fields o o1)))) (dynamic_invariant2 temp___3482 true false true true)))
(assert (= result x__split_fields))
(assert (= result1 x__split_fields1))
(assert (= temp___348 x__split_fields2))
(assert (= temp___3481 x__split_fields3))
