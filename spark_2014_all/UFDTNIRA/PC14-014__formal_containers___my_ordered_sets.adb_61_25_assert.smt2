...
(assert (not (= (oeq (union__2 (mk___rep m__split_discrs1 m__split_fields8) (mk___rep l__split_discrs l__split_fields11)) (union__2 (mk___rep k__split_discrs k__split_fields3) (mk___rep l__split_discrs l__split_fields11))) true)))
(check-sat)
(exit)
