...
(assert (<= 1 i))
(assert (<= i n2))
(assert (and (= o5 (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) i)) (in_range2 o5)))
(assert (and (= o1 (* 2 i)) (in_range7 (* 2 i))))
(assert (= o2 (- o1 1)))
(assert (and (= o3 o2) (in_range7 o2)))
(assert (and (= o4 o3) (in_range3 o3)))
(assert (and (= o (elements (mk___rep s__split_discrs s__split_fields1))) (and (and (and (= (length1 o) (length (mk___rep s__split_discrs s__split_fields1))) (forall ((temp___432 Int)) (=> (and (in_range3 temp___432) (= (iter_has_element o temp___432) true)) (= (contains (model__ (mk___rep s__split_discrs s__split_fields1)) (get o temp___432)) true)))) (forall ((item Int)) (=> (and (in_range5 item) (= (contains (model__ (mk___rep s__split_discrs s__split_fields1)) item) true)) (and (< 0 (find o item)) (= (equivalent_elements (get o (find o item)) item) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep s__split_discrs s__split_fields1)))) (and (= (find o (get o i1)) i1) (= (e_is_find o (get o i1) i1) true)))))))
(assert (and (= o6 (get o o4)) (in_range2 o6)))
(assert (= o7 (ite (= o6 o5) true false)))
(assert (not (<= i (last (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields)))))))
(check-sat)
(exit)
