...
(assert (<= 1 i))
(assert (<= i n2))
(assert (and (= o17 (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) i)) (in_range5 o17)))
(assert (and (= o13 (* 2 i)) (in_range1 (* 2 i))))
(assert (= o14 (- o13 1)))
(assert (and (= o15 o14) (in_range1 o14)))
(assert (and (= o16 o15) (in_range4 o15)))
(assert (and (= o12 (elements (mk___rep s__split_discrs s__split_fields2))) (and (and (and (= (length2 o12) (length (mk___rep s__split_discrs s__split_fields2))) (forall ((temp___390 Int)) (=> (and (in_range4 temp___390) (= (iter_has_element o12 temp___390) true)) (= (contains (model__ (mk___rep s__split_discrs s__split_fields2)) (get o12 temp___390)) true)))) (forall ((item Int)) (=> (and (in_range7 item) (= (contains (model__ (mk___rep s__split_discrs s__split_fields2)) item) true)) (and (< 0 (find o12 item)) (= (equivalent_elements (get o12 (find o12 item)) item) true))))) (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 (length (mk___rep s__split_discrs s__split_fields2)))) (and (= (find o12 (get o12 i4)) i4) (= (e_is_find o12 (get o12 i4) i4) true)))))))
(assert (and (= o18 (get o12 o16)) (in_range5 o18)))
