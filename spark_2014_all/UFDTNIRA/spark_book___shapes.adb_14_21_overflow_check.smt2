...
(assert (= delta_y1 o3))
(assert (and (= o5 (* (to_rep1 (rec__shapes__circle__radius (us_split_fields1 c))) (to_rep1 (rec__shapes__circle__radius (us_split_fields1 c))))) (in_range1 (* (to_rep1 (rec__shapes__circle__radius (us_split_fields1 c))) (to_rep1 (rec__shapes__circle__radius (us_split_fields1 c)))))))
(assert (and (= o6 o5) (in_range4 o5)))
(assert (and (= o4 (* delta_y1 delta_y1)) (in_range1 (* delta_y1 delta_y1))))
(assert (not (in_range1 (* delta_x1 delta_x1))))
(check-sat)
(exit)
