...
(define-fun default_initial_assumption ((temp___expr_368 us_rep2) (temp___skip_top_level_369 Bool)) Bool (=> (not (= temp___skip_top_level_369 true)) (and (= (is_empty temp___expr_368) true) (= (length2 temp___expr_368) 0))))
(assert (forall ((container us_rep2)) (forall ((key Int)) (! (=> (dynamic_invariant1 key true true true true) (=> (= (distinct 1 0) true) (=> (exists ((k Int)) (and (and (in_range2 k) (= (has_key container k) true)) (= (equivalent_keys k key) true))) (= (has_key container key) true)))) :pattern ((has_key container key))))))
...
(define-fun dynamic_invariant2 ((temp___expr_389 Int) (temp___is_init_385 Bool) (temp___skip_constant_386 Bool) (temp___do_toplevel_387 Bool) (temp___do_typ_inv_388 Bool)) Bool (=> (or (= temp___is_init_385 true) (<= 1 2147483647)) (in_range4 temp___expr_389)))
(define-fun dynamic_invariant3 ((temp___expr_396 Int) (temp___is_init_392 Bool) (temp___skip_constant_393 Bool) (temp___do_toplevel_394 Bool) (temp___do_typ_inv_395 Bool)) Bool (=> (or (= temp___is_init_392 true) (<= 0 2147483647)) (in_range3 temp___expr_396)))
...
(define-fun default_initial_assumption1 ((temp___expr_404 us_rep3) (temp___skip_top_level_405 Bool)) Bool (=> (not (= temp___skip_top_level_405 true)) (= (length3 temp___expr_404) 0)))
(assert (forall ((container us_rep3)) (forall ((position Int)) (! (=> (and (dynamic_invariant3 position true true true true) (and (<= 1 position) (<= position (last container)))) (dynamic_invariant2 (get container position) true false true true)) :pattern ((get container position))))))
...
(define-fun default_initial_assumption2 ((temp___expr_427 us_rep4) (temp___skip_top_level_428 Bool)) Bool (=> (not (= temp___skip_top_level_428 true)) (and (= (is_empty1 temp___expr_427) true) (= (length4 temp___expr_427) 0))))
...
(define-fun k_is_find ((container us_rep3) (key Int) (position Int)) Bool (and (ite (< 0 position) (k_bigger_than_range container 1 (- position 1) key) (distinct 1 0)) (ite (< position (length3 container)) (k_smaller_than_range container (+ position 1) (length3 container) key) (distinct 1 0))))
...
(assert (forall ((container us_rep)) (! (let ((result (keys container))) (and (and (and (= (length3 result) (length container)) (forall ((temp___442 Int)) (=> (and (in_range3 temp___442) (= (iter_has_element result temp___442) true)) (= (has_key (model__ container) (get result temp___442)) true)))) (forall ((key Int)) (=> (and (in_range2 key) (= (has_key (model__ container) key) true)) (and (< 0 (find result key)) (= (equivalent_keys (get result (find result key)) key) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (and (= (find result (get result i)) i) (= (k_is_find result (get result i) i) true)))))) :pattern ((keys container)))))
...
(assert (forall ((attr__tag Int)) (forall ((container us_rep)) (forall ((position us_rep1)) (! (dynamic_invariant5 (key1 attr__tag container position) true false true true) :pattern ((key1 attr__tag container position)))))))
...
(assert (forall ((attr__tag Int)) (forall ((container us_rep)) (forall ((position us_rep1)) (! (dynamic_invariant6 (element1 attr__tag container position) true false true true) :pattern ((element1 attr__tag container position)))))))
...
(assert (forall ((attr__tag Int) (key2 Int)) (forall ((container us_rep)) (! (=> (dynamic_invariant5 key2 true true true true) (dynamic_invariant6 (element__21 attr__tag container key2) true false true true)) :pattern ((element__21 attr__tag container key2))))))
...
(assert (forall ((container us_rep3)) (forall ((key2 Int)) (! (=> (dynamic_invariant5 key2 true true true true) (let ((result (find container key2))) (and (=> (< 0 result) (and (<= result (length3 container)) (= (equivalent_keys key2 (get container result)) true))) (dynamic_invariant result true false true true)))) :pattern ((find container key2))))))
(declare-fun keys_included1 (us_rep4 us_rep4) Bool)
(declare-fun keys_included__function_guard1 (Bool us_rep4 us_rep4) Bool)
(assert (forall ((small us_rep4) (big us_rep4)) (forall ((cut Int) (count Int)) (! (=> (and (dynamic_invariant8 cut true true true true) (dynamic_invariant count true true true true)) (= (= (p_positions_shifted small big cut count) true) (and (and (= (keys_included1 small big) true) (forall ((i us_rep1)) (=> (= (has_key1 small i) true) (ite (< (get1 small i) cut) (= (get1 big i) (get1 small i)) (= (- (get1 big i) count) (get1 small i)))))) (forall ((i us_rep1)) (=> (= (has_key1 big i) true) (or (= (has_key1 small i) true) (and (<= (- cut count) (- (get1 big i) count)) (<= (- (get1 big i) count) (- cut 1))))))))) :pattern ((p_positions_shifted small big cut count))))))
...
(assert (forall ((container us_rep2)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant1 key2 true true true true) (= (has_key container key2) true)) (let ((result (get2 container key2))) (and (=> (= (distinct 1 0) true) (and (= result (w_get1 container (witness1 container key2))) (forall ((k Int)) (=> (and (in_range2 k) (= (has_key container k) true)) (= (= (equivalent_keys k key2) true) (= (witness1 container key2) (witness1 container k))))))) (dynamic_invariant9 result true false true true)))) :pattern ((get2 container key2))))))
...
(assert true)
(assert (forall ((container us_rep2)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant1 key2 true true true true) (= (has_key container key2) true)) (let ((result (witness1 container key2))) (and (= (has_witness container result) true) (dynamic_invariant result true false true true)))) :pattern ((witness1 container key2))))))
(assert (forall ((container us_rep2)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant witness2 true true true true) (= (has_witness container witness2) true)) (dynamic_invariant9 (w_get1 container witness2) true false true true)) :pattern ((w_get1 container witness2))))))
...
(assert true)
(assert (forall ((container us_rep4)) (forall ((key2 us_rep1)) (! (=> (= (has_key1 container key2) true) (let ((result (witness container key2))) (and (= (has_witness1 container result) true) (dynamic_invariant result true false true true)))) :pattern ((witness container key2))))))
...
(define-fun temp___6771 () us_rep1 (mk___rep1 (mk___split_fields1 temp___677)))
(define-fun use_ordered_maps__apply_f__cu__assume1 () us_rep1 (mk___rep1 (mk___split_fields1 use_ordered_maps__apply_f__cu__assume)))
(assert (<= (length s) (to_rep (rec__use_ordered_maps__my_maps__map__capacity r__split_discrs))))
(assert (and (= use_ordered_maps__apply_f__cu__assume1 (first s)) (ite (= (= (length s) 0) true) (= (bool_eq1 use_ordered_maps__apply_f__cu__assume1 no_element) true) (and (= (has_key1 (positions s) use_ordered_maps__apply_f__cu__assume1) true) (= (get1 (positions s) use_ordered_maps__apply_f__cu__assume1) 1)))))
...
(assert (=> (= result1 true) (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields10)) 1))) (let ((temp___687 (keys (mk___rep r__split_discrs r__split_fields10)))) (exists ((temp___686 Int)) (and (and (in_range3 temp___686) (= (iter_has_element temp___687 temp___686) true)) (= (get2 (model__ (mk___rep r__split_discrs r__split_fields10)) (get temp___687 temp___686)) (f (get2 (model__ s) (get (keys s) i)))))))))))
(assert (=> (= result1 true) (let ((temp___693 (keys (mk___rep r__split_discrs r__split_fields10)))) (forall ((temp___692 Int)) (=> (and (in_range3 temp___692) (= (iter_has_element temp___693 temp___692) true)) (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields10)) 1))) (= (get2 (model__ (mk___rep r__split_discrs r__split_fields10)) (get temp___693 temp___692)) (f (get2 (model__ s) (get (keys s) i)))))))))))
...
(assert (not (= (length (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) (length s))))
(check-sat)
(exit)
