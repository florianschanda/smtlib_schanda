...
(assert (forall ((container us_rep2)) (forall ((key Int)) (! (=> (dynamic_invariant1 key true true true) (=> (= (of_int 1) true) (=> (exists ((k Int)) (and (and (in_range2 k) (= (has_key container k) true)) (= (equivalent_keys k key) true))) (= (has_key container key) true)))) :pattern ((has_key container key))))))
...
(define-fun dynamic_invariant3 ((temp___expr_358 Int) (temp___is_init_355 Bool) (temp___skip_constant_356 Bool) (temp___do_toplevel_357 Bool)) Bool (=> (or (= temp___is_init_355 true) (<= 0 2147483647)) (in_range3 temp___expr_358)))
...
(define-fun dynamic_invariant4 ((temp___expr_378 Int) (temp___is_init_375 Bool) (temp___skip_constant_376 Bool) (temp___do_toplevel_377 Bool)) Bool (=> (or (= temp___is_init_375 true) (<= 1 2147483647)) (in_range5 temp___expr_378)))
...
(assert (forall ((container us_rep)) (! (let ((result (keys container))) (and (and (and (= (length3 result) (length container)) (forall ((temp___399 Int)) (=> (and (in_range3 temp___399) (= (iter_has_element result temp___399) true)) (= (has_key (model__ container) (get result temp___399)) true)))) (forall ((key Int)) (=> (and (in_range2 key) (= (has_key (model__ container) key) true)) (and (< 0 (find result key)) (= (equivalent_keys (get result (find result key)) key) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (and (= (find result (get result i)) i) (= (k_is_find result (get result i) i) true)))))) :pattern ((keys container)))))
...
(define-fun dynamic_invariant5 ((temp___expr_289 Int) (temp___is_init_286 Bool) (temp___skip_constant_287 Bool) (temp___do_toplevel_288 Bool)) Bool (=> (or (= temp___is_init_286 true) (<= 1 2147483647)) (in_range6 temp___expr_289)))
...
(define-fun dynamic_invariant6 ((temp___expr_295 Int) (temp___is_init_292 Bool) (temp___skip_constant_293 Bool) (temp___do_toplevel_294 Bool)) Bool (=> (or (= temp___is_init_292 true) (<= (- 2147483648) 2147483647)) (in_range7 temp___expr_295)))
...
(define-fun dynamic_invariant8 ((temp___expr_315 Int) (temp___is_init_312 Bool) (temp___skip_constant_313 Bool) (temp___do_toplevel_314 Bool)) Bool (=> (or (= temp___is_init_312 true) (<= 1 2147483647)) (in_range9 temp___expr_315)))
(assert (forall ((container us_rep3)) (forall ((key2 Int)) (! (=> (dynamic_invariant5 key2 true true true) (let ((result (find container key2))) (and (=> (< 0 result) (and (<= result (length3 container)) (= (equivalent_keys key2 (get container result)) true))) (dynamic_invariant result true false true)))) :pattern ((find container key2))))))
(declare-fun keys_included1 (us_rep4 us_rep4) Bool)
(declare-fun keys_included__function_guard1 (Bool us_rep4 us_rep4) Bool)
(assert (forall ((small us_rep4) (big us_rep4)) (forall ((cut Int) (count Int)) (! (=> (and (dynamic_invariant8 cut true true true) (dynamic_invariant count true true true)) (= (= (p_positions_shifted small big cut count) true) (and (and (= (keys_included1 small big) true) (forall ((i us_rep1)) (=> (= (has_key1 small i) true) (ite (< (get1 small i) cut) (= (get1 big i) (get1 small i)) (= (- (get1 big i) count) (get1 small i)))))) (forall ((i us_rep1)) (=> (= (has_key1 big i) true) (or (= (has_key1 small i) true) (and (<= (- cut count) (- (get1 big i) count)) (<= (- (get1 big i) count) (- cut 1))))))))) :pattern ((p_positions_shifted small big cut count))))))
...
(define-fun dynamic_invariant9 ((temp___expr_327 Int) (temp___is_init_324 Bool) (temp___skip_constant_325 Bool) (temp___do_toplevel_326 Bool)) Bool (=> (or (= temp___is_init_324 true) (<= (- 2147483648) 2147483647)) (in_range10 temp___expr_327)))
...
(assert (forall ((container us_rep2)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant1 key2 true true true) (= (has_key container key2) true)) (let ((result (get2 container key2))) (and (=> (= (of_int 1) true) (and (= result (w_get1 container (witness1 container key2))) (forall ((k Int)) (=> (and (in_range2 k) (= (has_key container k) true)) (= (= (equivalent_keys k key2) true) (= (witness1 container key2) (witness1 container k))))))) (dynamic_invariant9 result true false true)))) :pattern ((get2 container key2))))))
...
(define-fun temp___6341 () us_rep1 (mk___rep1 (mk___split_fields1 temp___634)))
...
(assert (=> (= result1 true) (and (= r__split_discrs (mk___split_discrs temp___636)) (= temp___6361 r__split_fields))))
...
(assert (=> (= result1 true) (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields10)) 1))) (let ((temp___644 (keys (mk___rep r__split_discrs r__split_fields10)))) (exists ((temp___643 Int)) (and (and (in_range3 temp___643) (= (iter_has_element temp___644 temp___643) true)) (= (get2 (model__ (mk___rep r__split_discrs r__split_fields10)) (get temp___644 temp___643)) (f (get2 (model__ s) (get (keys s) i)))))))))))
(assert (=> (= result1 true) (let ((temp___650 (keys (mk___rep r__split_discrs r__split_fields10)))) (forall ((temp___649 Int)) (=> (and (in_range3 temp___649) (= (iter_has_element temp___650 temp___649) true)) (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields10)) 1))) (= (get2 (model__ (mk___rep r__split_discrs r__split_fields10)) (get temp___650 temp___649)) (f (get2 (model__ s) (get (keys s) i)))))))))))
...
(assert (=> (= result1 true) (and (= temp___6341 (next s (mk___rep1 cu__split_fields10))) (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields10) no_element) false) (= (get1 (positions s) (mk___rep1 cu__split_fields10)) (length s)) true) true) (= (bool_eq1 temp___6341 no_element) true) (and (= (has_key1 (positions s) temp___6341) true) (= (get1 (positions s) temp___6341) (+ (get1 (positions s) (mk___rep1 cu__split_fields10)) 1)))))))
(assert (=> (= result1 true) (= result2 cu__split_fields2)))
(assert (=> (= result1 true) (= cu__split_fields3 (mk___split_fields1 temp___634))))
