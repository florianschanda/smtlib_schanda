...
(define-fun in_range1 ((x Int)) Bool (and (<= (- 10000000000) x) (<= x 10000000000)))
...
(assert (forall ((x Int)) (forall ((y Int)) (! (ite (or (= x 0) (= y 0)) (= (fxp_mult1 x y) 0) (ite (or (and (< 0 x) (< 0 y)) (and (< x 0) (< y 0))) (pos_div_relation1 (fxp_mult1 x y) (* x y) 1000000000) (pos_div_relation1 (- (fxp_mult1 x y)) (- (* x y)) 1000000000))) :pattern ((fxp_mult1 x y))))))
(declare-fun fxp_div1 (Int Int) Int)
(assert (forall ((x Int)) (forall ((y Int)) (! (ite (= x 0) (= (fxp_div1 x y) 0) (ite (and (< 0 x) (< 0 y)) (pos_div_relation1 (fxp_div1 x y) (* x 1000000000) y) (ite (and (< x 0) (< y 0)) (pos_div_relation1 (fxp_div1 x y) (* (- x) 1000000000) (- y)) (ite (and (< x 0) (< 0 y)) (pos_div_relation1 (- (fxp_div1 x y)) (* (- x) 1000000000) y) (=> (and (< 0 x) (< y 0)) (pos_div_relation1 (- (fxp_div1 x y)) (* x 1000000000) (- y))))))) :pattern ((fxp_div1 x y))))))
...
(assert (forall ((x Int)) (! (ite (= x 0) (= (to_int2 x) 0) (ite (< 0 x) (pos_div_relation1 (to_int2 x) x 1000000000) (pos_div_relation1 (- (to_int2 x)) (- x) 1000000000))) :pattern ((to_int2 x)))))
(declare-fun of_real1 (Real) Int)
(assert (forall ((x my_subduration)) (! (= (of_fixed1 (to_fixed1 x)) x) :pattern ((to_fixed1 x)))))
...
(assert (= result ms))
(assert (= ms1 o))
(assert (not (= (to_fixed1 (of_fixed1 (to_fixed (of_fixed (to_fixed1 ms1))))) (to_fixed1 ms1))))
(check-sat)
(exit)
