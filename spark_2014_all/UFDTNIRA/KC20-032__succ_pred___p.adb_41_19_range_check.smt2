...
(define-fun in_range ((x Int)) Bool (and (<= (- 999999999999999) x) (<= x 999999999999999)))
...
(declare-const dummy money)
(declare-fun attr__ATTRIBUTE_IMAGE (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE (us_image) Int)
(declare-fun to_fixed (money) Int)
(declare-fun of_fixed (Int) money)
(declare-fun user_eq (money money) Bool)
...
(assert (forall ((x money)) (! (= (of_fixed (to_fixed x)) x) :pattern ((to_fixed x)))))
(assert (forall ((x money)) (in_range (to_fixed x))))
...
(declare-const dummy1 tmoneyB)
(declare-fun attr__ATTRIBUTE_IMAGE1 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check1 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE1 (us_image) Int)
(declare-fun to_fixed1 (tmoneyB) Int)
(declare-fun of_fixed1 (Int) tmoneyB)
(declare-fun user_eq1 (tmoneyB tmoneyB) Bool)
...
(assert (forall ((x tmoneyB)) (! (= (of_fixed1 (to_fixed1 x)) x) :pattern ((to_fixed1 x)))))
(assert (forall ((x tmoneyB)) (in_range1 (to_fixed1 x))))
...
(assert (not (= (to_fixed m) 999999999999999)))
(assert (not (in_range (- (+ (to_fixed m) 1) 1))))
(check-sat)
(exit)
