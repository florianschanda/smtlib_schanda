...
(declare-const p__ident__4__result money)
(declare-const o money)
(declare-const result money)
(declare-const p__ident__4__result1 money)
(declare-const p__ident__4__result2 money)
(declare-const p__ident__4__result3 money)
(declare-const p__ident__4__result4 money)
(declare-const p__ident__4__result5 money)
(assert (not (= (to_fixed1 m) 999999999999999)))
(assert (not (in_range1 (- (+ (to_fixed1 m) 1) 1))))
(check-sat)
(exit)
