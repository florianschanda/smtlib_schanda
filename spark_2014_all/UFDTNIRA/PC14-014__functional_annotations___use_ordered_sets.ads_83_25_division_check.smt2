...
(assert (= (= o2 true) (in_range4 temp___847)))
(assert (= result (ite (= o2 true) o1 false)))
(assert (= (= o3 true) (let ((temp___850 (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))))) (forall ((temp___849 Int)) (=> (and (in_range4 temp___849) (= (iter_has_element temp___850 temp___849) true)) (= (mod2 (get temp___850 temp___849) 2) 0))))))
(assert (and (= o (length (mk___rep s__split_discrs (mk___split_fields s__split_fields)))) (and (in_range2 o) (<= o (to_rep (rec__use_ordered_sets__my_sets__set__capacity s__split_discrs))))))
(assert (not (not (= 2 0))))
(check-sat)
(exit)
