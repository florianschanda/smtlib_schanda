...
(assert (= (= o3 true) (let ((temp___808 (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))))) (forall ((temp___807 Int)) (=> (and (in_range4 temp___807) (= (iter_has_element temp___808 temp___807) true)) (= (mod2 (get temp___808 temp___807) 2) 0))))))
