...
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get2 (positions (mk___rep s__split_discrs s__split_fields4)) (mk___rep1 cu__split_fields3)) 1))) (= (get (model__ (mk___rep s__split_discrs s__split_fields4)) (get1 (keys (mk___rep s__split_discrs s__split_fields4)) i)) (f (get (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (get1 (keys (mk___rep s__split_discrs s__split_fields4)) i)))))))
(assert (forall ((i Int)) (=> (and (<= (get2 (positions (mk___rep s__split_discrs s__split_fields4)) (mk___rep1 cu__split_fields3)) i) (<= i (length (mk___rep s__split_discrs s__split_fields4)))) (= (get (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (get1 (keys (mk___rep s__split_discrs s__split_fields4)) i)) (get (model__ (mk___rep s__split_discrs s__split_fields4)) (get1 (keys (mk___rep s__split_discrs s__split_fields4)) i))))))
(assert (and (= o1 (element (mk___rep s__split_discrs s__split_fields4) (mk___rep1 cu__split_fields3))) (and (in_range8 o1) (= o1 (get (model__ (mk___rep s__split_discrs s__split_fields4)) (key (mk___rep s__split_discrs s__split_fields4) (mk___rep1 cu__split_fields3)))))))
(assert (and (= o2 (f o1)) (and (in_range9 o2) (= o2 (ite (and (<= (- 100) o1) (<= o1 100)) (* o1 2) o1)))))
(assert (and (= o (key (mk___rep s__split_discrs s__split_fields4) (mk___rep1 cu__split_fields3))) (and (in_range7 o) (= o (get1 (keys (mk___rep s__split_discrs s__split_fields4)) (get2 (positions (mk___rep s__split_discrs s__split_fields4)) (mk___rep1 cu__split_fields3)))))))
...
(assert (not (or (= (has_key1 (positions (mk___rep s__split_discrs s__split_fields3)) (mk___rep1 cu__split_fields3)) true) (= (bool_eq1 (mk___rep1 cu__split_fields3) no_element) true))))
(check-sat)
(exit)
