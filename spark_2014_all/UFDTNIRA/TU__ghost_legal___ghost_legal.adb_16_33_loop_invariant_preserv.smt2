...
(assert (= ghost_legal__is_prime__result2 ghost_legal__is_prime__result))
(assert (= ghost_legal__is_prime__result2 ghost_legal__is_prime__result1))
(assert (= (mk_int__ref result) (mk_int__ref temp)))
(assert (= temp1 2))
(assert (< temp1 x))
(assert (<= 2 temp2))
(assert (and (=> (<= 0 2147483647) (in_range2 temp2)) (< temp2 x)))
(assert (not (= (mod2 x temp2) 0)))
(assert (= ghost_legal__is_prime__result4 ghost_legal__is_prime__result3))
(assert (and (= o (+ temp2 1)) (in_range1 (+ temp2 1))))
(assert (= temp2 result1))
(assert (= temp3 o))
(assert (< temp3 x))
(assert (not (<= 2 temp3)))
(check-sat)
