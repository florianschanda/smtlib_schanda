...
(assert (and (= temp___685 (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields1)))) (= (length4 temp___685) (length (mk___rep r__split_discrs (mk___split_fields r__split_fields1))))))
(assert (not true))
(check-sat)
(exit)
