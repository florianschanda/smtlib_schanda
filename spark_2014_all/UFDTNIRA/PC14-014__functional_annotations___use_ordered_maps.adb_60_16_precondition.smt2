...
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (and (= (has_key (model__ (mk___rep r__split_discrs r__split_fields4)) (get (keys s) i)) true) (= (get2 (model__ (mk___rep r__split_discrs r__split_fields4)) (get (keys s) i)) (f (get2 (model__ s) (get (keys s) i))))))))
(assert (let ((temp___690 (keys (mk___rep r__split_discrs r__split_fields4)))) (forall ((temp___689 Int)) (=> (and (in_range3 temp___689) (= (iter_has_element temp___690 temp___689) true)) (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (= (get temp___690 temp___689) (get (keys s) i))))))))
