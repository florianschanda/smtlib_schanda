...
(assert (= result1 true))
(assert (= temp___684 cu__split_fields1))
(assert (and (= r__split_discrs (mk___split_discrs temp___683)) (= temp___6831 r__split_fields)))
...
(assert (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (- (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))) (and (= (has_key (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) (get (keys s) i2)) true) (= (get2 (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) (get (keys s) i2)) (f (get2 (model__ s) (get (keys s) i2))))))))
(assert (let ((temp___690 (keys (mk___rep r__split_discrs (mk___split_fields r__split_fields1))))) (forall ((temp___689 Int)) (=> (and (in_range3 temp___689) (= (iter_has_element temp___690 temp___689) true)) (exists ((i2 Int)) (and (and (<= 1 i2) (<= i2 (- (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))) (= (get temp___690 temp___689) (get (keys s) i2))))))))
(assert (and (= o25 (element s (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range7 o25) (= o25 (get2 (model__ s) (key s (mk___rep1 (mk___split_fields1 cu__split_fields2))))))))
(assert (and (= o26 (f o25)) (and (in_range8 o26) (= o26 (ite (and (<= (- 100) o25) (<= o25 100)) (* o25 2) o25)))))
(assert (and (= o24 (key s (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range6 o24) (= o24 (get (keys s) (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))))))))
...
(assert (= result6 cu__split_fields2))
(assert (= cu__split_fields3 (mk___split_fields1 temp___682)))
(assert (and (= o27 (has_key1 (positions s) (mk___rep1 cu__split_fields3))) (= (= o27 true) (= (has_key1 (positions s) (mk___rep1 cu__split_fields3)) true))))
(assert (= result7 (ite (not (= o27 true)) true false)))
(assert (= result7 true))
(assert (= cu__split_fields4 (mk___split_fields__ref1 cu__split_fields3)))
(assert (= r__split_fields3 (mk___split_fields__ref (mk___split_fields r__split_fields2))))
(assert (= cu__split_fields5 cu__split_fields3))
(assert (= r__split_fields4 (mk___split_fields r__split_fields2)))
...
(assert (not (= (get2 (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) (get (keys s) temp___704)) (f (get2 (model__ s) (get (keys s) temp___704))))))
(check-sat)
(exit)
