...
(assert (<= 1 i))
(assert (<= i n2))
(assert (and (= o7 (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) i)) (in_range5 o7)))
(assert (and (= o3 (* 2 i)) (in_range1 (* 2 i))))
(assert (= o4 (- o3 1)))
(assert (and (= o5 o4) (in_range1 o4)))
(assert (and (= o6 o5) (in_range4 o5)))
(assert (and (= o2 (elements (mk___rep s__split_discrs s__split_fields1))) (and (and (and (= (length2 o2) (length (mk___rep s__split_discrs s__split_fields1))) (forall ((temp___390 Int)) (=> (and (in_range4 temp___390) (= (iter_has_element o2 temp___390) true)) (= (contains (model__ (mk___rep s__split_discrs s__split_fields1)) (get o2 temp___390)) true)))) (forall ((item Int)) (=> (and (in_range7 item) (= (contains (model__ (mk___rep s__split_discrs s__split_fields1)) item) true)) (and (< 0 (find o2 item)) (= (equivalent_elements (get o2 (find o2 item)) item) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep s__split_discrs s__split_fields1)))) (and (= (find o2 (get o2 i1)) i1) (= (e_is_find o2 (get o2 i1) i1) true)))))))
(assert (and (= o8 (get o2 o6)) (in_range5 o8)))
(assert (= o9 (ite (= o8 o7) true false)))
(assert (and (= o (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) i)) (in_range5 o)))
(assert (= o1 (+ o 1)))
