...
(assert (<= 1 i))
(assert (<= i n2))
(assert (and (= o7 (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) i)) (in_range2 o7)))
(assert (and (= o3 (* 2 i)) (in_range7 (* 2 i))))
(assert (= o4 (- o3 1)))
...
(assert (and (= o8 (get o2 o6)) (in_range2 o8)))
(assert (= o9 (ite (= o8 o7) true false)))
(assert (and (= o (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) i)) (in_range2 o)))
(assert (= o1 (+ o 1)))
(assert (not (in_range8 o1)))
(check-sat)
(exit)
