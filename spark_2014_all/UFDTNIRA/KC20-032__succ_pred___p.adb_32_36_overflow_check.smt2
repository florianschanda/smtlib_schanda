...
(declare-fun to_fixed (tvoltB) Int)
(declare-fun of_fixed (Int) tvoltB)
...
(assert (forall ((x tvoltB)) (! (= (of_fixed (to_fixed x)) x) :pattern ((to_fixed x)))))
(assert (forall ((x tvoltB)) (in_range (to_fixed x))))
(assert (forall ((x Int)) (! (=> (in_range x) (= (to_fixed (of_fixed x)) x)) :pattern ((to_fixed (of_fixed x))))))
(declare-datatypes () ((tvoltB__ref (mk_tvoltB__ref (tvoltB__content tvoltB)))))
(define-fun tvoltB__ref___projection ((a tvoltB__ref)) tvoltB (tvoltB__content a))
(declare-sort volt 0)
...
(declare-fun to_fixed1 (volt) Int)
(declare-fun of_fixed1 (Int) volt)
...
(assert (forall ((x Int)) (forall ((y Int)) (! (ite (or (= x 0) (= y 0)) (= (fxp_mult1 x y) 0) (ite (or (and (< 0 x) (< 0 y)) (and (< x 0) (< y 0))) (pos_div_relation1 (fxp_mult1 x y) (* x y) 8) (pos_div_relation1 (- (fxp_mult1 x y)) (- (* x y)) 8))) :pattern ((fxp_mult1 x y))))))
(declare-fun fxp_div1 (Int Int) Int)
(assert (forall ((x Int)) (forall ((y Int)) (! (ite (= x 0) (= (fxp_div1 x y) 0) (ite (and (< 0 x) (< 0 y)) (pos_div_relation1 (fxp_div1 x y) (* x 8) y) (ite (and (< x 0) (< y 0)) (pos_div_relation1 (fxp_div1 x y) (* (- x) 8) (- y)) (ite (and (< x 0) (< 0 y)) (pos_div_relation1 (- (fxp_div1 x y)) (* (- x) 8) y) (=> (and (< 0 x) (< y 0)) (pos_div_relation1 (- (fxp_div1 x y)) (* x 8) (- y))))))) :pattern ((fxp_div1 x y))))))
...
(assert (forall ((x Int)) (! (ite (= x 0) (= (to_int2 x) 0) (ite (< 0 x) (pos_div_relation1 (to_int2 x) x 8) (pos_div_relation1 (- (to_int2 x)) (- x) 8))) :pattern ((to_int2 x)))))
(declare-fun of_real1 (Real) Int)
(assert (forall ((x volt)) (! (= (of_fixed1 (to_fixed1 x)) x) :pattern ((to_fixed1 x)))))
(assert (forall ((x volt)) (in_range1 (to_fixed1 x))))
...
(declare-const p__ident__3__result volt)
(declare-const o volt)
(declare-const result volt)
(declare-const p__ident__3__result1 volt)
(declare-const p__ident__3__result2 volt)
(declare-const p__ident__3__result3 volt)
(declare-const p__ident__3__result4 volt)
(declare-const p__ident__3__result5 volt)
(assert (not (= (to_fixed1 v) 2040)))
(assert (not (not (= (to_fixed1 v) 32767))))
(check-sat)
(exit)
