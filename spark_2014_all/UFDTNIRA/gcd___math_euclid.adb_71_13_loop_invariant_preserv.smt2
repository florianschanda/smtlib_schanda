...
(assert (not (= bn1 0)))
(assert (= (mk_int__ref result2) (mk_int__ref c)))
(assert (= c2 an1))
(assert (and (= o1 bn1) (in_range2 bn1)))
(assert (= an1 result3))
(assert (= an2 o1))
(assert (and (= o2 (mod2 c2 bn1)) (in_range1 (mod2 c2 bn1))))
(assert (= bn1 result4))
(assert (= bn2 o2))
(assert (forall ((x3 Int)) (=> (and (<= 1 x3) (<= x3 2147483647)) (= (and (= (divides x3 c2) true) (= (divides x3 an2) true)) (and (= (divides x3 an2) true) (or (= (divides an2 c2) true) (= (divides x3 (mod2 c2 an2)) true)))))))
(assert (forall ((x3 Int)) (=> (and (<= 1 x3) (<= x3 2147483647)) (= (and (= (divides x3 a) true) (= (divides x3 b) true)) (and (= (divides x3 an3) true) (or (= bn3 0) (= (divides x3 bn3) true)))))))
(assert (and (and (=> (<= 1 2147483647) (in_range2 an3)) (=> (<= 0 2147483647) (in_range1 bn3))) (=> (<= 1 2147483647) (in_range2 c3))))
(assert (not (= bn3 0)))
(assert (= c3 result5))
(assert (= c4 an3))
(assert (and (= o4 bn3) (in_range2 bn3)))
(assert (= an3 result6))
(assert (= an4 o4))
(assert (and (= o5 (mod2 c4 bn3)) (in_range1 (mod2 c4 bn3))))
(assert (= result7 bn3))
(assert (= bn4 o5))
(assert (forall ((x3 Int)) (=> (and (<= 1 x3) (<= x3 2147483647)) (= (and (= (divides x3 c4) true) (= (divides x3 an4) true)) (and (= (divides x3 an4) true) (or (= (divides an4 c4) true) (= (divides x3 (mod2 c4 an4)) true)))))))
(declare-const x3 Int)
(assert (<= 1 x3))
(assert (<= x3 2147483647))
(assert (= (divides x3 a) true))
(assert (= (divides x3 b) true))
(assert (not (= (divides x3 an4) true)))
(check-sat)
(exit)
