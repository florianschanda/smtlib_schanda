...
(assert (= an1 result3))
(assert (= an2 o1))
(assert (and (= o2 (mod2 c1 bn1)) (in_range1 (mod2 c1 bn1))))
(assert (= bn1 result4))
(assert (= bn2 o2))
(assert (forall ((x Int)) (=> (and (<= 1 x) (<= x 2147483647)) (= (and (= (divides x c1) true) (= (divides x an2) true)) (and (= (divides x an2) true) (or (= (divides an2 c1) true) (= (divides x (mod2 c1 an2)) true)))))))
(assert (forall ((x Int)) (=> (and (<= 1 x) (<= x 2147483647)) (= (and (= (divides x a) true) (= (divides x b) true)) (and (= (divides x an3) true) (or (= bn3 0) (= (divides x bn3) true)))))))
(assert (and (and (=> (<= 1 2147483647) (in_range2 an3)) (=> (<= 0 2147483647) (in_range1 bn3))) (=> (<= 1 2147483647) (in_range2 c2))))
(assert (not (= bn3 0)))
(assert (= c2 result5))
(assert (= c3 an3))
(assert (and (= o3 bn3) (in_range2 bn3)))
(assert (= an3 result6))
(assert (= an4 o3))
(assert (and (= o4 (mod2 c3 bn3)) (in_range1 (mod2 c3 bn3))))
(assert (= result7 bn3))
(assert (= bn4 o4))
(assert (forall ((x Int)) (=> (and (<= 1 x) (<= x 2147483647)) (= (and (= (divides x c3) true) (= (divides x an4) true)) (and (= (divides x an4) true) (or (= (divides an4 c3) true) (= (divides x (mod2 c3 an4)) true)))))))
(declare-const x Int)
(assert (<= 1 x))
(assert (<= x 2147483647))
(assert (= (divides x a) true))
(assert (= (divides x b) true))
(assert (not (or (= bn4 0) (= (divides x bn4) true))))
(check-sat)
(exit)
