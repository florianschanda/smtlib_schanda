...
(assert (= m__split_fields2 (us_split_fields1 my_ordered_sets__test_set_pos__B_1__m__assume)))
...
(assert (and (and (= (oeq3 (model__ (mk___rep m__split_discrs m__split_fields3)) (model__ (mk___rep k__split_discrs k__split_fields3))) true) (= (oeq2 (elements (mk___rep m__split_discrs m__split_fields3)) (elements (mk___rep k__split_discrs k__split_fields3))) true)) (= (length (mk___rep m__split_discrs m__split_fields3)) (length (mk___rep k__split_discrs k__split_fields3)))))
(assert (= (oeq (intersection__2 (mk___rep m__split_discrs m__split_fields3) (mk___rep l__split_discrs l__split_fields11)) (intersection__2 (mk___rep k__split_discrs k__split_fields3) (mk___rep l__split_discrs l__split_fields11))) true))
(assert (and (and (and (and (and (and (= (length (mk___rep m__split_discrs m__split_fields4)) (num_overlaps (model__ (mk___rep m__split_discrs m__split_fields3)) (model__ (mk___rep l__split_discrs l__split_fields11)))) (= (ole (model__ (mk___rep m__split_discrs m__split_fields4)) (model__ (mk___rep m__split_discrs m__split_fields3))) true)) (= (ole (model__ (mk___rep m__split_discrs m__split_fields4)) (model__ (mk___rep l__split_discrs l__split_fields11))) true)) (= (includes_intersection (model__ (mk___rep m__split_discrs m__split_fields4)) (model__ (mk___rep l__split_discrs l__split_fields11)) (model__ (mk___rep m__split_discrs m__split_fields3))) true)) (= (e_elements_included (elements (mk___rep m__split_discrs m__split_fields4)) (elements (mk___rep m__split_discrs m__split_fields3))) true)) (= (e_elements_included__2 (elements (mk___rep m__split_discrs m__split_fields3)) (model__ (mk___rep l__split_discrs l__split_fields11)) (elements (mk___rep m__split_discrs m__split_fields4))) true)) (= (mapping_preserved (elements (mk___rep m__split_discrs m__split_fields4)) (elements (mk___rep m__split_discrs m__split_fields3)) (positions (mk___rep m__split_discrs m__split_fields4)) (positions (mk___rep m__split_discrs m__split_fields3))) true)))
...
(assert (= m__split_fields5 (us_split_fields1 my_ordered_sets__test_set_pos__B_2__m__assume)))
(assert (= m__split_discrs1 (us_split_discrs1 my_ordered_sets__test_set_pos__B_2__m__assume)))
(assert (and (and (= (oeq3 (model__ (mk___rep m__split_discrs1 m__split_fields6)) (model__ (mk___rep k__split_discrs k__split_fields3))) true) (= (oeq2 (elements (mk___rep m__split_discrs1 m__split_fields6)) (elements (mk___rep k__split_discrs k__split_fields3))) true)) (= (length (mk___rep m__split_discrs1 m__split_fields6)) (length (mk___rep k__split_discrs k__split_fields3)))))
(assert (and (= o2 (union__2 (mk___rep k__split_discrs k__split_fields3) (mk___rep l__split_discrs l__split_fields11))) (and (and (and (and (and (and (= (length o2) (+ (- (length (mk___rep k__split_discrs k__split_fields3)) (num_overlaps (model__ (mk___rep k__split_discrs k__split_fields3)) (model__ (mk___rep l__split_discrs l__split_fields11)))) (length (mk___rep l__split_discrs l__split_fields11)))) (= (ole (model__ (mk___rep k__split_discrs k__split_fields3)) (model__ o2)) true)) (= (ole (model__ (mk___rep l__split_discrs l__split_fields11)) (model__ o2)) true)) (= (included_in_union (model__ o2) (model__ (mk___rep k__split_discrs k__split_fields3)) (model__ (mk___rep l__split_discrs l__split_fields11))) true)) (= (e_elements_included__3 (elements o2) (model__ (mk___rep k__split_discrs k__split_fields3)) (elements (mk___rep k__split_discrs k__split_fields3)) (elements (mk___rep l__split_discrs l__split_fields11))) true)) (= (e_elements_included__2 (elements (mk___rep k__split_discrs k__split_fields3)) (model__ (mk___rep k__split_discrs k__split_fields3)) (elements o2)) true)) (= (e_elements_included__3 (elements (mk___rep l__split_discrs l__split_fields11)) (model__ (mk___rep k__split_discrs k__split_fields3)) (elements (mk___rep l__split_discrs l__split_fields11)) (elements o2)) true))))
(assert (not (<= (length (mk___rep m__split_discrs1 m__split_fields6)) (- 2147483647 (length (mk___rep l__split_discrs l__split_fields11))))))
(check-sat)
(exit)
