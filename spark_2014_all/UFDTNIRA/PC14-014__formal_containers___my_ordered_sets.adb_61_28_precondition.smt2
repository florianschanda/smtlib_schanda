...
(assert (and (= o15 (union__2 (mk___rep k__split_discrs k__split_fields3) (mk___rep l__split_discrs l__split_fields11))) (and (and (and (and (and (and (= (length o15) (+ (- (length (mk___rep k__split_discrs k__split_fields3)) (num_overlaps (model__ (mk___rep k__split_discrs k__split_fields3)) (model__ (mk___rep l__split_discrs l__split_fields11)))) (length (mk___rep l__split_discrs l__split_fields11)))) (= (ole (model__ (mk___rep k__split_discrs k__split_fields3)) (model__ o15)) true)) (= (ole (model__ (mk___rep l__split_discrs l__split_fields11)) (model__ o15)) true)) (= (included_in_union (model__ o15) (model__ (mk___rep k__split_discrs k__split_fields3)) (model__ (mk___rep l__split_discrs l__split_fields11))) true)) (= (e_elements_included__3 (elements o15) (model__ (mk___rep k__split_discrs k__split_fields3)) (elements (mk___rep k__split_discrs k__split_fields3)) (elements (mk___rep l__split_discrs l__split_fields11))) true)) (= (e_elements_included__2 (elements (mk___rep k__split_discrs k__split_fields3)) (model__ (mk___rep k__split_discrs k__split_fields3)) (elements o15)) true)) (= (e_elements_included__3 (elements (mk___rep l__split_discrs l__split_fields11)) (model__ (mk___rep k__split_discrs k__split_fields3)) (elements (mk___rep l__split_discrs l__split_fields11)) (elements o15)) true))))
(assert (not (<= (length (mk___rep m__split_discrs1 m__split_fields8)) (- 2147483647 (length (mk___rep l__split_discrs l__split_fields11))))))
(check-sat)
(exit)
