...
(assert (= bn1 result4))
(assert (= bn2 o2))
(assert (forall ((x1 Int)) (=> (and (<= 1 x1) (<= x1 2147483647)) (= (and (= (divides x1 c1) true) (= (divides x1 an2) true)) (and (= (divides x1 an2) true) (or (= (divides an2 c1) true) (= (divides x1 (mod2 c1 an2)) true)))))))
(assert (forall ((x1 Int)) (=> (and (<= 1 x1) (<= x1 2147483647)) (= (and (= (divides x1 a) true) (= (divides x1 b) true)) (and (= (divides x1 an3) true) (or (= bn3 0) (= (divides x1 bn3) true)))))))
(assert (and (and (=> (<= 1 2147483647) (in_range2 an3)) (=> (<= 0 2147483647) (in_range1 bn3))) (=> (<= 1 2147483647) (in_range2 c2))))
(assert (<= 1 x))
(assert (<= x 2147483647))
(assert (not (= bn3 0)))
(assert (not (in_range2 bn3)))
(check-sat)
(exit)
