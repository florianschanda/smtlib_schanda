...
(assert (and (= temp___493 (+ j (length (mk___rep v__split_discrs (mk___split_fields v__split_fields))))) (in_range1 (+ j (length (mk___rep v__split_discrs (mk___split_fields v__split_fields)))))))
(assert (and (= us temp___493) (dynamic_property1 first1 last1 temp___493)))
(assert (= o3 temp___493))
