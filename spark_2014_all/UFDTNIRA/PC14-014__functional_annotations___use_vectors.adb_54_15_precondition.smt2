...
(assert (= o14 j1))
(assert (and (= o15 (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) o14)) (in_range3 o15)))
(assert (and (= temp___454 (+ j1 (length (mk___rep v__split_discrs (mk___split_fields v__split_fields))))) (in_range1 (+ j1 (length (mk___rep v__split_discrs (mk___split_fields v__split_fields)))))))
(assert (and (= us2 temp___454) (dynamic_property1 first1 last1 temp___454)))
(assert (= o13 temp___454))
(assert (not (<= first1 o13)))
(check-sat)
(exit)
