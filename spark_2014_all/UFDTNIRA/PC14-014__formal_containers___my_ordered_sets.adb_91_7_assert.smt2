...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__my_ordered_sets__m__set__capacity (us_split_discrs1 container)))) (dynamic_invariant result true false true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant1 ((temp___expr_366 Int) (temp___is_init_363 Bool) (temp___skip_constant_364 Bool) (temp___do_toplevel_365 Bool)) Bool (=> (or (= temp___is_init_363 true) (<= 1 2147483647)) (in_range2 temp___expr_366)))
...
(define-fun default_initial_assumption ((temp___expr_373 us_rep2) (temp___skip_top_level_374 Bool)) Bool (=> (not (= temp___skip_top_level_374 true)) (and (= (is_empty temp___expr_373) true) (= (length2 temp___expr_373) 0))))
...
(define-fun dynamic_invariant2 ((temp___expr_289 Int) (temp___is_init_286 Bool) (temp___skip_constant_287 Bool) (temp___do_toplevel_288 Bool)) Bool (=> (or (= temp___is_init_286 true) (<= 0 2147483647)) (in_range4 temp___expr_289)))
(assert true)
...
(define-fun e_is_find ((container us_rep3) (item Int) (position Int)) Bool (and (ite (< 0 position) (e_bigger_than_range container 1 (- position 1) item) (of_int 1)) (ite (< position (length3 container)) (e_smaller_than_range container (+ position 1) (length3 container) item) (of_int 1))))
...
(define-fun dynamic_invariant3 ((temp___expr_781 us_rep) (temp___is_init_778 Bool) (temp___skip_constant_779 Bool) (temp___do_toplevel_780 Bool)) Bool (=> (not (= temp___skip_constant_779 true)) (in_range5 10 temp___expr_781)))
(define-fun default_initial_assumption1 ((temp___expr_783 us_rep) (temp___skip_top_level_784 Bool)) Bool (and (= (to_rep (rec__my_ordered_sets__m__set__capacity (us_split_discrs1 temp___expr_783))) 10) (=> (not (= temp___skip_top_level_784 true)) (= (is_empty1 temp___expr_783) true))))
...
(define-fun dynamic_invariant4 ((temp___expr_790 us_rep) (temp___is_init_787 Bool) (temp___skip_constant_788 Bool) (temp___do_toplevel_789 Bool)) Bool (=> (not (= temp___skip_constant_788 true)) (in_range6 10 temp___expr_790)))
(define-fun default_initial_assumption2 ((temp___expr_792 us_rep) (temp___skip_top_level_793 Bool)) Bool (and (= (to_rep (rec__my_ordered_sets__m__set__capacity (us_split_discrs1 temp___expr_792))) 10) (=> (not (= temp___skip_top_level_793 true)) (= (is_empty1 temp___expr_792) true))))
...
(define-fun dynamic_invariant5 ((temp___expr_309 Int) (temp___is_init_306 Bool) (temp___skip_constant_307 Bool) (temp___do_toplevel_308 Bool)) Bool (=> (or (= temp___is_init_306 true) (<= 1 2147483647)) (in_range7 temp___expr_309)))
(assert (forall ((a us_rep3) (b us_rep3)) (! (= (user_eq6 a b) (oeq2 a b)) :pattern ((user_eq6 a b)))))
(define-fun default_initial_assumption3 ((temp___expr_353 us_rep3) (temp___skip_top_level_354 Bool)) Bool (=> (not (= temp___skip_top_level_354 true)) (= (length3 temp___expr_353) 0)))
(assert (forall ((container us_rep3)) (forall ((item Int)) (! (=> (dynamic_invariant2 item true true true) (let ((result (find container item))) (and (=> (< 0 result) (and (<= result (length3 container)) (= (equivalent_elements item (get1 container result)) true))) (dynamic_invariant result true false true)))) :pattern ((find container item))))))
...
(define-fun default_initial_assumption4 ((temp___expr_322 us_rep4) (temp___skip_top_level_323 Bool)) Bool (=> (not (= temp___skip_top_level_323 true)) (= (is_empty3 temp___expr_322) true)))
...
(assert (forall ((container us_rep)) (! (let ((result (elements container))) (and (and (and (= (length3 result) (length container)) (forall ((temp___387 Int)) (=> (and (in_range3 temp___387) (= (iter_has_element result temp___387) true)) (= (contains (model__ container) (get1 result temp___387)) true)))) (forall ((item Int)) (=> (and (in_range8 item) (= (contains (model__ container) item) true)) (and (< 0 (find result item)) (= (equivalent_elements (get1 result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (and (= (find result (get1 result i)) i) (= (e_is_find result (get1 result i) i) true)))))) :pattern ((elements container)))))
...
(assert (forall ((container us_rep)) (! (=> (not (= (is_empty1 container) true)) (let ((result (first_element container))) (and (and (= result (get1 (elements container) 1)) (= (e_smaller_than_range (elements container) 2 (length container) result) true)) (dynamic_invariant2 result true false true)))) :pattern ((first_element container)))))
(assert (forall ((attr__tag Int)) (forall ((container us_rep)) (! (dynamic_invariant2 (first_element1 attr__tag container) true false true) :pattern ((first_element1 attr__tag container))))))
(assert (forall ((container us_rep)) (! (=> (not (= (is_empty1 container) true)) (let ((result (last_element container))) (and (and (= result (get1 (elements container) (length container))) (= (e_bigger_than_range (elements container) 1 (- (length container) 1) result) true)) (dynamic_invariant2 result true false true)))) :pattern ((last_element container)))))
(assert (forall ((attr__tag Int)) (forall ((container us_rep)) (! (dynamic_invariant2 (last_element1 attr__tag container) true false true) :pattern ((last_element1 attr__tag container))))))
(assert true)
(define-fun dynamic_invariant6 ((temp___expr_315 Int) (temp___is_init_312 Bool) (temp___skip_constant_313 Bool) (temp___do_toplevel_314 Bool)) Bool (=> (or (= temp___is_init_312 true) (<= 0 2147483647)) (in_range8 temp___expr_315)))
(assert (forall ((container us_rep4)) (forall ((item Int)) (! (=> (dynamic_invariant6 item true true true) (=> (= (of_int 1) true) (=> (exists ((e Int)) (and (and (in_range8 e) (= (contains container e) true)) (= (equivalent_elements e item) true))) (= (contains container item) true)))) :pattern ((contains container item))))))
...
(assert (forall ((left us_rep4) (right us_rep4)) (forall ((item Int)) (! (=> (dynamic_invariant6 item true true true) (= (= (included_except left right item) true) (forall ((e Int)) (=> (and (in_range8 e) (= (contains left e) true)) (or (= (contains right e) true) (= (equivalent_elements e item) true)))))) :pattern ((included_except left right item))))))
...
(define-fun dynamic_invariant7 ((temp___expr_346 Int) (temp___is_init_343 Bool) (temp___skip_constant_344 Bool) (temp___do_toplevel_345 Bool)) Bool (=> (or (= temp___is_init_343 true) (<= 0 2147483647)) (in_range3 temp___expr_346)))
...
(define-fun dynamic_invariant8 ((temp___expr_340 Int) (temp___is_init_337 Bool) (temp___skip_constant_338 Bool) (temp___do_toplevel_339 Bool)) Bool (=> (or (= temp___is_init_337 true) (<= 0 2147483647)) (in_range9 temp___expr_340)))
(assert (forall ((container us_rep3)) (forall ((position Int)) (! (=> (and (dynamic_invariant7 position true true true) (and (<= 1 position) (<= position (last container)))) (dynamic_invariant8 (get1 container position) true false true)) :pattern ((get1 container position))))))
...
(declare-const temp___1081 count_type)
(declare-const us Int)
(declare-const us1 Int)
(declare-const temp___1058 count_type)
(declare-const temp___1059 count_type)
...
(declare-const temp___1076 us_rep1)
(declare-const temp___1078 us_rep1)
...
(declare-const m__split_fields15 us_split_fields)
(declare-const my_ordered_sets__m__delete_first__container__fields us_split_fields)
(declare-const result20 us_split_fields__ref)
(declare-const l__split_fields12 us_split_fields)
(declare-const my_ordered_sets__m__delete_last__container__fields us_split_fields)
...
(declare-const my_ordered_sets__m__delete__2__container__fields us_split_fields)
...
(declare-const my_ordered_sets__m__exclude__container__fields us_split_fields)
(declare-const result25 us_split_fields__ref)
(declare-const l__split_fields15 us_split_fields)
(declare-const my_ordered_sets__m__exclude__container__fields1 us_split_fields)
...
(assert (and (= (mk___rep1 (mk___split_fields1 temp___1058)) (first (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (ite (= (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 0) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 temp___1058)) no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 temp___1058))) true) (= (get (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 temp___1058))) 1)))))
...
(assert (and (= (mk___rep1 (mk___split_fields1 temp___1059)) (next (mk___rep l__split_discrs (mk___split_fields l__split_fields)) (mk___rep1 c__split_fields1))) (ite (= (ite (= (bool_eq1 (mk___rep1 c__split_fields1) no_element) false) (= (get (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 c__split_fields1)) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 temp___1059)) no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 temp___1059))) true) (= (get (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 temp___1059))) (+ (get (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 c__split_fields1)) 1))))))
...
(assert (let ((temp___393 (elements (mk___rep l__split_discrs l__split_fields5)))) (forall ((temp___392 Int)) (=> (and (in_range3 temp___392) (= (iter_has_element temp___393 temp___392) true)) (exists ((i us_rep1)) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields5)) i) true) (= (get1 (elements (mk___rep l__split_discrs l__split_fields5)) (get (positions (mk___rep l__split_discrs l__split_fields5)) i)) (get1 temp___393 temp___392))))))))
...
(assert (and (and (and (and (and (and (= (length (mk___rep m__split_discrs3 m__split_fields15)) (+ (- (length (mk___rep m__split_discrs3 m__split_fields14)) (* 2 (num_overlaps (model__ (mk___rep m__split_discrs3 m__split_fields14)) (model__ (mk___rep l__split_discrs l__split_fields11))))) (length (mk___rep l__split_discrs l__split_fields11)))) (= (not_in_both (model__ (mk___rep m__split_discrs3 m__split_fields15)) (model__ (mk___rep m__split_discrs3 m__split_fields14)) (model__ (mk___rep l__split_discrs l__split_fields11))) true)) (= (included_in_union (model__ (mk___rep m__split_discrs3 m__split_fields14)) (model__ (mk___rep m__split_discrs3 m__split_fields15)) (model__ (mk___rep l__split_discrs l__split_fields11))) true)) (= (included_in_union (model__ (mk___rep l__split_discrs l__split_fields11)) (model__ (mk___rep m__split_discrs3 m__split_fields15)) (model__ (mk___rep m__split_discrs3 m__split_fields14))) true)) (= (e_elements_included__3 (elements (mk___rep m__split_discrs3 m__split_fields15)) (model__ (mk___rep m__split_discrs3 m__split_fields14)) (elements (mk___rep m__split_discrs3 m__split_fields14)) (elements (mk___rep l__split_discrs l__split_fields11))) true)) (= (e_elements_included__2 (elements (mk___rep m__split_discrs3 m__split_fields14)) (model__ (mk___rep m__split_discrs3 m__split_fields15)) (elements (mk___rep m__split_discrs3 m__split_fields15))) true)) (= (e_elements_included__2 (elements (mk___rep l__split_discrs l__split_fields11)) (model__ (mk___rep m__split_discrs3 m__split_fields15)) (elements (mk___rep m__split_discrs3 m__split_fields15))) true)))
(assert (ite (= (= (length (mk___rep l__split_discrs l__split_fields11)) 0) true) (= (length (mk___rep l__split_discrs my_ordered_sets__m__delete_first__container__fields)) 0) (and (and (and (and (and (= (length (mk___rep l__split_discrs my_ordered_sets__m__delete_first__container__fields)) (- (length (mk___rep l__split_discrs l__split_fields11)) 1)) (not (= (contains (model__ (mk___rep l__split_discrs my_ordered_sets__m__delete_first__container__fields)) (first_element (mk___rep l__split_discrs l__split_fields11))) true))) (= (ole (model__ (mk___rep l__split_discrs my_ordered_sets__m__delete_first__container__fields)) (model__ (mk___rep l__split_discrs l__split_fields11))) true)) (= (included_except (model__ (mk___rep l__split_discrs l__split_fields11)) (model__ (mk___rep l__split_discrs my_ordered_sets__m__delete_first__container__fields)) (first_element (mk___rep l__split_discrs l__split_fields11))) true)) (= (range_shifted (elements (mk___rep l__split_discrs my_ordered_sets__m__delete_first__container__fields)) (elements (mk___rep l__split_discrs l__split_fields11)) 1 (length (mk___rep l__split_discrs my_ordered_sets__m__delete_first__container__fields)) 1) true)) (= (p_positions_shifted (positions (mk___rep l__split_discrs my_ordered_sets__m__delete_first__container__fields)) (positions (mk___rep l__split_discrs l__split_fields11)) 1 1) true))))
(assert (= result20 (mk___split_fields__ref l__split_fields11)))
(assert (= l__split_fields12 my_ordered_sets__m__delete_first__container__fields))
(assert (ite (= (= (length (mk___rep l__split_discrs l__split_fields12)) 0) true) (= (length (mk___rep l__split_discrs my_ordered_sets__m__delete_last__container__fields)) 0) (and (and (and (and (and (= (length (mk___rep l__split_discrs my_ordered_sets__m__delete_last__container__fields)) (- (length (mk___rep l__split_discrs l__split_fields12)) 1)) (not (= (contains (model__ (mk___rep l__split_discrs my_ordered_sets__m__delete_last__container__fields)) (last_element (mk___rep l__split_discrs l__split_fields12))) true))) (= (ole (model__ (mk___rep l__split_discrs my_ordered_sets__m__delete_last__container__fields)) (model__ (mk___rep l__split_discrs l__split_fields12))) true)) (= (included_except (model__ (mk___rep l__split_discrs l__split_fields12)) (model__ (mk___rep l__split_discrs my_ordered_sets__m__delete_last__container__fields)) (last_element (mk___rep l__split_discrs l__split_fields12))) true)) (= (range_equal (elements (mk___rep l__split_discrs l__split_fields12)) (elements (mk___rep l__split_discrs my_ordered_sets__m__delete_last__container__fields)) 1 (length (mk___rep l__split_discrs my_ordered_sets__m__delete_last__container__fields))) true)) (= (ole1 (positions (mk___rep l__split_discrs my_ordered_sets__m__delete_last__container__fields)) (positions (mk___rep l__split_discrs l__split_fields12))) true))))
(assert (= result21 (mk___split_fields__ref l__split_fields12)))
(assert (= l__split_fields13 my_ordered_sets__m__delete_last__container__fields))
(assert (and (= temp___1076 (find1 (mk___rep l__split_discrs l__split_fields13) 3)) (ite (ite (= (contains (model__ (mk___rep l__split_discrs l__split_fields13)) 3) false) true false) (and (not (= (has_key (positions (mk___rep l__split_discrs l__split_fields13)) temp___1076) true)) (= (bool_eq1 temp___1076 no_element) true)) (and (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields13)) temp___1076) true) (= (get (positions (mk___rep l__split_discrs l__split_fields13)) temp___1076) (find (elements (mk___rep l__split_discrs l__split_fields13)) 3))) (= (equivalent_elements (element (mk___rep l__split_discrs l__split_fields13) temp___1076) 3) true)))))
(assert (= result22 (mk___split_fields__ref1 c__split_fields3)))
(assert (= c__split_fields4 (us_split_fields3 temp___1076)))
(assert (and (and (and (and (and (and (and (and (= (bool_eq1 (mk___rep1 c__split_fields5) no_element) true) (= (length (mk___rep l__split_discrs my_ordered_sets__m__delete__2__container__fields)) (- (length (mk___rep l__split_discrs l__split_fields13)) 1))) (not (= (contains (model__ (mk___rep l__split_discrs my_ordered_sets__m__delete__2__container__fields)) (element (mk___rep l__split_discrs l__split_fields13) (mk___rep1 c__split_fields4))) true))) (not (= (has_key (positions (mk___rep l__split_discrs my_ordered_sets__m__delete__2__container__fields)) (mk___rep1 c__split_fields4)) true))) (= (ole (model__ (mk___rep l__split_discrs my_ordered_sets__m__delete__2__container__fields)) (model__ (mk___rep l__split_discrs l__split_fields13))) true)) (= (included_except (model__ (mk___rep l__split_discrs l__split_fields13)) (model__ (mk___rep l__split_discrs my_ordered_sets__m__delete__2__container__fields)) (element (mk___rep l__split_discrs l__split_fields13) (mk___rep1 c__split_fields4))) true)) (= (range_equal (elements (mk___rep l__split_discrs l__split_fields13)) (elements (mk___rep l__split_discrs my_ordered_sets__m__delete__2__container__fields)) 1 (- (get (positions (mk___rep l__split_discrs l__split_fields13)) (mk___rep1 c__split_fields4)) 1)) true)) (= (range_shifted (elements (mk___rep l__split_discrs my_ordered_sets__m__delete__2__container__fields)) (elements (mk___rep l__split_discrs l__split_fields13)) (get (positions (mk___rep l__split_discrs l__split_fields13)) (mk___rep1 c__split_fields4)) (length (mk___rep l__split_discrs my_ordered_sets__m__delete__2__container__fields)) 1) true)) (= (p_positions_shifted (positions (mk___rep l__split_discrs my_ordered_sets__m__delete__2__container__fields)) (positions (mk___rep l__split_discrs l__split_fields13)) (get (positions (mk___rep l__split_discrs l__split_fields13)) (mk___rep1 c__split_fields4)) 1) true)))
(assert (= result23 (mk___split_fields__ref l__split_fields13)))
(assert (= l__split_fields14 my_ordered_sets__m__delete__2__container__fields))
(assert (not (= (contains (model__ (mk___rep l__split_discrs l__split_fields14)) 3) true)))
(assert (and (= temp___1078 (find1 (mk___rep l__split_discrs l__split_fields14) 3)) (ite (ite (= (contains (model__ (mk___rep l__split_discrs l__split_fields14)) 3) false) true false) (and (not (= (has_key (positions (mk___rep l__split_discrs l__split_fields14)) temp___1078) true)) (= (bool_eq1 temp___1078 no_element) true)) (and (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields14)) temp___1078) true) (= (get (positions (mk___rep l__split_discrs l__split_fields14)) temp___1078) (find (elements (mk___rep l__split_discrs l__split_fields14)) 3))) (= (equivalent_elements (element (mk___rep l__split_discrs l__split_fields14) temp___1078) 3) true)))))
(assert (= result24 (mk___split_fields__ref1 c__split_fields5)))
(assert (= c__split_fields6 (us_split_fields3 temp___1078)))
(assert (and (not (= (contains (model__ (mk___rep l__split_discrs my_ordered_sets__m__exclude__container__fields)) 2) true)) (ite (ite (= (contains (model__ (mk___rep l__split_discrs l__split_fields14)) 2) false) true false) (and (and (= (oeq3 (model__ (mk___rep l__split_discrs my_ordered_sets__m__exclude__container__fields)) (model__ (mk___rep l__split_discrs l__split_fields14))) true) (= (oeq2 (elements (mk___rep l__split_discrs my_ordered_sets__m__exclude__container__fields)) (elements (mk___rep l__split_discrs l__split_fields14))) true)) (= (oeq4 (positions (mk___rep l__split_discrs my_ordered_sets__m__exclude__container__fields)) (positions (mk___rep l__split_discrs l__split_fields14))) true)) (and (and (and (and (and (= (length (mk___rep l__split_discrs my_ordered_sets__m__exclude__container__fields)) (- (length (mk___rep l__split_discrs l__split_fields14)) 1)) (= (ole (model__ (mk___rep l__split_discrs my_ordered_sets__m__exclude__container__fields)) (model__ (mk___rep l__split_discrs l__split_fields14))) true)) (= (included_except (model__ (mk___rep l__split_discrs l__split_fields14)) (model__ (mk___rep l__split_discrs my_ordered_sets__m__exclude__container__fields)) 2) true)) (= (range_equal (elements (mk___rep l__split_discrs l__split_fields14)) (elements (mk___rep l__split_discrs my_ordered_sets__m__exclude__container__fields)) 1 (- (find (elements (mk___rep l__split_discrs l__split_fields14)) 2) 1)) true)) (= (range_shifted (elements (mk___rep l__split_discrs my_ordered_sets__m__exclude__container__fields)) (elements (mk___rep l__split_discrs l__split_fields14)) (find (elements (mk___rep l__split_discrs l__split_fields14)) 2) (length (mk___rep l__split_discrs my_ordered_sets__m__exclude__container__fields)) 1) true)) (= (p_positions_shifted (positions (mk___rep l__split_discrs my_ordered_sets__m__exclude__container__fields)) (positions (mk___rep l__split_discrs l__split_fields14)) (find (elements (mk___rep l__split_discrs l__split_fields14)) 2) 1) true)))))
(assert (= result25 (mk___split_fields__ref l__split_fields14)))
(assert (= l__split_fields15 my_ordered_sets__m__exclude__container__fields))
(assert (= (contains (model__ (mk___rep l__split_discrs l__split_fields15)) 4) true))
(assert (and (not (= (contains (model__ (mk___rep l__split_discrs my_ordered_sets__m__exclude__container__fields1)) 4) true)) (ite (ite (= (contains (model__ (mk___rep l__split_discrs l__split_fields15)) 4) false) true false) (and (and (= (oeq3 (model__ (mk___rep l__split_discrs my_ordered_sets__m__exclude__container__fields1)) (model__ (mk___rep l__split_discrs l__split_fields15))) true) (= (oeq2 (elements (mk___rep l__split_discrs my_ordered_sets__m__exclude__container__fields1)) (elements (mk___rep l__split_discrs l__split_fields15))) true)) (= (oeq4 (positions (mk___rep l__split_discrs my_ordered_sets__m__exclude__container__fields1)) (positions (mk___rep l__split_discrs l__split_fields15))) true)) (and (and (and (and (and (= (length (mk___rep l__split_discrs my_ordered_sets__m__exclude__container__fields1)) (- (length (mk___rep l__split_discrs l__split_fields15)) 1)) (= (ole (model__ (mk___rep l__split_discrs my_ordered_sets__m__exclude__container__fields1)) (model__ (mk___rep l__split_discrs l__split_fields15))) true)) (= (included_except (model__ (mk___rep l__split_discrs l__split_fields15)) (model__ (mk___rep l__split_discrs my_ordered_sets__m__exclude__container__fields1)) 4) true)) (= (range_equal (elements (mk___rep l__split_discrs l__split_fields15)) (elements (mk___rep l__split_discrs my_ordered_sets__m__exclude__container__fields1)) 1 (- (find (elements (mk___rep l__split_discrs l__split_fields15)) 4) 1)) true)) (= (range_shifted (elements (mk___rep l__split_discrs my_ordered_sets__m__exclude__container__fields1)) (elements (mk___rep l__split_discrs l__split_fields15)) (find (elements (mk___rep l__split_discrs l__split_fields15)) 4) (length (mk___rep l__split_discrs my_ordered_sets__m__exclude__container__fields1)) 1) true)) (= (p_positions_shifted (positions (mk___rep l__split_discrs my_ordered_sets__m__exclude__container__fields1)) (positions (mk___rep l__split_discrs l__split_fields15)) (find (elements (mk___rep l__split_discrs l__split_fields15)) 4) 1) true)))))
(assert (= result26 (mk___split_fields__ref l__split_fields15)))
(assert (= l__split_fields16 my_ordered_sets__m__exclude__container__fields1))
