...
(assert (and (and (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)) (fp.isFinite32 res)) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (of_int RNE numerator)) (and (fp.leq (fp #b0 #b01111111 #b00000000000000000000000) (of_int RNE denominator)) (and (and (and (= o (fp.div RNE (of_int RNE numerator) (of_int RNE denominator))) (fp.isFinite32 (fp.div RNE (of_int RNE numerator) (of_int RNE denominator)))) (and (= (mk_t__ref result) (mk_t__ref res)) (= res1 o))) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) res1) (and (and (= basic_contracts__average_orig__result1 basic_contracts__average_orig__result2) (= basic_contracts__average_orig__result3 basic_contracts__average_orig__result1)) (and (= result1 basic_contracts__average_orig__result) (= basic_contracts__average_orig__result1 res1)))))))) (and (and (= (mk_t__ref basic_contracts__average_orig__result4) (mk_t__ref basic_contracts__average_orig__result2)) (= res1 res2)) (and (= basic_contracts__average_orig__result5 basic_contracts__average_orig__result3) (= res3 res1)))))
(assert (= result2 basic_contracts__average_orig__result4))
(assert (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) basic_contracts__average_orig__result4)))
(check-sat)
(exit)
