...
(assert (= basic_contracts__average_orig__result1 basic_contracts__average_orig__result2))
(assert (= basic_contracts__average_orig__result3 basic_contracts__average_orig__result1))
(assert (= result1 basic_contracts__average_orig__result))
(assert (= basic_contracts__average_orig__result1 res1))
(assert (= (mk_t__ref basic_contracts__average_orig__result4) (mk_t__ref basic_contracts__average_orig__result2)))
(assert (= res1 res2))
(assert (= basic_contracts__average_orig__result5 basic_contracts__average_orig__result3))
(assert (= res3 res1))
