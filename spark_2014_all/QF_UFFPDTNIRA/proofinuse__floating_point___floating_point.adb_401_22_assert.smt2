...
(declare-fun user_eq (float_32 float_32) Bool)
(declare-fun attr__ATTRIBUTE_IMAGE1 (Float32) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check1 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE1 (us_image) Float32)
(declare-const dummy float_32)
...
(declare-sort float_64 0)
(declare-fun user_eq1 (float_64 float_64) Bool)
(declare-fun attr__ATTRIBUTE_IMAGE2 (Float64) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check2 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE2 (us_image) Float64)
(declare-const dummy1 float_64)
(declare-datatypes () ((float_64__ref (mk_float_64__ref (float_64__content float_64)))))
(define-fun float_64__ref___projection ((a float_64__ref)) float_64 (float_64__content a))
(define-fun dynamic_invariant1 ((temp___expr_215 Float64) (temp___is_init_211 Bool) (temp___skip_constant_212 Bool) (temp___do_toplevel_213 Bool) (temp___do_typ_inv_214 Bool)) Bool (=> (or (= temp___is_init_211 true) (fp.leq (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111))) (fp.isFinite64 temp___expr_215)))
...
(assert (=> (fp.leq (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) (fp.isFinite64 res)))
(assert (and (fp.leq (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)) x) (fp.leq x (fp #b0 #b01111111 #b00000000000000000000000))))
(assert (= result res))
(assert (= res1 ((_ to_fp 11 53) RNE (fp.mul RNE x (fp #b0 #b01111110 #b00000000000000000000000)))))
(assert (not (fp.leq (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)) res1)))
(check-sat)
(exit)
