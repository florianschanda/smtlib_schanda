...
(assert (= result (ite (fp.leq o (fp.neg (fp #b0 #b10000000010 #b0100000000000000000000000000000000000000000000000000))) true false)))
(assert (= result true))
(assert (not (fp.lt x (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))))
(check-sat)
(exit)
