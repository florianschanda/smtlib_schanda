...
(assert (fp.leq (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)) x2))
(assert (fp.leq x2 (fp #b0 #b01111111 #b00000000000000000000000)))
(assert (and (= o1 (fp.mul RNE x2 (fp #b0 #b10000000 #b00000000000000000000000))) (fp.isFinite32 (fp.mul RNE x2 (fp #b0 #b10000000 #b00000000000000000000000)))))
(assert (= x2 result1))
(assert (= x3 o1))
(assert (not (fp.leq (fp.neg (fp #b0 #b10000000 #b00000000000000000000000)) x3)))
(check-sat)
(exit)
