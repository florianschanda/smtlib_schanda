...
(define-fun dynamic_invariant1 ((temp___expr_211 Float32) (temp___is_init_208 Bool) (temp___skip_constant_209 Bool) (temp___do_toplevel_210 Bool)) Bool (=> (or (= temp___is_init_208 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (in_range1 temp___expr_211)))
...
(assert (not (fp.isFinite32 (fp.mul RNE (fp.sub RNE b_y a_y) (fp.sub RNE b_y a_y)))))
(check-sat)
(exit)
