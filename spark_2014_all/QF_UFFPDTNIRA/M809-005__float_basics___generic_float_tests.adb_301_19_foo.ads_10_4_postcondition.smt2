...
(assert (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)) (fp.isFinite32 m)))
(assert (= result m))
(assert (= m1 (fp.min x y)))
(assert (= m1 m2))
(assert (= m3 m1))
(assert (not (fp.leq m2 x)))
(check-sat)
(exit)
