...
(assert (fp.lt (fp.abs a) (fp.mul RNE (fp #b0 #b10001011 #b01101010100000000000000) (fp.abs b))))
(assert (and (= o1 (fp.div RNE a b)) (fp.isFinite32 (fp.div RNE a b))))
(assert (= o2 (ite (fp.leq (fp.neg (fp #b0 #b10001011 #b01101010100000000000000)) o1) true false)))
(assert (= result res))
(assert (= res1 o2))
