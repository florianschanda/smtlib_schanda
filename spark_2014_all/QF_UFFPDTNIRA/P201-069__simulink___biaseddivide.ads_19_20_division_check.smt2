...
(assert (= r1 r2))
(assert (= r3 r1))
(assert (and (= o3 (fp.sub RNE z (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000))) (fp.isFinite64 (fp.sub RNE z (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000)))))
(assert (not (not (fp.isZero o3))))
(check-sat)
(exit)
