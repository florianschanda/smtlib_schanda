...
(assert (and (= o (fp.roundToIntegral RTN x)) (fp.isFinite32 (fp.roundToIntegral RTN x))))
(assert (= result normalize__r3__result))
(assert (= normalize__r3__result1 o))
(assert (= (mk_t__ref normalize__r3__result4) (mk_t__ref normalize__r3__result2)))
(assert (= normalize__r3__result5 normalize__r3__result3))
(assert (= result1 normalize__r3__result4))
(assert (not (fp.leq (fp.sub RNE x (fp #b0 #b01111111 #b00000000000000000000000)) normalize__r3__result4)))
(check-sat)
(exit)
