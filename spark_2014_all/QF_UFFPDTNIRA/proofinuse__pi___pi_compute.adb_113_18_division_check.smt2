...
(assert (and (= o6 (fp.sub RNE a71 t81)) (fp.isFinite32 (fp.sub RNE a71 t81))))
(assert (= result17 (mk_t__ref a8)))
(assert (= a81 o6))
(assert (fp.isFinite32 a81))
(assert (and (= o7 (fp.add RNE a81 t91)) (fp.isFinite32 (fp.add RNE a81 t91))))
(assert (= result18 (mk_t__ref a9)))
(assert (= a91 o7))
(assert (fp.isFinite32 a91))
(assert (and (= o8 (fp.sub RNE a91 t101)) (fp.isFinite32 (fp.sub RNE a91 t101))))
(assert (= result19 (mk_t__ref a10)))
(assert (= a101 o8))
(assert (fp.isFinite32 a101))
(assert (and (= o9 (fp.mul RNE a91 a91)) (fp.isFinite32 (fp.mul RNE a91 a91))))
(assert (and (= o10 (fp.mul RNE a101 a81)) (fp.isFinite32 (fp.mul RNE a101 a81))))
(assert (= o11 (fp.sub RNE o10 o9)))
(assert (and (= o12 o11) (fp.isFinite32 o11)))
(assert (= o13 (fp.mul RNE (fp #b0 #b10000001 #b00000000000000000000000) o12)))
(assert (and (= o14 o13) (fp.isFinite32 o13)))
(assert (= result20 (mk_t__ref num)))
(assert (= num1 o14))
(assert (fp.isFinite32 num1))
(assert (and (= o15 (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) a91)) (fp.isFinite32 (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) a91))))
...
(assert (fp.isFinite32 (let ((subject den)) den1)))
(assert (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)) (fp.isFinite32 (t__content res))))
(assert (not (not (fp.isZero (let ((subject den)) den1)))))
(check-sat)
(exit)
