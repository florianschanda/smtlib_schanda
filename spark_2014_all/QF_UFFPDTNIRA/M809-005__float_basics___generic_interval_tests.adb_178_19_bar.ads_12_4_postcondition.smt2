...
(assert (and (and (and (and (and (and (and (fp.leq (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) a) (fp.leq a (fp #b0 #b10000000001 #b0100000000000000000000000000000000000000000000000000))) (and (fp.leq (fp #b0 #b10000000001 #b0100000000000000000000000000000000000000000000000000) b) (fp.leq b (fp #b0 #b10000000010 #b0100000000000000000000000000000000000000000000000000)))) (and (fp.leq (fp #b0 #b10000000001 #b0000000000000000000000000000000000000000000000000000) c) (fp.leq c (fp #b0 #b10000000001 #b1000000000000000000000000000000000000000000000000000)))) (fp.lt a d)) (fp.lt d b)) (fp.leq c a)) (fp.leq b c)))
(assert (and (and (fp.lt a b) (and (fp.eq c (fp #b0 #b10000000001 #b0100000000000000000000000000000000000000000000000000)) (and (and (fp.leq (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) d) (fp.leq d (fp #b0 #b10000000010 #b0100000000000000000000000000000000000000000000000000))) (and (and (and (and (and (and (= o (fp.add RNE a b)) (fp.isFinite64 (fp.add RNE a b))) (= o1 (fp.add RNE o c))) (and (= o2 o1) (fp.isFinite64 o1))) (= o3 (fp.add RNE o2 d))) (and (= o4 o3) (fp.isFinite64 o3))) (and (= result z) (= z1 o4)))))) (and (= z1 z2) (= z3 z1))))
(assert (not (fp.lt (fp #b0 #b10000000010 #b0100000000000000000000000000000000000000000000000000) z2)))
(check-sat)
(exit)
