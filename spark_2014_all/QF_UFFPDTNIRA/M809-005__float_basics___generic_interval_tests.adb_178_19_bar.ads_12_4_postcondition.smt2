...
(assert (fp.lt a b))
(assert (fp.eq c (fp #b0 #b10000000001 #b0100000000000000000000000000000000000000000000000000)))
(assert (and (fp.leq (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) d) (fp.leq d (fp #b0 #b10000000010 #b0100000000000000000000000000000000000000000000000000))))
