...
(assert (fp.lt (fp.mul RNE (fp.abs a) (fp.abs c)) (fp.mul RNE (fp #b0 #b10001011 #b01101010100000000000000) (fp.abs b))))
(assert (= result res))
(assert (= res1 (ite (not (fp.eq b (fp #b0 #b00000000 #b00000000000000000000000))) true false)))
