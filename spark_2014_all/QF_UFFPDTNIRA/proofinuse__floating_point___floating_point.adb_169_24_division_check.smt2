...
(assert (and (= o8 (fp.mul RNE (fp.sub RNE b_x c_x) (fp.sub RNE b_x c_x))) (fp.isFinite32 (fp.mul RNE (fp.sub RNE b_x c_x) (fp.sub RNE b_x c_x)))))
(assert (= o9 (fp.add RNE o8 o7)))
(assert (and (= o10 o9) (fp.isFinite32 o9)))
(assert (= floating_point__angle_between__length_bc__assume (fp.sqrt RNE o10)))
...
(assert (and (= o11 (fp.mul RNE length_ba length_bc)) (fp.isFinite32 (fp.mul RNE length_ba length_bc))))
(assert (not (not (fp.isZero o11))))
(check-sat)
(exit)
