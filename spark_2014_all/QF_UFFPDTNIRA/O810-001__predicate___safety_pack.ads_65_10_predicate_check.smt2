...
(define-fun dynamic_invariant ((temp___expr_1330 Float32) (temp___is_init_1327 Bool) (temp___skip_constant_1328 Bool) (temp___do_toplevel_1329 Bool)) Bool (=> (or (= temp___is_init_1327 true) (fp.leq (fp.neg (fp #b0 #b10000011 #b00000000000000000000000)) (fp #b0 #b10000011 #b00000000000000000000000))) (in_range1 temp___expr_1330)))
...
(define-fun temp___1351 () Float32 (fp.neg (fp #b0 #b00110101 #b00000000000000000000000)))
(assert (not (or (or (fp.eq temp___1351 (fp #b0 #b00000000 #b00000000000000000000000)) (fp.leq temp___1351 (fp.neg (fp #b0 #b00110101 #b00000000000000000000000)))) (fp.leq (fp #b0 #b00110101 #b00000000000000000000000) temp___1351))))
(check-sat)
(exit)
