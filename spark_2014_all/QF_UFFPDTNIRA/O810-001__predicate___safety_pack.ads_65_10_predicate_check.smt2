...
(define-fun dynamic_invariant ((temp___expr_1324 Float32) (temp___is_init_1321 Bool) (temp___skip_constant_1322 Bool) (temp___do_toplevel_1323 Bool)) Bool (=> (or (= temp___is_init_1321 true) (fp.leq (fp.neg (fp #b0 #b10000011 #b00000000000000000000000)) (fp #b0 #b10000011 #b00000000000000000000000))) (in_range1 temp___expr_1324)))
...
(assert (not (or (or (fp.eq (fp.neg (fp #b0 #b00110101 #b00000000000000000000000)) (fp #b0 #b00000000 #b00000000000000000000000)) (fp.leq (fp.neg (fp #b0 #b00110101 #b00000000000000000000000)) (fp.neg (fp #b0 #b00110101 #b00000000000000000000000)))) (fp.leq (fp #b0 #b00110101 #b00000000000000000000000) (fp.neg (fp #b0 #b00110101 #b00000000000000000000000))))))
(check-sat)
(exit)
