...
(assert (fp.leq (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) x))
(assert (not (fp.leq (fp.roundToIntegral RTN x) (fp.roundToIntegral RTN (fp.add RNE x (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))))))
(check-sat)
(exit)
