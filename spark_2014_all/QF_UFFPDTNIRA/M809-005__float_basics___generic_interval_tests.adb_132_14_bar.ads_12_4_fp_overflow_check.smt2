...
(assert (or (and (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) x) (fp.leq x (fp #b0 #b10000000001 #b0100000000000000000000000000000000000000000000000000))) (and (fp.leq (fp #b0 #b10000000010 #b0100000000000000000000000000000000000000000000000000) x) (fp.leq x (fp #b0 #b10000000011 #b0100000000000000000000000000000000000000000000000000)))))
(assert (not (fp.isFinite64 (fp.add RNE x (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))))
(check-sat)
(exit)
