...
(assert (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) x) (fp.leq x (fp #b0 #b10000100 #b11100000000000000000000))))
(assert (not (fp.leq (fp.add RNE (fp.mul RNE (fp.add RNE (fp.add RNE (fp.mul RNE (fp.add RNE x (fp #b0 #b10000000 #b00000000000000000000000)) x) (fp #b0 #b10000000 #b10000000000000000000000)) (fp #b0 #b10000001 #b00000000000000000000000)) x) (fp #b0 #b10000001 #b01000000000000000000000)) (fp #b0 #b11111110 #b11111111111111111111111))))
(check-sat)
(exit)
