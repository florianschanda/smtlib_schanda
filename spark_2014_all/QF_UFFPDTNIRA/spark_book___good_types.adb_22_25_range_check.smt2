...
(assert (not (in_range1 (fp.add RNE room_length1 (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) (fp.div RNE c3b (fp #b0 #b10000010 #b10000000000000000000000)))))))
(check-sat)
(exit)
