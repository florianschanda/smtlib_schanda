...
(define-fun dynamic_invariant1 ((temp___expr_165 Int) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool) (temp___do_typ_inv_164 Bool)) Bool (=> (or (= temp___is_init_161 true) (<= 0 16777215)) (in_range temp___expr_165)))
...
(assert (not (in_range (to_int1 RNA a1))))
(check-sat)
(exit)
