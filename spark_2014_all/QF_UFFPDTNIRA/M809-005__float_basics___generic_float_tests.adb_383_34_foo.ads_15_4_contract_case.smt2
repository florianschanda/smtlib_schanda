...
(assert (= i1 i2))
(assert (= i3 i1))
(assert (=> (= (fp.eq x (fp.neg (fp #b0 #b01111111111 #b1001100110011001100110011001100110011001100110011010))) true) (= i2 (- 2))))
(assert (=> (= (fp.eq x (fp.neg (fp #b0 #b01111111111 #b1000000000000000000000000000000000000000000000000000))) true) (= i2 (- 2))))
