...
(assert (and (= o (fp.sub RNE left right)) (fp.isFinite32 (fp.sub RNE left right))))
(assert (= (mk_t__ref result) (mk_t__ref numerics__Osubtract__result)))
(assert (= numerics__Osubtract__result1 o))
(assert (= (mk_t__ref numerics__Osubtract__result4) (mk_t__ref numerics__Osubtract__result2)))
(assert (= numerics__Osubtract__result5 numerics__Osubtract__result3))
(assert (= result1 numerics__Osubtract__result4))
(assert (not (fp.eq numerics__Osubtract__result4 (fp.sub RNE left right))))
(check-sat)
(exit)
