...
(assert (= float_example__minus_i__result1 float_example__minus_i__result2))
(assert (= float_example__minus_i__result3 float_example__minus_i__result1))
...
(assert (= (mk_t__ref float_example__minus_i__result4) (mk_t__ref float_example__minus_i__result2)))
(assert (= float_example__minus_i__result5 float_example__minus_i__result3))
(assert (= result1 float_example__minus_i__result4))
(assert (not (fp.eq float_example__minus_i__result4 (fp.add RNE a b))))
(check-sat)
(exit)
