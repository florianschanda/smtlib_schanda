...
(assert (fp.lt distance_to_target (fp #b0 #b10000010 #b01000000000000000000000)))
(assert (and (= o (fp.mul RNE f distance_to_target)) (fp.isFinite32 (fp.mul RNE f distance_to_target))))
(assert (not (not (fp.isZero (fp #b0 #b10000010 #b01000000000000000000000)))))
(check-sat)
(exit)
