...
(define-fun dynamic_invariant1 ((temp___expr_1294 Float32) (temp___is_init_1291 Bool) (temp___skip_constant_1292 Bool) (temp___do_toplevel_1293 Bool)) Bool (=> (or (= temp___is_init_1291 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b11111110 #b11111111111111111111111))) (in_range1 temp___expr_1294)))
...
(assert (not (fp.isFinite32 (fp.sub RNE value threshold))))
(check-sat)
(exit)
