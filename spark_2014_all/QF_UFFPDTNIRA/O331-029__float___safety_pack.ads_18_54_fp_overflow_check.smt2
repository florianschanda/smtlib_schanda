...
(define-fun dynamic_invariant1 ((temp___expr_1288 Float32) (temp___is_init_1285 Bool) (temp___skip_constant_1286 Bool) (temp___do_toplevel_1287 Bool)) Bool (=> (or (= temp___is_init_1285 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b11111110 #b11111111111111111111111))) (in_range1 temp___expr_1288)))
