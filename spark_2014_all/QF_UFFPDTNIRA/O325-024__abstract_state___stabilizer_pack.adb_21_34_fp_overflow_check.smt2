...
(assert (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)) (fp.isFinite32 asl_tmp)))
(assert (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)) (fp.isFinite32 asl_long_tmp)))
(assert (and (= o (fp.sub RNE (fp #b0 #b01111111 #b00000000000000000000000) asl_alpha)) (fp.isFinite32 (fp.sub RNE (fp #b0 #b01111111 #b00000000000000000000000) asl_alpha))))
(assert (= o1 (fp.mul RNE asl_raw o)))
(assert (and (= o2 o1) (fp.isFinite32 o1)))
(assert (and (= o3 (fp.mul RNE asl asl_alpha)) (fp.isFinite32 (fp.mul RNE asl asl_alpha))))
