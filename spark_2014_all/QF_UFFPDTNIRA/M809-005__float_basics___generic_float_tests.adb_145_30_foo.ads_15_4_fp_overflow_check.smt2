...
(assert (and (fp.leq (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) x) (fp.leq (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) y)))
(assert (and (= o (fp.sub RNE x y)) (fp.isFinite64 (fp.sub RNE x y))))
(assert (= o1 (fp.add RNE o y)))
