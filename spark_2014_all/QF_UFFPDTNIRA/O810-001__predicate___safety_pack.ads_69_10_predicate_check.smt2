...
(assert (not (or (or (fp.eq temp___1355 (fp #b0 #b00000000 #b00000000000000000000000)) (fp.leq temp___1355 (fp.neg (fp #b0 #b00110101 #b00000000000000000000000)))) (fp.leq (fp #b0 #b00110101 #b00000000000000000000000) temp___1355))))
(check-sat)
(exit)
