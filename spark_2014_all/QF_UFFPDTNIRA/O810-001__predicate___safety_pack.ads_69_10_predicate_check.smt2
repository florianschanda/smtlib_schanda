...
(assert (not (or (or (fp.eq x (fp #b0 #b00000000 #b00000000000000000000000)) (fp.leq x (fp.neg (fp #b0 #b00110101 #b00000000000000000000000)))) (fp.leq (fp #b0 #b00110101 #b00000000000000000000000) x))))
(check-sat)
(exit)
