...
(define-fun in_range ((x Float32)) Bool (and (fp.isFinite32 x) (and (fp.leq (fp.neg (fp #b0 #b10111110 #b11111111111111111111111)) x) (fp.leq x (fp #b0 #b10111110 #b11111111111111111111111)))))
...
(declare-datatypes () ((squarable_float__ref (mk_squarable_float__ref (squarable_float__content squarable_float)))))
(define-fun squarable_float__ref___projection ((a squarable_float__ref)) squarable_float (squarable_float__content a))
...
(define-fun dynamic_invariant1 ((temp___expr_217 Float32) (temp___is_init_214 Bool) (temp___skip_constant_215 Bool) (temp___do_toplevel_216 Bool)) Bool (=> (or (= temp___is_init_214 true) (fp.leq (fp.neg (fp #b0 #b10111110 #b11111111111111111111111)) (fp #b0 #b10111110 #b11111111111111111111111))) (in_range temp___expr_217)))
...
(assert (in_range c))
(assert (in_range d))
(assert (and (= o (fp.mul RNE d d)) (fp.isFinite32 (fp.mul RNE d d))))
(assert (= o1 (fp.mul RNE o b)))
(assert (and (= o2 o1) (fp.isFinite32 o1)))
(assert (not (fp.isFinite32 (fp.mul RNE c c))))
(check-sat)
(exit)
