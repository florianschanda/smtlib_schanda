...
(define-fun dynamic_invariant1 ((temp___expr_253 Float32) (temp___is_init_249 Bool) (temp___skip_constant_250 Bool) (temp___do_toplevel_251 Bool) (temp___do_typ_inv_252 Bool)) Bool (=> (or (= temp___is_init_249 true) (fp.leq (fp.neg (fp #b0 #b10111110 #b11111111111111111111111)) (fp #b0 #b10111110 #b11111111111111111111111))) (in_range temp___expr_253)))
