...
(define-fun dynamic_invariant1 ((temp___expr_1504 Float32) (temp___is_init_1500 Bool) (temp___skip_constant_1501 Bool) (temp___do_toplevel_1502 Bool) (temp___do_typ_inv_1503 Bool)) Bool (=> (or (= temp___is_init_1500 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b11111110 #b11111111111111111111111))) (in_range1 temp___expr_1504)))
...
(assert (=> (= (fp.gt value threshold) true) (fp.eq safety_pack__dead_band__result4 (fp.sub RNE value threshold))))
(assert (= (fp.lt value (fp.neg threshold)) true))
(assert (not (fp.isFinite32 (fp.add RNE value threshold))))
(check-sat)
(exit)
