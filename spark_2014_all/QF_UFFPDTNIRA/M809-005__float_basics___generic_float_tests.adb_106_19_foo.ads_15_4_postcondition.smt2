...
(assert (= foo__double_tests__underflow_3__result1 foo__double_tests__underflow_3__result2))
(assert (= foo__double_tests__underflow_3__result3 foo__double_tests__underflow_3__result1))
...
(assert (= (mk_t__ref foo__double_tests__underflow_3__result4) (mk_t__ref foo__double_tests__underflow_3__result2)))
(assert (= foo__double_tests__underflow_3__result5 foo__double_tests__underflow_3__result3))
(assert (= result1 foo__double_tests__underflow_3__result4))
(assert (not (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) foo__double_tests__underflow_3__result4)))
(check-sat)
(exit)
