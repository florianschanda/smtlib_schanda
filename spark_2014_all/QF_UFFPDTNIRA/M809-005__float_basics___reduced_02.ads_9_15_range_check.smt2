...
(assert (and (fp.leq (fp.neg (fp #b0 #b10001111110 #b1111111111111111111111100000000000000000000000000000)) x) (fp.leq x (fp #b0 #b10001111110 #b1111111111111111111111100000000000000000000000000000))))
(assert (not (fp.isFinite32 ((_ to_fp 8 24) RNE x))))
(check-sat)
(exit)
