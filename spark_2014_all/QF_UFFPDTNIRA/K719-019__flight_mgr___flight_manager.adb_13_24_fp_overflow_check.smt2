...
(assert (=> (fp.lt distance_to_target (fp #b0 #b10000010 #b01000000000000000000000)) (and (= o (fp.mul RNE f distance_to_target)) (fp.isFinite32 (fp.mul RNE f distance_to_target)))))
(assert (=> (fp.lt distance_to_target (fp #b0 #b10000010 #b01000000000000000000000)) (= o1 (fp.div RNE o (fp #b0 #b10000010 #b01000000000000000000000)))))
(assert (=> (fp.lt distance_to_target (fp #b0 #b10000010 #b01000000000000000000000)) (= (mk_t__ref result) (mk_t__ref f))))
(assert (=> (fp.lt distance_to_target (fp #b0 #b10000010 #b01000000000000000000000)) (= f2 o1)))
(assert (=> (not (fp.lt distance_to_target (fp #b0 #b10000010 #b01000000000000000000000))) (= f2 f)))
(assert (=> (not (fp.lt distance_to_target (fp #b0 #b10000010 #b01000000000000000000000))) (= f2 f1)))
(assert (= f2 f3))
(assert (= f4 f2))
(assert (fp.lt distance_to_target (fp #b0 #b10000010 #b01000000000000000000000)))
(assert (not (fp.isFinite32 (fp.mul RNE f distance_to_target))))
(check-sat)
(exit)
