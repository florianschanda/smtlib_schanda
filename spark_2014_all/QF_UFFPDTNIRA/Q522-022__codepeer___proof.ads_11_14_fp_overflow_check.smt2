...
(assert (and (fp.leq x1 (fp #b0 #b11111101 #b11111111111111111111111)) (and (fp.leq (fp.neg (fp #b0 #b11111101 #b11111111111111111111111)) x1) (and (fp.leq x2 (fp #b0 #b11111101 #b11111111111111111111111)) (fp.leq (fp.neg (fp #b0 #b11111101 #b11111111111111111111111)) x2)))))
(assert (not (fp.isFinite32 (fp.sub RNE x1 x2))))
(check-sat)
(exit)
