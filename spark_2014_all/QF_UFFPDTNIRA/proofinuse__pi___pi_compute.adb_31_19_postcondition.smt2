...
(assert (= pi_compute__leibniz_float__result2 (mk_t__ref pi_compute__leibniz_float__result1)))
(assert (= pi_compute__leibniz_float__result3 pi_compute__leibniz_float__result1))
(assert (= result11 (mk_t__ref pi_compute__leibniz_float__result)))
(assert (= pi_compute__leibniz_float__result1 res1))
(assert (= pi_compute__leibniz_float__result4 pi_compute__leibniz_float__result2))
...
(assert (= pi_compute__leibniz_float__result5 pi_compute__leibniz_float__result3))
(assert (= res3 res1))
(assert (= t103 t101))
(assert (= t93 t91))
(assert (= t83 t81))
