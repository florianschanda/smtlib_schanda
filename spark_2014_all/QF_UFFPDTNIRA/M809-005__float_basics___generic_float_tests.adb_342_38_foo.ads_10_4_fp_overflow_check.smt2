...
(assert (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) x) (fp.leq x (fp #b0 #b10010111 #b00000000000000000000000))))
(assert (not (fp.isFinite32 (fp.add RNE x (fp #b0 #b01111111 #b00000000000000000000000)))))
(check-sat)
(exit)
