...
(assert (not (fp.eq x (fp #b0 #b01111111101 #b1001100110011001100110011001100110011001100110011010))))
(assert (not (fp.eq x (fp #b0 #b01111111110 #b0000000000000000000000000000000000000000000000000000))))
(assert (not (fp.eq x (fp #b0 #b01111111110 #b0011001100110011001100110011001100110011001100110011))))
(assert (not (fp.eq x (fp #b0 #b10000000010 #b1000000000000000000000000000000000000000000000000000))))
(assert (fp.eq x (fp.neg (fp #b0 #b01111111110 #b0000000000000000000000000000000000000000000000000000))))
(assert (not (fp.eq (fp.roundToIntegral RTN x) (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))))
(check-sat)
(exit)
