...
(assert (and (and (= (mk_t__ref step_function__min__result5) (mk_t__ref step_function__min__result3)) (= step_function__min__result6 step_function__min__result4)) (ite (fp.leq x1 x2) (and (and (= step_function__min__result1 step_function__min__result3) (= step_function__min__result4 step_function__min__result1)) (and (= result step_function__min__result) (= step_function__min__result1 x1))) (and (and (= step_function__min__result2 step_function__min__result3) (= step_function__min__result4 step_function__min__result2)) (and (= result1 step_function__min__result) (= step_function__min__result2 x2))))))
(assert (= (mk_t__ref step_function__min__result7) (mk_t__ref step_function__min__result5)))
(assert (= step_function__min__result8 step_function__min__result6))
(assert (= result2 step_function__min__result7))
(assert (fp.leq x1 x2))
(assert (not (fp.eq step_function__min__result7 x1)))
(check-sat)
(exit)
