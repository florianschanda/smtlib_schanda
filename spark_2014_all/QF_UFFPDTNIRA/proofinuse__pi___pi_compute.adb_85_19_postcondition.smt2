...
(assert (and (= o20 (fp.div RNE num1 (let ((subject den)) den1))) (fp.isFinite32 (fp.div RNE num1 (let ((subject den)) den1)))))
(assert (= result22 res))
(assert (= (let ((subject res)) res1) o20))
(assert (fp.eq (let ((subject res)) res1) (fp #b0 #b10000000 #b10010010000101001010011)))
(assert (= pi_compute__shanks_float__result2 (let ((subject pi_compute__shanks_float__result)) (mk_t__ref pi_compute__shanks_float__result1))))
(assert (= pi_compute__shanks_float__result3 pi_compute__shanks_float__result1))
(assert (= result23 pi_compute__shanks_float__result))
(assert (= (let ((subject pi_compute__shanks_float__result)) pi_compute__shanks_float__result1) (let ((subject res)) res1)))
(assert (= pi_compute__shanks_float__result4 pi_compute__shanks_float__result2))
...
(assert (= pi_compute__shanks_float__result5 pi_compute__shanks_float__result3))
(assert (= res3 res1))
(assert (= den3 den1))
(assert (= num3 num1))
(assert (= a103 a101))
