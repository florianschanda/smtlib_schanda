...
(assert (and (and (fp.leq (fp.neg (fp #b0 #b10111110 #b00000000000000000000000)) val1) (fp.leq val1 fl_last_sqrt)) (and (and (fp.leq (fp.neg (fp #b0 #b10111110 #b00000000000000000000000)) val2) (fp.leq val2 fl_last_sqrt)) (and (and (fp.leq (fp.neg (fp #b0 #b10111110 #b00000000000000000000000)) val3) (fp.leq val3 (fp #b0 #b00000000 #b00000000000000000000000))) (fp.leq val1 val2)))))
