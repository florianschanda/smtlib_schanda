...
(assert (fp.isFinite32 val2))
(assert (fp.isFinite32 val3))
(assert (and (and (fp.leq (fp.neg (fp #b0 #b10111110 #b00000000000000000000000)) val1) (fp.leq val1 (fp #b0 #b10111110 #b00000000000000000000000))) (and (and (fp.leq (fp.neg (fp #b0 #b10111110 #b00000000000000000000000)) val2) (fp.leq val2 (fp #b0 #b10111110 #b00000000000000000000000))) (and (and (fp.leq (fp.neg (fp #b0 #b10111110 #b00000000000000000000000)) val3) (fp.leq val3 (fp #b0 #b00000000 #b00000000000000000000000))) (fp.leq val1 val2)))))
(assert (and (= o (fp.mul RNE val1 val3)) (fp.isFinite32 (fp.mul RNE val1 val3))))
(assert (not (fp.isFinite32 (fp.mul RNE val2 val3))))
(check-sat)
(exit)
