...
(assert (=> (not (fp.lt value min_value)) (=> (fp.lt max_value value) (= result2 res1))))
(assert (=> (not (fp.lt value min_value)) (=> (fp.lt max_value value) (= res3 max_value))))
(assert (=> (not (fp.lt value min_value)) (=> (not (fp.lt max_value value)) (= res3 res1))))
...
(assert (= (mk_t__ref safety_pack__saturate__result4) (mk_t__ref safety_pack__saturate__result2)))
(assert (= res4 res2))
...
(assert (not (fp.eq safety_pack__saturate__result4 min_value)))
(check-sat)
(exit)
