...
(define-fun dynamic_invariant ((temp___expr_147 Float64) (temp___is_init_144 Bool) (temp___skip_constant_145 Bool) (temp___do_toplevel_146 Bool)) Bool (=> (or (= temp___is_init_144 true) (fp.leq (fp.neg (fp #b0 #b10000000111 #b1001000000000000000000000000000000000000000000000000)) (fp #b0 #b10000000111 #b1001000000000000000000000000000000000000000000000000))) (in_range1 temp___expr_147)))
...
(define-fun dynamic_invariant1 ((temp___expr_153 Float64) (temp___is_init_150 Bool) (temp___skip_constant_151 Bool) (temp___do_toplevel_152 Bool)) Bool (and (=> (or (= temp___is_init_150 true) (fp.leq (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)) (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))) (in_range2 temp___expr_153)) (=> (= temp___do_toplevel_152 true) (=> (= temp___is_init_150 true) (= (not (and (ite (fp.leq (fp.neg (fp #b0 #b01111110110 #b0100011110101110000101000111101011100001010001111011)) temp___expr_153) true false) (ite (fp.leq temp___expr_153 (fp #b0 #b01111110110 #b0100011110101110000101000111101011100001010001111011)) true false))) true)))))
(define-fun dynamic_predicate ((temp___157 Float64)) Bool (= (not (and (ite (fp.leq (fp.neg (fp #b0 #b01111110110 #b0100011110101110000101000111101011100001010001111011)) temp___157) true false) (ite (fp.leq temp___157 (fp #b0 #b01111110110 #b0100011110101110000101000111101011100001010001111011)) true false))) true))
