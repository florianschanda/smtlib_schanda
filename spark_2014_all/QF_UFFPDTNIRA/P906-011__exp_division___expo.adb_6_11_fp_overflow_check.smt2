...
(assert (not (fp.eq (fp.mul RNE x (fp.mul RNE x x)) ((_ to_fp 8 24) #x00000000))))
(assert (= o (fp.div RNE (fp #b0 #b01111111 #b00000000000000000000000) (fp.mul RNE x (fp.mul RNE x x)))))
