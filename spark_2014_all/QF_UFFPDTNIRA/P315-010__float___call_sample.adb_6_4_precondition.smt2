...
(assert (= result time))
(assert (= time1 (fp #b0 #b11111110 #b11111111111111111111110)))
(assert (fp.isFinite32 time1))
(assert (not (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b01111111 #b00000000000000000000000))))
(check-sat)
(exit)
