...
(assert (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp.mul RNE x (fp.abs x))) (fp.leq (fp.mul RNE x (fp.abs x)) (fp #b0 #b01111111 #b00000000000000000000000))))
