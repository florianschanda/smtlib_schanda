...
(assert (and (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) x) (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) y)))
(assert (not (fp.isFinite64 (fp.add RNE x y))))
(check-sat)
(exit)
