...
(define-fun dynamic_invariant ((temp___expr_466 Int) (temp___is_init_463 Bool) (temp___skip_constant_464 Bool) (temp___do_toplevel_465 Bool)) Bool (=> (or (= temp___is_init_463 true) (<= 0 255)) (in_range temp___expr_466)))
(declare-sort feet 0)
...
(define-fun dynamic_invariant1 ((temp___expr_509 Float32) (temp___is_init_506 Bool) (temp___skip_constant_507 Bool) (temp___do_toplevel_508 Bool)) Bool (=> (or (= temp___is_init_506 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000101 #b10010000000000000000000))) (in_range1 temp___expr_509)))
...
(define-fun dynamic_invariant2 ((temp___expr_515 Float32) (temp___is_init_512 Bool) (temp___skip_constant_513 Bool) (temp___do_toplevel_514 Bool)) Bool (=> (or (= temp___is_init_512 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000010 #b10000000000000000000000))) (in_range2 temp___expr_515)))
...
(define-fun dynamic_invariant3 ((temp___expr_521 Float32) (temp___is_init_518 Bool) (temp___skip_constant_519 Bool) (temp___do_toplevel_520 Bool)) Bool (=> (or (= temp___is_init_518 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000101 #b10010000000000000000000))) (in_range3 temp___expr_521)))
...
(define-fun dynamic_invariant4 ((temp___expr_528 Float32) (temp___is_init_525 Bool) (temp___skip_constant_526 Bool) (temp___do_toplevel_527 Bool)) Bool (=> (or (= temp___is_init_525 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000010 #b10000000000000000000000))) (in_range4 temp___expr_528)))
