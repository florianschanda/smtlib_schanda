...
(assert (= foo__float_tests__sqrt_comedy_1__result1 foo__float_tests__sqrt_comedy_1__result2))
(assert (= foo__float_tests__sqrt_comedy_1__result3 foo__float_tests__sqrt_comedy_1__result1))
(assert (= result foo__float_tests__sqrt_comedy_1__result))
(assert (= foo__float_tests__sqrt_comedy_1__result1 (ite (fp.eq a b) true false)))
(assert (= (mk_bool__ref foo__float_tests__sqrt_comedy_1__result4) (mk_bool__ref foo__float_tests__sqrt_comedy_1__result2)))
(assert (= foo__float_tests__sqrt_comedy_1__result5 foo__float_tests__sqrt_comedy_1__result3))
(assert (= result1 foo__float_tests__sqrt_comedy_1__result4))
(assert (not (= foo__float_tests__sqrt_comedy_1__result4 true)))
(check-sat)
(exit)
