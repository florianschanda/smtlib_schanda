...
(assert (and (= o (fp.add RNE left right)) (fp.isFinite32 (fp.add RNE left right))))
(assert (= (mk_t__ref result) (mk_t__ref numerics__Oadd__result)))
(assert (= numerics__Oadd__result1 o))
(assert (= (mk_t__ref numerics__Oadd__result4) (mk_t__ref numerics__Oadd__result2)))
(assert (= numerics__Oadd__result5 numerics__Oadd__result3))
(assert (not (fp.isFinite32 (fp.add RNE left right))))
(check-sat)
(exit)
