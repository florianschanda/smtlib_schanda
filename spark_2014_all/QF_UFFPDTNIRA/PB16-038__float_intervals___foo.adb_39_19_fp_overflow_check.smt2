...
(declare-fun user_eq1 (unit_t unit_t) Bool)
(declare-fun attr__ATTRIBUTE_IMAGE2 (Float64) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check2 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE2 (us_image) Float64)
(declare-const dummy1 unit_t)
(declare-datatypes () ((unit_t__ref (mk_unit_t__ref (unit_t__content unit_t)))))
(define-fun unit_t__ref___projection ((a unit_t__ref)) unit_t (unit_t__content a))
(define-fun dynamic_invariant ((temp___expr_165 Float64) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool) (temp___do_typ_inv_164 Bool)) Bool (=> (or (= temp___is_init_161 true) (fp.leq (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)) (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))) (in_range1 temp___expr_165)))
(declare-sort inv_t 0)
(define-fun in_range2 ((x Float64)) Bool (and (fp.isFinite64 x) (and (fp.leq (fp.neg (fp #b0 #b10000000111 #b1001000000000000000000000000000000000000000000000000)) x) (fp.leq x (fp #b0 #b10000000111 #b1001000000000000000000000000000000000000000000000000)))))
(declare-fun user_eq2 (inv_t inv_t) Bool)
(declare-fun attr__ATTRIBUTE_IMAGE3 (Float64) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check3 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE3 (us_image) Float64)
(declare-const dummy2 inv_t)
...
(define-fun dynamic_invariant1 ((temp___expr_172 Float64) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool) (temp___do_typ_inv_171 Bool)) Bool (=> (or (= temp___is_init_168 true) (fp.leq (fp.neg (fp #b0 #b10000000111 #b1001000000000000000000000000000000000000000000000000)) (fp #b0 #b10000000111 #b1001000000000000000000000000000000000000000000000000))) (in_range2 temp___expr_172)))
(declare-const x Float64)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const y Float64)
(assert (in_range1 x))
(assert (=> (fp.leq (fp.neg (fp #b0 #b10000000111 #b1001000000000000000000000000000000000000000000000000)) (fp #b0 #b10000000111 #b1001000000000000000000000000000000000000000000000000)) (in_range2 y)))
(assert (not (and (fp.leq (fp.neg (fp #b0 #b01111110110 #b0100011110101110000101000111101011100001010001111011)) x) (fp.leq x (fp #b0 #b01111110110 #b0100011110101110000101000111101011100001010001111011)))))
(assert (not (fp.isFinite64 (fp.div RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) x))))
(check-sat)
(exit)
