...
(assert (= z1 z2))
(assert (= z3 z1))
(assert (not (ite (= (ite (= (fp.leq z2 (fp #b0 #b10000001 #b10000000000000000000000)) false) (fp.geq z2 (fp #b0 #b10000010 #b01100000000000000000000)) true) true) (ite (= (ite (= (fp.leq z2 (fp #b0 #b10000001 #b10000000000000000000000)) true) (fp.geq z2 (fp #b0 #b10000010 #b01100000000000000000000)) false) false) true false) true)))
(check-sat)
(exit)
