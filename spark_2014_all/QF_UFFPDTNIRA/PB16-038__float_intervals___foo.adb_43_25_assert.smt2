...
(assert (fp.leq (fp.neg (fp #b0 #b01111110110 #b0100011110101110000101000111101011100001010001111011)) x))
(assert (fp.leq x (fp #b0 #b01111110110 #b0100011110101110000101000111101011100001010001111011)))
(assert (not (fp.leq (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) x)))
(assert (not (fp.leq x (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))))
(check-sat)
(exit)
