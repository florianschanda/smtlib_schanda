...
(assert (and (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) a) (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) b)))
(assert (= foo__float_tests__underflow_3__result1 foo__float_tests__underflow_3__result2))
(assert (= foo__float_tests__underflow_3__result3 foo__float_tests__underflow_3__result1))
...
(assert (= (mk_t__ref foo__float_tests__underflow_3__result4) (mk_t__ref foo__float_tests__underflow_3__result2)))
(assert (= foo__float_tests__underflow_3__result5 foo__float_tests__underflow_3__result3))
(assert (= result1 foo__float_tests__underflow_3__result4))
(assert (not (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) foo__float_tests__underflow_3__result4)))
(check-sat)
(exit)
