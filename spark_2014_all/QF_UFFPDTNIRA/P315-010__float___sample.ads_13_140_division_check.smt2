...
(assert (not (fp.eq float_ref (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (and (= o (fp.sub RNE float_tested float_ref)) (fp.isFinite32 (fp.sub RNE float_tested float_ref))))
(assert (= o1 (fp.abs o)))
(assert (not (not (fp.isZero float_ref))))
(check-sat)
(exit)
