...
(assert (and (and (= (of_int RNE numerator) num) (and (fp.isFinite32 num) (and (fp.isFinite32 den) (and (fp.lt (fp #b0 #b01111111 #b00000000000000000000000) (fp #b0 #b00000000 #b00000000000000000000001)) (and (and (= basic_contracts__average__result1 basic_contracts__average__result2) (= basic_contracts__average__result3 basic_contracts__average__result1)) (and (and (= o (fp.div RNE num (fp #b0 #b00000000 #b00000000000000000000001))) (fp.isFinite32 (fp.div RNE num (fp #b0 #b00000000 #b00000000000000000000001)))) (and (= result basic_contracts__average__result) (= basic_contracts__average__result1 o)))))))) (and (= (mk_t__ref basic_contracts__average__result4) (mk_t__ref basic_contracts__average__result2)) (= basic_contracts__average__result5 basic_contracts__average__result3))))
