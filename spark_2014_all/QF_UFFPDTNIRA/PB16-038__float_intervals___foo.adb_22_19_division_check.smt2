...
(assert (not (and (fp.leq (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) x) (fp.leq x (fp #b0 #b01111110110 #b0100011110101110000101000111101011100001010001111011)))))
(assert (not (and (fp.leq (fp.neg (fp #b0 #b01111110110 #b0100011110101110000101000111101011100001010001111011)) x) (fp.leq x (fp.neg (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))))))
