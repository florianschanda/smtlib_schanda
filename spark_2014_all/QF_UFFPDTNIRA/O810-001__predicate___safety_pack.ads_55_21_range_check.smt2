...
(define-fun dynamic_invariant1 ((temp___expr_1234 Int) (temp___is_init_1231 Bool) (temp___skip_constant_1232 Bool) (temp___do_toplevel_1233 Bool)) Bool (=> (or (= temp___is_init_1231 true) (<= (- 32768) 32767)) (in_range temp___expr_1234)))
