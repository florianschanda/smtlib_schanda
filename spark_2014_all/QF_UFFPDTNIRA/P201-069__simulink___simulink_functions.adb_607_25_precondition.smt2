...
(define-fun dynamic_invariant ((temp___expr_172 Int) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool) (temp___do_typ_inv_171 Bool)) Bool (=> (or (= temp___is_init_168 true) (<= (- 128) 127)) (in_range temp___expr_172)))
(declare-const i Int)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(assert (in_range i))
(assert (not (or (fp.isZero (of_int RNE i)) (fp.isPositive (of_int RNE i)))))
(check-sat)
(exit)
