...
(assert (and (= o (fp.add RNE x (fp #b0 #b01111101 #b10011001100110011001101))) (fp.isFinite32 (fp.add RNE x (fp #b0 #b01111101 #b10011001100110011001101)))))
(assert (= result x))
(assert (= x1 o))
(assert (= x1 x2))
(assert (= x3 x1))
(assert (not (fp.eq x2 (fp.add RNE x (fp #b0 #b01111101 #b10011001100110011001101)))))
(check-sat)
(exit)
