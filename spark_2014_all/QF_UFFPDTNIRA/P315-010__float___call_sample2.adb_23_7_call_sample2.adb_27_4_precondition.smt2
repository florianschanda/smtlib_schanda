...
(define-fun dynamic_invariant1 ((temp___expr_158 Int) (temp___is_init_154 Bool) (temp___skip_constant_155 Bool) (temp___do_toplevel_156 Bool) (temp___do_typ_inv_157 Bool)) Bool (=> (or (= temp___is_init_154 true) (<= 0 100)) (in_range temp___expr_158)))
(declare-sort delta_time_type 0)
(define-fun in_range1 ((x Float32)) Bool (and (fp.isFinite32 x) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) x) (fp.leq x (fp #b0 #b01111111 #b00000000000000000000000)))))
...
(define-fun dynamic_invariant2 ((temp___expr_172 Float32) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool) (temp___do_typ_inv_171 Bool)) Bool (=> (or (= temp___is_init_168 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b01111111 #b00000000000000000000000))) (in_range1 temp___expr_172)))
...
(declare-datatypes () ((nb_type__ref1 (mk_nb_type__ref1 (nb_type__content1 nb_type1)))))
(define-fun nb_type__ref___2__projection ((a nb_type__ref1)) nb_type1 (nb_type__content1 a))
(define-fun dynamic_invariant3 ((temp___expr_186 Int) (temp___is_init_182 Bool) (temp___skip_constant_183 Bool) (temp___do_toplevel_184 Bool) (temp___do_typ_inv_185 Bool)) Bool (=> (or (= temp___is_init_182 true) (<= 0 100)) (in_range2 temp___expr_186)))
...
(declare-datatypes () ((delta_time_type__ref1 (mk_delta_time_type__ref1 (delta_time_type__content1 delta_time_type1)))))
(define-fun delta_time_type__ref___2__projection ((a delta_time_type__ref1)) delta_time_type1 (delta_time_type__content1 a))
(define-fun dynamic_invariant4 ((temp___expr_200 Float32) (temp___is_init_196 Bool) (temp___skip_constant_197 Bool) (temp___do_toplevel_198 Bool) (temp___do_typ_inv_199 Bool)) Bool (=> (or (= temp___is_init_196 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b01111111 #b00000000000000000000000))) (in_range3 temp___expr_200)))
