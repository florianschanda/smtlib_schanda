...
(assert (and (= o (fp.mul RNE left right)) (fp.isFinite32 (fp.mul RNE left right))))
(assert (= (mk_t__ref result) (mk_t__ref numerics__Omultiply__result)))
(assert (= numerics__Omultiply__result1 o))
(assert (= (mk_t__ref numerics__Omultiply__result4) (mk_t__ref numerics__Omultiply__result2)))
