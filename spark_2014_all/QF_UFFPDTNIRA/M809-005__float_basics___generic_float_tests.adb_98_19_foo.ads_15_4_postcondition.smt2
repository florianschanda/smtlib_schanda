...
(assert (fp.eq (fp.mul RNE a b) (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)))
(assert (= foo__double_tests__underflow_2__result1 foo__double_tests__underflow_2__result2))
(assert (= foo__double_tests__underflow_2__result3 foo__double_tests__underflow_2__result1))
(assert (= result foo__double_tests__underflow_2__result))
(assert (= foo__double_tests__underflow_2__result1 (ite (fp.eq a (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) true (ite (fp.eq b (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) true false))))
(assert (= (mk_bool__ref foo__double_tests__underflow_2__result4) (mk_bool__ref foo__double_tests__underflow_2__result2)))
(assert (= foo__double_tests__underflow_2__result5 foo__double_tests__underflow_2__result3))
(assert (= result1 foo__double_tests__underflow_2__result4))
(assert (not (= foo__double_tests__underflow_2__result4 true)))
(check-sat)
(exit)
