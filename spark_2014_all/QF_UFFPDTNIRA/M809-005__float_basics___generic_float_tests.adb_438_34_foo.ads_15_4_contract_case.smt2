...
(define-fun dynamic_invariant ((temp___expr_167 Float64) (temp___is_init_164 Bool) (temp___skip_constant_165 Bool) (temp___do_toplevel_166 Bool)) Bool (=> (or (= temp___is_init_164 true) (fp.leq (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111))) (fp.isFinite64 temp___expr_167)))
...
(assert (= y1 y2))
(assert (= y3 y1))
(assert (=> (= (fp.eq x (fp.neg (fp #b0 #b01111111111 #b1001100110011001100110011001100110011001100110011010))) true) (fp.eq y2 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))))
(assert (=> (= (fp.eq x (fp.neg (fp #b0 #b01111111111 #b1000000000000000000000000000000000000000000000000000))) true) (fp.eq y2 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))))
(assert (= (fp.eq x (fp.neg (fp #b0 #b01111111111 #b0110011001100110011001100110011001100110011001100110))) true))
