...
(assert (and (and (fp.lt a b) (and (fp.eq c (fp #b0 #b10000001 #b01000000000000000000000)) (and (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) d) (fp.leq d (fp #b0 #b10000010 #b01000000000000000000000))) (and (and (and (and (and (and (= o (fp.add RNE a b)) (fp.isFinite32 (fp.add RNE a b))) (= o1 (fp.add RNE o c))) (and (= o2 o1) (fp.isFinite32 o1))) (= o3 (fp.add RNE o2 d))) (and (= o4 o3) (fp.isFinite32 o3))) (and (= result z) (= z1 o4)))))) (and (= z1 z2) (= z3 z1))))
