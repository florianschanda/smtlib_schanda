...
(assert (= foo__float_tests__negate_wrong__result1 foo__float_tests__negate_wrong__result2))
(assert (= foo__float_tests__negate_wrong__result3 foo__float_tests__negate_wrong__result1))
(assert (and (= o (fp.sub RNE (fp #b0 #b00000000 #b00000000000000000000000) x)) (fp.isFinite32 (fp.sub RNE (fp #b0 #b00000000 #b00000000000000000000000) x))))
(assert (= result foo__float_tests__negate_wrong__result))
(assert (= foo__float_tests__negate_wrong__result1 o))
(assert (= (mk_t__ref foo__float_tests__negate_wrong__result4) (mk_t__ref foo__float_tests__negate_wrong__result2)))
(assert (= foo__float_tests__negate_wrong__result5 foo__float_tests__negate_wrong__result3))
(assert (= result1 foo__float_tests__negate_wrong__result4))
(assert (not (fp.eq foo__float_tests__negate_wrong__result4 (fp.neg x))))
(check-sat)
(exit)
