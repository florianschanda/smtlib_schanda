...
(assert (and (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) x) (fp.leq x (fp #b0 #b10000010 #b01000000000000000000000))) (and (fp.leq (fp #b0 #b10000001 #b01000000000000000000000) y) (fp.leq y (fp #b0 #b10000010 #b01000000000000000000000)))))
