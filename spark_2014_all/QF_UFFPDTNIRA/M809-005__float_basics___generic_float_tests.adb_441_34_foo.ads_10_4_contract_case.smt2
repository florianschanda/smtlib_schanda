...
(assert (=> (= (fp.eq x (fp #b0 #b00000000 #b00000000000000000000000)) true) (fp.eq y2 (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (= (fp.eq x (fp #b0 #b01111111 #b00000000000000000000000)) true))
(assert (not (fp.eq y2 (fp #b0 #b01111111 #b00000000000000000000000))))
(check-sat)
(exit)
