...
(assert (and (and (fp.leq (fp.neg (fp #b0 #b10000001 #b01000000000000000000000)) x) (fp.leq x (fp #b0 #b10000010 #b01000000000000000000000))) (and (fp.leq (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)) y) (fp.leq y (fp #b0 #b10000010 #b01000000000000000000000)))))
(assert (and (= o (fp.mul RNE x y)) (fp.isFinite32 (fp.mul RNE x y))))
(assert (= result (ite (fp.leq o (fp.neg (fp #b0 #b10000011 #b11100000000000000000000))) true false)))
(assert (= result true))
(assert (not (fp.lt x (fp #b0 #b00000000 #b00000000000000000000000))))
(check-sat)
(exit)
