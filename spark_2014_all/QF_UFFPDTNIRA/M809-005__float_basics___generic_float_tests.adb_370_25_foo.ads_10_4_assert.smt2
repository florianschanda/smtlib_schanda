...
(assert (not (fp.eq x (fp #b0 #b01111101 #b10011001100110011001101))))
(assert (not (fp.eq x (fp #b0 #b01111110 #b00000000000000000000000))))
(assert (not (fp.eq x (fp #b0 #b01111110 #b00110011001100110011010))))
(assert (fp.eq x (fp #b0 #b10000010 #b10000000000000000000000)))
(assert (fp.eq (fp.roundToIntegral RTN x) (fp #b0 #b10000010 #b10000000000000000000000)))
(assert (not (fp.eq (fp.roundToIntegral RTP x) (fp #b0 #b10000010 #b10000000000000000000000))))
(check-sat)
(exit)
