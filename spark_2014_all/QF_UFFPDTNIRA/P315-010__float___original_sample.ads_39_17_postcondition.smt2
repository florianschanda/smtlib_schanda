...
(assert (= t_fp1 o1))
(assert (and (= o2 (fp.add RNE t_fp1 (fp.mul RNE (of_int RNE nb_of_fp) delta_time))) (fp.isFinite32 (fp.add RNE t_fp1 (fp.mul RNE (of_int RNE nb_of_fp) delta_time)))))
(assert (= (mk_t__ref result2) (mk_t__ref t_pp)))
(assert (= t_pp1 o2))
(assert (and (= o3 (fp.add RNE t_pp1 (fp.mul RNE (fp.mul RNE (fp #b0 #b01111110 #b00000000000000000000000) (of_int RNE nb_of_fp)) delta_time))) (fp.isFinite32 (fp.add RNE t_pp1 (fp.mul RNE (fp.mul RNE (fp #b0 #b01111110 #b00000000000000000000000) (of_int RNE nb_of_fp)) delta_time)))))
(assert (= result3 time))
(assert (= time1 o3))
(assert (= t_pp2 t_pp1))
(assert (= t_fp2 t_fp1))
