...
(assert (and (and (fp.leq (fp.neg (fp #b0 #b11111101 #b11111111111111111111111)) val1) (fp.leq val1 (fp #b0 #b11111101 #b11111111111111111111111))) (and (and (fp.leq (fp.neg (fp #b0 #b11111101 #b11111111111111111111111)) val2) (fp.leq val2 (fp #b0 #b11111101 #b11111111111111111111111))) (and (and (fp.leq (fp.neg (fp #b0 #b11111101 #b11111111111111111111111)) val3) (fp.leq val3 (fp #b0 #b11111101 #b11111111111111111111111))) (fp.leq val1 val2)))))
(assert (not (fp.leq (fp.sub RNE val1 val3) (fp.sub RNE val2 val3))))
(check-sat)
(exit)
