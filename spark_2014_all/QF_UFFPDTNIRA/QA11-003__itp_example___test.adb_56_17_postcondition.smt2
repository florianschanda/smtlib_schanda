...
(assert (and (= o (fp.add RNE b1 (fp #b0 #b01111111 #b00011001100110011001101))) (fp.isFinite32 (fp.add RNE b1 (fp #b0 #b01111111 #b00011001100110011001101)))))
(assert (= result1 b1))
(assert (= b2 o))
...
(assert (= (mk_t__ref test__test_6__result4) (mk_t__ref test__test_6__result2)))
(assert (= b3 b2))
(assert (= test__test_6__result5 test__test_6__result3))
(assert (= b4 b2))
(assert (= result3 test__test_6__result4))
(assert (not (fp.eq test__test_6__result4 (fp #b0 #b01111011 #b10011001100110011001101))))
(check-sat)
(exit)
