...
(define-fun dynamic_invariant1 ((temp___expr_137 Float32) (temp___is_init_134 Bool) (temp___skip_constant_135 Bool) (temp___do_toplevel_136 Bool)) Bool (=> (or (= temp___is_init_134 true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111))) (fp.isFinite32 temp___expr_137)))
...
(assert (and (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) x) (fp.leq x (fp #b0 #b10001011 #b00000000000000000000000))))
(assert (and (= o (to_int1 RNA x)) (in_range1 (to_int1 RNA x))))
(assert (= result i))
(assert (= i1 o))
(assert (= i1 i2))
(assert (= i3 i1))
(assert (=> (= (fp.eq x (fp.neg (fp #b0 #b01111111 #b10011001100110011001101))) true) (= i2 (- 2))))
(assert (=> (= (fp.eq x (fp.neg (fp #b0 #b01111111 #b10000000000000000000000))) true) (= i2 (- 2))))
(assert (=> (= (fp.eq x (fp.neg (fp #b0 #b01111111 #b01100110011001100110011))) true) (= i2 (- 1))))
(assert (=> (= (fp.eq x (fp.neg (fp #b0 #b01111111 #b00000000000000000000000))) true) (= i2 (- 1))))
(assert (=> (= (fp.eq x (fp #b0 #b00000000 #b00000000000000000000000)) true) (= i2 0)))
(assert (=> (= (fp.eq x (fp #b0 #b01111111 #b00000000000000000000000)) true) (= i2 1)))
(assert (=> (= (fp.eq x (fp #b0 #b01111111 #b01100110011001100110011)) true) (= i2 1)))
(assert (=> (= (fp.eq x (fp #b0 #b01111111 #b10000000000000000000000)) true) (= i2 2)))
