...
(assert (= fl_last_sqrt (fp #b0 #b10111111110 #b0000000000000000000000000000000000000000000000000000)))
(declare-const o Float64)
(assert (fp.isFinite64 fl_last_sqrt))
(assert (= (fp #b0 #b10111111110 #b0000000000000000000000000000000000000000000000000000) fl_last_sqrt))
(assert (fp.isFinite64 val1))
(assert (fp.isFinite64 val2))
(assert (fp.isFinite64 val3))
(assert (and (and (fp.leq (fp.neg (fp #b0 #b10111111110 #b0000000000000000000000000000000000000000000000000000)) val1) (fp.leq val1 fl_last_sqrt)) (and (and (fp.leq (fp.neg (fp #b0 #b10111111110 #b0000000000000000000000000000000000000000000000000000)) val2) (fp.leq val2 fl_last_sqrt)) (and (and (fp.leq (fp.neg (fp #b0 #b10111111110 #b0000000000000000000000000000000000000000000000000000)) val3) (fp.leq val3 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))) (fp.leq val1 val2)))))
(assert (and (= o (fp.mul RNE val1 val3)) (fp.isFinite64 (fp.mul RNE val1 val3))))
(assert (not (fp.isFinite64 (fp.mul RNE val2 val3))))
(check-sat)
(exit)
