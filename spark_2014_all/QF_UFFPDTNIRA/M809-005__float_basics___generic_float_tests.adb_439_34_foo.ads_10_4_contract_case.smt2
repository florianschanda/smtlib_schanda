...
(assert (= y1 y2))
(assert (= y3 y1))
(assert (=> (= (fp.eq x (fp.neg (fp #b0 #b01111111 #b10011001100110011001101))) true) (fp.eq y2 (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)))))
(assert (=> (= (fp.eq x (fp.neg (fp #b0 #b01111111 #b10000000000000000000000))) true) (fp.eq y2 (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)))))
(assert (=> (= (fp.eq x (fp.neg (fp #b0 #b01111111 #b01100110011001100110011))) true) (fp.eq y2 (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)))))
(assert (= (fp.eq x (fp.neg (fp #b0 #b01111111 #b00000000000000000000000))) true))
