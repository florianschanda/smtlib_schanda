...
(assert (not (<= 1 (+ (+ (+ 0 (ite (and (fp.leq (fp.neg threshold) value) (fp.leq value threshold)) 1 0)) (ite (= (fp.gt value threshold) true) 1 0)) (ite (= (fp.lt value (fp.neg threshold)) true) 1 0)))))
(check-sat)
(exit)
