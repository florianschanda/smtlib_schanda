...
(assert (and (= o8 (fp.add RNE x (fp #b0 #b10000000 #b00000000000000000000000))) (fp.isFinite32 (fp.add RNE x (fp #b0 #b10000000 #b00000000000000000000000)))))
(assert (= o9 (fp.mul RNE o8 x)))
(assert (and (= o10 o9) (fp.isFinite32 o9)))
(assert (= o11 (fp.add RNE o10 (fp #b0 #b10000000 #b10000000000000000000000))))
(assert (and (= o12 o11) (fp.isFinite32 o11)))
(assert (= o13 (fp.add RNE o12 (fp #b0 #b10000001 #b00000000000000000000000))))
(assert (and (= o14 o13) (fp.isFinite32 o13)))
(assert (= o15 (fp.mul RNE o14 x)))
(assert (and (= o16 o15) (fp.isFinite32 o15)))
(assert (= o17 (fp.add RNE o16 (fp #b0 #b10000001 #b01000000000000000000000))))
(assert (and (= o18 o17) (fp.isFinite32 o17)))
(assert (= o19 (ite (fp.leq o18 (fp #b0 #b11111110 #b11111111111111111111111)) true false)))
