...
(define-fun in_range1 ((x Float32)) Bool (and (fp.isFinite32 x) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) x) (fp.leq x (fp #b0 #b10000011 #b00000000000000000000000)))))
(declare-fun user_eq1 (nb_float_type nb_float_type) Bool)
(declare-fun attr__ATTRIBUTE_IMAGE2 (Float32) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check2 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE2 (us_image) Float32)
(declare-const dummy1 nb_float_type)
(declare-datatypes () ((nb_float_type__ref (mk_nb_float_type__ref (nb_float_type__content nb_float_type)))))
(define-fun nb_float_type__ref___projection ((a nb_float_type__ref)) nb_float_type (nb_float_type__content a))
(define-fun dynamic_invariant1 ((temp___expr_153 Float32) (temp___is_init_150 Bool) (temp___skip_constant_151 Bool) (temp___do_toplevel_152 Bool)) Bool (=> (or (= temp___is_init_150 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000011 #b00000000000000000000000))) (in_range1 temp___expr_153)))
...
(assert (and (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) time) (fp.lt time (fp #b0 #b10000010 #b01000000000000000000000))))
(assert (and (= o (fp.add RNE time (fp.mul RNE (fp #b0 #b01111110 #b00000000000000000000000) nb))) (fp.isFinite32 (fp.add RNE time (fp.mul RNE (fp #b0 #b01111110 #b00000000000000000000000) nb)))))
(assert (= result time))
(assert (= time1 o))
(assert (= time1 time2))
(assert (= time3 time1))
