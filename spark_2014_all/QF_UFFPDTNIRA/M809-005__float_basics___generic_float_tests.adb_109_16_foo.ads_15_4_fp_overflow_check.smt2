...
(assert (and (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) a) (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) b)))
(assert (not (fp.isFinite64 (fp.mul RNE a b))))
(check-sat)
(exit)
