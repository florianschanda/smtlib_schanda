...
(assert (and (= o (fp.sub RNE f (fp #b0 #b00000000 #b00000000000000000000000))) (fp.isFinite32 (fp.sub RNE f (fp #b0 #b00000000 #b00000000000000000000000)))))
(assert (= result f))
(assert (= f1 o))
(assert (= f1 f2))
(assert (= f3 f1))
(assert (not (fp.eq f2 f)))
(check-sat)
(exit)
