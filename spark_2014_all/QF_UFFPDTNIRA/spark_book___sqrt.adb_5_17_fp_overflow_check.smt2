...
(assert (= approx1 (fp.div RNE x (fp #b0 #b10000000 #b00000000000000000000000))))
...
(assert (= o3 (fp.abs o2)))
(assert (= result1 (ite (fp.lt tolerance o3) true false)))
(assert (= result1 true))
(assert (and (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)) (fp.isFinite32 approx2)) (fp.lt tolerance (fp.abs (fp.sub RNE x (fp.mul RNE approx2 approx2))))))
(assert (and (= o4 (fp.div RNE x approx2)) (fp.isFinite32 (fp.div RNE x approx2))))
(assert (= o5 (fp.add RNE approx2 o4)))
(assert (and (= o6 o5) (fp.isFinite32 o5)))
(assert (= o7 (fp.mul RNE (fp #b0 #b01111110 #b00000000000000000000000) o6)))
(assert (= result2 approx2))
(assert (= approx3 o7))
(assert (and (= o8 (fp.mul RNE approx3 approx3)) (fp.isFinite32 (fp.mul RNE approx3 approx3))))
(assert (= o9 (fp.sub RNE x o8)))
(assert (not (fp.isFinite32 o9)))
(check-sat)
(exit)
