...
(declare-sort x_t 0)
(define-fun in_range ((x Float64)) Bool (and (fp.isFinite64 x) (and (fp.leq (fp #b0 #b10000000010 #b0100000000000000000000000000000000000000000000000000) x) (fp.leq x (fp #b0 #b10000000100 #b1001000000000000000000000000000000000000000000000000)))))
...
(define-fun dynamic_invariant ((temp___expr_141 Float64) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool (=> (or (= temp___is_init_138 true) (fp.leq (fp #b0 #b10000000010 #b0100000000000000000000000000000000000000000000000000) (fp #b0 #b10000000100 #b1001000000000000000000000000000000000000000000000000))) (in_range temp___expr_141)))
