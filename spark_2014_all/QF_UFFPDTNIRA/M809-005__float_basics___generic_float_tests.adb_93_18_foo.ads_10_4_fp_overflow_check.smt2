...
(assert (and (= o (fp.div RNE (fp #b0 #b01111111 #b00000000000000000000000) a)) (fp.isFinite32 (fp.div RNE (fp #b0 #b01111111 #b00000000000000000000000) a))))
(assert (= o1 (fp.div RNE (fp #b0 #b01111111 #b00000000000000000000000) o)))
