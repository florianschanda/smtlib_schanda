...
(define-fun dynamic_invariant ((temp___expr_178 Float32) (temp___is_init_175 Bool) (temp___skip_constant_176 Bool) (temp___do_toplevel_177 Bool)) Bool (=> (or (= temp___is_init_175 true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111))) (fp.isFinite32 temp___expr_178)))
...
(assert (fp.leq (fp.div RNE x (fp #b0 #b11111110 #b11111111111111111111111)) y))
(assert (not (fp.isFinite32 (fp.div RNE x y))))
(check-sat)
(exit)
