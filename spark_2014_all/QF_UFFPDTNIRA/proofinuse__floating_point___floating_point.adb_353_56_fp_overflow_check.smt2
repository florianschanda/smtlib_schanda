...
(assert (and (= o10 (fp.add RNE x (fp #b0 #b10000000 #b00000000000000000000000))) (fp.isFinite32 (fp.add RNE x (fp #b0 #b10000000 #b00000000000000000000000)))))
(assert (= o11 (fp.mul RNE o10 x)))
(assert (and (= o12 o11) (fp.isFinite32 o11)))
(assert (= o13 (fp.add RNE o12 (fp #b0 #b10000000 #b10000000000000000000000))))
(assert (and (= o14 o13) (fp.isFinite32 o13)))
(assert (= o15 (fp.add RNE o14 (fp #b0 #b10000001 #b00000000000000000000000))))
(assert (and (= o16 o15) (fp.isFinite32 o15)))
(assert (= o17 (fp.mul RNE o16 x)))
(assert (and (= o18 o17) (fp.isFinite32 o17)))
(assert (= o19 (fp.add RNE o18 (fp #b0 #b10000001 #b01000000000000000000000))))
(assert (and (= o20 o19) (fp.isFinite32 o19)))
(assert (= o21 (ite (fp.leq o20 (fp #b0 #b11111110 #b11111111111111111111111)) true false)))
