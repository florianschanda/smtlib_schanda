...
(assert (and (and (fp.leq (fp.neg (fp #b0 #b10111111110 #b0000000000000000000000000000000000000000000000000000)) val1) (fp.leq val1 fl_last_sqrt)) (and (and (fp.leq (fp.neg (fp #b0 #b10111111110 #b0000000000000000000000000000000000000000000000000000)) val2) (fp.leq val2 fl_last_sqrt)) (and (and (fp.leq (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) val3) (fp.leq val3 fl_last_sqrt)) (fp.leq val1 val2)))))
