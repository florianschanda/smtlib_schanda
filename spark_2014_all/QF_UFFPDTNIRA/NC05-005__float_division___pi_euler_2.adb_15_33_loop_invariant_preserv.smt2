...
(define-fun dynamic_invariant1 ((temp___expr_158 Int) (temp___is_init_154 Bool) (temp___skip_constant_155 Bool) (temp___do_toplevel_156 Bool) (temp___do_typ_inv_157 Bool)) Bool (=> (or (= temp___is_init_154 true) (<= 1 9223372036854775807)) (in_range2 temp___expr_158)))
...
(define-fun dynamic_invariant2 ((temp___expr_165 Float64) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool) (temp___do_typ_inv_164 Bool)) Bool (=> (or (= temp___is_init_161 true) (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111))) (in_range3 temp___expr_165)))
(declare-const attr__ATTRIBUTE_ADDRESS3 Int)
(define-fun dynamic_invariant3 ((temp___expr_25 Int) (temp___is_init_21 Bool) (temp___skip_constant_22 Bool) (temp___do_toplevel_23 Bool) (temp___do_typ_inv_24 Bool)) Bool (=> (or (= temp___is_init_21 true) (<= (- 9223372036854775808) 9223372036854775807)) (in_range1 temp___expr_25)))
...
(assert (= index3 o1))
(assert (and (= o2 (fp.add RNE index_float2 (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))) (fp.isFinite64 (fp.add RNE index_float2 (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))))
(assert (= result7 index_float2))
(assert (= index_float3 o2))
(assert (not (fp.lt erreur3 (fp #b0 #b01111100111 #b0101011110011000111011100010001100001000110000111010))))
(assert (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) index_float3)))
(check-sat)
(exit)
