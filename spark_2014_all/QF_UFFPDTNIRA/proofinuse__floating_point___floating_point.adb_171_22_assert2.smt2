...
(assert (= result res))
(assert (= res1 o13))
(assert (and (fp.leq (fp.neg (fp #b0 #b01111111 #b00000000000000001010100)) res1) (fp.leq res1 (fp #b0 #b01111111 #b00000000000000001010100))))
(assert (not (fp.leq (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)) res1)))
(check-sat)
(exit)
