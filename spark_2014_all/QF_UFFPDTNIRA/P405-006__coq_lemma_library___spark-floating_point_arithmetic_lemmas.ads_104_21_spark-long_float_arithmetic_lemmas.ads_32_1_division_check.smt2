...
(assert (and (and (fp.leq (fp.neg (fp #b0 #b10111111110 #b0000000000000000000000000000000000000000000000000000)) val1) (fp.leq val1 (fp #b0 #b10111111110 #b0000000000000000000000000000000000000000000000000000))) (and (and (fp.leq (fp.neg (fp #b0 #b10111111110 #b0000000000000000000000000000000000000000000000000000)) val2) (fp.leq val2 (fp #b0 #b10111111110 #b0000000000000000000000000000000000000000000000000000))) (and (and (fp.leq (fp #b0 #b01000000000 #b0000000000000000000000000000000000000000000000000000) val3) (fp.leq val3 (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111))) (fp.leq val1 val2)))))
