...
(declare-const m Float64)
(declare-const result Float64)
(declare-const m1 Float64)
(declare-const m2 Float64)
(declare-const m3 Float64)
(assert (fp.isFinite64 x))
(assert (fp.isFinite64 y))
(assert (=> (fp.leq (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) (fp.isFinite64 m)))
(assert (= result m))
(assert (= m1 (fp.max x y)))
(assert (= m1 m2))
(assert (= m3 m1))
(assert (not (fp.leq y m2)))
(check-sat)
(exit)
