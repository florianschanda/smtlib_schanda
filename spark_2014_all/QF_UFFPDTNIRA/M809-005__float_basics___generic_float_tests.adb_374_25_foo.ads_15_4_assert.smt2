...
(assert (fp.eq (fp.roundToIntegral RTN x) (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))))
(assert (not (fp.eq (fp.roundToIntegral RTP x) (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))))
(check-sat)
(exit)
