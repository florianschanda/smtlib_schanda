...
(assert (and (fp.lt r1 (fp #b0 #b01111111 #b00000000000000000000000)) (and (fp.lt r2 (fp #b0 #b01111111 #b00000000000000000000000)) (and (fp.lt (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)) r1) (fp.lt (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)) r2)))))
...
(assert (not (fp.isFinite32 (fp.add RNE r1 r2))))
(check-sat)
(exit)
