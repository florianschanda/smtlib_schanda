...
(assert (= result1 b))
(assert (= b1 o1))
(assert (and (= o2 (fp.div RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) b1)) (fp.isFinite64 (fp.div RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) b1))))
(assert (= result2 c))
(assert (= c1 o2))
