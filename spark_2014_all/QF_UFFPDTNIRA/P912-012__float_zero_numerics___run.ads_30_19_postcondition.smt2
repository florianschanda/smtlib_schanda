...
(define-fun dynamic_invariant1 ((temp___expr_172 Float32) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool) (temp___do_typ_inv_171 Bool)) Bool (=> (or (= temp___is_init_168 true) (fp.leq (fp #b0 #b01111111 #b00000000000000000000000) (fp #b0 #b10000101 #b10010000000000000000000))) (in_range temp___expr_172)))
...
(assert (not (fp.eq (fp.sub RNE x2 x1) (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (and (= o (fp.sub RNE x2 x1)) (and (fp.isFinite32 o) (and (= o (fp.sub RNE x2 x1)) (fp.eq o (fp.sub RNE x2 x1))))))
(assert (= result y))
(assert (= y1 o))
(assert (= y1 y2))
(assert (= y3 y1))
