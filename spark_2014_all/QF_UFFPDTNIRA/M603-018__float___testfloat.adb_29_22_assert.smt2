...
(assert (and (and (fp.leq x z) (fp.leq z y)) (and (and (fp.leq (fp.neg (fp #b0 #b10000010 #b01000000000000000000000)) x) (fp.leq x (fp #b0 #b10000010 #b01000000000000000000000))) (and (fp.eq y (fp.add RNE x (fp #b0 #b01111111 #b00000000000000000000000))) (and (fp.eq (fp.roundToIntegral RTN z) x) (fp.eq (fp.roundToIntegral RTP z) y))))))
(assert (and (= o1 (fp.add RNE x y)) (fp.isFinite32 (fp.add RNE x y))))
(assert (= o2 (fp.div RNE o1 (fp #b0 #b10000000 #b00000000000000000000000))))
(assert (= result t))
(assert (= t1 o2))
...
(assert (not (fp.eq (fp.roundToIntegral RTP t1) y)))
(check-sat)
(exit)
