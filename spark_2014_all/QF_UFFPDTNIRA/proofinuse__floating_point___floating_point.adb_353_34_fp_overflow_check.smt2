...
(assert (and (= o2 (fp.add RNE x (fp #b0 #b10000000 #b00000000000000000000000))) (fp.isFinite32 (fp.add RNE x (fp #b0 #b10000000 #b00000000000000000000000)))))
(assert (= o3 (fp.mul RNE o2 x)))
(assert (and (= o4 o3) (fp.isFinite32 o3)))
(assert (= o5 (fp.add RNE o4 (fp #b0 #b10000000 #b10000000000000000000000))))
(assert (and (= o6 o5) (fp.isFinite32 o5)))
(assert (= o7 (fp.add RNE o6 (fp #b0 #b10000001 #b00000000000000000000000))))
(assert (and (= o8 o7) (fp.isFinite32 o7)))
(assert (= o9 (fp.mul RNE o8 x)))
(assert (and (= o10 o9) (fp.isFinite32 o9)))
(assert (= o11 (fp.add RNE o10 (fp #b0 #b10000001 #b01000000000000000000000))))
(assert (and (= o12 o11) (fp.isFinite32 o11)))
(assert (= o13 (ite (fp.leq o12 (fp #b0 #b11111110 #b11111111111111111111111)) true false)))
