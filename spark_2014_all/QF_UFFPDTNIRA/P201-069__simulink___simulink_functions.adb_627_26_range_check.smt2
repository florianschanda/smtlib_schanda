...
(define-fun dynamic_invariant ((temp___expr_186 Int) (temp___is_init_182 Bool) (temp___skip_constant_183 Bool) (temp___do_toplevel_184 Bool) (temp___do_typ_inv_185 Bool)) Bool (=> (or (= temp___is_init_182 true) (<= (- 2147483648) 2147483647)) (in_range temp___expr_186)))
(declare-const i Int)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(assert (in_range i))
(assert (not (in_range (to_int1 RNA (fp.sqrt RNE (of_int RNE i))))))
(check-sat)
(exit)
