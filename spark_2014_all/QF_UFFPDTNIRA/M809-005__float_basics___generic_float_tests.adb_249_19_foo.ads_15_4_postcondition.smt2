...
(assert (and (= o (fp.sub RNE f (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))) (fp.isFinite64 (fp.sub RNE f (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)))))
(assert (= result f))
(assert (= f1 o))
(assert (= f1 f2))
(assert (= f3 f1))
