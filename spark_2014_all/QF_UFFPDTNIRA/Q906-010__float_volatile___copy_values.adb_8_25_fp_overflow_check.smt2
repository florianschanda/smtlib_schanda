...
(assert (fp.lt (fp #b0 #b10000101 #b10010000000000000000000) (fp.abs cur_speed)))
(assert (not (fp.isFinite32 (fp.sub RNE motor (fp #b0 #b01111111 #b00000000000000000000000)))))
(check-sat)
(exit)
