...
(assert (and (= o11 (fp.add RNE x (fp #b0 #b10000000 #b00000000000000000000000))) (fp.isFinite32 (fp.add RNE x (fp #b0 #b10000000 #b00000000000000000000000)))))
(assert (= o12 (fp.mul RNE o11 x)))
(assert (and (= o13 o12) (fp.isFinite32 o12)))
(assert (= o14 (fp.add RNE o13 (fp #b0 #b10000000 #b10000000000000000000000))))
(assert (and (= o15 o14) (fp.isFinite32 o14)))
(assert (= o16 (fp.add RNE o15 (fp #b0 #b10000001 #b00000000000000000000000))))
