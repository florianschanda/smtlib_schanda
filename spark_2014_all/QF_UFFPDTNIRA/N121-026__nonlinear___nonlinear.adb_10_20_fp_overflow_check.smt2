...
(assert (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)) (fp.isFinite32 result__)))
(assert (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) x) (fp.leq x (fp #b0 #b10000110 #b01101000000000000000000))))
(assert (and (fp.leq (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)) y) (fp.leq y (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) z) (fp.leq z (fp #b0 #b01111111 #b00000000000000000000000))))
(assert (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp.add RNE x y)))
(assert (not (fp.isFinite32 (fp.mul RNE y z))))
(check-sat)
(exit)
