...
(assert (not (fp.eq b (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))))
(assert (= foo__double_tests__bad_optimisation_1__result1 foo__double_tests__bad_optimisation_1__result2))
(assert (= foo__double_tests__bad_optimisation_1__result3 foo__double_tests__bad_optimisation_1__result1))
(assert (and (= o (fp.div RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) b)) (fp.isFinite64 (fp.div RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) b))))
(assert (= o1 (fp.mul RNE a o)))
(assert (and (= o2 o1) (fp.isFinite64 o1)))
(assert (= (mk_t__ref result) (mk_t__ref foo__double_tests__bad_optimisation_1__result)))
(assert (= foo__double_tests__bad_optimisation_1__result1 o2))
(assert (= (mk_t__ref foo__double_tests__bad_optimisation_1__result4) (mk_t__ref foo__double_tests__bad_optimisation_1__result2)))
(assert (= foo__double_tests__bad_optimisation_1__result5 foo__double_tests__bad_optimisation_1__result3))
(assert (= result1 foo__double_tests__bad_optimisation_1__result4))
(assert (not (fp.eq foo__double_tests__bad_optimisation_1__result4 (fp.div RNE a b))))
(check-sat)
(exit)
