...
(assert (= nextup_one (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000001)))
(assert (fp.isFinite64 nextup_one))
(assert (= (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000001) nextup_one))
(assert (fp.isFinite64 x))
(assert (fp.isFinite64 y))
(assert (fp.isFinite64 z))
(assert (not (not (and (and (and (fp.eq x (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)) (fp.eq z nextup_one)) (fp.lt x y)) (fp.lt y z)))))
(check-sat)
(exit)
