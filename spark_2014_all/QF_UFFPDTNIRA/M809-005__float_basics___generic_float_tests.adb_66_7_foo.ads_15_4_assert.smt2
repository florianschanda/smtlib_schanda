...
(assert (not (not (and (and (and (fp.eq x (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)) (fp.eq z (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000001))) (fp.lt x y)) (fp.lt y z)))))
(check-sat)
(exit)
