...
(assert (and (= o (fp.div RNE left right)) (fp.isFinite32 (fp.div RNE left right))))
(assert (= (mk_t__ref result) (mk_t__ref numerics__Odivide__result)))
(assert (= numerics__Odivide__result1 o))
(assert (= (mk_t__ref numerics__Odivide__result4) (mk_t__ref numerics__Odivide__result2)))
(assert (= numerics__Odivide__result5 numerics__Odivide__result3))
(assert (not (fp.isFinite32 (fp.div RNE left right))))
(check-sat)
(exit)
