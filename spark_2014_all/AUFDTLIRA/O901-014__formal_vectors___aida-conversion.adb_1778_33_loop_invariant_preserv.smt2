...
(assert (<= temp___2120 index1))
(assert (<= index1 temp___2121))
...
(assert (and (and (=> (<= (+ (to_rep1 (first (rt source))) 2) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 2) (+ (to_rep1 (first (rt source))) 10) index2)) (forall ((temp___2119 Int)) (=> (and (<= (to_rep1 n__first) temp___2119) (<= temp___2119 (to_rep1 n__last))) (=> (< index2 temp___2119) (= (select n3 temp___2119) (select n1 temp___2119)))))) (and (<= (+ (to_rep1 (first (rt source))) 2) index2) (<= index2 (+ (to_rep1 (first (rt source))) 10)))))
(assert (not (= index2 temp___2121)))
