...
(assert (and (= (length source) 11) (and (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 50)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 48)) (forall ((index4 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 2) index4) (<= index4 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index4))) true))))))
...
(assert (<= temp___2222 index1))
(assert (<= index1 temp___2223))
(assert (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last))))
(assert (= o index1))
(assert (= o1 (select n1 o)))
(assert (= o2 (to_rep1 o1)))
(assert (= o2 aida__conversion__convert_character_digit_to_integer__2__target))
(assert (and (<= (to_rep1 (first (rt source))) index1) (<= index1 (to_rep1 (last (rt source))))))
(assert (= o3 index1))
...
(assert (= (to_rep1 o6) aida__conversion__convert_character_digit_to_integer__2__target2))
(assert (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last))))
(assert (= o7 index1))
(assert (= o8 (store n1 o7 o6)))
(assert (= n1 result3))
(assert (= n2 o8))
(assert (forall ((i Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 2) i) (<= i index2)) (and (<= 0 (to_rep1 (select n3 i))) (<= (to_rep1 (select n3 i)) 9)))))
(assert (forall ((j Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 2) j) (<= j index2)) (<= (to_rep1 (select n3 j)) (to_rep1 (select int_array1 j))))))
(assert (and (and (=> (<= (+ (to_rep1 (first (rt source))) 2) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 2) (+ (to_rep1 (first (rt source))) 10) index2)) (forall ((temp___2221 Int)) (=> (and (<= (to_rep1 n__first) temp___2221) (<= temp___2221 (to_rep1 n__last))) (=> (< index2 temp___2221) (= (select n3 temp___2221) (select n1 temp___2221)))))) (and (<= (+ (to_rep1 (first (rt source))) 2) index2) (<= index2 (+ (to_rep1 (first (rt source))) 10)))))
(assert (not (= index2 temp___2223)))
(assert (= index2 result4))
(assert (= index3 (+ index2 1)))
(assert (and (<= (to_rep1 n__first) index3) (<= index3 (to_rep1 n__last))))
(assert (= o9 index3))
(assert (= o10 (select n3 o9)))
(assert (= o11 (to_rep1 o10)))
(assert (= o11 aida__conversion__convert_character_digit_to_integer__2__target1))
(assert (and (<= (to_rep1 (first (rt source))) index3) (<= index3 (to_rep1 (last (rt source))))))
(assert (= o12 index3))
(assert (= o13 (select (elts source) o12)))
(assert (= o14 (to_rep o13)))
(assert (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target3) (<= aida__conversion__convert_character_digit_to_integer__2__target3 9)) (= aida__conversion__convert_character_digit_to_integer__2__target3 (convert_character_digit_to_integer o14))) (ite (= (= o14 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 0) (ite (= (= o14 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 1) (ite (= (= o14 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 2) (ite (= (= o14 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 3) (ite (= (= o14 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 4) (ite (= (= o14 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 5) (ite (= (= o14 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 6) (ite (= (= o14 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 7) (ite (= (= o14 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 8) (=> (= (= o14 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target3)))
(assert (= (to_rep1 o15) aida__conversion__convert_character_digit_to_integer__2__target3))
(assert (and (<= (to_rep1 n__first) index3) (<= index3 (to_rep1 n__last))))
(assert (= o16 index3))
(assert (= o17 (store n3 o16 o15)))
(assert (= result5 n3))
(assert (= n4 o17))
(declare-const i Int)
(assert (<= (+ (to_rep1 (first (rt source))) 2) i))
(assert (<= i index3))
(assert (not (<= 0 (to_rep1 (select n4 i)))))
(check-sat)
(exit)
