...
(assert (<= temp___2120 index2))
(assert (<= index2 temp___2121))
(assert (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))))
(assert (= o13 index2))
(assert (= o14 (select n1 o13)))
(assert (= o15 (to_rep1 o14)))
(assert (= o15 aida__conversion__convert_character_digit_to_integer__2__target))
...
(assert (= (to_rep1 o19) aida__conversion__convert_character_digit_to_integer__2__target2))
(assert (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))))
(assert (= o20 index2))
(assert (= o21 (store n1 o20 o19)))
(assert (= n1 result4))
(assert (= n2 o21))
(assert (forall ((i2 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 2) i2) (<= i2 index3)) (and (<= 0 (to_rep1 (select n3 i2))) (<= (to_rep1 (select n3 i2)) 9)))))
(assert (forall ((j1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 2) j1) (<= j1 index3)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1))))))
(assert (and (and (=> (<= (+ (to_rep1 (first (rt source))) 2) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 2) (+ (to_rep1 (first (rt source))) 10) index3)) (forall ((temp___2119 Int)) (=> (and (<= (to_rep1 n__first) temp___2119) (<= temp___2119 (to_rep1 n__last))) (=> (< index3 temp___2119) (= (select n3 temp___2119) (select n1 temp___2119)))))) (and (<= (+ (to_rep1 (first (rt source))) 2) index3) (<= index3 (+ (to_rep1 (first (rt source))) 10)))))
(assert (not (= index3 temp___2121)))
(assert (= index3 result7))
(assert (= index4 (+ index3 1)))
(assert (and (<= (to_rep1 n__first) index4) (<= index4 (to_rep1 n__last))))
(assert (= o33 index4))
(assert (= o34 (select n3 o33)))
(assert (= o35 (to_rep1 o34)))
(assert (= o35 aida__conversion__convert_character_digit_to_integer__2__target1))
...
(assert (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target3) (<= aida__conversion__convert_character_digit_to_integer__2__target3 9)) (= aida__conversion__convert_character_digit_to_integer__2__target3 (convert_character_digit_to_integer o38))) (ite (= (= o38 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 0) (ite (= (= o38 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 1) (ite (= (= o38 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 2) (ite (= (= o38 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 3) (ite (= (= o38 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 4) (ite (= (= o38 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 5) (ite (= (= o38 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 6) (ite (= (= o38 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 7) (ite (= (= o38 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 8) (=> (= (= o38 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target3)))
(assert (= (to_rep1 o39) aida__conversion__convert_character_digit_to_integer__2__target3))
(assert (and (<= (to_rep1 n__first) index4) (<= index4 (to_rep1 n__last))))
(assert (= o40 index4))
(assert (= o41 (store n3 o40 o39)))
(assert (= result8 n3))
(assert (= n4 o41))
(declare-const i2 Int)
(assert (<= (+ (to_rep1 (first (rt source))) 2) i2))
(assert (<= i2 index4))
