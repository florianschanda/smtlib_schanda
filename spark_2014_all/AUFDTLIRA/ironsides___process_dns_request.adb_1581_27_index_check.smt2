...
(assert (= o6 (+ i2 o5)))
(assert (and (= temp___8031 o6) (in_range1 o6)))
(assert (and (<= 1 temp___8031) (<= temp___8031 129)))
(assert (= o7 temp___8031))
(assert (= o8 (select domainname o7)))
(assert (= o9 (to_rep o8)))
