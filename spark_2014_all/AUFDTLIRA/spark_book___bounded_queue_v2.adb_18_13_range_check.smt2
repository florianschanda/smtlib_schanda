...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep (rec__bounded_queue_v2__queue_type__max_size (us_split_discrs1 a))) (to_rep (rec__bounded_queue_v2__queue_type__max_size (us_split_discrs1 b)))) (and (and (and (= (to_rep3 (rec__bounded_queue_v2__queue_type__count (us_split_fields1 a))) (to_rep3 (rec__bounded_queue_v2__queue_type__count (us_split_fields1 b)))) (= (to_rep (rec__bounded_queue_v2__queue_type__front (us_split_fields1 a))) (to_rep (rec__bounded_queue_v2__queue_type__front (us_split_fields1 b))))) (= (to_rep (rec__bounded_queue_v2__queue_type__rear (us_split_fields1 a))) (to_rep (rec__bounded_queue_v2__queue_type__rear (us_split_fields1 b))))) (= (bool_eq1 (rec__bounded_queue_v2__queue_type__items (us_split_fields1 a)) (rec__bounded_queue_v2__queue_type__items (us_split_fields1 b))) true))) true false))
