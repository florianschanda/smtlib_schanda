...
(define-fun dynamic_invariant ((temp___expr_239 us_t1) (temp___is_init_236 Bool) (temp___skip_constant_237 Bool) (temp___do_toplevel_238 Bool)) Bool (and (=> (not (= temp___skip_constant_237 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_239) (last3 temp___expr_239))) (=> (= temp___do_toplevel_238 true) (=> (= temp___is_init_236 true) (and (let ((temp___241 (of_array (to_array1 temp___expr_239) (first3 temp___expr_239) (last3 temp___expr_239)))) (and (= (first1 temp___241) 1) (<= 0 (last1 temp___241)))) (<= (last3 temp___expr_239) 20))))))
(define-fun dynamic_predicate ((temp___243 us_t1)) Bool (and (let ((temp___245 (of_array (to_array1 temp___243) (first3 temp___243) (last3 temp___243)))) (and (= (first1 temp___245) 1) (<= 0 (last1 temp___245)))) (<= (last3 temp___243) 20)))
...
(assert (dynamic_invariant i13s true false false))
