...
(assert (= (= result9 true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 (- (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))) 1))) (<= (to_rep2 (select (elts1 (rec__simple_unc_arrays__table__v (us_split_fields1 (table__content simple_unc_arrays__bubble_sort__result6)))) j2)) (to_rep2 (select (elts1 (rec__simple_unc_arrays__table__v (us_split_fields1 (table__content simple_unc_arrays__bubble_sort__result6)))) (+ j2 1))))))))
(assert (= result9 true))
(assert (<= 1 j))
...
(assert (not (<= (to_rep1 (first2 (rt1 (rec__simple_unc_arrays__table__v (us_split_fields1 (table__content simple_unc_arrays__bubble_sort__result6)))))) k)))
(check-sat)
(exit)
