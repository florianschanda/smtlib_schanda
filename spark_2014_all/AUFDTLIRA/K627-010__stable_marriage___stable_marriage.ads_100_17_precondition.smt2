...
(assert (<= 1 g2))
(assert (<= g2 64))
(assert (and (= o13 (is_preferred_1 (to_rep (select (map__content stable_marriage__matching__result4) g2)) g11 (select ranking_2 g2))) (= (= o13 true) (<= (to_rep2 (select (invert_1 (select ranking_2 g2)) (to_rep (select (map__content stable_marriage__matching__result4) g2)))) (to_rep2 (select (invert_1 (select ranking_2 g2)) g11))))))
