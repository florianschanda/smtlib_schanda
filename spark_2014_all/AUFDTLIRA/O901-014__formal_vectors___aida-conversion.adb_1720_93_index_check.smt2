...
(assert (and (= o32 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (= o33 (ite (<= o32 j) true false)))
(assert (= result6 (ite (= o33 true) (ite (<= j index3) true false) false)))
(assert (= result6 true))
