...
(assert (and (= temp___599 (element (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c1)) (and (in_range4 temp___599) (= temp___599 (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c1))))))
(assert (not (<= (to_rep (first (rt a))) temp___599)))
(check-sat)
(exit)
