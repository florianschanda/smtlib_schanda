...
(assert (and (= temp___599 (element (mk___rep d__split_discrs (mk___split_fields d__split_fields)) (mk___rep1 (mk___split_fields1 c)))) (and (in_range4 temp___599) (= temp___599 (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) (mk___rep1 (mk___split_fields1 c))))))))
