...
(assert (=> (= result true) (= o18 (store data o17 (mk___rep (mk___split_fields o15 o16))))))
...
(assert (=> (= result true) (=> (and (<= 1 i2) (<= i2 r114b)) (forall ((j Int)) (=> (and (<= 1 j) (<= j (+ i3 1))) (not (= (get c112b j) (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select data2 (get c111b i3))))))))))))
