...
(assert (=> (= result true) (= (to_rep o17) first_available)))
(assert (=> (= result true) (= (to_rep1 o18) 0)))
(assert (=> (= result true) (= o18 o19)))
(assert (=> (= result true) (= o17 o20)))
(assert (=> (= result true) (= o21 o19)))
(assert (=> (= result true) (= o22 o20)))
(assert (=> (= result true) (and (<= 1 res) (<= res 10000))))
(assert (=> (= result true) (= o23 res)))
(assert (=> (= result true) (= o24 (store data o23 (mk___rep (mk___split_fields o21 o22))))))
(assert (=> (= result true) (= result1 (mk_map__ref data))))
(assert (=> (= result true) (= data2 o24)))
(assert (=> (= result true) (= result2 (mk_int__ref first_available))))
(assert (=> (= result true) (= first_available2 res)))
(assert (=> (= result true) (= ma c111b)))
(assert (=> (= result true) (and (= (mk___rep1 (mk___split_fields1 o25 o26)) (model__ data2 first_available2)) (= (model_is_well_formed (mk___rep1 (mk___split_fields1 o25 o26)) data2 first_available2) true))))
(assert (=> (= result true) (= o27 (mk___split_fields1 o25 o26))))
(assert (=> (= result true) (= list_mod_allocator__free__C112b__assume (rec__list_mod_allocator__m__t__available o27))))
(assert (=> (= result true) (= list_mod_allocator__free__C112b__assume c112b)))
(assert (=> (= result true) (and (= list_mod_allocator__free__B113b__L_4__R114b__assume (length c111b)) (and (in_range5 list_mod_allocator__free__B113b__L_4__R114b__assume) (<= (+ 0 list_mod_allocator__free__B113b__L_4__R114b__assume) 2147483647)))))
(assert (=> (= result true) (= list_mod_allocator__free__B113b__L_4__R114b__assume r114b)))
(assert (=> (= result true) (in_range1 r114b)))
(assert (=> (= result true) (= result3 (mk_int__ref i))))
(assert (=> (= result true) (= i2 1)))
(assert (=> (= result true) (=> (and (<= 1 i2) (<= i2 r114b)) (= temp___318 i2))))
(assert (=> (= result true) (=> (and (<= 1 i2) (<= i2 r114b)) (<= (+ i3 1) (length c112b)))))
(assert (=> (= result true) (=> (and (<= 1 i2) (<= i2 r114b)) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 i3)) (= (get c111b j3) (get c112b (+ j3 1))))))))
(assert (=> (= result true) (=> (and (<= 1 i2) (<= i2 r114b)) (forall ((j3 Int)) (=> (and (<= 2 j3) (<= j3 (+ i3 1))) (= (get c111b (- j3 1)) (get c112b j3)))))))
(assert (=> (= result true) (=> (and (<= 1 i2) (<= i2 r114b)) (and (=> (<= 1 r114b) (dynamic_property 1 r114b i3)) (and (<= 1 i3) (<= i3 r114b))))))
(assert (=> (= result true) (=> (and (<= 1 i2) (<= i2 r114b)) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 (+ i3 1))) (not (= (get c112b j3) (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select data2 (get c111b i3))))))))))))
(assert (=> (= result true) (=> (and (<= 1 i2) (<= i2 r114b)) (= i3 r114b))))
(assert (=> (= result true) (=> (and (<= 1 i2) (<= i2 r114b)) (= i5 (mk_int__ref i3)))))
(assert (=> (= result true) (=> (and (<= 1 i2) (<= i2 r114b)) (= i6 i3))))
(assert (=> (= result true) (=> (and (<= 1 i2) (<= i2 r114b)) (= i7 i5))))
(assert (=> (= result true) (=> (and (<= 1 i2) (<= i2 r114b)) (= i8 i6))))
(assert (=> (= result true) (=> (not (and (<= 1 i2) (<= i2 r114b))) (= i7 (mk_int__ref i2)))))
(assert (=> (= result true) (=> (not (and (<= 1 i2) (<= i2 r114b))) (= i8 i2))))
(assert (=> (= result true) (= i9 i7)))
(assert (=> (= result true) (= first_available3 (mk_int__ref first_available2))))
(assert (=> (= result true) (= data3 (mk_map__ref data2))))
(assert (=> (= result true) (= i10 i8)))
(assert (=> (= result true) (= first_available4 first_available2)))
(assert (=> (= result true) (= data4 data2)))
(assert (=> (not (= result true)) (= i9 (mk_int__ref i))))
(assert (=> (not (= result true)) (= first_available3 (mk_int__ref first_available))))
(assert (=> (not (= result true)) (= data3 (mk_map__ref data))))
(assert (=> (not (= result true)) (= i10 i1)))
...
(assert (= data6 data4))
(assert (=> (= (contains (rec__list_mod_allocator__m__t__allocated (us_split_fields3 (model__ data first_available))) res) true) (and (= (is_prepend (rec__list_mod_allocator__m__t__available (us_split_fields3 (model__ data first_available))) res (rec__list_mod_allocator__m__t__available (us_split_fields3 (model__ (map__content data5) (int__content first_available5))))) true) (= (is_add (rec__list_mod_allocator__m__t__allocated (us_split_fields3 (model__ (map__content data5) (int__content first_available5)))) res (rec__list_mod_allocator__m__t__allocated (us_split_fields3 (model__ data first_available)))) true))))
(assert (=> (not (= (contains (rec__list_mod_allocator__m__t__allocated (us_split_fields3 (model__ data first_available))) res) true)) (= (oeq1 (model__ (map__content data5) (int__content first_available5)) (model__ data first_available)) true)))
(assert (not (= (is_valid (map__content data5) (int__content first_available5)) true)))
(check-sat)
(exit)
