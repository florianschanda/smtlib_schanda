...
(assert (and (= o7 (remove a o6)) (and (dynamic_invariant2 o7 true false true true) (and (= (invariant__ o7) true) (and (= (to_rep2 (last (rt o7))) (- (to_rep2 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o6 1))) (= (to_rep (select (elts a) k)) (to_rep (select (elts o7) k))))) (and (forall ((k Int)) (=> (and (<= (+ o6 1) k) (<= k (to_rep2 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select (elts o7) (- k 1)))))) (forall ((k Int)) (=> (and (<= o6 k) (<= k (- (to_rep2 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select (elts o7) k))))))))))))
