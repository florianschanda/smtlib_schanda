...
(assert (= result13 (mk_bool__ref accepted)))
(assert (= accepted3 (of_int 0)))
(assert (= g11 c134b))
(assert (in_range1 c134b))
(assert (and (= o32 (+ (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields2)) 1)) (in_range4 (+ (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields2)) 1))))
(assert (= (to_rep3 o33) o32))
(assert (= (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields2) o34))
(assert (= o33 o35))
(assert (= temp___595 (mk___rep (mk___split_fields o34 o35))))
(assert (= result14 (mk___split_fields__ref unmatched_g1_set__split_fields2)))
(assert (= unmatched_g1_set__split_fields5 (us_split_fields1 temp___595)))
(assert (= (to_rep o36) c134b))
(assert (not (<= 1 (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields5)))))
(check-sat)
(exit)
