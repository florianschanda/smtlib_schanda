...
(assert (not (= (select unmatched_g2_set g21) true)))
(assert (not (< (to_rep1 (select (select ranking_2_inverted g21) g11)) (to_rep1 (select (select ranking_2_inverted g21) (to_rep (select result__ g21)))))))
(assert (= result7 (mk_bool__ref accepted)))
(assert (= accepted1 (distinct 0 0)))
(assert (= g11 c134b))
(assert (in_range1 c134b))
(assert (and (= o13 (+ (to_rep2 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields2)) 1)) (in_range3 (+ (to_rep2 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields2)) 1))))
(assert (= (to_rep2 o14) o13))
(assert (= (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields2) o15))
(assert (= o14 o16))
(assert (= temp___637 (mk___rep (mk___split_fields o15 o16))))
(assert (= result8 (mk___split_fields__ref unmatched_g1_set__split_fields2)))
(assert (= unmatched_g1_set__split_fields3 (us_split_fields1 temp___637)))
(assert (= (to_rep o17) c134b))
(assert (not (<= (to_rep2 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields3)) 64)))
(check-sat)
(exit)
