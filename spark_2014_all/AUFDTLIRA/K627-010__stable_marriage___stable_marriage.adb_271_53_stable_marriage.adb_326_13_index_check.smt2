...
(assert (not (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21)))))))
(assert (= result7 (mk_bool__ref accepted)))
(assert (= accepted1 (distinct 0 0)))
(assert (= g11 c134b))
(assert (in_range1 c134b))
(assert (and (= o13 (+ (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields2)) 1)) (in_range4 (+ (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields2)) 1))))
(assert (= (to_rep3 o14) o13))
...
(assert (not (<= 1 (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields3)))))
(check-sat)
(exit)
