...
(assert (= i3 (+ i2 1)))
(assert (= (to_rep2 o19) p_prime_index2))
(assert (= o20 (store f2 i3 o19)))
(assert (= result10 (mk_map__ref f2)))
(assert (= f3 o20))
(declare-const j6 Int)
(assert (<= (to_rep1 (rec__partition_refinement__interval__first p_prime__split_fields3)) j6))
(assert (<= j6 i3))
(assert (not (= (to_rep2 (select f3 j6)) p_prime_index2)))
(check-sat)
(exit)
