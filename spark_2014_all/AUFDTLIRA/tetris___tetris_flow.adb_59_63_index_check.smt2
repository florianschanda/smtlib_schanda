...
(assert (<= 0 x1))
(assert (<= x1 2))
(assert (and (forall ((temp___782 Int)) (=> (and (<= 1 temp___782) (<= temp___782 50)) (=> (not (= (+ (to_rep2 cur_piece__split_fields3) y2) temp___782)) (= (select cur_board1 temp___782) (select cur_board temp___782))))) (and (<= 0 x2) (<= x2 2))))
(assert (and (<= 3 (to_rep cur_piece__split_fields)) (<= (to_rep cur_piece__split_fields) 7)))
(assert (= o (to_rep cur_piece__split_fields)))
(assert (= temp___777 (get1 possible_three_shapes o (to_rep3 cur_piece__split_fields1))))
(assert (= result2 (get temp___777 y2 x2)))
(assert (= result2 true))
