...
(assert (in_range y))
(assert (and (= o (+ y 1)) (in_range (+ y 1))))
(assert (= (to_rep o1) o))
(assert (and (<= (to_rep x__first) 1) (<= 1 (to_rep x__last))))
(assert (= o2 1))
(assert (= o3 (store x o2 o1)))
(assert (= result x))
(assert (= x1 o3))
(assert (and (= o4 (- y 1)) (in_range (- y 1))))
(assert (= (to_rep o5) o4))
(assert (not (<= (to_rep x__first) 4)))
(check-sat)
(exit)
