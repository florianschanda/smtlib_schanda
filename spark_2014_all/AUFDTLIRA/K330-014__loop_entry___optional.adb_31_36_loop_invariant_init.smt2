...
(assert (and (<= 1 temp___550) (<= temp___550 3)))
(assert (= o3 temp___550))
(assert (= o4 (set ta11 o3 2 o2)))
(assert (= result5 ta11))
(assert (= ta12 o4))
(assert (= result6 outer))
(assert (= outer1 1))
(assert (= (mk_int__ref result7) (mk_int__ref inner)))
(assert (= inner1 1))
(assert (<= 1 inner1))
(assert (<= inner1 2))
(assert (not (= (to_rep2 (get ta12 outer1 inner1)) 0)))
(check-sat)
(exit)
