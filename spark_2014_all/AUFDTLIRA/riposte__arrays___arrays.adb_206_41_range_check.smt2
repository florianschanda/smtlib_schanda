...
(assert (and (and (forall ((temp___355 Int)) (=> (and (<= 0 temp___355) (<= temp___355 255)) (=> (or (< 255 temp___355) (or (< temp___355 0) (< x2 temp___355))) (= (select r2 temp___355) (select r temp___355))))) (=> (<= 0 255) (in_range1 x2))) (and (<= 0 x2) (<= x2 255))))
(assert (<= 0 x2))
(assert (not (<= x2 255)))
(check-sat)
(exit)
