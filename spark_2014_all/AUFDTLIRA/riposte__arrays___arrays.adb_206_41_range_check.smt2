...
(assert (and (and (forall ((temp___353 Int)) (=> (and (<= 0 temp___353) (<= temp___353 255)) (=> (< x2 temp___353) (= (select r2 temp___353) (select r temp___353))))) (=> (<= 0 255) (in_range1 x2))) (and (<= 0 x2) (<= x2 255))))
(assert (<= 0 x2))
(assert (not (<= 0 0)))
(check-sat)
(exit)
