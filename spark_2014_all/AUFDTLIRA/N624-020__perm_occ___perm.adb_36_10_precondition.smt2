...
(assert (and (= (mk___t o7 o8) (remove_last a)) (and (dynamic_invariant2 (mk___t o7 o8) true false true) (and (= (elts a) o7) (= (mk (to_rep1 (first2 (mk1 (to_rep1 (first (rt a))) (- (to_rep1 (last (rt a))) 1)))) (to_rep1 (last2 (mk1 (to_rep1 (first (rt a))) (- (to_rep1 (last (rt a))) 1))))) o8)))))
(assert (not (<= (to_rep1 (first o8)) i)))
(check-sat)
(exit)
