...
(assert (= b1 result1))
(assert (= b2 o2))
(assert (and (= o8 (remove_last r)) (and (dynamic_invariant2 o8 true false true) (and (= (elts r) o3) (= (mk (to_rep1 (first2 (mk1 (to_rep1 (first (rt r))) (- (to_rep1 (last (rt r))) 1)))) (to_rep1 (last2 (mk1 (to_rep1 (first (rt r))) (- (to_rep1 (last (rt r))) 1))))) o4)))))
(assert (= (occ o8 e) (occ (mk___t b2 (mk (to_rep1 b__first) (to_rep1 b__last))) e)))
(assert (and (= o7 (remove_last a)) (and (dynamic_invariant2 o7 true false true) (and (= (elts a) o5) (= (mk (to_rep1 (first2 (mk1 (to_rep1 (first (rt a))) (- (to_rep1 (last (rt a))) 1)))) (to_rep1 (last2 (mk1 (to_rep1 (first (rt a))) (- (to_rep1 (last (rt a))) 1))))) o6)))))
