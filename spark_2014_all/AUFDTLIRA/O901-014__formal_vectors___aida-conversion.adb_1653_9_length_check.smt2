...
(assert (not (= (ite (<= (to_rep1 (first4 temp___20231)) (to_rep1 (last4 temp___20231))) (+ (- (to_rep1 (last4 temp___20231)) (to_rep1 (first4 temp___20231))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 4) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 4)) 1) 0))))
(check-sat)
(exit)
