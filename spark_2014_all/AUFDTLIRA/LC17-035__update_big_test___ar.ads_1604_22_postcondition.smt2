...
(declare-fun temp_____aggregate_def_3459 ((Array Int (Array Int (Array Int et1))) Int (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1))))
(declare-fun temp_____aggregate_def_3465 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
(declare-fun temp_____aggregate_def_3471 ((Array Int et1) Int Int) (Array Int et1))
...
(assert (not (= (bool_eq3 (mk___rep (mk___split_fields r__split_fields18 r__split_fields19 r__split_fields20)) (mk___rep (mk___split_fields r__split_fields (temp_____aggregate_def_3459 a i (temp_____aggregate_def_3465 b j (temp_____aggregate_def_3471 c k d))) (distinct 0 0)))) true)))
(check-sat)
(exit)
