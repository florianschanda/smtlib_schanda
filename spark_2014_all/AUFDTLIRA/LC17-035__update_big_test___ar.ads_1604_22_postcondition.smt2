...
(declare-fun temp___3400 ((Array Int (Array Int (Array Int et1))) Int (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1))))
(assert (forall ((temp___3402 (Array Int (Array Int (Array Int et1))))) (forall ((temp___3403 Int)) (forall ((temp___3404 (Array Int (Array Int et1)))) (let ((temp___3401 (temp___3400 temp___3402 temp___3403 temp___3404))) (forall ((temp___3405 Int)) (ite (= temp___3405 temp___3403) (= (select temp___3401 temp___3405) temp___3404) (= (select temp___3401 temp___3405) (select temp___3402 temp___3405)))))))))
(declare-fun temp___3406 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
(assert (forall ((temp___3408 (Array Int (Array Int et1)))) (forall ((temp___3409 Int)) (forall ((temp___3410 (Array Int et1))) (let ((temp___3407 (temp___3406 temp___3408 temp___3409 temp___3410))) (forall ((temp___3411 Int)) (ite (= temp___3411 temp___3409) (= (select temp___3407 temp___3411) temp___3410) (= (select temp___3407 temp___3411) (select temp___3408 temp___3411)))))))))
(declare-fun temp___3412 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___3414 (Array Int et1))) (forall ((temp___3415 Int) (temp___3416 Int)) (let ((temp___3413 (temp___3412 temp___3414 temp___3415 temp___3416))) (forall ((temp___3417 Int)) (ite (= temp___3417 temp___3415) (= (select temp___3413 temp___3417) (of_rep temp___3416)) (= (select temp___3413 temp___3417) (select temp___3414 temp___3417))))))))
...
(declare-const temp___8619 enum1tb)
(declare-const temp___86191 (Array Int (Array Int (Array Int et1))))
(declare-const temp___86192 Bool)
...
(assert (not (= (bool_eq3 (mk___rep (mk___split_fields r__split_fields18 r__split_fields19 r__split_fields20)) (mk___rep (mk___split_fields r__split_fields (temp___3400 a i (temp___3406 b j (temp___3412 c k d))) (of_int 0)))) true)))
(check-sat)
(exit)
