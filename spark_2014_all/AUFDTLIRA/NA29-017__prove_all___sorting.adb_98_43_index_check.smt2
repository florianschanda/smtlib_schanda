...
(assert (< i2 length1))
(assert (and (= o34 (+ a_first length1)) (in_range1 (+ a_first length1))))
(assert (= o35 (+ o34 j2)))
(assert (and (= temp___258 o35) (in_range1 o35)))
(assert (and (<= (to_rep a__first) temp___258) (<= temp___258 (to_rep a__last))))
(assert (= o36 temp___258))
(assert (= o37 (select a o36)))
(assert (= o38 (to_rep o37)))
(assert (and (= temp___257 (+ a_first i2)) (in_range1 (+ a_first i2))))
(assert (not (<= (to_rep a__first) temp___257)))
(check-sat)
(exit)
