...
(assert (forall ((temp___141 Int)) (forall ((temp___142 Int)) (= (select (pack__a2__my_a__aggregate_def temp___141) temp___142) (of_rep1 temp___141)))))
...
(assert (= my_b (let ((temp___144 4)) (let ((temp___143 1)) my_a))))
...
(assert (= temp___409 glob))
(assert (= temp___411 temp___409))
(assert (<= 1 3))
(assert (not (<= 1 1)))
(check-sat)
(exit)
