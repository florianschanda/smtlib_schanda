...
(define-fun tTmy_s2SP1__ref___projection ((a tTmy_s2SP1__ref)) tTmy_s2SP1 (tTmy_s2SP1__content a))
...
(define-fun tTmy_aSP1__ref___2__projection ((a tTmy_aSP1__ref)) tTmy_aSP1 (tTmy_aSP1__content a))
(declare-const my_a (Array Int integer))
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(declare-fun pack__a2__my_a__aggregate_def (Int) (Array Int integer))
...
(declare-fun user_eq6 (tTmy_bSP1 tTmy_bSP1) Bool)
(declare-const dummy6 tTmy_bSP1)
(declare-datatypes () ((tTmy_bSP1__ref (mk_tTmy_bSP1__ref (tTmy_bSP1__content tTmy_bSP1)))))
(define-fun tTmy_bSP1__ref___2__projection ((a tTmy_bSP1__ref)) tTmy_bSP1 (tTmy_bSP1__content a))
(declare-const my_b (Array Int integer))
(declare-const attr__ATTRIBUTE_ADDRESS3 Int)
(declare-sort t29b 0)
(declare-fun t29bqtint (t29b) Int)
(assert (forall ((i t29b)) (and (<= 1 (t29bqtint i)) (<= (t29bqtint i) 3))))
(define-fun in_range6 ((x Int)) Bool (and (<= 1 x) (<= x 3)))
(declare-fun attr__ATTRIBUTE_IMAGE6 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check6 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE6 (us_image) Int)
(declare-fun user_eq7 (t29b t29b) Bool)
(declare-const dummy7 t29b)
...
(assert (forall ((i t32b)) (and (<= 1 (t32bqtint i)) (<= (t32bqtint i) 3))))
(define-fun in_range7 ((x Int)) Bool (and (<= 1 x) (<= x 3)))
(declare-fun attr__ATTRIBUTE_IMAGE7 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check7 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE7 (us_image) Int)
(declare-fun user_eq8 (t32b t32b) Bool)
(declare-const dummy8 t32b)
...
(assert (forall ((i t34b)) (and (<= 1 (t34bqtint i)) (<= (t34bqtint i) 4))))
(define-fun in_range8 ((x Int)) Bool (and (<= 1 x) (<= x 4)))
(declare-fun attr__ATTRIBUTE_IMAGE8 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check8 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE8 (us_image) Int)
(declare-fun user_eq9 (t34b t34b) Bool)
(declare-const dummy9 t34b)
...
(assert (forall ((i t36b)) (and (<= 1 (t36bqtint i)) (<= (t36bqtint i) 3))))
(define-fun in_range9 ((x Int)) Bool (and (<= 1 x) (<= x 3)))
(declare-fun attr__ATTRIBUTE_IMAGE9 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check9 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE9 (us_image) Int)
(declare-fun user_eq10 (t36b t36b) Bool)
(declare-const dummy10 t36b)
...
(assert (forall ((i t39b)) (and (<= 1 (t39bqtint i)) (<= (t39bqtint i) 3))))
(define-fun in_range10 ((x Int)) Bool (and (<= 1 x) (<= x 3)))
(declare-fun attr__ATTRIBUTE_IMAGE10 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check10 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE10 (us_image) Int)
(declare-fun user_eq11 (t39b t39b) Bool)
(declare-const dummy11 t39b)
...
(assert (= my_a (pack__a2__my_a__aggregate_def 42)))
(declare-const rliteral integer)
(assert (= (integerqtint rliteral) 42))
(assert (forall ((temp___163 Int)) (=> (dynamic_invariant temp___163 true true true true) (forall ((temp___164 Int)) (= (select (pack__a2__my_a__aggregate_def temp___163) temp___164) rliteral)))))
(assert (= my_b (let ((temp___166 4)) (let ((temp___165 1)) my_a))))
(declare-const glob (Array Int character))
(declare-const my_s2 (Array Int character))
(declare-const temp___426 (Array Int character))
(declare-const o (Array Int character))
(declare-const pack__a2__my_b__assume (Array Int integer))
(declare-const temp___452 (Array Int character))
...
(assert (= temp___426 glob))
(assert (= o temp___426))
(assert (= result my_s2))
(assert (= my_s21 o))
(assert (= (pack__a2__my_a__aggregate_def 42) my_a))
(assert (=> (<= 1 4) (and (and (<= 1 1) (<= 1 4)) (and (<= 1 4) (<= 4 4)))))
(assert (= pack__a2__my_b__assume my_a))
(assert (= pack__a2__my_b__assume my_b))
(assert (= (bool_eq my_s21 1 3 glob 1 3) true))
(assert (= (bool_eq2 my_b 1 4 my_a 1 4) true))
(assert (=> (<= 1 3) (and (and (<= (to_rep1 glob__first) 1) (<= 1 (to_rep1 glob__last))) (and (<= (to_rep1 glob__first) 3) (<= 3 (to_rep1 glob__last))))))
(assert (= temp___452 glob))
(assert (= temp___454 temp___452))
(assert (<= 1 3))
(assert (not (<= 1 4)))
(check-sat)
(exit)
