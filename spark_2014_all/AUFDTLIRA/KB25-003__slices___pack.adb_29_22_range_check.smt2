...
(assert (forall ((temp___163 Int)) (=> (dynamic_invariant temp___163 true true true true) (forall ((temp___164 Int)) (= (to_rep1 (select (pack__a2__my_a__aggregate_def temp___163) temp___164)) temp___163)))))
