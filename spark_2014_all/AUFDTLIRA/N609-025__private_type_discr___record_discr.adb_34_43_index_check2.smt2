...
(assert (not (<= (to_rep1 (first (rt (rec__record_discr__interm_result__to_search (us_split_fields3 r))))) (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))))))
(check-sat)
(exit)
