...
(assert (and (= o44 (remove a o43)) (and (dynamic_invariant2 o44 true false true) (and (= (invariant__ o44) true) (and (= (to_rep2 (last (rt o44))) (- (to_rep2 (last (rt a))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- o43 1))) (= (to_rep (select (elts a) k1)) (to_rep (select (elts o44) k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ o43 1) k1) (<= k1 (to_rep2 (last (rt a))))) (= (to_rep (select (elts a) k1)) (to_rep (select (elts o44) (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= o43 k1) (<= k1 (- (to_rep2 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k1 1))) (to_rep (select (elts o44) k1))))))))))))
(assert (not (= (invariant__ o44) true)))
(check-sat)
(exit)
