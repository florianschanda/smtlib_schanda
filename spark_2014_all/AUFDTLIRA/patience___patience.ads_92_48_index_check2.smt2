...
(assert (= result3 (ite (<= 0 j) o4 false)))
(assert (= result3 true))
(assert (and (<= 0 i) (<= i 99)))
(assert (= o6 i))
...
(assert (and (<= 0 i) (<= i 99)))
(assert (= o12 i))
(assert (= temp___481 (select (rec__patience__state__stacks (us_split_fields1 s)) o12)))
(assert (not (<= 0 k)))
(check-sat)
(exit)
