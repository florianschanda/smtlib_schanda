...
(assert (=> (= simple_unc_arrays__search__result4 0) (and (= result6 (not_in a v 1 (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))))) (= (= result6 true) (or (< (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))) (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a)))) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))))) (not (= (to_rep1 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) j1)) v)))))))))
(assert (=> (not (= simple_unc_arrays__search__result4 0)) (= result6 false)))
...
(assert (= o4 simple_unc_arrays__search__result4))
(assert (= o5 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) o4)))
(assert (= o6 (to_rep1 o5)))
(assert (= result7 (ite (= o6 v) true false)))
(assert (= result7 true))
