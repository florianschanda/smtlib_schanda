...
(assert (not (= (ite (<= (to_rep1 (first6 temp___2301)) (to_rep1 (last6 temp___2301))) (+ (- (to_rep1 (last6 temp___2301)) (to_rep1 (first6 temp___2301))) 1) 0) (ite (<= 1 (to_rep (rec__p__pp__c (us_split_discrs5 self__)))) (+ (- (to_rep (rec__p__pp__c (us_split_discrs5 self__))) 1) 1) 0))))
(check-sat)
(exit)
