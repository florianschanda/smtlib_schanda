...
(assert (forall ((temp___222 Int)) (forall ((temp___223 Int)) (= (select (temp___220 temp___222) temp___223) (of_rep1 temp___222)))))
...
(assert (forall ((s us_rep)) (! (let ((result (to__ s))) (and (and (= (first1 result) 1) (<= 0 (last1 result))) (dynamic_invariant2 result true false true))) :pattern ((to__ s)))))
...
(assert (= e__split_fields6 (mk___split_fields__ref (mk___split_fields e__split_fields4 e__split_fields5))))
(assert (= stack__empty_stack__result8 stack__empty_stack__result6))
(assert (= e__split_fields7 (mk___split_fields e__split_fields4 e__split_fields5)))
