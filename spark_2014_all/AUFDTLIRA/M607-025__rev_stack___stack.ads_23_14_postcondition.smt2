...
(declare-fun temp___247 (Int) (Array Int integer))
...
(assert (forall ((temp___249 Int)) (=> (dynamic_invariant temp___249 true true true true) (forall ((temp___250 Int)) (= (to_rep1 (select (temp___247 temp___249) temp___250)) temp___249)))))
...
(declare-const temp___246 r1)
(declare-const temp___2461 (Array Int integer))
...
(assert (= temp___246 e__split_fields2))
(assert (= temp___2461 e__split_fields3))
(assert (= result2 e__split_fields2))
(assert (= result3 e__split_fields3))
(assert (= e__split_fields2 e__split_fields4))
(assert (= (temp___247 0) e__split_fields5))
...
(assert (= stack__empty_stack__result6 (mk___rep (mk___split_fields stack__empty_stack__result2 stack__empty_stack__result3))))
...
(assert (= stack__empty_stack__result7 (mk_stack__ref (mk___rep (mk___split_fields stack__empty_stack__result4 stack__empty_stack__result5)))))
...
(assert (= (mk___rep (mk___split_fields result6 result7)) (stack__content stack__empty_stack__result7)))
(assert (not (= (is_empty (stack__content stack__empty_stack__result7)) true)))
(check-sat)
(exit)
