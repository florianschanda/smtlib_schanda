...
(assert (and (= o23 (count (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1)))) (and (in_range4 o23) (= o23 (to_rep1 (rec__stack_functional_spec__stack_type__pointer (us_split_fields1 (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1)))))))))
...
(assert (and (= o20 (count o26)) (and (in_range4 o20) (= o20 (to_rep1 o19)))))
...
(assert (and (= o13 (max_stack_size Tuple0)) (and (in_range4 o13) (= o13 100))))
...
(assert (and (= o14 (count o28)) (and (in_range4 o14) (= o14 (to_rep1 o12)))))
