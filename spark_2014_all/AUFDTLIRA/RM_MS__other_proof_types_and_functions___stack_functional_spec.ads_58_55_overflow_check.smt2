...
(assert (= my_stack__split_fields4 (mk___split_fields temp___205 temp___2051)))
...
(assert (and (= o24 (count (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1)))) (and (in_range4 o24) (= o24 (to_rep1 (rec__stack_functional_spec__stack_type__pointer (us_split_fields1 (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1)))))))))
(assert (= o25 (ite (<= i o24) true false)))
(assert (= result4 (ite (<= 1 i) o25 false)))
(assert (= (= o30 true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (count (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1))))) (= (stack_entry (state__2 (us_split_fields__content my_stack__split_fields5)) i1) (stack_entry (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1)) i1))))))
(assert (and (= (mk___rep (mk___split_fields o19 o20)) (state__2 (us_split_fields__content my_stack__split_fields5))) (= (us_split_fields__content my_stack__split_fields5) (mk___split_fields o19 o20))))
(assert (and (= o21 (count (mk___rep (mk___split_fields o19 o20)))) (and (in_range4 o21) (= o21 (to_rep1 o20)))))
(assert (and (= (mk___rep (mk___split_fields o17 o18)) (state__2 (us_split_fields__content my_stack__split_fields5))) (= (us_split_fields__content my_stack__split_fields5) (mk___split_fields o17 o18))))
(assert (and (= o22 (stack_entry (mk___rep (mk___split_fields o17 o18)) o21)) (and (in_range1 o22) (= o22 (to_rep (select o17 o21))))))
(assert (= o23 (ite (= o22 x) true false)))
(assert (and (= o14 (max_stack_size Tuple0)) (and (in_range4 o14) (= o14 100))))
(assert (and (= (mk___rep (mk___split_fields o12 o13)) (state__2 (us_split_fields__content my_stack__split_fields5))) (= (us_split_fields__content my_stack__split_fields5) (mk___split_fields o12 o13))))
(assert (and (= o15 (count (mk___rep (mk___split_fields o12 o13)))) (and (in_range4 o15) (= o15 (to_rep1 o13)))))
(assert (= o16 (ite (<= o15 o14) true false)))
(assert (and (= o9 (count (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1)))) (and (in_range4 o9) (= o9 (to_rep1 (rec__stack_functional_spec__stack_type__pointer (us_split_fields1 (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1)))))))))
(assert (= o10 (+ o9 1)))
