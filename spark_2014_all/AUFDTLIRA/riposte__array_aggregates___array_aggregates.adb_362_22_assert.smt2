...
(declare-fun temp___658 (Int Int) (Array Int unsigned_byte))
...
(assert (forall ((temp___660 Int) (temp___661 Int)) (let ((temp___659 (temp___658 temp___660 temp___661))) (=> (and (dynamic_invariant temp___660 true true true true) (dynamic_invariant temp___661 true true true true)) (forall ((temp___662 Int)) (ite (= temp___662 0) (= (to_rep (select temp___659 temp___662)) temp___660) (= (to_rep (select temp___659 temp___662)) temp___661)))))))
