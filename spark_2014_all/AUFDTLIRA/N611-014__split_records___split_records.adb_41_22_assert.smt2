...
(assert (not (not (= (rec__split_records__record_with_mutable_discrs__present (us_split_discrs1 (rec__split_records__mutable_holder__content h2__split_fields5))) true))))
(check-sat)
(exit)
