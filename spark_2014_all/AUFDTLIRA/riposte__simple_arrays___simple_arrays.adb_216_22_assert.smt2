...
(declare-fun temp___436 ((Array Int integer) Int Int) (Array Int integer))
(assert (forall ((temp___438 (Array Int integer))) (forall ((temp___439 Int) (temp___440 Int)) (let ((temp___437 (temp___436 temp___438 temp___439 temp___440))) (forall ((temp___441 Int)) (ite (= temp___441 temp___439) (= (select temp___437 temp___441) (of_rep temp___440)) (= (select temp___437 temp___441) (select temp___438 temp___441))))))))
(declare-fun temp___443 ((Array Int integer) Int Int) (Array Int integer))
(assert (forall ((temp___445 (Array Int integer))) (forall ((temp___446 Int) (temp___447 Int)) (let ((temp___444 (temp___443 temp___445 temp___446 temp___447))) (forall ((temp___448 Int)) (ite (= temp___448 temp___446) (= (select temp___444 temp___448) (of_rep temp___447)) (= (select temp___444 temp___448) (select temp___445 temp___448))))))))
(assert (in_range1 i))
(assert (= (bool_eq b (- 2147483648) 2147483647 a (- 2147483648) 2147483647) true))
(assert (= (bool_eq b (- 2147483648) 2147483647 (temp___436 a i 42) (- 2147483648) 2147483647) true))
(assert (not (= (to_rep (select a i)) (to_rep (select (temp___443 a i 42) i)))))
(check-sat)
(exit)
