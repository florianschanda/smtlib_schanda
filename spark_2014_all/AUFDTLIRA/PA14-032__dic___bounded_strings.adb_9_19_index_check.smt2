...
(declare-const bounded_strings__make__result3 length_type)
(declare-const us Int)
(declare-const temp___188 index_type)
...
(declare-const temp___2041 (Array Int character))
(declare-const temp___2042 t2)
(declare-const temp___2043 length_type)
(declare-const o5 character)
(declare-const o6 Int)
(declare-const o7 (Array Int character))
(declare-const o8 us_t2)
(declare-const o9 us_split_fields2)
(declare-const temp___208 us_rep1)
(declare-const o10 length_type)
(declare-const o11 us_split_fields2)
(declare-const temp___210 us_rep1)
...
(assert (= (ite (<= (to_rep3 (first4 temp___2011)) (to_rep3 (last4 temp___2011))) (+ (- (to_rep3 (last4 temp___2011)) (to_rep3 (first4 temp___2011))) 1) 0) (ite (<= (to_rep3 (first4 result____split_fields1)) (to_rep3 (last4 result____split_fields1))) (+ (- (to_rep3 (last4 result____split_fields1)) (to_rep3 (first4 result____split_fields1))) 1) 0)))
(assert (= (mk___t2 o o1) (mk___t2 temp___201 temp___2011)))
(assert (= o2 o))
(assert (= o3 o1))
(assert (= result____split_fields2 o4))
(assert (= result____split_discrs (mk___split_discrs temp___204)))
(assert (= temp___2041 o2))
(assert (= temp___2042 o3))
(assert (= temp___2043 o4))
...
(assert (= result____split_fields3 (mk___split_fields1 (mk___t2 temp___2041 temp___2042) temp___2043)))
(assert (= result____split_discrs (mk___split_discrs temp___204)))
