...
(define-fun dynamic_invariant1 ((temp___expr_229 Int) (temp___is_init_225 Bool) (temp___skip_constant_226 Bool) (temp___do_toplevel_227 Bool) (temp___do_typ_inv_228 Bool)) Bool (=> (or (= temp___is_init_225 true) (<= 1 2147483647)) (in_range6 temp___expr_229)))
...
(define-fun dynamic_invariant3 ((temp___expr_222 Int) (temp___is_init_218 Bool) (temp___skip_constant_219 Bool) (temp___do_toplevel_220 Bool) (temp___do_typ_inv_221 Bool)) Bool (=> (or (= temp___is_init_218 true) (<= 0 2147483647)) (in_range5 temp___expr_222)))
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant2 this true true true true) (dynamic_invariant3 (length3 this) true false true true)) :pattern ((length3 this)))))
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant2 this true true true true) (= (length3 this) (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 this))))) :pattern ((length3 this)))))
(declare-fun value (us_rep) us_t1)
(declare-fun value__function_guard (us_t1 us_rep) Bool)
(define-fun dynamic_invariant4 ((temp___expr_206 us_t1) (temp___is_init_202 Bool) (temp___skip_constant_203 Bool) (temp___do_toplevel_204 Bool) (temp___do_typ_inv_205 Bool)) Bool (=> (not (= temp___skip_constant_203 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_206) (last3 temp___expr_206))))
...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant2 this true true true true) (let ((result (value this))) (and (and (and (and (= (length1 result) (length3 this)) (= (first3 result) 1)) (= (last3 result) (length3 this))) (= (< 0 (length3 this)) (not (= (empty this) true)))) (dynamic_invariant4 result true false true true)))) :pattern ((value this)))))
...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant2 this true true true true) (= (= (empty this) true) (= (length3 this) 0))) :pattern ((empty this)))))
...
(assert (dynamic_invariant2 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2))) true false true true))
