...
(define-fun dynamic_invariant1 ((temp___expr_201 Int) (temp___is_init_198 Bool) (temp___skip_constant_199 Bool) (temp___do_toplevel_200 Bool)) Bool (=> (or (= temp___is_init_198 true) (<= 1 2147483647)) (in_range6 temp___expr_201)))
...
(define-fun dynamic_invariant3 ((temp___expr_195 Int) (temp___is_init_192 Bool) (temp___skip_constant_193 Bool) (temp___do_toplevel_194 Bool)) Bool (=> (or (= temp___is_init_192 true) (<= 0 2147483647)) (in_range5 temp___expr_195)))
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant2 this true true true) (dynamic_invariant3 (length3 this) true false true)) :pattern ((length3 this)))))
...
(define-fun dynamic_invariant4 ((temp___expr_181 us_t1) (temp___is_init_178 Bool) (temp___skip_constant_179 Bool) (temp___do_toplevel_180 Bool)) Bool (=> (not (= temp___skip_constant_179 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_181) (last3 temp___expr_181))))
...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant2 this true true true) (let ((result (value this))) (and (and (and (and (= (length1 result) (length3 this)) (= (first3 result) 1)) (= (last3 result) (length3 this))) (= (< 0 (length3 this)) (not (= (empty this) true)))) (dynamic_invariant4 result true false true)))) :pattern ((value this)))))
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant2 this true true true) (= (value this) (let ((temp___234 (let ((temp___232 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 this))))) (let ((temp___231 1)) (let ((temp___233 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 this)))) (of_array3 (to_array2 temp___233) temp___231 temp___232)))))) (of_array1 (to_array3 temp___234) (first7 temp___234) (last7 temp___234))))) :pattern ((value this)))))
...
(declare-const bounded_dynamic_strings__append__3__new_length__assume Int)
...
(declare-const o7 t2)
(declare-const temp___1147 natural_index)
(declare-const temp___11471 natural_index)
(declare-const temp___11472 (Array Int character))
(declare-const temp___11473 t2)
(declare-const temp___1148 natural_index)
(declare-const temp___11481 natural_index)
(declare-const temp___11482 (Array Int character))
(declare-const temp___11483 t2)
(declare-const o8 natural_index)
(declare-const o9 natural_index)
(declare-const o10 (Array Int character))
(declare-const o11 t2)
(declare-const temp___1150 natural_index)
(declare-const temp___11501 natural_index)
(declare-const temp___11502 (Array Int character))
(declare-const temp___11503 t2)
(declare-const temp___1151 natural_index)
(declare-const temp___11511 natural_index)
(declare-const temp___11512 (Array Int character))
(declare-const temp___11513 t2)
(declare-const temp___1155 us_t1)
...
(assert (in_range4 tail))
(assert (dynamic_invariant2 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2))) true false true))
(assert (<= (+ 1 (length3 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2))))) (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity to____split_discrs))))
(assert (not (in_range6 (+ 1 (to_rep2 to____split_fields)))))
(check-sat)
(exit)
