...
(assert (=> (= (length description) 0) (= temp___404 temp___405)))
(assert (=> (= (length description) 0) (= (mk (to_rep1 (first2 temp___4041)) (to_rep1 (last2 temp___4041))) temp___4051)))
(assert (=> (not (= (length description) 0)) (=> (<= (to_rep1 (first2 temp___4041)) (to_rep1 (last2 temp___4041))) (= o (+ (- (to_rep1 (last2 temp___4041)) (to_rep1 (first2 temp___4041))) 1)))))
(assert (=> (not (= (length description) 0)) (=> (not (<= (to_rep1 (first2 temp___4041)) (to_rep1 (last2 temp___4041)))) (= o 0))))
(assert (=> (not (= (length description) 0)) (=> (<= (to_rep1 (first (rt description))) (to_rep1 (last (rt description)))) (= o1 (+ (- (to_rep1 (last (rt description))) (to_rep1 (first (rt description)))) 1)))))
(assert (=> (not (= (length description) 0)) (=> (not (<= (to_rep1 (first (rt description))) (to_rep1 (last (rt description))))) (= o1 0))))
(assert (=> (not (= (length description) 0)) (= o2 (+ o1 o))))
(assert (=> (not (= (length description) 0)) (= o3 (+ (to_rep1 (first (rt description))) o2))))
(assert (=> (not (= (length description) 0)) (= o4 (- o3 1))))
(assert (=> (not (= (length description) 0)) (and (= o5 o4) (in_range2 o4))))
(assert (=> (not (= (length description) 0)) (= (concat1 (elts description) (to_rep1 (first (rt description))) (to_rep1 (last (rt description))) temp___404 (to_rep1 (first2 temp___4041)) (to_rep1 (last2 temp___4041))) temp___405)))
(assert (=> (not (= (length description) 0)) (= (mk (to_rep1 (first (rt description))) o5) temp___4051)))
(assert (not (= (ite (<= (to_rep1 (first temp___4051)) (to_rep1 (last temp___4051))) (+ (- (to_rep1 (last temp___4051)) (to_rep1 (first temp___4051))) 1) 0) (ite (<= 1 128) (+ (- 128 1) 1) 0))))
(check-sat)
(exit)
