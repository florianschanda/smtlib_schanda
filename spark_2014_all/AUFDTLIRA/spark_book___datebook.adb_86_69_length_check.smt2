...
(assert (=> (= (length description) 0) (= (mk (to_rep1 (first2 temp___3611)) (to_rep1 (last2 temp___3611))) temp___3621)))
(assert (=> (not (= (length description) 0)) (=> (<= (to_rep1 (first2 temp___3611)) (to_rep1 (last2 temp___3611))) (= o2 (+ (- (to_rep1 (last2 temp___3611)) (to_rep1 (first2 temp___3611))) 1)))))
(assert (=> (not (= (length description) 0)) (=> (not (<= (to_rep1 (first2 temp___3611)) (to_rep1 (last2 temp___3611)))) (= o2 0))))
(assert (=> (not (= (length description) 0)) (=> (<= (to_rep1 (first (rt description))) (to_rep1 (last (rt description)))) (= o3 (+ (- (to_rep1 (last (rt description))) (to_rep1 (first (rt description)))) 1)))))
(assert (=> (not (= (length description) 0)) (=> (not (<= (to_rep1 (first (rt description))) (to_rep1 (last (rt description))))) (= o3 0))))
(assert (=> (not (= (length description) 0)) (= o4 (+ o3 o2))))
(assert (=> (not (= (length description) 0)) (= o5 (+ (to_rep1 (first (rt description))) o4))))
(assert (=> (not (= (length description) 0)) (= o6 (- o5 1))))
(assert (=> (not (= (length description) 0)) (and (= o7 o6) (in_range2 o6))))
(assert (=> (not (= (length description) 0)) (= (concat1 (elts description) (to_rep1 (first (rt description))) (to_rep1 (last (rt description))) temp___361 (to_rep1 (first2 temp___3611)) (to_rep1 (last2 temp___3611))) temp___362)))
(assert (=> (not (= (length description) 0)) (= (mk (to_rep1 (first (rt description))) o7) temp___3621)))
(assert (not (= (ite (<= (to_rep1 (first temp___3621)) (to_rep1 (last temp___3621))) (+ (- (to_rep1 (last temp___3621)) (to_rep1 (first temp___3621))) 1) 0) (ite (<= 1 128) (+ (- 128 1) 1) 0))))
(check-sat)
(exit)
