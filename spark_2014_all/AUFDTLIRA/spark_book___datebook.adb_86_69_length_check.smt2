...
(assert (=> (not (= (length description) 0)) (=> (<= (to_rep1 (first2 temp___3611)) (to_rep1 (last2 temp___3611))) (= o (+ (- (to_rep1 (last2 temp___3611)) (to_rep1 (first2 temp___3611))) 1)))))
(assert (=> (not (= (length description) 0)) (=> (not (<= (to_rep1 (first2 temp___3611)) (to_rep1 (last2 temp___3611)))) (= o 0))))
...
(assert (=> (not (= (length description) 0)) (= (mk (to_rep1 (first (rt description))) o5) temp___3621)))
