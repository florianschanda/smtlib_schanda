...
(assert (and (= o91 (has_key1 (positions (mk___rep d__split_discrs d__split_fields2)) c6)) (= (= o91 true) (= (has_key1 (positions (mk___rep d__split_discrs d__split_fields2)) c6) true))))
(assert (= o92 true))
(assert (= result18 (ite (= o92 true) o91 false)))
(assert (= result18 true))
(assert (not (= (has_key1 (positions (mk___rep d__split_discrs d__split_fields2)) c6) true)))
(check-sat)
(exit)
