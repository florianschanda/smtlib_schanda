...
(assert (and (and (forall ((temp___2160 Int)) (=> (and (<= (to_rep1 n__first) temp___2160) (<= temp___2160 (to_rep1 n__last))) (=> (< index2 temp___2160) (= (select n3 temp___2160) (select n1 temp___2160))))) (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 10) index2))) (and (<= (+ (to_rep1 (first (rt source))) 1) index2) (<= index2 (+ (to_rep1 (first (rt source))) 10)))))
