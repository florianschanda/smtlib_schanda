...
(assert (and (and (forall ((temp___2160 Int)) (=> (and (<= (to_rep1 n__first) temp___2160) (<= temp___2160 (to_rep1 n__last))) (=> (< index3 temp___2160) (= (select n3 temp___2160) (select n1 temp___2160))))) (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 10) index3))) (and (<= (+ (to_rep1 (first (rt source))) 1) index3) (<= index3 (+ (to_rep1 (first (rt source))) 10)))))
(assert (and (= o18 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (= o19 (ite (<= o18 i) true false)))
(assert (= result5 (ite (= o19 true) (ite (<= i index3) true false) false)))
(assert (= result5 true))
