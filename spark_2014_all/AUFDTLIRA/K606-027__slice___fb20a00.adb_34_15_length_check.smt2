...
(assert (not (= (ite (<= (to_rep1 (first2 temp___2351)) (to_rep1 (last2 temp___2351))) (+ (- (to_rep1 (last2 temp___2351)) (to_rep1 (first2 temp___2351))) 1) 0) (ite (<= (to_rep1 new_str__first) (to_rep1 new_str__last)) (+ (- (to_rep1 new_str__last) (to_rep1 new_str__first)) 1) 0))))
(check-sat)
(exit)
