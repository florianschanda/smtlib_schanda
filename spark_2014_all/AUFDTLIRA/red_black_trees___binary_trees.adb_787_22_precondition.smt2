...
(assert (= o19 (select temp___1633 i)))
...
(assert (and (= temp___1632 (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) o15)) (and (dynamic_invariant3 temp___1632 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1632 o15))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1632 o15)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 o15)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1632 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1632 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1632 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1632 i1))) true) (not (= i1 o15))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1632 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i1)))) (position (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1632 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1632 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1632 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1632 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1632 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1632 j)))) true)) (= j i1))))))))))))))
(assert (= o16 (select temp___1632 i)))
(assert (= o17 (us_split_fields1 o16)))
(assert (= o18 (rec__tree_model__path_type__a o17)))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= temp___1631 (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root)) (and (dynamic_invariant3 temp___1631 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1631 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1631 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1631 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1631 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1631 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1631 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1631 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1)))) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1631 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1631 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1631 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1631 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1631 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1631 j)))) true)) (= j i1))))))))))))))
(assert (and (<= 1 v) (<= v 100)))
(assert (= o10 v))
(assert (= o11 (select temp___1631 o10)))
