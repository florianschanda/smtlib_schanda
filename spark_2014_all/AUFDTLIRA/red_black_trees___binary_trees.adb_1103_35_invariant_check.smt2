...
(assert (= n1 0))
(assert (=> (and (<= 0 n1) (<= n1 100)) (= temp___1916 n1)))
...
(assert (=> (and (<= 0 n1) (<= n1 100)) (and (=> (<= 0 100) (in_range2 n2)) (and (<= 0 n2) (<= n2 100)))))
...
(assert (= r2 1))
(assert (=> (and (<= 1 r2) (<= r2 r323b)) (= temp___1926 r2)))
(assert (=> (and (<= 1 r2) (<= r2 r323b)) (=> (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f_old__split_fields1 r2)))) 2) (and (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 r2)))) 2) (= (oeq1 (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) r2) (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) r2)) true)))))
(assert (=> (and (<= 1 r2) (<= r2 r323b)) (forall ((p Int)) (=> (and (<= 1 p) (<= p r3)) (=> (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f_old__split_fields1 p)))) 2) (= (oeq1 (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) p) (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) p)) true))))))
(assert (=> (and (<= 1 r2) (<= r2 r323b)) (and (=> (<= 1 r323b) (dynamic_property 1 r323b r3)) (and (<= 1 r3) (<= r3 r323b)))))
(assert (=> (and (<= 1 r2) (<= r2 r323b)) (= r3 r323b)))
(assert (=> (and (<= 1 r2) (<= r2 r323b)) (= r4 (mk_int__ref r3))))
(assert (=> (and (<= 1 r2) (<= r2 r323b)) (= r5 r3)))
(assert (=> (and (<= 1 r2) (<= r2 r323b)) (= r6 r4)))
(assert (=> (and (<= 1 r2) (<= r2 r323b)) (= r7 r5)))
(assert (=> (not (and (<= 1 r2) (<= r2 r323b))) (= r6 (mk_int__ref r2))))
(assert (=> (not (and (<= 1 r2) (<= r2 r323b))) (= r7 r2)))
(assert (= r8 r6))
(assert (= n7 n9))
(assert (= r9 r7))
(assert (= n8 n6))
...
(assert (= o r1))
(assert (= (mk___rep1 (mk___split_fields1 o1 o2 o3 o4)) (select f_old__split_fields1 o)))
(assert (= o1 o5))
(assert (= o2 o6))
(assert (= o3 o7))
(assert (= o4 o8))
...
(assert (= result2 (ite (= o10 2) true false)))
(assert (= result2 true))
(assert (and (= o11 r1) (in_range1 r1)))
