...
(define-fun dynamic_invariant4 ((temp___expr_168 Int) (temp___is_init_165 Bool) (temp___skip_constant_166 Bool) (temp___do_toplevel_167 Bool)) Bool (=> (or (= temp___is_init_165 true) (<= 0 1)) (in_range6 temp___expr_168)))
...
(declare-const n Int)
(declare-const r Int)
(declare-const temp___1870 Int)
(declare-const j Int)
(declare-const temp___1872 (Array Int us_rep1))
(declare-const o us_rep)
(declare-const o1 Bool)
(declare-const o2 us_rep)
(declare-const o3 Bool)
(declare-const o4 Bool)
(declare-const temp___1880 Int)
(declare-const p Int)
...
(declare-const o20 (Array Int us_rep1))
(declare-const i Int)
...
(assert (and (and (<= (+ (to_rep f_old__split_fields) 1) root) (<= root (to_rep f__split_fields))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i1)))) (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f_old__split_fields1 i1))))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 i1)))) (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f_old__split_fields1 i1))))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (= (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select f__split_fields1 i1)))) (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select f_old__split_fields1 i1))))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (= (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select f__split_fields1 i1)))) (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select f_old__split_fields1 i1))))))))))))
(assert (= (mk_int__ref result) (mk_int__ref n)))
(assert (= n1 0))
(assert (=> (and (<= 0 n1) (<= n1 100)) (and (and (= temp___1870 n1) (and (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root) j1))) true) (not (= j1 root))) (< n2 (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root) j1)))))))) (and (and (=> (<= 0 100) (in_range2 n2)) (and (<= 0 n2) (<= n2 100))) (= n2 100)))) (and (= n2 n6) (= n7 n2)))))
(assert (=> (and (<= 0 n1) (<= n1 100)) (= (mk_int__ref n8) (mk_int__ref n6))))
(assert (=> (and (<= 0 n1) (<= n1 100)) (= n9 n7)))
(assert (=> (not (and (<= 0 n1) (<= n1 100))) (= n1 n8)))
(assert (=> (not (and (<= 0 n1) (<= n1 100))) (= n9 n1)))
(assert (= (to_rep f_old__split_fields) r323b))
(assert (in_range2 r323b))
(assert (= result3 (mk_int__ref r)))
(assert (= r2 1))
(assert (=> (and (<= 1 r2) (<= r2 r323b)) (and (and (= temp___1880 r2) (and (=> (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f_old__split_fields1 r2)))) 2) (and (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 r2)))) 2) (= (oeq1 (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) r2) (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) r2)) true))) (and (forall ((p1 Int)) (=> (and (<= 1 p1) (<= p1 r3)) (=> (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f_old__split_fields1 p1)))) 2) (= (oeq1 (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) p1) (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) p1)) true)))) (and (and (=> (<= 1 r323b) (dynamic_property 1 r323b r3)) (and (<= 1 r3) (<= r3 r323b))) (= r3 r323b))))) (and (= r9 (mk_int__ref r3)) (= r10 r3)))))
(assert (=> (and (<= 1 r2) (<= r2 r323b)) (= r11 r9)))
(assert (=> (and (<= 1 r2) (<= r2 r323b)) (= r12 r10)))
(assert (=> (not (and (<= 1 r2) (<= r2 r323b))) (= r11 (mk_int__ref r2))))
(assert (=> (not (and (<= 1 r2) (<= r2 r323b))) (= r12 r2)))
(assert (= r13 r11))
(assert (= n10 (mk_int__ref n8)))
(assert (= r14 r12))
(assert (= n11 n9))
(assert (<= 1 r1))
(assert (<= r1 (to_rep f_old__split_fields)))
(assert (and (<= 1 r1) (<= r1 100)))
(assert (= o21 r1))
(assert (= (mk___rep1 (mk___split_fields1 o22 o23 o24 o25)) (select f_old__split_fields1 o21)))
(assert (= o22 o26))
(assert (= o23 o27))
(assert (= o24 o28))
(assert (= o25 o29))
...
(assert (= result7 (ite (= o31 2) true false)))
(assert (= result7 true))
(assert (and (= o34 r1) (in_range1 r1)))
