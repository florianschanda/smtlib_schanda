...
(define-fun dynamic_invariant ((temp___expr_157 us_rep) (temp___is_init_154 Bool) (temp___skip_constant_155 Bool) (temp___do_toplevel_156 Bool)) Bool (let ((temp___158 (rec__bounded_queue_v1__queue_type__max_size (us_split_discrs1 temp___expr_157)))) (and (dynamic_property1 1 (to_rep temp___158) (first1 (rec__bounded_queue_v1__queue_type__items (us_split_fields1 temp___expr_157))) (last1 (rec__bounded_queue_v1__queue_type__items (us_split_fields1 temp___expr_157)))) (and (= (first1 (rec__bounded_queue_v1__queue_type__items (us_split_fields1 temp___expr_157))) 1) (= (last1 (rec__bounded_queue_v1__queue_type__items (us_split_fields1 temp___expr_157))) (to_rep temp___158))))))
...
(assert (and (= us (to_rep (rec__bounded_queue_v1__queue_type__max_size (us_split_discrs1 queue)))) (in_range (to_rep (rec__bounded_queue_v1__queue_type__max_size (us_split_discrs1 queue))))))
(assert (not (<= (to_rep2 (first (rt (rec__bounded_queue_v1__queue_type__items (us_split_fields1 queue))))) (to_rep (rec__bounded_queue_v1__queue_type__rear (us_split_fields1 queue))))))
(check-sat)
(exit)
