...
(assert (=> (and (<= 0 s2) (<= s2 100)) (= o11 (select temp___473 s3))))
...
(assert (and (= o8 (to__2 o7)) (and (in_range4 o8) (= o8 (to_rep2 (rec__model__uml_control_flow__to_data (us_split_fields9 o7)))))))
