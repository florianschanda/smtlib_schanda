...
(assert (<= i13 3))
(assert (= (to_rep o3) 1))
(assert (= o4 (store (get (select x4 i32) i212 i223) i13 o3)))
(assert (= o5 (set (select x4 i32) i212 i223 o4)))
(assert (= o6 (store x4 i32 o5)))
(assert (= x4 result5))
(assert (= x5 o6))
...
(assert (= i15 (+ i14 1)))
(assert (= (to_rep o8) 1))
(assert (= o9 (store (get (select x6 i32) i212 i223) i15 o8)))
(assert (= o10 (set (select x6 i32) i212 i223 o9)))
(assert (= o11 (store x6 i32 o10)))
(assert (= result7 x6))
(assert (= x7 o11))
