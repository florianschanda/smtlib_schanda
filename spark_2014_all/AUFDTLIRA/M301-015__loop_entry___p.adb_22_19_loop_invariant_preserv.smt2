...
(assert (and (and (forall ((temp___266 Int)) (=> (and (<= 1 temp___266) (<= temp___266 3)) (ite (not (= i32 temp___266)) (= (select x6 temp___266) (select x4 temp___266)) (forall ((temp___267 Int) (temp___268 Int)) (=> (and (and (<= 1 temp___267) (<= temp___267 3)) (and (<= 1 temp___268) (<= temp___268 3))) (ite (or (not (= i222 temp___268)) (not (= i212 temp___267))) (= (get (select x6 temp___266) temp___267 temp___268) (get (select x4 temp___266) temp___267 temp___268)) (forall ((temp___269 Int)) (=> (and (<= 1 temp___269) (<= temp___269 3)) (=> (< i12 temp___269) (= (select (get (select x6 temp___266) temp___267 temp___268) temp___269) (select (get (select x4 temp___266) temp___267 temp___268) temp___269))))))))))) (=> (<= 1 3) (in_range2 i12))) (and (<= 1 i12) (<= i12 3))))
(assert (not (= i12 3)))
(assert (= result6 i12))
(assert (= i13 (+ i12 1)))
(assert (= (to_rep o4) 1))
(assert (= o5 (store (get (select x6 i32) i212 i222) i13 o4)))
(assert (= o6 (set (select x6 i32) i212 i222 o5)))
(assert (= o7 (store x6 i32 o6)))
(assert (= result7 x6))
(assert (= x7 o7))
(assert (not (= (bool_eq2 x7 (to_rep (first12 (mk6 (+ i32 1) 3))) (to_rep (last12 (mk6 (+ i32 1) 3))) x4 (to_rep (first14 (mk7 (+ i32 1) 3))) (to_rep (last14 (mk7 (+ i32 1) 3)))) true)))
(check-sat)
(exit)
