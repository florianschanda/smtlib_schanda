...
(assert (and (and (forall ((temp___234 Int)) (=> (and (<= 1 temp___234) (<= temp___234 3)) (ite (not (= i32 temp___234)) (= (select x6 temp___234) (select x4 temp___234)) (forall ((temp___235 Int) (temp___236 Int)) (=> (and (and (<= 1 temp___235) (<= temp___235 3)) (and (<= 1 temp___236) (<= temp___236 3))) (ite (or (not (= i222 temp___236)) (not (= i212 temp___235))) (= (get (select x6 temp___234) temp___235 temp___236) (get (select x4 temp___234) temp___235 temp___236)) (forall ((temp___237 Int)) (=> (and (<= 1 temp___237) (<= temp___237 3)) (=> (< i12 temp___237) (= (select (get (select x6 temp___234) temp___235 temp___236) temp___237) (select (get (select x4 temp___234) temp___235 temp___236) temp___237))))))))))) (=> (<= 1 3) (in_range2 i12))) (and (<= 1 i12) (<= i12 3))))
(assert (not (= i12 3)))
(assert (= result6 i12))
(assert (= i13 (+ i12 1)))
(assert (= (to_rep o4) 1))
