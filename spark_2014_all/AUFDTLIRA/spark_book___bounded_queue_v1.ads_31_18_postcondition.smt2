...
(assert (= queue__split_fields5 (mk___split_fields temp___2831 temp___2832 temp___2833 (mk___t temp___2834 temp___2835))))
(assert (= queue__split_discrs (mk___split_discrs temp___283)))
(assert (= (to_rep1 o6) 1))
...
(assert (= queue__split_fields6 (mk___split_fields temp___2851 temp___2852 temp___2853 (mk___t temp___2854 temp___2855))))
(assert (= queue__split_discrs (mk___split_discrs temp___285)))
...
(assert (= queue__split_fields7 (mk___split_fields temp___2871 temp___2872 temp___2873 (mk___t temp___2874 temp___2875))))
(assert (= queue__split_discrs (mk___split_discrs temp___287)))
