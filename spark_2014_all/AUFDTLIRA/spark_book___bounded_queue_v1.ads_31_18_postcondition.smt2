...
(declare-const o5 t)
(declare-const temp___313 positive)
(declare-const temp___3131 natural)
(declare-const temp___3132 positive)
(declare-const temp___3133 positive)
(declare-const temp___3134 (Array Int element_type))
(declare-const temp___3135 t)
...
(declare-const temp___3151 natural)
(declare-const temp___3152 positive)
(declare-const temp___3153 positive)
(declare-const temp___3154 (Array Int element_type))
(declare-const temp___3155 t)
...
(assert (= queue__split_discrs (mk___split_discrs temp___313)))
(assert (= temp___3131 o1))
(assert (= temp___3132 o2))
(assert (= temp___3133 o3))
(assert (= temp___3134 o4))
(assert (= temp___3135 o5))
...
(assert (= queue__split_fields5 (mk___split_fields temp___3131 temp___3132 temp___3133 (mk___t temp___3134 temp___3135))))
(assert (= queue__split_discrs (mk___split_discrs temp___313)))
(assert (= (to_rep1 o6) 1))
(assert (= (rec__bounded_queue_v1__queue_type__count queue__split_fields5) o7))
(assert (= o6 o8))
(assert (= (rec__bounded_queue_v1__queue_type__rear queue__split_fields5) o9))
(assert (= (rec__bounded_queue_v1__queue_type__items queue__split_fields5) (mk___t o10 o11)))
(assert (= queue__split_discrs (mk___split_discrs temp___315)))
(assert (= temp___3151 o7))
(assert (= temp___3152 o8))
(assert (= temp___3153 o9))
(assert (= temp___3154 o10))
(assert (= temp___3155 o11))
(assert (= result1 (mk___split_fields__ref queue__split_fields5)))
(assert (= queue__split_fields6 (mk___split_fields temp___3151 temp___3152 temp___3153 (mk___t temp___3154 temp___3155))))
(assert (= queue__split_discrs (mk___split_discrs temp___315)))
(assert (= (to_rep1 o12) (to_rep1 (rec__bounded_queue_v1__queue_type__max_size queue__split_discrs))))
(assert (= (rec__bounded_queue_v1__queue_type__count queue__split_fields6) o13))
(assert (= (rec__bounded_queue_v1__queue_type__front queue__split_fields6) o14))
(assert (= o12 o15))
(assert (= (rec__bounded_queue_v1__queue_type__items queue__split_fields6) (mk___t o16 o17)))
(assert (= queue__split_discrs (mk___split_discrs temp___317)))
(assert (= temp___3171 o13))
(assert (= temp___3172 o14))
(assert (= temp___3173 o15))
(assert (= temp___3174 o16))
(assert (= temp___3175 o17))
(assert (= result2 (mk___split_fields__ref queue__split_fields6)))
(assert (= queue__split_fields7 (mk___split_fields temp___3171 temp___3172 temp___3173 (mk___t temp___3174 temp___3175))))
(assert (= queue__split_discrs (mk___split_discrs temp___317)))
