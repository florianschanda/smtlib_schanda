...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (= (to_rep (select (temp___String_Literal_168 us_void_param) 1)) 104) (= (to_rep (select (temp___String_Literal_168 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_168 us_void_param) 3)) 108)) (= (to_rep (select (temp___String_Literal_168 us_void_param) 4)) 108)) (= (to_rep (select (temp___String_Literal_168 us_void_param) 5)) 111)) :pattern ((temp___String_Literal_168 us_void_param)))))
...
(assert (= result arr))
(assert (= arr1 (temp___String_Literal_168 Tuple0)))
