...
(assert (= (to_rep4 o1) 3))
(assert (= o1 o10))
(assert (= temp___1065 o10))
(assert (= temp___10651 o6))
(assert (= temp___10652 o7))
(assert (= temp___10653 o8))
(assert (= temp___10654 o9))
(assert (= true temp___10655))
(assert (= t__attr__constrained true))
(assert (not (= temp___1065 t__split_discrs)))
(check-sat)
(exit)
