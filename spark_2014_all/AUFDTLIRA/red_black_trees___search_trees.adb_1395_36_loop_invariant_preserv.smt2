...
(assert (not (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields5) (to_rep1 (rec__search_trees__search_tree__root t__split_fields5))) current3))) true)))
(check-sat)
(exit)
