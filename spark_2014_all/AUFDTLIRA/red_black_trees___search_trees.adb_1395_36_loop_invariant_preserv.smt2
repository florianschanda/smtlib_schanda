...
(assert (=> (= result11 true) (= result12 (mk_int__ref i7))))
(assert (=> (= result11 true) (= i8 0)))
(assert (=> (= result11 true) (exists ((i20 Int)) (and (and (<= 1 i20) (<= i20 100)) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__1 (mk___rep3 t__split_fields7)) i20))) true) (= (to_rep (select (rec__search_trees__search_tree__values t__split_fields7) i20)) v))))))
(assert (=> (= result11 true) (= (contains1 (mk___rep3 t__split_fields7) v) true)))
(assert (not (= result11 true)))
(assert (=> (= result11 true) (= d7 d6)))
(assert (=> (not (= result11 true)) (and (<= 1 previous4) (<= previous4 100))))
(assert (=> (not (= result11 true)) (= o41 previous4)))
(assert (=> (not (= result11 true)) (= o42 (select (rec__search_trees__search_tree__values t__split_fields7) o41))))
(assert (=> (not (= result11 true)) (= o43 (to_rep o42))))
(assert (=> (not (= result11 true)) (= result13 (ite (< v o43) true false))))
(assert (=> (not (= result11 true)) (=> (= result13 true) (= result14 (mk_int__ref d6)))))
(assert (=> (not (= result11 true)) (=> (= result13 true) (= d7 0))))
(assert (=> (not (= result11 true)) (=> (not (= result13 true)) (= result15 (mk_int__ref d6)))))
(assert (=> (not (= result11 true)) (=> (not (= result13 true)) (= d8 1))))
(assert (=> (not (= result11 true)) (=> (not (= result13 true)) (= d7 d8))))
(assert (=> (not (= result11 true)) (= i8 i7)))
(assert (and (= o44 previous4) (in_range3 previous4)))
(assert (and (= o45 (peek (rec__search_trees__search_tree__struct t__split_fields7) o44 d7)) (and (in_range4 o45) (and (ite (not (= o45 0)) (and (= (position (rec__search_trees__search_tree__struct t__split_fields7) o45) d7) (= (parent (rec__search_trees__search_tree__struct t__split_fields7) o45) o44)) (forall ((j10 Int)) (=> (and (<= 1 j10) (<= j10 100)) (=> (= (parent (rec__search_trees__search_tree__struct t__split_fields7) j10) o44) (not (= (position (rec__search_trees__search_tree__struct t__split_fields7) j10) d7)))))) (forall ((j10 Int)) (=> (and (<= 1 j10) (<= j10 100)) (=> (and (= (parent (rec__search_trees__search_tree__struct t__split_fields7) j10) o44) (= (position (rec__search_trees__search_tree__struct t__split_fields7) j10) d7)) (= o45 j10))))))))
(assert (= result16 (mk_int__ref current3)))
(assert (= current4 o45))
(assert (not (= current4 0)))
(assert (not (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields7) (to_rep1 (rec__search_trees__search_tree__root t__split_fields7))) current4))) true)))
(check-sat)
(exit)
