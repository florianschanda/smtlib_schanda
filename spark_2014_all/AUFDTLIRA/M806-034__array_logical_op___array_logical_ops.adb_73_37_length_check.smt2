...
(assert (not (= (ite (<= (to_rep1 (first (rt v))) (to_rep1 (last (rt v)))) (+ (- (to_rep1 (last (rt v))) (to_rep1 (first (rt v)))) 1) 0) (ite (<= (to_rep1 (first (rt w))) (to_rep1 (last (rt w)))) (+ (- (to_rep1 (last (rt w))) (to_rep1 (first (rt w)))) 1) 0))))
(check-sat)
(exit)
