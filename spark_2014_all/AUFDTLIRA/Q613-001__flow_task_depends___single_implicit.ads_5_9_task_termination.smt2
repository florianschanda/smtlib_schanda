...
(define-fun dynamic_invariant ((temp___expr_201 Int) (temp___is_init_197 Bool) (temp___skip_constant_198 Bool) (temp___do_toplevel_199 Bool) (temp___do_typ_inv_200 Bool)) Bool (=> (or (= temp___is_init_197 true) (<= 0 1)) (in_range temp___expr_201)))
...
(assert (forall ((x message_type)) (! (in_range (to_rep x)) :pattern ((to_rep x)))))
...
(assert (forall ((x message_index_type)) (! (in_range1 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(assert (forall ((x message_count_type)) (! (in_range2 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(define-fun dynamic_invariant1 ((temp___expr_208 Int) (temp___is_init_204 Bool) (temp___skip_constant_205 Bool) (temp___do_toplevel_206 Bool) (temp___do_typ_inv_207 Bool)) Bool (=> (or (= temp___is_init_204 true) (<= 1 64)) (in_range1 temp___expr_208)))
(define-fun dynamic_invariant2 ((temp___expr_215 Int) (temp___is_init_211 Bool) (temp___skip_constant_212 Bool) (temp___do_toplevel_213 Bool) (temp___do_typ_inv_214 Bool)) Bool (=> (or (= temp___is_init_211 true) (<= 0 64)) (in_range2 temp___expr_215)))
...
(define-fun dynamic_invariant3 ((temp___expr_187 Int) (temp___is_init_183 Bool) (temp___skip_constant_184 Bool) (temp___do_toplevel_185 Bool) (temp___do_typ_inv_186 Bool)) Bool (=> (or (= temp___is_init_183 true) (<= 0 97)) (in_range4 temp___expr_187)))
(assert (not true))
(check-sat)
(exit)
