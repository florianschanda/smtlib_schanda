...
(define-fun dynamic_invariant ((temp___expr_319 us_t1) (temp___is_init_316 Bool) (temp___skip_constant_317 Bool) (temp___do_toplevel_318 Bool)) Bool (and (=> (not (= temp___skip_constant_317 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_319) (last3 temp___expr_319))) (=> (= temp___do_toplevel_318 true) (=> (= temp___is_init_316 true) (and (let ((temp___321 (of_array2 (to_array1 temp___expr_319) (first3 temp___expr_319) (last3 temp___expr_319)))) (and (= (first5 temp___321) 1) (<= 0 (last5 temp___321)))) (<= (last3 temp___expr_319) 1000))))))
(define-fun dynamic_predicate ((temp___323 us_t1)) Bool (and (let ((temp___325 (of_array2 (to_array1 temp___323) (first3 temp___323) (last3 temp___323)))) (and (= (first5 temp___325) 1) (<= 0 (last5 temp___325)))) (<= (last3 temp___323) 1000)))
...
(define-fun dynamic_invariant1 ((temp___expr_1756 Int) (temp___is_init_1753 Bool) (temp___skip_constant_1754 Bool) (temp___do_toplevel_1755 Bool)) Bool (=> (or (= temp___is_init_1753 true) (<= 0 28)) (in_range3 temp___expr_1756)))
(declare-const x Int)
...
(define-fun dynamic_invariant6 ((temp___expr_285 us_t2) (temp___is_init_282 Bool) (temp___skip_constant_283 Bool) (temp___do_toplevel_284 Bool)) Bool (and (=> (not (= temp___skip_constant_283 true)) (dynamic_property2 1 2147483647 (first5 temp___expr_285) (last5 temp___expr_285))) (=> (= temp___do_toplevel_284 true) (=> (= temp___is_init_282 true) (and (= (first5 temp___expr_285) 1) (<= 0 (last5 temp___expr_285)))))))
(define-fun dynamic_predicate1 ((temp___288 us_t2)) Bool (and (= (first5 temp___288) 1) (<= 0 (last5 temp___288))))
