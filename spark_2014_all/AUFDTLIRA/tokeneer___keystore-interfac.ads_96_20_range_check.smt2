...
(define-fun dynamic_invariant1 ((temp___expr_1952 Int) (temp___is_init_1948 Bool) (temp___skip_constant_1949 Bool) (temp___do_toplevel_1950 Bool) (temp___do_typ_inv_1951 Bool)) Bool (=> (or (= temp___is_init_1948 true) (<= 0 28)) (in_range3 temp___expr_1952)))
(declare-const x Int)
