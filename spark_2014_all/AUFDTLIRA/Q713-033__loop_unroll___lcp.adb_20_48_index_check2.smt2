...
(assert (= result3 (ite (<= o1 (to_rep (last (rt a)))) true false)))
(assert (=> (= result3 true) (and (= o (+ y l1)) (in_range1 (+ y l1)))))
(assert (=> (= result3 true) (= result2 (ite (<= o (to_rep (last (rt a)))) true false))))
