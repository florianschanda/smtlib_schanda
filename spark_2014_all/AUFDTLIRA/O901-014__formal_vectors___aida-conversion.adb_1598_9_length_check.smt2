...
(assert (not (= (ite (<= (to_rep1 (first4 temp___19831)) (to_rep1 (last4 temp___19831))) (+ (- (to_rep1 (last4 temp___19831)) (to_rep1 (first4 temp___19831))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 5) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 5)) 1) 0))))
(check-sat)
(exit)
