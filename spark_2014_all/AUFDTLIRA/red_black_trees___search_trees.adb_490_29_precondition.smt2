...
(assert (= o41 (select temp___1647 i2)))
(assert (= o42 (us_split_fields5 o41)))
...
(assert (=> (= result14 true) (= o38 k)))
(assert (=> (= result14 true) (= o39 (select temp___1648 o38))))
(assert (=> (= result14 true) (= o40 (us_split_fields5 o39))))
(assert (=> (= result14 true) (= result13 (rec__tree_model__path_type__k o40))))
...
(assert (= o34 k))
(assert (= o35 (select temp___1650 o34)))
