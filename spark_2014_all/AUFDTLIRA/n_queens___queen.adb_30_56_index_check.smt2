...
(assert (and (and (forall ((temp___182 Int)) (=> (and (<= 1 temp___182) (<= temp___182 8)) (=> (<= j9 temp___182) (= (select r8 temp___182) (select r6 temp___182))))) (=> (<= (+ i 1) 8) (dynamic_property1 (+ i 1) 8 j9))) (and (<= (+ i 1) j9) (<= j9 8))))
(assert (<= 1 k))
(assert (<= k i))
(assert (not (<= 1 k)))
(check-sat)
