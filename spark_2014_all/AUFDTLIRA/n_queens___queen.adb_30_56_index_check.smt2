...
(assert (<= (+ i 1) j12))
(assert (<= j12 8))
(assert (forall ((k2 Int)) (=> (and (<= 1 k2) (<= k2 i)) (= (to_rep (select r10 k2)) (to_rep (select b k2))))))
(assert (and (and (forall ((temp___182 Int)) (=> (and (<= 1 temp___182) (<= temp___182 8)) (=> (<= j13 temp___182) (= (select r10 temp___182) (select r8 temp___182))))) (=> (<= (+ i 1) 8) (dynamic_property1 (+ i 1) 8 j13))) (and (<= (+ i 1) j13) (<= j13 8))))
(assert (<= 1 k1))
(assert (<= k1 i))
(assert (not (<= 1 k1)))
(check-sat)
