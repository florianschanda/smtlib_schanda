...
(declare-const temp___256 (Array Int natural))
...
(declare-const v2 (Array Int natural))
...
(assert (= (ite (<= (to_rep v__first) (to_rep v__last)) (+ (- (to_rep v__last) (to_rep v__first)) 1) 0) (ite (<= 0 y) (+ (- y 0) 1) 0)))
(assert (= v2 temp___256))
(assert (= (mk2 (to_rep v__first) (to_rep v__last)) temp___2561))
(assert (not (= (ite (<= (to_rep (first4 temp___2551)) (to_rep (last4 temp___2551))) (+ (- (to_rep (last4 temp___2551)) (to_rep (first4 temp___2551))) 1) 0) (ite (<= (to_rep (first4 temp___2561)) (to_rep (last4 temp___2561))) (+ (- (to_rep (last4 temp___2561)) (to_rep (first4 temp___2561))) 1) 0))))
(check-sat)
(exit)
