...
(assert (and (<= 0 i3) (<= i3 99)))
(assert (= o94 i3))
(assert (= o95 (select (rec__patience__state__posstack (us_split_fields1 s)) o94)))
(assert (= temp___408 (to_rep1 o95)))
(assert (and (<= 0 temp___408) (<= temp___408 99)))
(assert (= o96 temp___408))
(assert (= o97 (select (rec__patience__state__stacksizes (us_split_fields1 s)) o96)))
