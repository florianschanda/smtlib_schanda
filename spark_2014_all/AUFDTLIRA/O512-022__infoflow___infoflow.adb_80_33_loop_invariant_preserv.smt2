...
(assert (and (and (forall ((temp___363 Int)) (=> (and (<= 1 temp___363) (<= temp___363 10)) (=> (< i2 temp___363) (= (select outkeys_v12 temp___363) (select outkeys_v1 temp___363))))) (=> (<= 1 10) (in_range2 i2))) (and (<= 1 i2) (<= i2 10))))
(assert (not (= i2 10)))
(assert (= result2 i2))
(assert (= i3 (+ i2 1)))
