...
(assert (forall ((k Int)) (=> (and (<= 1 k) (<= k 10)) (=> (<= k i2) (= (to_rep (select outkeys_v12 k)) (to_rep (select inkeys_v1 k)))))))
(assert (and (and (forall ((temp___406 Int)) (=> (and (<= 1 temp___406) (<= temp___406 10)) (=> (< i2 temp___406) (= (select outkeys_v12 temp___406) (select outkeys_v1 temp___406))))) (=> (<= 1 10) (in_range2 i2))) (and (<= 1 i2) (<= i2 10))))
(assert (not (= i2 10)))
(assert (= result2 i2))
(assert (= i3 (+ i2 1)))
...
(assert (<= k 10))
(assert (<= k i3))
(assert (not (= (to_rep (select outkeys_v13 k)) (to_rep (select inkeys_v1 k)))))
(check-sat)
(exit)
