...
(declare-const temp___8343 (Array Int (Array Int et1)))
(declare-const temp___83431 Bool)
...
(assert (= temp___8343 o3))
(assert (= temp___83431 o4))
(assert (= result2 r__split_fields2))
(assert (= result3 r__split_fields3))
(assert (= temp___8343 r__split_fields4))
(assert (= temp___83431 r__split_fields5))
