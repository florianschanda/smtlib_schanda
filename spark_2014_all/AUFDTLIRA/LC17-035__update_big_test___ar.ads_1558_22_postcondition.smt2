...
(declare-const temp___8284 (Array Int (Array Int et1)))
(declare-const temp___82841 Bool)
...
(assert (= temp___8284 o3))
(assert (= temp___82841 o4))
(assert (= result2 r__split_fields2))
(assert (= result3 r__split_fields3))
(assert (= temp___8284 r__split_fields4))
(assert (= temp___82841 r__split_fields5))
...
(assert (not (= (bool_eq (select r__split_fields6 i) 1 10 a 1 10) true)))
(check-sat)
(exit)
