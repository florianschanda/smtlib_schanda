...
(declare-const temp___876 (Array Int character))
(declare-const temp___8761 t)
...
(assert (= branch 18))
(assert (= (to_rep1 (first2 (rt (do_checks__do_range_check__B_17__a__aggregate_def 48 zero 1)))) zero))
(assert (= (to_rep1 (last1 (rt (do_checks__do_range_check__B_17__a__aggregate_def 48 zero 1)))) 1))
(assert (= (mk___t temp___876 temp___8761) (do_checks__do_range_check__B_17__a__aggregate_def 48 zero 1)))
(assert (not (= (ite (<= (to_rep1 (first2 temp___8761)) (to_rep1 (last1 temp___8761))) (+ (- (to_rep1 (last1 temp___8761)) (to_rep1 (first2 temp___8761))) 1) 0) (ite (<= 1 10) (+ (- 10 1) 1) 0))))
(check-sat)
(exit)
