...
(assert (= (mk___t temp___796 temp___7961) (do_checks__do_range_check__B_17__a__aggregate_def 48 zero 1)))
(assert (not (= (ite (<= (to_rep1 (first2 temp___7961)) (to_rep1 (last1 temp___7961))) (+ (- (to_rep1 (last1 temp___7961)) (to_rep1 (first2 temp___7961))) 1) 0) (ite (<= 1 10) (+ (- 10 1) 1) 0))))
(check-sat)
(exit)
