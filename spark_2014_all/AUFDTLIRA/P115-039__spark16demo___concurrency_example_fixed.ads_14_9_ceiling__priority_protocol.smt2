...
(assert (forall ((temp___200 Int)) (forall ((temp___201 Int)) (= (select (concurrency_example_fixed__all_zeroes__aggregate_def temp___200) temp___201) (of_rep temp___200)))))
...
(assert (forall ((temp___203 Int)) (forall ((temp___204 Int)) (= (select (concurrency_example_fixed__all_ones__aggregate_def temp___203) temp___204) (of_rep temp___203)))))
...
(define-fun dynamic_invariant1 ((temp___expr_232 Int) (temp___is_init_229 Bool) (temp___skip_constant_230 Bool) (temp___do_toplevel_231 Bool)) Bool (=> (or (= temp___is_init_229 true) (<= 0 97)) (in_range1 temp___expr_232)))
