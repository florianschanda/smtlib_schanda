...
(declare-const diff20 bool__ref)
(declare-const j18 int__ref)
(declare-const diff21 Bool)
(declare-const j19 Int)
(declare-const diff22 bool__ref)
(declare-const j20 int__ref)
(declare-const diff23 Bool)
(declare-const j21 Int)
(declare-const diff24 bool__ref)
(declare-const j22 int__ref)
(declare-const diff25 Bool)
(declare-const j23 Int)
(declare-const string_search__brute_force__result5 int__ref)
(declare-const string_search__brute_force__result6 Int)
(declare-const diff26 bool__ref)
(declare-const i4 int__ref)
(declare-const j24 int__ref)
(declare-const string_search__brute_force__result7 int__ref)
(declare-const diff27 Bool)
(declare-const i5 Int)
(declare-const j25 Int)
(declare-const string_search__brute_force__result8 Int)
(define-fun j26 () int__ref (mk_int__ref j8))
(define-fun diff28 () bool__ref (mk_bool__ref diff9))
(define-fun j27 () int__ref (mk_int__ref j6))
(define-fun diff29 () bool__ref (mk_bool__ref diff7))
...
(assert (=> (and (<= (to_rep1 (first (rt needle))) j1) (<= j1 (to_rep1 (last (rt needle))))) (= (mk_int__ref j10) j26)))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j1) (<= j1 (to_rep1 (last (rt needle))))) (= (mk_bool__ref diff11) diff28)))
...
(assert (not (= i2 temp___273)))
(assert (= result6 (mk_int__ref i2)))
(assert (= i3 (+ i2 1)))
(assert (= result7 (mk_bool__ref diff13)))
(assert (= diff14 (of_int 0)))
(assert (= result8 (mk_int__ref j12)))
(assert (= j13 (to_rep1 (first (rt needle)))))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j13) (<= j13 (to_rep1 (last (rt needle))))) (= temp___2661 j13)))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j13) (<= j13 (to_rep1 (last (rt needle))))) (= temp___2651 diff14)))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j13) (<= j13 (to_rep1 (last (rt needle))))) (and (= temp___2642 (+ j13 (- i3 1))) (in_range1 (+ j13 (- i3 1))))))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j13) (<= j13 (to_rep1 (last (rt needle))))) (and (<= (to_rep1 (first (rt haystack))) temp___2642) (<= temp___2642 (to_rep1 (last (rt haystack)))))))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j13) (<= j13 (to_rep1 (last (rt needle))))) (= o15 temp___2642)))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j13) (<= j13 (to_rep1 (last (rt needle))))) (= o16 (select (elts haystack) o15))))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j13) (<= j13 (to_rep1 (last (rt needle))))) (= o17 (to_rep o16))))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j13) (<= j13 (to_rep1 (last (rt needle))))) (= o18 (ite (= (to_rep (select (elts needle) j13)) o17) true false))))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j13) (<= j13 (to_rep1 (last (rt needle))))) (= o19 (ite (not (= o18 true)) true false))))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j13) (<= j13 (to_rep1 (last (rt needle))))) (= result9 (mk_bool__ref diff14))))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j13) (<= j13 (to_rep1 (last (rt needle))))) (= diff15 o19)))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j13) (<= j13 (to_rep1 (last (rt needle))))) (or (and (and (and (= j18 (mk_int__ref j13)) (= diff20 (mk_bool__ref diff15))) (and (= j19 j13) (= diff21 diff15))) (= diff15 true)) (and (not (= diff15 true)) (and (and (and (= j18 j16) (= diff20 diff18)) (and (= j19 j17) (= diff21 diff19))) (and (and (= (partial_match_at needle haystack i3 j14) true) (= (= diff16 true) (not (= (to_rep (select (elts needle) j14)) (to_rep (select (elts haystack) (+ j14 (- i3 1)))))))) (and (and (=> (<= (to_rep1 (first (rt needle))) (to_rep1 (last (rt needle)))) (dynamic_property2 (to_rep1 (first (rt needle))) (to_rep1 (last (rt needle))) j14)) (and (<= (to_rep1 (first (rt needle))) j14) (<= j14 (to_rep1 (last (rt needle)))))) (or (and (and (and (= j16 (mk_int__ref j14)) (= diff18 (mk_bool__ref diff16))) (and (= j17 j14) (= diff19 diff16))) (= j14 (to_rep1 (last (rt needle))))) (and (not (= j14 (to_rep1 (last (rt needle))))) (and (and (and (= j16 (mk_int__ref j15)) (= diff18 (mk_bool__ref diff17))) (and (= j17 j15) (= diff19 diff17))) (and (and (= result10 (mk_int__ref j14)) (= j15 (+ j14 1))) (and (and (and (and (and (and (and (and (= temp___2643 (+ j15 (- i3 1))) (in_range1 (+ j15 (- i3 1)))) (and (and (<= (to_rep1 (first (rt haystack))) temp___2643) (<= temp___2643 (to_rep1 (last (rt haystack))))) (= o20 temp___2643))) (= o21 (select (elts haystack) o20))) (= o22 (to_rep o21))) (= o23 (ite (= (to_rep (select (elts needle) j15)) o22) true false))) (= o24 (ite (not (= o23 true)) true false))) (and (= result11 (mk_bool__ref diff16)) (= diff17 o24))) (= diff17 true)))))))))))))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j13) (<= j13 (to_rep1 (last (rt needle))))) (= j20 j18)))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j13) (<= j13 (to_rep1 (last (rt needle))))) (= diff22 diff20)))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j13) (<= j13 (to_rep1 (last (rt needle))))) (= j21 j19)))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j13) (<= j13 (to_rep1 (last (rt needle))))) (= diff23 diff21)))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j13) (<= j13 (to_rep1 (last (rt needle))))) (= j22 j20)))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j13) (<= j13 (to_rep1 (last (rt needle))))) (= diff24 diff22)))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j13) (<= j13 (to_rep1 (last (rt needle))))) (= j23 j21)))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j13) (<= j13 (to_rep1 (last (rt needle))))) (= diff25 diff23)))
(assert (=> (not (and (<= (to_rep1 (first (rt needle))) j13) (<= j13 (to_rep1 (last (rt needle)))))) (= j22 (mk_int__ref j13))))
(assert (=> (not (and (<= (to_rep1 (first (rt needle))) j13) (<= j13 (to_rep1 (last (rt needle)))))) (= diff24 (mk_bool__ref diff14))))
(assert (=> (not (and (<= (to_rep1 (first (rt needle))) j13) (<= j13 (to_rep1 (last (rt needle)))))) (= j23 j13)))
(assert (=> (not (and (<= (to_rep1 (first (rt needle))) j13) (<= j13 (to_rep1 (last (rt needle)))))) (= diff25 diff14)))
(assert (= (bool__content diff24) true))
(assert (= string_search__brute_force__result5 (mk_int__ref string_search__brute_force__result4)))
(assert (= string_search__brute_force__result6 string_search__brute_force__result4))
(assert (= string_search__brute_force__result7 string_search__brute_force__result5))
(assert (= j24 j22))
(assert (= i4 (mk_int__ref i3)))
(assert (= diff26 diff24))
(assert (= string_search__brute_force__result8 string_search__brute_force__result6))
(assert (= j25 j23))
(assert (= i5 i3))
(assert (= diff27 diff25))
(declare-const k Int)
(assert (<= 1 k))
(assert (<= k (int__content i4)))
