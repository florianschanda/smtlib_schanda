...
(assert (= i3 (+ i2 1)))
(assert (= result8 (mk_bool__ref diff14)))
(assert (= diff15 (of_int 0)))
(assert (= result9 (mk_int__ref j13)))
(assert (= j14 (to_rep1 (first (rt needle)))))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j14) (<= j14 (to_rep1 (last (rt needle))))) (= temp___2661 j14)))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j14) (<= j14 (to_rep1 (last (rt needle))))) (= temp___2651 diff15)))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j14) (<= j14 (to_rep1 (last (rt needle))))) (and (= temp___2642 (+ j14 (- i3 1))) (in_range1 (+ j14 (- i3 1))))))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j14) (<= j14 (to_rep1 (last (rt needle))))) (and (<= (to_rep1 (first (rt haystack))) temp___2642) (<= temp___2642 (to_rep1 (last (rt haystack)))))))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j14) (<= j14 (to_rep1 (last (rt needle))))) (= o19 temp___2642)))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j14) (<= j14 (to_rep1 (last (rt needle))))) (= o20 (select (elts haystack) o19))))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j14) (<= j14 (to_rep1 (last (rt needle))))) (= o21 (to_rep o20))))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j14) (<= j14 (to_rep1 (last (rt needle))))) (= o22 (ite (= (to_rep (select (elts needle) j14)) o21) true false))))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j14) (<= j14 (to_rep1 (last (rt needle))))) (= o23 (ite (not (= o22 true)) true false))))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j14) (<= j14 (to_rep1 (last (rt needle))))) (= result10 (mk_bool__ref diff15))))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j14) (<= j14 (to_rep1 (last (rt needle))))) (= diff16 o23)))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j14) (<= j14 (to_rep1 (last (rt needle))))) (or (and (and (and (= j21 (mk_int__ref j14)) (= diff23 (mk_bool__ref diff16))) (and (= j22 j14) (= diff24 diff16))) (= diff16 true)) (and (not (= diff16 true)) (and (and (and (= j21 j17) (= diff23 diff19)) (and (= j22 j18) (= diff24 diff20))) (and (and (= (partial_match_at needle haystack i3 j15) true) (= (= diff17 true) (not (= (to_rep (select (elts needle) j15)) (to_rep (select (elts haystack) (+ j15 (- i3 1)))))))) (and (and (=> (<= (to_rep1 (first (rt needle))) (to_rep1 (last (rt needle)))) (dynamic_property2 (to_rep1 (first (rt needle))) (to_rep1 (last (rt needle))) j15)) (and (<= (to_rep1 (first (rt needle))) j15) (<= j15 (to_rep1 (last (rt needle)))))) (or (and (and (and (= j17 (mk_int__ref j15)) (= diff19 (mk_bool__ref diff17))) (and (= j18 j15) (= diff20 diff17))) (= j15 (to_rep1 (last (rt needle))))) (and (not (= j15 (to_rep1 (last (rt needle))))) (and (and (and (= j17 (mk_int__ref j16)) (= diff19 (mk_bool__ref diff18))) (and (= j18 j16) (= diff20 diff18))) (and (and (= result11 (mk_int__ref j15)) (= j16 (+ j15 1))) (and (and (and (and (and (and (and (and (= temp___2643 (+ j16 (- i3 1))) (in_range1 (+ j16 (- i3 1)))) (and (and (<= (to_rep1 (first (rt haystack))) temp___2643) (<= temp___2643 (to_rep1 (last (rt haystack))))) (= o28 temp___2643))) (= o29 (select (elts haystack) o28))) (= o30 (to_rep o29))) (= o31 (ite (= (to_rep (select (elts needle) j16)) o30) true false))) (= o32 (ite (not (= o31 true)) true false))) (and (= result12 (mk_bool__ref diff17)) (= diff18 o32))) (= diff18 true)))))))))))))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j14) (<= j14 (to_rep1 (last (rt needle))))) (= j23 j21)))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j14) (<= j14 (to_rep1 (last (rt needle))))) (= diff25 diff23)))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j14) (<= j14 (to_rep1 (last (rt needle))))) (= j24 j22)))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j14) (<= j14 (to_rep1 (last (rt needle))))) (= diff26 diff24)))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j14) (<= j14 (to_rep1 (last (rt needle))))) (= j25 j23)))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j14) (<= j14 (to_rep1 (last (rt needle))))) (= diff27 diff25)))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j14) (<= j14 (to_rep1 (last (rt needle))))) (= j26 j24)))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j14) (<= j14 (to_rep1 (last (rt needle))))) (= diff28 diff26)))
(assert (=> (not (and (<= (to_rep1 (first (rt needle))) j14) (<= j14 (to_rep1 (last (rt needle)))))) (= j25 (mk_int__ref j14))))
(assert (=> (not (and (<= (to_rep1 (first (rt needle))) j14) (<= j14 (to_rep1 (last (rt needle)))))) (= diff27 (mk_bool__ref diff15))))
(assert (=> (not (and (<= (to_rep1 (first (rt needle))) j14) (<= j14 (to_rep1 (last (rt needle)))))) (= j26 j14)))
(assert (=> (not (and (<= (to_rep1 (first (rt needle))) j14) (<= j14 (to_rep1 (last (rt needle)))))) (= diff28 diff15)))
(assert (= (bool__content diff27) true))
(assert (= string_search__brute_force__result7 (mk_int__ref string_search__brute_force__result5)))
(assert (= string_search__brute_force__result8 string_search__brute_force__result5))
(assert (= string_search__brute_force__result9 string_search__brute_force__result7))
(assert (= j27 j25))
(assert (= i4 (mk_int__ref i3)))
(assert (= diff29 diff27))
(assert (= string_search__brute_force__result10 string_search__brute_force__result8))
(assert (= j28 j26))
(assert (= i5 i3))
(assert (= diff30 diff28))
(declare-const k1 Int)
(assert (<= 1 k1))
(assert (<= k1 (int__content i4)))
