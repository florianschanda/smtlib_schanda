...
(assert (<= 1 i1))
(assert (<= i1 10))
(assert (and (forall ((n1 Int)) (=> (and (<= 1 n1) (<= n1 (- i1 1))) (<= (to_rep (select a n1)) max1))) (exists ((n1 Int)) (and (and (<= 1 n1) (<= n1 (- i1 1))) (= (to_rep (select a n1)) max1)))))
...
(assert (forall ((m1 Int)) (=> (and (<= (- 2147483648) m1) (<= m1 2147483647)) (=> (and (forall ((n1 Int)) (=> (and (<= 1 n1) (<= n1 i2)) (<= (to_rep (select a n1)) m1))) (exists ((n1 Int)) (and (and (<= 1 n1) (<= n1 i2)) (= (to_rep (select a n1)) m1)))) (= m1 max3)))))
