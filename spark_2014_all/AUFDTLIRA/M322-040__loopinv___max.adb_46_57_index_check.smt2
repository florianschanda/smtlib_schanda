...
(assert (<= 1 i1))
(assert (<= i1 10))
(assert (and (forall ((n6 Int)) (=> (and (<= 1 n6) (<= n6 (- i1 1))) (<= (to_rep (select a n6)) max1))) (exists ((n6 Int)) (and (and (<= 1 n6) (<= n6 (- i1 1))) (= (to_rep (select a n6)) max1)))))
...
(assert (forall ((m1 Int)) (=> (and (<= (- 2147483648) m1) (<= m1 2147483647)) (=> (and (forall ((n6 Int)) (=> (and (<= 1 n6) (<= n6 i2)) (<= (to_rep (select a n6)) m1))) (exists ((n6 Int)) (and (and (<= 1 n6) (<= n6 i2)) (= (to_rep (select a n6)) m1)))) (= m1 max3)))))
