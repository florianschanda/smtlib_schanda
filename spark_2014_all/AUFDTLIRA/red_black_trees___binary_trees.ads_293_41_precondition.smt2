...
(declare-fun user_eq4 (position_type position_type) Bool)
(declare-const dummy4 position_type)
...
(define-fun dynamic_invariant2 ((temp___expr_175 Int) (temp___is_init_171 Bool) (temp___skip_constant_172 Bool) (temp___do_toplevel_173 Bool) (temp___do_typ_inv_174 Bool)) Bool (=> (or (= temp___is_init_171 true) (<= 1 100)) (in_range1 temp___expr_175)))
...
(assert (forall ((f us_rep3)) (forall ((i Int)) (! (=> (and (dynamic_invariant2 i true true true true) (type_invariant f)) (let ((result (parent f i))) (and (and (=> (= (valid_root f i) true) (= result 0)) (=> (= (size f) 0) (= result 0))) (dynamic_invariant1 result true false true true)))) :pattern ((parent f i))))))
...
(define-fun dynamic_invariant3 ((temp___expr_196 Int) (temp___is_init_192 Bool) (temp___skip_constant_193 Bool) (temp___do_toplevel_194 Bool) (temp___do_typ_inv_195 Bool)) Bool (=> (or (= temp___is_init_192 true) (<= 0 1)) (in_range4 temp___expr_196)))
(assert (forall ((f us_rep3)) (forall ((i Int)) (! (=> (and (and (dynamic_invariant2 i true true true true) (type_invariant f)) (not (= (parent f i) 0))) (dynamic_invariant3 (position f i) true false true true)) :pattern ((position f i))))))
...
(assert (forall ((f us_rep3)) (forall ((i Int) (d Int)) (! (=> (and (and (dynamic_invariant2 i true true true true) (dynamic_invariant3 d true true true true)) (type_invariant f)) (let ((result (peek f i d))) (and (and (ite (not (= result 0)) (and (= (position f result) d) (= (parent f result) i)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (parent f j) i) (not (= (position f j) d)))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (parent f j) i) (= (position f j) d)) (= result j))))) (dynamic_invariant1 result true false true true)))) :pattern ((peek f i d))))))
(assert (forall ((f us_rep3)) (forall ((i Int) (d Int)) (! (=> (and (dynamic_invariant2 i true true true true) (dynamic_invariant3 d true true true true)) (= (peek f i d) (ite (= d 0) (to_rep (rec__binary_trees__cell__left (us_split_fields3 (let ((temp___343 (rec__binary_trees__forest__c (us_split_fields5 f)))) (select temp___343 i))))) (to_rep (rec__binary_trees__cell__right (us_split_fields3 (let ((temp___344 (rec__binary_trees__forest__c (us_split_fields5 f)))) (select temp___344 i)))))))) :pattern ((peek f i d))))))
...
(declare-const o9 (Array Int us_rep2))
(declare-const o10 extended_index_type)
(declare-const o11 (Array Int us_rep2))
(declare-const temp___854 extended_index_type)
(declare-const temp___8541 (Array Int us_rep2))
...
(declare-const o20 position_type)
(declare-const o21 (Array Int us_rep2))
(declare-const o22 extended_index_type)
(declare-const o23 (Array Int us_rep2))
(declare-const temp___849 extended_index_type)
(declare-const temp___8491 (Array Int us_rep2))
...
(assert (=> (not (= v 0)) (=> (= d 0) (= (rec__binary_trees__cell__right (us_split_fields3 (select f__split_fields1 i))) o2))))
(assert (=> (not (= v 0)) (=> (= d 0) (= (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i))) o3))))
(assert (=> (not (= v 0)) (=> (= d 0) (= (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 i))) o4))))
(assert (=> (not (= v 0)) (=> (= d 0) (= o5 o1))))
(assert (=> (not (= v 0)) (=> (= d 0) (= o6 o2))))
(assert (=> (not (= v 0)) (=> (= d 0) (= o7 o3))))
(assert (=> (not (= v 0)) (=> (= d 0) (= o8 o4))))
(assert (=> (not (= v 0)) (=> (= d 0) (= o9 (store f__split_fields1 i (mk___rep1 (mk___split_fields1 o5 o6 o7 o8)))))))
(assert (=> (not (= v 0)) (=> (= d 0) (= f__split_fields o10))))
(assert (=> (not (= v 0)) (=> (= d 0) (= o9 o11))))
(assert (=> (not (= v 0)) (=> (= d 0) (= temp___854 o10))))
(assert (=> (not (= v 0)) (=> (= d 0) (= temp___8541 o11))))
(assert (=> (not (= v 0)) (=> (= d 0) (= result1 f__split_fields9))))
(assert (=> (not (= v 0)) (=> (= d 0) (= f__split_fields3 (mk___split_fields2 temp___854 temp___8541)))))
(assert (=> (not (= v 0)) (=> (not (= d 0)) (= (to_rep o12) v))))
(assert (=> (not (= v 0)) (=> (not (= d 0)) (= (rec__binary_trees__cell__left (us_split_fields3 (select f__split_fields1 i))) o13))))
(assert (=> (not (= v 0)) (=> (not (= d 0)) (= o12 o14))))
(assert (=> (not (= v 0)) (=> (not (= d 0)) (= (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i))) o15))))
(assert (=> (not (= v 0)) (=> (not (= d 0)) (= (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 i))) o16))))
(assert (=> (not (= v 0)) (=> (not (= d 0)) (= o17 o13))))
(assert (=> (not (= v 0)) (=> (not (= d 0)) (= o18 o14))))
(assert (=> (not (= v 0)) (=> (not (= d 0)) (= o19 o15))))
(assert (=> (not (= v 0)) (=> (not (= d 0)) (= o20 o16))))
(assert (=> (not (= v 0)) (=> (not (= d 0)) (= o21 (store f__split_fields1 i (mk___rep1 (mk___split_fields1 o17 o18 o19 o20)))))))
(assert (=> (not (= v 0)) (=> (not (= d 0)) (= f__split_fields o22))))
(assert (=> (not (= v 0)) (=> (not (= d 0)) (= o21 o23))))
(assert (=> (not (= v 0)) (=> (not (= d 0)) (= temp___849 o22))))
(assert (=> (not (= v 0)) (=> (not (= d 0)) (= temp___8491 o23))))
(assert (=> (not (= v 0)) (=> (not (= d 0)) (= result2 f__split_fields9))))
(assert (=> (not (= v 0)) (=> (not (= d 0)) (= f__split_fields4 (mk___split_fields2 temp___849 temp___8491)))))
(assert (=> (not (= v 0)) (=> (not (= d 0)) (= f__split_fields3 f__split_fields4))))
(assert (=> (not (= v 0)) (= (to_rep1 o24) d)))
(assert (=> (not (= v 0)) (= (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields3) v))) o25)))
(assert (=> (not (= v 0)) (= (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields3) v))) o26)))
(assert (=> (not (= v 0)) (= (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields3) v))) o27)))
...
(assert (=> (not (= v 0)) (= o34 (store (rec__binary_trees__forest__c f__split_fields3) o33 (mk___rep1 (mk___split_fields1 o29 o30 o31 o32))))))
(assert (=> (not (= v 0)) (= o35 (mk___split_fields2 (rec__binary_trees__forest__s f__split_fields3) o34))))
(assert (=> (not (= v 0)) (= temp___859 (mk___rep2 o35))))
(assert (=> (not (= v 0)) (= result3 (mk___split_fields__ref2 f__split_fields3))))
(assert (=> (not (= v 0)) (= f__split_fields5 (us_split_fields5 temp___859))))
(assert (=> (not (= v 0)) (= (to_rep o36) i)))
(assert (=> (not (= v 0)) (= o37 (mk___split_fields1 (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields5) v))) (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields5) v))) o36 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields5) v)))))))
(assert (=> (not (= v 0)) (= o38 (mk___rep1 o37))))
(assert (=> (not (= v 0)) (and (<= 1 v) (<= v 100))))
(assert (=> (not (= v 0)) (= o39 v)))
(assert (=> (not (= v 0)) (= o40 (store (rec__binary_trees__forest__c f__split_fields5) o39 o38))))
(assert (=> (not (= v 0)) (= o41 (mk___split_fields2 (rec__binary_trees__forest__s f__split_fields5) o40))))
(assert (=> (not (= v 0)) (= temp___864 (mk___rep2 o41))))
(assert (=> (not (= v 0)) (= result4 (mk___split_fields__ref2 f__split_fields5))))
(assert (=> (not (= v 0)) (= f__split_fields6 (us_split_fields5 temp___864))))
(assert (=> (not (= v 0)) (and (= (tree_structure (mk___rep2 f_old__split_fields2)) true) (= (tree_structure (mk___rep2 f__split_fields6)) true))))
(assert (=> (not (= v 0)) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 f__split_fields6) root) v))) true) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 f__split_fields6) root) i1))) true) (ite (= (ole (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 f__split_fields6) root) v))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 f__split_fields6) root) i1)))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 f_old__split_fields2) v) i1))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 f_old__split_fields2) root) i1))) true))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 f_old__split_fields2) root) i1))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 f__split_fields6) root) i1))) true)))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 f_old__split_fields2) v) i1))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 f__split_fields6) root) i1))) true)))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 f_old__split_fields2) root) i1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 f__split_fields6) root) i1))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 f_old__split_fields2) root) i1)))) true)))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 f_old__split_fields2) v) i1))) true) (= (is_concat (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 f__split_fields6) root) v))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 f_old__split_fields2) v) i1))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 f__split_fields6) root) i1)))) true)))) (forall ((r Int)) (=> (and (<= 1 r) (<= r (to_rep (rec__binary_trees__forest__s f__split_fields6)))) (=> (and (and (not (= r root)) (not (= r v))) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c f_old__split_fields2) r)))) 2)) (= (oeq1 (model__ (mk___rep2 f_old__split_fields2) r) (model__ (mk___rep2 f__split_fields6) r)) true))))))))))))
(assert (=> (not (not (= v 0))) (= f__split_fields6 (mk___split_fields2 f__split_fields f__split_fields1))))
...
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o52 (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)))) (and (in_range2 o52) (= o52 (to_rep f__split_fields)))))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= o53 (size (mk___rep2 (us_split_fields__content2 f__split_fields7)))) (and (in_range2 o53) (= o53 (to_rep (rec__binary_trees__forest__s (us_split_fields__content2 f__split_fields7)))))))
(assert (= result5 (ite (= o53 o52) true false)))
(assert (= result5 true))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= o51 (peek (mk___rep2 (us_split_fields__content2 f__split_fields7)) i d)) (and (in_range2 o51) (and (= o51 (ite (= d 0) (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) i)))) (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) i)))))) (and (ite (not (= o51 0)) (and (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) o51) d) (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) o51) i)) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j1) i) (not (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) j1) d)))))) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j1) i) (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) j1) d)) (= o51 j1)))))))))
(assert (= result6 (ite (= v o51) true false)))
(assert (= result6 true))
(assert (= (= result7 true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (valid_root (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j1) true) (not (= j1 v))) (= (valid_root (mk___rep2 (us_split_fields__content2 f__split_fields7)) j1) true))))))
(assert (= result7 true))
(assert (= (= result8 true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (= (valid_root (mk___rep2 (us_split_fields__content2 f__split_fields7)) j1) true) (= (valid_root (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j1) true))))))
(assert (= result8 true))
(assert (= (= result9 true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (not (= j1 v)) (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j1) (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j1)))))))
(assert (= result9 true))
(assert (= (= result10 true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (not (= j1 v)) (not (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j1) 0))) (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) j1) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j1)))))))
(assert (= result10 true))
(assert (= (= result11 true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (forall ((e Int)) (=> (and (<= 0 e) (<= e 1)) (=> (or (not (= j1 i)) (not (= e d))) (= (peek (mk___rep2 (us_split_fields__content2 f__split_fields7)) j1 e) (peek (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j1 e)))))))))
(assert (= result11 true))
(assert (= (= result12 true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root) j1))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (us_split_fields__content2 f__split_fields7)) root) j1))) true))))))
(assert (= result12 true))
(assert (= (= result13 true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (not (= v 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) v) j1))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (us_split_fields__content2 f__split_fields7)) root) j1))) true))))))
(assert (= result13 true))
(assert (= (= result14 true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (us_split_fields__content2 f__split_fields7)) root) i1))) true) (ite (and (not (= v 0)) (= (ole (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 (us_split_fields__content2 f__split_fields7)) root) v))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 (us_split_fields__content2 f__split_fields7)) root) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) v) i1))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root) i1))) true)))))))
(assert (= result14 true))
(assert (= (= result15 true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root) j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 (us_split_fields__content2 f__split_fields7)) root) j1))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root) j1)))) true))))))
(assert (= result15 true))
(assert (<= 1 j))
(assert (<= j 100))
(assert (=> (not (= v 0)) (and (= o42 v) (in_range1 v))))
(assert (=> (not (= v 0)) (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true)))
(assert (=> (not (= v 0)) (and (= o43 v) (in_range1 v))))
(assert (=> (not (= v 0)) (and (= temp___874 (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o43)) (and (dynamic_invariant temp___874 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___874 o43))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___874 o43)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 o43)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___874 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___874 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___874 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___874 i1))) true) (not (= i1 o43))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___874 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1)))) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___874 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___874 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___874 i1))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___874 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___874 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___874 j1)))) true)) (= j1 i1)))))))))))))))
(assert (=> (not (= v 0)) (= o44 (select temp___874 j))))
(assert (=> (not (= v 0)) (= o45 (us_split_fields1 o44))))
(assert (=> (not (= v 0)) (= result16 (rec__tree_model__path_type__k o45))))
(assert (=> (not (not (= v 0))) (= result16 false)))
(assert (= result16 true))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= temp___872 (model__ (mk___rep2 (us_split_fields__content2 f__split_fields7)) root)) (and (dynamic_invariant temp___872 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___872 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___872 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___872 (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___872 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___872 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___872 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___872 (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) i1)))) (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___872 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___872 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___872 i1))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___872 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___872 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___872 j1)))) true)) (= j1 i1))))))))))))))
(assert (= o48 (select temp___872 j)))
(assert (= o49 (us_split_fields1 o48)))
(assert (= o50 (rec__tree_model__path_type__a o49)))
(assert (and (= o46 v) (in_range1 v)))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o47 v) (in_range1 v)))
(assert (not (= (valid_root (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o47) true)))
(check-sat)
(exit)
