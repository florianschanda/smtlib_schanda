...
(assert (not (= (bool_eq o3 (to_rep (first o4)) (to_rep (last o4)) b2 (to_rep (first (mk (to_rep b__first) (to_rep b__last)))) (to_rep (last (mk (to_rep b__first) (to_rep b__last))))) true)))
(check-sat)
(exit)
