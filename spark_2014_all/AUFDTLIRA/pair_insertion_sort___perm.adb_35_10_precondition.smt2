...
(assert (not (= (bool_eq o5 (to_rep (first o6)) (to_rep (last o6)) b2 (to_rep (first (mk (to_rep b__first) (to_rep b__last)))) (to_rep (last (mk (to_rep b__first) (to_rep b__last))))) true)))
(check-sat)
(exit)
