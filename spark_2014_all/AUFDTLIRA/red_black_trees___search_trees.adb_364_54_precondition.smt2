...
(assert (<= 1 i2))
(assert (<= i2 100))
(assert (and (= temp___1678 (model__ f_old root)) (and (dynamic_invariant5 temp___1678 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1678 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1678 root)))) 0) (and (forall ((i21 Int)) (=> (and (<= 1 i21) (<= i21 100)) (=> (not (= i21 root)) (ite (and (not (= (parent f_old i21) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1678 (parent f_old i21)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1678 i21))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1678 i21))) true)))))) (and (forall ((i21 Int)) (=> (and (<= 1 i21) (<= i21 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1678 i21))) true) (not (= i21 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1678 (parent f_old i21)))) (position f_old i21) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1678 i21)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1678 i21)))) 0)))) (forall ((i21 Int)) (=> (and (<= 1 i21) (<= i21 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1678 i21))) true) (forall ((j26 Int)) (=> (and (<= 1 j26) (<= j26 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1678 j26))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1678 i21))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1678 j26)))) true)) (= j26 i21))))))))))))))
(assert (= (mk___rep (mk___split_fields o19 o20)) (select temp___1678 i2)))
(assert (= o19 o21))
(assert (= o20 o22))
(assert (= result18 o22))
(assert (= result18 true))
(assert (and (= temp___1677 (model__ f root)) (and (dynamic_invariant5 temp___1677 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1677 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1677 root)))) 0) (and (forall ((i21 Int)) (=> (and (<= 1 i21) (<= i21 100)) (=> (not (= i21 root)) (ite (and (not (= (parent f i21) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1677 (parent f i21)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1677 i21))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1677 i21))) true)))))) (and (forall ((i21 Int)) (=> (and (<= 1 i21) (<= i21 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1677 i21))) true) (not (= i21 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1677 (parent f i21)))) (position f i21) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1677 i21)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1677 i21)))) 0)))) (forall ((i21 Int)) (=> (and (<= 1 i21) (<= i21 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1677 i21))) true) (forall ((j26 Int)) (=> (and (<= 1 j26) (<= j26 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1677 j26))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1677 i21))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1677 j26)))) true)) (= j26 i21))))))))))))))
(assert (= (mk___rep (mk___split_fields o23 o24)) (select temp___1677 i2)))
(assert (= o23 o25))
(assert (= o24 o26))
(assert (= o27 o25))
