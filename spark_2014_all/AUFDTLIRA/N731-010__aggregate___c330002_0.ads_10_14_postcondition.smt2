...
(assert (= (ite (<= (to_rep (first temp___2171)) (to_rep (last temp___2171))) (+ (- (to_rep (last temp___2171)) (to_rep (first temp___2171))) 1) 0) (ite (<= (to_rep a__first) (to_rep a__last)) (+ (- (to_rep a__last) (to_rep a__first)) 1) 0)))
(assert (= (mk___t temp___218 temp___2181) (mk___t temp___217 temp___2171)))
(assert (= o (slide temp___218 (to_rep (first temp___2181)) (to_rep a__first))))
(assert (= result a))
(assert (= a1 o))
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (bool_eq a2 (to_rep a__first) (to_rep a__last) (temp___167 85 36) 1 2) true)))
(check-sat)
(exit)
