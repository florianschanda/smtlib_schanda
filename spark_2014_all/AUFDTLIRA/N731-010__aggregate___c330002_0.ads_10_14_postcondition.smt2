...
(assert (= (ite (<= (to_rep (first temp___1921)) (to_rep (last temp___1921))) (+ (- (to_rep (last temp___1921)) (to_rep (first temp___1921))) 1) 0) (ite (<= (to_rep a__first) (to_rep a__last)) (+ (- (to_rep a__last) (to_rep a__first)) 1) 0)))
(assert (= (mk___t temp___193 temp___1931) (mk___t temp___192 temp___1921)))
(assert (= o (slide temp___193 (to_rep (first temp___1931)) (to_rep a__first))))
(assert (= result a))
(assert (= a1 o))
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (bool_eq a2 (to_rep a__first) (to_rep a__last) (temp___144 85 36) 1 2) true)))
(check-sat)
(exit)
