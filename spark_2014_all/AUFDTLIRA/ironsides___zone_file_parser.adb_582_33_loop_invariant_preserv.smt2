...
(assert (= begidx4 o))
(assert (and (and (and (and (<= begidx5 endidx3) (<= begidx5 zlength)) (<= endidx3 zlength)) (=> (= foundtype3 1) (forall ((i48 Int)) (=> (and (<= begidx5 i48) (<= i48 endidx3)) (and (<= 48 (to_rep (select zonefileline i48))) (<= (to_rep (select zonefileline i48)) 57)))))) (and (and (in_range4 begidx5) (in_range4 endidx3)) (in_range3 foundtype3))))
