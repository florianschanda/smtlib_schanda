...
(define-fun dynamic_invariant ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= 0 100)) (in_range3 temp___expr_136)))
(assert true)
...
(define-fun dynamic_invariant1 ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= (- 1) 2147483647)) (in_range1 temp___expr_142)))
(define-fun dynamic_invariant2 ((temp___expr_148 Int) (temp___is_init_145 Bool) (temp___skip_constant_146 Bool) (temp___do_toplevel_147 Bool)) Bool (=> (or (= temp___is_init_145 true) (<= 1 100)) (in_range2 temp___expr_148)))
...
(declare-const stack__size__result15 Int)
(declare-const index13 Int)
(declare-const stack__size__result16 Int)
...
(assert (not (= (to_rep (select t index2)) (- 1))))
(assert (= stack__size__result3 stack__size__result2))
(assert (not (= index2 100)))
(assert (= result2 index2))
(assert (= index3 (+ index2 1)))
(declare-const i1 Int)
(assert (<= 1 i1))
(assert (<= i1 (- index3 1)))
(assert (not (not (= (to_rep (select t i1)) (- 1)))))
(check-sat)
(exit)
