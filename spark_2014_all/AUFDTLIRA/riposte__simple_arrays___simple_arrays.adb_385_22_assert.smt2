...
(assert (forall ((temp___594 (Array Int integer))) (forall ((temp___595 Int) (temp___596 Int)) (let ((temp___593 (temp___592 temp___594 temp___595 temp___596))) (forall ((temp___597 Int)) (ite (= temp___597 temp___595) (= (select temp___593 temp___597) (of_rep temp___596)) (= (select temp___593 temp___597) (select temp___594 temp___597))))))))
(assert (in_range i))
(assert (not (= (bool_eq (temp___592 a i (to_rep (select a i))) (- 2147483648) 2147483647 a (- 2147483648) 2147483647) true)))
(check-sat)
(exit)
