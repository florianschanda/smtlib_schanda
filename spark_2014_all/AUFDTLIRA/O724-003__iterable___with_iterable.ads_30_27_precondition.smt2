...
(define-fun dynamic_invariant ((temp___expr_191 us_rep1) (temp___is_init_187 Bool) (temp___skip_constant_188 Bool) (temp___do_toplevel_189 Bool) (temp___do_typ_inv_190 Bool)) Bool (and (=> (not (= temp___skip_constant_188 true)) (in_range2 101 temp___expr_191)) (=> (= temp___do_toplevel_189 true) (=> (= temp___is_init_187 true) (and (<= 1 (to_rep (rec__with_iterable__cursor__i (us_split_fields3 temp___expr_191)))) (<= (to_rep (rec__with_iterable__cursor__i (us_split_fields3 temp___expr_191))) (to_rep (rec__with_iterable__cursor__c (us_split_discrs1 temp___expr_191)))))))))
...
(define-fun dynamic_predicate1 ((temp___183 us_rep1)) Bool (and (<= 1 (to_rep (rec__with_iterable__cursor__i (us_split_fields3 temp___183)))) (<= (to_rep (rec__with_iterable__cursor__i (us_split_fields3 temp___183))) (to_rep (rec__with_iterable__cursor__c (us_split_discrs1 temp___183))))))
...
(assert (= (= o1 true) (dynamic_invariant cu2 true false true true)))
