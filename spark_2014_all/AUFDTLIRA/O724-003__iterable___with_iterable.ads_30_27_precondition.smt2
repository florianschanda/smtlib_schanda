...
(assert (forall ((a us_rep)) (forall ((i Int)) (! (=> (and (dynamic_invariant1 i true true true) (and (<= 1 i) (<= i 100))) (dynamic_invariant1 (get a i) true false true)) :pattern ((get a i))))))
(assert (forall ((a us_rep)) (forall ((i Int)) (! (=> (dynamic_invariant1 i true true true) (= (get a i) (to_rep (let ((temp___181 (rec__with_iterable__container__content (us_split_fields1 a)))) (select temp___181 i))))) :pattern ((get a i))))))
...
(define-fun dynamic_predicate1 ((temp___158 us_rep1)) Bool (and (<= 1 (to_rep (rec__with_iterable__cursor__i (us_split_fields3 temp___158)))) (<= (to_rep (rec__with_iterable__cursor__i (us_split_fields3 temp___158))) (to_rep (rec__with_iterable__cursor__c (us_split_discrs1 temp___158))))))
(declare-const cu natural)
(declare-const cu1 natural)
(declare-const o Bool)
(declare-const o1 Bool)
(declare-const o2 Int)
(declare-const result Bool)
(assert (and (= o (has_element a (mk___rep1 (mk___split_discrs cu) (mk___split_fields1 cu1)))) (= (= o true) (and (<= 1 (to_rep cu1)) (<= (to_rep cu1) 100)))))
(assert (= (= o1 true) (dynamic_invariant (mk___rep1 (mk___split_discrs cu) (mk___split_fields1 cu1)) true false true)))
(assert (= result (ite (= o1 true) o false)))
(assert (= result true))
(assert (not (<= 1 (to_rep cu1))))
(check-sat)
(exit)
