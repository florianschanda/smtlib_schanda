...
(declare-const content10 (Array Int positive))
(declare-const i9 Int)
(declare-const top2 Int)
(declare-const content11 (Array Int positive))
(declare-const i10 Int)
(declare-const top3 Int)
(declare-const content12 (Array Int positive))
...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 content__last))) (and (and (= temp___224 i1) (and (= temp___222 content) (and (and (and (= (to_rep o1) e) (= o2 (store content i1 o1))) (and (= (mk_map__ref result2) (mk_map__ref content)) (= content2 o2))) (and (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 i2)) (= (to_rep (select content3 j1)) e))) (and (and (and (forall ((temp___223 Int)) (=> (and (<= (to_rep1 content__first) temp___223) (<= temp___223 (to_rep1 content__last))) (=> (< i2 temp___223) (= (select content3 temp___223) (select temp___222 temp___223))))) (=> (<= 1 (to_rep1 content__last)) (dynamic_property3 1 (to_rep1 content__last) i2))) (and (<= 1 i2) (<= i2 (to_rep1 content__last)))) (= i2 (to_rep1 content__last))))))) (and (and (= i2 i6) (= content3 content7)) (and (= i7 i2) (= content8 content3))))))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 content__last))) (= (mk_int__ref i8) (mk_int__ref i6))))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 content__last))) (= (mk_map__ref content9) (mk_map__ref content7))))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 content__last))) (= i9 i7)))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 content__last))) (= content10 content8)))
(assert (=> (not (and (<= 1 i1) (<= i1 (to_rep1 content__last)))) (= i1 i8)))
(assert (=> (not (and (<= 1 i1) (<= i1 (to_rep1 content__last)))) (= (mk_map__ref content9) (mk_map__ref content))))
(assert (=> (not (and (<= 1 i1) (<= i1 (to_rep1 content__last)))) (= i9 i1)))
(assert (=> (not (and (<= 1 i1) (<= i1 (to_rep1 content__last)))) (= content10 content1)))
(assert (= i10 i8))
(assert (= (mk_map__ref content11) (mk_map__ref content9)))
(assert (= top1 top2))
(assert (= i11 i9))
(assert (= content12 content10))
(assert (= top3 top1))
