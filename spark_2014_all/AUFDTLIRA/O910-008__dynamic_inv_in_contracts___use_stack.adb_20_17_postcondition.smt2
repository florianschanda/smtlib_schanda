...
(declare-const temp___222 (Array Int positive))
...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 content__last))) (= temp___224 i1)))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 content__last))) (= temp___222 content)))
...
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 content__last))) (and (and (forall ((temp___223 Int)) (=> (and (<= (to_rep1 content__first) temp___223) (<= temp___223 (to_rep1 content__last))) (=> (< i2 temp___223) (= (select content3 temp___223) (select temp___222 temp___223))))) (=> (<= 1 (to_rep1 content__last)) (dynamic_property3 1 (to_rep1 content__last) i2))) (and (<= 1 i2) (<= i2 (to_rep1 content__last))))))
