...
(declare-const temp___252 (Array Int positive))
...
(declare-const content4 (Array Int positive))
(declare-const i3 Int)
(declare-const content5 (Array Int positive))
(declare-const i4 Int)
(declare-const content6 (Array Int positive))
(declare-const i5 Int)
(declare-const content7 (Array Int positive))
(declare-const i6 Int)
(declare-const top2 Int)
(declare-const content8 (Array Int positive))
(declare-const i7 Int)
(declare-const top3 Int)
(declare-const content9 (Array Int positive))
(declare-const i8 Int)
(define-fun content10 () map__ref (mk_map__ref content6))
...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 content__last))) (= temp___254 i1)))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 content__last))) (= temp___252 content)))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 content__last))) (= (to_rep o1) e)))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 content__last))) (= o2 (store content i1 o1))))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 content__last))) (= (mk_map__ref result2) content11)))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 content__last))) (= content2 o2)))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 content__last))) (forall ((j Int)) (=> (and (<= 1 j) (<= j i2)) (= (to_rep (select content3 j)) e)))))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 content__last))) (and (and (forall ((temp___253 Int)) (=> (and (<= (to_rep1 content__first) temp___253) (<= temp___253 (to_rep1 content__last))) (=> (< i2 temp___253) (= (select content3 temp___253) (select temp___252 temp___253))))) (=> (<= 1 (to_rep1 content__last)) (dynamic_property3 1 (to_rep1 content__last) i2))) (and (<= 1 i2) (<= i2 (to_rep1 content__last))))))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 content__last))) (= i2 (to_rep1 content__last))))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 content__last))) (= i2 i3)))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 content__last))) (= content3 content4)))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 content__last))) (= i4 i2)))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 content__last))) (= content5 content3)))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 content__last))) (= (mk_int__ref i5) (mk_int__ref i3))))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 content__last))) (= content10 (mk_map__ref content4))))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 content__last))) (= i6 i4)))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 content__last))) (= content7 content5)))
(assert (=> (not (and (<= 1 i1) (<= i1 (to_rep1 content__last)))) (= i1 i5)))
(assert (=> (not (and (<= 1 i1) (<= i1 (to_rep1 content__last)))) (= content10 content11)))
(assert (=> (not (and (<= 1 i1) (<= i1 (to_rep1 content__last)))) (= i6 i1)))
(assert (=> (not (and (<= 1 i1) (<= i1 (to_rep1 content__last)))) (= content7 content1)))
(assert (= i7 i5))
(assert (= (mk_map__ref content8) content10))
(assert (= top1 top2))
(assert (= i8 i6))
(assert (= content9 content7))
(assert (= top3 top1))
(assert (not (= (is_full top2) true)))
(check-sat)
(exit)
