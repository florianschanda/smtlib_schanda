...
(assert (and (= o21 (model__ (map__content data5) (int__content first_available5))) (= (model_is_well_formed o21 (map__content data5) (int__content first_available5)) true)))
(assert (= o22 (us_split_fields3 o21)))
(assert (= o23 (rec__list_mod_allocator__m__t__available o22)))
(assert (and (= result6 (is_prepend o23 (int__content res5) (rec__list_mod_allocator__m__t__available (us_split_fields3 (model__ data first_available))))) (= (= result6 true) (and (and (and (< (length o23) 2147483647) (= (length (rec__list_mod_allocator__m__t__available (us_split_fields3 (model__ data first_available)))) (+ (length o23) 1))) (= (get (rec__list_mod_allocator__m__t__available (us_split_fields3 (model__ data first_available))) 1) (int__content res5))) (= (range_shifted o23 (rec__list_mod_allocator__m__t__available (us_split_fields3 (model__ data first_available))) 1 (last o23) 1) true)))))
(assert (= result6 true))
