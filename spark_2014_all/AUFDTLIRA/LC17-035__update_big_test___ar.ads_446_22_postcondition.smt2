...
(declare-fun temp___1396 ((Array Int (Array Int (Array Int et1))) Int (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1))))
(assert (forall ((temp___1398 (Array Int (Array Int (Array Int et1))))) (forall ((temp___1399 Int)) (forall ((temp___1400 (Array Int (Array Int et1)))) (let ((temp___1397 (temp___1396 temp___1398 temp___1399 temp___1400))) (forall ((temp___1401 Int)) (ite (= temp___1401 temp___1399) (= (select temp___1397 temp___1401) temp___1400) (= (select temp___1397 temp___1401) (select temp___1398 temp___1401)))))))))
(declare-fun temp___1402 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
(assert (forall ((temp___1404 (Array Int (Array Int et1)))) (forall ((temp___1405 Int)) (forall ((temp___1406 (Array Int et1))) (let ((temp___1403 (temp___1402 temp___1404 temp___1405 temp___1406))) (forall ((temp___1407 Int)) (ite (= temp___1407 temp___1405) (= (select temp___1403 temp___1407) temp___1406) (= (select temp___1403 temp___1407) (select temp___1404 temp___1407)))))))))
...
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (bool_eq2 a2 1 16 (temp___1396 a i (temp___1402 (select a i) j b)) 1 16) true)))
(check-sat)
(exit)
