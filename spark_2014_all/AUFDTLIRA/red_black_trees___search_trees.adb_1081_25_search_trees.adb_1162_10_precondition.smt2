...
(assert (and (= o43 (model__ (mk___rep2 f_1__split_fields3) o42)) (and (dynamic_invariant6 o43 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o43 o42))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select o43 o42)))) 0) (and (forall ((i6 Int)) (=> (and (<= 1 i6) (<= i6 100)) (=> (not (= i6 o42)) (ite (and (not (= (parent (mk___rep2 f_1__split_fields3) i6) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select o43 (parent (mk___rep2 f_1__split_fields3) i6)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select o43 i6))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select o43 i6))) true)))))) (and (forall ((i6 Int)) (=> (and (<= 1 i6) (<= i6 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o43 i6))) true) (not (= i6 o42))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select o43 (parent (mk___rep2 f_1__split_fields3) i6)))) (position (mk___rep2 f_1__split_fields3) i6) (rec__tree_model__path_type__a (us_split_fields1 (select o43 i6)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select o43 i6)))) 0)))) (forall ((i6 Int)) (=> (and (<= 1 i6) (<= i6 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select o43 i6))) true) (forall ((j15 Int)) (=> (and (<= 1 j15) (<= j15 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o43 j15))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select o43 i6))) (rec__tree_model__path_type__a (us_split_fields1 (select o43 j15)))) true)) (= j15 i6))))))))))))))
(assert (and (= o40 (to_rep1 (rec__search_trees__search_tree__root t__split_fields11))) (in_range3 (to_rep1 (rec__search_trees__search_tree__root t__split_fields11)))))
(assert (not (= (valid_root (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) o40) true)))
(check-sat)
(exit)
