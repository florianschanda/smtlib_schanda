...
(declare-fun temp___654 (Int) (Array Int unsigned_byte))
...
(assert (forall ((temp___656 Int)) (=> (dynamic_invariant temp___656 true true true true) (forall ((temp___657 Int)) (= (to_rep (select (temp___654 temp___656) temp___657)) temp___656)))))
