...
(assert (and (and (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (dynamic_property9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) index3)) (forall ((temp___1521 Int)) (=> (and (<= (to_rep1 n__first) temp___1521) (<= temp___1521 (to_rep1 n__last))) (=> (< index3 temp___1521) (= (select n3 temp___1521) (select n1 temp___1521)))))) (and (<= (to_rep1 (first (rt source))) index3) (<= index3 (+ (to_rep1 (first (rt source))) 9)))))
(assert (not (= index3 temp___1523)))
(assert (= index3 result4))
(assert (= index4 (+ index3 1)))
(assert (and (<= (to_rep1 n__first) index4) (<= index4 (to_rep1 n__last))))
(assert (= o21 index4))
(assert (= o22 (select n3 o21)))
(assert (= o23 (to_rep1 o22)))
(assert (= o23 aida__conversion__convert_character_digit_to_integer__2__target1))
...
(assert (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target3) (<= aida__conversion__convert_character_digit_to_integer__2__target3 9)) (= aida__conversion__convert_character_digit_to_integer__2__target3 (convert_character_digit_to_integer o26))) (ite (= (= o26 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 0) (ite (= (= o26 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 1) (ite (= (= o26 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 2) (ite (= (= o26 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 3) (ite (= (= o26 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 4) (ite (= (= o26 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 5) (ite (= (= o26 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 6) (ite (= (= o26 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 7) (ite (= (= o26 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 8) (=> (= (= o26 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target3)))
(assert (= (to_rep1 o27) aida__conversion__convert_character_digit_to_integer__2__target3))
(assert (and (<= (to_rep1 n__first) index4) (<= index4 (to_rep1 n__last))))
(assert (= o28 index4))
(assert (= o29 (store n3 o28 o27)))
(assert (= result5 n3))
(assert (= n4 o29))
