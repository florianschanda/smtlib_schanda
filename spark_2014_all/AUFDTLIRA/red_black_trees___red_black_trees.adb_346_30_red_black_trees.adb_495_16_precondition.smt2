...
(declare-const temp___736 (Array Int us_rep7))
(declare-const o50 us_rep7)
(declare-const o51 us_split_fields10)
(declare-const o52 extended_index_type)
(declare-const o53 Int)
(declare-const temp___734 (Array Int us_rep7))
(declare-const o54 us_rep7)
(declare-const o55 us_split_fields10)
(declare-const o56 extended_index_type)
(declare-const temp___735 (Array Int us_rep7))
(declare-const o57 us_rep7)
(declare-const o58 us_split_fields10)
(declare-const o59 extended_index_type)
...
(assert (and (= temp___736 (nb_blacks c106b)) (and (= (bool_eq11 (select temp___736 0) (mk___rep5 (mk___split_fields5 (distinct 1 0) (of_rep 0) (of_rep 0)))) true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c106b))) i))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___736 i))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___736 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___736 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___736 i)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___736 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___736 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___736 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___736 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___736 i)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c106b)) i)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___736 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i 0))))))))))))))
(assert (= o50 (select temp___736 c108b)))
(assert (= o51 (us_split_fields11 o50)))
(assert (= o52 (rec__red_black_trees__black_count__depth o51)))
(assert (= o53 (to_rep o52)))
(assert (= result17 (ite (<= o53 (let ((subject n1)) n12)) true false)))
(assert (= result17 true))
(assert (and (= temp___735 (nb_blacks c107b)) (and (= (bool_eq11 (select temp___735 0) (mk___rep5 (mk___split_fields5 (distinct 1 0) (of_rep 0) (of_rep 0)))) true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c107b))) i))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___735 i))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___735 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___735 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___735 i)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___735 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___735 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___735 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___735 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___735 i)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c107b)) i)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___735 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 0))))))))))))))
(assert (= o57 (select temp___735 c108b)))
(assert (= o58 (us_split_fields11 o57)))
(assert (= o59 (rec__red_black_trees__black_count__count o58)))
(assert (= o60 (to_rep o59)))
(assert (= o61 (+ o60 1)))
(assert (and (= temp___734 (nb_blacks c107b)) (and (= (bool_eq11 (select temp___734 0) (mk___rep5 (mk___split_fields5 (distinct 1 0) (of_rep 0) (of_rep 0)))) true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c107b))) i))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___734 i))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___734 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___734 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___734 i)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___734 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___734 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___734 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___734 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___734 i)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c107b)) i)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___734 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 0))))))))))))))
(assert (= o54 (select temp___734 y3)))
(assert (= o55 (us_split_fields11 o54)))
(assert (= o56 (rec__red_black_trees__black_count__count o55)))
(assert (= o62 (to_rep o56)))
