...
(assert (<= (to_rep1 a__first) i4))
(assert (<= i4 (to_rep1 a__last)))
(assert (and (<= (to_rep1 a__first) i4) (<= i4 (to_rep1 a__last))))
(assert (= o39 i4))
(assert (= o40 (select a o39)))
(assert (= o41 (us_split_fields1 o40)))
(assert (= o42 (rec__frame_condition__cell__max_left o41)))
