...
(assert (and (= temp___592 (element (mk___rep d__split_discrs (mk___split_fields d__split_fields1)) (mk___rep1 (mk___split_fields1 c2)))) (and (in_range4 temp___592) (= temp___592 (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields1))) (key (mk___rep d__split_discrs (mk___split_fields d__split_fields1)) (mk___rep1 (mk___split_fields1 c2))))))))
(assert (not (<= (to_rep (first (rt a))) temp___592)))
(check-sat)
(exit)
