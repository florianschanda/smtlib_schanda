...
(assert (and (= o17 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (= o18 (ite (<= index1 o17) true false)))
(assert (and (= o16 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (= o19 (ite (<= o16 index1) true false)))
(assert (= result (ite (= o19 true) o18 false)))
(assert (= (= o20 true) (forall ((index11 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 4) index11) (<= index11 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index11))) true)))))
(assert (and (= temp___2050 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 (first (rt source))) temp___2050) (<= temp___2050 (to_rep1 (last (rt source))))))
(assert (= o12 temp___2050))
(assert (= o13 (select (elts source) o12)))
(assert (= o14 (to_rep o13)))
(assert (= o15 (ite (< o14 55) true false)))
(assert (and (= temp___2049 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 (first (rt source))) temp___2049) (<= temp___2049 (to_rep1 (last (rt source))))))
(assert (= o8 temp___2049))
(assert (= o9 (select (elts source) o8)))
(assert (= o10 (to_rep o9)))
(assert (= o11 (ite (= o10 52) true false)))
(assert (and (= temp___2048 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 (first (rt source))) temp___2048) (<= temp___2048 (to_rep1 (last (rt source))))))
(assert (= o4 temp___2048))
(assert (= o5 (select (elts source) o4)))
(assert (= o6 (to_rep o5)))
(assert (= o7 (ite (= o6 49) true false)))
