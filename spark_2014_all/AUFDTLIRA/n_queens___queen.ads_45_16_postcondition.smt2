...
(declare-const result8 (Array Int index))
(assert (in_range1 i))
...
(assert (= j12 (+ i 1)))
(assert (=> (and (<= (+ i 1) j12) (<= j12 8)) (and (and (= temp___183 j12) (and (= temp___181 r8) (and (forall ((k2 Int)) (=> (and (<= 1 k2) (<= k2 i)) (= (to_rep (select r10 k2)) (to_rep (select b k2))))) (and (and (and (forall ((temp___182 Int)) (=> (and (<= 1 temp___182) (<= temp___182 8)) (=> (<= j13 temp___182) (= (select r10 temp___182) (select temp___181 temp___182))))) (=> (<= (+ i 1) 8) (dynamic_property1 (+ i 1) 8 j13))) (and (<= (+ i 1) j13) (<= j13 8))) (and (and (and (= (to_rep o8) (to_rep (select c j13))) (= o9 (store r10 j13 o8))) (and (= r10 result5) (= r11 o9))) (= j13 8)))))) (and (and (= j19 (mk_int__ref j13)) (= r16 (mk_map__ref r11))) (and (= j20 j13) (= r17 r11))))))
(assert (=> (and (<= (+ i 1) j12) (<= j12 8)) (= j21 j19)))
(assert (=> (and (<= (+ i 1) j12) (<= j12 8)) (= r18 r16)))
(assert (=> (and (<= (+ i 1) j12) (<= j12 8)) (= j22 j20)))
(assert (=> (and (<= (+ i 1) j12) (<= j12 8)) (= r19 r17)))
(assert (=> (not (and (<= (+ i 1) j12) (<= j12 8))) (= j21 (mk_int__ref j12))))
(assert (=> (not (and (<= (+ i 1) j12) (<= j12 8))) (= r18 (mk_map__ref r8))))
(assert (=> (not (and (<= (+ i 1) j12) (<= j12 8))) (= j22 j12)))
(assert (=> (not (and (<= (+ i 1) j12) (<= j12 8))) (= r19 r9)))
...
(assert (= result7 (mk_map__ref queen__copy_until__result)))
(assert (= queen__copy_until__result1 (map__content r18)))
(assert (= queen__copy_until__result4 queen__copy_until__result2))
(assert (= j24 j21))
(assert (= j23 (mk_int__ref j10)))
(assert (= r20 r18))
(assert (= queen__copy_until__result5 queen__copy_until__result3))
(assert (= j26 j22))
(assert (= j25 j11))
(assert (= r21 r19))
(assert (= result8 (map__content queen__copy_until__result4)))
(declare-const j27 Int)
(assert (<= 1 j27))
(assert (<= j27 i))
(assert (not (= (to_rep (select (map__content queen__copy_until__result4) j27)) (to_rep (select b j27)))))
(check-sat)
(exit)
