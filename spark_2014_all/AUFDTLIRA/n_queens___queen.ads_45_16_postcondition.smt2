...
(assert (=> (and (<= (+ i 1) j8) (<= j8 8)) (and (and (forall ((temp___182 Int)) (=> (and (<= 1 temp___182) (<= temp___182 8)) (=> (<= j9 temp___182) (= (select r8 temp___182) (select temp___181 temp___182))))) (=> (<= (+ i 1) 8) (dynamic_property1 (+ i 1) 8 j9))) (and (<= (+ i 1) j9) (<= j9 8)))))
