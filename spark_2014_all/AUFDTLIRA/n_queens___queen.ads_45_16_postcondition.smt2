...
(declare-const temp___205 (Array Int index))
...
(assert (= j8 (+ i 1)))
(assert (=> (and (<= (+ i 1) j8) (<= j8 8)) (= temp___207 j8)))
(assert (=> (and (<= (+ i 1) j8) (<= j8 8)) (= temp___205 r6)))
(assert (=> (and (<= (+ i 1) j8) (<= j8 8)) (forall ((k Int)) (=> (and (<= 1 k) (<= k i)) (= (to_rep (select r8 k)) (to_rep (select b k)))))))
(assert (=> (and (<= (+ i 1) j8) (<= j8 8)) (and (and (forall ((temp___206 Int)) (=> (and (<= 1 temp___206) (<= temp___206 8)) (=> (<= j9 temp___206) (= (select r8 temp___206) (select temp___205 temp___206))))) (=> (<= (+ i 1) 8) (dynamic_property1 (+ i 1) 8 j9))) (and (<= (+ i 1) j9) (<= j9 8)))))
