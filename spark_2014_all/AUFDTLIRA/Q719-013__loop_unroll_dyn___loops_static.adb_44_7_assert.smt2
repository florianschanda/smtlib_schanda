...
(assert (not (not (and (and (= (mk_int__ref result) (mk_int__ref i)) (= i1 1)) (and (and (and (= (to_rep o) 0) (and (and (and (<= (to_rep1 a__first) i1) (<= i1 (to_rep1 a__last))) (= o1 i1)) (= o2 (store a o1 o)))) (and (= (mk_map__ref result1) (mk_map__ref a)) (= a1 o2))) (and (and (and (and (and (and (and (= o3 (- i1 (to_rep1 a__first))) (in_range1 (- i1 (to_rep1 a__first)))) (= o4 (+ o3 1))) (and (= o5 o4) (in_range1 o4))) (and (= o6 o5) (in_range2 o5))) (and (= (mk_int__ref result2) (mk_int__ref a_length)) (= a_length1 o6))) (in_range2 a_length1)) (and (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 a_length1)) (= (to_rep (select a1 (+ (to_rep1 a__first) i3))) 0))) (and (and (= i1 result3) (= i2 2)) (and (and (and (= (to_rep o7) 0) (and (and (and (<= (to_rep1 a__first) i2) (<= i2 (to_rep1 a__last))) (= o8 i2)) (= o9 (store a1 o8 o7)))) (and (= a1 result4) (= a2 o9))) (and (and (and (and (and (and (and (= o10 (- i2 (to_rep1 a__first))) (in_range1 (- i2 (to_rep1 a__first)))) (= o11 (+ o10 1))) (and (= o12 o11) (in_range1 o11))) (and (= o13 o12) (in_range2 o12))) (and (= a_length1 result5) (= a_length2 o13))) (in_range2 a_length2)) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 a_length2)) (= (to_rep (select a2 (+ (to_rep1 a__first) i3))) 0)))))))))))))
(check-sat)
(exit)
