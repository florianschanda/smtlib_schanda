...
(assert (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 a_length1)) (= (to_rep (select a1 (+ (to_rep1 a__first) i5))) 0))))
(assert (= i3 result3))
(assert (= i4 2))
(assert (= (to_rep o7) 0))
...
(assert (= a1 result4))
(assert (= a2 o9))
(assert (and (= o10 (- i4 (to_rep1 a__first))) (in_range1 (- i4 (to_rep1 a__first)))))
(assert (= o11 (+ o10 1)))
(assert (and (= o12 o11) (in_range1 o11)))
(assert (and (= o13 o12) (in_range2 o12)))
(assert (= a_length1 result5))
(assert (= a_length2 o13))
(assert (in_range2 a_length2))
(assert (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 a_length2)) (= (to_rep (select a2 (+ (to_rep1 a__first) i5))) 0))))
(assert (not false))
(check-sat)
(exit)
