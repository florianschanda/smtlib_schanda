...
(assert (= (= o37 true) (forall ((z1 Int)) (=> (and (<= (to_rep1 values__first) z1) (<= z1 (to_rep1 values__last))) (=> (and (not (= z1 x)) (not (= z1 y))) (= (to_rep (select values3 z1)) (to_rep (select values z1))))))))
(assert (and (<= (to_rep1 values__first) x) (<= x (to_rep1 values__last))))
(assert (= o29 x))
(assert (= o30 (select values o29)))
(assert (= o31 (to_rep o30)))
(assert (and (<= (to_rep1 values__first) y) (<= y (to_rep1 values__last))))
(assert (= o27 y))
(assert (= o28 (select values3 o27)))
(assert (= o32 (to_rep o28)))
(assert (= o33 (ite (= o32 o31) true false)))
(assert (and (<= (to_rep1 values__first) y) (<= y (to_rep1 values__last))))
(assert (= o24 y))
(assert (= o25 (select values o24)))
