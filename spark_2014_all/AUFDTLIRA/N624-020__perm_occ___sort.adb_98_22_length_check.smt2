...
(assert (not (= (ite (<= (to_rep1 (first2 temp___2401)) (to_rep1 (last2 temp___2401))) (+ (- (to_rep1 (last2 temp___2401)) (to_rep1 (first2 temp___2401))) 1) 0) (ite (<= (to_rep1 previous__first) (to_rep1 previous__last)) (+ (- (to_rep1 previous__last) (to_rep1 previous__first)) 1) 0))))
(check-sat)
(exit)
