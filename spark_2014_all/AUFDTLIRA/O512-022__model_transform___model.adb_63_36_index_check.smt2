...
(declare-const t Int)
(declare-const temp___477 (Array Int us_rep))
(declare-const o Int)
...
(assert (and (= temp___477 (owned_state sm)) (= temp___477 (rec__model__uml_state_machine__owned_state_data (us_split_fields5 sm)))))
(assert (not (<= 0 t)))
(check-sat)
(exit)
