...
(assert (<= 0 t))
(assert (<= t (- s3 1)))
(assert (and (= o t) (in_range4 t)))
(assert (= (mk___rep3 (mk___split_fields3 o1)) (select av2 o)))
(assert (and (= o2 (name__2 (mk___rep3 (mk___split_fields3 o1)))) (and (in_range1 o2) (= o2 (to_rep o1)))))
(assert (and (= temp___438 (owned_state sm)) (= temp___438 (rec__model__uml_state_machine__owned_state_data (us_split_fields5 sm)))))
(assert (not (<= 0 t)))
(check-sat)
(exit)
