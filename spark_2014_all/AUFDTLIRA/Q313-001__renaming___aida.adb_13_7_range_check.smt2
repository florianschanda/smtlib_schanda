...
(define-fun dynamic_invariant3 ((temp___expr_180 us_t1) (temp___is_init_176 Bool) (temp___skip_constant_177 Bool) (temp___do_toplevel_178 Bool) (temp___do_typ_inv_179 Bool)) Bool (=> (not (= temp___skip_constant_177 true)) (and (dynamic_property2 1 (length value) (first3 temp___expr_180) (last3 temp___expr_180)) (and (= (first3 temp___expr_180) 1) (= (last3 temp___expr_180) (length value))))))
