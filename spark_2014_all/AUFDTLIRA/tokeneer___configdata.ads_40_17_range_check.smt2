...
(define-fun dynamic_invariant ((temp___expr_382 us_t1) (temp___is_init_378 Bool) (temp___skip_constant_379 Bool) (temp___do_toplevel_380 Bool) (temp___do_typ_inv_381 Bool)) Bool (and (=> (not (= temp___skip_constant_379 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_382) (last3 temp___expr_382))) (=> (= temp___do_toplevel_380 true) (=> (= temp___is_init_378 true) (and (let ((temp___384 (of_array3 (to_array1 temp___expr_382) (first3 temp___expr_382) (last3 temp___expr_382)))) (and (let ((temp___385 (of_array2 (to_array3 temp___384) (first7 temp___384) (last7 temp___384)))) (and (= (first5 temp___385) 1) (<= 0 (last5 temp___385)))) (<= (last7 temp___384) 1000))) (<= 3 (length1 temp___expr_382)))))))
...
(define-fun dynamic_invariant1 ((temp___expr_1159 Int) (temp___is_init_1155 Bool) (temp___skip_constant_1156 Bool) (temp___do_toplevel_1157 Bool) (temp___do_typ_inv_1158 Bool)) Bool (=> (or (= temp___is_init_1155 true) (<= 0 2000)) (in_range3 temp___expr_1159)))
(declare-const x Int)
...
(define-fun dynamic_invariant7 ((temp___expr_354 us_t3) (temp___is_init_350 Bool) (temp___skip_constant_351 Bool) (temp___do_toplevel_352 Bool) (temp___do_typ_inv_353 Bool)) Bool (and (=> (not (= temp___skip_constant_351 true)) (dynamic_property3 1 2147483647 (first7 temp___expr_354) (last7 temp___expr_354))) (=> (= temp___do_toplevel_352 true) (=> (= temp___is_init_350 true) (and (let ((temp___356 (of_array2 (to_array3 temp___expr_354) (first7 temp___expr_354) (last7 temp___expr_354)))) (and (= (first5 temp___356) 1) (<= 0 (last5 temp___356)))) (<= (last7 temp___expr_354) 1000))))))
(define-fun dynamic_predicate2 ((temp___358 us_t3)) Bool (and (let ((temp___360 (of_array2 (to_array3 temp___358) (first7 temp___358) (last7 temp___358)))) (and (= (first5 temp___360) 1) (<= 0 (last5 temp___360)))) (<= (last7 temp___358) 1000)))
(assert (in_range3 x))
