...
(define-fun dynamic_invariant ((temp___expr_382 us_t1) (temp___is_init_378 Bool) (temp___skip_constant_379 Bool) (temp___do_toplevel_380 Bool) (temp___do_typ_inv_381 Bool)) Bool (and (=> (not (= temp___skip_constant_379 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_382) (last3 temp___expr_382))) (=> (= temp___do_toplevel_380 true) (=> (= temp___is_init_378 true) (and (let ((temp___384 (of_array2 (to_array1 temp___expr_382) (first3 temp___expr_382) (last3 temp___expr_382)))) (and (let ((temp___385 (of_array3 (to_array2 temp___384) (first5 temp___384) (last5 temp___384)))) (and (= (first7 temp___385) 1) (<= 0 (last7 temp___385)))) (<= (last5 temp___384) 1000))) (<= 3 (length1 temp___expr_382)))))))
(define-fun dynamic_predicate ((temp___387 us_t1)) Bool (and (let ((temp___389 (of_array2 (to_array1 temp___387) (first3 temp___387) (last3 temp___387)))) (and (let ((temp___390 (of_array3 (to_array2 temp___389) (first5 temp___389) (last5 temp___389)))) (and (= (first7 temp___390) 1) (<= 0 (last7 temp___390)))) (<= (last5 temp___389) 1000))) (<= 3 (length1 temp___387))))
...
(define-fun dynamic_invariant1 ((temp___expr_1152 Int) (temp___is_init_1148 Bool) (temp___skip_constant_1149 Bool) (temp___do_toplevel_1150 Bool) (temp___do_typ_inv_1151 Bool)) Bool (=> (or (= temp___is_init_1148 true) (<= 0 2000)) (in_range3 temp___expr_1152)))
(declare-const x Int)
...
(define-fun dynamic_invariant6 ((temp___expr_317 us_t3) (temp___is_init_313 Bool) (temp___skip_constant_314 Bool) (temp___do_toplevel_315 Bool) (temp___do_typ_inv_316 Bool)) Bool (and (=> (not (= temp___skip_constant_314 true)) (dynamic_property3 1 2147483647 (first7 temp___expr_317) (last7 temp___expr_317))) (=> (= temp___do_toplevel_315 true) (=> (= temp___is_init_313 true) (and (= (first7 temp___expr_317) 1) (<= 0 (last7 temp___expr_317)))))))
(define-fun dynamic_predicate1 ((temp___320 us_t3)) Bool (and (= (first7 temp___320) 1) (<= 0 (last7 temp___320))))
(define-fun dynamic_invariant7 ((temp___expr_354 us_t2) (temp___is_init_350 Bool) (temp___skip_constant_351 Bool) (temp___do_toplevel_352 Bool) (temp___do_typ_inv_353 Bool)) Bool (and (=> (not (= temp___skip_constant_351 true)) (dynamic_property2 1 2147483647 (first5 temp___expr_354) (last5 temp___expr_354))) (=> (= temp___do_toplevel_352 true) (=> (= temp___is_init_350 true) (and (let ((temp___356 (of_array3 (to_array2 temp___expr_354) (first5 temp___expr_354) (last5 temp___expr_354)))) (and (= (first7 temp___356) 1) (<= 0 (last7 temp___356)))) (<= (last5 temp___expr_354) 1000))))))
(define-fun dynamic_predicate2 ((temp___358 us_t2)) Bool (and (let ((temp___360 (of_array3 (to_array2 temp___358) (first5 temp___358) (last5 temp___358)))) (and (= (first7 temp___360) 1) (<= 0 (last7 temp___360)))) (<= (last5 temp___358) 1000)))
(assert (in_range3 x))
