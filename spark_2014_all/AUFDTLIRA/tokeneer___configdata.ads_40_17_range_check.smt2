...
(define-fun dynamic_invariant ((temp___expr_341 us_t1) (temp___is_init_338 Bool) (temp___skip_constant_339 Bool) (temp___do_toplevel_340 Bool)) Bool (and (=> (not (= temp___skip_constant_339 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_341) (last3 temp___expr_341))) (=> (= temp___do_toplevel_340 true) (=> (= temp___is_init_338 true) (and (let ((temp___343 (of_array3 (to_array1 temp___expr_341) (first3 temp___expr_341) (last3 temp___expr_341)))) (and (let ((temp___344 (of_array2 (to_array3 temp___343) (first7 temp___343) (last7 temp___343)))) (and (= (first5 temp___344) 1) (<= 0 (last5 temp___344)))) (<= (last7 temp___343) 1000))) (<= 3 (length1 temp___expr_341)))))))
(define-fun dynamic_predicate ((temp___346 us_t1)) Bool (and (let ((temp___348 (of_array3 (to_array1 temp___346) (first3 temp___346) (last3 temp___346)))) (and (let ((temp___349 (of_array2 (to_array3 temp___348) (first7 temp___348) (last7 temp___348)))) (and (= (first5 temp___349) 1) (<= 0 (last5 temp___349)))) (<= (last7 temp___348) 1000))) (<= 3 (length1 temp___346))))
...
(define-fun dynamic_invariant1 ((temp___expr_1030 Int) (temp___is_init_1027 Bool) (temp___skip_constant_1028 Bool) (temp___do_toplevel_1029 Bool)) Bool (=> (or (= temp___is_init_1027 true) (<= 0 2000)) (in_range3 temp___expr_1030)))
(declare-const x Int)
...
(define-fun dynamic_invariant6 ((temp___expr_281 us_t2) (temp___is_init_278 Bool) (temp___skip_constant_279 Bool) (temp___do_toplevel_280 Bool)) Bool (and (=> (not (= temp___skip_constant_279 true)) (dynamic_property2 1 2147483647 (first5 temp___expr_281) (last5 temp___expr_281))) (=> (= temp___do_toplevel_280 true) (=> (= temp___is_init_278 true) (and (= (first5 temp___expr_281) 1) (<= 0 (last5 temp___expr_281)))))))
(define-fun dynamic_predicate1 ((temp___284 us_t2)) Bool (and (= (first5 temp___284) 1) (<= 0 (last5 temp___284))))
(define-fun dynamic_invariant7 ((temp___expr_315 us_t3) (temp___is_init_312 Bool) (temp___skip_constant_313 Bool) (temp___do_toplevel_314 Bool)) Bool (and (=> (not (= temp___skip_constant_313 true)) (dynamic_property3 1 2147483647 (first7 temp___expr_315) (last7 temp___expr_315))) (=> (= temp___do_toplevel_314 true) (=> (= temp___is_init_312 true) (and (let ((temp___317 (of_array2 (to_array3 temp___expr_315) (first7 temp___expr_315) (last7 temp___expr_315)))) (and (= (first5 temp___317) 1) (<= 0 (last5 temp___317)))) (<= (last7 temp___expr_315) 1000))))))
(define-fun dynamic_predicate2 ((temp___319 us_t3)) Bool (and (let ((temp___321 (of_array2 (to_array3 temp___319) (first7 temp___319) (last7 temp___319)))) (and (= (first5 temp___321) 1) (<= 0 (last5 temp___321)))) (<= (last7 temp___319) 1000)))
(declare-const temp___1338 (Array Int character))
(declare-const temp___13381 t1)
(assert (in_range3 x))
