...
(assert (forall ((v us_rep)) (! (dynamic_invariant2 (to_string1 v) true false true) :pattern ((to_string1 v)))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_179 us_void_param) 1)) 80) (= (to_rep (select (temp___String_Literal_179 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_179 us_void_param) 3)) 112)) (= (to_rep (select (temp___String_Literal_179 us_void_param) 4)) 112)) (= (to_rep (select (temp___String_Literal_179 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_179 us_void_param) 6)) 110)) (= (to_rep (select (temp___String_Literal_179 us_void_param) 7)) 103)) (= (to_rep (select (temp___String_Literal_179 us_void_param) 8)) 32)) (= (to_rep (select (temp___String_Literal_179 us_void_param) 9)) 60)) (= (to_rep (select (temp___String_Literal_179 us_void_param) 10)) 45)) (= (to_rep (select (temp___String_Literal_179 us_void_param) 11)) 32)) :pattern ((temp___String_Literal_179 us_void_param)))))
