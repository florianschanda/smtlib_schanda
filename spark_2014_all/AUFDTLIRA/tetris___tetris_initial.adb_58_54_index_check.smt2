...
(assert (<= 0 x1))
(assert (<= x1 2))
(assert (and (forall ((temp___772 Int)) (=> (and (<= 1 temp___772) (<= temp___772 50)) (=> (not (= (+ (to_rep3 cur_piece__split_fields1) y2) temp___772)) (= (select cur_board1 temp___772) (select cur_board temp___772))))) (and (<= 0 x2) (<= x2 2))))
