...
(assert (= hr14 o117))
(assert (not (= (let ((temp___223 (remove (remove (mk___t interm1 (mk 1 100)) y) x))) (let ((temp___222 (remove (remove (mk___t interm1 (mk 1 100)) x) (- y 1)))) (bool_eq (elts temp___222) (to_rep1 (first (rt temp___222))) (to_rep1 (last (rt temp___222))) (elts temp___223) (to_rep1 (first (rt temp___223))) (to_rep1 (last (rt temp___223)))))) true)))
(check-sat)
(exit)
