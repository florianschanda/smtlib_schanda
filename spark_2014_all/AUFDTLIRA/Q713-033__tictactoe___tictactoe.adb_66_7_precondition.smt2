...
(assert (not (= (to_rep2 (select (select my_board (to_rep3 (rec__tictactoe__position__x (us_split_fields__content p__split_fields17)))) (to_rep3 (rec__tictactoe__position__y (us_split_fields__content p__split_fields17))))) 0)))
(check-sat)
(exit)
