...
(declare-const unconstr__equality__result Bool)
(declare-const result Bool)
(declare-const unconstr__equality__result1 Bool)
(declare-const unconstr__equality__result2 Bool)
(declare-const unconstr__equality__result3 Bool)
(declare-const unconstr__equality__result4 Bool)
(declare-const unconstr__equality__result5 Bool)
(declare-const result1 Bool)
(assert (dynamic_invariant s1 true false true))
(assert (dynamic_invariant s2 true false true))
(assert (= unconstr__equality__result1 unconstr__equality__result2))
(assert (= unconstr__equality__result3 unconstr__equality__result1))
(assert (= result unconstr__equality__result))
(assert (= unconstr__equality__result1 (bool_eq (elts s1) (to_rep1 (first (rt s1))) (to_rep1 (last (rt s1))) (elts s2) (to_rep1 (first (rt s2))) (to_rep1 (last (rt s2))))))
(assert (= (mk_bool__ref unconstr__equality__result4) (mk_bool__ref unconstr__equality__result2)))
(assert (= unconstr__equality__result5 unconstr__equality__result3))
(assert (= result1 unconstr__equality__result4))
(assert (= unconstr__equality__result4 true))
(assert (not (= (bool_eq (elts s1) (to_rep1 (first (rt s1))) (to_rep1 (last (rt s1))) (elts s2) (to_rep1 (first (rt s2))) (to_rep1 (last (rt s2)))) true)))
(check-sat)
(exit)
