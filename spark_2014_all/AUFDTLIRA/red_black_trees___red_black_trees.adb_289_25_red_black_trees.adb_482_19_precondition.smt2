...
(declare-const temp___694 (Array Int us_rep1))
...
(assert (<= 1 i))
(assert (<= i 100))
(assert (and (= temp___694 (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)))) (and (dynamic_invariant5 temp___694 true false true true) (= temp___694 (model__1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)))) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 c100b))))))))))
(assert (= o32 (select temp___694 i)))
(assert (= o33 (us_split_fields1 o32)))
(assert (= result14 (rec__tree_model__path_type__k o33)))
(assert (=> (= result14 true) (and (= temp___695 (nb_blacks c100b)) (and (= (bool_eq11 (select temp___695 0) (mk___rep5 (mk___split_fields5 (distinct 1 0) (of_rep 0) (of_rep 0)))) true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c100b))) i1))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___695 i1))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___695 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i1 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___695 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i1 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___695 i1)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___695 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i1 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___695 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i1 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___695 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i1 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___695 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i1 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___695 i1)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c100b)) i1)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___695 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i1 0)))))))))))))))
(assert (=> (= result14 true) (= o28 (select temp___695 i))))
...
(assert (and (= temp___693 (nb_blacks c100b)) (and (= (bool_eq11 (select temp___693 0) (mk___rep5 (mk___split_fields5 (distinct 1 0) (of_rep 0) (of_rep 0)))) true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c100b))) i1))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___693 i1))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___693 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i1 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___693 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i1 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___693 i1)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___693 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i1 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___693 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i1 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___693 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i1 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___693 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i1 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___693 i1)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c100b)) i1)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___693 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i1 0))))))))))))))
(assert (= o35 (select temp___693 i)))
