...
(assert (<= 1 n5))
(assert (<= n5 100))
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c100b))) i1))) true) (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c100b) i1)))) n6)) (not (= i1 y2))) (= (eq (select (nb_blacks c101b) i1) (select (nb_blacks c100b) i1)) true)))))
...
(assert (= o32 (select temp___645 i)))
(assert (= o33 (us_split_fields1 o32)))
(assert (= result14 (rec__tree_model__path_type__k o33)))
(assert (=> (= result14 true) (and (= temp___646 (nb_blacks c100b)) (and (= (bool_eq11 (select temp___646 0) (mk___rep5 (mk___split_fields5 (of_int 1) (of_rep 0) (of_rep 0)))) true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c100b))) i1))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___646 i1))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___646 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i1 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___646 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i1 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___646 i1)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___646 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i1 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___646 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i1 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___646 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i1 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___646 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i1 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___646 i1)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c100b)) i1)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___646 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i1 0)))))))))))))))
(assert (=> (= result14 true) (= o28 (select temp___646 i))))
...
(assert (= result13 (ite (and (= o34 true) (not (= i y2))) true false)))
(assert (= result13 true))
(assert (and (= temp___644 (nb_blacks c100b)) (and (= (bool_eq11 (select temp___644 0) (mk___rep5 (mk___split_fields5 (of_int 1) (of_rep 0) (of_rep 0)))) true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c100b))) i1))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___644 i1))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___644 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i1 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___644 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i1 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___644 i1)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___644 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i1 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___644 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i1 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___644 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i1 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___644 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i1 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___644 i1)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c100b)) i1)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___644 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i1 0))))))))))))))
(assert (= o35 (select temp___644 i)))
