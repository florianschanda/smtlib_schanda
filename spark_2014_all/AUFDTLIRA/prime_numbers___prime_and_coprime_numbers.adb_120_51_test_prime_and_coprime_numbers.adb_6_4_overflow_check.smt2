...
(assert (=> (not (= right_is_out1 true)) (and (<= 0 right2) (<= right2 100000))))
(assert (=> (not (= right_is_out1 true)) (= o3 right2)))
(assert (=> (not (= right_is_out1 true)) (= result5 (select number_list o3))))
(assert (not (= result5 true)))
(assert (and (<= (+ value 1) right3) (<= right3 100000)))
(assert (forall ((v Int)) (=> (and (<= value v) (<= v right3)) (not (= (select number_list v) true)))))
