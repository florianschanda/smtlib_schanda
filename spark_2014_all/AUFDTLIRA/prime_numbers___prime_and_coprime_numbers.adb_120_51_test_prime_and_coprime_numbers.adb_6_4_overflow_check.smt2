...
(assert (= right2 o2))
(assert (= (mk_bool__ref result5) (mk_bool__ref right_is_out)))
(assert (= right_is_out2 (ite (< 100000 right2) true false)))
(assert (=> (= right_is_out2 true) (= result6 true)))
(assert (=> (not (= right_is_out2 true)) (and (<= 0 right2) (<= right2 100000))))
(assert (=> (not (= right_is_out2 true)) (= o3 right2)))
(assert (=> (not (= right_is_out2 true)) (= result6 (select number_list o3))))
(assert (not (= result6 true)))
(assert (and (<= (+ value 1) right3) (<= right3 100000)))
(assert (forall ((v6 Int)) (=> (and (<= value v6) (<= v6 right3)) (not (= (select number_list v6) true)))))
(assert (=> (<= (- 2147483648) 2147483647) (in_range1 right3)))
(assert (not (in_range1 (+ value 1))))
(check-sat)
(exit)
