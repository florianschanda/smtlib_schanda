...
(define-fun dynamic_invariant ((temp___expr_211 (Array Int integer)) (temp___is_init_208 Bool) (temp___skip_constant_209 Bool) (temp___do_toplevel_210 Bool)) Bool (=> (= temp___do_toplevel_210 true) (=> (= temp___is_init_208 true) (forall ((k Int)) (=> (and (<= 1 k) (<= k 10)) (not (= (to_rep (select temp___expr_211 k)) 0)))))))
(define-fun default_initial_assumption ((temp___expr_214 (Array Int integer)) (temp___skip_top_level_215 Bool)) Bool (forall ((temp___216 Int)) (=> (and (<= 1 temp___216) (<= temp___216 10)) (= (to_rep (select temp___expr_214 temp___216)) 1))))
(define-fun dynamic_predicate ((temp___217 (Array Int integer))) Bool (forall ((k Int)) (=> (and (<= 1 k) (<= k 10)) (not (= (to_rep (select temp___217 k)) 0)))))
...
(assert (not (dynamic_predicate temp___346)))
(check-sat)
(exit)
