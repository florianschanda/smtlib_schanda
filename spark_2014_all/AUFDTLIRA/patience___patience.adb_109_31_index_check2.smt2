...
(declare-const temp___722 (Array Int cardindex))
...
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o116 i1))
(assert (= temp___724 (select (rec__patience__state__stacks (us_split_fields__content s__split_fields20)) o116)))
(assert (and (<= 0 k) (<= k 99)))
(assert (= o117 k))
(assert (= o118 (select temp___724 o117)))
(assert (= o119 (to_rep o118)))
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o115 i1))
(assert (= temp___722 (select (rec__patience__state__stacks (us_split_fields__content s__split_fields20)) o115)))
(assert (not (<= 0 j)))
(check-sat)
(exit)
