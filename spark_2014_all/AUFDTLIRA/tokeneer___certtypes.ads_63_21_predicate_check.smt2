...
(define-fun dynamic_invariant ((temp___expr_281 us_t1) (temp___is_init_278 Bool) (temp___skip_constant_279 Bool) (temp___do_toplevel_280 Bool)) Bool (and (=> (not (= temp___skip_constant_279 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_281) (last3 temp___expr_281))) (=> (= temp___do_toplevel_280 true) (=> (= temp___is_init_278 true) (and (let ((temp___283 (of_array3 (to_array1 temp___expr_281) (first3 temp___expr_281) (last3 temp___expr_281)))) (and (let ((temp___284 (of_array2 (to_array3 temp___283) (first7 temp___283) (last7 temp___283)))) (and (= (first5 temp___284) 1) (<= 0 (last5 temp___284)))) (<= (last7 temp___283) 1000))) (<= 2 (length1 temp___expr_281)))))))
(define-fun dynamic_predicate ((temp___286 us_t1)) Bool (and (let ((temp___288 (of_array3 (to_array1 temp___286) (first3 temp___286) (last3 temp___286)))) (and (let ((temp___289 (of_array2 (to_array3 temp___288) (first7 temp___288) (last7 temp___288)))) (and (= (first5 temp___289) 1) (<= 0 (last5 temp___289)))) (<= (last7 temp___288) 1000))) (<= 2 (length1 temp___286))))
...
(define-fun dynamic_invariant1 ((temp___expr_465 Int) (temp___is_init_462 Bool) (temp___skip_constant_463 Bool) (temp___do_toplevel_464 Bool)) Bool (=> (or (= temp___is_init_462 true) (<= 0 4294967295)) (in_range3 temp___expr_465)))
(declare-const x Int)
...
(define-fun dynamic_invariant6 ((temp___expr_235 us_t2) (temp___is_init_232 Bool) (temp___skip_constant_233 Bool) (temp___do_toplevel_234 Bool)) Bool (and (=> (not (= temp___skip_constant_233 true)) (dynamic_property2 1 2147483647 (first5 temp___expr_235) (last5 temp___expr_235))) (=> (= temp___do_toplevel_234 true) (=> (= temp___is_init_232 true) (and (= (first5 temp___expr_235) 1) (<= 0 (last5 temp___expr_235)))))))
(define-fun dynamic_predicate1 ((temp___238 us_t2)) Bool (and (= (first5 temp___238) 1) (<= 0 (last5 temp___238))))
(define-fun dynamic_invariant7 ((temp___expr_269 us_t3) (temp___is_init_266 Bool) (temp___skip_constant_267 Bool) (temp___do_toplevel_268 Bool)) Bool (and (=> (not (= temp___skip_constant_267 true)) (dynamic_property3 1 2147483647 (first7 temp___expr_269) (last7 temp___expr_269))) (=> (= temp___do_toplevel_268 true) (=> (= temp___is_init_266 true) (and (let ((temp___271 (of_array2 (to_array3 temp___expr_269) (first7 temp___expr_269) (last7 temp___expr_269)))) (and (= (first5 temp___271) 1) (<= 0 (last5 temp___271)))) (<= (last7 temp___expr_269) 1000))))))
(define-fun dynamic_predicate2 ((temp___273 us_t3)) Bool (and (let ((temp___275 (of_array2 (to_array3 temp___273) (first7 temp___273) (last7 temp___273)))) (and (= (first5 temp___275) 1) (<= 0 (last5 temp___275)))) (<= (last7 temp___273) 1000)))
(declare-const temp___488 (Array Int character))
(declare-const temp___4881 t1)
(assert (in_range3 x))
...
(assert (= (elts (to_string (attr__ATTRIBUTE_IMAGE3 x))) temp___488))
(assert (= (mk1 (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 x))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 x)))))) temp___4881))
(assert (not (dynamic_predicate (mk___t1 temp___488 temp___4881))))
(check-sat)
(exit)
