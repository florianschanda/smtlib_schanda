...
(define-fun dynamic_invariant ((temp___expr_321 us_t1) (temp___is_init_317 Bool) (temp___skip_constant_318 Bool) (temp___do_toplevel_319 Bool) (temp___do_typ_inv_320 Bool)) Bool (and (=> (not (= temp___skip_constant_318 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_321) (last3 temp___expr_321))) (=> (= temp___do_toplevel_319 true) (=> (= temp___is_init_317 true) (and (let ((temp___323 (of_array2 (to_array1 temp___expr_321) (first3 temp___expr_321) (last3 temp___expr_321)))) (and (let ((temp___324 (of_array3 (to_array2 temp___323) (first5 temp___323) (last5 temp___323)))) (and (= (first7 temp___324) 1) (<= 0 (last7 temp___324)))) (<= (last5 temp___323) 1000))) (<= 2 (length1 temp___expr_321)))))))
(define-fun dynamic_predicate ((temp___326 us_t1)) Bool (and (let ((temp___328 (of_array2 (to_array1 temp___326) (first3 temp___326) (last3 temp___326)))) (and (let ((temp___329 (of_array3 (to_array2 temp___328) (first5 temp___328) (last5 temp___328)))) (and (= (first7 temp___329) 1) (<= 0 (last7 temp___329)))) (<= (last5 temp___328) 1000))) (<= 2 (length1 temp___326))))
...
(define-fun dynamic_invariant1 ((temp___expr_525 Int) (temp___is_init_521 Bool) (temp___skip_constant_522 Bool) (temp___do_toplevel_523 Bool) (temp___do_typ_inv_524 Bool)) Bool (=> (or (= temp___is_init_521 true) (<= 0 4294967295)) (in_range3 temp___expr_525)))
(declare-const x Int)
...
(define-fun dynamic_invariant6 ((temp___expr_271 us_t3) (temp___is_init_267 Bool) (temp___skip_constant_268 Bool) (temp___do_toplevel_269 Bool) (temp___do_typ_inv_270 Bool)) Bool (and (=> (not (= temp___skip_constant_268 true)) (dynamic_property3 1 2147483647 (first7 temp___expr_271) (last7 temp___expr_271))) (=> (= temp___do_toplevel_269 true) (=> (= temp___is_init_267 true) (and (= (first7 temp___expr_271) 1) (<= 0 (last7 temp___expr_271)))))))
(define-fun dynamic_predicate1 ((temp___274 us_t3)) Bool (and (= (first7 temp___274) 1) (<= 0 (last7 temp___274))))
(define-fun dynamic_invariant7 ((temp___expr_308 us_t2) (temp___is_init_304 Bool) (temp___skip_constant_305 Bool) (temp___do_toplevel_306 Bool) (temp___do_typ_inv_307 Bool)) Bool (and (=> (not (= temp___skip_constant_305 true)) (dynamic_property2 1 2147483647 (first5 temp___expr_308) (last5 temp___expr_308))) (=> (= temp___do_toplevel_306 true) (=> (= temp___is_init_304 true) (and (let ((temp___310 (of_array3 (to_array2 temp___expr_308) (first5 temp___expr_308) (last5 temp___expr_308)))) (and (= (first7 temp___310) 1) (<= 0 (last7 temp___310)))) (<= (last5 temp___expr_308) 1000))))))
(define-fun dynamic_predicate2 ((temp___312 us_t2)) Bool (and (let ((temp___314 (of_array3 (to_array2 temp___312) (first5 temp___312) (last5 temp___312)))) (and (= (first7 temp___314) 1) (<= 0 (last7 temp___314)))) (<= (last5 temp___312) 1000)))
(declare-const temp___549 (Array Int character))
(declare-const temp___5491 t1)
(assert (in_range3 x))
...
(assert (= (elts (to_string (attr__ATTRIBUTE_IMAGE3 x))) temp___549))
(assert (= (mk1 (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 x))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 x)))))) temp___5491))
(assert (not (dynamic_predicate (mk___t1 temp___549 temp___5491))))
(check-sat)
(exit)
