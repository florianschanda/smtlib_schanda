...
(define-fun dynamic_invariant ((temp___expr_257 us_t1) (temp___is_init_254 Bool) (temp___skip_constant_255 Bool) (temp___do_toplevel_256 Bool)) Bool (and (=> (not (= temp___skip_constant_255 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_257) (last3 temp___expr_257))) (=> (= temp___do_toplevel_256 true) (=> (= temp___is_init_254 true) (and (= (first5 (of_array2 (to_array1 temp___expr_257) (first3 temp___expr_257) (last3 temp___expr_257))) 1) (<= (last3 temp___expr_257) 1000))))))
(define-fun dynamic_predicate ((temp___261 us_t1)) Bool (and (= (first5 (of_array2 (to_array1 temp___261) (first3 temp___261) (last3 temp___261))) 1) (<= (last3 temp___261) 1000)))
...
(define-fun dynamic_invariant1 ((temp___expr_425 Int) (temp___is_init_422 Bool) (temp___skip_constant_423 Bool) (temp___do_toplevel_424 Bool)) Bool (=> (or (= temp___is_init_422 true) (<= 0 4294967295)) (in_range3 temp___expr_425)))
(declare-const x Int)
...
(assert (= (elts (to_string (attr__ATTRIBUTE_IMAGE3 x))) temp___448))
(assert (= (mk1 (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 x))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 x)))))) temp___4481))
(assert (not (dynamic_predicate (mk___t1 temp___448 temp___4481))))
(check-sat)
(exit)
