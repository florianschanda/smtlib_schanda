...
(define-fun dynamic_invariant ((temp___expr_321 us_t1) (temp___is_init_317 Bool) (temp___skip_constant_318 Bool) (temp___do_toplevel_319 Bool) (temp___do_typ_inv_320 Bool)) Bool (and (=> (not (= temp___skip_constant_318 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_321) (last3 temp___expr_321))) (=> (= temp___do_toplevel_319 true) (=> (= temp___is_init_317 true) (and (let ((temp___323 (of_array3 (to_array1 temp___expr_321) (first3 temp___expr_321) (last3 temp___expr_321)))) (and (let ((temp___324 (of_array2 (to_array3 temp___323) (first7 temp___323) (last7 temp___323)))) (and (= (first5 temp___324) 1) (<= 0 (last5 temp___324)))) (<= (last7 temp___323) 1000))) (<= 2 (length1 temp___expr_321)))))))
(define-fun dynamic_predicate ((temp___326 us_t1)) Bool (and (let ((temp___328 (of_array3 (to_array1 temp___326) (first3 temp___326) (last3 temp___326)))) (and (let ((temp___329 (of_array2 (to_array3 temp___328) (first7 temp___328) (last7 temp___328)))) (and (= (first5 temp___329) 1) (<= 0 (last5 temp___329)))) (<= (last7 temp___328) 1000))) (<= 2 (length1 temp___326))))
...
(define-fun dynamic_invariant6 ((temp___expr_271 us_t2) (temp___is_init_267 Bool) (temp___skip_constant_268 Bool) (temp___do_toplevel_269 Bool) (temp___do_typ_inv_270 Bool)) Bool (and (=> (not (= temp___skip_constant_268 true)) (dynamic_property2 1 2147483647 (first5 temp___expr_271) (last5 temp___expr_271))) (=> (= temp___do_toplevel_269 true) (=> (= temp___is_init_267 true) (and (= (first5 temp___expr_271) 1) (<= 0 (last5 temp___expr_271)))))))
(define-fun dynamic_predicate1 ((temp___274 us_t2)) Bool (and (= (first5 temp___274) 1) (<= 0 (last5 temp___274))))
(define-fun dynamic_invariant7 ((temp___expr_308 us_t3) (temp___is_init_304 Bool) (temp___skip_constant_305 Bool) (temp___do_toplevel_306 Bool) (temp___do_typ_inv_307 Bool)) Bool (and (=> (not (= temp___skip_constant_305 true)) (dynamic_property3 1 2147483647 (first7 temp___expr_308) (last7 temp___expr_308))) (=> (= temp___do_toplevel_306 true) (=> (= temp___is_init_304 true) (and (let ((temp___310 (of_array2 (to_array3 temp___expr_308) (first7 temp___expr_308) (last7 temp___expr_308)))) (and (= (first5 temp___310) 1) (<= 0 (last5 temp___310)))) (<= (last7 temp___expr_308) 1000))))))
(define-fun dynamic_predicate2 ((temp___312 us_t3)) Bool (and (let ((temp___314 (of_array2 (to_array3 temp___312) (first7 temp___312) (last7 temp___312)))) (and (= (first5 temp___314) 1) (<= 0 (last5 temp___314)))) (<= (last7 temp___312) 1000)))
