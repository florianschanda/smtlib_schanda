...
(assert (not (= k3 (to_rep1 a__last))))
(assert (and (= o38 (+ k3 1)) (in_range1 (+ k3 1))))
(assert (= result6 (mk_int__ref k3)))
(assert (= k4 o38))
(assert (and (<= (to_rep1 a__first) k4) (<= k4 (to_rep1 a__last))))
(assert (= o39 k4))
(assert (= (mk___rep (mk___split_fields o40 o41 o42)) (select a3 o39)))
(assert (= o40 o43))
(assert (= o41 o44))
(assert (= o42 o45))
(assert (= o46 o43))
(assert (= o47 (to_rep o46)))
(assert (= result7 (ite (< max4 o47) true false)))
(assert (=> (= result7 true) (and (<= (to_rep1 a__first) k4) (<= k4 (to_rep1 a__last)))))
(assert (=> (= result7 true) (= o48 k4)))
(assert (=> (= result7 true) (= (mk___rep (mk___split_fields o49 o50 o51)) (select a3 o48))))
(assert (=> (= result7 true) (= o49 o52)))
(assert (=> (= result7 true) (= o50 o53)))
(assert (=> (= result7 true) (= o51 o54)))
(assert (=> (= result7 true) (= o55 o52)))
(assert (=> (= result7 true) (= o56 (to_rep o55))))
(assert (=> (= result7 true) (= result8 (mk_int__ref max4))))
(assert (=> (= result7 true) (= max5 o56)))
(assert (=> (not (= result7 true)) (= max5 max4)))
(assert (= (to_rep o57) max5))
(assert (= o58 (mk___split_fields (rec__frame_condition__cell__value (us_split_fields1 (select a3 k4))) o57 (rec__frame_condition__cell__max_right (us_split_fields1 (select a3 k4))))))
(assert (= o59 (mk___rep o58)))
(assert (and (<= (to_rep1 a__first) k4) (<= k4 (to_rep1 a__last))))
(assert (= o60 k4))
(assert (= o61 (store a3 o60 o59)))
(assert (= result9 (mk_map__ref a3)))
(assert (= a4 o61))
(declare-const i5 Int)
(assert (<= (to_rep1 a__first) i5))
(assert (<= i5 k4))
(assert (not (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a4 i5)))) max5)))
(check-sat)
(exit)
