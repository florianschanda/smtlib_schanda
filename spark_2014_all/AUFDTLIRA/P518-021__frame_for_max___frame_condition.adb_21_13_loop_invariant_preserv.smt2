...
(assert (=> (= result7 true) (and (<= (to_rep1 a__first) k3) (<= k3 (to_rep1 a__last)))))
(assert (=> (= result7 true) (= o39 k3)))
(assert (=> (= result7 true) (= (mk___rep (mk___split_fields o40 o41 o42)) (select a2 o39))))
...
(assert (= o49 (mk___split_fields (rec__frame_condition__cell__value (us_split_fields1 (select a2 k3))) o48 (rec__frame_condition__cell__max_right (us_split_fields1 (select a2 k3))))))
