...
(assert (forall ((us_void_param tuple0)) (! (= (to_rep (select (temp___String_Literal_990 us_void_param) 1)) 58) :pattern ((temp___String_Literal_990 us_void_param)))))
(declare-fun temp___String_Literal_991 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (= (to_rep (select (temp___String_Literal_991 us_void_param) 1)) 58) :pattern ((temp___String_Literal_991 us_void_param)))))
(declare-fun temp___String_Literal_992 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_992 us_void_param) 1)) 58) (= (to_rep (select (temp___String_Literal_992 us_void_param) 2)) 32)) :pattern ((temp___String_Literal_992 us_void_param)))))
