...
(define-fun dynamic_invariant1 ((temp___expr_645 Int) (temp___is_init_642 Bool) (temp___skip_constant_643 Bool) (temp___do_toplevel_644 Bool)) Bool (=> (or (= temp___is_init_642 true) (<= 0 2147483647)) (in_range4 temp___expr_645)))
...
(define-fun default_initial_assumption ((temp___expr_668 us_rep) (temp___skip_top_level_669 Bool)) Bool (and (= (attr__constrained temp___expr_668) false) (= (to_rep3 (rec__lexer__token__kind (us_split_discrs1 temp___expr_668))) 0)))
...
(assert (forall ((us_void_param tuple0)) (! (= (to_rep (select (temp___String_Literal_894 us_void_param) 1)) 58) :pattern ((temp___String_Literal_894 us_void_param)))))
(declare-fun temp___String_Literal_895 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (= (to_rep (select (temp___String_Literal_895 us_void_param) 1)) 58) :pattern ((temp___String_Literal_895 us_void_param)))))
(declare-fun temp___String_Literal_896 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_896 us_void_param) 1)) 58) (= (to_rep (select (temp___String_Literal_896 us_void_param) 2)) 32)) :pattern ((temp___String_Literal_896 us_void_param)))))
...
(define-fun dynamic_invariant6 ((temp___expr_654 Int) (temp___is_init_651 Bool) (temp___skip_constant_652 Bool) (temp___do_toplevel_653 Bool)) Bool (=> (or (= temp___is_init_651 true) (<= 0 8)) (in_range5 temp___expr_654)))
