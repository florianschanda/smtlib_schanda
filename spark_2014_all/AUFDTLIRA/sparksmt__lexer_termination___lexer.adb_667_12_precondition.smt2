...
(define-fun dynamic_invariant1 ((temp___expr_719 Int) (temp___is_init_715 Bool) (temp___skip_constant_716 Bool) (temp___do_toplevel_717 Bool) (temp___do_typ_inv_718 Bool)) Bool (=> (or (= temp___is_init_715 true) (<= 0 2147483647)) (in_range4 temp___expr_719)))
...
(assert (forall ((x token_kind)) (! (in_range5 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep4 (rec__lexer__token__kind (us_split_discrs1 a))) (to_rep4 (rec__lexer__token__kind (us_split_discrs1 b)))) (and (and (and (= (to_rep2 (rec__lexer__token__line (us_split_fields1 a))) (to_rep2 (rec__lexer__token__line (us_split_fields1 b)))) (= (to_rep2 (rec__lexer__token__col (us_split_fields1 a))) (to_rep2 (rec__lexer__token__col (us_split_fields1 b))))) (= (to_rep2 (rec__lexer__token__length (us_split_fields1 a))) (to_rep2 (rec__lexer__token__length (us_split_fields1 b))))) (=> (lexer__token__value__pred a) (= (to_rep3 (rec__lexer__token__value (us_split_fields1 a))) (to_rep3 (rec__lexer__token__value (us_split_fields1 b))))))) true false))
...
(assert (forall ((us_void_param tuple0)) (! (= (to_rep (select (temp___String_Literal_983 us_void_param) 1)) 58) :pattern ((temp___String_Literal_983 us_void_param)))))
(declare-fun temp___String_Literal_984 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (= (to_rep (select (temp___String_Literal_984 us_void_param) 1)) 58) :pattern ((temp___String_Literal_984 us_void_param)))))
(declare-fun temp___String_Literal_985 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_985 us_void_param) 1)) 58) (= (to_rep (select (temp___String_Literal_985 us_void_param) 2)) 32)) :pattern ((temp___String_Literal_985 us_void_param)))))
...
(define-fun dynamic_invariant6 ((temp___expr_729 Int) (temp___is_init_725 Bool) (temp___skip_constant_726 Bool) (temp___do_toplevel_727 Bool) (temp___do_typ_inv_728 Bool)) Bool (=> (or (= temp___is_init_725 true) (<= 0 8)) (in_range5 temp___expr_729)))
