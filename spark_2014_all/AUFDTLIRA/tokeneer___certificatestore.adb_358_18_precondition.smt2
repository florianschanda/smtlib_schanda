...
(assert (=> (< nextserialnumber 4294967295) (and (= o (+ nextserialnumber 1)) (in_range4 (+ nextserialnumber 1)))))
...
(assert (=> (not (< nextserialnumber 4294967295)) (= overflow2 (of_int 1))))
(assert (=> (not (< nextserialnumber 4294967295)) (= overflow1 overflow2)))
(assert (=> (not (< nextserialnumber 4294967295)) (= nextserialnumber2 nextserialnumber)))
(assert (=> (not (< nextserialnumber 4294967295)) (= overflow1 overflow2)))
(assert (=> (not (< nextserialnumber 4294967295)) (= nextserialnumber2 nextserialnumber1)))
(assert (= o1 (exists__ storefile)))
(assert (= result5 (ite (not (= o1 true)) true false)))
(assert (=> (= result5 true) (=> (not (= exists__3 true)) (= exists__4 exists__3))))
(assert (=> (= result5 true) (=> (not (= exists__3 true)) (= storefile3 storefile2))))
