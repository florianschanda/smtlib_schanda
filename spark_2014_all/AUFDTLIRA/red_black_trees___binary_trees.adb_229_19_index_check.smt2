...
(assert (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (= (select todo3 j2) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j2))) true)))))
(assert (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (= (select todo3 j2) true) (forall ((k Int)) (=> (and (<= 1 k) (<= k 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 k))) true) (not (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select r2 j2))) (rec__tree_model__path_type__a (us_split_fields1 (select r2 k)))) true)))))))))
...
(assert (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j2))) true) (not (= j2 root))) (and (not (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j2)))) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j2))))))) true))))))
(assert (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j2))) true) (not (= j2 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select r2 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j2))))))) (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j2)))) (rec__tree_model__path_type__a (us_split_fields1 (select r2 j2)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select r2 j2)))) 0)))))
(assert (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (not (= j2 root)) (ite (and (not (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j2)))) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j2))))))) true)) (or (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j2))) true) (= (select todo3 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j2))))) true)) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j2))) true)))))))
(assert (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j2))) true) (not (= j2 root))) (not (= (select todo3 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j2))))) true))))))
(assert (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j2))) true) (forall ((k Int)) (=> (and (<= 1 k) (<= k 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 k))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select r2 k))) (rec__tree_model__path_type__a (us_split_fields1 (select r2 j2)))) true)) (= j2 k))))))))
(assert (and (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 root))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select r2 root)))) 0)))
(assert (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (<= (length (rec__tree_model__path_type__a (us_split_fields1 (select r2 j2)))) (- 100 (length1 unseen2))))))
(assert (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (= (= (contains unseen2 j2) true) (or (not (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j2))) true)) (= (select todo3 j2) true))))))
...
(assert (< (length (rec__tree_model__path_type__a (us_split_fields1 (select r2 j1)))) 100))
(assert (= (rec__tree_model__path_type__a (us_split_fields1 (select r2 j1))) o18))
(assert (= (of_int 1) o19))
(assert (not (<= 1 j1)))
(check-sat)
(exit)
