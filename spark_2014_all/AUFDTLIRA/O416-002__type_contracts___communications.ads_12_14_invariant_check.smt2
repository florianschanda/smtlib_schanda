...
(assert (= (ite (<= (to_rep2 (first2 temp___3621)) (to_rep2 (last2 temp___3621))) (+ (- (to_rep2 (last2 temp___3621)) (to_rep2 (first2 temp___3621))) 1) 0) (ite (<= (to_rep2 (first com__split_fields1)) (to_rep2 (last com__split_fields1))) (+ (- (to_rep2 (last com__split_fields1)) (to_rep2 (first com__split_fields1))) 1) 0)))
(assert (= (mk___t1 temp___364 temp___3641) (mk___t1 temp___362 temp___3621)))
(assert (= temp___364 o))
(assert (= (mk (to_rep2 (first2 temp___3641)) (to_rep2 (last2 temp___3641))) o1))
(assert (= o2 o))
(assert (= o3 o1))
