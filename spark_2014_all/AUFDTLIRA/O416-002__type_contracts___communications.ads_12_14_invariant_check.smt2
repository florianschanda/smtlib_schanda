...
(assert (= (ite (<= (to_rep2 (first2 temp___3331)) (to_rep2 (last2 temp___3331))) (+ (- (to_rep2 (last2 temp___3331)) (to_rep2 (first2 temp___3331))) 1) 0) (ite (<= (to_rep2 (first com__split_fields1)) (to_rep2 (last com__split_fields1))) (+ (- (to_rep2 (last com__split_fields1)) (to_rep2 (first com__split_fields1))) 1) 0)))
(assert (= (mk___t1 temp___335 temp___3351) (mk___t1 temp___333 temp___3331)))
(assert (= temp___335 o))
(assert (= (mk (to_rep2 (first2 temp___3351)) (to_rep2 (last2 temp___3351))) o1))
(assert (= o2 o))
(assert (= o3 o1))
