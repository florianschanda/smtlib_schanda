...
(define-fun dynamic_invariant3 ((temp___expr_513 Int) (temp___is_init_510 Bool) (temp___skip_constant_511 Bool) (temp___do_toplevel_512 Bool)) Bool (=> (or (= temp___is_init_510 true) (<= 0 2)) (in_range4 temp___expr_513)))
...
(define-fun dynamic_invariant6 ((temp___expr_519 Int) (temp___is_init_516 Bool) (temp___skip_constant_517 Bool) (temp___do_toplevel_518 Bool)) Bool (=> (or (= temp___is_init_516 true) (<= 1 3)) (in_range5 temp___expr_519)))
...
(declare-const temp___779 pos)
(declare-const temp___7791 pos)
...
(assert (and (and (and (and (and (and (= p__split_fields temp___779) (= p__split_fields1 temp___7791)) (and (and (and (and (= (mk___t tictactoe__player_play__B_2__s__assume tictactoe__player_play__B_2__s__assume1) (get_line__4 Tuple0)) (dynamic_invariant1 (mk___t tictactoe__player_play__B_2__s__assume tictactoe__player_play__B_2__s__assume1) true false true)) (and (and (= result (mk_map__ref s)) (= s1 tictactoe__player_play__B_2__s__assume)) (and (= (to_rep1 s__first) (to_rep1 (first tictactoe__player_play__B_2__s__assume1))) (= (to_rep1 s__last) (to_rep1 (last tictactoe__player_play__B_2__s__assume1)))))) (dynamic_property 1 2147483647 (to_rep1 s__first) (to_rep1 s__last))) (and (and (= result1 (mk_bool__ref found)) (= found1 (of_int 1))) (and (and (and (= c2 (mk_int__ref c1)) (and (= found3 (mk_bool__ref found2)) (= p__split_fields13 (mk___split_fields__ref p__split_fields4)))) (and (= c3 c1) (and (= found4 found2) (= p__split_fields14 p__split_fields4)))) (and (and (ite (<= (to_rep1 s__first) (to_rep1 s__last)) (= o (+ (- (to_rep1 s__last) (to_rep1 s__first)) 1)) (= o 0)) (= result2 (ite (<= 1 o) true false))) (and (= result2 true) (and (and (and (and (and (and (<= (to_rep1 s__first) (to_rep1 s__first)) (<= (to_rep1 s__first) (to_rep1 s__last))) (= o1 (to_rep1 s__first))) (= o2 (select s1 o1))) (= o3 (to_rep o2))) (and (= result3 (mk_int__ref c)) (= c1 o3))) (and (in_range3 c1) (and (and (and (and (= (to_rep3 o4) 1) (and (= (to_rep3 o5) 1) (and (= o5 o6) (= o4 o7)))) (and (= temp___767 o6) (= temp___7671 o7))) (and (= result4 (mk___split_fields__ref p__split_fields2)) (= p__split_fields3 (mk___split_fields temp___767 temp___7671)))) (and (ite (= c1 49) (and (and (and (and (= (to_rep3 o8) 1) (and (= (to_rep3 o9) 1) (and (= o9 o10) (= o8 o11)))) (and (= temp___768 o10) (= temp___7681 o11))) (and (= result5 (mk___split_fields__ref p__split_fields3)) (= p__split_fields4 (mk___split_fields temp___768 temp___7681)))) (= found2 found1)) (and (ite (= c1 50) (and (and (and (and (= (to_rep3 o12) 1) (and (= (to_rep3 o13) 2) (and (= o13 o14) (= o12 o15)))) (and (= temp___769 o14) (= temp___7691 o15))) (and (= result6 (mk___split_fields__ref p__split_fields3)) (= p__split_fields5 (mk___split_fields temp___769 temp___7691)))) (= found2 found1)) (and (ite (= c1 51) (and (and (and (and (= (to_rep3 o16) 1) (and (= (to_rep3 o17) 3) (and (= o17 o18) (= o16 o19)))) (and (= temp___770 o18) (= temp___7701 o19))) (and (= result7 (mk___split_fields__ref p__split_fields3)) (= p__split_fields6 (mk___split_fields temp___770 temp___7701)))) (= found2 found1)) (and (ite (= c1 52) (and (and (and (and (= (to_rep3 o20) 2) (and (= (to_rep3 o21) 1) (= o22 (mk___split_fields o21 o20)))) (= temp___771 (mk___rep o22))) (and (= result8 (mk___split_fields__ref p__split_fields3)) (= p__split_fields7 (us_split_fields1 temp___771)))) (= found2 found1)) (and (ite (= c1 53) (and (and (and (and (= (to_rep3 o23) 2) (and (= (to_rep3 o24) 2) (= o25 (mk___split_fields o24 o23)))) (= temp___772 (mk___rep o25))) (and (= result9 (mk___split_fields__ref p__split_fields3)) (= p__split_fields8 (us_split_fields1 temp___772)))) (= found2 found1)) (and (ite (= c1 54) (and (and (and (and (= (to_rep3 o26) 2) (and (= (to_rep3 o27) 3) (= o28 (mk___split_fields o27 o26)))) (= temp___773 (mk___rep o28))) (and (= result10 (mk___split_fields__ref p__split_fields3)) (= p__split_fields9 (us_split_fields1 temp___773)))) (= found2 found1)) (and (ite (= c1 55) (and (and (and (and (= (to_rep3 o29) 3) (and (= (to_rep3 o30) 1) (= o31 (mk___split_fields o30 o29)))) (= temp___774 (mk___rep o31))) (and (= result11 (mk___split_fields__ref p__split_fields3)) (= p__split_fields10 (us_split_fields1 temp___774)))) (= found2 found1)) (and (ite (= c1 56) (and (and (and (and (= (to_rep3 o32) 3) (and (= (to_rep3 o33) 2) (= o34 (mk___split_fields o33 o32)))) (= temp___775 (mk___rep o34))) (and (= result12 (mk___split_fields__ref p__split_fields3)) (= p__split_fields11 (us_split_fields1 temp___775)))) (= found2 found1)) (and (ite (= c1 57) (and (and (and (and (= (to_rep3 o35) 3) (and (= (to_rep3 o36) 3) (= o37 (mk___split_fields o36 o35)))) (= temp___776 (mk___rep o37))) (and (= result13 (mk___split_fields__ref p__split_fields3)) (= p__split_fields12 (us_split_fields1 temp___776)))) (= found2 found1)) (and (and (= result14 (mk_bool__ref found1)) (= found2 (of_int 0))) (= p__split_fields12 p__split_fields3))) (= p__split_fields11 p__split_fields12))) (= p__split_fields10 p__split_fields11))) (= p__split_fields9 p__split_fields10))) (= p__split_fields8 p__split_fields9))) (= p__split_fields7 p__split_fields8))) (= p__split_fields6 p__split_fields7))) (= p__split_fields5 p__split_fields6))) (= p__split_fields4 p__split_fields5))) (and (= found2 true) (= (to_rep2 (select (select my_board (to_rep3 (rec__tictactoe__position__x p__split_fields4))) (to_rep3 (rec__tictactoe__position__y p__split_fields4)))) 0)))))))))))) (and (and (= c4 c2) (and (= found5 found3) (and (= s2 (mk_map__ref s1)) (= p__split_fields15 p__split_fields13)))) (and (= c5 c3) (and (= found6 found4) (and (= s3 s1) (= p__split_fields16 p__split_fields14)))))) (and (and (= c6 c4) (and (= found7 found5) (and (= s4 s2) (= p__split_fields17 p__split_fields15)))) (and (= c7 c5) (and (= found8 found6) (and (= s5 s3) (= p__split_fields18 p__split_fields16)))))) (= (num_free_slots my_board1) (- (num_free_slots my_board) 1))) (and (and (= c8 c6) (and (= found9 found7) (and (= s6 s4) (and (= p__split_fields19 p__split_fields17) (= my_board2 (mk_map__ref2 my_board1)))))) (and (= c9 c7) (and (= found10 found8) (and (= s7 s5) (and (= p__split_fields20 p__split_fields18) (= my_board3 my_board1))))))))
