...
(assert (forall ((x algorithmt)) (! (in_range2 (to_rep x)) :pattern ((to_rep x)))))
...
(assert (forall ((x namecountt)) (! (in_range3 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(assert (forall ((x privileget)) (! (in_range11 (to_rep9 x)) :pattern ((to_rep9 x)))))
...
(define-fun dynamic_invariant1 ((temp___expr_885 Int) (temp___is_init_882 Bool) (temp___skip_constant_883 Bool) (temp___do_toplevel_884 Bool)) Bool (=> (or (= temp___is_init_882 true) (<= 0 3)) (in_range11 temp___expr_885)))
(declare-fun therole (us_rep4) Int)
(declare-fun therole__function_guard (Int us_rep4) Bool)
(assert (forall ((admintoken__authcert__fields us_split_fields10)) (! (dynamic_invariant1 (theauthcertrole admintoken__authcert__fields) true false true) :pattern ((theauthcertrole admintoken__authcert__fields)))))
...
(define-fun dynamic_invariant3 ((temp___expr_341 Int) (temp___is_init_338 Bool) (temp___skip_constant_339 Bool) (temp___do_toplevel_340 Bool)) Bool (=> (or (= temp___is_init_338 true) (<= 1901 2099)) (in_range7 temp___expr_341)))
(define-fun dynamic_invariant4 ((temp___expr_347 Int) (temp___is_init_344 Bool) (temp___skip_constant_345 Bool) (temp___do_toplevel_346 Bool)) Bool (=> (or (= temp___is_init_344 true) (<= 1 12)) (in_range8 temp___expr_347)))
(define-fun dynamic_invariant5 ((temp___expr_353 Int) (temp___is_init_350 Bool) (temp___skip_constant_351 Bool) (temp___do_toplevel_352 Bool)) Bool (=> (or (= temp___is_init_350 true) (<= 1 31)) (in_range9 temp___expr_353)))
(define-fun dynamic_invariant6 ((temp___expr_377 Int) (temp___is_init_374 Bool) (temp___skip_constant_375 Bool) (temp___do_toplevel_376 Bool)) Bool (=> (or (= temp___is_init_374 true) (<= 0 86399999)) (in_range10 temp___expr_377)))
(define-fun dynamic_invariant7 ((temp___expr_179 Int) (temp___is_init_176 Bool) (temp___skip_constant_177 Bool) (temp___do_toplevel_178 Bool)) Bool (=> (or (= temp___is_init_176 true) (<= 0 40)) (in_range3 temp___expr_179)))
...
(define-fun dynamic_invariant9 ((temp___expr_218 Int) (temp___is_init_215 Bool) (temp___skip_constant_216 Bool) (temp___do_toplevel_217 Bool)) Bool (=> (or (= temp___is_init_215 true) (<= 0 10)) (in_range2 temp___expr_218)))
(define-fun dynamic_invariant10 ((temp___expr_230 Int) (temp___is_init_227 Bool) (temp___skip_constant_228 Bool) (temp___do_toplevel_229 Bool)) Bool (=> (or (= temp___is_init_227 true) (<= 0 4294967295)) (in_range13 temp___expr_230)))
(define-fun dynamic_invariant11 ((temp___expr_236 Int) (temp___is_init_233 Bool) (temp___skip_constant_234 Bool) (temp___do_toplevel_235 Bool)) Bool (=> (or (= temp___is_init_233 true) (<= 0 128)) (in_range14 temp___expr_236)))
(define-fun dynamic_invariant12 ((temp___expr_897 Int) (temp___is_init_894 Bool) (temp___skip_constant_895 Bool) (temp___do_toplevel_896 Bool)) Bool (=> (or (= temp___is_init_894 true) (<= 0 5)) (in_range12 temp___expr_897)))
(define-fun dynamic_invariant13 ((temp___expr_321 Int) (temp___is_init_318 Bool) (temp___skip_constant_319 Bool) (temp___do_toplevel_320 Bool)) Bool (=> (or (= temp___is_init_318 true) (<= 0 4294967295)) (in_range6 temp___expr_321)))
(assert (forall ((contents us_rep4)) (! (dynamic_invariant1 (therole contents) true false true) :pattern ((therole contents)))))
(assert (not true))
(check-sat)
(exit)
