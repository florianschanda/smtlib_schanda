...
(assert (not (= ki1 kj1)))
(assert (and (= (rec__tree_model__path_type__k (us_split_fields1 (select m ki2))) true) (= (ole (rec__tree_model__path_type__a (us_split_fields1 (select m ki2))) (rec__tree_model__path_type__a (us_split_fields1 (select m i)))) true)))
(assert (= (ole (rec__tree_model__path_type__a (us_split_fields1 (select m kj2))) (rec__tree_model__path_type__a (us_split_fields1 (select m j)))) true))
(assert (= (rec__tree_model__path_type__k (us_split_fields1 (select m kj2))) true))
(assert (=> (< (length (rec__tree_model__path_type__a (us_split_fields1 (select m kj2)))) (length (rec__tree_model__path_type__a (us_split_fields1 (select m ki2))))) (= kj2 j)))
(assert (=> (< (length (rec__tree_model__path_type__a (us_split_fields1 (select m ki2)))) (length (rec__tree_model__path_type__a (us_split_fields1 (select m kj2))))) (= ki2 i)))
(assert (and (=> (<= 1 100) (in_range2 kj2)) (=> (<= 1 100) (in_range2 ki2))))
(assert (= result4 (mk_int__ref temp___12701)))
(assert (= temp___12702 (length (rec__tree_model__path_type__a (us_split_fields1 (select m ki2))))))
(assert (= result5 (mk_int__ref temp___12691)))
(assert (= temp___12692 (length (rec__tree_model__path_type__a (us_split_fields1 (select m kj2))))))
(assert (and (= o4 (length (rec__tree_model__path_type__a (us_split_fields1 (select m kj2))))) (and (in_range3 o4) (<= (+ 0 o4) 2147483647))))
(assert (and (= o5 (length (rec__tree_model__path_type__a (us_split_fields1 (select m ki2))))) (and (in_range3 o5) (<= (+ 0 o5) 2147483647))))
(assert (= result6 (ite (< o4 o5) true false)))
(assert (=> (= result6 true) (and (= o6 (parent f ki2)) (and (in_range6 o6) (and (=> (= (valid_root f ki2) true) (= o6 0)) (=> (= (size f) 0) (= o6 0)))))))
(assert (=> (= result6 true) (and (= o7 o6) (in_range2 o6))))
(assert (=> (= result6 true) (= result7 (mk_int__ref ki2))))
(assert (=> (= result6 true) (= ki3 o7)))
(assert (=> (= result6 true) (= kj3 kj2)))
(assert (=> (not (= result6 true)) (and (= o8 (length (rec__tree_model__path_type__a (us_split_fields1 (select m ki2))))) (and (in_range3 o8) (<= (+ 0 o8) 2147483647)))))
(assert (=> (not (= result6 true)) (and (= o9 (length (rec__tree_model__path_type__a (us_split_fields1 (select m kj2))))) (and (in_range3 o9) (<= (+ 0 o9) 2147483647)))))
(assert (=> (not (= result6 true)) (= result8 (ite (< o8 o9) true false))))
(assert (=> (not (= result6 true)) (=> (= result8 true) (and (= o10 (parent f kj2)) (and (in_range6 o10) (and (=> (= (valid_root f kj2) true) (= o10 0)) (=> (= (size f) 0) (= o10 0))))))))
(assert (=> (not (= result6 true)) (=> (= result8 true) (and (= o11 o10) (in_range2 o10)))))
(assert (=> (not (= result6 true)) (=> (= result8 true) (= result9 (mk_int__ref kj2)))))
(assert (=> (not (= result6 true)) (=> (= result8 true) (= kj3 o11))))
(assert (=> (not (= result6 true)) (=> (= result8 true) (= ki4 ki2))))
(assert (=> (not (= result6 true)) (=> (not (= result8 true)) (and (= o12 (parent f ki2)) (and (in_range6 o12) (and (=> (= (valid_root f ki2) true) (= o12 0)) (=> (= (size f) 0) (= o12 0))))))))
(assert (=> (not (= result6 true)) (=> (not (= result8 true)) (and (= o13 o12) (in_range2 o12)))))
(assert (=> (not (= result6 true)) (=> (not (= result8 true)) (= result10 (mk_int__ref ki2)))))
(assert (=> (not (= result6 true)) (=> (not (= result8 true)) (= ki4 o13))))
(assert (=> (not (= result6 true)) (=> (not (= result8 true)) (and (= o14 (parent f kj2)) (and (in_range6 o14) (and (=> (= (valid_root f kj2) true) (= o14 0)) (=> (= (size f) 0) (= o14 0))))))))
(assert (=> (not (= result6 true)) (=> (not (= result8 true)) (and (= o15 o14) (in_range2 o14)))))
(assert (=> (not (= result6 true)) (=> (not (= result8 true)) (= result11 (mk_int__ref kj2)))))
(assert (=> (not (= result6 true)) (=> (not (= result8 true)) (= kj4 o15))))
(assert (=> (not (= result6 true)) (=> (not (= result8 true)) (= kj3 kj4))))
(assert (=> (not (= result6 true)) (= ki3 ki4)))
(assert (not (= ki3 kj3)))
(assert (not (= (rec__tree_model__path_type__k (us_split_fields1 (select m ki3))) true)))
(check-sat)
(exit)
