...
(assert (= result2 (mk_int__ref temp___1314)))
(assert (= temp___13141 (length (rec__tree_model__path_type__a (us_split_fields1 (select m ki2))))))
(assert (= result3 (mk_int__ref temp___1313)))
(assert (= temp___13131 (length (rec__tree_model__path_type__a (us_split_fields1 (select m kj2))))))
