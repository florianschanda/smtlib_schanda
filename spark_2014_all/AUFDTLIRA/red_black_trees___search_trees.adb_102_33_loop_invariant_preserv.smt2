...
(assert (= temp___12701 (length (rec__tree_model__path_type__a (us_split_fields1 (select m ki2))))))
(assert (= result3 (mk_int__ref temp___1269)))
(assert (= temp___12691 (length (rec__tree_model__path_type__a (us_split_fields1 (select m kj2))))))
(assert (and (= o (length (rec__tree_model__path_type__a (us_split_fields1 (select m kj2))))) (and (in_range3 o) (<= (+ 0 o) 2147483647))))
(assert (and (= o1 (length (rec__tree_model__path_type__a (us_split_fields1 (select m ki2))))) (and (in_range3 o1) (<= (+ 0 o1) 2147483647))))
(assert (= result4 (ite (< o o1) true false)))
(assert (=> (= result4 true) (and (= o2 (parent f ki2)) (and (in_range6 o2) (and (=> (= (valid_root f ki2) true) (= o2 0)) (=> (= (size f) 0) (= o2 0)))))))
...
(assert (=> (not (= result4 true)) (and (= o4 (length (rec__tree_model__path_type__a (us_split_fields1 (select m ki2))))) (and (in_range3 o4) (<= (+ 0 o4) 2147483647)))))
(assert (=> (not (= result4 true)) (and (= o5 (length (rec__tree_model__path_type__a (us_split_fields1 (select m kj2))))) (and (in_range3 o5) (<= (+ 0 o5) 2147483647)))))
(assert (=> (not (= result4 true)) (= result6 (ite (< o4 o5) true false))))
(assert (=> (not (= result4 true)) (=> (= result6 true) (and (= o6 (parent f kj2)) (and (in_range6 o6) (and (=> (= (valid_root f kj2) true) (= o6 0)) (=> (= (size f) 0) (= o6 0))))))))
(assert (=> (not (= result4 true)) (=> (= result6 true) (and (= o7 o6) (in_range2 o6)))))
(assert (=> (not (= result4 true)) (=> (= result6 true) (= result7 (mk_int__ref kj2)))))
(assert (=> (not (= result4 true)) (=> (= result6 true) (= kj3 o7))))
(assert (=> (not (= result4 true)) (=> (= result6 true) (= ki4 ki2))))
(assert (=> (not (= result4 true)) (=> (not (= result6 true)) (and (= o8 (parent f ki2)) (and (in_range6 o8) (and (=> (= (valid_root f ki2) true) (= o8 0)) (=> (= (size f) 0) (= o8 0))))))))
(assert (=> (not (= result4 true)) (=> (not (= result6 true)) (and (= o9 o8) (in_range2 o8)))))
(assert (=> (not (= result4 true)) (=> (not (= result6 true)) (= result8 (mk_int__ref ki2)))))
(assert (=> (not (= result4 true)) (=> (not (= result6 true)) (= ki4 o9))))
(assert (=> (not (= result4 true)) (=> (not (= result6 true)) (and (= o10 (parent f kj2)) (and (in_range6 o10) (and (=> (= (valid_root f kj2) true) (= o10 0)) (=> (= (size f) 0) (= o10 0))))))))
(assert (=> (not (= result4 true)) (=> (not (= result6 true)) (and (= o11 o10) (in_range2 o10)))))
(assert (=> (not (= result4 true)) (=> (not (= result6 true)) (= result9 (mk_int__ref kj2)))))
(assert (=> (not (= result4 true)) (=> (not (= result6 true)) (= kj4 o11))))
(assert (=> (not (= result4 true)) (=> (not (= result6 true)) (= kj3 kj4))))
