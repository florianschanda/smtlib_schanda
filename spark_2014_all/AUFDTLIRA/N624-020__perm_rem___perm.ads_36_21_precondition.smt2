...
(assert (forall ((a1 us_t) (b1 us_t)) (! (= (= (is_perm a1 b1) true) (or (and (= (length a1) 0) (= (length b1) 0)) (exists ((ia Int)) (and (and (<= (first1 a1) ia) (<= ia (last1 a1))) (exists ((ib Int)) (and (and (<= (first1 b1) ib) (<= ib (last1 b1))) (and (= (to_rep (select (to_array a1) ia)) (to_rep (select (to_array b1) ib))) (= (is_perm (remove a1 ia) (remove b1 ib)) true)))))))) :pattern ((is_perm a1 b1)))))
...
(define-fun o12 () us_t (mk___t o4 o5))
(define-fun o13 () us_t (mk___t o1 o2))
...
(assert (= result1 true))
(assert (and (= o3 ib) (in_range2 ib)))
(assert (and (= o12 (remove b o3)) (and (dynamic_invariant o12 true false true true) (and (= (invariant__ o12) true) (and (= (to_rep1 (last o5)) (- (to_rep1 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o3 1))) (= (to_rep (select (elts b) k)) (to_rep (select o4 k))))) (and (forall ((k Int)) (=> (and (<= (+ o3 1) k) (<= k (to_rep1 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select o4 (- k 1)))))) (forall ((k Int)) (=> (and (<= o3 k) (<= k (- (to_rep1 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o4 k))))))))))))
(assert (and (= o ia) (in_range2 ia)))
(assert (and (= o13 (remove a o)) (and (dynamic_invariant o13 true false true true) (and (= (invariant__ o13) true) (and (= (to_rep1 (last o2)) (- (to_rep1 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o 1))) (= (to_rep (select (elts a) k)) (to_rep (select o1 k))))) (and (forall ((k Int)) (=> (and (<= (+ o 1) k) (<= k (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select o1 (- k 1)))))) (forall ((k Int)) (=> (and (<= o k) (<= k (- (to_rep1 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select o1 k))))))))))))
(assert (not (= (invariant__ o13) true)))
(check-sat)
(exit)
