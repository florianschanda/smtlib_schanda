...
(assert (and (= (bool_eq x 1 1000 (elts y) (to_rep1 (first (rt y))) (to_rep1 (last (rt y)))) true) (= (to_rep (select x 1)) 88)))
(assert (= (bool_eq x 1 1000 (elts y) (to_rep1 (first (rt y))) (to_rep1 (last (rt y)))) true))
(assert (= (to_rep o) 63))
(assert (= o1 (store x 1 o)))
(assert (= result x))
(assert (= x1 o1))
(assert (not (not (= (bool_eq x1 1 1000 (elts y) (to_rep1 (first (rt y))) (to_rep1 (last (rt y)))) true))))
(check-sat)
(exit)
