...
(assert (= (= o110 true) (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 (- (to_rep1 (select (rec__patience__state__stacksizes (us_split_fields__content s__split_fields20)) i1)) 1))) (and (<= 0 (to_rep1 (select (select (rec__patience__state__stacks (us_split_fields__content s__split_fields20)) i1) j1))) (< (to_rep1 (select (select (rec__patience__state__stacks (us_split_fields__content s__split_fields20)) i1) j1)) (to_rep1 (rec__patience__state__numelts (us_split_fields__content s__split_fields20)))))))))
(assert (not (<= 0 i1)))
(check-sat)
(exit)
