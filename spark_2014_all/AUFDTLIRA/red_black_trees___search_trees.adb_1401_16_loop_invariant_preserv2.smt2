...
(assert (<= 1 i5))
(assert (<= i5 100))
(assert (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ (rec__search_trees__search_tree__struct t__split_fields5) (to_rep1 (rec__search_trees__search_tree__root t__split_fields5))) i5))) true))
...
(assert (= (get (rec__tree_model__path_type__a (us_split_fields5 (select (model__ (rec__search_trees__search_tree__struct t__split_fields5) (to_rep1 (rec__search_trees__search_tree__root t__split_fields5))) current3))) (+ (length (rec__tree_model__path_type__a (us_split_fields5 (select (model__ (rec__search_trees__search_tree__struct t__split_fields5) (to_rep1 (rec__search_trees__search_tree__root t__split_fields5))) i5)))) 1)) 0))
(assert (not (< v (to_rep (select (rec__search_trees__search_tree__values t__split_fields5) i5)))))
(check-sat)
(exit)
