...
(assert (in_range2 k1))
(assert (in_range2 k2))
(assert (and (= k1 k2) (and (<= 0 k1) (and (<= k1 100) (and (<= 0 k2) (and (<= k2 100) (and (forall ((i3 Int)) (=> (and (<= 0 i3) (<= i3 k1)) (= (to_rep (select b1 i3)) (to_rep (select b2 i3))))) (forall ((i3 Int)) (=> (and (<= (+ k1 1) i3) (<= i3 100)) (= (to_rep (select c1 (- i3 k1))) (to_rep (select c2 (- i3 k2)))))))))))))
(assert (= (mk_int__ref result) (mk_int__ref i)))
(assert (= i1 0))
(assert (<= 0 i1))
(assert (<= i1 k1))
(assert (and (forall ((temp___221 Int)) (=> (and (<= 0 temp___221) (<= temp___221 100)) (=> (or (< k1 temp___221) (or (< temp___221 0) (<= i2 temp___221))) (= (select a11 temp___221) (select a1 temp___221))))) (and (<= 0 i2) (<= i2 k1))))
(assert (and (<= 0 i2) (<= i2 100)))
(assert (= o i2))
(assert (= o1 (select b1 o)))
(assert (= o2 (to_rep o1)))
(assert (= (to_rep o3) o2))
(assert (not (<= 0 i2)))
(check-sat)
