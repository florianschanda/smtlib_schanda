...
(assert (and (and (forall ((temp___348 Int)) (=> (and (<= 0 temp___348) (<= temp___348 255)) (=> (< x2 temp___348) (= (select r2 temp___348) (select r temp___348))))) (=> (<= 0 255) (in_range1 x2))) (and (<= 0 x2) (<= x2 255))))
(assert (not (= x2 255)))
(assert (= result2 x2))
(assert (= x3 (+ x2 1)))
(assert (= result3 r2))
