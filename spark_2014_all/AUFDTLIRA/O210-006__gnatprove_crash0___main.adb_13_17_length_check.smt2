...
(assert (forall ((temp___211 Int) (temp___212 Int) (temp___213 Int)) (let ((temp___210 (temp___209 temp___211 temp___212 temp___213))) (and (=> (dynamic_property6 0 2147483647 temp___212 temp___213) (and (= (first5 temp___210) temp___212) (= (last5 temp___210) temp___213))) (forall ((temp___214 Int)) (= (select (to_array2 temp___210) temp___214) (of_rep1 temp___211)))))))
...
(assert (= (ite (<= (to_rep1 (first4 temp___2161)) (to_rep1 (last4 temp___2161))) (+ (- (to_rep1 (last4 temp___2161)) (to_rep1 (first4 temp___2161))) 1) 0) (ite (<= 0 r6b) (+ (- r6b 0) 1) 0)))
(assert (= temp___216 temp___217))
(assert (= (mk1 (to_rep1 (first4 temp___2161)) (to_rep1 (last4 temp___2161))) temp___2171))
(assert (not (= (ite (<= (to_rep1 (first2 temp___2171)) (to_rep1 (last2 temp___2171))) (+ (- (to_rep1 (last2 temp___2171)) (to_rep1 (first2 temp___2171))) 1) 0) (ite (<= (to_rep1 (first d__split_fields1)) (to_rep1 (last d__split_fields1))) (+ (- (to_rep1 (last d__split_fields1)) (to_rep1 (first d__split_fields1))) 1) 0))))
(check-sat)
(exit)
