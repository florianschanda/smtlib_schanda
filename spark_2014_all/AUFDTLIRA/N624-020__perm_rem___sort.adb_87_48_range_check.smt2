...
(assert (and (= o192 y) (in_range5 y)))
(assert (and (= o193 (remove (mk___t values2 (mk 1 100)) o192)) (and (dynamic_invariant4 o193 true false true) (and (= (invariant__ o193) true) (and (= (to_rep1 (last (rt o193))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o192 1))) (= (to_rep (select values2 k)) (to_rep (select (elts o193) k))))) (and (forall ((k Int)) (=> (and (<= (+ o192 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select (elts o193) (- k 1)))))) (forall ((k Int)) (=> (and (<= o192 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts o193) k))))))))))))
