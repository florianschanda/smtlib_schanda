...
(assert (and (= o48 (remove (mk___t values2 (mk 1 100)) o47)) (and (dynamic_invariant4 o48 true false true) (and (= (invariant__ o48) true) (and (= (to_rep1 (last (rt o48))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o47 1))) (= (to_rep (select values2 k)) (to_rep (select (elts o48) k))))) (and (forall ((k Int)) (=> (and (<= (+ o47 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select (elts o48) (- k 1)))))) (forall ((k Int)) (=> (and (<= o47 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts o48) k))))))))))))
