...
(assert (and (= temp___1128 (model__ f1 root)) (and (dynamic_invariant2 temp___1128 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1128 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1128 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent f1 i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1128 (parent f1 i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1128 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1128 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1128 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1128 (parent f1 i1)))) (position f1 i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1128 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1128 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1128 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1128 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1128 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1128 j)))) true)) (= j i1))))))))))))))
(assert (= (mk___rep (mk___split_fields o4 o5)) (select temp___1128 i)))
(assert (= o4 o6))
(assert (= o5 o7))
(assert (= o8 o6))
(assert (and (= o9 (length o8)) (and (in_range5 o9) (<= (+ 0 o9) 2147483647))))
(assert (= o10 (ite (< o9 n2) true false)))
(assert (= (tree_structure f1) true))
(assert (and (= temp___1127 (model__ f1 root)) (and (dynamic_invariant2 temp___1127 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1127 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1127 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent f1 i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1127 (parent f1 i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1127 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1127 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1127 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1127 (parent f1 i1)))) (position f1 i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1127 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1127 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1127 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1127 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1127 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1127 j)))) true)) (= j i1))))))))))))))
(assert (= (mk___rep (mk___split_fields o o1)) (select temp___1127 i)))
(assert (= o o2))
(assert (= o1 o3))
(assert (= o11 o3))
