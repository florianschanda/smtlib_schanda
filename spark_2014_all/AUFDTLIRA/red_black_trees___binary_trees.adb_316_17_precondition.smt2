...
(assert (and (= temp___1082 (model__ f1 root)) (and (dynamic_invariant2 temp___1082 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1082 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1082 root)))) 0) (and (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (not (= i5 root)) (ite (and (not (= (parent f1 i5) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1082 (parent f1 i5)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1082 i5))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1082 i5))) true)))))) (and (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1082 i5))) true) (not (= i5 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1082 (parent f1 i5)))) (position f1 i5) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1082 i5)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1082 i5)))) 0)))) (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1082 i5))) true) (forall ((j20 Int)) (=> (and (<= 1 j20) (<= j20 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1082 j20))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1082 i5))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1082 j20)))) true)) (= j20 i5))))))))))))))
(assert (= (mk___rep (mk___split_fields o4 o5)) (select temp___1082 i1)))
(assert (= o4 o6))
(assert (= o5 o7))
(assert (= o8 o6))
...
(assert (= (tree_structure f1) true))
(assert (and (= temp___1081 (model__ f1 root)) (and (dynamic_invariant2 temp___1081 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1081 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1081 root)))) 0) (and (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (not (= i5 root)) (ite (and (not (= (parent f1 i5) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1081 (parent f1 i5)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1081 i5))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1081 i5))) true)))))) (and (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1081 i5))) true) (not (= i5 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1081 (parent f1 i5)))) (position f1 i5) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1081 i5)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1081 i5)))) 0)))) (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1081 i5))) true) (forall ((j20 Int)) (=> (and (<= 1 j20) (<= j20 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1081 j20))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1081 i5))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1081 j20)))) true)) (= j20 i5))))))))))))))
(assert (= (mk___rep (mk___split_fields o o1)) (select temp___1081 i1)))
(assert (= o o2))
(assert (= o1 o3))
(assert (= o11 o3))
(assert (= result3 (ite (= o11 true) o10 false)))
(assert (= result3 true))
