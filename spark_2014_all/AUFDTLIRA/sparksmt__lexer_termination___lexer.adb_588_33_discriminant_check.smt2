...
(assert (= (to_rep4 (rec__file_io__read_result__status next_read__split_discrs8)) 0))
(assert (not (= (to_rep4 (rec__file_io__read_result__status next_read__split_discrs8)) 0)))
(check-sat)
(exit)
