...
(assert (= (let ((subject c)) c8) 34))
(assert (= (to_rep3 (rec__file_io__read_result__status next_read__split_discrs8)) 0))
(assert (not (= (to_rep3 (rec__file_io__read_result__status next_read__split_discrs8)) 0)))
(check-sat)
(exit)
