...
(assert (= o (+ i 1)))
(assert (= (mk___t temp___439 temp___4391) (temp_____aggregate_def_432 (mk___t a (mk (to_rep a__first) (to_rep a__last))) o new_val)))
(assert (not (= (ite (<= (to_rep (first temp___4391)) (to_rep (last temp___4391))) (+ (- (to_rep (last temp___4391)) (to_rep (first temp___4391))) 1) 0) (ite (<= (to_rep a__first) (to_rep a__last)) (+ (- (to_rep a__last) (to_rep a__first)) 1) 0))))
(check-sat)
(exit)
