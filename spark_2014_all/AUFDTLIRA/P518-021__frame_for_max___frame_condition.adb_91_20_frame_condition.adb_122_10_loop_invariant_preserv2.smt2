...
(assert (and (forall ((i Int)) (=> (and (<= first3 i) (<= i k2)) (forall ((j Int)) (=> (and (<= i j) (<= j k2)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a2 i)))) (get_max_left j a2)))))) (forall ((i Int)) (=> (and (<= k2 i) (<= i first3)) (forall ((j Int)) (=> (and (<= i j) (<= j first3)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a2 j)))) (get_max_left i a2))))))))
...
(assert (not (= k2 last3)))
(assert (and (= o27 (+ k2 1)) (in_range1 (+ k2 1))))
...
(assert (= result10 (mk_int__ref c238b2)))
(assert (= c238b3 k3))
(assert (in_range3 c238b3))
(assert (= result11 (mk_int__ref c239b2)))
(assert (= c239b3 max4))
(assert (in_range2 c239b3))
(assert (= (to_rep o46) c239b3))
(assert (= (rec__frame_condition__cell__value (us_split_fields1 (select a2 c238b3))) o47))
(assert (= o46 o48))
(assert (= (rec__frame_condition__cell__max_right (us_split_fields1 (select a2 c238b3))) o49))
(assert (= o50 (mk___rep (mk___split_fields o47 o48 o49))))
(assert (and (<= (to_rep1 a__first) c238b3) (<= c238b3 (to_rep1 a__last))))
(assert (= o51 c238b3))
...
(assert (<= i j))
(assert (<= j k3))
(assert (not (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a3 i)))) (get_max_left j a3))))
(check-sat)
(exit)
