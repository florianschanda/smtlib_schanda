...
(declare-fun temp_____aggregate_def_241 (Int Int Int) us_t2)
(declare-sort t3 0)
...
(assert (forall ((temp___243 Int) (temp___244 Int) (temp___245 Int)) (let ((temp___242 (temp_____aggregate_def_241 temp___243 temp___244 temp___245))) (=> (dynamic_invariant1 temp___243 true true true true) (and (=> (dynamic_property7 0 2147483647 temp___244 temp___245) (and (= (first5 temp___242) temp___244) (= (last5 temp___242) temp___245))) (forall ((temp___246 Int)) (= (select (to_array2 temp___242) temp___246) rliteral)))))))
...
(assert (= (to_rep (rec__main__branch_type__m_height branch__split_discrs)) r6b))
(assert (in_range2 r6b))
(assert (= (to_rep1 (first4 (rt2 (temp_____aggregate_def_241 0 0 r6b)))) 0))
(assert (= (to_rep1 (last4 (rt2 (temp_____aggregate_def_241 0 0 r6b)))) r6b))
(assert (= (mk___t2 temp___248 temp___2481) (temp_____aggregate_def_241 0 0 r6b)))
(assert (= (ite (<= (to_rep1 (first4 temp___2481)) (to_rep1 (last4 temp___2481))) (+ (- (to_rep1 (last4 temp___2481)) (to_rep1 (first4 temp___2481))) 1) 0) (ite (<= 0 r6b) (+ (- r6b 0) 1) 0)))
(assert (= temp___248 temp___249))
(assert (= (mk1 (to_rep1 (first4 temp___2481)) (to_rep1 (last4 temp___2481))) temp___2491))
(assert (= (ite (<= (to_rep1 (first2 temp___2491)) (to_rep1 (last2 temp___2491))) (+ (- (to_rep1 (last2 temp___2491)) (to_rep1 (first2 temp___2491))) 1) 0) (ite (<= (to_rep1 (first branch__split_fields1)) (to_rep1 (last branch__split_fields1))) (+ (- (to_rep1 (last branch__split_fields1)) (to_rep1 (first branch__split_fields1))) 1) 0)))
(assert (= (mk___t1 temp___251 temp___2511) (mk___t1 temp___249 temp___2491)))
(assert (= temp___251 o))
(assert (= (mk (to_rep1 (first2 temp___2511)) (to_rep1 (last2 temp___2511))) o1))
(assert (= o2 o))
(assert (= o3 o1))
...
(assert (= branch__split_discrs (mk___split_discrs temp___253)))
(assert (= (to_rep1 (last (rt (rec__main__branch_type__m_nodes branch__split_fields2)))) r9b))
