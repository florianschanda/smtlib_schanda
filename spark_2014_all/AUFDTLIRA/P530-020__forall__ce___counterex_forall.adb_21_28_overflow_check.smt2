...
(assert (<= 1 x1))
(assert (<= x1 100))
(assert (and (forall ((temp___167 Int)) (=> (and (<= (- 2147483648) temp___167) (<= temp___167 2147483647)) (=> (<= x2 temp___167) (= (select r1 temp___167) (select r temp___167))))) (and (<= 1 x2) (<= x2 100))))
(assert (= result1 y))
(assert (= y1 1))
(assert (<= 1 y1))
(assert (<= y1 200))
(assert (not (in_range1 (+ (to_rep (select r1 x2)) y1))))
(check-sat)
(exit)
