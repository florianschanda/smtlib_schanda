...
(assert (<= 1 x1))
(assert (<= x1 100))
(assert (and (forall ((temp___191 Int)) (=> (and (<= (- 2147483648) temp___191) (<= temp___191 2147483647)) (=> (<= x2 temp___191) (= (select r1 temp___191) (select r temp___191))))) (and (<= 1 x2) (<= x2 100))))
(assert (= result1 y))
(assert (= y1 1))
(assert (<= 1 y1))
(assert (<= y1 200))
