...
(define-fun dynamic_invariant3 ((temp___expr_202 us_t3) (temp___is_init_198 Bool) (temp___skip_constant_199 Bool) (temp___do_toplevel_200 Bool) (temp___do_typ_inv_201 Bool)) Bool (=> (not (= temp___skip_constant_199 true)) (dynamic_property7 0 2147483647 (first7 temp___expr_202) (last7 temp___expr_202))))
(assert (forall ((temp___243 Int) (temp___244 Int) (temp___245 Int)) (let ((temp___242 (temp___241 temp___243 temp___244 temp___245))) (=> (dynamic_invariant1 temp___243 true true true true) (and (=> (dynamic_property7 0 2147483647 temp___244 temp___245) (and (= (first5 temp___242) temp___244) (= (last5 temp___242) temp___245))) (forall ((temp___246 Int)) (= (to_rep (select (to_array2 temp___242) temp___246)) temp___243)))))))
(define-fun dynamic_invariant4 ((temp___expr_217 us_t1) (temp___is_init_213 Bool) (temp___skip_constant_214 Bool) (temp___do_toplevel_215 Bool) (temp___do_typ_inv_216 Bool)) Bool (=> (not (= temp___skip_constant_214 true)) (and (dynamic_property3 0 r6b (first3 temp___expr_217) (last3 temp___expr_217)) (and (= (first3 temp___expr_217) 0) (= (last3 temp___expr_217) r6b)))))
...
(declare-const temp___2511 t1)
(declare-const o (Array Int integer))
(declare-const o1 t)
(declare-const o2 (Array Int integer))
(declare-const o3 t)
(declare-const temp___253 natural)
(declare-const temp___2531 (Array Int integer))
(declare-const temp___2532 t)
...
(assert (= (to_rep (first4 (rt2 (temp___241 0 0 r6b)))) 0))
(assert (= (to_rep (last4 (rt2 (temp___241 0 0 r6b)))) r6b))
(assert (= (mk___t2 temp___248 temp___2481) (temp___241 0 0 r6b)))
(assert (= (ite (<= (to_rep (first4 temp___2481)) (to_rep (last4 temp___2481))) (+ (- (to_rep (last4 temp___2481)) (to_rep (first4 temp___2481))) 1) 0) (ite (<= 0 r6b) (+ (- r6b 0) 1) 0)))
(assert (= temp___248 temp___249))
(assert (= (mk1 (to_rep (first4 temp___2481)) (to_rep (last4 temp___2481))) temp___2491))
(assert (= (ite (<= (to_rep (first2 temp___2491)) (to_rep (last2 temp___2491))) (+ (- (to_rep (last2 temp___2491)) (to_rep (first2 temp___2491))) 1) 0) (ite (<= (to_rep (first branch__split_fields1)) (to_rep (last branch__split_fields1))) (+ (- (to_rep (last branch__split_fields1)) (to_rep (first branch__split_fields1))) 1) 0)))
(assert (= (mk___t1 temp___251 temp___2511) (mk___t1 temp___249 temp___2491)))
(assert (= temp___251 o))
(assert (= (mk (to_rep (first2 temp___2511)) (to_rep (last2 temp___2511))) o1))
(assert (= o2 o))
(assert (= o3 o1))
(assert (= branch__split_discrs (mk___split_discrs temp___253)))
(assert (= temp___2531 o2))
(assert (= temp___2532 o3))
(assert (= result (mk___split_fields__ref (mk___split_fields (mk___t branch__split_fields branch__split_fields1)))))
(assert (= branch__split_fields2 (mk___split_fields (mk___t temp___2531 temp___2532))))
(assert (= branch__split_discrs (mk___split_discrs temp___253)))
...
(assert (and (and (and (=> (<= 0 r9b) (dynamic_property6 0 r9b i2)) (dynamic_invariant2 (mk___rep branch__split_discrs branch__split_fields3) false true true true)) (forall ((temp___260 Int)) (=> (and (<= (to_rep (first (rt (rec__main__branch_type__m_nodes branch__split_fields3)))) temp___260) (<= temp___260 (to_rep (last (rt (rec__main__branch_type__m_nodes branch__split_fields3)))))) (=> (<= i2 temp___260) (= (select (elts (rec__main__branch_type__m_nodes branch__split_fields3)) temp___260) (select (elts (rec__main__branch_type__m_nodes branch__split_fields2)) temp___260)))))) (and (<= 0 i2) (<= i2 r9b))))
