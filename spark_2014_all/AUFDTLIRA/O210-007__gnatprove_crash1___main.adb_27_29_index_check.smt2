...
(define-fun dynamic_invariant2 ((temp___expr_178 us_rep) (temp___is_init_175 Bool) (temp___skip_constant_176 Bool) (temp___do_toplevel_177 Bool)) Bool (let ((temp___179 (rec__main__branch_type__m_height (us_split_discrs1 temp___expr_178)))) (and (dynamic_property1 0 (to_rep1 temp___179) (first1 (rec__main__branch_type__m_nodes (us_split_fields1 temp___expr_178))) (last1 (rec__main__branch_type__m_nodes (us_split_fields1 temp___expr_178)))) (and (= (first1 (rec__main__branch_type__m_nodes (us_split_fields1 temp___expr_178))) 0) (= (last1 (rec__main__branch_type__m_nodes (us_split_fields1 temp___expr_178))) (to_rep1 temp___179))))))
...
(assert (forall ((temp___211 Int) (temp___212 Int) (temp___213 Int)) (let ((temp___210 (temp___209 temp___211 temp___212 temp___213))) (and (=> (dynamic_property7 0 2147483647 temp___212 temp___213) (and (= (first5 temp___210) temp___212) (= (last5 temp___210) temp___213))) (forall ((temp___214 Int)) (= (select (to_array2 temp___210) temp___214) (of_rep temp___211)))))))
(define-fun dynamic_invariant3 ((temp___expr_186 us_t1) (temp___is_init_183 Bool) (temp___skip_constant_184 Bool) (temp___do_toplevel_185 Bool)) Bool (=> (not (= temp___skip_constant_184 true)) (and (dynamic_property3 0 r6b (first3 temp___expr_186) (last3 temp___expr_186)) (and (= (first3 temp___expr_186) 0) (= (last3 temp___expr_186) r6b)))))
...
(declare-const o10 t)
(declare-const temp___224 natural)
(declare-const temp___2241 (Array Int integer))
(declare-const temp___2242 t)
...
(assert (= (to_rep1 (rec__main__branch_type__m_height branch__split_discrs)) r6b))
(assert (in_range2 r6b))
(assert (= (to_rep (first4 (rt2 (temp___209 0 0 r6b)))) 0))
(assert (= (to_rep (last4 (rt2 (temp___209 0 0 r6b)))) r6b))
(assert (= (mk___t2 temp___216 temp___2161) (temp___209 0 0 r6b)))
(assert (= (ite (<= (to_rep (first4 temp___2161)) (to_rep (last4 temp___2161))) (+ (- (to_rep (last4 temp___2161)) (to_rep (first4 temp___2161))) 1) 0) (ite (<= 0 r6b) (+ (- r6b 0) 1) 0)))
(assert (= temp___216 temp___217))
(assert (= (mk1 (to_rep (first4 temp___2161)) (to_rep (last4 temp___2161))) temp___2171))
(assert (= (ite (<= (to_rep (first2 temp___2171)) (to_rep (last2 temp___2171))) (+ (- (to_rep (last2 temp___2171)) (to_rep (first2 temp___2171))) 1) 0) (ite (<= (to_rep (first branch__split_fields1)) (to_rep (last branch__split_fields1))) (+ (- (to_rep (last branch__split_fields1)) (to_rep (first branch__split_fields1))) 1) 0)))
(assert (= (mk___t1 temp___219 temp___2191) (mk___t1 temp___217 temp___2171)))
(assert (= temp___219 o))
(assert (= (mk (to_rep (first2 temp___2191)) (to_rep (last2 temp___2191))) o1))
(assert (= o2 o))
(assert (= o3 o1))
(assert (= branch__split_discrs (mk___split_discrs temp___221)))
(assert (= temp___2211 o2))
(assert (= temp___2212 o3))
(assert (= result (mk___split_fields__ref (mk___split_fields (mk___t branch__split_fields branch__split_fields1)))))
(assert (= branch__split_fields2 (mk___split_fields (mk___t temp___2211 temp___2212))))
(assert (= branch__split_discrs (mk___split_discrs temp___221)))
(assert (= (to_rep (last (rt (rec__main__branch_type__m_nodes branch__split_fields2)))) r9b))
...
(assert (and (and (and (=> (<= 0 r9b) (dynamic_property6 0 r9b i2)) (dynamic_invariant2 (mk___rep branch__split_discrs branch__split_fields3) false true true)) (forall ((temp___228 Int)) (=> (and (<= (to_rep (first (rt (rec__main__branch_type__m_nodes branch__split_fields3)))) temp___228) (<= temp___228 (to_rep (last (rt (rec__main__branch_type__m_nodes branch__split_fields3)))))) (=> (<= i2 temp___228) (= (select (elts (rec__main__branch_type__m_nodes branch__split_fields3)) temp___228) (select (elts (rec__main__branch_type__m_nodes branch__split_fields2)) temp___228)))))) (and (<= 0 i2) (<= i2 r9b))))
(assert (= i2 (to_rep (last (rt (rec__main__branch_type__m_nodes branch__split_fields3))))))
(assert (= (to_rep (last (rt (rec__main__branch_type__m_nodes branch__split_fields3)))) r11b))
(assert (in_range1 r11b))
(assert (and (<= 0 i2) (<= i2 r11b)))
(assert (= (to_rep o4) 0))
