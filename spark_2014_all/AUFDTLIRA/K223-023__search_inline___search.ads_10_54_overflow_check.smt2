...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 10)) (and (and (= temp___151 i1) (and (= temp___150 pos2) (and (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- i2 1))) (not (= (to_rep (select t j1)) v)))) (and (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 pos3)) (=> (<= 1 10) (in_range3 i2))) (and (<= 1 i2) (<= i2 10))) (or (and (and (= pos4 pos5) (= pos6 pos4)) (and (= (to_rep (select t i2)) v) (and (= pos3 result2) (= pos4 i2)))) (and (and (not (= (to_rep (select t i2)) v)) (= pos4 pos3)) (and (and (= pos4 pos5) (= pos6 pos4)) (= i2 10)))))))) (and (and (= i2 i6) (= (mk_int__ref pos9) (mk_int__ref pos5))) (and (= i7 i2) (= pos10 pos6))))))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= (mk_int__ref i8) (mk_int__ref i6))))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= (mk_int__ref pos11) (mk_int__ref pos9))))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= i9 i7)))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= pos12 pos10)))
(assert (=> (not (and (<= 1 i1) (<= i1 10))) (= i1 i8)))
(assert (=> (not (and (<= 1 i1) (<= i1 10))) (= pos2 pos11)))
(assert (=> (not (and (<= 1 i1) (<= i1 10))) (= i9 i1)))
(assert (=> (not (and (<= 1 i1) (<= i1 10))) (= pos12 pos2)))
(assert (= search__search__result1 search__search__result2))
(assert (= search__search__result3 search__search__result1))
(assert (= (mk_int__ref result4) (mk_int__ref search__search__result)))
(assert (= search__search__result1 pos11))
(assert (= (mk_int__ref search__search__result4) (mk_int__ref search__search__result2)))
(assert (= (mk_int__ref i10) (mk_int__ref i8)))
(assert (= (mk_int__ref pos13) (mk_int__ref pos11)))
(assert (= search__search__result5 search__search__result3))
(assert (= i11 i9))
(assert (= pos14 pos12))
(assert (=> (= search__search__result4 0) (= (= result5 true) (forall ((pos15 Int)) (=> (and (<= 1 pos15) (<= pos15 10)) (not (= (to_rep (select t pos15)) v)))))))
(assert (=> (not (= search__search__result4 0)) (= result5 (of_int 1))))
(assert (= result5 true))
(assert (and (<= 1 search__search__result4) (<= search__search__result4 10)))
(assert (= o search__search__result4))
(assert (= o1 (select t o)))
(assert (= o2 (to_rep o1)))
(assert (= result6 (ite (= o2 v) true false)))
(assert (= result6 true))
