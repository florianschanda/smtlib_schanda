...
(define-fun dynamic_invariant1 ((temp___expr_151 Int) (temp___is_init_148 Bool) (temp___skip_constant_149 Bool) (temp___do_toplevel_150 Bool)) Bool (=> (or (= temp___is_init_148 true) (<= 0 100)) (in_range2 temp___expr_151)))
(define-fun dynamic_invariant2 ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= 1 100)) (in_range1 temp___expr_136)))
...
(declare-const temp___1831 pointer_range)
...
(declare-const temp___1871 pointer_range)
...
(declare-const s__split_fields8 (Array Int integer))
(declare-const s__split_fields9 pointer_range)
(assert (in_range x))
(assert (not (= (is_full (mk___rep (mk___split_fields s__split_fields s__split_fields1))) true)))
(assert (and (= o (+ (to_rep1 s__split_fields1) 1)) (in_range2 (+ (to_rep1 s__split_fields1) 1))))
(assert (= (to_rep1 o1) o))
...
(assert (= (to_rep o4) x))
(assert (and (<= 1 (to_rep1 s__split_fields3)) (<= (to_rep1 s__split_fields3) 100)))
(assert (= o5 (to_rep1 s__split_fields3)))
(assert (= o6 (store s__split_fields2 o5 o4)))
(assert (= o6 o7))
(assert (= s__split_fields3 o8))
(assert (= temp___187 o7))
(assert (= temp___1871 o8))
(assert (= result2 s__split_fields2))
(assert (= result3 s__split_fields3))
(assert (= temp___187 s__split_fields4))
(assert (= temp___1871 s__split_fields5))
(assert (= s__split_fields6 s__split_fields4))
(assert (= s__split_fields7 s__split_fields5))
(assert (= s__split_fields8 s__split_fields4))
(assert (= s__split_fields9 s__split_fields5))
