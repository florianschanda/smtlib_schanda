...
(define-fun dynamic_invariant ((temp___expr_303 us_t1) (temp___is_init_300 Bool) (temp___skip_constant_301 Bool) (temp___do_toplevel_302 Bool)) Bool (and (=> (not (= temp___skip_constant_301 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_303) (last3 temp___expr_303))) (=> (= temp___do_toplevel_302 true) (=> (= temp___is_init_300 true) (and (let ((temp___305 (of_array2 (to_array1 temp___expr_303) (first3 temp___expr_303) (last3 temp___expr_303)))) (and (= (first5 temp___305) 1) (<= 0 (last5 temp___305)))) (<= (last3 temp___expr_303) 12))))))
(define-fun dynamic_predicate ((temp___307 us_t1)) Bool (and (let ((temp___309 (of_array2 (to_array1 temp___307) (first3 temp___307) (last3 temp___307)))) (and (= (first5 temp___309) 1) (<= 0 (last5 temp___309)))) (<= (last3 temp___307) 12)))
...
(define-fun dynamic_invariant1 ((temp___expr_1040 Int) (temp___is_init_1037 Bool) (temp___skip_constant_1038 Bool) (temp___do_toplevel_1039 Bool)) Bool (=> (or (= temp___is_init_1037 true) (<= 0 1)) (in_range3 temp___expr_1040)))
(declare-const x Int)
...
(declare-const temp___1341 (Array Int character))
(declare-const temp___13411 t1)
(assert (in_range3 x))
