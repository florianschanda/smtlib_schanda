...
(define-fun dynamic_invariant1 ((temp___expr_1170 Int) (temp___is_init_1166 Bool) (temp___skip_constant_1167 Bool) (temp___do_toplevel_1168 Bool) (temp___do_typ_inv_1169 Bool)) Bool (=> (or (= temp___is_init_1166 true) (<= 0 1)) (in_range3 temp___expr_1170)))
(declare-const x Int)
