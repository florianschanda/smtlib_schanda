...
(declare-fun temp_____aggregate_def_3126 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___3128 (Array Int et1))) (forall ((temp___3129 Int) (temp___3130 Int)) (let ((temp___3127 (temp_____aggregate_def_3126 temp___3128 temp___3129 temp___3130))) (=> (and (dynamic_invariant temp___3129 true true true true) (dynamic_invariant1 temp___3130 true true true true)) (forall ((temp___3131 Int)) (ite (= temp___3131 temp___3129) (= (to_rep (select temp___3127 temp___3131)) temp___3130) (= (select temp___3127 temp___3131) (select temp___3128 temp___3131)))))))))
(declare-const r__split_fields (Array Int et1))
(declare-const r__split_fields1 enum2t)
(declare-const o enum2t)
(declare-const o1 (Array Int et1))
(declare-const o2 enum2t)
(declare-const temp___8050 (Array Int et1))
(declare-const temp___80501 enum2t)
(declare-const o3 et1)
(declare-const o4 (Array Int et1))
(declare-const o5 (Array Int et1))
(declare-const o6 enum2t)
(declare-const temp___8053 (Array Int et1))
(declare-const temp___80531 enum2t)
...
(assert (= o o2))
(assert (= temp___8050 o1))
(assert (= temp___80501 o2))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= temp___8050 r__split_fields2))
(assert (= temp___80501 r__split_fields3))
(assert (= (to_rep o3) e))
(assert (= o4 (store r__split_fields2 i o3)))
(assert (= o4 o5))
(assert (= r__split_fields3 o6))
(assert (= temp___8053 o5))
(assert (= temp___80531 o6))
(assert (= result2 r__split_fields2))
(assert (= result3 r__split_fields3))
(assert (= temp___8053 r__split_fields4))
(assert (= temp___80531 r__split_fields5))
...
(assert (not (= (bool_eq r__split_fields6 1 10 (temp_____aggregate_def_3126 r__split_fields i e) 1 10) true)))
(check-sat)
(exit)
