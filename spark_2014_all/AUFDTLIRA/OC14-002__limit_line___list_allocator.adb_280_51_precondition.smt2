...
(assert (not (= first_available2 0)))
(assert (and (= o133 (length (rec__list_allocator__m__t__available model____split_fields4))) (in_range6 o133)))
(assert (= result32 (ite (< 0 o133) true false)))
