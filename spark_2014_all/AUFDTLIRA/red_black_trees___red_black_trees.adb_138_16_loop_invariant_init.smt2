...
(assert (or (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 j7)))) n2) (and (< j7 i5) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 j7)))) (+ n2 1)))))
(assert (= (rec__red_black_trees__black_count__status (us_split_fields11 (select res2 j7))) true))
(assert (not (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res2 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j7 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res2 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j7 1))))))))
(check-sat)
(exit)
