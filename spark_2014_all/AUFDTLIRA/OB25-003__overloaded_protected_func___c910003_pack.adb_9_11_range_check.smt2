...
(define-fun default_initial_assumption ((temp___expr_218 us_rep) (temp___skip_top_level_219 Bool)) Bool (and (and (and (= (to_rep2 (rec__c910003_pack__buffer__saved_item (us_split_fields1 temp___expr_218))) 1) (= (rec__c910003_pack__buffer__empty (us_split_fields1 temp___expr_218)) (distinct 1 0))) (= (rec__c910003_pack__buffer__tc_items (us_split_fields1 temp___expr_218)) (temp___220 1))) (= (to_rep (rec__c910003_pack__buffer__tc_last (us_split_fields1 temp___expr_218))) 0)))
(declare-const x Int)
...
(assert (forall ((temp___222 Int)) (=> (dynamic_invariant3 temp___222 true true true true) (forall ((temp___223 Int)) (= (to_rep2 (select (temp___220 temp___222) temp___223)) temp___222)))))
