...
(define-fun bool_eq ((a (Array Int item_type)) (a__first Int) (a__last Int) (b (Array Int item_type)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_132 Int)) (=> (and (<= a__first temp___idx_132) (<= temp___idx_132 a__last)) (= (to_rep2 (select a temp___idx_132)) (to_rep2 (select b (+ (- b__first a__first) temp___idx_132))))))) true false))
...
(assert (forall ((a (Array Int item_type)) (b (Array Int item_type))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep2 (select a (+ i 1))) (to_rep2 (select b (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int item_type)) (b (Array Int item_type))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep2 (select b (+ i 1))) (to_rep2 (select a (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(declare-sort t 0)
...
(assert (forall ((temp___191 Int)) (forall ((temp___192 Int)) (= (select (temp___189 temp___191) temp___192) (of_rep2 temp___191)))))
(define-fun default_initial_assumption ((temp___expr_187 us_rep) (temp___skip_top_level_188 Bool)) Bool (and (and (and (= (to_rep2 (rec__c910003_pack__buffer__saved_item (us_split_fields1 temp___expr_187))) 1) (= (rec__c910003_pack__buffer__empty (us_split_fields1 temp___expr_187)) (of_int 1))) (= (rec__c910003_pack__buffer__tc_items (us_split_fields1 temp___expr_187)) (temp___189 1))) (= (to_rep (rec__c910003_pack__buffer__tc_last (us_split_fields1 temp___expr_187))) 0)))
(declare-const x Int)
...
(define-fun dynamic_invariant3 ((temp___expr_174 Int) (temp___is_init_171 Bool) (temp___skip_constant_172 Bool) (temp___do_toplevel_173 Bool)) Bool (=> (or (= temp___is_init_171 true) (<= 1 100)) (in_range3 temp___expr_174)))
(define-fun dynamic_invariant4 ((temp___expr_180 us_t) (temp___is_init_177 Bool) (temp___skip_constant_178 Bool) (temp___do_toplevel_179 Bool)) Bool (=> (not (= temp___skip_constant_178 true)) (dynamic_property 1 2147483647 (first1 temp___expr_180) (last1 temp___expr_180))))
