...
(assert (= test__f1__result1 (to_rep (rec__test__t__a (us_split_fields1 x)))))
(assert (= (mk_int__ref test__f1__result4) (mk_int__ref test__f1__result2)))
(assert (= test__f1__result5 test__f1__result3))
(assert (= result1 test__f1__result4))
(assert (not (< 10 test__f1__result4)))
(check-sat)
(exit)
