...
(assert (= d1 0))
(assert (in_range5 d1))
(assert (=> (not (= current1 0)) (= temp___666 d1)))
(assert (=> (not (= current1 0)) (= temp___665 previous1)))
(assert (=> (not (= current1 0)) (= temp___664 current1)))
(assert (=> (not (= current1 0)) (= 0 temp___690)))
(assert (=> (not (= current1 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) current2))) true)))
(assert (=> (not (= current1 0)) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i1))) true) (=> (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i1))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) current2)))) true) (ite (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) current2))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i1)))) 1)) 0) (< v (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i1))) (< (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i1)) v))))))))
(assert (=> (not (= current1 0)) (and (and (and (=> (<= 0 100) (in_range4 current2)) (=> (<= 0 100) (in_range4 previous2))) (=> (<= 0 1) (in_range5 d2))) (not (= current2 0)))))
(assert (=> (not (= current1 0)) (= result5 (mk_int__ref temp___6901))))
(assert (=> (not (= current1 0)) (= temp___6902 (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) current2)))))))
(assert (=> (not (= current1 0)) (= result6 (mk_int__ref previous2))))
(assert (=> (not (= current1 0)) (= previous3 current2)))
(assert (=> (not (= current1 0)) (and (<= 1 current2) (<= current2 100))))
(assert (=> (not (= current1 0)) (= o36 current2)))
(assert (=> (not (= current1 0)) (= o37 (select (rec__search_trees__search_tree__values (us_split_fields7 t)) o36))))
(assert (=> (not (= current1 0)) (= o38 (to_rep o37))))
(assert (=> (not (= current1 0)) (= result7 (ite (= v o38) true false))))
(assert (=> (not (= current1 0)) (not (= result7 true))))
(assert (=> (not (= current1 0)) (and (<= 1 current2) (<= current2 100))))
(assert (=> (not (= current1 0)) (= o39 current2)))
(assert (=> (not (= current1 0)) (= o40 (select (rec__search_trees__search_tree__values (us_split_fields7 t)) o39))))
(assert (=> (not (= current1 0)) (= o41 (to_rep o40))))
(assert (=> (not (= current1 0)) (= result9 (ite (< v o41) true false))))
(assert (=> (not (= current1 0)) (=> (= result9 true) (= result10 (mk_int__ref d2)))))
(assert (=> (not (= current1 0)) (=> (= result9 true) (= d3 0))))
(assert (=> (not (= current1 0)) (=> (= result9 true) (and (= o42 current2) (in_range3 current2)))))
(assert (=> (not (= current1 0)) (=> (= result9 true) (and (= o43 (peek (rec__search_trees__search_tree__struct (us_split_fields7 t)) o42 0)) (and (in_range4 o43) (and (ite (not (= o43 0)) (and (= (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) o43) 0) (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) o43) o42)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) j) o42) (not (= (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) j) 0)))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) j) o42) (= (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) j) 0)) (= o43 j))))))))))
(assert (=> (not (= current1 0)) (=> (= result9 true) (= result11 (mk_int__ref current2)))))
(assert (=> (not (= current1 0)) (=> (= result9 true) (= current3 o43))))
(assert (=> (not (= current1 0)) (=> (not (= result9 true)) (= result12 (mk_int__ref d2)))))
(assert (=> (not (= current1 0)) (=> (not (= result9 true)) (= d4 1))))
(assert (=> (not (= current1 0)) (=> (not (= result9 true)) (and (= o44 current2) (in_range3 current2)))))
(assert (=> (not (= current1 0)) (=> (not (= result9 true)) (and (= o45 (peek (rec__search_trees__search_tree__struct (us_split_fields7 t)) o44 1)) (and (in_range4 o45) (and (ite (not (= o45 0)) (and (= (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) o45) 1) (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) o45) o44)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) j) o44) (not (= (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) j) 1)))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) j) o44) (= (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) j) 1)) (= o45 j))))))))))
(assert (=> (not (= current1 0)) (=> (not (= result9 true)) (= result13 (mk_int__ref current2)))))
(assert (=> (not (= current1 0)) (=> (not (= result9 true)) (= current4 o45))))
(assert (=> (not (= current1 0)) (=> (not (= result9 true)) (= d3 d4))))
(assert (=> (not (= current1 0)) (=> (not (= result9 true)) (= current3 current4))))
(assert (=> (not (= current1 0)) (= search_trees__contains__result3 search_trees__contains__result2)))
(assert (=> (not (= current1 0)) (= current3 0)))
(assert (=> (not (= current1 0)) (= search_trees__contains__result4 (mk_bool__ref search_trees__contains__result3))))
(assert (=> (not (= current1 0)) (= d5 (mk_int__ref d3))))
(assert (=> (not (= current1 0)) (= previous4 (mk_int__ref previous3))))
(assert (=> (not (= current1 0)) (= current5 (mk_int__ref current3))))
(assert (=> (not (= current1 0)) (= search_trees__contains__result5 search_trees__contains__result3)))
(assert (=> (not (= current1 0)) (= d6 d3)))
(assert (=> (not (= current1 0)) (= previous5 previous3)))
(assert (=> (not (= current1 0)) (= current6 current3)))
(assert (=> (not (= current1 0)) (= search_trees__contains__result6 search_trees__contains__result4)))
(assert (=> (not (= current1 0)) (= d7 d5)))
(assert (=> (not (= current1 0)) (= previous6 previous4)))
(assert (=> (not (= current1 0)) (= current7 current5)))
(assert (=> (not (= current1 0)) (= search_trees__contains__result7 search_trees__contains__result5)))
(assert (=> (not (= current1 0)) (= d8 d6)))
(assert (=> (not (= current1 0)) (= previous7 previous5)))
(assert (=> (not (= current1 0)) (= current8 current6)))
(assert (=> (= current1 0) (= search_trees__contains__result6 (mk_bool__ref search_trees__contains__result))))
(assert (=> (= current1 0) (= d7 (mk_int__ref d1))))
(assert (=> (= current1 0) (= previous6 (mk_int__ref previous1))))
(assert (=> (= current1 0) (= current7 (mk_int__ref current1))))
(assert (=> (= current1 0) (= search_trees__contains__result7 search_trees__contains__result1)))
(assert (=> (= current1 0) (= d8 d1)))
(assert (=> (= current1 0) (= previous7 previous1)))
(assert (=> (= current1 0) (= current8 current1)))
(assert (and (= o47 (size (rec__search_trees__search_tree__struct (us_split_fields7 t)))) (in_range4 o47)))
(assert (= result14 (ite (< 0 o47) true false)))
