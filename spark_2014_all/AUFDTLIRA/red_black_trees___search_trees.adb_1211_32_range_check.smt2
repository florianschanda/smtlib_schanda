...
(assert (=> (not (= current1 0)) (and (and (=> (<= 0 100) (in_range4 current2)) (=> (<= 0 100) (in_range4 previous2))) (=> (<= 0 1) (in_range5 d2)))))
(assert (=> (not (= current1 0)) (= result3 (mk_int__ref temp___6901))))
