...
(assert (= d1 0))
(assert (in_range5 d1))
(assert (=> (not (= current1 0)) (= temp___710 d1)))
(assert (=> (not (= current1 0)) (= temp___709 previous1)))
(assert (=> (not (= current1 0)) (= temp___708 current1)))
(assert (=> (not (= current1 0)) (= 0 temp___734)))
...
(assert (=> (not (= current1 0)) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i))) true) (=> (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) current2)))) true) (ite (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) current2))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i)))) 1)) 0) (< v (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i))) (< (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i)) v))))))))
(assert (=> (not (= current1 0)) (and (and (and (=> (<= 0 100) (in_range4 current2)) (=> (<= 0 100) (in_range4 previous2))) (=> (<= 0 1) (in_range5 d2))) (not (= current2 0)))))
(assert (=> (not (= current1 0)) (= result3 (mk_int__ref temp___7341))))
(assert (=> (not (= current1 0)) (= temp___7342 (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) current2)))))))
...
(assert (=> (not (= current1 0)) (= o current2)))
(assert (=> (not (= current1 0)) (= o1 (select (rec__search_trees__search_tree__values (us_split_fields7 t)) o))))
...
(assert (=> (not (= current1 0)) (and (<= 1 current2) (<= current2 100))))
(assert (=> (not (= current1 0)) (= o3 current2)))
(assert (=> (not (= current1 0)) (= o4 (select (rec__search_trees__search_tree__values (us_split_fields7 t)) o3))))
...
(assert (=> (not (not (= current1 0))) (= search_trees__contains__result6 (mk_bool__ref search_trees__contains__result))))
(assert (=> (not (not (= current1 0))) (= d7 (mk_int__ref d1))))
(assert (=> (not (not (= current1 0))) (= previous6 (mk_int__ref previous1))))
(assert (=> (not (not (= current1 0))) (= current7 (mk_int__ref current1))))
(assert (=> (not (not (= current1 0))) (= search_trees__contains__result7 search_trees__contains__result1)))
(assert (=> (not (not (= current1 0))) (= d8 d1)))
(assert (=> (not (not (= current1 0))) (= previous7 previous1)))
(assert (=> (not (not (= current1 0))) (= current8 current1)))
(assert (and (= o10 (size (rec__search_trees__search_tree__struct (us_split_fields7 t)))) (in_range4 o10)))
(assert (= result11 (ite (< 0 o10) true false)))
