...
(declare-const dummy event_count_type)
...
(define-fun dynamic_invariant ((temp___expr_216 Int) (temp___is_init_213 Bool) (temp___skip_constant_214 Bool) (temp___do_toplevel_215 Bool)) Bool (=> (or (= temp___is_init_213 true) (<= 0 64)) (in_range1 temp___expr_216)))
...
(declare-const dummy10 description_count_type)
...
(assert (forall ((x description_count_type)) (! (= (of_rep6 (to_rep6 x)) x) :pattern ((to_rep6 x)))))
(assert (forall ((x description_count_type)) (! (in_range8 (to_rep6 x)) :pattern ((to_rep6 x)))))
...
(assert (forall ((x character)) (! (in_range9 (to_rep7 x)) :pattern ((to_rep7 x)))))
...
(assert (forall ((a (Array Int character)) (b (Array Int character))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq3 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_78 Int)) (=> (and (<= a__first temp___idx_78) (<= temp___idx_78 a__last)) (= (to_rep7 (select a temp___idx_78)) (to_rep7 (select b (+ (- b__first a__first) temp___idx_78)))))))))))
...
(assert (forall ((a (Array Int character)) (b (Array Int character))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq3 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep7 (select a (+ i 1))) (to_rep7 (select b (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int character)) (b (Array Int character))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq3 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep7 (select b (+ i 1))) (to_rep7 (select a (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
...
(define-fun bool_eq4 ((a us_rep3) (b us_rep3)) Bool (ite (and (and (and (= (bool_eq3 (rec__datebook__event_record__description_text (us_split_fields7 a)) 1 128 (rec__datebook__event_record__description_text (us_split_fields7 b)) 1 128) true) (= (to_rep6 (rec__datebook__event_record__description_size (us_split_fields7 a))) (to_rep6 (rec__datebook__event_record__description_size (us_split_fields7 b))))) (= (bool_eq2 (rec__datebook__event_record__date (us_split_fields7 a)) (rec__datebook__event_record__date (us_split_fields7 b))) true)) (= (rec__datebook__event_record__is_used (us_split_fields7 a)) (rec__datebook__event_record__is_used (us_split_fields7 b)))) true false))
...
(declare-const dummy14 event_index_type)
...
(define-fun dynamic_invariant1 ((temp___expr_63 Int) (temp___is_init_60 Bool) (temp___skip_constant_61 Bool) (temp___do_toplevel_62 Bool)) Bool (=> (or (= temp___is_init_60 true) (<= 0 255)) (in_range9 temp___expr_63)))
(define-fun dynamic_invariant2 ((temp___expr_257 Int) (temp___is_init_254 Bool) (temp___skip_constant_255 Bool) (temp___do_toplevel_256 Bool)) Bool (=> (or (= temp___is_init_254 true) (<= 0 128)) (in_range8 temp___expr_257)))
(define-fun dynamic_invariant3 ((temp___expr_293 Int) (temp___is_init_290 Bool) (temp___skip_constant_291 Bool) (temp___do_toplevel_292 Bool)) Bool (=> (or (= temp___is_init_290 true) (<= 1 64)) (in_range10 temp___expr_293)))
(define-fun dynamic_invariant4 ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= 2000 2099)) (in_range2 temp___expr_136)))
(define-fun dynamic_invariant5 ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= 1 12)) (in_range3 temp___expr_142)))
(define-fun dynamic_invariant6 ((temp___expr_148 Int) (temp___is_init_145 Bool) (temp___skip_constant_146 Bool) (temp___do_toplevel_147 Bool)) Bool (=> (or (= temp___is_init_145 true) (<= 1 31)) (in_range4 temp___expr_148)))
(define-fun dynamic_invariant7 ((temp___expr_154 Int) (temp___is_init_151 Bool) (temp___skip_constant_152 Bool) (temp___do_toplevel_153 Bool)) Bool (=> (or (= temp___is_init_151 true) (<= 0 23)) (in_range5 temp___expr_154)))
(define-fun dynamic_invariant8 ((temp___expr_160 Int) (temp___is_init_157 Bool) (temp___skip_constant_158 Bool) (temp___do_toplevel_159 Bool)) Bool (=> (or (= temp___is_init_157 true) (<= 0 59)) (in_range6 temp___expr_160)))
(define-fun dynamic_invariant9 ((temp___expr_166 Int) (temp___is_init_163 Bool) (temp___skip_constant_164 Bool) (temp___do_toplevel_165 Bool)) Bool (=> (or (= temp___is_init_163 true) (<= 0 59)) (in_range7 temp___expr_166)))
