...
(assert (= o25 (ite (<= o24 (- (to_rep1 (rec__patience__state__numstacks (us_split_fields1 s))) 1)) true false)))
(assert (and (<= 0 i) (<= i 99)))
(assert (= o19 i))
...
(assert (=> (= result2 true) (= temp___438 (to_rep1 o11))))
...
(assert (= temp___444 (to_rep1 o4)))
(assert (not (<= 0 temp___444)))
(check-sat)
(exit)
