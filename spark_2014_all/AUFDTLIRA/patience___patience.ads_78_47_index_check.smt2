...
(assert (= result4 true))
(assert (<= 0 i3))
(assert (<= i3 (- (to_rep1 (rec__patience__state__numelts (us_split_fields1 s))) 1)))
(assert (and (<= 0 i3) (<= i3 99)))
(assert (= o106 i3))
(assert (= o107 (select (rec__patience__state__posstack (us_split_fields1 s)) o106)))
(assert (= o108 (to_rep1 o107)))
(assert (= o109 (ite (<= o108 (- (to_rep1 (rec__patience__state__numstacks (us_split_fields1 s))) 1)) true false)))
(assert (and (<= 0 i3) (<= i3 99)))
(assert (= o103 i3))
(assert (= o104 (select (rec__patience__state__posstack (us_split_fields1 s)) o103)))
(assert (= o105 (to_rep1 o104)))
(assert (= o110 (ite (<= 0 o105) true false)))
(assert (= result7 (ite (= o110 true) o109 false)))
(assert (=> (= result7 true) (and (<= 0 i3) (<= i3 99))))
(assert (=> (= result7 true) (= o94 i3)))
(assert (=> (= result7 true) (= o95 (select (rec__patience__state__posstack (us_split_fields1 s)) o94))))
(assert (=> (= result7 true) (= temp___408 (to_rep1 o95))))
(assert (=> (= result7 true) (and (<= 0 temp___408) (<= temp___408 99))))
(assert (=> (= result7 true) (= o96 temp___408)))
(assert (=> (= result7 true) (= o97 (select (rec__patience__state__stacksizes (us_split_fields1 s)) o96))))
(assert (=> (= result7 true) (= o98 (to_rep1 o97))))
(assert (=> (= result7 true) (= o99 (- o98 1))))
(assert (=> (= result7 true) (and (<= 0 i3) (<= i3 99))))
(assert (=> (= result7 true) (= o92 i3)))
(assert (=> (= result7 true) (= o93 (select (rec__patience__state__posheight (us_split_fields1 s)) o92))))
(assert (=> (= result7 true) (= o100 (to_rep1 o93))))
(assert (=> (= result7 true) (= o101 (ite (<= o100 o99) true false))))
(assert (=> (= result7 true) (and (<= 0 i3) (<= i3 99))))
(assert (=> (= result7 true) (= o89 i3)))
(assert (=> (= result7 true) (= o90 (select (rec__patience__state__posheight (us_split_fields1 s)) o89))))
(assert (=> (= result7 true) (= o91 (to_rep1 o90))))
(assert (=> (= result7 true) (= o102 (ite (<= 0 o91) true false))))
(assert (=> (= result7 true) (= result6 (ite (= o102 true) o101 false))))
(assert (=> (not (= result7 true)) (= result6 false)))
(assert (= result6 true))
(assert (and (<= 0 i3) (<= i3 99)))
(assert (= o84 i3))
(assert (= o85 (select (rec__patience__state__posstack (us_split_fields1 s)) o84)))
(assert (= temp___411 (to_rep1 o85)))
(assert (and (<= 0 temp___411) (<= temp___411 99)))
(assert (= o86 temp___411))
(assert (= temp___412 (select (rec__patience__state__stacks (us_split_fields1 s)) o86)))
(assert (and (<= 0 i3) (<= i3 99)))
(assert (= o87 i3))
(assert (= o88 (select (rec__patience__state__posheight (us_split_fields1 s)) o87)))
(assert (= temp___414 (to_rep1 o88)))
(assert (not (<= 0 temp___414)))
(check-sat)
(exit)
