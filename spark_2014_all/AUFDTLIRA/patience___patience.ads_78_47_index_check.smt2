...
(assert (and (<= 0 i) (<= i 99)))
(assert (= o22 i))
(assert (= o23 (select (rec__patience__state__posstack (us_split_fields1 s)) o22)))
(assert (= o24 (to_rep o23)))
(assert (= o25 (ite (<= o24 (- (to_rep (rec__patience__state__numstacks (us_split_fields1 s))) 1)) true false)))
(assert (and (<= 0 i) (<= i 99)))
(assert (= o19 i))
(assert (= o20 (select (rec__patience__state__posstack (us_split_fields1 s)) o19)))
...
(assert (=> (= result2 true) (= o11 (select (rec__patience__state__posstack (us_split_fields1 s)) o10))))
(assert (=> (= result2 true) (= temp___438 (to_rep o11))))
(assert (=> (= result2 true) (and (<= 0 temp___438) (<= temp___438 99))))
(assert (=> (= result2 true) (= o12 temp___438)))
(assert (=> (= result2 true) (= o13 (select (rec__patience__state__stacksizes (us_split_fields1 s)) o12))))
(assert (=> (= result2 true) (= o14 (to_rep o13))))
(assert (=> (= result2 true) (= o15 (- o14 1))))
(assert (=> (= result2 true) (and (<= 0 i) (<= i 99))))
(assert (=> (= result2 true) (= o8 i)))
(assert (=> (= result2 true) (= o9 (select (rec__patience__state__posheight (us_split_fields1 s)) o8))))
(assert (=> (= result2 true) (= o16 (to_rep o9))))
(assert (=> (= result2 true) (= o17 (ite (<= o16 o15) true false))))
(assert (=> (= result2 true) (and (<= 0 i) (<= i 99))))
(assert (=> (= result2 true) (= o5 i)))
(assert (=> (= result2 true) (= o6 (select (rec__patience__state__posheight (us_split_fields1 s)) o5))))
...
(assert (and (<= 0 i) (<= i 99)))
(assert (= o3 i))
(assert (= o4 (select (rec__patience__state__posheight (us_split_fields1 s)) o3)))
(assert (= temp___444 (to_rep o4)))
(assert (not (<= temp___444 99)))
(check-sat)
(exit)
