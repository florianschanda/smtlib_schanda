...
(assert (= a1 (store a i (mk___rep (mk___split_fields (distinct 1 0) (rec__arrays_of_records__basic_record__first_value (us_split_fields1 (select a i))) (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select a i))))))))
(assert (= (to_rep o) 42))
(assert (= (rec__arrays_of_records__basic_record__flag (us_split_fields1 (select a1 i))) o1))
(assert (= o o2))
(assert (= (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select a1 i))) o3))
(assert (= o4 o1))
(assert (= o5 o2))
(assert (= o6 o3))
(assert (= o7 (store a1 i (mk___rep (mk___split_fields o4 o5 o6)))))
(assert (= a1 result1))
(assert (= a2 o7))
(assert (= (to_rep o8) 23))
(assert (= (rec__arrays_of_records__basic_record__flag (us_split_fields1 (select a2 i))) o9))
(assert (= (rec__arrays_of_records__basic_record__first_value (us_split_fields1 (select a2 i))) o10))
(assert (= o8 o11))
(assert (= o12 o9))
(assert (= o13 o10))
(assert (= o14 o11))
(assert (= o15 (store a2 i (mk___rep (mk___split_fields o12 o13 o14)))))
(assert (= a2 result2))
(assert (= a3 o15))
(assert (= (to_rep (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select a3 i)))) 23))
(assert (= a3 a4))
(assert (= a5 a3))
