...
(assert (= a1 result1))
(assert (= a2 (store a1 i (mk___rep (mk___split_fields (rec__arrays_of_records__basic_record__flag (us_split_fields1 (select a1 i))) rliteral (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select a1 i))))))))
(assert (= a2 result2))
(assert (= a3 (store a2 i (mk___rep (mk___split_fields (rec__arrays_of_records__basic_record__flag (us_split_fields1 (select a2 i))) (rec__arrays_of_records__basic_record__first_value (us_split_fields1 (select a2 i))) rliteral1)))))
