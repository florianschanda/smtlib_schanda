...
(assert (and (= o23 (model__ f2 root)) (and (dynamic_invariant1 o23 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o23 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select o23 root)))) 0) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= i root)) (ite (and (not (= (parent f2 i) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select o23 (parent f2 i)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select o23 i))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select o23 i))) true)))))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o23 i))) true) (not (= i root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select o23 (parent f2 i)))) (position f2 i) (rec__tree_model__path_type__a (us_split_fields1 (select o23 i)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select o23 i)))) 0)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select o23 i))) true) (forall ((j15 Int)) (=> (and (<= 1 j15) (<= j15 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o23 j15))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select o23 i))) (rec__tree_model__path_type__a (us_split_fields1 (select o23 j15)))) true)) (= j15 i))))))))))))))
