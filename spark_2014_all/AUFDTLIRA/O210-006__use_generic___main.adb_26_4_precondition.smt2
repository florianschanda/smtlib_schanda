...
(define-fun of_base ((r us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r) (mk___split_fields1 (let ((temp___133 (rec__main__discr_type__m_array (us_split_fields1 r)))) (to_array temp___133)))))
...
(define-fun dynamic_invariant1 ((temp___expr_184 us_rep1) (temp___is_init_181 Bool) (temp___skip_constant_182 Bool) (temp___do_toplevel_183 Bool)) Bool (=> (not (= temp___skip_constant_182 true)) (in_range4 15 (to_base temp___expr_184))))
(define-fun default_initial_assumption ((temp___expr_187 us_rep1) (temp___skip_top_level_188 Bool)) Bool (= (to_rep (rec__main__discr_type__discr (us_split_discrs2 temp___expr_187))) 15))
...
(assert (and (= us 15) (in_range1 15)))
(assert (= (to_rep (rec__main__discr_type__discr d__split_discrs)) 15))
(assert (= 15 (to_rep (rec__main__discr_type__discr d__split_discrs))))
(assert (not true))
(check-sat)
(exit)
