...
(assert (and (= temp___939 (model__ (rec__red_black_trees__rbt__struct t__split_fields7))) (and (dynamic_invariant5 temp___939 true false true) (= temp___939 (model__1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields7))) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields7)))))))))
(assert (not (<= 1 x2)))
(check-sat)
(exit)
