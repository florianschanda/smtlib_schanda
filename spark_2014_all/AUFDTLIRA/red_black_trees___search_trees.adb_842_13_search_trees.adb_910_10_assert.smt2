...
(assert (<= 1 i5))
(assert (<= i5 100))
(assert (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) (to_rep1 (rec__search_trees__search_tree__root t__split_fields11))) i5))) true))
(assert (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) (to_rep1 (rec__search_trees__search_tree__root t__split_fields11))) i5))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields11) (to_rep1 (rec__search_trees__search_tree__root t__split_fields11))) y1)))) true))
(assert (not (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 f_old__split_fields2) (to_rep1 (rec__search_trees__search_tree__root t__split_fields11))) x1))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 f_1__split_fields3) (to_rep1 (rec__search_trees__search_tree__root t__split_fields11))) i5)))) 1)) (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields11) (to_rep1 (rec__search_trees__search_tree__root t__split_fields11))) y1))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) (to_rep1 (rec__search_trees__search_tree__root t__split_fields11))) i5)))) 1)))))
(check-sat)
(exit)
