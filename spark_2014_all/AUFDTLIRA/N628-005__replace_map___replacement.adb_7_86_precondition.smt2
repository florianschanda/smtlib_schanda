...
(assert (and (= o3 (has_key (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields))) (mk___rep1 (mk___split_fields1 c1)))) (= (= o3 true) (= (has_key (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields))) (mk___rep1 (mk___split_fields1 c1))) true))))
(assert (= o4 true))
(assert (= result2 (ite (= o4 true) o3 false)))
(assert (= result2 true))
(assert (and (= o5 (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) (mk___rep1 (mk___split_fields1 c1)))) (and (in_range3 o5) (= o5 (get (keys (mk___rep d__split_discrs (mk___split_fields d__split_fields))) (get1 (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields))) (mk___rep1 (mk___split_fields1 c1))))))))
(assert (= o6 (ite (= o5 k) true false)))
(assert (= result3 (ite (not (= o6 true)) true false)))
(assert (= result3 true))
(assert (not (= (has_key (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields))) (mk___rep1 (mk___split_fields1 c1))) true)))
(check-sat)
(exit)
