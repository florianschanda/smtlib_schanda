...
(assert (and (= o38 (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem)) (and (in_range6 o38) (= o38 (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem)))))
(assert (= o39 (select f o38)))
(assert (= o40 (to_rep4 o39)))
(assert (not (<= 0 o40)))
(check-sat)
(exit)
