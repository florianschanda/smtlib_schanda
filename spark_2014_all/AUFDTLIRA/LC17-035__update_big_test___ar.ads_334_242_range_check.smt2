...
(assert (=> (< 0 e) (= o16 (temp___982 o15 i o14))))
(assert (=> (< 0 e) (and (= o17 (+ j 1)) (in_range1 (+ j 1)))))
(assert (=> (< 0 e) (= temp___4662 (temp___967 a j (temp___975 (select a j) i e) o17 o16))))
(assert (=> (< 0 e) (= result8 (bool_eq1 a3 5 50 temp___4662 5 50))))
...
(assert (= o11 (temp___1005 o10 i 99)))
