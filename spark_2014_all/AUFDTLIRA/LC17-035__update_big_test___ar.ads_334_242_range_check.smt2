...
(assert (=> (< 0 e) (= o11 (temp_____aggregate_def_1041 o10 i o9))))
(assert (=> (< 0 e) (and (= o12 (+ j 1)) (in_range1 (+ j 1)))))
(assert (=> (< 0 e) (= temp___4721 (temp_____aggregate_def_1026 a j (temp_____aggregate_def_1034 (select a j) i e) o12 o11))))
...
(assert (= o7 (temp_____aggregate_def_1064 o6 i 99)))
