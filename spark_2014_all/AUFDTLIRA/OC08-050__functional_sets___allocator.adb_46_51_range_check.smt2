...
(assert (and (and (forall ((e2 Int)) (=> (and (in_range1 e2) (= (mem avail3 e2) true)) (and (<= 1 e2) (<= e2 r2)))) (forall ((e2 Int)) (=> (and (in_range1 e2) (= (mem alloc3 e2) true)) (and (<= 1 e2) (<= e2 r2))))) (forall ((rr1 Int)) (=> (and (<= 1 rr1) (<= rr1 r2)) (ite (= (to_rep (select data rr1)) 0) (and (= (mem avail3 rr1) true) (not (= (mem alloc3 rr1) true))) (and (not (= (mem avail3 rr1) true)) (= (mem alloc3 rr1) true)))))))
(assert (and (=> (<= 1 3) (in_range3 r2)) (and (<= 1 r2) (<= r2 3))))
(assert (and (= o10 (mem avail3 e1)) (=> (= e1 0) (not (= o10 true)))))
(assert (= (= o11 true) (in_range1 e1)))
(assert (= result5 (ite (= o11 true) o10 false)))
(assert (= (= result4 true) (forall ((e2 Int)) (=> (and (in_range1 e2) (= (mem avail3 e2) true)) (and (<= 1 e2) (<= e2 r2))))))
(assert (=> (= result4 true) (and (= o8 (mem alloc3 e)) (=> (= e 0) (not (= o8 true))))))
(assert (=> (= result4 true) (= (= o9 true) (in_range1 e))))
(assert (=> (= result4 true) (= result6 (ite (= o9 true) o8 false))))
(assert (=> (= result4 true) (= (= result3 true) (forall ((e2 Int)) (=> (and (in_range1 e2) (= (mem alloc3 e2) true)) (and (<= 1 e2) (<= e2 r2)))))))
