...
(declare-const r Int)
(declare-const allocator__m__model__result us_rep)
(declare-const allocator__m__model__result1 us_rep)
(declare-const temp___368 us_rep)
...
(declare-const allocator__m__model__result2 us_rep1)
(declare-const allocator__m__model__result3 t__ref)
(declare-const allocator__m__model__result4 us_rep1)
(declare-const avail11 set__ref)
(declare-const alloc11 set__ref)
(declare-const r10 int__ref)
(declare-const allocator__m__model__result5 t__ref)
(declare-const avail12 us_rep)
(declare-const alloc12 us_rep)
(declare-const r11 Int)
(declare-const allocator__m__model__result6 us_rep1)
...
(assert (and (= o14 (mem avail3 e1)) (=> (= e1 0) (not (= o14 true)))))
(assert (= (= o15 true) (in_range3 e1)))
(assert (= result5 (ite (= o15 true) o14 false)))
(assert (= (= result4 true) (forall ((e2 Int)) (=> (and (in_range3 e2) (= (mem avail3 e2) true)) (and (<= 1 e2) (<= e2 r2))))))
(assert (=> (= result4 true) (and (= o12 (mem alloc3 e)) (=> (= e 0) (not (= o12 true))))))
(assert (=> (= result4 true) (= (= o13 true) (in_range3 e))))
(assert (=> (= result4 true) (= result6 (ite (= o13 true) o12 false))))
...
(assert (= result7 true))
(assert (and (= o6 rr) (in_range3 rr)))
(assert (and (= o7 (mem alloc3 o6)) (=> (= o6 0) (not (= o7 true)))))
