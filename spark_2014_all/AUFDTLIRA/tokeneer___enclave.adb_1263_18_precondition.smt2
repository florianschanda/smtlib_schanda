...
(assert (= status1 8))
(assert (and (= (and (and (= (islocked state4) true) (= (thecurrentdoor state5) 0)) (= (greaterthanorequal (thecurrenttime currenttime) (alarm_timeout state5)) true)) (= (thedooralarm state5) 0)) (= (islocked state4) true)))
(assert (and (not (= (ispresent (mk___rep theadmin__split_fields2)) true)) (not (= (isdoingop (mk___rep theadmin__split_fields2)) true))))
(assert (= o1 (extractuser state)))
