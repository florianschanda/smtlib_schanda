...
(assert (and (and (forall ((temp___188 Int)) (=> (and (<= 0 temp___188) (<= temp___188 2)) (=> (< i2 temp___188) (= (select result__2 temp___188) (select result__ temp___188))))) (=> (<= 0 2) (in_range5 i2))) (and (<= 0 i2) (<= i2 2))))
(assert (not (= i2 2)))
(assert (= result2 i2))
(assert (= i3 (+ i2 1)))
