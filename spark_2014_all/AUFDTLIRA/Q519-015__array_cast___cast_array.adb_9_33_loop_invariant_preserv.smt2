...
(assert (= result__2 o1))
(assert (forall ((k1 Int)) (=> (and (<= 0 k1) (<= k1 i2)) (= (to_rep1 (select result__3 k1)) (to_rep (select input_array k1))))))
(assert (and (and (forall ((temp___163 Int)) (=> (and (<= 0 temp___163) (<= temp___163 2)) (=> (< i2 temp___163) (= (select result__3 temp___163) (select result__ temp___163))))) (=> (<= 0 2) (in_range5 i2))) (and (<= 0 i2) (<= i2 2))))
(assert (not (= i2 2)))
(assert (= result2 i2))
(assert (= i3 (+ i2 1)))
(assert (= (to_rep1 o5) (to_rep (select input_array i3))))
(assert (= o6 (store result__3 i3 o5)))
(assert (= result3 result__3))
(assert (= result__4 o6))
(declare-const k1 Int)
(assert (<= 0 k1))
(assert (<= k1 i3))
(assert (not (= (to_rep1 (select result__4 k1)) (to_rep (select input_array k1)))))
(check-sat)
(exit)
