...
(assert (= result__1 o1))
(assert (forall ((k Int)) (=> (and (<= 0 k) (<= k i2)) (= (to_rep1 (select result__2 k)) (to_rep (select input_array k))))))
(assert (and (and (forall ((temp___163 Int)) (=> (and (<= 0 temp___163) (<= temp___163 2)) (=> (< i2 temp___163) (= (select result__2 temp___163) (select result__ temp___163))))) (=> (<= 0 2) (in_range5 i2))) (and (<= 0 i2) (<= i2 2))))
(assert (not (= i2 2)))
(assert (= result2 i2))
(assert (= i3 (+ i2 1)))
...
(assert (<= 0 k))
(assert (<= k i3))
(assert (not (= (to_rep1 (select result__3 k)) (to_rep (select input_array k)))))
(check-sat)
(exit)
