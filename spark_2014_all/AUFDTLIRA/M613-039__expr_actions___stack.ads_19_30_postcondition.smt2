...
(assert (not (= (let ((temp___259 (to__ (mk___rep (mk___split_fields s__split_fields s__split_fields1))))) (let ((temp___258 (to_but_top (mk___rep (mk___split_fields s__split_fields6 s__split_fields7))))) (bool_eq (elts temp___258) (to_rep (first (rt temp___258))) (to_rep (last (rt temp___258))) (elts temp___259) (to_rep (first (rt temp___259))) (to_rep (last (rt temp___259)))))) true)))
(check-sat)
(exit)
