...
(declare-const temp___1274 (Array Int character))
(declare-const temp___12741 t)
...
(define-fun temp___12742 () us_t (mk___t temp___1274 temp___12741))
...
(assert (and (= o8 (length2 (mk___rep this__split_discrs (mk___split_fields this__split_fields6 (mk___t1 this__split_fields7 this__split_fields8))))) (and (in_range6 o8) (= o8 (to_rep2 this__split_fields6)))))
(assert (= o9 (ite (= o8 (length2 (mk___rep this__split_discrs (mk___split_fields this__split_fields (mk___t1 this__split_fields1 this__split_fields2))))) true false)))
(assert (and (= temp___12742 (value (mk___rep this__split_discrs (mk___split_fields this__split_fields6 (mk___t1 this__split_fields7 this__split_fields8))))) (and (dynamic_invariant4 temp___12742 true false true true) (and (and (= this__split_fields7 temp___1274) (= (mk (to_rep1 (first4 (mk2 1 (to_rep2 this__split_fields6)))) (to_rep1 (last4 (mk2 1 (to_rep2 this__split_fields6))))) temp___12741)) (and (and (and (= (length temp___12742) (length2 (mk___rep this__split_discrs (mk___split_fields this__split_fields6 (mk___t1 this__split_fields7 this__split_fields8))))) (= (to_rep1 (first temp___12741)) 1)) (= (to_rep1 (last temp___12741)) (length2 (mk___rep this__split_discrs (mk___split_fields this__split_fields6 (mk___t1 this__split_fields7 this__split_fields8)))))) (= (< 0 (length2 (mk___rep this__split_discrs (mk___split_fields this__split_fields6 (mk___t1 this__split_fields7 this__split_fields8))))) (not (= (empty (mk___rep this__split_discrs (mk___split_fields this__split_fields6 (mk___t1 this__split_fields7 this__split_fields8)))) true))))))))
(assert (not (<= (to_rep1 (first temp___12741)) start)))
(check-sat)
(exit)
