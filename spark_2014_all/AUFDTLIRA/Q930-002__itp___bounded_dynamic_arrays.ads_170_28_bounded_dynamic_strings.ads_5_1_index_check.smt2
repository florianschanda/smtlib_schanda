...
(assert (and (= (mk___t temp___1211 temp___12111) (value (mk___rep this__split_discrs (mk___split_fields this__split_fields6 (mk___t1 this__split_fields7 this__split_fields8))))) (and (dynamic_invariant4 (mk___t temp___1211 temp___12111) true false true) (and (and (= this__split_fields7 temp___1211) (= (mk (to_rep1 (first4 (mk2 1 (to_rep2 this__split_fields6)))) (to_rep1 (last4 (mk2 1 (to_rep2 this__split_fields6))))) temp___12111)) (and (and (and (= (length (mk___t temp___1211 temp___12111)) (length2 (mk___rep this__split_discrs (mk___split_fields this__split_fields6 (mk___t1 this__split_fields7 this__split_fields8))))) (= (to_rep1 (first temp___12111)) 1)) (= (to_rep1 (last temp___12111)) (length2 (mk___rep this__split_discrs (mk___split_fields this__split_fields6 (mk___t1 this__split_fields7 this__split_fields8)))))) (= (< 0 (length2 (mk___rep this__split_discrs (mk___split_fields this__split_fields6 (mk___t1 this__split_fields7 this__split_fields8))))) (not (= (empty (mk___rep this__split_discrs (mk___split_fields this__split_fields6 (mk___t1 this__split_fields7 this__split_fields8)))) true))))))))
(assert (not (<= (to_rep1 (first temp___12111)) start)))
(check-sat)
(exit)
