...
(assert (= (bool_eq2 a1 1 16 (temp___5321 t k (temp___5327 (select t k) j (temp___5333 (select (select t k) j) i e))) 1 16) true))
...
(assert (=> (< 0 e) (= o13 (+ k 1))))
(assert (=> (< 0 e) (= temp___5361 (select a o13))))
(assert (=> (< 0 e) (= o15 (select temp___5361 j))))
(assert (=> (< 0 e) (= o16 (temp___1675 o15 i o14))))
(assert (=> (< 0 e) (and (<= 1 (+ k 1)) (<= (+ k 1) 16))))
(assert (=> (< 0 e) (= o12 (+ k 1))))
(assert (=> (< 0 e) (= o17 (select a o12))))
(assert (=> (< 0 e) (= o18 (temp___1668 o17 j o16))))
(assert (=> (< 0 e) (and (= o19 (+ k 1)) (in_range2 (+ k 1)))))
(assert (=> (< 0 e) (= temp___5362 (temp___1645 a k (temp___1653 (select a k) j (temp___1660 (select (select a k) j) i e)) o19 o18))))
...
(assert (= o7 (+ k 1)))
(assert (= temp___5371 (select a o7)))
(assert (= o8 (select temp___5371 j)))
(assert (= o9 (temp___1714 o8 i 99)))
(assert (and (<= 1 (+ k 1)) (<= (+ k 1) 16)))
(assert (= o6 (+ k 1)))
(assert (= o10 (select a o6)))
(assert (= o11 (temp___1707 o10 j o9)))
