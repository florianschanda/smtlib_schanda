...
(declare-const temp___5430 (Array Int (Array Int et1)))
...
(assert (= a4 a2))
(assert (< k 16))
(assert (=> (< 0 e) (and (= o14 (- e 1)) (in_range3 (- e 1)))))
(assert (=> (< 0 e) (and (<= 1 (+ k 1)) (<= (+ k 1) 16))))
(assert (=> (< 0 e) (= o13 (+ k 1))))
(assert (=> (< 0 e) (= temp___5420 (select a o13))))
(assert (=> (< 0 e) (= o15 (select temp___5420 j))))
(assert (=> (< 0 e) (= o16 (temp_____aggregate_def_1734 o15 i o14))))
(assert (=> (< 0 e) (and (<= 1 (+ k 1)) (<= (+ k 1) 16))))
(assert (=> (< 0 e) (= o12 (+ k 1))))
(assert (=> (< 0 e) (= o17 (select a o12))))
(assert (=> (< 0 e) (= o18 (temp_____aggregate_def_1727 o17 j o16))))
(assert (=> (< 0 e) (and (= o19 (+ k 1)) (in_range2 (+ k 1)))))
(assert (=> (< 0 e) (= temp___5421 (temp_____aggregate_def_1704 a k (temp_____aggregate_def_1712 (select a k) j (temp_____aggregate_def_1719 (select (select a k) j) i e)) o19 o18))))
...
(assert (= o7 (+ k 1)))
(assert (= temp___5430 (select a o7)))
(assert (= o8 (select temp___5430 j)))
(assert (= o9 (temp_____aggregate_def_1773 o8 i 99)))
(assert (and (<= 1 (+ k 1)) (<= (+ k 1) 16)))
(assert (= o6 (+ k 1)))
(assert (= o10 (select a o6)))
(assert (= o11 (temp_____aggregate_def_1766 o10 j o9)))
