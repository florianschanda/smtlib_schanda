...
(assert (= (bool_eq2 a1 1 16 (temp___5380 t k (temp___5386 (select t k) j (temp___5392 (select (select t k) j) i e))) 1 16) true))
...
(assert (=> (< 0 e) (= o16 (temp___1734 o15 i o14))))
(assert (=> (< 0 e) (and (<= 1 (+ k 1)) (<= (+ k 1) 16))))
(assert (=> (< 0 e) (= o12 (+ k 1))))
(assert (=> (< 0 e) (= o17 (select a o12))))
(assert (=> (< 0 e) (= o18 (temp___1727 o17 j o16))))
(assert (=> (< 0 e) (and (= o19 (+ k 1)) (in_range2 (+ k 1)))))
(assert (=> (< 0 e) (= temp___5421 (temp___1704 a k (temp___1712 (select a k) j (temp___1719 (select (select a k) j) i e)) o19 o18))))
...
(assert (= o9 (temp___1773 o8 i 99)))
(assert (and (<= 1 (+ k 1)) (<= (+ k 1) 16)))
(assert (= o6 (+ k 1)))
(assert (= o10 (select a o6)))
(assert (= o11 (temp___1766 o10 j o9)))
