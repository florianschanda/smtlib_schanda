...
(assert (< k 16))
(assert (< 0 e))
(assert (and (= o12 (- e 1)) (in_range3 (- e 1))))
(assert (and (<= 1 (+ k 1)) (<= (+ k 1) 16)))
(assert (= o11 (+ k 1)))
(assert (= temp___5270 (select a o11)))
(assert (= o13 (select temp___5270 j)))
(assert (= o14 (temp_____aggregate_def_1564 o13 i o12)))
(assert (and (<= 1 (+ k 1)) (<= (+ k 1) 16)))
(assert (= o10 (+ k 1)))
(assert (= o15 (select a o10)))
(assert (= o16 (temp_____aggregate_def_1557 o15 j o14)))
