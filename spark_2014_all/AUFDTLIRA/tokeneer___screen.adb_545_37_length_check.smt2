...
(define-fun dynamic_invariant ((temp___expr_974 Int) (temp___is_init_971 Bool) (temp___skip_constant_972 Bool) (temp___do_toplevel_973 Bool)) Bool (=> (or (= temp___is_init_971 true) (<= 0 2147483647)) (in_range3 temp___expr_974)))
(declare-sort t2 0)
...
(assert (forall ((x Int)) (! (=> (dynamic_invariant x true true true) (= (fart_image x) (let ((temp___980 (to_string (attr__ATTRIBUTE_IMAGE3 x)))) (of_array1 (to_array temp___980) (first1 temp___980) (last1 temp___980))))) :pattern ((fart_image x)))))
...
(assert (forall ((temp___1843 Int)) (forall ((temp___1844 Int)) (= (select (screen__writeconfigdata__farstring__result__aggregate_def temp___1843) temp___1844) (of_rep temp___1843)))))
...
(define-fun dynamic_invariant6 ((temp___expr_1641 Int) (temp___is_init_1638 Bool) (temp___skip_constant_1639 Bool) (temp___do_toplevel_1640 Bool)) Bool (=> (or (= temp___is_init_1638 true) (<= 1 12)) (in_range4 temp___expr_1641)))
...
(declare-const temp___1847 (Array Int character))
(declare-const temp___18471 t4)
(declare-const temp___1848 (Array Int character))
(declare-const temp___18481 t3)
(declare-const temp___1850 Int)
(declare-const o1 (Array Int character))
(declare-const temp___1851 (Array Int character))
(declare-const temp___18511 t3)
...
(assert (and (= (mk___t1 temp___1840 temp___18401) (fart_image value)) (and (dynamic_invariant1 (mk___t1 temp___1840 temp___18401) true false true) (= (mk___t1 temp___1840 temp___18401) (let ((temp___978 (to_string (attr__ATTRIBUTE_IMAGE3 value)))) (mk___t1 (elts temp___978) (mk1 (to_rep1 (first (rt temp___978))) (to_rep1 (last (rt temp___978))))))))))
(assert (= temp___1840 screen__writeconfigdata__farstring__data__assume))
(assert (= (mk (to_rep1 (first2 temp___18401)) (to_rep1 (last2 temp___18401))) screen__writeconfigdata__farstring__data__assume1))
(assert (= result data))
...
(assert (= o data1))
(assert (= o temp___1847))
(assert (= (mk4 2 (to_rep1 data__last)) temp___18471))
(assert (= (ite (<= (to_rep1 (first8 temp___18471)) (to_rep1 (last8 temp___18471))) (+ (- (to_rep1 (last8 temp___18471)) (to_rep1 (first8 temp___18471))) 1) 0) (ite (<= 1 (- (to_rep1 data__last) 1)) (+ (- (- (to_rep1 data__last) 1) 1) 1) 0)))
(assert (= (slide temp___1847 (to_rep1 (first8 temp___18471)) 1) temp___1848))
(assert (= (mk3 1 (- (to_rep1 data__last) 1)) temp___18481))
(assert (and (= temp___1850 (- (to_rep1 data__last) 1)) (in_range (- (to_rep1 data__last) 1))))
(assert (=> (<= 1 temp___1850) (and (and (<= 1 1) (<= 1 12)) (and (<= 1 temp___1850) (<= temp___1850 12)))))
(assert (= o1 result__1))
(assert (= o1 temp___1851))
(assert (= (mk3 1 temp___1850) temp___18511))
(assert (not (= (ite (<= (to_rep1 (first6 temp___18481)) (to_rep1 (last6 temp___18481))) (+ (- (to_rep1 (last6 temp___18481)) (to_rep1 (first6 temp___18481))) 1) 0) (ite (<= (to_rep1 (first6 temp___18511)) (to_rep1 (last6 temp___18511))) (+ (- (to_rep1 (last6 temp___18511)) (to_rep1 (first6 temp___18511))) 1) 0))))
(check-sat)
(exit)
