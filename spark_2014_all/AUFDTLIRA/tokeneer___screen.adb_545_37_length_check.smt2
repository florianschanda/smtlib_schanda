...
(define-fun dynamic_invariant ((temp___expr_1092 Int) (temp___is_init_1088 Bool) (temp___skip_constant_1089 Bool) (temp___do_toplevel_1090 Bool) (temp___do_typ_inv_1091 Bool)) Bool (=> (or (= temp___is_init_1088 true) (<= 0 2147483647)) (in_range3 temp___expr_1092)))
(declare-sort t2 0)
...
(assert (forall ((x Int)) (! (=> (dynamic_invariant x true true true true) (dynamic_invariant1 (fart_image x) true false true true)) :pattern ((fart_image x)))))
(assert (forall ((x Int)) (! (=> (dynamic_invariant x true true true true) (= (fart_image x) (let ((temp___1098 (to_string (attr__ATTRIBUTE_IMAGE3 x)))) (of_array1 (to_array temp___1098) (first1 temp___1098) (last1 temp___1098))))) :pattern ((fart_image x)))))
(declare-sort classstringi 0)
(define-fun in_range4 ((x Int)) Bool (and (<= 1 x) (<= x 12)))
(declare-fun attr__ATTRIBUTE_IMAGE4 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check4 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE4 (us_image) Int)
(declare-fun user_eq7 (classstringi classstringi) Bool)
(declare-const dummy7 classstringi)
...
(declare-datatypes () ((t105b__ref (mk_t105b__ref (t105b__content integer)))))
(define-fun t105b__ref___projection ((a t105b__ref)) integer (t105b__content a))
(declare-sort t3 0)
...
(declare-datatypes () ((t106b__ref (mk_t106b__ref (t106b__content us_t3)))))
(define-fun t106b__ref___projection ((a t106b__ref)) us_t3 (t106b__content a))
...
(declare-fun screen__writeconfigdata__farstring__result__aggregate_def (Int) (Array Int character))
...
(define-fun dynamic_invariant6 ((temp___expr_1823 Int) (temp___is_init_1819 Bool) (temp___skip_constant_1820 Bool) (temp___do_toplevel_1821 Bool) (temp___do_typ_inv_1822 Bool)) Bool (=> (or (= temp___is_init_1819 true) (<= 1 12)) (in_range4 temp___expr_1823)))
(assert (forall ((temp___2034 Int)) (=> (dynamic_invariant3 temp___2034 true true true true) (forall ((temp___2035 Int)) (= (to_rep (select (screen__writeconfigdata__farstring__result__aggregate_def temp___2034) temp___2035)) temp___2034)))))
...
(declare-const temp___20311 t1)
(declare-const screen__writeconfigdata__farstring__data__assume (Array Int character))
(declare-const screen__writeconfigdata__farstring__data__assume1 t)
(declare-const o (Array Int character))
(declare-const temp___2038 (Array Int character))
(declare-const temp___20381 t4)
(declare-const temp___2039 (Array Int character))
(declare-const temp___20391 t3)
(declare-const temp___2041 Int)
(declare-const o1 (Array Int character))
(declare-const temp___2042 (Array Int character))
(declare-const temp___20421 t3)
...
(define-fun temp___20312 () us_t1 (mk___t1 temp___2031 temp___20311))
(assert (in_range3 value))
(assert (and (= temp___20312 (fart_image value)) (and (dynamic_invariant1 temp___20312 true false true true) (= temp___20312 (let ((temp___1096 (to_string (attr__ATTRIBUTE_IMAGE3 value)))) (mk___t1 (elts temp___1096) (mk1 (to_rep1 (first (rt temp___1096))) (to_rep1 (last (rt temp___1096))))))))))
(assert (= temp___2031 screen__writeconfigdata__farstring__data__assume))
(assert (= (mk (to_rep1 (first2 temp___20311)) (to_rep1 (last2 temp___20311))) screen__writeconfigdata__farstring__data__assume1))
(assert (= result data))
(assert (= data1 screen__writeconfigdata__farstring__data__assume))
(assert (= (to_rep1 data__first) (to_rep1 (first screen__writeconfigdata__farstring__data__assume1))))
(assert (= (to_rep1 data__last) (to_rep1 (last screen__writeconfigdata__farstring__data__assume1))))
(assert (dynamic_property 1 2147483647 (to_rep1 data__first) (to_rep1 data__last)))
(assert (= result1 result__))
(assert (= result__1 (screen__writeconfigdata__farstring__result__aggregate_def 32)))
(assert (<= (ite (<= (to_rep1 data__first) (to_rep1 data__last)) (+ (- (to_rep1 data__last) (to_rep1 data__first)) 1) 0) 13))
...
(assert (= o data1))
(assert (= o temp___2038))
(assert (= (mk4 2 (to_rep1 data__last)) temp___20381))
(assert (= (ite (<= (to_rep1 (first8 temp___20381)) (to_rep1 (last8 temp___20381))) (+ (- (to_rep1 (last8 temp___20381)) (to_rep1 (first8 temp___20381))) 1) 0) (ite (<= 1 (- (to_rep1 data__last) 1)) (+ (- (- (to_rep1 data__last) 1) 1) 1) 0)))
(assert (= (slide temp___2038 (to_rep1 (first8 temp___20381)) 1) temp___2039))
(assert (= (mk3 1 (- (to_rep1 data__last) 1)) temp___20391))
(assert (and (= temp___2041 (- (to_rep1 data__last) 1)) (in_range (- (to_rep1 data__last) 1))))
(assert (=> (<= 1 temp___2041) (and (and (<= 1 1) (<= 1 12)) (and (<= 1 temp___2041) (<= temp___2041 12)))))
(assert (= o1 result__1))
(assert (= o1 temp___2042))
(assert (= (mk3 1 temp___2041) temp___20421))
(assert (not (= (ite (<= (to_rep1 (first6 temp___20391)) (to_rep1 (last6 temp___20391))) (+ (- (to_rep1 (last6 temp___20391)) (to_rep1 (first6 temp___20391))) 1) 0) (ite (<= (to_rep1 (first6 temp___20421)) (to_rep1 (last6 temp___20421))) (+ (- (to_rep1 (last6 temp___20421)) (to_rep1 (first6 temp___20421))) 1) 0))))
(check-sat)
(exit)
