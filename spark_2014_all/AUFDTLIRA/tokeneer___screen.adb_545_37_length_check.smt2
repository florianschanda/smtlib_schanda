...
(define-fun dynamic_invariant1 ((temp___expr_1085 Int) (temp___is_init_1081 Bool) (temp___skip_constant_1082 Bool) (temp___do_toplevel_1083 Bool) (temp___do_typ_inv_1084 Bool)) Bool (=> (or (= temp___is_init_1081 true) (<= 0 2147483647)) (in_range3 temp___expr_1085)))
(assert (forall ((x Int)) (! (=> (dynamic_invariant1 x true true true true) (dynamic_invariant (fart_image x) true false true true)) :pattern ((fart_image x)))))
(assert (forall ((x Int)) (! (=> (dynamic_invariant1 x true true true true) (= (fart_image x) (let ((temp___1091 (to_string (attr__ATTRIBUTE_IMAGE3 x)))) (of_array1 (to_array temp___1091) (first1 temp___1091) (last1 temp___1091))))) :pattern ((fart_image x)))))
...
(define-fun dynamic_invariant6 ((temp___expr_1816 Int) (temp___is_init_1812 Bool) (temp___skip_constant_1813 Bool) (temp___do_toplevel_1814 Bool) (temp___do_typ_inv_1815 Bool)) Bool (=> (or (= temp___is_init_1812 true) (<= 1 12)) (in_range4 temp___expr_1816)))
(assert (forall ((temp___2027 Int)) (=> (dynamic_invariant3 temp___2027 true true true true) (forall ((temp___2028 Int)) (= (to_rep (select (screen__writeconfigdata__farstring__result__aggregate_def temp___2027) temp___2028)) temp___2027)))))
...
(declare-const temp___2024 (Array Int character))
(declare-const temp___20241 t1)
...
(declare-const temp___2032 (Array Int character))
(declare-const temp___20321 t3)
(declare-const temp___2034 Int)
(declare-const o1 (Array Int character))
(declare-const temp___2035 (Array Int character))
(declare-const temp___20351 t3)
...
(define-fun temp___20242 () us_t1 (mk___t1 temp___2024 temp___20241))
(assert (in_range3 value))
(assert (and (= temp___20242 (fart_image value)) (and (dynamic_invariant temp___20242 true false true true) (= temp___20242 (let ((temp___1089 (to_string (attr__ATTRIBUTE_IMAGE3 value)))) (mk___t1 (elts temp___1089) (mk1 (to_rep1 (first (rt temp___1089))) (to_rep1 (last (rt temp___1089))))))))))
(assert (= temp___2024 screen__writeconfigdata__farstring__data__assume))
(assert (= (mk (to_rep1 (first2 temp___20241)) (to_rep1 (last2 temp___20241))) screen__writeconfigdata__farstring__data__assume1))
(assert (= result data))
...
(assert (= (mk4 2 (to_rep1 data__last)) temp___20311))
(assert (= (ite (<= (to_rep1 (first8 temp___20311)) (to_rep1 (last8 temp___20311))) (+ (- (to_rep1 (last8 temp___20311)) (to_rep1 (first8 temp___20311))) 1) 0) (ite (<= 1 (- (to_rep1 data__last) 1)) (+ (- (- (to_rep1 data__last) 1) 1) 1) 0)))
(assert (= (slide temp___2031 (to_rep1 (first8 temp___20311)) 1) temp___2032))
(assert (= (mk3 1 (- (to_rep1 data__last) 1)) temp___20321))
(assert (and (= temp___2034 (- (to_rep1 data__last) 1)) (in_range (- (to_rep1 data__last) 1))))
(assert (=> (<= 1 temp___2034) (and (and (<= 1 1) (<= 1 12)) (and (<= 1 temp___2034) (<= temp___2034 12)))))
(assert (= o1 result__1))
(assert (= o1 temp___2035))
(assert (= (mk3 1 temp___2034) temp___20351))
(assert (not (= (ite (<= (to_rep1 (first6 temp___20321)) (to_rep1 (last6 temp___20321))) (+ (- (to_rep1 (last6 temp___20321)) (to_rep1 (first6 temp___20321))) 1) 0) (ite (<= (to_rep1 (first6 temp___20351)) (to_rep1 (last6 temp___20351))) (+ (- (to_rep1 (last6 temp___20351)) (to_rep1 (first6 temp___20351))) 1) 0))))
(check-sat)
(exit)
