...
(assert (= result2 true))
(assert (and (= o12 (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 ki1))))) (in_range5 (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 ki1)))))))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))) true))
...
(assert (= o9 (select temp___1790 ki1)))
...
(assert (= o6 (select temp___1789 ki1)))
...
(assert (not (<= 1 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 ki1)))))))
(check-sat)
(exit)
