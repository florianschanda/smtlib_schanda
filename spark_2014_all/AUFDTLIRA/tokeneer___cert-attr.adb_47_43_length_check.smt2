...
(assert (= (mk4 1 (to_rep1 fullstring__last)) temp___17101))
...
(assert (= o18 temp___1713))
(assert (= (mk4 1 (to_rep1 fullstring__last)) temp___17131))
(assert (not (= (ite (<= (to_rep1 (first8 temp___17101)) (to_rep1 (last8 temp___17101))) (+ (- (to_rep1 (last8 temp___17101)) (to_rep1 (first8 temp___17101))) 1) 0) (ite (<= (to_rep1 (first8 temp___17131)) (to_rep1 (last8 temp___17131))) (+ (- (to_rep1 (last8 temp___17131)) (to_rep1 (first8 temp___17131))) 1) 0))))
(check-sat)
(exit)
