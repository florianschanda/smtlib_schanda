...
(assert (= (slide fullstring1 (to_rep1 fullstring__first) 1) temp___1491))
(assert (= (mk3 1 (to_rep1 fullstring__last)) temp___14911))
...
(assert (= o18 temp___1494))
(assert (= (mk3 1 (to_rep1 fullstring__last)) temp___14941))
(assert (not (= (ite (<= (to_rep1 (first6 temp___14911)) (to_rep1 (last6 temp___14911))) (+ (- (to_rep1 (last6 temp___14911)) (to_rep1 (first6 temp___14911))) 1) 0) (ite (<= (to_rep1 (first6 temp___14941)) (to_rep1 (last6 temp___14941))) (+ (- (to_rep1 (last6 temp___14941)) (to_rep1 (first6 temp___14941))) 1) 0))))
(check-sat)
(exit)
