...
(assert (= (slide fullstring1 (to_rep1 fullstring__first) 1) temp___1547))
(assert (= (mk4 1 (to_rep1 fullstring__last)) temp___15471))
...
(assert (= o18 temp___1550))
(assert (= (mk4 1 (to_rep1 fullstring__last)) temp___15501))
(assert (not (= (ite (<= (to_rep1 (first8 temp___15471)) (to_rep1 (last8 temp___15471))) (+ (- (to_rep1 (last8 temp___15471)) (to_rep1 (first8 temp___15471))) 1) 0) (ite (<= (to_rep1 (first8 temp___15501)) (to_rep1 (last8 temp___15501))) (+ (- (to_rep1 (last8 temp___15501)) (to_rep1 (first8 temp___15501))) 1) 0))))
(check-sat)
(exit)
