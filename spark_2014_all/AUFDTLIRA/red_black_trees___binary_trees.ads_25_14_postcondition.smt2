...
(assert (forall ((f us_rep1)) (! (=> (type_invariant f) (dynamic_invariant1 (size f) true false true)) :pattern ((size f)))))
...
(assert (forall ((f us_rep1)) (forall ((i Int)) (! (=> (and (dynamic_invariant i true true true) (type_invariant f)) (=> (< (size f) i) (not (= (valid_root f i) true)))) :pattern ((valid_root f i))))))
(assert (forall ((f us_rep1)) (forall ((i Int)) (! (= (= (valid_root f i) true) (and (<= i (to_rep (rec__binary_trees__forest__s (us_split_fields3 f)))) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields1 (let ((temp___288 (rec__binary_trees__forest__c (us_split_fields3 f)))) (select temp___288 i))))) 2))) :pattern ((valid_root f i))))))
...
(declare-const binary_trees__parent__result Int)
(declare-const result Int)
(declare-const binary_trees__parent__result1 Int)
(declare-const binary_trees__parent__result2 Int)
(declare-const binary_trees__parent__result3 Int)
(declare-const binary_trees__parent__result4 Int)
(declare-const binary_trees__parent__result5 Int)
(declare-const result1 Bool)
(declare-const result2 Bool)
(declare-const result3 Int)
(assert (in_range1 i))
(assert (= (tree_structure f) true))
(assert (= binary_trees__parent__result1 binary_trees__parent__result2))
(assert (= binary_trees__parent__result3 binary_trees__parent__result1))
(assert (= (mk_int__ref result) (mk_int__ref binary_trees__parent__result)))
(assert (= binary_trees__parent__result1 (to_rep (rec__binary_trees__cell__parent (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 f)) i))))))
(assert (= (mk_int__ref binary_trees__parent__result4) (mk_int__ref binary_trees__parent__result2)))
(assert (= binary_trees__parent__result5 binary_trees__parent__result3))
(assert (= result3 binary_trees__parent__result4))
(assert (= (valid_root f i) true))
(assert (not (= binary_trees__parent__result4 0)))
(check-sat)
(exit)
