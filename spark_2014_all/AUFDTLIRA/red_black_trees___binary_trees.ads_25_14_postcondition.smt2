...
(assert (forall ((f us_rep1)) (forall ((i Int)) (! (=> (and (dynamic_invariant1 i true true true true) (type_invariant f)) (=> (< (size f) i) (not (= (valid_root f i) true)))) :pattern ((valid_root f i))))))
