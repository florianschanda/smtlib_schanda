...
(assert (forall ((f us_rep1)) (! (=> (type_invariant f) (dynamic_invariant1 (size f) true false true true)) :pattern ((size f)))))
...
(assert (forall ((f us_rep1)) (forall ((i Int)) (! (=> (and (dynamic_invariant i true true true true) (type_invariant f)) (=> (< (size f) i) (not (= (valid_root f i) true)))) :pattern ((valid_root f i))))))
(assert (forall ((f us_rep1)) (forall ((i Int)) (! (= (= (valid_root f i) true) (and (<= i (to_rep (rec__binary_trees__forest__s (us_split_fields3 f)))) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields1 (let ((temp___330 (rec__binary_trees__forest__c (us_split_fields3 f)))) (select temp___330 i))))) 2))) :pattern ((valid_root f i))))))
...
(assert (= result1 binary_trees__parent__result4))
