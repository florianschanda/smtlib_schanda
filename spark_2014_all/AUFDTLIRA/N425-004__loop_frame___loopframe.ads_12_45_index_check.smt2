...
(define-fun dynamic_invariant ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= 0 5)) (in_range1 temp___expr_136)))
...
(define-fun dynamic_invariant1 ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= 1 5)) (in_range2 temp___expr_142)))
...
(assert (= v1 0))
(assert (in_range1 v1))
(assert (or (and (and (and (= (mk_int__ref result1) (mk_int__ref x)) (= x1 1)) (and (and (not (= (select a x1) true)) (= v2 v1)) (and (and (= x1 result3) (= x2 2)) (and (and (not (= (select a x2) true)) (= v3 v2)) (and (and (= x2 result5) (= x3 3)) (and (and (not (= (select a x3) true)) (= v4 v3)) (and (and (= x3 result7) (= x4 4)) (and (and (not (= (select a x4) true)) (= v5 v4)) (and (and (= x4 result9) (= x5 5)) (and (not (= (select a x5) true)) (= v6 v5))))))))))) (and (and (= x14 (mk_int__ref x5)) (= v15 (mk_int__ref v6))) (and (= x15 x5) (= v16 v6)))) (and (and (= temp___156 v1) (and (and (= (mk_int__ref result1) (mk_int__ref x)) (= x1 1)) (or (and (and (and (= x12 (mk_int__ref x1)) (= v13 (mk_int__ref v2))) (and (= x13 x1) (= v14 v2))) (and (= (select a x1) true) (and (= v1 result2) (= v2 x1)))) (and (and (not (= (select a x1) true)) (= v2 v1)) (and (and (and (= x12 (mk_int__ref x10)) (= v13 (mk_int__ref v11))) (and (= x13 x11) (= v14 v12))) (and (and (= x1 result3) (= x2 2)) (or (and (and (and (= x2 x10) (= v3 v11)) (and (= x11 x2) (= v12 v3))) (and (= (select a x2) true) (and (= v2 result4) (= v3 x2)))) (and (and (not (= (select a x2) true)) (= v3 v2)) (and (and (and (= (mk_int__ref x10) (mk_int__ref x8)) (= (mk_int__ref v11) (mk_int__ref v9))) (and (= x11 x9) (= v12 v10))) (and (and (= x2 result5) (= x3 3)) (or (and (and (and (= x3 x8) (= v4 v9)) (and (= x9 x3) (= v10 v4))) (and (= (select a x3) true) (and (= v3 result6) (= v4 x3)))) (and (and (not (= (select a x3) true)) (= v4 v3)) (and (and (and (= (mk_int__ref x8) (mk_int__ref x6)) (= (mk_int__ref v9) (mk_int__ref v7))) (and (= x9 x7) (= v10 v8))) (and (and (= x3 result7) (= x4 4)) (or (and (and (and (= x4 x6) (= v5 v7)) (and (= x7 x4) (= v8 v5))) (and (= (select a x4) true) (and (= v4 result8) (= v5 x4)))) (and (and (not (= (select a x4) true)) (= v5 v4)) (and (and (and (= x5 x6) (= v6 v7)) (and (= x7 x5) (= v8 v6))) (and (and (= x4 result9) (= x5 5)) (and (= (select a x5) true) (and (= v5 result10) (= v6 x5))))))))))))))))))))) (and (and (= x14 x12) (= v15 v13)) (and (= x15 x13) (= v16 v14))))))
...
(assert (not (<= 1 (int__content loopframe__get__result4))))
(check-sat)
(exit)
