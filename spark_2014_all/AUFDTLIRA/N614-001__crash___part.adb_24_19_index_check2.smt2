...
(define-fun dynamic_invariant2 ((temp___expr_574 us_t) (temp___is_init_570 Bool) (temp___skip_constant_571 Bool) (temp___do_toplevel_572 Bool) (temp___do_typ_inv_573 Bool)) Bool (=> (not (= temp___skip_constant_571 true)) (dynamic_property 1 2147483647 (first1 temp___expr_574) (last1 temp___expr_574))))
...
(assert (in_range2 a))
(assert (in_range2 b))
(assert (and (and (<= (to_rep x__first) a) (<= a (to_rep x__last))) (and (<= (to_rep x__first) b) (<= b (to_rep x__last)))))
