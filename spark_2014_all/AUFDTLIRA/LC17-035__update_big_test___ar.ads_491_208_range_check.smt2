...
(assert (and (and (= (bool_eq2 a 1 16 (temp___5471 t k (temp___5477 (select t k) j (temp___5483 (select (select t k) j) i e))) 1 16) true) (or (and (= k 16) (= k_next1 1)) (and (< k 16) (= k_next1 (+ k 1))))) (in_range3 k_next1)))
