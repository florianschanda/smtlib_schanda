...
(assert (and (and (= (bool_eq2 a 1 16 (temp_____aggregate_def_5530 t k (temp_____aggregate_def_5536 (select t k) j (temp_____aggregate_def_5542 (select (select t k) j) i e))) 1 16) true) (or (and (= k 16) (= k_next1 1)) (and (< k 16) (= k_next1 (+ k 1))))) (in_range3 k_next1)))
