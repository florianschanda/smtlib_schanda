...
(assert (= (slide fullstring1 (to_rep1 fullstring__first) 1) temp___1739))
(assert (= (mk4 1 (to_rep1 fullstring__last)) temp___17391))
...
(assert (= o18 temp___1742))
(assert (= (mk4 1 (to_rep1 fullstring__last)) temp___17421))
(assert (not (= (ite (<= (to_rep1 (first8 temp___17391)) (to_rep1 (last8 temp___17391))) (+ (- (to_rep1 (last8 temp___17391)) (to_rep1 (first8 temp___17391))) 1) 0) (ite (<= (to_rep1 (first8 temp___17421)) (to_rep1 (last8 temp___17421))) (+ (- (to_rep1 (last8 temp___17421)) (to_rep1 (first8 temp___17421))) 1) 0))))
(check-sat)
(exit)
