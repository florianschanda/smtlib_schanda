...
(assert (= (slide fullstring1 (to_rep1 fullstring__first) 1) temp___1683))
(assert (= (mk3 1 (to_rep1 fullstring__last)) temp___16831))
...
(assert (= o18 temp___1686))
(assert (= (mk3 1 (to_rep1 fullstring__last)) temp___16861))
(assert (not (= (ite (<= (to_rep1 (first6 temp___16831)) (to_rep1 (last6 temp___16831))) (+ (- (to_rep1 (last6 temp___16831)) (to_rep1 (first6 temp___16831))) 1) 0) (ite (<= (to_rep1 (first6 temp___16861)) (to_rep1 (last6 temp___16861))) (+ (- (to_rep1 (last6 temp___16861)) (to_rep1 (first6 temp___16861))) 1) 0))))
(check-sat)
(exit)
