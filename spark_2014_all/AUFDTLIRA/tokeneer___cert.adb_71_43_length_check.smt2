...
(declare-const temp___1905 (Array Int character))
(declare-const temp___19051 t4)
...
(assert (= (mk4 1 (to_rep1 fullstring__last)) temp___19051))
(assert (not (= (ite (<= (to_rep1 (first8 temp___19021)) (to_rep1 (last8 temp___19021))) (+ (- (to_rep1 (last8 temp___19021)) (to_rep1 (first8 temp___19021))) 1) 0) (ite (<= (to_rep1 (first8 temp___19051)) (to_rep1 (last8 temp___19051))) (+ (- (to_rep1 (last8 temp___19051)) (to_rep1 (first8 temp___19051))) 1) 0))))
(check-sat)
(exit)
