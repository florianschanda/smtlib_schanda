...
(declare-const temp___1909 (Array Int character))
(declare-const temp___19091 t4)
(declare-const o18 (Array Int character))
(declare-const temp___1912 (Array Int character))
(declare-const temp___19121 t4)
...
(assert (= (slide fullstring1 (to_rep1 fullstring__first) 1) temp___1909))
(assert (= (mk4 1 (to_rep1 fullstring__last)) temp___19091))
(assert (=> (<= 1 (to_rep1 fullstring__last)) (and (and (<= 1 1) (<= 1 50)) (and (<= 1 (to_rep1 fullstring__last)) (<= (to_rep1 fullstring__last) 50)))))
(assert (= o18 localuser1))
(assert (= o18 temp___1912))
(assert (= (mk4 1 (to_rep1 fullstring__last)) temp___19121))
(assert (not (= (ite (<= (to_rep1 (first8 temp___19091)) (to_rep1 (last8 temp___19091))) (+ (- (to_rep1 (last8 temp___19091)) (to_rep1 (first8 temp___19091))) 1) 0) (ite (<= (to_rep1 (first8 temp___19121)) (to_rep1 (last8 temp___19121))) (+ (- (to_rep1 (last8 temp___19121)) (to_rep1 (first8 temp___19121))) 1) 0))))
(check-sat)
(exit)
