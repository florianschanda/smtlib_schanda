...
(define-fun default_initial_assumption2 ((temp___expr_293 us_rep) (temp___skip_top_level_294 Bool)) Bool (=> (not (= temp___skip_top_level_294 true)) (= (is_empty temp___expr_293) true)))
(assert (forall ((t us_rep3)) (! (=> (dynamic_invariant t true true true true) (=> (= (size1 t) 0) (= (is_empty (values t)) true))) :pattern ((values t)))))
...
(define-fun dynamic_invariant1 ((temp___expr_534 us_rep4) (temp___is_init_530 Bool) (temp___skip_constant_531 Bool) (temp___do_toplevel_532 Bool) (temp___do_typ_inv_533 Bool)) Bool (and (=> (= temp___do_typ_inv_533 true) (let ((temp___535 (rec__red_black_trees__rbt__struct (us_split_fields7 temp___expr_534)))) (ite (= (size (rec__search_trees__search_tree__struct (us_split_fields5 temp___535))) 0) (= (to_rep (rec__search_trees__search_tree__root (us_split_fields5 temp___535))) 0) (and (and (not (= (to_rep (rec__search_trees__search_tree__root (us_split_fields5 temp___535))) 0)) (= (valid_root (rec__search_trees__search_tree__struct (us_split_fields5 temp___535)) (to_rep (rec__search_trees__search_tree__root (us_split_fields5 temp___535)))) true)) (= (ordered_leafs (rec__search_trees__search_tree__struct (us_split_fields5 temp___535)) (to_rep (rec__search_trees__search_tree__root (us_split_fields5 temp___535))) (rec__search_trees__search_tree__values (us_split_fields5 temp___535))) true))))) (=> (= temp___do_typ_inv_533 true) (= (tree_structure (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields7 temp___expr_534))))) true))))
(define-fun default_initial_assumption3 ((temp___expr_540 us_rep4) (temp___skip_top_level_541 Bool)) Bool (and (and (and (and (= (to_rep (rec__search_trees__search_tree__root (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields7 temp___expr_540))))) 0) (and (and (= (to_rep (rec__binary_trees__forest__s (us_split_fields3 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields7 temp___expr_540))))))) 0) (forall ((temp___545 Int)) (=> (and (<= 1 temp___545) (<= temp___545 100)) (and (and (and (= (to_rep (rec__binary_trees__cell__left (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields7 temp___expr_540)))))) temp___545)))) 0) (= (to_rep (rec__binary_trees__cell__right (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields7 temp___expr_540)))))) temp___545)))) 0)) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields7 temp___expr_540)))))) temp___545)))) 0)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields7 temp___expr_540)))))) temp___545)))) 2))))) (= (size (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields7 temp___expr_540))))) 0))) (= (rec__search_trees__search_tree__values (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields7 temp___expr_540)))) (temp___434 0))) (= (size1 (rec__red_black_trees__rbt__struct (us_split_fields7 temp___expr_540))) 0)) (= (rec__red_black_trees__rbt__color (us_split_fields7 temp___expr_540)) (temp___549 0))))
(define-fun type_invariant1 ((temp___554 us_rep4)) Bool (= (invariant__ temp___554) true))
(declare-fun size2 (us_rep4) Int)
(declare-fun size__function_guard2 (Int us_rep4) Bool)
(define-fun dynamic_invariant2 ((temp___expr_184 Int) (temp___is_init_180 Bool) (temp___skip_constant_181 Bool) (temp___do_toplevel_182 Bool) (temp___do_typ_inv_183 Bool)) Bool (=> (or (= temp___is_init_180 true) (<= 0 100)) (in_range2 temp___expr_184)))
(assert (forall ((t us_rep4)) (! (=> (and (dynamic_invariant1 t true true true true) (type_invariant1 t)) (dynamic_invariant2 (size2 t) true false true true)) :pattern ((size2 t)))))
(assert (forall ((t us_rep4)) (! (=> (dynamic_invariant1 t true true true true) (= (size2 t) (size1 (rec__red_black_trees__rbt__struct (us_split_fields7 t))))) :pattern ((size2 t)))))
...
(define-fun bool_eq9 ((a (Array Int us_rep5)) (a__first Int) (a__last Int) (b (Array Int us_rep5)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_158 Int)) (=> (and (<= a__first temp___idx_158) (<= temp___idx_158 a__last)) (= (bool_eq8 (select a temp___idx_158) (select b (+ (- b__first a__first) temp___idx_158))) true)))) true false))
(assert (forall ((a (Array Int us_rep5)) (b (Array Int us_rep5))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq9 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_158 Int)) (=> (and (<= a__first temp___idx_158) (<= temp___idx_158 a__last)) (= (bool_eq8 (select a temp___idx_158) (select b (+ (- b__first a__first) temp___idx_158))) true))))))))
...
(define-fun bool_eq12 ((a (Array Int us_rep7)) (a__first Int) (a__last Int) (b (Array Int us_rep7)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (bool_eq11 (select a temp___idx_154) (select b (+ (- b__first a__first) temp___idx_154))) true)))) true false))
(assert (forall ((a (Array Int us_rep7)) (b (Array Int us_rep7))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq12 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (bool_eq11 (select a temp___idx_154) (select b (+ (- b__first a__first) temp___idx_154))) true))))))))
...
(assert (forall ((t1 us_rep4)) (! (=> (and (dynamic_invariant1 t1 true true true true) (not (= (size1 (rec__red_black_trees__rbt__struct (us_split_fields7 t1))) 0))) (let ((result (nb_blacks t1))) (and (= (bool_eq8 (select result 0) (mk___rep4 (mk___split_fields4 (distinct 1 0) (of_rep 0) (of_rep 0)))) true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields11 (let ((temp___616 (model__ (rec__red_black_trees__rbt__struct (us_split_fields7 t1))))) (select temp___616 i)))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields9 (select result i))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields9 (select result (peek (rec__red_black_trees__rbt__struct (us_split_fields7 t1)) i 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields9 (select result (peek (rec__red_black_trees__rbt__struct (us_split_fields7 t1)) i 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields9 (select result i)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields9 (select result (peek (rec__red_black_trees__rbt__struct (us_split_fields7 t1)) i 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields9 (select result (peek (rec__red_black_trees__rbt__struct (us_split_fields7 t1)) i 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields9 (select result (peek (rec__red_black_trees__rbt__struct (us_split_fields7 t1)) i 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields9 (select result (peek (rec__red_black_trees__rbt__struct (us_split_fields7 t1)) i 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields9 (select result i)))) (+ (ite (= (to_rep3 (let ((temp___615 (rec__red_black_trees__rbt__color (us_split_fields7 t1)))) (select temp___615 i))) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields9 (select result (peek (rec__red_black_trees__rbt__struct (us_split_fields7 t1)) i 0)))))))))))))) :pattern ((nb_blacks t1)))))
(define-fun dynamic_invariant4 ((temp___expr_517 Int) (temp___is_init_513 Bool) (temp___skip_constant_514 Bool) (temp___do_toplevel_515 Bool) (temp___do_typ_inv_516 Bool)) Bool (=> (or (= temp___is_init_513 true) (<= 0 1)) (in_range6 temp___expr_517)))
(assert (forall ((temp___551 Int)) (=> (dynamic_invariant4 temp___551 true true true true) (forall ((temp___552 Int)) (= (to_rep3 (select (temp___549 temp___551) temp___552)) temp___551)))))
(declare-fun same_nb_blacks (us_rep4) Bool)
(declare-fun same_nb_blacks__function_guard (Bool us_rep4) Bool)
(assert true)
(assert (forall ((t1 us_rep4)) (! (= (= (same_nb_blacks t1) true) (or (= (size1 (rec__red_black_trees__rbt__struct (us_split_fields7 t1))) 0) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields11 (let ((temp___585 (model__ (rec__red_black_trees__rbt__struct (us_split_fields7 t1))))) (select temp___585 i)))) true) (= (rec__red_black_trees__black_count__status (us_split_fields9 (let ((temp___584 (nb_blacks t1))) (select temp___584 i)))) true)))))) :pattern ((same_nb_blacks t1)))))
(declare-fun parent (us_rep3 Int) Int)
(declare-fun parent__function_guard (Int us_rep3 Int) Bool)
(assert true)
(assert (forall ((t1 us_rep4)) (! (= (= (invariant__ t1) true) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (or (= (parent (rec__red_black_trees__rbt__struct (us_split_fields7 t1)) i) 0) (= (to_rep3 (let ((temp___589 (rec__red_black_trees__rbt__color (us_split_fields7 t1)))) (select temp___589 (parent (rec__red_black_trees__rbt__struct (us_split_fields7 t1)) i)))) 1)) (= (to_rep3 (let ((temp___588 (rec__red_black_trees__rbt__color (us_split_fields7 t1)))) (select temp___588 i))) 0)))) (= (same_nb_blacks t1) true))) :pattern ((invariant__ t1)))))
(define-fun dynamic_invariant5 ((temp___expr_177 Int) (temp___is_init_173 Bool) (temp___skip_constant_174 Bool) (temp___do_toplevel_175 Bool) (temp___do_typ_inv_176 Bool)) Bool (=> (or (= temp___is_init_173 true) (<= 1 100)) (in_range5 temp___expr_177)))
(define-fun dynamic_invariant6 ((temp___expr_191 Int) (temp___is_init_187 Bool) (temp___skip_constant_188 Bool) (temp___do_toplevel_189 Bool) (temp___do_typ_inv_190 Bool)) Bool (=> (or (= temp___is_init_187 true) (<= 0 2)) (in_range3 temp___expr_191)))
...
(define-fun dynamic_invariant7 ((temp___expr_198 Int) (temp___is_init_194 Bool) (temp___skip_constant_195 Bool) (temp___do_toplevel_196 Bool) (temp___do_typ_inv_197 Bool)) Bool (=> (or (= temp___is_init_194 true) (<= 0 1)) (in_range7 temp___expr_198)))
(declare-fun length1 (us_rep6) Int)
(declare-fun length__function_guard1 (Int us_rep6) Bool)
(define-fun dynamic_invariant8 ((temp___expr_241 us_rep7) (temp___is_init_237 Bool) (temp___skip_constant_238 Bool) (temp___do_toplevel_239 Bool) (temp___do_typ_inv_240 Bool)) Bool (=> (= temp___do_toplevel_239 true) (=> (= temp___is_init_237 true) (< (length1 (rec__tree_model__path_type__a (us_split_fields11 temp___expr_241))) 100))))
(define-fun default_initial_assumption4 ((temp___expr_243 us_rep7) (temp___skip_top_level_244 Bool)) Bool (and (= (length1 (rec__tree_model__path_type__a (us_split_fields11 temp___expr_243))) 0) (= (rec__tree_model__path_type__k (us_split_fields11 temp___expr_243)) (distinct 0 0))))
(define-fun dynamic_predicate ((temp___247 us_rep7)) Bool (< (length1 (rec__tree_model__path_type__a (us_split_fields11 temp___247))) 100))
(define-fun dynamic_invariant9 ((temp___expr_253 (Array Int us_rep7)) (temp___is_init_249 Bool) (temp___skip_constant_250 Bool) (temp___do_toplevel_251 Bool) (temp___do_typ_inv_252 Bool)) Bool (forall ((temp___254 Int)) (=> (and (<= 1 temp___254) (<= temp___254 100)) (=> (= temp___is_init_249 true) (< (length1 (rec__tree_model__path_type__a (us_split_fields11 (select temp___expr_253 temp___254)))) 100)))))
(define-fun default_initial_assumption5 ((temp___expr_256 (Array Int us_rep7)) (temp___skip_top_level_257 Bool)) Bool (forall ((temp___258 Int)) (=> (and (<= 1 temp___258) (<= temp___258 100)) (and (= (length1 (rec__tree_model__path_type__a (us_split_fields11 (select temp___expr_256 temp___258)))) 0) (= (rec__tree_model__path_type__k (us_split_fields11 (select temp___expr_256 temp___258))) (distinct 0 0))))))
...
(define-fun default_initial_assumption6 ((temp___expr_234 us_rep6) (temp___skip_top_level_235 Bool)) Bool (=> (not (= temp___skip_top_level_235 true)) (= (length1 temp___expr_234) 0)))
...
(define-fun dynamic_invariant10 ((temp___expr_170 Int) (temp___is_init_166 Bool) (temp___skip_constant_167 Bool) (temp___do_toplevel_168 Bool) (temp___do_typ_inv_169 Bool)) Bool (=> (or (= temp___is_init_166 true) (<= 0 2147483647)) (in_range8 temp___expr_170)))
(assert (forall ((t1 us_rep3)) (! (=> (dynamic_invariant t1 true true true true) (dynamic_invariant2 (size1 t1) true false true true)) :pattern ((size1 t1)))))
(assert (forall ((t1 us_rep3)) (! (=> (dynamic_invariant t1 true true true true) (= (size1 t1) (size (rec__search_trees__search_tree__struct (us_split_fields5 t1))))) :pattern ((size1 t1)))))
(declare-fun parent1 (us_rep2 Int) Int)
(declare-fun parent__function_guard1 (Int us_rep2 Int) Bool)
(assert (forall ((t1 us_rep3)) (forall ((i Int)) (! (=> (and (dynamic_invariant t1 true true true true) (dynamic_invariant5 i true true true true)) (let ((result (parent t1 i))) (and (=> (= (size1 t1) 0) (= result 0)) (dynamic_invariant2 result true false true true)))) :pattern ((parent t1 i))))))
(assert (forall ((t1 us_rep3)) (forall ((i Int)) (! (=> (and (dynamic_invariant t1 true true true true) (dynamic_invariant5 i true true true true)) (= (parent t1 i) (parent1 (rec__search_trees__search_tree__struct (us_split_fields5 t1)) i))) :pattern ((parent t1 i))))))
...
(assert (forall ((t1 us_rep3)) (! (=> (and (dynamic_invariant t1 true true true true) (not (= (size1 t1) 0))) (dynamic_invariant9 (model__ t1) true false true true)) :pattern ((model__ t1)))))
(assert (forall ((t1 us_rep3)) (! (=> (dynamic_invariant t1 true true true true) (= (model__ t1) (model__1 (rec__search_trees__search_tree__struct (us_split_fields5 t1)) (to_rep (rec__search_trees__search_tree__root (us_split_fields5 t1)))))) :pattern ((model__ t1)))))
(declare-fun peek1 (us_rep2 Int Int) Int)
(declare-fun peek__function_guard1 (Int us_rep2 Int Int) Bool)
(assert (forall ((t1 us_rep3)) (forall ((i Int) (d Int)) (! (=> (and (and (and (dynamic_invariant t1 true true true true) (dynamic_invariant5 i true true true true)) (dynamic_invariant7 d true true true true)) (and (not (= (size1 t1) 0)) (= (rec__tree_model__path_type__k (us_split_fields11 (let ((temp___466 (model__ t1))) (select temp___466 i)))) true))) (dynamic_invariant2 (peek t1 i d) true false true true)) :pattern ((peek t1 i d))))))
(assert (forall ((t1 us_rep3)) (forall ((i Int) (d Int)) (! (=> (and (and (dynamic_invariant t1 true true true true) (dynamic_invariant5 i true true true true)) (dynamic_invariant7 d true true true true)) (= (peek t1 i d) (peek1 (rec__search_trees__search_tree__struct (us_split_fields5 t1)) i d))) :pattern ((peek t1 i d))))))
(assert (forall ((temp___436 Int)) (=> (dynamic_invariant3 temp___436 true true true true) (forall ((temp___437 Int)) (= (to_rep2 (select (temp___434 temp___436) temp___437)) temp___436)))))
...
(define-fun default_initial_assumption7 ((temp___expr_320 us_rep2) (temp___skip_top_level_321 Bool)) Bool (and (and (= (to_rep (rec__binary_trees__forest__s (us_split_fields3 temp___expr_320))) 0) (forall ((temp___323 Int)) (=> (and (<= 1 temp___323) (<= temp___323 100)) (and (and (and (= (to_rep (rec__binary_trees__cell__left (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 temp___expr_320)) temp___323)))) 0) (= (to_rep (rec__binary_trees__cell__right (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 temp___expr_320)) temp___323)))) 0)) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 temp___expr_320)) temp___323)))) 0)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 temp___expr_320)) temp___323)))) 2))))) (=> (not (= temp___skip_top_level_321 true)) (= (size temp___expr_320) 0))))
(define-fun type_invariant2 ((temp___326 us_rep2)) Bool (= (tree_structure temp___326) true))
(assert true)
(assert (forall ((f us_rep2)) (! (=> (dynamic_invariant11 f true true true true) (dynamic_invariant2 (size f) true false true true)) :pattern ((size f)))))
(assert (forall ((f us_rep2)) (forall ((i Int)) (! (=> (and (dynamic_invariant11 f true true true true) (dynamic_invariant5 i true true true true)) (=> (< (size f) i) (not (= (valid_root f i) true)))) :pattern ((valid_root f i))))))
(assert (forall ((f us_rep2)) (forall ((i Int)) (! (=> (and (dynamic_invariant11 f true true true true) (dynamic_invariant5 i true true true true)) (let ((result (parent1 f i))) (and (and (=> (= (valid_root f i) true) (= result 0)) (=> (= (size f) 0) (= result 0))) (dynamic_invariant2 result true false true true)))) :pattern ((parent1 f i))))))
(declare-fun position (us_rep2 Int) Int)
(declare-fun position__function_guard (Int us_rep2 Int) Bool)
(assert (forall ((f us_rep2)) (forall ((i Int)) (! (=> (and (and (dynamic_invariant11 f true true true true) (dynamic_invariant5 i true true true true)) (not (= (parent1 f i) 0))) (dynamic_invariant7 (position f i) true false true true)) :pattern ((position f i))))))
(assert (forall ((f us_rep2)) (forall ((i Int) (d Int)) (! (=> (and (and (dynamic_invariant11 f true true true true) (dynamic_invariant5 i true true true true)) (dynamic_invariant7 d true true true true)) (let ((result (peek1 f i d))) (and (and (ite (not (= result 0)) (and (= (position f result) d) (= (parent1 f result) i)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (parent1 f j) i) (not (= (position f j) d)))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (parent1 f j) i) (= (position f j) d)) (= result j))))) (dynamic_invariant2 result true false true true)))) :pattern ((peek1 f i d))))))
(assert (forall ((f us_rep2)) (forall ((root Int)) (! (=> (and (and (dynamic_invariant11 f true true true true) (dynamic_invariant5 root true true true true)) (= (valid_root f root) true)) (let ((result (model__1 f root))) (and (and (= (rec__tree_model__path_type__k (us_split_fields11 (select result root))) true) (and (= (length1 (rec__tree_model__path_type__a (us_split_fields11 (select result root)))) 0) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= i root)) (ite (and (not (= (parent1 f i) 0)) (= (rec__tree_model__path_type__k (us_split_fields11 (select result (parent1 f i)))) true)) (= (rec__tree_model__path_type__k (us_split_fields11 (select result i))) true) (not (= (rec__tree_model__path_type__k (us_split_fields11 (select result i))) true)))))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields11 (select result i))) true) (not (= i root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields11 (select result (parent1 f i)))) (position f i) (rec__tree_model__path_type__a (us_split_fields11 (select result i)))) true) (= (length1 (rec__tree_model__path_type__a (us_split_fields11 (select result i)))) 0)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields11 (select result i))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields11 (select result j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields11 (select result i))) (rec__tree_model__path_type__a (us_split_fields11 (select result j)))) true)) (= j i))))))))))) (dynamic_invariant9 result true false true true)))) :pattern ((model__1 f root))))))
...
(define-fun dynamic_invariant12 ((temp___expr_226 Int) (temp___is_init_222 Bool) (temp___skip_constant_223 Bool) (temp___do_toplevel_224 Bool) (temp___do_typ_inv_225 Bool)) Bool (=> (or (= temp___is_init_222 true) (<= 0 2147483647)) (in_range9 temp___expr_226)))
(assert (forall ((container us_rep6)) (! (let ((result (length1 container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant10 result true false true true))) :pattern ((length1 container)))))
...
(define-fun dynamic_invariant13 ((temp___expr_219 Int) (temp___is_init_215 Bool) (temp___skip_constant_216 Bool) (temp___do_toplevel_217 Bool) (temp___do_typ_inv_218 Bool)) Bool (=> (or (= temp___is_init_215 true) (<= 0 1)) (in_range10 temp___expr_219)))
(assert (forall ((container us_rep6)) (forall ((position1 Int)) (! (=> (and (dynamic_invariant12 position1 true true true true) (and (<= 1 position1) (<= position1 (last container)))) (dynamic_invariant13 (get container position1) true false true true)) :pattern ((get container position1))))))
(define-fun dynamic_invariant14 ((temp___expr_270 Int) (temp___is_init_266 Bool) (temp___skip_constant_267 Bool) (temp___do_toplevel_268 Bool) (temp___do_typ_inv_269 Bool)) Bool (=> (or (= temp___is_init_266 true) (<= 0 2147483647)) (in_range1 temp___expr_270)))
(assert (forall ((container us_rep)) (forall ((item Int)) (! (=> (dynamic_invariant14 item true true true true) (=> (= (distinct 1 0) true) (=> (exists ((e Int)) (and (and (in_range1 e) (= (contains container e) true)) (= e item))) (= (contains container item) true)))) :pattern ((contains container item))))))
(assert (forall ((container us_rep)) (! (dynamic_invariant10 (length container) true false true true) :pattern ((length container)))))
