...
(assert (forall ((t us_rep3)) (! (=> (dynamic_invariant t true true true true) (=> (= (size t) 0) (= (is_empty (values t)) true))) :pattern ((values t)))))
...
(assert (forall ((temp___551 Int)) (=> (dynamic_invariant4 temp___551 true true true true) (forall ((temp___552 Int)) (= (to_rep3 (select (temp_____aggregate_def_549 temp___551) temp___552)) temp___551)))))
(declare-fun same_nb_blacks (us_rep4) Bool)
(declare-fun same_nb_blacks__function_guard (Bool us_rep4) Bool)
(assert true)
(assert (forall ((t1 us_rep4)) (! (= (= (same_nb_blacks t1) true) (or (= (size (rec__red_black_trees__rbt__struct (us_split_fields7 t1))) 0) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields11 (let ((temp___585 (model__ (rec__red_black_trees__rbt__struct (us_split_fields7 t1))))) (select temp___585 i)))) true) (= (rec__red_black_trees__black_count__status (us_split_fields9 (let ((temp___584 (nb_blacks t1))) (select temp___584 i)))) true)))))) :pattern ((same_nb_blacks t1)))))
...
(assert (forall ((t1 us_rep3)) (! (=> (dynamic_invariant t1 true true true true) (dynamic_invariant1 (size t1) true false true true)) :pattern ((size t1)))))
(assert (forall ((t1 us_rep3)) (! (=> (dynamic_invariant t1 true true true true) (= (size t1) (size1 (rec__search_trees__search_tree__struct (us_split_fields5 t1))))) :pattern ((size t1)))))
(declare-fun parent1 (us_rep2 Int) Int)
(declare-fun parent__function_guard1 (Int us_rep2 Int) Bool)
(assert (forall ((t1 us_rep3)) (forall ((i Int)) (! (=> (and (dynamic_invariant t1 true true true true) (dynamic_invariant5 i true true true true)) (let ((result (parent t1 i))) (and (=> (= (size t1) 0) (= result 0)) (dynamic_invariant1 result true false true true)))) :pattern ((parent t1 i))))))
...
(assert (forall ((t1 us_rep3)) (! (=> (and (dynamic_invariant t1 true true true true) (not (= (size t1) 0))) (dynamic_invariant9 (model__ t1) true false true true)) :pattern ((model__ t1)))))
...
(assert (forall ((t1 us_rep3)) (forall ((i Int) (d Int)) (! (=> (and (and (and (dynamic_invariant t1 true true true true) (dynamic_invariant5 i true true true true)) (dynamic_invariant7 d true true true true)) (and (not (= (size t1) 0)) (= (rec__tree_model__path_type__k (us_split_fields11 (let ((temp___466 (model__ t1))) (select temp___466 i)))) true))) (dynamic_invariant1 (peek t1 i d) true false true true)) :pattern ((peek t1 i d))))))
...
(assert (forall ((temp___436 Int)) (=> (dynamic_invariant3 temp___436 true true true true) (forall ((temp___437 Int)) (= (select (temp_____aggregate_def_434 temp___436) temp___437) rliteral1)))))
...
(assert (forall ((f us_rep2)) (forall ((i Int)) (! (=> (and (dynamic_invariant11 f true true true true) (dynamic_invariant5 i true true true true)) (=> (< (size1 f) i) (not (= (valid_root f i) true)))) :pattern ((valid_root f i))))))
(assert (forall ((f us_rep2)) (forall ((i Int)) (! (=> (and (dynamic_invariant11 f true true true true) (dynamic_invariant5 i true true true true)) (let ((result (parent1 f i))) (and (and (=> (= (valid_root f i) true) (= result 0)) (=> (= (size1 f) 0) (= result 0))) (dynamic_invariant1 result true false true true)))) :pattern ((parent1 f i))))))
...
(assert (dynamic_invariant2 t true false true true))
...
(assert (and (= o (values (rec__red_black_trees__rbt__struct (us_split_fields7 t)))) (=> (= (size (rec__red_black_trees__rbt__struct (us_split_fields7 t))) 0) (= (is_empty o) true))))
