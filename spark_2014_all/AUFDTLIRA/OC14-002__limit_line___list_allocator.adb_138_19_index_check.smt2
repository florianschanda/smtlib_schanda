...
(assert (and (= o98 (length (rec__list_allocator__m__t__available model____split_fields4))) (in_range6 o98)))
(assert (= o99 (- o98 1)))
(assert (= o100 (ite (<= j4 o99) true false)))
(assert (= result24 (ite (<= 1 j4) o100 false)))
(assert (= result24 true))
(assert (and (= o102 (+ j4 2)) (in_range1 (+ j4 2))))
(assert (and (= o103 (get ma1 o102)) (in_range7 o103)))
(assert (and (= o101 (+ j4 1)) (in_range1 (+ j4 1))))
(assert (and (= temp___405 (get ma1 o101)) (in_range7 temp___405)))
(assert (not (<= 1 temp___405)))
(check-sat)
(exit)
