...
(assert (and (= o (+ (to_rep (rec__with_iterable__cursor__i (us_split_fields3 cu))) 1)) (in_range (+ (to_rep (rec__with_iterable__cursor__i (us_split_fields3 cu))) 1))))
(assert (and (= o1 o) (in_range1 o)))
(assert (= (to_rep o2) o1))
(assert (= o2 o3))
(assert (= (us_split_discrs1 cu) (mk___split_discrs temp___216)))
(assert (= temp___2161 o3))
(assert (not (dynamic_predicate (mk___rep1 (mk___split_discrs temp___216) (mk___split_fields1 temp___2161)))))
(check-sat)
(exit)
