...
(assert (=> (not (= currentlatch locallatch1)) (= (valid_numberlogentries state2) true)))
...
(assert (not (= (greaterthanorequal (thecurrenttime currenttime) (mk___rep (mk___split_fields latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3))) true)))
(check-sat)
(exit)
