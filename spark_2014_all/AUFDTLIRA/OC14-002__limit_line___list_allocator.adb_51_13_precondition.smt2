...
(assert (=> (not (= first_available 0)) (and (= o8 (length model____split_fields)) (in_range6 o8))))
(assert (=> (not (= first_available 0)) (= result3 (ite (< 0 o8) true false))))
(assert (=> (not (= first_available 0)) (=> (= result3 true) (and (= o7 (get model____split_fields 1)) (in_range7 o7)))))
(assert (=> (not (= first_available 0)) (=> (= result3 true) (= result2 (ite (= o7 first_available) true false)))))
(assert (=> (not (= first_available 0)) (=> (not (= result3 true)) (= result2 false))))
(assert (=> (not (not (= first_available 0))) (and (= o9 (length model____split_fields)) (in_range6 o9))))
(assert (=> (not (not (= first_available 0))) (= result2 (ite (= o9 0) true false))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (and (= o5 (length model____split_fields1)) (in_range6 o5)))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (= result4 (ite (< 0 o5) true false)))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (=> (= result4 true) (and (= o4 (get model____split_fields1 1)) (in_range7 o4))))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (=> (= result4 true) (= result1 (ite (= o4 first_allocated) true false))))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (=> (not (= result4 true)) (= result1 false)))))
(assert (=> (= result2 true) (=> (not (not (= first_allocated 0))) (and (= o6 (length model____split_fields1)) (in_range6 o6)))))
(assert (=> (= result2 true) (=> (not (not (= first_allocated 0))) (= result1 (ite (= o6 0) true false)))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (=> (= result1 true) (and (= o2 (length model____split_fields)) (in_range6 o2))))
(assert (=> (= result1 true) (= o3 (ite (<= j1 o2) true false))))
(assert (=> (= result1 true) (= result5 (ite (<= 1 j1) o3 false))))
(assert (=> (= result1 true) (= (= result true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 (length model____split_fields))) (and (and (and (in_range4 (get model____split_fields j2)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data (get model____split_fields j2))))) (ite (< j2 (length model____split_fields)) (get model____split_fields (+ j2 1)) 0))) (= (to_rep (rec__list_allocator__cell__prev (us_split_fields1 (select data (get model____split_fields j2))))) (ite (< 1 j2) (get model____split_fields (- j2 1)) 0))) (forall ((k Int)) (=> (and (<= 1 k) (<= k (length model____split_fields))) (=> (not (= j2 k)) (not (= (get model____split_fields j2) (get model____split_fields k))))))))))))
(assert (=> (not (= result1 true)) (= result false)))
(assert (= result true))
(assert (and (= o (length model____split_fields1)) (in_range6 o)))
