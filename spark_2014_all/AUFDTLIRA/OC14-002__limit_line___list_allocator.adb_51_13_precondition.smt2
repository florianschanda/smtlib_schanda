...
(assert (=> (= result1 true) (and (= o30 (length model____split_fields)) (in_range6 o30))))
(assert (=> (= result1 true) (= o31 (ite (<= j1 o30) true false))))
(assert (=> (= result1 true) (= result5 (ite (<= 1 j1) o31 false))))
(assert (=> (= result1 true) (= (= result true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 (length model____split_fields))) (and (and (and (in_range4 (get model____split_fields j2)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data (get model____split_fields j2))))) (ite (< j2 (length model____split_fields)) (get model____split_fields (+ j2 1)) 0))) (= (to_rep (rec__list_allocator__cell__prev (us_split_fields1 (select data (get model____split_fields j2))))) (ite (< 1 j2) (get model____split_fields (- j2 1)) 0))) (forall ((k2 Int)) (=> (and (<= 1 k2) (<= k2 (length model____split_fields))) (=> (not (= j2 k2)) (not (= (get model____split_fields j2) (get model____split_fields k2))))))))))))
(assert (=> (not (= result1 true)) (= result false)))
(assert (= result true))
(assert (and (= o (length model____split_fields1)) (in_range6 o)))
(assert (= o1 (ite (<= j o) true false)))
(assert (= result11 (ite (<= 1 j) o1 false)))
