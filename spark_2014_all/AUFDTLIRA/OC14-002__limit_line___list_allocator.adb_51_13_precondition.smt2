...
(assert (=> (not (= first_available 0)) (and (= o8 (length model____split_fields)) (in_range3 o8))))
(assert (=> (not (= first_available 0)) (= result3 (ite (< 0 o8) true false))))
(assert (=> (not (= first_available 0)) (=> (= result3 true) (and (= o7 (get model____split_fields 1)) (in_range4 o7)))))
...
(assert (=> (not (not (= first_available 0))) (and (= o9 (length model____split_fields)) (in_range3 o9))))
(assert (=> (not (not (= first_available 0))) (= result2 (ite (= o9 0) true false))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (and (= o5 (length model____split_fields1)) (in_range3 o5)))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (= result4 (ite (< 0 o5) true false)))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (=> (= result4 true) (and (= o4 (get model____split_fields1 1)) (in_range4 o4))))))
