...
(declare-datatypes () ((tTnextSP1__ref (mk_tTnextSP1__ref (tTnextSP1__content integer)))))
(define-fun tTnextSP1__ref___projection ((a tTnextSP1__ref)) integer (tTnextSP1__content a))
(declare-sort t1 0)
...
(declare-datatypes () ((tnextS__ref (mk_tnextS__ref (tnextS__content us_t1)))))
(define-fun tnextS__ref___projection ((a tnextS__ref)) us_t1 (tnextS__content a))
...
(assert (forall ((temp___159 Int) (temp___160 Int) (temp___161 Int)) (let ((temp___158 (kmp__init_next__next__aggregate_def temp___159 temp___160 temp___161))) (and (=> (dynamic_property (- 2147483648) 2147483647 temp___160 temp___161) (and (= (first5 temp___158) temp___160) (= (last5 temp___158) temp___161))) (forall ((temp___162 Int)) (= (select (to_array2 temp___158) temp___162) (of_rep temp___159)))))))
(define-fun dynamic_invariant2 ((temp___expr_152 us_t1) (temp___is_init_149 Bool) (temp___skip_constant_150 Bool) (temp___do_toplevel_151 Bool)) Bool (=> (not (= temp___skip_constant_150 true)) (and (dynamic_property2 (first1 p) (last1 p) (first3 temp___expr_152) (last3 temp___expr_152)) (and (= (first3 temp___expr_152) (first1 p)) (= (last3 temp___expr_152) (last1 p))))))
...
(declare-const kmp__init_next__result (Array Int integer))
(declare-const kmp__init_next__result1 t)
(declare-const temp___164 (Array Int integer))
(declare-const temp___1641 t2)
(declare-const kmp__init_next__next__assume (Array Int integer))
(declare-const kmp__init_next__next__assume1 t1)
(declare-const o Int)
(declare-const o1 Int)
(declare-const o2 Bool)
(declare-const temp___170 Int)
(declare-const temp___169 Int)
(declare-const temp___167 (Array Int integer))
(declare-const o3 Int)
(declare-const o4 Int)
(declare-const o5 (Array Int integer))
(declare-const temp___173 (Array Int integer))
(declare-const temp___1731 t4)
...
(declare-const next3 (Array Int integer))
(declare-const result11 Int)
(declare-const i4 Int)
(declare-const result12 map__ref)
(declare-const next4 (Array Int integer))
(declare-const result13 int__ref)
(declare-const j5 Int)
(declare-const result14 Bool)
(declare-const result15 int__ref)
(declare-const r8b4 Int)
(declare-const result16 int__ref)
(declare-const r9b4 Int)
(declare-const result17 int__ref)
(declare-const r12b4 Int)
(declare-const next5 map__ref)
(declare-const i5 int__ref)
(declare-const j6 int__ref)
(declare-const r8b5 int__ref)
(declare-const r9b5 int__ref)
(declare-const r12b5 int__ref)
(declare-const next6 (Array Int integer))
(declare-const i6 Int)
(declare-const j7 Int)
(declare-const r8b6 Int)
(declare-const r9b6 Int)
(declare-const r12b6 Int)
(declare-const next7 map__ref)
(declare-const i7 int__ref)
(declare-const j8 int__ref)
(declare-const r8b7 int__ref)
(declare-const r9b7 int__ref)
(declare-const r12b7 int__ref)
(declare-const next8 (Array Int integer))
(declare-const i8 Int)
(declare-const j9 Int)
(declare-const r8b8 Int)
(declare-const r9b8 Int)
(declare-const r12b8 Int)
(declare-const next9 map__ref)
(declare-const i9 int__ref)
(declare-const j10 int__ref)
(declare-const r8b9 int__ref)
(declare-const r9b9 int__ref)
(declare-const r12b9 int__ref)
(declare-const next10 (Array Int integer))
(declare-const i10 Int)
(declare-const j11 Int)
(declare-const r8b10 Int)
(declare-const r9b10 Int)
(declare-const r12b10 Int)
(declare-const result18 a__ref)
(declare-const kmp__init_next__result2 us_t)
(declare-const kmp__init_next__result3 a__ref)
(declare-const kmp__init_next__result4 us_t)
(declare-const next11 map__ref)
(declare-const i11 int__ref)
(declare-const j12 int__ref)
(declare-const r8b11 int__ref)
(declare-const r9b11 int__ref)
(declare-const r12b11 int__ref)
(declare-const kmp__init_next__result5 a__ref)
(declare-const next12 (Array Int integer))
(declare-const i12 Int)
(declare-const j13 Int)
(declare-const r8b12 Int)
(declare-const r9b12 Int)
(declare-const r12b12 Int)
(declare-const kmp__init_next__result6 us_t)
(assert (dynamic_invariant1 p true false true))
(assert (<= 1 (length p)))
(assert (= (to_rep (first4 (rt2 (kmp__init_next__next__aggregate_def 0 (to_rep (first (rt p))) (to_rep (last (rt p))))))) (to_rep (first (rt p)))))
(assert (= (to_rep (last4 (rt2 (kmp__init_next__next__aggregate_def 0 (to_rep (first (rt p))) (to_rep (last (rt p))))))) (to_rep (last (rt p)))))
(assert (= (mk___t2 temp___164 temp___1641) (kmp__init_next__next__aggregate_def 0 (to_rep (first (rt p))) (to_rep (last (rt p))))))
(assert (= (ite (<= (to_rep (first4 temp___1641)) (to_rep (last4 temp___1641))) (+ (- (to_rep (last4 temp___1641)) (to_rep (first4 temp___1641))) 1) 0) (ite (<= (to_rep (first (rt p))) (to_rep (last (rt p)))) (+ (- (to_rep (last (rt p))) (to_rep (first (rt p)))) 1) 0)))
(assert (= (slide temp___164 (to_rep (first4 temp___1641)) (to_rep (first (rt p)))) kmp__init_next__next__assume))
(assert (= (mk1 (to_rep (first (rt p))) (to_rep (last (rt p)))) kmp__init_next__next__assume1))
(assert (= (mk_map__ref result) (mk_map__ref next)))
(assert (= next1 kmp__init_next__next__assume))
(assert (= (to_rep next__first) (to_rep (first2 kmp__init_next__next__assume1))))
(assert (= (to_rep next__last) (to_rep (last2 kmp__init_next__next__assume1))))
(assert (and (dynamic_property2 (to_rep (first (rt p))) (to_rep (last (rt p))) (to_rep next__first) (to_rep next__last)) (and (= (to_rep next__first) (to_rep (first (rt p)))) (= (to_rep next__last) (to_rep (last (rt p)))))))
(assert (= (mk_int__ref result1) (mk_int__ref i)))
(assert (= i1 (to_rep (first (rt p)))))
(assert (in_range1 i1))
(assert (=> (<= (- 2147483648) 2147483647) (in_range1 j)))
(assert (< 1 (length p)))
(assert (and (= o (+ (to_rep (first (rt p))) 1)) (in_range1 (+ (to_rep (first (rt p))) 1))))
(assert (= (mk_int__ref result2) (mk_int__ref j)))
(assert (= j2 o))
(assert (and (= o1 (- (to_rep (last (rt p))) 1)) (in_range1 (- (to_rep (last (rt p))) 1))))
(assert (= o2 (ite (<= i1 o1) true false)))
(assert (= result3 (ite (<= (to_rep (first (rt p))) i1) o2 false)))
(assert (= result3 true))
(assert (and (= o3 (- i1 j2)) (in_range1 (- i1 j2))))
(assert (= (mk_int__ref result4) (mk_int__ref r8b)))
(assert (= r8b2 o3))
(assert (in_range1 r8b2))
(assert (= (mk_int__ref result5) (mk_int__ref r9b)))
(assert (= r9b2 j2))
(assert (in_range1 r9b2))
(assert (and (= o4 (- j2 1)) (in_range1 (- j2 1))))
(assert (= (mk_int__ref result6) (mk_int__ref r12b)))
(assert (= r12b2 o4))
(assert (in_range1 r12b2))
(assert (and (and (<= (to_rep (first (rt p))) j3) (<= j3 (to_rep (last (rt p))))) (< i2 j3)))
(assert (= (bool_eq (elts p) (to_rep (first6 (mk3 r8b3 r9b3))) (to_rep (last6 (mk3 r8b3 r9b3))) (elts p) (to_rep (first8 (mk4 0 r12b3))) (to_rep (last8 (mk4 0 r12b3)))) true))
(assert (and (=> (<= (- 2147483648) 2147483647) (in_range1 i2)) (=> (<= (- 2147483648) 2147483647) (in_range1 j3))))
(assert (and (<= (to_rep (first (rt p))) j3) (<= j3 (to_rep (last (rt p))))))
(assert (= o8 j3))
(assert (= o9 (select (elts p) o8)))
(assert (= o10 (to_rep o9)))
(assert (and (<= (to_rep (first (rt p))) i2) (<= i2 (to_rep (last (rt p))))))
(assert (= o6 i2))
(assert (= o7 (select (elts p) o6)))
(assert (= o11 (to_rep o7)))
(assert (= result7 (ite (= o11 o10) true false)))
(assert (=> (= result7 true) (and (= o12 (+ i2 1)) (in_range1 (+ i2 1)))))
(assert (=> (= result7 true) (= i2 result8)))
(assert (=> (= result7 true) (= i3 o12)))
(assert (=> (= result7 true) (and (= o13 (+ j3 1)) (in_range1 (+ j3 1)))))
(assert (=> (= result7 true) (= j3 result9)))
(assert (=> (= result7 true) (= j4 o13)))
(assert (=> (= result7 true) (= (to_rep o14) j4)))
(assert (=> (= result7 true) (and (<= (to_rep next__first) i3) (<= i3 (to_rep next__last)))))
(assert (=> (= result7 true) (= o15 i3)))
(assert (=> (= result7 true) (= o16 (store next2 o15 o14))))
(assert (=> (= result7 true) (= next2 result10)))
(assert (=> (= result7 true) (= next3 o16)))
(assert (=> (not (= result7 true)) (=> (= j3 (to_rep (first (rt p)))) (and (= o17 (+ i2 1)) (in_range1 (+ i2 1))))))
(assert (=> (not (= result7 true)) (=> (= j3 (to_rep (first (rt p)))) (= i2 result11))))
(assert (=> (not (= result7 true)) (=> (= j3 (to_rep (first (rt p)))) (= i4 o17))))
(assert (=> (not (= result7 true)) (=> (= j3 (to_rep (first (rt p)))) (= (to_rep o18) 0))))
(assert (=> (not (= result7 true)) (=> (= j3 (to_rep (first (rt p)))) (and (<= (to_rep next__first) i4) (<= i4 (to_rep next__last))))))
(assert (=> (not (= result7 true)) (=> (= j3 (to_rep (first (rt p)))) (= o19 i4))))
(assert (=> (not (= result7 true)) (=> (= j3 (to_rep (first (rt p)))) (= o20 (store next2 o19 o18)))))
(assert (=> (not (= result7 true)) (=> (= j3 (to_rep (first (rt p)))) (= result12 (mk_map__ref next2)))))
(assert (=> (not (= result7 true)) (=> (= j3 (to_rep (first (rt p)))) (= next4 o20))))
(assert (=> (not (= result7 true)) (=> (= j3 (to_rep (first (rt p)))) (= j5 j3))))
(assert (=> (not (= result7 true)) (=> (not (= j3 (to_rep (first (rt p))))) (and (<= (to_rep next__first) j3) (<= j3 (to_rep next__last))))))
(assert (=> (not (= result7 true)) (=> (not (= j3 (to_rep (first (rt p))))) (= o21 j3))))
(assert (=> (not (= result7 true)) (=> (not (= j3 (to_rep (first (rt p))))) (= o22 (select next2 o21)))))
(assert (=> (not (= result7 true)) (=> (not (= j3 (to_rep (first (rt p))))) (= o23 (to_rep o22)))))
(assert (=> (not (= result7 true)) (=> (not (= j3 (to_rep (first (rt p))))) (= result13 (mk_int__ref j3)))))
(assert (=> (not (= result7 true)) (=> (not (= j3 (to_rep (first (rt p))))) (= j5 o23))))
(assert (=> (not (= result7 true)) (=> (not (= j3 (to_rep (first (rt p))))) (= i4 i2))))
(assert (=> (not (= result7 true)) (=> (not (= j3 (to_rep (first (rt p))))) (= next4 next2))))
(assert (=> (not (= result7 true)) (= j4 j5)))
(assert (=> (not (= result7 true)) (= i3 i4)))
(assert (=> (not (= result7 true)) (= next3 next4)))
(assert (and (= o24 (- (to_rep (last (rt p))) 1)) (in_range1 (- (to_rep (last (rt p))) 1))))
(assert (= o25 (ite (<= i3 o24) true false)))
(assert (= o26 (ite (<= (to_rep (first (rt p))) i3) o25 false)))
(assert (= result14 (ite (not (= o26 true)) true false)))
(assert (not (= result14 true)))
(assert (and (= o27 (- i3 j4)) (in_range1 (- i3 j4))))
(assert (= result15 (mk_int__ref r8b3)))
(assert (= r8b4 o27))
(assert (in_range1 r8b4))
(assert (= result16 (mk_int__ref r9b3)))
(assert (= r9b4 j4))
(assert (in_range1 r9b4))
(assert (and (= o28 (- j4 1)) (in_range1 (- j4 1))))
(assert (= result17 (mk_int__ref r12b3)))
(assert (= r12b4 o28))
(assert (in_range1 r12b4))
(assert (not (= (bool_eq (elts p) (to_rep (first6 (mk3 r8b4 r9b4))) (to_rep (last6 (mk3 r8b4 r9b4))) (elts p) (to_rep (first8 (mk4 0 r12b4))) (to_rep (last8 (mk4 0 r12b4)))) true)))
(check-sat)
(exit)
