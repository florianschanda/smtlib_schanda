...
(assert (forall ((temp___184 Int) (temp___185 Int) (temp___186 Int)) (let ((temp___183 (kmp__init_next__next__aggregate_def temp___184 temp___185 temp___186))) (=> (dynamic_invariant temp___184 true true true true) (and (=> (dynamic_property (- 2147483648) 2147483647 temp___185 temp___186) (and (= (first5 temp___183) temp___185) (= (last5 temp___183) temp___186))) (forall ((temp___187 Int)) (= (to_rep (select (to_array2 temp___183) temp___187)) temp___184)))))))
(define-fun dynamic_invariant2 ((temp___expr_177 us_t1) (temp___is_init_173 Bool) (temp___skip_constant_174 Bool) (temp___do_toplevel_175 Bool) (temp___do_typ_inv_176 Bool)) Bool (=> (not (= temp___skip_constant_174 true)) (and (dynamic_property2 (first1 p) (last1 p) (first3 temp___expr_177) (last3 temp___expr_177)) (and (= (first3 temp___expr_177) (first1 p)) (= (last3 temp___expr_177) (last1 p))))))
...
(assert (= (mk___t2 temp___189 temp___1891) (kmp__init_next__next__aggregate_def 0 (to_rep (first (rt p))) (to_rep (last (rt p))))))
(assert (= (ite (<= (to_rep (first4 temp___1891)) (to_rep (last4 temp___1891))) (+ (- (to_rep (last4 temp___1891)) (to_rep (first4 temp___1891))) 1) 0) (ite (<= (to_rep (first (rt p))) (to_rep (last (rt p)))) (+ (- (to_rep (last (rt p))) (to_rep (first (rt p)))) 1) 0)))
(assert (= (slide temp___189 (to_rep (first4 temp___1891)) (to_rep (first (rt p)))) kmp__init_next__next__assume))
...
(assert (and (and (<= (to_rep (first (rt p))) j2) (<= j2 (to_rep (last (rt p))))) (< i2 j2)))
(assert (= (bool_eq (elts p) (to_rep (first6 (mk3 r8b2 r9b2))) (to_rep (last6 (mk3 r8b2 r9b2))) (elts p) (to_rep (first8 (mk4 0 r12b2))) (to_rep (last8 (mk4 0 r12b2)))) true))
(assert (and (=> (<= (- 2147483648) 2147483647) (in_range1 i2)) (=> (<= (- 2147483648) 2147483647) (in_range1 j2))))
(assert (and (<= (to_rep (first (rt p))) j2) (<= j2 (to_rep (last (rt p))))))
(assert (= o7 j2))
...
(assert (=> (not (= result7 true)) (=> (= j2 (to_rep (first (rt p)))) (and (= o16 (+ i2 1)) (in_range1 (+ i2 1))))))
(assert (=> (not (= result7 true)) (=> (= j2 (to_rep (first (rt p)))) (= i2 result11))))
(assert (=> (not (= result7 true)) (=> (= j2 (to_rep (first (rt p)))) (= i4 o16))))
(assert (=> (not (= result7 true)) (=> (= j2 (to_rep (first (rt p)))) (= (to_rep o17) 0))))
(assert (=> (not (= result7 true)) (=> (= j2 (to_rep (first (rt p)))) (and (<= (to_rep next__first) i4) (<= i4 (to_rep next__last))))))
(assert (=> (not (= result7 true)) (=> (= j2 (to_rep (first (rt p)))) (= o18 i4))))
(assert (=> (not (= result7 true)) (=> (= j2 (to_rep (first (rt p)))) (= o19 (store next2 o18 o17)))))
(assert (=> (not (= result7 true)) (=> (= j2 (to_rep (first (rt p)))) (= result12 (mk_map__ref next2)))))
(assert (=> (not (= result7 true)) (=> (= j2 (to_rep (first (rt p)))) (= next4 o19))))
(assert (=> (not (= result7 true)) (=> (= j2 (to_rep (first (rt p)))) (= j4 j2))))
(assert (=> (not (= result7 true)) (=> (not (= j2 (to_rep (first (rt p))))) (and (<= (to_rep next__first) j2) (<= j2 (to_rep next__last))))))
(assert (=> (not (= result7 true)) (=> (not (= j2 (to_rep (first (rt p))))) (= o20 j2))))
(assert (=> (not (= result7 true)) (=> (not (= j2 (to_rep (first (rt p))))) (= o21 (select next2 o20)))))
(assert (=> (not (= result7 true)) (=> (not (= j2 (to_rep (first (rt p))))) (= o22 (to_rep o21)))))
(assert (=> (not (= result7 true)) (=> (not (= j2 (to_rep (first (rt p))))) (= result13 (mk_int__ref j2)))))
(assert (=> (not (= result7 true)) (=> (not (= j2 (to_rep (first (rt p))))) (= j4 o22))))
(assert (=> (not (= result7 true)) (=> (not (= j2 (to_rep (first (rt p))))) (= i4 i2))))
(assert (=> (not (= result7 true)) (=> (not (= j2 (to_rep (first (rt p))))) (= next4 next2))))
(assert (=> (not (= result7 true)) (= j3 j4)))
(assert (=> (not (= result7 true)) (= i3 i4)))
(assert (=> (not (= result7 true)) (= next3 next4)))
(assert (and (= o23 (- (to_rep (last (rt p))) 1)) (in_range1 (- (to_rep (last (rt p))) 1))))
...
(assert (not (= (bool_eq (elts p) (to_rep (first6 (mk3 r8b3 r9b3))) (to_rep (last6 (mk3 r8b3 r9b3))) (elts p) (to_rep (first8 (mk4 0 r12b3))) (to_rep (last8 (mk4 0 r12b3)))) true)))
(check-sat)
(exit)
