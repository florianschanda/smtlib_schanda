...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (and (= (to_rep2 (rec__p_init__t__e (us_split_discrs1 a))) (to_rep2 (rec__p_init__t__e (us_split_discrs1 b)))) (= (to_rep1 (rec__p_init__t__x1 (us_split_fields1 a))) (to_rep1 (rec__p_init__t__x1 (us_split_fields1 b))))) (=> (p_init__t__x2__pred a) (= (to_rep1 (rec__p_init__t__x2 (us_split_fields1 a))) (to_rep1 (rec__p_init__t__x2 (us_split_fields1 b)))))) true false))
...
(define-fun temp___2384 () us_rep (mk___rep (mk___split_discrs temp___238) (mk___split_fields temp___2381 temp___2382) temp___2383))
(define-fun o16 () us_rep (mk___rep (mk___split_discrs o9) (mk___split_fields o10 o11) o12))
...
(assert (= o7 o3))
(assert (= true o8))
(assert (= o16 (mk___rep (mk___split_discrs o5) (mk___split_fields o6 o7) o8)))
(assert (= temp___2384 o16))
...
(assert (=> (= y1__attr__constrained true) (= (rec__p_init__t__e (us_split_discrs1 temp___226)) y1__split_discrs)))
(assert (= usq_1 temp___226))
(assert (= temp___228 (mk___rep (us_split_discrs1 usq_1) (us_split_fields1 usq_1) y1__attr__constrained)))
(assert (= result3 (mk___split_fields__ref (mk___split_fields y1__split_fields y1__split_fields1))))
(assert (= y1__split_fields2 (us_split_fields1 temp___228)))
(assert (= result4 (mk___split_discrs__ref (mk___split_discrs y1__split_discrs))))
(assert (= y1__split_discrs1 (us_split_discrs1 temp___228)))
(assert (=> (= y1__attr__constrained true) (= (rec__p_init__t__e (us_split_discrs1 c1)) (rec__p_init__t__e y1__split_discrs1))))
(assert (= usq_2 c1))
(assert (= temp___231 (mk___rep (us_split_discrs1 usq_2) (us_split_fields1 usq_2) y1__attr__constrained)))
(assert (= result5 (mk___split_fields__ref y1__split_fields2)))
(assert (= y1__split_fields3 (us_split_fields1 temp___231)))
(assert (= result6 (mk___split_discrs__ref y1__split_discrs1)))
(assert (= y1__split_discrs2 (us_split_discrs1 temp___231)))
(assert (= o15 (init Tuple0)))
(assert (not (= 0 (to_rep2 (rec__p_init__t__e (us_split_discrs1 o15))))))
(check-sat)
(exit)
