...
(assert (= c1 (mk___rep (mk___split_discrs (of_rep2 0)) (mk___split_fields rliteral dummy) true)))
...
(declare-const temp___258 us_rep)
...
(define-fun o13 () us_rep (mk___rep (mk___split_discrs o6) (mk___split_fields o7 o8) o9))
...
(assert (= dummy o4))
(assert (= true o5))
(assert (= o13 (mk___rep (mk___split_discrs o2) (mk___split_fields o3 o4) o5)))
(assert (= temp___2684 o13))
...
(assert (= o10 (init Tuple0)))
(assert (= o11 o10))
(assert (= temp___254 o11))
...
(assert (=> (= y1__attr__constrained true) (= (rec__p_init__t__e (us_split_discrs1 temp___256)) y1__split_discrs)))
(assert (= usq_1 temp___256))
(assert (= temp___258 (mk___rep (us_split_discrs1 usq_1) (us_split_fields1 usq_1) y1__attr__constrained)))
(assert (= result3 (mk___split_fields__ref (mk___split_fields y1__split_fields y1__split_fields1))))
(assert (= y1__split_fields2 (us_split_fields1 temp___258)))
(assert (= result4 (mk___split_discrs__ref (mk___split_discrs y1__split_discrs))))
(assert (= y1__split_discrs1 (us_split_discrs1 temp___258)))
(assert (=> (= y1__attr__constrained true) (= (rec__p_init__t__e (us_split_discrs1 c1)) (rec__p_init__t__e y1__split_discrs1))))
(assert (= usq_2 c1))
(assert (= temp___261 (mk___rep (us_split_discrs1 usq_2) (us_split_fields1 usq_2) y1__attr__constrained)))
(assert (= result5 (mk___split_fields__ref y1__split_fields2)))
(assert (= y1__split_fields3 (us_split_fields1 temp___261)))
(assert (= result6 (mk___split_discrs__ref y1__split_discrs1)))
(assert (= y1__split_discrs2 (us_split_discrs1 temp___261)))
(assert (= o12 (init Tuple0)))
(assert (not (= 0 (to_rep2 (rec__p_init__t__e (us_split_discrs1 o12))))))
(check-sat)
(exit)
