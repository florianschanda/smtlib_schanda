...
(assert (not (= j10 i)))
(assert (type_invariant1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3))))
(assert (and (= o256 (parent1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)) j10)) (and (in_range4 o256) (and (= o256 (parent (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) j10)) (=> (= (size1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3))) 0) (= o256 0))))))
(assert (= o257 (ite (= o256 i) true false)))
(assert (= result46 (ite (not (= o257 true)) true false)))
