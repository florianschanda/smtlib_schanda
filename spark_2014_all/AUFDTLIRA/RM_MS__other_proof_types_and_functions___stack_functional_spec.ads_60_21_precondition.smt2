...
(assert (and (= o14 (count (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1)))) (and (in_range4 o14) (= o14 (to_rep1 (rec__stack_functional_spec__stack_type__pointer (us_split_fields1 (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1)))))))))
...
(assert (and (= o13 (count o17)) (and (in_range4 o13) (= o13 (to_rep1 o12)))))
