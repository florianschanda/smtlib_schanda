...
(assert (and (= o65 (int__content v2)) (in_range1 (int__content v2))))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= o66 (int__content v2)) (in_range1 (int__content v2))))
(assert (not (= (valid_root (mk___rep2 (us_split_fields__content2 f__split_fields7)) o66) true)))
(check-sat)
(exit)
