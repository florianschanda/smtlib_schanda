...
(assert (and (<= (to_rep1 a__first) i8) (<= i8 (to_rep1 a__last))))
(assert (= o86 i8))
(assert (= o87 (select a13 o86)))
(assert (= o88 (us_split_fields1 o87)))
(assert (= o89 (rec__frame_condition__cell__max_right o88)))
(assert (= o90 (to_rep o89)))
(assert (not (<= (to_rep1 a__first) j3)))
(check-sat)
(exit)
