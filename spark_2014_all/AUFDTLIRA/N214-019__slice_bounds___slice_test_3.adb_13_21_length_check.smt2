...
(assert (=> (<= i j) (and (and (<= 1 i) (<= i 8)) (and (<= 1 j) (<= j 8)))))
(assert (= o1 a))
(assert (= o1 temp___176))
(assert (= (mk i j) temp___1761))
(assert (not (= (ite (<= (to_rep1 (first temp___1751)) (to_rep1 (last temp___1751))) (+ (- (to_rep1 (last temp___1751)) (to_rep1 (first temp___1751))) 1) 0) (ite (<= (to_rep1 (first temp___1761)) (to_rep1 (last temp___1761))) (+ (- (to_rep1 (last temp___1761)) (to_rep1 (first temp___1761))) 1) 0))))
(check-sat)
(exit)
