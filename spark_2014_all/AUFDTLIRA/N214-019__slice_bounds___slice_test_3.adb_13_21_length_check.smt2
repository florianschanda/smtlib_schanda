...
(assert (not (= (ite (<= (to_rep1 (first temp___1511)) (to_rep1 (last temp___1511))) (+ (- (to_rep1 (last temp___1511)) (to_rep1 (first temp___1511))) 1) 0) (ite (<= (to_rep1 (first temp___1521)) (to_rep1 (last temp___1521))) (+ (- (to_rep1 (last temp___1521)) (to_rep1 (first temp___1521))) 1) 0))))
(check-sat)
(exit)
