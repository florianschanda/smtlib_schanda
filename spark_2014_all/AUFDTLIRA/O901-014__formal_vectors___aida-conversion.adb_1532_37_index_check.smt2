...
(assert (= o26 (ite (<= index1 o25) true false)))
(assert (and (= o24 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (= o27 (ite (<= o24 index1) true false)))
(assert (= result (ite (= o27 true) o26 false)))
(assert (= (= o28 true) (forall ((index11 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 6) index11) (<= index11 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index11))) true)))))
(assert (and (= temp___1971 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1971) (<= temp___1971 (to_rep1 (last (rt source))))))
(assert (= o20 temp___1971))
(assert (= o21 (select (elts source) o20)))
(assert (= o22 (to_rep o21)))
(assert (= o23 (ite (< o22 56) true false)))
(assert (and (= temp___1970 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1970) (<= temp___1970 (to_rep1 (last (rt source))))))
(assert (= o16 temp___1970))
(assert (= o17 (select (elts source) o16)))
(assert (= o18 (to_rep o17)))
(assert (= o19 (ite (= o18 52) true false)))
(assert (and (= temp___1969 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1969) (<= temp___1969 (to_rep1 (last (rt source))))))
(assert (= o12 temp___1969))
(assert (= o13 (select (elts source) o12)))
(assert (= o14 (to_rep o13)))
(assert (= o15 (ite (= o14 55) true false)))
(assert (and (= temp___1968 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1968) (<= temp___1968 (to_rep1 (last (rt source))))))
(assert (= o8 temp___1968))
(assert (= o9 (select (elts source) o8)))
(assert (= o10 (to_rep o9)))
(assert (= o11 (ite (= o10 52) true false)))
(assert (and (= temp___1967 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (not (<= (to_rep1 (first (rt source))) temp___1967)))
(check-sat)
(exit)
