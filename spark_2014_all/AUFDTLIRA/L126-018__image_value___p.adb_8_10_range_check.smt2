...
(define-fun t__ref___projection ((a t__ref)) t1 (t__content a))
(define-fun dynamic_invariant2 ((temp___expr_579 Int) (temp___is_init_575 Bool) (temp___skip_constant_576 Bool) (temp___do_toplevel_577 Bool) (temp___do_typ_inv_578 Bool)) Bool (=> (or (= temp___is_init_575 true) (<= 1 10)) (in_range3 temp___expr_579)))
...
(declare-const p__s__assume (Array Int character))
(declare-const p__s__assume1 t)
(declare-const o Int)
(declare-const result Int)
(declare-const x1 Int)
(declare-const result1 (Array Int character))
(declare-const s1 (Array Int character))
(define-fun p__s__assume2 () us_t (mk___t p__s__assume p__s__assume1))
(assert (in_range y))
(assert (= result x))
(assert (= x1 1))
(assert (in_range3 x1))
(assert (and (= p__s__assume2 (get_line__4 Tuple0)) (dynamic_invariant1 p__s__assume2 true false true true)))
(assert (= result1 s))
(assert (= s1 p__s__assume))
(assert (= (to_rep1 s__first) (to_rep1 (first p__s__assume1))))
(assert (= (to_rep1 s__last) (to_rep1 (last p__s__assume1))))
