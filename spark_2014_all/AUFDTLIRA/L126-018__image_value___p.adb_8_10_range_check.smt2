...
(define-fun dynamic_invariant2 ((temp___expr_514 Int) (temp___is_init_511 Bool) (temp___skip_constant_512 Bool) (temp___do_toplevel_513 Bool)) Bool (=> (or (= temp___is_init_511 true) (<= 1 10)) (in_range3 temp___expr_514)))
...
(assert (= x1 1))
(assert (in_range3 x1))
(assert (and (= p__s__assume2 (get_line__4 Tuple0)) (dynamic_invariant1 p__s__assume2 true false true)))
(assert (= result1 s))
