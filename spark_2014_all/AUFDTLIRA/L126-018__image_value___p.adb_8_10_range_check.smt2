...
(define-fun dynamic_invariant2 ((temp___expr_508 Int) (temp___is_init_505 Bool) (temp___skip_constant_506 Bool) (temp___do_toplevel_507 Bool)) Bool (=> (or (= temp___is_init_505 true) (<= 1 10)) (in_range3 temp___expr_508)))
...
(assert (= x1 1))
(assert (in_range3 x1))
(assert (and (= (mk___t p__s__assume p__s__assume1) (get_line__4 Tuple0)) (dynamic_invariant1 (mk___t p__s__assume p__s__assume1) true false true)))
(assert (= result1 s))
