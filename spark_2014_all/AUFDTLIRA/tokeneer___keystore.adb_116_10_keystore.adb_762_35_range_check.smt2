...
(declare-const temp___1168 (Array Int character))
(declare-const temp___11681 t1)
...
(assert (= (slide (elts thestring) (to_rep1 (first (rt thestring))) 1) temp___1168))
(assert (= (mk1 1 (length thestring)) temp___11681))
(assert (and (= temp___1170 (length thestring)) (in_range1 (length thestring))))
(assert (<= 1 temp___1170))
(assert (not (<= 1 1)))
(check-sat)
(exit)
