...
(define-fun dynamic_invariant ((temp___expr_212 us_t2) (temp___is_init_209 Bool) (temp___skip_constant_210 Bool) (temp___do_toplevel_211 Bool)) Bool (=> (not (= temp___skip_constant_210 true)) (and (dynamic_property3 (to_rep a__first) (to_rep a__last) (first5 temp___expr_212) (last5 temp___expr_212)) (and (= (first5 temp___expr_212) (to_rep a__first)) (= (last5 temp___expr_212) (to_rep a__last))))))
...
(assert (forall ((temp___228 Int) (temp___229 Int) (temp___230 Int)) (let ((temp___227 (essai05__a__aggregate_def temp___228 temp___229 temp___230))) (and (and (= (select temp___227 (- 3)) (of_rep1 temp___228)) (= (select temp___227 (- 2)) (of_rep1 temp___229))) (= (select temp___227 (- 1)) (of_rep1 temp___230))))))
