...
(assert (= result4 true))
(assert (and (= o34 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (and (in_range5 o34) (<= (+ 0 o34) 2147483647))))
(assert (= o35 (ite (<= j2 o34) true false)))
(assert (= result7 (ite (<= 1 j2) o35 false)))
(assert (= result7 true))
(assert (and (= o39 (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m)) j2)) (in_range6 o39)))
(assert (= result8 (ite (in_range3 o39) true false)))
(assert (= result8 true))
(assert (and (= o36 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (and (in_range5 o36) (<= (+ 0 o36) 2147483647))))
(assert (= result9 (ite (< j2 o36) true false)))
(assert (= result9 true))
(assert (and (= o37 (+ j2 1)) (in_range1 (+ j2 1))))
(assert (and (= o38 (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m)) o37)) (in_range6 o38)))
(assert (not (<= 1 j2)))
(check-sat)
(exit)
