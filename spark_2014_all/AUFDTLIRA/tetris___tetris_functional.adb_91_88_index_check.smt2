...
(assert (=> (= result3 true) (= has_complete_lines2 (distinct 1 0))))
...
(assert (and (and (and (forall ((temp___812 Int)) (=> (and (<= 1 temp___812) (<= temp___812 50)) (=> (< del_line2 temp___812) (= (select cur_board3 temp___812) (select cur_board temp___812))))) (=> (<= 1 50) (in_range4 del_line2))) (=> (<= 1 50) (in_range4 to_line3))) (and (<= 1 del_line2) (<= del_line2 50))))
(assert (<= 1 y))
(assert (<= y del_line2))
(assert (not (<= 1 y)))
(check-sat)
