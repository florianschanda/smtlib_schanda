...
(assert (forall ((x enum1t)) (! (in_range3 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(declare-fun temp___4045 ((Array Int us_rep) Int us_rep) (Array Int us_rep))
...
(define-fun dynamic_invariant3 ((temp___expr_232 Int) (temp___is_init_228 Bool) (temp___skip_constant_229 Bool) (temp___do_toplevel_230 Bool) (temp___do_typ_inv_231 Bool)) Bool (=> (or (= temp___is_init_228 true) (<= 0 6)) (in_range3 temp___expr_232)))
(assert (forall ((temp___4047 (Array Int us_rep))) (forall ((temp___4048 Int)) (forall ((temp___4049 us_rep)) (let ((temp___4046 (temp___4045 temp___4047 temp___4048 temp___4049))) (=> (dynamic_invariant temp___4048 true true true true) (forall ((temp___4050 Int)) (ite (= temp___4050 temp___4048) (= (select temp___4046 temp___4050) temp___4049) (= (select temp___4046 temp___4050) (select temp___4047 temp___4050))))))))))
...
(declare-const temp___9374 (Array Int us_rep))
(declare-const temp___93741 Bool)
(declare-const temp___93742 enum1t)
...
(assert (= (to_rep o) e))
(assert (= o o1))
(assert (= (rec__ar__rec1t__g1 (us_split_fields1 (select r__split_fields i))) o2))
(assert (= o3 o1))
(assert (= o4 o2))
(assert (= o5 (store r__split_fields i (mk___rep (mk___split_fields o3 o4)))))
(assert (= o5 o6))
(assert (= r__split_fields1 o7))
(assert (= r__split_fields2 o8))
(assert (= temp___9374 o6))
(assert (= temp___93741 o7))
(assert (= temp___93742 o8))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= result2 r__split_fields2))
(assert (= temp___9374 r__split_fields3))
(assert (= temp___93741 r__split_fields4))
(assert (= temp___93742 r__split_fields5))
...
(assert (not (= (bool_eq2 (mk___rep1 (mk___split_fields1 r__split_fields6 r__split_fields7 r__split_fields8)) (mk___rep1 (mk___split_fields1 (temp___4045 r__split_fields i (mk___rep (mk___split_fields (of_rep e) (rec__ar__rec1t__g1 (us_split_fields1 (select r__split_fields i)))))) r__split_fields1 r__split_fields2))) true)))
(check-sat)
(exit)
