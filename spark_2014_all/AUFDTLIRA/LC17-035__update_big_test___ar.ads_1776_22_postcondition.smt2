...
(assert (forall ((temp___3988 (Array Int us_rep))) (forall ((temp___3989 Int)) (forall ((temp___3990 us_rep)) (let ((temp___3987 (temp___3986 temp___3988 temp___3989 temp___3990))) (forall ((temp___3991 Int)) (ite (= temp___3991 temp___3989) (= (select temp___3987 temp___3991) temp___3990) (= (select temp___3987 temp___3991) (select temp___3988 temp___3991)))))))))
...
(define-fun dynamic_invariant3 ((temp___expr_200 Int) (temp___is_init_197 Bool) (temp___skip_constant_198 Bool) (temp___do_toplevel_199 Bool)) Bool (=> (or (= temp___is_init_197 true) (<= 0 6)) (in_range3 temp___expr_200)))
...
(declare-const temp___9315 (Array Int us_rep))
(declare-const temp___93151 Bool)
(declare-const temp___93152 enum1t)
...
(assert (not (= (bool_eq2 (mk___rep1 (mk___split_fields1 r__split_fields6 r__split_fields7 r__split_fields8)) (mk___rep1 (mk___split_fields1 (temp___3986 r__split_fields i (mk___rep (mk___split_fields (of_rep e) (rec__ar__rec1t__g1 (us_split_fields1 (select r__split_fields i)))))) r__split_fields1 r__split_fields2))) true)))
(check-sat)
(exit)
