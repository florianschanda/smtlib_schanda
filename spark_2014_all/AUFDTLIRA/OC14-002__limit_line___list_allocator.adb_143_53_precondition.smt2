...
(assert (and (= o104 (length (rec__list_allocator__m__t__available model____split_fields4))) (in_range6 o104)))
(assert (= o105 (ite (<= j5 o104) true false)))
(assert (= result25 (ite (<= 1 j5) o105 false)))
(assert (= result25 true))
(assert (and (= o107 (length (rec__list_allocator__m__t__available model____split_fields4))) (in_range6 o107)))
(assert (= result26 (ite (< j5 o107) true false)))
(assert (= result26 true))
(assert (and (= o108 (+ j5 2)) (in_range1 (+ j5 2))))
(assert (not (<= 1 o108)))
(check-sat)
(exit)
