...
(assert (= (bool_eq a1 0 5 a_update 0 5) true))
(assert (and (= o61 (has_key (positions (mk___rep d__split_discrs d__split_fields1)) c2)) (= (= o61 true) (= (has_key (positions (mk___rep d__split_discrs d__split_fields1)) c2) true))))
(assert (= o62 true))
(assert (= result9 (ite (= o62 true) o61 false)))
(assert (= result9 true))
(assert (and (= o65 (key (mk___rep d__split_discrs d__split_fields1) c2)) (and (in_range5 o65) (= o65 (get (keys (mk___rep d__split_discrs d__split_fields1)) (get1 (positions (mk___rep d__split_discrs d__split_fields1)) c2))))))
(assert (= o66 (ite (= o65 (to_rep (select a1 j))) true false)))
(assert (= o67 (ite (not (= o66 true)) true false)))
(assert (and (= o63 (key (mk___rep d__split_discrs d__split_fields1) c2)) (and (in_range5 o63) (= o63 (get (keys (mk___rep d__split_discrs d__split_fields1)) (get1 (positions (mk___rep d__split_discrs d__split_fields1)) c2))))))
(assert (= o64 (ite (= o63 (to_rep (select a1 i))) true false)))
(assert (= o68 (ite (not (= o64 true)) true false)))
(assert (= result10 (ite (= o68 true) o67 false)))
(assert (= result10 true))
(assert (not (= (has_key (positions (mk___rep d__split_discrs d__split_fields1)) c2) true)))
(check-sat)
(exit)
