...
(assert (= result2 true))
(assert (and (= o4 (key (mk___rep d__split_discrs d__split_fields1) c)) (and (in_range3 o4) (= o4 (get (keys (mk___rep d__split_discrs d__split_fields1)) (get1 (positions (mk___rep d__split_discrs d__split_fields1)) c))))))
(assert (= o5 (ite (= o4 (to_rep (select a1 j))) true false)))
(assert (= o6 (ite (not (= o5 true)) true false)))
(assert (and (= o2 (key (mk___rep d__split_discrs d__split_fields1) c)) (and (in_range3 o2) (= o2 (get (keys (mk___rep d__split_discrs d__split_fields1)) (get1 (positions (mk___rep d__split_discrs d__split_fields1)) c))))))
