...
(assert (= (bool_eq a1 0 5 a_update 0 5) true))
(assert (and (= o (has_key (positions (mk___rep d__split_discrs d__split_fields1)) c)) (= (= o true) (= (has_key (positions (mk___rep d__split_discrs d__split_fields1)) c) true))))
(assert (= o1 true))
(assert (= result2 (ite (= o1 true) o false)))
(assert (= result2 true))
(assert (and (= o4 (key (mk___rep d__split_discrs d__split_fields1) c)) (and (in_range5 o4) (= o4 (get (keys (mk___rep d__split_discrs d__split_fields1)) (get1 (positions (mk___rep d__split_discrs d__split_fields1)) c))))))
(assert (= o5 (ite (= o4 (to_rep (select a1 j))) true false)))
(assert (= o6 (ite (not (= o5 true)) true false)))
(assert (and (= o2 (key (mk___rep d__split_discrs d__split_fields1) c)) (and (in_range5 o2) (= o2 (get (keys (mk___rep d__split_discrs d__split_fields1)) (get1 (positions (mk___rep d__split_discrs d__split_fields1)) c))))))
(assert (= o3 (ite (= o2 (to_rep (select a1 i))) true false)))
(assert (= o7 (ite (not (= o3 true)) true false)))
(assert (= result3 (ite (= o7 true) o6 false)))
(assert (= result3 true))
(assert (not (= (has_key (positions (mk___rep d__split_discrs d__split_fields1)) c) true)))
(check-sat)
(exit)
