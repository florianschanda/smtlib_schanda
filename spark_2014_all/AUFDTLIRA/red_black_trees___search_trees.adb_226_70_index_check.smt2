...
(assert (=> (= result27 true) (and (= temp___1309 (model__ f root)) (and (dynamic_invariant5 temp___1309 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1309 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1309 root)))) 0) (and (forall ((i34 Int)) (=> (and (<= 1 i34) (<= i34 100)) (=> (not (= i34 root)) (ite (and (not (= (parent f i34) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1309 (parent f i34)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1309 i34))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1309 i34))) true)))))) (and (forall ((i34 Int)) (=> (and (<= 1 i34) (<= i34 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1309 i34))) true) (not (= i34 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1309 (parent f i34)))) (position f i34) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1309 i34)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1309 i34)))) 0)))) (forall ((i34 Int)) (=> (and (<= 1 i34) (<= i34 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1309 i34))) true) (forall ((j52 Int)) (=> (and (<= 1 j52) (<= j52 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1309 j52))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1309 i34))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1309 j52)))) true)) (= j52 i34)))))))))))))))
(assert (=> (= result27 true) (and (<= 1 k1) (<= k1 100))))
(assert (=> (= result27 true) (= o95 k1)))
(assert (=> (= result27 true) (= o96 (select temp___1309 o95))))
(assert (=> (= result27 true) (= o97 (us_split_fields1 o96))))
(assert (=> (= result27 true) (= result26 (rec__tree_model__path_type__k o97))))
(assert (=> (not (= result27 true)) (= result26 false)))
(assert (= result26 true))
(assert (and (= temp___1311 (model__ f root)) (and (dynamic_invariant5 temp___1311 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1311 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1311 root)))) 0) (and (forall ((i34 Int)) (=> (and (<= 1 i34) (<= i34 100)) (=> (not (= i34 root)) (ite (and (not (= (parent f i34) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1311 (parent f i34)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1311 i34))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1311 i34))) true)))))) (and (forall ((i34 Int)) (=> (and (<= 1 i34) (<= i34 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1311 i34))) true) (not (= i34 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1311 (parent f i34)))) (position f i34) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1311 i34)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1311 i34)))) 0)))) (forall ((i34 Int)) (=> (and (<= 1 i34) (<= i34 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1311 i34))) true) (forall ((j52 Int)) (=> (and (<= 1 j52) (<= j52 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1311 j52))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1311 i34))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1311 j52)))) true)) (= j52 i34))))))))))))))
(assert (not (<= 1 k1)))
(check-sat)
(exit)
