...
(assert (<= j8 100))
(assert (type_invariant1 (mk___rep3 (us_split_fields__content3 t__split_fields14))))
(assert (and (= o113 (parent1 (mk___rep3 (us_split_fields__content3 t__split_fields14)) j8)) (and (in_range4 o113) (and (= o113 (parent (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14)) j8)) (=> (= (size1 (mk___rep3 (us_split_fields__content3 t__split_fields14))) 0) (= o113 0))))))
(assert (= o114 (ite (= o113 0) true false)))
(assert (= o115 (ite (not (= o114 true)) true false)))
(assert (= result44 (ite (not (= (int__content i18) j8)) o115 false)))
