...
(assert (=> (not (= (int__content i14) 0)) (= o37 (int__content i14))))
(assert (=> (not (= (int__content i14) 0)) (= o38 (select temp___820 o37))))
(assert (=> (not (= (int__content i14) 0)) (= o39 (us_split_fields1 o38))))
(assert (=> (not (= (int__content i14) 0)) (= result22 (rec__tree_model__path_type__k o39))))
(assert (=> (not (not (= (int__content i14) 0))) (= result22 false)))
...
(assert (=> (= result22 true) (and (= o35 (root (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)))) (and (in_range3 o35) (= o35 (to_rep1 t__split_fields))))))
(assert (=> (= result22 true) (type_invariant1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))))
(assert (=> (= result22 true) (and (= o36 (root (mk___rep3 (us_split_fields__content3 t__split_fields14)))) (and (in_range3 o36) (= o36 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields__content3 t__split_fields14))))))))
(assert (=> (= result22 true) (= result21 (ite (= o36 o35) true false))))
...
(assert (=> (= result21 true) (and (= o34 (size1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))) (and (in_range4 o34) (= o34 (size (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14))))))))
(assert (=> (= result21 true) (= result20 (ite (= o34 (+ (size1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3))) 1)) true false))))
...
(assert (=> (= result20 true) (and (= o33 (values1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))) (ite (= (size (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14))) 0) (= (is_empty o33) true) (and (forall ((i16 Int)) (=> (and (<= 1 i16) (<= i16 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields__content3 t__split_fields14)))) i16))) true) (= (contains o33 (to_rep (select (rec__search_trees__search_tree__values (us_split_fields__content3 t__split_fields14)) i16))) true)))) (forall ((v1 Int)) (=> (and (<= 0 v1) (<= v1 2147483647)) (=> (= (contains o33 v1) true) (exists ((i16 Int)) (and (and (<= 1 i16) (<= i16 100)) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields__content3 t__split_fields14)))) i16))) true) (= (to_rep (select (rec__search_trees__search_tree__values (us_split_fields__content3 t__split_fields14)) i16)) v1))))))))))))
...
(assert (= result23 (ite (not (= (int__content i14) j)) o31 false)))
