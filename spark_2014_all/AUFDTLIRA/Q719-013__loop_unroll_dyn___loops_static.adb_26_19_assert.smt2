...
(assert (<= 1 i2))
(assert (<= i2 2))
(assert (and (forall ((temp___393 Int)) (=> (and (<= (to_rep1 a__first) temp___393) (<= temp___393 (to_rep1 a__last))) (=> (<= i3 temp___393) (= (select a2 temp___393) (select a temp___393))))) (and (<= 1 i3) (<= i3 2))))
(assert (= j2 result1))
(assert (= j3 1))
(assert (<= 1 j3))
(assert (<= j3 2))
(assert (and (forall ((temp___388 Int)) (=> (and (<= (to_rep1 a__first) temp___388) (<= temp___388 (to_rep1 a__last))) (=> (not (= i3 temp___388)) (= (select a3 temp___388) (select a2 temp___388))))) (and (<= 1 j4) (<= j4 2))))
(assert (= (to_rep o) 0))
(assert (and (<= (to_rep1 a__first) i3) (<= i3 (to_rep1 a__last))))
(assert (= o1 i3))
(assert (= o2 (store a3 o1 o)))
(assert (= a3 result2))
(assert (= a4 o2))
(assert (=> (<= (to_rep1 a__first) i3) (and (and (<= (to_rep1 a__first) (to_rep1 a__first)) (<= (to_rep1 a__first) (to_rep1 a__last))) (and (<= (to_rep1 a__first) i3) (<= i3 (to_rep1 a__last))))))
(assert (= o3 a4))
(assert (= o3 temp___385))
(assert (= (mk1 (to_rep1 a__first) i3) temp___3851))
(assert (= temp___385 loops_static__loop11__B_5__a_begins__assume))
(assert (= (mk (to_rep1 (first2 temp___3851)) (to_rep1 (last2 temp___3851))) loops_static__loop11__B_5__a_begins__assume1))
(assert (= (mk___t loops_static__loop11__B_5__a_begins__assume loops_static__loop11__B_5__a_begins__assume1) a_begins))
(assert (dynamic_invariant a_begins true false true))
(declare-const i8 Int)
(assert (<= (to_rep1 (first (rt a_begins))) i8))
(assert (<= i8 (to_rep1 (last (rt a_begins)))))
(assert (not (= (to_rep (select (elts a_begins) i8)) 0)))
(check-sat)
(exit)
