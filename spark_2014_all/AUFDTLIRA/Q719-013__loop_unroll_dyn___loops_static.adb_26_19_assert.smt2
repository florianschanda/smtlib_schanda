...
(assert (<= 1 i1))
(assert (<= i1 2))
(assert (and (forall ((temp___393 Int)) (=> (and (<= (to_rep1 a__first) temp___393) (<= temp___393 (to_rep1 a__last))) (=> (<= i2 temp___393) (= (select a1 temp___393) (select a temp___393))))) (and (<= 1 i2) (<= i2 2))))
(assert (= j result1))
(assert (= j1 1))
(assert (<= 1 j1))
(assert (<= j1 2))
(assert (and (forall ((temp___388 Int)) (=> (and (<= (to_rep1 a__first) temp___388) (<= temp___388 (to_rep1 a__last))) (=> (not (= i2 temp___388)) (= (select a2 temp___388) (select a1 temp___388))))) (and (<= 1 j2) (<= j2 2))))
(assert (= (to_rep o) 0))
...
(assert (= (mk1 (to_rep1 a__first) i2) temp___3851))
