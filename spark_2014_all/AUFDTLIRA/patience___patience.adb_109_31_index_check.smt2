...
(assert (and (= o213 (+ j2 1)) (in_range1 (+ j2 1))))
(assert (= o219 (ite (<= o213 k1) true false)))
(assert (= result39 (ite (= o219 true) o218 false)))
(assert (= result39 true))
(assert (and (<= 0 i5) (<= i5 99)))
(assert (= o221 i5))
(assert (= temp___694 (select (rec__patience__state__stacks (us_split_fields__content s__split_fields20)) o221)))
(assert (and (<= 0 k1) (<= k1 99)))
(assert (= o222 k1))
(assert (= o223 (select temp___694 o222)))
(assert (= o224 (to_rep1 o223)))
(assert (and (<= 0 i5) (<= i5 99)))
(assert (= o220 i5))
(assert (= temp___692 (select (rec__patience__state__stacks (us_split_fields__content s__split_fields20)) o220)))
(assert (not (<= 0 j2)))
(check-sat)
(exit)
