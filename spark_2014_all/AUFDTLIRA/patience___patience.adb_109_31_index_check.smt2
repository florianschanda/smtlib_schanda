...
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o118 i1))
(assert (= temp___694 (select (rec__patience__state__stacks (us_split_fields__content s__split_fields20)) o118)))
(assert (and (<= 0 k) (<= k 99)))
(assert (= o119 k))
...
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o117 i1))
(assert (= temp___692 (select (rec__patience__state__stacks (us_split_fields__content s__split_fields20)) o117)))
(assert (not (<= 0 j)))
(check-sat)
(exit)
