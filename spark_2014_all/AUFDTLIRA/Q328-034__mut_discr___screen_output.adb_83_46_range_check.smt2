...
(assert (=> (<= 1 2) (= o5 (+ (- 2 1) 1))))
(assert (=> (not (<= 1 2)) (= o5 0)))
(assert (=> (<= (to_rep1 (first temp___6051)) (to_rep1 (last temp___6051))) (= o6 (+ (- (to_rep1 (last temp___6051)) (to_rep1 (first temp___6051))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___6051)) (to_rep1 (last temp___6051)))) (= o6 0)))
(assert (= o7 (+ o6 o5)))
(assert (= o8 (+ (to_rep1 (first temp___6051)) o7)))
(assert (= o9 (- o8 1)))
