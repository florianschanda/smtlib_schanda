...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (= (to_rep (select (temp___String_Literal_668 us_void_param) 1)) 115) (= (to_rep (select (temp___String_Literal_668 us_void_param) 2)) 100)) (= (to_rep (select (temp___String_Literal_668 us_void_param) 3)) 99)) (= (to_rep (select (temp___String_Literal_668 us_void_param) 4)) 58)) :pattern ((temp___String_Literal_668 us_void_param)))))
(declare-fun temp___String_Literal_669 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (= (to_rep (select (temp___String_Literal_669 us_void_param) 1)) 115) (= (to_rep (select (temp___String_Literal_669 us_void_param) 2)) 100)) (= (to_rep (select (temp___String_Literal_669 us_void_param) 3)) 99)) (= (to_rep (select (temp___String_Literal_669 us_void_param) 4)) 58)) :pattern ((temp___String_Literal_669 us_void_param)))))
(declare-fun temp___String_Literal_672 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (= (to_rep (select (temp___String_Literal_672 us_void_param) 1)) 45) :pattern ((temp___String_Literal_672 us_void_param)))))
(declare-fun temp___String_Literal_673 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (= (to_rep (select (temp___String_Literal_673 us_void_param) 1)) 33) :pattern ((temp___String_Literal_673 us_void_param)))))
(declare-fun temp___String_Literal_674 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_674 us_void_param) 1)) 115) (= (to_rep (select (temp___String_Literal_674 us_void_param) 2)) 100)) (= (to_rep (select (temp___String_Literal_674 us_void_param) 3)) 99)) (= (to_rep (select (temp___String_Literal_674 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_674 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_674 us_void_param) 6)) 110)) (= (to_rep (select (temp___String_Literal_674 us_void_param) 7)) 112)) (= (to_rep (select (temp___String_Literal_674 us_void_param) 8)) 117)) (= (to_rep (select (temp___String_Literal_674 us_void_param) 9)) 116)) (= (to_rep (select (temp___String_Literal_674 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_674 us_void_param) 11)) 101)) (= (to_rep (select (temp___String_Literal_674 us_void_param) 12)) 114)) (= (to_rep (select (temp___String_Literal_674 us_void_param) 13)) 114)) (= (to_rep (select (temp___String_Literal_674 us_void_param) 14)) 111)) (= (to_rep (select (temp___String_Literal_674 us_void_param) 15)) 114)) (= (to_rep (select (temp___String_Literal_674 us_void_param) 16)) 32)) (= (to_rep (select (temp___String_Literal_674 us_void_param) 17)) 97)) (= (to_rep (select (temp___String_Literal_674 us_void_param) 18)) 116)) (= (to_rep (select (temp___String_Literal_674 us_void_param) 19)) 32)) (= (to_rep (select (temp___String_Literal_674 us_void_param) 20)) 108)) (= (to_rep (select (temp___String_Literal_674 us_void_param) 21)) 105)) (= (to_rep (select (temp___String_Literal_674 us_void_param) 22)) 110)) (= (to_rep (select (temp___String_Literal_674 us_void_param) 23)) 101)) :pattern ((temp___String_Literal_674 us_void_param)))))
(declare-fun temp___String_Literal_675 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_675 us_void_param) 1)) 58) (= (to_rep (select (temp___String_Literal_675 us_void_param) 2)) 32)) :pattern ((temp___String_Literal_675 us_void_param)))))
...
(define-fun temp___6762 () us_t (mk___t temp___676 temp___6761))
...
(assert (= temp___6762 (to_string o4)))
(assert (not (= (length temp___6762) 0)))
(assert (=> (<= 1 2) (= o5 (+ (- 2 1) 1))))
(assert (=> (not (<= 1 2)) (= o5 0)))
(assert (=> (<= (to_rep1 (first temp___6761)) (to_rep1 (last temp___6761))) (= o6 (+ (- (to_rep1 (last temp___6761)) (to_rep1 (first temp___6761))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___6761)) (to_rep1 (last temp___6761)))) (= o6 0)))
(assert (= o7 (+ o6 o5)))
(assert (= o8 (+ (to_rep1 (first temp___6761)) o7)))
(assert (= o9 (- o8 1)))
