...
(assert (and (= o10 (current_line line last_char)) (dynamic_invariant2 o10 true false true)))
(assert (= (- pos2 1) r14b))
...
(assert (=> (<= 1 2) (= o5 (+ (- 2 1) 1))))
(assert (=> (not (<= 1 2)) (= o5 0)))
(assert (=> (<= (to_rep1 (first temp___6111)) (to_rep1 (last temp___6111))) (= o6 (+ (- (to_rep1 (last temp___6111)) (to_rep1 (first temp___6111))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___6111)) (to_rep1 (last temp___6111)))) (= o6 0)))
(assert (= o7 (+ o6 o5)))
