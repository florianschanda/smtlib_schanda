...
(assert (=> (and (<= 1 i2) (<= i2 100)) (forall ((k Int)) (=> (and (<= 1 k) (<= k (- i3 1))) (forall ((j19 Int)) (=> (and (<= 1 j19) (<= j19 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f root) k))) true) (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f root) j19))) true)) (= (olt (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) k))) (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) j19)))) true)) (ite (= (get (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) j19))) (+ (length (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) k)))) 1)) 0) (< (to_rep (select values j19)) (to_rep (select values k))) (< (to_rep (select values k)) (to_rep (select values j19)))))))))))
...
(assert (=> (= result11 true) (= (olt (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f_old root) i9))) (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f_old root) j16)))) true)))
(assert (=> (= result11 true) (ite (= (get (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f v) j16))) (+ (length (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f v) i9)))) 1)) 0) (< (to_rep (select values j16)) (to_rep (select values i9))) (< (to_rep (select values i9)) (to_rep (select values j16))))))
(assert (= j17 (mk_int__ref j16)))
(assert (= j18 j16))
(declare-const k Int)
(assert (<= 1 k))
(assert (<= k (int__content j17)))
(assert (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f v) i9))) true))
(assert (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f v) k))) true))
(assert (= (olt (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f v) i9))) (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f v) k)))) true))
(assert (not (= (get (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f v) k))) (+ (length (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f v) i9)))) 1)) 0)))
(assert (not (< (to_rep (select values i9)) (to_rep (select values k)))))
(check-sat)
(exit)
