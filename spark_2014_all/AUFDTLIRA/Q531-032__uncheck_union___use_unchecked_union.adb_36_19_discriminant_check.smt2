...
(declare-const temp___270 us_rep2)
...
(assert (= temp___270 (mk___rep2 (mk___split_discrs output__split_discrs) o3 output__attr__constrained)))
...
(assert (= output__split_fields4 (us_split_fields5 temp___270)))
(assert (= result1 (mk___split_discrs__ref (mk___split_discrs output__split_discrs))))
(assert (= output__split_discrs1 (us_split_discrs1 temp___270)))
