...
(assert (= num 1))
(assert (= (to_rep o9) 1))
(assert (= o10 (mk___split_fields1 o9 output__split_fields3)))
(assert (= o11 (mk___rep1 o10)))
(assert (= o12 (mk___split_fields2 (mk___rep (mk___split_fields output__split_fields output__split_fields1)) o11)))
(assert (= temp___243 (mk___rep2 (mk___split_discrs output__split_discrs) o12 output__attr__constrained)))
(assert (= result2 (mk___split_fields__ref2 (mk___split_fields2 (mk___rep (mk___split_fields output__split_fields output__split_fields1)) (mk___rep1 (mk___split_fields1 output__split_fields2 output__split_fields3))))))
(assert (= output__split_fields5 (us_split_fields5 temp___243)))
(assert (= result3 (mk___split_discrs__ref (mk___split_discrs output__split_discrs))))
(assert (= output__split_discrs2 (us_split_discrs1 temp___243)))
(assert (not (not (= (to_rep (rec__use_unchecked_union__myunion__discr output__split_discrs2)) 0))))
(check-sat)
(exit)
