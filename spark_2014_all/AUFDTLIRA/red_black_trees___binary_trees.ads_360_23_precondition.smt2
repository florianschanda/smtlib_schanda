...
(assert (= result8 true))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= o43 (peek (mk___rep2 (us_split_fields__content2 f__split_fields7)) i d)) (and (in_range2 o43) (and (= o43 (ite (= d 0) (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) i)))) (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) i)))))) (and (ite (not (= o43 0)) (and (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) o43) d) (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) o43) i)) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j1) i) (not (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) j1) d)))))) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j1) i) (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) j1) d)) (= o43 j1)))))))))
...
(assert (= (= result13 true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (not (= j1 (int__content v2))) (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j1) 0))) (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) j1) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j1)))))))
(assert (= result13 true))
(assert (= (= result14 true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (forall ((e Int)) (=> (and (<= 0 e) (<= e 1)) (=> (or (not (= j1 i)) (not (= e d))) (= (peek (mk___rep2 (us_split_fields__content2 f__split_fields7)) j1 e) (peek (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j1 e)))))))))
