...
(assert (not (= (is_prepend (rec__list_mod_allocator__m__t__available (us_split_fields3 (model__ data first_available))) res (rec__list_mod_allocator__m__t__available (us_split_fields3 (model__ (map__content data5) (int__content first_available5))))) true)))
(check-sat)
(exit)
