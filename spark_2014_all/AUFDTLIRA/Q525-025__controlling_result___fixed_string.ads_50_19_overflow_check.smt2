...
(assert (forall ((temp___244 Int) (temp___245 Int) (temp___246 Int)) (let ((temp___243 (temp___242 temp___244 temp___245 temp___246))) (and (=> (dynamic_property 1 2147483647 temp___245 temp___246) (and (= (first3 temp___243) temp___245) (= (last3 temp___243) temp___246))) (forall ((temp___247 Int)) (= (select (to_array1 temp___243) temp___247) (of_rep temp___244)))))))
...
(assert (= (to_rep1 (first2 (rt1 (temp___242 0 (to_rep1 change__first) (to_rep1 change__last))))) (to_rep1 change__first)))
(assert (= (to_rep1 (last2 (rt1 (temp___242 0 (to_rep1 change__first) (to_rep1 change__last))))) (to_rep1 change__last)))
(assert (= (mk___t1 temp___249 temp___2491) (temp___242 0 (to_rep1 change__first) (to_rep1 change__last))))
(assert (= temp___249 temp___250))
(assert (= (mk (to_rep1 (first2 temp___2491)) (to_rep1 (last2 temp___2491))) temp___2501))
(assert (= (ite (<= (to_rep1 (first temp___2501)) (to_rep1 (last temp___2501))) (+ (- (to_rep1 (last temp___2501)) (to_rep1 (first temp___2501))) 1) 0) (ite (<= (to_rep1 change__first) (to_rep1 change__last)) (+ (- (to_rep1 change__last) (to_rep1 change__first)) 1) 0)))
(assert (= (mk___t temp___251 temp___2511) (mk___t temp___250 temp___2501)))
(assert (= o5 (slide temp___251 (to_rep1 (first temp___2511)) (to_rep1 change__first))))
...
(assert (= (ite (<= (to_rep1 (first6 temp___2531)) (to_rep1 (last6 temp___2531))) (+ (- (to_rep1 (last6 temp___2531)) (to_rep1 (first6 temp___2531))) 1) 0) (ite (<= (to_rep1 change__first) r5b) (+ (- r5b (to_rep1 change__first)) 1) 0)))
(assert (= (slide temp___253 (to_rep1 (first6 temp___2531)) (to_rep1 change__first)) temp___254))
...
(assert (= (ite (<= (to_rep1 (first4 temp___2541)) (to_rep1 (last4 temp___2541))) (+ (- (to_rep1 (last4 temp___2541)) (to_rep1 (first4 temp___2541))) 1) 0) (ite (<= (to_rep1 (first4 temp___2561)) (to_rep1 (last4 temp___2561))) (+ (- (to_rep1 (last4 temp___2561)) (to_rep1 (first4 temp___2561))) 1) 0)))
(assert (= (mk___t2 temp___257 temp___2571) (mk___t2 temp___254 temp___2541)))
(assert (forall ((temp___258 Int)) (ite (and (<= (to_rep1 change__first) temp___258) (<= temp___258 r5b)) (= (select o8 temp___258) (select temp___257 temp___258)) (= (select o8 temp___258) (select change1 temp___258)))))
...
(assert (and (= o17 (- 2147483647 (to_rep1 (first (rt new_val))))) (in_range1 (- 2147483647 (to_rep1 (first (rt new_val)))))))
