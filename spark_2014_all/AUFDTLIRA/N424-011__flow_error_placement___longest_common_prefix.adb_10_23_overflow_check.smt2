...
(assert (= result3 l1))
(assert (= l2 o8))
(assert (and (= o13 (+ x l2)) (in_range1 (+ x l2))))
(assert (= result5 (ite (<= o13 1000) true false)))
(assert (=> (= result5 true) (and (= o12 (+ y l2)) (in_range1 (+ y l2)))))
(assert (=> (= result5 true) (= result4 (ite (<= o12 1000) true false))))
(assert (=> (not (= result5 true)) (= result4 false)))
(assert (= result4 true))
(assert (and (= temp___1781 (+ y l2)) (in_range1 (+ y l2))))
(assert (and (<= 1 temp___1781) (<= temp___1781 1000)))
