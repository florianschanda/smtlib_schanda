...
(define-fun dynamic_invariant ((temp___expr_147 Int) (temp___is_init_144 Bool) (temp___skip_constant_145 Bool) (temp___do_toplevel_146 Bool)) Bool (=> (or (= temp___is_init_144 true) (<= 0 3)) (in_range1 temp___expr_147)))
...
(define-fun dynamic_invariant1 ((temp___expr_153 Int) (temp___is_init_150 Bool) (temp___skip_constant_151 Bool) (temp___do_toplevel_152 Bool)) Bool (=> (or (= temp___is_init_150 true) (<= 0 4)) (in_range2 temp___expr_153)))
...
(assert (forall ((temp___134 us_rep) (temp___135 us_rep) (temp___136 us_rep) (temp___137 us_rep) (temp___138 us_rep) (temp___139 us_rep) (temp___140 us_rep) (temp___141 us_rep) (temp___142 us_rep)) (let ((temp___133 (sm_using_case_expression__invalid_transition_array__aggregate_def temp___134 temp___135 temp___136 temp___137 temp___138 temp___139 temp___140 temp___141 temp___142))) (forall ((temp___143 Int)) (ite (= temp___143 8) (= (select temp___133 temp___143) temp___141) (ite (= temp___143 7) (= (select temp___133 temp___143) temp___140) (ite (= temp___143 6) (= (select temp___133 temp___143) temp___139) (ite (= temp___143 5) (= (select temp___133 temp___143) temp___138) (ite (= temp___143 4) (= (select temp___133 temp___143) temp___137) (ite (= temp___143 3) (= (select temp___133 temp___143) temp___136) (ite (= temp___143 2) (= (select temp___133 temp___143) temp___135) (ite (= temp___143 1) (= (select temp___133 temp___143) temp___134) (= (select temp___133 temp___143) temp___142)))))))))))))
(declare-fun my_sm (Int Int) Int)
(declare-fun my_sm__function_guard (Int Int Int) Bool)
(assert (forall ((state Int) (trigger Int)) (! (=> (and (dynamic_invariant state true true true) (dynamic_invariant1 trigger true true true)) (dynamic_invariant (my_sm state trigger) true false true)) :pattern ((my_sm state trigger)))))
(assert (forall ((state Int) (trigger Int)) (! (=> (and (dynamic_invariant state true true true) (dynamic_invariant1 trigger true true true)) (= (my_sm state trigger) (ite (= state 0) (ite (= trigger 2) 0 (ite (= trigger 3) 2 (ite (= trigger 0) 1 (ite (= trigger 1) 0 3)))) (ite (= state 1) (ite (= trigger 2) 0 (ite (= trigger 3) 2 (ite (= trigger 0) 2 (ite (= trigger 1) 1 3)))) (ite (= state 2) (ite (= trigger 2) 0 (ite (= trigger 3) 2 (ite (= trigger 0) 2 (ite (= trigger 1) 2 3)))) (ite (= trigger 2) 0 (ite (= trigger 3) 2 3))))))) :pattern ((my_sm state trigger)))))
...
(assert (= temp___182 (sm_using_case_expression__invalid_transition_array__aggregate_def o50 o49 o48 (mk___rep (mk___split_fields o46 o47)) (mk___rep (mk___split_fields o44 o45)) (mk___rep (mk___split_fields o42 o43)) (mk___rep (mk___split_fields o40 o41)) (mk___rep (mk___split_fields o38 o39)) (mk___rep (mk___split_fields o36 o37)))))
...
(assert (forall ((state21 Int)) (=> (and (<= 0 state21) (<= state21 3)) (forall ((trigger1 Int)) (=> (and (<= 0 trigger1) (<= trigger1 4)) (or (not (= (my_sm state21 trigger1) 3)) (exists ((idx Int)) (and (and (<= 1 idx) (<= idx 20)) (and (= (to_rep (rec__sm_using_case_expression__invalid_transition_record_t__initial_state (us_split_fields1 (select invalid_transition_array idx)))) state21) (= (to_rep1 (rec__sm_using_case_expression__invalid_transition_record_t__trigger (us_split_fields1 (select invalid_transition_array idx)))) trigger1))))))))))
(assert (=> (= trigger 0) (=> (= state 0) (and (= (get_state state2) 1) (in_range1 state2)))))
(assert (=> (= trigger 0) (=> (not (= state 0)) (=> (=> (not (= state 1)) (= state 2)) (and (= (get_state state3) 2) (in_range1 state3))))))
(assert (=> (= trigger 0) (=> (not (= state 0)) (=> (not (=> (not (= state 1)) (= state 2))) (and (= (get_state state4) 3) (in_range1 state4))))))
(assert (=> (= trigger 0) (=> (not (= state 0)) (=> (not (=> (not (= state 1)) (= state 2))) (= state3 state4)))))
(assert (=> (= trigger 0) (=> (not (= state 0)) (= state2 state3))))
(assert (=> (not (= trigger 0)) (=> (= trigger 2) (and (= (get_state state5) 0) (in_range1 state5)))))
(assert (=> (not (= trigger 0)) (=> (not (= trigger 2)) (=> (= trigger 3) (and (= (get_state state6) 2) (in_range1 state6))))))
(assert (=> (not (= trigger 0)) (=> (not (= trigger 2)) (=> (not (= trigger 3)) (=> (= trigger 4) (and (= (get_state state7) 3) (in_range1 state7)))))))
(assert (=> (not (= trigger 0)) (=> (not (= trigger 2)) (=> (not (= trigger 3)) (=> (not (= trigger 4)) (= state7 state))))))
(assert (=> (not (= trigger 0)) (=> (not (= trigger 2)) (=> (not (= trigger 3)) (=> (not (= trigger 4)) (= state7 state1))))))
(assert (=> (not (= trigger 0)) (=> (not (= trigger 2)) (=> (not (= trigger 3)) (= state6 state7)))))
(assert (=> (not (= trigger 0)) (=> (not (= trigger 2)) (= state5 state6))))
(assert (=> (not (= trigger 0)) (= state2 state5)))
(assert (= state8 (mk_int__ref state2)))
(assert (= state9 state2))
(assert (not (= (get_state (int__content state8)) (my_sm (get_state state) trigger))))
(check-sat)
(exit)
