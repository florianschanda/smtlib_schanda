...
(assert (and (and (= state old_state) (and (in_range1 old_state) (and (forall ((final_state Int)) (=> (and (<= 0 final_state) (<= final_state 3)) (exists ((initial_state Int)) (and (and (<= 0 initial_state) (<= initial_state 3)) (exists ((trigger2 Int)) (and (and (<= 0 trigger2) (<= trigger2 4)) (= final_state (my_sm initial_state trigger2)))))))) (and (forall ((state21 Int)) (=> (and (<= 0 state21) (<= state21 3)) (forall ((trigger1 Int)) (=> (and (<= 0 trigger1) (<= trigger1 4)) (or (not (= (my_sm state21 trigger1) 3)) (exists ((idx Int)) (and (and (<= 1 idx) (<= idx 20)) (and (= (to_rep (rec__sm_using_case_expression__invalid_transition_record_t__initial_state (us_split_fields1 (select invalid_transition_array idx)))) state21) (= (to_rep1 (rec__sm_using_case_expression__invalid_transition_record_t__trigger (us_split_fields1 (select invalid_transition_array idx)))) trigger1))))))))) (ite (= trigger 0) (ite (= state 0) (and (= (get_state state2) 1) (in_range1 state2)) (and (ite (=> (not (= state 1)) (= state 2)) (and (= (get_state state3) 2) (in_range1 state3)) (and (and (= (get_state state4) 3) (in_range1 state4)) (= state3 state4))) (= state2 state3))) (and (ite (= trigger 2) (and (= (get_state state5) 0) (in_range1 state5)) (and (ite (= trigger 3) (and (= (get_state state6) 2) (in_range1 state6)) (and (ite (= trigger 4) (and (= (get_state state7) 3) (in_range1 state7)) (and (= state7 state) (= state7 state1))) (= state6 state7))) (= state5 state6))) (= state2 state5))))))) (and (= state8 (mk_int__ref state2)) (= state9 state2))))
