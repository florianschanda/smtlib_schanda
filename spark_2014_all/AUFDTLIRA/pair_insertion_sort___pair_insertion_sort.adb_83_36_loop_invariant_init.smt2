...
(assert (not (or (and (= (to_rep (select o63 j15)) (int__content x6)) (= (to_rep (select o63 (+ j15 1))) (int__content y6))) (and (= (to_rep (select o63 j15)) (int__content y6)) (= (to_rep (select o63 (+ j15 1))) (int__content x6))))))
(check-sat)
(exit)
