...
(assert (=> (<= 1 4) (= o6 (+ (- 4 1) 1))))
(assert (=> (not (<= 1 4)) (= o6 0)))
(assert (=> (<= (to_rep1 (first temp___7821)) (to_rep1 (last temp___7821))) (= o7 (+ (- (to_rep1 (last temp___7821)) (to_rep1 (first temp___7821))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___7821)) (to_rep1 (last temp___7821)))) (= o7 0)))
(assert (= o8 (+ o7 o6)))
