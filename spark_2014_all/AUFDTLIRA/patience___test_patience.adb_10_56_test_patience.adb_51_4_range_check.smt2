...
(assert (not (= (length (mk___t temp___776 temp___7761)) 0)))
(assert (=> (<= 1 4) (= o6 (+ (- 4 1) 1))))
(assert (=> (not (<= 1 4)) (= o6 0)))
(assert (=> (<= (to_rep1 (first temp___7761)) (to_rep1 (last temp___7761))) (= o7 (+ (- (to_rep1 (last temp___7761)) (to_rep1 (first temp___7761))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___7761)) (to_rep1 (last temp___7761)))) (= o7 0)))
(assert (= o8 (+ o7 o6)))
(assert (= o9 (+ (to_rep1 (first temp___7761)) o8)))
(assert (= o10 (- o9 1)))
