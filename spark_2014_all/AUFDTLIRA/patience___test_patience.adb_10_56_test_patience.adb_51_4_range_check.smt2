...
(assert (not (= (length (mk___t temp___847 temp___8471)) 0)))
(assert (=> (<= 1 4) (= o6 (+ (- 4 1) 1))))
(assert (=> (not (<= 1 4)) (= o6 0)))
(assert (=> (<= (to_rep1 (first temp___8471)) (to_rep1 (last temp___8471))) (= o7 (+ (- (to_rep1 (last temp___8471)) (to_rep1 (first temp___8471))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___8471)) (to_rep1 (last temp___8471)))) (= o7 0)))
(assert (= o8 (+ o7 o6)))
(assert (= o9 (+ (to_rep1 (first temp___8471)) o8)))
(assert (= o10 (- o9 1)))
