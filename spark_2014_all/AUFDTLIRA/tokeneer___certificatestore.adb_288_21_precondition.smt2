...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1032 us_void_param) 1)) 46) (= (to_rep (select (temp___String_Literal_1032 us_void_param) 2)) 47)) (= (to_rep (select (temp___String_Literal_1032 us_void_param) 3)) 83)) (= (to_rep (select (temp___String_Literal_1032 us_void_param) 4)) 121)) (= (to_rep (select (temp___String_Literal_1032 us_void_param) 5)) 115)) (= (to_rep (select (temp___String_Literal_1032 us_void_param) 6)) 116)) (= (to_rep (select (temp___String_Literal_1032 us_void_param) 7)) 101)) (= (to_rep (select (temp___String_Literal_1032 us_void_param) 8)) 109)) (= (to_rep (select (temp___String_Literal_1032 us_void_param) 9)) 47)) (= (to_rep (select (temp___String_Literal_1032 us_void_param) 10)) 99)) (= (to_rep (select (temp___String_Literal_1032 us_void_param) 11)) 101)) (= (to_rep (select (temp___String_Literal_1032 us_void_param) 12)) 114)) (= (to_rep (select (temp___String_Literal_1032 us_void_param) 13)) 116)) (= (to_rep (select (temp___String_Literal_1032 us_void_param) 14)) 46)) (= (to_rep (select (temp___String_Literal_1032 us_void_param) 15)) 100)) (= (to_rep (select (temp___String_Literal_1032 us_void_param) 16)) 97)) (= (to_rep (select (temp___String_Literal_1032 us_void_param) 17)) 116)) :pattern ((temp___String_Literal_1032 us_void_param)))))
(declare-fun temp___String_Literal_1033 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1033 us_void_param) 1)) 67) (= (to_rep (select (temp___String_Literal_1033 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_1033 us_void_param) 3)) 114)) (= (to_rep (select (temp___String_Literal_1033 us_void_param) 4)) 116)) (= (to_rep (select (temp___String_Literal_1033 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_1033 us_void_param) 6)) 102)) (= (to_rep (select (temp___String_Literal_1033 us_void_param) 7)) 105)) (= (to_rep (select (temp___String_Literal_1033 us_void_param) 8)) 99)) (= (to_rep (select (temp___String_Literal_1033 us_void_param) 9)) 97)) (= (to_rep (select (temp___String_Literal_1033 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_1033 us_void_param) 11)) 101)) (= (to_rep (select (temp___String_Literal_1033 us_void_param) 12)) 32)) (= (to_rep (select (temp___String_Literal_1033 us_void_param) 13)) 83)) (= (to_rep (select (temp___String_Literal_1033 us_void_param) 14)) 116)) (= (to_rep (select (temp___String_Literal_1033 us_void_param) 15)) 111)) (= (to_rep (select (temp___String_Literal_1033 us_void_param) 16)) 114)) (= (to_rep (select (temp___String_Literal_1033 us_void_param) 17)) 101)) (= (to_rep (select (temp___String_Literal_1033 us_void_param) 18)) 32)) (= (to_rep (select (temp___String_Literal_1033 us_void_param) 19)) 114)) (= (to_rep (select (temp___String_Literal_1033 us_void_param) 20)) 101)) (= (to_rep (select (temp___String_Literal_1033 us_void_param) 21)) 97)) (= (to_rep (select (temp___String_Literal_1033 us_void_param) 22)) 100)) (= (to_rep (select (temp___String_Literal_1033 us_void_param) 23)) 32)) (= (to_rep (select (temp___String_Literal_1033 us_void_param) 24)) 101)) (= (to_rep (select (temp___String_Literal_1033 us_void_param) 25)) 114)) (= (to_rep (select (temp___String_Literal_1033 us_void_param) 26)) 114)) (= (to_rep (select (temp___String_Literal_1033 us_void_param) 27)) 111)) (= (to_rep (select (temp___String_Literal_1033 us_void_param) 28)) 114)) :pattern ((temp___String_Literal_1033 us_void_param)))))
