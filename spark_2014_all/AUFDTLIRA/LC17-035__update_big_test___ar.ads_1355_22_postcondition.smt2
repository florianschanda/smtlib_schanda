...
(declare-fun temp___2993 ((Array Int us_rep2) Int us_rep2) (Array Int us_rep2))
...
(assert (forall ((temp___2995 (Array Int us_rep2))) (forall ((temp___2996 Int)) (forall ((temp___2997 us_rep2)) (let ((temp___2994 (temp___2993 temp___2995 temp___2996 temp___2997))) (=> (dynamic_invariant temp___2996 true true true true) (forall ((temp___2998 Int)) (ite (= temp___2998 temp___2996) (= (select temp___2994 temp___2998) temp___2997) (= (select temp___2994 temp___2998) (select temp___2995 temp___2998))))))))))
