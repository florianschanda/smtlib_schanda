...
(declare-const temp___1286 (Array Int us_rep1))
...
(assert (type_invariant1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3))))
(assert (and (= o2 (size1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)))) (and (in_range4 o2) (= o2 (size (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)))))))
(assert (= result (ite (< 0 o2) true false)))
(assert (= result true))
(assert (type_invariant1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3))))
(assert (and (= temp___1286 (model__1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)))) (and (dynamic_invariant6 temp___1286 true false true true) (= temp___1286 (model__ (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) (to_rep1 t__split_fields))))))
(assert (= o (select temp___1286 i)))
