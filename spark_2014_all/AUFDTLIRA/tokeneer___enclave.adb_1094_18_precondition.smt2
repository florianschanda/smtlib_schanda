...
(assert (=> (= result1 true) (and (= o11 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range6 o11))))
(assert (=> (= result1 true) (= o12 (ite (= o11 3) true false))))
(assert (=> (= result1 true) (= o13 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))
(assert (=> (= result1 true) (= o14 (ite (= o13 true) o12 false))))
(assert (=> (not (= result1 true)) (= o14 (of_int 1))))
(assert (and (= o1 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields4 theadmin__split_fields5)))) (in_range4 o1)))
(assert (= result2 (ite (= o1 1) true false)))
(assert (=> (= result2 true) (= o5 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields4 theadmin__split_fields5))))))
(assert (=> (= result2 true) (= o6 (ite (not (= o5 true)) true false))))
(assert (=> (= result2 true) (and (= o2 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields4 theadmin__split_fields5)))) (in_range6 o2))))
(assert (=> (= result2 true) (= o3 (ite (= o2 3) true false))))
(assert (=> (= result2 true) (= o4 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields4 theadmin__split_fields5))))))
...
(assert (not (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields4 theadmin__split_fields5))) true)))
(check-sat)
(exit)
