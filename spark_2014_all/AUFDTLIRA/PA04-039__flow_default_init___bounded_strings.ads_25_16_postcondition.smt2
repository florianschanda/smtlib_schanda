...
(declare-const temp___217 index_type)
(declare-const temp___2171 (Array Int character))
(declare-const temp___2172 t)
(declare-const temp___2173 length_type)
...
(assert (= target__split_discrs (mk___split_discrs temp___215)))
(assert (and (= o8 (+ (to_rep2 target__split_fields5) 1)) (in_range2 (+ (to_rep2 target__split_fields5) 1))))
(assert (= (to_rep2 o9) o8))
(assert (= target__split_fields3 o10))
(assert (= target__split_fields4 o11))
(assert (= o9 o12))
(assert (= target__split_discrs (mk___split_discrs temp___217)))
(assert (= temp___2171 o10))
(assert (= temp___2172 o11))
(assert (= temp___2173 o12))
(assert (= result3 (mk___split_fields__ref (mk___split_fields (mk___t target__split_fields3 target__split_fields4) target__split_fields5))))
(assert (= target__split_fields6 (mk___split_fields (mk___t temp___2171 temp___2172) temp___2173)))
(assert (= target__split_discrs (mk___split_discrs temp___217)))
...
(assert (not (= (length1 (mk___rep target__split_discrs (us_split_fields__content target__split_fields7))) (+ (length1 (mk___rep target__split_discrs (mk___split_fields (mk___t target__split_fields target__split_fields1) target__split_fields2))) 1))))
(check-sat)
(exit)
