...
(define-fun dynamic_property4 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range1 low) (and (in_range1 high) (=> (<= low high) (and (dynamic_property range_first range_last low) (dynamic_property range_first range_last high))))))
...
(assert (forall ((temp___143 Int) (temp___144 Int) (temp___145 Int)) (let ((temp___142 (p__x__aggregate_def temp___143 temp___144 temp___145))) (and (=> (dynamic_property4 a b temp___144 temp___145) (and (= (first3 temp___142) temp___144) (= (last3 temp___142) temp___145))) (forall ((temp___146 Int)) (= (select (to_array1 temp___142) temp___146) (of_rep temp___143)))))))
...
(declare-const p__x__assume (Array Int integer))
(declare-const p__x__assume1 t)
(declare-const j Int)
...
(assert (= (ite (<= (to_rep (first2 temp___1481)) (to_rep (last2 temp___1481))) (+ (- (to_rep (last2 temp___1481)) (to_rep (first2 temp___1481))) 1) 0) (ite (<= a b) (+ (- b a) 1) 0)))
(assert (= (slide temp___148 (to_rep (first2 temp___1481)) a) p__x__assume))
(assert (= (mk a b) p__x__assume1))
(assert (= result x))
(assert (= x1 p__x__assume))
(assert (= (to_rep x__first) (to_rep (first p__x__assume1))))
(assert (= (to_rep x__last) (to_rep (last p__x__assume1))))
(assert (and (dynamic_property1 a b (to_rep x__first) (to_rep x__last)) (and (= (to_rep x__first) a) (= (to_rep x__last) b))))
(assert (<= a j))
(assert (<= j b))
(assert (not (<= (to_rep x__first) j)))
(check-sat)
(exit)
