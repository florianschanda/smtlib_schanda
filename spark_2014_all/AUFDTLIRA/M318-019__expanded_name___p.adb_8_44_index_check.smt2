...
(assert (forall ((temp___166 Int) (temp___167 Int) (temp___168 Int)) (let ((temp___165 (p__x__aggregate_def temp___166 temp___167 temp___168))) (=> (dynamic_invariant temp___166 true true true true) (and (=> (dynamic_property4 a b temp___167 temp___168) (and (= (first3 temp___165) temp___167) (= (last3 temp___165) temp___168))) (forall ((temp___169 Int)) (= (to_rep (select (to_array1 temp___165) temp___169)) temp___166)))))))
...
(assert (= (mk___t1 temp___171 temp___1711) (p__x__aggregate_def a a b)))
(assert (= (ite (<= (to_rep (first2 temp___1711)) (to_rep (last2 temp___1711))) (+ (- (to_rep (last2 temp___1711)) (to_rep (first2 temp___1711))) 1) 0) (ite (<= a b) (+ (- b a) 1) 0)))
(assert (= (slide temp___171 (to_rep (first2 temp___1711)) a) p__x__assume))
