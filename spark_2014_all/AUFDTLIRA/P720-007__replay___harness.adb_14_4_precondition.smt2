...
(declare-const r__split_fields18 length_type)
...
(assert (= (to_rep1 r__split_fields8) (+ (to_rep1 r__split_fields5) 1)))
(assert (and (and (= (to_rep1 r__split_fields11) (- (to_rep1 r__split_fields8) 1)) (= (head (mk___rep (mk___split_fields r__split_fields6 r__split_fields7 r__split_fields8))) h1)) (in_range h1)))
(assert (= h1 x))
(assert (not (not (= (is_full (mk___rep (mk___split_fields r__split_fields9 r__split_fields10 r__split_fields11))) true))))
(check-sat)
(exit)
