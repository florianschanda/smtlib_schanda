...
(assert (= result true))
(assert (and (= o2 (currency account accounts_balance)) (and (in_range o2) (= o2 (to_rep (rec__money__amount__currency (us_split_fields1 (rec__database__account_balance__value (us_split_fields5 (select accounts_balance account))))))))))
(assert (= result1 (ite (= o2 (to_rep (rec__money__amount__currency (us_split_fields1 sum)))) true false)))
(assert (= result1 true))
