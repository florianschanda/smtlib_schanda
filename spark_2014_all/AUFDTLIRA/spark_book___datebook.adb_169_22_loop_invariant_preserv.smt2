...
(assert (and (= temp___444 (+ (to_rep1 description__first) (- j2 1))) (in_range1 (+ (to_rep1 description__first) (- j2 1)))))
(assert (and (<= (to_rep1 description__first) temp___444) (<= temp___444 (to_rep1 description__last))))
(assert (= o4 temp___444))
