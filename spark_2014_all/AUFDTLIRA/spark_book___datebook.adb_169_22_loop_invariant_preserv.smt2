...
(assert (and (= temp___401 (+ (to_rep1 description__first) (- j2 1))) (in_range1 (+ (to_rep1 description__first) (- j2 1)))))
(assert (and (<= (to_rep1 description__first) temp___401) (<= temp___401 (to_rep1 description__last))))
(assert (= o9 temp___401))
(assert (= o10 (store description3 o9 o8)))
(assert (= result6 description3))
(assert (= description4 o10))
(assert (not (= j2 r13b)))
(assert (= result7 j2))
(assert (= j3 (+ j2 1)))
