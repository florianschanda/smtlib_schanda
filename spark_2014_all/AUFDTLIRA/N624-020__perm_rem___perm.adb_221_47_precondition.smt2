...
(assert (= ib1 o4))
(assert (and (= o6 (- (to_rep2 (rec__perm__witnesses__ia (us_split_fields1 w))) 1)) (in_range3 (- (to_rep2 (rec__perm__witnesses__ia (us_split_fields1 w))) 1))))
(assert (and (= o5 ia1) (in_range3 ia1)))
(assert (not (<= (to_rep1 (first (rt a))) o5)))
(check-sat)
(exit)
