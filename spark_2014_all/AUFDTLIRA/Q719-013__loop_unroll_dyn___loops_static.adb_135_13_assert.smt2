...
(assert (=> (not (= i1 (to_rep1 a__first))) (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (= temp___349 bad1))))
...
(assert (=> (not (= i1 (to_rep1 a__first))) (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (=> (= result5 true) (= bad4 (of_int 1))))))
