...
(declare-const temp___3491 Bool)
...
(assert (=> (= i1 (to_rep1 a__first)) (= (mk_int__ref j10) (mk_int__ref j))))
(assert (=> (= i1 (to_rep1 a__first)) (= bad2 bad9)))
(assert (=> (= i1 (to_rep1 a__first)) (= j11 j3)))
(assert (=> (= i1 (to_rep1 a__first)) (= bad10 bad2)))
(assert (=> (not (= i1 (to_rep1 a__first))) (= (mk_int__ref result4) (mk_int__ref j))))
(assert (=> (not (= i1 (to_rep1 a__first))) (= j4 (to_rep1 a__first))))
(assert (=> (not (= i1 (to_rep1 a__first))) (=> (and (<= (to_rep1 a__first) j4) (<= j4 i1)) (= temp___349 bad1))))
(assert (=> (not (= i1 (to_rep1 a__first))) (=> (and (<= (to_rep1 a__first) j4) (<= j4 i1)) (and (<= (to_rep1 a__first) j5) (<= j5 i1)))))
(assert (=> (not (= i1 (to_rep1 a__first))) (=> (and (<= (to_rep1 a__first) j4) (<= j4 i1)) (and (<= (to_rep1 a__first) j5) (<= j5 (to_rep1 a__last))))))
(assert (=> (not (= i1 (to_rep1 a__first))) (=> (and (<= (to_rep1 a__first) j4) (<= j4 i1)) (= o3 j5))))
(assert (=> (not (= i1 (to_rep1 a__first))) (=> (and (<= (to_rep1 a__first) j4) (<= j4 i1)) (= o4 (select a1 o3)))))
(assert (=> (not (= i1 (to_rep1 a__first))) (=> (and (<= (to_rep1 a__first) j4) (<= j4 i1)) (= o5 (to_rep o4)))))
(assert (=> (not (= i1 (to_rep1 a__first))) (=> (and (<= (to_rep1 a__first) j4) (<= j4 i1)) (= o6 (ite (= o5 0) true false)))))
(assert (=> (not (= i1 (to_rep1 a__first))) (=> (and (<= (to_rep1 a__first) j4) (<= j4 i1)) (= result5 (ite (not (= o6 true)) true false)))))
(assert (=> (not (= i1 (to_rep1 a__first))) (=> (and (<= (to_rep1 a__first) j4) (<= j4 i1)) (=> (= result5 true) (= bad3 result6)))))
(assert (=> (not (= i1 (to_rep1 a__first))) (=> (and (<= (to_rep1 a__first) j4) (<= j4 i1)) (=> (= result5 true) (= bad4 (of_int 1))))))
(assert (=> (not (= i1 (to_rep1 a__first))) (=> (and (<= (to_rep1 a__first) j4) (<= j4 i1)) (=> (not (= result5 true)) (= bad4 bad3)))))
(assert (=> (not (= i1 (to_rep1 a__first))) (=> (and (<= (to_rep1 a__first) j4) (<= j4 i1)) (= j5 i1))))
(assert (=> (not (= i1 (to_rep1 a__first))) (=> (and (<= (to_rep1 a__first) j4) (<= j4 i1)) (= j5 j6))))
(assert (=> (not (= i1 (to_rep1 a__first))) (=> (and (<= (to_rep1 a__first) j4) (<= j4 i1)) (= bad4 bad5))))
(assert (=> (not (= i1 (to_rep1 a__first))) (=> (and (<= (to_rep1 a__first) j4) (<= j4 i1)) (= j7 j5))))
(assert (=> (not (= i1 (to_rep1 a__first))) (=> (and (<= (to_rep1 a__first) j4) (<= j4 i1)) (= bad6 bad4))))
(assert (=> (not (= i1 (to_rep1 a__first))) (=> (and (<= (to_rep1 a__first) j4) (<= j4 i1)) (= (mk_int__ref j8) (mk_int__ref j6)))))
(assert (=> (not (= i1 (to_rep1 a__first))) (=> (and (<= (to_rep1 a__first) j4) (<= j4 i1)) (= (mk_bool__ref bad7) (mk_bool__ref bad5)))))
(assert (=> (not (= i1 (to_rep1 a__first))) (=> (and (<= (to_rep1 a__first) j4) (<= j4 i1)) (= j9 j7))))
(assert (=> (not (= i1 (to_rep1 a__first))) (=> (and (<= (to_rep1 a__first) j4) (<= j4 i1)) (= bad8 bad6))))
(assert (=> (not (= i1 (to_rep1 a__first))) (=> (not (and (<= (to_rep1 a__first) j4) (<= j4 i1))) (= j4 j8))))
(assert (=> (not (= i1 (to_rep1 a__first))) (=> (not (and (<= (to_rep1 a__first) j4) (<= j4 i1))) (= bad1 bad7))))
(assert (=> (not (= i1 (to_rep1 a__first))) (=> (not (and (<= (to_rep1 a__first) j4) (<= j4 i1))) (= j9 j4))))
(assert (=> (not (= i1 (to_rep1 a__first))) (=> (not (and (<= (to_rep1 a__first) j4) (<= j4 i1))) (= bad8 bad1))))
(assert (=> (not (= i1 (to_rep1 a__first))) (= (mk_int__ref j10) (mk_int__ref j8))))
(assert (=> (not (= i1 (to_rep1 a__first))) (= (mk_bool__ref bad9) (mk_bool__ref bad7))))
(assert (=> (not (= i1 (to_rep1 a__first))) (= j11 j9)))
(assert (=> (not (= i1 (to_rep1 a__first))) (= bad10 bad8)))
(declare-const j20 Int)
(assert (<= (to_rep1 a__first) j20))
(assert (<= j20 i1))
(assert (not (= (to_rep (select a1 j20)) 0)))
(check-sat)
(exit)
