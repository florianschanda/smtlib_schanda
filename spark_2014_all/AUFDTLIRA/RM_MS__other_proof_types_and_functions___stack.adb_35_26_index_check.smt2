...
(assert (forall ((stack__my_stack__fields us_split_fields)) (! (dynamic_invariant1 (count stack__my_stack__fields) true false true) :pattern ((count stack__my_stack__fields)))))
...
(assert (forall ((n Int)) (forall ((stack__my_stack__fields us_split_fields)) (! (=> (and (dynamic_invariant1 n true true true) (and (<= 1 n) (<= n (count stack__my_stack__fields)))) (dynamic_invariant (stack_entry n stack__my_stack__fields) true false true)) :pattern ((stack_entry n stack__my_stack__fields))))))
(assert (forall ((n Int)) (forall ((stack__my_stack__fields us_split_fields)) (! (=> (dynamic_invariant1 n true true true) (= (stack_entry n stack__my_stack__fields) (to_rep (let ((temp___142 (rec__stack__stack_type__s (us_split_fields1 (mk___rep stack__my_stack__fields))))) (select temp___142 n))))) :pattern ((stack_entry n stack__my_stack__fields))))))
...
(declare-const temp___1941 pointer_range)
...
(declare-const temp___1981 pointer_range)
