...
(assert (<= j5 100))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= o89 (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j5)) (and (in_range2 o89) (and (= o89 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) j5))))) (and (=> (= (valid_root (mk___rep2 (us_split_fields__content2 f__split_fields7)) j5) true) (= o89 0)) (=> (= (size (mk___rep2 (us_split_fields__content2 f__split_fields7))) 0) (= o89 0)))))))
(assert (= o90 (ite (= o89 0) true false)))
(assert (= o91 (ite (not (= o90 true)) true false)))
(assert (= result16 (ite (not (= j5 v)) o91 false)))
(assert (= result16 true))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o92 (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j5)) (and (in_range4 o92) (= o92 (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 j5))))))))
