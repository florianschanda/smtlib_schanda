...
(declare-const bounded_dynamic_strings__Oconcat__2__result natural_index)
(declare-const bounded_dynamic_strings__Oconcat__2__result1 natural_index)
(declare-const bounded_dynamic_strings__Oconcat__2__result2 (Array Int character))
(declare-const bounded_dynamic_strings__Oconcat__2__result3 t2)
(declare-const o Int)
...
(declare-const temp___972 (Array Int character))
...
(declare-const temp___975 (Array Int character))
(declare-const temp___9751 t1)
...
(declare-const bounded_dynamic_strings__Oconcat__2__result4 natural_index)
(declare-const bounded_dynamic_strings__Oconcat__2__result5 natural_index)
(declare-const bounded_dynamic_strings__Oconcat__2__result6 (Array Int character))
(declare-const bounded_dynamic_strings__Oconcat__2__result7 t2)
(declare-const bounded_dynamic_strings__Oconcat__2__result8 sequence__ref)
(declare-const bounded_dynamic_strings__Oconcat__2__result9 us_rep)
(declare-const bounded_dynamic_strings__Oconcat__2__result10 sequence__ref)
(declare-const bounded_dynamic_strings__Oconcat__2__result11 us_rep)
...
(assert (not (in_range1 (length1 right))))
(check-sat)
(exit)
