...
(assert (not (= (ite (<= (to_rep1 (first8 temp___10881)) (to_rep1 (last8 temp___10881))) (+ (- (to_rep1 (last8 temp___10881)) (to_rep1 (first8 temp___10881))) 1) 0) (ite (<= (to_rep1 (first8 temp___10911)) (to_rep1 (last8 temp___10911))) (+ (- (to_rep1 (last8 temp___10911)) (to_rep1 (first8 temp___10911))) 1) 0))))
(check-sat)
(exit)
