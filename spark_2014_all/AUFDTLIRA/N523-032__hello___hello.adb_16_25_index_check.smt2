...
(assert (and (= temp___6581 (- j 1)) (in_range1 (- j 1))))
(assert (and (<= (to_rep1 (first (rt str))) temp___6581) (<= temp___6581 (to_rep1 (last (rt str))))))
(assert (= o3 temp___6581))
(assert (= o4 (select (elts str) o3)))
(assert (= o5 (to_rep o4)))
(assert (= o6 (ite (<= o5 122) true false)))
(assert (and (= temp___658 (- j 1)) (in_range1 (- j 1))))
(assert (and (<= (to_rep1 (first (rt str))) temp___658) (<= temp___658 (to_rep1 (last (rt str))))))
(assert (= o temp___658))
...
(assert (= result true))
(assert (and (= temp___659 (- j 1)) (in_range1 (- j 1))))
(assert (not (<= (to_rep1 (first (rt str))) temp___659)))
(check-sat)
(exit)
