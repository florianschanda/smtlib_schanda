...
(assert (and (= temp___5891 (- j 1)) (in_range1 (- j 1))))
(assert (and (<= (to_rep1 (first (rt str))) temp___5891) (<= temp___5891 (to_rep1 (last (rt str))))))
(assert (= o3 temp___5891))
(assert (= o4 (select (elts str) o3)))
(assert (= o5 (to_rep o4)))
(assert (= o6 (ite (<= o5 122) true false)))
(assert (and (= temp___589 (- j 1)) (in_range1 (- j 1))))
(assert (and (<= (to_rep1 (first (rt str))) temp___589) (<= temp___589 (to_rep1 (last (rt str))))))
(assert (= o temp___589))
(assert (= o1 (select (elts str) o)))
(assert (= o2 (to_rep o1)))
(assert (= o7 (ite (<= 97 o2) true false)))
(assert (= o8 (ite (= o7 true) o6 false)))
(assert (= result (ite (not (= o8 true)) true false)))
(assert (= result true))
(assert (and (= temp___590 (- j 1)) (in_range1 (- j 1))))
(assert (not (<= (to_rep1 (first (rt str))) temp___590)))
(check-sat)
(exit)
