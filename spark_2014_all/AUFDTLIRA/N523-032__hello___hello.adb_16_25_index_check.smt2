...
(assert (and (= temp___5831 (- j 1)) (in_range1 (- j 1))))
(assert (and (<= (to_rep1 (first (rt str))) temp___5831) (<= temp___5831 (to_rep1 (last (rt str))))))
(assert (= o16 temp___5831))
(assert (= o17 (select (elts str) o16)))
(assert (= o18 (to_rep o17)))
(assert (= o19 (ite (<= o18 122) true false)))
(assert (and (= temp___583 (- j 1)) (in_range1 (- j 1))))
(assert (and (<= (to_rep1 (first (rt str))) temp___583) (<= temp___583 (to_rep1 (last (rt str))))))
(assert (= o13 temp___583))
...
(assert (= result1 true))
(assert (and (= temp___5841 (- j 1)) (in_range1 (- j 1))))
(assert (not (<= (to_rep1 (first (rt str))) temp___5841)))
(check-sat)
(exit)
