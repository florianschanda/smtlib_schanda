...
(assert (and (= temp___671 (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o1)) (and (dynamic_invariant5 temp___671 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___671 o1))) true) (and (= (length1 (rec__tree_model__path_type__a (us_split_fields5 (select temp___671 o1)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 o1)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___671 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___671 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___671 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___671 i1))) true) (not (= i1 o1))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select temp___671 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))) (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) (rec__tree_model__path_type__a (us_split_fields5 (select temp___671 i1)))) true) (= (length1 (rec__tree_model__path_type__a (us_split_fields5 (select temp___671 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___671 i1))) true) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___671 j3))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select temp___671 i1))) (rec__tree_model__path_type__a (us_split_fields5 (select temp___671 j3)))) true)) (= j3 i1))))))))))))))
...
(assert (<= (length s3) j2))
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 j2)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i1))) true) (= (contains s3 (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i1))) true)))))
(assert (forall ((v Int)) (=> (and (<= 0 v) (<= v 2147483647)) (=> (= (contains s3 v) true) (exists ((i1 Int)) (and (and (<= 1 i1) (<= i1 100)) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i1))) true) (= (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i1)) v))))))))
(assert (and (=> (<= 1 100) (in_range6 j2)) (and (<= 1 j2) (<= j2 100))))
(assert (<= 1 i))
(assert (<= i j2))
(assert (not (in_range6 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))))))
(check-sat)
(exit)
