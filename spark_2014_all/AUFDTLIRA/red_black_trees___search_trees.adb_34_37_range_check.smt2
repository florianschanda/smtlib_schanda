...
(assert (and (= temp___669 (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o1)) (and (dynamic_invariant5 temp___669 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___669 o1))) true) (and (= (length1 (rec__tree_model__path_type__a (us_split_fields1 (select temp___669 o1)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 o1)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___669 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___669 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___669 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___669 i1))) true) (not (= i1 o1))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___669 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))) (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___669 i1)))) true) (= (length1 (rec__tree_model__path_type__a (us_split_fields1 (select temp___669 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___669 i1))) true) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___669 j3))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___669 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___669 j3)))) true)) (= j3 i1))))))))))))))
(assert (= (mk___rep (mk___split_fields o2 o3)) (select temp___669 j1)))
(assert (= o2 o4))
(assert (= o3 o5))
(assert (= result2 o5))
(assert (=> (= result2 true) (and (= o (contains s (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) j1)))) (=> (= (distinct 1 0) true) (=> (exists ((e Int)) (and (and (in_range4 e) (= (contains s e) true)) (= e (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) j1))))) (= o true))))))
...
(assert (<= (length s3) j2))
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 j2)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i1))) true) (= (contains s3 (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i1))) true)))))
...
(assert (<= 1 i))
(assert (<= i j2))
(assert (not (in_range2 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))))))
(check-sat)
(exit)
