...
(define-fun default_initial_assumption ((temp___expr_628 us_rep2) (temp___skip_top_level_629 Bool)) Bool (=> (not (= temp___skip_top_level_629 true)) (= (length temp___expr_628) 0)))
...
(define-fun k_is_find ((container us_rep2) (key Int) (position Int)) Bool (and (ite (< 0 position) (k_bigger_than_range container 1 (- position 1) key) (distinct 1 0)) (ite (< position (length container)) (k_smaller_than_range container (+ position 1) (length container) key) (distinct 1 0))))
...
(assert (forall ((container us_rep)) (! (let ((result (keys container))) (and (and (and (= (length result) (length1 container)) (forall ((temp___666 Int)) (=> (and (in_range6 temp___666) (= (iter_has_element result temp___666) true)) (= (has_key (model__ container) (get result temp___666)) true)))) (forall ((key Int)) (=> (and (in_range5 key) (= (has_key (model__ container) key) true)) (and (< 0 (find result key)) (= (equivalent_keys (get result (find result key)) key) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length1 container))) (and (= (find result (get result i)) i) (= (k_is_find result (get result i) i) true)))))) :pattern ((keys container)))))
...
(define-fun dynamic_invariant2 ((temp___expr_540 Int) (temp___is_init_536 Bool) (temp___skip_constant_537 Bool) (temp___do_toplevel_538 Bool) (temp___do_typ_inv_539 Bool)) Bool (=> (or (= temp___is_init_536 true) (<= 1 2147483647)) (in_range7 temp___expr_540)))
...
(define-fun dynamic_invariant3 ((temp___expr_547 Int) (temp___is_init_543 Bool) (temp___skip_constant_544 Bool) (temp___do_toplevel_545 Bool) (temp___do_typ_inv_546 Bool)) Bool (=> (or (= temp___is_init_543 true) (<= 0 5)) (in_range8 temp___expr_547)))
...
(define-fun dynamic_invariant4 ((temp___expr_799 Int) (temp___is_init_795 Bool) (temp___skip_constant_796 Bool) (temp___do_toplevel_797 Bool) (temp___do_typ_inv_798 Bool)) Bool (=> (or (= temp___is_init_795 true) (<= 0 10001)) (in_range10 temp___expr_799)))
(declare-fun length3 (us_rep6) Int)
(declare-fun length__function_guard3 (Int us_rep6) Bool)
(assert (forall ((container us_rep6)) (! (let ((result (length3 container))) (and (<= result (capacity container)) (dynamic_invariant4 result true false true true))) :pattern ((length3 container)))))
...
(define-fun dynamic_invariant6 ((temp___expr_768 Int) (temp___is_init_764 Bool) (temp___skip_constant_765 Bool) (temp___do_toplevel_766 Bool) (temp___do_typ_inv_767 Bool)) Bool (=> (or (= temp___is_init_764 true) (<= 0 10000)) (in_range9 temp___expr_768)))
...
(assert (forall ((container us_rep)) (! (let ((result (length1 container))) (and (<= result (to_rep3 (rec__partition_refinement__inverse_sets__map__capacity (us_split_discrs1 container)))) (dynamic_invariant7 result true false true true))) :pattern ((length1 container)))))
(assert (forall ((attr__tag Int)) (forall ((container us_rep)) (! (dynamic_invariant7 (length2 attr__tag container) true false true true) :pattern ((length2 attr__tag container))))))
(assert (forall ((container us_rep2)) (forall ((key2 Int)) (! (=> (dynamic_invariant2 key2 true true true true) (let ((result (find container key2))) (and (=> (< 0 result) (and (<= result (length container)) (= (equivalent_keys key2 (get container result)) true))) (dynamic_invariant7 result true false true true)))) :pattern ((find container key2))))))
...
(define-fun default_initial_assumption1 ((temp___expr_592 us_rep3) (temp___skip_top_level_593 Bool)) Bool (=> (not (= temp___skip_top_level_593 true)) (and (= (is_empty temp___expr_592) true) (= (length5 temp___expr_592) 0))))
(assert true)
...
(define-fun default_initial_assumption2 ((temp___expr_651 us_rep4) (temp___skip_top_level_652 Bool)) Bool (=> (not (= temp___skip_top_level_652 true)) (and (= (is_empty1 temp___expr_651) true) (= (length6 temp___expr_651) 0))))
...
(assert true)
(define-fun dynamic_invariant8 ((temp___expr_577 Int) (temp___is_init_573 Bool) (temp___skip_constant_574 Bool) (temp___do_toplevel_575 Bool) (temp___do_typ_inv_576 Bool)) Bool (=> (or (= temp___is_init_573 true) (<= 1 2147483647)) (in_range5 temp___expr_577)))
(assert (forall ((container us_rep3)) (forall ((key2 Int)) (! (=> (dynamic_invariant8 key2 true true true true) (=> (= (distinct 1 0) true) (=> (exists ((k Int)) (and (and (in_range5 k) (= (has_key container k) true)) (= (equivalent_keys k key2) true))) (= (has_key container key2) true)))) :pattern ((has_key container key2))))))
...
(assert (forall ((container us_rep3)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant8 key2 true true true true) (= (has_key container key2) true)) (let ((result (get2 container key2))) (and (=> (= (distinct 1 0) true) (and (= result (w_get container (witness container key2))) (forall ((k Int)) (=> (and (in_range5 k) (= (has_key container k) true)) (= (= (equivalent_keys k key2) true) (= (witness container key2) (witness container k))))))) (dynamic_invariant9 result true false true true)))) :pattern ((get2 container key2))))))
(assert (forall ((container us_rep3)) (! (dynamic_invariant7 (length5 container) true false true true) :pattern ((length5 container)))))
...
(assert true)
(assert (forall ((container us_rep3)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant8 key2 true true true true) (= (has_key container key2) true)) (let ((result (witness container key2))) (and (= (has_witness container result) true) (dynamic_invariant7 result true false true true)))) :pattern ((witness container key2))))))
(assert (forall ((container us_rep3)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant7 witness1 true true true true) (= (has_witness container witness1) true)) (dynamic_invariant9 (w_get container witness1) true false true true)) :pattern ((w_get container witness1))))))
(define-fun dynamic_invariant10 ((temp___expr_620 Int) (temp___is_init_616 Bool) (temp___skip_constant_617 Bool) (temp___do_toplevel_618 Bool) (temp___do_typ_inv_619 Bool)) Bool (=> (or (= temp___is_init_616 true) (<= 0 2147483647)) (in_range6 temp___expr_620)))
(assert (forall ((container us_rep2)) (! (let ((result (length container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant7 result true false true true))) :pattern ((length container)))))
...
(assert (forall ((container us_rep2)) (forall ((position Int)) (! (=> (and (dynamic_invariant10 position true true true true) (and (<= 1 position) (<= position (last container)))) (dynamic_invariant11 (get container position) true false true true)) :pattern ((get container position))))))
(assert (forall ((container us_rep4)) (forall ((key2 us_rep1)) (! (=> (= (distinct 0 0) true) (=> (exists ((k us_rep1)) (and (= (has_key1 container k) true) (= (bool_eq2 k key2) true))) (= (has_key1 container key2) true))) :pattern ((has_key1 container key2))))))
...
(assert (forall ((container us_rep4)) (forall ((key2 us_rep1)) (! (=> (= (has_key1 container key2) true) (let ((result (get1 container key2))) (and (=> (= (distinct 0 0) true) (and (= result (w_get1 container (witness1 container key2))) (forall ((k us_rep1)) (=> (= (has_key1 container k) true) (= (= (bool_eq2 k key2) true) (= (witness1 container key2) (witness1 container k))))))) (dynamic_invariant12 result true false true true)))) :pattern ((get1 container key2))))))
(assert (forall ((container us_rep4)) (! (dynamic_invariant7 (length6 container) true false true true) :pattern ((length6 container)))))
...
(assert true)
(assert (forall ((container us_rep4)) (forall ((key2 us_rep1)) (! (=> (= (has_key1 container key2) true) (let ((result (witness1 container key2))) (and (= (has_witness1 container result) true) (dynamic_invariant7 result true false true true)))) :pattern ((witness1 container key2))))))
...
(define-fun default_initial_assumption3 ((temp___expr_841 us_rep7) (temp___skip_top_level_842 Bool)) Bool (=> (not (= temp___skip_top_level_842 true)) (= (length4 temp___expr_841) 0)))
...
(assert (forall ((container us_rep7)) (! (let ((result (length4 container))) (and (<= (+ (- 1) result) 10000) (dynamic_invariant7 result true false true true))) :pattern ((length4 container)))))
(assert true)
...
(assert (= (bool_eq a1 0 5 a_update 0 5) true))
(assert (forall ((c us_rep1)) (=> (= (has_key1 (positions (mk___rep d__split_discrs d__split_fields1)) c) true) (=> (and (not (= (key (mk___rep d__split_discrs d__split_fields1) c) (to_rep (select a1 i)))) (not (= (key (mk___rep d__split_discrs d__split_fields1) c) (to_rep (select a1 j))))) (= (to_rep (select a1 (element (mk___rep d__split_discrs d__split_fields1) c))) (key (mk___rep d__split_discrs d__split_fields1) c))))))
(assert (forall ((c us_rep1)) (=> (= (has_key1 (positions (mk___rep d__split_discrs d__split_fields1)) c) true) (=> (= (key (mk___rep d__split_discrs d__split_fields1) c) (to_rep (select a1 i))) (= (to_rep (select a1 (element (mk___rep d__split_discrs d__split_fields1) c))) (key (mk___rep d__split_discrs d__split_fields1) c))))))
...
(assert (not (= (bool_eq a1 0 5 a_update 0 5) true)))
(check-sat)
(exit)
