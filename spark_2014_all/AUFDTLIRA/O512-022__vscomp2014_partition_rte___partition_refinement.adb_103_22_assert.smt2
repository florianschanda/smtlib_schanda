...
(assert (forall ((c9 us_rep1)) (=> (= (has_key1 (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields))) c9) true) (=> (and (not (= (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c9) (to_rep (select a1 i)))) (not (= (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c9) (to_rep (select a1 j))))) (= (to_rep (select a1 (element (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c9))) (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c9))))))
...
(assert (= (bool_eq a1 0 5 a_update 0 5) true))
(assert (forall ((c9 us_rep1)) (=> (= (has_key1 (positions (mk___rep d__split_discrs d__split_fields1)) c9) true) (=> (and (not (= (key (mk___rep d__split_discrs d__split_fields1) c9) (to_rep (select a1 i)))) (not (= (key (mk___rep d__split_discrs d__split_fields1) c9) (to_rep (select a1 j))))) (= (to_rep (select a1 (element (mk___rep d__split_discrs d__split_fields1) c9))) (key (mk___rep d__split_discrs d__split_fields1) c9))))))
(assert (forall ((c9 us_rep1)) (=> (= (has_key1 (positions (mk___rep d__split_discrs d__split_fields1)) c9) true) (=> (= (key (mk___rep d__split_discrs d__split_fields1) c9) (to_rep (select a1 i))) (= (to_rep (select a1 (element (mk___rep d__split_discrs d__split_fields1) c9))) (key (mk___rep d__split_discrs d__split_fields1) c9))))))
