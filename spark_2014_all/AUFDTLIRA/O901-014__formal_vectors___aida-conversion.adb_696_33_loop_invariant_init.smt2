...
(assert (<= index2 temp___1547))
(assert (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))))
(assert (= o1 index2))
(assert (= o2 (select n1 o1)))
(assert (= o3 (to_rep1 o2)))
(assert (= o3 aida__conversion__convert_character_digit_to_integer__2__target))
...
(assert (= (to_rep1 o7) aida__conversion__convert_character_digit_to_integer__2__target2))
(assert (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))))
(assert (= o8 index2))
(assert (= o9 (store n1 o8 o7)))
(assert (= n1 result2))
(assert (= n2 o9))
