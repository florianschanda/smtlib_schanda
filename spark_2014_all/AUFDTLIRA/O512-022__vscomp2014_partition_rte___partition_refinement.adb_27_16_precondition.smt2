...
(assert (and (= o14 (length3 (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields)))) (and (in_range10 o14) (<= o14 (capacity (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields)))))))
(assert (= result (ite (< o14 10000) true false)))
(assert (= result true))
(assert (and (= result1 (has_key (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem)) (= (= result1 true) (= (has_key (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem) true))))
(assert (= result1 true))
(assert (and (= o9 (length3 (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields)))) (and (in_range10 o9) (<= o9 (capacity (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields)))))))
(assert (= o10 (- o9 1)))
(assert (and (= o7 (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem)) (and (in_range8 o7) (= o7 (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem)))))
(assert (= o8 (select f o7)))
(assert (= o11 (to_rep4 o8)))
(assert (= o12 (ite (<= o11 o10) true false)))
(assert (and (= o4 (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem)) (and (in_range8 o4) (= o4 (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem)))))
(assert (= o5 (select f o4)))
(assert (= o6 (to_rep4 o5)))
(assert (= o13 (ite (<= 0 o6) true false)))
(assert (= result2 (ite (= o13 true) o12 false)))
(assert (= result2 true))
(assert (= (= result3 true) (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 5)) (= (has_key (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) (to_rep (select a j1))) true)))))
(assert (= result3 true))
(assert (not true))
(check-sat)
(exit)
