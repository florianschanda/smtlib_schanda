...
(assert (= result8 perm__remove__result8))
(assert (= result9 perm__remove__result9))
(assert (not (= (invariant__ (mk___t perm__remove__result8 perm__remove__result9)) true)))
(check-sat)
(exit)
