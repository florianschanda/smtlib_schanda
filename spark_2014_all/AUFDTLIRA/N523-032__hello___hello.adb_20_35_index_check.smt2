...
(assert (=> (= result1 true) (and (= temp___5901 (- j 1)) (in_range1 (- j 1)))))
(assert (=> (= result1 true) (and (<= (to_rep1 (first (rt str))) temp___5901) (<= temp___5901 (to_rep1 (last (rt str)))))))
(assert (=> (= result1 true) (= o3 temp___5901)))
(assert (=> (= result1 true) (= o4 (select (elts str) o3))))
(assert (=> (= result1 true) (= o5 (to_rep o4))))
(assert (=> (= result1 true) (= o6 (ite (<= o5 90) true false))))
(assert (=> (= result1 true) (and (= temp___590 (- j 1)) (in_range1 (- j 1)))))
(assert (=> (= result1 true) (and (<= (to_rep1 (first (rt str))) temp___590) (<= temp___590 (to_rep1 (last (rt str)))))))
(assert (=> (= result1 true) (= o temp___590)))
