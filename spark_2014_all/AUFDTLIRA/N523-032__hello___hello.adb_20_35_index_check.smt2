...
(assert (=> (= result1 true) (and (= temp___5841 (- j 1)) (in_range1 (- j 1)))))
(assert (=> (= result1 true) (and (<= (to_rep1 (first (rt str))) temp___5841) (<= temp___5841 (to_rep1 (last (rt str)))))))
(assert (=> (= result1 true) (= o7 temp___5841)))
(assert (=> (= result1 true) (= o8 (select (elts str) o7))))
(assert (=> (= result1 true) (= o9 (to_rep o8))))
(assert (=> (= result1 true) (= o10 (ite (<= o9 90) true false))))
(assert (=> (= result1 true) (and (= temp___584 (- j 1)) (in_range1 (- j 1)))))
(assert (=> (= result1 true) (and (<= (to_rep1 (first (rt str))) temp___584) (<= temp___584 (to_rep1 (last (rt str)))))))
(assert (=> (= result1 true) (= o4 temp___584)))
