...
(assert (=> (= result1 true) (and (= temp___6591 (- j 1)) (in_range1 (- j 1)))))
(assert (=> (= result1 true) (and (<= (to_rep1 (first (rt str))) temp___6591) (<= temp___6591 (to_rep1 (last (rt str)))))))
(assert (=> (= result1 true) (= o3 temp___6591)))
(assert (=> (= result1 true) (= o4 (select (elts str) o3))))
(assert (=> (= result1 true) (= o5 (to_rep o4))))
(assert (=> (= result1 true) (= o6 (ite (<= o5 90) true false))))
(assert (=> (= result1 true) (and (= temp___659 (- j 1)) (in_range1 (- j 1)))))
(assert (=> (= result1 true) (and (<= (to_rep1 (first (rt str))) temp___659) (<= temp___659 (to_rep1 (last (rt str)))))))
(assert (=> (= result1 true) (= o temp___659)))
