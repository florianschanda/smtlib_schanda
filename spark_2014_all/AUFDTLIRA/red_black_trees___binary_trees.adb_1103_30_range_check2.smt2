...
(assert (and (= o12 r1) (in_range2 r1)))
(assert (and (= o13 (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o12)) (and (dynamic_invariant1 o13 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o13 o12))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select o13 o12)))) 0) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= i o12)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select o13 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select o13 i))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select o13 i))) true)))))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o13 i))) true) (not (= i o12))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select o13 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i)))) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i) (rec__tree_model__path_type__a (us_split_fields1 (select o13 i)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select o13 i)))) 0)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select o13 i))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o13 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select o13 i))) (rec__tree_model__path_type__a (us_split_fields1 (select o13 j)))) true)) (= j i))))))))))))))
