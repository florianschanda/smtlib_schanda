...
(assert (=> (and (<= 0 x1) (<= x1 255)) (and (and (forall ((temp___310 Int)) (=> (and (<= 0 temp___310) (<= temp___310 255)) (=> (< x2 temp___310) (= (select r3 temp___310) (select temp___309 temp___310))))) (=> (<= 0 255) (in_range1 x2))) (and (<= 0 x2) (<= x2 255)))))
