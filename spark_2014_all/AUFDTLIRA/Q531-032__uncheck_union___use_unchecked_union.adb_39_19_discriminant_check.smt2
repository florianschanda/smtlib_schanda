...
(declare-const temp___243 us_rep2)
...
(declare-const output__split_fields5 us_split_fields4)
(declare-const result3 us_split_discrs__ref)
(declare-const output__split_discrs2 us_split_discrs)
(declare-const result4 us_split_fields__ref2)
(declare-const output__split_fields6 us_split_fields4)
(declare-const result5 us_split_discrs__ref)
(declare-const output__split_discrs3 us_split_discrs)
(assert (in_range num))
(assert (not (= num 0)))
(assert (not (= num 1)))
(assert (= (to_rep o13) 0))
(assert (= o14 (mk___split_fields1 o13 output__split_fields3)))
(assert (= o15 (mk___rep1 o14)))
(assert (= o16 (mk___split_fields2 (mk___rep (mk___split_fields output__split_fields output__split_fields1)) o15)))
(assert (= temp___256 (mk___rep2 (mk___split_discrs output__split_discrs) o16 output__attr__constrained)))
(assert (= result4 (mk___split_fields__ref2 (mk___split_fields2 (mk___rep (mk___split_fields output__split_fields output__split_fields1)) (mk___rep1 (mk___split_fields1 output__split_fields2 output__split_fields3))))))
(assert (= output__split_fields6 (us_split_fields5 temp___256)))
(assert (= result5 (mk___split_discrs__ref (mk___split_discrs output__split_discrs))))
(assert (= output__split_discrs3 (us_split_discrs1 temp___256)))
(assert (not (not (= (to_rep (rec__use_unchecked_union__myunion__discr output__split_discrs3)) 0))))
(check-sat)
(exit)
