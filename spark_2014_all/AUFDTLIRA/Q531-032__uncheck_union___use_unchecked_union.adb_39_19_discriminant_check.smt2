...
(declare-fun temp___259 (Int Int Int) (Array Int integer))
(declare-fun temp___271 (Int Int Int Int) (Array Int integer))
(declare-fun temp___284 (Int) (Array Int integer))
(assert (forall ((temp___261 Int) (temp___262 Int) (temp___263 Int)) (let ((temp___260 (temp___259 temp___261 temp___262 temp___263))) (=> (and (and (dynamic_invariant temp___261 true true true true) (dynamic_invariant temp___262 true true true true)) (dynamic_invariant temp___263 true true true true)) (and (and (= (to_rep (select temp___260 0)) temp___261) (= (to_rep (select temp___260 1)) temp___262)) (= (to_rep (select temp___260 2)) temp___263))))))
(assert (forall ((temp___273 Int) (temp___274 Int) (temp___275 Int) (temp___276 Int)) (let ((temp___272 (temp___271 temp___273 temp___274 temp___275 temp___276))) (=> (and (and (and (dynamic_invariant temp___273 true true true true) (dynamic_invariant temp___274 true true true true)) (dynamic_invariant temp___275 true true true true)) (dynamic_invariant temp___276 true true true true)) (and (and (and (= (to_rep (select temp___272 0)) temp___273) (= (to_rep (select temp___272 1)) temp___274)) (= (to_rep (select temp___272 2)) temp___275)) (= (to_rep (select temp___272 3)) temp___276))))))
(assert (forall ((temp___286 Int)) (=> (dynamic_invariant temp___286 true true true true) (forall ((temp___287 Int)) (= (to_rep (select (temp___284 temp___286) temp___287)) temp___286)))))
...
(declare-const temp___283 us_rep2)
...
(assert (not (= num 1)))
(assert (= (to_rep o) 0))
(assert (= o1 (mk___split_fields1 o output__split_fields3)))
(assert (= o2 (mk___rep1 o1)))
(assert (= o3 (mk___split_fields2 (mk___rep (mk___split_fields output__split_fields output__split_fields1)) o2)))
(assert (= temp___283 (mk___rep2 (mk___split_discrs output__split_discrs) o3 output__attr__constrained)))
(assert (= result (mk___split_fields__ref2 (mk___split_fields2 (mk___rep (mk___split_fields output__split_fields output__split_fields1)) (mk___rep1 (mk___split_fields1 output__split_fields2 output__split_fields3))))))
(assert (= output__split_fields4 (us_split_fields5 temp___283)))
(assert (= result1 (mk___split_discrs__ref (mk___split_discrs output__split_discrs))))
(assert (= output__split_discrs1 (us_split_discrs1 temp___283)))
(assert (not (not (= (to_rep (rec__use_unchecked_union__myunion__discr output__split_discrs1)) 0))))
(check-sat)
(exit)
