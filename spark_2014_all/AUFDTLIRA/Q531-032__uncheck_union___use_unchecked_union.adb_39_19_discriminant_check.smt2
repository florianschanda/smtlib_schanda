...
(assert (forall ((temp___234 Int) (temp___235 Int) (temp___236 Int)) (let ((temp___233 (temp___232 temp___234 temp___235 temp___236))) (and (and (= (select temp___233 0) (of_rep temp___234)) (= (select temp___233 1) (of_rep temp___235))) (= (select temp___233 2) (of_rep temp___236))))))
(declare-fun temp___244 (Int Int Int Int) (Array Int integer))
(assert (forall ((temp___246 Int) (temp___247 Int) (temp___248 Int) (temp___249 Int)) (let ((temp___245 (temp___244 temp___246 temp___247 temp___248 temp___249))) (and (and (and (= (select temp___245 0) (of_rep temp___246)) (= (select temp___245 1) (of_rep temp___247))) (= (select temp___245 2) (of_rep temp___248))) (= (select temp___245 3) (of_rep temp___249))))))
(declare-fun temp___257 (Int) (Array Int integer))
(assert (forall ((temp___259 Int)) (forall ((temp___260 Int)) (= (select (temp___257 temp___259) temp___260) (of_rep temp___259)))))
...
(declare-const temp___256 us_rep2)
...
(assert (= temp___256 (mk___rep2 (mk___split_discrs output__split_discrs) o3 output__attr__constrained)))
...
(assert (= output__split_fields4 (us_split_fields5 temp___256)))
(assert (= result1 (mk___split_discrs__ref (mk___split_discrs output__split_discrs))))
(assert (= output__split_discrs1 (us_split_discrs1 temp___256)))
