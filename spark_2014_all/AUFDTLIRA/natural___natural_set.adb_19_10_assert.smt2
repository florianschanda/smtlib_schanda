...
(declare-const dummy3 set_index)
...
(define-fun bool_eq ((a (Array Int element_t)) (a__first Int) (a__last Int) (b (Array Int element_t)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_132 Int)) (=> (and (<= a__first temp___idx_132) (<= temp___idx_132 a__last)) (= (to_rep1 (select a temp___idx_132)) (to_rep1 (select b (+ (- b__first a__first) temp___idx_132))))))) true false))
...
(assert (forall ((a (Array Int element_t)) (b (Array Int element_t))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep1 (select a (+ i 1))) (to_rep1 (select b (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int element_t)) (b (Array Int element_t))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep1 (select b (+ i 1))) (to_rep1 (select a (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
...
(assert true)
(assert (forall ((s us_rep)) (! (= (= (valid s) true) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i (to_rep (rec__natural_set__t__len (us_split_fields1 s))))) (in_range1 (to_rep1 (let ((temp___175 (rec__natural_set__t__m (us_split_fields1 s)))) (select temp___175 i)))))) (forall ((i Int)) (=> (and (<= (+ (to_rep (rec__natural_set__t__len (us_split_fields1 s))) 1) i) (<= i 10)) (= (to_rep1 (let ((temp___176 (rec__natural_set__t__m (us_split_fields1 s)))) (select temp___176 i))) (- 1)))))) :pattern ((valid s)))))
...
(assert true)
(assert (forall ((s us_rep)) (forall ((value Int)) (! (= (= (contains s value) true) (exists ((i Int)) (and (and (<= 1 i) (<= i (to_rep (rec__natural_set__t__len (us_split_fields1 s))))) (= (to_rep1 (let ((temp___185 (rec__natural_set__t__m (us_split_fields1 s)))) (select temp___185 i))) value)))) :pattern ((contains s value))))))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const value Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(assert (forall ((s us_rep)) (! (let ((result (members s))) (and (and (<= 0 result) (<= result 10)) (dynamic_invariant result true false true))) :pattern ((members s)))))
...
(define-fun dynamic_invariant2 ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= 0 10)) (in_range2 temp___expr_136)))
(define-fun dynamic_invariant3 ((temp___expr_148 Int) (temp___is_init_145 Bool) (temp___skip_constant_146 Bool) (temp___do_toplevel_147 Bool)) Bool (=> (or (= temp___is_init_145 true) (<= 1 10)) (in_range4 temp___expr_148)))
...
(declare-const temp___206 set_length)
(declare-const temp___2061 (Array Int element_t))
...
(declare-const temp___210 set_length)
(declare-const temp___2101 (Array Int element_t))
...
(assert (= temp___206 s__split_fields4))
(assert (= temp___2061 s__split_fields5))
(assert (= (to_rep1 o5) value))
(assert (and (<= 1 (to_rep s__split_fields4)) (<= (to_rep s__split_fields4) 10)))
(assert (= o6 (to_rep s__split_fields4)))
(assert (= o7 (store s__split_fields5 o6 o5)))
(assert (= s__split_fields4 o8))
(assert (= o7 o9))
(assert (= temp___210 o8))
(assert (= temp___2101 o9))
(assert (= result3 s__split_fields4))
(assert (= result4 s__split_fields5))
(assert (= temp___210 s__split_fields6))
(assert (= temp___2101 s__split_fields7))
(assert (not (= (contains (mk___rep (mk___split_fields s__split_fields6 s__split_fields7)) value) true)))
(check-sat)
(exit)
