...
(assert (not (= (let ((temp___241 (remove (mk___t interm1 (mk 1 100)) x))) (let ((temp___240 (remove (mk___t init (mk 1 100)) x))) (bool_eq (elts temp___240) (to_rep1 (first (rt temp___240))) (to_rep1 (last (rt temp___240))) (elts temp___241) (to_rep1 (first (rt temp___241))) (to_rep1 (last (rt temp___241)))))) true)))
(check-sat)
(exit)
