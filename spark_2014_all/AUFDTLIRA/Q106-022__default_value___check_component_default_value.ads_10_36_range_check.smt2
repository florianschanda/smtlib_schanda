...
(define-fun dynamic_invariant2 ((temp___expr_147 (Array Int integer)) (temp___is_init_144 Bool) (temp___skip_constant_145 Bool) (temp___do_toplevel_146 Bool)) Bool (forall ((temp___148 Int)) (=> (and (<= 1 temp___148) (<= temp___148 2)) (=> (or (= temp___is_init_144 true) (<= first 2147483647)) (dynamic_property first 2147483647 (to_rep (select temp___expr_147 temp___148)))))))
(define-fun default_initial_assumption ((temp___expr_149 (Array Int integer)) (temp___skip_top_level_150 Bool)) Bool (forall ((temp___151 Int)) (=> (and (<= 1 temp___151) (<= temp___151 2)) (= (to_rep (select temp___expr_149 temp___151)) 0))))
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(assert (= one (id 1)))
(define-fun dynamic_invariant3 ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= first 2147483647)) (dynamic_property first 2147483647 temp___expr_136)))
(assert (= first one))
(declare-const o Int)
...
(assert (= check_component_default_value__p__one__assume one))
(assert (in_range one))
(assert (=> (<= 1 2) (= o1 (+ (- 2 1) 1))))
(assert (=> (not (<= 1 2)) (= o1 0)))
