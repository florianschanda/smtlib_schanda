...
(assert (not (not (= (peek (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields12)) (parent (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields12)) (parent (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields12)) (int__content x5))) 0) 0))))
(check-sat)
(exit)
