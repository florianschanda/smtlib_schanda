...
(assert (forall ((temp___157 Int) (temp___158 Int)) (let ((temp___156 (main__map__aggregate_def temp___157 temp___158))) (=> (and (dynamic_invariant temp___157 true true true true) (dynamic_invariant temp___158 true true true true)) (and (= (to_rep (select temp___156 0)) temp___157) (= (to_rep (select temp___156 1)) temp___158))))))
