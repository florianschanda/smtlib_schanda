...
(declare-const main__with_invariant__result Int)
(declare-const result Int)
(declare-const main__with_invariant__result1 Int)
(declare-const main__with_invariant__result2 Int)
(declare-const main__with_invariant__result3 Int)
(declare-const main__with_invariant__result4 Int)
(declare-const main__with_invariant__result5 Int)
