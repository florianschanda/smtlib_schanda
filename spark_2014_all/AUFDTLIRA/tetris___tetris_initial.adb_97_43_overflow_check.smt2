...
(assert (forall ((temp___509 Int)) (forall ((temp___510 Int)) (= (select (tetris_initial__delete_complete_lines__empty_line__aggregate_def temp___509) temp___510) (of_rep temp___509)))))
...
(declare-const temp___751 (Array Int (Array Int cell)))
(declare-const temp___750 Bool)
...
(assert (= del_line1 1))
(assert (=> (and (<= 1 del_line1) (<= del_line1 50)) (= temp___753 to_line1)))
(assert (=> (and (<= 1 del_line1) (<= del_line1 50)) (= temp___751 cur_board)))
(assert (=> (and (<= 1 del_line1) (<= del_line1 50)) (= temp___750 has_complete_lines1)))
(assert (=> (and (<= 1 del_line1) (<= del_line1 50)) (and (and (forall ((temp___752 Int)) (=> (and (<= 1 temp___752) (<= temp___752 50)) (=> (<= del_line2 temp___752) (= (select cur_board2 temp___752) (select temp___751 temp___752))))) (=> (<= 1 50) (in_range3 to_line2))) (and (<= 1 del_line2) (<= del_line2 50)))))
