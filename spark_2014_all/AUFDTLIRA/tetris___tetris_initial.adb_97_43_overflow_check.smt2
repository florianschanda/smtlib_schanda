...
(declare-fun tetris_initial__delete_complete_lines__empty_line__aggregate_def (Int) (Array Int cell))
...
(assert (= empty_line (tetris_initial__delete_complete_lines__empty_line__aggregate_def 0)))
(define-fun dynamic_invariant3 ((temp___expr_537 Int) (temp___is_init_533 Bool) (temp___skip_constant_534 Bool) (temp___do_toplevel_535 Bool) (temp___do_typ_inv_536 Bool)) Bool (=> (or (= temp___is_init_533 true) (<= 0 7)) (in_range3 temp___expr_537)))
(assert (forall ((temp___531 Int)) (=> (dynamic_invariant3 temp___531 true true true true) (forall ((temp___532 Int)) (= (to_rep (select (tetris_initial__delete_complete_lines__empty_line__aggregate_def temp___531) temp___532)) temp___531)))))
...
(declare-const temp___793 (Array Int (Array Int cell)))
(declare-const temp___792 Bool)
...
(assert (= (tetris_initial__delete_complete_lines__empty_line__aggregate_def 0) empty_line))
...
(assert (= del_line1 1))
(assert (=> (and (<= 1 del_line1) (<= del_line1 50)) (= temp___795 to_line1)))
(assert (=> (and (<= 1 del_line1) (<= del_line1 50)) (= temp___793 cur_board)))
(assert (=> (and (<= 1 del_line1) (<= del_line1 50)) (= temp___792 has_complete_lines1)))
(assert (=> (and (<= 1 del_line1) (<= del_line1 50)) (and (and (forall ((temp___794 Int)) (=> (and (<= 1 temp___794) (<= temp___794 50)) (=> (or (< 50 temp___794) (or (< temp___794 1) (<= del_line2 temp___794))) (= (select cur_board2 temp___794) (select temp___793 temp___794))))) (=> (<= 1 50) (in_range4 to_line2))) (and (<= 1 del_line2) (<= del_line2 50)))))
...
(assert (<= 1 from_line1))
(assert (<= from_line1 r3b))
(assert (and (and (=> (<= 0 2147483647) (in_range2 num_deleted2)) (=> (<= 1 50) (in_range4 to_line8))) (and (<= 1 from_line2) (<= from_line2 r3b))))
...
(assert (= to_line9 o1))
(assert (not (in_range1 (+ num_deleted2 1))))
(check-sat)
(exit)
