...
(declare-const temp___791 (Array Int (Array Int cell)))
(declare-const temp___790 Bool)
...
(assert (= del_line1 1))
(assert (=> (and (<= 1 del_line1) (<= del_line1 50)) (= temp___793 to_line1)))
(assert (=> (and (<= 1 del_line1) (<= del_line1 50)) (= temp___791 cur_board)))
(assert (=> (and (<= 1 del_line1) (<= del_line1 50)) (= temp___790 has_complete_lines1)))
(assert (=> (and (<= 1 del_line1) (<= del_line1 50)) (and (and (forall ((temp___792 Int)) (=> (and (<= 1 temp___792) (<= temp___792 50)) (=> (<= del_line2 temp___792) (= (select cur_board2 temp___792) (select temp___791 temp___792))))) (=> (<= 1 50) (in_range3 to_line2))) (and (<= 1 del_line2) (<= del_line2 50)))))
...
(assert (<= 1 from_line1))
(assert (<= from_line1 r3b))
(assert (and (and (=> (<= 0 2147483647) (in_range2 num_deleted2)) (=> (<= 1 50) (in_range3 to_line8))) (and (<= 1 from_line2) (<= from_line2 r3b))))
