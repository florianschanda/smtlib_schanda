...
(assert (and (= result (valid t s)) (= (= result true) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i s)) (and (<= 0 (to_rep (select t i))) (<= (to_rep (select t i)) 2147483647)))) (forall ((i Int)) (=> (and (<= (+ s 1) i) (<= i 100)) (= (to_rep (select t i)) (- 1))))))))
(assert (= result true))
(assert (not (exists ((s1 Int)) (and (and (<= 0 s1) (<= s1 100)) (= (valid t s1) true)))))
(check-sat)
(exit)
