...
(assert (= (to_rep o) 1))
(assert (= o6 (concat_singleton_left o (- 2147483648) temp___211 1 9)))
(assert (= o6 temp___212))
(assert (= (mk (- 2147483648) o5) temp___2121))
...
(assert (= (to_rep o8) 1))
(assert (= o14 (concat_singleton_left o8 1 temp___216 1 9)))
(assert (= o14 temp___217))
(assert (= (mk1 1 o13) temp___2171))
...
(assert (= o15 (slide temp___217 (to_rep (first2 temp___2171)) 1)))
(assert (= result1 z1))
(assert (= z3 o15))
(assert (= (to_rep (select z3 1)) 1))
(assert (not (= (to_rep (select z3 10)) (to_rep (select y 9)))))
(check-sat)
(exit)
