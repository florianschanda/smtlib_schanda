...
(assert (not (= (length (mk___t temp___1758 temp___17581)) 0)))
(assert (=> (<= 1 5) (= o8 (+ (- 5 1) 1))))
(assert (=> (not (<= 1 5)) (= o8 0)))
(assert (=> (<= (to_rep1 (first temp___17581)) (to_rep1 (last temp___17581))) (= o9 (+ (- (to_rep1 (last temp___17581)) (to_rep1 (first temp___17581))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___17581)) (to_rep1 (last temp___17581)))) (= o9 0)))
(assert (= o10 (+ o9 o8)))
(assert (= o11 (+ (to_rep1 (first temp___17581)) o10)))
(assert (= o12 (- o11 1)))
