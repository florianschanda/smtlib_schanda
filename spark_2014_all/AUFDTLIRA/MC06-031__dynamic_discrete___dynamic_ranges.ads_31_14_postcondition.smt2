...
(assert (=> (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last))) (and (and (= temp___255 a) (and (= temp___253 i1) (and (and (and (= o i1) (in_range2 i1)) (and (= (to_rep (select a2 o)) 0) (forall ((j2 Int)) (=> (and (<= (to_rep a__first) j2) (<= j2 (to_rep a__last))) (=> (not (= o j2)) (= (to_rep (select a2 j2)) (to_rep (select a j2)))))))) (and (forall ((j2 Int)) (=> (and (<= (to_rep a__first) j2) (<= j2 i2)) (= (to_rep (select a3 j2)) 0))) (and (and (=> (<= (to_rep a__first) (to_rep a__last)) (dynamic_property1 (to_rep a__first) (to_rep a__last) i2)) (and (<= (to_rep a__first) i2) (<= i2 (to_rep a__last)))) (= i2 (to_rep a__last))))))) (and (and (= i2 i6) (= a3 a7)) (and (= i7 i2) (= a8 a3))))))
(assert (=> (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last))) (= (mk_int__ref i8) (mk_int__ref i6))))
(assert (=> (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last))) (= (mk_map__ref a9) (mk_map__ref a7))))
(assert (=> (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last))) (= i9 i7)))
(assert (=> (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last))) (= a10 a8)))
(assert (=> (not (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last)))) (= i1 i8)))
(assert (=> (not (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last)))) (= (mk_map__ref a9) (mk_map__ref a))))
(assert (=> (not (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last)))) (= i9 i1)))
(assert (=> (not (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last)))) (= a10 a1)))
...
(assert (<= j2 (to_rep a__last)))
(assert (not (= (to_rep (select a11 j2)) 0)))
(check-sat)
(exit)
