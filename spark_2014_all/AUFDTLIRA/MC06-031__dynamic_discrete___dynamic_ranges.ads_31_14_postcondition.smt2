...
(assert (=> (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last))) (and (= (to_rep (select a2 o)) 0) (forall ((j Int)) (=> (and (<= (to_rep a__first) j) (<= j (to_rep a__last))) (=> (not (= o j)) (= (to_rep (select a2 j)) (to_rep (select a j)))))))))
(assert (=> (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last))) (forall ((j Int)) (=> (and (<= (to_rep a__first) j) (<= j i2)) (= (to_rep (select a3 j)) 0)))))
...
(assert (not (= (to_rep (select a8 j)) 0)))
(check-sat)
(exit)
