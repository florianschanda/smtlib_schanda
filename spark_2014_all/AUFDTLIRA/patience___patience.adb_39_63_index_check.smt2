...
(assert (=> (= result6 true) (= temp___574 (to_rep1 o16))))
(assert (=> (= result6 true) (and (<= 0 temp___574) (<= temp___574 99))))
(assert (=> (= result6 true) (= o17 temp___574)))
...
(assert (= temp___577 (to_rep1 o11)))
(assert (and (<= 0 temp___577) (<= temp___577 99)))
(assert (= o12 temp___577))
(assert (= temp___578 (select s__split_fields4 o12)))
