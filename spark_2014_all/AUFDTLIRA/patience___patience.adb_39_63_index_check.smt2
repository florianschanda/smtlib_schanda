...
(assert (=> (= result8 true) (= o26 (to_rep o25))))
(assert (=> (= result8 true) (= result7 (ite (< o26 (to_rep s__split_fields2)) true false))))
...
(assert (=> (= result7 true) (= o23 (to_rep o22))))
...
(assert (=> (= result6 true) (= temp___574 (to_rep o16))))
