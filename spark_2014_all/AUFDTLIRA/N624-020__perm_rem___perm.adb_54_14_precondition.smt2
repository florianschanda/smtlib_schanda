...
(assert (and (= (mk___t o1 o2) (remove a o)) (and (dynamic_invariant (mk___t o1 o2) true false true) (and (= (invariant__ (mk___t o1 o2)) true) (and (= (to_rep2 (last o2)) (- (to_rep2 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o 1))) (= (to_rep (select (elts a) k)) (to_rep (select o1 k))))) (and (forall ((k Int)) (=> (and (<= (+ o 1) k) (<= k (to_rep2 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select o1 (- k 1)))))) (forall ((k Int)) (=> (and (<= o k) (<= k (- (to_rep2 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select o1 k))))))))))))
