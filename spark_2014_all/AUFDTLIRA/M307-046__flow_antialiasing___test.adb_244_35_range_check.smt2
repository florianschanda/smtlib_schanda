...
(declare-fun user_eq4 (t72b t72b) Bool)
(declare-const dummy4 t72b)
(declare-datatypes () ((t72b__ref (mk_t72b__ref (t72b__content t72b)))))
(define-fun t72b__ref___projection ((a t72b__ref)) t72b (t72b__content a))
(declare-sort t74b 0)
(define-fun in_range4 ((x Int)) Bool (and (<= 2 x) (<= x 3)))
(declare-fun attr__ATTRIBUTE_IMAGE4 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check4 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE4 (us_image) Int)
(declare-fun user_eq5 (t74b t74b) Bool)
(declare-const dummy5 t74b)
...
(assert (=> (<= 1 5) (and (and (<= (to_rep1 a__first) 1) (<= 1 (to_rep1 a__last))) (and (<= (to_rep1 a__first) 5) (<= 5 (to_rep1 a__last))))))
(assert (= temp___492 a))
(assert (= test__op_string_io_i__x__compl temp___492))
(assert (<= 2 3))
