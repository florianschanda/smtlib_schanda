...
(assert (not (= (length (mk___t temp___1521 temp___15211)) 0)))
(assert (=> (<= 1 3) (= o12 (+ (- 3 1) 1))))
(assert (=> (not (<= 1 3)) (= o12 0)))
(assert (=> (<= (to_rep1 (first temp___15211)) (to_rep1 (last temp___15211))) (= o13 (+ (- (to_rep1 (last temp___15211)) (to_rep1 (first temp___15211))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___15211)) (to_rep1 (last temp___15211)))) (= o13 0)))
(assert (= o14 (+ o13 o12)))
(assert (= o15 (+ (to_rep1 (first temp___15211)) o14)))
(assert (= o16 (- o15 1)))
