...
(assert (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 id2)) (=> (not (= (get_other_previous_track new_position k1) 0)) (let ((temp___394 (to_rep5 (select track_signals3 (get_other_previous_track new_position k1))))) (or (= temp___394 1) (= temp___394 2)))))))
...
(assert (and (= temp___391 (get_other_previous_track new_position o12)) (and (in_range1 temp___391) (= temp___391 (ite (= (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep (rec__trains__train_position__track_begin (us_split_fields3 new_position)))))))) o12)) (to_rep (rec__trains__train_position__track_end (us_split_fields3 new_position)))) 0 (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep (rec__trains__train_position__track_begin (us_split_fields3 new_position)))))))) o12)))))))
(assert (not (<= 1 temp___391)))
(check-sat)
(exit)
