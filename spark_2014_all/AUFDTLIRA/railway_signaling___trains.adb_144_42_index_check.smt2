...
(assert (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 id2)) (=> (not (= (get_other_previous_track new_position k1) 0)) (let ((temp___362 (to_rep5 (select track_signals3 (get_other_previous_track new_position k1))))) (or (= temp___362 1) (= temp___362 2)))))))
...
(assert (and (= o10 (get_other_previous_track new_position o9)) (and (in_range1 o10) (= o10 (ite (= (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep (rec__trains__train_position__track_begin (us_split_fields3 new_position)))))))) o9)) (to_rep (rec__trains__train_position__track_end (us_split_fields3 new_position)))) 0 (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep (rec__trains__train_position__track_begin (us_split_fields3 new_position)))))))) o9)))))))
...
(assert (and (= temp___359 (get_other_previous_track new_position o12)) (and (in_range1 temp___359) (= temp___359 (ite (= (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep (rec__trains__train_position__track_begin (us_split_fields3 new_position)))))))) o12)) (to_rep (rec__trains__train_position__track_end (us_split_fields3 new_position)))) 0 (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep (rec__trains__train_position__track_begin (us_split_fields3 new_position)))))))) o12)))))))
(assert (not (<= 1 temp___359)))
(check-sat)
(exit)
