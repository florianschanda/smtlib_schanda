...
(assert (<= 1 k))
(assert (<= k id15))
(assert (and (= o43 k) (in_range3 k)))
(assert (and (= o44 (get_other_previous_track new_position o43)) (and (in_range1 o44) (= o44 (ite (= (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep (rec__trains__train_position__track_begin (us_split_fields3 new_position)))))))) o43)) (to_rep (rec__trains__train_position__track_end (us_split_fields3 new_position)))) 0 (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep (rec__trains__train_position__track_begin (us_split_fields3 new_position)))))))) o43)))))))
(assert (= o45 (ite (= o44 0) true false)))
(assert (= result26 (ite (not (= o45 true)) true false)))
(assert (= result26 true))
(assert (and (= o46 k) (in_range3 k)))
(assert (and (= temp___359 (get_other_previous_track new_position o46)) (and (in_range1 temp___359) (= temp___359 (ite (= (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep (rec__trains__train_position__track_begin (us_split_fields3 new_position)))))))) o46)) (to_rep (rec__trains__train_position__track_end (us_split_fields3 new_position)))) 0 (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep (rec__trains__train_position__track_begin (us_split_fields3 new_position)))))))) o46)))))))
