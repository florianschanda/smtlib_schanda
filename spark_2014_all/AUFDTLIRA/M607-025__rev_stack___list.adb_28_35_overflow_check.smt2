...
(declare-const j Int)
(declare-const temp___518 (Array Int integer))
(declare-const temp___5181 t)
...
(define-fun temp___5182 () us_t (mk___t temp___518 temp___5181))
...
(assert (and (= temp___5182 (to__ (mk___rep s__split_fields4))) (and (dynamic_invariant1 temp___5182 true false true true) (and (= (to_rep (first temp___5181)) 1) (<= 0 (to_rep (last temp___5181)))))))
