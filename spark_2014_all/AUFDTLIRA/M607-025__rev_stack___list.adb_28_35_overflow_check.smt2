...
(assert (and (= o10 (to__ (mk___rep s__split_fields4))) (and (dynamic_invariant1 o10 true false true) (and (= (to_rep (first o5)) 1) (<= 0 (to_rep (last o5)))))))
(assert (= o9 (to_rep (last o5))))
(assert (= result3 (ite (= o9 o8) true false)))
(assert (= result3 true))
(assert (<= first4 j))
(assert (<= j i2))
(assert (and (= o2 j) (in_range5 j)))
(assert (and (= o3 (get (model__ l) o2)) (and (in_range8 o3) (= o3 (get (model__ l) o2)))))
(assert (and (= temp___4722 (to__ (mk___rep s__split_fields4))) (and (dynamic_invariant1 temp___4722 true false true) (and (= (to_rep (first temp___4721)) 1) (<= 0 (to_rep (last temp___4721)))))))
