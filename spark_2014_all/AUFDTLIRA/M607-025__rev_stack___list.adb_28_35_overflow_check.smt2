...
(assert (and (= o5 (get (model__ l) o4)) (and (in_range8 o5) (= o5 (get (model__ l) o4)))))
(assert (and (= (mk___t temp___472 temp___4721) (to__ (mk___rep s__split_fields4))) (and (dynamic_invariant1 (mk___t temp___472 temp___4721) true false true) (and (= (to_rep (first temp___4721)) 1) (<= 0 (to_rep (last temp___4721)))))))
