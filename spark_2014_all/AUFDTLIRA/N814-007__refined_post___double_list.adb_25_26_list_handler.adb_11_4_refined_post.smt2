...
(define-fun dynamic_invariant ((temp___expr_153 Int) (temp___is_init_150 Bool) (temp___skip_constant_151 Bool) (temp___do_toplevel_152 Bool)) Bool (=> (or (= temp___is_init_150 true) (<= 0 128)) (in_range2 temp___expr_153)))
...
(assert (forall ((list_handler__integer_list__count Int)) (! (=> (dynamic_invariant list_handler__integer_list__count true true true) (dynamic_invariant1 (size list_handler__integer_list__count) true false true)) :pattern ((size list_handler__integer_list__count)))))
(assert (forall ((list_handler__integer_list__count Int)) (! (=> (dynamic_invariant list_handler__integer_list__count true true true) (let ((result (size1 list_handler__integer_list__count))) (and (= result list_handler__integer_list__count) (dynamic_invariant1 result true false true)))) :pattern ((size1 list_handler__integer_list__count)))))
...
(assert (forall ((temp___219 Int)) (forall ((temp___220 Int)) (= (select (temp___217 temp___219) temp___220) (of_rep1 temp___219)))))
...
(assert (=> (and (<= 1 index1) (<= index1 127)) (and (forall ((temp___222 Int)) (=> (and (<= 0 temp___222) (<= temp___222 128)) (=> (<= index2 temp___222) (= (select free_list2 temp___222) (select temp___221 temp___222))))) (and (<= 1 index2) (<= index2 127)))))
