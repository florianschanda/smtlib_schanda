...
(define-fun dynamic_invariant ((temp___expr_178 Int) (temp___is_init_174 Bool) (temp___skip_constant_175 Bool) (temp___do_toplevel_176 Bool) (temp___do_typ_inv_177 Bool)) Bool (=> (or (= temp___is_init_174 true) (<= 0 128)) (in_range2 temp___expr_178)))
...
(assert (forall ((list_handler__integer_list__count Int)) (! (=> (dynamic_invariant list_handler__integer_list__count true true true true) (dynamic_invariant1 (size list_handler__integer_list__count) true false true true)) :pattern ((size list_handler__integer_list__count)))))
(assert (forall ((list_handler__integer_list__count Int)) (! (=> (dynamic_invariant list_handler__integer_list__count true true true true) (let ((result (size1 list_handler__integer_list__count))) (and (= result list_handler__integer_list__count) (dynamic_invariant1 result true false true true)))) :pattern ((size1 list_handler__integer_list__count)))))
(declare-const attr__ATTRIBUTE_ADDRESS4 Int)
(declare-fun temp___242 (us_rep) (Array Int us_rep))
(declare-fun temp___246 (Int) (Array Int index_type))
...
(assert (forall ((temp___244 us_rep)) (forall ((temp___245 Int)) (= (select (temp___242 temp___244) temp___245) temp___244))))
(assert (forall ((temp___248 Int)) (=> (dynamic_invariant temp___248 true true true true) (forall ((temp___249 Int)) (= (to_rep1 (select (temp___246 temp___248) temp___249)) temp___248)))))
...
(assert (= o7 o4))
(assert (= o8 o5))
(assert (= o9 (temp___242 (mk___rep (mk___split_fields o6 o7 o8)))))
(assert (= result memory))
(assert (= memory1 o9))
(assert (= result1 count))
(assert (= count1 0))
(assert (= result2 free_list))
(assert (= free_list1 (temp___246 0)))
(assert (= result3 free))
(assert (= free1 1))
(assert (= result4 index))
(assert (= index1 1))
(assert (=> (and (<= 1 index1) (<= index1 127)) (= temp___250 free_list1)))
(assert (=> (and (<= 1 index1) (<= index1 127)) (and (forall ((temp___251 Int)) (=> (and (<= 0 temp___251) (<= temp___251 128)) (=> (<= index2 temp___251) (= (select free_list2 temp___251) (select temp___250 temp___251))))) (and (<= 1 index2) (<= index2 127)))))
...
(assert (not (= (int__content count2) 0)))
(check-sat)
(exit)
