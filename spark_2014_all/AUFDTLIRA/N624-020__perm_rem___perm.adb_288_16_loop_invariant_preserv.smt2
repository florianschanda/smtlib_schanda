...
(assert (and (= o (extended_perm aa bb)) (and (in_range3 o) (=> (= (of_int o) true) (forall ((ia4 Int)) (=> (and (<= (to_rep2 (first (rt aa))) ia4) (<= ia4 (to_rep2 (last (rt aa))))) (exists ((ib1 Int)) (and (and (<= (to_rep2 (first (rt bb))) ib1) (<= ib1 (to_rep2 (last (rt bb))))) (and (= (to_rep (select (elts aa) ia4)) (to_rep (select (elts bb) ib1))) (= (is_perm (remove aa ia4) (remove bb ib1)) true))))))))))
...
(assert (exists ((ib1 Int)) (and (and (<= (to_rep2 (first (rt b))) ib1) (<= ib1 (to_rep2 (last (rt b))))) (and (= (to_rep (select (elts a) ia1)) (to_rep (select (elts b) ib1))) (= (is_perm (remove a ia1) (remove b ib1)) true)))))
(assert (=> (<= (to_rep2 (first (rt a))) (to_rep2 (last (rt a)))) (dynamic_property1 (to_rep2 (first (rt a))) (to_rep2 (last (rt a))) ia1)))
(assert (forall ((k Int)) (=> (and (<= 1 k) (<= k ia2)) (exists ((ib1 Int)) (and (and (<= (to_rep2 (first (rt b))) ib1) (<= ib1 (to_rep2 (last (rt b))))) (and (= (to_rep (select (elts a) k)) (to_rep (select (elts b) ib1))) (= (is_perm (remove a k) (remove b ib1)) true)))))))
(assert (and (and (and (=> (<= 1 1) (in_range3 ih2)) (=> (<= (to_rep2 (first (rt a))) (to_rep2 (last (rt a)))) (dynamic_property1 (to_rep2 (first (rt a))) (to_rep2 (last (rt a))) ia2))) (=> (<= 1 100) (in_range4 ib))) (and (<= (to_rep2 (first (rt a))) ia2) (<= ia2 (to_rep2 (last (rt a)))))))
(assert (not (= ia2 (to_rep2 (last (rt a))))))
(assert (= result2 (mk_int__ref ia2)))
(assert (= ia3 (+ ia2 1)))
(assert (exists ((ib1 Int)) (and (and (<= (to_rep2 (first (rt b))) ib1) (<= ib1 (to_rep2 (last (rt b))))) (and (= (to_rep (select (elts a) ia3)) (to_rep (select (elts b) ib1))) (= (is_perm (remove a ia3) (remove b ib1)) true)))))
(assert (=> (<= (to_rep2 (first (rt a))) (to_rep2 (last (rt a)))) (dynamic_property1 (to_rep2 (first (rt a))) (to_rep2 (last (rt a))) ia3)))
(declare-const k Int)
(assert (<= 1 k))
(assert (<= k ia3))
(assert (not (exists ((ib1 Int)) (and (and (<= (to_rep2 (first (rt b))) ib1) (<= ib1 (to_rep2 (last (rt b))))) (and (= (to_rep (select (elts a) k)) (to_rep (select (elts b) ib1))) (= (is_perm (remove a k) (remove b ib1)) true))))))
(check-sat)
(exit)
