...
(assert (not (= ia4 (to_rep2 (last (rt a))))))
(assert (= result24 (mk_int__ref ia4)))
(assert (= ia5 (+ ia4 1)))
(assert (exists ((ib29 Int)) (and (and (<= (to_rep2 (first (rt b))) ib29) (<= ib29 (to_rep2 (last (rt b))))) (and (= (to_rep (select (elts a) ia5)) (to_rep (select (elts b) ib29))) (= (is_perm (remove a ia5) (remove b ib29)) true)))))
(assert (=> (<= (to_rep2 (first (rt a))) (to_rep2 (last (rt a)))) (dynamic_property1 (to_rep2 (first (rt a))) (to_rep2 (last (rt a))) ia5)))
(declare-const k1 Int)
(assert (<= 1 k1))
(assert (<= k1 ia5))
(assert (not (exists ((ib29 Int)) (and (and (<= (to_rep2 (first (rt b))) ib29) (<= ib29 (to_rep2 (last (rt b))))) (and (= (to_rep (select (elts a) k1)) (to_rep (select (elts b) ib29))) (= (is_perm (remove a k1) (remove b ib29)) true))))))
(check-sat)
(exit)
