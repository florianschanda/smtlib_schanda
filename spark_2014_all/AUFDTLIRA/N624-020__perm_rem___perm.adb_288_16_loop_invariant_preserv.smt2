...
(assert (and (= o (extended_perm aa bb)) (and (in_range3 o) (=> (= (distinct o 0) true) (forall ((ia4 Int)) (=> (and (<= (to_rep2 (first (rt aa))) ia4) (<= ia4 (to_rep2 (last (rt aa))))) (exists ((ib1 Int)) (and (and (<= (to_rep2 (first (rt bb))) ib1) (<= ib1 (to_rep2 (last (rt bb))))) (and (= (to_rep (select (elts aa) ia4)) (to_rep (select (elts bb) ib1))) (= (is_perm (remove aa ia4) (remove bb ib1)) true))))))))))
