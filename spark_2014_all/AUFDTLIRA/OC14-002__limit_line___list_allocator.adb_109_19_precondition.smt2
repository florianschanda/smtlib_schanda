...
(assert (=> (= result13 true) (and (= o60 (length (rec__list_allocator__m__t__available model____split_fields4))) (in_range6 o60))))
(assert (=> (= result13 true) (= result14 (ite (< j o60) true false))))
(assert (=> (= result13 true) (=> (= result14 true) (and (= o61 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result13 true) (=> (= result14 true) (and (= o62 (get (rec__list_allocator__m__t__available model____split_fields4) o61)) (in_range7 o62)))))
(assert (=> (= result13 true) (=> (not (= result14 true)) (= o62 0))))
(assert (=> (= result13 true) (and (= temp___398 (get (rec__list_allocator__m__t__available model____split_fields4) j)) (in_range7 temp___398))))
(assert (=> (= result13 true) (and (<= 1 temp___398) (<= temp___398 3))))
(assert (=> (= result13 true) (= o56 temp___398)))
(assert (=> (= result13 true) (= o57 (select data4 o56))))
(assert (=> (= result13 true) (= o58 (us_split_fields1 o57))))
(assert (=> (= result13 true) (= o59 (rec__list_allocator__cell__next o58))))
(assert (=> (= result13 true) (= o63 (to_rep o59))))
(assert (=> (= result13 true) (= result12 (ite (= o63 o62) true false))))
(assert (=> (not (= result13 true)) (= result12 false)))
(assert (= result12 true))
(assert (=> (< 1 j) (and (= o53 (- j 1)) (in_range2 (- j 1)))))
(assert (=> (< 1 j) (and (= o54 (get (rec__list_allocator__m__t__available model____split_fields4) o53)) (in_range7 o54))))
(assert (=> (not (< 1 j)) (= o54 0)))
(assert (not (<= 1 j)))
(check-sat)
(exit)
