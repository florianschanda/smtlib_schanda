...
(assert (and (= o55 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (in_range7 o55)))
(assert (= result12 (ite (in_range4 o55) true false)))
(assert (=> (= result12 true) (and (= o51 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range6 o51))))
(assert (=> (= result12 true) (= result13 (ite (< j o51) true false))))
(assert (=> (= result12 true) (=> (= result13 true) (and (= o52 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result12 true) (=> (= result13 true) (and (= o53 (get (rec__list_allocator__m__t__available model____split_fields3) o52)) (in_range7 o53)))))
...
(assert (=> (= result12 true) (= o47 temp___431)))
...
(assert (=> (< 1 j) (and (= o46 (get (rec__list_allocator__m__t__available model____split_fields3) o45)) (in_range7 o46))))
