...
(assert (= hr15 o132))
(assert (= (let ((temp___231 (remove (remove (mk___t values2 (mk 1 100)) x) (- y 1)))) (let ((temp___230 (remove (remove (mk___t interm1 (mk 1 100)) x) (- y 1)))) (bool_eq (elts temp___230) (to_rep1 (first (rt temp___230))) (to_rep1 (last (rt temp___230))) (elts temp___231) (to_rep1 (first (rt temp___231))) (to_rep1 (last (rt temp___231)))))) true))
(assert (and (= o143 (- y 1)) (in_range5 (- y 1))))
(assert (and (= o141 x) (in_range5 x)))
(assert (and (= o142 (remove (mk___t interm1 (mk 1 100)) o141)) (and (dynamic_invariant4 o142 true false true) (and (= (invariant__ o142) true) (and (= (to_rep1 (last (rt o142))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o141 1))) (= (to_rep (select interm1 k)) (to_rep (select (elts o142) k))))) (and (forall ((k Int)) (=> (and (<= (+ o141 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select interm1 k)) (to_rep (select (elts o142) (- k 1)))))) (forall ((k Int)) (=> (and (<= o141 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select interm1 (+ k 1))) (to_rep (select (elts o142) k))))))))))))
(assert (and (= o139 x) (in_range5 x)))
(assert (and (= o140 (remove (mk___t init (mk 1 100)) o139)) (and (dynamic_invariant4 o140 true false true) (and (= (invariant__ o140) true) (and (= (to_rep1 (last (rt o140))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o139 1))) (= (to_rep (select init k)) (to_rep (select (elts o140) k))))) (and (forall ((k Int)) (=> (and (<= (+ o139 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select init k)) (to_rep (select (elts o140) (- k 1)))))) (forall ((k Int)) (=> (and (<= o139 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select init (+ k 1))) (to_rep (select (elts o140) k))))))))))))
(assert (and (= o144 (remove_eq o140 o142 o143)) (and (in_range4 o144) (=> (= (of_int o144) true) (= (let ((temp___163 (remove o142 o143))) (let ((temp___162 (remove o140 o143))) (bool_eq (elts temp___162) (to_rep1 (first (rt temp___162))) (to_rep1 (last (rt temp___162))) (elts temp___163) (to_rep1 (first (rt temp___163))) (to_rep1 (last (rt temp___163)))))) true)))))
(assert (= result15 (mk_int__ref hr15)))
(assert (= hr16 o144))
(assert (and (= o147 (- y 1)) (in_range5 (- y 1))))
(assert (and (= o145 x) (in_range5 x)))
(assert (and (= o146 (remove (mk___t values2 (mk 1 100)) o145)) (and (dynamic_invariant4 o146 true false true) (and (= (invariant__ o146) true) (and (= (to_rep1 (last (rt o146))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o145 1))) (= (to_rep (select values2 k)) (to_rep (select (elts o146) k))))) (and (forall ((k Int)) (=> (and (<= (+ o145 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select (elts o146) (- k 1)))))) (forall ((k Int)) (=> (and (<= o145 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts o146) k))))))))))))
(assert (and (= temp___237 (remove o146 o147)) (and (dynamic_invariant4 temp___237 true false true) (and (= (invariant__ temp___237) true) (and (= (to_rep1 (last (rt temp___237))) (- (to_rep1 (last (rt o146))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o147 1))) (= (to_rep (select (elts o146) k)) (to_rep (select (elts temp___237) k))))) (and (forall ((k Int)) (=> (and (<= (+ o147 1) k) (<= k (to_rep1 (last (rt o146))))) (= (to_rep (select (elts o146) k)) (to_rep (select (elts temp___237) (- k 1)))))) (forall ((k Int)) (=> (and (<= o147 k) (<= k (- (to_rep1 (last (rt o146))) 1))) (= (to_rep (select (elts o146) (+ k 1))) (to_rep (select (elts temp___237) k))))))))))))
(assert (and (= o150 (- y 1)) (in_range5 (- y 1))))
(assert (and (= o148 x) (in_range5 x)))
