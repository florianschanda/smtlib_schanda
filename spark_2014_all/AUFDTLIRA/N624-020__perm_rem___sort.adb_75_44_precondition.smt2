...
(assert (and (= o28 (remove (mk___t interm1 (mk 1 100)) o27)) (and (dynamic_invariant4 o28 true false true) (and (= (invariant__ o28) true) (and (= (to_rep1 (last (rt o28))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o27 1))) (= (to_rep (select interm1 k)) (to_rep (select (elts o28) k))))) (and (forall ((k Int)) (=> (and (<= (+ o27 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select interm1 k)) (to_rep (select (elts o28) (- k 1)))))) (forall ((k Int)) (=> (and (<= o27 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select interm1 (+ k 1))) (to_rep (select (elts o28) k))))))))))))
(assert (and (= o25 x) (in_range5 x)))
(assert (and (= o26 (remove (mk___t init (mk 1 100)) o25)) (and (dynamic_invariant4 o26 true false true) (and (= (invariant__ o26) true) (and (= (to_rep1 (last (rt o26))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o25 1))) (= (to_rep (select init k)) (to_rep (select (elts o26) k))))) (and (forall ((k Int)) (=> (and (<= (+ o25 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select init k)) (to_rep (select (elts o26) (- k 1)))))) (forall ((k Int)) (=> (and (<= o25 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select init (+ k 1))) (to_rep (select (elts o26) k))))))))))))
(assert (and (= o30 (remove_eq o26 o28 o29)) (and (in_range4 o30) (=> (= (of_int o30) true) (= (let ((temp___163 (remove o28 o29))) (let ((temp___162 (remove o26 o29))) (bool_eq (elts temp___162) (to_rep1 (first (rt temp___162))) (to_rep1 (last (rt temp___162))) (elts temp___163) (to_rep1 (first (rt temp___163))) (to_rep1 (last (rt temp___163)))))) true)))))
(assert (= result7 (mk_int__ref hr4)))
(assert (= hr5 o30))
(assert (and (= o33 (- y 1)) (in_range5 (- y 1))))
(assert (and (= o31 x) (in_range5 x)))
(assert (and (= o32 (remove (mk___t values2 (mk 1 100)) o31)) (and (dynamic_invariant4 o32 true false true) (and (= (invariant__ o32) true) (and (= (to_rep1 (last (rt o32))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o31 1))) (= (to_rep (select values2 k)) (to_rep (select (elts o32) k))))) (and (forall ((k Int)) (=> (and (<= (+ o31 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select (elts o32) (- k 1)))))) (forall ((k Int)) (=> (and (<= o31 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts o32) k))))))))))))
(assert (and (= temp___237 (remove o32 o33)) (and (dynamic_invariant4 temp___237 true false true) (and (= (invariant__ temp___237) true) (and (= (to_rep1 (last (rt temp___237))) (- (to_rep1 (last (rt o32))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o33 1))) (= (to_rep (select (elts o32) k)) (to_rep (select (elts temp___237) k))))) (and (forall ((k Int)) (=> (and (<= (+ o33 1) k) (<= k (to_rep1 (last (rt o32))))) (= (to_rep (select (elts o32) k)) (to_rep (select (elts temp___237) (- k 1)))))) (forall ((k Int)) (=> (and (<= o33 k) (<= k (- (to_rep1 (last (rt o32))) 1))) (= (to_rep (select (elts o32) (+ k 1))) (to_rep (select (elts temp___237) k))))))))))))
(assert (and (= o35 (- y 1)) (in_range5 (- y 1))))
