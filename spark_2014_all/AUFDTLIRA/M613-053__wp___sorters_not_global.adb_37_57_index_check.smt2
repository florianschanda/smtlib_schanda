...
(assert (=> (and (<= (+ starting_at 1) index1) (<= index1 limit)) (and (and (= temp___175 index1) (and (= temp___174 min1) (and (= temp___176 limit) (and (and (and (and (= limit temp___176) (<= starting_at min2)) (<= min2 limit)) (forall ((j2 Int)) (=> (and (<= starting_at j2) (<= j2 (- index2 1))) (<= (to_rep (select values min2)) (to_rep (select values j2)))))) (and (and (and (=> (<= 1 64) (in_range2 min2)) (=> (<= (+ starting_at 1) limit) (dynamic_property (+ starting_at 1) limit index2))) (and (<= (+ starting_at 1) index2) (<= index2 limit))) (and (ite (< (to_rep (select values index2)) (to_rep (select values min2))) (and (= min2 result3) (= min3 index2)) (= min3 min2)) (= index2 limit))))))) (and (and (= index2 index6) (= min3 min6)) (and (= index7 index2) (= min7 min3))))))
(assert (=> (and (<= (+ starting_at 1) index1) (<= index1 limit)) (= (mk_int__ref index8) (mk_int__ref index6))))
(assert (=> (and (<= (+ starting_at 1) index1) (<= index1 limit)) (= (mk_int__ref min8) (mk_int__ref min6))))
(assert (=> (and (<= (+ starting_at 1) index1) (<= index1 limit)) (= index9 index7)))
(assert (=> (and (<= (+ starting_at 1) index1) (<= index1 limit)) (= min9 min7)))
(assert (=> (not (and (<= (+ starting_at 1) index1) (<= index1 limit))) (= index1 index8)))
(assert (=> (not (and (<= (+ starting_at 1) index1) (<= index1 limit))) (= min1 min8)))
(assert (=> (not (and (<= (+ starting_at 1) index1) (<= index1 limit))) (= index9 index1)))
(assert (=> (not (and (<= (+ starting_at 1) index1) (<= index1 limit))) (= min9 min1)))
...
(assert (= (mk_int__ref result5) (mk_int__ref sorters_not_global__index_of_minimum__result)))
(assert (= sorters_not_global__index_of_minimum__result1 min8))
