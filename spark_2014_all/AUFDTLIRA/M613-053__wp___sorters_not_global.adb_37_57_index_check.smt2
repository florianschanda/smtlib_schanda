...
(assert (=> (and (<= (+ starting_at 1) index1) (<= index1 limit)) (= temp___175 index1)))
(assert (=> (and (<= (+ starting_at 1) index1) (<= index1 limit)) (= temp___174 min1)))
(assert (=> (and (<= (+ starting_at 1) index1) (<= index1 limit)) (= temp___176 limit)))
(assert (=> (and (<= (+ starting_at 1) index1) (<= index1 limit)) (and (and (and (= limit temp___176) (<= starting_at min2)) (<= min2 limit)) (forall ((j1 Int)) (=> (and (<= starting_at j1) (<= j1 (- index2 1))) (<= (to_rep (select values min2)) (to_rep (select values j1))))))))
