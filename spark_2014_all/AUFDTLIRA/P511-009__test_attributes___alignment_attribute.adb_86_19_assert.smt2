...
(assert (= int__ 2))
(assert (forall ((temp___272 Int)) (=> (dynamic_invariant5 temp___272 true true true true) (forall ((temp___273 Int)) (= (to_rep3 (select (alignment_attribute__ca__aggregate_def temp___272) temp___273)) temp___272)))))
(assert (forall ((temp___269 Int)) (=> (dynamic_invariant4 temp___269 true true true true) (forall ((temp___270 Int)) (= (to_rep4 (select (alignment_attribute__ua__aggregate_def temp___269) temp___270)) temp___269)))))
