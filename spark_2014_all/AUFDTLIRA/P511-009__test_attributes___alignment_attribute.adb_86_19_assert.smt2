...
(define-fun dynamic_invariant1 ((temp___expr_139 Int) (temp___is_init_136 Bool) (temp___skip_constant_137 Bool) (temp___do_toplevel_138 Bool)) Bool (=> (or (= temp___is_init_136 true) (<= 1 10)) (in_range4 temp___expr_139)))
(declare-sort r1 0)
...
(assert (forall ((x my_integer)) (! (= (of_rep2 (to_rep2 x)) x) :pattern ((to_rep2 x)))))
(assert (forall ((x my_integer)) (! (in_range4 (to_rep2 x)) :pattern ((to_rep2 x)))))
(assert (forall ((x Int)) (! (=> (in_range4 x) (= (to_rep2 (of_rep2 x)) x)) :pattern ((to_rep2 (of_rep2 x))))))
(declare-datatypes () ((us_split_discrs (mk___split_discrs (rec__alignment_attribute__r2__d1 my_integer)))))
(define-fun us_split_discrs___projection ((a us_split_discrs)) my_integer (rec__alignment_attribute__r2__d1 a))
(declare-datatypes () ((us_split_discrs__ref (mk___split_discrs__ref (us_split_discrs__content us_split_discrs)))))
(define-fun us_split_discrs__ref___projection ((a us_split_discrs__ref)) us_split_discrs (us_split_discrs__content a))
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__alignment_attribute__r2__d2 Bool)))))
(define-fun us_split_fields_D2__projection ((a us_split_fields)) Bool (rec__alignment_attribute__r2__d2 a))
...
(define-fun alignment_attribute__r2__d2__pred ((a us_rep)) Bool (= (to_rep2 (rec__alignment_attribute__r2__d1 (us_split_discrs1 a))) 5))
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep2 (rec__alignment_attribute__r2__d1 (us_split_discrs1 a))) (to_rep2 (rec__alignment_attribute__r2__d1 (us_split_discrs1 b)))) (=> (alignment_attribute__r2__d2__pred a) (= (rec__alignment_attribute__r2__d2 (us_split_fields1 a)) (rec__alignment_attribute__r2__d2 (us_split_fields1 b))))) true false))
...
(assert (< alignment_attribute__r2__d1__first__bit alignment_attribute__r2__d1__last__bit))
...
(assert (< alignment_attribute__r2__d2__first__bit alignment_attribute__r2__d2__last__bit))
...
(define-fun in_range5 ((rec__alignment_attribute__r2__d11 Int) (a us_rep)) Bool (= rec__alignment_attribute__r2__d11 (to_rep2 (rec__alignment_attribute__r2__d1 (us_split_discrs1 a)))))
...
(assert (< alignment_attribute__r2__d1__first__bit1 alignment_attribute__r2__d1__last__bit1))
...
(assert (< alignment_attribute__r2__d2__first__bit1 alignment_attribute__r2__d2__last__bit1))
...
(define-fun dynamic_invariant2 ((temp___expr_160 us_rep) (temp___is_init_157 Bool) (temp___skip_constant_158 Bool) (temp___do_toplevel_159 Bool)) Bool (and (=> (not (= temp___skip_constant_158 true)) (in_range5 5 temp___expr_160)) (= (attr__constrained temp___expr_160) true)))
(define-fun default_initial_assumption ((temp___expr_162 us_rep) (temp___skip_top_level_163 Bool)) Bool (and (= (attr__constrained temp___expr_162) true) (= (to_rep2 (rec__alignment_attribute__r2__d1 (us_split_discrs1 temp___expr_162))) 5)))
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__alignment_attribute__r3__i integer) (rec__ext__ us_private)))))
(define-fun us_split_fields_I__projection ((a us_split_fields2)) integer (rec__alignment_attribute__r3__i a))
...
(define-fun bool_eq3 ((a us_rep1) (b us_rep1)) Bool (ite (= (to_rep1 (rec__alignment_attribute__r3__i (us_split_fields3 a))) (to_rep1 (rec__alignment_attribute__r3__i (us_split_fields3 b)))) true false))
...
(assert (< alignment_attribute__r3__i__first__bit alignment_attribute__r3__i__last__bit))
...
(define-fun default_initial_assumption1 ((temp___expr_170 us_rep1) (temp___skip_top_level_171 Bool)) Bool (= (attr__tag temp___expr_170) us_tag))
(declare-datatypes () ((us_split_fields4 (mk___split_fields2 (rec__alignment_attribute__r4__j integer) (rec__alignment_attribute__r3__i1 integer) (rec__ext__1 us_private)))))
(define-fun us_split_fields_J__projection ((a us_split_fields4)) integer (rec__alignment_attribute__r4__j a))
(define-fun us_split_fields_I__2__projection ((a us_split_fields4)) integer (rec__alignment_attribute__r3__i1 a))
...
(define-fun to_base ((a us_rep2)) us_rep1 (mk___rep1 (mk___split_fields1 (rec__alignment_attribute__r3__i1 (us_split_fields5 a)) (hide_ext__ (rec__alignment_attribute__r4__j (us_split_fields5 a)) (rec__ext__1 (us_split_fields5 a)))) (attr__tag1 a)))
(define-fun of_base ((r us_rep1)) us_rep2 (mk___rep2 (mk___split_fields2 (extract__j (rec__ext__ (us_split_fields3 r))) (rec__alignment_attribute__r3__i (us_split_fields3 r)) (extract__ext__ (rec__ext__ (us_split_fields3 r)))) (attr__tag r)))
(define-fun bool_eq4 ((a us_rep2) (b us_rep2)) Bool (ite (and (= (to_rep1 (rec__alignment_attribute__r4__j (us_split_fields5 a))) (to_rep1 (rec__alignment_attribute__r4__j (us_split_fields5 b)))) (= (to_rep1 (rec__alignment_attribute__r3__i1 (us_split_fields5 a))) (to_rep1 (rec__alignment_attribute__r3__i1 (us_split_fields5 b))))) true false))
...
(assert (< alignment_attribute__r4__j__first__bit alignment_attribute__r4__j__last__bit))
...
(assert (< alignment_attribute__r3__i__first__bit1 alignment_attribute__r3__i__last__bit1))
...
(define-fun default_initial_assumption2 ((temp___expr_181 us_rep2) (temp___skip_top_level_182 Bool)) Bool (= (attr__tag1 temp___expr_181) us_tag1))
...
(define-fun bool_eq5 ((a (Array Int positive)) (a__first Int) (a__last Int) (b (Array Int positive)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_132 Int)) (=> (and (<= a__first temp___idx_132) (<= temp___idx_132 a__last)) (= (to_rep3 (select a temp___idx_132)) (to_rep3 (select b (+ (- b__first a__first) temp___idx_132))))))) true false))
(assert (forall ((a (Array Int positive)) (b (Array Int positive))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq5 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_132 Int)) (=> (and (<= a__first temp___idx_132) (<= temp___idx_132 a__last)) (= (to_rep3 (select a temp___idx_132)) (to_rep3 (select b (+ (- b__first a__first) temp___idx_132)))))))))))
(declare-fun compare1 ((Array Int positive) Int Int (Array Int positive) Int Int) Int)
(assert (forall ((a (Array Int positive)) (b (Array Int positive))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare1 a a_first a_last b b_first b_last) 0) (= (bool_eq5 a a_first a_last b b_first b_last) true)) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int positive)) (b (Array Int positive))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare1 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq5 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep3 (select a (+ i 1))) (to_rep3 (select b (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int positive)) (b (Array Int positive))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare1 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq5 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep3 (select b (+ i 1))) (to_rep3 (select a (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
...
(assert (forall ((a (Array Int natural))) (forall ((first2 Int)) (! (= (slide2 a first2 first2) a) :pattern ((slide2 a first2 first2))))))
...
(define-fun bool_eq6 ((a (Array Int natural)) (a__first Int) (a__last Int) (b (Array Int natural)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_133 Int)) (=> (and (<= a__first temp___idx_133) (<= temp___idx_133 a__last)) (= (to_rep4 (select a temp___idx_133)) (to_rep4 (select b (+ (- b__first a__first) temp___idx_133))))))) true false))
(assert (forall ((a (Array Int natural)) (b (Array Int natural))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq6 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_133 Int)) (=> (and (<= a__first temp___idx_133) (<= temp___idx_133 a__last)) (= (to_rep4 (select a temp___idx_133)) (to_rep4 (select b (+ (- b__first a__first) temp___idx_133)))))))))))
(declare-fun compare2 ((Array Int natural) Int Int (Array Int natural) Int Int) Int)
(assert (forall ((a (Array Int natural)) (b (Array Int natural))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare2 a a_first a_last b b_first b_last) 0) (= (bool_eq6 a a_first a_last b b_first b_last) true)) :pattern ((compare2 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int natural)) (b (Array Int natural))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare2 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq6 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep4 (select a (+ i 1))) (to_rep4 (select b (+ j 1))))))))))) :pattern ((compare2 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int natural)) (b (Array Int natural))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare2 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq6 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep4 (select b (+ i 1))) (to_rep4 (select a (+ j 1))))))))))) :pattern ((compare2 a a_first a_last b b_first b_last))))))
(declare-sort t1 0)
...
(declare-datatypes () ((unconstr_array__ref (mk_unconstr_array__ref (unconstr_array__content us_t1)))))
(define-fun unconstr_array__ref___projection ((a unconstr_array__ref)) us_t1 (unconstr_array__content a))
...
(define-fun in_range7 ((rec__alignment_attribute__r2__d11 Int) (a us_rep)) Bool (= rec__alignment_attribute__r2__d11 (to_rep2 (rec__alignment_attribute__r2__d1 (us_split_discrs1 a)))))
...
(assert (< alignment_attribute__r2__d1__first__bit2 alignment_attribute__r2__d1__last__bit2))
...
(assert (< alignment_attribute__r2__d2__first__bit2 alignment_attribute__r2__d2__last__bit2))
...
(define-fun trt2S__ref___projection ((a trt2S__ref)) us_rep (trt2S__content a))
(define-fun dynamic_invariant3 ((temp___expr_206 us_rep) (temp___is_init_203 Bool) (temp___skip_constant_204 Bool) (temp___do_toplevel_205 Bool)) Bool (and (=> (not (= temp___skip_constant_204 true)) (in_range7 3 temp___expr_206)) (= (attr__constrained temp___expr_206) true)))
(define-fun default_initial_assumption3 ((temp___expr_208 us_rep) (temp___skip_top_level_209 Bool)) Bool (and (= (attr__constrained temp___expr_208) true) (= (to_rep2 (rec__alignment_attribute__r2__d1 (us_split_discrs1 temp___expr_208))) 3)))
...
(assert (forall ((temp___243 Int)) (forall ((temp___244 Int)) (= (select (alignment_attribute__ua__aggregate_def temp___243) temp___244) (of_rep4 temp___243)))))
(declare-fun alignment_attribute__ca__aggregate_def (Int) (Array Int positive))
(assert (forall ((temp___246 Int)) (forall ((temp___247 Int)) (= (select (alignment_attribute__ca__aggregate_def temp___246) temp___247) (of_rep3 temp___246)))))
(declare-fun temp___String_Literal_259 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (= (to_rep (select (temp___String_Literal_259 us_void_param) 1)) 116) (= (to_rep (select (temp___String_Literal_259 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_259 us_void_param) 3)) 115)) (= (to_rep (select (temp___String_Literal_259 us_void_param) 4)) 116)) :pattern ((temp___String_Literal_259 us_void_param)))))
...
(define-fun default_initial_assumption4 ((temp___expr_153 us_rep) (temp___skip_top_level_154 Bool)) Bool (and (= (attr__constrained temp___expr_153) false) (= (to_rep2 (rec__alignment_attribute__r2__d1 (us_split_discrs1 temp___expr_153))) 1)))
(define-fun dynamic_invariant8 ((temp___expr_201 us_t1) (temp___is_init_198 Bool) (temp___skip_constant_199 Bool) (temp___do_toplevel_200 Bool)) Bool (=> (not (= temp___skip_constant_199 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_201) (last3 temp___expr_201))))
(assert (= int__ 2))
(declare-const b Bool)
(declare-const s (Array Int character))
(declare-const m Int)
(declare-const rt11 r1)
(declare-const rt2__split_fields Bool)
(declare-const rst2__split_fields Bool)
(declare-const rt3__split_fields integer)
(declare-const rt3__split_fields1 us_private)
(declare-const rt4__split_fields integer)
(declare-const rt4__split_fields1 integer)
(declare-const rt4__split_fields2 us_private)
...
(assert (and (= rt2__attr__constrained true) (= (to_rep2 (rec__alignment_attribute__r2__d1 rt2__split_discrs)) 3)))
(assert (and (= 3 (to_rep2 (rec__alignment_attribute__r2__d1 rt2__split_discrs))) (= rt2__attr__constrained true)))
(assert (and (= rst2__attr__constrained true) (= (to_rep2 (rec__alignment_attribute__r2__d1 rst2__split_discrs)) 5)))
(assert (and (= 5 (to_rep2 (rec__alignment_attribute__r2__d1 rst2__split_discrs))) (= rst2__attr__constrained true)))
...
(assert (<= 0 1))
(assert (<= 0 4))
(assert (<= 0 (object__alignment1 rt11)))
(assert (<= 0 (object__alignment8 (mk___rep rt2__split_discrs (mk___split_fields rt2__split_fields) rt2__attr__constrained))))
(assert (not (<= 0 (object__alignment3 (mk___rep rst2__split_discrs (mk___split_fields rst2__split_fields) rst2__attr__constrained)))))
(check-sat)
(exit)
