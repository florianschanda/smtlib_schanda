...
(assert (forall ((i my_integer)) (and (<= 1 (my_integerqtint i)) (<= (my_integerqtint i) 10))))
...
(define-fun dynamic_invariant1 ((temp___expr_162 Int) (temp___is_init_158 Bool) (temp___skip_constant_159 Bool) (temp___do_toplevel_160 Bool) (temp___do_typ_inv_161 Bool)) Bool (=> (or (= temp___is_init_158 true) (<= 1 10)) (in_range4 temp___expr_162)))
(declare-sort r1 0)
...
(define-fun to_rep2 ((x my_integer)) Int (my_integerqtint x))
...
(define-fun dynamic_invariant2 ((temp___expr_186 us_rep) (temp___is_init_182 Bool) (temp___skip_constant_183 Bool) (temp___do_toplevel_184 Bool) (temp___do_typ_inv_185 Bool)) Bool (and (=> (not (= temp___skip_constant_183 true)) (in_range5 5 temp___expr_186)) (= (attr__constrained temp___expr_186) true)))
(define-fun default_initial_assumption ((temp___expr_188 us_rep) (temp___skip_top_level_189 Bool)) Bool (and (= (attr__constrained temp___expr_188) true) (= (to_rep2 (rec__alignment_attribute__r2__d1 (us_split_discrs1 temp___expr_188))) 5)))
...
(define-fun default_initial_assumption1 ((temp___expr_197 us_rep1) (temp___skip_top_level_198 Bool)) Bool (= (attr__tag temp___expr_197) us_tag))
...
(define-fun default_initial_assumption2 ((temp___expr_205 us_rep2) (temp___skip_top_level_206 Bool)) Bool (= (attr__tag1 temp___expr_205) us_tag1))
...
(define-fun bool_eq5 ((a (Array Int positive)) (a__first Int) (a__last Int) (b (Array Int positive)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (to_rep3 (select a temp___idx_154)) (to_rep3 (select b (+ (- b__first a__first) temp___idx_154))))))) true false))
(assert (forall ((a (Array Int positive)) (b (Array Int positive))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq5 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (to_rep3 (select a temp___idx_154)) (to_rep3 (select b (+ (- b__first a__first) temp___idx_154)))))))))))
...
(define-fun bool_eq6 ((a (Array Int natural)) (a__first Int) (a__last Int) (b (Array Int natural)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_155 Int)) (=> (and (<= a__first temp___idx_155) (<= temp___idx_155 a__last)) (= (to_rep4 (select a temp___idx_155)) (to_rep4 (select b (+ (- b__first a__first) temp___idx_155))))))) true false))
(assert (forall ((a (Array Int natural)) (b (Array Int natural))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq6 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_155 Int)) (=> (and (<= a__first temp___idx_155) (<= temp___idx_155 a__last)) (= (to_rep4 (select a temp___idx_155)) (to_rep4 (select b (+ (- b__first a__first) temp___idx_155)))))))))))
(declare-sort t1 0)
...
(define-fun dynamic_invariant3 ((temp___expr_229 us_rep) (temp___is_init_225 Bool) (temp___skip_constant_226 Bool) (temp___do_toplevel_227 Bool) (temp___do_typ_inv_228 Bool)) Bool (and (=> (not (= temp___skip_constant_226 true)) (in_range7 3 temp___expr_229)) (= (attr__constrained temp___expr_229) true)))
(define-fun default_initial_assumption3 ((temp___expr_231 us_rep) (temp___skip_top_level_232 Bool)) Bool (and (= (attr__constrained temp___expr_231) true) (= (to_rep2 (rec__alignment_attribute__r2__d1 (us_split_discrs1 temp___expr_231))) 3)))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (= (to_rep (select (temp___String_Literal_285 us_void_param) 1)) 116) (= (to_rep (select (temp___String_Literal_285 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_285 us_void_param) 3)) 115)) (= (to_rep (select (temp___String_Literal_285 us_void_param) 4)) 116)) :pattern ((temp___String_Literal_285 us_void_param)))))
...
(define-fun default_initial_assumption4 ((temp___expr_178 us_rep) (temp___skip_top_level_179 Bool)) Bool (and (= (attr__constrained temp___expr_178) false) (= (to_rep2 (rec__alignment_attribute__r2__d1 (us_split_discrs1 temp___expr_178))) 1)))
(define-fun dynamic_invariant8 ((temp___expr_223 us_t1) (temp___is_init_219 Bool) (temp___skip_constant_220 Bool) (temp___do_toplevel_221 Bool) (temp___do_typ_inv_222 Bool)) Bool (=> (not (= temp___skip_constant_220 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_223) (last3 temp___expr_223))))
(assert (= int__ 2))
(declare-const rliteral positive)
(assert (= (positiveqtint rliteral) 2))
(assert (forall ((temp___272 Int)) (=> (dynamic_invariant5 temp___272 true true true true) (forall ((temp___273 Int)) (= (select (alignment_attribute__ca__aggregate_def temp___272) temp___273) rliteral)))))
(declare-const rliteral1 natural)
(assert (= (naturalqtint rliteral1) 1))
(assert (forall ((temp___269 Int)) (=> (dynamic_invariant4 temp___269 true true true true) (forall ((temp___270 Int)) (= (select (alignment_attribute__ua__aggregate_def temp___269) temp___270) rliteral1)))))
...
(assert (= result b))
(assert (= b1 (distinct 1 0)))
(assert (in_range1 int__))
(assert (= result1 s))
(assert (= s1 (temp___String_Literal_285 Tuple0)))
