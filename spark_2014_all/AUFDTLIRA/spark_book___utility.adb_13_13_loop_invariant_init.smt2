...
(assert (exists ((index2 Int)) (and (and (<= 0 index2) (<= index2 1023)) (= (to_rep (select values index2)) 0))))
...
(assert (not (exists ((j Int)) (and (and (<= (+ index1 1) j) (<= j 1023)) (= (to_rep (select values j)) 0)))))
(check-sat)
(exit)
