...
(assert (=> (<= 1 temp___1868) (and (and (<= 1 1) (<= 1 10)) (and (<= 1 temp___1868) (<= temp___1868 10)))))
(assert (= o1 result__1))
(assert (= o1 temp___1869))
(assert (= (mk3 1 temp___1868) temp___18691))
(assert (not (= (ite (<= (to_rep1 (first6 temp___18661)) (to_rep1 (last6 temp___18661))) (+ (- (to_rep1 (last6 temp___18661)) (to_rep1 (first6 temp___18661))) 1) 0) (ite (<= (to_rep1 (first6 temp___18691)) (to_rep1 (last6 temp___18691))) (+ (- (to_rep1 (last6 temp___18691)) (to_rep1 (first6 temp___18691))) 1) 0))))
(check-sat)
(exit)
