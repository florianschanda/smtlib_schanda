...
(declare-const temp___2053 (Array Int character))
(declare-const temp___20531 t3)
...
(assert (=> (<= 1 temp___2052) (and (and (<= 1 1) (<= 1 10)) (and (<= 1 temp___2052) (<= temp___2052 10)))))
(assert (= o1 result__1))
(assert (= o1 temp___2053))
(assert (= (mk3 1 temp___2052) temp___20531))
(assert (not (= (ite (<= (to_rep1 (first6 temp___20501)) (to_rep1 (last6 temp___20501))) (+ (- (to_rep1 (last6 temp___20501)) (to_rep1 (first6 temp___20501))) 1) 0) (ite (<= (to_rep1 (first6 temp___20531)) (to_rep1 (last6 temp___20531))) (+ (- (to_rep1 (last6 temp___20531)) (to_rep1 (first6 temp___20531))) 1) 0))))
(check-sat)
(exit)
