...
(declare-const temp___2060 (Array Int character))
(declare-const temp___20601 t3)
...
(assert (=> (<= 1 temp___2059) (and (and (<= 1 1) (<= 1 10)) (and (<= 1 temp___2059) (<= temp___2059 10)))))
(assert (= o1 result__1))
(assert (= o1 temp___2060))
(assert (= (mk3 1 temp___2059) temp___20601))
(assert (not (= (ite (<= (to_rep1 (first6 temp___20571)) (to_rep1 (last6 temp___20571))) (+ (- (to_rep1 (last6 temp___20571)) (to_rep1 (first6 temp___20571))) 1) 0) (ite (<= (to_rep1 (first6 temp___20601)) (to_rep1 (last6 temp___20601))) (+ (- (to_rep1 (last6 temp___20601)) (to_rep1 (first6 temp___20601))) 1) 0))))
(check-sat)
(exit)
