...
(assert (= i1 0))
(assert (=> (and (<= 0 i1) (<= i1 k1)) (= temp___218 a1)))
(assert (=> (and (<= 0 i1) (<= i1 k1)) (and (forall ((temp___219 Int)) (=> (and (<= 0 temp___219) (<= temp___219 100)) (=> (<= i2 temp___219) (= (select a12 temp___219) (select temp___218 temp___219))))) (and (<= 0 i2) (<= i2 k1)))))
