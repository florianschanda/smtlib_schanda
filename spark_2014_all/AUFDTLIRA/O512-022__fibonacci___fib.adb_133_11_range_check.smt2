...
(assert (= i1 0))
(assert (=> (and (<= 0 i1) (<= i1 k1)) (= temp___195 a1)))
(assert (=> (and (<= 0 i1) (<= i1 k1)) (and (forall ((temp___196 Int)) (=> (and (<= 0 temp___196) (<= temp___196 100)) (=> (<= i2 temp___196) (= (select a12 temp___196) (select temp___195 temp___196))))) (and (<= 0 i2) (<= i2 k1)))))
