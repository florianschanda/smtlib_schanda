...
(assert (= o1 (+ o j2)))
(assert (and (= temp___287 o1) (in_range1 o1)))
(assert (and (<= (to_rep a__first) temp___287) (<= temp___287 (to_rep a__last))))
(assert (= o2 temp___287))
(assert (= o3 (select a o2)))
(assert (= o4 (to_rep o3)))
(assert (and (= temp___286 (+ a_first i2)) (in_range1 (+ a_first i2))))
(assert (not (<= (to_rep a__first) temp___286)))
(check-sat)
(exit)
