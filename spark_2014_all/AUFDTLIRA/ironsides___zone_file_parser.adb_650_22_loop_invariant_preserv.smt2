...
(assert (and (= temp___1569 o13) (in_range1 o13)))
(assert (and (<= 1 temp___1569) (<= temp___1569 256)))
(assert (= o15 temp___1569))
(assert (= o16 (store rrstring2 o15 o14)))
(assert (= result16 (mk_map__ref rrstring2)))
(assert (= rrstring3 o16))
(assert (not (= i33 r29b)))
(assert (= result17 (mk_int__ref i33)))
(assert (= i34 (+ i33 1)))
