...
(assert (and (= (to_rep (select a1 o)) 0) (forall ((j1 Int)) (=> (and (<= (to_rep a__first) j1) (<= j1 (to_rep a__last))) (=> (not (= o j1)) (= (to_rep (select a1 j1)) (to_rep (select a j1))))))))
(assert (forall ((j1 Int)) (=> (and (<= (to_rep a__first) j1) (<= j1 i2)) (= (to_rep (select a2 j1)) 0))))
