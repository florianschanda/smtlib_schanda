...
(assert (and (and (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 i2)) (=> (<= (- 2147483648) 2147483647) (in_range1 j2))) (= (- i2 j2) r8b2)) (= j2 r9b2)) (= (- j2 1) r12b2)))
...
(assert (= j2 (to_rep (first (rt p)))))
(assert (and (= o11 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= i2 result8))
(assert (= i3 o11))
(assert (not (<= i3 (to_rep next__last))))
(check-sat)
(exit)
