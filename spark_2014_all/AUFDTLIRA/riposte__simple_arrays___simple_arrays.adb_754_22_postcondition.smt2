...
(define-fun dynamic_invariant1 ((temp___expr_137 Int) (temp___is_init_134 Bool) (temp___skip_constant_135 Bool) (temp___do_toplevel_136 Bool)) Bool (=> (or (= temp___is_init_134 true) (<= 0 2)) (in_range1 temp___expr_137)))
...
(assert (= tmp3 tmp1))
(assert (= a4 a2))
(assert (not (not (= (bool_eq a3 0 2 a 0 2) true))))
(check-sat)
(exit)
