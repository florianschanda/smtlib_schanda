...
(assert (and (= (length source) 4) (forall ((index Int)) (=> (and (<= (to_rep1 (first (rt source))) index) (<= index (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index))) true)))))
...
(assert (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 3)))
