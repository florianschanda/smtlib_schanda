...
(assert (=> (= result36 true) (and (<= 0 i6) (<= i6 99))))
(assert (=> (= result36 true) (= o250 i6)))
(assert (=> (= result36 true) (= o251 (select (rec__patience__state__posstack (us_split_fields__content s__split_fields20)) o250))))
(assert (=> (= result36 true) (= temp___651 (to_rep1 o251))))
(assert (=> (= result36 true) (and (<= 0 temp___651) (<= temp___651 99))))
(assert (=> (= result36 true) (= o252 temp___651)))
(assert (=> (= result36 true) (= o253 (select (rec__patience__state__stacksizes (us_split_fields__content s__split_fields20)) o252))))
(assert (=> (= result36 true) (= o254 (to_rep1 o253))))
(assert (=> (= result36 true) (= o255 (- o254 1))))
(assert (=> (= result36 true) (and (<= 0 i6) (<= i6 99))))
(assert (=> (= result36 true) (= o248 i6)))
(assert (=> (= result36 true) (= o249 (select (rec__patience__state__posheight (us_split_fields__content s__split_fields20)) o248))))
(assert (=> (= result36 true) (= o256 (to_rep1 o249))))
(assert (=> (= result36 true) (= o257 (ite (<= o256 o255) true false))))
(assert (=> (= result36 true) (and (<= 0 i6) (<= i6 99))))
(assert (=> (= result36 true) (= o245 i6)))
(assert (=> (= result36 true) (= o246 (select (rec__patience__state__posheight (us_split_fields__content s__split_fields20)) o245))))
(assert (=> (= result36 true) (= o247 (to_rep1 o246))))
(assert (=> (= result36 true) (= o258 (ite (<= 0 o247) true false))))
(assert (=> (= result36 true) (= result35 (ite (= o258 true) o257 false))))
(assert (=> (not (= result36 true)) (= result35 false)))
(assert (= result35 true))
(assert (and (<= 0 i6) (<= i6 99)))
(assert (= o240 i6))
(assert (= o241 (select (rec__patience__state__posstack (us_split_fields__content s__split_fields20)) o240)))
(assert (= temp___654 (to_rep1 o241)))
