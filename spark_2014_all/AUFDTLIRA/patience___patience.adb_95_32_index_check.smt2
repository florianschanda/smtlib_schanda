...
(assert (= o124 i1))
(assert (= o125 (select (rec__patience__state__posstack (us_split_fields__content s__split_fields20)) o124)))
(assert (= o126 (to_rep1 o125)))
(assert (= o127 (ite (<= o126 (- (to_rep1 (rec__patience__state__numstacks (us_split_fields__content s__split_fields20))) 1)) true false)))
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o121 i1))
(assert (= o122 (select (rec__patience__state__posstack (us_split_fields__content s__split_fields20)) o121)))
(assert (= o123 (to_rep1 o122)))
(assert (= o128 (ite (<= 0 o123) true false)))
(assert (= result23 (ite (= o128 true) o127 false)))
(assert (=> (= result23 true) (and (<= 0 i1) (<= i1 99))))
(assert (=> (= result23 true) (= o112 i1)))
(assert (=> (= result23 true) (= o113 (select (rec__patience__state__posstack (us_split_fields__content s__split_fields20)) o112))))
(assert (=> (= result23 true) (= temp___651 (to_rep1 o113))))
(assert (=> (= result23 true) (and (<= 0 temp___651) (<= temp___651 99))))
(assert (=> (= result23 true) (= o114 temp___651)))
(assert (=> (= result23 true) (= o115 (select (rec__patience__state__stacksizes (us_split_fields__content s__split_fields20)) o114))))
(assert (=> (= result23 true) (= o116 (to_rep1 o115))))
(assert (=> (= result23 true) (= o117 (- o116 1))))
(assert (=> (= result23 true) (and (<= 0 i1) (<= i1 99))))
(assert (=> (= result23 true) (= o110 i1)))
(assert (=> (= result23 true) (= o111 (select (rec__patience__state__posheight (us_split_fields__content s__split_fields20)) o110))))
(assert (=> (= result23 true) (= o118 (to_rep1 o111))))
(assert (=> (= result23 true) (= o119 (ite (<= o118 o117) true false))))
(assert (=> (= result23 true) (and (<= 0 i1) (<= i1 99))))
(assert (=> (= result23 true) (= o107 i1)))
(assert (=> (= result23 true) (= o108 (select (rec__patience__state__posheight (us_split_fields__content s__split_fields20)) o107))))
(assert (=> (= result23 true) (= o109 (to_rep1 o108))))
(assert (=> (= result23 true) (= o120 (ite (<= 0 o109) true false))))
(assert (=> (= result23 true) (= result22 (ite (= o120 true) o119 false))))
...
(assert (= temp___654 (to_rep1 o106)))
(assert (not (<= 0 temp___654)))
(check-sat)
(exit)
