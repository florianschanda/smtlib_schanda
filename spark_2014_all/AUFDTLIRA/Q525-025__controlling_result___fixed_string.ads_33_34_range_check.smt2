...
(assert (forall ((temp___164 Int)) (=> (dynamic_invariant4 temp___164 true true true true) (forall ((temp___165 Int)) (= (to_rep (select (temp___162 temp___164) temp___165)) temp___164)))))
