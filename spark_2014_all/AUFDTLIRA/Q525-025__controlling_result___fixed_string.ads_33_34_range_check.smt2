...
(assert (forall ((this us_rep)) (! (let ((result (null_string this))) (and (= (length result) (elements this)) (dynamic_invariant2 result true false true true))) :pattern ((null_string this)))))
(assert (forall ((attr__tag1 Int)) (forall ((this us_rep)) (! (dynamic_invariant2 (null_string1 attr__tag1 this) true false true true) :pattern ((null_string1 attr__tag1 this))))))
...
(declare-datatypes () ((t24b__ref (mk_t24b__ref (t24b__content us_t2)))))
...
(assert (forall ((temp___164 Int)) (=> (dynamic_invariant4 temp___164 true true true true) (forall ((temp___165 Int)) (= (to_rep (select (temp_____aggregate_def_162 temp___164) temp___165)) temp___164)))))
...
(declare-const temp___256 (Array Int character))
(declare-const temp___2561 t2)
(declare-const temp___257 (Array Int character))
(declare-const temp___2571 t1)
(declare-const o4 (Array Int character))
(declare-const temp___259 (Array Int character))
(declare-const temp___2591 t1)
(declare-const temp___260 (Array Int character))
(declare-const temp___2601 t1)
...
(define-fun fixed_string__convert__result11 () us_t (mk___t fixed_string__convert__result6 fixed_string__convert__result7))
(define-fun fixed_string__convert__out_string__assume2 () us_t (mk___t fixed_string__convert__out_string__assume fixed_string__convert__out_string__assume1))
(assert (dynamic_invariant2 in_string true false true true))
(assert (and (= o (length in_string)) (in_range (length in_string))))
(assert (= o1 (ite (< o (to_rep2 (rec__fixed_string__object__width (us_split_fields1 this)))) o (to_rep2 (rec__fixed_string__object__width (us_split_fields1 this))))))
(assert (and (= o2 o1) (in_range3 o1)))
(assert (= (mk_int__ref result) (mk_int__ref len)))
(assert (= len1 o2))
(assert (in_range3 len1))
(assert (and (= fixed_string__convert__out_string__assume2 (null_string this)) (and (dynamic_invariant2 fixed_string__convert__out_string__assume2 true false true true) (= (length fixed_string__convert__out_string__assume2) (elements this)))))
(assert (= (mk_map__ref result1) (mk_map__ref out_string)))
(assert (= out_string1 fixed_string__convert__out_string__assume))
(assert (= (to_rep1 out_string__first) (to_rep1 (first fixed_string__convert__out_string__assume1))))
(assert (= (to_rep1 out_string__last) (to_rep1 (last fixed_string__convert__out_string__assume1))))
(assert (dynamic_property 1 2147483647 (to_rep1 out_string__first) (to_rep1 out_string__last)))
(assert (and (= fixed_string__convert__R19b__assume (+ (to_rep1 out_string__first) (- len1 1))) (in_range (+ (to_rep1 out_string__first) (- len1 1)))))
(assert (= fixed_string__convert__R19b__assume r19b))
(assert (in_range r19b))
(assert (and (= fixed_string__convert__R22b__assume (+ (to_rep1 (first (rt in_string))) (- len1 1))) (in_range (+ (to_rep1 (first (rt in_string))) (- len1 1)))))
(assert (= fixed_string__convert__R22b__assume r22b))
(assert (in_range r22b))
(assert (=> (<= (to_rep1 (first (rt in_string))) r22b) (and (and (<= (to_rep1 (first (rt in_string))) (to_rep1 (first (rt in_string)))) (<= (to_rep1 (first (rt in_string))) (to_rep1 (last (rt in_string))))) (and (<= (to_rep1 (first (rt in_string))) r22b) (<= r22b (to_rep1 (last (rt in_string))))))))
(assert (= o3 (elts in_string)))
(assert (= o3 temp___256))
(assert (= (mk2 (to_rep1 (first (rt in_string))) r22b) temp___2561))
(assert (= (ite (<= (to_rep1 (first4 temp___2561)) (to_rep1 (last4 temp___2561))) (+ (- (to_rep1 (last4 temp___2561)) (to_rep1 (first4 temp___2561))) 1) 0) (ite (<= (to_rep1 out_string__first) r19b) (+ (- r19b (to_rep1 out_string__first)) 1) 0)))
(assert (= (slide temp___256 (to_rep1 (first4 temp___2561)) (to_rep1 out_string__first)) temp___257))
(assert (= (mk1 (to_rep1 out_string__first) r19b) temp___2571))
(assert (=> (<= (to_rep1 out_string__first) r19b) (and (and (<= (to_rep1 out_string__first) (to_rep1 out_string__first)) (<= (to_rep1 out_string__first) (to_rep1 out_string__last))) (and (<= (to_rep1 out_string__first) r19b) (<= r19b (to_rep1 out_string__last))))))
(assert (= o4 out_string1))
(assert (= o4 temp___259))
(assert (= (mk1 (to_rep1 out_string__first) r19b) temp___2591))
(assert (= (ite (<= (to_rep1 (first2 temp___2571)) (to_rep1 (last2 temp___2571))) (+ (- (to_rep1 (last2 temp___2571)) (to_rep1 (first2 temp___2571))) 1) 0) (ite (<= (to_rep1 (first2 temp___2591)) (to_rep1 (last2 temp___2591))) (+ (- (to_rep1 (last2 temp___2591)) (to_rep1 (first2 temp___2591))) 1) 0)))
(assert (= (mk___t1 temp___260 temp___2601) (mk___t1 temp___257 temp___2571)))
(assert (forall ((temp___261 Int)) (ite (and (<= (to_rep1 out_string__first) temp___261) (<= temp___261 r19b)) (= (select o5 temp___261) (select temp___260 temp___261)) (= (select o5 temp___261) (select out_string1 temp___261)))))
(assert (= out_string1 result2))
(assert (= out_string2 o5))
...
(assert (= fixed_string__convert__result11 (mk___t fixed_string__convert__result2 fixed_string__convert__result3)))
(assert (= (mk_string__ref (mk___t result3 result4)) (mk_string__ref (mk___t fixed_string__convert__result fixed_string__convert__result1))))
(assert (= out_string2 fixed_string__convert__result2))
(assert (= (mk (to_rep1 out_string__first) (to_rep1 out_string__last)) fixed_string__convert__result3))
(assert (= (mk_string__ref (mk___t fixed_string__convert__result8 fixed_string__convert__result9)) (mk_string__ref (mk___t fixed_string__convert__result4 fixed_string__convert__result5))))
(assert (= out_string2 out_string3))
(assert (= len1 len2))
(assert (= fixed_string__convert__result10 fixed_string__convert__result11))
(assert (= out_string4 out_string2))
(assert (= len3 len1))
(assert (and (= o6 (elements this)) (and (in_range3 o6) (= o6 (to_rep2 (rec__fixed_string__object__width (us_split_fields1 this)))))))
(assert (not (in_range (length (mk___t fixed_string__convert__result8 fixed_string__convert__result9)))))
(check-sat)
(exit)
