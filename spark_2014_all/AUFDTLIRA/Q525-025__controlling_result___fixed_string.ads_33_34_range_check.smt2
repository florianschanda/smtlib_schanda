...
(assert (forall ((this us_rep)) (! (let ((result (null_string this))) (and (= (length result) (elements this)) (dynamic_invariant2 result true false true))) :pattern ((null_string this)))))
(assert (forall ((attr__tag1 Int)) (forall ((this us_rep)) (! (dynamic_invariant2 (null_string1 attr__tag1 this) true false true) :pattern ((null_string1 attr__tag1 this))))))
...
(assert (and (= fixed_string__convert__out_string__assume2 (null_string this)) (and (dynamic_invariant2 fixed_string__convert__out_string__assume2 true false true) (= (length fixed_string__convert__out_string__assume2) (elements this)))))
...
(assert (= (ite (<= (to_rep1 (first4 temp___2331)) (to_rep1 (last4 temp___2331))) (+ (- (to_rep1 (last4 temp___2331)) (to_rep1 (first4 temp___2331))) 1) 0) (ite (<= (to_rep1 out_string__first) r19b) (+ (- r19b (to_rep1 out_string__first)) 1) 0)))
(assert (= (slide temp___233 (to_rep1 (first4 temp___2331)) (to_rep1 out_string__first)) temp___234))
...
(assert (= o4 temp___236))
(assert (= (mk1 (to_rep1 out_string__first) r19b) temp___2361))
(assert (= (ite (<= (to_rep1 (first2 temp___2341)) (to_rep1 (last2 temp___2341))) (+ (- (to_rep1 (last2 temp___2341)) (to_rep1 (first2 temp___2341))) 1) 0) (ite (<= (to_rep1 (first2 temp___2361)) (to_rep1 (last2 temp___2361))) (+ (- (to_rep1 (last2 temp___2361)) (to_rep1 (first2 temp___2361))) 1) 0)))
(assert (= (mk___t1 temp___237 temp___2371) (mk___t1 temp___234 temp___2341)))
(assert (forall ((temp___238 Int)) (ite (and (<= (to_rep1 out_string__first) temp___238) (<= temp___238 r19b)) (= (select o5 temp___238) (select temp___237 temp___238)) (= (select o5 temp___238) (select out_string1 temp___238)))))
