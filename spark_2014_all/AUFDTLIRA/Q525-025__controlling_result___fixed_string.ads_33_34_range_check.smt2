...
(assert (and (= (mk___t fixed_string__convert__out_string__assume fixed_string__convert__out_string__assume1) (null_string this)) (and (dynamic_invariant2 (mk___t fixed_string__convert__out_string__assume fixed_string__convert__out_string__assume1) true false true) (= (length (mk___t fixed_string__convert__out_string__assume fixed_string__convert__out_string__assume1)) (elements this)))))
...
(assert (= (mk___t fixed_string__convert__result6 fixed_string__convert__result7) (mk___t fixed_string__convert__result2 fixed_string__convert__result3)))
...
(assert (= len1 len2))
(assert (= fixed_string__convert__result10 (mk___t fixed_string__convert__result6 fixed_string__convert__result7)))
