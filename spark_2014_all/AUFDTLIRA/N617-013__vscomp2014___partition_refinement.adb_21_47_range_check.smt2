...
(assert (= f1 o10))
(assert (forall ((j6 Int)) (=> (and (<= (to_rep1 (rec__partition_refinement__interval__first p_prime__split_fields3)) j6) (<= j6 i2)) (= (to_rep2 (select f2 j6)) p_prime_index2))))
(assert (forall ((j6 Int)) (=> (and (<= 0 j6) (<= j6 (- (to_rep1 (rec__partition_refinement__interval__first p_prime__split_fields3)) 1))) (= (to_rep2 (select f2 j6)) (to_rep2 (select f j6))))))
(assert (forall ((j6 Int)) (=> (and (<= (+ i2 1) j6) (<= j6 5)) (= (to_rep2 (select f2 j6)) (to_rep2 (select f j6))))))
...
(assert (<= (to_rep1 (rec__partition_refinement__interval__first p_prime__split_fields3)) i2))
(assert (not (<= 0 (to_rep1 (rec__partition_refinement__interval__first p_prime__split_fields3)))))
(check-sat)
(exit)
