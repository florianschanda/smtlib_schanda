...
(assert (= 0 (to_rep2 temp___858)))
(assert (= (to_rep1 (first2 (rt1 (temp___494 32 1 0)))) 1))
(assert (= (to_rep1 (last2 (rt1 (temp___494 32 1 0)))) 0))
(assert (= (mk___t1 temp___861 temp___8611) (temp___494 32 1 0)))
(assert (not (= (ite (<= (to_rep1 (first2 temp___8611)) (to_rep1 (last2 temp___8611))) (+ (- (to_rep1 (last2 temp___8611)) (to_rep1 (first2 temp___8611))) 1) 0) (ite (<= 1 0) (+ (- 0 1) 1) 0))))
(check-sat)
(exit)
