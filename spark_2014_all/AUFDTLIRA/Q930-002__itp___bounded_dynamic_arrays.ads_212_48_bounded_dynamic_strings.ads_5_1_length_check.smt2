...
(declare-const temp___921 natural_index)
(declare-const temp___924 (Array Int character))
(declare-const temp___9241 t1)
(assert (= (bounded_dynamic_strings__null_list__aggregate_def 32) null_list))
(assert (and (= us 0) (in_range4 0)))
(assert (= 0 (to_rep2 temp___921)))
(assert (= (to_rep1 (first2 (rt1 (temp___526 32 1 0)))) 1))
(assert (= (to_rep1 (last2 (rt1 (temp___526 32 1 0)))) 0))
(assert (= (mk___t1 temp___924 temp___9241) (temp___526 32 1 0)))
(assert (not (= (ite (<= (to_rep1 (first2 temp___9241)) (to_rep1 (last2 temp___9241))) (+ (- (to_rep1 (last2 temp___9241)) (to_rep1 (first2 temp___9241))) 1) 0) (ite (<= 1 0) (+ (- 0 1) 1) 0))))
(check-sat)
(exit)
