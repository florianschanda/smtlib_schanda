...
(assert (and (and (and (and (<= (+ l 1) i3) (<= i3 u)) (< l u)) (forall ((x3 Int)) (=> (and (<= l x3) (<= x3 i3)) (<= (to_rep (select arr k3)) (to_rep (select arr x3)))))) (and (<= l k3) (<= k3 u))))
(assert (and (and (=> (<= (+ l 1) u) (dynamic_property (+ l 1) u i3)) (=> (<= 1 100) (in_range1 k3))) (and (<= (+ l 1) i3) (<= i3 u))))
(assert (not (= i3 u)))
(assert (= result3 i3))
(assert (= i4 (+ i3 1)))
(assert (=> (< (to_rep (select arr i4)) (to_rep (select arr k3))) (= result4 k3)))
(assert (=> (< (to_rep (select arr i4)) (to_rep (select arr k3))) (= k4 i4)))
(assert (=> (not (< (to_rep (select arr i4)) (to_rep (select arr k3)))) (= k4 k3)))
(assert (not (<= (+ l 1) i4)))
(check-sat)
(exit)
