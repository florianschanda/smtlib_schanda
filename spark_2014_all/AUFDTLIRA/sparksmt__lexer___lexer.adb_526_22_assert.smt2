...
(assert (or (= (int__content state74) 2) (or (= (int__content state74) 7) (= (int__content state74) 6))))
(assert (not (<= 2 (length1 (mk___rep1 s__split_discrs (us_split_fields__content1 s__split_fields49))))))
(check-sat)
(exit)
