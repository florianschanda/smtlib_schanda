...
(assert (and (= o115 v) (in_range1 v)))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o116 v) (in_range1 v)))
(assert (not (= (valid_root (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o116) true)))
(check-sat)
(exit)
