...
(assert (and (= o87 (length (rec__list_allocator__m__t__available model____split_fields4))) (in_range6 o87)))
(assert (= o88 (ite (<= j2 o87) true false)))
(assert (= result22 (ite (<= 1 j2) o88 false)))
