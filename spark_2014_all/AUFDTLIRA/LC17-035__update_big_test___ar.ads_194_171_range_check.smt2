...
(assert (< i 10))
(assert (=> (< 0 e) (and (= o8 (- e 1)) (in_range2 (- e 1)))))
(assert (=> (< 0 e) (and (= o9 (+ i 1)) (in_range1 (+ i 1)))))
(assert (=> (< 0 e) (= temp___4413 (temp___681 a i e o9 o8))))
(assert (=> (< 0 e) (= result8 (bool_eq a3 1 10 temp___4413 1 10))))
