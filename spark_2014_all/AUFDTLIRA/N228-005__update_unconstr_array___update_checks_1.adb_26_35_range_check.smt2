...
(assert (and (= us1 l) (dynamic_property1 (to_rep a__first) (to_rep a__last) l)))
(assert (= o l))
(assert (and (= us k) (dynamic_property1 (to_rep a__first) (to_rep a__last) k)))
(assert (= o1 k))
(assert (not (dynamic_property1 (to_rep a__first) (to_rep a__last) j)))
(check-sat)
(exit)
