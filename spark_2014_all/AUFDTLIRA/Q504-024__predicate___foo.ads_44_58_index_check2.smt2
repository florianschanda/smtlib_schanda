...
(assert (forall ((i cpu_range)) (and (<= 0 (cpu_rangeqtint i)) (<= (cpu_rangeqtint i) 1))))
(define-fun in_range1 ((x Int)) Bool (and (<= 0 x) (<= x 1)))
(declare-fun attr__ATTRIBUTE_IMAGE1 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check1 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE1 (us_image) Int)
(declare-fun user_eq1 (cpu_range cpu_range) Bool)
(declare-const dummy1 cpu_range)
...
(define-fun dynamic_invariant ((temp___expr_166 Int) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool (=> (or (= temp___is_init_162 true) (<= 0 1)) (in_range1 temp___expr_166)))
...
(assert (forall ((x tmax_lsid_typeB)) (! (in_range2 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(assert (forall ((i max_lsid_type)) (and (<= 0 (max_lsid_typeqtint i)) (<= (max_lsid_typeqtint i) 5))))
(define-fun in_range3 ((x Int)) Bool (and (<= 0 x) (<= x 5)))
(declare-fun attr__ATTRIBUTE_IMAGE4 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check4 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE4 (us_image) Int)
(declare-fun user_eq5 (max_lsid_type max_lsid_type) Bool)
(declare-const dummy5 max_lsid_type)
...
(define-fun to_rep2 ((x max_lsid_type)) Int (max_lsid_typeqtint x))
(declare-fun of_rep2 (Int) max_lsid_type)
(assert (forall ((x max_lsid_type)) (! (= (of_rep2 (to_rep2 x)) x) :pattern ((to_rep2 x)))))
(assert (forall ((x max_lsid_type)) (! (in_range3 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(declare-fun user_eq6 (tmax_lsid_typeB tmax_lsid_typeB) Bool)
(declare-const dummy6 tmax_lsid_typeB)
...
(declare-datatypes () ((t9s__ref (mk_t9s__ref (t9s__content us_t1)))))
(define-fun t9s__ref___projection ((a t9s__ref)) us_t1 (t9s__content a))
...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__foo__subject_state__states us_t1)))))
(define-fun us_split_fields_States__projection ((a us_split_fields)) us_t1 (rec__foo__subject_state__states a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_discrs1 us_split_discrs) (us_split_fields1 us_split_fields)))))
(define-fun us_rep___projection ((a us_rep)) us_split_discrs (us_split_discrs1 a))
(define-fun us_rep___2__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep2 (rec__foo__subject_state__max_id (us_split_discrs1 a))) (to_rep2 (rec__foo__subject_state__max_id (us_split_discrs1 b)))) (= (bool_eq2 (rec__foo__subject_state__states (us_split_fields1 a)) (rec__foo__subject_state__states (us_split_fields1 b))) true)) true false))
...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__foo__subject_state__states1 us_t)))))
(define-fun us_split_fields_States__2__projection ((a us_split_fields2)) us_t (rec__foo__subject_state__states1 a))
...
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (us_split_discrs2 a) (mk___split_fields (let ((temp___161 (rec__foo__subject_state__states1 (us_split_fields3 a)))) (of_array1 (to_array temp___161) (first1 temp___161) (last1 temp___161))))))
(define-fun of_base ((r us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r) (mk___split_fields1 (let ((temp___160 (rec__foo__subject_state__states (us_split_fields1 r)))) (of_array (to_array1 temp___160) (first3 temp___160) (last3 temp___160))))))
(define-fun bool_eq4 ((a us_rep1) (b us_rep1)) Bool (ite (and (= (to_rep2 (rec__foo__subject_state__max_id (us_split_discrs2 a))) (to_rep2 (rec__foo__subject_state__max_id (us_split_discrs2 b)))) (= (bool_eq1 (rec__foo__subject_state__states1 (us_split_fields3 a)) (rec__foo__subject_state__states1 (us_split_fields3 b))) true)) true false))
(define-fun in_range4 ((rec__foo__subject_state__max_id1 Int) (a us_rep)) Bool (= rec__foo__subject_state__max_id1 (to_rep2 (rec__foo__subject_state__max_id (us_split_discrs1 a)))))
...
(declare-datatypes () ((map__ref1 (mk_map__ref1 (map__content1 (Array Int max_lsid_type))))))
(declare-fun slide1 ((Array Int max_lsid_type) Int Int) (Array Int max_lsid_type))
(assert (forall ((a (Array Int max_lsid_type))) (forall ((first4 Int)) (! (= (slide1 a first4 first4) a) :pattern ((slide1 a first4 first4))))))
(assert (forall ((a (Array Int max_lsid_type))) (forall ((old_first Int)) (forall ((new_first Int)) (forall ((i Int)) (! (= (select (slide1 a old_first new_first) i) (select a (- i (- new_first old_first)))) :pattern ((select (slide1 a old_first new_first) i))))))))
(define-fun bool_eq5 ((a (Array Int max_lsid_type)) (a__first Int) (a__last Int) (b (Array Int max_lsid_type)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (to_rep2 (select a temp___idx_154)) (to_rep2 (select b (+ (- b__first a__first) temp___idx_154))))))) true false))
(assert (forall ((a (Array Int max_lsid_type)) (b (Array Int max_lsid_type))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq5 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (to_rep2 (select a temp___idx_154)) (to_rep2 (select b (+ (- b__first a__first) temp___idx_154)))))))))))
(declare-const cpu_lsid_last (Array Int max_lsid_type))
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(define-fun dynamic_invariant1 ((temp___expr_213 us_rep1) (temp___is_init_209 Bool) (temp___skip_constant_210 Bool) (temp___do_toplevel_211 Bool) (temp___do_typ_inv_212 Bool)) Bool (and (=> (not (= temp___skip_constant_210 true)) (in_range4 (to_rep2 (select cpu_lsid_last cpu_id)) (to_base temp___expr_213))) (and (dynamic_property1 0 (to_rep2 (select cpu_lsid_last cpu_id)) (first1 (rec__foo__subject_state__states1 (us_split_fields3 temp___expr_213))) (last1 (rec__foo__subject_state__states1 (us_split_fields3 temp___expr_213)))) (and (= (first1 (rec__foo__subject_state__states1 (us_split_fields3 temp___expr_213))) 0) (= (last1 (rec__foo__subject_state__states1 (us_split_fields3 temp___expr_213))) (to_rep2 (select cpu_lsid_last cpu_id)))))))
(define-fun default_initial_assumption ((temp___expr_216 us_rep1) (temp___skip_top_level_217 Bool)) Bool (= (to_rep2 (rec__foo__subject_state__max_id (us_split_discrs2 temp___expr_216))) (to_rep2 (select cpu_lsid_last cpu_id))))
...
(define-fun dynamic_invariant3 ((temp___expr_173 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool) (temp___do_typ_inv_172 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= 0 5)) (in_range3 temp___expr_173)))
...
(assert (forall ((temp___156 Int) (temp___157 Int)) (let ((temp___155 (foo__cpu_lsid_last__aggregate_def temp___156 temp___157))) (=> (and (dynamic_invariant3 temp___156 true true true true) (dynamic_invariant3 temp___157 true true true true)) (and (= (select temp___155 0) rliteral) (= (select temp___155 1) rliteral1))))))
(define-fun dynamic_invariant4 ((temp___expr_206 us_rep) (temp___is_init_202 Bool) (temp___skip_constant_203 Bool) (temp___do_toplevel_204 Bool) (temp___do_typ_inv_205 Bool)) Bool (let ((temp___207 (rec__foo__subject_state__max_id (us_split_discrs1 temp___expr_206)))) (and (dynamic_property3 0 (to_rep2 temp___207) (first3 (rec__foo__subject_state__states (us_split_fields1 temp___expr_206))) (last3 (rec__foo__subject_state__states (us_split_fields1 temp___expr_206)))) (and (= (first3 (rec__foo__subject_state__states (us_split_fields1 temp___expr_206))) 0) (= (last3 (rec__foo__subject_state__states (us_split_fields1 temp___expr_206))) (to_rep2 temp___207))))))
(declare-const states__split_fields (Array Int natural))
(declare-const states__split_fields1 t)
(assert (in_range1 cpu_id))
(assert (dynamic_invariant1 (mk___rep1 states__split_discrs (mk___split_fields1 (mk___t states__split_fields states__split_fields1))) true false true true))
(assert (not (<= (to_rep1 (first states__split_fields1)) 5)))
(check-sat)
(exit)
