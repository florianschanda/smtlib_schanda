...
(assert (and (= o17 (remove o15 o16)) (and (dynamic_invariant2 o17 true false true) (and (= (invariant__ o17) true) (and (= (to_rep2 (last (rt o17))) (- (to_rep2 (last (rt o15))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o16 1))) (= (to_rep (select (elts o15) k)) (to_rep (select (elts o17) k))))) (and (forall ((k Int)) (=> (and (<= (+ o16 1) k) (<= k (to_rep2 (last (rt o15))))) (= (to_rep (select (elts o15) k)) (to_rep (select (elts o17) (- k 1)))))) (forall ((k Int)) (=> (and (<= o16 k) (<= k (- (to_rep2 (last (rt o15))) 1))) (= (to_rep (select (elts o15) (+ k 1))) (to_rep (select (elts o17) k))))))))))))
