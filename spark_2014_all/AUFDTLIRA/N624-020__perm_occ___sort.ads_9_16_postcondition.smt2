...
(assert (not (= (is_perm (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last))) (mk___t (map__content values10) (mk (to_rep1 values__first) (to_rep1 values__last)))) true)))
(check-sat)
(exit)
