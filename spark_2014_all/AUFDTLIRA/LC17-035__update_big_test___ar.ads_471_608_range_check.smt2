...
(assert (=> (< k 16) (=> (< 0 e) (= o21 (temp___1564 o20 i o19)))))
(assert (=> (< k 16) (=> (< 0 e) (and (<= 1 (+ k 1)) (<= (+ k 1) 16)))))
(assert (=> (< k 16) (=> (< 0 e) (= o17 (+ k 1)))))
(assert (=> (< k 16) (=> (< 0 e) (= o22 (select a o17)))))
(assert (=> (< k 16) (=> (< 0 e) (= o23 (temp___1557 o22 j o21)))))
(assert (=> (< k 16) (=> (< 0 e) (and (= o24 (+ k 1)) (in_range2 (+ k 1))))))
(assert (=> (< k 16) (=> (< 0 e) (= temp___5271 (temp___1534 a k (temp___1542 (select a k) j (temp___1549 (select (select a k) j) i e)) o24 o23)))))
...
(assert (=> (< k 16) (=> (not (= result7 true)) (=> (= e 0) (= o13 (temp___1603 o12 i 99))))))
(assert (=> (< k 16) (=> (not (= result7 true)) (=> (= e 0) (and (<= 1 (+ k 1)) (<= (+ k 1) 16))))))
(assert (=> (< k 16) (=> (not (= result7 true)) (=> (= e 0) (= o10 (+ k 1))))))
(assert (=> (< k 16) (=> (not (= result7 true)) (=> (= e 0) (= o14 (select a o10))))))
(assert (=> (< k 16) (=> (not (= result7 true)) (=> (= e 0) (= o15 (temp___1596 o14 j o13))))))
(assert (=> (< k 16) (=> (not (= result7 true)) (=> (= e 0) (and (= o16 (+ k 1)) (in_range2 (+ k 1)))))))
(assert (=> (< k 16) (=> (not (= result7 true)) (=> (= e 0) (= temp___5281 (temp___1573 a k (temp___1581 (select a k) j (temp___1588 (select (select a k) j) i e)) o16 o15))))))
