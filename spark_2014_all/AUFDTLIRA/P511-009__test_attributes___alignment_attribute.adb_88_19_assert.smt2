...
(assert (<= 0 (object__alignment3 (mk___rep rst2__split_discrs (mk___split_fields rst2__split_fields) rst2__attr__constrained))))
(assert (<= 0 (object__alignment4 (mk___rep1 (mk___split_fields1 rt3__split_fields rt3__split_fields1) rt3__attr__tag))))
(assert (not (<= 0 (object__alignment5 (mk___rep2 (mk___split_fields2 rt4__split_fields rt4__split_fields1 rt4__split_fields2) rt4__attr__tag)))))
(check-sat)
(exit)
