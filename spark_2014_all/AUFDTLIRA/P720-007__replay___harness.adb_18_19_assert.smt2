...
(assert (= h2 y))
(assert (and (and (= (to_rep1 r__split_fields18) (- (to_rep1 r__split_fields17) 1)) (= (head (mk___rep (mk___split_fields r__split_fields15 r__split_fields16 r__split_fields17))) h3)) (in_range h3)))
(assert (not (= h3 z)))
(check-sat)
(exit)
