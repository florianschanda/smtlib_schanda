...
(assert (and (<= 0 i4) (<= i4 99)))
(assert (= o199 i4))
(assert (= temp___716 (select (rec__patience__state__stacks (us_split_fields__content s__split_fields20)) o199)))
(assert (and (<= 0 j1) (<= j1 99)))
(assert (= o200 j1))
(assert (= o201 (select temp___716 o200)))
(assert (= temp___717 (to_rep1 o201)))
