...
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o120 i1))
(assert (= temp___720 (select (rec__patience__state__stacks (us_split_fields__content s__split_fields20)) o120)))
(assert (and (<= 0 k) (<= k 99)))
(assert (= o121 k))
...
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o117 i1))
(assert (= temp___716 (select (rec__patience__state__stacks (us_split_fields__content s__split_fields20)) o117)))
(assert (and (<= 0 j) (<= j 99)))
(assert (= o118 j))
(assert (= o119 (select temp___716 o118)))
(assert (= temp___717 (to_rep1 o119)))
(assert (not (<= 0 temp___717)))
(check-sat)
(exit)
