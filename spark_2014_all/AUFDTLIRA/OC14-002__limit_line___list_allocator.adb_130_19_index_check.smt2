...
(assert (and (= o89 (+ j2 1)) (in_range1 (+ j2 1))))
(assert (and (= temp___403 (get ma1 o89)) (in_range7 temp___403)))
(assert (and (<= 1 temp___403) (<= temp___403 3)))
(assert (= o90 temp___403))
(assert (= o91 (select data4 o90)))
(assert (and (= temp___402 (get (rec__list_allocator__m__t__available model____split_fields4) j2)) (in_range7 temp___402)))
(assert (not (<= 1 temp___402)))
(check-sat)
(exit)
