...
(assert (and (= temp___403 (get ma1 o45)) (in_range7 temp___403)))
(assert (and (<= 1 temp___403) (<= temp___403 3)))
(assert (= o46 temp___403))
(assert (= o47 (select data3 o46)))
(assert (and (= temp___402 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (in_range7 temp___402)))
