...
(assert (and (= temp___436 (get ma1 o45)) (in_range7 temp___436)))
(assert (and (<= 1 temp___436) (<= temp___436 3)))
(assert (= o46 temp___436))
(assert (= o47 (select data3 o46)))
(assert (and (= temp___435 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (in_range7 temp___435)))
(assert (not (<= 1 temp___435)))
(check-sat)
(exit)
