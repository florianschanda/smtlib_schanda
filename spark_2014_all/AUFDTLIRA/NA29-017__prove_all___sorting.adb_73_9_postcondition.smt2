...
(assert (and (and (=> (<= 0 2147483647) (in_range2 i)) (and (=> (<= 0 2147483647) (in_range2 j)) (and (and (= (mk_int__ref result) (mk_int__ref i)) (= i1 0)) (and (and (= (mk_int__ref result1) (mk_int__ref j)) (= j1 0)) (and (and (and (and (= temp___266 a) (and (= temp___264 b) (and (= temp___262 j1) (and (= temp___261 i1) (and (and (and (and (and (and (and (<= i2 length1) (<= j2 length2)) (= (sorted (mk___t b1 (mk (to_rep b__first) (to_rep b__last))) (to_rep b__first) (+ i2 j2)) true)) (= (perm2 (mk___t a (mk (to_rep a__first) (to_rep a__last))) (mk___t b1 (mk (to_rep b__first) (to_rep b__last))) a_first (+ a_first length1) (to_rep b__first) i2 j2) true)) (= (le_array (mk___t b1 (mk (to_rep b__first) (to_rep b__last))) (mk___t a (mk (to_rep a__first) (to_rep a__last))) (to_rep b__first) (+ a_first i2) (+ i2 j2) (- length1 i2)) true)) (= (le_array (mk___t b1 (mk (to_rep b__first) (to_rep b__last))) (mk___t a (mk (to_rep a__first) (to_rep a__last))) (to_rep b__first) (+ (+ a_first length1) j2) (+ i2 j2) (- length2 j2)) true)) (= (bool_eq a (to_rep a__first) (to_rep a__last) temp___266 (to_rep a__first) (to_rep a__last)) true)) (and (and (=> (<= 0 2147483647) (in_range2 i2)) (=> (<= 0 2147483647) (in_range2 j2))) (and (and (and (= j2 j4) (and (= i2 i4) (= b1 b4))) (and (= j5 j2) (and (= i5 i2) (= b5 b1)))) (not (or (< i2 length1) (< j2 length2)))))))))) (and (and (= (mk_int__ref j8) (mk_int__ref j4)) (and (= (mk_int__ref i8) (mk_int__ref i4)) (= (mk_map__ref b8) (mk_map__ref b4)))) (and (= j9 j5) (and (= i9 i5) (= b9 b5))))) (and (and (= j10 (mk_int__ref j8)) (and (= (mk_int__ref i10) (mk_int__ref i8)) (= (mk_map__ref b10) (mk_map__ref b8)))) (and (= j11 j9) (and (= i11 i9) (= b11 b9))))) (and (and (= o61 (+ length1 length2)) (in_range1 (+ length1 length2))) (and (and (= o60 (to_rep b__first)) (in_range2 (to_rep b__first))) (forall ((j14 Int)) (=> (and (<= (to_rep a__first) j14) (<= j14 (to_rep a__last))) (and (=> (and (<= a_first j14) (<= j14 (- (+ a_first o61) 1))) (= (to_rep (select a1 j14)) (to_rep (select b10 (- (+ o60 j14) a_first))))) (=> (=> (<= a_first j14) (not (<= j14 (- (+ a_first o61) 1)))) (= (to_rep (select a1 j14)) (to_rep (select a j14)))))))))))))) (and (and (= j12 j10) (and (= i12 (mk_int__ref i10)) (and (= b12 (mk_map__ref b10)) (= a2 (mk_map__ref a1))))) (and (= j13 j11) (and (= i13 i11) (and (= b13 b11) (= a3 a1)))))))
(assert (not (= (sorted (mk___t (map__content a2) (mk (to_rep a__first) (to_rep a__last))) a_first (+ length1 length2)) true)))
(check-sat)
(exit)
