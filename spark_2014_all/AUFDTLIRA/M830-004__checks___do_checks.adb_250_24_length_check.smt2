...
(define-fun dynamic_invariant ((temp___expr_365 us_t) (temp___is_init_361 Bool) (temp___skip_constant_362 Bool) (temp___do_toplevel_363 Bool) (temp___do_typ_inv_364 Bool)) Bool (=> (not (= temp___skip_constant_362 true)) (dynamic_property 0 2147483647 (first1 temp___expr_365) (last1 temp___expr_365))))
(declare-sort ta2P1 0)
(declare-fun ta2P1qtint (ta2P1) Int)
(assert (forall ((i ta2P1)) (and (<= 0 (ta2P1qtint i)) (<= (ta2P1qtint i) 10))))
(define-fun in_range3 ((x Int)) Bool (and (<= 0 x) (<= x 10)))
(declare-fun attr__ATTRIBUTE_IMAGE3 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check3 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE3 (us_image) Int)
(declare-fun user_eq3 (ta2P1 ta2P1) Bool)
(declare-const dummy3 ta2P1)
(declare-datatypes () ((ta2P1__ref (mk_ta2P1__ref (ta2P1__content ta2P1)))))
(define-fun ta2P1__ref___projection ((a ta2P1__ref)) ta2P1 (ta2P1__content a))
...
(assert (and (= (to_rep (first (rt x))) 1) (= (to_rep (last (rt x))) 11)))
(assert (not (= (ite (<= (to_rep (first (rt x))) (to_rep (last (rt x)))) (+ (- (to_rep (last (rt x))) (to_rep (first (rt x)))) 1) 0) (ite (<= 0 10) (+ (- 10 0) 1) 0))))
(check-sat)
(exit)
