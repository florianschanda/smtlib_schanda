...
(define-fun dynamic_invariant ((temp___expr_320 us_t) (temp___is_init_317 Bool) (temp___skip_constant_318 Bool) (temp___do_toplevel_319 Bool)) Bool (=> (not (= temp___skip_constant_318 true)) (dynamic_property 0 2147483647 (first1 temp___expr_320) (last1 temp___expr_320))))
