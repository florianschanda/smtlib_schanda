...
(declare-const temp___1599 (Array Int us_rep3))
...
(assert (= result5 true))
(assert (and (= temp___1599 (model__ f_old v)) (and (dynamic_invariant5 temp___1599 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1599 v))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1599 v)))) 0) (and (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (=> (not (= i3 v)) (ite (and (not (= (parent f_old i3) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1599 (parent f_old i3)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1599 i3))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1599 i3))) true)))))) (and (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1599 i3))) true) (not (= i3 v))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select temp___1599 (parent f_old i3)))) (position f_old i3) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1599 i3)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1599 i3)))) 0)))) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1599 i3))) true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1599 j2))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select temp___1599 i3))) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1599 j2)))) true)) (= j2 i3))))))))))))))
(assert (= o20 (select temp___1599 j1)))
