...
(assert (and (and (forall ((temp___308 Int)) (=> (and (<= 1 temp___308) (<= temp___308 3)) (ite (not (= i32 temp___308)) (= (select x3 temp___308) (select x2 temp___308)) (forall ((temp___309 Int) (temp___310 Int)) (=> (and (and (<= 1 temp___309) (<= temp___309 3)) (and (<= 1 temp___310) (<= temp___310 3))) (=> (<= i212 temp___309) (= (get (select x3 temp___308) temp___309 temp___310) (get (select x2 temp___308) temp___309 temp___310)))))))) (=> (<= 1 3) (in_range2 i212))) (and (<= 1 i212) (<= i212 3))))
(assert (= i22 result3))
(assert (= i221 1))
(assert (<= 1 i221))
(assert (<= i221 3))
...
(assert (and (and (forall ((temp___287 Int)) (=> (and (<= 1 temp___287) (<= temp___287 3)) (ite (not (= i32 temp___287)) (= (select x4 temp___287) (select x3 temp___287)) (forall ((temp___288 Int) (temp___289 Int)) (=> (and (and (<= 1 temp___288) (<= temp___288 3)) (and (<= 1 temp___289) (<= temp___289 3))) (=> (or (<= i222 temp___289) (not (= i212 temp___288))) (= (get (select x4 temp___287) temp___288 temp___289) (get (select x3 temp___287) temp___288 temp___289)))))))) (=> (<= 1 3) (in_range2 i222))) (and (<= 1 i222) (<= i222 3))))
(assert (<= (+ i32 1) 3))
(assert (not (<= 1 (+ i32 1))))
(check-sat)
(exit)
