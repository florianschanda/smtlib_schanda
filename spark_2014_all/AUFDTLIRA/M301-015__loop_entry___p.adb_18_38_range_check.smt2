...
(assert (<= 1 i211))
(assert (<= i211 3))
(assert (= (bool_eq2 x3 (to_rep (first4 (mk2 (+ i32 1) 3))) (to_rep (last4 (mk2 (+ i32 1) 3))) x2 (to_rep (first6 (mk3 (+ i32 1) 3))) (to_rep (last6 (mk3 (+ i32 1) 3)))) true))
(assert (and (and (forall ((temp___276 Int)) (=> (and (<= 1 temp___276) (<= temp___276 3)) (ite (not (= i32 temp___276)) (= (select x3 temp___276) (select x2 temp___276)) (forall ((temp___277 Int) (temp___278 Int)) (=> (and (and (<= 1 temp___277) (<= temp___277 3)) (and (<= 1 temp___278) (<= temp___278 3))) (=> (<= i212 temp___277) (= (get (select x3 temp___276) temp___277 temp___278) (get (select x2 temp___276) temp___277 temp___278)))))))) (=> (<= 1 3) (in_range2 i212))) (and (<= 1 i212) (<= i212 3))))
(assert (= i221 result3))
(assert (= i222 1))
(assert (<= 1 i222))
(assert (<= i222 3))
(assert (= (bool_eq2 x4 (to_rep (first8 (mk4 (+ i32 1) 3))) (to_rep (last8 (mk4 (+ i32 1) 3))) x3 (to_rep (first10 (mk5 (+ i32 1) 3))) (to_rep (last10 (mk5 (+ i32 1) 3)))) true))
(assert (and (and (forall ((temp___255 Int)) (=> (and (<= 1 temp___255) (<= temp___255 3)) (ite (not (= i32 temp___255)) (= (select x4 temp___255) (select x3 temp___255)) (forall ((temp___256 Int) (temp___257 Int)) (=> (and (and (<= 1 temp___256) (<= temp___256 3)) (and (<= 1 temp___257) (<= temp___257 3))) (=> (or (<= i223 temp___257) (not (= i212 temp___256))) (= (get (select x4 temp___255) temp___256 temp___257) (get (select x3 temp___255) temp___256 temp___257)))))))) (=> (<= 1 3) (in_range2 i223))) (and (<= 1 i223) (<= i223 3))))
(assert (<= (+ i32 1) 3))
(assert (not (<= 1 (+ i32 1))))
(check-sat)
(exit)
