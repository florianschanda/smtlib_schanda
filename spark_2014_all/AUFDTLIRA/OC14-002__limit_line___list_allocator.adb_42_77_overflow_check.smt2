...
(assert (=> (not (= first_available 0)) (=> (= result2 true) (and (= o7 (get model____split_fields 1)) (in_range7 o7)))))
...
(assert (=> (= result1 true) (=> (not (= first_allocated 0)) (and (= o5 (length model____split_fields1)) (in_range6 o5)))))
(assert (=> (= result1 true) (=> (not (= first_allocated 0)) (= result3 (ite (< 0 o5) true false)))))
(assert (=> (= result1 true) (=> (not (= first_allocated 0)) (=> (= result3 true) (and (= o4 (get model____split_fields1 1)) (in_range7 o4))))))
...
(assert (=> (= result1 true) (=> (not (not (= first_allocated 0))) (and (= o6 (length model____split_fields1)) (in_range6 o6)))))
