...
(assert (=> (not (= first_available 0)) (= result2 (ite (< 0 o8) true false))))
(assert (=> (not (= first_available 0)) (=> (= result2 true) (and (= o7 (get model____split_fields 1)) (in_range4 o7)))))
(assert (=> (not (= first_available 0)) (=> (= result2 true) (= result1 (ite (= o7 first_available) true false)))))
...
(assert (=> (not (not (= first_available 0))) (= result1 (ite (= o9 0) true false))))
(assert (=> (= result1 true) (=> (not (= first_allocated 0)) (and (= o5 (length model____split_fields1)) (in_range3 o5)))))
(assert (=> (= result1 true) (=> (not (= first_allocated 0)) (= result3 (ite (< 0 o5) true false)))))
(assert (=> (= result1 true) (=> (not (= first_allocated 0)) (=> (= result3 true) (and (= o4 (get model____split_fields1 1)) (in_range4 o4))))))
(assert (=> (= result1 true) (=> (not (= first_allocated 0)) (=> (= result3 true) (= result (ite (= o4 first_allocated) true false))))))
(assert (=> (= result1 true) (=> (not (= first_allocated 0)) (=> (not (= result3 true)) (= result false)))))
(assert (=> (= result1 true) (=> (not (not (= first_allocated 0))) (and (= o6 (length model____split_fields1)) (in_range3 o6)))))
(assert (=> (= result1 true) (=> (not (not (= first_allocated 0))) (= result (ite (= o6 0) true false)))))
...
(assert (= result4 true))
(assert (and (= o3 (get model____split_fields j)) (in_range4 o3)))
(assert (= result5 (ite (in_range6 o3) true false)))
(assert (= result5 true))
