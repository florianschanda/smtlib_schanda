...
(assert (forall ((m2 Int)) (=> (and (<= (- 2147483648) m2) (<= m2 2147483647)) (=> (and (forall ((n6 Int)) (=> (and (<= 1 n6) (<= n6 i)) (<= (to_rep (select a n6)) m2))) (exists ((n6 Int)) (and (and (<= 1 n6) (<= n6 i)) (= (to_rep (select a n6)) m2)))) (= m2 max)))))
(assert (and (forall ((n6 Int)) (=> (and (<= 1 n6) (<= n6 (- i 1))) (<= (to_rep (select a n6)) max))) (exists ((n6 Int)) (and (and (<= 1 n6) (<= n6 (- i 1))) (= (to_rep (select a n6)) max)))))
(assert (=> (< (to_rep (select a i)) max) (= result max)))
(assert (=> (< (to_rep (select a i)) max) (= max2 (to_rep (select a i)))))
(assert (=> (not (< (to_rep (select a i)) max)) (= max2 max)))
(assert (=> (not (< (to_rep (select a i)) max)) (= max2 max1)))
(assert (<= (- 2147483648) m1))
(assert (<= m1 2147483647))
(assert (= (= o2 true) (exists ((n6 Int)) (and (and (<= 1 n6) (<= n6 i)) (= (to_rep (select a n6)) m1)))))
(assert (<= 1 n4))
(assert (<= n4 i))
(assert (not (<= 1 n4)))
(check-sat)
