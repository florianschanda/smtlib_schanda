...
(assert (=> (not (= first_available1 0)) (= result12 (ite (< 0 o51) true false))))
(assert (=> (not (= first_available1 0)) (=> (= result12 true) (and (= o50 (get (rec__list_allocator__m__t__available model____split_fields3) 1)) (in_range7 o50)))))
(assert (=> (not (= first_available1 0)) (=> (= result12 true) (= result11 (ite (= o50 first_available1) true false)))))
...
(assert (=> (not (not (= first_available1 0))) (= result11 (ite (= o52 0) true false))))
(assert (=> (= result11 true) (=> (not (= first_allocated1 0)) (and (= o48 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range6 o48)))))
(assert (=> (= result11 true) (=> (not (= first_allocated1 0)) (= result13 (ite (< 0 o48) true false)))))
(assert (=> (= result11 true) (=> (not (= first_allocated1 0)) (=> (= result13 true) (and (= o47 (get (rec__list_allocator__m__t__allocated model____split_fields3) 1)) (in_range7 o47))))))
(assert (=> (= result11 true) (=> (not (= first_allocated1 0)) (=> (= result13 true) (= result10 (ite (= o47 first_allocated1) true false))))))
(assert (=> (= result11 true) (=> (not (= first_allocated1 0)) (=> (not (= result13 true)) (= result10 false)))))
(assert (=> (= result11 true) (=> (not (not (= first_allocated1 0))) (and (= o49 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range6 o49)))))
(assert (=> (= result11 true) (=> (not (not (= first_allocated1 0))) (= result10 (ite (= o49 0) true false)))))
