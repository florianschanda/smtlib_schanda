...
(declare-const stacks__get_model__3__result1 t1)
...
(declare-const stacks__get_model__3__result3 t1)
(declare-const stacks__get_model__3__result4 (Array Int element))
(declare-const stacks__get_model__3__result5 t1)
(declare-const stacks__get_model__3__result6 (Array Int element))
(declare-const stacks__get_model__3__result7 t1)
(declare-const stacks__get_model__3__result8 (Array Int element))
(declare-const stacks__get_model__3__result9 t1)
(declare-const stacks__get_model__3__result10 (Array Int element))
(declare-const stacks__get_model__3__result11 t1)
(define-fun stacks__get_model__3__result12 () us_t1 (mk___t1 stacks__get_model__3__result2 stacks__get_model__3__result3))
...
(assert (= (mk___t1 stacks__get_model__3__result6 stacks__get_model__3__result7) stacks__get_model__3__result12))
...
(assert (=> (= result true) (=> (= (length2 (mk___t2 temp___559 temp___5591)) 0) (= (mk (to_rep1 (first6 temp___5601)) (to_rep1 (last8 temp___5601))) temp___5611))))
(assert (=> (= result true) (=> (not (= (length2 (mk___t2 temp___559 temp___5591)) 0)) (=> (<= (to_rep1 (first6 temp___5601)) (to_rep1 (last8 temp___5601))) (= o2 (+ (- (to_rep1 (last8 temp___5601)) (to_rep1 (first6 temp___5601))) 1))))))
(assert (=> (= result true) (=> (not (= (length2 (mk___t2 temp___559 temp___5591)) 0)) (=> (not (<= (to_rep1 (first6 temp___5601)) (to_rep1 (last8 temp___5601)))) (= o2 0)))))
(assert (=> (= result true) (=> (not (= (length2 (mk___t2 temp___559 temp___5591)) 0)) (=> (<= (to_rep1 (first4 temp___5591)) (to_rep1 (last6 temp___5591))) (= o3 (+ (- (to_rep1 (last6 temp___5591)) (to_rep1 (first4 temp___5591))) 1))))))
(assert (=> (= result true) (=> (not (= (length2 (mk___t2 temp___559 temp___5591)) 0)) (=> (not (<= (to_rep1 (first4 temp___5591)) (to_rep1 (last6 temp___5591)))) (= o3 0)))))
...
(assert (=> (= result true) (=> (not (= (length2 (mk___t2 temp___559 temp___5591)) 0)) (and (= o7 o6) (in_range2 o6)))))
(assert (=> (= result true) (=> (not (= (length2 (mk___t2 temp___559 temp___5591)) 0)) (= (slide (concat1 temp___559 (to_rep1 (first4 temp___5591)) (to_rep1 (last6 temp___5591)) temp___560 (to_rep1 (first6 temp___5601)) (to_rep1 (last8 temp___5601))) (to_rep1 (first4 temp___5591)) 1) temp___561))))
(assert (=> (= result true) (=> (not (= (length2 (mk___t2 temp___559 temp___5591)) 0)) (= (mk 1 o7) temp___5611))))
(assert (=> (= result true) (dynamic_property1 1 2147483647 (to_rep1 (first temp___5611)) (to_rep1 (last temp___5611)))))
(assert (=> (= result true) (= temp___561 o9)))
(assert (=> (= result true) (= (mk1 (to_rep1 (first temp___5611)) (to_rep1 (last temp___5611))) o10)))
(assert (=> (not (= result true)) (and (= stacks__get_model__3__R89s (last4 s)) (and (in_range1 stacks__get_model__3__R89s) (= stacks__get_model__3__R89s (ite (not (= (wraps_around s) true)) (- (+ (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))) (to_rep2 (rec__stacks__stack_root__length1 (us_split_fields3 s)))) 1) (- (- (+ (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))) (to_rep2 (rec__stacks__stack_root__length1 (us_split_fields3 s)))) 1) 100)))))))
...
(assert (=> (not (= result true)) (dynamic_property1 1 2147483647 (to_rep1 (first8 temp___5641)) (to_rep1 (last10 temp___5641)))))
(assert (=> (not (= result true)) (= temp___564 o9)))
(assert (=> (not (= result true)) (= (mk1 (to_rep1 (first8 temp___5641)) (to_rep1 (last10 temp___5641))) o10)))
(assert (= result1 stacks__get_model__3__result))
(assert (= result2 stacks__get_model__3__result1))
(assert (= stacks__get_model__3__result12 (mk___t1 o9 o10)))
(assert (= (mk_model____ref (mk___t1 stacks__get_model__3__result8 stacks__get_model__3__result9)) (mk_model____ref (mk___t1 stacks__get_model__3__result4 stacks__get_model__3__result5))))
...
(assert (not (in_range1 (to_rep1 (first2 stacks__get_model__3__result9)))))
(check-sat)
(exit)
