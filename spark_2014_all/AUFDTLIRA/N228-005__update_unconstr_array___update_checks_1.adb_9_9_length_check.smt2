...
(assert (not (= (ite (<= (to_rep (first temp___3811)) (to_rep (last temp___3811))) (+ (- (to_rep (last temp___3811)) (to_rep (first temp___3811))) 1) 0) (ite (<= (to_rep a__first) (to_rep a__last)) (+ (- (to_rep a__last) (to_rep a__first)) 1) 0))))
(check-sat)
(exit)
