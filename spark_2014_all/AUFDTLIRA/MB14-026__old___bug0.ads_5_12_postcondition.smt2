...
(assert (and (and (and (and (= (mk_map__ref result) (mk_map__ref old__)) (= old__1 s)) (and (= (to_rep1 old____first) (to_rep1 (first (mk (to_rep1 s__first) (to_rep1 s__last))))) (= (to_rep1 old____last) (to_rep1 (last (mk (to_rep1 s__first) (to_rep1 s__last))))))) (and (dynamic_property 1 2147483647 (to_rep1 old____first) (to_rep1 old____last)) (= (bool_eq old__1 (to_rep1 old____first) (to_rep1 old____last) s (to_rep1 s__first) (to_rep1 s__last)) true))) (and (= old__1 old__2) (= old__3 old__1))))
