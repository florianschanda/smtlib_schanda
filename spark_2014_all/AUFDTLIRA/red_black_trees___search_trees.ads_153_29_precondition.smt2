...
(assert (type_invariant1 (mk___rep3 (us_split_fields__content3 t__split_fields12))))
(assert (type_invariant1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3))))
(assert (and (= o236 (peek1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)) i 1)) (and (in_range4 o236) (= o236 (peek (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) i 1)))))
(assert (and (= o237 o236) (in_range3 o236)))
(assert (type_invariant1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3))))
(assert (type_invariant1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3))))
(assert (and (= o238 (peek1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)) i 1)) (and (in_range4 o238) (= o238 (peek (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) i 1)))))
(assert (and (= o239 o238) (in_range3 o238)))
(assert (and (= o240 (peek1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)) o239 0)) (and (in_range4 o240) (= o240 (peek (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) o239 0)))))
(assert (and (= o241 o240) (in_range3 o240)))
(assert (not (not (= (parent1 (mk___rep3 (us_split_fields__content3 t__split_fields12)) o241) 0))))
(check-sat)
(exit)
