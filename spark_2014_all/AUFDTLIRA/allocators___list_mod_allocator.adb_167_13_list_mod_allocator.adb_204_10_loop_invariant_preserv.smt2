...
(assert (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 (+ i3 1))) (not (= (get c112b j3) (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select data2 (get c111b i3))))))))))
(assert (not (= i3 r114b)))
...
(assert (<= 1 j3))
(assert (<= j3 i4))
(assert (not (= (get c111b j3) (get c112b (+ j3 1)))))
(check-sat)
(exit)
