...
(declare-const temp___192 (Array Int natural))
(declare-const temp___1921 t1)
...
(declare-const temp___1922 (Array Int natural))
(declare-const temp___1923 t1)
...
(assert (= o1 values))
(assert (= o1 temp___192))
(assert (= (mk1 current1 (to_rep values__last)) temp___1921))
(assert (= temp___192 o2))
(assert (= (mk (to_rep (first2 temp___1921)) (to_rep (last2 temp___1921))) o3))
...
(assert (= smallest1 o4))
(assert (=> (not (= smallest1 current1)) (and (= o6 smallest1) (in_range4 smallest1))))
(assert (=> (not (= smallest1 current1)) (and (= o5 current1) (in_range4 current1))))
(assert (=> (not (= smallest1 current1)) (= (is_perm__logic (mk___t values (mk (to_rep values__first) (to_rep values__last))) (mk___t o11 (mk (to_rep values__first) (to_rep values__last)))) true)))
(assert (=> (not (not (= smallest1 current1))) (= o11 values)))
(assert (=> (not (not (= smallest1 current1))) (= o11 values1)))
(assert (= (is_perm__logic (mk___t values (mk (to_rep values__first) (to_rep values__last))) (mk___t values2 (mk (to_rep values__first) (to_rep values__last)))) true))
...
(assert (not (= current2 temp___190)))
...
(assert (= o7 values2))
(assert (= o7 temp___1922))
(assert (= (mk1 current3 (to_rep values__last)) temp___1923))
(assert (= temp___1922 o8))
(assert (= (mk (to_rep (first2 temp___1923)) (to_rep (last2 temp___1923))) o9))
...
(assert (not (in_range4 smallest3)))
(check-sat)
(exit)
