...
(assert (= o1 values))
(assert (= o1 temp___190))
(assert (= (mk1 current1 (to_rep values__last)) temp___1901))
(assert (= temp___190 o2))
(assert (= (mk (to_rep (first2 temp___1901)) (to_rep (last2 temp___1901))) o3))
...
(assert (not (in_range4 smallest1)))
(check-sat)
(exit)
