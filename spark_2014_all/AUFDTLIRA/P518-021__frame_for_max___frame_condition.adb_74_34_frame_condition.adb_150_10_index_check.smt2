...
(assert (<= i5 j3))
(assert (<= j3 first3))
(assert (and (= o61 i5) (in_range2 i5)))
(assert (and (= o62 (get_max_right o61 (map__content a8))) (and (in_range1 o62) (= o62 (to_rep (rec__frame_condition__cell__max_right (us_split_fields1 (select (map__content a8) o61))))))))
