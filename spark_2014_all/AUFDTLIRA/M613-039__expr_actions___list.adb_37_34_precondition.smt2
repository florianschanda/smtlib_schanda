...
(assert (and (= o11 (to__ (mk___rep s__split_fields10))) (dynamic_invariant1 o11 true false true)))
...
(assert (=> (= result4 true) (= temp___472 (mk___t2 o9 (mk2 first2 temp___470)))))
...
(assert (=> (= result4 true) (= temp___471 (mk___t1 o10 (mk1 first2 temp___469)))))
