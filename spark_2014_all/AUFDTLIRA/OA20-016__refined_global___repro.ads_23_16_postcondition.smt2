...
(declare-fun temp___382 ((Array Int cell)) (Array Int (Array Int cell)))
(declare-fun temp___386 (Int) (Array Int cell))
(assert (forall ((temp___384 (Array Int cell))) (forall ((temp___385 Int)) (= (select (temp___382 temp___384) temp___385) temp___384))))
...
(assert (forall ((temp___388 Int)) (=> (dynamic_invariant temp___388 true true true true) (forall ((temp___389 Int)) (= (to_rep (select (temp___386 temp___388) temp___389)) temp___388)))))
...
(assert (= cur_board1 (temp___382 (temp___386 0))))
