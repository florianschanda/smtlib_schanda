...
(define-fun bool_eq ((a (Array Int cell)) (a__first Int) (a__last Int) (b (Array Int cell)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_133 Int)) (=> (and (<= a__first temp___idx_133) (<= temp___idx_133 a__last)) (= (to_rep (select a temp___idx_133)) (to_rep (select b (+ (- b__first a__first) temp___idx_133))))))) true false))
...
(define-fun bool_eq1 ((a (Array Int (Array Int cell))) (a__first Int) (a__last Int) (b (Array Int (Array Int cell))) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_134 Int)) (=> (and (<= a__first temp___idx_134) (<= temp___idx_134 a__last)) (= (bool_eq (select a temp___idx_134) 1 10 (select b (+ (- b__first a__first) temp___idx_134)) 1 10) true)))) true false))
(assert (forall ((a (Array Int (Array Int cell))) (b (Array Int (Array Int cell)))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq1 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_134 Int)) (=> (and (<= a__first temp___idx_134) (<= temp___idx_134 a__last)) (= (bool_eq (select a temp___idx_134) 1 10 (select b (+ (- b__first a__first) temp___idx_134)) 1 10) true))))))))
...
(assert true)
(assert (forall ((b (Array Int (Array Int cell)))) (! (= (= (is_empty b) true) (forall ((y Int)) (=> (and (<= 1 y) (<= y 20)) (forall ((x Int)) (=> (and (<= 1 x) (<= x 10)) (= (to_rep (let ((temp___309 (select b y))) (select temp___309 x))) 0)))))) :pattern ((is_empty b)))))
...
(declare-fun temp___333 ((Array Int cell)) (Array Int (Array Int cell)))
(assert (forall ((temp___335 (Array Int cell))) (forall ((temp___336 Int)) (= (select (temp___333 temp___335) temp___336) temp___335))))
(declare-fun temp___337 (Int) (Array Int cell))
(assert (forall ((temp___339 Int)) (forall ((temp___340 Int)) (= (select (temp___337 temp___339) temp___340) (of_rep temp___339)))))
(define-fun dynamic_invariant ((temp___expr_268 Int) (temp___is_init_265 Bool) (temp___skip_constant_266 Bool) (temp___do_toplevel_267 Bool)) Bool (=> (or (= temp___is_init_265 true) (<= 0 7)) (in_range temp___expr_268)))
...
(assert (= cur_board1 (temp___333 (temp___337 0))))
