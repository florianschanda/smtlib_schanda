...
(assert (and (= o10 (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem)) (and (in_range6 o10) (= o10 (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem)))))
(assert (= o11 (select f o10)))
(assert (= o12 (to_rep4 o11)))
(assert (and (= o23 (get3 (model__1 (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields))) o12)) (= (bool_eq6 o23 (get3 (model__1 (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields))) o12)) true)))
(assert (= o13 o16))
(assert (= o14 o17))
(assert (= o15 o18))
(assert (= o19 o18))
...
(assert (and (= o24 (get3 (model__1 (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields))) o2)) (= (bool_eq6 o24 (get3 (model__1 (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields))) o2)) true)))
(assert (= o3 o6))
(assert (= o4 o7))
(assert (= o5 o8))
(assert (= o9 o6))
