...
(define-fun o23 () us_rep6 (mk___rep3 (mk___split_fields3 o13 o14 o15)))
(define-fun o24 () us_rep6 (mk___rep3 (mk___split_fields3 o3 o4 o5)))
...
(assert (and (= o10 (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem)) (and (in_range4 o10) (= o10 (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem)))))
(assert (= o11 (select f o10)))
(assert (= o12 (to_rep5 o11)))
(assert (and (= o23 (get3 (model__1 (mk___rep2 p__split_discrs (mk___split_fields2 p__split_fields))) o12)) (= (bool_eq5 o23 (get3 (model__1 (mk___rep2 p__split_discrs (mk___split_fields2 p__split_fields))) o12)) true)))
(assert (= o13 o16))
(assert (= o14 o17))
(assert (= o15 o18))
(assert (= o19 o18))
...
(assert (and (= o24 (get3 (model__1 (mk___rep2 p__split_discrs (mk___split_fields2 p__split_fields))) o2)) (= (bool_eq5 o24 (get3 (model__1 (mk___rep2 p__split_discrs (mk___split_fields2 p__split_fields))) o2)) true)))
(assert (= o3 o6))
(assert (= o4 o7))
(assert (= o5 o8))
(assert (= o9 o6))
(assert (= o21 (to_rep4 o9)))
(assert (= o22 (+ o21 o20)))
(assert (not (in_range7 o22)))
(check-sat)
(exit)
