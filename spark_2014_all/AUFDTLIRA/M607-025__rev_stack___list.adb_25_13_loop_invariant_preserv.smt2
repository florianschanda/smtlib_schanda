...
(assert (= i5 (+ i4 1)))
(assert (and (= o12 i5) (in_range5 i5)))
(assert (and (= o13 (get (model__ l) o12)) (and (in_range8 o13) (= o13 (get (model__ l) o12)))))
(assert (= (let ((temp___188 (to__ (mk___rep s__split_fields5)))) (bool_eq (elts temp___188) (to_rep (first (rt temp___188))) (to_rep (last (rt temp___188))) (let ((temp___187 (temp___182 o13))) (let ((temp___186 (to__ (mk___rep s__split_fields4)))) (ite (= (length temp___186) 0) temp___187 (concat1 (elts temp___186) (to_rep (first (rt temp___186))) (to_rep (last (rt temp___186))) temp___187 1 1)))) (to_rep (first (let ((temp___186 (to__ (mk___rep s__split_fields4)))) (ite (= (length temp___186) 0) (mk 1 1) (mk (to_rep (first (rt temp___186))) (- (+ (to_rep (first (rt temp___186))) (+ (ite (<= (to_rep (first (rt temp___186))) (to_rep (last (rt temp___186)))) (+ (- (to_rep (last (rt temp___186))) (to_rep (first (rt temp___186)))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0))) 1)))))) (to_rep (last (let ((temp___186 (to__ (mk___rep s__split_fields4)))) (ite (= (length temp___186) 0) (mk 1 1) (mk (to_rep (first (rt temp___186))) (- (+ (to_rep (first (rt temp___186))) (+ (ite (<= (to_rep (first (rt temp___186))) (to_rep (last (rt temp___186)))) (+ (- (to_rep (last (rt temp___186))) (to_rep (first (rt temp___186)))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0))) 1)))))))) true))
(assert (not (= (to_rep (last (rt (to__ (mk___rep s__split_fields5))))) (+ (- i5 first4) 1))))
(check-sat)
(exit)
