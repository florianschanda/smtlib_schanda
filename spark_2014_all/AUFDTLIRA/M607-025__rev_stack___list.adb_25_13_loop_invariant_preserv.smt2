...
(assert (= (let ((temp___188 (to__ (mk___rep s__split_fields5)))) (bool_eq (elts temp___188) (to_rep (first (rt temp___188))) (to_rep (last (rt temp___188))) (let ((temp___187 (temp___182 o3))) (let ((temp___186 (to__ (mk___rep s__split_fields4)))) (ite (= (length temp___186) 0) temp___187 (concat1 (elts temp___186) (to_rep (first (rt temp___186))) (to_rep (last (rt temp___186))) temp___187 1 1)))) (to_rep (first (let ((temp___186 (to__ (mk___rep s__split_fields4)))) (ite (= (length temp___186) 0) (mk 1 1) (mk (to_rep (first (rt temp___186))) (- (+ (to_rep (first (rt temp___186))) (+ (ite (<= (to_rep (first (rt temp___186))) (to_rep (last (rt temp___186)))) (+ (- (to_rep (last (rt temp___186))) (to_rep (first (rt temp___186)))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0))) 1)))))) (to_rep (last (let ((temp___186 (to__ (mk___rep s__split_fields4)))) (ite (= (length temp___186) 0) (mk 1 1) (mk (to_rep (first (rt temp___186))) (- (+ (to_rep (first (rt temp___186))) (+ (ite (<= (to_rep (first (rt temp___186))) (to_rep (last (rt temp___186)))) (+ (- (to_rep (last (rt temp___186))) (to_rep (first (rt temp___186)))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0))) 1)))))))) true))
