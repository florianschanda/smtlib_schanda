...
(assert (= (let ((temp___215 (to__ (mk___rep s__split_fields5)))) (bool_eq (elts temp___215) (to_rep (first (rt temp___215))) (to_rep (last (rt temp___215))) (let ((temp___214 (temp___209 o3))) (let ((temp___213 (to__ (mk___rep s__split_fields4)))) (ite (= (length temp___213) 0) temp___214 (concat1 (elts temp___213) (to_rep (first (rt temp___213))) (to_rep (last (rt temp___213))) temp___214 1 1)))) (to_rep (first (let ((temp___213 (to__ (mk___rep s__split_fields4)))) (ite (= (length temp___213) 0) (mk 1 1) (mk (to_rep (first (rt temp___213))) (- (+ (to_rep (first (rt temp___213))) (+ (ite (<= (to_rep (first (rt temp___213))) (to_rep (last (rt temp___213)))) (+ (- (to_rep (last (rt temp___213))) (to_rep (first (rt temp___213)))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0))) 1)))))) (to_rep (last (let ((temp___213 (to__ (mk___rep s__split_fields4)))) (ite (= (length temp___213) 0) (mk 1 1) (mk (to_rep (first (rt temp___213))) (- (+ (to_rep (first (rt temp___213))) (+ (ite (<= (to_rep (first (rt temp___213))) (to_rep (last (rt temp___213)))) (+ (- (to_rep (last (rt temp___213))) (to_rep (first (rt temp___213)))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0))) 1)))))))) true))
