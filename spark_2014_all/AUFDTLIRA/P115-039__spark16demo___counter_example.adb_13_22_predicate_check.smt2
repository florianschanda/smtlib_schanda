...
(declare-const temp___193 category)
...
(assert (not (<= (to_rep temp___1931) (to_rep (select (elts num_item_per_category) (to_rep1 temp___193))))))
(check-sat)
(exit)
