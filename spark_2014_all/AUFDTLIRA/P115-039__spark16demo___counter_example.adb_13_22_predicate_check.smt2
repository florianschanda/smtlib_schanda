...
(define-fun dynamic_invariant1 ((temp___expr_146 Int) (temp___is_init_143 Bool) (temp___skip_constant_144 Bool) (temp___do_toplevel_145 Bool)) Bool (=> (or (= temp___is_init_143 true) (<= 1 8)) (in_range2 temp___expr_146)))
...
(define-fun dynamic_invariant2 ((temp___expr_157 us_rep) (temp___is_init_154 Bool) (temp___skip_constant_155 Bool) (temp___do_toplevel_156 Bool)) Bool (=> (= temp___do_toplevel_156 true) (=> (= temp___is_init_154 true) (<= (to_rep (rec__counter_example__item__idx (us_split_fields1 temp___expr_157))) (to_rep (select (to_array num_item_per_category) (to_rep1 (rec__counter_example__item__cat (us_split_fields1 temp___expr_157)))))))))
...
(assert (forall ((cat Int)) (! (=> (dynamic_invariant1 cat true true true) (dynamic_invariant (pick_last cat) true false true)) :pattern ((pick_last cat)))))
(assert (forall ((cat Int)) (! (=> (dynamic_invariant1 cat true true true) (= (pick_last cat) (to_rep (select (to_array num_item_per_category) cat)))) :pattern ((pick_last cat)))))
...
(define-fun dynamic_invariant4 ((temp___expr_152 us_t) (temp___is_init_149 Bool) (temp___skip_constant_150 Bool) (temp___do_toplevel_151 Bool)) Bool (=> (not (= temp___skip_constant_150 true)) (dynamic_property 1 8 (first1 temp___expr_152) (last1 temp___expr_152))))
(declare-sort t3s 0)
...
(declare-const o5 category)
(declare-const o6 category)
...
(assert (not (<= (to_rep temp___1681) (to_rep (select (elts num_item_per_category) (to_rep1 temp___168))))))
(check-sat)
(exit)
