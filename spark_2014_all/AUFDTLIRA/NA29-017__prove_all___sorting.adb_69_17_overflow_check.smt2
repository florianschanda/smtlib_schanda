...
(assert (and (= o5 (+ a_first length1)) (in_range1 (+ a_first length1))))
(assert (= o6 (sorted (mk___t a (mk (to_rep a__first) (to_rep a__last))) o5 length2)))
(assert (= o4 (sorted (mk___t a (mk (to_rep a__first) (to_rep a__last))) a_first length1)))
(assert (and (= o2 (+ length1 length2)) (in_range1 (+ length1 length2))))
(assert (= o3 (ite (<= o2 2147483647) true false)))
(assert (=> (<= (to_rep b__first) (to_rep b__last)) (= o (+ (- (to_rep b__last) (to_rep b__first)) 1))))
