...
(assert (<= 1 j2))
(assert (<= j2 100))
(assert (not (= j2 (int__content v2))))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o79 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j2)) (and (in_range2 o79) (and (= o79 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 j2))))) (and (=> (= (valid_root (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j2) true) (= o79 0)) (=> (= (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) 0) (= o79 0)))))))
