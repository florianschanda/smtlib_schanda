...
(assert (= result6 (ite (= o46 (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)))) true false)))
(assert (= result6 true))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
...
(assert (= result8 (ite (= o45 0) true false)))
(assert (= result8 true))
(assert (<= 1 j))
(assert (<= j 100))
(assert (not (= j (int__content v2))))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o44 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j)) (and (in_range2 o44) (and (= o44 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 j))))) (and (=> (= (valid_root (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j) true) (= o44 0)) (=> (= (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) 0) (= o44 0)))))))
