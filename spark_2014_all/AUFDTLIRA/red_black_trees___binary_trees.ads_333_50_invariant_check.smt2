...
(assert (<= i4 100))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= result14 (valid_root (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i4)) (and (= (= result14 true) (and (<= i4 (to_rep f__split_fields)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 i4)))) 2))) (=> (< (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) i4) (not (= result14 true))))))
