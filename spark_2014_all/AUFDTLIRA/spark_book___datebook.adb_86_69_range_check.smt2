...
(assert (= (to_rep1 (first2 (rt1 (temp___397 32 1 (- 128 (length description)))))) 1))
(assert (= (to_rep1 (last2 (rt1 (temp___397 32 1 (- 128 (length description)))))) (- 128 (length description))))
(assert (= (mk___t1 temp___404 temp___4041) (temp___397 32 1 (- 128 (length description)))))
