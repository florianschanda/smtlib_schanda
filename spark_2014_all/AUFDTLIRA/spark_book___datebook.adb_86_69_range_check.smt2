...
(assert (= (to_rep1 (first2 (rt1 (temp___354 32 1 (- 128 (length description)))))) 1))
(assert (= (to_rep1 (last2 (rt1 (temp___354 32 1 (- 128 (length description)))))) (- 128 (length description))))
(assert (= (mk___t1 temp___361 temp___3611) (temp___354 32 1 (- 128 (length description)))))
(assert (not (= (length description) 0)))
(assert (=> (<= (to_rep1 (first2 temp___3611)) (to_rep1 (last2 temp___3611))) (= o2 (+ (- (to_rep1 (last2 temp___3611)) (to_rep1 (first2 temp___3611))) 1))))
(assert (=> (not (<= (to_rep1 (first2 temp___3611)) (to_rep1 (last2 temp___3611)))) (= o2 0)))
(assert (=> (<= (to_rep1 (first (rt description))) (to_rep1 (last (rt description)))) (= o3 (+ (- (to_rep1 (last (rt description))) (to_rep1 (first (rt description)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt description))) (to_rep1 (last (rt description))))) (= o3 0)))
(assert (= o4 (+ o3 o2)))
(assert (= o5 (+ (to_rep1 (first (rt description))) o4)))
(assert (= o6 (- o5 1)))
