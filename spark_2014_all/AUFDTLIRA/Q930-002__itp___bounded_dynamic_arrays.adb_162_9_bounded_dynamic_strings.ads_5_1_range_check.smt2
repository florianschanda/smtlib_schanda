...
(assert (and (= bounded_dynamic_strings__append__2__new_length__assume o7) (in_range5 o7)))
...
(assert (and (= (mk___t1 temp___1117 temp___11171) (value (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2))))) (and (dynamic_invariant (mk___t1 temp___1117 temp___11171) true false true) (and (and (= to____split_fields1 temp___1117) (= (mk1 (to_rep1 (first6 (mk3 1 (to_rep2 to____split_fields)))) (to_rep1 (last6 (mk3 1 (to_rep2 to____split_fields))))) temp___11171)) (and (and (and (= (length1 (mk___t1 temp___1117 temp___11171)) (length3 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2))))) (= (to_rep1 (first2 temp___11171)) 1)) (= (to_rep1 (last2 temp___11171)) (length3 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2)))))) (= (< 0 (length3 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2))))) (not (= (empty (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2)))) true))))))))
(assert (=> (= (length1 (mk___t1 temp___1117 temp___11171)) 0) (= (elts1 tail) temp___1118)))
(assert (=> (= (length1 (mk___t1 temp___1117 temp___11171)) 0) (= (mk (to_rep1 (first2 (rt1 tail))) (to_rep1 (last2 (rt1 tail)))) temp___11181)))
(assert (=> (not (= (length1 (mk___t1 temp___1117 temp___11171)) 0)) (=> (<= (to_rep1 (first2 (rt1 tail))) (to_rep1 (last2 (rt1 tail)))) (= o8 (+ (- (to_rep1 (last2 (rt1 tail))) (to_rep1 (first2 (rt1 tail)))) 1)))))
(assert (=> (not (= (length1 (mk___t1 temp___1117 temp___11171)) 0)) (=> (not (<= (to_rep1 (first2 (rt1 tail))) (to_rep1 (last2 (rt1 tail))))) (= o8 0))))
(assert (=> (not (= (length1 (mk___t1 temp___1117 temp___11171)) 0)) (=> (<= (to_rep1 (first2 temp___11171)) (to_rep1 (last2 temp___11171))) (= o9 (+ (- (to_rep1 (last2 temp___11171)) (to_rep1 (first2 temp___11171))) 1)))))
(assert (=> (not (= (length1 (mk___t1 temp___1117 temp___11171)) 0)) (=> (not (<= (to_rep1 (first2 temp___11171)) (to_rep1 (last2 temp___11171)))) (= o9 0))))
(assert (=> (not (= (length1 (mk___t1 temp___1117 temp___11171)) 0)) (= o10 (+ o9 o8))))
(assert (=> (not (= (length1 (mk___t1 temp___1117 temp___11171)) 0)) (= o11 (+ (to_rep1 (first2 temp___11171)) o10))))
(assert (=> (not (= (length1 (mk___t1 temp___1117 temp___11171)) 0)) (= o12 (- o11 1))))
(assert (=> (not (= (length1 (mk___t1 temp___1117 temp___11171)) 0)) (and (= o13 o12) (in_range2 o12))))
(assert (=> (not (= (length1 (mk___t1 temp___1117 temp___11171)) 0)) (= (concat1 temp___1117 (to_rep1 (first2 temp___11171)) (to_rep1 (last2 temp___11171)) (elts1 tail) (to_rep1 (first2 (rt1 tail))) (to_rep1 (last2 (rt1 tail)))) temp___1118)))
(assert (=> (not (= (length1 (mk___t1 temp___1117 temp___11171)) 0)) (= (mk (to_rep1 (first2 temp___11171)) o13) temp___11181)))
(assert (= (ite (<= (to_rep1 (first temp___11181)) (to_rep1 (last temp___11181))) (+ (- (to_rep1 (last temp___11181)) (to_rep1 (first temp___11181))) 1) 0) (ite (<= 1 new_length) (+ (- new_length 1) 1) 0)))
(assert (= (slide temp___1118 (to_rep1 (first temp___11181)) 1) temp___1119))
(assert (= (mk4 1 new_length) temp___11191))
(assert (<= 1 new_length))
