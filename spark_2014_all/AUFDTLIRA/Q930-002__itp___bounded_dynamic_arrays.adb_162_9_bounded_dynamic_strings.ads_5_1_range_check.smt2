...
(define-fun dynamic_invariant2 ((temp___expr_229 Int) (temp___is_init_225 Bool) (temp___skip_constant_226 Bool) (temp___do_toplevel_227 Bool) (temp___do_typ_inv_228 Bool)) Bool (=> (or (= temp___is_init_225 true) (<= 1 2147483647)) (in_range5 temp___expr_229)))
...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant3 this true true true true) (dynamic_invariant1 (length3 this) true false true true)) :pattern ((length3 this)))))
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant3 this true true true true) (= (length3 this) (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 this))))) :pattern ((length3 this)))))
...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant3 this true true true true) (let ((result (value this))) (and (and (and (and (= (length1 result) (length3 this)) (= (first3 result) 1)) (= (last3 result) (length3 this))) (= (< 0 (length3 this)) (not (= (empty this) true)))) (dynamic_invariant result true false true true)))) :pattern ((value this)))))
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant3 this true true true true) (= (value this) (let ((temp___263 (let ((temp___261 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 this))))) (let ((temp___260 1)) (let ((temp___262 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 this)))) (of_array3 (to_array2 temp___262) temp___260 temp___261)))))) (of_array1 (to_array3 temp___263) (first7 temp___263) (last7 temp___263))))) :pattern ((value this)))))
...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant3 this true true true true) (= (= (empty this) true) (= (length3 this) 0))) :pattern ((empty this)))))
...
(declare-const temp___1180 (Array Int character))
(declare-const temp___11801 t1)
...
(declare-const temp___1181 (Array Int character))
(declare-const temp___11811 t)
(declare-const temp___1182 (Array Int character))
(declare-const temp___11821 t4)
(define-fun temp___11802 () us_t1 (mk___t1 temp___1180 temp___11801))
(assert (dynamic_invariant3 i52s true false true true))
(assert (dynamic_invariant tail true false true true))
(assert (dynamic_invariant3 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2))) true false true true))
...
(assert (and (= o (length1 tail)) (in_range1 (length1 tail))))
(assert (= o1 (+ o (to_rep2 to____split_fields))))
(assert (and (= bounded_dynamic_strings__append__2__new_length__assume o1) (in_range5 o1)))
(assert (= bounded_dynamic_strings__append__2__new_length__assume new_length))
(assert (in_range5 new_length))
(assert (= (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity to____split_discrs)) r135b))
(assert (in_range4 r135b))
(assert (and (= temp___11802 (value (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2))))) (and (dynamic_invariant temp___11802 true false true true) (and (and (= to____split_fields1 temp___1180) (= (mk1 (to_rep1 (first6 (mk3 1 (to_rep2 to____split_fields)))) (to_rep1 (last6 (mk3 1 (to_rep2 to____split_fields))))) temp___11801)) (and (and (and (= (length1 temp___11802) (length3 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2))))) (= (to_rep1 (first2 temp___11801)) 1)) (= (to_rep1 (last2 temp___11801)) (length3 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2)))))) (= (< 0 (length3 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2))))) (not (= (empty (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2)))) true))))))))
(assert (=> (= (length1 temp___11802) 0) (= (elts1 tail) temp___1181)))
(assert (=> (= (length1 temp___11802) 0) (= (mk (to_rep1 (first2 (rt1 tail))) (to_rep1 (last2 (rt1 tail)))) temp___11811)))
(assert (=> (not (= (length1 temp___11802) 0)) (=> (<= (to_rep1 (first2 (rt1 tail))) (to_rep1 (last2 (rt1 tail)))) (= o2 (+ (- (to_rep1 (last2 (rt1 tail))) (to_rep1 (first2 (rt1 tail)))) 1)))))
(assert (=> (not (= (length1 temp___11802) 0)) (=> (not (<= (to_rep1 (first2 (rt1 tail))) (to_rep1 (last2 (rt1 tail))))) (= o2 0))))
(assert (=> (not (= (length1 temp___11802) 0)) (=> (<= (to_rep1 (first2 temp___11801)) (to_rep1 (last2 temp___11801))) (= o3 (+ (- (to_rep1 (last2 temp___11801)) (to_rep1 (first2 temp___11801))) 1)))))
(assert (=> (not (= (length1 temp___11802) 0)) (=> (not (<= (to_rep1 (first2 temp___11801)) (to_rep1 (last2 temp___11801)))) (= o3 0))))
(assert (=> (not (= (length1 temp___11802) 0)) (= o4 (+ o3 o2))))
(assert (=> (not (= (length1 temp___11802) 0)) (= o5 (+ (to_rep1 (first2 temp___11801)) o4))))
(assert (=> (not (= (length1 temp___11802) 0)) (= o6 (- o5 1))))
(assert (=> (not (= (length1 temp___11802) 0)) (and (= o7 o6) (in_range2 o6))))
(assert (=> (not (= (length1 temp___11802) 0)) (= (concat1 temp___1180 (to_rep1 (first2 temp___11801)) (to_rep1 (last2 temp___11801)) (elts1 tail) (to_rep1 (first2 (rt1 tail))) (to_rep1 (last2 (rt1 tail)))) temp___1181)))
(assert (=> (not (= (length1 temp___11802) 0)) (= (mk (to_rep1 (first2 temp___11801)) o7) temp___11811)))
(assert (= (ite (<= (to_rep1 (first temp___11811)) (to_rep1 (last temp___11811))) (+ (- (to_rep1 (last temp___11811)) (to_rep1 (first temp___11811))) 1) 0) (ite (<= 1 new_length) (+ (- new_length 1) 1) 0)))
(assert (= (slide temp___1181 (to_rep1 (first temp___11811)) 1) temp___1182))
(assert (= (mk4 1 new_length) temp___11821))
(assert (<= 1 new_length))
(assert (not (<= (to_rep1 (first4 to____split_fields2)) 1)))
(check-sat)
(exit)
