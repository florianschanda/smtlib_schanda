...
(assert (and (= o2 (remove b o1)) (and (dynamic_invariant2 o2 true false true true) (and (= (invariant__ o2) true) (and (= (to_rep2 (last (rt o2))) (- (to_rep2 (last (rt b))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- o1 1))) (= (to_rep (select (elts b) k1)) (to_rep (select (elts o2) k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ o1 1) k1) (<= k1 (to_rep2 (last (rt b))))) (= (to_rep (select (elts b) k1)) (to_rep (select (elts o2) (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= o1 k1) (<= k1 (- (to_rep2 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k1 1))) (to_rep (select (elts o2) k1))))))))))))
(assert (not (in_range4 k)))
(check-sat)
(exit)
