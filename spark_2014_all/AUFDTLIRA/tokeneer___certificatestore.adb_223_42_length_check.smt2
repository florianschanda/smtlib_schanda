...
(assert (= (ite (<= (to_rep1 (first2 temp___14451)) (to_rep1 (last2 temp___14451))) (+ (- (to_rep1 (last2 temp___14451)) (to_rep1 (first2 temp___14451))) 1) 0) (ite (<= (to_rep1 (first2 temp___14471)) (to_rep1 (last2 temp___14471))) (+ (- (to_rep1 (last2 temp___14471)) (to_rep1 (first2 temp___14471))) 1) 0)))
(assert (= (mk___t1 temp___1448 temp___14481) (mk___t1 temp___1445 temp___14451)))
(assert (forall ((temp___1449 Int)) (ite (and (<= 1 temp___1449) (<= temp___1449 r6b)) (= (select o6 temp___1449) (select temp___1448 temp___1449)) (= (select o6 temp___1449) (select text temp___1449)))))
(assert (= result2 text))
(assert (= text1 o6))
(assert (= (+ length6 1) r13b))
(assert (in_range r13b))
(assert (= (to_rep1 (first8 (rt4 (temp___1450 32 r13b 10)))) r13b))
(assert (= (to_rep1 (last8 (rt4 (temp___1450 32 r13b 10)))) 10))
(assert (= (mk___t4 temp___1457 temp___14571) (temp___1450 32 r13b 10)))
(assert (= (ite (<= (to_rep1 (first8 temp___14571)) (to_rep1 (last8 temp___14571))) (+ (- (to_rep1 (last8 temp___14571)) (to_rep1 (first8 temp___14571))) 1) 0) (ite (<= r13b 10) (+ (- 10 r13b) 1) 0)))
(assert (= (slide temp___1457 (to_rep1 (first8 temp___14571)) r13b) temp___1458))
(assert (= (mk3 r13b 10) temp___14581))
(assert (=> (<= r13b 10) (and (and (<= 1 r13b) (<= r13b 10)) (and (<= 1 10) (<= 10 10)))))
(assert (= o7 text1))
(assert (= o7 temp___1460))
(assert (= (mk3 r13b 10) temp___14601))
(assert (not (= (ite (<= (to_rep1 (first6 temp___14581)) (to_rep1 (last6 temp___14581))) (+ (- (to_rep1 (last6 temp___14581)) (to_rep1 (first6 temp___14581))) 1) 0) (ite (<= (to_rep1 (first6 temp___14601)) (to_rep1 (last6 temp___14601))) (+ (- (to_rep1 (last6 temp___14601)) (to_rep1 (first6 temp___14601))) 1) 0))))
(check-sat)
(exit)
