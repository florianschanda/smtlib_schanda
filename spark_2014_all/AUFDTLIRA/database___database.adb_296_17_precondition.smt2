...
(assert (and (= o10 (currency account accounts_balance)) (and (in_range o10) (= o10 (to_rep (rec__money__amount__currency (us_split_fields1 (rec__database__account_balance__value (us_split_fields5 (select accounts_balance account))))))))))
(assert (= o11 (ite (= o10 (to_rep (rec__money__amount__currency (us_split_fields1 sum)))) true false)))
