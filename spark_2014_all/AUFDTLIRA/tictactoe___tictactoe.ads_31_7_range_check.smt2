...
(define-fun dynamic_invariant1 ((temp___expr_591 Int) (temp___is_init_587 Bool) (temp___skip_constant_588 Bool) (temp___do_toplevel_589 Bool) (temp___do_typ_inv_590 Bool)) Bool (=> (or (= temp___is_init_587 true) (<= 1 3)) (in_range3 temp___expr_591)))
...
(define-fun dynamic_invariant3 ((temp___expr_584 Int) (temp___is_init_580 Bool) (temp___skip_constant_581 Bool) (temp___do_toplevel_582 Bool) (temp___do_typ_inv_583 Bool)) Bool (=> (or (= temp___is_init_580 true) (<= 0 2)) (in_range1 temp___expr_584)))
