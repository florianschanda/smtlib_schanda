...
(assert (not (= (ite (<= (to_rep (first temp___2783)) (to_rep (last temp___2783))) (+ (- (to_rep (last temp___2783)) (to_rep (first temp___2783))) 1) 0) (ite (<= (to_rep (first temp___2823)) (to_rep (last temp___2823))) (+ (- (to_rep (last temp___2823)) (to_rep (first temp___2823))) 1) 0))))
(check-sat)
(exit)
