...
(assert (not (= (ite (<= (to_rep (first temp___2701)) (to_rep (last temp___2701))) (+ (- (to_rep (last temp___2701)) (to_rep (first temp___2701))) 1) 0) (ite (<= (to_rep (first temp___2741)) (to_rep (last temp___2741))) (+ (- (to_rep (last temp___2741)) (to_rep (first temp___2741))) 1) 0))))
(check-sat)
(exit)
