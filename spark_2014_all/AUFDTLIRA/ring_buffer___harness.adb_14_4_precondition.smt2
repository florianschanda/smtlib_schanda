...
(assert (and (and (= (to_rep1 r__split_fields9) (- (to_rep1 r__split_fields6) 1)) (= (head (mk___rep (mk___split_fields r__split_fields4 r__split_fields5 r__split_fields6))) h1)) (in_range h1)))
(assert (= h1 x))
(assert (not (not (= (is_full (mk___rep (mk___split_fields r__split_fields7 r__split_fields8 r__split_fields9))) true))))
(check-sat)
(exit)
