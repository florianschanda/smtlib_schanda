...
(assert (and (= o (rolepresent (mk___rep1 (mk___split_fields1 theadmin__split_fields theadmin__split_fields1)))) (in_range9 o)))
(assert (= result (ite (= o 1) true false)))
(assert (= result true))
(assert (= o1 (isdoingop (mk___rep1 (mk___split_fields1 theadmin__split_fields theadmin__split_fields1)))))
(assert (= o2 (ite (not (= o1 true)) true false)))
(assert (not (= (isdoingop (mk___rep1 (mk___split_fields1 theadmin__split_fields theadmin__split_fields1))) true)))
(check-sat)
(exit)
