...
(assert (forall ((temp___267 Int) (temp___268 Int) (temp___269 Int)) (let ((temp___266 (temp___265 temp___267 temp___268 temp___269))) (=> (dynamic_invariant4 temp___267 true true true true) (and (=> (dynamic_property 1 2147483647 temp___268 temp___269) (and (= (first3 temp___266) temp___268) (= (last3 temp___266) temp___269))) (forall ((temp___270 Int)) (= (to_rep (select (to_array1 temp___266) temp___270)) temp___267)))))))
...
(assert (= (to_rep1 (first2 (rt1 (temp___265 0 (to_rep1 change__first) (to_rep1 change__last))))) (to_rep1 change__first)))
(assert (= (to_rep1 (last2 (rt1 (temp___265 0 (to_rep1 change__first) (to_rep1 change__last))))) (to_rep1 change__last)))
(assert (= (mk___t1 temp___272 temp___2721) (temp___265 0 (to_rep1 change__first) (to_rep1 change__last))))
...
(assert (not (= (ite (<= (to_rep1 (first4 temp___2771)) (to_rep1 (last4 temp___2771))) (+ (- (to_rep1 (last4 temp___2771)) (to_rep1 (first4 temp___2771))) 1) 0) (ite (<= (to_rep1 (first4 temp___2791)) (to_rep1 (last4 temp___2791))) (+ (- (to_rep1 (last4 temp___2791)) (to_rep1 (first4 temp___2791))) 1) 0))))
(check-sat)
(exit)
