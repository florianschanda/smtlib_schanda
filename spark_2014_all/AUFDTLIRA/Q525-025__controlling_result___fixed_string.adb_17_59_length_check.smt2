...
(assert (not (= (ite (<= (to_rep1 (first4 temp___2541)) (to_rep1 (last4 temp___2541))) (+ (- (to_rep1 (last4 temp___2541)) (to_rep1 (first4 temp___2541))) 1) 0) (ite (<= (to_rep1 (first4 temp___2561)) (to_rep1 (last4 temp___2561))) (+ (- (to_rep1 (last4 temp___2561)) (to_rep1 (first4 temp___2561))) 1) 0))))
(check-sat)
(exit)
