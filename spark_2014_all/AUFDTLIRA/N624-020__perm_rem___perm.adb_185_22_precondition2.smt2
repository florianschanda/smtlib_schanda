...
(assert (and (= (invariant__ a) true) (and (= (invariant__ b) true) (and (= (invariant__ c) true) (and (= (bool_eq (elts c) (to_rep (first (rt c))) (to_rep (last (rt c))) (elts b) (to_rep (first (rt b))) (to_rep (last (rt b)))) true) (= (is_perm a b) true))))))
