...
(assert (and (= temp___221 (remove o119 o120)) (and (dynamic_invariant4 temp___221 true false true) (and (= (invariant__ temp___221) true) (and (= (to_rep1 (last (rt temp___221))) (- (to_rep1 (last (rt o119))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o120 1))) (= (to_rep (select (elts o119) k)) (to_rep (select (elts temp___221) k))))) (and (forall ((k Int)) (=> (and (<= (+ o120 1) k) (<= k (to_rep1 (last (rt o119))))) (= (to_rep (select (elts o119) k)) (to_rep (select (elts temp___221) (- k 1)))))) (forall ((k Int)) (=> (and (<= o120 k) (<= k (- (to_rep1 (last (rt o119))) 1))) (= (to_rep (select (elts o119) (+ k 1))) (to_rep (select (elts temp___221) k))))))))))))
