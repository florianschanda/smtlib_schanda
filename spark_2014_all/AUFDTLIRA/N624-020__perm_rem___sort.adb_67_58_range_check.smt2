...
(assert (and (= temp___221 (remove o23 o24)) (and (dynamic_invariant4 temp___221 true false true) (and (= (invariant__ temp___221) true) (and (= (to_rep1 (last (rt temp___221))) (- (to_rep1 (last (rt o23))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o24 1))) (= (to_rep (select (elts o23) k)) (to_rep (select (elts temp___221) k))))) (and (forall ((k Int)) (=> (and (<= (+ o24 1) k) (<= k (to_rep1 (last (rt o23))))) (= (to_rep (select (elts o23) k)) (to_rep (select (elts temp___221) (- k 1)))))) (forall ((k Int)) (=> (and (<= o24 k) (<= k (- (to_rep1 (last (rt o23))) 1))) (= (to_rep (select (elts o23) (+ k 1))) (to_rep (select (elts temp___221) k))))))))))))
