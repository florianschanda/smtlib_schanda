...
(assert (=> (<= (to_rep1 new_sub__first) (to_rep1 new_sub__last)) (= o11 (+ (- (to_rep1 new_sub__last) (to_rep1 new_sub__first)) 1))))
(assert (=> (not (<= (to_rep1 new_sub__first) (to_rep1 new_sub__last))) (= o11 0)))
(assert (and (= o12 o11) (in_range1 o11)))
(assert (= o13 (- (to_rep1 new_str__last) o12)))
(assert (and (= o14 o13) (in_range1 o13)))
(assert (= o15 (+ o14 1)))
(assert (and (= o16 o15) (in_range1 o15)))
(assert (= result3 (ite (<= pos1 o16) true false)))
(assert (= result3 true))
(assert (<= pos1 fb20a00__find__L_2__R7b))
(assert (not (<= (to_rep1 new_str__first) pos1)))
(check-sat)
(exit)
