...
(assert (and (= temp___2042 (upper_case str)) (dynamic_invariant1 temp___2042 true false true)))
...
(assert (= new_str1 o2))
(assert (and (= temp___2062 (upper_case sub)) (dynamic_invariant1 temp___2062 true false true)))
