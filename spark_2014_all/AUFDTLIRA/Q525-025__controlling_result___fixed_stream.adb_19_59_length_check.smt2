...
(assert (not (= (ite (<= (to_rep1 (first4 temp___2961)) (to_rep1 (last4 temp___2961))) (+ (- (to_rep1 (last4 temp___2961)) (to_rep1 (first4 temp___2961))) 1) 0) (ite (<= (to_rep1 (first4 temp___2981)) (to_rep1 (last4 temp___2981))) (+ (- (to_rep1 (last4 temp___2981)) (to_rep1 (first4 temp___2981))) 1) 0))))
(check-sat)
(exit)
