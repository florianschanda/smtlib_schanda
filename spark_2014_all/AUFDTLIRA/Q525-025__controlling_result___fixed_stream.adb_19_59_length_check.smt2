...
(assert (not (= (ite (<= (to_rep1 (first4 temp___3201)) (to_rep1 (last4 temp___3201))) (+ (- (to_rep1 (last4 temp___3201)) (to_rep1 (first4 temp___3201))) 1) 0) (ite (<= (to_rep1 (first4 temp___3221)) (to_rep1 (last4 temp___3221))) (+ (- (to_rep1 (last4 temp___3221)) (to_rep1 (first4 temp___3221))) 1) 0))))
(check-sat)
(exit)
