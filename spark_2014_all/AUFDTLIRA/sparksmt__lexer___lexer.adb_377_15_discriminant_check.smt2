...
(assert (= (to_rep2 o4) current_line2))
(assert (= o5 (mk___split_fields2 o4 o3 o2 dummy11)))
(assert (= (to_rep5 o) 0))
(assert (= o6 (mk___split_discrs2 o)))
(assert (= temp___831 (mk___rep2 o6 o5 true)))
(assert (= t__attr__constrained true))
(assert (not (= (rec__lexer__token__kind (us_split_discrs5 temp___831)) (rec__lexer__token__kind t__split_discrs1))))
(check-sat)
(exit)
