...
(assert (= o6 i2))
(assert (= o7 (select rawaccesspolicy1 o6)))
(assert (= o8 (to_rep o7)))
(assert (and (<= 1 i2) (<= i2 12)))
(assert (= o4 i2))
(assert (= o5 (select (rec__configdata__accessstringt__text (us_split_fields1 (select accessstringlookup ap1))) o4)))
(assert (= o9 (to_rep o5)))
(assert (= o10 (ite (= o9 o8) true false)))
(assert (= result8 (ite (not (= o10 true)) true false)))
