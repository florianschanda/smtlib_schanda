...
(assert (and (and (and (and (not (= (select winners3 0) true)) (< latest_highest_score2 i2)) (= (select winners3 latest_highest_score2) true)) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 (- i2 1))) (=> (< latest_highest_score2 j2) (< (to_rep (select counters j2)) (to_rep (select counters latest_highest_score2))))))) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 (- i2 1))) (ite (= (select winners3 j2) true) (= (to_rep (select counters latest_highest_score2)) (to_rep (select counters j2))) (< (to_rep (select counters j2)) (to_rep (select counters latest_highest_score2))))))))
...
(assert (<= 0 k))
(assert (<= k (- j1 1)))
(assert (not (not (= (select winners3 k) true))))
(check-sat)
(exit)
