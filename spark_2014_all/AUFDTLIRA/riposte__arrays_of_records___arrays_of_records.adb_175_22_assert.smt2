...
(declare-const o19 value)
(declare-const o20 Bool)
(declare-const o21 value)
(declare-const o22 value)
...
(assert (= (rec__arrays_of_records__basic_record__first_value (us_split_fields1 (select a i))) o2))
(assert (= o o3))
(assert (= o4 o1))
(assert (= o5 o2))
(assert (= o6 o3))
...
(assert (= a1 o7))
(assert (= (to_rep o8) 23))
(assert (= (rec__arrays_of_records__basic_record__flag (us_split_fields1 (select a1 i))) o9))
(assert (= o8 o10))
(assert (= (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select a1 i))) o11))
(assert (= o12 o9))
(assert (= o13 o10))
(assert (= o14 o11))
...
(assert (= a1 result1))
(assert (= a2 o15))
(assert (= (to_rep o16) 42))
(assert (= (rec__arrays_of_records__basic_record__flag (us_split_fields1 (select a2 j))) o17))
(assert (= o16 o18))
(assert (= (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select a2 j))) o19))
(assert (= o20 o17))
(assert (= o21 o18))
(assert (= o22 o19))
(assert (= o23 (store a2 j (mk___rep (mk___split_fields o20 o21 o22)))))
(assert (= a2 result2))
(assert (= a3 o23))
(assert (= a3 result3))
(assert (= a4 (store a3 i (mk___rep (mk___split_fields (distinct 1 0) (rec__arrays_of_records__basic_record__first_value (us_split_fields1 (select a3 i))) (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select a3 i))))))))
