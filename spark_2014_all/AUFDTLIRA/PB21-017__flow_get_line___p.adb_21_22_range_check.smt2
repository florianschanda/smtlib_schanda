...
(assert (= l1 0))
(assert (in_range3 l1))
(assert (and (= (mk___t p__pt__dummy2__nested__B_1__s__assume p__pt__dummy2__nested__B_1__s__assume1) (get_line__4 Tuple0)) (dynamic_invariant1 (mk___t p__pt__dummy2__nested__B_1__s__assume p__pt__dummy2__nested__B_1__s__assume1) true false true)))
(assert (= (mk___t p__pt__dummy2__nested__B_1__s__assume p__pt__dummy2__nested__B_1__s__assume1) s))
