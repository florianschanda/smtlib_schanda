...
(define-fun p__pt__dummy2__nested__B_1__s__assume2 () us_t (mk___t p__pt__dummy2__nested__B_1__s__assume p__pt__dummy2__nested__B_1__s__assume1))
(assert (= result l))
(assert (= l1 0))
(assert (in_range3 l1))
(assert (and (= p__pt__dummy2__nested__B_1__s__assume2 (get_line__4 Tuple0)) (dynamic_invariant1 p__pt__dummy2__nested__B_1__s__assume2 true false true true)))
