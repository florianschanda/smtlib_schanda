...
(assert (and (= o13 (remove bb ib2)) (and (dynamic_invariant2 o13 true false true true) (and (= (invariant__ o13) true) (and (= (to_rep1 (last o12)) (- (to_rep1 (last (rt bb))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib2 1))) (= (to_rep (select (elts bb) k)) (to_rep (select o11 k))))) (and (forall ((k Int)) (=> (and (<= (+ ib2 1) k) (<= k (to_rep1 (last (rt bb))))) (= (to_rep (select (elts bb) k)) (to_rep (select o11 (- k 1)))))) (forall ((k Int)) (=> (and (<= ib2 k) (<= k (- (to_rep1 (last (rt bb))) 1))) (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select o11 k))))))))))))
(assert (and (= o14 (remove aa ia21)) (and (dynamic_invariant2 o14 true false true true) (and (= (invariant__ o14) true) (and (= (to_rep1 (last o10)) (- (to_rep1 (last (rt aa))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ia21 1))) (= (to_rep (select (elts aa) k)) (to_rep (select o9 k))))) (and (forall ((k Int)) (=> (and (<= (+ ia21 1) k) (<= k (to_rep1 (last (rt aa))))) (= (to_rep (select (elts aa) k)) (to_rep (select o9 (- k 1)))))) (forall ((k Int)) (=> (and (<= ia21 k) (<= k (- (to_rep1 (last (rt aa))) 1))) (= (to_rep (select (elts aa) (+ k 1))) (to_rep (select o9 k))))))))))))
(assert (and (= o6 (- ib 1)) (in_range3 (- ib 1))))
(assert (and (= o15 (remove bb2 o6)) (and (dynamic_invariant2 o15 true false true true) (and (= (invariant__ o15) true) (and (= (to_rep1 (last o8)) (- (to_rep1 (last (rt bb2))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o6 1))) (= (to_rep (select (elts bb2) k)) (to_rep (select o7 k))))) (and (forall ((k Int)) (=> (and (<= (+ o6 1) k) (<= k (to_rep1 (last (rt bb2))))) (= (to_rep (select (elts bb2) k)) (to_rep (select o7 (- k 1)))))) (forall ((k Int)) (=> (and (<= o6 k) (<= k (- (to_rep1 (last (rt bb2))) 1))) (= (to_rep (select (elts bb2) (+ k 1))) (to_rep (select o7 k))))))))))))
