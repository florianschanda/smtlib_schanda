...
(assert (forall ((us_void_param tuple0)) (! (dynamic_invariant1 (get_line__4 us_void_param) true false true) :pattern ((get_line__4 us_void_param)))))
(declare-sort slot 0)
...
(assert (forall ((x pos)) (! (in_range5 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(declare-fun concat2 ((Array Int slot) Int Int (Array Int slot) Int Int) (Array Int slot))
...
(assert (forall ((v slot)) (forall ((i Int)) (! (= (select (singleton2 v i) i) v) :pattern ((select (singleton2 v i) i))))))
...
(declare-fun compare1 ((Array Int slot) Int Int (Array Int slot) Int Int) Int)
(assert (forall ((a (Array Int slot)) (b (Array Int slot))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare1 a a_first a_last b b_first b_last) 0) (= (bool_eq2 a a_first a_last b b_first b_last) true)) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int slot)) (b (Array Int slot))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare1 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq2 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep2 (select a (+ i 1))) (to_rep2 (select b (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int slot)) (b (Array Int slot))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare1 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq2 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep2 (select b (+ i 1))) (to_rep2 (select a (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
...
(declare-fun concat3 ((Array Int (Array Int slot)) Int Int (Array Int (Array Int slot)) Int Int) (Array Int (Array Int slot)))
...
(assert (forall ((v (Array Int slot))) (forall ((i Int)) (! (= (select (singleton3 v i) i) v) :pattern ((select (singleton3 v i) i))))))
(define-fun bool_eq3 ((a (Array Int (Array Int slot))) (a__first Int) (a__last Int) (b (Array Int (Array Int slot))) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_152 Int)) (=> (and (<= a__first temp___idx_152) (<= temp___idx_152 a__last)) (= (bool_eq2 (select a temp___idx_152) 1 3 (select b (+ (- b__first a__first) temp___idx_152)) 1 3) true)))) true false))
(assert (forall ((a (Array Int (Array Int slot))) (b (Array Int (Array Int slot)))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq3 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_152 Int)) (=> (and (<= a__first temp___idx_152) (<= temp___idx_152 a__last)) (= (bool_eq2 (select a temp___idx_152) 1 3 (select b (+ (- b__first a__first) temp___idx_152)) 1 3) true))))))))
...
(define-fun dynamic_invariant2 ((temp___expr_33 Int) (temp___is_init_30 Bool) (temp___skip_constant_31 Bool) (temp___do_toplevel_32 Bool)) Bool (=> (or (= temp___is_init_30 true) (<= 0 2147483647)) (in_range6 temp___expr_33)))
...
(assert (forall ((tictactoe__my_board (Array Int (Array Int slot)))) (! (dynamic_invariant2 (num_free_slots tictactoe__my_board) true false true) :pattern ((num_free_slots tictactoe__my_board)))))
...
(define-fun bool_eq5 ((a (Array Int us_rep)) (a__first Int) (a__last Int) (b (Array Int us_rep)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_153 Int)) (=> (and (<= a__first temp___idx_153) (<= temp___idx_153 a__last)) (= (bool_eq4 (select a temp___idx_153) (select b (+ (- b__first a__first) temp___idx_153))) true)))) true false))
(assert (forall ((a (Array Int us_rep)) (b (Array Int us_rep))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq5 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_153 Int)) (=> (and (<= a__first temp___idx_153) (<= temp___idx_153 a__last)) (= (bool_eq4 (select a temp___idx_153) (select b (+ (- b__first a__first) temp___idx_153))) true))))))))
...
(declare-fun concat5 ((Array Int (Array Int us_rep)) Int Int (Array Int (Array Int us_rep)) Int Int) (Array Int (Array Int us_rep)))
...
(declare-fun singleton5 ((Array Int us_rep) Int) (Array Int (Array Int us_rep)))
(assert (forall ((v (Array Int us_rep))) (forall ((i Int)) (! (= (select (singleton5 v i) i) v) :pattern ((select (singleton5 v i) i))))))
(define-fun bool_eq6 ((a (Array Int (Array Int us_rep))) (a__first Int) (a__last Int) (b (Array Int (Array Int us_rep))) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (bool_eq5 (select a temp___idx_154) 1 3 (select b (+ (- b__first a__first) temp___idx_154)) 1 3) true)))) true false))
(assert (forall ((a (Array Int (Array Int us_rep))) (b (Array Int (Array Int us_rep)))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq6 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (bool_eq5 (select a temp___idx_154) 1 3 (select b (+ (- b__first a__first) temp___idx_154)) 1 3) true))))))))
...
(define-fun dynamic_invariant3 ((temp___expr_519 Int) (temp___is_init_516 Bool) (temp___skip_constant_517 Bool) (temp___do_toplevel_518 Bool)) Bool (=> (or (= temp___is_init_516 true) (<= 0 2)) (in_range4 temp___expr_519)))
(assert (forall ((tictactoe__my_board (Array Int (Array Int slot)))) (forall ((tictactoe__all_solutions (Array Int (Array Int us_rep)))) (! (dynamic_invariant3 (won tictactoe__my_board tictactoe__all_solutions) true false true) :pattern ((won tictactoe__my_board tictactoe__all_solutions))))))
...
(define-fun dynamic_invariant6 ((temp___expr_525 Int) (temp___is_init_522 Bool) (temp___skip_constant_523 Bool) (temp___do_toplevel_524 Bool)) Bool (=> (or (= temp___is_init_522 true) (<= 1 3)) (in_range5 temp___expr_525)))
...
(assert (forall ((x Int) (y Int)) (forall ((tictactoe__my_board (Array Int (Array Int slot)))) (! (=> (and (dynamic_invariant6 x true true true) (dynamic_invariant6 y true true true)) (dynamic_invariant4 (one_free_slot x y tictactoe__my_board) true false true)) :pattern ((one_free_slot x y tictactoe__my_board))))))
(assert (forall ((x Int) (y Int)) (forall ((tictactoe__my_board (Array Int (Array Int slot)))) (! (=> (and (dynamic_invariant6 x true true true) (dynamic_invariant6 y true true true)) (= (one_free_slot x y tictactoe__my_board) (ite (= (to_rep2 (let ((temp___554 (select tictactoe__my_board x))) (select temp___554 y))) 0) 1 0))) :pattern ((one_free_slot x y tictactoe__my_board))))))
(assert (forall ((x Int) (y Int)) (forall ((tictactoe__my_board (Array Int (Array Int slot)))) (! (=> (and (dynamic_invariant6 x true true true) (dynamic_invariant6 y true true true)) (dynamic_invariant4 (count_free_slots x y tictactoe__my_board) true false true)) :pattern ((count_free_slots x y tictactoe__my_board))))))
(assert (forall ((x Int) (y Int)) (forall ((tictactoe__my_board (Array Int (Array Int slot)))) (! (=> (and (dynamic_invariant6 x true true true) (dynamic_invariant6 y true true true)) (= (count_free_slots x y tictactoe__my_board) (+ (+ (+ (+ (one_free_slot 1 1 tictactoe__my_board) (ite (<= 2 y) (one_free_slot 1 2 tictactoe__my_board) 0)) (ite (<= 3 y) (one_free_slot 1 3 tictactoe__my_board) 0)) (ite (<= 2 x) (+ (+ (one_free_slot 2 1 tictactoe__my_board) (ite (<= 2 y) (one_free_slot 2 2 tictactoe__my_board) 0)) (ite (<= 3 y) (one_free_slot 2 3 tictactoe__my_board) 0)) 0)) (ite (<= 3 x) (+ (+ (one_free_slot 3 1 tictactoe__my_board) (ite (<= 2 y) (one_free_slot 3 2 tictactoe__my_board) 0)) (ite (<= 3 y) (one_free_slot 3 3 tictactoe__my_board) 0)) 0)))) :pattern ((count_free_slots x y tictactoe__my_board))))))
...
(assert (and (= p__split_fields temp___785) (= p__split_fields1 temp___7851)))
(assert (and (= tictactoe__player_play__B_2__s__assume2 (get_line__4 Tuple0)) (dynamic_invariant1 tictactoe__player_play__B_2__s__assume2 true false true)))
...
(assert (=> (= c1 49) (= result5 (mk___split_fields__ref p__split_fields3))))
(assert (=> (= c1 49) (= p__split_fields4 (mk___split_fields temp___774 temp___7741))))
...
(assert (=> (not (= c1 49)) (=> (= c1 50) (= result6 (mk___split_fields__ref p__split_fields3)))))
(assert (=> (not (= c1 49)) (=> (= c1 50) (= p__split_fields5 (mk___split_fields temp___775 temp___7751)))))
(assert (=> (not (= c1 49)) (=> (= c1 50) (= found2 found1))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (= c1 51) (= (to_rep3 o16) 1)))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (= c1 51) (= (to_rep3 o17) 3)))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (= c1 51) (= o17 o18)))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (= c1 51) (= o16 o19)))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (= c1 51) (= temp___776 o18)))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (= c1 51) (= temp___7761 o19)))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (= c1 51) (= result7 (mk___split_fields__ref p__split_fields3))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (= c1 51) (= p__split_fields6 (mk___split_fields temp___776 temp___7761))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (= c1 51) (= found2 found1)))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (= c1 52) (= (to_rep3 o20) 2))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (= c1 52) (= (to_rep3 o21) 1))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (= c1 52) (= o22 (mk___split_fields o21 o20)))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (= c1 52) (= temp___777 (mk___rep o22)))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (= c1 52) (= result8 (mk___split_fields__ref p__split_fields3)))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (= c1 52) (= p__split_fields7 (us_split_fields1 temp___777)))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (= c1 52) (= found2 found1))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (=> (= c1 53) (= (to_rep3 o23) 2)))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (=> (= c1 53) (= (to_rep3 o24) 2)))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (=> (= c1 53) (= o25 (mk___split_fields o24 o23))))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (=> (= c1 53) (= temp___778 (mk___rep o25))))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (=> (= c1 53) (= result9 (mk___split_fields__ref p__split_fields3))))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (=> (= c1 53) (= p__split_fields8 (us_split_fields1 temp___778))))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (=> (= c1 53) (= found2 found1)))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (=> (not (= c1 53)) (=> (= c1 54) (= (to_rep3 o26) 2))))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (=> (not (= c1 53)) (=> (= c1 54) (= (to_rep3 o27) 3))))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (=> (not (= c1 53)) (=> (= c1 54) (= o28 (mk___split_fields o27 o26)))))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (=> (not (= c1 53)) (=> (= c1 54) (= temp___779 (mk___rep o28)))))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (=> (not (= c1 53)) (=> (= c1 54) (= result10 (mk___split_fields__ref p__split_fields3)))))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (=> (not (= c1 53)) (=> (= c1 54) (= p__split_fields9 (us_split_fields1 temp___779)))))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (=> (not (= c1 53)) (=> (= c1 54) (= found2 found1))))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (=> (not (= c1 53)) (=> (not (= c1 54)) (=> (= c1 55) (= (to_rep3 o29) 3)))))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (=> (not (= c1 53)) (=> (not (= c1 54)) (=> (= c1 55) (= (to_rep3 o30) 1)))))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (=> (not (= c1 53)) (=> (not (= c1 54)) (=> (= c1 55) (= o31 (mk___split_fields o30 o29))))))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (=> (not (= c1 53)) (=> (not (= c1 54)) (=> (= c1 55) (= temp___780 (mk___rep o31))))))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (=> (not (= c1 53)) (=> (not (= c1 54)) (=> (= c1 55) (= result11 (mk___split_fields__ref p__split_fields3))))))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (=> (not (= c1 53)) (=> (not (= c1 54)) (=> (= c1 55) (= p__split_fields10 (us_split_fields1 temp___780))))))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (=> (not (= c1 53)) (=> (not (= c1 54)) (=> (= c1 55) (= found2 found1)))))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (=> (not (= c1 53)) (=> (not (= c1 54)) (=> (not (= c1 55)) (=> (= c1 56) (= (to_rep3 o32) 3))))))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (=> (not (= c1 53)) (=> (not (= c1 54)) (=> (not (= c1 55)) (=> (= c1 56) (= (to_rep3 o33) 2))))))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (=> (not (= c1 53)) (=> (not (= c1 54)) (=> (not (= c1 55)) (=> (= c1 56) (= o34 (mk___split_fields o33 o32)))))))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (=> (not (= c1 53)) (=> (not (= c1 54)) (=> (not (= c1 55)) (=> (= c1 56) (= temp___781 (mk___rep o34)))))))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (=> (not (= c1 53)) (=> (not (= c1 54)) (=> (not (= c1 55)) (=> (= c1 56) (= result12 (mk___split_fields__ref p__split_fields3)))))))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (=> (not (= c1 53)) (=> (not (= c1 54)) (=> (not (= c1 55)) (=> (= c1 56) (= p__split_fields11 (us_split_fields1 temp___781)))))))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (=> (not (= c1 53)) (=> (not (= c1 54)) (=> (not (= c1 55)) (=> (= c1 56) (= found2 found1))))))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (=> (not (= c1 53)) (=> (not (= c1 54)) (=> (not (= c1 55)) (=> (not (= c1 56)) (=> (= c1 57) (= (to_rep3 o35) 3)))))))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (=> (not (= c1 53)) (=> (not (= c1 54)) (=> (not (= c1 55)) (=> (not (= c1 56)) (=> (= c1 57) (= (to_rep3 o36) 3)))))))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (=> (not (= c1 53)) (=> (not (= c1 54)) (=> (not (= c1 55)) (=> (not (= c1 56)) (=> (= c1 57) (= o37 (mk___split_fields o36 o35))))))))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (=> (not (= c1 53)) (=> (not (= c1 54)) (=> (not (= c1 55)) (=> (not (= c1 56)) (=> (= c1 57) (= temp___782 (mk___rep o37))))))))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (=> (not (= c1 53)) (=> (not (= c1 54)) (=> (not (= c1 55)) (=> (not (= c1 56)) (=> (= c1 57) (= result13 (mk___split_fields__ref p__split_fields3))))))))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (=> (not (= c1 53)) (=> (not (= c1 54)) (=> (not (= c1 55)) (=> (not (= c1 56)) (=> (= c1 57) (= p__split_fields12 (us_split_fields1 temp___782))))))))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (=> (not (= c1 53)) (=> (not (= c1 54)) (=> (not (= c1 55)) (=> (not (= c1 56)) (=> (= c1 57) (= found2 found1)))))))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (=> (not (= c1 53)) (=> (not (= c1 54)) (=> (not (= c1 55)) (=> (not (= c1 56)) (=> (not (= c1 57)) (= result14 (mk_bool__ref found1))))))))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (=> (not (= c1 53)) (=> (not (= c1 54)) (=> (not (= c1 55)) (=> (not (= c1 56)) (=> (not (= c1 57)) (= found2 (of_int 0))))))))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (=> (not (= c1 53)) (=> (not (= c1 54)) (=> (not (= c1 55)) (=> (not (= c1 56)) (=> (not (= c1 57)) (= p__split_fields12 p__split_fields3)))))))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (=> (not (= c1 53)) (=> (not (= c1 54)) (=> (not (= c1 55)) (=> (not (= c1 56)) (= p__split_fields11 p__split_fields12))))))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (=> (not (= c1 53)) (=> (not (= c1 54)) (=> (not (= c1 55)) (= p__split_fields10 p__split_fields11)))))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (=> (not (= c1 53)) (=> (not (= c1 54)) (= p__split_fields9 p__split_fields10))))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (=> (not (= c1 53)) (= p__split_fields8 p__split_fields9)))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (= p__split_fields7 p__split_fields8))))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (= p__split_fields6 p__split_fields7)))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (= p__split_fields5 p__split_fields6))))
(assert (=> (not (= c1 49)) (= p__split_fields4 p__split_fields5)))
(assert (= found2 true))
(assert (= (to_rep2 (select (select my_board (to_rep3 (rec__tictactoe__position__x p__split_fields4))) (to_rep3 (rec__tictactoe__position__y p__split_fields4)))) 0))
(assert (= c4 c2))
