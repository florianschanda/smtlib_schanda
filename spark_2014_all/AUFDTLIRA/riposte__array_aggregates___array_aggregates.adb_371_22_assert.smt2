...
(declare-fun temp___663 (Int Int) (Array Int unsigned_byte))
...
(assert (forall ((temp___665 Int) (temp___666 Int)) (let ((temp___664 (temp___663 temp___665 temp___666))) (=> (and (dynamic_invariant temp___665 true true true true) (dynamic_invariant temp___666 true true true true)) (and (= (to_rep (select temp___664 0)) temp___665) (= (to_rep (select temp___664 1)) temp___666))))))
