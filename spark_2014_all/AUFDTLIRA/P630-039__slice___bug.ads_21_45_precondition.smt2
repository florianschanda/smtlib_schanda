...
(assert (=> (<= temp___172 (to_rep (last (rt a)))) (and (and (<= (to_rep (first (rt a))) temp___172) (<= temp___172 (to_rep (last (rt a))))) (and (<= (to_rep (first (rt a))) (to_rep (last (rt a)))) (<= (to_rep (last (rt a))) (to_rep (last (rt a))))))))
(assert (= o4 (elts a)))
(assert (= o4 temp___174))
(assert (= (mk1 temp___172 (to_rep (last (rt a)))) temp___1741))
(assert (= temp___174 o5))
(assert (= (mk (to_rep (first2 temp___1741)) (to_rep (last2 temp___1741))) o6))
(assert (not (<= size_b (length (mk___t o5 o6)))))
(check-sat)
(exit)
