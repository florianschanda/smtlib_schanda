...
(assert (dynamic_invariant queue true false true))
(assert (not (in_range1 (to_rep1 (rec__bounded_queue_v2__queue_type__max_size (us_split_discrs1 queue))))))
(check-sat)
(exit)
