...
(assert (forall ((temp___566 (Array Int integer))) (forall ((temp___567 Int) (temp___568 Int)) (let ((temp___565 (temp___564 temp___566 temp___567 temp___568))) (forall ((temp___569 Int)) (ite (= temp___569 temp___567) (= (select temp___565 temp___569) (of_rep temp___568)) (= (select temp___565 temp___569) (select temp___566 temp___569))))))))
(declare-fun temp___571 ((Array Int integer) Int Int) (Array Int integer))
(assert (forall ((temp___573 (Array Int integer))) (forall ((temp___574 Int) (temp___575 Int)) (let ((temp___572 (temp___571 temp___573 temp___574 temp___575))) (forall ((temp___576 Int)) (ite (= temp___576 temp___574) (= (select temp___572 temp___576) (of_rep temp___575)) (= (select temp___572 temp___576) (select temp___573 temp___576))))))))
(assert (in_range1 i))
(assert (in_range1 j))
(assert (in_range1 x))
(assert (in_range1 y))
...
(assert (= (bool_eq d (- 2147483648) 2147483647 (temp___564 c j 42) (- 2147483648) 2147483647) true))
...
(assert (= (bool_eq g (- 2147483648) 2147483647 (temp___571 f i 42) (- 2147483648) 2147483647) true))
