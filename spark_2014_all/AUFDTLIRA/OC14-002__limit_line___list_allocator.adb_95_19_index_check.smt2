...
(assert (= (rec__list_allocator__cell__stat (us_split_fields1 (select data2 first_allocated))) o30))
(assert (= o29 o31))
(assert (= (rec__list_allocator__cell__next (us_split_fields1 (select data2 first_allocated))) o32))
(assert (= o33 o30))
(assert (= o34 o31))
(assert (= o35 o32))
