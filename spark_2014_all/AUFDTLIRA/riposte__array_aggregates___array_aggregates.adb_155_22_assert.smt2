...
(assert (forall ((temp___497 Int) (temp___498 Int)) (let ((temp___496 (temp_____aggregate_def_495 temp___497 temp___498))) (=> (and (dynamic_invariant temp___497 true true true true) (dynamic_invariant temp___498 true true true true)) (forall ((temp___499 Int)) (ite (or (= temp___499 2) (and (<= 4 temp___499) (<= temp___499 6))) (= (select temp___496 temp___499) rliteral) (= (select temp___496 temp___499) rliteral1)))))))
...
(assert (= result x))
(assert (= x1 (temp_____aggregate_def_495 2 8)))
