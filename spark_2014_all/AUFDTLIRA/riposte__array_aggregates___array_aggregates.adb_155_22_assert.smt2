...
(declare-fun temp___495 (Int Int) (Array Int unsigned_byte))
...
(assert (forall ((temp___497 Int) (temp___498 Int)) (let ((temp___496 (temp___495 temp___497 temp___498))) (=> (and (dynamic_invariant temp___497 true true true true) (dynamic_invariant temp___498 true true true true)) (forall ((temp___499 Int)) (ite (or (= temp___499 2) (and (<= 4 temp___499) (<= temp___499 6))) (= (to_rep (select temp___496 temp___499)) temp___497) (= (to_rep (select temp___496 temp___499)) temp___498)))))))
...
(assert (= result x))
(assert (= x1 (temp___495 2 8)))
(assert (not (= (to_rep (select x1 3)) 5)))
(check-sat)
(exit)
