...
(declare-const temp___8734 (Array Int et1))
(declare-const temp___87341 (Array Int (Array Int et1)))
...
(declare-const temp___8739 (Array Int et1))
(declare-const temp___87391 (Array Int (Array Int et1)))
...
(assert (<= 5 m))
(assert (<= m 50))
(assert (not (in_range3 (to_rep (select (select r__split_fields7 m) n)))))
(check-sat)
(exit)
