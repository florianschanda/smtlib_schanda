...
(assert (and (= (length source) 11) (and (and (and (and (and (and (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 50)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 49)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 3))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 4))) 55)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 5))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 6))) 56)) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 7))) 51)) (forall ((index Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 7) index) (<= index (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index))) true))))))
...
(assert (not (= (ite (<= (to_rep1 (first8 temp___20161)) (to_rep1 (last8 temp___20161))) (+ (- (to_rep1 (last8 temp___20161)) (to_rep1 (first8 temp___20161))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 7) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 7)) 1) 0))))
(check-sat)
(exit)
