...
(assert (not (= (ite (<= (to_rep1 (first8 temp___19141)) (to_rep1 (last8 temp___19141))) (+ (- (to_rep1 (last8 temp___19141)) (to_rep1 (first8 temp___19141))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 7) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 7)) 1) 0))))
(check-sat)
(exit)
