...
(define-fun bool_eq ((a (Array Int max_lsid_type)) (a__first Int) (a__last Int) (b (Array Int max_lsid_type)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (to_rep1 (select a temp___idx_154)) (to_rep1 (select b (+ (- b__first a__first) temp___idx_154))))))) true false))
...
(define-fun dynamic_invariant2 ((temp___expr_213 us_rep1) (temp___is_init_209 Bool) (temp___skip_constant_210 Bool) (temp___do_toplevel_211 Bool) (temp___do_typ_inv_212 Bool)) Bool (and (=> (not (= temp___skip_constant_210 true)) (in_range5 (to_rep1 (select cpu_lsid_last cpu_id)) (to_base temp___expr_213))) (and (dynamic_property1 0 (to_rep1 (select cpu_lsid_last cpu_id)) (first1 (rec__foo__subject_state__states1 (us_split_fields3 temp___expr_213))) (last1 (rec__foo__subject_state__states1 (us_split_fields3 temp___expr_213)))) (and (= (first1 (rec__foo__subject_state__states1 (us_split_fields3 temp___expr_213))) 0) (= (last1 (rec__foo__subject_state__states1 (us_split_fields3 temp___expr_213))) (to_rep1 (select cpu_lsid_last cpu_id)))))))
(define-fun default_initial_assumption ((temp___expr_216 us_rep1) (temp___skip_top_level_217 Bool)) Bool (= (to_rep1 (rec__foo__subject_state__max_id (us_split_discrs2 temp___expr_216))) (to_rep1 (select cpu_lsid_last cpu_id))))
...
(define-fun dynamic_invariant4 ((temp___expr_173 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool) (temp___do_typ_inv_172 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= 0 5)) (in_range2 temp___expr_173)))
...
(assert (forall ((temp___156 Int) (temp___157 Int)) (let ((temp___155 (foo__cpu_lsid_last__aggregate_def temp___156 temp___157))) (=> (and (dynamic_invariant4 temp___156 true true true true) (dynamic_invariant4 temp___157 true true true true)) (and (= (to_rep1 (select temp___155 0)) temp___156) (= (to_rep1 (select temp___155 1)) temp___157))))))
(define-fun dynamic_invariant5 ((temp___expr_206 us_rep) (temp___is_init_202 Bool) (temp___skip_constant_203 Bool) (temp___do_toplevel_204 Bool) (temp___do_typ_inv_205 Bool)) Bool (let ((temp___207 (rec__foo__subject_state__max_id (us_split_discrs1 temp___expr_206)))) (and (dynamic_property3 0 (to_rep1 temp___207) (first3 (rec__foo__subject_state__states (us_split_fields1 temp___expr_206))) (last3 (rec__foo__subject_state__states (us_split_fields1 temp___expr_206)))) (and (= (first3 (rec__foo__subject_state__states (us_split_fields1 temp___expr_206))) 0) (= (last3 (rec__foo__subject_state__states (us_split_fields1 temp___expr_206))) (to_rep1 temp___207))))))
...
(assert (dynamic_invariant2 (mk___rep1 states__split_discrs (mk___split_fields1 (mk___t states__split_fields states__split_fields1))) true false true true))
(assert (dynamic_invariant1 id true false true true))
