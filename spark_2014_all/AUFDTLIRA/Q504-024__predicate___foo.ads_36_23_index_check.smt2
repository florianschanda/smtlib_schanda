...
(define-fun dynamic_invariant ((temp___expr_143 Int) (temp___is_init_140 Bool) (temp___skip_constant_141 Bool) (temp___do_toplevel_142 Bool)) Bool (=> (or (= temp___is_init_140 true) (<= 0 1)) (in_range1 temp___expr_143)))
...
(declare-fun user_eq2 (max_lsid_type max_lsid_type) Bool)
(declare-const dummy2 max_lsid_type)
...
(declare-fun to_rep1 (max_lsid_type) Int)
(declare-fun of_rep1 (Int) max_lsid_type)
(assert (forall ((x max_lsid_type)) (! (= (of_rep1 (to_rep1 x)) x) :pattern ((to_rep1 x)))))
(assert (forall ((x max_lsid_type)) (! (in_range2 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun bool_eq ((a (Array Int max_lsid_type)) (a__first Int) (a__last Int) (b (Array Int max_lsid_type)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_132 Int)) (=> (and (<= a__first temp___idx_132) (<= temp___idx_132 a__last)) (= (to_rep1 (select a temp___idx_132)) (to_rep1 (select b (+ (- b__first a__first) temp___idx_132))))))) true false))
...
(assert (forall ((a (Array Int max_lsid_type)) (b (Array Int max_lsid_type))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep1 (select a (+ i 1))) (to_rep1 (select b (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int max_lsid_type)) (b (Array Int max_lsid_type))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep1 (select b (+ i 1))) (to_rep1 (select a (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
...
(declare-fun user_eq3 (local_subject_id_type local_subject_id_type) Bool)
(declare-const dummy3 local_subject_id_type)
...
(define-fun dynamic_invariant1 ((temp___expr_164 Int) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool)) Bool (and (=> (or (= temp___is_init_161 true) (<= 0 5)) (in_range3 temp___expr_164)) (=> (= temp___do_toplevel_163 true) (=> (= temp___is_init_161 true) (<= temp___expr_164 (to_rep1 (select cpu_lsid_last cpu_id)))))))
(define-fun dynamic_predicate ((temp___168 Int)) Bool (<= temp___168 (to_rep1 (select cpu_lsid_last cpu_id))))
...
(define-fun bool_eq1 ((a (Array Int natural)) (a__first Int) (a__last Int) (b (Array Int natural)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_137 Int)) (=> (and (<= a__first temp___idx_137) (<= temp___idx_137 a__last)) (= (to_rep (select a temp___idx_137)) (to_rep (select b (+ (- b__first a__first) temp___idx_137))))))) true false))
(assert (forall ((a (Array Int natural)) (b (Array Int natural))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq1 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_137 Int)) (=> (and (<= a__first temp___idx_137) (<= temp___idx_137 a__last)) (= (to_rep (select a temp___idx_137)) (to_rep (select b (+ (- b__first a__first) temp___idx_137)))))))))))
...
(declare-fun to_rep2 (tmax_lsid_typeB) Int)
(declare-fun of_rep2 (Int) tmax_lsid_typeB)
(assert (forall ((x tmax_lsid_typeB)) (! (= (of_rep2 (to_rep2 x)) x) :pattern ((to_rep2 x)))))
(assert (forall ((x tmax_lsid_typeB)) (! (in_range4 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(declare-const dummy5 tmax_lsid_typeB)
...
(define-fun bool_eq3 ((x us_t1) (y us_t1)) Bool (bool_eq1 (elts1 x) (to_rep2 (first2 (rt1 x))) (to_rep2 (last2 (rt1 x))) (elts1 y) (to_rep2 (first2 (rt1 y))) (to_rep2 (last2 (rt1 y)))))
...
(define-fun bool_eq4 ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep1 (rec__foo__subject_state__max_id (us_split_discrs1 a))) (to_rep1 (rec__foo__subject_state__max_id (us_split_discrs1 b)))) (= (bool_eq3 (rec__foo__subject_state__states (us_split_fields1 a)) (rec__foo__subject_state__states (us_split_fields1 b))) true)) true false))
...
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (us_split_discrs2 a) (mk___split_fields (let ((temp___139 (rec__foo__subject_state__states1 (us_split_fields3 a)))) (of_array1 (to_array temp___139) (first1 temp___139) (last1 temp___139))))))
(define-fun of_base ((r us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r) (mk___split_fields1 (let ((temp___138 (rec__foo__subject_state__states (us_split_fields1 r)))) (of_array (to_array1 temp___138) (first3 temp___138) (last3 temp___138))))))
(define-fun bool_eq5 ((a us_rep1) (b us_rep1)) Bool (ite (and (= (to_rep1 (rec__foo__subject_state__max_id (us_split_discrs2 a))) (to_rep1 (rec__foo__subject_state__max_id (us_split_discrs2 b)))) (= (bool_eq2 (rec__foo__subject_state__states1 (us_split_fields3 a)) (rec__foo__subject_state__states1 (us_split_fields3 b))) true)) true false))
(define-fun in_range5 ((rec__foo__subject_state__max_id1 Int) (a us_rep)) Bool (= rec__foo__subject_state__max_id1 (to_rep1 (rec__foo__subject_state__max_id (us_split_discrs1 a)))))
...
(define-fun dynamic_invariant2 ((temp___expr_184 us_rep1) (temp___is_init_181 Bool) (temp___skip_constant_182 Bool) (temp___do_toplevel_183 Bool)) Bool (and (=> (not (= temp___skip_constant_182 true)) (in_range5 (to_rep1 (select cpu_lsid_last cpu_id)) (to_base temp___expr_184))) (and (dynamic_property1 0 (to_rep1 (select cpu_lsid_last cpu_id)) (first1 (rec__foo__subject_state__states1 (us_split_fields3 temp___expr_184))) (last1 (rec__foo__subject_state__states1 (us_split_fields3 temp___expr_184)))) (and (= (first1 (rec__foo__subject_state__states1 (us_split_fields3 temp___expr_184))) 0) (= (last1 (rec__foo__subject_state__states1 (us_split_fields3 temp___expr_184))) (to_rep1 (select cpu_lsid_last cpu_id)))))))
(define-fun default_initial_assumption ((temp___expr_187 us_rep1) (temp___skip_top_level_188 Bool)) Bool (= (to_rep1 (rec__foo__subject_state__max_id (us_split_discrs2 temp___expr_187))) (to_rep1 (select cpu_lsid_last cpu_id))))
...
(define-fun dynamic_invariant4 ((temp___expr_149 Int) (temp___is_init_146 Bool) (temp___skip_constant_147 Bool) (temp___do_toplevel_148 Bool)) Bool (=> (or (= temp___is_init_146 true) (<= 0 5)) (in_range2 temp___expr_149)))
(declare-fun foo__cpu_lsid_last__aggregate_def (Int Int) (Array Int max_lsid_type))
(assert (forall ((temp___134 Int) (temp___135 Int)) (let ((temp___133 (foo__cpu_lsid_last__aggregate_def temp___134 temp___135))) (and (= (select temp___133 0) (of_rep1 temp___134)) (= (select temp___133 1) (of_rep1 temp___135))))))
(assert (= cpu_lsid_last (foo__cpu_lsid_last__aggregate_def 3 4)))
(define-fun dynamic_invariant5 ((temp___expr_178 us_rep) (temp___is_init_175 Bool) (temp___skip_constant_176 Bool) (temp___do_toplevel_177 Bool)) Bool (let ((temp___179 (rec__foo__subject_state__max_id (us_split_discrs1 temp___expr_178)))) (and (dynamic_property3 0 (to_rep1 temp___179) (first3 (rec__foo__subject_state__states (us_split_fields1 temp___expr_178))) (last3 (rec__foo__subject_state__states (us_split_fields1 temp___expr_178)))) (and (= (first3 (rec__foo__subject_state__states (us_split_fields1 temp___expr_178))) 0) (= (last3 (rec__foo__subject_state__states (us_split_fields1 temp___expr_178))) (to_rep1 temp___179))))))
...
(assert (dynamic_invariant2 (mk___rep1 states__split_discrs (mk___split_fields1 (mk___t states__split_fields states__split_fields1))) true false true))
(assert (dynamic_invariant1 id true false true))
(assert (not (<= (to_rep2 (first states__split_fields1)) id)))
(check-sat)
(exit)
