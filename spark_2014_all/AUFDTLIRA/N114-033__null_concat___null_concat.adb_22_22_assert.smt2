...
(assert (forall ((temp___142 Int)) (forall ((temp___143 Int)) (= (select (null_concat__p_bad__a1__aggregate_def temp___142) temp___143) (of_rep temp___142)))))
(declare-sort t7b 0)
...
(assert (forall ((temp___145 Int) (temp___146 Int)) (let ((temp___144 (null_concat__p_bad__a2__aggregate_def temp___145 temp___146))) (forall ((temp___147 Int)) (ite (and (<= 6 temp___147) (<= temp___147 10)) (= (select temp___144 temp___147) (of_rep temp___146)) (=> (and (<= 1 temp___147) (<= temp___147 5)) (= (select temp___144 temp___147) (of_rep temp___145))))))))
