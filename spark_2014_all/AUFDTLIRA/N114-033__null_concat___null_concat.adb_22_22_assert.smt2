...
(assert (forall ((temp___164 Int)) (=> (dynamic_invariant1 temp___164 true true true true) (forall ((temp___165 Int)) (= (to_rep (select (null_concat__p_bad__a1__aggregate_def temp___164) temp___165)) temp___164)))))
(assert (= a2 (of_array (null_concat__p_bad__a2__aggregate_def 1 2) 1 10)))
(assert (forall ((temp___167 Int) (temp___168 Int)) (let ((temp___166 (null_concat__p_bad__a2__aggregate_def temp___167 temp___168))) (=> (and (dynamic_invariant1 temp___167 true true true true) (dynamic_invariant1 temp___168 true true true true)) (forall ((temp___169 Int)) (ite (and (<= 6 temp___169) (<= temp___169 10)) (= (to_rep (select temp___166 temp___169)) temp___168) (=> (and (<= 1 temp___169) (<= temp___169 5)) (= (to_rep (select temp___166 temp___169)) temp___167))))))))
...
(assert (not (= (to_rep (select (elts a3) 1)) 2)))
(check-sat)
(exit)
