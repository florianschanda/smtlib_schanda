...
(assert (= model____split_fields4 (mk___split_fields1 temp___283 temp___2831)))
(assert (and (= o18 (add (rec__list_allocator__m__t__allocated model____split_fields4) res1)) (and (and (and (= (length1 o18) (+ (length1 (rec__list_allocator__m__t__allocated model____split_fields4)) 1)) (= (contains o18 res1) true)) (= (ole (rec__list_allocator__m__t__allocated model____split_fields4) o18) true)) (= (included_except o18 (rec__list_allocator__m__t__allocated model____split_fields4) res1) true))))
(assert (= (rec__list_allocator__m__t__available model____split_fields4) o19))
(assert (= o18 o20))
(assert (= temp___285 o19))
(assert (= temp___2851 o20))
(assert (= result6 (mk___split_fields__ref1 model____split_fields4)))
(assert (= model____split_fields5 (mk___split_fields1 temp___285 temp___2851)))
(declare-const j1 Int)
(assert (<= 1 j1))
(assert (<= j1 (length (rec__list_allocator__m__t__available model____split_fields5))))
(declare-const k1 Int)
(assert (<= 1 k1))
(assert (<= k1 (- j1 1)))
(assert (not (not (= (get (rec__list_allocator__m__t__available model____split_fields5) j1) (get (rec__list_allocator__m__t__available model____split_fields5) k1)))))
(check-sat)
(exit)
