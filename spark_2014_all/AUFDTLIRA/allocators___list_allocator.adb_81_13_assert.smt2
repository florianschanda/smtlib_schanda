...
(assert (and (= o15 (remove model____split_fields 1)) (and (= (length o15) (- (length model____split_fields) 1)) (and (= (range_equal model____split_fields o15 1 (- 1 1)) true) (= (range_shifted o15 model____split_fields 1 (last o15) 1) true)))))
(assert (= o15 o16))
(assert (= model____split_fields1 o17))
(assert (= temp___283 o16))
(assert (= temp___2831 o17))
(assert (= result5 (mk___split_fields__ref1 (mk___split_fields1 model____split_fields model____split_fields1))))
(assert (= model____split_fields2 (mk___split_fields1 temp___283 temp___2831)))
(assert (and (= o18 (add (rec__list_allocator__m__t__allocated model____split_fields2) res1)) (and (and (and (= (length1 o18) (+ (length1 (rec__list_allocator__m__t__allocated model____split_fields2)) 1)) (= (contains o18 res1) true)) (= (ole (rec__list_allocator__m__t__allocated model____split_fields2) o18) true)) (= (included_except o18 (rec__list_allocator__m__t__allocated model____split_fields2) res1) true))))
(assert (= (rec__list_allocator__m__t__available model____split_fields2) o19))
(assert (= o18 o20))
(assert (= temp___285 o19))
(assert (= temp___2851 o20))
(assert (= result6 (mk___split_fields__ref1 model____split_fields2)))
(assert (= model____split_fields3 (mk___split_fields1 temp___285 temp___2851)))
(declare-const j Int)
(assert (<= 1 j))
...
(assert (<= 1 k))
(assert (<= k (- j 1)))
(assert (not (not (= (get (rec__list_allocator__m__t__available model____split_fields3) j) (get (rec__list_allocator__m__t__available model____split_fields3) k)))))
(check-sat)
(exit)
