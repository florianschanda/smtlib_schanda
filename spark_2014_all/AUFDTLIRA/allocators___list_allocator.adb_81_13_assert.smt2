...
(assert (= temp___320 o16))
(assert (= temp___3201 o17))
(assert (= result5 (mk___split_fields__ref1 (mk___split_fields1 model____split_fields model____split_fields1))))
(assert (= model____split_fields2 (mk___split_fields1 temp___320 temp___3201)))
...
(assert (= o18 o20))
(assert (= temp___322 o19))
(assert (= temp___3221 o20))
(assert (= result6 (mk___split_fields__ref1 model____split_fields2)))
(assert (= model____split_fields3 (mk___split_fields1 temp___322 temp___3221)))
(declare-const j Int)
(assert (<= 1 j))
