...
(assert (= (bool_eq a1 0 5 a_update 0 5) true))
(assert (and (= o (has_key1 (positions (mk___rep d__split_discrs d__split_fields1)) c)) (= (= o true) (= (has_key1 (positions (mk___rep d__split_discrs d__split_fields1)) c) true))))
(assert (= o1 true))
(assert (= result2 (ite (= o1 true) o false)))
(assert (= result2 true))
(assert (and (= o2 (key (mk___rep d__split_discrs d__split_fields1) c)) (and (in_range7 o2) (= o2 (get (keys (mk___rep d__split_discrs d__split_fields1)) (get1 (positions (mk___rep d__split_discrs d__split_fields1)) c))))))
(assert (= o3 (ite (= o2 (to_rep (select a1 j))) true false)))
(assert (= o4 (ite (not (= o3 true)) true false)))
(assert (not (= (has_key1 (positions (mk___rep d__split_discrs d__split_fields1)) c) true)))
(check-sat)
(exit)
