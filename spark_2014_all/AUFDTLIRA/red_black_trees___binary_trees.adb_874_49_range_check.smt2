...
(assert (=> (and (not (= r2 root)) (and (not (= r2 v)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f_old__split_fields1 r2)))) 2))) (forall ((i15 Int)) (=> (and (<= 1 i15) (<= i15 100)) (or (not (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) root) i15))) true)) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) r2) i15))) true)))))))
(assert (=> (and (not (= r2 root)) (and (not (= r2 v)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f_old__split_fields1 r2)))) 2))) (and (= o300 v) (in_range1 v))))
(assert (=> (and (not (= r2 root)) (and (not (= r2 v)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f_old__split_fields1 r2)))) 2))) (= (tree_structure (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))) true)))
(assert (=> (and (not (= r2 root)) (and (not (= r2 v)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f_old__split_fields1 r2)))) 2))) (and (= o301 v) (in_range1 v))))
(assert (=> (and (not (= r2 root)) (and (not (= r2 v)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f_old__split_fields1 r2)))) 2))) (forall ((i15 Int)) (=> (and (<= 1 i15) (<= i15 100)) (or (not (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) o301) i15))) true)) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) r2) i15))) true)))))))
...
(assert (forall ((p1 Int)) (=> (and (<= 1 p1) (<= p1 r3)) (=> (and (and (not (= p1 root)) (not (= p1 v))) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f_old__split_fields1 p1)))) 2)) (= (oeq1 (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) p1) (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) p1)) true)))))
(assert (and (=> (<= 1 r256b) (dynamic_property 1 r256b r3)) (and (<= 1 r3) (<= r3 r256b))))
(assert (<= 1 p))
(assert (<= p r3))
(assert (and (<= 1 p) (<= p 100)))
(assert (= o302 p))
(assert (= o303 (select f_old__split_fields1 o302)))
(assert (= o304 (us_split_fields3 o303)))
(assert (= o305 (rec__binary_trees__cell__position o304)))
(assert (= o306 (to_rep1 o305)))
(assert (= o307 (ite (= o306 2) true false)))
(assert (= result49 (ite (not (= p root)) (ite (not (= p v)) o307 false) false)))
