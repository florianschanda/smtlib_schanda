...
(assert (= (store a__split_fields7 j rliteral2) a__split_fields10))
...
(assert (= (to_rep (select a__split_fields14 i)) 69))
...
(assert (not (not (= (to_rep (select a__split_fields16 i)) 23))))
(check-sat)
(exit)
