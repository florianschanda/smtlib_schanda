...
(declare-const temp___304 index)
(declare-const temp___3041 (Array Int value))
(declare-const temp___3042 (Array Int value))
...
(declare-const temp___307 index)
(declare-const temp___3071 (Array Int value))
(declare-const temp___3072 (Array Int value))
...
(declare-const temp___310 index)
(declare-const temp___3101 (Array Int value))
(declare-const temp___3102 (Array Int value))
(declare-const o15 index)
(declare-const o16 index)
(declare-const o17 (Array Int value))
(declare-const o18 (Array Int value))
(declare-const temp___312 index)
(declare-const temp___3121 (Array Int value))
(declare-const temp___3122 (Array Int value))
...
(assert (in_range j))
(assert (not (= i j)))
(assert (and (and (and (and (and (and (= (to_rep1 o) 69) (= o1 (store a__split_fields2 i o))) (and (= a__split_fields o2) (and (= a__split_fields1 o3) (= o1 o4)))) (and (= temp___304 o2) (and (= temp___3041 o3) (= temp___3042 o4)))) (and (= (mk___split_fields__ref (mk___split_fields result result1 result2)) (mk___split_fields__ref (mk___split_fields a__split_fields a__split_fields1 a__split_fields2))) (and (= temp___304 a__split_fields3) (and (= temp___3041 a__split_fields4) (= temp___3042 a__split_fields5))))) (and (and (and (and (and (= (to_rep1 o5) 23) (= o6 (store a__split_fields4 i o5))) (and (= a__split_fields3 o7) (and (= o6 o8) (= a__split_fields5 o9)))) (and (= temp___307 o7) (and (= temp___3071 o8) (= temp___3072 o9)))) (and (and (= result3 a__split_fields3) (and (= result4 a__split_fields4) (= result5 a__split_fields5))) (and (= temp___307 a__split_fields6) (and (= temp___3071 a__split_fields7) (= temp___3072 a__split_fields8))))) (and (and (and (and (and (= (to_rep1 o10) 42) (= o11 (store a__split_fields7 j o10))) (and (= a__split_fields6 o12) (and (= o11 o13) (= a__split_fields8 o14)))) (and (= temp___310 o12) (and (= temp___3101 o13) (= temp___3102 o14)))) (and (and (= result6 a__split_fields6) (and (= result7 a__split_fields7) (= result8 a__split_fields8))) (= a__split_fields9 (mk___split_fields temp___310 temp___3101 temp___3102)))) (and (and (and (and (= (to_rep o15) 100) (and (= o15 o16) (and (= (rec__arrays_in_records__record_with_arrays__first_array a__split_fields9) o17) (= (rec__arrays_in_records__record_with_arrays__second_array a__split_fields9) o18)))) (and (= temp___312 o16) (and (= temp___3121 o17) (= temp___3122 o18)))) (and (= result9 (mk___split_fields__ref a__split_fields9)) (= a__split_fields10 (mk___split_fields temp___312 temp___3121 temp___3122)))) (= (to_rep1 (select (rec__arrays_in_records__record_with_arrays__second_array a__split_fields10) i)) 69))))) (and (= a__split_fields11 (mk___split_fields__ref a__split_fields10)) (= a__split_fields12 a__split_fields10))))
(assert (not (not (= (to_rep1 (select (rec__arrays_in_records__record_with_arrays__first_array (us_split_fields__content a__split_fields11)) i)) 23))))
(check-sat)
(exit)
