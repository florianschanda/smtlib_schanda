...
(assert (= o1 o4))
(assert (= temp___304 o2))
(assert (= temp___3041 o3))
(assert (= temp___3042 o4))
...
(assert (= a__split_fields9 (mk___split_fields temp___310 temp___3101 temp___3102)))
...
(assert (= temp___312 o16))
(assert (= temp___3121 o17))
(assert (= temp___3122 o18))
(assert (= result9 (mk___split_fields__ref a__split_fields9)))
(assert (= a__split_fields10 (mk___split_fields temp___312 temp___3121 temp___3122)))
