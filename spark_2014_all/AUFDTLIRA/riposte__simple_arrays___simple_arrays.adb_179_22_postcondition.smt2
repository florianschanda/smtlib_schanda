...
(assert (forall ((temp___253 (Array Int integer))) (forall ((temp___254 Int) (temp___255 Int)) (let ((temp___252 (temp___251 temp___253 temp___254 temp___255))) (forall ((temp___256 Int)) (ite (= temp___256 temp___254) (= (select temp___252 temp___256) (of_rep temp___255)) (= (select temp___252 temp___256) (select temp___253 temp___256))))))))
(declare-fun temp___258 ((Array Int integer) Int Int) (Array Int integer))
(assert (forall ((temp___260 (Array Int integer))) (forall ((temp___261 Int) (temp___262 Int)) (let ((temp___259 (temp___258 temp___260 temp___261 temp___262))) (forall ((temp___263 Int)) (ite (= temp___263 temp___261) (= (select temp___259 temp___263) (of_rep temp___262)) (= (select temp___259 temp___263) (select temp___260 temp___263))))))))
...
(assert (in_range1 i))
(assert (in_range1 j))
(assert (and (and (= (bool_eq b (- 2147483648) 2147483647 (temp___251 a i 23) (- 2147483648) 2147483647) true) (= (bool_eq c (- 2147483648) 2147483647 (temp___258 a j 42) (- 2147483648) 2147483647) true)) (not (= i j))))
(assert (= (to_rep o) 42))
