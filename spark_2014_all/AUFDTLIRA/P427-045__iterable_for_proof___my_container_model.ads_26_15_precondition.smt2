...
(assert (forall ((c (Array Int natural))) (forall ((p Int)) (! (=> (dynamic_invariant p true true true) (= (m_element c p) (to_rep (select c p)))) :pattern ((m_element c p))))))
(declare-sort t3b 0)
...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 100)) (and (and (= temp___197 c) (and (= temp___196 i1) (and (ite (= (to_rep (select c i1)) 0) (and (and (= (to_rep o) 1) (= o1 (store c i1 o))) (and (= (mk_map__ref result1) (mk_map__ref c)) (= c2 o1))) (and (= c2 c) (= c2 c1))) (and (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 i2)) (= (valid (to_rep (select c3 j1))) true))) (and (and (and (=> (<= 1 100) (in_range3 i2)) (forall ((temp___198 Int)) (=> (and (<= 1 temp___198) (<= temp___198 100)) (=> (< i2 temp___198) (= (select c3 temp___198) (select temp___197 temp___198)))))) (and (<= 1 i2) (<= i2 100))) (= i2 100)))))) (and (and (= i2 i6) (= c3 c7)) (and (= i7 i2) (= c8 c3))))))
...
(assert (= i11 i9))
(assert (= c12 c10))
(assert (and (= temp___203 (get_model c11)) (= temp___203 c11)))
(assert (not true))
(check-sat)
(exit)
