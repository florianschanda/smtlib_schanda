...
(assert (= res15 res13))
(assert (=> (= (is_empty (rec__allocator__m__t__available (us_split_fields1 (model__ data)))) true) (and (= (int__content res14) 0) (= (oeq2 (model__ (map__content data13)) (model__ data)) true))))
(assert (not (= (is_empty (rec__allocator__m__t__available (us_split_fields1 (model__ data)))) true)))
(assert (not (= (is_add (rec__allocator__m__t__available (us_split_fields1 (model__ (map__content data13)))) (int__content res14) (rec__allocator__m__t__available (us_split_fields1 (model__ data)))) true)))
(check-sat)
(exit)
