...
(assert (<= 0 (object__size4 (mk___rep1 v4__split_fields1))))
(assert (<= 0 (object__size5 (mk___rep2 (mk___split_fields2 v5__split_fields v5__split_fields1) v5__attr__tag))))
(assert (not (<= 0 (object__size6 (mk___rep3 (mk___split_fields3 v6__split_fields v6__split_fields1 v6__split_fields2) v6__attr__tag)))))
(check-sat)
(exit)
