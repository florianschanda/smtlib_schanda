...
(assert (not (or (or (= (+ x lcp__result4) (+ (to_rep (last (rt a))) 1)) (= (+ y lcp__result4) (+ (to_rep (last (rt a))) 1))) (not (= (to_rep (select (elts a) (+ x lcp__result4))) (to_rep (select (elts a) (+ y lcp__result4))))))))
(check-sat)
(exit)
