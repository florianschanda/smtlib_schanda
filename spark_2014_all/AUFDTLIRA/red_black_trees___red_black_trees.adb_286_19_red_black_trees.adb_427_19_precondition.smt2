...
(assert (= t__split_fields8 (mk___split_fields4 (mk___rep3 search_trees__left_rotate__t__fields) (rec__red_black_trees__rbt__color t__split_fields7))))
(assert (= (mk___rep4 t_old__split_fields7) c81b))
(assert (dynamic_invariant6 c81b true false true true))
(assert (= (mk___rep4 t__split_fields8) c82b))
(assert (dynamic_invariant6 c82b true false true true))
(assert (and (= red_black_trees__insert__L_8__C83b__assume x3) (in_range2 x3)))
...
(assert (and (= red_black_trees__insert__L_8__B84b__y__assume o27) (in_range2 o27)))
...
(assert (<= 1 n5))
(assert (<= n5 100))
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c81b))) i1))) true) (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c81b) i1)))) n6)) (not (= i1 y))) (= (eq (select (nb_blacks c82b) i1) (select (nb_blacks c81b) i1)) true)))))
(assert (=> (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c81b) c83b)))) n6) (= (eq (select (nb_blacks c82b) y) (select (nb_blacks c81b) y)) true)))
