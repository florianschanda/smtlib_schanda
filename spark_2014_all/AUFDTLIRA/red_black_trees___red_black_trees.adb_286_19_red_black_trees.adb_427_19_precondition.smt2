...
(assert (and (= o25 (parent (rec__red_black_trees__rbt__struct t__split_fields7) o24)) (and (in_range2 o25) (and (= o25 (parent1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct t__split_fields7))) o24)) (=> (= (size (rec__red_black_trees__rbt__struct t__split_fields7)) 0) (= o25 0))))))
(assert (= result10 (mk_int__ref x2)))
(assert (= x3 o25))
(assert (and (= o26 x3) (in_range4 x3)))
...
(assert (= t__split_fields8 (mk___split_fields4 (mk___rep2 search_trees__left_rotate__t__fields) (rec__red_black_trees__rbt__color t__split_fields7))))
...
(assert (and (= red_black_trees__insert__L_8__C83b__assume x3) (in_range4 x3)))
(assert (= red_black_trees__insert__L_8__C83b__assume c83b))
(assert (in_range4 c83b))
...
(assert (and (= red_black_trees__insert__L_8__B84b__y__assume o27) (in_range4 o27)))
...
(assert (<= 1 n5))
(assert (<= n5 100))
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields7 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c81b))) i1))) true) (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c81b) i1)))) n6)) (not (= i1 y))) (= (eq (select (nb_blacks c82b) i1) (select (nb_blacks c81b) i1)) true)))))
