...
(assert (<= 1 n61))
(assert (<= n61 100))
(assert (forall ((i14 Int)) (=> (and (<= 1 i14) (<= i14 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c81b))) i14))) true) (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c81b) i14)))) n62)) (not (= i14 y))) (= (eq (select (nb_blacks c82b) i14) (select (nb_blacks c81b) i14)) true)))))
(assert (=> (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c81b) c83b)))) n62) (= (eq (select (nb_blacks c82b) y) (select (nb_blacks c81b) y)) true)))
(assert (and (=> (<= 1 100) (in_range2 n62)) (and (<= 1 n62) (<= n62 100))))
(assert (<= 1 i5))
(assert (<= i5 100))
(assert (not (not (= (size (rec__red_black_trees__rbt__struct (us_split_fields9 c81b))) 0))))
(check-sat)
(exit)
