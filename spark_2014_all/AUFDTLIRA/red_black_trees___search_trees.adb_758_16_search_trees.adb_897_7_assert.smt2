...
(assert (not (< (to_rep (select (rec__search_trees__search_tree__values t__split_fields8) x1)) (to_rep (select (rec__search_trees__search_tree__values t__split_fields8) j15)))))
(check-sat)
(exit)
