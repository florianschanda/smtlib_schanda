...
(assert (= (tree_structure f) true))
(assert (and (= temp___1126 (model__ f root)) (and (dynamic_invariant6 temp___1126 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1126 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1126 root)))) 0) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (not (= i2 root)) (ite (and (not (= (parent f i2) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1126 (parent f i2)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1126 i2))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1126 i2))) true)))))) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1126 i2))) true) (not (= i2 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1126 (parent f i2)))) (position f i2) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1126 i2)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1126 i2)))) 0)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1126 i2))) true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1126 j2))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1126 i2))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1126 j2)))) true)) (= j2 i2))))))))))))))
(assert (= (mk___rep (mk___split_fields o33 o34)) (select temp___1126 j)))
