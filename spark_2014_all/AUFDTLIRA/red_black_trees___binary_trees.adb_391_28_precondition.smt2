...
(declare-const temp___1172 (Array Int us_rep1))
...
(assert (= o37 (select temp___1173 i)))
...
(assert (= (tree_structure f) true))
(assert (and (= temp___1172 (model__ f root)) (and (dynamic_invariant6 temp___1172 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1172 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1172 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent f i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1172 (parent f i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1172 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1172 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1172 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1172 (parent f i1)))) (position f i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1172 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1172 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1172 i1))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1172 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1172 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1172 j1)))) true)) (= j1 i1))))))))))))))
(assert (= (mk___rep (mk___split_fields o33 o34)) (select temp___1172 j)))
