...
(declare-fun temp_____aggregate_def_208 (Int Int Int Int) us_t1)
...
(assert (forall ((temp___210 Int) (temp___211 Int) (temp___212 Int) (temp___213 Int)) (let ((temp___209 (temp_____aggregate_def_208 temp___210 temp___211 temp___212 temp___213))) (=> (and (dynamic_invariant temp___210 true true true true) (dynamic_invariant temp___211 true true true true)) (and (=> (dynamic_property 1 2147483647 temp___212 temp___213) (and (= (first3 temp___209) temp___212) (= (last3 temp___209) temp___213))) (and (= (select (to_array1 temp___209) (+ (to_rep a__first) 0)) rliteral) (= (select (to_array1 temp___209) (+ (to_rep a__first) 1)) rliteral1)))))))
(define-fun dynamic_invariant2 ((temp___expr_163 us_t) (temp___is_init_159 Bool) (temp___skip_constant_160 Bool) (temp___do_toplevel_161 Bool) (temp___do_typ_inv_162 Bool)) Bool (=> (not (= temp___skip_constant_160 true)) (dynamic_property 1 2147483647 (first1 temp___expr_163) (last1 temp___expr_163))))
(assert (forall ((temp___169 Int) (temp___170 Int)) (let ((temp___168 (temp_____aggregate_def_167 temp___169 temp___170))) (=> (and (dynamic_invariant temp___169 true true true true) (dynamic_invariant temp___170 true true true true)) (and (= (select temp___168 1) rliteral) (= (select temp___168 2) rliteral1))))))
...
(assert (= (to_rep (first2 (rt1 (temp_____aggregate_def_208 85 36 (to_rep a__first) (+ (to_rep a__first) 1))))) (to_rep a__first)))
(assert (= (to_rep (last2 (rt1 (temp_____aggregate_def_208 85 36 (to_rep a__first) (+ (to_rep a__first) 1))))) (+ (to_rep a__first) 1)))
(assert (= (mk___t1 temp___216 temp___2161) (temp_____aggregate_def_208 85 36 (to_rep a__first) (+ (to_rep a__first) 1))))
(assert (= temp___216 temp___217))
(assert (= (mk (to_rep (first2 temp___2161)) (to_rep (last2 temp___2161))) temp___2171))
(assert (not (= (ite (<= (to_rep (first temp___2171)) (to_rep (last temp___2171))) (+ (- (to_rep (last temp___2171)) (to_rep (first temp___2171))) 1) 0) (ite (<= (to_rep a__first) (to_rep a__last)) (+ (- (to_rep a__last) (to_rep a__first)) 1) 0))))
(check-sat)
(exit)
