...
(declare-fun temp___167 (Int Int) (Array Int integer))
(declare-fun temp___208 (Int Int Int Int) us_t1)
...
(assert (forall ((temp___210 Int) (temp___211 Int) (temp___212 Int) (temp___213 Int)) (let ((temp___209 (temp___208 temp___210 temp___211 temp___212 temp___213))) (=> (and (dynamic_invariant temp___210 true true true true) (dynamic_invariant temp___211 true true true true)) (and (=> (dynamic_property 1 2147483647 temp___212 temp___213) (and (= (first3 temp___209) temp___212) (= (last3 temp___209) temp___213))) (and (= (to_rep (select (to_array1 temp___209) (+ (to_rep a__first) 0))) temp___210) (= (to_rep (select (to_array1 temp___209) (+ (to_rep a__first) 1))) temp___211)))))))
...
(assert (forall ((temp___169 Int) (temp___170 Int)) (let ((temp___168 (temp___167 temp___169 temp___170))) (=> (and (dynamic_invariant temp___169 true true true true) (dynamic_invariant temp___170 true true true true)) (and (= (to_rep (select temp___168 1)) temp___169) (= (to_rep (select temp___168 2)) temp___170))))))
...
(assert (= (to_rep (first2 (rt1 (temp___208 85 36 (to_rep a__first) (+ (to_rep a__first) 1))))) (to_rep a__first)))
(assert (= (to_rep (last2 (rt1 (temp___208 85 36 (to_rep a__first) (+ (to_rep a__first) 1))))) (+ (to_rep a__first) 1)))
(assert (= (mk___t1 temp___216 temp___2161) (temp___208 85 36 (to_rep a__first) (+ (to_rep a__first) 1))))
