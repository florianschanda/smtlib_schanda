...
(assert (forall ((temp___146 Int) (temp___147 Int)) (let ((temp___145 (temp___144 temp___146 temp___147))) (and (= (select temp___145 1) (of_rep temp___146)) (= (select temp___145 2) (of_rep temp___147))))))
(declare-fun temp___183 (Int Int Int Int) us_t1)
(assert (forall ((temp___185 Int) (temp___186 Int) (temp___187 Int) (temp___188 Int)) (let ((temp___184 (temp___183 temp___185 temp___186 temp___187 temp___188))) (and (=> (dynamic_property 1 2147483647 temp___187 temp___188) (and (= (first3 temp___184) temp___187) (= (last3 temp___184) temp___188))) (and (= (select (to_array1 temp___184) (+ (to_rep a__first) 0)) (of_rep temp___185)) (= (select (to_array1 temp___184) (+ (to_rep a__first) 1)) (of_rep temp___186)))))))
...
(define-fun dynamic_invariant2 ((temp___expr_140 us_t) (temp___is_init_137 Bool) (temp___skip_constant_138 Bool) (temp___do_toplevel_139 Bool)) Bool (=> (not (= temp___skip_constant_138 true)) (dynamic_property 1 2147483647 (first1 temp___expr_140) (last1 temp___expr_140))))
...
(assert (= (to_rep (first2 (rt1 (temp___183 85 36 (to_rep a__first) (+ (to_rep a__first) 1))))) (to_rep a__first)))
(assert (= (to_rep (last2 (rt1 (temp___183 85 36 (to_rep a__first) (+ (to_rep a__first) 1))))) (+ (to_rep a__first) 1)))
(assert (= (mk___t1 temp___191 temp___1911) (temp___183 85 36 (to_rep a__first) (+ (to_rep a__first) 1))))
(assert (= temp___191 temp___192))
(assert (= (mk (to_rep (first2 temp___1911)) (to_rep (last2 temp___1911))) temp___1921))
(assert (not (= (ite (<= (to_rep (first temp___1921)) (to_rep (last temp___1921))) (+ (- (to_rep (last temp___1921)) (to_rep (first temp___1921))) 1) 0) (ite (<= (to_rep a__first) (to_rep a__last)) (+ (- (to_rep a__last) (to_rep a__first)) 1) 0))))
(check-sat)
(exit)
