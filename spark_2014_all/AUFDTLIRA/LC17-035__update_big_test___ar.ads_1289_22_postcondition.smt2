...
(declare-fun temp_____aggregate_def_2934 ((Array Int us_rep) Int us_rep) (Array Int us_rep))
...
(assert (forall ((temp___2936 (Array Int us_rep))) (forall ((temp___2937 Int)) (forall ((temp___2938 us_rep)) (let ((temp___2935 (temp_____aggregate_def_2934 temp___2936 temp___2937 temp___2938))) (=> (dynamic_invariant temp___2937 true true true true) (forall ((temp___2939 Int)) (ite (= temp___2939 temp___2937) (= (select temp___2935 temp___2939) temp___2938) (= (select temp___2935 temp___2939) (select temp___2936 temp___2939))))))))))
...
(assert (= a2 a3))
(assert (= a4 a2))
(assert (not (= (bool_eq1 a3 1 10 (temp_____aggregate_def_2934 a i (mk___rep (mk___split_fields (of_rep e) (rec__ar__rec1t__g1 (us_split_fields1 r))))) 1 10) true)))
(check-sat)
(exit)
