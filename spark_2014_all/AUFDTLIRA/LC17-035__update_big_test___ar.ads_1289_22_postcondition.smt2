...
(assert (forall ((temp___2877 (Array Int us_rep))) (forall ((temp___2878 Int)) (forall ((temp___2879 us_rep)) (let ((temp___2876 (temp___2875 temp___2877 temp___2878 temp___2879))) (forall ((temp___2880 Int)) (ite (= temp___2880 temp___2878) (= (select temp___2876 temp___2880) temp___2879) (= (select temp___2876 temp___2880) (select temp___2877 temp___2880)))))))))
...
(assert (= a2 a3))
(assert (= a4 a2))
(assert (not (= (bool_eq1 a3 1 10 (temp___2875 a i (mk___rep (mk___split_fields (of_rep e) (rec__ar__rec1t__g1 (us_split_fields1 r))))) 1 10) true)))
(check-sat)
(exit)
