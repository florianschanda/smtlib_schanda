...
(declare-fun temp___2934 ((Array Int us_rep) Int us_rep) (Array Int us_rep))
...
(assert (= a2 a3))
(assert (= a4 a2))
(assert (not (= (bool_eq1 a3 1 10 (temp___2934 a i (mk___rep (mk___split_fields (of_rep e) (rec__ar__rec1t__g1 (us_split_fields1 r))))) 1 10) true)))
(check-sat)
(exit)
