...
(declare-const imax10 Int)
(declare-const i10 Int)
(declare-const max__max__result4 Int)
(declare-const imax11 Int)
...
(assert (= i1 2))
(assert (=> (and (<= 2 i1) (<= i1 10)) (and (and (= temp___145 i1) (and (= temp___144 imax1) (and (<= (to_rep (select t 1)) imax2) (and (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 imax2)) (=> (<= 2 10) (in_range2 i2))) (and (<= 2 i2) (<= i2 10))) (and (ite (< imax2 (to_rep (select t i2))) (and (= imax2 result2) (= imax3 (to_rep (select t i2)))) (= imax3 imax2)) (= i2 10)))))) (and (and (= i2 i6) (= imax3 imax6)) (and (= i7 i2) (= imax7 imax3))))))
(assert (=> (and (<= 2 i1) (<= i1 10)) (= (mk_int__ref i8) (mk_int__ref i6))))
(assert (=> (and (<= 2 i1) (<= i1 10)) (= (mk_int__ref imax8) (mk_int__ref imax6))))
(assert (=> (and (<= 2 i1) (<= i1 10)) (= i9 i7)))
(assert (=> (and (<= 2 i1) (<= i1 10)) (= imax9 imax7)))
(assert (=> (not (and (<= 2 i1) (<= i1 10))) (= i1 i8)))
(assert (=> (not (and (<= 2 i1) (<= i1 10))) (= imax1 imax8)))
(assert (=> (not (and (<= 2 i1) (<= i1 10))) (= i9 i1)))
(assert (=> (not (and (<= 2 i1) (<= i1 10))) (= imax9 imax1)))
(assert (= max__max__result1 max__max__result2))
(assert (= max__max__result3 max__max__result1))
(assert (= result4 max__max__result))
(assert (= max__max__result1 imax8))
...
(assert (= i11 i9))
(assert (= imax11 imax9))
(assert (= result5 max__max__result4))
