...
(define-fun dynamic_invariant2 ((temp___expr_239 Int) (temp___is_init_235 Bool) (temp___skip_constant_236 Bool) (temp___do_toplevel_237 Bool) (temp___do_typ_inv_238 Bool)) Bool (=> (or (= temp___is_init_235 true) (<= 0 5)) (in_range3 temp___expr_239)))
...
(declare-const temp___8074 (Array Int et1))
(declare-const temp___80741 enum2t)
(declare-const o4 et1)
(declare-const o5 (Array Int et1))
(declare-const o6 (Array Int et1))
(declare-const o7 enum2t)
(declare-const temp___8077 (Array Int et1))
(declare-const temp___80771 enum2t)
...
(assert (= temp___8074 o2))
(assert (= temp___80741 o3))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= temp___8074 r__split_fields2))
(assert (= temp___80741 r__split_fields3))
(assert (= (to_rep o4) f))
(assert (= o5 (store r__split_fields2 j o4)))
(assert (= o5 o6))
(assert (= r__split_fields3 o7))
(assert (= temp___8077 o6))
(assert (= temp___80771 o7))
(assert (= result2 r__split_fields2))
(assert (= result3 r__split_fields3))
(assert (= temp___8077 r__split_fields4))
(assert (= temp___80771 r__split_fields5))
...
(assert (not (= (to_rep (select r__split_fields6 i)) e)))
(check-sat)
(exit)
