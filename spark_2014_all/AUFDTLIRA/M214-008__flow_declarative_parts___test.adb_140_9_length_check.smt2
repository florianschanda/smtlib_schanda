...
(declare-datatypes () ((t36b__ref (mk_t36b__ref (t36b__content us_t1)))))
(define-fun t36b__ref___projection ((a t36b__ref)) us_t1 (t36b__content a))
(declare-fun temp_____aggregate_def_323 (Int Int Int) us_t1)
...
(assert (forall ((temp___325 Int) (temp___326 Int) (temp___327 Int)) (let ((temp___324 (temp_____aggregate_def_323 temp___325 temp___326 temp___327))) (=> (dynamic_invariant2 temp___325 true true true true) (and (=> (dynamic_property 1 2147483647 temp___326 temp___327) (and (= (first3 temp___324) temp___326) (= (last3 temp___324) temp___327))) (forall ((temp___328 Int)) (= (to_rep (select (to_array1 temp___324) temp___328)) temp___325)))))))
(declare-const b Int)
(declare-const temp___330 (Array Int character))
(declare-const temp___3301 t1)
(declare-const temp___331 (Array Int character))
(declare-const temp___3311 t)
(assert (dynamic_property 1 2147483647 (to_rep1 a__first) (to_rep1 a__last)))
(assert (=> (<= (- 2147483648) 2147483647) (in_range b)))
(assert (= (to_rep1 (first2 (rt1 (temp_____aggregate_def_323 32 (to_rep1 a__first) (to_rep1 a__last))))) (to_rep1 a__first)))
(assert (= (to_rep1 (last2 (rt1 (temp_____aggregate_def_323 32 (to_rep1 a__first) (to_rep1 a__last))))) (to_rep1 a__last)))
(assert (= (mk___t1 temp___330 temp___3301) (temp_____aggregate_def_323 32 (to_rep1 a__first) (to_rep1 a__last))))
(assert (= temp___330 temp___331))
(assert (= (mk (to_rep1 (first2 temp___3301)) (to_rep1 (last2 temp___3301))) temp___3311))
(assert (not (= (ite (<= (to_rep1 (first temp___3311)) (to_rep1 (last temp___3311))) (+ (- (to_rep1 (last temp___3311)) (to_rep1 (first temp___3311))) 1) 0) (ite (<= (to_rep1 a__first) (to_rep1 a__last)) (+ (- (to_rep1 a__last) (to_rep1 a__first)) 1) 0))))
(check-sat)
(exit)
