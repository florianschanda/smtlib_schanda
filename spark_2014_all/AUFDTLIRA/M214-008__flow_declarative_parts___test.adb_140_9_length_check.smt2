...
(declare-fun temp___323 (Int Int Int) us_t1)
...
(assert (forall ((temp___325 Int) (temp___326 Int) (temp___327 Int)) (let ((temp___324 (temp___323 temp___325 temp___326 temp___327))) (=> (dynamic_invariant2 temp___325 true true true true) (and (=> (dynamic_property 1 2147483647 temp___326 temp___327) (and (= (first3 temp___324) temp___326) (= (last3 temp___324) temp___327))) (forall ((temp___328 Int)) (= (to_rep (select (to_array1 temp___324) temp___328)) temp___325)))))))
(declare-const b Int)
...
(assert (= (to_rep1 (first2 (rt1 (temp___323 32 (to_rep1 a__first) (to_rep1 a__last))))) (to_rep1 a__first)))
(assert (= (to_rep1 (last2 (rt1 (temp___323 32 (to_rep1 a__first) (to_rep1 a__last))))) (to_rep1 a__last)))
(assert (= (mk___t1 temp___330 temp___3301) (temp___323 32 (to_rep1 a__first) (to_rep1 a__last))))
