...
(declare-fun temp___287 (Int Int Int) us_t1)
(assert (forall ((temp___289 Int) (temp___290 Int) (temp___291 Int)) (let ((temp___288 (temp___287 temp___289 temp___290 temp___291))) (and (=> (dynamic_property 1 2147483647 temp___290 temp___291) (and (= (first3 temp___288) temp___290) (= (last3 temp___288) temp___291))) (forall ((temp___292 Int)) (= (select (to_array1 temp___288) temp___292) (of_rep temp___289)))))))
...
(declare-const b Int)
(declare-const temp___294 (Array Int character))
(declare-const temp___2941 t1)
(declare-const temp___295 (Array Int character))
(declare-const temp___2951 t)
(assert (dynamic_property 1 2147483647 (to_rep1 a__first) (to_rep1 a__last)))
(assert (=> (<= (- 2147483648) 2147483647) (in_range b)))
(assert (= (to_rep1 (first2 (rt1 (temp___287 32 (to_rep1 a__first) (to_rep1 a__last))))) (to_rep1 a__first)))
(assert (= (to_rep1 (last2 (rt1 (temp___287 32 (to_rep1 a__first) (to_rep1 a__last))))) (to_rep1 a__last)))
(assert (= (mk___t1 temp___294 temp___2941) (temp___287 32 (to_rep1 a__first) (to_rep1 a__last))))
(assert (= temp___294 temp___295))
(assert (= (mk (to_rep1 (first2 temp___2941)) (to_rep1 (last2 temp___2941))) temp___2951))
(assert (not (= (ite (<= (to_rep1 (first temp___2951)) (to_rep1 (last temp___2951))) (+ (- (to_rep1 (last temp___2951)) (to_rep1 (first temp___2951))) 1) 0) (ite (<= (to_rep1 a__first) (to_rep1 a__last)) (+ (- (to_rep1 a__last) (to_rep1 a__first)) 1) 0))))
(check-sat)
(exit)
