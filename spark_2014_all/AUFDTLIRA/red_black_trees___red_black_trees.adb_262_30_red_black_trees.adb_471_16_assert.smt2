...
(assert (=> (and (<= 1 n5) (<= n5 100)) (=> (= result14 true) (= (rec__red_black_trees__black_count__status (us_split_fields11 (select (nb_blacks c95b) c96b))) true))))
(assert (=> (and (<= 1 n5) (<= n5 100)) (=> (= result14 true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (nb_blacks c95b) c96b)))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (nb_blacks c94b) c96b))))))))
