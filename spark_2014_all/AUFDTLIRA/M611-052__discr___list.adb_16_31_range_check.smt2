...
(assert (<= r4b i1))
(assert (<= i1 r5b))
(assert (and (and (dynamic_property4 1 r1b (to_rep (first4 (rt2 (rec__stack__stack__content1 s__split_fields3)))) (to_rep (last5 (rt2 (rec__stack__stack__content1 s__split_fields3))))) (and (= (to_rep (first4 (rt2 (rec__stack__stack__content1 s__split_fields3)))) 1) (= (to_rep (last5 (rt2 (rec__stack__stack__content1 s__split_fields3)))) r1b))) (and (<= r4b i2) (<= i2 r5b))))
