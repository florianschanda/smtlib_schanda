...
(assert (<= r4b i3))
(assert (<= i3 r5b))
(assert (and (and (dynamic_property4 1 r1b (to_rep (first4 (rt2 (rec__stack__stack__content1 s__split_fields4)))) (to_rep (last5 (rt2 (rec__stack__stack__content1 s__split_fields4))))) (and (= (to_rep (first4 (rt2 (rec__stack__stack__content1 s__split_fields4)))) 1) (= (to_rep (last5 (rt2 (rec__stack__stack__content1 s__split_fields4)))) r1b))) (and (<= r4b i4) (<= i4 r5b))))
(assert (not (in_range4 i4)))
(check-sat)
(exit)
