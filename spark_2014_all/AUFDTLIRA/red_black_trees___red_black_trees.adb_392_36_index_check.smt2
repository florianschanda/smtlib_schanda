...
(assert (and (= temp___943 (parent (rec__red_black_trees__rbt__struct t__split_fields7) i)) (and (in_range3 temp___943) (and (= temp___943 (parent1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields7))) i)) (=> (= (size (rec__red_black_trees__rbt__struct t__split_fields7)) 0) (= temp___943 0))))))
