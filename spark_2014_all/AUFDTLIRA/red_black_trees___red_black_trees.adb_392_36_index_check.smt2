...
(assert (<= i 100))
(assert (not (= i x2)))
(assert (and (= o9 (parent (rec__red_black_trees__rbt__struct t__split_fields7) i)) (and (in_range3 o9) (and (= o9 (parent1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields7))) i)) (=> (= (size (rec__red_black_trees__rbt__struct t__split_fields7)) 0) (= o9 0))))))
(assert (= result5 (ite (= o9 0) true false)))
(assert (not (= result5 true)))
(assert (and (= temp___992 (parent (rec__red_black_trees__rbt__struct t__split_fields7) i)) (and (in_range3 temp___992) (and (= temp___992 (parent1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields7))) i)) (=> (= (size (rec__red_black_trees__rbt__struct t__split_fields7)) 0) (= temp___992 0))))))
(assert (not (<= 1 temp___992)))
(check-sat)
(exit)
