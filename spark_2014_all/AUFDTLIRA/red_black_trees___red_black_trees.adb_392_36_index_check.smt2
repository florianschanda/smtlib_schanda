...
(assert (<= i3 100))
(assert (not (= i3 x2)))
(assert (and (= o32 (parent (rec__red_black_trees__rbt__struct t__split_fields7) i3)) (and (in_range3 o32) (and (= o32 (parent1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields7))) i3)) (=> (= (size (rec__red_black_trees__rbt__struct t__split_fields7)) 0) (= o32 0))))))
(assert (= result18 (ite (= o32 0) true false)))
(assert (not (= result18 true)))
(assert (and (= temp___943 (parent (rec__red_black_trees__rbt__struct t__split_fields7) i3)) (and (in_range3 temp___943) (and (= temp___943 (parent1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields7))) i3)) (=> (= (size (rec__red_black_trees__rbt__struct t__split_fields7)) 0) (= temp___943 0))))))
