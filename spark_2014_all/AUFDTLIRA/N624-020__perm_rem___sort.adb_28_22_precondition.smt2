...
(assert (and (= temp___2132 (remove (mk___t interm1 (mk 1 100)) o9)) (and (dynamic_invariant4 temp___2132 true false true) (and (= (invariant__ temp___2132) true) (and (= (to_rep1 (last temp___2131)) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o9 1))) (= (to_rep (select interm1 k)) (to_rep (select temp___213 k))))) (and (forall ((k Int)) (=> (and (<= (+ o9 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select interm1 k)) (to_rep (select temp___213 (- k 1)))))) (forall ((k Int)) (=> (and (<= o9 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select interm1 (+ k 1))) (to_rep (select temp___213 k))))))))))))
