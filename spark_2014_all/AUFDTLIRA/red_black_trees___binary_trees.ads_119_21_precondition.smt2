...
(assert (<= i1 100))
(assert (= (tree_structure f) true))
(assert (and (= temp___691 (model__ f t2)) (and (dynamic_invariant2 temp___691 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___691 t2))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___691 t2)))) 0) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (not (= i2 t2)) (ite (and (not (= (parent f i2) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___691 (parent f i2)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___691 i2))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___691 i2))) true)))))) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___691 i2))) true) (not (= i2 t2))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___691 (parent f i2)))) (position f i2) (rec__tree_model__path_type__a (us_split_fields1 (select temp___691 i2)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___691 i2)))) 0)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___691 i2))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___691 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___691 i2))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___691 j)))) true)) (= j i2))))))))))))))
(assert (= (mk___rep (mk___split_fields o12 o13)) (select temp___691 i1)))
(assert (= o12 o14))
(assert (= o13 o15))
(assert (= o16 o15))
(assert (= o17 (ite (not (= o16 true)) true false)))
(assert (= (tree_structure f) true))
