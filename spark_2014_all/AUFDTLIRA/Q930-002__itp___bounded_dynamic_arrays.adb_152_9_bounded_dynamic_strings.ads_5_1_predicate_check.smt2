...
(assert (dynamic_predicate (mk___rep (mk___split_discrs temp___1096) (mk___split_fields temp___10961 (mk___t2 temp___10962 temp___10963)))))
(assert (= (mk___rep (mk___split_discrs temp___1097) (mk___split_fields temp___10971 (mk___t2 temp___10972 temp___10973))) (mk___rep (mk___split_discrs temp___1096) (mk___split_fields temp___10961 (mk___t2 temp___10962 temp___10963)))))
...
(assert (= to____split_fields3 (mk___split_fields temp___10971 (mk___t2 temp___10972 temp___10973))))
...
(assert (= temp___1099 (mk___rep to____split_discrs (mk___split_fields o15 (mk___t2 o16 o17)))))
(assert (not (dynamic_predicate temp___1099)))
(check-sat)
(exit)
