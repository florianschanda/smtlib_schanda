...
(define-fun bool_eq1 ((a us_rep) (b us_rep)) Bool (ite (and (= (bool_eq (rec__stackp__stack_root__content (us_split_fields1 a)) 1 100 (rec__stackp__stack_root__content (us_split_fields1 b)) 1 100) true) (= (to_rep1 (rec__stackp__stack_root__length (us_split_fields1 a))) (to_rep1 (rec__stackp__stack_root__length (us_split_fields1 b))))) true false))
...
(define-fun default_initial_assumption ((temp___expr_159 us_rep) (temp___skip_top_level_160 Bool)) Bool (and (and (= (attr__tag temp___expr_159) us_tag) (= (to_rep1 (rec__stackp__stack_root__length (us_split_fields1 temp___expr_159))) 0)) (=> (not (= temp___skip_top_level_160 true)) (= (size temp___expr_159) 0))))
...
(define-fun default_initial_assumption1 ((temp___expr_361 us_rep1) (temp___skip_top_level_362 Bool)) Bool (and (and (= (attr__tag1 temp___expr_361) us_tag1) (and (= (to_rep3 (rec__stackp__buffer__first (us_split_fields3 temp___expr_361))) 1) (= (to_rep1 (rec__stackp__stack_root__length1 (us_split_fields3 temp___expr_361))) 0))) (=> (not (= temp___skip_top_level_362 true)) (= (size (to_base temp___expr_361)) 0))))
...
(define-fun dynamic_property1 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range3 low) (and (in_range3 high) (=> (<= low high) (and (in_range5 low) (in_range5 high))))))
...
(define-fun dynamic_invariant4 ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= 0 100)) (in_range2 temp___expr_136)))
(assert (forall ((s us_rep)) (! (dynamic_invariant4 (size s) true false true) :pattern ((size s)))))
(assert (forall ((s us_rep)) (! (= (size s) (to_rep1 (rec__stackp__stack_root__length (us_split_fields1 s)))) :pattern ((size s)))))
...
(assert (forall ((s us_rep1)) (! (= (= (wraps_around s) true) (< 100 (- (+ (to_rep3 (rec__stackp__buffer__first (us_split_fields3 s))) (to_rep1 (rec__stackp__stack_root__length1 (us_split_fields3 s)))) 1))) :pattern ((wraps_around s)))))
...
(assert (forall ((s us_rep1)) (! (= (last4 s) (ite (not (= (wraps_around s) true)) (- (+ (to_rep3 (rec__stackp__buffer__first (us_split_fields3 s))) (to_rep1 (rec__stackp__stack_root__length1 (us_split_fields3 s)))) 1) (- (- (+ (to_rep3 (rec__stackp__buffer__first (us_split_fields3 s))) (to_rep1 (rec__stackp__stack_root__length1 (us_split_fields3 s)))) 1) 100))) :pattern ((last4 s)))))
