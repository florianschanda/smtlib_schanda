...
(declare-datatypes () ((arr_int_unconstrained__ref (mk_arr_int_unconstrained__ref (arr_int_unconstrained__content us_t)))))
(define-fun arr_int_unconstrained__ref___projection ((a arr_int_unconstrained__ref)) us_t (arr_int_unconstrained__content a))
(declare-sort t1 0)
...
(define-fun dynamic_invariant2 ((temp___expr_163 us_t) (temp___is_init_160 Bool) (temp___skip_constant_161 Bool) (temp___do_toplevel_162 Bool)) Bool (=> (not (= temp___skip_constant_161 true)) (dynamic_property (- 2147483648) 2147483647 (first1 temp___expr_163) (last1 temp___expr_163))))
(define-fun dynamic_invariant3 ((temp___expr_187 us_t1) (temp___is_init_184 Bool) (temp___skip_constant_185 Bool) (temp___do_toplevel_186 Bool)) Bool (=> (not (= temp___skip_constant_185 true)) (dynamic_property1 (- 2147483648) 2147483647 (first3 temp___expr_187) (last3 temp___expr_187))))
(declare-const temp___244 (Array Int integer))
(declare-const temp___2441 t)
...
(assert (= arr temp___244))
(assert (= (mk 1 10) temp___2441))
(assert (not (dynamic_property1 (- 2147483648) 2147483647 (to_rep (first temp___2441)) (to_rep (last temp___2441)))))
(check-sat)
(exit)
