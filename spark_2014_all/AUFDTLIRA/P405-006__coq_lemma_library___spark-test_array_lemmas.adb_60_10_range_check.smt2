...
(define-fun dynamic_invariant2 ((temp___expr_189 us_t) (temp___is_init_185 Bool) (temp___skip_constant_186 Bool) (temp___do_toplevel_187 Bool) (temp___do_typ_inv_188 Bool)) Bool (=> (not (= temp___skip_constant_186 true)) (dynamic_property (- 2147483648) 2147483647 (first1 temp___expr_189) (last1 temp___expr_189))))
(define-fun dynamic_invariant3 ((temp___expr_217 us_t1) (temp___is_init_213 Bool) (temp___skip_constant_214 Bool) (temp___do_toplevel_215 Bool) (temp___do_typ_inv_216 Bool)) Bool (=> (not (= temp___skip_constant_214 true)) (dynamic_property1 (- 2147483648) 2147483647 (first3 temp___expr_217) (last3 temp___expr_217))))
(declare-const temp___281 (Array Int integer))
(declare-const temp___2811 t)
...
(assert (= (mk 1 10) temp___2811))
(assert (not (dynamic_property1 (- 2147483648) 2147483647 (to_rep (first temp___2811)) (to_rep (last temp___2811)))))
(check-sat)
(exit)
