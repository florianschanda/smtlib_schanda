...
(assert (forall ((temp___174 Int) (temp___175 Int) (temp___176 Int)) (let ((temp___173 (array_logical_ops__test_ok5__y__aggregate_def temp___174 temp___175 temp___176))) (forall ((temp___177 Int)) (ite (and (<= 31 temp___177) (<= temp___177 40)) (= (select temp___173 temp___177) (of_rep temp___176)) (ite (and (<= 11 temp___177) (<= temp___177 30)) (= (select temp___173 temp___177) (of_rep temp___175)) (=> (and (<= 1 temp___177) (<= temp___177 10)) (= (select temp___173 temp___177) (of_rep temp___174)))))))))
