...
(declare-fun temp___3390 ((Array Int (Array Int (Array Int et1))) Int (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1))))
(declare-fun temp___3396 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
(declare-fun temp___3403 ((Array Int et1) Int Int) (Array Int et1))
...
(assert (forall ((temp___3392 (Array Int (Array Int (Array Int et1))))) (forall ((temp___3393 Int)) (forall ((temp___3394 (Array Int (Array Int et1)))) (let ((temp___3391 (temp___3390 temp___3392 temp___3393 temp___3394))) (=> (dynamic_invariant2 temp___3393 true true true true) (forall ((temp___3395 Int)) (ite (= temp___3395 temp___3393) (= (select temp___3391 temp___3395) temp___3394) (= (select temp___3391 temp___3395) (select temp___3392 temp___3395))))))))))
(assert (forall ((temp___3398 (Array Int (Array Int et1)))) (forall ((temp___3399 Int)) (forall ((temp___3400 (Array Int et1))) (let ((temp___3397 (temp___3396 temp___3398 temp___3399 temp___3400))) (=> (dynamic_invariant1 temp___3399 true true true true) (forall ((temp___3401 Int)) (ite (= temp___3401 temp___3399) (= (select temp___3397 temp___3401) temp___3400) (= (select temp___3397 temp___3401) (select temp___3398 temp___3401))))))))))
(assert (forall ((temp___3405 (Array Int et1))) (forall ((temp___3406 Int) (temp___3407 Int)) (let ((temp___3404 (temp___3403 temp___3405 temp___3406 temp___3407))) (=> (and (dynamic_invariant temp___3406 true true true true) (dynamic_invariant3 temp___3407 true true true true)) (forall ((temp___3408 Int)) (ite (= temp___3408 temp___3406) (= (to_rep (select temp___3404 temp___3408)) temp___3407) (= (select temp___3404 temp___3408) (select temp___3405 temp___3408)))))))))
...
(declare-const temp___8523 enum1tb)
(declare-const temp___85231 (Array Int (Array Int (Array Int et1))))
(declare-const temp___85232 Bool)
...
(assert (= temp___8523 o4))
(assert (= temp___85231 o5))
(assert (= temp___85232 o6))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= result2 r__split_fields2))
(assert (= temp___8523 r__split_fields3))
(assert (= temp___85231 r__split_fields4))
(assert (= temp___85232 r__split_fields5))
...
(assert (not (= (bool_eq2 r__split_fields7 1 16 (temp___3390 r__split_fields1 i (temp___3396 (select r__split_fields1 i) j (temp___3403 (select (select r__split_fields1 i) j) k e))) 1 16) true)))
(check-sat)
(exit)
