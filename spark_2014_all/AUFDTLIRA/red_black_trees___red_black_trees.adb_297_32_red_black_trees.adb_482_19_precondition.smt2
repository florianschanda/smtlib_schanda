...
(declare-const temp___689 (Array Int us_rep7))
...
(declare-const temp___688 (Array Int us_rep7))
(declare-const o33 Int)
(declare-const o34 us_rep7)
...
(assert (and (= temp___689 (nb_blacks c100b)) (and (= (bool_eq11 (select temp___689 0) (mk___rep5 (mk___split_fields5 (distinct 1 0) rliteral rliteral))) true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c100b))) i))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___689 i))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___689 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___689 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___689 i)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___689 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___689 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___689 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___689 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___689 i)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c100b)) i)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___689 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i 0))))))))))))))
(assert (and (= o28 (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c101b)) y2)) (and (in_range2 o28) (and (= o28 (parent1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 c101b)))) y2)) (=> (= (size (rec__red_black_trees__rbt__struct (us_split_fields9 c101b))) 0) (= o28 0))))))
(assert (= o29 (select temp___689 o28)))
...
(assert (and (= temp___688 (nb_blacks c100b)) (and (= (bool_eq11 (select temp___688 0) (mk___rep5 (mk___split_fields5 (distinct 1 0) rliteral rliteral))) true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c100b))) i))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___688 i))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___688 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___688 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___688 i)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___688 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___688 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___688 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___688 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___688 i)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c100b)) i)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___688 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i 0))))))))))))))
(assert (and (= o33 (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c101b)) y2)) (and (in_range2 o33) (and (= o33 (parent1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 c101b)))) y2)) (=> (= (size (rec__red_black_trees__rbt__struct (us_split_fields9 c101b))) 0) (= o33 0))))))
(assert (= o34 (select temp___688 o33)))
