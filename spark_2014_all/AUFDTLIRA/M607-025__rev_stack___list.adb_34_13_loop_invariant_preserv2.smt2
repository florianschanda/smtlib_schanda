...
(assert (and (= o2 (top (mk___rep s__split_fields9))) (and (in_range1 o2) (and (= o2 (to_rep (select (rec__stack__stack__content s__split_fields9) (to_rep1 (rec__stack__stack__top s__split_fields9))))) (= o2 (to_rep (select (elts (to__ (mk___rep s__split_fields9))) (to_rep (last (rt (to__ (mk___rep s__split_fields9))))))))))))
...
(assert (= res__split_fields3 list__my_lists__append__2__container__fields))
(assert (= (let ((temp___222 (to__ (mk___rep s__split_fields10)))) (bool_eq (elts temp___222) (to_rep (first (rt temp___222))) (to_rep (last (rt temp___222))) (elts (to__ (mk___rep s__split_fields9))) (to_rep (first2 (mk1 1 (- (to_rep (last (rt (to__ (mk___rep s__split_fields9))))) 1)))) (to_rep (last2 (mk1 1 (- (to_rep (last (rt (to__ (mk___rep s__split_fields9))))) 1)))))) true))
(assert (not (= i9 last5)))
(assert (= result5 (mk_int__ref i9)))
(assert (= i10 (+ i9 1)))
(assert (= i11 (mk_int__ref i10)))
(assert (= res__split_fields4 (mk___split_fields__ref1 res__split_fields3)))
(assert (= s__split_fields11 (mk___split_fields__ref s__split_fields10)))
(assert (= rho list__my_lists__append__2__container__fields))
(assert (= i12 i10))
(assert (= res__split_fields5 res__split_fields3))
(assert (= s__split_fields12 s__split_fields10))
(assert (not (= (length2 (mk___rep1 res__split_discrs (us_split_fields__content1 res__split_fields4))) (- (int__content i11) first4))))
(check-sat)
(exit)
