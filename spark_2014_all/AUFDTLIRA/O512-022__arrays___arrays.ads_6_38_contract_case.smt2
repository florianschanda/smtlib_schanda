...
(assert (= j2 (to_rep1 (first (rt x)))))
(assert (=> (and (<= (to_rep1 (first (rt x))) j2) (<= j2 (to_rep1 (last (rt x))))) (= temp___164 s1)))
(assert (=> (and (<= (to_rep1 (first (rt x))) j2) (<= j2 (to_rep1 (last (rt x))))) (and (=> (<= 0 2147483647) (in_range2 s2)) (and (<= (to_rep1 (first (rt x))) j3) (<= j3 (to_rep1 (last (rt x))))))))
(assert (=> (and (<= (to_rep1 (first (rt x))) j2) (<= j2 (to_rep1 (last (rt x))))) (and (= o (+ s2 (to_rep (select (elts x) j3)))) (in_range1 (+ s2 (to_rep (select (elts x) j3)))))))
(assert (=> (and (<= (to_rep1 (first (rt x))) j2) (<= j2 (to_rep1 (last (rt x))))) (= s2 result2)))
(assert (=> (and (<= (to_rep1 (first (rt x))) j2) (<= j2 (to_rep1 (last (rt x))))) (= s3 o)))
(assert (=> (and (<= (to_rep1 (first (rt x))) j2) (<= j2 (to_rep1 (last (rt x))))) (= j3 (to_rep1 (last (rt x))))))
(assert (=> (and (<= (to_rep1 (first (rt x))) j2) (<= j2 (to_rep1 (last (rt x))))) (= j3 j4)))
(assert (=> (and (<= (to_rep1 (first (rt x))) j2) (<= j2 (to_rep1 (last (rt x))))) (= s3 s4)))
(assert (=> (and (<= (to_rep1 (first (rt x))) j2) (<= j2 (to_rep1 (last (rt x))))) (= j5 j3)))
(assert (=> (and (<= (to_rep1 (first (rt x))) j2) (<= j2 (to_rep1 (last (rt x))))) (= s5 s3)))
(assert (=> (and (<= (to_rep1 (first (rt x))) j2) (<= j2 (to_rep1 (last (rt x))))) (= (mk_int__ref j6) (mk_int__ref j4))))
(assert (=> (and (<= (to_rep1 (first (rt x))) j2) (<= j2 (to_rep1 (last (rt x))))) (= (mk_int__ref s6) (mk_int__ref s4))))
(assert (=> (and (<= (to_rep1 (first (rt x))) j2) (<= j2 (to_rep1 (last (rt x))))) (= j7 j5)))
(assert (=> (and (<= (to_rep1 (first (rt x))) j2) (<= j2 (to_rep1 (last (rt x))))) (= s7 s5)))
(assert (=> (not (and (<= (to_rep1 (first (rt x))) j2) (<= j2 (to_rep1 (last (rt x)))))) (= j2 j6)))
(assert (=> (not (and (<= (to_rep1 (first (rt x))) j2) (<= j2 (to_rep1 (last (rt x)))))) (= s1 s6)))
(assert (=> (not (and (<= (to_rep1 (first (rt x))) j2) (<= j2 (to_rep1 (last (rt x)))))) (= j7 j2)))
(assert (=> (not (and (<= (to_rep1 (first (rt x))) j2) (<= j2 (to_rep1 (last (rt x)))))) (= s7 s1)))
