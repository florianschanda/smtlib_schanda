...
(assert (in_range1 d))
(assert (not (= c 0)))
(assert (and (= us c) (dynamic_property 0 last c)))
(assert (= o c))
(assert (= o1 (of_rep1 o)))
(assert (= o2 (mk___split_fields o1 dummy3)))
(assert (= usq_ (mk___rep (mk___split_discrs (distinct 1 0)) o2 true)))
(assert (= o3 (mk___rep (us_split_discrs1 usq_) (us_split_fields1 usq_) false)))
(assert (= temp___263 (temp___257 o3 1 d)))
(assert (= (to_rep1 (first4 (rt2 temp___263))) 1))
(assert (= (to_rep1 (last5 (rt2 temp___263))) d))
(assert (= temp___264 temp___263))
(assert (not (= (ite (<= (to_rep1 (first4 (rt2 temp___264))) (to_rep1 (last5 (rt2 temp___264)))) (+ (- (to_rep1 (last5 (rt2 temp___264))) (to_rep1 (first4 (rt2 temp___264)))) 1) 0) (ite (<= 1 d) (+ (- d 1) 1) 0))))
(check-sat)
(exit)
