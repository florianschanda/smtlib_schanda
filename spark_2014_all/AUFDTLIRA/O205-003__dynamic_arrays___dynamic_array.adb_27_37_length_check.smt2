...
(assert (= o18 c))
(assert (= o19 (of_rep1 o18)))
(assert (= o20 (mk___split_fields o19 dummy3)))
(assert (= usq_4 (mk___rep (mk___split_discrs (of_int 1)) o20 true)))
(assert (= o21 (mk___rep (us_split_discrs1 usq_4) (us_split_fields1 usq_4) false)))
(assert (= temp___236 (temp___230 o21 1 d)))
