...
(assert (= usq_ (mk___rep (mk___split_discrs (of_int 1)) o2 true)))
(assert (= o3 (mk___rep (us_split_discrs1 usq_) (us_split_fields1 usq_) false)))
(assert (= temp___236 (temp___230 o3 1 d)))
(assert (= (to_rep1 (first4 (rt2 temp___236))) 1))
(assert (= (to_rep1 (last5 (rt2 temp___236))) d))
(assert (= temp___237 temp___236))
(assert (not (= (ite (<= (to_rep1 (first4 (rt2 temp___237))) (to_rep1 (last5 (rt2 temp___237)))) (+ (- (to_rep1 (last5 (rt2 temp___237))) (to_rep1 (first4 (rt2 temp___237)))) 1) 0) (ite (<= 1 d) (+ (- d 1) 1) 0))))
(check-sat)
(exit)
