...
(assert (and (= o23 (length3 right)) (and (in_range5 o23) (= o23 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right)))))))
(assert (= o24 (+ 1 o23)))
(assert (= o25 (ite (= (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 (sequence__content bounded_dynamic_strings__Oconcat__5__result10)))) o24) true false)))
(assert (and (= o19 (length3 right)) (and (in_range5 o19) (= o19 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right)))))))
(assert (= o20 (+ 1 o19)))
(assert (and (= o21 (length3 (sequence__content bounded_dynamic_strings__Oconcat__5__result10))) (and (in_range5 o21) (= o21 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 (sequence__content bounded_dynamic_strings__Oconcat__5__result10))))))))
(assert (= o22 (ite (= o21 o20) true false)))
(assert (and (= (mk___t1 temp___1013 temp___10131) (value right)) (and (dynamic_invariant3 (mk___t1 temp___1013 temp___10131) true false true) (and (and (= (elts2 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 right))) temp___1013) (= (mk1 (to_rep1 (first6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right)))))) (to_rep1 (last6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right))))))) temp___10131)) (and (and (and (= (length1 (mk___t1 temp___1013 temp___10131)) (length3 right)) (= (to_rep1 (first2 temp___10131)) 1)) (= (to_rep1 (last2 temp___10131)) (length3 right))) (= (< 0 (length3 right)) (not (= (empty right) true))))))))
(assert (=> (<= (to_rep1 (first2 temp___10131)) (to_rep1 (last2 temp___10131))) (= o14 (+ (- (to_rep1 (last2 temp___10131)) (to_rep1 (first2 temp___10131))) 1))))
(assert (=> (not (<= (to_rep1 (first2 temp___10131)) (to_rep1 (last2 temp___10131)))) (= o14 0)))
(assert (= o15 (+ 1 o14)))
(assert (= o16 (+ 1 o15)))
(assert (= o17 (- o16 1)))
