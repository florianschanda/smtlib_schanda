...
(declare-const temp___1076 (Array Int character))
(declare-const temp___10761 t1)
...
(define-fun temp___10762 () us_t1 (mk___t1 temp___1076 temp___10761))
(define-fun o24 () us_rep (mk___rep (mk___split_discrs o9) (mk___split_fields o10 (mk___t2 o11 o12))))
(define-fun o25 () us_t1 (mk___t1 o7 o8))
...
(assert (and (= o24 (instance (+ (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right))) 1) o25)) (and (dynamic_invariant1 o24 true false true true) (and (and (= (to_rep2 o9) (+ (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right))) 1)) (= (length3 o24) (length1 o25))) (= (let ((temp___270 (value o24))) (bool_eq (elts1 temp___270) (to_rep1 (first2 (rt1 temp___270))) (to_rep1 (last2 (rt1 temp___270))) o7 (to_rep1 (first2 o8)) (to_rep1 (last2 o8)))) true)))))
...
(assert (and (= o21 (length3 right)) (and (in_range5 o21) (= o21 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right)))))))
(assert (= o22 (+ 1 o21)))
...
(assert (and (= o17 (length3 right)) (and (in_range5 o17) (= o17 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right)))))))
(assert (= o18 (+ 1 o17)))
(assert (and (= o19 (length3 (sequence__content bounded_dynamic_strings__Oconcat__5__result10))) (and (in_range5 o19) (= o19 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 (sequence__content bounded_dynamic_strings__Oconcat__5__result10))))))))
(assert (= o20 (ite (= o19 o18) true false)))
(assert (and (= temp___10762 (value right)) (and (dynamic_invariant3 temp___10762 true false true true) (and (and (= (elts2 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 right))) temp___1076) (= (mk1 (to_rep1 (first6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right)))))) (to_rep1 (last6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right))))))) temp___10761)) (and (and (and (= (length1 temp___10762) (length3 right)) (= (to_rep1 (first2 temp___10761)) 1)) (= (to_rep1 (last2 temp___10761)) (length3 right))) (= (< 0 (length3 right)) (not (= (empty right) true))))))))
(assert (=> (<= (to_rep1 (first2 temp___10761)) (to_rep1 (last2 temp___10761))) (= o13 (+ (- (to_rep1 (last2 temp___10761)) (to_rep1 (first2 temp___10761))) 1))))
(assert (=> (not (<= (to_rep1 (first2 temp___10761)) (to_rep1 (last2 temp___10761)))) (= o13 0)))
(assert (= o14 (+ 1 o13)))
(assert (= o15 (+ 1 o14)))
(assert (= o16 (- o15 1)))
