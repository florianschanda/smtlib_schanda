...
(assert (<= 1 i4))
(assert (<= i4 100))
(assert (and (= temp___1687 (model__ f_old root)) (and (dynamic_invariant5 temp___1687 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1687 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1687 root)))) 0) (and (forall ((i21 Int)) (=> (and (<= 1 i21) (<= i21 100)) (=> (not (= i21 root)) (ite (and (not (= (parent f_old i21) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1687 (parent f_old i21)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1687 i21))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1687 i21))) true)))))) (and (forall ((i21 Int)) (=> (and (<= 1 i21) (<= i21 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1687 i21))) true) (not (= i21 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1687 (parent f_old i21)))) (position f_old i21) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1687 i21)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1687 i21)))) 0)))) (forall ((i21 Int)) (=> (and (<= 1 i21) (<= i21 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1687 i21))) true) (forall ((j26 Int)) (=> (and (<= 1 j26) (<= j26 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1687 j26))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1687 i21))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1687 j26)))) true)) (= j26 i21))))))))))))))
(assert (= o31 (select temp___1687 i4)))
(assert (= o32 (us_split_fields1 o31)))
(assert (= result14 (rec__tree_model__path_type__k o32)))
