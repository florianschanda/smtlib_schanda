...
(define-fun in_range4 ((x Int)) Bool (and (<= (- 1) x) (<= x 49)))
...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (and (and (= (to_rep1 (rec__tetris_functional__piece__s (us_split_fields1 a))) (to_rep1 (rec__tetris_functional__piece__s (us_split_fields1 b)))) (= (to_rep4 (rec__tetris_functional__piece__d (us_split_fields1 a))) (to_rep4 (rec__tetris_functional__piece__d (us_split_fields1 b))))) (= (to_rep2 (rec__tetris_functional__piece__x (us_split_fields1 a))) (to_rep2 (rec__tetris_functional__piece__x (us_split_fields1 b))))) (= (to_rep3 (rec__tetris_functional__piece__y (us_split_fields1 a))) (to_rep3 (rec__tetris_functional__piece__y (us_split_fields1 b))))) true false))
...
(declare-fun valid_configuration ((Array Int (Array Int cell)) us_split_fields Int) Bool)
(declare-fun valid_configuration__function_guard (Bool (Array Int (Array Int cell)) us_split_fields Int) Bool)
...
(define-fun dynamic_invariant ((temp___expr_627 Int) (temp___is_init_623 Bool) (temp___skip_constant_624 Bool) (temp___do_toplevel_625 Bool) (temp___do_typ_inv_626 Bool)) Bool (=> (or (= temp___is_init_623 true) (<= 0 3)) (in_range6 temp___expr_627)))
(assert true)
(assert (forall ((tetris_functional__cur_board (Array Int (Array Int cell)))) (forall ((tetris_functional__cur_piece__fields us_split_fields)) (forall ((tetris_functional__cur_state Int)) (! (= (= (valid_configuration tetris_functional__cur_board tetris_functional__cur_piece__fields tetris_functional__cur_state) true) (ite (or (= tetris_functional__cur_state 0) (= tetris_functional__cur_state 1)) (= (no_overlap tetris_functional__cur_board (mk___rep tetris_functional__cur_piece__fields)) true) (=> (not (= tetris_functional__cur_state 2)) (= (no_complete_lines tetris_functional__cur_board) true)))) :pattern ((valid_configuration tetris_functional__cur_board tetris_functional__cur_piece__fields tetris_functional__cur_state)))))))
(declare-sort three_shape 0)
(define-fun in_range7 ((x Int)) Bool (and (<= 3 x) (<= x 7)))
(declare-fun attr__ATTRIBUTE_IMAGE7 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check7 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE7 (us_image) Int)
(declare-fun user_eq8 (three_shape three_shape) Bool)
(declare-const dummy8 three_shape)
...
(declare-fun user_eq9 (x_coord x_coord) Bool)
(declare-const dummy9 x_coord)
...
(declare-fun tetris_functional__possible_i_shapes__aggregate_def (map1 map1 map1 map1) (Array Int map1))
...
(declare-fun tetris_functional__possible_three_shapes__aggregate_def (map1 map1 map1 map1 map1 map1 map1 map1 map1 map1 map1 map1 map1 map1 map1 map1 map1 map1 map1 map1) map2)
...
(define-fun dynamic_invariant1 ((temp___expr_18 Int) (temp___is_init_14 Bool) (temp___skip_constant_15 Bool) (temp___do_toplevel_16 Bool) (temp___do_typ_inv_17 Bool)) Bool (=> (or (= temp___is_init_14 true) (<= (- 2147483648) 2147483647)) (in_range10 temp___expr_18)))
(define-fun dynamic_invariant2 ((temp___expr_537 Int) (temp___is_init_533 Bool) (temp___skip_constant_534 Bool) (temp___do_toplevel_535 Bool) (temp___do_typ_inv_536 Bool)) Bool (=> (or (= temp___is_init_533 true) (<= 0 7)) (in_range1 temp___expr_537)))
(define-fun dynamic_invariant3 ((temp___expr_544 Int) (temp___is_init_540 Bool) (temp___skip_constant_541 Bool) (temp___do_toplevel_542 Bool) (temp___do_typ_inv_543 Bool)) Bool (=> (or (= temp___is_init_540 true) (<= 1 7)) (in_range2 temp___expr_544)))
(define-fun dynamic_invariant4 ((temp___expr_551 Int) (temp___is_init_547 Bool) (temp___skip_constant_548 Bool) (temp___do_toplevel_549 Bool) (temp___do_typ_inv_550 Bool)) Bool (=> (or (= temp___is_init_547 true) (<= 3 7)) (in_range7 temp___expr_551)))
(define-fun dynamic_invariant5 ((temp___expr_558 Int) (temp___is_init_554 Bool) (temp___skip_constant_555 Bool) (temp___do_toplevel_556 Bool) (temp___do_typ_inv_557 Bool)) Bool (=> (or (= temp___is_init_554 true) (<= 1 10)) (in_range8 temp___expr_558)))
(define-fun dynamic_invariant6 ((temp___expr_565 Int) (temp___is_init_561 Bool) (temp___skip_constant_562 Bool) (temp___do_toplevel_563 Bool) (temp___do_typ_inv_564 Bool)) Bool (=> (or (= temp___is_init_561 true) (<= 1 50)) (in_range9 temp___expr_565)))
(define-fun dynamic_invariant7 ((temp___expr_595 Int) (temp___is_init_591 Bool) (temp___skip_constant_592 Bool) (temp___do_toplevel_593 Bool) (temp___do_typ_inv_594 Bool)) Bool (=> (or (= temp___is_init_591 true) (<= (- 1) 9)) (in_range3 temp___expr_595)))
(define-fun dynamic_invariant8 ((temp___expr_602 Int) (temp___is_init_598 Bool) (temp___skip_constant_599 Bool) (temp___do_toplevel_600 Bool) (temp___do_typ_inv_601 Bool)) Bool (=> (or (= temp___is_init_598 true) (<= (- 1) 49)) (in_range4 temp___expr_602)))
(define-fun dynamic_invariant9 ((temp___expr_609 Int) (temp___is_init_605 Bool) (temp___skip_constant_606 Bool) (temp___do_toplevel_607 Bool) (temp___do_typ_inv_608 Bool)) Bool (=> (or (= temp___is_init_605 true) (<= 0 3)) (in_range5 temp___expr_609)))
(assert (= possible_i_shapes (tetris_functional__possible_i_shapes__aggregate_def (temp_____aggregate_def_165 (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 1 0) (distinct 1 0) (distinct 1 0) (distinct 1 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 0 0)) (temp_____aggregate_def_185 (distinct 0 0) (distinct 0 0) (distinct 1 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 1 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 1 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 1 0) (distinct 0 0)) (temp_____aggregate_def_205 (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 1 0) (distinct 1 0) (distinct 1 0) (distinct 1 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 0 0)) (temp_____aggregate_def_225 (distinct 0 0) (distinct 1 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 1 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 1 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 1 0) (distinct 0 0) (distinct 0 0)))))
...
(assert (forall ((temp___160 map1) (temp___161 map1) (temp___162 map1) (temp___163 map1)) (let ((temp___159 (tetris_functional__possible_i_shapes__aggregate_def temp___160 temp___161 temp___162 temp___163))) (and (and (and (= (select temp___159 0) temp___160) (= (select temp___159 1) temp___161)) (= (select temp___159 2) temp___162)) (= (select temp___159 3) temp___163)))))
...
(assert true)
(assert (forall ((b (Array Int (Array Int cell)))) (forall ((y Int) (x Int)) (! (= (= (is_empty b y x) true) (and (and (in_range8 x) (in_range9 y)) (= (to_rep (let ((temp___673 (select b y))) (select temp___673 x))) 0))) :pattern ((is_empty b y x))))))
...
(assert true)
(assert (forall ((b (Array Int (Array Int cell)))) (! (= (= (no_complete_lines b) true) (forall ((y Int)) (=> (and (<= 1 y) (<= y 50)) (not (= (is_complete_line (select b y)) true))))) :pattern ((no_complete_lines b)))))
(assert true)
(assert (forall ((b (Array Int (Array Int cell)))) (forall ((p us_rep)) (! (= (= (no_overlap b p) true) (ite (= (to_rep1 (rec__tetris_functional__piece__s (us_split_fields1 p))) 2) (and (and (and (= (is_empty b (to_rep3 (rec__tetris_functional__piece__y (us_split_fields1 p))) (to_rep2 (rec__tetris_functional__piece__x (us_split_fields1 p)))) true) (= (is_empty b (to_rep3 (rec__tetris_functional__piece__y (us_split_fields1 p))) (+ (to_rep2 (rec__tetris_functional__piece__x (us_split_fields1 p))) 1)) true)) (= (is_empty b (+ (to_rep3 (rec__tetris_functional__piece__y (us_split_fields1 p))) 1) (to_rep2 (rec__tetris_functional__piece__x (us_split_fields1 p)))) true)) (= (is_empty b (+ (to_rep3 (rec__tetris_functional__piece__y (us_split_fields1 p))) 1) (+ (to_rep2 (rec__tetris_functional__piece__x (us_split_fields1 p))) 1)) true)) (ite (= (to_rep1 (rec__tetris_functional__piece__s (us_split_fields1 p))) 1) (forall ((y Int)) (=> (and (<= 0 y) (<= y 3)) (forall ((x Int)) (=> (and (<= 0 x) (<= x 3)) (=> (= (let ((temp___688 (select possible_i_shapes (to_rep4 (rec__tetris_functional__piece__d (us_split_fields1 p)))))) (get temp___688 y x)) true) (= (is_empty b (+ (to_rep3 (rec__tetris_functional__piece__y (us_split_fields1 p))) y) (+ (to_rep2 (rec__tetris_functional__piece__x (us_split_fields1 p))) x)) true)))))) (forall ((y Int)) (=> (and (<= 0 y) (<= y 2)) (forall ((x Int)) (=> (and (<= 0 x) (<= x 2)) (=> (= (let ((temp___689 (get1 possible_three_shapes (to_rep1 (rec__tetris_functional__piece__s (us_split_fields1 p))) (to_rep4 (rec__tetris_functional__piece__d (us_split_fields1 p)))))) (get temp___689 y x)) true) (= (is_empty b (+ (to_rep3 (rec__tetris_functional__piece__y (us_split_fields1 p))) y) (+ (to_rep2 (rec__tetris_functional__piece__x (us_split_fields1 p))) x)) true))))))))) :pattern ((no_overlap b p))))))
...
(declare-const o14 (Array Int (Array Int cell)))
(declare-const o15 cell)
(declare-const o16 Int)
(declare-const o17 (Array Int cell))
(declare-const o18 Int)
(declare-const o19 (Array Int (Array Int cell)))
(declare-const temp___782 (Array Int (Array Int cell)))
(declare-const temp___779 (Array Int (Array Int cell)))
(declare-const o20 cell)
(declare-const o21 Int)
(declare-const o22 (Array Int cell))
(declare-const o23 Int)
(declare-const o24 (Array Int (Array Int cell)))
(declare-const temp___797 (Array Int (Array Int cell)))
(declare-const temp___794 (Array Int (Array Int cell)))
(declare-const o25 Int)
(declare-const temp___790 map1)
(declare-const o26 cell)
(declare-const o27 Int)
(declare-const o28 (Array Int cell))
(declare-const o29 Int)
(declare-const o30 (Array Int (Array Int cell)))
...
(declare-const result2 (Array Int (Array Int cell)))
(declare-const cur_board4 (Array Int (Array Int cell)))
(declare-const result3 (Array Int (Array Int cell)))
...
(declare-const result6 (Array Int (Array Int cell)))
...
(declare-const cur_board11 (Array Int (Array Int cell)))
...
(declare-const cur_board15 map__ref1)
(declare-const y8 int__ref)
(declare-const x13 int__ref)
(declare-const cur_board16 (Array Int (Array Int cell)))
(declare-const y9 Int)
(declare-const x14 Int)
(declare-const result7 int__ref)
(declare-const y10 Int)
(declare-const cur_board17 (Array Int (Array Int cell)))
(declare-const y11 Int)
(declare-const x15 Int)
(declare-const result8 int__ref)
(declare-const x16 Int)
(declare-const cur_board18 (Array Int (Array Int cell)))
(declare-const x17 Int)
(declare-const result9 Bool)
(declare-const result10 map__ref1)
(declare-const cur_board19 (Array Int (Array Int cell)))
(declare-const cur_board20 map__ref1)
(declare-const x18 int__ref)
(declare-const cur_board21 (Array Int (Array Int cell)))
(declare-const x19 Int)
(declare-const cur_board22 map__ref1)
(declare-const x20 int__ref)
(declare-const cur_board23 (Array Int (Array Int cell)))
(declare-const x21 Int)
(declare-const cur_board24 map__ref1)
(declare-const y12 int__ref)
(declare-const x22 int__ref)
(declare-const cur_board25 (Array Int (Array Int cell)))
(declare-const y13 Int)
(declare-const x23 Int)
(declare-const cur_board26 map__ref1)
(declare-const y14 int__ref)
(declare-const x24 int__ref)
(declare-const cur_board27 (Array Int (Array Int cell)))
(declare-const y15 Int)
(declare-const x25 Int)
(declare-const cur_board28 map__ref1)
(declare-const y16 int__ref)
(declare-const x26 int__ref)
(declare-const y17 int__ref)
(declare-const x27 int__ref)
(declare-const cur_board29 (Array Int (Array Int cell)))
(declare-const y18 Int)
(declare-const x28 Int)
(declare-const y19 Int)
(declare-const x29 Int)
(declare-const cur_board30 map__ref1)
(declare-const y20 int__ref)
(declare-const x30 int__ref)
(declare-const y21 int__ref)
(declare-const x31 int__ref)
(declare-const cur_board31 (Array Int (Array Int cell)))
...
(declare-const cur_board32 map__ref1)
(declare-const cur_state2 int__ref)
(declare-const y24 int__ref)
(declare-const x34 int__ref)
(declare-const y25 int__ref)
(declare-const x35 int__ref)
(declare-const cur_board33 (Array Int (Array Int cell)))
(declare-const cur_state3 Int)
(declare-const y26 Int)
(declare-const x36 Int)
(declare-const y27 Int)
(declare-const x37 Int)
(define-fun x38 () int__ref (mk_int__ref x9))
(define-fun cur_board34 () map__ref1 (mk_map__ref1 cur_board11))
(define-fun x39 () int__ref (mk_int__ref x1))
(define-fun y28 () int__ref (mk_int__ref y1))
(define-fun x40 () int__ref (mk_int__ref x))
(define-fun y29 () int__ref (mk_int__ref y))
(define-fun cur_board35 () map__ref1 (mk_map__ref1 cur_board))
(assert (= (tetris_functional__possible_i_shapes__aggregate_def (temp_____aggregate_def_165 (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 1 0) (distinct 1 0) (distinct 1 0) (distinct 1 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 0 0)) (temp_____aggregate_def_185 (distinct 0 0) (distinct 0 0) (distinct 1 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 1 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 1 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 1 0) (distinct 0 0)) (temp_____aggregate_def_205 (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 1 0) (distinct 1 0) (distinct 1 0) (distinct 1 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 0 0)) (temp_____aggregate_def_225 (distinct 0 0) (distinct 1 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 1 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 1 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 1 0) (distinct 0 0) (distinct 0 0))) possible_i_shapes))
(assert (= (tetris_functional__possible_three_shapes__aggregate_def (temp_____aggregate_def_270 (distinct 1 0) (distinct 0 0) (distinct 0 0) (distinct 1 0) (distinct 1 0) (distinct 1 0) (distinct 0 0) (distinct 0 0) (distinct 0 0)) (temp_____aggregate_def_283 (distinct 0 0) (distinct 1 0) (distinct 1 0) (distinct 0 0) (distinct 1 0) (distinct 0 0) (distinct 0 0) (distinct 1 0) (distinct 0 0)) (temp_____aggregate_def_296 (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 1 0) (distinct 1 0) (distinct 1 0) (distinct 0 0) (distinct 0 0) (distinct 1 0)) (temp_____aggregate_def_309 (distinct 0 0) (distinct 1 0) (distinct 0 0) (distinct 0 0) (distinct 1 0) (distinct 0 0) (distinct 1 0) (distinct 1 0) (distinct 0 0)) (temp_____aggregate_def_322 (distinct 0 0) (distinct 0 0) (distinct 1 0) (distinct 1 0) (distinct 1 0) (distinct 1 0) (distinct 0 0) (distinct 0 0) (distinct 0 0)) (temp_____aggregate_def_335 (distinct 0 0) (distinct 1 0) (distinct 0 0) (distinct 0 0) (distinct 1 0) (distinct 0 0) (distinct 0 0) (distinct 1 0) (distinct 1 0)) (temp_____aggregate_def_348 (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 1 0) (distinct 1 0) (distinct 1 0) (distinct 1 0) (distinct 0 0) (distinct 0 0)) (temp_____aggregate_def_361 (distinct 1 0) (distinct 1 0) (distinct 0 0) (distinct 0 0) (distinct 1 0) (distinct 0 0) (distinct 0 0) (distinct 1 0) (distinct 0 0)) (temp_____aggregate_def_374 (distinct 0 0) (distinct 1 0) (distinct 1 0) (distinct 1 0) (distinct 1 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 0 0)) (temp_____aggregate_def_387 (distinct 0 0) (distinct 1 0) (distinct 0 0) (distinct 0 0) (distinct 1 0) (distinct 1 0) (distinct 0 0) (distinct 0 0) (distinct 1 0)) (temp_____aggregate_def_400 (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 1 0) (distinct 1 0) (distinct 1 0) (distinct 1 0) (distinct 0 0)) (temp_____aggregate_def_413 (distinct 1 0) (distinct 0 0) (distinct 0 0) (distinct 1 0) (distinct 1 0) (distinct 0 0) (distinct 0 0) (distinct 1 0) (distinct 0 0)) (temp_____aggregate_def_426 (distinct 0 0) (distinct 1 0) (distinct 0 0) (distinct 1 0) (distinct 1 0) (distinct 1 0) (distinct 0 0) (distinct 0 0) (distinct 0 0)) (temp_____aggregate_def_439 (distinct 0 0) (distinct 1 0) (distinct 0 0) (distinct 0 0) (distinct 1 0) (distinct 1 0) (distinct 0 0) (distinct 1 0) (distinct 0 0)) (temp_____aggregate_def_452 (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 1 0) (distinct 1 0) (distinct 1 0) (distinct 0 0) (distinct 1 0) (distinct 0 0)) (temp_____aggregate_def_465 (distinct 0 0) (distinct 1 0) (distinct 0 0) (distinct 1 0) (distinct 1 0) (distinct 0 0) (distinct 0 0) (distinct 1 0) (distinct 0 0)) (temp_____aggregate_def_478 (distinct 1 0) (distinct 1 0) (distinct 0 0) (distinct 0 0) (distinct 1 0) (distinct 1 0) (distinct 0 0) (distinct 0 0) (distinct 0 0)) (temp_____aggregate_def_491 (distinct 0 0) (distinct 0 0) (distinct 1 0) (distinct 0 0) (distinct 1 0) (distinct 1 0) (distinct 0 0) (distinct 1 0) (distinct 0 0)) (temp_____aggregate_def_504 (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 1 0) (distinct 1 0) (distinct 0 0) (distinct 0 0) (distinct 1 0) (distinct 1 0)) (temp_____aggregate_def_517 (distinct 0 0) (distinct 1 0) (distinct 0 0) (distinct 1 0) (distinct 1 0) (distinct 0 0) (distinct 1 0) (distinct 0 0) (distinct 0 0))) possible_three_shapes))
(assert (in_range6 cur_state))
(assert (and (= cur_state 1) (= (valid_configuration cur_board (mk___split_fields cur_piece__split_fields cur_piece__split_fields1 cur_piece__split_fields2 cur_piece__split_fields3) cur_state) true)))
(assert (=> (= (to_rep1 cur_piece__split_fields) 2) (= (to_rep o) (to_rep1 cur_piece__split_fields))))
(assert (=> (= (to_rep1 cur_piece__split_fields) 2) (and (<= 1 (to_rep2 cur_piece__split_fields2)) (<= (to_rep2 cur_piece__split_fields2) 10))))
(assert (=> (= (to_rep1 cur_piece__split_fields) 2) (= o1 (to_rep2 cur_piece__split_fields2))))
(assert (=> (= (to_rep1 cur_piece__split_fields) 2) (= o2 (store (select cur_board (to_rep3 cur_piece__split_fields3)) o1 o))))
(assert (=> (= (to_rep1 cur_piece__split_fields) 2) (and (<= 1 (to_rep3 cur_piece__split_fields3)) (<= (to_rep3 cur_piece__split_fields3) 50))))
(assert (=> (= (to_rep1 cur_piece__split_fields) 2) (= o3 (to_rep3 cur_piece__split_fields3))))
(assert (=> (= (to_rep1 cur_piece__split_fields) 2) (= o4 (store cur_board o3 o2))))
(assert (=> (= (to_rep1 cur_piece__split_fields) 2) (= (mk_map__ref1 result) cur_board35)))
(assert (=> (= (to_rep1 cur_piece__split_fields) 2) (= cur_board2 o4)))
(assert (=> (= (to_rep1 cur_piece__split_fields) 2) (= (to_rep o5) (to_rep1 cur_piece__split_fields))))
(assert (=> (= (to_rep1 cur_piece__split_fields) 2) (and (<= 1 (to_rep2 cur_piece__split_fields2)) (<= (to_rep2 cur_piece__split_fields2) 10))))
(assert (=> (= (to_rep1 cur_piece__split_fields) 2) (= o6 (to_rep2 cur_piece__split_fields2))))
(assert (=> (= (to_rep1 cur_piece__split_fields) 2) (= o7 (store (select cur_board2 (+ (to_rep3 cur_piece__split_fields3) 1)) o6 o5))))
(assert (=> (= (to_rep1 cur_piece__split_fields) 2) (and (<= 1 (+ (to_rep3 cur_piece__split_fields3) 1)) (<= (+ (to_rep3 cur_piece__split_fields3) 1) 50))))
(assert (=> (= (to_rep1 cur_piece__split_fields) 2) (= o8 (+ (to_rep3 cur_piece__split_fields3) 1))))
(assert (=> (= (to_rep1 cur_piece__split_fields) 2) (= o9 (store cur_board2 o8 o7))))
(assert (=> (= (to_rep1 cur_piece__split_fields) 2) (= cur_board2 result1)))
(assert (=> (= (to_rep1 cur_piece__split_fields) 2) (= cur_board3 o9)))
(assert (=> (= (to_rep1 cur_piece__split_fields) 2) (= (to_rep o10) (to_rep1 cur_piece__split_fields))))
(assert (=> (= (to_rep1 cur_piece__split_fields) 2) (and (<= 1 (+ (to_rep2 cur_piece__split_fields2) 1)) (<= (+ (to_rep2 cur_piece__split_fields2) 1) 10))))
(assert (=> (= (to_rep1 cur_piece__split_fields) 2) (= o11 (+ (to_rep2 cur_piece__split_fields2) 1))))
(assert (=> (= (to_rep1 cur_piece__split_fields) 2) (= o12 (store (select cur_board3 (to_rep3 cur_piece__split_fields3)) o11 o10))))
(assert (=> (= (to_rep1 cur_piece__split_fields) 2) (and (<= 1 (to_rep3 cur_piece__split_fields3)) (<= (to_rep3 cur_piece__split_fields3) 50))))
(assert (=> (= (to_rep1 cur_piece__split_fields) 2) (= o13 (to_rep3 cur_piece__split_fields3))))
(assert (=> (= (to_rep1 cur_piece__split_fields) 2) (= o14 (store cur_board3 o13 o12))))
(assert (=> (= (to_rep1 cur_piece__split_fields) 2) (= cur_board3 result2)))
(assert (=> (= (to_rep1 cur_piece__split_fields) 2) (= cur_board4 o14)))
(assert (=> (= (to_rep1 cur_piece__split_fields) 2) (= (to_rep o15) (to_rep1 cur_piece__split_fields))))
(assert (=> (= (to_rep1 cur_piece__split_fields) 2) (and (<= 1 (+ (to_rep2 cur_piece__split_fields2) 1)) (<= (+ (to_rep2 cur_piece__split_fields2) 1) 10))))
(assert (=> (= (to_rep1 cur_piece__split_fields) 2) (= o16 (+ (to_rep2 cur_piece__split_fields2) 1))))
(assert (=> (= (to_rep1 cur_piece__split_fields) 2) (= o17 (store (select cur_board4 (+ (to_rep3 cur_piece__split_fields3) 1)) o16 o15))))
(assert (=> (= (to_rep1 cur_piece__split_fields) 2) (and (<= 1 (+ (to_rep3 cur_piece__split_fields3) 1)) (<= (+ (to_rep3 cur_piece__split_fields3) 1) 50))))
(assert (=> (= (to_rep1 cur_piece__split_fields) 2) (= o18 (+ (to_rep3 cur_piece__split_fields3) 1))))
(assert (=> (= (to_rep1 cur_piece__split_fields) 2) (= o19 (store cur_board4 o18 o17))))
(assert (=> (= (to_rep1 cur_piece__split_fields) 2) (= result3 cur_board4)))
(assert (=> (= (to_rep1 cur_piece__split_fields) 2) (= cur_board5 o19)))
(assert (=> (= (to_rep1 cur_piece__split_fields) 2) (= x31 x39)))
(assert (=> (= (to_rep1 cur_piece__split_fields) 2) (= y21 y28)))
(assert (=> (= (to_rep1 cur_piece__split_fields) 2) (= x30 x40)))
(assert (=> (= (to_rep1 cur_piece__split_fields) 2) (= y20 y29)))
(assert (=> (= (to_rep1 cur_piece__split_fields) 2) (= cur_board30 (mk_map__ref1 cur_board5))))
(assert (=> (= (to_rep1 cur_piece__split_fields) 2) (= x33 x3)))
(assert (=> (= (to_rep1 cur_piece__split_fields) 2) (= y23 y3)))
(assert (=> (= (to_rep1 cur_piece__split_fields) 2) (= x32 x2)))
(assert (=> (= (to_rep1 cur_piece__split_fields) 2) (= y22 y2)))
(assert (=> (= (to_rep1 cur_piece__split_fields) 2) (= cur_board31 cur_board5)))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (= (mk_int__ref result4) y29))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (= y4 0))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (=> (and (<= 0 y4) (<= y4 3)) (= temp___782 cur_board)))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (=> (and (<= 0 y4) (<= y4 3)) (and (<= 0 y5) (<= y5 3))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (=> (and (<= 0 y4) (<= y4 3)) (= x4 result5)))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (=> (and (<= 0 y4) (<= y4 3)) (= x5 0)))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (=> (and (<= 0 y4) (<= y4 3)) (=> (and (<= 0 x5) (<= x5 3)) (= temp___779 cur_board6))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (=> (and (<= 0 y4) (<= y4 3)) (=> (and (<= 0 x5) (<= x5 3)) (and (forall ((temp___780 Int)) (=> (and (<= 1 temp___780) (<= temp___780 50)) (=> (not (= (+ (to_rep3 cur_piece__split_fields3) y5) temp___780)) (= (select cur_board7 temp___780) (select temp___779 temp___780))))) (and (<= 0 x6) (<= x6 3))))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (=> (and (<= 0 y4) (<= y4 3)) (=> (and (<= 0 x5) (<= x5 3)) (=> (= (get (select possible_i_shapes (to_rep4 cur_piece__split_fields1)) y5 x6) true) (= (to_rep o20) (to_rep1 cur_piece__split_fields))))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (=> (and (<= 0 y4) (<= y4 3)) (=> (and (<= 0 x5) (<= x5 3)) (=> (= (get (select possible_i_shapes (to_rep4 cur_piece__split_fields1)) y5 x6) true) (and (<= 1 (+ (to_rep2 cur_piece__split_fields2) x6)) (<= (+ (to_rep2 cur_piece__split_fields2) x6) 10))))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (=> (and (<= 0 y4) (<= y4 3)) (=> (and (<= 0 x5) (<= x5 3)) (=> (= (get (select possible_i_shapes (to_rep4 cur_piece__split_fields1)) y5 x6) true) (= o21 (+ (to_rep2 cur_piece__split_fields2) x6))))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (=> (and (<= 0 y4) (<= y4 3)) (=> (and (<= 0 x5) (<= x5 3)) (=> (= (get (select possible_i_shapes (to_rep4 cur_piece__split_fields1)) y5 x6) true) (= o22 (store (select cur_board7 (+ (to_rep3 cur_piece__split_fields3) y5)) o21 o20))))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (=> (and (<= 0 y4) (<= y4 3)) (=> (and (<= 0 x5) (<= x5 3)) (=> (= (get (select possible_i_shapes (to_rep4 cur_piece__split_fields1)) y5 x6) true) (and (<= 1 (+ (to_rep3 cur_piece__split_fields3) y5)) (<= (+ (to_rep3 cur_piece__split_fields3) y5) 50))))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (=> (and (<= 0 y4) (<= y4 3)) (=> (and (<= 0 x5) (<= x5 3)) (=> (= (get (select possible_i_shapes (to_rep4 cur_piece__split_fields1)) y5 x6) true) (= o23 (+ (to_rep3 cur_piece__split_fields3) y5))))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (=> (and (<= 0 y4) (<= y4 3)) (=> (and (<= 0 x5) (<= x5 3)) (=> (= (get (select possible_i_shapes (to_rep4 cur_piece__split_fields1)) y5 x6) true) (= o24 (store cur_board7 o23 o22))))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (=> (and (<= 0 y4) (<= y4 3)) (=> (and (<= 0 x5) (<= x5 3)) (=> (= (get (select possible_i_shapes (to_rep4 cur_piece__split_fields1)) y5 x6) true) (= result6 cur_board7)))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (=> (and (<= 0 y4) (<= y4 3)) (=> (and (<= 0 x5) (<= x5 3)) (=> (= (get (select possible_i_shapes (to_rep4 cur_piece__split_fields1)) y5 x6) true) (= cur_board8 o24)))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (=> (and (<= 0 y4) (<= y4 3)) (=> (and (<= 0 x5) (<= x5 3)) (=> (not (= (get (select possible_i_shapes (to_rep4 cur_piece__split_fields1)) y5 x6) true)) (= cur_board8 cur_board7)))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (=> (and (<= 0 y4) (<= y4 3)) (=> (and (<= 0 x5) (<= x5 3)) (= x6 3))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (=> (and (<= 0 y4) (<= y4 3)) (=> (and (<= 0 x5) (<= x5 3)) (= x6 x7))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (=> (and (<= 0 y4) (<= y4 3)) (=> (and (<= 0 x5) (<= x5 3)) (= cur_board8 cur_board9))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (=> (and (<= 0 y4) (<= y4 3)) (=> (and (<= 0 x5) (<= x5 3)) (= x8 x6))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (=> (and (<= 0 y4) (<= y4 3)) (=> (and (<= 0 x5) (<= x5 3)) (= cur_board10 cur_board8))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (=> (and (<= 0 y4) (<= y4 3)) (=> (and (<= 0 x5) (<= x5 3)) (= x38 (mk_int__ref x7)))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (=> (and (<= 0 y4) (<= y4 3)) (=> (and (<= 0 x5) (<= x5 3)) (= cur_board34 (mk_map__ref1 cur_board9)))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (=> (and (<= 0 y4) (<= y4 3)) (=> (and (<= 0 x5) (<= x5 3)) (= x10 x8))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (=> (and (<= 0 y4) (<= y4 3)) (=> (and (<= 0 x5) (<= x5 3)) (= cur_board12 cur_board10))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (=> (and (<= 0 y4) (<= y4 3)) (=> (not (and (<= 0 x5) (<= x5 3))) (= x5 x9))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (=> (and (<= 0 y4) (<= y4 3)) (=> (not (and (<= 0 x5) (<= x5 3))) (= cur_board6 cur_board11))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (=> (and (<= 0 y4) (<= y4 3)) (=> (not (and (<= 0 x5) (<= x5 3))) (= x10 x5))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (=> (and (<= 0 y4) (<= y4 3)) (=> (not (and (<= 0 x5) (<= x5 3))) (= cur_board12 cur_board6))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (=> (and (<= 0 y4) (<= y4 3)) (= y5 3)))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (=> (and (<= 0 y4) (<= y4 3)) (= x11 x38)))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (=> (and (<= 0 y4) (<= y4 3)) (= y6 (mk_int__ref y5))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (=> (and (<= 0 y4) (<= y4 3)) (= cur_board13 cur_board34)))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (=> (and (<= 0 y4) (<= y4 3)) (= x12 x10)))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (=> (and (<= 0 y4) (<= y4 3)) (= y7 y5)))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (=> (and (<= 0 y4) (<= y4 3)) (= cur_board14 cur_board12)))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (=> (and (<= 0 y4) (<= y4 3)) (= x13 x11)))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (=> (and (<= 0 y4) (<= y4 3)) (= y8 y6)))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (=> (and (<= 0 y4) (<= y4 3)) (= cur_board15 cur_board13)))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (=> (and (<= 0 y4) (<= y4 3)) (= x14 x12)))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (=> (and (<= 0 y4) (<= y4 3)) (= y9 y7)))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (=> (and (<= 0 y4) (<= y4 3)) (= cur_board16 cur_board14)))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (=> (not (and (<= 0 y4) (<= y4 3))) (= x13 x40)))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (=> (not (and (<= 0 y4) (<= y4 3))) (= y8 (mk_int__ref y4))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (=> (not (and (<= 0 y4) (<= y4 3))) (= cur_board15 cur_board35)))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (=> (not (and (<= 0 y4) (<= y4 3))) (= x14 x2)))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (=> (not (and (<= 0 y4) (<= y4 3))) (= y9 y4)))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (=> (not (and (<= 0 y4) (<= y4 3))) (= cur_board16 cur_board1)))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (= x27 x39))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (= y17 y28))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (= x26 x13))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (= y16 y8))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (= cur_board28 cur_board15))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (= x29 x3))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (= y19 y3))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (= x28 x14))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (= y18 y9))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (= (to_rep1 cur_piece__split_fields) 1) (= cur_board29 cur_board16))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (= result7 y28))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (= y10 0))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (and (<= 0 y10) (<= y10 2)) (= temp___797 cur_board)))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (and (<= 0 y10) (<= y10 2)) (and (<= 0 y11) (<= y11 2))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (and (<= 0 y10) (<= y10 2)) (= result8 (mk_int__ref x15))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (and (<= 0 y10) (<= y10 2)) (= x16 0)))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (and (<= 0 y10) (<= y10 2)) (=> (and (<= 0 x16) (<= x16 2)) (= temp___794 cur_board17))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (and (<= 0 y10) (<= y10 2)) (=> (and (<= 0 x16) (<= x16 2)) (and (forall ((temp___795 Int)) (=> (and (<= 1 temp___795) (<= temp___795 50)) (=> (not (= (+ (to_rep3 cur_piece__split_fields3) y11) temp___795)) (= (select cur_board18 temp___795) (select temp___794 temp___795))))) (and (<= 0 x17) (<= x17 2))))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (and (<= 0 y10) (<= y10 2)) (=> (and (<= 0 x16) (<= x16 2)) (and (<= 3 (to_rep1 cur_piece__split_fields)) (<= (to_rep1 cur_piece__split_fields) 7)))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (and (<= 0 y10) (<= y10 2)) (=> (and (<= 0 x16) (<= x16 2)) (= o25 (to_rep1 cur_piece__split_fields)))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (and (<= 0 y10) (<= y10 2)) (=> (and (<= 0 x16) (<= x16 2)) (= temp___790 (get1 possible_three_shapes o25 (to_rep4 cur_piece__split_fields1))))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (and (<= 0 y10) (<= y10 2)) (=> (and (<= 0 x16) (<= x16 2)) (= result9 (get temp___790 y11 x17)))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (and (<= 0 y10) (<= y10 2)) (=> (and (<= 0 x16) (<= x16 2)) (=> (= result9 true) (= (to_rep o26) (to_rep1 cur_piece__split_fields))))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (and (<= 0 y10) (<= y10 2)) (=> (and (<= 0 x16) (<= x16 2)) (=> (= result9 true) (and (<= 1 (+ (to_rep2 cur_piece__split_fields2) x17)) (<= (+ (to_rep2 cur_piece__split_fields2) x17) 10))))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (and (<= 0 y10) (<= y10 2)) (=> (and (<= 0 x16) (<= x16 2)) (=> (= result9 true) (= o27 (+ (to_rep2 cur_piece__split_fields2) x17))))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (and (<= 0 y10) (<= y10 2)) (=> (and (<= 0 x16) (<= x16 2)) (=> (= result9 true) (= o28 (store (select cur_board18 (+ (to_rep3 cur_piece__split_fields3) y11)) o27 o26))))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (and (<= 0 y10) (<= y10 2)) (=> (and (<= 0 x16) (<= x16 2)) (=> (= result9 true) (and (<= 1 (+ (to_rep3 cur_piece__split_fields3) y11)) (<= (+ (to_rep3 cur_piece__split_fields3) y11) 50))))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (and (<= 0 y10) (<= y10 2)) (=> (and (<= 0 x16) (<= x16 2)) (=> (= result9 true) (= o29 (+ (to_rep3 cur_piece__split_fields3) y11))))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (and (<= 0 y10) (<= y10 2)) (=> (and (<= 0 x16) (<= x16 2)) (=> (= result9 true) (= o30 (store cur_board18 o29 o28))))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (and (<= 0 y10) (<= y10 2)) (=> (and (<= 0 x16) (<= x16 2)) (=> (= result9 true) (= result10 (mk_map__ref1 cur_board18))))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (and (<= 0 y10) (<= y10 2)) (=> (and (<= 0 x16) (<= x16 2)) (=> (= result9 true) (= cur_board19 o30)))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (and (<= 0 y10) (<= y10 2)) (=> (and (<= 0 x16) (<= x16 2)) (=> (not (= result9 true)) (= cur_board19 cur_board18)))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (and (<= 0 y10) (<= y10 2)) (=> (and (<= 0 x16) (<= x16 2)) (= x17 2))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (and (<= 0 y10) (<= y10 2)) (=> (and (<= 0 x16) (<= x16 2)) (= x18 (mk_int__ref x17)))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (and (<= 0 y10) (<= y10 2)) (=> (and (<= 0 x16) (<= x16 2)) (= cur_board20 (mk_map__ref1 cur_board19)))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (and (<= 0 y10) (<= y10 2)) (=> (and (<= 0 x16) (<= x16 2)) (= x19 x17))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (and (<= 0 y10) (<= y10 2)) (=> (and (<= 0 x16) (<= x16 2)) (= cur_board21 cur_board19))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (and (<= 0 y10) (<= y10 2)) (=> (and (<= 0 x16) (<= x16 2)) (= x20 x18))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (and (<= 0 y10) (<= y10 2)) (=> (and (<= 0 x16) (<= x16 2)) (= cur_board22 cur_board20))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (and (<= 0 y10) (<= y10 2)) (=> (and (<= 0 x16) (<= x16 2)) (= x21 x19))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (and (<= 0 y10) (<= y10 2)) (=> (and (<= 0 x16) (<= x16 2)) (= cur_board23 cur_board21))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (and (<= 0 y10) (<= y10 2)) (=> (not (and (<= 0 x16) (<= x16 2))) (= x20 (mk_int__ref x16)))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (and (<= 0 y10) (<= y10 2)) (=> (not (and (<= 0 x16) (<= x16 2))) (= cur_board22 (mk_map__ref1 cur_board17)))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (and (<= 0 y10) (<= y10 2)) (=> (not (and (<= 0 x16) (<= x16 2))) (= x21 x16))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (and (<= 0 y10) (<= y10 2)) (=> (not (and (<= 0 x16) (<= x16 2))) (= cur_board23 cur_board17))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (and (<= 0 y10) (<= y10 2)) (= y11 2)))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (and (<= 0 y10) (<= y10 2)) (= x22 x20)))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (and (<= 0 y10) (<= y10 2)) (= y12 (mk_int__ref y11))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (and (<= 0 y10) (<= y10 2)) (= cur_board24 cur_board22)))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (and (<= 0 y10) (<= y10 2)) (= x23 x21)))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (and (<= 0 y10) (<= y10 2)) (= y13 y11)))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (and (<= 0 y10) (<= y10 2)) (= cur_board25 cur_board23)))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (and (<= 0 y10) (<= y10 2)) (= x24 x22)))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (and (<= 0 y10) (<= y10 2)) (= y14 y12)))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (and (<= 0 y10) (<= y10 2)) (= cur_board26 cur_board24)))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (and (<= 0 y10) (<= y10 2)) (= x25 x23)))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (and (<= 0 y10) (<= y10 2)) (= y15 y13)))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (and (<= 0 y10) (<= y10 2)) (= cur_board27 cur_board25)))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (not (and (<= 0 y10) (<= y10 2))) (= x24 x39)))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (not (and (<= 0 y10) (<= y10 2))) (= y14 (mk_int__ref y10))))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (not (and (<= 0 y10) (<= y10 2))) (= cur_board26 cur_board35)))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (not (and (<= 0 y10) (<= y10 2))) (= x25 x3)))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (not (and (<= 0 y10) (<= y10 2))) (= y15 y10)))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (=> (not (and (<= 0 y10) (<= y10 2))) (= cur_board27 cur_board1)))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (= x27 x24))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (= y17 y14))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (= x26 x40))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (= y16 y29))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (= cur_board28 cur_board26))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (= x29 x25))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (= y19 y15))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (= x28 x2))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (= y18 y2))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (= cur_board29 cur_board27))))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (= x31 x27)))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (= y21 y17)))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (= x30 x26)))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (= y20 y16)))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (= cur_board30 cur_board28)))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (= x33 x29)))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (= y23 y19)))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (= x32 x28)))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (= y22 y18)))
(assert (=> (not (= (to_rep1 cur_piece__split_fields) 2)) (= cur_board31 cur_board29)))
(assert (= result11 (mk_int__ref cur_state)))
(assert (= cur_state1 2))
(assert (= x35 x31))
(assert (= y25 y21))
(assert (= x34 x30))
(assert (= y24 y20))
(assert (= cur_state2 (mk_int__ref cur_state1)))
(assert (= cur_board32 cur_board30))
(assert (= x37 x33))
(assert (= y27 y23))
(assert (= x36 x32))
(assert (= y26 y22))
(assert (= cur_state3 cur_state1))
(assert (= cur_board33 cur_board31))
(assert (not (= (valid_configuration (map__content1 cur_board32) (mk___split_fields cur_piece__split_fields cur_piece__split_fields1 cur_piece__split_fields2 cur_piece__split_fields3) (int__content cur_state2)) true)))
(check-sat)
(exit)
