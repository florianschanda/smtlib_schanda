...
(declare-const temp___254 (Array Int positive))
...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 content__last))) (= temp___256 i1)))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 content__last))) (= temp___254 content)))
...
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 content__last))) (and (and (forall ((temp___255 Int)) (=> (and (<= (to_rep1 content__first) temp___255) (<= temp___255 (to_rep1 content__last))) (=> (or (< (to_rep1 content__last) temp___255) (or (< temp___255 1) (< i2 temp___255))) (= (select content3 temp___255) (select temp___254 temp___255))))) (=> (<= 1 (to_rep1 content__last)) (dynamic_property3 1 (to_rep1 content__last) i2))) (and (<= 1 i2) (<= i2 (to_rep1 content__last))))))
...
(assert (= top3 top1))
(assert (not (= (all_eq e content8) true)))
(check-sat)
(exit)
