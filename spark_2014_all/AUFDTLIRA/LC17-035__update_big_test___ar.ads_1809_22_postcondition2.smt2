...
(declare-const temp___9493 us_rep3)
...
(assert (= temp___9493 (mk___rep3 o28)))
(assert (= result (mk___split_fields__ref3 (mk___split_fields3 r__split_fields r__split_fields1))))
(assert (= r__split_fields2 (us_split_fields7 temp___9493)))
(assert (= r__split_fields3 (mk___split_fields__ref3 r__split_fields2)))
(assert (= r__split_fields4 r__split_fields2))
(declare-const n Int)
(assert (<= 90 n))
(assert (<= n 99))
(assert (not (in_range4 (to_rep3 (rec__ar__rec2t__f2 (us_split_fields3 (rec__ar__rec5t__f5 (us_split_fields5 (select (rec__ar__rofaofr2__b2 (us_split_fields__content3 r__split_fields3)) n)))))))))
(check-sat)
(exit)
