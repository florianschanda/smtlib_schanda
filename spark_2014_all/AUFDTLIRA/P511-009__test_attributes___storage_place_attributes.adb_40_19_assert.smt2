...
(assert (forall ((x my_integer)) (! (in_range1 (to_rep x)) :pattern ((to_rep x)))))
...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep (rec__storage_place_attributes__r2__d1 (us_split_discrs1 a))) (to_rep (rec__storage_place_attributes__r2__d1 (us_split_discrs1 b)))) (and (= (to_rep1 (rec__storage_place_attributes__r2__d3 (us_split_fields1 a))) (to_rep1 (rec__storage_place_attributes__r2__d3 (us_split_fields1 b)))) (=> (storage_place_attributes__r2__d2__pred a) (= (rec__storage_place_attributes__r2__d2 (us_split_fields1 a)) (rec__storage_place_attributes__r2__d2 (us_split_fields1 b)))))) true false))
...
(define-fun in_range3 ((rec__storage_place_attributes__r2__d11 Int) (a us_rep)) Bool (= rec__storage_place_attributes__r2__d11 (to_rep (rec__storage_place_attributes__r2__d1 (us_split_discrs1 a)))))
...
(assert (< storage_place_attributes__r2__d1__first__bit1 storage_place_attributes__r2__d1__last__bit1))
...
(assert (< storage_place_attributes__r2__d3__first__bit1 storage_place_attributes__r2__d3__last__bit1))
...
(assert (< storage_place_attributes__r2__d2__first__bit1 storage_place_attributes__r2__d2__last__bit1))
...
(define-fun dynamic_invariant ((temp___expr_212 us_rep) (temp___is_init_209 Bool) (temp___skip_constant_210 Bool) (temp___do_toplevel_211 Bool)) Bool (and (=> (not (= temp___skip_constant_210 true)) (in_range3 5 temp___expr_212)) (= (attr__constrained temp___expr_212) true)))
(define-fun default_initial_assumption1 ((temp___expr_214 us_rep) (temp___skip_top_level_215 Bool)) Bool (and (= (attr__constrained temp___expr_214) true) (and (and (= (to_rep (rec__storage_place_attributes__r2__d1 (us_split_discrs1 temp___expr_214))) 5) (= (to_rep1 (rec__storage_place_attributes__r2__d3 (us_split_fields1 temp___expr_214))) 0)) (=> (storage_place_attributes__r2__d2__pred temp___expr_214) (= (rec__storage_place_attributes__r2__d2 (us_split_fields1 temp___expr_214)) (of_int 0))))))
(define-fun in_range4 ((rec__storage_place_attributes__r2__d11 Int) (a us_rep)) Bool (= rec__storage_place_attributes__r2__d11 (to_rep (rec__storage_place_attributes__r2__d1 (us_split_discrs1 a)))))
...
(assert (< storage_place_attributes__r2__d1__first__bit2 storage_place_attributes__r2__d1__last__bit2))
...
(assert (< storage_place_attributes__r2__d2__first__bit2 storage_place_attributes__r2__d2__last__bit2))
...
(assert (< storage_place_attributes__r2__d3__first__bit2 storage_place_attributes__r2__d3__last__bit2))
...
(define-fun dynamic_invariant1 ((temp___expr_220 us_rep) (temp___is_init_217 Bool) (temp___skip_constant_218 Bool) (temp___do_toplevel_219 Bool)) Bool (and (=> (not (= temp___skip_constant_218 true)) (in_range4 1 temp___expr_220)) (= (attr__constrained temp___expr_220) true)))
(define-fun default_initial_assumption2 ((temp___expr_222 us_rep) (temp___skip_top_level_223 Bool)) Bool (and (= (attr__constrained temp___expr_222) true) (and (and (= (to_rep (rec__storage_place_attributes__r2__d1 (us_split_discrs1 temp___expr_222))) 1) (=> (storage_place_attributes__r2__d2__pred temp___expr_222) (= (rec__storage_place_attributes__r2__d2 (us_split_fields1 temp___expr_222)) (of_int 0)))) (= (to_rep1 (rec__storage_place_attributes__r2__d3 (us_split_fields1 temp___expr_222))) 0))))
...
(declare-datatypes () ((tTr2a_arrSP1__ref (mk_tTr2a_arrSP1__ref (tTr2a_arrSP1__content tTr2a_arrSP1)))))
(define-fun tTr2a_arrSP1__ref___projection ((a tTr2a_arrSP1__ref)) tTr2a_arrSP1 (tTr2a_arrSP1__content a))
...
(define-fun dynamic_invariant2 ((temp___expr_234 (Array Int us_rep)) (temp___is_init_231 Bool) (temp___skip_constant_232 Bool) (temp___do_toplevel_233 Bool)) Bool (forall ((temp___235 Int)) (=> (and (<= 1 temp___235) (<= temp___235 3)) (and (and (in_range3 5 (select temp___expr_234 temp___235)) (= (attr__constrained (select temp___expr_234 temp___235)) true)) (= (attr__constrained (select temp___expr_234 temp___235)) true)))))
(define-fun default_initial_assumption3 ((temp___expr_237 (Array Int us_rep)) (temp___skip_top_level_238 Bool)) Bool (forall ((temp___239 Int)) (=> (and (<= 1 temp___239) (<= temp___239 3)) (and (= (attr__constrained (select temp___expr_237 temp___239)) true) (and (and (= (to_rep (rec__storage_place_attributes__r2__d1 (us_split_discrs1 (select temp___expr_237 temp___239)))) 5) (= (to_rep1 (rec__storage_place_attributes__r2__d3 (us_split_fields1 (select temp___expr_237 temp___239)))) 0)) (=> (storage_place_attributes__r2__d2__pred (select temp___expr_237 temp___239)) (= (rec__storage_place_attributes__r2__d2 (us_split_fields1 (select temp___expr_237 temp___239))) (of_int 0))))))))
...
(define-fun dynamic_invariant4 ((temp___expr_172 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= 1 10)) (in_range1 temp___expr_172)))
(declare-const r2a_arr (Array Int us_rep))
(declare-const o2a__split_fields integer)
(declare-const o2a__split_fields1 Bool)
(declare-const o2aa__split_fields integer)
(declare-const o2aa__split_fields1 Bool)
(declare-const o2b__split_fields integer)
(declare-const o2b__split_fields1 Bool)
(declare-const o2__split_fields integer)
(declare-const o2__split_fields1 Bool)
...
(assert (default_initial_assumption1 (mk___rep o2a__split_discrs (mk___split_fields o2a__split_fields o2a__split_fields1) o2a__attr__constrained) false))
(assert (and (= 5 (to_rep (rec__storage_place_attributes__r2__d1 o2a__split_discrs))) (= o2a__attr__constrained true)))
(assert (default_initial_assumption1 (mk___rep o2aa__split_discrs (mk___split_fields o2aa__split_fields o2aa__split_fields1) o2aa__attr__constrained) false))
(assert (and (= 5 (to_rep (rec__storage_place_attributes__r2__d1 o2aa__split_discrs))) (= o2aa__attr__constrained true)))
(assert (default_initial_assumption2 (mk___rep o2b__split_discrs (mk___split_fields o2b__split_fields o2b__split_fields1) o2b__attr__constrained) false))
(assert (and (= 1 (to_rep (rec__storage_place_attributes__r2__d1 o2b__split_discrs))) (= o2b__attr__constrained true)))
(assert (= storage_place_attributes__r2__d3__first__bit1 storage_place_attributes__r2__d3__first__bit2))
(assert (not true))
(check-sat)
(exit)
