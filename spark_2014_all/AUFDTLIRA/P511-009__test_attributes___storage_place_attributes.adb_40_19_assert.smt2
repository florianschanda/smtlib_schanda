...
(define-fun default_initial_assumption ((temp___expr_218 us_rep) (temp___skip_top_level_219 Bool)) Bool (and (= (attr__constrained temp___expr_218) false) (and (and (= (to_rep (rec__storage_place_attributes__r2__d1 (us_split_discrs1 temp___expr_218))) 1) (= (to_rep1 (rec__storage_place_attributes__r2__d3 (us_split_fields1 temp___expr_218))) 0)) (=> (storage_place_attributes__r2__d2__pred temp___expr_218) (= (rec__storage_place_attributes__r2__d2 (us_split_fields1 temp___expr_218)) (distinct 0 0))))))
...
(define-fun dynamic_invariant ((temp___expr_242 us_rep) (temp___is_init_238 Bool) (temp___skip_constant_239 Bool) (temp___do_toplevel_240 Bool) (temp___do_typ_inv_241 Bool)) Bool (and (=> (not (= temp___skip_constant_239 true)) (in_range3 5 temp___expr_242)) (= (attr__constrained temp___expr_242) true)))
(define-fun default_initial_assumption1 ((temp___expr_244 us_rep) (temp___skip_top_level_245 Bool)) Bool (and (= (attr__constrained temp___expr_244) true) (and (and (= (to_rep (rec__storage_place_attributes__r2__d1 (us_split_discrs1 temp___expr_244))) 5) (= (to_rep1 (rec__storage_place_attributes__r2__d3 (us_split_fields1 temp___expr_244))) 0)) (=> (storage_place_attributes__r2__d2__pred temp___expr_244) (= (rec__storage_place_attributes__r2__d2 (us_split_fields1 temp___expr_244)) (distinct 0 0))))))
...
(define-fun dynamic_invariant1 ((temp___expr_251 us_rep) (temp___is_init_247 Bool) (temp___skip_constant_248 Bool) (temp___do_toplevel_249 Bool) (temp___do_typ_inv_250 Bool)) Bool (and (=> (not (= temp___skip_constant_248 true)) (in_range4 1 temp___expr_251)) (= (attr__constrained temp___expr_251) true)))
(define-fun default_initial_assumption2 ((temp___expr_253 us_rep) (temp___skip_top_level_254 Bool)) Bool (and (= (attr__constrained temp___expr_253) true) (and (and (= (to_rep (rec__storage_place_attributes__r2__d1 (us_split_discrs1 temp___expr_253))) 1) (=> (storage_place_attributes__r2__d2__pred temp___expr_253) (= (rec__storage_place_attributes__r2__d2 (us_split_fields1 temp___expr_253)) (distinct 0 0)))) (= (to_rep1 (rec__storage_place_attributes__r2__d3 (us_split_fields1 temp___expr_253))) 0))))
...
(define-fun dynamic_invariant2 ((temp___expr_267 (Array Int us_rep)) (temp___is_init_263 Bool) (temp___skip_constant_264 Bool) (temp___do_toplevel_265 Bool) (temp___do_typ_inv_266 Bool)) Bool (forall ((temp___268 Int)) (=> (and (<= 1 temp___268) (<= temp___268 3)) (and (and (in_range3 5 (select temp___expr_267 temp___268)) (= (attr__constrained (select temp___expr_267 temp___268)) true)) (= (attr__constrained (select temp___expr_267 temp___268)) true)))))
(define-fun default_initial_assumption3 ((temp___expr_270 (Array Int us_rep)) (temp___skip_top_level_271 Bool)) Bool (forall ((temp___272 Int)) (=> (and (<= 1 temp___272) (<= temp___272 3)) (and (= (attr__constrained (select temp___expr_270 temp___272)) true) (and (and (= (to_rep (rec__storage_place_attributes__r2__d1 (us_split_discrs1 (select temp___expr_270 temp___272)))) 5) (= (to_rep1 (rec__storage_place_attributes__r2__d3 (us_split_fields1 (select temp___expr_270 temp___272)))) 0)) (=> (storage_place_attributes__r2__d2__pred (select temp___expr_270 temp___272)) (= (rec__storage_place_attributes__r2__d2 (us_split_fields1 (select temp___expr_270 temp___272))) (distinct 0 0))))))))
...
(define-fun dynamic_invariant4 ((temp___expr_201 Int) (temp___is_init_197 Bool) (temp___skip_constant_198 Bool) (temp___do_toplevel_199 Bool) (temp___do_typ_inv_200 Bool)) Bool (=> (or (= temp___is_init_197 true) (<= 1 10)) (in_range1 temp___expr_201)))
(assert (not true))
(check-sat)
(exit)
