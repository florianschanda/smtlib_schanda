...
(assert (and (= o9 (tail s1)) (and (dynamic_invariant o9 true false true) (and (= (elts s1) o4) (= (mk (to_rep1 (first2 (mk1 (+ (to_rep1 (first (rt s1))) 1) (to_rep1 (last (rt s1)))))) (to_rep1 (last2 (mk1 (+ (to_rep1 (first (rt s1))) 1) (to_rep1 (last (rt s1))))))) o5)))))
(assert (and (= o6 (slow_lcs_length o9 s2)) (and (in_range4 o6) (= o6 (ite (or (= (bool_eq o4 (to_rep1 (first o5)) (to_rep1 (last o5)) (temp___String_Literal_152 Tuple0) 1 0) true) (= (bool_eq (elts s2) (to_rep1 (first (rt s2))) (to_rep1 (last (rt s2))) (temp___String_Literal_154 Tuple0) 1 0) true)) 0 (ite (= (head o9) (head s2)) (+ 1 (slow_lcs_length (tail o9) (tail s2))) (ite (< (slow_lcs_length o9 (tail s2)) (slow_lcs_length (tail o9) s2)) (slow_lcs_length (tail o9) s2) (slow_lcs_length o9 (tail s2)))))))))
(assert (and (= o10 (tail s2)) (and (dynamic_invariant o10 true false true) (and (= (elts s2) o2) (= (mk (to_rep1 (first2 (mk1 (+ (to_rep1 (first (rt s2))) 1) (to_rep1 (last (rt s2)))))) (to_rep1 (last2 (mk1 (+ (to_rep1 (first (rt s2))) 1) (to_rep1 (last (rt s2))))))) o3)))))
(assert (and (= o7 (slow_lcs_length s1 o10)) (and (in_range4 o7) (= o7 (ite (or (= (bool_eq (elts s1) (to_rep1 (first (rt s1))) (to_rep1 (last (rt s1))) (temp___String_Literal_152 Tuple0) 1 0) true) (= (bool_eq o2 (to_rep1 (first o3)) (to_rep1 (last o3)) (temp___String_Literal_154 Tuple0) 1 0) true)) 0 (ite (= (head s1) (head o10)) (+ 1 (slow_lcs_length (tail s1) (tail o10))) (ite (< (slow_lcs_length s1 (tail o10)) (slow_lcs_length (tail s1) o10)) (slow_lcs_length (tail s1) o10) (slow_lcs_length s1 (tail o10)))))))))
