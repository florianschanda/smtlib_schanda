...
(assert (forall ((s us_t)) (! (=> (dynamic_invariant s true true true) (dynamic_invariant1 (head s) true false true)) :pattern ((head s)))))
(assert (forall ((s us_t)) (! (=> (dynamic_invariant s true true true) (= (head s) (to_rep (select (to_array s) (first1 s))))) :pattern ((head s)))))
...
(assert (forall ((s us_t)) (! (=> (dynamic_invariant s true true true) (dynamic_invariant (tail s) true false true)) :pattern ((tail s)))))
(assert (forall ((s us_t)) (! (=> (dynamic_invariant s true true true) (= (tail s) (let ((temp___145 (let ((temp___144 (last1 s))) (let ((temp___143 (+ (first1 s) 1))) (of_array1 (to_array s) temp___143 temp___144))))) (of_array (to_array1 temp___145) (first3 temp___145) (last3 temp___145))))) :pattern ((tail s)))))
...
(assert (not (= (ite (= (bool_eq (elts s1) (to_rep1 (first (rt s1))) (to_rep1 (last (rt s1))) (temp___String_Literal_152 Tuple0) 1 0) false) (bool_eq (elts s2) (to_rep1 (first (rt s2))) (to_rep1 (last (rt s2))) (temp___String_Literal_154 Tuple0) 1 0) true) true)))
(assert (and (= o (head s2)) (and (in_range3 o) (= o (to_rep (select (elts s2) (to_rep1 (first (rt s2)))))))))
(assert (and (= o1 (head s1)) (and (in_range3 o1) (= o1 (to_rep (select (elts s1) (to_rep1 (first (rt s1)))))))))
(assert (= result (ite (= o1 o) true false)))
(assert (not (= result true)))
(assert (and (= (mk___t o10 o11) (tail s1)) (and (dynamic_invariant (mk___t o10 o11) true false true) (and (= (elts s1) o10) (= (mk (to_rep1 (first2 (mk1 (+ (to_rep1 (first (rt s1))) 1) (to_rep1 (last (rt s1)))))) (to_rep1 (last2 (mk1 (+ (to_rep1 (first (rt s1))) 1) (to_rep1 (last (rt s1))))))) o11)))))
(assert (and (= o12 (slow_lcs_length (mk___t o10 o11) s2)) (and (in_range4 o12) (= o12 (ite (or (= (bool_eq o10 (to_rep1 (first o11)) (to_rep1 (last o11)) (temp___String_Literal_152 Tuple0) 1 0) true) (= (bool_eq (elts s2) (to_rep1 (first (rt s2))) (to_rep1 (last (rt s2))) (temp___String_Literal_154 Tuple0) 1 0) true)) 0 (ite (= (head (mk___t o10 o11)) (head s2)) (+ 1 (slow_lcs_length (tail (mk___t o10 o11)) (tail s2))) (ite (< (slow_lcs_length (mk___t o10 o11) (tail s2)) (slow_lcs_length (tail (mk___t o10 o11)) s2)) (slow_lcs_length (tail (mk___t o10 o11)) s2) (slow_lcs_length (mk___t o10 o11) (tail s2)))))))))
(assert (and (= (mk___t o8 o9) (tail s2)) (and (dynamic_invariant (mk___t o8 o9) true false true) (and (= (elts s2) o8) (= (mk (to_rep1 (first2 (mk1 (+ (to_rep1 (first (rt s2))) 1) (to_rep1 (last (rt s2)))))) (to_rep1 (last2 (mk1 (+ (to_rep1 (first (rt s2))) 1) (to_rep1 (last (rt s2))))))) o9)))))
(assert (and (= o13 (slow_lcs_length s1 (mk___t o8 o9))) (and (in_range4 o13) (= o13 (ite (or (= (bool_eq (elts s1) (to_rep1 (first (rt s1))) (to_rep1 (last (rt s1))) (temp___String_Literal_152 Tuple0) 1 0) true) (= (bool_eq o8 (to_rep1 (first o9)) (to_rep1 (last o9)) (temp___String_Literal_154 Tuple0) 1 0) true)) 0 (ite (= (head s1) (head (mk___t o8 o9))) (+ 1 (slow_lcs_length (tail s1) (tail (mk___t o8 o9)))) (ite (< (slow_lcs_length s1 (tail (mk___t o8 o9))) (slow_lcs_length (tail s1) (mk___t o8 o9))) (slow_lcs_length (tail s1) (mk___t o8 o9)) (slow_lcs_length s1 (tail (mk___t o8 o9))))))))))
(assert (= o14 (ite (< o13 o12) o12 o13)))
