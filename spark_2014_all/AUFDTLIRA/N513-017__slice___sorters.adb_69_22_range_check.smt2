...
(assert (and (and (and (<= (to_rep values__first) current2) (< current2 (to_rep values__last))) (forall ((j Int)) (=> (and (<= (to_rep values__first) j) (<= j (- current2 1))) (<= (to_rep (select values3 j)) (to_rep (select values3 (+ j 1))))))) (forall ((j Int)) (=> (and (<= current2 j) (<= j (to_rep values__last))) (<= (to_rep (select values3 current2)) (to_rep (select values3 j)))))))
