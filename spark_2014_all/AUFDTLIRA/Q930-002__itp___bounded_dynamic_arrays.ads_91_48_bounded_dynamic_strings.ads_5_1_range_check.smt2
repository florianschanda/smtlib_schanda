...
(define-fun temp___10442 () us_t2 (mk___t2 temp___1044 temp___10441))
...
(assert (and (= o24 (length3 right)) (in_range1 (length3 right))))
(assert (and (= o25 (length2 left)) (and (in_range4 o25) (= o25 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 left)))))))
(assert (= o26 (+ o25 o24)))
...
(assert (and (= o19 (length3 right)) (in_range1 (length3 right))))
(assert (and (= o20 (length2 left)) (and (in_range4 o20) (= o20 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 left)))))))
(assert (= o21 (+ o20 o19)))
(assert (and (= o22 (length2 (sequence__content bounded_dynamic_strings__Oconcat__2__result10))) (and (in_range4 o22) (= o22 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 (sequence__content bounded_dynamic_strings__Oconcat__2__result10))))))))
(assert (= o23 (ite (= o22 o21) true false)))
(assert (and (= temp___10442 (value left)) (and (dynamic_invariant2 temp___10442 true false true true) (and (and (= (elts1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 left))) temp___1044) (= (mk2 (to_rep1 (first6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 left)))))) (to_rep1 (last6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 left))))))) temp___10441)) (and (and (and (= (length3 temp___10442) (length2 left)) (= (to_rep1 (first4 temp___10441)) 1)) (= (to_rep1 (last4 temp___10441)) (length2 left))) (= (< 0 (length2 left)) (not (= (empty left) true))))))))
(assert (not (= (length3 temp___10442) 0)))
(assert (=> (<= (to_rep1 (first4 (rt2 right))) (to_rep1 (last4 (rt2 right)))) (= o14 (+ (- (to_rep1 (last4 (rt2 right))) (to_rep1 (first4 (rt2 right)))) 1))))
(assert (=> (not (<= (to_rep1 (first4 (rt2 right))) (to_rep1 (last4 (rt2 right))))) (= o14 0)))
(assert (=> (<= (to_rep1 (first4 temp___10441)) (to_rep1 (last4 temp___10441))) (= o15 (+ (- (to_rep1 (last4 temp___10441)) (to_rep1 (first4 temp___10441))) 1))))
(assert (=> (not (<= (to_rep1 (first4 temp___10441)) (to_rep1 (last4 temp___10441)))) (= o15 0)))
(assert (= o16 (+ o15 o14)))
(assert (= o17 (+ (to_rep1 (first4 temp___10441)) o16)))
(assert (= o18 (- o17 1)))
