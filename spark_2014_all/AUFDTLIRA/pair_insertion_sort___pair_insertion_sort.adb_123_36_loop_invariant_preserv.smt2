...
(assert (=> (= result1 true) (=> (= result8 true) (= a27 (mk_map__ref a4)))))
...
(assert (and (and (= (is_perm (mk___t a23 (mk (to_rep a__first) (to_rep a__last))) (mk___t a24 (mk (to_rep a__first) (to_rep a__last)))) true) (and (= (to_rep (select a24 o64)) (to_rep (select a23 o65))) (and (= (to_rep (select a24 o65)) (to_rep (select a23 o64))) (forall ((z9 Int)) (=> (and (<= (to_rep a__first) z9) (<= z9 (to_rep a__last))) (=> (and (not (= z9 o64)) (not (= z9 o65))) (= (to_rep (select a24 z9)) (to_rep (select a23 z9))))))))) (= (to_rep a__first) 0)))
(assert (= j23 (mk_int__ref j22)))
(assert (= a25 (mk_map__ref a24)))
(assert (= j24 j22))
(assert (= a26 a24))
(assert (not (= (sorted (mk___t (map__content a25) (mk (to_rep a__first) (to_rep a__last))) 0 (- (int__content j23) 1)) true)))
(check-sat)
(exit)
