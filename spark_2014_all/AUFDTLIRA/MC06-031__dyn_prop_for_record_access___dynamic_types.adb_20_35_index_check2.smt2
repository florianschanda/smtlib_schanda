...
(assert (forall ((f Int) (l Int)) (! (=> (in_range2 f) (=> (in_range2 l) (and (= (to_rep1 (first1 (mk f l))) f) (= (to_rep1 (last1 (mk f l))) l)))) :pattern ((mk f l)))))
...
(define-fun dynamic_invariant1 ((temp___expr_160 us_t) (temp___is_init_156 Bool) (temp___skip_constant_157 Bool) (temp___do_toplevel_158 Bool) (temp___do_typ_inv_159 Bool)) Bool (=> (not (= temp___skip_constant_157 true)) (dynamic_property1 1 2147483647 (first2 temp___expr_160) (last2 temp___expr_160))))
...
(declare-fun temp_____aggregate_def_214 (Int) (Array Int integer))
(declare-fun temp_____aggregate_def_218 (Int) (Array Int integer))
...
(define-fun dynamic_invariant4 ((temp___expr_177 Int) (temp___is_init_173 Bool) (temp___skip_constant_174 Bool) (temp___do_toplevel_175 Bool) (temp___do_typ_inv_176 Bool)) Bool (=> (or (= temp___is_init_173 true) (<= first last)) (dynamic_property first last temp___expr_177)))
...
(define-fun dynamic_invariant6 ((temp___expr_194 us_rep) (temp___is_init_190 Bool) (temp___skip_constant_191 Bool) (temp___do_toplevel_192 Bool) (temp___do_typ_inv_193 Bool)) Bool (forall ((temp___195 Int)) (=> (and (<= 1 temp___195) (<= temp___195 1)) (=> (or (= temp___is_init_190 true) (<= first last)) (dynamic_property first last (to_rep1 (select (rec__dynamic_types__search__result_type__from (us_split_fields1 temp___expr_194)) temp___195)))))))
(assert (forall ((temp___220 Int)) (=> (dynamic_invariant4 temp___220 true true true true) (= (to_rep1 (select (temp_____aggregate_def_218 temp___220) 1)) temp___220))))
(assert (forall ((temp___216 Int)) (=> (dynamic_invariant4 temp___216 true true true true) (= (to_rep1 (select (temp_____aggregate_def_214 temp___216) 1)) temp___216))))
...
(assert (in_range1 c))
(assert (and (<= (to_rep1 (first1 (rt a))) from) (<= from (to_rep1 (last1 (rt a))))))
...
(assert (=> (= result true) (and (= us from) (dynamic_property first last from))))
(assert (=> (= result true) (= o3 from)))
(assert (=> (= result true) (= o5 (temp_____aggregate_def_218 o3))))
...
(assert (=> (not (= result true)) (and (= us1 from) (dynamic_property first last from))))
(assert (=> (not (= result true)) (= o10 from)))
(assert (=> (not (= result true)) (= o11 (temp_____aggregate_def_214 o10))))
(assert (=> (not (= result true)) (= o11 o12)))
(assert (=> (not (= result true)) (= rliteral o13)))
(assert (=> (not (= result true)) (= o14 o12)))
...
(assert (=> (not (= result true)) (= dynamic_types__search__search_range__result13 (mk___rep (mk___split_fields o14 o15)))))
...
(assert (not (<= (to_rep1 (first1 (rt a))) i)))
(check-sat)
(exit)
