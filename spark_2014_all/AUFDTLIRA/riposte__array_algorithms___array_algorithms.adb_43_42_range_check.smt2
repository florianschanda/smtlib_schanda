...
(define-fun dynamic_invariant1 ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_142)))
...
(declare-fun concat1 ((Array Int value_type) Int Int (Array Int value_type) Int Int) (Array Int value_type))
(assert (forall ((a (Array Int value_type)) (b (Array Int value_type))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (forall ((i Int)) (! (and (=> (and (<= a_first i) (<= i a_last)) (= (select (concat1 a a_first a_last b b_first b_last) i) (select a i))) (=> (< a_last i) (= (select (concat1 a a_first a_last b b_first b_last) i) (select b (+ (- i a_last) (- b_first 1)))))) :pattern ((select (concat1 a a_first a_last b b_first b_last) i)))))))
(declare-fun singleton1 (value_type Int) (Array Int value_type))
(assert (forall ((v value_type)) (forall ((i Int)) (! (= (select (singleton1 v i) i) v) :pattern ((select (singleton1 v i) i))))))
(define-fun bool_eq ((a (Array Int value_type)) (a__first Int) (a__last Int) (b (Array Int value_type)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_132 Int)) (=> (and (<= a__first temp___idx_132) (<= temp___idx_132 a__last)) (= (to_rep (select a temp___idx_132)) (to_rep (select b (+ (- b__first a__first) temp___idx_132))))))) true false))
...
(declare-fun compare ((Array Int value_type) Int Int (Array Int value_type) Int Int) Int)
(assert (forall ((a (Array Int value_type)) (b (Array Int value_type))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare a a_first a_last b b_first b_last) 0) (= (bool_eq a a_first a_last b b_first b_last) true)) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int value_type)) (b (Array Int value_type))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep (select a (+ i 1))) (to_rep (select b (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int value_type)) (b (Array Int value_type))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep (select b (+ i 1))) (to_rep (select a (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
...
(define-fun dynamic_invariant2 ((temp___expr_148 us_t) (temp___is_init_145 Bool) (temp___skip_constant_146 Bool) (temp___do_toplevel_147 Bool)) Bool (=> (not (= temp___skip_constant_146 true)) (dynamic_property (- 2147483648) 2147483647 (first1 temp___expr_148) (last1 temp___expr_148))))
(declare-fun has_value_inc (us_t Int Int) Bool)
(declare-fun has_value_inc__function_guard (Bool us_t Int Int) Bool)
(assert true)
(assert (forall ((a us_t)) (forall ((lastindex Int) (val__ Int)) (! (= (= (has_value_inc a lastindex val__) true) (exists ((i Int)) (and (and (<= (first1 a) i) (<= i lastindex)) (= (to_rep (select (to_array a) i)) val__)))) :pattern ((has_value_inc a lastindex val__))))))
(declare-fun has_value_exc (us_t Int Int) Bool)
(declare-fun has_value_exc__function_guard (Bool us_t Int Int) Bool)
(assert true)
(assert (forall ((a us_t)) (forall ((lastindex Int) (val__ Int)) (! (= (= (has_value_exc a lastindex val__) true) (exists ((i Int)) (and (and (<= (first1 a) i) (<= i lastindex)) (and (< i lastindex) (= (to_rep (select (to_array a) i)) val__))))) :pattern ((has_value_exc a lastindex val__))))))
...
(define-fun t9b__ref___projection ((a1 t9b__ref)) tindex_typeB (t9b__content a1))
...
(declare-const location15 int__ref)
(declare-const i14 int__ref)
(declare-const found16 Bool)
(declare-const location16 Int)
...
(assert (not (= (to_rep (select (elts a) i1)) val__)))
(assert (= location2 location1))
(assert (= found2 found1))
(assert (and (forall ((j1 Int)) (=> (and (<= (to_rep1 (first (rt a))) j1) (<= j1 i2)) (not (= (to_rep (select (elts a) j1)) val__)))) (not (= found3 true))))
(assert (and (and (=> (<= (- 2147483648) 2147483647) (in_range2 location3)) (=> (<= (to_rep1 (first (rt a))) (to_rep1 (last (rt a)))) (dynamic_property1 (to_rep1 (first (rt a))) (to_rep1 (last (rt a))) i2))) (and (<= (to_rep1 (first (rt a))) i2) (<= i2 (to_rep1 (last (rt a)))))))
(assert (<= (to_rep1 (first (rt a))) i2))
