...
(assert true)
(declare-const i Int)
(declare-const temp___1760 (Array Int us_rep3))
...
(assert (= result3 true))
(assert (and (= temp___1760 (model__ f root)) (and (dynamic_invariant5 temp___1760 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1760 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1760 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent f i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1760 (parent f i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1760 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1760 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1760 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select temp___1760 (parent f i1)))) (position f i1) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1760 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1760 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1760 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1760 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select temp___1760 i1))) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1760 j)))) true)) (= j i1))))))))))))))
...
(assert (= result5 true))
(assert (and (= result6 (ordered_leafs f_old v values)) (= (= result6 true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f_old v) i1))) true) (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f_old v) j))) true)) (= (olt (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f_old v) i1))) (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f_old v) j)))) true)) (ite (= (get (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f_old v) j))) (+ (length (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f_old v) i1)))) 1)) 0) (< (to_rep (select values j)) (to_rep (select values i1))) (< (to_rep (select values i1)) (to_rep (select values j))))))))))))
(assert (= result6 true))
(assert (= (= result7 true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f_old root) i1))) true) (= (olt (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f_old root) i1))) (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) v)))) true)) (ite (= (get (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) v))) (+ (length (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f_old root) i1)))) 1)) 0) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f_old v) j))) true) (< (to_rep (select values j)) (to_rep (select values i1)))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f_old v) j))) true) (< (to_rep (select values i1)) (to_rep (select values j))))))))))))
(assert (= result7 true))
(assert (= (= result8 true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f root) i1))) true) (ite (= (ole (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) v))) (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) i1)))) true) (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f_old v) i1))) true) (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f_old root) i1))) true)))))))
(assert (= result8 true))
(assert (= (= result9 true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f_old root) i1))) true) (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f root) i1))) true))))))
(assert (= result9 true))
(assert (= (= result10 true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (and (not (= v 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f_old v) i1))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f root) i1))) true))))))
(assert (= result10 true))
(assert (= (= result11 true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f_old root) i1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f_old root) i1))) (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) i1)))) true))))))
