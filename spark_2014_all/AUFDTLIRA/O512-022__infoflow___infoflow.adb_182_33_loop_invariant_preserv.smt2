...
(assert (and (= temp___480 (- i_v12 k_1)) (in_range1 (- i_v12 k_1))))
(assert (and (<= (to_rep (first (rt c_v1))) temp___480) (<= temp___480 (to_rep (last (rt c_v1))))))
(assert (= o temp___480))
...
(assert (<= m k_1))
(assert (not (= (to_rep (select a_v13 m)) (to_rep (select (elts b_v1) m)))))
(check-sat)
(exit)
