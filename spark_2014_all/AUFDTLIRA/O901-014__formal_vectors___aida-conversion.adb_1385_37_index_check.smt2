...
(assert (and (= o37 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (= o38 (ite (<= index1 o37) true false)))
(assert (and (= o36 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (= o39 (ite (<= o36 index1) true false)))
(assert (= result (ite (= o39 true) o38 false)))
(assert (= (= o40 true) (forall ((index11 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 9) index11) (<= index11 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index11))) true)))))
(assert (and (= temp___1860 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1860) (<= temp___1860 (to_rep1 (last (rt source))))))
(assert (= o32 temp___1860))
(assert (= o33 (select (elts source) o32)))
(assert (= o34 (to_rep o33)))
(assert (= o35 (ite (< o34 52) true false)))
(assert (and (= temp___1859 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1859) (<= temp___1859 (to_rep1 (last (rt source))))))
(assert (= o28 temp___1859))
(assert (= o29 (select (elts source) o28)))
(assert (= o30 (to_rep o29)))
(assert (= o31 (ite (= o30 54) true false)))
(assert (and (= temp___1858 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1858) (<= temp___1858 (to_rep1 (last (rt source))))))
(assert (= o24 temp___1858))
(assert (= o25 (select (elts source) o24)))
(assert (= o26 (to_rep o25)))
(assert (= o27 (ite (= o26 51) true false)))
(assert (and (= temp___1857 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1857) (<= temp___1857 (to_rep1 (last (rt source))))))
(assert (= o20 temp___1857))
(assert (= o21 (select (elts source) o20)))
(assert (= o22 (to_rep o21)))
(assert (= o23 (ite (= o22 56) true false)))
(assert (and (= temp___1856 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (not (<= (to_rep1 (first (rt source))) temp___1856)))
(check-sat)
(exit)
