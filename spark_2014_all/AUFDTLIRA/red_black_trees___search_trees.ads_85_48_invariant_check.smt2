...
(assert (= (= (size1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3))) 0) true))
(assert (=> (not (= (int__content i18) 0)) (type_invariant1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))))
(assert (=> (not (= (int__content i18) 0)) (and (= o74 (size1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))) (and (in_range4 o74) (= o74 (size (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14))))))))
(assert (=> (not (= (int__content i18) 0)) (= result32 (ite (= o74 1) true false))))
(assert (=> (= (int__content i18) 0) (= result32 false)))
(assert (=> (= result32 true) (type_invariant1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))))
(assert (=> (= result32 true) (and (= o73 (root (mk___rep3 (us_split_fields__content3 t__split_fields14)))) (and (in_range3 o73) (= o73 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields__content3 t__split_fields14))))))))
(assert (=> (= result32 true) (= result31 (ite (= o73 (int__content i18)) true false))))
(assert (=> (not (= result32 true)) (= result31 false)))
(assert (=> (= result31 true) (type_invariant1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))))
(assert (=> (= result31 true) (and (= o72 (values1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))) (ite (= (size (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14))) 0) (= (is_empty o72) true) (and (forall ((i20 Int)) (=> (and (<= 1 i20) (<= i20 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields__content3 t__split_fields14)))) i20))) true) (= (contains o72 (to_rep (select (rec__search_trees__search_tree__values (us_split_fields__content3 t__split_fields14)) i20))) true)))) (forall ((v1 Int)) (=> (and (<= 0 v1) (<= v1 2147483647)) (=> (= (contains o72 v1) true) (exists ((i20 Int)) (and (and (<= 1 i20) (<= i20 100)) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields__content3 t__split_fields14)))) i20))) true) (= (to_rep (select (rec__search_trees__search_tree__values (us_split_fields__content3 t__split_fields14)) i20)) v1))))))))))))
(assert (=> (= result31 true) (type_invariant1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)))))
(assert (=> (= result31 true) (and (= o71 (values1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)))) (ite (= (size (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2))) 0) (= (is_empty o71) true) (and (forall ((i20 Int)) (=> (and (<= 1 i20) (<= i20 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) (to_rep1 t__split_fields)) i20))) true) (= (contains o71 (to_rep (select t__split_fields3 i20))) true)))) (forall ((v1 Int)) (=> (and (<= 0 v1) (<= v1 2147483647)) (=> (= (contains o71 v1) true) (exists ((i20 Int)) (and (and (<= 1 i20) (<= i20 100)) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) (to_rep1 t__split_fields)) i20))) true) (= (to_rep (select t__split_fields3 i20)) v1))))))))))))
(assert (=> (= result31 true) (and (= result30 (is_add__2 o71 v o72)) (= (= result30 true) (and (and (and (not (= (contains o71 v) true)) (= (contains o72 v) true)) (= (ole o71 o72) true)) (= (included_except o72 o71 v) true))))))
(assert (=> (not (= result31 true)) (= result30 false)))
(assert (=> (= result30 true) (= (= result29 true) (forall ((i20 Int)) (=> (and (<= 1 i20) (<= i20 100)) (=> (not (= i20 (root (mk___rep3 (us_split_fields__content3 t__split_fields14))))) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__1 (mk___rep3 (us_split_fields__content3 t__split_fields14))) i20))) true))))))))
(assert (=> (not (= result30 true)) (= result29 false)))
(assert (= result29 true))
(assert (<= 1 i3))
(assert (<= i3 100))
(assert (type_invariant1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3))))
(assert (and (= o68 (parent1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)) i3)) (and (in_range4 o68) (and (= o68 (parent (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) i3)) (=> (= (size1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3))) 0) (= o68 0))))))
