...
(assert (and (= o109 (capacity (mk___rep3 p__split_discrs (us_split_fields__content3 p__split_fields2)))) (and (in_range8 o109) (= o109 (ite (= (of_int 1) true) (to_rep5 (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
(assert (= result24 (ite (= o109 (capacity (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields)))) true false)))
(assert (= result24 true))
(assert (and (= o108 (length1 (mk___rep3 p__split_discrs (us_split_fields__content3 p__split_fields2)))) (and (in_range8 o108) (<= o108 (capacity (mk___rep3 p__split_discrs (us_split_fields__content3 p__split_fields2)))))))
(assert (= result25 (ite (= o108 (length1 (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields)))) true false)))
(assert (= result25 true))
(assert (= (= result26 true) (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 5)) (= (has_key1 (model__ (mk___rep d__split_discrs (us_split_fields__content d__split_fields3))) (to_rep (select (map__content a2) j1))) true)))))
(assert (= result26 true))
(assert (and (= o104 (has_key (positions (mk___rep d__split_discrs (us_split_fields__content d__split_fields3))) c9)) (= (= o104 true) (= (has_key (positions (mk___rep d__split_discrs (us_split_fields__content d__split_fields3))) c9) true))))
(assert (= o105 true))
(assert (= result28 (ite (= o105 true) o104 false)))
(assert (= (= result27 true) (forall ((c10 us_rep1)) (=> (= (has_key (positions (mk___rep d__split_discrs (us_split_fields__content d__split_fields3))) c10) true) (= (to_rep (select (map__content a2) (element (mk___rep d__split_discrs (us_split_fields__content d__split_fields3)) c10))) (key (mk___rep d__split_discrs (us_split_fields__content d__split_fields3)) c10))))))
