...
(declare-const i Int)
(declare-const j Int)
(declare-const temp___429 (Array Int natural))
(declare-const temp___426 (Array Int natural))
(declare-const o Int)
(declare-const o1 (Array Int natural))
(declare-const o2 (Array Int natural))
(declare-const temp___424 (Array Int natural))
(declare-const temp___4241 t1)
...
(define-fun a13 () map__ref (mk_map__ref a11))
(define-fun j13 () int__ref (mk_int__ref j9))
(define-fun a14 () map__ref (mk_map__ref a9))
(define-fun j14 () int__ref (mk_int__ref j7))
(define-fun a15 () map__ref (mk_map__ref a7))
(assert (dynamic_property (- 2147483648) 2147483647 (to_rep1 a__first) (to_rep1 a__last)))
(assert (not (not (and (and (= (mk_int__ref result) (mk_int__ref i)) (= i1 1)) (ite (and (<= 1 i1) (<= i1 2)) (and (and (and (= temp___429 a) (and (and (forall ((temp___430 Int)) (=> (and (<= (to_rep1 a__first) temp___430) (<= temp___430 (to_rep1 a__last))) (=> (or (< 2 temp___430) (or (< temp___430 1) (<= i2 temp___430))) (= (select a2 temp___430) (select temp___429 temp___430))))) (and (<= 1 i2) (<= i2 2))) (and (and (and (= j2 result1) (= j3 1)) (ite (and (<= 1 j3) (<= j3 2)) (and (and (and (= temp___426 a2) (and (and (forall ((temp___427 Int)) (=> (and (<= (to_rep1 a__first) temp___427) (<= temp___427 (to_rep1 a__last))) (=> (not (= i2 temp___427)) (= (select a3 temp___427) (select temp___426 temp___427))))) (and (<= 1 j4) (<= j4 2))) (and (and (and (and (and (<= (to_rep1 a__first) i2) (<= i2 (to_rep1 a__last))) (= o i2)) (= o1 (store a3 o rliteral))) (and (= a3 result2) (= a4 o1))) (and (and (and (and (and (and (=> (<= (to_rep1 a__first) i2) (and (and (<= (to_rep1 a__first) (to_rep1 a__first)) (<= (to_rep1 a__first) (to_rep1 a__last))) (and (<= (to_rep1 a__first) i2) (<= i2 (to_rep1 a__last))))) (= o2 a4)) (and (= o2 temp___424) (= (mk1 (to_rep1 a__first) i2) temp___4241))) (and (= temp___424 loops_static__loop11__B_5__a_begins__assume) (= (mk (to_rep1 (first2 temp___4241)) (to_rep1 (last2 temp___4241))) loops_static__loop11__B_5__a_begins__assume1))) (= (mk___t loops_static__loop11__B_5__a_begins__assume loops_static__loop11__B_5__a_begins__assume1) a_begins)) (dynamic_invariant a_begins true false true true)) (and (forall ((i7 Int)) (=> (and (<= (to_rep1 (first (rt a_begins))) i7) (<= i7 (to_rep1 (last (rt a_begins))))) (= (to_rep (select (elts a_begins) i7)) 0))) (= j4 2)))))) (and (and (= j4 j5) (= a4 a5)) (and (= j6 j4) (= a6 a4)))) (and (and (= j14 (mk_int__ref j5)) (= a15 (mk_map__ref a5))) (and (= j8 j6) (= a8 a6)))) (and (and (= j3 j7) (= a2 a7)) (and (= j8 j3) (= a8 a2))))) (= i2 2)))) (and (and (= j13 j14) (and (= i2 i3) (= a14 a15))) (and (= j10 j8) (and (= i4 i2) (= a10 a8))))) (and (and (= j11 j13) (and (= i5 (mk_int__ref i3)) (= a13 a14))) (and (= j12 j10) (and (= i6 i4) (= a12 a10))))) (and (and (= j11 (mk_int__ref j)) (and (= i5 (mk_int__ref i1)) (= a13 (mk_map__ref a)))) (and (= j12 j1) (and (= i6 i1) (= a12 a1)))))))))
(check-sat)
(exit)
