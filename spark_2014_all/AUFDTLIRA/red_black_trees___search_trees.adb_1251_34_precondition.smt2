...
(assert (and (= o52 (to_rep1 t_old__split_fields)) (in_range3 (to_rep1 t_old__split_fields))))
(assert (and (= temp___2079 (model__ (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) o52)) (and (dynamic_invariant8 temp___2079 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2079 o52))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___2079 o52)))) 0) (and (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 100)) (=> (not (= i4 o52)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) i4) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2079 (parent (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) i4)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2079 i4))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2079 i4))) true)))))) (and (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2079 i4))) true) (not (= i4 o52))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___2079 (parent (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) i4)))) (position (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) i4) (rec__tree_model__path_type__a (us_split_fields1 (select temp___2079 i4)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___2079 i4)))) 0)))) (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2079 i4))) true) (forall ((j14 Int)) (=> (and (<= 1 j14) (<= j14 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2079 j14))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___2079 i4))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___2079 j14)))) true)) (= j14 i4))))))))))))))
(assert (= o53 (select temp___2079 l)))
