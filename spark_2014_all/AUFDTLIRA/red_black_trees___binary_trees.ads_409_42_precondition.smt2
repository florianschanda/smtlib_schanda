...
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5))) true))
(assert (and (= o6 (size (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5)))) (and (in_range2 o6) (= o6 (to_rep f__split_fields4)))))
(assert (= result5 (ite (= o6 (+ (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) 1)) true false)))
(assert (= result5 true))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o5 (valid_root (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root2)) (and (= (= o5 true) (and (<= root2 (to_rep f__split_fields)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 root2)))) 2))) (=> (< (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) root2) (not (= o5 true))))))
(assert (= result6 (ite (not (= o5 true)) true false)))
(assert (= result6 true))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5))) true))
...
(assert (= (= result12 true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (valid_root (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1) true) (= (oeq (model__ (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5)) i1) (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1)) true))))))
(assert (= result12 true))
(assert (<= 1 i))
(assert (<= i 100))
(assert (not (= i root2)))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5))) true))
(assert (not (= (valid_root (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5)) root2) true)))
(check-sat)
(exit)
