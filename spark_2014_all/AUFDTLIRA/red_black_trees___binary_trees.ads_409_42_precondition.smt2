...
(assert (= (= result15 true) (forall ((i6 Int)) (=> (and (<= 1 i6) (<= i6 100)) (=> (= (valid_root (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i6) true) (= (oeq (model__ (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5)) i6) (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i6)) true))))))
