...
(declare-const do_checks__do_length_check__B_24__p1__x (Array Int Bool))
(assert (dynamic_property 0 2147483647 (to_rep x__first) (to_rep x__last)))
(assert (and (= (to_rep x__first) 1) (= (to_rep x__last) 11)))
(assert (not (= (ite (<= (to_rep x__first) (to_rep x__last)) (+ (- (to_rep x__last) (to_rep x__first)) 1) 0) (ite (<= 0 10) (+ (- 10 0) 1) 0))))
(check-sat)
(exit)
