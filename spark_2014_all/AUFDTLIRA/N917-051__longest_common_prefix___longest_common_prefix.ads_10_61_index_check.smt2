...
(assert (=> (= result1 true) (and (and (= temp___155 l1) (and (= 0 temp___158) (and (forall ((k1 Int)) (=> (and (<= 0 k1) (<= k1 (- l2 1))) (= (to_rep (select a (+ x k1))) (to_rep (select a (+ y k1)))))) (and (and (=> (<= 0 2147483647) (in_range2 l2)) (and (and (<= (+ x l2) 1000) (<= (+ y l2) 1000)) (= (to_rep (select a (+ x l2))) (to_rep (select a (+ y l2)))))) (and (and (= temp___1581 result4) (= temp___1582 l2)) (and (and (and (= o11 (+ l2 1)) (in_range1 (+ l2 1))) (and (= l2 result5) (= l3 o11))) (and (and (and (and (and (and (= o19 (+ x l3)) (in_range1 (+ x l3))) (= result8 (ite (<= o19 1000) true false))) (ite (= result8 true) (and (and (= o18 (+ y l3)) (in_range1 (+ y l3))) (= result7 (ite (<= o18 1000) true false))) (= result7 false))) (ite (= result7 true) (and (and (and (and (and (= temp___1601 (+ y l3)) (in_range1 (+ y l3))) (and (and (<= 1 temp___1601) (<= temp___1601 1000)) (= o14 temp___1601))) (= o15 (select a o14))) (= o16 (to_rep o15))) (and (and (and (and (and (= temp___1591 (+ x l3)) (in_range1 (+ x l3))) (and (and (<= 1 temp___1591) (<= temp___1591 1000)) (= o12 temp___1591))) (= o13 (select a o12))) (= o17 (to_rep o13))) (= o20 (ite (= o17 o16) true false)))) (= o20 false))) (= result6 (ite (not (= o20 true)) true false))) (= result6 true)))))))) (and (= l3 l6) (= l7 l3)))))
...
(assert (= longest_common_prefix__lcp__result1 l8))
