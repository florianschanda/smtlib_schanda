...
(assert (=> (= result1 true) (=> (= result7 true) (and (= temp___1601 (+ y l3)) (in_range1 (+ y l3))))))
(assert (=> (= result1 true) (=> (= result7 true) (and (<= 1 temp___1601) (<= temp___1601 1000)))))
...
(assert (=> (= result1 true) (=> (= result7 true) (and (= temp___1591 (+ x l3)) (in_range1 (+ x l3))))))
(assert (=> (= result1 true) (=> (= result7 true) (and (<= 1 temp___1591) (<= temp___1591 1000)))))
