...
(assert (not (= (ite (<= (to_rep (first6 temp___4681)) (to_rep (last6 temp___4681))) (+ (- (to_rep (last6 temp___4681)) (to_rep (first6 temp___4681))) 1) 0) (ite (<= (to_rep (first6 temp___4701)) (to_rep (last6 temp___4701))) (+ (- (to_rep (last6 temp___4701)) (to_rep (first6 temp___4701))) 1) 0))))
(check-sat)
(exit)
