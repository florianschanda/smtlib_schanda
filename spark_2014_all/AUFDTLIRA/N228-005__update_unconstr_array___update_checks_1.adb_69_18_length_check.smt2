...
(assert (not (= (ite (<= (to_rep (first6 temp___5101)) (to_rep (last6 temp___5101))) (+ (- (to_rep (last6 temp___5101)) (to_rep (first6 temp___5101))) 1) 0) (ite (<= (to_rep (first6 temp___5121)) (to_rep (last6 temp___5121))) (+ (- (to_rep (last6 temp___5121)) (to_rep (first6 temp___5121))) 1) 0))))
(check-sat)
(exit)
