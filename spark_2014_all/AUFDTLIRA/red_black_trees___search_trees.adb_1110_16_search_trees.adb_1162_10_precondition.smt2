...
(assert (and (= o154 (to_rep1 (rec__search_trees__search_tree__root t__split_fields11))) (in_range3 (to_rep1 (rec__search_trees__search_tree__root t__split_fields11)))))
(assert (and (= temp___1150 (model__ (mk___rep2 f_old__split_fields2) o154)) (and (dynamic_invariant6 temp___1150 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1150 o154))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1150 o154)))) 0) (and (forall ((i6 Int)) (=> (and (<= 1 i6) (<= i6 100)) (=> (not (= i6 o154)) (ite (and (not (= (parent (mk___rep2 f_old__split_fields2) i6) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1150 (parent (mk___rep2 f_old__split_fields2) i6)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1150 i6))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1150 i6))) true)))))) (and (forall ((i6 Int)) (=> (and (<= 1 i6) (<= i6 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1150 i6))) true) (not (= i6 o154))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1150 (parent (mk___rep2 f_old__split_fields2) i6)))) (position (mk___rep2 f_old__split_fields2) i6) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1150 i6)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1150 i6)))) 0)))) (forall ((i6 Int)) (=> (and (<= 1 i6) (<= i6 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1150 i6))) true) (forall ((j15 Int)) (=> (and (<= 1 j15) (<= j15 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1150 j15))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1150 i6))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1150 j15)))) true)) (= j15 i6))))))))))))))
(assert (= o155 (select temp___1150 y1)))
(assert (= o156 (us_split_fields1 o155)))
(assert (= o157 (rec__tree_model__path_type__a o156)))
(assert (not (<= 1 o164)))
(check-sat)
(exit)
