...
(assert (forall ((k2 Int)) (=> (and (<= 1 k2) (<= k2 j2)) (= (to_rep (select v2 k2)) (to_rep (select v (ite (< 1 (- k2 1)) (- k2 1) 1)))))))
(assert (forall ((k2 Int)) (=> (and (<= (+ j2 1) k2) (<= k2 100)) (= (to_rep (select v2 k2)) (to_rep (select v k2))))))
(assert (and (and (and (and (and (=> (<= 0 10000) (in_range1 prev_value3)) (= (sorted v2) true)) (forall ((temp___181 Int)) (=> (and (<= 1 temp___181) (<= temp___181 100)) (=> (< j2 temp___181) (= (select v2 temp___181) (select v temp___181)))))) (=> (<= 0 10000) (in_range1 tmp_value2))) (=> (<= 1 100) (in_range2 j2))) (and (<= 1 j2) (<= j2 100))))
(assert (not (= j2 100)))
(assert (= j2 result5))
(assert (= j3 (+ j2 1)))
...
(assert (= (to_rep o8) tmp_value3))
(assert (= temp___1781 (store v2 j3 o8)))
(assert (dynamic_predicate temp___1781))
(assert (= o9 temp___1781))
(assert (= result8 v2))
(assert (= v3 o9))
(declare-const k2 Int)
(assert (<= (+ j3 1) k2))
(assert (<= k2 100))
(assert (not (= (to_rep (select v3 k2)) (to_rep (select v k2)))))
(check-sat)
(exit)
