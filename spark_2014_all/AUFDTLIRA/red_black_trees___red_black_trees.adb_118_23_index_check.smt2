...
(assert (<= 1 j1))
(assert (<= j1 (- i6 1)))
(assert (and (<= 0 j1) (<= j1 100)))
(assert (= o66 j1))
(assert (= o67 (select res3 o66)))
(assert (= o68 (us_split_fields11 o67)))
(assert (= o69 (rec__red_black_trees__black_count__depth o68)))
(assert (= o70 (to_rep o69)))
(assert (= o71 (ite (<= o70 (+ n2 1)) true false)))
(assert (not (<= 0 j1)))
(check-sat)
(exit)
