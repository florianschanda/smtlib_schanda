...
(assert (not (= (let ((temp___1212 (value (mk___rep to____split_discrs (us_split_fields__content to____split_fields5))))) (bool_eq (elts2 temp___1212) (to_rep1 (first4 (rt2 temp___1212))) (to_rep1 (last4 (rt2 temp___1212))) (let ((temp___1211 (value (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t1 to____split_fields1 to____split_fields2)))))) (ite (= (length3 temp___1211) 0) (elts2 tail) (concat1 (elts2 temp___1211) (to_rep1 (first4 (rt2 temp___1211))) (to_rep1 (last4 (rt2 temp___1211))) (elts2 tail) (to_rep1 (first4 (rt2 tail))) (to_rep1 (last4 (rt2 tail)))))) (to_rep1 (first (let ((temp___1211 (value (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t1 to____split_fields1 to____split_fields2)))))) (ite (= (length3 temp___1211) 0) (mk (to_rep1 (first4 (rt2 tail))) (to_rep1 (last4 (rt2 tail)))) (mk (to_rep1 (first4 (rt2 temp___1211))) (- (+ (to_rep1 (first4 (rt2 temp___1211))) (+ (ite (<= (to_rep1 (first4 (rt2 temp___1211))) (to_rep1 (last4 (rt2 temp___1211)))) (+ (- (to_rep1 (last4 (rt2 temp___1211))) (to_rep1 (first4 (rt2 temp___1211)))) 1) 0) (ite (<= (to_rep1 (first4 (rt2 tail))) (to_rep1 (last4 (rt2 tail)))) (+ (- (to_rep1 (last4 (rt2 tail))) (to_rep1 (first4 (rt2 tail)))) 1) 0))) 1)))))) (to_rep1 (last (let ((temp___1211 (value (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t1 to____split_fields1 to____split_fields2)))))) (ite (= (length3 temp___1211) 0) (mk (to_rep1 (first4 (rt2 tail))) (to_rep1 (last4 (rt2 tail)))) (mk (to_rep1 (first4 (rt2 temp___1211))) (- (+ (to_rep1 (first4 (rt2 temp___1211))) (+ (ite (<= (to_rep1 (first4 (rt2 temp___1211))) (to_rep1 (last4 (rt2 temp___1211)))) (+ (- (to_rep1 (last4 (rt2 temp___1211))) (to_rep1 (first4 (rt2 temp___1211)))) 1) 0) (ite (<= (to_rep1 (first4 (rt2 tail))) (to_rep1 (last4 (rt2 tail)))) (+ (- (to_rep1 (last4 (rt2 tail))) (to_rep1 (first4 (rt2 tail)))) 1) 0))) 1)))))))) true)))
(check-sat)
(exit)
