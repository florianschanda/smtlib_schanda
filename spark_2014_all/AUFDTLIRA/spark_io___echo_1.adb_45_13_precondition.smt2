...
(assert (and (and (and (= (is_readable standard_input2) true) (= (let ((temp___709 (name standard_input1))) (let ((temp___708 (name standard_input2))) (bool_eq (elts temp___708) (to_rep1 (first (rt temp___708))) (to_rep1 (last (rt temp___708))) (elts temp___709) (to_rep1 (first (rt temp___709))) (to_rep1 (last (rt temp___709)))))) true)) (= (let ((temp___711 (form standard_input1))) (let ((temp___710 (form standard_input2))) (bool_eq (elts temp___710) (to_rep1 (first (rt temp___710))) (to_rep1 (last (rt temp___710))) (elts temp___711) (to_rep1 (first (rt temp___711))) (to_rep1 (last (rt temp___711)))))) true)) (= (= (is_standard_file standard_input2) true) (= (is_standard_file standard_input1) true))))
