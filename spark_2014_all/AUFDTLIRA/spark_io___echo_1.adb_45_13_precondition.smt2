...
(assert (and (and (and (= (is_readable standard_input2) true) (= (let ((temp___795 (name standard_input1))) (let ((temp___794 (name standard_input2))) (bool_eq (elts temp___794) (to_rep1 (first (rt temp___794))) (to_rep1 (last (rt temp___794))) (elts temp___795) (to_rep1 (first (rt temp___795))) (to_rep1 (last (rt temp___795)))))) true)) (= (let ((temp___797 (form standard_input1))) (let ((temp___796 (form standard_input2))) (bool_eq (elts temp___796) (to_rep1 (first (rt temp___796))) (to_rep1 (last (rt temp___796))) (elts temp___797) (to_rep1 (first (rt temp___797))) (to_rep1 (last (rt temp___797)))))) true)) (= (= (is_standard_file standard_input2) true) (= (is_standard_file standard_input1) true))))
