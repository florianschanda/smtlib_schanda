...
(assert (forall ((s us_t)) (! (=> (dynamic_invariant2 s true true true) (dynamic_invariant1 (get_last s) true false true)) :pattern ((get_last s)))))
(assert (forall ((s us_t)) (! (=> (dynamic_invariant2 s true true true) (= (get_last s) (last3 (let ((temp___194 (last1 s))) (let ((temp___193 (first1 s))) (of_array1 (to_array s) temp___193 temp___194)))))) :pattern ((get_last s)))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (= (to_rep (select (temp___String_Literal_195 us_void_param) 1)) 121) (= (to_rep (select (temp___String_Literal_195 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_195 us_void_param) 3)) 117)) :pattern ((temp___String_Literal_195 us_void_param)))))
(declare-fun temp___String_Literal_197 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (= (to_rep (select (temp___String_Literal_197 us_void_param) 1)) 104) (= (to_rep (select (temp___String_Literal_197 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_197 us_void_param) 3)) 108)) (= (to_rep (select (temp___String_Literal_197 us_void_param) 4)) 108)) (= (to_rep (select (temp___String_Literal_197 us_void_param) 5)) 111)) :pattern ((temp___String_Literal_197 us_void_param)))))
(declare-fun temp___String_Literal_202 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (= (to_rep (select (temp___String_Literal_202 us_void_param) 1)) 104) (= (to_rep (select (temp___String_Literal_202 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_202 us_void_param) 3)) 108)) (= (to_rep (select (temp___String_Literal_202 us_void_param) 4)) 108)) (= (to_rep (select (temp___String_Literal_202 us_void_param) 5)) 111)) :pattern ((temp___String_Literal_202 us_void_param)))))
...
(assert (not (= (get_last (mk___t x2 (mk (to_rep1 x__first) (to_rep1 x__last)))) (get_last (mk___t y1 (mk (to_rep1 y__first) (to_rep1 y__last)))))))
(check-sat)
(exit)
