...
(assert (forall ((temp___159 Int)) (forall ((temp___160 Int)) (= (select (temp___157 temp___159) temp___160) (of_rep temp___159)))))
(define-fun default_initial_assumption ((temp___expr_155 us_rep) (temp___skip_top_level_156 Bool)) Bool (and (= (to_rep1 (rec__stack__stack__top (us_split_fields1 temp___expr_155))) 0) (= (rec__stack__stack__content (us_split_fields1 temp___expr_155)) (temp___157 0))))
...
(assert (forall ((s us_rep)) (! (dynamic_invariant1 (to__ s) true false true) :pattern ((to__ s)))))
(declare-fun is_empty (us_rep) Bool)
(declare-fun is_empty__function_guard (Bool us_rep) Bool)
(declare-fun top (us_rep) Int)
(declare-fun top__function_guard (Int us_rep) Bool)
(assert (forall ((s us_rep)) (! (=> (not (= (is_empty s) true)) (dynamic_invariant (top s) true false true)) :pattern ((top s)))))
...
(define-fun in_range6 ((x Int)) Bool (and (<= 0 x) (<= x 101)))
...
(define-fun dynamic_invariant2 ((temp___expr_257 Int) (temp___is_init_254 Bool) (temp___skip_constant_255 Bool) (temp___do_toplevel_256 Bool)) Bool (=> (or (= temp___is_init_254 true) (<= 0 101)) (in_range6 temp___expr_257)))
(declare-fun first_index__function_guard (Int us_rep1) Bool)
(define-fun dynamic_invariant3 ((temp___expr_245 Int) (temp___is_init_242 Bool) (temp___skip_constant_243 Bool) (temp___do_toplevel_244 Bool)) Bool (=> (or (= temp___is_init_242 true) (<= 1 100)) (in_range4 temp___expr_245)))
...
(define-fun dynamic_invariant4 ((temp___expr_251 Int) (temp___is_init_248 Bool) (temp___skip_constant_249 Bool) (temp___do_toplevel_250 Bool)) Bool (=> (or (= temp___is_init_248 true) (<= (- 2147483648) 2147483647)) (in_range7 temp___expr_251)))
...
(define-fun dynamic_invariant5 ((temp___expr_387 us_rep1) (temp___is_init_384 Bool) (temp___skip_constant_385 Bool) (temp___do_toplevel_386 Bool)) Bool (=> (not (= temp___skip_constant_385 true)) (in_range8 100 temp___expr_387)))
(define-fun default_initial_assumption1 ((temp___expr_389 us_rep1) (temp___skip_top_level_390 Bool)) Bool (and (= (to_rep2 (rec__list__my_lists__vector__capacity (us_split_discrs1 temp___expr_389))) 100) (=> (not (= temp___skip_top_level_390 true)) (= (is_empty1 temp___expr_389) true))))
...
(define-fun dynamic_invariant6 ((temp___expr_39 Int) (temp___is_init_36 Bool) (temp___skip_constant_37 Bool) (temp___do_toplevel_38 Bool)) Bool (=> (or (= temp___is_init_36 true) (<= 1 2147483647)) (in_range3 temp___expr_39)))
(assert (= first2 1))
...
(define-fun dynamic_invariant7 ((temp___expr_197 Int) (temp___is_init_194 Bool) (temp___skip_constant_195 Bool) (temp___do_toplevel_196 Bool)) Bool (=> (or (= temp___is_init_194 true) (<= 0 2147483647)) (in_range9 temp___expr_197)))
(assert (forall ((s us_rep)) (! (dynamic_invariant1 (to_but_top s) true false true) :pattern ((to_but_top s)))))
(assert true)
(assert true)
(define-fun dynamic_invariant8 ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= 0 100)) (in_range2 temp___expr_136)))
(define-fun dynamic_invariant9 ((temp___expr_263 Int) (temp___is_init_260 Bool) (temp___skip_constant_261 Bool) (temp___do_toplevel_262 Bool)) Bool (=> (or (= temp___is_init_260 true) (<= 0 100)) (in_range5 temp___expr_263)))
(assert (forall ((container us_rep1)) (! (let ((result (length2 container))) (and (<= result (capacity container)) (dynamic_invariant9 result true false true))) :pattern ((length2 container)))))
...
(define-fun default_initial_assumption2 ((temp___expr_297 us_rep2) (temp___skip_top_level_298 Bool)) Bool (=> (not (= temp___skip_top_level_298 true)) (= (length1 temp___expr_297) 0)))
...
(define-fun dynamic_invariant10 ((temp___expr_290 Int) (temp___is_init_287 Bool) (temp___skip_constant_288 Bool) (temp___do_toplevel_289 Bool)) Bool (=> (or (= temp___is_init_287 true) (<= 0 100)) (in_range10 temp___expr_290)))
(assert (forall ((container us_rep2)) (! (let ((result (length1 container))) (and (<= (+ 0 result) 100) (dynamic_invariant7 result true false true))) :pattern ((length1 container)))))
...
(define-fun dynamic_invariant11 ((temp___expr_284 Int) (temp___is_init_281 Bool) (temp___skip_constant_282 Bool) (temp___do_toplevel_283 Bool)) Bool (=> (or (= temp___is_init_281 true) (<= (- 2147483648) 2147483647)) (in_range11 temp___expr_284)))
(assert (forall ((container us_rep2)) (forall ((position Int)) (! (=> (and (dynamic_invariant10 position true true true) (and (<= 1 position) (<= position (last2 container)))) (dynamic_invariant11 (get container position) true false true)) :pattern ((get container position))))))
...
(declare-const temp___459 r1)
(declare-const temp___4591 (Array Int integer))
(declare-const temp___458 Int)
(declare-const o Int)
(declare-const o1 Int)
(declare-const j Int)
(declare-const temp___460 (Array Int integer))
(declare-const temp___4601 t)
...
(declare-const temp___468 capacity_range)
(declare-const temp___4681 us_main_type)
(declare-const temp___467 Int)
(declare-const temp___473 r1)
(declare-const temp___4731 (Array Int integer))
(declare-const temp___466 r1)
(declare-const temp___4661 (Array Int integer))
...
(declare-const list__reverse_list__L_2__R20b us_t)
(declare-const list__reverse_list__L_2__R16b us_t)
(declare-const temp___470 Int)
(declare-const o22 (Array Int integer))
(declare-const temp___472 us_t2)
(declare-const temp___469 Int)
(declare-const o23 (Array Int integer))
(declare-const temp___471 us_t1)
...
(declare-const result9 list__ref)
...
(assert (and (= (to_rep1 s__split_fields) 0) (= s__split_fields1 (temp___157 0))))
(assert (and (= list__reverse_list__first__assume 1) (and (in_range4 list__reverse_list__first__assume) (= list__reverse_list__first__assume 1))))
(assert (= list__reverse_list__first__assume first2))
(assert (in_range1 first2))
(assert (and (= list__reverse_list__last__assume (last2 (model__ l))) (and (in_range6 list__reverse_list__last__assume) (= list__reverse_list__last__assume (last2 (model__ l))))))
...
(assert (= i3 first2))
(assert (=> (and (<= first2 i3) (<= i3 last3)) (and (and (and (= s__split_fields temp___459) (= s__split_fields1 temp___4591)) (and (= temp___458 i3) (and (and (and (and (= o i3) (in_range4 i3)) (and (= o1 (get (model__ l) o)) (and (in_range7 o1) (= o1 (get (model__ l) o))))) (and (= (top (mk___rep s__split_fields3)) o1) (= (let ((temp___181 (to__ (mk___rep (mk___split_fields s__split_fields s__split_fields1))))) (let ((temp___180 (to_but_top (mk___rep s__split_fields3)))) (bool_eq (elts temp___180) (to_rep (first (rt temp___180))) (to_rep (last (rt temp___180))) (elts temp___181) (to_rep (first (rt temp___181))) (to_rep (last (rt temp___181)))))) true))) (and (and (= (to_rep (last (rt (to__ (mk___rep s__split_fields4))))) (+ (- i4 first2) 1)) (forall ((j2 Int)) (=> (and (<= first2 j2) (<= j2 i4)) (= (to_rep (select (elts (to__ (mk___rep s__split_fields4))) j2)) (get (model__ l) j2))))) (and (and (=> (<= first2 last3) (dynamic_property1 first2 last3 i4)) (and (<= first2 i4) (<= i4 last3))) (= i4 last3)))))) (and (and (= i8 (mk_int__ref i4)) (= s__split_fields8 (mk___split_fields__ref s__split_fields4))) (and (= i9 i4) (= s__split_fields9 s__split_fields4))))))
(assert (=> (and (<= first2 i3) (<= i3 last3)) (= i10 i8)))
(assert (=> (and (<= first2 i3) (<= i3 last3)) (= s__split_fields10 s__split_fields8)))
(assert (=> (and (<= first2 i3) (<= i3 last3)) (= i11 i9)))
(assert (=> (and (<= first2 i3) (<= i3 last3)) (= s__split_fields11 s__split_fields9)))
(assert (=> (not (and (<= first2 i3) (<= i3 last3))) (= i10 (mk_int__ref i3))))
(assert (=> (not (and (<= first2 i3) (<= i3 last3))) (= s__split_fields10 (mk___split_fields__ref (mk___split_fields s__split_fields s__split_fields1)))))
(assert (=> (not (and (<= first2 i3) (<= i3 last3))) (= i11 i3)))
(assert (=> (not (and (<= first2 i3) (<= i3 last3))) (= s__split_fields11 s__split_fields2)))
(assert (= result3 (mk_int__ref i1)))
(assert (= i12 first2))
(assert (=> (and (<= first2 i12) (<= i12 last3)) (and (and (and (= res__split_discrs (mk___split_discrs temp___468)) (= res__split_fields temp___4681)) (and (= temp___467 i12) (and (= (us_split_fields__content s__split_fields10) (mk___split_fields temp___473 temp___4731)) (and (= (us_split_fields__content s__split_fields10) (mk___split_fields temp___466 temp___4661)) (and (and (and (and (= o12 (top (mk___rep (us_split_fields__content s__split_fields10)))) (and (in_range1 o12) (= o12 (to_rep1 (rec__stack__stack__top (us_split_fields__content s__split_fields10)))))) (and (and (= (length2 (mk___rep1 res__split_discrs list__my_lists__append__2__container__fields)) (+ (length2 (mk___rep1 res__split_discrs (mk___split_fields1 res__split_fields))) 1)) (= (olt (model__ (mk___rep1 res__split_discrs (mk___split_fields1 res__split_fields))) (model__ (mk___rep1 res__split_discrs list__my_lists__append__2__container__fields))) true)) (= (get (model__ (mk___rep1 res__split_discrs list__my_lists__append__2__container__fields)) (+ (last2 (model__ (mk___rep1 res__split_discrs (mk___split_fields1 res__split_fields)))) 1)) o12))) (and (= result4 (mk___split_fields__ref1 (mk___split_fields1 res__split_fields))) (= res__split_fields2 list__my_lists__append__2__container__fields))) (and (= (let ((temp___185 (to__ (mk___rep s__split_fields12)))) (let ((temp___184 (to_but_top (mk___rep (us_split_fields__content s__split_fields10))))) (bool_eq (elts temp___184) (to_rep (first (rt temp___184))) (to_rep (last (rt temp___184))) (elts temp___185) (to_rep (first (rt temp___185))) (to_rep (last (rt temp___185)))))) true) (and (and (and (= (to_rep (last (rt (to__ (mk___rep s__split_fields13))))) (- last3 i13)) (= (bool_eq (elts (to__ (mk___rep s__split_fields13))) (to_rep (first3 (mk1 first2 (- last3 i13)))) (to_rep (last4 (mk1 first2 (- last3 i13)))) (elts (to__ (mk___rep (mk___split_fields temp___473 temp___4731)))) (to_rep (first5 (mk2 first2 (- last3 i13)))) (to_rep (last6 (mk2 first2 (- last3 i13))))) true)) (forall ((j2 Int)) (=> (and (<= first2 j2) (<= j2 i13)) (= (get (model__ (mk___rep1 res__split_discrs res__split_fields3)) j2) (get (model__ l) (+ (- (last2 (model__ l)) j2) 1)))))) (and (and (=> (<= first2 last3) (dynamic_property2 first2 last3 i13)) (and (<= first2 i13) (<= i13 last3))) (= i13 last3))))))))) (and (and (= i19 (mk_int__ref i13)) (and (= res__split_fields9 (mk___split_fields__ref1 res__split_fields3)) (= s__split_fields19 (mk___split_fields__ref s__split_fields13)))) (and (= i20 i13) (and (= res__split_fields10 res__split_fields3) (= s__split_fields20 s__split_fields13)))))))
(assert (=> (and (<= first2 i12) (<= i12 last3)) (= i21 i19)))
(assert (=> (and (<= first2 i12) (<= i12 last3)) (= res__split_fields11 res__split_fields9)))
(assert (=> (and (<= first2 i12) (<= i12 last3)) (= s__split_fields21 s__split_fields19)))
(assert (=> (and (<= first2 i12) (<= i12 last3)) (= i22 i20)))
(assert (=> (and (<= first2 i12) (<= i12 last3)) (= res__split_fields12 res__split_fields10)))
(assert (=> (and (<= first2 i12) (<= i12 last3)) (= s__split_fields22 s__split_fields20)))
(assert (=> (not (and (<= first2 i12) (<= i12 last3))) (= i21 (mk_int__ref i12))))
(assert (=> (not (and (<= first2 i12) (<= i12 last3))) (= res__split_fields11 (mk___split_fields__ref1 (mk___split_fields1 res__split_fields)))))
(assert (=> (not (and (<= first2 i12) (<= i12 last3))) (= s__split_fields21 s__split_fields10)))
(assert (=> (not (and (<= first2 i12) (<= i12 last3))) (= i22 i12)))
(assert (=> (not (and (<= first2 i12) (<= i12 last3))) (= res__split_fields12 res__split_fields1)))
(assert (=> (not (and (<= first2 i12) (<= i12 last3))) (= s__split_fields22 s__split_fields11)))
(assert (= result9 (mk_list__ref (mk___rep1 (mk___split_discrs list__reverse_list__result) (mk___split_fields1 list__reverse_list__result1)))))
(assert (= list__reverse_list__result2 (mk___rep1 res__split_discrs (us_split_fields__content1 res__split_fields11))))
...
(assert (= i30 i26))
(assert (= i29 i25))
(assert (= res__split_fields16 res__split_fields14))
(assert (= s__split_fields26 s__split_fields24))
(assert (and (= o29 (last2 (model__ l))) (and (in_range6 o29) (= o29 (last2 (model__ l))))))
(assert (= o30 (ite (<= i2 o29) true false)))
(assert (and (= o28 1) (and (in_range4 o28) (= o28 1))))
(assert (= o31 (ite (<= o28 i2) true false)))
(assert (= result10 (ite (= o31 true) o30 false)))
(assert (= result10 true))
(assert (and (= o33 (last2 (model__ l))) (and (in_range6 o33) (= o33 (last2 (model__ l))))))
(assert (= o34 (- o33 i2)))
(assert (and (= o35 o34) (in_range1 o34)))
(assert (= o36 (+ o35 1)))
(assert (and (= o37 o36) (in_range1 o36)))
(assert (and (= o38 o37) (in_range4 o37)))
(assert (and (= o39 (get (model__ (list__content list__reverse_list__result5)) o38)) (and (in_range7 o39) (= o39 (get (model__ (list__content list__reverse_list__result5)) o38)))))
(assert (not (in_range4 i2)))
(check-sat)
(exit)
