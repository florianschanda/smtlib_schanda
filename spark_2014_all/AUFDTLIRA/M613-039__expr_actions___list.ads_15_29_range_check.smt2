...
(declare-const result3 list__ref)
...
(assert (= i3 first2))
(assert (=> (and (<= first2 i3) (<= i3 last3)) (and (= s__split_fields temp___459) (= s__split_fields1 temp___4591))))
(assert (=> (and (<= first2 i3) (<= i3 last3)) (= temp___458 i3)))
(assert (=> (and (<= first2 i3) (<= i3 last3)) (and (= o i3) (in_range4 i3))))
(assert (=> (and (<= first2 i3) (<= i3 last3)) (and (= o1 (get (model__ l) o)) (and (in_range7 o1) (= o1 (get (model__ l) o))))))
(assert (=> (and (<= first2 i3) (<= i3 last3)) (and (= (top (mk___rep s__split_fields3)) o1) (= (let ((temp___181 (to__ (mk___rep (mk___split_fields s__split_fields s__split_fields1))))) (let ((temp___180 (to_but_top (mk___rep s__split_fields3)))) (bool_eq (elts temp___180) (to_rep (first (rt temp___180))) (to_rep (last (rt temp___180))) (elts temp___181) (to_rep (first (rt temp___181))) (to_rep (last (rt temp___181)))))) true))))
(assert (=> (and (<= first2 i3) (<= i3 last3)) (and (= (to_rep (last (rt (to__ (mk___rep s__split_fields4))))) (+ (- i4 first2) 1)) (forall ((j Int)) (=> (and (<= first2 j) (<= j i4)) (= (to_rep (select (elts (to__ (mk___rep s__split_fields4))) j)) (get (model__ l) j)))))))
(assert (=> (and (<= first2 i3) (<= i3 last3)) (and (=> (<= first2 last3) (dynamic_property1 first2 last3 i4)) (and (<= first2 i4) (<= i4 last3)))))
(assert (=> (and (<= first2 i3) (<= i3 last3)) (= i4 last3)))
(assert (=> (and (<= first2 i3) (<= i3 last3)) (= i5 (mk_int__ref i4))))
(assert (=> (and (<= first2 i3) (<= i3 last3)) (= s__split_fields5 (mk___split_fields__ref s__split_fields4))))
(assert (=> (and (<= first2 i3) (<= i3 last3)) (= i6 i4)))
(assert (=> (and (<= first2 i3) (<= i3 last3)) (= s__split_fields6 s__split_fields4)))
(assert (=> (and (<= first2 i3) (<= i3 last3)) (= i7 i5)))
(assert (=> (and (<= first2 i3) (<= i3 last3)) (= s__split_fields7 s__split_fields5)))
(assert (=> (and (<= first2 i3) (<= i3 last3)) (= i8 i6)))
(assert (=> (and (<= first2 i3) (<= i3 last3)) (= s__split_fields8 s__split_fields6)))
(assert (=> (not (and (<= first2 i3) (<= i3 last3))) (= i7 (mk_int__ref i3))))
(assert (=> (not (and (<= first2 i3) (<= i3 last3))) (= s__split_fields7 (mk___split_fields__ref (mk___split_fields s__split_fields s__split_fields1)))))
(assert (=> (not (and (<= first2 i3) (<= i3 last3))) (= i8 i3)))
(assert (=> (not (and (<= first2 i3) (<= i3 last3))) (= s__split_fields8 s__split_fields2)))
(assert (= result1 (mk_int__ref i1)))
(assert (= i9 first2))
(assert (=> (and (<= first2 i9) (<= i9 last3)) (and (= res__split_discrs (mk___split_discrs temp___468)) (= res__split_fields temp___4681))))
(assert (=> (and (<= first2 i9) (<= i9 last3)) (= temp___467 i9)))
(assert (=> (and (<= first2 i9) (<= i9 last3)) (= (us_split_fields__content s__split_fields7) (mk___split_fields temp___473 temp___4731))))
(assert (=> (and (<= first2 i9) (<= i9 last3)) (= (us_split_fields__content s__split_fields7) (mk___split_fields temp___466 temp___4661))))
(assert (=> (and (<= first2 i9) (<= i9 last3)) (and (= o2 (top (mk___rep (us_split_fields__content s__split_fields7)))) (and (in_range1 o2) (= o2 (to_rep1 (rec__stack__stack__top (us_split_fields__content s__split_fields7))))))))
(assert (=> (and (<= first2 i9) (<= i9 last3)) (and (and (= (length2 (mk___rep1 res__split_discrs list__my_lists__append__2__container__fields)) (+ (length2 (mk___rep1 res__split_discrs (mk___split_fields1 res__split_fields))) 1)) (= (olt (model__ (mk___rep1 res__split_discrs (mk___split_fields1 res__split_fields))) (model__ (mk___rep1 res__split_discrs list__my_lists__append__2__container__fields))) true)) (= (get (model__ (mk___rep1 res__split_discrs list__my_lists__append__2__container__fields)) (+ (last2 (model__ (mk___rep1 res__split_discrs (mk___split_fields1 res__split_fields)))) 1)) o2))))
(assert (=> (and (<= first2 i9) (<= i9 last3)) (= result2 res__split_fields12)))
(assert (=> (and (<= first2 i9) (<= i9 last3)) (= res__split_fields2 list__my_lists__append__2__container__fields)))
(assert (=> (and (<= first2 i9) (<= i9 last3)) (= (let ((temp___185 (to__ (mk___rep s__split_fields9)))) (let ((temp___184 (to_but_top (mk___rep (us_split_fields__content s__split_fields7))))) (bool_eq (elts temp___184) (to_rep (first (rt temp___184))) (to_rep (last (rt temp___184))) (elts temp___185) (to_rep (first (rt temp___185))) (to_rep (last (rt temp___185)))))) true)))
(assert (=> (and (<= first2 i9) (<= i9 last3)) (and (and (= (to_rep (last (rt (to__ (mk___rep s__split_fields10))))) (- last3 i10)) (= (bool_eq (elts (to__ (mk___rep s__split_fields10))) (to_rep (first3 (mk1 first2 (- last3 i10)))) (to_rep (last4 (mk1 first2 (- last3 i10)))) (elts (to__ (mk___rep (mk___split_fields temp___473 temp___4731)))) (to_rep (first5 (mk2 first2 (- last3 i10)))) (to_rep (last6 (mk2 first2 (- last3 i10))))) true)) (forall ((j Int)) (=> (and (<= first2 j) (<= j i10)) (= (get (model__ (mk___rep1 res__split_discrs res__split_fields3)) j) (get (model__ l) (+ (- (last2 (model__ l)) j) 1))))))))
(assert (=> (and (<= first2 i9) (<= i9 last3)) (and (=> (<= first2 last3) (dynamic_property2 first2 last3 i10)) (and (<= first2 i10) (<= i10 last3)))))
(assert (=> (and (<= first2 i9) (<= i9 last3)) (= i10 last3)))
(assert (=> (and (<= first2 i9) (<= i9 last3)) (= i11 (mk_int__ref i10))))
(assert (=> (and (<= first2 i9) (<= i9 last3)) (= res__split_fields4 (mk___split_fields__ref1 res__split_fields3))))
(assert (=> (and (<= first2 i9) (<= i9 last3)) (= s__split_fields11 (mk___split_fields__ref s__split_fields10))))
(assert (=> (and (<= first2 i9) (<= i9 last3)) (= i12 i10)))
(assert (=> (and (<= first2 i9) (<= i9 last3)) (= res__split_fields5 res__split_fields3)))
(assert (=> (and (<= first2 i9) (<= i9 last3)) (= s__split_fields12 s__split_fields10)))
(assert (=> (and (<= first2 i9) (<= i9 last3)) (= i13 i11)))
(assert (=> (and (<= first2 i9) (<= i9 last3)) (= res__split_fields6 res__split_fields4)))
(assert (=> (and (<= first2 i9) (<= i9 last3)) (= s__split_fields13 s__split_fields11)))
(assert (=> (and (<= first2 i9) (<= i9 last3)) (= i14 i12)))
(assert (=> (and (<= first2 i9) (<= i9 last3)) (= res__split_fields7 res__split_fields5)))
(assert (=> (and (<= first2 i9) (<= i9 last3)) (= s__split_fields14 s__split_fields12)))
(assert (=> (not (and (<= first2 i9) (<= i9 last3))) (= i13 (mk_int__ref i9))))
(assert (=> (not (and (<= first2 i9) (<= i9 last3))) (= res__split_fields6 res__split_fields12)))
(assert (=> (not (and (<= first2 i9) (<= i9 last3))) (= s__split_fields13 s__split_fields7)))
(assert (=> (not (and (<= first2 i9) (<= i9 last3))) (= i14 i9)))
(assert (=> (not (and (<= first2 i9) (<= i9 last3))) (= res__split_fields7 res__split_fields1)))
(assert (=> (not (and (<= first2 i9) (<= i9 last3))) (= s__split_fields14 s__split_fields8)))
(assert (= result3 (mk_list__ref (mk___rep1 (mk___split_discrs list__reverse_list__result) (mk___split_fields1 list__reverse_list__result1)))))
...
(assert (and (= o4 (last2 (model__ l))) (and (in_range6 o4) (= o4 (last2 (model__ l))))))
(assert (= o5 (ite (<= i2 o4) true false)))
(assert (and (= o3 1) (and (in_range4 o3) (= o3 1))))
(assert (= o6 (ite (<= o3 i2) true false)))
(assert (= result4 (ite (= o6 true) o5 false)))
(assert (= result4 true))
(assert (and (= o7 (last2 (model__ l))) (and (in_range6 o7) (= o7 (last2 (model__ l))))))
(assert (= o8 (- o7 i2)))
(assert (and (= o9 o8) (in_range1 o8)))
(assert (= o10 (+ o9 1)))
(assert (and (= o11 o10) (in_range1 o10)))
(assert (and (= o12 o11) (in_range4 o11)))
(assert (and (= o13 (get (model__ (list__content list__reverse_list__result5)) o12)) (and (in_range7 o13) (= o13 (get (model__ (list__content list__reverse_list__result5)) o12)))))
