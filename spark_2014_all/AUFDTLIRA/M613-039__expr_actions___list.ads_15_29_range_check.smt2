...
(define-fun dynamic_invariant2 ((temp___expr_296 Int) (temp___is_init_292 Bool) (temp___skip_constant_293 Bool) (temp___do_toplevel_294 Bool) (temp___do_typ_inv_295 Bool)) Bool (=> (or (= temp___is_init_292 true) (<= 0 101)) (in_range6 temp___expr_296)))
(declare-fun first_index__function_guard (Int us_rep1) Bool)
(define-fun dynamic_invariant3 ((temp___expr_282 Int) (temp___is_init_278 Bool) (temp___skip_constant_279 Bool) (temp___do_toplevel_280 Bool) (temp___do_typ_inv_281 Bool)) Bool (=> (or (= temp___is_init_278 true) (<= 1 100)) (in_range4 temp___expr_282)))
...
(define-fun dynamic_invariant6 ((temp___expr_46 Int) (temp___is_init_42 Bool) (temp___skip_constant_43 Bool) (temp___do_toplevel_44 Bool) (temp___do_typ_inv_45 Bool)) Bool (=> (or (= temp___is_init_42 true) (<= 1 2147483647)) (in_range3 temp___expr_46)))
(assert (= first2 1))
...
(assert true)
(assert true)
(define-fun dynamic_invariant8 ((temp___expr_159 Int) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool) (temp___do_typ_inv_158 Bool)) Bool (=> (or (= temp___is_init_155 true) (<= 0 100)) (in_range2 temp___expr_159)))
...
(define-fun dynamic_invariant9 ((temp___expr_303 Int) (temp___is_init_299 Bool) (temp___skip_constant_300 Bool) (temp___do_toplevel_301 Bool) (temp___do_typ_inv_302 Bool)) Bool (=> (or (= temp___is_init_299 true) (<= 0 100)) (in_range5 temp___expr_303)))
...
(declare-const temp___505 r1)
(declare-const temp___5051 (Array Int integer))
(declare-const temp___504 Int)
(declare-const o Int)
(declare-const o1 Int)
(declare-const temp___514 capacity_range)
(declare-const temp___5141 us_main_type)
(declare-const temp___513 Int)
(declare-const temp___519 r1)
(declare-const temp___5191 (Array Int integer))
(declare-const temp___512 r1)
(declare-const temp___5121 (Array Int integer))
...
(assert (and (= (to_rep1 s__split_fields) 0) (= s__split_fields1 (temp___183 0))))
...
(assert (= i3 first2))
(assert (=> (and (<= first2 i3) (<= i3 last3)) (and (= s__split_fields temp___505) (= s__split_fields1 temp___5051))))
(assert (=> (and (<= first2 i3) (<= i3 last3)) (= temp___504 i3)))
...
(assert (= i9 first2))
(assert (=> (and (<= first2 i9) (<= i9 last3)) (and (= res__split_discrs (mk___split_discrs temp___514)) (= res__split_fields temp___5141))))
(assert (=> (and (<= first2 i9) (<= i9 last3)) (= temp___513 i9)))
(assert (=> (and (<= first2 i9) (<= i9 last3)) (= (us_split_fields__content s__split_fields7) (mk___split_fields temp___519 temp___5191))))
(assert (=> (and (<= first2 i9) (<= i9 last3)) (= (us_split_fields__content s__split_fields7) (mk___split_fields temp___512 temp___5121))))
...
(assert (=> (and (<= first2 i9) (<= i9 last3)) (= (let ((temp___212 (to__ (mk___rep s__split_fields9)))) (let ((temp___211 (to_but_top (mk___rep (us_split_fields__content s__split_fields7))))) (bool_eq (elts temp___211) (to_rep (first (rt temp___211))) (to_rep (last (rt temp___211))) (elts temp___212) (to_rep (first (rt temp___212))) (to_rep (last (rt temp___212)))))) true)))
(assert (=> (and (<= first2 i9) (<= i9 last3)) (and (and (= (to_rep (last (rt (to__ (mk___rep s__split_fields10))))) (- last3 i10)) (= (bool_eq (elts (to__ (mk___rep s__split_fields10))) (to_rep (first3 (mk1 first2 (- last3 i10)))) (to_rep (last4 (mk1 first2 (- last3 i10)))) (elts (to__ (mk___rep (mk___split_fields temp___519 temp___5191)))) (to_rep (first5 (mk2 first2 (- last3 i10)))) (to_rep (last6 (mk2 first2 (- last3 i10))))) true)) (forall ((j Int)) (=> (and (<= first2 j) (<= j i10)) (= (get (model__ (mk___rep1 res__split_discrs res__split_fields3)) j) (get (model__ l) (+ (- (last2 (model__ l)) j) 1))))))))
