...
(declare-const temp___911 natural_index)
(declare-const temp___9111 natural_index)
(declare-const temp___9112 (Array Int character))
(declare-const temp___9113 t)
(assert (and (= (to_rep temp___9111) 0) (let ((temp___913 (temp_____aggregate_def_530 32 1 (to_rep temp___911)))) (and (= temp___9112 (elts1 temp___913)) (= temp___9113 (mk (to_rep2 (first2 (rt1 temp___913))) (to_rep2 (last2 (rt1 temp___913)))))))))
(assert (not (dynamic_predicate (mk___rep (mk___split_discrs temp___911) (mk___split_fields temp___9111 (mk___t temp___9112 temp___9113))))))
(check-sat)
(exit)
