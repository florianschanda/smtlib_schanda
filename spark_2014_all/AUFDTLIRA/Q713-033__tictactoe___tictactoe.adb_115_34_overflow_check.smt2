...
(assert (not (= (to_rep1 (select (select my_board (to_rep2 (rec__tictactoe__position__x p__split_fields3))) (to_rep2 (rec__tictactoe__position__y p__split_fields3)))) 2)))
(assert (= (to_rep1 (select (select my_board (to_rep2 (rec__tictactoe__position__x p__split_fields3))) (to_rep2 (rec__tictactoe__position__y p__split_fields3)))) 1))
(assert (not (in_range1 (+ score1 10))))
(check-sat)
(exit)
