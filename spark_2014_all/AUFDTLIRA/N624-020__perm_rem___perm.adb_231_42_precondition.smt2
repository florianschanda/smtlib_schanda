...
(assert (and (= (mk___t o41 o42) (remove (mk___t o38 o39) o40)) (and (dynamic_invariant2 (mk___t o41 o42) true false true) (and (= (invariant__ (mk___t o41 o42)) true) (and (= (to_rep2 (last o42)) (- (to_rep2 (last o39)) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- o40 1))) (= (to_rep (select o38 k1)) (to_rep (select o41 k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ o40 1) k1) (<= k1 (to_rep2 (last o39)))) (= (to_rep (select o38 k1)) (to_rep (select o41 (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= o40 k1) (<= k1 (- (to_rep2 (last o39)) 1))) (= (to_rep (select o38 (+ k1 1))) (to_rep (select o41 k1))))))))))))
(assert (and (= o35 (- (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) 1)) (in_range4 (- (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) 1))))
(assert (and (= o32 ia3) (in_range4 ia3)))
