...
(assert (= (find_root (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))) i l) l))
(assert (not (not (= (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i)) v))))
(check-sat)
(exit)
