...
(assert (<= 0 i1))
(assert (<= i1 (- length1 1)))
(assert (forall ((j3 Int)) (=> (and (<= (to_rep b__first) j3) (<= j3 (to_rep b__last))) (and (=> (and (<= b_first j3) (<= j3 (- (+ b_first i2) 1))) (= (to_rep (select b2 j3)) (to_rep (select (elts a) (- (+ a_first j3) b_first))))) (=> (=> (<= b_first j3) (not (<= j3 (- (+ b_first i2) 1)))) (= (to_rep (select b2 j3)) (to_rep (select b j3))))))))
...
(assert (and (<= (to_rep (first (rt a))) temp___237) (<= temp___237 (to_rep (last (rt a))))))
(assert (= o24 temp___237))
(assert (= o25 (select (elts a) o24)))
(assert (= o26 (to_rep o25)))
(assert (= (to_rep o27) o26))
(assert (and (= temp___238 (+ b_first i2)) (in_range1 (+ b_first i2))))
(assert (and (<= (to_rep b__first) temp___238) (<= temp___238 (to_rep b__last))))
(assert (= o28 temp___238))
(assert (= o29 (store b2 o28 o27)))
(assert (= b2 result3))
(assert (= b3 o29))
(assert (<= (to_rep b__first) j1))
(assert (<= j1 (to_rep b__last)))
(assert (and (= o40 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= o41 (+ b_first o40)))
(assert (and (= o42 o41) (in_range1 o41)))
(assert (= o43 (- o42 1)))
(assert (= o44 (ite (<= j1 o43) true false)))
(assert (= o45 (ite (<= b_first j1) o44 false)))
(assert (= result4 (ite (not (= o45 true)) true false)))
(assert (=> (= result4 true) (and (<= (to_rep b__first) j1) (<= j1 (to_rep b__last)))))
(assert (=> (= result4 true) (= o48 j1)))
(assert (=> (= result4 true) (= o49 (select b o48))))
(assert (=> (= result4 true) (= o50 (to_rep o49))))
(assert (=> (= result4 true) (and (<= (to_rep b__first) j1) (<= j1 (to_rep b__last)))))
(assert (=> (= result4 true) (= o46 j1)))
(assert (=> (= result4 true) (= o47 (select b3 o46))))
(assert (=> (= result4 true) (= o51 (to_rep o47))))
(assert (=> (= result4 true) (= o52 (ite (= o51 o50) true false))))
(assert (=> (not (= result4 true)) (= o52 (of_int 1))))
(assert (and (= o30 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= o31 (+ b_first o30)))
(assert (and (= o32 o31) (in_range1 o31)))
(assert (= o33 (- o32 1)))
(assert (= o34 (ite (<= j1 o33) true false)))
(assert (= result5 (ite (<= b_first j1) o34 false)))
(assert (= result5 true))
(assert (and (= o35 (+ a_first j1)) (in_range1 (+ a_first j1))))
(assert (= o36 (- o35 b_first)))
