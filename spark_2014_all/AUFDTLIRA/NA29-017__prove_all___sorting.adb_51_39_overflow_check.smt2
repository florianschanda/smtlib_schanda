...
(assert (and (= temp___266 (+ a_first i2)) (in_range1 (+ a_first i2))))
(assert (and (<= (to_rep (first (rt a))) temp___266) (<= temp___266 (to_rep (last (rt a))))))
(assert (= o temp___266))
(assert (= o1 (select (elts a) o)))
(assert (= o2 (to_rep o1)))
(assert (= (to_rep o3) o2))
(assert (and (= temp___267 (+ b_first i2)) (in_range1 (+ b_first i2))))
(assert (and (<= (to_rep b__first) temp___267) (<= temp___267 (to_rep b__last))))
(assert (= o4 temp___267))
