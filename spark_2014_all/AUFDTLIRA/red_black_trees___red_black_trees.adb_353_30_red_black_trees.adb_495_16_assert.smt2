...
(assert (=> (and (<= 1 (let ((subject n1)) n11)) (<= (let ((subject n1)) n11) 100)) (= temp___751 (let ((subject n1)) n11))))
(assert (=> (and (<= 1 (let ((subject n1)) n11)) (<= (let ((subject n1)) n11) 100)) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (and (and (and (= (rec__tree_model__path_type__k (us_split_fields7 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c106b))) i))) true) (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c106b) i)))) (let ((subject n1)) n12))) (not (= i y3))) (not (= i c108b))) (= (eq (select (nb_blacks c107b) i) (select (nb_blacks c106b) i)) true))))))
...
(assert (=> (and (<= 1 (let ((subject n1)) n11)) (<= (let ((subject n1)) n11) 100)) (and (=> (<= 1 100) (in_range4 (let ((subject n1)) n12))) (and (<= 1 (let ((subject n1)) n12)) (<= (let ((subject n1)) n12) 100)))))
