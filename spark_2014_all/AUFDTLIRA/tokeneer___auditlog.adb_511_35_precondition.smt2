...
(define-fun in_range8 ((x Int)) Bool (and (<= 1 x) (<= x 21)))
...
(define-fun in_range9 ((x Int)) Bool (and (<= 0 x) (<= x 43)))
(declare-fun attr__ATTRIBUTE_IMAGE9 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check9 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE9 (us_image) Int)
(declare-fun user_eq10 (elementt elementt) Bool)
(declare-const dummy10 elementt)
...
(define-fun dynamic_invariant ((temp___expr_483 Int) (temp___is_init_480 Bool) (temp___skip_constant_481 Bool) (temp___do_toplevel_482 Bool)) Bool (=> (or (= temp___is_init_480 true) (<= 0 43)) (in_range9 temp___expr_483)))
(declare-sort severityt 0)
(define-fun in_range10 ((x Int)) Bool (and (<= 0 x) (<= x 2)))
(declare-fun attr__ATTRIBUTE_IMAGE10 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check10 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE10 (us_image) Int)
(declare-fun user_eq11 (severityt severityt) Bool)
(declare-const dummy11 severityt)
...
(define-fun dynamic_invariant1 ((temp___expr_493 Int) (temp___is_init_490 Bool) (temp___skip_constant_491 Bool) (temp___do_toplevel_492 Bool)) Bool (=> (or (= temp___is_init_490 true) (<= 0 2)) (in_range10 temp___expr_493)))
...
(define-fun in_range13 ((x Int)) Bool (and (<= 1 x) (<= x 20)))
(declare-fun attr__ATTRIBUTE_IMAGE13 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check13 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE13 (us_image) Int)
(declare-fun user_eq15 (elementtexti elementtexti) Bool)
(declare-const dummy15 elementtexti)
...
(declare-fun nameoftype (Int) (Array Int character))
(declare-fun nameoftype__function_guard ((Array Int character) Int) Bool)
(assert true)
(declare-fun temp___String_Literal_1621 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_1621 us_void_param) 1)) 44) (= (to_rep (select (temp___String_Literal_1621 us_void_param) 2)) 32)) :pattern ((temp___String_Literal_1621 us_void_param)))))
(declare-fun temp___String_Literal_1622 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_1622 us_void_param) 1)) 44) (= (to_rep (select (temp___String_Literal_1622 us_void_param) 2)) 32)) :pattern ((temp___String_Literal_1622 us_void_param)))))
(declare-fun temp___String_Literal_1623 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_1623 us_void_param) 1)) 44) (= (to_rep (select (temp___String_Literal_1623 us_void_param) 2)) 32)) :pattern ((temp___String_Literal_1623 us_void_param)))))
(declare-fun temp___String_Literal_1624 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_1624 us_void_param) 1)) 44) (= (to_rep (select (temp___String_Literal_1624 us_void_param) 2)) 32)) :pattern ((temp___String_Literal_1624 us_void_param)))))
(declare-fun temp___String_Literal_1625 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_1625 us_void_param) 1)) 44) (= (to_rep (select (temp___String_Literal_1625 us_void_param) 2)) 32)) :pattern ((temp___String_Literal_1625 us_void_param)))))
...
(define-fun dynamic_invariant6 ((temp___expr_1265 Int) (temp___is_init_1262 Bool) (temp___skip_constant_1263 Bool) (temp___do_toplevel_1264 Bool)) Bool (=> (or (= temp___is_init_1262 true) (<= 1 20)) (in_range13 temp___expr_1265)))
(define-fun dynamic_invariant7 ((temp___expr_499 Int) (temp___is_init_496 Bool) (temp___skip_constant_497 Bool) (temp___do_toplevel_498 Bool)) Bool (=> (or (= temp___is_init_496 true) (<= 1 150)) (in_range11 temp___expr_499)))
(define-fun dynamic_invariant8 ((temp___expr_514 Int) (temp___is_init_511 Bool) (temp___skip_constant_512 Bool) (temp___do_toplevel_513 Bool)) Bool (=> (or (= temp___is_init_511 true) (<= 1 50)) (in_range12 temp___expr_514)))
(define-fun dynamic_invariant9 ((temp___expr_393 Int) (temp___is_init_390 Bool) (temp___skip_constant_391 Bool) (temp___do_toplevel_392 Bool)) Bool (=> (or (= temp___is_init_390 true) (<= 1901 2099)) (in_range4 temp___expr_393)))
(define-fun dynamic_invariant10 ((temp___expr_399 Int) (temp___is_init_396 Bool) (temp___skip_constant_397 Bool) (temp___do_toplevel_398 Bool)) Bool (=> (or (= temp___is_init_396 true) (<= 1 12)) (in_range5 temp___expr_399)))
(define-fun dynamic_invariant11 ((temp___expr_405 Int) (temp___is_init_402 Bool) (temp___skip_constant_403 Bool) (temp___do_toplevel_404 Bool)) Bool (=> (or (= temp___is_init_402 true) (<= 1 31)) (in_range6 temp___expr_405)))
(define-fun dynamic_invariant12 ((temp___expr_433 Int) (temp___is_init_430 Bool) (temp___skip_constant_431 Bool) (temp___do_toplevel_432 Bool)) Bool (=> (or (= temp___is_init_430 true) (<= 0 86399999)) (in_range7 temp___expr_433)))
(define-fun dynamic_invariant13 ((temp___expr_449 Int) (temp___is_init_446 Bool) (temp___skip_constant_447 Bool) (temp___do_toplevel_448 Bool)) Bool (=> (or (= temp___is_init_446 true) (<= 1 21)) (in_range8 temp___expr_449)))
(declare-const now__split_fields yearst)
(declare-const now__split_fields1 monthst)
(declare-const now__split_fields2 dayst)
(declare-const now__split_fields3 millisecst)
(declare-const temp___1620 yearst)
(declare-const temp___16201 monthst)
(declare-const temp___16202 dayst)
(declare-const temp___16203 millisecst)
...
(declare-const now__split_fields4 yearst)
(declare-const now__split_fields5 monthst)
(declare-const now__split_fields6 dayst)
(declare-const now__split_fields7 millisecst)
(declare-const thefile us_rep1)
(declare-const ok Bool)
(declare-const thefile1 us_rep1)
(declare-const ok1 Bool)
(assert (in_range9 elementid))
(assert (in_range10 severity))
(assert (= result now__split_fields))
(assert (= result1 now__split_fields1))
(assert (= result2 now__split_fields2))
(assert (= result3 now__split_fields3))
(assert (= temp___1620 now__split_fields4))
(assert (= temp___16201 now__split_fields5))
(assert (= temp___16202 now__split_fields6))
(assert (= temp___16203 now__split_fields7))
(assert (=> (= ok true) (= ok1 ok)))
(assert (=> (= ok true) (= thefile1 thefile)))
(assert (= ok1 true))
(assert (= o (printtime (mk___rep (mk___split_fields now__split_fields4 now__split_fields5 now__split_fields6 now__split_fields7)))))
(assert (= o1 o))
(assert (= o2 (mk 1 21)))
(assert (not true))
(check-sat)
