...
(define-fun dynamic_invariant ((temp___expr_538 Int) (temp___is_init_534 Bool) (temp___skip_constant_535 Bool) (temp___do_toplevel_536 Bool) (temp___do_typ_inv_537 Bool)) Bool (=> (or (= temp___is_init_534 true) (<= 0 43)) (in_range9 temp___expr_538)))
...
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_1775 us_void_param) 1)) 44) (= (to_rep (select (temp___String_Literal_1775 us_void_param) 2)) 32)) :pattern ((temp___String_Literal_1775 us_void_param)))))
(declare-fun temp___String_Literal_1776 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_1776 us_void_param) 1)) 44) (= (to_rep (select (temp___String_Literal_1776 us_void_param) 2)) 32)) :pattern ((temp___String_Literal_1776 us_void_param)))))
(declare-fun temp___String_Literal_1777 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_1777 us_void_param) 1)) 44) (= (to_rep (select (temp___String_Literal_1777 us_void_param) 2)) 32)) :pattern ((temp___String_Literal_1777 us_void_param)))))
(declare-fun temp___String_Literal_1778 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_1778 us_void_param) 1)) 44) (= (to_rep (select (temp___String_Literal_1778 us_void_param) 2)) 32)) :pattern ((temp___String_Literal_1778 us_void_param)))))
(declare-fun temp___String_Literal_1779 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_1779 us_void_param) 1)) 44) (= (to_rep (select (temp___String_Literal_1779 us_void_param) 2)) 32)) :pattern ((temp___String_Literal_1779 us_void_param)))))
...
(define-fun dynamic_invariant6 ((temp___expr_1415 Int) (temp___is_init_1411 Bool) (temp___skip_constant_1412 Bool) (temp___do_toplevel_1413 Bool) (temp___do_typ_inv_1414 Bool)) Bool (=> (or (= temp___is_init_1411 true) (<= 1 20)) (in_range13 temp___expr_1415)))
...
(define-fun dynamic_invariant13 ((temp___expr_500 Int) (temp___is_init_496 Bool) (temp___skip_constant_497 Bool) (temp___do_toplevel_498 Bool) (temp___do_typ_inv_499 Bool)) Bool (=> (or (= temp___is_init_496 true) (<= 1 21)) (in_range8 temp___expr_500)))
(assert (not true))
(check-sat)
(exit)
