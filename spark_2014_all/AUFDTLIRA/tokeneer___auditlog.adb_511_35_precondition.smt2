...
(define-fun dynamic_invariant ((temp___expr_538 Int) (temp___is_init_534 Bool) (temp___skip_constant_535 Bool) (temp___do_toplevel_536 Bool) (temp___do_typ_inv_537 Bool)) Bool (=> (or (= temp___is_init_534 true) (<= 0 43)) (in_range8 temp___expr_538)))
(assert true)
...
(define-fun dynamic_invariant1 ((temp___expr_549 Int) (temp___is_init_545 Bool) (temp___skip_constant_546 Bool) (temp___do_toplevel_547 Bool) (temp___do_typ_inv_548 Bool)) Bool (=> (or (= temp___is_init_545 true) (<= 0 2)) (in_range10 temp___expr_549)))
...
(declare-fun user_eq13 (descriptioni descriptioni) Bool)
(declare-const dummy13 descriptioni)
...
(declare-fun user_eq14 (usertexti usertexti) Bool)
(declare-const dummy14 usertexti)
...
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_1768 us_void_param) 1)) 44) (= (to_rep (select (temp___String_Literal_1768 us_void_param) 2)) 32)) :pattern ((temp___String_Literal_1768 us_void_param)))))
(declare-fun temp___String_Literal_1769 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_1769 us_void_param) 1)) 44) (= (to_rep (select (temp___String_Literal_1769 us_void_param) 2)) 32)) :pattern ((temp___String_Literal_1769 us_void_param)))))
(declare-fun temp___String_Literal_1770 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_1770 us_void_param) 1)) 44) (= (to_rep (select (temp___String_Literal_1770 us_void_param) 2)) 32)) :pattern ((temp___String_Literal_1770 us_void_param)))))
(declare-fun temp___String_Literal_1771 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_1771 us_void_param) 1)) 44) (= (to_rep (select (temp___String_Literal_1771 us_void_param) 2)) 32)) :pattern ((temp___String_Literal_1771 us_void_param)))))
(declare-fun temp___String_Literal_1772 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_1772 us_void_param) 1)) 44) (= (to_rep (select (temp___String_Literal_1772 us_void_param) 2)) 32)) :pattern ((temp___String_Literal_1772 us_void_param)))))
...
(define-fun dynamic_invariant6 ((temp___expr_1408 Int) (temp___is_init_1404 Bool) (temp___skip_constant_1405 Bool) (temp___do_toplevel_1406 Bool) (temp___do_typ_inv_1407 Bool)) Bool (=> (or (= temp___is_init_1404 true) (<= 1 20)) (in_range13 temp___expr_1408)))
(define-fun dynamic_invariant7 ((temp___expr_556 Int) (temp___is_init_552 Bool) (temp___skip_constant_553 Bool) (temp___do_toplevel_554 Bool) (temp___do_typ_inv_555 Bool)) Bool (=> (or (= temp___is_init_552 true) (<= 1 150)) (in_range11 temp___expr_556)))
(define-fun dynamic_invariant8 ((temp___expr_573 Int) (temp___is_init_569 Bool) (temp___skip_constant_570 Bool) (temp___do_toplevel_571 Bool) (temp___do_typ_inv_572 Bool)) Bool (=> (or (= temp___is_init_569 true) (<= 1 50)) (in_range12 temp___expr_573)))
(define-fun dynamic_invariant9 ((temp___expr_436 Int) (temp___is_init_432 Bool) (temp___skip_constant_433 Bool) (temp___do_toplevel_434 Bool) (temp___do_typ_inv_435 Bool)) Bool (=> (or (= temp___is_init_432 true) (<= 1901 2099)) (in_range4 temp___expr_436)))
(define-fun dynamic_invariant10 ((temp___expr_443 Int) (temp___is_init_439 Bool) (temp___skip_constant_440 Bool) (temp___do_toplevel_441 Bool) (temp___do_typ_inv_442 Bool)) Bool (=> (or (= temp___is_init_439 true) (<= 1 12)) (in_range5 temp___expr_443)))
(define-fun dynamic_invariant11 ((temp___expr_450 Int) (temp___is_init_446 Bool) (temp___skip_constant_447 Bool) (temp___do_toplevel_448 Bool) (temp___do_typ_inv_449 Bool)) Bool (=> (or (= temp___is_init_446 true) (<= 1 31)) (in_range6 temp___expr_450)))
(define-fun dynamic_invariant12 ((temp___expr_482 Int) (temp___is_init_478 Bool) (temp___skip_constant_479 Bool) (temp___do_toplevel_480 Bool) (temp___do_typ_inv_481 Bool)) Bool (=> (or (= temp___is_init_478 true) (<= 0 86399999)) (in_range7 temp___expr_482)))
(define-fun dynamic_invariant13 ((temp___expr_500 Int) (temp___is_init_496 Bool) (temp___skip_constant_497 Bool) (temp___do_toplevel_498 Bool) (temp___do_typ_inv_499 Bool)) Bool (=> (or (= temp___is_init_496 true) (<= 1 21)) (in_range9 temp___expr_500)))
(assert (not true))
(check-sat)
(exit)
