...
(assert (= (invariant__ (mk___rep4 (mk___split_fields4 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)) t__split_fields4))) true))
(assert (and (= result37 (contains1 (mk___rep4 (mk___split_fields4 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)) t__split_fields4)) v)) (and (= (= result37 true) (= (contains2 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)) v) true)) (= (= result37 true) (= (contains (values1 (mk___rep4 (mk___split_fields4 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)) t__split_fields4))) v) true)))))
(assert (not (= result37 true)))
(assert (= (invariant__ (mk___rep4 (us_split_fields__content4 t__split_fields39))) true))
(assert (and (= o133 (values1 (mk___rep4 (us_split_fields__content4 t__split_fields39)))) (and (= o133 (values (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields39)))) (=> (= (size2 (mk___rep4 (us_split_fields__content4 t__split_fields39))) 0) (= (is_empty o133) true)))))
