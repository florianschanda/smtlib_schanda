...
(assert (and (= o78 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (in_range7 o78)))
(assert (= result13 (ite (in_range4 o78) true false)))
(assert (=> (= result13 true) (and (= o74 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range6 o74))))
(assert (=> (= result13 true) (= result14 (ite (< j o74) true false))))
(assert (=> (= result13 true) (=> (= result14 true) (and (= o75 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result13 true) (=> (= result14 true) (and (= o76 (get (rec__list_allocator__m__t__allocated model____split_fields3) o75)) (in_range7 o76)))))
(assert (=> (= result13 true) (=> (not (= result14 true)) (= o76 0))))
(assert (=> (= result13 true) (and (= temp___429 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (in_range7 temp___429))))
(assert (=> (= result13 true) (and (<= 1 temp___429) (<= temp___429 3))))
(assert (=> (= result13 true) (= o70 temp___429)))
...
(assert (=> (= result12 true) (=> (< 1 j) (and (= o68 (get (rec__list_allocator__m__t__allocated model____split_fields3) o67)) (in_range7 o68)))))
(assert (=> (= result12 true) (=> (not (< 1 j)) (= o68 0))))
(assert (=> (= result12 true) (and (= temp___430 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (in_range7 temp___430))))
(assert (=> (= result12 true) (and (<= 1 temp___430) (<= temp___430 3))))
(assert (=> (= result12 true) (= o63 temp___430)))
...
(assert (not (= j k)))
(assert (and (= o62 (get (rec__list_allocator__m__t__allocated model____split_fields3) k)) (in_range7 o62)))
(assert (not (<= 1 j)))
(check-sat)
(exit)
