...
(assert (=> (= result13 true) (and (= temp___462 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (in_range7 temp___462))))
(assert (=> (= result13 true) (and (<= 1 temp___462) (<= temp___462 3))))
(assert (=> (= result13 true) (= o70 temp___462)))
...
(assert (=> (= result12 true) (and (= temp___463 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (in_range7 temp___463))))
(assert (=> (= result12 true) (and (<= 1 temp___463) (<= temp___463 3))))
(assert (=> (= result12 true) (= o63 temp___463)))
