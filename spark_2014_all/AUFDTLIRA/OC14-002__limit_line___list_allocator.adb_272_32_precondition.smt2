...
(assert (=> (= result25 true) (=> (< 1 j4) (and (= o105 (- j4 1)) (in_range2 (- j4 1))))))
(assert (=> (= result25 true) (=> (< 1 j4) (and (= o106 (get (rec__list_allocator__m__t__allocated model____split_fields4) o105)) (in_range7 o106)))))
(assert (=> (= result25 true) (=> (not (< 1 j4)) (= o106 0))))
(assert (=> (= result25 true) (and (= temp___430 (get (rec__list_allocator__m__t__allocated model____split_fields4) j4)) (in_range7 temp___430))))
(assert (=> (= result25 true) (and (<= 1 temp___430) (<= temp___430 3))))
(assert (=> (= result25 true) (= o101 temp___430)))
(assert (=> (= result25 true) (= o102 (select data4 o101))))
(assert (=> (= result25 true) (= o103 (us_split_fields1 o102))))
(assert (=> (= result25 true) (= o104 (rec__list_allocator__cell__prev o103))))
(assert (=> (= result25 true) (= o107 (to_rep o104))))
(assert (=> (= result25 true) (= result24 (ite (= o107 o106) true false))))
(assert (=> (not (= result25 true)) (= result24 false)))
(assert (= result24 true))
(assert (and (= o97 (length (rec__list_allocator__m__t__allocated model____split_fields4))) (in_range6 o97)))
(assert (= o98 (ite (<= k1 o97) true false)))
(assert (= result28 (ite (<= 1 k1) o98 false)))
(assert (= result28 true))
(assert (not (= j4 k1)))
(assert (and (= o99 (get (rec__list_allocator__m__t__allocated model____split_fields4) k1)) (in_range7 o99)))
(assert (not (<= 1 j4)))
(check-sat)
(exit)
