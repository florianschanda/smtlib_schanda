...
(assert (not (= (let ((temp___185 (id (mk___t t2 (mk 5 8))))) (bool_eq s1 (to_rep1 s__first) (to_rep1 s__last) (elts temp___185) (to_rep1 (first (rt temp___185))) (to_rep1 (last (rt temp___185))))) true)))
(check-sat)
(exit)
