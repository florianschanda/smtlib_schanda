...
(assert (and (= (length source) 3) (forall ((index3 Int)) (=> (and (<= (to_rep1 (first (rt source))) index3) (<= index3 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index3))) true)))))
...
(assert (and (and (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 2)) (dynamic_property5 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 2) index2)) (forall ((temp___1835 Int)) (=> (and (<= (to_rep1 n__first) temp___1835) (<= temp___1835 (to_rep1 n__last))) (=> (or (< temp___1831 temp___1835) (or (< temp___1835 (to_rep1 (first (rt source)))) (< index2 temp___1835))) (= (select n3 temp___1835) (select n1 temp___1835)))))) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (+ (to_rep1 (first (rt source))) 2)))))
