...
(assert (and (and (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 2)) (dynamic_property5 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 2) index2)) (forall ((temp___1833 Int)) (=> (and (<= (to_rep1 n__first) temp___1833) (<= temp___1833 (to_rep1 n__last))) (=> (< index2 temp___1833) (= (select n3 temp___1833) (select n1 temp___1833)))))) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (+ (to_rep1 (first (rt source))) 2)))))
