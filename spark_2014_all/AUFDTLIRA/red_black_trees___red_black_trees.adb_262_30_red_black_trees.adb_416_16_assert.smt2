...
(assert (= n50 1))
(assert (=> (and (<= 1 n50) (<= n50 100)) (and (and (= temp___908 n50) (and (forall ((i14 Int)) (=> (and (<= 1 i14) (<= i14 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c75b))) i14))) true) (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c75b) i14)))) n51)) (ite (= (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c76b)) i14) c77b) (and (= (rec__red_black_trees__black_count__status (us_split_fields11 (select (nb_blacks c76b) i14))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (nb_blacks c76b) i14)))) (+ (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (nb_blacks c75b) i14)))) 1))) (= (eq (select (nb_blacks c76b) i14) (select (nb_blacks c75b) i14)) true))))) (and (and (=> (<= 1 100) (in_range2 n51)) (and (<= 1 n51) (<= n51 100))) (and (and (and (and (and (and (and (and (= temp___901 (nb_blacks c75b)) (and (= (bool_eq11 (select temp___901 0) (mk___rep5 (mk___split_fields5 (of_int 1) (of_rep 0) (of_rep 0)))) true) (forall ((i14 Int)) (=> (and (<= 1 i14) (<= i14 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c75b))) i14))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___901 i14))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___901 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___901 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i14 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___901 i14)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___901 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___901 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i14 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___901 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i14 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___901 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i14 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___901 i14)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c75b)) i14)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___901 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i14 0))))))))))))) (= o80 (select temp___901 c77b))) (= o81 (us_split_fields11 o80))) (= o82 (rec__red_black_trees__black_count__depth o81))) (= o83 (to_rep o82))) (= result31 (ite (<= o83 n51) true false))) (=> (= result31 true) (and (= (rec__red_black_trees__black_count__status (us_split_fields11 (select (nb_blacks c76b) c77b))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (nb_blacks c76b) c77b)))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (nb_blacks c75b) c77b)))))))) (= n51 100))))) (and (= n57 (mk_int__ref n51)) (= n58 n51)))))
(assert (=> (and (<= 1 n50) (<= n50 100)) (= n59 n57)))
(assert (=> (and (<= 1 n50) (<= n50 100)) (= n60 n58)))
(assert (=> (not (and (<= 1 n50) (<= n50 100))) (= n59 (mk_int__ref n50))))
(assert (=> (not (and (<= 1 n50) (<= n50 100))) (= n60 n50)))
