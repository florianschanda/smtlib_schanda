...
(assert (= j3 1))
(assert (=> (and (<= 1 j3) (<= j3 i)) (= temp___202 j3)))
(assert (=> (and (<= 1 j3) (<= j3 i)) (= temp___200 r1)))
(assert (=> (and (<= 1 j3) (<= j3 i)) (forall ((k Int)) (=> (and (<= 1 k) (<= k (- j4 1))) (= (to_rep (select r2 k)) (to_rep (select b k)))))))
(assert (=> (and (<= 1 j3) (<= j3 i)) (and (and (forall ((temp___201 Int)) (=> (and (<= 1 temp___201) (<= temp___201 8)) (=> (<= j4 temp___201) (= (select r2 temp___201) (select temp___200 temp___201))))) (=> (<= 1 i) (dynamic_property 1 i j4))) (and (<= 1 j4) (<= j4 i)))))
...
(assert (= j9 (+ i 1)))
(assert (=> (and (<= (+ i 1) j9) (<= j9 8)) (= temp___207 j9)))
(assert (=> (and (<= (+ i 1) j9) (<= j9 8)) (= temp___205 r6)))
(assert (=> (and (<= (+ i 1) j9) (<= j9 8)) (forall ((k Int)) (=> (and (<= 1 k) (<= k i)) (= (to_rep (select r8 k)) (to_rep (select b k)))))))
(assert (=> (and (<= (+ i 1) j9) (<= j9 8)) (and (and (forall ((temp___206 Int)) (=> (and (<= 1 temp___206) (<= temp___206 8)) (=> (<= j10 temp___206) (= (select r8 temp___206) (select temp___205 temp___206))))) (=> (<= (+ i 1) 8) (dynamic_property1 (+ i 1) 8 j10))) (and (<= (+ i 1) j10) (<= j10 8)))))
