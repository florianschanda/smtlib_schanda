...
(assert (= o29 (- o28 1)))
(assert (and (= temp___204 o29) (in_range1 o29)))
...
(assert (not (<= (to_rep (first (rt a))) temp___202)))
(check-sat)
(exit)
