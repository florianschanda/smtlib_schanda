...
(assert (= r6b9 r6b7))
(assert (= l9 l7))
(assert (and (= o28 (+ y (int__content lcp__result4))) (in_range1 (+ y (int__content lcp__result4)))))
(assert (= o29 (- o28 1)))
(assert (and (= temp___179 o29) (in_range1 o29)))
...
(assert (= o30 (elts a)))
(assert (= o30 temp___181))
(assert (= (mk2 y temp___179) temp___1811))
(assert (and (= o31 (+ x (int__content lcp__result4))) (in_range1 (+ x (int__content lcp__result4)))))
(assert (= o32 (- o31 1)))
(assert (and (= temp___178 o32) (in_range1 o32)))
...
(assert (and (= o26 (+ (to_rep (last (rt a))) 1)) (in_range1 (+ (to_rep (last (rt a))) 1))))
(assert (and (= o27 (+ x (int__content lcp__result4))) (in_range1 (+ x (int__content lcp__result4)))))
(assert (= result14 (ite (= o27 o26) true false)))
(assert (=> (= result14 true) (= result13 true)))
(assert (=> (not (= result14 true)) (and (= o24 (+ (to_rep (last (rt a))) 1)) (in_range1 (+ (to_rep (last (rt a))) 1)))))
(assert (=> (not (= result14 true)) (and (= o25 (+ y (int__content lcp__result4))) (in_range1 (+ y (int__content lcp__result4))))))
(assert (=> (not (= result14 true)) (= result13 (ite (= o25 o24) true false))))
(assert (not (= result13 true)))
(assert (and (= temp___177 (+ y (int__content lcp__result4))) (in_range1 (+ y (int__content lcp__result4)))))
(assert (not (<= (to_rep (first (rt a))) temp___177)))
(check-sat)
(exit)
