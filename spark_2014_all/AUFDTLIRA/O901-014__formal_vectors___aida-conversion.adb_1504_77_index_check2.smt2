...
(assert (and (= (length source) 11) (and (and (and (and (and (and (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 50)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 49)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 3))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 4))) 55)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 5))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 6))) 56)) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 7))) 51)) (forall ((index3 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 7) index3) (<= index3 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index3))) true))))))
...
(assert (forall ((j1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 7) j1) (<= j1 index2)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1))))))
...
(assert (and (= o9 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
