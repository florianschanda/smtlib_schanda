...
(assert (= hr4 o26))
(assert (not (= (let ((temp___256 (remove (remove (mk___t values2 (mk 1 100)) x) y))) (let ((temp___255 (remove (remove (mk___t interm1 (mk 1 100)) x) y))) (bool_eq (elts temp___255) (to_rep1 (first (rt temp___255))) (to_rep1 (last (rt temp___255))) (elts temp___256) (to_rep1 (first (rt temp___256))) (to_rep1 (last (rt temp___256)))))) true)))
(check-sat)
(exit)
