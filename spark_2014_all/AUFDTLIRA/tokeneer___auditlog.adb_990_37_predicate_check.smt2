...
(define-fun dynamic_invariant2 ((temp___expr_1072 Int) (temp___is_init_1069 Bool) (temp___skip_constant_1070 Bool) (temp___do_toplevel_1071 Bool)) Bool (=> (or (= temp___is_init_1069 true) (<= 1 17)) (in_range10 temp___expr_1072)))
...
(define-fun dynamic_invariant3 ((temp___expr_1112 Int) (temp___is_init_1109 Bool) (temp___skip_constant_1110 Bool) (temp___do_toplevel_1111 Bool)) Bool (=> (or (= temp___is_init_1109 true) (<= 0 1024)) (in_range11 temp___expr_1112)))
...
(define-fun dynamic_invariant4 ((temp___expr_1184 Int) (temp___is_init_1181 Bool) (temp___skip_constant_1182 Bool) (temp___do_toplevel_1183 Bool)) Bool (=> (or (= temp___is_init_1181 true) (<= 0 2)) (in_range12 temp___expr_1184)))
...
(define-fun dynamic_invariant9 ((temp___expr_1208 Int) (temp___is_init_1205 Bool) (temp___skip_constant_1206 Bool) (temp___do_toplevel_1207 Bool)) Bool (=> (or (= temp___is_init_1205 true) (<= 1 16)) (in_range13 temp___expr_1208)))
(define-fun dynamic_invariant10 ((temp___expr_393 Int) (temp___is_init_390 Bool) (temp___skip_constant_391 Bool) (temp___do_toplevel_392 Bool)) Bool (=> (or (= temp___is_init_390 true) (<= 1901 2099)) (in_range5 temp___expr_393)))
(define-fun dynamic_invariant11 ((temp___expr_399 Int) (temp___is_init_396 Bool) (temp___skip_constant_397 Bool) (temp___do_toplevel_398 Bool)) Bool (=> (or (= temp___is_init_396 true) (<= 1 12)) (in_range6 temp___expr_399)))
(define-fun dynamic_invariant12 ((temp___expr_405 Int) (temp___is_init_402 Bool) (temp___skip_constant_403 Bool) (temp___do_toplevel_404 Bool)) Bool (=> (or (= temp___is_init_402 true) (<= 1 31)) (in_range7 temp___expr_405)))
(define-fun dynamic_invariant13 ((temp___expr_433 Int) (temp___is_init_430 Bool) (temp___skip_constant_431 Bool) (temp___do_toplevel_432 Bool)) Bool (=> (or (= temp___is_init_430 true) (<= 0 86399999)) (in_range8 temp___expr_433)))
(assert (= zerotime (mk___rep (mk___split_fields (of_rep2 1901) (of_rep3 1) (of_rep4 1) (of_rep5 0)))))
(define-fun dynamic_invariant14 ((temp___expr_449 Int) (temp___is_init_446 Bool) (temp___skip_constant_447 Bool) (temp___do_toplevel_448 Bool)) Bool (=> (or (= temp___is_init_446 true) (<= 1 21)) (in_range9 temp___expr_449)))
...
(declare-const temp___1767 yearst)
(declare-const temp___17671 monthst)
(declare-const temp___17672 dayst)
(declare-const temp___17673 millisecst)
(declare-const o8 (Array Int character))
(declare-const temp___1760 (Array Int character))
(declare-const temp___17601 t1)
...
(assert (= o1 o6))
(assert (= o o7))
(assert (= temp___1767 o4))
(assert (= temp___17671 o5))
(assert (= temp___17672 o6))
(assert (= temp___17673 o7))
(assert (= (mk___rep (mk___split_fields temp___1767 temp___17671 temp___17672 temp___17673)) zerotime))
...
(assert (= (select logfilenames i) temp___1760))
(assert (= (mk1 1 16) temp___17601))
(assert (not (dynamic_predicate (mk___t1 temp___1760 temp___17601))))
(check-sat)
(exit)
