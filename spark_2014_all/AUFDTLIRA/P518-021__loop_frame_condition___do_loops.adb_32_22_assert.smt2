...
(assert (not (= (to_rep (rec__do_loops__r__f2 (us_split_fields1 (select (rec__do_loops__r_array_record__f3 d__split_fields4) i8)))) (to_rep (rec__do_loops__r__f2 (us_split_fields1 (select d__split_fields i8)))))))
(check-sat)
(exit)
