...
(declare-const o5 t1)
(declare-const temp___1050 natural_index)
(declare-const temp___10501 natural_index)
(declare-const temp___10502 (Array Int character))
(declare-const temp___10503 t1)
(declare-const temp___1051 natural_index)
(declare-const temp___10511 natural_index)
(declare-const temp___10512 (Array Int character))
(declare-const temp___10513 t1)
(declare-const temp___1052 (Array Int character))
(declare-const temp___10521 t3)
(declare-const temp___1054 Int)
(declare-const o6 (Array Int character))
(declare-const temp___1056 (Array Int character))
(declare-const temp___10561 t3)
(declare-const temp___1058 (Array Int character))
(declare-const temp___10581 t3)
...
(declare-const temp___1061 natural_index)
(declare-const temp___10611 natural_index)
(declare-const temp___10612 (Array Int character))
(declare-const temp___10613 t1)
(declare-const temp___1062 us_rep)
...
(assert (dynamic_invariant2 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t1 to____split_fields1 to____split_fields2))) true false true))
(assert (<= (length source) (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity to____split_discrs))))
(assert (and (= o1 (length source)) (in_range4 (length source))))
(assert (= (to_rep2 o2) o1))
(assert (= o2 o3))
(assert (= to____split_fields1 o4))
(assert (= to____split_fields2 o5))
(assert (= to____split_discrs (mk___split_discrs temp___1050)))
(assert (= temp___10501 o3))
(assert (= temp___10502 o4))
(assert (= temp___10503 o5))
(assert (dynamic_predicate (mk___rep (mk___split_discrs temp___1050) (mk___split_fields temp___10501 (mk___t1 temp___10502 temp___10503)))))
(assert (= (mk___rep (mk___split_discrs temp___1051) (mk___split_fields temp___10511 (mk___t1 temp___10512 temp___10513))) (mk___rep (mk___split_discrs temp___1050) (mk___split_fields temp___10501 (mk___t1 temp___10502 temp___10503)))))
...
(assert (= to____split_fields3 (mk___split_fields temp___10511 (mk___t1 temp___10512 temp___10513))))
(assert (= to____split_discrs (mk___split_discrs temp___1051)))
...
(assert (= (slide (elts source) (to_rep1 (first (rt source))) 1) temp___1052))
(assert (= (mk3 1 (length source)) temp___10521))
(assert (and (= temp___1054 (length source)) (in_range1 (length source))))
(assert (=> (<= 1 temp___1054) (and (and (<= (to_rep1 (first2 (rt1 (rec__bounded_dynamic_strings__sequence__content to____split_fields3)))) 1) (<= 1 (to_rep1 (last2 (rt1 (rec__bounded_dynamic_strings__sequence__content to____split_fields3)))))) (and (<= (to_rep1 (first2 (rt1 (rec__bounded_dynamic_strings__sequence__content to____split_fields3)))) temp___1054) (<= temp___1054 (to_rep1 (last2 (rt1 (rec__bounded_dynamic_strings__sequence__content to____split_fields3)))))))))
(assert (= o6 (elts1 (rec__bounded_dynamic_strings__sequence__content to____split_fields3))))
(assert (= o6 temp___1056))
(assert (= (mk3 1 temp___1054) temp___10561))
(assert (= (ite (<= (to_rep1 (first6 temp___10521)) (to_rep1 (last6 temp___10521))) (+ (- (to_rep1 (last6 temp___10521)) (to_rep1 (first6 temp___10521))) 1) 0) (ite (<= (to_rep1 (first6 temp___10561)) (to_rep1 (last6 temp___10561))) (+ (- (to_rep1 (last6 temp___10561)) (to_rep1 (first6 temp___10561))) 1) 0)))
(assert (= (mk___t3 temp___1058 temp___10581) (mk___t3 temp___1052 temp___10521)))
(assert (and (and (= (to_rep1 (first2 (rt1 (rec__bounded_dynamic_strings__sequence__content to____split_fields3)))) (to_rep1 (first2 o8))) (= (to_rep1 (last2 (rt1 (rec__bounded_dynamic_strings__sequence__content to____split_fields3)))) (to_rep1 (last2 o8)))) (forall ((temp___1059 Int)) (ite (and (<= 1 temp___1059) (<= temp___1059 (length source))) (= (select o7 temp___1059) (select temp___1058 temp___1059)) (= (select o7 temp___1059) (select (elts1 (rec__bounded_dynamic_strings__sequence__content to____split_fields3)) temp___1059))))))
(assert (= (rec__bounded_dynamic_strings__sequence__current_length to____split_fields3) o9))
(assert (= o10 o7))
(assert (= o11 o8))
(assert (= to____split_discrs (mk___split_discrs temp___1061)))
(assert (= temp___10611 o9))
(assert (= temp___10612 o10))
(assert (= temp___10613 o11))
(assert (not (dynamic_predicate (mk___rep (mk___split_discrs temp___1061) (mk___split_fields temp___10611 (mk___t1 temp___10612 temp___10613))))))
(check-sat)
(exit)
