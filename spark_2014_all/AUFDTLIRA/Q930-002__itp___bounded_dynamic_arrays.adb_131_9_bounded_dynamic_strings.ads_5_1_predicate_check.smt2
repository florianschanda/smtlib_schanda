...
(declare-const o4 t)
(declare-const temp___1119 natural_index)
(declare-const temp___11191 natural_index)
(declare-const temp___11192 (Array Int character))
(declare-const temp___11193 t)
(declare-const temp___1120 natural_index)
(declare-const temp___11201 natural_index)
(declare-const temp___11202 (Array Int character))
(declare-const temp___11203 t)
...
(declare-const temp___1125 (Array Int character))
(declare-const temp___11251 t3)
(declare-const temp___1127 (Array Int character))
(declare-const temp___11271 t3)
(declare-const o6 (Array Int character))
(declare-const o7 t)
(declare-const o8 natural_index)
(declare-const o9 (Array Int character))
(declare-const o10 t)
(declare-const temp___1130 natural_index)
(declare-const temp___11301 natural_index)
(declare-const temp___11302 (Array Int character))
(declare-const temp___11303 t)
(declare-const result us_split_fields__ref)
(declare-const to____split_fields3 us_split_fields)
(define-fun temp___11194 () us_rep (mk___rep (mk___split_discrs temp___1119) (mk___split_fields temp___11191 (mk___t temp___11192 temp___11193))))
...
(assert (<= (length2 source) (to_rep1 (rec__bounded_dynamic_strings__sequence__capacity to____split_discrs))))
(assert (and (= o (length2 source)) (in_range3 (length2 source))))
(assert (= (to_rep1 o1) o))
(assert (= o1 o2))
(assert (= to____split_fields1 o3))
(assert (= to____split_fields2 o4))
(assert (= to____split_discrs (mk___split_discrs temp___1119)))
(assert (= temp___11191 o2))
(assert (= temp___11192 o3))
(assert (= temp___11193 o4))
(assert (dynamic_predicate temp___11194))
(assert (= (mk___rep (mk___split_discrs temp___1120) (mk___split_fields temp___11201 (mk___t temp___11202 temp___11203))) temp___11194))
(assert (= result (mk___split_fields__ref (mk___split_fields to____split_fields (mk___t to____split_fields1 to____split_fields2)))))
(assert (= to____split_fields3 (mk___split_fields temp___11201 (mk___t temp___11202 temp___11203))))
(assert (= to____split_discrs (mk___split_discrs temp___1120)))
(assert (= (to_rep1 (rec__bounded_dynamic_strings__sequence__capacity to____split_discrs)) r124b))
(assert (in_range3 r124b))
(assert (= (ite (<= (to_rep2 (first2 (rt1 source))) (to_rep2 (last2 (rt1 source)))) (+ (- (to_rep2 (last2 (rt1 source))) (to_rep2 (first2 (rt1 source)))) 1) 0) (ite (<= 1 (length2 source)) (+ (- (length2 source) 1) 1) 0)))
(assert (= (slide (elts1 source) (to_rep2 (first2 (rt1 source))) 1) temp___1121))
(assert (= (mk3 1 (length2 source)) temp___11211))
(assert (and (= temp___1123 (length2 source)) (in_range1 (length2 source))))
(assert (=> (<= 1 temp___1123) (and (and (<= (to_rep2 (first (rt (rec__bounded_dynamic_strings__sequence__content to____split_fields3)))) 1) (<= 1 (to_rep2 (last (rt (rec__bounded_dynamic_strings__sequence__content to____split_fields3)))))) (and (<= (to_rep2 (first (rt (rec__bounded_dynamic_strings__sequence__content to____split_fields3)))) temp___1123) (<= temp___1123 (to_rep2 (last (rt (rec__bounded_dynamic_strings__sequence__content to____split_fields3)))))))))
(assert (= o5 (elts (rec__bounded_dynamic_strings__sequence__content to____split_fields3))))
(assert (= o5 temp___1125))
(assert (= (mk3 1 temp___1123) temp___11251))
(assert (= (ite (<= (to_rep2 (first6 temp___11211)) (to_rep2 (last6 temp___11211))) (+ (- (to_rep2 (last6 temp___11211)) (to_rep2 (first6 temp___11211))) 1) 0) (ite (<= (to_rep2 (first6 temp___11251)) (to_rep2 (last6 temp___11251))) (+ (- (to_rep2 (last6 temp___11251)) (to_rep2 (first6 temp___11251))) 1) 0)))
(assert (= (mk___t3 temp___1127 temp___11271) (mk___t3 temp___1121 temp___11211)))
(assert (and (and (= (to_rep2 (first (rt (rec__bounded_dynamic_strings__sequence__content to____split_fields3)))) (to_rep2 (first o7))) (= (to_rep2 (last (rt (rec__bounded_dynamic_strings__sequence__content to____split_fields3)))) (to_rep2 (last o7)))) (forall ((temp___1128 Int)) (ite (and (<= 1 temp___1128) (<= temp___1128 (length2 source))) (= (select o6 temp___1128) (select temp___1127 temp___1128)) (= (select o6 temp___1128) (select (elts (rec__bounded_dynamic_strings__sequence__content to____split_fields3)) temp___1128))))))
(assert (= (rec__bounded_dynamic_strings__sequence__current_length to____split_fields3) o8))
(assert (= o9 o6))
(assert (= o10 o7))
(assert (= to____split_discrs (mk___split_discrs temp___1130)))
(assert (= temp___11301 o8))
(assert (= temp___11302 o9))
(assert (= temp___11303 o10))
(assert (not (dynamic_predicate (mk___rep (mk___split_discrs temp___1130) (mk___split_fields temp___11301 (mk___t temp___11302 temp___11303))))))
(check-sat)
(exit)
