...
(define-fun dynamic_invariant1 ((temp___expr_141 Int) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool (=> (or (= temp___is_init_138 true) (<= 1 8)) (in_range1 temp___expr_141)))
...
(declare-fun temp___311 ((Array Int integer) Int Int Int Int Int) (Array Int integer))
(assert (forall ((temp___313 (Array Int integer))) (forall ((temp___314 Int) (temp___315 Int) (temp___316 Int) (temp___317 Int) (temp___318 Int)) (let ((temp___312 (temp___311 temp___313 temp___314 temp___315 temp___316 temp___317 temp___318))) (forall ((temp___319 Int)) (ite (and (<= temp___316 temp___319) (<= temp___319 temp___317)) (= (select temp___312 temp___319) (of_rep temp___318)) (ite (= temp___319 temp___314) (= (select temp___312 temp___319) (of_rep temp___315)) (= (select temp___312 temp___319) (select temp___313 temp___319)))))))))
(declare-fun temp___320 (Int) (Array Int integer))
(assert (forall ((temp___322 Int)) (forall ((temp___323 Int)) (= (select (temp___320 temp___322) temp___323) (of_rep temp___322)))))
(declare-fun temp___446 (Int) (Array Int integer))
(assert (forall ((temp___448 Int)) (forall ((temp___449 Int)) (= (select (temp___446 temp___448) temp___449) (of_rep temp___448)))))
(declare-fun temp___450 ((Array Int integer) Int Int Int Int Int) (Array Int integer))
(assert (forall ((temp___452 (Array Int integer))) (forall ((temp___453 Int) (temp___454 Int) (temp___455 Int) (temp___456 Int) (temp___457 Int)) (let ((temp___451 (temp___450 temp___452 temp___453 temp___454 temp___455 temp___456 temp___457))) (forall ((temp___458 Int)) (ite (and (<= temp___455 temp___458) (<= temp___458 temp___456)) (= (select temp___451 temp___458) (of_rep temp___457)) (ite (= temp___458 temp___453) (= (select temp___451 temp___458) (of_rep temp___454)) (= (select temp___451 temp___458) (select temp___452 temp___458)))))))))
(declare-const x Int)
...
(assert (= a2 a3))
(assert (= a4 a2))
(assert (not (= (bool_eq a3 1 8 (temp___311 (temp___320 1) i 2 4 5 x) 1 8) true)))
(check-sat)
(exit)
