...
(assert (= a4 a2))
(assert (not (or (and (< k 16) (or (and (< 0 e) (= (bool_eq2 a3 1 16 (temp___1874 a k (temp___1882 (select a k) j (temp___1889 (select (select a k) j) i e)) (+ k 1) (temp___1897 (select a (+ k 1)) j (temp___1904 (select (select a (+ k 1)) j) i (- e 1)))) 1 16) true)) (and (= e 0) (= (bool_eq2 a3 1 16 (temp___1913 a k (temp___1921 (select a k) j (temp___1928 (select (select a k) j) i e)) (+ k 1) (temp___1936 (select a (+ k 1)) j (temp___1943 (select (select a (+ k 1)) j) i 99))) 1 16) true)))) (and (= k 16) (or (and (< 0 e) (= (bool_eq2 a3 1 16 (temp___1952 a k (temp___1960 (select a k) j (temp___1967 (select (select a k) j) i e)) 1 (temp___1975 (select a 1) j (temp___1982 (select (select a 1) j) i (- e 1)))) 1 16) true)) (and (= e 0) (= (bool_eq2 a3 1 16 (temp___1991 a k (temp___1999 (select a k) j (temp___2006 (select (select a k) j) i e)) 1 (temp___2014 (select a 1) j (temp___2021 (select (select a 1) j) i 99))) 1 16) true)))))))
(check-sat)
(exit)
