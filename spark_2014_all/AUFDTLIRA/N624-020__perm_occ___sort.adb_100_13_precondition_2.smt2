...
(assert (= (slide values (to_rep1 values__first) (to_rep1 values__first)) temp___273))
(assert (= (mk1 (to_rep1 values__first) (to_rep1 values__last)) temp___2731))
(assert (= (ite (<= (to_rep1 (first2 temp___2731)) (to_rep1 (last2 temp___2731))) (+ (- (to_rep1 (last2 temp___2731)) (to_rep1 (first2 temp___2731))) 1) 0) (ite (<= (to_rep1 previous__first) (to_rep1 previous__last)) (+ (- (to_rep1 previous__last) (to_rep1 previous__first)) 1) 0)))
(assert (= (mk___t1 o5 o6) (mk___t1 temp___273 temp___2731)))
(assert (= o7 o5))
(assert (= (mk_map__ref result3) (mk_map__ref previous)))
(assert (= previous1 o7))
(assert (and (= o8 current1) (in_range3 current1)))
(assert (not (<= o8 (to_rep1 values__last))))
(check-sat)
(exit)
