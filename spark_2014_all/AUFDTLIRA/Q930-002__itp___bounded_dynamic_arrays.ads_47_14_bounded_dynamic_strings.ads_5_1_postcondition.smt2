...
(define-fun o5 () us_rep (mk___rep (mk___split_discrs o1) (mk___split_fields o2 (mk___t1 o3 o4))))
...
(assert (and (= o5 (instance o content)) (and (dynamic_invariant2 o5 true false true true) (and (and (= (to_rep2 o1) o) (= (length2 o5) (length content))) (= (let ((temp___270 (value o5))) (bool_eq (elts temp___270) (to_rep1 (first (rt temp___270))) (to_rep1 (last (rt temp___270))) (elts content) (to_rep1 (first (rt content))) (to_rep1 (last (rt content))))) true)))))
