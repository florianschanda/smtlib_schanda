...
(assert (= (mk___rep (mk___split_discrs result4) (mk___split_fields result5 (mk___t1 result6 result7))) (sequence__content bounded_dynamic_strings__instance__3__result13)))
(assert (not (= (length2 (sequence__content bounded_dynamic_strings__instance__3__result13)) (length content))))
(check-sat)
(exit)
