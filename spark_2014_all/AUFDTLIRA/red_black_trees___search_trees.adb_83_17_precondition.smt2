...
(assert (= o15 (select temp___1279 (int__content search_trees__find_root__result4))))
(assert (= o16 (us_split_fields1 o15)))
(assert (= result11 (rec__tree_model__path_type__k o16)))
...
(assert (= o12 (select temp___1278 i)))
