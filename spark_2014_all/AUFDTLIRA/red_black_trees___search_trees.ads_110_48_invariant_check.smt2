...
(assert (=> (not (= (int__content i14) 0)) (= result26 (rec__tree_model__path_type__k o37))))
...
(assert (=> (= result26 true) (and (= o33 (root (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)))) (and (in_range3 o33) (= o33 (to_rep1 t__split_fields))))))
(assert (=> (= result26 true) (type_invariant1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))))
(assert (=> (= result26 true) (and (= o34 (root (mk___rep3 (us_split_fields__content3 t__split_fields14)))) (and (in_range3 o34) (= o34 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields__content3 t__split_fields14))))))))
(assert (=> (= result26 true) (= result25 (ite (= o34 o33) true false))))
...
(assert (=> (= result25 true) (and (= o32 (size1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))) (and (in_range4 o32) (= o32 (size (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14))))))))
(assert (=> (= result25 true) (= result24 (ite (= o32 (+ (size1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3))) 1)) true false))))
...
(assert (=> (= result24 true) (and (= result23 (is_add__2 o30 v o31)) (= (= result23 true) (and (and (and (not (= (contains o30 v) true)) (= (contains o31 v) true)) (= (ole o30 o31) true)) (= (included_except o31 o30 v) true))))))
