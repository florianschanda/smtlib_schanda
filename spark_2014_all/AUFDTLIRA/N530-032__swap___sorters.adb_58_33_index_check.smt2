...
(assert (and (<= (to_rep values__first) smallest2) (<= smallest2 (to_rep values__last))))
(assert (= o7 smallest2))
(assert (= o8 (select values o7)))
(assert (= o9 (to_rep o8)))
(assert (= o9 sorters__swap__y))
(assert (and (<= (to_rep values__first) current2) (<= current2 (to_rep values__last))))
(assert (= o10 current2))
(assert (= o11 (select values o10)))
(assert (= o12 (to_rep o11)))
(assert (= o12 sorters__swap__x))
(assert (and (and (= sorters__swap__x1 sorters__swap__y) (= sorters__swap__y1 sorters__swap__x)) (and (in_range1 sorters__swap__x1) (in_range1 sorters__swap__y1))))
(assert (= (to_rep o13) sorters__swap__x1))
(assert (and (<= (to_rep values__first) current2) (<= current2 (to_rep values__last))))
(assert (= o14 current2))
(assert (= o15 (store values o14 o13)))
(assert (= values result2))
(assert (= values1 o15))
(assert (= (to_rep o16) sorters__swap__y1))
