...
(assert (in_range1 n))
(assert (and (and (and (and (and (and (= (mk___rep (mk___split_fields o o1)) (create_stack Tuple0)) (= (get_length (mk___rep (mk___split_fields o o1))) 0)) (and (= (of_int 1) o2) (and (= o3 o) (= o4 o1)))) (and (= temp___234 o2) (and (= temp___2341 o3) (= temp___2342 o4)))) (and (= (mk___split_fields__ref1 (mk___split_fields1 result (mk___rep (mk___split_fields result1 result2)))) (mk___split_fields__ref1 (mk___split_fields1 s__split_fields (mk___rep (mk___split_fields s__split_fields1 s__split_fields2))))) (and (= temp___234 s__split_fields3) (and (= temp___2341 s__split_fields4) (= temp___2342 s__split_fields5))))) (and (= s__split_fields3 true) (and (and (and (= (get_length (mk___rep stack__push__the_stack__fields)) (+ (get_length (mk___rep (mk___split_fields s__split_fields4 s__split_fields5))) 1)) (= (top (mk___rep stack__push__the_stack__fields)) n)) (and (= result3 (mk___split_fields__ref1 (mk___split_fields1 s__split_fields3 (mk___rep (mk___split_fields s__split_fields4 s__split_fields5))))) (= s__split_fields6 (mk___split_fields1 s__split_fields3 (mk___rep stack__push__the_stack__fields))))) (and (and (= o5 (top (rec__private_a__optional_stack__the_stack s__split_fields6))) (in_range1 o5)) (and (= result4 (mk_int__ref n)) (= n1 o5)))))) (and (and (= s__split_fields7 (mk___split_fields__ref1 s__split_fields6)) (= n2 (mk_int__ref n1))) (and (= s__split_fields8 s__split_fields6) (= n3 n1)))))
