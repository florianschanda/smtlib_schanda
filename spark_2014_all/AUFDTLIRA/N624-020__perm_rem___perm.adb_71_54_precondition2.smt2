...
(define-fun perm__perm_reflexive__induction_hypothesis__result10 () int__ref (mk_int__ref perm__perm_reflexive__induction_hypothesis__result6))
...
(assert (and (= (invariant__ a) true) (and (= (invariant__ b) true) (= (bool_eq (elts a) (to_rep (first (rt a))) (to_rep (last (rt a))) (elts b) (to_rep (first (rt b))) (to_rep (last (rt b)))) true))))
(assert (or (and (and (= perm__perm_reflexive__induction_hypothesis__result2 perm__perm_reflexive__induction_hypothesis__result6) (= perm__perm_reflexive__induction_hypothesis__result7 perm__perm_reflexive__induction_hypothesis__result2)) (and (= (length a) 0) (and (= (mk_int__ref result) (mk_int__ref perm__perm_reflexive__induction_hypothesis__result)) (= perm__perm_reflexive__induction_hypothesis__result2 1)))) (and (and (not (= (length a) 0)) (and (= perm__perm_reflexive__induction_hypothesis__result2 perm__perm_reflexive__induction_hypothesis__result) (= perm__perm_reflexive__induction_hypothesis__result2 perm__perm_reflexive__induction_hypothesis__result1))) (and (and (= perm__perm_reflexive__induction_hypothesis__result10 (mk_int__ref perm__perm_reflexive__induction_hypothesis__result4)) (= perm__perm_reflexive__induction_hypothesis__result7 perm__perm_reflexive__induction_hypothesis__result5)) (and (and (= perm__perm_reflexive__induction_hypothesis__result3 perm__perm_reflexive__induction_hypothesis__result4) (= perm__perm_reflexive__induction_hypothesis__result5 perm__perm_reflexive__induction_hypothesis__result3)) (and (and (and (and (and (= o3 (to_rep (first (rt b)))) (in_range3 (to_rep (first (rt b))))) (and (= o6 (remove b o3)) (and (dynamic_invariant o6 true false true true) (and (= (invariant__ o6) true) (and (= (to_rep (last o5)) (- (to_rep (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o3 1))) (= (to_rep1 (select (elts b) k)) (to_rep1 (select o4 k))))) (and (forall ((k Int)) (=> (and (<= (+ o3 1) k) (<= k (to_rep (last (rt b))))) (= (to_rep1 (select (elts b) k)) (to_rep1 (select o4 (- k 1)))))) (forall ((k Int)) (=> (and (<= o3 k) (<= k (- (to_rep (last (rt b))) 1))) (= (to_rep1 (select (elts b) (+ k 1))) (to_rep1 (select o4 k)))))))))))) (and (and (and (= o (to_rep (first (rt a)))) (in_range3 (to_rep (first (rt a))))) (and (= o7 (remove a o)) (and (dynamic_invariant o7 true false true true) (and (= (invariant__ o7) true) (and (= (to_rep (last o2)) (- (to_rep (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o 1))) (= (to_rep1 (select (elts a) k)) (to_rep1 (select o1 k))))) (and (forall ((k Int)) (=> (and (<= (+ o 1) k) (<= k (to_rep (last (rt a))))) (= (to_rep1 (select (elts a) k)) (to_rep1 (select o1 (- k 1)))))) (forall ((k Int)) (=> (and (<= o k) (<= k (- (to_rep (last (rt a))) 1))) (= (to_rep1 (select (elts a) (+ k 1))) (to_rep1 (select o1 k)))))))))))) (and (= perm__perm_reflexive__induction_hypothesis__B_3__ih__assume (induction_hypothesis o7 o6)) (and (in_range4 perm__perm_reflexive__induction_hypothesis__B_3__ih__assume) (=> (= (distinct perm__perm_reflexive__induction_hypothesis__B_3__ih__assume 0) true) (= (is_perm o7 o6) true)))))) (= perm__perm_reflexive__induction_hypothesis__B_3__ih__assume ih)) (and (in_range4 ih) (and (= (distinct ih 0) true) (and (= perm__perm_reflexive__induction_hypothesis__result2 result1) (= perm__perm_reflexive__induction_hypothesis__result3 ih))))))))))
(assert (= (mk_int__ref perm__perm_reflexive__induction_hypothesis__result8) perm__perm_reflexive__induction_hypothesis__result10))
(assert (= perm__perm_reflexive__induction_hypothesis__result9 perm__perm_reflexive__induction_hypothesis__result7))
(assert (= (distinct perm__perm_reflexive__induction_hypothesis__result8 0) true))
