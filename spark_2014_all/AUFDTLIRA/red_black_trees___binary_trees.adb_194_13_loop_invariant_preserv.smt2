...
(assert (<= 1 k))
(assert (<= k 100))
(assert (= (rec__tree_model__path_type__k (us_split_fields1 (select r6 k))) true))
(assert (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select r6 k))) (rec__tree_model__path_type__a (us_split_fields1 (select r6 j16)))) true))
(assert (not (= j16 k)))
(check-sat)
(exit)
