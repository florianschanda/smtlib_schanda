...
(declare-const temp___2711 (Array Int us_rep))
(declare-const temp___2712 t1)
(assert (in_range2 temp___c_270))
(assert (dynamic_invariant2 (mk___rep1 (mk___split_discrs temp___271) (mk___split_fields1 (mk___t1 temp___2711 temp___2712))) true false true true))
(assert (forall ((temp___274 Int)) (=> (and (<= (to_rep (first2 temp___2712)) temp___274) (<= temp___274 (to_rep (last2 temp___2712)))) (and (= (rec__types_with_invariants__my_integer__sign (us_split_fields1 (select temp___2711 temp___274))) (distinct 1 0)) (= (to_rep1 (rec__types_with_invariants__my_integer__val (us_split_fields1 (select temp___2711 temp___274)))) 0)))))
(declare-const temp___277 Int)
(assert (<= (to_rep (first2 temp___2712)) temp___277))
(assert (<= temp___277 (to_rep (last2 temp___2712))))
(define-fun temp___164 () us_rep (select temp___2711 temp___277))
