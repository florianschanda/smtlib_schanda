...
(assert (dynamic_invariant2 (mk___rep1 (mk___split_discrs temp___238) (mk___split_fields1 (mk___t1 temp___2381 temp___2382))) true false true))
(assert (forall ((temp___241 Int)) (=> (and (<= (to_rep (first2 temp___2382)) temp___241) (<= temp___241 (to_rep (last2 temp___2382)))) (and (= (rec__types_with_invariants__my_integer__sign (us_split_fields1 (select temp___2381 temp___241))) (of_int 1)) (= (to_rep1 (rec__types_with_invariants__my_integer__val (us_split_fields1 (select temp___2381 temp___241)))) 0)))))
(declare-const temp___244 Int)
(assert (<= (to_rep (first2 temp___2382)) temp___244))
(assert (<= temp___244 (to_rep (last2 temp___2382))))
(assert (= (to_rep1 (rec__types_with_invariants__my_integer__val (us_split_fields1 (select temp___2381 temp___244)))) 0))
(assert (not (= (rec__types_with_invariants__my_integer__sign (us_split_fields1 (select temp___2381 temp___244))) true)))
(check-sat)
(exit)
