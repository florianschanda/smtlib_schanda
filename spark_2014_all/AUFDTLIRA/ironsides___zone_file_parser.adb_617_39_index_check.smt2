...
(assert (and (and (and (and (<= begidx2 endidx1) (<= begidx2 zlength)) (<= endidx1 zlength)) (=> (= foundtype1 1) (forall ((i3 Int)) (=> (and (<= begidx2 i3) (<= i3 endidx1)) (and (<= 48 (to_rep (select zonefileline i3))) (<= (to_rep (select zonefileline i3)) 57)))))) (and (and (in_range4 begidx2) (in_range4 endidx1)) (in_range3 foundtype1))))
...
(assert (=> (and (not (= foundtype1 3)) (< endidx1 zlength)) (and (and (and (and (<= begidx5 endidx3) (<= begidx5 zlength)) (<= endidx3 zlength)) (=> (= foundtype3 1) (forall ((i3 Int)) (=> (and (<= begidx5 i3) (<= i3 endidx3)) (and (<= 48 (to_rep (select zonefileline i3))) (<= (to_rep (select zonefileline i3)) 57)))))) (and (and (in_range4 begidx5) (in_range4 endidx3)) (in_range3 foundtype3)))))
...
(assert (= begidx10 o1))
(assert (and (and (and (and (<= begidx11 endidx8) (<= begidx11 zlength)) (<= endidx8 zlength)) (=> (= foundtype8 1) (forall ((i3 Int)) (=> (and (<= begidx11 i3) (<= i3 endidx8)) (and (<= 48 (to_rep (select zonefileline i3))) (<= (to_rep (select zonefileline i3)) 57)))))) (and (and (in_range4 begidx11) (in_range4 endidx8)) (in_range3 foundtype8))))
...
(assert (<= r23b i1))
(assert (<= i1 r24b))
(assert (and (<= 1 begidx11) (<= (+ (- endidx8 begidx11) 1) 128)))
(assert (and (=> (<= r23b r24b) (dynamic_property r23b r24b i2)) (and (<= r23b i2) (<= i2 r24b))))
(assert (= (to_rep o5) (to_rep (select zonefileline i2))))
(assert (and (= o3 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= o4 (- o3 begidx11)))
(assert (and (= temp___1618 o4) (in_range1 o4)))
(assert (not (<= temp___1618 128)))
(check-sat)
(exit)
