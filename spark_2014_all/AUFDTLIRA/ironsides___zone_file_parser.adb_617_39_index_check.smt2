...
(assert (= begidx13 r23b))
(assert (in_range4 r23b))
(assert (= endidx10 r24b))
...
(assert (and (=> (<= r23b r24b) (dynamic_property r23b r24b i7)) (and (<= r23b i7) (<= i7 r24b))))
(assert (= (to_rep o5) (to_rep (select zonefileline i7))))
(assert (and (= o3 (+ i7 1)) (in_range1 (+ i7 1))))
(assert (= o4 (- o3 begidx13)))
(assert (and (= temp___1557 o4) (in_range1 o4)))
(assert (not (<= 1 temp___1557)))
(check-sat)
(exit)
