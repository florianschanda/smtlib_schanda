...
(define-fun to_rep1 ((x integer_subtype)) Int (integer_subtypeqtint x))
...
(declare-fun tint_array1D1qtint (tint_array1D1) Int)
(assert (forall ((i tint_array1D1)) (and (<= 0 (tint_array1D1qtint i)) (<= (tint_array1D1qtint i) 2))))
...
(declare-fun tint_array2D1qtint (tint_array2D1) Int)
(assert (forall ((i tint_array2D1)) (and (<= 0 (tint_array2D1qtint i)) (<= (tint_array2D1qtint i) 2))))
...
(assert (forall ((i t1b)) (and (<= 0 (t1bqtint i)) (<= (t1bqtint i) 2))))
...
(assert (<= 0 i1))
(assert (<= i1 2))
(assert (= (to_rep1 o) (to_rep (select input_array i1))))
(assert (= o1 (store result__ i1 o)))
(assert (= (mk_map__ref1 result1) (mk_map__ref1 result__)))
(assert (= result__1 o1))
(assert (forall ((k1 Int)) (=> (and (<= 0 k1) (<= k1 i2)) (= (to_rep1 (select result__2 k1)) (to_rep (select input_array k1))))))
(assert (and (and (forall ((temp___190 Int)) (=> (and (<= 0 temp___190) (<= temp___190 2)) (=> (or (< 2 temp___190) (or (< temp___190 0) (< i2 temp___190))) (= (select result__2 temp___190) (select result__ temp___190))))) (=> (<= 0 2) (in_range5 i2))) (and (<= 0 i2) (<= i2 2))))
(assert (<= 0 k))
(assert (<= k i2))
(assert (and (<= 0 k) (<= k 2)))
(assert (= o2 k))
(assert (= o3 (select input_array o2)))
(assert (= o4 (to_rep o3)))
(assert (not (<= 0 k)))
(check-sat)
(exit)
