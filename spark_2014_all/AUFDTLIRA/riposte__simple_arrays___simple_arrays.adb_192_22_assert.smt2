...
(assert (forall ((temp___414 (Array Int integer))) (forall ((temp___415 Int) (temp___416 Int)) (let ((temp___413 (temp___412 temp___414 temp___415 temp___416))) (forall ((temp___417 Int)) (ite (= temp___417 temp___415) (= (select temp___413 temp___417) (of_rep temp___416)) (= (select temp___413 temp___417) (select temp___414 temp___417))))))))
(assert (in_range1 i))
(assert (= (bool_eq a (- 2147483648) 2147483647 (temp___412 a i 42) (- 2147483648) 2147483647) true))
