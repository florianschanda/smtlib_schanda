...
(assert (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 5)) (and (<= 97 (to_rep (select (rec__arrays__string_t__elem (us_split_fields1 s)) i))) (<= (to_rep (select (rec__arrays__string_t__elem (us_split_fields1 s)) i)) 122)))) (< 1 (to_rep1 (rec__arrays__string_t__len (us_split_fields1 s))))))
(assert (not (<= (to_rep (select (rec__arrays__string_t__elem (us_split_fields1 s)) (to_rep1 (rec__arrays__string_t__len (us_split_fields1 s))))) 122)))
(check-sat)
(exit)
