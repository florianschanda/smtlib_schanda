...
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i1))) true) (= (find_root (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))) i1 l) l)) (not (= (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i1)) v))))))
(assert (<= 1 i))
(assert (<= i 100))
