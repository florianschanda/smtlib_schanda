...
(assert (= hr15 o132))
(assert (and (= o135 (- y 1)) (in_range5 (- y 1))))
(assert (and (= o133 x) (in_range5 x)))
(assert (and (= o134 (remove (mk___t values2 (mk 1 100)) o133)) (and (dynamic_invariant4 o134 true false true) (and (= (invariant__ o134) true) (and (= (to_rep1 (last (rt o134))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o133 1))) (= (to_rep (select values2 k)) (to_rep (select (elts o134) k))))) (and (forall ((k Int)) (=> (and (<= (+ o133 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select (elts o134) (- k 1)))))) (forall ((k Int)) (=> (and (<= o133 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts o134) k))))))))))))
(assert (not (= (invariant__ o134) true)))
(check-sat)
(exit)
