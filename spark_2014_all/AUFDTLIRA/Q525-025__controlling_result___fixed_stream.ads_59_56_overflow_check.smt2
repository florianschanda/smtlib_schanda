...
(assert (=> (not (< (to_rep1 (first (rt new_val))) 0)) (and (= o14 (- 2147483647 (to_rep1 (first (rt new_val))))) (in_range1 (- 2147483647 (to_rep1 (first (rt new_val))))))))
(assert (=> (not (< (to_rep1 (first (rt new_val))) 0)) (and (= o15 (- i (to_rep1 change__first))) (in_range1 (- i (to_rep1 change__first))))))
(assert (=> (not (< (to_rep1 (first (rt new_val))) 0)) (= result4 (ite (<= o15 o14) true false))))
(assert (=> (= result4 true) (and (= o11 (- i (to_rep1 change__first))) (in_range1 (- i (to_rep1 change__first))))))
(assert (=> (= result4 true) (= o12 (+ o11 (to_rep1 (first (rt new_val)))))))
(assert (=> (= result4 true) (and (= o13 o12) (in_range1 o12))))
(assert (=> (= result4 true) (= result3 (ite (<= o13 (to_rep1 (last (rt new_val)))) true false))))
