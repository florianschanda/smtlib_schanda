...
(assert (and (= temp___657 (nb_blacks c100b)) (and (= (bool_eq11 (select temp___657 0) (mk___rep5 (mk___split_fields5 (of_int 1) (of_rep 0) (of_rep 0)))) true) (forall ((i14 Int)) (=> (and (<= 1 i14) (<= i14 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c100b))) i14))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___657 i14))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___657 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___657 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i14 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___657 i14)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___657 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___657 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i14 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___657 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i14 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___657 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i14 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___657 i14)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c100b)) i14)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___657 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i14 0))))))))))))))
(assert (= o300 (select temp___657 c102b)))
(assert (= o301 (us_split_fields11 o300)))
(assert (= o302 (rec__red_black_trees__black_count__depth o301)))
(assert (= o303 (to_rep o302)))
(assert (= result75 (ite (< o303 n99) true false)))
(assert (= result75 true))
(assert (and (= temp___656 (nb_blacks c100b)) (and (= (bool_eq11 (select temp___656 0) (mk___rep5 (mk___split_fields5 (of_int 1) (of_rep 0) (of_rep 0)))) true) (forall ((i14 Int)) (=> (and (<= 1 i14) (<= i14 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c100b))) i14))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___656 i14))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___656 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___656 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i14 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___656 i14)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___656 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___656 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i14 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___656 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i14 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___656 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i14 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___656 i14)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c100b)) i14)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___656 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i14 0))))))))))))))
(assert (= o304 (select temp___656 y2)))
