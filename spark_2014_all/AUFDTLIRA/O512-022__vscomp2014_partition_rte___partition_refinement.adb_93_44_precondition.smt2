...
(assert (and (= o51 (has_key1 (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields))) c1)) (= (= o51 true) (= (has_key1 (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields))) c1) true))))
(assert (= o52 true))
(assert (= result6 (ite (= o52 true) o51 false)))
(assert (= result6 true))
(assert (and (= o55 (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c1)) (and (in_range7 o55) (= o55 (get (keys (mk___rep d__split_discrs (mk___split_fields d__split_fields))) (get1 (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields))) c1))))))
(assert (= o56 (ite (= o55 (to_rep (select a1 j))) true false)))
(assert (= o57 (ite (not (= o56 true)) true false)))
(assert (not (= (has_key1 (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields))) c1) true)))
(check-sat)
(exit)
