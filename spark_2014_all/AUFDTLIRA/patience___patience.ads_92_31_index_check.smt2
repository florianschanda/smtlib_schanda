...
(assert (and (<= 0 i) (<= i 99)))
(assert (= o13 i))
(assert (= temp___451 (select (rec__patience__state__stacks (us_split_fields1 s)) o13)))
(assert (and (<= 0 k) (<= k 99)))
(assert (= o14 k))
...
(assert (and (<= 0 i) (<= i 99)))
(assert (= o12 i))
(assert (= temp___449 (select (rec__patience__state__stacks (us_split_fields1 s)) o12)))
(assert (not (<= 0 j)))
(check-sat)
(exit)
