...
(declare-const temp___479 (Array Int cardindex))
...
(assert (and (<= 0 i) (<= i 99)))
(assert (= o13 i))
(assert (= temp___481 (select (rec__patience__state__stacks (us_split_fields1 s)) o13)))
(assert (and (<= 0 k) (<= k 99)))
(assert (= o14 k))
(assert (= o15 (select temp___481 o14)))
(assert (= o16 (to_rep1 o15)))
(assert (and (<= 0 i) (<= i 99)))
(assert (= o12 i))
(assert (= temp___479 (select (rec__patience__state__stacks (us_split_fields1 s)) o12)))
(assert (not (<= 0 j)))
(check-sat)
(exit)
