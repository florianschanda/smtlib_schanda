...
(assert (and (= o7 (mem avail3 e1)) (=> (= e1 0) (not (= o7 true)))))
(assert (= (= o8 true) (in_range3 e1)))
(assert (= result5 (ite (= o8 true) o7 false)))
(assert (= (= result4 true) (forall ((e2 Int)) (=> (and (in_range3 e2) (= (mem avail3 e2) true)) (and (<= 1 e2) (<= e2 r2))))))
(assert (=> (= result4 true) (and (= o5 (mem alloc3 e)) (=> (= e 0) (not (= o5 true))))))
(assert (=> (= result4 true) (= (= o6 true) (in_range3 e))))
(assert (=> (= result4 true) (= result6 (ite (= o6 true) o5 false))))
