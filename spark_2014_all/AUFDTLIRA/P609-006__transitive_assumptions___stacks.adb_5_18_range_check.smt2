...
(assert (forall ((top Int)) (forall ((data (Array Int integer))) (! (=> (dynamic_invariant1 top true true true) (dynamic_invariant2 (size top data) true false true)) :pattern ((size top data))))))
(assert (forall ((top Int)) (forall ((data (Array Int integer))) (! (=> (dynamic_invariant1 top true true true) (= (size top data) top)) :pattern ((size top data))))))
(declare-fun is_full (Int (Array Int integer)) Bool)
(declare-fun is_full__function_guard (Bool Int (Array Int integer)) Bool)
(assert true)
(assert (forall ((top Int)) (forall ((data (Array Int integer))) (! (= (= (is_full top data) true) (= (size top data) 10)) :pattern ((is_full top data))))))
