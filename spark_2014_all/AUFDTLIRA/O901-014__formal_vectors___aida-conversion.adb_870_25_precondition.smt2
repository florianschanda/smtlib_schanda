...
(assert (and (= (length source) 7) (forall ((index4 Int)) (=> (and (<= (to_rep1 (first (rt source))) index4) (<= index4 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index4))) true)))))
...
(assert (and (and (forall ((temp___1734 Int)) (=> (and (<= (to_rep1 n__first) temp___1734) (<= temp___1734 (to_rep1 n__last))) (=> (or (< temp___1731 temp___1734) (or (< temp___1734 (to_rep1 (first (rt source)))) (< index2 temp___1734))) (= (select n3 temp___1734) (select n1 temp___1734))))) (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 6)) (dynamic_property5 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 6) index2))) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (+ (to_rep1 (first (rt source))) 6)))))
(assert (not (= index2 temp___1731)))
