...
(assert (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f1 root) i2))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f1 root) j2))) true)) (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f1 root) i2))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f1 root) j2)))) true)) (and (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f2 root) i2))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f2 root) j2))) true)) (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f2 root) i2))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f2 root) j2)))) true)) (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f1 root) j2))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f1 root) i2)))) 1)) (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f2 root) j2))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f2 root) i2)))) 1))))))))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f1 root) i2))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f1 root) j2))) true)) (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f1 root) i2))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f1 root) j2)))) true)) (ite (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f1 root) j2))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f1 root) i2)))) 1)) 0) (< (to_rep (select values j2)) (to_rep (select values i2))) (< (to_rep (select values i2)) (to_rep (select values j2)))))))))))
