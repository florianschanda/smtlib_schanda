...
(assert (and (= o39 (to_rep1 (rec__search_trees__search_tree__root t__split_fields11))) (in_range3 (to_rep1 (rec__search_trees__search_tree__root t__split_fields11)))))
(assert (not (= (valid_root (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) o39) true)))
(check-sat)
(exit)
