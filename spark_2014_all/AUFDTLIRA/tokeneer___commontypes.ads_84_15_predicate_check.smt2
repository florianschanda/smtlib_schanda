...
(assert (= (elts (to_string (attr__ATTRIBUTE_IMAGE x))) temp___342))
(assert (= (mk1 (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE x))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE x)))))) temp___3421))
(assert (not (dynamic_predicate (mk___t1 temp___342 temp___3421))))
(check-sat)
(exit)
