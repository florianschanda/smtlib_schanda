...
(assert (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j7 0))))) n2))
(assert (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j7 1))))) n2))
(assert (not (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 j7)))) (+ n2 1))))
(check-sat)
(exit)
