...
(assert (and (= o (parent (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) i)) (and (in_range4 o) (and (=> (= (valid_root (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) i) true) (= o 0)) (=> (= (size (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2))) 0) (= o 0))))))
(assert (and (= o1 o) (in_range3 o)))
(assert (= result9 (mk_int__ref j1)))
(assert (= j2 o1))
(assert (and (= o2 (position (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) i)) (in_range5 o2)))
