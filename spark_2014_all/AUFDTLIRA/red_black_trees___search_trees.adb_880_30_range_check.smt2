...
(assert (and (= o4 (parent (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) i)) (and (in_range4 o4) (and (=> (= (valid_root (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) i) true) (= o4 0)) (=> (= (size (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2))) 0) (= o4 0))))))
(assert (and (= o5 o4) (in_range3 o4)))
(assert (= result12 (mk_int__ref j11)))
(assert (= j12 o5))
(assert (and (= o6 (position (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) i)) (in_range5 o6)))
(assert (= result13 (mk_int__ref d2)))
(assert (= d3 o6))
(assert (not (in_range3 (to_rep1 t__split_fields))))
(check-sat)
(exit)
