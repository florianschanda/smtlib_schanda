...
(assert (and (= o22 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i 0)) (and (in_range2 o22) (= o22 (peek1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) i 0)))))
(assert (= (mk___rep5 (mk___split_fields5 o23 o24 o25)) (select res2 o22)))
(assert (= o23 o26))
(assert (= o24 o27))
(assert (= o25 o28))
(assert (= o29 o28))
(assert (= o30 (to_rep o29)))
(assert (=> (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) i)) 0) (= o31 1)))
(assert (=> (not (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) i)) 0)) (= o31 0)))
(assert (= o32 (+ o31 o30)))
(assert (and (= o33 o32) (in_range7 o32)))
(assert (= o34 (ite (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res2 i)))) o33) true false)))
...
(assert (= o21 (ite (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 i)))) o20) true false)))
