...
(assert (= o59 (ite (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res2 i1)))) o58) true false)))
(assert (and (= o35 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i1 1)) (and (in_range3 o35) (= o35 (peek1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) i1 1)))))
(assert (= (mk___rep5 (mk___split_fields5 o36 o37 o38)) (select res2 o35)))
(assert (= o36 o39))
(assert (= o37 o40))
(assert (= o38 o41))
(assert (= o42 o40))
(assert (= o43 (to_rep o42)))
(assert (and (= o27 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i1 0)) (and (in_range3 o27) (= o27 (peek1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) i1 0)))))
(assert (= (mk___rep5 (mk___split_fields5 o28 o29 o30)) (select res2 o27)))
(assert (= o28 o31))
(assert (= o29 o32))
(assert (= o30 o33))
(assert (= o34 o32))
(assert (= o44 (to_rep o34)))
(assert (= o45 (ite (< o44 o43) o43 o44)))
(assert (= o46 (+ 1 o45)))
(assert (and (= o47 o46) (in_range1 o46)))
(assert (= o48 (ite (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 i1)))) o47) true false)))
