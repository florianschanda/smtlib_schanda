...
(assert (and (= o39 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i 0)) (and (in_range3 o39) (= o39 (peek1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) i 0)))))
(assert (= (mk___rep5 (mk___split_fields5 o40 o41 o42)) (select res2 o39)))
(assert (= o43 (mk___split_fields5 o40 o41 o42)))
(assert (= o44 (rec__red_black_trees__black_count__count o43)))
(assert (= o45 (to_rep o44)))
(assert (=> (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) i)) 0) (= o46 1)))
(assert (=> (not (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) i)) 0)) (= o46 0)))
(assert (= o47 (+ o46 o45)))
(assert (and (= o48 o47) (in_range1 o47)))
(assert (= o49 (ite (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res2 i)))) o48) true false)))
(assert (and (= o25 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i 1)) (and (in_range3 o25) (= o25 (peek1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) i 1)))))
(assert (= (mk___rep5 (mk___split_fields5 o26 o27 o28)) (select res2 o25)))
(assert (= o26 o29))
(assert (= o27 o30))
(assert (= o28 o31))
(assert (= o32 o30))
...
(assert (= o38 (ite (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 i)))) o37) true false)))
