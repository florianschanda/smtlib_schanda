...
(assert (and (= o (extended_perm aa bb)) (and (in_range4 o) (=> (= (distinct o 0) true) (forall ((ia2 Int)) (=> (and (<= (to_rep1 (first (rt aa))) ia2) (<= ia2 (to_rep1 (last (rt aa))))) (exists ((ib1 Int)) (and (and (<= (to_rep1 (first (rt bb))) ib1) (<= ib1 (to_rep1 (last (rt bb))))) (and (= (to_rep (select (elts aa) ia2)) (to_rep (select (elts bb) ib1))) (= (is_perm (remove aa ia2) (remove bb ib1)) true))))))))))
