...
(assert (= (to_rep3 o12) n1))
(assert (= (to_rep o13) t_length))
(assert (= (to_rep o14) first_col))
(assert (= (to_rep o15) first_line))
(assert (= o16 (mk___split_fields o15 o14 o13 o12)))
(assert (= (to_rep4 o11) 4))
(assert (= o17 (mk___split_discrs o11)))
(assert (= temp___944 (mk___rep o17 o16 true)))
(assert (= t__attr__constrained true))
(assert (not (= (rec__lexer__token__kind (us_split_discrs1 temp___944)) t__split_discrs)))
(check-sat)
(exit)
