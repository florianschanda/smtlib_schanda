...
(assert (= (ite (<= (to_rep1 (first temp___2471)) (to_rep1 (last temp___2471))) (+ (- (to_rep1 (last temp___2471)) (to_rep1 (first temp___2471))) 1) 0) (ite (<= (to_rep1 z__first) (to_rep1 z__last)) (+ (- (to_rep1 z__last) (to_rep1 z__first)) 1) 0)))
(assert (= (mk___t o o1) (mk___t temp___247 temp___2471)))
(assert (= o2 o))
(assert (= result z))
(assert (= z1 o2))
(assert (= (to_rep o3) 1))
(assert (not (<= (to_rep1 z__first) x)))
(check-sat)
(exit)
