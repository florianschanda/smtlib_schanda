...
(assert (= (ite (<= (to_rep1 (first temp___2821)) (to_rep1 (last temp___2821))) (+ (- (to_rep1 (last temp___2821)) (to_rep1 (first temp___2821))) 1) 0) (ite (<= (to_rep1 z__first) (to_rep1 z__last)) (+ (- (to_rep1 z__last) (to_rep1 z__first)) 1) 0)))
