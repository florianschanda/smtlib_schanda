...
(assert (and (= o54 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields5)))) (in_range4 o54)))
(assert (= result2 (ite (= o54 1) true false)))
(assert (=> (= result2 true) (= o58 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields5))))))
(assert (=> (= result2 true) (= o59 (ite (not (= o58 true)) true false))))
(assert (=> (= result2 true) (and (= o55 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields5)))) (in_range6 o55))))
(assert (=> (= result2 true) (= o56 (ite (= o55 3) true false))))
(assert (=> (= result2 true) (= o57 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields5))))))
...
(assert (and (= o49 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields5)))) (in_range6 o49)))
(assert (= o50 (ite (= o49 3) true false)))
(assert (= o51 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields5)))))
(assert (= result3 (ite (= o51 true) o50 false)))
(assert (=> (= result3 true) (and (= o52 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields5)))) (in_range4 o52))))
...
(assert (=> (= result4 true) (and (= o45 (theauthcertrole (us_private__content state20))) (in_range4 o45))))
(assert (=> (= result4 true) (= o46 (ite (= o45 1) true false))))
(assert (=> (= result4 true) (= o43 (authcertvalid (us_private__content state20)))))
(assert (=> (= result4 true) (= o44 (isgood (us_private__content state20)))))
...
(assert (and (= o34 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields5)))) (in_range4 o34)))
(assert (= result5 (ite (= o34 1) true false)))
(assert (=> (= result5 true) (and (= o37 (theauthcertrole (us_private__content state20))) (in_range4 o37))))
(assert (=> (= result5 true) (= o38 (ite (= o37 1) true false))))
(assert (=> (= result5 true) (= o35 (authcertvalid (us_private__content state20)))))
(assert (=> (= result5 true) (= o36 (isgood (us_private__content state20)))))
...
(assert (and (= o29 (thedooralarm (us_private__content state22))) (in_range15 o29)))
...
(assert (and (= o15 (thecurrentdoor (us_private__content state22))) (in_range14 o15)))
...
(assert (and (= o9 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields5)))) (in_range6 o9)))
(assert (= o10 (ite (= o9 4) true false)))
(assert (= o11 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields5)))))
(assert (= o12 (ite (= o11 true) o10 false)))
(assert (= o13 (to_int1 o12)))
(assert (= o14 (ite (= o13 (to_int1 (ite (= (int__content status3) 6) true false))) true false)))
(assert (=> (= (int__content status3) 8) (= o5 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields5))))))
(assert (=> (= (int__content status3) 8) (= o6 (ite (not (= o5 true)) true false))))
(assert (=> (= (int__content status3) 8) (= o3 (islocked (us_private__content state21)))))
(assert (=> (= (int__content status3) 8) (and (= o2 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields5)))) (in_range4 o2))))
(assert (=> (= (int__content status3) 8) (= o4 (ite (= o2 0) true false))))
(assert (=> (= (int__content status3) 8) (= o7 (ite (= o4 true) o3 false))))
(assert (=> (= (int__content status3) 8) (= o8 (ite (= o7 true) o6 false))))
