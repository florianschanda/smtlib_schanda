...
(define-fun dynamic_invariant ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (and (=> (or (= temp___is_init_133 true) (<= (- 2147483648) 2147483647)) (in_range temp___expr_136)) (=> (= temp___do_toplevel_135 true) (=> (= temp___is_init_133 true) (or (and (<= (- 2147483648) temp___expr_136) (<= temp___expr_136 (- 1))) (and (<= 1 temp___expr_136) (<= temp___expr_136 2147483647)))))))
(define-fun dynamic_predicate ((temp___140 Int)) Bool (or (and (<= (- 2147483648) temp___140) (<= temp___140 (- 1))) (and (<= 1 temp___140) (<= temp___140 2147483647))))
...
(define-fun dynamic_invariant1 ((temp___expr_211 (Array Int integer)) (temp___is_init_208 Bool) (temp___skip_constant_209 Bool) (temp___do_toplevel_210 Bool)) Bool (=> (= temp___do_toplevel_210 true) (=> (= temp___is_init_208 true) (forall ((k Int)) (=> (and (<= 1 k) (<= k 10)) (not (= (to_rep1 (select temp___expr_211 k)) 0)))))))
(define-fun default_initial_assumption ((temp___expr_214 (Array Int integer)) (temp___skip_top_level_215 Bool)) Bool (forall ((temp___216 Int)) (=> (and (<= 1 temp___216) (<= temp___216 10)) (= (to_rep1 (select temp___expr_214 temp___216)) 1))))
(define-fun dynamic_predicate1 ((temp___217 (Array Int integer))) Bool (forall ((k Int)) (=> (and (<= 1 k) (<= k 10)) (not (= (to_rep1 (select temp___217 k)) 0)))))
...
(define-fun dynamic_invariant2 ((temp___expr_239 us_rep) (temp___is_init_236 Bool) (temp___skip_constant_237 Bool) (temp___do_toplevel_238 Bool)) Bool (and (=> (= temp___do_toplevel_238 true) (=> (= temp___is_init_236 true) (and (and (not (= (to_rep1 (rec__preds__rec_ok__i (us_split_fields1 temp___expr_239))) 0)) (not (= (to_rep (rec__preds__rec_ok__x (us_split_fields1 temp___expr_239))) 0))) (forall ((k Int)) (=> (and (<= 1 k) (<= k 10)) (not (= (to_rep1 (let ((temp___241 (rec__preds__rec_ok__a (us_split_fields1 temp___expr_239)))) (select temp___241 k))) 0))))))) (and (=> (= temp___is_init_236 true) (let ((temp___243 (to_rep (rec__preds__rec_ok__x (us_split_fields1 temp___expr_239))))) (or (and (<= (- 2147483648) temp___243) (<= temp___243 (- 1))) (and (<= 1 temp___243) (<= temp___243 2147483647))))) (=> (= temp___is_init_236 true) (forall ((k Int)) (=> (and (<= 1 k) (<= k 10)) (not (= (to_rep1 (select (rec__preds__rec_ok__a (us_split_fields1 temp___expr_239)) k)) 0))))))))
(define-fun default_initial_assumption1 ((temp___expr_246 us_rep) (temp___skip_top_level_247 Bool)) Bool (and (and (= (to_rep1 (rec__preds__rec_ok__i (us_split_fields1 temp___expr_246))) 1) (= (to_rep (rec__preds__rec_ok__x (us_split_fields1 temp___expr_246))) 1)) (forall ((temp___250 Int)) (=> (and (<= 1 temp___250) (<= temp___250 10)) (= (to_rep1 (select (rec__preds__rec_ok__a (us_split_fields1 temp___expr_246)) temp___250)) 1)))))
(define-fun dynamic_predicate2 ((temp___251 us_rep)) Bool (and (and (not (= (to_rep1 (rec__preds__rec_ok__i (us_split_fields1 temp___251))) 0)) (not (= (to_rep (rec__preds__rec_ok__x (us_split_fields1 temp___251))) 0))) (forall ((k Int)) (=> (and (<= 1 k) (<= k 10)) (not (= (to_rep1 (let ((temp___253 (rec__preds__rec_ok__a (us_split_fields1 temp___251)))) (select temp___253 k))) 0))))))
...
(declare-const temp___357 Int)
(declare-const temp___359 int_ok)
...
(assert (dynamic_invariant2 (mk___rep (mk___split_fields x__split_fields x__split_fields1 x__split_fields2)) false false true))
(assert (default_initial_assumption1 (mk___rep (mk___split_fields temp___363 temp___3631 temp___3632)) false))
(assert (not (dynamic_predicate2 (mk___rep (mk___split_fields temp___363 temp___3631 temp___3632)))))
(check-sat)
(exit)
