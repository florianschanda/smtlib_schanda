...
(define-fun bool_eq ((a (Array Int element_type)) (a__first Int) (a__last Int) (b (Array Int element_type)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_132 Int)) (=> (and (<= a__first temp___idx_132) (<= temp___idx_132 a__last)) (= (to_rep1 (select a temp___idx_132)) (to_rep1 (select b (+ (- b__first a__first) temp___idx_132))))))) true false))
...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (and (and (and (= (to_rep (rec__bounded_queue_v2__queue_type__max_size (us_split_discrs1 a))) (to_rep (rec__bounded_queue_v2__queue_type__max_size (us_split_discrs1 b)))) (= (to_rep3 (rec__bounded_queue_v2__queue_type__count (us_split_fields1 a))) (to_rep3 (rec__bounded_queue_v2__queue_type__count (us_split_fields1 b))))) (= (to_rep (rec__bounded_queue_v2__queue_type__front (us_split_fields1 a))) (to_rep (rec__bounded_queue_v2__queue_type__front (us_split_fields1 b))))) (= (to_rep (rec__bounded_queue_v2__queue_type__rear (us_split_fields1 a))) (to_rep (rec__bounded_queue_v2__queue_type__rear (us_split_fields1 b))))) (= (bool_eq1 (rec__bounded_queue_v2__queue_type__items (us_split_fields1 a)) (rec__bounded_queue_v2__queue_type__items (us_split_fields1 b))) true)) true false))
...
(define-fun dynamic_invariant ((temp___expr_157 us_rep) (temp___is_init_154 Bool) (temp___skip_constant_155 Bool) (temp___do_toplevel_156 Bool)) Bool (let ((temp___158 (rec__bounded_queue_v2__queue_type__max_size (us_split_discrs1 temp___expr_157)))) (and (dynamic_property1 1 (to_rep temp___158) (first1 (rec__bounded_queue_v2__queue_type__items (us_split_fields1 temp___expr_157))) (last1 (rec__bounded_queue_v2__queue_type__items (us_split_fields1 temp___expr_157)))) (and (= (first1 (rec__bounded_queue_v2__queue_type__items (us_split_fields1 temp___expr_157))) 1) (= (last1 (rec__bounded_queue_v2__queue_type__items (us_split_fields1 temp___expr_157))) (to_rep temp___158))))))
...
(define-fun dynamic_invariant4 ((temp___expr_146 Int) (temp___is_init_143 Bool) (temp___skip_constant_144 Bool) (temp___do_toplevel_145 Bool)) Bool (=> (or (= temp___is_init_143 true) (<= (- 2147483648) 2147483647)) (in_range1 temp___expr_146)))
(assert (dynamic_invariant queue true false true))
(assert (not (= (empty queue) true)))
(assert (not (in_range (to_rep (rec__bounded_queue_v2__queue_type__max_size (us_split_discrs1 queue))))))
(check-sat)
(exit)
