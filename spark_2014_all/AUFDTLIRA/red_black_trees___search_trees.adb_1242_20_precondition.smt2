...
(assert (and (= o1 (size (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)))) (in_range4 o1)))
(assert (= result (ite (< 0 o1) true false)))
(assert (= result true))
(assert (not (= (to_rep (select t_old__split_fields3 l)) v)))
(assert (and (= o (to_rep1 t_old__split_fields)) (in_range3 (to_rep1 t_old__split_fields))))
