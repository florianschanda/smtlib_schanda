...
(assert (not (= (ite (<= (to_rep1 (first2 temp___2491)) (to_rep1 (last2 temp___2491))) (+ (- (to_rep1 (last2 temp___2491)) (to_rep1 (first2 temp___2491))) 1) 0) (ite (<= (to_rep1 (first branch__split_fields1)) (to_rep1 (last branch__split_fields1))) (+ (- (to_rep1 (last branch__split_fields1)) (to_rep1 (first branch__split_fields1))) 1) 0))))
(check-sat)
(exit)
