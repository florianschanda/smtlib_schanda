...
(assert (not (= (ite (<= (to_rep (first2 temp___2491)) (to_rep (last2 temp___2491))) (+ (- (to_rep (last2 temp___2491)) (to_rep (first2 temp___2491))) 1) 0) (ite (<= (to_rep (first branch__split_fields1)) (to_rep (last branch__split_fields1))) (+ (- (to_rep (last branch__split_fields1)) (to_rep (first branch__split_fields1))) 1) 0))))
(check-sat)
(exit)
