...
(assert (<= i8 128))
(assert (<= 1 endidx8))
(assert (and (and (=> (<= r100b 128) (dynamic_property1 r100b 128 i9)) (forall ((temp___1800 Int)) (=> (and (<= 1 temp___1800) (<= temp___1800 128)) (=> (<= i9 temp___1800) (= (select newnameserver8 temp___1800) (select (map__content newnameserver6) temp___1800)))))) (and (<= r100b i9) (<= i9 128))))
(assert (= (to_rep o8) 32))
