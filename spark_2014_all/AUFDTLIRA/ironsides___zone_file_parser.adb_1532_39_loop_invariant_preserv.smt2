...
(assert (= i2 r97b))
(assert (=> (and (<= r97b i2) (<= i2 r98b)) (= temp___1797 endidx8)))
(assert (=> (and (<= r97b i2) (<= i2 r98b)) (= temp___1795 newnameserver1)))
(assert (=> (and (<= r97b i2) (<= i2 r98b)) (= temp___1794 i2)))
(assert (=> (and (<= r97b i2) (<= i2 r98b)) (and (and (<= 1 begidx11) (<= (+ (- endidx8 begidx11) 1) 128)) (= endidx8 temp___1797))))
...
(assert (=> (and (<= r97b i2) (<= i2 r98b)) (and (= temp___1793 o4) (in_range1 o4))))
(assert (=> (and (<= r97b i2) (<= i2 r98b)) (and (<= 1 temp___1793) (<= temp___1793 128))))
(assert (=> (and (<= r97b i2) (<= i2 r98b)) (= o6 temp___1793)))
...
(assert (<= i8 128))
(assert (<= 1 endidx8))
(assert (and (and (=> (<= r100b 128) (dynamic_property1 r100b 128 i9)) (forall ((temp___1802 Int)) (=> (and (<= 1 temp___1802) (<= temp___1802 128)) (=> (or (< 128 temp___1802) (or (< temp___1802 r100b) (<= i9 temp___1802))) (= (select newnameserver8 temp___1802) (select (map__content newnameserver6) temp___1802)))))) (and (<= r100b i9) (<= i9 128))))
(assert (= (to_rep o8) 32))
(assert (= o9 (store newnameserver8 i9 o8)))
(assert (= result9 (mk_map__ref newnameserver8)))
(assert (= newnameserver9 o9))
(assert (not (= i9 128)))
(assert (= result10 (mk_int__ref i9)))
(assert (= i10 (+ i9 1)))
(assert (= i11 (mk_int__ref i10)))
(assert (= newnameserver10 (mk_map__ref newnameserver9)))
(assert (= i12 i10))
(assert (= newnameserver11 newnameserver9))
