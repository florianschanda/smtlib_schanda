...
(assert (<= i17 128))
(assert (<= 1 endidx10))
(assert (and (and (=> (<= r100b 128) (dynamic_property1 r100b 128 i18)) (forall ((temp___1741 Int)) (=> (and (<= 1 temp___1741) (<= temp___1741 128)) (=> (<= i18 temp___1741) (= (select newnameserver12 temp___1741) (select (map__content newnameserver10) temp___1741)))))) (and (<= r100b i18) (<= i18 128))))
(assert (= (to_rep o8) 32))
(assert (= o9 (store newnameserver12 i18 o8)))
(assert (= result13 (mk_map__ref newnameserver12)))
(assert (= newnameserver13 o9))
(assert (not (= i18 128)))
(assert (= result14 (mk_int__ref i18)))
(assert (= i19 (+ i18 1)))
(assert (= i20 (mk_int__ref i19)))
(assert (= newnameserver14 (mk_map__ref newnameserver13)))
(assert (= i21 i19))
(assert (= newnameserver15 newnameserver13))
