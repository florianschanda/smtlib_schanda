...
(define-fun bool_eq ((a (Array Int positive)) (a__first Int) (a__last Int) (b (Array Int positive)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_132 Int)) (=> (and (<= a__first temp___idx_132) (<= temp___idx_132 a__last)) (= (to_rep1 (select a temp___idx_132)) (to_rep1 (select b (+ (- b__first a__first) temp___idx_132))))))) true false))
...
(define-fun dynamic_invariant2 ((temp___expr_192 us_t) (temp___is_init_189 Bool) (temp___skip_constant_190 Bool) (temp___do_toplevel_191 Bool)) Bool (=> (not (= temp___skip_constant_190 true)) (and (dynamic_property2 1 max (first1 temp___expr_192) (last2 temp___expr_192)) (and (= (first1 temp___expr_192) 1) (= (last2 temp___expr_192) max)))))
...
(assert (and (= us 0) (dynamic_property 0 last 0)))
(assert (= o 0))
(assert (= result top))
(assert (= top1 o))
(assert (dynamic_property 0 last top1))
...
(assert (and (= result1 (is_empty top1)) (= (= result1 true) (= top1 0))))
(assert (not (= (is_empty top1) true)))
(check-sat)
(exit)
