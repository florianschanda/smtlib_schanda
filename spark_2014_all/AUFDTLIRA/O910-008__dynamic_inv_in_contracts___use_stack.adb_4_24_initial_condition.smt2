...
(define-fun dynamic_invariant2 ((temp___expr_222 us_t) (temp___is_init_218 Bool) (temp___skip_constant_219 Bool) (temp___do_toplevel_220 Bool) (temp___do_typ_inv_221 Bool)) Bool (=> (not (= temp___skip_constant_219 true)) (and (dynamic_property2 1 max (first1 temp___expr_222) (last2 temp___expr_222)) (and (= (first1 temp___expr_222) 1) (= (last2 temp___expr_222) max)))))
