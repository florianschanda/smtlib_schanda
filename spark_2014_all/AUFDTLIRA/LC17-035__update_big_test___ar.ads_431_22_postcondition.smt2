...
(declare-fun temp___1358 ((Array Int (Array Int (Array Int et1))) Int (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1))))
(assert (forall ((temp___1360 (Array Int (Array Int (Array Int et1))))) (forall ((temp___1361 Int)) (forall ((temp___1362 (Array Int (Array Int et1)))) (let ((temp___1359 (temp___1358 temp___1360 temp___1361 temp___1362))) (forall ((temp___1363 Int)) (ite (= temp___1363 temp___1361) (= (select temp___1359 temp___1363) temp___1362) (= (select temp___1359 temp___1363) (select temp___1360 temp___1363)))))))))
...
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (bool_eq2 a2 1 16 (temp___1358 a i b) 1 16) true)))
(check-sat)
(exit)
