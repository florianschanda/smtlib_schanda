...
(assert (=> (not (= smallest1 current1)) (and (= (to_rep (select o5 o4)) (to_rep (select values smallest1))) (and (= (to_rep (select o5 smallest1)) (to_rep (select values o4))) (forall ((j1 Int)) (=> (and (<= (to_rep values__first) j1) (<= j1 (to_rep values__last))) (=> (and (not (= j1 o4)) (not (= j1 smallest1))) (= (to_rep (select o5 j1)) (to_rep (select values j1))))))))))
