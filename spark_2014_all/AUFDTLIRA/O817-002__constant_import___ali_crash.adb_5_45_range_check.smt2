...
(assert (= s (let ((temp___133 (temp___String_Literal_132 Tuple0))) (of_array (concat1 (singleton1 (of_rep dir_sep) 1) 1 1 temp___133 1 0) 1 (- (+ 1 (+ 1 (ite (<= 1 0) (+ (- 0 1) 1) 0))) 1)))))
(declare-const o Int)
