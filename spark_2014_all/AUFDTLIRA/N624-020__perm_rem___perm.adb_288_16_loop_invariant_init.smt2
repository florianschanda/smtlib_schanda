...
(assert (and (= o (extended_perm aa bb)) (and (in_range3 o) (=> (= (of_int o) true) (forall ((ia2 Int)) (=> (and (<= (to_rep2 (first (rt aa))) ia2) (<= ia2 (to_rep2 (last (rt aa))))) (exists ((ib Int)) (and (and (<= (to_rep2 (first (rt bb))) ib) (<= ib (to_rep2 (last (rt bb))))) (and (= (to_rep (select (elts aa) ia2)) (to_rep (select (elts bb) ib))) (= (is_perm (remove aa ia2) (remove bb ib)) true))))))))))
