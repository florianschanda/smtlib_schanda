...
(assert (and (= o (extended_perm aa bb)) (and (in_range3 o) (=> (= (distinct o 0) true) (forall ((ia2 Int)) (=> (and (<= (to_rep2 (first (rt aa))) ia2) (<= ia2 (to_rep2 (last (rt aa))))) (exists ((ib Int)) (and (and (<= (to_rep2 (first (rt bb))) ib) (<= ib (to_rep2 (last (rt bb))))) (and (= (to_rep (select (elts aa) ia2)) (to_rep (select (elts bb) ib))) (= (is_perm (remove aa ia2) (remove bb ib)) true))))))))))
...
(assert (exists ((ib Int)) (and (and (<= (to_rep2 (first (rt b))) ib) (<= ib (to_rep2 (last (rt b))))) (and (= (to_rep (select (elts a) ia1)) (to_rep (select (elts b) ib))) (= (is_perm (remove a ia1) (remove b ib)) true)))))
(assert (=> (<= (to_rep2 (first (rt a))) (to_rep2 (last (rt a)))) (dynamic_property1 (to_rep2 (first (rt a))) (to_rep2 (last (rt a))) ia1)))
(declare-const k Int)
(assert (<= 1 k))
(assert (<= k ia1))
(assert (not (exists ((ib Int)) (and (and (<= (to_rep2 (first (rt b))) ib) (<= ib (to_rep2 (last (rt b))))) (and (= (to_rep (select (elts a) k)) (to_rep (select (elts b) ib))) (= (is_perm (remove a k) (remove b ib)) true))))))
(check-sat)
(exit)
