...
(assert (= hr12 o99))
(assert (and (= o101 y) (in_range5 y)))
(assert (and (= temp___266 (remove (mk___t values2 (mk 1 100)) o101)) (and (dynamic_invariant4 temp___266 true false true) (and (= (invariant__ temp___266) true) (and (= (to_rep1 (last (rt temp___266))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o101 1))) (= (to_rep (select values2 k)) (to_rep (select (elts temp___266) k))))) (and (forall ((k Int)) (=> (and (<= (+ o101 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select (elts temp___266) (- k 1)))))) (forall ((k Int)) (=> (and (<= o101 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts temp___266) k))))))))))))
(assert (and (<= (to_rep1 (first (rt temp___266))) (- x 1)) (<= (- x 1) (to_rep1 (last (rt temp___266))))))
(assert (= o102 (- x 1)))
(assert (= o103 (select (elts temp___266) o102)))
