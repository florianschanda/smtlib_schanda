...
(assert (and (= o17 (remove b ib1)) (and (dynamic_invariant o17 true false true true) (and (= (invariant__ o17) true) (and (= (to_rep1 (last (rt o17))) (- (to_rep1 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib1 1))) (= (to_rep (select (elts b) k)) (to_rep (select (elts o17) k))))) (and (forall ((k Int)) (=> (and (<= (+ ib1 1) k) (<= k (to_rep1 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select (elts o17) (- k 1)))))) (forall ((k Int)) (=> (and (<= ib1 k) (<= k (- (to_rep1 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select (elts o17) k))))))))))))
(assert (and (= o19 (remove o17 o18)) (and (dynamic_invariant o19 true false true true) (and (= (invariant__ o19) true) (and (= (to_rep1 (last (rt o19))) (- (to_rep1 (last (rt o17))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o18 1))) (= (to_rep (select (elts o17) k)) (to_rep (select (elts o19) k))))) (and (forall ((k Int)) (=> (and (<= (+ o18 1) k) (<= k (to_rep1 (last (rt o17))))) (= (to_rep (select (elts o17) k)) (to_rep (select (elts o19) (- k 1)))))) (forall ((k Int)) (=> (and (<= o18 k) (<= k (- (to_rep1 (last (rt o17))) 1))) (= (to_rep (select (elts o17) (+ k 1))) (to_rep (select (elts o19) k))))))))))))
(assert (and (= o16 (remove bb ib1)) (and (dynamic_invariant o16 true false true true) (and (= (invariant__ o16) true) (and (= (to_rep1 (last (rt o16))) (- (to_rep1 (last (rt bb))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib1 1))) (= (to_rep (select (elts bb) k)) (to_rep (select (elts o16) k))))) (and (forall ((k Int)) (=> (and (<= (+ ib1 1) k) (<= k (to_rep1 (last (rt bb))))) (= (to_rep (select (elts bb) k)) (to_rep (select (elts o16) (- k 1)))))) (forall ((k Int)) (=> (and (<= ib1 k) (<= k (- (to_rep1 (last (rt bb))) 1))) (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select (elts o16) k))))))))))))
(assert (and (= o15 ia1) (in_range3 ia1)))
(assert (not (<= (to_rep1 (first (rt a))) o15)))
(check-sat)
(exit)
