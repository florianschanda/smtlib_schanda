...
(assert (and (and (and (forall ((temp___171 Int)) (=> (and (<= 1 temp___171) (<= temp___171 10)) (=> (< index2 temp___171) (= (select dest2 temp___171) (select dest temp___171))))) (forall ((temp___173 Int)) (=> (and (<= 1 temp___173) (<= temp___173 10)) (=> (< index2 temp___173) (= (select src2 temp___173) (select src temp___173)))))) (=> (<= 1 10) (in_range3 index2))) (and (<= 1 index2) (<= index2 10))))
(assert (= (= o7 true) (forall ((j1 Int)) (=> (and (<= (+ index2 1) j1) (<= j1 10)) (= (to_rep (select src2 j1)) (to_rep (select src j1)))))))
(assert (<= 1 j))
(assert (<= j index2))
(assert (and (<= 1 j) (<= j 10)))
(assert (= o4 j))
