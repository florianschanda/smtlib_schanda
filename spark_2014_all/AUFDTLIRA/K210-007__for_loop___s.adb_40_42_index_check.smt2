...
(assert (and (and (and (forall ((temp___195 Int)) (=> (and (<= 1 temp___195) (<= temp___195 10)) (=> (< index2 temp___195) (= (select dest2 temp___195) (select dest temp___195))))) (forall ((temp___197 Int)) (=> (and (<= 1 temp___197) (<= temp___197 10)) (=> (< index2 temp___197) (= (select src2 temp___197) (select src temp___197)))))) (=> (<= 1 10) (in_range3 index2))) (and (<= 1 index2) (<= index2 10))))
