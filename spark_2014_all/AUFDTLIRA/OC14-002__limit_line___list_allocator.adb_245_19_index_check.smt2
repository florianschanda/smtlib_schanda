...
(assert (= result11 (ite (in_range7 o62) true false)))
...
(assert (=> (= result12 true) (and (= o60 (+ j 1)) (in_range1 (+ j 1)))))
(assert (=> (= result12 true) (and (= o61 (get (rec__list_allocator__m__t__allocated model____split_fields3) o60)) (in_range4 o61))))
(assert (=> (not (= result12 true)) (= o61 0)))
(assert (and (= temp___459 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (in_range4 temp___459)))
(assert (not (<= temp___459 3)))
(check-sat)
(exit)
