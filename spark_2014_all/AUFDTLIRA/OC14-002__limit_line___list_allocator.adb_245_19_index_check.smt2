...
(assert (=> (= result12 true) (and (= o62 (get (rec__list_allocator__m__t__allocated model____split_fields3) o61)) (in_range7 o62))))
(assert (=> (not (= result12 true)) (= o62 0)))
(assert (and (= temp___459 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (in_range7 temp___459)))
(assert (not (<= 1 temp___459)))
(check-sat)
(exit)
