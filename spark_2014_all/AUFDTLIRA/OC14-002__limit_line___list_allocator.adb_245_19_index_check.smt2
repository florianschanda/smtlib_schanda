...
(assert (and (= o72 (get (rec__list_allocator__m__t__allocated model____split_fields4) j2)) (in_range7 o72)))
(assert (= result15 (ite (in_range4 o72) true false)))
(assert (= result15 true))
(assert (and (= o69 (length (rec__list_allocator__m__t__allocated model____split_fields4))) (in_range6 o69)))
(assert (= result16 (ite (< j2 o69) true false)))
(assert (=> (= result16 true) (and (= o70 (+ j2 1)) (in_range1 (+ j2 1)))))
(assert (=> (= result16 true) (and (= o71 (get (rec__list_allocator__m__t__allocated model____split_fields4) o70)) (in_range7 o71))))
(assert (=> (not (= result16 true)) (= o71 0)))
(assert (and (= temp___426 (get (rec__list_allocator__m__t__allocated model____split_fields4) j2)) (in_range7 temp___426)))
(assert (not (<= 1 temp___426)))
(check-sat)
(exit)
