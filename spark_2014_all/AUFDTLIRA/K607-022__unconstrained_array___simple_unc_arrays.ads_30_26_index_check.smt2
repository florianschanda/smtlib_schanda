...
(assert (=> (< low1 high1) (and (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- low2 1))) (= (to_rep2 (select a__split_fields4 j1)) (to_rep2 (select temp___825 (+ (- (to_rep (rec__simple_unc_arrays__table__last a__split_discrs)) j1) 1)))))) (forall ((j1 Int)) (=> (and (<= (- low2 1) j1) (<= j1 (to_rep (rec__simple_unc_arrays__table__last a__split_discrs)))) (= (to_rep2 (select a__split_fields4 j1)) (to_rep2 (select temp___829 j1))))))))
...
(assert (and (= temp___837 (+ (- (to_rep (rec__simple_unc_arrays__table__last a__split_discrs)) j) 1)) (in_range1 (+ (- (to_rep (rec__simple_unc_arrays__table__last a__split_discrs)) j) 1))))
(assert (and (<= (to_rep1 (first2 a__split_fields1)) temp___837) (<= temp___837 (to_rep1 (last2 a__split_fields1)))))
