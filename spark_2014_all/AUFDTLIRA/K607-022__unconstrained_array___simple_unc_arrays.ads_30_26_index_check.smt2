...
(assert (<= 1 j2))
(assert (<= j2 (to_rep (rec__simple_unc_arrays__table__last a__split_discrs))))
(assert (and (= temp___831 (+ (- (to_rep (rec__simple_unc_arrays__table__last a__split_discrs)) j2) 1)) (in_range1 (+ (- (to_rep (rec__simple_unc_arrays__table__last a__split_discrs)) j2) 1))))
(assert (and (<= (to_rep1 (first2 a__split_fields1)) temp___831) (<= temp___831 (to_rep1 (last2 a__split_fields1)))))
(assert (= o12 temp___831))
(assert (= o13 (select a__split_fields o12)))
(assert (= o14 (to_rep2 o13)))
(assert (not (<= (to_rep1 (first2 (rt1 (rec__simple_unc_arrays__table__v (us_split_fields__content a__split_fields13))))) j2)))
(check-sat)
(exit)
