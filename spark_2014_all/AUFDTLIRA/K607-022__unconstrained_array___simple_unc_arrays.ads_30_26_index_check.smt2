...
(assert (=> (< low1 high1) (and (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- low2 1))) (= (to_rep2 (select a__split_fields4 j1)) (to_rep2 (select temp___904 (+ (- (to_rep (rec__simple_unc_arrays__table__last a__split_discrs)) j1) 1)))))) (forall ((j1 Int)) (=> (and (<= (- low2 1) j1) (<= j1 (to_rep (rec__simple_unc_arrays__table__last a__split_discrs)))) (= (to_rep2 (select a__split_fields4 j1)) (to_rep2 (select temp___908 j1))))))))
...
(assert (and (= temp___916 (+ (- (to_rep (rec__simple_unc_arrays__table__last a__split_discrs)) j) 1)) (in_range1 (+ (- (to_rep (rec__simple_unc_arrays__table__last a__split_discrs)) j) 1))))
(assert (and (<= (to_rep1 (first2 a__split_fields1)) temp___916) (<= temp___916 (to_rep1 (last2 a__split_fields1)))))
(assert (= o5 temp___916))
(assert (= o6 (select a__split_fields o5)))
(assert (= o7 (to_rep2 o6)))
(assert (not (<= (to_rep1 (first2 (rt1 (rec__simple_unc_arrays__table__v (us_split_fields__content a__split_fields11))))) j)))
(check-sat)
(exit)
