...
(assert (and (<= (to_rep1 (first a__split_fields1)) temp___909) (<= temp___909 (to_rep1 (last a__split_fields1)))))
(assert (= o5 temp___909))
(assert (= o6 (select a__split_fields o5)))
(assert (= o7 (to_rep2 o6)))
(assert (not (<= j (to_rep1 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields__content a__split_fields11))))))))
(check-sat)
(exit)
