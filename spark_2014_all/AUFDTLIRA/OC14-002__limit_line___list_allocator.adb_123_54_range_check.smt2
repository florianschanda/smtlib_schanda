...
(assert (and (= o53 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (in_range7 o53)))
(assert (= result12 (ite (in_range4 o53) true false)))
(assert (=> (= result12 true) (and (= o49 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range6 o49))))
(assert (=> (= result12 true) (= result13 (ite (< j o49) true false))))
(assert (=> (= result12 true) (=> (= result13 true) (and (= o50 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result12 true) (=> (= result13 true) (and (= o51 (get (rec__list_allocator__m__t__allocated model____split_fields3) o50)) (in_range7 o51)))))
...
(assert (=> (= result12 true) (= o45 temp___433)))
(assert (=> (= result12 true) (= o46 (select data3 o45))))
(assert (=> (= result12 true) (= o47 (us_split_fields1 o46))))
(assert (=> (= result12 true) (= o48 (rec__list_allocator__cell__next o47))))
