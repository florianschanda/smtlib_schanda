...
(assert (and (= o6 (length alloc3)) (in_range2 o6)))
(assert (and (= o7 (length avail3)) (in_range2 o7)))
(assert (= o8 (+ o7 o6)))
(assert (and (= o9 o8) (in_range5 o8)))
(assert (= result5 (ite (= o9 r2) true false)))
(assert (=> (= result5 true) (and (= o4 (contains avail3 e1)) (=> (= (distinct 1 0) true) (=> (exists ((e2 Int)) (and (and (in_range1 e2) (= (contains avail3 e2) true)) (= e2 e1))) (= o4 true))))))
(assert (=> (= result5 true) (= (= o5 true) (in_range1 e1))))
...
(assert (=> (= result4 true) (and (= o2 (contains alloc3 e)) (=> (= (distinct 1 0) true) (=> (exists ((e2 Int)) (and (and (in_range1 e2) (= (contains alloc3 e2) true)) (= e2 e))) (= o2 true))))))
