...
(assert (<= (to_rep1 (first (rt source))) i1))
(assert (<= i1 (to_rep1 (last (rt source)))))
(assert (and (= o3 (is_digit (to_rep (select (elts source) i1)))) (ite (= (= (to_rep (select (elts source) i1)) 48) true) (= o3 true) (ite (= (= (to_rep (select (elts source) i1)) 49) true) (= o3 true) (ite (= (= (to_rep (select (elts source) i1)) 50) true) (= o3 true) (ite (= (= (to_rep (select (elts source) i1)) 51) true) (= o3 true) (ite (= (= (to_rep (select (elts source) i1)) 52) true) (= o3 true) (ite (= (= (to_rep (select (elts source) i1)) 53) true) (= o3 true) (ite (= (= (to_rep (select (elts source) i1)) 54) true) (= o3 true) (ite (= (= (to_rep (select (elts source) i1)) 55) true) (= o3 true) (ite (= (= (to_rep (select (elts source) i1)) 56) true) (= o3 true) (ite (= (= (to_rep (select (elts source) i1)) 57) true) (= o3 true) (ite (= (> (to_rep (select (elts source) i1)) 57) true) (not (= o3 true)) (=> (= (< (to_rep (select (elts source) i1)) 48) true) (not (= o3 true))))))))))))))))
(assert (= result2 (ite (not (= o3 true)) true false)))
(assert (not (= result2 true)))
(assert (= has_failed4 has_failed3))
(assert (= target4 target3))
(assert (forall ((j Int)) (=> (and (<= (to_rep1 (first (rt source))) j) (<= j i2)) (= (is_digit (to_rep (select (elts source) j))) true))))
(assert (and (and (=> (<= (to_rep1 (first (rt source))) (to_rep1 (last (rt source)))) (dynamic_property2 (to_rep1 (first (rt source))) (to_rep1 (last (rt source))) i2)) (=> (<= (- 2147483648) 2147483647) (in_range1 target5))) (and (<= (to_rep1 (first (rt source))) i2) (<= i2 (to_rep1 (last (rt source)))))))
(assert (not (= i2 (to_rep1 (last (rt source))))))
(assert (= result3 (mk_int__ref i2)))
(assert (= i3 (+ i2 1)))
(assert (and (= o4 (is_digit (to_rep (select (elts source) i3)))) (ite (= (= (to_rep (select (elts source) i3)) 48) true) (= o4 true) (ite (= (= (to_rep (select (elts source) i3)) 49) true) (= o4 true) (ite (= (= (to_rep (select (elts source) i3)) 50) true) (= o4 true) (ite (= (= (to_rep (select (elts source) i3)) 51) true) (= o4 true) (ite (= (= (to_rep (select (elts source) i3)) 52) true) (= o4 true) (ite (= (= (to_rep (select (elts source) i3)) 53) true) (= o4 true) (ite (= (= (to_rep (select (elts source) i3)) 54) true) (= o4 true) (ite (= (= (to_rep (select (elts source) i3)) 55) true) (= o4 true) (ite (= (= (to_rep (select (elts source) i3)) 56) true) (= o4 true) (ite (= (= (to_rep (select (elts source) i3)) 57) true) (= o4 true) (ite (= (> (to_rep (select (elts source) i3)) 57) true) (not (= o4 true)) (=> (= (< (to_rep (select (elts source) i3)) 48) true) (not (= o4 true))))))))))))))))
...
(assert (<= j i3))
(assert (not (= (is_digit (to_rep (select (elts source) j))) true)))
(check-sat)
(exit)
