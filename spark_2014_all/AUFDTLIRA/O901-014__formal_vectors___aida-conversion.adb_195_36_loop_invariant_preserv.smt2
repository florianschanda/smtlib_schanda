...
(assert (= o2 (to_rep o1)))
(assert (= result2 (ite (= o2 45) true false)))
(assert (not (= result2 true)))
(assert (not (< 10 (length source))))
(assert (= has_failed21 has_failed2))
(assert (= target21 target2))
(assert (= result18 (mk_int__ref i1)))
(assert (= i19 (to_rep1 (first (rt source)))))
(assert (<= (to_rep1 (first (rt source))) i19))
(assert (<= i19 (to_rep1 (last (rt source)))))
(assert (and (= o13 (is_digit (to_rep (select (elts source) i19)))) (ite (= (= (to_rep (select (elts source) i19)) 48) true) (= o13 true) (ite (= (= (to_rep (select (elts source) i19)) 49) true) (= o13 true) (ite (= (= (to_rep (select (elts source) i19)) 50) true) (= o13 true) (ite (= (= (to_rep (select (elts source) i19)) 51) true) (= o13 true) (ite (= (= (to_rep (select (elts source) i19)) 52) true) (= o13 true) (ite (= (= (to_rep (select (elts source) i19)) 53) true) (= o13 true) (ite (= (= (to_rep (select (elts source) i19)) 54) true) (= o13 true) (ite (= (= (to_rep (select (elts source) i19)) 55) true) (= o13 true) (ite (= (= (to_rep (select (elts source) i19)) 56) true) (= o13 true) (ite (= (= (to_rep (select (elts source) i19)) 57) true) (= o13 true) (ite (= (> (to_rep (select (elts source) i19)) 57) true) (not (= o13 true)) (=> (= (< (to_rep (select (elts source) i19)) 48) true) (not (= o13 true))))))))))))))))
(assert (= result19 (ite (not (= o13 true)) true false)))
(assert (not (= result19 true)))
(assert (= has_failed22 has_failed21))
(assert (= target22 target21))
(assert (forall ((j2 Int)) (=> (and (<= (to_rep1 (first (rt source))) j2) (<= j2 i20)) (= (is_digit (to_rep (select (elts source) j2))) true))))
(assert (and (and (=> (<= (to_rep1 (first (rt source))) (to_rep1 (last (rt source)))) (dynamic_property2 (to_rep1 (first (rt source))) (to_rep1 (last (rt source))) i20)) (=> (<= (- 2147483648) 2147483647) (in_range1 target23))) (and (<= (to_rep1 (first (rt source))) i20) (<= i20 (to_rep1 (last (rt source)))))))
(assert (not (= i20 (to_rep1 (last (rt source))))))
(assert (= result22 (mk_int__ref i20)))
(assert (= i21 (+ i20 1)))
(assert (and (= o14 (is_digit (to_rep (select (elts source) i21)))) (ite (= (= (to_rep (select (elts source) i21)) 48) true) (= o14 true) (ite (= (= (to_rep (select (elts source) i21)) 49) true) (= o14 true) (ite (= (= (to_rep (select (elts source) i21)) 50) true) (= o14 true) (ite (= (= (to_rep (select (elts source) i21)) 51) true) (= o14 true) (ite (= (= (to_rep (select (elts source) i21)) 52) true) (= o14 true) (ite (= (= (to_rep (select (elts source) i21)) 53) true) (= o14 true) (ite (= (= (to_rep (select (elts source) i21)) 54) true) (= o14 true) (ite (= (= (to_rep (select (elts source) i21)) 55) true) (= o14 true) (ite (= (= (to_rep (select (elts source) i21)) 56) true) (= o14 true) (ite (= (= (to_rep (select (elts source) i21)) 57) true) (= o14 true) (ite (= (> (to_rep (select (elts source) i21)) 57) true) (not (= o14 true)) (=> (= (< (to_rep (select (elts source) i21)) 48) true) (not (= o14 true))))))))))))))))
(assert (= result23 (ite (not (= o14 true)) true false)))
(assert (not (= result23 true)))
(assert (= has_failed24 has_failed23))
(assert (= target24 target23))
(declare-const j2 Int)
(assert (<= (to_rep1 (first (rt source))) j2))
(assert (<= j2 i21))
(assert (not (= (is_digit (to_rep (select (elts source) j2))) true)))
(check-sat)
(exit)
