...
(assert (= result9 true))
(assert (and (= o24 (+ x (int__content lcp__result16))) (in_range1 (+ x (int__content lcp__result16)))))
(assert (= o25 (ite (<= o24 (to_rep (last (rt a)))) true false)))
(assert (and (= o23 (+ x (int__content lcp__result16))) (in_range1 (+ x (int__content lcp__result16)))))
(assert (= o26 (ite (<= (to_rep (first (rt a))) o23) true false)))
(assert (= o27 (ite (= o26 true) o25 false)))
(assert (= result11 (ite (not (= o27 true)) true false)))
(assert (=> (= result11 true) (= result10 true)))
(assert (=> (not (= result11 true)) (and (= o19 (+ y (int__content lcp__result16))) (in_range1 (+ y (int__content lcp__result16))))))
(assert (=> (not (= result11 true)) (= o20 (ite (<= o19 (to_rep (last (rt a)))) true false))))
(assert (=> (not (= result11 true)) (and (= o18 (+ y (int__content lcp__result16))) (in_range1 (+ y (int__content lcp__result16))))))
(assert (=> (not (= result11 true)) (= o21 (ite (<= (to_rep (first (rt a))) o18) true false))))
(assert (=> (not (= result11 true)) (= o22 (ite (= o21 true) o20 false))))
(assert (=> (not (= result11 true)) (= result10 (ite (not (= o22 true)) true false))))
