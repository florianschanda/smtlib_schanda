...
(assert (=> (<= (to_rep1 (first4 temp___10781)) (to_rep1 (last4 temp___10781))) (= o (+ (- (to_rep1 (last4 temp___10781)) (to_rep1 (first4 temp___10781))) 1))))
(assert (=> (not (<= (to_rep1 (first4 temp___10781)) (to_rep1 (last4 temp___10781)))) (= o 0)))
(assert (= o1 (+ 1 o)))
(assert (= o2 (+ 1 o1)))
(assert (= o3 (- o2 1)))
