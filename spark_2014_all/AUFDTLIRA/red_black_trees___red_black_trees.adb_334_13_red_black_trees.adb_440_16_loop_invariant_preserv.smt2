...
(assert (not (= n73 100)))
(assert (= result55 (mk_int__ref n73)))
(assert (= n74 (+ n73 1)))
(assert (= n75 (mk_int__ref n74)))
(assert (= n76 n74))
(assert (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c87b) c89b)))) (int__content n75)))
