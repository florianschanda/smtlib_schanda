...
(assert (= (contains (values1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3))) v) true))
(assert (=> (= (int__content i18) 0) (type_invariant1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)))))
(assert (=> (= (int__content i18) 0) (and (= o67 (values1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)))) (ite (= (size (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2))) 0) (= (is_empty o67) true) (and (forall ((i20 Int)) (=> (and (<= 1 i20) (<= i20 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) (to_rep1 t__split_fields)) i20))) true) (= (contains o67 (to_rep (select t__split_fields3 i20))) true)))) (forall ((v1 Int)) (=> (and (<= 0 v1) (<= v1 2147483647)) (=> (= (contains o67 v1) true) (exists ((i20 Int)) (and (and (<= 1 i20) (<= i20 100)) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) (to_rep1 t__split_fields)) i20))) true) (= (to_rep (select t__split_fields3 i20)) v1))))))))))))
(assert (=> (= (int__content i18) 0) (type_invariant1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))))
(assert (=> (= (int__content i18) 0) (and (= o66 (values1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))) (ite (= (size (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14))) 0) (= (is_empty o66) true) (and (forall ((i20 Int)) (=> (and (<= 1 i20) (<= i20 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields__content3 t__split_fields14)))) i20))) true) (= (contains o66 (to_rep (select (rec__search_trees__search_tree__values (us_split_fields__content3 t__split_fields14)) i20))) true)))) (forall ((v1 Int)) (=> (and (<= 0 v1) (<= v1 2147483647)) (=> (= (contains o66 v1) true) (exists ((i20 Int)) (and (and (<= 1 i20) (<= i20 100)) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields__content3 t__split_fields14)))) i20))) true) (= (to_rep (select (rec__search_trees__search_tree__values (us_split_fields__content3 t__split_fields14)) i20)) v1))))))))))))
(assert (=> (= (int__content i18) 0) (and (= result24 (oeq1 o66 o67)) (= (= result24 true) (and (= (ole o66 o67) true) (= (ole o67 o66) true))))))
(assert (=> (not (= (int__content i18) 0)) (= result24 false)))
(assert (=> (= result24 true) (= (= result23 true) (forall ((j10 Int)) (=> (and (<= 1 j10) (<= j10 100)) (= (parent1 (mk___rep3 (us_split_fields__content3 t__split_fields14)) j10) (parent1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)) j10)))))))
(assert (=> (not (= result24 true)) (= result23 false)))
(assert (=> (= result23 true) (= (= result22 true) (forall ((j10 Int)) (=> (and (<= 1 j10) (<= j10 100)) (=> (not (= (parent1 (mk___rep3 (us_split_fields__content3 t__split_fields14)) j10) 0)) (= (position1 (mk___rep3 (us_split_fields__content3 t__split_fields14)) j10) (position1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)) j10))))))))
(assert (=> (not (= result23 true)) (= result22 false)))
(assert (=> (= result22 true) (= (= result21 true) (forall ((j10 Int)) (=> (and (<= 1 j10) (<= j10 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__1 (mk___rep3 (us_split_fields__content3 t__split_fields14))) j10))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3))) j10))) true)))))))
(assert (=> (not (= result22 true)) (= result21 false)))
(assert (=> (= result21 true) (= (= result20 true) (forall ((j10 Int)) (=> (and (<= 1 j10) (<= j10 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3))) j10))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__1 (mk___rep3 (us_split_fields__content3 t__split_fields14))) j10))) true)))))))
...
(assert (<= d1 1))
(assert (type_invariant1 (mk___rep3 (us_split_fields__content3 t__split_fields14))))
(assert (and (= temp___763 (model__1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))) (and (dynamic_invariant9 temp___763 true false true) (= temp___763 (model__ (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields__content3 t__split_fields14))))))))
(assert (= o55 (select temp___763 j)))
(assert (= o56 (us_split_fields1 o55)))
(assert (= result28 (rec__tree_model__path_type__k o56)))
(assert (= result28 true))
(assert (type_invariant1 (mk___rep3 (us_split_fields__content3 t__split_fields14))))
(assert (and (= o57 (peek1 (mk___rep3 (us_split_fields__content3 t__split_fields14)) j d1)) (and (in_range4 o57) (= o57 (peek (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14)) j d1)))))
(assert (type_invariant1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3))))
