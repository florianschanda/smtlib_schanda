...
(declare-const temp___807 (Array Int us_rep1))
...
(assert (<= d1 1))
(assert (type_invariant1 (mk___rep3 (us_split_fields__content3 t__split_fields14))))
(assert (and (= temp___807 (model__1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))) (and (dynamic_invariant9 temp___807 true false true true) (= temp___807 (model__ (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields__content3 t__split_fields14))))))))
(assert (= o29 (select temp___807 j)))
