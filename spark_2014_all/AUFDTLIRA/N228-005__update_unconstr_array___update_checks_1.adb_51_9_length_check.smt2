...
(assert (= o i))
(assert (= (mk___t temp___490 temp___4901) (temp_____aggregate_def_484 (mk___t a (mk (to_rep a__first) (to_rep a__last))) o new_val)))
(assert (not (= (ite (<= (to_rep (first temp___4901)) (to_rep (last temp___4901))) (+ (- (to_rep (last temp___4901)) (to_rep (first temp___4901))) 1) 0) (ite (<= (to_rep a__first) (to_rep a__last)) (+ (- (to_rep a__last) (to_rep a__first)) 1) 0))))
(check-sat)
(exit)
