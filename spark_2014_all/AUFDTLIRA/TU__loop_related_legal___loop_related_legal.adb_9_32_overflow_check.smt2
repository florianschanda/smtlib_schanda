...
(assert (and (and (=> (<= 1 10) (in_range4 n2)) (forall ((temp___169 Int)) (=> (and (<= 1 temp___169) (<= temp___169 10)) (=> (or (< 10 temp___169) (or (< temp___169 1) (< n2 temp___169))) (= (select arr3 temp___169) (select arr temp___169)))))) (and (<= 1 n2) (<= n2 10))))
(assert (not (= n2 10)))
(assert (= n2 result2))
(assert (= n3 (+ n2 1)))
(assert (< (to_rep (select arr3 n3)) 2147483647))
(assert (not (in_range1 (+ (to_rep (select arr3 n3)) 1))))
(check-sat)
(exit)
