...
(assert (forall ((m Int)) (=> (and (<= (- 2147483648) m) (<= m 2147483647)) (=> (and (forall ((n1 Int)) (=> (and (<= 1 n1) (<= n1 i)) (<= (to_rep (select a n1)) m))) (exists ((n1 Int)) (and (and (<= 1 n1) (<= n1 i)) (= (to_rep (select a n1)) m)))) (= m max)))))
(assert (= (= o true) (exists ((n1 Int)) (and (and (<= 1 n1) (<= n1 (- i 1))) (= (to_rep (select a n1)) max)))))
(assert (<= 1 n))
(assert (<= n (- i 1)))
(assert (not (<= n 10)))
(check-sat)
