...
(assert (=> (and (<= temp___443 i_v111) (<= i_v111 (to_rep a_v1__last))) (and (and (= temp___440 a_v18) (and (= temp___438 i_v111) (and (and (forall ((m12 Int)) (=> (and (<= (to_rep a_v1__first) m12) (<= m12 k_1)) (= (to_rep (select a_v110 m12)) (to_rep (select (elts b_v1) m12))))) (forall ((m12 Int)) (=> (and (<= (+ k_1 1) m12) (<= m12 (- i_v112 1))) (= (to_rep (select a_v110 m12)) (to_rep (select (elts c_v1) (- m12 k_1))))))) (and (and (and (=> (<= (+ k_1 1) (to_rep a_v1__last)) (dynamic_property2 (+ k_1 1) (to_rep a_v1__last) i_v112)) (forall ((temp___441 Int)) (=> (and (<= (to_rep a_v1__first) temp___441) (<= temp___441 (to_rep a_v1__last))) (=> (<= i_v112 temp___441) (= (select a_v110 temp___441) (select temp___440 temp___441)))))) (and (<= (+ k_1 1) i_v112) (<= i_v112 (to_rep a_v1__last)))) (and (and (and (and (and (and (and (and (= temp___437 (- i_v112 k_1)) (in_range1 (- i_v112 k_1))) (and (and (<= (to_rep (first (rt c_v1))) temp___437) (<= temp___437 (to_rep (last (rt c_v1))))) (= o24 temp___437))) (= o25 (select (elts c_v1) o24))) (= o26 (to_rep o25))) (= (to_rep o27) o26)) (and (and (and (<= (to_rep a_v1__first) i_v112) (<= i_v112 (to_rep a_v1__last))) (= o28 i_v112)) (= o29 (store a_v110 o28 o27)))) (and (= a_v110 result7) (= a_v111 o29))) (= i_v112 (to_rep a_v1__last))))))) (and (and (= i_v118 (mk_int__ref i_v112)) (= a_v116 (mk_map__ref a_v111))) (and (= i_v119 i_v112) (= a_v117 a_v111))))))
(assert (=> (and (<= temp___443 i_v111) (<= i_v111 (to_rep a_v1__last))) (= i_v120 i_v118)))
(assert (=> (and (<= temp___443 i_v111) (<= i_v111 (to_rep a_v1__last))) (= a_v118 a_v116)))
(assert (=> (and (<= temp___443 i_v111) (<= i_v111 (to_rep a_v1__last))) (= i_v121 i_v119)))
(assert (=> (and (<= temp___443 i_v111) (<= i_v111 (to_rep a_v1__last))) (= a_v119 a_v117)))
(assert (=> (not (and (<= temp___443 i_v111) (<= i_v111 (to_rep a_v1__last)))) (= i_v120 (mk_int__ref i_v111))))
(assert (=> (not (and (<= temp___443 i_v111) (<= i_v111 (to_rep a_v1__last)))) (= a_v118 (mk_map__ref a_v18))))
(assert (=> (not (and (<= temp___443 i_v111) (<= i_v111 (to_rep a_v1__last)))) (= i_v121 i_v111)))
(assert (=> (not (and (<= temp___443 i_v111) (<= i_v111 (to_rep a_v1__last)))) (= a_v119 a_v19)))
(assert (= (= result9 true) (forall ((m12 Int)) (=> (and (<= (to_rep a_v1__first) m12) (<= m12 k_1)) (= (to_rep (select (map__content a_v118) m12)) (to_rep (select (elts b_v1) m12)))))))
(assert (= result9 true))
(assert (<= (+ k_1 1) m4))
(assert (<= m4 (to_rep a_v1__last)))
(assert (and (<= (to_rep (first (rt c_v1))) (- m4 k_1)) (<= (- m4 k_1) (to_rep (last (rt c_v1))))))
(assert (= o30 (- m4 k_1)))
(assert (= o31 (select (elts c_v1) o30)))
(assert (= o32 (to_rep o31)))
(assert (not (<= (to_rep a_v1__first) m4)))
(check-sat)
(exit)
