...
(assert (=> (and (<= temp___443 i_v11) (<= i_v11 (to_rep a_v1__last))) (= temp___440 a_v1)))
(assert (=> (and (<= temp___443 i_v11) (<= i_v11 (to_rep a_v1__last))) (= temp___438 i_v11)))
(assert (=> (and (<= temp___443 i_v11) (<= i_v11 (to_rep a_v1__last))) (and (forall ((m1 Int)) (=> (and (<= (to_rep a_v1__first) m1) (<= m1 k_1)) (= (to_rep (select a_v12 m1)) (to_rep (select (elts b_v1) m1))))) (forall ((m1 Int)) (=> (and (<= (+ k_1 1) m1) (<= m1 (- i_v12 1))) (= (to_rep (select a_v12 m1)) (to_rep (select (elts c_v1) (- m1 k_1)))))))))
(assert (=> (and (<= temp___443 i_v11) (<= i_v11 (to_rep a_v1__last))) (and (and (=> (<= (+ k_1 1) (to_rep a_v1__last)) (dynamic_property2 (+ k_1 1) (to_rep a_v1__last) i_v12)) (forall ((temp___441 Int)) (=> (and (<= (to_rep a_v1__first) temp___441) (<= temp___441 (to_rep a_v1__last))) (=> (<= i_v12 temp___441) (= (select a_v12 temp___441) (select temp___440 temp___441)))))) (and (<= (+ k_1 1) i_v12) (<= i_v12 (to_rep a_v1__last))))))
(assert (=> (and (<= temp___443 i_v11) (<= i_v11 (to_rep a_v1__last))) (and (= temp___437 (- i_v12 k_1)) (in_range1 (- i_v12 k_1)))))
(assert (=> (and (<= temp___443 i_v11) (<= i_v11 (to_rep a_v1__last))) (and (<= (to_rep (first (rt c_v1))) temp___437) (<= temp___437 (to_rep (last (rt c_v1)))))))
(assert (=> (and (<= temp___443 i_v11) (<= i_v11 (to_rep a_v1__last))) (= o temp___437)))
(assert (=> (and (<= temp___443 i_v11) (<= i_v11 (to_rep a_v1__last))) (= o1 (select (elts c_v1) o))))
(assert (=> (and (<= temp___443 i_v11) (<= i_v11 (to_rep a_v1__last))) (= o2 (to_rep o1))))
(assert (=> (and (<= temp___443 i_v11) (<= i_v11 (to_rep a_v1__last))) (= (to_rep o3) o2)))
(assert (=> (and (<= temp___443 i_v11) (<= i_v11 (to_rep a_v1__last))) (and (<= (to_rep a_v1__first) i_v12) (<= i_v12 (to_rep a_v1__last)))))
(assert (=> (and (<= temp___443 i_v11) (<= i_v11 (to_rep a_v1__last))) (= o4 i_v12)))
(assert (=> (and (<= temp___443 i_v11) (<= i_v11 (to_rep a_v1__last))) (= o5 (store a_v12 o4 o3))))
(assert (=> (and (<= temp___443 i_v11) (<= i_v11 (to_rep a_v1__last))) (= a_v12 result1)))
(assert (=> (and (<= temp___443 i_v11) (<= i_v11 (to_rep a_v1__last))) (= a_v13 o5)))
(assert (=> (and (<= temp___443 i_v11) (<= i_v11 (to_rep a_v1__last))) (= i_v12 (to_rep a_v1__last))))
(assert (=> (and (<= temp___443 i_v11) (<= i_v11 (to_rep a_v1__last))) (= i_v13 (mk_int__ref i_v12))))
(assert (=> (and (<= temp___443 i_v11) (<= i_v11 (to_rep a_v1__last))) (= a_v14 (mk_map__ref a_v13))))
(assert (=> (and (<= temp___443 i_v11) (<= i_v11 (to_rep a_v1__last))) (= i_v14 i_v12)))
(assert (=> (and (<= temp___443 i_v11) (<= i_v11 (to_rep a_v1__last))) (= a_v15 a_v13)))
(assert (=> (and (<= temp___443 i_v11) (<= i_v11 (to_rep a_v1__last))) (= i_v15 i_v13)))
(assert (=> (and (<= temp___443 i_v11) (<= i_v11 (to_rep a_v1__last))) (= a_v16 a_v14)))
(assert (=> (and (<= temp___443 i_v11) (<= i_v11 (to_rep a_v1__last))) (= i_v16 i_v14)))
(assert (=> (and (<= temp___443 i_v11) (<= i_v11 (to_rep a_v1__last))) (= a_v17 a_v15)))
(assert (=> (not (and (<= temp___443 i_v11) (<= i_v11 (to_rep a_v1__last)))) (= i_v15 (mk_int__ref i_v11))))
(assert (=> (not (and (<= temp___443 i_v11) (<= i_v11 (to_rep a_v1__last)))) (= a_v16 (mk_map__ref a_v1))))
(assert (=> (not (and (<= temp___443 i_v11) (<= i_v11 (to_rep a_v1__last)))) (= i_v16 i_v11)))
(assert (=> (not (and (<= temp___443 i_v11) (<= i_v11 (to_rep a_v1__last)))) (= a_v17 a_v11)))
