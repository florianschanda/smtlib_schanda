...
(assert (<= j 100))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o42 (valid_root (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j)) (and (= (= o42 true) (and (<= j (to_rep f__split_fields)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 j)))) 2))) (=> (< (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) j) (not (= o42 true))))))
(assert (= result7 (ite (and (= o42 true) (not (= j v))) true false)))
(assert (= result7 true))
