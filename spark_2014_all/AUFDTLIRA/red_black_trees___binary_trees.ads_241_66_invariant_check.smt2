...
(assert (<= j8 100))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o94 (valid_root (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j8)) (and (= (= o94 true) (and (<= j8 (to_rep f__split_fields)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 j8)))) 2))) (=> (< (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) j8) (not (= o94 true))))))
(assert (= result11 (ite (and (= o94 true) (not (= j8 v))) true false)))
