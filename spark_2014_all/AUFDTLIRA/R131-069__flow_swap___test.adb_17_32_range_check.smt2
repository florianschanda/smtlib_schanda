...
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_575 us_void_param) 1)) 44) (= (to_rep (select (temp___String_Literal_575 us_void_param) 2)) 32)) :pattern ((temp___String_Literal_575 us_void_param)))))
...
(assert (= result3 a1))
(assert (= a2 tmp))
(assert (not (= (length (to_string (attr__ATTRIBUTE_IMAGE a2))) 0)))
(assert (=> (<= 1 2) (= o (+ (- 2 1) 1))))
(assert (=> (not (<= 1 2)) (= o 0)))
(assert (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE a2))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE a2)))))) (= o1 (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE a2))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE a2)))))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE a2))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE a2))))))) (= o1 0)))
(assert (= o2 (+ o1 o)))
(assert (= o3 (+ (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE a2))))) o2)))
(assert (= o4 (- o3 1)))
