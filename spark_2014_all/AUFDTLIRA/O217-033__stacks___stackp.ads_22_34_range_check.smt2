...
(assert (forall ((s us_rep)) (! (let ((result (get_model s))) (and (= (length result) (size s)) (dynamic_invariant1 result true false true))) :pattern ((get_model s)))))
(assert (forall ((attr__tag2 Int)) (forall ((s us_rep)) (! (let ((result (get_model1 attr__tag2 s))) (and (= (length result) (size s)) (dynamic_invariant1 result true false true))) :pattern ((get_model1 attr__tag2 s))))))
...
(declare-fun user_eq10 (t15s t15s) Bool)
(declare-const dummy10 t15s)
(declare-datatypes () ((t15s__ref (mk_t15s__ref (t15s__content t15s)))))
(define-fun t15s__ref___projection ((a t15s__ref)) t15s (t15s__content a))
(declare-fun temp___197 (Int) (Array Int element))
(assert (forall ((temp___199 Int)) (= (select (temp___197 temp___199) 1) (of_rep temp___199))))
...
(define-fun default_initial_assumption1 ((temp___expr_276 us_rep) (temp___skip_top_level_277 Bool)) Bool (and (and (= (attr__tag temp___expr_276) us_tag1) (= (to_rep1 (rec__stackp__stack_root__length (us_split_fields1 temp___expr_276))) 0)) (=> (not (= temp___skip_top_level_277 true)) (= (size temp___expr_276) 0))))
...
(assert (forall ((s us_rep)) (! (= (get_model__2 s) (let ((temp___298 (let ((temp___296 (to_rep1 (rec__stackp__stack_root__length (us_split_fields1 s))))) (let ((temp___295 1)) (let ((temp___297 (rec__stackp__stack_root__content (us_split_fields1 s)))) (of_array1 temp___297 temp___295 temp___296)))))) (of_array (to_array1 temp___298) (first3 temp___298) (last3 temp___298)))) :pattern ((get_model__2 s)))))
...
(declare-const dummy13 telement_arrayD1)
...
(define-fun dynamic_property3 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range3 low) (and (in_range3 high) (=> (<= low high) (and (in_range6 low) (in_range6 high))))))
...
(define-fun default_initial_assumption2 ((temp___expr_361 us_rep1) (temp___skip_top_level_362 Bool)) Bool (and (and (= (attr__tag1 temp___expr_361) us_tag2) (and (= (to_rep3 (rec__stackp__buffer__first (us_split_fields3 temp___expr_361))) 1) (= (to_rep1 (rec__stackp__stack_root__length1 (us_split_fields3 temp___expr_361))) 0))) (=> (not (= temp___skip_top_level_362 true)) (= (size (to_base temp___expr_361)) 0))))
...
(assert (forall ((s us_rep1)) (! (= (last6 s) (ite (not (= (wraps_around s) true)) (- (+ (to_rep3 (rec__stackp__buffer__first (us_split_fields3 s))) (to_rep1 (rec__stackp__stack_root__length1 (us_split_fields3 s)))) 1) (- (- (+ (to_rep3 (rec__stackp__buffer__first (us_split_fields3 s))) (to_rep1 (rec__stackp__stack_root__length1 (us_split_fields3 s)))) 1) 100))) :pattern ((last6 s)))))
(declare-const e Int)
(declare-const temp___463 (Array Int element))
(declare-const temp___4631 t)
(declare-const o Int)
...
(assert (in_range1 e1))
(assert (and (= (mk___t temp___463 temp___4631) (get_model (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag))) (and (dynamic_invariant1 (mk___t temp___463 temp___4631) true false true) (= (length (mk___t temp___463 temp___4631)) (size (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag))))))
(assert (not (= (length (mk___t temp___463 temp___4631)) 0)))
(assert (=> (<= 1 1) (= o (+ (- 1 1) 1))))
(assert (=> (not (<= 1 1)) (= o 0)))
(assert (=> (<= (to_rep2 (first temp___4631)) (to_rep2 (last temp___4631))) (= o1 (+ (- (to_rep2 (last temp___4631)) (to_rep2 (first temp___4631))) 1))))
(assert (=> (not (<= (to_rep2 (first temp___4631)) (to_rep2 (last temp___4631)))) (= o1 0)))
(assert (= o2 (+ o1 o)))
(assert (= o3 (+ (to_rep2 (first temp___4631)) o2)))
(assert (= o4 (- o3 1)))
