...
(define-fun s__split_fields3 () us_split_fields (mk___split_fields s__split_fields s__split_fields1 s__split_fields2))
(define-fun temp___4632 () us_t (mk___t temp___463 temp___4631))
(assert (=> (<= 0 2147483647) (in_range1 e)))
(assert (in_range1 e1))
(assert (and (= temp___4632 (get_model (mk___rep s__split_fields3 s__attr__tag))) (and (dynamic_invariant1 temp___4632 true false true) (= (length temp___4632) (size (mk___rep s__split_fields3 s__attr__tag))))))
(assert (not (= (length temp___4632) 0)))
(assert (=> (<= 1 1) (= o (+ (- 1 1) 1))))
(assert (=> (not (<= 1 1)) (= o 0)))
