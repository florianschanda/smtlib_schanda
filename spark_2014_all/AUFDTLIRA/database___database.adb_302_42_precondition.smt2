...
(assert (and (= o7 (currency account accounts_balance)) (and (in_range o7) (= o7 (to_rep (rec__money__amount__currency (us_split_fields1 (rec__database__account_balance__value (us_split_fields5 (select accounts_balance account))))))))))
(assert (= o8 (ite (= o7 (to_rep (rec__money__amount__currency (us_split_fields1 sum)))) true false)))
(assert (= result1 (ite (not (= o8 true)) true false)))
(assert (=> (= result1 true) (= result true)))
(assert (=> (not (= result1 true)) (and (= o9 (balance account links accounts_balance)) (= o9 (rec__database__account_balance__value (us_split_fields5 (select accounts_balance account)))))))
...
(assert (=> (not (= result1 true)) (= o6 (+ o5 (to_rep1 (rec__money__amount__raw (us_split_fields1 sum)))))))
(assert (=> (not (= result1 true)) (= result (ite (< 1000000 o6) true false))))
(assert (not (= result true)))
(assert (not (<= (+ (to_rep1 (rec__money__amount__raw (us_split_fields1 (rec__database__account_balance__value (us_split_fields5 (select accounts_balance account)))))) (to_rep1 (rec__money__amount__raw (us_split_fields1 sum)))) 1000000)))
(check-sat)
(exit)
