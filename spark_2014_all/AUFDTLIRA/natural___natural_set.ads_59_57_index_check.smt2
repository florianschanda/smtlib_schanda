...
(assert (= (= o true) (forall ((i2 Int)) (=> (and (<= (+ (to_rep (rec__natural_set__t__len (us_split_fields1 s))) 1) i2) (<= i2 10)) (= (to_rep1 (select (rec__natural_set__t__m (us_split_fields1 s)) i2)) (- 1))))))
(assert (<= 1 i))
