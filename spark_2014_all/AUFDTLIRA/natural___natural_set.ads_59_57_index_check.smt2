...
(assert (= (= o true) (forall ((i1 Int)) (=> (and (<= (+ (to_rep (rec__natural_set__t__len (us_split_fields1 s))) 1) i1) (<= i1 10)) (= (to_rep1 (select (rec__natural_set__t__m (us_split_fields1 s)) i1)) (- 1))))))
(assert (<= 1 i))
(assert (<= i (to_rep (rec__natural_set__t__len (us_split_fields1 s)))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
