...
(declare-fun user_eq2 (set_index set_index) Bool)
(declare-const dummy2 set_index)
...
(assert (forall ((x element_t)) (! (in_range4 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun dynamic_invariant1 ((temp___expr_173 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool) (temp___do_typ_inv_172 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= (- 1) 2147483647)) (in_range4 temp___expr_173)))
