...
(assert (not (= (length temp___820) 0)))
(assert (=> (<= 1 3) (= o88 (+ (- 3 1) 1))))
(assert (=> (not (<= 1 3)) (= o88 0)))
(assert (=> (<= (to_rep1 (first (rt temp___820))) (to_rep1 (last (rt temp___820)))) (= o89 (+ (- (to_rep1 (last (rt temp___820))) (to_rep1 (first (rt temp___820)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt temp___820))) (to_rep1 (last (rt temp___820))))) (= o89 0)))
(assert (= o90 (+ o89 o88)))
(assert (= o91 (+ (to_rep1 (first (rt temp___820))) o90)))
(assert (= o92 (- o91 1)))
