...
(assert (forall ((temp___262 us_rep)) (forall ((temp___263 Int)) (= (select (temp___260 temp___262) temp___263) temp___262))))
(declare-fun temp___264 (Int Int) (Array Int int5))
(assert (forall ((temp___266 Int) (temp___267 Int)) (let ((temp___265 (temp___264 temp___266 temp___267))) (forall ((temp___268 Int)) (ite (= temp___268 2) (= (select temp___265 temp___268) (of_rep temp___266)) (= (select temp___265 temp___268) (of_rep temp___267)))))))
