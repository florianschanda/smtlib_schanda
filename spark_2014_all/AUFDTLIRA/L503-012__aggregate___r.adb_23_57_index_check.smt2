...
(declare-fun temp___297 (us_rep) (Array Int us_rep))
(declare-fun temp___301 (Int Int) (Array Int int5))
...
(assert (forall ((temp___299 us_rep)) (forall ((temp___300 Int)) (= (select (temp___297 temp___299) temp___300) temp___299))))
(assert (forall ((temp___303 Int) (temp___304 Int)) (let ((temp___302 (temp___301 temp___303 temp___304))) (=> (and (dynamic_invariant1 temp___303 true true true true) (dynamic_invariant1 temp___304 true true true true)) (forall ((temp___305 Int)) (ite (= temp___305 2) (= (to_rep (select temp___302 temp___305)) temp___303) (= (to_rep (select temp___302 temp___305)) temp___304)))))))
