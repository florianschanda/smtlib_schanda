...
(assert (=> (not (= ch eof)) (and (=> (not (= result__2 eof)) (and (= cur_position2 (- cur_position 1)) (= (bool_eq the_file2 1 2147483647 (temp___367 the_file cur_position2 ch) 1 2147483647) true))) (and (in_range2 result__2) (in_range cur_position2)))))
...
(assert (not (= (bool_eq the_file3 1 2147483647 (temp___387 the_file cur_position ch) 1 2147483647) true)))
(check-sat)
(exit)
