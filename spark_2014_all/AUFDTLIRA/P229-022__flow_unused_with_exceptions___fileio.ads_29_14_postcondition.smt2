...
(assert (=> (not (= ch eof)) (and (=> (not (= result__2 eof)) (and (= cur_position2 (- cur_position 1)) (= (bool_eq the_file2 1 2147483647 (temp___361 the_file cur_position2 ch) 1 2147483647) true))) (and (in_range2 result__2) (in_range cur_position2)))))
(assert (=> (not (= ch eof)) (not (= result__2 eof))))
(assert (=> (= ch eof) (= result__2 result__)))
(assert (=> (= ch eof) (= cur_position2 cur_position)))
(assert (=> (= ch eof) (= the_file2 the_file)))
(assert (=> (= ch eof) (= result__2 result__1)))
(assert (=> (= ch eof) (= cur_position2 cur_position1)))
(assert (=> (= ch eof) (= the_file2 the_file1)))
...
(assert (not (= (bool_eq the_file3 1 2147483647 (temp___381 the_file cur_position ch) 1 2147483647) true)))
(check-sat)
(exit)
