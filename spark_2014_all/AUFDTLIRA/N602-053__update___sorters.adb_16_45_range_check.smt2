...
(define-fun temp___2002 () us_t (mk___t temp___200 temp___2001))
...
(assert (= o7 x))
(assert (= temp___2002 (temp___192 (mk___t values (mk (to_rep values__first) (to_rep values__last))) o7 o6 o5 o4)))
...
(assert (= (mk___t temp___201 temp___2011) temp___2002))
