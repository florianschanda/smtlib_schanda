...
(assert (forall ((temp___194 us_t)) (forall ((temp___195 Int) (temp___196 Int) (temp___197 Int) (temp___198 Int)) (let ((temp___193 (temp___192 temp___194 temp___195 temp___196 temp___197 temp___198))) (and (and (= (first1 temp___193) (first1 temp___194)) (= (last1 temp___193) (last1 temp___194))) (forall ((temp___199 Int)) (ite (= temp___199 temp___197) (= (select (to_array temp___193) temp___199) (of_rep temp___198)) (ite (= temp___199 temp___195) (= (select (to_array temp___193) temp___199) (of_rep temp___196)) (= (select (to_array temp___193) temp___199) (select (to_array temp___194) temp___199))))))))))
...
(assert (= o7 x))
(assert (= (mk___t temp___200 temp___2001) (temp___192 (mk___t values (mk (to_rep values__first) (to_rep values__last))) o7 o6 o5 o4)))
(assert (= (ite (<= (to_rep (first temp___2001)) (to_rep (last temp___2001))) (+ (- (to_rep (last temp___2001)) (to_rep (first temp___2001))) 1) 0) (ite (<= (to_rep values__first) (to_rep values__last)) (+ (- (to_rep values__last) (to_rep values__first)) 1) 0)))
(assert (= (mk___t temp___201 temp___2011) (mk___t temp___200 temp___2001)))
(assert (= o8 (slide temp___201 (to_rep (first temp___2011)) (to_rep values__first))))
