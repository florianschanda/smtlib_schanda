...
(assert (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res1 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j7 0))))) n1))
(assert (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res1 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j7 1))))) n1))
(assert (not (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res1 j7)))) n1)))
(check-sat)
(exit)
