...
(assert (= o23 j))
(assert (= o24 (select m o23)))
(assert (= o25 (us_split_fields1 o24)))
(assert (= result4 (rec__tree_model__path_type__k o25)))
(assert (=> (= result4 true) (and (= o17 j) (in_range2 j))))
(assert (=> (= result4 true) (and (= o18 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) o17 0)) (and (in_range3 o18) (= o18 (peek1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) o17 0))))))
