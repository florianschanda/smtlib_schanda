...
(assert (= o6 j))
(assert (= o7 (select m o6)))
(assert (= o8 (us_split_fields7 o7)))
(assert (= result4 (rec__tree_model__path_type__k o8)))
(assert (=> (= result4 true) (and (= o j) (in_range5 j))))
(assert (=> (= result4 true) (and (= o1 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) o 0)) (and (in_range2 o1) (= o1 (peek1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) o 0))))))
