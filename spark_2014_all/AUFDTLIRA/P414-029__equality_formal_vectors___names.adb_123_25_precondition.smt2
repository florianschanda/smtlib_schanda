...
(define-fun in_range6 ((rec__names__entry_tables__vector__capacity1 Int) (a us_rep)) Bool (= rec__names__entry_tables__vector__capacity1 (to_rep3 (rec__names__entry_tables__vector__capacity (us_split_discrs1 a)))))
...
(define-fun dynamic_invariant2 ((temp___expr_631 us_rep) (temp___is_init_627 Bool) (temp___skip_constant_628 Bool) (temp___do_toplevel_629 Bool) (temp___do_typ_inv_630 Bool)) Bool (=> (not (= temp___skip_constant_628 true)) (in_range6 128 temp___expr_631)))
(define-fun default_initial_assumption ((temp___expr_633 us_rep) (temp___skip_top_level_634 Bool)) Bool (and (= (to_rep3 (rec__names__entry_tables__vector__capacity (us_split_discrs1 temp___expr_633))) 128) (=> (not (= temp___skip_top_level_634 true)) (= (is_empty temp___expr_633) true))))
...
(define-fun in_range8 ((rec__names__char_tables__vector__capacity1 Int) (a us_rep1)) Bool (= rec__names__char_tables__vector__capacity1 (to_rep4 (rec__names__char_tables__vector__capacity (us_split_discrs3 a)))))
...
(define-fun dynamic_invariant3 ((temp___expr_454 us_rep1) (temp___is_init_450 Bool) (temp___skip_constant_451 Bool) (temp___do_toplevel_452 Bool) (temp___do_typ_inv_453 Bool)) Bool (=> (not (= temp___skip_constant_451 true)) (in_range8 1024 temp___expr_454)))
(define-fun default_initial_assumption1 ((temp___expr_456 us_rep1) (temp___skip_top_level_457 Bool)) Bool (and (= (to_rep4 (rec__names__char_tables__vector__capacity (us_split_discrs3 temp___expr_456))) 1024) (=> (not (= temp___skip_top_level_457 true)) (= (is_empty1 temp___expr_456) true))))
(declare-const n Int)
...
(assert (forall ((x char_table_index)) (! (= (of_rep5 (to_rep5 x)) x) :pattern ((to_rep5 x)))))
(assert (forall ((x char_table_index)) (! (in_range10 (to_rep5 x)) :pattern ((to_rep5 x)))))
...
(define-fun dynamic_invariant4 ((temp___expr_310 Int) (temp___is_init_306 Bool) (temp___skip_constant_307 Bool) (temp___do_toplevel_308 Bool) (temp___do_typ_inv_309 Bool)) Bool (=> (or (= temp___is_init_306 true) (<= 0 255)) (in_range12 temp___expr_310)))
...
(assert (forall ((x name_id)) (! (in_range4 (to_rep6 x)) :pattern ((to_rep6 x)))))
...
(define-fun bool_eq3 ((a us_rep3) (b us_rep3)) Bool (ite (and (and (= (to_rep5 (rec__names__name_entry__table_index (us_split_fields5 a))) (to_rep5 (rec__names__name_entry__table_index (us_split_fields5 b)))) (= (to_rep2 (rec__names__name_entry__length (us_split_fields5 a))) (to_rep2 (rec__names__name_entry__length (us_split_fields5 b))))) (= (to_rep6 (rec__names__name_entry__next_hash (us_split_fields5 a))) (to_rep6 (rec__names__name_entry__next_hash (us_split_fields5 b))))) true false))
...
(define-fun element1 ((container us_rep) (index Int)) us_rep3 (get1 (model__1 container) index))
...
(define-fun dynamic_invariant9 ((temp___expr_296 Int) (temp___is_init_292 Bool) (temp___skip_constant_293 Bool) (temp___do_toplevel_294 Bool) (temp___do_typ_inv_295 Bool)) Bool (=> (or (= temp___is_init_292 true) (<= 0 2147483646)) (in_range10 temp___expr_296)))
(assert (= l (to_rep2 (rec__names__name_entry__length (us_split_fields5 e)))))
...
(define-fun dynamic_invariant12 ((temp___expr_324 Int) (temp___is_init_320 Bool) (temp___skip_constant_321 Bool) (temp___do_toplevel_322 Bool) (temp___do_typ_inv_323 Bool)) Bool (=> (or (= temp___is_init_320 true) (<= 0 2147483647)) (in_range7 temp___expr_324)))
(define-fun capacity ((container us_rep1)) Int (ite (= (distinct 0 0) true) (to_rep4 (rec__names__char_tables__vector__capacity (us_split_discrs3 container))) 2147483647))
...
(define-fun default_initial_assumption2 ((temp___expr_363 us_rep2) (temp___skip_top_level_364 Bool)) Bool (=> (not (= temp___skip_top_level_364 true)) (= (length1 temp___expr_363) 0)))
...
(define-fun dynamic_invariant13 ((temp___expr_303 Int) (temp___is_init_299 Bool) (temp___skip_constant_300 Bool) (temp___do_toplevel_301 Bool) (temp___do_typ_inv_302 Bool)) Bool (=> (or (= temp___is_init_299 true) (<= 0 2147483646)) (in_range11 temp___expr_303)))
...
(assert (forall ((container us_rep2)) (forall ((position Int)) (! (=> (and (dynamic_invariant14 position true true true true) (and (<= 0 position) (<= position (last2 container)))) (dynamic_invariant15 (get container position) true false true true)) :pattern ((get container position))))))
...
(define-fun capacity1 ((container us_rep)) Int (ite (= (distinct 0 0) true) (to_rep3 (rec__names__entry_tables__vector__capacity (us_split_discrs1 container))) 2147483647))
...
(assert (forall ((container us_rep)) (! (let ((result (length5 container))) (and (<= result (capacity1 container)) (dynamic_invariant17 result true false true true))) :pattern ((length5 container)))))
(define-fun oeq1 ((left us_rep4) (right us_rep4)) Bool (and (= (length2 left) (length2 right)) (ite (forall ((n1 Int)) (=> (and (<= 1 n1) (<= n1 (last3 left))) (= (bool_eq3 (get1 left n1) (get1 right n1)) true))) true false)))
...
(define-fun default_initial_assumption3 ((temp___expr_540 us_rep4) (temp___skip_top_level_541 Bool)) Bool (=> (not (= temp___skip_top_level_541 true)) (= (length2 temp___expr_540) 0)))
(assert (forall ((container us_rep)) (! (= (length2 (model__1 container)) (length5 container)) :pattern ((model__1 container)))))
(assert (forall ((container us_rep)) (! (= (= (is_empty container) true) (= (length5 container) 0)) :pattern ((is_empty container)))))
...
(assert (= 1024 (to_rep4 (rec__names__char_tables__vector__capacity char_table__split_discrs))))
(assert (= 128 (to_rep3 (rec__names__entry_tables__vector__capacity entry_table__split_discrs))))
(assert (in_range4 n))
...
(assert (and (= names__to_string__B_3__e__assume3 (get1 (model__1 (mk___rep entry_table__split_discrs (mk___split_fields entry_table__split_fields))) o)) (= (bool_eq3 names__to_string__B_3__e__assume3 (get1 (model__1 (mk___rep entry_table__split_discrs (mk___split_fields entry_table__split_fields))) o)) true)))
(assert (= names__to_string__B_3__e__assume3 e))
(assert (= (to_rep2 (rec__names__name_entry__length (us_split_fields5 e))) l))
(assert (in_range2 l))
...
(assert (<= 1 i1))
(assert (<= i1 l))
(assert (and (forall ((temp___689 Int)) (=> (and (<= (to_rep1 s__first) temp___689) (<= temp___689 (to_rep1 s__last))) (=> (<= i2 temp___689) (= (select s1 temp___689) (select s temp___689))))) (and (<= 1 i2) (<= i2 l))))
(assert (and (= o1 (+ (to_rep5 (rec__names__name_entry__table_index (us_split_fields5 e))) (- i2 1))) (in_range9 (+ (to_rep5 (rec__names__name_entry__table_index (us_split_fields5 e))) (- i2 1)))))
