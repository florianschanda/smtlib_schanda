...
(define-fun dynamic_invariant2 ((temp___expr_570 us_rep) (temp___is_init_567 Bool) (temp___skip_constant_568 Bool) (temp___do_toplevel_569 Bool)) Bool (=> (not (= temp___skip_constant_568 true)) (in_range6 128 temp___expr_570)))
(define-fun default_initial_assumption ((temp___expr_572 us_rep) (temp___skip_top_level_573 Bool)) Bool (and (= (to_rep3 (rec__names__entry_tables__vector__capacity (us_split_discrs1 temp___expr_572))) 128) (=> (not (= temp___skip_top_level_573 true)) (= (is_empty temp___expr_572) true))))
...
(define-fun dynamic_invariant3 ((temp___expr_404 us_rep1) (temp___is_init_401 Bool) (temp___skip_constant_402 Bool) (temp___do_toplevel_403 Bool)) Bool (=> (not (= temp___skip_constant_402 true)) (in_range8 1024 temp___expr_404)))
(define-fun default_initial_assumption1 ((temp___expr_406 us_rep1) (temp___skip_top_level_407 Bool)) Bool (and (= (to_rep4 (rec__names__char_tables__vector__capacity (us_split_discrs3 temp___expr_406))) 1024) (=> (not (= temp___skip_top_level_407 true)) (= (is_empty1 temp___expr_406) true))))
(declare-const n Int)
...
(define-fun dynamic_invariant4 ((temp___expr_268 Int) (temp___is_init_265 Bool) (temp___skip_constant_266 Bool) (temp___do_toplevel_267 Bool)) Bool (=> (or (= temp___is_init_265 true) (<= 0 255)) (in_range12 temp___expr_268)))
...
(define-fun dynamic_invariant5 ((temp___expr_588 us_t1) (temp___is_init_585 Bool) (temp___skip_constant_586 Bool) (temp___do_toplevel_587 Bool)) Bool (=> (not (= temp___skip_constant_586 true)) (and (dynamic_property2 1 l (first3 temp___expr_588) (last5 temp___expr_588)) (and (= (first3 temp___expr_588) 1) (= (last5 temp___expr_588) l)))))
...
(define-fun dynamic_invariant9 ((temp___expr_256 Int) (temp___is_init_253 Bool) (temp___skip_constant_254 Bool) (temp___do_toplevel_255 Bool)) Bool (=> (or (= temp___is_init_253 true) (<= 0 2147483646)) (in_range10 temp___expr_256)))
...
(define-fun dynamic_invariant11 ((temp___expr_274 Int) (temp___is_init_271 Bool) (temp___skip_constant_272 Bool) (temp___do_toplevel_273 Bool)) Bool (=> (or (= temp___is_init_271 true) (<= (- 1) 2147483647)) (in_range15 temp___expr_274)))
(define-fun dynamic_invariant12 ((temp___expr_280 Int) (temp___is_init_277 Bool) (temp___skip_constant_278 Bool) (temp___do_toplevel_279 Bool)) Bool (=> (or (= temp___is_init_277 true) (<= 0 2147483647)) (in_range7 temp___expr_280)))
(define-fun capacity ((container us_rep1)) Int (ite (= (of_int 0) true) (to_rep4 (rec__names__char_tables__vector__capacity (us_split_discrs3 container))) 2147483647))
...
(assert (forall ((container us_rep1)) (! (let ((result (length4 container))) (and (<= result (capacity container)) (dynamic_invariant12 result true false true))) :pattern ((length4 container)))))
...
(define-fun default_initial_assumption2 ((temp___expr_314 us_rep2) (temp___skip_top_level_315 Bool)) Bool (=> (not (= temp___skip_top_level_315 true)) (= (length1 temp___expr_314) 0)))
...
(define-fun dynamic_invariant13 ((temp___expr_262 Int) (temp___is_init_259 Bool) (temp___skip_constant_260 Bool) (temp___do_toplevel_261 Bool)) Bool (=> (or (= temp___is_init_259 true) (<= 0 2147483646)) (in_range11 temp___expr_262)))
...
(define-fun dynamic_invariant14 ((temp___expr_307 Int) (temp___is_init_304 Bool) (temp___skip_constant_305 Bool) (temp___do_toplevel_306 Bool)) Bool (=> (or (= temp___is_init_304 true) (<= (- 1) 2147483646)) (in_range16 temp___expr_307)))
...
(define-fun dynamic_invariant15 ((temp___expr_301 Int) (temp___is_init_298 Bool) (temp___skip_constant_299 Bool) (temp___do_toplevel_300 Bool)) Bool (=> (or (= temp___is_init_298 true) (<= 0 255)) (in_range17 temp___expr_301)))
(assert (forall ((container us_rep2)) (forall ((position Int)) (! (=> (and (dynamic_invariant14 position true true true) (and (<= 0 position) (<= position (last2 container)))) (dynamic_invariant15 (get container position) true false true)) :pattern ((get container position))))))
...
(define-fun dynamic_invariant16 ((temp___expr_437 Int) (temp___is_init_434 Bool) (temp___skip_constant_435 Bool) (temp___do_toplevel_436 Bool)) Bool (=> (or (= temp___is_init_434 true) (<= 0 2147483647)) (in_range18 temp___expr_437)))
...
(define-fun capacity1 ((container us_rep)) Int (ite (= (of_int 0) true) (to_rep3 (rec__names__entry_tables__vector__capacity (us_split_discrs1 container))) 2147483647))
...
(assert (forall ((container us_rep)) (! (let ((result (length5 container))) (and (<= result (capacity1 container)) (dynamic_invariant17 result true false true))) :pattern ((length5 container)))))
...
(define-fun default_initial_assumption3 ((temp___expr_480 us_rep4) (temp___skip_top_level_481 Bool)) Bool (=> (not (= temp___skip_top_level_481 true)) (= (length2 temp___expr_480) 0)))
...
(define-fun dynamic_invariant18 ((temp___expr_422 Int) (temp___is_init_419 Bool) (temp___skip_constant_420 Bool) (temp___do_toplevel_421 Bool)) Bool (=> (or (= temp___is_init_419 true) (<= 1 2147483647)) (in_range13 temp___expr_422)))
...
(assert (and (= (mk___rep2 (mk___split_fields2 names__to_string__B_3__e__assume names__to_string__B_3__e__assume1 names__to_string__B_3__e__assume2)) (get1 (model__1 (mk___rep entry_table__split_discrs (mk___split_fields entry_table__split_fields))) o)) (= (bool_eq3 (mk___rep2 (mk___split_fields2 names__to_string__B_3__e__assume names__to_string__B_3__e__assume1 names__to_string__B_3__e__assume2)) (get1 (model__1 (mk___rep entry_table__split_discrs (mk___split_fields entry_table__split_fields))) o)) true)))
...
(assert (<= 1 i1))
(assert (<= i1 l))
(assert (and (forall ((temp___626 Int)) (=> (and (<= (to_rep1 s__first) temp___626) (<= temp___626 (to_rep1 s__last))) (=> (<= i2 temp___626) (= (select s1 temp___626) (select s temp___626))))) (and (<= 1 i2) (<= i2 l))))
