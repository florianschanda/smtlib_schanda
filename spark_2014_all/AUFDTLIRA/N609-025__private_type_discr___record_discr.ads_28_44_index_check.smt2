...
(assert (= result4 true))
(assert (and (= temp___270 (get_content (result_ty__content record_discr__search_upto__result8))) (in_range2 temp___270)))
(assert (not (<= (to_rep1 (first (rt (rec__record_discr__interm_result__to_search (us_split_fields3 r))))) temp___270)))
(check-sat)
(exit)
