...
(define-fun dynamic_invariant ((temp___expr_262 us_t1) (temp___is_init_259 Bool) (temp___skip_constant_260 Bool) (temp___do_toplevel_261 Bool)) Bool (and (=> (not (= temp___skip_constant_260 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_262) (last3 temp___expr_262))) (=> (= temp___do_toplevel_261 true) (=> (= temp___is_init_259 true) (and (= (first5 (of_array2 (to_array1 temp___expr_262) (first3 temp___expr_262) (last3 temp___expr_262))) 1) (<= (last3 temp___expr_262) 1000))))))
(define-fun dynamic_predicate ((temp___266 us_t1)) Bool (and (= (first5 (of_array2 (to_array1 temp___266) (first3 temp___266) (last3 temp___266))) 1) (<= (last3 temp___266) 1000)))
(declare-sort fart 0)
...
(define-fun dynamic_invariant1 ((temp___expr_372 Int) (temp___is_init_369 Bool) (temp___skip_constant_370 Bool) (temp___do_toplevel_371 Bool)) Bool (=> (or (= temp___is_init_369 true) (<= 0 2147483647)) (in_range3 temp___expr_372)))
(declare-const x Int)
...
(assert (= (elts (to_string (attr__ATTRIBUTE_IMAGE3 x))) temp___438))
(assert (= (mk1 (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 x))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 x)))))) temp___4381))
(assert (not (dynamic_predicate (mk___t1 temp___438 temp___4381))))
(check-sat)
(exit)
