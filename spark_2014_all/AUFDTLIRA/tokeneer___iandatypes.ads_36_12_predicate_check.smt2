...
(define-fun dynamic_invariant ((temp___expr_274 us_t1) (temp___is_init_271 Bool) (temp___skip_constant_272 Bool) (temp___do_toplevel_273 Bool)) Bool (and (=> (not (= temp___skip_constant_272 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_274) (last3 temp___expr_274))) (=> (= temp___do_toplevel_273 true) (=> (= temp___is_init_271 true) (and (let ((temp___276 (of_array2 (to_array1 temp___expr_274) (first3 temp___expr_274) (last3 temp___expr_274)))) (and (= (first5 temp___276) 1) (<= 0 (last5 temp___276)))) (<= (last3 temp___expr_274) 1000))))))
(define-fun dynamic_predicate ((temp___278 us_t1)) Bool (and (let ((temp___280 (of_array2 (to_array1 temp___278) (first3 temp___278) (last3 temp___278)))) (and (= (first5 temp___280) 1) (<= 0 (last5 temp___280)))) (<= (last3 temp___278) 1000)))
(declare-sort fart 0)
...
(define-fun dynamic_invariant1 ((temp___expr_412 Int) (temp___is_init_409 Bool) (temp___skip_constant_410 Bool) (temp___do_toplevel_411 Bool)) Bool (=> (or (= temp___is_init_409 true) (<= 0 2147483647)) (in_range3 temp___expr_412)))
(declare-const x Int)
...
(define-fun dynamic_invariant6 ((temp___expr_240 us_t2) (temp___is_init_237 Bool) (temp___skip_constant_238 Bool) (temp___do_toplevel_239 Bool)) Bool (and (=> (not (= temp___skip_constant_238 true)) (dynamic_property2 1 2147483647 (first5 temp___expr_240) (last5 temp___expr_240))) (=> (= temp___do_toplevel_239 true) (=> (= temp___is_init_237 true) (and (= (first5 temp___expr_240) 1) (<= 0 (last5 temp___expr_240)))))))
(define-fun dynamic_predicate1 ((temp___243 us_t2)) Bool (and (= (first5 temp___243) 1) (<= 0 (last5 temp___243))))
(declare-const temp___478 (Array Int character))
...
(assert (= (elts (to_string (attr__ATTRIBUTE_IMAGE3 x))) temp___478))
(assert (= (mk1 (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 x))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 x)))))) temp___4781))
(assert (not (dynamic_predicate (mk___t1 temp___478 temp___4781))))
(check-sat)
(exit)
