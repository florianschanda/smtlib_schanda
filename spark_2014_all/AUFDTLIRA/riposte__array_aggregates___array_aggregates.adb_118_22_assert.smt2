...
(declare-fun temp___473 (Int Int Int) (Array Int unsigned_byte))
...
(assert (forall ((temp___475 Int) (temp___476 Int) (temp___477 Int)) (let ((temp___474 (temp___473 temp___475 temp___476 temp___477))) (=> (and (and (dynamic_invariant temp___475 true true true true) (dynamic_invariant temp___476 true true true true)) (dynamic_invariant temp___477 true true true true)) (forall ((temp___478 Int)) (ite (= temp___478 7) (= (to_rep (select temp___474 temp___478)) temp___476) (ite (= temp___478 2) (= (to_rep (select temp___474 temp___478)) temp___475) (= (to_rep (select temp___474 temp___478)) temp___477))))))))
...
(assert (= result x))
(assert (= x1 (temp___473 2 10 8)))
(assert (not (= (to_rep (select x1 4)) 2)))
(check-sat)
(exit)
