...
(declare-fun temp_____aggregate_def_473 (Int Int Int) (Array Int unsigned_byte))
...
(assert (forall ((temp___475 Int) (temp___476 Int) (temp___477 Int)) (let ((temp___474 (temp_____aggregate_def_473 temp___475 temp___476 temp___477))) (=> (and (and (dynamic_invariant temp___475 true true true true) (dynamic_invariant temp___476 true true true true)) (dynamic_invariant temp___477 true true true true)) (forall ((temp___478 Int)) (ite (= temp___478 7) (= (select temp___474 temp___478) rliteral) (ite (= temp___478 2) (= (select temp___474 temp___478) rliteral1) (= (select temp___474 temp___478) rliteral2))))))))
