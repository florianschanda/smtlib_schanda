...
(define-fun dynamic_invariant1 ((temp___expr_2271 Int) (temp___is_init_2267 Bool) (temp___skip_constant_2268 Bool) (temp___do_toplevel_2269 Bool) (temp___do_typ_inv_2270 Bool)) Bool (=> (or (= temp___is_init_2267 true) (<= 0 4)) (in_range7 temp___expr_2271)))
(assert true)
(assert (forall ((p us_rep)) (forall ((a Int)) (! (= (= (move_is_possible p a) true) (ite (= a 0) (in_range2 (- (to_rep1 (rec__patris__piece__x (us_split_fields1 p))) 1)) (ite (= a 1) (in_range2 (+ (to_rep1 (rec__patris__piece__x (us_split_fields1 p))) 1)) (=> (= a 2) (in_range3 (+ (to_rep2 (rec__patris__piece__y (us_split_fields1 p))) 1)))))) :pattern ((move_is_possible p a))))))
...
(assert true)
(assert (forall ((p us_rep)) (forall ((a Int)) (! (=> (dynamic_invariant1 a true true true true) (= (move p a) (ite (= a 0) (mk___rep (let ((usq_ (us_split_fields1 p))) (mk___split_fields (rec__patris__piece__s usq_) (rec__patris__piece__d usq_) (of_rep1 (- (to_rep1 (rec__patris__piece__x (us_split_fields1 p))) 1)) (rec__patris__piece__y usq_)))) (ite (= a 1) (mk___rep (let ((usq_ (us_split_fields1 p))) (mk___split_fields (rec__patris__piece__s usq_) (rec__patris__piece__d usq_) (of_rep1 (+ (to_rep1 (rec__patris__piece__x (us_split_fields1 p))) 1)) (rec__patris__piece__y usq_)))) (ite (= a 2) (mk___rep (let ((usq_ (us_split_fields1 p))) (mk___split_fields (rec__patris__piece__s usq_) (rec__patris__piece__d usq_) (rec__patris__piece__x usq_) (of_rep2 (+ (to_rep2 (rec__patris__piece__y (us_split_fields1 p))) 1))))) (mk___rep (let ((usq_ (us_split_fields1 p))) (mk___split_fields (rec__patris__piece__s usq_) (of_rep3 (turn_direction (to_rep3 (rec__patris__piece__d (us_split_fields1 p))) a)) (rec__patris__piece__x usq_) (rec__patris__piece__y usq_))))))))) :pattern ((move p a))))))
(declare-const a Int)
...
(define-fun dynamic_invariant3 ((temp___expr_2094 Int) (temp___is_init_2090 Bool) (temp___skip_constant_2091 Bool) (temp___do_toplevel_2092 Bool) (temp___do_typ_inv_2093 Bool)) Bool (=> (or (= temp___is_init_2090 true) (<= 0 7)) (in_range6 temp___expr_2094)))
(define-fun dynamic_invariant4 ((temp___expr_2101 Int) (temp___is_init_2097 Bool) (temp___skip_constant_2098 Bool) (temp___do_toplevel_2099 Bool) (temp___do_typ_inv_2100 Bool)) Bool (=> (or (= temp___is_init_2097 true) (<= 1 7)) (in_range1 temp___expr_2101)))
...
(define-fun dynamic_invariant5 ((temp___expr_2115 Int) (temp___is_init_2111 Bool) (temp___skip_constant_2112 Bool) (temp___do_toplevel_2113 Bool) (temp___do_typ_inv_2114 Bool)) Bool (=> (or (= temp___is_init_2111 true) (<= 1 10)) (in_range9 temp___expr_2115)))
...
(define-fun dynamic_invariant6 ((temp___expr_2122 Int) (temp___is_init_2118 Bool) (temp___skip_constant_2119 Bool) (temp___do_toplevel_2120 Bool) (temp___do_typ_inv_2121 Bool)) Bool (=> (or (= temp___is_init_2118 true) (<= 1 20)) (in_range10 temp___expr_2122)))
(assert true)
...
(assert true)
(assert (forall ((b (Array Int (Array Int cell)))) (forall ((y Int) (x Int)) (! (= (= (is_empty b y x) true) (and (and (in_range9 x) (in_range10 y)) (= (to_rep4 (let ((temp___2238 (select b y))) (select temp___2238 x))) 0))) :pattern ((is_empty b y x))))))
...
(define-fun dynamic_invariant10 ((temp___expr_2285 Int) (temp___is_init_2281 Bool) (temp___skip_constant_2282 Bool) (temp___do_toplevel_2283 Bool) (temp___do_typ_inv_2284 Bool)) Bool (=> (or (= temp___is_init_2281 true) (<= 3 4)) (in_range11 temp___expr_2285)))
...
(declare-const temp___2366 shape)
(declare-const temp___23661 direction)
(declare-const temp___23662 px_coord)
(declare-const temp___23663 py_coord)
...
(define-fun temp___23664 () us_rep (mk___rep (mk___split_fields temp___2366 temp___23661 temp___23662 temp___23663)))
...
(assert (or (and (and (and (= candidate__split_fields12 (mk___split_fields__ref candidate__split_fields16)) (and (and (= cur_piece__split_fields12 cur_piece__split_fields8) (and (= cur_piece__split_fields13 cur_piece__split_fields9) (and (= cur_piece__split_fields14 cur_piece__split_fields10) (= cur_piece__split_fields15 cur_piece__split_fields11)))) (= success2 success4))) (and (= candidate__split_fields13 candidate__split_fields16) (and (= cur_piece__split_fields16 cur_piece__split_fields19) (= success5 success2)))) (and (and (= result (move_is_possible (mk___rep (mk___split_fields cur_piece__split_fields cur_piece__split_fields1 cur_piece__split_fields2 cur_piece__split_fields3)) a)) (= (= result true) (ite (= a 0) (in_range2 (- (to_rep1 cur_piece__split_fields2) 1)) (ite (= a 1) (in_range2 (+ (to_rep1 cur_piece__split_fields2) 1)) (=> (= a 2) (in_range3 (+ (to_rep2 cur_piece__split_fields3) 1))))))) (and (= result true) (and (and (and (= temp___23664 (move (mk___rep (mk___split_fields cur_piece__split_fields cur_piece__split_fields1 cur_piece__split_fields2 cur_piece__split_fields3)) a)) (= temp___23664 (ite (= a 0) (mk___rep (mk___split_fields cur_piece__split_fields cur_piece__split_fields1 (of_rep1 (- (to_rep1 cur_piece__split_fields2) 1)) cur_piece__split_fields3)) (ite (= a 1) (mk___rep (mk___split_fields cur_piece__split_fields cur_piece__split_fields1 (of_rep1 (+ (to_rep1 cur_piece__split_fields2) 1)) cur_piece__split_fields3)) (ite (= a 2) (mk___rep (mk___split_fields cur_piece__split_fields cur_piece__split_fields1 cur_piece__split_fields2 (of_rep2 (+ (to_rep2 cur_piece__split_fields3) 1)))) (mk___rep (mk___split_fields cur_piece__split_fields (of_rep3 (turn_direction (to_rep3 cur_piece__split_fields1) a)) cur_piece__split_fields2 cur_piece__split_fields3))))))) (and (= result12 candidate__split_fields17) (and (= temp___2366 candidate__split_fields8) (and (= temp___23661 candidate__split_fields9) (and (= temp___23662 candidate__split_fields10) (= temp___23663 candidate__split_fields11)))))) (and (and (= result5 (no_overlap cur_board (mk___rep candidate__split_fields16))) (= (= result5 true) (ite (= (to_rep candidate__split_fields8) 2) (and (and (and (= (is_empty cur_board (to_rep2 candidate__split_fields11) (to_rep1 candidate__split_fields10)) true) (= (is_empty cur_board (to_rep2 candidate__split_fields11) (+ (to_rep1 candidate__split_fields10) 1)) true)) (= (is_empty cur_board (+ (to_rep2 candidate__split_fields11) 1) (to_rep1 candidate__split_fields10)) true)) (= (is_empty cur_board (+ (to_rep2 candidate__split_fields11) 1) (+ (to_rep1 candidate__split_fields10) 1)) true)) (ite (= (to_rep candidate__split_fields8) 1) (forall ((y Int)) (=> (and (<= 0 y) (<= y 3)) (forall ((x Int)) (=> (and (<= 0 x) (<= x 3)) (=> (= (get (select possible_i_shapes (to_rep3 candidate__split_fields9)) y x) true) (= (is_empty cur_board (+ (to_rep2 candidate__split_fields11) y) (+ (to_rep1 candidate__split_fields10) x)) true)))))) (forall ((y Int)) (=> (and (<= 0 y) (<= y 2)) (forall ((x Int)) (=> (and (<= 0 x) (<= x 2)) (=> (= (get (get1 possible_three_shapes (to_rep candidate__split_fields8) (to_rep3 candidate__split_fields9)) y x) true) (= (is_empty cur_board (+ (to_rep2 candidate__split_fields11) y) (+ (to_rep1 candidate__split_fields10) x)) true)))))))))) (and (= result5 true) (and (and (and (= result6 cur_piece__split_fields) (and (= result7 cur_piece__split_fields1) (and (= result8 cur_piece__split_fields2) (= result9 cur_piece__split_fields3)))) (= cur_piece__split_fields19 candidate__split_fields16)) (and (= result10 success) (= success2 (distinct 1 0)))))))))) (and (and (and (= result (move_is_possible (mk___rep (mk___split_fields cur_piece__split_fields cur_piece__split_fields1 cur_piece__split_fields2 cur_piece__split_fields3)) a)) (= (= result true) (ite (= a 0) (in_range2 (- (to_rep1 cur_piece__split_fields2) 1)) (ite (= a 1) (in_range2 (+ (to_rep1 cur_piece__split_fields2) 1)) (=> (= a 2) (in_range3 (+ (to_rep2 cur_piece__split_fields3) 1))))))) (ite (= result true) (and (and (and (= temp___23664 (move (mk___rep (mk___split_fields cur_piece__split_fields cur_piece__split_fields1 cur_piece__split_fields2 cur_piece__split_fields3)) a)) (= temp___23664 (ite (= a 0) (mk___rep (mk___split_fields cur_piece__split_fields cur_piece__split_fields1 (of_rep1 (- (to_rep1 cur_piece__split_fields2) 1)) cur_piece__split_fields3)) (ite (= a 1) (mk___rep (mk___split_fields cur_piece__split_fields cur_piece__split_fields1 (of_rep1 (+ (to_rep1 cur_piece__split_fields2) 1)) cur_piece__split_fields3)) (ite (= a 2) (mk___rep (mk___split_fields cur_piece__split_fields cur_piece__split_fields1 cur_piece__split_fields2 (of_rep2 (+ (to_rep2 cur_piece__split_fields3) 1)))) (mk___rep (mk___split_fields cur_piece__split_fields (of_rep3 (turn_direction (to_rep3 cur_piece__split_fields1) a)) cur_piece__split_fields2 cur_piece__split_fields3))))))) (and (= result12 candidate__split_fields17) (and (= temp___2366 candidate__split_fields8) (and (= temp___23661 candidate__split_fields9) (and (= temp___23662 candidate__split_fields10) (= temp___23663 candidate__split_fields11)))))) (and (and (= result5 (no_overlap cur_board (mk___rep candidate__split_fields16))) (= (= result5 true) (ite (= (to_rep candidate__split_fields8) 2) (and (and (and (= (is_empty cur_board (to_rep2 candidate__split_fields11) (to_rep1 candidate__split_fields10)) true) (= (is_empty cur_board (to_rep2 candidate__split_fields11) (+ (to_rep1 candidate__split_fields10) 1)) true)) (= (is_empty cur_board (+ (to_rep2 candidate__split_fields11) 1) (to_rep1 candidate__split_fields10)) true)) (= (is_empty cur_board (+ (to_rep2 candidate__split_fields11) 1) (+ (to_rep1 candidate__split_fields10) 1)) true)) (ite (= (to_rep candidate__split_fields8) 1) (forall ((y Int)) (=> (and (<= 0 y) (<= y 3)) (forall ((x Int)) (=> (and (<= 0 x) (<= x 3)) (=> (= (get (select possible_i_shapes (to_rep3 candidate__split_fields9)) y x) true) (= (is_empty cur_board (+ (to_rep2 candidate__split_fields11) y) (+ (to_rep1 candidate__split_fields10) x)) true)))))) (forall ((y Int)) (=> (and (<= 0 y) (<= y 2)) (forall ((x Int)) (=> (and (<= 0 x) (<= x 2)) (=> (= (get (get1 possible_three_shapes (to_rep candidate__split_fields8) (to_rep3 candidate__split_fields9)) y x) true) (= (is_empty cur_board (+ (to_rep2 candidate__split_fields11) y) (+ (to_rep1 candidate__split_fields10) x)) true)))))))))) (and (not (= result5 true)) (and (and (and (= cur_piece__split_fields cur_piece__split_fields8) (and (= cur_piece__split_fields1 cur_piece__split_fields9) (and (= cur_piece__split_fields2 cur_piece__split_fields10) (= cur_piece__split_fields3 cur_piece__split_fields11)))) (= success2 success)) (and (= cur_piece__split_fields19 cur_piece__split_fields20) (= success2 success1)))))) (and (and (and (= candidate__split_fields candidate__split_fields8) (and (= candidate__split_fields1 candidate__split_fields9) (and (= candidate__split_fields2 candidate__split_fields10) (= candidate__split_fields3 candidate__split_fields11)))) (and (and (= cur_piece__split_fields cur_piece__split_fields8) (and (= cur_piece__split_fields1 cur_piece__split_fields9) (and (= cur_piece__split_fields2 cur_piece__split_fields10) (= cur_piece__split_fields3 cur_piece__split_fields11)))) (= success2 success))) (and (and (= candidate__split_fields4 candidate__split_fields8) (and (= candidate__split_fields5 candidate__split_fields9) (and (= candidate__split_fields6 candidate__split_fields10) (= candidate__split_fields7 candidate__split_fields11)))) (and (= cur_piece__split_fields19 cur_piece__split_fields20) (= success2 success1)))))) (and (and (and (= candidate__split_fields12 (mk___split_fields__ref candidate__split_fields16)) (and (and (= cur_piece__split_fields12 cur_piece__split_fields8) (and (= cur_piece__split_fields13 cur_piece__split_fields9) (and (= cur_piece__split_fields14 cur_piece__split_fields10) (= cur_piece__split_fields15 cur_piece__split_fields11)))) (= success3 success4))) (and (= candidate__split_fields13 candidate__split_fields16) (and (= cur_piece__split_fields16 cur_piece__split_fields19) (= success5 success3)))) (and (= result11 success2) (= success3 (distinct 0 0)))))))
