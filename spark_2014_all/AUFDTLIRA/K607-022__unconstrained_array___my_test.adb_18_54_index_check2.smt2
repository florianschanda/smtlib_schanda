...
(declare-const temp___3581 (Array Int value))
(declare-const i Int)
...
(define-fun o11 () us_rep (mk___rep (mk___split_discrs o5) (mk___split_fields (mk___t1 o6 o7))))
...
(assert (and (= o (max (mk___rep t1__split_discrs t1__split_fields2))) (and (in_range5 o) (and (forall ((j Int)) (=> (and (<= 1 j) (<= j (to_rep2 (rec__simple_unc_arrays__table__last t1__split_discrs)))) (<= (to_rep3 (select (elts1 (rec__simple_unc_arrays__table__v t1__split_fields2)) j)) o))) (exists ((j Int)) (and (and (<= 1 j) (<= j (to_rep2 (rec__simple_unc_arrays__table__last t1__split_discrs)))) (= o (to_rep3 (select (elts1 (rec__simple_unc_arrays__table__v t1__split_fields2)) j)))))))))
(assert (and (= o1 (min (mk___rep t1__split_discrs t1__split_fields2))) (and (in_range5 o1) (and (forall ((j Int)) (=> (and (<= 1 j) (<= j (to_rep2 (rec__simple_unc_arrays__table__last t1__split_discrs)))) (<= o1 (to_rep3 (select (elts1 (rec__simple_unc_arrays__table__v t1__split_fields2)) j))))) (exists ((j Int)) (and (and (<= 1 j) (<= j (to_rep2 (rec__simple_unc_arrays__table__last t1__split_discrs)))) (= o1 (to_rep3 (select (elts1 (rec__simple_unc_arrays__table__v t1__split_fields2)) j)))))))))
(assert (and (= o2 (average (mk___rep t1__split_discrs t1__split_fields2))) (and (in_range5 o2) (and (<= (min (mk___rep t1__split_discrs t1__split_fields2)) o2) (<= o2 (max (mk___rep t1__split_discrs t1__split_fields2)))))))
(assert (and (= o3 (search (mk___rep t1__split_discrs t1__split_fields2) 0)) (and (in_range4 o3) (or (and (= o3 0) (= (not_in (mk___rep t1__split_discrs t1__split_fields2) 0 1 (to_rep2 (rec__simple_unc_arrays__table__last t1__split_discrs))) true)) (and (= (to_rep3 (select (elts1 (rec__simple_unc_arrays__table__v t1__split_fields2)) o3)) 0) (= (not_in (mk___rep t1__split_discrs t1__split_fields2) 0 1 (- o3 1)) true))))))
(assert (and (= o4 (search (mk___rep t2__split_discrs t2__split_fields2) 9)) (and (in_range4 o4) (or (and (= o4 0) (= (not_in (mk___rep t2__split_discrs t2__split_fields2) 9 1 (to_rep2 (rec__simple_unc_arrays__table__last t2__split_discrs))) true)) (and (= (to_rep3 (select (elts1 (rec__simple_unc_arrays__table__v t2__split_fields2)) o4)) 9) (= (not_in (mk___rep t2__split_discrs t2__split_fields2) 9 1 (- o4 1)) true))))))
(assert (and (= o11 (add (mk___rep t1__split_discrs t1__split_fields2) (mk___rep t2__split_discrs t2__split_fields2))) (and (dynamic_invariant o11 true false true true) (and (= (same_range o11 (mk___rep t1__split_discrs t1__split_fields2)) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j (to_rep2 (rec__simple_unc_arrays__table__last t1__split_discrs)))) (= (to_rep3 (select o6 j)) (+ (to_rep3 (select (elts1 (rec__simple_unc_arrays__table__v t1__split_fields2)) j)) (to_rep3 (select (elts1 (rec__simple_unc_arrays__table__v t2__split_fields2)) j))))))))))
(assert (= (mk___rep (mk___split_discrs o8) (mk___split_fields (mk___t1 o9 o10))) o11))
(assert (= o8 temp___358))
(assert (= o9 temp___3581))
(assert (= result2 (mk___split_fields__ref3 (mk___split_fields3 t3__split_fields))))
(assert (= t3__split_fields1 (mk___split_fields3 temp___3581)))
(assert (= t3__split_discrs (mk___split_discrs temp___358)))
(assert (<= 1 i))
