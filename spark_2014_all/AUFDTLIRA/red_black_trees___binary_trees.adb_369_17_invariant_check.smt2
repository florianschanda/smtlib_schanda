...
(assert (and (= result (tree_structure f)) (= (= result true) (and (and (and (and (and (and (and (and (forall ((i2 Int)) (=> (and (<= (+ (to_rep (rec__binary_trees__forest__s (us_split_fields5 f))) 1) i2) (<= i2 100)) (= (bool_eq3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) i2) (mk___rep1 (mk___split_fields1 (of_rep 0) (of_rep 0) (of_rep 0) (of_rep1 2)))) true))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (and (<= 0 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) i2))))) (<= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) i2)))) (to_rep (rec__binary_trees__forest__s (us_split_fields5 f)))))))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (and (<= 0 (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) i2))))) (<= (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) i2)))) (to_rep (rec__binary_trees__forest__s (us_split_fields5 f)))))))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (and (<= 0 (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) i2))))) (<= (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) i2)))) (to_rep (rec__binary_trees__forest__s (us_split_fields5 f)))))))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) i2)))) 2) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) i2)))) 0))))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (not (= (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) i2)))) 0)) (and (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) i2)))))))) 0) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) i2)))))))) i2)))))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (not (= (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) i2)))) 0)) (and (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) i2)))))))) 1) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) i2)))))))) i2)))))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (and (not (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) i2)))) 0)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) i2)))) 0)) (= (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) i2)))))))) i2))))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (and (not (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) i2)))) 0)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) i2)))) 1)) (= (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) i2)))))))) i2))))))))
(assert (= result true))
