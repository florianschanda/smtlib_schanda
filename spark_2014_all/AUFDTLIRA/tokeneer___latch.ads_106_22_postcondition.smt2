...
(assert (= (= (islocked currentlatch1) true) (= (greaterthanorequal (thecurrenttime currenttime) (mk___rep (mk___split_fields latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3))) true)))
(assert (in_range10 currentlatch1))
(assert (= (islocked currentlatch1) true))
(assert (not (= (greaterthanorequal (thecurrenttime currenttime) (latch_timeout (mk___split_fields latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3))) true)))
(check-sat)
(exit)
