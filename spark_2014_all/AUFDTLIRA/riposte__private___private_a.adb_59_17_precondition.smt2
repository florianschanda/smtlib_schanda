...
(define-fun dynamic_invariant1 ((temp___expr_155 Int) (temp___is_init_152 Bool) (temp___skip_constant_153 Bool) (temp___do_toplevel_154 Bool)) Bool (=> (or (= temp___is_init_152 true) (<= 0 100)) (in_range2 temp___expr_155)))
...
(declare-const temp___234 Bool)
(declare-const temp___2341 length_t)
...
(assert (in_range1 n))
(assert (and (= (mk___rep (mk___split_fields o o1)) (create_stack Tuple0)) (= (get_length (mk___rep (mk___split_fields o o1))) 0)))
(assert (= (of_int 1) o2))
(assert (= o3 o))
(assert (= o4 o1))
...
(assert (not (< 0 (get_length (rec__private_a__optional_stack__the_stack s__split_fields6)))))
(check-sat)
(exit)
