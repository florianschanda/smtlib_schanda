...
(assert (and (= stackp__get_model__3__R87s (last4 s)) (and (in_range4 stackp__get_model__3__R87s) (= stackp__get_model__3__R87s (ite (not (= (wraps_around s) true)) (- (+ (to_rep3 (rec__stackp__buffer__first (us_split_fields3 s))) (to_rep2 (rec__stackp__stack_root__length1 (us_split_fields3 s)))) 1) (- (- (+ (to_rep3 (rec__stackp__buffer__first (us_split_fields3 s))) (to_rep2 (rec__stackp__stack_root__length1 (us_split_fields3 s)))) 1) 100))))))
(assert (<= (to_rep3 (rec__stackp__buffer__first (us_split_fields3 s))) stackp__get_model__3__R87s))
(assert (not (<= 1 (to_rep3 (rec__stackp__buffer__first (us_split_fields3 s))))))
(check-sat)
(exit)
