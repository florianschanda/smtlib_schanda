...
(assert (forall ((temp___140 us_t)) (forall ((temp___141 Int) (temp___142 Int) (temp___143 Int) (temp___144 Int)) (let ((temp___139 (temp___138 temp___140 temp___141 temp___142 temp___143 temp___144))) (and (and (= (first1 temp___139) (first1 temp___140)) (= (last1 temp___139) (last1 temp___140))) (forall ((temp___145 Int)) (ite (= temp___145 temp___143) (= (select (to_array temp___139) temp___145) (of_rep temp___144)) (ite (= temp___145 temp___141) (= (select (to_array temp___139) temp___145) (of_rep temp___142)) (= (select (to_array temp___139) temp___145) (select (to_array temp___140) temp___145))))))))))
(define-fun dynamic_invariant2 ((temp___expr_136 us_t) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (not (= temp___skip_constant_134 true)) (dynamic_property 0 2147483647 (first1 temp___expr_136) (last1 temp___expr_136))))
...
(assert (and (<= (to_rep v__first) i) (<= i (to_rep v__last))))
(assert (= o14 i))
(assert (= o15 (select v o14)))
(assert (= o16 (to_rep o15)))
(assert (and (= o17 j) (in_range2 j)))
(assert (not (<= (to_rep v__first) j)))
(check-sat)
(exit)
