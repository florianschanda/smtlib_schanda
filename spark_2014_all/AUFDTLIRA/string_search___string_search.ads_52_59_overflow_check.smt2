...
(assert (and (= o42 (length needle)) (in_range1 (length needle))))
(assert (= o43 (- o42 (to_rep (select bad_shift9 c2)))))
(assert (= o44 (+ o43 2)))
(assert (and (= o45 o44) (in_range1 o44)))
(assert (= o46 (ite (<= o45 k3) true false)))
(assert (= result9 (ite (= o46 true) (ite (<= k3 (to_rep2 (last (rt needle)))) true false) false)))
(assert (= (= o47 true) (forall ((k4 Int)) (=> (and (<= (+ (- (length needle) (to_rep (select bad_shift9 c2))) 2) k4) (<= k4 (to_rep2 (last (rt needle))))) (not (= (to_rep1 (select (elts needle) k4)) c2))))))
(assert (and (= o39 (length needle)) (in_range1 (length needle))))
(assert (= o40 (- o39 (to_rep (select bad_shift9 c2)))))
(assert (= o41 (+ o40 1)))
