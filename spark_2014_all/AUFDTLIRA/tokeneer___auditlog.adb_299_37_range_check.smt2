...
(declare-const temp___1747 (Array Int character))
(declare-const temp___17471 t)
...
(assert (=> (= (length (mk___t temp___1745 temp___17451)) 0) (= (temp___String_Literal_1744 Tuple0) temp___1747)))
(assert (=> (= (length (mk___t temp___1745 temp___17451)) 0) (= (mk 1 5) temp___17471)))
(assert (=> (not (= (length (mk___t temp___1745 temp___17451)) 0)) (=> (<= 1 5) (= o8 (+ (- 5 1) 1)))))
(assert (=> (not (= (length (mk___t temp___1745 temp___17451)) 0)) (=> (not (<= 1 5)) (= o8 0))))
(assert (=> (not (= (length (mk___t temp___1745 temp___17451)) 0)) (=> (<= (to_rep1 (first temp___17451)) (to_rep1 (last temp___17451))) (= o9 (+ (- (to_rep1 (last temp___17451)) (to_rep1 (first temp___17451))) 1)))))
(assert (=> (not (= (length (mk___t temp___1745 temp___17451)) 0)) (=> (not (<= (to_rep1 (first temp___17451)) (to_rep1 (last temp___17451)))) (= o9 0))))
(assert (=> (not (= (length (mk___t temp___1745 temp___17451)) 0)) (= o10 (+ o9 o8))))
(assert (=> (not (= (length (mk___t temp___1745 temp___17451)) 0)) (= o11 (+ (to_rep1 (first temp___17451)) o10))))
(assert (=> (not (= (length (mk___t temp___1745 temp___17451)) 0)) (= o12 (- o11 1))))
(assert (=> (not (= (length (mk___t temp___1745 temp___17451)) 0)) (and (= o13 o12) (in_range2 o12))))
(assert (=> (not (= (length (mk___t temp___1745 temp___17451)) 0)) (= (concat1 temp___1745 (to_rep1 (first temp___17451)) (to_rep1 (last temp___17451)) (temp___String_Literal_1744 Tuple0) 1 5) temp___1747)))
(assert (=> (not (= (length (mk___t temp___1745 temp___17451)) 0)) (= (mk (to_rep1 (first temp___17451)) o13) temp___17471)))
(assert (not (= (length (mk___t temp___1747 temp___17471)) 0)))
(assert (=> (<= 1 21) (= o14 (+ (- 21 1) 1))))
(assert (=> (not (<= 1 21)) (= o14 0)))
(assert (=> (<= (to_rep1 (first temp___17471)) (to_rep1 (last temp___17471))) (= o15 (+ (- (to_rep1 (last temp___17471)) (to_rep1 (first temp___17471))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___17471)) (to_rep1 (last temp___17471)))) (= o15 0)))
(assert (= o16 (+ o15 o14)))
(assert (= o17 (+ (to_rep1 (first temp___17471)) o16)))
(assert (= o18 (- o17 1)))
