...
(assert (=> (< 0 e) (= o14 (temp___881 o13 i o12))))
(assert (=> (< 0 e) (and (= o15 (+ j 1)) (in_range1 (+ j 1)))))
(assert (=> (< 0 e) (= temp___4584 (temp___866 a j (temp___874 (select a j) i e) o15 o14))))
(assert (=> (< 0 e) (= result6 (bool_eq1 a3 5 50 temp___4584 5 50))))
