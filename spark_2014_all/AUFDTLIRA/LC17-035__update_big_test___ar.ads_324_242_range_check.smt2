...
(assert (= a4 a2))
(assert (< j 50))
(assert (=> (< 0 e) (and (= o14 (- e 1)) (in_range2 (- e 1)))))
(assert (=> (< 0 e) (and (<= 5 (+ j 1)) (<= (+ j 1) 50))))
(assert (=> (< 0 e) (= o13 (+ j 1))))
(assert (=> (< 0 e) (= o15 (select a o13))))
(assert (=> (< 0 e) (= o16 (temp___881 o15 i o14))))
(assert (=> (< 0 e) (and (= o17 (+ j 1)) (in_range1 (+ j 1)))))
(assert (=> (< 0 e) (= temp___4584 (temp___866 a j (temp___874 (select a j) i e) o17 o16))))
(assert (=> (< 0 e) (= result7 (bool_eq1 a3 5 50 temp___4584 5 50))))
...
(assert (= o11 (temp___904 o10 i 99)))
