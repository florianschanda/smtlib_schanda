...
(declare-const i Int)
(declare-const test_higher_order__add_all__result (Array Int natural))
(declare-const test_higher_order__add_all__result1 t)
(declare-const temp___371 (Array Int natural))
...
(declare-const r4 (Array Int natural))
(declare-const i3 Int)
(declare-const r5 (Array Int natural))
(declare-const i4 Int)
(declare-const r6 (Array Int natural))
(declare-const i5 Int)
(declare-const r7 (Array Int natural))
(declare-const i6 Int)
(declare-const result2 (Array Int natural))
(declare-const result3 t)
(declare-const test_higher_order__add_all__result2 (Array Int natural))
(declare-const test_higher_order__add_all__result3 t)
(declare-const r8 (Array Int natural))
(declare-const i7 Int)
(declare-const test_higher_order__add_all__result4 (Array Int natural))
(declare-const test_higher_order__add_all__result5 t)
(declare-const r9 (Array Int natural))
(declare-const i8 Int)
(declare-const test_higher_order__add_all__result6 us_t)
(declare-const r10 map__ref)
(declare-const i9 int__ref)
(declare-const test_higher_order__add_all__result7 array_2__ref)
(declare-const r11 (Array Int natural))
(declare-const i10 Int)
(declare-const test_higher_order__add_all__result8 us_t)
(define-fun i11 () int__ref (mk_int__ref i7))
(define-fun r12 () map__ref (mk_map__ref r8))
(define-fun i12 () int__ref (mk_int__ref i5))
(define-fun r13 () map__ref (mk_map__ref r6))
(define-fun r14 () map__ref (mk_map__ref r))
...
(assert (= test_higher_order__add_all__result4 test_higher_order__add_all__result2))
(assert (= test_higher_order__add_all__result5 test_higher_order__add_all__result3))
(assert (= i11 i12))
(assert (= r12 r13))
(assert (= test_higher_order__add_all__result6 (mk___t test_higher_order__add_all__result2 test_higher_order__add_all__result3)))
(assert (= i8 i6))
(assert (= r9 r7))
...
(assert (=> (and (<= (to_rep1 (first4 (rt2 a))) i1) (<= i1 (to_rep1 (last4 (rt2 a))))) (= temp___371 r)))
(assert (=> (and (<= (to_rep1 (first4 (rt2 a))) i1) (<= i1 (to_rep1 (last4 (rt2 a))))) (= temp___369 i1)))
(assert (=> (and (<= (to_rep1 (first4 (rt2 a))) i1) (<= i1 (to_rep1 (last4 (rt2 a))))) (and (= o (add_one (to_rep (select (elts2 a) i1)))) (and (in_range3 o) (= o (+ (to_rep (select (elts2 a) i1)) 1))))))
(assert (=> (and (<= (to_rep1 (first4 (rt2 a))) i1) (<= i1 (to_rep1 (last4 (rt2 a))))) (and (= o1 o) (in_range1 o))))
(assert (=> (and (<= (to_rep1 (first4 (rt2 a))) i1) (<= i1 (to_rep1 (last4 (rt2 a))))) (= (to_rep o2) o1)))
(assert (=> (and (<= (to_rep1 (first4 (rt2 a))) i1) (<= i1 (to_rep1 (last4 (rt2 a))))) (= o3 (store r i1 o2))))
(assert (=> (and (<= (to_rep1 (first4 (rt2 a))) i1) (<= i1 (to_rep1 (last4 (rt2 a))))) (= (mk_map__ref result1) r14)))
(assert (=> (and (<= (to_rep1 (first4 (rt2 a))) i1) (<= i1 (to_rep1 (last4 (rt2 a))))) (= r2 o3)))
(assert (=> (and (<= (to_rep1 (first4 (rt2 a))) i1) (<= i1 (to_rep1 (last4 (rt2 a))))) (forall ((k Int)) (=> (and (<= (to_rep1 (first4 (rt2 a))) k) (<= k i2)) (= (to_rep (select r3 k)) (add_one (to_rep (select (elts2 a) k))))))))
(assert (=> (and (<= (to_rep1 (first4 (rt2 a))) i1) (<= i1 (to_rep1 (last4 (rt2 a))))) (and (and (=> (<= (to_rep1 (first4 (rt2 a))) (to_rep1 (last4 (rt2 a)))) (dynamic_property5 (to_rep1 (first4 (rt2 a))) (to_rep1 (last4 (rt2 a))) i2)) (forall ((temp___372 Int)) (=> (and (<= (to_rep1 r__first) temp___372) (<= temp___372 (to_rep1 r__last))) (=> (or (< (to_rep1 (last4 (rt2 a))) temp___372) (or (< temp___372 (to_rep1 (first4 (rt2 a)))) (< i2 temp___372))) (= (select r3 temp___372) (select temp___371 temp___372)))))) (and (<= (to_rep1 (first4 (rt2 a))) i2) (<= i2 (to_rep1 (last4 (rt2 a))))))))
(assert (=> (and (<= (to_rep1 (first4 (rt2 a))) i1) (<= i1 (to_rep1 (last4 (rt2 a))))) (= i2 (to_rep1 (last4 (rt2 a))))))
(assert (=> (and (<= (to_rep1 (first4 (rt2 a))) i1) (<= i1 (to_rep1 (last4 (rt2 a))))) (= i2 i3)))
(assert (=> (and (<= (to_rep1 (first4 (rt2 a))) i1) (<= i1 (to_rep1 (last4 (rt2 a))))) (= r3 r4)))
(assert (=> (and (<= (to_rep1 (first4 (rt2 a))) i1) (<= i1 (to_rep1 (last4 (rt2 a))))) (= i4 i2)))
(assert (=> (and (<= (to_rep1 (first4 (rt2 a))) i1) (<= i1 (to_rep1 (last4 (rt2 a))))) (= r5 r3)))
(assert (=> (and (<= (to_rep1 (first4 (rt2 a))) i1) (<= i1 (to_rep1 (last4 (rt2 a))))) (= i12 (mk_int__ref i3))))
(assert (=> (and (<= (to_rep1 (first4 (rt2 a))) i1) (<= i1 (to_rep1 (last4 (rt2 a))))) (= r13 (mk_map__ref r4))))
(assert (=> (and (<= (to_rep1 (first4 (rt2 a))) i1) (<= i1 (to_rep1 (last4 (rt2 a))))) (= i6 i4)))
(assert (=> (and (<= (to_rep1 (first4 (rt2 a))) i1) (<= i1 (to_rep1 (last4 (rt2 a))))) (= r7 r5)))
(assert (=> (not (and (<= (to_rep1 (first4 (rt2 a))) i1) (<= i1 (to_rep1 (last4 (rt2 a)))))) (= i1 i5)))
(assert (=> (not (and (<= (to_rep1 (first4 (rt2 a))) i1) (<= i1 (to_rep1 (last4 (rt2 a)))))) (= r13 r14)))
(assert (=> (not (and (<= (to_rep1 (first4 (rt2 a))) i1) (<= i1 (to_rep1 (last4 (rt2 a)))))) (= i6 i1)))
(assert (=> (not (and (<= (to_rep1 (first4 (rt2 a))) i1) (<= i1 (to_rep1 (last4 (rt2 a)))))) (= r7 r1)))
(assert (= (mk_array_2__ref (mk___t result2 result3)) (mk_array_2__ref (mk___t test_higher_order__add_all__result test_higher_order__add_all__result1))))
(assert (= r6 test_higher_order__add_all__result2))
(assert (= (mk (to_rep1 r__first) (to_rep1 r__last)) test_higher_order__add_all__result3))
(assert (= test_higher_order__add_all__result7 (mk_array_2__ref (mk___t test_higher_order__add_all__result4 test_higher_order__add_all__result5))))
(assert (= i9 i11))
(assert (= r10 r12))
(assert (= test_higher_order__add_all__result8 test_higher_order__add_all__result6))
(assert (= i10 i8))
(assert (= r11 r9))
(assert (= (mk___t result4 result5) (array_2__content test_higher_order__add_all__result7)))
(assert (not (= (to_rep1 (first (rt (array_2__content test_higher_order__add_all__result7)))) (to_rep1 (first4 (rt2 a))))))
(check-sat)
(exit)
