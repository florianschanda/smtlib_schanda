...
(assert (=> (<= j45 b) (= (to_rep o29) j45)))
(assert (=> (<= j45 b) (and (<= (to_rep tab__first) j45) (<= j45 (to_rep tab__last)))))
(assert (=> (<= j45 b) (= o30 j45)))
(assert (=> (<= j45 b) (= o31 (store (map__content tab36) o30 o29))))
(assert (=> (<= j45 b) (= result37 tab36)))
(assert (=> (<= j45 b) (= tab38 o31)))
(assert (=> (<= j45 b) (and (= o32 (+ j45 1)) (in_range1 (+ j45 1)))))
(assert (=> (<= j45 b) (= result38 (mk_int__ref j45))))
(assert (=> (<= j45 b) (= j46 o32)))
(assert (=> (<= j45 b) (and (= o33 (+ k24 1)) (in_range1 (+ k24 1)))))
(assert (=> (<= j45 b) (= result39 (mk_int__ref k24))))
(assert (=> (<= j45 b) (= k25 o33)))
...
(assert (= k31 0))
(assert (<= j52 b))
(assert (= (to_rep o34) j52))
(assert (and (<= (to_rep tab__first) j52) (<= j52 (to_rep tab__last))))
(assert (= o35 j52))
(assert (= o36 (store (map__content tab42) o35 o34)))
(assert (= result44 tab42))
(assert (= tab44 o36))
(assert (and (= o37 (+ j52 1)) (in_range1 (+ j52 1))))
(assert (= result45 (mk_int__ref j52)))
(assert (= j53 o37))
(assert (and (= o38 (+ k31 1)) (in_range1 (+ k31 1))))
...
(assert (<= j54 b))
(assert (= (to_rep o39) j54))
(assert (and (<= (to_rep tab__first) j54) (<= j54 (to_rep tab__last))))
(assert (= o40 j54))
(assert (= o41 (store tab45 o40 o39)))
(assert (= result49 (mk_map__ref tab45)))
(assert (= tab46 o41))
(assert (and (= o42 (+ j54 1)) (in_range1 (+ j54 1))))
(assert (= result50 (mk_int__ref j54)))
(assert (= j55 o42))
(assert (and (= o43 (+ k33 1)) (in_range1 (+ k33 1))))
