...
(assert (= tab63 o87))
(assert (and (= o88 (+ j73 1)) (in_range1 (+ j73 1))))
(assert (= result69 (mk_int__ref j73)))
(assert (= j74 o88))
(assert (and (= o89 (+ k41 1)) (in_range1 (+ k41 1))))
(assert (= result70 (mk_int__ref k41)))
(assert (= k42 o89))
(assert (= j75 (+ a k43)))
(assert (forall ((l8 Int)) (=> (and (<= a l8) (<= l8 (- j75 1))) (= (to_rep (select tab64 l8)) l8))))
(assert (forall ((l8 Int)) (=> (and (<= a l8) (<= l8 (- (+ a k43) 1))) (= (to_rep (select tab64 l8)) l8))))
(assert (and (=> (<= (- 2147483648) 2147483647) (in_range1 j75)) (=> (<= (- 2147483648) 2147483647) (in_range1 k43))))
(assert (= result73 (mk_int__ref temp___193)))
(assert (= temp___1931 j75))
(assert (= result74 (mk_int__ref temp___194)))
(assert (= temp___1941 k43))
(assert (<= j75 b))
(assert (= (to_rep o97) j75))
(assert (and (<= (to_rep tab__first) j75) (<= j75 (to_rep tab__last))))
(assert (= o98 j75))
(assert (= o99 (store tab64 o98 o97)))
(assert (= result75 (mk_map__ref tab64)))
(assert (= tab65 o99))
(assert (and (= o100 (+ j75 1)) (in_range1 (+ j75 1))))
(assert (= result76 (mk_int__ref j75)))
(assert (= j76 o100))
(assert (and (= o101 (+ k43 1)) (in_range1 (+ k43 1))))
(assert (= result77 (mk_int__ref k43)))
(assert (= k44 o101))
(assert (= temp___1932 (mk_int__ref temp___1931)))
(assert (= temp___1942 (mk_int__ref temp___1941)))
(assert (= k45 (mk_int__ref k44)))
(assert (= j77 (mk_int__ref j76)))
(assert (= tab66 (mk_map__ref tab65)))
(assert (= temp___1933 temp___1931))
(assert (= temp___1943 temp___1941))
(assert (= k46 k44))
(assert (= j78 j76))
(assert (= tab67 tab65))
(assert (not (= (int__content j77) (+ a (int__content k45)))))
(check-sat)
(exit)
