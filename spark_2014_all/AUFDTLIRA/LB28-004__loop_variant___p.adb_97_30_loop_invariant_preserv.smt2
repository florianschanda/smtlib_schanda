...
(declare-const tab47 map__ref)
(declare-const j56 int__ref)
(declare-const k35 int__ref)
(declare-const temp___2172 int__ref)
(declare-const temp___2162 int__ref)
(declare-const tab48 (Array Int integer))
(declare-const j57 Int)
(declare-const k36 Int)
(declare-const temp___2173 Int)
(declare-const temp___2163 Int)
(define-fun tab49 () map__ref (mk_map__ref tab))
(assert (in_range1 a))
(assert (in_range1 b))
...
(assert (=> (<= j1 b) (= (mk_map__ref result1) tab49)))
(assert (=> (<= j1 b) (= tab2 o2)))
...
(assert (=> (= result6 true) (=> (not (< j8 100)) (and (= o9 (+ k1 1)) (in_range1 (+ k1 1))))))
...
(assert (=> (= result6 true) (and (= o10 (+ j12 k5)) (in_range1 (+ j12 k5)))))
(assert (=> (= result6 true) (= o11 (ite (<= o10 b) true false))))
(assert (=> (= result6 true) (= result12 (ite (not (= o11 true)) true false))))
...
(assert (= result36 k22))
(assert (= k24 0))
(assert (=> (<= j45 b) (= temp___208 k24)))
(assert (=> (<= j45 b) (= temp___207 j45)))
(assert (=> (<= j45 b) (= temp___205 (map__content tab36))))
(assert (=> (<= j45 b) (= 0 temp___210)))
(assert (=> (<= j45 b) (= 0 temp___209)))
(assert (=> (<= j45 b) (= (to_rep o30) j45)))
(assert (=> (<= j45 b) (and (<= (to_rep tab__first) j45) (<= j45 (to_rep tab__last)))))
(assert (=> (<= j45 b) (= o31 j45)))
(assert (=> (<= j45 b) (= o32 (store (map__content tab36) o31 o30))))
(assert (=> (<= j45 b) (= result37 tab36)))
(assert (=> (<= j45 b) (= tab38 o32)))
(assert (=> (<= j45 b) (and (= o33 (+ j45 1)) (in_range1 (+ j45 1)))))
(assert (=> (<= j45 b) (= result38 (mk_int__ref j45))))
(assert (=> (<= j45 b) (= j46 o33)))
(assert (=> (<= j45 b) (and (= o34 (+ k24 1)) (in_range1 (+ k24 1)))))
(assert (=> (<= j45 b) (= result39 (mk_int__ref k24))))
(assert (=> (<= j45 b) (= k25 o34)))
(assert (=> (<= j45 b) (= j47 (+ a k26))))
(assert (=> (<= j45 b) (forall ((l Int)) (=> (and (<= a l) (<= l (- j47 1))) (= (to_rep (select tab39 l)) l)))))
(assert (=> (<= j45 b) (forall ((l Int)) (=> (and (<= a l) (<= l (- (+ a k26) 1))) (= (to_rep (select tab39 l)) l)))))
(assert (=> (<= j45 b) (and (=> (<= (- 2147483648) 2147483647) (in_range1 j47)) (=> (<= (- 2147483648) 2147483647) (in_range1 k26)))))
(assert (=> (<= j45 b) (= result40 (mk_int__ref temp___2091))))
(assert (=> (<= j45 b) (= temp___2092 j47)))
(assert (=> (<= j45 b) (= result41 (mk_int__ref temp___2101))))
(assert (=> (<= j45 b) (= temp___2102 k26)))
(assert (=> (<= j45 b) (not (<= j47 b))))
(assert (=> (<= j45 b) (= k27 (mk_int__ref k26))))
(assert (=> (<= j45 b) (= j48 (mk_int__ref j47))))
(assert (=> (<= j45 b) (= tab40 (mk_map__ref tab39))))
(assert (=> (<= j45 b) (= k28 k26)))
(assert (=> (<= j45 b) (= j49 j47)))
(assert (=> (<= j45 b) (= tab41 tab39)))
(assert (=> (<= j45 b) (= k29 k27)))
(assert (=> (<= j45 b) (= j50 j48)))
(assert (=> (<= j45 b) (= tab42 tab40)))
(assert (=> (<= j45 b) (= k30 k28)))
(assert (=> (<= j45 b) (= j51 j49)))
(assert (=> (<= j45 b) (= tab43 tab41)))
(assert (=> (not (<= j45 b)) (= k29 (mk_int__ref k24))))
(assert (=> (not (<= j45 b)) (= j50 (mk_int__ref j45))))
(assert (=> (not (<= j45 b)) (= tab42 tab36)))
(assert (=> (not (<= j45 b)) (= k30 k24)))
(assert (=> (not (<= j45 b)) (= j51 j45)))
(assert (=> (not (<= j45 b)) (= tab43 tab37)))
(assert (= result42 j50))
(assert (= j52 a))
(assert (= result43 k29))
(assert (= k31 0))
(assert (<= j52 b))
(assert (= (to_rep o35) j52))
(assert (and (<= (to_rep tab__first) j52) (<= j52 (to_rep tab__last))))
(assert (= o36 j52))
(assert (= o37 (store (map__content tab42) o36 o35)))
(assert (= result44 tab42))
(assert (= tab44 o37))
(assert (and (= o38 (+ j52 1)) (in_range1 (+ j52 1))))
(assert (= result45 (mk_int__ref j52)))
(assert (= j53 o38))
(assert (and (= o39 (+ k31 1)) (in_range1 (+ k31 1))))
(assert (= result46 (mk_int__ref k31)))
(assert (= k32 o39))
(assert (= j54 (+ a k33)))
(assert (forall ((l Int)) (=> (and (<= a l) (<= l (- j54 1))) (= (to_rep (select tab45 l)) l))))
(assert (forall ((l Int)) (=> (and (<= a l) (<= l (- (+ a k33) 1))) (= (to_rep (select tab45 l)) l))))
(assert (and (=> (<= (- 2147483648) 2147483647) (in_range1 j54)) (=> (<= (- 2147483648) 2147483647) (in_range1 k33))))
(assert (= result47 (mk_int__ref temp___216)))
(assert (= temp___2161 j54))
(assert (= result48 (mk_int__ref temp___217)))
(assert (= temp___2171 k33))
(assert (<= j54 b))
(assert (= (to_rep o40) j54))
(assert (and (<= (to_rep tab__first) j54) (<= j54 (to_rep tab__last))))
(assert (= o41 j54))
(assert (= o42 (store tab45 o41 o40)))
(assert (= result49 (mk_map__ref tab45)))
(assert (= tab46 o42))
(assert (and (= o43 (+ j54 1)) (in_range1 (+ j54 1))))
(assert (= result50 (mk_int__ref j54)))
(assert (= j55 o43))
(assert (and (= o44 (+ k33 1)) (in_range1 (+ k33 1))))
(assert (= result51 (mk_int__ref k33)))
(assert (= k34 o44))
(assert (= temp___2162 (mk_int__ref temp___2161)))
(assert (= temp___2172 (mk_int__ref temp___2171)))
(assert (= k35 (mk_int__ref k34)))
(assert (= j56 (mk_int__ref j55)))
(assert (= tab47 (mk_map__ref tab46)))
(assert (= temp___2163 temp___2161))
(assert (= temp___2173 temp___2171))
(assert (= k36 k34))
(assert (= j57 j55))
(assert (= tab48 tab46))
(assert (not (= (int__content j56) (+ a (int__content k35)))))
(check-sat)
(exit)
