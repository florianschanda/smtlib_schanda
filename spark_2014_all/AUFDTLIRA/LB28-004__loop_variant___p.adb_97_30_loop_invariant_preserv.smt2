...
(assert (=> (= result6 true) (and (= temp___149 (+ j8 k1)) (in_range1 (+ j8 k1)))))
(assert (=> (= result6 true) (and (<= (to_rep tab__first) temp___149) (<= temp___149 (to_rep tab__last)))))
...
(assert (= result36 k22))
(assert (= k24 0))
(assert (=> (<= j45 b) (= temp___185 k24)))
(assert (=> (<= j45 b) (= temp___184 j45)))
(assert (=> (<= j45 b) (= temp___182 (map__content tab36))))
(assert (=> (<= j45 b) (= 0 temp___187)))
(assert (=> (<= j45 b) (= 0 temp___186)))
...
(assert (=> (<= j45 b) (= result40 (mk_int__ref temp___1861))))
(assert (=> (<= j45 b) (= temp___1862 j47)))
(assert (=> (<= j45 b) (= result41 (mk_int__ref temp___1871))))
(assert (=> (<= j45 b) (= temp___1872 k26)))
...
(assert (= result47 (mk_int__ref temp___193)))
(assert (= temp___1931 j54))
(assert (= result48 (mk_int__ref temp___194)))
(assert (= temp___1941 k33))
(assert (<= j54 b))
...
(assert (= k34 o44))
(assert (= temp___1932 (mk_int__ref temp___1931)))
(assert (= temp___1942 (mk_int__ref temp___1941)))
(assert (= k35 (mk_int__ref k34)))
(assert (= j56 (mk_int__ref j55)))
(assert (= tab47 (mk_map__ref tab46)))
(assert (= temp___1933 temp___1931))
(assert (= temp___1943 temp___1941))
(assert (= k36 k34))
(assert (= j57 j55))
(assert (= tab48 tab46))
