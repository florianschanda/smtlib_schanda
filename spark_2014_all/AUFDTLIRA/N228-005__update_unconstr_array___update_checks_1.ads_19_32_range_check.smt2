...
(assert (= o i))
(assert (= (mk___t temp___448 temp___4481) (temp___442 (mk___t a (mk (to_rep a__first) (to_rep a__last))) o new_val)))
...
(assert (= (mk___t temp___449 temp___4491) (mk___t temp___448 temp___4481)))
