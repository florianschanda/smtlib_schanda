...
(define-fun dynamic_invariant1 ((temp___expr_139 Int) (temp___is_init_136 Bool) (temp___skip_constant_137 Bool) (temp___do_toplevel_138 Bool)) Bool (=> (or (= temp___is_init_136 true) (<= 1 8)) (in_range3 temp___expr_139)))
...
(declare-fun temp___260 (us_t Int Int) us_t)
(assert (forall ((temp___262 us_t)) (forall ((temp___263 Int) (temp___264 Int)) (let ((temp___261 (temp___260 temp___262 temp___263 temp___264))) (and (and (= (first1 temp___261) (first1 temp___262)) (= (last1 temp___261) (last1 temp___262))) (forall ((temp___265 Int)) (ite (= temp___265 temp___263) (= (select (to_array temp___261) temp___265) (of_rep1 temp___264)) (= (select (to_array temp___261) temp___265) (select (to_array temp___262) temp___265)))))))))
(declare-fun temp___442 (us_t Int Int) us_t)
(assert (forall ((temp___444 us_t)) (forall ((temp___445 Int) (temp___446 Int)) (let ((temp___443 (temp___442 temp___444 temp___445 temp___446))) (and (and (= (first1 temp___443) (first1 temp___444)) (= (last1 temp___443) (last1 temp___444))) (forall ((temp___447 Int)) (ite (= temp___447 temp___445) (= (select (to_array temp___443) temp___447) (of_rep1 temp___446)) (= (select (to_array temp___443) temp___447) (select (to_array temp___444) temp___447)))))))))
...
(declare-const o Int)
(declare-const temp___448 (Array Int integer))
(declare-const temp___4481 t)
(declare-const temp___449 (Array Int integer))
(declare-const temp___4491 t)
...
(define-fun temp___4482 () us_t (mk___t temp___448 temp___4481))
...
(assert (= o i))
(assert (= temp___4482 (temp___442 (mk___t a (mk (to_rep a__first) (to_rep a__last))) o new_val)))
(assert (= (ite (<= (to_rep (first temp___4481)) (to_rep (last temp___4481))) (+ (- (to_rep (last temp___4481)) (to_rep (first temp___4481))) 1) 0) (ite (<= (to_rep a__first) (to_rep a__last)) (+ (- (to_rep a__last) (to_rep a__first)) 1) 0)))
(assert (= (mk___t temp___449 temp___4491) temp___4482))
(assert (= o1 (slide temp___449 (to_rep (first temp___4491)) (to_rep a__first))))
