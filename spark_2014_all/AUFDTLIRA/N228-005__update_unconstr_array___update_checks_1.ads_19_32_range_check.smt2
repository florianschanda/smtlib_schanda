...
(declare-datatypes () ((tS7bP1__ref (mk_tS7bP1__ref (tS7bP1__content tindexB)))))
(define-fun tS7bP1__ref___projection ((a tS7bP1__ref)) tindexB (tS7bP1__content a))
(declare-fun temp___294 (us_t Int Int) us_t)
(declare-fun temp___484 (us_t Int Int) us_t)
...
(assert (forall ((temp___486 us_t)) (forall ((temp___487 Int) (temp___488 Int)) (let ((temp___485 (temp___484 temp___486 temp___487 temp___488))) (=> (and (and (dynamic_invariant2 temp___486 true true true true) (dynamic_invariant1 temp___487 true true true true)) (dynamic_invariant temp___488 true true true true)) (and (and (= (first1 temp___485) (first1 temp___486)) (= (last1 temp___485) (last1 temp___486))) (forall ((temp___489 Int)) (ite (= temp___489 temp___487) (= (to_rep1 (select (to_array temp___485) temp___489)) temp___488) (= (select (to_array temp___485) temp___489) (select (to_array temp___486) temp___489))))))))))
(assert (forall ((temp___296 us_t)) (forall ((temp___297 Int) (temp___298 Int)) (let ((temp___295 (temp___294 temp___296 temp___297 temp___298))) (=> (and (and (dynamic_invariant2 temp___296 true true true true) (dynamic_invariant1 temp___297 true true true true)) (dynamic_invariant temp___298 true true true true)) (and (and (= (first1 temp___295) (first1 temp___296)) (= (last1 temp___295) (last1 temp___296))) (forall ((temp___299 Int)) (ite (= temp___299 temp___297) (= (to_rep1 (select (to_array temp___295) temp___299)) temp___298) (= (select (to_array temp___295) temp___299) (select (to_array temp___296) temp___299))))))))))
(declare-const a (Array Int integer))
(declare-const us Int)
(declare-const o Int)
(declare-const temp___490 (Array Int integer))
(declare-const temp___4901 t)
(declare-const temp___491 (Array Int integer))
(declare-const temp___4911 t)
...
(define-fun temp___4902 () us_t (mk___t temp___490 temp___4901))
...
(assert (= o i))
(assert (= temp___4902 (temp___484 (mk___t a (mk (to_rep a__first) (to_rep a__last))) o new_val)))
(assert (= (ite (<= (to_rep (first temp___4901)) (to_rep (last temp___4901))) (+ (- (to_rep (last temp___4901)) (to_rep (first temp___4901))) 1) 0) (ite (<= (to_rep a__first) (to_rep a__last)) (+ (- (to_rep a__last) (to_rep a__first)) 1) 0)))
(assert (= (mk___t temp___491 temp___4911) temp___4902))
(assert (= o1 (slide temp___491 (to_rep (first temp___4911)) (to_rep a__first))))
