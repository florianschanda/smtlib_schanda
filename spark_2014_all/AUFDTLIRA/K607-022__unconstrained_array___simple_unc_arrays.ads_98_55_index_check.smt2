...
(assert (= (= result1 true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- (to_rep (rec__simple_unc_arrays__table__last a__split_discrs)) 1))) (<= (to_rep1 (select a__split_fields4 j1)) (to_rep1 (select a__split_fields4 (+ j1 1))))))))
(assert (= result1 true))
(assert (<= 1 j))
