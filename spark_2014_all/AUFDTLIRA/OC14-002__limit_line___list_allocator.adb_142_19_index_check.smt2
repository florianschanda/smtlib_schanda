...
(assert (=> (= result26 true) (and (= o108 (+ j5 2)) (in_range1 (+ j5 2)))))
(assert (=> (= result26 true) (and (= o109 (get ma1 o108)) (in_range7 o109))))
(assert (=> (not (= result26 true)) (= o109 0)))
(assert (and (= o106 (+ j5 1)) (in_range1 (+ j5 1))))
(assert (and (= temp___406 (get ma1 o106)) (in_range7 temp___406)))
(assert (not (<= 1 temp___406)))
(check-sat)
(exit)
