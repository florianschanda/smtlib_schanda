...
(assert (and (= o46 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range6 o46)))
...
(assert (and (= temp___439 (get ma1 o45)) (in_range7 temp___439)))
(assert (not (<= 1 temp___439)))
(check-sat)
(exit)
