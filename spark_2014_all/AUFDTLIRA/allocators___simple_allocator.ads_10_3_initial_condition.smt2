...
(assert (forall ((temp___220 Int)) (forall ((temp___221 Int)) (= (select (simple_allocator__data__aggregate_def temp___220) temp___221) (of_rep temp___220)))))
(define-fun dynamic_invariant1 ((temp___expr_207 Int) (temp___is_init_204 Bool) (temp___skip_constant_205 Bool) (temp___do_toplevel_206 Bool)) Bool (=> (or (= temp___is_init_204 true) (<= 0 1)) (in_range1 temp___expr_207)))
