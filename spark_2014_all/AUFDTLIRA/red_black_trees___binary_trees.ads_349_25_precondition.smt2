...
(assert (<= j4 100))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o58 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j4)) (and (in_range2 o58) (and (= o58 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 j4))))) (and (=> (= (valid_root (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j4) true) (= o58 0)) (=> (= (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) 0) (= o58 0)))))))
(assert (= o59 (ite (= o58 0) true false)))
(assert (= o60 (ite (not (= o59 true)) true false)))
(assert (= result18 (ite (not (= j4 (int__content v2))) o60 false)))
(assert (= result18 true))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o61 (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j4)) (and (in_range4 o61) (= o61 (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 j4))))))))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (not (not (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j4) 0))))
(check-sat)
(exit)
