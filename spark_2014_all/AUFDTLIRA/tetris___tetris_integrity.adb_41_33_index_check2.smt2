...
(assert (= (to_rep cur_piece__split_fields) 2))
(assert (= (to_rep4 o) (to_rep cur_piece__split_fields)))
(assert (and (<= 1 (to_rep1 cur_piece__split_fields2)) (<= (to_rep1 cur_piece__split_fields2) 10)))
(assert (= o1 (to_rep1 cur_piece__split_fields2)))
(assert (= o2 (store (select cur_board (to_rep2 cur_piece__split_fields3)) o1 o)))
(assert (not (<= 1 (to_rep2 cur_piece__split_fields3))))
(check-sat)
(exit)
