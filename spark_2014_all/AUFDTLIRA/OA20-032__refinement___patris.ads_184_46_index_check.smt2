...
(assert true)
(assert (forall ((b (Array Int (Array Int cell)))) (forall ((y Int) (x Int)) (! (= (= (is_empty b y x) true) (and (and (in_range8 x) (in_range9 y)) (= (to_rep1 (let ((temp___2231 (select b y))) (select temp___2231 x))) 0))) :pattern ((is_empty b y x))))))
(declare-const b (Array Int (Array Int cell)))
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(declare-const p us_rep)
(declare-const attr__ATTRIBUTE_ADDRESS3 Int)
(define-fun dynamic_invariant1 ((temp___expr_2087 Int) (temp___is_init_2083 Bool) (temp___skip_constant_2084 Bool) (temp___do_toplevel_2085 Bool) (temp___do_typ_inv_2086 Bool)) Bool (=> (or (= temp___is_init_2083 true) (<= 0 7)) (in_range3 temp___expr_2087)))
(define-fun dynamic_invariant2 ((temp___expr_2094 Int) (temp___is_init_2090 Bool) (temp___skip_constant_2091 Bool) (temp___do_toplevel_2092 Bool) (temp___do_typ_inv_2093 Bool)) Bool (=> (or (= temp___is_init_2090 true) (<= 1 7)) (in_range1 temp___expr_2094)))
(define-fun dynamic_invariant3 ((temp___expr_2101 Int) (temp___is_init_2097 Bool) (temp___skip_constant_2098 Bool) (temp___do_toplevel_2099 Bool) (temp___do_typ_inv_2100 Bool)) Bool (=> (or (= temp___is_init_2097 true) (<= 3 7)) (in_range2 temp___expr_2101)))
(define-fun dynamic_invariant4 ((temp___expr_2108 Int) (temp___is_init_2104 Bool) (temp___skip_constant_2105 Bool) (temp___do_toplevel_2106 Bool) (temp___do_typ_inv_2107 Bool)) Bool (=> (or (= temp___is_init_2104 true) (<= 1 10)) (in_range8 temp___expr_2108)))
(define-fun dynamic_invariant5 ((temp___expr_2115 Int) (temp___is_init_2111 Bool) (temp___skip_constant_2112 Bool) (temp___do_toplevel_2113 Bool) (temp___do_typ_inv_2114 Bool)) Bool (=> (or (= temp___is_init_2111 true) (<= 1 20)) (in_range9 temp___expr_2115)))
(define-fun dynamic_invariant6 ((temp___expr_2153 Int) (temp___is_init_2149 Bool) (temp___skip_constant_2150 Bool) (temp___do_toplevel_2151 Bool) (temp___do_typ_inv_2152 Bool)) Bool (=> (or (= temp___is_init_2149 true) (<= (- 1) 9)) (in_range4 temp___expr_2153)))
(define-fun dynamic_invariant7 ((temp___expr_2160 Int) (temp___is_init_2156 Bool) (temp___skip_constant_2157 Bool) (temp___do_toplevel_2158 Bool) (temp___do_typ_inv_2159 Bool)) Bool (=> (or (= temp___is_init_2156 true) (<= (- 1) 19)) (in_range5 temp___expr_2160)))
(define-fun dynamic_invariant8 ((temp___expr_2167 Int) (temp___is_init_2163 Bool) (temp___skip_constant_2164 Bool) (temp___do_toplevel_2165 Bool) (temp___do_typ_inv_2166 Bool)) Bool (=> (or (= temp___is_init_2163 true) (<= 0 3)) (in_range6 temp___expr_2167)))
