...
(declare-fun user_eq1 (tpair_typeD1 tpair_typeD1) Bool)
(declare-const dummy1 tpair_typeD1)
...
(define-fun dynamic_invariant ((temp___expr_176 us_t) (temp___is_init_172 Bool) (temp___skip_constant_173 Bool) (temp___do_toplevel_174 Bool) (temp___do_typ_inv_175 Bool)) Bool (=> (not (= temp___skip_constant_173 true)) (dynamic_property 0 2147483647 (first1 temp___expr_176) (last1 temp___expr_176))))
