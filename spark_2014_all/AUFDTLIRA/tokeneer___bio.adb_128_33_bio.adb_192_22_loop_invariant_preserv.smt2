...
(define-fun dynamic_invariant ((temp___expr_190 Int) (temp___is_init_186 Bool) (temp___skip_constant_187 Bool) (temp___do_toplevel_188 Bool) (temp___do_typ_inv_189 Bool)) Bool (=> (or (= temp___is_init_186 true) (<= 0 4294967295)) (in_range1 temp___expr_190)))
...
(define-fun dynamic_invariant1 ((temp___expr_333 us_t1) (temp___is_init_329 Bool) (temp___skip_constant_330 Bool) (temp___do_toplevel_331 Bool) (temp___do_typ_inv_332 Bool)) Bool (and (=> (not (= temp___skip_constant_330 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_333) (last3 temp___expr_333))) (=> (= temp___do_toplevel_331 true) (=> (= temp___is_init_329 true) (and (let ((temp___335 (of_array (to_array1 temp___expr_333) (first3 temp___expr_333) (last3 temp___expr_333)))) (and (= (first1 temp___335) 1) (<= 0 (last1 temp___335)))) (<= (last3 temp___expr_333) 1000))))))
(define-fun dynamic_predicate ((temp___337 us_t1)) Bool (and (let ((temp___339 (of_array (to_array1 temp___337) (first3 temp___337) (last3 temp___337)))) (and (= (first1 temp___339) 1) (<= 0 (last1 temp___339)))) (<= (last3 temp___337) 1000)))
...
(define-fun dynamic_invariant2 ((temp___expr_1418 Int) (temp___is_init_1414 Bool) (temp___skip_constant_1415 Bool) (temp___do_toplevel_1416 Bool) (temp___do_typ_inv_1417 Bool)) Bool (=> (or (= temp___is_init_1414 true) (<= 0 16)) (in_range5 temp___expr_1418)))
...
(define-fun dynamic_invariant3 ((temp___expr_1472 Int) (temp___is_init_1468 Bool) (temp___skip_constant_1469 Bool) (temp___do_toplevel_1470 Bool) (temp___do_typ_inv_1471 Bool)) Bool (=> (or (= temp___is_init_1468 true) (<= 0 16)) (in_range6 temp___expr_1472)))
...
(define-fun dynamic_invariant4 ((temp___expr_1479 Int) (temp___is_init_1475 Bool) (temp___skip_constant_1476 Bool) (temp___do_toplevel_1477 Bool) (temp___do_typ_inv_1478 Bool)) Bool (=> (or (= temp___is_init_1475 true) (<= 0 4294967295)) (in_range7 temp___expr_1479)))
(declare-fun codetoval (Int) Int)
(declare-fun codetoval__function_guard (Int Int) Bool)
(assert (forall ((s Int)) (! (=> (dynamic_invariant3 s true true true true) (dynamic_invariant4 (codetoval s) true false true true)) :pattern ((codetoval s)))))
...
(assert (forall ((temp___167 Int)) (=> (dynamic_invariant6 temp___167 true true true true) (forall ((temp___168 Int)) (= (to_rep (select (audittypes__nodescription__aggregate_def temp___167) temp___168)) temp___167)))))
(define-fun dynamic_invariant8 ((temp___expr_296 us_t) (temp___is_init_292 Bool) (temp___skip_constant_293 Bool) (temp___do_toplevel_294 Bool) (temp___do_typ_inv_295 Bool)) Bool (and (=> (not (= temp___skip_constant_293 true)) (dynamic_property 1 2147483647 (first1 temp___expr_296) (last1 temp___expr_296))) (=> (= temp___do_toplevel_294 true) (=> (= temp___is_init_292 true) (and (= (first1 temp___expr_296) 1) (<= 0 (last1 temp___expr_296)))))))
(define-fun dynamic_predicate1 ((temp___299 us_t)) Bool (and (= (first1 temp___299) 1) (<= 0 (last1 temp___299))))
