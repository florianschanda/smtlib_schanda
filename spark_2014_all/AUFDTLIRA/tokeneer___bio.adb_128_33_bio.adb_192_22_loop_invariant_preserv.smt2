...
(define-fun dynamic_invariant1 ((temp___expr_294 us_t1) (temp___is_init_291 Bool) (temp___skip_constant_292 Bool) (temp___do_toplevel_293 Bool)) Bool (and (=> (not (= temp___skip_constant_292 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_294) (last3 temp___expr_294))) (=> (= temp___do_toplevel_293 true) (=> (= temp___is_init_291 true) (and (let ((temp___296 (of_array (to_array1 temp___expr_294) (first3 temp___expr_294) (last3 temp___expr_294)))) (and (= (first1 temp___296) 1) (<= 0 (last1 temp___296)))) (<= (last3 temp___expr_294) 1000))))))
(define-fun dynamic_predicate ((temp___298 us_t1)) Bool (and (let ((temp___300 (of_array (to_array1 temp___298) (first3 temp___298) (last3 temp___298)))) (and (= (first1 temp___300) 1) (<= 0 (last1 temp___300)))) (<= (last3 temp___298) 1000)))
...
(define-fun dynamic_invariant2 ((temp___expr_1266 Int) (temp___is_init_1263 Bool) (temp___skip_constant_1264 Bool) (temp___do_toplevel_1265 Bool)) Bool (=> (or (= temp___is_init_1263 true) (<= 0 16)) (in_range5 temp___expr_1266)))
...
(define-fun dynamic_invariant3 ((temp___expr_1314 Int) (temp___is_init_1311 Bool) (temp___skip_constant_1312 Bool) (temp___do_toplevel_1313 Bool)) Bool (=> (or (= temp___is_init_1311 true) (<= 0 16)) (in_range6 temp___expr_1314)))
...
(define-fun dynamic_invariant4 ((temp___expr_1320 Int) (temp___is_init_1317 Bool) (temp___skip_constant_1318 Bool) (temp___do_toplevel_1319 Bool)) Bool (=> (or (= temp___is_init_1317 true) (<= 0 4294967295)) (in_range7 temp___expr_1320)))
