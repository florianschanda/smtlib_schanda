...
(assert (and (and (and (and (= (mk_int__ref utility__search_for_zero__result13) (mk_int__ref utility__search_for_zero__result7)) (= (mk_int__ref index12) (mk_int__ref index6))) (and (= utility__search_for_zero__result14 utility__search_for_zero__result8) (= index13 index7))) (and (= temp___151 0) (and (= temp___152 1023) (and (and (= (mk_int__ref result) (mk_int__ref index)) (= index1 temp___151)) (and (and (<= temp___151 index1) (<= index1 temp___152)) (and (= temp___150 index1) (or (and (and (and (= utility__search_for_zero__result2 utility__search_for_zero__result7) (= index1 index6)) (and (= utility__search_for_zero__result8 utility__search_for_zero__result2) (= index7 index1))) (and (= (to_rep (select values index1)) 0) (and (= result1 utility__search_for_zero__result) (= utility__search_for_zero__result2 index1)))) (and (and (not (= (to_rep (select values index1)) 0)) (and (= utility__search_for_zero__result2 utility__search_for_zero__result) (= utility__search_for_zero__result2 utility__search_for_zero__result1))) (and (and (and (= utility__search_for_zero__result4 utility__search_for_zero__result7) (= index3 index6)) (and (= utility__search_for_zero__result8 utility__search_for_zero__result4) (= index7 index3))) (and (exists ((j1 Int)) (and (and (<= (+ index2 1) j1) (<= j1 1023)) (= (to_rep (select values j1)) 0))) (and (and (=> (<= 0 1023) (in_range2 index2)) (and (<= 0 index2) (<= index2 1023))) (and (not (= index2 temp___152)) (and (and (= index2 result2) (= index3 (+ index2 1))) (and (= (to_rep (select values index3)) 0) (and (= result3 utility__search_for_zero__result3) (= utility__search_for_zero__result4 index3)))))))))))))))) (and (and (= (mk_int__ref utility__search_for_zero__result15) (mk_int__ref utility__search_for_zero__result13)) (= index14 index12)) (and (= utility__search_for_zero__result16 utility__search_for_zero__result14) (= index15 index13)))))
(assert (= result4 utility__search_for_zero__result15))
(assert (not (= (to_rep (select values utility__search_for_zero__result15)) 0)))
(check-sat)
(exit)
