...
(assert (= result9 true))
(assert (and (= o19 (+ x (int__content lcp__result16))) (in_range1 (+ x (int__content lcp__result16)))))
(assert (= o20 (ite (<= o19 (to_rep (last (rt a)))) true false)))
(assert (and (= o18 (+ x (int__content lcp__result16))) (in_range1 (+ x (int__content lcp__result16)))))
