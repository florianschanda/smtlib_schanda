...
(assert (and (= o51 x) (in_range5 x)))
(assert (and (= o52 (remove (mk___t interm1 (mk 1 100)) o51)) (and (dynamic_invariant4 o52 true false true) (and (= (invariant__ o52) true) (and (= (to_rep1 (last (rt o52))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o51 1))) (= (to_rep (select interm1 k)) (to_rep (select (elts o52) k))))) (and (forall ((k Int)) (=> (and (<= (+ o51 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select interm1 k)) (to_rep (select (elts o52) (- k 1)))))) (forall ((k Int)) (=> (and (<= o51 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select interm1 (+ k 1))) (to_rep (select (elts o52) k))))))))))))
(assert (not (= (invariant__ o52) true)))
(check-sat)
(exit)
