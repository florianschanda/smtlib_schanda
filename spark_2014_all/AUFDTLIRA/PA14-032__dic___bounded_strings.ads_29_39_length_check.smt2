...
(assert (= (to_rep3 (last2 (rt1 (temp___169 32 1 temp___179)))) temp___179))
(assert (= (mk___t1 temp___181 temp___1811) (temp___169 32 1 temp___179)))
(assert (not (= (ite (<= (to_rep3 (first2 temp___1811)) (to_rep3 (last2 temp___1811))) (+ (- (to_rep3 (last2 temp___1811)) (to_rep3 (first2 temp___1811))) 1) 0) (ite (<= 1 temp___179) (+ (- temp___179 1) 1) 0))))
(check-sat)
(exit)
