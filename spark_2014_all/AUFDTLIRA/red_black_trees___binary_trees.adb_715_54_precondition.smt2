...
(assert (and (= temp___1650 (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) o348)) (and (dynamic_invariant3 temp___1650 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1650 o348))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1650 o348)))) 0) (and (forall ((i15 Int)) (=> (and (<= 1 i15) (<= i15 100)) (=> (not (= i15 o348)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i15) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1650 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i15)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1650 i15))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1650 i15))) true)))))) (and (forall ((i15 Int)) (=> (and (<= 1 i15) (<= i15 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1650 i15))) true) (not (= i15 o348))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1650 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i15)))) (position (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i15) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1650 i15)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1650 i15)))) 0)))) (forall ((i15 Int)) (=> (and (<= 1 i15) (<= i15 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1650 i15))) true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1650 j2))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1650 i15))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1650 j2)))) true)) (= j2 i15))))))))))))))
(assert (= o349 (select temp___1650 i12)))
(assert (= o350 (us_split_fields1 o349)))
(assert (= result58 (rec__tree_model__path_type__k o350)))
