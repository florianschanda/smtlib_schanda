...
(assert (<= 1 i4))
(assert (<= i4 100))
(assert (and (= temp___914 (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)))) (and (dynamic_invariant5 temp___914 true false true) (= temp___914 (model__1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)))) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 c75b))))))))))
(assert (= o66 (select temp___914 i4)))
(assert (= o67 (us_split_fields1 o66)))
(assert (= result29 (rec__tree_model__path_type__k o67)))
(assert (=> (= result29 true) (and (= temp___915 (nb_blacks c75b)) (and (= (bool_eq11 (select temp___915 0) (mk___rep5 (mk___split_fields5 (of_int 1) (of_rep 0) (of_rep 0)))) true) (forall ((i14 Int)) (=> (and (<= 1 i14) (<= i14 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c75b))) i14))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___915 i14))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___915 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___915 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i14 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___915 i14)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___915 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___915 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i14 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___915 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i14 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___915 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i14 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___915 i14)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c75b)) i14)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___915 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i14 0)))))))))))))))
(assert (=> (= result29 true) (= o62 (select temp___915 i4))))
(assert (=> (= result29 true) (= o63 (us_split_fields11 o62))))
(assert (=> (= result29 true) (= o64 (rec__red_black_trees__black_count__depth o63))))
(assert (=> (= result29 true) (= o65 (to_rep o64))))
(assert (=> (= result29 true) (= result28 (ite (< o65 n51) true false))))
(assert (=> (not (= result29 true)) (= result28 false)))
(assert (= result28 true))
(assert (and (= o68 (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c76b)) i4)) (and (in_range3 o68) (and (= o68 (parent1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 c76b)))) i4)) (=> (= (size (rec__red_black_trees__rbt__struct (us_split_fields9 c76b))) 0) (= o68 0))))))
(assert (= result30 (ite (= o68 c77b) true false)))
(assert (= result30 true))
(assert (and (= temp___911 (nb_blacks c75b)) (and (= (bool_eq11 (select temp___911 0) (mk___rep5 (mk___split_fields5 (of_int 1) (of_rep 0) (of_rep 0)))) true) (forall ((i14 Int)) (=> (and (<= 1 i14) (<= i14 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c75b))) i14))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___911 i14))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___911 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___911 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i14 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___911 i14)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___911 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___911 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i14 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___911 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i14 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___911 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i14 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___911 i14)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c75b)) i14)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___911 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i14 0))))))))))))))
(assert (= o72 (select temp___911 i4)))
(assert (= o73 (us_split_fields11 o72)))
(assert (= o74 (rec__red_black_trees__black_count__count o73)))
