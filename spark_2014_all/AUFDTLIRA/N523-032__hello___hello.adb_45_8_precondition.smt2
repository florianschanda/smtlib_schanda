...
(define-fun dynamic_invariant4 ((temp___expr_562 us_t1) (temp___is_init_559 Bool) (temp___skip_constant_560 Bool) (temp___do_toplevel_561 Bool)) Bool (=> (not (= temp___skip_constant_560 true)) (and (dynamic_property2 (first1 str) (last1 str) (first3 temp___expr_562) (last3 temp___expr_562)) (and (= (first3 temp___expr_562) (first1 str)) (= (last3 temp___expr_562) (last1 str))))))
...
(declare-const temp___591 Bool)
(declare-const temp___589 (Array Int character))
(declare-const o Int)
...
(declare-const ret7 (Array Int character))
...
(declare-const ret13 map__ref)
(declare-const to_up11 bool__ref)
(declare-const idx10 int__ref)
(declare-const hello__to_camel_case__result5 string__ref)
(declare-const ret14 (Array Int character))
(declare-const to_up12 Bool)
(declare-const idx11 Int)
(declare-const hello__to_camel_case__result6 us_t)
(assert (dynamic_invariant str true false true))
(assert (and (and (and (and (= (slide (elts str) (to_rep1 (first (rt str))) (to_rep1 (first (rt str)))) hello__to_camel_case__ret__assume) (= (mk1 (to_rep1 (first (rt str))) (to_rep1 (last (rt str)))) hello__to_camel_case__ret__assume1)) (and (and (= (mk_map__ref result) (mk_map__ref ret)) (= ret1 hello__to_camel_case__ret__assume)) (and (= (to_rep1 ret__first) (to_rep1 (first2 hello__to_camel_case__ret__assume1))) (= (to_rep1 ret__last) (to_rep1 (last2 hello__to_camel_case__ret__assume1)))))) (and (and (dynamic_property2 (to_rep1 (first (rt str))) (to_rep1 (last (rt str))) (to_rep1 ret__first) (to_rep1 ret__last)) (and (= (to_rep1 ret__first) (to_rep1 (first (rt str)))) (= (to_rep1 ret__last) (to_rep1 (last (rt str)))))) (and (and (= (mk_bool__ref result1) (mk_bool__ref to_up)) (= to_up1 (of_int 1))) (and (and (and (= (mk_int__ref result2) (mk_int__ref idx)) (= idx1 (to_rep1 (first (rt str))))) (ite (and (<= (to_rep1 (first (rt str))) idx1) (<= idx1 (to_rep1 (last (rt str))))) (and (and (and (= temp___592 idx1) (and (= temp___591 to_up1) (and (= temp___589 ret1) (and (ite (= to_up1 true) (and (and (and (and (= o (to_upper (to_rep (select ret1 idx1)))) (in_range3 o)) (= (to_rep o1) o)) (= o2 (store ret1 idx1 o1))) (and (= ret1 result3) (= ret2 o2))) (and (and (and (and (and (= o3 (to_lower (to_rep (select ret1 idx1)))) (in_range3 o3)) (= (to_rep o4) o3)) (= o5 (store ret1 idx1 o4))) (and (= ret1 result4) (= ret3 o5))) (= ret2 ret3))) (and (and (<= (to_rep1 (first (rt str))) idx1) (<= idx1 (to_rep1 (last (rt str))))) (and (and (<= (to_rep1 ret__first) idx1) (<= idx1 (to_rep1 ret__last))) (and (and (= (to_caml_char2 str (mk___t ret4 (mk (to_rep1 ret__first) (to_rep1 ret__last))) idx2) true) (forall ((j1 Int)) (=> (and (<= idx2 j1) (<= j1 (to_rep1 (last (rt str))))) (=> (< idx2 j1) (= (to_rep (select ret4 j1)) (to_rep (select (elts str) j1))))))) (and (and (and (forall ((temp___590 Int)) (=> (and (<= (to_rep1 ret__first) temp___590) (<= temp___590 (to_rep1 ret__last))) (=> (< idx2 temp___590) (= (select ret4 temp___590) (select temp___589 temp___590))))) (=> (<= (to_rep1 (first (rt str))) (to_rep1 (last (rt str)))) (dynamic_property3 (to_rep1 (first (rt str))) (to_rep1 (last (rt str))) idx2))) (and (<= (to_rep1 (first (rt str))) idx2) (<= idx2 (to_rep1 (last (rt str)))))) (and (ite (and (not (and (<= 65 (to_rep (select (elts str) idx2))) (<= (to_rep (select (elts str) idx2)) 90))) (not (and (<= 97 (to_rep (select (elts str) idx2))) (<= (to_rep (select (elts str) idx2)) 122)))) (and (= to_up2 result5) (= to_up3 (of_int 1))) (and (and (= to_up2 result6) (= to_up4 (of_int 0))) (= to_up3 to_up4))) (= idx2 (to_rep1 (last (rt str))))))))))))) (and (and (= idx6 (mk_int__ref idx2)) (and (= to_up3 to_up7) (= ret4 ret9))) (and (= idx7 idx2) (and (= to_up8 to_up3) (= ret10 ret4))))) (and (and (= idx8 idx6) (and (= to_up9 (mk_bool__ref to_up7)) (= ret11 (mk_map__ref ret9)))) (and (= idx9 idx7) (and (= to_up10 to_up8) (= ret12 ret10))))) (and (and (= idx8 (mk_int__ref idx1)) (and (= to_up9 (mk_bool__ref to_up1)) (= ret11 (mk_map__ref ret1)))) (and (= idx9 idx1) (and (= to_up10 to_up1) (= ret12 ret1)))))) (and (and (= hello__to_camel_case__result3 (mk_string__ref hello__to_camel_case__result2)) (= hello__to_camel_case__result4 hello__to_camel_case__result2)) (and (= result10 (mk_string__ref (mk___t hello__to_camel_case__result hello__to_camel_case__result1))) (= hello__to_camel_case__result2 (mk___t (map__content ret11) (mk (to_rep1 ret__first) (to_rep1 ret__last)))))))))) (and (and (= hello__to_camel_case__result5 hello__to_camel_case__result3) (and (= idx10 idx8) (and (= to_up11 to_up9) (= ret13 ret11)))) (and (= hello__to_camel_case__result6 hello__to_camel_case__result4) (and (= idx11 idx9) (and (= to_up12 to_up10) (= ret14 ret12)))))))
