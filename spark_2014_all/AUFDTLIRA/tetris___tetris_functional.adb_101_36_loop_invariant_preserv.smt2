...
(define-fun dynamic_invariant2 ((temp___expr_565 Int) (temp___is_init_561 Bool) (temp___skip_constant_562 Bool) (temp___do_toplevel_563 Bool) (temp___do_typ_inv_564 Bool)) Bool (=> (or (= temp___is_init_561 true) (<= 1 50)) (in_range4 temp___expr_565)))
...
(define-fun dynamic_invariant3 ((temp___expr_627 Int) (temp___is_init_623 Bool) (temp___skip_constant_624 Bool) (temp___do_toplevel_625 Bool) (temp___do_typ_inv_626 Bool)) Bool (=> (or (= temp___is_init_623 true) (<= 0 3)) (in_range9 temp___expr_627)))
...
(define-fun dynamic_invariant4 ((temp___expr_537 Int) (temp___is_init_533 Bool) (temp___skip_constant_534 Bool) (temp___do_toplevel_535 Bool) (temp___do_typ_inv_536 Bool)) Bool (=> (or (= temp___is_init_533 true) (<= 0 7)) (in_range3 temp___expr_537)))
(assert (forall ((temp___531 Int)) (=> (dynamic_invariant4 temp___531 true true true true) (forall ((temp___532 Int)) (= (to_rep (select (tetris_functional__delete_complete_lines__empty_line__aggregate_def temp___531) temp___532)) temp___531)))))
(define-fun dynamic_invariant5 ((temp___expr_544 Int) (temp___is_init_540 Bool) (temp___skip_constant_541 Bool) (temp___do_toplevel_542 Bool) (temp___do_typ_inv_543 Bool)) Bool (=> (or (= temp___is_init_540 true) (<= 1 7)) (in_range5 temp___expr_544)))
...
(define-fun dynamic_invariant6 ((temp___expr_558 Int) (temp___is_init_554 Bool) (temp___skip_constant_555 Bool) (temp___do_toplevel_556 Bool) (temp___do_typ_inv_557 Bool)) Bool (=> (or (= temp___is_init_554 true) (<= 1 10)) (in_range10 temp___expr_558)))
...
(assert true)
(assert (forall ((b (Array Int (Array Int cell)))) (forall ((y Int) (x Int)) (! (= (= (is_empty b y x) true) (and (and (in_range10 x) (in_range4 y)) (= (to_rep (let ((temp___673 (select b y))) (select temp___673 x))) 0))) :pattern ((is_empty b y x))))))
(assert true)
...
(declare-const temp___815 Int)
(declare-const temp___814 Int)
(declare-const temp___813 Bool)
(declare-const temp___811 (Array Int (Array Int cell)))
...
(assert (= del_line1 1))
(assert (=> (and (<= 1 del_line1) (<= del_line1 50)) (= temp___815 to_line1)))
(assert (=> (and (<= 1 del_line1) (<= del_line1 50)) (= temp___814 del_line1)))
(assert (=> (and (<= 1 del_line1) (<= del_line1 50)) (= temp___813 has_complete_lines1)))
(assert (=> (and (<= 1 del_line1) (<= del_line1 50)) (= temp___811 cur_board)))
...
(assert (=> (and (<= 1 del_line1) (<= del_line1 50)) (=> (= result3 true) (= has_complete_lines2 (distinct 1 0)))))
...
(assert (=> (and (<= 1 del_line1) (<= del_line1 50)) (and (and (and (forall ((temp___812 Int)) (=> (and (<= 1 temp___812) (<= temp___812 50)) (=> (< del_line2 temp___812) (= (select cur_board3 temp___812) (select temp___811 temp___812))))) (=> (<= 1 50) (in_range4 del_line2))) (=> (<= 1 50) (in_range4 to_line3))) (and (<= 1 del_line2) (<= del_line2 50)))))
