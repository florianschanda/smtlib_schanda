...
(assert (and (= o138 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i6 1)) (and (in_range3 o138) (= o138 (peek1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) i6 1)))))
(assert (= red_black_trees__nb_blacks__B_3__count_r__assume (select res3 o138)))
(assert (= red_black_trees__nb_blacks__B_3__count_r__assume count_r))
(assert (and (= o139 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i6 0)) (and (in_range3 o139) (= o139 (peek1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) i6 0)))))
(assert (= red_black_trees__nb_blacks__B_3__count_l__assume (select res3 o139)))
...
(assert (= (to_rep o140) (+ n2 1)))
(assert (= o141 (mk___split_fields5 (rec__red_black_trees__black_count__status (us_split_fields11 (select res3 i6))) o140 (rec__red_black_trees__black_count__count (us_split_fields11 (select res3 i6))))))
(assert (= o142 (mk___rep5 o141)))
(assert (= o143 (store res3 i6 o142)))
(assert (= result9 (mk_map__ref4 res3)))
(assert (= res4 o143))
(assert (= result10 (mk_map__ref4 res4)))
(assert (= res5 (store res4 i6 (mk___rep5 (mk___split_fields5 (ite (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 count_r))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 count_l)))) true false) (rec__red_black_trees__black_count__depth (us_split_fields11 (select res4 i6))) (rec__red_black_trees__black_count__count (us_split_fields11 (select res4 i6))))))))
(assert (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) i6)) 0))
(assert (not (in_range3 (+ (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 count_l))) 1))))
(check-sat)
(exit)
