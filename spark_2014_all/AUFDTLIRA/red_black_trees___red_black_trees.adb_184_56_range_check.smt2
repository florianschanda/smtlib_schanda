...
(assert (and (= o17 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i2 1)) (and (in_range3 o17) (= o17 (peek1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) i2 1)))))
(assert (= red_black_trees__nb_blacks__B_3__count_r__assume (select res3 o17)))
(assert (= red_black_trees__nb_blacks__B_3__count_r__assume count_r))
(assert (and (= o18 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i2 0)) (and (in_range3 o18) (= o18 (peek1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) i2 0)))))
(assert (= red_black_trees__nb_blacks__B_3__count_l__assume (select res3 o18)))
...
(assert (= o20 (mk___split_fields5 (rec__red_black_trees__black_count__status (us_split_fields11 (select res3 i2))) o19 (rec__red_black_trees__black_count__count (us_split_fields11 (select res3 i2))))))
