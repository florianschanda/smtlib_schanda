...
(assert (= result2 true))
(assert (and (= o17 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (and (in_range5 o17) (<= (+ 0 o17) 2147483647))))
(assert (= o18 (ite (<= j o17) true false)))
(assert (= result12 (ite (<= 1 j) o18 false)))
(assert (= result12 true))
(assert (and (= o19 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (and (in_range5 o19) (<= (+ 0 o19) 2147483647))))
(assert (= o20 (ite (<= k o19) true false)))
(assert (= result13 (ite (<= 1 k) o20 false)))
