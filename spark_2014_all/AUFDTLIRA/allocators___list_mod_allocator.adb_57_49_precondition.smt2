...
(assert (and (= o11 (length (rec__list_mod_allocator__m__t__available (us_split_fields1 m)))) (and (in_range2 o11) (<= (+ 0 o11) 2147483647))))
(assert (= result3 (ite (<= o11 10000) true false)))
(assert (=> (= result3 true) (=> (not (= first_available 0)) (and (= o9 (length (rec__list_mod_allocator__m__t__available (us_split_fields1 m)))) (and (in_range2 o9) (<= (+ 0 o9) 2147483647))))))
(assert (=> (= result3 true) (=> (not (= first_available 0)) (= result4 (ite (< 0 o9) true false)))))
(assert (=> (= result3 true) (=> (not (= first_available 0)) (=> (= result4 true) (and (= o8 (get (rec__list_mod_allocator__m__t__available (us_split_fields1 m)) 1)) (in_range3 o8))))))
(assert (=> (= result3 true) (=> (not (= first_available 0)) (=> (= result4 true) (= result2 (ite (= o8 first_available) true false))))))
(assert (=> (= result3 true) (=> (not (= first_available 0)) (=> (not (= result4 true)) (= result2 false)))))
(assert (=> (= result3 true) (=> (not (not (= first_available 0))) (and (= o10 (length (rec__list_mod_allocator__m__t__available (us_split_fields1 m)))) (and (in_range2 o10) (<= (+ 0 o10) 2147483647))))))
(assert (=> (= result3 true) (=> (not (not (= first_available 0))) (= result2 (ite (= o10 0) true false)))))
(assert (=> (not (= result3 true)) (= result2 false)))
(assert (=> (= result2 true) (and (= o6 (length (rec__list_mod_allocator__m__t__available (us_split_fields1 m)))) (and (in_range2 o6) (<= (+ 0 o6) 2147483647)))))
(assert (=> (= result2 true) (= o7 (ite (<= j2 o6) true false))))
(assert (=> (= result2 true) (= result5 (ite (<= 1 j2) o7 false))))
...
(assert (=> (= result1 true) (and (= o4 (length (rec__list_mod_allocator__m__t__available (us_split_fields1 m)))) (and (in_range2 o4) (<= (+ 0 o4) 2147483647)))))
(assert (=> (= result1 true) (= o5 (ite (<= j1 o4) true false))))
(assert (=> (= result1 true) (= result6 (ite (<= 1 j1) o5 false))))
...
(assert (= result8 true))
(assert (not (<= k (last (rec__list_mod_allocator__m__t__available (us_split_fields1 m))))))
(check-sat)
(exit)
