...
(assert (and (= o11 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (and (in_range5 o11) (<= (+ 0 o11) 2147483647))))
(assert (= result3 (ite (<= o11 10000) true false)))
(assert (=> (= result3 true) (=> (not (= first_available 0)) (and (= o9 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (and (in_range5 o9) (<= (+ 0 o9) 2147483647))))))
(assert (=> (= result3 true) (=> (not (= first_available 0)) (= result4 (ite (< 0 o9) true false)))))
(assert (=> (= result3 true) (=> (not (= first_available 0)) (=> (= result4 true) (and (= o8 (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m)) 1)) (in_range6 o8))))))
...
(assert (=> (= result3 true) (=> (not (not (= first_available 0))) (and (= o10 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (and (in_range5 o10) (<= (+ 0 o10) 2147483647))))))
(assert (=> (= result3 true) (=> (not (not (= first_available 0))) (= result2 (ite (= o10 0) true false)))))
(assert (=> (not (= result3 true)) (= result2 false)))
(assert (=> (= result2 true) (and (= o6 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (and (in_range5 o6) (<= (+ 0 o6) 2147483647)))))
...
(assert (=> (= result1 true) (and (= o4 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (and (in_range5 o4) (<= (+ 0 o4) 2147483647)))))
...
(assert (= result true))
(assert (and (= o (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (and (in_range5 o) (<= (+ 0 o) 2147483647))))
(assert (= o1 (ite (<= j o) true false)))
(assert (= result7 (ite (<= 1 j) o1 false)))
(assert (= result7 true))
(assert (and (= o2 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (and (in_range5 o2) (<= (+ 0 o2) 2147483647))))
