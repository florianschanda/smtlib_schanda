...
(define-fun dynamic_invariant1 ((temp___expr_535 Int) (temp___is_init_531 Bool) (temp___skip_constant_532 Bool) (temp___do_toplevel_533 Bool) (temp___do_typ_inv_534 Bool)) Bool (=> (or (= temp___is_init_531 true) (<= 0 255)) (in_range4 temp___expr_535)))
...
(define-fun dynamic_invariant2 ((temp___expr_542 Int) (temp___is_init_538 Bool) (temp___skip_constant_539 Bool) (temp___do_toplevel_540 Bool) (temp___do_typ_inv_541 Bool)) Bool (=> (or (= temp___is_init_538 true) (<= 2 16)) (in_range5 temp___expr_542)))
...
(assert (forall ((source us_t)) (forall ((pattern Int)) (! (=> (and (dynamic_invariant4 source true true true true) (dynamic_invariant3 pattern true true true true)) (dynamic_invariant (count source pattern) true false true true)) :pattern ((count source pattern))))))
(declare-sort t1 0)
...
(define-fun dynamic_invariant5 ((temp___expr_600 Int) (temp___is_init_596 Bool) (temp___skip_constant_597 Bool) (temp___do_toplevel_598 Bool) (temp___do_typ_inv_599 Bool)) Bool (=> (or (= temp___is_init_596 true) (<= 0 255)) (in_range6 temp___expr_600)))
(define-fun dynamic_invariant6 ((temp___expr_614 us_t1) (temp___is_init_610 Bool) (temp___skip_constant_611 Bool) (temp___do_toplevel_612 Bool) (temp___do_typ_inv_613 Bool)) Bool (=> (not (= temp___skip_constant_611 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_614) (last3 temp___expr_614))))
(declare-fun char_count (us_t1 Int) Int)
(declare-fun char_count__function_guard (Int us_t1 Int) Bool)
(assert (forall ((source us_t1)) (forall ((pattern Int)) (! (=> (and (dynamic_invariant6 source true true true true) (dynamic_invariant5 pattern true true true true)) (dynamic_invariant (char_count source pattern) true false true true)) :pattern ((char_count source pattern))))))
...
(define-fun dynamic_invariant7 ((temp___expr_645 Int) (temp___is_init_641 Bool) (temp___skip_constant_642 Bool) (temp___do_toplevel_643 Bool) (temp___do_typ_inv_644 Bool)) Bool (=> (or (= temp___is_init_641 true) (<= 0 100)) (in_range8 temp___expr_645)))
(define-fun dynamic_invariant8 ((temp___expr_659 us_t3) (temp___is_init_655 Bool) (temp___skip_constant_656 Bool) (temp___do_toplevel_657 Bool) (temp___do_typ_inv_658 Bool)) Bool (=> (not (= temp___skip_constant_656 true)) (dynamic_property3 0 255 (first7 temp___expr_659) (last7 temp___expr_659))))
(declare-fun percent_count (us_t3 Int) Int)
(declare-fun percent_count__function_guard (Int us_t3 Int) Bool)
(assert (forall ((source us_t3)) (forall ((pattern Int)) (! (=> (and (dynamic_invariant8 source true true true true) (dynamic_invariant7 pattern true true true true)) (dynamic_invariant (percent_count source pattern) true false true true)) :pattern ((percent_count source pattern))))))
(declare-sort t4 0)
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_720 us_void_param) 1)) 72) (= (to_rep (select (temp___String_Literal_720 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_720 us_void_param) 3)) 119)) (= (to_rep (select (temp___String_Literal_720 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_720 us_void_param) 5)) 110)) (= (to_rep (select (temp___String_Literal_720 us_void_param) 6)) 111)) (= (to_rep (select (temp___String_Literal_720 us_void_param) 7)) 119)) (= (to_rep (select (temp___String_Literal_720 us_void_param) 8)) 32)) (= (to_rep (select (temp___String_Literal_720 us_void_param) 9)) 98)) (= (to_rep (select (temp___String_Literal_720 us_void_param) 10)) 114)) (= (to_rep (select (temp___String_Literal_720 us_void_param) 11)) 111)) (= (to_rep (select (temp___String_Literal_720 us_void_param) 12)) 119)) (= (to_rep (select (temp___String_Literal_720 us_void_param) 13)) 110)) (= (to_rep (select (temp___String_Literal_720 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_720 us_void_param) 15)) 99)) (= (to_rep (select (temp___String_Literal_720 us_void_param) 16)) 111)) (= (to_rep (select (temp___String_Literal_720 us_void_param) 17)) 119)) :pattern ((temp___String_Literal_720 us_void_param)))))
(declare-fun temp___String_Literal_721 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_721 us_void_param) 1)) 72) (= (to_rep (select (temp___String_Literal_721 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 3)) 119)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 5)) 110)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 6)) 111)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 7)) 119)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 8)) 32)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 9)) 98)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 10)) 114)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 11)) 111)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 12)) 119)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 13)) 110)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 15)) 99)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 16)) 111)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 17)) 119)) :pattern ((temp___String_Literal_721 us_void_param)))))
...
(define-fun dynamic_invariant11 ((temp___expr_632 Int) (temp___is_init_628 Bool) (temp___skip_constant_629 Bool) (temp___do_toplevel_630 Bool) (temp___do_typ_inv_631 Bool)) Bool (=> (or (= temp___is_init_628 true) (<= 0 100)) (in_range7 temp___expr_632)))
(define-fun dynamic_invariant12 ((temp___expr_639 us_t2) (temp___is_init_635 Bool) (temp___skip_constant_636 Bool) (temp___do_toplevel_637 Bool) (temp___do_typ_inv_638 Bool)) Bool (=> (not (= temp___skip_constant_636 true)) (dynamic_property2 0 255 (first5 temp___expr_639) (last5 temp___expr_639))))
(assert (forall ((temp___705 Int) (temp___706 Int) (temp___707 Int) (temp___708 Int) (temp___709 Int) (temp___710 Int) (temp___711 Int) (temp___712 Int) (temp___713 Int) (temp___714 Int) (temp___715 Int) (temp___716 Int) (temp___717 Int)) (let ((temp___704 (generic_examples__my_percents__aggregate_def temp___705 temp___706 temp___707 temp___708 temp___709 temp___710 temp___711 temp___712 temp___713 temp___714 temp___715 temp___716 temp___717))) (=> (and (and (and (and (and (and (and (and (and (and (and (and (dynamic_invariant11 temp___705 true true true true) (dynamic_invariant11 temp___706 true true true true)) (dynamic_invariant11 temp___707 true true true true)) (dynamic_invariant11 temp___708 true true true true)) (dynamic_invariant11 temp___709 true true true true)) (dynamic_invariant11 temp___710 true true true true)) (dynamic_invariant11 temp___711 true true true true)) (dynamic_invariant11 temp___712 true true true true)) (dynamic_invariant11 temp___713 true true true true)) (dynamic_invariant11 temp___714 true true true true)) (dynamic_invariant11 temp___715 true true true true)) (dynamic_invariant11 temp___716 true true true true)) (dynamic_invariant11 temp___717 true true true true)) (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep2 (select temp___704 0)) temp___705) (= (to_rep2 (select temp___704 1)) temp___706)) (= (to_rep2 (select temp___704 2)) temp___707)) (= (to_rep2 (select temp___704 3)) temp___708)) (= (to_rep2 (select temp___704 4)) temp___709)) (= (to_rep2 (select temp___704 5)) temp___710)) (= (to_rep2 (select temp___704 6)) temp___711)) (= (to_rep2 (select temp___704 7)) temp___712)) (= (to_rep2 (select temp___704 8)) temp___713)) (= (to_rep2 (select temp___704 9)) temp___714)) (= (to_rep2 (select temp___704 10)) temp___715)) (= (to_rep2 (select temp___704 11)) temp___716)) (= (to_rep2 (select temp___704 12)) temp___717))))))
(define-fun dynamic_invariant13 ((temp___expr_691 us_t4) (temp___is_init_687 Bool) (temp___skip_constant_688 Bool) (temp___do_toplevel_689 Bool) (temp___do_typ_inv_690 Bool)) Bool (=> (not (= temp___skip_constant_688 true)) (dynamic_property4 0 255 (first9 temp___expr_691) (last9 temp___expr_691))))
...
(assert (and (= o (count (mk___t (temp___String_Literal_720 Tuple0) (mk 1 17)) 119)) (in_range3 o)))
(assert (= result1 the_count))
(assert (= the_count1 o))
(assert (dynamic_property1 1 2147483647 1 17))
(assert (= (temp___String_Literal_721 Tuple0) o1))
(assert (= (mk1 1 17) o2))
