...
(define-fun dynamic_invariant1 ((temp___expr_473 Int) (temp___is_init_470 Bool) (temp___skip_constant_471 Bool) (temp___do_toplevel_472 Bool)) Bool (=> (or (= temp___is_init_470 true) (<= 0 255)) (in_range4 temp___expr_473)))
...
(define-fun dynamic_invariant2 ((temp___expr_479 Int) (temp___is_init_476 Bool) (temp___skip_constant_477 Bool) (temp___do_toplevel_478 Bool)) Bool (=> (or (= temp___is_init_476 true) (<= 2 16)) (in_range5 temp___expr_479)))
...
(define-fun dynamic_invariant5 ((temp___expr_533 Int) (temp___is_init_530 Bool) (temp___skip_constant_531 Bool) (temp___do_toplevel_532 Bool)) Bool (=> (or (= temp___is_init_530 true) (<= 0 255)) (in_range6 temp___expr_533)))
...
(define-fun dynamic_invariant7 ((temp___expr_572 Int) (temp___is_init_569 Bool) (temp___skip_constant_570 Bool) (temp___do_toplevel_571 Bool)) Bool (=> (or (= temp___is_init_569 true) (<= 0 100)) (in_range8 temp___expr_572)))
(define-fun dynamic_invariant8 ((temp___expr_584 us_t3) (temp___is_init_581 Bool) (temp___skip_constant_582 Bool) (temp___do_toplevel_583 Bool)) Bool (=> (not (= temp___skip_constant_582 true)) (dynamic_property3 0 255 (first7 temp___expr_584) (last7 temp___expr_584))))
...
(assert (forall ((temp___625 Int) (temp___626 Int) (temp___627 Int) (temp___628 Int) (temp___629 Int) (temp___630 Int) (temp___631 Int) (temp___632 Int) (temp___633 Int) (temp___634 Int) (temp___635 Int) (temp___636 Int) (temp___637 Int)) (let ((temp___624 (generic_examples__my_percents__aggregate_def temp___625 temp___626 temp___627 temp___628 temp___629 temp___630 temp___631 temp___632 temp___633 temp___634 temp___635 temp___636 temp___637))) (and (and (and (and (and (and (and (and (and (and (and (and (= (select temp___624 0) (of_rep2 temp___625)) (= (select temp___624 1) (of_rep2 temp___626))) (= (select temp___624 2) (of_rep2 temp___627))) (= (select temp___624 3) (of_rep2 temp___628))) (= (select temp___624 4) (of_rep2 temp___629))) (= (select temp___624 5) (of_rep2 temp___630))) (= (select temp___624 6) (of_rep2 temp___631))) (= (select temp___624 7) (of_rep2 temp___632))) (= (select temp___624 8) (of_rep2 temp___633))) (= (select temp___624 9) (of_rep2 temp___634))) (= (select temp___624 10) (of_rep2 temp___635))) (= (select temp___624 11) (of_rep2 temp___636))) (= (select temp___624 12) (of_rep2 temp___637))))))
(declare-fun temp___String_Literal_640 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_640 us_void_param) 1)) 72) (= (to_rep (select (temp___String_Literal_640 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_640 us_void_param) 3)) 119)) (= (to_rep (select (temp___String_Literal_640 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_640 us_void_param) 5)) 110)) (= (to_rep (select (temp___String_Literal_640 us_void_param) 6)) 111)) (= (to_rep (select (temp___String_Literal_640 us_void_param) 7)) 119)) (= (to_rep (select (temp___String_Literal_640 us_void_param) 8)) 32)) (= (to_rep (select (temp___String_Literal_640 us_void_param) 9)) 98)) (= (to_rep (select (temp___String_Literal_640 us_void_param) 10)) 114)) (= (to_rep (select (temp___String_Literal_640 us_void_param) 11)) 111)) (= (to_rep (select (temp___String_Literal_640 us_void_param) 12)) 119)) (= (to_rep (select (temp___String_Literal_640 us_void_param) 13)) 110)) (= (to_rep (select (temp___String_Literal_640 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_640 us_void_param) 15)) 99)) (= (to_rep (select (temp___String_Literal_640 us_void_param) 16)) 111)) (= (to_rep (select (temp___String_Literal_640 us_void_param) 17)) 119)) :pattern ((temp___String_Literal_640 us_void_param)))))
(declare-fun temp___String_Literal_641 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_641 us_void_param) 1)) 72) (= (to_rep (select (temp___String_Literal_641 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_641 us_void_param) 3)) 119)) (= (to_rep (select (temp___String_Literal_641 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_641 us_void_param) 5)) 110)) (= (to_rep (select (temp___String_Literal_641 us_void_param) 6)) 111)) (= (to_rep (select (temp___String_Literal_641 us_void_param) 7)) 119)) (= (to_rep (select (temp___String_Literal_641 us_void_param) 8)) 32)) (= (to_rep (select (temp___String_Literal_641 us_void_param) 9)) 98)) (= (to_rep (select (temp___String_Literal_641 us_void_param) 10)) 114)) (= (to_rep (select (temp___String_Literal_641 us_void_param) 11)) 111)) (= (to_rep (select (temp___String_Literal_641 us_void_param) 12)) 119)) (= (to_rep (select (temp___String_Literal_641 us_void_param) 13)) 110)) (= (to_rep (select (temp___String_Literal_641 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_641 us_void_param) 15)) 99)) (= (to_rep (select (temp___String_Literal_641 us_void_param) 16)) 111)) (= (to_rep (select (temp___String_Literal_641 us_void_param) 17)) 119)) :pattern ((temp___String_Literal_641 us_void_param)))))
...
(define-fun dynamic_invariant11 ((temp___expr_561 Int) (temp___is_init_558 Bool) (temp___skip_constant_559 Bool) (temp___do_toplevel_560 Bool)) Bool (=> (or (= temp___is_init_558 true) (<= 0 100)) (in_range7 temp___expr_561)))
(define-fun dynamic_invariant12 ((temp___expr_567 us_t2) (temp___is_init_564 Bool) (temp___skip_constant_565 Bool) (temp___do_toplevel_566 Bool)) Bool (=> (not (= temp___skip_constant_565 true)) (dynamic_property2 0 255 (first5 temp___expr_567) (last5 temp___expr_567))))
(define-fun dynamic_invariant13 ((temp___expr_612 us_t4) (temp___is_init_609 Bool) (temp___skip_constant_610 Bool) (temp___do_toplevel_611 Bool)) Bool (=> (not (= temp___skip_constant_610 true)) (dynamic_property4 0 255 (first9 temp___expr_612) (last9 temp___expr_612))))
...
(assert (and (= o (count (mk___t (temp___String_Literal_640 Tuple0) (mk 1 17)) 119)) (in_range3 o)))
(assert (= result1 the_count))
(assert (= the_count1 o))
(assert (dynamic_property1 1 2147483647 1 17))
(assert (= (temp___String_Literal_641 Tuple0) o1))
(assert (= (mk1 1 17) o2))
