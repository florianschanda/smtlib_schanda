...
(define-fun dynamic_invariant1 ((temp___expr_467 Int) (temp___is_init_464 Bool) (temp___skip_constant_465 Bool) (temp___do_toplevel_466 Bool)) Bool (=> (or (= temp___is_init_464 true) (<= 0 255)) (in_range4 temp___expr_467)))
...
(declare-const dummy6 number_base)
...
(define-fun dynamic_invariant2 ((temp___expr_473 Int) (temp___is_init_470 Bool) (temp___skip_constant_471 Bool) (temp___do_toplevel_472 Bool)) Bool (=> (or (= temp___is_init_470 true) (<= 2 16)) (in_range5 temp___expr_473)))
...
(assert (forall ((source us_t)) (forall ((pattern Int)) (! (=> (and (dynamic_invariant4 source true true true) (dynamic_invariant3 pattern true true true)) (dynamic_invariant (count source pattern) true false true)) :pattern ((count source pattern))))))
(declare-sort t1 0)
...
(declare-const dummy8 component_type)
...
(define-fun dynamic_invariant5 ((temp___expr_527 Int) (temp___is_init_524 Bool) (temp___skip_constant_525 Bool) (temp___do_toplevel_526 Bool)) Bool (=> (or (= temp___is_init_524 true) (<= 0 255)) (in_range6 temp___expr_527)))
(define-fun dynamic_invariant6 ((temp___expr_539 us_t1) (temp___is_init_536 Bool) (temp___skip_constant_537 Bool) (temp___do_toplevel_538 Bool)) Bool (=> (not (= temp___skip_constant_537 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_539) (last3 temp___expr_539))))
(declare-fun char_count (us_t1 Int) Int)
(declare-fun char_count__function_guard (Int us_t1 Int) Bool)
(assert (forall ((source us_t1)) (forall ((pattern Int)) (! (=> (and (dynamic_invariant6 source true true true) (dynamic_invariant5 pattern true true true)) (dynamic_invariant (char_count source pattern) true false true)) :pattern ((char_count source pattern))))))
...
(assert (forall ((x percent)) (! (in_range7 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(declare-fun concat2 ((Array Int percent) Int Int (Array Int percent) Int Int) (Array Int percent))
(assert (forall ((a (Array Int percent)) (b (Array Int percent))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (forall ((i Int)) (! (and (=> (and (<= a_first i) (<= i a_last)) (= (select (concat2 a a_first a_last b b_first b_last) i) (select a i))) (=> (< a_last i) (= (select (concat2 a a_first a_last b b_first b_last) i) (select b (+ (- i a_last) (- b_first 1)))))) :pattern ((select (concat2 a a_first a_last b b_first b_last) i)))))))
(declare-fun singleton2 (percent Int) (Array Int percent))
(assert (forall ((v percent)) (forall ((i Int)) (! (= (select (singleton2 v i) i) v) :pattern ((select (singleton2 v i) i))))))
(define-fun bool_eq3 ((a (Array Int percent)) (a__first Int) (a__last Int) (b (Array Int percent)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_151 Int)) (=> (and (<= a__first temp___idx_151) (<= temp___idx_151 a__last)) (= (to_rep2 (select a temp___idx_151)) (to_rep2 (select b (+ (- b__first a__first) temp___idx_151))))))) true false))
...
(declare-fun compare1 ((Array Int percent) Int Int (Array Int percent) Int Int) Int)
(assert (forall ((a (Array Int percent)) (b (Array Int percent))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare1 a a_first a_last b b_first b_last) 0) (= (bool_eq3 a a_first a_last b b_first b_last) true)) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int percent)) (b (Array Int percent))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare1 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq3 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep2 (select a (+ i 1))) (to_rep2 (select b (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int percent)) (b (Array Int percent))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare1 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq3 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep2 (select b (+ i 1))) (to_rep2 (select a (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(declare-sort t2 0)
...
(declare-datatypes () ((percent_array__ref (mk_percent_array__ref (percent_array__content us_t2)))))
(define-fun percent_array__ref___projection ((a percent_array__ref)) us_t2 (percent_array__content a))
(declare-sort t3 0)
...
(declare-datatypes () ((array_type__ref1 (mk_array_type__ref1 (array_type__content1 us_t3)))))
(define-fun array_type__ref___2__projection ((a array_type__ref1)) us_t3 (array_type__content1 a))
...
(declare-const dummy12 component_type1)
...
(define-fun dynamic_invariant7 ((temp___expr_566 Int) (temp___is_init_563 Bool) (temp___skip_constant_564 Bool) (temp___do_toplevel_565 Bool)) Bool (=> (or (= temp___is_init_563 true) (<= 0 100)) (in_range8 temp___expr_566)))
(define-fun dynamic_invariant8 ((temp___expr_578 us_t3) (temp___is_init_575 Bool) (temp___skip_constant_576 Bool) (temp___do_toplevel_577 Bool)) Bool (=> (not (= temp___skip_constant_576 true)) (dynamic_property3 0 255 (first7 temp___expr_578) (last7 temp___expr_578))))
(declare-fun percent_count (us_t3 Int) Int)
(declare-fun percent_count__function_guard (Int us_t3 Int) Bool)
(assert (forall ((source us_t3)) (forall ((pattern Int)) (! (=> (and (dynamic_invariant8 source true true true) (dynamic_invariant7 pattern true true true)) (dynamic_invariant (percent_count source pattern) true false true)) :pattern ((percent_count source pattern))))))
(declare-sort t4 0)
...
(declare-datatypes () ((array_type__ref2 (mk_array_type__ref2 (array_type__content2 us_t4)))))
(define-fun array_type__ref___3__projection ((a array_type__ref2)) us_t4 (array_type__content2 a))
...
(assert (forall ((temp___619 Int) (temp___620 Int) (temp___621 Int) (temp___622 Int) (temp___623 Int) (temp___624 Int) (temp___625 Int) (temp___626 Int) (temp___627 Int) (temp___628 Int) (temp___629 Int) (temp___630 Int) (temp___631 Int)) (let ((temp___618 (generic_examples__my_percents__aggregate_def temp___619 temp___620 temp___621 temp___622 temp___623 temp___624 temp___625 temp___626 temp___627 temp___628 temp___629 temp___630 temp___631))) (and (and (and (and (and (and (and (and (and (and (and (and (= (select temp___618 0) (of_rep2 temp___619)) (= (select temp___618 1) (of_rep2 temp___620))) (= (select temp___618 2) (of_rep2 temp___621))) (= (select temp___618 3) (of_rep2 temp___622))) (= (select temp___618 4) (of_rep2 temp___623))) (= (select temp___618 5) (of_rep2 temp___624))) (= (select temp___618 6) (of_rep2 temp___625))) (= (select temp___618 7) (of_rep2 temp___626))) (= (select temp___618 8) (of_rep2 temp___627))) (= (select temp___618 9) (of_rep2 temp___628))) (= (select temp___618 10) (of_rep2 temp___629))) (= (select temp___618 11) (of_rep2 temp___630))) (= (select temp___618 12) (of_rep2 temp___631))))))
(declare-fun temp___String_Literal_634 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_634 us_void_param) 1)) 72) (= (to_rep (select (temp___String_Literal_634 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_634 us_void_param) 3)) 119)) (= (to_rep (select (temp___String_Literal_634 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_634 us_void_param) 5)) 110)) (= (to_rep (select (temp___String_Literal_634 us_void_param) 6)) 111)) (= (to_rep (select (temp___String_Literal_634 us_void_param) 7)) 119)) (= (to_rep (select (temp___String_Literal_634 us_void_param) 8)) 32)) (= (to_rep (select (temp___String_Literal_634 us_void_param) 9)) 98)) (= (to_rep (select (temp___String_Literal_634 us_void_param) 10)) 114)) (= (to_rep (select (temp___String_Literal_634 us_void_param) 11)) 111)) (= (to_rep (select (temp___String_Literal_634 us_void_param) 12)) 119)) (= (to_rep (select (temp___String_Literal_634 us_void_param) 13)) 110)) (= (to_rep (select (temp___String_Literal_634 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_634 us_void_param) 15)) 99)) (= (to_rep (select (temp___String_Literal_634 us_void_param) 16)) 111)) (= (to_rep (select (temp___String_Literal_634 us_void_param) 17)) 119)) :pattern ((temp___String_Literal_634 us_void_param)))))
(declare-fun temp___String_Literal_635 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_635 us_void_param) 1)) 72) (= (to_rep (select (temp___String_Literal_635 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_635 us_void_param) 3)) 119)) (= (to_rep (select (temp___String_Literal_635 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_635 us_void_param) 5)) 110)) (= (to_rep (select (temp___String_Literal_635 us_void_param) 6)) 111)) (= (to_rep (select (temp___String_Literal_635 us_void_param) 7)) 119)) (= (to_rep (select (temp___String_Literal_635 us_void_param) 8)) 32)) (= (to_rep (select (temp___String_Literal_635 us_void_param) 9)) 98)) (= (to_rep (select (temp___String_Literal_635 us_void_param) 10)) 114)) (= (to_rep (select (temp___String_Literal_635 us_void_param) 11)) 111)) (= (to_rep (select (temp___String_Literal_635 us_void_param) 12)) 119)) (= (to_rep (select (temp___String_Literal_635 us_void_param) 13)) 110)) (= (to_rep (select (temp___String_Literal_635 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_635 us_void_param) 15)) 99)) (= (to_rep (select (temp___String_Literal_635 us_void_param) 16)) 111)) (= (to_rep (select (temp___String_Literal_635 us_void_param) 17)) 119)) :pattern ((temp___String_Literal_635 us_void_param)))))
...
(define-fun dynamic_invariant10 ((temp___expr_15 Int) (temp___is_init_12 Bool) (temp___skip_constant_13 Bool) (temp___do_toplevel_14 Bool)) Bool (=> (or (= temp___is_init_12 true) (<= (- 2147483648) 2147483647)) (in_range temp___expr_15)))
(define-fun dynamic_invariant11 ((temp___expr_555 Int) (temp___is_init_552 Bool) (temp___skip_constant_553 Bool) (temp___do_toplevel_554 Bool)) Bool (=> (or (= temp___is_init_552 true) (<= 0 100)) (in_range7 temp___expr_555)))
(define-fun dynamic_invariant12 ((temp___expr_561 us_t2) (temp___is_init_558 Bool) (temp___skip_constant_559 Bool) (temp___do_toplevel_560 Bool)) Bool (=> (not (= temp___skip_constant_559 true)) (dynamic_property2 0 255 (first5 temp___expr_561) (last5 temp___expr_561))))
(define-fun dynamic_invariant13 ((temp___expr_606 us_t4) (temp___is_init_603 Bool) (temp___skip_constant_604 Bool) (temp___do_toplevel_605 Bool)) Bool (=> (not (= temp___skip_constant_604 true)) (dynamic_property4 0 255 (first9 temp___expr_606) (last9 temp___expr_606))))
...
(declare-const o4 (Array Int percent))
(declare-const o5 t3)
...
(assert (dynamic_property2 0 255 (to_rep my_percents__first) (to_rep my_percents__last)))
(assert (and (= o (count (mk___t (temp___String_Literal_634 Tuple0) (mk 1 17)) 119)) (in_range3 o)))
(assert (= result1 the_count))
(assert (= the_count1 o))
(assert (dynamic_property1 1 2147483647 1 17))
(assert (= (temp___String_Literal_635 Tuple0) o1))
(assert (= (mk1 1 17) o2))
(assert (and (= o3 (char_count (mk___t1 o1 o2) 119)) (in_range3 o3)))
(assert (= result2 the_count1))
(assert (= the_count2 o3))
(assert (dynamic_property3 0 255 (to_rep my_percents__first) (to_rep my_percents__last)))
(assert (= my_percents1 o4))
(assert (= (mk3 (to_rep my_percents__first) (to_rep my_percents__last)) o5))
(assert (and (= o6 (percent_count (mk___t3 o4 o5) 5)) (in_range3 o6)))
(assert (= result3 the_count2))
(assert (= the_count3 o6))
(assert (not (dynamic_property4 0 255 (to_rep my_percents__first) (to_rep my_percents__last))))
(check-sat)
(exit)
