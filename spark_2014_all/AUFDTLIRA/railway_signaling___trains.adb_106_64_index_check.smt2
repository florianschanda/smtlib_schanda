...
(assert (and (= o11 (get_previous_track o13 id1)) (and (in_range3 o11) (= o11 (to_rep2 (select (select previous_tracks (to_rep (rec__trains__track__from (us_split_fields1 (select tracks (to_rep4 o10)))))) id1))))))
(assert (= o12 (ite (= o11 0) true false)))
(assert (= result8 (ite (not (= o12 true)) true false)))
(assert (= result8 true))
(assert (not (<= train1 10)))
(check-sat)
(exit)
