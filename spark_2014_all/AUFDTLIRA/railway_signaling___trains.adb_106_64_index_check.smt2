...
(assert (= result3 true))
(assert (= (mk_int__ref result4) (mk_int__ref result__)))
(assert (= result__2 2))
(assert (= (mk_map__ref3 result5) (mk_map__ref3 trains)))
(assert (= trains3 (store trains train new_position)))
(assert (= (previous_tracks_on_orange_or_red cur_num_trains trains3 track_signals) true))
(assert (= (to_rep5 o) 1))
(assert (= o1 (store track_signals (to_rep (rec__trains__train_position__track_end (us_split_fields3 cur_position))) o)))
(assert (= (mk_map__ref4 result6) (mk_map__ref4 track_signals)))
(assert (= track_signals2 o1))
(assert (= (no_track_precedes_itself Tuple0) true))
(assert (= (occupied_tracks_on_red cur_num_trains trains3 track_signals2) true))
(assert (= (previous_tracks_on_orange_or_red cur_num_trains trains3 track_signals2) true))
(assert (= (mk_int__ref result7) (mk_int__ref id)))
(assert (= id5 1))
(assert (=> (and (<= 1 id5) (<= id5 3)) (and (and (= temp___371 track_signals2) (and (= temp___370 prev) (and (= temp___369 track_signals2) (and (= temp___372 track_signals2) (and (= temp___367 id5) (and (and (and (= o2 (get_previous_track cur_position id5)) (and (in_range1 o2) (= o2 (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep (rec__trains__train_position__track_end (us_split_fields3 cur_position)))))))) id5))))) (and (= result8 (mk_int__ref prev)) (= prev2 o2))) (and (and (ite (not (= prev2 0)) (and (and (and (and (and (<= 1 prev2) (<= prev2 8)) (= o3 prev2)) (= o4 (select track_signals2 o3))) (= o5 (to_rep5 o4))) (= result9 (ite (= o5 1) true false))) (= result9 false)) (ite (= result9 true) (and (and (= o6 prev2) (in_range2 prev2)) (and (ite (exists ((t1 Int)) (and (and (<= 1 t1) (<= t1 cur_num_trains)) (= (is_previous_track (select trains3 t1) o6) true))) (= (to_rep5 (select track_signals3 o6)) 1) (= (to_rep5 (select track_signals3 o6)) 0)) (forall ((other_track Int)) (=> (and (<= 1 other_track) (<= other_track 8)) (=> (not (= other_track o6)) (= (to_rep5 (select track_signals3 other_track)) (to_rep5 (select track_signals2 other_track)))))))) (= track_signals3 track_signals2))) (and (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 8)) (and (=> (= (to_rep5 (select temp___371 j1)) 2) (= (to_rep5 (select track_signals4 j1)) 2)) (=> (and (= (to_rep5 (select temp___372 j1)) 1) (exists ((t1 Int)) (and (and (<= 1 t1) (<= t1 cur_num_trains)) (= (is_previous_track (select trains3 t1) j1) true)))) (= (to_rep5 (select track_signals4 j1)) 1))))) (and (and (and (=> (<= 1 3) (in_range3 id6)) (=> (<= 0 8) (in_range1 prev3))) (and (<= 1 id6) (<= id6 3))) (= id6 3)))))))))) (and (and (= id10 (mk_int__ref id6)) (and (= prev7 (mk_int__ref prev3)) (= track_signals8 (mk_map__ref4 track_signals4)))) (and (= id11 id6) (and (= prev8 prev3) (= track_signals9 track_signals4)))))))
(assert (=> (and (<= 1 id5) (<= id5 3)) (= id12 id10)))
(assert (=> (and (<= 1 id5) (<= id5 3)) (= prev9 prev7)))
(assert (=> (and (<= 1 id5) (<= id5 3)) (= track_signals10 track_signals8)))
(assert (=> (and (<= 1 id5) (<= id5 3)) (= id13 id11)))
(assert (=> (and (<= 1 id5) (<= id5 3)) (= prev10 prev8)))
(assert (=> (and (<= 1 id5) (<= id5 3)) (= track_signals11 track_signals9)))
(assert (=> (not (and (<= 1 id5) (<= id5 3))) (= id12 (mk_int__ref id5))))
(assert (=> (not (and (<= 1 id5) (<= id5 3))) (= prev9 (mk_int__ref prev))))
(assert (=> (not (and (<= 1 id5) (<= id5 3))) (= track_signals10 (mk_map__ref4 track_signals2))))
(assert (=> (not (and (<= 1 id5) (<= id5 3))) (= id13 id5)))
(assert (=> (not (and (<= 1 id5) (<= id5 3))) (= prev10 prev1)))
(assert (=> (not (and (<= 1 id5) (<= id5 3))) (= track_signals11 track_signals2)))
(assert (= (no_track_precedes_itself Tuple0) true))
(assert (= (occupied_tracks_on_red cur_num_trains trains3 (map__content4 track_signals10)) true))
(assert (<= 1 train1))
...
(assert (= o22 train1))
(assert (= (mk___rep1 (mk___split_fields1 o23 o24 o25)) (select trains3 o22)))
(assert (and (= o26 (get_previous_track (mk___rep1 (mk___split_fields1 o23 o24 o25)) id2)) (and (in_range1 o26) (= o26 (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep o25)))))) id2))))))
(assert (= o27 (ite (= o26 0) true false)))
(assert (= result15 (ite (not (= o27 true)) true false)))
