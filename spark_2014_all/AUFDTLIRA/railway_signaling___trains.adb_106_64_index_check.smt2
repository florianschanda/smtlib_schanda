...
(define-fun o13 () us_rep1 (mk___rep1 (mk___split_fields1 o8 o9 o10)))
...
(assert (=> (and (<= 1 id2) (<= id2 3)) (and (= o2 (get_previous_track cur_position id2)) (and (in_range1 o2) (= o2 (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep (rec__trains__train_position__track_end (us_split_fields3 cur_position)))))))) id2)))))))
...
(assert (=> (and (<= 1 id2) (<= id2 3)) (=> (= result7 true) (and (= o6 prev2) (in_range2 prev2)))))
...
(assert (=> (and (<= 1 id2) (<= id2 3)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 8)) (and (=> (= (to_rep5 (select temp___371 j)) 2) (= (to_rep5 (select track_signals3 j)) 2)) (=> (and (= (to_rep5 (select temp___372 j)) 1) (exists ((t Int)) (and (and (<= 1 t) (<= t cur_num_trains)) (= (is_previous_track (select trains1 t) j) true)))) (= (to_rep5 (select track_signals3 j)) 1)))))))
(assert (=> (and (<= 1 id2) (<= id2 3)) (and (and (=> (<= 1 3) (in_range3 id3)) (=> (<= 0 8) (in_range1 prev3))) (and (<= 1 id3) (<= id3 3)))))
...
(assert (= o7 train1))
(assert (= o13 (select trains1 o7)))
(assert (and (= o11 (get_previous_track o13 id1)) (and (in_range1 o11) (= o11 (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep o10)))))) id1))))))
(assert (= o12 (ite (= o11 0) true false)))
(assert (= result8 (ite (not (= o12 true)) true false)))
(assert (= result8 true))
(assert (not (<= 1 train1)))
(check-sat)
(exit)
