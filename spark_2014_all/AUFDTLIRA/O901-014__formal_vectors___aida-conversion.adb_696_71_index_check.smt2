...
(assert (and (and (forall ((temp___1544 Int)) (=> (and (<= (to_rep1 n__first) temp___1544) (<= temp___1544 (to_rep1 n__last))) (=> (< index3 temp___1544) (= (select n3 temp___1544) (select n1 temp___1544))))) (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (dynamic_property5 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) index3))) (and (<= (to_rep1 (first (rt source))) index3) (<= index3 (+ (to_rep1 (first (rt source))) 9)))))
(assert (<= (to_rep1 (first (rt source))) j))
(assert (<= j index3))
(assert (and (<= (to_rep1 (first (rt source))) j) (<= j (to_rep1 (last (rt source))))))
(assert (= o10 j))
(assert (= o11 (select (elts source) o10)))
(assert (= o12 (to_rep o11)))
(assert (and (= o13 (convert_character_digit_to_integer o12)) (and (in_range1 o13) (and (and (<= 0 o13) (<= o13 9)) (ite (= (= o12 48) true) (= o13 0) (ite (= (= o12 49) true) (= o13 1) (ite (= (= o12 50) true) (= o13 2) (ite (= (= o12 51) true) (= o13 3) (ite (= (= o12 52) true) (= o13 4) (ite (= (= o12 53) true) (= o13 5) (ite (= (= o12 54) true) (= o13 6) (ite (= (= o12 55) true) (= o13 7) (ite (= (= o12 56) true) (= o13 8) (=> (= (= o12 57) true) (= o13 9)))))))))))))))
