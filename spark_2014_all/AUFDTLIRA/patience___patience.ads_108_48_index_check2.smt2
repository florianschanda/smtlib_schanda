...
(assert (= o12 (ite (<= o11 (- (to_rep (rec__patience__state__numelts (us_split_fields1 s))) 1)) true false)))
(assert (and (<= 0 i) (<= i 99)))
(assert (= o6 i))
...
(assert (=> (= result6 true) (= o4 (select (rec__patience__state__preds (us_split_fields1 s)) o3))))
(assert (=> (= result6 true) (= o5 (to_rep o4))))
