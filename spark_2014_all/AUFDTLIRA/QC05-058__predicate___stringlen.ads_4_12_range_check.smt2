...
(declare-datatypes () ((stringf1l20__ref (mk_stringf1l20__ref (stringf1l20__content us_t1)))))
(define-fun stringf1l20__ref___projection ((a stringf1l20__ref)) us_t1 (stringf1l20__content a))
(define-fun dynamic_invariant ((temp___expr_145 us_t1) (temp___is_init_142 Bool) (temp___skip_constant_143 Bool) (temp___do_toplevel_144 Bool)) Bool (and (=> (not (= temp___skip_constant_143 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_145) (last3 temp___expr_145))) (=> (= temp___do_toplevel_144 true) (=> (= temp___is_init_142 true) (and (= (first1 (of_array (to_array1 temp___expr_145) (first3 temp___expr_145) (last3 temp___expr_145))) 1) (<= (last3 temp___expr_145) 20))))))
(define-fun dynamic_predicate ((temp___149 us_t1)) Bool (and (= (first1 (of_array (to_array1 temp___149) (first3 temp___149) (last3 temp___149))) 1) (<= (last3 temp___149) 20)))
(declare-const i3s us_t1)
...
(define-fun dynamic_invariant4 ((temp___expr_135 us_t) (temp___is_init_132 Bool) (temp___skip_constant_133 Bool) (temp___do_toplevel_134 Bool)) Bool (and (=> (not (= temp___skip_constant_133 true)) (dynamic_property 1 2147483647 (first1 temp___expr_135) (last1 temp___expr_135))) (=> (= temp___do_toplevel_134 true) (=> (= temp___is_init_132 true) (= (first1 temp___expr_135) 1)))))
(define-fun dynamic_predicate1 ((temp___138 us_t)) Bool (= (first1 temp___138) 1))
(assert (dynamic_invariant i3s true false false))
(assert (not (dynamic_property 1 2147483647 (to_rep1 (first2 (rt1 i3s))) (to_rep1 (last2 (rt1 i3s))))))
(check-sat)
(exit)
