...
(define-fun dynamic_invariant ((temp___expr_169 us_t1) (temp___is_init_165 Bool) (temp___skip_constant_166 Bool) (temp___do_toplevel_167 Bool) (temp___do_typ_inv_168 Bool)) Bool (and (=> (not (= temp___skip_constant_166 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_169) (last3 temp___expr_169))) (=> (= temp___do_toplevel_167 true) (=> (= temp___is_init_165 true) (and (= (first1 (of_array (to_array1 temp___expr_169) (first3 temp___expr_169) (last3 temp___expr_169))) 1) (<= (last3 temp___expr_169) 20))))))
(define-fun dynamic_predicate ((temp___173 us_t1)) Bool (and (= (first1 (of_array (to_array1 temp___173) (first3 temp___173) (last3 temp___173))) 1) (<= (last3 temp___173) 20)))
...
(define-fun dynamic_invariant4 ((temp___expr_158 us_t) (temp___is_init_154 Bool) (temp___skip_constant_155 Bool) (temp___do_toplevel_156 Bool) (temp___do_typ_inv_157 Bool)) Bool (and (=> (not (= temp___skip_constant_155 true)) (dynamic_property 1 2147483647 (first1 temp___expr_158) (last1 temp___expr_158))) (=> (= temp___do_toplevel_156 true) (=> (= temp___is_init_154 true) (= (first1 temp___expr_158) 1)))))
(define-fun dynamic_predicate1 ((temp___161 us_t)) Bool (= (first1 temp___161) 1))
