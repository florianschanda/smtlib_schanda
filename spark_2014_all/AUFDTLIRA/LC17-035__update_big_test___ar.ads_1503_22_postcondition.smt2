...
(define-fun dynamic_invariant ((temp___expr_239 Int) (temp___is_init_235 Bool) (temp___skip_constant_236 Bool) (temp___do_toplevel_237 Bool) (temp___do_typ_inv_238 Bool)) Bool (=> (or (= temp___is_init_235 true) (<= 0 5)) (in_range3 temp___expr_239)))
...
(define-fun dynamic_invariant1 ((temp___expr_176 Int) (temp___is_init_172 Bool) (temp___skip_constant_173 Bool) (temp___do_toplevel_174 Bool) (temp___do_typ_inv_175 Bool)) Bool (=> (or (= temp___is_init_172 true) (<= 1 10)) (in_range1 temp___expr_176)))
...
(declare-const temp___8129 (Array Int et1))
(declare-const temp___81291 enum2t)
...
(assert (= a r__split_fields2))
(assert (= r__split_fields1 r__split_fields3))
(assert (= (to_rep1 o) e))
(assert (= r__split_fields2 o1))
(assert (= o o2))
(assert (= temp___8129 o1))
(assert (= temp___81291 o2))
(assert (= result2 r__split_fields2))
(assert (= result3 r__split_fields3))
(assert (= temp___8129 r__split_fields4))
(assert (= temp___81291 r__split_fields5))
...
(assert (<= 1 n))
(assert (<= n 10))
(assert (not (= (to_rep (select r__split_fields6 n)) (to_rep (select a n)))))
(check-sat)
(exit)
