...
(define-fun dynamic_invariant ((temp___expr_206 Int) (temp___is_init_203 Bool) (temp___skip_constant_204 Bool) (temp___do_toplevel_205 Bool)) Bool (=> (or (= temp___is_init_203 true) (<= 0 5)) (in_range3 temp___expr_206)))
...
(define-fun dynamic_invariant1 ((temp___expr_152 Int) (temp___is_init_149 Bool) (temp___skip_constant_150 Bool) (temp___do_toplevel_151 Bool)) Bool (=> (or (= temp___is_init_149 true) (<= 1 10)) (in_range1 temp___expr_152)))
...
(declare-const temp___8070 (Array Int et1))
(declare-const temp___80701 enum2t)
...
(assert (= o o2))
(assert (= temp___8070 o1))
(assert (= temp___80701 o2))
(assert (= result2 r__split_fields2))
(assert (= result3 r__split_fields3))
(assert (= temp___8070 r__split_fields4))
(assert (= temp___80701 r__split_fields5))
