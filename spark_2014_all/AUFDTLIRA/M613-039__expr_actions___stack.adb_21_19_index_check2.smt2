...
(declare-fun user_eq10 (r2 r2) Bool)
(declare-const dummy10 r2)
...
(define-fun dynamic_invariant4 ((temp___expr_172 Int) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool) (temp___do_typ_inv_171 Bool)) Bool (=> (or (= temp___is_init_168 true) (<= 1 100)) (in_range4 temp___expr_172)))
