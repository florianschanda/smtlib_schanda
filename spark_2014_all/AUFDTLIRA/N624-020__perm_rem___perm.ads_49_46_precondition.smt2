...
(assert (and (= o (induction_hypothesis a b c)) (and (in_range4 o) (=> (= (of_int o) true) (= (is_perm a c) true)))))
(assert (= (mk_int__ref result4) (mk_int__ref perm__perm_transitive__result)))
