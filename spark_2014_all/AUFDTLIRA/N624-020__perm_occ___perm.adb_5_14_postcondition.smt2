...
(assert (or (= (length a) 0) (and (not (= (length a) 0)) (and (and (and (and (and (and (and (<= (to_rep1 (first (rt a))) (to_rep1 (last (rt a)))) (<= (to_rep1 (last (rt a))) (to_rep1 (last (rt a))))) (= o (to_rep1 (last (rt a))))) (= o1 (select (elts a) o))) (= o2 (to_rep o1))) (= result (ite (= o2 e) true false))) (ite (= result true) (= (to_rep (select (elts b) (to_rep1 (last (rt b))))) e) (not (= (to_rep (select (elts b) (to_rep1 (last (rt b))))) e)))) (and (and (= (mk___t o5 o6) (remove_last b)) (and (dynamic_invariant1 (mk___t o5 o6) true false true) (and (= (elts b) o5) (= (mk (to_rep1 (first2 (mk1 (to_rep1 (first (rt b))) (- (to_rep1 (last (rt b))) 1)))) (to_rep1 (last2 (mk1 (to_rep1 (first (rt b))) (- (to_rep1 (last (rt b))) 1))))) o6)))) (and (and (= (mk___t o3 o4) (remove_last a)) (and (dynamic_invariant1 (mk___t o3 o4) true false true) (and (= (elts a) o3) (= (mk (to_rep1 (first2 (mk1 (to_rep1 (first (rt a))) (- (to_rep1 (last (rt a))) 1)))) (to_rep1 (last2 (mk1 (to_rep1 (first (rt a))) (- (to_rep1 (last (rt a))) 1))))) o4)))) (= (occ (mk___t o3 o4) e) (occ (mk___t o5 o6) e))))))))
