...
(assert (not (= (to_rep (rec__do_loops__r__f2 (us_split_fields1 (select (rec__do_loops__r_array_record__f3 d__split_fields11) i14)))) (to_rep (rec__do_loops__r__f2 (us_split_fields1 (select (rec__do_loops__r_array_record__f3 (us_split_fields__content1 d__split_fields7)) i14)))))))
(check-sat)
(exit)
