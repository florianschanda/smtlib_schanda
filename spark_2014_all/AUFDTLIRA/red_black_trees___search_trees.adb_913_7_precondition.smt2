...
(assert (=> (not (= is_root true)) (and (= o146 (to_rep1 (rec__search_trees__search_tree__root t__split_fields11))) (in_range3 (to_rep1 (rec__search_trees__search_tree__root t__split_fields11))))))
(assert (=> (not (= is_root true)) (= (ordered_leafs (rec__search_trees__search_tree__struct t__split_fields11) o146 (rec__search_trees__search_tree__values t__split_fields11)) true)))
(assert (=> (not (= is_root true)) (= t__split_fields10 t__split_fields11)))
(assert (not (not (= (to_rep1 (rec__search_trees__search_tree__root t_old__split_fields4)) 0))))
(check-sat)
(exit)
