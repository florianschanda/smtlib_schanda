...
(assert (= i12 result4))
(assert (= i13 1))
(assert (=> (and (<= 1 i13) (<= i13 3)) (and (and (= temp___238 i13) (and (= temp___233 x4) (and (= temp___243 x4) (and (and (and (and (and (= (to_rep o3) 1) (= o4 (store (get (select x4 i32) i212 i223) i13 o3))) (= o5 (set (select x4 i32) i212 i223 o4))) (= o6 (store x4 i32 o5))) (and (= x4 result5) (= x5 o6))) (and (= (bool_eq2 x6 (to_rep (first12 (mk6 (+ i32 1) 3))) (to_rep (last12 (mk6 (+ i32 1) 3))) temp___243 (to_rep (first14 (mk7 (+ i32 1) 3))) (to_rep (last14 (mk7 (+ i32 1) 3)))) true) (and (and (and (forall ((temp___234 Int)) (=> (and (<= 1 temp___234) (<= temp___234 3)) (ite (not (= i32 temp___234)) (= (select x6 temp___234) (select temp___233 temp___234)) (forall ((temp___235 Int) (temp___236 Int)) (=> (and (and (<= 1 temp___235) (<= temp___235 3)) (and (<= 1 temp___236) (<= temp___236 3))) (ite (or (not (= i223 temp___236)) (not (= i212 temp___235))) (= (get (select x6 temp___234) temp___235 temp___236) (get (select temp___233 temp___234) temp___235 temp___236)) (forall ((temp___237 Int)) (=> (and (<= 1 temp___237) (<= temp___237 3)) (=> (< i14 temp___237) (= (select (get (select x6 temp___234) temp___235 temp___236) temp___237) (select (get (select temp___233 temp___234) temp___235 temp___236) temp___237))))))))))) (=> (<= 1 3) (in_range2 i14))) (and (<= 1 i14) (<= i14 3))) (= i14 3))))))) (and (and (= i14 i18) (= x6 x10)) (and (= i19 i14) (= x11 x6))))))
(assert (=> (and (<= 1 i13) (<= i13 3)) (= i110 (mk_int__ref i18))))
(assert (=> (and (<= 1 i13) (<= i13 3)) (= x12 (mk_map__ref2 x10))))
(assert (=> (and (<= 1 i13) (<= i13 3)) (= i111 i19)))
(assert (=> (and (<= 1 i13) (<= i13 3)) (= x13 x11)))
(assert (=> (not (and (<= 1 i13) (<= i13 3))) (= i110 (mk_int__ref i13))))
(assert (=> (not (and (<= 1 i13) (<= i13 3))) (= x12 (mk_map__ref2 x4))))
(assert (=> (not (and (<= 1 i13) (<= i13 3))) (= i111 i13)))
(assert (=> (not (and (<= 1 i13) (<= i13 3))) (= x13 x4)))
(assert (not (= i223 3)))
(assert (= result8 (mk_int__ref i223)))
(assert (= i224 (+ i223 1)))
(assert (= i112 i110))
(assert (= i225 (mk_int__ref i224)))
(assert (= x14 x12))
(assert (= i113 i111))
(assert (= i226 i224))
(assert (= x15 x13))
(assert (not (= (bool_eq2 (map__content2 x14) (to_rep (first8 (mk4 (+ i32 1) 3))) (to_rep (last8 (mk4 (+ i32 1) 3))) x3 (to_rep (first10 (mk5 (+ i32 1) 3))) (to_rep (last10 (mk5 (+ i32 1) 3)))) true)))
(check-sat)
(exit)
