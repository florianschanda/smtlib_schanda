...
(assert (= i1 result4))
(assert (= i11 1))
(assert (=> (and (<= 1 i11) (<= i11 3)) (= temp___238 i11)))
(assert (=> (and (<= 1 i11) (<= i11 3)) (= temp___233 x4)))
(assert (=> (and (<= 1 i11) (<= i11 3)) (= temp___243 x4)))
...
(assert (=> (and (<= 1 i11) (<= i11 3)) (= (bool_eq2 x6 (to_rep (first12 (mk6 (+ i32 1) 3))) (to_rep (last12 (mk6 (+ i32 1) 3))) temp___243 (to_rep (first14 (mk7 (+ i32 1) 3))) (to_rep (last14 (mk7 (+ i32 1) 3)))) true)))
(assert (=> (and (<= 1 i11) (<= i11 3)) (and (and (forall ((temp___234 Int)) (=> (and (<= 1 temp___234) (<= temp___234 3)) (ite (not (= i32 temp___234)) (= (select x6 temp___234) (select temp___233 temp___234)) (forall ((temp___235 Int) (temp___236 Int)) (=> (and (and (<= 1 temp___235) (<= temp___235 3)) (and (<= 1 temp___236) (<= temp___236 3))) (ite (or (not (= i222 temp___236)) (not (= i212 temp___235))) (= (get (select x6 temp___234) temp___235 temp___236) (get (select temp___233 temp___234) temp___235 temp___236)) (forall ((temp___237 Int)) (=> (and (<= 1 temp___237) (<= temp___237 3)) (=> (< i12 temp___237) (= (select (get (select x6 temp___234) temp___235 temp___236) temp___237) (select (get (select temp___233 temp___234) temp___235 temp___236) temp___237))))))))))) (=> (<= 1 3) (in_range2 i12))) (and (<= 1 i12) (<= i12 3)))))
