...
(assert (= i1 result4))
(assert (= i11 1))
(assert (=> (and (<= 1 i11) (<= i11 3)) (= temp___270 i11)))
(assert (=> (and (<= 1 i11) (<= i11 3)) (= temp___265 x4)))
(assert (=> (and (<= 1 i11) (<= i11 3)) (= temp___275 x4)))
(assert (=> (and (<= 1 i11) (<= i11 3)) (= (to_rep o) 1)))
(assert (=> (and (<= 1 i11) (<= i11 3)) (= o1 (store (get (select x4 i32) i212 i222) i11 o))))
(assert (=> (and (<= 1 i11) (<= i11 3)) (= o2 (set (select x4 i32) i212 i222 o1))))
(assert (=> (and (<= 1 i11) (<= i11 3)) (= o3 (store x4 i32 o2))))
(assert (=> (and (<= 1 i11) (<= i11 3)) (= x4 result5)))
(assert (=> (and (<= 1 i11) (<= i11 3)) (= x5 o3)))
(assert (=> (and (<= 1 i11) (<= i11 3)) (= (bool_eq2 x6 (to_rep (first12 (mk6 (+ i32 1) 3))) (to_rep (last12 (mk6 (+ i32 1) 3))) temp___275 (to_rep (first14 (mk7 (+ i32 1) 3))) (to_rep (last14 (mk7 (+ i32 1) 3)))) true)))
(assert (=> (and (<= 1 i11) (<= i11 3)) (and (and (forall ((temp___266 Int)) (=> (and (<= 1 temp___266) (<= temp___266 3)) (ite (not (= i32 temp___266)) (= (select x6 temp___266) (select temp___265 temp___266)) (forall ((temp___267 Int) (temp___268 Int)) (=> (and (and (<= 1 temp___267) (<= temp___267 3)) (and (<= 1 temp___268) (<= temp___268 3))) (ite (or (not (= i222 temp___268)) (not (= i212 temp___267))) (= (get (select x6 temp___266) temp___267 temp___268) (get (select temp___265 temp___266) temp___267 temp___268)) (forall ((temp___269 Int)) (=> (and (<= 1 temp___269) (<= temp___269 3)) (=> (< i12 temp___269) (= (select (get (select x6 temp___266) temp___267 temp___268) temp___269) (select (get (select temp___265 temp___266) temp___267 temp___268) temp___269))))))))))) (=> (<= 1 3) (in_range2 i12))) (and (<= 1 i12) (<= i12 3)))))
(assert (=> (and (<= 1 i11) (<= i11 3)) (= i12 3)))
(assert (=> (and (<= 1 i11) (<= i11 3)) (= i12 i13)))
(assert (=> (and (<= 1 i11) (<= i11 3)) (= x6 x7)))
(assert (=> (and (<= 1 i11) (<= i11 3)) (= i14 i12)))
(assert (=> (and (<= 1 i11) (<= i11 3)) (= x8 x6)))
(assert (=> (and (<= 1 i11) (<= i11 3)) (= i15 (mk_int__ref i13))))
(assert (=> (and (<= 1 i11) (<= i11 3)) (= x9 (mk_map__ref2 x7))))
(assert (=> (and (<= 1 i11) (<= i11 3)) (= i16 i14)))
(assert (=> (and (<= 1 i11) (<= i11 3)) (= x10 x8)))
(assert (=> (not (and (<= 1 i11) (<= i11 3))) (= i15 (mk_int__ref i11))))
(assert (=> (not (and (<= 1 i11) (<= i11 3))) (= x9 (mk_map__ref2 x4))))
(assert (=> (not (and (<= 1 i11) (<= i11 3))) (= i16 i11)))
(assert (=> (not (and (<= 1 i11) (<= i11 3))) (= x10 x4)))
(assert (not (= i222 3)))
(assert (= result6 (mk_int__ref i222)))
(assert (= i223 (+ i222 1)))
(assert (= i17 i15))
(assert (= i224 (mk_int__ref i223)))
(assert (= x11 x9))
(assert (= i18 i16))
(assert (= i225 i223))
(assert (= x12 x10))
(assert (not (= (bool_eq2 (map__content2 x11) (to_rep (first8 (mk4 (+ i32 1) 3))) (to_rep (last8 (mk4 (+ i32 1) 3))) x3 (to_rep (first10 (mk5 (+ i32 1) 3))) (to_rep (last10 (mk5 (+ i32 1) 3)))) true)))
(check-sat)
(exit)
