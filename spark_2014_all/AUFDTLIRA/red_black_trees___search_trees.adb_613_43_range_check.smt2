...
(assert (in_range7 l))
(assert (in_range1 v))
(assert (and (= o1 (size (rec__search_trees__search_tree__struct (us_split_fields7 t)))) (in_range5 o1)))
...
(assert (and (= result1 (valid_root (rec__search_trees__search_tree__struct (us_split_fields7 t)) o)) (=> (< (size (rec__search_trees__search_tree__struct (us_split_fields7 t))) o) (not (= result1 true)))))
(assert (= result1 true))
