...
(assert (forall ((x element)) (! (in_range3 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range f) (=> (in_range l) (and (= (to_rep3 (first2 (mk1 f l))) f) (= (to_rep3 (last2 (mk1 f l))) l)))) :pattern ((mk1 f l)))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range f) (=> (in_range l) (and (= (to_rep3 (first4 (mk2 f l))) f) (= (to_rep3 (last4 (mk2 f l))) l)))) :pattern ((mk2 f l)))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range f) (=> (in_range l) (and (= (to_rep3 (first6 (mk3 f l))) f) (= (to_rep3 (last6 (mk3 f l))) l)))) :pattern ((mk3 f l)))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range f) (=> (in_range l) (and (= (to_rep3 (first8 (mk4 f l))) f) (= (to_rep3 (last8 (mk4 f l))) l)))) :pattern ((mk4 f l)))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range f) (=> (in_range l) (and (= (to_rep3 (first10 (mk5 f l))) f) (= (to_rep3 (last10 (mk5 f l))) l)))) :pattern ((mk5 f l)))))
(define-fun dynamic_property10 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range low) (and (in_range high) (=> (<= low high) (and (in_range2 low) (in_range2 high))))))
...
(declare-const temp___2781 (Array Int element))
(declare-const temp___2782 t)
(declare-const temp___2783 natural)
(declare-const temp___2784 us_private)
(declare-const temp___2785 Int)
...
(assert (not (in_range (+ (to_rep this__split_fields2) 1))))
(check-sat)
(exit)
