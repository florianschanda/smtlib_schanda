...
(assert (forall ((temp___247 Int) (temp___248 Int) (temp___249 Int)) (let ((temp___246 (temp___245 temp___247 temp___248 temp___249))) (=> (dynamic_invariant temp___247 true true true true) (and (=> (dynamic_property8 1 2147483647 temp___248 temp___249) (and (= (first11 temp___246) temp___248) (= (last11 temp___246) temp___249))) (forall ((temp___250 Int)) (= (to_rep2 (select (to_array5 temp___246) temp___250)) temp___247)))))))
