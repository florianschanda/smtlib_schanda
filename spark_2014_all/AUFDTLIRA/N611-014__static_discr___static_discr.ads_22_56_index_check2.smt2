...
(declare-const temp___352 natural)
(declare-const temp___3521 natural)
(declare-const temp___3522 natural)
(declare-const temp___3523 natural)
(declare-const temp___3524 (Array Int natural))
(declare-const temp___3525 natural)
...
(define-fun current__split_fields16 () us_split_fields8 (mk___split_fields4 (mk___rep3 (mk___split_discrs current__split_fields4 current__split_fields5) (mk___split_fields3 current__split_fields6)) current__split_fields7))
...
(assert (= current__split_fields16 (us_split_fields9 a)))
...
(assert (=> (and (= result__1 0) (< 0 (to_rep current__split_fields7))) (and (= current__split_discrs (mk___split_discrs1 temp___352 temp___3521)) (and (and (and (= temp___3522 current__split_fields4) (= temp___3523 current__split_fields5)) (= temp___3524 current__split_fields6)) (= temp___3525 current__split_fields7)))))
(assert (=> (and (= result__1 0) (< 0 (to_rep current__split_fields7))) (= temp___351 result__1)))
(assert (=> (and (= result__1 0) (< 0 (to_rep current__split_fields7))) (and (and (and (<= 1 (to_rep (rec__static_discr__holder__length1 current__split_fields8))) (<= (to_rep (rec__static_discr__holder__length1 current__split_fields8)) (to_rep (rec__static_discr__holder__length1 (us_split_fields9 a))))) (= (bool_eq (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 (us_split_fields9 a)))) 1 100 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 current__split_fields8))) 1 100) true)) (forall ((i Int)) (=> (and (<= (+ (to_rep (rec__static_discr__holder__length1 current__split_fields8)) 1) i) (<= i (to_rep (rec__static_discr__holder__length1 (us_split_fields9 a))))) (not (= (to_rep (select (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 (us_split_fields9 a)))) i)) e)))))))
(assert (=> (and (= result__1 0) (< 0 (to_rep current__split_fields7))) (and (and (=> (<= 0 2147483647) (in_range2 result__2)) (and (= 100 (to_rep (rec__static_discr__i_holder__unused (us_split_discrs5 (rec__static_discr__holder__content1 current__split_fields8))))) (= 100 (to_rep (rec__static_discr__i_holder__c (us_split_discrs5 (rec__static_discr__holder__content1 current__split_fields8))))))) (and (= result__2 0) (< 0 (to_rep (rec__static_discr__holder__length1 current__split_fields8)))))))
(assert (=> (and (= result__1 0) (< 0 (to_rep current__split_fields7))) (= (to_rep (rec__static_discr__holder__unused current__split_discrs)) 100)))
(assert (=> (and (= result__1 0) (< 0 (to_rep current__split_fields7))) (and (and (= (bool_eq (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 current__split_fields9))) 1 100 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 current__split_fields8))) 1 100) true) (and (< (to_rep (rec__static_discr__holder__length1 current__split_fields9)) (to_rep (rec__static_discr__holder__length1 current__split_fields8))) (ite (= result__3 0) (forall ((i Int)) (=> (and (<= (+ (to_rep (rec__static_discr__holder__length1 current__split_fields9)) 1) i) (<= i (to_rep (rec__static_discr__holder__length1 current__split_fields8)))) (not (= (to_rep (select (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 current__split_fields9))) i)) e)))) (and (and (<= (to_rep (rec__static_discr__holder__length1 current__split_fields9)) result__3) (<= result__3 (to_rep (rec__static_discr__holder__length1 current__split_fields8)))) (= (to_rep (select (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 current__split_fields9))) result__3)) e))))) (and (and (= 100 (to_rep (rec__static_discr__i_holder__unused (us_split_discrs5 (rec__static_discr__holder__content1 current__split_fields9))))) (= 100 (to_rep (rec__static_discr__i_holder__c (us_split_discrs5 (rec__static_discr__holder__content1 current__split_fields9)))))) (in_range2 result__3)))))
(assert (=> (and (= result__1 0) (< 0 (to_rep current__split_fields7))) (= (to_rep (rec__static_discr__holder__unused current__split_discrs)) 100)))
(assert (=> (and (= result__1 0) (< 0 (to_rep current__split_fields7))) (= (bool_eq (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 (us_split_fields9 a)))) 1 100 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 current__split_fields9))) 1 100) true)))
(assert (=> (and (= result__1 0) (< 0 (to_rep current__split_fields7))) (not (and (= result__3 0) (< 0 (to_rep (rec__static_discr__holder__length1 current__split_fields9)))))))
(assert (=> (and (= result__1 0) (< 0 (to_rep current__split_fields7))) (= result__4 (mk_int__ref result__3))))
(assert (=> (and (= result__1 0) (< 0 (to_rep current__split_fields7))) (= current__split_fields10 (mk___split_fields__ref4 current__split_fields9))))
(assert (=> (and (= result__1 0) (< 0 (to_rep current__split_fields7))) (= result__5 result__3)))
(assert (=> (and (= result__1 0) (< 0 (to_rep current__split_fields7))) (= current__split_fields11 current__split_fields9)))
(assert (=> (and (= result__1 0) (< 0 (to_rep current__split_fields7))) (= result__6 result__4)))
(assert (=> (and (= result__1 0) (< 0 (to_rep current__split_fields7))) (= current__split_fields12 current__split_fields10)))
(assert (=> (and (= result__1 0) (< 0 (to_rep current__split_fields7))) (= result__7 result__5)))
(assert (=> (and (= result__1 0) (< 0 (to_rep current__split_fields7))) (= current__split_fields13 current__split_fields11)))
(assert (=> (not (and (= result__1 0) (< 0 (to_rep current__split_fields7)))) (= result__6 (mk_int__ref result__1))))
(assert (=> (not (and (= result__1 0) (< 0 (to_rep current__split_fields7)))) (= current__split_fields12 (mk___split_fields__ref4 current__split_fields16))))
(assert (=> (not (and (= result__1 0) (< 0 (to_rep current__split_fields7)))) (= result__7 result__1)))
(assert (=> (not (and (= result__1 0) (< 0 (to_rep current__split_fields7)))) (= current__split_fields13 current__split_fields16)))
(assert (= static_discr__search_max__result2 (mk_int__ref static_discr__search_max__result1)))
(assert (= static_discr__search_max__result3 static_discr__search_max__result1))
(assert (= result5 (mk_int__ref static_discr__search_max__result)))
(assert (= static_discr__search_max__result1 (int__content result__6)))
(assert (= static_discr__search_max__result4 static_discr__search_max__result2))
(assert (= result__8 result__6))
(assert (= current__split_fields14 current__split_fields12))
(assert (= static_discr__search_max__result5 static_discr__search_max__result3))
(assert (= result__9 result__7))
(assert (= current__split_fields15 current__split_fields13))
(assert (<= (int__content static_discr__search_max__result4) (to_rep (rec__static_discr__holder__length1 (us_split_fields9 a)))))
(assert (not (= (int__content static_discr__search_max__result4) 0)))
(assert (not (<= 1 (int__content static_discr__search_max__result4))))
(check-sat)
(exit)
