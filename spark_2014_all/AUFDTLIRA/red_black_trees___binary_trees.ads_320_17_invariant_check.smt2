...
(assert (= result true))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= temp___960 (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root)) (and (dynamic_invariant2 temp___960 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___960 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___960 root)))) 0) (and (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (not (= i5 root)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i5) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___960 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i5)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___960 i5))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___960 i5))) true)))))) (and (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___960 i5))) true) (not (= i5 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___960 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i5)))) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i5) (rec__tree_model__path_type__a (us_split_fields1 (select temp___960 i5)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___960 i5)))) 0)))) (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___960 i5))) true) (forall ((j6 Int)) (=> (and (<= 1 j6) (<= j6 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___960 j6))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___960 i5))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___960 j6)))) true)) (= j6 i5))))))))))))))
(assert (= (mk___rep (mk___split_fields o1 o2)) (select temp___960 i)))
(assert (= o1 o3))
(assert (= o2 o4))
(assert (= result1 o4))
(assert (= result1 true))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o (peek (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i d)) (and (in_range2 o) (and (= o (ite (= d 0) (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select f__split_fields1 i)))) (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select f__split_fields1 i)))))) (and (ite (not (= o 0)) (and (= (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o) d) (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o) i)) (forall ((j6 Int)) (=> (and (<= 1 j6) (<= j6 100)) (=> (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j6) i) (not (= (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j6) d)))))) (forall ((j6 Int)) (=> (and (<= 1 j6) (<= j6 100)) (=> (and (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j6) i) (= (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j6) d)) (= o j6)))))))))
