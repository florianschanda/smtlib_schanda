...
(assert (and (<= (to_rep1 (first perm__remove__result9)) temp___551) (<= temp___551 (to_rep1 (last perm__remove__result9)))))
(assert (= o13 temp___551))
(assert (= o14 (select perm__remove__result8 o13)))
(assert (= o15 (to_rep o14)))
(assert (not (<= (to_rep1 (first (rt a))) k1)))
(check-sat)
(exit)
