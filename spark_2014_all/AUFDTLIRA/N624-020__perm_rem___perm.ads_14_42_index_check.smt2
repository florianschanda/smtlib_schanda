...
(assert (and (<= (to_rep1 (first perm__remove__result9)) temp___615) (<= temp___615 (to_rep1 (last perm__remove__result9)))))
(assert (= o8 temp___615))
(assert (= o9 (select perm__remove__result8 o8)))
(assert (= o10 (to_rep o9)))
(assert (not (<= k (to_rep1 (last (rt a))))))
(check-sat)
(exit)
