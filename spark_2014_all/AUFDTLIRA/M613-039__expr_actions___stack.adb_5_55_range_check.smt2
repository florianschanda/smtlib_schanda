...
(define-fun dynamic_invariant2 ((temp___expr_191 us_t) (temp___is_init_187 Bool) (temp___skip_constant_188 Bool) (temp___do_toplevel_189 Bool) (temp___do_typ_inv_190 Bool)) Bool (=> (not (= temp___skip_constant_188 true)) (dynamic_property 1 2147483647 (first1 temp___expr_191) (last1 temp___expr_191))))
...
(define-fun dynamic_invariant4 ((temp___expr_172 Int) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool) (temp___do_typ_inv_171 Bool)) Bool (=> (or (= temp___is_init_168 true) (<= 1 100)) (in_range2 temp___expr_172)))
(assert (forall ((temp___185 Int)) (=> (dynamic_invariant temp___185 true true true true) (forall ((temp___186 Int)) (= (to_rep1 (select (temp___183 temp___185) temp___186)) temp___185)))))
...
(assert (= o temp___241))
(assert (= (mk1 1 (- (to_rep (rec__stack__stack__top (us_split_fields1 s))) 1)) temp___2411))
(assert (not (dynamic_property 1 2147483647 (to_rep1 (first2 temp___2411)) (to_rep1 (last2 temp___2411)))))
(check-sat)
(exit)
