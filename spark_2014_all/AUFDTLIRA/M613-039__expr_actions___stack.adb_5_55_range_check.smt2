...
(assert (forall ((x r1)) (! (in_range1 (to_rep x)) :pattern ((to_rep x)))))
...
(define-fun dynamic_invariant ((temp___expr_15 Int) (temp___is_init_12 Bool) (temp___skip_constant_13 Bool) (temp___do_toplevel_14 Bool)) Bool (=> (or (= temp___is_init_12 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_15)))
(define-fun dynamic_invariant1 ((temp___expr_39 Int) (temp___is_init_36 Bool) (temp___skip_constant_37 Bool) (temp___do_toplevel_38 Bool)) Bool (=> (or (= temp___is_init_36 true) (<= 1 2147483647)) (in_range temp___expr_39)))
(define-fun dynamic_invariant2 ((temp___expr_164 us_t) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool)) Bool (=> (not (= temp___skip_constant_162 true)) (dynamic_property 1 2147483647 (first1 temp___expr_164) (last1 temp___expr_164))))
(define-fun dynamic_invariant3 ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= 0 100)) (in_range1 temp___expr_136)))
(define-fun dynamic_invariant4 ((temp___expr_147 Int) (temp___is_init_144 Bool) (temp___skip_constant_145 Bool) (temp___do_toplevel_146 Bool)) Bool (=> (or (= temp___is_init_144 true) (<= 1 100)) (in_range2 temp___expr_147)))
(declare-const o (Array Int integer))
(declare-const temp___214 (Array Int integer))
(declare-const temp___2141 t1)
(assert (=> (<= 1 (- (to_rep (rec__stack__stack__top (us_split_fields1 s))) 1)) (and (and (<= 1 1) (<= 1 100)) (and (<= 1 (- (to_rep (rec__stack__stack__top (us_split_fields1 s))) 1)) (<= (- (to_rep (rec__stack__stack__top (us_split_fields1 s))) 1) 100)))))
(assert (= o (rec__stack__stack__content (us_split_fields1 s))))
(assert (= o temp___214))
(assert (= (mk1 1 (- (to_rep (rec__stack__stack__top (us_split_fields1 s))) 1)) temp___2141))
(assert (not (dynamic_property 1 2147483647 (to_rep1 (first2 temp___2141)) (to_rep1 (last2 temp___2141)))))
(check-sat)
(exit)
