...
(assert (= o18 (to_rep2 (rec__perm__witnesses__ib (us_split_fields1 (witnesses__content perm__get_witnesses__result11))))))
(assert (= o19 (select (elts b) o18)))
(assert (= o20 (to_rep o19)))
(assert (not (<= (to_rep2 (rec__perm__witnesses__ia (us_split_fields1 (witnesses__content perm__get_witnesses__result11)))) (to_rep1 (last (rt a))))))
(check-sat)
(exit)
