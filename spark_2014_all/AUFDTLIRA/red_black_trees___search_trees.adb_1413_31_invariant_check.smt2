...
(assert (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields5) (to_rep1 (rec__search_trees__search_tree__root t__split_fields5))) current2))) true))
(assert (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields5) (to_rep1 (rec__search_trees__search_tree__root t__split_fields5))) i5))) true) (=> (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields5) (to_rep1 (rec__search_trees__search_tree__root t__split_fields5))) i5))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields5) (to_rep1 (rec__search_trees__search_tree__root t__split_fields5))) current2)))) true) (ite (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields5) (to_rep1 (rec__search_trees__search_tree__root t__split_fields5))) current2))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields5) (to_rep1 (rec__search_trees__search_tree__root t__split_fields5))) i5)))) 1)) 0) (< v (to_rep (select (rec__search_trees__search_tree__values t__split_fields5) i5))) (< (to_rep (select (rec__search_trees__search_tree__values t__split_fields5) i5)) v)))))))
(assert (and (and (and (=> (<= 0 100) (in_range4 previous2)) (=> (<= 0 1) (in_range5 d2))) (=> (<= 0 100) (in_range4 i3))) (=> (<= 0 100) (in_range4 current2))))
...
(assert (= i4 0))
(assert (exists ((i5 Int)) (and (and (<= 1 i5) (<= i5 100)) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__1 (mk___rep3 t__split_fields5)) i5))) true) (= (to_rep (select (rec__search_trees__search_tree__values t__split_fields5) i5)) v)))))
(assert (not (type_invariant1 (mk___rep3 t__split_fields5))))
(check-sat)
(exit)
