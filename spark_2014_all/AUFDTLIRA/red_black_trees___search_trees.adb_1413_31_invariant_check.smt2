...
(assert (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields7) (to_rep1 (rec__search_trees__search_tree__root t__split_fields7))) current3))) true))
...
(assert (and (and (and (and (=> (<= 0 100) (in_range4 previous3)) (=> (<= 0 1) (in_range5 d6))) (=> (<= 0 100) (in_range4 i7))) (=> (<= 0 100) (in_range4 current3))) (not (= current3 0))))
(assert (= result10 (mk_int__ref previous3)))
(assert (= previous4 current3))
(assert (and (<= 1 previous4) (<= previous4 100)))
(assert (= o38 previous4))
(assert (= o39 (select (rec__search_trees__search_tree__values t__split_fields7) o38)))
(assert (= o40 (to_rep o39)))
(assert (= result11 (ite (= v o40) true false)))
(assert (= result11 true))
(assert (= result12 (mk_int__ref i7)))
(assert (= i8 0))
(assert (exists ((i20 Int)) (and (and (<= 1 i20) (<= i20 100)) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__1 (mk___rep3 t__split_fields7)) i20))) true) (= (to_rep (select (rec__search_trees__search_tree__values t__split_fields7) i20)) v)))))
(assert (not (type_invariant1 (mk___rep3 t__split_fields7))))
(check-sat)
(exit)
