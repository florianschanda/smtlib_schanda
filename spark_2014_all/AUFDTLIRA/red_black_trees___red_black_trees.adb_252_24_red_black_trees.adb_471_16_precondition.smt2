...
(declare-const i Int)
(declare-const temp___812 (Array Int us_rep7))
(declare-const o38 us_rep7)
(declare-const o39 us_split_fields10)
(declare-const o40 extended_index_type)
(declare-const o41 Int)
(declare-const temp___811 (Array Int us_rep1))
...
(declare-const o45 us_rep7)
(declare-const o46 us_split_fields10)
(declare-const o47 extended_index_type)
(declare-const temp___808 (Array Int us_rep7))
(declare-const o48 us_rep7)
(declare-const o49 us_split_fields10)
...
(assert (= result8 true))
(assert (= (to_rep3 o20) 0))
(assert (and (<= 1 y6) (<= y6 100)))
(assert (= o21 y6))
(assert (= o22 (store (rec__red_black_trees__rbt__color t__split_fields7) o21 o20)))
(assert (= o23 (mk___split_fields4 (rec__red_black_trees__rbt__struct t__split_fields7) o22)))
(assert (= temp___789 (mk___rep4 o23)))
(assert (= result9 (mk___split_fields__ref4 t__split_fields7)))
(assert (= t__split_fields8 (us_split_fields9 temp___789)))
(assert (= (to_rep3 o25) 0))
(assert (and (= o24 x2) (in_range2 x2)))
(assert (and (= temp___791 (parent (rec__red_black_trees__rbt__struct t__split_fields8) o24)) (and (in_range3 temp___791) (and (= temp___791 (parent1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields8))) o24)) (=> (= (size (rec__red_black_trees__rbt__struct t__split_fields8)) 0) (= temp___791 0))))))
(assert (and (<= 1 temp___791) (<= temp___791 100)))
(assert (= o26 temp___791))
(assert (= o27 (store (rec__red_black_trees__rbt__color t__split_fields8) o26 o25)))
(assert (= o28 (mk___split_fields4 (rec__red_black_trees__rbt__struct t__split_fields8) o27)))
(assert (= temp___793 (mk___rep4 o28)))
(assert (= result10 (mk___split_fields__ref4 t__split_fields8)))
(assert (= t__split_fields9 (us_split_fields9 temp___793)))
(assert (= (to_rep3 o30) 1))
(assert (and (= o29 y6) (in_range2 y6)))
(assert (and (= temp___795 (parent (rec__red_black_trees__rbt__struct t__split_fields9) o29)) (and (in_range3 temp___795) (and (= temp___795 (parent1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields9))) o29)) (=> (= (size (rec__red_black_trees__rbt__struct t__split_fields9)) 0) (= temp___795 0))))))
(assert (and (<= 1 temp___795) (<= temp___795 100)))
(assert (= o31 temp___795))
(assert (= o32 (store (rec__red_black_trees__rbt__color t__split_fields9) o31 o30)))
(assert (= o33 (mk___split_fields4 (rec__red_black_trees__rbt__struct t__split_fields9) o32)))
(assert (= temp___797 (mk___rep4 o33)))
(assert (= result11 (mk___split_fields__ref4 t__split_fields9)))
(assert (= t__split_fields10 (us_split_fields9 temp___797)))
(assert (and (= o34 y6) (in_range2 y6)))
(assert (and (= o35 (parent (rec__red_black_trees__rbt__struct t__split_fields10) o34)) (and (in_range3 o35) (and (= o35 (parent1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields10))) o34)) (=> (= (size (rec__red_black_trees__rbt__struct t__split_fields10)) 0) (= o35 0))))))
(assert (= result12 (mk_int__ref x2)))
(assert (= x3 o35))
(assert (= (mk___rep4 t_old__split_fields7) c94b))
(assert (dynamic_invariant6 c94b true false true true))
(assert (= (mk___rep4 t__split_fields10) c95b))
(assert (dynamic_invariant6 c95b true false true true))
(assert (and (= o36 y6) (in_range2 y6)))
(assert (and (= o37 (parent (rec__red_black_trees__rbt__struct t__split_fields10) o36)) (and (in_range3 o37) (and (= o37 (parent1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields10))) o36)) (=> (= (size (rec__red_black_trees__rbt__struct t__split_fields10)) 0) (= o37 0))))))
(assert (and (= red_black_trees__insert__L_8__C96b__assume o37) (in_range2 o37)))
(assert (= red_black_trees__insert__L_8__C96b__assume c96b))
(assert (in_range2 c96b))
(assert (= (same_nb_blacks c94b) true))
(assert (= result13 (mk_int__ref n4)))
(assert (= n5 1))
(assert (<= 1 n5))
(assert (<= n5 100))
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c94b))) i1))) true) (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c94b) i1)))) n6)) (ite (= (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c95b)) i1) c96b) (and (= (rec__red_black_trees__black_count__status (us_split_fields11 (select (nb_blacks c95b) i1))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (nb_blacks c95b) i1)))) (+ (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (nb_blacks c94b) i1)))) 1))) (= (eq (select (nb_blacks c95b) i1) (select (nb_blacks c94b) i1)) true))))))
(assert (and (=> (<= 1 100) (in_range2 n6)) (and (<= 1 n6) (<= n6 100))))
(assert (<= 1 i))
(assert (<= i 100))
(assert (and (= temp___811 (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)))) (and (dynamic_invariant5 temp___811 true false true true) (= temp___811 (model__1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)))) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 c94b))))))))))
(assert (= o42 (select temp___811 i)))
(assert (= o43 (us_split_fields1 o42)))
(assert (= result15 (rec__tree_model__path_type__k o43)))
(assert (=> (= result15 true) (and (= temp___812 (nb_blacks c94b)) (and (= (bool_eq11 (select temp___812 0) (mk___rep5 (mk___split_fields5 (distinct 1 0) (of_rep 0) (of_rep 0)))) true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c94b))) i1))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___812 i1))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___812 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i1 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___812 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i1 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___812 i1)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___812 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i1 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___812 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i1 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___812 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i1 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___812 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i1 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___812 i1)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c94b)) i1)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___812 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i1 0)))))))))))))))
(assert (=> (= result15 true) (= o38 (select temp___812 i))))
(assert (=> (= result15 true) (= o39 (us_split_fields11 o38))))
(assert (=> (= result15 true) (= o40 (rec__red_black_trees__black_count__depth o39))))
(assert (=> (= result15 true) (= o41 (to_rep o40))))
(assert (=> (= result15 true) (= result14 (ite (< o41 n6) true false))))
(assert (=> (not (= result15 true)) (= result14 false)))
(assert (= result14 true))
(assert (and (= o44 (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c95b)) i)) (and (in_range3 o44) (and (= o44 (parent1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 c95b)))) i)) (=> (= (size (rec__red_black_trees__rbt__struct (us_split_fields9 c95b))) 0) (= o44 0))))))
(assert (= result16 (ite (= o44 c96b) true false)))
(assert (= result16 true))
(assert (and (= temp___808 (nb_blacks c94b)) (and (= (bool_eq11 (select temp___808 0) (mk___rep5 (mk___split_fields5 (distinct 1 0) (of_rep 0) (of_rep 0)))) true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c94b))) i1))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___808 i1))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___808 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i1 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___808 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i1 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___808 i1)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___808 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i1 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___808 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i1 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___808 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i1 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___808 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i1 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___808 i1)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c94b)) i1)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___808 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i1 0))))))))))))))
(assert (= o48 (select temp___808 i)))
(assert (= o49 (us_split_fields11 o48)))
(assert (= o50 (rec__red_black_trees__black_count__count o49)))
(assert (= o51 (to_rep o50)))
(assert (= o52 (+ o51 1)))
(assert (and (= temp___807 (nb_blacks c95b)) (and (= (bool_eq11 (select temp___807 0) (mk___rep5 (mk___split_fields5 (distinct 1 0) (of_rep 0) (of_rep 0)))) true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c95b))) i1))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___807 i1))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___807 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c95b)) i1 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___807 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c95b)) i1 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___807 i1)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___807 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c95b)) i1 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___807 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c95b)) i1 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___807 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c95b)) i1 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___807 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c95b)) i1 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___807 i1)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c95b)) i1)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___807 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c95b)) i1 0))))))))))))))
(assert (= o45 (select temp___807 i)))
(assert (= o46 (us_split_fields11 o45)))
(assert (= o47 (rec__red_black_trees__black_count__count o46)))
(assert (= o53 (to_rep o47)))
(assert (= o54 (ite (= o53 o52) true false)))
