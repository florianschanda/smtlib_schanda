...
(assert (= (to_rep3 o240) 0))
(assert (and (<= 1 y8) (<= y8 100)))
(assert (= o241 y8))
(assert (= o242 (store (rec__red_black_trees__rbt__color t__split_fields7) o241 o240)))
(assert (= o243 (mk___split_fields4 (rec__red_black_trees__rbt__struct t__split_fields7) o242)))
(assert (= temp___740 (mk___rep4 o243)))
(assert (= result59 (mk___split_fields__ref4 t__split_fields7)))
(assert (= t__split_fields19 (us_split_fields9 temp___740)))
(assert (= (to_rep3 o245) 0))
(assert (and (= o244 x2) (in_range2 x2)))
(assert (and (= temp___742 (parent (rec__red_black_trees__rbt__struct t__split_fields19) o244)) (and (in_range3 temp___742) (and (= temp___742 (parent1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields19))) o244)) (=> (= (size (rec__red_black_trees__rbt__struct t__split_fields19)) 0) (= temp___742 0))))))
(assert (and (<= 1 temp___742) (<= temp___742 100)))
(assert (= o246 temp___742))
(assert (= o247 (store (rec__red_black_trees__rbt__color t__split_fields19) o246 o245)))
(assert (= o248 (mk___split_fields4 (rec__red_black_trees__rbt__struct t__split_fields19) o247)))
(assert (= temp___744 (mk___rep4 o248)))
(assert (= result60 (mk___split_fields__ref4 t__split_fields19)))
(assert (= t__split_fields20 (us_split_fields9 temp___744)))
(assert (= (to_rep3 o250) 1))
(assert (and (= o249 y8) (in_range2 y8)))
(assert (and (= temp___746 (parent (rec__red_black_trees__rbt__struct t__split_fields20) o249)) (and (in_range3 temp___746) (and (= temp___746 (parent1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields20))) o249)) (=> (= (size (rec__red_black_trees__rbt__struct t__split_fields20)) 0) (= temp___746 0))))))
(assert (and (<= 1 temp___746) (<= temp___746 100)))
(assert (= o251 temp___746))
(assert (= o252 (store (rec__red_black_trees__rbt__color t__split_fields20) o251 o250)))
(assert (= o253 (mk___split_fields4 (rec__red_black_trees__rbt__struct t__split_fields20) o252)))
(assert (= temp___748 (mk___rep4 o253)))
(assert (= result61 (mk___split_fields__ref4 t__split_fields20)))
(assert (= t__split_fields21 (us_split_fields9 temp___748)))
(assert (and (= o254 y8) (in_range2 y8)))
(assert (and (= o255 (parent (rec__red_black_trees__rbt__struct t__split_fields21) o254)) (and (in_range3 o255) (and (= o255 (parent1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields21))) o254)) (=> (= (size (rec__red_black_trees__rbt__struct t__split_fields21)) 0) (= o255 0))))))
(assert (= result62 (mk_int__ref x2)))
(assert (= x9 o255))
(assert (= (mk___rep4 t_old__split_fields7) c94b))
(assert (dynamic_invariant6 c94b true false true))
(assert (= (mk___rep4 t__split_fields21) c95b))
(assert (dynamic_invariant6 c95b true false true))
(assert (and (= o256 y8) (in_range2 y8)))
(assert (and (= o257 (parent (rec__red_black_trees__rbt__struct t__split_fields21) o256)) (and (in_range3 o257) (and (= o257 (parent1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields21))) o256)) (=> (= (size (rec__red_black_trees__rbt__struct t__split_fields21)) 0) (= o257 0))))))
(assert (and (= red_black_trees__insert__L_8__C96b__assume o257) (in_range2 o257)))
(assert (= red_black_trees__insert__L_8__C96b__assume c96b))
(assert (in_range2 c96b))
(assert (= (same_nb_blacks c94b) true))
(assert (= result63 (mk_int__ref n47)))
(assert (= n87 1))
(assert (<= 1 n87))
(assert (<= n87 100))
(assert (forall ((i14 Int)) (=> (and (<= 1 i14) (<= i14 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c94b))) i14))) true) (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c94b) i14)))) n88)) (ite (= (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c95b)) i14) c96b) (and (= (rec__red_black_trees__black_count__status (us_split_fields11 (select (nb_blacks c95b) i14))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (nb_blacks c95b) i14)))) (+ (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (nb_blacks c94b) i14)))) 1))) (= (eq (select (nb_blacks c95b) i14) (select (nb_blacks c94b) i14)) true))))))
(assert (and (=> (<= 1 100) (in_range2 n88)) (and (<= 1 n88) (<= n88 100))))
(assert (<= 1 i8))
(assert (<= i8 100))
(assert (and (= temp___762 (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)))) (and (dynamic_invariant5 temp___762 true false true) (= temp___762 (model__1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)))) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 c94b))))))))))
(assert (= o262 (select temp___762 i8)))
(assert (= o263 (us_split_fields1 o262)))
(assert (= result65 (rec__tree_model__path_type__k o263)))
(assert (=> (= result65 true) (and (= temp___763 (nb_blacks c94b)) (and (= (bool_eq11 (select temp___763 0) (mk___rep5 (mk___split_fields5 (of_int 1) (of_rep 0) (of_rep 0)))) true) (forall ((i14 Int)) (=> (and (<= 1 i14) (<= i14 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c94b))) i14))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___763 i14))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___763 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___763 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i14 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___763 i14)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___763 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___763 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i14 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___763 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i14 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___763 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i14 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___763 i14)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c94b)) i14)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___763 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i14 0)))))))))))))))
(assert (=> (= result65 true) (= o258 (select temp___763 i8))))
(assert (=> (= result65 true) (= o259 (us_split_fields11 o258))))
(assert (=> (= result65 true) (= o260 (rec__red_black_trees__black_count__depth o259))))
(assert (=> (= result65 true) (= o261 (to_rep o260))))
(assert (=> (= result65 true) (= result64 (ite (< o261 n88) true false))))
(assert (=> (not (= result65 true)) (= result64 false)))
(assert (= result64 true))
(assert (and (= o264 (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c95b)) i8)) (and (in_range3 o264) (and (= o264 (parent1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 c95b)))) i8)) (=> (= (size (rec__red_black_trees__rbt__struct (us_split_fields9 c95b))) 0) (= o264 0))))))
(assert (= result66 (ite (= o264 c96b) true false)))
(assert (= result66 true))
(assert (and (= temp___759 (nb_blacks c94b)) (and (= (bool_eq11 (select temp___759 0) (mk___rep5 (mk___split_fields5 (of_int 1) (of_rep 0) (of_rep 0)))) true) (forall ((i14 Int)) (=> (and (<= 1 i14) (<= i14 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c94b))) i14))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___759 i14))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___759 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___759 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i14 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___759 i14)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___759 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___759 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i14 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___759 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i14 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___759 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i14 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___759 i14)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c94b)) i14)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___759 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i14 0))))))))))))))
(assert (= o268 (select temp___759 i8)))
(assert (= o269 (us_split_fields11 o268)))
(assert (= o270 (rec__red_black_trees__black_count__count o269)))
(assert (= o271 (to_rep o270)))
(assert (= o272 (+ o271 1)))
(assert (and (= temp___758 (nb_blacks c95b)) (and (= (bool_eq11 (select temp___758 0) (mk___rep5 (mk___split_fields5 (of_int 1) (of_rep 0) (of_rep 0)))) true) (forall ((i14 Int)) (=> (and (<= 1 i14) (<= i14 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c95b))) i14))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___758 i14))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___758 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c95b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___758 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c95b)) i14 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___758 i14)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___758 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c95b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___758 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c95b)) i14 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___758 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c95b)) i14 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___758 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c95b)) i14 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___758 i14)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c95b)) i14)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___758 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c95b)) i14 0))))))))))))))
(assert (= o265 (select temp___758 i8)))
(assert (= o266 (us_split_fields11 o265)))
(assert (= o267 (rec__red_black_trees__black_count__count o266)))
(assert (= o273 (to_rep o267)))
(assert (= o274 (ite (= o273 o272) true false)))
(assert (not (not (= (size (rec__red_black_trees__rbt__struct (us_split_fields9 c95b))) 0))))
(check-sat)
(exit)
