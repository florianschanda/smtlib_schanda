...
(assert (=> (= (select sel st2) true) (and (= o6 (+ st_count2 1)) (in_range3 (+ st_count2 1)))))
(assert (=> (= (select sel st2) true) (= st_count2 result5)))
(assert (=> (= (select sel st2) true) (= st_count3 o6)))
(assert (=> (= (select sel st2) true) (=> (< (to_rep (select max st2)) lowest_max2) (= lowest_max2 result6))))
(assert (=> (= (select sel st2) true) (=> (< (to_rep (select max st2)) lowest_max2) (= lowest_max3 (to_rep (select max st2))))))
(assert (=> (= (select sel st2) true) (=> (not (< (to_rep (select max st2)) lowest_max2)) (= lowest_max3 lowest_max2))))
(assert (=> (not (= (select sel st2) true)) (= lowest_max3 lowest_max2)))
(assert (=> (not (= (select sel st2) true)) (= st_count3 st_count2)))
(assert (not (= st2 100)))
(assert (= result7 st2))
(assert (= st3 (+ st2 1)))
(assert (not (< st_count3 st3)))
(check-sat)
(exit)
