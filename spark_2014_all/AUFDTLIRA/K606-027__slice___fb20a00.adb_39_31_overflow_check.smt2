...
(assert (forall ((str us_t)) (! (=> (dynamic_invariant1 str true true true true) (dynamic_invariant1 (upper_case str) true false true true)) :pattern ((upper_case str)))))
...
(declare-const temp___239 (Array Int character))
...
(define-fun temp___2362 () us_t (mk___t temp___236 temp___2361))
...
(assert (= (ite (<= (to_rep1 (first temp___2341)) (to_rep1 (last temp___2341))) (+ (- (to_rep1 (last temp___2341)) (to_rep1 (first temp___2341))) 1) 0) (ite (<= (to_rep1 (first (rt str))) (to_rep1 (last (rt str)))) (+ (- (to_rep1 (last (rt str))) (to_rep1 (first (rt str)))) 1) 0)))
(assert (= (slide temp___234 (to_rep1 (first temp___2341)) (to_rep1 (first (rt str)))) temp___235))
(assert (= (mk1 (to_rep1 (first (rt str))) (to_rep1 (last (rt str)))) temp___2351))
(assert (= (ite (<= (to_rep1 (first2 temp___2351)) (to_rep1 (last2 temp___2351))) (+ (- (to_rep1 (last2 temp___2351)) (to_rep1 (first2 temp___2351))) 1) 0) (ite (<= (to_rep1 new_str__first) (to_rep1 new_str__last)) (+ (- (to_rep1 new_str__last) (to_rep1 new_str__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___235 temp___2351)))
(assert (= o2 o))
(assert (= result1 new_str))
(assert (= new_str1 o2))
(assert (and (= temp___2362 (upper_case sub)) (dynamic_invariant1 temp___2362 true false true true)))
(assert (= (ite (<= (to_rep1 (first temp___2361)) (to_rep1 (last temp___2361))) (+ (- (to_rep1 (last temp___2361)) (to_rep1 (first temp___2361))) 1) 0) (ite (<= (to_rep1 (first (rt sub))) (to_rep1 (last (rt sub)))) (+ (- (to_rep1 (last (rt sub))) (to_rep1 (first (rt sub)))) 1) 0)))
(assert (= (slide temp___236 (to_rep1 (first temp___2361)) (to_rep1 (first (rt sub)))) temp___237))
(assert (= (mk2 (to_rep1 (first (rt sub))) (to_rep1 (last (rt sub)))) temp___2371))
(assert (= (ite (<= (to_rep1 (first4 temp___2371)) (to_rep1 (last4 temp___2371))) (+ (- (to_rep1 (last4 temp___2371)) (to_rep1 (first4 temp___2371))) 1) 0) (ite (<= (to_rep1 new_sub__first) (to_rep1 new_sub__last)) (+ (- (to_rep1 new_sub__last) (to_rep1 new_sub__first)) 1) 0)))
(assert (= (mk___t2 o3 o4) (mk___t2 temp___237 temp___2371)))
(assert (= o5 o3))
...
(assert (=> (= result4 true) (= o11 temp___239)))
(assert (=> (= result4 true) (= (mk3 pos1 fb20a00__find__L_2__R7b) temp___2391)))
(assert (=> (= result4 true) (= o12 (bool_eq temp___239 (to_rep1 (first6 temp___2391)) (to_rep1 (last6 temp___2391)) new_sub1 (to_rep1 new_sub__first) (to_rep1 new_sub__last)))))
(assert (=> (= result4 true) (= result3 (ite (not (= o12 true)) true false))))
(assert (=> (not (= result4 true)) (= result3 false)))
(assert (= result3 true))
(assert (and (=> (<= (- 2147483648) 2147483647) (in_range1 pos2)) (let ((fb20a00__find__L_2__R7b1 (- (+ pos2 (ite (<= (to_rep1 new_sub__first) (to_rep1 new_sub__last)) (+ (- (to_rep1 new_sub__last) (to_rep1 new_sub__first)) 1) 0)) 1))) (and (<= pos2 (+ (- (to_rep1 new_str__last) (ite (<= (to_rep1 new_sub__first) (to_rep1 new_sub__last)) (+ (- (to_rep1 new_sub__last) (to_rep1 new_sub__first)) 1) 0)) 1)) (not (= (bool_eq new_str1 (to_rep1 (first6 (mk3 pos2 fb20a00__find__L_2__R7b1))) (to_rep1 (last6 (mk3 pos2 fb20a00__find__L_2__R7b1))) new_sub1 (to_rep1 new_sub__first) (to_rep1 new_sub__last)) true))))))
(assert (and (= o19 (+ pos2 1)) (in_range1 (+ pos2 1))))
(assert (= pos2 result5))
(assert (= pos3 o19))
(assert (=> (<= (to_rep1 new_sub__first) (to_rep1 new_sub__last)) (= o20 (+ (- (to_rep1 new_sub__last) (to_rep1 new_sub__first)) 1))))
(assert (=> (not (<= (to_rep1 new_sub__first) (to_rep1 new_sub__last))) (= o20 0)))
