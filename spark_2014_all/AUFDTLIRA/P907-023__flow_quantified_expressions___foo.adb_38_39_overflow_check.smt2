...
(define-fun dynamic_invariant ((temp___expr_137 us_t) (temp___is_init_134 Bool) (temp___skip_constant_135 Bool) (temp___do_toplevel_136 Bool)) Bool (=> (not (= temp___skip_constant_135 true)) (dynamic_property 1 2147483647 (first1 temp___expr_137) (last1 temp___expr_137))))
