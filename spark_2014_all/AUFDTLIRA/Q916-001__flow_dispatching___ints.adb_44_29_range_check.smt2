...
(assert (not (= (length (mk___t temp___676 temp___6761)) 0)))
...
(assert (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE (to_rep1 (rec__ints__int__max1 (us_split_fields3 arg)))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE (to_rep1 (rec__ints__int__max1 (us_split_fields3 arg)))))))))) (= o20 0)))
(assert (=> (<= (to_rep1 (first temp___6761)) (to_rep1 (last temp___6761))) (= o21 (+ (- (to_rep1 (last temp___6761)) (to_rep1 (first temp___6761))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___6761)) (to_rep1 (last temp___6761)))) (= o21 0)))
(assert (= o22 (+ o21 o20)))
(assert (= o23 (+ (to_rep1 (first temp___6761)) o22)))
(assert (= o24 (- o23 1)))
