...
(assert (not (= (length (mk___t temp___606 temp___6061)) 0)))
...
(assert (=> (<= (to_rep1 (first temp___6061)) (to_rep1 (last temp___6061))) (= o21 (+ (- (to_rep1 (last temp___6061)) (to_rep1 (first temp___6061))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___6061)) (to_rep1 (last temp___6061)))) (= o21 0)))
(assert (= o22 (+ o21 o20)))
(assert (= o23 (+ (to_rep1 (first temp___6061)) o22)))
(assert (= o24 (- o23 1)))
