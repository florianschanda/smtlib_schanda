...
(assert (<= 1 st1))
(assert (<= st1 100))
(assert (not (or (and (forall ((s Int)) (=> (and (<= 1 s) (<= s (- st1 1))) (not (= (select sel s) true)))) (= lowest_max1 2147483647)) (exists ((s Int)) (and (and (<= 1 s) (<= s (- st1 1))) (and (= (select sel s) true) (= (to_rep (select max s)) lowest_max1)))))))
(check-sat)
(exit)
