...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep (rec__road_traffic__conflict__left (us_split_fields1 a))) (to_rep (rec__road_traffic__conflict__left (us_split_fields1 b)))) (= (to_rep (rec__road_traffic__conflict__right (us_split_fields1 a))) (to_rep (rec__road_traffic__conflict__right (us_split_fields1 b))))) true false))
...
(declare-datatypes () ((map__ref1 (mk_map__ref1 (map__content1 (Array Int light))))))
(declare-fun slide1 ((Array Int light) Int Int) (Array Int light))
(assert (forall ((a (Array Int light))) (forall ((first Int)) (! (= (slide1 a first first) a) :pattern ((slide1 a first first))))))
(assert (forall ((a (Array Int light))) (forall ((old_first Int)) (forall ((new_first Int)) (forall ((i Int)) (! (= (select (slide1 a old_first new_first) i) (select a (- i (- new_first old_first)))) :pattern ((select (slide1 a old_first new_first) i))))))))
...
(assert (forall ((i tTconflictsSP1)) (and (<= 1 (tTconflictsSP1qtint i)) (<= (tTconflictsSP1qtint i) 8))))
...
(declare-fun temp_____aggregate_def_231 ((Array Int light) Int Int) (Array Int light))
...
(assert (forall ((temp___233 (Array Int light))) (forall ((temp___234 Int) (temp___235 Int)) (let ((temp___232 (temp_____aggregate_def_231 temp___233 temp___234 temp___235))) (=> (and (dynamic_invariant temp___234 true true true true) (dynamic_invariant1 temp___235 true true true true)) (forall ((temp___236 Int)) (ite (= temp___236 temp___234) (= (to_rep1 (select temp___232 temp___236)) temp___235) (= (select temp___232 temp___236) (select temp___233 temp___236)))))))))
...
(assert (in_range1 p))
(assert (and (= (safety_property l conflicts) true) (= (to_rep1 (select l p)) 2)))
(assert (= (to_rep1 o) 1))
