...
(assert (and (forall ((temp___155 Int)) (=> (and (<= (to_rep x__first) temp___155) (<= temp___155 (to_rep x__last))) (=> (<= j2 temp___155) (= (select x1 temp___155) (select x temp___155))))) (and (<= (to_rep x__first) j2) (<= j2 (to_rep x__last)))))
