...
(assert (and (forall ((temp___179 Int)) (=> (and (<= (to_rep x__first) temp___179) (<= temp___179 (to_rep x__last))) (=> (<= j2 temp___179) (= (select x1 temp___179) (select x temp___179))))) (and (<= (to_rep x__first) j2) (<= j2 (to_rep x__last)))))
