...
(assert (= result j))
(assert (= j1 (to_rep x__first)))
(assert (<= (to_rep x__first) j1))
(assert (<= j1 (to_rep x__last)))
(assert (and (forall ((temp___181 Int)) (=> (and (<= (to_rep x__first) temp___181) (<= temp___181 (to_rep x__last))) (=> (or (< (to_rep x__last) temp___181) (or (< temp___181 (to_rep x__first)) (<= j2 temp___181))) (= (select x1 temp___181) (select x temp___181))))) (and (<= (to_rep x__first) j2) (<= j2 (to_rep x__last)))))
