...
(assert (<= 1 j4))
(assert (<= j4 100))
(assert (ite (= (rec__tree_model__path_type__k (us_split_fields1 (select m j4))) true) (=> (not (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res3 j4)))) n2)) (< j4 i6)) true))
(assert (ite (= (rec__tree_model__path_type__k (us_split_fields1 (select m j4))) true) (=> (not (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res3 j4)))) n2)) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res3 j4)))) (+ n2 1))) true))
(assert (ite (= (rec__tree_model__path_type__k (us_split_fields1 (select m j4))) true) true false))
(assert (and (= o108 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j4 0)) (and (in_range3 o108) (= o108 (peek1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) j4 0)))))
(assert (= o109 (select res3 o108)))
(assert (= o110 (us_split_fields11 o109)))
(assert (= o111 (rec__red_black_trees__black_count__count o110)))
(assert (= o112 (to_rep o111)))
(assert (=> (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) j4)) 0) (= o113 1)))
(assert (=> (not (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) j4)) 0)) (= o113 0)))
(assert (= o114 (+ o113 o112)))
(assert (and (= o115 o114) (in_range1 o114)))
(assert (= o116 (ite (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res3 j4)))) o115) true false)))
(assert (and (= o98 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j4 1)) (and (in_range3 o98) (= o98 (peek1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) j4 1)))))
(assert (= o99 (select res3 o98)))
(assert (= o100 (us_split_fields11 o99)))
(assert (= o101 (rec__red_black_trees__black_count__depth o100)))
(assert (= o102 (to_rep o101)))
(assert (and (= o94 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j4 0)) (and (in_range3 o94) (= o94 (peek1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) j4 0)))))
(assert (= o95 (select res3 o94)))
(assert (= o96 (us_split_fields11 o95)))
(assert (= o97 (rec__red_black_trees__black_count__depth o96)))
(assert (= o103 (to_rep o97)))
(assert (= o104 (ite (< o103 o102) o102 o103)))
(assert (= o105 (+ 1 o104)))
(assert (not (in_range1 o105)))
(check-sat)
(exit)
