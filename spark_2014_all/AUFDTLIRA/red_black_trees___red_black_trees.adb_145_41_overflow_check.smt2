...
(declare-const j Int)
(declare-const o Int)
(declare-const o1 us_rep6)
(declare-const o2 us_split_fields10)
(declare-const o3 extended_index_type)
(declare-const o4 Int)
(declare-const o5 us_rep6)
(declare-const o6 us_split_fields10)
...
(declare-const o14 us_split_fields10)
...
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields7 (select m j1))) true) (< n2 (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res3 j1)))))) (< (length (rec__tree_model__path_type__a (us_split_fields7 (select m j1)))) (- 100 n2))))))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- i2 1))) (=> (and (= (rec__tree_model__path_type__k (us_split_fields7 (select m j1))) true) (< (+ n2 1) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res3 j1)))))) (< (length (rec__tree_model__path_type__a (us_split_fields7 (select m j1)))) (- 100 (+ n2 1)))))))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields7 (select m j1))) true) (or (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res3 j1)))) n2) (and (< j1 i2) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res3 j1)))) (+ n2 1))))) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select res3 j1))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res3 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j1 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res3 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j1 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res3 j1)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res3 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j1 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res3 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j1 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res3 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j1 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res3 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j1 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res3 j1)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) j1)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res3 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j1 0))))))))))))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields7 (select m j1))) true) (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res3 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j1 0))))) n2)) (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res3 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j1 1))))) n2)) (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res3 j1)))) n2)))))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- i2 1))) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields7 (select m j1))) true) (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res3 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j1 0))))) n2)) (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res3 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j1 1))))) n2)) (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res3 j1)))) (+ n2 1))))))
...
(assert (<= 1 j))
(assert (<= j 100))
(assert (ite (= (rec__tree_model__path_type__k (us_split_fields7 (select m j))) true) (=> (not (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res3 j)))) n2)) (< j i2)) true))
(assert (ite (= (rec__tree_model__path_type__k (us_split_fields7 (select m j))) true) (=> (not (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res3 j)))) n2)) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res3 j)))) (+ n2 1))) true))
(assert (ite (= (rec__tree_model__path_type__k (us_split_fields7 (select m j))) true) true false))
(assert (and (= o12 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j 0)) (and (in_range2 o12) (= o12 (peek1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) j 0)))))
(assert (= o13 (select res3 o12)))
(assert (= o14 (us_split_fields11 o13)))
(assert (= o15 (rec__red_black_trees__black_count__count o14)))
(assert (= o16 (to_rep o15)))
(assert (=> (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) j)) 0) (= o17 1)))
(assert (=> (not (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) j)) 0)) (= o17 0)))
(assert (= o18 (+ o17 o16)))
(assert (and (= o19 o18) (in_range7 o18)))
(assert (= o20 (ite (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res3 j)))) o19) true false)))
(assert (and (= o4 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j 1)) (and (in_range2 o4) (= o4 (peek1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) j 1)))))
(assert (= o5 (select res3 o4)))
(assert (= o6 (us_split_fields11 o5)))
(assert (= o7 (rec__red_black_trees__black_count__depth o6)))
(assert (= o8 (to_rep o7)))
(assert (and (= o (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j 0)) (and (in_range2 o) (= o (peek1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) j 0)))))
(assert (= o1 (select res3 o)))
(assert (= o2 (us_split_fields11 o1)))
(assert (= o3 (rec__red_black_trees__black_count__depth o2)))
(assert (= o9 (to_rep o3)))
(assert (= o10 (ite (< o9 o8) o8 o9)))
(assert (= o11 (+ 1 o10)))
(assert (not (in_range7 o11)))
(check-sat)
(exit)
