...
(declare-const o Int)
(declare-const o1 partition_index)
...
(define-fun o11 () us_rep5 (mk___rep2 (mk___split_fields2 o3 o4 o5)))
...
(assert (and (= o (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem)) (and (in_range8 o) (= o (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem)))))
(assert (= o1 (select f o)))
(assert (= o2 (to_rep4 o1)))
(assert (and (= o11 (get3 (model__1 (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields))) o2)) (= (bool_eq6 o11 (get3 (model__1 (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields))) o2)) true)))
(assert (= o3 o6))
(assert (= o4 o7))
(assert (= o5 o8))
(assert (= o9 o8))
(assert (= o10 (to_rep1 o9)))
(assert (not (= (has_key (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem) true)))
(check-sat)
(exit)
