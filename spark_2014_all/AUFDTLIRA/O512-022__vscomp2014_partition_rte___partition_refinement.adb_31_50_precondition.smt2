...
(assert (and (= o25 (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem)) (and (in_range8 o25) (= o25 (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem)))))
(assert (= o26 (select f o25)))
(assert (= o27 (to_rep4 o26)))
(assert (and (= (mk___rep2 (mk___split_fields2 o28 o29 o30)) (get3 (model__1 (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields))) o27)) (= (bool_eq6 (mk___rep2 (mk___split_fields2 o28 o29 o30)) (get3 (model__1 (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields))) o27)) true)))
(assert (= o28 o31))
(assert (= o29 o32))
(assert (= o30 o33))
(assert (= o34 o33))
