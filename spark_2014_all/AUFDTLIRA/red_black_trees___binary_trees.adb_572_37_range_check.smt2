...
(assert (= o27 (select temp___1269 ki1)))
(assert (= o28 (us_split_fields1 o27)))
(assert (= result6 (rec__tree_model__path_type__k o28)))
...
(assert (=> (= result6 true) (= o23 (select temp___1270 ki1))))
(assert (=> (= result6 true) (= o24 (us_split_fields1 o23))))
(assert (=> (= result6 true) (= o25 (rec__tree_model__path_type__a o24))))
(assert (=> (= result6 true) (and (= o26 (length o25)) (and (in_range5 o26) (<= (+ 0 o26) 2147483647)))))
(assert (=> (= result6 true) (= result5 (ite (= o26 n2) true false))))
