...
(assert (and (<= 0 topstacki2) (<= topstacki2 99)))
(assert (= o26 topstacki2))
(assert (= o27 (select s__split_fields5 o26)))
(assert (= o28 (to_rep o27)))
(assert (= result8 (ite (<= 0 o28) true false)))
(assert (=> (= result8 true) (and (<= 0 topstacki2) (<= topstacki2 99))))
(assert (=> (= result8 true) (= o23 topstacki2)))
(assert (=> (= result8 true) (= o24 (select s__split_fields5 o23))))
(assert (=> (= result8 true) (= o25 (to_rep o24))))
(assert (=> (= result8 true) (= result7 (ite (< o25 (to_rep s__split_fields2)) true false))))
...
(assert (=> (= result7 true) (= o21 (select s__split_fields6 o20))))
(assert (=> (= result7 true) (= o22 (to_rep o21))))
(assert (=> (= result7 true) (= result6 (ite (<= 0 o22) true false))))
(assert (=> (not (= result7 true)) (= result6 false)))
(assert (=> (= result6 true) (and (<= 0 topstacki2) (<= topstacki2 99))))
(assert (=> (= result6 true) (= o14 topstacki2)))
(assert (=> (= result6 true) (= o15 (select s__split_fields5 o14))))
(assert (=> (= result6 true) (= temp___574 (to_rep o15))))
(assert (=> (= result6 true) (and (<= 0 temp___574) (<= temp___574 99))))
(assert (=> (= result6 true) (= o16 temp___574)))
(assert (=> (= result6 true) (= o17 (select s__split_fields3 o16))))
(assert (=> (= result6 true) (= o18 (to_rep o17))))
(assert (=> (= result6 true) (and (<= 0 topstacki2) (<= topstacki2 99))))
(assert (=> (= result6 true) (= o12 topstacki2)))
(assert (=> (= result6 true) (= o13 (select s__split_fields6 o12))))
(assert (=> (= result6 true) (= o19 (to_rep o13))))
(assert (=> (= result6 true) (= result5 (ite (< o19 o18) true false))))
(assert (=> (not (= result6 true)) (= result5 false)))
(assert (= result5 true))
(assert (and (<= 0 topstacki2) (<= topstacki2 99)))
(assert (= o10 topstacki2))
(assert (= o11 (select s__split_fields5 o10)))
(assert (= temp___577 (to_rep o11)))
(assert (not (<= 0 temp___577)))
(check-sat)
(exit)
