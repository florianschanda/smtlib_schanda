...
(assert (= (contains1 (mk___rep4 (mk___split_fields4 (mk___rep2 (mk___split_fields2 t__split_fields (mk___rep1 (mk___split_fields1 t__split_fields1 t__split_fields2)) t__split_fields3)) t__split_fields4)) v) true))
(assert (not (= (oeq (values1 (mk___rep4 (us_split_fields__content4 t__split_fields39))) (values1 (mk___rep4 (mk___split_fields4 (mk___rep2 (mk___split_fields2 t__split_fields (mk___rep1 (mk___split_fields1 t__split_fields1 t__split_fields2)) t__split_fields3)) t__split_fields4)))) true)))
(check-sat)
(exit)
