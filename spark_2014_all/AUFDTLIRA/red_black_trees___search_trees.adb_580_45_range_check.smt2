...
(assert (and (= result2 (ordered_leafs (rec__search_trees__search_tree__struct (us_split_fields7 t1)) o (rec__search_trees__search_tree__values (us_split_fields7 t1)))) (= (= result2 true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t1)) o) i))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t1)) o) j))) true)) (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t1)) o) i))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t1)) o) j)))) true)) (ite (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t1)) o) j))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t1)) o) i)))) 1)) 0) (< (to_rep2 (select (rec__search_trees__search_tree__values (us_split_fields7 t1)) j)) (to_rep2 (select (rec__search_trees__search_tree__values (us_split_fields7 t1)) i))) (< (to_rep2 (select (rec__search_trees__search_tree__values (us_split_fields7 t1)) i)) (to_rep2 (select (rec__search_trees__search_tree__values (us_split_fields7 t1)) j))))))))))))
(assert (= result2 true))
