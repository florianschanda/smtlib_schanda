...
(declare-const temp___1107 us_rep)
...
(define-fun temp___11064 () us_rep (mk___rep (mk___split_discrs temp___1106) (mk___split_fields temp___11061 (mk___t temp___11062 temp___11063))))
...
(assert (dynamic_predicate temp___11064))
(assert (= temp___1107 temp___11064))
(assert (= result1 (mk___split_fields__ref to____split_fields3)))
(assert (= to____split_fields4 (us_split_fields1 temp___1107)))
(assert (= to____split_discrs (us_split_discrs1 temp___1107)))
(assert (= to____split_fields5 (mk___split_fields__ref to____split_fields4)))
(assert (= to____split_fields6 to____split_fields4))
(assert (not (= (length1 (mk___rep to____split_discrs (us_split_fields__content to____split_fields5))) (length1 source))))
(check-sat)
(exit)
