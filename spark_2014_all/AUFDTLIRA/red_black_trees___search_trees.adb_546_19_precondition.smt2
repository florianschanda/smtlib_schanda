...
(assert (forall ((f us_rep3)) (forall ((i Int)) (! (=> (and (dynamic_invariant5 f true true true true) (dynamic_invariant i true true true true)) (=> (< (size f) i) (not (= (valid_root f i) true)))) :pattern ((valid_root f i))))))
...
(assert (forall ((f us_rep3)) (forall ((i Int)) (! (=> (and (dynamic_invariant5 f true true true true) (dynamic_invariant i true true true true)) (let ((result (parent f i))) (and (and (=> (= (valid_root f i) true) (= result 0)) (=> (= (size f) 0) (= result 0))) (dynamic_invariant7 result true false true true)))) :pattern ((parent f i))))))
(assert (forall ((f us_rep3)) (forall ((i Int)) (! (=> (and (and (dynamic_invariant5 f true true true true) (dynamic_invariant i true true true true)) (not (= (parent f i) 0))) (dynamic_invariant9 (position f i) true false true true)) :pattern ((position f i))))))
