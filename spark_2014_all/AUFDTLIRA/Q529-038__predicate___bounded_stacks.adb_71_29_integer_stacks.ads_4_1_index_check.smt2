...
(assert (and (<= (to_rep2 (first (rt (rec__integer_stacks__stack__values (us_split_fields1 right))))) k2) (<= k2 (to_rep2 (last (rt (rec__integer_stacks__stack__values (us_split_fields1 right))))))))
(assert (= o k2))
(assert (= o1 (select (elts (rec__integer_stacks__stack__values (us_split_fields1 right))) o)))
(assert (= o2 (to_rep1 o1)))
(assert (not (<= k2 (to_rep2 (last (rt (rec__integer_stacks__stack__values (us_split_fields1 left))))))))
(check-sat)
(exit)
