...
(assert (and (= us (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 right)))) (in_range2 (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 right))))))
(assert (and (= us1 (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 left)))) (in_range2 (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 left))))))
...
(assert (and (<= (to_rep3 (first (rt (rec__integer_stacks__stack__values (us_split_fields1 right))))) k2) (<= k2 (to_rep3 (last (rt (rec__integer_stacks__stack__values (us_split_fields1 right))))))))
(assert (= o k2))
(assert (= o1 (select (elts (rec__integer_stacks__stack__values (us_split_fields1 right))) o)))
(assert (= o2 (to_rep2 o1)))
(assert (not (<= (to_rep3 (first (rt (rec__integer_stacks__stack__values (us_split_fields1 left))))) k2)))
(check-sat)
(exit)
