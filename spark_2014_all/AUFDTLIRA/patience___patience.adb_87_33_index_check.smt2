...
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o111 i1))
(assert (= temp___629 (select (rec__patience__state__stacks (us_split_fields__content s__split_fields20)) o111)))
(assert (and (<= 0 j) (<= j 99)))
(assert (= o112 j))
...
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o110 i1))
(assert (= temp___627 (select (rec__patience__state__stacks (us_split_fields__content s__split_fields20)) o110)))
(assert (not (<= 0 j)))
(check-sat)
(exit)
