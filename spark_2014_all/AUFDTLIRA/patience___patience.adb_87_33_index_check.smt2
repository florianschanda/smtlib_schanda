...
(declare-const temp___657 (Array Int cardindex))
...
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o111 i1))
(assert (= temp___659 (select (rec__patience__state__stacks (us_split_fields__content s__split_fields20)) o111)))
(assert (and (<= 0 j) (<= j 99)))
(assert (= o112 j))
(assert (= o113 (select temp___659 o112)))
(assert (= o114 (to_rep1 o113)))
(assert (= o115 (ite (< o114 (to_rep1 (rec__patience__state__numelts (us_split_fields__content s__split_fields20)))) true false)))
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o110 i1))
(assert (= temp___657 (select (rec__patience__state__stacks (us_split_fields__content s__split_fields20)) o110)))
(assert (not (<= 0 j)))
(check-sat)
(exit)
