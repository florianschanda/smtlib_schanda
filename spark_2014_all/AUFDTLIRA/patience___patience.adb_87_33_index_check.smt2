...
(assert (and (<= 0 j) (<= j 99)))
(assert (= o151 j))
(assert (= o152 (select temp___629 o151)))
(assert (= o153 (to_rep1 o152)))
(assert (= o154 (ite (< o153 (to_rep1 (rec__patience__state__numelts (us_split_fields__content s__split_fields20)))) true false)))
(assert (and (<= 0 i2) (<= i2 99)))
(assert (= o149 i2))
(assert (= temp___627 (select (rec__patience__state__stacks (us_split_fields__content s__split_fields20)) o149)))
(assert (not (<= 0 j)))
(check-sat)
(exit)
