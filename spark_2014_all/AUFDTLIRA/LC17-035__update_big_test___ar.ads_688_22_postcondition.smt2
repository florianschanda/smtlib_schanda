...
(declare-fun temp___2648 ((Array Int (Array Int (Array Int (Array Int et1)))) Int (Array Int (Array Int (Array Int et1))) Int (Array Int (Array Int (Array Int et1)))) (Array Int (Array Int (Array Int (Array Int et1)))))
(assert (forall ((temp___2650 (Array Int (Array Int (Array Int (Array Int et1)))))) (forall ((temp___2651 Int) (temp___2653 Int)) (forall ((temp___2652 (Array Int (Array Int (Array Int et1)))) (temp___2654 (Array Int (Array Int (Array Int et1))))) (let ((temp___2649 (temp___2648 temp___2650 temp___2651 temp___2652 temp___2653 temp___2654))) (forall ((temp___2655 Int)) (ite (= temp___2655 temp___2653) (= (select temp___2649 temp___2655) temp___2654) (ite (= temp___2655 temp___2651) (= (select temp___2649 temp___2655) temp___2652) (= (select temp___2649 temp___2655) (select temp___2650 temp___2655))))))))))
(declare-fun temp___2656 ((Array Int (Array Int (Array Int et1))) Int (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1))))
(assert (forall ((temp___2658 (Array Int (Array Int (Array Int et1))))) (forall ((temp___2659 Int)) (forall ((temp___2660 (Array Int (Array Int et1)))) (let ((temp___2657 (temp___2656 temp___2658 temp___2659 temp___2660))) (forall ((temp___2661 Int)) (ite (= temp___2661 temp___2659) (= (select temp___2657 temp___2661) temp___2660) (= (select temp___2657 temp___2661) (select temp___2658 temp___2661)))))))))
(declare-fun temp___2663 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
(assert (forall ((temp___2665 (Array Int (Array Int et1)))) (forall ((temp___2666 Int)) (forall ((temp___2667 (Array Int et1))) (let ((temp___2664 (temp___2663 temp___2665 temp___2666 temp___2667))) (forall ((temp___2668 Int)) (ite (= temp___2668 temp___2666) (= (select temp___2664 temp___2668) temp___2667) (= (select temp___2664 temp___2668) (select temp___2665 temp___2668)))))))))
(declare-fun temp___2671 ((Array Int (Array Int (Array Int et1))) Int (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1))))
(assert (forall ((temp___2673 (Array Int (Array Int (Array Int et1))))) (forall ((temp___2674 Int)) (forall ((temp___2675 (Array Int (Array Int et1)))) (let ((temp___2672 (temp___2671 temp___2673 temp___2674 temp___2675))) (forall ((temp___2676 Int)) (ite (= temp___2676 temp___2674) (= (select temp___2672 temp___2676) temp___2675) (= (select temp___2672 temp___2676) (select temp___2673 temp___2676)))))))))
(declare-fun temp___2678 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
(assert (forall ((temp___2680 (Array Int (Array Int et1)))) (forall ((temp___2681 Int)) (forall ((temp___2682 (Array Int et1))) (let ((temp___2679 (temp___2678 temp___2680 temp___2681 temp___2682))) (forall ((temp___2683 Int)) (ite (= temp___2683 temp___2681) (= (select temp___2679 temp___2683) temp___2682) (= (select temp___2679 temp___2683) (select temp___2680 temp___2683)))))))))
...
(assert (= a2 a3))
(assert (= a4 a2))
(assert (not (= (bool_eq3 a3 90 99 (temp___2648 a i1 (temp___2656 (select a i1) j1 (temp___2663 (select (select a i1) j1) k1 b)) i2 (temp___2671 (select a i2) j2 (temp___2678 (select (select a i2) j2) k2 c))) 90 99) true)))
(check-sat)
(exit)
