...
(assert true)
(assert (forall ((a us_t) (b us_t)) (! (= (= (is_perm a b) true) (forall ((e Int)) (=> (and (<= 0 e) (<= e 2147483647)) (= (occ a e) (occ b e))))) :pattern ((is_perm a b)))))
(declare-fun index_of_minimum (us_t) Int)
(declare-fun index_of_minimum__function_guard (Int us_t) Bool)
(assert (forall ((values us_t)) (! (=> (and (dynamic_invariant1 values true true true true) (< 0 (length values))) (let ((result (index_of_minimum values))) (and (and (and (<= (first1 values) result) (<= result (last1 values))) (forall ((i Int)) (=> (and (<= (first1 values) i) (<= i (last1 values))) (<= (to_rep (select (to_array values) result)) (to_rep (select (to_array values) i)))))) (dynamic_invariant result true false true true)))) :pattern ((index_of_minimum values)))))
...
(declare-datatypes () ((tTpreviousSP1__ref (mk_tTpreviousSP1__ref (tTpreviousSP1__content integer)))))
(define-fun tTpreviousSP1__ref___projection ((a tTpreviousSP1__ref)) integer (tTpreviousSP1__content a))
(declare-sort t1 0)
...
(declare-datatypes () ((tpreviousS__ref (mk_tpreviousS__ref (tpreviousS__content us_t1)))))
(define-fun tpreviousS__ref___projection ((a tpreviousS__ref)) us_t1 (tpreviousS__content a))
(define-fun dynamic_invariant2 ((temp___expr_261 us_t1) (temp___is_init_257 Bool) (temp___skip_constant_258 Bool) (temp___do_toplevel_259 Bool) (temp___do_typ_inv_260 Bool)) Bool (=> (not (= temp___skip_constant_258 true)) (and (dynamic_property2 (to_rep1 values__first) (to_rep1 values__last) (first3 temp___expr_261) (last3 temp___expr_261)) (and (= (first3 temp___expr_261) (to_rep1 values__first)) (= (last3 temp___expr_261) (to_rep1 values__last))))))
...
(define-fun dynamic_invariant5 ((temp___expr_159 Int) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool) (temp___do_typ_inv_158 Bool)) Bool (=> (or (= temp___is_init_155 true) (<= 1 100)) (in_range4 temp___expr_159)))
...
(define-fun dynamic_invariant6 ((temp___expr_172 Int) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool) (temp___do_typ_inv_171 Bool)) Bool (=> (or (= temp___is_init_168 true) (<= 0 100)) (in_range5 temp___expr_172)))
...
(assert (forall ((a us_t)) (! (=> (dynamic_invariant1 a true true true true) (= (remove_last a) (let ((temp___184 (let ((temp___183 (- (last1 a) 1))) (let ((temp___182 (first1 a))) (of_array3 (to_array a) temp___182 temp___183))))) (of_array (to_array3 temp___184) (first7 temp___184) (last7 temp___184))))) :pattern ((remove_last a)))))
(declare-fun occ_def (us_t Int) Int)
(declare-fun occ_def__function_guard (Int us_t Int) Bool)
(assert (forall ((a us_t)) (forall ((e Int)) (! (=> (and (dynamic_invariant1 a true true true true) (dynamic_invariant3 e true true true true)) (= (occ_def a e) (ite (= (length a) 0) 0 (ite (= (to_rep (select (to_array a) (last1 a))) e) (+ (occ_def (remove_last a) e) 1) (occ_def (remove_last a) e))))) :pattern ((occ_def a e))))))
(assert (forall ((a us_t)) (forall ((e Int)) (! (=> (and (dynamic_invariant1 a true true true true) (dynamic_invariant3 e true true true true)) (let ((result (occ a e))) (and (<= result (length a)) (dynamic_invariant6 result true false true true)))) :pattern ((occ a e))))))
(assert (forall ((a us_t)) (forall ((e Int)) (! (=> (and (dynamic_invariant1 a true true true true) (dynamic_invariant3 e true true true true)) (= (occ a e) (occ_def a e))) :pattern ((occ a e))))))
...
(declare-const temp___273 (Array Int natural))
(declare-const temp___2731 t1)
...
(assert (and (dynamic_property2 (to_rep1 values__first) (to_rep1 values__last) (to_rep1 previous__first) (to_rep1 previous__last)) (and (= (to_rep1 previous__first) (to_rep1 values__first)) (= (to_rep1 previous__last) (to_rep1 values__last)))))
(assert (=> (<= (to_rep1 values__first) (to_rep1 values__last)) (= o (+ (- (to_rep1 values__last) (to_rep1 values__first)) 1))))
(assert (=> (not (<= (to_rep1 values__first) (to_rep1 values__last))) (= o 0)))
(assert (= result (ite (= o 0) true false)))
(assert (not (= result true)))
(assert (and (= temp___270 (- (to_rep1 values__last) 1)) (in_range1 (- (to_rep1 values__last) 1))))
(assert (= (mk_int__ref result1) (mk_int__ref current)))
(assert (= current1 (to_rep1 values__first)))
(assert (<= (to_rep1 values__first) current1))
(assert (<= current1 temp___270))
(assert (=> (<= current1 (to_rep1 values__last)) (and (and (<= (to_rep1 values__first) current1) (<= current1 (to_rep1 values__last))) (and (<= (to_rep1 values__first) (to_rep1 values__last)) (<= (to_rep1 values__last) (to_rep1 values__last))))))
(assert (= o1 values))
(assert (= o1 temp___272))
(assert (= (mk2 current1 (to_rep1 values__last)) temp___2721))
(assert (= temp___272 o2))
(assert (= (mk (to_rep1 (first4 temp___2721)) (to_rep1 (last4 temp___2721))) o3))
(assert (and (= o4 (index_of_minimum (mk___t o2 o3))) (and (in_range3 o4) (and (and (<= (to_rep1 (first o3)) o4) (<= o4 (to_rep1 (last o3)))) (forall ((i1 Int)) (=> (and (<= (to_rep1 (first o3)) i1) (<= i1 (to_rep1 (last o3)))) (<= (to_rep (select o2 o4)) (to_rep (select o2 i1)))))))))
(assert (= (mk_int__ref result2) (mk_int__ref smallest)))
(assert (= smallest1 o4))
(assert (=> (not (= smallest1 current1)) (= (slide values (to_rep1 values__first) (to_rep1 values__first)) temp___273)))
(assert (=> (not (= smallest1 current1)) (= (mk1 (to_rep1 values__first) (to_rep1 values__last)) temp___2731)))
(assert (=> (not (= smallest1 current1)) (= (ite (<= (to_rep1 (first2 temp___2731)) (to_rep1 (last2 temp___2731))) (+ (- (to_rep1 (last2 temp___2731)) (to_rep1 (first2 temp___2731))) 1) 0) (ite (<= (to_rep1 previous__first) (to_rep1 previous__last)) (+ (- (to_rep1 previous__last) (to_rep1 previous__first)) 1) 0))))
(assert (=> (not (= smallest1 current1)) (= (mk___t1 o5 o6) (mk___t1 temp___273 temp___2731))))
(assert (=> (not (= smallest1 current1)) (= o7 o5)))
(assert (=> (not (= smallest1 current1)) (= (mk_map__ref result3) (mk_map__ref previous))))
(assert (=> (not (= smallest1 current1)) (= previous2 o7)))
(assert (=> (not (= smallest1 current1)) (and (= o8 current1) (in_range3 current1))))
(assert (=> (not (= smallest1 current1)) (and (and (and (= (is_perm (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last))) (mk___t o11 (mk (to_rep1 values__first) (to_rep1 values__last)))) true) (= (to_rep (select o11 o8)) (to_rep (select values smallest1)))) (= (to_rep (select o11 smallest1)) (to_rep (select values o8)))) (forall ((z Int)) (=> (and (<= (to_rep1 values__first) z) (<= z (to_rep1 values__last))) (=> (and (not (= z o8)) (not (= z smallest1))) (= (to_rep (select o11 z)) (to_rep (select values z)))))))))
(assert (=> (not (not (= smallest1 current1))) (= previous2 previous)))
(assert (=> (not (not (= smallest1 current1))) (= o11 values)))
(assert (=> (not (not (= smallest1 current1))) (= previous2 previous1)))
(assert (=> (not (not (= smallest1 current1))) (= o11 values1)))
(assert (forall ((i1 Int)) (=> (and (<= (to_rep1 values__first) i1) (<= i1 current2)) (forall ((j1 Int)) (=> (and (<= (+ i1 1) j1) (<= j1 (to_rep1 values__last))) (<= (to_rep (select values2 i1)) (to_rep (select values2 j1))))))))
(assert (= (is_perm (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last))) (mk___t values2 (mk (to_rep1 values__first) (to_rep1 values__last)))) true))
(assert (and (and (=> (<= (to_rep1 values__first) (- (to_rep1 values__last) 1)) (dynamic_property3 (to_rep1 values__first) (- (to_rep1 values__last) 1) current2)) (=> (<= 1 2147483647) (in_range3 smallest2))) (and (<= (to_rep1 values__first) current2) (<= current2 (- (to_rep1 values__last) 1)))))
(assert (<= (to_rep1 values__first) i))
(assert (<= i current2))
(assert (and (= o9 (+ i 1)) (in_range1 (+ i 1))))
(assert (= o10 (ite (<= o9 j) true false)))
(assert (= result4 (ite (= o10 true) (ite (<= j (to_rep1 values__last)) true false) false)))
(assert (= result4 true))
(assert (not (<= j (to_rep1 values__last))))
(check-sat)
(exit)
