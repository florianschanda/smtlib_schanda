...
(assert (forall ((y Int) (array_arith__init3__one Int)) (! (=> (and (dynamic_invariant1 y true true true true) (dynamic_invariant array_arith__init3__one true true true true)) (dynamic_invariant1 (ident y array_arith__init3__one) true false true true)) :pattern ((ident y array_arith__init3__one)))))
...
(assert (<= 1 j))
(assert (<= j 10))
(assert (not (= (to_rep (select x11 j)) (+ j 1))))
(check-sat)
(exit)
