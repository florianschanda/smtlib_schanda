...
(assert (and (= o122 (remove (mk___t interm1 (mk 1 100)) o121)) (and (dynamic_invariant4 o122 true false true) (and (= (invariant__ o122) true) (and (= (to_rep1 (last (rt o122))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o121 1))) (= (to_rep (select interm1 k)) (to_rep (select (elts o122) k))))) (and (forall ((k Int)) (=> (and (<= (+ o121 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select interm1 k)) (to_rep (select (elts o122) (- k 1)))))) (forall ((k Int)) (=> (and (<= o121 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select interm1 (+ k 1))) (to_rep (select (elts o122) k))))))))))))
(assert (not (= (invariant__ o122) true)))
(check-sat)
(exit)
