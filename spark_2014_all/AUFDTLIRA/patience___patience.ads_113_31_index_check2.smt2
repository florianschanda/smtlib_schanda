...
(assert (= o20 (ite (<= o19 (- (to_rep (rec__patience__state__numelts (us_split_fields1 s))) 1)) true false)))
(assert (and (<= 0 i) (<= i 99)))
(assert (= o14 i))
(assert (= o15 (select (rec__patience__state__preds (us_split_fields1 s)) o14)))
...
(assert (=> (= result6 true) (= o12 (select (rec__patience__state__preds (us_split_fields1 s)) o11))))
(assert (=> (= result6 true) (= o13 (to_rep o12))))
...
(assert (and (<= 0 i) (<= i 99)))
(assert (= o7 i))
(assert (= o8 (select (rec__patience__state__values (us_split_fields1 s)) o7)))
(assert (= o9 (to_rep1 o8)))
(assert (and (<= 0 i) (<= i 99)))
(assert (= o3 i))
(assert (= o4 (select (rec__patience__state__preds (us_split_fields1 s)) o3)))
(assert (= temp___537 (to_rep o4)))
(assert (and (<= 0 temp___537) (<= temp___537 99)))
(assert (= o5 temp___537))
(assert (= o6 (select (rec__patience__state__values (us_split_fields1 s)) o5)))
(assert (= o10 (to_rep1 o6)))
