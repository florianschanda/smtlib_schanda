...
(assert (and (= o190 x) (in_range5 x)))
(assert (and (= o191 (remove (mk___t init (mk 1 100)) o190)) (and (dynamic_invariant4 o191 true false true) (and (= (invariant__ o191) true) (and (= (to_rep1 (last (rt o191))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o190 1))) (= (to_rep (select init k)) (to_rep (select (elts o191) k))))) (and (forall ((k Int)) (=> (and (<= (+ o190 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select init k)) (to_rep (select (elts o191) (- k 1)))))) (forall ((k Int)) (=> (and (<= o190 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select init (+ k 1))) (to_rep (select (elts o191) k))))))))))))
(assert (not (= (invariant__ o191) true)))
(check-sat)
(exit)
