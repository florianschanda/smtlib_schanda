...
(assert (and (dynamic_invariant1 temp___2064 true false true true) (and (let ((temp___208 (temp___198 32 1 (to_rep temp___206)))) (and (= temp___2061 (elts1 temp___208)) (= temp___2062 (mk (to_rep3 (first2 (rt1 temp___208))) (to_rep3 (last2 (rt1 temp___208))))))) (= (to_rep1 temp___2063) 0))))
(assert (not (= (length2 temp___2064) 0)))
(check-sat)
(exit)
