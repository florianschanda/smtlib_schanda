...
(assert (and (dynamic_invariant1 (mk___rep (mk___split_discrs temp___180) (mk___split_fields (mk___t temp___1801 temp___1802) temp___1803)) true false true) (and (let ((temp___182 (temp___172 32 1 (to_rep temp___180)))) (and (= temp___1801 (elts1 temp___182)) (= temp___1802 (mk (to_rep3 (first2 (rt1 temp___182))) (to_rep3 (last2 (rt1 temp___182))))))) (= (to_rep1 temp___1803) 0))))
(assert (not (= (length2 (mk___rep (mk___split_discrs temp___180) (mk___split_fields (mk___t temp___1801 temp___1802) temp___1803))) 0)))
(check-sat)
(exit)
