...
(assert (forall ((unsorted us_t)) (! (=> (and (dynamic_invariant2 unsorted true true true) (and (<= (first1 unsorted) (last1 unsorted)) (< (first1 unsorted) 2147483647))) (let ((result (index_of_minimum unsorted))) (and (and (and (<= (first1 unsorted) result) (<= result (last1 unsorted))) (forall ((j Int)) (=> (and (<= (first1 unsorted) j) (<= j (last1 unsorted))) (<= (to_rep (select (to_array unsorted) result)) (to_rep (select (to_array unsorted) j)))))) (dynamic_invariant result true false true)))) :pattern ((index_of_minimum unsorted)))))
...
(declare-const sorters__swap__y Int)
(declare-const o10 Int)
(declare-const o11 integer)
(declare-const o12 Int)
(declare-const sorters__swap__x Int)
...
(declare-const sorters__swap__y1 Int)
(declare-const sorters__swap__x1 Int)
...
(assert (and (= temp___166 (- (to_rep values__last) 1)) (in_range1 (- (to_rep values__last) 1))))
(assert (= result current))
(assert (= current1 (to_rep values__first)))
(assert (<= (to_rep values__first) current1))
(assert (<= current1 temp___166))
(assert (and (=> (<= 1 2147483647) (in_range2 smallest1)) (and (<= (to_rep values__first) current2) (<= current2 (- (to_rep values__last) 1)))))
