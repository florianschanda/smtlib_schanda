...
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= temp___1635 (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root)) (and (dynamic_invariant3 temp___1635 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1635 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1635 root)))) 0) (and (forall ((i15 Int)) (=> (and (<= 1 i15) (<= i15 100)) (=> (not (= i15 root)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i15) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1635 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i15)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1635 i15))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1635 i15))) true)))))) (and (forall ((i15 Int)) (=> (and (<= 1 i15) (<= i15 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1635 i15))) true) (not (= i15 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1635 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i15)))) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i15) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1635 i15)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1635 i15)))) 0)))) (forall ((i15 Int)) (=> (and (<= 1 i15) (<= i15 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1635 i15))) true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1635 j2))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1635 i15))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1635 j2)))) true)) (= j2 i15))))))))))))))
(assert (and (<= 1 v) (<= v 100)))
(assert (= o330 v))
(assert (= o331 (select temp___1635 o330)))
(assert (= o332 (us_split_fields1 o331)))
(assert (= o333 (rec__tree_model__path_type__a o332)))
(assert (not (<= (length o333) 100)))
(check-sat)
(exit)
