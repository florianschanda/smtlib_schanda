...
(assert (=> (= result67 true) (= o186 true)))
(assert (=> (not (= result67 true)) (type_invariant1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)))))
(assert (=> (not (= result67 true)) (and (= o182 (position1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)) i)) (and (in_range5 o182) (= o182 (position (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) i))))))
(assert (=> (not (= result67 true)) (= o183 (ite (= d1 o182) true false))))
(assert (=> (not (= result67 true)) (= o186 (ite (not (= o183 true)) true false))))
(assert (= o191 (ite (not (= j6 i)) o186 (ite (= d1 1) o186 false))))
(assert (= o195 (ite (= o191 true) o190 false)))
(assert (= result66 (ite (= o195 true) o194 false)))
