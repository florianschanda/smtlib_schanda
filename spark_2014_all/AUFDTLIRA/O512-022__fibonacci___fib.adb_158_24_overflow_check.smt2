...
(assert (=> (and (<= 0 i4) (<= i4 k)) (and (forall ((temp___222 Int)) (=> (and (<= 0 temp___222) (<= temp___222 100)) (=> (<= i5 temp___222) (= (select a12 temp___222) (select temp___221 temp___222))))) (and (<= 0 i5) (<= i5 k)))))
...
(assert (=> (and (<= temp___228 i10) (<= i10 100)) (and (forall ((temp___227 Int)) (=> (and (<= 0 temp___227) (<= temp___227 100)) (=> (<= i11 temp___227) (= (select a18 temp___227) (select temp___226 temp___227))))) (and (<= (+ k 1) i11) (<= i11 100)))))
(assert (=> (and (<= temp___228 i10) (<= i10 100)) (and (= temp___225 (- i11 k)) (in_range1 (- i11 k)))))
(assert (=> (and (<= temp___228 i10) (<= i10 100)) (and (<= 0 temp___225) (<= temp___225 100))))
...
(assert (=> (and (<= temp___228 i10) (<= i10 100)) (and (<= 0 i11) (<= i11 100))))
(assert (=> (and (<= temp___228 i10) (<= i10 100)) (= o10 i11)))
(assert (=> (and (<= temp___228 i10) (<= i10 100)) (= o11 (store a18 o10 o9))))
...
(assert (=> (and (<= temp___228 i10) (<= i10 100)) (= i14 (mk_int__ref i12))))
(assert (=> (and (<= temp___228 i10) (<= i10 100)) (= a114 (mk_map__ref a110))))
(assert (=> (and (<= temp___228 i10) (<= i10 100)) (= i15 i13)))
(assert (=> (and (<= temp___228 i10) (<= i10 100)) (= a113 a111)))
(assert (=> (not (and (<= temp___228 i10) (<= i10 100))) (= i14 (mk_int__ref i10))))
(assert (=> (not (and (<= temp___228 i10) (<= i10 100))) (= a114 a115)))
...
(assert (=> (and (<= 0 i16) (<= i16 k)) (and (forall ((temp___231 Int)) (=> (and (<= 0 temp___231) (<= temp___231 100)) (=> (<= i17 temp___231) (= (select a22 temp___231) (select temp___230 temp___231))))) (and (<= 0 i17) (<= i17 k)))))
...
(assert (<= temp___237 i22))
(assert (<= i22 100))
(assert (and (forall ((temp___236 Int)) (=> (and (<= 0 temp___236) (<= temp___236 100)) (=> (<= i23 temp___236) (= (select a28 temp___236) (select (map__content a26) temp___236))))) (and (<= (+ k 1) i23) (<= i23 100))))
(assert (not (in_range1 (- i23 k))))
(check-sat)
(exit)
