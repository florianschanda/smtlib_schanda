...
(assert (=> (and (<= temp___251 i10) (<= i10 100)) (= a114 (mk_map__ref a110))))
...
(assert (=> (not (and (<= temp___251 i10) (<= i10 100))) (= a114 a115)))
...
(assert (<= temp___260 i22))
(assert (<= i22 100))
(assert (and (forall ((temp___259 Int)) (=> (and (<= 0 temp___259) (<= temp___259 100)) (=> (<= i23 temp___259) (= (select a28 temp___259) (select (map__content a26) temp___259))))) (and (<= (+ k 1) i23) (<= i23 100))))
