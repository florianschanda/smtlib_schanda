...
(assert (= i18 0))
(assert (=> (and (<= 0 i18) (<= i18 k)) (= temp___230 a2)))
(assert (=> (and (<= 0 i18) (<= i18 k)) (and (forall ((temp___231 Int)) (=> (and (<= 0 temp___231) (<= temp___231 100)) (=> (<= i19 temp___231) (= (select a22 temp___231) (select temp___230 temp___231))))) (and (<= 0 i19) (<= i19 k)))))
(assert (=> (and (<= 0 i18) (<= i18 k)) (and (<= 0 i19) (<= i19 100))))
(assert (=> (and (<= 0 i18) (<= i18 k)) (= o18 i19)))
(assert (=> (and (<= 0 i18) (<= i18 k)) (= o19 (select b2 o18))))
(assert (=> (and (<= 0 i18) (<= i18 k)) (= o20 (to_rep o19))))
(assert (=> (and (<= 0 i18) (<= i18 k)) (= (to_rep o21) o20)))
(assert (=> (and (<= 0 i18) (<= i18 k)) (and (<= 0 i19) (<= i19 100))))
(assert (=> (and (<= 0 i18) (<= i18 k)) (= o22 i19)))
(assert (=> (and (<= 0 i18) (<= i18 k)) (= o23 (store a22 o22 o21))))
(assert (=> (and (<= 0 i18) (<= i18 k)) (= result6 (mk_map__ref a22))))
(assert (=> (and (<= 0 i18) (<= i18 k)) (= a23 o23)))
(assert (=> (and (<= 0 i18) (<= i18 k)) (= i19 k)))
(assert (=> (and (<= 0 i18) (<= i18 k)) (= i20 (mk_int__ref i19))))
(assert (=> (and (<= 0 i18) (<= i18 k)) (= a24 (mk_map__ref a23))))
(assert (=> (and (<= 0 i18) (<= i18 k)) (= i21 i19)))
(assert (=> (and (<= 0 i18) (<= i18 k)) (= a25 a23)))
(assert (=> (and (<= 0 i18) (<= i18 k)) (= i22 i20)))
(assert (=> (and (<= 0 i18) (<= i18 k)) (= a26 a24)))
(assert (=> (and (<= 0 i18) (<= i18 k)) (= i23 i21)))
(assert (=> (and (<= 0 i18) (<= i18 k)) (= a27 a25)))
(assert (=> (not (and (<= 0 i18) (<= i18 k))) (= i22 (mk_int__ref i18))))
(assert (=> (not (and (<= 0 i18) (<= i18 k))) (= a26 (mk_map__ref a2))))
(assert (=> (not (and (<= 0 i18) (<= i18 k))) (= i23 i18)))
(assert (=> (not (and (<= 0 i18) (<= i18 k))) (= a27 a21)))
(assert (and (= temp___237 (+ k 1)) (in_range1 (+ k 1))))
(assert (= result7 (mk_int__ref i3)))
(assert (= i24 temp___237))
(assert (<= temp___237 i24))
(assert (<= i24 100))
(assert (and (forall ((temp___236 Int)) (=> (and (<= 0 temp___236) (<= temp___236 100)) (=> (<= i25 temp___236) (= (select a28 temp___236) (select (map__content a26) temp___236))))) (and (<= (+ k 1) i25) (<= i25 100))))
(assert (not (in_range1 (- i25 k))))
(check-sat)
(exit)
