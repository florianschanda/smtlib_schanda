...
(assert (not (= r3 r256b)))
(assert (= result50 (mk_int__ref r3)))
(assert (= r4 (+ r3 1)))
...
(assert (=> (and (not (= r4 root)) (and (not (= r4 v)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f_old__split_fields1 r4)))) 2))) (forall ((i15 Int)) (=> (and (<= 1 i15) (<= i15 100)) (or (not (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) root) i15))) true)) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) r4) i15))) true)))))))
(assert (=> (and (not (= r4 root)) (and (not (= r4 v)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f_old__split_fields1 r4)))) 2))) (and (= o313 v) (in_range1 v))))
(assert (=> (and (not (= r4 root)) (and (not (= r4 v)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f_old__split_fields1 r4)))) 2))) (= (tree_structure (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))) true)))
(assert (=> (and (not (= r4 root)) (and (not (= r4 v)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f_old__split_fields1 r4)))) 2))) (and (= o314 v) (in_range1 v))))
(assert (=> (and (not (= r4 root)) (and (not (= r4 v)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f_old__split_fields1 r4)))) 2))) (forall ((i15 Int)) (=> (and (<= 1 i15) (<= i15 100)) (or (not (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) o314) i15))) true)) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) r4) i15))) true)))))))
