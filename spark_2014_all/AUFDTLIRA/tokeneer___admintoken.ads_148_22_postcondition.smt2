...
(define-fun dynamic_invariant ((temp___expr_251 Int) (temp___is_init_248 Bool) (temp___skip_constant_249 Bool) (temp___do_toplevel_250 Bool)) Bool (=> (or (= temp___is_init_248 true) (<= 0 4294967295)) (in_range4 temp___expr_251)))
(declare-sort tryt 0)
...
(define-fun dynamic_invariant1 ((temp___expr_257 Int) (temp___is_init_254 Bool) (temp___skip_constant_255 Bool) (temp___do_toplevel_256 Bool)) Bool (=> (or (= temp___is_init_254 true) (<= 0 2)) (in_range5 temp___expr_257)))
...
(assert (forall ((x algorithmt)) (! (= (of_rep2 (to_rep2 x)) x) :pattern ((to_rep2 x)))))
(assert (forall ((x algorithmt)) (! (in_range7 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(assert (forall ((x namecountt)) (! (in_range8 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(assert (forall ((x issueridt)) (! (in_range9 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(assert (forall ((x serialnumbert)) (! (= (of_rep5 (to_rep5 x)) x) :pattern ((to_rep5 x)))))
(assert (forall ((x serialnumbert)) (! (in_range10 (to_rep5 x)) :pattern ((to_rep5 x)))))
...
(define-fun bool_eq3 ((a us_rep1) (b us_rep1)) Bool (ite (and (= (bool_eq2 (rec__certtypes__idt__issuer (us_split_fields3 a)) (rec__certtypes__idt__issuer (us_split_fields3 b))) true) (= (to_rep5 (rec__certtypes__idt__serialnumber (us_split_fields3 a))) (to_rep5 (rec__certtypes__idt__serialnumber (us_split_fields3 b))))) true false))
...
(assert (forall ((x yearst)) (! (in_range11 (to_rep6 x)) :pattern ((to_rep6 x)))))
...
(assert (forall ((x monthst)) (! (in_range12 (to_rep7 x)) :pattern ((to_rep7 x)))))
...
(assert (forall ((x dayst)) (! (in_range13 (to_rep8 x)) :pattern ((to_rep8 x)))))
...
(assert (forall ((x millisecst)) (! (in_range14 (to_rep9 x)) :pattern ((to_rep9 x)))))
...
(define-fun bool_eq5 ((a us_rep3) (b us_rep3)) Bool (ite (= (to_rep11 (rec__privtypes__clearancet__class (us_split_fields7 a))) (to_rep11 (rec__privtypes__clearancet__class (us_split_fields7 b)))) true false))
...
(define-fun bool_eq6 ((a us_rep4) (b us_rep4)) Bool (ite (and (and (and (and (and (and (= (bool_eq3 (rec__cert__attr__auth__contentst__id (us_split_fields9 a)) (rec__cert__attr__auth__contentst__id (us_split_fields9 b))) true) (= (bool_eq4 (rec__cert__attr__auth__contentst__notbefore (us_split_fields9 a)) (rec__cert__attr__auth__contentst__notbefore (us_split_fields9 b))) true)) (= (bool_eq4 (rec__cert__attr__auth__contentst__notafter (us_split_fields9 a)) (rec__cert__attr__auth__contentst__notafter (us_split_fields9 b))) true)) (= (to_rep2 (rec__cert__attr__auth__contentst__mechanism (us_split_fields9 a))) (to_rep2 (rec__cert__attr__auth__contentst__mechanism (us_split_fields9 b))))) (= (bool_eq3 (rec__cert__attr__auth__contentst__basecertid (us_split_fields9 a)) (rec__cert__attr__auth__contentst__basecertid (us_split_fields9 b))) true)) (= (to_rep10 (rec__cert__attr__auth__contentst__role (us_split_fields9 a))) (to_rep10 (rec__cert__attr__auth__contentst__role (us_split_fields9 b))))) (= (bool_eq5 (rec__cert__attr__auth__contentst__clearance (us_split_fields9 a)) (rec__cert__attr__auth__contentst__clearance (us_split_fields9 b))) true)) true false))
...
(define-fun dynamic_invariant2 ((temp___expr_885 Int) (temp___is_init_882 Bool) (temp___skip_constant_883 Bool) (temp___do_toplevel_884 Bool)) Bool (=> (or (= temp___is_init_882 true) (<= 0 3)) (in_range15 temp___expr_885)))
(assert (forall ((contents us_rep4)) (! (dynamic_invariant2 (therole contents) true false true) :pattern ((therole contents)))))
...
(assert (forall ((x keyidt)) (! (in_range17 (to_rep12 x)) :pattern ((to_rep12 x)))))
...
(assert (forall ((x keylengtht)) (! (in_range18 (to_rep13 x)) :pattern ((to_rep13 x)))))
...
(define-fun bool_eq7 ((a us_rep5) (b us_rep5)) Bool (ite (and (and (= (to_rep2 (rec__cryptotypes__keypartt__algorithmid (us_split_fields11 a))) (to_rep2 (rec__cryptotypes__keypartt__algorithmid (us_split_fields11 b)))) (= (to_rep12 (rec__cryptotypes__keypartt__keyid (us_split_fields11 a))) (to_rep12 (rec__cryptotypes__keypartt__keyid (us_split_fields11 b))))) (= (to_rep13 (rec__cryptotypes__keypartt__keylength (us_split_fields11 a))) (to_rep13 (rec__cryptotypes__keypartt__keylength (us_split_fields11 b))))) true false))
...
(define-fun bool_eq8 ((a us_rep6) (b us_rep6)) Bool (ite (and (and (and (and (and (= (bool_eq3 (rec__cert__id__contentst__id (us_split_fields13 a)) (rec__cert__id__contentst__id (us_split_fields13 b))) true) (= (bool_eq4 (rec__cert__id__contentst__notbefore (us_split_fields13 a)) (rec__cert__id__contentst__notbefore (us_split_fields13 b))) true)) (= (bool_eq4 (rec__cert__id__contentst__notafter (us_split_fields13 a)) (rec__cert__id__contentst__notafter (us_split_fields13 b))) true)) (= (to_rep2 (rec__cert__id__contentst__mechanism (us_split_fields13 a))) (to_rep2 (rec__cert__id__contentst__mechanism (us_split_fields13 b))))) (= (bool_eq2 (rec__cert__id__contentst__subject (us_split_fields13 a)) (rec__cert__id__contentst__subject (us_split_fields13 b))) true)) (= (bool_eq7 (rec__cert__id__contentst__subjectpublickey (us_split_fields13 a)) (rec__cert__id__contentst__subjectpublickey (us_split_fields13 b))) true)) true false))
...
(assert (forall ((admintoken__authcert__fields us_split_fields14)) (! (dynamic_invariant2 (theauthcertrole admintoken__authcert__fields) true false true) :pattern ((theauthcertrole admintoken__authcert__fields)))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1342 us_void_param) 1)) 84) (= (to_rep (select (temp___String_Literal_1342 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_1342 us_void_param) 3)) 107)) (= (to_rep (select (temp___String_Literal_1342 us_void_param) 4)) 101)) (= (to_rep (select (temp___String_Literal_1342 us_void_param) 5)) 110)) (= (to_rep (select (temp___String_Literal_1342 us_void_param) 6)) 32)) (= (to_rep (select (temp___String_Literal_1342 us_void_param) 7)) 66)) (= (to_rep (select (temp___String_Literal_1342 us_void_param) 8)) 97)) (= (to_rep (select (temp___String_Literal_1342 us_void_param) 9)) 100)) :pattern ((temp___String_Literal_1342 us_void_param)))))
(declare-fun temp___String_Literal_1343 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1343 us_void_param) 1)) 65) (= (to_rep (select (temp___String_Literal_1343 us_void_param) 2)) 117)) (= (to_rep (select (temp___String_Literal_1343 us_void_param) 3)) 116)) (= (to_rep (select (temp___String_Literal_1343 us_void_param) 4)) 104)) (= (to_rep (select (temp___String_Literal_1343 us_void_param) 5)) 111)) (= (to_rep (select (temp___String_Literal_1343 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_1343 us_void_param) 7)) 105)) (= (to_rep (select (temp___String_Literal_1343 us_void_param) 8)) 115)) (= (to_rep (select (temp___String_Literal_1343 us_void_param) 9)) 97)) (= (to_rep (select (temp___String_Literal_1343 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_1343 us_void_param) 11)) 105)) (= (to_rep (select (temp___String_Literal_1343 us_void_param) 12)) 111)) (= (to_rep (select (temp___String_Literal_1343 us_void_param) 13)) 110)) (= (to_rep (select (temp___String_Literal_1343 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_1343 us_void_param) 15)) 67)) (= (to_rep (select (temp___String_Literal_1343 us_void_param) 16)) 101)) (= (to_rep (select (temp___String_Literal_1343 us_void_param) 17)) 114)) (= (to_rep (select (temp___String_Literal_1343 us_void_param) 18)) 116)) (= (to_rep (select (temp___String_Literal_1343 us_void_param) 19)) 105)) (= (to_rep (select (temp___String_Literal_1343 us_void_param) 20)) 102)) (= (to_rep (select (temp___String_Literal_1343 us_void_param) 21)) 105)) (= (to_rep (select (temp___String_Literal_1343 us_void_param) 22)) 99)) (= (to_rep (select (temp___String_Literal_1343 us_void_param) 23)) 97)) (= (to_rep (select (temp___String_Literal_1343 us_void_param) 24)) 116)) (= (to_rep (select (temp___String_Literal_1343 us_void_param) 25)) 101)) (= (to_rep (select (temp___String_Literal_1343 us_void_param) 26)) 32)) (= (to_rep (select (temp___String_Literal_1343 us_void_param) 27)) 110)) (= (to_rep (select (temp___String_Literal_1343 us_void_param) 28)) 111)) (= (to_rep (select (temp___String_Literal_1343 us_void_param) 29)) 116)) (= (to_rep (select (temp___String_Literal_1343 us_void_param) 30)) 32)) (= (to_rep (select (temp___String_Literal_1343 us_void_param) 31)) 102)) (= (to_rep (select (temp___String_Literal_1343 us_void_param) 32)) 111)) (= (to_rep (select (temp___String_Literal_1343 us_void_param) 33)) 114)) (= (to_rep (select (temp___String_Literal_1343 us_void_param) 34)) 32)) (= (to_rep (select (temp___String_Literal_1343 us_void_param) 35)) 65)) (= (to_rep (select (temp___String_Literal_1343 us_void_param) 36)) 100)) (= (to_rep (select (temp___String_Literal_1343 us_void_param) 37)) 109)) (= (to_rep (select (temp___String_Literal_1343 us_void_param) 38)) 105)) (= (to_rep (select (temp___String_Literal_1343 us_void_param) 39)) 110)) (= (to_rep (select (temp___String_Literal_1343 us_void_param) 40)) 105)) (= (to_rep (select (temp___String_Literal_1343 us_void_param) 41)) 115)) (= (to_rep (select (temp___String_Literal_1343 us_void_param) 42)) 116)) (= (to_rep (select (temp___String_Literal_1343 us_void_param) 43)) 114)) (= (to_rep (select (temp___String_Literal_1343 us_void_param) 44)) 97)) (= (to_rep (select (temp___String_Literal_1343 us_void_param) 45)) 116)) (= (to_rep (select (temp___String_Literal_1343 us_void_param) 46)) 111)) (= (to_rep (select (temp___String_Literal_1343 us_void_param) 47)) 114)) :pattern ((temp___String_Literal_1343 us_void_param)))))
...
(define-fun dynamic_invariant7 ((temp___expr_341 Int) (temp___is_init_338 Bool) (temp___skip_constant_339 Bool) (temp___do_toplevel_340 Bool)) Bool (=> (or (= temp___is_init_338 true) (<= 1901 2099)) (in_range11 temp___expr_341)))
(define-fun dynamic_invariant8 ((temp___expr_347 Int) (temp___is_init_344 Bool) (temp___skip_constant_345 Bool) (temp___do_toplevel_346 Bool)) Bool (=> (or (= temp___is_init_344 true) (<= 1 12)) (in_range12 temp___expr_347)))
(define-fun dynamic_invariant9 ((temp___expr_353 Int) (temp___is_init_350 Bool) (temp___skip_constant_351 Bool) (temp___do_toplevel_352 Bool)) Bool (=> (or (= temp___is_init_350 true) (<= 1 31)) (in_range13 temp___expr_353)))
(define-fun dynamic_invariant10 ((temp___expr_377 Int) (temp___is_init_374 Bool) (temp___skip_constant_375 Bool) (temp___do_toplevel_376 Bool)) Bool (=> (or (= temp___is_init_374 true) (<= 0 86399999)) (in_range14 temp___expr_377)))
(define-fun dynamic_invariant11 ((temp___expr_179 Int) (temp___is_init_176 Bool) (temp___skip_constant_177 Bool) (temp___do_toplevel_178 Bool)) Bool (=> (or (= temp___is_init_176 true) (<= 0 40)) (in_range8 temp___expr_179)))
(define-fun dynamic_invariant12 ((temp___expr_200 Int) (temp___is_init_197 Bool) (temp___skip_constant_198 Bool) (temp___do_toplevel_199 Bool)) Bool (=> (or (= temp___is_init_197 true) (<= 0 4294967295)) (in_range9 temp___expr_200)))
(define-fun dynamic_invariant13 ((temp___expr_218 Int) (temp___is_init_215 Bool) (temp___skip_constant_216 Bool) (temp___do_toplevel_217 Bool)) Bool (=> (or (= temp___is_init_215 true) (<= 0 10)) (in_range7 temp___expr_218)))
(define-fun dynamic_invariant14 ((temp___expr_230 Int) (temp___is_init_227 Bool) (temp___skip_constant_228 Bool) (temp___do_toplevel_229 Bool)) Bool (=> (or (= temp___is_init_227 true) (<= 0 4294967295)) (in_range17 temp___expr_230)))
(define-fun dynamic_invariant15 ((temp___expr_236 Int) (temp___is_init_233 Bool) (temp___skip_constant_234 Bool) (temp___do_toplevel_235 Bool)) Bool (=> (or (= temp___is_init_233 true) (<= 0 128)) (in_range18 temp___expr_236)))
(define-fun dynamic_invariant16 ((temp___expr_891 Int) (temp___is_init_888 Bool) (temp___skip_constant_889 Bool) (temp___do_toplevel_890 Bool)) Bool (=> (or (= temp___is_init_888 true) (<= 1 3)) (in_range6 temp___expr_891)))
(define-fun dynamic_invariant17 ((temp___expr_897 Int) (temp___is_init_894 Bool) (temp___skip_constant_895 Bool) (temp___do_toplevel_896 Bool)) Bool (=> (or (= temp___is_init_894 true) (<= 0 5)) (in_range16 temp___expr_897)))
(define-fun dynamic_invariant18 ((temp___expr_321 Int) (temp___is_init_318 Bool) (temp___skip_constant_319 Bool) (temp___do_toplevel_320 Bool)) Bool (=> (or (= temp___is_init_318 true) (<= 0 4294967295)) (in_range10 temp___expr_321)))
...
(assert (= (= (bool__content tokenok) true) (and (and (= (rec__admintoken__valididcertt__valid (us_split_fields__content8 idcert__split_fields)) true) (= (rec__admintoken__validauthcertt__valid (us_split_fields__content7 authcert__split_fields)) true)) (in_range6 (therole (rec__admintoken__validauthcertt__contents (us_split_fields__content7 authcert__split_fields)))))))
(assert (and (in_range5 (int__content tokentry1)) (in_range4 (int__content tokenid1))))
