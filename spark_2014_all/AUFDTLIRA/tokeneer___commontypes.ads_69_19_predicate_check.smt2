...
(define-fun dynamic_invariant ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= 0 4294967295)) (in_range3 temp___expr_136)))
(declare-sort t1 0)
...
(define-fun dynamic_invariant1 ((temp___expr_251 us_t1) (temp___is_init_248 Bool) (temp___skip_constant_249 Bool) (temp___do_toplevel_250 Bool)) Bool (and (=> (not (= temp___skip_constant_249 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_251) (last3 temp___expr_251))) (=> (= temp___do_toplevel_250 true) (=> (= temp___is_init_248 true) (and (= (first5 (of_array2 (to_array1 temp___expr_251) (first3 temp___expr_251) (last3 temp___expr_251))) 1) (<= (last3 temp___expr_251) 1000))))))
(define-fun dynamic_predicate ((temp___255 us_t1)) Bool (and (= (first5 (of_array2 (to_array1 temp___255) (first3 temp___255) (last3 temp___255))) 1) (<= (last3 temp___255) 1000)))
(declare-const x Int)
...
(assert (= (elts (to_string (attr__ATTRIBUTE_IMAGE3 x))) temp___295))
(assert (= (mk1 (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 x))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 x)))))) temp___2951))
(assert (not (dynamic_predicate (mk___t1 temp___295 temp___2951))))
(check-sat)
(exit)
