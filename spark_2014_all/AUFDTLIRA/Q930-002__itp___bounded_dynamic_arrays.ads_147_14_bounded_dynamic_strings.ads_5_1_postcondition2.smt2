...
(define-fun dynamic_invariant4 ((temp___expr_229 Int) (temp___is_init_225 Bool) (temp___skip_constant_226 Bool) (temp___do_toplevel_227 Bool) (temp___do_typ_inv_228 Bool)) Bool (=> (or (= temp___is_init_225 true) (<= 1 2147483647)) (in_range6 temp___expr_229)))
...
(declare-const o7 t1)
(declare-const temp___1216 natural_index)
(declare-const temp___12161 natural_index)
(declare-const temp___12162 (Array Int character))
(declare-const temp___12163 t1)
(declare-const temp___1217 natural_index)
(declare-const temp___12171 natural_index)
(declare-const temp___12172 (Array Int character))
(declare-const temp___12173 t1)
(declare-const o8 natural_index)
(declare-const o9 natural_index)
(declare-const o10 (Array Int character))
(declare-const o11 t1)
(declare-const temp___1219 natural_index)
(declare-const temp___12191 natural_index)
(declare-const temp___12192 (Array Int character))
(declare-const temp___12193 t1)
(declare-const temp___1220 natural_index)
(declare-const temp___12201 natural_index)
(declare-const temp___12202 (Array Int character))
(declare-const temp___12203 t1)
...
(define-fun temp___12194 () us_rep (mk___rep (mk___split_discrs temp___1219) (mk___split_fields temp___12191 (mk___t1 temp___12192 temp___12193))))
(define-fun temp___12164 () us_rep (mk___rep (mk___split_discrs temp___1216) (mk___split_fields temp___12161 (mk___t1 temp___12162 temp___12163))))
(assert (dynamic_invariant1 i52s true false true true))
(assert (in_range5 tail))
...
(assert (<= (+ 1 (length2 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t1 to____split_fields1 to____split_fields2))))) (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity to____split_discrs))))
(assert (and (= bounded_dynamic_strings__append__3__new_length__assume (+ 1 (to_rep2 to____split_fields))) (in_range6 (+ 1 (to_rep2 to____split_fields)))))
(assert (= bounded_dynamic_strings__append__3__new_length__assume new_length))
(assert (in_range6 new_length))
(assert (= (to_rep o) tail))
(assert (and (<= (to_rep1 (first2 to____split_fields2)) new_length) (<= new_length (to_rep1 (last2 to____split_fields2)))))
(assert (= o1 new_length))
...
(assert (= o6 o3))
(assert (= o7 o4))
(assert (= to____split_discrs (mk___split_discrs temp___1216)))
(assert (= temp___12161 o5))
(assert (= temp___12162 o6))
(assert (= temp___12163 o7))
(assert (dynamic_predicate temp___12164))
(assert (= (mk___rep (mk___split_discrs temp___1217) (mk___split_fields temp___12171 (mk___t1 temp___12172 temp___12173))) temp___12164))
...
(assert (= to____split_fields3 (mk___split_fields temp___12171 (mk___t1 temp___12172 temp___12173))))
(assert (= to____split_discrs (mk___split_discrs temp___1217)))
(assert (= (to_rep2 o8) new_length))
(assert (= o8 o9))
(assert (= (rec__bounded_dynamic_strings__sequence__content to____split_fields3) (mk___t1 o10 o11)))
(assert (= to____split_discrs (mk___split_discrs temp___1219)))
(assert (= temp___12191 o9))
(assert (= temp___12192 o10))
(assert (= temp___12193 o11))
(assert (dynamic_predicate temp___12194))
(assert (= (mk___rep (mk___split_discrs temp___1220) (mk___split_fields temp___12201 (mk___t1 temp___12202 temp___12203))) temp___12194))
(assert (= result1 (mk___split_fields__ref to____split_fields3)))
(assert (= to____split_fields4 (mk___split_fields temp___12201 (mk___t1 temp___12202 temp___12203))))
(assert (= to____split_discrs (mk___split_discrs temp___1220)))
(assert (= to____split_fields5 (mk___split_fields__ref to____split_fields4)))
(assert (= to____split_fields6 to____split_fields4))
(assert (not (= (let ((temp___1231 (value (mk___rep to____split_discrs (us_split_fields__content to____split_fields5))))) (bool_eq (elts2 temp___1231) (to_rep1 (first4 (rt2 temp___1231))) (to_rep1 (last4 (rt2 temp___1231))) (let ((temp___1230 (value (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t1 to____split_fields1 to____split_fields2)))))) (ite (= (length3 temp___1230) 0) (singleton1 (of_rep tail) 1) (concat_singleton_right (elts2 temp___1230) (to_rep1 (first4 (rt2 temp___1230))) (to_rep1 (last4 (rt2 temp___1230))) (of_rep tail)))) (to_rep1 (first (let ((temp___1230 (value (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t1 to____split_fields1 to____split_fields2)))))) (ite (= (length3 temp___1230) 0) (mk 1 1) (mk (to_rep1 (first4 (rt2 temp___1230))) (- (+ (to_rep1 (first4 (rt2 temp___1230))) (+ (ite (<= (to_rep1 (first4 (rt2 temp___1230))) (to_rep1 (last4 (rt2 temp___1230)))) (+ (- (to_rep1 (last4 (rt2 temp___1230))) (to_rep1 (first4 (rt2 temp___1230)))) 1) 0) 1)) 1)))))) (to_rep1 (last (let ((temp___1230 (value (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t1 to____split_fields1 to____split_fields2)))))) (ite (= (length3 temp___1230) 0) (mk 1 1) (mk (to_rep1 (first4 (rt2 temp___1230))) (- (+ (to_rep1 (first4 (rt2 temp___1230))) (+ (ite (<= (to_rep1 (first4 (rt2 temp___1230))) (to_rep1 (last4 (rt2 temp___1230)))) (+ (- (to_rep1 (last4 (rt2 temp___1230))) (to_rep1 (first4 (rt2 temp___1230)))) 1) 0) 1)) 1)))))))) true)))
(check-sat)
(exit)
