...
(declare-const o7 t2)
(declare-const temp___1210 natural_index)
(declare-const temp___12101 natural_index)
(declare-const temp___12102 (Array Int character))
(declare-const temp___12103 t2)
(declare-const temp___1211 natural_index)
(declare-const temp___12111 natural_index)
(declare-const temp___12112 (Array Int character))
(declare-const temp___12113 t2)
(declare-const o8 natural_index)
(declare-const o9 natural_index)
(declare-const o10 (Array Int character))
(declare-const o11 t2)
(declare-const temp___1213 natural_index)
(declare-const temp___12131 natural_index)
(declare-const temp___12132 (Array Int character))
(declare-const temp___12133 t2)
(declare-const temp___1214 natural_index)
(declare-const temp___12141 natural_index)
(declare-const temp___12142 (Array Int character))
(declare-const temp___12143 t2)
...
(define-fun temp___12134 () us_rep (mk___rep (mk___split_discrs temp___1213) (mk___split_fields temp___12131 (mk___t2 temp___12132 temp___12133))))
(define-fun temp___12104 () us_rep (mk___rep (mk___split_discrs temp___1210) (mk___split_fields temp___12101 (mk___t2 temp___12102 temp___12103))))
...
(assert (and (<= (to_rep1 (first4 to____split_fields2)) new_length) (<= new_length (to_rep1 (last4 to____split_fields2)))))
...
(assert (= o6 o3))
(assert (= o7 o4))
(assert (= to____split_discrs (mk___split_discrs temp___1210)))
(assert (= temp___12101 o5))
(assert (= temp___12102 o6))
(assert (= temp___12103 o7))
(assert (dynamic_predicate temp___12104))
(assert (= (mk___rep (mk___split_discrs temp___1211) (mk___split_fields temp___12111 (mk___t2 temp___12112 temp___12113))) temp___12104))
...
(assert (= to____split_fields3 (mk___split_fields temp___12111 (mk___t2 temp___12112 temp___12113))))
(assert (= to____split_discrs (mk___split_discrs temp___1211)))
(assert (= (to_rep2 o8) new_length))
(assert (= o8 o9))
(assert (= (rec__bounded_dynamic_strings__sequence__content to____split_fields3) (mk___t2 o10 o11)))
(assert (= to____split_discrs (mk___split_discrs temp___1213)))
(assert (= temp___12131 o9))
(assert (= temp___12132 o10))
(assert (= temp___12133 o11))
(assert (dynamic_predicate temp___12134))
(assert (= (mk___rep (mk___split_discrs temp___1214) (mk___split_fields temp___12141 (mk___t2 temp___12142 temp___12143))) temp___12134))
(assert (= result1 (mk___split_fields__ref to____split_fields3)))
(assert (= to____split_fields4 (mk___split_fields temp___12141 (mk___t2 temp___12142 temp___12143))))
(assert (= to____split_discrs (mk___split_discrs temp___1214)))
(assert (= to____split_fields5 (mk___split_fields__ref to____split_fields4)))
(assert (= to____split_fields6 to____split_fields4))
(assert (not (= (let ((temp___1225 (value (mk___rep to____split_discrs (us_split_fields__content to____split_fields5))))) (bool_eq (elts1 temp___1225) (to_rep1 (first2 (rt1 temp___1225))) (to_rep1 (last2 (rt1 temp___1225))) (let ((temp___1224 (value (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2)))))) (ite (= (length1 temp___1224) 0) (singleton1 (of_rep tail) 1) (concat_singleton_right (elts1 temp___1224) (to_rep1 (first2 (rt1 temp___1224))) (to_rep1 (last2 (rt1 temp___1224))) (of_rep tail)))) (to_rep1 (first (let ((temp___1224 (value (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2)))))) (ite (= (length1 temp___1224) 0) (mk 1 1) (mk (to_rep1 (first2 (rt1 temp___1224))) (- (+ (to_rep1 (first2 (rt1 temp___1224))) (+ (ite (<= (to_rep1 (first2 (rt1 temp___1224))) (to_rep1 (last2 (rt1 temp___1224)))) (+ (- (to_rep1 (last2 (rt1 temp___1224))) (to_rep1 (first2 (rt1 temp___1224)))) 1) 0) 1)) 1)))))) (to_rep1 (last (let ((temp___1224 (value (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2)))))) (ite (= (length1 temp___1224) 0) (mk 1 1) (mk (to_rep1 (first2 (rt1 temp___1224))) (- (+ (to_rep1 (first2 (rt1 temp___1224))) (+ (ite (<= (to_rep1 (first2 (rt1 temp___1224))) (to_rep1 (last2 (rt1 temp___1224)))) (+ (- (to_rep1 (last2 (rt1 temp___1224))) (to_rep1 (first2 (rt1 temp___1224)))) 1) 0) 1)) 1)))))))) true)))
(check-sat)
(exit)
