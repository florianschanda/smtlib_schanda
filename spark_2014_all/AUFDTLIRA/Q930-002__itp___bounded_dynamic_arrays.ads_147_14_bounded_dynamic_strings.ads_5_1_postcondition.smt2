...
(assert (= o6 o3))
(assert (= o7 o4))
(assert (= to____split_discrs (mk___split_discrs temp___1147)))
(assert (= temp___11471 o5))
(assert (= temp___11472 o6))
(assert (= temp___11473 o7))
(assert (dynamic_predicate (mk___rep (mk___split_discrs temp___1147) (mk___split_fields temp___11471 (mk___t2 temp___11472 temp___11473)))))
(assert (= (mk___rep (mk___split_discrs temp___1148) (mk___split_fields temp___11481 (mk___t2 temp___11482 temp___11483))) (mk___rep (mk___split_discrs temp___1147) (mk___split_fields temp___11471 (mk___t2 temp___11472 temp___11473)))))
...
(assert (= to____split_fields3 (mk___split_fields temp___11481 (mk___t2 temp___11482 temp___11483))))
(assert (= to____split_discrs (mk___split_discrs temp___1148)))
(assert (= (to_rep2 o8) new_length))
(assert (= o8 o9))
(assert (= (rec__bounded_dynamic_strings__sequence__content to____split_fields3) (mk___t2 o10 o11)))
(assert (= to____split_discrs (mk___split_discrs temp___1150)))
(assert (= temp___11501 o9))
(assert (= temp___11502 o10))
(assert (= temp___11503 o11))
(assert (dynamic_predicate (mk___rep (mk___split_discrs temp___1150) (mk___split_fields temp___11501 (mk___t2 temp___11502 temp___11503)))))
(assert (= (mk___rep (mk___split_discrs temp___1151) (mk___split_fields temp___11511 (mk___t2 temp___11512 temp___11513))) (mk___rep (mk___split_discrs temp___1150) (mk___split_fields temp___11501 (mk___t2 temp___11502 temp___11503)))))
(assert (= result1 (mk___split_fields__ref to____split_fields3)))
(assert (= to____split_fields4 (mk___split_fields temp___11511 (mk___t2 temp___11512 temp___11513))))
(assert (= to____split_discrs (mk___split_discrs temp___1151)))
(assert (= to____split_fields5 (mk___split_fields__ref to____split_fields4)))
(assert (= to____split_fields6 to____split_fields4))
(assert (not (= (let ((temp___1162 (value (mk___rep to____split_discrs (us_split_fields__content to____split_fields5))))) (bool_eq (elts1 temp___1162) (to_rep1 (first2 (rt1 temp___1162))) (to_rep1 (last2 (rt1 temp___1162))) (let ((temp___1161 (value (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2)))))) (ite (= (length1 temp___1161) 0) (singleton1 (of_rep tail) 1) (concat1 (elts1 temp___1161) (to_rep1 (first2 (rt1 temp___1161))) (to_rep1 (last2 (rt1 temp___1161))) (singleton1 (of_rep tail) 1) 1 1))) (to_rep1 (first (let ((temp___1161 (value (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2)))))) (ite (= (length1 temp___1161) 0) (mk 1 1) (mk (to_rep1 (first2 (rt1 temp___1161))) (- (+ (to_rep1 (first2 (rt1 temp___1161))) (+ (ite (<= (to_rep1 (first2 (rt1 temp___1161))) (to_rep1 (last2 (rt1 temp___1161)))) (+ (- (to_rep1 (last2 (rt1 temp___1161))) (to_rep1 (first2 (rt1 temp___1161)))) 1) 0) 1)) 1)))))) (to_rep1 (last (let ((temp___1161 (value (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2)))))) (ite (= (length1 temp___1161) 0) (mk 1 1) (mk (to_rep1 (first2 (rt1 temp___1161))) (- (+ (to_rep1 (first2 (rt1 temp___1161))) (+ (ite (<= (to_rep1 (first2 (rt1 temp___1161))) (to_rep1 (last2 (rt1 temp___1161)))) (+ (- (to_rep1 (last2 (rt1 temp___1161))) (to_rep1 (first2 (rt1 temp___1161)))) 1) 0) 1)) 1)))))))) true)))
(check-sat)
(exit)
