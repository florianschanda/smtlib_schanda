...
(assert (not (= (length (mk___t temp___610 temp___6101)) 0)))
...
(assert (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE (to_rep2 (rec__ints__approx_int__precision (us_split_fields3 arg)))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE (to_rep2 (rec__ints__approx_int__precision (us_split_fields3 arg)))))))))) (= o44 0)))
(assert (=> (<= (to_rep1 (first temp___6101)) (to_rep1 (last temp___6101))) (= o45 (+ (- (to_rep1 (last temp___6101)) (to_rep1 (first temp___6101))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___6101)) (to_rep1 (last temp___6101)))) (= o45 0)))
(assert (= o46 (+ o45 o44)))
(assert (= o47 (+ (to_rep1 (first temp___6101)) o46)))
(assert (= o48 (- o47 1)))
