...
(assert (=> (and (<= 0 s2) (<= s2 100)) (= o11 (select temp___475 s3))))
(assert (=> (and (<= 0 s2) (<= s2 100)) (and (= o1 (name o11)) (and (in_range1 o1) (= o1 (to_rep o))))))
...
(assert (and (= o8 (to__2 o7)) (and (in_range3 o8) (= o8 (to_rep2 (rec__model__uml_control_flow__to_data (us_split_fields9 o7)))))))
(assert (= o9 (select (map__content2 av6) o8)))
(assert (and (= o10 (name__2 o9)) (and (in_range1 o10) (= o10 (to_rep (rec__model__uml_action__name_data (us_split_fields7 o9)))))))
