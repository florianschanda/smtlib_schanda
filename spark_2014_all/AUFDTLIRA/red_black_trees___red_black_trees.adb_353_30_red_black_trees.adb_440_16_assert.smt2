...
(assert (= n72 1))
(assert (=> (and (<= 1 n72) (<= n72 100)) (= temp___852 n72)))
(assert (=> (and (<= 1 n72) (<= n72 100)) (forall ((i14 Int)) (=> (and (<= 1 i14) (<= i14 100)) (=> (and (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c87b))) i14))) true) (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c87b) i14)))) n73)) (not (= i14 y1))) (not (= i14 c89b))) (= (eq (select (nb_blacks c88b) i14) (select (nb_blacks c87b) i14)) true))))))
(assert (=> (and (<= 1 n72) (<= n72 100)) (=> (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c87b) c89b)))) n73) (and (= (rec__red_black_trees__black_count__status (us_split_fields11 (select (nb_blacks c88b) c89b))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (nb_blacks c88b) c89b)))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (nb_blacks c87b) y1)))))))))
...
(assert (=> (and (<= 1 n72) (<= n72 100)) (and (=> (<= 1 100) (in_range2 n73)) (and (<= 1 n73) (<= n73 100)))))
(assert (=> (and (<= 1 n72) (<= n72 100)) (=> (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c87b) c89b)))) n73) (and (= (rec__red_black_trees__black_count__status (us_split_fields11 (select (nb_blacks c88b) c89b))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (nb_blacks c88b) c89b)))) (- (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (nb_blacks c87b) c89b)))) 1))))))
...
(assert (=> (and (<= 1 n72) (<= n72 100)) (=> (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c87b) (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c88b)) y1))))) n73) (= (rec__red_black_trees__black_count__status (us_split_fields11 (select (nb_blacks c88b) (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c88b)) y1)))) true))))
(assert (=> (and (<= 1 n72) (<= n72 100)) (= n73 100)))
(assert (=> (and (<= 1 n72) (<= n72 100)) (= n77 (mk_int__ref n73))))
(assert (=> (and (<= 1 n72) (<= n72 100)) (= n78 n73)))
(assert (=> (and (<= 1 n72) (<= n72 100)) (= n79 n77)))
(assert (=> (and (<= 1 n72) (<= n72 100)) (= n80 n78)))
(assert (=> (not (and (<= 1 n72) (<= n72 100))) (= n79 (mk_int__ref n72))))
(assert (=> (not (and (<= 1 n72) (<= n72 100))) (= n80 n72)))
(assert (not (= (same_nb_blacks c88b) true)))
(check-sat)
(exit)
