...
(assert (= n10 1))
(assert (=> (and (<= 1 n10) (<= n10 100)) (= temp___852 n10)))
(assert (=> (and (<= 1 n10) (<= n10 100)) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (and (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c87b))) i))) true) (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c87b) i)))) n11)) (not (= i y1))) (not (= i c89b))) (= (eq (select (nb_blacks c88b) i) (select (nb_blacks c87b) i)) true))))))
(assert (=> (and (<= 1 n10) (<= n10 100)) (=> (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c87b) c89b)))) n11) (and (= (rec__red_black_trees__black_count__status (us_split_fields11 (select (nb_blacks c88b) c89b))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (nb_blacks c88b) c89b)))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (nb_blacks c87b) y1)))))))))
...
(assert (=> (and (<= 1 n10) (<= n10 100)) (and (=> (<= 1 100) (in_range2 n11)) (and (<= 1 n11) (<= n11 100)))))
(assert (=> (and (<= 1 n10) (<= n10 100)) (=> (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c87b) c89b)))) n11) (and (= (rec__red_black_trees__black_count__status (us_split_fields11 (select (nb_blacks c88b) c89b))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (nb_blacks c88b) c89b)))) (- (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (nb_blacks c87b) c89b)))) 1))))))
...
(assert (=> (and (<= 1 n10) (<= n10 100)) (= n11 100)))
(assert (=> (and (<= 1 n10) (<= n10 100)) (= n12 (mk_int__ref n11))))
(assert (=> (and (<= 1 n10) (<= n10 100)) (= n13 n11)))
(assert (=> (and (<= 1 n10) (<= n10 100)) (= n14 n12)))
(assert (=> (and (<= 1 n10) (<= n10 100)) (= n15 n13)))
(assert (=> (not (and (<= 1 n10) (<= n10 100))) (= n14 (mk_int__ref n10))))
(assert (=> (not (and (<= 1 n10) (<= n10 100))) (= n15 n10)))
