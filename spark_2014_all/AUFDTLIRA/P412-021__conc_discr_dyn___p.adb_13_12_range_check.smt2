...
(define-fun dynamic_invariant1 ((temp___expr_187 us_rep2) (temp___is_init_184 Bool) (temp___skip_constant_185 Bool) (temp___do_toplevel_186 Bool)) Bool (let ((temp___189 (rec__p__pp__c (us_split_discrs4 temp___expr_187)))) (and (in_range4 (to_rep temp___189) (to_base (rec__p__pp__r (us_split_fields5 temp___expr_187)))) (and (dynamic_property3 1 (to_rep temp___189) (first3 (rec__p__my_rec__content1 (us_split_fields3 (rec__p__pp__r (us_split_fields5 temp___expr_187))))) (last3 (rec__p__my_rec__content1 (us_split_fields3 (rec__p__pp__r (us_split_fields5 temp___expr_187)))))) (and (= (first3 (rec__p__my_rec__content1 (us_split_fields3 (rec__p__pp__r (us_split_fields5 temp___expr_187))))) 1) (= (last3 (rec__p__my_rec__content1 (us_split_fields3 (rec__p__pp__r (us_split_fields5 temp___expr_187))))) (to_rep temp___189)))))))
...
(define-fun to_base2 ((a us_rep4)) us_rep (mk___rep (us_split_discrs6 a) (mk___split_fields (let ((temp___136 (rec__p__my_rec__content2 (us_split_fields9 a)))) (of_array (to_array2 temp___136) (first5 temp___136) (last5 temp___136))))))
(define-fun of_base2 ((r us_rep)) us_rep4 (mk___rep4 (us_split_discrs1 r) (mk___split_fields4 (let ((temp___135 (rec__p__my_rec__content (us_split_fields1 r)))) (of_array2 (to_array temp___135) (first1 temp___135) (last1 temp___135))))))
...
(assert (forall ((temp___212 Int) (temp___213 Int) (temp___214 Int)) (let ((temp___211 (temp___210 temp___212 temp___213 temp___214))) (and (=> (dynamic_property8 1 2147483647 temp___213 temp___214) (and (= (first7 temp___211) temp___213) (= (last7 temp___211) temp___214))) (forall ((temp___215 Int)) (= (select (to_array3 temp___211) temp___215) (of_rep temp___212)))))))
(define-fun dynamic_invariant2 ((temp___expr_201 us_rep3) (temp___is_init_198 Bool) (temp___skip_constant_199 Bool) (temp___do_toplevel_200 Bool)) Bool (and (=> (not (= temp___skip_constant_199 true)) (in_range5 (of_int 1) 10 (to_base1 temp___expr_201))) (let ((temp___203 (rec__p__pp__c (us_split_discrs5 temp___expr_201)))) (and (in_range4 (to_rep temp___203) (to_base (rec__p__pp__r1 (us_split_fields7 temp___expr_201)))) (and (dynamic_property3 1 (to_rep temp___203) (first3 (rec__p__my_rec__content1 (us_split_fields3 (rec__p__pp__r1 (us_split_fields7 temp___expr_201))))) (last3 (rec__p__my_rec__content1 (us_split_fields3 (rec__p__pp__r1 (us_split_fields7 temp___expr_201)))))) (and (= (first3 (rec__p__my_rec__content1 (us_split_fields3 (rec__p__pp__r1 (us_split_fields7 temp___expr_201))))) 1) (= (last3 (rec__p__my_rec__content1 (us_split_fields3 (rec__p__pp__r1 (us_split_fields7 temp___expr_201))))) (to_rep temp___203))))))))
(define-fun default_initial_assumption ((temp___expr_206 us_rep3) (temp___skip_top_level_207 Bool)) Bool (let ((temp___209 (rec__p__pp__c (us_split_discrs5 temp___expr_206)))) (and (and (and (= (rec__p__pp__b (us_split_discrs5 temp___expr_206)) (of_int 1)) (= (to_rep (rec__p__pp__c (us_split_discrs5 temp___expr_206))) 10)) (= (rec__p__pp__dummy1 (us_split_fields7 temp___expr_206)) (of_int 1))) (= (rec__p__pp__r1 (us_split_fields7 temp___expr_206)) (of_base (to_base2 (mk___rep4 (mk___split_discrs temp___209) (mk___split_fields4 (let ((temp___216 (temp___210 0 1 (to_rep temp___209)))) (of_array2 (to_array3 temp___216) (first7 temp___216) (last7 temp___216)))))))))))
...
(declare-const p__d__assume Bool)
(declare-const o15 us_rep3)
(declare-const o16 us_rep2)
(declare-const p__e__assume Bool)
(declare-const x__split_fields4 us_split_fields6)
(declare-const x__split_fields5 us_split_fields6)
(declare-const x__split_fields6 us_split_fields6)
