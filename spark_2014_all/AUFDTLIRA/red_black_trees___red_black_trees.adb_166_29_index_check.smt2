...
(declare-const o19 us_rep6)
(declare-const o20 us_split_fields10)
(declare-const o21 extended_index_type)
(declare-const o22 Int)
(declare-const o23 Int)
(declare-const o24 Int)
(declare-const o25 us_rep6)
(declare-const o26 us_split_fields10)
...
(assert (= o29 j))
(assert (= o30 (select m o29)))
(assert (= o31 (us_split_fields1 o30)))
(assert (= result5 (rec__tree_model__path_type__k o31)))
(assert (=> (= result5 true) (and (= o23 j) (in_range2 j))))
(assert (=> (= result5 true) (and (= o24 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) o23 0)) (and (in_range3 o24) (= o24 (peek1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) o23 0))))))
(assert (=> (= result5 true) (= o25 (select res3 o24))))
(assert (=> (= result5 true) (= o26 (us_split_fields11 o25))))
(assert (=> (= result5 true) (= o27 (rec__red_black_trees__black_count__depth o26))))
(assert (=> (= result5 true) (= o28 (to_rep o27))))
(assert (=> (= result5 true) (= result4 (ite (<= o28 n2) true false))))
(assert (=> (not (= result5 true)) (= result4 false)))
(assert (=> (= result4 true) (and (= o17 j) (in_range2 j))))
(assert (=> (= result4 true) (and (= o18 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) o17 1)) (and (in_range3 o18) (= o18 (peek1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) o17 1))))))
(assert (=> (= result4 true) (= o19 (select res3 o18))))
(assert (=> (= result4 true) (= o20 (us_split_fields11 o19))))
(assert (=> (= result4 true) (= o21 (rec__red_black_trees__black_count__depth o20))))
(assert (=> (= result4 true) (= o22 (to_rep o21))))
(assert (=> (= result4 true) (= result3 (ite (<= o22 n2) true false))))
