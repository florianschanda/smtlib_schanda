...
(assert (<= 1 j6))
(assert (<= j6 (- i6 1)))
(assert (and (<= 1 j6) (<= j6 100)))
(assert (= o135 j6))
(assert (= o136 (select m o135)))
(assert (= o137 (us_split_fields1 o136)))
(assert (= result8 (rec__tree_model__path_type__k o137)))
(assert (=> (= result8 true) (and (= o129 j6) (in_range2 j6))))
(assert (=> (= result8 true) (and (= o130 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) o129 0)) (and (in_range3 o130) (= o130 (peek1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) o129 0))))))
(assert (=> (= result8 true) (= o131 (select res3 o130))))
(assert (=> (= result8 true) (= o132 (us_split_fields11 o131))))
(assert (=> (= result8 true) (= o133 (rec__red_black_trees__black_count__depth o132))))
(assert (=> (= result8 true) (= o134 (to_rep o133))))
(assert (=> (= result8 true) (= result7 (ite (<= o134 n2) true false))))
(assert (=> (not (= result8 true)) (= result7 false)))
(assert (=> (= result7 true) (and (= o123 j6) (in_range2 j6))))
(assert (=> (= result7 true) (and (= o124 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) o123 1)) (and (in_range3 o124) (= o124 (peek1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) o123 1))))))
(assert (=> (= result7 true) (= o125 (select res3 o124))))
(assert (=> (= result7 true) (= o126 (us_split_fields11 o125))))
(assert (=> (= result7 true) (= o127 (rec__red_black_trees__black_count__depth o126))))
(assert (=> (= result7 true) (= o128 (to_rep o127))))
(assert (=> (= result7 true) (= result6 (ite (<= o128 n2) true false))))
