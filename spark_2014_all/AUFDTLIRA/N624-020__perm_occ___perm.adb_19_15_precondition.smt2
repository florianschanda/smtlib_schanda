...
(assert (and (= o5 (remove_last b)) (and (dynamic_invariant1 o5 true false true true) (and (= (elts b) o3) (= (mk (to_rep1 (first2 (mk1 (to_rep1 (first (rt b))) (- (to_rep1 (last (rt b))) 1)))) (to_rep1 (last2 (mk1 (to_rep1 (first (rt b))) (- (to_rep1 (last (rt b))) 1))))) o4)))))
