...
(define-fun dynamic_invariant1 ((temp___expr_516 Int) (temp___is_init_513 Bool) (temp___skip_constant_514 Bool) (temp___do_toplevel_515 Bool)) Bool (=> (or (= temp___is_init_513 true) (<= 0 1000)) (in_range4 temp___expr_516)))
...
(define-fun dynamic_invariant2 ((temp___expr_563 Int) (temp___is_init_560 Bool) (temp___skip_constant_561 Bool) (temp___do_toplevel_562 Bool)) Bool (=> (or (= temp___is_init_560 true) (<= 0 3)) (in_range6 temp___expr_563)))
(assert true)
...
(declare-const o2 nat_type)
(declare-const o3 (Array Int character))
(declare-const o4 nat_type)
(declare-const o5 nat_type)
(declare-const o6 nat_type)
(declare-const temp___575 (Array Int character))
(declare-const temp___5751 nat_type)
(declare-const temp___5752 nat_type)
(declare-const temp___5753 nat_type)
...
(declare-const result4 nat_type)
...
(define-fun cur_pump__split_fields20 () us_split_fields (mk___split_fields cur_pump__split_fields8 cur_pump__split_fields9 cur_pump__split_fields10 cur_pump__split_fields11))
...
(assert (=> (= result true) (= (mk_int__ref result1) (mk_int__ref cur_state))))
(assert (=> (= result true) (= cur_state2 0)))
(assert (=> (= result true) (and (= o (+ outstanding (to_rep2 cur_pump__split_fields2))) (in_range (+ outstanding (to_rep2 cur_pump__split_fields2))))))
(assert (=> (= result true) (= (mk_int__ref result2) (mk_int__ref outstanding))))
(assert (=> (= result true) (= outstanding2 o)))
(assert (=> (= result true) (and (= o1 (- (to_rep2 cur_pump__split_fields1) 1)) (in_range4 (- (to_rep2 cur_pump__split_fields1) 1)))))
(assert (=> (= result true) (= (to_rep2 o2) o1)))
(assert (=> (= result true) (= cur_pump__split_fields o3)))
(assert (=> (= result true) (= o2 o4)))
(assert (=> (= result true) (= cur_pump__split_fields2 o5)))
(assert (=> (= result true) (= cur_pump__split_fields3 o6)))
(assert (=> (= result true) (= temp___575 o3)))
(assert (=> (= result true) (= temp___5751 o4)))
(assert (=> (= result true) (= temp___5752 o5)))
(assert (=> (= result true) (= temp___5753 o6)))
(assert (=> (= result true) (= (mk___split_fields__ref (mk___split_fields result3 result4 result5 result6)) (mk___split_fields__ref (mk___split_fields cur_pump__split_fields cur_pump__split_fields1 cur_pump__split_fields2 cur_pump__split_fields3)))))
(assert (=> (= result true) (= temp___575 cur_pump__split_fields8)))
(assert (=> (= result true) (= temp___5751 cur_pump__split_fields9)))
(assert (=> (= result true) (= temp___5752 cur_pump__split_fields10)))
(assert (=> (= result true) (= temp___5753 cur_pump__split_fields11)))
(assert (=> (not (= result true)) (= outstanding2 outstanding)))
(assert (=> (not (= result true)) (= cur_pump__split_fields cur_pump__split_fields8)))
(assert (=> (not (= result true)) (= cur_pump__split_fields1 cur_pump__split_fields9)))
(assert (=> (not (= result true)) (= cur_pump__split_fields2 cur_pump__split_fields10)))
(assert (=> (not (= result true)) (= cur_pump__split_fields3 cur_pump__split_fields11)))
(assert (=> (not (= result true)) (= cur_state2 cur_state)))
(assert (=> (not (= result true)) (= outstanding2 outstanding1)))
(assert (=> (not (= result true)) (= cur_pump__split_fields20 (mk___split_fields cur_pump__split_fields4 cur_pump__split_fields5 cur_pump__split_fields6 cur_pump__split_fields7))))
...
(assert (= (mk___split_fields cur_pump__split_fields16 cur_pump__split_fields17 cur_pump__split_fields18 cur_pump__split_fields19) cur_pump__split_fields20))
(assert (= cur_state4 cur_state2))
(assert (and (= result7 (is_pumping cur_state3)) (= (= result7 true) (= cur_state3 0))))
(assert (= result7 true))
(assert (and (= o7 (get_cur_price (mk___split_fields cur_pump__split_fields12 cur_pump__split_fields13 cur_pump__split_fields14 cur_pump__split_fields15))) (and (in_range4 o7) (= o7 (to_rep2 cur_pump__split_fields14)))))
(assert (= o8 (+ (get_outstanding outstanding) o7)))
