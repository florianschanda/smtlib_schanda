...
(define-fun dynamic_invariant1 ((temp___expr_581 Int) (temp___is_init_577 Bool) (temp___skip_constant_578 Bool) (temp___do_toplevel_579 Bool) (temp___do_typ_inv_580 Bool)) Bool (=> (or (= temp___is_init_577 true) (<= 0 1000)) (in_range4 temp___expr_581)))
...
(define-fun dynamic_invariant2 ((temp___expr_631 Int) (temp___is_init_627 Bool) (temp___skip_constant_628 Bool) (temp___do_toplevel_629 Bool) (temp___do_typ_inv_630 Bool)) Bool (=> (or (= temp___is_init_627 true) (<= 0 3)) (in_range6 temp___expr_631)))
(assert true)
...
(declare-const temp___643 (Array Int character))
(declare-const temp___6431 nat_type)
(declare-const temp___6432 nat_type)
(declare-const temp___6433 nat_type)
...
(assert (=> (= result true) (= temp___643 o3)))
(assert (=> (= result true) (= temp___6431 o4)))
(assert (=> (= result true) (= temp___6432 o5)))
(assert (=> (= result true) (= temp___6433 o6)))
...
(assert (=> (= result true) (= temp___643 cur_pump__split_fields8)))
(assert (=> (= result true) (= temp___6431 cur_pump__split_fields9)))
(assert (=> (= result true) (= temp___6432 cur_pump__split_fields10)))
(assert (=> (= result true) (= temp___6433 cur_pump__split_fields11)))
