...
(declare-const temp___636 (Array Int character))
(declare-const temp___6361 nat_type)
(declare-const temp___6362 nat_type)
(declare-const temp___6363 nat_type)
...
(assert (=> (= result true) (= temp___636 o3)))
(assert (=> (= result true) (= temp___6361 o4)))
(assert (=> (= result true) (= temp___6362 o5)))
(assert (=> (= result true) (= temp___6363 o6)))
...
(assert (=> (= result true) (= temp___636 cur_pump__split_fields8)))
(assert (=> (= result true) (= temp___6361 cur_pump__split_fields9)))
(assert (=> (= result true) (= temp___6362 cur_pump__split_fields10)))
(assert (=> (= result true) (= temp___6363 cur_pump__split_fields11)))
