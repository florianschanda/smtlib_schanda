...
(declare-fun to_rep2 (nat_type) Int)
...
(assert (forall ((pumpunit__outstanding Int)) (! (=> (dynamic_invariant pumpunit__outstanding true true true) (dynamic_invariant (get_outstanding pumpunit__outstanding) true false true)) :pattern ((get_outstanding pumpunit__outstanding)))))
(assert (forall ((pumpunit__outstanding Int)) (! (=> (dynamic_invariant pumpunit__outstanding true true true) (= (get_outstanding pumpunit__outstanding) pumpunit__outstanding)) :pattern ((get_outstanding pumpunit__outstanding)))))
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-fun get_cur_price (us_split_fields) Int)
(declare-fun get_cur_price__function_guard (Int us_split_fields) Bool)
(define-fun dynamic_invariant1 ((temp___expr_510 Int) (temp___is_init_507 Bool) (temp___skip_constant_508 Bool) (temp___do_toplevel_509 Bool)) Bool (=> (or (= temp___is_init_507 true) (<= 0 1000)) (in_range4 temp___expr_510)))
(assert (forall ((pumpunit__cur_pump__fields us_split_fields)) (! (dynamic_invariant1 (get_cur_price pumpunit__cur_pump__fields) true false true) :pattern ((get_cur_price pumpunit__cur_pump__fields)))))
...
(assert (forall ((pumpunit__cur_pump__fields us_split_fields)) (! (dynamic_invariant1 (get_cur_resevoir pumpunit__cur_pump__fields) true false true) :pattern ((get_cur_resevoir pumpunit__cur_pump__fields)))))
...
(declare-fun user_eq9 (internal_state internal_state) Bool)
(declare-const dummy9 internal_state)
...
(define-fun dynamic_invariant2 ((temp___expr_557 Int) (temp___is_init_554 Bool) (temp___skip_constant_555 Bool) (temp___do_toplevel_556 Bool)) Bool (=> (or (= temp___is_init_554 true) (<= 0 3)) (in_range6 temp___expr_557)))
(assert true)
...
(declare-const o5 nat_type)
(declare-const o6 (Array Int character))
(declare-const o7 nat_type)
(declare-const o8 nat_type)
(declare-const o9 nat_type)
(declare-const temp___569 (Array Int character))
(declare-const temp___5691 nat_type)
(declare-const temp___5692 nat_type)
(declare-const temp___5693 nat_type)
...
(assert (and (= result1 (is_ready cur_state)) (= (= result1 true) (= cur_state 1))))
(assert (=> (= result1 true) (= (mk_int__ref result2) (mk_int__ref cur_state))))
(assert (=> (= result1 true) (= cur_state2 0)))
(assert (=> (= result1 true) (and (= o3 (+ outstanding (to_rep2 cur_pump__split_fields2))) (in_range (+ outstanding (to_rep2 cur_pump__split_fields2))))))
(assert (=> (= result1 true) (= (mk_int__ref result3) (mk_int__ref outstanding))))
(assert (=> (= result1 true) (= outstanding2 o3)))
(assert (=> (= result1 true) (and (= o4 (- (to_rep2 cur_pump__split_fields1) 1)) (in_range4 (- (to_rep2 cur_pump__split_fields1) 1)))))
(assert (=> (= result1 true) (= (to_rep2 o5) o4)))
(assert (=> (= result1 true) (= cur_pump__split_fields o6)))
(assert (=> (= result1 true) (= o5 o7)))
(assert (=> (= result1 true) (= cur_pump__split_fields2 o8)))
(assert (=> (= result1 true) (= cur_pump__split_fields3 o9)))
(assert (=> (= result1 true) (= temp___569 o6)))
(assert (=> (= result1 true) (= temp___5691 o7)))
(assert (=> (= result1 true) (= temp___5692 o8)))
(assert (=> (= result1 true) (= temp___5693 o9)))
(assert (=> (= result1 true) (= (mk___split_fields__ref (mk___split_fields result4 result5 result6 result7)) (mk___split_fields__ref (mk___split_fields cur_pump__split_fields cur_pump__split_fields1 cur_pump__split_fields2 cur_pump__split_fields3)))))
(assert (=> (= result1 true) (= temp___569 cur_pump__split_fields8)))
(assert (=> (= result1 true) (= temp___5691 cur_pump__split_fields9)))
(assert (=> (= result1 true) (= temp___5692 cur_pump__split_fields10)))
(assert (=> (= result1 true) (= temp___5693 cur_pump__split_fields11)))
(assert (=> (not (= result1 true)) (= outstanding2 outstanding)))
(assert (=> (not (= result1 true)) (= cur_pump__split_fields cur_pump__split_fields8)))
(assert (=> (not (= result1 true)) (= cur_pump__split_fields1 cur_pump__split_fields9)))
(assert (=> (not (= result1 true)) (= cur_pump__split_fields2 cur_pump__split_fields10)))
(assert (=> (not (= result1 true)) (= cur_pump__split_fields3 cur_pump__split_fields11)))
(assert (=> (not (= result1 true)) (= cur_state2 cur_state)))
(assert (=> (not (= result1 true)) (= outstanding2 outstanding1)))
(assert (=> (not (= result1 true)) (= (mk___split_fields cur_pump__split_fields8 cur_pump__split_fields9 cur_pump__split_fields10 cur_pump__split_fields11) (mk___split_fields cur_pump__split_fields4 cur_pump__split_fields5 cur_pump__split_fields6 cur_pump__split_fields7))))
(assert (=> (not (= result1 true)) (= cur_state2 cur_state1)))
(assert (= outstanding2 outstanding3))
(assert (= cur_pump__split_fields12 cur_pump__split_fields8))
(assert (= cur_pump__split_fields13 cur_pump__split_fields9))
(assert (= cur_pump__split_fields14 cur_pump__split_fields10))
(assert (= cur_pump__split_fields15 cur_pump__split_fields11))
(assert (= cur_state2 cur_state3))
(assert (= outstanding4 outstanding2))
(assert (= (mk___split_fields cur_pump__split_fields16 cur_pump__split_fields17 cur_pump__split_fields18 cur_pump__split_fields19) (mk___split_fields cur_pump__split_fields8 cur_pump__split_fields9 cur_pump__split_fields10 cur_pump__split_fields11)))
(assert (= cur_state4 cur_state2))
(assert (and (= result8 (is_pumping cur_state3)) (= (= result8 true) (= cur_state3 0))))
(assert (= result8 true))
(assert (and (= o10 (get_cur_price (mk___split_fields cur_pump__split_fields12 cur_pump__split_fields13 cur_pump__split_fields14 cur_pump__split_fields15))) (and (in_range4 o10) (= o10 (to_rep2 cur_pump__split_fields14)))))
(assert (= o11 (+ (get_outstanding outstanding) o10)))
