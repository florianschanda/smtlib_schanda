...
(define-fun dynamic_invariant ((temp___expr_1212 Int) (temp___is_init_1208 Bool) (temp___skip_constant_1209 Bool) (temp___do_toplevel_1210 Bool) (temp___do_typ_inv_1211 Bool)) Bool (=> (or (= temp___is_init_1208 true) (<= 0 1)) (in_range3 temp___expr_1212)))
(declare-sort t2 0)
...
(assert (forall ((x Int)) (! (=> (dynamic_invariant x true true true true) (dynamic_invariant1 (accesspolicyt_image x) true false true true)) :pattern ((accesspolicyt_image x)))))
(assert (forall ((x Int)) (! (=> (dynamic_invariant x true true true true) (= (accesspolicyt_image x) (let ((temp___1218 (to_string (attr__ATTRIBUTE_IMAGE3 x)))) (of_array1 (to_array temp___1218) (first1 temp___1218) (last1 temp___1218))))) :pattern ((accesspolicyt_image x)))))
...
(define-fun dynamic_invariant6 ((temp___expr_1874 Int) (temp___is_init_1870 Bool) (temp___skip_constant_1871 Bool) (temp___do_toplevel_1872 Bool) (temp___do_typ_inv_1873 Bool)) Bool (=> (or (= temp___is_init_1870 true) (<= 1 12)) (in_range4 temp___expr_1874)))
(assert (forall ((temp___2012 Int)) (=> (dynamic_invariant3 temp___2012 true true true true) (forall ((temp___2013 Int)) (= (to_rep (select (screen__writeconfigdata__accesspolicystring__result__aggregate_def temp___2012) temp___2013)) temp___2012)))))
...
(declare-const temp___2009 (Array Int character))
(declare-const temp___20091 t1)
...
(define-fun temp___20092 () us_t1 (mk___t1 temp___2009 temp___20091))
(assert (in_range3 value))
(assert (and (= temp___20092 (accesspolicyt_image value)) (and (dynamic_invariant1 temp___20092 true false true true) (= temp___20092 (let ((temp___1216 (to_string (attr__ATTRIBUTE_IMAGE3 value)))) (mk___t1 (elts temp___1216) (mk1 (to_rep1 (first (rt temp___1216))) (to_rep1 (last (rt temp___1216))))))))))
(assert (= temp___2009 screen__writeconfigdata__accesspolicystring__data__assume))
(assert (= (mk (to_rep1 (first2 temp___20091)) (to_rep1 (last2 temp___20091))) screen__writeconfigdata__accesspolicystring__data__assume1))
(assert (= result data))
