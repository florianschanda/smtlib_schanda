...
(assert true)
(assert (forall ((a1 us_rep)) (forall ((v1 Int) (low Int) (up Int)) (! (= (= (not_in a1 v1 low up) true) (or (< (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a1))) up) (forall ((j Int)) (=> (and (<= low j) (<= j up)) (not (= (to_rep1 (let ((temp___600 (rec__simple_unc_arrays__table__v (us_split_fields1 a1)))) (select (to_array temp___600) j))) v1)))))) :pattern ((not_in a1 v1 low up))))))
...
(assert (= i1 1))
(assert (<= 1 i1))
(assert (<= i1 (to_rep2 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a)))))))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- i2 1))) (not (= (to_rep1 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) j1)) v)))))
(assert (and (and (=> (<= 0 2147483647) (in_range1 pos2)) (=> (<= 1 (to_rep2 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a)))))) (dynamic_property2 1 (to_rep2 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))) i2))) (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a)))))))))
...
(assert (= result2 (ite (= o2 v) true false)))
(assert (not (= result2 true)))
(assert (= pos3 pos2))
(assert (not (= i2 (to_rep2 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))))))
(assert (= result4 i2))
(assert (= i3 (+ i2 1)))
(declare-const j1 Int)
(assert (<= 1 j1))
(assert (<= j1 (- i3 1)))
(assert (not (not (= (to_rep1 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) j1)) v))))
(check-sat)
(exit)
