...
(declare-const temp___482 (Array Int element))
(declare-const temp___4821 less_than_max)
(declare-const temp___4822 us_private)
(declare-const temp___4823 Int)
...
(assert (= temp___4821 o2))
(assert (= temp___4822 o3))
(assert (= s__attr__tag temp___4823))
(assert (= result s__split_fields))
(assert (= result1 s__split_fields1))
(assert (= result2 s__split_fields2))
(assert (= temp___482 s__split_fields3))
(assert (= temp___4821 s__split_fields4))
(assert (= temp___4822 s__split_fields5))
...
(assert (not (= (is_empty (mk___rep (mk___split_fields s__split_fields6 s__split_fields7 s__split_fields8) s__attr__tag)) true)))
(check-sat)
(exit)
