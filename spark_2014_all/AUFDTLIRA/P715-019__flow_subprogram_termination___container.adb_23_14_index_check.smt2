...
(define-fun dynamic_invariant2 ((temp___expr_580 Int) (temp___is_init_576 Bool) (temp___skip_constant_577 Bool) (temp___do_toplevel_578 Bool) (temp___do_typ_inv_579 Bool)) Bool (=> (or (= temp___is_init_576 true) (<= 1 200)) (in_range2 temp___expr_580)))
(assert (= (has_element c p) true))
(assert (not (<= 1 (to_rep (rec__container__cursor__index (us_split_fields3 p))))))
(check-sat)
(exit)
