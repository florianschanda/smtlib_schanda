...
(assert (and (<= (to_rep1 (first (rt b))) i1) (<= i1 (to_rep1 (last (rt b))))))
(assert (= o i1))
(assert (= o1 (select (elts b) o)))
(assert (= o2 (to_rep o1)))
(assert (= o3 (ite (= (to_rep (select (elts a) i1)) o2) true false)))
(assert (= result3 (ite (not (= o3 true)) true false)))
(assert (not (= result3 true)))
(assert (= location2 location1))
(assert (= found2 found1))
(assert (and (forall ((j1 Int)) (=> (and (<= (to_rep1 (first (rt a))) j1) (<= j1 i2)) (= (to_rep (select (elts a) j1)) (to_rep (select (elts b) j1))))) (not (= found3 true))))
(assert (and (and (=> (<= (- 2147483648) 2147483647) (in_range3 location3)) (=> (<= (to_rep1 (first (rt a))) (to_rep1 (last (rt a)))) (dynamic_property1 (to_rep1 (first (rt a))) (to_rep1 (last (rt a))) i2))) (and (<= (to_rep1 (first (rt a))) i2) (<= i2 (to_rep1 (last (rt a)))))))
