...
(define-fun dynamic_invariant1 ((temp___expr_148 us_t) (temp___is_init_145 Bool) (temp___skip_constant_146 Bool) (temp___do_toplevel_147 Bool)) Bool (=> (not (= temp___skip_constant_146 true)) (dynamic_property (- 2147483648) 2147483647 (first1 temp___expr_148) (last1 temp___expr_148))))
...
(define-fun dynamic_invariant2 ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= (- 2147483648) 2147483647)) (in_range1 temp___expr_136)))
...
(declare-const o8 value_type)
(declare-const o9 Int)
(declare-const o10 Bool)
(declare-const o11 Int)
(declare-const o12 value_type)
...
(declare-const o17 value_type)
(declare-const o18 Int)
(declare-const o19 Bool)
(declare-const i2 Int)
(declare-const o20 Int)
(declare-const o21 value_type)
...
(assert (= i3 (to_rep1 (first (rt a)))))
(assert (<= (to_rep1 (first (rt a))) i3))
(assert (<= i3 (to_rep1 (last (rt a)))))
(assert (and (<= (to_rep1 (first (rt b))) i3) (<= i3 (to_rep1 (last (rt b))))))
(assert (= o i3))
(assert (= o1 (select (elts b) o)))
(assert (= o2 (to_rep o1)))
(assert (= o3 (ite (= (to_rep (select (elts a) i3)) o2) true false)))
(assert (= result3 (ite (not (= o3 true)) true false)))
(assert (not (= result3 true)))
(assert (= location2 location1))
(assert (= found2 found1))
(assert (and (forall ((j1 Int)) (=> (and (<= (to_rep1 (first (rt a))) j1) (<= j1 i4)) (= (to_rep (select (elts a) j1)) (to_rep (select (elts b) j1))))) (not (= found3 true))))
(assert (and (and (=> (<= (- 2147483648) 2147483647) (in_range3 location3)) (=> (<= (to_rep1 (first (rt a))) (to_rep1 (last (rt a)))) (dynamic_property1 (to_rep1 (first (rt a))) (to_rep1 (last (rt a))) i4))) (and (<= (to_rep1 (first (rt a))) i4) (<= i4 (to_rep1 (last (rt a)))))))
(assert (<= (to_rep1 (first (rt a))) j))
(assert (<= j i4))
(assert (not (<= (to_rep1 (first (rt b))) j)))
(check-sat)
(exit)
