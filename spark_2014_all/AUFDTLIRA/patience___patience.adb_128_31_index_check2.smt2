...
(assert (= o118 (ite (<= o117 (- (to_rep (rec__patience__state__numelts (us_split_fields__content s__split_fields20))) 1)) true false)))
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o112 i1))
(assert (= o113 (select (rec__patience__state__preds (us_split_fields__content s__split_fields20)) o112)))
(assert (= o114 (to_rep o113)))
(assert (= o119 (ite (<= (- 1) o114) true false)))
(assert (= result27 (ite (= o119 true) o118 false)))
(assert (=> (= result27 true) (and (<= 0 i1) (<= i1 99))))
(assert (=> (= result27 true) (= o109 i1)))
(assert (=> (= result27 true) (= o110 (select (rec__patience__state__preds (us_split_fields__content s__split_fields20)) o109))))
(assert (=> (= result27 true) (= o111 (to_rep o110))))
(assert (=> (= result27 true) (= result26 (ite (< o111 i1) true false))))
...
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o106 i1))
(assert (= o107 (select (rec__patience__state__values (us_split_fields__content s__split_fields20)) o106)))
