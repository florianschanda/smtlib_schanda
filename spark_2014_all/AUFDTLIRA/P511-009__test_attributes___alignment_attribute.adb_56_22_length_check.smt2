...
(define-fun bool_eq ((a (Array Int integer)) (a__first Int) (a__last Int) (b (Array Int integer)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_134 Int)) (=> (and (<= a__first temp___idx_134) (<= temp___idx_134 a__last)) (= (to_rep (select a temp___idx_134)) (to_rep (select b (+ (- b__first a__first) temp___idx_134))))))) true false))
...
(declare-fun concat2 ((Array Int us_t) Int Int (Array Int us_t) Int Int) (Array Int us_t))
(assert (forall ((a (Array Int us_t)) (b (Array Int us_t))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (forall ((i Int)) (! (and (=> (and (<= a_first i) (<= i a_last)) (= (select (concat2 a a_first a_last b b_first b_last) i) (select a i))) (=> (< a_last i) (= (select (concat2 a a_first a_last b b_first b_last) i) (select b (+ (- i a_last) (- b_first 1)))))) :pattern ((select (concat2 a a_first a_last b b_first b_last) i)))))))
(declare-fun singleton2 (us_t Int) (Array Int us_t))
(assert (forall ((v us_t)) (forall ((i Int)) (! (= (select (singleton2 v i) i) v) :pattern ((select (singleton2 v i) i))))))
(define-fun bool_eq2 ((a (Array Int us_t)) (a__first Int) (a__last Int) (b (Array Int us_t)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_135 Int)) (=> (and (<= a__first temp___idx_135) (<= temp___idx_135 a__last)) (= (bool_eq1 (select a temp___idx_135) (select b (+ (- b__first a__first) temp___idx_135))) true)))) true false))
(assert (forall ((a (Array Int us_t)) (b (Array Int us_t))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq2 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_135 Int)) (=> (and (<= a__first temp___idx_135) (<= temp___idx_135 a__last)) (= (bool_eq1 (select a temp___idx_135) (select b (+ (- b__first a__first) temp___idx_135))) true))))))))
...
(define-fun dynamic_invariant1 ((temp___expr_233 (Array Int us_t)) (temp___is_init_230 Bool) (temp___skip_constant_231 Bool) (temp___do_toplevel_232 Bool)) Bool (forall ((temp___234 Int)) (=> (and (<= 1 temp___234) (<= temp___234 1)) (and (dynamic_property1 1 x (first1 (select temp___expr_233 temp___234)) (last1 (select temp___expr_233 temp___234))) (and (= (first1 (select temp___expr_233 temp___234)) 1) (= (last1 (select temp___expr_233 temp___234)) x))))))
...
(assert (forall ((temp___267 Int) (temp___268 Int) (temp___269 Int)) (let ((temp___266 (alignment_attribute__q__a1__aggregate_def temp___267 temp___268 temp___269))) (and (=> (dynamic_property4 1 x temp___268 temp___269) (and (= (first3 temp___266) temp___268) (= (last3 temp___266) temp___269))) (forall ((temp___270 Int)) (= (select (to_array1 temp___266) temp___270) (of_rep temp___267)))))))
(declare-fun alignment_attribute__q__a2__aggregate_def (us_t) (Array Int us_t))
(assert (forall ((temp___275 us_t)) (forall ((temp___276 Int)) (= (select (alignment_attribute__q__a2__aggregate_def temp___275) temp___276) temp___275))))
(define-fun dynamic_invariant2 ((temp___expr_224 us_t) (temp___is_init_221 Bool) (temp___skip_constant_222 Bool) (temp___do_toplevel_223 Bool)) Bool (=> (not (= temp___skip_constant_222 true)) (and (dynamic_property1 1 x (first1 temp___expr_224) (last1 temp___expr_224)) (and (= (first1 temp___expr_224) 1) (= (last1 temp___expr_224) x)))))
(declare-const temp___272 (Array Int integer))
...
(assert (= (mk___t1 temp___272 temp___2721) (alignment_attribute__q__a1__aggregate_def 1 1 x)))
(assert (not (= (ite (<= (to_rep (first2 temp___2721)) (to_rep (last2 temp___2721))) (+ (- (to_rep (last2 temp___2721)) (to_rep (first2 temp___2721))) 1) 0) (ite (<= 1 x) (+ (- x 1) 1) 0))))
(check-sat)
(exit)
