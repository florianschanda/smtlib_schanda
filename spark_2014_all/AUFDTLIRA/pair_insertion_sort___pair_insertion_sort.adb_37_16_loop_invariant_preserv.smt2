...
(define-fun dynamic_invariant ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= 0 2147483646)) (in_range2 temp___expr_136)))
...
(define-fun dynamic_invariant3 ((temp___expr_152 Int) (temp___is_init_149 Bool) (temp___skip_constant_150 Bool) (temp___do_toplevel_151 Bool)) Bool (=> (or (= temp___is_init_149 true) (<= 0 2147483647)) (in_range3 temp___expr_152)))
...
(define-fun dynamic_invariant4 ((temp___expr_204 us_t1) (temp___is_init_201 Bool) (temp___skip_constant_202 Bool) (temp___do_toplevel_203 Bool)) Bool (and (=> (not (= temp___skip_constant_202 true)) (and (dynamic_property2 (to_rep values__first) (to_rep values__last) (first3 temp___expr_204) (last3 temp___expr_204)) (and (= (first3 temp___expr_204) (to_rep values__first)) (= (last3 temp___expr_204) (to_rep values__last))))) (=> (= temp___do_toplevel_203 true) (=> (= temp___is_init_201 true) (= (first3 temp___expr_204) 0)))))
...
(assert (and (and (<= (to_rep values__first) x) (<= x (to_rep values__last))) (and (and (<= (to_rep values__first) y) (<= y (to_rep values__last))) (and (= (is_set (mk___t (elts1 init) (mk (to_rep (first2 (rt1 init))) (to_rep (last2 (rt1 init))))) x (to_rep (select (elts1 init) y)) (mk___t interm (mk (to_rep interm__first) (to_rep interm__last)))) true) (= (is_set (mk___t interm (mk (to_rep interm__first) (to_rep interm__last))) y (to_rep (select (elts1 init) x)) (mk___t values (mk (to_rep values__first) (to_rep values__last)))) true)))))
...
(assert (= o6 y))
(assert (= o7 (select (elts1 init) o6)))
(assert (= o8 (to_rep o7)))
(assert (ite (= o8 (to_rep (select (elts1 init) x))) (= (occ (mk___t interm (mk (to_rep interm__first) (to_rep interm__last))) e1) (occ (mk___t (elts1 init) (mk (to_rep (first2 (rt1 init))) (to_rep (last2 (rt1 init))))) e1)) (ite (= o8 e1) (= (occ (mk___t interm (mk (to_rep interm__first) (to_rep interm__last))) e1) (+ (occ (mk___t (elts1 init) (mk (to_rep (first2 (rt1 init))) (to_rep (last2 (rt1 init))))) e1) 1)) (ite (= (to_rep (select (elts1 init) x)) e1) (= (occ (mk___t interm (mk (to_rep interm__first) (to_rep interm__last))) e1) (- (occ (mk___t (elts1 init) (mk (to_rep (first2 (rt1 init))) (to_rep (last2 (rt1 init))))) e1) 1)) (= (occ (mk___t interm (mk (to_rep interm__first) (to_rep interm__last))) e1) (occ (mk___t (elts1 init) (mk (to_rep (first2 (rt1 init))) (to_rep (last2 (rt1 init))))) e1))))))
(assert (and (<= (to_rep (first2 (rt1 init))) x) (<= x (to_rep (last2 (rt1 init))))))
(assert (= o9 x))
(assert (= o10 (select (elts1 init) o9)))
(assert (= o11 (to_rep o10)))
(assert (ite (= o11 (to_rep (select interm y))) (= (occ (mk___t values (mk (to_rep values__first) (to_rep values__last))) e1) (occ (mk___t interm (mk (to_rep interm__first) (to_rep interm__last))) e1)) (ite (= o11 e1) (= (occ (mk___t values (mk (to_rep values__first) (to_rep values__last))) e1) (+ (occ (mk___t interm (mk (to_rep interm__first) (to_rep interm__last))) e1) 1)) (ite (= (to_rep (select interm y)) e1) (= (occ (mk___t values (mk (to_rep values__first) (to_rep values__last))) e1) (- (occ (mk___t interm (mk (to_rep interm__first) (to_rep interm__last))) e1) 1)) (= (occ (mk___t values (mk (to_rep values__first) (to_rep values__last))) e1) (occ (mk___t interm (mk (to_rep interm__first) (to_rep interm__last))) e1))))))
(assert (forall ((f Int)) (=> (and (<= (- 2147483648) f) (<= f e2)) (= (occ (mk___t values (mk (to_rep values__first) (to_rep values__last))) f) (occ (mk___t (elts1 init) (mk (to_rep (first2 (rt1 init))) (to_rep (last2 (rt1 init))))) f)))))
(assert (and (=> (<= (- 2147483648) 2147483647) (in_range1 e2)) (and (<= (- 2147483648) e2) (<= e2 2147483647))))
(assert (not (= e2 2147483647)))
(assert (= e2 result2))
(assert (= e3 (+ e2 1)))
(assert (and (<= (to_rep (first2 (rt1 init))) y) (<= y (to_rep (last2 (rt1 init))))))
(assert (= o12 y))
(assert (= o13 (select (elts1 init) o12)))
(assert (= o14 (to_rep o13)))
(assert (ite (= o14 (to_rep (select (elts1 init) x))) (= (occ (mk___t interm (mk (to_rep interm__first) (to_rep interm__last))) e3) (occ (mk___t (elts1 init) (mk (to_rep (first2 (rt1 init))) (to_rep (last2 (rt1 init))))) e3)) (ite (= o14 e3) (= (occ (mk___t interm (mk (to_rep interm__first) (to_rep interm__last))) e3) (+ (occ (mk___t (elts1 init) (mk (to_rep (first2 (rt1 init))) (to_rep (last2 (rt1 init))))) e3) 1)) (ite (= (to_rep (select (elts1 init) x)) e3) (= (occ (mk___t interm (mk (to_rep interm__first) (to_rep interm__last))) e3) (- (occ (mk___t (elts1 init) (mk (to_rep (first2 (rt1 init))) (to_rep (last2 (rt1 init))))) e3) 1)) (= (occ (mk___t interm (mk (to_rep interm__first) (to_rep interm__last))) e3) (occ (mk___t (elts1 init) (mk (to_rep (first2 (rt1 init))) (to_rep (last2 (rt1 init))))) e3))))))
(assert (and (<= (to_rep (first2 (rt1 init))) x) (<= x (to_rep (last2 (rt1 init))))))
(assert (= o15 x))
(assert (= o16 (select (elts1 init) o15)))
(assert (= o17 (to_rep o16)))
(assert (ite (= o17 (to_rep (select interm y))) (= (occ (mk___t values (mk (to_rep values__first) (to_rep values__last))) e3) (occ (mk___t interm (mk (to_rep interm__first) (to_rep interm__last))) e3)) (ite (= o17 e3) (= (occ (mk___t values (mk (to_rep values__first) (to_rep values__last))) e3) (+ (occ (mk___t interm (mk (to_rep interm__first) (to_rep interm__last))) e3) 1)) (ite (= (to_rep (select interm y)) e3) (= (occ (mk___t values (mk (to_rep values__first) (to_rep values__last))) e3) (- (occ (mk___t interm (mk (to_rep interm__first) (to_rep interm__last))) e3) 1)) (= (occ (mk___t values (mk (to_rep values__first) (to_rep values__last))) e3) (occ (mk___t interm (mk (to_rep interm__first) (to_rep interm__last))) e3))))))
(declare-const f Int)
(assert (<= (- 2147483648) f))
(assert (<= f e3))
(assert (not (= (occ (mk___t values (mk (to_rep values__first) (to_rep values__last))) f) (occ (mk___t (elts1 init) (mk (to_rep (first2 (rt1 init))) (to_rep (last2 (rt1 init))))) f))))
(check-sat)
(exit)
