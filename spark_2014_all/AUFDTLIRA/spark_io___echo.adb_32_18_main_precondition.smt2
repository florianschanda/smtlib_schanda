...
(assert (forall ((x file_status)) (! (in_range3 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(define-fun dynamic_invariant ((temp___expr_538 Int) (temp___is_init_535 Bool) (temp___skip_constant_536 Bool) (temp___do_toplevel_537 Bool)) Bool (=> (or (= temp___is_init_535 true) (<= 0 10)) (in_range3 temp___expr_538)))
...
(define-fun dynamic_invariant5 ((temp___expr_550 Int) (temp___is_init_547 Bool) (temp___skip_constant_548 Bool) (temp___do_toplevel_549 Bool)) Bool (=> (or (= temp___is_init_547 true) (<= 0 2)) (in_range4 temp___expr_550)))
...
(define-fun dynamic_invariant6 ((temp___expr_556 Int) (temp___is_init_553 Bool) (temp___skip_constant_554 Bool) (temp___do_toplevel_555 Bool)) Bool (=> (or (= temp___is_init_553 true) (<= 0 2147483647)) (in_range5 temp___expr_556)))
