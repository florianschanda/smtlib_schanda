...
(define-fun default_initial_assumption ((temp___expr_597 us_rep1) (temp___skip_top_level_598 Bool)) Bool (and (= (attr__constrained temp___expr_597) false) (= (to_rep2 (rec__spark__text_io__character_result__status (us_split_discrs1 temp___expr_597))) 3)))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_805 us_void_param) 1)) 69) (= (to_rep (select (temp___String_Literal_805 us_void_param) 2)) 114)) (= (to_rep (select (temp___String_Literal_805 us_void_param) 3)) 114)) (= (to_rep (select (temp___String_Literal_805 us_void_param) 4)) 111)) (= (to_rep (select (temp___String_Literal_805 us_void_param) 5)) 114)) (= (to_rep (select (temp___String_Literal_805 us_void_param) 6)) 32)) (= (to_rep (select (temp___String_Literal_805 us_void_param) 7)) 111)) (= (to_rep (select (temp___String_Literal_805 us_void_param) 8)) 110)) (= (to_rep (select (temp___String_Literal_805 us_void_param) 9)) 32)) (= (to_rep (select (temp___String_Literal_805 us_void_param) 10)) 83)) (= (to_rep (select (temp___String_Literal_805 us_void_param) 11)) 116)) (= (to_rep (select (temp___String_Literal_805 us_void_param) 12)) 97)) (= (to_rep (select (temp___String_Literal_805 us_void_param) 13)) 110)) (= (to_rep (select (temp___String_Literal_805 us_void_param) 14)) 100)) (= (to_rep (select (temp___String_Literal_805 us_void_param) 15)) 97)) (= (to_rep (select (temp___String_Literal_805 us_void_param) 16)) 114)) (= (to_rep (select (temp___String_Literal_805 us_void_param) 17)) 100)) (= (to_rep (select (temp___String_Literal_805 us_void_param) 18)) 95)) (= (to_rep (select (temp___String_Literal_805 us_void_param) 19)) 73)) (= (to_rep (select (temp___String_Literal_805 us_void_param) 20)) 110)) (= (to_rep (select (temp___String_Literal_805 us_void_param) 21)) 112)) (= (to_rep (select (temp___String_Literal_805 us_void_param) 22)) 117)) (= (to_rep (select (temp___String_Literal_805 us_void_param) 23)) 116)) :pattern ((temp___String_Literal_805 us_void_param)))))
(declare-fun temp___String_Literal_806 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_806 us_void_param) 1)) 69) (= (to_rep (select (temp___String_Literal_806 us_void_param) 2)) 114)) (= (to_rep (select (temp___String_Literal_806 us_void_param) 3)) 114)) (= (to_rep (select (temp___String_Literal_806 us_void_param) 4)) 111)) (= (to_rep (select (temp___String_Literal_806 us_void_param) 5)) 114)) (= (to_rep (select (temp___String_Literal_806 us_void_param) 6)) 32)) (= (to_rep (select (temp___String_Literal_806 us_void_param) 7)) 111)) (= (to_rep (select (temp___String_Literal_806 us_void_param) 8)) 110)) (= (to_rep (select (temp___String_Literal_806 us_void_param) 9)) 32)) (= (to_rep (select (temp___String_Literal_806 us_void_param) 10)) 83)) (= (to_rep (select (temp___String_Literal_806 us_void_param) 11)) 116)) (= (to_rep (select (temp___String_Literal_806 us_void_param) 12)) 97)) (= (to_rep (select (temp___String_Literal_806 us_void_param) 13)) 110)) (= (to_rep (select (temp___String_Literal_806 us_void_param) 14)) 100)) (= (to_rep (select (temp___String_Literal_806 us_void_param) 15)) 97)) (= (to_rep (select (temp___String_Literal_806 us_void_param) 16)) 114)) (= (to_rep (select (temp___String_Literal_806 us_void_param) 17)) 100)) (= (to_rep (select (temp___String_Literal_806 us_void_param) 18)) 95)) (= (to_rep (select (temp___String_Literal_806 us_void_param) 19)) 79)) (= (to_rep (select (temp___String_Literal_806 us_void_param) 20)) 117)) (= (to_rep (select (temp___String_Literal_806 us_void_param) 21)) 116)) (= (to_rep (select (temp___String_Literal_806 us_void_param) 22)) 112)) (= (to_rep (select (temp___String_Literal_806 us_void_param) 23)) 117)) (= (to_rep (select (temp___String_Literal_806 us_void_param) 24)) 116)) :pattern ((temp___String_Literal_806 us_void_param)))))
...
(define-fun dynamic_invariant5 ((temp___expr_544 Int) (temp___is_init_541 Bool) (temp___skip_constant_542 Bool) (temp___do_toplevel_543 Bool)) Bool (=> (or (= temp___is_init_541 true) (<= 0 2)) (in_range5 temp___expr_544)))
...
(define-fun dynamic_invariant6 ((temp___expr_550 Int) (temp___is_init_547 Bool) (temp___skip_constant_548 Bool) (temp___do_toplevel_549 Bool)) Bool (=> (or (= temp___is_init_547 true) (<= 0 2147483647)) (in_range6 temp___expr_550)))
