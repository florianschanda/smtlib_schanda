...
(assert (= (slide fullstring1 (to_rep1 fullstring__first) 1) temp___2517))
(assert (= (mk3 1 (to_rep1 fullstring__last)) temp___25171))
(assert (=> (<= 1 (to_rep1 fullstring__last)) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 (to_rep1 fullstring__last)) (<= (to_rep1 fullstring__last) 150)))))
(assert (= o6 result__))
(assert (= o6 temp___2520))
(assert (= (mk3 1 (to_rep1 fullstring__last)) temp___25201))
(assert (not (= (ite (<= (to_rep1 (first6 temp___25171)) (to_rep1 (last6 temp___25171))) (+ (- (to_rep1 (last6 temp___25171)) (to_rep1 (first6 temp___25171))) 1) 0) (ite (<= (to_rep1 (first6 temp___25201)) (to_rep1 (last6 temp___25201))) (+ (- (to_rep1 (last6 temp___25201)) (to_rep1 (first6 temp___25201))) 1) 0))))
(check-sat)
(exit)
