...
(declare-const temp___2710 (Array Int character))
(declare-const temp___27101 t3)
(declare-const o6 (Array Int character))
(declare-const temp___2713 (Array Int character))
(declare-const temp___27131 t3)
...
(assert (= (slide fullstring1 (to_rep1 fullstring__first) 1) temp___2710))
(assert (= (mk3 1 (to_rep1 fullstring__last)) temp___27101))
(assert (=> (<= 1 (to_rep1 fullstring__last)) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 (to_rep1 fullstring__last)) (<= (to_rep1 fullstring__last) 150)))))
(assert (= o6 result__))
(assert (= o6 temp___2713))
(assert (= (mk3 1 (to_rep1 fullstring__last)) temp___27131))
(assert (not (= (ite (<= (to_rep1 (first6 temp___27101)) (to_rep1 (last6 temp___27101))) (+ (- (to_rep1 (last6 temp___27101)) (to_rep1 (first6 temp___27101))) 1) 0) (ite (<= (to_rep1 (first6 temp___27131)) (to_rep1 (last6 temp___27131))) (+ (- (to_rep1 (last6 temp___27131)) (to_rep1 (first6 temp___27131))) 1) 0))))
(check-sat)
(exit)
