...
(define-fun default_initial_assumption ((temp___expr_183 us_rep) (temp___skip_top_level_184 Bool)) Bool (and (= (attr__constrained temp___expr_183) false) (= (to_rep1 (rec__var__decision__kind (us_split_discrs1 temp___expr_183))) 0)))
