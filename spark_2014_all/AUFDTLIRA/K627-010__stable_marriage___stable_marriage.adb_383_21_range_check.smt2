...
(assert (and (forall ((g13 Int)) (=> (and (<= 1 g13) (<= g13 64)) (= (is_permutation_2 (select ranking_1 g13)) true))) (forall ((g2 Int)) (=> (and (<= 1 g2) (<= g2 64)) (= (is_permutation_1 (select ranking_2 g2)) true)))))
