...
(define-fun dynamic_invariant ((temp___expr_195 Int) (temp___is_init_192 Bool) (temp___skip_constant_193 Bool) (temp___do_toplevel_194 Bool)) Bool (=> (or (= temp___is_init_192 true) (<= 0 2147483647)) (in_range temp___expr_195)))
...
(assert (forall ((temp___496 Int) (temp___497 Int) (temp___498 Int)) (let ((temp___495 (temp___494 temp___496 temp___497 temp___498))) (and (=> (dynamic_property4 1 2147483647 temp___497 temp___498) (and (= (first3 temp___495) temp___497) (= (last3 temp___495) temp___498))) (forall ((temp___499 Int)) (= (select (to_array1 temp___495) temp___499) (of_rep1 temp___496)))))))
...
(declare-const temp___840 natural_index)
(declare-const temp___843 (Array Int character))
(declare-const temp___8431 t1)
(declare-const temp___844 natural_index)
(declare-const temp___8441 natural_index)
(declare-const temp___8442 (Array Int character))
(declare-const temp___8443 t)
(assert (and (= (to_rep temp___8441) 0) (let ((temp___846 (temp___494 32 1 (to_rep temp___844)))) (and (= temp___8442 (elts1 temp___846)) (= temp___8443 (mk (to_rep2 (first2 (rt1 temp___846))) (to_rep2 (last2 (rt1 temp___846)))))))))
(assert (not (dynamic_predicate (mk___rep (mk___split_discrs temp___844) (mk___split_fields temp___8441 (mk___t temp___8442 temp___8443))))))
(check-sat)
(exit)
