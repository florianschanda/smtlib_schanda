...
(define-fun dynamic_invariant ((temp___expr_222 Int) (temp___is_init_218 Bool) (temp___skip_constant_219 Bool) (temp___do_toplevel_220 Bool) (temp___do_typ_inv_221 Bool)) Bool (=> (or (= temp___is_init_218 true) (<= 0 2147483647)) (in_range temp___expr_222)))
...
(assert (forall ((temp___528 Int) (temp___529 Int) (temp___530 Int)) (let ((temp___527 (temp___526 temp___528 temp___529 temp___530))) (=> (dynamic_invariant3 temp___528 true true true true) (and (=> (dynamic_property4 1 2147483647 temp___529 temp___530) (and (= (first3 temp___527) temp___529) (= (last3 temp___527) temp___530))) (forall ((temp___531 Int)) (= (to_rep1 (select (to_array1 temp___527) temp___531)) temp___528)))))))
(declare-const temp___907 natural_index)
(declare-const temp___9071 natural_index)
(declare-const temp___9072 (Array Int character))
(declare-const temp___9073 t)
(assert (and (= (to_rep temp___9071) 0) (let ((temp___909 (temp___526 32 1 (to_rep temp___907)))) (and (= temp___9072 (elts1 temp___909)) (= temp___9073 (mk (to_rep2 (first2 (rt1 temp___909))) (to_rep2 (last2 (rt1 temp___909)))))))))
(assert (not (dynamic_predicate (mk___rep (mk___split_discrs temp___907) (mk___split_fields temp___9071 (mk___t temp___9072 temp___9073))))))
(check-sat)
(exit)
