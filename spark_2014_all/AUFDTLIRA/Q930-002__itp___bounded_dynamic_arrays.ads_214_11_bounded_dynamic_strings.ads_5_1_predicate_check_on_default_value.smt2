...
(define-fun temp___9313 () us_rep1 (mk___rep1 (mk___split_discrs temp___931) (mk___split_fields1 temp___9311 temp___9312)))
(assert (= (bounded_dynamic_strings__null_list__aggregate_def 32) null_list))
(assert (and (= us 0) (in_range2 0)))
(assert (default_initial_assumption temp___9313 false))
(assert (not (dynamic_predicate1 temp___9313)))
(check-sat)
(exit)
