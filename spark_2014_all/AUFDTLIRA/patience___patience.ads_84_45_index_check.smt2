...
(assert (and (<= 0 ist) (<= ist 99)))
(assert (= o6 ist))
(assert (= temp___430 (select (rec__patience__state__stacks (us_split_fields1 s)) o6)))
(assert (and (<= 0 ip) (<= ip 99)))
(assert (= o7 ip))
(assert (= o8 (select temp___430 o7)))
(assert (= temp___431 (to_rep1 o8)))
(assert (and (<= 0 temp___431) (<= temp___431 99)))
(assert (= o9 temp___431))
