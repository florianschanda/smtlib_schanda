...
(assert (and (<= 0 ist) (<= ist 99)))
(assert (= o6 ist))
(assert (= temp___460 (select (rec__patience__state__stacks (us_split_fields1 s)) o6)))
(assert (and (<= 0 ip) (<= ip 99)))
(assert (= o7 ip))
(assert (= o8 (select temp___460 o7)))
(assert (= temp___461 (to_rep1 o8)))
(assert (and (<= 0 temp___461) (<= temp___461 99)))
(assert (= o9 temp___461))
(assert (= o10 (select (rec__patience__state__posheight (us_split_fields1 s)) o9)))
(assert (= o11 (to_rep1 o10)))
(assert (= o12 (ite (= ip o11) true false)))
(assert (and (<= 0 ist) (<= ist 99)))
(assert (= o5 ist))
