...
(define-fun dynamic_invariant4 ((temp___expr_525 Int) (temp___is_init_522 Bool) (temp___skip_constant_523 Bool) (temp___do_toplevel_524 Bool)) Bool (=> (or (= temp___is_init_522 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_525)))
...
(define-fun dynamic_invariant6 ((temp___expr_669 us_t2) (temp___is_init_666 Bool) (temp___skip_constant_667 Bool) (temp___do_toplevel_668 Bool)) Bool (=> (not (= temp___skip_constant_667 true)) (and (dynamic_property4 1 r22b (first5 temp___expr_669) (last5 temp___expr_669)) (and (= (first5 temp___expr_669) 1) (= (last5 temp___expr_669) r22b)))))
...
(declare-const temp___823 (Array Int value))
(declare-const temp___8231 t1)
(declare-const temp___816 natural)
(declare-const temp___8161 (Array Int value))
(declare-const temp___8162 t1)
(declare-const temp___815 Int)
(declare-const temp___819 (Array Int value))
(declare-const temp___8191 t1)
(declare-const temp___814 Int)
(declare-const j Int)
(declare-const temp___820 Int)
(declare-const o Int)
...
(declare-const a__split_fields5 t1)
...
(declare-const low3 Int)
(declare-const result5 int__ref)
(declare-const high3 Int)
(declare-const a__split_fields7 us_split_fields__ref)
(declare-const low4 int__ref)
(declare-const high4 int__ref)
(declare-const a__split_fields8 us_split_fields)
(declare-const low5 Int)
(declare-const high5 Int)
(declare-const a__split_fields9 us_split_fields__ref)
(declare-const low6 int__ref)
(declare-const high6 int__ref)
(declare-const a__split_fields10 us_split_fields)
(declare-const low7 Int)
(declare-const high7 Int)
(declare-const a__split_fields11 us_split_fields__ref)
(declare-const low8 int__ref)
(declare-const high8 int__ref)
(declare-const a__split_fields12 us_split_fields)
(declare-const low9 Int)
(declare-const high9 Int)
(declare-const a__split_fields13 us_split_fields__ref)
(declare-const low10 int__ref)
(declare-const high10 int__ref)
(declare-const a__split_fields14 us_split_fields)
(declare-const low11 Int)
(declare-const high11 Int)
(assert (dynamic_invariant2 (mk___rep a__split_discrs (mk___split_fields (mk___t1 a__split_fields a__split_fields1))) true false true))
...
(assert (< low1 high1))
(assert (and (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 (- low2 1))) (= (to_rep2 (select a__split_fields4 j3)) (to_rep2 (select a__split_fields (+ (- (to_rep (rec__simple_unc_arrays__table__last a__split_discrs)) j3) 1)))))) (forall ((j3 Int)) (=> (and (<= (- low2 1) j3) (<= j3 (to_rep (rec__simple_unc_arrays__table__last a__split_discrs)))) (= (to_rep2 (select a__split_fields4 j3)) (to_rep2 (select a__split_fields j3)))))))
(assert (and (and (and (=> (<= 1 2147483647) (in_range3 low2)) (=> (<= 0 2147483647) (in_range2 high2))) (dynamic_invariant2 (mk___rep a__split_discrs (mk___split_fields (mk___t1 a__split_fields4 a__split_fields5))) true true true)) (< low2 high2)))
(assert (= (= o6 true) (forall ((j3 Int)) (=> (and (<= (- low2 1) j3) (<= j3 (to_rep (rec__simple_unc_arrays__table__last a__split_discrs)))) (= (to_rep2 (select a__split_fields4 j3)) (to_rep2 (select a__split_fields j3)))))))
(assert (<= 1 j))
(assert (<= j (- low2 1)))
(assert (and (= temp___820 (+ (- (to_rep (rec__simple_unc_arrays__table__last a__split_discrs)) j) 1)) (in_range1 (+ (- (to_rep (rec__simple_unc_arrays__table__last a__split_discrs)) j) 1))))
(assert (not (<= (to_rep1 (first2 a__split_fields1)) temp___820)))
(check-sat)
(exit)
