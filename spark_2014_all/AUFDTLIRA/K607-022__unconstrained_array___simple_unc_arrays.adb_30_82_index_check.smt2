...
(define-fun dynamic_invariant4 ((temp___expr_596 Int) (temp___is_init_592 Bool) (temp___skip_constant_593 Bool) (temp___do_toplevel_594 Bool) (temp___do_typ_inv_595 Bool)) Bool (=> (or (= temp___is_init_592 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_596)))
...
(define-fun dynamic_invariant6 ((temp___expr_746 us_t2) (temp___is_init_742 Bool) (temp___skip_constant_743 Bool) (temp___do_toplevel_744 Bool) (temp___do_typ_inv_745 Bool)) Bool (=> (not (= temp___skip_constant_743 true)) (and (dynamic_property4 1 r22b (first5 temp___expr_746) (last5 temp___expr_746)) (and (= (first5 temp___expr_746) 1) (= (last5 temp___expr_746) r22b)))))
...
(assert (and (and (and (=> (<= 1 2147483647) (in_range3 low2)) (=> (<= 0 2147483647) (in_range2 high2))) (dynamic_invariant2 (mk___rep a__split_discrs (mk___split_fields (mk___t1 a__split_fields2 a__split_fields3))) true true true true)) (< low2 high2)))
...
(assert (<= 1 j))
(assert (<= j (- low2 1)))
(assert (and (= temp___905 (+ (- (to_rep (rec__simple_unc_arrays__table__last a__split_discrs)) j) 1)) (in_range1 (+ (- (to_rep (rec__simple_unc_arrays__table__last a__split_discrs)) j) 1))))
(assert (not (<= (to_rep1 (first2 a__split_fields1)) temp___905)))
(check-sat)
(exit)
