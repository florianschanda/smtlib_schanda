...
(define-fun dynamic_invariant4 ((temp___expr_531 Int) (temp___is_init_528 Bool) (temp___skip_constant_529 Bool) (temp___do_toplevel_530 Bool)) Bool (=> (or (= temp___is_init_528 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_531)))
...
(define-fun dynamic_invariant6 ((temp___expr_675 us_t2) (temp___is_init_672 Bool) (temp___skip_constant_673 Bool) (temp___do_toplevel_674 Bool)) Bool (=> (not (= temp___skip_constant_673 true)) (and (dynamic_property4 1 r22b (first5 temp___expr_675) (last5 temp___expr_675)) (and (= (first5 temp___expr_675) 1) (= (last5 temp___expr_675) r22b)))))
...
(assert (and (and (and (=> (<= 1 2147483647) (in_range3 low2)) (=> (<= 0 2147483647) (in_range2 high2))) (dynamic_invariant2 (mk___rep a__split_discrs (mk___split_fields (mk___t1 a__split_fields2 a__split_fields3))) true true true)) (< low2 high2)))
(assert (= (= o true) (forall ((j1 Int)) (=> (and (<= (- low2 1) j1) (<= j1 (to_rep (rec__simple_unc_arrays__table__last a__split_discrs)))) (= (to_rep2 (select a__split_fields2 j1)) (to_rep2 (select a__split_fields j1)))))))
(assert (<= 1 j))
(assert (<= j (- low2 1)))
(assert (and (= temp___826 (+ (- (to_rep (rec__simple_unc_arrays__table__last a__split_discrs)) j) 1)) (in_range1 (+ (- (to_rep (rec__simple_unc_arrays__table__last a__split_discrs)) j) 1))))
(assert (not (<= (to_rep1 (first2 a__split_fields1)) temp___826)))
(check-sat)
(exit)
