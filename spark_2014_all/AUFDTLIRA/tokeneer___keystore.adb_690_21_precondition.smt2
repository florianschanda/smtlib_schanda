...
(assert (forall ((x namecountt)) (! (in_range6 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(assert (forall ((x issueridt)) (! (in_range7 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(define-fun dynamic_invariant2 ((temp___expr_742 Int) (temp___is_init_739 Bool) (temp___skip_constant_740 Bool) (temp___do_toplevel_741 Bool)) Bool (=> (or (= temp___is_init_739 true) (<= 0 10)) (in_range8 temp___expr_742)))
...
(assert (forall ((x rawcertificatei)) (! (= (of_rep4 (to_rep4 x)) x) :pattern ((to_rep4 x)))))
(assert (forall ((x rawcertificatei)) (! (in_range9 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__certtypes__rawdatat__rawdata (Array Int character)) (rec__certtypes__rawdatat__datalength rawcertificatei)))))
(define-fun us_split_fields_RawData__projection ((a us_split_fields2)) (Array Int character) (rec__certtypes__rawdatat__rawdata a))
(define-fun us_split_fields_DataLength__projection ((a us_split_fields2)) rawcertificatei (rec__certtypes__rawdatat__datalength a))
...
(define-fun bool_eq3 ((a us_rep1) (b us_rep1)) Bool (ite (and (= (bool_eq (rec__certtypes__rawdatat__rawdata (us_split_fields3 a)) 1 4096 (rec__certtypes__rawdatat__rawdata (us_split_fields3 b)) 1 4096) true) (= (to_rep4 (rec__certtypes__rawdatat__datalength (us_split_fields3 a))) (to_rep4 (rec__certtypes__rawdatat__datalength (us_split_fields3 b))))) true false))
...
(declare-datatypes () ((rawdatat__ref (mk_rawdatat__ref (rawdatat__content us_rep1)))))
(define-fun rawdatat__ref___projection ((a rawdatat__ref)) us_rep1 (rawdatat__content a))
...
(assert (forall ((x sigdatai)) (! (= (of_rep5 (to_rep5 x)) x) :pattern ((to_rep5 x)))))
(assert (forall ((x sigdatai)) (! (in_range10 (to_rep5 x)) :pattern ((to_rep5 x)))))
...
(define-fun bool_eq4 ((a us_rep2) (b us_rep2)) Bool (ite (and (= (bool_eq (rec__certtypes__signaturet__sigdata (us_split_fields5 a)) 1 4096 (rec__certtypes__signaturet__sigdata (us_split_fields5 b)) 1 4096) true) (= (to_rep5 (rec__certtypes__signaturet__siglength (us_split_fields5 a))) (to_rep5 (rec__certtypes__signaturet__siglength (us_split_fields5 b))))) true false))
...
(declare-datatypes () ((signaturet__ref (mk_signaturet__ref (signaturet__content us_rep2)))))
(define-fun signaturet__ref___projection ((a signaturet__ref)) us_rep2 (signaturet__content a))
...
(define-fun dynamic_invariant3 ((temp___expr_1038 Int) (temp___is_init_1035 Bool) (temp___skip_constant_1036 Bool) (temp___do_toplevel_1037 Bool)) Bool (=> (or (= temp___is_init_1035 true) (<= 0 28)) (in_range11 temp___expr_1038)))
(declare-fun to_rep6 (unsigned32t) Int)
(declare-fun of_rep6 (Int) unsigned32t)
(assert (forall ((x unsigned32t)) (! (= (of_rep6 (to_rep6 x)) x) :pattern ((to_rep6 x)))))
(assert (forall ((x unsigned32t)) (! (in_range5 (to_rep6 x)) :pattern ((to_rep6 x)))))
...
(assert (forall ((x returnvaluet)) (! (= (of_rep7 (to_rep7 x)) x) :pattern ((to_rep7 x)))))
(assert (forall ((x returnvaluet)) (! (in_range11 (to_rep7 x)) :pattern ((to_rep7 x)))))
...
(define-fun bool_eq5 ((a (Array Int bytet)) (a__first Int) (a__last Int) (b (Array Int bytet)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_141 Int)) (=> (and (<= a__first temp___idx_141) (<= temp___idx_141 a__last)) (= (to_rep8 (select a temp___idx_141)) (to_rep8 (select b (+ (- b__first a__first) temp___idx_141))))))) true false))
(assert (forall ((a (Array Int bytet)) (b (Array Int bytet))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq5 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_141 Int)) (=> (and (<= a__first temp___idx_141) (<= temp___idx_141 a__last)) (= (to_rep8 (select a temp___idx_141)) (to_rep8 (select b (+ (- b__first a__first) temp___idx_141)))))))))))
(declare-fun compare1 ((Array Int bytet) Int Int (Array Int bytet) Int Int) Int)
(assert (forall ((a (Array Int bytet)) (b (Array Int bytet))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare1 a a_first a_last b b_first b_last) 0) (= (bool_eq5 a a_first a_last b b_first b_last) true)) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int bytet)) (b (Array Int bytet))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare1 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq5 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep8 (select a (+ i 1))) (to_rep8 (select b (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int bytet)) (b (Array Int bytet))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare1 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq5 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep8 (select b (+ i 1))) (to_rep8 (select a (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
...
(define-fun bool_eq6 ((a us_rep3) (b us_rep3)) Bool (ite (and (and (and (= (to_rep6 (rec__keystore__interfac__digestt__digestid (us_split_fields7 a))) (to_rep6 (rec__keystore__interfac__digestt__digestid (us_split_fields7 b)))) (= (to_rep7 (rec__keystore__interfac__digestt__signreturn (us_split_fields7 a))) (to_rep7 (rec__keystore__interfac__digestt__signreturn (us_split_fields7 b))))) (= (to_rep7 (rec__keystore__interfac__digestt__verifyreturn (us_split_fields7 a))) (to_rep7 (rec__keystore__interfac__digestt__verifyreturn (us_split_fields7 b))))) (= (bool_eq5 (rec__keystore__interfac__digestt__pad (us_split_fields7 a)) 1 20 (rec__keystore__interfac__digestt__pad (us_split_fields7 b)) 1 20) true)) true false))
...
(assert (forall ((a (Array Int Bool)) (b (Array Int Bool))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq7 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_157 Int)) (=> (and (<= a__first temp___idx_157) (<= temp___idx_157 a__last)) (= (select a temp___idx_157) (select b (+ (- b__first a__first) temp___idx_157))))))))))
(declare-fun compare2 ((Array Int Bool) Int Int (Array Int Bool) Int Int) Int)
(assert (forall ((a (Array Int Bool)) (b (Array Int Bool))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare2 a a_first a_last b b_first b_last) 0) (= (bool_eq7 a a_first a_last b b_first b_last) true)) :pattern ((compare2 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int Bool)) (b (Array Int Bool))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare2 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq7 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_int1 (select a (+ i 1))) (to_int1 (select b (+ j 1))))))))))) :pattern ((compare2 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int Bool)) (b (Array Int Bool))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare2 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq7 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_int1 (select b (+ i 1))) (to_int1 (select a (+ j 1))))))))))) :pattern ((compare2 a a_first a_last b b_first b_last))))))
...
(define-fun bool_eq8 ((x us_t1) (y us_t1)) Bool (bool_eq (elts1 x) (to_rep1 (first2 (rt1 x))) (to_rep1 (last2 (rt1 x))) (elts1 y) (to_rep1 (first2 (rt1 y))) (to_rep1 (last2 (rt1 y)))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1138 us_void_param) 1)) 86) (= (to_rep (select (temp___String_Literal_1138 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_1138 us_void_param) 3)) 114)) (= (to_rep (select (temp___String_Literal_1138 us_void_param) 4)) 105)) (= (to_rep (select (temp___String_Literal_1138 us_void_param) 5)) 102)) (= (to_rep (select (temp___String_Literal_1138 us_void_param) 6)) 121)) :pattern ((temp___String_Literal_1138 us_void_param)))))
(declare-fun temp___String_Literal_1148 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1148 us_void_param) 1)) 67) (= (to_rep (select (temp___String_Literal_1148 us_void_param) 2)) 114)) (= (to_rep (select (temp___String_Literal_1148 us_void_param) 3)) 121)) (= (to_rep (select (temp___String_Literal_1148 us_void_param) 4)) 112)) (= (to_rep (select (temp___String_Literal_1148 us_void_param) 5)) 116)) (= (to_rep (select (temp___String_Literal_1148 us_void_param) 6)) 111)) (= (to_rep (select (temp___String_Literal_1148 us_void_param) 7)) 32)) (= (to_rep (select (temp___String_Literal_1148 us_void_param) 8)) 76)) (= (to_rep (select (temp___String_Literal_1148 us_void_param) 9)) 105)) (= (to_rep (select (temp___String_Literal_1148 us_void_param) 10)) 98)) (= (to_rep (select (temp___String_Literal_1148 us_void_param) 11)) 114)) (= (to_rep (select (temp___String_Literal_1148 us_void_param) 12)) 97)) (= (to_rep (select (temp___String_Literal_1148 us_void_param) 13)) 114)) (= (to_rep (select (temp___String_Literal_1148 us_void_param) 14)) 121)) (= (to_rep (select (temp___String_Literal_1148 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_1148 us_void_param) 16)) 69)) (= (to_rep (select (temp___String_Literal_1148 us_void_param) 17)) 114)) (= (to_rep (select (temp___String_Literal_1148 us_void_param) 18)) 114)) (= (to_rep (select (temp___String_Literal_1148 us_void_param) 19)) 111)) (= (to_rep (select (temp___String_Literal_1148 us_void_param) 20)) 114)) (= (to_rep (select (temp___String_Literal_1148 us_void_param) 21)) 32)) (= (to_rep (select (temp___String_Literal_1148 us_void_param) 22)) 105)) (= (to_rep (select (temp___String_Literal_1148 us_void_param) 23)) 110)) (= (to_rep (select (temp___String_Literal_1148 us_void_param) 24)) 32)) (= (to_rep (select (temp___String_Literal_1148 us_void_param) 25)) 86)) (= (to_rep (select (temp___String_Literal_1148 us_void_param) 26)) 101)) (= (to_rep (select (temp___String_Literal_1148 us_void_param) 27)) 114)) (= (to_rep (select (temp___String_Literal_1148 us_void_param) 28)) 105)) (= (to_rep (select (temp___String_Literal_1148 us_void_param) 29)) 102)) (= (to_rep (select (temp___String_Literal_1148 us_void_param) 30)) 121)) (= (to_rep (select (temp___String_Literal_1148 us_void_param) 31)) 32)) (= (to_rep (select (temp___String_Literal_1148 us_void_param) 32)) 58)) (= (to_rep (select (temp___String_Literal_1148 us_void_param) 33)) 32)) :pattern ((temp___String_Literal_1148 us_void_param)))))
...
(define-fun dynamic_invariant7 ((temp___expr_271 Int) (temp___is_init_268 Bool) (temp___skip_constant_269 Bool) (temp___do_toplevel_270 Bool)) Bool (=> (or (= temp___is_init_268 true) (<= 0 255)) (in_range12 temp___expr_271)))
(define-fun dynamic_invariant8 ((temp___expr_880 Int) (temp___is_init_877 Bool) (temp___skip_constant_878 Bool) (temp___do_toplevel_879 Bool)) Bool (=> (or (= temp___is_init_877 true) (<= 1 4096)) (in_range9 temp___expr_880)))
(define-fun dynamic_invariant9 ((temp___expr_912 Int) (temp___is_init_909 Bool) (temp___skip_constant_910 Bool) (temp___do_toplevel_911 Bool)) Bool (=> (or (= temp___is_init_909 true) (<= 1 4096)) (in_range10 temp___expr_912)))
(define-fun dynamic_invariant10 ((temp___expr_703 Int) (temp___is_init_700 Bool) (temp___skip_constant_701 Bool) (temp___do_toplevel_702 Bool)) Bool (=> (or (= temp___is_init_700 true) (<= 0 40)) (in_range6 temp___expr_703)))
(define-fun dynamic_invariant11 ((temp___expr_724 Int) (temp___is_init_721 Bool) (temp___skip_constant_722 Bool) (temp___do_toplevel_723 Bool)) Bool (=> (or (= temp___is_init_721 true) (<= 0 4294967295)) (in_range7 temp___expr_724)))
(define-fun dynamic_invariant12 ((temp___expr_217 Int) (temp___is_init_214 Bool) (temp___skip_constant_215 Bool) (temp___do_toplevel_216 Bool)) Bool (=> (or (= temp___is_init_214 true) (<= 1 150)) (in_range4 temp___expr_217)))
...
(declare-const c125b (Array Int character))
...
(declare-const temp___1145 (Array Int character))
(declare-const temp___11451 t1)
(declare-const temp___1146 (Array Int character))
(declare-const temp___11461 t1)
(declare-const o8 (Array Int character))
(declare-const temp___1141 (Array Int character))
(declare-const temp___11411 t)
...
(declare-const c125b1 (Array Int character))
...
(assert (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE11 c123b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE11 c123b)))))) (= o (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE11 c123b))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE11 c123b)))))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE11 c123b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE11 c123b))))))) (= o 0)))
...
(assert (= (concat1 (temp___String_Literal_1148 Tuple0) 1 33 (elts (to_string (attr__ATTRIBUTE_IMAGE11 c123b))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE11 c123b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE11 c123b)))))) keystore__isverifiedby__B127b__thestring__assume))
(assert (= (mk 1 o5) keystore__isverifiedby__B127b__thestring__assume1))
(assert (= (mk___t keystore__isverifiedby__B127b__thestring__assume keystore__isverifiedby__B127b__thestring__assume1) thestring))
...
(assert (=> (= result2 true) (= (slide (elts thestring) (to_rep1 (first (rt thestring))) 1) temp___1142)))
(assert (=> (= result2 true) (= (mk1 1 (length thestring)) temp___11421)))
(assert (=> (= result2 true) (and (= temp___1144 (length thestring)) (in_range1 (length thestring)))))
(assert (=> (= result2 true) (=> (<= 1 temp___1144) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 temp___1144) (<= temp___1144 150))))))
(assert (=> (= result2 true) (= o7 result__1)))
(assert (=> (= result2 true) (= o7 temp___1145)))
(assert (=> (= result2 true) (= (mk1 1 temp___1144) temp___11451)))
(assert (=> (= result2 true) (= (ite (<= (to_rep1 (first2 temp___11421)) (to_rep1 (last2 temp___11421))) (+ (- (to_rep1 (last2 temp___11421)) (to_rep1 (first2 temp___11421))) 1) 0) (ite (<= (to_rep1 (first2 temp___11451)) (to_rep1 (last2 temp___11451))) (+ (- (to_rep1 (last2 temp___11451)) (to_rep1 (first2 temp___11451))) 1) 0))))
(assert (=> (= result2 true) (= (mk___t1 temp___1146 temp___11461) (mk___t1 temp___1142 temp___11421))))
(assert (=> (= result2 true) (forall ((temp___1147 Int)) (ite (and (<= 1 temp___1147) (<= temp___1147 (length thestring))) (= (select o8 temp___1147) (select temp___1146 temp___1147)) (= (select o8 temp___1147) (select result__1 temp___1147))))))
(assert (=> (= result2 true) (= result3 result__1)))
...
(assert (=> (not (= result2 true)) (= (mk___t temp___1141 temp___11411) thestring)))
(assert (=> (not (= result2 true)) (= o9 temp___1141)))
(assert (=> (not (= result2 true)) (= result4 result__1)))
(assert (=> (not (= result2 true)) (= result__3 o9)))
(assert (=> (not (= result2 true)) (= result__2 result__3)))
(assert (= result5 c125b))
(assert (= c125b1 result__2))
