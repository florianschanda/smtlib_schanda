...
(assert (and (= o8 (+ b_first i2)) (in_range1 (+ b_first i2))))
(assert (= o9 (- o8 1)))
(assert (= o10 (ite (<= j o9) true false)))
(assert (= o11 (ite (<= b_first j) o10 false)))
(assert (= result1 (ite (not (= o11 true)) true false)))
(assert (=> (= result1 true) (and (<= (to_rep b__first) j) (<= j (to_rep b__last)))))
(assert (=> (= result1 true) (= o14 j)))
(assert (=> (= result1 true) (= o15 (select b o14))))
(assert (=> (= result1 true) (= o16 (to_rep o15))))
(assert (=> (= result1 true) (and (<= (to_rep b__first) j) (<= j (to_rep b__last)))))
(assert (=> (= result1 true) (= o12 j)))
(assert (=> (= result1 true) (= o13 (select b1 o12))))
(assert (=> (= result1 true) (= o17 (to_rep o13))))
(assert (=> (= result1 true) (= o18 (ite (= o17 o16) true false))))
(assert (=> (not (= result1 true)) (= o18 (distinct 1 0))))
...
(assert (and (= temp___276 o4) (in_range1 o4)))
(assert (and (<= (to_rep (first (rt a))) temp___276) (<= temp___276 (to_rep (last (rt a))))))
(assert (= o5 temp___276))
