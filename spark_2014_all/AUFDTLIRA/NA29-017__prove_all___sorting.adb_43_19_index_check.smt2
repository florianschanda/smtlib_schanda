...
(assert (and (= o13 (+ b_first i2)) (in_range1 (+ b_first i2))))
(assert (= o14 (- o13 1)))
(assert (= o15 (ite (<= j o14) true false)))
(assert (= o16 (ite (<= b_first j) o15 false)))
(assert (= result1 (ite (not (= o16 true)) true false)))
(assert (=> (= result1 true) (and (<= (to_rep b__first) j) (<= j (to_rep b__last)))))
(assert (=> (= result1 true) (= o19 j)))
(assert (=> (= result1 true) (= o20 (select b o19))))
(assert (=> (= result1 true) (= o21 (to_rep o20))))
(assert (=> (= result1 true) (and (<= (to_rep b__first) j) (<= j (to_rep b__last)))))
(assert (=> (= result1 true) (= o17 j)))
(assert (=> (= result1 true) (= o18 (select b2 o17))))
(assert (=> (= result1 true) (= o22 (to_rep o18))))
(assert (=> (= result1 true) (= o23 (ite (= o22 o21) true false))))
(assert (=> (not (= result1 true)) (= o23 (of_int 1))))
(assert (and (= o5 (+ b_first i2)) (in_range1 (+ b_first i2))))
(assert (= o6 (- o5 1)))
(assert (= o7 (ite (<= j o6) true false)))
(assert (= result2 (ite (<= b_first j) o7 false)))
(assert (= result2 true))
(assert (and (= o8 (+ a_first j)) (in_range1 (+ a_first j))))
(assert (= o9 (- o8 b_first)))
(assert (and (= temp___247 o9) (in_range1 o9)))
(assert (and (<= (to_rep (first (rt a))) temp___247) (<= temp___247 (to_rep (last (rt a))))))
(assert (= o10 temp___247))
