...
(define-fun dynamic_invariant1 ((temp___expr_149 Int) (temp___is_init_146 Bool) (temp___skip_constant_147 Bool) (temp___do_toplevel_148 Bool)) Bool (=> (or (= temp___is_init_146 true) (<= (- 23) 69)) (in_range1 temp___expr_149)))
...
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (to_rep (select (select a2 i) j)) 17)))
(check-sat)
(exit)
