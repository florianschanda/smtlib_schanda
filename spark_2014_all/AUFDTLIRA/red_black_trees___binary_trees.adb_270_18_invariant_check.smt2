...
(define-fun dynamic_invariant1 ((temp___expr_175 Int) (temp___is_init_171 Bool) (temp___skip_constant_172 Bool) (temp___do_toplevel_173 Bool) (temp___do_typ_inv_174 Bool)) Bool (=> (or (= temp___is_init_171 true) (<= 1 100)) (in_range4 temp___expr_175)))
...
(assert (forall ((f us_rep2)) (forall ((i Int)) (! (=> (and (dynamic_invariant1 i true true true true) (type_invariant f)) (=> (< (size f) i) (not (= (valid_root f i) true)))) :pattern ((valid_root f i))))))
...
(assert (forall ((f1 us_rep2)) (! (=> (type_invariant f1) (dynamic_invariant3 (size f1) true false true true)) :pattern ((size f1)))))
(assert (forall ((f1 us_rep2)) (! (= (size f1) (to_rep (rec__binary_trees__forest__s (us_split_fields3 f1)))) :pattern ((size f1)))))
(assert (forall ((f1 us_rep2)) (forall ((i Int)) (! (=> (and (dynamic_invariant1 i true true true true) (type_invariant f1)) (let ((result (parent f1 i))) (and (and (=> (= (valid_root f1 i) true) (= result 0)) (=> (= (size f1) 0) (= result 0))) (dynamic_invariant3 result true false true true)))) :pattern ((parent f1 i))))))
(assert (forall ((f1 us_rep2)) (forall ((i Int)) (! (=> (dynamic_invariant1 i true true true true) (= (parent f1 i) (to_rep (rec__binary_trees__cell__parent (us_split_fields1 (let ((temp___334 (rec__binary_trees__forest__c (us_split_fields3 f1)))) (select temp___334 i))))))) :pattern ((parent f1 i))))))
...
(assert (forall ((f1 us_rep2)) (forall ((i Int)) (! (=> (and (and (dynamic_invariant1 i true true true true) (type_invariant f1)) (not (= (parent f1 i) 0))) (dynamic_invariant4 (position f1 i) true false true true)) :pattern ((position f1 i))))))
(assert (forall ((f1 us_rep2)) (forall ((i Int)) (! (=> (dynamic_invariant1 i true true true true) (= (position f1 i) (to_rep1 (rec__binary_trees__cell__position (us_split_fields1 (let ((temp___338 (rec__binary_trees__forest__c (us_split_fields3 f1)))) (select temp___338 i))))))) :pattern ((position f1 i))))))
...
(define-fun dynamic_invariant6 ((temp___expr_239 us_rep3) (temp___is_init_235 Bool) (temp___skip_constant_236 Bool) (temp___do_toplevel_237 Bool) (temp___do_typ_inv_238 Bool)) Bool (=> (= temp___do_toplevel_237 true) (=> (= temp___is_init_235 true) (< (length (rec__tree_model__path_type__a (us_split_fields5 temp___expr_239))) 100))))
...
(declare-const n Int)
(declare-const i Int)
(declare-const temp___729 (Array Int us_rep3))
...
(assert (<= 1 n1))
(assert (<= n1 100))
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f t1) i1))) true) (< (length (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f t1) i1)))) n2)) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f t2) i1))) true))))))
(assert (and (=> (<= 1 100) (in_range4 n2)) (and (<= 1 n2) (<= n2 100))))
(assert (<= 1 i))
(assert (<= i 100))
(assert (= (tree_structure f) true))
(assert (and (= temp___729 (model__ f t1)) (and (dynamic_invariant2 temp___729 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___729 t1))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___729 t1)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 t1)) (ite (and (not (= (parent f i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___729 (parent f i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___729 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___729 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___729 i1))) true) (not (= i1 t1))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select temp___729 (parent f i1)))) (position f i1) (rec__tree_model__path_type__a (us_split_fields5 (select temp___729 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___729 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___729 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___729 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select temp___729 i1))) (rec__tree_model__path_type__a (us_split_fields5 (select temp___729 j)))) true)) (= j i1))))))))))))))
(assert (= (mk___rep2 (mk___split_fields2 o o1)) (select temp___729 i)))
(assert (= o o2))
(assert (= o1 o3))
(assert (= o4 o2))
