...
(assert (and (= o92 (length ma1)) (in_range6 o92)))
(assert (= o93 (- o92 2)))
(assert (= o94 (ite (<= j3 o93) true false)))
(assert (= result23 (ite (<= 1 j3) o94 false)))
(assert (= result23 true))
(assert (and (= o96 (+ j3 2)) (in_range1 (+ j3 2))))
(assert (and (= o97 (get ma1 o96)) (in_range7 o97)))
(assert (and (= o95 (+ j3 1)) (in_range1 (+ j3 1))))
(assert (and (= temp___404 (get ma1 o95)) (in_range7 temp___404)))
(assert (not (<= 1 temp___404)))
(check-sat)
(exit)
