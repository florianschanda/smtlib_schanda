...
(assert (and (= o36 (length ma1)) (in_range3 o36)))
(assert (= o37 (- o36 2)))
(assert (= o38 (ite (<= j o37) true false)))
(assert (= result10 (ite (<= 1 j) o38 false)))
(assert (= result10 true))
(assert (and (= o40 (+ j 2)) (in_range1 (+ j 2))))
(assert (and (= o41 (get ma1 o40)) (in_range4 o41)))
(assert (and (= o39 (+ j 1)) (in_range1 (+ j 1))))
(assert (and (= temp___437 (get ma1 o39)) (in_range4 temp___437)))
(assert (not (<= temp___437 3)))
(check-sat)
(exit)
