...
(assert (=> (not (= (int__content i14) 0)) (= o32 (select temp___776 o31))))
(assert (=> (not (= (int__content i14) 0)) (= o33 (us_split_fields1 o32))))
...
(assert (=> (= result19 true) (and (= o29 (root (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)))) (and (in_range3 o29) (= o29 (to_rep1 t__split_fields))))))
(assert (=> (= result19 true) (type_invariant1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))))
(assert (=> (= result19 true) (and (= o30 (root (mk___rep3 (us_split_fields__content3 t__split_fields14)))) (and (in_range3 o30) (= o30 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields__content3 t__split_fields14))))))))
