...
(assert (not (= (ite (<= (to_rep (first4 temp___2461)) (to_rep (last4 temp___2461))) (+ (- (to_rep (last4 temp___2461)) (to_rep (first4 temp___2461))) 1) 0) (ite (<= (to_rep u__first) (to_rep u__last)) (+ (- (to_rep u__last) (to_rep u__first)) 1) 0))))
(check-sat)
(exit)
