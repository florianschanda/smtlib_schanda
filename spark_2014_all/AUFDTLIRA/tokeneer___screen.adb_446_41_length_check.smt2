...
(assert (=> (<= temp___1797 3) (and (and (<= 1 temp___1797) (<= temp___1797 7)) (and (<= 1 3) (<= 3 7)))))
(assert (= o6 str2))
(assert (= o6 temp___1799))
(assert (= (mk4 temp___1797 3) temp___17991))
(assert (not (= (ite (<= (to_rep1 (first8 temp___17961)) (to_rep1 (last8 temp___17961))) (+ (- (to_rep1 (last8 temp___17961)) (to_rep1 (first8 temp___17961))) 1) 0) (ite (<= (to_rep1 (first8 temp___17991)) (to_rep1 (last8 temp___17991))) (+ (- (to_rep1 (last8 temp___17991)) (to_rep1 (first8 temp___17991))) 1) 0))))
(check-sat)
(exit)
