...
(assert (=> (= result1 true) (= o6 j)))
(assert (=> (= result1 true) (= o7 (select b o6))))
(assert (=> (= result1 true) (= o8 (to_rep o7))))
(assert (=> (= result1 true) (and (<= (to_rep b__first) j) (<= j (to_rep b__last)))))
(assert (=> (= result1 true) (= o4 j)))
(assert (=> (= result1 true) (= o5 (select b1 o4))))
(assert (=> (= result1 true) (= o9 (to_rep o5))))
(assert (=> (= result1 true) (= o10 (ite (= o9 o8) true false))))
(assert (=> (not (= result1 true)) (= o10 (distinct 1 0))))
