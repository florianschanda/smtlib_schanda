...
(assert (not (= (ite (<= (to_rep1 (first temp___5471)) (to_rep1 (last temp___5471))) (+ (- (to_rep1 (last temp___5471)) (to_rep1 (first temp___5471))) 1) 0) (ite (<= 1 (- (to_rep1 (last (rt a))) 1)) (+ (- (- (to_rep1 (last (rt a))) 1) 1) 1) 0))))
(check-sat)
(exit)
