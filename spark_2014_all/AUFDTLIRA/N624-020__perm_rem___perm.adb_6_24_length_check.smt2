...
(assert (not (= (ite (<= (to_rep1 (first temp___6111)) (to_rep1 (last temp___6111))) (+ (- (to_rep1 (last temp___6111)) (to_rep1 (first temp___6111))) 1) 0) (ite (<= 1 (- (to_rep1 (last (rt a))) 1)) (+ (- (- (to_rep1 (last (rt a))) 1) 1) 1) 0))))
(check-sat)
(exit)
