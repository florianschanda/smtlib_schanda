...
(assert (default_initial_assumption (mk___rep (mk___split_discrs o2__split_discrs) (mk___split_fields o2__split_fields o2__split_fields1) o2__attr__constrained) false))
(assert (not (= storage_place_attributes__r2__d3__first__bit storage_place_attributes__r2__d3__first__bit1)))
(check-sat)
(exit)
