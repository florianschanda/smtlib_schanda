...
(assert (=> (and (<= 1 r1) (<= r1 8)) (and (and (not (= done__2 true)) (forall ((j Int)) (=> (and (<= 1 j) (<= j (- i 1))) (= (to_rep (select b2 j)) (to_rep (select temp___216 j)))))) (=> (< (to_rep (select c i)) r2) (not (= (consistent c 8) true))))))
