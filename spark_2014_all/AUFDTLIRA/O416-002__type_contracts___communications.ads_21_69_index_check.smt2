...
(define-fun dynamic_invariant1 ((temp___expr_149 us_rep) (temp___is_init_146 Bool) (temp___skip_constant_147 Bool) (temp___do_toplevel_148 Bool)) Bool (=> (= temp___do_toplevel_148 true) (=> (= temp___is_init_146 true) (<= (let ((temp___152 (rec__messages__message__received (us_split_fields1 temp___expr_149)))) (let ((temp___151 (rec__messages__message__sent (us_split_fields1 temp___expr_149)))) (compare temp___151 1 10 temp___152 1 10))) 0))))
(define-fun dynamic_predicate ((temp___163 us_rep)) Bool (<= (let ((temp___166 (rec__messages__message__received (us_split_fields1 temp___163)))) (let ((temp___165 (rec__messages__message__sent (us_split_fields1 temp___163)))) (compare temp___165 1 10 temp___166 1 10))) 0))
...
(define-fun dynamic_invariant2 ((temp___expr_188 us_rep1) (temp___is_init_185 Bool) (temp___skip_constant_186 Bool) (temp___do_toplevel_187 Bool)) Bool (let ((temp___189 (rec__communications__communication__num (us_split_discrs1 temp___expr_188)))) (and (and (dynamic_property1 1 (to_rep temp___189) (first1 (rec__communications__communication__msgs (us_split_fields3 temp___expr_188))) (last1 (rec__communications__communication__msgs (us_split_fields3 temp___expr_188)))) (and (= (first1 (rec__communications__communication__msgs (us_split_fields3 temp___expr_188))) 1) (= (last1 (rec__communications__communication__msgs (us_split_fields3 temp___expr_188))) (to_rep temp___189)))) (forall ((temp___190 Int)) (=> (and (<= (first1 (rec__communications__communication__msgs (us_split_fields3 temp___expr_188))) temp___190) (<= temp___190 (last1 (rec__communications__communication__msgs (us_split_fields3 temp___expr_188))))) (=> (= temp___is_init_185 true) (let ((temp___191 (select (to_array (rec__communications__communication__msgs (us_split_fields3 temp___expr_188))) temp___190))) (<= (let ((temp___193 (rec__messages__message__received (us_split_fields1 temp___191)))) (let ((temp___192 (rec__messages__message__sent (us_split_fields1 temp___191)))) (compare temp___192 1 10 temp___193 1 10))) 0))))))))
(define-fun type_invariant ((temp___196 us_rep1)) Bool (forall ((idx Int)) (=> (and (<= 1 idx) (<= idx (- (to_rep (rec__communications__communication__num (us_split_discrs1 temp___196))) 1))) (<= (let ((temp___201 (rec__messages__message__received (us_split_fields1 (let ((temp___199 (rec__communications__communication__msgs (us_split_fields3 temp___196)))) (select (to_array temp___199) (+ idx 1))))))) (let ((temp___200 (rec__messages__message__received (us_split_fields1 (let ((temp___198 (rec__communications__communication__msgs (us_split_fields3 temp___196)))) (select (to_array temp___198) idx)))))) (compare temp___200 1 10 temp___201 1 10))) 0))))
...
(declare-const temp___num_287 Int)
(declare-const temp___288 positive)
(declare-const temp___2881 (Array Int us_rep))
(declare-const temp___2882 t)
...
(assert (dynamic_invariant2 (mk___rep1 (mk___split_discrs temp___288) (mk___split_fields1 (mk___t temp___2881 temp___2882))) true false true))
(assert (<= 1 idx))
(assert (<= idx (- (to_rep temp___288) 1)))
(assert (and (= temp___291 (+ idx 1)) (in_range1 (+ idx 1))))
(assert (not (<= (to_rep2 (first temp___2882)) temp___291)))
(check-sat)
(exit)
