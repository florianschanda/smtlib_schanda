...
(assert (forall ((temp___251 Int)) (=> (dynamic_invariant temp___251 true true true true) (forall ((temp___252 Int)) (= (to_rep (select (for_loop_array__a__aggregate_def temp___251) temp___252)) temp___251)))))
