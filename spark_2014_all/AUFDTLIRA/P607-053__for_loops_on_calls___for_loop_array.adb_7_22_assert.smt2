...
(assert (forall ((temp___219 Int)) (forall ((temp___220 Int)) (= (select (for_loop_array__a__aggregate_def temp___219) temp___220) (of_rep temp___219)))))
...
(assert (and (= (mk___rep (mk___split_fields o)) (from_nat_array a1)) (= a1 o)))
(assert (and (= for_loop_array__L_1__R4b__assume (to_nat_array (mk___rep (mk___split_fields o)))) (= for_loop_array__L_1__R4b__assume o)))
...
(assert (and (= (mk___rep (mk___split_fields o1)) (from_nat_array a1)) (= a1 o1)))
(assert (and (= for_loop_array__L_1__R6b__assume (to_nat_array (mk___rep (mk___split_fields o1)))) (= for_loop_array__L_1__R6b__assume o1)))
