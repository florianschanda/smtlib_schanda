...
(assert (= o27 v))
(assert (= (mk___rep1 (mk___split_fields1 o28 o29 o30 o31)) (select f_old__split_fields1 o27)))
(assert (= o28 o32))
(assert (= o29 o33))
(assert (= o30 o34))
(assert (= o31 o35))
...
(assert (= result (ite (= o37 2) true false)))
(assert (= result true))
(assert (and (<= 1 v) (<= v 100)))
(assert (= o15 v))
(assert (= (mk___rep1 (mk___split_fields1 o16 o17 o18 o19)) (select f__split_fields1 o15)))
(assert (= o16 o20))
(assert (= o17 o21))
(assert (= o18 o22))
(assert (= o19 o23))
...
(assert (= result1 (ite (not (= o26 true)) true false)))
(assert (= result1 true))
