...
(assert (and (<= 0 topstacki3) (<= topstacki3 99)))
(assert (= o34 topstacki3))
(assert (= o35 (select s__split_fields5 o34)))
(assert (= temp___544 (to_rep1 o35)))
(assert (and (<= 0 temp___544) (<= temp___544 99)))
(assert (= o36 temp___544))
(assert (= o37 (select s__split_fields3 o36)))
(assert (= o38 (to_rep1 o37)))
(assert (not (<= 0 topstacki3)))
(check-sat)
(exit)
