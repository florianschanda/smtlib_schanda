...
(assert (and (<= 0 topstacki2) (<= topstacki2 99)))
(assert (= o21 topstacki2))
(assert (= o22 (select s__split_fields5 o21)))
(assert (= o23 (to_rep1 o22)))
(assert (= result7 (ite (<= 0 o23) true false)))
(assert (=> (= result7 true) (and (<= 0 topstacki2) (<= topstacki2 99))))
(assert (=> (= result7 true) (= o18 topstacki2)))
(assert (=> (= result7 true) (= o19 (select s__split_fields5 o18))))
(assert (=> (= result7 true) (= o20 (to_rep1 o19))))
(assert (=> (= result7 true) (= result6 (ite (< o20 (to_rep1 s__split_fields2)) true false))))
(assert (=> (not (= result7 true)) (= result6 false)))
(assert (=> (= result6 true) (and (<= 0 topstacki2) (<= topstacki2 99))))
(assert (=> (= result6 true) (= o15 topstacki2)))
(assert (=> (= result6 true) (= o16 (select s__split_fields6 o15))))
(assert (=> (= result6 true) (= o17 (to_rep1 o16))))
(assert (=> (= result6 true) (= result5 (ite (<= 0 o17) true false))))
(assert (=> (not (= result6 true)) (= result5 false)))
(assert (= result5 true))
(assert (and (<= 0 topstacki2) (<= topstacki2 99)))
(assert (= o10 topstacki2))
(assert (= o11 (select s__split_fields5 o10)))
(assert (= temp___544 (to_rep1 o11)))
(assert (and (<= 0 temp___544) (<= temp___544 99)))
(assert (= o12 temp___544))
(assert (= o13 (select s__split_fields3 o12)))
