...
(assert (and (and (and (= us (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 source)))) (in_range4 (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 source))))) (and (and (= (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity to____split_discrs)) r118b) (in_range4 r118b)) (and (and (and (and (and (and (and (and (and (and (=> (<= 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 source)))) (and (and (<= (to_rep1 (first2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 source))))) 1) (<= 1 (to_rep1 (last2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 source))))))) (and (<= (to_rep1 (first2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 source))))) (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 source)))) (<= (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 source))) (to_rep1 (last2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 source))))))))) (= o (elts1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 source))))) (and (= o temp___1024) (= (mk4 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 source)))) temp___10241))) (and (= (ite (<= (to_rep1 (first8 temp___10241)) (to_rep1 (last9 temp___10241))) (+ (- (to_rep1 (last9 temp___10241)) (to_rep1 (first8 temp___10241))) 1) 0) (ite (<= 1 last6) (+ (- last6 1) 1) 0)) (and (= temp___1024 temp___1025) (= (mk3 (to_rep1 (first8 temp___10241)) (to_rep1 (last9 temp___10241))) temp___10251)))) (and (and (and (=> (<= 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 source)))) (and (and (<= (to_rep1 (first2 to____split_fields2)) 1) (<= 1 (to_rep1 (last2 to____split_fields2)))) (and (<= (to_rep1 (first2 to____split_fields2)) (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 source)))) (<= (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 source))) (to_rep1 (last2 to____split_fields2)))))) (= o1 to____split_fields1)) (and (= o1 temp___1029) (= (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 source)))) temp___10291))) (and (= (ite (<= (to_rep1 (first6 temp___10251)) (to_rep1 (last7 temp___10251))) (+ (- (to_rep1 (last7 temp___10251)) (to_rep1 (first6 temp___10251))) 1) 0) (ite (<= (to_rep1 (first6 temp___10291)) (to_rep1 (last7 temp___10291))) (+ (- (to_rep1 (last7 temp___10291)) (to_rep1 (first6 temp___10291))) 1) 0)) (= (mk___t3 temp___1031 temp___10311) (mk___t3 temp___1025 temp___10251))))) (and (and (= (to_rep1 (first2 to____split_fields2)) (to_rep1 (first2 o3))) (= (to_rep1 (last2 to____split_fields2)) (to_rep1 (last2 o3)))) (forall ((temp___1032 Int)) (ite (and (<= 1 temp___1032) (<= temp___1032 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 source))))) (= (select o2 temp___1032) (select temp___1031 temp___1032)) (= (select o2 temp___1032) (select to____split_fields1 temp___1032)))))) (and (= to____split_fields o4) (and (= o5 o2) (= o6 o3)))) (and (= to____split_discrs (mk___split_discrs temp___1034)) (and (= temp___10341 o4) (and (= temp___10342 o5) (= temp___10343 o6))))) (and (dynamic_predicate (mk___rep (mk___split_discrs temp___1034) (mk___split_fields temp___10341 (mk___t1 temp___10342 temp___10343)))) (= (mk___rep (mk___split_discrs temp___1035) (mk___split_fields temp___10351 (mk___t1 temp___10352 temp___10353))) (mk___rep (mk___split_discrs temp___1034) (mk___split_fields temp___10341 (mk___t1 temp___10342 temp___10343)))))) (and (and (= result (mk___split_fields__ref (mk___split_fields to____split_fields (mk___t1 to____split_fields1 to____split_fields2)))) (= to____split_fields3 (mk___split_fields temp___10351 (mk___t1 temp___10352 temp___10353)))) (= to____split_discrs (mk___split_discrs temp___1035)))) (and (and (and (and (= (to_rep2 o7) (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 source)))) (and (= o7 o8) (= (rec__bounded_dynamic_strings__sequence__content to____split_fields3) (mk___t1 o9 o10)))) (and (= to____split_discrs (mk___split_discrs temp___1037)) (and (= temp___10371 o8) (and (= temp___10372 o9) (= temp___10373 o10))))) (and (dynamic_predicate (mk___rep (mk___split_discrs temp___1037) (mk___split_fields temp___10371 (mk___t1 temp___10372 temp___10373)))) (= temp___1038 (mk___rep (mk___split_discrs temp___1037) (mk___split_fields temp___10371 (mk___t1 temp___10372 temp___10373)))))) (and (and (= result1 (mk___split_fields__ref to____split_fields3)) (= to____split_fields4 (us_split_fields1 temp___1038))) (= to____split_discrs (us_split_discrs1 temp___1038))))))) (and (= to____split_fields5 (mk___split_fields__ref to____split_fields4)) (= to____split_fields6 to____split_fields4))))
(assert (not (= (let ((temp___1048 (value source))) (let ((temp___1047 (value (mk___rep to____split_discrs (us_split_fields__content to____split_fields5))))) (bool_eq (elts temp___1047) (to_rep1 (first (rt temp___1047))) (to_rep1 (last (rt temp___1047))) (elts temp___1048) (to_rep1 (first (rt temp___1048))) (to_rep1 (last (rt temp___1048)))))) true)))
(check-sat)
(exit)
