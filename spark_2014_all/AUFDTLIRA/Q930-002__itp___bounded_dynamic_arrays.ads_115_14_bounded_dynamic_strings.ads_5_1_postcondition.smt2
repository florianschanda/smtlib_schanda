...
(define-fun temp___11004 () us_rep (mk___rep (mk___split_discrs temp___1100) (mk___split_fields temp___11001 (mk___t1 temp___11002 temp___11003))))
...
(assert (dynamic_predicate temp___11004))
(assert (= temp___1101 temp___11004))
(assert (= result1 (mk___split_fields__ref to____split_fields3)))
(assert (= to____split_fields4 (us_split_fields1 temp___1101)))
(assert (= to____split_discrs (us_split_discrs1 temp___1101)))
(assert (= to____split_fields5 (mk___split_fields__ref to____split_fields4)))
(assert (= to____split_fields6 to____split_fields4))
(assert (not (= (let ((temp___1111 (value source))) (let ((temp___1110 (value (mk___rep to____split_discrs (us_split_fields__content to____split_fields5))))) (bool_eq (elts temp___1110) (to_rep1 (first (rt temp___1110))) (to_rep1 (last (rt temp___1110))) (elts temp___1111) (to_rep1 (first (rt temp___1111))) (to_rep1 (last (rt temp___1111)))))) true)))
(check-sat)
(exit)
