...
(define-fun temp___1824 () us_rep (mk___rep (mk___split_discrs temp___182) (mk___split_fields (mk___t temp___1821 temp___1822) temp___1823)))
(assert (in_range temp___179))
(assert (= temp___179 (to_rep temp___178)))
(assert (and (dynamic_invariant1 temp___1824 true false true) (and (let ((temp___184 (temp___169 32 1 (to_rep temp___182)))) (and (= temp___1821 (elts1 temp___184)) (= temp___1822 (mk (to_rep3 (first2 (rt1 temp___184))) (to_rep3 (last2 (rt1 temp___184))))))) (= (to_rep1 temp___1823) 0))))
(assert (not (= (length2 temp___1824) 0)))
(check-sat)
(exit)
