...
(define-fun dynamic_invariant ((temp___expr_160 Int) (temp___is_init_156 Bool) (temp___skip_constant_157 Bool) (temp___do_toplevel_158 Bool) (temp___do_typ_inv_159 Bool)) Bool (=> (or (= temp___is_init_156 true) (<= 1 65536)) (in_range temp___expr_160)))
...
(define-fun dynamic_invariant2 ((temp___expr_167 Int) (temp___is_init_163 Bool) (temp___skip_constant_164 Bool) (temp___do_toplevel_165 Bool) (temp___do_typ_inv_166 Bool)) Bool (=> (or (= temp___is_init_163 true) (<= 0 65536)) (in_range1 temp___expr_167)))
...
(assert (forall ((temp___197 Int) (temp___198 Int) (temp___199 Int)) (let ((temp___196 (temp___195 temp___197 temp___198 temp___199))) (=> (dynamic_invariant4 temp___197 true true true true) (and (=> (dynamic_property4 1 2147483647 temp___198 temp___199) (and (= (first3 temp___196) temp___198) (= (last3 temp___196) temp___199))) (forall ((temp___200 Int)) (= (to_rep2 (select (to_array1 temp___196) temp___200)) temp___197)))))))
(declare-const temp___205 Int)
(declare-const temp___204 index_type)
(declare-const temp___208 index_type)
(declare-const temp___2081 (Array Int character))
(declare-const temp___2082 t)
(declare-const temp___2083 length_type)
(define-fun temp___2084 () us_rep (mk___rep (mk___split_discrs temp___208) (mk___split_fields (mk___t temp___2081 temp___2082) temp___2083)))
(assert (in_range temp___205))
(assert (= temp___205 (to_rep temp___204)))
(assert (and (dynamic_invariant1 temp___2084 true false true true) (and (let ((temp___210 (temp___195 32 1 (to_rep temp___208)))) (and (= temp___2081 (elts1 temp___210)) (= temp___2082 (mk (to_rep3 (first2 (rt1 temp___210))) (to_rep3 (last2 (rt1 temp___210))))))) (= (to_rep1 temp___2083) 0))))
(assert (not (= (length2 temp___2084) 0)))
(check-sat)
(exit)
