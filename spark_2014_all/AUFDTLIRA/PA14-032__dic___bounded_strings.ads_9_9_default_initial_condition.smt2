...
(define-fun dynamic_invariant ((temp___expr_137 Int) (temp___is_init_134 Bool) (temp___skip_constant_135 Bool) (temp___do_toplevel_136 Bool)) Bool (=> (or (= temp___is_init_134 true) (<= 1 65536)) (in_range temp___expr_137)))
...
(define-fun dynamic_invariant1 ((temp___expr_149 us_rep) (temp___is_init_146 Bool) (temp___skip_constant_147 Bool) (temp___do_toplevel_148 Bool)) Bool (let ((temp___150 (rec__bounded_strings__bounded_string__bound (us_split_discrs1 temp___expr_149)))) (and (dynamic_property1 1 (to_rep temp___150) (first1 (rec__bounded_strings__bounded_string__text (us_split_fields1 temp___expr_149))) (last1 (rec__bounded_strings__bounded_string__text (us_split_fields1 temp___expr_149)))) (and (= (first1 (rec__bounded_strings__bounded_string__text (us_split_fields1 temp___expr_149))) 1) (= (last1 (rec__bounded_strings__bounded_string__text (us_split_fields1 temp___expr_149))) (to_rep temp___150))))))
(declare-fun length2 (us_rep) Int)
(declare-fun length__function_guard (Int us_rep) Bool)
(define-fun dynamic_invariant2 ((temp___expr_143 Int) (temp___is_init_140 Bool) (temp___skip_constant_141 Bool) (temp___do_toplevel_142 Bool)) Bool (=> (or (= temp___is_init_140 true) (<= 0 65536)) (in_range1 temp___expr_143)))
...
(declare-fun temp___169 (Int Int Int) us_t1)
(assert (forall ((temp___171 Int) (temp___172 Int) (temp___173 Int)) (let ((temp___170 (temp___169 temp___171 temp___172 temp___173))) (and (=> (dynamic_property4 1 2147483647 temp___172 temp___173) (and (= (first3 temp___170) temp___172) (= (last3 temp___170) temp___173))) (forall ((temp___174 Int)) (= (select (to_array1 temp___170) temp___174) (of_rep2 temp___171)))))))
...
(declare-const temp___178 index_type)
(declare-const temp___181 (Array Int character))
(declare-const temp___1811 t1)
(declare-const temp___182 index_type)
(declare-const temp___1821 (Array Int character))
(declare-const temp___1822 t)
(declare-const temp___1823 length_type)
(assert (in_range temp___179))
(assert (= temp___179 (to_rep temp___178)))
(assert (and (dynamic_invariant1 (mk___rep (mk___split_discrs temp___182) (mk___split_fields (mk___t temp___1821 temp___1822) temp___1823)) true false true) (and (let ((temp___184 (temp___169 32 1 (to_rep temp___182)))) (and (= temp___1821 (elts1 temp___184)) (= temp___1822 (mk (to_rep3 (first2 (rt1 temp___184))) (to_rep3 (last2 (rt1 temp___184))))))) (= (to_rep1 temp___1823) 0))))
(assert (not (= (length2 (mk___rep (mk___split_discrs temp___182) (mk___split_fields (mk___t temp___1821 temp___1822) temp___1823))) 0)))
(check-sat)
(exit)
