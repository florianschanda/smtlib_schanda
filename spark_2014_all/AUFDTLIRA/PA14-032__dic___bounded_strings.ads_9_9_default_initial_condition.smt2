...
(assert (and (dynamic_invariant1 temp___2084 true false true true) (and (let ((temp___210 (temp_____aggregate_def_195 32 1 (to_rep temp___208)))) (and (= temp___2081 (elts1 temp___210)) (= temp___2082 (mk (to_rep3 (first2 (rt1 temp___210))) (to_rep3 (last2 (rt1 temp___210))))))) (= (to_rep1 temp___2083) 0))))
(assert (not (= (length1 temp___2084) 0)))
(check-sat)
(exit)
