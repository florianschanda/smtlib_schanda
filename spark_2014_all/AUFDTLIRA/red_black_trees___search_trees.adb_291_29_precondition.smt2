...
(assert (= o27 (select temp___1440 i9)))
...
(assert (=> (= result11 true) (= o25 (select temp___1441 o24))))
(assert (=> (= result11 true) (= o26 (us_split_fields5 o25))))
...
(assert (= o20 k))
(assert (= o21 (select temp___1443 o20)))
