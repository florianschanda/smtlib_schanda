...
(assert (and (= temp___1690 (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) root)) (and (dynamic_invariant3 temp___1690 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1690 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1690 root)))) 0) (and (forall ((i15 Int)) (=> (and (<= 1 i15) (<= i15 100)) (=> (not (= i15 root)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i15) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1690 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i15)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1690 i15))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1690 i15))) true)))))) (and (forall ((i15 Int)) (=> (and (<= 1 i15) (<= i15 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1690 i15))) true) (not (= i15 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1690 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i15)))) (position (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i15) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1690 i15)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1690 i15)))) 0)))) (forall ((i15 Int)) (=> (and (<= 1 i15) (<= i15 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1690 i15))) true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1690 j2))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1690 i15))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1690 j2)))) true)) (= j2 i15))))))))))))))
(assert (and (<= 1 v) (<= v 100)))
(assert (= o v))
...
(assert (and (<= 1 temp___1692) (<= temp___1692 100)))
(assert (= o10 temp___1692))
(assert (= (mk___rep (mk___split_fields o11 o12)) (select temp___1690 o10)))
(assert (= o11 o13))
(assert (= o12 o14))
(assert (= result2 o14))
(assert (= result2 true))
(assert (= (= result3 true) (forall ((i15 Int)) (=> (and (<= 1 i15) (<= i15 100)) (=> (not (= i15 v)) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i15)))) (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f_old__split_fields1 i15))))))))))
(assert (= result3 true))
(assert (= (= result4 true) (forall ((i15 Int)) (=> (and (<= 1 i15) (<= i15 100)) (=> (not (= i15 v)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 i15)))) (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f_old__split_fields1 i15))))))))))
(assert (= result4 true))
(assert (<= 1 j1))
(assert (<= j1 100))
