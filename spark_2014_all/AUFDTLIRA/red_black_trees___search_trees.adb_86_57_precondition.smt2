...
(assert (= o18 (select temp___1279 (int__content search_trees__find_root__result4))))
...
(assert (= o15 (select temp___1278 i)))
...
(assert (= o12 (select temp___1277 (int__content search_trees__find_root__result4))))
