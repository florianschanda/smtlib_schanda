...
(assert (and (<= (to_rep3 (first (rt (rec__integer_stacks__stack__values this__split_fields4)))) (to_rep (rec__integer_stacks__stack__top this__split_fields4))) (<= (to_rep (rec__integer_stacks__stack__top this__split_fields4)) (to_rep3 (last (rt (rec__integer_stacks__stack__values this__split_fields4)))))))
...
(assert (not (<= (to_rep temp___3163) (to_rep1 temp___316))))
(check-sat)
(exit)
