...
(assert (= (mk___rep (mk___split_discrs temp___284) (mk___split_fields (mk___t temp___2841 temp___2842) temp___2843 temp___2844) temp___2845) (mk___rep (mk___split_discrs temp___283) (mk___split_fields (mk___t temp___2831 temp___2832) temp___2833 temp___2834) temp___2835)))
...
(assert (= this__split_fields4 (mk___split_fields (mk___t temp___2841 temp___2842) temp___2843 temp___2844)))
...
(assert (not (<= (to_rep temp___2883) (to_rep1 temp___288))))
(check-sat)
(exit)
