...
(assert (=> (and (<= (+ starting_at 1) index1) (<= index1 limit)) (and (and (and (= limit temp___176) (<= starting_at min2)) (<= min2 limit)) (forall ((j Int)) (=> (and (<= starting_at j) (<= j (- index2 1))) (<= (to_rep (select values min2)) (to_rep (select values j))))))))
