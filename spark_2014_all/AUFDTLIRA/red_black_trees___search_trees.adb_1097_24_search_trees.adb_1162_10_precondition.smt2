...
(assert (and (= temp___1117 (model__ (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) o88)) (and (dynamic_invariant6 temp___1117 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1117 o88))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1117 o88)))) 0) (and (forall ((i6 Int)) (=> (and (<= 1 i6) (<= i6 100)) (=> (not (= i6 o88)) (ite (and (not (= (parent (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) i6) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1117 (parent (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) i6)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1117 i6))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1117 i6))) true)))))) (and (forall ((i6 Int)) (=> (and (<= 1 i6) (<= i6 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1117 i6))) true) (not (= i6 o88))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1117 (parent (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) i6)))) (position (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) i6) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1117 i6)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1117 i6)))) 0)))) (forall ((i6 Int)) (=> (and (<= 1 i6) (<= i6 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1117 i6))) true) (forall ((j15 Int)) (=> (and (<= 1 j15) (<= j15 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1117 j15))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1117 i6))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1117 j15)))) true)) (= j15 i6))))))))))))))
(assert (= o89 (select temp___1117 i3)))
(assert (= o90 (us_split_fields1 o89)))
(assert (= o91 (rec__tree_model__path_type__a o90)))
(assert (and (= o96 (olt o91 o95)) (= (= o96 true) (and (< (length o91) (length o95)) (forall ((n Int)) (=> (and (<= 1 n) (<= n (last o91))) (= (get o91 n) (get o95 n))))))))
(assert (and (= o85 (to_rep1 (rec__search_trees__search_tree__root t__split_fields11))) (in_range3 (to_rep1 (rec__search_trees__search_tree__root t__split_fields11)))))
(assert (and (= temp___1116 (model__ (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) o85)) (and (dynamic_invariant6 temp___1116 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1116 o85))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1116 o85)))) 0) (and (forall ((i6 Int)) (=> (and (<= 1 i6) (<= i6 100)) (=> (not (= i6 o85)) (ite (and (not (= (parent (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) i6) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1116 (parent (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) i6)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1116 i6))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1116 i6))) true)))))) (and (forall ((i6 Int)) (=> (and (<= 1 i6) (<= i6 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1116 i6))) true) (not (= i6 o85))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1116 (parent (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) i6)))) (position (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) i6) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1116 i6)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1116 i6)))) 0)))) (forall ((i6 Int)) (=> (and (<= 1 i6) (<= i6 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1116 i6))) true) (forall ((j15 Int)) (=> (and (<= 1 j15) (<= j15 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1116 j15))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1116 i6))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1116 j15)))) true)) (= j15 i6))))))))))))))
(assert (= o86 (select temp___1116 i3)))
(assert (= o87 (us_split_fields1 o86)))
(assert (= o97 (rec__tree_model__path_type__k o87)))
(assert (= result30 (ite (= o97 true) o96 false)))
(assert (= result30 true))
(assert (and (= o99 (to_rep1 (rec__search_trees__search_tree__root t__split_fields11))) (in_range3 (to_rep1 (rec__search_trees__search_tree__root t__split_fields11)))))
(assert (and (= temp___1115 (model__ (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) o99)) (and (dynamic_invariant6 temp___1115 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1115 o99))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1115 o99)))) 0) (and (forall ((i6 Int)) (=> (and (<= 1 i6) (<= i6 100)) (=> (not (= i6 o99)) (ite (and (not (= (parent (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) i6) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1115 (parent (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) i6)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1115 i6))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1115 i6))) true)))))) (and (forall ((i6 Int)) (=> (and (<= 1 i6) (<= i6 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1115 i6))) true) (not (= i6 o99))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1115 (parent (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) i6)))) (position (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) i6) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1115 i6)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1115 i6)))) 0)))) (forall ((i6 Int)) (=> (and (<= 1 i6) (<= i6 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1115 i6))) true) (forall ((j15 Int)) (=> (and (<= 1 j15) (<= j15 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1115 j15))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1115 i6))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1115 j15)))) true)) (= j15 i6))))))))))))))
(assert (= o100 (select temp___1115 i3)))
(assert (= o101 (us_split_fields1 o100)))
(assert (= o102 (rec__tree_model__path_type__a o101)))
(assert (and (= o103 (length o102)) (and (in_range6 o103) (<= (+ 0 o103) 2147483647))))
(assert (and (= o98 (to_rep1 (rec__search_trees__search_tree__root t__split_fields11))) (in_range3 (to_rep1 (rec__search_trees__search_tree__root t__split_fields11)))))
(assert (not (= (valid_root (mk___rep2 f_1__split_fields3) o98) true)))
(check-sat)
(exit)
