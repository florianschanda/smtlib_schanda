...
(define-fun dynamic_invariant1 ((temp___expr_164 Int) (temp___is_init_160 Bool) (temp___skip_constant_161 Bool) (temp___do_toplevel_162 Bool) (temp___do_typ_inv_163 Bool)) Bool (=> (or (= temp___is_init_160 true) (<= 0 1024)) (in_range1 temp___expr_164)))
(assert true)
...
(define-fun dynamic_invariant2 ((temp___expr_171 Int) (temp___is_init_167 Bool) (temp___skip_constant_168 Bool) (temp___do_toplevel_169 Bool) (temp___do_typ_inv_170 Bool)) Bool (=> (or (= temp___is_init_167 true) (<= 1 1024)) (in_range2 temp___expr_171)))
(declare-const x Int)
(declare-const pointer Int)
(assert (in_range1 pointer))
(assert (=> (<= (- 2147483648) 2147483647) (in_range x)))
(assert (not (= (is_empty pointer) true)))
