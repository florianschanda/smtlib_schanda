...
(assert (=> (= (int__content i14) 0) (and (= o29 (values1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))) (ite (= (size (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14))) 0) (= (is_empty o29) true) (and (forall ((i16 Int)) (=> (and (<= 1 i16) (<= i16 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields__content3 t__split_fields14)))) i16))) true) (= (contains o29 (to_rep (select (rec__search_trees__search_tree__values (us_split_fields__content3 t__split_fields14)) i16))) true)))) (forall ((v1 Int)) (=> (and (<= 0 v1) (<= v1 2147483647)) (=> (= (contains o29 v1) true) (exists ((i16 Int)) (and (and (<= 1 i16) (<= i16 100)) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields__content3 t__split_fields14)))) i16))) true) (= (to_rep (select (rec__search_trees__search_tree__values (us_split_fields__content3 t__split_fields14)) i16)) v1))))))))))))
...
(assert (=> (= result21 true) (= (= result20 true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (= (parent1 (mk___rep3 (us_split_fields__content3 t__split_fields14)) j1) (parent1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)) j1)))))))
(assert (=> (not (= result21 true)) (= result20 false)))
(assert (=> (= result20 true) (= (= result19 true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (not (= (parent1 (mk___rep3 (us_split_fields__content3 t__split_fields14)) j1) 0)) (= (position1 (mk___rep3 (us_split_fields__content3 t__split_fields14)) j1) (position1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)) j1))))))))
(assert (=> (not (= result20 true)) (= result19 false)))
(assert (=> (= result19 true) (= (= result18 true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__1 (mk___rep3 (us_split_fields__content3 t__split_fields14))) j1))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3))) j1))) true)))))))
