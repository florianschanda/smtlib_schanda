...
(assert (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (and (not (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields6) i5)))) 0)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields6) i5)))) 1)) (= (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields6) (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields6) i5)))))))) i5)))))
(assert (and (= (tree_structure (mk___rep2 f_old__split_fields2)) true) (= (tree_structure (mk___rep2 f__split_fields6)) true)))
(assert (not (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c f_old__split_fields2) root)))) 2)))
(check-sat)
(exit)
