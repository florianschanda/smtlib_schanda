...
(declare-const j Int)
(declare-const temp___987 (Array Int us_rep1))
...
(assert (= (= result16 true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root) j1))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (us_split_fields__content2 f__split_fields7)) root) j1))) true))))))
(assert (= result16 true))
(assert (<= 1 j))
(assert (<= j 100))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= temp___987 (model__ (mk___rep2 (us_split_fields__content2 f__split_fields7)) root)) (and (dynamic_invariant2 temp___987 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___987 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___987 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___987 (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___987 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___987 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___987 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___987 (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) i1)))) (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___987 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___987 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___987 i1))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___987 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___987 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___987 j1)))) true)) (= j1 i1))))))))))))))
(assert (= o41 (select temp___987 j)))
(assert (= o42 (us_split_fields1 o41)))
(assert (= o43 (rec__tree_model__path_type__k o42)))
(assert (= result17 (ite (= o43 true) (ite (not (= j (int__content v2))) true false) false)))
