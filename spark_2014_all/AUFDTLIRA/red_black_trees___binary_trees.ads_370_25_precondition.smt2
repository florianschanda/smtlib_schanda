...
(assert (<= j 100))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= temp___941 (model__ (mk___rep2 (us_split_fields__content2 f__split_fields7)) root)) (and (dynamic_invariant2 temp___941 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___941 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___941 root)))) 0) (and (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (not (= i5 root)) (ite (and (not (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) i5) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___941 (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) i5)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___941 i5))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___941 i5))) true)))))) (and (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___941 i5))) true) (not (= i5 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___941 (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) i5)))) (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) i5) (rec__tree_model__path_type__a (us_split_fields1 (select temp___941 i5)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___941 i5)))) 0)))) (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___941 i5))) true) (forall ((j6 Int)) (=> (and (<= 1 j6) (<= j6 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___941 j6))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___941 i5))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___941 j6)))) true)) (= j6 i5))))))))))))))
(assert (= o54 (select temp___941 j)))
(assert (= o55 (us_split_fields1 o54)))
(assert (= o56 (rec__tree_model__path_type__k o55)))
(assert (= result23 (ite (= o56 true) (ite (not (= j (int__content v2))) true false) false)))
