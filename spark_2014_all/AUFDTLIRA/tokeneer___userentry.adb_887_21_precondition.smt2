...
(assert (= result1 (greaterthan o6 (mk___rep (mk___split_fields tokenremovaltimeout__split_fields tokenremovaltimeout__split_fields1 tokenremovaltimeout__split_fields2 tokenremovaltimeout__split_fields3)))))
(assert (= result1 true))
