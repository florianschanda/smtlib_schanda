...
(assert (not (= (let ((temp___236 (temp___164 (mk___t values (mk (to_rep values__first) (to_rep values__last))) x (to_rep (select values y)) y (to_rep (select values x))))) (bool_eq values2 (to_rep values__first) (to_rep values__last) (elts temp___236) (to_rep (first (rt temp___236))) (to_rep (last (rt temp___236))))) true)))
(check-sat)
(exit)
