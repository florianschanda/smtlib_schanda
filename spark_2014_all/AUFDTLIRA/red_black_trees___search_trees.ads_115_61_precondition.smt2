...
(define-fun dynamic_invariant6 ((temp___expr_232 Int) (temp___is_init_229 Bool) (temp___skip_constant_230 Bool) (temp___do_toplevel_231 Bool)) Bool (=> (or (= temp___is_init_229 true) (<= 0 2147483647)) (in_range9 temp___expr_232)))
(declare-fun is_empty (us_rep2) Bool)
(declare-fun is_empty__function_guard (Bool us_rep2) Bool)
(define-fun default_initial_assumption1 ((temp___expr_239 us_rep2) (temp___skip_top_level_240 Bool)) Bool (=> (not (= temp___skip_top_level_240 true)) (= (is_empty temp___expr_239) true)))
(assert (forall ((container us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant6 item true true true) (=> (= (of_int 1) true) (=> (exists ((e Int)) (and (and (in_range9 e) (= (contains container e) true)) (= e item))) (= (contains container item) true)))) :pattern ((contains container item))))))
...
(assert (forall ((left us_rep2) (right us_rep2)) (! (= (= (oeq1 left right) true) (and (= (ole left right) true) (= (ole right left) true))) :pattern ((oeq1 left right)))))
...
(define-fun default_initial_assumption2 ((temp___expr_252 us_rep2) (temp___skip_top_level_253 Bool)) Bool (=> (not (= temp___skip_top_level_253 true)) (= (is_empty temp___expr_252) true)))
(assert true)
...
(define-fun dynamic_invariant7 ((temp___expr_150 Int) (temp___is_init_147 Bool) (temp___skip_constant_148 Bool) (temp___do_toplevel_149 Bool)) Bool (=> (or (= temp___is_init_147 true) (<= 1 100)) (in_range3 temp___expr_150)))
...
(define-fun dynamic_invariant8 ((temp___expr_273 us_rep4) (temp___is_init_270 Bool) (temp___skip_constant_271 Bool) (temp___do_toplevel_272 Bool)) Bool (= (tree_structure temp___expr_273) true))
...
(assert (forall ((t us_rep5)) (! (=> (and (dynamic_invariant10 t true true true) (type_invariant1 t)) (dynamic_invariant1 (size1 t) true false true)) :pattern ((size1 t)))))
(assert (forall ((t us_rep5)) (! (=> (dynamic_invariant10 t true true true) (= (size1 t) (size (rec__search_trees__search_tree__struct (us_split_fields7 t))))) :pattern ((size1 t)))))
(declare-fun root (us_rep5) Int)
(declare-fun root__function_guard (Int us_rep5) Bool)
(assert (forall ((t us_rep5)) (! (=> (and (and (dynamic_invariant10 t true true true) (type_invariant1 t)) (not (= (size1 t) 0))) (dynamic_invariant7 (root t) true false true)) :pattern ((root t)))))
(assert (forall ((t us_rep5)) (! (=> (dynamic_invariant10 t true true true) (= (root t) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))))) :pattern ((root t)))))
(declare-fun parent1 (us_rep5 Int) Int)
(declare-fun parent__function_guard1 (Int us_rep5 Int) Bool)
(assert (forall ((t us_rep5)) (forall ((i Int)) (! (=> (and (and (dynamic_invariant10 t true true true) (dynamic_invariant7 i true true true)) (type_invariant1 t)) (let ((result (parent1 t i))) (and (=> (= (size1 t) 0) (= result 0)) (dynamic_invariant1 result true false true)))) :pattern ((parent1 t i))))))
(assert (forall ((t us_rep5)) (forall ((i Int)) (! (=> (and (dynamic_invariant10 t true true true) (dynamic_invariant7 i true true true)) (= (parent1 t i) (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i))) :pattern ((parent1 t i))))))
(declare-fun position1 (us_rep5 Int) Int)
(declare-fun position__function_guard1 (Int us_rep5 Int) Bool)
(assert (forall ((t us_rep5)) (forall ((i Int)) (! (=> (and (and (and (dynamic_invariant10 t true true true) (dynamic_invariant7 i true true true)) (type_invariant1 t)) (not (= (parent1 t i) 0))) (dynamic_invariant2 (position1 t i) true false true)) :pattern ((position1 t i))))))
(assert (forall ((t us_rep5)) (forall ((i Int)) (! (=> (and (dynamic_invariant10 t true true true) (dynamic_invariant7 i true true true)) (= (position1 t i) (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i))) :pattern ((position1 t i))))))
(declare-fun model__1 (us_rep5) (Array Int us_rep1))
(declare-fun model____function_guard1 ((Array Int us_rep1) us_rep5) Bool)
(assert (forall ((t us_rep5)) (! (=> (and (and (dynamic_invariant10 t true true true) (type_invariant1 t)) (not (= (size1 t) 0))) (dynamic_invariant9 (model__1 t) true false true)) :pattern ((model__1 t)))))
(assert (forall ((t us_rep5)) (! (=> (dynamic_invariant10 t true true true) (= (model__1 t) (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))))) :pattern ((model__1 t)))))
(declare-fun peek1 (us_rep5 Int Int) Int)
(declare-fun peek__function_guard1 (Int us_rep5 Int Int) Bool)
(assert (forall ((t us_rep5)) (forall ((i Int) (d Int)) (! (=> (and (and (and (and (dynamic_invariant10 t true true true) (dynamic_invariant7 i true true true)) (dynamic_invariant2 d true true true)) (type_invariant1 t)) (and (not (= (size1 t) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (let ((temp___419 (model__1 t))) (select temp___419 i)))) true))) (dynamic_invariant1 (peek1 t i d) true false true)) :pattern ((peek1 t i d))))))
(assert (forall ((t us_rep5)) (forall ((i Int) (d Int)) (! (=> (and (and (dynamic_invariant10 t true true true) (dynamic_invariant7 i true true true)) (dynamic_invariant2 d true true true)) (= (peek1 t i d) (peek (rec__search_trees__search_tree__struct (us_split_fields7 t)) i d))) :pattern ((peek1 t i d))))))
...
(assert (forall ((t us_rep5)) (! (=> (and (dynamic_invariant10 t true true true) (type_invariant1 t)) (=> (= (size1 t) 0) (= (is_empty (values t)) true))) :pattern ((values t)))))
(assert (forall ((t us_rep5)) (! (=> (and (dynamic_invariant10 t true true true) (type_invariant1 t)) (let ((result (values1 t))) (ite (= (size (rec__search_trees__search_tree__struct (us_split_fields7 t))) 0) (= (is_empty result) true) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (let ((temp___429 (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))))) (select temp___429 i)))) true) (= (contains result (to_rep (let ((temp___428 (rec__search_trees__search_tree__values (us_split_fields7 t)))) (select temp___428 i)))) true)))) (forall ((v Int)) (=> (and (<= 0 v) (<= v 2147483647)) (=> (= (contains result v) true) (exists ((i Int)) (and (and (<= 1 i) (<= i 100)) (and (= (rec__tree_model__path_type__k (us_split_fields1 (let ((temp___430 (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))))) (select temp___430 i)))) true) (= (to_rep (let ((temp___431 (rec__search_trees__search_tree__values (us_split_fields7 t)))) (select temp___431 i))) v))))))))))) :pattern ((values1 t)))))
(declare-fun contains1 (us_rep5 Int) Bool)
(declare-fun contains__function_guard1 (Bool us_rep5 Int) Bool)
(assert (forall ((t us_rep5)) (forall ((v Int)) (! (=> (and (and (dynamic_invariant10 t true true true) (dynamic_invariant v true true true)) (type_invariant1 t)) (= (= (contains1 t v) true) (= (contains (values1 t) v) true))) :pattern ((contains1 t v))))))
...
(assert true)
(assert (forall ((f us_rep4)) (forall ((root1 Int)) (forall ((values2 (Array Int natural))) (! (= (= (ordered_leafs f root1 values2) true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (let ((temp___482 (model__ f root1))) (select temp___482 i)))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (let ((temp___483 (model__ f root1))) (select temp___483 j)))) true)) (= (olt (rec__tree_model__path_type__a (us_split_fields1 (let ((temp___484 (model__ f root1))) (select temp___484 i)))) (rec__tree_model__path_type__a (us_split_fields1 (let ((temp___485 (model__ f root1))) (select temp___485 j))))) true)) (ite (= (get (rec__tree_model__path_type__a (us_split_fields1 (let ((temp___480 (model__ f root1))) (select temp___480 j)))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (let ((temp___481 (model__ f root1))) (select temp___481 i))))) 1)) 0) (< (to_rep (select values2 j)) (to_rep (select values2 i))) (< (to_rep (select values2 i)) (to_rep (select values2 j)))))))))) :pattern ((ordered_leafs f root1 values2)))))))
(define-fun dynamic_invariant11 ((temp___expr_162 Int) (temp___is_init_159 Bool) (temp___skip_constant_160 Bool) (temp___do_toplevel_161 Bool)) Bool (=> (or (= temp___is_init_159 true) (<= 0 2)) (in_range10 temp___expr_162)))
(define-fun dynamic_invariant12 ((temp___expr_205 us_rep1) (temp___is_init_202 Bool) (temp___skip_constant_203 Bool) (temp___do_toplevel_204 Bool)) Bool (=> (= temp___do_toplevel_204 true) (=> (= temp___is_init_202 true) (< (length (rec__tree_model__path_type__a (us_split_fields1 temp___expr_205))) 100))))
...
(assert (forall ((f us_rep4)) (! (=> (dynamic_invariant8 f true true true) (dynamic_invariant1 (size f) true false true)) :pattern ((size f)))))
(assert (forall ((f us_rep4)) (forall ((i Int)) (! (=> (and (dynamic_invariant8 f true true true) (dynamic_invariant7 i true true true)) (=> (< (size f) i) (not (= (valid_root f i) true)))) :pattern ((valid_root f i))))))
(assert (forall ((f us_rep4)) (forall ((i Int)) (! (=> (and (dynamic_invariant8 f true true true) (dynamic_invariant7 i true true true)) (let ((result (parent f i))) (and (and (=> (= (valid_root f i) true) (= result 0)) (=> (= (size f) 0) (= result 0))) (dynamic_invariant1 result true false true)))) :pattern ((parent f i))))))
(assert (forall ((f us_rep4)) (forall ((i Int)) (! (=> (and (and (dynamic_invariant8 f true true true) (dynamic_invariant7 i true true true)) (not (= (parent f i) 0))) (dynamic_invariant2 (position f i) true false true)) :pattern ((position f i))))))
...
(assert (forall ((left us_rep2) (right us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant6 item true true true) (= (= (included_except left right item) true) (forall ((e Int)) (=> (and (in_range9 e) (= (contains left e) true)) (or (= (contains right e) true) (= e item)))))) :pattern ((included_except left right item))))))
...
(declare-const temp___794 (Array Int us_rep1))
...
(declare-const temp___789 (Array Int us_rep1))
(declare-const o108 us_rep1)
(declare-const o109 us_split_fields)
(declare-const j7 Int)
(declare-const temp___784 (Array Int us_rep1))
...
(declare-const binary_trees__init__f__fields us_split_fields4)
...
(declare-const binary_trees__insert__f__fields us_split_fields4)
...
(declare-const result19 us_split_fields__ref3)
...
(assert (< (size1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3))) 100))
(assert (= result (mk___split_fields__ref3 (mk___split_fields3 t_old__split_fields (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) t_old__split_fields3))))
...
(assert (or (and (and (and (= d15 (mk_int__ref d)) (and (= previous11 (mk_int__ref previous)) (and (= current11 (mk_int__ref current)) (and (= i16 (mk_int__ref i6)) (= t__split_fields12 (mk___split_fields__ref3 t__split_fields7)))))) (and (= d16 d4) (and (= previous12 previous1) (and (= current12 current1) (and (= i17 i6) (= t__split_fields13 t__split_fields7)))))) (and (= (to_rep1 t__split_fields) 0) (and (and (and (and (= (size (mk___rep2 binary_trees__init__f__fields)) (+ (size (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2))) 1)) (and (not (= (valid_root (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) binary_trees__init__root) true)) (and (= (valid_root (mk___rep2 binary_trees__init__f__fields) binary_trees__init__root) true) (and (forall ((i20 Int)) (=> (and (<= 1 i20) (<= i20 100)) (= (parent (mk___rep2 binary_trees__init__f__fields) i20) (parent (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) i20)))) (and (forall ((i20 Int)) (=> (and (<= 1 i20) (<= i20 100)) (=> (not (= (parent (mk___rep2 binary_trees__init__f__fields) i20) 0)) (= (position (mk___rep2 binary_trees__init__f__fields) i20) (position (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) i20))))) (and (forall ((i20 Int)) (=> (and (<= 1 i20) (<= i20 100)) (=> (= (valid_root (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) i20) true) (= (valid_root (mk___rep2 binary_trees__init__f__fields) i20) true)))) (and (forall ((i20 Int)) (=> (and (<= 1 i20) (<= i20 100)) (=> (and (= (valid_root (mk___rep2 binary_trees__init__f__fields) i20) true) (not (= i20 binary_trees__init__root))) (= (valid_root (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) i20) true)))) (and (forall ((i20 Int)) (=> (and (<= 1 i20) (<= i20 100)) (=> (= (valid_root (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) i20) true) (= (oeq2 (model__ (mk___rep2 binary_trees__init__f__fields) i20) (model__ (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) i20)) true)))) (forall ((i20 Int)) (=> (and (<= 1 i20) (<= i20 100)) (=> (not (= i20 binary_trees__init__root)) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 binary_trees__init__f__fields) binary_trees__init__root) i20))) true))))))))))))) (and (= (tree_structure (mk___rep2 binary_trees__init__f__fields)) true) (in_range3 binary_trees__init__root))) (and (and (= result1 (mk___split_fields__ref3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3))) (= t__split_fields5 (mk___split_fields3 t__split_fields (mk___rep2 binary_trees__init__f__fields) t__split_fields3))) (and (= result2 (mk_int__ref i)) (= i6 binary_trees__init__root)))) (and (and (and (and (and (= (to_rep o) v) (and (and (and (<= 1 i6) (<= i6 100)) (= o1 i6)) (= o2 (store (rec__search_trees__search_tree__values t__split_fields5) o1 o)))) (and (= (rec__search_trees__search_tree__root t__split_fields5) o3) (and (= (rec__search_trees__search_tree__struct t__split_fields5) (mk___rep2 (mk___split_fields2 o4 o5))) (= o2 o6)))) (and (= temp___704 o3) (and (and (= temp___7041 o4) (= temp___7042 o5)) (= temp___7043 o6)))) (and (= result3 (mk___split_fields__ref3 t__split_fields5)) (= t__split_fields6 (mk___split_fields3 temp___704 (mk___rep2 (mk___split_fields2 temp___7041 temp___7042)) temp___7043)))) (and (and (and (= (to_rep1 o7) i6) (and (= o7 o8) (and (= (rec__search_trees__search_tree__struct t__split_fields6) (mk___rep2 (mk___split_fields2 o9 o10))) (= (rec__search_trees__search_tree__values t__split_fields6) o11)))) (= temp___706 (mk___rep3 (mk___split_fields3 o8 (mk___rep2 (mk___split_fields2 o9 o10)) o11)))) (and (= result4 (mk___split_fields__ref3 t__split_fields6)) (= t__split_fields7 (us_split_fields7 temp___706)))))))) (and (and (not (= (to_rep1 t__split_fields) 0)) (and (and (= i6 i) (= t__split_fields7 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3))) (and (= i6 i5) (= t__split_fields7 t__split_fields4)))) (and (and (and (= d15 d13) (and (= previous11 previous9) (and (= current11 current9) (and (= i16 i14) (= t__split_fields12 t__split_fields10))))) (and (= d16 d14) (and (= previous12 previous10) (and (= current12 current10) (and (= i17 i15) (= t__split_fields13 t__split_fields11)))))) (or (and (and (and (= d13 (mk_int__ref d6)) (and (= previous9 (mk_int__ref previous4)) (and (= current9 (mk_int__ref current3)) (and (= i14 (mk_int__ref i8)) (= t__split_fields10 (mk___split_fields__ref3 t__split_fields7)))))) (and (= d14 d6) (and (= previous10 previous4) (and (= current10 current3) (and (= i15 i8) (= t__split_fields11 t__split_fields7)))))) (and (and (= result5 (mk_int__ref current)) (= current2 (to_rep1 (rec__search_trees__search_tree__root t__split_fields7)))) (and (in_range4 current2) (and (and (= result6 (mk_int__ref previous)) (= previous2 0)) (and (in_range4 previous2) (and (and (= result7 (mk_int__ref d)) (= d5 0)) (and (in_range5 d5) (and (not (= current2 0)) (and (= temp___718 current2) (and (= temp___717 i6) (and (= temp___716 d5) (and (= temp___715 previous2) (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields7) (to_rep1 (rec__search_trees__search_tree__root t__split_fields7))) current3))) true) (forall ((i20 Int)) (=> (and (<= 1 i20) (<= i20 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields7) (to_rep1 (rec__search_trees__search_tree__root t__split_fields7))) i20))) true) (=> (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields7) (to_rep1 (rec__search_trees__search_tree__root t__split_fields7))) i20))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields7) (to_rep1 (rec__search_trees__search_tree__root t__split_fields7))) current3)))) true) (ite (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields7) (to_rep1 (rec__search_trees__search_tree__root t__split_fields7))) current3))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields7) (to_rep1 (rec__search_trees__search_tree__root t__split_fields7))) i20)))) 1)) 0) (< v (to_rep (select (rec__search_trees__search_tree__values t__split_fields7) i20))) (< (to_rep (select (rec__search_trees__search_tree__values t__split_fields7) i20)) v))))))) (and (and (and (and (and (=> (<= 0 100) (in_range4 previous3)) (=> (<= 0 1) (in_range5 d6))) (=> (<= 0 100) (in_range4 i7))) (=> (<= 0 100) (in_range4 current3))) (not (= current3 0))) (and (and (= result10 (mk_int__ref previous3)) (= previous4 current3)) (and (and (and (and (and (and (<= 1 previous4) (<= previous4 100)) (= o38 previous4)) (= o39 (select (rec__search_trees__search_tree__values t__split_fields7) o38))) (= o40 (to_rep o39))) (= result11 (ite (= v o40) true false))) (and (= result11 true) (and (and (= result12 (mk_int__ref i7)) (= i8 0)) (and (exists ((i20 Int)) (and (and (<= 1 i20) (<= i20 100)) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__1 (mk___rep3 t__split_fields7)) i20))) true) (= (to_rep (select (rec__search_trees__search_tree__values t__split_fields7) i20)) v)))) (= (contains1 (mk___rep3 t__split_fields7) v) true)))))))))))))))))))) (and (and (and (= result5 (mk_int__ref current)) (= current2 (to_rep1 (rec__search_trees__search_tree__root t__split_fields7)))) (and (in_range4 current2) (and (and (= result6 (mk_int__ref previous)) (= previous2 0)) (and (in_range4 previous2) (and (and (= result7 (mk_int__ref d)) (= d5 0)) (and (in_range5 d5) (and (ite (not (= current2 0)) (and (and (and (= temp___718 current2) (and (= temp___717 i6) (and (= temp___716 d5) (and (= temp___715 previous2) (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields7) (to_rep1 (rec__search_trees__search_tree__root t__split_fields7))) current3))) true) (forall ((i20 Int)) (=> (and (<= 1 i20) (<= i20 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields7) (to_rep1 (rec__search_trees__search_tree__root t__split_fields7))) i20))) true) (=> (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields7) (to_rep1 (rec__search_trees__search_tree__root t__split_fields7))) i20))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields7) (to_rep1 (rec__search_trees__search_tree__root t__split_fields7))) current3)))) true) (ite (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields7) (to_rep1 (rec__search_trees__search_tree__root t__split_fields7))) current3))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields7) (to_rep1 (rec__search_trees__search_tree__root t__split_fields7))) i20)))) 1)) 0) (< v (to_rep (select (rec__search_trees__search_tree__values t__split_fields7) i20))) (< (to_rep (select (rec__search_trees__search_tree__values t__split_fields7) i20)) v))))))) (and (and (and (and (and (=> (<= 0 100) (in_range4 previous3)) (=> (<= 0 1) (in_range5 d6))) (=> (<= 0 100) (in_range4 i7))) (=> (<= 0 100) (in_range4 current3))) (not (= current3 0))) (and (and (= result10 (mk_int__ref previous3)) (= previous4 current3)) (and (and (and (and (and (and (and (<= 1 previous4) (<= previous4 100)) (= o38 previous4)) (= o39 (select (rec__search_trees__search_tree__values t__split_fields7) o38))) (= o40 (to_rep o39))) (= result11 (ite (= v o40) true false))) (and (not (= result11 true)) (and (and (and (and (and (and (and (<= 1 previous4) (<= previous4 100)) (= o41 previous4)) (= o42 (select (rec__search_trees__search_tree__values t__split_fields7) o41))) (= o43 (to_rep o42))) (= result13 (ite (< v o43) true false))) (ite (= result13 true) (and (= result14 (mk_int__ref d6)) (= d7 0)) (and (and (= result15 (mk_int__ref d6)) (= d8 1)) (= d7 d8)))) (= i8 i7)))) (and (and (and (and (= o44 previous4) (in_range3 previous4)) (and (= o45 (peek (rec__search_trees__search_tree__struct t__split_fields7) o44 d7)) (and (in_range4 o45) (and (ite (not (= o45 0)) (and (= (position (rec__search_trees__search_tree__struct t__split_fields7) o45) d7) (= (parent (rec__search_trees__search_tree__struct t__split_fields7) o45) o44)) (forall ((j10 Int)) (=> (and (<= 1 j10) (<= j10 100)) (=> (= (parent (rec__search_trees__search_tree__struct t__split_fields7) j10) o44) (not (= (position (rec__search_trees__search_tree__struct t__split_fields7) j10) d7)))))) (forall ((j10 Int)) (=> (and (<= 1 j10) (<= j10 100)) (=> (and (= (parent (rec__search_trees__search_tree__struct t__split_fields7) j10) o44) (= (position (rec__search_trees__search_tree__struct t__split_fields7) j10) d7)) (= o45 j10)))))))) (and (= result16 (mk_int__ref current3)) (= current4 o45))) (= current4 0)))))))))) (and (and (= d9 (mk_int__ref d7)) (and (= previous5 (mk_int__ref previous4)) (and (= current5 (mk_int__ref current4)) (= i9 (mk_int__ref i8))))) (and (= d10 d7) (and (= previous6 previous4) (and (= current6 current4) (= i10 i8)))))) (and (and (= d11 d9) (and (= previous7 previous5) (and (= current7 current5) (= i11 i9)))) (and (= d12 d10) (and (= previous8 previous6) (and (= current8 current6) (= i12 i10)))))) (and (and (= d11 (mk_int__ref d5)) (and (= previous7 (mk_int__ref previous2)) (and (= current7 (mk_int__ref current2)) (= i11 (mk_int__ref i6))))) (and (= d12 d5) (and (= previous8 previous2) (and (= current8 current2) (= i12 i6)))))) (and (and (and (= o46 (int__content previous7)) (in_range3 (int__content previous7))) (forall ((i20 Int)) (=> (and (<= 1 i20) (<= i20 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields7) (to_rep1 (rec__search_trees__search_tree__root t__split_fields7))) i20))) true) (not (= (to_rep (select (rec__search_trees__search_tree__values t__split_fields7) i20)) v)))))) (and (and (and (and (= o48 (int__content previous7)) (in_range3 (int__content previous7))) (and (and (= o47 (to_rep1 (rec__search_trees__search_tree__root t__split_fields7))) (in_range3 (to_rep1 (rec__search_trees__search_tree__root t__split_fields7)))) (and (and (= (size (mk___rep2 binary_trees__insert__f__fields)) (+ (size (mk___rep2 (us_split_fields5 (rec__search_trees__search_tree__struct t__split_fields7)))) 1)) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 binary_trees__insert__f__fields) o47) o48))) true) (and (= (peek (mk___rep2 binary_trees__insert__f__fields) o48 (int__content d11)) binary_trees__insert__v) (and (forall ((i20 Int)) (=> (and (<= 1 i20) (<= i20 100)) (ite (= (valid_root (mk___rep2 (us_split_fields5 (rec__search_trees__search_tree__struct t__split_fields7))) i20) true) (= (valid_root (mk___rep2 binary_trees__insert__f__fields) i20) true) (not (= (valid_root (mk___rep2 binary_trees__insert__f__fields) i20) true))))) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 binary_trees__insert__f__fields) o47) binary_trees__insert__v))) true) (and (not (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (us_split_fields5 (rec__search_trees__search_tree__struct t__split_fields7))) o47) binary_trees__insert__v))) true)) (and (forall ((j10 Int)) (=> (and (<= 1 j10) (<= j10 100)) (=> (not (= j10 binary_trees__insert__v)) (= (parent (mk___rep2 binary_trees__insert__f__fields) j10) (parent (mk___rep2 (us_split_fields5 (rec__search_trees__search_tree__struct t__split_fields7))) j10))))) (and (forall ((j10 Int)) (=> (and (<= 1 j10) (<= j10 100)) (=> (and (not (= j10 binary_trees__insert__v)) (not (= (parent (mk___rep2 (us_split_fields5 (rec__search_trees__search_tree__struct t__split_fields7))) j10) 0))) (= (position (mk___rep2 binary_trees__insert__f__fields) j10) (position (mk___rep2 (us_split_fields5 (rec__search_trees__search_tree__struct t__split_fields7))) j10))))) (and (forall ((j10 Int)) (=> (and (<= 1 j10) (<= j10 100)) (forall ((e Int)) (=> (and (<= 0 e) (<= e 1)) (=> (or (not (= j10 o48)) (not (= e (int__content d11)))) (= (peek (mk___rep2 binary_trees__insert__f__fields) j10 e) (peek (mk___rep2 (us_split_fields5 (rec__search_trees__search_tree__struct t__split_fields7))) j10 e))))))) (and (forall ((j10 Int)) (=> (and (<= 1 j10) (<= j10 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 binary_trees__insert__f__fields) o47) j10))) true) (or (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (us_split_fields5 (rec__search_trees__search_tree__struct t__split_fields7))) o47) j10))) true) (= j10 binary_trees__insert__v))))) (and (forall ((j10 Int)) (=> (and (<= 1 j10) (<= j10 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (us_split_fields5 (rec__search_trees__search_tree__struct t__split_fields7))) o47) j10))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 binary_trees__insert__f__fields) o47) j10))) true)))) (and (forall ((j10 Int)) (=> (and (<= 1 j10) (<= j10 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 binary_trees__insert__f__fields) o47) j10))) true) (not (= j10 binary_trees__insert__v))) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 binary_trees__insert__f__fields) o47) j10))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 (us_split_fields5 (rec__search_trees__search_tree__struct t__split_fields7))) o47) j10)))) true)))) (and (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 binary_trees__insert__f__fields) o47) o48))) (int__content d11) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 binary_trees__insert__f__fields) o47) binary_trees__insert__v)))) true) (forall ((i20 Int)) (=> (and (<= 1 i20) (<= i20 100)) (=> (and (not (= i20 o47)) (= (valid_root (mk___rep2 (us_split_fields5 (rec__search_trees__search_tree__struct t__split_fields7))) i20) true)) (= (oeq2 (model__ (mk___rep2 binary_trees__insert__f__fields) i20) (model__ (mk___rep2 (us_split_fields5 (rec__search_trees__search_tree__struct t__split_fields7))) i20)) true))))))))))))))))) (and (= (tree_structure (mk___rep2 binary_trees__insert__f__fields)) true) (in_range3 binary_trees__insert__v))))) (and (and (= result17 (mk___split_fields__ref3 t__split_fields7)) (= t__split_fields8 (mk___split_fields3 (rec__search_trees__search_tree__root t__split_fields7) (mk___rep2 binary_trees__insert__f__fields) (rec__search_trees__search_tree__values t__split_fields7)))) (and (= result18 i11) (= i13 binary_trees__insert__v)))) (and (and (and (and (and (= (to_rep o49) v) (and (and (and (<= 1 i13) (<= i13 100)) (= o50 i13)) (= o51 (store (rec__search_trees__search_tree__values t__split_fields8) o50 o49)))) (= o52 (mk___split_fields3 (rec__search_trees__search_tree__root t__split_fields8) (rec__search_trees__search_tree__struct t__split_fields8) o51))) (= temp___746 (mk___rep3 o52))) (and (= result19 (mk___split_fields__ref3 t__split_fields8)) (= t__split_fields9 (us_split_fields7 temp___746)))) (and (and (and (= o53 (int__content previous7)) (in_range3 (int__content previous7))) (type_invariant1 (mk___rep3 t_old__split_fields4))) (and (and (= o54 (int__content previous7)) (in_range3 (int__content previous7))) (= (ordered_leafs (rec__search_trees__search_tree__struct t__split_fields9) (to_rep1 (rec__search_trees__search_tree__root t__split_fields9)) (rec__search_trees__search_tree__values t__split_fields9)) true))))))))))))) (and (and (= d13 d11) (and (= previous9 previous7) (and (= current9 current7) (and (= i14 (mk_int__ref i13)) (= t__split_fields10 (mk___split_fields__ref3 t__split_fields9)))))) (and (= d14 d12) (and (= previous10 previous8) (and (= current10 current8) (and (= i15 i13) (= t__split_fields11 t__split_fields9))))))))))))
(assert (= d17 d15))
...
(assert (=> (= (contains (values1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3))) v) true) (and (and (and (and (and (and (= (int__content i18) 0) (= (oeq1 (values1 (mk___rep3 (us_split_fields__content3 t__split_fields14))) (values1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)))) true)) (forall ((j10 Int)) (=> (and (<= 1 j10) (<= j10 100)) (= (parent1 (mk___rep3 (us_split_fields__content3 t__split_fields14)) j10) (parent1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)) j10))))) (forall ((j10 Int)) (=> (and (<= 1 j10) (<= j10 100)) (=> (not (= (parent1 (mk___rep3 (us_split_fields__content3 t__split_fields14)) j10) 0)) (= (position1 (mk___rep3 (us_split_fields__content3 t__split_fields14)) j10) (position1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)) j10)))))) (forall ((j10 Int)) (=> (and (<= 1 j10) (<= j10 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__1 (mk___rep3 (us_split_fields__content3 t__split_fields14))) j10))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3))) j10))) true))))) (forall ((j10 Int)) (=> (and (<= 1 j10) (<= j10 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3))) j10))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__1 (mk___rep3 (us_split_fields__content3 t__split_fields14))) j10))) true))))) (forall ((j10 Int)) (=> (and (<= 1 j10) (<= j10 100)) (forall ((d19 Int)) (=> (and (<= 0 d19) (<= d19 1)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__1 (mk___rep3 (us_split_fields__content3 t__split_fields14))) j10))) true) (= (peek1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)) j10 d19) (peek1 (mk___rep3 (us_split_fields__content3 t__split_fields14)) j10 d19))))))))))
(assert (=> (= (= (size1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3))) 0) true) (and (and (and (and (and (not (= (int__content i18) 0)) (= (size1 (mk___rep3 (us_split_fields__content3 t__split_fields14))) 1)) (= (root (mk___rep3 (us_split_fields__content3 t__split_fields14))) (int__content i18))) (= (is_add__2 (values1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3))) v (values1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))) true)) (forall ((i20 Int)) (=> (and (<= 1 i20) (<= i20 100)) (=> (not (= i20 (root (mk___rep3 (us_split_fields__content3 t__split_fields14))))) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__1 (mk___rep3 (us_split_fields__content3 t__split_fields14))) i20))) true)))))) (forall ((i20 Int)) (=> (and (<= 1 i20) (<= i20 100)) (= (parent1 (mk___rep3 (us_split_fields__content3 t__split_fields14)) i20) (parent1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)) i20)))))))
(assert (not (= (ite (= (contains (values1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3))) v) false) (= (size1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3))) 0) true) true)))
(assert (=> (not (= (int__content i18) 0)) (type_invariant1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))))
(assert (=> (not (= (int__content i18) 0)) (and (= temp___776 (model__1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))) (and (dynamic_invariant9 temp___776 true false true) (= temp___776 (model__ (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields__content3 t__split_fields14)))))))))
(assert (=> (not (= (int__content i18) 0)) (and (<= 1 (int__content i18)) (<= (int__content i18) 100))))
(assert (=> (not (= (int__content i18) 0)) (= o123 (int__content i18))))
(assert (=> (not (= (int__content i18) 0)) (= o124 (select temp___776 o123))))
(assert (=> (not (= (int__content i18) 0)) (= o125 (us_split_fields1 o124))))
(assert (=> (not (= (int__content i18) 0)) (= result43 (rec__tree_model__path_type__k o125))))
(assert (=> (= (int__content i18) 0) (= result43 false)))
(assert (=> (= result43 true) (type_invariant1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)))))
(assert (=> (= result43 true) (and (= o121 (root (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)))) (and (in_range3 o121) (= o121 (to_rep1 t__split_fields))))))
(assert (=> (= result43 true) (type_invariant1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))))
(assert (=> (= result43 true) (and (= o122 (root (mk___rep3 (us_split_fields__content3 t__split_fields14)))) (and (in_range3 o122) (= o122 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields__content3 t__split_fields14))))))))
(assert (=> (= result43 true) (= result42 (ite (= o122 o121) true false))))
(assert (=> (not (= result43 true)) (= result42 false)))
(assert (=> (= result42 true) (type_invariant1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))))
(assert (=> (= result42 true) (and (= o120 (size1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))) (and (in_range4 o120) (= o120 (size (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14))))))))
(assert (=> (= result42 true) (= result41 (ite (= o120 (+ (size1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3))) 1)) true false))))
(assert (=> (not (= result42 true)) (= result41 false)))
(assert (=> (= result41 true) (type_invariant1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))))
(assert (=> (= result41 true) (and (= o119 (values1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))) (ite (= (size (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14))) 0) (= (is_empty o119) true) (and (forall ((i20 Int)) (=> (and (<= 1 i20) (<= i20 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields__content3 t__split_fields14)))) i20))) true) (= (contains o119 (to_rep (select (rec__search_trees__search_tree__values (us_split_fields__content3 t__split_fields14)) i20))) true)))) (forall ((v1 Int)) (=> (and (<= 0 v1) (<= v1 2147483647)) (=> (= (contains o119 v1) true) (exists ((i20 Int)) (and (and (<= 1 i20) (<= i20 100)) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields__content3 t__split_fields14)))) i20))) true) (= (to_rep (select (rec__search_trees__search_tree__values (us_split_fields__content3 t__split_fields14)) i20)) v1))))))))))))
(assert (=> (= result41 true) (type_invariant1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)))))
(assert (=> (= result41 true) (and (= o118 (values1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)))) (ite (= (size (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2))) 0) (= (is_empty o118) true) (and (forall ((i20 Int)) (=> (and (<= 1 i20) (<= i20 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) (to_rep1 t__split_fields)) i20))) true) (= (contains o118 (to_rep (select t__split_fields3 i20))) true)))) (forall ((v1 Int)) (=> (and (<= 0 v1) (<= v1 2147483647)) (=> (= (contains o118 v1) true) (exists ((i20 Int)) (and (and (<= 1 i20) (<= i20 100)) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) (to_rep1 t__split_fields)) i20))) true) (= (to_rep (select t__split_fields3 i20)) v1))))))))))))
(assert (=> (= result41 true) (and (= result40 (is_add__2 o118 v o119)) (= (= result40 true) (and (and (and (not (= (contains o118 v) true)) (= (contains o119 v) true)) (= (ole o118 o119) true)) (= (included_except o119 o118 v) true))))))
(assert (=> (not (= result41 true)) (= result40 false)))
(assert (=> (= result40 true) (= (= result39 true) (forall ((j10 Int)) (=> (and (<= 1 j10) (<= j10 100)) (=> (not (= (int__content i18) j10)) (= (parent1 (mk___rep3 (us_split_fields__content3 t__split_fields14)) j10) (parent1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)) j10))))))))
(assert (=> (not (= result40 true)) (= result39 false)))
(assert (=> (= result39 true) (= (= result38 true) (forall ((j10 Int)) (=> (and (<= 1 j10) (<= j10 100)) (=> (and (not (= (int__content i18) j10)) (not (= (parent1 (mk___rep3 (us_split_fields__content3 t__split_fields14)) j10) 0))) (= (position1 (mk___rep3 (us_split_fields__content3 t__split_fields14)) j10) (position1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)) j10))))))))
(assert (=> (not (= result39 true)) (= result38 false)))
(assert (=> (= result38 true) (= (= result37 true) (forall ((j10 Int)) (=> (and (<= 1 j10) (<= j10 100)) (=> (and (not (= (int__content i18) j10)) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__1 (mk___rep3 (us_split_fields__content3 t__split_fields14))) j10))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3))) j10))) true)))))))
(assert (=> (not (= result38 true)) (= result37 false)))
(assert (=> (= result37 true) (= (= result36 true) (forall ((j10 Int)) (=> (and (<= 1 j10) (<= j10 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3))) j10))) true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__1 (mk___rep3 (us_split_fields__content3 t__split_fields14))) j10))) true) (not (= (int__content i18) j10)))))))))
(assert (=> (not (= result37 true)) (= result36 false)))
(assert (=> (= result36 true) (= (= result35 true) (forall ((d19 Int)) (=> (and (<= 0 d19) (<= d19 1)) (= (peek1 (mk___rep3 (us_split_fields__content3 t__split_fields14)) (int__content i18) d19) 0))))))
(assert (=> (not (= result36 true)) (= result35 false)))
(assert (=> (= result35 true) (and (= o95 (int__content i18)) (in_range3 (int__content i18)))))
(assert (=> (= result35 true) (type_invariant1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))))
(assert (=> (= result35 true) (and (= o96 (int__content i18)) (in_range3 (int__content i18)))))
(assert (=> (= result35 true) (and (= o97 (position1 (mk___rep3 (us_split_fields__content3 t__split_fields14)) o96)) (and (in_range5 o97) (= o97 (position (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14)) o96))))))
(assert (=> (= result35 true) (and (= o91 (int__content i18)) (in_range3 (int__content i18)))))
(assert (=> (= result35 true) (type_invariant1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))))
(assert (=> (= result35 true) (and (= o92 (int__content i18)) (in_range3 (int__content i18)))))
(assert (=> (= result35 true) (and (= o93 (parent1 (mk___rep3 (us_split_fields__content3 t__split_fields14)) o92)) (and (in_range4 o93) (and (= o93 (parent (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14)) o92)) (=> (= (size1 (mk___rep3 (us_split_fields__content3 t__split_fields14))) 0) (= o93 0)))))))
(assert (=> (= result35 true) (and (= o94 o93) (in_range3 o93))))
(assert (=> (= result35 true) (type_invariant1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)))))
(assert (=> (= result35 true) (and (= o102 (int__content i18)) (in_range3 (int__content i18)))))
(assert (=> (= result35 true) (type_invariant1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))))
(assert (=> (= result35 true) (and (= o103 (int__content i18)) (in_range3 (int__content i18)))))
(assert (=> (= result35 true) (and (= o104 (position1 (mk___rep3 (us_split_fields__content3 t__split_fields14)) o103)) (and (in_range5 o104) (= o104 (position (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14)) o103))))))
(assert (=> (= result35 true) (and (= o98 (int__content i18)) (in_range3 (int__content i18)))))
(assert (=> (= result35 true) (type_invariant1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))))
(assert (=> (= result35 true) (and (= o99 (int__content i18)) (in_range3 (int__content i18)))))
(assert (=> (= result35 true) (and (= o100 (parent1 (mk___rep3 (us_split_fields__content3 t__split_fields14)) o99)) (and (in_range4 o100) (and (= o100 (parent (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14)) o99)) (=> (= (size1 (mk___rep3 (us_split_fields__content3 t__split_fields14))) 0) (= o100 0)))))))
(assert (=> (= result35 true) (and (= o101 o100) (in_range3 o100))))
(assert (=> (= result35 true) (and (= o105 (peek1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)) o101 o104)) (and (in_range4 o105) (= o105 (peek (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) o101 o104))))))
(assert (=> (= result35 true) (= result34 (ite (= o105 0) true false))))
(assert (=> (not (= result35 true)) (= result34 false)))
(assert (= result34 true))
(assert (<= 1 j5))
(assert (<= j5 100))
(assert (<= 0 d2))
(assert (<= d2 1))
(assert (and (= o82 (int__content i18)) (in_range3 (int__content i18))))
(assert (type_invariant1 (mk___rep3 (us_split_fields__content3 t__split_fields14))))
(assert (and (= o83 (int__content i18)) (in_range3 (int__content i18))))
(assert (not (not (= (parent1 (mk___rep3 (us_split_fields__content3 t__split_fields14)) o83) 0))))
(check-sat)
(exit)
