...
(define-fun default_initial_assumption2 ((temp___expr_291 us_rep2) (temp___skip_top_level_292 Bool)) Bool (=> (not (= temp___skip_top_level_292 true)) (= (is_empty temp___expr_291) true)))
(assert true)
...
(define-fun dynamic_invariant7 ((temp___expr_175 Int) (temp___is_init_171 Bool) (temp___skip_constant_172 Bool) (temp___do_toplevel_173 Bool) (temp___do_typ_inv_174 Bool)) Bool (=> (or (= temp___is_init_171 true) (<= 1 100)) (in_range3 temp___expr_175)))
...
(define-fun dynamic_invariant8 ((temp___expr_315 us_rep4) (temp___is_init_311 Bool) (temp___skip_constant_312 Bool) (temp___do_toplevel_313 Bool) (temp___do_typ_inv_314 Bool)) Bool (=> (= temp___do_typ_inv_314 true) (= (tree_structure temp___expr_315) true)))
...
(assert (forall ((f us_rep4)) (forall ((i Int) (d Int)) (! (=> (and (and (dynamic_invariant8 f true true true true) (dynamic_invariant7 i true true true true)) (dynamic_invariant2 d true true true true)) (let ((result (peek f i d))) (and (and (ite (not (= result 0)) (and (= (position f result) d) (= (parent f result) i)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (parent f j) i) (not (= (position f j) d)))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (parent f j) i) (= (position f j) d)) (= result j))))) (dynamic_invariant1 result true false true true)))) :pattern ((peek f i d))))))
...
(assert (forall ((t us_rep5)) (! (=> (and (dynamic_invariant10 t true true true true) (type_invariant1 t)) (dynamic_invariant1 (size1 t) true false true true)) :pattern ((size1 t)))))
...
(assert (forall ((t us_rep5)) (! (=> (and (and (dynamic_invariant10 t true true true true) (type_invariant1 t)) (not (= (size1 t) 0))) (dynamic_invariant7 (root t) true false true true)) :pattern ((root t)))))
...
(assert (forall ((t us_rep5)) (forall ((i Int)) (! (=> (and (and (dynamic_invariant10 t true true true true) (dynamic_invariant7 i true true true true)) (type_invariant1 t)) (let ((result (parent1 t i))) (and (=> (= (size1 t) 0) (= result 0)) (dynamic_invariant1 result true false true true)))) :pattern ((parent1 t i))))))
(assert (forall ((t us_rep5)) (forall ((i Int)) (! (=> (and (dynamic_invariant10 t true true true true) (dynamic_invariant7 i true true true true)) (= (parent1 t i) (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i))) :pattern ((parent1 t i))))))
(declare-fun position1 (us_rep5 Int) Int)
(declare-fun position__function_guard1 (Int us_rep5 Int) Bool)
(assert (forall ((t us_rep5)) (forall ((i Int)) (! (=> (and (and (and (dynamic_invariant10 t true true true true) (dynamic_invariant7 i true true true true)) (type_invariant1 t)) (not (= (parent1 t i) 0))) (dynamic_invariant2 (position1 t i) true false true true)) :pattern ((position1 t i))))))
(assert (forall ((t us_rep5)) (forall ((i Int)) (! (=> (and (dynamic_invariant10 t true true true true) (dynamic_invariant7 i true true true true)) (= (position1 t i) (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i))) :pattern ((position1 t i))))))
...
(assert (forall ((t us_rep5)) (forall ((i Int) (d Int)) (! (=> (and (and (and (and (dynamic_invariant10 t true true true true) (dynamic_invariant7 i true true true true)) (dynamic_invariant2 d true true true true)) (type_invariant1 t)) (and (not (= (size1 t) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (let ((temp___463 (model__1 t))) (select temp___463 i)))) true))) (dynamic_invariant1 (peek1 t i d) true false true true)) :pattern ((peek1 t i d))))))
(assert (forall ((t us_rep5)) (forall ((i Int) (d Int)) (! (=> (and (and (dynamic_invariant10 t true true true true) (dynamic_invariant7 i true true true true)) (dynamic_invariant2 d true true true true)) (= (peek1 t i d) (peek (rec__search_trees__search_tree__struct (us_split_fields7 t)) i d))) :pattern ((peek1 t i d))))))
...
(assert (forall ((f us_rep4)) (! (=> (dynamic_invariant8 f true true true true) (dynamic_invariant1 (size f) true false true true)) :pattern ((size f)))))
(assert (forall ((f us_rep4)) (forall ((i Int)) (! (=> (and (dynamic_invariant8 f true true true true) (dynamic_invariant7 i true true true true)) (=> (< (size f) i) (not (= (valid_root f i) true)))) :pattern ((valid_root f i))))))
(assert (forall ((f us_rep4)) (forall ((i Int)) (! (=> (and (dynamic_invariant8 f true true true true) (dynamic_invariant7 i true true true true)) (let ((result (parent f i))) (and (and (=> (= (valid_root f i) true) (= result 0)) (=> (= (size f) 0) (= result 0))) (dynamic_invariant1 result true false true true)))) :pattern ((parent f i))))))
(assert (forall ((f us_rep4)) (forall ((i Int)) (! (=> (and (and (dynamic_invariant8 f true true true true) (dynamic_invariant7 i true true true true)) (not (= (parent f i) 0))) (dynamic_invariant2 (position f i) true false true true)) :pattern ((position f i))))))
...
(assert (forall ((left us_rep2) (right us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant6 item true true true true) (= (= (included_except left right item) true) (forall ((e Int)) (=> (and (in_range9 e) (= (contains left e) true)) (or (= (contains right e) true) (= e item)))))) :pattern ((included_except left right item))))))
...
(declare-const temp___7482 (Array Int us_rep3))
...
(declare-const temp___820 (Array Int us_rep1))
