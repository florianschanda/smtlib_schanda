...
(assert (= (ite (<= (to_rep x__first) (to_rep x__last)) (+ (- (to_rep x__last) (to_rep x__first)) 1) 0) (ite (<= 0 10) (+ (- 10 0) 1) 0)))
(assert (= o (slide x (to_rep x__first) 0)))
(assert (= o do_checks__do_length_check__B_24__p1__x))
(assert (not true))
(check-sat)
(exit)
