...
(assert (forall ((temp___4030 (Array Int us_rep))) (forall ((temp___4031 Int)) (forall ((temp___4032 us_rep)) (let ((temp___4029 (temp___4028 temp___4030 temp___4031 temp___4032))) (forall ((temp___4033 Int)) (ite (= temp___4033 temp___4031) (= (select temp___4029 temp___4033) temp___4032) (= (select temp___4029 temp___4033) (select temp___4030 temp___4033)))))))))
...
(assert (= r__split_fields9 (mk___split_fields1 temp___9421 temp___94211 temp___94212)))
(assert (= r__split_fields10 (mk___split_fields__ref1 r__split_fields9)))
(assert (= r__split_fields11 r__split_fields9))
(assert (not (= (bool_eq2 (mk___rep1 (us_split_fields__content1 r__split_fields10)) (mk___rep1 (mk___split_fields1 (temp___4028 r__split_fields i (mk___rep (mk___split_fields (of_rep e) (of_rep1 f)))) (of_int 1) r__split_fields2))) true)))
(check-sat)
(exit)
