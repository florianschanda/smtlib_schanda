...
(declare-fun temp_____aggregate_def_4087 ((Array Int us_rep) Int us_rep) (Array Int us_rep))
...
(assert (forall ((temp___4089 (Array Int us_rep))) (forall ((temp___4090 Int)) (forall ((temp___4091 us_rep)) (let ((temp___4088 (temp_____aggregate_def_4087 temp___4089 temp___4090 temp___4091))) (=> (dynamic_invariant temp___4090 true true true true) (forall ((temp___4092 Int)) (ite (= temp___4092 temp___4090) (= (select temp___4088 temp___4092) temp___4091) (= (select temp___4088 temp___4092) (select temp___4089 temp___4092))))))))))
...
(declare-const temp___9473 (Array Int us_rep))
(declare-const temp___94731 Bool)
(declare-const temp___94732 enum1t)
...
(declare-const temp___9480 (Array Int us_rep))
(declare-const temp___94801 Bool)
(declare-const temp___94802 enum1t)
...
(assert (= temp___94731 o7))
(assert (= temp___94732 o8))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= result2 r__split_fields2))
(assert (= temp___9473 r__split_fields3))
(assert (= temp___94731 r__split_fields4))
(assert (= temp___94732 r__split_fields5))
...
(assert (= temp___9480 o15))
(assert (= temp___94801 o16))
(assert (= temp___94802 o17))
(assert (= result6 r__split_fields6))
(assert (= result7 r__split_fields7))
(assert (= result8 r__split_fields8))
(assert (= r__split_fields9 (mk___split_fields1 temp___9480 temp___94801 temp___94802)))
(assert (= r__split_fields10 (mk___split_fields__ref1 r__split_fields9)))
(assert (= r__split_fields11 r__split_fields9))
(assert (not (= (bool_eq2 (mk___rep1 (us_split_fields__content1 r__split_fields10)) (mk___rep1 (mk___split_fields1 (temp_____aggregate_def_4087 r__split_fields i (mk___rep (mk___split_fields (of_rep e) (of_rep1 f)))) (distinct 1 0) r__split_fields2))) true)))
(check-sat)
(exit)
