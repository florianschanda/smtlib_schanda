...
(define-fun o18 () us_rep3 (mk___rep1 (mk___split_fields1 o13 o14)))
...
(assert (<= 1 i1))
(assert (<= i1 r145b))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 i2)) (= (get c143b j1) j1))))
(assert (and (=> (<= 1 r145b) (dynamic_property 1 r145b i2)) (and (<= 1 i2) (<= i2 r145b))))
(assert (<= 1 j))
(assert (<= j i2))
(assert (and (= o17 j) (in_range8 j)))
(assert (not (<= 1 j)))
(check-sat)
(exit)
