...
(assert (forall ((temp___156 Int)) (=> (dynamic_invariant1 temp___156 true true true true) (forall ((temp___157 Int)) (= (select (null_concat__p_good__a1__aggregate_def temp___156) temp___157) rliteral)))))
...
(assert (forall ((temp___159 Int) (temp___160 Int)) (let ((temp___158 (null_concat__p_good__a2__aggregate_def temp___159 temp___160))) (=> (and (dynamic_invariant1 temp___159 true true true true) (dynamic_invariant1 temp___160 true true true true)) (forall ((temp___161 Int)) (ite (and (<= 6 temp___161) (<= temp___161 10)) (= (select temp___158 temp___161) rliteral1) (=> (and (<= 1 temp___161) (<= temp___161 5)) (= (select temp___158 temp___161) rliteral2))))))))
...
(assert (=> (not (= (length a1) 0)) (=> (<= (to_rep (first (rt a1))) (to_rep (last (rt a1)))) (= o9 (+ (- (to_rep (last (rt a1))) (to_rep (first (rt a1)))) 1)))))
(assert (=> (not (= (length a1) 0)) (=> (not (<= (to_rep (first (rt a1))) (to_rep (last (rt a1))))) (= o9 0))))
(assert (=> (not (= (length a1) 0)) (= o10 (+ o9 1))))
(assert (=> (not (= (length a1) 0)) (= o11 (+ (to_rep (first (rt a1))) o10))))
(assert (=> (not (= (length a1) 0)) (= o12 (- o11 1))))
(assert (=> (not (= (length a1) 0)) (and (= o13 o12) (in_range1 o12))))
(assert (=> (not (= (length a1) 0)) (= (to_rep o8) 2)))
(assert (=> (not (= (length a1) 0)) (= o14 (concat_singleton_right (elts a1) (to_rep (first (rt a1))) (to_rep (last (rt a1))) o8))))
(assert (=> (not (= (length a1) 0)) (= o14 null_concat__p_good__a4__assume)))
(assert (=> (not (= (length a1) 0)) (= (mk (to_rep (first (rt a1))) o13) null_concat__p_good__a4__assume1)))
(assert (= (mk___t null_concat__p_good__a4__assume null_concat__p_good__a4__assume1) a4))
(assert (dynamic_invariant a4 true false true true))
(assert (= (to_rep (first (rt a3))) 1))
(assert (= (to_rep (select (elts a3) 1)) 1))
(assert (= (to_rep (first (rt a4))) (- 2147483648)))
(assert (not (<= (to_rep (first (rt a4))) (to_rep (first (rt a4))))))
(check-sat)
(exit)
