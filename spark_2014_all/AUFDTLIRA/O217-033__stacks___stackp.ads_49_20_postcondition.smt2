...
(define-fun s__split_fields16 () us_split_fields2 (mk___split_fields1 s__split_fields8 s__split_fields9 s__split_fields10 s__split_fields11))
(assert (in_range2 e))
...
(assert (=> (not (= (to_rep3 s__split_fields4) 1)) (= s__split_fields16 s__split_fields12)))
