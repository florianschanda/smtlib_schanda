...
(assert (and (= temp___631 (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o8)) (and (dynamic_invariant5 temp___631 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___631 o8))) true) (and (= (length1 (rec__tree_model__path_type__a (us_split_fields1 (select temp___631 o8)))) 0) (and (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 100)) (=> (not (= i4 o8)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i4) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___631 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i4)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___631 i4))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___631 i4))) true)))))) (and (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___631 i4))) true) (not (= i4 o8))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___631 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i4)))) (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i4) (rec__tree_model__path_type__a (us_split_fields1 (select temp___631 i4)))) true) (= (length1 (rec__tree_model__path_type__a (us_split_fields1 (select temp___631 i4)))) 0)))) (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___631 i4))) true) (forall ((j13 Int)) (=> (and (<= 1 j13) (<= j13 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___631 j13))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___631 i4))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___631 j13)))) true)) (= j13 i4))))))))))))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
