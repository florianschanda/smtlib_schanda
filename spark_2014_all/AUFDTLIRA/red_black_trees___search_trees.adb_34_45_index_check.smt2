...
(assert (and (= temp___675 (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o8)) (and (dynamic_invariant5 temp___675 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___675 o8))) true) (and (= (length1 (rec__tree_model__path_type__a (us_split_fields1 (select temp___675 o8)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 o8)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___675 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___675 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___675 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___675 i1))) true) (not (= i1 o8))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___675 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))) (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___675 i1)))) true) (= (length1 (rec__tree_model__path_type__a (us_split_fields1 (select temp___675 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___675 i1))) true) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___675 j3))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___675 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___675 j3)))) true)) (= j3 i1))))))))))))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
