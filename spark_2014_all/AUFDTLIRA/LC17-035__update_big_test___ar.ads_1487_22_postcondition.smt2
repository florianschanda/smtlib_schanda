...
(declare-fun temp___3086 ((Array Int et1) Int Int Int Int) (Array Int et1))
(assert (forall ((temp___3088 (Array Int et1))) (forall ((temp___3089 Int) (temp___3090 Int) (temp___3091 Int) (temp___3092 Int)) (let ((temp___3087 (temp___3086 temp___3088 temp___3089 temp___3090 temp___3091 temp___3092))) (forall ((temp___3093 Int)) (ite (= temp___3093 temp___3091) (= (select temp___3087 temp___3093) (of_rep temp___3092)) (ite (= temp___3093 temp___3089) (= (select temp___3087 temp___3093) (of_rep temp___3090)) (= (select temp___3087 temp___3093) (select temp___3088 temp___3093)))))))))
(define-fun dynamic_invariant2 ((temp___expr_206 Int) (temp___is_init_203 Bool) (temp___skip_constant_204 Bool) (temp___do_toplevel_205 Bool)) Bool (=> (or (= temp___is_init_203 true) (<= 0 5)) (in_range2 temp___expr_206)))
...
(declare-const temp___8035 (Array Int et1))
(declare-const temp___80351 enum2t)
(declare-const o4 et1)
(declare-const o5 (Array Int et1))
(declare-const o6 (Array Int et1))
(declare-const o7 enum2t)
(declare-const temp___8038 (Array Int et1))
(declare-const temp___80381 enum2t)
...
(assert (= temp___8035 o2))
(assert (= temp___80351 o3))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= temp___8035 r__split_fields2))
(assert (= temp___80351 r__split_fields3))
(assert (= (to_rep o4) f))
(assert (= o5 (store r__split_fields2 j o4)))
(assert (= o5 o6))
(assert (= r__split_fields3 o7))
(assert (= temp___8038 o6))
(assert (= temp___80381 o7))
(assert (= result2 r__split_fields2))
(assert (= result3 r__split_fields3))
(assert (= temp___8038 r__split_fields4))
(assert (= temp___80381 r__split_fields5))
...
(assert (not (= (bool_eq1 (mk___rep (mk___split_fields r__split_fields6 r__split_fields7)) (mk___rep (mk___split_fields (temp___3086 r__split_fields i e j f) r__split_fields1))) true)))
(check-sat)
(exit)
