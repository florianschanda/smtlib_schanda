...
(assert (forall ((x enum2t)) (! (in_range2 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(declare-fun temp___3145 ((Array Int et1) Int Int Int Int) (Array Int et1))
(define-fun dynamic_invariant2 ((temp___expr_239 Int) (temp___is_init_235 Bool) (temp___skip_constant_236 Bool) (temp___do_toplevel_237 Bool) (temp___do_typ_inv_238 Bool)) Bool (=> (or (= temp___is_init_235 true) (<= 0 5)) (in_range2 temp___expr_239)))
(assert (forall ((temp___3147 (Array Int et1))) (forall ((temp___3148 Int) (temp___3149 Int) (temp___3150 Int) (temp___3151 Int)) (let ((temp___3146 (temp___3145 temp___3147 temp___3148 temp___3149 temp___3150 temp___3151))) (=> (and (and (and (dynamic_invariant temp___3148 true true true true) (dynamic_invariant1 temp___3149 true true true true)) (dynamic_invariant temp___3150 true true true true)) (dynamic_invariant1 temp___3151 true true true true)) (forall ((temp___3152 Int)) (ite (= temp___3152 temp___3150) (= (to_rep (select temp___3146 temp___3152)) temp___3151) (ite (= temp___3152 temp___3148) (= (to_rep (select temp___3146 temp___3152)) temp___3149) (= (select temp___3146 temp___3152) (select temp___3147 temp___3152))))))))))
...
(declare-const temp___8094 (Array Int et1))
(declare-const temp___80941 enum2t)
(declare-const o4 et1)
(declare-const o5 (Array Int et1))
(declare-const o6 (Array Int et1))
(declare-const o7 enum2t)
(declare-const temp___8097 (Array Int et1))
(declare-const temp___80971 enum2t)
...
(assert (= temp___8094 o2))
(assert (= temp___80941 o3))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= temp___8094 r__split_fields2))
(assert (= temp___80941 r__split_fields3))
(assert (= (to_rep o4) f))
(assert (= o5 (store r__split_fields2 j o4)))
(assert (= o5 o6))
(assert (= r__split_fields3 o7))
(assert (= temp___8097 o6))
(assert (= temp___80971 o7))
(assert (= result2 r__split_fields2))
(assert (= result3 r__split_fields3))
(assert (= temp___8097 r__split_fields4))
(assert (= temp___80971 r__split_fields5))
...
(assert (not (= (bool_eq1 (mk___rep (mk___split_fields r__split_fields6 r__split_fields7)) (mk___rep (mk___split_fields (temp___3145 r__split_fields i e j f) r__split_fields1))) true)))
(check-sat)
(exit)
