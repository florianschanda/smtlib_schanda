...
(assert (not (= (ite (<= (to_rep1 (first (rt x))) (to_rep1 (last (rt x)))) (+ (- (to_rep1 (last (rt x))) (to_rep1 (first (rt x)))) 1) 0) (ite (<= (to_rep1 (first (rt y))) (to_rep1 (last (rt y)))) (+ (- (to_rep1 (last (rt y))) (to_rep1 (first (rt y)))) 1) 0))))
(check-sat)
(exit)
