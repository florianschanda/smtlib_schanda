...
(define-fun dynamic_invariant ((temp___expr_135 us_t) (temp___is_init_132 Bool) (temp___skip_constant_133 Bool) (temp___do_toplevel_134 Bool)) Bool (and (=> (not (= temp___skip_constant_133 true)) (dynamic_property 1 2147483647 (first1 temp___expr_135) (last1 temp___expr_135))) (=> (= temp___do_toplevel_134 true) (=> (= temp___is_init_132 true) (forall ((temp___137 Int)) (=> (and (<= (first1 temp___expr_135) temp___137) (<= temp___137 (last1 temp___expr_135))) (let ((c (to_rep (select (to_array temp___expr_135) temp___137)))) (and (<= 97 c) (<= c 98)))))))))
(define-fun dynamic_predicate ((temp___139 us_t)) Bool (forall ((temp___141 Int)) (=> (and (<= (first1 temp___139) temp___141) (<= temp___141 (last1 temp___139))) (let ((c (to_rep (select (to_array temp___139) temp___141)))) (and (<= 97 c) (<= c 98))))))
