...
(declare-datatypes () ((str__ref (mk_str__ref (str__content us_t)))))
(define-fun str__ref___projection ((a str__ref)) us_t (str__content a))
(define-fun dynamic_invariant ((temp___expr_158 us_t) (temp___is_init_154 Bool) (temp___skip_constant_155 Bool) (temp___do_toplevel_156 Bool) (temp___do_typ_inv_157 Bool)) Bool (and (=> (not (= temp___skip_constant_155 true)) (dynamic_property 1 2147483647 (first1 temp___expr_158) (last1 temp___expr_158))) (=> (= temp___do_toplevel_156 true) (=> (= temp___is_init_154 true) (forall ((temp___160 Int)) (=> (and (<= (first1 temp___expr_158) temp___160) (<= temp___160 (last1 temp___expr_158))) (let ((c (to_rep (select (to_array temp___expr_158) temp___160)))) (and (<= 97 c) (<= c 98)))))))))
(define-fun dynamic_predicate ((temp___162 us_t)) Bool (forall ((temp___164 Int)) (=> (and (<= (first1 temp___162) temp___164) (<= temp___164 (last1 temp___162))) (let ((c (to_rep (select (to_array temp___162) temp___164)))) (and (<= 97 c) (<= c 98))))))
(declare-const i1s us_t)
...
(assert (= result j))
(assert (= j1 (to_rep1 (first (rt value)))))
(assert (<= (to_rep1 (first (rt value))) j1))
(assert (<= j1 (to_rep1 (last (rt value)))))
(assert (and (<= (to_rep1 (first (rt value))) j2) (<= j2 (to_rep1 (last (rt value))))))
(assert (not (<= 97 (to_rep (select (elts value) j2)))))
(check-sat)
(exit)
