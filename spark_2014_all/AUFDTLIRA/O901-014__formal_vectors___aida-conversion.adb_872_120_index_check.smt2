...
(assert (and (and (forall ((temp___1630 Int)) (=> (and (<= (to_rep1 n__first) temp___1630) (<= temp___1630 (to_rep1 n__last))) (=> (< index3 temp___1630) (= (select n3 temp___1630) (select n1 temp___1630))))) (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 6)) (dynamic_property5 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 6) index3))) (and (<= (to_rep1 (first (rt source))) index3) (<= index3 (+ (to_rep1 (first (rt source))) 6)))))
(assert (<= (to_rep1 (first (rt source))) j))
(assert (<= j index3))
(assert (not (<= (to_rep1 (first (rt source))) j)))
(check-sat)
(exit)
