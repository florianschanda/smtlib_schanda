...
(assert (and (= (length source) 7) (forall ((index3 Int)) (=> (and (<= (to_rep1 (first (rt source))) index3) (<= index3 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index3))) true)))))
...
(assert (and (and (forall ((temp___1732 Int)) (=> (and (<= (to_rep1 n__first) temp___1732) (<= temp___1732 (to_rep1 n__last))) (=> (< index2 temp___1732) (= (select n3 temp___1732) (select n1 temp___1732))))) (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 6)) (dynamic_property5 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 6) index2))) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (+ (to_rep1 (first (rt source))) 6)))))
