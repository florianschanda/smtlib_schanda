...
(declare-const temp___171 (Array Int integer))
(declare-const temp___1711 t)
...
(assert (=> (= (length x) 0) (= (elts y) temp___171)))
(assert (=> (= (length x) 0) (= (mk (to_rep (first (rt y))) (to_rep (last (rt y)))) temp___1711)))
(assert (=> (not (= (length x) 0)) (=> (<= (to_rep (first (rt y))) (to_rep (last (rt y)))) (= o (+ (- (to_rep (last (rt y))) (to_rep (first (rt y)))) 1)))))
(assert (=> (not (= (length x) 0)) (=> (not (<= (to_rep (first (rt y))) (to_rep (last (rt y))))) (= o 0))))
(assert (=> (not (= (length x) 0)) (=> (<= (to_rep (first (rt x))) (to_rep (last (rt x)))) (= o1 (+ (- (to_rep (last (rt x))) (to_rep (first (rt x)))) 1)))))
(assert (=> (not (= (length x) 0)) (=> (not (<= (to_rep (first (rt x))) (to_rep (last (rt x))))) (= o1 0))))
(assert (=> (not (= (length x) 0)) (= o2 (+ o1 o))))
(assert (=> (not (= (length x) 0)) (= o3 (+ (to_rep (first (rt x))) o2))))
(assert (=> (not (= (length x) 0)) (= o4 (- o3 1))))
(assert (=> (not (= (length x) 0)) (and (= o5 o4) (in_range o4))))
(assert (=> (not (= (length x) 0)) (= (concat1 (elts x) (to_rep (first (rt x))) (to_rep (last (rt x))) (elts y) (to_rep (first (rt y))) (to_rep (last (rt y)))) temp___171)))
(assert (=> (not (= (length x) 0)) (= (mk (to_rep (first (rt x))) o5) temp___1711)))
(assert (not (= (ite (<= (to_rep (first temp___1711)) (to_rep (last temp___1711))) (+ (- (to_rep (last temp___1711)) (to_rep (first temp___1711))) 1) 0) (ite (<= (to_rep z__first) (to_rep z__last)) (+ (- (to_rep z__last) (to_rep z__first)) 1) 0))))
(check-sat)
(exit)
