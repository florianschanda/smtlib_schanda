...
(assert (=> (= (length x) 0) (= (elts y) temp___197)))
(assert (=> (= (length x) 0) (= (mk (to_rep (first (rt y))) (to_rep (last (rt y)))) temp___1971)))
...
(assert (=> (not (= (length x) 0)) (= (concat1 (elts x) (to_rep (first (rt x))) (to_rep (last (rt x))) (elts y) (to_rep (first (rt y))) (to_rep (last (rt y)))) temp___197)))
(assert (=> (not (= (length x) 0)) (= (mk (to_rep (first (rt x))) o5) temp___1971)))
(assert (not (= (ite (<= (to_rep (first temp___1971)) (to_rep (last temp___1971))) (+ (- (to_rep (last temp___1971)) (to_rep (first temp___1971))) 1) 0) (ite (<= (to_rep z__first) (to_rep z__last)) (+ (- (to_rep z__last) (to_rep z__first)) 1) 0))))
(check-sat)
(exit)
