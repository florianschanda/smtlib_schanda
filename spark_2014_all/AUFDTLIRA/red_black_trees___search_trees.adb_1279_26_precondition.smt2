...
(assert (= result4 true))
(assert (and (= o16 (size (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)))) (in_range4 o16)))
(assert (= o17 (+ o16 1)))
(assert (and (= o18 (size (rec__search_trees__search_tree__struct (us_split_fields7 t)))) (in_range4 o18)))
...
(assert (and (= temp___2106 (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o7)) (and (dynamic_invariant8 temp___2106 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2106 o7))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___2106 o7)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 o7)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2106 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2106 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2106 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2106 i1))) true) (not (= i1 o7))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___2106 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))) (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___2106 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___2106 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2106 i1))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2106 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___2106 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___2106 j1)))) true)) (= j1 i1))))))))))))))
(assert (and (<= 1 i) (<= i 100)))
(assert (= o8 i))
(assert (= (mk___rep (mk___split_fields o9 o10)) (select temp___2106 o8)))
(assert (= o9 o11))
(assert (= o10 o12))
(assert (= o13 o11))
...
(assert (and (= temp___2105 (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o1)) (and (dynamic_invariant8 temp___2105 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2105 o1))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___2105 o1)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 o1)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2105 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2105 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2105 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2105 i1))) true) (not (= i1 o1))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___2105 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))) (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___2105 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___2105 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2105 i1))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2105 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___2105 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___2105 j1)))) true)) (= j1 i1))))))))))))))
(assert (= (mk___rep (mk___split_fields o2 o3)) (select temp___2105 l)))
(assert (= o2 o4))
(assert (= o3 o5))
(assert (= o6 o4))
