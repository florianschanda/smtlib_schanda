...
(assert (= o67 (select temp___1629 i2)))
(assert (= o68 (us_split_fields5 o67)))
(assert (= o69 (rec__tree_model__path_type__a o68)))
(assert (and (= o70 (length o69)) (and (in_range2 o70) (<= (+ 0 o70) 2147483647))))
(assert (= o71 (+ o70 1)))
(assert (and (= o72 o71) (in_range8 o71)))
