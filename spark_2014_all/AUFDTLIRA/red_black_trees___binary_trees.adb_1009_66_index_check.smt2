...
(assert (= result2 true))
(assert (and (= o16 (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 ki1))))) (in_range4 (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 ki1)))))))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))) true))
...
(assert (= o13 (select temp___1786 ki1)))
