...
(define-fun a_range__ref___2__projection ((a1 a_range__ref)) integer (a_range__content a1))
...
(declare-datatypes () ((twrapper2D1__ref (mk_twrapper2D1__ref (twrapper2D1__content twrapper2D1)))))
(define-fun twrapper2D1__ref___projection ((a1 twrapper2D1__ref)) twrapper2D1 (twrapper2D1__content a1))
...
(define-fun bool_eq2 ((a1 (Array Int integer)) (a__first Int) (a__last Int) (b (Array Int integer)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_133 Int)) (=> (and (<= a__first temp___idx_133) (<= temp___idx_133 a__last)) (= (to_rep (select a1 temp___idx_133)) (to_rep (select b (+ (- b__first a__first) temp___idx_133))))))) true false))
(assert (forall ((a1 (Array Int integer)) (b (Array Int integer))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq2 b b__first b__last a1 a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_133 Int)) (=> (and (<= a__first temp___idx_133) (<= temp___idx_133 a__last)) (= (to_rep (select a1 temp___idx_133)) (to_rep (select b (+ (- b__first a__first) temp___idx_133)))))))))))
...
(assert (forall ((a1 (Array Int integer)) (b (Array Int integer))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare1 a1 a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq2 a1 a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep (select a1 (+ i 1))) (to_rep (select b (+ j 1))))))))))) :pattern ((compare1 a1 a_first a_last b b_first b_last))))))
(assert (forall ((a1 (Array Int integer)) (b (Array Int integer))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare1 a1 a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq2 a1 a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep (select b (+ i 1))) (to_rep (select a1 (+ j 1))))))))))) :pattern ((compare1 a1 a_first a_last b b_first b_last))))))
(define-fun dynamic_invariant1 ((temp___expr_197 (Array Int integer)) (temp___is_init_194 Bool) (temp___skip_constant_195 Bool) (temp___do_toplevel_196 Bool)) Bool (forall ((temp___198 Int)) (=> (and (<= 1 temp___198) (<= temp___198 1)) (=> (or (= temp___is_init_194 true) (<= first2 last2)) (dynamic_property1 first2 last2 (to_rep (select temp___expr_197 temp___198)))))))
...
(assert (forall ((temp___135 Int)) (= (select (aggregate_checks__do_wrong_aggregate_2__should_fail2__aggregate_def temp___135) 1) (of_rep temp___135))))
...
(define-fun dynamic_invariant5 ((temp___expr_191 Int) (temp___is_init_188 Bool) (temp___skip_constant_189 Bool) (temp___do_toplevel_190 Bool)) Bool (=> (or (= temp___is_init_188 true) (<= first2 last2)) (dynamic_property1 first2 last2 temp___expr_191)))
