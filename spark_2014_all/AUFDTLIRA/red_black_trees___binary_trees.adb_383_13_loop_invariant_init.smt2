...
(assert (<= (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) j2)))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) i2)))) n1)))
