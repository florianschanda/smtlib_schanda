...
(assert (= (elts (to_string (attr__ATTRIBUTE_IMAGE3 x))) temp___392))
(assert (= (mk1 (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 x))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 x)))))) temp___3921))
(assert (not (dynamic_predicate (mk___t1 temp___392 temp___3921))))
(check-sat)
(exit)
