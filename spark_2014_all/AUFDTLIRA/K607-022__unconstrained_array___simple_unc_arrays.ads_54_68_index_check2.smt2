...
(declare-const i Int)
(declare-const simple_unc_arrays__max__result Int)
(declare-const o Int)
...
(declare-const simple_unc_arrays__max__result1 Int)
(declare-const res8 Int)
(declare-const i7 Int)
(declare-const simple_unc_arrays__max__result2 Int)
(declare-const res9 Int)
(declare-const i8 Int)
(declare-const simple_unc_arrays__max__result3 Int)
(declare-const res10 Int)
(declare-const i9 Int)
(declare-const simple_unc_arrays__max__result4 Int)
(declare-const res11 Int)
(declare-const i10 Int)
(declare-const simple_unc_arrays__max__result5 Int)
...
(assert (= simple_unc_arrays__max__result1 simple_unc_arrays__max__result2))
(assert (= i11 i12))
(assert (= res12 res13))
(assert (= simple_unc_arrays__max__result3 simple_unc_arrays__max__result1))
(assert (= i8 i6))
(assert (= res9 res7))
...
(assert (= i1 2))
(assert (=> (and (<= 2 i1) (<= i1 r35b)) (= temp___943 i1)))
(assert (=> (and (<= 2 i1) (<= i1 r35b)) (= temp___942 res1)))
(assert (=> (and (<= 2 i1) (<= i1 r35b)) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- i2 1))) (<= (to_rep2 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) j1)) res2)))))
(assert (=> (and (<= 2 i1) (<= i1 r35b)) (and (and (=> (<= (- 2147483648) 2147483647) (in_range3 res2)) (=> (<= 2 r35b) (dynamic_property2 2 r35b i2))) (and (<= 2 i2) (<= i2 r35b)))))
(assert (=> (and (<= 2 i1) (<= i1 r35b)) (and (<= (to_rep1 (first (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))) i2) (<= i2 (to_rep1 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a)))))))))
(assert (=> (and (<= 2 i1) (<= i1 r35b)) (= o3 i2)))
(assert (=> (and (<= 2 i1) (<= i1 r35b)) (= o4 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) o3))))
(assert (=> (and (<= 2 i1) (<= i1 r35b)) (= o5 (to_rep2 o4))))
(assert (=> (and (<= 2 i1) (<= i1 r35b)) (= result2 (ite (< res2 o5) true false))))
(assert (=> (and (<= 2 i1) (<= i1 r35b)) (=> (= result2 true) (and (<= (to_rep1 (first (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))) i2) (<= i2 (to_rep1 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))))))))
(assert (=> (and (<= 2 i1) (<= i1 r35b)) (=> (= result2 true) (= o6 i2))))
(assert (=> (and (<= 2 i1) (<= i1 r35b)) (=> (= result2 true) (= o7 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) o6)))))
(assert (=> (and (<= 2 i1) (<= i1 r35b)) (=> (= result2 true) (= o8 (to_rep2 o7)))))
(assert (=> (and (<= 2 i1) (<= i1 r35b)) (=> (= result2 true) (= res2 result3))))
(assert (=> (and (<= 2 i1) (<= i1 r35b)) (=> (= result2 true) (= res3 o8))))
(assert (=> (and (<= 2 i1) (<= i1 r35b)) (=> (not (= result2 true)) (= res3 res2))))
(assert (=> (and (<= 2 i1) (<= i1 r35b)) (= i2 r35b)))
(assert (=> (and (<= 2 i1) (<= i1 r35b)) (= i2 i3)))
(assert (=> (and (<= 2 i1) (<= i1 r35b)) (= res3 res4)))
(assert (=> (and (<= 2 i1) (<= i1 r35b)) (= i4 i2)))
(assert (=> (and (<= 2 i1) (<= i1 r35b)) (= res5 res3)))
(assert (=> (and (<= 2 i1) (<= i1 r35b)) (= i12 (mk_int__ref i3))))
(assert (=> (and (<= 2 i1) (<= i1 r35b)) (= res13 (mk_int__ref res4))))
(assert (=> (and (<= 2 i1) (<= i1 r35b)) (= i6 i4)))
(assert (=> (and (<= 2 i1) (<= i1 r35b)) (= res7 res5)))
(assert (=> (not (and (<= 2 i1) (<= i1 r35b))) (= i1 i5)))
(assert (=> (not (and (<= 2 i1) (<= i1 r35b))) (= res1 res6)))
(assert (=> (not (and (<= 2 i1) (<= i1 r35b))) (= i6 i1)))
(assert (=> (not (and (<= 2 i1) (<= i1 r35b))) (= res7 res1)))
(assert (= (mk_int__ref result4) (mk_int__ref simple_unc_arrays__max__result)))
(assert (= simple_unc_arrays__max__result1 res6))
(assert (= (mk_int__ref simple_unc_arrays__max__result4) (mk_int__ref simple_unc_arrays__max__result2)))
(assert (= (mk_int__ref i9) i11))
(assert (= (mk_int__ref res10) res12))
(assert (= simple_unc_arrays__max__result5 simple_unc_arrays__max__result3))
(assert (= i10 i8))
(assert (= res11 res9))
(assert (= (= result5 true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))))) (<= (to_rep2 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) j1)) simple_unc_arrays__max__result4)))))
(assert (= result5 true))
(assert (<= 1 j))
