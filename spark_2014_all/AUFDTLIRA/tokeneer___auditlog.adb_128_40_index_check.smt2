...
(assert (and (<= (to_rep1 (first (rt description))) temp___1516) (<= temp___1516 (to_rep1 (last (rt description))))))
(assert (= o1 temp___1516))
(assert (= o2 (select (elts description) o1)))
(assert (= o3 (to_rep o2)))
(assert (= (to_rep o4) o3))
(assert (and (= temp___1517 (+ 1 i3)) (in_range1 (+ 1 i3))))
(assert (not (<= 1 temp___1517)))
(check-sat)
(exit)
