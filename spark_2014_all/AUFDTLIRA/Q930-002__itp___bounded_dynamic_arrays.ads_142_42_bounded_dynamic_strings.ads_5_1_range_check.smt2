...
(assert (dynamic_predicate temp___1130))
(assert (= temp___1131 temp___1130))
...
(assert (and (= o30 (length1 tail)) (in_range1 (length1 tail))))
(assert (and (= o31 (length3 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2))))) (and (in_range4 o31) (= o31 (to_rep2 to____split_fields)))))
(assert (= o32 (+ o31 o30)))
(assert (and (= o33 (length3 (mk___rep to____split_discrs (us_split_fields__content to____split_fields5)))) (and (in_range4 o33) (= o33 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields__content to____split_fields5)))))))
(assert (= o34 (ite (= o33 o32) true false)))
(assert (and (= temp___1135 (value (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2))))) (and (dynamic_invariant temp___1135 true false true) (and (= temp___1135 (mk___t1 to____split_fields1 (mk1 (to_rep1 (first6 (mk3 1 (to_rep2 to____split_fields)))) (to_rep1 (last6 (mk3 1 (to_rep2 to____split_fields))))))) (and (and (and (= (length1 temp___1135) (length3 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2))))) (= (to_rep1 (first2 (rt1 temp___1135))) 1)) (= (to_rep1 (last2 (rt1 temp___1135))) (length3 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2)))))) (= (< 0 (length3 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2))))) (not (= (empty (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2)))) true))))))))
(assert (not (= (length1 temp___1135) 0)))
(assert (=> (<= (to_rep1 (first2 (rt1 tail))) (to_rep1 (last2 (rt1 tail)))) (= o24 (+ (- (to_rep1 (last2 (rt1 tail))) (to_rep1 (first2 (rt1 tail)))) 1))))
(assert (=> (not (<= (to_rep1 (first2 (rt1 tail))) (to_rep1 (last2 (rt1 tail))))) (= o24 0)))
(assert (=> (<= (to_rep1 (first2 (rt1 temp___1135))) (to_rep1 (last2 (rt1 temp___1135)))) (= o25 (+ (- (to_rep1 (last2 (rt1 temp___1135))) (to_rep1 (first2 (rt1 temp___1135)))) 1))))
(assert (=> (not (<= (to_rep1 (first2 (rt1 temp___1135))) (to_rep1 (last2 (rt1 temp___1135))))) (= o25 0)))
(assert (= o26 (+ o25 o24)))
(assert (= o27 (+ (to_rep1 (first2 (rt1 temp___1135))) o26)))
(assert (= o28 (- o27 1)))
