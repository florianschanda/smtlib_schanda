...
(declare-const temp___1198 us_t1)
...
(assert (dynamic_predicate temp___1193))
(assert (= temp___1194 temp___1193))
(assert (= result1 (mk___split_fields__ref to____split_fields3)))
(assert (= to____split_fields4 (us_split_fields1 temp___1194)))
(assert (= to____split_discrs (us_split_discrs1 temp___1194)))
(assert (= to____split_fields5 (mk___split_fields__ref to____split_fields4)))
(assert (= to____split_fields6 to____split_fields4))
(assert (and (= o23 (length1 tail)) (in_range1 (length1 tail))))
(assert (and (= o24 (length3 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2))))) (and (in_range4 o24) (= o24 (to_rep2 to____split_fields)))))
(assert (= o25 (+ o24 o23)))
(assert (and (= o26 (length3 (mk___rep to____split_discrs (us_split_fields__content to____split_fields5)))) (and (in_range4 o26) (= o26 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields__content to____split_fields5)))))))
(assert (= o27 (ite (= o26 o25) true false)))
(assert (and (= temp___1198 (value (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2))))) (and (dynamic_invariant temp___1198 true false true true) (and (= temp___1198 (mk___t1 to____split_fields1 (mk1 (to_rep1 (first6 (mk3 1 (to_rep2 to____split_fields)))) (to_rep1 (last6 (mk3 1 (to_rep2 to____split_fields))))))) (and (and (and (= (length1 temp___1198) (length3 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2))))) (= (to_rep1 (first2 (rt1 temp___1198))) 1)) (= (to_rep1 (last2 (rt1 temp___1198))) (length3 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2)))))) (= (< 0 (length3 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2))))) (not (= (empty (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2)))) true))))))))
(assert (not (= (length1 temp___1198) 0)))
(assert (=> (<= (to_rep1 (first2 (rt1 tail))) (to_rep1 (last2 (rt1 tail)))) (= o18 (+ (- (to_rep1 (last2 (rt1 tail))) (to_rep1 (first2 (rt1 tail)))) 1))))
(assert (=> (not (<= (to_rep1 (first2 (rt1 tail))) (to_rep1 (last2 (rt1 tail))))) (= o18 0)))
(assert (=> (<= (to_rep1 (first2 (rt1 temp___1198))) (to_rep1 (last2 (rt1 temp___1198)))) (= o19 (+ (- (to_rep1 (last2 (rt1 temp___1198))) (to_rep1 (first2 (rt1 temp___1198)))) 1))))
(assert (=> (not (<= (to_rep1 (first2 (rt1 temp___1198))) (to_rep1 (last2 (rt1 temp___1198))))) (= o19 0)))
(assert (= o20 (+ o19 o18)))
(assert (= o21 (+ (to_rep1 (first2 (rt1 temp___1198))) o20)))
(assert (= o22 (- o21 1)))
