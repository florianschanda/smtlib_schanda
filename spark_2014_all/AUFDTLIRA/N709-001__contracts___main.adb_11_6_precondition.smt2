...
(define-fun x1__split_fields2 () us_split_fields (mk___split_fields x1__split_fields x1__split_fields1))
(assert (= x1__attr__tag us_tag))
(assert (= x2__attr__tag us_tag1))
(assert (= (to_rep1 x1__split_fields) 0))
(assert (= (is_zero (mk___rep x1__split_fields2 x1__attr__tag)) true))
(assert (not (not (= (is_max (mk___rep x1__split_fields2 x1__attr__tag)) true))))
(check-sat)
(exit)
