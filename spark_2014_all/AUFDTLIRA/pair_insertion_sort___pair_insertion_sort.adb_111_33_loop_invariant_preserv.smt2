...
(declare-const temp___2881 (Array Int integer))
(declare-const temp___2851 Int)
...
(declare-const temp___2981 (Array Int integer))
...
(assert (=> (= result23 true) (= temp___2881 a17)))
(assert (=> (= result23 true) (= temp___2851 j15)))
...
(assert (and (= temp___2941 (+ (int__content j20) 2)) (in_range1 (+ (int__content j20) 2))))
(assert (and (<= (to_rep a__first) temp___2941) (<= temp___2941 (to_rep a__last))))
(assert (= o63 temp___2941))
...
(assert (=> (= result27 true) (= temp___2981 (map__content a25))))
(assert (=> (= result27 true) (= temp___2951 (int__content j20))))
...
(assert (= i5 i3))
(assert (= a34 a32))
(assert (not (= (is_perm (mk___t (elts1 b) (mk (to_rep (first2 (rt1 b))) (to_rep (last2 (rt1 b))))) (mk___t (map__content a33) (mk (to_rep a__first) (to_rep a__last)))) true)))
(check-sat)
(exit)
