...
(assert (=> (= result1 true) (=> (not (= first_available 0)) (and (= o6 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (and (in_range5 o6) (<= (+ 0 o6) 2147483647))))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (= result2 (ite (< 0 o6) true false)))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (=> (= result2 true) (and (= o5 (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m)) 1)) (in_range6 o5))))))
...
(assert (=> (= result1 true) (=> (not (not (= first_available 0))) (and (= o7 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (and (in_range5 o7) (<= (+ 0 o7) 2147483647))))))
...
(assert (= result3 true))
(assert (and (= o4 (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m)) j)) (in_range6 o4)))
(assert (= result4 (ite (in_range3 o4) true false)))
(assert (= result4 true))
