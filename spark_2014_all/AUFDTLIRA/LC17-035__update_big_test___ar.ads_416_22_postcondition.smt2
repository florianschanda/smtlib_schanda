...
(declare-fun temp_____aggregate_def_1350 ((Array Int (Array Int (Array Int et1))) Int (Array Int (Array Int et1)) Int (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1))))
(declare-fun temp_____aggregate_def_1358 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
(declare-fun temp_____aggregate_def_1365 ((Array Int et1) Int Int) (Array Int et1))
(declare-fun temp_____aggregate_def_1373 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
(declare-fun temp_____aggregate_def_1380 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___1352 (Array Int (Array Int (Array Int et1))))) (forall ((temp___1353 Int) (temp___1355 Int)) (forall ((temp___1354 (Array Int (Array Int et1))) (temp___1356 (Array Int (Array Int et1)))) (let ((temp___1351 (temp_____aggregate_def_1350 temp___1352 temp___1353 temp___1354 temp___1355 temp___1356))) (=> (and (dynamic_invariant2 temp___1353 true true true true) (dynamic_invariant2 temp___1355 true true true true)) (forall ((temp___1357 Int)) (ite (= temp___1357 temp___1355) (= (select temp___1351 temp___1357) temp___1356) (ite (= temp___1357 temp___1353) (= (select temp___1351 temp___1357) temp___1354) (= (select temp___1351 temp___1357) (select temp___1352 temp___1357)))))))))))
(assert (forall ((temp___1360 (Array Int (Array Int et1)))) (forall ((temp___1361 Int)) (forall ((temp___1362 (Array Int et1))) (let ((temp___1359 (temp_____aggregate_def_1358 temp___1360 temp___1361 temp___1362))) (=> (dynamic_invariant1 temp___1361 true true true true) (forall ((temp___1363 Int)) (ite (= temp___1363 temp___1361) (= (select temp___1359 temp___1363) temp___1362) (= (select temp___1359 temp___1363) (select temp___1360 temp___1363))))))))))
(assert (forall ((temp___1367 (Array Int et1))) (forall ((temp___1368 Int) (temp___1369 Int)) (let ((temp___1366 (temp_____aggregate_def_1365 temp___1367 temp___1368 temp___1369))) (=> (and (dynamic_invariant temp___1368 true true true true) (dynamic_invariant3 temp___1369 true true true true)) (forall ((temp___1370 Int)) (ite (= temp___1370 temp___1368) (= (to_rep (select temp___1366 temp___1370)) temp___1369) (= (select temp___1366 temp___1370) (select temp___1367 temp___1370)))))))))
(assert (forall ((temp___1375 (Array Int (Array Int et1)))) (forall ((temp___1376 Int)) (forall ((temp___1377 (Array Int et1))) (let ((temp___1374 (temp_____aggregate_def_1373 temp___1375 temp___1376 temp___1377))) (=> (dynamic_invariant1 temp___1376 true true true true) (forall ((temp___1378 Int)) (ite (= temp___1378 temp___1376) (= (select temp___1374 temp___1378) temp___1377) (= (select temp___1374 temp___1378) (select temp___1375 temp___1378))))))))))
(assert (forall ((temp___1382 (Array Int et1))) (forall ((temp___1383 Int) (temp___1384 Int)) (let ((temp___1381 (temp_____aggregate_def_1380 temp___1382 temp___1383 temp___1384))) (=> (and (dynamic_invariant temp___1383 true true true true) (dynamic_invariant3 temp___1384 true true true true)) (forall ((temp___1385 Int)) (ite (= temp___1385 temp___1383) (= (to_rep (select temp___1381 temp___1385)) temp___1384) (= (select temp___1381 temp___1385) (select temp___1382 temp___1385)))))))))
...
(assert (= a2 a3))
(assert (= a4 a2))
(assert (not (= (bool_eq2 a3 1 16 (temp_____aggregate_def_1350 a k1 (temp_____aggregate_def_1358 (select a k1) j1 (temp_____aggregate_def_1365 (select (select a k1) j1) i1 e)) k2 (temp_____aggregate_def_1373 (select a k2) j2 (temp_____aggregate_def_1380 (select (select a k2) j2) i2 f))) 1 16) true)))
(check-sat)
(exit)
