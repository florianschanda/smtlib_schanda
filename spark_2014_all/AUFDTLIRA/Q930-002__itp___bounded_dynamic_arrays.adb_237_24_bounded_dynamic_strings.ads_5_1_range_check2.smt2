...
(assert (= temp___1299 (+ o5 1)))
(assert (= (mk_int__ref result1) (mk_int__ref k)))
(assert (= k1 1))
(assert (<= 1 k1))
(assert (<= k1 temp___1299))
(assert (and (= o6 (length fragment)) (in_range1 (length fragment))))
(assert (= o7 (+ k1 o6)))
(assert (= temp___1300 (- o7 1)))
(assert (=> (<= k1 temp___1300) (and (and (<= (to_rep1 (first2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))) k1) (<= k1 (to_rep1 (last2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))))) (and (<= (to_rep1 (first2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))) temp___1300) (<= temp___1300 (to_rep1 (last2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))))))))
(assert (= o8 (elts1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within)))))
(assert (= o8 temp___1302))
(assert (= (mk3 k1 temp___1300) temp___13021))
(assert (= result2 (bool_eq temp___1302 (to_rep1 (first6 temp___13021)) (to_rep1 (last6 temp___13021)) (elts fragment) (to_rep1 (first (rt fragment))) (to_rep1 (last (rt fragment))))))
...
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 k2)) (not (= (bool_eq (elts1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))) (to_rep1 (first8 (mk4 j1 (- (+ j1 (length fragment)) 1)))) (to_rep1 (last8 (mk4 j1 (- (+ j1 (length fragment)) 1)))) (elts fragment) (to_rep1 (first (rt fragment))) (to_rep1 (last (rt fragment)))) true)))))
(assert (and (=> (<= 1 (+ (- (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 within))) (length fragment)) 1)) (dynamic_property5 1 (+ (- (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 within))) (length fragment)) 1) k2)) (and (<= 1 k2) (<= k2 (+ (- (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 within))) (length fragment)) 1)))))
(assert (<= 1 j))
(assert (<= j k2))
(assert (and (= o9 (length fragment)) (in_range1 (length fragment))))
(assert (= o10 (+ j o9)))
(assert (= temp___1304 (- o10 1)))
(assert (<= j temp___1304))
(assert (not (<= (to_rep1 (first2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))) j)))
(check-sat)
(exit)
