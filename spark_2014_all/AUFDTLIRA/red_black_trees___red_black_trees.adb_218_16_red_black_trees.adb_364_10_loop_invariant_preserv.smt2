...
(assert (and (= o (size (rec__red_black_trees__rbt__struct (us_split_fields9 c61b)))) (and (in_range2 o) (= o (size1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 c61b)))))))))
...
(assert (<= 1 n1))
(assert (<= n1 100))
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields7 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c61b))) i))) true) (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c61b) i)))) n2)) (not (= i (root (rec__red_black_trees__rbt__struct (us_split_fields9 c62b)))))) (= (eq (select (nb_blacks c62b) i) (select (nb_blacks c61b) i)) true)))))
...
(assert (<= 1 i))
(assert (<= i 100))
(assert (= (rec__tree_model__path_type__k (us_split_fields7 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c61b))) i))) true))
(assert (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c61b) i)))) n3))
(assert (not (= i (root (rec__red_black_trees__rbt__struct (us_split_fields9 c62b))))))
(assert (not (= (eq (select (nb_blacks c62b) i) (select (nb_blacks c61b) i)) true)))
(check-sat)
(exit)
