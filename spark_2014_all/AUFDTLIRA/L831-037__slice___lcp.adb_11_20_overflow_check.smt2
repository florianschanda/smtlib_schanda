...
(assert (= result9 (ite (<= o19 (to_rep (last (rt a)))) true false)))
(assert (=> (= result9 true) (and (= o18 (+ y l3)) (in_range1 (+ y l3)))))
(assert (=> (= result9 true) (= result8 (ite (<= o18 (to_rep (last (rt a)))) true false))))
(assert (=> (not (= result9 true)) (= result8 false)))
(assert (= result8 true))
(assert (and (= temp___2001 (+ y l3)) (in_range1 (+ y l3))))
(assert (and (<= (to_rep (first (rt a))) temp___2001) (<= temp___2001 (to_rep (last (rt a))))))
(assert (= o15 temp___2001))
