...
(define-fun dynamic_invariant1 ((temp___expr_1792 Int) (temp___is_init_1789 Bool) (temp___skip_constant_1790 Bool) (temp___do_toplevel_1791 Bool)) Bool (=> (or (= temp___is_init_1789 true) (<= 0 8)) (in_range7 temp___expr_1792)))
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-fun getstatus (Int) Int)
(declare-fun getstatus__function_guard (Int Int) Bool)
(assert (forall ((enclave__status Int)) (! (=> (dynamic_invariant1 enclave__status true true true) (dynamic_invariant1 (getstatus enclave__status) true false true)) :pattern ((getstatus enclave__status)))))
(assert (forall ((enclave__status Int)) (! (=> (dynamic_invariant1 enclave__status true true true) (= (getstatus enclave__status) enclave__status)) :pattern ((getstatus enclave__status)))))
...
(assert true)
(assert (forall ((enclave__status Int)) (! (= (= (enrolmentisinprogress enclave__status) true) (in_range8 enclave__status)) :pattern ((enrolmentisinprogress enclave__status)))))
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(declare-fun presentadminhasdeparted (us_rep us_private) Bool)
(declare-fun presentadminhasdeparted__function_guard (Bool us_rep us_private) Bool)
(assert true)
...
(define-fun dynamic_invariant6 ((temp___expr_1798 Int) (temp___is_init_1795 Bool) (temp___skip_constant_1796 Bool) (temp___do_toplevel_1797 Bool)) Bool (=> (or (= temp___is_init_1795 true) (<= 0 2)) (in_range8 temp___expr_1798)))
(define-fun dynamic_invariant7 ((temp___expr_261 Int) (temp___is_init_258 Bool) (temp___skip_constant_259 Bool) (temp___do_toplevel_260 Bool)) Bool (=> (or (= temp___is_init_258 true) (<= 0 4)) (in_range5 temp___expr_261)))
(assert true)
(define-fun dynamic_invariant8 ((temp___expr_324 Int) (temp___is_init_321 Bool) (temp___skip_constant_322 Bool) (temp___do_toplevel_323 Bool)) Bool (=> (or (= temp___is_init_321 true) (<= 1 150)) (in_range6 temp___expr_324)))
...
(assert (= result (presentadminhasdeparted (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)) state1)))
