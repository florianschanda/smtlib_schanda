...
(declare-const temp___204 stack_capacity)
(declare-const temp___2041 (Array Int element))
(declare-const temp___2042 t)
(declare-const temp___2043 stack_extent)
(declare-const result (Array Int element))
(declare-const result1 t)
(declare-const result2 stack_extent)
(declare-const this__split_fields3 us_split_fields)
(declare-const this__split_fields4 us_split_fields__ref)
(declare-const this__split_fields5 us_split_fields)
(define-fun temp___2024 () us_rep (mk___rep (mk___split_discrs temp___202) (mk___split_fields (mk___t temp___2021 temp___2022) temp___2023)))
...
(assert (= o8 o4))
(assert (= o9 o5))
(assert (= temp___2024 (to_base (mk___rep1 (mk___split_discrs o6) (mk___split_fields1 (mk___t1 o7 o8) o9)))))
(assert (= temp___202 (rec__p__stack__capacity this__split_discrs)))
(assert (= (mk___rep (mk___split_discrs temp___204) (mk___split_fields (mk___t temp___2041 temp___2042) temp___2043)) temp___2024))
(assert (= result this__split_fields))
(assert (= result1 this__split_fields1))
(assert (= result2 this__split_fields2))
(assert (= this__split_fields3 (mk___split_fields (mk___t temp___2041 temp___2042) temp___2043)))
(assert (= this__split_discrs (mk___split_discrs temp___204)))
(assert (= this__split_fields4 (mk___split_fields__ref this__split_fields3)))
(assert (= this__split_fields5 this__split_fields3))
(assert (not (= (empty (mk___rep this__split_discrs (us_split_fields__content this__split_fields4))) true)))
(check-sat)
(exit)
