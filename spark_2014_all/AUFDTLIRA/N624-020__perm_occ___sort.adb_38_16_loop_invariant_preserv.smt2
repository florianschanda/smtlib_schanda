...
(assert (ite (= o19 (to_rep (select (elts1 init) o16))) (= (occ (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last))) e3) (occ (mk___t (elts1 init) (mk (to_rep1 (first2 (rt1 init))) (to_rep1 (last2 (rt1 init))))) e3)) (ite (= o19 e3) (= (occ (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last))) e3) (+ (occ (mk___t (elts1 init) (mk (to_rep1 (first2 (rt1 init))) (to_rep1 (last2 (rt1 init))))) e3) 1)) (ite (= (to_rep (select (elts1 init) o16)) e3) (= (occ (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last))) e3) (- (occ (mk___t (elts1 init) (mk (to_rep1 (first2 (rt1 init))) (to_rep1 (last2 (rt1 init))))) e3) 1)) (= (occ (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last))) e3) (occ (mk___t (elts1 init) (mk (to_rep1 (first2 (rt1 init))) (to_rep1 (last2 (rt1 init))))) e3))))))
(assert (and (<= (to_rep1 (first2 (rt1 init))) x) (<= x (to_rep1 (last2 (rt1 init))))))
(assert (= o21 x))
(assert (= o22 (select (elts1 init) o21)))
(assert (= o23 (to_rep o22)))
(assert (and (= o20 y) (in_range4 y)))
(assert (ite (= o23 (to_rep (select interm o20))) (= (occ (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last))) e3) (occ (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last))) e3)) (ite (= o23 e3) (= (occ (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last))) e3) (+ (occ (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last))) e3) 1)) (ite (= (to_rep (select interm o20)) e3) (= (occ (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last))) e3) (- (occ (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last))) e3) 1)) (= (occ (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last))) e3) (occ (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last))) e3))))))
(declare-const f Int)
(assert (<= 0 f))
(assert (<= f e3))
