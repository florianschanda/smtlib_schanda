...
(define-fun dynamic_invariant ((temp___expr_155 Int) (temp___is_init_152 Bool) (temp___skip_constant_153 Bool) (temp___do_toplevel_154 Bool)) Bool (=> (or (= temp___is_init_152 true) (<= 0 100)) (in_range temp___expr_155)))
...
(assert (= (mk___split_fields x__split_fields2 x__split_fields3) (us_split_fields1 (select a 5))))
(assert (not (<= 0 (get_length (mk___rep (mk___split_fields x__split_fields2 x__split_fields3))))))
(check-sat)
(exit)
