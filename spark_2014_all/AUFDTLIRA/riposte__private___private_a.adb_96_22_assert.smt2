...
(define-fun dynamic_invariant ((temp___expr_180 Int) (temp___is_init_176 Bool) (temp___skip_constant_177 Bool) (temp___do_toplevel_178 Bool) (temp___do_typ_inv_179 Bool)) Bool (=> (or (= temp___is_init_176 true) (<= 0 100)) (in_range temp___expr_180)))
...
(define-fun x__split_fields4 () us_split_fields (mk___split_fields x__split_fields2 x__split_fields3))
(assert (= result x__split_fields))
(assert (= result1 x__split_fields1))
(assert (= x__split_fields4 (us_split_fields1 (select a 5))))
(assert (not (<= 0 (get_length (mk___rep x__split_fields4)))))
(check-sat)
(exit)
