...
(assert (and (= (length source) 11) (and (and (and (and (and (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 50)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 49)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 3))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 4))) 55)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 5))) 52)) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 6))) 56)) (forall ((index3 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 6) index3) (<= index3 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index3))) true))))))
...
(assert (<= temp___2056 index1))
(assert (<= index1 temp___2057))
...
(assert (= n1 result3))
(assert (= n2 o8))
(assert (forall ((i Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 6) i) (<= i index2)) (and (<= 0 (to_rep1 (select n3 i))) (<= (to_rep1 (select n3 i)) 9)))))
(assert (forall ((j1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 6) j1) (<= j1 index2)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1))))))
(assert (and (and (forall ((temp___2060 Int)) (=> (and (<= (to_rep1 n__first) temp___2060) (<= temp___2060 (to_rep1 n__last))) (=> (or (< temp___2057 temp___2060) (or (< temp___2060 temp___2056) (< index2 temp___2060))) (= (select n3 temp___2060) (select n1 temp___2060))))) (=> (<= (+ (to_rep1 (first (rt source))) 6) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 6) (+ (to_rep1 (first (rt source))) 10) index2))) (and (<= (+ (to_rep1 (first (rt source))) 6) index2) (<= index2 (+ (to_rep1 (first (rt source))) 10)))))
(assert (and (= o9 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
