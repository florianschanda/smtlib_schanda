...
(define-fun dynamic_invariant ((temp___expr_138 Int) (temp___is_init_135 Bool) (temp___skip_constant_136 Bool) (temp___do_toplevel_137 Bool)) Bool (=> (or (= temp___is_init_135 true) (<= 0 255)) (in_range1 temp___expr_138)))
...
(define-fun dynamic_invariant1 ((temp___expr_144 Int) (temp___is_init_141 Bool) (temp___skip_constant_142 Bool) (temp___do_toplevel_143 Bool)) Bool (=> (or (= temp___is_init_141 true) (<= 1 2147483647)) (in_range2 temp___expr_144)))
...
(define-fun dynamic_invariant2 ((temp___expr_164 Int) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool)) Bool (=> (or (= temp___is_init_161 true) (<= 0 2147483647)) (in_range4 temp___expr_164)))
...
(declare-const temp___capacity_190 Int)
...
(assert (in_range4 temp___capacity_190))
(assert (<= 1 temp___capacity_190))
(assert (not (<= 1 1)))
(check-sat)
(exit)
