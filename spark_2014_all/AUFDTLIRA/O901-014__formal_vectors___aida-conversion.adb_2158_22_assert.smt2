...
(define-fun tint_arrayD1__ref___24__projection ((a tint_arrayD1__ref)) integer (tint_arrayD1__content a))
(declare-sort t1 0)
...
(define-fun tint_arrayT__ref___24__projection ((a tint_arrayT__ref)) us_t1 (tint_arrayT__content a))
...
(declare-datatypes () ((t761b__ref (mk_t761b__ref (t761b__content integer)))))
(define-fun t761b__ref___projection ((a t761b__ref)) integer (t761b__content a))
(declare-sort t2 0)
...
(declare-datatypes () ((t762b__ref (mk_t762b__ref (t762b__content us_t2)))))
...
(define-fun tnumber_array_typeD1__ref___33__projection ((a tnumber_array_typeD1__ref)) integer (tnumber_array_typeD1__content a))
(declare-sort t3 0)
...
(define-fun number_array_type__ref___33__projection ((a number_array_type__ref)) us_t3 (number_array_type__content a))
...
(declare-datatypes () ((t765b__ref (mk_t765b__ref (t765b__content integer)))))
(define-fun t765b__ref___projection ((a t765b__ref)) integer (t765b__content a))
(declare-sort t4 0)
...
(declare-datatypes () ((t766b__ref (mk_t766b__ref (t766b__content us_t4)))))
...
(declare-datatypes () ((t767b__ref (mk_t767b__ref (t767b__content integer)))))
(define-fun t767b__ref___projection ((a t767b__ref)) integer (t767b__content a))
...
(define-fun tint_arrayB__ref___24__projection ((a tint_arrayB__ref)) us_t5 (tint_arrayB__content a))
(declare-fun aida__conversion__calculate_negative_target_length_5__int_array__aggregate_def (Int Int Int Int Int Int) us_t2)
(assert (forall ((temp___2356 Int) (temp___2357 Int) (temp___2358 Int) (temp___2359 Int) (temp___2360 Int) (temp___2361 Int)) (let ((temp___2355 (aida__conversion__calculate_negative_target_length_5__int_array__aggregate_def temp___2356 temp___2357 temp___2358 temp___2359 temp___2360 temp___2361))) (and (=> (dynamic_property10 (+ (first1 source) 1) (+ (first1 source) 4) temp___2360 temp___2361) (and (= (first5 temp___2355) temp___2360) (= (last5 temp___2355) temp___2361))) (and (and (and (= (select (to_array2 temp___2355) (+ (+ (first1 source) 1) 0)) (of_rep1 temp___2356)) (= (select (to_array2 temp___2355) (+ (+ (first1 source) 1) 1)) (of_rep1 temp___2357))) (= (select (to_array2 temp___2355) (+ (+ (first1 source) 1) 2)) (of_rep1 temp___2358))) (= (select (to_array2 temp___2355) (+ (+ (first1 source) 1) 3)) (of_rep1 temp___2359)))))))
(declare-sort t6 0)
...
(define-fun tnumber_array_typeB__ref___33__projection ((a tnumber_array_typeB__ref)) us_t6 (tnumber_array_typeB__content a))
(declare-fun aida__conversion__calculate_negative_target_length_5__n__aggregate_def (Int Int Int) us_t4)
(assert (forall ((temp___2367 Int) (temp___2368 Int) (temp___2369 Int)) (let ((temp___2366 (aida__conversion__calculate_negative_target_length_5__n__aggregate_def temp___2367 temp___2368 temp___2369))) (and (=> (dynamic_property11 (+ (first1 source) 1) (+ (first1 source) 4) temp___2368 temp___2369) (and (= (first9 temp___2366) temp___2368) (= (last9 temp___2366) temp___2369))) (forall ((temp___2370 Int)) (= (select (to_array4 temp___2366) temp___2370) (of_rep1 temp___2367)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_779 us_t3) (temp___is_init_776 Bool) (temp___skip_constant_777 Bool) (temp___do_toplevel_778 Bool)) Bool (=> (not (= temp___skip_constant_777 true)) (and (dynamic_property6 (+ (first1 source) 1) (+ (first1 source) 4) (first7 temp___expr_779) (last7 temp___expr_779)) (and (= (first7 temp___expr_779) (+ (first1 source) 1)) (= (last7 temp___expr_779) (+ (first1 source) 4))))))
...
(assert (and (= (length source) 5) (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (forall ((index11 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) index11) (<= index11 (+ (to_rep1 (first (rt source))) 4))) (= (is_digit (to_rep (select (elts source) index11))) true))))))
(assert (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_negative_target_length_5__int_array__aggregate_def 9 9 9 9 (+ (to_rep1 (first (rt source))) 1) (+ (+ (to_rep1 (first (rt source))) 1) 3))))) (+ (to_rep1 (first (rt source))) 1)))
(assert (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_negative_target_length_5__int_array__aggregate_def 9 9 9 9 (+ (to_rep1 (first (rt source))) 1) (+ (+ (to_rep1 (first (rt source))) 1) 3))))) (+ (+ (to_rep1 (first (rt source))) 1) 3)))
(assert (= (mk___t2 temp___2364 temp___23641) (aida__conversion__calculate_negative_target_length_5__int_array__aggregate_def 9 9 9 9 (+ (to_rep1 (first (rt source))) 1) (+ (+ (to_rep1 (first (rt source))) 1) 3))))
(assert (= (ite (<= (to_rep1 (first4 temp___23641)) (to_rep1 (last4 temp___23641))) (+ (- (to_rep1 (last4 temp___23641)) (to_rep1 (first4 temp___23641))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 4)) (+ (- (+ (to_rep1 (first (rt source))) 4) (+ (to_rep1 (first (rt source))) 1)) 1) 0)))
(assert (= (slide1 temp___2364 (to_rep1 (first4 temp___23641)) (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_negative_target_length_5__int_array__assume))
(assert (= (mk1 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 4)) aida__conversion__calculate_negative_target_length_5__int_array__assume1))
(assert (= (mk_map__ref1 result1) (mk_map__ref1 int_array)))
(assert (= int_array1 aida__conversion__calculate_negative_target_length_5__int_array__assume))
(assert (= (to_rep1 int_array__first) (to_rep1 (first2 aida__conversion__calculate_negative_target_length_5__int_array__assume1))))
(assert (= (to_rep1 int_array__last) (to_rep1 (last2 aida__conversion__calculate_negative_target_length_5__int_array__assume1))))
(assert (and (dynamic_property2 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 4) (to_rep1 int_array__first) (to_rep1 int_array__last)) (and (= (to_rep1 int_array__first) (+ (to_rep1 (first (rt source))) 1)) (= (to_rep1 int_array__last) (+ (to_rep1 (first (rt source))) 4)))))
(assert (= (to_rep1 (first8 (rt4 (aida__conversion__calculate_negative_target_length_5__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 4))))) (+ (to_rep1 (first (rt source))) 1)))
(assert (= (to_rep1 (last8 (rt4 (aida__conversion__calculate_negative_target_length_5__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 4))))) (+ (to_rep1 (first (rt source))) 4)))
(assert (= (mk___t4 temp___2372 temp___23721) (aida__conversion__calculate_negative_target_length_5__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 4))))
(assert (= (ite (<= (to_rep1 (first8 temp___23721)) (to_rep1 (last8 temp___23721))) (+ (- (to_rep1 (last8 temp___23721)) (to_rep1 (first8 temp___23721))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 4)) (+ (- (+ (to_rep1 (first (rt source))) 4) (+ (to_rep1 (first (rt source))) 1)) 1) 0)))
(assert (= (slide1 temp___2372 (to_rep1 (first8 temp___23721)) (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_negative_target_length_5__n__assume))
(assert (= (mk3 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 4)) aida__conversion__calculate_negative_target_length_5__n__assume1))
(assert (= (mk_map__ref1 result2) (mk_map__ref1 n)))
(assert (= n1 aida__conversion__calculate_negative_target_length_5__n__assume))
(assert (= (to_rep1 n__first) (to_rep1 (first6 aida__conversion__calculate_negative_target_length_5__n__assume1))))
(assert (= (to_rep1 n__last) (to_rep1 (last6 aida__conversion__calculate_negative_target_length_5__n__assume1))))
(assert (and (dynamic_property6 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 4) (to_rep1 n__first) (to_rep1 n__last)) (and (= (to_rep1 n__first) (+ (to_rep1 (first (rt source))) 1)) (= (to_rep1 n__last) (+ (to_rep1 (first (rt source))) 4)))))
(assert (and (= temp___2378 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (= temp___2379 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (= (mk_int__ref result3) (mk_int__ref index)))
(assert (= index2 temp___2378))
(assert (=> (and (<= temp___2378 index2) (<= index2 temp___2379)) (= temp___2377 index2)))
(assert (=> (and (<= temp___2378 index2) (<= index2 temp___2379)) (= temp___2375 n1)))
(assert (=> (and (<= temp___2378 index2) (<= index2 temp___2379)) (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2378 index2) (<= index2 temp___2379)) (= o5 index2)))
(assert (=> (and (<= temp___2378 index2) (<= index2 temp___2379)) (= o6 (select n1 o5))))
(assert (=> (and (<= temp___2378 index2) (<= index2 temp___2379)) (= o7 (to_rep1 o6))))
(assert (=> (and (<= temp___2378 index2) (<= index2 temp___2379)) (= o7 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= temp___2378 index2) (<= index2 temp___2379)) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= temp___2378 index2) (<= index2 temp___2379)) (= o8 index2)))
(assert (=> (and (<= temp___2378 index2) (<= index2 temp___2379)) (= o9 (select (elts source) o8))))
(assert (=> (and (<= temp___2378 index2) (<= index2 temp___2379)) (= o10 (to_rep o9))))
(assert (=> (and (<= temp___2378 index2) (<= index2 temp___2379)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target2) (<= aida__conversion__convert_character_digit_to_integer__2__target2 9)) (= aida__conversion__convert_character_digit_to_integer__2__target2 (convert_character_digit_to_integer o10))) (ite (= (= o10 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 0) (ite (= (= o10 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 1) (ite (= (= o10 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 2) (ite (= (= o10 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 3) (ite (= (= o10 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 4) (ite (= (= o10 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 5) (ite (= (= o10 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 6) (ite (= (= o10 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 7) (ite (= (= o10 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 8) (=> (= (= o10 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target2))))
(assert (=> (and (<= temp___2378 index2) (<= index2 temp___2379)) (= (to_rep1 o11) aida__conversion__convert_character_digit_to_integer__2__target2)))
(assert (=> (and (<= temp___2378 index2) (<= index2 temp___2379)) (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2378 index2) (<= index2 temp___2379)) (= o12 index2)))
(assert (=> (and (<= temp___2378 index2) (<= index2 temp___2379)) (= o13 (store n1 o12 o11))))
(assert (=> (and (<= temp___2378 index2) (<= index2 temp___2379)) (= n1 result4)))
(assert (=> (and (<= temp___2378 index2) (<= index2 temp___2379)) (= n2 o13)))
(assert (=> (and (<= temp___2378 index2) (<= index2 temp___2379)) (forall ((i2 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) i2) (<= i2 index3)) (and (<= 0 (to_rep1 (select n3 i2))) (<= (to_rep1 (select n3 i2)) 9))))))
(assert (=> (and (<= temp___2378 index2) (<= index2 temp___2379)) (forall ((j1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) j1) (<= j1 index3)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1)))))))
(assert (=> (and (<= temp___2378 index2) (<= index2 temp___2379)) (and (and (forall ((temp___2376 Int)) (=> (and (<= (to_rep1 n__first) temp___2376) (<= temp___2376 (to_rep1 n__last))) (=> (< index3 temp___2376) (= (select n3 temp___2376) (select temp___2375 temp___2376))))) (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 4)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 4) index3))) (and (<= (+ (to_rep1 (first (rt source))) 1) index3) (<= index3 (+ (to_rep1 (first (rt source))) 4))))))
(assert (=> (and (<= temp___2378 index2) (<= index2 temp___2379)) (= index3 temp___2379)))
(assert (=> (and (<= temp___2378 index2) (<= index2 temp___2379)) (= index3 index5)))
(assert (=> (and (<= temp___2378 index2) (<= index2 temp___2379)) (= n3 n5)))
(assert (=> (and (<= temp___2378 index2) (<= index2 temp___2379)) (= index6 index3)))
(assert (=> (and (<= temp___2378 index2) (<= index2 temp___2379)) (= n6 n3)))
(assert (=> (and (<= temp___2378 index2) (<= index2 temp___2379)) (= index7 (mk_int__ref index5))))
(assert (=> (and (<= temp___2378 index2) (<= index2 temp___2379)) (= n7 (mk_map__ref1 n5))))
(assert (=> (and (<= temp___2378 index2) (<= index2 temp___2379)) (= index8 index6)))
(assert (=> (and (<= temp___2378 index2) (<= index2 temp___2379)) (= n8 n6)))
(assert (=> (not (and (<= temp___2378 index2) (<= index2 temp___2379))) (= index7 (mk_int__ref index2))))
(assert (=> (not (and (<= temp___2378 index2) (<= index2 temp___2379))) (= n7 (mk_map__ref1 n1))))
(assert (=> (not (and (<= temp___2378 index2) (<= index2 temp___2379))) (= index8 index2)))
(assert (=> (not (and (<= temp___2378 index2) (<= index2 temp___2379))) (= n8 n1)))
...
(assert (and (= temp___2380 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 n__first) temp___2380) (<= temp___2380 (to_rep1 n__last))))
(assert (= o41 temp___2380))
