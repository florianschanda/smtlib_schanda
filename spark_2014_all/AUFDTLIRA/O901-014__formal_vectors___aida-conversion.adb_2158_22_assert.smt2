...
(assert (forall ((temp___2458 Int) (temp___2459 Int) (temp___2460 Int) (temp___2461 Int) (temp___2462 Int) (temp___2463 Int)) (let ((temp___2457 (aida__conversion__calculate_negative_target_length_5__int_array__aggregate_def temp___2458 temp___2459 temp___2460 temp___2461 temp___2462 temp___2463))) (=> (and (and (and (dynamic_invariant temp___2458 true true true true) (dynamic_invariant temp___2459 true true true true)) (dynamic_invariant temp___2460 true true true true)) (dynamic_invariant temp___2461 true true true true)) (and (=> (dynamic_property10 (+ (first1 source) 1) (+ (first1 source) 4) temp___2462 temp___2463) (and (= (first5 temp___2457) temp___2462) (= (last5 temp___2457) temp___2463))) (and (and (and (= (select (to_array2 temp___2457) (+ (+ (first1 source) 1) 0)) rliteral) (= (select (to_array2 temp___2457) (+ (+ (first1 source) 1) 1)) rliteral)) (= (select (to_array2 temp___2457) (+ (+ (first1 source) 1) 2)) rliteral)) (= (select (to_array2 temp___2457) (+ (+ (first1 source) 1) 3)) rliteral)))))))
(define-fun dynamic_invariant4 ((temp___expr_874 us_t3) (temp___is_init_870 Bool) (temp___skip_constant_871 Bool) (temp___do_toplevel_872 Bool) (temp___do_typ_inv_873 Bool)) Bool (=> (not (= temp___skip_constant_871 true)) (and (dynamic_property6 (+ (first1 source) 1) (+ (first1 source) 4) (first7 temp___expr_874) (last7 temp___expr_874)) (and (= (first7 temp___expr_874) (+ (first1 source) 1)) (= (last7 temp___expr_874) (+ (first1 source) 4))))))
(declare-sort t6 0)
...
(assert (forall ((temp___2469 Int) (temp___2470 Int) (temp___2471 Int)) (let ((temp___2468 (aida__conversion__calculate_negative_target_length_5__n__aggregate_def temp___2469 temp___2470 temp___2471))) (=> (dynamic_invariant temp___2469 true true true true) (and (=> (dynamic_property11 (+ (first1 source) 1) (+ (first1 source) 4) temp___2470 temp___2471) (and (= (first9 temp___2468) temp___2470) (= (last9 temp___2468) temp___2471))) (forall ((temp___2472 Int)) (= (select (to_array4 temp___2468) temp___2472) rliteral1)))))))
...
(declare-const temp___2474 (Array Int integer))
(declare-const temp___24741 t4)
...
(declare-const temp___2476 Int)
(declare-const temp___2477 Int)
(declare-const temp___2481 Int)
(declare-const temp___2479 (Array Int integer))
(declare-const o Int)
...
(assert (and (= (length source) 5) (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (forall ((index7 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) index7) (<= index7 (+ (to_rep1 (first (rt source))) 4))) (= (is_digit (to_rep (select (elts source) index7))) true))))))
...
(assert (= (mk___t2 temp___2466 temp___24661) (aida__conversion__calculate_negative_target_length_5__int_array__aggregate_def 9 9 9 9 (+ (to_rep1 (first (rt source))) 1) (+ (+ (to_rep1 (first (rt source))) 1) 3))))
(assert (= (ite (<= (to_rep1 (first4 temp___24661)) (to_rep1 (last4 temp___24661))) (+ (- (to_rep1 (last4 temp___24661)) (to_rep1 (first4 temp___24661))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 4)) (+ (- (+ (to_rep1 (first (rt source))) 4) (+ (to_rep1 (first (rt source))) 1)) 1) 0)))
(assert (= (slide1 temp___2466 (to_rep1 (first4 temp___24661)) (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_negative_target_length_5__int_array__assume))
...
(assert (= (mk___t4 temp___2474 temp___24741) (aida__conversion__calculate_negative_target_length_5__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 4))))
(assert (= (ite (<= (to_rep1 (first8 temp___24741)) (to_rep1 (last8 temp___24741))) (+ (- (to_rep1 (last8 temp___24741)) (to_rep1 (first8 temp___24741))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 4)) (+ (- (+ (to_rep1 (first (rt source))) 4) (+ (to_rep1 (first (rt source))) 1)) 1) 0)))
(assert (= (slide1 temp___2474 (to_rep1 (first8 temp___24741)) (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_negative_target_length_5__n__assume))
...
(assert (and (= temp___2476 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (= temp___2477 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (= (mk_int__ref result2) (mk_int__ref index)))
(assert (= index1 temp___2476))
(assert (=> (and (<= temp___2476 index1) (<= index1 temp___2477)) (= temp___2481 index1)))
(assert (=> (and (<= temp___2476 index1) (<= index1 temp___2477)) (= temp___2479 n1)))
(assert (=> (and (<= temp___2476 index1) (<= index1 temp___2477)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2476 index1) (<= index1 temp___2477)) (= o index1)))
(assert (=> (and (<= temp___2476 index1) (<= index1 temp___2477)) (= o1 (select n1 o))))
(assert (=> (and (<= temp___2476 index1) (<= index1 temp___2477)) (= o2 (to_rep1 o1))))
(assert (=> (and (<= temp___2476 index1) (<= index1 temp___2477)) (= o2 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= temp___2476 index1) (<= index1 temp___2477)) (and (<= (to_rep1 (first (rt source))) index1) (<= index1 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= temp___2476 index1) (<= index1 temp___2477)) (= o3 index1)))
(assert (=> (and (<= temp___2476 index1) (<= index1 temp___2477)) (= o4 (select (elts source) o3))))
(assert (=> (and (<= temp___2476 index1) (<= index1 temp___2477)) (= o5 (to_rep o4))))
(assert (=> (and (<= temp___2476 index1) (<= index1 temp___2477)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target1) (<= aida__conversion__convert_character_digit_to_integer__2__target1 9)) (= aida__conversion__convert_character_digit_to_integer__2__target1 (convert_character_digit_to_integer o5))) (ite (= (= o5 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 0) (ite (= (= o5 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 1) (ite (= (= o5 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 2) (ite (= (= o5 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 3) (ite (= (= o5 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 4) (ite (= (= o5 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 5) (ite (= (= o5 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 6) (ite (= (= o5 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 7) (ite (= (= o5 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 8) (=> (= (= o5 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target1))))
(assert (=> (and (<= temp___2476 index1) (<= index1 temp___2477)) (= (to_rep1 o6) aida__conversion__convert_character_digit_to_integer__2__target1)))
(assert (=> (and (<= temp___2476 index1) (<= index1 temp___2477)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2476 index1) (<= index1 temp___2477)) (= o7 index1)))
(assert (=> (and (<= temp___2476 index1) (<= index1 temp___2477)) (= o8 (store n1 o7 o6))))
(assert (=> (and (<= temp___2476 index1) (<= index1 temp___2477)) (= n1 result3)))
(assert (=> (and (<= temp___2476 index1) (<= index1 temp___2477)) (= n2 o8)))
(assert (=> (and (<= temp___2476 index1) (<= index1 temp___2477)) (forall ((i Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) i) (<= i index2)) (and (<= 0 (to_rep1 (select n3 i))) (<= (to_rep1 (select n3 i)) 9))))))
(assert (=> (and (<= temp___2476 index1) (<= index1 temp___2477)) (forall ((j Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) j) (<= j index2)) (<= (to_rep1 (select n3 j)) (to_rep1 (select int_array1 j)))))))
(assert (=> (and (<= temp___2476 index1) (<= index1 temp___2477)) (and (and (forall ((temp___2480 Int)) (=> (and (<= (to_rep1 n__first) temp___2480) (<= temp___2480 (to_rep1 n__last))) (=> (or (< temp___2477 temp___2480) (or (< temp___2480 temp___2476) (< index2 temp___2480))) (= (select n3 temp___2480) (select temp___2479 temp___2480))))) (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 4)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 4) index2))) (and (<= (+ (to_rep1 (first (rt source))) 1) index2) (<= index2 (+ (to_rep1 (first (rt source))) 4))))))
(assert (=> (and (<= temp___2476 index1) (<= index1 temp___2477)) (= index2 temp___2477)))
(assert (=> (and (<= temp___2476 index1) (<= index1 temp___2477)) (= index2 index3)))
(assert (=> (and (<= temp___2476 index1) (<= index1 temp___2477)) (= n3 n4)))
(assert (=> (and (<= temp___2476 index1) (<= index1 temp___2477)) (= index4 index2)))
(assert (=> (and (<= temp___2476 index1) (<= index1 temp___2477)) (= n5 n3)))
(assert (=> (and (<= temp___2476 index1) (<= index1 temp___2477)) (= index5 (mk_int__ref index3))))
(assert (=> (and (<= temp___2476 index1) (<= index1 temp___2477)) (= n6 (mk_map__ref1 n4))))
(assert (=> (and (<= temp___2476 index1) (<= index1 temp___2477)) (= index6 index4)))
(assert (=> (and (<= temp___2476 index1) (<= index1 temp___2477)) (= n7 n5)))
(assert (=> (not (and (<= temp___2476 index1) (<= index1 temp___2477))) (= index5 (mk_int__ref index1))))
(assert (=> (not (and (<= temp___2476 index1) (<= index1 temp___2477))) (= n6 (mk_map__ref1 n1))))
(assert (=> (not (and (<= temp___2476 index1) (<= index1 temp___2477))) (= index6 index1)))
(assert (=> (not (and (<= temp___2476 index1) (<= index1 temp___2477))) (= n7 n1)))
...
(assert (and (= temp___2482 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 n__first) temp___2482) (<= temp___2482 (to_rep1 n__last))))
(assert (= o9 temp___2482))
