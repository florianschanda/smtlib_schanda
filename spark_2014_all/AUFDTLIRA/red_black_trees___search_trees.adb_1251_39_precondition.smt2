...
(assert (and (= temp___2124 (model__ (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) o12)) (and (dynamic_invariant8 temp___2124 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2124 o12))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___2124 o12)))) 0) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (not (= i2 o12)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) i2) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2124 (parent (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) i2)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2124 i2))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2124 i2))) true)))))) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2124 i2))) true) (not (= i2 o12))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___2124 (parent (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) i2)))) (position (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) i2) (rec__tree_model__path_type__a (us_split_fields1 (select temp___2124 i2)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___2124 i2)))) 0)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2124 i2))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2124 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___2124 i2))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___2124 j)))) true)) (= j i2))))))))))))))
(assert (= o13 (select temp___2124 i1)))
