...
(assert (and (= o (extended_perm a b)) (and (in_range2 o) (=> (= (of_int o) true) (forall ((ia1 Int)) (=> (and (<= (to_rep1 (first (rt a))) ia1) (<= ia1 (to_rep1 (last (rt a))))) (exists ((ib3 Int)) (and (and (<= (to_rep1 (first (rt b))) ib3) (<= ib3 (to_rep1 (last (rt b))))) (and (= (to_rep (select (elts a) ia1)) (to_rep (select (elts b) ib3))) (= (is_perm (remove a ia1) (remove b ib3)) true))))))))))
