...
(assert (and (= o3 (remove b o)) (and (dynamic_invariant o3 true false true true) (and (= (invariant__ o3) true) (and (= (to_rep (last o2)) (- (to_rep (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o 1))) (= (to_rep1 (select (elts b) k)) (to_rep1 (select o1 k))))) (and (forall ((k Int)) (=> (and (<= (+ o 1) k) (<= k (to_rep (last (rt b))))) (= (to_rep1 (select (elts b) k)) (to_rep1 (select o1 (- k 1)))))) (forall ((k Int)) (=> (and (<= o k) (<= k (- (to_rep (last (rt b))) 1))) (= (to_rep1 (select (elts b) (+ k 1))) (to_rep1 (select o1 k))))))))))))
(assert (not (in_range3 (to_rep (first (rt a))))))
(check-sat)
(exit)
