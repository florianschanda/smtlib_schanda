...
(assert (= temp___156 g))
(assert (= (mk___rep (mk___split_fields vol__ident__x__compl)) (select temp___156 1)))
(assert (in_range temp___157))
(assert (= result g))
(assert (= g1 (store g 1 (mk___rep (mk___split_fields vol__ident__x__fields)))))
(assert (= vol__h3__assume temp___157))
(assert (= vol__h3__assume h3))
(assert (in_range h3))
(assert (= temp___152 g2))
(assert (= (mk___rep (mk___split_fields vol__ident__x__compl1)) (select temp___152 1)))
...
(assert (= result2 h1))
(assert (= h11 o))
(assert (= temp___154 g4))
(assert (= (mk___rep (mk___split_fields vol__ident__x__compl2)) (select temp___154 1)))
(assert (in_range temp___155))
(assert (= result3 g4))
