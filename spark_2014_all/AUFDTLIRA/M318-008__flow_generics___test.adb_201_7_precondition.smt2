...
(declare-const o1 t)
(declare-const o2 (Array Int fruits))
...
(assert (forall ((i Int)) (=> (and (<= (to_rep initial_crate__first) i) (<= i (to_rep initial_crate__last))) (not (= (found_none (to_rep1 (select o2 i))) true)))))
(assert (dynamic_property 1 2147483647 (to_rep initial_crate__first) (to_rep initial_crate__last)))
(assert (= o2 o))
(assert (= (mk (to_rep initial_crate__first) (to_rep initial_crate__last)) o1))
(assert (not (= (to_rep (last o1)) (to_rep final_crate__last))))
(check-sat)
(exit)
