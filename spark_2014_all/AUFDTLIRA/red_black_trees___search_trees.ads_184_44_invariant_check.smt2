...
(assert (<= j8 100))
(assert (type_invariant1 (mk___rep3 (us_split_fields__content3 t__split_fields12))))
(assert (and (= temp___975 (model__1 (mk___rep3 (us_split_fields__content3 t__split_fields12)))) (and (dynamic_invariant6 temp___975 true false true) (= temp___975 (model__ (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields12)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields__content3 t__split_fields12))))))))
(assert (= o187 (select temp___975 j8)))
(assert (= o188 (us_split_fields1 o187)))
(assert (= result57 (rec__tree_model__path_type__k o188)))
(assert (= result57 true))
