...
(assert (= (to_rep (rec__do_loops__r__f1 (us_split_fields1 (select (rec__do_loops__r_array_record__f3 (us_split_fields__content1 d__split_fields28)) i23)))) (to_rep (rec__do_loops__r__f1 (us_split_fields1 (select (rec__do_loops__r_array_record__f3 (us_split_fields__content1 d__split_fields22)) i23))))))
(assert (not (= (to_rep (rec__do_loops__r__f2 (us_split_fields1 (select (rec__do_loops__r_array_record__f3 (us_split_fields__content1 d__split_fields28)) i23)))) (to_rep (rec__do_loops__r__f2 (us_split_fields1 (select (rec__do_loops__r_array_record__f3 (us_split_fields__content1 d__split_fields22)) i23)))))))
(check-sat)
(exit)
