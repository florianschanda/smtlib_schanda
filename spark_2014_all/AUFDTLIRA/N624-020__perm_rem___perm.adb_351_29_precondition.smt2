...
(assert (< ib ib2))
(assert (and (= o6 (get_witness bb2 aa ib)) (and (in_range3 o6) (and (and (<= (to_rep1 (first (rt aa))) o6) (<= o6 (to_rep1 (last (rt aa))))) (and (= (to_rep (select (elts bb2) ib)) (to_rep (select (elts aa) o6))) (= (is_perm (remove bb2 ib) (remove aa o6)) true))))))
(assert (= (mk_int__ref result7) (mk_int__ref ia2)))
(assert (= ia22 o6))
(assert (and (= o7 (remove_swap b ib ib2)) (and (in_range2 o7) (=> (= (of_int o7) true) (= (let ((temp___157 (remove (remove b ib2) ib))) (let ((temp___156 (remove (remove b ib) (- ib2 1)))) (bool_eq (elts temp___156) (to_rep1 (first (rt temp___156))) (to_rep1 (last (rt temp___156))) (elts temp___157) (to_rep1 (first (rt temp___157))) (to_rep1 (last (rt temp___157)))))) true)))))
(assert (= h3 result8))
(assert (= h4 o7))
(assert (= (of_int h4) true))
(assert (and (= o12 (- ib2 1)) (in_range3 (- ib2 1))))
