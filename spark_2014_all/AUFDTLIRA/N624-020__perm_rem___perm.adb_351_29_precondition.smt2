...
(assert (= ia21 o3))
(assert (and (= o4 (remove_swap b ib ib2)) (and (in_range2 o4) (=> (= (of_int o4) true) (= (let ((temp___157 (remove (remove b ib2) ib))) (let ((temp___156 (remove (remove b ib) (- ib2 1)))) (bool_eq (elts temp___156) (to_rep1 (first (rt temp___156))) (to_rep1 (last (rt temp___156))) (elts temp___157) (to_rep1 (first (rt temp___157))) (to_rep1 (last (rt temp___157)))))) true)))))
(assert (= h3 result4))
(assert (= h4 o4))
