...
(assert (forall ((train1 Int)) (=> (and (<= 1 train1) (<= train1 cur_num_trains)) (forall ((id7 Int)) (=> (and (<= 1 id7) (<= id7 3)) (and (=> (not (= (get_previous_track (select trains1 train1) id7) 0)) (let ((temp___383 (to_rep5 (select (map__content4 track_signals6) (get_previous_track (select trains1 train1) id7))))) (or (= temp___383 1) (= temp___383 2)))) (=> (not (= (get_other_previous_track (select trains1 train1) id7) 0)) (let ((temp___384 (to_rep5 (select (map__content4 track_signals6) (get_other_previous_track (select trains1 train1) id7))))) (or (= temp___384 1) (= temp___384 2))))))))))
