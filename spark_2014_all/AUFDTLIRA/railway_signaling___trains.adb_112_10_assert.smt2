...
(assert (forall ((train2 Int)) (=> (and (<= 1 train2) (<= train2 cur_num_trains)) (forall ((id35 Int)) (=> (and (<= 1 id35) (<= id35 3)) (and (=> (not (= (get_previous_track (select trains3 train2) id35) 0)) (let ((temp___383 (to_rep5 (select (map__content4 track_signals10) (get_previous_track (select trains3 train2) id35))))) (or (= temp___383 1) (= temp___383 2)))) (=> (not (= (get_other_previous_track (select trains3 train2) id35) 0)) (let ((temp___384 (to_rep5 (select (map__content4 track_signals10) (get_other_previous_track (select trains3 train2) id35))))) (or (= temp___384 1) (= temp___384 2))))))))))
(assert (not (= (previous_tracks_on_orange_or_red cur_num_trains trains3 (map__content4 track_signals10)) true)))
(check-sat)
(exit)
