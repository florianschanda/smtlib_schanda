...
(assert (=> (not (= first_available1 0)) (and (= o47 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range3 o47))))
(assert (=> (not (= first_available1 0)) (= result13 (ite (< 0 o47) true false))))
(assert (=> (not (= first_available1 0)) (=> (= result13 true) (and (= o46 (get (rec__list_allocator__m__t__available model____split_fields3) 1)) (in_range4 o46)))))
(assert (=> (not (= first_available1 0)) (=> (= result13 true) (= result12 (ite (= o46 first_available1) true false)))))
(assert (=> (not (= first_available1 0)) (=> (not (= result13 true)) (= result12 false))))
(assert (=> (not (not (= first_available1 0))) (and (= o48 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range3 o48))))
(assert (=> (not (not (= first_available1 0))) (= result12 (ite (= o48 0) true false))))
(assert (=> (= result12 true) (=> (not (= first_allocated1 0)) (and (= o44 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range3 o44)))))
(assert (=> (= result12 true) (=> (not (= first_allocated1 0)) (= result14 (ite (< 0 o44) true false)))))
(assert (=> (= result12 true) (=> (not (= first_allocated1 0)) (=> (= result14 true) (and (= o43 (get (rec__list_allocator__m__t__allocated model____split_fields3) 1)) (in_range4 o43))))))
(assert (=> (= result12 true) (=> (not (= first_allocated1 0)) (=> (= result14 true) (= result11 (ite (= o43 first_allocated1) true false))))))
(assert (=> (= result12 true) (=> (not (= first_allocated1 0)) (=> (not (= result14 true)) (= result11 false)))))
(assert (=> (= result12 true) (=> (not (not (= first_allocated1 0))) (and (= o45 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range3 o45)))))
(assert (=> (= result12 true) (=> (not (not (= first_allocated1 0))) (= result11 (ite (= o45 0) true false)))))
(assert (=> (not (= result12 true)) (= result11 false)))
(assert (=> (= result11 true) (and (= o41 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range3 o41))))
(assert (=> (= result11 true) (= o42 (ite (<= j1 o41) true false))))
(assert (=> (= result11 true) (= result15 (ite (<= 1 j1) o42 false))))
...
(assert (= result17 (ite (in_range7 o40) true false)))
