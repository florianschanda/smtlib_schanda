...
(assert (forall ((us_void_param tuple0)) (! (and (and (= (to_rep (select (temp___String_Literal_247 us_void_param) 1)) 102) (= (to_rep (select (temp___String_Literal_247 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_247 us_void_param) 3)) 111)) :pattern ((temp___String_Literal_247 us_void_param)))))
