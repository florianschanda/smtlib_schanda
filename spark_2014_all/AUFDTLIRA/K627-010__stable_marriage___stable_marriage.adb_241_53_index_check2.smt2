...
(assert (= result true))
(assert (= (= o true) (forall ((g1_id1 Int)) (=> (and (<= 1 g1_id1) (<= g1_id1 64)) (=> (forall ((idx1 Int)) (=> (and (<= 1 idx1) (<= idx1 (to_rep2 unmatched_g1_set__split_fields1))) (not (= (to_rep (select unmatched_g1_set__split_fields idx1)) g1_id1)))) (and (< 0 (to_rep2 (select proposals_made g1_id1))) (= (to_rep (select result__ (to_rep3 (select (select ranking_1 g1_id1) (to_rep2 (select proposals_made g1_id1)))))) g1_id1)))))))
(assert (<= 1 g1_id))
(assert (<= g1_id 64))
(assert (= (to_rep2 (select proposals_made g1_id)) 0))
(assert (<= 1 idx))
