...
(define-fun utility__search_for_zero__result8 () int__ref (mk_int__ref utility__search_for_zero__result6))
(assert (exists ((index7 Int)) (and (and (<= 0 index7) (<= index7 1023)) (= (to_rep (select values index7)) 0))))
(assert (not (not (and (and (= (mk_int__ref result) (mk_int__ref index)) (= index1 0)) (ite (and (<= 0 index1) (<= index1 1023)) (and (and (and (= temp___150 index1) (and (and (not (= (to_rep (select values index1)) 0)) (and (= utility__search_for_zero__result2 utility__search_for_zero__result) (= utility__search_for_zero__result2 utility__search_for_zero__result1))) (and (exists ((j Int)) (and (and (<= (+ index2 1) j) (<= j 1023)) (= (to_rep (select values j)) 0))) (and (and (=> (<= 0 1023) (in_range2 index2)) (and (<= 0 index2) (<= index2 1023))) (= index2 1023))))) (and (and (= utility__search_for_zero__result3 utility__search_for_zero__result4) (= index2 index3)) (and (= utility__search_for_zero__result5 utility__search_for_zero__result3) (= index4 index2)))) (and (and (= utility__search_for_zero__result8 (mk_int__ref utility__search_for_zero__result4)) (= (mk_int__ref index5) (mk_int__ref index3))) (and (= utility__search_for_zero__result7 utility__search_for_zero__result5) (= index6 index4)))) (and (and (= utility__search_for_zero__result8 (mk_int__ref utility__search_for_zero__result)) (= index1 index5)) (and (= utility__search_for_zero__result7 utility__search_for_zero__result1) (= index6 index1))))))))
(check-sat)
(exit)
