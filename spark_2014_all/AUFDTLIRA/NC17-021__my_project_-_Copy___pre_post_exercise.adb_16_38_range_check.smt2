...
(define-fun dynamic_invariant1 ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= 0 100)) (in_range1 temp___expr_136)))
...
(declare-const stack_pointer1 Int)
(assert (in_range1 stack_pointer))
(assert (in_range x))
(assert (not (in_range1 (+ stack_pointer 1))))
(check-sat)
(exit)
