...
(assert (and (and (forall ((temp___1568 Int)) (=> (and (<= (to_rep1 n__first) temp___1568) (<= temp___1568 (to_rep1 n__last))) (=> (< index2 temp___1568) (= (select n3 temp___1568) (select n1 temp___1568))))) (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 8)) (dynamic_property5 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 8) index2))) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (+ (to_rep1 (first (rt source))) 8)))))
(assert (not (= index2 temp___1571)))
