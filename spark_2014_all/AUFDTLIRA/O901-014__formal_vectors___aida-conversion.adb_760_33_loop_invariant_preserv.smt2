...
(assert (= n1 result2))
(assert (= n2 o8))
(assert (forall ((j1 Int)) (=> (and (<= (to_rep1 (first (rt source))) j1) (<= j1 index3)) (= (to_rep1 (select n3 j1)) (convert_character_digit_to_integer (to_rep (select (elts source) j1)))))))
(assert (and (and (forall ((temp___1568 Int)) (=> (and (<= (to_rep1 n__first) temp___1568) (<= temp___1568 (to_rep1 n__last))) (=> (< index3 temp___1568) (= (select n3 temp___1568) (select n1 temp___1568))))) (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 8)) (dynamic_property5 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 8) index3))) (and (<= (to_rep1 (first (rt source))) index3) (<= index3 (+ (to_rep1 (first (rt source))) 8)))))
(assert (not (= index3 temp___1571)))
(assert (= index3 result3))
(assert (= index4 (+ index3 1)))
(assert (and (<= (to_rep1 n__first) index4) (<= index4 (to_rep1 n__last))))
(assert (= o13 index4))
(assert (= o14 (select n3 o13)))
(assert (= o15 (to_rep1 o14)))
(assert (= o15 aida__conversion__convert_character_digit_to_integer__2__target1))
...
(assert (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target3) (<= aida__conversion__convert_character_digit_to_integer__2__target3 9)) (= aida__conversion__convert_character_digit_to_integer__2__target3 (convert_character_digit_to_integer o18))) (ite (= (= o18 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 0) (ite (= (= o18 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 1) (ite (= (= o18 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 2) (ite (= (= o18 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 3) (ite (= (= o18 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 4) (ite (= (= o18 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 5) (ite (= (= o18 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 6) (ite (= (= o18 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 7) (ite (= (= o18 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 8) (=> (= (= o18 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target3)))
(assert (= (to_rep1 o19) aida__conversion__convert_character_digit_to_integer__2__target3))
(assert (and (<= (to_rep1 n__first) index4) (<= index4 (to_rep1 n__last))))
(assert (= o20 index4))
(assert (= o21 (store n3 o20 o19)))
(assert (= result4 n3))
(assert (= n4 o21))
(declare-const j1 Int)
(assert (<= (to_rep1 (first (rt source))) j1))
(assert (<= j1 index4))
(assert (not (= (to_rep1 (select n4 j1)) (convert_character_digit_to_integer (to_rep (select (elts source) j1))))))
(check-sat)
(exit)
