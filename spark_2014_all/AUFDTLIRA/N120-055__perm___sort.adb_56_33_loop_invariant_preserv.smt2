...
(declare-const temp___1902 (Array Int natural))
(declare-const temp___1903 t1)
...
(assert (not (= current2 temp___197)))
...
(assert (= o7 values3))
(assert (= o7 temp___1902))
(assert (= (mk1 current3 (to_rep values__last)) temp___1903))
(assert (= temp___1902 o8))
(assert (= (mk (to_rep (first2 temp___1903)) (to_rep (last2 temp___1903))) o9))
