...
(assert (=> (not (= smallest3 current3)) (= (is_perm__logic (mk___t values3 (mk (to_rep values__first) (to_rep values__last))) (mk___t values4 (mk (to_rep values__first) (to_rep values__last)))) true)))
