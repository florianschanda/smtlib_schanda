...
(assert (<= 1 j1))
(assert (<= j1 100))
(assert (ite (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j1))) true) (not (= j1 root)) true))
(assert (ite (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j1))) true) true false))
