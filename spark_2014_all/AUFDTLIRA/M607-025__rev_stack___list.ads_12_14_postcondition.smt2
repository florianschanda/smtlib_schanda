...
(assert (= i8 first4))
(assert (=> (and (<= first4 i8) (<= i8 last5)) (= temp___527 i8)))
(assert (=> (and (<= first4 i8) (<= i8 last5)) (= (us_split_fields__content s__split_fields7) (mk___split_fields temp___526 temp___5261))))
(assert (=> (and (<= first4 i8) (<= i8 last5)) (and (= res__split_discrs (mk___split_discrs temp___525)) (= res__split_fields1 (mk___split_fields1 temp___5251)))))
(assert (=> (and (<= first4 i8) (<= i8 last5)) (= temp___529 (mk___rep (us_split_fields__content s__split_fields7)))))
(assert (=> (and (<= first4 i8) (<= i8 last5)) (and (and (and (= (length2 (mk___rep1 res__split_discrs res__split_fields2)) (- i9 first4)) (= (to_rep (last (rt (to__ (mk___rep s__split_fields9))))) (+ (- last5 i9) 1))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (+ (- last5 i9) 1))) (= (to_rep (select (elts (to__ (mk___rep s__split_fields9))) j)) (to_rep (select (elts (to__ temp___529)) j)))))) (forall ((j Int)) (=> (and (<= first4 j) (<= j (- i9 1))) (= (get (model__ (mk___rep1 res__split_discrs res__split_fields2)) j) (get (model__ l) (+ (- last5 j) first4))))))))
...
(assert (=> (and (<= first4 i8) (<= i8 last5)) (= (let ((temp___222 (to__ (mk___rep s__split_fields10)))) (bool_eq (elts temp___222) (to_rep (first (rt temp___222))) (to_rep (last (rt temp___222))) (elts (to__ (mk___rep s__split_fields9))) (to_rep (first2 (mk1 1 (- (to_rep (last (rt (to__ (mk___rep s__split_fields9))))) 1)))) (to_rep (last2 (mk1 1 (- (to_rep (last (rt (to__ (mk___rep s__split_fields9))))) 1)))))) true)))
