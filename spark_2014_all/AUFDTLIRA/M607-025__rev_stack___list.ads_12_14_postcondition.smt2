...
(declare-const result15 capacity_range)
(declare-const result16 us_main_type)
...
(assert (= (mk___rep1 (mk___split_discrs result15) (mk___split_fields1 result16)) (list__content list__reverse_list__result5)))
(declare-const i31 Int)
(assert (<= 1 i31))
(assert (<= i31 (last4 (model__ l))))
(assert (not (= (get (model__ l) i31) (get (model__ (list__content list__reverse_list__result5)) (+ (- (last4 (model__ l)) i31) 1)))))
(check-sat)
(exit)
