...
(declare-const result6 capacity_range)
(declare-const result7 us_main_type)
...
(assert (= i2 first4))
(assert (=> (and (<= first4 i2) (<= i2 last5)) (= temp___471 i2)))
(assert (=> (and (<= first4 i2) (<= i2 last5)) (= s__split_fields2 (mk___split_fields temp___470 temp___4701))))
...
(assert (= i8 first4))
(assert (=> (and (<= first4 i8) (<= i8 last5)) (= temp___481 i8)))
(assert (=> (and (<= first4 i8) (<= i8 last5)) (= (us_split_fields__content s__split_fields7) (mk___split_fields temp___480 temp___4801))))
(assert (=> (and (<= first4 i8) (<= i8 last5)) (and (= res__split_discrs (mk___split_discrs temp___479)) (= res__split_fields1 (mk___split_fields1 temp___4791)))))
(assert (=> (and (<= first4 i8) (<= i8 last5)) (= temp___483 (mk___rep (us_split_fields__content s__split_fields7)))))
(assert (=> (and (<= first4 i8) (<= i8 last5)) (and (and (and (= (length2 (mk___rep1 res__split_discrs res__split_fields2)) (- i9 first4)) (= (to_rep (last (rt (to__ (mk___rep s__split_fields9))))) (+ (- last5 i9) 1))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (+ (- last5 i9) 1))) (= (to_rep (select (elts (to__ (mk___rep s__split_fields9))) j)) (to_rep (select (elts (to__ temp___483)) j)))))) (forall ((j Int)) (=> (and (<= first4 j) (<= j (- i9 1))) (= (get (model__ (mk___rep1 res__split_discrs res__split_fields2)) j) (get (model__ l) (+ (- last5 j) first4))))))))
(assert (=> (and (<= first4 i8) (<= i8 last5)) (and (=> (<= first4 last5) (dynamic_property4 first4 last5 i9)) (and (<= first4 i9) (<= i9 last5)))))
(assert (=> (and (<= first4 i8) (<= i8 last5)) (and (= o2 (top (mk___rep s__split_fields9))) (and (in_range1 o2) (and (= o2 (to_rep (select (rec__stack__stack__content s__split_fields9) (to_rep1 (rec__stack__stack__top s__split_fields9))))) (= o2 (to_rep (select (elts (to__ (mk___rep s__split_fields9))) (to_rep (last (rt (to__ (mk___rep s__split_fields9)))))))))))))
(assert (=> (and (<= first4 i8) (<= i8 last5)) (and (and (= (length2 (mk___rep1 res__split_discrs list__my_lists__append__2__container__fields)) (+ (length2 (mk___rep1 res__split_discrs res__split_fields2)) 1)) (= (olt (model__ (mk___rep1 res__split_discrs res__split_fields2)) (model__ (mk___rep1 res__split_discrs list__my_lists__append__2__container__fields))) true)) (= (get (model__ (mk___rep1 res__split_discrs list__my_lists__append__2__container__fields)) (+ (last4 (model__ (mk___rep1 res__split_discrs res__split_fields2))) 1)) o2))))
(assert (=> (and (<= first4 i8) (<= i8 last5)) (= result4 (mk___split_fields__ref1 res__split_fields2))))
(assert (=> (and (<= first4 i8) (<= i8 last5)) (= res__split_fields3 list__my_lists__append__2__container__fields)))
(assert (=> (and (<= first4 i8) (<= i8 last5)) (= (let ((temp___195 (to__ (mk___rep s__split_fields10)))) (bool_eq (elts temp___195) (to_rep (first (rt temp___195))) (to_rep (last (rt temp___195))) (elts (to__ (mk___rep s__split_fields9))) (to_rep (first2 (mk1 1 (- (to_rep (last (rt (to__ (mk___rep s__split_fields9))))) 1)))) (to_rep (last2 (mk1 1 (- (to_rep (last (rt (to__ (mk___rep s__split_fields9))))) 1)))))) true)))
(assert (=> (and (<= first4 i8) (<= i8 last5)) (= i9 last5)))
(assert (=> (and (<= first4 i8) (<= i8 last5)) (= i10 (mk_int__ref i9))))
(assert (=> (and (<= first4 i8) (<= i8 last5)) (= res__split_fields4 (mk___split_fields__ref1 res__split_fields3))))
(assert (=> (and (<= first4 i8) (<= i8 last5)) (= s__split_fields11 (mk___split_fields__ref s__split_fields10))))
(assert (=> (and (<= first4 i8) (<= i8 last5)) (= i11 i9)))
(assert (=> (and (<= first4 i8) (<= i8 last5)) (= res__split_fields5 res__split_fields3)))
(assert (=> (and (<= first4 i8) (<= i8 last5)) (= s__split_fields12 s__split_fields10)))
(assert (=> (and (<= first4 i8) (<= i8 last5)) (= i12 i10)))
(assert (=> (and (<= first4 i8) (<= i8 last5)) (= res__split_fields6 res__split_fields4)))
(assert (=> (and (<= first4 i8) (<= i8 last5)) (= s__split_fields13 s__split_fields11)))
(assert (=> (and (<= first4 i8) (<= i8 last5)) (= i13 i11)))
(assert (=> (and (<= first4 i8) (<= i8 last5)) (= res__split_fields7 res__split_fields5)))
(assert (=> (and (<= first4 i8) (<= i8 last5)) (= s__split_fields14 s__split_fields12)))
(assert (=> (not (and (<= first4 i8) (<= i8 last5))) (= i12 (mk_int__ref i8))))
(assert (=> (not (and (<= first4 i8) (<= i8 last5))) (= res__split_fields6 (mk___split_fields__ref1 res__split_fields1))))
(assert (=> (not (and (<= first4 i8) (<= i8 last5))) (= s__split_fields13 s__split_fields7)))
(assert (=> (not (and (<= first4 i8) (<= i8 last5))) (= i13 i8)))
(assert (=> (not (and (<= first4 i8) (<= i8 last5))) (= res__split_fields7 res__split_fields1)))
(assert (=> (not (and (<= first4 i8) (<= i8 last5))) (= s__split_fields14 s__split_fields8)))
...
(assert (= (mk___rep1 (mk___split_discrs result6) (mk___split_fields1 result7)) (list__content list__reverse_list__result5)))
(declare-const i22 Int)
(assert (<= 1 i22))
(assert (<= i22 (last4 (model__ l))))
(assert (not (= (get (model__ l) i22) (get (model__ (list__content list__reverse_list__result5)) (+ (- (last4 (model__ l)) i22) 1)))))
(check-sat)
(exit)
