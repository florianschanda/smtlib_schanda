...
(declare-const temp___1753 (Array Int character))
(declare-const temp___17531 t)
...
(assert (= (concat1 (temp___String_Literal_1748 Tuple0) 1 6 firsttime1 1 21) temp___1751))
(assert (= (mk 1 o7) temp___17511))
(assert (=> (= (length (mk___t temp___1751 temp___17511)) 0) (= (temp___String_Literal_1750 Tuple0) temp___1753)))
(assert (=> (= (length (mk___t temp___1751 temp___17511)) 0) (= (mk 1 5) temp___17531)))
(assert (=> (not (= (length (mk___t temp___1751 temp___17511)) 0)) (=> (<= 1 5) (= o8 (+ (- 5 1) 1)))))
(assert (=> (not (= (length (mk___t temp___1751 temp___17511)) 0)) (=> (not (<= 1 5)) (= o8 0))))
(assert (=> (not (= (length (mk___t temp___1751 temp___17511)) 0)) (=> (<= (to_rep1 (first temp___17511)) (to_rep1 (last temp___17511))) (= o9 (+ (- (to_rep1 (last temp___17511)) (to_rep1 (first temp___17511))) 1)))))
(assert (=> (not (= (length (mk___t temp___1751 temp___17511)) 0)) (=> (not (<= (to_rep1 (first temp___17511)) (to_rep1 (last temp___17511)))) (= o9 0))))
(assert (=> (not (= (length (mk___t temp___1751 temp___17511)) 0)) (= o10 (+ o9 o8))))
(assert (=> (not (= (length (mk___t temp___1751 temp___17511)) 0)) (= o11 (+ (to_rep1 (first temp___17511)) o10))))
(assert (=> (not (= (length (mk___t temp___1751 temp___17511)) 0)) (= o12 (- o11 1))))
(assert (=> (not (= (length (mk___t temp___1751 temp___17511)) 0)) (and (= o13 o12) (in_range2 o12))))
(assert (=> (not (= (length (mk___t temp___1751 temp___17511)) 0)) (= (concat1 temp___1751 (to_rep1 (first temp___17511)) (to_rep1 (last temp___17511)) (temp___String_Literal_1750 Tuple0) 1 5) temp___1753)))
(assert (=> (not (= (length (mk___t temp___1751 temp___17511)) 0)) (= (mk (to_rep1 (first temp___17511)) o13) temp___17531)))
(assert (not (= (length (mk___t temp___1753 temp___17531)) 0)))
(assert (=> (<= 1 21) (= o14 (+ (- 21 1) 1))))
(assert (=> (not (<= 1 21)) (= o14 0)))
(assert (=> (<= (to_rep1 (first temp___17531)) (to_rep1 (last temp___17531))) (= o15 (+ (- (to_rep1 (last temp___17531)) (to_rep1 (first temp___17531))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___17531)) (to_rep1 (last temp___17531)))) (= o15 0)))
(assert (= o16 (+ o15 o14)))
(assert (= o17 (+ (to_rep1 (first temp___17531)) o16)))
(assert (= o18 (- o17 1)))
