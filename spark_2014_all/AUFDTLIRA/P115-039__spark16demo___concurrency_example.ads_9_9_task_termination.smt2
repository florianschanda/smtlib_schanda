...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1764 us_void_param) 1)) 97) (= (to_rep (select (temp___String_Literal_1764 us_void_param) 2)) 108)) (= (to_rep (select (temp___String_Literal_1764 us_void_param) 3)) 108)) (= (to_rep (select (temp___String_Literal_1764 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_1764 us_void_param) 5)) 122)) (= (to_rep (select (temp___String_Literal_1764 us_void_param) 6)) 101)) (= (to_rep (select (temp___String_Literal_1764 us_void_param) 7)) 114)) (= (to_rep (select (temp___String_Literal_1764 us_void_param) 8)) 111)) (= (to_rep (select (temp___String_Literal_1764 us_void_param) 9)) 101)) (= (to_rep (select (temp___String_Literal_1764 us_void_param) 10)) 115)) :pattern ((temp___String_Literal_1764 us_void_param)))))
(declare-fun temp___String_Literal_1765 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1765 us_void_param) 1)) 97) (= (to_rep (select (temp___String_Literal_1765 us_void_param) 2)) 108)) (= (to_rep (select (temp___String_Literal_1765 us_void_param) 3)) 108)) (= (to_rep (select (temp___String_Literal_1765 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_1765 us_void_param) 5)) 111)) (= (to_rep (select (temp___String_Literal_1765 us_void_param) 6)) 110)) (= (to_rep (select (temp___String_Literal_1765 us_void_param) 7)) 101)) (= (to_rep (select (temp___String_Literal_1765 us_void_param) 8)) 115)) :pattern ((temp___String_Literal_1765 us_void_param)))))
(declare-fun temp___String_Literal_1766 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1766 us_void_param) 1)) 100) (= (to_rep (select (temp___String_Literal_1766 us_void_param) 2)) 97)) (= (to_rep (select (temp___String_Literal_1766 us_void_param) 3)) 116)) (= (to_rep (select (temp___String_Literal_1766 us_void_param) 4)) 97)) (= (to_rep (select (temp___String_Literal_1766 us_void_param) 5)) 32)) (= (to_rep (select (temp___String_Literal_1766 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_1766 us_void_param) 7)) 97)) (= (to_rep (select (temp___String_Literal_1766 us_void_param) 8)) 99)) (= (to_rep (select (temp___String_Literal_1766 us_void_param) 9)) 101)) (= (to_rep (select (temp___String_Literal_1766 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_1766 us_void_param) 11)) 100)) (= (to_rep (select (temp___String_Literal_1766 us_void_param) 12)) 101)) (= (to_rep (select (temp___String_Literal_1766 us_void_param) 13)) 116)) (= (to_rep (select (temp___String_Literal_1766 us_void_param) 14)) 101)) (= (to_rep (select (temp___String_Literal_1766 us_void_param) 15)) 99)) (= (to_rep (select (temp___String_Literal_1766 us_void_param) 16)) 116)) (= (to_rep (select (temp___String_Literal_1766 us_void_param) 17)) 101)) (= (to_rep (select (temp___String_Literal_1766 us_void_param) 18)) 100)) :pattern ((temp___String_Literal_1766 us_void_param)))))
