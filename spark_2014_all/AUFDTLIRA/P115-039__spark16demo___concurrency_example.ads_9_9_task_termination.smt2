...
(declare-fun temp___String_Literal_1972 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1972 us_void_param) 1)) 97) (= (to_rep (select (temp___String_Literal_1972 us_void_param) 2)) 108)) (= (to_rep (select (temp___String_Literal_1972 us_void_param) 3)) 108)) (= (to_rep (select (temp___String_Literal_1972 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_1972 us_void_param) 5)) 122)) (= (to_rep (select (temp___String_Literal_1972 us_void_param) 6)) 101)) (= (to_rep (select (temp___String_Literal_1972 us_void_param) 7)) 114)) (= (to_rep (select (temp___String_Literal_1972 us_void_param) 8)) 111)) (= (to_rep (select (temp___String_Literal_1972 us_void_param) 9)) 101)) (= (to_rep (select (temp___String_Literal_1972 us_void_param) 10)) 115)) :pattern ((temp___String_Literal_1972 us_void_param)))))
(declare-fun temp___String_Literal_1973 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1973 us_void_param) 1)) 97) (= (to_rep (select (temp___String_Literal_1973 us_void_param) 2)) 108)) (= (to_rep (select (temp___String_Literal_1973 us_void_param) 3)) 108)) (= (to_rep (select (temp___String_Literal_1973 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_1973 us_void_param) 5)) 111)) (= (to_rep (select (temp___String_Literal_1973 us_void_param) 6)) 110)) (= (to_rep (select (temp___String_Literal_1973 us_void_param) 7)) 101)) (= (to_rep (select (temp___String_Literal_1973 us_void_param) 8)) 115)) :pattern ((temp___String_Literal_1973 us_void_param)))))
(declare-fun temp___String_Literal_1974 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1974 us_void_param) 1)) 100) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 2)) 97)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 3)) 116)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 4)) 97)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 5)) 32)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 7)) 97)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 8)) 99)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 9)) 101)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 11)) 100)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 12)) 101)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 13)) 116)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 14)) 101)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 15)) 99)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 16)) 116)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 17)) 101)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 18)) 100)) :pattern ((temp___String_Literal_1974 us_void_param)))))
...
(assert (forall ((temp___222 Int)) (=> (dynamic_invariant temp___222 true true true true) (forall ((temp___223 Int)) (= (to_rep1 (select (concurrency_example__all_zeroes__aggregate_def temp___222) temp___223)) temp___222)))))
(assert (= all_ones (concurrency_example__all_ones__aggregate_def (- 2147483648))))
(assert (forall ((temp___225 Int)) (=> (dynamic_invariant temp___225 true true true true) (forall ((temp___226 Int)) (= (to_rep1 (select (concurrency_example__all_ones__aggregate_def temp___225) temp___226)) temp___225)))))
(assert (not true))
(check-sat)
(exit)
