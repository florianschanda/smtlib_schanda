...
(define-fun bool_eq1 ((a us_rep) (b us_rep)) Bool (ite (and (= (bool_eq (rec__stack_external_prover__stack_type__s (us_split_fields1 a)) 1 100 (rec__stack_external_prover__stack_type__s (us_split_fields1 b)) 1 100) true) (= (to_rep (rec__stack_external_prover__stack_type__pointer (us_split_fields1 a))) (to_rep (rec__stack_external_prover__stack_type__pointer (us_split_fields1 b))))) true false))
...
(define-fun dynamic_invariant1 ((temp___expr_154 Int) (temp___is_init_151 Bool) (temp___skip_constant_152 Bool) (temp___do_toplevel_153 Bool)) Bool (=> (or (= temp___is_init_151 true) (<= 0 100)) (in_range temp___expr_154)))
...
(declare-const stack_external_prover__initial_stack__assume (Array Int integer))
(declare-const stack_external_prover__initial_stack__assume1 pointer_range)
...
(assert (= (mk___rep (mk___split_fields stack_external_prover__initial_stack__assume stack_external_prover__initial_stack__assume1)) initial_stack))
...
(assert (= result2 (is_empty (mk___split_fields my_stack__split_fields2 my_stack__split_fields3))))
