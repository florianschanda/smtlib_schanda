...
(define-fun f__split_fields7 () us_split_fields__ref2 (mk___split_fields__ref2 (mk___split_fields2 f__split_fields f__split_fields1)))
...
(assert (= v1 o))
(assert (=> (not (= v1 0)) (=> (= d 0) (= result2 f__split_fields7))))
...
(assert (=> (not (= v1 0)) (=> (not (= d 0)) (= result3 f__split_fields7))))
...
(assert (<= 1 i1))
(assert (<= i1 100))
(assert (not (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields6) i1)))) 0)))
(assert (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields6) i1)))) 1))
(assert (not (<= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields6) i1)))) 100)))
(check-sat)
(exit)
