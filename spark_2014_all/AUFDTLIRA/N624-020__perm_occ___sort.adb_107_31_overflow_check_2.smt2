...
(assert (=> (not (= smallest1 current1)) (and (and (and (= (is_perm (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last))) (mk___t o9 (mk (to_rep1 values__first) (to_rep1 values__last)))) true) (= (to_rep (select o9 o8)) (to_rep (select values smallest1)))) (= (to_rep (select o9 smallest1)) (to_rep (select values o8)))) (forall ((z Int)) (=> (and (<= (to_rep1 values__first) z) (<= z (to_rep1 values__last))) (=> (and (not (= z o8)) (not (= z smallest1))) (= (to_rep (select o9 z)) (to_rep (select values z)))))))))
...
(assert (forall ((i1 Int)) (=> (and (<= (to_rep1 values__first) i1) (<= i1 current2)) (forall ((j Int)) (=> (and (<= (+ i1 1) j) (<= j (to_rep1 values__last))) (<= (to_rep (select values2 i1)) (to_rep (select values2 j))))))))
