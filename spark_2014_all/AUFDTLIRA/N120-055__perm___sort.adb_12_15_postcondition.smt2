...
(assert (not (= (is_perm__logic (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last))) (mk___t values3 (mk (to_rep1 values__first) (to_rep1 values__last)))) true)))
(check-sat)
(exit)
