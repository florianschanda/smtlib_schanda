...
(assert (= i2 r18b))
(assert (=> (and (<= r18b i2) (<= i2 r19b)) (= temp___1600 newdomainname1)))
(assert (=> (and (<= r18b i2) (<= i2 r19b)) (= temp___1602 endidx8)))
(assert (=> (and (<= r18b i2) (<= i2 r19b)) (= temp___1599 i2)))
(assert (=> (and (<= r18b i2) (<= i2 r19b)) (and (and (<= 1 begidx11) (<= (+ (- endidx8 begidx11) 1) 128)) (= endidx8 temp___1602))))
...
(assert (=> (and (<= r18b i2) (<= i2 r19b)) (and (= temp___1598 o4) (in_range1 o4))))
(assert (=> (and (<= r18b i2) (<= i2 r19b)) (and (<= 1 temp___1598) (<= temp___1598 128))))
(assert (=> (and (<= r18b i2) (<= i2 r19b)) (= o6 temp___1598)))
...
(assert (<= i8 128))
(assert (<= 1 endidx8))
(assert (and (and (=> (<= r21b 128) (dynamic_property1 r21b 128 i9)) (forall ((temp___1607 Int)) (=> (and (<= 1 temp___1607) (<= temp___1607 128)) (=> (<= i9 temp___1607) (= (select newdomainname8 temp___1607) (select (map__content newdomainname6) temp___1607)))))) (and (<= r21b i9) (<= i9 128))))
(assert (= (to_rep o8) 32))
