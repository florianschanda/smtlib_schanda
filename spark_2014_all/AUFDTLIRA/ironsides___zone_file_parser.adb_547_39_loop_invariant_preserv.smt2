...
(assert (= i2 r18b))
(assert (=> (and (<= r18b i2) (<= i2 r19b)) (and (and (= temp___1541 newdomainname1) (and (= temp___1543 endidx10) (and (= temp___1540 i2) (and (and (and (<= 1 begidx13) (<= (+ (- endidx10 begidx13) 1) 128)) (= endidx10 temp___1543)) (and (and (=> (<= r18b r19b) (dynamic_property r18b r19b i3)) (and (<= r18b i3) (<= i3 r19b))) (and (and (and (= (to_rep o5) (to_rep (select zonefileline i3))) (and (and (and (and (and (= o3 (+ i3 1)) (in_range1 (+ i3 1))) (= o4 (- o3 begidx13))) (and (= temp___1539 o4) (in_range1 o4))) (and (and (<= 1 temp___1539) (<= temp___1539 128)) (= o6 temp___1539))) (= o7 (store newdomainname2 o6 o5)))) (and (= result6 (mk_map__ref newdomainname2)) (= newdomainname3 o7))) (= i3 r19b))))))) (and (and (= i9 (mk_int__ref i3)) (= newdomainname8 (mk_map__ref newdomainname3))) (and (= i10 i3) (= newdomainname9 newdomainname3))))))
(assert (=> (and (<= r18b i2) (<= i2 r19b)) (= i11 i9)))
(assert (=> (and (<= r18b i2) (<= i2 r19b)) (= newdomainname10 newdomainname8)))
(assert (=> (and (<= r18b i2) (<= i2 r19b)) (= i12 i10)))
(assert (=> (and (<= r18b i2) (<= i2 r19b)) (= newdomainname11 newdomainname9)))
(assert (=> (not (and (<= r18b i2) (<= i2 r19b))) (= i11 (mk_int__ref i2))))
(assert (=> (not (and (<= r18b i2) (<= i2 r19b))) (= newdomainname10 (mk_map__ref newdomainname1))))
(assert (=> (not (and (<= r18b i2) (<= i2 r19b))) (= i12 i2)))
(assert (=> (not (and (<= r18b i2) (<= i2 r19b))) (= newdomainname11 newdomainname1)))
(assert (= (+ endidx10 1) r21b))
...
(assert (<= i13 128))
(assert (<= 1 endidx10))
(assert (and (and (=> (<= r21b 128) (dynamic_property1 r21b 128 i14)) (forall ((temp___1548 Int)) (=> (and (<= 1 temp___1548) (<= temp___1548 128)) (=> (<= i14 temp___1548) (= (select newdomainname12 temp___1548) (select (map__content newdomainname10) temp___1548)))))) (and (<= r21b i14) (<= i14 128))))
(assert (= (to_rep o8) 32))
(assert (= o9 (store newdomainname12 i14 o8)))
(assert (= result9 (mk_map__ref newdomainname12)))
(assert (= newdomainname13 o9))
(assert (not (= i14 128)))
(assert (= result10 (mk_int__ref i14)))
(assert (= i15 (+ i14 1)))
(assert (= i16 (mk_int__ref i15)))
(assert (= newdomainname14 (mk_map__ref newdomainname13)))
(assert (= i17 i15))
(assert (= newdomainname15 newdomainname13))
(assert (not (<= 1 endidx10)))
(check-sat)
(exit)
