...
(assert (= i2 r18b))
(assert (=> (and (<= r18b i2) (<= i2 r19b)) (= temp___1602 newdomainname1)))
(assert (=> (and (<= r18b i2) (<= i2 r19b)) (= temp___1604 endidx8)))
(assert (=> (and (<= r18b i2) (<= i2 r19b)) (= temp___1601 i2)))
(assert (=> (and (<= r18b i2) (<= i2 r19b)) (and (and (<= 1 begidx11) (<= (+ (- endidx8 begidx11) 1) 128)) (= endidx8 temp___1604))))
(assert (=> (and (<= r18b i2) (<= i2 r19b)) (and (=> (<= r18b r19b) (dynamic_property r18b r19b i3)) (and (<= r18b i3) (<= i3 r19b)))))
(assert (=> (and (<= r18b i2) (<= i2 r19b)) (= (to_rep o5) (to_rep (select zonefileline i3)))))
(assert (=> (and (<= r18b i2) (<= i2 r19b)) (and (= o3 (+ i3 1)) (in_range1 (+ i3 1)))))
(assert (=> (and (<= r18b i2) (<= i2 r19b)) (= o4 (- o3 begidx11))))
(assert (=> (and (<= r18b i2) (<= i2 r19b)) (and (= temp___1600 o4) (in_range1 o4))))
(assert (=> (and (<= r18b i2) (<= i2 r19b)) (and (<= 1 temp___1600) (<= temp___1600 128))))
(assert (=> (and (<= r18b i2) (<= i2 r19b)) (= o6 temp___1600)))
(assert (=> (and (<= r18b i2) (<= i2 r19b)) (= o7 (store newdomainname2 o6 o5))))
(assert (=> (and (<= r18b i2) (<= i2 r19b)) (= result6 (mk_map__ref newdomainname2))))
(assert (=> (and (<= r18b i2) (<= i2 r19b)) (= newdomainname3 o7)))
(assert (=> (and (<= r18b i2) (<= i2 r19b)) (= i3 r19b)))
(assert (=> (and (<= r18b i2) (<= i2 r19b)) (= i4 (mk_int__ref i3))))
(assert (=> (and (<= r18b i2) (<= i2 r19b)) (= newdomainname4 (mk_map__ref newdomainname3))))
(assert (=> (and (<= r18b i2) (<= i2 r19b)) (= i5 i3)))
(assert (=> (and (<= r18b i2) (<= i2 r19b)) (= newdomainname5 newdomainname3)))
(assert (=> (and (<= r18b i2) (<= i2 r19b)) (= i6 i4)))
(assert (=> (and (<= r18b i2) (<= i2 r19b)) (= newdomainname6 newdomainname4)))
(assert (=> (and (<= r18b i2) (<= i2 r19b)) (= i7 i5)))
(assert (=> (and (<= r18b i2) (<= i2 r19b)) (= newdomainname7 newdomainname5)))
(assert (=> (not (and (<= r18b i2) (<= i2 r19b))) (= i6 (mk_int__ref i2))))
(assert (=> (not (and (<= r18b i2) (<= i2 r19b))) (= newdomainname6 (mk_map__ref newdomainname1))))
(assert (=> (not (and (<= r18b i2) (<= i2 r19b))) (= i7 i2)))
(assert (=> (not (and (<= r18b i2) (<= i2 r19b))) (= newdomainname7 newdomainname1)))
(assert (= (+ endidx8 1) r21b))
...
(assert (<= i8 128))
(assert (<= 1 endidx8))
(assert (and (and (=> (<= r21b 128) (dynamic_property1 r21b 128 i9)) (forall ((temp___1609 Int)) (=> (and (<= 1 temp___1609) (<= temp___1609 128)) (=> (or (< 128 temp___1609) (or (< temp___1609 r21b) (<= i9 temp___1609))) (= (select newdomainname8 temp___1609) (select (map__content newdomainname6) temp___1609)))))) (and (<= r21b i9) (<= i9 128))))
(assert (= (to_rep o8) 32))
(assert (= o9 (store newdomainname8 i9 o8)))
(assert (= result8 (mk_map__ref newdomainname8)))
(assert (= newdomainname9 o9))
(assert (not (= i9 128)))
(assert (= result9 (mk_int__ref i9)))
(assert (= i10 (+ i9 1)))
(assert (= i11 (mk_int__ref i10)))
(assert (= newdomainname10 (mk_map__ref newdomainname9)))
(assert (= i12 i10))
(assert (= newdomainname11 newdomainname9))
(assert (not (<= 1 endidx8)))
(check-sat)
(exit)
