...
(assert (and (and (forall ((temp___2201 Int)) (=> (and (<= (to_rep1 n__first) temp___2201) (<= temp___2201 (to_rep1 n__last))) (=> (< index2 temp___2201) (= (select n3 temp___2201) (select n1 temp___2201))))) (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 9)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 9) index2))) (and (<= (+ (to_rep1 (first (rt source))) 1) index2) (<= index2 (+ (to_rep1 (first (rt source))) 9)))))
(assert (not (= index2 temp___2204)))
