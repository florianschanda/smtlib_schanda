...
(assert (<= temp___2301 index1))
(assert (<= index1 temp___2302))
...
(assert (and (and (forall ((temp___2305 Int)) (=> (and (<= (to_rep1 n__first) temp___2305) (<= temp___2305 (to_rep1 n__last))) (=> (or (< temp___2302 temp___2305) (or (< temp___2305 temp___2301) (< index2 temp___2305))) (= (select n3 temp___2305) (select n1 temp___2305))))) (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 9)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 9) index2))) (and (<= (+ (to_rep1 (first (rt source))) 1) index2) (<= index2 (+ (to_rep1 (first (rt source))) 9)))))
(assert (not (= index2 temp___2302)))
