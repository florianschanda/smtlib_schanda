...
(assert (and (= (length source) 10) (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (forall ((index4 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) index4) (<= index4 (+ (to_rep1 (first (rt source))) 9))) (= (is_digit (to_rep (select (elts source) index4))) true))))))
...
(assert (<= temp___2305 index1))
(assert (<= index1 temp___2306))
...
(assert (and (and (forall ((temp___2303 Int)) (=> (and (<= (to_rep1 n__first) temp___2303) (<= temp___2303 (to_rep1 n__last))) (=> (< index2 temp___2303) (= (select n3 temp___2303) (select n1 temp___2303))))) (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 9)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 9) index2))) (and (<= (+ (to_rep1 (first (rt source))) 1) index2) (<= index2 (+ (to_rep1 (first (rt source))) 9)))))
(assert (not (= index2 temp___2306)))
