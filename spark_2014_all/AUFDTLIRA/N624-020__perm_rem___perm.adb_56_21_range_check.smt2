...
(assert (= ia3 (+ ia2 1)))
(assert (= (= result3 true) (exists ((ib Int)) (and (and (<= (to_rep1 (first (rt b))) ib) (<= ib (to_rep1 (last (rt b))))) (and (= (to_rep (select (elts a) ia3)) (to_rep (select (elts b) ib))) (= (is_perm (remove a ia3) (remove b ib)) true))))))
(assert (= result3 true))
(assert (and (= o ia3) (in_range3 ia3)))
(assert (and (= o1 (get_witness a b o)) (and (in_range3 o1) (and (and (<= (to_rep1 (first (rt b))) o1) (<= o1 (to_rep1 (last (rt b))))) (and (= (to_rep (select (elts a) o)) (to_rep (select (elts b) o1))) (= (is_perm (remove a o) (remove b o1)) true))))))
