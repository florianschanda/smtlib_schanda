...
(assert (and (= o14 (get_witness a b o13)) (and (in_range2 o14) (and (and (<= (to_rep2 (first (rt b))) o14) (<= o14 (to_rep2 (last (rt b))))) (and (= (to_rep (select (elts a) o13)) (to_rep (select (elts b) o14))) (= (is_perm (remove a o13) (remove b o14)) true))))))
