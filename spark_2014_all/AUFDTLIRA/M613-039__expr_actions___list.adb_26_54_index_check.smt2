...
(declare-const j Int)
(declare-const temp___506 (Array Int integer))
(declare-const temp___5061 t)
...
(define-fun temp___5062 () us_t (mk___t temp___506 temp___5061))
...
(assert (<= first2 j))
(assert (<= j i2))
(assert (and (= o2 j) (in_range4 j)))
(assert (and (= o3 (get (model__ l) o2)) (and (in_range7 o3) (= o3 (get (model__ l) o2)))))
(assert (and (= temp___5062 (to__ (mk___rep s__split_fields3))) (dynamic_invariant1 temp___5062 true false true true)))
(assert (not (<= (to_rep (first temp___5061)) j)))
(check-sat)
(exit)
