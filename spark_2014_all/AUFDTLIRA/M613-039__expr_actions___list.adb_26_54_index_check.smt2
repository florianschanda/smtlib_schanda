...
(assert (and (= o6 (- i4 first2)) (in_range1 (- i4 first2))))
(assert (= o7 (+ o6 1)))
(assert (and (= o8 o7) (in_range1 o7)))
(assert (and (= (mk___t o4 o5) (to__ (mk___rep s__split_fields4))) (dynamic_invariant1 (mk___t o4 o5) true false true)))
...
(assert (and (= (mk___t temp___460 temp___4601) (to__ (mk___rep s__split_fields4))) (dynamic_invariant1 (mk___t temp___460 temp___4601) true false true)))
