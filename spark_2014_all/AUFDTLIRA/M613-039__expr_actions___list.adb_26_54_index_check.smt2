...
(define-fun temp___4602 () us_t (mk___t temp___460 temp___4601))
...
(assert (and (= o10 (to__ (mk___rep s__split_fields3))) (dynamic_invariant1 o10 true false true)))
...
(assert (and (= temp___4602 (to__ (mk___rep s__split_fields3))) (dynamic_invariant1 temp___4602 true false true)))
(assert (not (<= (to_rep (first temp___4601)) j)))
(check-sat)
(exit)
