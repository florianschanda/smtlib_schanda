...
(declare-const temp___285 index)
(declare-const temp___2851 (Array Int value))
(declare-const temp___2852 (Array Int value))
...
(declare-const temp___288 index)
(declare-const temp___2881 (Array Int value))
(declare-const temp___2882 (Array Int value))
...
(declare-const temp___291 index)
(declare-const temp___2911 (Array Int value))
(declare-const temp___2912 (Array Int value))
(declare-const o15 index)
(declare-const o16 index)
(declare-const o17 (Array Int value))
(declare-const o18 (Array Int value))
(declare-const temp___293 index)
(declare-const temp___2931 (Array Int value))
(declare-const temp___2932 (Array Int value))
...
(assert (in_range i))
(assert (= (to_rep1 o) 69))
(assert (= o1 (store a__split_fields2 i o)))
(assert (= a__split_fields o2))
(assert (= a__split_fields1 o3))
(assert (= o1 o4))
(assert (= temp___285 o2))
(assert (= temp___2851 o3))
(assert (= temp___2852 o4))
...
(assert (= temp___285 a__split_fields3))
(assert (= temp___2851 a__split_fields4))
(assert (= temp___2852 a__split_fields5))
(assert (= (to_rep1 o5) 42))
(assert (= o6 (store a__split_fields4 i o5)))
(assert (= a__split_fields3 o7))
(assert (= o6 o8))
(assert (= a__split_fields5 o9))
(assert (= temp___288 o7))
(assert (= temp___2881 o8))
(assert (= temp___2882 o9))
(assert (= result3 a__split_fields3))
(assert (= result4 a__split_fields4))
(assert (= result5 a__split_fields5))
(assert (= temp___288 a__split_fields6))
(assert (= temp___2881 a__split_fields7))
(assert (= temp___2882 a__split_fields8))
(assert (= (to_rep1 o10) 23))
(assert (= o11 (store a__split_fields7 i o10)))
(assert (= a__split_fields6 o12))
(assert (= o11 o13))
(assert (= a__split_fields8 o14))
(assert (= temp___291 o12))
(assert (= temp___2911 o13))
(assert (= temp___2912 o14))
(assert (= result6 a__split_fields6))
(assert (= result7 a__split_fields7))
(assert (= result8 a__split_fields8))
(assert (= a__split_fields9 (mk___split_fields temp___291 temp___2911 temp___2912)))
...
(assert (= temp___293 o16))
(assert (= temp___2931 o17))
(assert (= temp___2932 o18))
(assert (= result9 (mk___split_fields__ref a__split_fields9)))
(assert (= a__split_fields10 (mk___split_fields temp___293 temp___2931 temp___2932)))
(assert (not (= (to_rep1 (select (rec__arrays_in_records__record_with_arrays__second_array a__split_fields10) i)) 69)))
(check-sat)
(exit)
