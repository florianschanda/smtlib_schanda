...
(assert (= (store a__split_fields2 i rliteral) a__split_fields5))
...
(assert (= (store a__split_fields4 i rliteral1) a__split_fields7))
...
(assert (= (store a__split_fields7 i rliteral2) a__split_fields10))
...
(assert (not (= (to_rep (select a__split_fields14 i)) 69)))
(check-sat)
(exit)
