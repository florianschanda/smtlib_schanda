...
(assert (in_range1 id))
(assert (and (and (and (= (to_rep (select map1 0)) 1) (= (to_rep (select map1 1)) 0)) (and (forall ((id1 Int)) (=> (and (<= 0 id1) (<= id1 1)) (not (= (to_rep (select map1 id1)) id1)))) (and (and (= main__with_spoon_feeding__result1 main__with_spoon_feeding__result2) (= main__with_spoon_feeding__result3 main__with_spoon_feeding__result1)) (and (= result main__with_spoon_feeding__result) (= main__with_spoon_feeding__result1 (to_rep (select map1 id))))))) (and (= (mk_int__ref main__with_spoon_feeding__result4) (mk_int__ref main__with_spoon_feeding__result2)) (= main__with_spoon_feeding__result5 main__with_spoon_feeding__result3))))
