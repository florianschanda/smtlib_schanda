...
(assert (=> (not (= smallest1 current1)) (and (and (and (= (is_perm (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last))) (mk___t o14 (mk (to_rep1 values__first) (to_rep1 values__last)))) true) (= (to_rep (select o14 o8)) (to_rep (select values smallest1)))) (= (to_rep (select o14 smallest1)) (to_rep (select values o8)))) (forall ((z Int)) (=> (and (<= (to_rep1 values__first) z) (<= z (to_rep1 values__last))) (=> (and (not (= z o8)) (not (= z smallest1))) (= (to_rep (select o14 z)) (to_rep (select values z)))))))))
...
(assert (= result4 true))
(assert (and (<= (to_rep1 values__first) j) (<= j (to_rep1 values__last))))
(assert (= o11 j))
(assert (= o12 (select values2 o11)))
(assert (= o13 (to_rep o12)))
(assert (not (<= (to_rep1 values__first) i)))
(check-sat)
(exit)
