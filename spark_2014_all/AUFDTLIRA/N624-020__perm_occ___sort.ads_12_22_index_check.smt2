...
(assert (or (and (and (and (= current9 (mk_int__ref current)) (and (= previous9 (mk_map__ref previous)) (and (= smallest9 (mk_int__ref smallest)) (= values9 (mk_map__ref values))))) (and (= current10 current1) (and (= previous10 previous1) (and (= smallest10 smallest1) (= values10 values1))))) (and (and (ite (<= (to_rep1 values__first) (to_rep1 values__last)) (= o (+ (- (to_rep1 values__last) (to_rep1 values__first)) 1)) (= o 0)) (= result (ite (= o 0) true false))) (= result true))) (and (and (and (ite (<= (to_rep1 values__first) (to_rep1 values__last)) (= o (+ (- (to_rep1 values__last) (to_rep1 values__first)) 1)) (= o 0)) (= result (ite (= o 0) true false))) (not (= result true))) (and (and (and (= current9 current7) (and (= previous9 previous7) (and (= smallest9 smallest7) (= values9 values7)))) (and (= current10 current8) (and (= previous10 previous8) (and (= smallest10 smallest8) (= values10 values8))))) (and (and (= temp___249 (- (to_rep1 values__last) 1)) (in_range1 (- (to_rep1 values__last) 1))) (and (and (= (mk_int__ref result1) (mk_int__ref current)) (= current2 (to_rep1 values__first))) (ite (and (<= (to_rep1 values__first) current2) (<= current2 temp___249)) (and (and (and (= temp___246 previous) (and (= temp___244 smallest) (and (= temp___242 values) (and (= temp___243 current2) (and (= temp___247 values) (and (and (and (and (and (and (=> (<= current2 (to_rep1 values__last)) (and (and (<= (to_rep1 values__first) current2) (<= current2 (to_rep1 values__last))) (and (<= (to_rep1 values__first) (to_rep1 values__last)) (<= (to_rep1 values__last) (to_rep1 values__last))))) (= o1 values)) (and (= o1 temp___239) (= (mk2 current2 (to_rep1 values__last)) temp___2391))) (and (= temp___239 o2) (= (mk (to_rep1 (first4 temp___2391)) (to_rep1 (last4 temp___2391))) o3))) (and (= o4 (index_of_minimum (mk___t o2 o3))) (and (in_range3 o4) (and (and (<= (to_rep1 (first o3)) o4) (<= o4 (to_rep1 (last o3)))) (forall ((i2 Int)) (=> (and (<= (to_rep1 (first o3)) i2) (<= i2 (to_rep1 (last o3)))) (<= (to_rep (select o2 o4)) (to_rep (select o2 i2))))))))) (and (= (mk_int__ref result2) (mk_int__ref smallest)) (= smallest2 o4))) (and (ite (not (= smallest2 current2)) (and (and (and (and (and (= (slide values (to_rep1 values__first) (to_rep1 values__first)) temp___240) (= (mk1 (to_rep1 values__first) (to_rep1 values__last)) temp___2401)) (and (= (ite (<= (to_rep1 (first2 temp___2401)) (to_rep1 (last2 temp___2401))) (+ (- (to_rep1 (last2 temp___2401)) (to_rep1 (first2 temp___2401))) 1) 0) (ite (<= (to_rep1 previous__first) (to_rep1 previous__last)) (+ (- (to_rep1 previous__last) (to_rep1 previous__first)) 1) 0)) (= (mk___t1 o5 o6) (mk___t1 temp___240 temp___2401)))) (= o7 o5)) (and (= (mk_map__ref result3) (mk_map__ref previous)) (= previous2 o7))) (and (and (= o8 current2) (in_range3 current2)) (and (and (and (= (is_perm (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last))) (mk___t values2 (mk (to_rep1 values__first) (to_rep1 values__last)))) true) (= (to_rep (select values2 o8)) (to_rep (select values smallest2)))) (= (to_rep (select values2 smallest2)) (to_rep (select values o8)))) (forall ((z Int)) (=> (and (<= (to_rep1 values__first) z) (<= z (to_rep1 values__last))) (=> (and (not (= z o8)) (not (= z smallest2))) (= (to_rep (select values2 z)) (to_rep (select values z))))))))) (and (and (= previous2 previous) (= values2 values)) (and (= previous2 previous1) (= values2 values1)))) (and (and (forall ((i2 Int)) (=> (and (<= (to_rep1 values__first) i2) (<= i2 current3)) (forall ((j1 Int)) (=> (and (<= (+ i2 1) j1) (<= j1 (to_rep1 values__last))) (<= (to_rep (select values3 i2)) (to_rep (select values3 j1))))))) (= (is_perm (mk___t temp___247 (mk (to_rep1 values__first) (to_rep1 values__last))) (mk___t values3 (mk (to_rep1 values__first) (to_rep1 values__last)))) true)) (and (and (and (=> (<= (to_rep1 values__first) (- (to_rep1 values__last) 1)) (dynamic_property3 (to_rep1 values__first) (- (to_rep1 values__last) 1) current3)) (=> (<= 1 2147483647) (in_range3 smallest3))) (and (<= (to_rep1 values__first) current3) (<= current3 (- (to_rep1 values__last) 1)))) (= current3 temp___249)))))))))) (and (and (= current5 (mk_int__ref current3)) (and (= previous5 (mk_map__ref previous3)) (and (= smallest5 (mk_int__ref smallest3)) (= values5 (mk_map__ref values3))))) (and (= current6 current3) (and (= previous6 previous3) (and (= smallest6 smallest3) (= values6 values3)))))) (and (and (= current7 current5) (and (= previous7 previous5) (and (= smallest7 smallest5) (= values7 values5)))) (and (= current8 current6) (and (= previous8 previous6) (and (= smallest8 smallest6) (= values8 values6)))))) (and (and (= current7 (mk_int__ref current2)) (and (= previous7 (mk_map__ref previous)) (and (= smallest7 (mk_int__ref smallest)) (= values7 (mk_map__ref values))))) (and (= current8 current2) (and (= previous8 previous1) (and (= smallest8 smallest1) (= values8 values1))))))))))))
...
(assert (= previous12 previous10))
(assert (= smallest12 smallest10))
(assert (= values12 values10))
(assert (and (= result8 (is_perm (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last))) (mk___t (map__content values11) (mk (to_rep1 values__first) (to_rep1 values__last))))) (= (= result8 true) (forall ((e Int)) (=> (and (<= 0 e) (<= e 2147483647)) (= (occ (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last))) e) (occ (mk___t (map__content values11) (mk (to_rep1 values__first) (to_rep1 values__last))) e)))))))
(assert (= result8 true))
(assert (=> (<= (to_rep1 values__first) (to_rep1 values__last)) (= o22 (+ (- (to_rep1 values__last) (to_rep1 values__first)) 1))))
(assert (=> (not (<= (to_rep1 values__first) (to_rep1 values__last))) (= o22 0)))
(assert (= result9 (ite (< 0 o22) true false)))
(assert (= result9 true))
(assert (and (= o23 (- (to_rep1 values__last) 1)) (in_range1 (- (to_rep1 values__last) 1))))
(assert (= o24 (ite (<= i1 o23) true false)))
(assert (= result10 (ite (<= (to_rep1 values__first) i1) o24 false)))
(assert (= result10 true))
(assert (and (= temp___251 (+ i1 1)) (in_range1 (+ i1 1))))
(assert (and (<= (to_rep1 values__first) temp___251) (<= temp___251 (to_rep1 values__last))))
(assert (= o25 temp___251))
(assert (= o26 (select (map__content values11) o25)))
(assert (= o27 (to_rep o26)))
(assert (not (<= (to_rep1 values__first) i1)))
(check-sat)
(exit)
