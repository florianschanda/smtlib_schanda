...
(assert true)
(assert (forall ((b (Array Int (Array Int cell)))) (forall ((y Int) (x Int)) (! (= (= (is_empty b y x) true) (and (and (in_range8 x) (in_range9 y)) (= (to_rep1 (let ((temp___673 (select b y))) (select temp___673 x))) 0))) :pattern ((is_empty b y x))))))
