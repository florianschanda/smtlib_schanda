...
(define-fun dynamic_invariant ((temp___expr_159 Int) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool) (temp___do_typ_inv_158 Bool)) Bool (=> (or (= temp___is_init_155 true) (<= 0 2)) (in_range1 temp___expr_159)))
...
(define-fun dynamic_invariant1 ((temp___expr_166 Int) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool (=> (or (= temp___is_init_162 true) (<= 1 2)) (in_range2 temp___expr_166)))
...
(assert (forall ((side Int)) (forall ((request (Array Int Bool)) (du_available (Array Int Bool))) (! (=> (dynamic_invariant1 side true true true true) (and (= (select du_available side) true) (or (= (select request side) true) (not (= (select du_available (change_side side)) true))))) :pattern ((fulfill_condition side request du_available))))))
...
(assert (forall ((du_available1 (Array Int Bool))) (! (and (not (= (select du_available1 1) true)) (not (= (select du_available1 2) true))) :pattern ((none_available du_available1)))))
(assert (forall ((side Int)) (! (=> (dynamic_invariant1 side true true true true) (dynamic_invariant1 (change_side side) true false true true)) :pattern ((change_side side)))))
(assert (forall ((side Int)) (! (=> (dynamic_invariant1 side true true true true) (= (change_side side) (ite (= side 1) 2 1))) :pattern ((change_side side)))))
