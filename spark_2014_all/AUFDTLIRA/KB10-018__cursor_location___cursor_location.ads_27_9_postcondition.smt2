...
(define-fun dynamic_invariant ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= 0 2)) (in_range1 temp___expr_136)))
...
(define-fun dynamic_invariant1 ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= 1 2)) (in_range2 temp___expr_142)))
...
(assert (forall ((side Int)) (forall ((request (Array Int Bool)) (du_available (Array Int Bool))) (! (=> (dynamic_invariant1 side true true true) (and (= (select du_available side) true) (or (= (select request side) true) (not (= (select du_available (change_side side)) true))))) :pattern ((fulfill_condition side request du_available))))))
...
(assert (forall ((side Int)) (! (=> (dynamic_invariant1 side true true true) (dynamic_invariant1 (change_side side) true false true)) :pattern ((change_side side)))))
(assert (forall ((side Int)) (! (=> (dynamic_invariant1 side true true true) (= (change_side side) (ite (= side 1) 2 1))) :pattern ((change_side side)))))
