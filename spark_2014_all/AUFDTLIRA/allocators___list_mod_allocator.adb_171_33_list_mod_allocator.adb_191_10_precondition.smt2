...
(assert (forall ((r Int)) (=> (and (<= 1 r) (<= r 10000)) (=> (and (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data1 r)))) 0) (not (= (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select data1 r)))) 0))) (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data1 (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select data1 r)))))))) 0)))))
(assert (and (= o19 (model__ data1 first_available1)) (= (model_is_well_formed o19 data1 first_available1) true)))
(assert (= o20 (us_split_fields3 o19)))
(assert (= list_mod_allocator__alloc__C96b__assume (rec__list_mod_allocator__m__t__available o20)))
...
(assert (= result5 (ite (<= 2 j) o22 false)))
(assert (= result5 true))
(assert (not (<= 1 j)))
(check-sat)
(exit)
