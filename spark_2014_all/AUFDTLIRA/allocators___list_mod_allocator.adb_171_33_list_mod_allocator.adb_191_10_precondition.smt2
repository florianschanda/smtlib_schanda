...
(assert (forall ((r1 Int)) (=> (and (<= 1 r1) (<= r1 10000)) (=> (and (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data2 r1)))) 0) (not (= (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select data2 r1)))) 0))) (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data2 (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select data2 r1)))))))) 0)))))
(assert (and (= o25 (model__ data2 first_available2)) (= (model_is_well_formed o25 data2 first_available2) true)))
(assert (= o26 (us_split_fields3 o25)))
(assert (= list_mod_allocator__alloc__C96b__assume (rec__list_mod_allocator__m__t__available o26)))
(assert (= list_mod_allocator__alloc__C96b__assume c96b))
(assert (= ma c97b))
(assert (and (= list_mod_allocator__alloc__B98b__L_4__R99b__assume (length c96b)) (and (in_range5 list_mod_allocator__alloc__B98b__L_4__R99b__assume) (<= (+ 0 list_mod_allocator__alloc__B98b__L_4__R99b__assume) 2147483647))))
...
(assert (<= 1 i2))
(assert (<= i2 r99b))
(assert (<= (+ i3 1) (length c97b)))
(assert (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 i3)) (= (get c96b j3) (get c97b (+ j3 1))))))
(assert (forall ((j3 Int)) (=> (and (<= 2 j3) (<= j3 (+ i3 1))) (= (get c96b (- j3 1)) (get c97b j3)))))
(assert (and (=> (<= 1 r99b) (dynamic_property 1 r99b i3)) (and (<= 1 i3) (<= i3 r99b))))
(assert (and (= o31 (+ i3 1)) (in_range1 (+ i3 1))))
(assert (= o32 (ite (<= j1 o31) true false)))
(assert (= result5 (ite (<= 2 j1) o32 false)))
(assert (= result5 true))
(assert (not (<= 1 j1)))
(check-sat)
(exit)
