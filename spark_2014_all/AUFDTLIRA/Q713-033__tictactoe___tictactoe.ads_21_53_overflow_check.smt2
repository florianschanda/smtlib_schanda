...
(assert (in_range1 x))
(assert (in_range1 y))
(assert (=> (<= 3 x) (=> (<= 3 y) (and (= o9 (one_free_slot 3 3 my_board)) (and (in_range o9) (= o9 (ite (= (to_rep (select (select my_board 3) 3)) 0) 1 0)))))))
(assert (=> (<= 3 x) (=> (not (<= 3 y)) (= o9 0))))
(assert (=> (<= 3 x) (=> (<= 2 y) (and (= o6 (one_free_slot 3 2 my_board)) (and (in_range o6) (= o6 (ite (= (to_rep (select (select my_board 3) 2)) 0) 1 0)))))))
(assert (=> (<= 3 x) (=> (not (<= 2 y)) (= o6 0))))
(assert (=> (<= 3 x) (and (= o7 (one_free_slot 3 1 my_board)) (and (in_range o7) (= o7 (ite (= (to_rep (select (select my_board 3) 1)) 0) 1 0))))))
(assert (=> (<= 3 x) (= o8 (+ o7 o6))))
(assert (=> (<= 3 x) (and (= o10 o8) (in_range o8))))
(assert (=> (<= 3 x) (= o11 (+ o10 o9))))
(assert (=> (<= 3 x) (and (= o12 o11) (in_range o11))))
(assert (=> (not (<= 3 x)) (= o12 0)))
(assert (<= 2 x))
