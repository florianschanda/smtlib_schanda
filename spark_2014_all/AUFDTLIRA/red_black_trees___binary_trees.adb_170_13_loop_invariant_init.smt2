...
(assert (not (= j16 root)))
(assert (not (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select r1 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j16))))))) (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j16)))) (rec__tree_model__path_type__a (us_split_fields1 (select r1 j16)))) true)))
(check-sat)
(exit)
