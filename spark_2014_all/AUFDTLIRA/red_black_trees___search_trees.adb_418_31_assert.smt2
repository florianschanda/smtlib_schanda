...
(assert (= (olt (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f_old v) i2))) (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f_old v) j3)))) true))
(assert (not (= (get (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) j3))) (+ (length (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) i2)))) 1)) (get (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f_old v) j3))) (+ (length (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f_old v) i2)))) 1)))))
(check-sat)
(exit)
