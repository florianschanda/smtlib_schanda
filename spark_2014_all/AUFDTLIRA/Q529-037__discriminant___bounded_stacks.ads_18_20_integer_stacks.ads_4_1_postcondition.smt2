...
(define-fun temp___2686 () us_rep (mk___rep (mk___split_discrs temp___268) (mk___split_fields (mk___t temp___2681 temp___2682) temp___2683 temp___2684) temp___2685))
...
(assert (= o11 o6))
(assert (= us_tag1 o12))
(assert (= temp___2686 (to_base (mk___rep1 (mk___split_discrs o7) (mk___split_fields1 (mk___t1 o8 o9) o10 o11) o12))))
(assert (= temp___268 (rec__integer_stacks__stack__capacity this__split_discrs)))
(assert (= (mk___rep (mk___split_discrs usq_) (mk___split_fields (mk___t usq_1 usq_2) usq_3 usq_4) usq_5) temp___2686))
(assert (= usq_ temp___270))
(assert (= usq_1 temp___2701))
(assert (= usq_2 temp___2702))
(assert (= usq_3 temp___2703))
(assert (= usq_4 temp___2704))
(assert (= this__attr__tag temp___2705))
...
(assert (= this__split_fields4 (mk___split_fields (mk___t temp___2701 temp___2702) temp___2703 temp___2704)))
(assert (= this__split_discrs (mk___split_discrs temp___270)))
