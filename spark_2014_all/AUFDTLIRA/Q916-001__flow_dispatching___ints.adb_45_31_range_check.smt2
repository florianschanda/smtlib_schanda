...
(assert (not (= (length (mk___t temp___605 temp___6051)) 0)))
...
(assert (=> (<= (to_rep1 (first temp___6051)) (to_rep1 (last temp___6051))) (= o33 (+ (- (to_rep1 (last temp___6051)) (to_rep1 (first temp___6051))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___6051)) (to_rep1 (last temp___6051)))) (= o33 0)))
(assert (= o34 (+ o33 o32)))
(assert (= o35 (+ (to_rep1 (first temp___6051)) o34)))
(assert (= o36 (- o35 1)))
