...
(assert (<= 1 i1))
(assert (<= i1 100))
(assert (not (ite (= (rec__tree_model__path_type__k (us_split_fields1 (select m i1))) true) (< n2 (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 i1))))) false)))
(assert (= (rec__tree_model__path_type__k (us_split_fields1 (select m i1))) true))
(assert (and (= o49 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i1 0)) (and (in_range3 o49) (= o49 (peek1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) i1 0)))))
(assert (= (mk___rep5 (mk___split_fields5 o50 o51 o52)) (select res2 o49)))
(assert (= o53 (mk___split_fields5 o50 o51 o52)))
(assert (= o54 (rec__red_black_trees__black_count__count o53)))
(assert (= o55 (to_rep o54)))
(assert (=> (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) i1)) 0) (= o56 1)))
(assert (=> (not (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) i1)) 0)) (= o56 0)))
(assert (= o57 (+ o56 o55)))
