...
(assert (=> (= (int__content i14) 0) (and (= result19 (oeq1 o31 o32)) (= (= result19 true) (and (= (ole o31 o32) true) (= (ole o32 o31) true))))))
(assert (=> (not (= (int__content i14) 0)) (= result19 false)))
(assert (=> (= result19 true) (= (= result18 true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (= (parent1 (mk___rep3 (us_split_fields__content3 t__split_fields14)) j1) (parent1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)) j1)))))))
(assert (=> (not (= result19 true)) (= result18 false)))
(assert (= result18 true))
(assert (<= 1 j))
(assert (<= j 100))
(assert (type_invariant1 (mk___rep3 (us_split_fields__content3 t__split_fields14))))
(assert (and (= o29 (parent1 (mk___rep3 (us_split_fields__content3 t__split_fields14)) j)) (and (in_range4 o29) (and (= o29 (parent (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14)) j)) (=> (= (size1 (mk___rep3 (us_split_fields__content3 t__split_fields14))) 0) (= o29 0))))))
(assert (= o30 (ite (= o29 0) true false)))
(assert (= result20 (ite (not (= o30 true)) true false)))
(assert (= result20 true))
(assert (type_invariant1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3))))
(assert (not (not (= (parent1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)) j) 0))))
(check-sat)
(exit)
