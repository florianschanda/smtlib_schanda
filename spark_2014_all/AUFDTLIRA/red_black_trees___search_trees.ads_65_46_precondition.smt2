...
(assert (<= j3 100))
(assert (type_invariant1 (mk___rep3 (us_split_fields__content3 t__split_fields14))))
(assert (and (= o62 (parent1 (mk___rep3 (us_split_fields__content3 t__split_fields14)) j3)) (and (in_range4 o62) (and (= o62 (parent (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14)) j3)) (=> (= (size1 (mk___rep3 (us_split_fields__content3 t__split_fields14))) 0) (= o62 0))))))
(assert (= o63 (ite (= o62 0) true false)))
(assert (= result25 (ite (not (= o63 true)) true false)))
(assert (= result25 true))
(assert (type_invariant1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3))))
(assert (not (not (= (parent1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)) j3) 0))))
(check-sat)
(exit)
