...
(assert (forall ((temp___284 us_rep)) (=> (= (has_element c1 temp___284) true) (= (valid2 (element c1 temp___284)) true))))
(assert (= (has_element c1 (mk___rep (mk___split_fields p1__split_fields))) true))
(assert (= (valid2 (element c1 (mk___rep (mk___split_fields p1__split_fields)))) true))
(assert (forall ((e Int)) (=> (and (in_range e) (= (mem c2 e) true)) (= (valid1 e) true))))
(assert (= (mem c2 p2) true))
(assert (not (= (valid1 p2) true)))
(check-sat)
(exit)
