...
(assert (forall ((k Int)) (=> (and (<= 1 k) (<= k id2)) (=> (not (= (get_other_previous_track new_position k) 0)) (let ((temp___396 (to_rep5 (select track_signals3 (get_other_previous_track new_position k))))) (or (= temp___396 1) (= temp___396 2)))))))
...
(assert (= id3 (+ id2 1)))
(assert (and (= o9 (get_other_previous_track new_position id3)) (and (in_range3 o9) (= o9 (ite (= (to_rep2 (select (select previous_tracks (to_rep (rec__trains__track__from (us_split_fields1 (select tracks (to_rep4 (rec__trains__train_position__track_begin (us_split_fields3 new_position)))))))) id3)) (to_rep4 (rec__trains__train_position__track_end (us_split_fields3 new_position)))) 0 (to_rep2 (select (select previous_tracks (to_rep (rec__trains__track__from (us_split_fields1 (select tracks (to_rep4 (rec__trains__train_position__track_begin (us_split_fields3 new_position)))))))) id3)))))))
