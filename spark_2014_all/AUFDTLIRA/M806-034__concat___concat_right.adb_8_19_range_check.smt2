...
(assert (=> (<= (to_rep (first (rt y))) (to_rep (last (rt y)))) (= o (+ (- (to_rep (last (rt y))) (to_rep (first (rt y)))) 1))))
(assert (=> (not (<= (to_rep (first (rt y))) (to_rep (last (rt y))))) (= o 0)))
(assert (= o1 (+ o 1)))
(assert (= o2 (+ (to_rep (first (rt y))) o1)))
(assert (= o3 (- o2 1)))
