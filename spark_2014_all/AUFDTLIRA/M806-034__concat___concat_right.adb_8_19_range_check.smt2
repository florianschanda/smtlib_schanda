...
(assert (not (= (length y) 0)))
(assert (=> (<= (to_rep (first (rt y))) (to_rep (last (rt y)))) (= o4 (+ (- (to_rep (last (rt y))) (to_rep (first (rt y)))) 1))))
(assert (=> (not (<= (to_rep (first (rt y))) (to_rep (last (rt y))))) (= o4 0)))
(assert (= o5 (+ o4 1)))
(assert (= o6 (+ (to_rep (first (rt y))) o5)))
(assert (= o7 (- o6 1)))
