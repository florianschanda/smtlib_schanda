...
(assert (= result19 (ite (< 51 o38) true false)))
(assert (not (= result19 true)))
(assert (= has_failed14 has_failed13))
(assert (and (= temp___1018 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
...
(assert (= result21 (ite (< o41 51) true false)))
(assert (=> (= result21 true) (and (not (= has_failed15 true)) (in_range1 target8))))
(assert (not (= result21 true)))
(assert (=> (not (= result21 true)) (= has_failed15 has_failed14)))
(assert (=> (not (= result21 true)) (= target8 target7)))
(assert (and (= temp___1019 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
...
(assert (= result22 (ite (< 54 o44) true false)))
(assert (not (= result22 true)))
(assert (= has_failed16 has_failed15))
(assert (and (= temp___1020 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
...
(assert (= result24 (ite (< o47 54) true false)))
(assert (=> (= result24 true) (and (not (= has_failed17 true)) (in_range1 target9))))
(assert (not (= result24 true)))
(assert (=> (not (= result24 true)) (= has_failed17 has_failed16)))
(assert (=> (not (= result24 true)) (= target9 target8)))
(assert (and (= temp___1021 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
...
(assert (= result25 (ite (< 52 o50) true false)))
(assert (not (= result25 true)))
(assert (= has_failed18 has_failed17))
(assert (and (= temp___1022 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1022) (<= temp___1022 (to_rep1 (last (rt source))))))
(assert (= o51 temp___1022))
(assert (= o52 (select (elts source) o51)))
(assert (= o53 (to_rep o52)))
(assert (= result27 (ite (< o53 52) true false)))
(assert (=> (= result27 true) (and (not (= has_failed19 true)) (in_range1 target10))))
(assert (not (= result27 true)))
(assert (=> (not (= result27 true)) (= has_failed19 has_failed18)))
(assert (=> (not (= result27 true)) (= target10 target9)))
(assert (and (= temp___1023 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (not (<= (to_rep1 (first (rt source))) temp___1023)))
(check-sat)
(exit)
