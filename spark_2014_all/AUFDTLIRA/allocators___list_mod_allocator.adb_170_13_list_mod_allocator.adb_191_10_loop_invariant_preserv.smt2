...
(assert (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 (+ i3 1))) (not (= (get c97b j3) (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select data2 (get c96b i3))))))))))
(assert (not (= i3 r99b)))
...
(assert (<= 2 j3))
(assert (<= j3 (+ i4 1)))
(assert (not (= (get c96b (- j3 1)) (get c97b j3))))
(check-sat)
(exit)
