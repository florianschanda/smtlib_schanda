...
(assert (= (= result12 true) (forall ((t1 Int)) (=> (and (<= 1 t1) (<= t1 100)) (=> (and (and (= (valid_root (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) t1) true) (not (= i t1))) (not (= (int__content v2) t1))) (= (valid_root (mk___rep2 (us_split_fields__content2 f__split_fields7)) t1) true))))))
(assert (= result12 true))
(assert (<= 1 t))
(assert (<= t 100))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o44 (valid_root (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) t)) (and (= (= o44 true) (and (<= t (to_rep f__split_fields)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 t)))) 2))) (=> (< (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) t) (not (= o44 true))))))
(assert (= o45 (ite (and (= o44 true) (not (= root t))) true false)))
(assert (= result13 (ite (and (= o45 true) (not (= (int__content v2) t))) true false)))
