...
(assert (<= t 100))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o69 (valid_root (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) t)) (and (= (= o69 true) (and (<= t (to_rep f__split_fields)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 t)))) 2))) (=> (< (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) t) (not (= o69 true))))))
(assert (= o70 (ite (and (= o69 true) (not (= root t))) true false)))
(assert (= result17 (ite (and (= o70 true) (not (= (int__content v2) t))) true false)))
