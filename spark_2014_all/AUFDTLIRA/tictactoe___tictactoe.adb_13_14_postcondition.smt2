...
(assert (forall ((x pos)) (! (in_range3 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun dynamic_invariant3 ((temp___expr_584 Int) (temp___is_init_580 Bool) (temp___skip_constant_581 Bool) (temp___do_toplevel_582 Bool) (temp___do_typ_inv_583 Bool)) Bool (=> (or (= temp___is_init_580 true) (<= 1 3)) (in_range3 temp___expr_584)))
