...
(assert (= result2 true))
(assert (and (= o21 (valid_root f v)) (=> (< (size f) v) (not (= o21 true)))))
...
(assert (= o19 (select temp___1760 v)))
...
(assert (and (= temp___1748 (model__ f root)) (and (dynamic_invariant5 temp___1748 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1748 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1748 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent f i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1748 (parent f i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1748 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1748 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1748 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select temp___1748 (parent f i1)))) (position f i1) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1748 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1748 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1748 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1748 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select temp___1748 i1))) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1748 j)))) true)) (= j i1))))))))))))))
