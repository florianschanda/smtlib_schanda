...
(assert (forall ((i tTxSP1)) (and (<= 1 (tTxSP1qtint i)) (<= (tTxSP1qtint i) 1000))))
...
(assert (forall ((temp___220 Int)) (=> (dynamic_invariant1 temp___220 true true true true) (forall ((temp___221 Int)) (= (to_rep (select (purecat__x__aggregate_def temp___220) temp___221)) temp___220)))))
...
(assert (not (= (to_rep (select x1 1)) 88)))
(check-sat)
(exit)
