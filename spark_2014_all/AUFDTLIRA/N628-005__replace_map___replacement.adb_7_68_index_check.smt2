...
(assert (and (= temp___587 (element (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c1)) (and (in_range4 temp___587) (= temp___587 (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c1))))))
(assert (not (<= (to_rep (first (rt a))) temp___587)))
(check-sat)
(exit)
