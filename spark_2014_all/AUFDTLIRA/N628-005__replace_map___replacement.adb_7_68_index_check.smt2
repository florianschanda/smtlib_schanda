...
(assert (= result3 true))
(assert (and (= o7 (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) (mk___rep1 (mk___split_fields1 c1)))) (and (in_range3 o7) (= o7 (get (keys (mk___rep d__split_discrs (mk___split_fields d__split_fields))) (get1 (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields))) (mk___rep1 (mk___split_fields1 c1))))))))
(assert (and (= temp___587 (element (mk___rep d__split_discrs (mk___split_fields d__split_fields)) (mk___rep1 (mk___split_fields1 c1)))) (and (in_range4 temp___587) (= temp___587 (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) (mk___rep1 (mk___split_fields1 c1))))))))
