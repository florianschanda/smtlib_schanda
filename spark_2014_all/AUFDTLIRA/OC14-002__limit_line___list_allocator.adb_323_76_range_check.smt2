...
(define-fun dynamic_invariant ((temp___expr_284 Int) (temp___is_init_281 Bool) (temp___skip_constant_282 Bool) (temp___do_toplevel_283 Bool)) Bool (=> (or (= temp___is_init_281 true) (<= 0 3)) (in_range2 temp___expr_284)))
...
(define-fun dynamic_invariant1 ((temp___expr_33 Int) (temp___is_init_30 Bool) (temp___skip_constant_31 Bool) (temp___do_toplevel_32 Bool)) Bool (=> (or (= temp___is_init_30 true) (<= 0 2147483647)) (in_range5 temp___expr_33)))
...
(define-fun dynamic_invariant2 ((temp___expr_302 Int) (temp___is_init_299 Bool) (temp___skip_constant_300 Bool) (temp___do_toplevel_301 Bool)) Bool (=> (or (= temp___is_init_299 true) (<= 0 3)) (in_range6 temp___expr_302)))
...
(assert (forall ((s us_rep1)) (forall ((e Int)) (! (=> (dynamic_invariant2 e true true true) (= (is_add s e (add s e)) true)) :pattern ((add s e))))))
(assert true)
...
(assert (forall ((temp___369 us_rep)) (forall ((temp___370 Int)) (= (select (list_allocator__data__aggregate_def temp___369) temp___370) temp___369))))
...
(define-fun dynamic_invariant3 ((temp___expr_39 Int) (temp___is_init_36 Bool) (temp___skip_constant_37 Bool) (temp___do_toplevel_38 Bool)) Bool (=> (or (= temp___is_init_36 true) (<= 1 2147483647)) (in_range7 temp___expr_39)))
(define-fun dynamic_invariant4 ((temp___expr_331 Int) (temp___is_init_328 Bool) (temp___skip_constant_329 Bool) (temp___do_toplevel_330 Bool)) Bool (=> (or (= temp___is_init_328 true) (<= 0 1)) (in_range4 temp___expr_331)))
(define-fun dynamic_invariant5 ((temp___expr_290 Int) (temp___is_init_287 Bool) (temp___skip_constant_288 Bool) (temp___do_toplevel_289 Bool)) Bool (=> (or (= temp___is_init_287 true) (<= 1 3)) (in_range3 temp___expr_290)))
...
(assert (forall ((s us_rep1)) (forall ((n Int)) (! (=> (and (dynamic_invariant3 n true true true) (and (<= 1 n) (<= n (length s)))) (dynamic_invariant2 (get s n) true false true)) :pattern ((get s n))))))
(assert (forall ((attr__tag Int) (n Int)) (forall ((s us_rep1)) (! (=> (dynamic_invariant3 n true true true) (dynamic_invariant2 (get1 attr__tag s n) true false true)) :pattern ((get1 attr__tag s n))))))
...
(assert true)
(assert (forall ((s us_rep1) (result__ us_rep1)) (forall ((e Int)) (! (=> (dynamic_invariant2 e true true true) (= (= (is_add s e result__) true) (and (and (= (length result__) (+ (length s) 1)) (= (get result__ (length result__)) e)) (forall ((m Int)) (=> (and (<= 1 m) (<= m (length s))) (= (get result__ m) (get s m))))))) :pattern ((is_add s e result__))))))
(assert true)
...
(declare-const temp___357 (Array Int us_rep))
...
(declare-const temp___365 Int)
(declare-const temp___364 us_rep2)
(declare-const o46 us_rep1)
(declare-const o47 us_split_fields2)
(declare-const temp___363 us_rep2)
(declare-const rr2 Int)
(declare-const o48 Int)
(declare-const o49 us_rep1)
(declare-const o50 us_split_fields2)
(declare-const temp___3631 us_rep2)
...
(declare-const data7 map__ref)
(declare-const r5 int__ref)
(declare-const data8 (Array Int us_rep))
(declare-const r6 Int)
(declare-const data9 map__ref)
(declare-const r7 int__ref)
(declare-const data10 (Array Int us_rep))
...
(declare-const model____split_fields5 us_split_fields2)
(declare-const model____split_fields6 us_split_fields__ref1)
(declare-const r12 int__ref)
(declare-const model____split_fields7 us_split_fields2)
(declare-const r13 Int)
(declare-const model____split_fields8 us_split_fields__ref1)
(declare-const r14 int__ref)
(declare-const model____split_fields9 us_split_fields2)
(declare-const r15 Int)
(declare-const model____split_fields10 us_split_fields__ref1)
(declare-const r16 int__ref)
(declare-const model____split_fields11 us_split_fields2)
...
(assert (= r2 1))
(assert (=> (and (<= 1 r2) (<= r2 3)) (= temp___359 r2)))
(assert (=> (and (<= 1 r2) (<= r2 3)) (= temp___357 data1)))
(assert (=> (and (<= 1 r2) (<= r2 3)) (=> (< 1 r2) (= (to_rep o10) (- r2 1)))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (=> (< 1 r2) (= (rec__list_allocator__cell__stat (us_split_fields1 (select data1 r2))) o11))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (=> (< 1 r2) (= o10 o12))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (=> (< 1 r2) (= (rec__list_allocator__cell__next (us_split_fields1 (select data1 r2))) o13))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (=> (< 1 r2) (= o14 o11))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (=> (< 1 r2) (= o15 o12))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (=> (< 1 r2) (= o16 o13))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (=> (< 1 r2) (= o17 (store data1 r2 (mk___rep (mk___split_fields o14 o15 o16)))))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (=> (< 1 r2) (= result4 (mk_map__ref data1)))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (=> (< 1 r2) (= data2 o17))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (=> (not (< 1 r2)) (= data2 data1))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (=> (< r2 3) (and (= o18 (+ r2 1)) (in_range2 (+ r2 1))))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (=> (< r2 3) (= (to_rep o19) o18))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (=> (< r2 3) (= (rec__list_allocator__cell__stat (us_split_fields1 (select data2 r2))) o20))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (=> (< r2 3) (= (rec__list_allocator__cell__prev (us_split_fields1 (select data2 r2))) o21))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (=> (< r2 3) (= o19 o22))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (=> (< r2 3) (= o23 o20))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (=> (< r2 3) (= o24 o21))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (=> (< r2 3) (= o25 o22))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (=> (< r2 3) (= o26 (store data2 r2 (mk___rep (mk___split_fields o23 o24 o25)))))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (=> (< r2 3) (= result5 (mk_map__ref data2)))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (=> (< r2 3) (= data3 o26))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (=> (not (< r2 3)) (= data3 data2))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (forall ((rr3 Int)) (=> (and (<= 1 rr3) (<= rr3 r3)) (= (to_rep (rec__list_allocator__cell__prev (us_split_fields1 (select data4 rr3)))) (ite (= rr3 1) 0 (- rr3 1)))))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (forall ((rr3 Int)) (=> (and (<= 1 rr3) (<= rr3 r3)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data4 rr3)))) (ite (= rr3 3) 0 (+ rr3 1)))))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (forall ((rr3 Int)) (=> (and (<= 1 rr3) (<= rr3 3)) (= (to_rep1 (rec__list_allocator__cell__stat (us_split_fields1 (select data4 rr3)))) 0)))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (and (and (forall ((temp___358 Int)) (=> (and (<= 1 temp___358) (<= temp___358 3)) (ite (< r3 temp___358) (= (select data4 temp___358) (select temp___357 temp___358)) (= (rec__list_allocator__cell__stat (us_split_fields1 (select data4 temp___358))) (rec__list_allocator__cell__stat (us_split_fields1 (select temp___357 temp___358))))))) (=> (<= 1 3) (in_range3 r3))) (and (<= 1 r3) (<= r3 3)))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (= r3 3)))
(assert (=> (and (<= 1 r2) (<= r2 3)) (= r5 (mk_int__ref r3))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (= data7 (mk_map__ref data4))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (= r6 r3)))
(assert (=> (and (<= 1 r2) (<= r2 3)) (= data8 data4)))
(assert (=> (and (<= 1 r2) (<= r2 3)) (= r7 r5)))
(assert (=> (and (<= 1 r2) (<= r2 3)) (= data9 data7)))
(assert (=> (and (<= 1 r2) (<= r2 3)) (= r8 r6)))
(assert (=> (and (<= 1 r2) (<= r2 3)) (= data10 data8)))
(assert (=> (not (and (<= 1 r2) (<= r2 3))) (= r7 (mk_int__ref r2))))
(assert (=> (not (and (<= 1 r2) (<= r2 3))) (= data9 (mk_map__ref data1))))
(assert (=> (not (and (<= 1 r2) (<= r2 3))) (= r8 r2)))
(assert (=> (not (and (<= 1 r2) (<= r2 3))) (= data10 data1)))
(assert (= result9 (mk_int__ref r1)))
(assert (= r9 1))
(assert (<= 1 r9))
(assert (<= r9 3))
(assert (and (= o46 (add model____split_fields r9)) (= (is_add model____split_fields r9 o46) true)))
(assert (= o47 (mk___split_fields1 o46 model____split_fields1)))
(assert (= temp___363 (mk___rep1 o47)))
(assert (= result10 (mk___split_fields__ref1 (mk___split_fields1 model____split_fields model____split_fields1))))
(assert (= model____split_fields3 (us_split_fields3 temp___363)))
(assert (forall ((rr3 Int)) (=> (and (<= 1 rr3) (<= rr3 r10)) (= (mem (rec__list_allocator__m__t__available model____split_fields4) rr3) true))))
(assert (= (length (rec__list_allocator__m__t__allocated model____split_fields4)) 0))
(assert (and (and (= (rec__list_allocator__m__t__allocated model____split_fields4) model____split_fields1) (=> (<= 1 3) (in_range3 r10))) (and (<= 1 r10) (<= r10 3))))
(assert (<= 1 rr2))
(assert (<= rr2 r10))
(assert (not (in_range2 rr2)))
(check-sat)
(exit)
