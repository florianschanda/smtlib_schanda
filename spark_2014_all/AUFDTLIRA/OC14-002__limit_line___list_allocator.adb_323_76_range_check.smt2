...
(assert (=> (and (<= 1 r2) (<= r2 3)) (forall ((rr1 Int)) (=> (and (<= 1 rr1) (<= rr1 r3)) (= (to_rep (rec__list_allocator__cell__prev (us_split_fields1 (select data4 rr1)))) (ite (= rr1 1) 0 (- rr1 1)))))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (forall ((rr1 Int)) (=> (and (<= 1 rr1) (<= rr1 r3)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data4 rr1)))) (ite (= rr1 3) 0 (+ rr1 1)))))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (forall ((rr1 Int)) (=> (and (<= 1 rr1) (<= rr1 3)) (= (to_rep1 (rec__list_allocator__cell__stat (us_split_fields1 (select data4 rr1)))) 0)))))
...
(assert (=> (and (<= 1 r2) (<= r2 3)) (= r4 (mk_int__ref r3))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (= data5 (mk_map__ref data4))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (= r5 r3)))
(assert (=> (and (<= 1 r2) (<= r2 3)) (= data6 data4)))
(assert (=> (and (<= 1 r2) (<= r2 3)) (= r6 r4)))
(assert (=> (and (<= 1 r2) (<= r2 3)) (= data7 data5)))
(assert (=> (and (<= 1 r2) (<= r2 3)) (= r7 r5)))
(assert (=> (and (<= 1 r2) (<= r2 3)) (= data8 data6)))
(assert (=> (not (and (<= 1 r2) (<= r2 3))) (= r6 (mk_int__ref r2))))
(assert (=> (not (and (<= 1 r2) (<= r2 3))) (= data7 (mk_map__ref data1))))
(assert (=> (not (and (<= 1 r2) (<= r2 3))) (= r7 r2)))
(assert (=> (not (and (<= 1 r2) (<= r2 3))) (= data8 data1)))
(assert (= result6 (mk_int__ref r1)))
(assert (= r8 1))
(assert (<= 1 r8))
(assert (<= r8 3))
(assert (and (= o27 (add model____split_fields r8)) (= (is_add model____split_fields r8 o27) true)))
(assert (= o28 (mk___split_fields1 o27 model____split_fields1)))
(assert (= temp___363 (mk___rep1 o28)))
(assert (= result7 (mk___split_fields__ref1 (mk___split_fields1 model____split_fields model____split_fields1))))
(assert (= model____split_fields2 (us_split_fields3 temp___363)))
(assert (forall ((rr1 Int)) (=> (and (<= 1 rr1) (<= rr1 r9)) (= (mem (rec__list_allocator__m__t__available model____split_fields3) rr1) true))))
(assert (= (length (rec__list_allocator__m__t__allocated model____split_fields3)) 0))
(assert (and (and (= (rec__list_allocator__m__t__allocated model____split_fields3) model____split_fields1) (=> (<= 1 3) (in_range3 r9))) (and (<= 1 r9) (<= r9 3))))
(assert (<= 1 rr))
(assert (<= rr r9))
(assert (not (in_range2 rr)))
(check-sat)
(exit)
