...
(declare-const temp___390 (Array Int us_rep))
...
(declare-const temp___396 us_rep2)
...
(assert (= r2 1))
(assert (=> (and (<= 1 r2) (<= r2 3)) (= temp___392 r2)))
(assert (=> (and (<= 1 r2) (<= r2 3)) (= temp___390 data1)))
...
(assert (=> (and (<= 1 r2) (<= r2 3)) (and (and (forall ((temp___391 Int)) (=> (and (<= 1 temp___391) (<= temp___391 3)) (ite (< r3 temp___391) (= (select data4 temp___391) (select temp___390 temp___391)) (= (rec__list_allocator__cell__stat (us_split_fields1 (select data4 temp___391))) (rec__list_allocator__cell__stat (us_split_fields1 (select temp___390 temp___391))))))) (=> (<= 1 3) (in_range3 r3))) (and (<= 1 r3) (<= r3 3)))))
