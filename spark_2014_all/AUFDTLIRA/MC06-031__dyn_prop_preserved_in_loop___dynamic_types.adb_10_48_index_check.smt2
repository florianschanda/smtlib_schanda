...
(assert (=> (= (to_rep (select (elts a) from)) c) (= (mk_int__ref result) result__5)))
(assert (=> (= (to_rep (select (elts a) from)) c) (= result__1 o)))
(assert (=> (not (= (to_rep (select (elts a) from)) c)) (= (mk_int__ref result1) result__5)))
...
(assert (=> (= result__3 0) (= (= result2 true) (forall ((i Int)) (=> (and (<= from i) (<= i from)) (not (= (to_rep (select (elts a) i)) c)))))))
