...
(assert (in_range1 c))
(assert (and (= first2 (to_rep1 (first (rt a)))) (= last2 (to_rep1 (last (rt a))))))
(assert (=> (= (to_rep (select (elts a) from)) c) (and (= o from) (in_range1 from))))
(assert (=> (= (to_rep (select (elts a) from)) c) (= (mk_int__ref result) (mk_int__ref result__))))
(assert (=> (= (to_rep (select (elts a) from)) c) (= result__1 o)))
(assert (=> (not (= (to_rep (select (elts a) from)) c)) (= (mk_int__ref result1) (mk_int__ref result__))))
(assert (=> (not (= (to_rep (select (elts a) from)) c)) (= result__2 0)))
(assert (=> (not (= (to_rep (select (elts a) from)) c)) (= result__1 result__2)))
(assert (= result__1 result__3))
(assert (= result__4 result__1))
(assert (=> (= result__3 0) (= (= result2 true) (forall ((i1 Int)) (=> (and (<= from i1) (<= i1 from)) (not (= (to_rep (select (elts a) i1)) c)))))))
...
(assert (not (<= (to_rep1 (first (rt a))) result__3)))
(check-sat)
(exit)
