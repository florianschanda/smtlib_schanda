...
(assert (= o5 (- o4 o3)))
(assert (and (= temp___230 o5) (in_range1 o5)))
(assert (= result3 (mk_int__ref i)))
(assert (= i1 (to_rep (first (rt a)))))
(assert (<= (to_rep (first (rt a))) i1))
(assert (<= i1 temp___230))
(assert (and (= result4 (equal_subrange a i1 b)) (= (= result4 true) (= (bool_eq (elts a) (to_rep (first2 (mk1 i1 (+ (- i1 1) (length b))))) (to_rep (last2 (mk1 i1 (+ (- i1 1) (length b))))) (elts b) (to_rep (first (rt b))) (to_rep (last (rt b)))) true))))
...
(assert (not (= (rec__types__option__exists result____split_fields4) true)))
(assert (and (=> (<= (to_rep (first (rt a))) (- (+ (to_rep (last (rt a))) 1) (length b))) (dynamic_property3 (to_rep (first (rt a))) (- (+ (to_rep (last (rt a))) 1) (length b)) i2)) (and (<= (to_rep (first (rt a))) i2) (<= i2 (- (+ (to_rep (last (rt a))) 1) (length b))))))
(assert (= result5 (mk_int__ref temp___228)))
(assert (= temp___2281 i2))
(assert (not (= i2 temp___230)))
(assert (= result6 (mk_int__ref i2)))
(assert (= i3 (+ i2 1)))
(assert (and (= result7 (equal_subrange a i3 b)) (= (= result7 true) (= (bool_eq (elts a) (to_rep (first2 (mk1 i3 (+ (- i3 1) (length b))))) (to_rep (last2 (mk1 i3 (+ (- i3 1) (length b))))) (elts b) (to_rep (first (rt b))) (to_rep (last (rt b)))) true))))
...
(assert (not (not (= (rec__types__option__exists result____split_fields5) true))))
(check-sat)
(exit)
