...
(assert (and (= o4 (+ (to_rep (last (rt a))) 1)) (in_range1 (+ (to_rep (last (rt a))) 1))))
(assert (= o5 (- o4 o3)))
(assert (and (= temp___204 o5) (in_range1 o5)))
(assert (= result4 (mk_int__ref i)))
(assert (= i2 (to_rep (first (rt a)))))
(assert (<= (to_rep (first (rt a))) i2))
(assert (<= i2 temp___204))
(assert (and (= result5 (equal_subrange a i2 b)) (= (= result5 true) (= (bool_eq (elts a) (to_rep (first2 (mk1 i2 (+ (- i2 1) (length b))))) (to_rep (last2 (mk1 i2 (+ (- i2 1) (length b))))) (elts b) (to_rep (first (rt b))) (to_rep (last (rt b)))) true))))
(assert (not (= result5 true)))
(assert (= search_ter_p__search__result5 search_ter_p__search__result4))
(assert (= result____split_fields4 result____split_fields2))
(assert (not (= (has_sub_range_in_prefix a i3 b) true)))
(assert (not (= (rec__types__option__exists result____split_fields5) true)))
(assert (and (=> (<= (to_rep (first (rt a))) (- (+ (to_rep (last (rt a))) 1) (length b))) (dynamic_property3 (to_rep (first (rt a))) (- (+ (to_rep (last (rt a))) 1) (length b)) i3)) (and (<= (to_rep (first (rt a))) i3) (<= i3 (- (+ (to_rep (last (rt a))) 1) (length b))))))
(assert (= result9 (mk_int__ref temp___2022)))
(assert (= temp___2023 i3))
(assert (not (= i3 temp___204)))
(assert (= result10 (mk_int__ref i3)))
(assert (= i4 (+ i3 1)))
(assert (and (= result11 (equal_subrange a i4 b)) (= (= result11 true) (= (bool_eq (elts a) (to_rep (first2 (mk1 i4 (+ (- i4 1) (length b))))) (to_rep (last2 (mk1 i4 (+ (- i4 1) (length b))))) (elts b) (to_rep (first (rt b))) (to_rep (last (rt b)))) true))))
...
(assert (not (not (= (rec__types__option__exists result____split_fields7) true))))
(check-sat)
(exit)
