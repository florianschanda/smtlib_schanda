...
(define-fun dynamic_invariant2 ((temp___expr_176 Int) (temp___is_init_172 Bool) (temp___skip_constant_173 Bool) (temp___do_toplevel_174 Bool) (temp___do_typ_inv_175 Bool)) Bool (=> (or (= temp___is_init_172 true) (<= 1 10)) (in_range1 temp___expr_176)))
...
(assert (not (= n j1)))
(assert (not (= n j2)))
(assert (not (= (bool_eq (select (select a3 i1) n) 1 10 (select (select a i1) n) 1 10) true)))
(check-sat)
(exit)
