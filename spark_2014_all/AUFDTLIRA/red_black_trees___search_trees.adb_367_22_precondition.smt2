...
(declare-const temp___1712 (Array Int us_rep3))
...
(assert (= (mk___rep2 (mk___split_fields2 o14 o15)) (select temp___1714 i)))
(assert (= o14 o16))
(assert (= o15 o17))
(assert (= o18 o16))
...
(assert (= (mk___rep2 (mk___split_fields2 o9 o10)) (select temp___1713 i)))
(assert (= o9 o11))
(assert (= o10 o12))
(assert (= o13 o11))
(assert (and (= temp___1712 (model__ f root)) (and (dynamic_invariant5 temp___1712 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1712 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1712 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent f i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1712 (parent f i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1712 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1712 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1712 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select temp___1712 (parent f i1)))) (position f i1) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1712 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1712 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1712 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1712 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select temp___1712 i1))) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1712 j)))) true)) (= j i1))))))))))))))
(assert (= (mk___rep2 (mk___split_fields2 o4 o5)) (select temp___1712 v)))
(assert (= o4 o6))
(assert (= o5 o7))
(assert (= o8 o6))
