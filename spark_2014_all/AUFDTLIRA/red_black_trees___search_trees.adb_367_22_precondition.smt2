...
(assert (= o10 o12))
(assert (= o13 o11))
(assert (and (= temp___1668 (model__ f root)) (and (dynamic_invariant5 temp___1668 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1668 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1668 root)))) 0) (and (forall ((i21 Int)) (=> (and (<= 1 i21) (<= i21 100)) (=> (not (= i21 root)) (ite (and (not (= (parent f i21) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1668 (parent f i21)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1668 i21))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1668 i21))) true)))))) (and (forall ((i21 Int)) (=> (and (<= 1 i21) (<= i21 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1668 i21))) true) (not (= i21 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1668 (parent f i21)))) (position f i21) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1668 i21)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1668 i21)))) 0)))) (forall ((i21 Int)) (=> (and (<= 1 i21) (<= i21 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1668 i21))) true) (forall ((j26 Int)) (=> (and (<= 1 j26) (<= j26 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1668 j26))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1668 i21))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1668 j26)))) true)) (= j26 i21))))))))))))))
(assert (= (mk___rep (mk___split_fields o4 o5)) (select temp___1668 v)))
(assert (= o4 o6))
(assert (= o5 o7))
(assert (= o8 o6))
