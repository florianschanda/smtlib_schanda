...
(declare-const temp___857 cardindex)
(declare-const temp___8571 (Array Int card))
(declare-const temp___8572 cardindex)
(declare-const temp___8573 (Array Int cardindex))
(declare-const temp___8574 (Array Int (Array Int cardindex)))
(declare-const temp___8575 (Array Int cardindex))
(declare-const temp___8576 (Array Int cardindex))
(declare-const temp___8577 (Array Int cardindex))
...
(define-fun s__split_fields38 () us_split_fields (mk___split_fields s__split_fields24 s__split_fields25 s__split_fields26 s__split_fields27 s__split_fields28 s__split_fields29 s__split_fields30 s__split_fields31))
(define-fun s__split_fields39 () us_split_fields (mk___split_fields s__split_fields8 s__split_fields9 s__split_fields10 s__split_fields11 s__split_fields12 s__split_fields13 s__split_fields14 s__split_fields15))
...
(assert (=> (and (<= (to_rep1 (first (rt cards))) i1) (<= i1 (to_rep1 (last (rt cards))))) (= temp___858 i1)))
(assert (=> (and (<= (to_rep1 (first (rt cards))) i1) (<= i1 (to_rep1 (last (rt cards))))) (and (= temp___857 s__split_fields8) (and (= temp___8571 s__split_fields9) (and (= temp___8572 s__split_fields10) (and (= temp___8573 s__split_fields11) (and (= temp___8574 s__split_fields12) (and (= temp___8575 s__split_fields13) (and (= temp___8576 s__split_fields14) (= temp___8577 s__split_fields15))))))))))
(assert (=> (and (<= (to_rep1 (first (rt cards))) i1) (<= i1 (to_rep1 (last (rt cards))))) (= (to_rep2 s__split_fields16) (- i2 (to_rep1 (first (rt cards)))))))
(assert (=> (and (<= (to_rep1 (first (rt cards))) i1) (<= i1 (to_rep1 (last (rt cards))))) (= (inv (mk___rep (mk___split_fields s__split_fields16 s__split_fields17 s__split_fields18 s__split_fields19 s__split_fields20 s__split_fields21 s__split_fields22 s__split_fields23))) true)))
(assert (=> (and (<= (to_rep1 (first (rt cards))) i1) (<= i1 (to_rep1 (last (rt cards))))) (and (=> (<= (to_rep1 (first (rt cards))) (to_rep1 (last (rt cards)))) (dynamic_property1 (to_rep1 (first (rt cards))) (to_rep1 (last (rt cards))) i2)) (and (<= (to_rep1 (first (rt cards))) i2) (<= i2 (to_rep1 (last (rt cards))))))))
(assert (=> (and (<= (to_rep1 (first (rt cards))) i1) (<= i1 (to_rep1 (last (rt cards))))) (and (and (= (inv (mk___rep s__split_fields38)) true) (= (to_rep (select s__split_fields25 (to_rep2 s__split_fields16))) (to_rep (select (elts cards) i2)))) (= (to_rep2 s__split_fields24) (+ (to_rep2 s__split_fields16) 1)))))
(assert (=> (and (<= (to_rep1 (first (rt cards))) i1) (<= i1 (to_rep1 (last (rt cards))))) (= i2 (to_rep1 (last (rt cards))))))
(assert (=> (and (<= (to_rep1 (first (rt cards))) i1) (<= i1 (to_rep1 (last (rt cards))))) (= i3 (mk_int__ref i2))))
(assert (=> (and (<= (to_rep1 (first (rt cards))) i1) (<= i1 (to_rep1 (last (rt cards))))) (= s__split_fields32 (mk___split_fields__ref s__split_fields38))))
(assert (=> (and (<= (to_rep1 (first (rt cards))) i1) (<= i1 (to_rep1 (last (rt cards))))) (= i4 i2)))
(assert (=> (and (<= (to_rep1 (first (rt cards))) i1) (<= i1 (to_rep1 (last (rt cards))))) (= s__split_fields33 s__split_fields38)))
(assert (=> (and (<= (to_rep1 (first (rt cards))) i1) (<= i1 (to_rep1 (last (rt cards))))) (= i5 i3)))
(assert (=> (and (<= (to_rep1 (first (rt cards))) i1) (<= i1 (to_rep1 (last (rt cards))))) (= s__split_fields34 s__split_fields32)))
(assert (=> (and (<= (to_rep1 (first (rt cards))) i1) (<= i1 (to_rep1 (last (rt cards))))) (= i6 i4)))
(assert (=> (and (<= (to_rep1 (first (rt cards))) i1) (<= i1 (to_rep1 (last (rt cards))))) (= s__split_fields35 s__split_fields33)))
(assert (=> (not (and (<= (to_rep1 (first (rt cards))) i1) (<= i1 (to_rep1 (last (rt cards)))))) (= i5 (mk_int__ref i1))))
(assert (=> (not (and (<= (to_rep1 (first (rt cards))) i1) (<= i1 (to_rep1 (last (rt cards)))))) (= s__split_fields34 (mk___split_fields__ref s__split_fields39))))
(assert (=> (not (and (<= (to_rep1 (first (rt cards))) i1) (<= i1 (to_rep1 (last (rt cards)))))) (= i6 i1)))
(assert (=> (not (and (<= (to_rep1 (first (rt cards))) i1) (<= i1 (to_rep1 (last (rt cards)))))) (= s__split_fields35 s__split_fields39)))
(assert (= patience__playgame__result9 (mk_state__ref patience__playgame__result8)))
(assert (= patience__playgame__result10 patience__playgame__result8))
(assert (= result9 (mk_state__ref (mk___rep (mk___split_fields patience__playgame__result patience__playgame__result1 patience__playgame__result2 patience__playgame__result3 patience__playgame__result4 patience__playgame__result5 patience__playgame__result6 patience__playgame__result7)))))
(assert (= patience__playgame__result8 (mk___rep (us_split_fields__content s__split_fields34))))
...
(assert (= (mk___rep (mk___split_fields result10 result11 result12 result13 result14 result15 result16 result17)) (state__content patience__playgame__result11)))
(assert (not (= (inv (state__content patience__playgame__result11)) true)))
(check-sat)
(exit)
