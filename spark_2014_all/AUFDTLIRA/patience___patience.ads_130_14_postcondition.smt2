...
(declare-const result11 cardindex)
(declare-const result12 (Array Int card))
(declare-const result13 cardindex)
(declare-const result14 (Array Int cardindex))
(declare-const result15 (Array Int (Array Int cardindex)))
(declare-const result16 (Array Int cardindex))
(declare-const result17 (Array Int cardindex))
(declare-const result18 (Array Int cardindex))
(assert (= (to_rep2 o) 0))
(assert (= (to_rep2 o1) 0))
(assert (= o1 o2))
...
(assert (=> (and (<= (to_rep1 (first (rt cards))) i1) (<= i1 (to_rep1 (last (rt cards))))) (= temp___828 i1)))
(assert (=> (and (<= (to_rep1 (first (rt cards))) i1) (<= i1 (to_rep1 (last (rt cards))))) (and (= temp___827 s__split_fields8) (and (= temp___8271 s__split_fields9) (and (= temp___8272 s__split_fields10) (and (= temp___8273 s__split_fields11) (and (= temp___8274 s__split_fields12) (and (= temp___8275 s__split_fields13) (and (= temp___8276 s__split_fields14) (= temp___8277 s__split_fields15))))))))))
...
(assert (=> (and (<= (to_rep1 (first (rt cards))) i1) (<= i1 (to_rep1 (last (rt cards))))) (and (and (= (inv (mk___rep (mk___split_fields s__split_fields24 s__split_fields25 s__split_fields26 s__split_fields27 s__split_fields28 s__split_fields29 s__split_fields30 s__split_fields31))) true) (= (to_rep (select s__split_fields25 (to_rep2 s__split_fields16))) (to_rep (select (elts cards) i2)))) (= (to_rep2 s__split_fields24) (+ (to_rep2 s__split_fields16) 1)))))
(assert (=> (and (<= (to_rep1 (first (rt cards))) i1) (<= i1 (to_rep1 (last (rt cards))))) (= i2 (to_rep1 (last (rt cards))))))
(assert (=> (and (<= (to_rep1 (first (rt cards))) i1) (<= i1 (to_rep1 (last (rt cards))))) (= i4 (mk_int__ref i2))))
(assert (=> (and (<= (to_rep1 (first (rt cards))) i1) (<= i1 (to_rep1 (last (rt cards))))) (= s__split_fields32 (mk___split_fields__ref (mk___split_fields s__split_fields24 s__split_fields25 s__split_fields26 s__split_fields27 s__split_fields28 s__split_fields29 s__split_fields30 s__split_fields31)))))
(assert (=> (and (<= (to_rep1 (first (rt cards))) i1) (<= i1 (to_rep1 (last (rt cards))))) (= i5 i2)))
(assert (=> (and (<= (to_rep1 (first (rt cards))) i1) (<= i1 (to_rep1 (last (rt cards))))) (= s__split_fields33 (mk___split_fields s__split_fields24 s__split_fields25 s__split_fields26 s__split_fields27 s__split_fields28 s__split_fields29 s__split_fields30 s__split_fields31))))
...
(assert (=> (and (<= (to_rep1 (first (rt cards))) i1) (<= i1 (to_rep1 (last (rt cards))))) (= i7 i5)))
(assert (=> (and (<= (to_rep1 (first (rt cards))) i1) (<= i1 (to_rep1 (last (rt cards))))) (= s__split_fields35 s__split_fields33)))
(assert (=> (not (and (<= (to_rep1 (first (rt cards))) i1) (<= i1 (to_rep1 (last (rt cards)))))) (= i6 (mk_int__ref i1))))
(assert (=> (not (and (<= (to_rep1 (first (rt cards))) i1) (<= i1 (to_rep1 (last (rt cards)))))) (= s__split_fields34 (mk___split_fields__ref (mk___split_fields s__split_fields8 s__split_fields9 s__split_fields10 s__split_fields11 s__split_fields12 s__split_fields13 s__split_fields14 s__split_fields15)))))
(assert (=> (not (and (<= (to_rep1 (first (rt cards))) i1) (<= i1 (to_rep1 (last (rt cards)))))) (= i7 i1)))
(assert (=> (not (and (<= (to_rep1 (first (rt cards))) i1) (<= i1 (to_rep1 (last (rt cards)))))) (= s__split_fields35 (mk___split_fields s__split_fields8 s__split_fields9 s__split_fields10 s__split_fields11 s__split_fields12 s__split_fields13 s__split_fields14 s__split_fields15))))
...
(assert (= result10 (mk_state__ref (mk___rep (mk___split_fields patience__playgame__result patience__playgame__result1 patience__playgame__result2 patience__playgame__result3 patience__playgame__result4 patience__playgame__result5 patience__playgame__result6 patience__playgame__result7)))))
...
(assert (= (mk___rep (mk___split_fields result11 result12 result13 result14 result15 result16 result17 result18)) (state__content patience__playgame__result11)))
