...
(assert (and (= o30 (to_rep1 (rec__search_trees__search_tree__root t__split_fields8))) (in_range3 (to_rep1 (rec__search_trees__search_tree__root t__split_fields8)))))
(assert (not (= (valid_root (rec__search_trees__search_tree__struct t__split_fields8) o30) true)))
(check-sat)
(exit)
