...
(assert (not (= (inv (mk___rep (mk___split_fields s__split_fields16 s__split_fields17 s__split_fields18 s__split_fields19 s__split_fields20 s__split_fields21 s__split_fields22 s__split_fields23))) true)))
(check-sat)
(exit)
