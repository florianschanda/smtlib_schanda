...
(define-fun dynamic_invariant ((temp___expr_141 Int) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool (=> (or (= temp___is_init_138 true) (<= 1 8)) (in_range1 temp___expr_141)))
...
(declare-fun temp___339 ((Array Int integer) Int Int Int Int) (Array Int integer))
(assert (forall ((temp___341 (Array Int integer))) (forall ((temp___342 Int) (temp___343 Int) (temp___344 Int) (temp___345 Int)) (let ((temp___340 (temp___339 temp___341 temp___342 temp___343 temp___344 temp___345))) (forall ((temp___346 Int)) (ite (= temp___346 temp___344) (= (select temp___340 temp___346) (of_rep temp___345)) (ite (= temp___346 temp___342) (= (select temp___340 temp___346) (of_rep temp___343)) (= (select temp___340 temp___346) (select temp___341 temp___346)))))))))
...
(assert (not (= (bool_eq (temp___339 arrays__swap_fun__result4 i (to_rep (select arrays__swap_fun__result4 j)) j (to_rep (select arrays__swap_fun__result4 i))) 1 8 arr_in 1 8) true)))
(check-sat)
(exit)
