...
(assert (=> (= (to_rep1 (first (rt r))) (to_rep1 (first (rt a)))) (= result1 (ite (= (to_rep1 (last (rt r))) (to_rep1 (last (rt a)))) true false))))
(assert (=> (not (= (to_rep1 (first (rt r))) (to_rep1 (first (rt a))))) (= result1 false)))
(assert (=> (= result1 true) (and (<= (to_rep1 (first (rt r))) i) (<= i (to_rep1 (last (rt r)))))))
