...
(assert (and (= o9 (has_key (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields1))) (mk___rep1 (mk___split_fields1 c2)))) (= (= o9 true) (= (has_key (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields1))) (mk___rep1 (mk___split_fields1 c2))) true))))
(assert (= o10 true))
(assert (= result5 (ite (= o10 true) o9 false)))
(assert (= result5 true))
(assert (and (= o11 (key (mk___rep d__split_discrs (mk___split_fields d__split_fields1)) (mk___rep1 (mk___split_fields1 c2)))) (and (in_range3 o11) (= o11 (get (keys (mk___rep d__split_discrs (mk___split_fields d__split_fields1))) (get1 (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields1))) (mk___rep1 (mk___split_fields1 c2))))))))
(assert (= o12 (ite (= o11 k) true false)))
(assert (= result6 (ite (not (= o12 true)) true false)))
(assert (= result6 true))
(assert (and (= o13 (key (mk___rep d__split_discrs (mk___split_fields d__split_fields1)) (mk___rep1 (mk___split_fields1 c2)))) (and (in_range3 o13) (= o13 (get (keys (mk___rep d__split_discrs (mk___split_fields d__split_fields1))) (get1 (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields1))) (mk___rep1 (mk___split_fields1 c2))))))))
(assert (not (= (has_key (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields1))) (mk___rep1 (mk___split_fields1 c2))) true)))
(check-sat)
(exit)
