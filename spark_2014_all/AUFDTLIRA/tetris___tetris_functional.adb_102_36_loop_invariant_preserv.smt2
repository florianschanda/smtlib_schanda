...
(assert (=> (= result9 true) (and (= o1 (- to_line8 1)) (in_range9 (- to_line8 1)))))
...
(assert (not (= (+ (int__content num_deleted6) (int__content to_line12)) (+ num_deleted1 (int__content to_line6)))))
(check-sat)
(exit)
