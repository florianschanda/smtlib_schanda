...
(define-fun dynamic_invariant4 ((temp___expr_179 us_t) (temp___is_init_175 Bool) (temp___skip_constant_176 Bool) (temp___do_toplevel_177 Bool) (temp___do_typ_inv_178 Bool)) Bool (=> (not (= temp___skip_constant_176 true)) (dynamic_property 1 2147483647 (first1 temp___expr_179) (last1 temp___expr_179))))
...
(assert (=> (<= 1 (to_rep1 (rec__stack__stack__top (us_split_fields1 s)))) (and (and (<= (to_rep (first2 (rt1 (rec__stack__stack__content (us_split_fields1 s))))) 1) (<= 1 (to_rep (last2 (rt1 (rec__stack__stack__content (us_split_fields1 s))))))) (and (<= (to_rep (first2 (rt1 (rec__stack__stack__content (us_split_fields1 s))))) (to_rep1 (rec__stack__stack__top (us_split_fields1 s)))) (<= (to_rep1 (rec__stack__stack__top (us_split_fields1 s))) (to_rep (last2 (rt1 (rec__stack__stack__content (us_split_fields1 s))))))))))
(assert (= o (elts1 (rec__stack__stack__content (us_split_fields1 s)))))
(assert (= o temp___259))
(assert (= (mk2 1 (to_rep1 (rec__stack__stack__top (us_split_fields1 s)))) temp___2591))
(assert (not (dynamic_property 1 2147483647 (to_rep (first4 temp___2591)) (to_rep (last4 temp___2591)))))
(check-sat)
(exit)
