...
(define-fun bool_eq1 ((a (Array Int us_rep)) (a__first Int) (a__last Int) (b (Array Int us_rep)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_139 Int)) (=> (and (<= a__first temp___idx_139) (<= temp___idx_139 a__last)) (= (bool_eq (select a temp___idx_139) (select b (+ (- b__first a__first) temp___idx_139))) true)))) true false))
(assert (forall ((a (Array Int us_rep)) (b (Array Int us_rep))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq1 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_139 Int)) (=> (and (<= a__first temp___idx_139) (<= temp___idx_139 a__last)) (= (bool_eq (select a temp___idx_139) (select b (+ (- b__first a__first) temp___idx_139))) true))))))))
...
(define-fun dynamic_invariant1 ((temp___expr_540 us_rep1) (temp___is_init_537 Bool) (temp___skip_constant_538 Bool) (temp___do_toplevel_539 Bool)) Bool (forall ((temp___541 Int)) (=> (and (<= 1 temp___541) (<= temp___541 100)) (= (attr__constrained (select (rec__with_default__bad_nested_defaults2__non_init__e (us_split_fields1 temp___expr_540)) temp___541)) false))))
(define-fun default_initial_assumption ((temp___expr_543 us_rep1) (temp___skip_top_level_544 Bool)) Bool (forall ((temp___546 Int)) (=> (and (<= 1 temp___546) (<= temp___546 100)) (and (= (attr__constrained (select (rec__with_default__bad_nested_defaults2__non_init__e (us_split_fields1 temp___expr_543)) temp___546)) false) (= (to_rep1 (rec__with_default__bad_nested_defaults2__empty_rec__d (us_split_discrs1 (select (rec__with_default__bad_nested_defaults2__non_init__e (us_split_fields1 temp___expr_543)) temp___546)))) c)))))
