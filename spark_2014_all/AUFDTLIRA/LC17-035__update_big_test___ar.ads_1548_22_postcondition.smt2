...
(declare-fun temp___3189 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
(assert (forall ((temp___3191 (Array Int (Array Int et1)))) (forall ((temp___3192 Int)) (forall ((temp___3193 (Array Int et1))) (let ((temp___3190 (temp___3189 temp___3191 temp___3192 temp___3193))) (forall ((temp___3194 Int)) (ite (= temp___3194 temp___3192) (= (select temp___3190 temp___3194) temp___3193) (= (select temp___3190 temp___3194) (select temp___3191 temp___3194)))))))))
(declare-fun temp___3195 ((Array Int et1) Int Int Int Int) (Array Int et1))
(assert (forall ((temp___3197 (Array Int et1))) (forall ((temp___3198 Int) (temp___3199 Int) (temp___3200 Int) (temp___3201 Int)) (let ((temp___3196 (temp___3195 temp___3197 temp___3198 temp___3199 temp___3200 temp___3201))) (forall ((temp___3202 Int)) (ite (= temp___3202 temp___3200) (= (select temp___3196 temp___3202) (of_rep temp___3201)) (ite (= temp___3202 temp___3198) (= (select temp___3196 temp___3202) (of_rep temp___3199)) (= (select temp___3196 temp___3202) (select temp___3197 temp___3202)))))))))
(declare-fun temp___3205 ((Array Int (Array Int et1)) Int (Array Int et1) Int (Array Int et1)) (Array Int (Array Int et1)))
(assert (forall ((temp___3207 (Array Int (Array Int et1)))) (forall ((temp___3208 Int) (temp___3210 Int)) (forall ((temp___3209 (Array Int et1)) (temp___3211 (Array Int et1))) (let ((temp___3206 (temp___3205 temp___3207 temp___3208 temp___3209 temp___3210 temp___3211))) (forall ((temp___3212 Int)) (ite (= temp___3212 temp___3210) (= (select temp___3206 temp___3212) temp___3211) (ite (= temp___3212 temp___3208) (= (select temp___3206 temp___3212) temp___3209) (= (select temp___3206 temp___3212) (select temp___3207 temp___3212))))))))))
(declare-fun temp___3213 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___3215 (Array Int et1))) (forall ((temp___3216 Int) (temp___3217 Int)) (let ((temp___3214 (temp___3213 temp___3215 temp___3216 temp___3217))) (forall ((temp___3218 Int)) (ite (= temp___3218 temp___3216) (= (select temp___3214 temp___3218) (of_rep temp___3217)) (= (select temp___3214 temp___3218) (select temp___3215 temp___3218))))))))
(declare-fun temp___3220 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___3222 (Array Int et1))) (forall ((temp___3223 Int) (temp___3224 Int)) (let ((temp___3221 (temp___3220 temp___3222 temp___3223 temp___3224))) (forall ((temp___3225 Int)) (ite (= temp___3225 temp___3223) (= (select temp___3221 temp___3225) (of_rep temp___3224)) (= (select temp___3221 temp___3225) (select temp___3222 temp___3225))))))))
...
(assert (not (= i1 i2)))
(assert (not (= (bool_eq2 (mk___rep (mk___split_fields r__split_fields6 r__split_fields7)) (mk___rep (mk___split_fields (temp___3205 r__split_fields i1 (temp___3213 (select r__split_fields i1) j1 e) i2 (temp___3220 (select r__split_fields i2) j2 f)) r__split_fields1))) true)))
(check-sat)
(exit)
