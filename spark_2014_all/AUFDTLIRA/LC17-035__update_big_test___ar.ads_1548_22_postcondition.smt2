...
(assert (not (= i1 i2)))
(assert (not (= (bool_eq2 (mk___rep (mk___split_fields r__split_fields6 r__split_fields7)) (mk___rep (mk___split_fields (temp___3264 r__split_fields i1 (temp___3272 (select r__split_fields i1) j1 e) i2 (temp___3279 (select r__split_fields i2) j2 f)) r__split_fields1))) true)))
(check-sat)
(exit)
