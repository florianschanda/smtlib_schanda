...
(assert (=> (= result39 true) (and (= o120 (+ j5 1)) (in_range1 (+ j5 1)))))
(assert (=> (= result39 true) (and (= o121 (get (rec__list_allocator__m__t__allocated model____split_fields4) o120)) (in_range7 o121))))
(assert (=> (not (= result39 true)) (= o121 0)))
(assert (not (<= 1 j5)))
(check-sat)
(exit)
