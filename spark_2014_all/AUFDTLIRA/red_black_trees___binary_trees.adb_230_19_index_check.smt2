...
(assert (= o36 temp___599))
(assert (= o37 (select r3 o36)))
(assert (= o38 (us_split_fields1 o37)))
(assert (= o39 (rec__tree_model__path_type__a o38)))
(assert (and (= o40 (add o39 0)) (and (= (length o40) (+ (length o39) 1)) (and (= (get o40 (last o40)) 0) (= (ole o39 o40) true)))))
(assert (= o41 (mk___split_fields o40 (rec__tree_model__path_type__k (us_split_fields1 (select r3 j8))))))
(assert (= temp___601 (mk___rep o41)))
(assert (< (length (rec__tree_model__path_type__a (us_split_fields1 temp___601))) 100))
(assert (= o42 temp___601))
(assert (not (<= 1 j8)))
(check-sat)
(exit)
