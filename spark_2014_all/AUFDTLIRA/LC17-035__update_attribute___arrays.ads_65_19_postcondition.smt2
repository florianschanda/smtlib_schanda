...
(declare-fun temp___326 ((Array Int integer) Int Int Int Int) (Array Int integer))
(assert (forall ((temp___328 (Array Int integer))) (forall ((temp___329 Int) (temp___330 Int) (temp___331 Int) (temp___332 Int)) (let ((temp___327 (temp___326 temp___328 temp___329 temp___330 temp___331 temp___332))) (forall ((temp___333 Int)) (ite (= temp___333 temp___331) (= (select temp___327 temp___333) (of_rep temp___332)) (ite (= temp___333 temp___329) (= (select temp___327 temp___333) (of_rep temp___330)) (= (select temp___327 temp___333) (select temp___328 temp___333)))))))))
...
(assert (= tmp3 tmp1))
(assert (= a4 a2))
(assert (not (= (bool_eq a3 1 8 (temp___326 a i (to_rep (select a j)) j (to_rep (select a i))) 1 8) true)))
(check-sat)
(exit)
