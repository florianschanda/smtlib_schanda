...
(assert (and (and (= (bool_eq1 a 5 50 (temp___4750 t j (temp___4756 (select t j) i e)) 5 50) true) (or (and (= j 50) (= j_next1 5)) (and (< j 50) (= j_next1 (+ j 1))))) (in_range2 j_next1)))
