...
(assert (= aux3 aux1))
(assert (= v4 v2))
(assert (not (= (let ((temp___195 (temp___161 (mk___t v (mk (to_rep v__first) (to_rep v__last))) i (to_rep (select v j)) j (to_rep (select v i))))) (bool_eq v3 (to_rep v__first) (to_rep v__last) (elts temp___195) (to_rep (first (rt temp___195))) (to_rep (last (rt temp___195))))) true)))
(check-sat)
(exit)
