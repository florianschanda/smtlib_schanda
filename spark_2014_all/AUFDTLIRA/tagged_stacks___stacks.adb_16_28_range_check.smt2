...
(assert (forall ((s us_rep)) (! (let ((result (get_model__2 s))) (and (and (= (length result) (size s)) (and (in_range1 (last1 result)) (in_range1 (first1 result)))) (dynamic_invariant4 result true false true true))) :pattern ((get_model__2 s)))))
(assert (forall ((attr__tag2 Int)) (forall ((s us_rep)) (! (let ((result (get_model__21 attr__tag2 s))) (and (and (= (length result) (size s)) (and (in_range1 (last1 result)) (in_range1 (first1 result)))) (dynamic_invariant4 result true false true true))) :pattern ((get_model__21 attr__tag2 s))))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range4 f) (=> (in_range4 l) (and (= (to_rep2 (first4 (mk2 f l))) f) (= (to_rep2 (last4 (mk2 f l))) l)))) :pattern ((mk2 f l)))))
(define-fun dynamic_property3 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range4 low) (and (in_range4 high) (=> (<= low high) (and (in_range3 low) (in_range3 high))))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range4 f) (=> (in_range4 l) (and (= (to_rep2 (first10 (mk5 f l))) f) (= (to_rep2 (last12 (mk5 f l))) l)))) :pattern ((mk5 f l)))))
(define-fun dynamic_property9 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range4 low) (and (in_range4 high) (=> (<= low high) (and (dynamic_property8 range_first range_last low) (dynamic_property8 range_first range_last high))))))
...
(assert (forall ((s us_rep1)) (! (dynamic_invariant3 (last6 s) true false true true) :pattern ((last6 s)))))
(assert (forall ((attr__tag2 Int)) (forall ((s us_rep1)) (! (dynamic_invariant3 (last7 attr__tag2 s) true false true true) :pattern ((last7 attr__tag2 s))))))
(assert (forall ((s us_rep1)) (! (= (last6 s) (last7 us_tag2 s)) :pattern ((last7 us_tag2 s)))))
(assert (forall ((s us_rep1)) (! (= (last6 s) (ite (not (= (wraps_around s) true)) (- (+ (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))) (to_rep (rec__stacks__stack_root__length1 (us_split_fields3 s)))) 1) (- (- (+ (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))) (to_rep (rec__stacks__stack_root__length1 (us_split_fields3 s)))) 1) 100))) :pattern ((last6 s)))))
...
(assert (not (in_range1 (+ (to_rep s__split_fields1) 1))))
(check-sat)
(exit)
