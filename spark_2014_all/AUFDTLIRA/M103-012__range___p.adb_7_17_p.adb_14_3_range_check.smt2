...
(declare-datatypes () ((b__ref (mk_b__ref (b__content us_t)))))
(define-fun b__ref___projection ((a b__ref)) us_t (b__content a))
(declare-sort tTtSP1 0)
(define-fun in_range2 ((x Int)) Bool (and (<= (- 10) x) (<= x 1000)))
(declare-fun attr__ATTRIBUTE_IMAGE2 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check2 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE2 (us_image) Int)
(declare-fun user_eq3 (tTtSP1 tTtSP1) Bool)
(declare-const dummy3 tTtSP1)
(declare-datatypes () ((tTtSP1__ref (mk_tTtSP1__ref (tTtSP1__content tTtSP1)))))
(define-fun tTtSP1__ref___projection ((a tTtSP1__ref)) tTtSP1 (tTtSP1__content a))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const c9b (Array Int integer))
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const y__first integer)
(declare-const y__last integer)
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(declare-fun p__t__aggregate_def (Int) (Array Int integer))
(assert (forall ((temp___198 Int)) (forall ((temp___199 Int)) (= (select (p__t__aggregate_def temp___198) temp___199) (of_rep temp___198)))))
...
(define-fun dynamic_invariant2 ((temp___expr_177 us_t) (temp___is_init_174 Bool) (temp___skip_constant_175 Bool) (temp___do_toplevel_176 Bool)) Bool (=> (not (= temp___skip_constant_175 true)) (dynamic_property 1 2147483647 (first1 temp___expr_177) (last1 temp___expr_177))))
(declare-const t1 (Array Int integer))
(declare-const result (Array Int integer))
(declare-const t2 (Array Int integer))
(assert (= result t1))
(assert (= t2 (p__t__aggregate_def 0)))
(assert (= t2 c9b))
(assert (not (dynamic_property 1 2147483647 (- 10) 1000)))
(check-sat)
(exit)
