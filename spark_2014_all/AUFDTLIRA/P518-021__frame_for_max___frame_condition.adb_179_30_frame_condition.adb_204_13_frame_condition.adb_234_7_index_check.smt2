...
(assert (= o39 (mk___split_fields (rec__frame_condition__cell__value (us_split_fields1 (select (map__content a5) c204b1))) (rec__frame_condition__cell__max_left (us_split_fields1 (select (map__content a5) c204b1))) o38)))
