...
(assert (not (= 1 0)))
(assert (= (to_rep o75) c205b2))
(assert (= o76 (mk___split_fields (rec__frame_condition__cell__value (us_split_fields1 (select (map__content a7) c204b2))) (rec__frame_condition__cell__max_left (us_split_fields1 (select (map__content a7) c204b2))) o75)))
(assert (= o77 (mk___rep o76)))
