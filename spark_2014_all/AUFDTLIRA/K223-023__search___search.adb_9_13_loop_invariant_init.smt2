...
(assert (<= 1 i1))
(assert (<= i1 10))
(assert (not (or (and (= pos1 0) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 (- i1 1))) (not (= (to_rep (select t j2)) v))))) (and (= (to_rep (select t pos1)) v) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 (- pos1 1))) (not (= (to_rep (select t j2)) v))))))))
(check-sat)
(exit)
