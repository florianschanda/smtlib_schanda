...
(declare-fun temp___500 ((Array Int integer) Int Int) (Array Int integer))
(assert (forall ((temp___502 (Array Int integer))) (forall ((temp___503 Int) (temp___504 Int)) (let ((temp___501 (temp___500 temp___502 temp___503 temp___504))) (forall ((temp___505 Int)) (ite (= temp___505 temp___503) (= (select temp___501 temp___505) (of_rep temp___504)) (= (select temp___501 temp___505) (select temp___502 temp___505))))))))
(declare-fun temp___507 ((Array Int integer) Int Int) (Array Int integer))
(assert (forall ((temp___509 (Array Int integer))) (forall ((temp___510 Int) (temp___511 Int)) (let ((temp___508 (temp___507 temp___509 temp___510 temp___511))) (forall ((temp___512 Int)) (ite (= temp___512 temp___510) (= (select temp___508 temp___512) (of_rep temp___511)) (= (select temp___508 temp___512) (select temp___509 temp___512))))))))
(assert (in_range1 i))
...
(assert (= (bool_eq d (- 2147483648) 2147483647 (temp___507 c i 42) (- 2147483648) 2147483647) true))
...
(assert (not (= (to_rep (select e i)) (to_rep (select (temp___500 f i 42) i)))))
(check-sat)
(exit)
