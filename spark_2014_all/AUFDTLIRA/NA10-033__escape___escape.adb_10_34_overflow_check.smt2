...
(assert (<= (to_rep1 (first (rt s))) i2))
(assert (<= i2 (to_rep1 (last (rt s)))))
(assert (and (=> (<= 0 2147483647) (in_range4 count_bs2)) (and (<= (to_rep1 (first (rt s))) i3) (<= i3 (to_rep1 (last (rt s)))))))
(assert (= (to_rep (select (elts s) i3)) 92))
