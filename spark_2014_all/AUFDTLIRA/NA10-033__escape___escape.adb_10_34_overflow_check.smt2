...
(define-fun dynamic_invariant3 ((temp___expr_172 us_t1) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool) (temp___do_typ_inv_171 Bool)) Bool (=> (not (= temp___skip_constant_169 true)) (and (dynamic_property2 1 len (first3 temp___expr_172) (last3 temp___expr_172)) (and (= (first3 temp___expr_172) 1) (= (last3 temp___expr_172) len)))))
...
(assert (<= (to_rep1 (first (rt s))) i1))
(assert (<= i1 (to_rep1 (last (rt s)))))
(assert (and (=> (<= 0 2147483647) (in_range4 count_bs2)) (and (<= (to_rep1 (first (rt s))) i2) (<= i2 (to_rep1 (last (rt s)))))))
(assert (= (to_rep (select (elts s) i2)) 92))
(assert (not (in_range1 (+ count_bs2 1))))
(check-sat)
(exit)
