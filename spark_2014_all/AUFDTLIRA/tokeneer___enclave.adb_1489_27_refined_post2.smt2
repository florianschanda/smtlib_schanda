...
(declare-const idcert__split_fields us_split_fields__ref5)
...
(assert (in_range14 tokenpresence))
...
(assert (and (= o1 (adminhasdeparted status tokenpresence state tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content5 idcert__split_fields))) (= (= o1 true) (and (not (= (ispresent tokenpresence state tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content5 idcert__split_fields)) true)) (in_range18 status)))))
