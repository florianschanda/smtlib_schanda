...
(assert (and (= o50 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (= o51 (ite (<= o50 i) true false)))
(assert (= result5 (ite (= o51 true) (ite (<= i index3) true false) false)))
(assert (= result5 true))
