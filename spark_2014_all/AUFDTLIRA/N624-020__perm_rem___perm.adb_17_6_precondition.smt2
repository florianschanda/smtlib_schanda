...
(assert (and (= (mk___t o40 o41) (remove a ia)) (and (dynamic_invariant1 (mk___t o40 o41) true false true) (and (= (invariant__ (mk___t o40 o41)) true) (and (= (to_rep1 (last o41)) (- (to_rep1 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ia 1))) (= (to_rep (select (elts a) k)) (to_rep (select o40 k))))) (and (forall ((k Int)) (=> (and (<= (+ ia 1) k) (<= k (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select o40 (- k 1)))))) (forall ((k Int)) (=> (and (<= ia k) (<= k (- (to_rep1 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select o40 k))))))))))))
(assert (not (= (invariant__ (mk___t o40 o41)) true)))
(check-sat)
(exit)
