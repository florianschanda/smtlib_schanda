...
(assert (= result8 true))
(assert (and (= o28 (remove b (int__content perm__get_witness__result9))) (and (dynamic_invariant1 o28 true false true) (and (= (invariant__ o28) true) (and (= (to_rep1 (last o21)) (- (to_rep1 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- (int__content perm__get_witness__result9) 1))) (= (to_rep (select (elts b) k)) (to_rep (select o20 k))))) (and (forall ((k Int)) (=> (and (<= (+ (int__content perm__get_witness__result9) 1) k) (<= k (to_rep1 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select o20 (- k 1)))))) (forall ((k Int)) (=> (and (<= (int__content perm__get_witness__result9) k) (<= k (- (to_rep1 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o20 k))))))))))))
(assert (and (= o29 (remove a ia)) (and (dynamic_invariant1 o29 true false true) (and (= (invariant__ o29) true) (and (= (to_rep1 (last o19)) (- (to_rep1 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ia 1))) (= (to_rep (select (elts a) k)) (to_rep (select o18 k))))) (and (forall ((k Int)) (=> (and (<= (+ ia 1) k) (<= k (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select o18 (- k 1)))))) (forall ((k Int)) (=> (and (<= ia k) (<= k (- (to_rep1 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select o18 k))))))))))))
