...
(define-fun dynamic_invariant4 ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_136)))
(declare-const o Int)
...
(declare-const o4 (Array Int t))
(declare-const temp___174 (Array Int t))
(declare-const temp___1741 t2)
(declare-const o5 (Array Int t))
(declare-const o6 t1)
(declare-const us Bool)
(declare-const result Bool)
(declare-const result1 Bool)
(assert (dynamic_invariant1 a true false true))
(assert (in_range2 size_a))
(assert (dynamic_invariant1 b true false true))
(assert (in_range2 size_b))
(assert (and (<= size_a (length a)) (<= size_b (length b))))
(assert (and (= o2 (- size_a size_b)) (in_range1 (- size_a size_b))))
(assert (= o3 (ite (<= i o2) true false)))
(assert (= result1 (ite (<= 0 i) o3 false)))
(assert (= result1 true))
(assert (not (in_range1 (+ (to_rep (first (rt a))) i))))
(check-sat)
(exit)
