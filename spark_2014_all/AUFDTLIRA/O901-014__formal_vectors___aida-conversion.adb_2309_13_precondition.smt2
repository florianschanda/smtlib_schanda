...
(assert (and (<= (length source) 10) (and (<= 2 (length source)) (and (= (to_rep (select (elts source) (to_rep1 (first (rt source))))) 45) (forall ((index1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) index1) (<= index1 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index1))) true)))))))
