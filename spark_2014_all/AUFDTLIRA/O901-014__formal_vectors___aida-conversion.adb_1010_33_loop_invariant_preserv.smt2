...
(assert (and (and (forall ((temp___1708 Int)) (=> (and (<= (to_rep1 n__first) temp___1708) (<= temp___1708 (to_rep1 n__last))) (=> (< index3 temp___1708) (= (select n3 temp___1708) (select n1 temp___1708))))) (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 3)) (dynamic_property5 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 3) index3))) (and (<= (to_rep1 (first (rt source))) index3) (<= index3 (+ (to_rep1 (first (rt source))) 3)))))
(assert (not (= index3 temp___1711)))
