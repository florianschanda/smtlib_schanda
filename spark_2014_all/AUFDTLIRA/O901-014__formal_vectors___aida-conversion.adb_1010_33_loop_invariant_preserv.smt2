...
(assert (and (= (length source) 4) (forall ((index4 Int)) (=> (and (<= (to_rep1 (first (rt source))) index4) (<= index4 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index4))) true)))))
...
(assert (and (and (forall ((temp___1810 Int)) (=> (and (<= (to_rep1 n__first) temp___1810) (<= temp___1810 (to_rep1 n__last))) (=> (< index2 temp___1810) (= (select n3 temp___1810) (select n1 temp___1810))))) (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 3)) (dynamic_property5 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 3) index2))) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (+ (to_rep1 (first (rt source))) 3)))))
(assert (not (= index2 temp___1813)))
