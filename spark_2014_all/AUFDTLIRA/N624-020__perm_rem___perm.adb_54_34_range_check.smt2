...
(assert (and (= o9 (remove b o)) (and (dynamic_invariant o9 true false true true) (and (= (invariant__ o9) true) (and (= (to_rep2 (last o2)) (- (to_rep2 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o 1))) (= (to_rep (select (elts b) k)) (to_rep (select o1 k))))) (and (forall ((k Int)) (=> (and (<= (+ o 1) k) (<= k (to_rep2 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select o1 (- k 1)))))) (forall ((k Int)) (=> (and (<= o k) (<= k (- (to_rep2 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o1 k))))))))))))
(assert (not (in_range2 ia1)))
(check-sat)
(exit)
