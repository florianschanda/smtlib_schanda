...
(assert (forall ((temp___134 Int) (temp___135 Int) (temp___136 Int) (temp___137 Int) (temp___138 Int) (temp___139 Int) (temp___140 Int) (temp___141 Int) (temp___142 Int) (temp___143 Int)) (let ((temp___133 (prime_search__primes__aggregate_def temp___134 temp___135 temp___136 temp___137 temp___138 temp___139 temp___140 temp___141 temp___142 temp___143))) (and (and (and (and (and (and (and (and (and (= (select temp___133 1) (of_rep temp___134)) (= (select temp___133 2) (of_rep temp___135))) (= (select temp___133 3) (of_rep temp___136))) (= (select temp___133 4) (of_rep temp___137))) (= (select temp___133 5) (of_rep temp___138))) (= (select temp___133 6) (of_rep temp___139))) (= (select temp___133 7) (of_rep temp___140))) (= (select temp___133 8) (of_rep temp___141))) (= (select temp___133 9) (of_rep temp___142))) (= (select temp___133 10) (of_rep temp___143))))))
...
(define-fun dynamic_invariant2 ((temp___expr_169 Int) (temp___is_init_166 Bool) (temp___skip_constant_167 Bool) (temp___do_toplevel_168 Bool)) Bool (=> (or (= temp___is_init_166 true) (<= 1 10)) (in_range4 temp___expr_169)))
...
(assert (<= (+ i1 1) j1))
(assert (<= j1 10))
(assert (not (< (to_rep (select primes i1)) (to_rep (select primes j1)))))
(check-sat)
(exit)
