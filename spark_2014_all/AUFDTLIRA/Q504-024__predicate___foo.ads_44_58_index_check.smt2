...
(assert (forall ((temp___156 Int) (temp___157 Int)) (let ((temp___155 (foo__cpu_lsid_last__aggregate_def temp___156 temp___157))) (=> (and (dynamic_invariant3 temp___156 true true true true) (dynamic_invariant3 temp___157 true true true true)) (and (= (to_rep2 (select temp___155 0)) temp___156) (= (to_rep2 (select temp___155 1)) temp___157))))))
