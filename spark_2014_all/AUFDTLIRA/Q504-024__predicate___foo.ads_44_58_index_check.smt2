...
(assert (forall ((a (Array Int natural)) (b (Array Int natural))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_137 Int)) (=> (and (<= a__first temp___idx_137) (<= temp___idx_137 a__last)) (= (to_rep (select a temp___idx_137)) (to_rep (select b (+ (- b__first a__first) temp___idx_137)))))))))))
...
(declare-fun concat2 ((Array Int max_lsid_type) Int Int (Array Int max_lsid_type) Int Int) (Array Int max_lsid_type))
...
(assert (forall ((v max_lsid_type)) (forall ((i Int)) (! (= (select (singleton2 v i) i) v) :pattern ((select (singleton2 v i) i))))))
(define-fun bool_eq5 ((a (Array Int max_lsid_type)) (a__first Int) (a__last Int) (b (Array Int max_lsid_type)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_132 Int)) (=> (and (<= a__first temp___idx_132) (<= temp___idx_132 a__last)) (= (to_rep2 (select a temp___idx_132)) (to_rep2 (select b (+ (- b__first a__first) temp___idx_132))))))) true false))
(assert (forall ((a (Array Int max_lsid_type)) (b (Array Int max_lsid_type))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq5 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_132 Int)) (=> (and (<= a__first temp___idx_132) (<= temp___idx_132 a__last)) (= (to_rep2 (select a temp___idx_132)) (to_rep2 (select b (+ (- b__first a__first) temp___idx_132)))))))))))
(declare-fun compare1 ((Array Int max_lsid_type) Int Int (Array Int max_lsid_type) Int Int) Int)
(assert (forall ((a (Array Int max_lsid_type)) (b (Array Int max_lsid_type))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare1 a a_first a_last b b_first b_last) 0) (= (bool_eq5 a a_first a_last b b_first b_last) true)) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int max_lsid_type)) (b (Array Int max_lsid_type))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare1 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq5 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep2 (select a (+ i 1))) (to_rep2 (select b (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int max_lsid_type)) (b (Array Int max_lsid_type))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare1 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq5 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep2 (select b (+ i 1))) (to_rep2 (select a (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(declare-const cpu_lsid_last (Array Int max_lsid_type))
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(define-fun dynamic_invariant1 ((temp___expr_184 us_rep1) (temp___is_init_181 Bool) (temp___skip_constant_182 Bool) (temp___do_toplevel_183 Bool)) Bool (and (=> (not (= temp___skip_constant_182 true)) (in_range4 (to_rep2 (select cpu_lsid_last cpu_id)) (to_base temp___expr_184))) (and (dynamic_property1 0 (to_rep2 (select cpu_lsid_last cpu_id)) (first1 (rec__foo__subject_state__states1 (us_split_fields3 temp___expr_184))) (last1 (rec__foo__subject_state__states1 (us_split_fields3 temp___expr_184)))) (and (= (first1 (rec__foo__subject_state__states1 (us_split_fields3 temp___expr_184))) 0) (= (last1 (rec__foo__subject_state__states1 (us_split_fields3 temp___expr_184))) (to_rep2 (select cpu_lsid_last cpu_id)))))))
(define-fun default_initial_assumption ((temp___expr_187 us_rep1) (temp___skip_top_level_188 Bool)) Bool (= (to_rep2 (rec__foo__subject_state__max_id (us_split_discrs2 temp___expr_187))) (to_rep2 (select cpu_lsid_last cpu_id))))
...
(define-fun dynamic_invariant3 ((temp___expr_149 Int) (temp___is_init_146 Bool) (temp___skip_constant_147 Bool) (temp___do_toplevel_148 Bool)) Bool (=> (or (= temp___is_init_146 true) (<= 0 5)) (in_range3 temp___expr_149)))
(declare-fun foo__cpu_lsid_last__aggregate_def (Int Int) (Array Int max_lsid_type))
(assert (forall ((temp___134 Int) (temp___135 Int)) (let ((temp___133 (foo__cpu_lsid_last__aggregate_def temp___134 temp___135))) (and (= (select temp___133 0) (of_rep2 temp___134)) (= (select temp___133 1) (of_rep2 temp___135))))))
(assert (= cpu_lsid_last (foo__cpu_lsid_last__aggregate_def 3 4)))
(define-fun dynamic_invariant4 ((temp___expr_178 us_rep) (temp___is_init_175 Bool) (temp___skip_constant_176 Bool) (temp___do_toplevel_177 Bool)) Bool (let ((temp___179 (rec__foo__subject_state__max_id (us_split_discrs1 temp___expr_178)))) (and (dynamic_property3 0 (to_rep2 temp___179) (first3 (rec__foo__subject_state__states (us_split_fields1 temp___expr_178))) (last3 (rec__foo__subject_state__states (us_split_fields1 temp___expr_178)))) (and (= (first3 (rec__foo__subject_state__states (us_split_fields1 temp___expr_178))) 0) (= (last3 (rec__foo__subject_state__states (us_split_fields1 temp___expr_178))) (to_rep2 temp___179))))))
(declare-const states__split_fields (Array Int natural))
(declare-const states__split_fields1 t)
(assert (in_range1 cpu_id))
(assert (dynamic_invariant1 (mk___rep1 states__split_discrs (mk___split_fields1 (mk___t states__split_fields states__split_fields1))) true false true))
