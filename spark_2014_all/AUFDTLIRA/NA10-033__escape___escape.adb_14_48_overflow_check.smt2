...
(assert (=> (and (<= (to_rep1 (first (rt s))) i1) (<= i1 (to_rep1 (last (rt s))))) (= temp___178 count_bs1)))
(assert (=> (and (<= (to_rep1 (first (rt s))) i1) (<= i1 (to_rep1 (last (rt s))))) (and (=> (<= 0 2147483647) (in_range4 count_bs2)) (and (<= (to_rep1 (first (rt s))) i2) (<= i2 (to_rep1 (last (rt s))))))))
(assert (=> (and (<= (to_rep1 (first (rt s))) i1) (<= i1 (to_rep1 (last (rt s))))) (=> (= (to_rep (select (elts s) i2)) 92) (and (= o (+ count_bs2 1)) (in_range1 (+ count_bs2 1))))))
(assert (=> (and (<= (to_rep1 (first (rt s))) i1) (<= i1 (to_rep1 (last (rt s))))) (=> (= (to_rep (select (elts s) i2)) 92) (= count_bs2 result2))))
(assert (=> (and (<= (to_rep1 (first (rt s))) i1) (<= i1 (to_rep1 (last (rt s))))) (=> (= (to_rep (select (elts s) i2)) 92) (= count_bs3 o))))
(assert (=> (and (<= (to_rep1 (first (rt s))) i1) (<= i1 (to_rep1 (last (rt s))))) (=> (not (= (to_rep (select (elts s) i2)) 92)) (= count_bs3 count_bs2))))
(assert (=> (and (<= (to_rep1 (first (rt s))) i1) (<= i1 (to_rep1 (last (rt s))))) (= i2 (to_rep1 (last (rt s))))))
(assert (=> (and (<= (to_rep1 (first (rt s))) i1) (<= i1 (to_rep1 (last (rt s))))) (= i2 i3)))
(assert (=> (and (<= (to_rep1 (first (rt s))) i1) (<= i1 (to_rep1 (last (rt s))))) (= count_bs3 count_bs4)))
(assert (=> (and (<= (to_rep1 (first (rt s))) i1) (<= i1 (to_rep1 (last (rt s))))) (= i4 i2)))
(assert (=> (and (<= (to_rep1 (first (rt s))) i1) (<= i1 (to_rep1 (last (rt s))))) (= count_bs5 count_bs3)))
(assert (=> (and (<= (to_rep1 (first (rt s))) i1) (<= i1 (to_rep1 (last (rt s))))) (= (mk_int__ref i5) (mk_int__ref i3))))
(assert (=> (and (<= (to_rep1 (first (rt s))) i1) (<= i1 (to_rep1 (last (rt s))))) (= (mk_int__ref count_bs6) (mk_int__ref count_bs4))))
(assert (=> (and (<= (to_rep1 (first (rt s))) i1) (<= i1 (to_rep1 (last (rt s))))) (= i6 i4)))
(assert (=> (and (<= (to_rep1 (first (rt s))) i1) (<= i1 (to_rep1 (last (rt s))))) (= count_bs7 count_bs5)))
(assert (=> (not (and (<= (to_rep1 (first (rt s))) i1) (<= i1 (to_rep1 (last (rt s)))))) (= i1 i5)))
(assert (=> (not (and (<= (to_rep1 (first (rt s))) i1) (<= i1 (to_rep1 (last (rt s)))))) (= count_bs1 count_bs6)))
(assert (=> (not (and (<= (to_rep1 (first (rt s))) i1) (<= i1 (to_rep1 (last (rt s)))))) (= i6 i1)))
(assert (=> (not (and (<= (to_rep1 (first (rt s))) i1) (<= i1 (to_rep1 (last (rt s)))))) (= count_bs7 count_bs1)))
