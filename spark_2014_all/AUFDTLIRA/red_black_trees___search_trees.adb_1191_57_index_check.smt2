...
(assert (and (= temp___672 (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o19)) (and (dynamic_invariant9 temp___672 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___672 o19))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___672 o19)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 o19)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___672 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___672 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___672 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___672 i1))) true) (not (= i1 o19))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___672 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))) (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___672 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___672 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___672 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___672 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___672 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___672 j)))) true)) (= j i1))))))))))))))
(assert (= (mk___rep (mk___split_fields o20 o21)) (select temp___672 i)))
(assert (= o20 o22))
(assert (= o21 o23))
(assert (= o24 o22))
