...
(assert (forall ((c9 us_rep1)) (=> (= (has_key1 (positions (mk___rep d__split_discrs d__split_fields2)) c9) true) (= (to_rep (select a1 (element (mk___rep d__split_discrs d__split_fields2) c9))) (key (mk___rep d__split_discrs d__split_fields2) c9)))))
