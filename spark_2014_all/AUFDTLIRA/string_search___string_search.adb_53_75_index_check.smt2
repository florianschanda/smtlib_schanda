...
(assert (and (= o5 (length needle)) (in_range1 (length needle))))
(assert (= o6 (- o5 j1)))
...
(assert (= o12 (store bad_shift1 (to_rep1 (select (elts needle) j1)) o11)))
(assert (= bad_shift1 result2))
(assert (= bad_shift2 o12))
(assert (forall ((c4 Int)) (=> (and (<= 0 c4) (<= c4 255)) (and (<= 1 (to_rep (select bad_shift3 c4))) (<= (to_rep (select bad_shift3 c4)) (+ (length needle) 1))))))
(assert (forall ((c4 Int)) (=> (and (<= 0 c4) (<= c4 255)) (ite (= (to_rep (select bad_shift3 c4)) (+ (length needle) 1)) (forall ((k4 Int)) (=> (and (<= 1 k4) (<= k4 j2)) (not (= c4 (to_rep1 (select (elts needle) k4)))))) (and (= (to_rep1 (select (elts needle) (+ (- (length needle) (to_rep (select bad_shift3 c4))) 1))) c4) (forall ((k4 Int)) (=> (and (<= (+ (- (length needle) (to_rep (select bad_shift3 c4))) 2) k4) (<= k4 j2)) (not (= (to_rep1 (select (elts needle) k4)) c4)))))))))
...
(assert (= result3 (ite (= (to_rep (select bad_shift3 c1)) o18) true false)))
(assert (not (= result3 true)))
(assert (and (= o22 (length needle)) (in_range1 (length needle))))
(assert (= o23 (- o22 (to_rep (select bad_shift3 c1)))))
(assert (= o24 (+ o23 2)))
(assert (and (= o25 o24) (in_range1 o24)))
(assert (= o26 (ite (<= o25 k1) true false)))
(assert (= result4 (ite (= o26 true) (ite (<= k1 j2) true false) false)))
(assert (= (= o27 true) (forall ((k4 Int)) (=> (and (<= (+ (- (length needle) (to_rep (select bad_shift3 c1))) 2) k4) (<= k4 j2)) (not (= (to_rep1 (select (elts needle) k4)) c1))))))
(assert (and (= o19 (length needle)) (in_range1 (length needle))))
(assert (= o20 (- o19 (to_rep (select bad_shift3 c1)))))
(assert (= o21 (+ o20 1)))
(assert (and (= temp___290 o21) (in_range1 o21)))
(assert (not (<= (to_rep2 (first (rt needle))) temp___290)))
(check-sat)
(exit)
