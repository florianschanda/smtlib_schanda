...
(assert (forall ((c1 Int)) (=> (and (<= 0 c1) (<= c1 255)) (ite (= (to_rep (select bad_shift3 c1)) (+ (length needle) 1)) (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 j2)) (not (= c1 (to_rep1 (select (elts needle) k1)))))) (and (= (to_rep1 (select (elts needle) (+ (- (length needle) (to_rep (select bad_shift3 c1))) 1))) c1) (forall ((k1 Int)) (=> (and (<= (+ (- (length needle) (to_rep (select bad_shift3 c1))) 2) k1) (<= k1 j2)) (not (= (to_rep1 (select (elts needle) k1)) c1)))))))))
...
(assert (= result3 (ite (= (to_rep (select bad_shift3 c)) o14) true false)))
(assert (not (= result3 true)))
(assert (and (= o18 (length needle)) (in_range1 (length needle))))
(assert (= o19 (- o18 (to_rep (select bad_shift3 c)))))
(assert (= o20 (+ o19 2)))
(assert (and (= o21 o20) (in_range1 o20)))
(assert (= o22 (ite (<= o21 k) true false)))
(assert (= result4 (ite (= o22 true) (ite (<= k j2) true false) false)))
(assert (= (= o23 true) (forall ((k1 Int)) (=> (and (<= (+ (- (length needle) (to_rep (select bad_shift3 c))) 2) k1) (<= k1 j2)) (not (= (to_rep1 (select (elts needle) k1)) c))))))
(assert (and (= o15 (length needle)) (in_range1 (length needle))))
(assert (= o16 (- o15 (to_rep (select bad_shift3 c)))))
(assert (= o17 (+ o16 1)))
(assert (and (= temp___323 o17) (in_range1 o17)))
(assert (not (<= temp___323 (to_rep2 (last (rt needle))))))
(check-sat)
(exit)
