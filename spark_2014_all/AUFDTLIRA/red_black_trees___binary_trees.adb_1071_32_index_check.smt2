...
(assert (and (= o5 (+ (to_rep f__split_fields) 1)) (in_range1 (+ (to_rep f__split_fields) 1))))
(assert (= result4 (mk_int__ref v)))
(assert (= v1 o5))
(assert (= (to_rep1 o6) d))
(assert (= (rec__binary_trees__cell__left (us_split_fields3 (select f__split_fields1 v1))) o7))
(assert (= (rec__binary_trees__cell__right (us_split_fields3 (select f__split_fields1 v1))) o8))
(assert (= (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 v1))) o9))
(assert (= o6 o10))
(assert (= o11 o7))
(assert (= o12 o8))
(assert (= o13 o9))
(assert (= o14 o10))
(assert (= o15 (store f__split_fields1 v1 (mk___rep1 (mk___split_fields1 o11 o12 o13 o14)))))
(assert (= f__split_fields o16))
(assert (= o15 o17))
(assert (= temp___890 o16))
(assert (= temp___8901 o17))
(assert (= result5 (mk___split_fields__ref2 (mk___split_fields2 f__split_fields f__split_fields1))))
(assert (= f__split_fields2 (mk___split_fields2 temp___890 temp___8901)))
(assert (= (to_rep o18) i))
(assert (= (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields2) v1))) o19))
(assert (= (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields2) v1))) o20))
(assert (= o18 o21))
(assert (= (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields2) v1))) o22))
(assert (= o23 o19))
(assert (= o24 o20))
(assert (= o25 o21))
(assert (= o26 o22))
(assert (= o27 (store (rec__binary_trees__forest__c f__split_fields2) v1 (mk___rep1 (mk___split_fields1 o23 o24 o25 o26)))))
(assert (= (rec__binary_trees__forest__s f__split_fields2) o28))
(assert (= o27 o29))
(assert (= temp___895 o28))
(assert (= temp___8951 o29))
(assert (= result6 (mk___split_fields__ref2 f__split_fields2)))
(assert (= f__split_fields3 (mk___split_fields2 temp___895 temp___8951)))
(assert (=> (= d 0) (= (to_rep o30) v1)))
(assert (=> (= d 0) (= o30 o31)))
(assert (=> (= d 0) (= (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields3) i))) o32)))
(assert (=> (= d 0) (= (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields3) i))) o33)))
(assert (=> (= d 0) (= (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields3) i))) o34)))
(assert (=> (= d 0) (= o35 (mk___rep1 (mk___split_fields1 o31 o32 o33 o34)))))
(assert (=> (= d 0) (= o36 (store (rec__binary_trees__forest__c f__split_fields3) i o35))))
(assert (=> (= d 0) (= o37 (mk___split_fields2 (rec__binary_trees__forest__s f__split_fields3) o36))))
(assert (=> (= d 0) (= temp___905 (mk___rep2 o37))))
(assert (=> (= d 0) (= result7 (mk___split_fields__ref2 f__split_fields3))))
(assert (=> (= d 0) (= f__split_fields4 (us_split_fields5 temp___905))))
(assert (=> (not (= d 0)) (= (to_rep o38) v1)))
(assert (=> (not (= d 0)) (= o39 (mk___split_fields1 (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields3) i))) o38 (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields3) i))) (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields3) i)))))))
(assert (=> (not (= d 0)) (= o40 (mk___rep1 o39))))
(assert (=> (not (= d 0)) (= o41 (store (rec__binary_trees__forest__c f__split_fields3) i o40))))
(assert (=> (not (= d 0)) (= o42 (mk___split_fields2 (rec__binary_trees__forest__s f__split_fields3) o41))))
(assert (=> (not (= d 0)) (= temp___900 (mk___rep2 o42))))
(assert (=> (not (= d 0)) (= result8 (mk___split_fields__ref2 f__split_fields3))))
(assert (=> (not (= d 0)) (= f__split_fields5 (us_split_fields5 temp___900))))
(assert (=> (not (= d 0)) (= f__split_fields4 f__split_fields5)))
(assert (and (= o43 (+ (to_rep (rec__binary_trees__forest__s f__split_fields4)) 1)) (in_range2 (+ (to_rep (rec__binary_trees__forest__s f__split_fields4)) 1))))
(assert (= (to_rep o44) o43))
(assert (= o45 (mk___split_fields2 o44 (rec__binary_trees__forest__c f__split_fields4))))
(assert (= temp___907 (mk___rep2 o45)))
(assert (= result9 (mk___split_fields__ref2 f__split_fields4)))
(assert (= f__split_fields6 (us_split_fields5 temp___907)))
(assert (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (and (not (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields6) i5)))) 0)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields6) i5)))) 0)) (= (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields6) (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields6) i5)))))))) i5)))))
(assert (<= 1 i2))
(assert (<= i2 100))
(assert (not (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields6) i2)))) 0)))
(assert (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields6) i2)))) 1))
(assert (not (<= 1 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields6) i2)))))))
(check-sat)
(exit)
