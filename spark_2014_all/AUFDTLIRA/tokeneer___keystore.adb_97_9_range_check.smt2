...
(assert (not (= (length (mk___t temp___1885 temp___18851)) 0)))
(assert (=> (<= (to_rep1 (first2 temp___18861)) (to_rep1 (last2 temp___18861))) (= o12 (+ (- (to_rep1 (last2 temp___18861)) (to_rep1 (first2 temp___18861))) 1))))
(assert (=> (not (<= (to_rep1 (first2 temp___18861)) (to_rep1 (last2 temp___18861)))) (= o12 0)))
(assert (=> (<= (to_rep1 (first temp___18851)) (to_rep1 (last temp___18851))) (= o13 (+ (- (to_rep1 (last temp___18851)) (to_rep1 (first temp___18851))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___18851)) (to_rep1 (last temp___18851)))) (= o13 0)))
(assert (= o14 (+ o13 o12)))
(assert (= o15 (+ (to_rep1 (first temp___18851)) o14)))
(assert (= o16 (- o15 1)))
