...
(define-fun component_type__ref___3__projection ((a component_type__ref)) component_type (component_type__content a))
(define-fun dynamic_invariant1 ((temp___expr_677 Int) (temp___is_init_673 Bool) (temp___skip_constant_674 Bool) (temp___do_toplevel_675 Bool) (temp___do_typ_inv_676 Bool)) Bool (=> (or (= temp___is_init_673 true) (<= 0 100)) (in_range4 temp___expr_677)))
...
(define-fun array_type__ref___3__projection ((a array_type__ref)) us_t (array_type__content a))
(define-fun dynamic_invariant2 ((temp___expr_691 us_t) (temp___is_init_687 Bool) (temp___skip_constant_688 Bool) (temp___do_toplevel_689 Bool) (temp___do_typ_inv_690 Bool)) Bool (=> (not (= temp___skip_constant_688 true)) (dynamic_property 0 255 (first1 temp___expr_691) (last1 temp___expr_691))))
