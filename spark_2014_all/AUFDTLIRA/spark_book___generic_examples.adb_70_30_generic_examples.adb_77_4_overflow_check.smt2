...
(define-fun dynamic_invariant1 ((temp___expr_594 Int) (temp___is_init_591 Bool) (temp___skip_constant_592 Bool) (temp___do_toplevel_593 Bool)) Bool (=> (or (= temp___is_init_591 true) (<= 0 100)) (in_range4 temp___expr_594)))
...
(define-fun dynamic_invariant2 ((temp___expr_606 us_t) (temp___is_init_603 Bool) (temp___skip_constant_604 Bool) (temp___do_toplevel_605 Bool)) Bool (=> (not (= temp___skip_constant_604 true)) (dynamic_property 0 255 (first1 temp___expr_606) (last1 temp___expr_606))))
