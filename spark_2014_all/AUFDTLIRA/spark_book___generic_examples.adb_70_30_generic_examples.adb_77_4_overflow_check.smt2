...
(define-fun dynamic_invariant1 ((temp___expr_600 Int) (temp___is_init_597 Bool) (temp___skip_constant_598 Bool) (temp___do_toplevel_599 Bool)) Bool (=> (or (= temp___is_init_597 true) (<= 0 100)) (in_range4 temp___expr_600)))
...
(define-fun dynamic_invariant2 ((temp___expr_612 us_t) (temp___is_init_609 Bool) (temp___skip_constant_610 Bool) (temp___do_toplevel_611 Bool)) Bool (=> (not (= temp___skip_constant_610 true)) (dynamic_property 0 255 (first1 temp___expr_612) (last1 temp___expr_612))))
