...
(assert (<= 0 x1))
(assert (<= x1 2))
(assert (and (forall ((temp___778 Int)) (=> (and (<= 1 temp___778) (<= temp___778 50)) (=> (not (= (+ (to_rep3 cur_piece__split_fields1) y2) temp___778)) (= (select cur_board1 temp___778) (select cur_board temp___778))))) (and (<= 0 x2) (<= x2 2))))
