...
(define-fun dynamic_property ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range3 low) (and (in_range3 high) (=> (<= low high) (and (in_range1 low) (in_range1 high))))))
...
(declare-datatypes () ((telement_arrayB__ref (mk_telement_arrayB__ref (telement_arrayB__content us_t)))))
(define-fun telement_arrayB__ref___projection ((a telement_arrayB__ref)) us_t (telement_arrayB__content a))
...
(define-fun dynamic_property1 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range3 low) (and (in_range3 high) (=> (<= low high) (and (in_range low) (in_range high))))))
...
(declare-datatypes () ((model____ref (mk_model____ref (model____content us_t1)))))
(define-fun model____ref___projection ((a model____ref)) us_t1 (model____content a))
...
(define-fun bool_eq4 ((a us_rep1) (b us_rep1)) Bool (ite (and (and (= (to_rep3 (rec__stackp__buffer__first (us_split_fields3 a))) (to_rep3 (rec__stackp__buffer__first (us_split_fields3 b)))) (= (bool_eq (rec__stackp__stack_root__content1 (us_split_fields3 a)) 1 100 (rec__stackp__stack_root__content1 (us_split_fields3 b)) 1 100) true)) (= (to_rep2 (rec__stackp__stack_root__length1 (us_split_fields3 a))) (to_rep2 (rec__stackp__stack_root__length1 (us_split_fields3 b))))) true false))
...
(assert true)
(assert true)
(assert (forall ((s1 us_rep1)) (! (= (to_int1 (wraps_around s1)) (to_int1 (wraps_around1 us_tag1 s1))) :pattern ((wraps_around1 us_tag1 s1)))))
(assert (forall ((s1 us_rep1)) (! (= (= (wraps_around s1) true) (< 100 (- (+ (to_rep3 (rec__stackp__buffer__first (us_split_fields3 s1))) (to_rep2 (rec__stackp__stack_root__length1 (us_split_fields3 s1)))) 1))) :pattern ((wraps_around s1)))))
(define-fun dynamic_invariant ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= 0 100)) (in_range4 temp___expr_136)))
...
(assert (forall ((s1 us_rep1)) (! (dynamic_invariant (last4 s1) true false true) :pattern ((last4 s1)))))
(assert (forall ((attr__tag2 Int)) (forall ((s1 us_rep1)) (! (dynamic_invariant (last5 attr__tag2 s1) true false true) :pattern ((last5 attr__tag2 s1))))))
(assert (forall ((s1 us_rep1)) (! (= (last4 s1) (last5 us_tag1 s1)) :pattern ((last5 us_tag1 s1)))))
(assert (forall ((s1 us_rep1)) (! (= (last4 s1) (ite (not (= (wraps_around s1) true)) (- (+ (to_rep3 (rec__stackp__buffer__first (us_split_fields3 s1))) (to_rep2 (rec__stackp__stack_root__length1 (us_split_fields3 s1)))) 1) (- (- (+ (to_rep3 (rec__stackp__buffer__first (us_split_fields3 s1))) (to_rep2 (rec__stackp__stack_root__length1 (us_split_fields3 s1)))) 1) 100))) :pattern ((last4 s1)))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range3 f) (=> (in_range3 l) (and (= (to_rep1 (first4 (mk2 f l))) f) (= (to_rep1 (last6 (mk2 f l))) l)))) :pattern ((mk2 f l)))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range3 f) (=> (in_range3 l) (and (= (to_rep1 (first6 (mk3 f l))) f) (= (to_rep1 (last8 (mk3 f l))) l)))) :pattern ((mk3 f l)))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range3 f) (=> (in_range3 l) (and (= (to_rep1 (first8 (mk4 f l))) f) (= (to_rep1 (last10 (mk4 f l))) l)))) :pattern ((mk4 f l)))))
...
(define-fun dynamic_invariant4 ((temp___expr_168 us_t1) (temp___is_init_165 Bool) (temp___skip_constant_166 Bool) (temp___do_toplevel_167 Bool)) Bool (=> (not (= temp___skip_constant_166 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_168) (last3 temp___expr_168))))
...
(assert (forall ((s1 us_rep)) (! (dynamic_invariant (size s1) true false true) :pattern ((size s1)))))
(assert (forall ((s1 us_rep)) (! (= (size s1) (to_rep2 (rec__stackp__stack_root__length (us_split_fields1 s1)))) :pattern ((size s1)))))
...
(declare-const stackp__get_model__3__result (Array Int element))
(declare-const stackp__get_model__3__result1 t1)
(declare-const stackp__get_model__3__R84s Int)
(declare-const o (Array Int element))
(declare-const temp___543 (Array Int element))
(declare-const temp___5431 t3)
(declare-const o1 (Array Int element))
(declare-const temp___542 (Array Int element))
(declare-const temp___5421 t2)
...
(declare-const temp___544 (Array Int element))
(declare-const temp___5441 t)
(declare-const stackp__get_model__3__R87s Int)
(declare-const o8 (Array Int element))
(declare-const temp___547 (Array Int element))
(declare-const temp___5471 t4)
...
(declare-const stackp__get_model__3__result2 (Array Int element))
(declare-const stackp__get_model__3__result3 t1)
(declare-const stackp__get_model__3__result4 (Array Int element))
(declare-const stackp__get_model__3__result5 t1)
(declare-const stackp__get_model__3__result6 (Array Int element))
(declare-const stackp__get_model__3__result7 t1)
(declare-const stackp__get_model__3__result8 (Array Int element))
(declare-const stackp__get_model__3__result9 t1)
(declare-const stackp__get_model__3__result10 (Array Int element))
(declare-const stackp__get_model__3__result11 t1)
(define-fun stackp__get_model__3__result12 () us_t1 (mk___t1 stackp__get_model__3__result2 stackp__get_model__3__result3))
(declare-const result3 (Array Int element))
(declare-const result4 t1)
(assert (= stackp__get_model__3__result4 stackp__get_model__3__result2))
(assert (= stackp__get_model__3__result5 stackp__get_model__3__result3))
(assert (= (mk___t1 stackp__get_model__3__result6 stackp__get_model__3__result7) stackp__get_model__3__result12))
(assert (and (= result (wraps_around s)) (= (= result true) (< 100 (- (+ (to_rep3 (rec__stackp__buffer__first (us_split_fields3 s))) (to_rep2 (rec__stackp__stack_root__length1 (us_split_fields3 s)))) 1)))))
(assert (=> (= result true) (and (= stackp__get_model__3__R84s (last4 s)) (and (in_range4 stackp__get_model__3__R84s) (= stackp__get_model__3__R84s (ite (not (= (wraps_around s) true)) (- (+ (to_rep3 (rec__stackp__buffer__first (us_split_fields3 s))) (to_rep2 (rec__stackp__stack_root__length1 (us_split_fields3 s)))) 1) (- (- (+ (to_rep3 (rec__stackp__buffer__first (us_split_fields3 s))) (to_rep2 (rec__stackp__stack_root__length1 (us_split_fields3 s)))) 1) 100)))))))
(assert (=> (= result true) (=> (<= 1 stackp__get_model__3__R84s) (and (and (<= 1 1) (<= 1 100)) (and (<= 1 stackp__get_model__3__R84s) (<= stackp__get_model__3__R84s 100))))))
(assert (=> (= result true) (= o (rec__stackp__stack_root__content1 (us_split_fields3 s)))))
(assert (=> (= result true) (= o temp___543)))
(assert (=> (= result true) (= (mk3 1 stackp__get_model__3__R84s) temp___5431)))
(assert (=> (= result true) (=> (<= (to_rep3 (rec__stackp__buffer__first (us_split_fields3 s))) 100) (and (and (<= 1 (to_rep3 (rec__stackp__buffer__first (us_split_fields3 s)))) (<= (to_rep3 (rec__stackp__buffer__first (us_split_fields3 s))) 100)) (and (<= 1 100) (<= 100 100))))))
(assert (=> (= result true) (= o1 (rec__stackp__stack_root__content1 (us_split_fields3 s)))))
(assert (=> (= result true) (= o1 temp___542)))
(assert (=> (= result true) (= (mk2 (to_rep3 (rec__stackp__buffer__first (us_split_fields3 s))) 100) temp___5421)))
(assert (=> (= result true) (=> (= (length2 (mk___t2 temp___542 temp___5421)) 0) (= temp___543 temp___544))))
(assert (=> (= result true) (=> (= (length2 (mk___t2 temp___542 temp___5421)) 0) (= (mk (to_rep1 (first6 temp___5431)) (to_rep1 (last8 temp___5431))) temp___5441))))
(assert (=> (= result true) (=> (not (= (length2 (mk___t2 temp___542 temp___5421)) 0)) (=> (<= (to_rep1 (first6 temp___5431)) (to_rep1 (last8 temp___5431))) (= o2 (+ (- (to_rep1 (last8 temp___5431)) (to_rep1 (first6 temp___5431))) 1))))))
(assert (=> (= result true) (=> (not (= (length2 (mk___t2 temp___542 temp___5421)) 0)) (=> (not (<= (to_rep1 (first6 temp___5431)) (to_rep1 (last8 temp___5431)))) (= o2 0)))))
(assert (=> (= result true) (=> (not (= (length2 (mk___t2 temp___542 temp___5421)) 0)) (=> (<= (to_rep1 (first4 temp___5421)) (to_rep1 (last6 temp___5421))) (= o3 (+ (- (to_rep1 (last6 temp___5421)) (to_rep1 (first4 temp___5421))) 1))))))
(assert (=> (= result true) (=> (not (= (length2 (mk___t2 temp___542 temp___5421)) 0)) (=> (not (<= (to_rep1 (first4 temp___5421)) (to_rep1 (last6 temp___5421)))) (= o3 0)))))
(assert (=> (= result true) (=> (not (= (length2 (mk___t2 temp___542 temp___5421)) 0)) (= o4 (+ o3 o2)))))
(assert (=> (= result true) (=> (not (= (length2 (mk___t2 temp___542 temp___5421)) 0)) (= o5 (+ 1 o4)))))
(assert (=> (= result true) (=> (not (= (length2 (mk___t2 temp___542 temp___5421)) 0)) (= o6 (- o5 1)))))
(assert (=> (= result true) (=> (not (= (length2 (mk___t2 temp___542 temp___5421)) 0)) (and (= o7 o6) (in_range1 o6)))))
(assert (=> (= result true) (=> (not (= (length2 (mk___t2 temp___542 temp___5421)) 0)) (= (slide (concat1 temp___542 (to_rep1 (first4 temp___5421)) (to_rep1 (last6 temp___5421)) temp___543 (to_rep1 (first6 temp___5431)) (to_rep1 (last8 temp___5431))) (to_rep1 (first4 temp___5421)) 1) temp___544))))
(assert (=> (= result true) (=> (not (= (length2 (mk___t2 temp___542 temp___5421)) 0)) (= (mk 1 o7) temp___5441))))
(assert (=> (= result true) (dynamic_property1 1 2147483647 (to_rep1 (first temp___5441)) (to_rep1 (last temp___5441)))))
(assert (=> (= result true) (= temp___544 o9)))
(assert (=> (= result true) (= (mk1 (to_rep1 (first temp___5441)) (to_rep1 (last temp___5441))) o10)))
(assert (=> (not (= result true)) (and (= stackp__get_model__3__R87s (last4 s)) (and (in_range4 stackp__get_model__3__R87s) (= stackp__get_model__3__R87s (ite (not (= (wraps_around s) true)) (- (+ (to_rep3 (rec__stackp__buffer__first (us_split_fields3 s))) (to_rep2 (rec__stackp__stack_root__length1 (us_split_fields3 s)))) 1) (- (- (+ (to_rep3 (rec__stackp__buffer__first (us_split_fields3 s))) (to_rep2 (rec__stackp__stack_root__length1 (us_split_fields3 s)))) 1) 100)))))))
(assert (=> (not (= result true)) (=> (<= (to_rep3 (rec__stackp__buffer__first (us_split_fields3 s))) stackp__get_model__3__R87s) (and (and (<= 1 (to_rep3 (rec__stackp__buffer__first (us_split_fields3 s)))) (<= (to_rep3 (rec__stackp__buffer__first (us_split_fields3 s))) 100)) (and (<= 1 stackp__get_model__3__R87s) (<= stackp__get_model__3__R87s 100))))))
(assert (=> (not (= result true)) (= o8 (rec__stackp__stack_root__content1 (us_split_fields3 s)))))
(assert (=> (not (= result true)) (= o8 temp___547)))
(assert (=> (not (= result true)) (= (mk4 (to_rep3 (rec__stackp__buffer__first (us_split_fields3 s))) stackp__get_model__3__R87s) temp___5471)))
(assert (=> (not (= result true)) (dynamic_property1 1 2147483647 (to_rep1 (first8 temp___5471)) (to_rep1 (last10 temp___5471)))))
(assert (=> (not (= result true)) (= temp___547 o9)))
(assert (=> (not (= result true)) (= (mk1 (to_rep1 (first8 temp___5471)) (to_rep1 (last10 temp___5471))) o10)))
(assert (= result1 stackp__get_model__3__result))
(assert (= result2 stackp__get_model__3__result1))
(assert (= stackp__get_model__3__result12 (mk___t1 o9 o10)))
(assert (= (mk_model____ref (mk___t1 stackp__get_model__3__result8 stackp__get_model__3__result9)) (mk_model____ref (mk___t1 stackp__get_model__3__result4 stackp__get_model__3__result5))))
(assert (= stackp__get_model__3__result10 stackp__get_model__3__result6))
(assert (= stackp__get_model__3__result11 stackp__get_model__3__result7))
(assert (= result3 stackp__get_model__3__result8))
(assert (= result4 stackp__get_model__3__result9))
(assert (not (= (length1 (mk___t1 stackp__get_model__3__result8 stackp__get_model__3__result9)) (size (mk___rep (mk___split_fields (rec__stackp__stack_root__content1 (us_split_fields3 s)) (rec__stackp__stack_root__length1 (us_split_fields3 s)) (hide_ext__ (rec__stackp__buffer__first (us_split_fields3 s)) (rec__ext__1 (us_split_fields3 s)))) (attr__tag1 s))))))
(check-sat)
(exit)
