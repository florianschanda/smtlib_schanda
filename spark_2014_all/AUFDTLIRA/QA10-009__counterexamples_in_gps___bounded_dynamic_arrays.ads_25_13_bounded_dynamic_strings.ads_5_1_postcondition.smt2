...
(define-fun dynamic_invariant ((temp___expr_176 us_rep) (temp___is_init_173 Bool) (temp___skip_constant_174 Bool) (temp___do_toplevel_175 Bool)) Bool (and (=> (= temp___do_toplevel_175 true) (=> (= temp___is_init_173 true) (and (<= 0 (to_rep (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 temp___expr_176)))) (<= (to_rep (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 temp___expr_176))) (to_rep (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 temp___expr_176))))))) (let ((temp___178 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 temp___expr_176)))) (and (dynamic_property1 1 (to_rep temp___178) (first1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 temp___expr_176))) (last1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 temp___expr_176)))) (and (= (first1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 temp___expr_176))) 1) (= (last1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 temp___expr_176))) (to_rep temp___178)))))))
(define-fun dynamic_predicate ((temp___180 us_rep)) Bool (and (<= 0 (to_rep (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 temp___180)))) (<= (to_rep (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 temp___180))) (to_rep (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 temp___180))))))
(declare-const this us_rep)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-fun length1 (us_rep) Int)
(declare-fun length__function_guard (Int us_rep) Bool)
(define-fun dynamic_invariant1 ((temp___expr_164 Int) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool)) Bool (=> (or (= temp___is_init_161 true) (<= 0 2147483647)) (in_range1 temp___expr_164)))
(assert (forall ((this1 us_rep)) (! (=> (dynamic_invariant this1 true true true) (dynamic_invariant1 (length1 this1) true false true)) :pattern ((length1 this1)))))
(assert (forall ((this1 us_rep)) (! (=> (dynamic_invariant this1 true true true) (= (length1 this1) (to_rep (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 this1))))) :pattern ((length1 this1)))))
...
(assert (dynamic_invariant i8s true false true))
(assert (dynamic_invariant this true false true))
