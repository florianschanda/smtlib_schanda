...
(define-fun dynamic_invariant2 ((temp___expr_645 Int) (temp___is_init_642 Bool) (temp___skip_constant_643 Bool) (temp___do_toplevel_644 Bool)) Bool (=> (or (= temp___is_init_642 true) (<= 0 2147483647)) (in_range5 temp___expr_645)))
...
(define-fun dynamic_invariant3 ((temp___expr_654 Int) (temp___is_init_651 Bool) (temp___skip_constant_652 Bool) (temp___do_toplevel_653 Bool)) Bool (=> (or (= temp___is_init_651 true) (<= 0 8)) (in_range6 temp___expr_654)))
...
(define-fun dynamic_invariant4 ((temp___expr_660 Int) (temp___is_init_657 Bool) (temp___skip_constant_658 Bool) (temp___do_toplevel_659 Bool)) Bool (=> (or (= temp___is_init_657 true) (<= 3 8)) (in_range7 temp___expr_660)))
...
(define-fun default_initial_assumption ((temp___expr_668 us_rep) (temp___skip_top_level_669 Bool)) Bool (and (= (attr__constrained temp___expr_668) false) (= (to_rep4 (rec__lexer__token__kind (us_split_discrs1 temp___expr_668))) 0)))
...
(declare-const temp___976 token_kind)
(declare-const temp___9761 natural)
(declare-const temp___9762 natural)
(declare-const temp___9763 natural)
(declare-const temp___9764 name_id)
(declare-const temp___9765 Bool)
...
(declare-const temp___978 token_kind)
(declare-const temp___9781 natural)
(declare-const temp___9782 natural)
(declare-const temp___9783 natural)
(declare-const temp___9784 name_id)
(declare-const temp___9785 Bool)
...
(declare-const temp___979 us_rep)
(declare-const usq_6 us_rep)
(declare-const temp___981 us_rep)
