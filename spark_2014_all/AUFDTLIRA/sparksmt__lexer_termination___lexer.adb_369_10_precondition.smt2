...
(define-fun dynamic_invariant2 ((temp___expr_726 Int) (temp___is_init_722 Bool) (temp___skip_constant_723 Bool) (temp___do_toplevel_724 Bool) (temp___do_typ_inv_725 Bool)) Bool (=> (or (= temp___is_init_722 true) (<= 0 2147483647)) (in_range5 temp___expr_726)))
...
(define-fun dynamic_invariant3 ((temp___expr_736 Int) (temp___is_init_732 Bool) (temp___skip_constant_733 Bool) (temp___do_toplevel_734 Bool) (temp___do_typ_inv_735 Bool)) Bool (=> (or (= temp___is_init_732 true) (<= 0 8)) (in_range6 temp___expr_736)))
...
(define-fun dynamic_invariant4 ((temp___expr_743 Int) (temp___is_init_739 Bool) (temp___skip_constant_740 Bool) (temp___do_toplevel_741 Bool) (temp___do_typ_inv_742 Bool)) Bool (=> (or (= temp___is_init_739 true) (<= 3 8)) (in_range7 temp___expr_743)))
...
(define-fun default_initial_assumption ((temp___expr_752 us_rep) (temp___skip_top_level_753 Bool)) Bool (and (= (attr__constrained temp___expr_752) false) (= (to_rep4 (rec__lexer__token__kind (us_split_discrs1 temp___expr_752))) 0)))
