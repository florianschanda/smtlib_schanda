...
(define-fun dynamic_invariant2 ((temp___expr_651 Int) (temp___is_init_648 Bool) (temp___skip_constant_649 Bool) (temp___do_toplevel_650 Bool)) Bool (=> (or (= temp___is_init_648 true) (<= 0 2147483647)) (in_range5 temp___expr_651)))
...
(define-fun dynamic_invariant3 ((temp___expr_660 Int) (temp___is_init_657 Bool) (temp___skip_constant_658 Bool) (temp___do_toplevel_659 Bool)) Bool (=> (or (= temp___is_init_657 true) (<= 0 8)) (in_range6 temp___expr_660)))
...
(define-fun dynamic_invariant4 ((temp___expr_666 Int) (temp___is_init_663 Bool) (temp___skip_constant_664 Bool) (temp___do_toplevel_665 Bool)) Bool (=> (or (= temp___is_init_663 true) (<= 3 8)) (in_range7 temp___expr_666)))
...
(define-fun default_initial_assumption ((temp___expr_674 us_rep) (temp___skip_top_level_675 Bool)) Bool (and (= (attr__constrained temp___expr_674) false) (= (to_rep4 (rec__lexer__token__kind (us_split_discrs1 temp___expr_674))) 0)))
