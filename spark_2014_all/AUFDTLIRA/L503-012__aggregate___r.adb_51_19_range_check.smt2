...
(declare-fun temp_____aggregate_def_341 ((Array Int int5)) (Array Int (Array Int int5)))
(declare-fun temp_____aggregate_def_345 (Int Int) (Array Int int5))
...
(assert (forall ((temp___343 (Array Int int5))) (forall ((temp___344 Int)) (= (select (temp_____aggregate_def_341 temp___343) temp___344) temp___343))))
(declare-const rliteral int5)
(assert (= (int5qtint rliteral) 1))
(assert (forall ((temp___347 Int) (temp___348 Int)) (let ((temp___346 (temp_____aggregate_def_345 temp___347 temp___348))) (=> (and (dynamic_invariant2 temp___347 true true true true) (dynamic_invariant2 temp___348 true true true true)) (forall ((temp___349 Int)) (ite (= temp___349 3) (= (select temp___346 temp___349) rliteral) (= (to_rep (select temp___346 temp___349)) temp___348)))))))
