...
(define-fun dynamic_invariant1 ((temp___expr_180 Int) (temp___is_init_177 Bool) (temp___skip_constant_178 Bool) (temp___do_toplevel_179 Bool)) Bool (=> (or (= temp___is_init_177 true) (<= 1 6)) (in_range3 temp___expr_180)))
...
(declare-fun concat1 ((Array Int int5) Int Int (Array Int int5) Int Int) (Array Int int5))
(assert (forall ((a (Array Int int5)) (b (Array Int int5))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (forall ((i Int)) (! (and (=> (and (<= a_first i) (<= i a_last)) (= (select (concat1 a a_first a_last b b_first b_last) i) (select a i))) (=> (< a_last i) (= (select (concat1 a a_first a_last b b_first b_last) i) (select b (+ (- i a_last) (- b_first 1)))))) :pattern ((select (concat1 a a_first a_last b b_first b_last) i)))))))
(declare-fun singleton1 (int5 Int) (Array Int int5))
(assert (forall ((v int5)) (forall ((i Int)) (! (= (select (singleton1 v i) i) v) :pattern ((select (singleton1 v i) i))))))
(define-fun bool_eq ((a (Array Int int5)) (a__first Int) (a__last Int) (b (Array Int int5)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_132 Int)) (=> (and (<= a__first temp___idx_132) (<= temp___idx_132 a__last)) (= (to_rep (select a temp___idx_132)) (to_rep (select b (+ (- b__first a__first) temp___idx_132))))))) true false))
...
(assert (forall ((a (Array Int int5)) (b (Array Int int5))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare a a_first a_last b b_first b_last) 0) (= (bool_eq a a_first a_last b b_first b_last) true)) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int int5)) (b (Array Int int5))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep (select a (+ i 1))) (to_rep (select b (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int int5)) (b (Array Int int5))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep (select b (+ i 1))) (to_rep (select a (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
...
(declare-fun concat2 ((Array Int (Array Int int5)) Int Int (Array Int (Array Int int5)) Int Int) (Array Int (Array Int int5)))
...
(assert (forall ((v (Array Int int5))) (forall ((i Int)) (! (= (select (singleton2 v i) i) v) :pattern ((select (singleton2 v i) i))))))
(define-fun bool_eq1 ((a (Array Int (Array Int int5))) (a__first Int) (a__last Int) (b (Array Int (Array Int int5))) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_134 Int)) (=> (and (<= a__first temp___idx_134) (<= temp___idx_134 a__last)) (= (bool_eq (select a temp___idx_134) 2 6 (select b (+ (- b__first a__first) temp___idx_134)) 2 6) true)))) true false))
(assert (forall ((a (Array Int (Array Int int5))) (b (Array Int (Array Int int5)))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq1 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_134 Int)) (=> (and (<= a__first temp___idx_134) (<= temp___idx_134 a__last)) (= (bool_eq (select a temp___idx_134) 2 6 (select b (+ (- b__first a__first) temp___idx_134)) 2 6) true))))))))
...
(assert (forall ((temp___306 (Array Int int5))) (forall ((temp___307 Int)) (= (select (temp___304 temp___306) temp___307) temp___306))))
(declare-fun temp___308 (Int Int) (Array Int int5))
(assert (forall ((temp___310 Int) (temp___311 Int)) (let ((temp___309 (temp___308 temp___310 temp___311))) (forall ((temp___312 Int)) (ite (= temp___312 3) (= (select temp___309 temp___312) (of_rep temp___310)) (= (select temp___309 temp___312) (of_rep temp___311)))))))
(define-fun dynamic_invariant2 ((temp___expr_174 Int) (temp___is_init_171 Bool) (temp___skip_constant_172 Bool) (temp___do_toplevel_173 Bool)) Bool (=> (or (= temp___is_init_171 true) (<= 1 5)) (in_range2 temp___expr_174)))
(declare-const a (Array Int (Array Int int5)))
(declare-const i Int)
(declare-const o Int)
(declare-const temp___303 (Array Int int5))
(declare-const o1 Int)
(declare-const o2 int5)
(declare-const o3 Int)
(declare-const o4 Int)
(declare-const o5 Int)
(declare-const temp___313 (Array Int int5))
...
(assert (and (<= 3 n) (<= n 7)))
(assert (= o n))
(assert (= temp___303 (select a o)))
(assert (and (<= 2 n) (<= n 6)))
(assert (= o1 n))
(assert (= o2 (select temp___303 o1)))
(assert (= o3 (to_rep o2)))
