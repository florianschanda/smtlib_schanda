...
(define-fun dynamic_invariant ((temp___expr_201 Int) (temp___is_init_197 Bool) (temp___skip_constant_198 Bool) (temp___do_toplevel_199 Bool) (temp___do_typ_inv_200 Bool)) Bool (=> (or (= temp___is_init_197 true) (<= 1 10)) (in_range temp___expr_201)))
(declare-const i Int)
(declare-const result Int)
(declare-const i1 Int)
(assert (= result i))
(assert (= i1 1))
(assert (not (in_range (+ i1 1))))
(check-sat)
(exit)
