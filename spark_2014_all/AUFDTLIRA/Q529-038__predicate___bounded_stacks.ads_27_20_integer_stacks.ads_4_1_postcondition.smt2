...
(assert (not (= (extent (mk___rep this__split_discrs (us_split_fields__content this__split_fields6) this__attr__tag)) (+ (extent (mk___rep this__split_discrs (mk___split_fields (mk___t this__split_fields this__split_fields1) this__split_fields2 this__split_fields3) this__attr__tag)) 1))))
(check-sat)
(exit)
