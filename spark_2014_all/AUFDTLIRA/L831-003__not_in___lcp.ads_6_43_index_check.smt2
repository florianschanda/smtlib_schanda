...
(assert (and (<= (to_rep (first (rt a))) temp___163) (<= temp___163 (to_rep (last (rt a))))))
(assert (= o31 temp___163))
(assert (= o32 (select (elts a) o31)))
(assert (= o33 (to_rep o32)))
(assert (and (= temp___162 (+ x k)) (in_range1 (+ x k))))
(assert (not (<= (to_rep (first (rt a))) temp___162)))
(check-sat)
(exit)
