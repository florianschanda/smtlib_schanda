...
(assert (=> (= result11 true) (and (= temp___1293 (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root)) (and (dynamic_invariant3 temp___1293 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1293 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1293 root)))) 0) (and (forall ((i13 Int)) (=> (and (<= 1 i13) (<= i13 100)) (=> (not (= i13 root)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i13) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1293 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i13)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1293 i13))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1293 i13))) true)))))) (and (forall ((i13 Int)) (=> (and (<= 1 i13) (<= i13 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1293 i13))) true) (not (= i13 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1293 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i13)))) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i13) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1293 i13)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1293 i13)))) 0)))) (forall ((i13 Int)) (=> (and (<= 1 i13) (<= i13 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1293 i13))) true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1293 j2))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1293 i13))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1293 j2)))) true)) (= j2 i13)))))))))))))))
(assert (=> (= result11 true) (= o43 (select temp___1293 i2))))
(assert (=> (= result11 true) (= o44 (us_split_fields1 o43))))
(assert (=> (= result11 true) (= o45 (rec__tree_model__path_type__a o44))))
(assert (=> (= result11 true) (and (= o46 (length o45)) (and (in_range5 o46) (<= (+ 0 o46) 2147483647)))))
(assert (=> (= result11 true) (= result10 (ite (<= o46 (- n2 1)) true false))))
