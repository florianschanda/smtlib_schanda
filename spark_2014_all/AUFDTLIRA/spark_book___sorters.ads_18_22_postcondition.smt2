...
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (and (= o6 (index_of_minimum (mk___t o4 o5))) (and (in_range2 o6) (and (and (<= (to_rep (first o5)) o6) (<= o6 (to_rep (last o5)))) (forall ((j Int)) (=> (and (<= (to_rep (first o5)) j) (<= j (to_rep (last o5)))) (<= (to_rep (select o4 o6)) (to_rep (select o4 j))))))))))
...
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (forall ((j Int)) (=> (and (<= current2 j) (<= j (to_rep values__last))) (<= (to_rep (select values3 current2)) (to_rep (select values3 j)))))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (forall ((j Int)) (=> (and (<= (to_rep values__first) j) (<= j current2)) (<= (to_rep (select values3 j)) (to_rep (select values3 (+ j 1))))))))
