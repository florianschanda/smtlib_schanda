...
(define-fun to_rep2 ((x year_type)) Int (year_typeqtint x))
...
(define-fun to_rep3 ((x month_type)) Int (month_typeqtint x))
...
(define-fun to_rep4 ((x day_type)) Int (day_typeqtint x))
...
(define-fun to_rep5 ((x hour_type)) Int (hour_typeqtint x))
...
(define-fun to_rep6 ((x minute_type)) Int (minute_typeqtint x))
...
(define-fun to_rep7 ((x second_type)) Int (second_typeqtint x))
...
(declare-fun event_index_typeqtint (event_index_type) Int)
(assert (forall ((i event_index_type)) (and (<= 1 (event_index_typeqtint i)) (<= (event_index_typeqtint i) 64))))
(define-fun in_range10 ((x Int)) Bool (and (<= 1 x) (<= x 64)))
(declare-fun attr__ATTRIBUTE_IMAGE10 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check10 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE10 (us_image) Int)
(declare-fun user_eq13 (event_index_type event_index_type) Bool)
(declare-const dummy13 event_index_type)
...
(define-fun to_rep8 ((x event_index_type)) Int (event_index_typeqtint x))
(declare-fun of_rep8 (Int) event_index_type)
(assert (forall ((x event_index_type)) (! (= (of_rep8 (to_rep8 x)) x) :pattern ((to_rep8 x)))))
(assert (forall ((x event_index_type)) (! (in_range10 (to_rep8 x)) :pattern ((to_rep8 x)))))
(assert (forall ((x Int)) (! (=> (in_range10 x) (= (to_rep8 (of_rep8 x)) x)) :pattern ((to_rep8 (of_rep8 x))))))
(declare-sort description_index_type 0)
(declare-fun description_index_typeqtint (description_index_type) Int)
(assert (forall ((i description_index_type)) (and (<= 1 (description_index_typeqtint i)) (<= (description_index_typeqtint i) 128))))
(define-fun in_range11 ((x Int)) Bool (and (<= 1 x) (<= x 128)))
(declare-fun attr__ATTRIBUTE_IMAGE11 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check11 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE11 (us_image) Int)
(declare-fun user_eq14 (description_index_type description_index_type) Bool)
(declare-const dummy14 description_index_type)
(declare-datatypes () ((description_index_type__ref (mk_description_index_type__ref (description_index_type__content description_index_type)))))
(define-fun description_index_type__ref___projection ((a description_index_type__ref)) description_index_type (description_index_type__content a))
(declare-sort description_count_type 0)
(declare-fun description_count_typeqtint (description_count_type) Int)
(assert (forall ((i description_count_type)) (and (<= 0 (description_count_typeqtint i)) (<= (description_count_typeqtint i) 128))))
(define-fun in_range12 ((x Int)) Bool (and (<= 0 x) (<= x 128)))
(declare-fun attr__ATTRIBUTE_IMAGE12 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check12 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE12 (us_image) Int)
(declare-fun user_eq15 (description_count_type description_count_type) Bool)
(declare-const dummy15 description_count_type)
...
(define-fun to_rep9 ((x description_count_type)) Int (description_count_typeqtint x))
(declare-fun of_rep9 (Int) description_count_type)
(assert (forall ((x description_count_type)) (! (= (of_rep9 (to_rep9 x)) x) :pattern ((to_rep9 x)))))
(assert (forall ((x description_count_type)) (! (in_range12 (to_rep9 x)) :pattern ((to_rep9 x)))))
...
(declare-datatypes () ((us_split_fields6 (mk___split_fields3 (rec__datebooks__event_record__description_text (Array Int character)) (rec__datebooks__event_record__description_size description_count_type) (rec__datebooks__event_record__date us_rep2) (rec__datebooks__event_record__is_used Bool)))))
(define-fun us_split_fields_Description_Text__projection ((a us_split_fields6)) (Array Int character) (rec__datebooks__event_record__description_text a))
(define-fun us_split_fields_Description_Size__projection ((a us_split_fields6)) description_count_type (rec__datebooks__event_record__description_size a))
(define-fun us_split_fields_Date__projection ((a us_split_fields6)) us_rep2 (rec__datebooks__event_record__date a))
(define-fun us_split_fields_Is_Used__projection ((a us_split_fields6)) Bool (rec__datebooks__event_record__is_used a))
...
(define-fun bool_eq5 ((a us_rep3) (b us_rep3)) Bool (ite (and (and (and (= (bool_eq (rec__datebooks__event_record__description_text (us_split_fields7 a)) 1 128 (rec__datebooks__event_record__description_text (us_split_fields7 b)) 1 128) true) (= (to_rep9 (rec__datebooks__event_record__description_size (us_split_fields7 a))) (to_rep9 (rec__datebooks__event_record__description_size (us_split_fields7 b))))) (= (bool_eq4 (rec__datebooks__event_record__date (us_split_fields7 a)) (rec__datebooks__event_record__date (us_split_fields7 b))) true)) (= (rec__datebooks__event_record__is_used (us_split_fields7 a)) (rec__datebooks__event_record__is_used (us_split_fields7 b)))) true false))
...
(assert (< datebooks__event_record__description_text__first__bit datebooks__event_record__description_text__last__bit))
...
(assert (< datebooks__event_record__description_size__first__bit datebooks__event_record__description_size__last__bit))
...
(assert (< datebooks__event_record__date__first__bit datebooks__event_record__date__last__bit))
...
(assert (< datebooks__event_record__is_used__first__bit datebooks__event_record__is_used__last__bit))
...
(define-fun bool_eq6 ((a (Array Int us_rep3)) (a__first Int) (a__last Int) (b (Array Int us_rep3)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (bool_eq5 (select a temp___idx_154) (select b (+ (- b__first a__first) temp___idx_154))) true)))) true false))
...
(define-fun dynamic_invariant1 ((temp___expr_335 Int) (temp___is_init_331 Bool) (temp___skip_constant_332 Bool) (temp___do_toplevel_333 Bool) (temp___do_typ_inv_334 Bool)) Bool (=> (or (= temp___is_init_331 true) (<= 0 3)) (in_range13 temp___expr_335)))
...
(declare-datatypes () ((us_split_fields8 (mk___split_fields4 (rec__datebooks__add_event__find_result_record__fresh_index event_index_type) (rec__datebooks__add_event__find_result_record__found_slot Bool)))))
(define-fun us_split_fields_Fresh_Index__projection ((a us_split_fields8)) event_index_type (rec__datebooks__add_event__find_result_record__fresh_index a))
(define-fun us_split_fields_Found_Slot__projection ((a us_split_fields8)) Bool (rec__datebooks__add_event__find_result_record__found_slot a))
...
(define-fun bool_eq7 ((a us_rep4) (b us_rep4)) Bool (ite (and (= (to_rep8 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields9 a))) (to_rep8 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields9 b)))) (= (rec__datebooks__add_event__find_result_record__found_slot (us_split_fields9 a)) (rec__datebooks__add_event__find_result_record__found_slot (us_split_fields9 b)))) true false))
...
(assert (<= 0 datebooks__add_event__find_result_record__fresh_index__first__bit))
(assert (< datebooks__add_event__find_result_record__fresh_index__first__bit datebooks__add_event__find_result_record__fresh_index__last__bit))
(assert (<= 0 datebooks__add_event__find_result_record__fresh_index__position))
...
(assert (<= 0 datebooks__add_event__find_result_record__found_slot__first__bit))
(assert (< datebooks__add_event__find_result_record__found_slot__first__bit datebooks__add_event__find_result_record__found_slot__last__bit))
(assert (<= 0 datebooks__add_event__find_result_record__found_slot__position))
(declare-fun user_eq19 (us_rep4 us_rep4) Bool)
(declare-const dummy19 us_rep4)
(declare-datatypes () ((find_result_record__ref (mk_find_result_record__ref (find_result_record__content us_rep4)))))
(define-fun find_result_record__ref___projection ((a find_result_record__ref)) us_rep4 (find_result_record__content a))
...
(declare-fun temp_____aggregate_def_410 (Int) (Array Int character))
...
(assert (forall ((temp___412 Int)) (=> (dynamic_invariant3 temp___412 true true true true) (forall ((temp___413 Int)) (= (to_rep (select (temp_____aggregate_def_410 temp___412) temp___413)) temp___412)))))
(define-fun dynamic_invariant5 ((temp___expr_257 Int) (temp___is_init_253 Bool) (temp___skip_constant_254 Bool) (temp___do_toplevel_255 Bool) (temp___do_typ_inv_256 Bool)) Bool (=> (or (= temp___is_init_253 true) (<= 1 128)) (in_range11 temp___expr_257)))
(define-fun dynamic_invariant6 ((temp___expr_274 Int) (temp___is_init_270 Bool) (temp___skip_constant_271 Bool) (temp___do_toplevel_272 Bool) (temp___do_typ_inv_273 Bool)) Bool (=> (or (= temp___is_init_270 true) (<= 0 128)) (in_range12 temp___expr_274)))
(define-fun dynamic_invariant7 ((temp___expr_250 Int) (temp___is_init_246 Bool) (temp___skip_constant_247 Bool) (temp___do_toplevel_248 Bool) (temp___do_typ_inv_249 Bool)) Bool (=> (or (= temp___is_init_246 true) (<= 1 64)) (in_range10 temp___expr_250)))
(define-fun dynamic_invariant8 ((temp___expr_159 Int) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool) (temp___do_typ_inv_158 Bool)) Bool (=> (or (= temp___is_init_155 true) (<= 2000 2099)) (in_range4 temp___expr_159)))
(define-fun dynamic_invariant9 ((temp___expr_166 Int) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool (=> (or (= temp___is_init_162 true) (<= 1 12)) (in_range5 temp___expr_166)))
(define-fun dynamic_invariant10 ((temp___expr_173 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool) (temp___do_typ_inv_172 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= 1 31)) (in_range6 temp___expr_173)))
(define-fun dynamic_invariant11 ((temp___expr_180 Int) (temp___is_init_176 Bool) (temp___skip_constant_177 Bool) (temp___do_toplevel_178 Bool) (temp___do_typ_inv_179 Bool)) Bool (=> (or (= temp___is_init_176 true) (<= 0 23)) (in_range7 temp___expr_180)))
(define-fun dynamic_invariant12 ((temp___expr_187 Int) (temp___is_init_183 Bool) (temp___skip_constant_184 Bool) (temp___do_toplevel_185 Bool) (temp___do_typ_inv_186 Bool)) Bool (=> (or (= temp___is_init_183 true) (<= 0 59)) (in_range8 temp___expr_187)))
(define-fun dynamic_invariant13 ((temp___expr_194 Int) (temp___is_init_190 Bool) (temp___skip_constant_191 Bool) (temp___do_toplevel_192 Bool) (temp___do_typ_inv_193 Bool)) Bool (=> (or (= temp___is_init_190 true) (<= 0 59)) (in_range9 temp___expr_194)))
(declare-const rliteral event_index_type)
(assert (= (event_index_typeqtint rliteral) 1))
...
(declare-const temp___408 event_index_type)
(declare-const temp___4081 Bool)
(declare-const o event_index_type)
(declare-const o1 event_index_type)
(declare-const o2 Bool)
(declare-const temp___407 event_index_type)
(declare-const temp___4071 Bool)
(declare-const o3 Int)
(declare-const o4 Int)
(declare-const temp___418 Int)
(declare-const o5 character)
(declare-const o6 Int)
(declare-const o7 (Array Int character))
(declare-const o8 (Array Int character))
(declare-const o9 description_count_type)
(declare-const o10 day_type)
(declare-const o11 month_type)
(declare-const o12 year_type)
(declare-const o13 hour_type)
(declare-const o14 minute_type)
(declare-const o15 second_type)
(declare-const o16 Bool)
(declare-const o17 (Array Int character))
(declare-const o18 description_count_type)
(declare-const o19 day_type)
(declare-const o20 month_type)
(declare-const o21 year_type)
(declare-const o22 hour_type)
(declare-const o23 minute_type)
(declare-const o24 second_type)
(declare-const o25 Bool)
(declare-const o26 (Array Int us_rep3))
...
(assert (dynamic_invariant description true false true true))
(assert (=> (<= 0 3) (in_range13 status)))
(assert (= result (mk___split_fields__ref4 (mk___split_fields4 find_result__split_fields find_result__split_fields1))))
(assert (= find_result__split_fields2 (mk___split_fields4 rliteral (distinct 0 0))))
(assert (not (< 128 (length description))))
(assert (= result1 (mk_int__ref i)))
(assert (= i2 1))
(assert (=> (and (<= 1 i2) (<= i2 64)) (= temp___409 i2)))
(assert (=> (and (<= 1 i2) (<= i2 64)) (= (mk___split_fields4 temp___408 temp___4081) find_result__split_fields2)))
(assert (=> (and (<= 1 i2) (<= i2 64)) (<= (length description) 128)))
(assert (=> (and (<= 1 i2) (<= i2 64)) (and (=> (<= 1 64) (in_range10 i3)) (and (<= 1 i3) (<= i3 64)))))
(assert (=> (and (<= 1 i2) (<= i2 64)) (or (and (and (= find_result__split_fields5 (mk___split_fields__ref4 find_result__split_fields4)) (= find_result__split_fields6 find_result__split_fields4)) (and (not (= (rec__datebooks__event_record__is_used (us_split_fields7 (select book i3))) true)) (and (and (and (= (to_rep8 o) i3) (and (= o o1) (= (distinct 1 0) o2))) (and (= temp___407 o1) (= temp___4071 o2))) (and (= result2 (mk___split_fields__ref4 find_result__split_fields3)) (= find_result__split_fields4 (mk___split_fields4 temp___407 temp___4071)))))) (and (and (= (rec__datebooks__event_record__is_used (us_split_fields7 (select book i3))) true) (= find_result__split_fields4 find_result__split_fields3)) (and (and (= find_result__split_fields5 (mk___split_fields__ref4 find_result__split_fields4)) (= find_result__split_fields6 find_result__split_fields4)) (= i3 64))))))
(assert (=> (and (<= 1 i2) (<= i2 64)) (= i4 (mk_int__ref i3))))
(assert (=> (and (<= 1 i2) (<= i2 64)) (= find_result__split_fields7 find_result__split_fields5)))
(assert (=> (and (<= 1 i2) (<= i2 64)) (= i5 i3)))
(assert (=> (and (<= 1 i2) (<= i2 64)) (= find_result__split_fields8 find_result__split_fields6)))
(assert (=> (and (<= 1 i2) (<= i2 64)) (= i6 i4)))
(assert (=> (and (<= 1 i2) (<= i2 64)) (= find_result__split_fields9 find_result__split_fields7)))
(assert (=> (and (<= 1 i2) (<= i2 64)) (= i7 i5)))
(assert (=> (and (<= 1 i2) (<= i2 64)) (= find_result__split_fields10 find_result__split_fields8)))
(assert (=> (not (and (<= 1 i2) (<= i2 64))) (= i6 (mk_int__ref i2))))
(assert (=> (not (and (<= 1 i2) (<= i2 64))) (= find_result__split_fields9 (mk___split_fields__ref4 find_result__split_fields2))))
(assert (=> (not (and (<= 1 i2) (<= i2 64))) (= i7 i2)))
(assert (=> (not (and (<= 1 i2) (<= i2 64))) (= find_result__split_fields10 find_result__split_fields2)))
(assert (= (rec__datebooks__add_event__find_result_record__found_slot (us_split_fields__content4 find_result__split_fields9)) true))
(assert (= result3 (mk_map__ref1 book)))
(assert (= book1 (store book (to_rep8 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields9))) (mk___rep3 (mk___split_fields3 (temp_____aggregate_def_410 32) (rec__datebooks__event_record__description_size (us_split_fields7 (select book (to_rep8 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields9)))))) (rec__datebooks__event_record__date (us_split_fields7 (select book (to_rep8 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields9)))))) (rec__datebooks__event_record__is_used (us_split_fields7 (select book (to_rep8 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields9)))))))))))
(assert (= result4 (mk_int__ref i1)))
(assert (= i8 (to_rep1 (first (rt description)))))
(assert (<= (to_rep1 (first (rt description))) i8))
(assert (<= i8 (to_rep1 (last (rt description)))))
(assert (and (and (in_range10 (to_rep8 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields9)))) (<= (length description) 128)) (< (- i9 (to_rep1 (first (rt description)))) 128)))
(assert (and (and (forall ((temp___421 Int)) (=> (and (<= 1 temp___421) (<= temp___421 64)) (ite (not (= (to_rep8 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields9))) temp___421)) (= (select book2 temp___421) (select book1 temp___421)) (and (and (= (rec__datebooks__event_record__description_size (us_split_fields7 (select book2 temp___421))) (rec__datebooks__event_record__description_size (us_split_fields7 (select book1 temp___421)))) (= (rec__datebooks__event_record__date (us_split_fields7 (select book2 temp___421))) (rec__datebooks__event_record__date (us_split_fields7 (select book1 temp___421))))) (= (rec__datebooks__event_record__is_used (us_split_fields7 (select book2 temp___421))) (rec__datebooks__event_record__is_used (us_split_fields7 (select book1 temp___421)))))))) (=> (<= (to_rep1 (first (rt description))) (to_rep1 (last (rt description)))) (dynamic_property1 (to_rep1 (first (rt description))) (to_rep1 (last (rt description))) i9))) (and (<= (to_rep1 (first (rt description))) i9) (<= i9 (to_rep1 (last (rt description)))))))
(assert (= (to_rep o5) (to_rep (select (elts description) i9))))
(assert (and (= o3 (- i9 (to_rep1 (first (rt description))))) (in_range1 (- i9 (to_rep1 (first (rt description)))))))
(assert (= o4 (+ 1 o3)))
(assert (and (= temp___418 o4) (in_range1 o4)))
(assert (and (<= 1 temp___418) (<= temp___418 128)))
(assert (= o6 temp___418))
(assert (= o7 (store (rec__datebooks__event_record__description_text (us_split_fields7 (select book2 (to_rep8 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields9)))))) o6 o5)))
(assert (= o7 o8))
(assert (= (rec__datebooks__event_record__description_size (us_split_fields7 (select book2 (to_rep8 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields9)))))) o9))
(assert (= (rec__datebooks__event_record__date (us_split_fields7 (select book2 (to_rep8 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields9)))))) (mk___rep2 (mk___split_fields2 (mk___rep (mk___split_fields o10 o11 o12)) (mk___rep1 (mk___split_fields1 o13 o14 o15))))))
(assert (= (rec__datebooks__event_record__is_used (us_split_fields7 (select book2 (to_rep8 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields9)))))) o16))
(assert (= o17 o8))
(assert (= o18 o9))
(assert (= o19 o10))
(assert (= o20 o11))
...
(assert (= o24 o15))
(assert (= o25 o16))
(assert (= o26 (store book2 (to_rep8 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields9))) (mk___rep3 (mk___split_fields3 o17 o18 (mk___rep2 (mk___split_fields2 (mk___rep (mk___split_fields o19 o20 o21)) (mk___rep1 (mk___split_fields1 o22 o23 o24)))) o25)))))
(assert (= result5 (mk_map__ref1 book2)))
(assert (= book3 o26))
(assert (not (= i9 (to_rep1 (last (rt description))))))
(assert (= result6 (mk_int__ref i9)))
(assert (= i10 (+ i9 1)))
(assert (= i11 (mk_int__ref i10)))
(assert (= book4 (mk_map__ref1 book3)))
(assert (= i12 i10))
(assert (= book5 book3))
(assert (not (<= (length description) 128)))
(check-sat)
(exit)
