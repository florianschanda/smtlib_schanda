...
(define-fun dynamic_invariant1 ((temp___expr_196 Int) (temp___is_init_192 Bool) (temp___skip_constant_193 Bool) (temp___do_toplevel_194 Bool) (temp___do_typ_inv_195 Bool)) Bool (=> (or (= temp___is_init_192 true) (<= 0 1)) (in_range1 temp___expr_196)))
...
(assert (forall ((t us_rep4)) (! (=> (and (dynamic_invariant4 t true true true true) (type_invariant1 t)) (dynamic_invariant2 (size1 t) true false true true)) :pattern ((size1 t)))))
(assert (forall ((t us_rep4)) (! (=> (dynamic_invariant4 t true true true true) (= (size1 t) (size (rec__search_trees__search_tree__struct (us_split_fields7 t))))) :pattern ((size1 t)))))
...
(assert (forall ((t us_rep4)) (! (=> (and (and (dynamic_invariant4 t true true true true) (type_invariant1 t)) (not (= (size1 t) 0))) (dynamic_invariant5 (model__ t) true false true true)) :pattern ((model__ t)))))
(assert (forall ((t us_rep4)) (! (=> (dynamic_invariant4 t true true true true) (= (model__ t) (model__1 (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t)))))) :pattern ((model__ t)))))
...
(assert (forall ((temp___433 Int)) (=> (dynamic_invariant6 temp___433 true true true true) (forall ((temp___434 Int)) (= (to_rep2 (select (temp___431 temp___433) temp___434)) temp___433)))))
...
(assert true)
(assert (forall ((f us_rep3)) (forall ((root Int)) (forall ((values (Array Int natural))) (! (= (= (ordered_leafs f root values) true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (let ((temp___526 (model__1 f root))) (select temp___526 i1)))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (let ((temp___527 (model__1 f root))) (select temp___527 j)))) true)) (= (olt (rec__tree_model__path_type__a (us_split_fields1 (let ((temp___528 (model__1 f root))) (select temp___528 i1)))) (rec__tree_model__path_type__a (us_split_fields1 (let ((temp___529 (model__1 f root))) (select temp___529 j))))) true)) (ite (= (get (rec__tree_model__path_type__a (us_split_fields1 (let ((temp___524 (model__1 f root))) (select temp___524 j)))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (let ((temp___525 (model__1 f root))) (select temp___525 i1))))) 1)) 0) (< (to_rep2 (select values j)) (to_rep2 (select values i1))) (< (to_rep2 (select values i1)) (to_rep2 (select values j)))))))))) :pattern ((ordered_leafs f root values)))))))
(define-fun dynamic_invariant7 ((temp___expr_189 Int) (temp___is_init_185 Bool) (temp___skip_constant_186 Bool) (temp___do_toplevel_187 Bool) (temp___do_typ_inv_188 Bool)) Bool (=> (or (= temp___is_init_185 true) (<= 0 2)) (in_range3 temp___expr_189)))
...
(define-fun default_initial_assumption4 ((temp___expr_232 us_rep) (temp___skip_top_level_233 Bool)) Bool (=> (not (= temp___skip_top_level_233 true)) (= (length temp___expr_232) 0)))
...
(assert (forall ((f us_rep3)) (! (=> (dynamic_invariant3 f true true true true) (dynamic_invariant2 (size f) true false true true)) :pattern ((size f)))))
(assert (forall ((f us_rep3)) (forall ((i1 Int)) (! (=> (and (dynamic_invariant3 f true true true true) (dynamic_invariant i1 true true true true)) (=> (< (size f) i1) (not (= (valid_root f i1) true)))) :pattern ((valid_root f i1))))))
(assert (forall ((f us_rep3)) (forall ((i1 Int)) (! (=> (and (dynamic_invariant3 f true true true true) (dynamic_invariant i1 true true true true)) (let ((result (parent f i1))) (and (and (=> (= (valid_root f i1) true) (= result 0)) (=> (= (size f) 0) (= result 0))) (dynamic_invariant2 result true false true true)))) :pattern ((parent f i1))))))
(assert (forall ((f us_rep3)) (forall ((i1 Int)) (! (=> (and (and (dynamic_invariant3 f true true true true) (dynamic_invariant i1 true true true true)) (not (= (parent f i1) 0))) (dynamic_invariant1 (position f i1) true false true true)) :pattern ((position f i1))))))
(assert (forall ((f us_rep3)) (forall ((root Int)) (! (=> (and (and (dynamic_invariant3 f true true true true) (dynamic_invariant root true true true true)) (= (valid_root f root) true)) (let ((result (model__1 f root))) (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select result root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select result root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent f i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select result (parent f i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select result i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select result i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select result i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select result (parent f i1)))) (position f i1) (rec__tree_model__path_type__a (us_split_fields1 (select result i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select result i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select result i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select result j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select result i1))) (rec__tree_model__path_type__a (us_split_fields1 (select result j)))) true)) (= j i1))))))))))) (dynamic_invariant5 result true false true true)))) :pattern ((model__1 f root))))))
