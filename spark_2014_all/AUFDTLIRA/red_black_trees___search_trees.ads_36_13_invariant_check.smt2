...
(assert (forall ((x extended_index_type)) (! (in_range (to_rep x)) :pattern ((to_rep x)))))
...
(assert (forall ((x position_type)) (! (in_range1 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(declare-fun peek (us_rep1 Int Int) Int)
(declare-fun peek__function_guard (Int us_rep1 Int Int) Bool)
...
(define-fun dynamic_invariant1 ((temp___expr_182 Int) (temp___is_init_178 Bool) (temp___skip_constant_179 Bool) (temp___do_toplevel_180 Bool) (temp___do_typ_inv_181 Bool)) Bool (=> (or (= temp___is_init_178 true) (<= 0 100)) (in_range temp___expr_182)))
...
(define-fun dynamic_invariant4 ((temp___expr_420 us_rep2) (temp___is_init_416 Bool) (temp___skip_constant_417 Bool) (temp___do_toplevel_418 Bool) (temp___do_typ_inv_419 Bool)) Bool (=> (= temp___do_typ_inv_419 true) (= (tree_structure (rec__search_trees__search_tree__struct (us_split_fields5 temp___expr_420))) true)))
(define-fun default_initial_assumption1 ((temp___expr_424 us_rep2) (temp___skip_top_level_425 Bool)) Bool (and (and (and (= (to_rep (rec__search_trees__search_tree__root (us_split_fields5 temp___expr_424))) 0) (and (and (= (to_rep (rec__binary_trees__forest__s (us_split_fields3 (rec__search_trees__search_tree__struct (us_split_fields5 temp___expr_424))))) 0) (forall ((temp___428 Int)) (=> (and (<= 1 temp___428) (<= temp___428 100)) (and (and (and (= (to_rep (rec__binary_trees__cell__left (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 (rec__search_trees__search_tree__struct (us_split_fields5 temp___expr_424)))) temp___428)))) 0) (= (to_rep (rec__binary_trees__cell__right (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 (rec__search_trees__search_tree__struct (us_split_fields5 temp___expr_424)))) temp___428)))) 0)) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 (rec__search_trees__search_tree__struct (us_split_fields5 temp___expr_424)))) temp___428)))) 0)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 (rec__search_trees__search_tree__struct (us_split_fields5 temp___expr_424)))) temp___428)))) 2))))) (= (size (rec__search_trees__search_tree__struct (us_split_fields5 temp___expr_424))) 0))) (= (rec__search_trees__search_tree__values (us_split_fields5 temp___expr_424)) (temp_____aggregate_def_431 0))) (=> (not (= temp___skip_top_level_425 true)) (= (size1 temp___expr_424) 0))))
(define-fun type_invariant1 ((temp___436 us_rep2)) Bool (ite (= (size (rec__search_trees__search_tree__struct (us_split_fields5 temp___436))) 0) (= (to_rep (rec__search_trees__search_tree__root (us_split_fields5 temp___436))) 0) (and (and (not (= (to_rep (rec__search_trees__search_tree__root (us_split_fields5 temp___436))) 0)) (= (valid_root (rec__search_trees__search_tree__struct (us_split_fields5 temp___436)) (to_rep (rec__search_trees__search_tree__root (us_split_fields5 temp___436)))) true)) (= (ordered_leafs (rec__search_trees__search_tree__struct (us_split_fields5 temp___436)) (to_rep (rec__search_trees__search_tree__root (us_split_fields5 temp___436))) (rec__search_trees__search_tree__values (us_split_fields5 temp___436))) true))))
(assert (forall ((t us_rep2)) (! (=> (and (dynamic_invariant4 t true true true true) (type_invariant1 t)) (dynamic_invariant1 (size1 t) true false true true)) :pattern ((size1 t)))))
(assert (forall ((t us_rep2)) (! (=> (dynamic_invariant4 t true true true true) (= (size1 t) (size (rec__search_trees__search_tree__struct (us_split_fields5 t))))) :pattern ((size1 t)))))
...
(define-fun bool_eq6 ((a us_rep4) (b us_rep4)) Bool (ite (and (= (user_eq10 (rec__tree_model__path_type__a (us_split_fields7 a)) (rec__tree_model__path_type__a (us_split_fields7 b))) true) (= (rec__tree_model__path_type__k (us_split_fields7 a)) (rec__tree_model__path_type__k (us_split_fields7 b)))) true false))
...
(define-fun dynamic_invariant5 ((temp___expr_251 (Array Int us_rep4)) (temp___is_init_247 Bool) (temp___skip_constant_248 Bool) (temp___do_toplevel_249 Bool) (temp___do_typ_inv_250 Bool)) Bool (forall ((temp___252 Int)) (=> (and (<= 1 temp___252) (<= temp___252 100)) (=> (= temp___is_init_247 true) (< (length (rec__tree_model__path_type__a (us_split_fields7 (select temp___expr_251 temp___252)))) 100)))))
(define-fun default_initial_assumption2 ((temp___expr_254 (Array Int us_rep4)) (temp___skip_top_level_255 Bool)) Bool (forall ((temp___256 Int)) (=> (and (<= 1 temp___256) (<= temp___256 100)) (and (= (length (rec__tree_model__path_type__a (us_split_fields7 (select temp___expr_254 temp___256)))) 0) (= (rec__tree_model__path_type__k (us_split_fields7 (select temp___expr_254 temp___256))) (distinct 0 0))))))
(assert (forall ((t us_rep2)) (! (=> (and (and (dynamic_invariant4 t true true true true) (type_invariant1 t)) (not (= (size1 t) 0))) (dynamic_invariant5 (model__ t) true false true true)) :pattern ((model__ t)))))
(assert (forall ((t us_rep2)) (! (=> (dynamic_invariant4 t true true true true) (= (model__ t) (model__1 (rec__search_trees__search_tree__struct (us_split_fields5 t)) (to_rep (rec__search_trees__search_tree__root (us_split_fields5 t)))))) :pattern ((model__ t)))))
...
(define-fun dynamic_invariant6 ((temp___expr_39 Int) (temp___is_init_35 Bool) (temp___skip_constant_36 Bool) (temp___do_toplevel_37 Bool) (temp___do_typ_inv_38 Bool)) Bool (=> (or (= temp___is_init_35 true) (<= 0 2147483647)) (in_range4 temp___expr_39)))
(declare-const rliteral natural)
(assert (= (naturalqtint rliteral) 0))
(assert (forall ((temp___433 Int)) (=> (dynamic_invariant6 temp___433 true true true true) (forall ((temp___434 Int)) (= (select (temp_____aggregate_def_431 temp___433) temp___434) rliteral)))))
...
(assert true)
(assert (forall ((f us_rep1)) (forall ((root Int)) (forall ((values (Array Int natural))) (! (= (= (ordered_leafs f root values) true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields7 (let ((temp___526 (model__1 f root))) (select temp___526 i1)))) true) (= (rec__tree_model__path_type__k (us_split_fields7 (let ((temp___527 (model__1 f root))) (select temp___527 j)))) true)) (= (olt (rec__tree_model__path_type__a (us_split_fields7 (let ((temp___528 (model__1 f root))) (select temp___528 i1)))) (rec__tree_model__path_type__a (us_split_fields7 (let ((temp___529 (model__1 f root))) (select temp___529 j))))) true)) (ite (= (get (rec__tree_model__path_type__a (us_split_fields7 (let ((temp___524 (model__1 f root))) (select temp___524 j)))) (+ (length (rec__tree_model__path_type__a (us_split_fields7 (let ((temp___525 (model__1 f root))) (select temp___525 i1))))) 1)) 0) (< (to_rep2 (select values j)) (to_rep2 (select values i1))) (< (to_rep2 (select values i1)) (to_rep2 (select values j)))))))))) :pattern ((ordered_leafs f root values)))))))
(define-fun dynamic_invariant7 ((temp___expr_189 Int) (temp___is_init_185 Bool) (temp___skip_constant_186 Bool) (temp___do_toplevel_187 Bool) (temp___do_typ_inv_188 Bool)) Bool (=> (or (= temp___is_init_185 true) (<= 0 2)) (in_range1 temp___expr_189)))
(define-fun dynamic_invariant8 ((temp___expr_239 us_rep4) (temp___is_init_235 Bool) (temp___skip_constant_236 Bool) (temp___do_toplevel_237 Bool) (temp___do_typ_inv_238 Bool)) Bool (=> (= temp___do_toplevel_237 true) (=> (= temp___is_init_235 true) (< (length (rec__tree_model__path_type__a (us_split_fields7 temp___expr_239))) 100))))
(define-fun default_initial_assumption3 ((temp___expr_241 us_rep4) (temp___skip_top_level_242 Bool)) Bool (and (= (length (rec__tree_model__path_type__a (us_split_fields7 temp___expr_241))) 0) (= (rec__tree_model__path_type__k (us_split_fields7 temp___expr_241)) (distinct 0 0))))
(define-fun dynamic_predicate ((temp___245 us_rep4)) Bool (< (length (rec__tree_model__path_type__a (us_split_fields7 temp___245))) 100))
...
(define-fun default_initial_assumption4 ((temp___expr_232 us_rep3) (temp___skip_top_level_233 Bool)) Bool (=> (not (= temp___skip_top_level_233 true)) (= (length temp___expr_232) 0)))
(assert true)
(assert (forall ((s1 us_rep3) (s2 us_rep3)) (forall ((d1 Int)) (! (= (= (is_add s1 d1 s2) true) (and (and (= (- (length s2) 1) (length s1)) (= (olt s1 s2) true)) (= (get s2 (length s2)) d1))) :pattern ((is_add s1 d1 s2))))))
...
(assert (forall ((f us_rep1)) (! (=> (dynamic_invariant3 f true true true true) (dynamic_invariant1 (size f) true false true true)) :pattern ((size f)))))
(assert (forall ((f us_rep1)) (forall ((i1 Int)) (! (=> (and (dynamic_invariant3 f true true true true) (dynamic_invariant i1 true true true true)) (=> (< (size f) i1) (not (= (valid_root f i1) true)))) :pattern ((valid_root f i1))))))
(assert (forall ((f us_rep1)) (forall ((i1 Int)) (! (=> (and (dynamic_invariant3 f true true true true) (dynamic_invariant i1 true true true true)) (let ((result (parent f i1))) (and (and (=> (= (valid_root f i1) true) (= result 0)) (=> (= (size f) 0) (= result 0))) (dynamic_invariant1 result true false true true)))) :pattern ((parent f i1))))))
(assert (forall ((f us_rep1)) (forall ((i1 Int)) (! (=> (and (and (dynamic_invariant3 f true true true true) (dynamic_invariant i1 true true true true)) (not (= (parent f i1) 0))) (dynamic_invariant2 (position f i1) true false true true)) :pattern ((position f i1))))))
(assert (forall ((f us_rep1)) (forall ((root Int)) (! (=> (and (and (dynamic_invariant3 f true true true true) (dynamic_invariant root true true true true)) (= (valid_root f root) true)) (let ((result (model__1 f root))) (and (and (= (rec__tree_model__path_type__k (us_split_fields7 (select result root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields7 (select result root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent f i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields7 (select result (parent f i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields7 (select result i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields7 (select result i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields7 (select result i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields7 (select result (parent f i1)))) (position f i1) (rec__tree_model__path_type__a (us_split_fields7 (select result i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields7 (select result i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select result i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields7 (select result j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields7 (select result i1))) (rec__tree_model__path_type__a (us_split_fields7 (select result j)))) true)) (= j i1))))))))))) (dynamic_invariant5 result true false true true)))) :pattern ((model__1 f root))))))
