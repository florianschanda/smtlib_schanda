...
(declare-fun user_eq1 (direction direction) Bool)
(declare-const dummy1 direction)
...
(define-fun dynamic_invariant1 ((temp___expr_168 Int) (temp___is_init_165 Bool) (temp___skip_constant_166 Bool) (temp___do_toplevel_167 Bool)) Bool (=> (or (= temp___is_init_165 true) (<= 0 1)) (in_range1 temp___expr_168)))
...
(define-fun dynamic_invariant3 ((temp___expr_273 us_rep3) (temp___is_init_270 Bool) (temp___skip_constant_271 Bool) (temp___do_toplevel_272 Bool)) Bool (= (tree_structure temp___expr_273) true))
(define-fun default_initial_assumption ((temp___expr_276 us_rep3) (temp___skip_top_level_277 Bool)) Bool (and (and (= (to_rep (rec__binary_trees__forest__s (us_split_fields5 temp___expr_276))) 0) (forall ((temp___279 Int)) (=> (and (<= 1 temp___279) (<= temp___279 100)) (and (and (and (= (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 temp___expr_276)) temp___279)))) 0) (= (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 temp___expr_276)) temp___279)))) 0)) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 temp___expr_276)) temp___279)))) 0)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 temp___expr_276)) temp___279)))) 2))))) (=> (not (= temp___skip_top_level_277 true)) (= (size temp___expr_276) 0))))
...
(assert (forall ((t us_rep4)) (! (=> (and (dynamic_invariant4 t true true true) (type_invariant1 t)) (dynamic_invariant2 (size1 t) true false true)) :pattern ((size1 t)))))
(assert (forall ((t us_rep4)) (! (=> (dynamic_invariant4 t true true true) (= (size1 t) (size (rec__search_trees__search_tree__struct (us_split_fields7 t))))) :pattern ((size1 t)))))
...
(assert (forall ((t us_rep4)) (! (=> (and (and (dynamic_invariant4 t true true true) (type_invariant1 t)) (not (= (size1 t) 0))) (dynamic_invariant5 (model__ t) true false true)) :pattern ((model__ t)))))
(assert (forall ((t us_rep4)) (! (=> (dynamic_invariant4 t true true true) (= (model__ t) (model__1 (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t)))))) :pattern ((model__ t)))))
...
(define-fun dynamic_invariant6 ((temp___expr_33 Int) (temp___is_init_30 Bool) (temp___skip_constant_31 Bool) (temp___do_toplevel_32 Bool)) Bool (=> (or (= temp___is_init_30 true) (<= 0 2147483647)) (in_range4 temp___expr_33)))
...
(assert true)
(assert (forall ((f us_rep3)) (forall ((root Int)) (forall ((values (Array Int natural))) (! (= (= (ordered_leafs f root values) true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (let ((temp___482 (model__1 f root))) (select temp___482 i1)))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (let ((temp___483 (model__1 f root))) (select temp___483 j)))) true)) (= (olt (rec__tree_model__path_type__a (us_split_fields1 (let ((temp___484 (model__1 f root))) (select temp___484 i1)))) (rec__tree_model__path_type__a (us_split_fields1 (let ((temp___485 (model__1 f root))) (select temp___485 j))))) true)) (ite (= (get (rec__tree_model__path_type__a (us_split_fields1 (let ((temp___480 (model__1 f root))) (select temp___480 j)))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (let ((temp___481 (model__1 f root))) (select temp___481 i1))))) 1)) 0) (< (to_rep2 (select values j)) (to_rep2 (select values i1))) (< (to_rep2 (select values i1)) (to_rep2 (select values j)))))))))) :pattern ((ordered_leafs f root values)))))))
(define-fun dynamic_invariant7 ((temp___expr_162 Int) (temp___is_init_159 Bool) (temp___skip_constant_160 Bool) (temp___do_toplevel_161 Bool)) Bool (=> (or (= temp___is_init_159 true) (<= 0 2)) (in_range3 temp___expr_162)))
...
(define-fun default_initial_assumption4 ((temp___expr_199 us_rep) (temp___skip_top_level_200 Bool)) Bool (=> (not (= temp___skip_top_level_200 true)) (= (length temp___expr_199) 0)))
...
(assert (forall ((f us_rep3)) (! (=> (dynamic_invariant3 f true true true) (dynamic_invariant2 (size f) true false true)) :pattern ((size f)))))
(assert (forall ((f us_rep3)) (forall ((i1 Int)) (! (=> (and (dynamic_invariant3 f true true true) (dynamic_invariant i1 true true true)) (=> (< (size f) i1) (not (= (valid_root f i1) true)))) :pattern ((valid_root f i1))))))
(assert (forall ((f us_rep3)) (forall ((i1 Int)) (! (=> (and (dynamic_invariant3 f true true true) (dynamic_invariant i1 true true true)) (let ((result (parent f i1))) (and (and (=> (= (valid_root f i1) true) (= result 0)) (=> (= (size f) 0) (= result 0))) (dynamic_invariant2 result true false true)))) :pattern ((parent f i1))))))
(assert (forall ((f us_rep3)) (forall ((i1 Int)) (! (=> (and (and (dynamic_invariant3 f true true true) (dynamic_invariant i1 true true true)) (not (= (parent f i1) 0))) (dynamic_invariant1 (position f i1) true false true)) :pattern ((position f i1))))))
(assert (forall ((f us_rep3)) (forall ((root Int)) (! (=> (and (and (dynamic_invariant3 f true true true) (dynamic_invariant root true true true)) (= (valid_root f root) true)) (let ((result (model__1 f root))) (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select result root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select result root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent f i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select result (parent f i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select result i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select result i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select result i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select result (parent f i1)))) (position f i1) (rec__tree_model__path_type__a (us_split_fields1 (select result i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select result i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select result i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select result j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select result i1))) (rec__tree_model__path_type__a (us_split_fields1 (select result j)))) true)) (= j i1))))))))))) (dynamic_invariant5 result true false true)))) :pattern ((model__1 f root))))))
