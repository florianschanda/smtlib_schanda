...
(declare-const i Int)
(declare-const temp___276 (Array Int integer))
(declare-const temp___274 Int)
(declare-const temp___271 (Array Int integer))
(declare-const temp___279 (Array Int integer))
(declare-const j Int)
(declare-const o Int)
...
(assert (= i1 0))
(assert (=> (and (<= 0 i1) (<= i1 (- length1 1))) (= temp___276 b)))
(assert (=> (and (<= 0 i1) (<= i1 (- length1 1))) (= temp___274 i1)))
(assert (=> (and (<= 0 i1) (<= i1 (- length1 1))) (= temp___271 b)))
(assert (=> (and (<= 0 i1) (<= i1 (- length1 1))) (= temp___279 b)))
(assert (=> (and (<= 0 i1) (<= i1 (- length1 1))) (forall ((j1 Int)) (=> (and (<= (to_rep b__first) j1) (<= j1 (to_rep b__last))) (and (=> (and (<= b_first j1) (<= j1 (- (+ b_first i2) 1))) (= (to_rep (select b2 j1)) (to_rep (select (elts a) (- (+ a_first j1) b_first))))) (=> (=> (<= b_first j1) (not (<= j1 (- (+ b_first i2) 1)))) (= (to_rep (select b2 j1)) (to_rep (select temp___279 j1)))))))))
(assert (=> (and (<= 0 i1) (<= i1 (- length1 1))) (and (=> (<= 0 (- length1 1)) (dynamic_property1 0 (- length1 1) i2)) (and (<= 0 i2) (<= i2 (- length1 1))))))
(assert (=> (and (<= 0 i1) (<= i1 (- length1 1))) (forall ((j1 Int)) (=> (and (<= (to_rep b__first) j1) (<= j1 (to_rep b__last))) (and (=> (and (<= b_first j1) (<= j1 (- (+ b_first (+ i2 1)) 1))) (= (to_rep (select b3 j1)) (to_rep (select (elts a) (- (+ a_first j1) b_first))))) (=> (=> (<= b_first j1) (not (<= j1 (- (+ b_first (+ i2 1)) 1)))) (= (to_rep (select b3 j1)) (to_rep (select temp___271 j1)))))))))
(assert (=> (and (<= 0 i1) (<= i1 (- length1 1))) (=> (<= 0 (- length1 1)) (dynamic_property1 0 (- length1 1) i2))))
(assert (=> (and (<= 0 i1) (<= i1 (- length1 1))) (= i2 (- length1 1))))
(assert (=> (and (<= 0 i1) (<= i1 (- length1 1))) (= i2 i3)))
(assert (=> (and (<= 0 i1) (<= i1 (- length1 1))) (= b3 b4)))
(assert (=> (and (<= 0 i1) (<= i1 (- length1 1))) (= i4 i2)))
(assert (=> (and (<= 0 i1) (<= i1 (- length1 1))) (= b5 b3)))
(assert (=> (and (<= 0 i1) (<= i1 (- length1 1))) (= i9 (mk_int__ref i3))))
(assert (=> (and (<= 0 i1) (<= i1 (- length1 1))) (= b10 (mk_map__ref b4))))
(assert (=> (and (<= 0 i1) (<= i1 (- length1 1))) (= i6 i4)))
(assert (=> (and (<= 0 i1) (<= i1 (- length1 1))) (= b7 b5)))
(assert (=> (not (and (<= 0 i1) (<= i1 (- length1 1)))) (= i1 i5)))
(assert (=> (not (and (<= 0 i1) (<= i1 (- length1 1)))) (= b10 (mk_map__ref b))))
(assert (=> (not (and (<= 0 i1) (<= i1 (- length1 1)))) (= i6 i1)))
(assert (=> (not (and (<= 0 i1) (<= i1 (- length1 1)))) (= b7 b1)))
(assert (= (mk_int__ref i7) i9))
(assert (= (mk_map__ref b8) b10))
(assert (= i8 i6))
(assert (= b9 b7))
(assert (<= (to_rep b__first) j))
(assert (<= j (to_rep b__last)))
(assert (and (= o5 (+ b_first length1)) (in_range1 (+ b_first length1))))
(assert (= o6 (- o5 1)))
(assert (= o7 (ite (<= j o6) true false)))
(assert (= o8 (ite (<= b_first j) o7 false)))
(assert (= result1 (ite (not (= o8 true)) true false)))
(assert (=> (= result1 true) (and (<= (to_rep b__first) j) (<= j (to_rep b__last)))))
(assert (=> (= result1 true) (= o11 j)))
(assert (=> (= result1 true) (= o12 (select b o11))))
(assert (=> (= result1 true) (= o13 (to_rep o12))))
(assert (=> (= result1 true) (and (<= (to_rep b__first) j) (<= j (to_rep b__last)))))
(assert (=> (= result1 true) (= o9 j)))
(assert (=> (= result1 true) (= o10 (select b8 o9))))
(assert (=> (= result1 true) (= o14 (to_rep o10))))
(assert (=> (= result1 true) (= o15 (ite (= o14 o13) true false))))
(assert (=> (not (= result1 true)) (= o15 (distinct 1 0))))
(assert (and (= o (+ b_first length1)) (in_range1 (+ b_first length1))))
(assert (= o1 (- o 1)))
(assert (= o2 (ite (<= j o1) true false)))
(assert (= result2 (ite (<= b_first j) o2 false)))
(assert (= result2 true))
(assert (and (= o3 (+ a_first j)) (in_range1 (+ a_first j))))
(assert (= o4 (- o3 b_first)))
(assert (and (= temp___280 o4) (in_range1 o4)))
(assert (not (<= (to_rep (first (rt a))) temp___280)))
(check-sat)
(exit)
