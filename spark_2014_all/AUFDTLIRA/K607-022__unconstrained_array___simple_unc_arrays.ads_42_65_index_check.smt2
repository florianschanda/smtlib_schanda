...
(assert (= i8 i6))
(assert (= res9 res7))
(assert (= (= result5 true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))))) (<= simple_unc_arrays__min__result4 (to_rep2 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) j1)))))))
(assert (= result5 true))
(assert (<= 1 j))
