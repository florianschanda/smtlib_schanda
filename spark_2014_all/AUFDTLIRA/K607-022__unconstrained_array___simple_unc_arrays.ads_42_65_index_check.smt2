...
(assert (= i1 2))
(assert (=> (and (<= 2 i1) (<= i1 r25b)) (= temp___929 res1)))
(assert (=> (and (<= 2 i1) (<= i1 r25b)) (= temp___928 i1)))
(assert (=> (and (<= 2 i1) (<= i1 r25b)) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- i2 1))) (<= res2 (to_rep1 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) j1)))))))
(assert (=> (and (<= 2 i1) (<= i1 r25b)) (and (and (=> (<= 2 r25b) (dynamic_property2 2 r25b i2)) (=> (<= (- 2147483648) 2147483647) (in_range2 res2))) (and (<= 2 i2) (<= i2 r25b)))))
(assert (=> (and (<= 2 i1) (<= i1 r25b)) (and (<= (to_rep2 (first (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))) i2) (<= i2 (to_rep2 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a)))))))))
...
(assert (=> (and (<= 2 i1) (<= i1 r25b)) (=> (= result2 true) (and (<= (to_rep2 (first (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))) i2) (<= i2 (to_rep2 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))))))))
...
(assert (=> (and (<= 2 i1) (<= i1 r25b)) (=> (= result2 true) (= o8 (to_rep1 o7)))))
...
(assert (= i8 i6))
(assert (= res9 res7))
(assert (= (= result5 true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))))) (<= simple_unc_arrays__min__result4 (to_rep1 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) j1)))))))
(assert (= result5 true))
(assert (<= 1 j))
