...
(assert (and (and (and (= us (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a)))) (in_range1 (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))))) (and (and (and (and (and (and (<= (to_rep2 (first (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))) 1) (<= 1 (to_rep2 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))))) (= o 1)) (= o1 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) o))) (= o2 (to_rep1 o1))) (and (= (mk_int__ref result) (mk_int__ref res)) (= res1 o2))) (and (in_range2 res1) (and (and (= (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))) r25b) (in_range1 r25b)) (and (and (and (= (mk_int__ref result1) (mk_int__ref i)) (= i1 2)) (ite (and (<= 2 i1) (<= i1 r25b)) (and (and (and (= temp___844 res1) (and (= temp___843 i1) (and (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 (- i2 1))) (<= res2 (to_rep1 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) j3))))) (and (and (and (=> (<= 2 r25b) (dynamic_property2 2 r25b i2)) (=> (<= (- 2147483648) 2147483647) (in_range2 res2))) (and (<= 2 i2) (<= i2 r25b))) (and (and (and (and (and (and (and (<= (to_rep2 (first (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))) i2) (<= i2 (to_rep2 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))))) (= o3 i2)) (= o4 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) o3))) (= o5 (to_rep1 o4))) (= result2 (ite (< o5 res2) true false))) (ite (= result2 true) (and (and (and (and (and (<= (to_rep2 (first (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))) i2) (<= i2 (to_rep2 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))))) (= o6 i2)) (= o7 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) o6))) (= o8 (to_rep1 o7))) (and (= res2 result3) (= res3 o8))) (= res3 res2))) (= i2 r25b)))))) (and (and (= i2 i6) (= res3 res6)) (and (= i7 i2) (= res7 res3)))) (and (and (= (mk_int__ref i8) (mk_int__ref i6)) (= (mk_int__ref res8) (mk_int__ref res6))) (and (= i9 i7) (= res9 res7)))) (and (and (= i1 i8) (= res1 res8)) (and (= i9 i1) (= res9 res1))))) (and (and (= simple_unc_arrays__min__result1 simple_unc_arrays__min__result2) (= simple_unc_arrays__min__result3 simple_unc_arrays__min__result1)) (and (= (mk_int__ref result5) (mk_int__ref simple_unc_arrays__min__result)) (= simple_unc_arrays__min__result1 res8)))))))) (and (and (= (mk_int__ref simple_unc_arrays__min__result4) (mk_int__ref simple_unc_arrays__min__result2)) (and (= (mk_int__ref i10) (mk_int__ref i8)) (= (mk_int__ref res10) (mk_int__ref res8)))) (and (= simple_unc_arrays__min__result5 simple_unc_arrays__min__result3) (and (= i11 i9) (= res11 res9))))))
(assert (= (= result6 true) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))))) (<= simple_unc_arrays__min__result4 (to_rep1 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) j3)))))))
(assert (= result6 true))
(assert (<= 1 j1))
