...
(assert (and (= o12 (length alloc3)) (in_range2 o12)))
(assert (and (= o13 (length avail3)) (in_range2 o13)))
(assert (= o14 (+ o13 o12)))
(assert (and (= o15 o14) (in_range5 o14)))
(assert (= result5 (ite (= o15 r2) true false)))
(assert (=> (= result5 true) (and (= o10 (contains avail3 e1)) (=> (= (distinct 1 0) true) (=> (exists ((e2 Int)) (and (and (in_range1 e2) (= (contains avail3 e2) true)) (= e2 e1))) (= o10 true))))))
(assert (=> (= result5 true) (= (= o11 true) (in_range1 e1))))
...
(assert (=> (= result4 true) (and (= o8 (contains alloc3 e)) (=> (= (distinct 1 0) true) (=> (exists ((e2 Int)) (and (and (in_range1 e2) (= (contains alloc3 e2) true)) (= e2 e))) (= o8 true))))))
