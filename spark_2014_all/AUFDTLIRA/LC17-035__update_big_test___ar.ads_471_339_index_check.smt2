...
(assert (=> (< 0 e) (= o17 (temp___1564 o16 i o15))))
(assert (=> (< 0 e) (and (<= 1 (+ k 1)) (<= (+ k 1) 16))))
(assert (=> (< 0 e) (= o13 (+ k 1))))
(assert (=> (< 0 e) (= o18 (select a o13))))
(assert (=> (< 0 e) (= o19 (temp___1557 o18 j o17))))
(assert (=> (< 0 e) (and (= o20 (+ k 1)) (in_range2 (+ k 1)))))
(assert (=> (< 0 e) (= temp___5271 (temp___1534 a k (temp___1542 (select a k) j (temp___1549 (select (select a k) j) i e)) o20 o19))))
...
(assert (= o12 (temp___1603 o11 i 99)))
(assert (not (<= 1 (+ k 1))))
(check-sat)
(exit)
