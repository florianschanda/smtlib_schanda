...
(assert (= a4 a2))
(assert (< k 16))
(assert (=> (< 0 e) (and (= o15 (- e 1)) (in_range3 (- e 1)))))
(assert (=> (< 0 e) (and (<= 1 (+ k 1)) (<= (+ k 1) 16))))
(assert (=> (< 0 e) (= o14 (+ k 1))))
(assert (=> (< 0 e) (= temp___5270 (select a o14))))
(assert (=> (< 0 e) (= o16 (select temp___5270 j))))
(assert (=> (< 0 e) (= o17 (temp_____aggregate_def_1564 o16 i o15))))
(assert (=> (< 0 e) (and (<= 1 (+ k 1)) (<= (+ k 1) 16))))
(assert (=> (< 0 e) (= o13 (+ k 1))))
(assert (=> (< 0 e) (= o18 (select a o13))))
(assert (=> (< 0 e) (= o19 (temp_____aggregate_def_1557 o18 j o17))))
(assert (=> (< 0 e) (and (= o20 (+ k 1)) (in_range2 (+ k 1)))))
(assert (=> (< 0 e) (= temp___5271 (temp_____aggregate_def_1534 a k (temp_____aggregate_def_1542 (select a k) j (temp_____aggregate_def_1549 (select (select a k) j) i e)) o20 o19))))
...
(assert (= o10 (+ k 1)))
(assert (= temp___5280 (select a o10)))
(assert (= o11 (select temp___5280 j)))
(assert (= o12 (temp_____aggregate_def_1603 o11 i 99)))
(assert (not (<= (+ k 1) 16)))
(check-sat)
(exit)
