...
(assert (=> (< 0 e) (= o14 (+ k 1))))
(assert (=> (< 0 e) (= temp___5211 (select a o14))))
(assert (=> (< 0 e) (= o16 (select temp___5211 j))))
(assert (=> (< 0 e) (= o17 (temp___1505 o16 i o15))))
(assert (=> (< 0 e) (and (<= 1 (+ k 1)) (<= (+ k 1) 16))))
(assert (=> (< 0 e) (= o13 (+ k 1))))
(assert (=> (< 0 e) (= o18 (select a o13))))
(assert (=> (< 0 e) (= o19 (temp___1498 o18 j o17))))
(assert (=> (< 0 e) (and (= o20 (+ k 1)) (in_range2 (+ k 1)))))
(assert (=> (< 0 e) (= temp___5212 (temp___1475 a k (temp___1483 (select a k) j (temp___1490 (select (select a k) j) i e)) o20 o19))))
...
(assert (= o10 (+ k 1)))
(assert (= temp___5221 (select a o10)))
(assert (= o11 (select temp___5221 j)))
(assert (= o12 (temp___1544 o11 i 99)))
(assert (not (<= 1 (+ k 1))))
(check-sat)
(exit)
