...
(declare-const temp___269 us_rep)
(declare-const temp___268 Int)
(declare-const temp___267 us_rep)
...
(assert (= r1 1))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (= temp___269 avail)))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (= temp___268 r1)))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (= temp___267 alloc)))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (=> (= (to_rep (select data r1)) 0) (and (= o (add avail r1)) (and (and (and (= (length o) (+ (length avail) 1)) (= (contains o r1) true)) (= (ole avail o) true)) (= (included_except o avail r1) true))))))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (=> (= (to_rep (select data r1)) 0) (= (mk_set__ref result1) avail11))))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (=> (= (to_rep (select data r1)) 0) (= avail2 o))))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (=> (= (to_rep (select data r1)) 0) (= alloc2 alloc))))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (=> (= (to_rep (select data r1)) 0) (= alloc2 alloc1))))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (=> (not (= (to_rep (select data r1)) 0)) (and (= o1 (add alloc r1)) (and (and (and (= (length o1) (+ (length alloc) 1)) (= (contains o1 r1) true)) (= (ole alloc o1) true)) (= (included_except o1 alloc r1) true))))))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (=> (not (= (to_rep (select data r1)) 0)) (= (mk_set__ref result2) alloc11))))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (=> (not (= (to_rep (select data r1)) 0)) (= alloc2 o1))))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (=> (not (= (to_rep (select data r1)) 0)) (= avail2 avail))))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (=> (not (= (to_rep (select data r1)) 0)) (= avail2 avail1))))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (and (and (and (= (+ (length avail3) (length alloc3)) r2) (forall ((e Int)) (=> (and (in_range4 e) (= (contains avail3 e) true)) (and (<= 1 e) (<= e r2))))) (forall ((e Int)) (=> (and (in_range4 e) (= (contains alloc3 e) true)) (and (<= 1 e) (<= e r2))))) (forall ((rr Int)) (=> (and (<= 1 rr) (<= rr r2)) (ite (= (to_rep (select data rr)) 0) (and (= (contains avail3 rr) true) (not (= (contains alloc3 rr) true))) (and (not (= (contains avail3 rr) true)) (= (contains alloc3 rr) true))))))))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (and (=> (<= 1 10000) (in_range2 r2)) (and (<= 1 r2) (<= r2 10000)))))
...
(assert (=> (and (<= 1 r1) (<= r1 10000)) (= alloc10 (mk_set__ref alloc4))))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (= avail10 (mk_set__ref avail4))))
...
(assert (= result3 (mk_t__ref (mk___rep (mk___split_fields simple_allocator__m__model__result simple_allocator__m__model__result1)))))
(assert (= simple_allocator__m__model__result2 (mk___rep (mk___split_fields avail6 alloc6))))
...
(assert (= (mk___rep (mk___split_fields result4 result5)) (t__content simple_allocator__m__model__result5)))
