...
(assert (forall ((a us_t)) (! (=> (dynamic_invariant1 a true true true) (= (remove_last a) (let ((temp___159 (let ((temp___158 (- (last1 a) 1))) (let ((temp___157 (first1 a))) (of_array1 (to_array a) temp___157 temp___158))))) (of_array (to_array1 temp___159) (first3 temp___159) (last3 temp___159))))) :pattern ((remove_last a)))))
(declare-const a us_t)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const e Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(define-fun dynamic_invariant2 ((temp___expr_147 Int) (temp___is_init_144 Bool) (temp___skip_constant_145 Bool) (temp___do_toplevel_146 Bool)) Bool (=> (or (= temp___is_init_144 true) (<= 0 100)) (in_range3 temp___expr_147)))
...
(assert (not (<= (to_rep1 (first (rt a))) (to_rep1 (last (rt a))))))
(check-sat)
(exit)
