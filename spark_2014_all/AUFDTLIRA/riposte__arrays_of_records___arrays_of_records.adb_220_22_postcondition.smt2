...
(define-fun dynamic_invariant ((temp___expr_173 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool) (temp___do_typ_inv_172 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= (- 23) 69)) (in_range2 temp___expr_173)))
...
(define-fun dynamic_invariant1 ((temp___expr_166 Int) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool (=> (or (= temp___is_init_162 true) (<= 0 1001)) (in_range1 temp___expr_166)))
...
(assert (= result1 a))
(assert (= a1 (store a 23 (mk___rep (mk___split_fields (distinct 1 0) (rec__arrays_of_records__basic_record__first_value (us_split_fields1 (select a 23))) (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select a 23))))))))
(assert (= (to_rep o) (to_rep (rec__arrays_of_records__basic_record__first_value (us_split_fields1 (select a1 5))))))
(assert (= (rec__arrays_of_records__basic_record__flag (us_split_fields1 (select a1 17))) o1))
(assert (= o o2))
(assert (= (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select a1 17))) o3))
(assert (= o4 o1))
(assert (= o5 o2))
(assert (= o6 o3))
...
(assert (= (rec__arrays_of_records__basic_record__flag (us_split_fields1 (select a2 23))) o9))
(assert (= (rec__arrays_of_records__basic_record__first_value (us_split_fields1 (select a2 23))) o10))
(assert (= o8 o11))
(assert (= o12 o9))
(assert (= o13 o10))
(assert (= o14 o11))
(assert (= o15 (store a2 23 (mk___rep (mk___split_fields o12 o13 o14)))))
(assert (= result3 a2))
(assert (= a3 o15))
(assert (= (to_rep o16) tmp1))
(assert (= (rec__arrays_of_records__basic_record__flag (us_split_fields1 (select a3 5))) o17))
(assert (= o16 o18))
(assert (= (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select a3 5))) o19))
(assert (= o20 o17))
(assert (= o21 o18))
(assert (= o22 o19))
(assert (= o23 (store a3 5 (mk___rep (mk___split_fields o20 o21 o22)))))
(assert (= result4 a3))
(assert (= a4 o23))
(assert (= tmp2 tmp1))
(assert (= a4 a5))
(assert (= tmp3 tmp1))
(assert (= a6 a4))
(assert (not (not (= (bool_eq1 a5 0 1001 a 0 1001) true))))
(check-sat)
(exit)
