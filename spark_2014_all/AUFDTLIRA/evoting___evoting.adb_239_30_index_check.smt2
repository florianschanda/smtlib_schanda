...
(assert (=> (and (and (= (to_int1 (select winners3 0)) (to_int1 (of_int 0))) (< latest_highest_score2 i2)) (= (select winners3 latest_highest_score2) true)) (= (= result4 true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- i2 1))) (=> (< latest_highest_score2 j1) (< (to_rep (select counters j1)) (to_rep (select counters latest_highest_score2)))))))))
