...
(assert (=> (and (and (= (to_int1 (select winners3 0)) (to_int1 (of_int 0))) (< latest_highest_score2 i5)) (= (select winners3 latest_highest_score2) true)) (= (= result4 true) (forall ((j28 Int)) (=> (and (<= 1 j28) (<= j28 (- i5 1))) (=> (< latest_highest_score2 j28) (< (to_rep (select counters j28)) (to_rep (select counters latest_highest_score2)))))))))
(assert (=> (not (and (and (= (to_int1 (select winners3 0)) (to_int1 (of_int 0))) (< latest_highest_score2 i5)) (= (select winners3 latest_highest_score2) true))) (= result4 false)))
(assert (= result4 true))
(assert (<= 1 j1))
(assert (<= j1 (- i5 1)))
(assert (not (<= 0 j1)))
