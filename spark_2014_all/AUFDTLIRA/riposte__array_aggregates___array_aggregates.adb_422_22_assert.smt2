...
(declare-fun temp___694 (us_rep) (Array Int us_rep))
(declare-fun temp___698 (Int) (Array Int character))
(declare-fun temp___702 (Int Int) (Array Int character))
...
(assert (forall ((temp___696 us_rep)) (forall ((temp___697 Int)) (= (select (temp___694 temp___696) temp___697) temp___696))))
(assert (forall ((temp___700 Int)) (=> (dynamic_invariant temp___700 true true true true) (forall ((temp___701 Int)) (= (to_rep1 (select (temp___698 temp___700) temp___701)) temp___700)))))
(assert (forall ((temp___704 Int) (temp___705 Int)) (let ((temp___703 (temp___702 temp___704 temp___705))) (=> (and (dynamic_invariant temp___704 true true true true) (dynamic_invariant temp___705 true true true true)) (forall ((temp___706 Int)) (ite (= temp___706 1) (= (to_rep1 (select temp___703 temp___706)) temp___704) (= (to_rep1 (select temp___703 temp___706)) temp___705)))))))
...
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= (temp___698 32) o2))
(assert (= o3 o1))
(assert (= o4 o2))
(assert (= o5 (temp___694 (mk___rep (mk___split_fields o3 o4)))))
(assert (= result x))
(assert (= x1 o5))
(declare-const n Int)
(assert (<= 1 n))
(assert (<= n 1000))
(assert (not (= (bool_eq1 (select x1 n) (mk___rep (mk___split_fields (of_rep 0) (temp___702 32 32)))) true)))
(check-sat)
(exit)
