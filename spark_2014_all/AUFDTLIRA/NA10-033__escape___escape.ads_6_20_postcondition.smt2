...
(assert (=> (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s))))) (= temp___160 ti1)))
(assert (=> (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s))))) (= temp___158 result__)))
...
(assert (= i16 (mk_int__ref i6)))
(assert (= count_bs8 (mk_int__ref count_bs6)))
