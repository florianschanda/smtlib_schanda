...
(assert (forall ((s us_rep)) (! (let ((result (get_model s))) (and (and (in_range3 (first1 result)) (and (in_range3 (last1 result)) (= (length result) (size s)))) (dynamic_invariant result true false true true))) :pattern ((get_model s)))))
(assert (forall ((attr__tag2 Int)) (forall ((s us_rep)) (! (let ((result (get_model1 attr__tag2 s))) (and (and (in_range3 (first1 result)) (and (in_range3 (last1 result)) (= (length result) (size s)))) (dynamic_invariant result true false true true))) :pattern ((get_model1 attr__tag2 s))))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range f) (=> (in_range l) (and (= (to_rep (first8 (mk4 f l))) f) (= (to_rep (last8 (mk4 f l))) l)))) :pattern ((mk4 f l)))))
...
(declare-fun temp_____aggregate_def_478 (Int Int Int Int Int) (Array Int element))
...
(assert (forall ((temp___480 Int) (temp___481 Int) (temp___482 Int) (temp___483 Int) (temp___484 Int)) (let ((temp___479 (temp_____aggregate_def_478 temp___480 temp___481 temp___482 temp___483 temp___484))) (=> (and (and (and (and (dynamic_invariant1 temp___480 true true true true) (dynamic_invariant1 temp___481 true true true true)) (dynamic_invariant1 temp___482 true true true true)) (dynamic_invariant1 temp___483 true true true true)) (dynamic_invariant1 temp___484 true true true true)) (and (and (and (and (= (select temp___479 1) rliteral) (= (select temp___479 2) rliteral1)) (= (select temp___479 3) rliteral2)) (= (select temp___479 4) rliteral3)) (= (select temp___479 5) rliteral4))))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range f) (=> (in_range l) (and (= (to_rep (first10 (mk5 f l))) f) (= (to_rep (last10 (mk5 f l))) l)))) :pattern ((mk5 f l)))))
...
(assert (forall ((s us_rep)) (! (let ((result (get_model__2 s))) (and (and (= (length result) (size s)) (and (in_range3 (last1 result)) (in_range3 (first1 result)))) (dynamic_invariant result true false true true))) :pattern ((get_model__2 s)))))
(assert (forall ((attr__tag2 Int)) (forall ((s us_rep)) (! (let ((result (get_model__21 attr__tag2 s))) (and (and (= (length result) (size s)) (and (in_range3 (last1 result)) (in_range3 (first1 result)))) (dynamic_invariant result true false true true))) :pattern ((get_model__21 attr__tag2 s))))))
...
(assert (forall ((s us_rep)) (! (= (get_model__2 s) (let ((temp___310 (let ((temp___308 (to_rep2 (rec__stacks__stack_root__length (us_split_fields1 s))))) (let ((temp___307 1)) (let ((temp___309 (rec__stacks__stack_root__content (us_split_fields1 s)))) (of_array5 temp___309 temp___307 temp___308)))))) (of_array (to_array5 temp___310) (first11 temp___310) (last11 temp___310)))) :pattern ((get_model__2 s)))))
...
(declare-fun last12 (us_rep1) Int)
(declare-fun last__function_guard (Int us_rep1) Bool)
(declare-fun last13 (Int us_rep1) Int)
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range f) (=> (in_range l) (and (= (to_rep (first12 (mk6 f l))) f) (= (to_rep (last14 (mk6 f l))) l)))) :pattern ((mk6 f l)))))
(define-fun dynamic_property11 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range low) (and (in_range high) (=> (<= low high) (and (in_range6 low) (in_range6 high))))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range f) (=> (in_range l) (and (= (to_rep (first14 (mk7 f l))) f) (= (to_rep (last16 (mk7 f l))) l)))) :pattern ((mk7 f l)))))
(define-fun dynamic_property13 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range low) (and (in_range high) (=> (<= low high) (and (dynamic_property12 range_first range_last low) (dynamic_property12 range_first range_last high))))))
...
(define-fun last17 ((a us_t7)) Int (to_rep (last16 (rt7 a))))
...
(define-fun bool_eq10 ((x us_t7) (y us_t7)) Bool (bool_eq (elts7 x) (to_rep (first14 (rt7 x))) (to_rep (last16 (rt7 x))) (elts7 y) (to_rep (first14 (rt7 y))) (to_rep (last16 (rt7 y)))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range f) (=> (in_range l) (and (= (to_rep (first16 (mk8 f l))) f) (= (to_rep (last18 (mk8 f l))) l)))) :pattern ((mk8 f l)))))
(define-fun dynamic_property15 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range low) (and (in_range high) (=> (<= low high) (and (dynamic_property14 range_first range_last low) (dynamic_property14 range_first range_last high))))))
...
(define-fun last19 ((a us_t8)) Int (to_rep (last18 (rt8 a))))
...
(define-fun bool_eq11 ((x us_t8) (y us_t8)) Bool (bool_eq (elts8 x) (to_rep (first16 (rt8 x))) (to_rep (last18 (rt8 x))) (elts8 y) (to_rep (first16 (rt8 y))) (to_rep (last18 (rt8 y)))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range f) (=> (in_range l) (and (= (to_rep (first18 (mk9 f l))) f) (= (to_rep (last20 (mk9 f l))) l)))) :pattern ((mk9 f l)))))
(define-fun dynamic_property17 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range low) (and (in_range high) (=> (<= low high) (and (dynamic_property16 range_first range_last low) (dynamic_property16 range_first range_last high))))))
...
(define-fun last21 ((a us_t9)) Int (to_rep (last20 (rt9 a))))
...
(define-fun bool_eq12 ((x us_t9) (y us_t9)) Bool (bool_eq (elts9 x) (to_rep (first18 (rt9 x))) (to_rep (last20 (rt9 x))) (elts9 y) (to_rep (first18 (rt9 y))) (to_rep (last20 (rt9 y)))))
...
(assert (forall ((s us_rep1)) (! (let ((result (get_model__3 s))) (and (and (in_range3 (first1 result)) (and (in_range3 (last1 result)) (= (length result) (size (to_base s))))) (dynamic_invariant result true false true true))) :pattern ((get_model__3 s)))))
(assert (forall ((attr__tag2 Int)) (forall ((s us_rep1)) (! (let ((result (get_model__31 attr__tag2 s))) (and (and (in_range3 (first1 result)) (and (in_range3 (last1 result)) (= (length result) (size (to_base s))))) (dynamic_invariant result true false true true))) :pattern ((get_model__31 attr__tag2 s))))))
(assert (forall ((s us_rep1)) (! (= (get_model__3 s) (get_model__31 us_tag2 s)) :pattern ((get_model__31 us_tag2 s)))))
(assert (forall ((s us_rep1)) (! (= (get_model__3 s) (ite (= (wraps_around s) true) (let ((stacks__get_model__3__R86s (last12 s))) (let ((temp___413 (let ((temp___412 (let ((temp___409 1)) (let ((temp___410 (rec__stacks__stack_root__content1 (us_split_fields3 s)))) (of_array8 temp___410 temp___409 stacks__get_model__3__R86s))))) (let ((temp___411 (let ((temp___407 100)) (let ((temp___406 (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))))) (let ((temp___408 (rec__stacks__stack_root__content1 (us_split_fields3 s)))) (of_array7 temp___408 temp___406 temp___407)))))) (ite (= (length7 temp___411) 0) (of_array6 (to_array8 temp___412) (first17 temp___412) (last19 temp___412)) (of_array6 (slide (concat1 (to_array7 temp___411) (first15 temp___411) (last17 temp___411) (to_array8 temp___412) (first17 temp___412) (last19 temp___412)) (first15 temp___411) 1) 1 (- (+ 1 (+ (ite (<= (first15 temp___411) (last17 temp___411)) (+ (- (last17 temp___411) (first15 temp___411)) 1) 0) (ite (<= (first17 temp___412) (last19 temp___412)) (+ (- (last19 temp___412) (first17 temp___412)) 1) 0))) 1))))))) (of_array (to_array6 temp___413) (first13 temp___413) (last15 temp___413)))) (let ((stacks__get_model__3__R89s (last12 s))) (let ((temp___416 (let ((temp___414 (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))))) (let ((temp___415 (rec__stacks__stack_root__content1 (us_split_fields3 s)))) (of_array9 temp___415 temp___414 stacks__get_model__3__R89s))))) (of_array (to_array9 temp___416) (first19 temp___416) (last21 temp___416)))))) :pattern ((get_model__3 s)))))
...
(assert (forall ((s us_rep1)) (! (= (peek__3 s) (to_rep1 (let ((temp___439 (rec__stacks__stack_root__content1 (us_split_fields3 s)))) (select temp___439 (last12 s))))) :pattern ((peek__3 s)))))
(declare-const rliteral5 element)
(assert (= (elementqtint rliteral5) 0))
(assert (forall ((temp___189 Int)) (=> (dynamic_invariant1 temp___189 true true true true) (forall ((temp___190 Int)) (= (select (temp_____aggregate_def_187 temp___189) temp___190) rliteral5)))))
...
(assert (forall ((s us_rep1)) (! (dynamic_invariant4 (last12 s) true false true false) :pattern ((last12 s)))))
(assert (forall ((attr__tag2 Int)) (forall ((s us_rep1)) (! (dynamic_invariant4 (last13 attr__tag2 s) true false true false) :pattern ((last13 attr__tag2 s))))))
(assert (forall ((s us_rep1)) (! (= (last12 s) (last13 us_tag2 s)) :pattern ((last13 us_tag2 s)))))
(assert (forall ((s us_rep1)) (! (= (last12 s) (ite (not (= (wraps_around s) true)) (- (+ (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))) (to_rep2 (rec__stacks__stack_root__length1 (us_split_fields3 s)))) 1) (- (- (+ (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))) (to_rep2 (rec__stacks__stack_root__length1 (us_split_fields3 s)))) 1) 100))) :pattern ((last12 s)))))
...
(assert (=> (<= 0 2147483647) (in_range2 e)))
...
(assert (= i2 1))
(assert (and (= (let ((temp___265 (get_model1 s__attr__tag (mk___rep s__split_fields36 s__attr__tag)))) (bool_eq (elts temp___265) (to_rep (first (rt temp___265))) (to_rep (last (rt temp___265))) (let ((temp___264 (get_model1 s__attr__tag (mk___rep s__split_fields37 s__attr__tag)))) (ite (= (length temp___264) 0) (singleton1 (of_rep1 i2) 1) (concat_singleton_right (elts temp___264) (to_rep (first (rt temp___264))) (to_rep (last (rt temp___264))) (of_rep1 i2)))) (to_rep (first (let ((temp___264 (get_model1 s__attr__tag (mk___rep s__split_fields37 s__attr__tag)))) (ite (= (length temp___264) 0) (mk 1 1) (mk (to_rep (first (rt temp___264))) (- (+ (to_rep (first (rt temp___264))) (+ (ite (<= (to_rep (first (rt temp___264))) (to_rep (last (rt temp___264)))) (+ (- (to_rep (last (rt temp___264))) (to_rep (first (rt temp___264)))) 1) 0) 1)) 1)))))) (to_rep (last (let ((temp___264 (get_model1 s__attr__tag (mk___rep s__split_fields37 s__attr__tag)))) (ite (= (length temp___264) 0) (mk 1 1) (mk (to_rep (first (rt temp___264))) (- (+ (to_rep (first (rt temp___264))) (+ (ite (<= (to_rep (first (rt temp___264))) (to_rep (last (rt temp___264)))) (+ (- (to_rep (last (rt temp___264))) (to_rep (first (rt temp___264)))) 1) 0) 1)) 1)))))))) true) (push__specific_post s__attr__tag s__split_fields36 s__attr__tag i2 s__split_fields37)))
(assert (= i2 result1))
(assert (= i3 2))
(assert (and (= (let ((temp___265 (get_model1 s__attr__tag (mk___rep s__split_fields35 s__attr__tag)))) (bool_eq (elts temp___265) (to_rep (first (rt temp___265))) (to_rep (last (rt temp___265))) (let ((temp___264 (get_model1 s__attr__tag (mk___rep s__split_fields36 s__attr__tag)))) (ite (= (length temp___264) 0) (singleton1 (of_rep1 i3) 1) (concat_singleton_right (elts temp___264) (to_rep (first (rt temp___264))) (to_rep (last (rt temp___264))) (of_rep1 i3)))) (to_rep (first (let ((temp___264 (get_model1 s__attr__tag (mk___rep s__split_fields36 s__attr__tag)))) (ite (= (length temp___264) 0) (mk 1 1) (mk (to_rep (first (rt temp___264))) (- (+ (to_rep (first (rt temp___264))) (+ (ite (<= (to_rep (first (rt temp___264))) (to_rep (last (rt temp___264)))) (+ (- (to_rep (last (rt temp___264))) (to_rep (first (rt temp___264)))) 1) 0) 1)) 1)))))) (to_rep (last (let ((temp___264 (get_model1 s__attr__tag (mk___rep s__split_fields36 s__attr__tag)))) (ite (= (length temp___264) 0) (mk 1 1) (mk (to_rep (first (rt temp___264))) (- (+ (to_rep (first (rt temp___264))) (+ (ite (<= (to_rep (first (rt temp___264))) (to_rep (last (rt temp___264)))) (+ (- (to_rep (last (rt temp___264))) (to_rep (first (rt temp___264)))) 1) 0) 1)) 1)))))))) true) (push__specific_post s__attr__tag s__split_fields35 s__attr__tag i3 s__split_fields36)))
(assert (= i3 result2))
(assert (= i4 3))
(assert (and (= (let ((temp___265 (get_model1 s__attr__tag (mk___rep s__split_fields34 s__attr__tag)))) (bool_eq (elts temp___265) (to_rep (first (rt temp___265))) (to_rep (last (rt temp___265))) (let ((temp___264 (get_model1 s__attr__tag (mk___rep s__split_fields35 s__attr__tag)))) (ite (= (length temp___264) 0) (singleton1 (of_rep1 i4) 1) (concat_singleton_right (elts temp___264) (to_rep (first (rt temp___264))) (to_rep (last (rt temp___264))) (of_rep1 i4)))) (to_rep (first (let ((temp___264 (get_model1 s__attr__tag (mk___rep s__split_fields35 s__attr__tag)))) (ite (= (length temp___264) 0) (mk 1 1) (mk (to_rep (first (rt temp___264))) (- (+ (to_rep (first (rt temp___264))) (+ (ite (<= (to_rep (first (rt temp___264))) (to_rep (last (rt temp___264)))) (+ (- (to_rep (last (rt temp___264))) (to_rep (first (rt temp___264)))) 1) 0) 1)) 1)))))) (to_rep (last (let ((temp___264 (get_model1 s__attr__tag (mk___rep s__split_fields35 s__attr__tag)))) (ite (= (length temp___264) 0) (mk 1 1) (mk (to_rep (first (rt temp___264))) (- (+ (to_rep (first (rt temp___264))) (+ (ite (<= (to_rep (first (rt temp___264))) (to_rep (last (rt temp___264)))) (+ (- (to_rep (last (rt temp___264))) (to_rep (first (rt temp___264)))) 1) 0) 1)) 1)))))))) true) (push__specific_post s__attr__tag s__split_fields34 s__attr__tag i4 s__split_fields35)))
(assert (= i4 result3))
(assert (= i5 4))
(assert (and (= (let ((temp___265 (get_model1 s__attr__tag (mk___rep s__split_fields33 s__attr__tag)))) (bool_eq (elts temp___265) (to_rep (first (rt temp___265))) (to_rep (last (rt temp___265))) (let ((temp___264 (get_model1 s__attr__tag (mk___rep s__split_fields34 s__attr__tag)))) (ite (= (length temp___264) 0) (singleton1 (of_rep1 i5) 1) (concat_singleton_right (elts temp___264) (to_rep (first (rt temp___264))) (to_rep (last (rt temp___264))) (of_rep1 i5)))) (to_rep (first (let ((temp___264 (get_model1 s__attr__tag (mk___rep s__split_fields34 s__attr__tag)))) (ite (= (length temp___264) 0) (mk 1 1) (mk (to_rep (first (rt temp___264))) (- (+ (to_rep (first (rt temp___264))) (+ (ite (<= (to_rep (first (rt temp___264))) (to_rep (last (rt temp___264)))) (+ (- (to_rep (last (rt temp___264))) (to_rep (first (rt temp___264)))) 1) 0) 1)) 1)))))) (to_rep (last (let ((temp___264 (get_model1 s__attr__tag (mk___rep s__split_fields34 s__attr__tag)))) (ite (= (length temp___264) 0) (mk 1 1) (mk (to_rep (first (rt temp___264))) (- (+ (to_rep (first (rt temp___264))) (+ (ite (<= (to_rep (first (rt temp___264))) (to_rep (last (rt temp___264)))) (+ (- (to_rep (last (rt temp___264))) (to_rep (first (rt temp___264)))) 1) 0) 1)) 1)))))))) true) (push__specific_post s__attr__tag s__split_fields33 s__attr__tag i5 s__split_fields34)))
(assert (= i5 result4))
(assert (= i6 5))
(assert (and (= (let ((temp___265 (get_model1 s__attr__tag (mk___rep s__split_fields32 s__attr__tag)))) (bool_eq (elts temp___265) (to_rep (first (rt temp___265))) (to_rep (last (rt temp___265))) (let ((temp___264 (get_model1 s__attr__tag (mk___rep s__split_fields33 s__attr__tag)))) (ite (= (length temp___264) 0) (singleton1 (of_rep1 i6) 1) (concat_singleton_right (elts temp___264) (to_rep (first (rt temp___264))) (to_rep (last (rt temp___264))) (of_rep1 i6)))) (to_rep (first (let ((temp___264 (get_model1 s__attr__tag (mk___rep s__split_fields33 s__attr__tag)))) (ite (= (length temp___264) 0) (mk 1 1) (mk (to_rep (first (rt temp___264))) (- (+ (to_rep (first (rt temp___264))) (+ (ite (<= (to_rep (first (rt temp___264))) (to_rep (last (rt temp___264)))) (+ (- (to_rep (last (rt temp___264))) (to_rep (first (rt temp___264)))) 1) 0) 1)) 1)))))) (to_rep (last (let ((temp___264 (get_model1 s__attr__tag (mk___rep s__split_fields33 s__attr__tag)))) (ite (= (length temp___264) 0) (mk 1 1) (mk (to_rep (first (rt temp___264))) (- (+ (to_rep (first (rt temp___264))) (+ (ite (<= (to_rep (first (rt temp___264))) (to_rep (last (rt temp___264)))) (+ (- (to_rep (last (rt temp___264))) (to_rep (first (rt temp___264)))) 1) 0) 1)) 1)))))))) true) (push__specific_post s__attr__tag s__split_fields32 s__attr__tag i6 s__split_fields33)))
(assert (= (let ((temp___488 (get_model1 s__attr__tag (mk___rep s__split_fields32 s__attr__tag)))) (bool_eq (elts temp___488) (to_rep (first (rt temp___488))) (to_rep (last (rt temp___488))) (temp_____aggregate_def_478 1 2 3 4 5) 1 5)) true))
(assert (= (mk_int__ref result5) (mk_int__ref i1)))
(assert (= i7 5))
(assert (and (and (and (= e1 (peek1 s__attr__tag (mk___rep s__split_fields32 s__attr__tag))) (= (let ((temp___228 (get_model1 s__attr__tag (mk___rep s__split_fields31 s__attr__tag)))) (bool_eq (elts temp___228) (to_rep (first (rt temp___228))) (to_rep (last (rt temp___228))) (elts (get_model1 s__attr__tag (mk___rep s__split_fields32 s__attr__tag))) (to_rep (first4 (mk2 (to_rep (first (rt (get_model1 s__attr__tag (mk___rep s__split_fields32 s__attr__tag))))) (- (to_rep (last (rt (get_model1 s__attr__tag (mk___rep s__split_fields32 s__attr__tag))))) 1)))) (to_rep (last4 (mk2 (to_rep (first (rt (get_model1 s__attr__tag (mk___rep s__split_fields32 s__attr__tag))))) (- (to_rep (last (rt (get_model1 s__attr__tag (mk___rep s__split_fields32 s__attr__tag))))) 1)))))) true)) (in_range2 e1)) (pop__specific_post s__attr__tag s__split_fields31 s__attr__tag e1 s__split_fields32 e)))
(assert (= e1 i7))
(assert (= i7 result6))
(assert (= i8 4))
(assert (and (and (and (= e2 (peek1 s__attr__tag (mk___rep s__split_fields31 s__attr__tag))) (= (let ((temp___228 (get_model1 s__attr__tag (mk___rep s__split_fields30 s__attr__tag)))) (bool_eq (elts temp___228) (to_rep (first (rt temp___228))) (to_rep (last (rt temp___228))) (elts (get_model1 s__attr__tag (mk___rep s__split_fields31 s__attr__tag))) (to_rep (first4 (mk2 (to_rep (first (rt (get_model1 s__attr__tag (mk___rep s__split_fields31 s__attr__tag))))) (- (to_rep (last (rt (get_model1 s__attr__tag (mk___rep s__split_fields31 s__attr__tag))))) 1)))) (to_rep (last4 (mk2 (to_rep (first (rt (get_model1 s__attr__tag (mk___rep s__split_fields31 s__attr__tag))))) (- (to_rep (last (rt (get_model1 s__attr__tag (mk___rep s__split_fields31 s__attr__tag))))) 1)))))) true)) (in_range2 e2)) (pop__specific_post s__attr__tag s__split_fields30 s__attr__tag e2 s__split_fields31 e1)))
(assert (= e2 i8))
(assert (= i8 result7))
(assert (= i9 3))
(assert (and (and (and (= e3 (peek1 s__attr__tag (mk___rep s__split_fields30 s__attr__tag))) (= (let ((temp___228 (get_model1 s__attr__tag (mk___rep s__split_fields27 s__attr__tag)))) (bool_eq (elts temp___228) (to_rep (first (rt temp___228))) (to_rep (last (rt temp___228))) (elts (get_model1 s__attr__tag (mk___rep s__split_fields30 s__attr__tag))) (to_rep (first4 (mk2 (to_rep (first (rt (get_model1 s__attr__tag (mk___rep s__split_fields30 s__attr__tag))))) (- (to_rep (last (rt (get_model1 s__attr__tag (mk___rep s__split_fields30 s__attr__tag))))) 1)))) (to_rep (last4 (mk2 (to_rep (first (rt (get_model1 s__attr__tag (mk___rep s__split_fields30 s__attr__tag))))) (- (to_rep (last (rt (get_model1 s__attr__tag (mk___rep s__split_fields30 s__attr__tag))))) 1)))))) true)) (in_range2 e3)) (pop__specific_post s__attr__tag s__split_fields27 s__attr__tag e3 s__split_fields30 e2)))
(assert (= e3 i9))
(assert (= result8 (mk_int__ref i9)))
(assert (= i10 2))
(assert (and (and (and (= e4 (peek1 s__attr__tag (mk___rep s__split_fields27 s__attr__tag))) (= (let ((temp___228 (get_model1 s__attr__tag (mk___rep s__split_fields28 s__attr__tag)))) (bool_eq (elts temp___228) (to_rep (first (rt temp___228))) (to_rep (last (rt temp___228))) (elts (get_model1 s__attr__tag (mk___rep s__split_fields27 s__attr__tag))) (to_rep (first4 (mk2 (to_rep (first (rt (get_model1 s__attr__tag (mk___rep s__split_fields27 s__attr__tag))))) (- (to_rep (last (rt (get_model1 s__attr__tag (mk___rep s__split_fields27 s__attr__tag))))) 1)))) (to_rep (last4 (mk2 (to_rep (first (rt (get_model1 s__attr__tag (mk___rep s__split_fields27 s__attr__tag))))) (- (to_rep (last (rt (get_model1 s__attr__tag (mk___rep s__split_fields27 s__attr__tag))))) 1)))))) true)) (in_range2 e4)) (pop__specific_post s__attr__tag s__split_fields28 s__attr__tag e4 s__split_fields27 e3)))
(assert (= e4 i10))
(assert (= result9 (mk_int__ref i10)))
(assert (= i11 1))
(assert (and (and (and (= e5 (peek1 s__attr__tag (mk___rep s__split_fields28 s__attr__tag))) (= (let ((temp___228 (get_model1 s__attr__tag (mk___rep s__split_fields29 s__attr__tag)))) (bool_eq (elts temp___228) (to_rep (first (rt temp___228))) (to_rep (last (rt temp___228))) (elts (get_model1 s__attr__tag (mk___rep s__split_fields28 s__attr__tag))) (to_rep (first4 (mk2 (to_rep (first (rt (get_model1 s__attr__tag (mk___rep s__split_fields28 s__attr__tag))))) (- (to_rep (last (rt (get_model1 s__attr__tag (mk___rep s__split_fields28 s__attr__tag))))) 1)))) (to_rep (last4 (mk2 (to_rep (first (rt (get_model1 s__attr__tag (mk___rep s__split_fields28 s__attr__tag))))) (- (to_rep (last (rt (get_model1 s__attr__tag (mk___rep s__split_fields28 s__attr__tag))))) 1)))))) true)) (in_range2 e5)) (pop__specific_post s__attr__tag s__split_fields29 s__attr__tag e5 s__split_fields28 e4)))
(assert (= e5 i11))
