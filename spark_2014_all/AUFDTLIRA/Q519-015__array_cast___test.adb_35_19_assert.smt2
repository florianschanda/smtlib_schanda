...
(declare-const o (Array Int integer_subtype))
...
(declare-const result6 (Array Int integer_subtype))
...
(assert (= result5 result_array))
(assert (= result_array1 (convert2 test_array1)))
(assert (= (to_rep2 (select result_array1 1)) 2))
(assert (and (= o (cast test_array1)) (forall ((k Int)) (=> (and (<= 0 k) (<= k 2)) (= (to_rep2 (select o k)) (to_rep (select test_array1 k)))))))
(assert (= result6 result_array1))
(assert (= result_array2 o))
