...
(declare-fun temp___342 (Int) (Array Int natural))
...
(assert (forall ((temp___344 Int)) (=> (dynamic_invariant3 temp___344 true true true true) (forall ((temp___345 Int)) (= (to_rep1 (select (temp___342 temp___344) temp___345)) temp___344)))))
...
(assert (forall ((temp___352 Int) (temp___353 Int) (temp___354 Int)) (let ((temp___351 (test__test_array__aggregate_def temp___352 temp___353 temp___354))) (=> (and (and (dynamic_invariant2 temp___352 true true true true) (dynamic_invariant2 temp___353 true true true true)) (dynamic_invariant2 temp___354 true true true true)) (and (and (= (to_rep (select temp___351 0)) temp___352) (= (to_rep (select temp___351 1)) temp___353)) (= (to_rep (select temp___351 2)) temp___354))))))
...
(assert (= result x))
(assert (= x1 (test__x__aggregate_def (temp___342 1))))
