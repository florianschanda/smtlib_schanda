...
(define-fun bool_eq1 ((a (Array Int integer_subtype)) (a__first Int) (a__last Int) (b (Array Int integer_subtype)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_133 Int)) (=> (and (<= a__first temp___idx_133) (<= temp___idx_133 a__last)) (= (to_rep2 (select a temp___idx_133)) (to_rep2 (select b (+ (- b__first a__first) temp___idx_133))))))) true false))
(assert (forall ((a (Array Int integer_subtype)) (b (Array Int integer_subtype))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq1 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_133 Int)) (=> (and (<= a__first temp___idx_133) (<= temp___idx_133 a__last)) (= (to_rep2 (select a temp___idx_133)) (to_rep2 (select b (+ (- b__first a__first) temp___idx_133)))))))))))
...
(assert (forall ((a (Array Int integer_subtype)) (b (Array Int integer_subtype))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare1 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq1 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep2 (select a (+ i 1))) (to_rep2 (select b (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int integer_subtype)) (b (Array Int integer_subtype))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare1 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq1 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep2 (select b (+ i 1))) (to_rep2 (select a (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
...
(define-fun bool_eq2 ((a (Array Int natural)) (a__first Int) (a__last Int) (b (Array Int natural)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_134 Int)) (=> (and (<= a__first temp___idx_134) (<= temp___idx_134 a__last)) (= (to_rep1 (select a temp___idx_134)) (to_rep1 (select b (+ (- b__first a__first) temp___idx_134))))))) true false))
(assert (forall ((a (Array Int natural)) (b (Array Int natural))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq2 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_134 Int)) (=> (and (<= a__first temp___idx_134) (<= temp___idx_134 a__last)) (= (to_rep1 (select a temp___idx_134)) (to_rep1 (select b (+ (- b__first a__first) temp___idx_134)))))))))))
(declare-fun compare2 ((Array Int natural) Int Int (Array Int natural) Int Int) Int)
(assert (forall ((a (Array Int natural)) (b (Array Int natural))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare2 a a_first a_last b b_first b_last) 0) (= (bool_eq2 a a_first a_last b b_first b_last) true)) :pattern ((compare2 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int natural)) (b (Array Int natural))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare2 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq2 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep1 (select a (+ i 1))) (to_rep1 (select b (+ j 1))))))))))) :pattern ((compare2 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int natural)) (b (Array Int natural))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare2 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq2 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep1 (select b (+ i 1))) (to_rep1 (select a (+ j 1))))))))))) :pattern ((compare2 a a_first a_last b b_first b_last))))))
...
(declare-fun concat4 ((Array Int (Array Int natural)) Int Int (Array Int (Array Int natural)) Int Int) (Array Int (Array Int natural)))
...
(declare-fun singleton4 ((Array Int natural) Int) (Array Int (Array Int natural)))
(assert (forall ((v (Array Int natural))) (forall ((i Int)) (! (= (select (singleton4 v i) i) v) :pattern ((select (singleton4 v i) i))))))
(define-fun bool_eq3 ((a (Array Int (Array Int natural))) (a__first Int) (a__last Int) (b (Array Int (Array Int natural))) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_135 Int)) (=> (and (<= a__first temp___idx_135) (<= temp___idx_135 a__last)) (= (bool_eq2 (select a temp___idx_135) 1 100 (select b (+ (- b__first a__first) temp___idx_135)) 1 100) true)))) true false))
(assert (forall ((a (Array Int (Array Int natural))) (b (Array Int (Array Int natural)))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq3 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_135 Int)) (=> (and (<= a__first temp___idx_135) (<= temp___idx_135 a__last)) (= (bool_eq2 (select a temp___idx_135) 1 100 (select b (+ (- b__first a__first) temp___idx_135)) 1 100) true))))))))
...
(declare-fun concat5 ((Array Int (Array Int natural)) Int Int (Array Int (Array Int natural)) Int Int) (Array Int (Array Int natural)))
...
(declare-fun singleton5 ((Array Int natural) Int) (Array Int (Array Int natural)))
(assert (forall ((v (Array Int natural))) (forall ((i Int)) (! (= (select (singleton5 v i) i) v) :pattern ((select (singleton5 v i) i))))))
(define-fun bool_eq4 ((a (Array Int (Array Int natural))) (a__first Int) (a__last Int) (b (Array Int (Array Int natural))) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_136 Int)) (=> (and (<= a__first temp___idx_136) (<= temp___idx_136 a__last)) (= (bool_eq2 (select a temp___idx_136) 1 100 (select b (+ (- b__first a__first) temp___idx_136)) 1 100) true)))) true false))
...
(declare-fun concat6 ((Array Int us_rep) Int Int (Array Int us_rep) Int Int) (Array Int us_rep))
...
(assert (forall ((v us_rep)) (forall ((i Int)) (! (= (select (singleton6 v i) i) v) :pattern ((select (singleton6 v i) i))))))
(define-fun bool_eq6 ((a (Array Int us_rep)) (a__first Int) (a__last Int) (b (Array Int us_rep)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_137 Int)) (=> (and (<= a__first temp___idx_137) (<= temp___idx_137 a__last)) (= (bool_eq5 (select a temp___idx_137) (select b (+ (- b__first a__first) temp___idx_137))) true)))) true false))
(assert (forall ((a (Array Int us_rep)) (b (Array Int us_rep))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq6 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_137 Int)) (=> (and (<= a__first temp___idx_137) (<= temp___idx_137 a__last)) (= (bool_eq5 (select a temp___idx_137) (select b (+ (- b__first a__first) temp___idx_137))) true))))))))
(define-fun dynamic_invariant ((temp___expr_276 (Array Int us_rep)) (temp___is_init_273 Bool) (temp___skip_constant_274 Bool) (temp___do_toplevel_275 Bool)) Bool (forall ((temp___277 Int)) (=> (and (<= 1 temp___277) (<= temp___277 3)) (in_range4 10 (select temp___expr_276 temp___277)))))
(define-fun default_initial_assumption ((temp___expr_279 (Array Int us_rep)) (temp___skip_top_level_280 Bool)) Bool (forall ((temp___281 Int)) (=> (and (<= 1 temp___281) (<= temp___281 3)) (= (to_rep (rec__test__rec__x (us_split_discrs1 (select temp___expr_279 temp___281)))) 10))))
...
(declare-fun concat7 ((Array Int us_rep) Int Int (Array Int us_rep) Int Int) (Array Int us_rep))
...
(assert (forall ((v us_rep)) (forall ((i Int)) (! (= (select (singleton7 v i) i) v) :pattern ((select (singleton7 v i) i))))))
(define-fun bool_eq7 ((a (Array Int us_rep)) (a__first Int) (a__last Int) (b (Array Int us_rep)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_138 Int)) (=> (and (<= a__first temp___idx_138) (<= temp___idx_138 a__last)) (= (bool_eq5 (select a temp___idx_138) (select b (+ (- b__first a__first) temp___idx_138))) true)))) true false))
(assert (forall ((a (Array Int us_rep)) (b (Array Int us_rep))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq7 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_138 Int)) (=> (and (<= a__first temp___idx_138) (<= temp___idx_138 a__last)) (= (bool_eq5 (select a temp___idx_138) (select b (+ (- b__first a__first) temp___idx_138))) true))))))))
...
(define-fun dynamic_invariant1 ((temp___expr_288 (Array Int us_rep)) (temp___is_init_285 Bool) (temp___skip_constant_286 Bool) (temp___do_toplevel_287 Bool)) Bool (forall ((temp___289 Int)) (=> (and (<= 1 temp___289) (<= temp___289 3)) (in_range5 10 (select temp___expr_288 temp___289)))))
(define-fun default_initial_assumption1 ((temp___expr_291 (Array Int us_rep)) (temp___skip_top_level_292 Bool)) Bool (forall ((temp___293 Int)) (=> (and (<= 1 temp___293) (<= temp___293 3)) (= (to_rep (rec__test__rec__x (us_split_discrs1 (select temp___expr_291 temp___293)))) 10))))
...
(assert (forall ((temp___299 (Array Int natural))) (forall ((temp___300 Int)) (= (select (test__x__aggregate_def temp___299) temp___300) temp___299))))
(declare-fun temp___301 (Int) (Array Int natural))
(assert (forall ((temp___303 Int)) (forall ((temp___304 Int)) (= (select (temp___301 temp___303) temp___304) (of_rep1 temp___303)))))
(declare-fun convert ((Array Int (Array Int natural))) (Array Int (Array Int natural)))
(assert (forall ((a (Array Int (Array Int natural)))) (forall ((temp___305 Int)) (= (select a temp___305) (select (convert a) temp___305)))))
(declare-fun test__w__aggregate_def (us_rep) (Array Int us_rep))
(assert (forall ((temp___307 us_rep)) (forall ((temp___308 Int)) (= (select (test__w__aggregate_def temp___307) temp___308) temp___307))))
(declare-fun convert1 ((Array Int us_rep)) (Array Int us_rep))
(assert (forall ((a (Array Int us_rep))) (forall ((temp___309 Int)) (= (select a temp___309) (select (convert1 a) temp___309)))))
(declare-fun test__test_array__aggregate_def (Int Int Int) (Array Int integer))
(assert (forall ((temp___311 Int) (temp___312 Int) (temp___313 Int)) (let ((temp___310 (test__test_array__aggregate_def temp___311 temp___312 temp___313))) (and (and (= (select temp___310 0) (of_rep temp___311)) (= (select temp___310 1) (of_rep temp___312))) (= (select temp___310 2) (of_rep temp___313))))))
(declare-fun convert2 ((Array Int integer)) (Array Int integer_subtype))
(assert (forall ((a (Array Int integer))) (forall ((temp___319 Int)) (= (to_rep (select a temp___319)) (to_rep2 (select (convert2 a) temp___319))))))
...
(define-fun dynamic_invariant4 ((temp___expr_258 us_rep) (temp___is_init_255 Bool) (temp___skip_constant_256 Bool) (temp___do_toplevel_257 Bool)) Bool (=> (not (= temp___skip_constant_256 true)) (in_range4 10 temp___expr_258)))
(define-fun default_initial_assumption2 ((temp___expr_260 us_rep) (temp___skip_top_level_261 Bool)) Bool (= (to_rep (rec__test__rec__x (us_split_discrs1 temp___expr_260))) 10))
(define-fun dynamic_invariant5 ((temp___expr_267 us_rep) (temp___is_init_264 Bool) (temp___skip_constant_265 Bool) (temp___do_toplevel_266 Bool)) Bool (=> (not (= temp___skip_constant_265 true)) (in_range5 10 temp___expr_267)))
(define-fun default_initial_assumption3 ((temp___expr_269 us_rep) (temp___skip_top_level_270 Bool)) Bool (= (to_rep (rec__test__rec__x (us_split_discrs1 temp___expr_269))) 10))
(define-fun dynamic_invariant6 ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_142)))
...
(declare-const result_array (Array Int integer_subtype))
...
(declare-const result_array1 (Array Int integer_subtype))
(declare-const result6 map__ref1)
(declare-const result_array2 (Array Int integer_subtype))
...
(assert (= o4 o3))
(assert (= o5 o2))
(assert (= (mk___rep (mk___split_discrs o6) (mk___split_fields o7)) (mk___rep (mk___split_discrs o4) (mk___split_fields o5))))
(assert (= (mk___rep (mk___split_discrs o8) (mk___split_fields o9)) (mk___rep (mk___split_discrs o6) (mk___split_fields o7))))
(assert (= (mk___rep (mk___split_discrs o10) (mk___split_fields o11)) (mk___rep (mk___split_discrs o8) (mk___split_fields o9))))
(assert (= o12 (test__w__aggregate_def (mk___rep (mk___split_discrs o10) (mk___split_fields o11)))))
...
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i 3)) (= (to_rep (rec__test__rec__y (us_split_fields1 (select z1 i)))) 1))))
(assert (= result5 (mk_map__ref1 result_array)))
(assert (= result_array1 (convert2 test_array1)))
(assert (= (to_rep2 (select result_array1 1)) 2))
(assert (and (= o13 (cast test_array1)) (forall ((k Int)) (=> (and (<= 0 k) (<= k 2)) (= (to_rep2 (select o13 k)) (to_rep (select test_array1 k)))))))
(assert (= result6 (mk_map__ref1 result_array1)))
(assert (= result_array2 o13))
(assert (not (= (to_rep2 (select result_array2 1)) 2)))
(check-sat)
(exit)
