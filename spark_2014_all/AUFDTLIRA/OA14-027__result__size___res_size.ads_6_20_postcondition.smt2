...
(assert (= (mk___t res_size__f__result6 res_size__f__result7) (mk___t res_size__f__result2 res_size__f__result3)))
(assert (= result res_size__f__result))
(assert (= result1 res_size__f__result1))
(assert (= (mk___t res_size__f__result2 res_size__f__result3) a))
