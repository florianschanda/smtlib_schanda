...
(assert (and (and (forall ((temp___295 Int)) (=> (and (<= 1 temp___295) (<= temp___295 10000)) (ite (< r2 temp___295) (= (select data3 temp___295) (select data1 temp___295)) (= (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data3 temp___295))) (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data1 temp___295))))))) (=> (<= 1 10000) (in_range4 r2))) (and (<= 1 r2) (<= r2 10000))))
(assert (<= 1 rr))
(assert (<= rr r2))
(assert (not (= rr 10000)))
