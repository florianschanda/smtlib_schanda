...
(assert (<= 1 r1))
(assert (<= r1 10000))
(assert (=> (< r1 10000) (and (= o7 (+ r1 1)) (in_range3 (+ r1 1)))))
(assert (=> (< r1 10000) (= (to_rep o8) o7)))
(assert (=> (< r1 10000) (= (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data1 r1))) o9)))
...
(assert (and (and (forall ((temp___258 Int)) (=> (and (<= 1 temp___258) (<= temp___258 10000)) (ite (< r2 temp___258) (= (select data3 temp___258) (select data1 temp___258)) (= (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data3 temp___258))) (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data1 temp___258))))))) (=> (<= 1 10000) (in_range4 r2))) (and (<= 1 r2) (<= r2 10000))))
(assert (<= 1 rr))
(assert (<= rr r2))
(assert (not (= rr 10000)))
(assert (not (in_range2 (+ rr 1))))
(check-sat)
(exit)
