...
(assert (and (and (and (= (mk_map__ref1 result) (mk_map__ref1 result__)) (= result__1 (stable_marriage__invert_1__result__aggregate_def 64))) (and (forall ((rank11 Int)) (=> (and (<= 1 rank11) (<= rank11 64)) (forall ((rank21 Int)) (=> (and (<= 1 rank21) (<= rank21 64)) (=> (not (= rank11 rank21)) (not (= (to_rep (select r1 rank11)) (to_rep (select r1 rank21))))))))) (and (and (and (= (mk_int__ref result1) (mk_int__ref rank)) (= rank1 1)) (ite (and (<= 1 rank1) (<= rank1 64)) (and (and (and (= temp___445 rank1) (and (= temp___443 result__1) (and (and (forall ((prev2 Int)) (=> (and (<= 1 prev2) (<= prev2 (- rank2 1))) (= (to_rep1 (select result__2 (to_rep (select r1 prev2)))) prev2))) (forall ((g11 Int)) (=> (and (<= 1 g11) (<= g11 64)) (=> (exists ((prev2 Int)) (and (and (<= 1 prev2) (<= prev2 (- rank2 1))) (= (to_rep (select r1 prev2)) g11))) (= (to_rep (select r1 (to_rep1 (select result__2 g11)))) g11))))) (and (and (=> (<= 1 64) (in_range2 rank2)) (and (<= 1 rank2) (<= rank2 64))) (and (and (and (= (to_rep1 o) rank2) (= o1 (store result__2 (to_rep (select r1 rank2)) o))) (and (= result__2 result2) (= result__3 o1))) (= rank2 64)))))) (and (and (= rank2 rank4) (= result__3 result__4)) (and (= rank5 rank2) (= result__5 result__3)))) (and (and (= (mk_int__ref rank6) (mk_int__ref rank4)) (= (mk_map__ref1 result__6) (mk_map__ref1 result__4))) (and (= rank7 rank5) (= result__7 result__5)))) (and (and (= rank1 rank6) (= result__1 result__6)) (and (= rank7 rank1) (= result__7 result__1))))) (and (and (= stable_marriage__invert_1__result1 stable_marriage__invert_1__result2) (= stable_marriage__invert_1__result3 stable_marriage__invert_1__result1)) (and (= result4 stable_marriage__invert_1__result) (= stable_marriage__invert_1__result1 result__6)))))) (and (and (= (mk_map__ref1 stable_marriage__invert_1__result4) (mk_map__ref1 stable_marriage__invert_1__result2)) (and (= (mk_int__ref rank8) (mk_int__ref rank6)) (= (mk_map__ref1 result__8) (mk_map__ref1 result__6)))) (and (= stable_marriage__invert_1__result5 stable_marriage__invert_1__result3) (and (= rank9 rank7) (= result__9 result__7))))))
(assert (= result5 stable_marriage__invert_1__result4))
