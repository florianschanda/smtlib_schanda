...
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r23b i4) (<= i4 r24b)) (= temp___1619 i4))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r23b i4) (<= i4 r24b)) (= temp___1617 newdomainname1))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r23b i4) (<= i4 r24b)) (= temp___1620 endidx8))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r23b i4) (<= i4 r24b)) (and (and (<= 1 begidx11) (<= (+ (- endidx8 begidx11) 1) 128)) (= endidx8 temp___1620)))))
...
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r23b i4) (<= i4 r24b)) (and (= temp___1616 o4) (in_range1 o4)))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r23b i4) (<= i4 r24b)) (and (<= 1 temp___1616) (<= temp___1616 128)))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r23b i4) (<= i4 r24b)) (= o6 temp___1616))))
...
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r26b i10) (<= i10 128)) (= temp___1625 i10))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r26b i10) (<= i10 128)) (= temp___1623 (map__content newdomainname6)))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r26b i10) (<= i10 128)) (<= 1 endidx8))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r26b i10) (<= i10 128)) (and (and (forall ((temp___1624 Int)) (=> (and (<= 1 temp___1624) (<= temp___1624 128)) (=> (<= i11 temp___1624) (= (select newdomainname8 temp___1624) (select temp___1623 temp___1624))))) (=> (<= r26b 128) (dynamic_property1 r26b 128 i11))) (and (<= r26b i11) (<= i11 128))))))
