...
(declare-fun temp___1240 ((Array Int (Array Int et1)) Int (Array Int et1) Int (Array Int et1)) (Array Int (Array Int et1)))
...
(assert (forall ((temp___1242 (Array Int (Array Int et1)))) (forall ((temp___1243 Int) (temp___1245 Int)) (forall ((temp___1244 (Array Int et1)) (temp___1246 (Array Int et1))) (let ((temp___1241 (temp___1240 temp___1242 temp___1243 temp___1244 temp___1245 temp___1246))) (=> (and (dynamic_invariant temp___1243 true true true true) (dynamic_invariant temp___1245 true true true true)) (forall ((temp___1247 Int)) (ite (= temp___1247 temp___1245) (= (select temp___1241 temp___1247) temp___1246) (ite (= temp___1247 temp___1243) (= (select temp___1241 temp___1247) temp___1244) (= (select temp___1241 temp___1247) (select temp___1242 temp___1247)))))))))))
...
(assert (= a2 a3))
(assert (= a4 a2))
(assert (not (= (bool_eq1 a3 5 50 (temp___1240 a i b j c) 5 50) true)))
(check-sat)
(exit)
