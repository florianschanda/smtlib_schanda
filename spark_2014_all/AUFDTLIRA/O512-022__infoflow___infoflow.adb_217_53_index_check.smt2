...
(assert (and (forall ((m12 Int)) (=> (and (<= (to_rep a_v2__first) m12) (<= m12 k_2)) (= (to_rep (select a_v212 m12)) (to_rep (select (elts b_v2) m12))))) (forall ((m12 Int)) (=> (and (<= (+ k_2 1) m12) (<= m12 (- i_v214 1))) (= (to_rep (select a_v212 m12)) (to_rep (select (elts c_v2) (- m12 k_2))))))))
(assert (and (and (forall ((temp___461 Int)) (=> (and (<= (to_rep a_v2__first) temp___461) (<= temp___461 (to_rep a_v2__last))) (=> (<= i_v214 temp___461) (= (select a_v212 temp___461) (select (map__content a_v210) temp___461))))) (=> (<= (+ k_2 1) (to_rep a_v2__last)) (dynamic_property4 (+ k_2 1) (to_rep a_v2__last) i_v214))) (and (<= (+ k_2 1) i_v214) (<= i_v214 (to_rep a_v2__last)))))
(assert (<= (to_rep a_v2__first) m11))
(assert (<= m11 k_2))
(assert (not (<= (to_rep (first (rt b_v2))) m11)))
(check-sat)
(exit)
