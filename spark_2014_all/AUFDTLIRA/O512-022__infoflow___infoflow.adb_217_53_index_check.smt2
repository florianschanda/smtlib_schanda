...
(assert (and (and (forall ((temp___461 Int)) (=> (and (<= (to_rep a_v2__first) temp___461) (<= temp___461 (to_rep a_v2__last))) (=> (<= i_v22 temp___461) (= (select a_v21 temp___461) (select (map__content a_v2) temp___461))))) (=> (<= (+ k_2 1) (to_rep a_v2__last)) (dynamic_property4 (+ k_2 1) (to_rep a_v2__last) i_v22))) (and (<= (+ k_2 1) i_v22) (<= i_v22 (to_rep a_v2__last)))))
