...
(assert (=> (not (= first_available 0)) (and (= o11 (length model____split_fields)) (in_range6 o11))))
(assert (=> (not (= first_available 0)) (= result3 (ite (< 0 o11) true false))))
(assert (=> (not (= first_available 0)) (=> (= result3 true) (and (= o10 (get model____split_fields 1)) (in_range7 o10)))))
...
(assert (=> (not (not (= first_available 0))) (and (= o12 (length model____split_fields)) (in_range6 o12))))
(assert (=> (not (not (= first_available 0))) (= result2 (ite (= o12 0) true false))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (and (= o8 (length model____split_fields1)) (in_range6 o8)))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (= result4 (ite (< 0 o8) true false)))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (=> (= result4 true) (and (= o7 (get model____split_fields1 1)) (in_range7 o7))))))
...
(assert (=> (= result2 true) (=> (not (not (= first_allocated 0))) (and (= o9 (length model____split_fields1)) (in_range6 o9)))))
(assert (=> (= result2 true) (=> (not (not (= first_allocated 0))) (= result1 (ite (= o9 0) true false)))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (=> (= result1 true) (and (= o5 (length model____split_fields)) (in_range6 o5))))
...
(assert (= result6 true))
(assert (and (= o4 (get model____split_fields1 j)) (in_range7 o4)))
(assert (= result7 (ite (in_range4 o4) true false)))
(assert (= result7 true))
