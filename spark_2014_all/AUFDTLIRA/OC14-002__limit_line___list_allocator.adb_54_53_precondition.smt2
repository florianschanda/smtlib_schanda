...
(assert (=> (not (= first_available 0)) (and (= o11 (length model____split_fields)) (in_range3 o11))))
(assert (=> (not (= first_available 0)) (= result3 (ite (< 0 o11) true false))))
(assert (=> (not (= first_available 0)) (=> (= result3 true) (and (= o10 (get model____split_fields 1)) (in_range4 o10)))))
(assert (=> (not (= first_available 0)) (=> (= result3 true) (= result2 (ite (= o10 first_available) true false)))))
(assert (=> (not (= first_available 0)) (=> (not (= result3 true)) (= result2 false))))
(assert (=> (not (not (= first_available 0))) (and (= o12 (length model____split_fields)) (in_range3 o12))))
(assert (=> (not (not (= first_available 0))) (= result2 (ite (= o12 0) true false))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (and (= o8 (length model____split_fields1)) (in_range3 o8)))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (= result4 (ite (< 0 o8) true false)))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (=> (= result4 true) (and (= o7 (get model____split_fields1 1)) (in_range4 o7))))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (=> (= result4 true) (= result1 (ite (= o7 first_allocated) true false))))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (=> (not (= result4 true)) (= result1 false)))))
(assert (=> (= result2 true) (=> (not (not (= first_allocated 0))) (and (= o9 (length model____split_fields1)) (in_range3 o9)))))
(assert (=> (= result2 true) (=> (not (not (= first_allocated 0))) (= result1 (ite (= o9 0) true false)))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (=> (= result1 true) (and (= o5 (length model____split_fields)) (in_range3 o5))))
(assert (=> (= result1 true) (= o6 (ite (<= j1 o5) true false))))
(assert (=> (= result1 true) (= result5 (ite (<= 1 j1) o6 false))))
...
(assert (= result6 true))
(assert (and (= o4 (get model____split_fields1 j)) (in_range4 o4)))
(assert (= result7 (ite (in_range6 o4) true false)))
(assert (= result7 true))
...
(assert (not (<= o3 (length model____split_fields1))))
(check-sat)
(exit)
