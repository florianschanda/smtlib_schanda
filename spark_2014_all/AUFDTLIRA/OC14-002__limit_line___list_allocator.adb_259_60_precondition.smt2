...
(assert (and (= o77 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (in_range7 o77)))
(assert (= result13 (ite (in_range4 o77) true false)))
(assert (=> (= result13 true) (and (= o73 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range6 o73))))
(assert (=> (= result13 true) (= result14 (ite (< j o73) true false))))
(assert (=> (= result13 true) (=> (= result14 true) (and (= o74 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result13 true) (=> (= result14 true) (and (= o75 (get (rec__list_allocator__m__t__available model____split_fields3) o74)) (in_range7 o75)))))
...
(assert (=> (= result13 true) (= o69 temp___427)))
...
(assert (=> (= result12 true) (=> (< 1 j) (and (= o67 (get (rec__list_allocator__m__t__available model____split_fields3) o66)) (in_range7 o67)))))
...
(assert (=> (= result12 true) (= o62 temp___428)))
