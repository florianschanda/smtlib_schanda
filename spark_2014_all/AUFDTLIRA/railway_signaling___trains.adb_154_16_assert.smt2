...
(declare-const temp___396 (Array Int signal))
(declare-const temp___390 Int)
(declare-const temp___395 (Array Int signal))
(declare-const temp___388 (Array Int signal))
(declare-const temp___386 Int)
...
(assert (= id1 1))
(assert (=> (and (<= 1 id1) (<= id1 3)) (= temp___396 track_signals1)))
(assert (=> (and (<= 1 id1) (<= id1 3)) (= temp___390 prev)))
(assert (=> (and (<= 1 id1) (<= id1 3)) (= temp___395 track_signals1)))
(assert (=> (and (<= 1 id1) (<= id1 3)) (= temp___388 track_signals1)))
(assert (=> (and (<= 1 id1) (<= id1 3)) (= temp___386 id1)))
...
(assert (=> (and (<= 1 id1) (<= id1 3)) (forall ((k Int)) (=> (and (<= 1 k) (<= k id2)) (=> (not (= (get_other_previous_track new_position k) 0)) (let ((temp___394 (to_rep5 (select track_signals3 (get_other_previous_track new_position k))))) (or (= temp___394 1) (= temp___394 2))))))))
(assert (=> (and (<= 1 id1) (<= id1 3)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 8)) (and (=> (= (to_rep5 (select temp___395 j)) 2) (= (to_rep5 (select track_signals3 j)) 2)) (=> (= (to_rep5 (select temp___396 j)) 1) (= (to_rep5 (select track_signals3 j)) 1)))))))
