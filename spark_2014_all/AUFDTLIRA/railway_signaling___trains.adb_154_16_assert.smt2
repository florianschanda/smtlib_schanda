...
(assert (= id1 1))
(assert (=> (and (<= 1 id1) (<= id1 3)) (= temp___364 track_signals1)))
(assert (=> (and (<= 1 id1) (<= id1 3)) (= temp___358 prev)))
(assert (=> (and (<= 1 id1) (<= id1 3)) (= temp___363 track_signals1)))
(assert (=> (and (<= 1 id1) (<= id1 3)) (= temp___356 track_signals1)))
(assert (=> (and (<= 1 id1) (<= id1 3)) (= temp___354 id1)))
(assert (=> (and (<= 1 id1) (<= id1 3)) (and (= o2 (get_other_previous_track new_position id1)) (and (in_range1 o2) (= o2 (ite (= (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep (rec__trains__train_position__track_begin (us_split_fields3 new_position)))))))) id1)) (to_rep (rec__trains__train_position__track_end (us_split_fields3 new_position)))) 0 (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep (rec__trains__train_position__track_begin (us_split_fields3 new_position)))))))) id1))))))))
(assert (=> (and (<= 1 id1) (<= id1 3)) (= result7 prev8)))
(assert (=> (and (<= 1 id1) (<= id1 3)) (= prev2 o2)))
(assert (=> (and (<= 1 id1) (<= id1 3)) (=> (not (= prev2 0)) (and (<= 1 prev2) (<= prev2 8)))))
(assert (=> (and (<= 1 id1) (<= id1 3)) (=> (not (= prev2 0)) (= o3 prev2))))
(assert (=> (and (<= 1 id1) (<= id1 3)) (=> (not (= prev2 0)) (= o4 (select track_signals1 o3)))))
(assert (=> (and (<= 1 id1) (<= id1 3)) (=> (not (= prev2 0)) (= o5 (to_rep5 o4)))))
(assert (=> (and (<= 1 id1) (<= id1 3)) (=> (not (= prev2 0)) (= result8 (ite (= o5 0) true false)))))
(assert (=> (and (<= 1 id1) (<= id1 3)) (=> (not (not (= prev2 0))) (= result8 false))))
(assert (=> (and (<= 1 id1) (<= id1 3)) (=> (= result8 true) (= (to_rep5 o6) 1))))
(assert (=> (and (<= 1 id1) (<= id1 3)) (=> (= result8 true) (and (<= 1 prev2) (<= prev2 8)))))
(assert (=> (and (<= 1 id1) (<= id1 3)) (=> (= result8 true) (= o7 prev2))))
(assert (=> (and (<= 1 id1) (<= id1 3)) (=> (= result8 true) (= o8 (store track_signals1 o7 o6)))))
(assert (=> (and (<= 1 id1) (<= id1 3)) (=> (= result8 true) (= result9 (mk_map__ref4 track_signals1)))))
(assert (=> (and (<= 1 id1) (<= id1 3)) (=> (= result8 true) (= track_signals2 o8))))
(assert (=> (and (<= 1 id1) (<= id1 3)) (=> (not (= result8 true)) (= track_signals2 track_signals1))))
(assert (=> (and (<= 1 id1) (<= id1 3)) (forall ((k Int)) (=> (and (<= 1 k) (<= k id2)) (=> (not (= (get_other_previous_track new_position k) 0)) (let ((temp___362 (to_rep5 (select track_signals3 (get_other_previous_track new_position k))))) (or (= temp___362 1) (= temp___362 2))))))))
(assert (=> (and (<= 1 id1) (<= id1 3)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 8)) (and (=> (= (to_rep5 (select temp___363 j)) 2) (= (to_rep5 (select track_signals3 j)) 2)) (=> (= (to_rep5 (select temp___364 j)) 1) (= (to_rep5 (select track_signals3 j)) 1)))))))
(assert (=> (and (<= 1 id1) (<= id1 3)) (and (and (=> (<= 1 3) (in_range3 id2)) (=> (<= 0 8) (in_range1 prev3))) (and (<= 1 id2) (<= id2 3)))))
(assert (=> (and (<= 1 id1) (<= id1 3)) (= id2 3)))
(assert (=> (and (<= 1 id1) (<= id1 3)) (= id3 (mk_int__ref id2))))
(assert (=> (and (<= 1 id1) (<= id1 3)) (= prev4 (mk_int__ref prev3))))
(assert (=> (and (<= 1 id1) (<= id1 3)) (= track_signals4 (mk_map__ref4 track_signals3))))
...
(assert (=> (not (and (<= 1 id1) (<= id1 3))) (= track_signals6 (mk_map__ref4 track_signals1))))
(assert (=> (not (and (<= 1 id1) (<= id1 3))) (= id6 id1)))
(assert (=> (not (and (<= 1 id1) (<= id1 3))) (= prev7 prev1)))
(assert (=> (not (and (<= 1 id1) (<= id1 3))) (= track_signals7 track_signals1)))
(assert (= (occupied_tracks_on_red cur_num_trains trains1 (map__content4 track_signals6)) true))
(assert (not (= (previous_tracks_on_orange_or_red cur_num_trains trains1 (map__content4 track_signals6)) true)))
(check-sat)
(exit)
