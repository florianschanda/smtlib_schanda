...
(declare-const temp___398 (Array Int signal))
(declare-const temp___392 Int)
(declare-const temp___397 (Array Int signal))
(declare-const temp___390 (Array Int signal))
(declare-const temp___388 Int)
...
(assert (not (= (to_rep5 (select track_signals (to_rep4 (rec__trains__train_position__track_begin (us_split_fields3 new_position))))) 2)))
(assert (=> (= (to_rep5 (select track_signals (to_rep4 (rec__trains__train_position__track_begin (us_split_fields3 new_position))))) 0) (= result2 result__3)))
(assert (=> (= (to_rep5 (select track_signals (to_rep4 (rec__trains__train_position__track_begin (us_split_fields3 new_position))))) 0) (= result__1 0)))
(assert (=> (not (= (to_rep5 (select track_signals (to_rep4 (rec__trains__train_position__track_begin (us_split_fields3 new_position))))) 0)) (= result3 result__3)))
(assert (=> (not (= (to_rep5 (select track_signals (to_rep4 (rec__trains__train_position__track_begin (us_split_fields3 new_position))))) 0)) (= result__2 1)))
(assert (=> (not (= (to_rep5 (select track_signals (to_rep4 (rec__trains__train_position__track_begin (us_split_fields3 new_position))))) 0)) (= result__1 result__2)))
(assert (= result4 (mk_map__ref3 trains)))
(assert (= trains1 (store trains train new_position)))
(assert (= (to_rep5 o) 2))
(assert (= o1 (store track_signals (to_rep4 (rec__trains__train_position__track_begin (us_split_fields3 new_position))) o)))
(assert (= result5 (mk_map__ref4 track_signals)))
(assert (= track_signals1 o1))
(assert (= result6 (mk_int__ref id)))
(assert (= id1 1))
(assert (=> (and (<= 1 id1) (<= id1 3)) (= temp___398 track_signals1)))
(assert (=> (and (<= 1 id1) (<= id1 3)) (= temp___392 prev)))
(assert (=> (and (<= 1 id1) (<= id1 3)) (= temp___397 track_signals1)))
(assert (=> (and (<= 1 id1) (<= id1 3)) (= temp___390 track_signals1)))
(assert (=> (and (<= 1 id1) (<= id1 3)) (= temp___388 id1)))
(assert (=> (and (<= 1 id1) (<= id1 3)) (and (= o2 (get_other_previous_track new_position id1)) (and (in_range3 o2) (= o2 (ite (= (to_rep2 (select (select previous_tracks (to_rep (rec__trains__track__from (us_split_fields1 (select tracks (to_rep4 (rec__trains__train_position__track_begin (us_split_fields3 new_position)))))))) id1)) (to_rep4 (rec__trains__train_position__track_end (us_split_fields3 new_position)))) 0 (to_rep2 (select (select previous_tracks (to_rep (rec__trains__track__from (us_split_fields1 (select tracks (to_rep4 (rec__trains__train_position__track_begin (us_split_fields3 new_position)))))))) id1))))))))
...
(assert (=> (and (<= 1 id1) (<= id1 3)) (forall ((k Int)) (=> (and (<= 1 k) (<= k id2)) (=> (not (= (get_other_previous_track new_position k) 0)) (let ((temp___396 (to_rep5 (select track_signals3 (get_other_previous_track new_position k))))) (or (= temp___396 1) (= temp___396 2))))))))
(assert (=> (and (<= 1 id1) (<= id1 3)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 8)) (and (=> (= (to_rep5 (select temp___397 j)) 2) (= (to_rep5 (select track_signals3 j)) 2)) (=> (= (to_rep5 (select temp___398 j)) 1) (= (to_rep5 (select track_signals3 j)) 1)))))))
(assert (=> (and (<= 1 id1) (<= id1 3)) (and (and (=> (<= 1 3) (in_range8 id2)) (=> (<= 0 8) (in_range3 prev3))) (and (<= 1 id2) (<= id2 3)))))
