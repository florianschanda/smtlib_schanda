...
(define-fun dynamic_invariant ((temp___expr_202 Int) (temp___is_init_199 Bool) (temp___skip_constant_200 Bool) (temp___do_toplevel_201 Bool)) Bool (=> (or (= temp___is_init_199 true) (<= 0 8)) (in_range1 temp___expr_202)))
...
(declare-fun concat2 ((Array Int track_opt_id) Int Int (Array Int track_opt_id) Int Int) (Array Int track_opt_id))
...
(assert (forall ((v track_opt_id)) (forall ((i Int)) (! (= (select (singleton2 v i) i) v) :pattern ((select (singleton2 v i) i))))))
(define-fun bool_eq2 ((a (Array Int track_opt_id)) (a__first Int) (a__last Int) (b (Array Int track_opt_id)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_143 Int)) (=> (and (<= a__first temp___idx_143) (<= temp___idx_143 a__last)) (= (to_rep3 (select a temp___idx_143)) (to_rep3 (select b (+ (- b__first a__first) temp___idx_143))))))) true false))
(assert (forall ((a (Array Int track_opt_id)) (b (Array Int track_opt_id))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq2 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_143 Int)) (=> (and (<= a__first temp___idx_143) (<= temp___idx_143 a__last)) (= (to_rep3 (select a temp___idx_143)) (to_rep3 (select b (+ (- b__first a__first) temp___idx_143)))))))))))
(declare-fun compare ((Array Int track_opt_id) Int Int (Array Int track_opt_id) Int Int) Int)
(assert (forall ((a (Array Int track_opt_id)) (b (Array Int track_opt_id))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare a a_first a_last b b_first b_last) 0) (= (bool_eq2 a a_first a_last b b_first b_last) true)) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int track_opt_id)) (b (Array Int track_opt_id))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq2 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep3 (select a (+ i 1))) (to_rep3 (select b (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int track_opt_id)) (b (Array Int track_opt_id))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq2 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep3 (select b (+ i 1))) (to_rep3 (select a (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
...
(declare-fun concat3 ((Array Int (Array Int track_opt_id)) Int Int (Array Int (Array Int track_opt_id)) Int Int) (Array Int (Array Int track_opt_id)))
...
(declare-fun singleton3 ((Array Int track_opt_id) Int) (Array Int (Array Int track_opt_id)))
(assert (forall ((v (Array Int track_opt_id))) (forall ((i Int)) (! (= (select (singleton3 v i) i) v) :pattern ((select (singleton3 v i) i))))))
(define-fun bool_eq3 ((a (Array Int (Array Int track_opt_id))) (a__first Int) (a__last Int) (b (Array Int (Array Int track_opt_id))) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_144 Int)) (=> (and (<= a__first temp___idx_144) (<= temp___idx_144 a__last)) (= (bool_eq2 (select a temp___idx_144) 1 3 (select b (+ (- b__first a__first) temp___idx_144)) 1 3) true)))) true false))
(assert (forall ((a (Array Int (Array Int track_opt_id))) (b (Array Int (Array Int track_opt_id)))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq3 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_144 Int)) (=> (and (<= a__first temp___idx_144) (<= temp___idx_144 a__last)) (= (bool_eq2 (select a temp___idx_144) 1 3 (select b (+ (- b__first a__first) temp___idx_144)) 1 3) true))))))))
(declare-const previous_tracks (Array Int (Array Int track_opt_id)))
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(assert true)
(assert (forall ((us_void_param tuple0)) (! (= (= (no_track_precedes_itself us_void_param) true) (forall ((track Int)) (=> (and (<= 1 track) (<= track 8)) (forall ((id Int)) (=> (and (<= 1 id) (<= id 3)) (not (= (to_rep3 (let ((temp___227 (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks track))))))) (select temp___227 id))) track))))))) :pattern ((no_track_precedes_itself us_void_param)))))
...
(define-fun dynamic_invariant1 ((temp___expr_231 Int) (temp___is_init_228 Bool) (temp___skip_constant_229 Bool) (temp___do_toplevel_230 Bool)) Bool (=> (or (= temp___is_init_228 true) (<= 1 10)) (in_range6 temp___expr_231)))
...
(declare-fun concat4 ((Array Int us_rep1) Int Int (Array Int us_rep1) Int Int) (Array Int us_rep1))
...
(assert (forall ((v us_rep1)) (forall ((i Int)) (! (= (select (singleton4 v i) i) v) :pattern ((select (singleton4 v i) i))))))
(define-fun bool_eq5 ((a (Array Int us_rep1)) (a__first Int) (a__last Int) (b (Array Int us_rep1)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_182 Int)) (=> (and (<= a__first temp___idx_182) (<= temp___idx_182 a__last)) (= (bool_eq4 (select a temp___idx_182) (select b (+ (- b__first a__first) temp___idx_182))) true)))) true false))
(assert (forall ((a (Array Int us_rep1)) (b (Array Int us_rep1))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq5 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_182 Int)) (=> (and (<= a__first temp___idx_182) (<= temp___idx_182 a__last)) (= (bool_eq4 (select a temp___idx_182) (select b (+ (- b__first a__first) temp___idx_182))) true))))))))
...
(declare-fun concat5 ((Array Int signal) Int Int (Array Int signal) Int Int) (Array Int signal))
(assert (forall ((a (Array Int signal)) (b (Array Int signal))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (forall ((i Int)) (! (and (=> (and (<= a_first i) (<= i a_last)) (= (select (concat5 a a_first a_last b b_first b_last) i) (select a i))) (=> (< a_last i) (= (select (concat5 a a_first a_last b b_first b_last) i) (select b (+ (- i a_last) (- b_first 1)))))) :pattern ((select (concat5 a a_first a_last b b_first b_last) i)))))))
(declare-fun singleton5 (signal Int) (Array Int signal))
(assert (forall ((v signal)) (forall ((i Int)) (! (= (select (singleton5 v i) i) v) :pattern ((select (singleton5 v i) i))))))
(define-fun bool_eq6 ((a (Array Int signal)) (a__first Int) (a__last Int) (b (Array Int signal)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_183 Int)) (=> (and (<= a__first temp___idx_183) (<= temp___idx_183 a__last)) (= (to_rep5 (select a temp___idx_183)) (to_rep5 (select b (+ (- b__first a__first) temp___idx_183))))))) true false))
(assert (forall ((a (Array Int signal)) (b (Array Int signal))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq6 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_183 Int)) (=> (and (<= a__first temp___idx_183) (<= temp___idx_183 a__last)) (= (to_rep5 (select a temp___idx_183)) (to_rep5 (select b (+ (- b__first a__first) temp___idx_183)))))))))))
(declare-fun compare1 ((Array Int signal) Int Int (Array Int signal) Int Int) Int)
(assert (forall ((a (Array Int signal)) (b (Array Int signal))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare1 a a_first a_last b b_first b_last) 0) (= (bool_eq6 a a_first a_last b b_first b_last) true)) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int signal)) (b (Array Int signal))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare1 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq6 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep5 (select a (+ i 1))) (to_rep5 (select b (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int signal)) (b (Array Int signal))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare1 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq6 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep5 (select b (+ i 1))) (to_rep5 (select a (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
...
(define-fun dynamic_invariant2 ((temp___expr_214 Int) (temp___is_init_211 Bool) (temp___skip_constant_212 Bool) (temp___do_toplevel_213 Bool)) Bool (=> (or (= temp___is_init_211 true) (<= 1 3)) (in_range3 temp___expr_214)))
(assert (forall ((position us_rep1)) (forall ((id Int)) (! (=> (dynamic_invariant2 id true true true) (dynamic_invariant (get_previous_track position id) true false true)) :pattern ((get_previous_track position id))))))
(assert (forall ((position us_rep1)) (forall ((id Int)) (! (=> (dynamic_invariant2 id true true true) (= (get_previous_track position id) (to_rep3 (let ((temp___261 (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep (rec__trains__train_position__track_end (us_split_fields3 position)))))))))) (select temp___261 id))))) :pattern ((get_previous_track position id))))))
...
(assert (forall ((position us_rep1)) (forall ((id Int)) (! (=> (dynamic_invariant2 id true true true) (dynamic_invariant (get_other_previous_track position id) true false true)) :pattern ((get_other_previous_track position id))))))
(assert (forall ((position us_rep1)) (forall ((id Int)) (! (=> (dynamic_invariant2 id true true true) (= (get_other_previous_track position id) (ite (= (to_rep3 (let ((temp___265 (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep (rec__trains__train_position__track_begin (us_split_fields3 position)))))))))) (select temp___265 id))) (to_rep (rec__trains__train_position__track_end (us_split_fields3 position)))) 0 (to_rep3 (let ((temp___264 (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep (rec__trains__train_position__track_begin (us_split_fields3 position)))))))))) (select temp___264 id)))))) :pattern ((get_other_previous_track position id))))))
(declare-fun is_previous_track (us_rep1 Int) Bool)
(declare-fun is_previous_track__function_guard (Bool us_rep1 Int) Bool)
(define-fun dynamic_invariant3 ((temp___expr_208 Int) (temp___is_init_205 Bool) (temp___skip_constant_206 Bool) (temp___do_toplevel_207 Bool)) Bool (=> (or (= temp___is_init_205 true) (<= 1 8)) (in_range2 temp___expr_208)))
(assert true)
...
(assert true)
(assert (forall ((trains__cur_num_trains Int)) (forall ((trains__trains (Array Int us_rep1))) (forall ((trains__track_signals (Array Int signal))) (! (= (= (previous_tracks_on_orange_or_red trains__cur_num_trains trains__trains trains__track_signals) true) (forall ((train Int)) (=> (and (<= 1 train) (<= train trains__cur_num_trains)) (forall ((id Int)) (=> (and (<= 1 id) (<= id 3)) (and (=> (not (= (get_previous_track (select trains__trains train) id) 0)) (let ((temp___274 (to_rep5 (select trains__track_signals (get_previous_track (select trains__trains train) id))))) (or (= temp___274 1) (= temp___274 2)))) (=> (not (= (get_other_previous_track (select trains__trains train) id) 0)) (let ((temp___275 (to_rep5 (select trains__track_signals (get_other_previous_track (select trains__trains train) id))))) (or (= temp___275 1) (= temp___275 2)))))))))) :pattern ((previous_tracks_on_orange_or_red trains__cur_num_trains trains__trains trains__track_signals)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_285 Int) (temp___is_init_282 Bool) (temp___skip_constant_283 Bool) (temp___do_toplevel_284 Bool)) Bool (=> (or (= temp___is_init_282 true) (<= 0 3)) (in_range9 temp___expr_285)))
...
(define-fun dynamic_invariant5 ((temp___expr_33 Int) (temp___is_init_30 Bool) (temp___skip_constant_31 Bool) (temp___do_toplevel_32 Bool)) Bool (=> (or (= temp___is_init_30 true) (<= 0 2147483647)) (in_range7 temp___expr_33)))
(define-fun dynamic_invariant6 ((temp___expr_39 Int) (temp___is_init_36 Bool) (temp___skip_constant_37 Bool) (temp___do_toplevel_38 Bool)) Bool (=> (or (= temp___is_init_36 true) (<= 1 2147483647)) (in_range5 temp___expr_39)))
(define-fun dynamic_invariant7 ((temp___expr_187 Int) (temp___is_init_184 Bool) (temp___skip_constant_185 Bool) (temp___do_toplevel_186 Bool)) Bool (=> (or (= temp___is_init_184 true) (<= 1 5)) (in_range4 temp___expr_187)))
(declare-fun trains__tracks__aggregate_def (us_rep us_rep us_rep us_rep us_rep us_rep us_rep us_rep) (Array Int us_rep))
(assert (forall ((temp___134 us_rep) (temp___135 us_rep) (temp___136 us_rep) (temp___137 us_rep) (temp___138 us_rep) (temp___139 us_rep) (temp___140 us_rep) (temp___141 us_rep)) (let ((temp___133 (trains__tracks__aggregate_def temp___134 temp___135 temp___136 temp___137 temp___138 temp___139 temp___140 temp___141))) (and (and (and (and (and (and (and (= (select temp___133 1) temp___134) (= (select temp___133 2) temp___135)) (= (select temp___133 3) temp___136)) (= (select temp___133 4) temp___137)) (= (select temp___133 5) temp___138)) (= (select temp___133 6) temp___139)) (= (select temp___133 7) temp___140)) (= (select temp___133 8) temp___141)))))
...
(assert (forall ((temp___146 (Array Int track_opt_id)) (temp___147 (Array Int track_opt_id)) (temp___148 (Array Int track_opt_id)) (temp___149 (Array Int track_opt_id)) (temp___150 (Array Int track_opt_id))) (let ((temp___145 (trains__previous_tracks__aggregate_def temp___146 temp___147 temp___148 temp___149 temp___150))) (and (and (and (and (= (select temp___145 1) temp___146) (= (select temp___145 2) temp___147)) (= (select temp___145 3) temp___148)) (= (select temp___145 4) temp___149)) (= (select temp___145 5) temp___150)))))
(declare-fun temp___152 (Int Int Int) (Array Int track_opt_id))
(assert (forall ((temp___154 Int) (temp___155 Int) (temp___156 Int)) (let ((temp___153 (temp___152 temp___154 temp___155 temp___156))) (and (and (= (select temp___153 1) (of_rep3 temp___154)) (= (select temp___153 2) (of_rep3 temp___155))) (= (select temp___153 3) (of_rep3 temp___156))))))
(declare-fun temp___158 (Int Int Int) (Array Int track_opt_id))
(assert (forall ((temp___160 Int) (temp___161 Int) (temp___162 Int)) (let ((temp___159 (temp___158 temp___160 temp___161 temp___162))) (and (and (= (select temp___159 1) (of_rep3 temp___160)) (= (select temp___159 2) (of_rep3 temp___161))) (= (select temp___159 3) (of_rep3 temp___162))))))
(declare-fun temp___164 (Int Int Int) (Array Int track_opt_id))
(assert (forall ((temp___166 Int) (temp___167 Int) (temp___168 Int)) (let ((temp___165 (temp___164 temp___166 temp___167 temp___168))) (and (and (= (select temp___165 1) (of_rep3 temp___166)) (= (select temp___165 2) (of_rep3 temp___167))) (= (select temp___165 3) (of_rep3 temp___168))))))
(declare-fun temp___170 (Int Int Int) (Array Int track_opt_id))
(assert (forall ((temp___172 Int) (temp___173 Int) (temp___174 Int)) (let ((temp___171 (temp___170 temp___172 temp___173 temp___174))) (and (and (= (select temp___171 1) (of_rep3 temp___172)) (= (select temp___171 2) (of_rep3 temp___173))) (= (select temp___171 3) (of_rep3 temp___174))))))
(declare-fun temp___176 (Int Int Int) (Array Int track_opt_id))
(assert (forall ((temp___178 Int) (temp___179 Int) (temp___180 Int)) (let ((temp___177 (temp___176 temp___178 temp___179 temp___180))) (and (and (= (select temp___177 1) (of_rep3 temp___178)) (= (select temp___177 2) (of_rep3 temp___179))) (= (select temp___177 3) (of_rep3 temp___180))))))
(assert (= previous_tracks (trains__previous_tracks__aggregate_def (temp___152 8 0 0) (temp___158 1 0 0) (temp___164 2 3 0) (temp___170 5 0 0) (temp___176 4 6 7))))
(assert true)
(assert (forall ((position us_rep1)) (! (= (= (entering_a_track position) true) (and (not (= (to_rep (rec__trains__train_position__track_begin (us_split_fields3 position))) (to_rep (rec__trains__train_position__track_end (us_split_fields3 position))))) (exists ((id Int)) (and (and (<= 1 id) (<= id 3)) (= (to_rep (rec__trains__train_position__track_end (us_split_fields3 position))) (to_rep3 (let ((temp___244 (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep (rec__trains__train_position__track_begin (us_split_fields3 position)))))))))) (select temp___244 id)))))))) :pattern ((entering_a_track position)))))
(assert true)
...
(define-fun dynamic_invariant8 ((temp___expr_251 Int) (temp___is_init_248 Bool) (temp___skip_constant_249 Bool) (temp___do_toplevel_250 Bool)) Bool (=> (or (= temp___is_init_248 true) (<= 0 2)) (in_range8 temp___expr_251)))
(assert true)
...
(declare-const temp___375 Int)
(declare-const o32 Int)
(declare-const o33 signal)
(declare-const temp___376 Int)
(declare-const o34 signal)
(declare-const o35 (Array Int signal))
(declare-const temp___364 (Array Int signal))
(declare-const temp___358 Int)
(declare-const temp___363 (Array Int signal))
(declare-const temp___356 (Array Int signal))
(declare-const temp___354 Int)
(declare-const o36 Int)
(declare-const o37 Int)
(declare-const o38 signal)
(declare-const o39 Int)
(declare-const o40 signal)
...
(declare-const o49 signal)
(declare-const o50 Int)
(declare-const o51 signal)
(declare-const o52 Int)
(declare-const o53 (Array Int signal))
...
(declare-const result2 (Array Int us_rep1))
(declare-const trains2 (Array Int us_rep1))
(declare-const result3 Bool)
(declare-const result4 Int)
(declare-const result__2 Int)
(declare-const result5 (Array Int us_rep1))
(declare-const trains3 (Array Int us_rep1))
(declare-const result6 (Array Int signal))
...
(declare-const id6 Int)
(declare-const result10 Bool)
(declare-const result11 int__ref)
(declare-const id7 Int)
(declare-const result12 int__ref)
(declare-const prev4 Int)
(declare-const result13 Bool)
(declare-const track_signals5 (Array Int signal))
(declare-const track_signals6 map__ref4)
(declare-const prev5 int__ref)
(declare-const id8 int__ref)
(declare-const track_signals7 (Array Int signal))
(declare-const prev6 Int)
(declare-const id9 Int)
(declare-const track_signals8 map__ref4)
(declare-const prev7 int__ref)
(declare-const id10 int__ref)
(declare-const track_signals9 (Array Int signal))
(declare-const prev8 Int)
(declare-const id11 Int)
(declare-const track_signals10 map__ref4)
(declare-const prev9 int__ref)
(declare-const id12 int__ref)
(declare-const track_signals11 (Array Int signal))
(declare-const prev10 Int)
(declare-const id13 Int)
...
(declare-const result20 map__ref3)
(declare-const trains4 (Array Int us_rep1))
(declare-const result21 map__ref4)
(declare-const track_signals12 (Array Int signal))
(declare-const result22 int__ref)
(declare-const id14 Int)
(declare-const result23 int__ref)
(declare-const prev11 Int)
(declare-const result24 Bool)
(declare-const result25 map__ref4)
(declare-const track_signals13 (Array Int signal))
(declare-const track_signals14 (Array Int signal))
(declare-const prev12 Int)
(declare-const id15 Int)
(declare-const result26 Bool)
(declare-const result27 int__ref)
(declare-const id16 Int)
(declare-const result28 int__ref)
(declare-const prev13 Int)
(declare-const result29 Bool)
(declare-const result30 map__ref4)
(declare-const track_signals15 (Array Int signal))
(declare-const track_signals16 map__ref4)
(declare-const prev14 int__ref)
(declare-const id17 int__ref)
(declare-const track_signals17 (Array Int signal))
(declare-const prev15 Int)
(declare-const id18 Int)
(declare-const track_signals18 map__ref4)
(declare-const prev16 int__ref)
(declare-const id19 int__ref)
(declare-const track_signals19 (Array Int signal))
(declare-const prev17 Int)
(declare-const id20 Int)
(declare-const trains5 map__ref3)
(declare-const track_signals20 map__ref4)
(declare-const result__6 int__ref)
(declare-const prev18 int__ref)
(declare-const id21 int__ref)
(declare-const trains6 (Array Int us_rep1))
(declare-const track_signals21 (Array Int signal))
(declare-const result__7 Int)
(declare-const prev19 Int)
(declare-const id22 Int)
(declare-const trains7 map__ref3)
(declare-const track_signals22 map__ref4)
(declare-const result__8 int__ref)
(declare-const prev20 int__ref)
(declare-const id23 int__ref)
(declare-const id24 int__ref)
(declare-const trains8 (Array Int us_rep1))
(declare-const track_signals23 (Array Int signal))
(declare-const result__9 Int)
(declare-const prev21 Int)
(declare-const id25 Int)
(declare-const id26 Int)
(declare-const trains9 map__ref3)
(declare-const track_signals24 map__ref4)
(declare-const result__10 int__ref)
(declare-const prev22 int__ref)
(declare-const id27 int__ref)
(declare-const id28 int__ref)
(declare-const trains10 (Array Int us_rep1))
(declare-const track_signals25 (Array Int signal))
(declare-const result__11 Int)
(declare-const prev23 Int)
(declare-const id29 Int)
(declare-const id30 Int)
(declare-const trains11 map__ref3)
(declare-const track_signals26 map__ref4)
(declare-const result__12 int__ref)
(declare-const prev24 int__ref)
(declare-const id31 int__ref)
(declare-const id32 int__ref)
(declare-const trains12 (Array Int us_rep1))
(declare-const track_signals27 (Array Int signal))
(declare-const result__13 Int)
(declare-const prev25 Int)
(declare-const id33 Int)
(declare-const id34 Int)
...
(assert (and (= result3 (moving_away_from_current_track cur_position new_position)) (= (= result3 true) (and (and (= (entering_a_track cur_position) true) (= (inside_a_track new_position) true)) (= (to_rep (rec__trains__train_position__track_begin (us_split_fields3 cur_position))) (to_rep (rec__trains__train_position__track_end (us_split_fields3 new_position))))))))
(assert (not (= result3 true)))
(assert (not (= (to_rep5 (select track_signals (to_rep (rec__trains__train_position__track_begin (us_split_fields3 new_position))))) 2)))
(assert (=> (= (to_rep5 (select track_signals (to_rep (rec__trains__train_position__track_begin (us_split_fields3 new_position))))) 0) (= result18 (mk_int__ref result__))))
(assert (=> (= (to_rep5 (select track_signals (to_rep (rec__trains__train_position__track_begin (us_split_fields3 new_position))))) 0) (= result__4 0)))
(assert (=> (not (= (to_rep5 (select track_signals (to_rep (rec__trains__train_position__track_begin (us_split_fields3 new_position))))) 0)) (= result19 (mk_int__ref result__))))
(assert (=> (not (= (to_rep5 (select track_signals (to_rep (rec__trains__train_position__track_begin (us_split_fields3 new_position))))) 0)) (= result__5 1)))
(assert (=> (not (= (to_rep5 (select track_signals (to_rep (rec__trains__train_position__track_begin (us_split_fields3 new_position))))) 0)) (= result__4 result__5)))
(assert (= result20 (mk_map__ref3 trains)))
(assert (= trains4 (store trains train new_position)))
(assert (= (to_rep5 o34) 2))
(assert (= o35 (store track_signals (to_rep (rec__trains__train_position__track_begin (us_split_fields3 new_position))) o34)))
(assert (= result21 (mk_map__ref4 track_signals)))
(assert (= track_signals12 o35))
(assert (= result22 (mk_int__ref id1)))
(assert (= id14 1))
(assert (=> (and (<= 1 id14) (<= id14 3)) (= temp___364 track_signals12)))
(assert (=> (and (<= 1 id14) (<= id14 3)) (= temp___358 prev)))
(assert (=> (and (<= 1 id14) (<= id14 3)) (= temp___363 track_signals12)))
(assert (=> (and (<= 1 id14) (<= id14 3)) (= temp___356 track_signals12)))
(assert (=> (and (<= 1 id14) (<= id14 3)) (= temp___354 id14)))
(assert (=> (and (<= 1 id14) (<= id14 3)) (and (= o36 (get_other_previous_track new_position id14)) (and (in_range1 o36) (= o36 (ite (= (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep (rec__trains__train_position__track_begin (us_split_fields3 new_position)))))))) id14)) (to_rep (rec__trains__train_position__track_end (us_split_fields3 new_position)))) 0 (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep (rec__trains__train_position__track_begin (us_split_fields3 new_position)))))))) id14))))))))
(assert (=> (and (<= 1 id14) (<= id14 3)) (= result23 (mk_int__ref prev))))
(assert (=> (and (<= 1 id14) (<= id14 3)) (= prev11 o36)))
(assert (=> (and (<= 1 id14) (<= id14 3)) (=> (not (= prev11 0)) (and (<= 1 prev11) (<= prev11 8)))))
(assert (=> (and (<= 1 id14) (<= id14 3)) (=> (not (= prev11 0)) (= o37 prev11))))
(assert (=> (and (<= 1 id14) (<= id14 3)) (=> (not (= prev11 0)) (= o38 (select track_signals12 o37)))))
(assert (=> (and (<= 1 id14) (<= id14 3)) (=> (not (= prev11 0)) (= o39 (to_rep5 o38)))))
(assert (=> (and (<= 1 id14) (<= id14 3)) (=> (not (= prev11 0)) (= result24 (ite (= o39 0) true false)))))
(assert (=> (and (<= 1 id14) (<= id14 3)) (=> (= prev11 0) (= result24 false))))
(assert (=> (and (<= 1 id14) (<= id14 3)) (=> (= result24 true) (= (to_rep5 o40) 1))))
(assert (=> (and (<= 1 id14) (<= id14 3)) (=> (= result24 true) (and (<= 1 prev11) (<= prev11 8)))))
(assert (=> (and (<= 1 id14) (<= id14 3)) (=> (= result24 true) (= o41 prev11))))
(assert (=> (and (<= 1 id14) (<= id14 3)) (=> (= result24 true) (= o42 (store track_signals12 o41 o40)))))
(assert (=> (and (<= 1 id14) (<= id14 3)) (=> (= result24 true) (= result25 (mk_map__ref4 track_signals12)))))
(assert (=> (and (<= 1 id14) (<= id14 3)) (=> (= result24 true) (= track_signals13 o42))))
(assert (=> (and (<= 1 id14) (<= id14 3)) (=> (not (= result24 true)) (= track_signals13 track_signals12))))
(assert (=> (and (<= 1 id14) (<= id14 3)) (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 id15)) (=> (not (= (get_other_previous_track new_position k1) 0)) (let ((temp___362 (to_rep5 (select track_signals14 (get_other_previous_track new_position k1))))) (or (= temp___362 1) (= temp___362 2))))))))
(assert (=> (and (<= 1 id14) (<= id14 3)) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 8)) (and (=> (= (to_rep5 (select temp___363 j1)) 2) (= (to_rep5 (select track_signals14 j1)) 2)) (=> (= (to_rep5 (select temp___364 j1)) 1) (= (to_rep5 (select track_signals14 j1)) 1)))))))
(assert (=> (and (<= 1 id14) (<= id14 3)) (and (and (=> (<= 1 3) (in_range3 id15)) (=> (<= 0 8) (in_range1 prev12))) (and (<= 1 id15) (<= id15 3)))))
(assert (=> (and (<= 1 id14) (<= id14 3)) (= id15 3)))
(assert (=> (and (<= 1 id14) (<= id14 3)) (= id17 (mk_int__ref id15))))
(assert (=> (and (<= 1 id14) (<= id14 3)) (= prev14 (mk_int__ref prev12))))
(assert (=> (and (<= 1 id14) (<= id14 3)) (= track_signals16 (mk_map__ref4 track_signals14))))
(assert (=> (and (<= 1 id14) (<= id14 3)) (= id18 id15)))
(assert (=> (and (<= 1 id14) (<= id14 3)) (= prev15 prev12)))
(assert (=> (and (<= 1 id14) (<= id14 3)) (= track_signals17 track_signals14)))
(assert (=> (and (<= 1 id14) (<= id14 3)) (= id19 id17)))
(assert (=> (and (<= 1 id14) (<= id14 3)) (= prev16 prev14)))
(assert (=> (and (<= 1 id14) (<= id14 3)) (= track_signals18 track_signals16)))
(assert (=> (and (<= 1 id14) (<= id14 3)) (= id20 id18)))
(assert (=> (and (<= 1 id14) (<= id14 3)) (= prev17 prev15)))
(assert (=> (and (<= 1 id14) (<= id14 3)) (= track_signals19 track_signals17)))
(assert (=> (not (and (<= 1 id14) (<= id14 3))) (= id19 (mk_int__ref id14))))
(assert (=> (not (and (<= 1 id14) (<= id14 3))) (= prev16 (mk_int__ref prev))))
(assert (=> (not (and (<= 1 id14) (<= id14 3))) (= track_signals18 (mk_map__ref4 track_signals12))))
(assert (=> (not (and (<= 1 id14) (<= id14 3))) (= id20 id14)))
(assert (=> (not (and (<= 1 id14) (<= id14 3))) (= prev17 prev1)))
(assert (=> (not (and (<= 1 id14) (<= id14 3))) (= track_signals19 track_signals12)))
(assert (= (occupied_tracks_on_red cur_num_trains trains4 (map__content4 track_signals18)) true))
(assert (not (= (previous_tracks_on_orange_or_red cur_num_trains trains4 (map__content4 track_signals18)) true)))
(check-sat)
(exit)
