...
(define-fun dynamic_invariant ((temp___expr_243 us_t1) (temp___is_init_240 Bool) (temp___skip_constant_241 Bool) (temp___do_toplevel_242 Bool)) Bool (and (=> (not (= temp___skip_constant_241 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_243) (last3 temp___expr_243))) (=> (= temp___do_toplevel_242 true) (=> (= temp___is_init_240 true) (and (let ((temp___245 (of_array2 (to_array1 temp___expr_243) (first3 temp___expr_243) (last3 temp___expr_243)))) (and (= (first5 temp___245) 1) (<= 0 (last5 temp___245)))) (<= (last3 temp___expr_243) 20))))))
(define-fun dynamic_predicate ((temp___247 us_t1)) Bool (and (let ((temp___249 (of_array2 (to_array1 temp___247) (first3 temp___247) (last3 temp___247)))) (and (= (first5 temp___249) 1) (<= 0 (last5 temp___249)))) (<= (last3 temp___247) 20)))
...
(define-fun dynamic_invariant1 ((temp___expr_329 Int) (temp___is_init_326 Bool) (temp___skip_constant_327 Bool) (temp___do_toplevel_328 Bool)) Bool (=> (or (= temp___is_init_326 true) (<= 0 43)) (in_range3 temp___expr_329)))
(declare-const x Int)
...
(declare-const temp___389 (Array Int character))
(declare-const temp___3891 t1)
(assert (in_range3 x))
...
(assert (= (elts (to_string (attr__ATTRIBUTE_IMAGE3 x))) temp___389))
(assert (= (mk1 (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 x))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 x)))))) temp___3891))
(assert (not (dynamic_predicate (mk___t1 temp___389 temp___3891))))
(check-sat)
(exit)
