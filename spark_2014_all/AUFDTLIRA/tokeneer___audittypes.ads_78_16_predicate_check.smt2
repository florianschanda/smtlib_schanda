...
(assert (= (elts (to_string (attr__ATTRIBUTE_IMAGE3 x))) temp___439))
(assert (= (mk1 (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 x))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 x)))))) temp___4391))
(assert (not (dynamic_predicate (mk___t1 temp___439 temp___4391))))
(check-sat)
(exit)
