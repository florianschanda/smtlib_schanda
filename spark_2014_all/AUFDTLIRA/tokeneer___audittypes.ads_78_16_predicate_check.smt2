...
(define-fun dynamic_invariant ((temp___expr_243 us_t1) (temp___is_init_240 Bool) (temp___skip_constant_241 Bool) (temp___do_toplevel_242 Bool)) Bool (and (=> (not (= temp___skip_constant_241 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_243) (last3 temp___expr_243))) (=> (= temp___do_toplevel_242 true) (=> (= temp___is_init_240 true) (and (= (first5 (of_array2 (to_array1 temp___expr_243) (first3 temp___expr_243) (last3 temp___expr_243))) 1) (<= (last3 temp___expr_243) 20))))))
(define-fun dynamic_predicate ((temp___247 us_t1)) Bool (and (= (first5 (of_array2 (to_array1 temp___247) (first3 temp___247) (last3 temp___247))) 1) (<= (last3 temp___247) 20)))
...
(define-fun dynamic_invariant1 ((temp___expr_289 Int) (temp___is_init_286 Bool) (temp___skip_constant_287 Bool) (temp___do_toplevel_288 Bool)) Bool (=> (or (= temp___is_init_286 true) (<= 0 43)) (in_range3 temp___expr_289)))
(declare-const x Int)
...
(define-fun dynamic_invariant6 ((temp___expr_233 us_t2) (temp___is_init_230 Bool) (temp___skip_constant_231 Bool) (temp___do_toplevel_232 Bool)) Bool (and (=> (not (= temp___skip_constant_231 true)) (dynamic_property2 1 2147483647 (first5 temp___expr_233) (last5 temp___expr_233))) (=> (= temp___do_toplevel_232 true) (=> (= temp___is_init_230 true) (= (first5 temp___expr_233) 1)))))
(define-fun dynamic_predicate1 ((temp___236 us_t2)) Bool (= (first5 temp___236) 1))
(declare-const temp___345 (Array Int character))
...
(assert (= (elts (to_string (attr__ATTRIBUTE_IMAGE3 x))) temp___345))
(assert (= (mk1 (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 x))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 x)))))) temp___3451))
(assert (not (dynamic_predicate (mk___t1 temp___345 temp___3451))))
(check-sat)
(exit)
