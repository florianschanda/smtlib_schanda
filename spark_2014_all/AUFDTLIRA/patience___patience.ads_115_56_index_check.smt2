...
(assert (= temp___507 (to_rep1 o13)))
(assert (and (<= 0 temp___507) (<= temp___507 99)))
(assert (= o14 temp___507))
(assert (= o15 (select (rec__patience__state__values (us_split_fields1 s)) o14)))
(assert (= o19 (to_rep o15)))
(assert (= result17 (ite (< o19 o18) true false)))
(assert (=> (= result17 true) (and (<= 0 i) (<= i 99))))
(assert (=> (= result17 true) (= o9 i)))
(assert (=> (= result17 true) (= o10 (select (rec__patience__state__posstack (us_split_fields1 s)) o9))))
(assert (=> (= result17 true) (= o11 (to_rep1 o10))))
(assert (=> (= result17 true) (= result16 (ite (< 0 o11) true false))))
