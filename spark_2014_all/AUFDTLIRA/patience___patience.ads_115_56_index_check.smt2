...
(assert (and (<= 0 i) (<= i 99)))
(assert (= o20 i))
(assert (= o21 (select (rec__patience__state__preds (us_split_fields1 s)) o20)))
(assert (= o22 (to_rep1 o21)))
(assert (= o23 (ite (<= o22 (- (to_rep1 (rec__patience__state__numelts (us_split_fields1 s))) 1)) true false)))
(assert (and (<= 0 i) (<= i 99)))
(assert (= o17 i))
(assert (= o18 (select (rec__patience__state__preds (us_split_fields1 s)) o17)))
(assert (= o19 (to_rep1 o18)))
(assert (= o24 (ite (<= (- 1) o19) true false)))
(assert (= result6 (ite (= o24 true) o23 false)))
(assert (=> (= result6 true) (and (<= 0 i) (<= i 99))))
(assert (=> (= result6 true) (= o14 i)))
(assert (=> (= result6 true) (= o15 (select (rec__patience__state__preds (us_split_fields1 s)) o14))))
(assert (=> (= result6 true) (= o16 (to_rep1 o15))))
(assert (=> (= result6 true) (= result5 (ite (< o16 i) true false))))
...
(assert (and (<= 0 i) (<= i 99)))
(assert (= o10 i))
(assert (= o11 (select (rec__patience__state__values (us_split_fields1 s)) o10)))
(assert (= o12 (to_rep o11)))
(assert (and (<= 0 i) (<= i 99)))
(assert (= o6 i))
(assert (= o7 (select (rec__patience__state__preds (us_split_fields1 s)) o6)))
(assert (= temp___507 (to_rep1 o7)))
(assert (and (<= 0 temp___507) (<= temp___507 99)))
(assert (= o8 temp___507))
(assert (= o9 (select (rec__patience__state__values (us_split_fields1 s)) o8)))
(assert (= o13 (to_rep o9)))
(assert (= result9 (ite (< o13 o12) true false)))
(assert (=> (= result9 true) (and (<= 0 i) (<= i 99))))
(assert (=> (= result9 true) (= o3 i)))
(assert (=> (= result9 true) (= o4 (select (rec__patience__state__posstack (us_split_fields1 s)) o3))))
(assert (=> (= result9 true) (= o5 (to_rep1 o4))))
(assert (=> (= result9 true) (= result8 (ite (< 0 o5) true false))))
