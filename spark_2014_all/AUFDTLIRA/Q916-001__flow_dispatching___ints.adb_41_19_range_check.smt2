...
(assert (not (= (bool_eq (elts msg) (to_rep1 (first (rt msg))) (to_rep1 (last (rt msg))) (temp___String_Literal_596 Tuple0) 1 0) true)))
(assert (not (= (length msg) 0)))
(assert (=> (<= 1 3) (= o (+ (- 3 1) 1))))
(assert (=> (not (<= 1 3)) (= o 0)))
(assert (=> (<= (to_rep1 (first (rt msg))) (to_rep1 (last (rt msg)))) (= o1 (+ (- (to_rep1 (last (rt msg))) (to_rep1 (first (rt msg)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt msg))) (to_rep1 (last (rt msg))))) (= o1 0)))
(assert (= o2 (+ o1 o)))
(assert (= o3 (+ (to_rep1 (first (rt msg))) o2)))
(assert (= o4 (- o3 1)))
