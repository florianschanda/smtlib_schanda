...
(assert (forall ((i tT5sP1)) (and (<= 1 (tT5sP1qtint i)) (<= (tT5sP1qtint i) 3))))
...
(define-fun of_base ((r us_rep1)) us_rep2 (mk___rep2 (us_split_discrs3 r) (mk___split_fields2 (let ((temp___155 (rec__record_discr__interm_result__to_search (us_split_fields3 r)))) (to_array temp___155)))))
...
(define-fun dynamic_invariant2 ((temp___expr_192 us_rep2) (temp___is_init_188 Bool) (temp___skip_constant_189 Bool) (temp___do_toplevel_190 Bool) (temp___do_typ_inv_191 Bool)) Bool (=> (not (= temp___skip_constant_189 true)) (in_range5 3 (to_base temp___expr_192))))
(define-fun default_initial_assumption ((temp___expr_195 us_rep2) (temp___skip_top_level_196 Bool)) Bool (= (to_rep (rec__record_discr__interm_result__upto (us_split_discrs4 temp___expr_195))) 3))
...
(define-fun dynamic_invariant4 ((temp___expr_185 us_rep1) (temp___is_init_181 Bool) (temp___skip_constant_182 Bool) (temp___do_toplevel_183 Bool) (temp___do_typ_inv_184 Bool)) Bool (let ((temp___186 (rec__record_discr__interm_result__upto (us_split_discrs3 temp___expr_185)))) (and (dynamic_property1 1 (to_rep temp___186) (first1 (rec__record_discr__interm_result__to_search (us_split_fields3 temp___expr_185))) (last1 (rec__record_discr__interm_result__to_search (us_split_fields3 temp___expr_185)))) (and (= (first1 (rec__record_discr__interm_result__to_search (us_split_fields3 temp___expr_185))) 1) (= (last1 (rec__record_discr__interm_result__to_search (us_split_fields3 temp___expr_185))) (to_rep temp___186))))))
...
(define-fun record_discr__search_upto_3__result17 () us_rep (mk___rep (mk___split_discrs record_discr__search_upto_3__result2) (mk___split_fields record_discr__search_upto_3__result3)))
(define-fun o8 () us_rep (mk___rep (mk___split_discrs o6) (mk___split_fields o7)))
(define-fun o9 () us_rep (mk___rep (mk___split_discrs o4) (mk___split_fields o5)))
(define-fun o10 () us_rep (mk___rep (mk___split_discrs o2) (mk___split_fields o3)))
(define-fun o11 () us_rep (mk___rep (mk___split_discrs o) (mk___split_fields o1)))
(define-fun record_discr__search_upto_3__result18 () result_ty__ref (mk_result_ty__ref (mk___rep (mk___split_discrs record_discr__search_upto_3__result) (mk___split_fields record_discr__search_upto_3__result1))))
(declare-const result5 Bool)
(declare-const result6 us_main_type)
(assert (= 3 (to_rep (rec__record_discr__interm_result__upto (us_split_discrs4 r)))))
(assert (in_range1 e))
(assert (= (to_rep (rec__record_discr__interm_result__upto (us_split_discrs4 r))) 3))
(assert (= record_discr__search_upto_3__result13 record_discr__search_upto_3__result11))
(assert (= record_discr__search_upto_3__result14 record_discr__search_upto_3__result12))
(assert (=> (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 1)) e) (= record_discr__search_upto_3__result11 (mk_result_ty__ref record_discr__search_upto_3__result17))))
(assert (=> (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 1)) e) (= record_discr__search_upto_3__result12 record_discr__search_upto_3__result17)))
(assert (=> (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 1)) e) (and (= o11 (mk_result (distinct 1 0) 1)) (and (= (= o true) (= (distinct 1 0) true)) (=> (= (distinct 1 0) true) (= (get_content o11) 1))))))
(assert (=> (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 1)) e) (= (mk_result_ty__ref (mk___rep (mk___split_discrs result) (mk___split_fields result1))) record_discr__search_upto_3__result18)))
(assert (=> (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 1)) e) (= record_discr__search_upto_3__result17 o11)))
(assert (=> (not (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 1)) e)) (= record_discr__search_upto_3__result11 record_discr__search_upto_3__result9)))
(assert (=> (not (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 1)) e)) (= record_discr__search_upto_3__result12 record_discr__search_upto_3__result10)))
(assert (=> (not (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 1)) e)) (=> (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 2)) e) (= record_discr__search_upto_3__result9 (mk_result_ty__ref record_discr__search_upto_3__result4)))))
(assert (=> (not (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 1)) e)) (=> (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 2)) e) (= record_discr__search_upto_3__result10 record_discr__search_upto_3__result4))))
(assert (=> (not (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 1)) e)) (=> (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 2)) e) (and (= o10 (mk_result (distinct 1 0) 2)) (and (= (= o2 true) (= (distinct 1 0) true)) (=> (= (distinct 1 0) true) (= (get_content o10) 2)))))))
(assert (=> (not (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 1)) e)) (=> (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 2)) e) (= result2 record_discr__search_upto_3__result18))))
(assert (=> (not (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 1)) e)) (=> (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 2)) e) (= record_discr__search_upto_3__result4 o10))))
(assert (=> (not (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 1)) e)) (=> (not (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 2)) e)) (= record_discr__search_upto_3__result9 record_discr__search_upto_3__result7))))
(assert (=> (not (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 1)) e)) (=> (not (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 2)) e)) (= record_discr__search_upto_3__result10 record_discr__search_upto_3__result8))))
(assert (=> (not (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 1)) e)) (=> (not (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 2)) e)) (=> (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 3)) e) (= record_discr__search_upto_3__result7 (mk_result_ty__ref record_discr__search_upto_3__result5))))))
(assert (=> (not (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 1)) e)) (=> (not (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 2)) e)) (=> (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 3)) e) (= record_discr__search_upto_3__result8 record_discr__search_upto_3__result5)))))
(assert (=> (not (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 1)) e)) (=> (not (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 2)) e)) (=> (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 3)) e) (and (= o9 (mk_result (distinct 1 0) 3)) (and (= (= o4 true) (= (distinct 1 0) true)) (=> (= (distinct 1 0) true) (= (get_content o9) 3))))))))
(assert (=> (not (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 1)) e)) (=> (not (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 2)) e)) (=> (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 3)) e) (= result3 record_discr__search_upto_3__result18)))))
(assert (=> (not (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 1)) e)) (=> (not (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 2)) e)) (=> (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 3)) e) (= record_discr__search_upto_3__result5 o9)))))
(assert (=> (not (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 1)) e)) (=> (not (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 2)) e)) (=> (not (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 3)) e)) (= record_discr__search_upto_3__result7 (mk_result_ty__ref record_discr__search_upto_3__result6))))))
(assert (=> (not (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 1)) e)) (=> (not (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 2)) e)) (=> (not (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 3)) e)) (= record_discr__search_upto_3__result8 record_discr__search_upto_3__result6)))))
(assert (=> (not (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 1)) e)) (=> (not (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 2)) e)) (=> (not (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 3)) e)) (and (= o8 (mk_result (distinct 0 0) 1)) (and (= (= o6 true) (= (distinct 0 0) true)) (=> (= (distinct 0 0) true) (= (get_content o8) 1))))))))
(assert (=> (not (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 1)) e)) (=> (not (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 2)) e)) (=> (not (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 3)) e)) (= result4 record_discr__search_upto_3__result18)))))
(assert (=> (not (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 1)) e)) (=> (not (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 2)) e)) (=> (not (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 3)) e)) (= record_discr__search_upto_3__result6 o8)))))
(assert (= record_discr__search_upto_3__result15 record_discr__search_upto_3__result13))
(assert (= record_discr__search_upto_3__result16 record_discr__search_upto_3__result14))
(assert (= (mk___rep (mk___split_discrs result5) (mk___split_fields result6)) (result_ty__content record_discr__search_upto_3__result15)))
...
(assert (not (<= (get_content (result_ty__content record_discr__search_upto_3__result15)) (to_rep (rec__record_discr__interm_result__upto (us_split_discrs4 r))))))
(check-sat)
(exit)
