...
(define-fun dynamic_invariant1 ((temp___expr_246 (Array Int integer)) (temp___is_init_242 Bool) (temp___skip_constant_243 Bool) (temp___do_toplevel_244 Bool) (temp___do_typ_inv_245 Bool)) Bool (forall ((temp___247 Int)) (=> (and (<= 1 temp___247) (<= temp___247 100)) (=> (or (= temp___is_init_242 true) (<= first 2147483647)) (dynamic_property first 2147483647 (to_rep (select temp___expr_246 temp___247)))))))
(define-fun default_initial_assumption ((temp___expr_248 (Array Int integer)) (temp___skip_top_level_249 Bool)) Bool (forall ((temp___250 Int)) (=> (and (<= 1 temp___250) (<= temp___250 100)) (= (to_rep (select temp___expr_248 temp___250)) 0))))
...
(define-fun dynamic_invariant3 ((temp___expr_233 Int) (temp___is_init_229 Bool) (temp___skip_constant_230 Bool) (temp___do_toplevel_231 Bool) (temp___do_typ_inv_232 Bool)) Bool (=> (or (= temp___is_init_229 true) (<= first 2147483647)) (dynamic_property first 2147483647 temp___expr_233)))
(assert (= first c))
(declare-const o Int)
