...
(assert (not (= (to_rep2 (rec__file_io__read_result__status current_read__split_discrs)) 0)))
(assert (= next_read__attr__constrained true))
(assert (not (= (rec__file_io__read_result__status current_read__split_discrs) next_read__split_discrs)))
(check-sat)
(exit)
