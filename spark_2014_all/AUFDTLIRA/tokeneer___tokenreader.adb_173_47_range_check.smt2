...
(assert (=> (<= 1 2) (= o (+ (- 2 1) 1))))
(assert (=> (not (<= 1 2)) (= o 0)))
(assert (=> (<= (to_rep1 (first (rt text))) (to_rep1 (last (rt text)))) (= o1 (+ (- (to_rep1 (last (rt text))) (to_rep1 (first (rt text)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt text))) (to_rep1 (last (rt text))))) (= o1 0)))
(assert (= o2 (+ o1 o)))
