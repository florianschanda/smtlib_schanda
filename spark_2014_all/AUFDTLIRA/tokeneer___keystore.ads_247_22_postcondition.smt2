...
(define-fun dynamic_invariant1 ((temp___expr_889 Int) (temp___is_init_886 Bool) (temp___skip_constant_887 Bool) (temp___do_toplevel_888 Bool)) Bool (=> (or (= temp___is_init_886 true) (<= 0 40)) (in_range1 temp___expr_889)))
...
(define-fun dynamic_invariant2 ((temp___expr_910 Int) (temp___is_init_907 Bool) (temp___skip_constant_908 Bool) (temp___do_toplevel_909 Bool)) Bool (=> (or (= temp___is_init_907 true) (<= 0 4294967295)) (in_range3 temp___expr_910)))
...
(declare-const temp___1707 issueridt)
(declare-const temp___17071 namecountt)
(declare-const temp___17072 (Array Int character))
...
(assert (= o o3))
(assert (= blankname o4))
(assert (= temp___1707 o2))
(assert (= temp___17071 o3))
(assert (= temp___17072 o4))
(assert (= (mk___rep (mk___split_fields temp___1707 temp___17071 temp___17072)) nullissuer))
