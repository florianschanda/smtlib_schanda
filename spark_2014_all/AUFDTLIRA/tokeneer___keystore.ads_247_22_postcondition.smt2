...
(define-fun dynamic_invariant1 ((temp___expr_990 Int) (temp___is_init_986 Bool) (temp___skip_constant_987 Bool) (temp___do_toplevel_988 Bool) (temp___do_typ_inv_989 Bool)) Bool (=> (or (= temp___is_init_986 true) (<= 0 40)) (in_range1 temp___expr_990)))
...
(assert (forall ((temp___162 Int)) (=> (dynamic_invariant temp___162 true true true true) (forall ((temp___163 Int)) (= (to_rep1 (select (cryptotypes__blankname__aggregate_def temp___162) temp___163)) temp___162)))))
(define-fun dynamic_invariant2 ((temp___expr_1014 Int) (temp___is_init_1010 Bool) (temp___skip_constant_1011 Bool) (temp___do_toplevel_1012 Bool) (temp___do_typ_inv_1013 Bool)) Bool (=> (or (= temp___is_init_1010 true) (<= 0 4294967295)) (in_range3 temp___expr_1014)))
(declare-const rliteral issueridt)
(assert (= (issueridtqtint rliteral) 0))
(declare-const rliteral1 namecountt)
(assert (= (namecounttqtint rliteral1) 0))
(assert (= nullissuer (mk___rep (mk___split_fields rliteral rliteral1 blankname))))
...
(assert (= (mk___rep (mk___split_fields rliteral rliteral1 blankname)) nullissuer))
...
(assert (= (distinct 0 0) thistisinfo__split_fields4))
