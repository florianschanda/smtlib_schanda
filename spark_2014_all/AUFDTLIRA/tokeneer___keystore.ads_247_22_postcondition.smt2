...
(define-fun dynamic_invariant1 ((temp___expr_997 Int) (temp___is_init_993 Bool) (temp___skip_constant_994 Bool) (temp___do_toplevel_995 Bool) (temp___do_typ_inv_996 Bool)) Bool (=> (or (= temp___is_init_993 true) (<= 0 40)) (in_range1 temp___expr_997)))
...
(define-fun dynamic_invariant2 ((temp___expr_1021 Int) (temp___is_init_1017 Bool) (temp___skip_constant_1018 Bool) (temp___do_toplevel_1019 Bool) (temp___do_typ_inv_1020 Bool)) Bool (=> (or (= temp___is_init_1017 true) (<= 0 4294967295)) (in_range3 temp___expr_1021)))
...
(declare-const temp___1881 issueridt)
(declare-const temp___18811 namecountt)
(declare-const temp___18812 (Array Int character))
...
(assert (= temp___18811 o3))
(assert (= temp___18812 o4))
(assert (= (mk___rep (mk___split_fields temp___1881 temp___18811 temp___18812)) nullissuer))
