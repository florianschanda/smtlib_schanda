...
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o59 (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)))) (and (in_range2 o59) (= o59 (to_rep f__split_fields)))))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
...
(assert (= result5 true))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= o58 (peek (mk___rep2 (us_split_fields__content2 f__split_fields7)) i d)) (and (in_range2 o58) (and (= o58 (ite (= d 0) (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) i)))) (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) i)))))) (and (ite (not (= o58 0)) (and (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) o58) d) (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) o58) i)) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j1) i) (not (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) j1) d)))))) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j1) i) (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) j1) d)) (= o58 j1)))))))))
...
(assert (= o55 (select temp___872 j)))
...
(assert (and (= temp___871 (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o51)) (and (dynamic_invariant3 temp___871 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___871 o51))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___871 o51)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 o51)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___871 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___871 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___871 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___871 i1))) true) (not (= i1 o51))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___871 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1)))) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___871 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___871 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___871 i1))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___871 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___871 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___871 j1)))) true)) (= j1 i1))))))))))))))
(assert (= o52 (select temp___871 j)))
...
(assert (and (<= 1 temp___869) (<= temp___869 100)))
(assert (= o46 temp___869))
(assert (= o47 (select temp___868 o46)))
(assert (= o48 (us_split_fields1 o47)))
(assert (= o49 (rec__tree_model__path_type__a o48)))
(assert (not (<= (length o49) 100)))
(check-sat)
(exit)
