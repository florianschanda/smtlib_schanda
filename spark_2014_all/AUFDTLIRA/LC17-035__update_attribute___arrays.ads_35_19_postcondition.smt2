...
(define-fun dynamic_invariant ((temp___expr_141 Int) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool (=> (or (= temp___is_init_138 true) (<= 1 8)) (in_range temp___expr_141)))
...
(declare-fun temp___222 ((Array Int integer) Int Int Int) (Array Int integer))
(assert (forall ((temp___224 (Array Int integer))) (forall ((temp___225 Int) (temp___226 Int) (temp___227 Int)) (let ((temp___223 (temp___222 temp___224 temp___225 temp___226 temp___227))) (forall ((temp___228 Int)) (ite (and (<= temp___225 temp___228) (<= temp___228 temp___226)) (= (select temp___223 temp___228) (of_rep temp___227)) (= (select temp___223 temp___228) (select temp___224 temp___228))))))))
(declare-fun temp___392 ((Array Int integer) Int Int Int) (Array Int integer))
(assert (forall ((temp___394 (Array Int integer))) (forall ((temp___395 Int) (temp___396 Int) (temp___397 Int)) (let ((temp___393 (temp___392 temp___394 temp___395 temp___396 temp___397))) (forall ((temp___398 Int)) (ite (and (<= temp___395 temp___398) (<= temp___398 temp___396)) (= (select temp___393 temp___398) (of_rep temp___397)) (= (select temp___393 temp___398) (select temp___394 temp___398))))))))
...
(assert (not (= (bool_eq arrays__f2__result4 1 8 (temp___222 arr_in 1 i 7) 1 8) true)))
(check-sat)
(exit)
