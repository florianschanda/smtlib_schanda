...
(define-fun dynamic_invariant ((temp___expr_152 Int) (temp___is_init_149 Bool) (temp___skip_constant_150 Bool) (temp___do_toplevel_151 Bool)) Bool (=> (or (= temp___is_init_149 true) (<= 0 4294967295)) (in_range3 temp___expr_152)))
(declare-sort fart 0)
...
(define-fun dynamic_invariant1 ((temp___expr_248 Int) (temp___is_init_245 Bool) (temp___skip_constant_246 Bool) (temp___do_toplevel_247 Bool)) Bool (=> (or (= temp___is_init_245 true) (<= 0 2147483647)) (in_range4 temp___expr_248)))
...
(define-fun dynamic_invariant2 ((temp___expr_254 Int) (temp___is_init_251 Bool) (temp___skip_constant_252 Bool) (temp___do_toplevel_253 Bool)) Bool (=> (or (= temp___is_init_251 true) (<= 0 1)) (in_range5 temp___expr_254)))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_146 us_void_param) 1)) 78) (= (to_rep (select (temp___String_Literal_146 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_146 us_void_param) 3)) 85)) (= (to_rep (select (temp___String_Literal_146 us_void_param) 4)) 115)) (= (to_rep (select (temp___String_Literal_146 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_146 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_146 us_void_param) 7)) 32)) (= (to_rep (select (temp___String_Literal_146 us_void_param) 8)) 32)) (= (to_rep (select (temp___String_Literal_146 us_void_param) 9)) 32)) (= (to_rep (select (temp___String_Literal_146 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_146 us_void_param) 11)) 32)) (= (to_rep (select (temp___String_Literal_146 us_void_param) 12)) 32)) (= (to_rep (select (temp___String_Literal_146 us_void_param) 13)) 32)) (= (to_rep (select (temp___String_Literal_146 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_146 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_146 us_void_param) 16)) 32)) (= (to_rep (select (temp___String_Literal_146 us_void_param) 17)) 32)) (= (to_rep (select (temp___String_Literal_146 us_void_param) 18)) 32)) (= (to_rep (select (temp___String_Literal_146 us_void_param) 19)) 32)) (= (to_rep (select (temp___String_Literal_146 us_void_param) 20)) 32)) (= (to_rep (select (temp___String_Literal_146 us_void_param) 21)) 32)) (= (to_rep (select (temp___String_Literal_146 us_void_param) 22)) 32)) (= (to_rep (select (temp___String_Literal_146 us_void_param) 23)) 32)) (= (to_rep (select (temp___String_Literal_146 us_void_param) 24)) 32)) (= (to_rep (select (temp___String_Literal_146 us_void_param) 25)) 32)) (= (to_rep (select (temp___String_Literal_146 us_void_param) 26)) 32)) (= (to_rep (select (temp___String_Literal_146 us_void_param) 27)) 32)) (= (to_rep (select (temp___String_Literal_146 us_void_param) 28)) 32)) (= (to_rep (select (temp___String_Literal_146 us_void_param) 29)) 32)) (= (to_rep (select (temp___String_Literal_146 us_void_param) 30)) 32)) (= (to_rep (select (temp___String_Literal_146 us_void_param) 31)) 32)) (= (to_rep (select (temp___String_Literal_146 us_void_param) 32)) 32)) (= (to_rep (select (temp___String_Literal_146 us_void_param) 33)) 32)) (= (to_rep (select (temp___String_Literal_146 us_void_param) 34)) 32)) (= (to_rep (select (temp___String_Literal_146 us_void_param) 35)) 32)) (= (to_rep (select (temp___String_Literal_146 us_void_param) 36)) 32)) (= (to_rep (select (temp___String_Literal_146 us_void_param) 37)) 32)) (= (to_rep (select (temp___String_Literal_146 us_void_param) 38)) 32)) (= (to_rep (select (temp___String_Literal_146 us_void_param) 39)) 32)) (= (to_rep (select (temp___String_Literal_146 us_void_param) 40)) 32)) (= (to_rep (select (temp___String_Literal_146 us_void_param) 41)) 32)) (= (to_rep (select (temp___String_Literal_146 us_void_param) 42)) 32)) (= (to_rep (select (temp___String_Literal_146 us_void_param) 43)) 32)) (= (to_rep (select (temp___String_Literal_146 us_void_param) 44)) 32)) (= (to_rep (select (temp___String_Literal_146 us_void_param) 45)) 32)) (= (to_rep (select (temp___String_Literal_146 us_void_param) 46)) 32)) (= (to_rep (select (temp___String_Literal_146 us_void_param) 47)) 32)) (= (to_rep (select (temp___String_Literal_146 us_void_param) 48)) 32)) (= (to_rep (select (temp___String_Literal_146 us_void_param) 49)) 32)) (= (to_rep (select (temp___String_Literal_146 us_void_param) 50)) 32)) :pattern ((temp___String_Literal_146 us_void_param)))))
...
(define-fun dynamic_invariant3 ((temp___expr_835 Int) (temp___is_init_832 Bool) (temp___skip_constant_833 Bool) (temp___do_toplevel_834 Bool)) Bool (=> (or (= temp___is_init_832 true) (<= 0 16)) (in_range9 temp___expr_835)))
...
(define-fun dynamic_invariant5 ((temp___expr_886 Int) (temp___is_init_883 Bool) (temp___skip_constant_884 Bool) (temp___do_toplevel_885 Bool)) Bool (=> (or (= temp___is_init_883 true) (<= 0 16)) (in_range10 temp___expr_886)))
...
(define-fun dynamic_invariant6 ((temp___expr_892 Int) (temp___is_init_889 Bool) (temp___skip_constant_890 Bool) (temp___do_toplevel_891 Bool)) Bool (=> (or (= temp___is_init_889 true) (<= 0 4294967295)) (in_range11 temp___expr_892)))
(declare-fun codetoval (Int) Int)
(declare-fun codetoval__function_guard (Int Int) Bool)
(assert (forall ((s Int)) (! (=> (dynamic_invariant5 s true true true) (dynamic_invariant6 (codetoval s) true false true)) :pattern ((codetoval s)))))
(declare-fun temp___String_Literal_895 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_895 us_void_param) 1)) 66) (= (to_rep (select (temp___String_Literal_895 us_void_param) 2)) 105)) (= (to_rep (select (temp___String_Literal_895 us_void_param) 3)) 111)) (= (to_rep (select (temp___String_Literal_895 us_void_param) 4)) 109)) (= (to_rep (select (temp___String_Literal_895 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_895 us_void_param) 6)) 116)) (= (to_rep (select (temp___String_Literal_895 us_void_param) 7)) 114)) (= (to_rep (select (temp___String_Literal_895 us_void_param) 8)) 105)) (= (to_rep (select (temp___String_Literal_895 us_void_param) 9)) 99)) (= (to_rep (select (temp___String_Literal_895 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_895 us_void_param) 11)) 100)) (= (to_rep (select (temp___String_Literal_895 us_void_param) 12)) 101)) (= (to_rep (select (temp___String_Literal_895 us_void_param) 13)) 118)) (= (to_rep (select (temp___String_Literal_895 us_void_param) 14)) 105)) (= (to_rep (select (temp___String_Literal_895 us_void_param) 15)) 99)) (= (to_rep (select (temp___String_Literal_895 us_void_param) 16)) 101)) (= (to_rep (select (temp___String_Literal_895 us_void_param) 17)) 32)) (= (to_rep (select (temp___String_Literal_895 us_void_param) 18)) 102)) (= (to_rep (select (temp___String_Literal_895 us_void_param) 19)) 97)) (= (to_rep (select (temp___String_Literal_895 us_void_param) 20)) 105)) (= (to_rep (select (temp___String_Literal_895 us_void_param) 21)) 108)) (= (to_rep (select (temp___String_Literal_895 us_void_param) 22)) 117)) (= (to_rep (select (temp___String_Literal_895 us_void_param) 23)) 114)) (= (to_rep (select (temp___String_Literal_895 us_void_param) 24)) 101)) (= (to_rep (select (temp___String_Literal_895 us_void_param) 25)) 32)) :pattern ((temp___String_Literal_895 us_void_param)))))
(define-fun dynamic_invariant7 ((temp___expr_39 Int) (temp___is_init_36 Bool) (temp___skip_constant_37 Bool) (temp___do_toplevel_38 Bool)) Bool (=> (or (= temp___is_init_36 true) (<= 1 2147483647)) (in_range1 temp___expr_39)))
(define-fun dynamic_invariant8 ((temp___expr_63 Int) (temp___is_init_60 Bool) (temp___skip_constant_61 Bool) (temp___do_toplevel_62 Bool)) Bool (=> (or (= temp___is_init_60 true) (<= 0 255)) (in_range2 temp___expr_63)))
...
(assert true)
(define-fun dynamic_invariant10 ((temp___expr_330 Int) (temp___is_init_327 Bool) (temp___skip_constant_328 Bool) (temp___do_toplevel_329 Bool)) Bool (=> (or (= temp___is_init_327 true) (<= 1 150)) (in_range8 temp___expr_330)))
(assert (= nouser (temp___String_Literal_146 Tuple0)))
(define-fun dynamic_invariant11 ((temp___expr_164 Int) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool)) Bool (=> (or (= temp___is_init_161 true) (<= 0 255)) (in_range6 temp___expr_164)))
(define-fun dynamic_invariant12 ((temp___expr_275 Int) (temp___is_init_272 Bool) (temp___skip_constant_273 Bool) (temp___do_toplevel_274 Bool)) Bool (=> (or (= temp___is_init_272 true) (<= 0 4294967295)) (in_range7 temp___expr_275)))
...
(assert (= o1 (makedescription (mk___t (temp___String_Literal_895 Tuple0) (mk 1 25)) numericreturn1)))
(assert (= o1 o2))
(assert (= (mk 1 150) o3))
