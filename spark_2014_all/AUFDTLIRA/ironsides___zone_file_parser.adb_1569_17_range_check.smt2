...
(assert (= i29 r102b))
(assert (=> (and (<= r102b i29) (<= i29 r103b)) (= temp___1806 i29)))
(assert (=> (and (<= r102b i29) (<= i29 r103b)) (= temp___1807 endidx11)))
(assert (=> (and (<= r102b i29) (<= i29 r103b)) (= temp___1804 newemail1)))
(assert (=> (and (<= r102b i29) (<= i29 r103b)) (and (and (<= 1 begidx15) (<= (+ (- endidx11 begidx15) 1) 128)) (= endidx11 temp___1807))))
...
(assert (=> (and (<= r102b i29) (<= i29 r103b)) (and (= temp___1803 o13) (in_range1 o13))))
(assert (=> (and (<= r102b i29) (<= i29 r103b)) (and (<= 1 temp___1803) (<= temp___1803 128))))
(assert (=> (and (<= r102b i29) (<= i29 r103b)) (= o15 temp___1803)))
