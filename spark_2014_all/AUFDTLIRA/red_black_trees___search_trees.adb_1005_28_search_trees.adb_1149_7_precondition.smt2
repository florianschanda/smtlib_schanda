...
(declare-const temp___1084 (Array Int us_rep1))
...
(assert (not (= xr1 0)))
(assert (and (= temp___1084 (model__ (rec__search_trees__search_tree__struct t__split_fields8) y1)) (and (dynamic_invariant3 temp___1084 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1084 y1))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1084 y1)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 y1)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct t__split_fields8) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1084 (parent (rec__search_trees__search_tree__struct t__split_fields8) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1084 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1084 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1084 i1))) true) (not (= i1 y1))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1084 (parent (rec__search_trees__search_tree__struct t__split_fields8) i1)))) (position (rec__search_trees__search_tree__struct t__split_fields8) i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1084 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1084 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1084 i1))) true) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1084 j3))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1084 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1084 j3)))) true)) (= j3 i1))))))))))))))
(assert (and (<= 1 xr1) (<= xr1 100)))
(assert (= o12 xr1))
(assert (= o13 (select temp___1084 o12)))
(assert (= o14 (us_split_fields1 o13)))
(assert (= o15 (rec__tree_model__path_type__a o14)))
(assert (not (<= 1 (last o15))))
(check-sat)
(exit)
