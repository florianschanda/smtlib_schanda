...
(declare-fun user_eq10 (t17s t17s) Bool)
(declare-const dummy10 t17s)
(declare-datatypes () ((t17s__ref (mk_t17s__ref (t17s__content t17s)))))
(define-fun t17s__ref___projection ((a t17s__ref)) t17s (t17s__content a))
(declare-fun temp___238 (Int) (Array Int element))
(assert (forall ((temp___240 Int)) (= (select (temp___238 temp___240) 1) (of_rep temp___240))))
...
(assert (=> (<= 1 1) (= o (+ (- 1 1) 1))))
(assert (=> (not (<= 1 1)) (= o 0)))
(assert (=> (<= (to_rep2 (first (rt (get_model (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag))))) (to_rep2 (last (rt (get_model (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag)))))) (= o1 (+ (- (to_rep2 (last (rt (get_model (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag))))) (to_rep2 (first (rt (get_model (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag)))))) 1))))
(assert (=> (not (<= (to_rep2 (first (rt (get_model (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag))))) (to_rep2 (last (rt (get_model (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag))))))) (= o1 0)))
(assert (= o2 (+ o1 o)))
(assert (= o3 (+ (to_rep2 (first (rt (get_model (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag))))) o2)))
(assert (= o4 (- o3 1)))
