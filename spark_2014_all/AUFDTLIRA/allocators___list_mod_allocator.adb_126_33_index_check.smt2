...
(assert (and (= o33 (+ j1 1)) (in_range1 (+ j1 1))))
(assert (and (= o34 (get avail3 o33)) (in_range6 o34)))
(assert (and (= temp___297 (get avail3 j1)) (in_range6 temp___297)))
(assert (not (<= 1 temp___297)))
(check-sat)
(exit)
