...
(assert (and (= result (consistent b i)) (= (= result true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 i)) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 (- i1 1))) (and (and (not (= (to_rep (select b i1)) (to_rep (select b j3)))) (not (= (- i1 j3) (- (to_rep (select b i1)) (to_rep (select b j3)))))) (not (= (- i1 j3) (- (to_rep (select b j3)) (to_rep (select b i1)))))))))))))
(assert (not (= result true)))
(assert (not (not (= (consistent c i) true))))
(check-sat)
(exit)
