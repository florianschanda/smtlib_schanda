...
(assert (and (= result (consistent b i)) (= (= result true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 i)) (forall ((j Int)) (=> (and (<= 1 j) (<= j (- i1 1))) (and (and (not (= (to_rep (select b i1)) (to_rep (select b j)))) (not (= (- i1 j) (- (to_rep (select b i1)) (to_rep (select b j)))))) (not (= (- i1 j) (- (to_rep (select b j)) (to_rep (select b i1)))))))))))))
