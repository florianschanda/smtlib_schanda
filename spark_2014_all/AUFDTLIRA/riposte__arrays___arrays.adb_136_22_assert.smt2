...
(assert (forall ((temp___159 Int) (temp___160 Int)) (let ((temp___158 (arrays__zero_enum_map__aggregate_def temp___159 temp___160))) (=> (and (dynamic_invariant temp___159 true true true true) (dynamic_invariant temp___160 true true true true)) (forall ((temp___161 Int)) (ite (= temp___161 2) (= (to_rep (select temp___158 temp___161)) temp___159) (= (to_rep (select temp___158 temp___161)) temp___160)))))))
