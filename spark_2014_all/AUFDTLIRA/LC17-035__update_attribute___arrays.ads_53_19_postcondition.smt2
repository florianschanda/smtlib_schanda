...
(declare-fun temp___282 ((Array Int integer) Int Int Int Int) (Array Int integer))
(assert (forall ((temp___284 (Array Int integer))) (forall ((temp___285 Int) (temp___286 Int) (temp___287 Int) (temp___288 Int)) (let ((temp___283 (temp___282 temp___284 temp___285 temp___286 temp___287 temp___288))) (forall ((temp___289 Int)) (ite (or (and (<= temp___285 temp___289) (<= temp___289 temp___286)) (= temp___289 temp___287)) (= (select temp___283 temp___289) (of_rep temp___288)) (= (select temp___283 temp___289) (select temp___284 temp___289))))))))
...
(assert (not (= (bool_eq arrays__f6__result4 1 8 (temp___282 arr_in 1 2 5 2) 1 8) true)))
(check-sat)
(exit)
