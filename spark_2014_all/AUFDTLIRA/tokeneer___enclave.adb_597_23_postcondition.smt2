...
(define-fun dynamic_invariant5 ((temp___expr_179 Int) (temp___is_init_176 Bool) (temp___skip_constant_177 Bool) (temp___do_toplevel_178 Bool)) Bool (=> (or (= temp___is_init_176 true) (<= 0 3)) (in_range6 temp___expr_179)))
(define-fun dynamic_invariant6 ((temp___expr_185 Int) (temp___is_init_182 Bool) (temp___skip_constant_183 Bool) (temp___do_toplevel_184 Bool)) Bool (=> (or (= temp___is_init_182 true) (<= 1 3)) (in_range4 temp___expr_185)))
(assert (forall ((admintoken__state us_private)) (! (dynamic_invariant5 (theauthcertrole admintoken__state) true false true) :pattern ((theauthcertrole admintoken__state)))))
(assert true)
(assert true)
(assert true)
(define-fun dynamic_invariant7 ((temp___expr_324 Int) (temp___is_init_321 Bool) (temp___skip_constant_322 Bool) (temp___do_toplevel_323 Bool)) Bool (=> (or (= temp___is_init_321 true) (<= 1 150)) (in_range3 temp___expr_324)))
...
(assert (= status1 3))
(assert (and (not (= (isgood state4) true)) (and (not (= (authcertvalid state4) true)) (not (in_range4 (theauthcertrole state4))))))
