...
(define-fun dynamic_invariant2 ((temp___expr_161 us_t) (temp___is_init_157 Bool) (temp___skip_constant_158 Bool) (temp___do_toplevel_159 Bool) (temp___do_typ_inv_160 Bool)) Bool (=> (not (= temp___skip_constant_158 true)) (dynamic_property 1 2147483647 (first1 temp___expr_161) (last1 temp___expr_161))))
...
(assert (and (= (to_rep (select o2 o)) 0) (forall ((j Int)) (=> (and (<= (to_rep a__first) j) (<= j (to_rep a__last))) (=> (not (= o j)) (= (to_rep (select o2 j)) (to_rep (select a j))))))))
(assert (forall ((j Int)) (=> (and (<= (to_rep a__first) j) (<= j i2)) (= (to_rep (select o3 j)) 0))))
...
(assert (and (= (to_rep (select o4 o1)) 0) (forall ((j Int)) (=> (and (<= (to_rep a__first) j) (<= j (to_rep a__last))) (=> (not (= o1 j)) (= (to_rep (select o4 j)) (to_rep (select o3 j))))))))
(declare-const j Int)
(assert (<= (to_rep a__first) j))
(assert (<= j i3))
(assert (not (= (to_rep (select o4 j)) 0)))
(check-sat)
(exit)
