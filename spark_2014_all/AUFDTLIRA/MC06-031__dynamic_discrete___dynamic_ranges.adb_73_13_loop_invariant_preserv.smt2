...
(define-fun dynamic_invariant2 ((temp___expr_138 us_t) (temp___is_init_135 Bool) (temp___skip_constant_136 Bool) (temp___do_toplevel_137 Bool)) Bool (=> (not (= temp___skip_constant_136 true)) (dynamic_property 1 2147483647 (first1 temp___expr_138) (last1 temp___expr_138))))
...
(assert (and (= o i1) (in_range2 i1)))
(assert (and (= (to_rep (select a2 o)) 0) (forall ((j2 Int)) (=> (and (<= (to_rep a__first) j2) (<= j2 (to_rep a__last))) (=> (not (= o j2)) (= (to_rep (select a2 j2)) (to_rep (select a j2))))))))
(assert (forall ((j2 Int)) (=> (and (<= (to_rep a__first) j2) (<= j2 i2)) (= (to_rep (select a3 j2)) 0))))
(assert (and (=> (<= (to_rep a__first) (to_rep a__last)) (dynamic_property1 (to_rep a__first) (to_rep a__last) i2)) (and (<= (to_rep a__first) i2) (<= i2 (to_rep a__last)))))
(assert (not (= i2 (to_rep a__last))))
(assert (= i2 result1))
(assert (= i3 (+ i2 1)))
(assert (and (= o1 i3) (in_range2 i3)))
(assert (and (= (to_rep (select a4 o1)) 0) (forall ((j2 Int)) (=> (and (<= (to_rep a__first) j2) (<= j2 (to_rep a__last))) (=> (not (= o1 j2)) (= (to_rep (select a4 j2)) (to_rep (select a3 j2))))))))
(declare-const j2 Int)
(assert (<= (to_rep a__first) j2))
(assert (<= j2 i3))
(assert (not (= (to_rep (select a4 j2)) 0)))
(check-sat)
(exit)
