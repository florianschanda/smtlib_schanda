...
(declare-const temp___1011 (Array Int character))
(declare-const temp___10111 t1)
(declare-const o (Array Int character))
(declare-const o1 t)
(declare-const o2 natural_index)
(declare-const o3 (Array Int character))
(declare-const o4 t)
(declare-const temp___1013 natural_index)
(declare-const temp___10131 natural_index)
(declare-const temp___10132 (Array Int character))
(declare-const temp___10133 t)
(declare-const temp___1014 natural_index)
(declare-const temp___10141 natural_index)
(declare-const temp___10142 (Array Int character))
(declare-const temp___10143 t)
...
(define-fun temp___10134 () us_rep (mk___rep (mk___split_discrs temp___1013) (mk___split_fields temp___10131 (mk___t temp___10132 temp___10133))))
...
(assert (= (ite (<= (to_rep2 (first2 temp___10091)) (to_rep2 (last2 temp___10091))) (+ (- (to_rep2 (last2 temp___10091)) (to_rep2 (first2 temp___10091))) 1) 0) (ite (<= (to_rep2 (first (rt (rec__bounded_dynamic_strings__sequence__content this__split_fields3)))) (to_rep2 (last (rt (rec__bounded_dynamic_strings__sequence__content this__split_fields3))))) (+ (- (to_rep2 (last (rt (rec__bounded_dynamic_strings__sequence__content this__split_fields3)))) (to_rep2 (first (rt (rec__bounded_dynamic_strings__sequence__content this__split_fields3))))) 1) 0)))
(assert (= (mk___t1 temp___1011 temp___10111) (mk___t1 temp___1009 temp___10091)))
(assert (= temp___1011 o))
(assert (= (mk (to_rep2 (first2 temp___10111)) (to_rep2 (last2 temp___10111))) o1))
(assert (= (rec__bounded_dynamic_strings__sequence__current_length this__split_fields3) o2))
(assert (= o3 o))
(assert (= o4 o1))
(assert (= this__split_discrs (mk___split_discrs temp___1013)))
(assert (= temp___10131 o2))
(assert (= temp___10132 o3))
(assert (= temp___10133 o4))
(assert (dynamic_predicate temp___10134))
(assert (= (mk___rep (mk___split_discrs temp___1014) (mk___split_fields temp___10141 (mk___t temp___10142 temp___10143))) temp___10134))
(assert (= result1 (mk___split_fields__ref this__split_fields3)))
(assert (= this__split_fields4 (mk___split_fields temp___10141 (mk___t temp___10142 temp___10143))))
(assert (= this__split_discrs (mk___split_discrs temp___1014)))
(assert (= this__split_fields5 (mk___split_fields__ref this__split_fields4)))
(assert (= this__split_fields6 this__split_fields4))
(assert (not (= (empty (mk___rep this__split_discrs (us_split_fields__content this__split_fields5))) true)))
(check-sat)
(exit)
