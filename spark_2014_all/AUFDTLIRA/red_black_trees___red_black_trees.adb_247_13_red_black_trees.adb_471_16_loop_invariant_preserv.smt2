...
(assert (=> (= result67 true) (= (rec__red_black_trees__black_count__status (us_split_fields11 (select (nb_blacks c95b) c96b))) true)))
(assert (=> (= result67 true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (nb_blacks c95b) c96b)))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (nb_blacks c94b) c96b)))))))
(assert (not (= n88 100)))
(assert (= result68 (mk_int__ref n88)))
(assert (= n89 (+ n88 1)))
(assert (= n90 (mk_int__ref n89)))
(assert (= n91 n89))
(declare-const i14 Int)
(assert (<= 1 i14))
(assert (<= i14 100))
(assert (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c94b))) i14))) true))
(assert (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c94b) i14)))) (int__content n90)))
(assert (= (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c95b)) i14) c96b))
(assert (not (= (rec__red_black_trees__black_count__status (us_split_fields11 (select (nb_blacks c95b) i14))) true)))
(check-sat)
(exit)
