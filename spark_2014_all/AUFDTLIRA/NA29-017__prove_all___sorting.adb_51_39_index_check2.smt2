...
(assert (and (= o13 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= o14 (+ b_first o13)))
(assert (and (= o15 o14) (in_range1 o14)))
(assert (= o16 (- o15 1)))
(assert (= o17 (ite (<= j o16) true false)))
(assert (= o18 (ite (<= b_first j) o17 false)))
(assert (= result2 (ite (not (= o18 true)) true false)))
(assert (=> (= result2 true) (and (<= (to_rep b__first) j) (<= j (to_rep b__last)))))
(assert (=> (= result2 true) (= o21 j)))
(assert (=> (= result2 true) (= o22 (select b o21))))
(assert (=> (= result2 true) (= o23 (to_rep o22))))
(assert (=> (= result2 true) (and (<= (to_rep b__first) j) (<= j (to_rep b__last)))))
(assert (=> (= result2 true) (= o19 j)))
(assert (=> (= result2 true) (= o20 (select b2 o19))))
(assert (=> (= result2 true) (= o24 (to_rep o20))))
(assert (=> (= result2 true) (= o25 (ite (= o24 o23) true false))))
(assert (=> (not (= result2 true)) (= o25 (distinct 1 0))))
...
(assert (not (<= (to_rep (first (rt a))) temp___272)))
(check-sat)
(exit)
