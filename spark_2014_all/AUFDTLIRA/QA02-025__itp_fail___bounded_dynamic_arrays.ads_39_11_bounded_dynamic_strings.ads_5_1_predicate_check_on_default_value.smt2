...
(declare-const temp___230 natural_index)
(declare-const temp___2301 natural_index)
(declare-const temp___2302 (Array Int character))
(declare-const temp___2303 t)
(assert (and (= (to_rep temp___2301) 0) (let ((temp___232 (temp___222 32 1 (to_rep temp___230)))) (and (= temp___2302 (elts1 temp___232)) (= temp___2303 (mk (to_rep2 (first2 (rt1 temp___232))) (to_rep2 (last2 (rt1 temp___232)))))))))
(assert (not (dynamic_predicate (mk___rep (mk___split_discrs temp___230) (mk___split_fields temp___2301 (mk___t temp___2302 temp___2303))))))
(check-sat)
(exit)
