...
(assert (and (= (to_rep temp___2011) 0) (let ((temp___203 (temp___193 32 1 (to_rep temp___201)))) (and (= temp___2012 (elts1 temp___203)) (= temp___2013 (mk (to_rep2 (first2 (rt1 temp___203))) (to_rep2 (last2 (rt1 temp___203)))))))))
(assert (not (dynamic_predicate (mk___rep (mk___split_discrs temp___201) (mk___split_fields temp___2011 (mk___t temp___2012 temp___2013))))))
(check-sat)
(exit)
