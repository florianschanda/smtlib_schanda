...
(assert (forall ((x serialnumbert)) (! (in_range5 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(define-fun bool_eq6 ((a us_rep4) (b us_rep4)) Bool (ite (and (and (= (to_rep5 (rec__cryptotypes__keypartt__algorithmid (us_split_fields9 a))) (to_rep5 (rec__cryptotypes__keypartt__algorithmid (us_split_fields9 b)))) (= (to_rep10 (rec__cryptotypes__keypartt__keyid (us_split_fields9 a))) (to_rep10 (rec__cryptotypes__keypartt__keyid (us_split_fields9 b))))) (= (to_rep11 (rec__cryptotypes__keypartt__keylength (us_split_fields9 a))) (to_rep11 (rec__cryptotypes__keypartt__keylength (us_split_fields9 b))))) true false))
...
(define-fun us_split_fields_ID__6__projection ((a us_split_fields10)) us_rep1 (rec__cert__id__contentst__id a))
...
(define-fun bool_eq7 ((a us_rep5) (b us_rep5)) Bool (ite (and (and (and (and (and (= (bool_eq3 (rec__cert__id__contentst__id (us_split_fields11 a)) (rec__cert__id__contentst__id (us_split_fields11 b))) true) (= (bool_eq4 (rec__cert__id__contentst__notbefore (us_split_fields11 a)) (rec__cert__id__contentst__notbefore (us_split_fields11 b))) true)) (= (bool_eq4 (rec__cert__id__contentst__notafter (us_split_fields11 a)) (rec__cert__id__contentst__notafter (us_split_fields11 b))) true)) (= (to_rep5 (rec__cert__id__contentst__mechanism (us_split_fields11 a))) (to_rep5 (rec__cert__id__contentst__mechanism (us_split_fields11 b))))) (= (bool_eq2 (rec__cert__id__contentst__subject (us_split_fields11 a)) (rec__cert__id__contentst__subject (us_split_fields11 b))) true)) (= (bool_eq6 (rec__cert__id__contentst__subjectpublickey (us_split_fields11 a)) (rec__cert__id__contentst__subjectpublickey (us_split_fields11 b))) true)) true false))
...
(define-fun contentst__ref___4__projection ((a contentst__ref1)) us_rep5 (contentst__content1 a))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1383 us_void_param) 1)) 73) (= (to_rep (select (temp___String_Literal_1383 us_void_param) 2)) 68)) (= (to_rep (select (temp___String_Literal_1383 us_void_param) 3)) 32)) (= (to_rep (select (temp___String_Literal_1383 us_void_param) 4)) 67)) (= (to_rep (select (temp___String_Literal_1383 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_1383 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_1383 us_void_param) 7)) 116)) (= (to_rep (select (temp___String_Literal_1383 us_void_param) 8)) 105)) (= (to_rep (select (temp___String_Literal_1383 us_void_param) 9)) 102)) (= (to_rep (select (temp___String_Literal_1383 us_void_param) 10)) 105)) (= (to_rep (select (temp___String_Literal_1383 us_void_param) 11)) 99)) (= (to_rep (select (temp___String_Literal_1383 us_void_param) 12)) 97)) (= (to_rep (select (temp___String_Literal_1383 us_void_param) 13)) 116)) (= (to_rep (select (temp___String_Literal_1383 us_void_param) 14)) 101)) (= (to_rep (select (temp___String_Literal_1383 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_1383 us_void_param) 16)) 78)) (= (to_rep (select (temp___String_Literal_1383 us_void_param) 17)) 111)) (= (to_rep (select (temp___String_Literal_1383 us_void_param) 18)) 116)) (= (to_rep (select (temp___String_Literal_1383 us_void_param) 19)) 32)) (= (to_rep (select (temp___String_Literal_1383 us_void_param) 20)) 86)) (= (to_rep (select (temp___String_Literal_1383 us_void_param) 21)) 101)) (= (to_rep (select (temp___String_Literal_1383 us_void_param) 22)) 114)) (= (to_rep (select (temp___String_Literal_1383 us_void_param) 23)) 105)) (= (to_rep (select (temp___String_Literal_1383 us_void_param) 24)) 102)) (= (to_rep (select (temp___String_Literal_1383 us_void_param) 25)) 105)) (= (to_rep (select (temp___String_Literal_1383 us_void_param) 26)) 97)) (= (to_rep (select (temp___String_Literal_1383 us_void_param) 27)) 98)) (= (to_rep (select (temp___String_Literal_1383 us_void_param) 28)) 108)) (= (to_rep (select (temp___String_Literal_1383 us_void_param) 29)) 101)) :pattern ((temp___String_Literal_1383 us_void_param)))))
(declare-fun temp___String_Literal_1384 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1384 us_void_param) 1)) 73) (= (to_rep (select (temp___String_Literal_1384 us_void_param) 2)) 68)) (= (to_rep (select (temp___String_Literal_1384 us_void_param) 3)) 32)) (= (to_rep (select (temp___String_Literal_1384 us_void_param) 4)) 67)) (= (to_rep (select (temp___String_Literal_1384 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_1384 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_1384 us_void_param) 7)) 116)) (= (to_rep (select (temp___String_Literal_1384 us_void_param) 8)) 105)) (= (to_rep (select (temp___String_Literal_1384 us_void_param) 9)) 102)) (= (to_rep (select (temp___String_Literal_1384 us_void_param) 10)) 105)) (= (to_rep (select (temp___String_Literal_1384 us_void_param) 11)) 99)) (= (to_rep (select (temp___String_Literal_1384 us_void_param) 12)) 97)) (= (to_rep (select (temp___String_Literal_1384 us_void_param) 13)) 116)) (= (to_rep (select (temp___String_Literal_1384 us_void_param) 14)) 101)) (= (to_rep (select (temp___String_Literal_1384 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_1384 us_void_param) 16)) 66)) (= (to_rep (select (temp___String_Literal_1384 us_void_param) 17)) 97)) (= (to_rep (select (temp___String_Literal_1384 us_void_param) 18)) 100)) :pattern ((temp___String_Literal_1384 us_void_param)))))
...
(define-fun dynamic_invariant10 ((temp___expr_200 Int) (temp___is_init_197 Bool) (temp___skip_constant_198 Bool) (temp___do_toplevel_199 Bool)) Bool (=> (or (= temp___is_init_197 true) (<= 0 4294967295)) (in_range7 temp___expr_200)))
...
(define-fun dynamic_invariant12 ((temp___expr_230 Int) (temp___is_init_227 Bool) (temp___skip_constant_228 Bool) (temp___do_toplevel_229 Bool)) Bool (=> (or (= temp___is_init_227 true) (<= 0 4294967295)) (in_range13 temp___expr_230)))
(define-fun dynamic_invariant13 ((temp___expr_236 Int) (temp___is_init_233 Bool) (temp___skip_constant_234 Bool) (temp___do_toplevel_235 Bool)) Bool (=> (or (= temp___is_init_233 true) (<= 0 128)) (in_range14 temp___expr_236)))
(define-fun dynamic_invariant14 ((temp___expr_321 Int) (temp___is_init_318 Bool) (temp___skip_constant_319 Bool) (temp___do_toplevel_320 Bool)) Bool (=> (or (= temp___is_init_318 true) (<= 0 4294967295)) (in_range5 temp___expr_321)))
...
(assert (=> (= certfound true) (=> (= extractok2 true) (= o10 (to_rep2 o9)))))
(assert (=> (= certfound true) (=> (= extractok2 true) (= o11 (ite (= tokenid o10) true false)))))
(assert (=> (= certfound true) (=> (= extractok2 true) (= result3 tokenidmatches1))))
(assert (=> (= certfound true) (=> (= extractok2 true) (= tokenidmatches2 o11))))
(assert (=> (= certfound true) (=> (= extractok2 true) (= o12 (cert_id_to_cert (mk___rep5 (let ((subject idcertcontents__split_fields)) idcertcontents__split_fields2)))))))
