...
(assert (and (= o29 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (= o30 (ite (<= index1 o29) true false)))
(assert (and (= o28 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (= o31 (ite (<= o28 index1) true false)))
(assert (= result (ite (= o31 true) o30 false)))
(assert (= (= o32 true) (forall ((index11 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 7) index11) (<= index11 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index11))) true)))))
(assert (and (= temp___1933 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1933) (<= temp___1933 (to_rep1 (last (rt source))))))
(assert (= o24 temp___1933))
(assert (= o25 (select (elts source) o24)))
(assert (= o26 (to_rep o25)))
(assert (= o27 (ite (< o26 51) true false)))
(assert (and (= temp___1932 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1932) (<= temp___1932 (to_rep1 (last (rt source))))))
(assert (= o20 temp___1932))
(assert (= o21 (select (elts source) o20)))
(assert (= o22 (to_rep o21)))
(assert (= o23 (ite (= o22 56) true false)))
(assert (and (= temp___1931 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1931) (<= temp___1931 (to_rep1 (last (rt source))))))
(assert (= o16 temp___1931))
