...
(assert (= (= o true) (forall ((i Int)) (=> (and (<= (+ (to_rep (rec__natural_set__t__len (us_split_fields1 s))) 1) i) (<= i 10)) (= (to_rep1 (select (rec__natural_set__t__m (us_split_fields1 s)) i)) (- 1))))))
(assert (<= 1 (to_rep (rec__natural_set__t__len (us_split_fields1 s)))))
(assert (not (<= 1 1)))
(check-sat)
(exit)
