...
(assert (and (= o2 (- i9 first4)) (in_range1 (- i9 first4))))
(assert (and (= o3 (length2 (mk___rep1 res__split_discrs res__split_fields2))) (and (in_range6 o3) (<= o3 (capacity (mk___rep1 res__split_discrs res__split_fields2))))))
(assert (= result4 (ite (= o3 o2) true false)))
(assert (= result4 true))
