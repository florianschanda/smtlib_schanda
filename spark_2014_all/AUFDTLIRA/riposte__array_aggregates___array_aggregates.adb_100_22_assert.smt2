...
(declare-fun temp_____aggregate_def_465 (Int) (Array Int unsigned_byte))
...
(assert (forall ((temp___467 Int)) (=> (dynamic_invariant temp___467 true true true true) (forall ((temp___468 Int)) (= (select (temp_____aggregate_def_465 temp___467) temp___468) rliteral)))))
...
(assert (= result x))
(assert (= x1 (temp_____aggregate_def_465 8)))
