...
(declare-fun temp___465 (Int) (Array Int unsigned_byte))
...
(assert (forall ((temp___467 Int)) (=> (dynamic_invariant temp___467 true true true true) (forall ((temp___468 Int)) (= (to_rep (select (temp___465 temp___467) temp___468)) temp___467)))))
