...
(assert (= i2 r4b))
(assert (=> (and (<= r4b i2) (<= i2 r5b)) (and (= s__split_discrs (mk___split_discrs temp___476)) (and (= s__split_fields temp___4761) (and (= s__split_fields1 temp___4762) (= s__split_fields2 temp___4763))))))
...
(assert (=> (and (<= r4b i2) (<= i2 r5b)) (and (and (= (top (mk___rep s__split_discrs stack__push__s__fields)) o1) (= (let ((temp___182 (to__ (mk___rep s__split_discrs (us_split_fields1 (to_base (mk___rep2 s__split_discrs s__split_fields4))))))) (let ((temp___181 (to_but_top (mk___rep s__split_discrs stack__push__s__fields)))) (bool_eq (elts1 temp___181) (to_rep (first2 (rt1 temp___181))) (to_rep (last2 (rt1 temp___181))) (elts1 temp___182) (to_rep (first2 (rt1 temp___182))) (to_rep (last2 (rt1 temp___182)))))) true)) (dynamic_invariant2 (mk___rep s__split_discrs stack__push__s__fields) true true true))))
