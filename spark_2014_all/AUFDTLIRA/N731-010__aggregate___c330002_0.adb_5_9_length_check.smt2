...
(declare-fun temp___170 (Int Int Int Int) us_t1)
(assert (forall ((temp___172 Int) (temp___173 Int) (temp___174 Int) (temp___175 Int)) (let ((temp___171 (temp___170 temp___172 temp___173 temp___174 temp___175))) (and (=> (dynamic_property 1 2147483647 temp___174 temp___175) (and (= (first3 temp___171) temp___174) (= (last3 temp___171) temp___175))) (and (= (select (to_array1 temp___171) (+ (to_rep a__first) 0)) (of_rep temp___172)) (= (select (to_array1 temp___171) (+ (to_rep a__first) 1)) (of_rep temp___173)))))))
...
(assert (= (to_rep (first2 (rt1 (temp___170 84 36 (to_rep a__first) (+ (to_rep a__first) 1))))) (to_rep a__first)))
(assert (= (to_rep (last2 (rt1 (temp___170 84 36 (to_rep a__first) (+ (to_rep a__first) 1))))) (+ (to_rep a__first) 1)))
(assert (= (mk___t1 temp___178 temp___1781) (temp___170 84 36 (to_rep a__first) (+ (to_rep a__first) 1))))
(assert (= temp___178 temp___179))
(assert (= (mk (to_rep (first2 temp___1781)) (to_rep (last2 temp___1781))) temp___1791))
(assert (not (= (ite (<= (to_rep (first temp___1791)) (to_rep (last temp___1791))) (+ (- (to_rep (last temp___1791)) (to_rep (first temp___1791))) 1) 0) (ite (<= (to_rep a__first) (to_rep a__last)) (+ (- (to_rep a__last) (to_rep a__first)) 1) 0))))
(check-sat)
(exit)
