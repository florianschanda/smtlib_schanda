...
(declare-fun temp___195 (Int Int Int Int) us_t1)
...
(assert (forall ((temp___197 Int) (temp___198 Int) (temp___199 Int) (temp___200 Int)) (let ((temp___196 (temp___195 temp___197 temp___198 temp___199 temp___200))) (=> (and (dynamic_invariant temp___197 true true true true) (dynamic_invariant temp___198 true true true true)) (and (=> (dynamic_property 1 2147483647 temp___199 temp___200) (and (= (first3 temp___196) temp___199) (= (last3 temp___196) temp___200))) (and (= (to_rep (select (to_array1 temp___196) (+ (to_rep a__first) 0))) temp___197) (= (to_rep (select (to_array1 temp___196) (+ (to_rep a__first) 1))) temp___198)))))))
...
(assert (= (to_rep (first2 (rt1 (temp___195 84 36 (to_rep a__first) (+ (to_rep a__first) 1))))) (to_rep a__first)))
(assert (= (to_rep (last2 (rt1 (temp___195 84 36 (to_rep a__first) (+ (to_rep a__first) 1))))) (+ (to_rep a__first) 1)))
(assert (= (mk___t1 temp___203 temp___2031) (temp___195 84 36 (to_rep a__first) (+ (to_rep a__first) 1))))
