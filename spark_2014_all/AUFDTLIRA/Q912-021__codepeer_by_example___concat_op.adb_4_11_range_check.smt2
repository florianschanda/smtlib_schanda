...
(assert (=> (<= (to_rep (first (rt x))) (to_rep (last (rt x)))) (= o1 (+ (- (to_rep (last (rt x))) (to_rep (first (rt x)))) 1))))
(assert (=> (not (<= (to_rep (first (rt x))) (to_rep (last (rt x))))) (= o1 0)))
(assert (= o2 (+ o1 o)))
(assert (= o3 (+ (to_rep (first (rt x))) o2)))
(assert (= o4 (- o3 1)))
