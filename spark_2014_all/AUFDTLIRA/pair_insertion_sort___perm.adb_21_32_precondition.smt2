...
(assert (forall ((a us_t)) (! (=> (dynamic_invariant1 a true true true) (= (remove_last a) (let ((temp___164 (let ((temp___163 (- (last1 a) 1))) (let ((temp___162 (first1 a))) (of_array1 (to_array a) temp___162 temp___163))))) (of_array (to_array1 temp___164) (first3 temp___164) (last3 temp___164))))) :pattern ((remove_last a)))))
...
(assert (forall ((a us_t)) (forall ((e Int)) (! (=> (and (dynamic_invariant1 a true true true) (dynamic_invariant e true true true)) (let ((result (occ a e))) (and (<= result (length a)) (dynamic_invariant2 result true false true)))) :pattern ((occ a e))))))
...
(assert (forall ((a1 us_t)) (forall ((e1 Int)) (! (=> (and (dynamic_invariant1 a1 true true true) (dynamic_invariant e1 true true true)) (= (occ_def a1 e1) (ite (= (length a1) 0) 0 (ite (= (to_rep (select (to_array a1) (last1 a1))) e1) (+ (occ_def (remove_last a1) e1) 1) (occ_def (remove_last a1) e1))))) :pattern ((occ_def a1 e1))))))
...
(assert (=> (= result true) (= (to_rep (select (elts b) (to_rep (last (rt b))))) e)))
(assert (=> (not (= result true)) (not (= (to_rep (select (elts b) (to_rep (last (rt b))))) e))))
(assert (not (< 0 (length b))))
(check-sat)
(exit)
