...
(assert (= last3 o1))
(assert (and (= temp___1812 (to_string1 (mk___rep v__split_fields4))) (dynamic_invariant2 temp___1812 true false true)))
...
(assert (= (concat1 (temp___String_Literal_179 Tuple0) 1 11 temp___181 (to_rep1 (first temp___1811)) (to_rep1 (last temp___1811))) o8))
(assert (= (mk 1 o7) o9))
(assert (= last3 last4))
