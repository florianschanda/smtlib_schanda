...
(define-fun dynamic_invariant3 ((temp___expr_159 Int) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool) (temp___do_typ_inv_158 Bool)) Bool (=> (or (= temp___is_init_155 true) (<= 1 100)) (in_range4 temp___expr_159)))
(define-fun dynamic_invariant4 ((temp___expr_166 us_t) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool (=> (not (= temp___skip_constant_163 true)) (dynamic_property 1 100 (first1 temp___expr_166) (last1 temp___expr_166))))
(assert true)
...
(define-fun dynamic_invariant5 ((temp___expr_219 us_t1) (temp___is_init_215 Bool) (temp___skip_constant_216 Bool) (temp___do_toplevel_217 Bool) (temp___do_typ_inv_218 Bool)) Bool (=> (not (= temp___skip_constant_216 true)) (and (dynamic_property2 (to_rep1 values__first) (to_rep1 values__last) (first3 temp___expr_219) (last3 temp___expr_219)) (and (= (first3 temp___expr_219) (to_rep1 values__first)) (= (last3 temp___expr_219) (to_rep1 values__last))))))
...
(define-fun dynamic_invariant6 ((temp___expr_229 us_t2) (temp___is_init_225 Bool) (temp___skip_constant_226 Bool) (temp___do_toplevel_227 Bool) (temp___do_typ_inv_228 Bool)) Bool (=> (not (= temp___skip_constant_226 true)) (and (dynamic_property4 (to_rep1 values__first) (to_rep1 values__last) (first5 temp___expr_229) (last5 temp___expr_229)) (and (= (first5 temp___expr_229) (to_rep1 values__first)) (= (last5 temp___expr_229) (to_rep1 values__last))))))
...
(define-fun dynamic_invariant7 ((temp___expr_172 Int) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool) (temp___do_typ_inv_171 Bool)) Bool (=> (or (= temp___is_init_168 true) (<= 0 100)) (in_range5 temp___expr_172)))
...
(assert (forall ((a us_t)) (! (=> (and (dynamic_invariant4 a true true true true) (< 0 (length a))) (dynamic_invariant4 (remove_last a) true false true true)) :pattern ((remove_last a)))))
(assert (forall ((a us_t)) (! (=> (dynamic_invariant4 a true true true true) (= (remove_last a) (let ((temp___184 (let ((temp___183 (- (last1 a) 1))) (let ((temp___182 (first1 a))) (of_array3 (to_array a) temp___182 temp___183))))) (of_array (to_array3 temp___184) (first7 temp___184) (last7 temp___184))))) :pattern ((remove_last a)))))
(declare-fun occ_def (us_t Int) Int)
(declare-fun occ_def__function_guard (Int us_t Int) Bool)
(assert (forall ((a us_t)) (forall ((e Int)) (! (=> (and (dynamic_invariant4 a true true true true) (dynamic_invariant2 e true true true true)) (= (occ_def a e) (ite (= (length a) 0) 0 (ite (= (to_rep (select (to_array a) (last1 a))) e) (+ (occ_def (remove_last a) e) 1) (occ_def (remove_last a) e))))) :pattern ((occ_def a e))))))
(assert (forall ((a us_t)) (forall ((e Int)) (! (=> (and (dynamic_invariant4 a true true true true) (dynamic_invariant2 e true true true true)) (let ((result (occ a e))) (and (<= result (length a)) (dynamic_invariant7 result true false true true)))) :pattern ((occ a e))))))
(assert (forall ((a us_t)) (forall ((e Int)) (! (=> (and (dynamic_invariant4 a true true true true) (dynamic_invariant2 e true true true true)) (= (occ a e) (occ_def a e))) :pattern ((occ a e))))))
...
(declare-const temp___289 (Array Int natural))
(declare-const temp___2891 t2)
...
(assert (= (slide values (to_rep1 values__first) (to_rep1 values__first)) sort__swap__init__assume))
(assert (= (mk1 (to_rep1 values__first) (to_rep1 values__last)) sort__swap__init__assume1))
(assert (= (mk___t1 sort__swap__init__assume sort__swap__init__assume1) init))
(assert (dynamic_invariant5 init true false true true))
(assert (and (dynamic_property4 (to_rep1 values__first) (to_rep1 values__last) (to_rep1 interm__first) (to_rep1 interm__last)) (and (= (to_rep1 interm__first) (to_rep1 values__first)) (= (to_rep1 interm__last) (to_rep1 values__last)))))
...
(assert (= values1 o8))
(assert (= (is_set (mk___t (elts1 init) (mk (to_rep1 (first2 (rt1 init))) (to_rep1 (last2 (rt1 init))))) x (to_rep (select (elts1 init) y)) (mk___t values1 (mk (to_rep1 values__first) (to_rep1 values__last)))) true))
(assert (= (slide values1 (to_rep1 values__first) (to_rep1 values__first)) temp___289))
(assert (= (mk2 (to_rep1 values__first) (to_rep1 values__last)) temp___2891))
(assert (= (ite (<= (to_rep1 (first4 temp___2891)) (to_rep1 (last4 temp___2891))) (+ (- (to_rep1 (last4 temp___2891)) (to_rep1 (first4 temp___2891))) 1) 0) (ite (<= (to_rep1 interm__first) (to_rep1 interm__last)) (+ (- (to_rep1 interm__last) (to_rep1 interm__first)) 1) 0)))
(assert (= (mk___t2 o9 o10) (mk___t2 temp___289 temp___2891)))
(assert (= o11 o9))
...
(assert (= values2 o15))
(assert (= (is_set (mk___t interm1 (mk (to_rep1 interm__first) (to_rep1 interm__last))) y (to_rep (select (elts1 init) x)) (mk___t values2 (mk (to_rep1 values__first) (to_rep1 values__last)))) true))
(assert (= (is_perm (mk___t (elts1 init) (mk (to_rep1 (first2 (rt1 init))) (to_rep1 (last2 (rt1 init))))) (mk___t values2 (mk (to_rep1 values__first) (to_rep1 values__last)))) true))
