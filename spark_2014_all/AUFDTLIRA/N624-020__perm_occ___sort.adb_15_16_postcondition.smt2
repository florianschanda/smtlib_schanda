...
(define-fun dynamic_invariant3 ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= 1 100)) (in_range4 temp___expr_136)))
(define-fun dynamic_invariant4 ((temp___expr_142 us_t) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (not (= temp___skip_constant_140 true)) (dynamic_property 1 100 (first1 temp___expr_142) (last1 temp___expr_142))))
(assert true)
...
(define-fun bool_eq2 ((x1 us_t1) (y1 us_t1)) Bool (bool_eq (elts1 x1) (to_rep1 (first2 (rt1 x1))) (to_rep1 (last2 (rt1 x1))) (elts1 y1) (to_rep1 (first2 (rt1 y1))) (to_rep1 (last2 (rt1 y1)))))
...
(define-fun dynamic_invariant5 ((temp___expr_192 us_t1) (temp___is_init_189 Bool) (temp___skip_constant_190 Bool) (temp___do_toplevel_191 Bool)) Bool (=> (not (= temp___skip_constant_190 true)) (and (dynamic_property2 (to_rep1 values__first) (to_rep1 values__last) (first3 temp___expr_192) (last3 temp___expr_192)) (and (= (first3 temp___expr_192) (to_rep1 values__first)) (= (last3 temp___expr_192) (to_rep1 values__last))))))
...
(define-fun bool_eq3 ((x1 us_t2) (y1 us_t2)) Bool (bool_eq (elts2 x1) (to_rep1 (first4 (rt2 x1))) (to_rep1 (last4 (rt2 x1))) (elts2 y1) (to_rep1 (first4 (rt2 y1))) (to_rep1 (last4 (rt2 y1)))))
...
(define-fun dynamic_invariant6 ((temp___expr_201 us_t2) (temp___is_init_198 Bool) (temp___skip_constant_199 Bool) (temp___do_toplevel_200 Bool)) Bool (=> (not (= temp___skip_constant_199 true)) (and (dynamic_property4 (to_rep1 values__first) (to_rep1 values__last) (first5 temp___expr_201) (last5 temp___expr_201)) (and (= (first5 temp___expr_201) (to_rep1 values__first)) (= (last5 temp___expr_201) (to_rep1 values__last))))))
...
(define-fun dynamic_invariant7 ((temp___expr_147 Int) (temp___is_init_144 Bool) (temp___skip_constant_145 Bool) (temp___do_toplevel_146 Bool)) Bool (=> (or (= temp___is_init_144 true) (<= 0 100)) (in_range5 temp___expr_147)))
...
(define-fun bool_eq4 ((x1 us_t3) (y1 us_t3)) Bool (bool_eq (elts3 x1) (to_rep1 (first6 (rt3 x1))) (to_rep1 (last6 (rt3 x1))) (elts3 y1) (to_rep1 (first6 (rt3 y1))) (to_rep1 (last6 (rt3 y1)))))
...
(assert (forall ((a us_t)) (! (=> (and (dynamic_invariant4 a true true true) (< 0 (length a))) (dynamic_invariant4 (remove_last a) true false true)) :pattern ((remove_last a)))))
(assert (forall ((a us_t)) (! (=> (dynamic_invariant4 a true true true) (= (remove_last a) (let ((temp___159 (let ((temp___158 (- (last1 a) 1))) (let ((temp___157 (first1 a))) (of_array3 (to_array a) temp___157 temp___158))))) (of_array (to_array3 temp___159) (first7 temp___159) (last7 temp___159))))) :pattern ((remove_last a)))))
(declare-fun occ_def (us_t Int) Int)
(declare-fun occ_def__function_guard (Int us_t Int) Bool)
(assert (forall ((a us_t)) (forall ((e Int)) (! (=> (and (dynamic_invariant4 a true true true) (dynamic_invariant2 e true true true)) (= (occ_def a e) (ite (= (length a) 0) 0 (ite (= (to_rep (select (to_array a) (last1 a))) e) (+ (occ_def (remove_last a) e) 1) (occ_def (remove_last a) e))))) :pattern ((occ_def a e))))))
(assert (forall ((a us_t)) (forall ((e Int)) (! (=> (and (dynamic_invariant4 a true true true) (dynamic_invariant2 e true true true)) (let ((result (occ a e))) (and (<= result (length a)) (dynamic_invariant7 result true false true)))) :pattern ((occ a e))))))
(assert (forall ((a us_t)) (forall ((e Int)) (! (=> (and (dynamic_invariant4 a true true true) (dynamic_invariant2 e true true true)) (= (occ a e) (occ_def a e))) :pattern ((occ a e))))))
...
(assert (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 temp)) (and (and (and (= (slide values (to_rep1 values__first) (to_rep1 values__first)) sort__swap__init__assume) (= (mk1 (to_rep1 values__first) (to_rep1 values__last)) sort__swap__init__assume1)) (= (mk___t1 sort__swap__init__assume sort__swap__init__assume1) init)) (and (dynamic_invariant5 init true false true) (and (and (dynamic_property4 (to_rep1 values__first) (to_rep1 values__last) (to_rep1 interm__first) (to_rep1 interm__last)) (and (= (to_rep1 interm__first) (to_rep1 values__first)) (= (to_rep1 interm__last) (to_rep1 values__last)))) (and (and (and (and (and (and (<= (to_rep1 values__first) x) (<= x (to_rep1 values__last))) (= o x)) (= o1 (select values o))) (= o2 (to_rep o1))) (and (= (mk_int__ref result) (mk_int__ref temp)) (= temp1 o2))) (and (and (and (and (and (and (and (and (<= (to_rep1 values__first) y) (<= y (to_rep1 values__last))) (= o3 y)) (= o4 (select values o3))) (= o5 (to_rep o4))) (= (to_rep o6) o5)) (and (and (and (<= (to_rep1 values__first) x) (<= x (to_rep1 values__last))) (= o7 x)) (= o8 (store values o7 o6)))) (and (= (mk_map__ref result1) (mk_map__ref values)) (= values1 o8))) (and (= (is_set (mk___t (elts1 init) (mk (to_rep1 (first2 (rt1 init))) (to_rep1 (last2 (rt1 init))))) x (to_rep (select (elts1 init) y)) (mk___t values1 (mk (to_rep1 values__first) (to_rep1 values__last)))) true) (and (and (and (and (and (= (slide values1 (to_rep1 values__first) (to_rep1 values__first)) temp___258) (= (mk2 (to_rep1 values__first) (to_rep1 values__last)) temp___2581)) (and (= (ite (<= (to_rep1 (first4 temp___2581)) (to_rep1 (last4 temp___2581))) (+ (- (to_rep1 (last4 temp___2581)) (to_rep1 (first4 temp___2581))) 1) 0) (ite (<= (to_rep1 interm__first) (to_rep1 interm__last)) (+ (- (to_rep1 interm__last) (to_rep1 interm__first)) 1) 0)) (= (mk___t2 o13 o14) (mk___t2 temp___258 temp___2581)))) (= o15 o13)) (and (= (mk_map__ref result2) (mk_map__ref interm)) (= interm1 o15))) (and (and (and (and (and (= o16 temp1) (in_range2 temp1)) (= (to_rep o17) o16)) (and (and (and (<= (to_rep1 values__first) y) (<= y (to_rep1 values__last))) (= o18 y)) (= o19 (store values1 o18 o17)))) (and (= values1 result3) (= values2 o19))) (and (= (is_set (mk___t interm1 (mk (to_rep1 interm__first) (to_rep1 interm__last))) y (to_rep (select (elts1 init) x)) (mk___t values2 (mk (to_rep1 values__first) (to_rep1 values__last)))) true) (= (is_perm (mk___t (elts1 init) (mk (to_rep1 (first2 (rt1 init))) (to_rep1 (last2 (rt1 init))))) (mk___t values2 (mk (to_rep1 values__first) (to_rep1 values__last)))) true))))))))))) (and (and (= interm1 interm2) (and (= temp1 temp2) (= values2 values3))) (and (= interm3 interm1) (and (= temp3 temp1) (= values4 values2))))))
(assert (not (= (is_perm (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last))) (mk___t values3 (mk (to_rep1 values__first) (to_rep1 values__last)))) true)))
(check-sat)
(exit)
