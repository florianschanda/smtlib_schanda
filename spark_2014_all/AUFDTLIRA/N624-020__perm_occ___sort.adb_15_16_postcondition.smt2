...
(assert (= (slide values1 (to_rep1 values__first) (to_rep1 values__first)) temp___258))
(assert (= (mk2 (to_rep1 values__first) (to_rep1 values__last)) temp___2581))
(assert (= (ite (<= (to_rep1 (first4 temp___2581)) (to_rep1 (last4 temp___2581))) (+ (- (to_rep1 (last4 temp___2581)) (to_rep1 (first4 temp___2581))) 1) 0) (ite (<= (to_rep1 interm__first) (to_rep1 interm__last)) (+ (- (to_rep1 interm__last) (to_rep1 interm__first)) 1) 0)))
