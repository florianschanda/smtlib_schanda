...
(assert (not (= (ite (<= (to_rep1 (first8 temp___19431)) (to_rep1 (last8 temp___19431))) (+ (- (to_rep1 (last8 temp___19431)) (to_rep1 (first8 temp___19431))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 9) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 9)) 1) 0))))
(check-sat)
(exit)
