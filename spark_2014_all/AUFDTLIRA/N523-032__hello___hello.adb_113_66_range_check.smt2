...
(define-fun dynamic_invariant1 ((temp___expr_618 Int) (temp___is_init_614 Bool) (temp___skip_constant_615 Bool) (temp___do_toplevel_616 Bool) (temp___do_typ_inv_617 Bool)) Bool (=> (or (= temp___is_init_614 true) (<= 0 1)) (in_range3 temp___expr_618)))
...
(assert (forall ((us_void_param tuple0)) (! (= (to_rep (select (temp___String_Literal_654 us_void_param) 1)) 33) :pattern ((temp___String_Literal_654 us_void_param)))))
...
(declare-const temp___6551 t)
(declare-const o12 Int)
(declare-const o13 Int)
(declare-const o14 Int)
(declare-const o15 Int)
(declare-const o16 Int)
(define-fun temp___6532 () us_t (mk___t temp___653 temp___6531))
...
(assert (and (= temp___6532 (to_camel_case who)) (and (dynamic_invariant temp___6532 true false true true) (and (= (to_rep1 (first temp___6531)) (to_rep1 (first (rt who)))) (and (= (to_rep1 (last temp___6531)) (to_rep1 (last (rt who)))) (= (to_caml_char2 who temp___6532 (to_rep1 (last (rt who)))) true))))))
(assert (=> (= (length hello) 0) (= (elts prefix) temp___652)))
(assert (=> (= (length hello) 0) (= (mk (to_rep1 (first (rt prefix))) (to_rep1 (last (rt prefix)))) temp___6521)))
...
(assert (=> (not (= (length hello) 0)) (= (concat1 (elts hello) (to_rep1 (first (rt hello))) (to_rep1 (last (rt hello))) (elts prefix) (to_rep1 (first (rt prefix))) (to_rep1 (last (rt prefix)))) temp___652)))
(assert (=> (not (= (length hello) 0)) (= (mk (to_rep1 (first (rt hello))) o5) temp___6521)))
(assert (=> (= (length (mk___t temp___652 temp___6521)) 0) (= temp___653 temp___655)))
(assert (=> (= (length (mk___t temp___652 temp___6521)) 0) (= (mk (to_rep1 (first temp___6531)) (to_rep1 (last temp___6531))) temp___6551)))
(assert (=> (not (= (length (mk___t temp___652 temp___6521)) 0)) (=> (<= (to_rep1 (first temp___6531)) (to_rep1 (last temp___6531))) (= o6 (+ (- (to_rep1 (last temp___6531)) (to_rep1 (first temp___6531))) 1)))))
(assert (=> (not (= (length (mk___t temp___652 temp___6521)) 0)) (=> (not (<= (to_rep1 (first temp___6531)) (to_rep1 (last temp___6531)))) (= o6 0))))
(assert (=> (not (= (length (mk___t temp___652 temp___6521)) 0)) (=> (<= (to_rep1 (first temp___6521)) (to_rep1 (last temp___6521))) (= o7 (+ (- (to_rep1 (last temp___6521)) (to_rep1 (first temp___6521))) 1)))))
(assert (=> (not (= (length (mk___t temp___652 temp___6521)) 0)) (=> (not (<= (to_rep1 (first temp___6521)) (to_rep1 (last temp___6521)))) (= o7 0))))
(assert (=> (not (= (length (mk___t temp___652 temp___6521)) 0)) (= o8 (+ o7 o6))))
(assert (=> (not (= (length (mk___t temp___652 temp___6521)) 0)) (= o9 (+ (to_rep1 (first temp___6521)) o8))))
(assert (=> (not (= (length (mk___t temp___652 temp___6521)) 0)) (= o10 (- o9 1))))
(assert (=> (not (= (length (mk___t temp___652 temp___6521)) 0)) (and (= o11 o10) (in_range1 o10))))
(assert (=> (not (= (length (mk___t temp___652 temp___6521)) 0)) (= (concat1 temp___652 (to_rep1 (first temp___6521)) (to_rep1 (last temp___6521)) temp___653 (to_rep1 (first temp___6531)) (to_rep1 (last temp___6531))) temp___655)))
(assert (=> (not (= (length (mk___t temp___652 temp___6521)) 0)) (= (mk (to_rep1 (first temp___6521)) o11) temp___6551)))
(assert (not (= (length (mk___t temp___655 temp___6551)) 0)))
(assert (=> (<= 1 1) (= o12 (+ (- 1 1) 1))))
(assert (=> (not (<= 1 1)) (= o12 0)))
(assert (=> (<= (to_rep1 (first temp___6551)) (to_rep1 (last temp___6551))) (= o13 (+ (- (to_rep1 (last temp___6551)) (to_rep1 (first temp___6551))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___6551)) (to_rep1 (last temp___6551)))) (= o13 0)))
(assert (= o14 (+ o13 o12)))
(assert (= o15 (+ (to_rep1 (first temp___6551)) o14)))
(assert (= o16 (- o15 1)))
