...
(define-fun dynamic_invariant1 ((temp___expr_546 Int) (temp___is_init_543 Bool) (temp___skip_constant_544 Bool) (temp___do_toplevel_545 Bool)) Bool (=> (or (= temp___is_init_543 true) (<= 0 1)) (in_range3 temp___expr_546)))
...
(assert (forall ((us_void_param tuple0)) (! (= (to_rep (select (temp___String_Literal_579 us_void_param) 1)) 33) :pattern ((temp___String_Literal_579 us_void_param)))))
...
(assert (and (= (mk___t temp___578 temp___5781) (to_camel_case who)) (and (dynamic_invariant (mk___t temp___578 temp___5781) true false true) (and (= (to_rep1 (first temp___5781)) (to_rep1 (first (rt who)))) (and (= (to_rep1 (last temp___5781)) (to_rep1 (last (rt who)))) (= (to_caml_char2 who (mk___t temp___578 temp___5781) (to_rep1 (last (rt who)))) true))))))
(assert (=> (= (length hello) 0) (= (elts prefix) temp___577)))
(assert (=> (= (length hello) 0) (= (mk (to_rep1 (first (rt prefix))) (to_rep1 (last (rt prefix)))) temp___5771)))
...
(assert (=> (not (= (length hello) 0)) (= (concat1 (elts hello) (to_rep1 (first (rt hello))) (to_rep1 (last (rt hello))) (elts prefix) (to_rep1 (first (rt prefix))) (to_rep1 (last (rt prefix)))) temp___577)))
(assert (=> (not (= (length hello) 0)) (= (mk (to_rep1 (first (rt hello))) o5) temp___5771)))
(assert (=> (= (length (mk___t temp___577 temp___5771)) 0) (= temp___578 temp___580)))
(assert (=> (= (length (mk___t temp___577 temp___5771)) 0) (= (mk (to_rep1 (first temp___5781)) (to_rep1 (last temp___5781))) temp___5801)))
(assert (=> (not (= (length (mk___t temp___577 temp___5771)) 0)) (=> (<= (to_rep1 (first temp___5781)) (to_rep1 (last temp___5781))) (= o6 (+ (- (to_rep1 (last temp___5781)) (to_rep1 (first temp___5781))) 1)))))
(assert (=> (not (= (length (mk___t temp___577 temp___5771)) 0)) (=> (not (<= (to_rep1 (first temp___5781)) (to_rep1 (last temp___5781)))) (= o6 0))))
(assert (=> (not (= (length (mk___t temp___577 temp___5771)) 0)) (=> (<= (to_rep1 (first temp___5771)) (to_rep1 (last temp___5771))) (= o7 (+ (- (to_rep1 (last temp___5771)) (to_rep1 (first temp___5771))) 1)))))
(assert (=> (not (= (length (mk___t temp___577 temp___5771)) 0)) (=> (not (<= (to_rep1 (first temp___5771)) (to_rep1 (last temp___5771)))) (= o7 0))))
(assert (=> (not (= (length (mk___t temp___577 temp___5771)) 0)) (= o8 (+ o7 o6))))
(assert (=> (not (= (length (mk___t temp___577 temp___5771)) 0)) (= o9 (+ (to_rep1 (first temp___5771)) o8))))
(assert (=> (not (= (length (mk___t temp___577 temp___5771)) 0)) (= o10 (- o9 1))))
(assert (=> (not (= (length (mk___t temp___577 temp___5771)) 0)) (and (= o11 o10) (in_range1 o10))))
(assert (=> (not (= (length (mk___t temp___577 temp___5771)) 0)) (= (concat1 temp___577 (to_rep1 (first temp___5771)) (to_rep1 (last temp___5771)) temp___578 (to_rep1 (first temp___5781)) (to_rep1 (last temp___5781))) temp___580)))
(assert (=> (not (= (length (mk___t temp___577 temp___5771)) 0)) (= (mk (to_rep1 (first temp___5771)) o11) temp___5801)))
(assert (not (= (length (mk___t temp___580 temp___5801)) 0)))
...
(assert (= o14 (+ o13 o12)))
(assert (= o15 (+ (to_rep1 (first temp___5801)) o14)))
(assert (= o16 (- o15 1)))
