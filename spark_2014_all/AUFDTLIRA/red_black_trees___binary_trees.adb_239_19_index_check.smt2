...
(assert (and (<= 1 j9) (<= j9 100)))
(assert (= o55 j9))
(assert (= o56 (select (rec__binary_trees__forest__c (us_split_fields5 f)) o55)))
(assert (= o57 (us_split_fields3 o56)))
(assert (= o58 (rec__binary_trees__cell__parent o57)))
(assert (= temp___606 (to_rep o58)))
(assert (and (<= 1 temp___606) (<= temp___606 100)))
(assert (= o59 temp___606))
(assert (= o60 (select r5 o59)))
(assert (= o61 (us_split_fields1 o60)))
(assert (= o62 (rec__tree_model__path_type__a o61)))
(assert (and (= o63 (add o62 1)) (and (= (length o63) (+ (length o62) 1)) (and (= (get o63 (last o63)) 1) (= (ole o62 o63) true)))))
(assert (= o64 (mk___split_fields o63 (rec__tree_model__path_type__k (us_split_fields1 (select r5 j9))))))
(assert (= temp___608 (mk___rep o64)))
(assert (< (length (rec__tree_model__path_type__a (us_split_fields1 temp___608))) 100))
(assert (= o65 temp___608))
(assert (not (<= 1 j9)))
(check-sat)
(exit)
