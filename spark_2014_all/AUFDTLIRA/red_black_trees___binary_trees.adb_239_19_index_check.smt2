...
(assert (and (<= 1 j2) (<= j2 100)))
(assert (= o48 j2))
(assert (= o49 (select (rec__binary_trees__forest__c (us_split_fields5 f)) o48)))
(assert (= o50 (us_split_fields3 o49)))
(assert (= o51 (rec__binary_trees__cell__parent o50)))
(assert (= temp___606 (to_rep o51)))
(assert (and (<= 1 temp___606) (<= temp___606 100)))
(assert (= o52 temp___606))
(assert (= o53 (select r5 o52)))
(assert (= o54 (us_split_fields1 o53)))
(assert (= o55 (rec__tree_model__path_type__a o54)))
(assert (and (= o56 (add o55 1)) (and (= (length o56) (+ (length o55) 1)) (and (= (get o56 (last o56)) 1) (= (ole o55 o56) true)))))
(assert (= o57 (mk___split_fields o56 (rec__tree_model__path_type__k (us_split_fields1 (select r5 j2))))))
(assert (= temp___608 (mk___rep o57)))
(assert (< (length (rec__tree_model__path_type__a (us_split_fields1 temp___608))) 100))
(assert (= o58 temp___608))
(assert (not (<= 1 j2)))
(check-sat)
(exit)
