...
(assert (<= i2 100))
(assert (not (= i2 x1)))
(assert (and (= o24 (parent (rec__red_black_trees__rbt__struct t__split_fields6) i2)) (and (in_range3 o24) (and (= o24 (parent1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields6))) i2)) (=> (= (size (rec__red_black_trees__rbt__struct t__split_fields6)) 0) (= o24 0))))))
(assert (= result15 (ite (= o24 0) true false)))
(assert (not (= result15 true)))
(assert (and (= temp___622 (parent (rec__red_black_trees__rbt__struct t__split_fields6) i2)) (and (in_range3 temp___622) (and (= temp___622 (parent1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields6))) i2)) (=> (= (size (rec__red_black_trees__rbt__struct t__split_fields6)) 0) (= temp___622 0))))))
(assert (not (<= 1 temp___622)))
(check-sat)
(exit)
