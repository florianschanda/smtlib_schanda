...
(assert (<= i 100))
(assert (not (= i x1)))
(assert (and (= o4 (parent (rec__red_black_trees__rbt__struct t__split_fields6) i)) (and (in_range3 o4) (and (= o4 (parent1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields6))) i)) (=> (= (size (rec__red_black_trees__rbt__struct t__split_fields6)) 0) (= o4 0))))))
(assert (= result3 (ite (= o4 0) true false)))
(assert (not (= result3 true)))
(assert (and (= temp___622 (parent (rec__red_black_trees__rbt__struct t__split_fields6) i)) (and (in_range3 temp___622) (and (= temp___622 (parent1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields6))) i)) (=> (= (size (rec__red_black_trees__rbt__struct t__split_fields6)) 0) (= temp___622 0))))))
