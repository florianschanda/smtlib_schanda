...
(assert (= my_s13 (p__B19b__my_s1__aggregate_def 1 2 3)))
(assert (= (mk_map__ref result1) (mk_map__ref my_s2)))
(assert (= my_s23 (slide my_s13 1 2)))
(assert (= (to_rep (select my_s23 2)) 1))
(assert (= (mk_map__ref result2) (mk_map__ref my_s11)))
(assert (= my_s14 (p__B22b__my_s1__aggregate_def 1 2 3)))
...
(assert (= my_s15 (p__B25b__my_s1__aggregate_def 1 2 3)))
(assert (= (mk_map__ref result5) (mk_map__ref my_s22)))
(assert (= my_s25 (slide my_s15 1 2)))
(assert (not (= (to_rep (select my_s25 2)) 2)))
(check-sat)
(exit)
