...
(assert (=> (= (to_rep (rec__database__availability__account_link__prev (us_split_fields1 (select links account)))) 0) (= links2 links)))
(assert (=> (= (to_rep (rec__database__availability__account_link__prev (us_split_fields1 (select links account)))) 0) (= links2 links1)))
...
(assert (=> (= (to_rep (rec__database__availability__account_link__next (us_split_fields1 (select links2 account)))) 0) (= links3 links2)))
...
(assert (=> (= first_available 0) (= links4 links3)))
