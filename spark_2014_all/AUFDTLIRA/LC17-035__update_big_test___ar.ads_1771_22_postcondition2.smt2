...
(declare-const temp___9351 (Array Int us_rep))
(declare-const temp___93511 Bool)
(declare-const temp___93512 enum1t)
...
(assert (= temp___9351 o6))
(assert (= temp___93511 o7))
(assert (= temp___93512 o8))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= result2 r__split_fields2))
(assert (= temp___9351 r__split_fields3))
(assert (= temp___93511 r__split_fields4))
(assert (= temp___93512 r__split_fields5))
...
(assert (<= n 10))
(assert (not (= n i)))
(assert (not (= (bool_eq (select r__split_fields6 n) (select r__split_fields n)) true)))
(check-sat)
(exit)
