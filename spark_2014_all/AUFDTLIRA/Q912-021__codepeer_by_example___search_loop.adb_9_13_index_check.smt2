...
(declare-const search_loop__result Int)
(declare-const search_loop__result1 Int)
(declare-const result1 Bool)
(declare-const search_loop__result2 Int)
(assert (in_range y))
(assert (= result j))
(assert (= j1 1))
(assert (in_range j1))
(assert (=> (<= (- 2147483648) 2147483647) (in_range j2)))
(assert (not (< 10 j2)))
(assert (= search_loop__result1 search_loop__result))
(assert (not (<= 1 j2)))
(check-sat)
(exit)
