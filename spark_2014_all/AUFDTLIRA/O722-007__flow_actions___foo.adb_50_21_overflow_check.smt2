...
(declare-const temp___170 (Array Int character))
(declare-const temp___1701 t1)
...
(assert (=> (= b1 true) (= o1 (bool_eq temp___172 (to_rep1 (first temp___1721)) (to_rep1 (last temp___1721)) new_sub 1 5))))
(assert (=> (= b1 true) (= result2 (ite (not (= o1 true)) true false))))
(assert (=> (not (= b1 true)) (= result2 false)))
(assert (= result2 true))
(assert (not (in_range1 (+ pos1 1))))
(check-sat)
(exit)
