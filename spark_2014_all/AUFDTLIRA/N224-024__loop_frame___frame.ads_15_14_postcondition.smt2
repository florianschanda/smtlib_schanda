...
(assert (= j1 1))
(assert (=> (and (<= 1 j1) (<= j1 10)) (and (and (= temp___190 a) (and (= temp___189 j1) (and (= temp___192 a) (and (and (and (and (and (= (to_rep o) (to_rep (rec__frame__rec__c2 (us_split_fields1 (select a j1))))) (and (= o o1) (= (rec__frame__rec__c2 (us_split_fields1 (select a j1))) o2))) (and (= o3 o1) (= o4 o2))) (= o5 (store a j1 (mk___rep (mk___split_fields o3 o4))))) (and (= (mk_map__ref result1) (mk_map__ref a)) (= a2 o5))) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 j2)) (= (to_rep (rec__frame__rec__c1 (us_split_fields1 (select a3 k1)))) (to_rep (rec__frame__rec__c2 (us_split_fields1 (select temp___192 k1))))))) (and (and (and (=> (<= 1 10) (in_range2 j2)) (forall ((temp___191 Int)) (=> (and (<= 1 temp___191) (<= temp___191 10)) (ite (< j2 temp___191) (= (select a3 temp___191) (select temp___190 temp___191)) (= (rec__frame__rec__c2 (us_split_fields1 (select a3 temp___191))) (rec__frame__rec__c2 (us_split_fields1 (select temp___190 temp___191)))))))) (and (<= 1 j2) (<= j2 10))) (= j2 10))))))) (and (and (= j2 j6) (= a3 a7)) (and (= j7 j2) (= a8 a3))))))
(assert (=> (and (<= 1 j1) (<= j1 10)) (= (mk_int__ref j8) (mk_int__ref j6))))
(assert (=> (and (<= 1 j1) (<= j1 10)) (= (mk_map__ref a9) (mk_map__ref a7))))
(assert (=> (and (<= 1 j1) (<= j1 10)) (= j9 j7)))
(assert (=> (and (<= 1 j1) (<= j1 10)) (= a10 a8)))
(assert (=> (not (and (<= 1 j1) (<= j1 10))) (= j1 j8)))
(assert (=> (not (and (<= 1 j1) (<= j1 10))) (= (mk_map__ref a9) (mk_map__ref a))))
(assert (=> (not (and (<= 1 j1) (<= j1 10))) (= j9 j1)))
(assert (=> (not (and (<= 1 j1) (<= j1 10))) (= a10 a1)))
(assert (= j10 (mk_int__ref j8)))
(assert (= a11 (mk_map__ref a9)))
(assert (= j11 j9))
(assert (= a12 a10))
(declare-const j12 Int)
(assert (<= 1 j12))
(assert (<= j12 10))
(assert (not (= (to_rep (rec__frame__rec__c1 (us_split_fields1 (select (map__content a11) j12)))) (to_rep (rec__frame__rec__c2 (us_split_fields1 (select a j12)))))))
(check-sat)
(exit)
