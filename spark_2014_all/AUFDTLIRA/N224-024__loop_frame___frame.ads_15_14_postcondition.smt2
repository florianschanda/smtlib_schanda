...
(declare-const temp___220 (Array Int us_rep))
...
(assert (=> (and (<= 1 j1) (<= j1 10)) (= temp___217 j1)))
(assert (=> (and (<= 1 j1) (<= j1 10)) (= temp___220 a)))
...
(assert (=> (and (<= 1 j1) (<= j1 10)) (forall ((k Int)) (=> (and (<= 1 k) (<= k j2)) (= (to_rep (rec__frame__rec__c1 (us_split_fields1 (select a3 k)))) (to_rep (rec__frame__rec__c2 (us_split_fields1 (select temp___220 k)))))))))
(assert (=> (and (<= 1 j1) (<= j1 10)) (and (and (=> (<= 1 10) (in_range2 j2)) (forall ((temp___219 Int)) (=> (and (<= 1 temp___219) (<= temp___219 10)) (ite (or (< 10 temp___219) (or (< temp___219 1) (< j2 temp___219))) (= (select a3 temp___219) (select temp___218 temp___219)) (= (rec__frame__rec__c2 (us_split_fields1 (select a3 temp___219))) (rec__frame__rec__c2 (us_split_fields1 (select temp___218 temp___219)))))))) (and (<= 1 j2) (<= j2 10)))))
