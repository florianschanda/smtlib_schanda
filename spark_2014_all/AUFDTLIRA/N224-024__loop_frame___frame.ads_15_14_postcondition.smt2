...
(assert (=> (and (<= 1 j1) (<= j1 10)) (forall ((k Int)) (=> (and (<= 1 k) (<= k j2)) (= (to_rep (rec__frame__rec__c1 (us_split_fields1 (select a3 k)))) (to_rep (rec__frame__rec__c2 (us_split_fields1 (select temp___192 k)))))))))
(assert (=> (and (<= 1 j1) (<= j1 10)) (and (and (=> (<= 1 10) (in_range2 j2)) (forall ((temp___191 Int)) (=> (and (<= 1 temp___191) (<= temp___191 10)) (ite (< j2 temp___191) (= (select a3 temp___191) (select temp___190 temp___191)) (= (rec__frame__rec__c2 (us_split_fields1 (select a3 temp___191))) (rec__frame__rec__c2 (us_split_fields1 (select temp___190 temp___191)))))))) (and (<= 1 j2) (<= j2 10)))))
