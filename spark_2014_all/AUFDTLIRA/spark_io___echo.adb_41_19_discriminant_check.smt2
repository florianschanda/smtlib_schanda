...
(assert (and (and (and (and (and (= (is_readable standard_input2) true) (= (let ((temp___714 (name standard_input1))) (let ((temp___713 (name standard_input2))) (bool_eq (elts temp___713) (to_rep1 (first (rt temp___713))) (to_rep1 (last (rt temp___713))) (elts temp___714) (to_rep1 (first (rt temp___714))) (to_rep1 (last (rt temp___714)))))) true)) (= (let ((temp___716 (form standard_input1))) (let ((temp___715 (form standard_input2))) (bool_eq (elts temp___715) (to_rep1 (first (rt temp___715))) (to_rep1 (last (rt temp___715))) (elts temp___716) (to_rep1 (first (rt temp___716))) (to_rep1 (last (rt temp___716)))))) true)) (= (is_standard_file standard_input2) true)) (= (is_standard_input standard_input2) true)) (=> (= (to_rep2 c__split_discrs1) 1) (= (status standard_input2) 1))))
