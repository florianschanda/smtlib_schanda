...
(assert (and (and (and (and (and (= (is_readable standard_input2) true) (= (let ((temp___720 (name standard_input1))) (let ((temp___719 (name standard_input2))) (bool_eq (elts temp___719) (to_rep1 (first (rt temp___719))) (to_rep1 (last (rt temp___719))) (elts temp___720) (to_rep1 (first (rt temp___720))) (to_rep1 (last (rt temp___720)))))) true)) (= (let ((temp___722 (form standard_input1))) (let ((temp___721 (form standard_input2))) (bool_eq (elts temp___721) (to_rep1 (first (rt temp___721))) (to_rep1 (last (rt temp___721))) (elts temp___722) (to_rep1 (first (rt temp___722))) (to_rep1 (last (rt temp___722)))))) true)) (= (is_standard_file standard_input2) true)) (= (is_standard_input standard_input2) true)) (=> (= (to_rep2 c__split_discrs1) 1) (= (status standard_input2) 1))))
(assert (= (to_rep2 c__split_discrs1) 1))
(assert (and (= o1 (status standard_output1)) (in_range3 o1)))
