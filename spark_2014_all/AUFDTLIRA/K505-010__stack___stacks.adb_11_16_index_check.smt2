...
(define-fun dynamic_invariant1 ((temp___expr_167 Int) (temp___is_init_163 Bool) (temp___skip_constant_164 Bool) (temp___do_toplevel_165 Bool) (temp___do_typ_inv_166 Bool)) Bool (=> (or (= temp___is_init_163 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_167)))
...
(define-fun dynamic_invariant2 ((temp___expr_180 us_rep) (temp___is_init_176 Bool) (temp___skip_constant_177 Bool) (temp___do_toplevel_178 Bool) (temp___do_typ_inv_179 Bool)) Bool (let ((temp___181 (rec__stacks__stack__max (us_split_discrs1 temp___expr_180)))) (and (dynamic_property1 1 (to_rep3 temp___181) (first1 (rec__stacks__stack__data (us_split_fields1 temp___expr_180))) (last1 (rec__stacks__stack__data (us_split_fields1 temp___expr_180)))) (and (= (first1 (rec__stacks__stack__data (us_split_fields1 temp___expr_180))) 1) (= (last1 (rec__stacks__stack__data (us_split_fields1 temp___expr_180))) (to_rep3 temp___181))))))
...
(assert (forall ((s us_rep)) (! (=> (dynamic_invariant2 s true true true true) (dynamic_invariant3 (size s) true false true true)) :pattern ((size s)))))
(assert (forall ((attr__tag1 Int)) (forall ((s us_rep)) (! (=> (dynamic_invariant2 s true true true true) (dynamic_invariant3 (size1 attr__tag1 s) true false true true)) :pattern ((size1 attr__tag1 s))))))
(assert (forall ((s us_rep)) (! (= (size s) (size1 us_tag s)) :pattern ((size1 us_tag s)))))
(assert (forall ((s us_rep)) (! (=> (dynamic_invariant2 s true true true true) (= (size s) (to_rep (rec__stacks__stack__top (us_split_fields1 s))))) :pattern ((size s)))))
...
(assert (dynamic_invariant2 (mk___rep s__split_discrs (mk___split_fields s__split_fields (mk___t s__split_fields1 s__split_fields2) s__split_fields3) s__attr__tag) true false true true))
(assert (in_range3 e))
