...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep3 (rec__stacks__stack__max (us_split_discrs1 a))) (to_rep3 (rec__stacks__stack__max (us_split_discrs1 b)))) (and (= (to_rep (rec__stacks__stack__top (us_split_fields1 a))) (to_rep (rec__stacks__stack__top (us_split_fields1 b)))) (= (bool_eq1 (rec__stacks__stack__data (us_split_fields1 a)) (rec__stacks__stack__data (us_split_fields1 b))) true))) true false))
...
(declare-const o12 (Array Int element))
(declare-const o13 t)
(declare-const o14 us_private)
(declare-const temp___214 positive)
(declare-const temp___2141 natural)
(declare-const temp___2142 (Array Int element))
(declare-const temp___2143 t)
(declare-const temp___2144 us_private)
(declare-const temp___2145 Int)
(declare-const mystate1 Int)
(declare-const s__split_fields4 natural)
(declare-const s__split_fields5 (Array Int element))
(declare-const s__split_fields6 t)
...
(assert (= s__split_fields8 (mk___split_fields temp___2101 (mk___t temp___2102 temp___2103) temp___2104)))
(assert (= s__split_discrs (mk___split_discrs temp___210)))
(assert (= (to_rep1 o6) e))
(assert (not (<= (to_rep2 (first (rt (rec__stacks__stack__data s__split_fields8)))) (to_rep (rec__stacks__stack__top s__split_fields8)))))
(check-sat)
(exit)
