...
(assert (=> (= result2 true) (and (<= (to_rep2 (first (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))) i2) (<= i2 (to_rep2 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a)))))))))
(assert (=> (= result2 true) (= o6 i2)))
(assert (=> (= result2 true) (= o7 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) o6))))
(assert (=> (= result2 true) (= o8 (to_rep1 o7))))
(assert (=> (= result2 true) (= res2 result3)))
(assert (=> (= result2 true) (= res3 o8)))
(assert (=> (not (= result2 true)) (= res3 res2)))
(assert (not (= i2 r25b)))
(assert (= result4 i2))
(assert (= i3 (+ i2 1)))
...
(assert (<= 1 j3))
(assert (<= j3 (- i3 1)))
(assert (not (<= res3 (to_rep1 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) j3)))))
(check-sat)
(exit)
