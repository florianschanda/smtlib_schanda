...
(assert (and (<= (to_rep1 (first (rt source))) temp___2132) (<= temp___2132 (to_rep1 (last (rt source))))))
(assert (= o4 temp___2132))
(assert (= o5 (select (elts source) o4)))
(assert (= o6 (to_rep o5)))
(assert (= o7 (ite (= o6 48) true false)))
(assert (and (= temp___2131 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (<= (to_rep1 (first (rt source))) temp___2131) (<= temp___2131 (to_rep1 (last (rt source))))))
(assert (= o temp___2131))
