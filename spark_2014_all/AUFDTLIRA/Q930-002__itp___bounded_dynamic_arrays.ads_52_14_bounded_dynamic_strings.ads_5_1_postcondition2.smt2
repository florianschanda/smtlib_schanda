...
(declare-const bounded_dynamic_strings__value__result (Array Int character))
(declare-const bounded_dynamic_strings__value__result1 t1)
(declare-const o (Array Int character))
(declare-const temp___923 (Array Int character))
(declare-const temp___9231 t2)
(declare-const o1 (Array Int character))
(declare-const o2 t1)
(declare-const result (Array Int character))
(declare-const result1 t1)
(declare-const bounded_dynamic_strings__value__result2 (Array Int character))
(declare-const bounded_dynamic_strings__value__result3 t1)
(declare-const bounded_dynamic_strings__value__result4 (Array Int character))
(declare-const bounded_dynamic_strings__value__result5 t1)
(declare-const bounded_dynamic_strings__value__result6 (Array Int character))
(declare-const bounded_dynamic_strings__value__result7 t1)
(declare-const bounded_dynamic_strings__value__result8 (Array Int character))
(declare-const bounded_dynamic_strings__value__result9 t1)
(declare-const bounded_dynamic_strings__value__result10 (Array Int character))
(declare-const bounded_dynamic_strings__value__result11 t1)
(define-fun bounded_dynamic_strings__value__result12 () us_t1 (mk___t1 bounded_dynamic_strings__value__result6 bounded_dynamic_strings__value__result7))
(define-fun bounded_dynamic_strings__value__result13 () us_t1 (mk___t1 bounded_dynamic_strings__value__result2 bounded_dynamic_strings__value__result3))
...
(assert (= bounded_dynamic_strings__value__result4 bounded_dynamic_strings__value__result2))
(assert (= bounded_dynamic_strings__value__result5 bounded_dynamic_strings__value__result3))
(assert (= bounded_dynamic_strings__value__result12 bounded_dynamic_strings__value__result13))
(assert (=> (<= 1 (to_rep (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 this)))) (and (and (<= (to_rep2 (first (rt (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 this))))) 1) (<= 1 (to_rep2 (last (rt (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 this))))))) (and (<= (to_rep2 (first (rt (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 this))))) (to_rep (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 this)))) (<= (to_rep (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 this))) (to_rep2 (last (rt (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 this))))))))))
(assert (= o (elts (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 this)))))
(assert (= o temp___923))
(assert (= (mk2 1 (to_rep (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 this)))) temp___9231))
(assert (dynamic_property2 1 2147483647 (to_rep2 (first4 temp___9231)) (to_rep2 (last4 temp___9231))))
(assert (= temp___923 o1))
(assert (= (mk1 (to_rep2 (first4 temp___9231)) (to_rep2 (last4 temp___9231))) o2))
(assert (= (mk_list__ref (mk___t1 result result1)) (mk_list__ref (mk___t1 bounded_dynamic_strings__value__result bounded_dynamic_strings__value__result1))))
(assert (= bounded_dynamic_strings__value__result13 (mk___t1 o1 o2)))
(assert (= (mk_list__ref (mk___t1 bounded_dynamic_strings__value__result8 bounded_dynamic_strings__value__result9)) (mk_list__ref (mk___t1 bounded_dynamic_strings__value__result4 bounded_dynamic_strings__value__result5))))
(assert (= (mk___t1 bounded_dynamic_strings__value__result10 bounded_dynamic_strings__value__result11) bounded_dynamic_strings__value__result12))
(assert (= result2 bounded_dynamic_strings__value__result8))
(assert (= result3 bounded_dynamic_strings__value__result9))
(assert (not (= (length2 (mk___t1 bounded_dynamic_strings__value__result8 bounded_dynamic_strings__value__result9)) (length1 this))))
(check-sat)
(exit)
