...
(assert (<= 1 i1))
(assert (<= i1 200000))
(assert (and (and (and (=> (<= 0 200000) (in_range1 tmp_prev1)) (=> (<= 0 200000) (in_range1 tmp_next1))) (forall ((temp___416 Int)) (=> (and (<= 1 temp___416) (<= temp___416 200000)) (=> (<= i2 temp___416) (= (select links1 temp___416) (select links temp___416)))))) (and (<= 1 i2) (<= i2 200000))))
