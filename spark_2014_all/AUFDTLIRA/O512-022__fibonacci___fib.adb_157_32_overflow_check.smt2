...
(assert (= i3 0))
(assert (=> (and (<= 0 i3) (<= i3 k)) (= temp___221 a1)))
(assert (=> (and (<= 0 i3) (<= i3 k)) (and (forall ((temp___222 Int)) (=> (and (<= 0 temp___222) (<= temp___222 100)) (=> (<= i4 temp___222) (= (select a12 temp___222) (select temp___221 temp___222))))) (and (<= 0 i4) (<= i4 k)))))
...
(assert (= i9 temp___228))
(assert (=> (and (<= temp___228 i9) (<= i9 100)) (= temp___226 a16)))
(assert (=> (and (<= temp___228 i9) (<= i9 100)) (and (forall ((temp___227 Int)) (=> (and (<= 0 temp___227) (<= temp___227 100)) (=> (<= i10 temp___227) (= (select a18 temp___227) (select temp___226 temp___227))))) (and (<= (+ k 1) i10) (<= i10 100)))))
(assert (=> (and (<= temp___228 i9) (<= i9 100)) (and (= temp___225 (- i10 k)) (in_range1 (- i10 k)))))
(assert (=> (and (<= temp___228 i9) (<= i9 100)) (and (<= 0 temp___225) (<= temp___225 100))))
(assert (=> (and (<= temp___228 i9) (<= i9 100)) (= o6 temp___225)))
(assert (=> (and (<= temp___228 i9) (<= i9 100)) (= o7 (select c1 o6))))
(assert (=> (and (<= temp___228 i9) (<= i9 100)) (= o8 (to_rep o7))))
(assert (=> (and (<= temp___228 i9) (<= i9 100)) (= (to_rep o9) o8)))
(assert (=> (and (<= temp___228 i9) (<= i9 100)) (and (<= 0 i10) (<= i10 100))))
(assert (=> (and (<= temp___228 i9) (<= i9 100)) (= o10 i10)))
(assert (=> (and (<= temp___228 i9) (<= i9 100)) (= o11 (store a18 o10 o9))))
(assert (=> (and (<= temp___228 i9) (<= i9 100)) (= a18 result3)))
(assert (=> (and (<= temp___228 i9) (<= i9 100)) (= a19 o11)))
(assert (=> (and (<= temp___228 i9) (<= i9 100)) (= i10 100)))
(assert (=> (and (<= temp___228 i9) (<= i9 100)) (= i10 i11)))
(assert (=> (and (<= temp___228 i9) (<= i9 100)) (= a19 a110)))
(assert (=> (and (<= temp___228 i9) (<= i9 100)) (= i12 i10)))
(assert (=> (and (<= temp___228 i9) (<= i9 100)) (= a111 a19)))
(assert (=> (and (<= temp___228 i9) (<= i9 100)) (= i13 (mk_int__ref i11))))
(assert (=> (and (<= temp___228 i9) (<= i9 100)) (= a114 (mk_map__ref a110))))
(assert (=> (and (<= temp___228 i9) (<= i9 100)) (= i14 i12)))
(assert (=> (and (<= temp___228 i9) (<= i9 100)) (= a113 a111)))
(assert (=> (not (and (<= temp___228 i9) (<= i9 100))) (= i13 (mk_int__ref i9))))
(assert (=> (not (and (<= temp___228 i9) (<= i9 100))) (= a114 a115)))
(assert (=> (not (and (<= temp___228 i9) (<= i9 100))) (= i14 i9)))
(assert (=> (not (and (<= temp___228 i9) (<= i9 100))) (= a113 a17)))
(assert (= result4 (mk_int__ref i2)))
(assert (= i15 0))
(assert (=> (and (<= 0 i15) (<= i15 k)) (= temp___230 a2)))
(assert (=> (and (<= 0 i15) (<= i15 k)) (and (forall ((temp___231 Int)) (=> (and (<= 0 temp___231) (<= temp___231 100)) (=> (<= i16 temp___231) (= (select a22 temp___231) (select temp___230 temp___231))))) (and (<= 0 i16) (<= i16 k)))))
