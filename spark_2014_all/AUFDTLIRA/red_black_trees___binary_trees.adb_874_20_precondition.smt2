...
(assert (and (= o310 p) (in_range1 p)))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))) true))
(assert (and (= o311 p) (in_range1 p)))
(assert (and (= o312 (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) o311)) (and (dynamic_invariant3 o312 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o312 o311))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select o312 o311)))) 0) (and (forall ((i15 Int)) (=> (and (<= 1 i15) (<= i15 100)) (=> (not (= i15 o311)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i15) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select o312 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i15)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select o312 i15))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select o312 i15))) true)))))) (and (forall ((i15 Int)) (=> (and (<= 1 i15) (<= i15 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o312 i15))) true) (not (= i15 o311))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select o312 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i15)))) (position (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i15) (rec__tree_model__path_type__a (us_split_fields1 (select o312 i15)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select o312 i15)))) 0)))) (forall ((i15 Int)) (=> (and (<= 1 i15) (<= i15 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select o312 i15))) true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o312 j2))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select o312 i15))) (rec__tree_model__path_type__a (us_split_fields1 (select o312 j2)))) true)) (= j2 i15))))))))))))))
(assert (and (= o308 p) (in_range1 p)))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o309 p) (in_range1 p)))
(assert (not (= (valid_root (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o309) true)))
(check-sat)
(exit)
