...
(assert (and (= o3 (elementt_image elementid)) (and (dynamic_invariant2 o3 true false true true) (= o3 (let ((temp___542 (to_string (attr__ATTRIBUTE_IMAGE4 elementid)))) (mk___t (elts1 temp___542) (mk (to_rep1 (first2 (rt1 temp___542))) (to_rep1 (last2 (rt1 temp___542))))))))))
...
(assert (= o2 temp___1783))
(assert (= (mk3 1 r46b) temp___17831))
(assert (not (= (ite (<= (to_rep1 (first6 temp___17811)) (to_rep1 (last6 temp___17811))) (+ (- (to_rep1 (last6 temp___17811)) (to_rep1 (first6 temp___17811))) 1) 0) (ite (<= (to_rep1 (first6 temp___17831)) (to_rep1 (last6 temp___17831))) (+ (- (to_rep1 (last6 temp___17831)) (to_rep1 (first6 temp___17831))) 1) 0))))
(check-sat)
(exit)
