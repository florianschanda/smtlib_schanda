...
(assert (= o2 temp___1629))
(assert (= (mk3 1 r46b) temp___16291))
(assert (not (= (ite (<= (to_rep1 (first6 temp___16271)) (to_rep1 (last6 temp___16271))) (+ (- (to_rep1 (last6 temp___16271)) (to_rep1 (first6 temp___16271))) 1) 0) (ite (<= (to_rep1 (first6 temp___16291)) (to_rep1 (last6 temp___16291))) (+ (- (to_rep1 (last6 temp___16291)) (to_rep1 (first6 temp___16291))) 1) 0))))
(check-sat)
(exit)
