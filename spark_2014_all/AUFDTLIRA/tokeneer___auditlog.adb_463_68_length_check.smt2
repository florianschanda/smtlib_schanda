...
(assert (= o2 temp___1573))
(assert (= (mk3 1 r46b) temp___15731))
(assert (not (= (ite (<= (to_rep1 (first6 temp___15711)) (to_rep1 (last6 temp___15711))) (+ (- (to_rep1 (last6 temp___15711)) (to_rep1 (first6 temp___15711))) 1) 0) (ite (<= (to_rep1 (first6 temp___15731)) (to_rep1 (last6 temp___15731))) (+ (- (to_rep1 (last6 temp___15731)) (to_rep1 (first6 temp___15731))) 1) 0))))
(check-sat)
(exit)
