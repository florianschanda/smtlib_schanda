...
(assert (= o34 v))
(assert (= o35 (select temp___1275 o34)))
(assert (= o36 (us_split_fields1 o35)))
(assert (= o37 (rec__tree_model__path_type__a o36)))
(assert (and (= result9 (ole o37 o40)) (= (= result9 true) (and (<= (length o37) (length o40)) (forall ((n12 Int)) (=> (and (<= 1 n12) (<= n12 (last o37))) (= (get o37 n12) (get o40 n12))))))))
