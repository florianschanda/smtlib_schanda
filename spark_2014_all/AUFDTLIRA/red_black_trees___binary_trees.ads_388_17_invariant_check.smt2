...
(assert (and (forall ((r Int)) (=> (and (<= 1 r) (<= r (to_rep f_old__split_fields2))) (=> (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f_old__split_fields3 r)))) 2) (= (oeq (model__ (mk___rep2 f_old__split_fields7) r) (model__ (mk___rep2 f__split_fields8) r)) true)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= i root1)) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 f__split_fields8) root1) i))) true)))))))
