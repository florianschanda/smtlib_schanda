...
(assert (= o114 i1))
(assert (= o115 (select (rec__patience__state__posstack (us_split_fields__content s__split_fields20)) o114)))
(assert (= o116 (to_rep1 o115)))
(assert (= o117 (ite (<= o116 (- (to_rep1 (rec__patience__state__numstacks (us_split_fields__content s__split_fields20))) 1)) true false)))
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o111 i1))
(assert (= o112 (select (rec__patience__state__posstack (us_split_fields__content s__split_fields20)) o111)))
(assert (= o113 (to_rep1 o112)))
(assert (= o118 (ite (<= 0 o113) true false)))
(assert (= result22 (ite (= o118 true) o117 false)))
...
(assert (and (<= 0 temp___651) (<= temp___651 99)))
(assert (= o107 temp___651))
(assert (= o108 (select (rec__patience__state__stacksizes (us_split_fields__content s__split_fields20)) o107)))
