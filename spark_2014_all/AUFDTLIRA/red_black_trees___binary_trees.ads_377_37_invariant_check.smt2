...
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= temp___938 (model__ (mk___rep2 (us_split_fields__content2 f__split_fields7)) root)) (and (dynamic_invariant2 temp___938 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___938 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___938 root)))) 0) (and (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (not (= i5 root)) (ite (and (not (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) i5) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___938 (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) i5)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___938 i5))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___938 i5))) true)))))) (and (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___938 i5))) true) (not (= i5 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___938 (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) i5)))) (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) i5) (rec__tree_model__path_type__a (us_split_fields1 (select temp___938 i5)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___938 i5)))) 0)))) (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___938 i5))) true) (forall ((j6 Int)) (=> (and (<= 1 j6) (<= j6 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___938 j6))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___938 i5))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___938 j6)))) true)) (= j6 i5))))))))))))))
(assert (= o51 (select temp___938 (int__content v2))))
(assert (= o52 (us_split_fields1 o51)))
(assert (= o53 (rec__tree_model__path_type__a o52)))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= temp___937 (model__ (mk___rep2 (us_split_fields__content2 f__split_fields7)) root)) (and (dynamic_invariant2 temp___937 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___937 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___937 root)))) 0) (and (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (not (= i5 root)) (ite (and (not (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) i5) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___937 (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) i5)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___937 i5))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___937 i5))) true)))))) (and (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___937 i5))) true) (not (= i5 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___937 (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) i5)))) (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) i5) (rec__tree_model__path_type__a (us_split_fields1 (select temp___937 i5)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___937 i5)))) 0)))) (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___937 i5))) true) (forall ((j6 Int)) (=> (and (<= 1 j6) (<= j6 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___937 j6))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___937 i5))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___937 j6)))) true)) (= j6 i5))))))))))))))
(assert (= o48 (select temp___937 i)))
(assert (= o49 (us_split_fields1 o48)))
(assert (= o50 (rec__tree_model__path_type__a o49)))
(assert (and (= result24 (is_add o50 d o53)) (= (= result24 true) (and (and (= (- (length o53) 1) (length o50)) (= (olt o50 o53) true)) (= (get o53 (length o53)) d)))))
