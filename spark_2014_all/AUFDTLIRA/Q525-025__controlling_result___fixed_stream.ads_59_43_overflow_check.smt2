...
(declare-fun temp___308 (Int Int Int) us_t1)
...
(assert (forall ((temp___310 Int) (temp___311 Int) (temp___312 Int)) (let ((temp___309 (temp___308 temp___310 temp___311 temp___312))) (=> (dynamic_invariant4 temp___310 true true true true) (and (=> (dynamic_property 1 2147483647 temp___311 temp___312) (and (= (first3 temp___309) temp___311) (= (last3 temp___309) temp___312))) (forall ((temp___313 Int)) (= (to_rep (select (to_array1 temp___309) temp___313)) temp___310)))))))
...
(assert (= (to_rep1 (first2 (rt1 (temp___308 0 (to_rep1 change__first) (to_rep1 change__last))))) (to_rep1 change__first)))
(assert (= (to_rep1 (last2 (rt1 (temp___308 0 (to_rep1 change__first) (to_rep1 change__last))))) (to_rep1 change__last)))
(assert (= (mk___t1 temp___315 temp___3151) (temp___308 0 (to_rep1 change__first) (to_rep1 change__last))))
...
(assert (= o14 i))
(assert (= o15 (select change3 o14)))
(assert (= o16 (to_rep o15)))
(assert (= o17 (ite (= o16 0) true false)))
(assert (=> (< (to_rep1 (first (rt new_val))) 0) (= result4 true)))
(assert (=> (not (< (to_rep1 (first (rt new_val))) 0)) (and (= o12 (- 2147483647 (to_rep1 (first (rt new_val))))) (in_range1 (- 2147483647 (to_rep1 (first (rt new_val))))))))
(assert (=> (not (< (to_rep1 (first (rt new_val))) 0)) (and (= o13 (- i (to_rep1 change__first))) (in_range1 (- i (to_rep1 change__first))))))
(assert (=> (not (< (to_rep1 (first (rt new_val))) 0)) (= result4 (ite (<= o13 o12) true false))))
(assert (=> (= result4 true) (and (= o9 (- i (to_rep1 change__first))) (in_range1 (- i (to_rep1 change__first))))))
(assert (=> (= result4 true) (= o10 (+ o9 (to_rep1 (first (rt new_val)))))))
(assert (=> (= result4 true) (and (= o11 o10) (in_range1 o10))))
(assert (=> (= result4 true) (= result3 (ite (<= o11 (to_rep1 (last (rt new_val)))) true false))))
(assert (=> (not (= result4 true)) (= result3 false)))
(assert (= result3 true))
(assert (not (in_range1 (- i (to_rep1 change__first)))))
(check-sat)
(exit)
