...
(define-fun dynamic_invariant ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= (- 2147483648) 2147483647)) (in_range1 temp___expr_142)))
...
(assert (forall ((x positive)) (! (in_range3 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(define-fun bool_eq4 ((a us_rep1) (b us_rep1)) Bool (ite (and (and (= (to_rep3 (rec__integer_stacks__stack__capacity (us_split_discrs2 a))) (to_rep3 (rec__integer_stacks__stack__capacity (us_split_discrs2 b)))) (= (bool_eq3 (rec__integer_stacks__stack__values1 (us_split_fields3 a)) (rec__integer_stacks__stack__values1 (us_split_fields3 b))) true)) (= (to_rep (rec__integer_stacks__stack__top1 (us_split_fields3 a))) (to_rep (rec__integer_stacks__stack__top1 (us_split_fields3 b))))) true false))
(declare-const us_tag1 Int)
(define-fun in_range5 ((rec__integer_stacks__stack__capacity1 Int) (a us_rep)) Bool (= rec__integer_stacks__stack__capacity1 (to_rep3 (rec__integer_stacks__stack__capacity (us_split_discrs1 a)))))
...
(define-fun to_base2 ((a us_rep3)) us_rep (mk___rep (us_split_discrs4 a) (mk___split_fields (let ((temp___138 (rec__integer_stacks__stack__values3 (us_split_fields7 a)))) (of_array (to_array3 temp___138) (first7 temp___138) (last7 temp___138))) (rec__integer_stacks__stack__top3 (us_split_fields7 a)) (hide_ext__2 (rec__ext__3 (us_split_fields7 a)))) (attr__tag3 a)))
(define-fun of_base2 ((r us_rep)) us_rep3 (mk___rep3 (us_split_discrs1 r) (mk___split_fields3 (let ((temp___137 (rec__integer_stacks__stack__values (us_split_fields1 r)))) (of_array3 (to_array temp___137) (first1 temp___137) (last1 temp___137))) (rec__integer_stacks__stack__top (us_split_fields1 r)) (extract__ext__2 (rec__ext__ (us_split_fields1 r)))) (attr__tag r)))
(define-fun bool_eq8 ((a us_rep3) (b us_rep3)) Bool (ite (and (and (= (to_rep3 (rec__integer_stacks__stack__capacity (us_split_discrs4 a))) (to_rep3 (rec__integer_stacks__stack__capacity (us_split_discrs4 b)))) (= (bool_eq7 (rec__integer_stacks__stack__values3 (us_split_fields7 a)) (rec__integer_stacks__stack__values3 (us_split_fields7 b))) true)) (= (to_rep (rec__integer_stacks__stack__top3 (us_split_fields7 a))) (to_rep (rec__integer_stacks__stack__top3 (us_split_fields7 b))))) true false))
(declare-const us_tag3 Int)
(define-fun in_range7 ((rec__integer_stacks__stack__capacity1 Int) (a us_rep)) Bool (= rec__integer_stacks__stack__capacity1 (to_rep3 (rec__integer_stacks__stack__capacity (us_split_discrs1 a)))))
...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant1 this true true true) (dynamic_invariant2 (extent this) true false true)) :pattern ((extent this)))))
(assert (forall ((attr__tag4 Int)) (forall ((this us_rep)) (! (=> (dynamic_invariant1 this true true true) (dynamic_invariant2 (extent1 attr__tag4 this) true false true)) :pattern ((extent1 attr__tag4 this))))))
...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant1 this true true true) (= (extent this) (to_rep (rec__integer_stacks__stack__top (us_split_fields1 this))))) :pattern ((extent this)))))
(assert true)
(assert true)
...
(assert (forall ((this us_rep)) (! (= (= (full this) true) (= (to_rep (rec__integer_stacks__stack__top (us_split_fields1 this))) (to_rep3 (rec__integer_stacks__stack__capacity (us_split_discrs1 this))))) :pattern ((full this)))))
...
(declare-datatypes () ((t12s__ref (mk_t12s__ref (t12s__content us_t4)))))
(define-fun t12s__ref___projection ((a t12s__ref)) us_t4 (t12s__content a))
...
(define-fun dynamic_property10 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range2 low) (and (in_range2 high) (=> (<= low high) (and (in_range3 low) (in_range3 high))))))
...
(declare-datatypes () ((contents__ref (mk_contents__ref (contents__content us_t5)))))
(define-fun contents__ref___projection ((a contents__ref)) us_t5 (contents__content a))
(declare-fun temp___218 (Int Int Int) us_t4)
(assert (forall ((temp___220 Int) (temp___221 Int) (temp___222 Int)) (let ((temp___219 (temp___218 temp___220 temp___221 temp___222))) (and (=> (dynamic_property10 1 2147483647 temp___221 temp___222) (and (= (first9 temp___219) temp___221) (= (last9 temp___219) temp___222))) (forall ((temp___223 Int)) (= (select (to_array4 temp___219) temp___223) (of_rep1 temp___220)))))))
(assert (forall ((a us_rep3) (b us_rep3)) (! (= (user_eq15 a b) (oeq (to_base2 a) (to_base2 b))) :pattern ((user_eq15 a b)))))
(define-fun dynamic_invariant5 ((temp___expr_229 us_rep3) (temp___is_init_226 Bool) (temp___skip_constant_227 Bool) (temp___do_toplevel_228 Bool)) Bool (and (=> (not (= temp___skip_constant_227 true)) (in_range7 (to_rep3 (rec__integer_stacks__stack__capacity (us_split_discrs1 left))) (to_base2 temp___expr_229))) (and (dynamic_property7 1 (to_rep3 (rec__integer_stacks__stack__capacity (us_split_discrs1 left))) (first7 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_229))) (last7 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_229)))) (and (= (first7 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_229))) 1) (= (last7 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_229))) (to_rep3 (rec__integer_stacks__stack__capacity (us_split_discrs1 left))))))))
(define-fun default_initial_assumption ((temp___expr_232 us_rep3) (temp___skip_top_level_233 Bool)) Bool (and (and (= (attr__tag3 temp___expr_232) us_tag3) (and (and (= (to_rep3 (rec__integer_stacks__stack__capacity (us_split_discrs4 temp___expr_232))) (to_rep3 (rec__integer_stacks__stack__capacity (us_split_discrs1 left)))) (= (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_232)) (let ((temp___235 (temp___218 0 1 (to_rep3 (rec__integer_stacks__stack__capacity (us_split_discrs4 temp___expr_232)))))) (of_array3 (to_array4 temp___235) (first9 temp___235) (last9 temp___235))))) (= (to_rep (rec__integer_stacks__stack__top3 (us_split_fields7 temp___expr_232))) 0))) (=> (not (= temp___skip_top_level_233 true)) (= (empty (to_base2 temp___expr_232)) true))))
...
(define-fun dynamic_invariant6 ((temp___expr_212 us_rep2) (temp___is_init_209 Bool) (temp___skip_constant_210 Bool) (temp___do_toplevel_211 Bool)) Bool (and (=> (not (= temp___skip_constant_210 true)) (in_range6 (to_rep3 (rec__integer_stacks__stack__capacity (us_split_discrs1 right))) (to_base1 temp___expr_212))) (and (dynamic_property5 1 (to_rep3 (rec__integer_stacks__stack__capacity (us_split_discrs1 right))) (first5 (rec__integer_stacks__stack__values2 (us_split_fields5 temp___expr_212))) (last5 (rec__integer_stacks__stack__values2 (us_split_fields5 temp___expr_212)))) (and (= (first5 (rec__integer_stacks__stack__values2 (us_split_fields5 temp___expr_212))) 1) (= (last5 (rec__integer_stacks__stack__values2 (us_split_fields5 temp___expr_212))) (to_rep3 (rec__integer_stacks__stack__capacity (us_split_discrs1 right))))))))
(define-fun default_initial_assumption1 ((temp___expr_215 us_rep2) (temp___skip_top_level_216 Bool)) Bool (and (and (= (attr__tag2 temp___expr_215) us_tag2) (and (and (= (to_rep3 (rec__integer_stacks__stack__capacity (us_split_discrs3 temp___expr_215))) (to_rep3 (rec__integer_stacks__stack__capacity (us_split_discrs1 right)))) (= (rec__integer_stacks__stack__values2 (us_split_fields5 temp___expr_215)) (let ((temp___224 (temp___218 0 1 (to_rep3 (rec__integer_stacks__stack__capacity (us_split_discrs3 temp___expr_215)))))) (of_array2 (to_array4 temp___224) (first9 temp___224) (last9 temp___224))))) (= (to_rep (rec__integer_stacks__stack__top2 (us_split_fields5 temp___expr_215))) 0))) (=> (not (= temp___skip_top_level_216 true)) (= (empty (to_base1 temp___expr_215)) true))))
...
(declare-const temp___287 positive)
(declare-const temp___2871 (Array Int element))
(declare-const temp___2872 t)
(declare-const temp___2873 natural)
(declare-const temp___2874 us_private)
(declare-const temp___2875 Int)
...
(declare-const this__split_fields12 (Array Int element))
(declare-const this__split_fields13 t)
(declare-const this__split_fields14 natural)
(declare-const this__split_fields15 us_private)
(declare-const item3 Int)
(assert (dynamic_invariant1 (mk___rep this__split_discrs (mk___split_fields (mk___t this__split_fields this__split_fields1) this__split_fields2 this__split_fields3) this__attr__tag) true false true))
(assert (=> (<= (- 2147483648) 2147483647) (in_range1 item)))
(assert (not (= (empty (mk___rep this__split_discrs (mk___split_fields (mk___t this__split_fields this__split_fields1) this__split_fields2 this__split_fields3) this__attr__tag)) true)))
(assert (and (<= (to_rep2 (first this__split_fields1)) (to_rep this__split_fields2)) (<= (to_rep this__split_fields2) (to_rep2 (last this__split_fields1)))))
...
(assert (= item1 o2))
(assert (and (= o3 (- (to_rep this__split_fields2) 1)) (in_range (- (to_rep this__split_fields2) 1))))
(assert (= (to_rep o4) o3))
(assert (= this__split_fields o5))
(assert (= this__split_fields1 o6))
(assert (= o4 o7))
(assert (= this__split_fields3 o8))
(assert (= this__split_discrs (mk___split_discrs temp___287)))
(assert (= temp___2871 o5))
(assert (= temp___2872 o6))
(assert (= temp___2873 o7))
(assert (= temp___2874 o8))
(assert (= this__attr__tag temp___2875))
...
(assert (= temp___2871 this__split_fields4))
(assert (= temp___2872 this__split_fields5))
(assert (= temp___2873 this__split_fields6))
(assert (= temp___2874 this__split_fields7))
(assert (= this__split_discrs (mk___split_discrs temp___287)))
(assert (= item2 item1))
...
(assert (= item3 item1))
(assert (= this__split_fields12 this__split_fields4))
(assert (= this__split_fields13 this__split_fields5))
(assert (= this__split_fields14 this__split_fields6))
(assert (= this__split_fields15 this__split_fields7))
(assert (not (not (= (full (mk___rep this__split_discrs (mk___split_fields (mk___t this__split_fields8 this__split_fields9) this__split_fields10 this__split_fields11) this__attr__tag)) true))))
(check-sat)
(exit)
