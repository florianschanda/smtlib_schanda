...
(define-fun dynamic_invariant ((temp___expr_165 Int) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool) (temp___do_typ_inv_164 Bool)) Bool (=> (or (= temp___is_init_161 true) (<= (- 2147483648) 2147483647)) (in_range1 temp___expr_165)))
...
(define-fun dynamic_property8 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range2 low) (and (in_range2 high) (=> (<= low high) (and (in_range3 low) (in_range3 high))))))
...
(declare-fun temp___245 (Int Int Int) us_t5)
(assert (forall ((temp___247 Int) (temp___248 Int) (temp___249 Int)) (let ((temp___246 (temp___245 temp___247 temp___248 temp___249))) (=> (dynamic_invariant temp___247 true true true true) (and (=> (dynamic_property8 1 2147483647 temp___248 temp___249) (and (= (first11 temp___246) temp___248) (= (last11 temp___246) temp___249))) (forall ((temp___250 Int)) (= (to_rep1 (select (to_array5 temp___246) temp___250)) temp___247)))))))
...
(define-fun dynamic_invariant6 ((temp___expr_257 us_rep3) (temp___is_init_253 Bool) (temp___skip_constant_254 Bool) (temp___do_toplevel_255 Bool) (temp___do_typ_inv_256 Bool)) Bool (and (=> (not (= temp___skip_constant_254 true)) (in_range7 (to_rep3 (rec__integer_stacks__stack__capacity (us_split_discrs1 left))) (to_base2 temp___expr_257))) (and (dynamic_property7 1 (to_rep3 (rec__integer_stacks__stack__capacity (us_split_discrs1 left))) (first7 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_257))) (last7 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_257)))) (and (= (first7 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_257))) 1) (= (last7 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_257))) (to_rep3 (rec__integer_stacks__stack__capacity (us_split_discrs1 left))))))))
(define-fun default_initial_assumption ((temp___expr_260 us_rep3) (temp___skip_top_level_261 Bool)) Bool (and (and (= (attr__tag3 temp___expr_260) us_tag3) (and (and (= (to_rep3 (rec__integer_stacks__stack__capacity (us_split_discrs4 temp___expr_260))) (to_rep3 (rec__integer_stacks__stack__capacity (us_split_discrs1 left)))) (= (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_260)) (let ((temp___263 (temp___245 0 1 (to_rep3 (rec__integer_stacks__stack__capacity (us_split_discrs4 temp___expr_260)))))) (of_array3 (to_array5 temp___263) (first11 temp___263) (last11 temp___263))))) (= (to_rep (rec__integer_stacks__stack__top3 (us_split_fields7 temp___expr_260))) 0))) (=> (not (= temp___skip_top_level_261 true)) (= (empty (to_base2 temp___expr_260)) true))))
...
(declare-const temp___315 positive)
(declare-const temp___3151 (Array Int element))
(declare-const temp___3152 t)
(declare-const temp___3153 natural)
(declare-const temp___3154 us_private)
(declare-const temp___3155 Int)
...
(assert (= this__split_discrs (mk___split_discrs temp___315)))
(assert (= temp___3151 o5))
(assert (= temp___3152 o6))
(assert (= temp___3153 o7))
(assert (= temp___3154 o8))
(assert (= this__attr__tag temp___3155))
...
(assert (= temp___3151 this__split_fields4))
(assert (= temp___3152 this__split_fields5))
(assert (= temp___3153 this__split_fields6))
(assert (= temp___3154 this__split_fields7))
(assert (= this__split_discrs (mk___split_discrs temp___315)))
(assert (= item2 item1))
