...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_132 us_void_param) 1)) 78) (= (to_rep (select (temp___String_Literal_132 us_void_param) 2)) 79)) (= (to_rep (select (temp___String_Literal_132 us_void_param) 3)) 95)) (= (to_rep (select (temp___String_Literal_132 us_void_param) 4)) 78)) (= (to_rep (select (temp___String_Literal_132 us_void_param) 5)) 65)) (= (to_rep (select (temp___String_Literal_132 us_void_param) 6)) 77)) (= (to_rep (select (temp___String_Literal_132 us_void_param) 7)) 69)) :pattern ((temp___String_Literal_132 us_void_param)))))
...
(assert (= no_name (temp___String_Literal_132 Tuple0)))
...
(declare-const temp___155 (Array Int character))
...
(assert (= no_name temp___153))
(assert (= (mk 1 7) temp___1531))
(assert (<= 1 r4b))
(assert (not (<= 1 1)))
(check-sat)
(exit)
