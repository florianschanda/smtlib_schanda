...
(assert (=> (and (<= (to_rep1 (first (rt s))) courant3) (<= courant3 (to_rep1 (last (rt s))))) (= (= o11 true) (exists ((i4 Int)) (and (and (<= (to_rep1 (first (rt s))) i4) (<= i4 (- courant3 1))) (exists ((j6 Int)) (and (and (<= (to_rep1 (first (rt c))) j6) (<= j6 (to_rep1 (last (rt c))))) (= (to_rep (select (elts s) i4)) (to_rep (select (elts c) j6))))))))))
(assert (=> (and (<= (to_rep1 (first (rt s))) courant3) (<= courant3 (to_rep1 (last (rt s))))) (= result5 (ite (not (= o11 true)) true false))))
(assert (=> (not (and (<= (to_rep1 (first (rt s))) courant3) (<= courant3 (to_rep1 (last (rt s)))))) (= result5 false)))
(assert (=> (= result5 true) (= result4 (ite (<= (to_rep1 (first (rt c))) possible4) (ite (<= possible4 (to_rep1 (last (rt c)))) true false) false))))
(assert (=> (not (= result5 true)) (= result4 false)))
(assert (= result4 true))
(assert (<= (to_rep1 (first (rt c))) j1))
(assert (<= j1 (- possible4 1)))
(assert (and (<= (to_rep1 (first (rt c))) j1) (<= j1 (to_rep1 (last (rt c))))))
(assert (= o5 j1))
(assert (= o6 (select (elts c) o5)))
(assert (= o7 (to_rep o6)))
(assert (not (<= (to_rep1 (first (rt s))) courant3)))
(check-sat)
(exit)
