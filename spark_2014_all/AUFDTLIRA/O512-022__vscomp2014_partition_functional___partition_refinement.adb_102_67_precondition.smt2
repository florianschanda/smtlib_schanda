...
(assert (and (= o (has_key (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields))) c)) (= (= o true) (= (has_key (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields))) c) true))))
(assert (= o1 true))
(assert (= result1 (ite (= o1 true) o false)))
(assert (= result1 true))
(assert (not (= (has_key (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields))) c) true)))
(check-sat)
(exit)
