...
(assert (and (= o51 (has_key (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields))) c1)) (= (= o51 true) (= (has_key (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields))) c1) true))))
(assert (= o52 true))
