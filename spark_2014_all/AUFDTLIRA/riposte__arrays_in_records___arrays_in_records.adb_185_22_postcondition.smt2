...
(declare-const temp___348 index)
(declare-const temp___3481 (Array Int value))
(declare-const temp___3482 (Array Int value))
...
(assert (= temp___348 o2))
(assert (= temp___3481 o3))
(assert (= temp___3482 o4))
(assert (= result1 a__split_fields))
(assert (= result2 a__split_fields1))
(assert (= result3 a__split_fields2))
(assert (= temp___348 a__split_fields3))
(assert (= temp___3481 a__split_fields4))
(assert (= temp___3482 a__split_fields5))
(assert (= (to_rep o5) tmp1))
(assert (= o6 (store a__split_fields4 5 o5)))
(assert (= a__split_fields3 o7))
(assert (= o6 o8))
(assert (= a__split_fields5 o9))
(assert (= temp___351 o7))
(assert (= temp___3511 o8))
(assert (= temp___3512 o9))
(assert (= result4 a__split_fields3))
(assert (= result5 a__split_fields4))
(assert (= result6 a__split_fields5))
(assert (= temp___351 a__split_fields6))
(assert (= temp___3511 a__split_fields7))
(assert (= temp___3512 a__split_fields8))
(assert (= tmp2 tmp1))
