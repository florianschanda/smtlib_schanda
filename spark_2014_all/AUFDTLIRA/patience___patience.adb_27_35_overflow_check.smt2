...
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (= o3 temp___570)))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (= temp___571 (select s__split_fields4 o3))))
...
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (= o4 temp___573)))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (= o5 (select s__split_fields3 o4))))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (= o6 (to_rep1 o5))))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (= temp___574 (- o6 1))))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (and (<= 0 temp___574) (<= temp___574 99))))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (= o7 temp___574)))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (= o8 (select temp___571 o7))))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (= o9 (to_rep1 o8))))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (= result3 (ite (= pred2 o9) true false))))
