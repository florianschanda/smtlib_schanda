...
(assert (=> (= result3 true) (and (= temp___159 (+ y l1)) (in_range1 (+ y l1)))))
(assert (=> (= result3 true) (and (<= (to_rep (first (rt a))) temp___159) (<= temp___159 (to_rep (last (rt a)))))))
(assert (=> (= result3 true) (= o5 temp___159)))
(assert (=> (= result3 true) (= o6 (select (elts a) o5))))
(assert (=> (= result3 true) (= o7 (to_rep o6))))
(assert (=> (= result3 true) (and (= temp___158 (+ x l1)) (in_range1 (+ x l1)))))
(assert (=> (= result3 true) (and (<= (to_rep (first (rt a))) temp___158) (<= temp___158 (to_rep (last (rt a)))))))
(assert (=> (= result3 true) (= o3 temp___158)))
(assert (=> (= result3 true) (= o4 (select (elts a) o3))))
(assert (=> (= result3 true) (= o8 (to_rep o4))))
(assert (=> (= result3 true) (= o11 (ite (= o8 o7) true false))))
