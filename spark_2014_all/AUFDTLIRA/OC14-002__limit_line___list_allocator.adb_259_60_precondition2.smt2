...
(declare-const o70 us_split_fields2)
(declare-const o71 resource)
...
(assert (and (= o76 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (in_range4 o76)))
(assert (= result13 (ite (in_range7 o76) true false)))
(assert (=> (= result13 true) (and (= o72 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range3 o72))))
(assert (=> (= result13 true) (= result14 (ite (< j o72) true false))))
(assert (=> (= result13 true) (=> (= result14 true) (and (= o73 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result13 true) (=> (= result14 true) (and (= o74 (get (rec__list_allocator__m__t__available model____split_fields3) o73)) (in_range4 o74)))))
(assert (=> (= result13 true) (=> (not (= result14 true)) (= o74 0))))
...
(assert (=> (= result13 true) (= o68 temp___460)))
(assert (=> (= result13 true) (= o69 (select data3 o68))))
(assert (=> (= result13 true) (= o70 (us_split_fields3 o69))))
(assert (=> (= result13 true) (= o71 (rec__list_allocator__cell__next o70))))
(assert (=> (= result13 true) (= o75 (to_rep o71))))
(assert (=> (= result13 true) (= result12 (ite (= o75 o74) true false))))
(assert (=> (not (= result13 true)) (= result12 false)))
(assert (=> (= result12 true) (=> (< 1 j) (and (= o65 (- j 1)) (in_range2 (- j 1))))))
(assert (=> (= result12 true) (=> (< 1 j) (and (= o66 (get (rec__list_allocator__m__t__available model____split_fields3) o65)) (in_range4 o66)))))
(assert (=> (= result12 true) (=> (not (< 1 j)) (= o66 0))))
...
(assert (=> (= result12 true) (= o61 temp___461)))
(assert (=> (= result12 true) (= o62 (select data3 o61))))
(assert (=> (= result12 true) (= o63 (us_split_fields3 o62))))
(assert (=> (= result12 true) (= o64 (rec__list_allocator__cell__prev o63))))
(assert (=> (= result12 true) (= o67 (to_rep o64))))
(assert (=> (= result12 true) (= result11 (ite (= o67 o66) true false))))
