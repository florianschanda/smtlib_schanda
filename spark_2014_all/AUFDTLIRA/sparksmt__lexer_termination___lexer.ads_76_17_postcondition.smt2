...
(assert (and (and (and (not (= current_read__attr__constrained true)) (not (= next_read__attr__constrained true))) (and (and (= (invariant__ name_table1) true) (in_range6 the_filename1)) (and (= (index the_file) 0) (and (and (= result (mk_int__ref current_line)) (= current_line1 1)) (and (and (= result1 (mk_int__ref current_col)) (= current_col1 0)) (and (and (and (and (= (size the_file1) (size the_file)) (<= (index the_file1) (size the_file1))) (or (not (= (to_rep2 (rec__file_io__read_result__status current_read__split_discrs)) 0)) (= (index the_file1) (+ (index the_file) 1)))) (or (= (to_rep2 (rec__file_io__read_result__status current_read__split_discrs)) 0) (= (index the_file1) (index the_file)))) (and (and (and (= o (index the_file1)) (and (in_range1 o) (<= o (size the_file1)))) (and (= result2 (mk_int__ref current_idx)) (= current_idx1 o))) (and (and (in_range2 current_line2) (in_range1 current_col2)) (ite (= (to_rep2 (rec__file_io__read_result__status current_read__split_discrs)) 0) (and (and (and (and (= (size the_file2) (size the_file1)) (<= (index the_file2) (size the_file2))) (or (not (= (to_rep2 (rec__file_io__read_result__status next_read__split_discrs1)) 0)) (= (index the_file2) (+ (index the_file1) 1)))) (or (= (to_rep2 (rec__file_io__read_result__status next_read__split_discrs1)) 0) (= (index the_file2) (index the_file1)))) (and (and (= o1 (index the_file2)) (and (in_range1 o1) (<= o1 (size the_file2)))) (and (= result3 (mk_int__ref next_idx)) (= next_idx1 o1)))) (and (and (and (and (and (=> (= next_read__attr__constrained true) (= (rec__file_io__read_result__status current_read__split_discrs) next_read__split_discrs)) (and (= current_read__split_discrs (mk___split_discrs usq_)) (and (= current_read__split_fields (mk___split_fields usq_1)) (= current_read__attr__constrained usq_2)))) (and (= usq_ temp___830) (and (= usq_1 temp___8301) (= next_read__attr__constrained temp___8302)))) (and (and (= result4 (mk___split_fields__ref (mk___split_fields next_read__split_fields))) (= next_read__split_fields2 (mk___split_fields temp___8301))) (and (= result5 (mk___split_discrs__ref (mk___split_discrs next_read__split_discrs))) (= next_read__split_discrs2 (mk___split_discrs temp___830))))) (and (= result6 (mk_int__ref next_idx)) (= next_idx2 current_idx1))) (and (= next_idx1 next_idx2) (and (= next_read__split_discrs1 next_read__split_discrs2) (and (= next_read__split_fields1 next_read__split_fields2) (= the_file2 the_file1)))))))))))))) (and (and (= name_table2 (mk___private__ref name_table1)) (and (= next_idx3 (mk_int__ref next_idx1)) (and (= next_read__split_discrs3 (mk___split_discrs__ref next_read__split_discrs1)) (and (= next_read__split_fields3 (mk___split_fields__ref next_read__split_fields1)) (and (= current_idx2 (mk_int__ref current_idx1)) (and (= current_col3 (mk_int__ref current_col2)) (and (= current_line3 (mk_int__ref current_line2)) (and (= current_read__split_discrs1 (mk___split_discrs__ref current_read__split_discrs)) (and (= current_read__split_fields1 (mk___split_fields__ref current_read__split_fields)) (and (= the_file3 (mk_file__ref the_file2)) (= the_filename2 (mk_int__ref the_filename1)))))))))))) (and (= name_table3 name_table1) (and (= next_idx4 next_idx1) (and (= next_read__split_discrs4 next_read__split_discrs1) (and (= next_read__split_fields4 next_read__split_fields1) (and (= current_idx3 current_idx1) (and (= current_col4 current_col2) (and (= current_line4 current_line2) (and (= current_read__split_discrs2 current_read__split_discrs) (and (= current_read__split_fields2 current_read__split_fields) (and (= the_file4 the_file2) (= the_filename3 the_filename1))))))))))))))
