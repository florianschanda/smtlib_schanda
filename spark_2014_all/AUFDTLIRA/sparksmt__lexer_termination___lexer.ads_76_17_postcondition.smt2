...
(assert (=> (not (= (to_rep2 (rec__file_io__read_result__status current_read__split_discrs)) 0)) (= usq_ temp___838)))
(assert (=> (not (= (to_rep2 (rec__file_io__read_result__status current_read__split_discrs)) 0)) (= usq_1 temp___8381)))
(assert (=> (not (= (to_rep2 (rec__file_io__read_result__status current_read__split_discrs)) 0)) (= next_read__attr__constrained temp___8382)))
...
(assert (=> (not (= (to_rep2 (rec__file_io__read_result__status current_read__split_discrs)) 0)) (= next_read__split_fields2 (mk___split_fields temp___8381))))
...
(assert (=> (not (= (to_rep2 (rec__file_io__read_result__status current_read__split_discrs)) 0)) (= next_read__split_discrs2 (mk___split_discrs temp___838))))
