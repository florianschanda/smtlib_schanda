...
(declare-const temp___2305 Bool)
(assert (in_range num))
(assert (not (= output__attr__constrained true)))
(assert (= num 0))
(assert (= (to_rep o1) 1))
(assert (= o1 o2))
(assert (= (temp___224 1 2 3) o3))
(assert (= o4 o2))
(assert (= o5 o3))
(assert (= o6 o4))
(assert (= o7 o5))
...
(assert (= (to_rep o) 0))
(assert (= o o10))
(assert (= temp___230 o10))
(assert (= temp___2301 o6))
(assert (= temp___2302 o7))
(assert (= temp___2303 o8))
(assert (= temp___2304 o9))
(assert (= true temp___2305))
(assert (= output__attr__constrained true))
(assert (not (= temp___230 output__split_discrs)))
(check-sat)
(exit)
