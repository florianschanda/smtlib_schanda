...
(assert (forall ((f us_rep1)) (forall ((i Int)) (! (=> (and (dynamic_invariant2 f true true true true) (dynamic_invariant i true true true true)) (let ((result (parent f i))) (and (and (=> (= (valid_root f i) true) (= result 0)) (=> (= (size f) 0) (= result 0))) (dynamic_invariant1 result true false true true)))) :pattern ((parent f i))))))
...
(assert (forall ((a (Array Int us_rep4))) (forall ((old_first Int)) (forall ((new_first Int)) (forall ((i1 Int)) (! (= (select (slide2 a old_first new_first) i1) (select a (- i1 (- new_first old_first)))) :pattern ((select (slide2 a old_first new_first) i1))))))))
...
(assert true)
(assert (forall ((f us_rep1)) (forall ((root Int)) (forall ((values (Array Int natural))) (! (= (= (ordered_leafs f root values) true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields7 (let ((temp___526 (model__ f root))) (select temp___526 i1)))) true) (= (rec__tree_model__path_type__k (us_split_fields7 (let ((temp___527 (model__ f root))) (select temp___527 j)))) true)) (= (olt (rec__tree_model__path_type__a (us_split_fields7 (let ((temp___528 (model__ f root))) (select temp___528 i1)))) (rec__tree_model__path_type__a (us_split_fields7 (let ((temp___529 (model__ f root))) (select temp___529 j))))) true)) (ite (= (get (rec__tree_model__path_type__a (us_split_fields7 (let ((temp___524 (model__ f root))) (select temp___524 j)))) (+ (length (rec__tree_model__path_type__a (us_split_fields7 (let ((temp___525 (model__ f root))) (select temp___525 i1))))) 1)) 0) (< (to_rep2 (select values j)) (to_rep2 (select values i1))) (< (to_rep2 (select values i1)) (to_rep2 (select values j)))))))))) :pattern ((ordered_leafs f root values)))))))
...
(assert (forall ((f us_rep1)) (! (=> (dynamic_invariant2 f true true true true) (dynamic_invariant1 (size f) true false true true)) :pattern ((size f)))))
(assert (forall ((f us_rep1)) (forall ((i1 Int)) (! (=> (and (dynamic_invariant2 f true true true true) (dynamic_invariant i1 true true true true)) (=> (< (size f) i1) (not (= (valid_root f i1) true)))) :pattern ((valid_root f i1))))))
(declare-fun position (us_rep1 Int) Int)
(declare-fun position__function_guard (Int us_rep1 Int) Bool)
(assert (forall ((f us_rep1)) (forall ((i1 Int)) (! (=> (and (and (dynamic_invariant2 f true true true true) (dynamic_invariant i1 true true true true)) (not (= (parent f i1) 0))) (dynamic_invariant6 (position f i1) true false true true)) :pattern ((position f i1))))))
(assert (forall ((f us_rep1)) (forall ((root Int)) (! (=> (and (and (dynamic_invariant2 f true true true true) (dynamic_invariant root true true true true)) (= (valid_root f root) true)) (let ((result (model__ f root))) (and (and (= (rec__tree_model__path_type__k (us_split_fields7 (select result root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields7 (select result root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent f i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields7 (select result (parent f i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields7 (select result i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields7 (select result i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields7 (select result i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields7 (select result (parent f i1)))) (position f i1) (rec__tree_model__path_type__a (us_split_fields7 (select result i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields7 (select result i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select result i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields7 (select result j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields7 (select result i1))) (rec__tree_model__path_type__a (us_split_fields7 (select result j)))) true)) (= j i1))))))))))) (dynamic_invariant8 result true false true true)))) :pattern ((model__ f root))))))
...
(declare-const search_trees__parent__result Int)
(declare-const o Int)
(declare-const result Int)
(declare-const search_trees__parent__result1 Int)
(declare-const search_trees__parent__result2 Int)
(declare-const search_trees__parent__result3 Int)
(declare-const search_trees__parent__result4 Int)
(declare-const search_trees__parent__result5 Int)
(declare-const result1 Int)
(assert (= (tree_structure (rec__search_trees__search_tree__struct (us_split_fields5 t))) true))
(assert (in_range3 i))
(assert (type_invariant1 t))
(assert (= search_trees__parent__result1 search_trees__parent__result2))
(assert (= search_trees__parent__result3 search_trees__parent__result1))
(assert (and (= o (parent (rec__search_trees__search_tree__struct (us_split_fields5 t)) i)) (and (in_range1 o) (and (=> (= (valid_root (rec__search_trees__search_tree__struct (us_split_fields5 t)) i) true) (= o 0)) (=> (= (size (rec__search_trees__search_tree__struct (us_split_fields5 t))) 0) (= o 0))))))
(assert (= (mk_int__ref result) (mk_int__ref search_trees__parent__result)))
(assert (= search_trees__parent__result1 o))
(assert (= (mk_int__ref search_trees__parent__result4) (mk_int__ref search_trees__parent__result2)))
(assert (= search_trees__parent__result5 search_trees__parent__result3))
(assert (= result1 search_trees__parent__result4))
(assert (= (size1 t) 0))
(assert (not (= search_trees__parent__result4 0)))
(check-sat)
(exit)
