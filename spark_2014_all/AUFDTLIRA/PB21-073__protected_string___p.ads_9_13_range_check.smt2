...
(assert (forall ((temp___187 Int) (temp___188 Int) (temp___189 Int)) (let ((temp___186 (temp___185 temp___187 temp___188 temp___189))) (and (=> (dynamic_property4 1 2147483647 temp___188 temp___189) (and (= (first3 temp___186) temp___188) (= (last3 temp___186) temp___189))) (forall ((temp___190 Int)) (= (select (to_array1 temp___186) temp___190) (of_rep temp___187)))))))
(define-fun dynamic_invariant ((temp___expr_179 us_rep1) (temp___is_init_176 Bool) (temp___skip_constant_177 Bool) (temp___do_toplevel_178 Bool)) Bool (and (=> (not (= temp___skip_constant_177 true)) (in_range2 3 (to_base temp___expr_179))) (let ((temp___180 (rec__p__pt__x (us_split_discrs2 temp___expr_179)))) (and (dynamic_property1 1 (to_rep1 temp___180) (first1 (rec__p__pt__s1 (us_split_fields3 temp___expr_179))) (last1 (rec__p__pt__s1 (us_split_fields3 temp___expr_179)))) (and (= (first1 (rec__p__pt__s1 (us_split_fields3 temp___expr_179))) 1) (= (last1 (rec__p__pt__s1 (us_split_fields3 temp___expr_179))) (to_rep1 temp___180)))))))
(define-fun default_initial_assumption ((temp___expr_182 us_rep1) (temp___skip_top_level_183 Bool)) Bool (and (= (to_rep1 (rec__p__pt__x (us_split_discrs2 temp___expr_182))) 3) (= (rec__p__pt__s1 (us_split_fields3 temp___expr_182)) (let ((temp___191 (temp___185 32 1 (to_rep1 (rec__p__pt__x (us_split_discrs2 temp___expr_182)))))) (of_array (to_array1 temp___191) (first3 temp___191) (last3 temp___191))))))
...
(define-fun dynamic_invariant3 ((temp___expr_171 us_rep) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool)) Bool (let ((temp___172 (rec__p__pt__x (us_split_discrs1 temp___expr_171)))) (and (dynamic_property1 1 (to_rep1 temp___172) (first1 (rec__p__pt__s (us_split_fields1 temp___expr_171))) (last1 (rec__p__pt__s (us_split_fields1 temp___expr_171)))) (and (= (first1 (rec__p__pt__s (us_split_fields1 temp___expr_171))) 1) (= (last1 (rec__p__pt__s (us_split_fields1 temp___expr_171))) (to_rep1 temp___172))))))
