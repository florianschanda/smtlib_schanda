...
(declare-const temp___8228 (Array Int (Array Int et1)))
(declare-const temp___82281 Bool)
...
(declare-const temp___8233 (Array Int (Array Int et1)))
(declare-const temp___82331 Bool)
...
(assert (<= 1 n))
(assert (<= n 10))
(assert (not (in_range3 (to_rep (select (select r__split_fields6 m) n)))))
(check-sat)
(exit)
