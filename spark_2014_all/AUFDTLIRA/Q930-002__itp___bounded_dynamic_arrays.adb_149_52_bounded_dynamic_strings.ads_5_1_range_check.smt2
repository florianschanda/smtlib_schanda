...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant2 this true true true true) (dynamic_invariant (length3 this) true false true true)) :pattern ((length3 this)))))
...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant2 this true true true true) (let ((result (value this))) (and (and (and (and (= (length1 result) (length3 this)) (= (first3 result) 1)) (= (last3 result) (length3 this))) (= (< 0 (length3 this)) (not (= (empty this) true)))) (dynamic_invariant3 result true false true true)))) :pattern ((value this)))))
...
(assert (dynamic_invariant2 tail true false true true))
