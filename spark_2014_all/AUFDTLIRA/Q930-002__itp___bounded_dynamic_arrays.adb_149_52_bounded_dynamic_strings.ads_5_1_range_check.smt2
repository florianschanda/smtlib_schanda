...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant2 this true true true) (dynamic_invariant (length3 this) true false true)) :pattern ((length3 this)))))
...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant2 this true true true) (let ((result (value this))) (and (and (and (and (= (length1 result) (length3 this)) (= (first3 result) 1)) (= (last3 result) (length3 this))) (= (< 0 (length3 this)) (not (= (empty this) true)))) (dynamic_invariant3 result true false true)))) :pattern ((value this)))))
...
(declare-const temp___1086 (Array Int character))
(declare-const temp___10861 t1)
(declare-const temp___1085 (Array Int character))
(declare-const temp___10851 t1)
...
(declare-const temp___10871 t)
(declare-const temp___1088 (Array Int character))
(declare-const temp___10881 t4)
(declare-const o8 (Array Int character))
(declare-const temp___1091 (Array Int character))
(declare-const temp___10911 t4)
...
(declare-const temp___1096 natural_index)
(declare-const temp___10961 natural_index)
(declare-const temp___10962 (Array Int character))
(declare-const temp___10963 t2)
...
(declare-const temp___10973 t2)
(declare-const o14 natural_index)
(declare-const o15 natural_index)
(declare-const o16 (Array Int character))
(declare-const o17 t2)
(declare-const temp___1099 us_rep)
(declare-const temp___1100 us_rep)
(declare-const temp___1105 us_t1)
(declare-const temp___1104 us_t1)
...
(assert (dynamic_invariant2 tail true false true))
...
(assert (and (<= 1 (+ (length3 tail) (length3 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2)))))) (<= (+ (length3 tail) (length3 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2))))) (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity to____split_discrs)))))
(assert (and (= us (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 tail)))) (in_range4 (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 tail))))))
(assert (and (= o (length3 tail)) (and (in_range4 o) (= o (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 tail)))))))
(assert (= o1 (+ o (to_rep2 to____split_fields))))
(assert (not (in_range5 o1)))
(check-sat)
(exit)
