...
(assert (=> (and (<= (to_rep1 (first (rt source))) i19) (<= i19 (to_rep1 (last (rt source))))) (and (and (= temp___876 target21) (and (= temp___875 i19) (and (= temp___874 has_failed21) (and (and (and (and (= o13 (is_digit (to_rep (select (elts source) i19)))) (ite (= (= (to_rep (select (elts source) i19)) 48) true) (= o13 true) (ite (= (= (to_rep (select (elts source) i19)) 49) true) (= o13 true) (ite (= (= (to_rep (select (elts source) i19)) 50) true) (= o13 true) (ite (= (= (to_rep (select (elts source) i19)) 51) true) (= o13 true) (ite (= (= (to_rep (select (elts source) i19)) 52) true) (= o13 true) (ite (= (= (to_rep (select (elts source) i19)) 53) true) (= o13 true) (ite (= (= (to_rep (select (elts source) i19)) 54) true) (= o13 true) (ite (= (= (to_rep (select (elts source) i19)) 55) true) (= o13 true) (ite (= (= (to_rep (select (elts source) i19)) 56) true) (= o13 true) (ite (= (= (to_rep (select (elts source) i19)) 57) true) (= o13 true) (ite (= (> (to_rep (select (elts source) i19)) 57) true) (not (= o13 true)) (=> (= (< (to_rep (select (elts source) i19)) 48) true) (not (= o13 true))))))))))))))) (= result19 (ite (not (= o13 true)) true false))) (and (not (= result19 true)) (and (= has_failed22 has_failed21) (= target22 target21)))) (and (forall ((j2 Int)) (=> (and (<= (to_rep1 (first (rt source))) j2) (<= j2 i20)) (= (is_digit (to_rep (select (elts source) j2))) true))) (and (and (and (=> (<= (to_rep1 (first (rt source))) (to_rep1 (last (rt source)))) (dynamic_property2 (to_rep1 (first (rt source))) (to_rep1 (last (rt source))) i20)) (=> (<= (- 2147483648) 2147483647) (in_range1 target23))) (and (<= (to_rep1 (first (rt source))) i20) (<= i20 (to_rep1 (last (rt source)))))) (= i20 (to_rep1 (last (rt source)))))))))) (and (and (= i26 (mk_int__ref i20)) (and (= has_failed29 (mk_bool__ref has_failed23)) (= target29 (mk_int__ref target23)))) (and (= i27 i20) (and (= has_failed30 has_failed23) (= target30 target23)))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) i19) (<= i19 (to_rep1 (last (rt source))))) (= i28 i26)))
(assert (=> (and (<= (to_rep1 (first (rt source))) i19) (<= i19 (to_rep1 (last (rt source))))) (= has_failed31 has_failed29)))
(assert (=> (and (<= (to_rep1 (first (rt source))) i19) (<= i19 (to_rep1 (last (rt source))))) (= target31 target29)))
(assert (=> (and (<= (to_rep1 (first (rt source))) i19) (<= i19 (to_rep1 (last (rt source))))) (= i29 i27)))
(assert (=> (and (<= (to_rep1 (first (rt source))) i19) (<= i19 (to_rep1 (last (rt source))))) (= has_failed32 has_failed30)))
(assert (=> (and (<= (to_rep1 (first (rt source))) i19) (<= i19 (to_rep1 (last (rt source))))) (= target32 target30)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) i19) (<= i19 (to_rep1 (last (rt source)))))) (= i28 (mk_int__ref i19))))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) i19) (<= i19 (to_rep1 (last (rt source)))))) (= has_failed31 (mk_bool__ref has_failed21))))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) i19) (<= i19 (to_rep1 (last (rt source)))))) (= target31 (mk_int__ref target21))))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) i19) (<= i19 (to_rep1 (last (rt source)))))) (= i29 i19)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) i19) (<= i19 (to_rep1 (last (rt source)))))) (= has_failed32 has_failed21)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) i19) (<= i19 (to_rep1 (last (rt source)))))) (= target32 target21)))
(declare-const index5 Int)
(assert (<= (to_rep1 (first (rt source))) index5))
(assert (<= index5 (to_rep1 (last (rt source)))))
(assert (not (= (is_digit (to_rep (select (elts source) index5))) true)))
(check-sat)
(exit)
