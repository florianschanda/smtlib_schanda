...
(assert (=> (and (<= (to_rep1 (first (rt source))) i1) (<= i1 (to_rep1 (last (rt source))))) (= temp___876 target3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) i1) (<= i1 (to_rep1 (last (rt source))))) (= temp___875 i1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) i1) (<= i1 (to_rep1 (last (rt source))))) (= temp___874 has_failed3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) i1) (<= i1 (to_rep1 (last (rt source))))) (and (= o3 (is_digit (to_rep (select (elts source) i1)))) (ite (= (= (to_rep (select (elts source) i1)) 48) true) (= o3 true) (ite (= (= (to_rep (select (elts source) i1)) 49) true) (= o3 true) (ite (= (= (to_rep (select (elts source) i1)) 50) true) (= o3 true) (ite (= (= (to_rep (select (elts source) i1)) 51) true) (= o3 true) (ite (= (= (to_rep (select (elts source) i1)) 52) true) (= o3 true) (ite (= (= (to_rep (select (elts source) i1)) 53) true) (= o3 true) (ite (= (= (to_rep (select (elts source) i1)) 54) true) (= o3 true) (ite (= (= (to_rep (select (elts source) i1)) 55) true) (= o3 true) (ite (= (= (to_rep (select (elts source) i1)) 56) true) (= o3 true) (ite (= (= (to_rep (select (elts source) i1)) 57) true) (= o3 true) (ite (= (> (to_rep (select (elts source) i1)) 57) true) (not (= o3 true)) (=> (= (< (to_rep (select (elts source) i1)) 48) true) (not (= o3 true)))))))))))))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) i1) (<= i1 (to_rep1 (last (rt source))))) (= result2 (ite (not (= o3 true)) true false))))
(assert (=> (and (<= (to_rep1 (first (rt source))) i1) (<= i1 (to_rep1 (last (rt source))))) (not (= result2 true))))
(assert (=> (and (<= (to_rep1 (first (rt source))) i1) (<= i1 (to_rep1 (last (rt source))))) (= has_failed4 has_failed3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) i1) (<= i1 (to_rep1 (last (rt source))))) (= target4 target3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) i1) (<= i1 (to_rep1 (last (rt source))))) (forall ((j Int)) (=> (and (<= (to_rep1 (first (rt source))) j) (<= j i2)) (= (is_digit (to_rep (select (elts source) j))) true)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) i1) (<= i1 (to_rep1 (last (rt source))))) (and (and (=> (<= (to_rep1 (first (rt source))) (to_rep1 (last (rt source)))) (dynamic_property2 (to_rep1 (first (rt source))) (to_rep1 (last (rt source))) i2)) (=> (<= (- 2147483648) 2147483647) (in_range1 target5))) (and (<= (to_rep1 (first (rt source))) i2) (<= i2 (to_rep1 (last (rt source))))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) i1) (<= i1 (to_rep1 (last (rt source))))) (= i2 (to_rep1 (last (rt source))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) i1) (<= i1 (to_rep1 (last (rt source))))) (= i3 (mk_int__ref i2))))
(assert (=> (and (<= (to_rep1 (first (rt source))) i1) (<= i1 (to_rep1 (last (rt source))))) (= has_failed6 (mk_bool__ref has_failed5))))
(assert (=> (and (<= (to_rep1 (first (rt source))) i1) (<= i1 (to_rep1 (last (rt source))))) (= target6 (mk_int__ref target5))))
(assert (=> (and (<= (to_rep1 (first (rt source))) i1) (<= i1 (to_rep1 (last (rt source))))) (= i4 i2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) i1) (<= i1 (to_rep1 (last (rt source))))) (= has_failed7 has_failed5)))
(assert (=> (and (<= (to_rep1 (first (rt source))) i1) (<= i1 (to_rep1 (last (rt source))))) (= target7 target5)))
(assert (=> (and (<= (to_rep1 (first (rt source))) i1) (<= i1 (to_rep1 (last (rt source))))) (= i5 i3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) i1) (<= i1 (to_rep1 (last (rt source))))) (= has_failed8 has_failed6)))
(assert (=> (and (<= (to_rep1 (first (rt source))) i1) (<= i1 (to_rep1 (last (rt source))))) (= target8 target6)))
(assert (=> (and (<= (to_rep1 (first (rt source))) i1) (<= i1 (to_rep1 (last (rt source))))) (= i6 i4)))
(assert (=> (and (<= (to_rep1 (first (rt source))) i1) (<= i1 (to_rep1 (last (rt source))))) (= has_failed9 has_failed7)))
(assert (=> (and (<= (to_rep1 (first (rt source))) i1) (<= i1 (to_rep1 (last (rt source))))) (= target9 target7)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) i1) (<= i1 (to_rep1 (last (rt source)))))) (= i5 (mk_int__ref i1))))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) i1) (<= i1 (to_rep1 (last (rt source)))))) (= has_failed8 (mk_bool__ref has_failed3))))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) i1) (<= i1 (to_rep1 (last (rt source)))))) (= target8 (mk_int__ref target3))))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) i1) (<= i1 (to_rep1 (last (rt source)))))) (= i6 i1)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) i1) (<= i1 (to_rep1 (last (rt source)))))) (= has_failed9 has_failed3)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) i1) (<= i1 (to_rep1 (last (rt source)))))) (= target9 target3)))
