...
(declare-const tab35 map__ref)
(declare-const j42 int__ref)
(declare-const k21 int__ref)
(declare-const temp___1802 int__ref)
(declare-const temp___1792 int__ref)
...
(define-fun tab37 () map__ref (mk_map__ref tab))
(assert (in_range1 a))
(assert (in_range1 b))
...
(assert (=> (<= j1 b) (= (mk_map__ref result1) tab37)))
(assert (=> (<= j1 b) (= tab2 o2)))
...
(assert (= k17 0))
(assert (<= j38 b))
(assert (= (to_rep o25) j38))
(assert (and (<= (to_rep tab__first) j38) (<= j38 (to_rep tab__last))))
(assert (= o26 j38))
(assert (= o27 (store (map__content tab30) o26 o25)))
(assert (= result30 tab30))
(assert (= tab32 o27))
(assert (and (= o28 (+ j38 1)) (in_range1 (+ j38 1))))
(assert (= result31 (mk_int__ref j38)))
(assert (= j39 o28))
(assert (and (= o29 (+ k17 1)) (in_range1 (+ k17 1))))
(assert (= result32 (mk_int__ref k17)))
(assert (= k18 o29))
(assert (= j40 (+ a k19)))
(assert (forall ((l Int)) (=> (and (<= a l) (<= l (- j40 1))) (= (to_rep (select tab33 l)) l))))
(assert (forall ((l Int)) (=> (and (<= a l) (<= l (- (+ a k19) 1))) (= (to_rep (select tab33 l)) l))))
(assert (and (=> (<= (- 2147483648) 2147483647) (in_range1 j40)) (=> (<= (- 2147483648) 2147483647) (in_range1 k19))))
(assert (= result33 (mk_int__ref temp___179)))
(assert (= temp___1791 j40))
(assert (= result34 (mk_int__ref temp___180)))
(assert (= temp___1801 k19))
(assert (<= j40 b))
(assert (= (to_rep o30) j40))
(assert (and (<= (to_rep tab__first) j40) (<= j40 (to_rep tab__last))))
(assert (= o31 j40))
(assert (= o32 (store tab33 o31 o30)))
(assert (= result35 (mk_map__ref tab33)))
(assert (= tab34 o32))
(assert (and (= o33 (+ j40 1)) (in_range1 (+ j40 1))))
(assert (= result36 (mk_int__ref j40)))
(assert (= j41 o33))
(assert (and (= o34 (+ k19 1)) (in_range1 (+ k19 1))))
(assert (= result37 (mk_int__ref k19)))
(assert (= k20 o34))
(assert (= temp___1792 (mk_int__ref temp___1791)))
(assert (= temp___1802 (mk_int__ref temp___1801)))
(assert (= k21 (mk_int__ref k20)))
(assert (= j42 (mk_int__ref j41)))
(assert (= tab35 (mk_map__ref tab34)))
(assert (= temp___1793 temp___1791))
(assert (= temp___1803 temp___1801))
(assert (= k22 k20))
(assert (= j43 j41))
(assert (= tab36 tab34))
(assert (not (= (int__content j42) (+ a (int__content k21)))))
(check-sat)
(exit)
