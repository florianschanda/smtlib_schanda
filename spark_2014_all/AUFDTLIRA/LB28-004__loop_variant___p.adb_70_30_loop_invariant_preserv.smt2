...
(assert (= k21 0))
(assert (<= j53 b))
(assert (= (to_rep o51) j53))
(assert (and (<= (to_rep tab__first) j53) (<= j53 (to_rep tab__last))))
(assert (= o52 j53))
(assert (= o53 (store (map__content tab43) o52 o51)))
(assert (= result44 tab43))
(assert (= tab45 o53))
(assert (and (= o54 (+ j53 1)) (in_range1 (+ j53 1))))
(assert (= result45 (mk_int__ref j53)))
(assert (= j54 o54))
(assert (and (= o55 (+ k21 1)) (in_range1 (+ k21 1))))
(assert (= result46 (mk_int__ref k21)))
(assert (= k22 o55))
(assert (= j55 (+ a k23)))
(assert (forall ((l8 Int)) (=> (and (<= a l8) (<= l8 (- j55 1))) (= (to_rep (select tab46 l8)) l8))))
(assert (forall ((l8 Int)) (=> (and (<= a l8) (<= l8 (- (+ a k23) 1))) (= (to_rep (select tab46 l8)) l8))))
(assert (and (=> (<= (- 2147483648) 2147483647) (in_range1 j55)) (=> (<= (- 2147483648) 2147483647) (in_range1 k23))))
(assert (= result49 (mk_int__ref temp___1791)))
(assert (= temp___1792 j55))
(assert (= result50 (mk_int__ref temp___1801)))
(assert (= temp___1802 k23))
(assert (<= j55 b))
(assert (= (to_rep o63) j55))
(assert (and (<= (to_rep tab__first) j55) (<= j55 (to_rep tab__last))))
(assert (= o64 j55))
(assert (= o65 (store tab46 o64 o63)))
(assert (= result51 (mk_map__ref tab46)))
(assert (= tab47 o65))
(assert (and (= o66 (+ j55 1)) (in_range1 (+ j55 1))))
(assert (= result52 (mk_int__ref j55)))
(assert (= j56 o66))
(assert (and (= o67 (+ k23 1)) (in_range1 (+ k23 1))))
(assert (= result53 (mk_int__ref k23)))
(assert (= k24 o67))
(assert (= temp___1793 (mk_int__ref temp___1792)))
(assert (= temp___1803 (mk_int__ref temp___1802)))
(assert (= k25 (mk_int__ref k24)))
(assert (= j57 (mk_int__ref j56)))
(assert (= tab48 (mk_map__ref tab47)))
(assert (= temp___1794 temp___1792))
(assert (= temp___1804 temp___1802))
(assert (= k26 k24))
(assert (= j58 j56))
(assert (= tab49 tab47))
(assert (not (= (int__content j57) (+ a (int__content k25)))))
(check-sat)
(exit)
