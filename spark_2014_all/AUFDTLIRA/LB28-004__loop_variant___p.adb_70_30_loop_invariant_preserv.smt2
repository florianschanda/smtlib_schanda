...
(declare-const temp___2032 int__ref)
(declare-const temp___2022 int__ref)
...
(assert (= result33 (mk_int__ref temp___202)))
(assert (= temp___2021 j40))
(assert (= result34 (mk_int__ref temp___203)))
(assert (= temp___2031 k19))
(assert (<= j40 b))
...
(assert (= k20 o34))
(assert (= temp___2022 (mk_int__ref temp___2021)))
(assert (= temp___2032 (mk_int__ref temp___2031)))
(assert (= k21 (mk_int__ref k20)))
(assert (= j42 (mk_int__ref j41)))
(assert (= tab35 (mk_map__ref tab34)))
(assert (= temp___2023 temp___2021))
(assert (= temp___2033 temp___2031))
(assert (= k22 k20))
(assert (= j43 j41))
(assert (= tab36 tab34))
