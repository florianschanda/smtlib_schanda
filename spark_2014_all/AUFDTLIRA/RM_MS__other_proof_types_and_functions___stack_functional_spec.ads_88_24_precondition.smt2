...
(assert (and (= o19 (state__2 (us_split_fields__content my_stack__split_fields4))) (= o19 (mk___rep (us_split_fields__content my_stack__split_fields4)))))
(assert (and (= o20 (count o19)) (and (in_range2 o20) (= o20 (to_rep1 (rec__stack_functional_spec__stack_type__pointer (us_split_fields1 o19)))))))
(assert (= o21 (- o20 2)))
(assert (= o22 (ite (<= i o21) true false)))
(assert (= result3 (ite (<= 1 i) o22 false)))
(assert (= (= o23 true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (- (count (state__2 (us_split_fields__content my_stack__split_fields4))) 2))) (= (stack_entry (state__2 (us_split_fields__content my_stack__split_fields4)) i1) (stack_entry (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1)) i1))))))
(assert (and (= o24 (state__2 (us_split_fields__content my_stack__split_fields4))) (= (us_split_fields__content my_stack__split_fields4) (mk___split_fields o16 o17))))
(assert (and (= o18 (count o24)) (and (in_range2 o18) (= o18 (to_rep1 o17)))))
(assert (not (<= o18 (count (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1))))))
(check-sat)
(exit)
