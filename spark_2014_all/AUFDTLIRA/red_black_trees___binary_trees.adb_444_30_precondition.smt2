...
(assert (and (= temp___1407 (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) root)) (and (dynamic_invariant3 temp___1407 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1407 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1407 root)))) 0) (and (forall ((i13 Int)) (=> (and (<= 1 i13) (<= i13 100)) (=> (not (= i13 root)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i13) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1407 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i13)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1407 i13))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1407 i13))) true)))))) (and (forall ((i13 Int)) (=> (and (<= 1 i13) (<= i13 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1407 i13))) true) (not (= i13 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1407 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i13)))) (position (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i13) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1407 i13)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1407 i13)))) 0)))) (forall ((i13 Int)) (=> (and (<= 1 i13) (<= i13 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1407 i13))) true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1407 j2))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1407 i13))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1407 j2)))) true)) (= j2 i13))))))))))))))
(assert (and (<= 1 v) (<= v 100)))
(assert (= o v))
(assert (= (mk___rep (mk___split_fields o1 o2)) (select temp___1407 o)))
(assert (= o1 o3))
(assert (= o2 o4))
(assert (= result1 o4))
(assert (= result1 true))
(assert (= (= result2 true) (forall ((i13 Int)) (=> (and (<= 1 i13) (<= i13 100)) (=> (not (= i13 v)) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i13)))) (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f_old__split_fields1 i13))))))))))
(assert (= result2 true))
(assert (= (= result3 true) (forall ((i13 Int)) (=> (and (<= 1 i13) (<= i13 100)) (=> (not (= i13 v)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 i13)))) (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f_old__split_fields1 i13))))))))))
(assert (= result3 true))
(assert (<= 1 j1))
(assert (<= j1 100))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))) true))
