...
(assert (forall ((temp___422 (Array Int integer))) (forall ((temp___423 Int) (temp___424 Int)) (let ((temp___421 (temp___420 temp___422 temp___423 temp___424))) (forall ((temp___425 Int)) (ite (= temp___425 temp___423) (= (select temp___421 temp___425) (of_rep temp___424)) (= (select temp___421 temp___425) (select temp___422 temp___425))))))))
(declare-fun temp___427 ((Array Int integer) Int Int) (Array Int integer))
(assert (forall ((temp___429 (Array Int integer))) (forall ((temp___430 Int) (temp___431 Int)) (let ((temp___428 (temp___427 temp___429 temp___430 temp___431))) (forall ((temp___432 Int)) (ite (= temp___432 temp___430) (= (select temp___428 temp___432) (of_rep temp___431)) (= (select temp___428 temp___432) (select temp___429 temp___432))))))))
(assert (in_range1 i))
(assert (= (bool_eq a (- 2147483648) 2147483647 (temp___420 a i 42) (- 2147483648) 2147483647) true))
(assert (not (= (to_rep (select a i)) (to_rep (select (temp___427 a i 42) i)))))
(check-sat)
(exit)
