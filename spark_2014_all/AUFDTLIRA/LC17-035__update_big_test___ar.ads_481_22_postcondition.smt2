...
(assert (= a4 a2))
(assert (not (or (and (< k 16) (or (and (< 0 e) (= (bool_eq2 a3 1 16 (temp___1704 a k (temp___1712 (select a k) j (temp___1719 (select (select a k) j) i e)) (+ k 1) (temp___1727 (select a (+ k 1)) j (temp___1734 (select (select a (+ k 1)) j) i (- e 1)))) 1 16) true)) (and (= e 0) (= (bool_eq2 a3 1 16 (temp___1743 a k (temp___1751 (select a k) j (temp___1758 (select (select a k) j) i e)) (+ k 1) (temp___1766 (select a (+ k 1)) j (temp___1773 (select (select a (+ k 1)) j) i 99))) 1 16) true)))) (and (= k 16) (or (and (< 0 e) (= (bool_eq2 a3 1 16 (temp___1782 a k (temp___1790 (select a k) j (temp___1797 (select (select a k) j) i e)) 1 (temp___1805 (select a 1) j (temp___1812 (select (select a 1) j) i (- e 1)))) 1 16) true)) (and (= e 0) (= (bool_eq2 a3 1 16 (temp___1821 a k (temp___1829 (select a k) j (temp___1836 (select (select a k) j) i e)) 1 (temp___1844 (select a 1) j (temp___1851 (select (select a 1) j) i 99))) 1 16) true)))))))
(check-sat)
(exit)
