...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (and (= (to_rep1 (rec__bounded_strings__bounded_string__bound (us_split_discrs1 a))) (to_rep1 (rec__bounded_strings__bounded_string__bound (us_split_discrs1 b)))) (= (bool_eq1 (rec__bounded_strings__bounded_string__text (us_split_fields1 a)) (rec__bounded_strings__bounded_string__text (us_split_fields1 b))) true)) (= (to_rep2 (rec__bounded_strings__bounded_string__length (us_split_fields1 a))) (to_rep2 (rec__bounded_strings__bounded_string__length (us_split_fields1 b))))) true false))
...
(assert (= target__split_discrs (mk___split_discrs temp___189)))
(assert (= temp___1891 o5))
(assert (= temp___1892 o6))
(assert (= temp___1893 o7))
...
(assert (= temp___1891 target__split_fields3))
(assert (= temp___1892 target__split_fields4))
(assert (= temp___1893 target__split_fields5))
(assert (= target__split_discrs (mk___split_discrs temp___189)))
