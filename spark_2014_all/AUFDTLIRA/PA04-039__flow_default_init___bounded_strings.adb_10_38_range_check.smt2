...
(define-fun dynamic_invariant2 ((temp___expr_165 Int) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool) (temp___do_typ_inv_164 Bool)) Bool (=> (or (= temp___is_init_161 true) (<= 0 65536)) (in_range2 temp___expr_165)))
(assert (forall ((source us_rep)) (! (=> (dynamic_invariant1 source true true true true) (dynamic_invariant2 (length1 source) true false true true)) :pattern ((length1 source)))))
(assert (forall ((source us_rep)) (! (=> (dynamic_invariant1 source true true true true) (= (length1 source) (to_rep2 (rec__bounded_strings__bounded_string__length (us_split_fields1 source))))) :pattern ((length1 source)))))
...
(assert (dynamic_invariant1 (mk___rep target__split_discrs (mk___split_fields (mk___t target__split_fields target__split_fields1) target__split_fields2)) true false true true))
