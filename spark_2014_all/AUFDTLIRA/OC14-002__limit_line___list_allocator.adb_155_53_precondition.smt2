...
(assert (=> (not (= next_avail1 0)) (= (rec__list_allocator__cell__stat (us_split_fields1 (select data1 next_avail1))) o21)))
(assert (=> (not (= next_avail1 0)) (= o20 o22)))
(assert (=> (not (= next_avail1 0)) (= (rec__list_allocator__cell__next (us_split_fields1 (select data1 next_avail1))) o23)))
...
(assert (=> (not (= next_avail1 0)) (= o28 (store data1 o27 (mk___rep (mk___split_fields o24 o25 o26))))))
...
(assert (=> (not (= first_allocated 0)) (= (rec__list_allocator__cell__stat (us_split_fields1 (select data2 first_allocated))) o30)))
(assert (=> (not (= first_allocated 0)) (= o29 o31)))
(assert (=> (not (= first_allocated 0)) (= (rec__list_allocator__cell__next (us_split_fields1 (select data2 first_allocated))) o32)))
...
(assert (=> (not (= first_allocated 0)) (= o37 (store data2 o36 (mk___rep (mk___split_fields o33 o34 o35))))))
...
(assert (= temp___428 (mk___rep1 (mk___split_fields1 o39 o40))))
(assert (= result8 (mk___split_fields__ref1 (mk___split_fields1 model____split_fields model____split_fields1))))
(assert (= model____split_fields2 (us_split_fields3 temp___428)))
(assert (and (= o41 (prepend (rec__list_allocator__m__t__allocated model____split_fields2) res1)) (= (is_prepend (rec__list_allocator__m__t__allocated model____split_fields2) res1 o41) true)))
(assert (= o42 (mk___split_fields1 (rec__list_allocator__m__t__available model____split_fields2) o41)))
(assert (= temp___430 (mk___rep1 o42)))
(assert (= result9 (mk___split_fields__ref1 model____split_fields2)))
(assert (= model____split_fields3 (us_split_fields3 temp___430)))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (length (rec__list_allocator__m__t__available model____split_fields3)))) (and (and (and (in_range4 (get (rec__list_allocator__m__t__available model____split_fields3) j1)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data3 (get (rec__list_allocator__m__t__available model____split_fields3) j1))))) (ite (< j1 (length (rec__list_allocator__m__t__available model____split_fields3))) (get (rec__list_allocator__m__t__available model____split_fields3) (+ j1 1)) 0))) (= (to_rep (rec__list_allocator__cell__prev (us_split_fields1 (select data3 (get (rec__list_allocator__m__t__available model____split_fields3) j1))))) (ite (< 1 j1) (get (rec__list_allocator__m__t__available model____split_fields3) (- j1 1)) 0))) (forall ((k Int)) (=> (and (<= 1 k) (<= k (length (rec__list_allocator__m__t__available model____split_fields3)))) (=> (not (= j1 k)) (not (= (get (rec__list_allocator__m__t__available model____split_fields3) j1) (get (rec__list_allocator__m__t__available model____split_fields3) k))))))))))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (length (rec__list_allocator__m__t__allocated model____split_fields3)))) (and (and (and (in_range4 (get (rec__list_allocator__m__t__allocated model____split_fields3) j1)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data3 (get (rec__list_allocator__m__t__allocated model____split_fields3) j1))))) (ite (< j1 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (get (rec__list_allocator__m__t__allocated model____split_fields3) (+ j1 1)) 0))) (= (to_rep (rec__list_allocator__cell__prev (us_split_fields1 (select data3 (get (rec__list_allocator__m__t__allocated model____split_fields3) j1))))) (ite (< 1 j1) (get (rec__list_allocator__m__t__allocated model____split_fields3) (- j1 1)) 0))) (forall ((k Int)) (=> (and (<= 1 k) (<= k (length (rec__list_allocator__m__t__allocated model____split_fields3)))) (=> (not (= j1 k)) (not (= (get (rec__list_allocator__m__t__allocated model____split_fields3) j1) (get (rec__list_allocator__m__t__allocated model____split_fields3) k))))))))))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (length (rec__list_allocator__m__t__available model____split_fields3)))) (= (bool_eq (select data3 (get (rec__list_allocator__m__t__available model____split_fields3) j1)) (select data3 (get ma1 (+ j1 1)))) true))))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- (length ma1) 2))) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data3 (get ma1 (+ j1 1)))))) (get ma1 (+ j1 2))))))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- (length (rec__list_allocator__m__t__available model____split_fields3)) 1))) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data3 (get ma1 (+ j1 1)))))) (get ma1 (+ j1 2))))))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (length (rec__list_allocator__m__t__available model____split_fields3)))) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data3 (get ma1 (+ j1 1)))))) (ite (< j1 (length (rec__list_allocator__m__t__available model____split_fields3))) (get ma1 (+ j1 2)) 0)))))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (length (rec__list_allocator__m__t__available model____split_fields3)))) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data3 (get (rec__list_allocator__m__t__available model____split_fields3) j1))))) (ite (< j1 (length (rec__list_allocator__m__t__available model____split_fields3))) (get ma1 (+ j1 2)) 0)))))
(assert (and (= o43 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range6 o43)))
(assert (= o44 (ite (<= j o43) true false)))
(assert (= result10 (ite (<= 1 j) o44 false)))
(assert (= result10 true))
(assert (and (= o47 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (in_range7 o47)))
(assert (= result11 (ite (in_range4 o47) true false)))
(assert (= result11 true))
(assert (and (= o45 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range6 o45)))
(assert (= result12 (ite (< j o45) true false)))
(assert (= result12 true))
(assert (and (= o46 (+ j 1)) (in_range1 (+ j 1))))
(assert (not (<= 1 o46)))
(check-sat)
(exit)
