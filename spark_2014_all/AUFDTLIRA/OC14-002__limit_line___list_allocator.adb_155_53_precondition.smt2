...
(assert (and (= o115 (length (rec__list_allocator__m__t__available model____split_fields4))) (in_range6 o115)))
(assert (= o116 (ite (<= j7 o115) true false)))
(assert (= result29 (ite (<= 1 j7) o116 false)))
(assert (= result29 true))
(assert (and (= o120 (get (rec__list_allocator__m__t__available model____split_fields4) j7)) (in_range7 o120)))
(assert (= result30 (ite (in_range4 o120) true false)))
(assert (= result30 true))
(assert (and (= o117 (length (rec__list_allocator__m__t__available model____split_fields4))) (in_range6 o117)))
(assert (= result31 (ite (< j7 o117) true false)))
(assert (= result31 true))
(assert (and (= o118 (+ j7 1)) (in_range1 (+ j7 1))))
(assert (not (<= 1 o118)))
(check-sat)
(exit)
