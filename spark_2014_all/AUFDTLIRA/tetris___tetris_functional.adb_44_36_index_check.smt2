...
(assert (and (<= 1 (+ (to_rep2 cur_piece__split_fields2) 1)) (<= (+ (to_rep2 cur_piece__split_fields2) 1) 10)))
(assert (= o16 (+ (to_rep2 cur_piece__split_fields2) 1)))
(assert (= o17 (store (select cur_board3 (+ (to_rep3 cur_piece__split_fields3) 1)) o16 o15)))
(assert (not (<= (+ (to_rep3 cur_piece__split_fields3) 1) 50)))
(check-sat)
(exit)
