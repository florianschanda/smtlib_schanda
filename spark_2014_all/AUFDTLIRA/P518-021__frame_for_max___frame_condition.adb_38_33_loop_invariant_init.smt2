...
(assert (forall ((i Int)) (=> (and (<= (to_rep1 a__first) i) (<= i k2)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a2 i)))) max3))))
...
(assert (= result10 a5))
(assert (= a7 o44))
(assert (not (<= (to_rep1 a__first) k9)))
(check-sat)
(exit)
