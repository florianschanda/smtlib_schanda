...
(assert (= result1 true))
(assert (and (= result2 (invariant__ c)) (= (= result2 true) (and (= (to_rep2 (first (rt c))) 1) (<= 0 (to_rep2 (last (rt c))))))))
(assert (= result2 true))
(assert (= (bool_eq (elts a) (to_rep2 (first (rt a))) (to_rep2 (last (rt a))) (elts c) (to_rep2 (first (rt c))) (to_rep2 (last (rt c)))) true))
