...
(assert (= result4 true))
(assert (< (sum_of counter8) 0))
(assert (and (=> (<= 0 2147483647) (in_range4 counter10)) (< (sum_of counter10) 2)))
(assert (and (= o5 (+ counter10 1)) (in_range1 (+ counter10 1))))
(assert (= counter10 result5))
(assert (= counter11 o5))
(assert (and (= o6 (sum_of counter11)) (in_range4 o6)))
(assert (= o7 (ite (< o6 2) true false)))
(assert (= result6 (ite (not (= o7 true)) true false)))
(assert (not (= result6 true)))
(assert (= counter12 counter11))
(assert (= counter13 counter11))
(assert (not (< (sum_of counter8) 0)))
(check-sat)
(exit)
