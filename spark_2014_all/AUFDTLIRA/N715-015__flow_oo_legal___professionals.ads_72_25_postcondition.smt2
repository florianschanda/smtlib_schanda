...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (= (to_rep2 (select (temp___String_Literal_1012 us_void_param) 1)) 78) (= (to_rep2 (select (temp___String_Literal_1012 us_void_param) 2)) 97)) (= (to_rep2 (select (temp___String_Literal_1012 us_void_param) 3)) 109)) (= (to_rep2 (select (temp___String_Literal_1012 us_void_param) 4)) 101)) (= (to_rep2 (select (temp___String_Literal_1012 us_void_param) 5)) 108)) (= (to_rep2 (select (temp___String_Literal_1012 us_void_param) 6)) 101)) (= (to_rep2 (select (temp___String_Literal_1012 us_void_param) 7)) 115)) (= (to_rep2 (select (temp___String_Literal_1012 us_void_param) 8)) 115)) :pattern ((temp___String_Literal_1012 us_void_param)))))
...
(assert (forall ((p us_rep2)) (! (= (= (has_licence_to_kill p) true) (let ((temp___1089 (to_rep3 (rec__professionals__professional__profession (us_split_fields3 p))))) (or (= temp___1089 2) (= temp___1089 3)))) :pattern ((has_licence_to_kill p)))))
(assert true)
(assert true)
(assert true)
(assert true)
...
(declare-const temp___1223 professions)
(declare-const temp___12231 (Array Int skills))
(declare-const temp___12232 natural)
(declare-const temp___12233 us_rep)
(declare-const temp___12234 integer)
(declare-const temp___12235 Bool)
(declare-const temp___12236 us_private)
(declare-const temp___12237 Int)
...
(assert (= temp___1223 o2))
(assert (= temp___12231 o3))
(assert (= temp___12232 o4))
(assert (= temp___12233 o5))
(assert (= temp___12234 o6))
(assert (= temp___12235 o7))
(assert (= temp___12236 o8))
(assert (= killer__attr__tag temp___12237))
...
(assert (= temp___1223 killer__split_fields7))
(assert (= temp___12231 killer__split_fields8))
(assert (= temp___12232 killer__split_fields9))
(assert (= temp___12233 killer__split_fields10))
(assert (= temp___12234 killer__split_fields11))
(assert (= temp___12235 killer__split_fields12))
(assert (= temp___12236 killer__split_fields13))
