...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (= (to_rep2 (select (temp___String_Literal_928 us_void_param) 1)) 78) (= (to_rep2 (select (temp___String_Literal_928 us_void_param) 2)) 97)) (= (to_rep2 (select (temp___String_Literal_928 us_void_param) 3)) 109)) (= (to_rep2 (select (temp___String_Literal_928 us_void_param) 4)) 101)) (= (to_rep2 (select (temp___String_Literal_928 us_void_param) 5)) 108)) (= (to_rep2 (select (temp___String_Literal_928 us_void_param) 6)) 101)) (= (to_rep2 (select (temp___String_Literal_928 us_void_param) 7)) 115)) (= (to_rep2 (select (temp___String_Literal_928 us_void_param) 8)) 115)) :pattern ((temp___String_Literal_928 us_void_param)))))
...
(assert (forall ((p us_rep2)) (! (= (= (has_licence_to_kill p) true) (let ((temp___1007 (to_rep3 (rec__professionals__professional__profession (us_split_fields3 p))))) (or (= temp___1007 2) (= temp___1007 3)))) :pattern ((has_licence_to_kill p)))))
(assert true)
(assert true)
(assert true)
(assert true)
