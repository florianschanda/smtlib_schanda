...
(define-fun dynamic_invariant1 ((temp___expr_263 us_t1) (temp___is_init_260 Bool) (temp___skip_constant_261 Bool) (temp___do_toplevel_262 Bool)) Bool (and (=> (not (= temp___skip_constant_261 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_263) (last3 temp___expr_263))) (=> (= temp___do_toplevel_262 true) (=> (= temp___is_init_260 true) (and (let ((temp___265 (of_array2 (to_array1 temp___expr_263) (first3 temp___expr_263) (last3 temp___expr_263)))) (and (= (first5 temp___265) 1) (<= 0 (last5 temp___265)))) (<= (last3 temp___expr_263) 1000))))))
...
(declare-const temp___339 (Array Int character))
(declare-const temp___3391 t1)
(assert (in_range3 x))
