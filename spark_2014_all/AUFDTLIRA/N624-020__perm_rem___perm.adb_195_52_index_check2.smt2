...
(assert (or (and (and (and (= perm__extended_perm__result6 (mk_int__ref perm__extended_perm__result2)) (and (= ib10 ib14) (and (= ia11 ia15) (= ih10 ih14)))) (and (= perm__extended_perm__result7 perm__extended_perm__result2) (and (= ib11 ib2) (and (= ia12 ia2) (= ih11 ih1))))) (and (= (length a) 0) (and (= result (mk_int__ref perm__extended_perm__result)) (= perm__extended_perm__result2 1)))) (and (and (not (= (length a) 0)) (and (= perm__extended_perm__result2 perm__extended_perm__result) (= perm__extended_perm__result2 perm__extended_perm__result1))) (and (and (and (= perm__extended_perm__result6 perm__extended_perm__result4) (and (= ib10 ib8) (and (= ia11 ia9) (= ih10 ih8)))) (and (= perm__extended_perm__result7 perm__extended_perm__result5) (and (= ib11 ib9) (and (= ia12 ia10) (= ih11 ih9))))) (and (and (and (= perm__extended_perm__result4 (mk_int__ref perm__extended_perm__result3)) (and (= ib8 ib6) (and (= ia9 ia7) (= ih8 ih6)))) (and (= perm__extended_perm__result5 perm__extended_perm__result3) (and (= ib9 ib7) (and (= ia10 ia8) (= ih9 ih7))))) (and (and (and (= perm__extended_perm__B_6__w__assume2 (get_witnesses a b)) (and (and (<= (to_rep1 (first (rt a))) (to_rep2 perm__extended_perm__B_6__w__assume)) (<= (to_rep2 perm__extended_perm__B_6__w__assume) (to_rep1 (last (rt a))))) (and (and (<= (to_rep1 (first (rt b))) (to_rep2 perm__extended_perm__B_6__w__assume1)) (<= (to_rep2 perm__extended_perm__B_6__w__assume1) (to_rep1 (last (rt b))))) (and (= (to_rep (select (elts a) (to_rep2 perm__extended_perm__B_6__w__assume))) (to_rep (select (elts b) (to_rep2 perm__extended_perm__B_6__w__assume1)))) (= (is_perm (remove a (to_rep2 perm__extended_perm__B_6__w__assume)) (remove b (to_rep2 perm__extended_perm__B_6__w__assume1))) true))))) (= perm__extended_perm__B_6__w__assume2 w)) (and (and (and (= perm__extended_perm__B_6__aa__assume2 (remove a (to_rep2 (rec__perm__witnesses__ia (us_split_fields1 w))))) (and (dynamic_invariant perm__extended_perm__B_6__aa__assume2 true false true true) (and (= (invariant__ perm__extended_perm__B_6__aa__assume2) true) (and (= (to_rep1 (last perm__extended_perm__B_6__aa__assume1)) (- (to_rep1 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- (to_rep2 (rec__perm__witnesses__ia (us_split_fields1 w))) 1))) (= (to_rep (select (elts a) k)) (to_rep (select perm__extended_perm__B_6__aa__assume k))))) (and (forall ((k Int)) (=> (and (<= (+ (to_rep2 (rec__perm__witnesses__ia (us_split_fields1 w))) 1) k) (<= k (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select perm__extended_perm__B_6__aa__assume (- k 1)))))) (forall ((k Int)) (=> (and (<= (to_rep2 (rec__perm__witnesses__ia (us_split_fields1 w))) k) (<= k (- (to_rep1 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select perm__extended_perm__B_6__aa__assume k))))))))))) (= perm__extended_perm__B_6__aa__assume2 aa)) (and (dynamic_invariant aa true false true true) (and (and (and (= perm__extended_perm__B_6__bb__assume2 (remove b (to_rep2 (rec__perm__witnesses__ib (us_split_fields1 w))))) (and (dynamic_invariant perm__extended_perm__B_6__bb__assume2 true false true true) (and (= (invariant__ perm__extended_perm__B_6__bb__assume2) true) (and (= (to_rep1 (last perm__extended_perm__B_6__bb__assume1)) (- (to_rep1 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- (to_rep2 (rec__perm__witnesses__ib (us_split_fields1 w))) 1))) (= (to_rep (select (elts b) k)) (to_rep (select perm__extended_perm__B_6__bb__assume k))))) (and (forall ((k Int)) (=> (and (<= (+ (to_rep2 (rec__perm__witnesses__ib (us_split_fields1 w))) 1) k) (<= k (to_rep1 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select perm__extended_perm__B_6__bb__assume (- k 1)))))) (forall ((k Int)) (=> (and (<= (to_rep2 (rec__perm__witnesses__ib (us_split_fields1 w))) k) (<= k (- (to_rep1 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select perm__extended_perm__B_6__bb__assume k))))))))))) (= perm__extended_perm__B_6__bb__assume2 bb)) (and (dynamic_invariant bb true false true true) (and (and (and (= o (extended_perm aa bb)) (and (in_range4 o) (=> (= (distinct o 0) true) (forall ((ia16 Int)) (=> (and (<= (to_rep1 (first (rt aa))) ia16) (<= ia16 (to_rep1 (last (rt aa))))) (exists ((ib15 Int)) (and (and (<= (to_rep1 (first (rt bb))) ib15) (<= ib15 (to_rep1 (last (rt bb))))) (and (= (to_rep (select (elts aa) ia16)) (to_rep (select (elts bb) ib15))) (= (is_perm (remove aa ia16) (remove bb ib15)) true))))))))) (and (= result1 ih14) (= ih2 o))) (and (in_range4 ih2) (and (= (distinct ih2 0) true) (and (and (and (= result2 ia15) (= ia3 (to_rep1 (first (rt a))))) (ite (and (<= (to_rep1 (first (rt a))) ia3) (<= ia3 (to_rep1 (last (rt a))))) (and (and (and (= temp___661 ib) (and (= temp___660 ia3) (and (= temp___659 ih2) (and (exists ((ib15 Int)) (and (and (<= (to_rep1 (first (rt b))) ib15) (<= ib15 (to_rep1 (last (rt b))))) (and (= (to_rep (select (elts a) ia3)) (to_rep (select (elts b) ib15))) (= (is_perm (remove a ia3) (remove b ib15)) true)))) (and (=> (<= (to_rep1 (first (rt a))) (to_rep1 (last (rt a)))) (dynamic_property1 (to_rep1 (first (rt a))) (to_rep1 (last (rt a))) ia3)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k ia4)) (exists ((ib15 Int)) (and (and (<= (to_rep1 (first (rt b))) ib15) (<= ib15 (to_rep1 (last (rt b))))) (and (= (to_rep (select (elts a) k)) (to_rep (select (elts b) ib15))) (= (is_perm (remove a k) (remove b ib15)) true)))))) (and (and (and (and (=> (<= 1 1) (in_range4 ih3)) (=> (<= (to_rep1 (first (rt a))) (to_rep1 (last (rt a)))) (dynamic_property1 (to_rep1 (first (rt a))) (to_rep1 (last (rt a))) ia4))) (=> (<= 1 100) (in_range3 ib3))) (and (<= (to_rep1 (first (rt a))) ia4) (<= ia4 (to_rep1 (last (rt a)))))) (= ia4 (to_rep1 (last (rt a))))))))))) (and (and (= ib4 (mk_int__ref ib3)) (and (= ia5 (mk_int__ref ia4)) (= ih4 (mk_int__ref ih3)))) (and (= ib5 ib3) (and (= ia6 ia4) (= ih5 ih3))))) (and (and (= ib6 ib4) (and (= ia7 ia5) (= ih6 ih4))) (and (= ib7 ib5) (and (= ia8 ia6) (= ih7 ih5))))) (and (and (= ib6 ib14) (and (= ia7 (mk_int__ref ia3)) (= ih6 (mk_int__ref ih2)))) (and (= ib7 ib2) (and (= ia8 ia3) (= ih7 ih2)))))) (and (= result3 (mk_int__ref perm__extended_perm__result2)) (= perm__extended_perm__result3 (int__content ih6)))))))))))))))))
...
(assert (= ia14 ia12))
(assert (= ih13 ih11))
(assert (= (distinct (int__content perm__extended_perm__result8) 0) true))
...
(assert (= o1 ib1))
(assert (= o2 (select (elts b) o1)))
(assert (= o3 (to_rep o2)))
(assert (not (<= (to_rep1 (first (rt a))) ia1)))
(check-sat)
(exit)
