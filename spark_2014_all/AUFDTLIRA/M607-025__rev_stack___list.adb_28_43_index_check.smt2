...
(assert (and (= o12 (to__ (mk___rep s__split_fields4))) (and (dynamic_invariant1 o12 true false true true) (and (= (to_rep (first o7)) 1) (<= 0 (to_rep (last o7)))))))
...
(assert (= o3 (+ o2 1)))
(assert (and (= temp___519 o3) (in_range1 o3)))
(assert (not (<= (to_rep (first temp___5181)) temp___519)))
(check-sat)
(exit)
