...
(assert (and (= o12 (to__ (mk___rep s__split_fields4))) (and (dynamic_invariant1 o12 true false true) (and (= (to_rep (first o7)) 1) (<= 0 (to_rep (last o7)))))))
...
(assert (not (<= (to_rep (first temp___4721)) temp___473)))
(check-sat)
(exit)
