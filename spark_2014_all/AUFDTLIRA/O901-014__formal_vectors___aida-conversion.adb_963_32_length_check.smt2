...
(assert (and (= (length source) 5) (forall ((index Int)) (=> (and (<= (to_rep1 (first (rt source))) index) (<= index (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index))) true)))))
...
(assert (not (= (ite (<= (to_rep1 (first4 temp___17821)) (to_rep1 (last4 temp___17821))) (+ (- (to_rep1 (last4 temp___17821)) (to_rep1 (first4 temp___17821))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 4)) (+ (- (+ (to_rep1 (first (rt source))) 4) (to_rep1 (first (rt source)))) 1) 0))))
(check-sat)
(exit)
