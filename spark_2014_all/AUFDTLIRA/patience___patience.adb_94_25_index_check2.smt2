...
(assert (= o112 i1))
(assert (= o113 (select (rec__patience__state__posstack (us_split_fields__content s__split_fields20)) o112)))
(assert (= o114 (to_rep o113)))
(assert (= o115 (ite (<= o114 (- (to_rep (rec__patience__state__numstacks (us_split_fields__content s__split_fields20))) 1)) true false)))
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o109 i1))
(assert (= o110 (select (rec__patience__state__posstack (us_split_fields__content s__split_fields20)) o109)))
(assert (= o111 (to_rep o110)))
(assert (= o116 (ite (<= 0 o111) true false)))
(assert (= result22 (ite (= o116 true) o115 false)))
