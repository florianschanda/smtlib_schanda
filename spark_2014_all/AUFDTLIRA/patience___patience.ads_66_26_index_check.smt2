...
(assert (<= 0 (to_rep (rec__patience__state__numstacks (us_split_fields1 s)))))
(assert (<= (to_rep (rec__patience__state__numstacks (us_split_fields1 s))) (to_rep (rec__patience__state__numelts (us_split_fields1 s)))))
(assert (<= (to_rep (rec__patience__state__numelts (us_split_fields1 s))) 100))
(assert (or (= (to_rep (rec__patience__state__numelts (us_split_fields1 s))) 0) (< 0 (to_rep (rec__patience__state__numstacks (us_split_fields1 s))))))
(assert (<= 0 i))
...
(assert (= (= o5 true) (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 (- (to_rep (select (rec__patience__state__stacksizes (us_split_fields1 s)) i)) 1))) (and (<= 0 (to_rep (select (select (rec__patience__state__stacks (us_split_fields1 s)) i) j1))) (< (to_rep (select (select (rec__patience__state__stacks (us_split_fields1 s)) i) j1)) (to_rep (rec__patience__state__numelts (us_split_fields1 s)))))))))
(assert (not (<= i 99)))
(check-sat)
(exit)
