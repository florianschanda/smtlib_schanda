...
(assert (= result (ite (<= 0 j) o4 false)))
(assert (= (= o5 true) (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 (- (to_rep1 (select (rec__patience__state__stacksizes (us_split_fields1 s)) i)) 1))) (and (<= 0 (to_rep1 (select (select (rec__patience__state__stacks (us_split_fields1 s)) i) j1))) (< (to_rep1 (select (select (rec__patience__state__stacks (us_split_fields1 s)) i) j1)) (to_rep1 (rec__patience__state__numelts (us_split_fields1 s)))))))))
(assert (not (<= 0 i)))
(check-sat)
(exit)
