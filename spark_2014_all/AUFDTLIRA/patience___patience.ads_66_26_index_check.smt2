...
(assert (<= 0 (to_rep1 (rec__patience__state__numstacks (us_split_fields1 s)))))
(assert (<= (to_rep1 (rec__patience__state__numstacks (us_split_fields1 s))) (to_rep1 (rec__patience__state__numelts (us_split_fields1 s)))))
(assert (<= (to_rep1 (rec__patience__state__numelts (us_split_fields1 s))) 100))
(assert (or (= (to_rep1 (rec__patience__state__numelts (us_split_fields1 s))) 0) (< 0 (to_rep1 (rec__patience__state__numstacks (us_split_fields1 s))))))
(assert (<= 0 i4))
(assert (<= i4 (- (to_rep1 (rec__patience__state__numstacks (us_split_fields1 s))) 1)))
(assert (and (<= 0 i4) (<= i4 99)))
(assert (= o115 i4))
(assert (= o116 (select (rec__patience__state__stacksizes (us_split_fields1 s)) o115)))
(assert (= o117 (to_rep1 o116)))
(assert (= o118 (- o117 1)))
(assert (= o119 (ite (<= j2 o118) true false)))
(assert (= result5 (ite (<= 0 j2) o119 false)))
(assert (= (= o126 true) (forall ((j3 Int)) (=> (and (<= 0 j3) (<= j3 (- (to_rep1 (select (rec__patience__state__stacksizes (us_split_fields1 s)) i4)) 1))) (and (<= 0 (to_rep1 (select (select (rec__patience__state__stacks (us_split_fields1 s)) i4) j3))) (< (to_rep1 (select (select (rec__patience__state__stacks (us_split_fields1 s)) i4) j3)) (to_rep1 (rec__patience__state__numelts (us_split_fields1 s)))))))))
(assert (not (<= 0 i4)))
(check-sat)
(exit)
