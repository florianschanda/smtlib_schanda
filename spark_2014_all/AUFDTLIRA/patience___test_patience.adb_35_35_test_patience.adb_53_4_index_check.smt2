...
(assert (=> (= (length (mk___t temp___809 temp___8091)) 0) (= (elts (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep3 (select (rec__patience__state__stacksizes (us_split_fields1 c60b)) i16))))) temp___812)))
(assert (=> (= (length (mk___t temp___809 temp___8091)) 0) (= (mk (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep3 (select (rec__patience__state__stacksizes (us_split_fields1 c60b)) i16))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep3 (select (rec__patience__state__stacksizes (us_split_fields1 c60b)) i16)))))))) temp___8121)))
(assert (=> (not (= (length (mk___t temp___809 temp___8091)) 0)) (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep3 (select (rec__patience__state__stacksizes (us_split_fields1 c60b)) i16))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep3 (select (rec__patience__state__stacksizes (us_split_fields1 c60b)) i16)))))))) (= o62 (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep3 (select (rec__patience__state__stacksizes (us_split_fields1 c60b)) i16))))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep3 (select (rec__patience__state__stacksizes (us_split_fields1 c60b)) i16)))))))) 1)))))
(assert (=> (not (= (length (mk___t temp___809 temp___8091)) 0)) (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep3 (select (rec__patience__state__stacksizes (us_split_fields1 c60b)) i16))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep3 (select (rec__patience__state__stacksizes (us_split_fields1 c60b)) i16))))))))) (= o62 0))))
(assert (=> (not (= (length (mk___t temp___809 temp___8091)) 0)) (=> (<= (to_rep1 (first temp___8091)) (to_rep1 (last temp___8091))) (= o63 (+ (- (to_rep1 (last temp___8091)) (to_rep1 (first temp___8091))) 1)))))
(assert (=> (not (= (length (mk___t temp___809 temp___8091)) 0)) (=> (not (<= (to_rep1 (first temp___8091)) (to_rep1 (last temp___8091)))) (= o63 0))))
(assert (=> (not (= (length (mk___t temp___809 temp___8091)) 0)) (= o64 (+ o63 o62))))
(assert (=> (not (= (length (mk___t temp___809 temp___8091)) 0)) (= o65 (+ (to_rep1 (first temp___8091)) o64))))
(assert (=> (not (= (length (mk___t temp___809 temp___8091)) 0)) (= o66 (- o65 1))))
(assert (=> (not (= (length (mk___t temp___809 temp___8091)) 0)) (and (= o67 o66) (in_range2 o66))))
(assert (=> (not (= (length (mk___t temp___809 temp___8091)) 0)) (= (concat1 temp___809 (to_rep1 (first temp___8091)) (to_rep1 (last temp___8091)) (elts (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep3 (select (rec__patience__state__stacksizes (us_split_fields1 c60b)) i16))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep3 (select (rec__patience__state__stacksizes (us_split_fields1 c60b)) i16))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep3 (select (rec__patience__state__stacksizes (us_split_fields1 c60b)) i16)))))))) temp___812)))
(assert (=> (not (= (length (mk___t temp___809 temp___8091)) 0)) (= (mk (to_rep1 (first temp___8091)) o67) temp___8121)))
(assert (=> (= (length (mk___t temp___812 temp___8121)) 0) (= o74 (mk___t (temp___String_Literal_811 Tuple0) (mk 1 2)))))
(assert (=> (not (= (length (mk___t temp___812 temp___8121)) 0)) (=> (<= 1 2) (= o68 (+ (- 2 1) 1)))))
(assert (=> (not (= (length (mk___t temp___812 temp___8121)) 0)) (=> (not (<= 1 2)) (= o68 0))))
(assert (=> (not (= (length (mk___t temp___812 temp___8121)) 0)) (=> (<= (to_rep1 (first temp___8121)) (to_rep1 (last temp___8121))) (= o69 (+ (- (to_rep1 (last temp___8121)) (to_rep1 (first temp___8121))) 1)))))
(assert (=> (not (= (length (mk___t temp___812 temp___8121)) 0)) (=> (not (<= (to_rep1 (first temp___8121)) (to_rep1 (last temp___8121)))) (= o69 0))))
(assert (=> (not (= (length (mk___t temp___812 temp___8121)) 0)) (= o70 (+ o69 o68))))
(assert (=> (not (= (length (mk___t temp___812 temp___8121)) 0)) (= o71 (+ (to_rep1 (first temp___8121)) o70))))
(assert (=> (not (= (length (mk___t temp___812 temp___8121)) 0)) (= o72 (- o71 1))))
(assert (=> (not (= (length (mk___t temp___812 temp___8121)) 0)) (and (= o73 o72) (in_range2 o72))))
(assert (=> (not (= (length (mk___t temp___812 temp___8121)) 0)) (= o74 (mk___t (concat1 temp___812 (to_rep1 (first temp___8121)) (to_rep1 (last temp___8121)) (temp___String_Literal_811 Tuple0) 1 2) (mk (to_rep1 (first temp___8121)) o73)))))
