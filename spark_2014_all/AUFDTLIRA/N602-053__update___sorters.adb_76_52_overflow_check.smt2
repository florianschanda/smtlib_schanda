...
(assert (and (= temp___214 (- (to_rep values__last) 1)) (in_range1 (- (to_rep values__last) 1))))
(assert (= result current))
(assert (= current1 (to_rep values__first)))
(assert (<= (to_rep values__first) current1))
(assert (<= current1 temp___214))
...
(assert (= o values))
(assert (= o temp___207))
(assert (= (mk1 current1 (to_rep values__last)) temp___2071))
(assert (= temp___207 o1))
(assert (= (mk (to_rep (first2 temp___2071)) (to_rep (last2 temp___2071))) o2))
...
(assert (forall ((j Int)) (=> (and (<= (to_rep values__first) j) (<= j (- current2 1))) (<= (to_rep (select values3 j)) (to_rep (select values3 (+ j 1)))))))
