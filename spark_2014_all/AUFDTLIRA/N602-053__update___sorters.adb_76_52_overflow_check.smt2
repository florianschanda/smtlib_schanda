...
(assert (and (= temp___188 (- (to_rep values__last) 1)) (in_range1 (- (to_rep values__last) 1))))
...
(assert (= (mk (to_rep (first2 temp___1811)) (to_rep (last2 temp___1811))) o2))
