...
(assert (=> (not (= first_available 0)) (and (= o35 (length model____split_fields)) (in_range3 o35))))
(assert (=> (not (= first_available 0)) (= result3 (ite (< 0 o35) true false))))
(assert (=> (not (= first_available 0)) (=> (= result3 true) (and (= o34 (get model____split_fields 1)) (in_range4 o34)))))
(assert (=> (not (= first_available 0)) (=> (= result3 true) (= result2 (ite (= o34 first_available) true false)))))
(assert (=> (not (= first_available 0)) (=> (not (= result3 true)) (= result2 false))))
(assert (=> (not (not (= first_available 0))) (and (= o36 (length model____split_fields)) (in_range3 o36))))
(assert (=> (not (not (= first_available 0))) (= result2 (ite (= o36 0) true false))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (and (= o32 (length model____split_fields1)) (in_range3 o32)))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (= result4 (ite (< 0 o32) true false)))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (=> (= result4 true) (and (= o31 (get model____split_fields1 1)) (in_range4 o31))))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (=> (= result4 true) (= result1 (ite (= o31 first_allocated) true false))))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (=> (not (= result4 true)) (= result1 false)))))
(assert (=> (= result2 true) (=> (not (not (= first_allocated 0))) (and (= o33 (length model____split_fields1)) (in_range3 o33)))))
(assert (=> (= result2 true) (=> (not (not (= first_allocated 0))) (= result1 (ite (= o33 0) true false)))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (=> (= result1 true) (and (= o29 (length model____split_fields)) (in_range3 o29))))
(assert (=> (= result1 true) (= o30 (ite (<= j1 o29) true false))))
(assert (=> (= result1 true) (= result5 (ite (<= 1 j1) o30 false))))
...
(assert (= result6 true))
(assert (and (= o28 (get model____split_fields1 j)) (in_range4 o28)))
(assert (= result9 (ite (in_range6 o28) true false)))
(assert (=> (= result9 true) (and (= o24 (length model____split_fields1)) (in_range3 o24))))
(assert (=> (= result9 true) (= result10 (ite (< j o24) true false))))
(assert (=> (= result9 true) (=> (= result10 true) (and (= o25 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result9 true) (=> (= result10 true) (and (= o26 (get model____split_fields1 o25)) (in_range4 o26)))))
(assert (=> (= result9 true) (=> (not (= result10 true)) (= o26 0))))
...
(assert (=> (= result9 true) (= o16 temp___420)))
(assert (=> (= result9 true) (= (mk___rep (mk___split_fields o17 o18 o19)) (select data o16))))
(assert (=> (= result9 true) (= o17 o20)))
(assert (=> (= result9 true) (= o18 o21)))
(assert (=> (= result9 true) (= o19 o22)))
(assert (=> (= result9 true) (= o23 o22)))
(assert (=> (= result9 true) (= o27 (to_rep o23))))
(assert (=> (= result9 true) (= result8 (ite (= o27 o26) true false))))
(assert (=> (not (= result9 true)) (= result8 false)))
(assert (=> (= result8 true) (=> (< 1 j) (and (= o13 (- j 1)) (in_range2 (- j 1))))))
(assert (=> (= result8 true) (=> (< 1 j) (and (= o14 (get model____split_fields1 o13)) (in_range4 o14)))))
(assert (=> (= result8 true) (=> (not (< 1 j)) (= o14 0))))
...
(assert (=> (= result8 true) (= o5 temp___421)))
(assert (=> (= result8 true) (= (mk___rep (mk___split_fields o6 o7 o8)) (select data o5))))
(assert (=> (= result8 true) (= o6 o9)))
(assert (=> (= result8 true) (= o7 o10)))
(assert (=> (= result8 true) (= o8 o11)))
(assert (=> (= result8 true) (= o12 o10)))
(assert (=> (= result8 true) (= o15 (to_rep o12))))
...
(assert (not (= j k)))
(assert (and (= o4 (get model____split_fields1 k)) (in_range4 o4)))
(assert (not (<= 1 j)))
(check-sat)
(exit)
