...
(assert (<= 1 i))
(assert (<= i 100))
(assert (not (or (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res1 i)))) 100) (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res1 i)))) n1))))
(check-sat)
(exit)
