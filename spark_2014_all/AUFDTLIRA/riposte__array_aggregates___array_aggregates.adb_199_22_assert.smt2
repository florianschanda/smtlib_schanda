...
(define-fun bool_eq1 ((a (Array Int us_rep)) (a__first Int) (a__last Int) (b (Array Int us_rep)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_146 Int)) (=> (and (<= a__first temp___idx_146) (<= temp___idx_146 a__last)) (= (bool_eq (select a temp___idx_146) (select b (+ (- b__first a__first) temp___idx_146))) true)))) true false))
(assert (forall ((a (Array Int us_rep)) (b (Array Int us_rep))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq1 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_146 Int)) (=> (and (<= a__first temp___idx_146) (<= temp___idx_146 a__last)) (= (bool_eq (select a temp___idx_146) (select b (+ (- b__first a__first) temp___idx_146))) true))))))))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-fun temp___466 (us_rep us_rep) (Array Int us_rep))
(assert (forall ((temp___468 us_rep) (temp___469 us_rep)) (let ((temp___467 (temp___466 temp___468 temp___469))) (forall ((temp___470 Int)) (ite (or (= temp___470 2) (and (<= 4 temp___470) (<= temp___470 6))) (= (select temp___467 temp___470) temp___468) (= (select temp___467 temp___470) temp___469))))))
...
(define-fun dynamic_invariant1 ((temp___expr_267 Int) (temp___is_init_264 Bool) (temp___skip_constant_265 Bool) (temp___do_toplevel_266 Bool)) Bool (=> (or (= temp___is_init_264 true) (<= 1 1000)) (in_range2 temp___expr_267)))
...
(assert (= o14 o3))
(assert (= o15 o4))
(assert (= o16 (temp___466 (mk___rep (mk___split_fields o13 o14 o15)) (mk___rep (mk___split_fields o10 o11 o12)))))
(assert (= result x))
(assert (= x1 o16))
(assert (not (= (to_rep (rec__array_aggregates__basic_record__c (us_split_fields1 (select x1 3)))) 1)))
(check-sat)
(exit)
