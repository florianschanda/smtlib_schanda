...
(declare-fun temp___515 (us_rep us_rep) (Array Int us_rep))
...
(assert (forall ((temp___517 us_rep) (temp___518 us_rep)) (let ((temp___516 (temp___515 temp___517 temp___518))) (forall ((temp___519 Int)) (ite (or (= temp___519 2) (and (<= 4 temp___519) (<= temp___519 6))) (= (select temp___516 temp___519) temp___517) (= (select temp___516 temp___519) temp___518))))))
...
(assert (= o14 o3))
(assert (= o15 o4))
(assert (= o16 (temp___515 (mk___rep (mk___split_fields o13 o14 o15)) (mk___rep (mk___split_fields o10 o11 o12)))))
(assert (= result x))
(assert (= x1 o16))
