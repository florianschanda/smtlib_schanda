...
(assert (forall ((i tarray_typeD1)) (and (<= 1 (tarray_typeD1qtint i)) (<= (tarray_typeD1qtint i) 10))))
...
(assert (forall ((temp___174 Int)) (=> (dynamic_invariant2 temp___174 true true true true) (forall ((temp___175 Int)) (= (select (integer_arrays__make_unique__result__aggregate_def temp___174) temp___175) rliteral)))))
...
(assert (= i2 result6))
(assert (= i3 (+ i2 1)))
(assert (= (= result7 true) (forall ((j Int)) (=> (and (<= 1 j) (<= j result_index3)) (not (= (to_rep (select result__3 j)) (to_rep (select arr i3))))))))
