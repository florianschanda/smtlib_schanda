...
(assert (<= result_index3 i2))
(assert (<= result_index3 1))
(assert (and (and (=> (<= 0 2147483647) (in_range2 result_index3)) (=> (<= 1 10) (in_range5 i2))) (and (<= 1 i2) (<= i2 10))))
(assert (not (= i2 10)))
(assert (= i2 result6))
(assert (= i3 (+ i2 1)))
(assert (= (= result7 true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 result_index3)) (not (= (to_rep (select result__3 j2)) (to_rep (select arr i3))))))))
(assert (=> (= result7 true) (and (= o4 (+ result_index3 1)) (in_range1 (+ result_index3 1)))))
(assert (=> (= result7 true) (= result_index3 result8)))
(assert (=> (= result7 true) (= result_index4 o4)))
(assert (=> (= result7 true) (and (<= 1 result_index4) (<= result_index4 10))))
(assert (=> (= result7 true) (= (to_rep o5) (to_rep (select arr i3)))))
(assert (=> (= result7 true) (and (<= 1 result_index4) (<= result_index4 10))))
(assert (=> (= result7 true) (= o6 result_index4)))
(assert (=> (= result7 true) (= o7 (store result__3 o6 o5))))
(assert (=> (= result7 true) (= result9 result__3)))
(assert (=> (= result7 true) (= result__4 o7)))
(assert (=> (not (= result7 true)) (= result_index4 result_index3)))
(assert (=> (not (= result7 true)) (= result__4 result__3)))
(assert (not (<= result_index4 1)))
(check-sat)
(exit)
