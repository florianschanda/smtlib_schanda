...
(declare-const temp___1191 natural_index)
(declare-const temp___11911 natural_index)
(declare-const temp___11912 (Array Int character))
(declare-const temp___11913 t2)
(declare-const o14 natural_index)
(declare-const o15 natural_index)
(declare-const o16 (Array Int character))
(declare-const o17 t2)
(declare-const temp___1193 us_rep)
(declare-const result us_split_fields__ref)
(declare-const to____split_fields3 us_split_fields)
(define-fun temp___11904 () us_rep (mk___rep (mk___split_discrs temp___1190) (mk___split_fields temp___11901 (mk___t2 temp___11902 temp___11903))))
...
(assert (dynamic_predicate temp___11904))
(assert (= (mk___rep (mk___split_discrs temp___1191) (mk___split_fields temp___11911 (mk___t2 temp___11912 temp___11913))) temp___11904))
(assert (= result (mk___split_fields__ref (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2)))))
(assert (= to____split_fields3 (mk___split_fields temp___11911 (mk___t2 temp___11912 temp___11913))))
(assert (= to____split_discrs (mk___split_discrs temp___1191)))
(assert (= (to_rep2 o14) new_length))
(assert (= o14 o15))
(assert (= (rec__bounded_dynamic_strings__sequence__content to____split_fields3) (mk___t2 o16 o17)))
(assert (= temp___1193 (mk___rep to____split_discrs (mk___split_fields o15 (mk___t2 o16 o17)))))
(assert (not (dynamic_predicate temp___1193)))
(check-sat)
(exit)
