...
(assert (dynamic_predicate (mk___rep (mk___split_discrs temp___1127) (mk___split_fields temp___11271 (mk___t2 temp___11272 temp___11273)))))
(assert (= (mk___rep (mk___split_discrs temp___1128) (mk___split_fields temp___11281 (mk___t2 temp___11282 temp___11283))) (mk___rep (mk___split_discrs temp___1127) (mk___split_fields temp___11271 (mk___t2 temp___11272 temp___11273)))))
...
(assert (= to____split_fields3 (mk___split_fields temp___11281 (mk___t2 temp___11282 temp___11283))))
(assert (= to____split_discrs (mk___split_discrs temp___1128)))
(assert (= (to_rep2 o20) new_length))
(assert (= o20 o21))
(assert (= (rec__bounded_dynamic_strings__sequence__content to____split_fields3) (mk___t2 o22 o23)))
(assert (= temp___1130 (mk___rep to____split_discrs (mk___split_fields o21 (mk___t2 o22 o23)))))
(assert (not (dynamic_predicate temp___1130)))
(check-sat)
(exit)
