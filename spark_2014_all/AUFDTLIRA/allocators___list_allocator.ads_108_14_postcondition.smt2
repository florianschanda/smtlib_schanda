...
(assert (=> (= result true) (= temp___331 o16)))
(assert (=> (= result true) (= temp___3311 o17)))
...
(assert (=> (= result true) (= model____split_fields4 (mk___split_fields1 temp___331 temp___3311))))
...
(assert (=> (= result true) (= temp___333 o19)))
(assert (=> (= result true) (= temp___3331 o20)))
(assert (=> (= result true) (= result5 (mk___split_fields__ref1 model____split_fields4))))
(assert (=> (= result true) (= model____split_fields5 (mk___split_fields1 temp___333 temp___3331))))
