...
(define-fun dynamic_invariant1 ((temp___expr_166 Int) (temp___is_init_163 Bool) (temp___skip_constant_164 Bool) (temp___do_toplevel_165 Bool)) Bool (=> (or (= temp___is_init_163 true) (<= 1 2147483647)) (in_range3 temp___expr_166)))
...
(define-fun dynamic_invariant2 ((temp___expr_172 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= 0 10000)) (in_range4 temp___expr_172)))
...
(define-fun dynamic_invariant3 ((temp___expr_191 Int) (temp___is_init_188 Bool) (temp___skip_constant_189 Bool) (temp___do_toplevel_190 Bool)) Bool (=> (or (= temp___is_init_188 true) (<= 0 10000)) (in_range6 temp___expr_191)))
...
(assert (forall ((container us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant3 item true true true) (=> (= (of_int 1) true) (=> (exists ((e Int)) (and (and (in_range6 e) (= (contains container e) true)) (= e item))) (= (contains container item) true)))) :pattern ((contains container item))))))
...
(assert (forall ((container us_rep2)) (forall ((item Int)) (! (=> (and (dynamic_invariant3 item true true true) (= (contains container item) true)) (let ((result (remove container item))) (and (and (and (= (length1 result) (- (length1 container) 1)) (not (= (contains result item) true))) (= (ole result container) true)) (= (included_except container result item) true)))) :pattern ((remove container item))))))
...
(define-fun default_initial_assumption2 ((temp___expr_211 us_rep3) (temp___skip_top_level_212 Bool)) Bool (and (= (length (rec__list_allocator__m__t__available (us_split_fields3 temp___expr_211))) 0) (= (is_empty (rec__list_allocator__m__t__allocated (us_split_fields3 temp___expr_211))) true)))
...
(define-fun dynamic_invariant4 ((temp___expr_228 Int) (temp___is_init_225 Bool) (temp___skip_constant_226 Bool) (temp___do_toplevel_227 Bool)) Bool (=> (or (= temp___is_init_225 true) (<= 0 1)) (in_range2 temp___expr_228)))
(define-fun dynamic_invariant5 ((temp___expr_154 Int) (temp___is_init_151 Bool) (temp___skip_constant_152 Bool) (temp___do_toplevel_153 Bool)) Bool (=> (or (= temp___is_init_151 true) (<= 1 10000)) (in_range1 temp___expr_154)))
(assert true)
...
(define-fun dynamic_invariant6 ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= 0 2147483647)) (in_range7 temp___expr_142)))
...
(define-fun dynamic_invariant7 ((temp___expr_178 Int) (temp___is_init_175 Bool) (temp___skip_constant_176 Bool) (temp___do_toplevel_177 Bool)) Bool (=> (or (= temp___is_init_175 true) (<= 0 2147483647)) (in_range8 temp___expr_178)))
(assert (forall ((container us_rep1)) (! (let ((result (length container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant6 result true false true))) :pattern ((length container)))))
(assert (forall ((container us_rep1)) (forall ((position Int)) (! (=> (and (dynamic_invariant7 position true true true) (and (<= 1 position) (<= position (last container)))) (dynamic_invariant2 (get container position) true false true)) :pattern ((get container position))))))
(assert (forall ((container us_rep2)) (! (dynamic_invariant6 (length1 container) true false true) :pattern ((length1 container)))))
...
(assert (forall ((left us_rep2) (right us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant3 item true true true) (= (= (included_except left right item) true) (forall ((e Int)) (=> (and (in_range6 e) (= (contains left e) true)) (or (= (contains right e) true) (= e item)))))) :pattern ((included_except left right item))))))
...
(declare-const temp___294 us_rep1)
(declare-const temp___2941 us_rep2)
(declare-const o18 us_rep1)
(declare-const o19 us_rep1)
(declare-const o20 us_rep2)
(declare-const temp___296 us_rep1)
(declare-const temp___2961 us_rep2)
(declare-const model____split_fields2 us_rep1)
(declare-const model____split_fields3 us_rep2)
...
(assert (=> (= result true) (= o14 (store data o13 (mk___rep (mk___split_fields o11 o12))))))
(assert (=> (= result true) (= (mk_map__ref result1) (mk_map__ref data))))
(assert (=> (= result true) (= data2 o14)))
(assert (=> (= result true) (= (mk_int__ref result2) (mk_int__ref first_available))))
(assert (=> (= result true) (= first_available2 res)))
(assert (=> (= result true) (and (= o15 (remove model____split_fields1 res)) (and (and (and (= (length1 o15) (- (length1 model____split_fields1) 1)) (not (= (contains o15 res) true))) (= (ole o15 model____split_fields1) true)) (= (included_except model____split_fields1 o15 res) true)))))
(assert (=> (= result true) (= model____split_fields o16)))
(assert (=> (= result true) (= o15 o17)))
(assert (=> (= result true) (= temp___294 o16)))
(assert (=> (= result true) (= temp___2941 o17)))
(assert (=> (= result true) (= (mk___split_fields__ref1 (mk___split_fields1 result3 result4)) (mk___split_fields__ref1 (mk___split_fields1 model____split_fields model____split_fields1)))))
(assert (=> (= result true) (= model____split_fields4 (mk___split_fields1 temp___294 temp___2941))))
(assert (=> (= result true) (and (= o18 (add__2 (rec__list_allocator__m__t__available model____split_fields4) 1 res)) (and (= (length o18) (+ (length (rec__list_allocator__m__t__available model____split_fields4)) 1)) (and (= (get o18 1) res) (and (= (range_equal (rec__list_allocator__m__t__available model____split_fields4) o18 1 (- 1 1)) true) (= (range_shifted (rec__list_allocator__m__t__available model____split_fields4) o18 1 (last (rec__list_allocator__m__t__available model____split_fields4)) 1) true)))))))
(assert (=> (= result true) (= o18 o19)))
(assert (=> (= result true) (= (rec__list_allocator__m__t__allocated model____split_fields4) o20)))
(assert (=> (= result true) (= temp___296 o19)))
(assert (=> (= result true) (= temp___2961 o20)))
(assert (=> (= result true) (= result5 (mk___split_fields__ref1 model____split_fields4))))
(assert (=> (= result true) (= model____split_fields5 (mk___split_fields1 temp___296 temp___2961))))
(assert (=> (not (= result true)) (= first_available2 first_available)))
(assert (=> (not (= result true)) (= data2 data)))
(assert (=> (not (= result true)) (= model____split_fields5 (mk___split_fields1 model____split_fields model____split_fields1))))
(assert (=> (not (= result true)) (= first_available2 first_available1)))
(assert (=> (not (= result true)) (= data2 data1)))
(assert (=> (not (= result true)) (= model____split_fields5 (mk___split_fields1 model____split_fields2 model____split_fields3))))
(assert (= first_available3 (mk_int__ref first_available2)))
(assert (= data3 (mk_map__ref data2)))
(assert (= model____split_fields6 (mk___split_fields__ref1 model____split_fields5)))
(assert (= first_available4 first_available2))
(assert (= data4 data2))
(assert (= model____split_fields7 model____split_fields5))
(assert (=> (= (contains model____split_fields1 res) true) (and (= (is_prepend model____split_fields res (rec__list_allocator__m__t__available (us_split_fields__content1 model____split_fields6))) true) (= (is_add (rec__list_allocator__m__t__allocated (us_split_fields__content1 model____split_fields6)) res model____split_fields1) true))))
(assert (=> (not (= (contains model____split_fields1 res) true)) (= (oeq1 (mk___rep1 (us_split_fields__content1 model____split_fields6)) (mk___rep1 (mk___split_fields1 model____split_fields model____split_fields1))) true)))
(assert (not (= (is_valid (map__content data3) (int__content first_available3) (us_split_fields__content1 model____split_fields6)) true)))
(check-sat)
(exit)
