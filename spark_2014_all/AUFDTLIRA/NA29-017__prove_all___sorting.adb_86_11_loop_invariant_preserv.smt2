...
(assert (=> (= result2 true) (= o42 temp___259)))
(assert (=> (= result2 true) (= o43 (select a o42))))
(assert (=> (= result2 true) (= o44 (to_rep o43))))
(assert (=> (= result2 true) (= (to_rep o45) o44)))
(assert (=> (= result2 true) (and (= o40 (+ i2 j2)) (in_range1 (+ i2 j2)))))
(assert (=> (= result2 true) (= o41 (+ (to_rep b__first) o40))))
(assert (=> (= result2 true) (and (= temp___260 o41) (in_range1 o41))))
(assert (=> (= result2 true) (and (<= (to_rep b__first) temp___260) (<= temp___260 (to_rep b__last)))))
(assert (=> (= result2 true) (= o46 temp___260)))
(assert (=> (= result2 true) (= o47 (store b1 o46 o45))))
(assert (=> (= result2 true) (= b1 result3)))
(assert (=> (= result2 true) (= b2 o47)))
(assert (=> (= result2 true) (and (= o48 (+ i2 1)) (in_range1 (+ i2 1)))))
(assert (=> (= result2 true) (= i2 result4)))
(assert (=> (= result2 true) (= i3 o48)))
(assert (=> (= result2 true) (= j3 j2)))
(assert (=> (not (= result2 true)) (and (= o51 (+ a_first length1)) (in_range1 (+ a_first length1)))))
(assert (=> (not (= result2 true)) (= o52 (+ o51 j2))))
(assert (=> (not (= result2 true)) (and (= temp___255 o52) (in_range1 o52))))
(assert (=> (not (= result2 true)) (and (<= (to_rep a__first) temp___255) (<= temp___255 (to_rep a__last)))))
(assert (=> (not (= result2 true)) (= o53 temp___255)))
(assert (=> (not (= result2 true)) (= o54 (select a o53))))
(assert (=> (not (= result2 true)) (= o55 (to_rep o54))))
(assert (=> (not (= result2 true)) (= (to_rep o56) o55)))
(assert (=> (not (= result2 true)) (and (= o49 (+ i2 j2)) (in_range1 (+ i2 j2)))))
(assert (=> (not (= result2 true)) (= o50 (+ (to_rep b__first) o49))))
(assert (=> (not (= result2 true)) (and (= temp___256 o50) (in_range1 o50))))
(assert (=> (not (= result2 true)) (and (<= (to_rep b__first) temp___256) (<= temp___256 (to_rep b__last)))))
(assert (=> (not (= result2 true)) (= o57 temp___256)))
(assert (=> (not (= result2 true)) (= o58 (store b1 o57 o56))))
(assert (=> (not (= result2 true)) (= b1 result5)))
(assert (=> (not (= result2 true)) (= b3 o58)))
(assert (=> (not (= result2 true)) (and (= o59 (+ j2 1)) (in_range1 (+ j2 1)))))
(assert (=> (not (= result2 true)) (= j2 result6)))
(assert (=> (not (= result2 true)) (= j3 o59)))
(assert (=> (not (= result2 true)) (= i3 i2)))
(assert (=> (not (= result2 true)) (= b2 b3)))
