...
(assert (=> (not (= j2 length2)) (=> (< i2 length1) (and (= temp___258 o3) (in_range1 o3)))))
...
(assert (=> (= result2 true) (and (= temp___259 (+ a_first i2)) (in_range1 (+ a_first i2)))))
(assert (=> (= result2 true) (and (<= (to_rep a__first) temp___259) (<= temp___259 (to_rep a__last)))))
(assert (=> (= result2 true) (= o10 temp___259)))
(assert (=> (= result2 true) (= o11 (select a o10))))
(assert (=> (= result2 true) (= o12 (to_rep o11))))
(assert (=> (= result2 true) (= (to_rep o13) o12)))
(assert (=> (= result2 true) (and (= o8 (+ i2 j2)) (in_range1 (+ i2 j2)))))
(assert (=> (= result2 true) (= o9 (+ (to_rep b__first) o8))))
(assert (=> (= result2 true) (and (= temp___260 o9) (in_range1 o9))))
(assert (=> (= result2 true) (and (<= (to_rep b__first) temp___260) (<= temp___260 (to_rep b__last)))))
(assert (=> (= result2 true) (= o14 temp___260)))
(assert (=> (= result2 true) (= o15 (store b o14 o13))))
(assert (=> (= result2 true) (= b result3)))
(assert (=> (= result2 true) (= b1 o15)))
(assert (=> (= result2 true) (and (= o16 (+ i2 1)) (in_range1 (+ i2 1)))))
(assert (=> (= result2 true) (= i2 result4)))
(assert (=> (= result2 true) (= i3 o16)))
(assert (=> (= result2 true) (= j3 j2)))
(assert (=> (not (= result2 true)) (and (= o19 (+ a_first length1)) (in_range1 (+ a_first length1)))))
(assert (=> (not (= result2 true)) (= o20 (+ o19 j2))))
(assert (=> (not (= result2 true)) (and (= temp___255 o20) (in_range1 o20))))
(assert (=> (not (= result2 true)) (and (<= (to_rep a__first) temp___255) (<= temp___255 (to_rep a__last)))))
(assert (=> (not (= result2 true)) (= o21 temp___255)))
(assert (=> (not (= result2 true)) (= o22 (select a o21))))
(assert (=> (not (= result2 true)) (= o23 (to_rep o22))))
(assert (=> (not (= result2 true)) (= (to_rep o24) o23)))
(assert (=> (not (= result2 true)) (and (= o17 (+ i2 j2)) (in_range1 (+ i2 j2)))))
(assert (=> (not (= result2 true)) (= o18 (+ (to_rep b__first) o17))))
(assert (=> (not (= result2 true)) (and (= temp___256 o18) (in_range1 o18))))
(assert (=> (not (= result2 true)) (and (<= (to_rep b__first) temp___256) (<= temp___256 (to_rep b__last)))))
(assert (=> (not (= result2 true)) (= o25 temp___256)))
(assert (=> (not (= result2 true)) (= o26 (store b o25 o24))))
(assert (=> (not (= result2 true)) (= b result5)))
(assert (=> (not (= result2 true)) (= b2 o26)))
(assert (=> (not (= result2 true)) (and (= o27 (+ j2 1)) (in_range1 (+ j2 1)))))
(assert (=> (not (= result2 true)) (= j2 result6)))
(assert (=> (not (= result2 true)) (= j3 o27)))
(assert (=> (not (= result2 true)) (= i3 i2)))
(assert (=> (not (= result2 true)) (= b1 b2)))
(assert (not (<= i3 length1)))
(check-sat)
(exit)
