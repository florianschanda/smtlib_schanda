...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 100)) (and (and (= temp___153 i1) (and (= temp___151 b) (and (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- i2 1))) (= (to_rep (select b2 (to_rep (select a j1)))) j1))) (and (and (=> (<= 1 100) (in_range1 i2)) (and (<= 1 i2) (<= i2 100))) (and (and (and (= (to_rep o) i2) (= o1 (store b2 (to_rep (select a i2)) o))) (and (= b2 result1) (= b3 o1))) (= i2 100)))))) (and (and (= i2 i6) (= b3 b6)) (and (= i7 i2) (= b7 b3))))))
(assert (=> (and (<= 1 i1) (<= i1 100)) (= (mk_int__ref i8) (mk_int__ref i6))))
(assert (=> (and (<= 1 i1) (<= i1 100)) (= (mk_map__ref b8) (mk_map__ref b6))))
(assert (=> (and (<= 1 i1) (<= i1 100)) (= i9 i7)))
(assert (=> (and (<= 1 i1) (<= i1 100)) (= b9 b7)))
(assert (=> (not (and (<= 1 i1) (<= i1 100))) (= i1 i8)))
(assert (=> (not (and (<= 1 i1) (<= i1 100))) (= (mk_map__ref b8) (mk_map__ref b))))
(assert (=> (not (and (<= 1 i1) (<= i1 100))) (= i9 i1)))
(assert (=> (not (and (<= 1 i1) (<= i1 100))) (= b9 b1)))
(declare-const j1 Int)
(assert (<= 1 j1))
(assert (<= j1 100))
(assert (not (= (to_rep (select b8 (to_rep (select a j1)))) j1)))
(check-sat)
(exit)
