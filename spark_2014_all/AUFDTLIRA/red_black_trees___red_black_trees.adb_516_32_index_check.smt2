...
(assert (and (= o129 (parent (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields34)) i)) (and (in_range2 o129) (and (= o129 (parent1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields34)))) i)) (=> (= (size (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields34))) 0) (= o129 0))))))
(assert (= result37 (ite (= o129 0) true false)))
(assert (not (= result37 true)))
(assert (and (= temp___1001 (parent (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields34)) i)) (and (in_range2 temp___1001) (and (= temp___1001 (parent1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields34)))) i)) (=> (= (size (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields34))) 0) (= temp___1001 0))))))
(assert (not (<= temp___1001 100)))
(check-sat)
(exit)
