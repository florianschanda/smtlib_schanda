...
(assert (= o8 other_train))
(assert (= (mk___rep (mk___split_fields o9 o10 o11)) (select trains o8)))
(assert (= o12 (mk___split_fields o9 o10 o11)))
(assert (= o13 (rec__trains__train_position__track_begin o12)))
...
(assert (= o3 o6))
(assert (= o7 o4))
(assert (= o15 (to_rep o7)))
(assert (= o16 (ite (= o15 o14) true false)))
(assert (= result (ite (not (= o16 true)) true false)))
(assert (= result true))
