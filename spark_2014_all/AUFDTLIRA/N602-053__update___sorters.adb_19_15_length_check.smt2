...
(assert (= o7 x))
(assert (= (mk___t temp___226 temp___2261) (temp_____aggregate_def_218 (mk___t values (mk (to_rep values__first) (to_rep values__last))) o7 o6 o5 o4)))
(assert (not (= (ite (<= (to_rep (first temp___2261)) (to_rep (last temp___2261))) (+ (- (to_rep (last temp___2261)) (to_rep (first temp___2261))) 1) 0) (ite (<= (to_rep values__first) (to_rep values__last)) (+ (- (to_rep values__last) (to_rep values__first)) 1) 0))))
(check-sat)
(exit)
