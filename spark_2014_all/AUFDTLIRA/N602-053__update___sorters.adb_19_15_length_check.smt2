...
(assert (not (= (ite (<= (to_rep (first temp___2001)) (to_rep (last temp___2001))) (+ (- (to_rep (last temp___2001)) (to_rep (first temp___2001))) 1) 0) (ite (<= (to_rep values__first) (to_rep values__last)) (+ (- (to_rep values__last) (to_rep values__first)) 1) 0))))
(check-sat)
(exit)
