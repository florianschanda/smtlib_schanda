...
(define-fun dynamic_invariant1 ((temp___expr_273 us_rep) (temp___is_init_270 Bool) (temp___skip_constant_271 Bool) (temp___do_toplevel_272 Bool)) Bool (let ((temp___274 (rec__main__discr_type__discr (us_split_discrs1 temp___expr_273)))) (and (dynamic_property1 0 (to_rep temp___274) (first1 (rec__main__discr_type__m_array (us_split_fields1 temp___expr_273))) (last1 (rec__main__discr_type__m_array (us_split_fields1 temp___expr_273)))) (and (= (first1 (rec__main__discr_type__m_array (us_split_fields1 temp___expr_273))) 0) (= (last1 (rec__main__discr_type__m_array (us_split_fields1 temp___expr_273))) (to_rep temp___274))))))
(declare-sort tT9bP1 0)
(define-fun in_range4 ((x Int)) Bool (and (<= 0 x) (<= x 15)))
(declare-fun attr__ATTRIBUTE_IMAGE5 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check5 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE5 (us_image) Int)
(declare-fun user_eq6 (tT9bP1 tT9bP1) Bool)
(declare-const dummy6 tT9bP1)
...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__main__discr_type__m_array1 (Array Int Bool))))))
(define-fun us_split_fields_M_Array__2__projection ((a us_split_fields2)) (Array Int Bool) (rec__main__discr_type__m_array1 a))
...
(define-fun of_base ((r us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r) (mk___split_fields1 (let ((temp___134 (rec__main__discr_type__m_array (us_split_fields1 r)))) (to_array temp___134)))))
...
(define-fun in_range5 ((rec__main__discr_type__discr1 Int) (a us_rep)) Bool (= rec__main__discr_type__discr1 (to_rep (rec__main__discr_type__discr (us_split_discrs1 a)))))
...
(define-fun dynamic_invariant2 ((temp___expr_290 us_rep1) (temp___is_init_287 Bool) (temp___skip_constant_288 Bool) (temp___do_toplevel_289 Bool)) Bool (=> (not (= temp___skip_constant_288 true)) (in_range5 15 (to_base temp___expr_290))))
(define-fun default_initial_assumption ((temp___expr_293 us_rep1) (temp___skip_top_level_294 Bool)) Bool (= (to_rep (rec__main__discr_type__discr (us_split_discrs2 temp___expr_293))) 15))
...
(declare-const temp___discr_299 Int)
(assert (in_range1 temp___discr_299))
(assert (<= 0 temp___discr_299))
(assert (not (<= 0 0)))
(check-sat)
(exit)
