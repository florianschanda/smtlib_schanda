...
(assert (and (and (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 3)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 3) index2)) (forall ((temp___2406 Int)) (=> (and (<= (to_rep1 n__first) temp___2406) (<= temp___2406 (to_rep1 n__last))) (=> (< index2 temp___2406) (= (select n3 temp___2406) (select n1 temp___2406)))))) (and (<= (+ (to_rep1 (first (rt source))) 1) index2) (<= index2 (+ (to_rep1 (first (rt source))) 3)))))
