...
(assert (and (and (and (and (not (= (select winners3 0) true)) (< latest_highest_score2 i2)) (= (select winners3 latest_highest_score2) true)) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- i2 1))) (=> (< latest_highest_score2 j1) (< (to_rep (select counters j1)) (to_rep (select counters latest_highest_score2))))))) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- i2 1))) (ite (= (select winners3 j1) true) (= (to_rep (select counters latest_highest_score2)) (to_rep (select counters j1))) (< (to_rep (select counters j1)) (to_rep (select counters latest_highest_score2))))))))
...
(assert (=> (and (and (= (ite (select winners3 0) 1 0) (ite (distinct 0 0) 1 0)) (< latest_highest_score2 i2)) (= (select winners3 latest_highest_score2) true)) (= (= result4 true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- i2 1))) (=> (< latest_highest_score2 j1) (< (to_rep (select counters j1)) (to_rep (select counters latest_highest_score2)))))))))
(assert (=> (not (and (and (= (ite (select winners3 0) 1 0) (ite (distinct 0 0) 1 0)) (< latest_highest_score2 i2)) (= (select winners3 latest_highest_score2) true))) (= result4 false)))
(assert (= result4 true))
(assert (<= 1 j))
(assert (<= j (- i2 1)))
(assert (not (<= 0 j)))
