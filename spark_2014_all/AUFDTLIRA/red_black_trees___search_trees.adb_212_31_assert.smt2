...
(assert (= result2 true))
(assert (not (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f_old root) i2))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f_old root) j1)))) true)))
(check-sat)
(exit)
