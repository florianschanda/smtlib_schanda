...
(assert (and (<= 0 i4) (<= i4 99)))
(assert (= o111 i4))
(assert (= o112 (select (rec__patience__state__stacksizes (us_split_fields1 s)) o111)))
(assert (= o113 (to_rep1 o112)))
(assert (= o114 (ite (<= o113 (to_rep1 (rec__patience__state__numelts (us_split_fields1 s)))) true false)))
(assert (not (<= 0 i4)))
(check-sat)
(exit)
