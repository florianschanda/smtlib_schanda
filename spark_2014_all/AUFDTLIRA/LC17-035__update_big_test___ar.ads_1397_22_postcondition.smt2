...
(declare-const o33 (Array Int us_rep2))
...
(assert (= (to_rep o) f))
(assert (= o o1))
(assert (= (rec__ar__rec1t__g1 (us_split_fields1 (rec__ar__rec2t__g2 (us_split_fields3 (rec__ar__rec5t__f5 (us_split_fields5 (select a i))))))) o2))
(assert (= o3 o1))
(assert (= o4 o2))
(assert (= (rec__ar__rec2t__f2 (us_split_fields3 (rec__ar__rec5t__f5 (us_split_fields5 (select a i))))) o5))
(assert (= o6 o3))
(assert (= o7 o4))
(assert (= (rec__ar__rec2t__h2 (us_split_fields3 (rec__ar__rec5t__f5 (us_split_fields5 (select a i))))) o8))
(assert (= o9 o5))
(assert (= o10 o6))
(assert (= o11 o7))
(assert (= o12 o8))
...
(assert (= o15 o11))
(assert (= o16 o12))
(assert (= (rec__ar__rec5t__g5 (us_split_fields5 (select a i))) o17))
(assert (= (rec__ar__rec5t__h5 (us_split_fields5 (select a i))) (mk___rep (mk___split_fields o18 o19))))
(assert (= o20 o13))
(assert (= o21 o14))
(assert (= o22 o15))
(assert (= o23 o16))
...
(assert (= o25 o18))
(assert (= o26 o19))
(assert (= o27 (store a i (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 o20 (mk___rep (mk___split_fields o21 o22)) o23)) o24 (mk___rep (mk___split_fields o25 o26)))))))
(assert (= result (mk_map__ref a)))
(assert (= a1 o27))
(assert (= (to_rep o28) g))
(assert (= o29 (mk___split_fields o28 (rec__ar__rec1t__g1 (us_split_fields1 (rec__ar__rec5t__h5 (us_split_fields5 (select a1 i))))))))
(assert (= o30 (mk___rep o29)))
(assert (= o31 (mk___split_fields2 (rec__ar__rec5t__f5 (us_split_fields5 (select a1 i))) (rec__ar__rec5t__g5 (us_split_fields5 (select a1 i))) o30)))
(assert (= o32 (mk___rep2 o31)))
(assert (= o33 (store a1 i o32)))
...
(assert (<= n 99))
(assert (not (= n i)))
(assert (not (= (bool_eq2 (select (map__content a3) n) (select a n)) true)))
(check-sat)
(exit)
