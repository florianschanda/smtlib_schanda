...
(define-fun o12 () us_rep (mk___rep (mk___split_discrs o8) (mk___split_fields o9 (mk___t1 o10 o11))))
(define-fun o13 () us_t2 (mk___t2 o6 o7))
...
(declare-const result4 natural_index)
(declare-const result5 natural_index)
(declare-const result6 (Array Int character))
(declare-const result7 t1)
...
(assert (and (= o12 (instance (+ (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 left))) (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right)))) o13)) (and (dynamic_invariant1 o12 true false true true) (and (and (= (to_rep2 o8) (+ (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 left))) (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right))))) (= (length2 o12) (length3 o13))) (= (let ((temp___274 (value o12))) (bool_eq (elts2 temp___274) (to_rep1 (first4 (rt2 temp___274))) (to_rep1 (last4 (rt2 temp___274))) o6 (to_rep1 (first4 o7)) (to_rep1 (last4 o7)))) true)))))
...
(assert (= bounded_dynamic_strings__Oconcat__result12 o12))
...
(assert (= (mk___rep (mk___split_discrs result4) (mk___split_fields result5 (mk___t1 result6 result7))) (sequence__content bounded_dynamic_strings__Oconcat__result10)))
(assert (not (= (length2 (sequence__content bounded_dynamic_strings__Oconcat__result10)) (+ (length2 left) (length2 right)))))
(check-sat)
(exit)
