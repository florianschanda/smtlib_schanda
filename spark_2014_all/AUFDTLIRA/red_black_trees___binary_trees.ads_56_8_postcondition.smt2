...
(declare-const result18 (Array Int us_rep1))
...
(assert (=> (not (= i1 0)) (forall ((j11 Int)) (=> (and (<= 1 j11) (<= j11 100)) (=> (= (select todo3 j11) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j11))) true))))))
(assert (=> (not (= i1 0)) (forall ((j11 Int)) (=> (and (<= 1 j11) (<= j11 100)) (=> (= (select todo3 j11) true) (forall ((k Int)) (=> (and (<= 1 k) (<= k 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 k))) true) (not (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select r2 j11))) (rec__tree_model__path_type__a (us_split_fields1 (select r2 k)))) true))))))))))
...
(assert (=> (not (= i1 0)) (forall ((j11 Int)) (=> (and (<= 1 j11) (<= j11 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j11))) true) (not (= j11 root))) (not (= (select todo3 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j11))))) true)))))))
...
(assert (=> (not (= i1 0)) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 root))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select r2 root)))) 0))))
(assert (=> (not (= i1 0)) (forall ((j11 Int)) (=> (and (<= 1 j11) (<= j11 100)) (<= (length (rec__tree_model__path_type__a (us_split_fields1 (select r2 j11)))) (- 100 (length1 unseen2)))))))
(assert (=> (not (= i1 0)) (forall ((j11 Int)) (=> (and (<= 1 j11) (<= j11 100)) (= (= (contains unseen2 j11) true) (or (not (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j11))) true)) (= (select todo3 j11) true)))))))
...
(assert (=> (not (= i1 0)) (and (= o65 (next todo6)) (and (in_range2 o65) (ite (= o65 0) (forall ((i10 Int)) (=> (and (<= 1 i10) (<= i10 100)) (not (= (select todo6 i10) true)))) (= (select todo6 o65) true))))))
...
(assert (= result18 (map__content binary_trees__model__result4)))
(assert (not (= (rec__tree_model__path_type__k (us_split_fields1 (select (map__content binary_trees__model__result4) root))) true)))
(check-sat)
(exit)
