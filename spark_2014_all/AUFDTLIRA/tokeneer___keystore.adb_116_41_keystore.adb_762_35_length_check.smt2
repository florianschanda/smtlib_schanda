...
(assert (=> (<= 1 temp___1170) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 temp___1170) (<= temp___1170 150)))))
(assert (= o7 result__1))
(assert (= o7 temp___1171))
(assert (= (mk1 1 temp___1170) temp___11711))
(assert (not (= (ite (<= (to_rep1 (first2 temp___11681)) (to_rep1 (last2 temp___11681))) (+ (- (to_rep1 (last2 temp___11681)) (to_rep1 (first2 temp___11681))) 1) 0) (ite (<= (to_rep1 (first2 temp___11711)) (to_rep1 (last2 temp___11711))) (+ (- (to_rep1 (last2 temp___11711)) (to_rep1 (first2 temp___11711))) 1) 0))))
(check-sat)
(exit)
