...
(define-fun dynamic_invariant ((temp___expr_251 us_t1) (temp___is_init_248 Bool) (temp___skip_constant_249 Bool) (temp___do_toplevel_250 Bool)) Bool (and (=> (not (= temp___skip_constant_249 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_251) (last3 temp___expr_251))) (=> (= temp___do_toplevel_250 true) (=> (= temp___is_init_248 true) (and (let ((temp___253 (of_array (to_array1 temp___expr_251) (first3 temp___expr_251) (last3 temp___expr_251)))) (and (= (first1 temp___253) 1) (<= 0 (last1 temp___253)))) (<= (last3 temp___expr_251) 12))))))
(define-fun dynamic_predicate ((temp___255 us_t1)) Bool (and (let ((temp___257 (of_array (to_array1 temp___255) (first3 temp___255) (last3 temp___255)))) (and (= (first1 temp___257) 1) (<= 0 (last1 temp___257)))) (<= (last3 temp___255) 12)))
...
(assert (dynamic_invariant i15s true false false))
