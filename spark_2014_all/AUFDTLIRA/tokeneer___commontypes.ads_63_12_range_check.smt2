...
(assert (dynamic_predicate1 (mk___t1 temp___289 temp___2891)))
(assert (= (mk___t1 temp___290 temp___2901) (mk___t1 temp___289 temp___2891)))
(assert (not (dynamic_property 1 2147483647 (to_rep1 (first2 temp___2901)) (to_rep1 (last2 temp___2901)))))
(check-sat)
(exit)
