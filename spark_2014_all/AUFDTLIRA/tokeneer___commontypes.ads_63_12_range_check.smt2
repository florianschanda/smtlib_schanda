...
(define-fun dynamic_invariant ((temp___expr_289 us_t1) (temp___is_init_285 Bool) (temp___skip_constant_286 Bool) (temp___do_toplevel_287 Bool) (temp___do_typ_inv_288 Bool)) Bool (and (=> (not (= temp___skip_constant_286 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_289) (last3 temp___expr_289))) (=> (= temp___do_toplevel_287 true) (=> (= temp___is_init_285 true) (and (let ((temp___291 (of_array (to_array1 temp___expr_289) (first3 temp___expr_289) (last3 temp___expr_289)))) (and (= (first1 temp___291) 1) (<= 0 (last1 temp___291)))) (<= (last3 temp___expr_289) 12))))))
(define-fun dynamic_predicate ((temp___293 us_t1)) Bool (and (let ((temp___295 (of_array (to_array1 temp___293) (first3 temp___293) (last3 temp___293)))) (and (= (first1 temp___295) 1) (<= 0 (last1 temp___295)))) (<= (last3 temp___293) 12)))
...
(assert (dynamic_invariant i15s true false false true))
(assert (not (dynamic_property 1 2147483647 (to_rep1 (first2 (rt1 i15s))) (to_rep1 (last2 (rt1 i15s))))))
(check-sat)
(exit)
