...
(assert (exists ((index Int)) (and (and (<= (to_rep (first (rt list))) index) (<= index (to_rep (last (rt list))))) (= (to_rep (select (elts list) index)) value))))
...
(assert (= position2 o4))
(assert (and (and (<= (to_rep (first (rt list))) position3) (<= position3 (to_rep (last (rt list))))) (forall ((j Int)) (=> (and (<= (to_rep (first (rt list))) j) (<= j (- position3 1))) (not (= (to_rep (select (elts list) j)) value))))))
