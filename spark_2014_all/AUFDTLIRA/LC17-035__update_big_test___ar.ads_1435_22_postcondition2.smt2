...
(declare-const temp___7967 (Array Int et1))
(declare-const temp___79671 enum2t)
(declare-const o4 enum2t)
(declare-const o5 (Array Int et1))
(declare-const o6 enum2t)
(declare-const temp___7969 (Array Int et1))
(declare-const temp___79691 enum2t)
...
(assert (= temp___7967 o2))
(assert (= temp___79671 o3))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= temp___7967 r__split_fields2))
(assert (= temp___79671 r__split_fields3))
(assert (= (to_rep1 o4) f))
(assert (= r__split_fields2 o5))
(assert (= o4 o6))
(assert (= temp___7969 o5))
(assert (= temp___79691 o6))
(assert (= result2 r__split_fields2))
(assert (= result3 r__split_fields3))
(assert (= temp___7969 r__split_fields4))
(assert (= temp___79691 r__split_fields5))
