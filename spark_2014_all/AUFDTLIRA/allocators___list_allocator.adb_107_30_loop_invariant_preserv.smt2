...
(assert (and (and (forall ((temp___252 Int)) (=> (and (<= 1 temp___252) (<= temp___252 10000)) (ite (< r2 temp___252) (= (select data3 temp___252) (select data1 temp___252)) (= (rec__list_allocator__cell__stat (us_split_fields1 (select data3 temp___252))) (rec__list_allocator__cell__stat (us_split_fields1 (select data1 temp___252))))))) (=> (<= 1 10000) (in_range3 r2))) (and (<= 1 r2) (<= r2 10000))))
(assert (not (= r2 10000)))
(assert (= r2 result4))
(assert (= r3 (+ r2 1)))
(assert (=> (< r3 10000) (and (= o15 (+ r3 1)) (in_range2 (+ r3 1)))))
(assert (=> (< r3 10000) (= (to_rep o16) o15)))
(assert (=> (< r3 10000) (= (rec__list_allocator__cell__stat (us_split_fields1 (select data3 r3))) o17)))
(assert (=> (< r3 10000) (= o16 o18)))
(assert (=> (< r3 10000) (= o19 o17)))
(assert (=> (< r3 10000) (= o20 o18)))
(assert (=> (< r3 10000) (= o21 (store data3 r3 (mk___rep (mk___split_fields o19 o20))))))
(assert (=> (< r3 10000) (= result5 data3)))
(assert (=> (< r3 10000) (= data4 o21)))
(assert (=> (not (< r3 10000)) (= data4 data3)))
(declare-const rr1 Int)
(assert (<= 1 rr1))
(assert (<= rr1 10000))
(assert (not (= (to_rep1 (rec__list_allocator__cell__stat (us_split_fields1 (select data4 rr1)))) 0)))
(check-sat)
(exit)
