...
(assert (and (and (forall ((temp___289 Int)) (=> (and (<= 1 temp___289) (<= temp___289 10000)) (ite (< r2 temp___289) (= (select data3 temp___289) (select data1 temp___289)) (= (rec__list_allocator__cell__stat (us_split_fields1 (select data3 temp___289))) (rec__list_allocator__cell__stat (us_split_fields1 (select data1 temp___289))))))) (=> (<= 1 10000) (in_range3 r2))) (and (<= 1 r2) (<= r2 10000))))
(assert (not (= r2 10000)))
(assert (= r2 result4))
(assert (= r3 (+ r2 1)))
(assert (=> (< r3 10000) (and (= o14 (+ r3 1)) (in_range2 (+ r3 1)))))
(assert (=> (< r3 10000) (= (to_rep o15) o14)))
(assert (=> (< r3 10000) (= (rec__list_allocator__cell__stat (us_split_fields1 (select data3 r3))) o16)))
(assert (=> (< r3 10000) (= o15 o17)))
(assert (=> (< r3 10000) (= o18 o16)))
(assert (=> (< r3 10000) (= o19 o17)))
(assert (=> (< r3 10000) (= o20 (store data3 r3 (mk___rep (mk___split_fields o18 o19))))))
...
(assert (<= 1 rr))
(assert (<= rr 10000))
(assert (not (= (to_rep1 (rec__list_allocator__cell__stat (us_split_fields1 (select data4 rr)))) 0)))
(check-sat)
(exit)
