...
(assert (forall ((temp___187 us_rep)) (forall ((temp___188 Int)) (= (select (temp___185 temp___187) temp___188) temp___187))))
(declare-fun temp___189 (Int) (Array Int character))
(assert (forall ((temp___191 Int)) (forall ((temp___192 Int)) (= (select (temp___189 temp___191) temp___192) (of_rep1 temp___191)))))
(declare-fun temp___193 (Int) (Array Int character))
(assert (forall ((temp___195 Int)) (forall ((temp___196 Int)) (= (select (temp___193 temp___195) temp___196) (of_rep1 temp___195)))))
...
(define-fun dynamic_invariant1 ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= 0 5)) (in_range1 temp___expr_142)))
...
(assert (<= 1 n))
(assert (<= n 1000))
(assert (not (= (bool_eq1 (select x1 n) (mk___rep (mk___split_fields (of_rep 0) (temp___193 32)))) true)))
(check-sat)
(exit)
