...
(declare-fun temp_____aggregate_def_213 (us_rep) (Array Int us_rep))
(declare-fun temp_____aggregate_def_217 (Int) (Array Int character))
(declare-fun temp_____aggregate_def_221 (Int) (Array Int character))
...
(assert (forall ((temp___215 us_rep)) (forall ((temp___216 Int)) (= (select (temp_____aggregate_def_213 temp___215) temp___216) temp___215))))
(assert (forall ((temp___219 Int)) (=> (dynamic_invariant temp___219 true true true true) (forall ((temp___220 Int)) (= (to_rep1 (select (temp_____aggregate_def_217 temp___219) temp___220)) temp___219)))))
(assert (forall ((temp___223 Int)) (=> (dynamic_invariant temp___223 true true true true) (forall ((temp___224 Int)) (= (to_rep1 (select (temp_____aggregate_def_221 temp___223) temp___224)) temp___223)))))
...
(assert (= result x))
(assert (= x1 (temp_____aggregate_def_213 (mk___rep (mk___split_fields rliteral (temp_____aggregate_def_217 32))))))
(declare-const n Int)
(assert (<= 1 n))
(assert (<= n 1000))
(assert (not (= (bool_eq1 (select x1 n) (mk___rep (mk___split_fields rliteral (temp_____aggregate_def_221 32)))) true)))
(check-sat)
(exit)
