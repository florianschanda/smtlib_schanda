...
(define-fun dynamic_invariant3 ((temp___expr_159 Int) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool) (temp___do_typ_inv_158 Bool)) Bool (=> (or (= temp___is_init_155 true) (<= 0 2147483647)) (in_range2 temp___expr_159)))
(declare-const c Int)
(declare-const o Bool)
(declare-const o1 Bool)
(declare-const result Bool)
(assert (dynamic_invariant cont true false true true))
