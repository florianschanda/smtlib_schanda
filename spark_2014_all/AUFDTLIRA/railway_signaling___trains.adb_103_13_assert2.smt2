...
(assert (<= 1 id7))
(assert (<= id7 3))
(assert (not (= (get_previous_track (select trains1 train1) id7) 0)))
(define-fun temp___415 () Int (to_rep5 (select (map__content4 track_signals6) (get_previous_track (select trains1 train1) id7))))
(assert (not (or (= temp___415 1) (= temp___415 2))))
(check-sat)
(exit)
