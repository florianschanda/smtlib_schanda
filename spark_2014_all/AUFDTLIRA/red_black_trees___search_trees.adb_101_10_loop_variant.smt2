...
(assert (not (= ki3 kj3)))
(assert (not (or (< (length (rec__tree_model__path_type__a (us_split_fields1 (select m ki3)))) temp___12701) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select m ki3)))) temp___12701) (< (length (rec__tree_model__path_type__a (us_split_fields1 (select m kj3)))) temp___12691)))))
(check-sat)
(exit)
