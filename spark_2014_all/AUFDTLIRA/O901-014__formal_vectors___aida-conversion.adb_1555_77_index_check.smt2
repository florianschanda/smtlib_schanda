...
(assert (and (= o44 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (= o45 (ite (<= o44 j) true false)))
(assert (= result6 (ite (= o45 true) (ite (<= j index3) true false) false)))
(assert (= result6 true))
(assert (and (<= (to_rep1 int_array__first) j) (<= j (to_rep1 int_array__last))))
(assert (= o46 j))
(assert (= o47 (select int_array1 o46)))
