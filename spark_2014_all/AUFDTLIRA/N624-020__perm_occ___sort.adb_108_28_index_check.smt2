...
(assert (forall ((i1 Int)) (=> (and (<= (to_rep1 values__first) i1) (<= i1 current2)) (forall ((j1 Int)) (=> (and (<= (+ i1 1) j1) (<= j1 (to_rep1 values__last))) (<= (to_rep (select values3 i1)) (to_rep (select values3 j1))))))))
