...
(assert (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) v) (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i))))))) true))
(assert (not (not (= i v))))
(check-sat)
(exit)
