...
(assert (<= 1 j5))
(assert (<= j5 100))
(assert (and (= o93 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) (in_range3 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))))))
(assert (and (= temp___1962 (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o93)) (and (dynamic_invariant8 temp___1962 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1962 o93))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1962 o93)))) 0) (and (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 100)) (=> (not (= i4 o93)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i4) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1962 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i4)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1962 i4))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1962 i4))) true)))))) (and (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1962 i4))) true) (not (= i4 o93))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1962 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i4)))) (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i4) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1962 i4)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1962 i4)))) 0)))) (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1962 i4))) true) (forall ((j14 Int)) (=> (and (<= 1 j14) (<= j14 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1962 j14))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1962 i4))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1962 j14)))) true)) (= j14 i4))))))))))))))
(assert (= o94 (select temp___1962 j5)))
(assert (= o95 (us_split_fields1 o94)))
(assert (= result21 (rec__tree_model__path_type__k o95)))
(assert (= result21 true))
(assert (and (= o97 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) (in_range3 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))))))
(assert (and (= temp___1961 (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o97)) (and (dynamic_invariant8 temp___1961 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1961 o97))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1961 o97)))) 0) (and (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 100)) (=> (not (= i4 o97)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i4) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1961 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i4)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1961 i4))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1961 i4))) true)))))) (and (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1961 i4))) true) (not (= i4 o97))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1961 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i4)))) (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i4) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1961 i4)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1961 i4)))) 0)))) (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1961 i4))) true) (forall ((j14 Int)) (=> (and (<= 1 j14) (<= j14 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1961 j14))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1961 i4))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1961 j14)))) true)) (= j14 i4))))))))))))))
(assert (= o98 (select temp___1961 j5)))
(assert (= o99 (us_split_fields1 o98)))
(assert (= o100 (rec__tree_model__path_type__a o99)))
(assert (and (= o96 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) (in_range3 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))))))
(assert (not (= (valid_root (rec__search_trees__search_tree__struct (us_split_fields7 t)) o96) true)))
(check-sat)
(exit)
