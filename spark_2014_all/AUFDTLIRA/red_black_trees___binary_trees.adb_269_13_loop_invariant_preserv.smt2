...
(assert (<= 1 i2))
(assert (<= i2 100))
(assert (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f t1) i2))) true))
(assert (< (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f t1) i2)))) n3))
(assert (not (not (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f t2) i2))) true))))
(check-sat)
(exit)
