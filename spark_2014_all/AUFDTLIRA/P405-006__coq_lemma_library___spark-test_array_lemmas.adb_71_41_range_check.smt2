...
(assert (forall ((i2 Int)) (=> (and (<= (+ (to_rep (first (rt arr))) 1) i2) (<= i2 (to_rep (last (rt arr))))) (< (to_rep (select (elts arr) (- i2 1))) (to_rep (select (elts arr) i2))))))
(assert (not (dynamic_property1 (- 2147483648) 2147483647 (to_rep (first (rt arr))) (to_rep (last (rt arr))))))
(check-sat)
(exit)
