...
(assert (<= 1 j))
(assert (<= j 100))
(assert (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select m j))) true) (and (= o61 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j 0)) (and (in_range3 o61) (= o61 (peek1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) j 0))))))
(assert (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select m j))) true) (= o62 (select res2 o61))))
(assert (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select m j))) true) (= o63 (us_split_fields11 o62))))
(assert (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select m j))) true) (= o64 (rec__red_black_trees__black_count__depth o63))))
(assert (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select m j))) true) (= o65 (to_rep o64))))
(assert (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select m j))) true) (= result2 (ite (< o65 n2) true false))))
(assert (=> (not (= (rec__tree_model__path_type__k (us_split_fields1 (select m j))) true)) (= result2 false)))
(assert (= result2 true))
