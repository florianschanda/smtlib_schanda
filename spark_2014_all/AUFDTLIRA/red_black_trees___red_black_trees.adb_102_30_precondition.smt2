...
(assert (<= 1 j))
(assert (<= j 100))
(assert (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select m j))) true) (and (= o17 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j 0)) (and (in_range3 o17) (= o17 (peek1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) j 0))))))
(assert (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select m j))) true) (= o18 (select res2 o17))))
(assert (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select m j))) true) (= o19 (us_split_fields11 o18))))
(assert (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select m j))) true) (= o20 (rec__red_black_trees__black_count__depth o19))))
(assert (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select m j))) true) (= o21 (to_rep o20))))
(assert (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select m j))) true) (= result2 (ite (< o21 n2) true false))))
