...
(assert (and (and (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 4)) (dynamic_property5 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 4) index3)) (forall ((temp___1685 Int)) (=> (and (<= (to_rep1 n__first) temp___1685) (<= temp___1685 (to_rep1 n__last))) (=> (< index3 temp___1685) (= (select n3 temp___1685) (select n1 temp___1685)))))) (and (<= (to_rep1 (first (rt source))) index3) (<= index3 (+ (to_rep1 (first (rt source))) 4)))))
(assert (not (= index3 temp___1687)))
