...
(assert (=> (= (to_rep2 self__7) 0) (= (of_int 0) self__13)))
(assert (=> (= (to_rep2 self__7) 0) (= self__9 self__14)))
(assert (=> (not (= (to_rep2 self__7) 0)) (= (mk___rep (mk___split_fields self__10 self__11 self__12 self__13 self__14)) (mk___rep (mk___split_fields self__5 self__6 self__7 self__8 self__9)))))
