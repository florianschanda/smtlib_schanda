...
(assert (<= i5 100))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o10 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i5)) (and (in_range2 o10) (and (= o10 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i5))))) (and (=> (= (valid_root (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i5) true) (= o10 0)) (=> (= (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) 0) (= o10 0)))))))
