...
(assert (<= i 100))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o5 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i)) (and (in_range2 o5) (and (= o5 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i))))) (and (=> (= (valid_root (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i) true) (= o5 0)) (=> (= (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) 0) (= o5 0)))))))
