...
(assert (and (and (=> (<= 0 1024) (in_range2 count2)) (=> (<= 1 1024) (in_range3 index2))) (and (<= 1 index2) (<= index2 1024))))
(assert (= (to_rep (select buffer index2)) ch))
(assert (not (in_range2 (+ count2 1))))
(check-sat)
(exit)
