...
(assert (=> (and (<= (to_rep1 (first (rt x))) j1) (<= j1 (to_rep1 (last (rt x))))) (= temp___191 s1)))
(assert (=> (and (<= (to_rep1 (first (rt x))) j1) (<= j1 (to_rep1 (last (rt x))))) (and (=> (<= 0 2147483647) (in_range2 s2)) (and (<= (to_rep1 (first (rt x))) j2) (<= j2 (to_rep1 (last (rt x))))))))
(assert (=> (and (<= (to_rep1 (first (rt x))) j1) (<= j1 (to_rep1 (last (rt x))))) (and (= o (+ s2 (to_rep (select (elts x) j2)))) (in_range1 (+ s2 (to_rep (select (elts x) j2)))))))
(assert (=> (and (<= (to_rep1 (first (rt x))) j1) (<= j1 (to_rep1 (last (rt x))))) (= s2 result2)))
(assert (=> (and (<= (to_rep1 (first (rt x))) j1) (<= j1 (to_rep1 (last (rt x))))) (= s3 o)))
...
(assert (=> (and (<= (to_rep1 (first (rt x))) j1) (<= j1 (to_rep1 (last (rt x))))) (= s3 s4)))
(assert (=> (and (<= (to_rep1 (first (rt x))) j1) (<= j1 (to_rep1 (last (rt x))))) (= j4 j2)))
(assert (=> (and (<= (to_rep1 (first (rt x))) j1) (<= j1 (to_rep1 (last (rt x))))) (= s5 s3)))
(assert (=> (and (<= (to_rep1 (first (rt x))) j1) (<= j1 (to_rep1 (last (rt x))))) (= j9 (mk_int__ref j3))))
(assert (=> (and (<= (to_rep1 (first (rt x))) j1) (<= j1 (to_rep1 (last (rt x))))) (= s10 (mk_int__ref s4))))
(assert (=> (and (<= (to_rep1 (first (rt x))) j1) (<= j1 (to_rep1 (last (rt x))))) (= j6 j4)))
(assert (=> (and (<= (to_rep1 (first (rt x))) j1) (<= j1 (to_rep1 (last (rt x))))) (= s7 s5)))
(assert (=> (not (and (<= (to_rep1 (first (rt x))) j1) (<= j1 (to_rep1 (last (rt x)))))) (= j1 j5)))
(assert (=> (not (and (<= (to_rep1 (first (rt x))) j1) (<= j1 (to_rep1 (last (rt x)))))) (= s1 s6)))
(assert (=> (not (and (<= (to_rep1 (first (rt x))) j1) (<= j1 (to_rep1 (last (rt x)))))) (= j6 j1)))
(assert (=> (not (and (<= (to_rep1 (first (rt x))) j1) (<= j1 (to_rep1 (last (rt x)))))) (= s7 s1)))
...
(assert (= (mk_int__ref arrays__sum__result4) (mk_int__ref arrays__sum__result2)))
...
(assert (not (= arrays__sum__result4 0)))
(check-sat)
(exit)
