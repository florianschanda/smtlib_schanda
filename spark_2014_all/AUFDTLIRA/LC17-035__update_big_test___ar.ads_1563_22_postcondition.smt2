...
(declare-fun temp___3258 ((Array Int (Array Int et1)) Int (Array Int et1) Int (Array Int et1)) (Array Int (Array Int et1)))
(assert (forall ((temp___3260 (Array Int (Array Int et1)))) (forall ((temp___3261 Int) (temp___3263 Int)) (forall ((temp___3262 (Array Int et1)) (temp___3264 (Array Int et1))) (let ((temp___3259 (temp___3258 temp___3260 temp___3261 temp___3262 temp___3263 temp___3264))) (forall ((temp___3265 Int)) (ite (= temp___3265 temp___3263) (= (select temp___3259 temp___3265) temp___3264) (ite (= temp___3265 temp___3261) (= (select temp___3259 temp___3265) temp___3262) (= (select temp___3259 temp___3265) (select temp___3260 temp___3265))))))))))
(declare-fun temp___3266 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___3268 (Array Int et1))) (forall ((temp___3269 Int) (temp___3270 Int)) (let ((temp___3267 (temp___3266 temp___3268 temp___3269 temp___3270))) (forall ((temp___3271 Int)) (ite (= temp___3271 temp___3269) (= (select temp___3267 temp___3271) (of_rep temp___3270)) (= (select temp___3267 temp___3271) (select temp___3268 temp___3271))))))))
...
(assert (not (= (bool_eq2 (mk___rep (mk___split_fields r__split_fields6 r__split_fields7)) (mk___rep (mk___split_fields (temp___3258 r__split_fields i a (- 55 i) (temp___3266 (select r__split_fields (- 55 i)) 1 0)) r__split_fields1))) true)))
(check-sat)
(exit)
