...
(assert (not (= (bool_eq2 (mk___rep (mk___split_fields r__split_fields6 r__split_fields7)) (mk___rep (mk___split_fields (temp_____aggregate_def_3317 r__split_fields i a (- 55 i) (temp_____aggregate_def_3325 (select r__split_fields (- 55 i)) 1 0)) r__split_fields1))) true)))
(check-sat)
(exit)
