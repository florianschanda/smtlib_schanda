...
(declare-fun temp___3317 ((Array Int (Array Int et1)) Int (Array Int et1) Int (Array Int et1)) (Array Int (Array Int et1)))
(declare-fun temp___3325 ((Array Int et1) Int Int) (Array Int et1))
(declare-sort it1 0)
...
(declare-const temp___8397 (Array Int (Array Int et1)))
(declare-const temp___83971 Bool)
...
(assert (= temp___8397 o3))
(assert (= temp___83971 o4))
(assert (= result2 r__split_fields2))
(assert (= result3 r__split_fields3))
(assert (= temp___8397 r__split_fields4))
(assert (= temp___83971 r__split_fields5))
...
(assert (not (= (bool_eq2 (mk___rep (mk___split_fields r__split_fields6 r__split_fields7)) (mk___rep (mk___split_fields (temp___3317 r__split_fields i a (- 55 i) (temp___3325 (select r__split_fields (- 55 i)) 1 0)) r__split_fields1))) true)))
(check-sat)
(exit)
