...
(assert (<= i2 1024))
(assert (< offset2 i3))
(assert (and (and (=> (<= 1 1024) (in_range3 i3)) (=> (<= 0 1024) (in_range2 offset2))) (and (<= 1 i3) (<= i3 1024))))
(assert (not (= (to_rep (select buffer i3)) erase_character)))
(assert (= (to_rep o) (to_rep (select buffer i3))))
(assert (and (<= 1 (+ 1 offset2)) (<= (+ 1 offset2) 1024)))
(assert (= o1 (+ 1 offset2)))
(assert (= o2 (store workspace2 o1 o)))
(assert (= workspace2 result3))
(assert (= workspace3 o2))
(assert (not (in_range2 (+ offset2 1))))
(check-sat)
(exit)
