...
(declare-fun temp___224 ((Array Int integer) (Array Int integer)) (Array Int (Array Int integer)))
(assert (forall ((temp___226 (Array Int integer)) (temp___227 (Array Int integer))) (let ((temp___225 (temp___224 temp___226 temp___227))) (and (= (select temp___225 1) temp___226) (= (select temp___225 2) temp___227)))))
...
(assert (forall ((temp___236 Int) (temp___237 Int)) (let ((temp___235 (temp___234 temp___236 temp___237))) (and (= (select temp___235 1) (of_rep temp___236)) (= (select temp___235 2) (of_rep temp___237))))))
(declare-fun temp___240 ((Array Int integer) (Array Int integer)) (Array Int (Array Int integer)))
(assert (forall ((temp___242 (Array Int integer)) (temp___243 (Array Int integer))) (let ((temp___241 (temp___240 temp___242 temp___243))) (and (= (select temp___241 1) temp___242) (= (select temp___241 2) temp___243)))))
...
(declare-fun temp___256 ((Array Int integer) (Array Int integer)) (Array Int (Array Int integer)))
(assert (forall ((temp___258 (Array Int integer)) (temp___259 (Array Int integer))) (let ((temp___257 (temp___256 temp___258 temp___259))) (and (= (select temp___257 1) temp___258) (= (select temp___257 2) temp___259)))))
(declare-fun temp___261 (Int Int) (Array Int integer))
(assert (forall ((temp___263 Int) (temp___264 Int)) (let ((temp___262 (temp___261 temp___263 temp___264))) (and (= (select temp___262 1) (of_rep temp___263)) (= (select temp___262 2) (of_rep temp___264))))))
(declare-fun temp___266 (Int Int) (Array Int integer))
(assert (forall ((temp___268 Int) (temp___269 Int)) (let ((temp___267 (temp___266 temp___268 temp___269))) (and (= (select temp___267 1) (of_rep temp___268)) (= (select temp___267 2) (of_rep temp___269))))))
(declare-fun temp___272 ((Array Int integer) (Array Int integer)) (Array Int (Array Int integer)))
(assert (forall ((temp___274 (Array Int integer)) (temp___275 (Array Int integer))) (let ((temp___273 (temp___272 temp___274 temp___275))) (and (= (select temp___273 1) temp___274) (= (select temp___273 2) temp___275)))))
(declare-fun temp___277 (Int Int) (Array Int integer))
(assert (forall ((temp___279 Int) (temp___280 Int)) (let ((temp___278 (temp___277 temp___279 temp___280))) (and (= (select temp___278 1) (of_rep temp___279)) (= (select temp___278 2) (of_rep temp___280))))))
(declare-fun temp___282 (Int Int) (Array Int integer))
(assert (forall ((temp___284 Int) (temp___285 Int)) (let ((temp___283 (temp___282 temp___284 temp___285))) (and (= (select temp___283 1) (of_rep temp___284)) (= (select temp___283 2) (of_rep temp___285))))))
(declare-fun temp___288 ((Array Int integer) (Array Int integer)) (Array Int (Array Int integer)))
(assert (forall ((temp___290 (Array Int integer)) (temp___291 (Array Int integer))) (let ((temp___289 (temp___288 temp___290 temp___291))) (and (= (select temp___289 1) temp___290) (= (select temp___289 2) temp___291)))))
(declare-fun temp___293 (Int Int) (Array Int integer))
(assert (forall ((temp___295 Int) (temp___296 Int)) (let ((temp___294 (temp___293 temp___295 temp___296))) (and (= (select temp___294 1) (of_rep temp___295)) (= (select temp___294 2) (of_rep temp___296))))))
(declare-fun temp___298 (Int Int) (Array Int integer))
(assert (forall ((temp___300 Int) (temp___301 Int)) (let ((temp___299 (temp___298 temp___300 temp___301))) (and (= (select temp___299 1) (of_rep temp___300)) (= (select temp___299 2) (of_rep temp___301))))))
...
(assert (in_range b))
(assert (= one 1))
(assert (and (ite (= b 1) (forall ((j Int)) (=> (and (<= 1 j) (<= j 2)) (and (= (to_rep (select (select a j) one)) one) (= (to_rep (select (select a j) 2)) 2)))) (ite (= b 2) (forall ((j Int)) (=> (and (<= 1 j) (<= j 2)) (forall ((k Int)) (=> (and (<= 1 k) (<= k 2)) (= (to_rep (select (select a j) k)) one))))) (ite (= b 3) (forall ((j Int)) (=> (and (<= 1 j) (<= j 2)) (forall ((k Int)) (=> (and (<= 1 k) (<= k 2)) (= (to_rep (select (select a j) k)) one))))) (ite (= b 4) (forall ((j Int)) (=> (and (<= 1 j) (<= j 2)) (and (= (to_rep (select (select a j) one)) 2) (= (to_rep (select (select a j) 2)) one)))) (forall ((j Int)) (=> (and (<= 1 j) (<= j 2)) (and (= (to_rep (select (select a j) one)) one) (= (to_rep (select (select a j) 2)) 2)))))))) (and (= a a1) (= a2 a))))
(assert (= b 1))
(assert (not (= (bool_eq1 a1 1 2 (temp___224 (temp___229 one 2) (temp___234 one 2)) 1 2) true)))
(check-sat)
(exit)
