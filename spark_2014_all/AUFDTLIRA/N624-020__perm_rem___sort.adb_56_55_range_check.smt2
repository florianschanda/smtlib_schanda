...
(assert (and (= o40 (remove (mk___t values2 (mk 1 100)) o39)) (and (dynamic_invariant4 o40 true false true) (and (= (invariant__ o40) true) (and (= (to_rep1 (last (rt o40))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o39 1))) (= (to_rep (select values2 k)) (to_rep (select (elts o40) k))))) (and (forall ((k Int)) (=> (and (<= (+ o39 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select (elts o40) (- k 1)))))) (forall ((k Int)) (=> (and (<= o39 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts o40) k))))))))))))
(assert (and (= o42 (remove o40 o41)) (and (dynamic_invariant4 o42 true false true) (and (= (invariant__ o42) true) (and (= (to_rep1 (last (rt o42))) (- (to_rep1 (last (rt o40))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o41 1))) (= (to_rep (select (elts o40) k)) (to_rep (select (elts o42) k))))) (and (forall ((k Int)) (=> (and (<= (+ o41 1) k) (<= k (to_rep1 (last (rt o40))))) (= (to_rep (select (elts o40) k)) (to_rep (select (elts o42) (- k 1)))))) (forall ((k Int)) (=> (and (<= o41 k) (<= k (- (to_rep1 (last (rt o40))) 1))) (= (to_rep (select (elts o40) (+ k 1))) (to_rep (select (elts o42) k))))))))))))
