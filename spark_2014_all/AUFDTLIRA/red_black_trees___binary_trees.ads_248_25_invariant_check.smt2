...
(assert (not (= j6 v)))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o93 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j6)) (and (in_range2 o93) (and (= o93 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 j6))))) (and (=> (= (valid_root (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j6) true) (= o93 0)) (=> (= (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) 0) (= o93 0)))))))
