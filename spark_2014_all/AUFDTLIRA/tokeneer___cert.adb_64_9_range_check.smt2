...
(assert (not (= (length (mk___t temp___1901 temp___19011)) 0)))
(assert (=> (<= 1 12) (= o6 (+ (- 12 1) 1))))
(assert (=> (not (<= 1 12)) (= o6 0)))
(assert (=> (<= (to_rep1 (first temp___19011)) (to_rep1 (last temp___19011))) (= o7 (+ (- (to_rep1 (last temp___19011)) (to_rep1 (first temp___19011))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___19011)) (to_rep1 (last temp___19011)))) (= o7 0)))
(assert (= o8 (+ o7 o6)))
(assert (= o9 (+ (to_rep1 (first temp___19011)) o8)))
(assert (= o10 (- o9 1)))
