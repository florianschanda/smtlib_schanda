...
(declare-const i Int)
(declare-const temp___320 (Array Int natural))
(declare-const o Int)
...
(assert (not (not (and (and (= (mk_int__ref result) (mk_int__ref i)) (= i1 1)) (ite (and (<= 1 i1) (<= i1 2)) (and (and (and (= temp___320 a) (and (and (forall ((temp___321 Int)) (=> (and (<= (to_rep1 a__first) temp___321) (<= temp___321 (to_rep1 a__last))) (=> (or (< 2 temp___321) (or (< temp___321 1) (<= i2 temp___321))) (= (select a2 temp___321) (select temp___320 temp___321))))) (and (<= 1 i2) (<= i2 2))) (and (and (and (and (and (<= (to_rep1 a__first) i2) (<= i2 (to_rep1 a__last))) (= o i2)) (= o1 (store a2 o rliteral))) (and (= a2 result1) (= a3 o1))) (and (and (and (and (and (and (=> (<= (to_rep1 a__first) i2) (and (and (<= (to_rep1 a__first) (to_rep1 a__first)) (<= (to_rep1 a__first) (to_rep1 a__last))) (and (<= (to_rep1 a__first) i2) (<= i2 (to_rep1 a__last))))) (= o2 a3)) (and (= o2 temp___318) (= (mk1 (to_rep1 a__first) i2) temp___3181))) (and (= temp___318 loops_static__loop1__B_2__a_begins__assume) (= (mk (to_rep1 (first2 temp___3181)) (to_rep1 (last2 temp___3181))) loops_static__loop1__B_2__a_begins__assume1))) (= (mk___t loops_static__loop1__B_2__a_begins__assume loops_static__loop1__B_2__a_begins__assume1) a_begins)) (dynamic_invariant a_begins true false true true)) (and (forall ((i7 Int)) (=> (and (<= (to_rep1 (first (rt a_begins))) i7) (<= i7 (to_rep1 (last (rt a_begins))))) (= (to_rep (select (elts a_begins) i7)) 0))) (= i2 2)))))) (and (and (= i2 i3) (= a3 a4)) (and (= i4 i2) (= a5 a3)))) (and (and (= (mk_int__ref i5) (mk_int__ref i3)) (= a8 (mk_map__ref a4))) (and (= i6 i4) (= a7 a5)))) (and (and (= i1 i5) (= a8 (mk_map__ref a))) (and (= i6 i1) (= a7 a1))))))))
(check-sat)
(exit)
