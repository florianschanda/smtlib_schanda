...
(assert (= i2 1))
(assert (=> (and (<= 1 i2) (<= i2 2)) (= temp___283 a)))
(assert (=> (and (<= 1 i2) (<= i2 2)) (and (forall ((temp___284 Int)) (=> (and (<= (to_rep1 a__first) temp___284) (<= temp___284 (to_rep1 a__last))) (=> (<= i3 temp___284) (= (select a2 temp___284) (select temp___283 temp___284))))) (and (<= 1 i3) (<= i3 2)))))
(assert (=> (and (<= 1 i2) (<= i2 2)) (= (to_rep o) 0)))
(assert (=> (and (<= 1 i2) (<= i2 2)) (and (<= (to_rep1 a__first) i3) (<= i3 (to_rep1 a__last)))))
(assert (=> (and (<= 1 i2) (<= i2 2)) (= o1 i3)))
(assert (=> (and (<= 1 i2) (<= i2 2)) (= o2 (store a2 o1 o))))
(assert (=> (and (<= 1 i2) (<= i2 2)) (= a2 result1)))
(assert (=> (and (<= 1 i2) (<= i2 2)) (= a3 o2)))
(assert (=> (and (<= 1 i2) (<= i2 2)) (=> (<= (to_rep1 a__first) i3) (and (and (<= (to_rep1 a__first) (to_rep1 a__first)) (<= (to_rep1 a__first) (to_rep1 a__last))) (and (<= (to_rep1 a__first) i3) (<= i3 (to_rep1 a__last)))))))
(assert (=> (and (<= 1 i2) (<= i2 2)) (= o3 a3)))
(assert (=> (and (<= 1 i2) (<= i2 2)) (= o3 temp___281)))
(assert (=> (and (<= 1 i2) (<= i2 2)) (= (mk1 (to_rep1 a__first) i3) temp___2811)))
(assert (=> (and (<= 1 i2) (<= i2 2)) (= temp___281 loops_static__loop1__B_2__a_begins__assume)))
(assert (=> (and (<= 1 i2) (<= i2 2)) (= (mk (to_rep1 (first2 temp___2811)) (to_rep1 (last2 temp___2811))) loops_static__loop1__B_2__a_begins__assume1)))
(assert (=> (and (<= 1 i2) (<= i2 2)) (= (mk___t loops_static__loop1__B_2__a_begins__assume loops_static__loop1__B_2__a_begins__assume1) a_begins)))
(assert (=> (and (<= 1 i2) (<= i2 2)) (dynamic_invariant a_begins true false true)))
(assert (=> (and (<= 1 i2) (<= i2 2)) (forall ((i8 Int)) (=> (and (<= (to_rep1 (first (rt a_begins))) i8) (<= i8 (to_rep1 (last (rt a_begins))))) (= (to_rep (select (elts a_begins) i8)) 0)))))
(assert (=> (and (<= 1 i2) (<= i2 2)) (= i3 2)))
(assert (=> (and (<= 1 i2) (<= i2 2)) (= i3 i4)))
(assert (=> (and (<= 1 i2) (<= i2 2)) (= a3 a4)))
(assert (=> (and (<= 1 i2) (<= i2 2)) (= i5 i3)))
(assert (=> (and (<= 1 i2) (<= i2 2)) (= a5 a3)))
(assert (=> (and (<= 1 i2) (<= i2 2)) (= (mk_int__ref i6) (mk_int__ref i4))))
(assert (=> (and (<= 1 i2) (<= i2 2)) (= (mk_map__ref a6) (mk_map__ref a4))))
(assert (=> (and (<= 1 i2) (<= i2 2)) (= i7 i5)))
(assert (=> (and (<= 1 i2) (<= i2 2)) (= a7 a5)))
(assert (=> (not (and (<= 1 i2) (<= i2 2))) (= i2 i6)))
(assert (=> (not (and (<= 1 i2) (<= i2 2))) (= (mk_map__ref a6) (mk_map__ref a))))
(assert (=> (not (and (<= 1 i2) (<= i2 2))) (= i7 i2)))
(assert (=> (not (and (<= 1 i2) (<= i2 2))) (= a7 a1)))
(assert (not false))
(check-sat)
(exit)
