...
(assert (and (= o5 (parent (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) i)) (and (in_range4 o5) (and (=> (= (valid_root (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) i) true) (= o5 0)) (=> (= (size (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2))) 0) (= o5 0))))))
(assert (and (= o6 o5) (in_range3 o5)))
(assert (= result12 (mk_int__ref j11)))
(assert (= j12 o6))
(assert (and (= o7 (position (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) i)) (in_range5 o7)))
(assert (= result13 (mk_int__ref d2)))
(assert (= d3 o7))
(assert (and (= o8 (to_rep1 t__split_fields)) (in_range3 (to_rep1 t__split_fields))))
...
(assert (= result14 (mk___split_fields__ref3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3))))
(assert (= t__split_fields5 (mk___split_fields3 t__split_fields (mk___rep2 binary_trees__extract__f__fields) t__split_fields3)))
