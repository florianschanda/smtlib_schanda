...
(assert (and (= o1 (parent (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) i)) (and (in_range4 o1) (and (=> (= (valid_root (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) i) true) (= o1 0)) (=> (= (size (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2))) 0) (= o1 0))))))
(assert (and (= o2 o1) (in_range3 o1)))
(assert (= result9 (mk_int__ref j1)))
(assert (= j2 o2))
(assert (and (= o3 (position (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) i)) (in_range5 o3)))
(assert (= result10 (mk_int__ref d1)))
(assert (= d2 o3))
(assert (and (= o4 (to_rep1 t__split_fields)) (in_range3 (to_rep1 t__split_fields))))
...
(assert (not (in_range3 binary_trees__extract__v)))
(check-sat)
(exit)
