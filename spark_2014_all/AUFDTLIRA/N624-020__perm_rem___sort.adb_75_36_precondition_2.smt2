...
(assert (and (= o21 (remove_swap (mk___t interm1 (mk 1 100)) o19 o20)) (and (in_range5 o21) (=> (= (distinct o21 0) true) (= (let ((temp___182 (remove (remove (mk___t interm1 (mk 1 100)) o20) o19))) (let ((temp___181 (remove (remove (mk___t interm1 (mk 1 100)) o19) (- o20 1)))) (bool_eq (elts temp___181) (to_rep1 (first (rt temp___181))) (to_rep1 (last (rt temp___181))) (elts temp___182) (to_rep1 (first (rt temp___182))) (to_rep1 (last (rt temp___182)))))) true)))))
...
(assert (= hr4 o24))
(assert (= (let ((temp___257 (remove (remove (mk___t values2 (mk 1 100)) x) (- y 1)))) (let ((temp___256 (remove (remove (mk___t interm1 (mk 1 100)) x) (- y 1)))) (bool_eq (elts temp___256) (to_rep1 (first (rt temp___256))) (to_rep1 (last (rt temp___256))) (elts temp___257) (to_rep1 (first (rt temp___257))) (to_rep1 (last (rt temp___257)))))) true))
(assert (and (= o29 (- y 1)) (in_range4 (- y 1))))
(assert (and (= o27 x) (in_range4 x)))
(assert (and (= o28 (remove (mk___t interm1 (mk 1 100)) o27)) (and (dynamic_invariant3 o28 true false true true) (and (= (invariant__ o28) true) (and (= (to_rep1 (last (rt o28))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o27 1))) (= (to_rep (select interm1 k)) (to_rep (select (elts o28) k))))) (and (forall ((k Int)) (=> (and (<= (+ o27 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select interm1 k)) (to_rep (select (elts o28) (- k 1)))))) (forall ((k Int)) (=> (and (<= o27 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select interm1 (+ k 1))) (to_rep (select (elts o28) k))))))))))))
(assert (and (= o25 x) (in_range4 x)))
(assert (and (= o26 (remove (mk___t init (mk 1 100)) o25)) (and (dynamic_invariant3 o26 true false true true) (and (= (invariant__ o26) true) (and (= (to_rep1 (last (rt o26))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o25 1))) (= (to_rep (select init k)) (to_rep (select (elts o26) k))))) (and (forall ((k Int)) (=> (and (<= (+ o25 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select init k)) (to_rep (select (elts o26) (- k 1)))))) (forall ((k Int)) (=> (and (<= o25 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select init (+ k 1))) (to_rep (select (elts o26) k))))))))))))
(assert (and (= o30 (remove_eq o26 o28 o29)) (and (in_range5 o30) (=> (= (distinct o30 0) true) (= (let ((temp___188 (remove o28 o29))) (let ((temp___187 (remove o26 o29))) (bool_eq (elts temp___187) (to_rep1 (first (rt temp___187))) (to_rep1 (last (rt temp___187))) (elts temp___188) (to_rep1 (first (rt temp___188))) (to_rep1 (last (rt temp___188)))))) true)))))
(assert (= result7 (mk_int__ref hr4)))
(assert (= hr5 o30))
(assert (and (= o33 (- y 1)) (in_range4 (- y 1))))
(assert (and (= o31 x) (in_range4 x)))
(assert (and (= o32 (remove (mk___t values2 (mk 1 100)) o31)) (and (dynamic_invariant3 o32 true false true true) (and (= (invariant__ o32) true) (and (= (to_rep1 (last (rt o32))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o31 1))) (= (to_rep (select values2 k)) (to_rep (select (elts o32) k))))) (and (forall ((k Int)) (=> (and (<= (+ o31 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select (elts o32) (- k 1)))))) (forall ((k Int)) (=> (and (<= o31 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts o32) k))))))))))))
(assert (and (= temp___263 (remove o32 o33)) (and (dynamic_invariant3 temp___263 true false true true) (and (= (invariant__ temp___263) true) (and (= (to_rep1 (last (rt temp___263))) (- (to_rep1 (last (rt o32))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o33 1))) (= (to_rep (select (elts o32) k)) (to_rep (select (elts temp___263) k))))) (and (forall ((k Int)) (=> (and (<= (+ o33 1) k) (<= k (to_rep1 (last (rt o32))))) (= (to_rep (select (elts o32) k)) (to_rep (select (elts temp___263) (- k 1)))))) (forall ((k Int)) (=> (and (<= o33 k) (<= k (- (to_rep1 (last (rt o32))) 1))) (= (to_rep (select (elts o32) (+ k 1))) (to_rep (select (elts temp___263) k))))))))))))
...
(assert (not (<= (to_rep1 (first (rt o35))) o36)))
(check-sat)
(exit)
