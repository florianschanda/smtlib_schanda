...
(assert (= a4 a2))
(assert (not (or (and (< j 50) (or (and (< 0 e) (= (bool_eq1 a3 5 50 (temp___925 a j (temp___933 (select a j) i e) (+ j 1) (temp___940 (select a (+ j 1)) i (- e 1))) 5 50) true)) (and (= e 0) (= (bool_eq1 a3 5 50 (temp___948 a j (temp___956 (select a j) i e) (+ j 1) (temp___963 (select a (+ j 1)) i 99)) 5 50) true)))) (and (= j 50) (or (and (< 0 e) (= (bool_eq1 a3 5 50 (temp___971 a j (temp___979 (select a j) i e) 5 (temp___986 (select a 5) i (- e 1))) 5 50) true)) (and (= e 0) (= (bool_eq1 a3 5 50 (temp___994 a j (temp___1002 (select a j) i e) 5 (temp___1009 (select a 5) i 99)) 5 50) true)))))))
(check-sat)
(exit)
