...
(assert (= a4 a2))
(assert (not (or (and (< j 50) (or (and (< 0 e) (= (bool_eq1 a3 5 50 (temp___866 a j (temp___874 (select a j) i e) (+ j 1) (temp___881 (select a (+ j 1)) i (- e 1))) 5 50) true)) (and (= e 0) (= (bool_eq1 a3 5 50 (temp___889 a j (temp___897 (select a j) i e) (+ j 1) (temp___904 (select a (+ j 1)) i 99)) 5 50) true)))) (and (= j 50) (or (and (< 0 e) (= (bool_eq1 a3 5 50 (temp___912 a j (temp___920 (select a j) i e) 5 (temp___927 (select a 5) i (- e 1))) 5 50) true)) (and (= e 0) (= (bool_eq1 a3 5 50 (temp___935 a j (temp___943 (select a j) i e) 5 (temp___950 (select a 5) i 99)) 5 50) true)))))))
(check-sat)
(exit)
