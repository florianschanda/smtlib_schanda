...
(declare-fun temp___636 (Int Int Int) (Array Int enum_t))
...
(assert (forall ((temp___638 Int) (temp___639 Int) (temp___640 Int)) (let ((temp___637 (temp___636 temp___638 temp___639 temp___640))) (=> (and (and (dynamic_invariant1 temp___638 true true true true) (dynamic_invariant1 temp___639 true true true true)) (dynamic_invariant1 temp___640 true true true true)) (forall ((temp___641 Int)) (ite (= temp___641 1000) (= (to_rep (select temp___637 temp___641)) temp___639) (ite (or (= temp___641 2) (and (<= 4 temp___641) (<= temp___641 6))) (= (to_rep (select temp___637 temp___641)) temp___638) (= (to_rep (select temp___637 temp___641)) temp___640))))))))
(declare-const x (Array Int enum_t))
(declare-const result (Array Int enum_t))
(declare-const x1 (Array Int enum_t))
(assert (in_range2 n))
(assert (= result x))
(assert (= x1 (temp___636 0 2 1)))
