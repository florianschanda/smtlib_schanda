...
(assert (and (and (and (and (not (= (select winners3 0) true)) (< latest_highest_score2 i2)) (= (select winners3 latest_highest_score2) true)) (forall ((j Int)) (=> (and (<= 1 j) (<= j (- i2 1))) (=> (< latest_highest_score2 j) (< (to_rep (select counters j)) (to_rep (select counters latest_highest_score2))))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (- i2 1))) (ite (= (select winners3 j) true) (= (to_rep (select counters latest_highest_score2)) (to_rep (select counters j))) (< (to_rep (select counters j)) (to_rep (select counters latest_highest_score2))))))))
...
(assert (=> (and (and (= (to_int1 (select winners3 0)) (to_int1 (of_int 0))) (< latest_highest_score2 i2)) (= (select winners3 latest_highest_score2) true)) (= (= result4 true) (forall ((j Int)) (=> (and (<= 1 j) (<= j (- i2 1))) (=> (< latest_highest_score2 j) (< (to_rep (select counters j)) (to_rep (select counters latest_highest_score2)))))))))
(assert (=> (not (and (and (= (to_int1 (select winners3 0)) (to_int1 (of_int 0))) (< latest_highest_score2 i2)) (= (select winners3 latest_highest_score2) true))) (= result4 false)))
(assert (= result4 true))
(assert (<= 1 (- i2 1)))
(assert (not (<= 0 1)))
(check-sat)
