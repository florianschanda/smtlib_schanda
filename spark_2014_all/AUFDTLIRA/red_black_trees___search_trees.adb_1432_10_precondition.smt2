...
(assert (forall ((i10 Int)) (=> (and (<= 1 i10) (<= i10 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields5) (to_rep1 (rec__search_trees__search_tree__root t__split_fields5))) i10))) true) (not (= (to_rep (select (rec__search_trees__search_tree__values t__split_fields5) i10)) v))))))
...
(assert (and (and (= (size (mk___rep2 binary_trees__insert__f__fields)) (+ (size (mk___rep2 (us_split_fields5 (rec__search_trees__search_tree__struct t__split_fields5)))) 1)) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 binary_trees__insert__f__fields) o9) o10))) true) (and (= (peek (mk___rep2 binary_trees__insert__f__fields) o10 (int__content d7)) binary_trees__insert__v) (and (forall ((i10 Int)) (=> (and (<= 1 i10) (<= i10 100)) (ite (= (valid_root (mk___rep2 (us_split_fields5 (rec__search_trees__search_tree__struct t__split_fields5))) i10) true) (= (valid_root (mk___rep2 binary_trees__insert__f__fields) i10) true) (not (= (valid_root (mk___rep2 binary_trees__insert__f__fields) i10) true))))) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 binary_trees__insert__f__fields) o9) binary_trees__insert__v))) true) (and (not (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (us_split_fields5 (rec__search_trees__search_tree__struct t__split_fields5))) o9) binary_trees__insert__v))) true)) (and (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (not (= j binary_trees__insert__v)) (= (parent (mk___rep2 binary_trees__insert__f__fields) j) (parent (mk___rep2 (us_split_fields5 (rec__search_trees__search_tree__struct t__split_fields5))) j))))) (and (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (not (= j binary_trees__insert__v)) (not (= (parent (mk___rep2 (us_split_fields5 (rec__search_trees__search_tree__struct t__split_fields5))) j) 0))) (= (position (mk___rep2 binary_trees__insert__f__fields) j) (position (mk___rep2 (us_split_fields5 (rec__search_trees__search_tree__struct t__split_fields5))) j))))) (and (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (forall ((e Int)) (=> (and (<= 0 e) (<= e 1)) (=> (or (not (= j o10)) (not (= e (int__content d7)))) (= (peek (mk___rep2 binary_trees__insert__f__fields) j e) (peek (mk___rep2 (us_split_fields5 (rec__search_trees__search_tree__struct t__split_fields5))) j e))))))) (and (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 binary_trees__insert__f__fields) o9) j))) true) (or (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (us_split_fields5 (rec__search_trees__search_tree__struct t__split_fields5))) o9) j))) true) (= j binary_trees__insert__v))))) (and (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (us_split_fields5 (rec__search_trees__search_tree__struct t__split_fields5))) o9) j))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 binary_trees__insert__f__fields) o9) j))) true)))) (and (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 binary_trees__insert__f__fields) o9) j))) true) (not (= j binary_trees__insert__v))) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 binary_trees__insert__f__fields) o9) j))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 (us_split_fields5 (rec__search_trees__search_tree__struct t__split_fields5))) o9) j)))) true)))) (and (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 binary_trees__insert__f__fields) o9) o10))) (int__content d7) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 binary_trees__insert__f__fields) o9) binary_trees__insert__v)))) true) (forall ((i10 Int)) (=> (and (<= 1 i10) (<= i10 100)) (=> (and (not (= i10 o9)) (= (valid_root (mk___rep2 (us_split_fields5 (rec__search_trees__search_tree__struct t__split_fields5))) i10) true)) (= (oeq2 (model__ (mk___rep2 binary_trees__insert__f__fields) i10) (model__ (mk___rep2 (us_split_fields5 (rec__search_trees__search_tree__struct t__split_fields5))) i10)) true))))))))))))))))) (and (= (tree_structure (mk___rep2 binary_trees__insert__f__fields)) true) (in_range3 binary_trees__insert__v))))
(assert (= result10 (mk___split_fields__ref3 t__split_fields5)))
(assert (= t__split_fields6 (mk___split_fields3 (rec__search_trees__search_tree__root t__split_fields5) (mk___rep2 binary_trees__insert__f__fields) (rec__search_trees__search_tree__values t__split_fields5))))
(assert (= result11 i7))
...
(assert (and (= o15 (int__content previous6)) (in_range3 (int__content previous6))))
(assert (type_invariant1 (mk___rep3 t_old__split_fields4)))
(assert (and (= o16 (int__content previous6)) (in_range3 (int__content previous6))))
(assert (not (< 0 (size (rec__search_trees__search_tree__struct t_old__split_fields4)))))
(check-sat)
(exit)
