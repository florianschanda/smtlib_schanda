...
(assert (forall ((temp___553 us_rep)) (forall ((temp___554 Int)) (= (select (temp___551 temp___553) temp___554) temp___553))))
(declare-fun temp___555 (Int Int Int Int Int) (Array Int character))
(assert (forall ((temp___557 Int) (temp___558 Int) (temp___559 Int) (temp___560 Int) (temp___561 Int)) (let ((temp___556 (temp___555 temp___557 temp___558 temp___559 temp___560 temp___561))) (and (and (and (and (= (select temp___556 1) (of_rep1 temp___557)) (= (select temp___556 2) (of_rep1 temp___558))) (= (select temp___556 3) (of_rep1 temp___559))) (= (select temp___556 4) (of_rep1 temp___560))) (= (select temp___556 5) (of_rep1 temp___561))))))
...
(define-fun dynamic_invariant1 ((temp___expr_314 Int) (temp___is_init_311 Bool) (temp___skip_constant_312 Bool) (temp___do_toplevel_313 Bool)) Bool (=> (or (= temp___is_init_311 true) (<= 0 5)) (in_range temp___expr_314)))
