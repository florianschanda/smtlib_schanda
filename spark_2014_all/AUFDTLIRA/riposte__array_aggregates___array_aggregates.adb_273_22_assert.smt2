...
(declare-fun temp_____aggregate_def_604 (Int Int Int Int Int) (Array Int character))
...
(assert (forall ((temp___602 us_rep)) (forall ((temp___603 Int)) (= (select (temp_____aggregate_def_600 temp___602) temp___603) temp___602))))
(assert (forall ((temp___606 Int) (temp___607 Int) (temp___608 Int) (temp___609 Int) (temp___610 Int)) (let ((temp___605 (temp_____aggregate_def_604 temp___606 temp___607 temp___608 temp___609 temp___610))) (=> (and (and (and (and (dynamic_invariant temp___606 true true true true) (dynamic_invariant temp___607 true true true true)) (dynamic_invariant temp___608 true true true true)) (dynamic_invariant temp___609 true true true true)) (dynamic_invariant temp___610 true true true true)) (and (and (and (and (= (to_rep1 (select temp___605 1)) temp___606) (= (to_rep1 (select temp___605 2)) temp___607)) (= (to_rep1 (select temp___605 3)) temp___608)) (= (to_rep1 (select temp___605 4)) temp___609)) (= (to_rep1 (select temp___605 5)) temp___610))))))
...
(assert (= result x))
(assert (= x1 (temp_____aggregate_def_600 (mk___rep (mk___split_fields rliteral (temp_____aggregate_def_604 72 101 108 108 111))))))
(assert (not (= (to_rep (rec__array_aggregates__string_t__len (us_split_fields1 (select x1 3)))) 3)))
(check-sat)
(exit)
