...
(assert (not (= j10 i)))
(assert (type_invariant1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3))))
(assert (and (= o221 (parent1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)) j10)) (and (in_range4 o221) (and (= o221 (parent (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) j10)) (=> (= (size1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3))) 0) (= o221 0))))))
(assert (= o222 (ite (= o221 i) true false)))
(assert (= result45 (ite (not (= o222 true)) true false)))
(assert (not (= result45 true)))
