...
(assert (=> (= (mem model____split_fields1 res) true) (and (and (= (is_prepend model____split_fields res (rec__list_allocator__m__t__available (us_split_fields__content1 model____split_fields5))) true) (= (length (rec__list_allocator__m__t__allocated (us_split_fields__content1 model____split_fields5))) (- (length model____split_fields1) 1))) (forall ((j8 Int)) (=> (and (<= 1 j8) (<= j8 (length model____split_fields1))) (=> (not (= (get model____split_fields1 j8) res)) (= (mem (rec__list_allocator__m__t__allocated (us_split_fields__content1 model____split_fields5)) (get model____split_fields1 j8)) true)))))))
