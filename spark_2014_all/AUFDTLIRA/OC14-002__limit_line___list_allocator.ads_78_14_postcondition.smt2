...
(assert (=> (= result true) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (rec__list_allocator__m__t__allocated model____split_fields4)))) (in_range4 (get (rec__list_allocator__m__t__allocated model____split_fields4) j))))))
(assert (=> (= result true) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (rec__list_allocator__m__t__allocated model____split_fields4)))) (and (in_range4 (get (rec__list_allocator__m__t__allocated model____split_fields4) j)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data4 (get (rec__list_allocator__m__t__allocated model____split_fields4) j))))) (ite (< j (length (rec__list_allocator__m__t__allocated model____split_fields4))) (get (rec__list_allocator__m__t__allocated model____split_fields4) (+ j 1)) 0)))))))
...
(assert (=> (= (mem model____split_fields1 res) true) (and (and (= (is_prepend model____split_fields res (rec__list_allocator__m__t__available (us_split_fields__content1 model____split_fields5))) true) (= (length (rec__list_allocator__m__t__allocated (us_split_fields__content1 model____split_fields5))) (- (length model____split_fields1) 1))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length model____split_fields1))) (=> (not (= (get model____split_fields1 j) res)) (= (mem (rec__list_allocator__m__t__allocated (us_split_fields__content1 model____split_fields5)) (get model____split_fields1 j)) true)))))))
(assert (=> (not (= (mem model____split_fields1 res) true)) (= (oeq2 (mk___rep1 (us_split_fields__content1 model____split_fields5)) (mk___rep1 (mk___split_fields1 model____split_fields model____split_fields1))) true)))
(assert (not (= (is_valid (int__content first_available3) (int__content first_allocated3) (us_split_fields__content1 model____split_fields5) (map__content data5)) true)))
(check-sat)
(exit)
