...
(declare-const temp___2007 (Array Int character))
(declare-const temp___20071 t3)
...
(assert (= (slide data1 (to_rep1 data__first) 1) temp___2007))
(assert (= (mk3 1 (to_rep1 data__last)) temp___20071))
