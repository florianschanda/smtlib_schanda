...
(assert (= (ite (<= (to_rep (first temp___1811)) (to_rep (last temp___1811))) (+ (- (to_rep (last temp___1811)) (to_rep (first temp___1811))) 1) 0) (ite (<= (to_rep x__first) (to_rep x__last)) (+ (- (to_rep x__last) (to_rep x__first)) 1) 0)))
(assert (= (mk___t temp___182 temp___1821) (mk___t temp___181 temp___1811)))
(assert (= o (slide temp___182 (to_rep (first temp___1821)) (to_rep x__first))))
(assert (= (mk_map__ref result) (mk_map__ref x)))
(assert (= x1 o))
(assert (= x1 x2))
(assert (= x3 x1))
(assert (not (= (to_rep1 (select x2 (to_rep x__first))) 0)))
(check-sat)
(exit)
