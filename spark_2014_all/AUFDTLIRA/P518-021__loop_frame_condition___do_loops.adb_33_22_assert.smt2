...
(assert (<= 1 i1))
(assert (<= i1 100))
(assert (and (and (forall ((temp___242 Int)) (=> (and (<= 1 temp___242) (<= temp___242 100)) (ite (<= i2 temp___242) (= (select (rec__do_loops__r_array_record__f3 d__split_fields2) temp___242) (select d__split_fields temp___242)) (= (rec__do_loops__r__f2 (us_split_fields1 (select (rec__do_loops__r_array_record__f3 d__split_fields2) temp___242))) (rec__do_loops__r__f2 (us_split_fields1 (select d__split_fields temp___242))))))) (= (rec__do_loops__r_array_record__f4 d__split_fields2) d__split_fields1)) (and (<= 1 i2) (<= i2 100))))
(assert (= (to_rep o2) 0))
