...
(assert (<= 1 i1))
(assert (<= i1 100))
(assert (and (and (forall ((temp___276 Int)) (=> (and (<= 1 temp___276) (<= temp___276 100)) (ite (<= i2 temp___276) (= (select (rec__do_loops__r_array_record__f3 d__split_fields2) temp___276) (select d__split_fields temp___276)) (= (rec__do_loops__r__f2 (us_split_fields1 (select (rec__do_loops__r_array_record__f3 d__split_fields2) temp___276))) (rec__do_loops__r__f2 (us_split_fields1 (select d__split_fields temp___276))))))) (= (rec__do_loops__r_array_record__f4 d__split_fields2) d__split_fields1)) (and (<= 1 i2) (<= i2 100))))
(assert (= (to_rep o2) 0))
(assert (= o3 (mk___split_fields o2 (rec__do_loops__r__f2 (us_split_fields1 (select (rec__do_loops__r_array_record__f3 d__split_fields2) i2))))))
(assert (= o4 (mk___rep o3)))
(assert (= o5 (store (rec__do_loops__r_array_record__f3 d__split_fields2) i2 o4)))
(assert (= o6 (mk___split_fields1 o5 (rec__do_loops__r_array_record__f4 d__split_fields2))))
(assert (= temp___268 (mk___rep1 o6)))
(assert (= result2 (mk___split_fields__ref1 d__split_fields2)))
(assert (= d__split_fields3 (us_split_fields3 temp___268)))
(assert (= (to_rep (rec__do_loops__r__f2 (us_split_fields1 (select (rec__do_loops__r_array_record__f3 d__split_fields3) i2)))) (to_rep (rec__do_loops__r__f2 (us_split_fields1 (select d__split_fields i2))))))
(assert (not (= (bool_eq1 (rec__do_loops__r_array_record__f4 d__split_fields3) 1 100 d__split_fields1 1 100) true)))
(check-sat)
(exit)
