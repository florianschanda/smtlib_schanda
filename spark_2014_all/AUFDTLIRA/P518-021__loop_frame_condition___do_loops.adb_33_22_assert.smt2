...
(assert (<= 1 i7))
(assert (<= i7 100))
(assert (and (and (forall ((temp___242 Int)) (=> (and (<= 1 temp___242) (<= temp___242 100)) (ite (<= i8 temp___242) (= (select (rec__do_loops__r_array_record__f3 d__split_fields3) temp___242) (select d__split_fields temp___242)) (= (rec__do_loops__r__f2 (us_split_fields1 (select (rec__do_loops__r_array_record__f3 d__split_fields3) temp___242))) (rec__do_loops__r__f2 (us_split_fields1 (select d__split_fields temp___242))))))) (= (rec__do_loops__r_array_record__f4 d__split_fields3) d__split_fields1)) (and (<= 1 i8) (<= i8 100))))
(assert (= (to_rep o2) 0))
(assert (= o3 (mk___split_fields o2 (rec__do_loops__r__f2 (us_split_fields1 (select (rec__do_loops__r_array_record__f3 d__split_fields3) i8))))))
(assert (= o4 (mk___rep o3)))
(assert (= o5 (store (rec__do_loops__r_array_record__f3 d__split_fields3) i8 o4)))
(assert (= o6 (mk___split_fields1 o5 (rec__do_loops__r_array_record__f4 d__split_fields3))))
(assert (= temp___234 (mk___rep1 o6)))
(assert (= result2 (mk___split_fields__ref1 d__split_fields3)))
(assert (= d__split_fields4 (us_split_fields3 temp___234)))
(assert (= (to_rep (rec__do_loops__r__f2 (us_split_fields1 (select (rec__do_loops__r_array_record__f3 d__split_fields4) i8)))) (to_rep (rec__do_loops__r__f2 (us_split_fields1 (select d__split_fields i8))))))
(assert (not (= (bool_eq1 (rec__do_loops__r_array_record__f4 d__split_fields4) 1 100 d__split_fields1 1 100) true)))
(check-sat)
(exit)
