...
(assert (=> (= status3 8) (and (= o30 (rolepresent (mk___rep1 (mk___split_fields1 theadmin__split_fields6 theadmin__split_fields7)))) (in_range9 o30))))
(assert (=> (= status3 8) (= o31 (ite (= o30 0) true false))))
(assert (=> (= status3 8) (= o29 (isdoingop (mk___rep1 (mk___split_fields1 theadmin__split_fields6 theadmin__split_fields7))))))
(assert (=> (= status3 8) (= o32 (ite (not (= o29 true)) true false))))
(assert (=> (= status3 8) (= o33 (ite (= o32 true) o31 false))))
(assert (=> (not (= status3 8)) (= o33 (of_int 1))))
(assert (=> (= status3 3) (and (= o24 (rolepresent (mk___rep1 (mk___split_fields1 theadmin__split_fields theadmin__split_fields1)))) (in_range9 o24))))
(assert (=> (= status3 3) (and (= o25 (rolepresent (mk___rep1 (mk___split_fields1 theadmin__split_fields6 theadmin__split_fields7)))) (in_range9 o25))))
(assert (=> (= status3 3) (= o26 (ite (= o25 o24) true false))))
(assert (=> (= status3 3) (= o23 (isdoingop (mk___rep1 (mk___split_fields1 theadmin__split_fields6 theadmin__split_fields7))))))
(assert (=> (= status3 3) (= o27 (ite (not (= o23 true)) true false))))
(assert (=> (= status3 3) (= o28 (ite (= o27 true) o26 false))))
(assert (=> (not (= status3 3)) (= o28 (of_int 1))))
(assert (=> (=> (not (= status3 6)) (= status3 7)) (and (= o18 (rolepresent (mk___rep1 (mk___split_fields1 theadmin__split_fields theadmin__split_fields1)))) (in_range9 o18))))
(assert (=> (=> (not (= status3 6)) (= status3 7)) (and (= o19 (rolepresent (mk___rep1 (mk___split_fields1 theadmin__split_fields6 theadmin__split_fields7)))) (in_range9 o19))))
(assert (=> (=> (not (= status3 6)) (= status3 7)) (= o20 (ite (= o19 o18) true false))))
(assert (=> (=> (not (= status3 6)) (= status3 7)) (= o16 (ispresent (mk___rep1 (mk___split_fields1 theadmin__split_fields6 theadmin__split_fields7))))))
(assert (=> (=> (not (= status3 6)) (= status3 7)) (= o17 (isdoingop (mk___rep1 (mk___split_fields1 theadmin__split_fields6 theadmin__split_fields7))))))
(assert (=> (=> (not (= status3 6)) (= status3 7)) (= o21 (ite (= o17 true) o16 false))))
(assert (=> (=> (not (= status3 6)) (= status3 7)) (= o22 (ite (= o21 true) o20 false))))
(assert (=> (not (=> (not (= status3 6)) (= status3 7))) (= o22 (of_int 1))))
(assert (and (= o12 (thecurrentop (mk___rep1 (mk___split_fields1 theadmin__split_fields6 theadmin__split_fields7)))) (in_range8 o12)))
(assert (= o13 (ite (= o12 4) true false)))
(assert (= o14 (isdoingop (mk___rep1 (mk___split_fields1 theadmin__split_fields6 theadmin__split_fields7)))))
(assert (= result2 (ite (= o14 true) o13 false)))
(assert (=> (= result2 true) (= o15 (ite (= status3 6) true false))))
...
(assert (=> (= result3 true) (= o8 (isdoingop (mk___rep1 (mk___split_fields1 theadmin__split_fields6 theadmin__split_fields7))))))
(assert (=> (= result3 true) (= o9 (ite (not (= o8 true)) true false))))
(assert (=> (= result3 true) (and (= o5 (thecurrentop (mk___rep1 (mk___split_fields1 theadmin__split_fields6 theadmin__split_fields7)))) (in_range8 o5))))
(assert (=> (= result3 true) (= o6 (ite (= o5 3) true false))))
(assert (=> (= result3 true) (= o7 (isdoingop (mk___rep1 (mk___split_fields1 theadmin__split_fields6 theadmin__split_fields7))))))
