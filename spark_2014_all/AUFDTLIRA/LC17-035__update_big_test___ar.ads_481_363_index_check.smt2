...
(assert (=> (< 0 e) (= o7 (+ k 1))))
(assert (=> (< 0 e) (= temp___5361 (select a o7))))
(assert (=> (< 0 e) (= o9 (select temp___5361 j))))
(assert (=> (< 0 e) (= o10 (temp___1675 o9 i o8))))
(assert (=> (< 0 e) (and (<= 1 (+ k 1)) (<= (+ k 1) 16))))
(assert (=> (< 0 e) (= o6 (+ k 1))))
(assert (=> (< 0 e) (= o11 (select a o6))))
(assert (=> (< 0 e) (= o12 (temp___1668 o11 j o10))))
(assert (=> (< 0 e) (and (= o13 (+ k 1)) (in_range2 (+ k 1)))))
(assert (=> (< 0 e) (= temp___5362 (temp___1645 a k (temp___1653 (select a k) j (temp___1660 (select (select a k) j) i e)) o13 o12))))
