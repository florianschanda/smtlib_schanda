...
(assert (=> (< 0 e) (= o10 (temp___1734 o9 i o8))))
(assert (=> (< 0 e) (and (<= 1 (+ k 1)) (<= (+ k 1) 16))))
(assert (=> (< 0 e) (= o6 (+ k 1))))
(assert (=> (< 0 e) (= o11 (select a o6))))
(assert (=> (< 0 e) (= o12 (temp___1727 o11 j o10))))
(assert (=> (< 0 e) (and (= o13 (+ k 1)) (in_range2 (+ k 1)))))
(assert (=> (< 0 e) (= temp___5421 (temp___1704 a k (temp___1712 (select a k) j (temp___1719 (select (select a k) j) i e)) o13 o12))))
