...
(assert (forall ((a (Array Int us_rep)) (b (Array Int us_rep))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (forall ((i1 Int)) (! (and (=> (and (<= a_first i1) (<= i1 a_last)) (= (select (concat1 a a_first a_last b b_first b_last) i1) (select a i1))) (=> (< a_last i1) (= (select (concat1 a a_first a_last b b_first b_last) i1) (select b (+ (- i1 a_last) (- b_first 1)))))) :pattern ((select (concat1 a a_first a_last b b_first b_last) i1)))))))
(declare-fun singleton1 (us_rep Int) (Array Int us_rep))
(assert (forall ((v us_rep)) (forall ((i1 Int)) (! (= (select (singleton1 v i1) i1) v) :pattern ((select (singleton1 v i1) i1))))))
...
(declare-const x__split_fields1 null_record_type)
(declare-const cache (Array Int us_rep))
(declare-const o Int)
(declare-const o1 Bool)
(declare-const o2 null_record_type)
(declare-const o3 Bool)
(declare-const o4 null_record_type)
(declare-const o5 Bool)
(declare-const o6 Bool)
(declare-const o7 null_record_type)
(declare-const temp___168 Bool)
(declare-const temp___1681 null_record_type)
(declare-const result Bool)
(declare-const result1 null_record_type)
(declare-const x__split_fields2 Bool)
(declare-const x__split_fields3 null_record_type)
(assert (in_range i))
(assert (not (<= 1 i)))
(check-sat)
(exit)
