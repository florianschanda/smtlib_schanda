...
(define-fun dynamic_invariant ((temp___expr_396 Int) (temp___is_init_393 Bool) (temp___skip_constant_394 Bool) (temp___do_toplevel_395 Bool)) Bool (=> (or (= temp___is_init_393 true) (<= 0 2147483647)) (in_range3 temp___expr_396)))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_286 us_t1) (temp___is_init_283 Bool) (temp___skip_constant_284 Bool) (temp___do_toplevel_285 Bool)) Bool (and (=> (not (= temp___skip_constant_284 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_286) (last3 temp___expr_286))) (=> (= temp___do_toplevel_285 true) (=> (= temp___is_init_283 true) (and (= (first5 (of_array2 (to_array1 temp___expr_286) (first3 temp___expr_286) (last3 temp___expr_286))) 1) (<= (last3 temp___expr_286) 1000))))))
(define-fun dynamic_predicate ((temp___290 us_t1)) Bool (and (= (first5 (of_array2 (to_array1 temp___290) (first3 temp___290) (last3 temp___290))) 1) (<= (last3 temp___290) 1000)))
...
(assert (forall ((x Int)) (! (=> (dynamic_invariant x true true true) (= (fart_image x) (let ((temp___402 (to_string (attr__ATTRIBUTE_IMAGE3 x)))) (of_array1 (to_array temp___402) (first1 temp___402) (last1 temp___402))))) :pattern ((fart_image x)))))
...
(declare-fun temp___String_Literal_2454 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2454 us_void_param) 1)) 65) (= (to_rep (select (temp___String_Literal_2454 us_void_param) 2)) 99)) (= (to_rep (select (temp___String_Literal_2454 us_void_param) 3)) 104)) (= (to_rep (select (temp___String_Literal_2454 us_void_param) 4)) 101)) (= (to_rep (select (temp___String_Literal_2454 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_2454 us_void_param) 6)) 118)) (= (to_rep (select (temp___String_Literal_2454 us_void_param) 7)) 101)) (= (to_rep (select (temp___String_Literal_2454 us_void_param) 8)) 100)) (= (to_rep (select (temp___String_Literal_2454 us_void_param) 9)) 32)) (= (to_rep (select (temp___String_Literal_2454 us_void_param) 10)) 70)) (= (to_rep (select (temp___String_Literal_2454 us_void_param) 11)) 65)) (= (to_rep (select (temp___String_Literal_2454 us_void_param) 12)) 82)) (= (to_rep (select (temp___String_Literal_2454 us_void_param) 13)) 32)) (= (to_rep (select (temp___String_Literal_2454 us_void_param) 14)) 58)) (= (to_rep (select (temp___String_Literal_2454 us_void_param) 15)) 32)) :pattern ((temp___String_Literal_2454 us_void_param)))))
...
(declare-const temp___2461 (Array Int character))
(declare-const temp___24611 t3)
(declare-const o6 (Array Int character))
(declare-const temp___2464 (Array Int character))
(declare-const temp___24641 t3)
(declare-const result (Array Int character))
(declare-const fullstring1 (Array Int character))
(assert (in_range3 achievedfar))
(assert (and (= (mk___t1 temp___2456 temp___24561) (fart_image achievedfar)) (and (dynamic_invariant1 (mk___t1 temp___2456 temp___24561) true false true) (= (mk___t1 temp___2456 temp___24561) (let ((temp___400 (to_string (attr__ATTRIBUTE_IMAGE3 achievedfar)))) (mk___t1 (elts temp___400) (mk1 (to_rep1 (first (rt temp___400))) (to_rep1 (last (rt temp___400))))))))))
(assert (=> (<= (to_rep1 (first2 temp___24561)) (to_rep1 (last2 temp___24561))) (= o (+ (- (to_rep1 (last2 temp___24561)) (to_rep1 (first2 temp___24561))) 1))))
(assert (=> (not (<= (to_rep1 (first2 temp___24561)) (to_rep1 (last2 temp___24561)))) (= o 0)))
...
(assert (= (concat1 (temp___String_Literal_2454 Tuple0) 1 15 temp___2456 (to_rep1 (first2 temp___24561)) (to_rep1 (last2 temp___24561))) userentry__validatefinger__achievedfardescription__setresultstring__fullstring__assume))
