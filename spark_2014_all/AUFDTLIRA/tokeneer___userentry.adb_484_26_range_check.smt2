...
(define-fun dynamic_invariant ((temp___expr_489 Int) (temp___is_init_485 Bool) (temp___skip_constant_486 Bool) (temp___do_toplevel_487 Bool) (temp___do_typ_inv_488 Bool)) Bool (=> (or (= temp___is_init_485 true) (<= 0 2147483647)) (in_range3 temp___expr_489)))
(declare-sort t2 0)
...
(assert (forall ((x Int)) (! (=> (dynamic_invariant x true true true true) (= (fart_image x) (let ((temp___495 (to_string (attr__ATTRIBUTE_IMAGE3 x)))) (of_array1 (to_array temp___495) (first1 temp___495) (last1 temp___495))))) :pattern ((fart_image x)))))
...
(declare-fun temp___String_Literal_2703 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2703 us_void_param) 1)) 65) (= (to_rep (select (temp___String_Literal_2703 us_void_param) 2)) 99)) (= (to_rep (select (temp___String_Literal_2703 us_void_param) 3)) 104)) (= (to_rep (select (temp___String_Literal_2703 us_void_param) 4)) 101)) (= (to_rep (select (temp___String_Literal_2703 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_2703 us_void_param) 6)) 118)) (= (to_rep (select (temp___String_Literal_2703 us_void_param) 7)) 101)) (= (to_rep (select (temp___String_Literal_2703 us_void_param) 8)) 100)) (= (to_rep (select (temp___String_Literal_2703 us_void_param) 9)) 32)) (= (to_rep (select (temp___String_Literal_2703 us_void_param) 10)) 70)) (= (to_rep (select (temp___String_Literal_2703 us_void_param) 11)) 65)) (= (to_rep (select (temp___String_Literal_2703 us_void_param) 12)) 82)) (= (to_rep (select (temp___String_Literal_2703 us_void_param) 13)) 32)) (= (to_rep (select (temp___String_Literal_2703 us_void_param) 14)) 58)) (= (to_rep (select (temp___String_Literal_2703 us_void_param) 15)) 32)) :pattern ((temp___String_Literal_2703 us_void_param)))))
...
(declare-const temp___2705 (Array Int character))
(declare-const temp___27051 t1)
(declare-const o Int)
...
(define-fun temp___27052 () us_t1 (mk___t1 temp___2705 temp___27051))
(assert (in_range3 achievedfar))
(assert (and (= temp___27052 (fart_image achievedfar)) (and (dynamic_invariant1 temp___27052 true false true true) (= temp___27052 (let ((temp___493 (to_string (attr__ATTRIBUTE_IMAGE3 achievedfar)))) (mk___t1 (elts temp___493) (mk1 (to_rep1 (first (rt temp___493))) (to_rep1 (last (rt temp___493))))))))))
(assert (=> (<= (to_rep1 (first2 temp___27051)) (to_rep1 (last2 temp___27051))) (= o (+ (- (to_rep1 (last2 temp___27051)) (to_rep1 (first2 temp___27051))) 1))))
(assert (=> (not (<= (to_rep1 (first2 temp___27051)) (to_rep1 (last2 temp___27051)))) (= o 0)))
...
(assert (= (concat1 (temp___String_Literal_2703 Tuple0) 1 15 temp___2705 (to_rep1 (first2 temp___27051)) (to_rep1 (last2 temp___27051))) userentry__validatefinger__achievedfardescription__setresultstring__fullstring__assume))
