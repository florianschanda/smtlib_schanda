...
(assert (<= (compare (temp___String_Literal_266 Tuple0) 1 10 (temp___String_Literal_267 Tuple0) 1 10) 0))
...
(assert (and (dynamic_property (- 2147483648) 2147483647 (to_rep1 a__first) (to_rep1 a__last)) (forall ((temp___272 Int)) (=> (and (<= (to_rep1 a__first) temp___272) (<= temp___272 (to_rep1 a__last))) (let ((temp___147 (select a1 temp___272))) (<= (compare (rec__messages__message__sent (us_split_fields1 temp___147)) 1 10 (rec__messages__message__received (us_split_fields1 temp___147)) 1 10) 0))))))
