...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= temp___178 i1)))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= temp___177 pos1)))
...
(assert (not (or (and (= search__search__result4 0) (= (no_v_in_range t v 1 10) true)) (and (= (to_rep (select t search__search__result4)) v) (= (no_v_in_range t v 1 (- search__search__result4 1)) true)))))
(check-sat)
(exit)
