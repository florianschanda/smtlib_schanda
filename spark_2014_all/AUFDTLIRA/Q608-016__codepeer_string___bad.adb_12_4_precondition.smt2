...
(declare-fun bad__bad_lo__aggregate_def (Int) (Array Int character))
...
(assert (forall ((temp___218 Int)) (=> (dynamic_invariant1 temp___218 true true true true) (forall ((temp___219 Int)) (= (to_rep (select (bad__bad_lo__aggregate_def temp___218) temp___219)) temp___218)))))
(assert (not true))
(check-sat)
(exit)
