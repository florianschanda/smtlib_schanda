...
(declare-const i Int)
(declare-const temp___510 (Array Int fruits))
...
(assert (=> (and (<= (to_rep inventory__first) i2) (<= i2 (to_rep inventory__last))) (= temp___510 inventory)))
(assert (=> (and (<= (to_rep inventory__first) i2) (<= i2 (to_rep inventory__last))) (and (forall ((temp___511 Int)) (=> (and (<= (to_rep inventory__first) temp___511) (<= temp___511 (to_rep inventory__last))) (=> (<= i3 temp___511) (= (select inventory2 temp___511) (select temp___510 temp___511))))) (and (<= (to_rep inventory__first) i3) (<= i3 (to_rep inventory__last))))))
