...
(assert (=> (and (<= (to_rep inventory__first) i2) (<= i2 (to_rep inventory__last))) (= temp___459 inventory)))
(assert (=> (and (<= (to_rep inventory__first) i2) (<= i2 (to_rep inventory__last))) (and (forall ((temp___460 Int)) (=> (and (<= (to_rep inventory__first) temp___460) (<= temp___460 (to_rep inventory__last))) (=> (<= i3 temp___460) (= (select inventory2 temp___460) (select temp___459 temp___460))))) (and (<= (to_rep inventory__first) i3) (<= i3 (to_rep inventory__last))))))
...
(assert (=> (and (<= (to_rep inventory__first) i2) (<= i2 (to_rep inventory__last))) (= (mk_int__ref i6) (mk_int__ref i4))))
(assert (=> (and (<= (to_rep inventory__first) i2) (<= i2 (to_rep inventory__last))) (= (mk_map__ref inventory6) (mk_map__ref inventory4))))
...
(assert (=> (not (and (<= (to_rep inventory__first) i2) (<= i2 (to_rep inventory__last)))) (= (mk_map__ref inventory6) (mk_map__ref inventory))))
...
(assert (= (mk_int__ref i8) (mk_int__ref i6)))
(assert (= (mk_map__ref inventory8) (mk_map__ref inventory6)))
(assert (= i9 i7))
(assert (= inventory9 inventory7))
(assert (<= (to_rep inventory__first) i1))
(assert (<= i1 (to_rep inventory__last)))
(assert (not (<= (to_rep inventory__first) i1)))
(check-sat)
(exit)
