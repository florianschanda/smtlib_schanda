...
(assert (not (<= 1 (+ (+ (+ (+ (+ (+ 0 (ite (= (= (length source) 0) true) 1 0)) (ite (= (= (length source) 1) true) 1 0)) (ite (= (ite (= (> (length source) 1) true) (< (length source) 10) false) true) 1 0)) (ite (= (= (length source) 10) true) 1 0)) (ite (= (= (length source) 11) true) 1 0)) (ite (= (>= (length source) 12) true) 1 0)))))
(check-sat)
(exit)
