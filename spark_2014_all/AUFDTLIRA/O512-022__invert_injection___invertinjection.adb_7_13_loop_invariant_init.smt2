...
(assert (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (to_rep (select a i2)) (to_rep (select a j))) (= i2 j)))))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (not (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (not (= (to_rep (select a j)) i2)))))))))
...
(assert (<= 1 j))
(assert (<= j (- i1 1)))
(assert (not (= (to_rep (select b (to_rep (select a j)))) j)))
(check-sat)
(exit)
