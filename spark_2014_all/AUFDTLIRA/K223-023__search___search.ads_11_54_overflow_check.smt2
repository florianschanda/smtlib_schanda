...
(assert (= (mk_int__ref result5) (mk_int__ref search__search__result)))
...
(assert (= i11 i9))
(assert (= pos11 pos9))
(assert (=> (= search__search__result4 0) (and (= result6 (no_v_in_range t v 1 10)) (= (= result6 true) (forall ((pos12 Int)) (=> (and (<= 1 pos12) (<= pos12 10)) (not (= (to_rep (select t pos12)) v))))))))
(assert (=> (not (= search__search__result4 0)) (= result6 false)))
(assert (not (= result6 true)))
(assert (and (<= 1 search__search__result4) (<= search__search__result4 10)))
(assert (= o10 search__search__result4))
(assert (= o11 (select t o10)))
(assert (= o12 (to_rep o11)))
(assert (= result7 (ite (= o12 v) true false)))
(assert (= result7 true))
