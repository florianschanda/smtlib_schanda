...
(define-fun dynamic_invariant ((temp___expr_229 Int) (temp___is_init_225 Bool) (temp___skip_constant_226 Bool) (temp___do_toplevel_227 Bool) (temp___do_typ_inv_228 Bool)) Bool (=> (or (= temp___is_init_225 true) (<= 1 2147483647)) (in_range1 temp___expr_229)))
...
(define-fun dynamic_invariant3 ((temp___expr_74 Int) (temp___is_init_70 Bool) (temp___skip_constant_71 Bool) (temp___do_toplevel_72 Bool) (temp___do_typ_inv_73 Bool)) Bool (=> (or (= temp___is_init_70 true) (<= 0 255)) (in_range temp___expr_74)))
...
(assert (in_range1 location))
(assert (<= location (length1 this)))
(assert (not (<= (to_rep1 (first (rt (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 this))))) location)))
(check-sat)
(exit)
