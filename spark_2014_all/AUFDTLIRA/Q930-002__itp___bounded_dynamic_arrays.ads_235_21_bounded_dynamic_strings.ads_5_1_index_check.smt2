...
(define-fun dynamic_invariant ((temp___expr_201 Int) (temp___is_init_198 Bool) (temp___skip_constant_199 Bool) (temp___do_toplevel_200 Bool)) Bool (=> (or (= temp___is_init_198 true) (<= 1 2147483647)) (in_range1 temp___expr_201)))
...
(assert (dynamic_invariant1 this true false true))
