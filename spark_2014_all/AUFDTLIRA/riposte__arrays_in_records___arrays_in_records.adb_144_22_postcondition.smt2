...
(declare-const temp___308 index)
(declare-const temp___3081 (Array Int value))
(declare-const temp___3082 (Array Int value))
...
(declare-const temp___311 index)
(declare-const temp___3111 (Array Int value))
(declare-const temp___3112 (Array Int value))
...
(assert (= temp___308 o2))
(assert (= temp___3081 o3))
(assert (= temp___3082 o4))
(assert (= result a__split_fields))
(assert (= result1 a__split_fields1))
(assert (= result2 a__split_fields2))
(assert (= temp___308 a__split_fields3))
(assert (= temp___3081 a__split_fields4))
(assert (= temp___3082 a__split_fields5))
(assert (= (to_rep o5) 42))
(assert (= o6 (store a__split_fields4 j o5)))
(assert (= a__split_fields3 o7))
(assert (= o6 o8))
(assert (= a__split_fields5 o9))
(assert (= temp___311 o7))
(assert (= temp___3111 o8))
(assert (= temp___3112 o9))
(assert (= result3 a__split_fields3))
(assert (= result4 a__split_fields4))
(assert (= result5 a__split_fields5))
(assert (= temp___311 a__split_fields6))
(assert (= temp___3111 a__split_fields7))
(assert (= temp___3112 a__split_fields8))
