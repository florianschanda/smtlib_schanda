...
(declare-const temp___281 index)
(declare-const temp___2811 (Array Int value))
(declare-const temp___2812 (Array Int value))
...
(declare-const temp___284 index)
(declare-const temp___2841 (Array Int value))
(declare-const temp___2842 (Array Int value))
...
(assert (not (= i j)))
(assert (= (to_rep o) 23))
(assert (= o1 (store a__split_fields1 i o)))
(assert (= a__split_fields o2))
(assert (= o1 o3))
(assert (= a__split_fields2 o4))
(assert (= temp___281 o2))
(assert (= temp___2811 o3))
(assert (= temp___2812 o4))
(assert (= result a__split_fields))
(assert (= result1 a__split_fields1))
(assert (= result2 a__split_fields2))
(assert (= temp___281 a__split_fields3))
(assert (= temp___2811 a__split_fields4))
(assert (= temp___2812 a__split_fields5))
(assert (= (to_rep o5) 42))
(assert (= o6 (store a__split_fields4 j o5)))
(assert (= a__split_fields3 o7))
(assert (= o6 o8))
(assert (= a__split_fields5 o9))
(assert (= temp___284 o7))
(assert (= temp___2841 o8))
(assert (= temp___2842 o9))
(assert (= result3 a__split_fields3))
(assert (= result4 a__split_fields4))
(assert (= result5 a__split_fields5))
(assert (= temp___284 a__split_fields6))
(assert (= temp___2841 a__split_fields7))
(assert (= temp___2842 a__split_fields8))
...
(assert (not (not (= (to_rep (select a__split_fields10 i)) 23))))
(check-sat)
(exit)
