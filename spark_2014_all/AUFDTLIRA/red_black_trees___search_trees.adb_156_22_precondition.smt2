...
(assert (= o10 o12))
(assert (= o13 o11))
(assert (and (= temp___1477 (model__ f_old root)) (and (dynamic_invariant5 temp___1477 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1477 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1477 root)))) 0) (and (forall ((i34 Int)) (=> (and (<= 1 i34) (<= i34 100)) (=> (not (= i34 root)) (ite (and (not (= (parent f_old i34) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1477 (parent f_old i34)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1477 i34))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1477 i34))) true)))))) (and (forall ((i34 Int)) (=> (and (<= 1 i34) (<= i34 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1477 i34))) true) (not (= i34 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1477 (parent f_old i34)))) (position f_old i34) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1477 i34)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1477 i34)))) 0)))) (forall ((i34 Int)) (=> (and (<= 1 i34) (<= i34 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1477 i34))) true) (forall ((j52 Int)) (=> (and (<= 1 j52) (<= j52 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1477 j52))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1477 i34))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1477 j52)))) true)) (= j52 i34))))))))))))))
(assert (= (mk___rep (mk___split_fields o4 o5)) (select temp___1477 v)))
(assert (= o4 o6))
(assert (= o5 o7))
(assert (= o8 o6))
(assert (not (<= (length o8) 100)))
(check-sat)
(exit)
