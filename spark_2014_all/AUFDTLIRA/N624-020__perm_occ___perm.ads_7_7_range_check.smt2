...
(define-fun dynamic_invariant ((temp___expr_142 us_t) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (not (= temp___skip_constant_140 true)) (dynamic_property 1 100 (first1 temp___expr_142) (last1 temp___expr_142))))
...
(define-fun dynamic_invariant3 ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= 1 100)) (in_range2 temp___expr_136)))
(declare-const temp___210 Int)
(assert (dynamic_invariant a true false true))
(assert (< 0 (length a)))
(assert (and (= temp___210 (- (to_rep (last (rt a))) 1)) (in_range (- (to_rep (last (rt a))) 1))))
