...
(define-fun dynamic_invariant1 ((temp___expr_159 Int) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool) (temp___do_typ_inv_158 Bool)) Bool (=> (or (= temp___is_init_155 true) (<= 1 100)) (in_range3 temp___expr_159)))
...
(assert (forall ((a us_t)) (! (=> (dynamic_invariant2 a true true true true) (= (remove_last a) (let ((temp___184 (let ((temp___183 (- (last1 a) 1))) (let ((temp___182 (first1 a))) (of_array1 (to_array a) temp___182 temp___183))))) (of_array (to_array1 temp___184) (first3 temp___184) (last3 temp___184))))) :pattern ((remove_last a)))))
...
(define-fun dynamic_invariant3 ((temp___expr_172 Int) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool) (temp___do_typ_inv_171 Bool)) Bool (=> (or (= temp___is_init_168 true) (<= 0 100)) (in_range4 temp___expr_172)))
...
(declare-const b3 (Array Int natural))
(declare-const b4 (Array Int natural))
(declare-const b5 (Array Int natural))
(declare-const b6 (Array Int natural))
(declare-const result2 Bool)
(define-fun o12 () us_t (mk___t o7 o8))
(define-fun o13 () us_t (mk___t o5 o6))
(define-fun o14 () us_t (mk___t o o1))
...
(assert (and (= perm__occ_set__b__assume2 (remove_last a)) (and (dynamic_invariant2 perm__occ_set__b__assume2 true false true true) (and (= (elts a) perm__occ_set__b__assume) (= (mk (to_rep1 (first2 (mk1 (to_rep1 (first (rt a))) (- (to_rep1 (last (rt a))) 1)))) (to_rep1 (last2 (mk1 (to_rep1 (first (rt a))) (- (to_rep1 (last (rt a))) 1))))) perm__occ_set__b__assume1)))))
...
(assert (or (and (and (= b1 b3) (= b4 b1)) (= (length a) 0)) (and (not (= (length a) 0)) (and (and (= b2 b3) (= b4 b2)) (ite (= i (to_rep1 (last (rt a)))) (and (and (and (= o14 (remove_last r)) (and (dynamic_invariant2 o14 true false true true) (and (= (elts r) o) (= (mk (to_rep1 (first2 (mk1 (to_rep1 (first (rt r))) (- (to_rep1 (last (rt r))) 1)))) (to_rep1 (last2 (mk1 (to_rep1 (first (rt r))) (- (to_rep1 (last (rt r))) 1))))) o1)))) (= (occ (mk___t b1 (mk (to_rep1 b__first) (to_rep1 b__last))) e) (occ o14 e))) (= b2 b1)) (and (and (and (= (to_rep o2) v) (and (and (and (<= (to_rep1 b__first) i) (<= i (to_rep1 b__last))) (= o3 i)) (= o4 (store b1 o3 o2)))) (and (= b1 result1) (= b2 o4))) (and (and (and (= o13 (remove_last r)) (and (dynamic_invariant2 o13 true false true true) (and (= (elts r) o5) (= (mk (to_rep1 (first2 (mk1 (to_rep1 (first (rt r))) (- (to_rep1 (last (rt r))) 1)))) (to_rep1 (last2 (mk1 (to_rep1 (first (rt r))) (- (to_rep1 (last (rt r))) 1))))) o6)))) (= (occ o13 e) (occ (mk___t b2 (mk (to_rep1 b__first) (to_rep1 b__last))) e))) (and (and (= o12 (remove_last a)) (and (dynamic_invariant2 o12 true false true true) (and (= (elts a) o7) (= (mk (to_rep1 (first2 (mk1 (to_rep1 (first (rt a))) (- (to_rep1 (last (rt a))) 1)))) (to_rep1 (last2 (mk1 (to_rep1 (first (rt a))) (- (to_rep1 (last (rt a))) 1))))) o8)))) (ite (= v (to_rep (select o7 i))) (= (occ (mk___t b2 (mk (to_rep1 b__first) (to_rep1 b__last))) e) (occ o12 e)) (ite (= v e) (= (occ (mk___t b2 (mk (to_rep1 b__first) (to_rep1 b__last))) e) (+ (occ o12 e) 1)) (ite (= (to_rep (select o7 i)) e) (= (occ (mk___t b2 (mk (to_rep1 b__first) (to_rep1 b__last))) e) (- (occ o12 e) 1)) (= (occ (mk___t b2 (mk (to_rep1 b__first) (to_rep1 b__last))) e) (occ o12 e)))))))))))))
(assert (= (mk_map__ref b5) (mk_map__ref b3)))
(assert (= b6 b4))
(assert (and (<= (to_rep1 (first (rt a))) i) (<= i (to_rep1 (last (rt a))))))
(assert (= o9 i))
(assert (= o10 (select (elts a) o9)))
(assert (= o11 (to_rep o10)))
(assert (= result2 (ite (= v o11) true false)))
