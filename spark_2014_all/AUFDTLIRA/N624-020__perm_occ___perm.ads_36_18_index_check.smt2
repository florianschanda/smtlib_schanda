...
(assert (or (and (and (= b1 b3) (= b4 b1)) (= (length a) 0)) (and (not (= (length a) 0)) (and (and (= b2 b3) (= b4 b2)) (ite (= i (to_rep1 (last (rt a)))) (and (and (and (= o14 (remove_last r)) (and (dynamic_invariant2 o14 true false true) (and (= (elts r) o) (= (mk (to_rep1 (first2 (mk1 (to_rep1 (first (rt r))) (- (to_rep1 (last (rt r))) 1)))) (to_rep1 (last2 (mk1 (to_rep1 (first (rt r))) (- (to_rep1 (last (rt r))) 1))))) o1)))) (= (occ (mk___t b1 (mk (to_rep1 b__first) (to_rep1 b__last))) e) (occ o14 e))) (= b2 b1)) (and (and (and (= (to_rep o2) v) (and (and (and (<= (to_rep1 b__first) i) (<= i (to_rep1 b__last))) (= o3 i)) (= o4 (store b1 o3 o2)))) (and (= b1 result1) (= b2 o4))) (and (and (and (= o13 (remove_last r)) (and (dynamic_invariant2 o13 true false true) (and (= (elts r) o5) (= (mk (to_rep1 (first2 (mk1 (to_rep1 (first (rt r))) (- (to_rep1 (last (rt r))) 1)))) (to_rep1 (last2 (mk1 (to_rep1 (first (rt r))) (- (to_rep1 (last (rt r))) 1))))) o6)))) (= (occ o13 e) (occ (mk___t b2 (mk (to_rep1 b__first) (to_rep1 b__last))) e))) (and (and (= o12 (remove_last a)) (and (dynamic_invariant2 o12 true false true) (and (= (elts a) o7) (= (mk (to_rep1 (first2 (mk1 (to_rep1 (first (rt a))) (- (to_rep1 (last (rt a))) 1)))) (to_rep1 (last2 (mk1 (to_rep1 (first (rt a))) (- (to_rep1 (last (rt a))) 1))))) o8)))) (ite (= v (to_rep (select o7 i))) (= (occ (mk___t b2 (mk (to_rep1 b__first) (to_rep1 b__last))) e) (occ o12 e)) (ite (= v e) (= (occ (mk___t b2 (mk (to_rep1 b__first) (to_rep1 b__last))) e) (+ (occ o12 e) 1)) (ite (= (to_rep (select o7 i)) e) (= (occ (mk___t b2 (mk (to_rep1 b__first) (to_rep1 b__last))) e) (- (occ o12 e) 1)) (= (occ (mk___t b2 (mk (to_rep1 b__first) (to_rep1 b__last))) e) (occ o12 e)))))))))))))
