...
(assert (and (= (mk___t perm__occ_set__b__assume perm__occ_set__b__assume1) (remove_last a)) (and (dynamic_invariant2 (mk___t perm__occ_set__b__assume perm__occ_set__b__assume1) true false true) (and (= (elts a) perm__occ_set__b__assume) (= (mk (to_rep1 (first2 (mk1 (to_rep1 (first (rt a))) (- (to_rep1 (last (rt a))) 1)))) (to_rep1 (last2 (mk1 (to_rep1 (first (rt a))) (- (to_rep1 (last (rt a))) 1))))) perm__occ_set__b__assume1)))))
...
(assert (or (and (and (= b1 b3) (= b4 b1)) (= (length a) 0)) (and (not (= (length a) 0)) (and (and (= b2 b3) (= b4 b2)) (ite (= i (to_rep1 (last (rt a)))) (and (and (and (= (mk___t o o1) (remove_last r)) (and (dynamic_invariant2 (mk___t o o1) true false true) (and (= (elts r) o) (= (mk (to_rep1 (first2 (mk1 (to_rep1 (first (rt r))) (- (to_rep1 (last (rt r))) 1)))) (to_rep1 (last2 (mk1 (to_rep1 (first (rt r))) (- (to_rep1 (last (rt r))) 1))))) o1)))) (= (occ (mk___t b1 (mk (to_rep1 b__first) (to_rep1 b__last))) e) (occ (mk___t o o1) e))) (= b2 b1)) (and (and (and (= (to_rep o2) v) (and (and (and (<= (to_rep1 b__first) i) (<= i (to_rep1 b__last))) (= o3 i)) (= o4 (store b1 o3 o2)))) (and (= b1 result1) (= b2 o4))) (and (and (and (= (mk___t o5 o6) (remove_last r)) (and (dynamic_invariant2 (mk___t o5 o6) true false true) (and (= (elts r) o5) (= (mk (to_rep1 (first2 (mk1 (to_rep1 (first (rt r))) (- (to_rep1 (last (rt r))) 1)))) (to_rep1 (last2 (mk1 (to_rep1 (first (rt r))) (- (to_rep1 (last (rt r))) 1))))) o6)))) (= (occ (mk___t o5 o6) e) (occ (mk___t b2 (mk (to_rep1 b__first) (to_rep1 b__last))) e))) (and (and (= (mk___t o7 o8) (remove_last a)) (and (dynamic_invariant2 (mk___t o7 o8) true false true) (and (= (elts a) o7) (= (mk (to_rep1 (first2 (mk1 (to_rep1 (first (rt a))) (- (to_rep1 (last (rt a))) 1)))) (to_rep1 (last2 (mk1 (to_rep1 (first (rt a))) (- (to_rep1 (last (rt a))) 1))))) o8)))) (ite (= v (to_rep (select o7 i))) (= (occ (mk___t b2 (mk (to_rep1 b__first) (to_rep1 b__last))) e) (occ (mk___t o7 o8) e)) (ite (= v e) (= (occ (mk___t b2 (mk (to_rep1 b__first) (to_rep1 b__last))) e) (+ (occ (mk___t o7 o8) e) 1)) (ite (= (to_rep (select o7 i)) e) (= (occ (mk___t b2 (mk (to_rep1 b__first) (to_rep1 b__last))) e) (- (occ (mk___t o7 o8) e) 1)) (= (occ (mk___t b2 (mk (to_rep1 b__first) (to_rep1 b__last))) e) (occ (mk___t o7 o8) e)))))))))))))
