...
(define-fun temp___4132 () us_t (mk___t temp___413 temp___4131))
...
(assert (= o i))
(assert (= temp___4132 (temp___406 (mk___t a (mk (to_rep a__first) (to_rep a__last))) 1 o new_val)))
...
(assert (= (mk___t temp___414 temp___4141) temp___4132))
(assert (= o1 (slide temp___414 (to_rep (first temp___4141)) (to_rep a__first))))
(assert (= (mk_map__ref result) (mk_map__ref a)))
(assert (= a1 o1))
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (let ((temp___421 (temp___234 (mk___t a (mk (to_rep a__first) (to_rep a__last))) 1 i new_val))) (bool_eq a2 (to_rep a__first) (to_rep a__last) (elts temp___421) (to_rep (first (rt temp___421))) (to_rep (last (rt temp___421))))) true)))
(check-sat)
(exit)
