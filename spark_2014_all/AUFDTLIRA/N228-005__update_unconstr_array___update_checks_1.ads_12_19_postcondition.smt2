...
(declare-fun temp_____aggregate_def_268 (us_t Int Int Int) us_t)
(declare-fun temp_____aggregate_def_448 (us_t Int Int Int) us_t)
...
(assert (forall ((temp___450 us_t)) (forall ((temp___451 Int) (temp___452 Int) (temp___453 Int)) (let ((temp___449 (temp_____aggregate_def_448 temp___450 temp___451 temp___452 temp___453))) (=> (and (and (and (dynamic_invariant2 temp___450 true true true true) (dynamic_invariant1 temp___451 true true true true)) (dynamic_invariant1 temp___452 true true true true)) (dynamic_invariant temp___453 true true true true)) (and (and (= (first1 temp___449) (first1 temp___450)) (= (last1 temp___449) (last1 temp___450))) (forall ((temp___454 Int)) (ite (and (<= temp___451 temp___454) (<= temp___454 temp___452)) (= (to_rep1 (select (to_array temp___449) temp___454)) temp___453) (= (select (to_array temp___449) temp___454) (select (to_array temp___450) temp___454))))))))))
(assert (forall ((temp___270 us_t)) (forall ((temp___271 Int) (temp___272 Int) (temp___273 Int)) (let ((temp___269 (temp_____aggregate_def_268 temp___270 temp___271 temp___272 temp___273))) (=> (and (and (and (dynamic_invariant2 temp___270 true true true true) (dynamic_invariant1 temp___271 true true true true)) (dynamic_invariant1 temp___272 true true true true)) (dynamic_invariant temp___273 true true true true)) (and (and (= (first1 temp___269) (first1 temp___270)) (= (last1 temp___269) (last1 temp___270))) (forall ((temp___274 Int)) (ite (and (<= temp___271 temp___274) (<= temp___274 temp___272)) (= (to_rep1 (select (to_array temp___269) temp___274)) temp___273) (= (select (to_array temp___269) temp___274) (select (to_array temp___270) temp___274))))))))))
(declare-const a (Array Int integer))
(declare-const us Int)
(declare-const o Int)
(declare-const temp___455 (Array Int integer))
(declare-const temp___4551 t)
(declare-const temp___456 (Array Int integer))
(declare-const temp___4561 t)
...
(define-fun temp___4552 () us_t (mk___t temp___455 temp___4551))
...
(assert (= o i))
(assert (= temp___4552 (temp_____aggregate_def_448 (mk___t a (mk (to_rep a__first) (to_rep a__last))) 1 o new_val)))
(assert (= (ite (<= (to_rep (first temp___4551)) (to_rep (last temp___4551))) (+ (- (to_rep (last temp___4551)) (to_rep (first temp___4551))) 1) 0) (ite (<= (to_rep a__first) (to_rep a__last)) (+ (- (to_rep a__last) (to_rep a__first)) 1) 0)))
(assert (= (mk___t temp___456 temp___4561) temp___4552))
(assert (= o1 (slide temp___456 (to_rep (first temp___4561)) (to_rep a__first))))
(assert (= (mk_map__ref result) (mk_map__ref a)))
(assert (= a1 o1))
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (let ((temp___463 (temp_____aggregate_def_268 (mk___t a (mk (to_rep a__first) (to_rep a__last))) 1 i new_val))) (bool_eq a2 (to_rep a__first) (to_rep a__last) (elts temp___463) (to_rep (first (rt temp___463))) (to_rep (last (rt temp___463))))) true)))
(check-sat)
(exit)
