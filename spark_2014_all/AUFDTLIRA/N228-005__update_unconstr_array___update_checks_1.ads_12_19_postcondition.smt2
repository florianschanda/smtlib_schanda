...
(declare-fun temp___268 (us_t Int Int Int) us_t)
(declare-fun temp___448 (us_t Int Int Int) us_t)
...
(assert (forall ((temp___450 us_t)) (forall ((temp___451 Int) (temp___452 Int) (temp___453 Int)) (let ((temp___449 (temp___448 temp___450 temp___451 temp___452 temp___453))) (=> (and (and (and (dynamic_invariant2 temp___450 true true true true) (dynamic_invariant1 temp___451 true true true true)) (dynamic_invariant1 temp___452 true true true true)) (dynamic_invariant temp___453 true true true true)) (and (and (= (first1 temp___449) (first1 temp___450)) (= (last1 temp___449) (last1 temp___450))) (forall ((temp___454 Int)) (ite (and (<= temp___451 temp___454) (<= temp___454 temp___452)) (= (to_rep1 (select (to_array temp___449) temp___454)) temp___453) (= (select (to_array temp___449) temp___454) (select (to_array temp___450) temp___454))))))))))
...
(assert (= o i))
(assert (= temp___4552 (temp___448 (mk___t a (mk (to_rep a__first) (to_rep a__last))) 1 o new_val)))
...
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (let ((temp___463 (temp___268 (mk___t a (mk (to_rep a__first) (to_rep a__last))) 1 i new_val))) (bool_eq a2 (to_rep a__first) (to_rep a__last) (elts temp___463) (to_rep (first (rt temp___463))) (to_rep (last (rt temp___463))))) true)))
(check-sat)
(exit)
