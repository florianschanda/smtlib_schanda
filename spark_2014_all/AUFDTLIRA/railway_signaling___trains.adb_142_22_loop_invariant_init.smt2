...
(assert (not (or (= (to_rep5 (select track_signals13 (get_other_previous_track new_position k1))) 1) (= (to_rep5 (select track_signals13 (get_other_previous_track new_position k1))) 2))))
(check-sat)
(exit)
