...
(define-fun dynamic_invariant ((temp___expr_251 us_t1) (temp___is_init_248 Bool) (temp___skip_constant_249 Bool) (temp___do_toplevel_250 Bool)) Bool (and (=> (not (= temp___skip_constant_249 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_251) (last3 temp___expr_251))) (=> (= temp___do_toplevel_250 true) (=> (= temp___is_init_248 true) (and (let ((temp___253 (of_array2 (to_array1 temp___expr_251) (first3 temp___expr_251) (last3 temp___expr_251)))) (and (= (first5 temp___253) 1) (<= 0 (last5 temp___253)))) (<= (last3 temp___expr_251) 12))))))
(define-fun dynamic_predicate ((temp___255 us_t1)) Bool (and (let ((temp___257 (of_array2 (to_array1 temp___255) (first3 temp___255) (last3 temp___255)))) (and (= (first5 temp___257) 1) (<= 0 (last5 temp___257)))) (<= (last3 temp___255) 12)))
...
(define-fun dynamic_invariant1 ((temp___expr_337 Int) (temp___is_init_334 Bool) (temp___skip_constant_335 Bool) (temp___do_toplevel_336 Bool)) Bool (=> (or (= temp___is_init_334 true) (<= 0 5)) (in_range3 temp___expr_337)))
(declare-const x Int)
...
(declare-const temp___352 (Array Int character))
(declare-const temp___3521 t1)
(assert (in_range3 x))
...
(assert (= (elts (to_string (attr__ATTRIBUTE_IMAGE3 x))) temp___352))
(assert (= (mk1 (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 x))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 x)))))) temp___3521))
(assert (not (dynamic_predicate (mk___t1 temp___352 temp___3521))))
(check-sat)
(exit)
