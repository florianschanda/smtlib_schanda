...
(define-fun dynamic_invariant ((temp___expr_289 us_t1) (temp___is_init_285 Bool) (temp___skip_constant_286 Bool) (temp___do_toplevel_287 Bool) (temp___do_typ_inv_288 Bool)) Bool (and (=> (not (= temp___skip_constant_286 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_289) (last3 temp___expr_289))) (=> (= temp___do_toplevel_287 true) (=> (= temp___is_init_285 true) (and (let ((temp___291 (of_array2 (to_array1 temp___expr_289) (first3 temp___expr_289) (last3 temp___expr_289)))) (and (= (first5 temp___291) 1) (<= 0 (last5 temp___291)))) (<= (last3 temp___expr_289) 12))))))
(define-fun dynamic_predicate ((temp___293 us_t1)) Bool (and (let ((temp___295 (of_array2 (to_array1 temp___293) (first3 temp___293) (last3 temp___293)))) (and (= (first5 temp___295) 1) (<= 0 (last5 temp___295)))) (<= (last3 temp___293) 12)))
...
(define-fun dynamic_invariant1 ((temp___expr_382 Int) (temp___is_init_378 Bool) (temp___skip_constant_379 Bool) (temp___do_toplevel_380 Bool) (temp___do_typ_inv_381 Bool)) Bool (=> (or (= temp___is_init_378 true) (<= 0 5)) (in_range3 temp___expr_382)))
(declare-const x Int)
...
(assert (= (elts (to_string (attr__ATTRIBUTE_IMAGE3 x))) temp___398))
(assert (= (mk1 (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 x))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 x)))))) temp___3981))
(assert (not (dynamic_predicate (mk___t1 temp___398 temp___3981))))
(check-sat)
(exit)
