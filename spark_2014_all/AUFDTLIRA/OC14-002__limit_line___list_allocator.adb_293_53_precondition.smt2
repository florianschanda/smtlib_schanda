...
(assert (=> (not (= first_available1 0)) (and (= o67 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range6 o67))))
(assert (=> (not (= first_available1 0)) (= result12 (ite (< 0 o67) true false))))
(assert (=> (not (= first_available1 0)) (=> (= result12 true) (and (= o66 (get (rec__list_allocator__m__t__available model____split_fields3) 1)) (in_range7 o66)))))
...
(assert (=> (not (not (= first_available1 0))) (and (= o68 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range6 o68))))
(assert (=> (not (not (= first_available1 0))) (= result11 (ite (= o68 0) true false))))
(assert (=> (= result11 true) (=> (not (= first_allocated2 0)) (and (= o64 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range6 o64)))))
(assert (=> (= result11 true) (=> (not (= first_allocated2 0)) (= result13 (ite (< 0 o64) true false)))))
(assert (=> (= result11 true) (=> (not (= first_allocated2 0)) (=> (= result13 true) (and (= o63 (get (rec__list_allocator__m__t__allocated model____split_fields3) 1)) (in_range7 o63))))))
...
(assert (=> (= result11 true) (=> (not (not (= first_allocated2 0))) (and (= o65 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range6 o65)))))
...
(assert (= result15 (ite (in_range4 o62) true false)))
