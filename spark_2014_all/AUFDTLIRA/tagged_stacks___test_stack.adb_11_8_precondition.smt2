...
(define-fun s__split_fields24 () us_split_fields (mk___split_fields s__split_fields21 s__split_fields22 s__split_fields23))
(define-fun s__split_fields25 () us_split_fields (mk___split_fields s__split_fields18 s__split_fields19 s__split_fields20))
(define-fun s__split_fields26 () us_split_fields (mk___split_fields s__split_fields15 s__split_fields16 s__split_fields17))
(define-fun s__split_fields27 () us_split_fields (mk___split_fields s__split_fields12 s__split_fields13 s__split_fields14))
(define-fun s__split_fields28 () us_split_fields (mk___split_fields s__split_fields9 s__split_fields10 s__split_fields11))
(define-fun s__split_fields29 () us_split_fields (mk___split_fields s__split_fields6 s__split_fields7 s__split_fields8))
(define-fun s__split_fields30 () us_split_fields (mk___split_fields s__split_fields3 s__split_fields4 s__split_fields5))
(assert (=> (<= 0 2147483647) (in_range2 e)))
(assert (and (= (is_empty (mk___rep s__split_fields30 s__attr__tag)) true) (reset__specific_post s__attr__tag s__split_fields30 s__attr__tag (mk___split_fields s__split_fields s__split_fields1 s__split_fields2))))
(assert (= (mk_int__ref result) (mk_int__ref i)))
(assert (= i2 1))
(assert (and (= (let ((temp___265 (get_model1 s__attr__tag (mk___rep s__split_fields29 s__attr__tag)))) (bool_eq (elts temp___265) (to_rep (first (rt temp___265))) (to_rep (last (rt temp___265))) (let ((temp___264 (get_model1 s__attr__tag (mk___rep s__split_fields30 s__attr__tag)))) (ite (= (length temp___264) 0) (singleton1 (of_rep1 i2) 1) (concat_singleton_right (elts temp___264) (to_rep (first (rt temp___264))) (to_rep (last (rt temp___264))) (of_rep1 i2)))) (to_rep (first (let ((temp___264 (get_model1 s__attr__tag (mk___rep s__split_fields30 s__attr__tag)))) (ite (= (length temp___264) 0) (mk 1 1) (mk (to_rep (first (rt temp___264))) (- (+ (to_rep (first (rt temp___264))) (+ (ite (<= (to_rep (first (rt temp___264))) (to_rep (last (rt temp___264)))) (+ (- (to_rep (last (rt temp___264))) (to_rep (first (rt temp___264)))) 1) 0) 1)) 1)))))) (to_rep (last (let ((temp___264 (get_model1 s__attr__tag (mk___rep s__split_fields30 s__attr__tag)))) (ite (= (length temp___264) 0) (mk 1 1) (mk (to_rep (first (rt temp___264))) (- (+ (to_rep (first (rt temp___264))) (+ (ite (<= (to_rep (first (rt temp___264))) (to_rep (last (rt temp___264)))) (+ (- (to_rep (last (rt temp___264))) (to_rep (first (rt temp___264)))) 1) 0) 1)) 1)))))))) true) (push__specific_post s__attr__tag s__split_fields29 s__attr__tag i2 s__split_fields30)))
(assert (= i2 result1))
(assert (= i3 2))
(assert (and (= (let ((temp___265 (get_model1 s__attr__tag (mk___rep s__split_fields28 s__attr__tag)))) (bool_eq (elts temp___265) (to_rep (first (rt temp___265))) (to_rep (last (rt temp___265))) (let ((temp___264 (get_model1 s__attr__tag (mk___rep s__split_fields29 s__attr__tag)))) (ite (= (length temp___264) 0) (singleton1 (of_rep1 i3) 1) (concat_singleton_right (elts temp___264) (to_rep (first (rt temp___264))) (to_rep (last (rt temp___264))) (of_rep1 i3)))) (to_rep (first (let ((temp___264 (get_model1 s__attr__tag (mk___rep s__split_fields29 s__attr__tag)))) (ite (= (length temp___264) 0) (mk 1 1) (mk (to_rep (first (rt temp___264))) (- (+ (to_rep (first (rt temp___264))) (+ (ite (<= (to_rep (first (rt temp___264))) (to_rep (last (rt temp___264)))) (+ (- (to_rep (last (rt temp___264))) (to_rep (first (rt temp___264)))) 1) 0) 1)) 1)))))) (to_rep (last (let ((temp___264 (get_model1 s__attr__tag (mk___rep s__split_fields29 s__attr__tag)))) (ite (= (length temp___264) 0) (mk 1 1) (mk (to_rep (first (rt temp___264))) (- (+ (to_rep (first (rt temp___264))) (+ (ite (<= (to_rep (first (rt temp___264))) (to_rep (last (rt temp___264)))) (+ (- (to_rep (last (rt temp___264))) (to_rep (first (rt temp___264)))) 1) 0) 1)) 1)))))))) true) (push__specific_post s__attr__tag s__split_fields28 s__attr__tag i3 s__split_fields29)))
(assert (= i3 result2))
(assert (= i4 3))
(assert (and (= (let ((temp___265 (get_model1 s__attr__tag (mk___rep s__split_fields27 s__attr__tag)))) (bool_eq (elts temp___265) (to_rep (first (rt temp___265))) (to_rep (last (rt temp___265))) (let ((temp___264 (get_model1 s__attr__tag (mk___rep s__split_fields28 s__attr__tag)))) (ite (= (length temp___264) 0) (singleton1 (of_rep1 i4) 1) (concat_singleton_right (elts temp___264) (to_rep (first (rt temp___264))) (to_rep (last (rt temp___264))) (of_rep1 i4)))) (to_rep (first (let ((temp___264 (get_model1 s__attr__tag (mk___rep s__split_fields28 s__attr__tag)))) (ite (= (length temp___264) 0) (mk 1 1) (mk (to_rep (first (rt temp___264))) (- (+ (to_rep (first (rt temp___264))) (+ (ite (<= (to_rep (first (rt temp___264))) (to_rep (last (rt temp___264)))) (+ (- (to_rep (last (rt temp___264))) (to_rep (first (rt temp___264)))) 1) 0) 1)) 1)))))) (to_rep (last (let ((temp___264 (get_model1 s__attr__tag (mk___rep s__split_fields28 s__attr__tag)))) (ite (= (length temp___264) 0) (mk 1 1) (mk (to_rep (first (rt temp___264))) (- (+ (to_rep (first (rt temp___264))) (+ (ite (<= (to_rep (first (rt temp___264))) (to_rep (last (rt temp___264)))) (+ (- (to_rep (last (rt temp___264))) (to_rep (first (rt temp___264)))) 1) 0) 1)) 1)))))))) true) (push__specific_post s__attr__tag s__split_fields27 s__attr__tag i4 s__split_fields28)))
(assert (= i4 result3))
(assert (= i5 4))
(assert (and (= (let ((temp___265 (get_model1 s__attr__tag (mk___rep s__split_fields26 s__attr__tag)))) (bool_eq (elts temp___265) (to_rep (first (rt temp___265))) (to_rep (last (rt temp___265))) (let ((temp___264 (get_model1 s__attr__tag (mk___rep s__split_fields27 s__attr__tag)))) (ite (= (length temp___264) 0) (singleton1 (of_rep1 i5) 1) (concat_singleton_right (elts temp___264) (to_rep (first (rt temp___264))) (to_rep (last (rt temp___264))) (of_rep1 i5)))) (to_rep (first (let ((temp___264 (get_model1 s__attr__tag (mk___rep s__split_fields27 s__attr__tag)))) (ite (= (length temp___264) 0) (mk 1 1) (mk (to_rep (first (rt temp___264))) (- (+ (to_rep (first (rt temp___264))) (+ (ite (<= (to_rep (first (rt temp___264))) (to_rep (last (rt temp___264)))) (+ (- (to_rep (last (rt temp___264))) (to_rep (first (rt temp___264)))) 1) 0) 1)) 1)))))) (to_rep (last (let ((temp___264 (get_model1 s__attr__tag (mk___rep s__split_fields27 s__attr__tag)))) (ite (= (length temp___264) 0) (mk 1 1) (mk (to_rep (first (rt temp___264))) (- (+ (to_rep (first (rt temp___264))) (+ (ite (<= (to_rep (first (rt temp___264))) (to_rep (last (rt temp___264)))) (+ (- (to_rep (last (rt temp___264))) (to_rep (first (rt temp___264)))) 1) 0) 1)) 1)))))))) true) (push__specific_post s__attr__tag s__split_fields26 s__attr__tag i5 s__split_fields27)))
(assert (= i5 result4))
(assert (= i6 5))
(assert (and (= (let ((temp___265 (get_model1 s__attr__tag (mk___rep s__split_fields25 s__attr__tag)))) (bool_eq (elts temp___265) (to_rep (first (rt temp___265))) (to_rep (last (rt temp___265))) (let ((temp___264 (get_model1 s__attr__tag (mk___rep s__split_fields26 s__attr__tag)))) (ite (= (length temp___264) 0) (singleton1 (of_rep1 i6) 1) (concat_singleton_right (elts temp___264) (to_rep (first (rt temp___264))) (to_rep (last (rt temp___264))) (of_rep1 i6)))) (to_rep (first (let ((temp___264 (get_model1 s__attr__tag (mk___rep s__split_fields26 s__attr__tag)))) (ite (= (length temp___264) 0) (mk 1 1) (mk (to_rep (first (rt temp___264))) (- (+ (to_rep (first (rt temp___264))) (+ (ite (<= (to_rep (first (rt temp___264))) (to_rep (last (rt temp___264)))) (+ (- (to_rep (last (rt temp___264))) (to_rep (first (rt temp___264)))) 1) 0) 1)) 1)))))) (to_rep (last (let ((temp___264 (get_model1 s__attr__tag (mk___rep s__split_fields26 s__attr__tag)))) (ite (= (length temp___264) 0) (mk 1 1) (mk (to_rep (first (rt temp___264))) (- (+ (to_rep (first (rt temp___264))) (+ (ite (<= (to_rep (first (rt temp___264))) (to_rep (last (rt temp___264)))) (+ (- (to_rep (last (rt temp___264))) (to_rep (first (rt temp___264)))) 1) 0) 1)) 1)))))))) true) (push__specific_post s__attr__tag s__split_fields25 s__attr__tag i6 s__split_fields26)))
(assert (= (let ((temp___488 (get_model1 s__attr__tag (mk___rep s__split_fields25 s__attr__tag)))) (bool_eq (elts temp___488) (to_rep (first (rt temp___488))) (to_rep (last (rt temp___488))) (temp_____aggregate_def_478 1 2 3 4 5) 1 5)) true))
(assert (= (mk_int__ref result5) (mk_int__ref i1)))
(assert (= i7 5))
(assert (and (and (and (= e1 (peek1 s__attr__tag (mk___rep s__split_fields25 s__attr__tag))) (= (let ((temp___228 (get_model1 s__attr__tag (mk___rep s__split_fields24 s__attr__tag)))) (bool_eq (elts temp___228) (to_rep (first (rt temp___228))) (to_rep (last (rt temp___228))) (elts (get_model1 s__attr__tag (mk___rep s__split_fields25 s__attr__tag))) (to_rep (first4 (mk2 (to_rep (first (rt (get_model1 s__attr__tag (mk___rep s__split_fields25 s__attr__tag))))) (- (to_rep (last (rt (get_model1 s__attr__tag (mk___rep s__split_fields25 s__attr__tag))))) 1)))) (to_rep (last4 (mk2 (to_rep (first (rt (get_model1 s__attr__tag (mk___rep s__split_fields25 s__attr__tag))))) (- (to_rep (last (rt (get_model1 s__attr__tag (mk___rep s__split_fields25 s__attr__tag))))) 1)))))) true)) (in_range2 e1)) (pop__specific_post s__attr__tag s__split_fields24 s__attr__tag e1 s__split_fields25 e)))
(assert (= e1 i7))
(assert (= i7 result6))
(assert (= i8 4))
(assert (not (not (= (is_empty (mk___rep s__split_fields24 s__attr__tag)) true))))
(check-sat)
(exit)
