...
(define-fun dynamic_invariant1 ((temp___expr_166 Int) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool (=> (or (= temp___is_init_162 true) (<= 0 1001)) (in_range2 temp___expr_166)))
...
(declare-const temp___394 index)
(declare-const temp___3941 (Array Int value))
(declare-const temp___3942 (Array Int value))
...
(declare-const temp___397 index)
(declare-const temp___3971 (Array Int value))
(declare-const temp___3972 (Array Int value))
...
(assert (= temp___394 o2))
(assert (= temp___3941 o3))
(assert (= temp___3942 o4))
(assert (= result1 a__split_fields))
(assert (= result2 a__split_fields1))
(assert (= result3 a__split_fields2))
(assert (= temp___394 a__split_fields3))
(assert (= temp___3941 a__split_fields4))
(assert (= temp___3942 a__split_fields5))
(assert (= (to_rep o5) tmp1))
(assert (= o6 (store b__split_fields2 5 o5)))
(assert (= b__split_fields o7))
(assert (= b__split_fields1 o8))
(assert (= o6 o9))
(assert (= temp___397 o7))
(assert (= temp___3971 o8))
(assert (= temp___3972 o9))
(assert (= result4 b__split_fields))
(assert (= result5 b__split_fields1))
(assert (= result6 b__split_fields2))
(assert (= temp___397 b__split_fields3))
(assert (= temp___3971 b__split_fields4))
(assert (= temp___3972 b__split_fields5))
...
(assert (= tmp3 tmp1))
(assert (= b__split_fields9 (mk___split_fields b__split_fields3 b__split_fields4 b__split_fields5)))
(assert (= a__split_fields9 (mk___split_fields a__split_fields3 a__split_fields4 a__split_fields5)))
(assert (not (not (= (bool_eq1 (mk___rep (mk___split_fields b__split_fields6 b__split_fields7 b__split_fields8)) (mk___rep (mk___split_fields b__split_fields b__split_fields1 b__split_fields2))) true))))
(check-sat)
(exit)
