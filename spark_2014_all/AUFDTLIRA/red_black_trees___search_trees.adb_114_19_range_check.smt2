...
(assert (and (= o2 (length (rec__tree_model__path_type__a (us_split_fields5 (select m ki2))))) (and (in_range1 o2) (<= (+ 0 o2) 2147483647))))
(assert (and (= o3 (length (rec__tree_model__path_type__a (us_split_fields5 (select m kj2))))) (and (in_range1 o3) (<= (+ 0 o3) 2147483647))))
(assert (= result5 (ite (< o2 o3) true false)))
(assert (not (= result5 true)))
(assert (and (= o4 (parent f ki2)) (and (in_range4 o4) (and (=> (= (valid_root f ki2) true) (= o4 0)) (=> (= (size f) 0) (= o4 0))))))
