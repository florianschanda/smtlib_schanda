...
(assert (and (= o8 (length (rec__tree_model__path_type__a (us_split_fields1 (select m ki2))))) (and (in_range3 o8) (<= (+ 0 o8) 2147483647))))
(assert (and (= o9 (length (rec__tree_model__path_type__a (us_split_fields1 (select m kj2))))) (and (in_range3 o9) (<= (+ 0 o9) 2147483647))))
(assert (= result8 (ite (< o8 o9) true false)))
(assert (not (= result8 true)))
(assert (and (= o12 (parent f ki2)) (and (in_range6 o12) (and (=> (= (valid_root f ki2) true) (= o12 0)) (=> (= (size f) 0) (= o12 0))))))
