...
(assert (= i1 r1b))
(assert (=> (and (<= r1b i1) (<= i1 r2b)) (= temp___208 item)))
(assert (=> (and (<= r1b i1) (<= i1 r2b)) (= temp___207 total1)))
...
(assert (=> (and (<= r1b i1) (<= i1 r2b)) (= temp___206 a2)))
(assert (=> (and (<= r1b i1) (<= i1 r2b)) (and (<= 1 i2) (<= i2 10))))
(assert (=> (and (<= r1b i1) (<= i1 r2b)) (= o i2)))
(assert (=> (and (<= r1b i1) (<= i1 r2b)) (= o1 (select temp___206 o))))
