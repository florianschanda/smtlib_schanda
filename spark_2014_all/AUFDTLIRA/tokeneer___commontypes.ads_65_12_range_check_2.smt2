...
(declare-const temp___377 (Array Int character))
(declare-const temp___3771 t)
(assert (dynamic_invariant i23s true false false true))
(assert (dynamic_property 1 2147483647 (to_rep1 (first4 (rt2 i23s))) (to_rep1 (last4 (rt2 i23s)))))
(assert (= (elts2 i23s) temp___377))
(assert (= (mk (to_rep1 (first4 (rt2 i23s))) (to_rep1 (last4 (rt2 i23s)))) temp___3771))
(assert (not (dynamic_property1 1 2147483647 (to_rep1 (first temp___3771)) (to_rep1 (last temp___3771)))))
(check-sat)
(exit)
