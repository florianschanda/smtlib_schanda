...
(assert (not (= (invariant__ (mk___rep4 (mk___split_fields4 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)) t__split_fields4))) true)))
(check-sat)
(exit)
