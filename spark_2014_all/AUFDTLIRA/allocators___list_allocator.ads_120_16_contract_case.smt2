...
(assert (not (= (oeq1 (mk___rep1 (us_split_fields__content1 model____split_fields6)) (mk___rep1 (mk___split_fields1 model____split_fields model____split_fields1))) true)))
(check-sat)
(exit)
