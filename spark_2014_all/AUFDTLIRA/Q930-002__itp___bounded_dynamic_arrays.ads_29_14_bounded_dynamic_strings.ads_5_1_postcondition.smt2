...
(assert (and (and (and (= us 0) (in_range4 0)) (and (default_initial_assumption (mk___rep1 result____split_discrs (mk___split_fields1 result____split_fields result____split_fields1)) false) (and (dynamic_invariant3 (mk___rep1 result____split_discrs (mk___split_fields1 result____split_fields result____split_fields1)) false false true) (and (and (and (and (and (= (to_rep2 o) 0) (and (= o o1) (= result____split_fields1 o2))) (and (= result____split_discrs (mk___split_discrs temp___865)) (and (= temp___8651 o1) (= temp___8652 o2)))) (and (dynamic_predicate1 (mk___rep1 (mk___split_discrs temp___865) (mk___split_fields1 temp___8651 temp___8652))) (= (mk___rep1 (mk___split_discrs temp___866) (mk___split_fields1 temp___8661 temp___8662)) (mk___rep1 (mk___split_discrs temp___865) (mk___split_fields1 temp___8651 temp___8652))))) (and (and (= result (mk___split_fields__ref1 (mk___split_fields1 result____split_fields result____split_fields1))) (= result____split_fields2 (mk___split_fields1 temp___8661 temp___8662))) (= result____split_discrs (mk___split_discrs temp___866)))) (and (and (and (and (and (forall ((temp___869 Int)) (ite (and (<= 1 temp___869) (<= temp___869 0)) (= (select o3 temp___869) (select null_list temp___869)) (= (select o3 temp___869) (select (rec__bounded_dynamic_strings__sequence__content1 result____split_fields2) temp___869)))) (= o4 (mk___split_fields1 (rec__bounded_dynamic_strings__sequence__current_length1 result____split_fields2) o3))) (= temp___871 (mk___rep1 result____split_discrs o4))) (and (dynamic_predicate1 temp___871) (= temp___872 temp___871))) (and (and (= result1 (mk___split_fields__ref1 result____split_fields2)) (= result____split_fields3 (us_split_fields3 temp___872))) (= result____split_discrs (us_split_discrs2 temp___872)))) (and (and (= bounded_dynamic_strings__null_sequence__result5 (mk_sequence__ref bounded_dynamic_strings__null_sequence__result4)) (= bounded_dynamic_strings__null_sequence__result6 bounded_dynamic_strings__null_sequence__result4)) (and (= result2 (mk_sequence__ref (mk___rep (mk___split_discrs bounded_dynamic_strings__null_sequence__result) (mk___split_fields bounded_dynamic_strings__null_sequence__result1 (mk___t2 bounded_dynamic_strings__null_sequence__result2 bounded_dynamic_strings__null_sequence__result3))))) (= bounded_dynamic_strings__null_sequence__result4 (mk___rep result____split_discrs (mk___split_fields (rec__bounded_dynamic_strings__sequence__current_length1 result____split_fields3) (mk___t2 (rec__bounded_dynamic_strings__sequence__content1 result____split_fields3) (mk2 1 0)))))))))))) (and (and (= bounded_dynamic_strings__null_sequence__result7 bounded_dynamic_strings__null_sequence__result5) (= result____split_fields4 (mk___split_fields__ref1 result____split_fields3))) (and (= bounded_dynamic_strings__null_sequence__result8 bounded_dynamic_strings__null_sequence__result6) (= result____split_fields5 result____split_fields3)))))
(assert (= (mk___rep (mk___split_discrs result3) (mk___split_fields result4 (mk___t2 result5 result6))) (sequence__content bounded_dynamic_strings__null_sequence__result7)))
(assert (not (= (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 (sequence__content bounded_dynamic_strings__null_sequence__result7)))) 0)))
(check-sat)
(exit)
