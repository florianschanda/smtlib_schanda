...
(assert true)
(assert (forall ((list_allocator__data (Array Int us_rep))) (! (= (= (all_available list_allocator__data) true) (forall ((r Int)) (=> (and (<= 1 r) (<= r 10000)) (= (to_rep1 (rec__list_allocator__cell__stat (us_split_fields1 (select list_allocator__data r)))) 0)))) :pattern ((all_available list_allocator__data)))))
...
(define-fun bool_eq4 ((a us_rep3) (b us_rep3)) Bool (ite (and (= (user_eq3 (rec__list_allocator__m__t__available (us_split_fields3 a)) (rec__list_allocator__m__t__available (us_split_fields3 b))) true) (= (bool_eq3 (rec__list_allocator__m__t__allocated (us_split_fields3 a)) (rec__list_allocator__m__t__allocated (us_split_fields3 b))) true)) true false))
...
(define-fun dynamic_invariant ((temp___expr_173 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool) (temp___do_typ_inv_172 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= 0 10000)) (in_range1 temp___expr_173)))
...
(declare-fun user_eq8 (tresourceB tresourceB) Bool)
(declare-const dummy8 tresourceB)
...
(define-fun dynamic_invariant1 ((temp___expr_263 Int) (temp___is_init_259 Bool) (temp___skip_constant_260 Bool) (temp___do_toplevel_261 Bool) (temp___do_typ_inv_262 Bool)) Bool (=> (or (= temp___is_init_259 true) (<= 0 1)) (in_range2 temp___expr_263)))
(assert (forall ((temp___294 us_rep)) (forall ((temp___295 Int)) (= (select (list_allocator__data__aggregate_def temp___294) temp___295) temp___294))))
(define-fun dynamic_invariant2 ((temp___expr_180 Int) (temp___is_init_176 Bool) (temp___skip_constant_177 Bool) (temp___do_toplevel_178 Bool) (temp___do_typ_inv_179 Bool)) Bool (=> (or (= temp___is_init_176 true) (<= 1 10000)) (in_range3 temp___expr_180)))
(assert (= no_resource 0))
(define-fun last ((container us_rep1)) Int (+ 0 (length container)))
(declare-fun last__function_guard (Int us_rep1) Bool)
(define-fun oeq1 ((left us_rep1) (right us_rep1)) Bool (and (= (length left) (length right)) (ite (forall ((n Int)) (=> (and (<= 1 n) (<= n (last left))) (= (get left n) (get right n)))) true false)))
...
(define-fun default_initial_assumption1 ((temp___expr_215 us_rep1) (temp___skip_top_level_216 Bool)) Bool (=> (not (= temp___skip_top_level_216 true)) (= (length temp___expr_215) 0)))
(assert true)
...
(assert true)
(assert (forall ((x us_rep3) (y us_rep3)) (! (= (= (oeq x y) true) (and (= (oeq1 (rec__list_allocator__m__t__available (us_split_fields3 x)) (rec__list_allocator__m__t__available (us_split_fields3 y))) true) (= (oeq2 (rec__list_allocator__m__t__allocated (us_split_fields3 x)) (rec__list_allocator__m__t__allocated (us_split_fields3 y))) true))) :pattern ((oeq x y)))))
...
(define-fun dynamic_invariant4 ((temp___expr_207 Int) (temp___is_init_203 Bool) (temp___skip_constant_204 Bool) (temp___do_toplevel_205 Bool) (temp___do_typ_inv_206 Bool)) Bool (=> (or (= temp___is_init_203 true) (<= 0 2147483647)) (in_range7 temp___expr_207)))
(assert (forall ((container us_rep1)) (! (let ((result (length container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant3 result true false true true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant5 ((temp___expr_200 Int) (temp___is_init_196 Bool) (temp___skip_constant_197 Bool) (temp___do_toplevel_198 Bool) (temp___do_typ_inv_199 Bool)) Bool (=> (or (= temp___is_init_196 true) (<= 0 10000)) (in_range8 temp___expr_200)))
...
(define-fun dynamic_invariant6 ((temp___expr_222 Int) (temp___is_init_218 Bool) (temp___skip_constant_219 Bool) (temp___do_toplevel_220 Bool) (temp___do_typ_inv_221 Bool)) Bool (=> (or (= temp___is_init_218 true) (<= 0 10000)) (in_range4 temp___expr_222)))
(assert (forall ((container us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant6 item true true true true) (=> (= (distinct 1 0) true) (=> (exists ((e Int)) (and (and (in_range4 e) (= (contains1 container e) true)) (= e item))) (= (contains1 container item) true)))) :pattern ((contains1 container item))))))
...
(assert (forall ((left us_rep2) (right us_rep2)) (! (= (= (ole left right) true) (forall ((item Int)) (=> (and (in_range4 item) (= (contains1 left item) true)) (= (contains1 right item) true)))) :pattern ((ole left right)))))
...
(assert (forall ((container us_rep2)) (! (let ((result (is_empty container))) (and (= (= result true) (forall ((item Int)) (not (and (in_range4 item) (= (contains1 container item) true))))) (= (= result true) (= (length1 container) 0)))) :pattern ((is_empty container)))))
...
(assert (= o3 o1))
(assert (= o4 o2))
(assert (= o5 (list_allocator__data__aggregate_def (mk___rep (mk___split_fields o3 o4)))))
(assert (= (mk_map__ref result) (mk_map__ref data)))
(assert (= data1 o5))
(assert (= (mk_int__ref result1) (mk_int__ref first_available)))
(assert (= first_available1 1))
(assert (in_range1 first_available1))
(assert (and (and (and (and (and (= (is_empty model____split_fields1) true) (= (length1 model____split_fields1) 0)) (= (length model____split_fields) 10000)) (= (get model____split_fields 1) 1)) (forall ((rr Int)) (=> (and (<= 1 rr) (<= rr 10000)) (= (get model____split_fields rr) rr)))) (forall ((rr Int)) (=> (and (<= 1 rr) (<= rr 10000)) (= (contains model____split_fields rr) true)))))
(assert (= (mk_int__ref result2) (mk_int__ref r)))
(assert (= r1 1))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (= temp___292 r1)))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (= temp___290 data1)))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (=> (< r1 10000) (and (= o6 (+ r1 1)) (in_range1 (+ r1 1))))))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (=> (< r1 10000) (= (to_rep o7) o6))))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (=> (< r1 10000) (= (rec__list_allocator__cell__stat (us_split_fields1 (select data1 r1))) o8))))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (=> (< r1 10000) (= o7 o9))))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (=> (< r1 10000) (= o10 o8))))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (=> (< r1 10000) (= o11 o9))))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (=> (< r1 10000) (= o12 (store data1 r1 (mk___rep (mk___split_fields o10 o11)))))))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (=> (< r1 10000) (= data1 result3))))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (=> (< r1 10000) (= data2 o12))))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (=> (not (< r1 10000)) (= data2 data1))))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (forall ((rr Int)) (=> (and (<= 1 rr) (<= rr r2)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data3 rr)))) (ite (= rr 10000) 0 (+ rr 1)))))))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data3 10000)))) 0)))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (forall ((rr Int)) (=> (and (<= 1 rr) (<= rr 10000)) (= (to_rep1 (rec__list_allocator__cell__stat (us_split_fields1 (select data3 rr)))) 0)))))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (and (and (forall ((temp___291 Int)) (=> (and (<= 1 temp___291) (<= temp___291 10000)) (ite (or (< 10000 temp___291) (or (< temp___291 1) (< r2 temp___291))) (= (select data3 temp___291) (select temp___290 temp___291)) (= (rec__list_allocator__cell__stat (us_split_fields1 (select data3 temp___291))) (rec__list_allocator__cell__stat (us_split_fields1 (select temp___290 temp___291))))))) (=> (<= 1 10000) (in_range3 r2))) (and (<= 1 r2) (<= r2 10000)))))
...
(assert (and (= o13 (is_valid (map__content data6) first_available1 (mk___split_fields1 model____split_fields model____split_fields1))) (= (= o13 true) (and (and (and (and (and (and (<= (length model____split_fields) 10000) (<= (length1 model____split_fields1) 10000)) (= (+ (length model____split_fields) (length1 model____split_fields1)) 10000)) (ite (not (= first_available1 0)) (and (< 0 (length model____split_fields)) (= (get model____split_fields 1) first_available1)) (= (length model____split_fields) 0))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length model____split_fields))) (and (and (in_range3 (get model____split_fields j)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select (map__content data6) (get model____split_fields j))))) (ite (< j (length model____split_fields)) (get model____split_fields (+ j 1)) 0))) (forall ((k Int)) (=> (and (<= 1 k) (<= k (- j 1))) (not (= (get model____split_fields j) (get model____split_fields k))))))))) (forall ((e Int)) (=> (and (in_range4 e) (= (contains1 model____split_fields1 e) true)) (in_range3 e)))) (forall ((r7 Int)) (=> (and (<= 1 r7) (<= r7 10000)) (ite (= (to_rep1 (rec__list_allocator__cell__stat (us_split_fields1 (select (map__content data6) r7)))) 0) (and (= (contains model____split_fields r7) true) (not (= (contains1 model____split_fields1 r7) true))) (and (not (= (contains model____split_fields r7) true)) (= (contains1 model____split_fields1 r7) true)))))))))
(assert (and (= o14 (all_available (map__content data6))) (= (= o14 true) (forall ((r7 Int)) (=> (and (<= 1 r7) (<= r7 10000)) (= (to_rep1 (rec__list_allocator__cell__stat (us_split_fields1 (select (map__content data6) r7)))) 0))))))
(assert (= result4 (ite (= o14 true) o13 false)))
(assert (not (= (all_available (map__content data6)) true)))
(check-sat)
(exit)
