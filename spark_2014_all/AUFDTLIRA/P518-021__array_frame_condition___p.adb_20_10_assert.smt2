...
(assert (= (bool_eq2 x28 (to_rep (first (mk (+ i31 1) 3))) (to_rep (last (mk (+ i31 1) 3))) y (to_rep (first2 (mk1 (+ i31 1) 3))) (to_rep (last2 (mk1 (+ i31 1) 3)))) true))
...
(assert (not (= (bool_eq2 x55 (to_rep (first (mk (+ i32 1) 3))) (to_rep (last (mk (+ i32 1) 3))) y (to_rep (first2 (mk1 (+ i32 1) 3))) (to_rep (last2 (mk1 (+ i32 1) 3)))) true)))
(check-sat)
(exit)
