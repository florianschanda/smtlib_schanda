...
(assert (= result2 true))
(assert (and (= o7 (valid_root f_old v)) (=> (< (size f_old) v) (not (= o7 true)))))
...
(assert (= o5 (select temp___1553 v)))
(assert (= o6 (us_split_fields1 o5)))
(assert (= result4 (rec__tree_model__path_type__k o6)))
(assert (= result4 true))
...
(assert (= o2 (select temp___1546 i)))
