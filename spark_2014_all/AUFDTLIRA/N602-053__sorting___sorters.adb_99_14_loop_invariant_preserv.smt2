...
(declare-const temp___1992 (Array Int integer))
(declare-const temp___1993 t1)
...
(assert (=> (not (= smallest1 current1)) (and (= (to_rep (select values2 o4)) (to_rep (select values smallest1))) (and (= (to_rep (select values2 smallest1)) (to_rep (select values o4))) (forall ((j Int)) (=> (and (<= (to_rep values__first) j) (<= j (to_rep values__last))) (=> (and (not (= j o4)) (not (= j smallest1))) (= (to_rep (select values2 j)) (to_rep (select values j))))))))))
...
(assert (not (= current2 temp___206)))
...
(assert (= o5 values3))
(assert (= o5 temp___1992))
(assert (= (mk1 current3 (to_rep values__last)) temp___1993))
(assert (= temp___1992 o6))
(assert (= (mk (to_rep (first2 temp___1993)) (to_rep (last2 temp___1993))) o7))
...
(assert (=> (not (= smallest3 current3)) (and (= (to_rep (select values4 o9)) (to_rep (select values3 smallest3))) (and (= (to_rep (select values4 smallest3)) (to_rep (select values3 o9))) (forall ((j Int)) (=> (and (<= (to_rep values__first) j) (<= j (to_rep values__last))) (=> (and (not (= j o9)) (not (= j smallest3))) (= (to_rep (select values4 j)) (to_rep (select values3 j))))))))))
(assert (=> (not (not (= smallest3 current3))) (= values4 values3)))
(declare-const j Int)
(assert (<= (to_rep values__first) j))
(assert (<= j (- current3 1)))
(assert (not (<= (to_rep (select values4 j)) (to_rep (select values4 (+ j 1))))))
(check-sat)
(exit)
