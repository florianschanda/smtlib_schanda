...
(assert (= o13 values3))
(assert (= o13 temp___1732))
(assert (= (mk1 current3 (to_rep values__last)) temp___1733))
(assert (= temp___1732 o14))
(assert (= (mk (to_rep (first2 temp___1733)) (to_rep (last2 temp___1733))) o15))
(assert (and (= o16 (index_of_minimum (mk___t o14 o15))) (and (in_range2 o16) (and (and (<= (to_rep (first o15)) o16) (<= o16 (to_rep (last o15)))) (forall ((j2 Int)) (=> (and (<= (to_rep (first o15)) j2) (<= j2 (to_rep (last o15)))) (<= (to_rep (select o14 o16)) (to_rep (select o14 j2)))))))))
(assert (= smallest2 result4))
(assert (= smallest3 o16))
(assert (=> (not (= smallest3 current3)) (and (= o17 current3) (in_range2 current3))))
(assert (=> (not (= smallest3 current3)) (and (= (to_rep (select values4 o17)) (to_rep (select values3 smallest3))) (and (= (to_rep (select values4 smallest3)) (to_rep (select values3 o17))) (forall ((j2 Int)) (=> (and (<= (to_rep values__first) j2) (<= j2 (to_rep values__last))) (=> (and (not (= j2 o17)) (not (= j2 smallest3))) (= (to_rep (select values4 j2)) (to_rep (select values3 j2))))))))))
(assert (=> (= smallest3 current3) (= values4 values3)))
(declare-const j2 Int)
(assert (<= (to_rep values__first) j2))
(assert (<= j2 (- current3 1)))
(assert (not (<= (to_rep (select values4 j2)) (to_rep (select values4 (+ j2 1))))))
(check-sat)
(exit)
