...
(assert (=> (= result13 true) (and (= o58 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range6 o58))))
(assert (=> (= result13 true) (= result14 (ite (< j o58) true false))))
(assert (=> (= result13 true) (=> (= result14 true) (and (= o59 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result13 true) (=> (= result14 true) (and (= o60 (get (rec__list_allocator__m__t__allocated model____split_fields3) o59)) (in_range7 o60)))))
...
(assert (=> (= result13 true) (= o54 temp___433)))
...
(assert (=> (= result12 true) (=> (< 1 j) (and (= o52 (get (rec__list_allocator__m__t__allocated model____split_fields3) o51)) (in_range7 o52)))))
...
(assert (=> (= result12 true) (= o47 temp___434)))
