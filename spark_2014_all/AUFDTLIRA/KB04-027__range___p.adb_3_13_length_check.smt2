...
(assert (in_range1 x))
(assert (in_range1 y))
(assert (= (to_rep (first2 (rt1 (p__z__aggregate_def (of_int 1) x y)))) x))
(assert (= (to_rep (last2 (rt1 (p__z__aggregate_def (of_int 1) x y)))) y))
(assert (= (mk___t1 temp___148 temp___1481) (p__z__aggregate_def (of_int 1) x y)))
(assert (not (= (ite (<= (to_rep (first2 temp___1481)) (to_rep (last2 temp___1481))) (+ (- (to_rep (last2 temp___1481)) (to_rep (first2 temp___1481))) 1) 0) (ite (<= x y) (+ (- y x) 1) 0))))
(check-sat)
(exit)
