...
(define-fun dynamic_invariant1 ((temp___expr_159 us_t) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool) (temp___do_typ_inv_158 Bool)) Bool (=> (not (= temp___skip_constant_156 true)) (and (dynamic_property1 x y (first1 temp___expr_159) (last1 temp___expr_159)) (and (= (first1 temp___expr_159) x) (= (last1 temp___expr_159) y)))))
(declare-sort t2 0)
...
(assert (forall ((temp___166 Bool)) (forall ((temp___167 Int) (temp___168 Int)) (let ((temp___165 (p__z__aggregate_def temp___166 temp___167 temp___168))) (and (=> (dynamic_property4 x y temp___167 temp___168) (and (= (first3 temp___165) temp___167) (= (last3 temp___165) temp___168))) (forall ((temp___169 Int)) (= (select (to_array1 temp___165) temp___169) temp___166)))))))
(declare-const temp___171 (Array Int Bool))
(declare-const temp___1711 t1)
(assert (in_range1 x))
(assert (in_range1 y))
(assert (= (to_rep (first2 (rt1 (p__z__aggregate_def (distinct 1 0) x y)))) x))
(assert (= (to_rep (last2 (rt1 (p__z__aggregate_def (distinct 1 0) x y)))) y))
(assert (= (mk___t1 temp___171 temp___1711) (p__z__aggregate_def (distinct 1 0) x y)))
(assert (not (= (ite (<= (to_rep (first2 temp___1711)) (to_rep (last2 temp___1711))) (+ (- (to_rep (last2 temp___1711)) (to_rep (first2 temp___1711))) 1) 0) (ite (<= x y) (+ (- y x) 1) 0))))
(check-sat)
(exit)
