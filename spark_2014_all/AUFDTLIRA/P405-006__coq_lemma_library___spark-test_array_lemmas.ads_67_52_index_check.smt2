...
(assert (forall ((i1 Int)) (=> (and (<= (+ (to_rep (first (rt arr))) 1) i1) (<= i1 (to_rep (last (rt arr))))) (< (to_rep (select (elts arr) (- i1 1))) (to_rep (select (elts arr) i1))))))
(assert (dynamic_property1 (- 2147483648) 2147483647 (to_rep (first (rt arr))) (to_rep (last (rt arr)))))
(assert (= (elts arr) o))
(assert (= (mk1 (to_rep (first (rt arr))) (to_rep (last (rt arr)))) o1))
(assert (forall ((i1 Int)) (=> (and (<= (to_rep (first2 o1)) i1) (<= i1 (to_rep (last2 o1)))) (forall ((j1 Int)) (=> (and (<= (to_rep (first2 o1)) j1) (<= j1 (to_rep (last2 o1)))) (=> (< i1 j1) (< (to_rep (select o i1)) (to_rep (select o j1)))))))))
