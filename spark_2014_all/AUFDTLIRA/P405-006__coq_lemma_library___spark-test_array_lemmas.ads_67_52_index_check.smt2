...
(assert (and (and (dynamic_property1 (- 2147483648) 2147483647 (to_rep (first (rt arr))) (to_rep (last (rt arr)))) (and (= (elts arr) o3) (= (mk1 (to_rep (first (rt arr))) (to_rep (last (rt arr)))) o4))) (forall ((i2 Int)) (=> (and (<= (to_rep (first2 o4)) i2) (<= i2 (to_rep (last2 o4)))) (forall ((j1 Int)) (=> (and (<= (to_rep (first2 o4)) j1) (<= j1 (to_rep (last2 o4)))) (=> (< i2 j1) (< (to_rep (select o3 i2)) (to_rep (select o3 j1))))))))))
