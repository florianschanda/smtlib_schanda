...
(assert (and (= o47 (to_rep1 (rec__search_trees__search_tree__root t__split_fields7))) (in_range3 (to_rep1 (rec__search_trees__search_tree__root t__split_fields7)))))
(assert (not (= (valid_root (mk___rep2 (us_split_fields5 (rec__search_trees__search_tree__struct t__split_fields7))) o47) true)))
(check-sat)
(exit)
