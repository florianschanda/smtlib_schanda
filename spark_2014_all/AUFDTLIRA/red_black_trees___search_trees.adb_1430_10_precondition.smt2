...
(assert (and (= o10 (int__content previous6)) (in_range3 (int__content previous6))))
(assert (and (= o9 (to_rep1 (rec__search_trees__search_tree__root t__split_fields5))) (in_range3 (to_rep1 (rec__search_trees__search_tree__root t__split_fields5)))))
(assert (not (= (valid_root (mk___rep2 (us_split_fields5 (rec__search_trees__search_tree__struct t__split_fields5))) o9) true)))
(check-sat)
(exit)
