...
(assert (=> (not (= (int__content i15) 0)) (and (= o32 (size1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))) (and (in_range4 o32) (= o32 (size (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14))))))))
...
(assert (=> (= result20 true) (and (= o31 (root (mk___rep3 (us_split_fields__content3 t__split_fields14)))) (and (in_range3 o31) (= o31 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields__content3 t__split_fields14))))))))
...
(assert (=> (= result19 true) (and (= o30 (values1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))) (ite (= (size (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14))) 0) (= (is_empty o30) true) (and (forall ((i17 Int)) (=> (and (<= 1 i17) (<= i17 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields__content3 t__split_fields14)))) i17))) true) (= (contains o30 (to_rep (select (rec__search_trees__search_tree__values (us_split_fields__content3 t__split_fields14)) i17))) true)))) (forall ((v1 Int)) (=> (and (<= 0 v1) (<= v1 2147483647)) (=> (= (contains o30 v1) true) (exists ((i17 Int)) (and (and (<= 1 i17) (<= i17 100)) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields__content3 t__split_fields14)))) i17))) true) (= (to_rep (select (rec__search_trees__search_tree__values (us_split_fields__content3 t__split_fields14)) i17)) v1))))))))))))
...
(assert (=> (= result19 true) (and (= o29 (values1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)))) (ite (= (size (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2))) 0) (= (is_empty o29) true) (and (forall ((i17 Int)) (=> (and (<= 1 i17) (<= i17 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) (to_rep1 t__split_fields)) i17))) true) (= (contains o29 (to_rep (select t__split_fields3 i17))) true)))) (forall ((v1 Int)) (=> (and (<= 0 v1) (<= v1 2147483647)) (=> (= (contains o29 v1) true) (exists ((i17 Int)) (and (and (<= 1 i17) (<= i17 100)) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) (to_rep1 t__split_fields)) i17))) true) (= (to_rep (select t__split_fields3 i17)) v1))))))))))))
