...
(define-fun default_initial_assumption ((temp___expr_276 us_rep) (temp___skip_top_level_277 Bool)) Bool (and (and (= (attr__tag temp___expr_276) us_tag) (= (to_rep2 (rec__stackp__stack_root__length (us_split_fields1 temp___expr_276))) 0)) (=> (not (= temp___skip_top_level_277 true)) (= (size temp___expr_276) 0))))
...
(declare-const stackp__stack_root__content__first__bit2 Int)
(declare-const stackp__stack_root__content__last__bit2 Int)
(declare-const stackp__stack_root__content__position2 Int)
(assert (<= 0 stackp__stack_root__content__first__bit2))
(assert (< stackp__stack_root__content__first__bit2 stackp__stack_root__content__last__bit2))
(assert (<= 0 stackp__stack_root__content__position2))
(declare-const stackp__stack_root__length__first__bit2 Int)
(declare-const stackp__stack_root__length__last__bit2 Int)
(declare-const stackp__stack_root__length__position2 Int)
(assert (<= 0 stackp__stack_root__length__first__bit2))
(assert (< stackp__stack_root__length__first__bit2 stackp__stack_root__length__last__bit2))
(assert (<= 0 stackp__stack_root__length__position2))
...
(assert (forall ((s us_rep)) (! (let ((result (get_model__2 s))) (and (= (length result) (size s)) (dynamic_invariant1 result true false true))) :pattern ((get_model__2 s)))))
(assert (forall ((attr__tag2 Int)) (forall ((s us_rep)) (! (let ((result (get_model__21 attr__tag2 s))) (and (= (length result) (size s)) (dynamic_invariant1 result true false true))) :pattern ((get_model__21 attr__tag2 s))))))
(assert (forall ((s us_rep)) (! (= (get_model__2 s) (get_model__21 us_tag s)) :pattern ((get_model__21 us_tag s)))))
(assert (forall ((s us_rep)) (! (= (get_model__3 (of_base s)) (get_model__21 us_tag2 s)) :pattern ((get_model__21 us_tag2 s)))))
(assert (forall ((s us_rep)) (! (= (get_model__2 s) (let ((temp___298 (let ((temp___296 (to_rep2 (rec__stackp__stack_root__length (us_split_fields1 s))))) (let ((temp___295 1)) (let ((temp___297 (rec__stackp__stack_root__content (us_split_fields1 s)))) (of_array1 temp___297 temp___295 temp___296)))))) (of_array (to_array1 temp___298) (first3 temp___298) (last3 temp___298)))) :pattern ((get_model__2 s)))))
...
(declare-fun user_eq12 (t44s t44s) Bool)
(declare-const dummy12 t44s)
(declare-datatypes () ((t44s__ref (mk_t44s__ref (t44s__content t44s)))))
(define-fun t44s__ref___projection ((a t44s__ref)) t44s (t44s__content a))
(declare-sort t21s 0)
(define-fun in_range6 ((x Int)) Bool (and (<= 1 x) (<= x 1)))
(declare-fun attr__ATTRIBUTE_IMAGE7 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check7 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE7 (us_image) Int)
(declare-fun user_eq13 (t21s t21s) Bool)
(declare-const dummy13 t21s)
(declare-datatypes () ((t21s__ref (mk_t21s__ref (t21s__content t21s)))))
(define-fun t21s__ref___projection ((a t21s__ref)) t21s (t21s__content a))
(declare-fun temp___255 (Int) (Array Int element))
(assert (forall ((temp___257 Int)) (= (select (temp___255 temp___257) 1) (of_rep temp___257))))
(declare-fun temp___522 (Int) (Array Int element))
(assert (forall ((temp___524 Int)) (= (select (temp___522 temp___524) 1) (of_rep temp___524))))
...
(define-fun default_initial_assumption1 ((temp___expr_159 us_rep) (temp___skip_top_level_160 Bool)) Bool (and (and (= (attr__tag temp___expr_159) us_tag1) (= (to_rep2 (rec__stackp__stack_root__length (us_split_fields1 temp___expr_159))) 0)) (=> (not (= temp___skip_top_level_160 true)) (= (size temp___expr_159) 0))))
...
(define-fun dynamic_property3 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range2 low) (and (in_range2 high) (=> (<= low high) (and (in_range7 low) (in_range7 high))))))
...
(define-fun default_initial_assumption2 ((temp___expr_361 us_rep1) (temp___skip_top_level_362 Bool)) Bool (and (and (= (attr__tag1 temp___expr_361) us_tag2) (and (= (to_rep3 (rec__stackp__buffer__first (us_split_fields3 temp___expr_361))) 1) (= (to_rep2 (rec__stackp__stack_root__length1 (us_split_fields3 temp___expr_361))) 0))) (=> (not (= temp___skip_top_level_362 true)) (= (size (to_base temp___expr_361)) 0))))
...
(declare-datatypes () ((t83s__ref (mk_t83s__ref (t83s__content us_t3)))))
(define-fun t83s__ref___projection ((a t83s__ref)) us_t3 (t83s__content a))
...
(declare-datatypes () ((t86s__ref (mk_t86s__ref (t86s__content us_t4)))))
(define-fun t86s__ref___projection ((a t86s__ref)) us_t4 (t86s__content a))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range2 f) (=> (in_range2 l) (and (= (to_rep1 (first10 (mk5 f l))) f) (= (to_rep1 (last12 (mk5 f l))) l)))) :pattern ((mk5 f l)))))
...
(define-fun bool_eq8 ((x us_t5) (y us_t5)) Bool (bool_eq (elts5 x) (to_rep1 (first10 (rt5 x))) (to_rep1 (last12 (rt5 x))) (elts5 y) (to_rep1 (first10 (rt5 y))) (to_rep1 (last12 (rt5 y)))))
(declare-fun user_eq21 (us_t5 us_t5) Bool)
(declare-const dummy21 us_t5)
(declare-datatypes () ((t89s__ref (mk_t89s__ref (t89s__content us_t5)))))
(define-fun t89s__ref___projection ((a t89s__ref)) us_t5 (t89s__content a))
...
(assert (forall ((s us_rep1)) (! (= (get_model__3 s) (ite (= (wraps_around s) true) (let ((stackp__get_model__3__R84s (last6 s))) (let ((temp___394 (let ((temp___393 (let ((temp___390 1)) (let ((temp___391 (rec__stackp__stack_root__content1 (us_split_fields3 s)))) (of_array4 temp___391 temp___390 stackp__get_model__3__R84s))))) (let ((temp___392 (let ((temp___388 100)) (let ((temp___387 (to_rep3 (rec__stackp__buffer__first (us_split_fields3 s))))) (let ((temp___389 (rec__stackp__stack_root__content1 (us_split_fields3 s)))) (of_array3 temp___389 temp___387 temp___388)))))) (ite (= (length3 temp___392) 0) (of_array2 (to_array4 temp___393) (first9 temp___393) (last11 temp___393)) (of_array2 (slide (concat1 (to_array3 temp___392) (first7 temp___392) (last9 temp___392) (to_array4 temp___393) (first9 temp___393) (last11 temp___393)) (first7 temp___392) 1) 1 (- (+ 1 (+ (ite (<= (first7 temp___392) (last9 temp___392)) (+ (- (last9 temp___392) (first7 temp___392)) 1) 0) (ite (<= (first9 temp___393) (last11 temp___393)) (+ (- (last11 temp___393) (first9 temp___393)) 1) 0))) 1))))))) (of_array (to_array2 temp___394) (first5 temp___394) (last5 temp___394)))) (let ((stackp__get_model__3__R87s (last6 s))) (let ((temp___397 (let ((temp___395 (to_rep3 (rec__stackp__buffer__first (us_split_fields3 s))))) (let ((temp___396 (rec__stackp__stack_root__content1 (us_split_fields3 s)))) (of_array5 temp___396 temp___395 stackp__get_model__3__R87s))))) (of_array (to_array5 temp___397) (first11 temp___397) (last13 temp___397)))))) :pattern ((get_model__3 s)))))
...
(declare-fun attr__ATTRIBUTE_IMAGE12 (Bool) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check12 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE12 (us_image) Bool)
(assert true)
(assert true)
(assert (forall ((s us_rep1)) (! (= (to_int1 (wraps_around s)) (to_int1 (wraps_around1 us_tag2 s))) :pattern ((wraps_around1 us_tag2 s)))))
...
(assert (forall ((s us_rep1)) (! (dynamic_invariant4 (last6 s) true false true) :pattern ((last6 s)))))
(assert (forall ((attr__tag2 Int)) (forall ((s us_rep1)) (! (dynamic_invariant4 (last7 attr__tag2 s) true false true) :pattern ((last7 attr__tag2 s))))))
(assert (forall ((s us_rep1)) (! (= (last6 s) (last7 us_tag2 s)) :pattern ((last7 us_tag2 s)))))
(assert (forall ((s us_rep1)) (! (= (last6 s) (ite (not (= (wraps_around s) true)) (- (+ (to_rep3 (rec__stackp__buffer__first (us_split_fields3 s))) (to_rep2 (rec__stackp__stack_root__length1 (us_split_fields3 s)))) 1) (- (- (+ (to_rep3 (rec__stackp__buffer__first (us_split_fields3 s))) (to_rep2 (rec__stackp__stack_root__length1 (us_split_fields3 s)))) 1) 100))) :pattern ((last6 s)))))
...
(assert (in_range1 e))
(assert (not (= (length (get_model__2 (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag))) 0)))
(assert (=> (<= 1 1) (= o (+ (- 1 1) 1))))
(assert (=> (not (<= 1 1)) (= o 0)))
(assert (=> (<= (to_rep1 (first (rt (get_model__2 (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag))))) (to_rep1 (last (rt (get_model__2 (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag)))))) (= o1 (+ (- (to_rep1 (last (rt (get_model__2 (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag))))) (to_rep1 (first (rt (get_model__2 (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag)))))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt (get_model__2 (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag))))) (to_rep1 (last (rt (get_model__2 (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag))))))) (= o1 0)))
(assert (= o2 (+ o1 o)))
(assert (= o3 (+ (to_rep1 (first (rt (get_model__2 (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag))))) o2)))
(assert (= o4 (- o3 1)))
