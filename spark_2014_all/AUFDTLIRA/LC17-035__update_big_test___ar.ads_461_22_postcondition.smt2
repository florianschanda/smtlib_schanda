...
(declare-fun temp___1445 ((Array Int (Array Int (Array Int et1))) Int (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1))))
(assert (forall ((temp___1447 (Array Int (Array Int (Array Int et1))))) (forall ((temp___1448 Int)) (forall ((temp___1449 (Array Int (Array Int et1)))) (let ((temp___1446 (temp___1445 temp___1447 temp___1448 temp___1449))) (forall ((temp___1450 Int)) (ite (= temp___1450 temp___1448) (= (select temp___1446 temp___1450) temp___1449) (= (select temp___1446 temp___1450) (select temp___1447 temp___1450)))))))))
(declare-fun temp___1451 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
(assert (forall ((temp___1453 (Array Int (Array Int et1)))) (forall ((temp___1454 Int)) (forall ((temp___1455 (Array Int et1))) (let ((temp___1452 (temp___1451 temp___1453 temp___1454 temp___1455))) (forall ((temp___1456 Int)) (ite (= temp___1456 temp___1454) (= (select temp___1452 temp___1456) temp___1455) (= (select temp___1452 temp___1456) (select temp___1453 temp___1456)))))))))
...
(assert (= a2 a3))
(assert (= a4 a2))
(assert (not (= (bool_eq2 a3 1 16 (temp___1445 a i (temp___1451 b j c)) 1 16) true)))
(check-sat)
(exit)
