...
(declare-fun temp___1504 ((Array Int (Array Int (Array Int et1))) Int (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1))))
(declare-fun temp___1510 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
...
(assert (forall ((temp___1506 (Array Int (Array Int (Array Int et1))))) (forall ((temp___1507 Int)) (forall ((temp___1508 (Array Int (Array Int et1)))) (let ((temp___1505 (temp___1504 temp___1506 temp___1507 temp___1508))) (=> (dynamic_invariant1 temp___1507 true true true true) (forall ((temp___1509 Int)) (ite (= temp___1509 temp___1507) (= (select temp___1505 temp___1509) temp___1508) (= (select temp___1505 temp___1509) (select temp___1506 temp___1509))))))))))
(assert (forall ((temp___1512 (Array Int (Array Int et1)))) (forall ((temp___1513 Int)) (forall ((temp___1514 (Array Int et1))) (let ((temp___1511 (temp___1510 temp___1512 temp___1513 temp___1514))) (=> (dynamic_invariant temp___1513 true true true true) (forall ((temp___1515 Int)) (ite (= temp___1515 temp___1513) (= (select temp___1511 temp___1515) temp___1514) (= (select temp___1511 temp___1515) (select temp___1512 temp___1515))))))))))
...
(assert (= a2 a3))
(assert (= a4 a2))
(assert (not (= (bool_eq2 a3 1 16 (temp___1504 a i (temp___1510 b j c)) 1 16) true)))
(check-sat)
(exit)
