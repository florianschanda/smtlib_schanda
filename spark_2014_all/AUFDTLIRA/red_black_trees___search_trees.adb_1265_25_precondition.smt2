...
(assert (= result4 true))
(assert (and (= o6 (size (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)))) (in_range4 o6)))
(assert (= o7 (+ o6 1)))
