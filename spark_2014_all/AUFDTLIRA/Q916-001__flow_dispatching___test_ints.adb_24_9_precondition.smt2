...
(declare-const ic__split_fields4 us_split_fields)
...
(assert (= ic__split_fields4 (mk___split_fields i__split_fields9 i__split_fields10 i__split_fields11 i__split_fields12)))
(assert (= ic__attr__tag i__attr__tag))
(assert (not (< (to_rep1 (rec__ints__int__value ic__split_fields4)) (- (to_rep1 (rec__ints__int__max ic__split_fields4)) 10))))
(check-sat)
(exit)
