...
(assert (= temp___487 o5))
(assert (= temp___4871 o6))
(assert (= temp___4872 o7))
(assert (= s__attr__tag temp___4873))
(assert (= result1 s__split_fields))
(assert (= result2 s__split_fields1))
(assert (= result3 s__split_fields2))
(assert (= temp___487 s__split_fields3))
(assert (= temp___4871 s__split_fields4))
(assert (= temp___4872 s__split_fields5))
(assert (= e1 e2))
...
(assert (not (= (let ((temp___493 (get_model__2 (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag)))) (bool_eq (let ((temp___491 (temp___213 e2))) (let ((temp___490 (get_model__2 (mk___rep (mk___split_fields s__split_fields6 s__split_fields7 s__split_fields8) s__attr__tag)))) (ite (= (length temp___490) 0) temp___491 (concat1 (elts temp___490) (to_rep2 (first (rt temp___490))) (to_rep2 (last (rt temp___490))) temp___491 1 1)))) (to_rep2 (first (let ((temp___490 (get_model__2 (mk___rep (mk___split_fields s__split_fields6 s__split_fields7 s__split_fields8) s__attr__tag)))) (ite (= (length temp___490) 0) (mk 1 1) (mk (to_rep2 (first (rt temp___490))) (- (+ (to_rep2 (first (rt temp___490))) (+ (ite (<= (to_rep2 (first (rt temp___490))) (to_rep2 (last (rt temp___490)))) (+ (- (to_rep2 (last (rt temp___490))) (to_rep2 (first (rt temp___490)))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0))) 1)))))) (to_rep2 (last (let ((temp___490 (get_model__2 (mk___rep (mk___split_fields s__split_fields6 s__split_fields7 s__split_fields8) s__attr__tag)))) (ite (= (length temp___490) 0) (mk 1 1) (mk (to_rep2 (first (rt temp___490))) (- (+ (to_rep2 (first (rt temp___490))) (+ (ite (<= (to_rep2 (first (rt temp___490))) (to_rep2 (last (rt temp___490)))) (+ (- (to_rep2 (last (rt temp___490))) (to_rep2 (first (rt temp___490)))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0))) 1)))))) (elts temp___493) (to_rep2 (first (rt temp___493))) (to_rep2 (last (rt temp___493))))) true)))
(check-sat)
(exit)
