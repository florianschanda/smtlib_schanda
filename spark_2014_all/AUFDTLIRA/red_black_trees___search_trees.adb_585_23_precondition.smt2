...
(assert (= result3 true))
(assert (= (= result4 true) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t1)) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t1)))) i2))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t2)) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t2)))) i2))) true))))))
(assert (= result4 true))
(assert (<= 1 i))
(assert (<= i 100))
