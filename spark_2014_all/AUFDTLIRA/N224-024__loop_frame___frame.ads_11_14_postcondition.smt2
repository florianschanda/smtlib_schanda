...
(assert (= j1 1))
(assert (=> (and (<= 1 j1) (<= j1 10)) (and (and (= temp___176 a) (and (= temp___175 j1) (and (= temp___178 a) (and (= temp___179 a) (and (ite (< 10 (to_rep (select a j1))) (and (and (= (to_rep o) 10) (= o1 (store a j1 o))) (and (= (mk_map__ref result1) (mk_map__ref a)) (= a2 o1))) (and (= a2 a) (= a2 a1))) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 j2)) (= (to_rep (select a3 k1)) (ite (< 10 (to_rep (select temp___179 k1))) 10 (to_rep (select temp___178 k1)))))) (and (and (and (=> (<= 1 10) (in_range2 j2)) (forall ((temp___177 Int)) (=> (and (<= 1 temp___177) (<= temp___177 10)) (=> (< j2 temp___177) (= (select a3 temp___177) (select temp___176 temp___177)))))) (and (<= 1 j2) (<= j2 10))) (= j2 10)))))))) (and (and (= j2 j6) (= a3 a7)) (and (= j7 j2) (= a8 a3))))))
...
(assert (<= 1 j12))
(assert (<= j12 10))
(assert (not (= (to_rep (select a11 j12)) (ite (< 10 (to_rep (select a j12))) 10 (to_rep (select a j12))))))
(check-sat)
(exit)
