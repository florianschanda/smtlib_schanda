...
(assert (=> (and (<= 1 j1) (<= j1 10)) (forall ((k Int)) (=> (and (<= 1 k) (<= k j2)) (= (to_rep (select a3 k)) (ite (< 10 (to_rep (select temp___179 k))) 10 (to_rep (select temp___178 k))))))))
(assert (=> (and (<= 1 j1) (<= j1 10)) (and (and (=> (<= 1 10) (in_range2 j2)) (forall ((temp___177 Int)) (=> (and (<= 1 temp___177) (<= temp___177 10)) (=> (< j2 temp___177) (= (select a3 temp___177) (select temp___176 temp___177)))))) (and (<= 1 j2) (<= j2 10)))))
