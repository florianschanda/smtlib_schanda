...
(declare-const temp___205 (Array Int natural))
...
(assert (= j1 1))
(assert (=> (and (<= 1 j1) (<= j1 10)) (= temp___202 a)))
(assert (=> (and (<= 1 j1) (<= j1 10)) (= temp___201 j1)))
(assert (=> (and (<= 1 j1) (<= j1 10)) (= temp___204 a)))
(assert (=> (and (<= 1 j1) (<= j1 10)) (= temp___205 a)))
(assert (=> (and (<= 1 j1) (<= j1 10)) (=> (< 10 (to_rep (select a j1))) (= (to_rep o) 10))))
(assert (=> (and (<= 1 j1) (<= j1 10)) (=> (< 10 (to_rep (select a j1))) (= o1 (store a j1 o)))))
(assert (=> (and (<= 1 j1) (<= j1 10)) (=> (< 10 (to_rep (select a j1))) (= (mk_map__ref result1) a11))))
(assert (=> (and (<= 1 j1) (<= j1 10)) (=> (< 10 (to_rep (select a j1))) (= a2 o1))))
(assert (=> (and (<= 1 j1) (<= j1 10)) (=> (not (< 10 (to_rep (select a j1)))) (= a2 a))))
(assert (=> (and (<= 1 j1) (<= j1 10)) (=> (not (< 10 (to_rep (select a j1)))) (= a2 a1))))
(assert (=> (and (<= 1 j1) (<= j1 10)) (forall ((k Int)) (=> (and (<= 1 k) (<= k j2)) (= (to_rep (select a3 k)) (ite (< 10 (to_rep (select temp___205 k))) 10 (to_rep (select temp___204 k))))))))
(assert (=> (and (<= 1 j1) (<= j1 10)) (and (and (=> (<= 1 10) (in_range2 j2)) (forall ((temp___203 Int)) (=> (and (<= 1 temp___203) (<= temp___203 10)) (=> (< j2 temp___203) (= (select a3 temp___203) (select temp___202 temp___203)))))) (and (<= 1 j2) (<= j2 10)))))
