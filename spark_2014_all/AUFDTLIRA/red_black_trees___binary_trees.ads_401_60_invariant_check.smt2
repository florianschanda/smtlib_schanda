...
(assert (<= i2 100))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5))) true))
(assert (and (= o6 (valid_root (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5)) i2)) (and (= (= o6 true) (and (<= i2 (to_rep f__split_fields4)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields5 i2)))) 2))) (=> (< (size (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5))) i2) (not (= o6 true))))))
(assert (= result14 (ite (= o6 true) (ite (not (= i2 root2)) true false) false)))
