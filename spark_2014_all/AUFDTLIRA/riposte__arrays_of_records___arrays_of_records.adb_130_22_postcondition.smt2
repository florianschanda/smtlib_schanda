...
(assert (= result1 a1))
(assert (= a2 (store a1 5 (mk___rep (mk___split_fields (rec__arrays_of_records__basic_record__flag (us_split_fields1 (select a1 5))) rliteral1 (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select a1 5))))))))
(assert (= a2 a3))
(assert (= a4 a2))
(assert (not (not (= (to_rep (rec__arrays_of_records__basic_record__first_value (us_split_fields1 (select a3 17)))) 23))))
(check-sat)
(exit)
