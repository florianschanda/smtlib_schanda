...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 10)) (and (and (= temp___145 i1) (and (= temp___144 res1) (and (= res2 0) (and (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 res2)) (=> (<= 1 10) (in_range3 i2))) (and (<= 1 i2) (<= i2 10))) (or (and (and (= res3 res4) (= res5 res3)) (and (= (to_rep (select t i2)) r) (and (= res2 result2) (= res3 i2)))) (and (and (not (= (to_rep (select t i2)) r)) (= res3 res2)) (and (and (= res3 res4) (= res5 res3)) (= i2 10)))))))) (and (and (= i2 i6) (= (mk_int__ref res8) (mk_int__ref res4))) (and (= i7 i2) (= res9 res5))))))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= (mk_int__ref i8) (mk_int__ref i6))))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= (mk_int__ref res10) (mk_int__ref res8))))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= i9 i7)))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= res11 res9)))
(assert (=> (not (and (<= 1 i1) (<= i1 10))) (= i1 i8)))
(assert (=> (not (and (<= 1 i1) (<= i1 10))) (= res1 res10)))
(assert (=> (not (and (<= 1 i1) (<= i1 10))) (= i9 i1)))
(assert (=> (not (and (<= 1 i1) (<= i1 10))) (= res11 res1)))
(assert (= find__find__result1 find__find__result2))
(assert (= find__find__result3 find__find__result1))
(assert (= (mk_int__ref result4) (mk_int__ref find__find__result)))
(assert (= find__find__result1 res10))
(assert (= (mk_int__ref find__find__result4) (mk_int__ref find__find__result2)))
(assert (= (mk_int__ref i10) (mk_int__ref i8)))
(assert (= (mk_int__ref res12) (mk_int__ref res10)))
(assert (= find__find__result5 find__find__result3))
(assert (= i11 i9))
(assert (= res13 res11))
(assert (= result5 find__find__result4))
(assert (not (<= 0 find__find__result4)))
(check-sat)
(exit)
