...
(assert (forall ((i t10b)) (and (<= 2 (t10bqtint i)) (<= (t10bqtint i) 30))))
...
(assert (= a2 result3))
(assert (= a3 o2))
(assert (and (and (forall ((j Int)) (=> (and (<= 2 j) (<= j i2)) (= (to_rep (select a4 j)) (+ (to_rep (select a4 (- j 1))) (to_rep (select a4 (- j 2))))))) (= (to_rep (select a4 0)) 0)) (= (to_rep (select a4 1)) 1)))
(assert (and (and (=> (<= 2 30) (in_range4 i2)) (forall ((temp___183 Int)) (=> (and (<= 0 temp___183) (<= temp___183 30)) (=> (or (< 30 temp___183) (or (< temp___183 2) (< i2 temp___183))) (= (select a4 temp___183) (select a2 temp___183)))))) (and (<= 2 i2) (<= i2 30))))
(assert (not (= i2 30)))
(assert (= i2 result4))
(assert (= i3 (+ i2 1)))
(assert (not (in_range1 (+ (to_rep (select a4 (- i3 1))) (to_rep (select a4 (- i3 2)))))))
(check-sat)
(exit)
