...
(assert (= (= o63 true) (forall ((i6 Int)) (=> (and (<= last3 i6) (<= i6 first3)) (forall ((j4 Int)) (=> (and (<= i6 j4) (<= j4 first3)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select (map__content a8) j4)))) (get_max_left i6 (map__content a8)))))))))
(assert (<= first3 i4))
(assert (<= i4 last3))
(assert (<= i4 j2))
(assert (<= j2 last3))
(assert (and (= o59 j2) (in_range3 j2)))
(assert (and (= o60 (get_max_left o59 (map__content a8))) (and (in_range2 o60) (= o60 (to_rep (rec__frame_condition__cell__max_left (us_split_fields1 (select (map__content a8) o59))))))))
