...
(assert (=> (and (<= (to_rep1 (first (rt a))) i1) (<= i1 (to_rep1 (last (rt a))))) (= temp___222 i1)))
(assert (=> (and (<= (to_rep1 (first (rt a))) i1) (<= i1 (to_rep1 (last (rt a))))) (= temp___221 location1)))
(assert (=> (and (<= (to_rep1 (first (rt a))) i1) (<= i1 (to_rep1 (last (rt a))))) (= temp___220 found1)))
(assert (=> (and (<= (to_rep1 (first (rt a))) i1) (<= i1 (to_rep1 (last (rt a))))) (or (and (and (and (= i1 i6) (and (= location2 location7) (= found2 found7))) (and (= i7 i1) (and (= location8 location2) (= found8 found2)))) (and (and (and (and (and (and (and (<= (to_rep1 (first (rt b))) i1) (<= i1 (to_rep1 (last (rt b))))) (= o i1)) (= o1 (select (elts b) o))) (= o2 (to_rep o1))) (= o3 (ite (= (to_rep (select (elts a) i1)) o2) true false))) (= result3 (ite (not (= o3 true)) true false))) (and (= result3 true) (and (and (= found1 result4) (= found2 (distinct 1 0))) (and (= location1 result5) (= location2 i1)))))) (and (and (and (and (and (and (and (and (<= (to_rep1 (first (rt b))) i1) (<= i1 (to_rep1 (last (rt b))))) (= o i1)) (= o1 (select (elts b) o))) (= o2 (to_rep o1))) (= o3 (ite (= (to_rep (select (elts a) i1)) o2) true false))) (= result3 (ite (not (= o3 true)) true false))) (and (not (= result3 true)) (and (= location2 location1) (= found2 found1)))) (and (and (and (= i14 (mk_int__ref i4)) (and (= location15 (mk_int__ref location5)) (= found16 (mk_bool__ref found5)))) (and (= i7 i5) (and (= location8 location6) (= found8 found6)))) (and (and (forall ((j Int)) (=> (and (<= (to_rep1 (first (rt a))) j) (<= j i2)) (= (to_rep (select (elts a) j)) (to_rep (select (elts b) j))))) (not (= found3 true))) (and (and (and (=> (<= (- 2147483648) 2147483647) (in_range3 location3)) (=> (<= (to_rep1 (first (rt a))) (to_rep1 (last (rt a)))) (dynamic_property1 (to_rep1 (first (rt a))) (to_rep1 (last (rt a))) i2))) (and (<= (to_rep1 (first (rt a))) i2) (<= i2 (to_rep1 (last (rt a)))))) (or (and (and (and (= i2 i4) (and (= location3 location5) (= found3 found5))) (and (= i5 i2) (and (= location6 location3) (= found6 found3)))) (= i2 (to_rep1 (last (rt a))))) (and (not (= i2 (to_rep1 (last (rt a))))) (and (and (and (= i3 i4) (and (= location4 location5) (= found4 found5))) (and (= i5 i3) (and (= location6 location4) (= found6 found4)))) (and (and (= i2 result6) (= i3 (+ i2 1))) (and (and (and (and (and (and (and (<= (to_rep1 (first (rt b))) i3) (<= i3 (to_rep1 (last (rt b))))) (= o4 i3)) (= o5 (select (elts b) o4))) (= o6 (to_rep o5))) (= o7 (ite (= (to_rep (select (elts a) i3)) o6) true false))) (= result7 (ite (not (= o7 true)) true false))) (and (= result7 true) (and (and (= found3 result8) (= found4 (distinct 1 0))) (and (= location3 result9) (= location4 i3))))))))))))))))
(assert (=> (and (<= (to_rep1 (first (rt a))) i1) (<= i1 (to_rep1 (last (rt a))))) (= i8 i14)))
(assert (=> (and (<= (to_rep1 (first (rt a))) i1) (<= i1 (to_rep1 (last (rt a))))) (= location9 location15)))
(assert (=> (and (<= (to_rep1 (first (rt a))) i1) (<= i1 (to_rep1 (last (rt a))))) (= found15 found16)))
(assert (=> (and (<= (to_rep1 (first (rt a))) i1) (<= i1 (to_rep1 (last (rt a))))) (= i9 i7)))
(assert (=> (and (<= (to_rep1 (first (rt a))) i1) (<= i1 (to_rep1 (last (rt a))))) (= location10 location8)))
(assert (=> (and (<= (to_rep1 (first (rt a))) i1) (<= i1 (to_rep1 (last (rt a))))) (= found10 found8)))
(assert (=> (and (<= (to_rep1 (first (rt a))) i1) (<= i1 (to_rep1 (last (rt a))))) (= i10 i8)))
(assert (=> (and (<= (to_rep1 (first (rt a))) i1) (<= i1 (to_rep1 (last (rt a))))) (= location11 location9)))
(assert (=> (and (<= (to_rep1 (first (rt a))) i1) (<= i1 (to_rep1 (last (rt a))))) (= found11 found15)))
(assert (=> (and (<= (to_rep1 (first (rt a))) i1) (<= i1 (to_rep1 (last (rt a))))) (= i11 i9)))
(assert (=> (and (<= (to_rep1 (first (rt a))) i1) (<= i1 (to_rep1 (last (rt a))))) (= location12 location10)))
(assert (=> (and (<= (to_rep1 (first (rt a))) i1) (<= i1 (to_rep1 (last (rt a))))) (= found12 found10)))
(assert (=> (not (and (<= (to_rep1 (first (rt a))) i1) (<= i1 (to_rep1 (last (rt a)))))) (= i10 (mk_int__ref i1))))
(assert (=> (not (and (<= (to_rep1 (first (rt a))) i1) (<= i1 (to_rep1 (last (rt a)))))) (= location11 (mk_int__ref location1))))
(assert (=> (not (and (<= (to_rep1 (first (rt a))) i1) (<= i1 (to_rep1 (last (rt a)))))) (= found11 (mk_bool__ref found1))))
(assert (=> (not (and (<= (to_rep1 (first (rt a))) i1) (<= i1 (to_rep1 (last (rt a)))))) (= i11 i1)))
(assert (=> (not (and (<= (to_rep1 (first (rt a))) i1) (<= i1 (to_rep1 (last (rt a)))))) (= location12 location1)))
(assert (=> (not (and (<= (to_rep1 (first (rt a))) i1) (<= i1 (to_rep1 (last (rt a)))))) (= found12 found1)))
(assert (= i12 i10))
...
(assert (<= (to_rep1 (first (rt a))) (- (int__content location13) 1)))
