...
(assert (=> (= result1 true) (=> (not (= first_available 0)) (and (= o5 (length (rec__list_mod_allocator__m__t__available (us_split_fields1 m)))) (and (in_range2 o5) (<= (+ 0 o5) 2147483647))))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (= result2 (ite (< 0 o5) true false)))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (=> (= result2 true) (and (= o4 (get (rec__list_mod_allocator__m__t__available (us_split_fields1 m)) 1)) (in_range3 o4))))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (=> (= result2 true) (= result (ite (= o4 first_available) true false))))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (=> (not (= result2 true)) (= result false)))))
(assert (=> (= result1 true) (=> (not (not (= first_available 0))) (and (= o6 (length (rec__list_mod_allocator__m__t__available (us_split_fields1 m)))) (and (in_range2 o6) (<= (+ 0 o6) 2147483647))))))
...
(assert (= result3 true))
(assert (and (= o3 (get (rec__list_mod_allocator__m__t__available (us_split_fields1 m)) j)) (in_range3 o3)))
(assert (= result4 (ite (in_range7 o3) true false)))
(assert (= result4 true))
