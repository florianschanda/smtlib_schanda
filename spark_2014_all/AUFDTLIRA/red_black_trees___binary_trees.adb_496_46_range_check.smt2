...
(declare-const temp___1244 (Array Int us_rep1))
...
(assert (<= 1 i))
(assert (<= i 100))
(assert (=> (< 0 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i))))) (and (= o v) (in_range2 v))))
(assert (=> (< 0 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i))))) (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true)))
(assert (=> (< 0 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i))))) (and (= o1 v) (in_range2 v))))
(assert (=> (< 0 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i))))) (and (= temp___1244 (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o1)) (and (dynamic_invariant1 temp___1244 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1244 o1))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1244 o1)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 o1)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1244 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1244 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1244 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1244 i1))) true) (not (= i1 o1))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1244 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1)))) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1244 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1244 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1244 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1244 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1244 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1244 j)))) true)) (= j i1)))))))))))))))
(assert (=> (< 0 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i))))) (and (<= 1 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i))))) (<= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i)))) 100))))
(assert (=> (< 0 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i))))) (= o2 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i)))))))
(assert (=> (< 0 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i))))) (= (mk___rep (mk___split_fields o3 o4)) (select temp___1244 o2))))
(assert (=> (< 0 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i))))) (= o3 o5)))
(assert (=> (< 0 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i))))) (= o4 o6)))
(assert (=> (< 0 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i))))) (= result o6)))
(assert (=> (not (< 0 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i)))))) (= result false)))
(assert (= result true))
(assert (not (= i v)))
