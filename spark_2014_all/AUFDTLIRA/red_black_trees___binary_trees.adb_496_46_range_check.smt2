...
(assert (<= 1 i))
(assert (<= i 100))
(assert (=> (< 0 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i))))) (and (= o16 v) (in_range1 v))))
...
(assert (=> (< 0 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i))))) (and (= o17 v) (in_range1 v))))
(assert (=> (< 0 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i))))) (and (= temp___1198 (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o17)) (and (dynamic_invariant3 temp___1198 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1198 o17))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1198 o17)))) 0) (and (forall ((i13 Int)) (=> (and (<= 1 i13) (<= i13 100)) (=> (not (= i13 o17)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i13) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1198 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i13)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1198 i13))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1198 i13))) true)))))) (and (forall ((i13 Int)) (=> (and (<= 1 i13) (<= i13 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1198 i13))) true) (not (= i13 o17))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1198 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i13)))) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i13) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1198 i13)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1198 i13)))) 0)))) (forall ((i13 Int)) (=> (and (<= 1 i13) (<= i13 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1198 i13))) true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1198 j2))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1198 i13))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1198 j2)))) true)) (= j2 i13)))))))))))))))
...
(assert (=> (< 0 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i))))) (= o18 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i)))))))
(assert (=> (< 0 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i))))) (= (mk___rep (mk___split_fields o19 o20)) (select temp___1198 o18))))
(assert (=> (< 0 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i))))) (= o19 o21)))
(assert (=> (< 0 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i))))) (= o20 o22)))
(assert (=> (< 0 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i))))) (= result5 o22)))
(assert (=> (not (< 0 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i)))))) (= result5 false)))
(assert (= result5 true))
(assert (not (= i v)))
