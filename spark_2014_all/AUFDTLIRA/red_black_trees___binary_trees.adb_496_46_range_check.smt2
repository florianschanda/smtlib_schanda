...
(assert (<= 1 i))
(assert (<= i 100))
(assert (=> (< 0 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i))))) (and (= o v) (in_range1 v))))
