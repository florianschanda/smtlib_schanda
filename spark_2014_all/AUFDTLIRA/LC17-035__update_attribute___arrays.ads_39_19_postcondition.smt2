...
(declare-fun temp___235 ((Array Int integer) Int Int Int Int Int Int Int) (Array Int integer))
(assert (forall ((temp___237 (Array Int integer))) (forall ((temp___238 Int) (temp___239 Int) (temp___240 Int) (temp___241 Int) (temp___242 Int) (temp___243 Int) (temp___244 Int)) (let ((temp___236 (temp___235 temp___237 temp___238 temp___239 temp___240 temp___241 temp___242 temp___243 temp___244))) (forall ((temp___245 Int)) (ite (= temp___245 temp___243) (= (select temp___236 temp___245) (of_rep temp___244)) (ite (= temp___245 temp___241) (= (select temp___236 temp___245) (of_rep temp___242)) (ite (and (<= temp___238 temp___245) (<= temp___245 temp___239)) (= (select temp___236 temp___245) (of_rep temp___240)) (= (select temp___236 temp___245) (select temp___237 temp___245))))))))))
...
(assert (not (= (bool_eq arrays__f3__result4 1 8 (temp___235 arr_in 1 4 x 2 1 3 (to_rep (select an_arr 4))) 1 8) true)))
(check-sat)
(exit)
