...
(declare-const result11 (Array Int group1_id))
...
(assert (= result11 (map__content stable_marriage__matching__result4)))
(declare-const g111 Int)
(assert (<= 1 g111))
(assert (<= g111 64))
(assert (not (exists ((g21 Int)) (and (and (<= 1 g21) (<= g21 64)) (= (to_rep (select (map__content stable_marriage__matching__result4) g21)) g111)))))
(check-sat)
(exit)
