...
(assert (and (= (length source) 11) (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 50)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 49)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 3))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 4))) 55)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 5))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 6))) 56)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 7))) 51)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 8))) 54)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 9))) 52)) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 10))) 57)) (forall ((index1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 10) index1) (<= index1 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index1))) true))))))
(assert (=> (<= (- 2147483648) 2147483647) (in_range1 n)))
(assert (and (= temp___1814 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (not (<= (to_rep1 (first (rt source))) temp___1814)))
(check-sat)
(exit)
