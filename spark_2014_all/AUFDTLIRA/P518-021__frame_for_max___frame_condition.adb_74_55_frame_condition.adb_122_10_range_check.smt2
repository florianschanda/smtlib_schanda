...
(assert (= k10 k8))
(assert (= a8 a6))
(assert (and (= o27 (frame_left (mk___t a (mk (to_rep1 a__first) (to_rep1 a__last))) (map__content a7))) (= (= o27 true) (forall ((i1 Int)) (=> (and (<= (to_rep1 a__first) i1) (<= i1 (to_rep1 a__last))) (= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select (map__content a7) i1)))) (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a i1))))))))))
(assert (<= last3 i))
(assert (<= i first3))
(assert (<= i j))
(assert (<= j first3))
