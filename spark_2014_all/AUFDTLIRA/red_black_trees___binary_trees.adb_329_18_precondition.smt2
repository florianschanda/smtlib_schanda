...
(assert (and (= temp___1103 (model__ f2 root)) (and (dynamic_invariant2 temp___1103 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1103 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1103 root)))) 0) (and (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (not (= i5 root)) (ite (and (not (= (parent f2 i5) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1103 (parent f2 i5)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1103 i5))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1103 i5))) true)))))) (and (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1103 i5))) true) (not (= i5 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1103 (parent f2 i5)))) (position f2 i5) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1103 i5)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1103 i5)))) 0)))) (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1103 i5))) true) (forall ((j20 Int)) (=> (and (<= 1 j20) (<= j20 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1103 j20))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1103 i5))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1103 j20)))) true)) (= j20 i5))))))))))))))
(assert (= (mk___rep (mk___split_fields o33 o34)) (select temp___1103 i3)))
(assert (= o35 (mk___split_fields o33 o34)))
(assert (= o36 (rec__tree_model__path_type__a o35)))
(assert (and (= o37 (length o36)) (and (in_range5 o37) (<= (+ 0 o37) 2147483647))))
(assert (= o38 (ite (< o37 n2) true false)))
(assert (= (tree_structure f2) true))
