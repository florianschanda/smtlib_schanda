...
(declare-const n Int)
(declare-const i Int)
(declare-const temp___1149 (Array Int us_rep1))
...
(assert (and (= temp___1149 (model__ f2 root)) (and (dynamic_invariant2 temp___1149 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1149 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1149 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent f2 i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1149 (parent f2 i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1149 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1149 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1149 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1149 (parent f2 i1)))) (position f2 i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1149 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1149 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1149 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1149 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1149 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1149 j)))) true)) (= j i1))))))))))))))
(assert (= (mk___rep (mk___split_fields o o1)) (select temp___1149 i)))
(assert (= o2 (mk___split_fields o o1)))
(assert (= o3 (rec__tree_model__path_type__a o2)))
(assert (and (= o4 (length o3)) (and (in_range5 o4) (<= (+ 0 o4) 2147483647))))
