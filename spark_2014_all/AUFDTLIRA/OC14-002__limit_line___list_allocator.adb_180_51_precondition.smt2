...
(assert (=> (not (= first_available1 0)) (and (= o45 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range6 o45))))
(assert (=> (not (= first_available1 0)) (= result11 (ite (< 0 o45) true false))))
(assert (=> (not (= first_available1 0)) (=> (= result11 true) (and (= o44 (get (rec__list_allocator__m__t__available model____split_fields3) 1)) (in_range7 o44)))))
(assert (=> (not (= first_available1 0)) (=> (= result11 true) (= result10 (ite (= o44 first_available1) true false)))))
(assert (=> (not (= first_available1 0)) (=> (not (= result11 true)) (= result10 false))))
(assert (=> (not (not (= first_available1 0))) (and (= o46 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range6 o46))))
(assert (=> (not (not (= first_available1 0))) (= result10 (ite (= o46 0) true false))))
