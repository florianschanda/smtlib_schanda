...
(assert (= (to_rep o) (to_rep (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select b 5))))))
...
(assert (= (rec__arrays_of_records__basic_record__flag (us_split_fields1 (select b 5))) o9))
(assert (= (rec__arrays_of_records__basic_record__first_value (us_split_fields1 (select b 5))) o10))
(assert (= o8 o11))
(assert (= o12 o9))
(assert (= o13 o10))
(assert (= o14 o11))
