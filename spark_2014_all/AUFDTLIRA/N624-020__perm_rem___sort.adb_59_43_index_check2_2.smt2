...
(assert (and (= temp___291 (remove (mk___t init (mk 1 100)) o47)) (and (dynamic_invariant3 temp___291 true false true true) (and (= (invariant__ temp___291) true) (and (= (to_rep1 (last (rt temp___291))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o47 1))) (= (to_rep (select init k)) (to_rep (select (elts temp___291) k))))) (and (forall ((k Int)) (=> (and (<= (+ o47 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select init k)) (to_rep (select (elts temp___291) (- k 1)))))) (forall ((k Int)) (=> (and (<= o47 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select init (+ k 1))) (to_rep (select (elts temp___291) k))))))))))))
(assert (not (<= (to_rep1 (first (rt temp___291))) y)))
(check-sat)
(exit)
