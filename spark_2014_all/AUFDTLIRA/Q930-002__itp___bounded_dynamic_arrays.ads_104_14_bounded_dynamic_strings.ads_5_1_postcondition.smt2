...
(declare-const bounded_dynamic_strings__Oconcat__4__result3 t1)
(declare-const temp___1066 (Array Int character))
(declare-const temp___10661 t2)
...
(declare-const bounded_dynamic_strings__Oconcat__4__result7 t1)
...
(define-fun bounded_dynamic_strings__Oconcat__4__result12 () us_rep (mk___rep (mk___split_discrs bounded_dynamic_strings__Oconcat__4__result4) (mk___split_fields bounded_dynamic_strings__Oconcat__4__result5 (mk___t1 bounded_dynamic_strings__Oconcat__4__result6 bounded_dynamic_strings__Oconcat__4__result7))))
(define-fun o15 () us_rep (mk___rep (mk___split_discrs o11) (mk___split_fields o12 (mk___t1 o13 o14))))
(define-fun o16 () us_t2 (mk___t2 o9 o10))
(define-fun temp___10662 () us_t2 (mk___t2 temp___1066 temp___10661))
...
(assert (and (= temp___10662 (value left)) (and (dynamic_invariant2 temp___10662 true false true true) (and (and (= (elts1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 left))) temp___1066) (= (mk2 (to_rep1 (first6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 left)))))) (to_rep1 (last6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 left))))))) temp___10661)) (and (and (and (= (length3 temp___10662) (length2 left)) (= (to_rep1 (first4 temp___10661)) 1)) (= (to_rep1 (last4 temp___10661)) (length2 left))) (= (< 0 (length2 left)) (not (= (empty left) true))))))))
(assert (=> (= (length3 temp___10662) 0) (= (to_rep o) right)))
(assert (=> (= (length3 temp___10662) 0) (= o1 (singleton1 o 1))))
(assert (=> (= (length3 temp___10662) 0) (= o1 temp___1067)))
(assert (=> (= (length3 temp___10662) 0) (= (mk 1 1) temp___10671)))
(assert (=> (not (= (length3 temp___10662) 0)) (=> (<= (to_rep1 (first4 temp___10661)) (to_rep1 (last4 temp___10661))) (= o3 (+ (- (to_rep1 (last4 temp___10661)) (to_rep1 (first4 temp___10661))) 1)))))
(assert (=> (not (= (length3 temp___10662) 0)) (=> (not (<= (to_rep1 (first4 temp___10661)) (to_rep1 (last4 temp___10661)))) (= o3 0))))
(assert (=> (not (= (length3 temp___10662) 0)) (= o4 (+ o3 1))))
(assert (=> (not (= (length3 temp___10662) 0)) (= o5 (+ (to_rep1 (first4 temp___10661)) o4))))
(assert (=> (not (= (length3 temp___10662) 0)) (= o6 (- o5 1))))
(assert (=> (not (= (length3 temp___10662) 0)) (and (= o7 o6) (in_range2 o6))))
(assert (=> (not (= (length3 temp___10662) 0)) (= (to_rep o2) right)))
(assert (=> (not (= (length3 temp___10662) 0)) (= o8 (concat_singleton_right temp___1066 (to_rep1 (first4 temp___10661)) (to_rep1 (last4 temp___10661)) o2))))
(assert (=> (not (= (length3 temp___10662) 0)) (= o8 temp___1067)))
(assert (=> (not (= (length3 temp___10662) 0)) (= (mk (to_rep1 (first4 temp___10661)) o7) temp___10671)))
(assert (dynamic_property3 1 2147483647 (to_rep1 (first temp___10671)) (to_rep1 (last temp___10671))))
(assert (= temp___1067 o9))
(assert (= (mk2 (to_rep1 (first temp___10671)) (to_rep1 (last temp___10671))) o10))
(assert (and (= o15 (instance (+ (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 left))) 1) o16)) (and (dynamic_invariant1 o15 true false true true) (and (and (= (to_rep2 o11) (+ (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 left))) 1)) (= (length2 o15) (length3 o16))) (= (let ((temp___274 (value o15))) (bool_eq (elts2 temp___274) (to_rep1 (first4 (rt2 temp___274))) (to_rep1 (last4 (rt2 temp___274))) o9 (to_rep1 (first4 o10)) (to_rep1 (last4 o10)))) true)))))
(assert (= (mk_sequence__ref (mk___rep (mk___split_discrs result) (mk___split_fields result1 (mk___t1 result2 result3)))) (mk_sequence__ref (mk___rep (mk___split_discrs bounded_dynamic_strings__Oconcat__4__result) (mk___split_fields bounded_dynamic_strings__Oconcat__4__result1 (mk___t1 bounded_dynamic_strings__Oconcat__4__result2 bounded_dynamic_strings__Oconcat__4__result3))))))
...
(assert (= (mk___rep (mk___split_discrs result4) (mk___split_fields result5 (mk___t1 result6 result7))) (sequence__content bounded_dynamic_strings__Oconcat__4__result10)))
(assert (not (= (length2 (sequence__content bounded_dynamic_strings__Oconcat__4__result10)) (+ (length2 left) 1))))
(check-sat)
(exit)
