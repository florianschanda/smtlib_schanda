...
(assert (=> (and (<= 1 g12) (<= g12 64)) (forall ((prev1 Int)) (=> (and (<= 1 prev1) (<= prev1 (- g13 1))) (= (to_rep (select (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields3) prev1)) prev1)))))
...
(assert (=> (and (<= 1 g12) (<= g12 64)) (and (= o5 (+ (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields3)) 1)) (in_range4 (+ (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields3)) 1)))))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= (to_rep3 o6) o5)))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields3) o7)))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= o6 o8)))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= temp___495 o7)))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= temp___4951 o8)))
...
(assert (=> (and (<= 1 g12) (<= g12 64)) (= (to_rep o9) c175b)))
...
(assert (=> (and (<= 1 g12) (<= g12 64)) (= o10 (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields4)))))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= o11 (store (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields4) o10 o9))))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= o11 o12)))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields4) o13)))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= temp___499 o12)))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= temp___4991 o13)))
...
(assert (<= 1 g21))
(assert (<= g21 64))
(assert (not (= (is_permutation_1 (select ranking_2 g21)) true)))
(check-sat)
(exit)
