...
(assert (and (forall ((g17 Int)) (=> (and (<= 1 g17) (<= g17 64)) (= (is_permutation_2 (select ranking_1 g17)) true))) (forall ((g2 Int)) (=> (and (<= 1 g2) (<= g2 64)) (= (is_permutation_1 (select ranking_2 g2)) true)))))
...
(assert (and (= o3 (invert ranking_2)) (forall ((g2 Int)) (=> (and (<= 1 g2) (<= g2 64)) (= (bool_eq4 (select o3 g2) 1 64 (invert_1 (select ranking_2 g2)) 1 64) true)))))
(assert (= result4 (mk_map__ref5 ranking_2_inverted)))
(assert (= ranking_2_inverted1 o3))
(assert (= result5 (mk_int__ref g1)))
(assert (= g11 1))
(assert (=> (and (<= 1 g11) (<= g11 64)) (= unmatched_g1_set__split_fields2 (mk___split_fields temp___543 temp___5431))))
(assert (=> (and (<= 1 g11) (<= g11 64)) (= temp___542 g11)))
...
(assert (=> (and (<= 1 g11) (<= g11 64)) (and (= o4 (+ (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields3)) 1)) (in_range4 (+ (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields3)) 1)))))
(assert (=> (and (<= 1 g11) (<= g11 64)) (= (to_rep3 o5) o4)))
(assert (=> (and (<= 1 g11) (<= g11 64)) (= (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields3) o6)))
(assert (=> (and (<= 1 g11) (<= g11 64)) (= o5 o7)))
(assert (=> (and (<= 1 g11) (<= g11 64)) (= temp___537 o6)))
(assert (=> (and (<= 1 g11) (<= g11 64)) (= temp___5371 o7)))
(assert (=> (and (<= 1 g11) (<= g11 64)) (= result6 (mk___split_fields__ref unmatched_g1_set__split_fields3))))
(assert (=> (and (<= 1 g11) (<= g11 64)) (= unmatched_g1_set__split_fields4 (mk___split_fields temp___537 temp___5371))))
(assert (=> (and (<= 1 g11) (<= g11 64)) (= (to_rep o8) c175b)))
...
(assert (=> (and (<= 1 g11) (<= g11 64)) (= o9 (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields4)))))
(assert (=> (and (<= 1 g11) (<= g11 64)) (= o10 (store (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields4) o9 o8))))
(assert (=> (and (<= 1 g11) (<= g11 64)) (= o10 o11)))
(assert (=> (and (<= 1 g11) (<= g11 64)) (= (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields4) o12)))
(assert (=> (and (<= 1 g11) (<= g11 64)) (= temp___541 o11)))
(assert (=> (and (<= 1 g11) (<= g11 64)) (= temp___5411 o12)))
(assert (=> (and (<= 1 g11) (<= g11 64)) (= result7 (mk___split_fields__ref unmatched_g1_set__split_fields4))))
(assert (=> (and (<= 1 g11) (<= g11 64)) (= unmatched_g1_set__split_fields5 (mk___split_fields temp___541 temp___5411))))
...
(assert (< 0 (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality (us_split_fields__content unmatched_g1_set__split_fields8)))))
(assert (= (invariant_holds unmatched_g1_set__split_fields10 proposals_made2 result__2 unmatched_g2_set2) true))
(assert (< 0 (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields10))))
(declare-const g2 Int)
(assert (<= 1 g2))
(assert (<= g2 64))
(assert (not (= (is_permutation_1 (select ranking_2 g2)) true)))
(check-sat)
(exit)
