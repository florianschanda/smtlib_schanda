...
(assert (not (= (ite (<= (to_rep1 (first8 temp___14571)) (to_rep1 (last8 temp___14571))) (+ (- (to_rep1 (last8 temp___14571)) (to_rep1 (first8 temp___14571))) 1) 0) (ite (<= r13b 10) (+ (- 10 r13b) 1) 0))))
(check-sat)
(exit)
