...
(assert (= (slide (concat1 temp___191 6 10 temp___192 1 5) 6 1) temp___193))
(assert (= (mk 1 o5) temp___1931))
(assert (not (= (ite (<= (to_rep (first temp___1931)) (to_rep (last temp___1931))) (+ (- (to_rep (last temp___1931)) (to_rep (first temp___1931))) 1) 0) (ite (<= 1 10) (+ (- 10 1) 1) 0))))
(check-sat)
(exit)
