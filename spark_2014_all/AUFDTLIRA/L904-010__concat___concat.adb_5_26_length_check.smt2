...
(declare-const temp___221 (Array Int Bool))
(declare-const o Int)
...
(declare-const temp___223 (Array Int Bool))
...
(assert (= (slide (concat1 temp___221 6 10 temp___222 1 5) 6 1) temp___223))
(assert (= (mk 1 o5) temp___2231))
(assert (not (= (ite (<= (to_rep (first temp___2231)) (to_rep (last temp___2231))) (+ (- (to_rep (last temp___2231)) (to_rep (first temp___2231))) 1) 0) (ite (<= 1 10) (+ (- 10 1) 1) 0))))
(check-sat)
(exit)
