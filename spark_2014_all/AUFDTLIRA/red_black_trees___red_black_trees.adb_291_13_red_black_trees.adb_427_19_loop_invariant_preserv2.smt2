...
(assert (=> (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c81b) (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c82b)) y))))) n62) (= (eq (select (nb_blacks c82b) (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c82b)) y)) (select (nb_blacks c81b) (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c82b)) y))) true)))
(assert (not (= n62 100)))
(assert (= result42 (mk_int__ref n62)))
(assert (= n63 (+ n62 1)))
(assert (= n64 (mk_int__ref n63)))
(assert (= n65 n63))
(assert (not (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c81b) c83b)))) (int__content n64))))
(assert (not true))
(check-sat)
(exit)
