...
(assert (= unmatched_g2_set4 (mk_map__ref7 unmatched_g2_set3)))
...
(assert (not (= (invariant_holds (us_split_fields__content unmatched_g1_set__split_fields12) (map__content6 proposals_made4) (map__content result__4) (map__content7 unmatched_g2_set4)) true)))
(check-sat)
(exit)
