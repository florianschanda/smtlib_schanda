...
(assert (=> (not (= (int__content i14) 0)) (= result22 (rec__tree_model__path_type__k o40))))
...
(assert (=> (= result22 true) (and (= o36 (root (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)))) (and (in_range3 o36) (= o36 (to_rep1 t__split_fields))))))
(assert (=> (= result22 true) (type_invariant1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))))
(assert (=> (= result22 true) (and (= o37 (root (mk___rep3 (us_split_fields__content3 t__split_fields14)))) (and (in_range3 o37) (= o37 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields__content3 t__split_fields14))))))))
(assert (=> (= result22 true) (= result21 (ite (= o37 o36) true false))))
...
(assert (=> (= result21 true) (and (= o35 (size1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))) (and (in_range4 o35) (= o35 (size (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14))))))))
(assert (=> (= result21 true) (= result20 (ite (= o35 (+ (size1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3))) 1)) true false))))
...
(assert (=> (= result20 true) (and (= o33 (values1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)))) (ite (= (size (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2))) 0) (= (is_empty o33) true) (and (forall ((i16 Int)) (=> (and (<= 1 i16) (<= i16 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) (to_rep1 t__split_fields)) i16))) true) (= (contains o33 (to_rep (select t__split_fields3 i16))) true)))) (forall ((v1 Int)) (=> (and (<= 0 v1) (<= v1 2147483647)) (=> (= (contains o33 v1) true) (exists ((i16 Int)) (and (and (<= 1 i16) (<= i16 100)) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) (to_rep1 t__split_fields)) i16))) true) (= (to_rep (select t__split_fields3 i16)) v1))))))))))))
(assert (=> (= result20 true) (and (= result19 (is_add__2 o33 v o34)) (= (= result19 true) (and (and (and (not (= (contains o33 v) true)) (= (contains o34 v) true)) (= (ole o33 o34) true)) (= (included_except o34 o33 v) true))))))
...
(assert (type_invariant1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3))))
(assert (and (= o32 (position1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)) j)) (and (in_range5 o32) (= o32 (position (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) j)))))
