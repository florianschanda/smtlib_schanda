...
(assert (= value1 o2))
(assert (=> (= (bool_eq4 value1 1 1000 all_zeroes 1 1000) true) (= (temp___String_Literal_1986 Tuple0) o3)))
(assert (=> (= (bool_eq4 value1 1 1000 all_zeroes 1 1000) true) (= (mk 1 10) o4)))
(assert (=> (not (= (bool_eq4 value1 1 1000 all_zeroes 1 1000) true)) (=> (= (bool_eq4 value1 1 1000 all_ones 1 1000) true) (= (temp___String_Literal_1987 Tuple0) o3))))
(assert (=> (not (= (bool_eq4 value1 1 1000 all_zeroes 1 1000) true)) (=> (= (bool_eq4 value1 1 1000 all_ones 1 1000) true) (= (mk 1 8) o4))))
(assert (=> (not (= (bool_eq4 value1 1 1000 all_zeroes 1 1000) true)) (=> (not (= (bool_eq4 value1 1 1000 all_ones 1 1000) true)) (= (temp___String_Literal_1988 Tuple0) o3))))
