...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant1 this true true true true) (dynamic_invariant2 (length2 this) true false true true)) :pattern ((length2 this)))))
...
(define-fun dynamic_invariant3 ((temp___expr_206 us_t) (temp___is_init_202 Bool) (temp___skip_constant_203 Bool) (temp___do_toplevel_204 Bool) (temp___do_typ_inv_205 Bool)) Bool (=> (not (= temp___skip_constant_203 true)) (dynamic_property 1 2147483647 (first1 temp___expr_206) (last1 temp___expr_206))))
...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant1 this true true true true) (let ((result (value this))) (and (and (and (and (= (length result) (length2 this)) (= (first1 result) 1)) (= (last1 result) (length2 this))) (= (< 0 (length2 this)) (not (= (empty this) true)))) (dynamic_invariant3 result true false true true)))) :pattern ((value this)))))
...
(declare-const o7 t1)
(declare-const temp___1136 natural_index)
(declare-const temp___11361 natural_index)
(declare-const temp___11362 (Array Int character))
(declare-const temp___11363 t1)
(declare-const temp___1137 natural_index)
(declare-const temp___11371 natural_index)
(declare-const temp___11372 (Array Int character))
(declare-const temp___11373 t1)
(declare-const o8 natural_index)
(declare-const o9 natural_index)
(declare-const o10 (Array Int character))
(declare-const o11 t1)
(declare-const temp___1139 natural_index)
(declare-const temp___11391 natural_index)
(declare-const temp___11392 (Array Int character))
(declare-const temp___11393 t1)
(declare-const result us_split_fields__ref)
(declare-const to____split_fields3 us_split_fields)
(define-fun temp___11364 () us_rep (mk___rep (mk___split_discrs temp___1136) (mk___split_fields temp___11361 (mk___t1 temp___11362 temp___11363))))
...
(assert (= o6 o3))
(assert (= o7 o4))
(assert (= to____split_discrs (mk___split_discrs temp___1136)))
(assert (= temp___11361 o5))
(assert (= temp___11362 o6))
(assert (= temp___11363 o7))
(assert (dynamic_predicate temp___11364))
(assert (= (mk___rep (mk___split_discrs temp___1137) (mk___split_fields temp___11371 (mk___t1 temp___11372 temp___11373))) temp___11364))
...
(assert (= to____split_fields3 (mk___split_fields temp___11371 (mk___t1 temp___11372 temp___11373))))
(assert (= to____split_discrs (mk___split_discrs temp___1137)))
(assert (= (to_rep2 o8) 1))
(assert (= o8 o9))
(assert (= (rec__bounded_dynamic_strings__sequence__content to____split_fields3) (mk___t1 o10 o11)))
(assert (= to____split_discrs (mk___split_discrs temp___1139)))
(assert (= temp___11391 o9))
(assert (= temp___11392 o10))
(assert (= temp___11393 o11))
(assert (not (dynamic_predicate (mk___rep (mk___split_discrs temp___1139) (mk___split_fields temp___11391 (mk___t1 temp___11392 temp___11393))))))
(check-sat)
(exit)
