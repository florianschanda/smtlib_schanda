...
(define-fun dynamic_invariant5 ((temp___expr_74 Int) (temp___is_init_70 Bool) (temp___skip_constant_71 Bool) (temp___do_toplevel_72 Bool) (temp___do_typ_inv_73 Bool)) Bool (=> (or (= temp___is_init_70 true) (<= 0 255)) (in_range1 temp___expr_74)))
...
(assert (= (natural_indexqtint rliteral) 1))
...
(declare-const o4 t)
(declare-const o5 natural_index)
(declare-const o6 (Array Int character))
(declare-const o7 t)
(declare-const temp___1142 natural_index)
(declare-const temp___11421 natural_index)
(declare-const temp___11422 (Array Int character))
(declare-const temp___11423 t)
(declare-const temp___1143 natural_index)
(declare-const temp___11431 natural_index)
(declare-const temp___11432 (Array Int character))
(declare-const temp___11433 t)
...
(define-fun temp___11424 () us_rep (mk___rep (mk___split_discrs temp___1142) (mk___split_fields temp___11421 (mk___t temp___11422 temp___11423))))
(assert (dynamic_invariant1 i52s true false true true))
(assert (in_range5 source))
...
(assert (< 0 (to_rep1 (rec__bounded_dynamic_strings__sequence__capacity to____split_discrs))))
(assert (= (to_rep o) source))
(assert (and (<= (to_rep2 (first to____split_fields2)) 1) (<= 1 (to_rep2 (last to____split_fields2)))))
(assert (= o1 1))
(assert (= o2 (store to____split_fields1 o1 o)))
(assert (= o2 o3))
(assert (= to____split_fields2 o4))
(assert (= to____split_fields o5))
(assert (= o6 o3))
(assert (= o7 o4))
(assert (= to____split_discrs (mk___split_discrs temp___1142)))
(assert (= temp___11421 o5))
(assert (= temp___11422 o6))
(assert (= temp___11423 o7))
(assert (dynamic_predicate temp___11424))
(assert (= (mk___rep (mk___split_discrs temp___1143) (mk___split_fields temp___11431 (mk___t temp___11432 temp___11433))) temp___11424))
(assert (= (mk___split_fields__ref (mk___split_fields result (mk___t result1 result2))) (mk___split_fields__ref (mk___split_fields to____split_fields (mk___t to____split_fields1 to____split_fields2)))))
(assert (= to____split_fields3 (mk___split_fields temp___11431 (mk___t temp___11432 temp___11433))))
(assert (= to____split_discrs (mk___split_discrs temp___1143)))
(assert (not (dynamic_predicate (mk___rep to____split_discrs (mk___split_fields rliteral (rec__bounded_dynamic_strings__sequence__content to____split_fields3))))))
(check-sat)
(exit)
