...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant1 this true true true) (dynamic_invariant2 (length2 this) true false true)) :pattern ((length2 this)))))
...
(define-fun dynamic_invariant3 ((temp___expr_181 us_t) (temp___is_init_178 Bool) (temp___skip_constant_179 Bool) (temp___do_toplevel_180 Bool)) Bool (=> (not (= temp___skip_constant_179 true)) (dynamic_property 1 2147483647 (first1 temp___expr_181) (last1 temp___expr_181))))
...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant1 this true true true) (let ((result (value this))) (and (and (and (and (= (length result) (length2 this)) (= (first1 result) 1)) (= (last1 result) (length2 this))) (= (< 0 (length2 this)) (not (= (empty this) true)))) (dynamic_invariant3 result true false true)))) :pattern ((value this)))))
...
(define-fun dynamic_invariant5 ((temp___expr_63 Int) (temp___is_init_60 Bool) (temp___skip_constant_61 Bool) (temp___do_toplevel_62 Bool)) Bool (=> (or (= temp___is_init_60 true) (<= 0 255)) (in_range1 temp___expr_63)))
...
(declare-const o7 t1)
(declare-const temp___1073 natural_index)
(declare-const temp___10731 natural_index)
(declare-const temp___10732 (Array Int character))
(declare-const temp___10733 t1)
(declare-const temp___1074 natural_index)
(declare-const temp___10741 natural_index)
(declare-const temp___10742 (Array Int character))
(declare-const temp___10743 t1)
(declare-const o8 natural_index)
(declare-const o9 natural_index)
(declare-const o10 (Array Int character))
(declare-const o11 t1)
(declare-const temp___1076 natural_index)
(declare-const temp___10761 natural_index)
(declare-const temp___10762 (Array Int character))
(declare-const temp___10763 t1)
(declare-const temp___1077 natural_index)
(declare-const temp___10771 natural_index)
(declare-const temp___10772 (Array Int character))
(declare-const temp___10773 t1)
(declare-const temp___1080 us_t)
...
(assert (< 0 (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity to____split_discrs))))
(assert (= (to_rep o) source))
(assert (and (<= (to_rep1 (first2 to____split_fields2)) 1) (<= 1 (to_rep1 (last2 to____split_fields2)))))
(assert (= o1 1))
...
(assert (= o6 o3))
(assert (= o7 o4))
(assert (= to____split_discrs (mk___split_discrs temp___1073)))
(assert (= temp___10731 o5))
(assert (= temp___10732 o6))
(assert (= temp___10733 o7))
(assert (dynamic_predicate (mk___rep (mk___split_discrs temp___1073) (mk___split_fields temp___10731 (mk___t1 temp___10732 temp___10733)))))
(assert (= (mk___rep (mk___split_discrs temp___1074) (mk___split_fields temp___10741 (mk___t1 temp___10742 temp___10743))) (mk___rep (mk___split_discrs temp___1073) (mk___split_fields temp___10731 (mk___t1 temp___10732 temp___10733)))))
...
(assert (= to____split_fields3 (mk___split_fields temp___10741 (mk___t1 temp___10742 temp___10743))))
(assert (= to____split_discrs (mk___split_discrs temp___1074)))
(assert (= (to_rep2 o8) 1))
(assert (= o8 o9))
(assert (= (rec__bounded_dynamic_strings__sequence__content to____split_fields3) (mk___t1 o10 o11)))
(assert (= to____split_discrs (mk___split_discrs temp___1076)))
(assert (= temp___10761 o9))
(assert (= temp___10762 o10))
(assert (= temp___10763 o11))
(assert (not (dynamic_predicate (mk___rep (mk___split_discrs temp___1076) (mk___split_fields temp___10761 (mk___t1 temp___10762 temp___10763))))))
(check-sat)
(exit)
