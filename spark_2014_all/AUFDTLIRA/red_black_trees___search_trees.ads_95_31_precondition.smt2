...
(assert (=> (not (= (int__content i14) 0)) (= o30 (select temp___776 o29))))
(assert (=> (not (= (int__content i14) 0)) (= o31 (us_split_fields1 o30))))
