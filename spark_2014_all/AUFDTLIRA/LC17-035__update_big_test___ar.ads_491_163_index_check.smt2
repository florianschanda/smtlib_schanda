...
(assert (and (and (= (bool_eq2 a1 1 16 (temp___5471 t k (temp___5477 (select t k) j (temp___5483 (select (select t k) j) i e))) 1 16) true) (or (and (= k 16) (= k_next1 1)) (and (< k 16) (= k_next1 (+ k 1))))) (in_range3 k_next1)))
...
(assert (< k 16))
(assert (< 0 e))
(assert (and (= o6 (- e 1)) (in_range4 (- e 1))))
(assert (and (<= 1 (+ k 1)) (<= (+ k 1) 16)))
(assert (= o5 (+ k 1)))
(assert (= temp___5511 (select a o5)))
(assert (= o7 (select temp___5511 j)))
(assert (= o8 (temp___1845 o7 i o6)))
(assert (not (<= 1 (+ k 1))))
(check-sat)
(exit)
