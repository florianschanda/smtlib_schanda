...
(assert (forall ((temp___194 Int) (temp___195 Int)) (let ((temp___193 (temp___192 temp___194 temp___195))) (and (= (select temp___193 1) (of_rep temp___194)) (= (select temp___193 2) (of_rep temp___195))))))
(declare-fun temp___198 (Int Int) (Array Int integer))
(assert (forall ((temp___200 Int) (temp___201 Int)) (let ((temp___199 (temp___198 temp___200 temp___201))) (and (= (select temp___199 1) (of_rep temp___200)) (= (select temp___199 2) (of_rep temp___201))))))
(declare-fun temp___204 (Int Int) (Array Int integer))
(assert (forall ((temp___206 Int) (temp___207 Int)) (let ((temp___205 (temp___204 temp___206 temp___207))) (and (= (select temp___205 1) (of_rep temp___206)) (= (select temp___205 2) (of_rep temp___207))))))
(declare-fun temp___210 (Int Int) (Array Int integer))
(assert (forall ((temp___212 Int) (temp___213 Int)) (let ((temp___211 (temp___210 temp___212 temp___213))) (and (= (select temp___211 1) (of_rep temp___212)) (= (select temp___211 2) (of_rep temp___213))))))
(declare-fun temp___216 (Int Int) (Array Int integer))
(assert (forall ((temp___218 Int) (temp___219 Int)) (let ((temp___217 (temp___216 temp___218 temp___219))) (and (= (select temp___217 1) (of_rep temp___218)) (= (select temp___217 2) (of_rep temp___219))))))
