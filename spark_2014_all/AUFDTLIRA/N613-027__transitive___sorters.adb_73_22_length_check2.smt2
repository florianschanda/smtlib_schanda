...
(assert (not (= (ite (<= (to_rep (first2 temp___2181)) (to_rep (last2 temp___2181))) (+ (- (to_rep (last2 temp___2181)) (to_rep (first2 temp___2181))) 1) 0) (ite (<= (to_rep values_last__first) (to_rep values_last__last)) (+ (- (to_rep values_last__last) (to_rep values_last__first)) 1) 0))))
(check-sat)
(exit)
