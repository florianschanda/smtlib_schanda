...
(define-fun temp___5013 () us_rep (mk___rep (mk___split_fields temp___501 temp___5011 temp___5012)))
...
(assert (<= 0 j1))
(assert (<= j1 r1b))
(assert (and (=> (<= 0 10000) (in_range5 p_prime_index1)) (and (<= 0 j2) (<= j2 r1b))))
(assert (and (= temp___5013 (get (model__ (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields))) j2)) (= (bool_eq temp___5013 (get (model__ (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields))) j2)) true)))
...
(assert (<= (+ i1 1) j3))
(assert (<= j3 5))
(assert (not (= (to_rep2 (select f1 j3)) (to_rep2 (select f j3)))))
(check-sat)
(exit)
