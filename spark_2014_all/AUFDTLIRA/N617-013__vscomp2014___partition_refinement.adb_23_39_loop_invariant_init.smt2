...
(define-fun dynamic_invariant ((temp___expr_284 Int) (temp___is_init_280 Bool) (temp___skip_constant_281 Bool) (temp___do_toplevel_282 Bool) (temp___do_typ_inv_283 Bool)) Bool (=> (or (= temp___is_init_280 true) (<= 0 5)) (in_range3 temp___expr_284)))
...
(define-fun dynamic_invariant1 ((temp___expr_301 Int) (temp___is_init_297 Bool) (temp___skip_constant_298 Bool) (temp___do_toplevel_299 Bool) (temp___do_typ_inv_300 Bool)) Bool (=> (or (= temp___is_init_297 true) (<= 0 10000)) (in_range5 temp___expr_301)))
...
(define-fun dynamic_invariant2 ((temp___expr_332 Int) (temp___is_init_328 Bool) (temp___skip_constant_329 Bool) (temp___do_toplevel_330 Bool) (temp___do_typ_inv_331 Bool)) Bool (=> (or (= temp___is_init_328 true) (<= 0 10001)) (in_range6 temp___expr_332)))
...
(define-fun bool_eq2 ((a (Array Int partition_index)) (a__first Int) (a__last Int) (b (Array Int partition_index)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (to_rep2 (select a temp___idx_154)) (to_rep2 (select b (+ (- b__first a__first) temp___idx_154))))))) true false))
...
(declare-const temp___541 index)
(declare-const temp___5411 index)
(declare-const temp___5412 index_count)
...
(declare-const temp___542 index)
(declare-const temp___5421 index)
(declare-const temp___5422 index_count)
...
(define-fun temp___5413 () us_rep (mk___rep (mk___split_fields temp___541 temp___5411 temp___5412)))
...
(assert (and (= temp___5413 (get (model__ (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields))) j2)) (= (bool_eq temp___5413 (get (model__ (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields))) j2)) true)))
(assert (= result1 p_elem__split_fields))
(assert (= result2 p_elem__split_fields1))
(assert (= result3 p_elem__split_fields2))
(assert (= temp___541 p_elem__split_fields3))
(assert (= temp___5411 p_elem__split_fields4))
(assert (= temp___5412 p_elem__split_fields5))
...
(assert (= o2 o6))
(assert (= temp___542 o4))
(assert (= temp___5421 o5))
(assert (= temp___5422 o6))
...
(assert (= p_prime__split_fields3 (mk___split_fields temp___542 temp___5421 temp___5422)))
