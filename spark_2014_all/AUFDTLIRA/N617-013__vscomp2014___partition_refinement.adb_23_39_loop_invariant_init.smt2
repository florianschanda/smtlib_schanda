...
(define-fun dynamic_invariant ((temp___expr_257 Int) (temp___is_init_254 Bool) (temp___skip_constant_255 Bool) (temp___do_toplevel_256 Bool)) Bool (=> (or (= temp___is_init_254 true) (<= 0 5)) (in_range3 temp___expr_257)))
...
(define-fun dynamic_invariant1 ((temp___expr_272 Int) (temp___is_init_269 Bool) (temp___skip_constant_270 Bool) (temp___do_toplevel_271 Bool)) Bool (=> (or (= temp___is_init_269 true) (<= 0 10000)) (in_range5 temp___expr_272)))
...
(define-fun dynamic_invariant2 ((temp___expr_299 Int) (temp___is_init_296 Bool) (temp___skip_constant_297 Bool) (temp___do_toplevel_298 Bool)) Bool (=> (or (= temp___is_init_296 true) (<= 0 10001)) (in_range6 temp___expr_299)))
...
(define-fun bool_eq2 ((a (Array Int partition_index)) (a__first Int) (a__last Int) (b (Array Int partition_index)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_132 Int)) (=> (and (<= a__first temp___idx_132) (<= temp___idx_132 a__last)) (= (to_rep2 (select a temp___idx_132)) (to_rep2 (select b (+ (- b__first a__first) temp___idx_132))))))) true false))
...
(assert (forall ((x tindex_countB)) (! (in_range1 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(define-fun dynamic_invariant3 ((temp___expr_251 Int) (temp___is_init_248 Bool) (temp___skip_constant_249 Bool) (temp___do_toplevel_250 Bool)) Bool (=> (or (= temp___is_init_248 true) (<= 0 6)) (in_range2 temp___expr_251)))
...
(define-fun dynamic_invariant5 ((temp___expr_293 Int) (temp___is_init_290 Bool) (temp___skip_constant_291 Bool) (temp___do_toplevel_292 Bool)) Bool (=> (or (= temp___is_init_290 true) (<= (- 1) 10001)) (in_range8 temp___expr_293)))
...
(define-fun default_initial_assumption ((temp___expr_336 us_rep2) (temp___skip_top_level_337 Bool)) Bool (=> (not (= temp___skip_top_level_337 true)) (= (length1 temp___expr_336) 0)))
...
(define-fun dynamic_invariant6 ((temp___expr_278 Int) (temp___is_init_275 Bool) (temp___skip_constant_276 Bool) (temp___do_toplevel_277 Bool)) Bool (=> (or (= temp___is_init_275 true) (<= 0 10000)) (in_range9 temp___expr_278)))
...
(define-fun dynamic_invariant7 ((temp___expr_329 Int) (temp___is_init_326 Bool) (temp___skip_constant_327 Bool) (temp___do_toplevel_328 Bool)) Bool (=> (or (= temp___is_init_326 true) (<= (- 1) 10000)) (in_range10 temp___expr_329)))
...
(declare-const o17 partition_index)
(declare-const o18 Int)
(declare-const o19 partition_index)
(declare-const o20 (Array Int partition_index))
...
(assert (<= 0 j4))
(assert (<= j4 r1b))
(assert (and (=> (<= 0 10000) (in_range5 p_prime_index1)) (and (<= 0 j5) (<= j5 r1b))))
(assert (and (= (mk___rep (mk___split_fields temp___501 temp___5011 temp___5012)) (get (model__ (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields))) j5)) (= (bool_eq (mk___rep (mk___split_fields temp___501 temp___5011 temp___5012)) (get (model__ (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields))) j5)) true)))
...
(assert (<= (to_rep p_elem__split_fields5) (- (to_rep1 p_elem__split_fields4) (to_rep1 p_elem__split_fields3))))
(assert (= (to_rep o2) 0))
(assert (and (= o1 (+ (to_rep1 p_elem__split_fields3) (to_rep p_elem__split_fields5))) (in_range3 (+ (to_rep1 p_elem__split_fields3) (to_rep p_elem__split_fields5)))))
...
(assert (= result4 (mk___split_fields__ref (mk___split_fields p_prime__split_fields p_prime__split_fields1 p_prime__split_fields2))))
(assert (= p_prime__split_fields3 (mk___split_fields temp___502 temp___5021 temp___5022)))
(assert (and (= o7 (length (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields)))) (and (in_range6 o7) (<= o7 (capacity (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields)))))))
(assert (and (= o8 o7) (in_range5 o7)))
(assert (= result5 (mk_int__ref p_prime_index1)))
(assert (= p_prime_index2 o8))
(assert (= (to_rep1 (rec__partition_refinement__interval__first p_prime__split_fields3)) r3b))
(assert (in_range3 r3b))
(assert (= (to_rep1 (rec__partition_refinement__interval__last p_prime__split_fields3)) r4b))
...
(assert (<= (+ i1 1) j6))
(assert (<= j6 5))
(assert (not (= (to_rep2 (select f1 j6)) (to_rep2 (select f j6)))))
(check-sat)
(exit)
