...
(declare-const temp___717 (Array Int us_rep3))
...
(assert (= (tree_structure f) true))
(assert (and (= result (valid_root f root)) (and (= (= result true) (and (<= root (to_rep (rec__binary_trees__forest__s (us_split_fields3 f)))) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 f)) root)))) 2))) (=> (< (size f) root) (not (= result true))))))
(assert (= result true))
(assert (= (tree_structure f) true))
(assert (and (= temp___717 (model__ f root)) (and (dynamic_invariant6 temp___717 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___717 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___717 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent f i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___717 (parent f i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___717 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___717 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___717 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select temp___717 (parent f i1)))) (position f i1) (rec__tree_model__path_type__a (us_split_fields5 (select temp___717 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___717 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___717 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___717 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select temp___717 i1))) (rec__tree_model__path_type__a (us_split_fields5 (select temp___717 j)))) true)) (= j i1))))))))))))))
(assert (= (mk___rep2 (mk___split_fields2 o o1)) (select temp___717 i)))
(assert (= o o2))
(assert (= o1 o3))
(assert (= result1 o3))
(assert (= result1 true))
