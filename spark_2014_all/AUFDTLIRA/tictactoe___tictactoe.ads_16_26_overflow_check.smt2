...
(define-fun dynamic_invariant ((temp___expr_591 Int) (temp___is_init_587 Bool) (temp___skip_constant_588 Bool) (temp___do_toplevel_589 Bool) (temp___do_typ_inv_590 Bool)) Bool (=> (or (= temp___is_init_587 true) (<= 1 3)) (in_range1 temp___expr_591)))
(declare-sort slot 0)
...
(assert (forall ((x Int) (y Int)) (forall ((tictactoe__my_board (Array Int (Array Int slot)))) (! (=> (and (dynamic_invariant x true true true true) (dynamic_invariant y true true true true)) (dynamic_invariant1 (one_free_slot x y tictactoe__my_board) true false true true)) :pattern ((one_free_slot x y tictactoe__my_board))))))
(assert (forall ((x Int) (y Int)) (forall ((tictactoe__my_board (Array Int (Array Int slot)))) (! (=> (and (dynamic_invariant x true true true true) (dynamic_invariant y true true true true)) (= (one_free_slot x y tictactoe__my_board) (ite (= (to_rep (let ((temp___622 (select tictactoe__my_board x))) (select temp___622 y))) 0) 1 0))) :pattern ((one_free_slot x y tictactoe__my_board))))))
(declare-const x Int)
...
(assert (in_range1 x))
(assert (in_range1 y))
(assert (=> (<= 3 x) (=> (<= 3 y) (and (= o14 (one_free_slot 3 3 my_board)) (and (in_range o14) (= o14 (ite (= (to_rep (select (select my_board 3) 3)) 0) 1 0)))))))
(assert (=> (<= 3 x) (=> (not (<= 3 y)) (= o14 0))))
(assert (=> (<= 3 x) (=> (<= 2 y) (and (= o11 (one_free_slot 3 2 my_board)) (and (in_range o11) (= o11 (ite (= (to_rep (select (select my_board 3) 2)) 0) 1 0)))))))
(assert (=> (<= 3 x) (=> (not (<= 2 y)) (= o11 0))))
(assert (=> (<= 3 x) (and (= o12 (one_free_slot 3 1 my_board)) (and (in_range o12) (= o12 (ite (= (to_rep (select (select my_board 3) 1)) 0) 1 0))))))
(assert (=> (<= 3 x) (= o13 (+ o12 o11))))
(assert (=> (<= 3 x) (and (= o15 o13) (in_range o13))))
(assert (=> (<= 3 x) (= o16 (+ o15 o14))))
(assert (=> (<= 3 x) (and (= o17 o16) (in_range o16))))
(assert (=> (not (<= 3 x)) (= o17 0)))
(assert (=> (<= 2 x) (=> (<= 3 y) (and (= o7 (one_free_slot 2 3 my_board)) (and (in_range o7) (= o7 (ite (= (to_rep (select (select my_board 2) 3)) 0) 1 0)))))))
(assert (=> (<= 2 x) (=> (not (<= 3 y)) (= o7 0))))
(assert (=> (<= 2 x) (=> (<= 2 y) (and (= o4 (one_free_slot 2 2 my_board)) (and (in_range o4) (= o4 (ite (= (to_rep (select (select my_board 2) 2)) 0) 1 0)))))))
(assert (=> (<= 2 x) (=> (not (<= 2 y)) (= o4 0))))
(assert (=> (<= 2 x) (and (= o5 (one_free_slot 2 1 my_board)) (and (in_range o5) (= o5 (ite (= (to_rep (select (select my_board 2) 1)) 0) 1 0))))))
(assert (=> (<= 2 x) (= o6 (+ o5 o4))))
(assert (=> (<= 2 x) (and (= o8 o6) (in_range o6))))
(assert (=> (<= 2 x) (= o9 (+ o8 o7))))
(assert (=> (<= 2 x) (and (= o10 o9) (in_range o9))))
(assert (=> (not (<= 2 x)) (= o10 0)))
