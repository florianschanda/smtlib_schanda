...
(assert (forall ((c Int)) (! (=> (dynamic_invariant c true true true true) (forall ((i Int)) (=> (and (<= 0 i) (<= i 255)) (= (= (select (single_char_set c) i) true) (= i c))))) :pattern ((single_char_set c)))))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const a (Array Int Bool))
(declare-const o (Array Int Bool))
(declare-const result (Array Int Bool))
(declare-const a1 (Array Int Bool))
(assert (and (= o (single_char_set 68)) (forall ((i Int)) (=> (and (<= 0 i) (<= i 255)) (= (= (select o i) true) (= i 68))))))
(assert (= result a))
(assert (= a1 o))
