...
(assert (and (= o25 (remove o23 o24)) (and (dynamic_invariant2 o25 true false true) (and (= (invariant__ o25) true) (and (= (to_rep2 (last (rt o25))) (- (to_rep2 (last (rt o23))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o24 1))) (= (to_rep (select (elts o23) k)) (to_rep (select (elts o25) k))))) (and (forall ((k Int)) (=> (and (<= (+ o24 1) k) (<= k (to_rep2 (last (rt o23))))) (= (to_rep (select (elts o23) k)) (to_rep (select (elts o25) (- k 1)))))) (forall ((k Int)) (=> (and (<= o24 k) (<= k (- (to_rep2 (last (rt o23))) 1))) (= (to_rep (select (elts o23) (+ k 1))) (to_rep (select (elts o25) k))))))))))))
