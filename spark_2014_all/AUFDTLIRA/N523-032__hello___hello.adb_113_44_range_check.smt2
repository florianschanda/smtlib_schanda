...
(assert (not (= (length (mk___t temp___652 temp___6521)) 0)))
(assert (=> (<= (to_rep1 (first temp___6531)) (to_rep1 (last temp___6531))) (= o6 (+ (- (to_rep1 (last temp___6531)) (to_rep1 (first temp___6531))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___6531)) (to_rep1 (last temp___6531)))) (= o6 0)))
(assert (=> (<= (to_rep1 (first temp___6521)) (to_rep1 (last temp___6521))) (= o7 (+ (- (to_rep1 (last temp___6521)) (to_rep1 (first temp___6521))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___6521)) (to_rep1 (last temp___6521)))) (= o7 0)))
(assert (= o8 (+ o7 o6)))
(assert (= o9 (+ (to_rep1 (first temp___6521)) o8)))
(assert (= o10 (- o9 1)))
