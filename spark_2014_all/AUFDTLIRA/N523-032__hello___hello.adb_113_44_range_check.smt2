...
(assert (=> (<= (to_rep1 (first temp___5841)) (to_rep1 (last temp___5841))) (= o6 (+ (- (to_rep1 (last temp___5841)) (to_rep1 (first temp___5841))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___5841)) (to_rep1 (last temp___5841)))) (= o6 0)))
(assert (=> (<= (to_rep1 (first temp___5831)) (to_rep1 (last temp___5831))) (= o7 (+ (- (to_rep1 (last temp___5831)) (to_rep1 (first temp___5831))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___5831)) (to_rep1 (last temp___5831)))) (= o7 0)))
(assert (= o8 (+ o7 o6)))
