...
(assert (not (= (length (mk___t temp___645 temp___6451)) 0)))
(assert (=> (<= (to_rep1 (first temp___6461)) (to_rep1 (last temp___6461))) (= o6 (+ (- (to_rep1 (last temp___6461)) (to_rep1 (first temp___6461))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___6461)) (to_rep1 (last temp___6461)))) (= o6 0)))
(assert (=> (<= (to_rep1 (first temp___6451)) (to_rep1 (last temp___6451))) (= o7 (+ (- (to_rep1 (last temp___6451)) (to_rep1 (first temp___6451))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___6451)) (to_rep1 (last temp___6451)))) (= o7 0)))
(assert (= o8 (+ o7 o6)))
(assert (= o9 (+ (to_rep1 (first temp___6451)) o8)))
(assert (= o10 (- o9 1)))
