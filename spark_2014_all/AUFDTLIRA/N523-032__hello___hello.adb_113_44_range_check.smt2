...
(assert (not (= (length (mk___t temp___577 temp___5771)) 0)))
(assert (=> (<= (to_rep1 (first temp___5781)) (to_rep1 (last temp___5781))) (= o6 (+ (- (to_rep1 (last temp___5781)) (to_rep1 (first temp___5781))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___5781)) (to_rep1 (last temp___5781)))) (= o6 0)))
(assert (=> (<= (to_rep1 (first temp___5771)) (to_rep1 (last temp___5771))) (= o7 (+ (- (to_rep1 (last temp___5771)) (to_rep1 (first temp___5771))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___5771)) (to_rep1 (last temp___5771)))) (= o7 0)))
(assert (= o8 (+ o7 o6)))
(assert (= o9 (+ (to_rep1 (first temp___5771)) o8)))
(assert (= o10 (- o9 1)))
