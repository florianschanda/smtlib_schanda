...
(assert (=> (and (<= 1 del_line1) (<= del_line1 50)) (=> (= result3 true) (= (mk_map__ref1 result4) cur_board11))))
...
(assert (=> (not (and (<= 1 del_line1) (<= del_line1 50))) (= cur_board6 cur_board11)))
...
(assert (not (in_range9 (- to_line8 1))))
(check-sat)
(exit)
