...
(assert (and (= temp___255 (remove o26 o27)) (and (dynamic_invariant3 temp___255 true false true true) (and (= (invariant__ temp___255) true) (and (= (to_rep1 (last (rt temp___255))) (- (to_rep1 (last (rt o26))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o27 1))) (= (to_rep (select (elts o26) k)) (to_rep (select (elts temp___255) k))))) (and (forall ((k Int)) (=> (and (<= (+ o27 1) k) (<= k (to_rep1 (last (rt o26))))) (= (to_rep (select (elts o26) k)) (to_rep (select (elts temp___255) (- k 1)))))) (forall ((k Int)) (=> (and (<= o27 k) (<= k (- (to_rep1 (last (rt o26))) 1))) (= (to_rep (select (elts o26) (+ k 1))) (to_rep (select (elts temp___255) k))))))))))))
(assert (and (= o30 (- y 1)) (in_range4 (- y 1))))
...
(assert (not (<= (to_rep1 (first (rt o29))) o30)))
(check-sat)
(exit)
