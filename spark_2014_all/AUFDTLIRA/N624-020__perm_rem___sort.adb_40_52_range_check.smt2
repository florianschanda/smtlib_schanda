...
(assert (and (= (mk___t o29 o30) (remove (mk___t interm1 (mk 1 100)) o28)) (and (dynamic_invariant4 (mk___t o29 o30) true false true) (and (= (invariant__ (mk___t o29 o30)) true) (and (= (to_rep1 (last o30)) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o28 1))) (= (to_rep (select interm1 k)) (to_rep (select o29 k))))) (and (forall ((k Int)) (=> (and (<= (+ o28 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select interm1 k)) (to_rep (select o29 (- k 1)))))) (forall ((k Int)) (=> (and (<= o28 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select interm1 (+ k 1))) (to_rep (select o29 k))))))))))))
(assert (and (= (mk___t temp___246 temp___2461) (remove (mk___t o29 o30) o31)) (and (dynamic_invariant4 (mk___t temp___246 temp___2461) true false true) (and (= (invariant__ (mk___t temp___246 temp___2461)) true) (and (= (to_rep1 (last temp___2461)) (- (to_rep1 (last o30)) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o31 1))) (= (to_rep (select o29 k)) (to_rep (select temp___246 k))))) (and (forall ((k Int)) (=> (and (<= (+ o31 1) k) (<= k (to_rep1 (last o30)))) (= (to_rep (select o29 k)) (to_rep (select temp___246 (- k 1)))))) (forall ((k Int)) (=> (and (<= o31 k) (<= k (- (to_rep1 (last o30)) 1))) (= (to_rep (select o29 (+ k 1))) (to_rep (select temp___246 k))))))))))))
