...
(assert (= (= o32 true) (forall ((index11 Int)) (=> (and (<= (to_rep1 (first (rt source))) index11) (<= index11 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index11))) true)))))
(assert (= (length source) 10))
(assert (and (= temp___1240 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1240) (<= temp___1240 (to_rep1 (last (rt source))))))
(assert (= o28 temp___1240))
(assert (= o29 (select (elts source) o28)))
(assert (= o30 (to_rep o29)))
(assert (= o31 (ite (< o30 52) true false)))
(assert (and (= temp___1239 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1239) (<= temp___1239 (to_rep1 (last (rt source))))))
(assert (= o24 temp___1239))
