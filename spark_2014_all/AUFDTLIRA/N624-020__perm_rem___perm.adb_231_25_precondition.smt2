...
(assert (and (= (mk___t o36 o37) (remove (mk___t o33 o34) o35)) (and (dynamic_invariant2 (mk___t o36 o37) true false true) (and (= (invariant__ (mk___t o36 o37)) true) (and (= (to_rep2 (last o37)) (- (to_rep2 (last o34)) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- o35 1))) (= (to_rep (select o33 k1)) (to_rep (select o36 k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ o35 1) k1) (<= k1 (to_rep2 (last o34)))) (= (to_rep (select o33 k1)) (to_rep (select o36 (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= o35 k1) (<= k1 (- (to_rep2 (last o34)) 1))) (= (to_rep (select o33 (+ k1 1))) (to_rep (select o36 k1))))))))))))
(assert (not (= (invariant__ (mk___t o36 o37)) true)))
(check-sat)
(exit)
