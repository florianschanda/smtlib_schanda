...
(assert (= (slide (concat1 temp___229 6 10 temp___230 1 5) 6 1) temp___231))
(assert (= (mk1 1 o12) temp___2311))
(assert (= (ite (<= (to_rep (first2 temp___2311)) (to_rep (last2 temp___2311))) (+ (- (to_rep (last2 temp___2311)) (to_rep (first2 temp___2311))) 1) 0) (ite (<= 1 10) (+ (- 10 1) 1) 0)))
(assert (= o13 (slide temp___231 (to_rep (first2 temp___2311)) 1)))
