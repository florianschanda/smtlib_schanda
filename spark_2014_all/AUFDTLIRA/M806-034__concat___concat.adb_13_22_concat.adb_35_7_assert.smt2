...
(assert (= (ite (<= (to_rep (first temp___1961)) (to_rep (last temp___1961))) (+ (- (to_rep (last temp___1961)) (to_rep (first temp___1961))) 1) 0) (ite (<= 1 10) (+ (- 10 1) 1) 0)))
(assert (= o6 (slide temp___196 (to_rep (first temp___1961)) 1)))
(assert (= (mk_map__ref result) (mk_map__ref d)))
(assert (= d2 o6))
(assert (= (to_rep (select d2 1)) (to_rep (select x 6))))
(assert (= (to_rep (select d2 6)) (to_rep (select x 1))))
(assert (=> (<= 1 5) (and (and (<= 1 1) (<= 1 10)) (and (<= 1 5) (<= 5 10)))))
(assert (= temp___202 y))
(assert (=> (<= 6 10) (and (and (<= 1 6) (<= 6 10)) (and (<= 1 10) (<= 10 10)))))
(assert (= temp___201 y))
(assert (=> (<= 1 5) (= o7 (+ (- 5 1) 1))))
(assert (=> (not (<= 1 5)) (= o7 0)))
(assert (=> (<= 6 10) (= o8 (+ (- 10 6) 1))))
(assert (=> (not (<= 6 10)) (= o8 0)))
(assert (= o9 (+ o8 o7)))
(assert (= o10 (+ 1 o9)))
(assert (= o11 (- o10 1)))
(assert (and (= o12 o11) (in_range1 o11)))
(assert (= (slide (concat1 temp___201 6 10 temp___202 1 5) 6 1) temp___203))
(assert (= (mk1 1 o12) temp___2031))
(assert (= (ite (<= (to_rep (first2 temp___2031)) (to_rep (last2 temp___2031))) (+ (- (to_rep (last2 temp___2031)) (to_rep (first2 temp___2031))) 1) 0) (ite (<= 1 10) (+ (- 10 1) 1) 0)))
(assert (= o13 (slide temp___203 (to_rep (first2 temp___2031)) 1)))
(assert (= (mk_map__ref result1) (mk_map__ref d1)))
(assert (= d3 o13))
(assert (not (= (to_rep (select d3 1)) (to_rep (select y 6)))))
(check-sat)
(exit)
