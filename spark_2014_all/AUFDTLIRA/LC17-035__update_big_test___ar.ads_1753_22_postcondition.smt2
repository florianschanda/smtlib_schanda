...
(assert (= a2 a3))
(assert (= a4 a2))
(assert (not (= (bool_eq3 a3 90 99 (temp_____aggregate_def_3957 a i (mk___rep (mk___split_fields (temp_____aggregate_def_3979 (rec__ar__rofa4__s4 (us_split_fields1 (select a i))) k f) (temp_____aggregate_def_3964 (rec__ar__rofa4__t4 (us_split_fields1 (select a i))) j (temp_____aggregate_def_3971 (select (rec__ar__rofa4__t4 (us_split_fields1 (select a i))) j) k e))))) 90 99) true)))
(check-sat)
(exit)
