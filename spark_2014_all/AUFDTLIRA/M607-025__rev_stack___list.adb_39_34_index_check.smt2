...
(assert (= result6 true))
(assert (and (= temp___530 (to__ (mk___rep (us_split_fields__content s__split_fields7)))) (and (dynamic_invariant1 temp___530 true false true true) (and (= (to_rep (first (rt temp___530))) 1) (<= 0 (to_rep (last (rt temp___530))))))))
(assert (and (<= (to_rep (first (rt temp___530))) j) (<= j (to_rep (last (rt temp___530))))))
(assert (= o6 j))
(assert (= o7 (select (elts temp___530) o6)))
(assert (= o8 (to_rep o7)))
(assert (and (= temp___528 (to__ (mk___rep s__split_fields9))) (and (dynamic_invariant1 temp___528 true false true true) (and (= (to_rep (first (rt temp___528))) 1) (<= 0 (to_rep (last (rt temp___528))))))))
(assert (not (<= (to_rep (first (rt temp___528))) j)))
(check-sat)
(exit)
