...
(assert (= result7 true))
(assert (and (= o23 (- last5 i13)) (in_range1 (- last5 i13))))
(assert (= o24 (+ o23 1)))
(assert (and (= o25 o24) (in_range1 o24)))
(assert (= o26 (ite (<= j2 o25) true false)))
(assert (= result9 (ite (<= 1 j2) o26 false)))
(assert (= result9 true))
(assert (and (= temp___484 (to__ (mk___rep (us_split_fields__content s__split_fields10)))) (and (dynamic_invariant1 temp___484 true false true) (and (= (to_rep (first (rt temp___484))) 1) (<= 0 (to_rep (last (rt temp___484))))))))
(assert (and (<= (to_rep (first (rt temp___484))) j2) (<= j2 (to_rep (last (rt temp___484))))))
(assert (= o27 j2))
(assert (= o28 (select (elts temp___484) o27)))
(assert (= o29 (to_rep o28)))
(assert (and (= temp___482 (to__ (mk___rep s__split_fields12))) (and (dynamic_invariant1 temp___482 true false true) (and (= (to_rep (first (rt temp___482))) 1) (<= 0 (to_rep (last (rt temp___482))))))))
(assert (not (<= (to_rep (first (rt temp___482))) j2)))
(check-sat)
(exit)
