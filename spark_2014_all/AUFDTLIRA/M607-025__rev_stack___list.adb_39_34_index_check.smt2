...
(assert (and (= o15 (length2 (mk___rep1 res__split_discrs res__split_fields2))) (and (in_range6 o15) (<= o15 (capacity (mk___rep1 res__split_discrs res__split_fields2))))))
...
(assert (=> (= result5 true) (and (= o9 (to__ (mk___rep s__split_fields9))) (and (dynamic_invariant1 o9 true false true) (and (= (to_rep (first (rt o9))) 1) (<= 0 (to_rep (last (rt o9)))))))))
...
(assert (= result6 true))
(assert (and (= temp___484 (to__ (mk___rep (us_split_fields__content s__split_fields7)))) (and (dynamic_invariant1 temp___484 true false true) (and (= (to_rep (first (rt temp___484))) 1) (<= 0 (to_rep (last (rt temp___484))))))))
(assert (and (<= (to_rep (first (rt temp___484))) j) (<= j (to_rep (last (rt temp___484))))))
(assert (= o6 j))
(assert (= o7 (select (elts temp___484) o6)))
(assert (= o8 (to_rep o7)))
(assert (and (= temp___482 (to__ (mk___rep s__split_fields9))) (and (dynamic_invariant1 temp___482 true false true) (and (= (to_rep (first (rt temp___482))) 1) (<= 0 (to_rep (last (rt temp___482))))))))
(assert (not (<= (to_rep (first (rt temp___482))) j)))
(check-sat)
(exit)
