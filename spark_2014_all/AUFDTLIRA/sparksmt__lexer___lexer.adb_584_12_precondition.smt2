...
(assert (forall ((us_void_param tuple0)) (! (= (to_rep (select (temp___String_Literal_883 us_void_param) 1)) 58) :pattern ((temp___String_Literal_883 us_void_param)))))
(declare-fun temp___String_Literal_884 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (= (to_rep (select (temp___String_Literal_884 us_void_param) 1)) 58) :pattern ((temp___String_Literal_884 us_void_param)))))
(declare-fun temp___String_Literal_885 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_885 us_void_param) 1)) 58) (= (to_rep (select (temp___String_Literal_885 us_void_param) 2)) 32)) :pattern ((temp___String_Literal_885 us_void_param)))))
