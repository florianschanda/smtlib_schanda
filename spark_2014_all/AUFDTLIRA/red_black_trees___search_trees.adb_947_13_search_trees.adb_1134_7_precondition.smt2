...
(assert (and (= o7 (to_rep1 (rec__search_trees__search_tree__root t__split_fields5))) (in_range3 (to_rep1 (rec__search_trees__search_tree__root t__split_fields5)))))
(assert (not (= (valid_root (mk___rep2 f_old__split_fields2) o7) true)))
(check-sat)
(exit)
