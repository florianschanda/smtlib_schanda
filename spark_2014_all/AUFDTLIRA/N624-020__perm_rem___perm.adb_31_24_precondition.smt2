...
(assert (= result3 true))
(assert (and (= o8 kb) (in_range3 kb)))
(assert (and (= o17 (remove b o8)) (and (dynamic_invariant o17 true false true true) (and (= (invariant__ o17) true) (and (= (to_rep1 (last o10)) (- (to_rep1 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o8 1))) (= (to_rep (select (elts b) k)) (to_rep (select o9 k))))) (and (forall ((k Int)) (=> (and (<= (+ o8 1) k) (<= k (to_rep1 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select o9 (- k 1)))))) (forall ((k Int)) (=> (and (<= o8 k) (<= k (- (to_rep1 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o9 k))))))))))))
