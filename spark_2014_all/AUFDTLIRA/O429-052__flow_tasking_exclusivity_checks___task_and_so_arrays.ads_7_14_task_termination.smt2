...
(define-fun dynamic_invariant ((temp___expr_1473 Int) (temp___is_init_1470 Bool) (temp___skip_constant_1471 Bool) (temp___do_toplevel_1472 Bool)) Bool (=> (or (= temp___is_init_1470 true) (<= 0 2)) (in_range temp___expr_1473)))
...
(declare-const temp___1497 (Array Int us_rep))
...
(assert (in_range id))
(assert (= temp___1497 sos))
(assert (= o (select temp___1497 id)))
(assert (= o ada__synchronous_task_control__suspend_until_true__s))
(assert (= result sos))
(assert (= sos1 (store sos id ada__synchronous_task_control__suspend_until_true__s1)))
(assert (not false))
(check-sat)
(exit)
