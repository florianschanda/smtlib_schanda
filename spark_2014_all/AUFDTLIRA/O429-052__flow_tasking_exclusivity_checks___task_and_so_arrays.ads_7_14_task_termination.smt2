...
(define-fun dynamic_invariant ((temp___expr_1649 Int) (temp___is_init_1645 Bool) (temp___skip_constant_1646 Bool) (temp___do_toplevel_1647 Bool) (temp___do_typ_inv_1648 Bool)) Bool (=> (or (= temp___is_init_1645 true) (<= 0 2)) (in_range temp___expr_1649)))
...
(declare-const temp___1674 (Array Int us_rep))
...
(assert (not (not (and (in_range id) (and (and (and (= temp___1674 sos) (= o (select temp___1674 id))) (= o ada__synchronous_task_control__suspend_until_true__s)) (and (= result sos) (= sos1 (store sos id ada__synchronous_task_control__suspend_until_true__s1))))))))
(check-sat)
(exit)
