...
(define-fun dynamic_invariant ((temp___expr_1483 Int) (temp___is_init_1480 Bool) (temp___skip_constant_1481 Bool) (temp___do_toplevel_1482 Bool)) Bool (=> (or (= temp___is_init_1480 true) (<= 0 2)) (in_range temp___expr_1483)))
...
(assert (not (not (and (in_range id) (and (and (and (= temp___1507 sos) (= o (select temp___1507 id))) (= o ada__synchronous_task_control__suspend_until_true__s)) (and (= result sos) (= sos1 (store sos id ada__synchronous_task_control__suspend_until_true__s1))))))))
(check-sat)
(exit)
