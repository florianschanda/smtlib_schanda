...
(assert (= (to_rep2 (first2 (rt1 (temp___245 0 1 temp___267)))) 1))
(assert (= (to_rep2 (last2 (rt1 (temp___245 0 1 temp___267)))) temp___267))
(assert (= (mk___t1 temp___269 temp___2691) (temp___245 0 1 temp___267)))
(assert (not (= (ite (<= (to_rep2 (first2 temp___2691)) (to_rep2 (last2 temp___2691))) (+ (- (to_rep2 (last2 temp___2691)) (to_rep2 (first2 temp___2691))) 1) 0) (ite (<= 1 temp___267) (+ (- temp___267 1) 1) 0))))
(check-sat)
(exit)
