...
(assert (and (= o41 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields5)))) (in_range4 o41)))
(assert (= result2 (ite (= o41 1) true false)))
(assert (=> (= result2 true) (= o45 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields5))))))
(assert (=> (= result2 true) (= o46 (ite (not (= o45 true)) true false))))
(assert (=> (= result2 true) (and (= o42 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields5)))) (in_range6 o42))))
(assert (=> (= result2 true) (= o43 (ite (= o42 3) true false))))
(assert (=> (= result2 true) (= o44 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields5))))))
...
(assert (and (= o36 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields5)))) (in_range6 o36)))
(assert (= o37 (ite (= o36 3) true false)))
(assert (= o38 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields5)))))
(assert (= result3 (ite (= o38 true) o37 false)))
(assert (=> (= result3 true) (and (= o39 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields5)))) (in_range4 o39))))
...
(assert (=> (= result4 true) (and (= o32 (theauthcertrole (us_private__content state20))) (in_range4 o32))))
(assert (=> (= result4 true) (= o33 (ite (= o32 1) true false))))
(assert (=> (= result4 true) (= o30 (authcertvalid (us_private__content state20)))))
(assert (=> (= result4 true) (= o31 (isgood (us_private__content state20)))))
...
(assert (and (= o21 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields5)))) (in_range4 o21)))
(assert (= result5 (ite (= o21 1) true false)))
(assert (=> (= result5 true) (and (= o24 (theauthcertrole (us_private__content state20))) (in_range4 o24))))
(assert (=> (= result5 true) (= o25 (ite (= o24 1) true false))))
(assert (=> (= result5 true) (= o22 (authcertvalid (us_private__content state20)))))
(assert (=> (= result5 true) (= o23 (isgood (us_private__content state20)))))
...
(assert (and (= o16 (thedooralarm (us_private__content state22))) (in_range15 o16)))
...
(assert (and (= o2 (thecurrentdoor (us_private__content state22))) (in_range14 o2)))
