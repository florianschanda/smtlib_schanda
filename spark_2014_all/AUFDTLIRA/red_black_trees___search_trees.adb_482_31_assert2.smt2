...
(assert (not (not (= (olt (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) i2))) (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) j1)))) true))))
(check-sat)
(exit)
