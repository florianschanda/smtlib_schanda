...
(declare-fun temp___217 (Int) (Array Int integer))
...
(assert (forall ((temp___219 Int)) (=> (dynamic_invariant temp___219 true true true true) (= (to_rep (select (temp___217 temp___219) 1)) temp___219))))
