...
(define-fun dynamic_invariant ((temp___expr_172 us_t) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool)) Bool (=> (not (= temp___skip_constant_170 true)) (dynamic_property 1 2147483647 (first1 temp___expr_172) (last1 temp___expr_172))))
...
(define-fun bool_eq2 ((a (Array Int cardindex)) (a__first Int) (a__last Int) (b (Array Int cardindex)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_133 Int)) (=> (and (<= a__first temp___idx_133) (<= temp___idx_133 a__last)) (= (to_rep2 (select a temp___idx_133)) (to_rep2 (select b (+ (- b__first a__first) temp___idx_133))))))) true false))
(assert (forall ((a (Array Int cardindex)) (b (Array Int cardindex))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq2 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_133 Int)) (=> (and (<= a__first temp___idx_133) (<= temp___idx_133 a__last)) (= (to_rep2 (select a temp___idx_133)) (to_rep2 (select b (+ (- b__first a__first) temp___idx_133)))))))))))
(declare-fun compare1 ((Array Int cardindex) Int Int (Array Int cardindex) Int Int) Int)
(assert (forall ((a (Array Int cardindex)) (b (Array Int cardindex))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare1 a a_first a_last b b_first b_last) 0) (= (bool_eq2 a a_first a_last b b_first b_last) true)) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int cardindex)) (b (Array Int cardindex))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare1 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq2 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep2 (select a (+ i 1))) (to_rep2 (select b (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int cardindex)) (b (Array Int cardindex))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare1 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq2 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep2 (select b (+ i 1))) (to_rep2 (select a (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
...
(define-fun bool_eq3 ((a (Array Int (Array Int cardindex))) (a__first Int) (a__last Int) (b (Array Int (Array Int cardindex))) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_134 Int)) (=> (and (<= a__first temp___idx_134) (<= temp___idx_134 a__last)) (= (bool_eq2 (select a temp___idx_134) 0 99 (select b (+ (- b__first a__first) temp___idx_134)) 0 99) true)))) true false))
(assert (forall ((a (Array Int (Array Int cardindex))) (b (Array Int (Array Int cardindex)))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq3 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_134 Int)) (=> (and (<= a__first temp___idx_134) (<= temp___idx_134 a__last)) (= (bool_eq2 (select a temp___idx_134) 0 99 (select b (+ (- b__first a__first) temp___idx_134)) 0 99) true))))))))
...
(assert (forall ((temp___137 Int)) (forall ((temp___138 Int)) (= (select (temp___135 temp___137) temp___138) (of_rep temp___137)))))
(declare-fun temp___139 (Int) (Array Int cardindex))
(assert (forall ((temp___141 Int)) (forall ((temp___142 Int)) (= (select (temp___139 temp___141) temp___142) (of_rep2 temp___141)))))
(declare-fun temp___143 ((Array Int cardindex)) (Array Int (Array Int cardindex)))
(assert (forall ((temp___145 (Array Int cardindex))) (forall ((temp___146 Int)) (= (select (temp___143 temp___145) temp___146) temp___145))))
(declare-fun temp___147 (Int) (Array Int cardindex))
(assert (forall ((temp___149 Int)) (forall ((temp___150 Int)) (= (select (temp___147 temp___149) temp___150) (of_rep2 temp___149)))))
(declare-fun temp___151 (Int) (Array Int cardindex))
(assert (forall ((temp___153 Int)) (forall ((temp___154 Int)) (= (select (temp___151 temp___153) temp___154) (of_rep2 temp___153)))))
...
(assert (forall ((temp___161 Int)) (forall ((temp___162 Int)) (= (select (temp___159 temp___161) temp___162) (of_rep2 temp___161)))))
(declare-fun inv (us_rep) Bool)
(declare-fun inv__function_guard (Bool us_rep) Bool)
(assert true)
(assert (forall ((s us_rep)) (! (= (= (inv s) true) (and (and (and (and (and (and (and (and (and (<= 0 (to_rep2 (rec__patience__state__numstacks (us_split_fields1 s)))) (<= (to_rep2 (rec__patience__state__numstacks (us_split_fields1 s))) (to_rep2 (rec__patience__state__numelts (us_split_fields1 s))))) (<= (to_rep2 (rec__patience__state__numelts (us_split_fields1 s))) 100)) (or (= (to_rep2 (rec__patience__state__numelts (us_split_fields1 s))) 0) (< 0 (to_rep2 (rec__patience__state__numstacks (us_split_fields1 s)))))) (forall ((i Int)) (=> (and (<= 0 i) (<= i (- (to_rep2 (rec__patience__state__numstacks (us_split_fields1 s))) 1))) (and (and (<= 1 (to_rep2 (let ((temp___306 (rec__patience__state__stacksizes (us_split_fields1 s)))) (select temp___306 i)))) (<= (to_rep2 (let ((temp___307 (rec__patience__state__stacksizes (us_split_fields1 s)))) (select temp___307 i))) (to_rep2 (rec__patience__state__numelts (us_split_fields1 s))))) (forall ((j Int)) (=> (and (<= 0 j) (<= j (- (to_rep2 (let ((temp___308 (rec__patience__state__stacksizes (us_split_fields1 s)))) (select temp___308 i))) 1))) (and (<= 0 (to_rep2 (let ((temp___310 (let ((temp___309 (rec__patience__state__stacks (us_split_fields1 s)))) (select temp___309 i)))) (select temp___310 j)))) (< (to_rep2 (let ((temp___312 (let ((temp___311 (rec__patience__state__stacks (us_split_fields1 s)))) (select temp___311 i)))) (select temp___312 j))) (to_rep2 (rec__patience__state__numelts (us_split_fields1 s))))))))))) (forall ((i Int)) (=> (and (<= 0 i) (<= i (- (to_rep2 (rec__patience__state__numelts (us_split_fields1 s))) 1))) (and (and (and (<= 0 (to_rep2 (let ((temp___313 (rec__patience__state__posstack (us_split_fields1 s)))) (select temp___313 i)))) (<= (to_rep2 (let ((temp___313 (rec__patience__state__posstack (us_split_fields1 s)))) (select temp___313 i))) (- (to_rep2 (rec__patience__state__numstacks (us_split_fields1 s))) 1))) (and (<= 0 (to_rep2 (let ((temp___314 (rec__patience__state__posheight (us_split_fields1 s)))) (select temp___314 i)))) (<= (to_rep2 (let ((temp___314 (rec__patience__state__posheight (us_split_fields1 s)))) (select temp___314 i))) (- (to_rep2 (let ((temp___315 (rec__patience__state__stacksizes (us_split_fields1 s)))) (select temp___315 (to_rep2 (let ((temp___316 (rec__patience__state__posstack (us_split_fields1 s)))) (select temp___316 i)))))) 1)))) (= (to_rep2 (let ((temp___319 (let ((temp___317 (rec__patience__state__stacks (us_split_fields1 s)))) (select temp___317 (to_rep2 (let ((temp___318 (rec__patience__state__posstack (us_split_fields1 s)))) (select temp___318 i))))))) (select temp___319 (to_rep2 (let ((temp___320 (rec__patience__state__posheight (us_split_fields1 s)))) (select temp___320 i)))))) i))))) (forall ((ist Int)) (=> (and (<= 0 ist) (<= ist (- (to_rep2 (rec__patience__state__numstacks (us_split_fields1 s))) 1))) (forall ((ip Int)) (=> (and (<= 0 ip) (<= ip (- (to_rep2 (let ((temp___321 (rec__patience__state__stacksizes (us_split_fields1 s)))) (select temp___321 ist))) 1))) (and (= ist (to_rep2 (let ((temp___322 (rec__patience__state__posstack (us_split_fields1 s)))) (select temp___322 (to_rep2 (let ((temp___324 (let ((temp___323 (rec__patience__state__stacks (us_split_fields1 s)))) (select temp___323 ist)))) (select temp___324 ip))))))) (= ip (to_rep2 (let ((temp___325 (rec__patience__state__posheight (us_split_fields1 s)))) (select temp___325 (to_rep2 (let ((temp___327 (let ((temp___326 (rec__patience__state__stacks (us_split_fields1 s)))) (select temp___326 ist)))) (select temp___327 ip))))))))))))) (forall ((i Int)) (=> (and (<= 0 i) (<= i (- (to_rep2 (rec__patience__state__numstacks (us_split_fields1 s))) 1))) (forall ((j Int)) (=> (and (<= 0 j) (<= j (- (to_rep2 (let ((temp___328 (rec__patience__state__stacksizes (us_split_fields1 s)))) (select temp___328 i))) 2))) (forall ((k Int)) (=> (and (<= (+ j 1) k) (<= k (- (to_rep2 (let ((temp___329 (rec__patience__state__stacksizes (us_split_fields1 s)))) (select temp___329 i))) 1))) (< (to_rep2 (let ((temp___331 (let ((temp___330 (rec__patience__state__stacks (us_split_fields1 s)))) (select temp___330 i)))) (select temp___331 j))) (to_rep2 (let ((temp___333 (let ((temp___332 (rec__patience__state__stacks (us_split_fields1 s)))) (select temp___332 i)))) (select temp___333 k))))))))))) (forall ((i Int)) (=> (and (<= 0 i) (<= i (- (to_rep2 (rec__patience__state__numstacks (us_split_fields1 s))) 1))) (forall ((j Int)) (=> (and (<= 0 j) (<= j (- (to_rep2 (let ((temp___334 (rec__patience__state__stacksizes (us_split_fields1 s)))) (select temp___334 i))) 2))) (forall ((k Int)) (=> (and (<= (+ j 1) k) (<= k (- (to_rep2 (let ((temp___335 (rec__patience__state__stacksizes (us_split_fields1 s)))) (select temp___335 i))) 1))) (<= (to_rep (let ((temp___339 (rec__patience__state__values (us_split_fields1 s)))) (select temp___339 (to_rep2 (let ((temp___341 (let ((temp___340 (rec__patience__state__stacks (us_split_fields1 s)))) (select temp___340 i)))) (select temp___341 k)))))) (to_rep (let ((temp___336 (rec__patience__state__values (us_split_fields1 s)))) (select temp___336 (to_rep2 (let ((temp___338 (let ((temp___337 (rec__patience__state__stacks (us_split_fields1 s)))) (select temp___337 i)))) (select temp___338 j)))))))))))))) (forall ((i Int)) (=> (and (<= 0 i) (<= i (- (to_rep2 (rec__patience__state__numelts (us_split_fields1 s))) 1))) (and (and (and (<= (- 1) (to_rep2 (let ((temp___342 (rec__patience__state__preds (us_split_fields1 s)))) (select temp___342 i)))) (<= (to_rep2 (let ((temp___342 (rec__patience__state__preds (us_split_fields1 s)))) (select temp___342 i))) (- (to_rep2 (rec__patience__state__numelts (us_split_fields1 s))) 1))) (< (to_rep2 (let ((temp___343 (rec__patience__state__preds (us_split_fields1 s)))) (select temp___343 i))) i)) (ite (< (to_rep2 (let ((temp___352 (rec__patience__state__preds (us_split_fields1 s)))) (select temp___352 i))) 0) (= (to_rep2 (let ((temp___344 (rec__patience__state__posstack (us_split_fields1 s)))) (select temp___344 i))) 0) (and (and (< (to_rep (let ((temp___345 (rec__patience__state__values (us_split_fields1 s)))) (select temp___345 (to_rep2 (let ((temp___346 (rec__patience__state__preds (us_split_fields1 s)))) (select temp___346 i)))))) (to_rep (let ((temp___347 (rec__patience__state__values (us_split_fields1 s)))) (select temp___347 i)))) (< 0 (to_rep2 (let ((temp___348 (rec__patience__state__posstack (us_split_fields1 s)))) (select temp___348 i))))) (= (to_rep2 (let ((temp___349 (rec__patience__state__posstack (us_split_fields1 s)))) (select temp___349 (to_rep2 (let ((temp___350 (rec__patience__state__preds (us_split_fields1 s)))) (select temp___350 i)))))) (- (to_rep2 (let ((temp___351 (rec__patience__state__posstack (us_split_fields1 s)))) (select temp___351 i))) 1))))))))) :pattern ((inv s)))))
...
(define-fun dynamic_invariant3 ((temp___expr_166 Int) (temp___is_init_163 Bool) (temp___skip_constant_164 Bool) (temp___do_toplevel_165 Bool)) Bool (=> (or (= temp___is_init_163 true) (<= 1 52)) (in_range2 temp___expr_166)))
(define-fun dynamic_invariant4 ((temp___expr_177 Int) (temp___is_init_174 Bool) (temp___skip_constant_175 Bool) (temp___do_toplevel_176 Bool)) Bool (=> (or (= temp___is_init_174 true) (<= (- 1) 100)) (in_range4 temp___expr_177)))
(assert (= null_state (mk___rep (mk___split_fields (of_rep2 0) (temp___135 1) (of_rep2 0) (temp___139 (- 1)) (temp___143 (temp___147 (- 1))) (temp___151 (- 1)) (temp___155 (- 1)) (temp___159 (- 1))))))
...
(declare-const i Int)
(declare-const patience__playgame__result cardindex)
(declare-const patience__playgame__result1 (Array Int card))
(declare-const patience__playgame__result2 cardindex)
(declare-const patience__playgame__result3 (Array Int cardindex))
(declare-const patience__playgame__result4 (Array Int (Array Int cardindex)))
(declare-const patience__playgame__result5 (Array Int cardindex))
(declare-const patience__playgame__result6 (Array Int cardindex))
(declare-const patience__playgame__result7 (Array Int cardindex))
...
(declare-const temp___827 cardindex)
(declare-const temp___8271 (Array Int card))
(declare-const temp___8272 cardindex)
(declare-const temp___8273 (Array Int cardindex))
(declare-const temp___8274 (Array Int (Array Int cardindex)))
(declare-const temp___8275 (Array Int cardindex))
(declare-const temp___8276 (Array Int cardindex))
(declare-const temp___8277 (Array Int cardindex))
...
(declare-const result10 state__ref)
(declare-const patience__playgame__result8 us_rep)
(declare-const patience__playgame__result9 state__ref)
(declare-const patience__playgame__result10 us_rep)
(declare-const s__split_fields36 us_split_fields__ref)
(declare-const i8 int__ref)
(declare-const patience__playgame__result11 state__ref)
(declare-const s__split_fields37 us_split_fields)
(declare-const i9 Int)
(declare-const patience__playgame__result12 us_rep)
(assert (= (to_rep2 o) 0))
(assert (= (to_rep2 o1) 0))
(assert (= o1 o2))
...
(assert (= (mk___rep (mk___split_fields temp___839 temp___8391 temp___8392 temp___8393 temp___8394 temp___8395 temp___8396 temp___8397)) null_state))
...
(assert (not (= (to_rep2 s__split_fields8) (- i1 (to_rep1 (first (rt cards)))))))
(check-sat)
(exit)
