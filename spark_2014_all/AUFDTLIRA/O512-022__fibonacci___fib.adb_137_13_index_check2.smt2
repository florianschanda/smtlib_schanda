...
(assert (in_range2 k1))
(assert (in_range2 k2))
(assert (and (= k1 k2) (and (<= 0 k1) (and (<= k1 100) (and (<= 0 k2) (and (<= k2 100) (and (forall ((i17 Int)) (=> (and (<= 0 i17) (<= i17 k1)) (= (to_rep (select b1 i17)) (to_rep (select b2 i17))))) (forall ((i17 Int)) (=> (and (<= (+ k1 1) i17) (<= i17 100)) (= (to_rep (select c1 (- i17 k1))) (to_rep (select c2 (- i17 k2)))))))))))))
(assert (= (mk_int__ref result) (mk_int__ref i)))
(assert (= i3 0))
(assert (=> (and (<= 0 i3) (<= i3 k1)) (= temp___220 a1)))
(assert (=> (and (<= 0 i3) (<= i3 k1)) (and (forall ((temp___221 Int)) (=> (and (<= 0 temp___221) (<= temp___221 100)) (=> (or (< k1 temp___221) (or (< temp___221 0) (<= i4 temp___221))) (= (select a12 temp___221) (select temp___220 temp___221))))) (and (<= 0 i4) (<= i4 k1)))))
...
(assert (=> (and (<= 0 i3) (<= i3 k1)) (= (mk_int__ref i7) (mk_int__ref i5))))
...
(assert (and (= temp___222 (+ k1 1)) (in_range1 (+ k1 1))))
(assert (= (mk_int__ref result2) (mk_int__ref i1)))
(assert (= i9 temp___222))
(assert (=> (and (<= temp___222 i9) (<= i9 0)) (= temp___225 a16)))
(assert (=> (and (<= temp___222 i9) (<= i9 0)) (and (forall ((temp___226 Int)) (=> (and (<= 0 temp___226) (<= temp___226 100)) (=> (or (< 0 temp___226) (or (< temp___226 temp___222) (<= i10 temp___226))) (= (select a18 temp___226) (select temp___225 temp___226))))) (and (<= (+ k1 1) i10) (<= i10 0)))))
(assert (=> (and (<= temp___222 i9) (<= i9 0)) (and (= temp___224 (- i10 k1)) (in_range1 (- i10 k1)))))
(assert (=> (and (<= temp___222 i9) (<= i9 0)) (and (<= 0 temp___224) (<= temp___224 100))))
(assert (=> (and (<= temp___222 i9) (<= i9 0)) (= o6 temp___224)))
(assert (=> (and (<= temp___222 i9) (<= i9 0)) (= o7 (select c1 o6))))
(assert (=> (and (<= temp___222 i9) (<= i9 0)) (= o8 (to_rep o7))))
(assert (=> (and (<= temp___222 i9) (<= i9 0)) (= (to_rep o9) o8)))
(assert (=> (and (<= temp___222 i9) (<= i9 0)) (and (<= 0 i10) (<= i10 100))))
(assert (=> (and (<= temp___222 i9) (<= i9 0)) (= o10 i10)))
(assert (=> (and (<= temp___222 i9) (<= i9 0)) (= o11 (store a18 o10 o9))))
(assert (=> (and (<= temp___222 i9) (<= i9 0)) (= a18 result3)))
(assert (=> (and (<= temp___222 i9) (<= i9 0)) (= a19 o11)))
(assert (=> (and (<= temp___222 i9) (<= i9 0)) (= i10 0)))
(assert (=> (and (<= temp___222 i9) (<= i9 0)) (= i10 i11)))
(assert (=> (and (<= temp___222 i9) (<= i9 0)) (= a19 a110)))
(assert (=> (and (<= temp___222 i9) (<= i9 0)) (= i12 i10)))
(assert (=> (and (<= temp___222 i9) (<= i9 0)) (= a111 a19)))
(assert (=> (and (<= temp___222 i9) (<= i9 0)) (= i13 (mk_int__ref i11))))
(assert (=> (and (<= temp___222 i9) (<= i9 0)) (= a114 (mk_map__ref a110))))
(assert (=> (and (<= temp___222 i9) (<= i9 0)) (= i14 i12)))
(assert (=> (and (<= temp___222 i9) (<= i9 0)) (= a113 a111)))
(assert (=> (not (and (<= temp___222 i9) (<= i9 0))) (= i13 (mk_int__ref i9))))
(assert (=> (not (and (<= temp___222 i9) (<= i9 0))) (= a114 a115)))
(assert (=> (not (and (<= temp___222 i9) (<= i9 0))) (= i14 i9)))
(assert (=> (not (and (<= temp___222 i9) (<= i9 0))) (= a113 a17)))
(assert (= result4 (mk_int__ref i2)))
(assert (= i15 0))
(assert (<= 0 i15))
(assert (<= i15 k2))
(assert (and (forall ((temp___230 Int)) (=> (and (<= 0 temp___230) (<= temp___230 100)) (=> (or (< k2 temp___230) (or (< temp___230 0) (<= i16 temp___230))) (= (select a21 temp___230) (select a2 temp___230))))) (and (<= 0 i16) (<= i16 k2))))
