...
(declare-const temp___289 us_rep1)
...
(assert (= (mk___rep (mk___split_discrs (distinct 0 0)) (mk___split_fields dummy) true) c3))
(assert (and (= (distinct 0 0) (rec__split_records__record_with_mutable_discrs__present (us_split_discrs1 c3))) (= (attr__constrained c3) true)))
(assert (= (mk___rep (mk___split_discrs (distinct 0 0)) (mk___split_fields dummy) true) c4))
(assert (and (= (distinct 0 0) (rec__split_records__record_with_mutable_discrs__present (us_split_discrs1 c4))) (= (attr__constrained c4) true)))
(assert (= (mk___rep5 (mk___split_discrs1 (distinct 0 0)) (mk___split_fields5 (mk___rep (mk___split_discrs (distinct 0 0)) (mk___split_fields dummy) true))) h3))
(assert (dynamic_invariant5 h3 true false true true))
(assert (= (mk___rep1 (mk___split_fields1 (mk___rep (mk___split_discrs (distinct 0 0)) (mk___split_fields dummy) false))) h4))
(assert (= (attr__constrained (rec__split_records__mutable_holder__content (us_split_fields3 h4))) false))
(assert (= (split_records__test__a2__aggregate_def (mk___rep (mk___split_discrs (distinct 0 0)) (mk___split_fields dummy) false)) a2))
(assert (dynamic_invariant6 a2 true false true true))
(assert (=> (= (rec__split_records__record_with_mutable_discrs__present split_records__update_field_if_possible__r__discrs) true) (= (to_rep (rec__split_records__record_with_mutable_discrs__field split_records__update_field_if_possible__r__fields)) 0)))
(assert (= result5 (mk___split_fields__ref (mk___split_fields c1__split_fields))))
(assert (= c1__split_fields1 split_records__update_field_if_possible__r__fields))
(assert (=> (= c1__attr__constrained true) (= split_records__update_field_if_possible__r__discrs c1__split_discrs)))
(assert (not (= (rec__split_records__record_with_mutable_discrs__present c1__split_discrs) true)))
(assert (=> (= (rec__split_records__record_with_mutable_discrs__present c2__split_discrs2) true) (= (to_rep (rec__split_records__record_with_mutable_discrs__field c2__split_fields2)) 0)))
(assert (not (= (rec__split_records__record_with_mutable_discrs__present c2__split_discrs2) true)))
(assert (=> (= (rec__split_records__record_with_mutable_discrs__present split_records__update_field_if_possible__r__discrs1) true) (= (to_rep (rec__split_records__record_with_mutable_discrs__field split_records__update_field_if_possible__r__fields1)) 0)))
(assert (= result6 (mk___split_fields__ref3 h1__split_fields3)))
(assert (= h1__split_fields4 (mk___split_fields3 (mk___rep split_records__update_field_if_possible__r__discrs1 split_records__update_field_if_possible__r__fields1 (attr__constrained (rec__split_records__holder__content1 h1__split_fields3))))))
(assert (=> (= (attr__constrained (rec__split_records__holder__content1 h1__split_fields3)) true) (= split_records__update_field_if_possible__r__discrs1 (us_split_discrs1 (rec__split_records__holder__content1 h1__split_fields3)))))
(assert (not (= (rec__split_records__record_with_mutable_discrs__present (us_split_discrs1 (rec__split_records__holder__content1 h1__split_fields4))) true)))
(assert (not (= (attr__constrained (rec__split_records__mutable_holder__content h2__split_fields3)) true)))
(assert (=> (= (attr__constrained (rec__split_records__mutable_holder__content h2__split_fields3)) true) (= (distinct 0 0) (rec__split_records__record_with_mutable_discrs__present (us_split_discrs1 (rec__split_records__mutable_holder__content h2__split_fields3))))))
(assert (= (distinct 0 0) usq_))
(assert (= dummy usq_1))
(assert (= true usq_2))
(assert (= usq_ o))
(assert (= usq_1 o1))
(assert (= (attr__constrained (rec__split_records__mutable_holder__content h2__split_fields3)) o2))
(assert (= o3 (mk___split_fields1 (mk___rep (mk___split_discrs o) (mk___split_fields o1) o2))))
(assert (= temp___289 (mk___rep1 o3)))
(assert (= result7 (mk___split_fields__ref1 h2__split_fields3)))
(assert (= h2__split_fields4 (us_split_fields3 temp___289)))
(assert (not (= (attr__constrained (rec__split_records__mutable_holder__content h2__split_fields4)) true)))
(assert (=> (= (rec__split_records__record_with_mutable_discrs__present split_records__update_field_if_possible__r__discrs2) true) (= (to_rep (rec__split_records__record_with_mutable_discrs__field split_records__update_field_if_possible__r__fields2)) 0)))
(assert (= result8 (mk___split_fields__ref1 h2__split_fields4)))
(assert (= h2__split_fields5 (mk___split_fields1 (mk___rep split_records__update_field_if_possible__r__discrs2 split_records__update_field_if_possible__r__fields2 (attr__constrained (rec__split_records__mutable_holder__content h2__split_fields4))))))
(assert (=> (= (attr__constrained (rec__split_records__mutable_holder__content h2__split_fields4)) true) (= split_records__update_field_if_possible__r__discrs2 (us_split_discrs1 (rec__split_records__mutable_holder__content h2__split_fields4)))))
(assert (not (= (rec__split_records__record_with_mutable_discrs__present (us_split_discrs1 (rec__split_records__mutable_holder__content h2__split_fields5))) true)))
(assert (not (= (attr__constrained (select a1 1)) true)))
(assert (=> (= (attr__constrained (select a1 1)) true) (= (distinct 0 0) (rec__split_records__record_with_mutable_discrs__present (us_split_discrs1 (select a1 1))))))
(assert (= usq_3 (mk___rep (mk___split_discrs (distinct 0 0)) (mk___split_fields dummy) true)))
(assert (= o4 (mk___rep (us_split_discrs1 usq_3) (us_split_fields1 usq_3) (attr__constrained (select a1 1)))))
(assert (= o5 (store a1 1 o4)))
(assert (= result9 (mk_map__ref a1)))
(assert (= a3 o5))
(assert (not (not (= (attr__constrained (select a3 1)) true))))
(check-sat)
(exit)
