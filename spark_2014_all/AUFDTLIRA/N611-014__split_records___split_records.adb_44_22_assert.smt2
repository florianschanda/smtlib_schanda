...
(assert (=> (= (attr__constrained (rec__split_records__mutable_holder__content h2__split_fields3)) true) (= (of_int 0) (rec__split_records__record_with_mutable_discrs__present (us_split_discrs1 (rec__split_records__mutable_holder__content h2__split_fields3))))))
...
(assert (=> (= (attr__constrained (select a1 1)) true) (= (of_int 0) (rec__split_records__record_with_mutable_discrs__present (us_split_discrs1 (select a1 1))))))
(assert (= usq_3 (mk___rep (mk___split_discrs (of_int 0)) (mk___split_fields dummy) true)))
