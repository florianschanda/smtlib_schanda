...
(define-fun i26 () int__ref (mk_int__ref i1))
(define-fun i27 () int__ref (mk_int__ref i))
...
(assert (=> (< 128 lengthoftoken1) (= i18 i26)))
(assert (=> (< 128 lengthoftoken1) (= i17 i27)))
...
(assert (=> (not (< 128 lengthoftoken1)) (= result7 i27)))
...
(assert (=> (not (< 128 lengthoftoken1)) (= result9 i26)))
...
(assert (and (=> (<= r28b r29b) (dynamic_property2 r28b r29b i22)) (and (<= r28b i22) (<= i22 r29b))))
(assert (= (to_rep o14) (to_rep (select zonefileline i22))))
(assert (and (= o12 (+ i22 1)) (in_range1 (+ i22 1))))
(assert (= o13 (- o12 begidx13)))
(assert (and (= temp___1630 o13) (in_range1 o13)))
(assert (and (<= 1 temp___1630) (<= temp___1630 256)))
(assert (= o15 temp___1630))
(assert (= o16 (store rrstring2 o15 o14)))
(assert (= result14 (mk_map__ref rrstring2)))
(assert (= rrstring3 o16))
(assert (not (= i22 r29b)))
(assert (= result15 (mk_int__ref i22)))
(assert (= i23 (+ i22 1)))
(assert (= i24 (mk_int__ref i23)))
(assert (= rrstring4 (mk_map__ref rrstring3)))
(assert (= i25 i23))
(assert (= rrstring5 rrstring3))
