...
(assert (not (= (oeq1 (model__ (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) (to_rep1 (rec__search_trees__search_tree__root t__split_fields11))) (model__ (mk___rep2 f_1__split_fields3) (to_rep1 (rec__search_trees__search_tree__root t__split_fields11)))) true)))
(check-sat)
(exit)
