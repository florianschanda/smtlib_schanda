...
(declare-const workspace8 (Array Int character))
(declare-const offset8 Int)
(declare-const i9 Int)
(declare-const workspace9 (Array Int character))
...
(assert (= i2 1))
(assert (=> (and (<= 1 i2) (<= i2 1024)) (and (and (= temp___243 offset1) (and (= temp___241 workspace1) (and (= temp___240 i2) (and (< offset2 i3) (and (and (and (=> (<= 1 1024) (in_range3 i3)) (=> (<= 0 1024) (in_range2 offset2))) (and (<= 1 i3) (<= i3 1024))) (and (ite (not (= (to_rep (select buffer i3)) erase_character)) (and (and (and (= (to_rep o) (to_rep (select buffer i3))) (and (and (and (<= 1 (+ 1 offset2)) (<= (+ 1 offset2) 1024)) (= o1 (+ 1 offset2))) (= o2 (store workspace2 o1 o)))) (and (= workspace2 result3) (= workspace3 o2))) (and (and (= o3 (+ offset2 1)) (in_range2 (+ offset2 1))) (and (= offset2 result4) (= offset3 o3)))) (and (= offset3 offset2) (= workspace3 workspace2))) (= i3 1024))))))) (and (and (= i3 i7) (and (= offset3 offset6) (= workspace3 workspace6))) (and (= i8 i3) (and (= offset7 offset3) (= workspace7 workspace3)))))))
(assert (=> (and (<= 1 i2) (<= i2 1024)) (= (mk_int__ref i9) (mk_int__ref i7))))
(assert (=> (and (<= 1 i2) (<= i2 1024)) (= (mk_int__ref offset8) (mk_int__ref offset6))))
(assert (=> (and (<= 1 i2) (<= i2 1024)) (= (mk_map__ref workspace8) (mk_map__ref workspace6))))
