...
(assert (<= i8 128))
(assert (<= 1 endidx8))
(assert (and (and (forall ((temp___1624 Int)) (=> (and (<= 1 temp___1624) (<= temp___1624 128)) (=> (<= i9 temp___1624) (= (select newdomainname8 temp___1624) (select (map__content newdomainname6) temp___1624))))) (=> (<= r26b 128) (dynamic_property1 r26b 128 i9))) (and (<= r26b i9) (<= i9 128))))
(assert (= (to_rep o8) 32))
