...
(assert (<= i17 128))
(assert (<= 1 endidx10))
(assert (and (and (forall ((temp___1565 Int)) (=> (and (<= 1 temp___1565) (<= temp___1565 128)) (=> (<= i18 temp___1565) (= (select newdomainname12 temp___1565) (select (map__content newdomainname10) temp___1565))))) (=> (<= r26b 128) (dynamic_property1 r26b 128 i18))) (and (<= r26b i18) (<= i18 128))))
(assert (= (to_rep o8) 32))
(assert (= o9 (store newdomainname12 i18 o8)))
(assert (= result11 (mk_map__ref newdomainname12)))
(assert (= newdomainname13 o9))
(assert (not (= i18 128)))
(assert (= result12 (mk_int__ref i18)))
(assert (= i19 (+ i18 1)))
(assert (= i20 (mk_int__ref i19)))
