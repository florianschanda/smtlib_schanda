...
(define-fun dynamic_invariant4 ((temp___expr_158 Int) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool)) Bool (=> (or (= temp___is_init_155 true) (<= 0 2)) (in_range3 temp___expr_158)))
(declare-const i Int)
...
(assert (= result i))
(assert (= i1 0))
(assert (not (= (bool_eq (elts (to_string (attr__ATTRIBUTE_IMAGE3 i1))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 i1))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 i1))))) (elts word) (to_rep1 (first (rt word))) (to_rep1 (last (rt word)))) true)))
(assert (= instructions__read__result2 instructions__read__result))
(assert (= instructions__read__result2 instructions__read__result1))
(assert (= result1 i1))
(assert (= i2 1))
(assert (not (= (bool_eq (elts (to_string (attr__ATTRIBUTE_IMAGE3 i2))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 i2))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 i2))))) (elts word) (to_rep1 (first (rt word))) (to_rep1 (last (rt word)))) true)))
(assert (= instructions__read__result3 instructions__read__result2))
(assert (= result2 i2))
(assert (= i3 2))
(assert (not (= (bool_eq (elts (to_string (attr__ATTRIBUTE_IMAGE3 i3))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 i3))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 i3))))) (elts word) (to_rep1 (first (rt word))) (to_rep1 (last (rt word)))) true)))
(assert (= instructions__read__result4 instructions__read__result3))
(assert (not false))
(check-sat)
(exit)
