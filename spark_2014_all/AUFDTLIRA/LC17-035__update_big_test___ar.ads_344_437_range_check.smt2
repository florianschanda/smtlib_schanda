...
(declare-const temp___4804 (Array Int (Array Int et1)))
...
(assert (= a4 a2))
(assert (=> (< j 50) (=> (< 0 e) (and (= o9 (- e 1)) (in_range3 (- e 1))))))
(assert (=> (< j 50) (=> (< 0 e) (and (<= 5 (+ j 1)) (<= (+ j 1) 50)))))
(assert (=> (< j 50) (=> (< 0 e) (= o8 (+ j 1)))))
(assert (=> (< j 50) (=> (< 0 e) (= o10 (select a o8)))))
(assert (=> (< j 50) (=> (< 0 e) (= o11 (temp___1142 o10 i o9)))))
(assert (=> (< j 50) (=> (< 0 e) (and (= o12 (+ j 1)) (in_range2 (+ j 1))))))
(assert (=> (< j 50) (=> (< 0 e) (= temp___4799 (temp___1127 a j (temp___1135 (select a j) i e) o12 o11)))))
(assert (=> (< j 50) (=> (< 0 e) (= result4 (bool_eq1 a3 5 50 temp___4799 5 50)))))
(assert (=> (< j 50) (=> (not (< 0 e)) (= result4 false))))
(assert (=> (< j 50) (=> (= result4 true) (= result3 true))))
(assert (=> (< j 50) (=> (not (= result4 true)) (=> (= e 0) (and (<= 5 (+ j 1)) (<= (+ j 1) 50))))))
(assert (=> (< j 50) (=> (not (= result4 true)) (=> (= e 0) (= o4 (+ j 1))))))
(assert (=> (< j 50) (=> (not (= result4 true)) (=> (= e 0) (= o5 (select a o4))))))
(assert (=> (< j 50) (=> (not (= result4 true)) (=> (= e 0) (= o6 (temp___1165 o5 i 99))))))
(assert (=> (< j 50) (=> (not (= result4 true)) (=> (= e 0) (and (= o7 (+ j 1)) (in_range2 (+ j 1)))))))
(assert (=> (< j 50) (=> (not (= result4 true)) (=> (= e 0) (= temp___4804 (temp___1150 a j (temp___1158 (select a j) i e) o7 o6))))))
(assert (=> (< j 50) (=> (not (= result4 true)) (=> (= e 0) (= result3 (bool_eq1 a3 5 50 temp___4804 5 50))))))
(assert (=> (< j 50) (=> (not (= result4 true)) (=> (not (= e 0)) (= result3 false)))))
