...
(assert (=> (< j 50) (=> (< 0 e) (and (= o14 (- e 1)) (in_range3 (- e 1))))))
(assert (=> (< j 50) (=> (< 0 e) (and (<= 5 (+ j 1)) (<= (+ j 1) 50)))))
(assert (=> (< j 50) (=> (< 0 e) (= o13 (+ j 1)))))
(assert (=> (< j 50) (=> (< 0 e) (= o15 (select a o13)))))
(assert (=> (< j 50) (=> (< 0 e) (= o16 (temp___1083 o15 i o14)))))
(assert (=> (< j 50) (=> (< 0 e) (and (= o17 (+ j 1)) (in_range2 (+ j 1))))))
(assert (=> (< j 50) (=> (< 0 e) (= temp___4740 (temp___1068 a j (temp___1076 (select a j) i e) o17 o16)))))
(assert (=> (< j 50) (=> (< 0 e) (= result8 (bool_eq1 a3 5 50 temp___4740 5 50)))))
...
(assert (=> (< j 50) (=> (not (= result8 true)) (=> (= e 0) (= o11 (temp___1106 o10 i 99))))))
(assert (=> (< j 50) (=> (not (= result8 true)) (=> (= e 0) (and (= o12 (+ j 1)) (in_range2 (+ j 1)))))))
(assert (=> (< j 50) (=> (not (= result8 true)) (=> (= e 0) (= temp___4745 (temp___1091 a j (temp___1099 (select a j) i e) o12 o11))))))
(assert (=> (< j 50) (=> (not (= result8 true)) (=> (= e 0) (= result7 (bool_eq1 a3 5 50 temp___4745 5 50))))))
