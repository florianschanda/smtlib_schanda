...
(assert (=> (< j 50) (=> (< 0 e) (= temp___4740 (temp___1068 a j (temp___1076 (select a j) i e) o12 o11)))))
(assert (=> (< j 50) (=> (< 0 e) (= result4 (bool_eq1 a3 5 50 temp___4740 5 50)))))
...
(assert (=> (< j 50) (=> (not (= result4 true)) (=> (= e 0) (= o6 (temp___1106 o5 i 99))))))
(assert (=> (< j 50) (=> (not (= result4 true)) (=> (= e 0) (and (= o7 (+ j 1)) (in_range2 (+ j 1)))))))
(assert (=> (< j 50) (=> (not (= result4 true)) (=> (= e 0) (= temp___4745 (temp___1091 a j (temp___1099 (select a j) i e) o7 o6))))))
(assert (=> (< j 50) (=> (not (= result4 true)) (=> (= e 0) (= result3 (bool_eq1 a3 5 50 temp___4745 5 50))))))
