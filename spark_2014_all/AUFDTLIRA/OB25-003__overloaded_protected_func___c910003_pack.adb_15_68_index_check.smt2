...
(define-fun dynamic_invariant ((temp___expr_203 Int) (temp___is_init_199 Bool) (temp___skip_constant_200 Bool) (temp___do_toplevel_201 Bool) (temp___do_typ_inv_202 Bool)) Bool (=> (or (= temp___is_init_199 true) (<= 1 100)) (in_range1 temp___expr_203)))
...
(define-fun bool_eq ((a (Array Int item_type)) (a__first Int) (a__last Int) (b (Array Int item_type)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (to_rep (select a temp___idx_154)) (to_rep (select b (+ (- b__first a__first) temp___idx_154))))))) true false))
...
(declare-fun temp___220 (Int) (Array Int item_type))
(define-fun default_initial_assumption ((temp___expr_218 us_rep) (temp___skip_top_level_219 Bool)) Bool (and (and (and (= (to_rep (rec__c910003_pack__buffer__saved_item (us_split_fields1 temp___expr_218))) 1) (= (rec__c910003_pack__buffer__empty (us_split_fields1 temp___expr_218)) (distinct 1 0))) (= (rec__c910003_pack__buffer__tc_items (us_split_fields1 temp___expr_218)) (temp___220 1))) (= (to_rep2 (rec__c910003_pack__buffer__tc_last (us_split_fields1 temp___expr_218))) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_210 us_t) (temp___is_init_206 Bool) (temp___skip_constant_207 Bool) (temp___do_toplevel_208 Bool) (temp___do_typ_inv_209 Bool)) Bool (=> (not (= temp___skip_constant_207 true)) (dynamic_property 1 2147483647 (first1 temp___expr_210) (last1 temp___expr_210))))
...
(assert (forall ((self__ us_rep)) (forall ((x Bool)) (! (dynamic_invariant2 (tc_items_buffered__2 self__ x) true false true true) :pattern ((tc_items_buffered__2 self__ x))))))
...
(assert (forall ((temp___222 Int)) (=> (dynamic_invariant temp___222 true true true true) (forall ((temp___223 Int)) (= (to_rep (select (temp___220 temp___222) temp___223)) temp___222)))))
...
(declare-const temp___260 (Array Int item_type))
...
(define-fun temp___2602 () us_t (mk___t temp___260 temp___2601))
...
(assert (and (= temp___2582 (tc_items_buffered (mk___rep (mk___split_fields o o1 o2 o3)) 1)) (and (dynamic_invariant2 temp___2582 true false true true) (and (= o2 temp___258) (= (mk (to_rep1 (first2 (mk1 1 (to_rep2 o3)))) (to_rep1 (last2 (mk1 1 (to_rep2 o3))))) temp___2581)))))
(assert (and (<= (to_rep1 (first temp___2581)) 1) (<= 1 (to_rep1 (last temp___2581)))))
(assert (= o4 1))
(assert (= o5 (select temp___258 o4)))
...
(assert (and (= temp___2602 (tc_items_buffered__2 (mk___rep (mk___split_fields o6 o7 o8 o9)) (distinct 0 0))) (and (dynamic_invariant2 temp___2602 true false true true) (and (= o8 temp___260) (= (mk (to_rep1 (first4 (mk2 1 (to_rep2 o9)))) (to_rep1 (last4 (mk2 1 (to_rep2 o9))))) temp___2601)))))
(assert (not (<= (to_rep1 (first temp___2601)) 2)))
(check-sat)
(exit)
