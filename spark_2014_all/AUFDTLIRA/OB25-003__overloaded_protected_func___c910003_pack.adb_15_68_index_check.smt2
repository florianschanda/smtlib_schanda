...
(assert (and (<= (to_rep (first temp___2581)) 1) (<= 1 (to_rep (last temp___2581)))))
(assert (= o4 1))
(assert (= o5 (select temp___258 o4)))
(assert (= c910003_pack__proc__item1__assume (to_rep1 o5)))
(assert (= c910003_pack__proc__item1__assume item1))
(assert (in_range3 item1))
(assert (= o6 po__split_fields4))
(assert (= o7 po__split_fields5))
(assert (= o8 po__split_fields6))
(assert (= o9 po__split_fields7))
(assert (and (= temp___2602 (tc_items_buffered__2 (mk___rep (mk___split_fields o6 o7 o8 o9)) (distinct 0 0))) (and (dynamic_invariant1 temp___2602 true false true true) (and (= o8 temp___260) (= (mk (to_rep (first4 (mk2 1 (to_rep2 o9)))) (to_rep (last4 (mk2 1 (to_rep2 o9))))) temp___2601)))))
(assert (not (<= 2 (to_rep (last temp___2601)))))
(check-sat)
(exit)
