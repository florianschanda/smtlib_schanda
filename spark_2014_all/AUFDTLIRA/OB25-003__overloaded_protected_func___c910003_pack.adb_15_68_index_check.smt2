...
(assert (and (= temp___2272 (tc_items_buffered (mk___rep (mk___split_fields o o1 o2 o3)) 1)) (and (dynamic_invariant2 temp___2272 true false true) (and (= o2 temp___227) (= (mk (to_rep1 (first2 (mk1 1 (to_rep2 o3)))) (to_rep1 (last2 (mk1 1 (to_rep2 o3))))) temp___2271)))))
(assert (and (<= (to_rep1 (first temp___2271)) 1) (<= 1 (to_rep1 (last temp___2271)))))
(assert (= o4 1))
...
(assert (and (= temp___2292 (tc_items_buffered__2 (mk___rep (mk___split_fields o6 o7 o8 o9)) (of_int 0))) (and (dynamic_invariant2 temp___2292 true false true) (and (= o8 temp___229) (= (mk (to_rep1 (first4 (mk2 1 (to_rep2 o9)))) (to_rep1 (last4 (mk2 1 (to_rep2 o9))))) temp___2291)))))
(assert (not (<= (to_rep1 (first temp___2291)) 2)))
(check-sat)
(exit)
