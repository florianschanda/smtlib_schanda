...
(assert (and (= o79 (to_rep1 (rec__search_trees__search_tree__root t__split_fields11))) (in_range3 (to_rep1 (rec__search_trees__search_tree__root t__split_fields11)))))
(assert (and (= temp___873 (model__ (mk___rep2 f_old__split_fields2) o79)) (and (dynamic_invariant6 temp___873 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___873 o79))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___873 o79)))) 0) (and (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (not (= i5 o79)) (ite (and (not (= (parent (mk___rep2 f_old__split_fields2) i5) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___873 (parent (mk___rep2 f_old__split_fields2) i5)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___873 i5))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___873 i5))) true)))))) (and (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___873 i5))) true) (not (= i5 o79))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___873 (parent (mk___rep2 f_old__split_fields2) i5)))) (position (mk___rep2 f_old__split_fields2) i5) (rec__tree_model__path_type__a (us_split_fields1 (select temp___873 i5)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___873 i5)))) 0)))) (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___873 i5))) true) (forall ((j15 Int)) (=> (and (<= 1 j15) (<= j15 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___873 j15))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___873 i5))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___873 j15)))) true)) (= j15 i5))))))))))))))
(assert (= o80 (select temp___873 x1)))
(assert (= o81 (us_split_fields1 o80)))
(assert (= o82 (rec__tree_model__path_type__a o81)))
(assert (and (= o75 (to_rep1 (rec__search_trees__search_tree__root t__split_fields11))) (in_range3 (to_rep1 (rec__search_trees__search_tree__root t__split_fields11)))))
(assert (and (= temp___872 (model__ (mk___rep2 f_1__split_fields3) o75)) (and (dynamic_invariant6 temp___872 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___872 o75))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___872 o75)))) 0) (and (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (not (= i5 o75)) (ite (and (not (= (parent (mk___rep2 f_1__split_fields3) i5) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___872 (parent (mk___rep2 f_1__split_fields3) i5)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___872 i5))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___872 i5))) true)))))) (and (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___872 i5))) true) (not (= i5 o75))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___872 (parent (mk___rep2 f_1__split_fields3) i5)))) (position (mk___rep2 f_1__split_fields3) i5) (rec__tree_model__path_type__a (us_split_fields1 (select temp___872 i5)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___872 i5)))) 0)))) (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___872 i5))) true) (forall ((j15 Int)) (=> (and (<= 1 j15) (<= j15 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___872 j15))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___872 i5))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___872 j15)))) true)) (= j15 i5))))))))))))))
(assert (= o76 (select temp___872 i2)))
(assert (= o77 (us_split_fields1 o76)))
(assert (= o78 (rec__tree_model__path_type__a o77)))
(assert (and (= o83 (olt o78 o82)) (= (= o83 true) (and (< (length o78) (length o82)) (forall ((n Int)) (=> (and (<= 1 n) (<= n (last o78))) (= (get o78 n) (get o82 n))))))))
(assert (and (= o74 (to_rep1 (rec__search_trees__search_tree__root t__split_fields11))) (in_range3 (to_rep1 (rec__search_trees__search_tree__root t__split_fields11)))))
(assert (not (= (valid_root (mk___rep2 f_1__split_fields3) o74) true)))
(check-sat)
(exit)
