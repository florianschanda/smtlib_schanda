...
(assert (=> (not (= i1 1)) (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (= temp___361 bad1))))
...
(assert (=> (not (= i1 1)) (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (= o3 j4))))
(assert (=> (not (= i1 1)) (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (= o4 (select a1 o3)))))
(assert (=> (not (= i1 1)) (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (= o5 (to_rep o4)))))
(assert (=> (not (= i1 1)) (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (= o6 (ite (= o5 0) true false)))))
(assert (=> (not (= i1 1)) (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (= result5 (ite (not (= o6 true)) true false)))))
(assert (=> (not (= i1 1)) (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (=> (= result5 true) (= bad3 result6)))))
(assert (=> (not (= i1 1)) (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (=> (= result5 true) (= bad4 (of_int 1))))))
