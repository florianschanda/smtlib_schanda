...
(declare-const b2 (Array Int us_rep))
(declare-const tmp2 Int)
(declare-const a3 (Array Int us_rep))
(declare-const b3 (Array Int us_rep))
(declare-const tmp3 Int)
(assert (in_range1 i))
(assert (in_range1 j))
(assert (=> (<= (- 23) 69) (in_range2 tmp)))
(assert (= result tmp))
(assert (= tmp1 (to_rep (rec__arrays_of_records__basic_record__first_value (us_split_fields1 (select a i))))))
(assert (= (to_rep o) (to_rep (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select b j))))))
...
(assert (= (rec__arrays_of_records__basic_record__flag (us_split_fields1 (select b j))) o9))
(assert (= (rec__arrays_of_records__basic_record__first_value (us_split_fields1 (select b j))) o10))
(assert (= o8 o11))
(assert (= o12 o9))
(assert (= o13 o10))
(assert (= o14 o11))
(assert (= o15 (store b j (mk___rep (mk___split_fields o12 o13 o14)))))
(assert (= result2 b))
(assert (= b1 o15))
(assert (= tmp2 tmp1))
(assert (= b1 b2))
...
(assert (= b3 b1))
(assert (= a3 a1))
(assert (not (not (= (bool_eq1 a2 0 1001 a 0 1001) true))))
(check-sat)
(exit)
