...
(define-fun dynamic_invariant1 ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= 0 9999)) (in_range1 temp___expr_136)))
(define-fun dynamic_invariant2 ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= 0 10000)) (in_range2 temp___expr_142)))
(assert true)
...
(assert (forall ((r us_rep)) (! (=> (not (= (is_empty r) true)) (dynamic_invariant (head r) true false true)) :pattern ((head r)))))
(assert (forall ((r us_rep)) (! (= (head r) (to_rep2 (let ((temp___174 (rec__ring_buf__ring_buffer__data (us_split_fields1 r)))) (select temp___174 (to_rep (rec__ring_buf__ring_buffer__first (us_split_fields1 r))))))) :pattern ((head r)))))
(declare-const h Int)
...
(declare-const r__split_fields8 (Array Int integer))
(declare-const r__split_fields9 ar_index)
(declare-const r__split_fields10 length_type)
...
(assert (and (and (= (to_rep1 r__split_fields11) (- (to_rep1 r__split_fields10) 1)) (= (head (mk___rep (mk___split_fields r__split_fields8 r__split_fields9 r__split_fields10))) h2)) (in_range h2)))
(assert (not (= h2 y)))
(check-sat)
(exit)
