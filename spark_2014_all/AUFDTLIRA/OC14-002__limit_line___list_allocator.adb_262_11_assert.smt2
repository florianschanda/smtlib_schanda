...
(assert (<= 1 j8))
(assert (<= j8 (length (rec__list_allocator__m__t__allocated model____split_fields4))))
(assert (not (in_range4 (get (rec__list_allocator__m__t__allocated model____split_fields4) j8))))
(check-sat)
(exit)
