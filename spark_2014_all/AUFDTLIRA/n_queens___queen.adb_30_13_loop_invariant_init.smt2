...
(declare-const temp___200 (Array Int index))
...
(assert (= j2 1))
(assert (=> (and (<= 1 j2) (<= j2 i)) (= temp___202 j2)))
(assert (=> (and (<= 1 j2) (<= j2 i)) (= temp___200 r1)))
(assert (=> (and (<= 1 j2) (<= j2 i)) (forall ((k Int)) (=> (and (<= 1 k) (<= k (- j3 1))) (= (to_rep (select r2 k)) (to_rep (select b k)))))))
(assert (=> (and (<= 1 j2) (<= j2 i)) (and (and (forall ((temp___201 Int)) (=> (and (<= 1 temp___201) (<= temp___201 8)) (=> (<= j3 temp___201) (= (select r2 temp___201) (select temp___200 temp___201))))) (=> (<= 1 i) (dynamic_property 1 i j3))) (and (<= 1 j3) (<= j3 i)))))
