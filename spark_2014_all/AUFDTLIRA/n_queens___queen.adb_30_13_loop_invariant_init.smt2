...
(assert (=> (and (<= 1 j2) (<= j2 i)) (and (and (forall ((temp___177 Int)) (=> (and (<= 1 temp___177) (<= temp___177 8)) (=> (<= j3 temp___177) (= (select r2 temp___177) (select temp___176 temp___177))))) (=> (<= 1 i) (dynamic_property 1 i j3))) (and (<= 1 j3) (<= j3 i)))))
