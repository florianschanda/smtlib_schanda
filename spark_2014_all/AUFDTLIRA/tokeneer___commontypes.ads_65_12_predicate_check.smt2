...
(assert (dynamic_property1 1 2147483647 (to_rep1 (first4 (rt2 i17s))) (to_rep1 (last4 (rt2 i17s)))))
(assert (= (elts2 i17s) temp___289))
(assert (= (mk1 (to_rep1 (first4 (rt2 i17s))) (to_rep1 (last4 (rt2 i17s)))) temp___2891))
(assert (not (dynamic_predicate1 (mk___t1 temp___289 temp___2891))))
(check-sat)
(exit)
