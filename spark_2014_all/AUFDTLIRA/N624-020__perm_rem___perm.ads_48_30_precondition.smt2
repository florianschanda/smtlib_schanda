...
(assert (= result2 true))
(assert (and (= result3 (is_perm a b)) (= (= result3 true) (or (and (= (length a) 0) (= (length b) 0)) (exists ((ia Int)) (and (and (<= (to_rep (first (rt a))) ia) (<= ia (to_rep (last (rt a))))) (exists ((ib Int)) (and (and (<= (to_rep (first (rt b))) ib) (<= ib (to_rep (last (rt b))))) (and (= (to_rep1 (select (elts a) ia)) (to_rep1 (select (elts b) ib))) (= (is_perm (remove a ia) (remove b ib)) true))))))))))
(assert (= result3 true))
