...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (and (= (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 a))) (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 b)))) (= (bool_eq1 (rec__integer_stacks__stack__values (us_split_fields1 a)) (rec__integer_stacks__stack__values (us_split_fields1 b))) true)) (= (to_rep1 (rec__integer_stacks__stack__top (us_split_fields1 a))) (to_rep1 (rec__integer_stacks__stack__top (us_split_fields1 b))))) true false))
...
(define-fun bool_eq4 ((a us_rep1) (b us_rep1)) Bool (ite (and (and (= (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs2 a))) (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs2 b)))) (= (bool_eq3 (rec__integer_stacks__stack__values1 (us_split_fields3 a)) (rec__integer_stacks__stack__values1 (us_split_fields3 b))) true)) (= (to_rep1 (rec__integer_stacks__stack__top1 (us_split_fields3 a))) (to_rep1 (rec__integer_stacks__stack__top1 (us_split_fields3 b))))) true false))
...
(define-fun bool_eq8 ((a us_rep3) (b us_rep3)) Bool (ite (and (and (= (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs4 a))) (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs4 b)))) (= (bool_eq7 (rec__integer_stacks__stack__values3 (us_split_fields7 a)) (rec__integer_stacks__stack__values3 (us_split_fields7 b))) true)) (= (to_rep1 (rec__integer_stacks__stack__top3 (us_split_fields7 a))) (to_rep1 (rec__integer_stacks__stack__top3 (us_split_fields7 b))))) true false))
...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant1 this true true true) (= (extent this) (to_rep1 (rec__integer_stacks__stack__top (us_split_fields1 this))))) :pattern ((extent this)))))
...
(assert (forall ((temp___220 Int) (temp___221 Int) (temp___222 Int)) (let ((temp___219 (temp___218 temp___220 temp___221 temp___222))) (and (=> (dynamic_property10 1 2147483647 temp___221 temp___222) (and (= (first9 temp___219) temp___221) (= (last9 temp___219) temp___222))) (forall ((temp___223 Int)) (= (select (to_array4 temp___219) temp___223) (of_rep3 temp___220)))))))
(assert (forall ((a us_rep3) (b us_rep3)) (! (= (user_eq15 a b) (oeq (to_base2 a) (to_base2 b))) :pattern ((user_eq15 a b)))))
(define-fun dynamic_invariant5 ((temp___expr_229 us_rep3) (temp___is_init_226 Bool) (temp___skip_constant_227 Bool) (temp___do_toplevel_228 Bool)) Bool (and (=> (not (= temp___skip_constant_227 true)) (in_range7 (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 left))) (to_base2 temp___expr_229))) (and (dynamic_property7 1 (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 left))) (first7 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_229))) (last7 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_229)))) (and (= (first7 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_229))) 1) (= (last7 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_229))) (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 left))))))))
(define-fun default_initial_assumption ((temp___expr_232 us_rep3) (temp___skip_top_level_233 Bool)) Bool (and (and (= (attr__tag3 temp___expr_232) us_tag3) (and (and (= (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs4 temp___expr_232))) (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 left)))) (= (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_232)) (let ((temp___235 (temp___218 0 1 (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs4 temp___expr_232)))))) (of_array3 (to_array4 temp___235) (first9 temp___235) (last9 temp___235))))) (= (to_rep1 (rec__integer_stacks__stack__top3 (us_split_fields7 temp___expr_232))) 0))) (=> (not (= temp___skip_top_level_233 true)) (= (empty (to_base2 temp___expr_232)) true))))
...
(define-fun dynamic_invariant6 ((temp___expr_212 us_rep2) (temp___is_init_209 Bool) (temp___skip_constant_210 Bool) (temp___do_toplevel_211 Bool)) Bool (and (=> (not (= temp___skip_constant_210 true)) (in_range6 (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 right))) (to_base1 temp___expr_212))) (and (dynamic_property5 1 (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 right))) (first5 (rec__integer_stacks__stack__values2 (us_split_fields5 temp___expr_212))) (last5 (rec__integer_stacks__stack__values2 (us_split_fields5 temp___expr_212)))) (and (= (first5 (rec__integer_stacks__stack__values2 (us_split_fields5 temp___expr_212))) 1) (= (last5 (rec__integer_stacks__stack__values2 (us_split_fields5 temp___expr_212))) (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 right))))))))
(define-fun default_initial_assumption1 ((temp___expr_215 us_rep2) (temp___skip_top_level_216 Bool)) Bool (and (and (= (attr__tag2 temp___expr_215) us_tag2) (and (and (= (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs3 temp___expr_215))) (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 right)))) (= (rec__integer_stacks__stack__values2 (us_split_fields5 temp___expr_215)) (let ((temp___224 (temp___218 0 1 (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs3 temp___expr_215)))))) (of_array2 (to_array4 temp___224) (first9 temp___224) (last9 temp___224))))) (= (to_rep1 (rec__integer_stacks__stack__top2 (us_split_fields5 temp___expr_215))) 0))) (=> (not (= temp___skip_top_level_216 true)) (= (empty (to_base1 temp___expr_215)) true))))
...
(assert (dynamic_invariant1 (mk___rep this__split_discrs (mk___split_fields (mk___t this__split_fields4 this__split_fields5) this__split_fields6 this__split_fields7) this__attr__tag) true true true))
(assert (and (= o (extent (mk___rep this__split_discrs (mk___split_fields (mk___t this__split_fields this__split_fields1) this__split_fields2 this__split_fields3) this__attr__tag))) (and (in_range4 o) (= o (to_rep1 this__split_fields2)))))
(assert (= o1 (+ o 1)))
