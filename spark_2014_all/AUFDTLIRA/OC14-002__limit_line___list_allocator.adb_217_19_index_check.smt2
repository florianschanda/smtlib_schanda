...
(assert (= (to_rep o38) next_alloc1))
(assert (= (rec__list_allocator__cell__stat (us_split_fields1 (select data1 prev_alloc1))) o39))
(assert (= (rec__list_allocator__cell__prev (us_split_fields1 (select data1 prev_alloc1))) o40))
(assert (= o38 o41))
(assert (= o42 o39))
(assert (= o43 o40))
(assert (= o44 o41))
(assert (not (<= 1 prev_alloc1)))
(check-sat)
(exit)
