...
(define-fun dynamic_invariant ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= 0 1001)) (in_range1 temp___expr_142)))
(define-fun dynamic_invariant1 ((temp___expr_148 Int) (temp___is_init_145 Bool) (temp___skip_constant_146 Bool) (temp___do_toplevel_147 Bool)) Bool (=> (or (= temp___is_init_145 true) (<= (- 23) 69)) (in_range temp___expr_148)))
...
(declare-const temp___1931 (Array Int value))
(declare-const temp___1932 (Array Int value))
...
(assert (= temp___193 o2))
(assert (= temp___1931 o3))
(assert (= temp___1932 o4))
(assert (= result a__split_fields))
(assert (= result1 a__split_fields1))
(assert (= result2 a__split_fields2))
(assert (= temp___193 a__split_fields3))
(assert (= temp___1931 a__split_fields4))
(assert (= temp___1932 a__split_fields5))
