...
(declare-const temp___220 index)
(declare-const temp___2201 (Array Int value))
(declare-const temp___2202 (Array Int value))
...
(assert (= temp___2202 o4))
(assert (= result a__split_fields))
(assert (= result1 a__split_fields1))
(assert (= result2 a__split_fields2))
(assert (= temp___220 a__split_fields3))
(assert (= temp___2201 a__split_fields4))
(assert (= temp___2202 a__split_fields5))
(assert (= a__split_fields6 a__split_fields3))
(assert (= a__split_fields7 a__split_fields4))
(assert (= a__split_fields8 a__split_fields5))
(assert (= a__split_fields9 a__split_fields3))
(assert (= a__split_fields10 a__split_fields4))
(assert (= a__split_fields11 a__split_fields5))
(assert (not (= (to_rep (select a__split_fields7 17)) 23)))
(check-sat)
(exit)
