...
(define-fun dynamic_invariant ((temp___expr_141 Int) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool (=> (or (= temp___is_init_138 true) (<= 0 1024)) (in_range1 temp___expr_141)))
(assert true)
...
(declare-fun temp___159 (Int) (Array Int integer))
(assert (forall ((temp___161 Int)) (forall ((temp___162 Int)) (= (select (temp___159 temp___161) temp___162) (of_rep temp___161)))))
