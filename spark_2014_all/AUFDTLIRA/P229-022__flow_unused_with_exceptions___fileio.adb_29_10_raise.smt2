...
(define-fun dynamic_invariant1 ((temp___expr_300 Int) (temp___is_init_297 Bool) (temp___skip_constant_298 Bool) (temp___do_toplevel_299 Bool)) Bool (=> (or (= temp___is_init_297 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_300)))
...
(define-fun dynamic_invariant2 ((temp___expr_348 Int) (temp___is_init_345 Bool) (temp___skip_constant_346 Bool) (temp___do_toplevel_347 Bool)) Bool (=> (or (= temp___is_init_345 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_348)))
(declare-fun ferror (Int) Int)
(declare-fun ferror__function_guard (Int Int) Bool)
(assert (forall ((stream Int)) (! (=> (dynamic_invariant2 stream true true true) (dynamic_invariant1 (ferror stream) true false true)) :pattern ((ferror stream)))))
