...
(define-fun dynamic_invariant1 ((temp___expr_306 Int) (temp___is_init_303 Bool) (temp___skip_constant_304 Bool) (temp___do_toplevel_305 Bool)) Bool (=> (or (= temp___is_init_303 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_306)))
...
(define-fun dynamic_invariant2 ((temp___expr_354 Int) (temp___is_init_351 Bool) (temp___skip_constant_352 Bool) (temp___do_toplevel_353 Bool)) Bool (=> (or (= temp___is_init_351 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_354)))
