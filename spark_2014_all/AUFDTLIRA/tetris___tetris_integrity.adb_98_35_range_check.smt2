...
(declare-const temp___810 (Array Int (Array Int cell)))
(declare-const temp___809 Int)
(declare-const temp___808 Bool)
...
(assert (= del_line1 1))
(assert (=> (and (<= 1 del_line1) (<= del_line1 50)) (= temp___810 cur_board)))
(assert (=> (and (<= 1 del_line1) (<= del_line1 50)) (= temp___809 to_line1)))
(assert (=> (and (<= 1 del_line1) (<= del_line1 50)) (= temp___808 has_complete_lines1)))
(assert (=> (and (<= 1 del_line1) (<= del_line1 50)) (and (and (=> (<= 1 50) (in_range4 to_line2)) (forall ((temp___811 Int)) (=> (and (<= 1 temp___811) (<= temp___811 50)) (=> (or (< 50 temp___811) (or (< temp___811 1) (<= del_line2 temp___811))) (= (select cur_board2 temp___811) (select temp___810 temp___811)))))) (and (<= 1 del_line2) (<= del_line2 50)))))
...
(assert (and (and (and (=> (<= 1 r3b) (dynamic_property 1 r3b from_line2)) (=> (<= 1 50) (in_range4 to_line8))) (=> (<= 0 2147483647) (in_range2 num_deleted2))) (and (<= 1 from_line2) (<= from_line2 r3b))))
...
(assert (not (in_range4 (- to_line8 1))))
(check-sat)
(exit)
