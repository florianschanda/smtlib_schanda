...
(assert (and (= o2 (is_empty_line (select cur_board8 from_line2))) (= (= o2 true) (forall ((x Int)) (=> (and (<= 1 x) (<= x 10)) (= (to_rep (select (select cur_board8 from_line2) x)) 0))))))
(assert (= result9 (ite (not (= o2 true)) true false)))
(assert (= result9 true))
