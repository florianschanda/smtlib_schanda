...
(assert (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 10)) (= (to_rep (select x1 j3)) 0))))
...
(assert (<= 1 j1))
(assert (<= j1 10))
(assert (= result22 (mk_map__ref x11)))
(assert (= x12 (store x11 j1 rliteral2)))
(assert (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 j2)) (= (to_rep (select x13 k1)) 2))))
(assert (and (and (forall ((temp___223 Int)) (=> (and (<= 1 temp___223) (<= temp___223 10)) (=> (or (< 10 temp___223) (or (< temp___223 1) (< j2 temp___223))) (= (select x13 temp___223) (select x11 temp___223))))) (=> (<= 1 10) (in_range3 j2))) (and (<= 1 j2) (<= j2 10))))
(assert (<= 1 k))
(assert (<= k j2))
(assert (not (<= 1 k)))
(check-sat)
