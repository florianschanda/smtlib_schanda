...
(declare-fun temp___520 ((Array Int unsigned_byte) (Array Int unsigned_byte)) (Array Int (Array Int unsigned_byte)))
(declare-fun temp___525 (Int Int Int Int) (Array Int unsigned_byte))
(declare-fun temp___532 (Int Int) (Array Int unsigned_byte))
...
(assert (forall ((temp___522 (Array Int unsigned_byte)) (temp___523 (Array Int unsigned_byte))) (let ((temp___521 (temp___520 temp___522 temp___523))) (forall ((temp___524 Int)) (ite (or (= temp___524 2) (and (<= 4 temp___524) (<= temp___524 6))) (= (select temp___521 temp___524) temp___522) (= (select temp___521 temp___524) temp___523))))))
(assert (forall ((temp___527 Int) (temp___528 Int) (temp___529 Int) (temp___530 Int)) (let ((temp___526 (temp___525 temp___527 temp___528 temp___529 temp___530))) (=> (and (and (and (dynamic_invariant temp___527 true true true true) (dynamic_invariant temp___528 true true true true)) (dynamic_invariant temp___529 true true true true)) (dynamic_invariant temp___530 true true true true)) (forall ((temp___531 Int)) (ite (= temp___531 3) (= (to_rep (select temp___526 temp___531)) temp___529) (ite (= temp___531 2) (= (to_rep (select temp___526 temp___531)) temp___528) (ite (= temp___531 1) (= (to_rep (select temp___526 temp___531)) temp___527) (= (to_rep (select temp___526 temp___531)) temp___530)))))))))
(assert (forall ((temp___534 Int) (temp___535 Int)) (let ((temp___533 (temp___532 temp___534 temp___535))) (=> (and (dynamic_invariant temp___534 true true true true) (dynamic_invariant temp___535 true true true true)) (forall ((temp___536 Int)) (ite (= temp___536 5) (= (to_rep (select temp___533 temp___536)) temp___534) (= (to_rep (select temp___533 temp___536)) temp___535)))))))
...
(assert (= result x))
(assert (= x1 (temp___520 (temp___525 1 2 3 0) (temp___532 10 12))))
