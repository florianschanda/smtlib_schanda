...
(assert (= index1 10))
(assert (=> (and (<= 1 index1) (<= index1 10)) (= temp___214 index1)))
(assert (=> (and (<= 1 index1) (<= index1 10)) (= temp___215 src)))
(assert (=> (and (<= 1 index1) (<= index1 10)) (= temp___212 src)))
(assert (=> (and (<= 1 index1) (<= index1 10)) (= temp___210 dest)))
(assert (=> (and (<= 1 index1) (<= index1 10)) (= temp___216 src)))
...
(assert (=> (and (<= 1 index1) (<= index1 10)) (and (forall ((j Int)) (=> (and (<= index2 j) (<= j 10)) (= (to_rep (select dest3 j)) (to_rep (select temp___215 j))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (- index2 1))) (= (to_rep (select src3 j)) (to_rep (select temp___216 j))))))))
(assert (=> (and (<= 1 index1) (<= index1 10)) (and (and (and (forall ((temp___211 Int)) (=> (and (<= 1 temp___211) (<= temp___211 10)) (=> (or (< 10 temp___211) (or (< temp___211 1) (< temp___211 index2))) (= (select dest3 temp___211) (select temp___210 temp___211))))) (forall ((temp___213 Int)) (=> (and (<= 1 temp___213) (<= temp___213 10)) (=> (or (< 10 temp___213) (or (< temp___213 1) (< temp___213 index2))) (= (select src3 temp___213) (select temp___212 temp___213)))))) (=> (<= 1 10) (in_range3 index2))) (and (<= 1 index2) (<= index2 10)))))
