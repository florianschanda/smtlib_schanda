...
(assert (= index1 10))
(assert (=> (and (<= 1 index1) (<= index1 10)) (and (and (= temp___188 index1) (and (= temp___189 src) (and (= temp___186 src) (and (= temp___184 dest) (and (= temp___190 src) (and (and (and (= (to_rep o) (to_rep (select src index1))) (= o1 (store dest index1 o))) (and (= (mk_map__ref result1) (mk_map__ref dest)) (= dest2 o1))) (and (and (and (= (to_rep o2) 0) (= o3 (store src index1 o2))) (and (= (mk_map__ref result2) (mk_map__ref src)) (= src2 o3))) (and (and (forall ((j2 Int)) (=> (and (<= index2 j2) (<= j2 10)) (= (to_rep (select dest3 j2)) (to_rep (select temp___189 j2))))) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 (- index2 1))) (= (to_rep (select src3 j2)) (to_rep (select temp___190 j2)))))) (and (and (and (and (forall ((temp___185 Int)) (=> (and (<= 1 temp___185) (<= temp___185 10)) (=> (< temp___185 index2) (= (select dest3 temp___185) (select temp___184 temp___185))))) (forall ((temp___187 Int)) (=> (and (<= 1 temp___187) (<= temp___187 10)) (=> (< temp___187 index2) (= (select src3 temp___187) (select temp___186 temp___187)))))) (=> (<= 1 10) (in_range3 index2))) (and (<= 1 index2) (<= index2 10))) (= index2 1)))))))))) (and (and (= index2 index6) (and (= src3 src7) (= dest3 dest7))) (and (= index7 index2) (and (= src8 src3) (= dest8 dest3)))))))
