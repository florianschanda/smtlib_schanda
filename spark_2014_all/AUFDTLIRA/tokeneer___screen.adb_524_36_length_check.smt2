...
(define-fun dynamic_invariant ((temp___expr_1182 Int) (temp___is_init_1178 Bool) (temp___skip_constant_1179 Bool) (temp___do_toplevel_1180 Bool) (temp___do_typ_inv_1181 Bool)) Bool (=> (or (= temp___is_init_1178 true) (<= 0 5)) (in_range3 temp___expr_1182)))
(declare-sort t2 0)
...
(assert (forall ((x Int)) (! (=> (dynamic_invariant x true true true true) (dynamic_invariant1 (classt_image x) true false true true)) :pattern ((classt_image x)))))
(assert (forall ((x Int)) (! (=> (dynamic_invariant x true true true true) (= (classt_image x) (let ((temp___1188 (to_string (attr__ATTRIBUTE_IMAGE3 x)))) (of_array1 (to_array temp___1188) (first1 temp___1188) (last1 temp___1188))))) :pattern ((classt_image x)))))
...
(assert (forall ((temp___2023 Int)) (=> (dynamic_invariant3 temp___2023 true true true true) (forall ((temp___2024 Int)) (= (to_rep (select (screen__writeconfigdata__classstring__result__aggregate_def temp___2023) temp___2024)) temp___2023)))))
...
(declare-const temp___2020 (Array Int character))
(declare-const temp___20201 t1)
...
(define-fun temp___20202 () us_t1 (mk___t1 temp___2020 temp___20201))
(assert (in_range3 value))
(assert (and (= temp___20202 (classt_image value)) (and (dynamic_invariant1 temp___20202 true false true true) (= temp___20202 (let ((temp___1186 (to_string (attr__ATTRIBUTE_IMAGE3 value)))) (mk___t1 (elts temp___1186) (mk1 (to_rep1 (first (rt temp___1186))) (to_rep1 (last (rt temp___1186))))))))))
(assert (= temp___2020 screen__writeconfigdata__classstring__data__assume))
(assert (= (mk (to_rep1 (first2 temp___20201)) (to_rep1 (last2 temp___20201))) screen__writeconfigdata__classstring__data__assume1))
(assert (= result data))
