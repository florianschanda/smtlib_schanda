...
(define-fun dynamic_invariant ((temp___expr_1054 Int) (temp___is_init_1051 Bool) (temp___skip_constant_1052 Bool) (temp___do_toplevel_1053 Bool)) Bool (=> (or (= temp___is_init_1051 true) (<= 0 5)) (in_range3 temp___expr_1054)))
(declare-sort t2 0)
...
(assert (forall ((x Int)) (! (=> (dynamic_invariant x true true true) (dynamic_invariant1 (classt_image x) true false true)) :pattern ((classt_image x)))))
(assert (forall ((x Int)) (! (=> (dynamic_invariant x true true true) (= (classt_image x) (let ((temp___1060 (to_string (attr__ATTRIBUTE_IMAGE3 x)))) (of_array1 (to_array temp___1060) (first1 temp___1060) (last1 temp___1060))))) :pattern ((classt_image x)))))
...
(assert (forall ((temp___1832 Int)) (forall ((temp___1833 Int)) (= (select (screen__writeconfigdata__classstring__result__aggregate_def temp___1832) temp___1833) (of_rep temp___1832)))))
...
(declare-const temp___1837 (Array Int character))
(declare-const temp___18371 t3)
...
(assert (and (= (mk___t1 temp___1829 temp___18291) (classt_image value)) (and (dynamic_invariant1 (mk___t1 temp___1829 temp___18291) true false true) (= (mk___t1 temp___1829 temp___18291) (let ((temp___1058 (to_string (attr__ATTRIBUTE_IMAGE3 value)))) (mk___t1 (elts temp___1058) (mk1 (to_rep1 (first (rt temp___1058))) (to_rep1 (last (rt temp___1058))))))))))
(assert (= temp___1829 screen__writeconfigdata__classstring__data__assume))
(assert (= (mk (to_rep1 (first2 temp___18291)) (to_rep1 (last2 temp___18291))) screen__writeconfigdata__classstring__data__assume1))
(assert (= result data))
