...
(assert (and (= o54 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (in_range7 o54)))
(assert (= result12 (ite (in_range4 o54) true false)))
(assert (=> (= result12 true) (and (= o50 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range6 o50))))
(assert (=> (= result12 true) (= result13 (ite (< j o50) true false))))
(assert (=> (= result12 true) (=> (= result13 true) (and (= o51 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result12 true) (=> (= result13 true) (and (= o52 (get (rec__list_allocator__m__t__allocated model____split_fields3) o51)) (in_range7 o52)))))
...
(assert (=> (= result12 true) (= o46 temp___400)))
