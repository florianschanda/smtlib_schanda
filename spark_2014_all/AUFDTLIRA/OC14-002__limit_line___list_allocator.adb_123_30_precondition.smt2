...
(assert (and (= o47 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (in_range4 o47)))
(assert (= result12 (ite (in_range7 o47) true false)))
(assert (=> (= result12 true) (and (= o43 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range3 o43))))
(assert (=> (= result12 true) (= result13 (ite (< j o43) true false))))
(assert (=> (= result12 true) (=> (= result13 true) (and (= o44 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result12 true) (=> (= result13 true) (and (= o45 (get (rec__list_allocator__m__t__allocated model____split_fields3) o44)) (in_range4 o45)))))
(assert (=> (= result12 true) (=> (not (= result13 true)) (= o45 0))))
...
(assert (=> (= result12 true) (= o39 temp___433)))
(assert (=> (= result12 true) (= o40 (select data3 o39))))
(assert (=> (= result12 true) (= o41 (us_split_fields3 o40))))
(assert (=> (= result12 true) (= o42 (rec__list_allocator__cell__next o41))))
(assert (=> (= result12 true) (= o46 (to_rep o42))))
(assert (=> (= result12 true) (= result11 (ite (= o46 o45) true false))))
(assert (=> (not (= result12 true)) (= result11 false)))
(assert (= result11 true))
(assert (< 1 j))
(assert (and (= o38 (- j 1)) (in_range2 (- j 1))))
(assert (not (<= o38 (length (rec__list_allocator__m__t__allocated model____split_fields3)))))
(check-sat)
(exit)
