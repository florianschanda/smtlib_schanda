...
(define-fun dynamic_invariant ((temp___expr_345 us_t2) (temp___is_init_341 Bool) (temp___skip_constant_342 Bool) (temp___do_toplevel_343 Bool) (temp___do_typ_inv_344 Bool)) Bool (and (=> (not (= temp___skip_constant_342 true)) (dynamic_property2 1 2147483647 (first5 temp___expr_345) (last5 temp___expr_345))) (=> (= temp___do_toplevel_343 true) (=> (= temp___is_init_341 true) (and (let ((temp___347 (of_array (to_array2 temp___expr_345) (first5 temp___expr_345) (last5 temp___expr_345)))) (and (let ((temp___348 (of_array1 (to_array temp___347) (first1 temp___347) (last1 temp___347)))) (and (= (first3 temp___348) 1) (<= 0 (last3 temp___348)))) (<= (last1 temp___347) 1000))) (<= 1 (length2 temp___expr_345)))))))
(define-fun dynamic_predicate ((temp___350 us_t2)) Bool (and (let ((temp___352 (of_array (to_array2 temp___350) (first5 temp___350) (last5 temp___350)))) (and (let ((temp___353 (of_array1 (to_array temp___352) (first1 temp___352) (last1 temp___352)))) (and (= (first3 temp___353) 1) (<= 0 (last3 temp___353)))) (<= (last1 temp___352) 1000))) (<= 1 (length2 temp___350))))
...
(assert (not (dynamic_property 1 2147483647 (to_rep1 (first4 (rt2 i23s))) (to_rep1 (last4 (rt2 i23s))))))
(check-sat)
(exit)
