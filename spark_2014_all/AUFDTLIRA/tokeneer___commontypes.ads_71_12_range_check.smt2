...
(define-fun dynamic_invariant ((temp___expr_303 us_t2) (temp___is_init_300 Bool) (temp___skip_constant_301 Bool) (temp___do_toplevel_302 Bool)) Bool (and (=> (not (= temp___skip_constant_301 true)) (dynamic_property2 1 2147483647 (first5 temp___expr_303) (last5 temp___expr_303))) (=> (= temp___do_toplevel_302 true) (=> (= temp___is_init_300 true) (and (let ((temp___305 (of_array1 (to_array2 temp___expr_303) (first5 temp___expr_303) (last5 temp___expr_303)))) (and (let ((temp___306 (of_array (to_array1 temp___305) (first3 temp___305) (last3 temp___305)))) (and (= (first1 temp___306) 1) (<= 0 (last1 temp___306)))) (<= (last3 temp___305) 1000))) (<= 1 (length2 temp___expr_303)))))))
(define-fun dynamic_predicate ((temp___308 us_t2)) Bool (and (let ((temp___310 (of_array1 (to_array2 temp___308) (first5 temp___308) (last5 temp___308)))) (and (let ((temp___311 (of_array (to_array1 temp___310) (first3 temp___310) (last3 temp___310)))) (and (= (first1 temp___311) 1) (<= 0 (last1 temp___311)))) (<= (last3 temp___310) 1000))) (<= 1 (length2 temp___308))))
...
(declare-const temp___335 (Array Int character))
(declare-const temp___3351 t1)
(assert (dynamic_invariant i23s true false false))
