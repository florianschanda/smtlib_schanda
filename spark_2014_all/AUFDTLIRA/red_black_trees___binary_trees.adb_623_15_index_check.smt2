...
(assert (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields3) v1)))) i))
(assert (= (to_rep1 o25) 2))
(assert (= (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields3) v1))) o26))
(assert (= (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields3) v1))) o27))
(assert (= (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields3) v1))) o28))
(assert (= o25 o29))
(assert (= o30 o26))
(assert (= o31 o27))
(assert (= o32 o28))
...
(assert (= o34 v1))
(assert (= o35 (store (rec__binary_trees__forest__c f__split_fields3) o34 (mk___rep1 (mk___split_fields1 o30 o31 o32 o33)))))
(assert (= (rec__binary_trees__forest__s f__split_fields3) o36))
(assert (= o35 o37))
(assert (= temp___715 (mk___rep2 (mk___split_fields2 o36 o37))))
(assert (= result5 (mk___split_fields__ref2 f__split_fields3)))
(assert (= f__split_fields5 (us_split_fields5 temp___715)))
(assert (= (to_rep o38) 0))
