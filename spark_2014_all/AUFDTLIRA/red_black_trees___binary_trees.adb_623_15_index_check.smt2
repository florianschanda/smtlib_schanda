...
(assert (= (to_rep1 o1) 2))
(assert (= (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields2) v1))) o2))
(assert (= (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields2) v1))) o3))
(assert (= (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields2) v1))) o4))
(assert (= o1 o5))
(assert (= o6 o2))
(assert (= o7 o3))
(assert (= o8 o4))
...
(assert (= o10 v1))
(assert (= o11 (store (rec__binary_trees__forest__c f__split_fields2) o10 (mk___rep1 (mk___split_fields1 o6 o7 o8 o9)))))
(assert (= (rec__binary_trees__forest__s f__split_fields2) o12))
(assert (= o11 o13))
(assert (= temp___761 o12))
(assert (= temp___7611 o13))
(assert (= result4 (mk___split_fields__ref2 f__split_fields2)))
(assert (= f__split_fields4 (mk___split_fields2 temp___761 temp___7611)))
(assert (not (<= v1 100)))
(check-sat)
(exit)
