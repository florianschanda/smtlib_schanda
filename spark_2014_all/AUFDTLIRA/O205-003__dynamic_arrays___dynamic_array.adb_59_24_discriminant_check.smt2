...
(assert (and (= dynamic_array__B_2__hh__assume (new_holder c)) (and (dynamic_invariant2 dynamic_array__B_2__hh__assume true false true) (ite (= c 0) (= (to_rep (rec__dynamic_array__holder__d (us_split_discrs3 dynamic_array__B_2__hh__assume))) 0) (= (to_rep (rec__dynamic_array__holder__d (us_split_discrs3 dynamic_array__B_2__hh__assume))) c)))))
(assert (= dynamic_array__B_2__hh__assume hh))
(assert (dynamic_invariant2 hh true false true))
(assert (and (<= (to_rep1 (first (rt (rec__dynamic_array__holder__content (us_split_fields3 hh))))) i2) (<= i2 (to_rep1 (last1 (rt (rec__dynamic_array__holder__content (us_split_fields3 hh))))))))
(assert (= o30 i2))
(assert (= dynamic_array__B_2__r__assume (select (elts (rec__dynamic_array__holder__content (us_split_fields3 hh))) o30)))
(assert (= (mk___rep (us_split_discrs1 dynamic_array__B_2__r__assume) (us_split_fields1 dynamic_array__B_2__r__assume) false) r))
(assert (dynamic_invariant1 r true false true))
(assert (=> (<= 0 2147483647) (in_range2 f)))
(assert (=> (= (rec__dynamic_array__rec__b (us_split_discrs1 r)) true) (= result3 (mk_int__ref f))))
(assert (=> (= (rec__dynamic_array__rec__b (us_split_discrs1 r)) true) (= f1 (to_rep1 (rec__dynamic_array__rec__f1 (us_split_fields1 r))))))
(assert (=> (not (= (rec__dynamic_array__rec__b (us_split_discrs1 r)) true)) (= result4 (mk_int__ref f))))
(assert (=> (not (= (rec__dynamic_array__rec__b (us_split_discrs1 r)) true)) (= f2 (to_rep1 (rec__dynamic_array__rec__f2 (us_split_fields1 r))))))
(assert (=> (not (= (rec__dynamic_array__rec__b (us_split_discrs1 r)) true)) (= f1 f2)))
(assert (=> (< f1 c) (and (= o31 (+ f1 1)) (in_range1 (+ f1 1)))))
(assert (=> (< f1 c) (= result5 (mk_int__ref f1))))
(assert (=> (< f1 c) (= f3 o31)))
(assert (=> (not (< f1 c)) (= f3 f1)))
(assert (and (= us2 f3) (dynamic_property 0 last f3)))
(assert (= o32 f3))
(assert (= o33 (of_rep1 o32)))
(assert (= o34 (mk___split_fields o33 dummy3)))
(assert (= temp___205 (mk___rep (mk___split_discrs (of_int 1)) o34 true)))
(assert (= (attr__constrained (select (elts1 (rec__dynamic_array__holder__content1 h__split_fields3)) i2)) true))
(assert (not (= (rec__dynamic_array__rec__b (us_split_discrs1 temp___205)) (rec__dynamic_array__rec__b (us_split_discrs1 (select (elts1 (rec__dynamic_array__holder__content1 h__split_fields3)) i2))))))
(check-sat)
(exit)
