...
(declare-const temp___232 us_rep)
...
(assert (and (= dynamic_array__B_2__hh__assume (new_holder c)) (and (dynamic_invariant2 dynamic_array__B_2__hh__assume true false true true) (ite (= c 0) (= (to_rep (rec__dynamic_array__holder__d (us_split_discrs3 dynamic_array__B_2__hh__assume))) 0) (= (to_rep (rec__dynamic_array__holder__d (us_split_discrs3 dynamic_array__B_2__hh__assume))) c)))))
(assert (= dynamic_array__B_2__hh__assume hh))
(assert (dynamic_invariant2 hh true false true true))
...
(assert (= o19 i2))
(assert (= dynamic_array__B_2__r__assume (select (elts (rec__dynamic_array__holder__content (us_split_fields3 hh))) o19)))
...
(assert (=> (= (rec__dynamic_array__rec__b (us_split_discrs1 r)) true) (= result2 (mk_int__ref f))))
(assert (=> (= (rec__dynamic_array__rec__b (us_split_discrs1 r)) true) (= f1 (to_rep1 (rec__dynamic_array__rec__f1 (us_split_fields1 r))))))
(assert (=> (not (= (rec__dynamic_array__rec__b (us_split_discrs1 r)) true)) (= result3 (mk_int__ref f))))
...
(assert (= temp___232 (mk___rep (mk___split_discrs (distinct 1 0)) o23 true)))
(assert (= (attr__constrained (select (elts1 (rec__dynamic_array__holder__content1 h__split_fields3)) i2)) true))
(assert (not (= (rec__dynamic_array__rec__b (us_split_discrs1 temp___232)) (rec__dynamic_array__rec__b (us_split_discrs1 (select (elts1 (rec__dynamic_array__holder__content1 h__split_fields3)) i2))))))
(check-sat)
(exit)
