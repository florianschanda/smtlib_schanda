...
(assert (forall ((use_stack__stacks__top Int)) (forall ((use_stack__stacks__content (Array Int positive))) (! (=> (dynamic_invariant1 use_stack__stacks__top true true true) (= (peek use_stack__stacks__top use_stack__stacks__content) (to_rep1 (select use_stack__stacks__content use_stack__stacks__top)))) :pattern ((peek use_stack__stacks__top use_stack__stacks__content))))))
(assert true)
...
(assert (and (and (not (= (is_full top2) true)) (= (peek top1 content) e2)) (and (in_range e2) (dynamic_property 0 last top2))))
(assert (not (= e2 1)))
(check-sat)
(exit)
