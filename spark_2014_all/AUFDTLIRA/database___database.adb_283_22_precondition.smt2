...
(assert (and (= (mk___rep (mk___split_fields o6 o7)) (balance account links accounts_balance)) (= (mk___rep (mk___split_fields o6 o7)) (rec__database__account_balance__value (us_split_fields7 (select accounts_balance account))))))
(assert (= o6 o8))
(assert (= o7 o9))
(assert (= o10 o9))
(assert (= o11 (to_rep2 o10)))
(assert (= o12 (ite (= o11 0) true false)))
(assert (= result2 (ite (not (= o12 true)) true false)))
...
(assert (= (bool_eq1 (rec__database__account_rec__owner_id (us_split_fields5 (select accounts account))) 0 2 id 0 2) true))
