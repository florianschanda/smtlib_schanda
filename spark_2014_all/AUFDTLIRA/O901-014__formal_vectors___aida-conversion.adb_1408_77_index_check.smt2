...
(assert (and (= o56 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (= o57 (ite (<= o56 j) true false)))
(assert (= result6 (ite (= o57 true) (ite (<= j index3) true false) false)))
(assert (= result6 true))
(assert (and (<= (to_rep1 int_array__first) j) (<= j (to_rep1 int_array__last))))
(assert (= o58 j))
(assert (= o59 (select int_array1 o58)))
