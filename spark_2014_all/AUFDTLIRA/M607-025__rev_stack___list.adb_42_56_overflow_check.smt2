...
(assert (and (= o14 (length2 (mk___rep1 res__split_discrs res__split_fields2))) (and (in_range6 o14) (<= o14 (capacity (mk___rep1 res__split_discrs res__split_fields2))))))
...
(assert (=> (= result6 true) (and (= o8 (to__ (mk___rep s__split_fields9))) (and (dynamic_invariant1 o8 true false true) (and (= (to_rep (first (rt o8))) 1) (<= 0 (to_rep (last (rt o8)))))))))
