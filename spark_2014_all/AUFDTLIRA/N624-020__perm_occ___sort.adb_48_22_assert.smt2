...
(assert (= values1 o8))
(assert (not (= (is_set (mk___t (elts1 init) (mk (to_rep1 (first2 (rt1 init))) (to_rep1 (last2 (rt1 init))))) x (to_rep (select (elts1 init) y)) (mk___t values1 (mk (to_rep1 values__first) (to_rep1 values__last)))) true)))
(check-sat)
(exit)
