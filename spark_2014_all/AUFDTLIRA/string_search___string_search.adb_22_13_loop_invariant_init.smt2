...
(assert (=> (and (<= (to_rep1 (first (rt needle))) j2) (<= j2 (to_rep1 (last (rt needle))))) (= temp___266 j2)))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j2) (<= j2 (to_rep1 (last (rt needle))))) (= temp___265 diff2)))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j2) (<= j2 (to_rep1 (last (rt needle))))) (and (= temp___264 (+ j2 (- i1 1))) (in_range1 (+ j2 (- i1 1))))))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j2) (<= j2 (to_rep1 (last (rt needle))))) (and (<= (to_rep1 (first (rt haystack))) temp___264) (<= temp___264 (to_rep1 (last (rt haystack)))))))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j2) (<= j2 (to_rep1 (last (rt needle))))) (= o5 temp___264)))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j2) (<= j2 (to_rep1 (last (rt needle))))) (= o6 (select (elts haystack) o5))))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j2) (<= j2 (to_rep1 (last (rt needle))))) (= o7 (to_rep o6))))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j2) (<= j2 (to_rep1 (last (rt needle))))) (= o8 (ite (= (to_rep (select (elts needle) j2)) o7) true false))))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j2) (<= j2 (to_rep1 (last (rt needle))))) (= o9 (ite (not (= o8 true)) true false))))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j2) (<= j2 (to_rep1 (last (rt needle))))) (= diff2 result3)))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j2) (<= j2 (to_rep1 (last (rt needle))))) (= diff3 o9)))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j2) (<= j2 (to_rep1 (last (rt needle))))) (or (and (and (and (= j2 j7) (= diff3 diff8)) (and (= j8 j2) (= diff9 diff3))) (= diff3 true)) (and (not (= diff3 true)) (and (and (and (= (mk_int__ref j7) (mk_int__ref j5)) (= (mk_bool__ref diff8) (mk_bool__ref diff6))) (and (= j8 j6) (= diff9 diff7))) (and (and (= (partial_match_at needle haystack i1 j3) true) (= (= diff4 true) (not (= (to_rep (select (elts needle) j3)) (to_rep (select (elts haystack) (+ j3 (- i1 1)))))))) (and (and (=> (<= (to_rep1 (first (rt needle))) (to_rep1 (last (rt needle)))) (dynamic_property2 (to_rep1 (first (rt needle))) (to_rep1 (last (rt needle))) j3)) (and (<= (to_rep1 (first (rt needle))) j3) (<= j3 (to_rep1 (last (rt needle)))))) (or (and (and (and (= j3 j5) (= diff4 diff6)) (and (= j6 j3) (= diff7 diff4))) (= j3 (to_rep1 (last (rt needle))))) (and (not (= j3 (to_rep1 (last (rt needle))))) (and (and (and (= j4 j5) (= diff5 diff6)) (and (= j6 j4) (= diff7 diff5))) (and (and (= j3 result4) (= j4 (+ j3 1))) (and (and (and (and (and (and (and (and (= temp___2641 (+ j4 (- i1 1))) (in_range1 (+ j4 (- i1 1)))) (and (and (<= (to_rep1 (first (rt haystack))) temp___2641) (<= temp___2641 (to_rep1 (last (rt haystack))))) (= o14 temp___2641))) (= o15 (select (elts haystack) o14))) (= o16 (to_rep o15))) (= o17 (ite (= (to_rep (select (elts needle) j4)) o16) true false))) (= o18 (ite (not (= o17 true)) true false))) (and (= diff4 result5) (= diff5 o18))) (= diff5 true)))))))))))))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j2) (<= j2 (to_rep1 (last (rt needle))))) (= (mk_int__ref j9) (mk_int__ref j7))))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j2) (<= j2 (to_rep1 (last (rt needle))))) (= (mk_bool__ref diff10) (mk_bool__ref diff8))))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j2) (<= j2 (to_rep1 (last (rt needle))))) (= j10 j8)))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j2) (<= j2 (to_rep1 (last (rt needle))))) (= diff11 diff9)))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j2) (<= j2 (to_rep1 (last (rt needle))))) (= (mk_int__ref j11) (mk_int__ref j9))))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j2) (<= j2 (to_rep1 (last (rt needle))))) (= (mk_bool__ref diff12) (mk_bool__ref diff10))))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j2) (<= j2 (to_rep1 (last (rt needle))))) (= j12 j10)))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j2) (<= j2 (to_rep1 (last (rt needle))))) (= diff13 diff11)))
(assert (=> (not (and (<= (to_rep1 (first (rt needle))) j2) (<= j2 (to_rep1 (last (rt needle)))))) (= j2 j11)))
(assert (=> (not (and (<= (to_rep1 (first (rt needle))) j2) (<= j2 (to_rep1 (last (rt needle)))))) (= diff2 diff12)))
(assert (=> (not (and (<= (to_rep1 (first (rt needle))) j2) (<= j2 (to_rep1 (last (rt needle)))))) (= j12 j2)))
(assert (=> (not (and (<= (to_rep1 (first (rt needle))) j2) (<= j2 (to_rep1 (last (rt needle)))))) (= diff13 diff2)))
(assert (= diff12 true))
(assert (= string_search__brute_force__result3 (mk_int__ref string_search__brute_force__result)))
(assert (= string_search__brute_force__result4 string_search__brute_force__result1))
(declare-const k1 Int)
(assert (<= 1 k1))
(assert (<= k1 i1))
(assert (not (not (= (match_at needle haystack k1) true))))
(check-sat)
(exit)
