...
(assert (=> (and (<= (to_rep1 (first (rt needle))) j1) (<= j1 (to_rep1 (last (rt needle))))) (= temp___266 j1)))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j1) (<= j1 (to_rep1 (last (rt needle))))) (= temp___265 diff1)))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j1) (<= j1 (to_rep1 (last (rt needle))))) (and (= temp___264 (+ j1 (- i1 1))) (in_range1 (+ j1 (- i1 1))))))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j1) (<= j1 (to_rep1 (last (rt needle))))) (and (<= (to_rep1 (first (rt haystack))) temp___264) (<= temp___264 (to_rep1 (last (rt haystack)))))))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j1) (<= j1 (to_rep1 (last (rt needle))))) (= o5 temp___264)))
...
(assert (=> (and (<= (to_rep1 (first (rt needle))) j1) (<= j1 (to_rep1 (last (rt needle))))) (or (and (and (and (= j1 j6) (= diff2 diff7)) (and (= j7 j1) (= diff8 diff2))) (= diff2 true)) (and (not (= diff2 true)) (and (and (and (= j13 (mk_int__ref j4)) (= diff14 (mk_bool__ref diff5))) (and (= j7 j5) (= diff8 diff6))) (and (and (= (partial_match_at needle haystack i1 j2) true) (= (= diff3 true) (not (= (to_rep (select (elts needle) j2)) (to_rep (select (elts haystack) (+ j2 (- i1 1)))))))) (and (and (=> (<= (to_rep1 (first (rt needle))) (to_rep1 (last (rt needle)))) (dynamic_property2 (to_rep1 (first (rt needle))) (to_rep1 (last (rt needle))) j2)) (and (<= (to_rep1 (first (rt needle))) j2) (<= j2 (to_rep1 (last (rt needle)))))) (or (and (and (and (= j2 j4) (= diff3 diff5)) (and (= j5 j2) (= diff6 diff3))) (= j2 (to_rep1 (last (rt needle))))) (and (not (= j2 (to_rep1 (last (rt needle))))) (and (and (and (= j3 j4) (= diff4 diff5)) (and (= j5 j3) (= diff6 diff4))) (and (and (= j2 result4) (= j3 (+ j2 1))) (and (and (and (and (and (and (and (and (= temp___2641 (+ j3 (- i1 1))) (in_range1 (+ j3 (- i1 1)))) (and (and (<= (to_rep1 (first (rt haystack))) temp___2641) (<= temp___2641 (to_rep1 (last (rt haystack))))) (= o10 temp___2641))) (= o11 (select (elts haystack) o10))) (= o12 (to_rep o11))) (= o13 (ite (= (to_rep (select (elts needle) j3)) o12) true false))) (= o14 (ite (not (= o13 true)) true false))) (and (= diff3 result5) (= diff4 o14))) (= diff4 true)))))))))))))
