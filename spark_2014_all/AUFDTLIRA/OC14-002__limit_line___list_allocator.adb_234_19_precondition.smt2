...
(assert (and (= o58 (length (rec__list_allocator__m__t__available model____split_fields4))) (in_range6 o58)))
(assert (= o59 (ite (<= j o58) true false)))
(assert (= result10 (ite (<= 1 j) o59 false)))
(assert (= result10 true))
(assert (and (= o63 (get (rec__list_allocator__m__t__available model____split_fields4) j)) (in_range7 o63)))
...
(assert (=> (= result12 true) (and (= o62 (get (rec__list_allocator__m__t__available model____split_fields4) o61)) (in_range7 o62))))
