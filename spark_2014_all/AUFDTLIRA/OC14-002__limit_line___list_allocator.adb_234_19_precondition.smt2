...
(assert (and (= o63 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (in_range7 o63)))
...
(assert (=> (= result12 true) (and (= o62 (get (rec__list_allocator__m__t__available model____split_fields3) o61)) (in_range7 o62))))
