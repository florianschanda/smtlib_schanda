...
(declare-const dynamic_in_post__test_2__get_last__result Int)
(declare-const result Int)
(declare-const dynamic_in_post__test_2__get_last__result1 Int)
(declare-const dynamic_in_post__test_2__get_last__result2 Int)
(declare-const dynamic_in_post__test_2__get_last__result3 Int)
(declare-const dynamic_in_post__test_2__get_last__result4 Int)
(declare-const dynamic_in_post__test_2__get_last__result5 Int)
(assert (dynamic_invariant s true false true true))
(assert (= dynamic_in_post__test_2__get_last__result1 dynamic_in_post__test_2__get_last__result2))
(assert (= dynamic_in_post__test_2__get_last__result3 dynamic_in_post__test_2__get_last__result1))
(assert (= (mk_int__ref result) (mk_int__ref dynamic_in_post__test_2__get_last__result)))
(assert (= dynamic_in_post__test_2__get_last__result1 (to_rep1 (last (rt s)))))
(assert (= (mk_int__ref dynamic_in_post__test_2__get_last__result4) (mk_int__ref dynamic_in_post__test_2__get_last__result2)))
(assert (= dynamic_in_post__test_2__get_last__result5 dynamic_in_post__test_2__get_last__result3))
(assert (<= (to_rep1 (first (rt s))) (to_rep1 (last (rt s)))))
(assert (not (<= (to_rep1 (first (rt s))) (to_rep1 (first (rt s))))))
(check-sat)
(exit)
