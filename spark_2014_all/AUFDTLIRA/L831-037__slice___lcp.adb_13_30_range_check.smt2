...
(assert (=> (<= y r9b3) (and (and (<= (to_rep (first (rt a))) y) (<= y (to_rep (last (rt a))))) (and (<= (to_rep (first (rt a))) r9b3) (<= r9b3 (to_rep (last (rt a))))))))
(assert (= o17 (elts a)))
(assert (= temp___170 o17))
(assert (= temp___1701 (mk4 y r9b3)))
(assert (<= x r6b3))
