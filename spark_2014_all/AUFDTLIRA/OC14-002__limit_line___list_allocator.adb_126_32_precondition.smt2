...
(assert (=> (= result18 true) (=> (< 1 j1) (and (= o75 (- j1 1)) (in_range2 (- j1 1))))))
(assert (=> (= result18 true) (=> (< 1 j1) (and (= o76 (get (rec__list_allocator__m__t__allocated model____split_fields4) o75)) (in_range7 o76)))))
(assert (=> (= result18 true) (=> (not (< 1 j1)) (= o76 0))))
(assert (=> (= result18 true) (and (= temp___401 (get (rec__list_allocator__m__t__allocated model____split_fields4) j1)) (in_range7 temp___401))))
(assert (=> (= result18 true) (and (<= 1 temp___401) (<= temp___401 3))))
(assert (=> (= result18 true) (= o71 temp___401)))
(assert (=> (= result18 true) (= o72 (select data4 o71))))
(assert (=> (= result18 true) (= o73 (us_split_fields1 o72))))
(assert (=> (= result18 true) (= o74 (rec__list_allocator__cell__prev o73))))
(assert (=> (= result18 true) (= o77 (to_rep o74))))
(assert (=> (= result18 true) (= result17 (ite (= o77 o76) true false))))
...
(assert (= o68 (ite (<= k1 o67) true false)))
(assert (= result21 (ite (<= 1 k1) o68 false)))
(assert (= result21 true))
(assert (not (= j1 k1)))
(assert (and (= o69 (get (rec__list_allocator__m__t__allocated model____split_fields4) k1)) (in_range7 o69)))
(assert (not (<= 1 j1)))
(check-sat)
(exit)
