...
(assert (=> (= result13 true) (and (= temp___400 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (in_range7 temp___400))))
...
(assert (=> (= result12 true) (and (= temp___401 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (in_range7 temp___401))))
