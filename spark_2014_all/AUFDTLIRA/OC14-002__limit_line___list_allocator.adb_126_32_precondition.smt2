...
(assert (=> (= result13 true) (and (= o59 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range6 o59))))
(assert (=> (= result13 true) (= result14 (ite (< j o59) true false))))
(assert (=> (= result13 true) (=> (= result14 true) (and (= o60 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result13 true) (=> (= result14 true) (and (= o61 (get (rec__list_allocator__m__t__allocated model____split_fields3) o60)) (in_range7 o61)))))
(assert (=> (= result13 true) (=> (not (= result14 true)) (= o61 0))))
(assert (=> (= result13 true) (and (= temp___433 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (in_range7 temp___433))))
(assert (=> (= result13 true) (and (<= 1 temp___433) (<= temp___433 3))))
(assert (=> (= result13 true) (= o55 temp___433)))
(assert (=> (= result13 true) (= o56 (select data3 o55))))
(assert (=> (= result13 true) (= o57 (us_split_fields1 o56))))
(assert (=> (= result13 true) (= o58 (rec__list_allocator__cell__next o57))))
...
(assert (=> (= result12 true) (=> (< 1 j) (and (= o52 (- j 1)) (in_range2 (- j 1))))))
(assert (=> (= result12 true) (=> (< 1 j) (and (= o53 (get (rec__list_allocator__m__t__allocated model____split_fields3) o52)) (in_range7 o53)))))
(assert (=> (= result12 true) (=> (not (< 1 j)) (= o53 0))))
(assert (=> (= result12 true) (and (= temp___434 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (in_range7 temp___434))))
(assert (=> (= result12 true) (and (<= 1 temp___434) (<= temp___434 3))))
(assert (=> (= result12 true) (= o48 temp___434)))
(assert (=> (= result12 true) (= o49 (select data3 o48))))
(assert (=> (= result12 true) (= o50 (us_split_fields1 o49))))
(assert (=> (= result12 true) (= o51 (rec__list_allocator__cell__prev o50))))
...
(assert (not (= j k)))
(assert (and (= o47 (get (rec__list_allocator__m__t__allocated model____split_fields3) k)) (in_range7 o47)))
(assert (not (<= 1 j)))
(check-sat)
(exit)
