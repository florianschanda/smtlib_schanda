...
(assert (< ia3 (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w)))))
(assert (and (= o1 ia3) (in_range4 ia3)))
...
(assert (= result6 (mk_int__ref ih2)))
(assert (= ih3 o2))
(assert (= (of_int ih3) true))
(assert (and (= o3 ia3) (in_range4 ia3)))
...
(assert (and (= o10 ia3) (in_range4 ia3)))
(assert (and (= (mk___t o11 o12) (remove a o10)) (and (dynamic_invariant2 (mk___t o11 o12) true false true) (and (= (invariant__ (mk___t o11 o12)) true) (and (= (to_rep2 (last o12)) (- (to_rep2 (last (rt a))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- o10 1))) (= (to_rep (select (elts a) k1)) (to_rep (select o11 k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ o10 1) k1) (<= k1 (to_rep2 (last (rt a))))) (= (to_rep (select (elts a) k1)) (to_rep (select o11 (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= o10 k1) (<= k1 (- (to_rep2 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k1 1))) (to_rep (select o11 k1))))))))))))
(assert (and (= (mk___t o14 o15) (remove (mk___t o11 o12) o13)) (and (dynamic_invariant2 (mk___t o14 o15) true false true) (and (= (invariant__ (mk___t o14 o15)) true) (and (= (to_rep2 (last o15)) (- (to_rep2 (last o12)) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- o13 1))) (= (to_rep (select o11 k1)) (to_rep (select o14 k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ o13 1) k1) (<= k1 (to_rep2 (last o12)))) (= (to_rep (select o11 k1)) (to_rep (select o14 (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= o13 k1) (<= k1 (- (to_rep2 (last o12)) 1))) (= (to_rep (select o11 (+ k1 1))) (to_rep (select o14 k1))))))))))))
(assert (and (= (mk___t o8 o9) (remove bb ib7)) (and (dynamic_invariant2 (mk___t o8 o9) true false true) (and (= (invariant__ (mk___t o8 o9)) true) (and (= (to_rep2 (last o9)) (- (to_rep2 (last (rt bb))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- ib7 1))) (= (to_rep (select (elts bb) k1)) (to_rep (select o8 k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ ib7 1) k1) (<= k1 (to_rep2 (last (rt bb))))) (= (to_rep (select (elts bb) k1)) (to_rep (select o8 (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= ib7 k1) (<= k1 (- (to_rep2 (last (rt bb))) 1))) (= (to_rep (select (elts bb) (+ k1 1))) (to_rep (select o8 k1))))))))))))
(assert (and (= o5 ia3) (in_range4 ia3)))
(assert (and (= (mk___t o6 o7) (remove aa o5)) (and (dynamic_invariant2 (mk___t o6 o7) true false true) (and (= (invariant__ (mk___t o6 o7)) true) (and (= (to_rep2 (last o7)) (- (to_rep2 (last (rt aa))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- o5 1))) (= (to_rep (select (elts aa) k1)) (to_rep (select o6 k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ o5 1) k1) (<= k1 (to_rep2 (last (rt aa))))) (= (to_rep (select (elts aa) k1)) (to_rep (select o6 (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= o5 k1) (<= k1 (- (to_rep2 (last (rt aa))) 1))) (= (to_rep (select (elts aa) (+ k1 1))) (to_rep (select o6 k1))))))))))))
(assert (and (= o16 (shift_perm_l (mk___t o6 o7) (mk___t o8 o9) (mk___t o14 o15))) (and (in_range3 o16) (=> (= (of_int o16) true) (= (is_perm (mk___t o14 o15) (mk___t o8 o9)) true)))))
(assert (= result8 (mk_int__ref ih3)))
(assert (= ih4 o16))
(assert (= (of_int ih4) true))
(assert (not (< ib7 (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))))))
(assert (and (= o46 (+ ib7 1)) (in_range4 (+ ib7 1))))
(assert (= result11 (mk_int__ref ib7)))
(assert (= ib8 o46))
(assert (and (= o47 (remove_swap b (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) ib8)) (and (in_range3 o47) (=> (= (of_int o47) true) (= (let ((temp___157 (remove (remove b ib8) (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w)))))) (let ((temp___156 (remove (remove b (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w)))) (- ib8 1)))) (bool_eq (elts temp___156) (to_rep2 (first (rt temp___156))) (to_rep2 (last (rt temp___156))) (elts temp___157) (to_rep2 (first (rt temp___157))) (to_rep2 (last (rt temp___157)))))) true)))))
(assert (= result12 (mk_int__ref ih4)))
(assert (= ih7 o47))
(assert (= (of_int ih7) true))
(assert (and (= o54 (remove b ib8)) (and (dynamic_invariant2 o54 true false true) (and (= (invariant__ o54) true) (and (= (to_rep2 (last (rt o54))) (- (to_rep2 (last (rt b))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- ib8 1))) (= (to_rep (select (elts b) k1)) (to_rep (select (elts o54) k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ ib8 1) k1) (<= k1 (to_rep2 (last (rt b))))) (= (to_rep (select (elts b) k1)) (to_rep (select (elts o54) (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= ib8 k1) (<= k1 (- (to_rep2 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k1 1))) (to_rep (select (elts o54) k1))))))))))))
(assert (and (= o55 (remove o54 (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))))) (and (dynamic_invariant2 o55 true false true) (and (= (invariant__ o55) true) (and (= (to_rep2 (last (rt o55))) (- (to_rep2 (last (rt o54))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1))) (= (to_rep (select (elts o54) k1)) (to_rep (select (elts o55) k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1) k1) (<= k1 (to_rep2 (last (rt o54))))) (= (to_rep (select (elts o54) k1)) (to_rep (select (elts o55) (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) k1) (<= k1 (- (to_rep2 (last (rt o54))) 1))) (= (to_rep (select (elts o54) (+ k1 1))) (to_rep (select (elts o55) k1))))))))))))
(assert (and (= o52 (- ib8 1)) (in_range4 (- ib8 1))))
(assert (and (= o53 (remove bb o52)) (and (dynamic_invariant2 o53 true false true) (and (= (invariant__ o53) true) (and (= (to_rep2 (last (rt o53))) (- (to_rep2 (last (rt bb))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- o52 1))) (= (to_rep (select (elts bb) k1)) (to_rep (select (elts o53) k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ o52 1) k1) (<= k1 (to_rep2 (last (rt bb))))) (= (to_rep (select (elts bb) k1)) (to_rep (select (elts o53) (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= o52 k1) (<= k1 (- (to_rep2 (last (rt bb))) 1))) (= (to_rep (select (elts bb) (+ k1 1))) (to_rep (select (elts o53) k1))))))))))))
(assert (and (= o50 (- (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) 1)) (in_range4 (- (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) 1))))
(assert (and (= o48 ia3) (in_range4 ia3)))
(assert (and (= o49 (remove a o48)) (and (dynamic_invariant2 o49 true false true) (and (= (invariant__ o49) true) (and (= (to_rep2 (last (rt o49))) (- (to_rep2 (last (rt a))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- o48 1))) (= (to_rep (select (elts a) k1)) (to_rep (select (elts o49) k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ o48 1) k1) (<= k1 (to_rep2 (last (rt a))))) (= (to_rep (select (elts a) k1)) (to_rep (select (elts o49) (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= o48 k1) (<= k1 (- (to_rep2 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k1 1))) (to_rep (select (elts o49) k1))))))))))))
(assert (and (= o51 (remove o49 o50)) (and (dynamic_invariant2 o51 true false true) (and (= (invariant__ o51) true) (and (= (to_rep2 (last (rt o51))) (- (to_rep2 (last (rt o49))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- o50 1))) (= (to_rep (select (elts o49) k1)) (to_rep (select (elts o51) k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ o50 1) k1) (<= k1 (to_rep2 (last (rt o49))))) (= (to_rep (select (elts o49) k1)) (to_rep (select (elts o51) (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= o50 k1) (<= k1 (- (to_rep2 (last (rt o49))) 1))) (= (to_rep (select (elts o49) (+ k1 1))) (to_rep (select (elts o51) k1))))))))))))
(assert (and (= o56 (shift_perm_r o51 o53 o55)) (and (in_range3 o56) (=> (= (of_int o56) true) (= (is_perm o51 o55) true)))))
(assert (= result13 (mk_int__ref ih7)))
(assert (= ih8 o56))
(assert (= (of_int ih8) true))
(assert (= (is_perm (remove (remove a ia3) (- (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) 1)) (remove (remove b ib8) (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))))) true))
(assert (and (= o65 (remove b ib8)) (and (dynamic_invariant2 o65 true false true) (and (= (invariant__ o65) true) (and (= (to_rep2 (last (rt o65))) (- (to_rep2 (last (rt b))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- ib8 1))) (= (to_rep (select (elts b) k1)) (to_rep (select (elts o65) k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ ib8 1) k1) (<= k1 (to_rep2 (last (rt b))))) (= (to_rep (select (elts b) k1)) (to_rep (select (elts o65) (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= ib8 k1) (<= k1 (- (to_rep2 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k1 1))) (to_rep (select (elts o65) k1))))))))))))
(assert (not (in_range4 ia3)))
(check-sat)
(exit)
