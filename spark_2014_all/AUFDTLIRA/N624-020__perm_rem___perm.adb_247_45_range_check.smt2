...
(assert (and (= o30 (remove a o10)) (and (dynamic_invariant2 o30 true false true) (and (= (invariant__ o30) true) (and (= (to_rep2 (last o12)) (- (to_rep2 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o10 1))) (= (to_rep (select (elts a) k)) (to_rep (select o11 k))))) (and (forall ((k Int)) (=> (and (<= (+ o10 1) k) (<= k (to_rep2 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select o11 (- k 1)))))) (forall ((k Int)) (=> (and (<= o10 k) (<= k (- (to_rep2 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select o11 k))))))))))))
(assert (and (= o29 (remove o30 o13)) (and (dynamic_invariant2 o29 true false true) (and (= (invariant__ o29) true) (and (= (to_rep2 (last o15)) (- (to_rep2 (last o12)) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o13 1))) (= (to_rep (select o11 k)) (to_rep (select o14 k))))) (and (forall ((k Int)) (=> (and (<= (+ o13 1) k) (<= k (to_rep2 (last o12)))) (= (to_rep (select o11 k)) (to_rep (select o14 (- k 1)))))) (forall ((k Int)) (=> (and (<= o13 k) (<= k (- (to_rep2 (last o12)) 1))) (= (to_rep (select o11 (+ k 1))) (to_rep (select o14 k))))))))))))
(assert (and (= o31 (remove bb ib1)) (and (dynamic_invariant2 o31 true false true) (and (= (invariant__ o31) true) (and (= (to_rep2 (last o9)) (- (to_rep2 (last (rt bb))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib1 1))) (= (to_rep (select (elts bb) k)) (to_rep (select o8 k))))) (and (forall ((k Int)) (=> (and (<= (+ ib1 1) k) (<= k (to_rep2 (last (rt bb))))) (= (to_rep (select (elts bb) k)) (to_rep (select o8 (- k 1)))))) (forall ((k Int)) (=> (and (<= ib1 k) (<= k (- (to_rep2 (last (rt bb))) 1))) (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select o8 k))))))))))))
(assert (and (= o5 ia1) (in_range4 ia1)))
(assert (and (= o32 (remove aa o5)) (and (dynamic_invariant2 o32 true false true) (and (= (invariant__ o32) true) (and (= (to_rep2 (last o7)) (- (to_rep2 (last (rt aa))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o5 1))) (= (to_rep (select (elts aa) k)) (to_rep (select o6 k))))) (and (forall ((k Int)) (=> (and (<= (+ o5 1) k) (<= k (to_rep2 (last (rt aa))))) (= (to_rep (select (elts aa) k)) (to_rep (select o6 (- k 1)))))) (forall ((k Int)) (=> (and (<= o5 k) (<= k (- (to_rep2 (last (rt aa))) 1))) (= (to_rep (select (elts aa) (+ k 1))) (to_rep (select o6 k))))))))))))
(assert (and (= o16 (shift_perm_l o32 o31 o29)) (and (in_range3 o16) (=> (= (of_int o16) true) (= (is_perm o29 o31) true)))))
...
(assert (and (= o28 (remove b ib2)) (and (dynamic_invariant2 o28 true false true) (and (= (invariant__ o28) true) (and (= (to_rep2 (last (rt o28))) (- (to_rep2 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib2 1))) (= (to_rep (select (elts b) k)) (to_rep (select (elts o28) k))))) (and (forall ((k Int)) (=> (and (<= (+ ib2 1) k) (<= k (to_rep2 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select (elts o28) (- k 1)))))) (forall ((k Int)) (=> (and (<= ib2 k) (<= k (- (to_rep2 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select (elts o28) k))))))))))))
