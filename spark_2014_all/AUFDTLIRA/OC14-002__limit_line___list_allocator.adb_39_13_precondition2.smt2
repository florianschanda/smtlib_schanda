...
(assert (=> (not (= first_available 0)) (and (= o6 (length model____split_fields)) (in_range3 o6))))
(assert (=> (not (= first_available 0)) (= result2 (ite (< 0 o6) true false))))
(assert (=> (not (= first_available 0)) (=> (= result2 true) (and (= o5 (get model____split_fields 1)) (in_range4 o5)))))
...
(assert (=> (not (not (= first_available 0))) (and (= o7 (length model____split_fields)) (in_range3 o7))))
(assert (=> (not (not (= first_available 0))) (= result1 (ite (= o7 0) true false))))
(assert (=> (= result1 true) (=> (not (= first_allocated 0)) (and (= o3 (length model____split_fields1)) (in_range3 o3)))))
(assert (=> (= result1 true) (=> (not (= first_allocated 0)) (= result3 (ite (< 0 o3) true false)))))
(assert (=> (= result1 true) (=> (not (= first_allocated 0)) (=> (= result3 true) (and (= o2 (get model____split_fields1 1)) (in_range4 o2))))))
...
(assert (=> (= result1 true) (=> (not (not (= first_allocated 0))) (and (= o4 (length model____split_fields1)) (in_range3 o4)))))
