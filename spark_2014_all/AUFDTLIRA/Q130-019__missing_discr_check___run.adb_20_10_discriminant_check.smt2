...
(define-fun o13 () us_rep (mk___rep (mk___split_discrs o9) (mk___split_fields o10 o11) o12))
...
(assert (= o7 o3))
(assert (= true o8))
(assert (= o13 (mk___rep (mk___split_discrs o5) (mk___split_fields o6 o7) o8)))
(assert (= temp___2384 o13))
...
(assert (= y2__attr__constrained true))
(assert (not (= (rec__p_init__t__e (us_split_discrs1 temp___220)) y2__split_discrs)))
(check-sat)
(exit)
