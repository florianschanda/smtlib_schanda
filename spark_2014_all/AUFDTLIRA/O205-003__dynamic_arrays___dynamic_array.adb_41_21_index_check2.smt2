...
(assert (= result2 true))
(assert (and (= o19 (new_holder c)) (and (dynamic_invariant1 o19 true false true true) (ite (= c 0) (= (to_rep (rec__dynamic_array__holder__d (us_split_discrs3 o19))) 0) (= (to_rep (rec__dynamic_array__holder__d (us_split_discrs3 o19))) c)))))
(assert (= o20 (us_split_fields3 o19)))
(assert (= temp___247 (rec__dynamic_array__holder__content o20)))
(assert (and (<= (to_rep1 (first (rt temp___247))) j) (<= j (to_rep1 (last1 (rt temp___247))))))
(assert (= o21 j))
(assert (= o22 (select (elts temp___247) o21)))
