...
(assert (and (and (forall ((temp___665 Int)) (=> (and (<= (to_rep1 ret__first) temp___665) (<= temp___665 (to_rep1 ret__last))) (=> (< idx2 temp___665) (= (select ret4 temp___665) (select ret1 temp___665))))) (=> (<= (to_rep1 (first (rt str))) (to_rep1 (last (rt str)))) (dynamic_property3 (to_rep1 (first (rt str))) (to_rep1 (last (rt str))) idx2))) (and (<= (to_rep1 (first (rt str))) idx2) (<= idx2 (to_rep1 (last (rt str)))))))
...
(assert (=> (and (not (and (<= 65 (to_rep (select (elts str) idx2))) (<= (to_rep (select (elts str) idx2)) 90))) (not (and (<= 97 (to_rep (select (elts str) idx2))) (<= (to_rep (select (elts str) idx2)) 122)))) (= to_up3 (distinct 1 0))))
...
(assert (=> (not (and (not (and (<= 65 (to_rep (select (elts str) idx2))) (<= (to_rep (select (elts str) idx2)) 90))) (not (and (<= 97 (to_rep (select (elts str) idx2))) (<= (to_rep (select (elts str) idx2)) 122))))) (= to_up4 (distinct 0 0))))
