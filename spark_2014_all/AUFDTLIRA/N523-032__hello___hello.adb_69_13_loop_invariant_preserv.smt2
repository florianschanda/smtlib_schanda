...
(assert (forall ((j Int)) (=> (and (<= idx2 j) (<= j (to_rep1 (last (rt str))))) (=> (< idx2 j) (= (to_rep (select ret4 j)) (to_rep (select (elts str) j)))))))
(assert (and (and (forall ((temp___596 Int)) (=> (and (<= (to_rep1 ret__first) temp___596) (<= temp___596 (to_rep1 ret__last))) (=> (< idx2 temp___596) (= (select ret4 temp___596) (select ret1 temp___596))))) (=> (<= (to_rep1 (first (rt str))) (to_rep1 (last (rt str)))) (dynamic_property3 (to_rep1 (first (rt str))) (to_rep1 (last (rt str))) idx2))) (and (<= (to_rep1 (first (rt str))) idx2) (<= idx2 (to_rep1 (last (rt str)))))))
...
(assert (= idx2 result7))
(assert (= idx3 (+ idx2 1)))
(assert (=> (= to_up3 true) (and (= o6 (to_upper (to_rep (select ret4 idx3)))) (in_range3 o6))))
(assert (=> (= to_up3 true) (= (to_rep o7) o6)))
(assert (=> (= to_up3 true) (= o8 (store ret4 idx3 o7))))
(assert (=> (= to_up3 true) (= ret4 result8)))
(assert (=> (= to_up3 true) (= ret5 o8)))
(assert (=> (not (= to_up3 true)) (and (= o9 (to_lower (to_rep (select ret4 idx3)))) (in_range3 o9))))
(assert (=> (not (= to_up3 true)) (= (to_rep o10) o9)))
(assert (=> (not (= to_up3 true)) (= o11 (store ret4 idx3 o10))))
(assert (=> (not (= to_up3 true)) (= ret4 result9)))
(assert (=> (not (= to_up3 true)) (= ret6 o11)))
...
(assert (< idx3 j))
(assert (not (= (to_rep (select ret5 j)) (to_rep (select (elts str) j)))))
(check-sat)
(exit)
