...
(assert (= result true))
(assert (and (= temp___1281 (model__ f root)) (and (dynamic_invariant4 temp___1281 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1281 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1281 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent f i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1281 (parent f i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1281 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1281 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1281 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1281 (parent f i1)))) (position f i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1281 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1281 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1281 i1))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1281 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1281 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1281 j1)))) true)) (= j1 i1))))))))))))))
(assert (= (mk___rep (mk___split_fields o o1)) (select temp___1281 i)))
(assert (= o o2))
(assert (= o1 o3))
(assert (= result1 o3))
(assert (= result1 true))
