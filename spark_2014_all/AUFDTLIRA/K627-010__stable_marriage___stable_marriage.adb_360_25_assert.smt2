...
(assert (<= 1 g1_id3))
(assert (<= g1_id3 64))
(assert (= (to_rep3 (select proposals_made1 g1_id3)) 0))
(assert (not (exists ((idx3 Int)) (and (and (<= 1 idx3) (<= idx3 (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields4)))) (= (to_rep (select (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields4) idx3)) g1_id3)))))
(check-sat)
(exit)
