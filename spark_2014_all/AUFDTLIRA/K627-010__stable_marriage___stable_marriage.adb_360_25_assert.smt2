...
(assert (forall ((g1_id Int)) (=> (and (<= 1 g1_id) (<= g1_id 64)) (forall ((rank3 Int)) (=> (and (<= 1 rank3) (<= rank3 (to_rep3 (select proposals_made1 g1_id)))) (and (not (= (select unmatched_g2_set2 (to_rep1 (select (select ranking_1 g1_id) rank3))) true)) (=> (not (= (to_rep (select result__2 (to_rep1 (select (select ranking_1 g1_id) rank3)))) g1_id)) (not (= (is_preferred_1 g1_id (to_rep (select result__2 (to_rep1 (select (select ranking_1 g1_id) rank3)))) (select ranking_2 (to_rep1 (select (select ranking_1 g1_id) rank3)))) true)))))))))
(declare-const g1_id Int)
(assert (<= 1 g1_id))
(assert (<= g1_id 64))
(assert (= (to_rep3 (select proposals_made1 g1_id)) 0))
(assert (not (exists ((idx Int)) (and (and (<= 1 idx) (<= idx (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields4)))) (= (to_rep (select (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields4) idx)) g1_id)))))
(check-sat)
(exit)
