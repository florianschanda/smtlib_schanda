...
(assert (=> (and (<= 1 j2) (<= j2 i)) (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- j3 1))) (= (to_rep (select r2 k1)) (to_rep (select b k1)))))))
...
(assert (<= (+ i 1) j8))
(assert (<= j8 8))
(assert (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 i)) (= (to_rep (select r8 k1)) (to_rep (select b k1))))))
(assert (and (and (forall ((temp___208 Int)) (=> (and (<= 1 temp___208) (<= temp___208 8)) (=> (or (< 8 temp___208) (or (< temp___208 (+ i 1)) (<= j9 temp___208))) (= (select r8 temp___208) (select r6 temp___208))))) (=> (<= (+ i 1) 8) (dynamic_property1 (+ i 1) 8 j9))) (and (<= (+ i 1) j9) (<= j9 8))))
(assert (<= 1 k))
(assert (<= k i))
(assert (and (<= 1 k) (<= k 8)))
(assert (= o2 k))
