...
(assert (=> (and (= result__1 0) (< 0 (to_rep (rec__static_discr__holder__length current__split_fields5)))) (= temp___343 result__1)))
(assert (=> (and (= result__1 0) (< 0 (to_rep (rec__static_discr__holder__length current__split_fields5)))) (and (= current__split_discrs (mk___split_discrs1 temp___342 temp___3421)) (= current__split_fields5 (mk___split_fields2 (mk___rep1 (mk___split_discrs temp___3422 temp___3423) (mk___split_fields1 (mk___t1 temp___3424 temp___3425))) temp___3426)))))
(assert (=> (and (= result__1 0) (< 0 (to_rep (rec__static_discr__holder__length current__split_fields5)))) (and (and (and (<= 1 (to_rep (rec__static_discr__holder__length current__split_fields6))) (<= (to_rep (rec__static_discr__holder__length current__split_fields6)) (to_rep (rec__static_discr__holder__length (us_split_fields5 a))))) (= (let ((temp___349 (rec__static_discr__i_holder__content1 (us_split_fields3 (rec__static_discr__holder__content current__split_fields6))))) (let ((temp___348 (rec__static_discr__i_holder__content1 (us_split_fields3 (rec__static_discr__holder__content (us_split_fields5 a)))))) (bool_eq (elts1 temp___348) (to_rep1 (first2 (rt1 temp___348))) (to_rep1 (last2 (rt1 temp___348))) (elts1 temp___349) (to_rep1 (first2 (rt1 temp___349))) (to_rep1 (last2 (rt1 temp___349)))))) true)) (forall ((i Int)) (=> (and (<= (+ (to_rep (rec__static_discr__holder__length current__split_fields6)) 1) i) (<= i (to_rep (rec__static_discr__holder__length (us_split_fields5 a))))) (not (= (to_rep (select (elts1 (rec__static_discr__i_holder__content1 (us_split_fields3 (rec__static_discr__holder__content (us_split_fields5 a))))) i)) e)))))))
...
(assert (=> (and (= result__1 0) (< 0 (to_rep (rec__static_discr__holder__length current__split_fields5)))) (and (= us4 r54b) (in_range2 r54b))))
(assert (=> (and (= result__1 0) (< 0 (to_rep (rec__static_discr__holder__length current__split_fields5)))) (and (= us5 r53b) (in_range2 r53b))))
(assert (=> (and (= result__1 0) (< 0 (to_rep (rec__static_discr__holder__length current__split_fields5)))) (= (let ((temp___341 (rec__static_discr__i_holder__content3 (us_split_fields9 (of_base2 (to_base (rec__static_discr__holder__content current__split_fields7))))))) (let ((temp___340 (rec__static_discr__i_holder__content2 (us_split_fields7 (of_base1 (to_base (rec__static_discr__holder__content (us_split_fields5 a)))))))) (bool_eq (elts2 temp___340) (to_rep1 (first4 (rt2 temp___340))) (to_rep1 (last4 (rt2 temp___340))) (elts3 temp___341) (to_rep1 (first6 (rt3 temp___341))) (to_rep1 (last6 (rt3 temp___341)))))) true)))
