...
(assert (and (and (and (= us (to_rep (rec__static_discr__holder__c (us_split_discrs4 a)))) (in_range2 (to_rep (rec__static_discr__holder__c (us_split_discrs4 a))))) (and (and (= us1 (to_rep (rec__static_discr__holder__unused (us_split_discrs4 a)))) (in_range2 (to_rep (rec__static_discr__holder__unused (us_split_discrs4 a))))) (and (and (and (= (mk___split_fields__ref2 (mk___split_fields2 (mk___rep1 (mk___split_discrs result result1) (mk___split_fields1 (mk___t1 result2 result3))) result4)) (mk___split_fields__ref2 (mk___split_fields2 (mk___rep1 (mk___split_discrs current__split_fields current__split_fields1) (mk___split_fields1 (mk___t1 current__split_fields2 current__split_fields3))) current__split_fields4))) (= current__split_fields5 (us_split_fields5 a))) (= current__split_discrs (us_split_discrs4 a))) (and (dynamic_invariant1 (mk___rep2 current__split_discrs current__split_fields5) true false true) (and (and (= result5 (mk_int__ref result__)) (= result__1 0)) (and (in_range2 result__1) (and (ite (and (= result__1 0) (< 0 (to_rep (rec__static_discr__holder__length current__split_fields5)))) (and (and (and (= temp___343 result__1) (and (and (= current__split_discrs (mk___split_discrs1 temp___342 temp___3421)) (= current__split_fields5 (mk___split_fields2 (mk___rep1 (mk___split_discrs temp___3422 temp___3423) (mk___split_fields1 (mk___t1 temp___3424 temp___3425))) temp___3426))) (and (and (and (and (<= 1 (to_rep (rec__static_discr__holder__length current__split_fields6))) (<= (to_rep (rec__static_discr__holder__length current__split_fields6)) (to_rep (rec__static_discr__holder__length (us_split_fields5 a))))) (= (let ((temp___349 (rec__static_discr__i_holder__content1 (us_split_fields3 (rec__static_discr__holder__content current__split_fields6))))) (let ((temp___348 (rec__static_discr__i_holder__content1 (us_split_fields3 (rec__static_discr__holder__content (us_split_fields5 a)))))) (bool_eq (elts1 temp___348) (to_rep1 (first2 (rt1 temp___348))) (to_rep1 (last2 (rt1 temp___348))) (elts1 temp___349) (to_rep1 (first2 (rt1 temp___349))) (to_rep1 (last2 (rt1 temp___349)))))) true)) (forall ((i2 Int)) (=> (and (<= (+ (to_rep (rec__static_discr__holder__length current__split_fields6)) 1) i2) (<= i2 (to_rep (rec__static_discr__holder__length (us_split_fields5 a))))) (not (= (to_rep (select (elts1 (rec__static_discr__i_holder__content1 (us_split_fields3 (rec__static_discr__holder__content (us_split_fields5 a))))) i2)) e))))) (and (and (and (dynamic_invariant1 (mk___rep2 current__split_discrs current__split_fields6) false true true) (=> (<= 0 2147483647) (in_range2 result__2))) (and (= result__2 0) (< 0 (to_rep (rec__static_discr__holder__length current__split_fields6))))) (and (= (to_rep (rec__static_discr__holder__unused current__split_discrs)) (to_rep (rec__static_discr__holder__unused (us_split_discrs4 a)))) (and (and (and (= (let ((temp___268 (rec__static_discr__i_holder__content1 (us_split_fields3 (rec__static_discr__holder__content current__split_fields6))))) (let ((temp___267 (rec__static_discr__i_holder__content1 (us_split_fields3 (rec__static_discr__holder__content current__split_fields7))))) (bool_eq (elts1 temp___267) (to_rep1 (first2 (rt1 temp___267))) (to_rep1 (last2 (rt1 temp___267))) (elts1 temp___268) (to_rep1 (first2 (rt1 temp___268))) (to_rep1 (last2 (rt1 temp___268)))))) true) (and (< (to_rep (rec__static_discr__holder__length current__split_fields7)) (to_rep (rec__static_discr__holder__length current__split_fields6))) (ite (= result__3 0) (forall ((i2 Int)) (=> (and (<= (+ (to_rep (rec__static_discr__holder__length current__split_fields7)) 1) i2) (<= i2 (to_rep (rec__static_discr__holder__length current__split_fields6)))) (not (= (to_rep (select (elts1 (rec__static_discr__i_holder__content1 (us_split_fields3 (rec__static_discr__holder__content current__split_fields7)))) i2)) e)))) (and (and (<= (to_rep (rec__static_discr__holder__length current__split_fields7)) result__3) (<= result__3 (to_rep (rec__static_discr__holder__length current__split_fields6)))) (= (to_rep (select (elts1 (rec__static_discr__i_holder__content1 (us_split_fields3 (rec__static_discr__holder__content current__split_fields7)))) result__3)) e))))) (and (dynamic_invariant1 (mk___rep2 current__split_discrs current__split_fields7) true true true) (in_range2 result__3))) (and (= (to_rep (rec__static_discr__holder__unused current__split_discrs)) (to_rep (rec__static_discr__holder__unused (us_split_discrs4 a)))) (and (and (and (= us2 (to_rep (rec__static_discr__holder__c (us_split_discrs4 a)))) (in_range2 (to_rep (rec__static_discr__holder__c (us_split_discrs4 a))))) (and (= us3 (to_rep (rec__static_discr__holder__unused (us_split_discrs4 a)))) (in_range2 (to_rep (rec__static_discr__holder__unused (us_split_discrs4 a)))))) (and (and (= (to_rep (rec__static_discr__holder__unused current__split_discrs)) r53b) (in_range2 r53b)) (and (and (= (to_rep (rec__static_discr__holder__c current__split_discrs)) r54b) (in_range2 r54b)) (and (and (and (= us4 r54b) (in_range2 r54b)) (and (= us5 r53b) (in_range2 r53b))) (and (= (let ((temp___341 (rec__static_discr__i_holder__content3 (us_split_fields9 (of_base2 (to_base (rec__static_discr__holder__content current__split_fields7))))))) (let ((temp___340 (rec__static_discr__i_holder__content2 (us_split_fields7 (of_base1 (to_base (rec__static_discr__holder__content (us_split_fields5 a)))))))) (bool_eq (elts2 temp___340) (to_rep1 (first4 (rt2 temp___340))) (to_rep1 (last4 (rt2 temp___340))) (elts3 temp___341) (to_rep1 (first6 (rt3 temp___341))) (to_rep1 (last6 (rt3 temp___341)))))) true) (not (and (= result__3 0) (< 0 (to_rep (rec__static_discr__holder__length current__split_fields7))))))))))))))))) (and (and (= result__6 (mk_int__ref result__3)) (= current__split_fields10 (mk___split_fields__ref2 current__split_fields7))) (and (= result__7 result__3) (= current__split_fields11 current__split_fields7)))) (and (and (= result__8 result__6) (= current__split_fields12 current__split_fields10)) (and (= result__9 result__7) (= current__split_fields13 current__split_fields11)))) (and (and (= result__8 (mk_int__ref result__1)) (= current__split_fields12 (mk___split_fields__ref2 current__split_fields5))) (and (= result__9 result__1) (= current__split_fields13 current__split_fields5)))) (and (and (= static_discr__search__result2 (mk_int__ref static_discr__search__result1)) (= static_discr__search__result3 static_discr__search__result1)) (and (= result7 (mk_int__ref static_discr__search__result)) (= static_discr__search__result1 (int__content result__8))))))))))) (and (and (= static_discr__search__result4 static_discr__search__result2) (and (= result__10 result__8) (= current__split_fields14 current__split_fields12))) (and (= static_discr__search__result5 static_discr__search__result3) (and (= result__11 result__9) (= current__split_fields15 current__split_fields13))))))
(assert (= result8 (int__content static_discr__search__result4)))
(assert (not (<= (int__content static_discr__search__result4) (to_rep (rec__static_discr__holder__length (us_split_fields5 a))))))
(check-sat)
(exit)
