...
(assert (=> (and (<= 1 ki3) (<= ki3 100)) (and (=> (<= 1 100) (in_range1 ki4)) (and (<= 1 ki4) (<= ki4 100)))))
(assert (=> (and (<= 1 ki3) (<= ki3 100)) (= ki4 100)))
(assert (=> (and (<= 1 ki3) (<= ki3 100)) (= ki6 (mk_int__ref ki4))))
(assert (=> (and (<= 1 ki3) (<= ki3 100)) (= ki7 ki4)))
(assert (=> (and (<= 1 ki3) (<= ki3 100)) (= ki8 ki6)))
(assert (=> (and (<= 1 ki3) (<= ki3 100)) (= ki9 ki7)))
(assert (=> (not (and (<= 1 ki3) (<= ki3 100))) (= ki8 (mk_int__ref ki3))))
(assert (=> (not (and (<= 1 ki3) (<= ki3 100))) (= ki9 ki3)))
(assert (not (= n2 100)))
(assert (= result44 (mk_int__ref n2)))
(assert (= n3 (+ n2 1)))
(assert (= ki10 ki8))
...
(assert (<= 1 i15))
(assert (<= i15 100))
(assert (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) v) i15))) true))
(assert (<= (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) v) i15)))) (- (int__content n4) 1)))
...
(assert (not (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root) i15))) true)))
(check-sat)
(exit)
