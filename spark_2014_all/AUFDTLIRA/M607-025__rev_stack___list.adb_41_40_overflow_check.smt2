...
(assert (=> (= result6 true) (and (= o7 (- last5 i9)) (in_range1 (- last5 i9)))))
(assert (=> (= result6 true) (= o8 (+ o7 1))))
(assert (=> (= result6 true) (and (= o9 o8) (in_range1 o8))))
(assert (=> (= result6 true) (and (= o6 (to__ (mk___rep s__split_fields9))) (and (dynamic_invariant1 o6 true false true true) (and (= (to_rep (first (rt o6))) 1) (<= 0 (to_rep (last (rt o6)))))))))
...
(assert (=> (= result5 true) (and (= o2 (- last5 i9)) (in_range1 (- last5 i9)))))
...
(assert (=> (= result5 true) (= (= result4 true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (+ (- last5 i9) 1))) (= (to_rep (select (elts (to__ (mk___rep s__split_fields9))) j1)) (to_rep (select (elts (to__ (mk___rep (us_split_fields__content s__split_fields7)))) j1))))))))
