...
(declare-const temp___7977 (Array Int et1))
(declare-const temp___79771 enum2t)
(declare-const o4 enum2t)
(declare-const o5 (Array Int et1))
(declare-const o6 enum2t)
(declare-const temp___7979 (Array Int et1))
(declare-const temp___79791 enum2t)
...
(assert (= temp___7977 o2))
(assert (= temp___79771 o3))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= temp___7977 r__split_fields2))
(assert (= temp___79771 r__split_fields3))
(assert (= (to_rep1 o4) f))
(assert (= r__split_fields2 o5))
(assert (= o4 o6))
(assert (= temp___7979 o5))
(assert (= temp___79791 o6))
(assert (= result2 r__split_fields2))
(assert (= result3 r__split_fields3))
(assert (= temp___7979 r__split_fields4))
(assert (= temp___79791 r__split_fields5))
...
(assert (<= n 10))
(assert (not (= n i)))
(assert (not (= (to_rep (select r__split_fields6 n)) (to_rep (select r__split_fields n)))))
(check-sat)
(exit)
