...
(assert (dynamic_predicate1 (mk___rep1 (mk___split_discrs temp___221) (mk___split_fields1 temp___2211))))
(assert (= (mk___rep1 (mk___split_discrs o4) (mk___split_fields1 o5)) (mk___rep1 (mk___split_discrs temp___221) (mk___split_fields1 temp___2211))))
...
(assert (= (mk___rep1 (mk___split_discrs temp___222) (mk___split_fields1 temp___2221)) (mk___rep1 (mk___split_discrs o8) (mk___split_fields1 o9))))
(assert (dynamic_predicate (mk___rep1 (mk___split_discrs temp___222) (mk___split_fields1 temp___2221))))
(assert (= with_iterable__set_to_0__first__assume (mk___rep1 (mk___split_discrs temp___222) (mk___split_fields1 temp___2221))))
