...
(define-fun d__split_discrs2 () us_split_discrs (mk___split_discrs d__split_discrs1))
(define-fun d__split_fields8 () us_split_fields (mk___split_fields d__split_fields4 d__split_fields5 d__split_fields6 d__split_fields7))
...
(assert (= d__split_fields8 (us_split_fields1 (select decision_table root_id))))
(assert (= (mk___split_discrs__ref (mk___split_discrs result4)) (mk___split_discrs__ref (mk___split_discrs d__split_discrs))))
(assert (= d__split_discrs2 (us_split_discrs1 (select decision_table root_id))))
...
(assert (not (= kind1 1)))
(assert (= kind1 2))
(assert (and (= o (decision_eval (to_rep2 d__split_fields7) decision_table condition_values)) (and (in_range1 o) (not (= o 2)))))
(assert (not (var__decision__left__pred (mk___rep d__split_discrs2 d__split_fields8 d__attr__constrained))))
(check-sat)
(exit)
