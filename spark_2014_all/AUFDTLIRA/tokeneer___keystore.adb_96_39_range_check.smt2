...
(assert (not (= (length (mk___t temp___1883 temp___18831)) 0)))
(assert (=> (<= 1 3) (= o6 (+ (- 3 1) 1))))
(assert (=> (not (<= 1 3)) (= o6 0)))
(assert (=> (<= (to_rep1 (first temp___18831)) (to_rep1 (last temp___18831))) (= o7 (+ (- (to_rep1 (last temp___18831)) (to_rep1 (first temp___18831))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___18831)) (to_rep1 (last temp___18831)))) (= o7 0)))
(assert (= o8 (+ o7 o6)))
(assert (= o9 (+ (to_rep1 (first temp___18831)) o8)))
(assert (= o10 (- o9 1)))
