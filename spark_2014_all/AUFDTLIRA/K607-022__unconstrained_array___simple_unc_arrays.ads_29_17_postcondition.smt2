...
(declare-const temp___908 (Array Int value))
(declare-const temp___9081 t1)
(declare-const temp___901 natural)
(declare-const temp___9011 (Array Int value))
(declare-const temp___9012 t1)
(declare-const temp___900 Int)
(declare-const temp___904 (Array Int value))
(declare-const temp___9041 t1)
...
(assert (=> (< low1 high1) (and (= a__split_fields temp___908) (= a__split_fields1 temp___9081))))
(assert (=> (< low1 high1) (and (= a__split_discrs (mk___split_discrs temp___901)) (and (= a__split_fields temp___9011) (= a__split_fields1 temp___9012)))))
(assert (=> (< low1 high1) (= temp___900 high1)))
(assert (=> (< low1 high1) (and (= a__split_fields temp___904) (= a__split_fields1 temp___9041))))
(assert (=> (< low1 high1) (= temp___899 low1)))
(assert (=> (< low1 high1) (and (forall ((j Int)) (=> (and (<= 1 j) (<= j (- low2 1))) (= (to_rep2 (select a__split_fields4 j)) (to_rep2 (select temp___904 (+ (- (to_rep (rec__simple_unc_arrays__table__last a__split_discrs)) j) 1)))))) (forall ((j Int)) (=> (and (<= (- low2 1) j) (<= j (to_rep (rec__simple_unc_arrays__table__last a__split_discrs)))) (= (to_rep2 (select a__split_fields4 j)) (to_rep2 (select temp___908 j))))))))
(assert (=> (< low1 high1) (and (and (and (and (=> (<= 1 2147483647) (in_range3 low2)) (=> (<= 0 2147483647) (in_range2 high2))) (dynamic_invariant2 (mk___rep a__split_discrs (mk___split_fields (mk___t1 a__split_fields4 a__split_fields5))) true true true true)) (= (rec__simple_unc_arrays__table__last a__split_discrs) temp___901)) (< low2 high2))))
(assert (=> (< low1 high1) (= (to_rep (rec__simple_unc_arrays__table__last a__split_discrs)) r22b)))
(assert (=> (< low1 high1) (in_range2 r22b)))
(assert (=> (< low1 high1) (= (ite (<= (to_rep1 (first2 a__split_fields5)) (to_rep1 (last2 a__split_fields5))) (+ (- (to_rep1 (last2 a__split_fields5)) (to_rep1 (first2 a__split_fields5))) 1) 0) (ite (<= 1 r22b) (+ (- r22b 1) 1) 0))))
(assert (=> (< low1 high1) (= a__split_fields4 simple_unc_arrays__swap_cells__a__compl)))
(assert (=> (< low1 high1) (= (mk2 (to_rep1 (first2 a__split_fields5)) (to_rep1 (last2 a__split_fields5))) simple_unc_arrays__swap_cells__a__compl1)))
(assert (=> (< low1 high1) (and (= o2 high2) (in_range3 high2))))
(assert (=> (< low1 high1) (= (to_rep1 o1) (to_rep1 (last4 simple_unc_arrays__swap_cells__a__compl1)))))
(assert (=> (< low1 high1) (= (to_rep1 o) (to_rep1 (first4 simple_unc_arrays__swap_cells__a__compl1)))))
(assert (=> (< low1 high1) (and (and (= (to_rep2 (select simple_unc_arrays__swap_cells__a low2)) (to_rep2 (select simple_unc_arrays__swap_cells__a__compl o2))) (= (to_rep2 (select simple_unc_arrays__swap_cells__a o2)) (to_rep2 (select simple_unc_arrays__swap_cells__a__compl low2)))) (forall ((k Int)) (=> (and (<= (to_rep1 o) k) (<= k (to_rep1 o1))) (=> (and (not (= k low2)) (not (= k o2))) (= (to_rep2 (select simple_unc_arrays__swap_cells__a k)) (to_rep2 (select simple_unc_arrays__swap_cells__a__compl k)))))))))
(assert (=> (< low1 high1) (= result2 a__split_fields4)))
(assert (=> (< low1 high1) (= result3 a__split_fields5)))
(assert (=> (< low1 high1) (= a__split_fields6 (mk___split_fields (mk___t1 (slide simple_unc_arrays__swap_cells__a (to_rep1 (first (mk (to_rep1 (first4 simple_unc_arrays__swap_cells__a__compl1)) (to_rep1 (last4 simple_unc_arrays__swap_cells__a__compl1))))) 1) (mk1 (to_rep1 (first4 (mk2 1 r22b))) (to_rep1 (last4 (mk2 1 r22b)))))))))
(assert (=> (< low1 high1) (and (= o3 (+ low2 1)) (in_range1 (+ low2 1)))))
(assert (=> (< low1 high1) (= result4 (mk_int__ref low2))))
(assert (=> (< low1 high1) (= low3 o3)))
(assert (=> (< low1 high1) (and (= o4 (- high2 1)) (in_range2 (- high2 1)))))
...
(assert (=> (< low1 high1) (= a__split_fields7 (mk___split_fields__ref a__split_fields6))))
...
(assert (=> (not (< low1 high1)) (= a__split_fields9 (mk___split_fields__ref (mk___split_fields (mk___t1 a__split_fields a__split_fields1))))))
(assert (=> (not (< low1 high1)) (= high7 high1)))
(assert (=> (not (< low1 high1)) (= low7 low1)))
(assert (=> (not (< low1 high1)) (= a__split_fields10 (mk___split_fields (mk___t1 a__split_fields2 a__split_fields3)))))
(assert (= high8 high6))
(assert (= low8 low6))
...
(assert (not (= (to_rep2 (select (elts1 (rec__simple_unc_arrays__table__v (us_split_fields__content a__split_fields11))) j)) (to_rep2 (select a__split_fields (+ (- (to_rep (rec__simple_unc_arrays__table__last a__split_discrs)) j) 1))))))
(check-sat)
(exit)
