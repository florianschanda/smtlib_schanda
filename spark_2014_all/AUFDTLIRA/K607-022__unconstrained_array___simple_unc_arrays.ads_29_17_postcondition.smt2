...
(assert (=> (< low1 high1) (and (and (and (= a__split_fields temp___823) (= a__split_fields1 temp___8231)) (and (and (= a__split_discrs (mk___split_discrs temp___816)) (and (= a__split_fields temp___8161) (= a__split_fields1 temp___8162))) (and (= temp___815 high1) (and (and (= a__split_fields temp___819) (= a__split_fields1 temp___8191)) (and (= temp___814 low1) (and (and (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 (- low2 1))) (= (to_rep2 (select a__split_fields4 j3)) (to_rep2 (select temp___819 (+ (- (to_rep (rec__simple_unc_arrays__table__last a__split_discrs)) j3) 1)))))) (forall ((j3 Int)) (=> (and (<= (- low2 1) j3) (<= j3 (to_rep (rec__simple_unc_arrays__table__last a__split_discrs)))) (= (to_rep2 (select a__split_fields4 j3)) (to_rep2 (select temp___823 j3)))))) (and (and (and (and (and (=> (<= 1 2147483647) (in_range3 low2)) (=> (<= 0 2147483647) (in_range2 high2))) (dynamic_invariant2 (mk___rep a__split_discrs (mk___split_fields (mk___t1 a__split_fields4 a__split_fields5))) true true true)) (= (rec__simple_unc_arrays__table__last a__split_discrs) temp___816)) (< low2 high2)) (and (and (= (to_rep (rec__simple_unc_arrays__table__last a__split_discrs)) r22b) (in_range2 r22b)) (and (and (and (= (ite (<= (to_rep1 (first2 a__split_fields5)) (to_rep1 (last2 a__split_fields5))) (+ (- (to_rep1 (last2 a__split_fields5)) (to_rep1 (first2 a__split_fields5))) 1) 0) (ite (<= 1 r22b) (+ (- r22b 1) 1) 0)) (and (= a__split_fields4 simple_unc_arrays__swap_cells__a__compl) (= (mk2 (to_rep1 (first2 a__split_fields5)) (to_rep1 (last2 a__split_fields5))) simple_unc_arrays__swap_cells__a__compl1))) (and (and (and (= o9 high2) (in_range3 high2)) (and (= (to_rep1 o8) (to_rep1 (last4 simple_unc_arrays__swap_cells__a__compl1))) (and (= (to_rep1 o7) (to_rep1 (first4 simple_unc_arrays__swap_cells__a__compl1))) (and (and (= (to_rep2 (select simple_unc_arrays__swap_cells__a low2)) (to_rep2 (select simple_unc_arrays__swap_cells__a__compl o9))) (= (to_rep2 (select simple_unc_arrays__swap_cells__a o9)) (to_rep2 (select simple_unc_arrays__swap_cells__a__compl low2)))) (forall ((k Int)) (=> (and (<= (to_rep1 o7) k) (<= k (to_rep1 o8))) (=> (and (not (= k low2)) (not (= k o9))) (= (to_rep2 (select simple_unc_arrays__swap_cells__a k)) (to_rep2 (select simple_unc_arrays__swap_cells__a__compl k)))))))))) (and (and (= result2 a__split_fields4) (= result3 a__split_fields5)) (= a__split_fields6 (mk___split_fields (mk___t1 (slide simple_unc_arrays__swap_cells__a (to_rep1 (first (mk (to_rep1 (first4 simple_unc_arrays__swap_cells__a__compl1)) (to_rep1 (last4 simple_unc_arrays__swap_cells__a__compl1))))) 1) (mk1 (to_rep1 (first4 (mk2 1 r22b))) (to_rep1 (last4 (mk2 1 r22b)))))))))) (and (and (and (= o10 (+ low2 1)) (in_range1 (+ low2 1))) (and (= result4 (mk_int__ref low2)) (= low3 o10))) (and (and (and (= o11 (- high2 1)) (in_range2 (- high2 1))) (and (= result5 (mk_int__ref high2)) (= high3 o11))) (not (< low3 high3))))))))))))) (and (and (= high6 (mk_int__ref high3)) (and (= low6 (mk_int__ref low3)) (= a__split_fields9 (mk___split_fields__ref a__split_fields6)))) (and (= high7 high3) (and (= low7 low3) (= a__split_fields10 a__split_fields6)))))))
(assert (=> (< low1 high1) (= high8 high6)))
(assert (=> (< low1 high1) (= low8 low6)))
(assert (=> (< low1 high1) (= a__split_fields11 a__split_fields9)))
(assert (=> (< low1 high1) (= high9 high7)))
(assert (=> (< low1 high1) (= low9 low7)))
(assert (=> (< low1 high1) (= a__split_fields12 a__split_fields10)))
(assert (=> (not (< low1 high1)) (= high8 (mk_int__ref high1))))
(assert (=> (not (< low1 high1)) (= low8 (mk_int__ref low1))))
(assert (=> (not (< low1 high1)) (= a__split_fields11 (mk___split_fields__ref (mk___split_fields (mk___t1 a__split_fields a__split_fields1))))))
(assert (=> (not (< low1 high1)) (= high9 high1)))
(assert (=> (not (< low1 high1)) (= low9 low1)))
(assert (=> (not (< low1 high1)) (= a__split_fields12 (mk___split_fields (mk___t1 a__split_fields2 a__split_fields3)))))
(assert (= high10 high8))
(assert (= low10 low8))
(assert (= a__split_fields13 a__split_fields11))
(assert (= high11 high9))
(assert (= low11 low9))
(assert (= a__split_fields14 a__split_fields12))
(declare-const j3 Int)
(assert (<= 1 j3))
(assert (<= j3 (to_rep (rec__simple_unc_arrays__table__last a__split_discrs))))
(assert (not (= (to_rep2 (select (elts1 (rec__simple_unc_arrays__table__v (us_split_fields__content a__split_fields13))) j3)) (to_rep2 (select a__split_fields (+ (- (to_rep (rec__simple_unc_arrays__table__last a__split_discrs)) j3) 1))))))
(check-sat)
(exit)
