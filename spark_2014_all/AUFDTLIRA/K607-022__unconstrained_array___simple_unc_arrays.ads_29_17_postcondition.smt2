...
(declare-const temp___901 (Array Int value))
(declare-const temp___9011 t)
(declare-const temp___894 natural)
(declare-const temp___8941 (Array Int value))
(declare-const temp___8942 t)
(declare-const temp___893 Int)
(declare-const temp___897 (Array Int value))
(declare-const temp___8971 t)
...
(assert (=> (< low1 high1) (and (= a__split_fields temp___901) (= a__split_fields1 temp___9011))))
(assert (=> (< low1 high1) (and (= a__split_discrs (mk___split_discrs temp___894)) (and (= a__split_fields temp___8941) (= a__split_fields1 temp___8942)))))
(assert (=> (< low1 high1) (= temp___893 high1)))
(assert (=> (< low1 high1) (and (= a__split_fields temp___897) (= a__split_fields1 temp___8971))))
(assert (=> (< low1 high1) (= temp___892 low1)))
(assert (=> (< low1 high1) (and (forall ((j Int)) (=> (and (<= 1 j) (<= j (- low2 1))) (= (to_rep2 (select a__split_fields4 j)) (to_rep2 (select temp___897 (+ (- (to_rep (rec__simple_unc_arrays__table__last a__split_discrs)) j) 1)))))) (forall ((j Int)) (=> (and (<= (- low2 1) j) (<= j (to_rep (rec__simple_unc_arrays__table__last a__split_discrs)))) (= (to_rep2 (select a__split_fields4 j)) (to_rep2 (select temp___901 j))))))))
(assert (=> (< low1 high1) (and (and (and (and (=> (<= 1 2147483647) (in_range3 low2)) (=> (<= 0 2147483647) (in_range2 high2))) (dynamic_invariant2 (mk___rep a__split_discrs (mk___split_fields (mk___t a__split_fields4 a__split_fields5))) true true true true)) (= (rec__simple_unc_arrays__table__last a__split_discrs) temp___894)) (< low2 high2))))
(assert (=> (< low1 high1) (= (to_rep (rec__simple_unc_arrays__table__last a__split_discrs)) r22b)))
(assert (=> (< low1 high1) (in_range2 r22b)))
(assert (=> (< low1 high1) (= (ite (<= (to_rep1 (first a__split_fields5)) (to_rep1 (last a__split_fields5))) (+ (- (to_rep1 (last a__split_fields5)) (to_rep1 (first a__split_fields5))) 1) 0) (ite (<= 1 r22b) (+ (- r22b 1) 1) 0))))
(assert (=> (< low1 high1) (= a__split_fields4 simple_unc_arrays__swap_cells__a__compl)))
(assert (=> (< low1 high1) (= (mk2 (to_rep1 (first a__split_fields5)) (to_rep1 (last a__split_fields5))) simple_unc_arrays__swap_cells__a__compl1)))
...
(assert (=> (< low1 high1) (= a__split_fields6 (mk___split_fields (mk___t (slide simple_unc_arrays__swap_cells__a (to_rep1 (first2 (mk1 (to_rep1 (first4 simple_unc_arrays__swap_cells__a__compl1)) (to_rep1 (last4 simple_unc_arrays__swap_cells__a__compl1))))) 1) (mk (to_rep1 (first4 (mk2 1 r22b))) (to_rep1 (last4 (mk2 1 r22b)))))))))
...
(assert (=> (not (< low1 high1)) (= a__split_fields9 (mk___split_fields__ref (mk___split_fields (mk___t a__split_fields a__split_fields1))))))
(assert (=> (not (< low1 high1)) (= high7 high1)))
(assert (=> (not (< low1 high1)) (= low7 low1)))
(assert (=> (not (< low1 high1)) (= a__split_fields10 (mk___split_fields (mk___t a__split_fields2 a__split_fields3)))))
(assert (= high8 high6))
(assert (= low8 low6))
...
(assert (not (= (to_rep2 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields__content a__split_fields11))) j)) (to_rep2 (select a__split_fields (+ (- (to_rep (rec__simple_unc_arrays__table__last a__split_discrs)) j) 1))))))
(check-sat)
(exit)
