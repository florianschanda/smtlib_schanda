...
(assert (=> (< low1 high1) (and (= a__split_fields temp___829) (= a__split_fields1 temp___8291))))
(assert (=> (< low1 high1) (and (= a__split_discrs (mk___split_discrs temp___822)) (and (= a__split_fields temp___8221) (= a__split_fields1 temp___8222)))))
(assert (=> (< low1 high1) (= temp___821 high1)))
(assert (=> (< low1 high1) (and (= a__split_fields temp___825) (= a__split_fields1 temp___8251))))
(assert (=> (< low1 high1) (= temp___820 low1)))
(assert (=> (< low1 high1) (and (forall ((j Int)) (=> (and (<= 1 j) (<= j (- low2 1))) (= (to_rep2 (select a__split_fields4 j)) (to_rep2 (select temp___825 (+ (- (to_rep (rec__simple_unc_arrays__table__last a__split_discrs)) j) 1)))))) (forall ((j Int)) (=> (and (<= (- low2 1) j) (<= j (to_rep (rec__simple_unc_arrays__table__last a__split_discrs)))) (= (to_rep2 (select a__split_fields4 j)) (to_rep2 (select temp___829 j))))))))
(assert (=> (< low1 high1) (and (and (and (and (=> (<= 1 2147483647) (in_range3 low2)) (=> (<= 0 2147483647) (in_range2 high2))) (dynamic_invariant2 (mk___rep a__split_discrs (mk___split_fields (mk___t1 a__split_fields4 a__split_fields5))) true true true)) (= (rec__simple_unc_arrays__table__last a__split_discrs) temp___822)) (< low2 high2))))
