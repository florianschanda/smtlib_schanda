...
(assert (=> (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) i1)) 0) (= o27 1)))
(assert (=> (not (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) i1)) 0)) (= o27 0)))
(assert (= o28 (+ o27 o26)))
(assert (and (= o29 o28) (in_range7 o28)))
(assert (= o30 (ite (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (map__content4 red_black_trees__nb_blacks__result4) i1)))) o29) true false)))
