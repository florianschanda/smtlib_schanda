...
(declare-const stacks__peek__3__result Int)
(declare-const temp___593 Int)
(declare-const o Int)
(declare-const o1 element)
(declare-const o2 Int)
(declare-const result Int)
(declare-const stacks__peek__3__result1 Int)
(declare-const stacks__peek__3__result2 Int)
(declare-const stacks__peek__3__result3 Int)
(declare-const stacks__peek__3__result4 Int)
(declare-const stacks__peek__3__result5 Int)
...
(assert (= stacks__peek__3__result1 stacks__peek__3__result2))
(assert (= stacks__peek__3__result3 stacks__peek__3__result1))
...
(assert (and (<= 1 temp___593) (<= temp___593 100)))
(assert (= o temp___593))
(assert (= o1 (select (rec__stacks__stack_root__content1 (us_split_fields3 s)) o)))
(assert (= o2 (to_rep o1)))
(assert (= result stacks__peek__3__result))
(assert (= stacks__peek__3__result1 o2))
(assert (= (mk_int__ref stacks__peek__3__result4) (mk_int__ref stacks__peek__3__result2)))
(assert (= stacks__peek__3__result5 stacks__peek__3__result3))
(assert (= result1 stacks__peek__3__result4))
(assert (not (not (= (is_empty (mk___rep (mk___split_fields (rec__stacks__stack_root__content1 (us_split_fields3 s)) (rec__stacks__stack_root__length1 (us_split_fields3 s)) (hide_ext__ (rec__stacks__buffer__first (us_split_fields3 s)) (rec__ext__1 (us_split_fields3 s)))) (attr__tag1 s))) true))))
(check-sat)
(exit)
