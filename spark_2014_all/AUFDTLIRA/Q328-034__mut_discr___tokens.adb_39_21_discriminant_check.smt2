...
(assert (and (= o37 (read2 (mk___t word1 (mk (to_rep1 word__first) (to_rep1 word__last))))) (in_range5 o37)))
(assert (= (to_rep3 o38) o37))
(assert (= o39 (mk___split_fields1 dummy5 o38 dummy4)))
(assert (= (to_rep4 o36) 1))
(assert (= o40 (mk___split_discrs o36)))
(assert (= temp___235 (mk___rep1 o40 o39 true)))
(assert (= v__attr__constrained true))
(assert (not (= (rec__tokens__token__kind (us_split_discrs1 temp___235)) (rec__tokens__token__kind v__split_discrs))))
(check-sat)
(exit)
