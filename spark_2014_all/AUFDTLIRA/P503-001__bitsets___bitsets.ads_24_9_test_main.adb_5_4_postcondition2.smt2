...
(declare-const test_main__my_sets__remove__result (Array Int Bool))
...
(declare-const test_main__my_sets__remove__result1 (Array Int Bool))
(declare-const test_main__my_sets__remove__result2 (Array Int Bool))
(declare-const test_main__my_sets__remove__result3 (Array Int Bool))
(declare-const res3 (Array Int Bool))
(declare-const test_main__my_sets__remove__result4 (Array Int Bool))
(declare-const res4 (Array Int Bool))
(declare-const test_main__my_sets__remove__result5 (Array Int Bool))
(declare-const result3 (Array Int Bool))
(assert (in_range1 e))
(assert (= result res))
(assert (= res1 s))
(assert (= result1 res1))
(assert (= res2 (store res1 e (distinct 0 0))))
(assert (= test_main__my_sets__remove__result1 test_main__my_sets__remove__result2))
(assert (= test_main__my_sets__remove__result3 test_main__my_sets__remove__result1))
(assert (= result2 test_main__my_sets__remove__result))
(assert (= test_main__my_sets__remove__result1 res2))
(assert (= (mk_map__ref test_main__my_sets__remove__result4) (mk_map__ref test_main__my_sets__remove__result2)))
(assert (= res3 res2))
(assert (= test_main__my_sets__remove__result5 test_main__my_sets__remove__result3))
(assert (= res4 res2))
