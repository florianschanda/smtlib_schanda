...
(assert (= rank2 o9))
(assert (not (not (= (is_preferred_1 g11 (to_rep (select result__ (to_rep3 (select (select ranking_1 g11) (- rank2 1))))) (select ranking_2 (to_rep3 (select (select ranking_1 g11) (- rank2 1))))) true))))
(check-sat)
(exit)
