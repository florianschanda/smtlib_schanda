...
(assert (= rank3 o9))
(assert (not (not (= (is_preferred_1 g11 (to_rep (select result__ (to_rep1 (select (select ranking_1 g11) (- rank3 1))))) (select ranking_2 (to_rep1 (select (select ranking_1 g11) (- rank3 1))))) true))))
(check-sat)
(exit)
