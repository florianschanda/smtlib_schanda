...
(declare-fun temp_____aggregate_def_177 ((Array Int integer) Int Int) (Array Int integer))
...
(assert (forall ((temp___179 (Array Int integer))) (forall ((temp___180 Int) (temp___181 Int)) (let ((temp___178 (temp_____aggregate_def_177 temp___179 temp___180 temp___181))) (=> (and (in_range1 temp___180) (dynamic_invariant temp___181 true true true true)) (forall ((temp___182 Int)) (ite (= temp___182 temp___180) (= (select temp___178 temp___182) rliteral) (= (select temp___178 temp___182) (select temp___179 temp___182)))))))))
...
(assert (= result arr))
(assert (= arr1 (temp_____aggregate_def_177 arr 5 5)))
(assert (= arr1 arr2))
(assert (= arr3 arr1))
(assert (not (= (to_rep (select arr2 2)) (to_rep (select arr 2)))))
(check-sat)
(exit)
