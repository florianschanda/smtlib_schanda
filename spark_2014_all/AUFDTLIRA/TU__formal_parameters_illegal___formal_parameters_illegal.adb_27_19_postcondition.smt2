...
(assert (forall ((temp___155 (Array Int integer))) (forall ((temp___156 Int) (temp___157 Int)) (let ((temp___154 (temp___153 temp___155 temp___156 temp___157))) (forall ((temp___158 Int)) (ite (= temp___158 temp___156) (= (select temp___154 temp___158) (of_rep temp___157)) (= (select temp___154 temp___158) (select temp___155 temp___158))))))))
