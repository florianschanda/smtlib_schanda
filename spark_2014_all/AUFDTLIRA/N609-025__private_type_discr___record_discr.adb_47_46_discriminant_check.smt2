...
(assert (= o8 o4))
(assert (= o9 o5))
(assert (= (mk___rep1 (mk___split_discrs1 o10) (mk___split_fields1 (mk___t o11 o12))) (to_base1 (mk___rep3 (mk___split_discrs1 o7) (mk___split_fields3 (mk___t3 o8 o9))))))
(assert (not (= (to_rep1 (last2 (rt1 a))) (to_rep o10))))
(check-sat)
(exit)
