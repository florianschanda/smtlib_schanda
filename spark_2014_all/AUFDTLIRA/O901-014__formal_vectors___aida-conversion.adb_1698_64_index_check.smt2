...
(assert (and (<= (to_rep1 (first (rt source))) temp___2089) (<= temp___2089 (to_rep1 (last (rt source))))))
(assert (= o temp___2089))
(assert (= o1 (select (elts source) o)))
(assert (= o2 (to_rep o1)))
(assert (= o3 (ite (= o2 50) true false)))
(assert (and (= temp___2088 (+ (to_rep1 (first (rt source))) 0)) (in_range1 (+ (to_rep1 (first (rt source))) 0))))
(assert (not (<= (to_rep1 (first (rt source))) temp___2088)))
(check-sat)
(exit)
