...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 10)) (and (and (= temp___154 i1) (and (= temp___153 pos1) (and (or (and (= pos2 0) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 (- i2 1))) (not (= (to_rep (select t j2)) v))))) (and (= (to_rep (select t pos2)) v) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 (- pos2 1))) (not (= (to_rep (select t j2)) v)))))) (and (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 pos2)) (=> (<= 1 10) (in_range3 i2))) (and (<= 1 i2) (<= i2 10))) (and (ite (= (to_rep (select t i2)) v) (and (= pos2 result5) (= pos3 i2)) (= pos3 pos2)) (= i2 10)))))) (and (and (= i2 i6) (= pos3 pos6)) (and (= i7 i2) (= pos7 pos3))))))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= (mk_int__ref i8) (mk_int__ref i6))))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= (mk_int__ref pos8) (mk_int__ref pos6))))
...
(assert (= (mk_int__ref result7) (mk_int__ref search__search__result)))
...
(assert (= (mk_int__ref pos10) (mk_int__ref pos8)))
(assert (= search__search__result5 search__search__result3))
(assert (= i11 i9))
(assert (= pos11 pos9))
(assert (=> (= search__search__result4 0) (and (= result8 (no_v_in_range t v 1 10)) (= (= result8 true) (forall ((pos12 Int)) (=> (and (<= 1 pos12) (<= pos12 10)) (not (= (to_rep (select t pos12)) v))))))))
(assert (=> (not (= search__search__result4 0)) (= result8 false)))
(assert (not (= result8 true)))
(assert (and (<= 1 search__search__result4) (<= search__search__result4 10)))
(assert (= o7 search__search__result4))
(assert (= o8 (select t o7)))
(assert (= o9 (to_rep o8)))
(assert (= result9 (ite (= o9 v) true false)))
(assert (= result9 true))
(assert (and (= o5 (- search__search__result4 1)) (in_range1 (- search__search__result4 1))))
(assert (not (in_range2 o5)))
(check-sat)
(exit)
