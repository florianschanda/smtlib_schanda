...
(assert (=> (and (<= 1 i1) (<= i1 10)) (or (and (= pos2 0) (forall ((j Int)) (=> (and (<= 1 j) (<= j (- i2 1))) (not (= (to_rep (select t j)) v))))) (and (= (to_rep (select t pos2)) v) (forall ((j Int)) (=> (and (<= 1 j) (<= j (- pos2 1))) (not (= (to_rep (select t j)) v))))))))
(assert (=> (and (<= 1 i1) (<= i1 10)) (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 pos2)) (=> (<= 1 10) (in_range3 i2))) (and (<= 1 i2) (<= i2 10)))))
(assert (=> (and (<= 1 i1) (<= i1 10)) (=> (= (to_rep (select t i2)) v) (= pos2 result2))))
(assert (=> (and (<= 1 i1) (<= i1 10)) (=> (= (to_rep (select t i2)) v) (= pos3 i2))))
(assert (=> (and (<= 1 i1) (<= i1 10)) (=> (not (= (to_rep (select t i2)) v)) (= pos3 pos2))))
...
(assert (= i8 i6))
(assert (= pos9 pos7))
(assert (=> (= search__search__result4 0) (and (= result4 (no_v_in_range t v 1 10)) (= (= result4 true) (forall ((pos11 Int)) (=> (and (<= 1 pos11) (<= pos11 10)) (not (= (to_rep (select t pos11)) v))))))))
...
(assert (= result5 true))
(assert (and (= o (- search__search__result4 1)) (in_range1 (- search__search__result4 1))))
