...
(assert (=> (and (<= 1 r2) (<= r2 3)) (forall ((rr Int)) (=> (and (<= 1 rr) (<= rr r3)) (= (to_rep (rec__list_allocator__cell__prev (us_split_fields1 (select data4 rr)))) (ite (= rr 1) 0 (- rr 1)))))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (forall ((rr Int)) (=> (and (<= 1 rr) (<= rr r3)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data4 rr)))) (ite (= rr 3) 0 (+ rr 1)))))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (forall ((rr Int)) (=> (and (<= 1 rr) (<= rr 3)) (= (to_rep1 (rec__list_allocator__cell__stat (us_split_fields1 (select data4 rr)))) 0)))))
...
(assert (not (= (length (rec__list_allocator__m__t__allocated model____split_fields2)) 0)))
(check-sat)
(exit)
