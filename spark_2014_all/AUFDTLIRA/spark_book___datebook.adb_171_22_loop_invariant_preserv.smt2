...
(assert (and (<= (to_rep1 description__first) temp___446) (<= temp___446 (to_rep1 description__last))))
(assert (= o4 temp___446))
...
(assert (= result6 j2))
(assert (= j3 (+ j2 1)))
(assert (not (< (- j3 1) (ite (<= (to_rep1 description__first) (to_rep1 description__last)) (+ (- (to_rep1 description__last) (to_rep1 description__first)) 1) 0))))
(check-sat)
(exit)
