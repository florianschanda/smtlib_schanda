...
(assert (= a3 o23))
(assert (= a3 result3))
(assert (= a4 (store a3 23 (mk___rep (mk___split_fields (of_int 1) (rec__arrays_of_records__basic_record__first_value (us_split_fields1 (select a3 23))) (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select a3 23))))))))
