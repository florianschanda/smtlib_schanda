...
(assert (= (rec__arrays_of_records__basic_record__flag (us_split_fields1 (select a2 5))) o17))
(assert (= o16 o18))
(assert (= (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select a2 5))) o19))
(assert (= o20 o17))
(assert (= o21 o18))
(assert (= o22 o19))
(assert (= o23 (store a2 5 (mk___rep (mk___split_fields o20 o21 o22)))))
(assert (= a2 result2))
(assert (= a3 o23))
(assert (= a3 result3))
(assert (= a4 (store a3 23 (mk___rep (mk___split_fields (distinct 1 0) (rec__arrays_of_records__basic_record__first_value (us_split_fields1 (select a3 23))) (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select a3 23))))))))
