...
(assert (in_range1 i))
(assert (in_range2 e))
(assert (and (and (=> (<= 1 10) (in_range1 j)) (and (=> (<= 0 99) (in_range2 f)) (and (and (and (= (bool_eq a1 1 10 (temp___4389 t1 i e) 1 10) true) (or (and (= i 10) (= j1 1)) (and (< i 10) (= j1 (+ i 1))))) (in_range1 j1)) (and (=> (<= 1 10) (in_range1 j1)) (and (ite (= e 0) (and (= result4 f) (= f1 99)) (and (and (and (= o3 (- e 1)) (in_range2 (- e 1))) (and (= result5 f) (= f2 o3))) (= f1 f2))) (and (and (= (to_rep o4) f1) (= o5 (store a1 j1 o4))) (and (= result6 a1) (= a2 o5)))))))) (and (and (= t1 t2) (and (= f1 f3) (and (= j1 j3) (= a2 a3)))) (and (= t3 t1) (and (= f4 f1) (and (= j4 j1) (= a4 a2)))))))
(declare-const n Int)
(assert (<= 1 n))
(assert (<= n 10))
