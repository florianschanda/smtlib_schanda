...
(declare-const o48 status)
(declare-const o49 resource)
(declare-const o50 resource)
(declare-const o51 status)
(declare-const o52 resource)
(declare-const o53 resource)
(declare-const o54 resource)
...
(assert (=> (not (= first_available 0)) (and (= o64 (length model____split_fields)) (in_range6 o64))))
(assert (=> (not (= first_available 0)) (= result3 (ite (< 0 o64) true false))))
(assert (=> (not (= first_available 0)) (=> (= result3 true) (and (= o63 (get model____split_fields 1)) (in_range7 o63)))))
(assert (=> (not (= first_available 0)) (=> (= result3 true) (= result2 (ite (= o63 first_available) true false)))))
(assert (=> (not (= first_available 0)) (=> (not (= result3 true)) (= result2 false))))
(assert (=> (= first_available 0) (and (= o65 (length model____split_fields)) (in_range6 o65))))
(assert (=> (= first_available 0) (= result2 (ite (= o65 0) true false))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (and (= o61 (length model____split_fields1)) (in_range6 o61)))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (= result4 (ite (< 0 o61) true false)))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (=> (= result4 true) (and (= o60 (get model____split_fields1 1)) (in_range7 o60))))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (=> (= result4 true) (= result1 (ite (= o60 first_allocated) true false))))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (=> (not (= result4 true)) (= result1 false)))))
(assert (=> (= result2 true) (=> (= first_allocated 0) (and (= o62 (length model____split_fields1)) (in_range6 o62)))))
(assert (=> (= result2 true) (=> (= first_allocated 0) (= result1 (ite (= o62 0) true false)))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (= result1 true))
(assert (and (= o30 (length model____split_fields)) (in_range6 o30)))
(assert (= o31 (ite (<= j1 o30) true false)))
(assert (= result5 (ite (<= 1 j1) o31 false)))
(assert (= result5 true))
(assert (and (= o59 (get model____split_fields j1)) (in_range7 o59)))
(assert (= result8 (ite (in_range4 o59) true false)))
(assert (=> (= result8 true) (and (= o55 (length model____split_fields)) (in_range6 o55))))
(assert (=> (= result8 true) (= result9 (ite (< j1 o55) true false))))
(assert (=> (= result8 true) (=> (= result9 true) (and (= o56 (+ j1 1)) (in_range1 (+ j1 1))))))
(assert (=> (= result8 true) (=> (= result9 true) (and (= o57 (get model____split_fields o56)) (in_range7 o57)))))
(assert (=> (= result8 true) (=> (not (= result9 true)) (= o57 0))))
(assert (=> (= result8 true) (and (= temp___385 (get model____split_fields j1)) (in_range7 temp___385))))
(assert (=> (= result8 true) (and (<= 1 temp___385) (<= temp___385 3))))
(assert (=> (= result8 true) (= o47 temp___385)))
(assert (=> (= result8 true) (= (mk___rep (mk___split_fields o48 o49 o50)) (select data o47))))
(assert (=> (= result8 true) (= o48 o51)))
(assert (=> (= result8 true) (= o49 o52)))
(assert (=> (= result8 true) (= o50 o53)))
(assert (=> (= result8 true) (= o54 o53)))
(assert (=> (= result8 true) (= o58 (to_rep o54))))
(assert (=> (= result8 true) (= result7 (ite (= o58 o57) true false))))
(assert (=> (not (= result8 true)) (= result7 false)))
(assert (= result7 true))
(assert (=> (< 1 j1) (and (= o44 (- j1 1)) (in_range2 (- j1 1)))))
(assert (=> (< 1 j1) (and (= o45 (get model____split_fields o44)) (in_range7 o45))))
(assert (=> (not (< 1 j1)) (= o45 0)))
(assert (and (= temp___386 (get model____split_fields j1)) (in_range7 temp___386)))
(assert (not (<= 1 temp___386)))
(check-sat)
(exit)
