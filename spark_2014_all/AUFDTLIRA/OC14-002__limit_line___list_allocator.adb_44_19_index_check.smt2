...
(assert (=> (not (= first_available 0)) (and (= o21 (length model____split_fields)) (in_range6 o21))))
(assert (=> (not (= first_available 0)) (= result2 (ite (< 0 o21) true false))))
(assert (=> (not (= first_available 0)) (=> (= result2 true) (and (= o20 (get model____split_fields 1)) (in_range7 o20)))))
(assert (=> (not (= first_available 0)) (=> (= result2 true) (= result1 (ite (= o20 first_available) true false)))))
(assert (=> (not (= first_available 0)) (=> (not (= result2 true)) (= result1 false))))
(assert (=> (not (not (= first_available 0))) (and (= o22 (length model____split_fields)) (in_range6 o22))))
(assert (=> (not (not (= first_available 0))) (= result1 (ite (= o22 0) true false))))
(assert (=> (= result1 true) (=> (not (= first_allocated 0)) (and (= o18 (length model____split_fields1)) (in_range6 o18)))))
(assert (=> (= result1 true) (=> (not (= first_allocated 0)) (= result3 (ite (< 0 o18) true false)))))
(assert (=> (= result1 true) (=> (not (= first_allocated 0)) (=> (= result3 true) (and (= o17 (get model____split_fields1 1)) (in_range7 o17))))))
(assert (=> (= result1 true) (=> (not (= first_allocated 0)) (=> (= result3 true) (= result (ite (= o17 first_allocated) true false))))))
(assert (=> (= result1 true) (=> (not (= first_allocated 0)) (=> (not (= result3 true)) (= result false)))))
(assert (=> (= result1 true) (=> (not (not (= first_allocated 0))) (and (= o19 (length model____split_fields1)) (in_range6 o19)))))
(assert (=> (= result1 true) (=> (not (not (= first_allocated 0))) (= result (ite (= o19 0) true false)))))
...
(assert (= result4 true))
(assert (and (= o16 (get model____split_fields j)) (in_range7 o16)))
(assert (= result6 (ite (in_range4 o16) true false)))
(assert (=> (= result6 true) (and (= o12 (length model____split_fields)) (in_range6 o12))))
(assert (=> (= result6 true) (= result7 (ite (< j o12) true false))))
(assert (=> (= result6 true) (=> (= result7 true) (and (= o13 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result6 true) (=> (= result7 true) (and (= o14 (get model____split_fields o13)) (in_range7 o14)))))
(assert (=> (= result6 true) (=> (not (= result7 true)) (= o14 0))))
(assert (=> (= result6 true) (and (= temp___418 (get model____split_fields j)) (in_range7 temp___418))))
(assert (=> (= result6 true) (and (<= 1 temp___418) (<= temp___418 3))))
(assert (=> (= result6 true) (= o4 temp___418)))
(assert (=> (= result6 true) (= (mk___rep (mk___split_fields o5 o6 o7)) (select data o4))))
(assert (=> (= result6 true) (= o5 o8)))
(assert (=> (= result6 true) (= o6 o9)))
(assert (=> (= result6 true) (= o7 o10)))
(assert (=> (= result6 true) (= o11 o10)))
(assert (=> (= result6 true) (= o15 (to_rep o11))))
(assert (=> (= result6 true) (= result5 (ite (= o15 o14) true false))))
(assert (=> (not (= result6 true)) (= result5 false)))
(assert (= result5 true))
(assert (=> (< 1 j) (and (= o2 (- j 1)) (in_range2 (- j 1)))))
(assert (=> (< 1 j) (and (= o3 (get model____split_fields o2)) (in_range7 o3))))
(assert (=> (not (< 1 j)) (= o3 0)))
(assert (and (= temp___419 (get model____split_fields j)) (in_range7 temp___419)))
(assert (not (<= 1 temp___419)))
(check-sat)
(exit)
