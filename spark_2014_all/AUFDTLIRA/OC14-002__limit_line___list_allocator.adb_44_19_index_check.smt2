...
(assert (=> (= result6 true) (and (= temp___385 (get model____split_fields j)) (in_range7 temp___385))))
(assert (=> (= result6 true) (and (<= 1 temp___385) (<= temp___385 3))))
(assert (=> (= result6 true) (= o4 temp___385)))
...
(assert (=> (not (< 1 j)) (= o3 0)))
(assert (and (= temp___386 (get model____split_fields j)) (in_range7 temp___386)))
