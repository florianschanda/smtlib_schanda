...
(assert (and (= o33 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (= o34 (ite (<= index1 o33) true false)))
(assert (and (= o32 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (= o35 (ite (<= o32 index1) true false)))
(assert (= result (ite (= o35 true) o34 false)))
(assert (= (= o36 true) (forall ((index11 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 8) index11) (<= index11 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index11))) true)))))
(assert (and (= temp___1896 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1896) (<= temp___1896 (to_rep1 (last (rt source))))))
(assert (= o28 temp___1896))
(assert (= o29 (select (elts source) o28)))
(assert (= o30 (to_rep o29)))
(assert (= o31 (ite (< o30 54) true false)))
(assert (and (= temp___1895 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1895) (<= temp___1895 (to_rep1 (last (rt source))))))
(assert (= o24 temp___1895))
(assert (= o25 (select (elts source) o24)))
(assert (= o26 (to_rep o25)))
(assert (= o27 (ite (= o26 51) true false)))
(assert (and (= temp___1894 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1894) (<= temp___1894 (to_rep1 (last (rt source))))))
(assert (= o20 temp___1894))
(assert (= o21 (select (elts source) o20)))
(assert (= o22 (to_rep o21)))
(assert (= o23 (ite (= o22 56) true false)))
(assert (and (= temp___1893 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1893) (<= temp___1893 (to_rep1 (last (rt source))))))
(assert (= o16 temp___1893))
(assert (= o17 (select (elts source) o16)))
(assert (= o18 (to_rep o17)))
(assert (= o19 (ite (= o18 52) true false)))
(assert (and (= temp___1892 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1892) (<= temp___1892 (to_rep1 (last (rt source))))))
(assert (= o12 temp___1892))
(assert (= o13 (select (elts source) o12)))
(assert (= o14 (to_rep o13)))
(assert (= o15 (ite (= o14 55) true false)))
(assert (and (= temp___1891 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1891) (<= temp___1891 (to_rep1 (last (rt source))))))
(assert (= o8 temp___1891))
(assert (= o9 (select (elts source) o8)))
(assert (= o10 (to_rep o9)))
(assert (= o11 (ite (= o10 52) true false)))
