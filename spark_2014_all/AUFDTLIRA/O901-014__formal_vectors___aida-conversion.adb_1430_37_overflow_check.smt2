...
(declare-const temp___1993 Int)
(declare-const o Int)
(declare-const o1 character)
(declare-const o2 Int)
(declare-const o3 Bool)
(declare-const temp___1994 Int)
...
(assert (and (= o24 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (= o27 (ite (<= o24 index) true false)))
(assert (= result (ite (= o27 true) o26 false)))
(assert (= (= o28 true) (forall ((index1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 8) index1) (<= index1 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index1))) true)))))
(assert (and (= temp___1998 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1998) (<= temp___1998 (to_rep1 (last (rt source))))))
(assert (= o20 temp___1998))
(assert (= o21 (select (elts source) o20)))
(assert (= o22 (to_rep o21)))
(assert (= o23 (ite (< o22 54) true false)))
(assert (and (= temp___1997 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1997) (<= temp___1997 (to_rep1 (last (rt source))))))
(assert (= o16 temp___1997))
(assert (= o17 (select (elts source) o16)))
(assert (= o18 (to_rep o17)))
(assert (= o19 (ite (= o18 51) true false)))
(assert (and (= temp___1996 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1996) (<= temp___1996 (to_rep1 (last (rt source))))))
(assert (= o12 temp___1996))
(assert (= o13 (select (elts source) o12)))
(assert (= o14 (to_rep o13)))
(assert (= o15 (ite (= o14 56) true false)))
(assert (and (= temp___1995 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1995) (<= temp___1995 (to_rep1 (last (rt source))))))
(assert (= o8 temp___1995))
(assert (= o9 (select (elts source) o8)))
(assert (= o10 (to_rep o9)))
(assert (= o11 (ite (= o10 52) true false)))
(assert (and (= temp___1994 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1994) (<= temp___1994 (to_rep1 (last (rt source))))))
(assert (= o4 temp___1994))
(assert (= o5 (select (elts source) o4)))
(assert (= o6 (to_rep o5)))
(assert (= o7 (ite (= o6 55) true false)))
(assert (and (= temp___1993 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1993) (<= temp___1993 (to_rep1 (last (rt source))))))
(assert (= o temp___1993))
(assert (= o1 (select (elts source) o)))
(assert (= o2 (to_rep o1)))
(assert (= o3 (ite (= o2 52) true false)))
