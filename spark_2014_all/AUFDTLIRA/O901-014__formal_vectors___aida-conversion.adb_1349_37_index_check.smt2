...
(assert (and (= o41 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (= o42 (ite (<= index o41) true false)))
(assert (and (= o40 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (= o43 (ite (<= o40 index) true false)))
(assert (= result (ite (= o43 true) o42 false)))
(assert (= (= o44 true) (forall ((index1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 10) index1) (<= index1 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index1))) true)))))
(assert (and (= temp___1825 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1825) (<= temp___1825 (to_rep1 (last (rt source))))))
(assert (= o36 temp___1825))
(assert (= o37 (select (elts source) o36)))
(assert (= o38 (to_rep o37)))
(assert (= o39 (ite (< o38 57) true false)))
(assert (and (= temp___1824 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1824) (<= temp___1824 (to_rep1 (last (rt source))))))
(assert (= o32 temp___1824))
(assert (= o33 (select (elts source) o32)))
(assert (= o34 (to_rep o33)))
(assert (= o35 (ite (= o34 52) true false)))
(assert (and (= temp___1823 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1823) (<= temp___1823 (to_rep1 (last (rt source))))))
(assert (= o28 temp___1823))
(assert (= o29 (select (elts source) o28)))
(assert (= o30 (to_rep o29)))
(assert (= o31 (ite (= o30 54) true false)))
(assert (and (= temp___1822 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1822) (<= temp___1822 (to_rep1 (last (rt source))))))
(assert (= o24 temp___1822))
(assert (= o25 (select (elts source) o24)))
(assert (= o26 (to_rep o25)))
(assert (= o27 (ite (= o26 51) true false)))
(assert (and (= temp___1821 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1821) (<= temp___1821 (to_rep1 (last (rt source))))))
(assert (= o20 temp___1821))
(assert (= o21 (select (elts source) o20)))
(assert (= o22 (to_rep o21)))
(assert (= o23 (ite (= o22 56) true false)))
(assert (and (= temp___1820 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1820) (<= temp___1820 (to_rep1 (last (rt source))))))
(assert (= o16 temp___1820))
(assert (= o17 (select (elts source) o16)))
(assert (= o18 (to_rep o17)))
(assert (= o19 (ite (= o18 52) true false)))
(assert (and (= temp___1819 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (not (<= (to_rep1 (first (rt source))) temp___1819)))
(check-sat)
(exit)
