...
(assert (= result4 true))
(assert (and (<= c21b result__2) (< result__2 256)))
(assert (and (=> (<= 1 256) (in_range3 result__2)) (and (< result__2 128) (not (= (to_rep (select domainnameversion result__2)) 46)))))
(assert (and (= o6 (+ result__2 1)) (in_range3 (+ result__2 1))))
(assert (= result__2 result5))
(assert (= result__3 o6))
(assert (=> (< result__3 128) (and (<= 1 result__3) (<= result__3 128))))
(assert (=> (< result__3 128) (= o7 result__3)))
(assert (=> (< result__3 128) (= o8 (select domainnameversion o7))))
(assert (=> (< result__3 128) (= o9 (to_rep o8))))
(assert (=> (< result__3 128) (= o10 (ite (= o9 46) true false))))
(assert (=> (< result__3 128) (= o11 (ite (not (= o10 true)) true false))))
(assert (=> (not (< result__3 128)) (= o11 false)))
(assert (= result6 (ite (not (= o11 true)) true false)))
(assert (not (= result6 true)))
(assert (not (<= c21b result__3)))
(check-sat)
(exit)
