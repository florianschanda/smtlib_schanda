...
(assert (<= 0 i4))
(assert (<= i4 (- (to_rep1 (rec__patience__state__numstacks (us_split_fields__content s__split_fields20))) 1)))
(assert (and (<= 0 i4) (<= i4 99)))
(assert (= o187 i4))
(assert (= o188 (select (rec__patience__state__stacksizes (us_split_fields__content s__split_fields20)) o187)))
(assert (= o189 (to_rep1 o188)))
(assert (= o190 (- o189 2)))
(assert (= o191 (ite (<= j1 o190) true false)))
(assert (= result40 (ite (<= 0 j1) o191 false)))
(assert (= result40 true))
(assert (and (<= 0 i4) (<= i4 99)))
(assert (= o193 i4))
(assert (= o194 (select (rec__patience__state__stacksizes (us_split_fields__content s__split_fields20)) o193)))
(assert (= o195 (to_rep1 o194)))
(assert (= o196 (- o195 1)))
(assert (= o197 (ite (<= k o196) true false)))
(assert (and (= o192 (+ j1 1)) (in_range1 (+ j1 1))))
(assert (= o198 (ite (<= o192 k) true false)))
(assert (= result41 (ite (= o198 true) o197 false)))
(assert (= result41 true))
(assert (and (<= 0 i4) (<= i4 99)))
(assert (= o202 i4))
(assert (= temp___720 (select (rec__patience__state__stacks (us_split_fields__content s__split_fields20)) o202)))
(assert (and (<= 0 k) (<= k 99)))
(assert (= o203 k))
(assert (= o204 (select temp___720 o203)))
(assert (= temp___721 (to_rep1 o204)))
(assert (and (<= 0 temp___721) (<= temp___721 99)))
(assert (= o205 temp___721))
(assert (= o206 (select (rec__patience__state__values (us_split_fields__content s__split_fields20)) o205)))
