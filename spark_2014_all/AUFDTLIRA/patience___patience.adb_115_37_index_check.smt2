...
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o117 i1))
(assert (= temp___720 (select (rec__patience__state__stacks (us_split_fields__content s__split_fields20)) o117)))
(assert (and (<= 0 k) (<= k 99)))
(assert (= o118 k))
(assert (= o119 (select temp___720 o118)))
(assert (= temp___721 (to_rep1 o119)))
(assert (and (<= 0 temp___721) (<= temp___721 99)))
(assert (= o120 temp___721))
