...
(assert (not (= t1 t2)))
(assert (= (tree_structure f) true))
(assert (and (= result (valid_root f t1)) (and (= (= result true) (and (<= t1 (to_rep (rec__binary_trees__forest__s (us_split_fields5 f)))) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) t1)))) 2))) (=> (< (size f) t1) (not (= result true))))))
(assert (= result true))
