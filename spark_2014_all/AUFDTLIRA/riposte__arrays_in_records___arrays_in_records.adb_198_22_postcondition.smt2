...
(declare-const temp___330 index)
(declare-const temp___3301 (Array Int value))
(declare-const temp___3302 (Array Int value))
...
(declare-const temp___333 index)
(declare-const temp___3331 (Array Int value))
(declare-const temp___3332 (Array Int value))
