...
(assert (= r6b9 r6b7))
(assert (= l9 l7))
(assert (and (= o27 (+ y (int__content lcp__result4))) (in_range1 (+ y (int__content lcp__result4)))))
(assert (= o28 (- o27 1)))
(assert (and (= temp___204 o28) (in_range1 o28)))
...
(assert (and (= o25 (+ (to_rep (last (rt a))) 1)) (in_range1 (+ (to_rep (last (rt a))) 1))))
(assert (and (= o26 (+ x (int__content lcp__result4))) (in_range1 (+ x (int__content lcp__result4)))))
(assert (= result13 (ite (= o26 o25) true false)))
