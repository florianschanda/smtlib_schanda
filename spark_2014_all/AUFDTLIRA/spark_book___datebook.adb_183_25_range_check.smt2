...
(declare-fun temp___433 (Int Int Int) us_t1)
...
(assert (forall ((temp___435 Int) (temp___436 Int) (temp___437 Int)) (let ((temp___434 (temp___433 temp___435 temp___436 temp___437))) (=> (dynamic_invariant4 temp___435 true true true true) (and (=> (dynamic_property 1 2147483647 temp___436 temp___437) (and (= (first3 temp___434) temp___436) (= (last3 temp___434) temp___437))) (forall ((temp___438 Int)) (= (to_rep (select (to_array1 temp___434) temp___438)) temp___435)))))))
...
(assert (= status1 3))
(assert (= (to_rep1 (first2 (rt1 (temp___433 32 (to_rep1 description__first) (to_rep1 description__last))))) (to_rep1 description__first)))
(assert (= (to_rep1 (last2 (rt1 (temp___433 32 (to_rep1 description__first) (to_rep1 description__last))))) (to_rep1 description__last)))
(assert (= (mk___t1 temp___440 temp___4401) (temp___433 32 (to_rep1 description__first) (to_rep1 description__last))))
...
(assert (not (= (bool_eq4 (rec__datebook__event_record__date (us_split_fields7 (select event_array index2))) date) true)))
(assert (= j1 j))
(assert (= status3 status2))
(assert (= description3 description2))
(assert (= j2 j))
(assert (= status4 status2))
(assert (= description4 description2))
(assert (not (= index2 64)))
(assert (not (in_range12 (+ index2 1))))
(check-sat)
(exit)
