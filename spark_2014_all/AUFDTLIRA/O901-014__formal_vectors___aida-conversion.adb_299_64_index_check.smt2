...
(assert (and (<= (to_rep1 (first (rt source))) temp___1278) (<= temp___1278 (to_rep1 (last (rt source))))))
(assert (= o8 temp___1278))
(assert (= o9 (select (elts source) o8)))
(assert (= o10 (to_rep o9)))
(assert (= o11 (ite (= o10 55) true false)))
(assert (and (= temp___1277 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1277) (<= temp___1277 (to_rep1 (last (rt source))))))
(assert (= o4 temp___1277))
(assert (= o5 (select (elts source) o4)))
(assert (= o6 (to_rep o5)))
(assert (= o7 (ite (= o6 52) true false)))
(assert (and (= temp___1276 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1276) (<= temp___1276 (to_rep1 (last (rt source))))))
(assert (= o temp___1276))
(assert (= o1 (select (elts source) o)))
(assert (= o2 (to_rep o1)))
(assert (= o3 (ite (= o2 49) true false)))
(assert (and (= temp___1275 (+ (to_rep1 (first (rt source))) 0)) (in_range1 (+ (to_rep1 (first (rt source))) 0))))
(assert (not (<= (to_rep1 (first (rt source))) temp___1275)))
(check-sat)
(exit)
