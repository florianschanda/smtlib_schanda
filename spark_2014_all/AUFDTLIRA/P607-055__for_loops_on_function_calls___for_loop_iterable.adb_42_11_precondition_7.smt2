...
(declare-const declare_iterable__set__x__fields us_split_fields)
...
(assert (=> (= result3 true) (and (= o1 (element (mk___rep (mk___split_fields h__split_fields1)) temp___295)) (and (in_range1 o1) (= o1 (to_rep (select h__split_fields1 temp___295)))))))
...
(assert (and (= result5 (has_element (mk___rep (mk___split_fields h__split_fields1)) temp___295)) (= (= result5 true) (in_range3 temp___295))))
(assert (= result5 true))
(assert (and (= (has_element (rec__for_loop_iterable__container_holder__content h__split_fields2) temp___2951) true) (= e3 (element (rec__for_loop_iterable__container_holder__content h__split_fields2) temp___2951))))
(assert (= result6 (mk___split_fields__ref1 h__split_fields2)))
(assert (= h__split_fields3 (mk___split_fields1 (mk___rep declare_iterable__set__x__fields))))
(assert (= e3 0))
(assert (not (= (has_element (rec__for_loop_iterable__container_holder__content h__split_fields3) temp___2951) true)))
(check-sat)
(exit)
