...
(define-fun dynamic_invariant2 ((temp___expr_218 Int) (temp___is_init_215 Bool) (temp___skip_constant_216 Bool) (temp___do_toplevel_217 Bool)) Bool (=> (or (= temp___is_init_215 true) (<= first 1)) (dynamic_property first 1 temp___expr_218)))
(assert (= first zero))
...
(define-fun dynamic_invariant3 ((temp___expr_224 Int) (temp___is_init_221 Bool) (temp___skip_constant_222 Bool) (temp___do_toplevel_223 Bool)) Bool (=> (or (= temp___is_init_221 true) (<= first1 last)) (dynamic_property1 first1 last temp___expr_224)))
(assert (= first1 zero))
(assert (= last (- zero 1)))
...
(assert (forall ((temp___791 Int) (temp___792 Int) (temp___793 Int)) (let ((temp___790 (do_checks__do_range_check__B_17__a__aggregate_def temp___791 temp___792 temp___793))) (and (=> (dynamic_property6 1 2147483647 temp___792 temp___793) (and (= (first3 temp___790) temp___792) (= (last2 temp___790) temp___793))) (forall ((temp___794 Int)) (= (select (to_array temp___790) temp___794) (of_rep temp___791)))))))
(declare-fun do_checks__do_range_check__B_18__a__aggregate_def (Int Int Int) us_t1)
(assert (forall ((temp___798 Int) (temp___799 Int) (temp___800 Int)) (let ((temp___797 (do_checks__do_range_check__B_18__a__aggregate_def temp___798 temp___799 temp___800))) (and (=> (dynamic_property6 1 2147483647 temp___799 temp___800) (and (= (first5 temp___797) temp___799) (= (last4 temp___797) temp___800))) (forall ((temp___801 Int)) (= (select (to_array1 temp___797) temp___801) (of_rep temp___798)))))))
...
(declare-const temp___796 (Array Int character))
(declare-const temp___7961 t)
(declare-const us8 Int)
(declare-const o Int)
(declare-const temp___803 (Array Int character))
(declare-const temp___8031 t1)
