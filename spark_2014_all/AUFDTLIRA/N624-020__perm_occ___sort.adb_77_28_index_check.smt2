...
(assert (and (and (<= (to_rep1 (first (rt values))) min3) (<= min3 (to_rep1 (last (rt values))))) (forall ((i2 Int)) (=> (and (<= (to_rep1 (first (rt values))) i2) (<= i2 index3)) (<= (to_rep (select (elts values) min3)) (to_rep (select (elts values) i2)))))))
