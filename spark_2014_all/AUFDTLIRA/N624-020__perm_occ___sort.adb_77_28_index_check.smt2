...
(define-fun dynamic_invariant1 ((temp___expr_142 us_t) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (not (= temp___skip_constant_140 true)) (dynamic_property 1 100 (first1 temp___expr_142) (last1 temp___expr_142))))
...
(assert (and (= o (to_rep1 (first (rt values)))) (in_range2 (to_rep1 (first (rt values))))))
...
(assert (<= (to_rep1 (first (rt values))) index2))
(assert (<= index2 (to_rep1 (last (rt values)))))
(assert (and (<= (to_rep1 (first (rt values))) min1) (<= min1 (to_rep1 (last (rt values))))))
(assert (= o1 min1))
(assert (= o2 (select (elts values) o1)))
(assert (= o3 (to_rep o2)))
(assert (= result2 (ite (< (to_rep (select (elts values) index2)) o3) true false)))
(assert (=> (= result2 true) (and (= o4 index2) (in_range2 index2))))
(assert (=> (= result2 true) (= min1 result3)))
(assert (=> (= result2 true) (= min2 o4)))
(assert (=> (not (= result2 true)) (= min2 min1)))
(assert (and (and (<= (to_rep1 (first (rt values))) min3) (<= min3 (to_rep1 (last (rt values))))) (forall ((i1 Int)) (=> (and (<= (to_rep1 (first (rt values))) i1) (<= i1 index3)) (<= (to_rep (select (elts values) min3)) (to_rep (select (elts values) i1)))))))
(assert (and (and (=> (<= (to_rep1 (first (rt values))) (to_rep1 (last (rt values)))) (dynamic_property1 (to_rep1 (first (rt values))) (to_rep1 (last (rt values))) index3)) (=> (<= 1 2147483647) (in_range2 min3))) (and (<= (to_rep1 (first (rt values))) index3) (<= index3 (to_rep1 (last (rt values)))))))
(assert (<= (to_rep1 (first (rt values))) min3))
(assert (<= min3 (to_rep1 (last (rt values)))))
(assert (<= (to_rep1 (first (rt values))) i))
(assert (<= i index3))
(assert (and (<= (to_rep1 (first (rt values))) i) (<= i (to_rep1 (last (rt values))))))
(assert (= o5 i))
(assert (= o6 (select (elts values) o5)))
(assert (= o7 (to_rep o6)))
(assert (not (<= (to_rep1 (first (rt values))) min3)))
(check-sat)
(exit)
