...
(define-fun o15 () us_t (mk___t o3 o4))
...
(assert (=> (= result2 true) (and (= o15 (remove b o2)) (and (dynamic_invariant1 o15 true false true true) (and (= (invariant__ o15) true) (and (= (to_rep1 (last o4)) (- (to_rep1 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o2 1))) (= (to_rep (select (elts b) k)) (to_rep (select o3 k))))) (and (forall ((k Int)) (=> (and (<= (+ o2 1) k) (<= k (to_rep1 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select o3 (- k 1)))))) (forall ((k Int)) (=> (and (<= o2 k) (<= k (- (to_rep1 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o3 k)))))))))))))
(assert (=> (= result2 true) (and (= o16 (remove a ia)) (and (dynamic_invariant1 o16 true false true true) (and (= (invariant__ o16) true) (and (= (to_rep1 (last o1)) (- (to_rep1 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ia 1))) (= (to_rep (select (elts a) k)) (to_rep (select o k))))) (and (forall ((k Int)) (=> (and (<= (+ ia 1) k) (<= k (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select o (- k 1)))))) (forall ((k Int)) (=> (and (<= ia k) (<= k (- (to_rep1 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select o k)))))))))))))
(assert (=> (= result2 true) (and (= result1 (is_perm o16 o15)) (= (= result1 true) (or (and (= (length o16) 0) (= (length o15) 0)) (exists ((ia1 Int)) (and (and (<= (to_rep1 (first o1)) ia1) (<= ia1 (to_rep1 (last o1)))) (exists ((ib3 Int)) (and (and (<= (to_rep1 (first o4)) ib3) (<= ib3 (to_rep1 (last o4)))) (and (= (to_rep (select o ia1)) (to_rep (select o3 ib3))) (= (is_perm (remove o16 ia1) (remove o15 ib3)) true)))))))))))
...
(assert (= o14 (to_rep o10)))
(assert (= result3 (ite (= o14 o13) true false)))
(assert (= result3 true))
