...
(declare-fun temp___469 (Int) (Array Int unsigned_byte))
...
(assert (forall ((temp___471 Int)) (=> (dynamic_invariant temp___471 true true true true) (forall ((temp___472 Int)) (= (to_rep (select (temp___469 temp___471) temp___472)) temp___471)))))
