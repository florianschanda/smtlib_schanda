...
(declare-fun temp_____aggregate_def_469 (Int) (Array Int unsigned_byte))
...
(assert (= (unsigned_byteqtint rliteral) 8))
(assert (forall ((temp___471 Int)) (=> (dynamic_invariant temp___471 true true true true) (forall ((temp___472 Int)) (= (select (temp_____aggregate_def_469 temp___471) temp___472) rliteral)))))
...
(assert (= result x))
(assert (= x1 (temp_____aggregate_def_469 8)))
(assert (not (= (to_rep (select x1 4)) 8)))
(check-sat)
(exit)
