...
(assert (<= 1 i5))
(assert (<= i5 100))
(assert (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) y1) i5))) true))
(assert (not (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 f_1__split_fields3) x1) i5))) true)))
(check-sat)
(exit)
