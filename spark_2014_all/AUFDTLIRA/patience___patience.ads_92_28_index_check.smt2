...
(assert (= result2 true))
(assert (<= 0 i2))
(assert (<= i2 (- (to_rep1 (rec__patience__state__numstacks (us_split_fields1 s))) 1)))
(assert (and (<= 0 i2) (<= i2 99)))
(assert (= o52 i2))
(assert (= o53 (select (rec__patience__state__stacksizes (us_split_fields1 s)) o52)))
(assert (= o54 (to_rep1 o53)))
(assert (= o55 (- o54 2)))
(assert (= o56 (ite (<= j1 o55) true false)))
(assert (= result9 (ite (<= 0 j1) o56 false)))
(assert (= result9 true))
(assert (and (<= 0 i2) (<= i2 99)))
(assert (= o58 i2))
(assert (= o59 (select (rec__patience__state__stacksizes (us_split_fields1 s)) o58)))
(assert (= o60 (to_rep1 o59)))
(assert (= o61 (- o60 1)))
(assert (= o62 (ite (<= k1 o61) true false)))
(assert (and (= o57 (+ j1 1)) (in_range1 (+ j1 1))))
(assert (= o63 (ite (<= o57 k1) true false)))
(assert (= result10 (ite (= o63 true) o62 false)))
(assert (= result10 true))
(assert (and (<= 0 i2) (<= i2 99)))
(assert (= o65 i2))
(assert (= temp___451 (select (rec__patience__state__stacks (us_split_fields1 s)) o65)))
(assert (and (<= 0 k1) (<= k1 99)))
(assert (= o66 k1))
(assert (= o67 (select temp___451 o66)))
