...
(assert (type_invariant1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3))))
(assert (and (= o64 (position1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)) j3)) (and (in_range5 o64) (= o64 (position (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) j3)))))
(assert (type_invariant1 (mk___rep3 (us_split_fields__content3 t__split_fields14))))
(assert (not (not (= (parent1 (mk___rep3 (us_split_fields__content3 t__split_fields14)) j3) 0))))
(check-sat)
(exit)
