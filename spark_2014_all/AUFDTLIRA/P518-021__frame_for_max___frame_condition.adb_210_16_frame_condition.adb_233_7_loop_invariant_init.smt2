...
(assert (<= i11 j5))
(assert (<= j5 k4))
(assert (not (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a2 i11)))) (to_rep (rec__frame_condition__cell__max_left (us_split_fields1 (select a2 j5)))))))
(check-sat)
(exit)
