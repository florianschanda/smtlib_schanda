...
(define-fun dynamic_invariant ((temp___expr_148 Int) (temp___is_init_145 Bool) (temp___skip_constant_146 Bool) (temp___do_toplevel_147 Bool)) Bool (=> (or (= temp___is_init_145 true) (<= 0 99)) (in_range1 temp___expr_148)))
...
(assert (forall ((temp___287 (Array Int et1))) (forall ((temp___288 Int) (temp___289 Int) (temp___290 Int)) (let ((temp___286 (temp___285 temp___287 temp___288 temp___289 temp___290))) (forall ((temp___291 Int)) (ite (and (<= temp___288 temp___291) (<= temp___291 temp___289)) (= (select temp___286 temp___291) (of_rep temp___290)) (= (select temp___286 temp___291) (select temp___287 temp___291))))))))
(define-fun dynamic_invariant1 ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= 1 10)) (in_range temp___expr_142)))
(declare-const o Int)
(assert (in_range1 e))
