...
(declare-fun temp_____aggregate_def_633 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___635 (Array Int et1))) (forall ((temp___636 Int) (temp___637 Int)) (let ((temp___634 (temp_____aggregate_def_633 temp___635 temp___636 temp___637))) (=> (and (dynamic_invariant temp___636 true true true true) (dynamic_invariant1 temp___637 true true true true)) (forall ((temp___638 Int)) (ite (= temp___638 temp___636) (= (to_rep (select temp___634 temp___638)) temp___637) (= (select temp___634 temp___638) (select temp___635 temp___638)))))))))
...
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (bool_eq a2 1 10 (temp_____aggregate_def_633 a i e) 1 10) true)))
(check-sat)
(exit)
