...
(declare-fun temp___995 (Int Int Int) us_t2)
...
(assert (forall ((temp___997 Int) (temp___998 Int) (temp___999 Int)) (let ((temp___996 (temp___995 temp___997 temp___998 temp___999))) (=> (dynamic_invariant3 temp___997 true true true true) (and (=> (dynamic_property6 1 2147483647 temp___998 temp___999) (and (= (first5 temp___996) temp___998) (= (last5 temp___996) temp___999))) (forall ((temp___1000 Int)) (= (to_rep1 (select (to_array2 temp___996) temp___1000)) temp___997)))))))
(define-fun dynamic_invariant6 ((temp___expr_509 us_t1) (temp___is_init_505 Bool) (temp___skip_constant_506 Bool) (temp___do_toplevel_507 Bool) (temp___do_typ_inv_508 Bool)) Bool (=> (not (= temp___skip_constant_506 true)) (and (dynamic_property3 1 r79b (first3 temp___expr_509) (last3 temp___expr_509)) (and (= (first3 temp___expr_509) 1) (= (last3 temp___expr_509) r79b)))))
...
(declare-const o3 t)
(declare-const temp___993 natural_index)
(declare-const temp___9931 natural_index)
(declare-const temp___9932 (Array Int character))
(declare-const temp___9933 t)
(declare-const temp___994 natural_index)
(declare-const temp___9941 natural_index)
(declare-const temp___9942 (Array Int character))
(declare-const temp___9943 t)
(declare-const temp___1002 (Array Int character))
(declare-const temp___10021 t2)
(declare-const temp___1003 (Array Int character))
(declare-const temp___10031 t1)
(declare-const result us_split_fields__ref)
(declare-const this__split_fields3 us_split_fields)
(define-fun temp___9934 () us_rep (mk___rep (mk___split_discrs temp___993) (mk___split_fields temp___9931 (mk___t temp___9932 temp___9933))))
...
(assert (= this__split_discrs (mk___split_discrs temp___993)))
(assert (= temp___9931 o1))
(assert (= temp___9932 o2))
(assert (= temp___9933 o3))
(assert (dynamic_predicate temp___9934))
(assert (= (mk___rep (mk___split_discrs temp___994) (mk___split_fields temp___9941 (mk___t temp___9942 temp___9943))) temp___9934))
(assert (= result (mk___split_fields__ref (mk___split_fields this__split_fields (mk___t this__split_fields1 this__split_fields2)))))
(assert (= this__split_fields3 (mk___split_fields temp___9941 (mk___t temp___9942 temp___9943))))
(assert (= this__split_discrs (mk___split_discrs temp___994)))
(assert (= (to_rep (rec__bounded_dynamic_strings__sequence__capacity this__split_discrs)) r79b))
(assert (in_range1 r79b))
(assert (= (to_rep2 (first4 (rt2 (temp___995 32 1 r79b)))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___995 32 1 r79b)))) r79b))
(assert (= (mk___t2 temp___1002 temp___10021) (temp___995 32 1 r79b)))
(assert (= (ite (<= (to_rep2 (first4 temp___10021)) (to_rep2 (last4 temp___10021))) (+ (- (to_rep2 (last4 temp___10021)) (to_rep2 (first4 temp___10021))) 1) 0) (ite (<= 1 r79b) (+ (- r79b 1) 1) 0)))
(assert (= temp___1002 temp___1003))
(assert (= (mk1 (to_rep2 (first4 temp___10021)) (to_rep2 (last4 temp___10021))) temp___10031))
(assert (not (= (ite (<= (to_rep2 (first2 temp___10031)) (to_rep2 (last2 temp___10031))) (+ (- (to_rep2 (last2 temp___10031)) (to_rep2 (first2 temp___10031))) 1) 0) (ite (<= (to_rep2 (first (rt (rec__bounded_dynamic_strings__sequence__content this__split_fields3)))) (to_rep2 (last (rt (rec__bounded_dynamic_strings__sequence__content this__split_fields3))))) (+ (- (to_rep2 (last (rt (rec__bounded_dynamic_strings__sequence__content this__split_fields3)))) (to_rep2 (first (rt (rec__bounded_dynamic_strings__sequence__content this__split_fields3))))) 1) 0))))
(check-sat)
(exit)
