...
(define-fun dynamic_invariant ((temp___expr_195 Int) (temp___is_init_192 Bool) (temp___skip_constant_193 Bool) (temp___do_toplevel_194 Bool)) Bool (=> (or (= temp___is_init_192 true) (<= 0 2147483647)) (in_range1 temp___expr_195)))
(declare-fun to_rep (natural_index) Int)
...
(define-fun dynamic_invariant1 ((temp___expr_207 us_rep) (temp___is_init_204 Bool) (temp___skip_constant_205 Bool) (temp___do_toplevel_206 Bool)) Bool (and (=> (= temp___do_toplevel_206 true) (=> (= temp___is_init_204 true) (and (<= 0 (to_rep (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 temp___expr_207)))) (<= (to_rep (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 temp___expr_207))) (to_rep (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 temp___expr_207))))))) (let ((temp___209 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 temp___expr_207)))) (and (dynamic_property1 1 (to_rep temp___209) (first1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 temp___expr_207))) (last1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 temp___expr_207)))) (and (= (first1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 temp___expr_207))) 1) (= (last1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 temp___expr_207))) (to_rep temp___209)))))))
(define-fun dynamic_predicate ((temp___211 us_rep)) Bool (and (<= 0 (to_rep (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 temp___211)))) (<= (to_rep (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 temp___211))) (to_rep (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 temp___211))))))
(declare-fun length1 (us_rep) Int)
(declare-fun length__function_guard (Int us_rep) Bool)
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant1 this true true true) (dynamic_invariant (length1 this) true false true)) :pattern ((length1 this)))))
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant1 this true true true) (= (length1 this) (to_rep (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 this))))) :pattern ((length1 this)))))
(declare-fun empty (us_rep) Bool)
(declare-fun empty__function_guard (Bool us_rep) Bool)
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant1 this true true true) (= (= (empty this) true) (= (length1 this) 0))) :pattern ((empty this)))))
...
(declare-fun temp___932 (Int Int Int) us_t2)
(assert (forall ((temp___934 Int) (temp___935 Int) (temp___936 Int)) (let ((temp___933 (temp___932 temp___934 temp___935 temp___936))) (and (=> (dynamic_property6 1 2147483647 temp___935 temp___936) (and (= (first5 temp___933) temp___935) (= (last5 temp___933) temp___936))) (forall ((temp___937 Int)) (= (select (to_array2 temp___933) temp___937) (of_rep1 temp___934)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_478 us_t1) (temp___is_init_475 Bool) (temp___skip_constant_476 Bool) (temp___do_toplevel_477 Bool)) Bool (=> (not (= temp___skip_constant_476 true)) (and (dynamic_property3 1 r79b (first3 temp___expr_478) (last3 temp___expr_478)) (and (= (first3 temp___expr_478) 1) (= (last3 temp___expr_478) r79b)))))
...
(declare-const o natural_index)
(declare-const o1 natural_index)
(declare-const o2 (Array Int character))
(declare-const o3 t)
(declare-const temp___930 natural_index)
(declare-const temp___9301 natural_index)
(declare-const temp___9302 (Array Int character))
(declare-const temp___9303 t)
(declare-const temp___931 natural_index)
(declare-const temp___9311 natural_index)
(declare-const temp___9312 (Array Int character))
(declare-const temp___9313 t)
(declare-const temp___939 (Array Int character))
(declare-const temp___9391 t2)
(declare-const temp___940 (Array Int character))
(declare-const temp___9401 t1)
(declare-const temp___942 (Array Int character))
(declare-const temp___9421 t1)
(declare-const o4 (Array Int character))
(declare-const o5 t)
(declare-const o6 natural_index)
(declare-const o7 (Array Int character))
(declare-const o8 t)
(declare-const temp___944 natural_index)
(declare-const temp___9441 natural_index)
(declare-const temp___9442 (Array Int character))
(declare-const temp___9443 t)
...
(assert (dynamic_invariant1 (mk___rep this__split_discrs (mk___split_fields this__split_fields (mk___t this__split_fields1 this__split_fields2))) false false true))
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= this__split_fields1 o2))
(assert (= this__split_fields2 o3))
(assert (= this__split_discrs (mk___split_discrs temp___930)))
(assert (= temp___9301 o1))
(assert (= temp___9302 o2))
(assert (= temp___9303 o3))
(assert (dynamic_predicate (mk___rep (mk___split_discrs temp___930) (mk___split_fields temp___9301 (mk___t temp___9302 temp___9303)))))
(assert (= (mk___rep (mk___split_discrs temp___931) (mk___split_fields temp___9311 (mk___t temp___9312 temp___9313))) (mk___rep (mk___split_discrs temp___930) (mk___split_fields temp___9301 (mk___t temp___9302 temp___9303)))))
(assert (= result (mk___split_fields__ref (mk___split_fields this__split_fields (mk___t this__split_fields1 this__split_fields2)))))
(assert (= this__split_fields3 (mk___split_fields temp___9311 (mk___t temp___9312 temp___9313))))
(assert (= this__split_discrs (mk___split_discrs temp___931)))
(assert (= (to_rep (rec__bounded_dynamic_strings__sequence__capacity this__split_discrs)) r79b))
(assert (in_range1 r79b))
(assert (= (to_rep2 (first4 (rt2 (temp___932 32 1 r79b)))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___932 32 1 r79b)))) r79b))
(assert (= (mk___t2 temp___939 temp___9391) (temp___932 32 1 r79b)))
(assert (= (ite (<= (to_rep2 (first4 temp___9391)) (to_rep2 (last4 temp___9391))) (+ (- (to_rep2 (last4 temp___9391)) (to_rep2 (first4 temp___9391))) 1) 0) (ite (<= 1 r79b) (+ (- r79b 1) 1) 0)))
(assert (= temp___939 temp___940))
(assert (= (mk1 (to_rep2 (first4 temp___9391)) (to_rep2 (last4 temp___9391))) temp___9401))
(assert (not (= (ite (<= (to_rep2 (first2 temp___9401)) (to_rep2 (last2 temp___9401))) (+ (- (to_rep2 (last2 temp___9401)) (to_rep2 (first2 temp___9401))) 1) 0) (ite (<= (to_rep2 (first (rt (rec__bounded_dynamic_strings__sequence__content this__split_fields3)))) (to_rep2 (last (rt (rec__bounded_dynamic_strings__sequence__content this__split_fields3))))) (+ (- (to_rep2 (last (rt (rec__bounded_dynamic_strings__sequence__content this__split_fields3)))) (to_rep2 (first (rt (rec__bounded_dynamic_strings__sequence__content this__split_fields3))))) 1) 0))))
(check-sat)
(exit)
