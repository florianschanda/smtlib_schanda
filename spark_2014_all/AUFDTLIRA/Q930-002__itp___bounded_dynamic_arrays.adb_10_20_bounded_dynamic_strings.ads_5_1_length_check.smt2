...
(assert (= (ite (<= (to_rep2 (first4 temp___10081)) (to_rep2 (last4 temp___10081))) (+ (- (to_rep2 (last4 temp___10081)) (to_rep2 (first4 temp___10081))) 1) 0) (ite (<= 1 r79b) (+ (- r79b 1) 1) 0)))
(assert (= temp___1008 temp___1009))
(assert (= (mk1 (to_rep2 (first4 temp___10081)) (to_rep2 (last4 temp___10081))) temp___10091))
(assert (not (= (ite (<= (to_rep2 (first2 temp___10091)) (to_rep2 (last2 temp___10091))) (+ (- (to_rep2 (last2 temp___10091)) (to_rep2 (first2 temp___10091))) 1) 0) (ite (<= (to_rep2 (first (rt (rec__bounded_dynamic_strings__sequence__content this__split_fields3)))) (to_rep2 (last (rt (rec__bounded_dynamic_strings__sequence__content this__split_fields3))))) (+ (- (to_rep2 (last (rt (rec__bounded_dynamic_strings__sequence__content this__split_fields3)))) (to_rep2 (first (rt (rec__bounded_dynamic_strings__sequence__content this__split_fields3))))) 1) 0))))
(check-sat)
(exit)
