...
(assert (not (= (to_rep (select (select my_board (to_rep1 p__split_fields2)) (to_rep1 p__split_fields3))) 2)))
(assert (= (to_rep (select (select my_board (to_rep1 p__split_fields2)) (to_rep1 p__split_fields3))) 1))
(assert (not (in_range (+ score1 10))))
(check-sat)
(exit)
