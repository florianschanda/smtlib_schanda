...
(assert (<= j8 100))
(assert (type_invariant1 (mk___rep3 (us_split_fields__content3 t__split_fields12))))
(assert (and (= temp___1203 (model__1 (mk___rep3 (us_split_fields__content3 t__split_fields12)))) (and (dynamic_invariant6 temp___1203 true false true) (= temp___1203 (model__ (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields12)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields__content3 t__split_fields12))))))))
(assert (= o222 (select temp___1203 j8)))
(assert (= o223 (us_split_fields1 o222)))
(assert (= result58 (rec__tree_model__path_type__k o223)))
