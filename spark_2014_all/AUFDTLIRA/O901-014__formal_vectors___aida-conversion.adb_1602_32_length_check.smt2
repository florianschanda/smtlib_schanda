...
(assert (not (= (ite (<= (to_rep1 (first8 temp___19911)) (to_rep1 (last8 temp___19911))) (+ (- (to_rep1 (last8 temp___19911)) (to_rep1 (first8 temp___19911))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 5) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 5)) 1) 0))))
(check-sat)
(exit)
