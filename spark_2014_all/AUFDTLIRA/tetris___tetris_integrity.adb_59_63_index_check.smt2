...
(assert (forall ((x px_coord)) (! (in_range2 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun in_range3 ((x Int)) Bool (and (<= (- 1) x) (<= x 49)))
...
(assert (forall ((x py_coord)) (! (in_range3 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(assert (forall ((x direction)) (! (in_range4 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (and (and (= (to_rep (rec__tetris_integrity__piece__s (us_split_fields1 a))) (to_rep (rec__tetris_integrity__piece__s (us_split_fields1 b)))) (= (to_rep3 (rec__tetris_integrity__piece__d (us_split_fields1 a))) (to_rep3 (rec__tetris_integrity__piece__d (us_split_fields1 b))))) (= (to_rep1 (rec__tetris_integrity__piece__x (us_split_fields1 a))) (to_rep1 (rec__tetris_integrity__piece__x (us_split_fields1 b))))) (= (to_rep2 (rec__tetris_integrity__piece__y (us_split_fields1 a))) (to_rep2 (rec__tetris_integrity__piece__y (us_split_fields1 b))))) true false))
...
(declare-datatypes () ((map__ref1 (mk_map__ref1 (map__content1 (Array Int map1))))))
(declare-fun slide1 ((Array Int map1) Int Int) (Array Int map1))
(assert (forall ((a (Array Int map1))) (forall ((first Int)) (! (= (slide1 a first first) a) :pattern ((slide1 a first first))))))
(assert (forall ((a (Array Int map1))) (forall ((old_first Int)) (forall ((new_first Int)) (forall ((i Int)) (! (= (select (slide1 a old_first new_first) i) (select a (- i (- new_first old_first)))) :pattern ((select (slide1 a old_first new_first) i))))))))
(define-fun bool_eq2 ((a (Array Int map1)) (a__first Int) (a__last Int) (b (Array Int map1)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_158 Int)) (=> (and (<= a__first temp___idx_158) (<= temp___idx_158 a__last)) (= (bool_eq1 (select a temp___idx_158) 0 3 0 3 (select b (+ (- b__first a__first) temp___idx_158)) 0 3 0 3) true)))) true false))
...
(declare-sort map2 0)
(declare-datatypes () ((map__ref2 (mk_map__ref2 (map__content2 map2)))))
...
(declare-fun slide2 (map2 Int Int Int Int) map2)
(assert (forall ((a map2)) (forall ((new_first Int) (old_first Int)) (forall ((new_first_2 Int) (old_first_2 Int)) (forall ((i Int)) (forall ((j Int)) (! (= (get1 (slide2 a old_first new_first old_first_2 new_first_2) i j) (get1 a (- i (- new_first old_first)) (- j (- new_first_2 old_first_2)))) :pattern ((get1 (slide2 a old_first new_first old_first_2 new_first_2) i j)))))))))
(define-fun bool_eq3 ((a map2) (a__first Int) (a__last Int) (a__first_2 Int) (a__last_2 Int) (b map2) (b__first Int) (b__last Int) (b__first_2 Int) (b__last_2 Int)) Bool (ite (and (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (ite (<= a__first_2 a__last_2) (and (<= b__first_2 b__last_2) (= (- a__last_2 a__first_2) (- b__last_2 b__first_2))) (< b__last_2 b__first_2))) (forall ((temp___idx_245 Int) (temp___idx_246 Int)) (=> (and (and (<= a__first temp___idx_245) (<= temp___idx_245 a__last)) (and (<= a__first_2 temp___idx_246) (<= temp___idx_246 a__last_2))) (= (bool_eq1 (get1 a temp___idx_245 temp___idx_246) 0 2 0 2 (get1 b (+ (- b__first a__first) temp___idx_245) (+ (- b__first_2 a__first_2) temp___idx_246)) 0 2 0 2) true)))) true false))
(assert (forall ((a map2) (b map2)) (forall ((a__first Int) (a__last Int) (a__first_2 Int) (a__last_2 Int) (b__first Int) (b__last Int) (b__first_2 Int) (b__last_2 Int)) (=> (= (bool_eq3 b b__first b__last b__first_2 b__last_2 a a__first a__last a__first_2 a__last_2) true) (and (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (ite (<= a__first_2 a__last_2) (and (<= b__first_2 b__last_2) (= (- a__last_2 a__first_2) (- b__last_2 b__first_2))) (< b__last_2 b__first_2))) (forall ((temp___idx_245 Int) (temp___idx_246 Int)) (=> (and (and (<= a__first temp___idx_245) (<= temp___idx_245 a__last)) (and (<= a__first_2 temp___idx_246) (<= temp___idx_246 a__last_2))) (= (bool_eq1 (get1 a temp___idx_245 temp___idx_246) 0 2 0 2 (get1 b (+ (- b__first a__first) temp___idx_245) (+ (- b__first_2 a__first_2) temp___idx_246)) 0 2 0 2) true))))))))
(declare-const possible_three_shapes map2)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(assert true)
(assert (forall ((p us_rep)) (! (= (= (within_bounds__2 p) true) (ite (= (to_rep (rec__tetris_integrity__piece__s (us_split_fields1 p))) 2) (and (= (within_bounds (to_rep2 (rec__tetris_integrity__piece__y (us_split_fields1 p))) (to_rep1 (rec__tetris_integrity__piece__x (us_split_fields1 p)))) true) (= (within_bounds (+ (to_rep2 (rec__tetris_integrity__piece__y (us_split_fields1 p))) 1) (+ (to_rep1 (rec__tetris_integrity__piece__x (us_split_fields1 p))) 1)) true)) (ite (= (to_rep (rec__tetris_integrity__piece__s (us_split_fields1 p))) 1) (forall ((y Int)) (=> (and (<= 0 y) (<= y 3)) (forall ((x Int)) (=> (and (<= 0 x) (<= x 3)) (=> (= (let ((temp___681 (select possible_i_shapes (to_rep3 (rec__tetris_integrity__piece__d (us_split_fields1 p)))))) (get temp___681 y x)) true) (= (within_bounds (+ (to_rep2 (rec__tetris_integrity__piece__y (us_split_fields1 p))) y) (+ (to_rep1 (rec__tetris_integrity__piece__x (us_split_fields1 p))) x)) true)))))) (forall ((y Int)) (=> (and (<= 0 y) (<= y 2)) (forall ((x Int)) (=> (and (<= 0 x) (<= x 2)) (=> (= (let ((temp___682 (get1 possible_three_shapes (to_rep (rec__tetris_integrity__piece__s (us_split_fields1 p))) (to_rep3 (rec__tetris_integrity__piece__d (us_split_fields1 p)))))) (get temp___682 y x)) true) (= (within_bounds (+ (to_rep2 (rec__tetris_integrity__piece__y (us_split_fields1 p))) y) (+ (to_rep1 (rec__tetris_integrity__piece__x (us_split_fields1 p))) x)) true))))))))) :pattern ((within_bounds__2 p)))))
(declare-sort cell 0)
...
(assert (forall ((x cell)) (! (in_range5 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(declare-datatypes () ((map__ref3 (mk_map__ref3 (map__content3 (Array Int cell))))))
(declare-fun slide3 ((Array Int cell) Int Int) (Array Int cell))
(assert (forall ((a (Array Int cell))) (forall ((first Int)) (! (= (slide3 a first first) a) :pattern ((slide3 a first first))))))
(assert (forall ((a (Array Int cell))) (forall ((old_first Int)) (forall ((new_first Int)) (forall ((i Int)) (! (= (select (slide3 a old_first new_first) i) (select a (- i (- new_first old_first)))) :pattern ((select (slide3 a old_first new_first) i))))))))
(define-fun bool_eq4 ((a (Array Int cell)) (a__first Int) (a__last Int) (b (Array Int cell)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (to_rep4 (select a temp___idx_154)) (to_rep4 (select b (+ (- b__first a__first) temp___idx_154))))))) true false))
...
(declare-const dummy11 (Array Int cell))
(declare-const value__size3 Int)
(declare-fun object__size3 ((Array Int cell)) Int)
(declare-const value__component__size2 Int)
(declare-fun object__component__size2 ((Array Int cell)) Int)
(declare-const value__alignment3 Int)
(declare-fun object__alignment3 ((Array Int cell)) Int)
(assert (<= 0 value__size3))
(assert (forall ((a (Array Int cell))) (<= 0 (object__size3 a))))
(assert (<= 0 value__component__size2))
(assert (forall ((a (Array Int cell))) (<= 0 (object__component__size2 a))))
(assert (<= 0 value__alignment3))
(assert (forall ((a (Array Int cell))) (<= 0 (object__alignment3 a))))
(declare-fun user_eq11 ((Array Int cell) (Array Int cell)) Bool)
(declare-datatypes () ((map__ref4 (mk_map__ref4 (map__content4 (Array Int (Array Int cell)))))))
(declare-fun slide4 ((Array Int (Array Int cell)) Int Int) (Array Int (Array Int cell)))
(assert (forall ((a (Array Int (Array Int cell)))) (forall ((first Int)) (! (= (slide4 a first first) a) :pattern ((slide4 a first first))))))
(assert (forall ((a (Array Int (Array Int cell)))) (forall ((old_first Int)) (forall ((new_first Int)) (forall ((i Int)) (! (= (select (slide4 a old_first new_first) i) (select a (- i (- new_first old_first)))) :pattern ((select (slide4 a old_first new_first) i))))))))
...
(define-fun dynamic_invariant1 ((temp___expr_537 Int) (temp___is_init_533 Bool) (temp___skip_constant_534 Bool) (temp___do_toplevel_535 Bool) (temp___do_typ_inv_536 Bool)) Bool (=> (or (= temp___is_init_533 true) (<= 0 7)) (in_range5 temp___expr_537)))
...
(define-fun dynamic_invariant3 ((temp___expr_551 Int) (temp___is_init_547 Bool) (temp___skip_constant_548 Bool) (temp___do_toplevel_549 Bool) (temp___do_typ_inv_550 Bool)) Bool (=> (or (= temp___is_init_547 true) (<= 3 7)) (in_range6 temp___expr_551)))
(define-fun dynamic_invariant4 ((temp___expr_558 Int) (temp___is_init_554 Bool) (temp___skip_constant_555 Bool) (temp___do_toplevel_556 Bool) (temp___do_typ_inv_557 Bool)) Bool (=> (or (= temp___is_init_554 true) (<= 1 10)) (in_range7 temp___expr_558)))
(define-fun dynamic_invariant5 ((temp___expr_565 Int) (temp___is_init_561 Bool) (temp___skip_constant_562 Bool) (temp___do_toplevel_563 Bool) (temp___do_typ_inv_564 Bool)) Bool (=> (or (= temp___is_init_561 true) (<= 1 50)) (in_range8 temp___expr_565)))
(define-fun dynamic_invariant6 ((temp___expr_595 Int) (temp___is_init_591 Bool) (temp___skip_constant_592 Bool) (temp___do_toplevel_593 Bool) (temp___do_typ_inv_594 Bool)) Bool (=> (or (= temp___is_init_591 true) (<= (- 1) 9)) (in_range2 temp___expr_595)))
(define-fun dynamic_invariant7 ((temp___expr_602 Int) (temp___is_init_598 Bool) (temp___skip_constant_599 Bool) (temp___do_toplevel_600 Bool) (temp___do_typ_inv_601 Bool)) Bool (=> (or (= temp___is_init_598 true) (<= (- 1) 49)) (in_range3 temp___expr_602)))
(define-fun dynamic_invariant8 ((temp___expr_609 Int) (temp___is_init_605 Bool) (temp___skip_constant_606 Bool) (temp___do_toplevel_607 Bool) (temp___do_typ_inv_608 Bool)) Bool (=> (or (= temp___is_init_605 true) (<= 0 3)) (in_range4 temp___expr_609)))
(assert (= possible_i_shapes (tetris_integrity__possible_i_shapes__aggregate_def (temp_____aggregate_def_165 (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 1 0) (distinct 1 0) (distinct 1 0) (distinct 1 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 0 0)) (temp_____aggregate_def_185 (distinct 0 0) (distinct 0 0) (distinct 1 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 1 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 1 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 1 0) (distinct 0 0)) (temp_____aggregate_def_205 (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 1 0) (distinct 1 0) (distinct 1 0) (distinct 1 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 0 0)) (temp_____aggregate_def_225 (distinct 0 0) (distinct 1 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 1 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 1 0) (distinct 0 0) (distinct 0 0) (distinct 0 0) (distinct 1 0) (distinct 0 0) (distinct 0 0)))))
...
(assert true)
(assert (forall ((y Int) (x Int)) (! (= (= (within_bounds y x) true) (and (in_range8 y) (in_range7 x))) :pattern ((within_bounds y x)))))
...
(assert (not (= (to_rep cur_piece__split_fields) 2)))
(assert (not (= (to_rep cur_piece__split_fields) 1)))
(assert (= result y))
(assert (= y1 0))
(assert (<= 0 y1))
(assert (<= y1 2))
...
(assert (<= 0 x1))
(assert (<= x1 2))
(assert (and (forall ((temp___792 Int)) (=> (and (<= 1 temp___792) (<= temp___792 50)) (=> (not (= (+ (to_rep2 cur_piece__split_fields3) y2) temp___792)) (= (select cur_board1 temp___792) (select cur_board temp___792))))) (and (<= 0 x2) (<= x2 2))))
(assert (and (<= 3 (to_rep cur_piece__split_fields)) (<= (to_rep cur_piece__split_fields) 7)))
(assert (= o (to_rep cur_piece__split_fields)))
(assert (= temp___787 (get1 possible_three_shapes o (to_rep3 cur_piece__split_fields1))))
(assert (= result2 (get temp___787 y2 x2)))
(assert (= result2 true))
(assert (= (to_rep4 o1) (to_rep cur_piece__split_fields)))
(assert (not (<= (+ (to_rep1 cur_piece__split_fields2) x2) 10)))
(check-sat)
(exit)
