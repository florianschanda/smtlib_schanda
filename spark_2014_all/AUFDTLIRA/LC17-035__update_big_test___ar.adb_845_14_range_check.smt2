...
(assert (and (and (= (bool_eq2 a1 1 16 (temp___5423 t1 k (temp___5429 (select t1 k) j (temp___5435 (select (select t1 k) j) i e))) 1 16) true) (or (and (= k 16) (= k_next1 1)) (and (< k 16) (= k_next1 (+ k 1))))) (in_range3 k_next1)))
