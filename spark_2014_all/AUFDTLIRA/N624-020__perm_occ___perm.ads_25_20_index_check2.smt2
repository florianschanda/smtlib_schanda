...
(assert (=> (= (to_rep1 (first (rt r))) (to_rep1 (first (rt a)))) (= result (ite (= (to_rep1 (last (rt r))) (to_rep1 (last (rt a)))) true false))))
(assert (=> (not (= (to_rep1 (first (rt r))) (to_rep1 (first (rt a))))) (= result false)))
(assert (= result true))
(assert (not (<= (to_rep1 (first (rt r))) i)))
(check-sat)
(exit)
