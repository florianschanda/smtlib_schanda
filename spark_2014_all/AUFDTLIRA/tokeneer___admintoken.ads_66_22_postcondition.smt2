...
(assert (forall ((admintoken__authcert__fields us_split_fields10)) (! (dynamic_invariant3 (theauthcertrole admintoken__authcert__fields) true false true) :pattern ((theauthcertrole admintoken__authcert__fields)))))
...
(declare-datatypes () ((us_split_fields14 (mk___split_fields7 (rec__cert__id__contentst__id us_rep1) (rec__cert__id__contentst__notbefore us_rep2) (rec__cert__id__contentst__notafter us_rep2) (rec__cert__id__contentst__mechanism algorithmt) (rec__cert__id__contentst__subject us_rep) (rec__cert__id__contentst__subjectpublickey us_rep6)))))
...
(define-fun bool_eq8 ((a us_rep7) (b us_rep7)) Bool (ite (and (and (and (and (and (= (bool_eq2 (rec__cert__id__contentst__id (us_split_fields15 a)) (rec__cert__id__contentst__id (us_split_fields15 b))) true) (= (bool_eq3 (rec__cert__id__contentst__notbefore (us_split_fields15 a)) (rec__cert__id__contentst__notbefore (us_split_fields15 b))) true)) (= (bool_eq3 (rec__cert__id__contentst__notafter (us_split_fields15 a)) (rec__cert__id__contentst__notafter (us_split_fields15 b))) true)) (= (to_rep (rec__cert__id__contentst__mechanism (us_split_fields15 a))) (to_rep (rec__cert__id__contentst__mechanism (us_split_fields15 b))))) (= (bool_eq1 (rec__cert__id__contentst__subject (us_split_fields15 a)) (rec__cert__id__contentst__subject (us_split_fields15 b))) true)) (= (bool_eq7 (rec__cert__id__contentst__subjectpublickey (us_split_fields15 a)) (rec__cert__id__contentst__subjectpublickey (us_split_fields15 b))) true)) true false))
...
(assert (and (and (not (= (isgood (let ((subject idcert__split_fields)) idcert__split_fields1)) true)) (and (not (= (authcertvalid (let ((subject authcert__split_fields)) authcert__split_fields1)) true)) (not (in_range4 (theauthcertrole (let ((subject authcert__split_fields)) authcert__split_fields1)))))) (and (and (in_range1 tokenpresence1) (in_range3 tokentry1)) (in_range2 tokenid1))))
