...
(declare-fun user_eq2 (item item) Bool)
(declare-const dummy2 item)
...
(assert (forall ((i tTmy_arraySP1)) (and (<= 1 (tTmy_arraySP1qtint i)) (<= (tTmy_arraySP1qtint i) 10))))
...
(declare-datatypes () ((tTmy_arraySP1__ref (mk_tTmy_arraySP1__ref (tTmy_arraySP1__content tTmy_arraySP1)))))
(define-fun tTmy_arraySP1__ref___projection ((a tTmy_arraySP1__ref)) tTmy_arraySP1 (tTmy_arraySP1__content a))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-fun main__my_array__aggregate_def (Int) (Array Int item))
(define-fun dynamic_invariant ((temp___expr_18 Int) (temp___is_init_14 Bool) (temp___skip_constant_15 Bool) (temp___do_toplevel_16 Bool) (temp___do_typ_inv_17 Bool)) Bool (=> (or (= temp___is_init_14 true) (<= (- 2147483648) 2147483647)) (in_range temp___expr_18)))
(define-fun dynamic_invariant1 ((temp___expr_159 Int) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool) (temp___do_typ_inv_158 Bool)) Bool (=> (or (= temp___is_init_155 true) (<= 0 20)) (in_range2 temp___expr_159)))
(declare-const rliteral item)
(assert (= (itemqtint rliteral) 0))
(assert (forall ((temp___231 Int)) (=> (dynamic_invariant1 temp___231 true true true true) (forall ((temp___232 Int)) (= (select (main__my_array__aggregate_def temp___231) temp___232) rliteral)))))
(define-fun dynamic_invariant2 ((temp___expr_166 Int) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool (=> (or (= temp___is_init_162 true) (<= 1 10000)) (in_range1 temp___expr_166)))
...
(declare-const my_array (Array Int item))
(declare-const o integer)
(declare-const o1 integer)
(declare-const result (Array Int item))
(declare-const my_array1 (Array Int item))
(assert (= result my_array))
(assert (= my_array1 (main__my_array__aggregate_def 0)))
(assert (= (to_rep o1) 10))
(assert (= (to_rep o) 1))
