...
(assert (<= i5 j3))
(assert (<= j3 k2))
(assert (not (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a2 i5)))) (to_rep (rec__frame_condition__cell__max_left (us_split_fields1 (select a2 j3)))))))
(check-sat)
(exit)
