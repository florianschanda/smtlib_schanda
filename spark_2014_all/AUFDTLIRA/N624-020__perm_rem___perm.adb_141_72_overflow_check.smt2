...
(assert (and (= perm__remove_eq__aa__assume2 (remove a i)) (and (dynamic_invariant1 perm__remove_eq__aa__assume2 true false true true) (and (= (invariant__ perm__remove_eq__aa__assume2) true) (and (= (to_rep1 (last perm__remove_eq__aa__assume1)) (- (to_rep1 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- i 1))) (= (to_rep (select (elts a) k)) (to_rep (select perm__remove_eq__aa__assume k))))) (and (forall ((k Int)) (=> (and (<= (+ i 1) k) (<= k (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select perm__remove_eq__aa__assume (- k 1)))))) (forall ((k Int)) (=> (and (<= i k) (<= k (- (to_rep1 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select perm__remove_eq__aa__assume k))))))))))))
(assert (= perm__remove_eq__aa__assume2 aa))
(assert (dynamic_invariant1 aa true false true true))
(assert (and (= perm__remove_eq__bb__assume2 (remove b i)) (and (dynamic_invariant1 perm__remove_eq__bb__assume2 true false true true) (and (= (invariant__ perm__remove_eq__bb__assume2) true) (and (= (to_rep1 (last perm__remove_eq__bb__assume1)) (- (to_rep1 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- i 1))) (= (to_rep (select (elts b) k)) (to_rep (select perm__remove_eq__bb__assume k))))) (and (forall ((k Int)) (=> (and (<= (+ i 1) k) (<= k (to_rep1 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select perm__remove_eq__bb__assume (- k 1)))))) (forall ((k Int)) (=> (and (<= i k) (<= k (- (to_rep1 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select perm__remove_eq__bb__assume k))))))))))))
(assert (= perm__remove_eq__bb__assume2 bb))
(assert (dynamic_invariant1 bb true false true true))
(assert (forall ((j1 Int)) (=> (and (<= (to_rep1 (first (rt a))) j1) (<= j1 (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) j1)) (to_rep (select (elts b) j1))))))
(assert (<= (to_rep1 (first (rt aa))) j))
(assert (<= j (to_rep1 (last (rt aa)))))
(assert (not (< j i)))
(assert (and (= temp___626 (+ j 1)) (in_range1 (+ j 1))))
(assert (and (<= (to_rep1 (first (rt a))) temp___626) (<= temp___626 (to_rep1 (last (rt a))))))
(assert (= o2 temp___626))
(assert (= o3 (select (elts a) o2)))
(assert (= o4 (to_rep o3)))
(assert (and (<= (to_rep1 (first (rt aa))) j) (<= j (to_rep1 (last (rt aa))))))
(assert (= o j))
(assert (= o1 (select (elts aa) o)))
(assert (= o5 (to_rep o1)))
(assert (= result (ite (= o5 o4) true false)))
(assert (= result true))
