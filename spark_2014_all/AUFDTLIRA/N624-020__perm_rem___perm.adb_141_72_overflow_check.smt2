...
(assert (and (= (mk___t perm__remove_eq__aa__assume perm__remove_eq__aa__assume1) (remove a i)) (and (dynamic_invariant1 (mk___t perm__remove_eq__aa__assume perm__remove_eq__aa__assume1) true false true) (and (= (invariant__ (mk___t perm__remove_eq__aa__assume perm__remove_eq__aa__assume1)) true) (and (= (to_rep1 (last perm__remove_eq__aa__assume1)) (- (to_rep1 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- i 1))) (= (to_rep (select (elts a) k)) (to_rep (select perm__remove_eq__aa__assume k))))) (and (forall ((k Int)) (=> (and (<= (+ i 1) k) (<= k (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select perm__remove_eq__aa__assume (- k 1)))))) (forall ((k Int)) (=> (and (<= i k) (<= k (- (to_rep1 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select perm__remove_eq__aa__assume k))))))))))))
(assert (= (mk___t perm__remove_eq__aa__assume perm__remove_eq__aa__assume1) aa))
(assert (dynamic_invariant1 aa true false true))
(assert (and (= (mk___t perm__remove_eq__bb__assume perm__remove_eq__bb__assume1) (remove b i)) (and (dynamic_invariant1 (mk___t perm__remove_eq__bb__assume perm__remove_eq__bb__assume1) true false true) (and (= (invariant__ (mk___t perm__remove_eq__bb__assume perm__remove_eq__bb__assume1)) true) (and (= (to_rep1 (last perm__remove_eq__bb__assume1)) (- (to_rep1 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- i 1))) (= (to_rep (select (elts b) k)) (to_rep (select perm__remove_eq__bb__assume k))))) (and (forall ((k Int)) (=> (and (<= (+ i 1) k) (<= k (to_rep1 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select perm__remove_eq__bb__assume (- k 1)))))) (forall ((k Int)) (=> (and (<= i k) (<= k (- (to_rep1 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select perm__remove_eq__bb__assume k))))))))))))
(assert (= (mk___t perm__remove_eq__bb__assume perm__remove_eq__bb__assume1) bb))
(assert (dynamic_invariant1 bb true false true))
(assert (forall ((j2 Int)) (=> (and (<= (to_rep1 (first (rt a))) j2) (<= j2 (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) j2)) (to_rep (select (elts b) j2))))))
(assert (<= (to_rep1 (first (rt aa))) j1))
(assert (<= j1 (to_rep1 (last (rt aa)))))
(assert (not (< j1 i)))
(assert (and (= temp___562 (+ j1 1)) (in_range1 (+ j1 1))))
(assert (and (<= (to_rep1 (first (rt a))) temp___562) (<= temp___562 (to_rep1 (last (rt a))))))
(assert (= o17 temp___562))
(assert (= o18 (select (elts a) o17)))
(assert (= o19 (to_rep o18)))
(assert (and (<= (to_rep1 (first (rt aa))) j1) (<= j1 (to_rep1 (last (rt aa))))))
(assert (= o15 j1))
(assert (= o16 (select (elts aa) o15)))
(assert (= o20 (to_rep o16)))
(assert (= result1 (ite (= o20 o19) true false)))
(assert (= result1 true))
