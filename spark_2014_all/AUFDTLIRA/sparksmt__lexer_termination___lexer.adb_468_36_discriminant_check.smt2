...
(assert (and (and (and (and (and (and (and (and (=> (<= 0 2147483647) (in_range4 (let ((subject first_idx)) first_idx2))) (in_range2 current_line2)) (in_range4 current_col2)) (in_range4 current_idx2)) (=> (<= 0 9) (in_range11 (let ((subject state)) state2)))) (=> (<= 0 255) (in_range3 (let ((subject c)) c2)))) (=> (<= 0 2147483647) (in_range4 first_line2))) (in_range4 next_idx2)) (=> (<= 0 2147483647) (in_range4 (let ((subject first_col)) first_col2)))))
(assert (= result3 (mk_int__ref temp___8602)))
(assert (= temp___8603 current_idx2))
(assert (= result4 (mk_int__ref first_line2)))
(assert (= first_line3 current_line2))
(assert (= result5 (let ((subject first_col)) (mk_int__ref first_col2))))
(assert (= (let ((subject first_col)) first_col3) current_col2))
(assert (= result6 (let ((subject first_idx)) (mk_int__ref first_idx2))))
(assert (= (let ((subject first_idx)) first_idx3) current_idx2))
(assert (not (= (to_rep3 (rec__file_io__read_result__status current_read__split_discrs2)) 0)))
(check-sat)
(exit)
