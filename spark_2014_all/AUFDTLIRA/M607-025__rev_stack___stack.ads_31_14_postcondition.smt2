...
(assert (not (= (let ((temp___274 (to__ (mk___rep (mk___split_fields s__split_fields6 s__split_fields7))))) (bool_eq (elts temp___274) (to_rep (first (rt temp___274))) (to_rep (last (rt temp___274))) (let ((temp___273 (temp___217 x))) (let ((temp___272 (to__ (mk___rep (mk___split_fields s__split_fields s__split_fields1))))) (ite (= (length temp___272) 0) temp___273 (concat1 (elts temp___272) (to_rep (first (rt temp___272))) (to_rep (last (rt temp___272))) temp___273 1 1)))) (to_rep (first (let ((temp___272 (to__ (mk___rep (mk___split_fields s__split_fields s__split_fields1))))) (ite (= (length temp___272) 0) (mk 1 1) (mk (to_rep (first (rt temp___272))) (- (+ (to_rep (first (rt temp___272))) (+ (ite (<= (to_rep (first (rt temp___272))) (to_rep (last (rt temp___272)))) (+ (- (to_rep (last (rt temp___272))) (to_rep (first (rt temp___272)))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0))) 1)))))) (to_rep (last (let ((temp___272 (to__ (mk___rep (mk___split_fields s__split_fields s__split_fields1))))) (ite (= (length temp___272) 0) (mk 1 1) (mk (to_rep (first (rt temp___272))) (- (+ (to_rep (first (rt temp___272))) (+ (ite (<= (to_rep (first (rt temp___272))) (to_rep (last (rt temp___272)))) (+ (- (to_rep (last (rt temp___272))) (to_rep (first (rt temp___272)))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0))) 1)))))))) true)))
(check-sat)
(exit)
