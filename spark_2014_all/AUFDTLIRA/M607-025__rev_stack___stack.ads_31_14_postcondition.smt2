...
(assert (not (= (let ((temp___247 (to__ (mk___rep (mk___split_fields s__split_fields6 s__split_fields7))))) (bool_eq (elts temp___247) (to_rep (first (rt temp___247))) (to_rep (last (rt temp___247))) (let ((temp___246 (temp___190 x))) (let ((temp___245 (to__ (mk___rep (mk___split_fields s__split_fields s__split_fields1))))) (ite (= (length temp___245) 0) temp___246 (concat1 (elts temp___245) (to_rep (first (rt temp___245))) (to_rep (last (rt temp___245))) temp___246 1 1)))) (to_rep (first (let ((temp___245 (to__ (mk___rep (mk___split_fields s__split_fields s__split_fields1))))) (ite (= (length temp___245) 0) (mk 1 1) (mk (to_rep (first (rt temp___245))) (- (+ (to_rep (first (rt temp___245))) (+ (ite (<= (to_rep (first (rt temp___245))) (to_rep (last (rt temp___245)))) (+ (- (to_rep (last (rt temp___245))) (to_rep (first (rt temp___245)))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0))) 1)))))) (to_rep (last (let ((temp___245 (to__ (mk___rep (mk___split_fields s__split_fields s__split_fields1))))) (ite (= (length temp___245) 0) (mk 1 1) (mk (to_rep (first (rt temp___245))) (- (+ (to_rep (first (rt temp___245))) (+ (ite (<= (to_rep (first (rt temp___245))) (to_rep (last (rt temp___245)))) (+ (- (to_rep (last (rt temp___245))) (to_rep (first (rt temp___245)))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0))) 1)))))))) true)))
(check-sat)
(exit)
