...
(assert (=> (<= 1 r2b) (and (and (<= 1 1) (<= 1 10)) (and (<= 1 r2b) (<= r2b 10)))))
(assert (= o5 target__split_fields5))
(assert (= o5 temp___209))
(assert (= (mk1 1 r2b) temp___2091))
(assert (not (= (ite (<= (to_rep1 (first2 temp___2061)) (to_rep1 (last2 temp___2061))) (+ (- (to_rep1 (last2 temp___2061)) (to_rep1 (first2 temp___2061))) 1) 0) (ite (<= (to_rep1 (first2 temp___2091)) (to_rep1 (last2 temp___2091))) (+ (- (to_rep1 (last2 temp___2091)) (to_rep1 (first2 temp___2091))) 1) 0))))
(check-sat)
(exit)
