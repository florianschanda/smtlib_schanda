...
(assert (not (= (ite (<= (to_rep1 (first2 temp___1791)) (to_rep1 (last2 temp___1791))) (+ (- (to_rep1 (last2 temp___1791)) (to_rep1 (first2 temp___1791))) 1) 0) (ite (<= (to_rep1 (first2 temp___1821)) (to_rep1 (last2 temp___1821))) (+ (- (to_rep1 (last2 temp___1821)) (to_rep1 (first2 temp___1821))) 1) 0))))
(check-sat)
(exit)
