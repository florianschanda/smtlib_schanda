...
(assert (= result__3 (screen__writestatsdata__B251b__result__aggregate_def 32)))
...
(assert (forall ((temp___1407 Int)) (ite (and (<= 1 temp___1407) (<= temp___1407 (- (to_rep1 data__last) 1))) (= (select o2 temp___1407) (select (elts1 temp___1406) temp___1407)) (= (select o2 temp___1407) (select result__3 temp___1407)))))
...
(assert (= result__5 (screen__writestatsdata__B262b__result__aggregate_def 32)))
...
(assert (and (= temp___1417 (- (to_rep1 data__last1) 1)) (in_range1 (- (to_rep1 data__last1) 1))))
(assert (=> (<= 1 temp___1417) (and (and (<= 1 1) (<= 1 10)) (and (<= 1 temp___1417) (<= temp___1417 10)))))
(assert (= o8 result__5))
(assert (= temp___1418 (mk___t3 o8 (mk3 1 temp___1417))))
(assert (= (ite (<= (to_rep1 (first6 (rt3 temp___1415))) (to_rep1 (last6 (rt3 temp___1415)))) (+ (- (to_rep1 (last6 (rt3 temp___1415))) (to_rep1 (first6 (rt3 temp___1415)))) 1) 0) (ite (<= (to_rep1 (first6 (rt3 temp___1418))) (to_rep1 (last6 (rt3 temp___1418)))) (+ (- (to_rep1 (last6 (rt3 temp___1418))) (to_rep1 (first6 (rt3 temp___1418)))) 1) 0)))
(assert (= temp___1419 temp___1415))
(assert (forall ((temp___1420 Int)) (ite (and (<= 1 temp___1420) (<= temp___1420 (- (to_rep1 data__last1) 1))) (= (select o9 temp___1420) (select (elts3 temp___1419) temp___1420)) (= (select o9 temp___1420) (select result__5 temp___1420)))))
...
(assert (= (to_rep1 data__first2) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE4 c270b)))))))
(assert (= (to_rep1 data__last2) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE4 c270b)))))))
(assert (dynamic_property 1 2147483647 (to_rep1 data__first2) (to_rep1 data__last2)))
(assert (= result11 (mk_map__ref result__2)))
(assert (= result__7 (screen__writestatsdata__B273b__result__aggregate_def 32)))
(assert (=> (<= 2 (to_rep1 data__last2)) (and (and (<= (to_rep1 data__first2) 2) (<= 2 (to_rep1 data__last2))) (and (<= (to_rep1 data__first2) (to_rep1 data__last2)) (<= (to_rep1 data__last2) (to_rep1 data__last2))))))
(assert (= o14 data5))
(assert (= temp___1427 (mk___t6 o14 (mk6 2 (to_rep1 data__last2)))))
(assert (= (ite (<= (to_rep1 (first12 (rt6 temp___1427))) (to_rep1 (last12 (rt6 temp___1427)))) (+ (- (to_rep1 (last12 (rt6 temp___1427))) (to_rep1 (first12 (rt6 temp___1427)))) 1) 0) (ite (<= 1 (- (to_rep1 data__last2) 1)) (+ (- (- (to_rep1 data__last2) 1) 1) 1) 0)))
(assert (= temp___1428 (mk___t5 (slide (elts6 temp___1427) (to_rep1 (first12 (rt6 temp___1427))) 1) (mk5 1 (- (to_rep1 data__last2) 1)))))
(assert (and (= temp___1430 (- (to_rep1 data__last2) 1)) (in_range1 (- (to_rep1 data__last2) 1))))
(assert (<= 1 temp___1430))
(assert (not (<= temp___1430 10)))
(check-sat)
(exit)
