...
(assert (=> (= d 0) (= o1 o2)))
(assert (=> (= d 0) (= (rec__binary_trees__cell__right (us_split_fields3 (select f__split_fields1 i))) o3)))
(assert (=> (= d 0) (= (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i))) o4)))
(assert (=> (= d 0) (= (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 i))) o5)))
(assert (=> (= d 0) (= o6 o2)))
(assert (=> (= d 0) (= o7 o3)))
(assert (=> (= d 0) (= o8 o4)))
(assert (=> (= d 0) (= o9 o5)))
(assert (=> (= d 0) (= o10 (store f__split_fields1 i (mk___rep1 (mk___split_fields1 o6 o7 o8 o9))))))
(assert (=> (= d 0) (= f__split_fields o11)))
(assert (=> (= d 0) (= o10 o12)))
(assert (=> (= d 0) (= temp___708 o11)))
(assert (=> (= d 0) (= temp___7081 o12)))
(assert (=> (= d 0) (= result3 (mk___split_fields__ref2 (mk___split_fields2 f__split_fields f__split_fields1)))))
(assert (=> (= d 0) (= f__split_fields3 (mk___split_fields2 temp___708 temp___7081))))
(assert (=> (not (= d 0)) (= (to_rep o13) 0)))
(assert (=> (not (= d 0)) (= (rec__binary_trees__cell__left (us_split_fields3 (select f__split_fields1 i))) o14)))
(assert (=> (not (= d 0)) (= o13 o15)))
(assert (=> (not (= d 0)) (= (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i))) o16)))
(assert (=> (not (= d 0)) (= (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 i))) o17)))
(assert (=> (not (= d 0)) (= o18 o14)))
(assert (=> (not (= d 0)) (= o19 o15)))
(assert (=> (not (= d 0)) (= o20 o16)))
(assert (=> (not (= d 0)) (= o21 o17)))
(assert (=> (not (= d 0)) (= o22 (store f__split_fields1 i (mk___rep1 (mk___split_fields1 o18 o19 o20 o21))))))
(assert (=> (not (= d 0)) (= f__split_fields o23)))
(assert (=> (not (= d 0)) (= o22 o24)))
(assert (=> (not (= d 0)) (= temp___703 o23)))
(assert (=> (not (= d 0)) (= temp___7031 o24)))
(assert (=> (not (= d 0)) (= result4 (mk___split_fields__ref2 (mk___split_fields2 f__split_fields f__split_fields1)))))
(assert (=> (not (= d 0)) (= f__split_fields4 (mk___split_fields2 temp___703 temp___7031))))
(assert (=> (not (= d 0)) (= f__split_fields3 f__split_fields4)))
(assert (not (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields3) v1)))) i)))
(check-sat)
(exit)
