...
(assert (=> (= d 0) (= o10 o12)))
(assert (=> (= d 0) (= temp___754 o11)))
(assert (=> (= d 0) (= temp___7541 o12)))
(assert (=> (= d 0) (= result2 f__split_fields4)))
(assert (=> (= d 0) (= f__split_fields2 (mk___split_fields2 temp___754 temp___7541))))
...
(assert (=> (not (= d 0)) (= temp___749 o23)))
(assert (=> (not (= d 0)) (= temp___7491 o24)))
(assert (=> (not (= d 0)) (= result3 f__split_fields4)))
(assert (=> (not (= d 0)) (= f__split_fields3 (mk___split_fields2 temp___749 temp___7491))))
