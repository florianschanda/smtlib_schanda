...
(assert (and (= o4 (length model____split_fields)) (and (in_range6 o4) (<= (+ 0 o4) 2147483647))))
(assert (= result1 (ite (<= o4 10000) true false)))
(assert (=> (= result1 true) (and (= o3 (length1 model____split_fields1)) (in_range6 o3))))
(assert (=> (= result1 true) (= result (ite (<= o3 10000) true false))))
(assert (=> (not (= result1 true)) (= result false)))
(assert (= result true))
(assert (and (= o (length1 model____split_fields1)) (in_range6 o)))
