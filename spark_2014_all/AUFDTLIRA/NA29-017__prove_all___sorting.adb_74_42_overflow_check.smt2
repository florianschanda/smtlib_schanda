...
(assert (= (= o74 true) (forall ((k1 Int)) (=> (and (<= (to_rep a__first) k1) (<= k1 (to_rep a__last))) (=> (=> (<= a_first k1) (not (<= k1 (- (+ (+ a_first length1) length2) 1)))) (= (to_rep (select (map__content a2) k1)) (to_rep (select a k1))))))))
