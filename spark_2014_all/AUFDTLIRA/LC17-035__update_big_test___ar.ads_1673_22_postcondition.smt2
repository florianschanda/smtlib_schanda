...
(declare-fun temp___3621 ((Array Int us_rep) Int us_rep Int us_rep) (Array Int us_rep))
(assert (forall ((temp___3623 (Array Int us_rep))) (forall ((temp___3624 Int) (temp___3626 Int)) (forall ((temp___3625 us_rep) (temp___3627 us_rep)) (let ((temp___3622 (temp___3621 temp___3623 temp___3624 temp___3625 temp___3626 temp___3627))) (forall ((temp___3628 Int)) (ite (= temp___3628 temp___3626) (= (select temp___3622 temp___3628) temp___3627) (ite (= temp___3628 temp___3624) (= (select temp___3622 temp___3628) temp___3625) (= (select temp___3622 temp___3628) (select temp___3623 temp___3628))))))))))
(declare-fun temp___3630 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___3632 (Array Int et1))) (forall ((temp___3633 Int) (temp___3634 Int)) (let ((temp___3631 (temp___3630 temp___3632 temp___3633 temp___3634))) (forall ((temp___3635 Int)) (ite (= temp___3635 temp___3633) (= (select temp___3631 temp___3635) (of_rep temp___3634)) (= (select temp___3631 temp___3635) (select temp___3632 temp___3635))))))))
...
(assert (= a2 a3))
(assert (= a4 a2))
(assert (not (= (bool_eq2 a3 1 16 (temp___3621 a i (mk___rep (mk___split_fields (temp___3630 (rec__ar__rofa1__s1 (us_split_fields1 (select a i))) j e) (rec__ar__rofa1__t1 (us_split_fields1 (select a i))))) x r) 1 16) true)))
(check-sat)
(exit)
