...
(declare-fun temp___3680 ((Array Int us_rep) Int us_rep Int us_rep) (Array Int us_rep))
(declare-fun temp___3689 ((Array Int et1) Int Int) (Array Int et1))
...
(assert (forall ((temp___3682 (Array Int us_rep))) (forall ((temp___3683 Int) (temp___3685 Int)) (forall ((temp___3684 us_rep) (temp___3686 us_rep)) (let ((temp___3681 (temp___3680 temp___3682 temp___3683 temp___3684 temp___3685 temp___3686))) (=> (and (dynamic_invariant1 temp___3683 true true true true) (dynamic_invariant1 temp___3685 true true true true)) (forall ((temp___3687 Int)) (ite (= temp___3687 temp___3685) (= (select temp___3681 temp___3687) temp___3686) (ite (= temp___3687 temp___3683) (= (select temp___3681 temp___3687) temp___3684) (= (select temp___3681 temp___3687) (select temp___3682 temp___3687)))))))))))
(assert (forall ((temp___3691 (Array Int et1))) (forall ((temp___3692 Int) (temp___3693 Int)) (let ((temp___3690 (temp___3689 temp___3691 temp___3692 temp___3693))) (=> (and (dynamic_invariant temp___3692 true true true true) (dynamic_invariant2 temp___3693 true true true true)) (forall ((temp___3694 Int)) (ite (= temp___3694 temp___3692) (= (to_rep (select temp___3690 temp___3694)) temp___3693) (= (select temp___3690 temp___3694) (select temp___3691 temp___3694)))))))))
...
(assert (= a2 a3))
(assert (= a4 a2))
(assert (not (= (bool_eq2 a3 1 16 (temp___3680 a i (mk___rep (mk___split_fields (temp___3689 (rec__ar__rofa1__s1 (us_split_fields1 (select a i))) j e) (rec__ar__rofa1__t1 (us_split_fields1 (select a i))))) x r) 1 16) true)))
(check-sat)
(exit)
