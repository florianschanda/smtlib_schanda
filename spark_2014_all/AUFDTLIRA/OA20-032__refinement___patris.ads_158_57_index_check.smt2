...
(define-fun dynamic_invariant1 ((temp___expr_1855 Int) (temp___is_init_1852 Bool) (temp___skip_constant_1853 Bool) (temp___do_toplevel_1854 Bool)) Bool (=> (or (= temp___is_init_1852 true) (<= 0 7)) (in_range1 temp___expr_1855)))
(define-fun dynamic_invariant2 ((temp___expr_1873 Int) (temp___is_init_1870 Bool) (temp___skip_constant_1871 Bool) (temp___do_toplevel_1872 Bool)) Bool (=> (or (= temp___is_init_1870 true) (<= 1 10)) (in_range2 temp___expr_1873)))
(define-fun dynamic_invariant3 ((temp___expr_1879 Int) (temp___is_init_1876 Bool) (temp___skip_constant_1877 Bool) (temp___do_toplevel_1878 Bool)) Bool (=> (or (= temp___is_init_1876 true) (<= 1 20)) (in_range3 temp___expr_1879)))
(declare-const o Int)
