...
(define-fun dynamic_invariant1 ((temp___expr_1849 Int) (temp___is_init_1846 Bool) (temp___skip_constant_1847 Bool) (temp___do_toplevel_1848 Bool)) Bool (=> (or (= temp___is_init_1846 true) (<= 0 7)) (in_range1 temp___expr_1849)))
(define-fun dynamic_invariant2 ((temp___expr_1867 Int) (temp___is_init_1864 Bool) (temp___skip_constant_1865 Bool) (temp___do_toplevel_1866 Bool)) Bool (=> (or (= temp___is_init_1864 true) (<= 1 10)) (in_range2 temp___expr_1867)))
(define-fun dynamic_invariant3 ((temp___expr_1873 Int) (temp___is_init_1870 Bool) (temp___skip_constant_1871 Bool) (temp___do_toplevel_1872 Bool)) Bool (=> (or (= temp___is_init_1870 true) (<= 1 20)) (in_range3 temp___expr_1873)))
(declare-const o Int)
(declare-const temp___2073 (Array Int cell))
(assert (in_range y))
(assert (in_range x))
(assert (in_range2 x))
(assert (in_range3 y))
