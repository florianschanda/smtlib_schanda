...
(define-fun dynamic_invariant1 ((temp___expr_2087 Int) (temp___is_init_2083 Bool) (temp___skip_constant_2084 Bool) (temp___do_toplevel_2085 Bool) (temp___do_typ_inv_2086 Bool)) Bool (=> (or (= temp___is_init_2083 true) (<= 0 7)) (in_range1 temp___expr_2087)))
(define-fun dynamic_invariant2 ((temp___expr_2108 Int) (temp___is_init_2104 Bool) (temp___skip_constant_2105 Bool) (temp___do_toplevel_2106 Bool) (temp___do_typ_inv_2107 Bool)) Bool (=> (or (= temp___is_init_2104 true) (<= 1 10)) (in_range2 temp___expr_2108)))
(define-fun dynamic_invariant3 ((temp___expr_2115 Int) (temp___is_init_2111 Bool) (temp___skip_constant_2112 Bool) (temp___do_toplevel_2113 Bool) (temp___do_typ_inv_2114 Bool)) Bool (=> (or (= temp___is_init_2111 true) (<= 1 20)) (in_range3 temp___expr_2115)))
(declare-const o Int)
(declare-const temp___2330 (Array Int cell))
(assert (in_range y))
(assert (in_range x))
(assert (in_range2 x))
(assert (in_range3 y))
