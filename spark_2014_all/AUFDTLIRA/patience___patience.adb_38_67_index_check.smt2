...
(assert (and (<= 0 topstacki2) (<= topstacki2 99)))
(assert (= o16 topstacki2))
(assert (= o17 (select s__split_fields5 o16)))
(assert (= o18 (to_rep1 o17)))
(assert (= result7 (ite (<= 0 o18) true false)))
...
(assert (=> (= result7 true) (= o15 (to_rep1 o14))))
(assert (=> (= result7 true) (= result6 (ite (< o15 (to_rep1 s__split_fields2)) true false))))
...
(assert (=> (= result6 true) (= result5 (ite (<= 0 o12) true false))))
