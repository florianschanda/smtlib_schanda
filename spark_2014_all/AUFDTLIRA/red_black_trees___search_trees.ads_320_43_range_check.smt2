...
(define-fun dynamic_invariant ((temp___expr_315 us_rep1) (temp___is_init_311 Bool) (temp___skip_constant_312 Bool) (temp___do_toplevel_313 Bool) (temp___do_typ_inv_314 Bool)) Bool (=> (= temp___do_typ_inv_314 true) (= (tree_structure temp___expr_315) true)))
...
(assert (forall ((f us_rep1)) (! (=> (dynamic_invariant f true true true true) (dynamic_invariant1 (size f) true false true true)) :pattern ((size f)))))
(define-fun dynamic_invariant2 ((temp___expr_175 Int) (temp___is_init_171 Bool) (temp___skip_constant_172 Bool) (temp___do_toplevel_173 Bool) (temp___do_typ_inv_174 Bool)) Bool (=> (or (= temp___is_init_171 true) (<= 1 100)) (in_range temp___expr_175)))
(declare-fun valid_root (us_rep1 Int) Bool)
(declare-fun valid_root__function_guard (Bool us_rep1 Int) Bool)
(assert (forall ((f us_rep1)) (forall ((i Int)) (! (=> (and (dynamic_invariant f true true true true) (dynamic_invariant2 i true true true true)) (=> (< (size f) i) (not (= (valid_root f i) true)))) :pattern ((valid_root f i))))))
...
(assert (forall ((t us_rep2)) (! (=> (and (dynamic_invariant3 t true true true true) (type_invariant1 t)) (dynamic_invariant1 (size1 t) true false true true)) :pattern ((size1 t)))))
...
(define-fun dynamic_invariant5 ((temp___expr_189 Int) (temp___is_init_185 Bool) (temp___skip_constant_186 Bool) (temp___do_toplevel_187 Bool) (temp___do_typ_inv_188 Bool)) Bool (=> (or (= temp___is_init_185 true) (<= 0 2)) (in_range2 temp___expr_189)))
...
(assert (and (= o (size (mk___rep1 (mk___split_fields1 temp___6431 temp___6432)))) (in_range1 o)))
(assert (= result (ite (= o 0) true false)))
(assert (not (= result true)))
(assert (=> (not (= (to_rep temp___643) 0)) (and (= o1 (to_rep temp___643)) (in_range (to_rep temp___643)))))
...
(assert (= result1 true))
(assert (not (in_range (to_rep temp___643))))
(check-sat)
(exit)
