...
(define-fun dynamic_invariant ((temp___expr_273 us_rep1) (temp___is_init_270 Bool) (temp___skip_constant_271 Bool) (temp___do_toplevel_272 Bool)) Bool (= (tree_structure temp___expr_273) true))
(define-fun default_initial_assumption ((temp___expr_276 us_rep1) (temp___skip_top_level_277 Bool)) Bool (and (and (= (to_rep (rec__binary_trees__forest__s (us_split_fields3 temp___expr_276))) 0) (forall ((temp___279 Int)) (=> (and (<= 1 temp___279) (<= temp___279 100)) (and (and (and (= (to_rep (rec__binary_trees__cell__left (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 temp___expr_276)) temp___279)))) 0) (= (to_rep (rec__binary_trees__cell__right (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 temp___expr_276)) temp___279)))) 0)) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 temp___expr_276)) temp___279)))) 0)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 temp___expr_276)) temp___279)))) 2))))) (=> (not (= temp___skip_top_level_277 true)) (= (size temp___expr_276) 0))))
(define-fun type_invariant ((temp___282 us_rep1)) Bool (= (tree_structure temp___282) true))
(define-fun dynamic_invariant1 ((temp___expr_156 Int) (temp___is_init_153 Bool) (temp___skip_constant_154 Bool) (temp___do_toplevel_155 Bool)) Bool (=> (or (= temp___is_init_153 true) (<= 0 100)) (in_range1 temp___expr_156)))
(assert (forall ((f us_rep1)) (! (=> (dynamic_invariant f true true true) (dynamic_invariant1 (size f) true false true)) :pattern ((size f)))))
(define-fun dynamic_invariant2 ((temp___expr_150 Int) (temp___is_init_147 Bool) (temp___skip_constant_148 Bool) (temp___do_toplevel_149 Bool)) Bool (=> (or (= temp___is_init_147 true) (<= 1 100)) (in_range temp___expr_150)))
(declare-fun valid_root (us_rep1 Int) Bool)
(declare-fun valid_root__function_guard (Bool us_rep1 Int) Bool)
(assert (forall ((f us_rep1)) (forall ((i Int)) (! (=> (and (dynamic_invariant f true true true) (dynamic_invariant2 i true true true)) (=> (< (size f) i) (not (= (valid_root f i) true)))) :pattern ((valid_root f i))))))
...
(assert (forall ((a (Array Int natural)) (b (Array Int natural))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq3 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_134 Int)) (=> (and (<= a__first temp___idx_134) (<= temp___idx_134 a__last)) (= (to_rep2 (select a temp___idx_134)) (to_rep2 (select b (+ (- b__first a__first) temp___idx_134)))))))))))
...
(assert (forall ((a (Array Int natural)) (b (Array Int natural))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq3 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep2 (select a (+ i 1))) (to_rep2 (select b (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int natural)) (b (Array Int natural))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq3 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep2 (select b (+ i 1))) (to_rep2 (select a (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
...
(define-fun dynamic_invariant3 ((temp___expr_376 us_rep2) (temp___is_init_373 Bool) (temp___skip_constant_374 Bool) (temp___do_toplevel_375 Bool)) Bool (= (tree_structure (rec__search_trees__search_tree__struct (us_split_fields5 temp___expr_376))) true))
(define-fun default_initial_assumption1 ((temp___expr_380 us_rep2) (temp___skip_top_level_381 Bool)) Bool (and (and (and (= (to_rep (rec__search_trees__search_tree__root (us_split_fields5 temp___expr_380))) 0) (and (and (= (to_rep (rec__binary_trees__forest__s (us_split_fields3 (rec__search_trees__search_tree__struct (us_split_fields5 temp___expr_380))))) 0) (forall ((temp___384 Int)) (=> (and (<= 1 temp___384) (<= temp___384 100)) (and (and (and (= (to_rep (rec__binary_trees__cell__left (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 (rec__search_trees__search_tree__struct (us_split_fields5 temp___expr_380)))) temp___384)))) 0) (= (to_rep (rec__binary_trees__cell__right (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 (rec__search_trees__search_tree__struct (us_split_fields5 temp___expr_380)))) temp___384)))) 0)) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 (rec__search_trees__search_tree__struct (us_split_fields5 temp___expr_380)))) temp___384)))) 0)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 (rec__search_trees__search_tree__struct (us_split_fields5 temp___expr_380)))) temp___384)))) 2))))) (= (size (rec__search_trees__search_tree__struct (us_split_fields5 temp___expr_380))) 0))) (= (rec__search_trees__search_tree__values (us_split_fields5 temp___expr_380)) (temp___387 0))) (=> (not (= temp___skip_top_level_381 true)) (= (size1 temp___expr_380) 0))))
(define-fun type_invariant1 ((temp___392 us_rep2)) Bool (ite (= (size (rec__search_trees__search_tree__struct (us_split_fields5 temp___392))) 0) (= (to_rep (rec__search_trees__search_tree__root (us_split_fields5 temp___392))) 0) (and (and (not (= (to_rep (rec__search_trees__search_tree__root (us_split_fields5 temp___392))) 0)) (= (valid_root (rec__search_trees__search_tree__struct (us_split_fields5 temp___392)) (to_rep (rec__search_trees__search_tree__root (us_split_fields5 temp___392)))) true)) (= (ordered_leafs (rec__search_trees__search_tree__struct (us_split_fields5 temp___392)) (to_rep (rec__search_trees__search_tree__root (us_split_fields5 temp___392))) (rec__search_trees__search_tree__values (us_split_fields5 temp___392))) true))))
...
(define-fun bool_eq7 ((a (Array Int us_rep4)) (a__first Int) (a__last Int) (b (Array Int us_rep4)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_132 Int)) (=> (and (<= a__first temp___idx_132) (<= temp___idx_132 a__last)) (= (bool_eq6 (select a temp___idx_132) (select b (+ (- b__first a__first) temp___idx_132))) true)))) true false))
(assert (forall ((a (Array Int us_rep4)) (b (Array Int us_rep4))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq7 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_132 Int)) (=> (and (<= a__first temp___idx_132) (<= temp___idx_132 a__last)) (= (bool_eq6 (select a temp___idx_132) (select b (+ (- b__first a__first) temp___idx_132))) true))))))))
(declare-fun model__ (us_rep1 Int) (Array Int us_rep4))
(declare-fun model____function_guard ((Array Int us_rep4) us_rep1 Int) Bool)
(assert true)
(assert (forall ((f us_rep1)) (forall ((root Int)) (forall ((values (Array Int natural))) (! (= (= (ordered_leafs f root values) true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields7 (let ((temp___482 (model__ f root))) (select temp___482 i)))) true) (= (rec__tree_model__path_type__k (us_split_fields7 (let ((temp___483 (model__ f root))) (select temp___483 j)))) true)) (= (olt (rec__tree_model__path_type__a (us_split_fields7 (let ((temp___484 (model__ f root))) (select temp___484 i)))) (rec__tree_model__path_type__a (us_split_fields7 (let ((temp___485 (model__ f root))) (select temp___485 j))))) true)) (ite (= (get (rec__tree_model__path_type__a (us_split_fields7 (let ((temp___480 (model__ f root))) (select temp___480 j)))) (+ (length (rec__tree_model__path_type__a (us_split_fields7 (let ((temp___481 (model__ f root))) (select temp___481 i))))) 1)) 0) (< (to_rep2 (select values j)) (to_rep2 (select values i))) (< (to_rep2 (select values i)) (to_rep2 (select values j)))))))))) :pattern ((ordered_leafs f root values)))))))
...
(assert (forall ((t us_rep2)) (! (=> (and (dynamic_invariant3 t true true true) (type_invariant1 t)) (dynamic_invariant1 (size1 t) true false true)) :pattern ((size1 t)))))
(assert (forall ((t us_rep2)) (! (=> (dynamic_invariant3 t true true true) (= (size1 t) (size (rec__search_trees__search_tree__struct (us_split_fields5 t))))) :pattern ((size1 t)))))
(define-fun dynamic_invariant5 ((temp___expr_162 Int) (temp___is_init_159 Bool) (temp___skip_constant_160 Bool) (temp___do_toplevel_161 Bool)) Bool (=> (or (= temp___is_init_159 true) (<= 0 2)) (in_range2 temp___expr_162)))
...
(define-fun dynamic_invariant6 ((temp___expr_168 Int) (temp___is_init_165 Bool) (temp___skip_constant_166 Bool) (temp___do_toplevel_167 Bool)) Bool (=> (or (= temp___is_init_165 true) (<= 0 1)) (in_range5 temp___expr_168)))
(define-fun dynamic_invariant7 ((temp___expr_205 us_rep4) (temp___is_init_202 Bool) (temp___skip_constant_203 Bool) (temp___do_toplevel_204 Bool)) Bool (=> (= temp___do_toplevel_204 true) (=> (= temp___is_init_202 true) (< (length (rec__tree_model__path_type__a (us_split_fields7 temp___expr_205))) 100))))
(define-fun default_initial_assumption2 ((temp___expr_207 us_rep4) (temp___skip_top_level_208 Bool)) Bool (and (= (length (rec__tree_model__path_type__a (us_split_fields7 temp___expr_207))) 0) (= (rec__tree_model__path_type__k (us_split_fields7 temp___expr_207)) (of_int 0))))
(define-fun dynamic_predicate ((temp___211 us_rep4)) Bool (< (length (rec__tree_model__path_type__a (us_split_fields7 temp___211))) 100))
(define-fun dynamic_invariant8 ((temp___expr_216 (Array Int us_rep4)) (temp___is_init_213 Bool) (temp___skip_constant_214 Bool) (temp___do_toplevel_215 Bool)) Bool (forall ((temp___217 Int)) (=> (and (<= 1 temp___217) (<= temp___217 100)) (=> (= temp___is_init_213 true) (< (length (rec__tree_model__path_type__a (us_split_fields7 (select temp___expr_216 temp___217)))) 100)))))
(define-fun default_initial_assumption3 ((temp___expr_219 (Array Int us_rep4)) (temp___skip_top_level_220 Bool)) Bool (forall ((temp___221 Int)) (=> (and (<= 1 temp___221) (<= temp___221 100)) (and (= (length (rec__tree_model__path_type__a (us_split_fields7 (select temp___expr_219 temp___221)))) 0) (= (rec__tree_model__path_type__k (us_split_fields7 (select temp___expr_219 temp___221))) (of_int 0))))))
...
(define-fun default_initial_assumption4 ((temp___expr_199 us_rep3) (temp___skip_top_level_200 Bool)) Bool (=> (not (= temp___skip_top_level_200 true)) (= (length temp___expr_199) 0)))
...
(assert (forall ((f us_rep1)) (forall ((i Int)) (! (=> (and (dynamic_invariant f true true true) (dynamic_invariant2 i true true true)) (let ((result (parent f i))) (and (and (=> (= (valid_root f i) true) (= result 0)) (=> (= (size f) 0) (= result 0))) (dynamic_invariant1 result true false true)))) :pattern ((parent f i))))))
(declare-fun position (us_rep1 Int) Int)
(declare-fun position__function_guard (Int us_rep1 Int) Bool)
(assert (forall ((f us_rep1)) (forall ((i Int)) (! (=> (and (and (dynamic_invariant f true true true) (dynamic_invariant2 i true true true)) (not (= (parent f i) 0))) (dynamic_invariant6 (position f i) true false true)) :pattern ((position f i))))))
(assert (forall ((f us_rep1)) (forall ((root Int)) (! (=> (and (and (dynamic_invariant f true true true) (dynamic_invariant2 root true true true)) (= (valid_root f root) true)) (let ((result (model__ f root))) (and (and (= (rec__tree_model__path_type__k (us_split_fields7 (select result root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields7 (select result root)))) 0) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= i root)) (ite (and (not (= (parent f i) 0)) (= (rec__tree_model__path_type__k (us_split_fields7 (select result (parent f i)))) true)) (= (rec__tree_model__path_type__k (us_split_fields7 (select result i))) true) (not (= (rec__tree_model__path_type__k (us_split_fields7 (select result i))) true)))))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields7 (select result i))) true) (not (= i root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields7 (select result (parent f i)))) (position f i) (rec__tree_model__path_type__a (us_split_fields7 (select result i)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields7 (select result i)))) 0)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select result i))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields7 (select result j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields7 (select result i))) (rec__tree_model__path_type__a (us_split_fields7 (select result j)))) true)) (= j i))))))))))) (dynamic_invariant8 result true false true)))) :pattern ((model__ f root))))))
(define-fun default_initial_assumption5 ((temp___expr_259 us_rep) (temp___skip_top_level_260 Bool)) Bool (and (and (and (= (to_rep (rec__binary_trees__cell__left (us_split_fields1 temp___expr_259))) 0) (= (to_rep (rec__binary_trees__cell__right (us_split_fields1 temp___expr_259))) 0)) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields1 temp___expr_259))) 0)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields1 temp___expr_259))) 2)))
...
(assert (forall ((container us_rep3)) (! (let ((result (length container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant9 result true false true))) :pattern ((length container)))))
...
(assert (forall ((container us_rep3)) (forall ((position1 Int)) (! (=> (and (dynamic_invariant10 position1 true true true) (and (<= 1 position1) (<= position1 (last container)))) (dynamic_invariant11 (get container position1) true false true)) :pattern ((get container position1))))))
(declare-const temp___599 extended_index_type)
(declare-const temp___5991 extended_index_type)
(declare-const temp___5992 (Array Int us_rep))
(declare-const temp___5993 (Array Int natural))
(declare-const o Int)
(declare-const o1 Int)
(declare-const o2 Int)
(declare-const result Bool)
(declare-const result1 Bool)
(assert (= (tree_structure (mk___rep1 (mk___split_fields1 temp___5991 temp___5992))) true))
(assert (and (= o (size (mk___rep1 (mk___split_fields1 temp___5991 temp___5992)))) (in_range1 o)))
(assert (= result (ite (= o 0) true false)))
(assert (not (= result true)))
(assert (=> (not (= (to_rep temp___599) 0)) (and (= o2 (to_rep temp___599)) (in_range (to_rep temp___599)))))
(assert (=> (not (= (to_rep temp___599) 0)) (and (= result1 (valid_root (mk___rep1 (mk___split_fields1 temp___5991 temp___5992)) o2)) (=> (< (size (mk___rep1 (mk___split_fields1 temp___5991 temp___5992))) o2) (not (= result1 true))))))
(assert (=> (= (to_rep temp___599) 0) (= result1 false)))
(assert (= result1 true))
(assert (not (in_range (to_rep temp___599))))
(check-sat)
(exit)
