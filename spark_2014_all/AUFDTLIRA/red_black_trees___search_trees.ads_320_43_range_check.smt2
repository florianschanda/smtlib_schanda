...
(assert (=> (not (= (to_rep temp___643) 0)) (and (= o1 (to_rep temp___643)) (in_range2 (to_rep temp___643)))))
(assert (=> (not (= (to_rep temp___643) 0)) (and (= result1 (valid_root (mk___rep1 (mk___split_fields1 temp___6431 temp___6432)) o1)) (=> (< (size (mk___rep1 (mk___split_fields1 temp___6431 temp___6432))) o1) (not (= result1 true))))))
(assert (=> (not (not (= (to_rep temp___643) 0))) (= result1 false)))
(assert (= result1 true))
(assert (not (in_range2 (to_rep temp___643))))
(check-sat)
(exit)
