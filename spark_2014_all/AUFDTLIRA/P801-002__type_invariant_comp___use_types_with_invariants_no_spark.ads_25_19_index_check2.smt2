...
(assert (in_range1 i))
(assert (<= i (to_rep (rec__use_types_with_invariants_no_spark__container__c (us_split_discrs1 c)))))
(assert (not (<= (to_rep1 (first (rt (rec__use_types_with_invariants_no_spark__container__content (us_split_fields1 c))))) i)))
(check-sat)
(exit)
