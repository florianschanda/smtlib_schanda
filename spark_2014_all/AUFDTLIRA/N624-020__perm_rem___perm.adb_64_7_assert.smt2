...
(assert (=> (and (<= (to_rep2 (first (rt a))) ia1) (<= ia1 (to_rep2 (last (rt a))))) (and (and (= temp___586 ia1) (and (and (= (= result4 true) (exists ((ib2 Int)) (and (and (<= (to_rep2 (first (rt b))) ib2) (<= ib2 (to_rep2 (last (rt b))))) (and (= (to_rep (select (elts a) ia1)) (to_rep (select (elts b) ib2))) (= (is_perm (remove a ia1) (remove b ib2)) true))))) (and (not (= result4 true)) (and (= perm__get_witnesses__result4 (mk___rep (mk___split_fields perm__get_witnesses__result perm__get_witnesses__result1))) (= perm__get_witnesses__result4 (mk___rep (mk___split_fields perm__get_witnesses__result2 perm__get_witnesses__result3)))))) (and (forall ((ka1 Int)) (=> (and (<= 1 ka1) (<= ka1 ia2)) (forall ((kb1 Int)) (=> (and (<= (to_rep2 (first (rt b))) kb1) (<= kb1 (to_rep2 (last (rt b))))) (not (and (= (to_rep (select (elts a) ka1)) (to_rep (select (elts b) kb1))) (= (is_perm (remove a ka1) (remove b kb1)) true))))))) (and (and (=> (<= (to_rep2 (first (rt a))) (to_rep2 (last (rt a)))) (dynamic_property1 (to_rep2 (first (rt a))) (to_rep2 (last (rt a))) ia2)) (and (<= (to_rep2 (first (rt a))) ia2) (<= ia2 (to_rep2 (last (rt a)))))) (= ia2 (to_rep2 (last (rt a)))))))) (and (and (= perm__get_witnesses__result11 (mk_witnesses__ref perm__get_witnesses__result5)) (= ia8 (mk_int__ref ia2))) (and (= perm__get_witnesses__result12 perm__get_witnesses__result5) (= ia9 ia2))))))
(assert (=> (and (<= (to_rep2 (first (rt a))) ia1) (<= ia1 (to_rep2 (last (rt a))))) (= perm__get_witnesses__result13 perm__get_witnesses__result11)))
(assert (=> (and (<= (to_rep2 (first (rt a))) ia1) (<= ia1 (to_rep2 (last (rt a))))) (= ia10 ia8)))
(assert (=> (and (<= (to_rep2 (first (rt a))) ia1) (<= ia1 (to_rep2 (last (rt a))))) (= perm__get_witnesses__result14 perm__get_witnesses__result12)))
(assert (=> (and (<= (to_rep2 (first (rt a))) ia1) (<= ia1 (to_rep2 (last (rt a))))) (= ia11 ia9)))
(assert (=> (not (and (<= (to_rep2 (first (rt a))) ia1) (<= ia1 (to_rep2 (last (rt a)))))) (= perm__get_witnesses__result13 (mk_witnesses__ref (mk___rep (mk___split_fields perm__get_witnesses__result perm__get_witnesses__result1))))))
(assert (=> (not (and (<= (to_rep2 (first (rt a))) ia1) (<= ia1 (to_rep2 (last (rt a)))))) (= ia10 (mk_int__ref ia1))))
(assert (=> (not (and (<= (to_rep2 (first (rt a))) ia1) (<= ia1 (to_rep2 (last (rt a)))))) (= perm__get_witnesses__result14 (mk___rep (mk___split_fields perm__get_witnesses__result2 perm__get_witnesses__result3)))))
(assert (=> (not (and (<= (to_rep2 (first (rt a))) ia1) (<= ia1 (to_rep2 (last (rt a)))))) (= ia11 ia1)))
(assert (not false))
(check-sat)
(exit)
