...
(define-fun perm__get_witnesses__result10 () us_rep (mk___rep (mk___split_fields perm__get_witnesses__result2 perm__get_witnesses__result3)))
...
(assert (not (not (and (and (= (mk_int__ref result) (mk_int__ref ia)) (= ia1 (to_rep2 (first (rt a))))) (ite (and (<= (to_rep2 (first (rt a))) ia1) (<= ia1 (to_rep2 (last (rt a))))) (and (and (and (= temp___650 ia1) (and (and (= (= result1 true) (exists ((ib Int)) (and (and (<= (to_rep2 (first (rt b))) ib) (<= ib (to_rep2 (last (rt b))))) (and (= (to_rep (select (elts a) ia1)) (to_rep (select (elts b) ib))) (= (is_perm (remove a ia1) (remove b ib)) true))))) (and (not (= result1 true)) (and (= perm__get_witnesses__result4 (mk___rep (mk___split_fields perm__get_witnesses__result perm__get_witnesses__result1))) (= perm__get_witnesses__result4 perm__get_witnesses__result10)))) (and (forall ((ka Int)) (=> (and (<= 1 ka) (<= ka ia2)) (forall ((kb Int)) (=> (and (<= (to_rep2 (first (rt b))) kb) (<= kb (to_rep2 (last (rt b))))) (not (and (= (to_rep (select (elts a) ka)) (to_rep (select (elts b) kb))) (= (is_perm (remove a ka) (remove b kb)) true))))))) (and (and (=> (<= (to_rep2 (first (rt a))) (to_rep2 (last (rt a)))) (dynamic_property1 (to_rep2 (first (rt a))) (to_rep2 (last (rt a))) ia2)) (and (<= (to_rep2 (first (rt a))) ia2) (<= ia2 (to_rep2 (last (rt a)))))) (= ia2 (to_rep2 (last (rt a)))))))) (and (and (= perm__get_witnesses__result6 (mk_witnesses__ref perm__get_witnesses__result5)) (= ia3 (mk_int__ref ia2))) (and (= perm__get_witnesses__result7 perm__get_witnesses__result5) (= ia4 ia2)))) (and (and (= perm__get_witnesses__result8 perm__get_witnesses__result6) (= ia5 ia3)) (and (= perm__get_witnesses__result9 perm__get_witnesses__result7) (= ia6 ia4)))) (and (and (= perm__get_witnesses__result8 (mk_witnesses__ref (mk___rep (mk___split_fields perm__get_witnesses__result perm__get_witnesses__result1)))) (= ia5 (mk_int__ref ia1))) (and (= perm__get_witnesses__result9 perm__get_witnesses__result10) (= ia6 ia1))))))))
(check-sat)
(exit)
