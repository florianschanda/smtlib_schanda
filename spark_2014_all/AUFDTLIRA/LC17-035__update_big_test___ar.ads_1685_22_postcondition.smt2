...
(declare-fun temp___3666 ((Array Int us_rep) Int us_rep Int us_rep) (Array Int us_rep))
(assert (forall ((temp___3668 (Array Int us_rep))) (forall ((temp___3669 Int) (temp___3671 Int)) (forall ((temp___3670 us_rep) (temp___3672 us_rep)) (let ((temp___3667 (temp___3666 temp___3668 temp___3669 temp___3670 temp___3671 temp___3672))) (forall ((temp___3673 Int)) (ite (= temp___3673 temp___3671) (= (select temp___3667 temp___3673) temp___3672) (ite (= temp___3673 temp___3669) (= (select temp___3667 temp___3673) temp___3670) (= (select temp___3667 temp___3673) (select temp___3668 temp___3673))))))))))
(declare-fun temp___3675 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___3677 (Array Int et1))) (forall ((temp___3678 Int) (temp___3679 Int)) (let ((temp___3676 (temp___3675 temp___3677 temp___3678 temp___3679))) (forall ((temp___3680 Int)) (ite (= temp___3680 temp___3678) (= (select temp___3676 temp___3680) (of_rep temp___3679)) (= (select temp___3676 temp___3680) (select temp___3677 temp___3680))))))))
...
(assert (= a2 a3))
(assert (= a4 a2))
(assert (not (= (bool_eq2 a3 1 16 (temp___3666 a x r i (mk___rep (mk___split_fields (temp___3675 (rec__ar__rofa1__s1 (us_split_fields1 (select a i))) j e) (rec__ar__rofa1__t1 (us_split_fields1 (select a i)))))) 1 16) true)))
(check-sat)
(exit)
