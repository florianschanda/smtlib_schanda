...
(assert (= i1 1))
(assert (in_range2 i1))
(assert (=> (and (not (= (to_rep (select a i1)) x)) (< i1 10)) (and (and (= temp___149 i1) (and (and (< i2 10) (forall ((m1 Int)) (=> (and (<= 1 m1) (<= m1 i2)) (not (= (to_rep (select a m1)) x))))) (and (and (=> (<= 1 10) (in_range2 i2)) (and (not (= (to_rep (select a i2)) x)) (< i2 10))) (and (and (and (= o (+ i2 1)) (in_range2 (+ i2 1))) (and (= i2 result1) (= i3 o))) (not (and (not (= (to_rep (select a i3)) x)) (< i3 10))))))) (and (= i3 i6) (= i7 i3)))))
(assert (=> (and (not (= (to_rep (select a i1)) x)) (< i1 10)) (= (mk_int__ref i8) (mk_int__ref i6))))
(assert (=> (and (not (= (to_rep (select a i1)) x)) (< i1 10)) (= i9 i7)))
(assert (=> (not (and (not (= (to_rep (select a i1)) x)) (< i1 10))) (= i1 i8)))
(assert (=> (not (and (not (= (to_rep (select a i1)) x)) (< i1 10))) (= i9 i1)))
...
(assert (= assert_loop_14__value_present__result1 (ite (= (to_rep (select a i8)) x) true false)))
...
(assert (not (exists ((m1 Int)) (and (and (<= 1 m1) (<= m1 10)) (= (to_rep (select a m1)) x)))))
(check-sat)
(exit)
