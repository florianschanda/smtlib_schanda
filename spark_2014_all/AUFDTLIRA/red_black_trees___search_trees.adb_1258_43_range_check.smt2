...
(assert (= result4 true))
(assert (and (= o (size (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)))) (in_range4 o)))
(assert (= o1 (+ o 1)))
(assert (and (= o2 (size (rec__search_trees__search_tree__struct (us_split_fields7 t)))) (in_range4 o2)))
