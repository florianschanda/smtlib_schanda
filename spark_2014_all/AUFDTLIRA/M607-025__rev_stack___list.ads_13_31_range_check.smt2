...
(assert (and (= o14 (get (model__ (list__content list__reverse_list__result5)) o13)) (and (in_range8 o14) (= o14 (get (model__ (list__content list__reverse_list__result5)) o13)))))
(assert (not (in_range5 i2)))
(check-sat)
(exit)
