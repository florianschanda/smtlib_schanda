...
(assert (and (= o66 (length (rec__tree_model__path_type__a (us_split_fields1 (select (map__content binary_trees__model__result4) root))))) (and (in_range5 o66) (<= (+ 0 o66) 2147483647))))
