...
(assert (= o9 (- o8 1)))
(assert (= result11 (mk_int__ref left1)))
(assert (= left2 o9))
(assert (= result12 (mk_bool__ref left_is_out)))
(assert (= left_is_out2 (ite (< left2 0) true false)))
(assert (=> (= left_is_out2 true) (= result13 true)))
(assert (=> (not (= left_is_out2 true)) (and (<= 0 left2) (<= left2 100000))))
(assert (=> (not (= left_is_out2 true)) (= o10 left2)))
(assert (=> (not (= left_is_out2 true)) (= result13 (select number_list o10))))
(assert (not (= result13 true)))
(assert (and (<= 0 left3) (<= left3 (- value 1))))
(assert (forall ((v6 Int)) (=> (and (<= left3 v6) (<= v6 value)) (not (= (select number_list v6) true)))))
(assert (=> (<= (- 2147483648) 2147483647) (in_range1 left3)))
(assert (not (not (= left3 (- 2147483648)))))
(check-sat)
(exit)
