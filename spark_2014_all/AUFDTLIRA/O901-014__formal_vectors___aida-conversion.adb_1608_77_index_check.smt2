...
(assert (and (= o40 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (= o41 (ite (<= o40 j) true false)))
(assert (= result6 (ite (= o41 true) (ite (<= j index3) true false) false)))
(assert (= result6 true))
(assert (and (<= (to_rep1 int_array__first) j) (<= j (to_rep1 int_array__last))))
(assert (= o42 j))
(assert (= o43 (select int_array1 o42)))
(assert (= o44 (to_rep1 o43)))
(assert (not (<= (to_rep1 n__first) j)))
(check-sat)
(exit)
