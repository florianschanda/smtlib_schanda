...
(declare-const temp___568 positive_less_than_max)
(declare-const temp___5681 (Array Int element))
(declare-const temp___5682 less_than_max)
(declare-const temp___5683 us_private)
(declare-const temp___5684 Int)
...
(assert (= temp___568 o2))
(assert (= temp___5681 o3))
(assert (= temp___5682 o4))
(assert (= temp___5683 o5))
(assert (= s__attr__tag temp___5684))
...
(assert (= temp___568 s__split_fields4))
(assert (= temp___5681 s__split_fields5))
(assert (= temp___5682 s__split_fields6))
(assert (= temp___5683 s__split_fields7))
(assert (not (= (to_rep3 s__split_fields4) 1)))
(assert (not (in_range4 (- (to_rep3 s__split_fields4) 1))))
(check-sat)
(exit)
