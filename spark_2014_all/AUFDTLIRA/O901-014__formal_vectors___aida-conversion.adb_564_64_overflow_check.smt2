...
(assert (and (= temp___1594 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1594) (<= temp___1594 (to_rep1 (last (rt source))))))
(assert (= o4 temp___1594))
(assert (= o5 (select (elts source) o4)))
(assert (= o6 (to_rep o5)))
(assert (= o7 (ite (< o6 52) true false)))
(assert (and (= temp___1593 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1593) (<= temp___1593 (to_rep1 (last (rt source))))))
(assert (= o temp___1593))
