...
(assert (<= 1 i3))
(assert (<= i3 100))
(assert (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields5) (to_rep1 (rec__search_trees__search_tree__root t__split_fields5))) i3))) true))
(assert (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields5) (to_rep1 (rec__search_trees__search_tree__root t__split_fields5))) i3))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields5) (to_rep1 (rec__search_trees__search_tree__root t__split_fields5))) current1)))) true))
(assert (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields5) (to_rep1 (rec__search_trees__search_tree__root t__split_fields5))) current1))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields5) (to_rep1 (rec__search_trees__search_tree__root t__split_fields5))) i3)))) 1)) 0))
