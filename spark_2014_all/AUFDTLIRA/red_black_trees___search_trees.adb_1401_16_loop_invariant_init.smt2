...
(assert (<= 1 i20))
(assert (<= i20 100))
(assert (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields7) (to_rep1 (rec__search_trees__search_tree__root t__split_fields7))) i20))) true))
(assert (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields7) (to_rep1 (rec__search_trees__search_tree__root t__split_fields7))) i20))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields7) (to_rep1 (rec__search_trees__search_tree__root t__split_fields7))) current2)))) true))
(assert (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields7) (to_rep1 (rec__search_trees__search_tree__root t__split_fields7))) current2))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields7) (to_rep1 (rec__search_trees__search_tree__root t__split_fields7))) i20)))) 1)) 0))
(assert (not (< v (to_rep (select (rec__search_trees__search_tree__values t__split_fields7) i20)))))
(check-sat)
(exit)
