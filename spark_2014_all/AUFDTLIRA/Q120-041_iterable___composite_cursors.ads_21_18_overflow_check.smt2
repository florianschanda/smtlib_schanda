...
(assert true)
(assert (forall ((c1 us_rep)) (forall ((p1 (Array Int natural))) (! (= (= (has_element c1 p1) true) (and (<= 1 (to_rep (select p1 1))) (<= (to_rep (select p1 1)) (to_rep (rec__composite_cursors__cont1__length (us_split_fields1 c1)))))) :pattern ((has_element c1 p1))))))
