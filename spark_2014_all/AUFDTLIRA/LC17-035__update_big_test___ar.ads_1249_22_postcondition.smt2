...
(declare-fun temp___2835 ((Array Int us_rep) Int us_rep Int us_rep) (Array Int us_rep))
(assert (forall ((temp___2837 (Array Int us_rep))) (forall ((temp___2838 Int) (temp___2840 Int)) (forall ((temp___2839 us_rep) (temp___2841 us_rep)) (let ((temp___2836 (temp___2835 temp___2837 temp___2838 temp___2839 temp___2840 temp___2841))) (forall ((temp___2842 Int)) (ite (= temp___2842 temp___2840) (= (select temp___2836 temp___2842) temp___2841) (ite (= temp___2842 temp___2838) (= (select temp___2836 temp___2842) temp___2839) (= (select temp___2836 temp___2842) (select temp___2837 temp___2842))))))))))
...
(assert (= temp3 temp1))
(assert (= a4 a2))
(assert (not (= (bool_eq1 a3 1 10 (temp___2835 a i (mk___rep (mk___split_fields (rec__ar__rec1t__f1 (us_split_fields1 (select a i))) (rec__ar__rec1t__g1 (us_split_fields1 (select a j))))) j (mk___rep (mk___split_fields (rec__ar__rec1t__f1 (us_split_fields1 (select a j))) (rec__ar__rec1t__g1 (us_split_fields1 (select a i)))))) 1 10) true)))
(check-sat)
(exit)
