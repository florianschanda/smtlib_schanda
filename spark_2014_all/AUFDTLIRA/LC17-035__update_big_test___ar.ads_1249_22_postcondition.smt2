...
(declare-fun to_rep (et2) Int)
(declare-fun of_rep (Int) et2)
(assert (forall ((x et2)) (! (= (of_rep (to_rep x)) x) :pattern ((to_rep x)))))
(assert (forall ((x et2)) (! (in_range2 (to_rep x)) :pattern ((to_rep x)))))
...
(assert (forall ((x et1)) (! (in_range3 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep1 (rec__ar__rec1t__f1 (us_split_fields1 a))) (to_rep1 (rec__ar__rec1t__f1 (us_split_fields1 b)))) (= (to_rep (rec__ar__rec1t__g1 (us_split_fields1 a))) (to_rep (rec__ar__rec1t__g1 (us_split_fields1 b))))) true false))
...
(declare-fun temp___2894 ((Array Int us_rep) Int us_rep Int us_rep) (Array Int us_rep))
...
(assert (forall ((temp___2896 (Array Int us_rep))) (forall ((temp___2897 Int) (temp___2899 Int)) (forall ((temp___2898 us_rep) (temp___2900 us_rep)) (let ((temp___2895 (temp___2894 temp___2896 temp___2897 temp___2898 temp___2899 temp___2900))) (=> (and (dynamic_invariant temp___2897 true true true true) (dynamic_invariant temp___2899 true true true true)) (forall ((temp___2901 Int)) (ite (= temp___2901 temp___2899) (= (select temp___2895 temp___2901) temp___2900) (ite (= temp___2901 temp___2897) (= (select temp___2895 temp___2901) temp___2898) (= (select temp___2895 temp___2901) (select temp___2896 temp___2901)))))))))))
...
(assert (in_range1 i))
(assert (in_range1 j))
(assert (=> (<= 1 25) (in_range2 temp)))
(assert (= result temp))
(assert (= temp1 (to_rep (rec__ar__rec1t__g1 (us_split_fields1 (select a i))))))
(assert (= (to_rep o) (to_rep (rec__ar__rec1t__g1 (us_split_fields1 (select a j))))))
...
(assert (= temp3 temp1))
(assert (= a4 a2))
(assert (not (= (bool_eq1 a3 1 10 (temp___2894 a i (mk___rep (mk___split_fields (rec__ar__rec1t__f1 (us_split_fields1 (select a i))) (rec__ar__rec1t__g1 (us_split_fields1 (select a j))))) j (mk___rep (mk___split_fields (rec__ar__rec1t__f1 (us_split_fields1 (select a j))) (rec__ar__rec1t__g1 (us_split_fields1 (select a i)))))) 1 10) true)))
(check-sat)
(exit)
