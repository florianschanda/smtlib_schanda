...
(assert (and (and (and (and (= o (length a)) (in_range (length a))) (and (= us o) (in_range1 o))) (and (= (to_rep2 (rec__communications__communication__num coms__split_discrs)) (length a)) (and (dynamic_invariant3 (mk___rep2 coms__split_discrs (mk___split_fields2 (mk___t2 coms__split_fields coms__split_fields1))) false false true) (and (and (and (and (and (and (= (ite (<= (to_rep1 (first (rt a))) (to_rep1 (last (rt a)))) (+ (- (to_rep1 (last (rt a))) (to_rep1 (first (rt a)))) 1) 0) (ite (<= 1 (length a)) (+ (- (length a) 1) 1) 0)) (and (= (slide1 (elts a) (to_rep1 (first (rt a))) 1) temp___313) (= (mk2 1 (length a)) temp___3131))) (and (= (ite (<= (to_rep1 (first4 temp___3131)) (to_rep1 (last4 temp___3131))) (+ (- (to_rep1 (last4 temp___3131)) (to_rep1 (first4 temp___3131))) 1) 0) (ite (<= (to_rep1 (first4 coms__split_fields1)) (to_rep1 (last4 coms__split_fields1))) (+ (- (to_rep1 (last4 coms__split_fields1)) (to_rep1 (first4 coms__split_fields1))) 1) 0)) (= (mk___t2 o1 o2) (mk___t2 temp___313 temp___3131)))) (and (= o3 o1) (= o4 o2))) (and (= coms__split_discrs (mk___split_discrs temp___316)) (and (= temp___3161 o3) (= temp___3162 o4)))) (and (and (and (= result coms__split_fields) (= result1 coms__split_fields1)) (and (= temp___3161 coms__split_fields2) (= temp___3162 coms__split_fields3))) (= coms__split_discrs (mk___split_discrs temp___316)))) (and (and (= communications__create__result4 (mk_communication__ref communications__create__result3)) (= communications__create__result5 communications__create__result3)) (and (= result2 (mk_communication__ref (mk___rep1 (mk___split_discrs communications__create__result) (mk___split_fields1 (mk___t1 communications__create__result1 communications__create__result2))))) (= communications__create__result3 (to_base (mk___rep2 coms__split_discrs (mk___split_fields2 (mk___t2 coms__split_fields2 coms__split_fields3))))))))))) (and (and (= communications__create__result6 communications__create__result4) (= coms__split_fields4 (mk___split_fields__ref2 (mk___split_fields2 (mk___t2 coms__split_fields2 coms__split_fields3))))) (and (= communications__create__result7 communications__create__result5) (= coms__split_fields5 (mk___split_fields2 (mk___t2 coms__split_fields2 coms__split_fields3)))))))
(assert (not (type_invariant (communication__content communications__create__result6))))
(check-sat)
(exit)
