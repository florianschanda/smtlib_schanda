...
(assert (= (ite (<= (to_rep1 (first4 temp___3131)) (to_rep1 (last4 temp___3131))) (+ (- (to_rep1 (last4 temp___3131)) (to_rep1 (first4 temp___3131))) 1) 0) (ite (<= (to_rep1 (first4 coms__split_fields1)) (to_rep1 (last4 coms__split_fields1))) (+ (- (to_rep1 (last4 coms__split_fields1)) (to_rep1 (first4 coms__split_fields1))) 1) 0)))
