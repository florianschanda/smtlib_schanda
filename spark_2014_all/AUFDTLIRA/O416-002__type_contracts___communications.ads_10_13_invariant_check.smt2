...
(declare-const communications__create__result2 t)
(declare-const o Int)
...
(declare-const o4 t2)
(declare-const temp___345 positive)
(declare-const temp___3451 (Array Int us_rep))
(declare-const temp___3452 t2)
...
(define-fun coms__split_fields6 () us_split_fields4 (mk___split_fields2 (mk___t2 coms__split_fields2 coms__split_fields3)))
...
(assert (= (ite (<= (to_rep1 (first4 temp___3421)) (to_rep1 (last4 temp___3421))) (+ (- (to_rep1 (last4 temp___3421)) (to_rep1 (first4 temp___3421))) 1) 0) (ite (<= (to_rep1 (first4 coms__split_fields1)) (to_rep1 (last4 coms__split_fields1))) (+ (- (to_rep1 (last4 coms__split_fields1)) (to_rep1 (first4 coms__split_fields1))) 1) 0)))
(assert (= (mk___t2 o1 o2) (mk___t2 temp___342 temp___3421)))
(assert (= o3 o1))
(assert (= o4 o2))
(assert (= coms__split_discrs (mk___split_discrs temp___345)))
(assert (= temp___3451 o3))
(assert (= temp___3452 o4))
(assert (= result coms__split_fields))
(assert (= result1 coms__split_fields1))
(assert (= temp___3451 coms__split_fields2))
(assert (= temp___3452 coms__split_fields3))
(assert (= coms__split_discrs (mk___split_discrs temp___345)))
(assert (= communications__create__result4 (mk_communication__ref communications__create__result3)))
(assert (= communications__create__result5 communications__create__result3))
(assert (= result2 (mk_communication__ref (mk___rep1 (mk___split_discrs communications__create__result) (mk___split_fields1 (mk___t communications__create__result1 communications__create__result2))))))
(assert (= communications__create__result3 (to_base (mk___rep2 coms__split_discrs coms__split_fields6))))
(assert (= communications__create__result6 communications__create__result4))
(assert (= coms__split_fields4 (mk___split_fields__ref2 coms__split_fields6)))
(assert (= communications__create__result7 communications__create__result5))
