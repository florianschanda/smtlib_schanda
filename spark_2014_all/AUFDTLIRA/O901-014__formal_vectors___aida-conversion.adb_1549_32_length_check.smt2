...
(assert (not (= (ite (<= (to_rep1 (first8 temp___19521)) (to_rep1 (last8 temp___19521))) (+ (- (to_rep1 (last8 temp___19521)) (to_rep1 (first8 temp___19521))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 6) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 6)) 1) 0))))
(check-sat)
(exit)
