...
(define-fun dynamic_invariant ((temp___expr_178 Int) (temp___is_init_174 Bool) (temp___skip_constant_175 Bool) (temp___do_toplevel_176 Bool) (temp___do_typ_inv_177 Bool)) Bool (=> (or (= temp___is_init_174 true) (<= 0 100)) (in_range1 temp___expr_178)))
(assert true)
...
(assert (not (= (is_empty the_ptr) true)))
(assert (not (<= 1 the_ptr)))
(check-sat)
(exit)
