...
(declare-fun temp___580 ((Array Int unsigned_byte)) (Array Int (Array Int unsigned_byte)))
(declare-fun temp___584 (Int) (Array Int unsigned_byte))
...
(assert (forall ((temp___582 (Array Int unsigned_byte))) (forall ((temp___583 Int)) (= (select (temp___580 temp___582) temp___583) temp___582))))
(assert (forall ((temp___586 Int)) (=> (dynamic_invariant temp___586 true true true true) (forall ((temp___587 Int)) (= (to_rep (select (temp___584 temp___586) temp___587)) temp___586)))))
...
(assert (= result x))
(assert (= x1 (temp___580 (temp___584 12))))
