...
(assert (forall ((temp___582 (Array Int unsigned_byte))) (forall ((temp___583 Int)) (= (select (temp_____aggregate_def_580 temp___582) temp___583) temp___582))))
(declare-const rliteral unsigned_byte)
(assert (= (unsigned_byteqtint rliteral) 12))
(assert (forall ((temp___586 Int)) (=> (dynamic_invariant temp___586 true true true true) (forall ((temp___587 Int)) (= (select (temp_____aggregate_def_584 temp___586) temp___587) rliteral)))))
...
(assert (= result x))
(assert (= x1 (temp_____aggregate_def_580 (temp_____aggregate_def_584 12))))
