...
(assert (and (= o121 (length (rec__list_allocator__m__t__allocated model____split_fields4))) (in_range6 o121)))
(assert (= o122 (ite (<= j8 o121) true false)))
(assert (= result32 (ite (<= 1 j8) o122 false)))
