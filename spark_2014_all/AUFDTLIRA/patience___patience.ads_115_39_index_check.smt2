...
(assert (= o27 (ite (<= o26 (- (to_rep1 (rec__patience__state__numelts (us_split_fields1 s))) 1)) true false)))
(assert (and (<= 0 i) (<= i 99)))
(assert (= o21 i))
...
(assert (=> (= result6 true) (= o20 (to_rep1 o19))))
...
(assert (=> (= result9 true) (= o9 (to_rep1 o8))))
