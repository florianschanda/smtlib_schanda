...
(assert (and (<= 0 i) (<= i 99)))
(assert (= o24 i))
(assert (= o25 (select (rec__patience__state__preds (us_split_fields1 s)) o24)))
(assert (= o26 (to_rep o25)))
(assert (= o27 (ite (<= o26 (- (to_rep (rec__patience__state__numelts (us_split_fields1 s))) 1)) true false)))
(assert (and (<= 0 i) (<= i 99)))
(assert (= o21 i))
(assert (= o22 (select (rec__patience__state__preds (us_split_fields1 s)) o21)))
(assert (= o23 (to_rep o22)))
(assert (= o28 (ite (<= (- 1) o23) true false)))
(assert (= result6 (ite (= o28 true) o27 false)))
(assert (=> (= result6 true) (and (<= 0 i) (<= i 99))))
(assert (=> (= result6 true) (= o18 i)))
(assert (=> (= result6 true) (= o19 (select (rec__patience__state__preds (us_split_fields1 s)) o18))))
(assert (=> (= result6 true) (= o20 (to_rep o19))))
(assert (=> (= result6 true) (= result5 (ite (< o20 i) true false))))
...
(assert (and (<= 0 i) (<= i 99)))
(assert (= o10 i))
(assert (= o11 (select (rec__patience__state__preds (us_split_fields1 s)) o10)))
(assert (= temp___537 (to_rep o11)))
(assert (and (<= 0 temp___537) (<= temp___537 99)))
(assert (= o12 temp___537))
(assert (= o13 (select (rec__patience__state__values (us_split_fields1 s)) o12)))
(assert (= o17 (to_rep1 o13)))
(assert (= result9 (ite (< o17 o16) true false)))
(assert (=> (= result9 true) (and (<= 0 i) (<= i 99))))
(assert (=> (= result9 true) (= o7 i)))
(assert (=> (= result9 true) (= o8 (select (rec__patience__state__posstack (us_split_fields1 s)) o7))))
(assert (=> (= result9 true) (= o9 (to_rep o8))))
(assert (=> (= result9 true) (= result8 (ite (< 0 o9) true false))))
