...
(assert (not (or (or (= (+ x (int__content lcp__result4)) (+ (to_rep (last (rt a))) 1)) (= (+ y (int__content lcp__result4)) (+ (to_rep (last (rt a))) 1))) (not (= (to_rep (select (elts a) (+ x (int__content lcp__result4)))) (to_rep (select (elts a) (+ y (int__content lcp__result4)))))))))
(check-sat)
(exit)
