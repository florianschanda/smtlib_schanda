...
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (prev i2))) (=> (< threshold (to_rep (select b j1))) (exists ((k Int)) (and (and (<= 1 k) (<= k cur2)) (= (to_rep (select a k)) (to_rep (select b j1)))))))))
(assert (and (and (=> (<= 1 10) (in_range2 i2)) (=> (<= (- 2147483648) 2147483647) (in_range1 cur2))) (and (<= 1 i2) (<= i2 10))))
(assert (and (= o (prev i2)) (and (in_range1 o) (= o (- i2 1)))))
(assert (= o1 (ite (<= j o) true false)))
(assert (= result2 (ite (<= 1 j) o1 false)))
(assert (= result2 true))
(assert (and (<= 1 j) (<= j 10)))
(assert (= o2 j))
(assert (= o3 (select b o2)))
(assert (= o4 (to_rep o3)))
(assert (= result3 (ite (< threshold o4) true false)))
(assert (= result3 true))
(assert (<= 1 cur2))
(assert (not (<= 1 1)))
(check-sat)
