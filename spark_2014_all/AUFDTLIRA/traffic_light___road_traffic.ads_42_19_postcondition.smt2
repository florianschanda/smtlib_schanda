...
(define-fun bool_eq ((a (Array Int light)) (a__first Int) (a__last Int) (b (Array Int light)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (to_rep (select a temp___idx_154)) (to_rep (select b (+ (- b__first a__first) temp___idx_154))))))) true false))
...
(assert (forall ((temp___233 (Array Int light))) (forall ((temp___234 Int) (temp___235 Int)) (let ((temp___232 (temp___231 temp___233 temp___234 temp___235))) (=> (and (dynamic_invariant temp___234 true true true true) (dynamic_invariant1 temp___235 true true true true)) (forall ((temp___236 Int)) (ite (= temp___236 temp___234) (= (to_rep (select temp___232 temp___236)) temp___235) (= (select temp___232 temp___236) (select temp___233 temp___236)))))))))
