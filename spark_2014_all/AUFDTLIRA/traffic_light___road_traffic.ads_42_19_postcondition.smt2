...
(assert (forall ((x light)) (! (= (of_rep (to_rep x)) x) :pattern ((to_rep x)))))
(assert (forall ((x light)) (! (in_range2 (to_rep x)) :pattern ((to_rep x)))))
...
(define-fun bool_eq ((a (Array Int light)) (a__first Int) (a__last Int) (b (Array Int light)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_132 Int)) (=> (and (<= a__first temp___idx_132) (<= temp___idx_132 a__last)) (= (to_rep (select a temp___idx_132)) (to_rep (select b (+ (- b__first a__first) temp___idx_132))))))) true false))
...
(assert (forall ((a (Array Int light)) (b (Array Int light))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep (select a (+ i 1))) (to_rep (select b (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int light)) (b (Array Int light))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep (select b (+ i 1))) (to_rep (select a (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(declare-fun to_rep1 (path) Int)
(declare-fun of_rep1 (Int) path)
(assert (forall ((x path)) (! (= (of_rep1 (to_rep1 x)) x) :pattern ((to_rep1 x)))))
(assert (forall ((x path)) (! (in_range1 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun bool_eq1 ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep1 (rec__road_traffic__conflict__left (us_split_fields1 a))) (to_rep1 (rec__road_traffic__conflict__left (us_split_fields1 b)))) (= (to_rep1 (rec__road_traffic__conflict__right (us_split_fields1 a))) (to_rep1 (rec__road_traffic__conflict__right (us_split_fields1 b))))) true false))
...
(assert true)
(assert (forall ((l (Array Int light))) (forall ((road_traffic__conflicts (Array Int us_rep))) (! (= (= (safety_property l road_traffic__conflicts) true) (forall ((temp___188 Int)) (=> (and (<= 1 temp___188) (<= temp___188 8)) (let ((c (select road_traffic__conflicts temp___188))) (or (= (to_rep (select l (to_rep1 (rec__road_traffic__conflict__left (us_split_fields1 c))))) 0) (= (to_rep (select l (to_rep1 (rec__road_traffic__conflict__right (us_split_fields1 c))))) 0)))))) :pattern ((safety_property l road_traffic__conflicts))))))
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const p Int)
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(declare-fun temp___203 ((Array Int light) Int Int) (Array Int light))
(assert (forall ((temp___205 (Array Int light))) (forall ((temp___206 Int) (temp___207 Int)) (let ((temp___204 (temp___203 temp___205 temp___206 temp___207))) (forall ((temp___208 Int)) (ite (= temp___208 temp___206) (= (select temp___204 temp___208) (of_rep temp___207)) (= (select temp___204 temp___208) (select temp___205 temp___208))))))))
...
(assert (in_range1 p))
(assert (and (= (safety_property l conflicts) true) (= (to_rep (select l p)) 2)))
(assert (= (to_rep o) 1))
