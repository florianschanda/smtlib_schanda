...
(assert (= data2 data1))
(assert (= res2 res1))
(assert (and (= (bool_eq data3 1 10000 data 1 10000) true) (forall ((rr1 Int)) (=> (and (<= 1 rr1) (<= rr1 r2)) (= (to_rep (select data3 rr1)) 1)))))
(assert (and (and (and (=> (<= 1 10000) (in_range2 r2)) (=> (<= 0 10000) (in_range1 res3))) (forall ((temp___246 Int)) (=> (and (<= 1 temp___246) (<= temp___246 10000)) (=> (< r2 temp___246) (= (select data3 temp___246) (select data temp___246)))))) (and (<= 1 r2) (<= r2 10000))))
(assert (not (= r2 10000)))
(assert (= r2 result3))
(assert (= r3 (+ r2 1)))
...
(assert (= data4 data3))
(assert (= res4 res3))
(assert (not (= (bool_eq data4 1 10000 data 1 10000) true)))
(check-sat)
(exit)
