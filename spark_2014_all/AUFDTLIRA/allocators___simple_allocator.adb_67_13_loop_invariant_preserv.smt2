...
(assert (= data2 data1))
(assert (= res2 res1))
(assert (and (= (bool_eq data3 1 10000 data 1 10000) true) (forall ((rr Int)) (=> (and (<= 1 rr) (<= rr r2)) (= (to_rep (select data3 rr)) 1)))))
(assert (and (and (and (=> (<= 1 10000) (in_range2 r2)) (=> (<= 0 10000) (in_range1 res3))) (forall ((temp___278 Int)) (=> (and (<= 1 temp___278) (<= temp___278 10000)) (=> (< r2 temp___278) (= (select data3 temp___278) (select data temp___278)))))) (and (<= 1 r2) (<= r2 10000))))
(assert (not (= r2 10000)))
(assert (= r2 result1))
(assert (= r3 (+ r2 1)))
