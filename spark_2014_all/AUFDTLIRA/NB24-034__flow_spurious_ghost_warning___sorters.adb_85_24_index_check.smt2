...
(assert (and (and (=> (<= (to_rep values__first) (- (to_rep values__last) 1)) (dynamic_property3 (to_rep values__first) (- (to_rep values__last) 1) current2)) (=> (<= 1 2147483647) (in_range2 smallest3))) (and (<= (to_rep values__first) current2) (<= current2 (- (to_rep values__last) 1)))))
(assert (<= (to_rep values__first) j1))
(assert (<= j1 current2))
(assert (and (= temp___200 (+ j1 1)) (in_range1 (+ j1 1))))
(assert (and (<= (to_rep values__first) temp___200) (<= temp___200 (to_rep values__last))))
(assert (= o11 temp___200))
(assert (= o12 (select values3 o11)))
(assert (= o13 (to_rep o12)))
(assert (not (<= (to_rep values__first) j1)))
(check-sat)
(exit)
