...
(assert (and (and (=> (<= (to_rep values__first) (- (to_rep values__last) 1)) (dynamic_property3 (to_rep values__first) (- (to_rep values__last) 1) current2)) (=> (<= 1 2147483647) (in_range2 smallest2))) (and (<= (to_rep values__first) current2) (<= current2 (- (to_rep values__last) 1)))))
