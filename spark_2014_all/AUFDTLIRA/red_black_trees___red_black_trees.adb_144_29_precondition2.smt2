...
(declare-const o15 us_rep6)
(declare-const o16 us_split_fields10)
...
(assert (and (= o14 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j 0)) (and (in_range2 o14) (= o14 (peek1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) j 0)))))
(assert (= o15 (select res3 o14)))
(assert (= o16 (us_split_fields11 o15)))
(assert (= o17 (rec__red_black_trees__black_count__count o16)))
(assert (= o18 (to_rep o17)))
(assert (=> (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) j)) 0) (= o19 1)))
(assert (=> (not (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) j)) 0)) (= o19 0)))
(assert (= o20 (+ o19 o18)))
(assert (and (= o21 o20) (in_range7 o20)))
(assert (= o22 (ite (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res3 j)))) o21) true false)))
...
(assert (= o13 (ite (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res3 j)))) o12) true false)))
