...
(assert (= o24 (- o23 1)))
(assert (and (= fb20a00__find__L_2__R7b1 o24) (in_range1 o24)))
(assert (=> (<= (to_rep1 new_sub__first) (to_rep1 new_sub__last)) (= o25 (+ (- (to_rep1 new_sub__last) (to_rep1 new_sub__first)) 1))))
(assert (=> (not (<= (to_rep1 new_sub__first) (to_rep1 new_sub__last))) (= o25 0)))
(assert (not (in_range1 o25)))
(check-sat)
(exit)
