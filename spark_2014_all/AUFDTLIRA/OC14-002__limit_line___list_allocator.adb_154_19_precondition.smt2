...
(assert (=> (= result31 true) (and (= o118 (+ j7 1)) (in_range1 (+ j7 1)))))
(assert (=> (= result31 true) (and (= o119 (get (rec__list_allocator__m__t__available model____split_fields4) o118)) (in_range7 o119))))
(assert (=> (not (= result31 true)) (= o119 0)))
(assert (not (<= 1 j7)))
(check-sat)
(exit)
