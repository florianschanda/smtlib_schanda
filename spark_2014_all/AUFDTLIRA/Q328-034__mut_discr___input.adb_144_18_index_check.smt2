...
(define-fun dynamic_invariant2 ((temp___expr_652 Int) (temp___is_init_648 Bool) (temp___skip_constant_649 Bool) (temp___do_toplevel_650 Bool) (temp___do_typ_inv_651 Bool)) Bool (=> (or (= temp___is_init_648 true) (<= 1 1025)) (in_range4 temp___expr_652)))
...
(define-fun dynamic_invariant3 ((temp___expr_659 Int) (temp___is_init_655 Bool) (temp___skip_constant_656 Bool) (temp___do_toplevel_657 Bool) (temp___do_typ_inv_658 Bool)) Bool (=> (or (= temp___is_init_655 true) (<= 0 1024)) (in_range5 temp___expr_659)))
...
(declare-const temp___722 (Array Int character))
...
(assert (=> (< last_char (+ first_char 0)) (= temp___723 first_char)))
(assert (=> (< last_char (+ first_char 0)) (= temp___722 line)))
(assert (=> (< last_char (+ first_char 0)) (= temp___721 line_num)))
(assert (=> (< last_char (+ first_char 0)) (= temp___720 last_char)))
