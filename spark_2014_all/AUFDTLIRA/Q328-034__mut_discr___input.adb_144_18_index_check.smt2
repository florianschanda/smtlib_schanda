...
(define-fun dynamic_invariant2 ((temp___expr_577 Int) (temp___is_init_574 Bool) (temp___skip_constant_575 Bool) (temp___do_toplevel_576 Bool)) Bool (=> (or (= temp___is_init_574 true) (<= 1 1025)) (in_range4 temp___expr_577)))
...
(define-fun dynamic_invariant3 ((temp___expr_583 Int) (temp___is_init_580 Bool) (temp___skip_constant_581 Bool) (temp___do_toplevel_582 Bool)) Bool (=> (or (= temp___is_init_580 true) (<= 0 1024)) (in_range5 temp___expr_583)))
...
(assert (=> (< last_char (+ first_char 0)) (= temp___645 first_char)))
...
(assert (=> (< last_char (+ first_char 0)) (= (mk_int__ref line_num6) (mk_int__ref line_num4))))
(assert (=> (< last_char (+ first_char 0)) (= (mk_int__ref last_char6) (mk_int__ref last_char4))))
(assert (=> (< last_char (+ first_char 0)) (= (mk_int__ref first_char6) (mk_int__ref first_char4))))
(assert (=> (< last_char (+ first_char 0)) (= (mk_map__ref line5) (mk_map__ref line3))))
...
(assert (=> (not (< last_char (+ first_char 0))) (= (mk_int__ref line_num6) (mk_int__ref line_num))))
(assert (=> (not (< last_char (+ first_char 0))) (= (mk_int__ref last_char6) (mk_int__ref last_char))))
(assert (=> (not (< last_char (+ first_char 0))) (= (mk_int__ref first_char6) (mk_int__ref first_char))))
(assert (=> (not (< last_char (+ first_char 0))) (= (mk_map__ref line5) (mk_map__ref line))))
