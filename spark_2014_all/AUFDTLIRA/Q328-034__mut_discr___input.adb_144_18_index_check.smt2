...
(define-fun dynamic_invariant2 ((temp___expr_583 Int) (temp___is_init_580 Bool) (temp___skip_constant_581 Bool) (temp___do_toplevel_582 Bool)) Bool (=> (or (= temp___is_init_580 true) (<= 1 1025)) (in_range4 temp___expr_583)))
...
(define-fun dynamic_invariant3 ((temp___expr_589 Int) (temp___is_init_586 Bool) (temp___skip_constant_587 Bool) (temp___do_toplevel_588 Bool)) Bool (=> (or (= temp___is_init_586 true) (<= 0 1024)) (in_range5 temp___expr_589)))
...
(assert (=> (< last_char (+ first_char 0)) (and (and (in_range4 first_char3) (in_range5 last_char3)) (in_range1 line_num3))))
