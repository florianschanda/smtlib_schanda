...
(assert (=> (= result20 true) (= (= result19 true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (= (parent1 (mk___rep3 (us_split_fields__content3 t__split_fields14)) j1) (parent1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)) j1)))))))
(assert (=> (not (= result20 true)) (= result19 false)))
(assert (=> (= result19 true) (= (= result18 true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (not (= (parent1 (mk___rep3 (us_split_fields__content3 t__split_fields14)) j1) 0)) (= (position1 (mk___rep3 (us_split_fields__content3 t__split_fields14)) j1) (position1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)) j1))))))))
...
(assert (= o29 (select temp___754 j)))
