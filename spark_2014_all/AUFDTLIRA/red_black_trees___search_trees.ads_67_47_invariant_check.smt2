...
(assert (<= j2 100))
(assert (type_invariant1 (mk___rep3 (us_split_fields__content3 t__split_fields14))))
(assert (and (= temp___754 (model__1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))) (and (dynamic_invariant9 temp___754 true false true) (= temp___754 (model__ (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields__content3 t__split_fields14))))))))
(assert (= o60 (select temp___754 j2)))
(assert (= o61 (us_split_fields1 o60)))
(assert (= result26 (rec__tree_model__path_type__k o61)))
