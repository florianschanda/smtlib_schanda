...
(define-fun a22 () map__ref (mk_map__ref a6))
...
(define-fun a23 () map__ref (mk_map__ref a))
...
(assert (=> (= result1 true) (=> (= result8 true) (= a22 (mk_map__ref a4)))))
...
(assert (=> (= result1 true) (=> (not (= result8 true)) (= a22 a23))))
...
(assert (=> (= result1 true) (=> (not (= result11 true)) (= a9 a22))))
...
(assert (=> (not (= result1 true)) (= a20 a23)))
...
(assert (and (= o56 j20) (in_range2 j20)))
(assert (and (= o55 (+ j20 1)) (in_range1 (+ j20 1))))
(assert (not (in_range2 o55)))
(check-sat)
(exit)
