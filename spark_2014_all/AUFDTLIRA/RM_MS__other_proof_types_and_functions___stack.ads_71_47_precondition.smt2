...
(assert (and (= o (count (mk___split_fields my_stack__split_fields my_stack__split_fields1))) (and (in_range2 o) (= o (to_rep1 my_stack__split_fields1)))))
(assert (not (<= o (count (mk___split_fields my_stack__split_fields my_stack__split_fields1)))))
(check-sat)
(exit)
