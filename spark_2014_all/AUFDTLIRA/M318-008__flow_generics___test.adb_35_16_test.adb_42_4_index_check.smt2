...
(define-fun dynamic_invariant ((temp___expr_162 us_t) (temp___is_init_159 Bool) (temp___skip_constant_160 Bool) (temp___do_toplevel_161 Bool)) Bool (=> (not (= temp___skip_constant_160 true)) (dynamic_property 1 2147483647 (first1 temp___expr_162) (last1 temp___expr_162))))
...
(assert (and (forall ((temp___417 Int)) (=> (and (<= (to_rep c__first) temp___417) (<= temp___417 (to_rep c__last))) (=> (<= i2 temp___417) (= (select c1 temp___417) (select c temp___417))))) (and (<= (to_rep (first (rt a))) i2) (<= i2 (to_rep (last (rt a)))))))
...
(assert (and (<= (to_rep (first (rt b))) temp___414) (<= temp___414 (to_rep (last (rt b))))))
(assert (= o2 temp___414))
