...
(declare-const temp___269 us_rep1)
...
(assert (= temp___269 (mk___rep1 o38 o37 true)))
(assert (= v__attr__constrained true))
(assert (not (= (rec__tokens__token__kind (us_split_discrs1 temp___269)) (rec__tokens__token__kind v__split_discrs))))
(check-sat)
(exit)
