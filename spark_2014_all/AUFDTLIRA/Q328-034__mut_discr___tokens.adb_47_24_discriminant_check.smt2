...
(assert (= result5 true))
(assert (=> (<= (to_rep1 word__first) (to_rep1 word__last)) (= o33 (+ (- (to_rep1 word__last) (to_rep1 word__first)) 1))))
(assert (=> (not (<= (to_rep1 word__first) (to_rep1 word__last))) (= o33 0)))
...
(assert (and (= o35 (read2 (mk___t word1 (mk (to_rep1 word__first) (to_rep1 word__last))))) (in_range5 o35)))
...
(assert (not (= (rec__tokens__token__kind (us_split_discrs1 temp___238)) (rec__tokens__token__kind v__split_discrs))))
(check-sat)
(exit)
