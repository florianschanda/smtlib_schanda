...
(assert (= result5 true))
(assert (=> (<= (to_rep1 word__first) (to_rep1 word__last)) (= o44 (+ (- (to_rep1 word__last) (to_rep1 word__first)) 1))))
(assert (=> (not (<= (to_rep1 word__first) (to_rep1 word__last))) (= o44 0)))
(assert (= result6 (ite (< 1 o44) true false)))
(assert (not (= result6 true)))
(assert (= (to_rep4 (rec__tokens__token__kind v__split_discrs)) r17b))
(assert (in_range6 r17b))
(assert (and (= o50 (read2 (mk___t word1 (mk (to_rep1 word__first) (to_rep1 word__last))))) (in_range5 o50)))
(assert (= (to_rep3 o51) o50))
(assert (= o52 (mk___split_fields1 dummy5 o51 dummy4)))
(assert (= (to_rep4 o49) 1))
(assert (= o53 (mk___split_discrs o49)))
(assert (= temp___238 (mk___rep1 o53 o52 true)))
