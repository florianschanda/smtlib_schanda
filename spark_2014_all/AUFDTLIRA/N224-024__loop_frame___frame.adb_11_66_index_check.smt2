...
(declare-const j Int)
(declare-const temp___176 (Array Int natural))
(declare-const temp___175 Int)
(declare-const temp___178 (Array Int natural))
...
(assert (<= 1 j1))
(assert (<= j1 10))
(assert (=> (< 10 (to_rep (select a j1))) (= (to_rep o) 10)))
(assert (=> (< 10 (to_rep (select a j1))) (= o1 (store a j1 o))))
(assert (=> (< 10 (to_rep (select a j1))) (= (mk_map__ref result1) (mk_map__ref a))))
(assert (=> (< 10 (to_rep (select a j1))) (= a2 o1)))
...
(assert (and (and (=> (<= 1 10) (in_range2 j2)) (forall ((temp___177 Int)) (=> (and (<= 1 temp___177) (<= temp___177 10)) (=> (< j2 temp___177) (= (select a3 temp___177) (select a temp___177)))))) (and (<= 1 j2) (<= j2 10))))
(assert (<= 1 k))
(assert (<= k j2))
(assert (and (<= 1 k) (<= k 10)))
(assert (= o2 k))
...
(assert (= o4 (to_rep o3)))
(assert (= result2 (ite (< 10 o4) true false)))
