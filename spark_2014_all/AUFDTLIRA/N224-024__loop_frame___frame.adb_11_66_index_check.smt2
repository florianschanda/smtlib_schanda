...
(assert (and (and (=> (<= 1 10) (in_range2 j2)) (forall ((temp___203 Int)) (=> (and (<= 1 temp___203) (<= temp___203 10)) (=> (< j2 temp___203) (= (select a3 temp___203) (select a temp___203)))))) (and (<= 1 j2) (<= j2 10))))
(assert (<= 1 k))
(assert (<= k j2))
(assert (and (<= 1 k) (<= k 10)))
(assert (= o2 k))
