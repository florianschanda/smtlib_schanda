...
(define-fun dynamic_invariant1 ((temp___expr_593 us_rep1) (temp___is_init_589 Bool) (temp___skip_constant_590 Bool) (temp___do_toplevel_591 Bool) (temp___do_typ_inv_592 Bool)) Bool (=> (not (= temp___skip_constant_590 true)) (in_range3 10 (to_base temp___expr_593))))
...
(assert (and (= us (to_rep (rec__do_checks__do_discriminant_check__r1__j (us_split_discrs1 x)))) (in_range1 (to_rep (rec__do_checks__do_discriminant_check__r1__j (us_split_discrs1 x))))))
