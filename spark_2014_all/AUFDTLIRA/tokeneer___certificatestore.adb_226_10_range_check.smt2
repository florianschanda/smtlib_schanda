...
(assert (= o4 str1))
(assert (= o4 temp___1501))
(assert (= (mk5 2 r10b) temp___15011))
(assert (= (ite (<= (to_rep1 (first10 temp___15011)) (to_rep1 (last10 temp___15011))) (+ (- (to_rep1 (last10 temp___15011)) (to_rep1 (first10 temp___15011))) 1) 0) (ite (<= 1 r6b) (+ (- r6b 1) 1) 0)))
(assert (= (slide temp___1501 (to_rep1 (first10 temp___15011)) 1) temp___1502))
(assert (= (mk4 1 r6b) temp___15021))
(assert (=> (<= 1 r6b) (and (and (<= 1 1) (<= 1 10)) (and (<= 1 r6b) (<= r6b 10)))))
(assert (= o5 text))
(assert (= o5 temp___1504))
(assert (= (mk4 1 r6b) temp___15041))
(assert (= (ite (<= (to_rep1 (first8 temp___15021)) (to_rep1 (last8 temp___15021))) (+ (- (to_rep1 (last8 temp___15021)) (to_rep1 (first8 temp___15021))) 1) 0) (ite (<= (to_rep1 (first8 temp___15041)) (to_rep1 (last8 temp___15041))) (+ (- (to_rep1 (last8 temp___15041)) (to_rep1 (first8 temp___15041))) 1) 0)))
(assert (= (mk___t4 temp___1505 temp___15051) (mk___t4 temp___1502 temp___15021)))
(assert (forall ((temp___1506 Int)) (ite (and (<= 1 temp___1506) (<= temp___1506 r6b)) (= (select o6 temp___1506) (select temp___1505 temp___1506)) (= (select o6 temp___1506) (select text temp___1506)))))
(assert (= result2 text))
(assert (= text1 o6))
(assert (= (+ length9 1) r15b))
(assert (in_range r15b))
(assert (= (to_rep1 (first14 (rt7 (temp___1507 32 r15b 10)))) r15b))
(assert (= (to_rep1 (last14 (rt7 (temp___1507 32 r15b 10)))) 10))
(assert (= (mk___t7 temp___1514 temp___15141) (temp___1507 32 r15b 10)))
(assert (= (ite (<= (to_rep1 (first14 temp___15141)) (to_rep1 (last14 temp___15141))) (+ (- (to_rep1 (last14 temp___15141)) (to_rep1 (first14 temp___15141))) 1) 0) (ite (<= r15b 10) (+ (- 10 r15b) 1) 0)))
(assert (= (slide temp___1514 (to_rep1 (first14 temp___15141)) r15b) temp___1515))
(assert (= (mk6 r15b 10) temp___15151))
(assert (<= r15b 10))
(assert (not (<= 1 r15b)))
(check-sat)
(exit)
