...
(declare-const temp___16731 t4)
(declare-const o6 (Array Int character))
(declare-const temp___1682 (Array Int character))
(declare-const temp___16821 t7)
(declare-const temp___1683 (Array Int character))
(declare-const temp___16831 t6)
...
(assert (= (ite (<= (to_rep1 (first8 temp___16701)) (to_rep1 (last8 temp___16701))) (+ (- (to_rep1 (last8 temp___16701)) (to_rep1 (first8 temp___16701))) 1) 0) (ite (<= (to_rep1 (first8 temp___16721)) (to_rep1 (last8 temp___16721))) (+ (- (to_rep1 (last8 temp___16721)) (to_rep1 (first8 temp___16721))) 1) 0)))
(assert (= (mk___t4 temp___1673 temp___16731) (mk___t4 temp___1670 temp___16701)))
(assert (forall ((temp___1674 Int)) (ite (and (<= 1 temp___1674) (<= temp___1674 r6b)) (= (select o6 temp___1674) (select temp___1673 temp___1674)) (= (select o6 temp___1674) (select text temp___1674)))))
(assert (= result2 text))
(assert (= text1 o6))
(assert (= (+ length9 1) r15b))
(assert (in_range r15b))
(assert (= (to_rep1 (first14 (rt7 (temp___1675 32 r15b 10)))) r15b))
(assert (= (to_rep1 (last14 (rt7 (temp___1675 32 r15b 10)))) 10))
(assert (= (mk___t7 temp___1682 temp___16821) (temp___1675 32 r15b 10)))
(assert (= (ite (<= (to_rep1 (first14 temp___16821)) (to_rep1 (last14 temp___16821))) (+ (- (to_rep1 (last14 temp___16821)) (to_rep1 (first14 temp___16821))) 1) 0) (ite (<= r15b 10) (+ (- 10 r15b) 1) 0)))
(assert (= (slide temp___1682 (to_rep1 (first14 temp___16821)) r15b) temp___1683))
(assert (= (mk6 r15b 10) temp___16831))
(assert (<= r15b 10))
(assert (not (<= 1 r15b)))
(check-sat)
(exit)
