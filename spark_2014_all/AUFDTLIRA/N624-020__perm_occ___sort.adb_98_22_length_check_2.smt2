...
(assert (=> (not (= smallest1 current1)) (and (and (and (= (is_perm (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last))) (mk___t o13 (mk (to_rep1 values__first) (to_rep1 values__last)))) true) (= (to_rep (select o13 o8)) (to_rep (select values smallest1)))) (= (to_rep (select o13 smallest1)) (to_rep (select values o8)))) (forall ((z Int)) (=> (and (<= (to_rep1 values__first) z) (<= z (to_rep1 values__last))) (=> (and (not (= z o8)) (not (= z smallest1))) (= (to_rep (select o13 z)) (to_rep (select values z)))))))))
...
(assert (= (slide values2 (to_rep1 values__first) (to_rep1 values__first)) temp___2732))
(assert (= (mk1 (to_rep1 values__first) (to_rep1 values__last)) temp___2733))
(assert (not (= (ite (<= (to_rep1 (first2 temp___2733)) (to_rep1 (last2 temp___2733))) (+ (- (to_rep1 (last2 temp___2733)) (to_rep1 (first2 temp___2733))) 1) 0) (ite (<= (to_rep1 previous__first) (to_rep1 previous__last)) (+ (- (to_rep1 previous__last) (to_rep1 previous__first)) 1) 0))))
(check-sat)
(exit)
