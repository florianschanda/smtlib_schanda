...
(assert (= result4 true))
(assert (and (= o4 (to_rep1 (rec__search_trees__search_tree__root t__split_fields5))) (in_range3 (to_rep1 (rec__search_trees__search_tree__root t__split_fields5)))))
(assert (and (= temp___726 (model__ (rec__search_trees__search_tree__struct t__split_fields5) o4)) (and (dynamic_invariant9 temp___726 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___726 o4))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___726 o4)))) 0) (and (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (not (= i5 o4)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct t__split_fields5) i5) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___726 (parent (rec__search_trees__search_tree__struct t__split_fields5) i5)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___726 i5))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___726 i5))) true)))))) (and (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___726 i5))) true) (not (= i5 o4))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___726 (parent (rec__search_trees__search_tree__struct t__split_fields5) i5)))) (position (rec__search_trees__search_tree__struct t__split_fields5) i5) (rec__tree_model__path_type__a (us_split_fields1 (select temp___726 i5)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___726 i5)))) 0)))) (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___726 i5))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___726 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___726 i5))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___726 j)))) true)) (= j i5))))))))))))))
(assert (and (<= 1 current2) (<= current2 100)))
(assert (= o5 current2))
(assert (= o6 (select temp___726 o5)))
