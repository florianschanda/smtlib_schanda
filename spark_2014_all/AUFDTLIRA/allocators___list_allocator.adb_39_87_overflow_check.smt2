...
(assert (and (= o12 (length model____split_fields)) (and (in_range6 o12) (<= (+ 0 o12) 2147483647))))
(assert (= result3 (ite (<= o12 10000) true false)))
(assert (=> (= result3 true) (and (= o11 (length1 model____split_fields1)) (in_range6 o11))))
(assert (=> (= result3 true) (= result2 (ite (<= o11 10000) true false))))
(assert (=> (not (= result3 true)) (= result2 false)))
(assert (=> (= result2 true) (and (= o7 (length1 model____split_fields1)) (in_range6 o7))))
(assert (=> (= result2 true) (and (= o8 (length model____split_fields)) (and (in_range6 o8) (<= (+ 0 o8) 2147483647)))))
...
(assert (=> (= result1 true) (=> (not (= first_available 0)) (and (= o5 (length model____split_fields)) (and (in_range6 o5) (<= (+ 0 o5) 2147483647))))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (= result4 (ite (< 0 o5) true false)))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (=> (= result4 true) (and (= o4 (get model____split_fields 1)) (in_range7 o4))))))
...
(assert (=> (= result1 true) (=> (not (not (= first_available 0))) (and (= o6 (length model____split_fields)) (and (in_range6 o6) (<= (+ 0 o6) 2147483647))))))
