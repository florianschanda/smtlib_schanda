...
(assert (and (= o12 (length model____split_fields)) (and (in_range2 o12) (<= (+ 0 o12) 2147483647))))
(assert (= result3 (ite (<= o12 10000) true false)))
(assert (=> (= result3 true) (and (= o11 (length1 model____split_fields1)) (in_range2 o11))))
(assert (=> (= result3 true) (= result2 (ite (<= o11 10000) true false))))
(assert (=> (not (= result3 true)) (= result2 false)))
(assert (=> (= result2 true) (and (= o7 (length1 model____split_fields1)) (in_range2 o7))))
(assert (=> (= result2 true) (and (= o8 (length model____split_fields)) (and (in_range2 o8) (<= (+ 0 o8) 2147483647)))))
(assert (=> (= result2 true) (= o9 (+ o8 o7))))
(assert (=> (= result2 true) (and (= o10 o9) (in_range7 o9))))
(assert (=> (= result2 true) (= result1 (ite (= o10 10000) true false))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (and (= o5 (length model____split_fields)) (and (in_range2 o5) (<= (+ 0 o5) 2147483647))))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (= result4 (ite (< 0 o5) true false)))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (=> (= result4 true) (and (= o4 (get model____split_fields 1)) (in_range3 o4))))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (=> (= result4 true) (= result (ite (= o4 first_available) true false))))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (=> (not (= result4 true)) (= result false)))))
(assert (=> (= result1 true) (=> (not (not (= first_available 0))) (and (= o6 (length model____split_fields)) (and (in_range2 o6) (<= (+ 0 o6) 2147483647))))))
(assert (=> (= result1 true) (=> (not (not (= first_available 0))) (= result (ite (= o6 0) true false)))))
...
(assert (= result5 true))
(assert (and (= o3 (get model____split_fields j)) (in_range3 o3)))
(assert (= result6 (ite (in_range8 o3) true false)))
(assert (= result6 true))
