...
(define-fun dynamic_invariant2 ((temp___expr_155 Int) (temp___is_init_152 Bool) (temp___skip_constant_153 Bool) (temp___do_toplevel_154 Bool)) Bool (=> (or (= temp___is_init_152 true) (<= 0 100)) (in_range3 temp___expr_155)))
(define-fun dynamic_invariant3 ((temp___expr_140 Int) (temp___is_init_137 Bool) (temp___skip_constant_138 Bool) (temp___do_toplevel_139 Bool)) Bool (=> (or (= temp___is_init_137 true) (<= 1 100)) (in_range2 temp___expr_140)))
(declare-const x Int)
...
(declare-const temp___2141 pointer_range)
(declare-const i Int)
...
(define-fun o14 () us_rep (mk___rep (mk___split_fields o7 o8)))
...
(assert (= x1 o2))
(assert (and (= o3 (- (to_rep1 my_stack__split_fields1) 1)) (in_range3 (- (to_rep1 my_stack__split_fields1) 1))))
...
(assert (= x3 x1))
(assert (and (= o14 (state__2 (mk___split_fields my_stack__split_fields4 my_stack__split_fields5))) (and (= my_stack__split_fields4 o7) (= my_stack__split_fields5 o8))))
(assert (and (= o9 (count o14)) (and (in_range4 o9) (= o9 (to_rep1 o8)))))
(assert (= o10 (ite (<= i o9) true false)))
(assert (= result3 (ite (<= 1 i) o10 false)))
(assert (= result3 true))
(assert (and (= o13 (stack_entry (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1)) i)) (and (in_range1 o13) (= o13 (to_rep (select (rec__stack_functional_spec__stack_type__s (us_split_fields1 (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1)))) i))))))
(assert (and (= (mk___rep (mk___split_fields o11 o12)) (state__2 (mk___split_fields my_stack__split_fields4 my_stack__split_fields5))) (and (= my_stack__split_fields4 o11) (= my_stack__split_fields5 o12))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
