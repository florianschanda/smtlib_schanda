...
(declare-const o14 pointer_range)
...
(assert (= x3 x1))
(assert (and (= (mk___rep (mk___split_fields o9 o10)) (state__2 (mk___split_fields my_stack__split_fields4 my_stack__split_fields5))) (and (= my_stack__split_fields4 o9) (= my_stack__split_fields5 o10))))
(assert (and (= o11 (count (mk___rep (mk___split_fields o9 o10)))) (and (in_range4 o11) (= o11 (to_rep1 o10)))))
(assert (= o12 (ite (<= i o11) true false)))
(assert (= result3 (ite (<= 1 i) o12 false)))
(assert (= result3 true))
(assert (and (= o15 (stack_entry (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1)) i)) (and (in_range1 o15) (= o15 (to_rep (select (rec__stack_functional_spec__stack_type__s (us_split_fields1 (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1)))) i))))))
(assert (and (= (mk___rep (mk___split_fields o13 o14)) (state__2 (mk___split_fields my_stack__split_fields4 my_stack__split_fields5))) (and (= my_stack__split_fields4 o13) (= my_stack__split_fields5 o14))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
