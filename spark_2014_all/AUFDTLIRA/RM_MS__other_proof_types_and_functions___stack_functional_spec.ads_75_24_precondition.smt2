...
(define-fun o14 () us_rep (mk___rep (mk___split_fields o11 o12)))
(define-fun o15 () us_rep (mk___rep (mk___split_fields o7 o8)))
...
(assert (= x3 x1))
(assert (and (= o15 (state__2 (mk___split_fields my_stack__split_fields4 my_stack__split_fields5))) (and (= my_stack__split_fields4 o7) (= my_stack__split_fields5 o8))))
(assert (and (= o9 (count o15)) (and (in_range3 o9) (= o9 (to_rep1 o8)))))
...
(assert (and (= o14 (state__2 (mk___split_fields my_stack__split_fields4 my_stack__split_fields5))) (and (= my_stack__split_fields4 o11) (= my_stack__split_fields5 o12))))
(assert (not (<= i (count o14))))
(check-sat)
(exit)
