...
(define-fun dynamic_invariant ((temp___expr_164 Int) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool)) Bool (=> (or (= temp___is_init_161 true) (<= 0 2147483647)) (in_range temp___expr_164)))
...
(declare-fun temp___193 (Int Int Int) us_t1)
(assert (forall ((temp___195 Int) (temp___196 Int) (temp___197 Int)) (let ((temp___194 (temp___193 temp___195 temp___196 temp___197))) (and (=> (dynamic_property4 1 2147483647 temp___196 temp___197) (and (= (first3 temp___194) temp___196) (= (last3 temp___194) temp___197))) (forall ((temp___198 Int)) (= (select (to_array1 temp___194) temp___198) (of_rep1 temp___195)))))))
...
(declare-const temp___191 natural_index)
(declare-const temp___200 (Array Int character))
(declare-const temp___2001 t1)
(declare-const temp___201 natural_index)
(declare-const temp___2011 natural_index)
(declare-const temp___2012 (Array Int character))
(declare-const temp___2013 t)
(assert (in_range temp___192))
(assert (= temp___192 (to_rep temp___191)))
(assert (= (to_rep2 (first2 (rt1 (temp___193 32 1 temp___192)))) 1))
(assert (= (to_rep2 (last2 (rt1 (temp___193 32 1 temp___192)))) temp___192))
(assert (= (mk___t1 temp___200 temp___2001) (temp___193 32 1 temp___192)))
(assert (not (= (ite (<= (to_rep2 (first2 temp___2001)) (to_rep2 (last2 temp___2001))) (+ (- (to_rep2 (last2 temp___2001)) (to_rep2 (first2 temp___2001))) 1) 0) (ite (<= 1 temp___192) (+ (- temp___192 1) 1) 0))))
(check-sat)
(exit)
