...
(assert (=> (not (= first_available 0)) (and (= o34 (length model____split_fields)) (in_range6 o34))))
(assert (=> (not (= first_available 0)) (= result3 (ite (< 0 o34) true false))))
(assert (=> (not (= first_available 0)) (=> (= result3 true) (and (= o33 (get model____split_fields 1)) (in_range7 o33)))))
...
(assert (=> (not (not (= first_available 0))) (and (= o35 (length model____split_fields)) (in_range6 o35))))
(assert (=> (not (not (= first_available 0))) (= result2 (ite (= o35 0) true false))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (and (= o31 (length model____split_fields1)) (in_range6 o31)))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (= result4 (ite (< 0 o31) true false)))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (=> (= result4 true) (and (= o30 (get model____split_fields1 1)) (in_range7 o30))))))
...
(assert (=> (= result2 true) (=> (not (not (= first_allocated 0))) (and (= o32 (length model____split_fields1)) (in_range6 o32)))))
(assert (=> (= result2 true) (=> (not (not (= first_allocated 0))) (= result1 (ite (= o32 0) true false)))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (=> (= result1 true) (and (= o28 (length model____split_fields)) (in_range6 o28))))
...
(assert (= result6 true))
(assert (and (= o27 (get model____split_fields1 j)) (in_range7 o27)))
(assert (= result9 (ite (in_range4 o27) true false)))
(assert (=> (= result9 true) (and (= o23 (length model____split_fields1)) (in_range6 o23))))
(assert (=> (= result9 true) (= result10 (ite (< j o23) true false))))
(assert (=> (= result9 true) (=> (= result10 true) (and (= o24 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result9 true) (=> (= result10 true) (and (= o25 (get model____split_fields1 o24)) (in_range7 o25)))))
(assert (=> (= result9 true) (=> (not (= result10 true)) (= o25 0))))
(assert (=> (= result9 true) (and (= temp___387 (get model____split_fields1 j)) (in_range7 temp___387))))
(assert (=> (= result9 true) (and (<= 1 temp___387) (<= temp___387 3))))
(assert (=> (= result9 true) (= o15 temp___387)))
...
(assert (=> (= result8 true) (=> (< 1 j) (and (= o13 (get model____split_fields1 o12)) (in_range7 o13)))))
(assert (=> (= result8 true) (=> (not (< 1 j)) (= o13 0))))
(assert (=> (= result8 true) (and (= temp___388 (get model____split_fields1 j)) (in_range7 temp___388))))
(assert (=> (= result8 true) (and (<= 1 temp___388) (<= temp___388 3))))
(assert (=> (= result8 true) (= o4 temp___388)))
