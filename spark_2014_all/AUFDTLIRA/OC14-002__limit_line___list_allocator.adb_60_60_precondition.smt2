...
(assert (=> (= result13 true) (=> (< 1 j) (and (= o14 (- j 1)) (in_range2 (- j 1))))))
(assert (=> (= result13 true) (=> (< 1 j) (and (= o15 (get model____split_fields1 o14)) (in_range7 o15)))))
(assert (=> (= result13 true) (=> (not (< 1 j)) (= o15 0))))
(assert (=> (= result13 true) (and (= temp___388 (get model____split_fields1 j)) (in_range7 temp___388))))
(assert (=> (= result13 true) (and (<= 1 temp___388) (<= temp___388 3))))
(assert (=> (= result13 true) (= o6 temp___388)))
(assert (=> (= result13 true) (= (mk___rep (mk___split_fields o7 o8 o9)) (select data o6))))
(assert (=> (= result13 true) (= o7 o10)))
(assert (=> (= result13 true) (= o8 o11)))
(assert (=> (= result13 true) (= o9 o12)))
(assert (=> (= result13 true) (= o13 o11)))
(assert (=> (= result13 true) (= o16 (to_rep o13))))
(assert (=> (= result13 true) (= result12 (ite (= o16 o15) true false))))
...
(assert (= result16 (ite (<= 1 k) o3 false)))
