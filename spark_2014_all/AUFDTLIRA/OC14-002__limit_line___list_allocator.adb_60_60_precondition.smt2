...
(assert (=> (= result9 true) (and (= temp___420 (get model____split_fields1 j)) (in_range7 temp___420))))
...
(assert (=> (= result8 true) (and (= temp___421 (get model____split_fields1 j)) (in_range7 temp___421))))
