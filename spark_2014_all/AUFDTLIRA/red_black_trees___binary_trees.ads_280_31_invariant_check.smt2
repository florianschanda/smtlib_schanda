...
(define-fun dynamic_invariant2 ((temp___expr_168 Int) (temp___is_init_165 Bool) (temp___skip_constant_166 Bool) (temp___do_toplevel_167 Bool)) Bool (=> (or (= temp___is_init_165 true) (<= 0 1)) (in_range4 temp___expr_168)))
...
(assert (forall ((f us_rep3)) (forall ((i Int)) (! (=> (and (and (dynamic_invariant i true true true) (type_invariant f)) (not (= (parent f i) 0))) (dynamic_invariant2 (position f i) true false true)) :pattern ((position f i))))))
...
(declare-const o18 (Array Int us_rep2))
(declare-const temp___808 extended_index_type)
(declare-const temp___8081 (Array Int us_rep2))
...
(declare-const o27 position_type)
(declare-const o28 (Array Int us_rep2))
(declare-const o29 extended_index_type)
(declare-const o30 (Array Int us_rep2))
(declare-const temp___803 extended_index_type)
(declare-const temp___8031 (Array Int us_rep2))
...
(declare-const temp___822 (Array Int us_rep1))
...
(declare-const temp___825 (Array Int us_rep1))
...
(assert (=> (not (= v 0)) (=> (= d 0) (= (to_rep o7) v))))
(assert (=> (not (= v 0)) (=> (= d 0) (= o7 o8))))
(assert (=> (not (= v 0)) (=> (= d 0) (= (rec__binary_trees__cell__right (us_split_fields3 (select f__split_fields1 i))) o9))))
(assert (=> (not (= v 0)) (=> (= d 0) (= (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i))) o10))))
(assert (=> (not (= v 0)) (=> (= d 0) (= (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 i))) o11))))
(assert (=> (not (= v 0)) (=> (= d 0) (= o12 o8))))
(assert (=> (not (= v 0)) (=> (= d 0) (= o13 o9))))
(assert (=> (not (= v 0)) (=> (= d 0) (= o14 o10))))
(assert (=> (not (= v 0)) (=> (= d 0) (= o15 o11))))
(assert (=> (not (= v 0)) (=> (= d 0) (= o16 (store f__split_fields1 i (mk___rep1 (mk___split_fields1 o12 o13 o14 o15)))))))
(assert (=> (not (= v 0)) (=> (= d 0) (= f__split_fields o17))))
(assert (=> (not (= v 0)) (=> (= d 0) (= o16 o18))))
(assert (=> (not (= v 0)) (=> (= d 0) (= temp___808 o17))))
(assert (=> (not (= v 0)) (=> (= d 0) (= temp___8081 o18))))
(assert (=> (not (= v 0)) (=> (= d 0) (= result4 (mk___split_fields__ref2 (mk___split_fields2 f__split_fields f__split_fields1))))))
(assert (=> (not (= v 0)) (=> (= d 0) (= f__split_fields3 (mk___split_fields2 temp___808 temp___8081)))))
(assert (=> (not (= v 0)) (=> (not (= d 0)) (= (to_rep o19) v))))
(assert (=> (not (= v 0)) (=> (not (= d 0)) (= (rec__binary_trees__cell__left (us_split_fields3 (select f__split_fields1 i))) o20))))
(assert (=> (not (= v 0)) (=> (not (= d 0)) (= o19 o21))))
(assert (=> (not (= v 0)) (=> (not (= d 0)) (= (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i))) o22))))
(assert (=> (not (= v 0)) (=> (not (= d 0)) (= (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 i))) o23))))
(assert (=> (not (= v 0)) (=> (not (= d 0)) (= o24 o20))))
(assert (=> (not (= v 0)) (=> (not (= d 0)) (= o25 o21))))
(assert (=> (not (= v 0)) (=> (not (= d 0)) (= o26 o22))))
(assert (=> (not (= v 0)) (=> (not (= d 0)) (= o27 o23))))
(assert (=> (not (= v 0)) (=> (not (= d 0)) (= o28 (store f__split_fields1 i (mk___rep1 (mk___split_fields1 o24 o25 o26 o27)))))))
(assert (=> (not (= v 0)) (=> (not (= d 0)) (= f__split_fields o29))))
(assert (=> (not (= v 0)) (=> (not (= d 0)) (= o28 o30))))
(assert (=> (not (= v 0)) (=> (not (= d 0)) (= temp___803 o29))))
(assert (=> (not (= v 0)) (=> (not (= d 0)) (= temp___8031 o30))))
(assert (=> (not (= v 0)) (=> (not (= d 0)) (= result5 (mk___split_fields__ref2 (mk___split_fields2 f__split_fields f__split_fields1))))))
(assert (=> (not (= v 0)) (=> (not (= d 0)) (= f__split_fields4 (mk___split_fields2 temp___803 temp___8031)))))
(assert (=> (not (= v 0)) (=> (not (= d 0)) (= f__split_fields3 f__split_fields4))))
(assert (=> (not (= v 0)) (= (to_rep1 o31) d)))
(assert (=> (not (= v 0)) (= (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields3) v))) o32)))
(assert (=> (not (= v 0)) (= (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields3) v))) o33)))
(assert (=> (not (= v 0)) (= (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields3) v))) o34)))
(assert (=> (not (= v 0)) (= o31 o35)))
(assert (=> (not (= v 0)) (= o36 o32)))
(assert (=> (not (= v 0)) (= o37 o33)))
(assert (=> (not (= v 0)) (= o38 o34)))
(assert (=> (not (= v 0)) (= o39 o35)))
(assert (=> (not (= v 0)) (and (<= 1 v) (<= v 100))))
(assert (=> (not (= v 0)) (= o40 v)))
(assert (=> (not (= v 0)) (= o41 (store (rec__binary_trees__forest__c f__split_fields3) o40 (mk___rep1 (mk___split_fields1 o36 o37 o38 o39))))))
(assert (=> (not (= v 0)) (= o42 (mk___split_fields2 (rec__binary_trees__forest__s f__split_fields3) o41))))
(assert (=> (not (= v 0)) (= temp___813 (mk___rep2 o42))))
(assert (=> (not (= v 0)) (= result6 (mk___split_fields__ref2 f__split_fields3))))
(assert (=> (not (= v 0)) (= f__split_fields5 (us_split_fields5 temp___813))))
(assert (=> (not (= v 0)) (= (to_rep o43) i)))
(assert (=> (not (= v 0)) (= o44 (mk___split_fields1 (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields5) v))) (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields5) v))) o43 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields5) v)))))))
(assert (=> (not (= v 0)) (= o45 (mk___rep1 o44))))
(assert (=> (not (= v 0)) (and (<= 1 v) (<= v 100))))
(assert (=> (not (= v 0)) (= o46 v)))
(assert (=> (not (= v 0)) (= o47 (store (rec__binary_trees__forest__c f__split_fields5) o46 o45))))
(assert (=> (not (= v 0)) (= o48 (mk___split_fields2 (rec__binary_trees__forest__s f__split_fields5) o47))))
(assert (=> (not (= v 0)) (= temp___818 (mk___rep2 o48))))
(assert (=> (not (= v 0)) (= result7 (mk___split_fields__ref2 f__split_fields5))))
(assert (=> (not (= v 0)) (= f__split_fields6 (us_split_fields5 temp___818))))
(assert (=> (not (= v 0)) (and (= (tree_structure (mk___rep2 f_old__split_fields2)) true) (= (tree_structure (mk___rep2 f__split_fields6)) true))))
(assert (=> (not (= v 0)) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 f__split_fields6) root) v))) true) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 f__split_fields6) root) i2))) true) (ite (= (ole (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 f__split_fields6) root) v))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 f__split_fields6) root) i2)))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 f_old__split_fields2) v) i2))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 f_old__split_fields2) root) i2))) true))))) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 f_old__split_fields2) root) i2))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 f__split_fields6) root) i2))) true)))) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 f_old__split_fields2) v) i2))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 f__split_fields6) root) i2))) true)))) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 f_old__split_fields2) root) i2))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 f__split_fields6) root) i2))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 f_old__split_fields2) root) i2)))) true)))) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 f_old__split_fields2) v) i2))) true) (= (is_concat (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 f__split_fields6) root) v))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 f_old__split_fields2) v) i2))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 f__split_fields6) root) i2)))) true)))) (forall ((r Int)) (=> (and (<= 1 r) (<= r (to_rep (rec__binary_trees__forest__s f__split_fields6)))) (=> (and (and (not (= r root)) (not (= r v))) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c f_old__split_fields2) r)))) 2)) (= (oeq1 (model__ (mk___rep2 f_old__split_fields2) r) (model__ (mk___rep2 f__split_fields6) r)) true))))))))))))
(assert (=> (= v 0) (= f__split_fields6 (mk___split_fields2 f__split_fields f__split_fields1))))
(assert (=> (= v 0) (= f__split_fields6 f__split_fields2)))
...
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o96 (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)))) (and (in_range2 o96) (= o96 (to_rep f__split_fields)))))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= o97 (size (mk___rep2 (us_split_fields__content2 f__split_fields7)))) (and (in_range2 o97) (= o97 (to_rep (rec__binary_trees__forest__s (us_split_fields__content2 f__split_fields7)))))))
(assert (= result8 (ite (= o97 o96) true false)))
(assert (= result8 true))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= o95 (peek (mk___rep2 (us_split_fields__content2 f__split_fields7)) i d)) (and (in_range2 o95) (and (= o95 (ite (= d 0) (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) i)))) (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) i)))))) (and (ite (not (= o95 0)) (and (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) o95) d) (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) o95) i)) (forall ((j9 Int)) (=> (and (<= 1 j9) (<= j9 100)) (=> (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j9) i) (not (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) j9) d)))))) (forall ((j9 Int)) (=> (and (<= 1 j9) (<= j9 100)) (=> (and (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j9) i) (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) j9) d)) (= o95 j9)))))))))
(assert (= result9 (ite (= v o95) true false)))
(assert (= result9 true))
(assert (= (= result10 true) (forall ((j9 Int)) (=> (and (<= 1 j9) (<= j9 100)) (=> (and (= (valid_root (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j9) true) (not (= j9 v))) (= (valid_root (mk___rep2 (us_split_fields__content2 f__split_fields7)) j9) true))))))
(assert (= result10 true))
(assert (= (= result12 true) (forall ((j9 Int)) (=> (and (<= 1 j9) (<= j9 100)) (=> (= (valid_root (mk___rep2 (us_split_fields__content2 f__split_fields7)) j9) true) (= (valid_root (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j9) true))))))
(assert (= result12 true))
(assert (= (= result14 true) (forall ((j9 Int)) (=> (and (<= 1 j9) (<= j9 100)) (=> (not (= j9 v)) (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j9) (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j9)))))))
(assert (= result14 true))
(assert (= (= result15 true) (forall ((j9 Int)) (=> (and (<= 1 j9) (<= j9 100)) (=> (and (not (= j9 v)) (not (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j9) 0))) (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) j9) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j9)))))))
(assert (= result15 true))
(assert (= (= result17 true) (forall ((j9 Int)) (=> (and (<= 1 j9) (<= j9 100)) (forall ((e1 Int)) (=> (and (<= 0 e1) (<= e1 1)) (=> (or (not (= j9 i)) (not (= e1 d))) (= (peek (mk___rep2 (us_split_fields__content2 f__split_fields7)) j9 e1) (peek (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j9 e1)))))))))
(assert (= result17 true))
(assert (= (= result18 true) (forall ((j9 Int)) (=> (and (<= 1 j9) (<= j9 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root) j9))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (us_split_fields__content2 f__split_fields7)) root) j9))) true))))))
(assert (= result18 true))
(assert (= (= result19 true) (forall ((j9 Int)) (=> (and (<= 1 j9) (<= j9 100)) (=> (and (not (= v 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) v) j9))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (us_split_fields__content2 f__split_fields7)) root) j9))) true))))))
(assert (= result19 true))
(assert (<= 1 i1))
(assert (<= i1 100))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= temp___847 (model__ (mk___rep2 (us_split_fields__content2 f__split_fields7)) root)) (and (dynamic_invariant3 temp___847 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___847 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___847 root)))) 0) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (not (= i2 root)) (ite (and (not (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) i2) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___847 (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) i2)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___847 i2))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___847 i2))) true)))))) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___847 i2))) true) (not (= i2 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___847 (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) i2)))) (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) i2) (rec__tree_model__path_type__a (us_split_fields1 (select temp___847 i2)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___847 i2)))) 0)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___847 i2))) true) (forall ((j9 Int)) (=> (and (<= 1 j9) (<= j9 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___847 j9))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___847 i2))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___847 j9)))) true)) (= j9 i2))))))))))))))
(assert (= o73 (select temp___847 i1)))
(assert (= o74 (us_split_fields1 o73)))
(assert (= result22 (rec__tree_model__path_type__k o74)))
(assert (= result22 true))
(assert (=> (not (= v 0)) (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true)))
(assert (=> (not (= v 0)) (and (= temp___846 (model__ (mk___rep2 (us_split_fields__content2 f__split_fields7)) root)) (and (dynamic_invariant3 temp___846 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___846 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___846 root)))) 0) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (not (= i2 root)) (ite (and (not (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) i2) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___846 (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) i2)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___846 i2))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___846 i2))) true)))))) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___846 i2))) true) (not (= i2 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___846 (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) i2)))) (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) i2) (rec__tree_model__path_type__a (us_split_fields1 (select temp___846 i2)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___846 i2)))) 0)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___846 i2))) true) (forall ((j9 Int)) (=> (and (<= 1 j9) (<= j9 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___846 j9))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___846 i2))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___846 j9)))) true)) (= j9 i2)))))))))))))))
(assert (=> (not (= v 0)) (= o79 (select temp___846 i1))))
(assert (=> (not (= v 0)) (= o80 (us_split_fields1 o79))))
(assert (=> (not (= v 0)) (= o81 (rec__tree_model__path_type__a o80))))
(assert (=> (not (= v 0)) (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true)))
(assert (=> (not (= v 0)) (and (= temp___845 (model__ (mk___rep2 (us_split_fields__content2 f__split_fields7)) root)) (and (dynamic_invariant3 temp___845 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___845 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___845 root)))) 0) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (not (= i2 root)) (ite (and (not (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) i2) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___845 (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) i2)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___845 i2))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___845 i2))) true)))))) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___845 i2))) true) (not (= i2 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___845 (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) i2)))) (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) i2) (rec__tree_model__path_type__a (us_split_fields1 (select temp___845 i2)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___845 i2)))) 0)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___845 i2))) true) (forall ((j9 Int)) (=> (and (<= 1 j9) (<= j9 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___845 j9))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___845 i2))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___845 j9)))) true)) (= j9 i2)))))))))))))))
(assert (=> (not (= v 0)) (and (<= 1 v) (<= v 100))))
(assert (=> (not (= v 0)) (= o75 v)))
(assert (=> (not (= v 0)) (= o76 (select temp___845 o75))))
(assert (=> (not (= v 0)) (= o77 (us_split_fields1 o76))))
(assert (=> (not (= v 0)) (= o78 (rec__tree_model__path_type__a o77))))
(assert (=> (not (= v 0)) (and (= result23 (ole o78 o81)) (= (= result23 true) (and (<= (length o78) (length o81)) (forall ((n Int)) (=> (and (<= 1 n) (<= n (last o78))) (= (get o78 n) (get o81 n)))))))))
(assert (=> (= v 0) (= result23 false)))
