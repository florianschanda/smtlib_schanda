...
(declare-const stable_marriage__is_permutation_1__result Bool)
...
(declare-const stable_marriage__is_permutation_1__result1 Bool)
(declare-const stable_marriage__is_permutation_1__result2 Bool)
(declare-const stable_marriage__is_permutation_1__result3 Bool)
(declare-const seen8 (Array Int Bool))
(declare-const rank7 Int)
(declare-const stable_marriage__is_permutation_1__result4 Bool)
(declare-const seen9 (Array Int Bool))
(declare-const rank8 Int)
(declare-const stable_marriage__is_permutation_1__result5 Bool)
...
(assert (= (= (bool_eq1 seen6 1 64 (temp_____aggregate_def_448 (distinct 1 0)) 1 64) true) (forall ((g1 Int)) (=> (and (<= 1 g1) (<= g1 64)) (and (= (select seen6 g1) true) (exists ((rank10 Int)) (and (and (<= 1 rank10) (<= rank10 64)) (= (to_rep (select r1 rank10)) g1))))))))
(assert (= stable_marriage__is_permutation_1__result1 stable_marriage__is_permutation_1__result2))
(assert (= stable_marriage__is_permutation_1__result3 stable_marriage__is_permutation_1__result1))
(assert (= result3 stable_marriage__is_permutation_1__result))
(assert (= stable_marriage__is_permutation_1__result1 (bool_eq1 seen6 1 64 (temp_____aggregate_def_454 (distinct 1 0)) 1 64)))
(assert (= (mk_bool__ref stable_marriage__is_permutation_1__result4) (mk_bool__ref stable_marriage__is_permutation_1__result2)))
(assert (= (mk_int__ref rank7) rank9))
(assert (= (mk_map__ref1 seen8) seen10))
(assert (= stable_marriage__is_permutation_1__result5 stable_marriage__is_permutation_1__result3))
(assert (= rank8 rank6))
(assert (= seen9 seen7))
...
(assert (<= 1 g1))
(assert (<= g1 64))
(assert (not (exists ((rank10 Int)) (and (and (<= 1 rank10) (<= rank10 64)) (= (to_rep (select r1 rank10)) g1)))))
(check-sat)
(exit)
