...
(assert (not (= (let ((temp___633 (remove b i))) (let ((temp___632 (remove a i))) (bool_eq (elts temp___632) (to_rep1 (first (rt temp___632))) (to_rep1 (last (rt temp___632))) (elts temp___633) (to_rep1 (first (rt temp___633))) (to_rep1 (last (rt temp___633)))))) true)))
(check-sat)
(exit)
