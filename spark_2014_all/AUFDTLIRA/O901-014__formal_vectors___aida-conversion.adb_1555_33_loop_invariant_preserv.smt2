...
(assert (and (and (forall ((temp___1956 Int)) (=> (and (<= (to_rep1 n__first) temp___1956) (<= temp___1956 (to_rep1 n__last))) (=> (< index2 temp___1956) (= (select n3 temp___1956) (select n1 temp___1956))))) (=> (<= (+ (to_rep1 (first (rt source))) 6) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 6) (+ (to_rep1 (first (rt source))) 10) index2))) (and (<= (+ (to_rep1 (first (rt source))) 6) index2) (<= index2 (+ (to_rep1 (first (rt source))) 10)))))
(assert (not (= index2 temp___1959)))
