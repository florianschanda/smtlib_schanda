...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (and (= (to_rep (rec__discr_dyn__r2__a (us_split_discrs1 a))) (to_rep (rec__discr_dyn__r2__a (us_split_discrs1 b)))) (= (bool_eq1 (rec__discr_dyn__r2__b (us_split_fields1 a)) (rec__discr_dyn__r2__b (us_split_fields1 b))) true)) (= (rec__discr_dyn__r2__c (us_split_fields1 a)) (rec__discr_dyn__r2__c (us_split_fields1 b)))) true false))
...
(define-fun bool_eq4 ((a us_rep2) (b us_rep2)) Bool (ite (and (and (= (to_rep (rec__discr_dyn__r2__a (us_split_discrs3 a))) (to_rep (rec__discr_dyn__r2__a (us_split_discrs3 b)))) (= (bool_eq (rec__discr_dyn__r2__b2 (us_split_fields5 a)) 1 2 (rec__discr_dyn__r2__b2 (us_split_fields5 b)) 1 2) true)) (= (rec__discr_dyn__r2__c2 (us_split_fields5 a)) (rec__discr_dyn__r2__c2 (us_split_fields5 b)))) true false))
