...
(assert (= i11 1))
(assert (=> (and (<= 1 i11) (<= i11 10)) (and (and (= temp___368 outkeys_v2) (and (= temp___367 i11) (and (and (and (= (to_rep o4) (to_rep (select inkeys_v2 i11))) (= o5 (store outkeys_v2 i11 o4))) (and (= (mk_map__ref result5) (mk_map__ref outkeys_v2)) (= outkeys_v22 o5))) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k 10)) (=> (<= k i12) (= (to_rep (select outkeys_v23 k)) (to_rep (select inkeys_v2 k)))))) (and (and (and (=> (<= 1 10) (in_range2 i12)) (forall ((temp___369 Int)) (=> (and (<= 1 temp___369) (<= temp___369 10)) (=> (< i12 temp___369) (= (select outkeys_v23 temp___369) (select temp___368 temp___369)))))) (and (<= 1 i12) (<= i12 10))) (= i12 10)))))) (and (and (= i18 (mk_int__ref i12)) (= outkeys_v29 (mk_map__ref outkeys_v23))) (and (= i19 i12) (= outkeys_v210 outkeys_v23))))))
(assert (=> (and (<= 1 i11) (<= i11 10)) (= i20 i18)))
(assert (=> (and (<= 1 i11) (<= i11 10)) (= outkeys_v211 outkeys_v29)))
(assert (=> (and (<= 1 i11) (<= i11 10)) (= i21 i19)))
(assert (=> (and (<= 1 i11) (<= i11 10)) (= outkeys_v212 outkeys_v210)))
(assert (=> (not (and (<= 1 i11) (<= i11 10))) (= i20 (mk_int__ref i11))))
(assert (=> (not (and (<= 1 i11) (<= i11 10))) (= outkeys_v211 (mk_map__ref outkeys_v2))))
(assert (=> (not (and (<= 1 i11) (<= i11 10))) (= i21 i11)))
(assert (=> (not (and (<= 1 i11) (<= i11 10))) (= outkeys_v212 outkeys_v21)))
(assert (= i23 i20))
(assert (= i22 (mk_int__ref i9)))
(assert (= outkeys_v213 outkeys_v211))
(assert (= outkeys_v111 (mk_map__ref outkeys_v19)))
(assert (= i25 i21))
(assert (= i24 i10))
(assert (= outkeys_v214 outkeys_v212))
(assert (= outkeys_v112 outkeys_v110))
(assert (= (= (to_rep (select inkeys_v1 j)) (to_rep (select inkeys_v2 j))) true))
(assert (not (= (to_rep (select (map__content outkeys_v111) j)) (to_rep (select (map__content outkeys_v213) j)))))
(check-sat)
(exit)
