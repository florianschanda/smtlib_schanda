...
(assert (=> (and (<= 1 i2) (<= i2 10)) (and (and (forall ((temp___363 Int)) (=> (and (<= 1 temp___363) (<= temp___363 10)) (=> (< i3 temp___363) (= (select outkeys_v13 temp___363) (select temp___362 temp___363))))) (=> (<= 1 10) (in_range2 i3))) (and (<= 1 i3) (<= i3 10)))))
...
(assert (=> (and (<= 1 i8) (<= i8 10)) (and (and (=> (<= 1 10) (in_range2 i9)) (forall ((temp___369 Int)) (=> (and (<= 1 temp___369) (<= temp___369 10)) (=> (< i9 temp___369) (= (select outkeys_v23 temp___369) (select temp___368 temp___369)))))) (and (<= 1 i9) (<= i9 10)))))
