...
(declare-fun temp_____aggregate_def_4142 ((Array Int us_rep2) Int us_rep2) (Array Int us_rep2))
...
(assert (forall ((temp___4144 (Array Int us_rep2))) (forall ((temp___4145 Int)) (forall ((temp___4146 us_rep2)) (let ((temp___4143 (temp_____aggregate_def_4142 temp___4144 temp___4145 temp___4146))) (=> (dynamic_invariant temp___4145 true true true true) (forall ((temp___4147 Int)) (ite (= temp___4147 temp___4145) (= (select temp___4143 temp___4147) temp___4146) (= (select temp___4143 temp___4147) (select temp___4144 temp___4147))))))))))
...
(declare-const temp___9622 us_rep3)
...
(assert (= temp___9622 (mk___rep3 o28)))
(assert (= result (mk___split_fields__ref3 (mk___split_fields3 r__split_fields r__split_fields1))))
(assert (= r__split_fields2 (us_split_fields7 temp___9622)))
(assert (= r__split_fields3 (mk___split_fields__ref3 r__split_fields2)))
(assert (= r__split_fields4 r__split_fields2))
(assert (not (= (bool_eq4 (mk___rep3 (us_split_fields__content3 r__split_fields3)) (mk___rep3 (mk___split_fields3 r__split_fields (temp_____aggregate_def_4142 r__split_fields1 i (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 (rec__ar__rec2t__f2 (us_split_fields3 (rec__ar__rec5t__f5 (us_split_fields5 (select r__split_fields1 i))))) (mk___rep (mk___split_fields (of_rep e) (rec__ar__rec1t__g1 (us_split_fields1 (rec__ar__rec2t__g2 (us_split_fields3 (rec__ar__rec5t__f5 (us_split_fields5 (select r__split_fields1 i))))))))) (rec__ar__rec2t__h2 (us_split_fields3 (rec__ar__rec5t__f5 (us_split_fields5 (select r__split_fields1 i))))))) (rec__ar__rec5t__g5 (us_split_fields5 (select r__split_fields1 i))) (mk___rep (mk___split_fields (rec__ar__rec1t__f1 (us_split_fields1 (rec__ar__rec5t__h5 (us_split_fields5 (select r__split_fields1 i))))) (rec__ar__rec1t__g1 (us_split_fields1 (rec__ar__rec5t__h5 (us_split_fields5 (select r__split_fields1 i))))))))))))) true)))
(check-sat)
(exit)
