...
(declare-fun user_eq11 (component component) Bool)
(declare-const dummy11 component)
...
(declare-const bounded_dynamic_strings__Oconcat__5__result3 t1)
(declare-const temp___1078 (Array Int character))
(declare-const temp___10781 t2)
...
(declare-const temp___1079 (Array Int character))
(declare-const temp___10791 t)
...
(declare-const bounded_dynamic_strings__Oconcat__5__result7 t1)
...
(define-fun bounded_dynamic_strings__Oconcat__5__result12 () us_rep (mk___rep (mk___split_discrs bounded_dynamic_strings__Oconcat__5__result4) (mk___split_fields bounded_dynamic_strings__Oconcat__5__result5 (mk___t1 bounded_dynamic_strings__Oconcat__5__result6 bounded_dynamic_strings__Oconcat__5__result7))))
(define-fun o13 () us_rep (mk___rep (mk___split_discrs o9) (mk___split_fields o10 (mk___t1 o11 o12))))
(define-fun o14 () us_t2 (mk___t2 o7 o8))
(define-fun temp___10782 () us_t2 (mk___t2 temp___1078 temp___10781))
...
(assert (in_range5 left))
(assert (dynamic_invariant1 right true false true true))
(assert (<= (+ 1 (length2 right)) 2147483647))
(assert (= bounded_dynamic_strings__Oconcat__5__result8 (mk_sequence__ref bounded_dynamic_strings__Oconcat__5__result12)))
(assert (= bounded_dynamic_strings__Oconcat__5__result9 bounded_dynamic_strings__Oconcat__5__result12))
(assert (and (= temp___10782 (value right)) (and (dynamic_invariant2 temp___10782 true false true true) (and (and (= (elts1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 right))) temp___1078) (= (mk2 (to_rep1 (first6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right)))))) (to_rep1 (last6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right))))))) temp___10781)) (and (and (and (= (length3 temp___10782) (length2 right)) (= (to_rep1 (first4 temp___10781)) 1)) (= (to_rep1 (last4 temp___10781)) (length2 right))) (= (< 0 (length2 right)) (not (= (empty right) true))))))))
(assert (=> (<= (to_rep1 (first4 temp___10781)) (to_rep1 (last4 temp___10781))) (= o1 (+ (- (to_rep1 (last4 temp___10781)) (to_rep1 (first4 temp___10781))) 1))))
(assert (=> (not (<= (to_rep1 (first4 temp___10781)) (to_rep1 (last4 temp___10781)))) (= o1 0)))
(assert (= o2 (+ 1 o1)))
(assert (= o3 (+ 1 o2)))
(assert (= o4 (- o3 1)))
(assert (and (= o5 o4) (in_range2 o4)))
(assert (= (to_rep o) left))
(assert (= o6 (concat_singleton_left o 1 temp___1078 (to_rep1 (first4 temp___10781)) (to_rep1 (last4 temp___10781)))))
(assert (= o6 temp___1079))
(assert (= (mk 1 o5) temp___10791))
(assert (dynamic_property3 1 2147483647 (to_rep1 (first temp___10791)) (to_rep1 (last temp___10791))))
(assert (= temp___1079 o7))
(assert (= (mk2 (to_rep1 (first temp___10791)) (to_rep1 (last temp___10791))) o8))
(assert (and (= o13 (instance (+ (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right))) 1) o14)) (and (dynamic_invariant1 o13 true false true true) (and (and (= (to_rep2 o9) (+ (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right))) 1)) (= (length2 o13) (length3 o14))) (= (let ((temp___274 (value o13))) (bool_eq (elts2 temp___274) (to_rep1 (first4 (rt2 temp___274))) (to_rep1 (last4 (rt2 temp___274))) o7 (to_rep1 (first4 o8)) (to_rep1 (last4 o8)))) true)))))
(assert (= (mk_sequence__ref (mk___rep (mk___split_discrs result) (mk___split_fields result1 (mk___t1 result2 result3)))) (mk_sequence__ref (mk___rep (mk___split_discrs bounded_dynamic_strings__Oconcat__5__result) (mk___split_fields bounded_dynamic_strings__Oconcat__5__result1 (mk___t1 bounded_dynamic_strings__Oconcat__5__result2 bounded_dynamic_strings__Oconcat__5__result3))))))
(assert (= bounded_dynamic_strings__Oconcat__5__result12 o13))
(assert (= bounded_dynamic_strings__Oconcat__5__result10 bounded_dynamic_strings__Oconcat__5__result8))
(assert (= bounded_dynamic_strings__Oconcat__5__result11 bounded_dynamic_strings__Oconcat__5__result9))
(assert (= (mk___rep (mk___split_discrs result4) (mk___split_fields result5 (mk___t1 result6 result7))) (sequence__content bounded_dynamic_strings__Oconcat__5__result10)))
(assert (not (= (let ((temp___1088 (value (sequence__content bounded_dynamic_strings__Oconcat__5__result10)))) (bool_eq (elts2 temp___1088) (to_rep1 (first4 (rt2 temp___1088))) (to_rep1 (last4 (rt2 temp___1088))) (let ((temp___1087 (value right))) (concat_singleton_left (of_rep left) 1 (elts2 temp___1087) (to_rep1 (first4 (rt2 temp___1087))) (to_rep1 (last4 (rt2 temp___1087))))) (to_rep1 (first (let ((temp___1087 (value right))) (mk 1 (- (+ 1 (+ 1 (ite (<= (to_rep1 (first4 (rt2 temp___1087))) (to_rep1 (last4 (rt2 temp___1087)))) (+ (- (to_rep1 (last4 (rt2 temp___1087))) (to_rep1 (first4 (rt2 temp___1087)))) 1) 0))) 1))))) (to_rep1 (last (let ((temp___1087 (value right))) (mk 1 (- (+ 1 (+ 1 (ite (<= (to_rep1 (first4 (rt2 temp___1087))) (to_rep1 (last4 (rt2 temp___1087)))) (+ (- (to_rep1 (last4 (rt2 temp___1087))) (to_rep1 (first4 (rt2 temp___1087)))) 1) 0))) 1))))))) true)))
(check-sat)
(exit)
