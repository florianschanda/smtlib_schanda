...
(assert (=> (= (length1 (mk___t1 temp___954 temp___9541)) 0) (= temp___955 temp___956)))
(assert (=> (= (length1 (mk___t1 temp___954 temp___9541)) 0) (= (mk (to_rep1 (first2 temp___9551)) (to_rep1 (last2 temp___9551))) temp___9561)))
(assert (=> (not (= (length1 (mk___t1 temp___954 temp___9541)) 0)) (=> (<= (to_rep1 (first2 temp___9551)) (to_rep1 (last2 temp___9551))) (= o (+ (- (to_rep1 (last2 temp___9551)) (to_rep1 (first2 temp___9551))) 1)))))
(assert (=> (not (= (length1 (mk___t1 temp___954 temp___9541)) 0)) (=> (not (<= (to_rep1 (first2 temp___9551)) (to_rep1 (last2 temp___9551)))) (= o 0))))
(assert (=> (not (= (length1 (mk___t1 temp___954 temp___9541)) 0)) (=> (<= (to_rep1 (first2 temp___9541)) (to_rep1 (last2 temp___9541))) (= o1 (+ (- (to_rep1 (last2 temp___9541)) (to_rep1 (first2 temp___9541))) 1)))))
(assert (=> (not (= (length1 (mk___t1 temp___954 temp___9541)) 0)) (=> (not (<= (to_rep1 (first2 temp___9541)) (to_rep1 (last2 temp___9541)))) (= o1 0))))
(assert (=> (not (= (length1 (mk___t1 temp___954 temp___9541)) 0)) (= o2 (+ o1 o))))
(assert (=> (not (= (length1 (mk___t1 temp___954 temp___9541)) 0)) (= o3 (+ (to_rep1 (first2 temp___9541)) o2))))
(assert (=> (not (= (length1 (mk___t1 temp___954 temp___9541)) 0)) (= o4 (- o3 1))))
(assert (=> (not (= (length1 (mk___t1 temp___954 temp___9541)) 0)) (and (= o5 o4) (in_range2 o4))))
(assert (=> (not (= (length1 (mk___t1 temp___954 temp___9541)) 0)) (= (concat1 temp___954 (to_rep1 (first2 temp___9541)) (to_rep1 (last2 temp___9541)) temp___955 (to_rep1 (first2 temp___9551)) (to_rep1 (last2 temp___9551))) temp___956)))
(assert (=> (not (= (length1 (mk___t1 temp___954 temp___9541)) 0)) (= (mk (to_rep1 (first2 temp___9541)) o5) temp___9561)))
(assert (dynamic_property1 1 2147483647 (to_rep1 (first temp___9561)) (to_rep1 (last temp___9561))))
(assert (= temp___956 o6))
(assert (= (mk1 (to_rep1 (first temp___9561)) (to_rep1 (last temp___9561))) o7))
(assert (not (<= (length1 (mk___t1 o6 o7)) (+ (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 left))) (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right)))))))
(check-sat)
(exit)
