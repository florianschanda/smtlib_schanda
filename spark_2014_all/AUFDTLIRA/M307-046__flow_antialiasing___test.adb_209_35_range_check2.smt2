...
(declare-const temp___451 (Array Int character))
...
(assert (=> (<= 2 5) (and (and (<= (to_rep1 s__first) 2) (<= 2 (to_rep1 s__last))) (and (<= (to_rep1 s__first) 5) (<= 5 (to_rep1 s__last))))))
(assert (= temp___451 s))
(assert (= test__op_string_io_i__x__compl temp___451))
(assert (<= 1 1))
(assert (not (<= (to_rep1 s__first) 1)))
(check-sat)
(exit)
