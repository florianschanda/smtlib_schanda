...
(assert (not (= (ite (<= (to_rep1 (first temp___3161)) (to_rep1 (last temp___3161))) (+ (- (to_rep1 (last temp___3161)) (to_rep1 (first temp___3161))) 1) 0) (ite (<= (to_rep1 change__first) (to_rep1 change__last)) (+ (- (to_rep1 change__last) (to_rep1 change__first)) 1) 0))))
(check-sat)
(exit)
