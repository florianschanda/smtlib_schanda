...
(assert (= result11 (ite (< j o38) true false)))
(assert (=> (= result11 true) (and (= o39 (+ j 2)) (in_range1 (+ j 2)))))
(assert (=> (= result11 true) (and (= o40 (get ma1 o39)) (in_range4 o40))))
(assert (=> (not (= result11 true)) (= o40 0)))
