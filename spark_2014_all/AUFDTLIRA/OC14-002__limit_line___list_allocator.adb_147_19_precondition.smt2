...
(assert (= result11 (ite (< j o45) true false)))
(assert (=> (= result11 true) (and (= o46 (+ j 2)) (in_range1 (+ j 2)))))
(assert (=> (= result11 true) (and (= o47 (get ma1 o46)) (in_range7 o47))))
(assert (=> (not (= result11 true)) (= o47 0)))
(assert (not (<= 1 j)))
(check-sat)
(exit)
