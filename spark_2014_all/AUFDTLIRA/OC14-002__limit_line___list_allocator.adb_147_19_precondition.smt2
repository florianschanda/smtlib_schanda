...
(assert (and (= o110 (length (rec__list_allocator__m__t__available model____split_fields4))) (in_range6 o110)))
(assert (= o111 (ite (<= j6 o110) true false)))
(assert (= result27 (ite (<= 1 j6) o111 false)))
(assert (= result27 true))
(assert (and (= o112 (length (rec__list_allocator__m__t__available model____split_fields4))) (in_range6 o112)))
(assert (= result28 (ite (< j6 o112) true false)))
(assert (=> (= result28 true) (and (= o113 (+ j6 2)) (in_range1 (+ j6 2)))))
(assert (=> (= result28 true) (and (= o114 (get ma1 o113)) (in_range7 o114))))
(assert (=> (not (= result28 true)) (= o114 0)))
(assert (not (<= 1 j6)))
(check-sat)
(exit)
