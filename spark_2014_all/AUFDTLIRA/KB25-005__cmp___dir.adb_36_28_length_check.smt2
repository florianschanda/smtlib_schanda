...
(assert (forall ((name1 us_t) (directory us_t)) (forall ((resolve_links Bool)) (! (=> (and (dynamic_invariant name1 true true true) (dynamic_invariant directory true true true)) (dynamic_invariant (normalize_pathname name1 directory resolve_links) true false true)) :pattern ((normalize_pathname name1 directory resolve_links))))))
(declare-fun test (us_t us_t) us_t)
(declare-fun test__function_guard (us_t us_t us_t) Bool)
(assert (forall ((name1 us_t) (directory us_t)) (! (=> (and (dynamic_invariant name1 true true true) (dynamic_invariant directory true true true)) (dynamic_invariant (test name1 directory) true false true)) :pattern ((test name1 directory)))))
(declare-fun is_valid (us_t) Bool)
(declare-fun is_valid__function_guard (Bool us_t) Bool)
(assert true)
(assert (forall ((name1 us_t)) (! (= (is_valid name1) true) :pattern ((is_valid name1)))))
(declare-const value us_t)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-fun temp___String_Literal_132 (tuple0) (Array Int character))
(assert true)
...
(declare-datatypes () ((tresultP1__ref (mk_tresultP1__ref (tresultP1__content integer)))))
(define-fun tresultP1__ref___projection ((a tresultP1__ref)) integer (tresultP1__content a))
(declare-sort t1 0)
...
(declare-datatypes () ((result____ref (mk_result____ref (result____content us_t1)))))
(define-fun result____ref___projection ((a result____ref)) us_t1 (result____content a))
...
(assert (= value (normalize_pathname name (of_array (temp___String_Literal_132 Tuple0) 1 0) (of_int 1))))
(assert (= test_value (test name (of_array (temp___String_Literal_133 Tuple0) 1 0))))
(define-fun dynamic_invariant4 ((temp___expr_186 us_t1) (temp___is_init_183 Bool) (temp___skip_constant_184 Bool) (temp___do_toplevel_185 Bool)) Bool (=> (not (= temp___skip_constant_184 true)) (and (dynamic_property2 1 (length value) (first3 temp___expr_186) (last3 temp___expr_186)) (and (= (first3 temp___expr_186) 1) (= (last3 temp___expr_186) (length value))))))
(declare-const o Bool)
(declare-const dir__full_name__B_1__value__assume (Array Int character))
(declare-const dir__full_name__B_1__value__assume1 t)
(declare-const dir__full_name__B_1__test_value__assume (Array Int character))
(declare-const dir__full_name__B_1__test_value__assume1 t)
...
(assert (and (= (mk___t dir__full_name__B_1__value__assume dir__full_name__B_1__value__assume1) (normalize_pathname name (mk___t (temp___String_Literal_132 Tuple0) (mk 1 0)) (of_int 1))) (dynamic_invariant (mk___t dir__full_name__B_1__value__assume dir__full_name__B_1__value__assume1) true false true)))
(assert (= (mk___t dir__full_name__B_1__value__assume dir__full_name__B_1__value__assume1) value))
(assert (dynamic_invariant value true false true))
(assert (and (= (mk___t dir__full_name__B_1__test_value__assume dir__full_name__B_1__test_value__assume1) (test name (mk___t (temp___String_Literal_133 Tuple0) (mk 1 0)))) (dynamic_invariant (mk___t dir__full_name__B_1__test_value__assume dir__full_name__B_1__test_value__assume1) true false true)))
(assert (= (mk___t dir__full_name__B_1__test_value__assume dir__full_name__B_1__test_value__assume1) test_value))
(assert (dynamic_invariant test_value true false true))
(assert (not (= (ite (<= (to_rep1 (first (rt value))) (to_rep1 (last (rt value)))) (+ (- (to_rep1 (last (rt value))) (to_rep1 (first (rt value)))) 1) 0) (ite (<= 1 (length value)) (+ (- (length value) 1) 1) 0))))
(check-sat)
(exit)
