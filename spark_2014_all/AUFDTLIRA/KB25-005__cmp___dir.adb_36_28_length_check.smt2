...
(define-fun dir__full_name__B_1__test_value__assume2 () us_t (mk___t dir__full_name__B_1__test_value__assume dir__full_name__B_1__test_value__assume1))
(define-fun dir__full_name__B_1__value__assume2 () us_t (mk___t dir__full_name__B_1__value__assume dir__full_name__B_1__value__assume1))
...
(assert (and (= dir__full_name__B_1__value__assume2 (normalize_pathname name (mk___t (temp___String_Literal_132 Tuple0) (mk 1 0)) (of_int 1))) (dynamic_invariant dir__full_name__B_1__value__assume2 true false true)))
(assert (= dir__full_name__B_1__value__assume2 value))
(assert (dynamic_invariant value true false true))
(assert (and (= dir__full_name__B_1__test_value__assume2 (test name (mk___t (temp___String_Literal_133 Tuple0) (mk 1 0)))) (dynamic_invariant dir__full_name__B_1__test_value__assume2 true false true)))
