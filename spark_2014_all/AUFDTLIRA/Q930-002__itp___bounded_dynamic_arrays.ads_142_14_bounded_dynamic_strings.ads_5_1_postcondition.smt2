...
(assert (not (= (let ((temp___1143 (value (mk___rep to____split_discrs (us_split_fields__content to____split_fields5))))) (bool_eq (elts1 temp___1143) (to_rep1 (first2 (rt1 temp___1143))) (to_rep1 (last2 (rt1 temp___1143))) (let ((temp___1142 (value (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2)))))) (ite (= (length1 temp___1142) 0) (elts1 tail) (concat1 (elts1 temp___1142) (to_rep1 (first2 (rt1 temp___1142))) (to_rep1 (last2 (rt1 temp___1142))) (elts1 tail) (to_rep1 (first2 (rt1 tail))) (to_rep1 (last2 (rt1 tail)))))) (to_rep1 (first (let ((temp___1142 (value (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2)))))) (ite (= (length1 temp___1142) 0) (mk (to_rep1 (first2 (rt1 tail))) (to_rep1 (last2 (rt1 tail)))) (mk (to_rep1 (first2 (rt1 temp___1142))) (- (+ (to_rep1 (first2 (rt1 temp___1142))) (+ (ite (<= (to_rep1 (first2 (rt1 temp___1142))) (to_rep1 (last2 (rt1 temp___1142)))) (+ (- (to_rep1 (last2 (rt1 temp___1142))) (to_rep1 (first2 (rt1 temp___1142)))) 1) 0) (ite (<= (to_rep1 (first2 (rt1 tail))) (to_rep1 (last2 (rt1 tail)))) (+ (- (to_rep1 (last2 (rt1 tail))) (to_rep1 (first2 (rt1 tail)))) 1) 0))) 1)))))) (to_rep1 (last (let ((temp___1142 (value (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2)))))) (ite (= (length1 temp___1142) 0) (mk (to_rep1 (first2 (rt1 tail))) (to_rep1 (last2 (rt1 tail)))) (mk (to_rep1 (first2 (rt1 temp___1142))) (- (+ (to_rep1 (first2 (rt1 temp___1142))) (+ (ite (<= (to_rep1 (first2 (rt1 temp___1142))) (to_rep1 (last2 (rt1 temp___1142)))) (+ (- (to_rep1 (last2 (rt1 temp___1142))) (to_rep1 (first2 (rt1 temp___1142)))) 1) 0) (ite (<= (to_rep1 (first2 (rt1 tail))) (to_rep1 (last2 (rt1 tail)))) (+ (- (to_rep1 (last2 (rt1 tail))) (to_rep1 (first2 (rt1 tail)))) 1) 0))) 1)))))))) true)))
(check-sat)
(exit)
