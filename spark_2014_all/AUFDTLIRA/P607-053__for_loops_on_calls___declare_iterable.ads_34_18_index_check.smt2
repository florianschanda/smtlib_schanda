...
(define-fun dynamic_invariant ((temp___expr_161 Int) (temp___is_init_158 Bool) (temp___skip_constant_159 Bool) (temp___do_toplevel_160 Bool)) Bool (=> (or (= temp___is_init_158 true) (<= 0 100)) (in_range2 temp___expr_161)))
(declare-fun has_element (us_rep Int) Bool)
(declare-fun has_element__function_guard (Bool us_rep Int) Bool)
(assert true)
(assert (forall ((x us_rep)) (forall ((c Int)) (! (= (= (has_element x c) true) (in_range1 c)) :pattern ((has_element x c))))))
