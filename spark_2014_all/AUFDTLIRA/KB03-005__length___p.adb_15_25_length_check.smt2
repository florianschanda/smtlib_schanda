...
(assert (forall ((temp___225 Int) (temp___226 Int) (temp___227 Int)) (let ((temp___224 (p__a__aggregate_def temp___225 temp___226 temp___227))) (=> (dynamic_invariant temp___225 true true true true) (and (=> (dynamic_property4 (- 2147483648) 2147483647 temp___226 temp___227) (and (= (first3 temp___224) temp___226) (= (last3 temp___224) temp___227))) (forall ((temp___228 Int)) (= (to_rep (select (to_array1 temp___224) temp___228)) temp___225)))))))
(define-fun dynamic_invariant2 ((temp___expr_218 us_t) (temp___is_init_214 Bool) (temp___skip_constant_215 Bool) (temp___do_toplevel_216 Bool) (temp___do_typ_inv_217 Bool)) Bool (=> (not (= temp___skip_constant_215 true)) (and (dynamic_property1 r4b 10 (first1 temp___expr_218) (last1 temp___expr_218)) (and (= (first1 temp___expr_218) r4b) (= (last1 temp___expr_218) 10)))))
...
(assert (= (mk___t1 temp___230 temp___2301) (p__a__aggregate_def 0 r4b 10)))
(assert (not (= (ite (<= (to_rep (first2 temp___2301)) (to_rep (last2 temp___2301))) (+ (- (to_rep (last2 temp___2301)) (to_rep (first2 temp___2301))) 1) 0) (ite (<= r4b 10) (+ (- 10 r4b) 1) 0))))
(check-sat)
(exit)
