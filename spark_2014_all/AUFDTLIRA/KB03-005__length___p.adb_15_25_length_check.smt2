...
(assert (forall ((temp___194 Int) (temp___195 Int) (temp___196 Int)) (let ((temp___193 (p__a__aggregate_def temp___194 temp___195 temp___196))) (and (=> (dynamic_property4 (- 2147483648) 2147483647 temp___195 temp___196) (and (= (first3 temp___193) temp___195) (= (last3 temp___193) temp___196))) (forall ((temp___197 Int)) (= (select (to_array1 temp___193) temp___197) (of_rep temp___194)))))))
(define-fun dynamic_invariant1 ((temp___expr_187 us_t) (temp___is_init_184 Bool) (temp___skip_constant_185 Bool) (temp___do_toplevel_186 Bool)) Bool (=> (not (= temp___skip_constant_185 true)) (and (dynamic_property1 r4b 10 (first1 temp___expr_187) (last1 temp___expr_187)) (and (= (first1 temp___expr_187) r4b) (= (last1 temp___expr_187) 10)))))
...
(assert (= (mk___t1 temp___199 temp___1991) (p__a__aggregate_def 0 r4b 10)))
(assert (not (= (ite (<= (to_rep (first2 temp___1991)) (to_rep (last2 temp___1991))) (+ (- (to_rep (last2 temp___1991)) (to_rep (first2 temp___1991))) 1) 0) (ite (<= r4b 10) (+ (- 10 r4b) 1) 0))))
(check-sat)
(exit)
