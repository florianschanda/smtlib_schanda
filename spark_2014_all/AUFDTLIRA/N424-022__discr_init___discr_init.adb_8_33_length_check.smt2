...
(declare-const temp___2341 (Array Int Bool))
(declare-const temp___237 (Array Int Bool))
(declare-const temp___2371 t)
...
(assert (= 10 (to_rep temp___234)))
(assert (discr_init__r1__arr__pred1 (mk___rep1 (mk___split_discrs temp___234) (mk___split_fields1 temp___2341))))
(assert (= (to_rep (first (rt (temp_____aggregate_def_221 (distinct 1 0) 1 10)))) 1))
(assert (= (to_rep (last (rt (temp_____aggregate_def_221 (distinct 1 0) 1 10)))) 10))
(assert (= (mk___t temp___237 temp___2371) (temp_____aggregate_def_221 (distinct 1 0) 1 10)))
(assert (not (= (ite (<= (to_rep (first temp___2371)) (to_rep (last temp___2371))) (+ (- (to_rep (last temp___2371)) (to_rep (first temp___2371))) 1) 0) (ite (<= 1 10) (+ (- 10 1) 1) 0))))
(check-sat)
(exit)
