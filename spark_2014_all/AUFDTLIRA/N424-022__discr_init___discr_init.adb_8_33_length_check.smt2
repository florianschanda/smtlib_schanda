...
(assert (discr_init__r1__arr__pred1 (mk___rep1 (mk___split_discrs temp___198) (mk___split_fields1 temp___1981))))
...
(assert (not (= (ite (<= (to_rep (first temp___2011)) (to_rep (last temp___2011))) (+ (- (to_rep (last temp___2011)) (to_rep (first temp___2011))) 1) 0) (ite (<= 1 10) (+ (- 10 1) 1) 0))))
(check-sat)
(exit)
