...
(declare-const temp___229 integer)
(declare-const temp___2291 (Array Int Bool))
(declare-const temp___232 (Array Int Bool))
(declare-const temp___2321 t)
(assert (in_range1 temp___j_228))
(assert (and (= us 10) (in_range1 10)))
(assert (= 10 (to_rep temp___229)))
(assert (discr_init__r1__arr__pred1 (mk___rep1 (mk___split_discrs temp___229) (mk___split_fields1 temp___2291))))
(assert (= (to_rep (first (rt (temp___221 (distinct 1 0) 1 10)))) 1))
(assert (= (to_rep (last (rt (temp___221 (distinct 1 0) 1 10)))) 10))
(assert (= (mk___t temp___232 temp___2321) (temp___221 (distinct 1 0) 1 10)))
(assert (not (= (ite (<= (to_rep (first temp___2321)) (to_rep (last temp___2321))) (+ (- (to_rep (last temp___2321)) (to_rep (first temp___2321))) 1) 0) (ite (<= 1 10) (+ (- 10 1) 1) 0))))
(check-sat)
(exit)
