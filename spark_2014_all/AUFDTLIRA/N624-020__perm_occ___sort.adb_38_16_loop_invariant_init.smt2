...
(define-fun dynamic_invariant3 ((temp___expr_147 Int) (temp___is_init_144 Bool) (temp___skip_constant_145 Bool) (temp___do_toplevel_146 Bool)) Bool (=> (or (= temp___is_init_144 true) (<= 0 100)) (in_range5 temp___expr_147)))
(declare-fun occ_def (us_t Int) Int)
(declare-fun occ_def__function_guard (Int us_t Int) Bool)
(assert (forall ((a us_t)) (forall ((e Int)) (! (=> (and (dynamic_invariant2 a true true true) (dynamic_invariant1 e true true true)) (let ((result (occ a e))) (and (<= result (length a)) (dynamic_invariant3 result true false true)))) :pattern ((occ a e))))))
(assert (forall ((a us_t)) (forall ((e Int)) (! (=> (and (dynamic_invariant2 a true true true) (dynamic_invariant1 e true true true)) (= (occ a e) (occ_def a e))) :pattern ((occ a e))))))
(declare-fun is_set (us_t Int Int us_t) Bool)
(declare-fun is_set__function_guard (Bool us_t Int Int us_t) Bool)
(define-fun dynamic_invariant4 ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= 1 100)) (in_range4 temp___expr_136)))
(assert true)
...
(assert (forall ((a us_t)) (! (=> (dynamic_invariant2 a true true true) (= (remove_last a) (let ((temp___159 (let ((temp___158 (- (last1 a) 1))) (let ((temp___157 (first1 a))) (of_array3 (to_array a) temp___157 temp___158))))) (of_array (to_array3 temp___159) (first7 temp___159) (last7 temp___159))))) :pattern ((remove_last a)))))
(assert (forall ((a us_t)) (forall ((e Int)) (! (=> (and (dynamic_invariant2 a true true true) (dynamic_invariant1 e true true true)) (= (occ_def a e) (ite (= (length a) 0) 0 (ite (= (to_rep (select (to_array a) (last1 a))) e) (+ (occ_def (remove_last a) e) 1) (occ_def (remove_last a) e))))) :pattern ((occ_def a e))))))
(define-fun dynamic_invariant7 ((temp___expr_201 us_t2) (temp___is_init_198 Bool) (temp___skip_constant_199 Bool) (temp___do_toplevel_200 Bool)) Bool (=> (not (= temp___skip_constant_199 true)) (and (dynamic_property4 (to_rep1 values__first) (to_rep1 values__last) (first5 temp___expr_201) (last5 temp___expr_201)) (and (= (first5 temp___expr_201) (to_rep1 values__first)) (= (last5 temp___expr_201) (to_rep1 values__last))))))
...
(assert (= o9 y))
(assert (= o10 (select (elts1 init) o9)))
(assert (= o11 (to_rep o10)))
(assert (and (= o8 x) (in_range4 x)))
(assert (ite (= o11 (to_rep (select (elts1 init) o8))) (= (occ (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last))) e1) (occ (mk___t (elts1 init) (mk (to_rep1 (first2 (rt1 init))) (to_rep1 (last2 (rt1 init))))) e1)) (ite (= o11 e1) (= (occ (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last))) e1) (+ (occ (mk___t (elts1 init) (mk (to_rep1 (first2 (rt1 init))) (to_rep1 (last2 (rt1 init))))) e1) 1)) (ite (= (to_rep (select (elts1 init) o8)) e1) (= (occ (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last))) e1) (- (occ (mk___t (elts1 init) (mk (to_rep1 (first2 (rt1 init))) (to_rep1 (last2 (rt1 init))))) e1) 1)) (= (occ (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last))) e1) (occ (mk___t (elts1 init) (mk (to_rep1 (first2 (rt1 init))) (to_rep1 (last2 (rt1 init))))) e1))))))
(assert (and (<= (to_rep1 (first2 (rt1 init))) x) (<= x (to_rep1 (last2 (rt1 init))))))
(assert (= o13 x))
(assert (= o14 (select (elts1 init) o13)))
(assert (= o15 (to_rep o14)))
(assert (and (= o12 y) (in_range4 y)))
(assert (ite (= o15 (to_rep (select interm o12))) (= (occ (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last))) e1) (occ (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last))) e1)) (ite (= o15 e1) (= (occ (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last))) e1) (+ (occ (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last))) e1) 1)) (ite (= (to_rep (select interm o12)) e1) (= (occ (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last))) e1) (- (occ (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last))) e1) 1)) (= (occ (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last))) e1) (occ (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last))) e1))))))
(declare-const f Int)
(assert (<= 0 f))
(assert (<= f e1))
