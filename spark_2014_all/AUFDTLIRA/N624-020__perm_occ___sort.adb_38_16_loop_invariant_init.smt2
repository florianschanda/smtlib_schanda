...
(define-fun dynamic_invariant2 ((temp___expr_166 us_t) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool (=> (not (= temp___skip_constant_163 true)) (dynamic_property 1 100 (first1 temp___expr_166) (last1 temp___expr_166))))
...
(define-fun dynamic_invariant3 ((temp___expr_172 Int) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool) (temp___do_typ_inv_171 Bool)) Bool (=> (or (= temp___is_init_168 true) (<= 0 100)) (in_range5 temp___expr_172)))
(declare-fun occ_def (us_t Int) Int)
(declare-fun occ_def__function_guard (Int us_t Int) Bool)
(assert (forall ((a us_t)) (forall ((e Int)) (! (=> (and (dynamic_invariant2 a true true true true) (dynamic_invariant1 e true true true true)) (let ((result (occ a e))) (and (<= result (length a)) (dynamic_invariant3 result true false true true)))) :pattern ((occ a e))))))
(assert (forall ((a us_t)) (forall ((e Int)) (! (=> (and (dynamic_invariant2 a true true true true) (dynamic_invariant1 e true true true true)) (= (occ a e) (occ_def a e))) :pattern ((occ a e))))))
(declare-fun is_set (us_t Int Int us_t) Bool)
(declare-fun is_set__function_guard (Bool us_t Int Int us_t) Bool)
(define-fun dynamic_invariant4 ((temp___expr_159 Int) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool) (temp___do_typ_inv_158 Bool)) Bool (=> (or (= temp___is_init_155 true) (<= 1 100)) (in_range4 temp___expr_159)))
(assert true)
...
(assert (forall ((a us_t)) (! (=> (dynamic_invariant2 a true true true true) (= (remove_last a) (let ((temp___184 (let ((temp___183 (- (last1 a) 1))) (let ((temp___182 (first1 a))) (of_array3 (to_array a) temp___182 temp___183))))) (of_array (to_array3 temp___184) (first7 temp___184) (last7 temp___184))))) :pattern ((remove_last a)))))
(assert (forall ((a us_t)) (forall ((e Int)) (! (=> (and (dynamic_invariant2 a true true true true) (dynamic_invariant1 e true true true true)) (= (occ_def a e) (ite (= (length a) 0) 0 (ite (= (to_rep (select (to_array a) (last1 a))) e) (+ (occ_def (remove_last a) e) 1) (occ_def (remove_last a) e))))) :pattern ((occ_def a e))))))
(define-fun dynamic_invariant7 ((temp___expr_229 us_t2) (temp___is_init_225 Bool) (temp___skip_constant_226 Bool) (temp___do_toplevel_227 Bool) (temp___do_typ_inv_228 Bool)) Bool (=> (not (= temp___skip_constant_226 true)) (and (dynamic_property4 (to_rep1 values__first) (to_rep1 values__last) (first5 temp___expr_229) (last5 temp___expr_229)) (and (= (first5 temp___expr_229) (to_rep1 values__first)) (= (last5 temp___expr_229) (to_rep1 values__last))))))
...
(assert (and (and (<= (to_rep1 values__first) x) (<= x (to_rep1 values__last))) (and (and (<= (to_rep1 values__first) y) (<= y (to_rep1 values__last))) (and (= (is_set (mk___t (elts1 init) (mk (to_rep1 (first2 (rt1 init))) (to_rep1 (last2 (rt1 init))))) x (to_rep (select (elts1 init) y)) (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last)))) true) (= (is_set (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last))) y (to_rep (select (elts1 init) x)) (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last)))) true)))))
(assert (= (mk_int__ref result) (mk_int__ref e)))
(assert (= e1 0))
(assert (<= 0 e1))
(assert (<= e1 2147483647))
(assert (and (<= (to_rep1 (first2 (rt1 init))) y) (<= y (to_rep1 (last2 (rt1 init))))))
(assert (= o1 y))
(assert (= o2 (select (elts1 init) o1)))
(assert (= o3 (to_rep o2)))
(assert (and (= o x) (in_range4 x)))
(assert (ite (= o3 (to_rep (select (elts1 init) o))) (= (occ (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last))) e1) (occ (mk___t (elts1 init) (mk (to_rep1 (first2 (rt1 init))) (to_rep1 (last2 (rt1 init))))) e1)) (ite (= o3 e1) (= (occ (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last))) e1) (+ (occ (mk___t (elts1 init) (mk (to_rep1 (first2 (rt1 init))) (to_rep1 (last2 (rt1 init))))) e1) 1)) (ite (= (to_rep (select (elts1 init) o)) e1) (= (occ (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last))) e1) (- (occ (mk___t (elts1 init) (mk (to_rep1 (first2 (rt1 init))) (to_rep1 (last2 (rt1 init))))) e1) 1)) (= (occ (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last))) e1) (occ (mk___t (elts1 init) (mk (to_rep1 (first2 (rt1 init))) (to_rep1 (last2 (rt1 init))))) e1))))))
(assert (and (<= (to_rep1 (first2 (rt1 init))) x) (<= x (to_rep1 (last2 (rt1 init))))))
(assert (= o5 x))
(assert (= o6 (select (elts1 init) o5)))
(assert (= o7 (to_rep o6)))
(assert (and (= o4 y) (in_range4 y)))
(assert (ite (= o7 (to_rep (select interm o4))) (= (occ (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last))) e1) (occ (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last))) e1)) (ite (= o7 e1) (= (occ (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last))) e1) (+ (occ (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last))) e1) 1)) (ite (= (to_rep (select interm o4)) e1) (= (occ (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last))) e1) (- (occ (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last))) e1) 1)) (= (occ (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last))) e1) (occ (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last))) e1))))))
(declare-const f Int)
(assert (<= 0 f))
(assert (<= f e1))
(assert (not (= (occ (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last))) f) (occ (mk___t (elts1 init) (mk (to_rep1 (first2 (rt1 init))) (to_rep1 (last2 (rt1 init))))) f))))
(check-sat)
(exit)
