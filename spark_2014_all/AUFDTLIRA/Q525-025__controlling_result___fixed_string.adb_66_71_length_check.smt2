...
(assert (not (= (ite (<= (to_rep1 (first2 temp___2341)) (to_rep1 (last2 temp___2341))) (+ (- (to_rep1 (last2 temp___2341)) (to_rep1 (first2 temp___2341))) 1) 0) (ite (<= (to_rep1 (first2 temp___2361)) (to_rep1 (last2 temp___2361))) (+ (- (to_rep1 (last2 temp___2361)) (to_rep1 (first2 temp___2361))) 1) 0))))
(check-sat)
(exit)
