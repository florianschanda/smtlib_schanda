...
(assert (and (= (mk___rep (mk___split_fields o18 o19)) (state__2 (us_split_fields__content my_stack__split_fields4))) (= (us_split_fields__content my_stack__split_fields4) (mk___split_fields o18 o19))))
(assert (and (= o20 (count (mk___rep (mk___split_fields o18 o19)))) (and (in_range2 o20) (= o20 (to_rep1 o19)))))
