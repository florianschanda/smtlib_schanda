...
(declare-fun user_eq3 (index_range index_range) Bool)
(declare-const dummy3 index_range)
...
(assert (and (= o40 (state__2 (us_split_fields__content my_stack__split_fields4))) (= o40 (mk___rep (us_split_fields__content my_stack__split_fields4)))))
(assert (and (= o41 (count o40)) (and (in_range2 o41) (= o41 (to_rep1 (rec__stack_functional_spec__stack_type__pointer (us_split_fields1 o40)))))))
(assert (= o42 (- o41 2)))
(assert (= o43 (ite (<= i o42) true false)))
(assert (= result3 (ite (<= 1 i) o43 false)))
(assert (= (= o44 true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (- (count (state__2 (us_split_fields__content my_stack__split_fields4))) 2))) (= (stack_entry (state__2 (us_split_fields__content my_stack__split_fields4)) i1) (stack_entry (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1)) i1))))))
(assert (and (= o45 (state__2 (us_split_fields__content my_stack__split_fields4))) (= (us_split_fields__content my_stack__split_fields4) (mk___split_fields o34 o35))))
(assert (and (= o36 (count o45)) (and (in_range2 o36) (= o36 (to_rep1 o35)))))
(assert (and (= o37 (stack_entry (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1)) o36)) (and (in_range1 o37) (= o37 (to_rep (select (rec__stack_functional_spec__stack_type__s (us_split_fields1 (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1)))) o36))))))
(assert (and (= o46 (state__2 (us_split_fields__content my_stack__split_fields4))) (= (us_split_fields__content my_stack__split_fields4) (mk___split_fields o29 o30))))
(assert (and (= o31 (count o46)) (and (in_range2 o31) (= o31 (to_rep1 o30)))))
(assert (= o32 (- o31 1)))
(assert (and (= o33 o32) (in_range2 o32)))
(assert (and (= o47 (state__2 (us_split_fields__content my_stack__split_fields4))) (= (us_split_fields__content my_stack__split_fields4) (mk___split_fields o27 o28))))
(assert (and (= o38 (stack_entry o47 o33)) (and (in_range1 o38) (= o38 (to_rep (select o27 o33))))))
(assert (= o39 (ite (= o38 o37) true false)))
(assert (and (= o48 (state__2 (us_split_fields__content my_stack__split_fields4))) (= (us_split_fields__content my_stack__split_fields4) (mk___split_fields o21 o22))))
(assert (and (= o23 (count o48)) (and (in_range2 o23) (= o23 (to_rep1 o22)))))
(assert (= o24 (- o23 1)))
(assert (and (= o25 o24) (in_range2 o24)))
(assert (and (= o26 (stack_entry (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1)) o25)) (and (in_range1 o26) (= o26 (to_rep (select (rec__stack_functional_spec__stack_type__s (us_split_fields1 (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1)))) o25))))))
(assert (and (= o49 (state__2 (us_split_fields__content my_stack__split_fields4))) (= (us_split_fields__content my_stack__split_fields4) (mk___split_fields o18 o19))))
(assert (and (= o20 (count o49)) (and (in_range2 o20) (= o20 (to_rep1 o19)))))
(assert (and (= (mk___rep (mk___split_fields o16 o17)) (state__2 (us_split_fields__content my_stack__split_fields4))) (= (us_split_fields__content my_stack__split_fields4) (mk___split_fields o16 o17))))
(assert (not (<= 1 o20)))
(check-sat)
(exit)
