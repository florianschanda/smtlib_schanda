...
(assert (and (= o50 (state__2 (us_split_fields__content my_stack__split_fields4))) (= (us_split_fields__content my_stack__split_fields4) (mk___split_fields o16 o17))))
(assert (not (<= o20 (count o50))))
(check-sat)
(exit)
