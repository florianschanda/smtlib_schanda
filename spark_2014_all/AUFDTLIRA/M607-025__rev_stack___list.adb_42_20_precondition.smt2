...
(assert (and (= o20 (length2 (mk___rep1 res__split_discrs res__split_fields2))) (and (in_range6 o20) (<= o20 (capacity (mk___rep1 res__split_discrs res__split_fields2))))))
(assert (= result6 (ite (= o20 o19) true false)))
(assert (=> (= result6 true) (and (= o15 (- last5 i9)) (in_range1 (- last5 i9)))))
(assert (=> (= result6 true) (= o16 (+ o15 1))))
(assert (=> (= result6 true) (and (= o17 o16) (in_range1 o16))))
(assert (=> (= result6 true) (and (= o14 (to__ (mk___rep s__split_fields9))) (and (dynamic_invariant1 o14 true false true true) (and (= (to_rep (first (rt o14))) 1) (<= 0 (to_rep (last (rt o14)))))))))
...
(assert (and (= o9 (get (model__ l) o8)) (and (in_range8 o9) (= o9 (get (model__ l) o8)))))
