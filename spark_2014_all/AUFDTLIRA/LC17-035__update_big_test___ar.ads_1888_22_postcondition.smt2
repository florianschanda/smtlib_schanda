...
(assert (forall ((temp___4275 (Array Int us_rep))) (forall ((temp___4276 Int)) (forall ((temp___4277 us_rep)) (let ((temp___4274 (temp___4273 temp___4275 temp___4276 temp___4277))) (forall ((temp___4278 Int)) (ite (= temp___4278 temp___4276) (= (select temp___4274 temp___4278) temp___4277) (= (select temp___4274 temp___4278) (select temp___4275 temp___4278)))))))))
(declare-fun temp___4280 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___4282 (Array Int et1))) (forall ((temp___4283 Int) (temp___4284 Int)) (let ((temp___4281 (temp___4280 temp___4282 temp___4283 temp___4284))) (forall ((temp___4285 Int)) (ite (= temp___4285 temp___4283) (= (select temp___4281 temp___4285) (of_rep temp___4284)) (= (select temp___4281 temp___4285) (select temp___4282 temp___4285))))))))
...
(assert (not (= (bool_eq3 (mk___rep1 (mk___split_fields1 r__split_fields4 r__split_fields5)) (mk___rep1 (mk___split_fields1 (temp___4273 r__split_fields i (mk___rep (mk___split_fields (temp___4280 (rec__ar__rofa1__s1 (us_split_fields1 (select r__split_fields i))) j e) (rec__ar__rofa1__t1 (us_split_fields1 (select r__split_fields i)))))) r__split_fields1))) true)))
(check-sat)
(exit)
