...
(define-fun dynamic_invariant1 ((temp___expr_153 us_rep) (temp___is_init_150 Bool) (temp___skip_constant_151 Bool) (temp___do_toplevel_152 Bool)) Bool (and (=> (= temp___do_toplevel_152 true) (=> (= temp___is_init_150 true) (<= (to_rep1 (rec__integer_stacks__stack__top (us_split_fields1 temp___expr_153))) (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 temp___expr_153)))))) (let ((temp___155 (rec__integer_stacks__stack__capacity (us_split_discrs1 temp___expr_153)))) (and (dynamic_property1 1 (to_rep temp___155) (first1 (rec__integer_stacks__stack__values (us_split_fields1 temp___expr_153))) (last1 (rec__integer_stacks__stack__values (us_split_fields1 temp___expr_153)))) (and (= (first1 (rec__integer_stacks__stack__values (us_split_fields1 temp___expr_153))) 1) (= (last1 (rec__integer_stacks__stack__values (us_split_fields1 temp___expr_153))) (to_rep temp___155)))))))
(define-fun dynamic_predicate ((temp___157 us_rep)) Bool (<= (to_rep1 (rec__integer_stacks__stack__top (us_split_fields1 temp___157))) (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 temp___157)))))
...
(define-fun dynamic_predicate1 ((temp___213 us_rep1)) Bool (<= (to_rep1 (rec__integer_stacks__stack__top (us_split_fields1 (to_base temp___213)))) (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 (to_base temp___213))))))
...
(define-fun dynamic_invariant5 ((temp___expr_234 us_rep3) (temp___is_init_231 Bool) (temp___skip_constant_232 Bool) (temp___do_toplevel_233 Bool)) Bool (and (and (=> (not (= temp___skip_constant_232 true)) (in_range7 (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 left))) (to_base2 temp___expr_234))) (=> (= temp___do_toplevel_233 true) (=> (= temp___is_init_231 true) (<= (to_rep1 (rec__integer_stacks__stack__top (us_split_fields1 (to_base2 temp___expr_234)))) (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 (to_base2 temp___expr_234)))))))) (and (dynamic_property7 1 (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 left))) (first7 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_234))) (last7 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_234)))) (and (= (first7 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_234))) 1) (= (last7 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_234))) (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 left))))))))
(define-fun default_initial_assumption ((temp___expr_238 us_rep3) (temp___skip_top_level_239 Bool)) Bool (and (and (= (attr__tag3 temp___expr_238) us_tag3) (and (= (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs4 temp___expr_238))) (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 left)))) (= (to_rep1 (rec__integer_stacks__stack__top3 (us_split_fields7 temp___expr_238))) 0))) (=> (not (= temp___skip_top_level_239 true)) (= (empty (to_base2 temp___expr_238)) true))))
(define-fun dynamic_predicate2 ((temp___245 us_rep3)) Bool (<= (to_rep1 (rec__integer_stacks__stack__top (us_split_fields1 (to_base2 temp___245)))) (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 (to_base2 temp___245))))))
...
(define-fun dynamic_invariant6 ((temp___expr_218 us_rep2) (temp___is_init_215 Bool) (temp___skip_constant_216 Bool) (temp___do_toplevel_217 Bool)) Bool (and (and (=> (not (= temp___skip_constant_216 true)) (in_range6 (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 right))) (to_base1 temp___expr_218))) (=> (= temp___do_toplevel_217 true) (=> (= temp___is_init_215 true) (<= (to_rep1 (rec__integer_stacks__stack__top (us_split_fields1 (to_base1 temp___expr_218)))) (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 (to_base1 temp___expr_218)))))))) (and (dynamic_property5 1 (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 right))) (first5 (rec__integer_stacks__stack__values2 (us_split_fields5 temp___expr_218))) (last5 (rec__integer_stacks__stack__values2 (us_split_fields5 temp___expr_218)))) (and (= (first5 (rec__integer_stacks__stack__values2 (us_split_fields5 temp___expr_218))) 1) (= (last5 (rec__integer_stacks__stack__values2 (us_split_fields5 temp___expr_218))) (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 right))))))))
(define-fun default_initial_assumption1 ((temp___expr_222 us_rep2) (temp___skip_top_level_223 Bool)) Bool (and (and (= (attr__tag2 temp___expr_222) us_tag2) (and (= (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs3 temp___expr_222))) (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 right)))) (= (to_rep1 (rec__integer_stacks__stack__top2 (us_split_fields5 temp___expr_222))) 0))) (=> (not (= temp___skip_top_level_223 true)) (= (empty (to_base1 temp___expr_222)) true))))
(define-fun dynamic_predicate3 ((temp___229 us_rep2)) Bool (<= (to_rep1 (rec__integer_stacks__stack__top (us_split_fields1 (to_base1 temp___229)))) (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 (to_base1 temp___229))))))
