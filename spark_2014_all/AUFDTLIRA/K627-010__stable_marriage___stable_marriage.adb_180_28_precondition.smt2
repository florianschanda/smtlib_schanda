...
(assert (<= 1 g21))
(assert (<= g21 64))
(assert (forall ((prev Int)) (=> (and (<= 1 prev) (<= prev (- g22 1))) (= (bool_eq2 (select result__2 prev) 1 64 (invert_1 (select r2 prev)) 1 64) true))))
...
(assert (not (= (is_permutation_1 (select r2 g22)) true)))
(check-sat)
(exit)
