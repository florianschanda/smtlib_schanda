...
(assert (= (= result1 true) (exists ((ib1 Int)) (and (and (<= (to_rep1 (first (rt b))) ib1) (<= ib1 (to_rep1 (last (rt b))))) (and (= (to_rep (select (elts a) ia1)) (to_rep (select (elts b) ib1))) (= (is_perm (remove a ia1) (remove b ib1)) true))))))
...
(assert (forall ((ka Int)) (=> (and (<= 1 ka) (<= ka ia2)) (forall ((kb Int)) (=> (and (<= (to_rep1 (first (rt b))) kb) (<= kb (to_rep1 (last (rt b))))) (not (and (= (to_rep (select (elts a) ka)) (to_rep (select (elts b) kb))) (= (is_perm (remove a ka) (remove b kb)) true))))))))
