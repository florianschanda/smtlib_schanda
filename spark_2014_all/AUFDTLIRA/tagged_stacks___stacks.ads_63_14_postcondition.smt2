...
(assert (= s__split_fields1 s__split_fields5))
(assert (= s__split_fields2 s__split_fields6))
(assert (= s__split_fields3 s__split_fields7))
...
(assert (= s__split_fields4 s__split_fields8))
(assert (= s__split_fields5 s__split_fields9))
(assert (= rliteral2 s__split_fields10))
(assert (= s__split_fields7 s__split_fields11))
