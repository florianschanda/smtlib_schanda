...
(define-fun dynamic_invariant1 ((temp___expr_173 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool) (temp___do_typ_inv_172 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= 0 5)) (in_range1 temp___expr_173)))
...
(assert (forall ((temp___156 Int) (temp___157 Int)) (let ((temp___155 (foo__cpu_lsid_last__aggregate_def temp___156 temp___157))) (=> (and (dynamic_invariant1 temp___156 true true true true) (dynamic_invariant1 temp___157 true true true true)) (and (= (to_rep (select temp___155 0)) temp___156) (= (to_rep (select temp___155 1)) temp___157))))))
...
(declare-const temp___max_id_241 Int)
(assert (=> (<= 0 1) (in_range cpu_id)))
(assert (= (foo__cpu_lsid_last__aggregate_def 3 4) cpu_lsid_last))
(assert (in_range1 temp___max_id_241))
(assert (<= 0 temp___max_id_241))
(assert (not (<= 0 0)))
(check-sat)
(exit)
