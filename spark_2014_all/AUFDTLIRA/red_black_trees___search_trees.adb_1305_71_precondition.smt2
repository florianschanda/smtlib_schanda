...
(assert (and (= temp___1991 (model__ (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) o9)) (and (dynamic_invariant8 temp___1991 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1991 o9))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1991 o9)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 o9)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1991 (parent (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1991 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1991 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1991 i1))) true) (not (= i1 o9))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1991 (parent (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) i1)))) (position (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1991 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1991 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1991 i1))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1991 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1991 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1991 j1)))) true)) (= j1 i1))))))))))))))
(assert (= o10 (select temp___1991 j)))
...
(assert (=> (= result2 true) (and (= temp___1993 (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o5)) (and (dynamic_invariant8 temp___1993 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1993 o5))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1993 o5)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 o5)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1993 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1993 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1993 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1993 i1))) true) (not (= i1 o5))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1993 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))) (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1993 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1993 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1993 i1))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1993 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1993 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1993 j1)))) true)) (= j1 i1)))))))))))))))
(assert (=> (= result2 true) (= o6 (select temp___1993 j))))
(assert (=> (= result2 true) (= o7 (us_split_fields1 o6))))
(assert (=> (= result2 true) (= o8 (rec__tree_model__path_type__a o7))))
(assert (=> (= result2 true) (and (= o1 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) (in_range3 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))))))
(assert (=> (= result2 true) (and (= temp___1992 (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o1)) (and (dynamic_invariant8 temp___1992 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1992 o1))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1992 o1)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 o1)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1992 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1992 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1992 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1992 i1))) true) (not (= i1 o1))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1992 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))) (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1992 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1992 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1992 i1))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1992 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1992 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1992 j1)))) true)) (= j1 i1)))))))))))))))
(assert (=> (= result2 true) (= o2 (select temp___1992 l))))
(assert (=> (= result2 true) (= o3 (us_split_fields1 o2))))
(assert (=> (= result2 true) (= o4 (rec__tree_model__path_type__a o3))))
(assert (=> (= result2 true) (and (= result1 (olt o4 o8)) (= (= result1 true) (and (< (length o4) (length o8)) (forall ((n Int)) (=> (and (<= 1 n) (<= n (last o4))) (= (get o4 n) (get o8 n)))))))))
...
(assert (not (= (valid_root (rec__search_trees__search_tree__struct (us_split_fields7 t)) o12) true)))
(check-sat)
(exit)
