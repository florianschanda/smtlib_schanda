...
(assert (and (= temp___1927 (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o3)) (and (dynamic_invariant8 temp___1927 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1927 o3))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1927 o3)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 o3)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1927 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1927 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1927 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1927 i1))) true) (not (= i1 o3))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select temp___1927 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))) (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1927 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1927 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1927 i1))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1927 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select temp___1927 i1))) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1927 j1)))) true)) (= j1 i1))))))))))))))
(assert (= o4 (select temp___1927 ki1)))
...
(assert (=> (= result2 true) (and (= temp___1928 (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o)) (and (dynamic_invariant8 temp___1928 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1928 o))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1928 o)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 o)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1928 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1928 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1928 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1928 i1))) true) (not (= i1 o))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select temp___1928 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))) (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1928 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1928 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1928 i1))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1928 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select temp___1928 i1))) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1928 j1)))) true)) (= j1 i1)))))))))))))))
(assert (=> (= result2 true) (= o1 (select temp___1928 j))))
(assert (=> (= result2 true) (= o2 (us_split_fields5 o1))))
(assert (=> (= result2 true) (= o6 (rec__tree_model__path_type__k o2))))
(assert (=> (not (= result2 true)) (= o6 false)))
(assert (= result1 (ite (and (= o6 true) (not (= j i))) true false)))
(assert (= result1 true))
