...
(assert (= (elts (to_string (attr__ATTRIBUTE_IMAGE3 x))) temp___1282))
(assert (= (mk1 (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 x))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 x)))))) temp___12821))
(assert (not (dynamic_predicate (mk___t1 temp___1282 temp___12821))))
(check-sat)
(exit)
