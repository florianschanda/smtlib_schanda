...
(declare-const temp___376 (Array Int natural))
(declare-const temp___3761 t1)
(declare-const j Int)
...
(declare-const res2 (Array Int natural))
(declare-const loops_static__loop10__result4 (Array Int natural))
(declare-const loops_static__loop10__result5 t)
(declare-const result2 (Array Int natural))
(declare-const r3 (Array Int natural))
(declare-const res3 (Array Int natural))
(declare-const loops_static__loop10__result6 (Array Int natural))
(declare-const loops_static__loop10__result7 t)
(declare-const r4 (Array Int natural))
(declare-const i3 Int)
(declare-const res4 (Array Int natural))
(declare-const loops_static__loop10__result8 nat_array__ref)
(declare-const r5 (Array Int natural))
(declare-const i4 Int)
(declare-const res5 (Array Int natural))
(declare-const loops_static__loop10__result9 us_t)
(declare-const r6 map__ref)
(declare-const i5 int__ref)
(declare-const res6 map__ref)
(declare-const loops_static__loop10__result10 nat_array__ref)
(declare-const r7 (Array Int natural))
(declare-const i6 Int)
(declare-const res7 (Array Int natural))
(declare-const loops_static__loop10__result11 us_t)
...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= temp___378 r1)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (and (forall ((temp___379 Int)) (=> (and (<= (to_rep1 r__first) temp___379) (<= temp___379 (to_rep1 r__last))) (=> (<= i2 temp___379) (= (select r2 temp___379) (select temp___378 temp___379))))) (and (<= 1 i2) (<= i2 2)))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= (to_rep o) 0)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (and (<= (to_rep1 r__first) i2) (<= i2 (to_rep1 r__last)))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= o1 i2)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= o2 (store r2 o1 o))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= r2 result2)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= r3 o2)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (not (= i2 (to_rep1 (last (rt a)))))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= (mk___t loops_static__loop10__result6 loops_static__loop10__result7) (mk___t loops_static__loop10__result4 loops_static__loop10__result5))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= res3 res2)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (forall ((j1 Int)) (=> (and (<= (to_rep1 (first (rt a))) j1) (<= j1 i2)) (= (to_rep (select r3 j1)) 0)))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= i2 2)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= loops_static__loop10__result8 (mk_nat_array__ref (mk___t loops_static__loop10__result6 loops_static__loop10__result7)))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= res3 res4)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= i2 i3)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= r3 r4)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= loops_static__loop10__result9 (mk___t loops_static__loop10__result6 loops_static__loop10__result7))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= res5 res3)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= i4 i2)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= r5 r3)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= loops_static__loop10__result10 loops_static__loop10__result8)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= res6 (mk_map__ref res4))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= i5 (mk_int__ref i3))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= r6 (mk_map__ref r4))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= loops_static__loop10__result11 loops_static__loop10__result9)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= res7 res5)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= i6 i4)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= r7 r5)))
(assert (=> (not (and (<= 1 i1) (<= i1 2))) (= loops_static__loop10__result10 (mk_nat_array__ref (mk___t loops_static__loop10__result loops_static__loop10__result1)))))
(assert (=> (not (and (<= 1 i1) (<= i1 2))) (= res6 (mk_map__ref res))))
(assert (=> (not (and (<= 1 i1) (<= i1 2))) (= i5 (mk_int__ref i1))))
(assert (=> (not (and (<= 1 i1) (<= i1 2))) (= r6 (mk_map__ref r1))))
(assert (=> (not (and (<= 1 i1) (<= i1 2))) (= loops_static__loop10__result11 (mk___t loops_static__loop10__result2 loops_static__loop10__result3))))
(assert (=> (not (and (<= 1 i1) (<= i1 2))) (= res7 res1)))
(assert (=> (not (and (<= 1 i1) (<= i1 2))) (= i6 i1)))
(assert (=> (not (and (<= 1 i1) (<= i1 2))) (= r7 r1)))
(assert (not false))
(check-sat)
(exit)
