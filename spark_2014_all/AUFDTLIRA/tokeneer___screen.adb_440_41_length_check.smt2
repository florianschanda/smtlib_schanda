...
(assert (and (= temp___1814 (- 6 (to_rep1 valuestr__last))) (in_range (- 6 (to_rep1 valuestr__last)))))
(assert (=> (<= temp___1814 3) (and (and (<= 1 temp___1814) (<= temp___1814 7)) (and (<= 1 3) (<= 3 7)))))
(assert (= o6 str2))
(assert (= o6 temp___1816))
(assert (= (mk4 temp___1814 3) temp___18161))
(assert (not (= (ite (<= (to_rep1 (first8 temp___18131)) (to_rep1 (last8 temp___18131))) (+ (- (to_rep1 (last8 temp___18131)) (to_rep1 (first8 temp___18131))) 1) 0) (ite (<= (to_rep1 (first8 temp___18161)) (to_rep1 (last8 temp___18161))) (+ (- (to_rep1 (last8 temp___18161)) (to_rep1 (first8 temp___18161))) 1) 0))))
(check-sat)
(exit)
