...
(assert (and (= (length source) 5) (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (forall ((index3 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) index3) (<= index3 (+ (to_rep1 (first (rt source))) 4))) (= (is_digit (to_rep (select (elts source) index3))) true))))))
...
(assert (<= temp___2476 index1))
(assert (<= index1 temp___2477))
...
(assert (and (and (forall ((temp___2480 Int)) (=> (and (<= (to_rep1 n__first) temp___2480) (<= temp___2480 (to_rep1 n__last))) (=> (or (< temp___2477 temp___2480) (or (< temp___2480 temp___2476) (< index2 temp___2480))) (= (select n3 temp___2480) (select n1 temp___2480))))) (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 4)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 4) index2))) (and (<= (+ (to_rep1 (first (rt source))) 1) index2) (<= index2 (+ (to_rep1 (first (rt source))) 4)))))
