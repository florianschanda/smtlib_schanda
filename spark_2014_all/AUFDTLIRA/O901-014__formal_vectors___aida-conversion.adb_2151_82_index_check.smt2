...
(assert (<= temp___2480 index1))
(assert (<= index1 temp___2481))
...
(assert (and (and (forall ((temp___2478 Int)) (=> (and (<= (to_rep1 n__first) temp___2478) (<= temp___2478 (to_rep1 n__last))) (=> (< index2 temp___2478) (= (select n3 temp___2478) (select n1 temp___2478))))) (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 4)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 4) index2))) (and (<= (+ (to_rep1 (first (rt source))) 1) index2) (<= index2 (+ (to_rep1 (first (rt source))) 4)))))
