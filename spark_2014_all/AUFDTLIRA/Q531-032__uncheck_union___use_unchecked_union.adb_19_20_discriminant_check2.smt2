...
(declare-fun temp_____aggregate_def_224 (Int Int Int) (Array Int integer))
(declare-fun temp_____aggregate_def_233 (Int Int Int Int) (Array Int integer))
(declare-fun temp_____aggregate_def_243 (Int Int Int Int) (Array Int integer))
...
(assert (forall ((temp___226 Int) (temp___227 Int) (temp___228 Int)) (let ((temp___225 (temp_____aggregate_def_224 temp___226 temp___227 temp___228))) (=> (and (and (dynamic_invariant temp___226 true true true true) (dynamic_invariant temp___227 true true true true)) (dynamic_invariant temp___228 true true true true)) (and (and (= (select temp___225 0) rliteral1) (= (select temp___225 1) rliteral2)) (= (select temp___225 2) rliteral3))))))
(declare-const rliteral4 integer)
(assert (= (integerqtint rliteral4) 4))
(assert (forall ((temp___235 Int) (temp___236 Int) (temp___237 Int) (temp___238 Int)) (let ((temp___234 (temp_____aggregate_def_233 temp___235 temp___236 temp___237 temp___238))) (=> (and (and (and (dynamic_invariant temp___235 true true true true) (dynamic_invariant temp___236 true true true true)) (dynamic_invariant temp___237 true true true true)) (dynamic_invariant temp___238 true true true true)) (and (and (and (= (select temp___234 0) rliteral1) (= (select temp___234 1) rliteral2)) (= (select temp___234 2) rliteral3)) (= (select temp___234 3) rliteral4))))))
(assert (forall ((temp___245 Int) (temp___246 Int) (temp___247 Int) (temp___248 Int)) (let ((temp___244 (temp_____aggregate_def_243 temp___245 temp___246 temp___247 temp___248))) (=> (and (and (and (dynamic_invariant temp___245 true true true true) (dynamic_invariant temp___246 true true true true)) (dynamic_invariant temp___247 true true true true)) (dynamic_invariant temp___248 true true true true)) (and (and (and (= (select temp___244 0) rliteral) (= (select temp___244 1) rliteral)) (= (select temp___244 2) rliteral)) (= (select temp___244 3) rliteral))))))
...
(assert (not (= rliteral1 output__split_discrs)))
(check-sat)
(exit)
