...
(declare-const result11 (Array Int value))
(declare-const result12 t1)
...
(assert (= (mk___rep (mk___split_discrs result10) (mk___split_fields (mk___t1 result11 result12))) (table__content simple_unc_arrays__bubble_sort__result6)))
(declare-const j2 Int)
(assert (<= 1 j2))
(assert (<= j2 (- (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))) 1)))
(assert (not (<= (to_rep2 (select (elts1 (rec__simple_unc_arrays__table__v (us_split_fields1 (table__content simple_unc_arrays__bubble_sort__result6)))) j2)) (to_rep2 (select (elts1 (rec__simple_unc_arrays__table__v (us_split_fields1 (table__content simple_unc_arrays__bubble_sort__result6)))) (+ j2 1))))))
(check-sat)
(exit)
