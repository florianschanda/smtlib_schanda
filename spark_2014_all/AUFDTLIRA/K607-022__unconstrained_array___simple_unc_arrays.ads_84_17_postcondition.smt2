...
(declare-const result10 (Array Int value))
(declare-const result11 t1)
...
(assert (= (mk___rep (mk___split_discrs result9) (mk___split_fields (mk___t1 result10 result11))) (table__content simple_unc_arrays__bubble_sort__result6)))
(declare-const j Int)
(assert (<= 1 j))
(assert (<= j (- (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))) 1)))
(assert (not (<= (to_rep2 (select (elts1 (rec__simple_unc_arrays__table__v (us_split_fields1 (table__content simple_unc_arrays__bubble_sort__result6)))) j)) (to_rep2 (select (elts1 (rec__simple_unc_arrays__table__v (us_split_fields1 (table__content simple_unc_arrays__bubble_sort__result6)))) (+ j 1))))))
(check-sat)
(exit)
