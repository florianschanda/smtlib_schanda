...
(assert (and (= (get_length (mk___rep (mk___split_fields s__split_fields4 s__split_fields5))) (+ (get_length (mk___rep (mk___split_fields s__split_fields2 s__split_fields3))) 1)) (= (top (mk___rep (mk___split_fields s__split_fields4 s__split_fields5))) n)))
(assert (not (< 0 (get_length (mk___rep (mk___split_fields s__split_fields4 s__split_fields5))))))
(check-sat)
(exit)
