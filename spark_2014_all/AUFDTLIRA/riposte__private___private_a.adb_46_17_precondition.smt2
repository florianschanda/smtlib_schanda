...
(define-fun dynamic_invariant1 ((temp___expr_180 Int) (temp___is_init_176 Bool) (temp___skip_constant_177 Bool) (temp___do_toplevel_178 Bool) (temp___do_typ_inv_179 Bool)) Bool (=> (or (= temp___is_init_176 true) (<= 0 100)) (in_range1 temp___expr_180)))
...
(declare-const temp___260 length_t)
(declare-const temp___2601 (Array Int integer))
...
(define-fun s__split_fields6 () us_split_fields (mk___split_fields s__split_fields4 s__split_fields5))
(define-fun temp___2602 () us_rep (mk___rep (mk___split_fields temp___260 temp___2601)))
(assert (in_range n))
(assert (and (= temp___2602 (create_stack Tuple0)) (= (get_length temp___2602) 0)))
...
(assert (= temp___260 s__split_fields2))
(assert (= temp___2601 s__split_fields3))
(assert (and (= (get_length (mk___rep s__split_fields6)) (+ (get_length (mk___rep (mk___split_fields s__split_fields2 s__split_fields3))) 1)) (= (top (mk___rep s__split_fields6)) n)))
(assert (not (< 0 (get_length (mk___rep s__split_fields6)))))
(check-sat)
(exit)
