...
(define-fun bool_eq2 ((a us_rep1) (b us_rep1)) Bool (ite (and (and (= (to_rep2 (rec__stackp__buffer__first (us_split_fields3 a))) (to_rep2 (rec__stackp__buffer__first (us_split_fields3 b)))) (= (bool_eq (rec__stackp__stack_root__content1 (us_split_fields3 a)) 1 100 (rec__stackp__stack_root__content1 (us_split_fields3 b)) 1 100) true)) (= (to_rep (rec__stackp__stack_root__length1 (us_split_fields3 a))) (to_rep (rec__stackp__stack_root__length1 (us_split_fields3 b))))) true false))
...
(define-fun default_initial_assumption ((temp___expr_361 us_rep1) (temp___skip_top_level_362 Bool)) Bool (and (and (= (attr__tag1 temp___expr_361) us_tag1) (and (= (to_rep2 (rec__stackp__buffer__first (us_split_fields3 temp___expr_361))) 1) (= (to_rep (rec__stackp__stack_root__length1 (us_split_fields3 temp___expr_361))) 0))) (=> (not (= temp___skip_top_level_362 true)) (= (size (to_base temp___expr_361)) 0))))
(declare-const s__attr__tag Int)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(define-fun dynamic_invariant ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= 0 100)) (in_range temp___expr_136)))
...
(define-fun dynamic_invariant2 ((temp___expr_353 Int) (temp___is_init_350 Bool) (temp___skip_constant_351 Bool) (temp___do_toplevel_352 Bool)) Bool (=> (or (= temp___is_init_350 true) (<= 1 100)) (in_range2 temp___expr_353)))
...
(declare-const temp___570 positive_less_than_max)
(declare-const temp___5701 (Array Int element))
(declare-const temp___5702 less_than_max)
(declare-const temp___5703 us_private)
(declare-const temp___5704 Int)
...
(declare-const temp___572 positive_less_than_max)
(declare-const temp___5721 (Array Int element))
(declare-const temp___5722 less_than_max)
(declare-const temp___5723 us_private)
(declare-const temp___5724 Int)
...
(assert (= temp___570 o1))
(assert (= temp___5701 o2))
(assert (= temp___5702 o3))
(assert (= temp___5703 o4))
(assert (= s__attr__tag temp___5704))
...
(assert (= temp___570 s__split_fields4))
(assert (= temp___5701 s__split_fields5))
(assert (= temp___5702 s__split_fields6))
(assert (= temp___5703 s__split_fields7))
(assert (= (to_rep o5) 0))
(assert (= s__split_fields4 o6))
(assert (= s__split_fields5 o7))
(assert (= o5 o8))
(assert (= s__split_fields7 o9))
(assert (= temp___572 o6))
(assert (= temp___5721 o7))
(assert (= temp___5722 o8))
(assert (= temp___5723 o9))
(assert (= s__attr__tag temp___5724))
...
(assert (= temp___572 s__split_fields8))
(assert (= temp___5721 s__split_fields9))
(assert (= temp___5722 s__split_fields10))
(assert (= temp___5723 s__split_fields11))
