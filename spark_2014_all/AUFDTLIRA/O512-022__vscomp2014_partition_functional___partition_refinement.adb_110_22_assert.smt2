...
(assert (= (has_key (positions (mk___rep d__split_discrs d__split_fields1)) c10) true))
(assert (= (key (mk___rep d__split_discrs d__split_fields1) c10) (to_rep (select a1 i))))
(assert (not (= (to_rep (select a1 (element (mk___rep d__split_discrs d__split_fields1) c10))) (key (mk___rep d__split_discrs d__split_fields1) c10))))
(check-sat)
(exit)
