...
(assert (and (<= (to_rep1 (first (rt source))) temp___1507) (<= temp___1507 (to_rep1 (last (rt source))))))
(assert (= o temp___1507))
(assert (= o1 (select (elts source) o)))
(assert (= o2 (to_rep o1)))
(assert (= o3 (ite (= o2 49) true false)))
(assert (and (= temp___1506 (+ (to_rep1 (first (rt source))) 0)) (in_range1 (+ (to_rep1 (first (rt source))) 0))))
(assert (not (<= (to_rep1 (first (rt source))) temp___1506)))
(check-sat)
(exit)
