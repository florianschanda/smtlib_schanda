...
(define-fun dynamic_invariant2 ((temp___expr_155 us_t) (temp___is_init_152 Bool) (temp___skip_constant_153 Bool) (temp___do_toplevel_154 Bool)) Bool (=> (not (= temp___skip_constant_153 true)) (dynamic_property 1 2147483647 (first1 temp___expr_155) (last1 temp___expr_155))))
...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__record_discr__interm_result__to_search us_t1)))))
(define-fun us_split_fields_To_Search__projection ((a us_split_fields2)) us_t1 (rec__record_discr__interm_result__to_search a))
...
(define-fun bool_eq4 ((a us_rep1) (b us_rep1)) Bool (ite (and (= (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 a))) (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 b)))) (= (bool_eq3 (rec__record_discr__interm_result__to_search (us_split_fields3 a)) (rec__record_discr__interm_result__to_search (us_split_fields3 b))) true)) true false))
...
(declare-datatypes () ((tT19bP1__ref (mk_tT19bP1__ref (tT19bP1__content integer)))))
(define-fun tT19bP1__ref___projection ((a1 tT19bP1__ref)) integer (tT19bP1__content a1))
(declare-sort t2 0)
...
(declare-datatypes () ((t19b__ref (mk_t19b__ref (t19b__content us_t2)))))
(define-fun t19b__ref___projection ((a1 t19b__ref)) us_t2 (t19b__content a1))
(declare-datatypes () ((us_split_fields4 (mk___split_fields2 (rec__record_discr__interm_result__to_search1 us_t2)))))
(define-fun us_split_fields_To_Search__6__projection ((a1 us_split_fields4)) us_t2 (rec__record_discr__interm_result__to_search1 a1))
(declare-datatypes () ((us_split_fields__ref2 (mk___split_fields__ref2 (us_split_fields__content2 us_split_fields4)))))
(define-fun us_split_fields__ref___7__projection ((a1 us_split_fields__ref2)) us_split_fields4 (us_split_fields__content2 a1))
(declare-datatypes () ((us_rep2 (mk___rep2 (us_split_discrs4 us_split_discrs2) (us_split_fields5 us_split_fields4)))))
(define-fun us_rep___13__projection ((a1 us_rep2)) us_split_discrs2 (us_split_discrs4 a1))
(define-fun us_rep___14__projection ((a1 us_rep2)) us_split_fields4 (us_split_fields5 a1))
(define-fun to_base ((a1 us_rep2)) us_rep1 (mk___rep1 (us_split_discrs4 a1) (mk___split_fields1 (let ((temp___141 (rec__record_discr__interm_result__to_search1 (us_split_fields5 a1)))) (of_array1 (to_array2 temp___141) (first5 temp___141) (last5 temp___141))))))
(define-fun of_base ((r us_rep1)) us_rep2 (mk___rep2 (us_split_discrs3 r) (mk___split_fields2 (let ((temp___140 (rec__record_discr__interm_result__to_search (us_split_fields3 r)))) (of_array2 (to_array1 temp___140) (first3 temp___140) (last3 temp___140))))))
(define-fun bool_eq6 ((a1 us_rep2) (b us_rep2)) Bool (ite (and (= (to_rep (rec__record_discr__interm_result__upto (us_split_discrs4 a1))) (to_rep (rec__record_discr__interm_result__upto (us_split_discrs4 b)))) (= (bool_eq5 (rec__record_discr__interm_result__to_search1 (us_split_fields5 a1)) (rec__record_discr__interm_result__to_search1 (us_split_fields5 b))) true)) true false))
(define-fun in_range4 ((rec__record_discr__interm_result__upto1 Int) (a1 us_rep1)) Bool (= rec__record_discr__interm_result__upto1 (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 a1)))))
...
(declare-datatypes () ((my_interm__ref (mk_my_interm__ref (my_interm__content us_rep2)))))
(define-fun my_interm__ref___projection ((a1 my_interm__ref)) us_rep2 (my_interm__content a1))
(define-fun dynamic_invariant3 ((temp___expr_236 us_rep2) (temp___is_init_233 Bool) (temp___skip_constant_234 Bool) (temp___do_toplevel_235 Bool)) Bool (and (=> (not (= temp___skip_constant_234 true)) (in_range4 (last1 a) (to_base temp___expr_236))) (and (dynamic_property4 1 (last1 a) (first5 (rec__record_discr__interm_result__to_search1 (us_split_fields5 temp___expr_236))) (last5 (rec__record_discr__interm_result__to_search1 (us_split_fields5 temp___expr_236)))) (and (= (first5 (rec__record_discr__interm_result__to_search1 (us_split_fields5 temp___expr_236))) 1) (= (last5 (rec__record_discr__interm_result__to_search1 (us_split_fields5 temp___expr_236))) (last1 a))))))
(define-fun default_initial_assumption ((temp___expr_239 us_rep2) (temp___skip_top_level_240 Bool)) Bool (= (to_rep (rec__record_discr__interm_result__upto (us_split_discrs4 temp___expr_239))) (last1 a)))
...
(define-fun tT21bP1__ref___projection ((a1 tT21bP1__ref)) integer (tT21bP1__content a1))
(declare-sort t3 0)
...
(define-fun bool_eq7 ((x us_t3) (y us_t3)) Bool (bool_eq1 (elts3 x) (to_rep1 (first6 (rt3 x))) (to_rep1 (last6 (rt3 x))) (elts3 y) (to_rep1 (first6 (rt3 y))) (to_rep1 (last6 (rt3 y)))))
...
(declare-datatypes () ((us_split_fields6 (mk___split_fields3 (rec__record_discr__interm_result__to_search2 us_t3)))))
(define-fun us_split_fields_To_Search__7__projection ((a1 us_split_fields6)) us_t3 (rec__record_discr__interm_result__to_search2 a1))
...
(define-fun us_rep___15__projection ((a1 us_rep3)) us_split_discrs2 (us_split_discrs5 a1))
(define-fun us_rep___16__projection ((a1 us_rep3)) us_split_fields6 (us_split_fields7 a1))
(define-fun to_base1 ((a1 us_rep3)) us_rep1 (mk___rep1 (us_split_discrs5 a1) (mk___split_fields1 (let ((temp___143 (rec__record_discr__interm_result__to_search2 (us_split_fields7 a1)))) (of_array1 (to_array3 temp___143) (first7 temp___143) (last7 temp___143))))))
(define-fun of_base1 ((r us_rep1)) us_rep3 (mk___rep3 (us_split_discrs3 r) (mk___split_fields3 (let ((temp___142 (rec__record_discr__interm_result__to_search (us_split_fields3 r)))) (of_array3 (to_array1 temp___142) (first3 temp___142) (last3 temp___142))))))
(define-fun bool_eq8 ((a1 us_rep3) (b us_rep3)) Bool (ite (and (= (to_rep (rec__record_discr__interm_result__upto (us_split_discrs5 a1))) (to_rep (rec__record_discr__interm_result__upto (us_split_discrs5 b)))) (= (bool_eq7 (rec__record_discr__interm_result__to_search2 (us_split_fields7 a1)) (rec__record_discr__interm_result__to_search2 (us_split_fields7 b))) true)) true false))
(define-fun in_range5 ((rec__record_discr__interm_result__upto1 Int) (a1 us_rep1)) Bool (= rec__record_discr__interm_result__upto1 (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 a1)))))
...
(assert (< record_discr__interm_result__upto__first__bit2 record_discr__interm_result__upto__last__bit2))
...
(assert (< record_discr__interm_result__to_search__first__bit2 record_discr__interm_result__to_search__last__bit2))
...
(declare-datatypes () ((t20b__ref (mk_t20b__ref (t20b__content us_rep3)))))
(define-fun t20b__ref___projection ((a1 t20b__ref)) us_rep3 (t20b__content a1))
...
(assert (= init (of_base (to_base1 (mk___rep3 (mk___split_discrs1 (of_rep (last1 a))) (mk___split_fields3 (of_array3 (slide (to_array a) (first1 a) 1) 1 (last1 a))))))))
(define-fun dynamic_invariant5 ((temp___expr_160 us_rep1) (temp___is_init_157 Bool) (temp___skip_constant_158 Bool) (temp___do_toplevel_159 Bool)) Bool (let ((temp___161 (rec__record_discr__interm_result__upto (us_split_discrs3 temp___expr_160)))) (and (dynamic_property2 1 (to_rep temp___161) (first3 (rec__record_discr__interm_result__to_search (us_split_fields3 temp___expr_160))) (last3 (rec__record_discr__interm_result__to_search (us_split_fields3 temp___expr_160)))) (and (= (first3 (rec__record_discr__interm_result__to_search (us_split_fields3 temp___expr_160))) 1) (= (last3 (rec__record_discr__interm_result__to_search (us_split_fields3 temp___expr_160))) (to_rep temp___161))))))
...
(assert (in_range1 e))
(assert (and (= (to_rep1 (first (rt a))) 1) (<= 0 (to_rep1 (last (rt a))))))
(assert (and (and (and (= us (to_rep1 (last (rt a)))) (in_range1 (to_rep1 (last (rt a))))) (and (and (and (and (and (and (and (and (= (ite (<= (to_rep1 (first (rt a))) (to_rep1 (last (rt a)))) (+ (- (to_rep1 (last (rt a))) (to_rep1 (first (rt a)))) 1) 0) (ite (<= 1 (to_rep1 (last (rt a)))) (+ (- (to_rep1 (last (rt a))) 1) 1) 0)) (and (= (slide (elts a) (to_rep1 (first (rt a))) 1) o2) (= (mk3 1 (to_rep1 (last (rt a)))) o3))) (and (= o4 o2) (= o5 o3))) (and (and (and (and (= o (to_rep1 (last (rt a)))) (in_range1 (to_rep1 (last (rt a))))) (= (to_rep o1) o)) (= o1 o6)) (and (= o7 o6) (and (= o8 o4) (= o9 o5))))) (= (mk___rep1 (mk___split_discrs1 o10) (mk___split_fields1 (mk___t1 o11 o12))) (to_base1 (mk___rep3 (mk___split_discrs1 o7) (mk___split_fields3 (mk___t3 o8 o9)))))) (= (mk___rep1 (mk___split_discrs1 o13) (mk___split_fields1 (mk___t1 o14 o15))) (mk___rep1 (mk___split_discrs1 o10) (mk___split_fields1 (mk___t1 o11 o12))))) (= (mk___rep2 (mk___split_discrs1 record_discr__search__init__assume) (mk___split_fields2 (mk___t2 record_discr__search__init__assume1 record_discr__search__init__assume2))) (of_base (mk___rep1 (mk___split_discrs1 o13) (mk___split_fields1 (mk___t1 o14 o15)))))) (= (mk___rep2 (mk___split_discrs1 record_discr__search__init__assume) (mk___split_fields2 (mk___t2 record_discr__search__init__assume1 record_discr__search__init__assume2))) init)) (and (dynamic_invariant3 init true false true) (and (and (= record_discr__search__result3 (mk_result_ty__ref record_discr__search__result2)) (= record_discr__search__result4 record_discr__search__result2)) (and (and (= o16 (search_upto (to_base init) e)) (ite (= (rec__private_record__result_ty__found (us_split_discrs1 o16)) true) (and (<= (get_content o16) (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 (to_base init))))) (= (to_rep (select (elts1 (rec__record_discr__interm_result__to_search (us_split_fields3 (to_base init)))) (get_content o16))) e)) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 (to_base init)))))) (not (= (to_rep (select (elts1 (rec__record_discr__interm_result__to_search (us_split_fields3 (to_base init)))) i1)) e)))))) (and (= result (mk_result_ty__ref (mk___rep (mk___split_discrs record_discr__search__result) (mk___split_fields record_discr__search__result1)))) (= record_discr__search__result2 o16))))))) (and (= record_discr__search__result5 record_discr__search__result3) (= record_discr__search__result6 record_discr__search__result4))))
(assert (= (mk___rep (mk___split_discrs result1) (mk___split_fields result2)) (result_ty__content record_discr__search__result5)))
(assert (= (rec__private_record__result_ty__found (us_split_discrs1 (result_ty__content record_discr__search__result5))) true))
(assert (not (= (to_rep (select (elts a) (get_content (result_ty__content record_discr__search__result5)))) e)))
(check-sat)
(exit)
