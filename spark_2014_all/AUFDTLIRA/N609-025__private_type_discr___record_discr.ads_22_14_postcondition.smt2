...
(define-fun to_base ((a1 us_rep2)) us_rep1 (mk___rep1 (us_split_discrs4 a1) (mk___split_fields1 (let ((temp___163 (rec__record_discr__interm_result__to_search1 (us_split_fields5 a1)))) (of_array1 (to_array2 temp___163) (first5 temp___163) (last5 temp___163))))))
(define-fun of_base ((r us_rep1)) us_rep2 (mk___rep2 (us_split_discrs3 r) (mk___split_fields2 (let ((temp___162 (rec__record_discr__interm_result__to_search (us_split_fields3 r)))) (of_array2 (to_array1 temp___162) (first3 temp___162) (last3 temp___162))))))
...
(define-fun dynamic_invariant3 ((temp___expr_268 us_rep2) (temp___is_init_264 Bool) (temp___skip_constant_265 Bool) (temp___do_toplevel_266 Bool) (temp___do_typ_inv_267 Bool)) Bool (and (=> (not (= temp___skip_constant_265 true)) (in_range4 (last1 a) (to_base temp___expr_268))) (and (dynamic_property4 1 (last1 a) (first5 (rec__record_discr__interm_result__to_search1 (us_split_fields5 temp___expr_268))) (last5 (rec__record_discr__interm_result__to_search1 (us_split_fields5 temp___expr_268)))) (and (= (first5 (rec__record_discr__interm_result__to_search1 (us_split_fields5 temp___expr_268))) 1) (= (last5 (rec__record_discr__interm_result__to_search1 (us_split_fields5 temp___expr_268))) (last1 a))))))
(define-fun default_initial_assumption ((temp___expr_271 us_rep2) (temp___skip_top_level_272 Bool)) Bool (= (to_rep (rec__record_discr__interm_result__upto (us_split_discrs4 temp___expr_271))) (last1 a)))
...
(define-fun to_base1 ((a1 us_rep3)) us_rep1 (mk___rep1 (us_split_discrs5 a1) (mk___split_fields1 (let ((temp___165 (rec__record_discr__interm_result__to_search2 (us_split_fields7 a1)))) (of_array1 (to_array3 temp___165) (first7 temp___165) (last7 temp___165))))))
(define-fun of_base1 ((r us_rep1)) us_rep3 (mk___rep3 (us_split_discrs3 r) (mk___split_fields3 (let ((temp___164 (rec__record_discr__interm_result__to_search (us_split_fields3 r)))) (of_array3 (to_array1 temp___164) (first3 temp___164) (last3 temp___164))))))
...
(define-fun dynamic_invariant5 ((temp___expr_185 us_rep1) (temp___is_init_181 Bool) (temp___skip_constant_182 Bool) (temp___do_toplevel_183 Bool) (temp___do_typ_inv_184 Bool)) Bool (let ((temp___186 (rec__record_discr__interm_result__upto (us_split_discrs3 temp___expr_185)))) (and (dynamic_property2 1 (to_rep temp___186) (first3 (rec__record_discr__interm_result__to_search (us_split_fields3 temp___expr_185))) (last3 (rec__record_discr__interm_result__to_search (us_split_fields3 temp___expr_185)))) (and (= (first3 (rec__record_discr__interm_result__to_search (us_split_fields3 temp___expr_185))) 1) (= (last3 (rec__record_discr__interm_result__to_search (us_split_fields3 temp___expr_185))) (to_rep temp___186))))))
