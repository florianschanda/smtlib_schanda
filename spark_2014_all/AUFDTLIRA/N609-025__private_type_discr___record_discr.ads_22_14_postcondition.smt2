...
(define-fun record_discr__search__init__assume3 () us_rep2 (mk___rep2 (mk___split_discrs1 record_discr__search__init__assume) (mk___split_fields2 (mk___t2 record_discr__search__init__assume1 record_discr__search__init__assume2))))
(define-fun o17 () us_rep1 (mk___rep1 (mk___split_discrs1 o13) (mk___split_fields1 (mk___t1 o14 o15))))
(define-fun o18 () us_rep1 (mk___rep1 (mk___split_discrs1 o10) (mk___split_fields1 (mk___t1 o11 o12))))
...
(assert (and (= us (to_rep1 (last (rt a)))) (in_range1 (to_rep1 (last (rt a))))))
...
(assert (= o4 o2))
(assert (= o5 o3))
(assert (and (= o (to_rep1 (last (rt a)))) (in_range1 (to_rep1 (last (rt a))))))
(assert (= (to_rep o1) o))
(assert (= o1 o6))
(assert (= o7 o6))
(assert (= o8 o4))
(assert (= o9 o5))
(assert (= o18 (to_base1 (mk___rep3 (mk___split_discrs1 o7) (mk___split_fields3 (mk___t3 o8 o9))))))
(assert (= o17 o18))
...
(assert (= record_discr__search__result3 (mk_result_ty__ref record_discr__search__result2)))
(assert (= record_discr__search__result4 record_discr__search__result2))
(assert (and (= o16 (search_upto (to_base init) e)) (ite (= (rec__private_record__result_ty__found (us_split_discrs1 o16)) true) (and (<= (get_content o16) (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 (to_base init))))) (= (to_rep (select (elts1 (rec__record_discr__interm_result__to_search (us_split_fields3 (to_base init)))) (get_content o16))) e)) (forall ((i Int)) (=> (and (<= 1 i) (<= i (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 (to_base init)))))) (not (= (to_rep (select (elts1 (rec__record_discr__interm_result__to_search (us_split_fields3 (to_base init)))) i)) e)))))))
(assert (= result (mk_result_ty__ref (mk___rep (mk___split_discrs record_discr__search__result) (mk___split_fields record_discr__search__result1)))))
