...
(assert (and (= temp___667 (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o)) (and (dynamic_invariant9 temp___667 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___667 o))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___667 o)))) 0) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= i o)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___667 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___667 i))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___667 i))) true)))))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___667 i))) true) (not (= i o))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___667 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i)))) (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i) (rec__tree_model__path_type__a (us_split_fields1 (select temp___667 i)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___667 i)))) 0)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___667 i))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___667 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___667 i))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___667 j)))) true)) (= j i))))))))))))))
