...
(assert (=> (<= 1 1) (= o (+ (- 1 1) 1))))
(assert (=> (not (<= 1 1)) (= o 0)))
(assert (=> (<= (to_rep1 (first (rt s))) (to_rep1 (last (rt s)))) (= o1 (+ (- (to_rep1 (last (rt s))) (to_rep1 (first (rt s)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt s))) (to_rep1 (last (rt s))))) (= o1 0)))
(assert (= o2 (+ o1 o)))
(assert (= o3 (+ (to_rep1 (first (rt s))) o2)))
(assert (= o4 (- o3 1)))
