...
(assert (not (= (bool_eq (elts (to__ (mk___rep (us_split_fields__content s__split_fields12)))) (to_rep (first3 (mk1 first2 (- last3 (int__content i11))))) (to_rep (last4 (mk1 first2 (- last3 (int__content i11))))) (elts (to__ (mk___rep (us_split_fields__content s__split_fields7)))) (to_rep (first5 (mk2 first2 (- last3 (int__content i11))))) (to_rep (last6 (mk2 first2 (- last3 (int__content i11)))))) true)))
(check-sat)
(exit)
