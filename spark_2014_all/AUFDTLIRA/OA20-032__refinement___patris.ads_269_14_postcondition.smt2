...
(define-fun dynamic_invariant1 ((temp___expr_2185 Int) (temp___is_init_2181 Bool) (temp___skip_constant_2182 Bool) (temp___do_toplevel_2183 Bool) (temp___do_typ_inv_2184 Bool)) Bool (=> (or (= temp___is_init_2181 true) (<= 0 4)) (in_range7 temp___expr_2185)))
...
(define-fun dynamic_invariant3 ((temp___expr_2087 Int) (temp___is_init_2083 Bool) (temp___skip_constant_2084 Bool) (temp___do_toplevel_2085 Bool) (temp___do_typ_inv_2086 Bool)) Bool (=> (or (= temp___is_init_2083 true) (<= 0 7)) (in_range2 temp___expr_2087)))
(define-fun dynamic_invariant4 ((temp___expr_2094 Int) (temp___is_init_2090 Bool) (temp___skip_constant_2091 Bool) (temp___do_toplevel_2092 Bool) (temp___do_typ_inv_2093 Bool)) Bool (=> (or (= temp___is_init_2090 true) (<= 1 7)) (in_range3 temp___expr_2094)))
...
(define-fun dynamic_invariant7 ((temp___expr_2153 Int) (temp___is_init_2149 Bool) (temp___skip_constant_2150 Bool) (temp___do_toplevel_2151 Bool) (temp___do_typ_inv_2152 Bool)) Bool (=> (or (= temp___is_init_2149 true) (<= (- 1) 9)) (in_range4 temp___expr_2153)))
(define-fun dynamic_invariant8 ((temp___expr_2160 Int) (temp___is_init_2156 Bool) (temp___skip_constant_2157 Bool) (temp___do_toplevel_2158 Bool) (temp___do_typ_inv_2159 Bool)) Bool (=> (or (= temp___is_init_2156 true) (<= (- 1) 19)) (in_range5 temp___expr_2160)))
(define-fun dynamic_invariant9 ((temp___expr_2167 Int) (temp___is_init_2163 Bool) (temp___skip_constant_2164 Bool) (temp___do_toplevel_2165 Bool) (temp___do_typ_inv_2166 Bool)) Bool (=> (or (= temp___is_init_2163 true) (<= 0 3)) (in_range6 temp___expr_2167)))
(assert true)
...
(define-fun next_piece__split_fields10 () us_split_fields (mk___split_fields next_piece__split_fields4 next_piece__split_fields5 next_piece__split_fields6 next_piece__split_fields7))
(define-fun cur_piece__split_fields13 () us_split_fields (mk___split_fields cur_piece__split_fields4 cur_piece__split_fields5 cur_piece__split_fields6 cur_piece__split_fields7))
...
(assert (= next_piece__split_fields8 (mk___split_fields__ref next_piece__split_fields10)))
