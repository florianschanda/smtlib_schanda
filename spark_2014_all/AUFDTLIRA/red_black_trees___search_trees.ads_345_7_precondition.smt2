...
(assert (forall ((f us_rep1)) (forall ((i Int)) (! (=> (and (and (dynamic_invariant2 f true true true true) (dynamic_invariant i true true true true)) (not (= (parent f i) 0))) (dynamic_invariant1 (position f i) true false true true)) :pattern ((position f i))))))
...
(assert (forall ((t us_rep2)) (forall ((i Int)) (! (=> (and (and (dynamic_invariant3 t true true true true) (dynamic_invariant i true true true true)) (type_invariant1 t)) (let ((result (parent1 t i))) (and (=> (= (size1 t) 0) (= result 0)) (dynamic_invariant4 result true false true true)))) :pattern ((parent1 t i))))))
(assert (forall ((t us_rep2)) (forall ((i Int)) (! (=> (and (dynamic_invariant3 t true true true true) (dynamic_invariant i true true true true)) (= (parent1 t i) (parent (rec__search_trees__search_tree__struct (us_split_fields5 t)) i))) :pattern ((parent1 t i))))))
...
(assert (forall ((t1 us_rep2)) (! (=> (and (dynamic_invariant3 t1 true true true true) (type_invariant1 t1)) (dynamic_invariant4 (size1 t1) true false true true)) :pattern ((size1 t1)))))
(assert (forall ((t1 us_rep2)) (! (=> (dynamic_invariant3 t1 true true true true) (= (size1 t1) (size (rec__search_trees__search_tree__struct (us_split_fields5 t1))))) :pattern ((size1 t1)))))
...
(assert (forall ((f us_rep1)) (forall ((i1 Int)) (! (=> (and (dynamic_invariant2 f true true true true) (dynamic_invariant i1 true true true true)) (let ((result (parent f i1))) (and (and (=> (= (valid_root f i1) true) (= result 0)) (=> (= (size f) 0) (= result 0))) (dynamic_invariant4 result true false true true)))) :pattern ((parent f i1))))))
...
(assert (not (not (= (parent (rec__search_trees__search_tree__struct (us_split_fields5 t)) i) 0))))
(check-sat)
(exit)
