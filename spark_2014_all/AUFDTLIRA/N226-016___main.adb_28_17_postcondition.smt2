...
(assert (in_range1 id))
(assert (and (and (forall ((id1 Int)) (=> (and (<= 0 id1) (<= id1 1)) (not (= (to_rep (select map1 id1)) id1)))) (and (and (= main__with_invariant__result1 main__with_invariant__result2) (= main__with_invariant__result3 main__with_invariant__result1)) (and (= result main__with_invariant__result) (= main__with_invariant__result1 (to_rep (select map1 id)))))) (and (= (mk_int__ref main__with_invariant__result4) (mk_int__ref main__with_invariant__result2)) (= main__with_invariant__result5 main__with_invariant__result3))))
(assert (= result1 main__with_invariant__result4))
(assert (not (not (= id main__with_invariant__result4))))
(check-sat)
(exit)
