...
(assert (and (and (<= (to_rep1 (first (mk (to_rep1 x__first) (to_rep1 x__last)))) 1) (<= 3 (to_rep1 (last (mk (to_rep1 x__first) (to_rep1 x__last)))))) (not (= (to_rep (select o5 3)) 0))))
(assert (and (<= (to_rep1 x__first) 1) (<= 3 (to_rep1 x__last))))
(assert (and (<= (to_rep1 x__first) 1) (<= 3 (to_rep1 x__last))))
(assert (and (<= (to_rep1 x__first) 1) (<= 3 (to_rep1 x__last))))
(assert (and (<= (to_rep1 x__first) 1) (<= 3 (to_rep1 x__last))))
(assert (and (<= (to_rep1 x__first) 1) (<= 3 (to_rep1 x__last))))
(assert (and (and (<= (to_rep1 (first (mk (to_rep1 x__first) (to_rep1 x__last)))) 1) (<= 3 (to_rep1 (last (mk (to_rep1 x__first) (to_rep1 x__last)))))) (not (= (to_rep (select o6 3)) 0))))
(assert (and (<= (to_rep1 x__first) 1) (<= 3 (to_rep1 x__last))))
(assert (and (<= (to_rep1 x__first) 1) (<= 3 (to_rep1 x__last))))
(assert (and (<= (to_rep1 x__first) 1) (<= 3 (to_rep1 x__last))))
(assert (dynamic_property1 (- 2147483648) 2147483647 (to_rep1 x__first) (to_rep1 x__last)))
(assert (= o7 temp___316))
...
(assert (and (and (<= (to_rep1 (first (mk (to_rep1 y__first) (to_rep1 y__last)))) 1) (<= 3 (to_rep1 (last (mk (to_rep1 y__first) (to_rep1 y__last)))))) (not (= (to_rep (select o9 3)) 0))))
(assert (and (and (<= (to_rep1 (first (mk (to_rep1 y__first) (to_rep1 y__last)))) 1) (<= 3 (to_rep1 (last (mk (to_rep1 y__first) (to_rep1 y__last)))))) (not (= (to_rep (select o10 3)) 0))))
(assert (not (<= (to_rep1 (first (mk (to_rep1 y__first) (to_rep1 y__last)))) 1)))
(check-sat)
(exit)
