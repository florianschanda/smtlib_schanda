...
(assert (and (= (length source) 3) (forall ((index2 Int)) (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index2))) true)))))
