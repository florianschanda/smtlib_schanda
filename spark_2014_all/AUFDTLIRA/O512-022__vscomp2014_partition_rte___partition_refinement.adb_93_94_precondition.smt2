...
(assert (= result2 true))
(assert (and (= o8 (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c)) (and (in_range7 o8) (= o8 (get (keys (mk___rep d__split_discrs (mk___split_fields d__split_fields))) (get1 (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields))) c))))))
