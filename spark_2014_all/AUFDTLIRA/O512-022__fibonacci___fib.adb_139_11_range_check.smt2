...
(assert (= i15 0))
(assert (=> (and (<= 0 i15) (<= i15 k2)) (= temp___229 a2)))
(assert (=> (and (<= 0 i15) (<= i15 k2)) (and (forall ((temp___230 Int)) (=> (and (<= 0 temp___230) (<= temp___230 100)) (=> (or (< k2 temp___230) (or (< temp___230 0) (<= i16 temp___230))) (= (select a22 temp___230) (select temp___229 temp___230))))) (and (<= 0 i16) (<= i16 k2)))))
