...
(assert (=> (and (<= 0 i3) (<= i3 k1)) (and (forall ((temp___196 Int)) (=> (and (<= 0 temp___196) (<= temp___196 100)) (=> (<= i4 temp___196) (= (select a12 temp___196) (select temp___195 temp___196))))) (and (<= 0 i4) (<= i4 k1)))))
...
(assert (=> (and (<= temp___202 i9) (<= i9 0)) (and (forall ((temp___201 Int)) (=> (and (<= 0 temp___201) (<= temp___201 100)) (=> (<= i10 temp___201) (= (select a18 temp___201) (select temp___200 temp___201))))) (and (<= (+ k1 1) i10) (<= i10 0)))))
(assert (=> (and (<= temp___202 i9) (<= i9 0)) (and (= temp___199 (- i10 k1)) (in_range1 (- i10 k1)))))
(assert (=> (and (<= temp___202 i9) (<= i9 0)) (and (<= 0 temp___199) (<= temp___199 100))))
...
(assert (=> (and (<= temp___202 i9) (<= i9 0)) (and (<= 0 i10) (<= i10 100))))
...
(assert (=> (and (<= temp___202 i9) (<= i9 0)) (= a114 (mk_map__ref a110))))
(assert (=> (and (<= temp___202 i9) (<= i9 0)) (= i14 i12)))
(assert (=> (and (<= temp___202 i9) (<= i9 0)) (= a113 a111)))
(assert (=> (not (and (<= temp___202 i9) (<= i9 0))) (= i13 (mk_int__ref i9))))
...
(assert (= i15 0))
(assert (=> (and (<= 0 i15) (<= i15 k2)) (= temp___204 a2)))
(assert (=> (and (<= 0 i15) (<= i15 k2)) (and (forall ((temp___205 Int)) (=> (and (<= 0 temp___205) (<= temp___205 100)) (=> (<= i16 temp___205) (= (select a22 temp___205) (select temp___204 temp___205))))) (and (<= 0 i16) (<= i16 k2)))))
