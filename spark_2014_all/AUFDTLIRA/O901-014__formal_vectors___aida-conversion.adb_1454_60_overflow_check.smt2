...
(assert (<= temp___1883 index2))
(assert (<= index2 temp___1884))
...
(assert (= n1 result4))
(assert (= n2 o45))
(assert (forall ((i2 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 8) i2) (<= i2 index3)) (and (<= 0 (to_rep1 (select n3 i2))) (<= (to_rep1 (select n3 i2)) 9)))))
(assert (forall ((j1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 8) j1) (<= j1 index3)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1))))))
(assert (and (and (forall ((temp___1881 Int)) (=> (and (<= (to_rep1 n__first) temp___1881) (<= temp___1881 (to_rep1 n__last))) (=> (< index3 temp___1881) (= (select n3 temp___1881) (select n1 temp___1881))))) (=> (<= (+ (to_rep1 (first (rt source))) 8) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 8) (+ (to_rep1 (first (rt source))) 10) index3))) (and (<= (+ (to_rep1 (first (rt source))) 8) index3) (<= index3 (+ (to_rep1 (first (rt source))) 10)))))
