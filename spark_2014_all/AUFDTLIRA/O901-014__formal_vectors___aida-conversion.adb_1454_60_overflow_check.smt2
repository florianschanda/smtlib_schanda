...
(assert (<= temp___1883 index1))
(assert (<= index1 temp___1884))
...
(assert (and (and (forall ((temp___1881 Int)) (=> (and (<= (to_rep1 n__first) temp___1881) (<= temp___1881 (to_rep1 n__last))) (=> (< index2 temp___1881) (= (select n3 temp___1881) (select n1 temp___1881))))) (=> (<= (+ (to_rep1 (first (rt source))) 8) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 8) (+ (to_rep1 (first (rt source))) 10) index2))) (and (<= (+ (to_rep1 (first (rt source))) 8) index2) (<= index2 (+ (to_rep1 (first (rt source))) 10)))))
