...
(declare-fun union__function_guard ((Array Int Bool) (Array Int Bool) (Array Int Bool)) Bool)
(declare-fun mem ((Array Int Bool) Int) Bool)
(declare-fun mem__function_guard (Bool (Array Int Bool) Int) Bool)
(assert (forall ((a (Array Int Bool)) (b (Array Int Bool))) (! (forall ((elt Int)) (=> (and (<= 1 elt) (<= elt 10)) (= (= (mem (union1 a b) elt) true) (or (= (mem a elt) true) (= (mem b elt) true))))) :pattern ((union1 a b)))))
...
(define-fun dynamic_invariant ((temp___expr_267 Int) (temp___is_init_264 Bool) (temp___skip_constant_265 Bool) (temp___do_toplevel_266 Bool)) Bool (=> (or (= temp___is_init_264 true) (<= 1 10)) (in_range temp___expr_267)))
(assert true)
