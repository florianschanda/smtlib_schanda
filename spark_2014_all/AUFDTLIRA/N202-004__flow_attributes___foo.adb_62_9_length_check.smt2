...
(declare-fun temp_____aggregate_def_300 (Int Int Int) us_t1)
...
(assert (= (to_rep1 (first2 (rt1 (temp_____aggregate_def_300 32 (to_rep1 a__first) (to_rep1 a__last))))) (to_rep1 a__first)))
(assert (= (to_rep1 (last2 (rt1 (temp_____aggregate_def_300 32 (to_rep1 a__first) (to_rep1 a__last))))) (to_rep1 a__last)))
(assert (= (mk___t1 temp___307 temp___3071) (temp_____aggregate_def_300 32 (to_rep1 a__first) (to_rep1 a__last))))
(assert (= temp___307 temp___308))
(assert (= (mk (to_rep1 (first2 temp___3071)) (to_rep1 (last2 temp___3071))) temp___3081))
(assert (not (= (ite (<= (to_rep1 (first temp___3081)) (to_rep1 (last temp___3081))) (+ (- (to_rep1 (last temp___3081)) (to_rep1 (first temp___3081))) 1) 0) (ite (<= (to_rep1 a__first) (to_rep1 a__last)) (+ (- (to_rep1 a__last) (to_rep1 a__first)) 1) 0))))
(check-sat)
(exit)
