...
(assert (= null_stack (mk___rep (mk___split_fields (of_rep 0) (temp___155 (- 2147483648))))))
...
(declare-const temp___280 length_t)
(declare-const temp___2801 (Array Int integer))
...
(declare-const dst__split_fields9 us_split_fields__ref1)
(declare-const dst__split_fields10 us_split_fields2)
(define-fun dst__split_fields11 () us_split_fields2 (mk___split_fields1 dst__split_fields6 (mk___rep (mk___split_fields dst__split_fields7 dst__split_fields8))))
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= (temp___155 (- 2147483648)) o2))
(assert (= temp___280 o1))
(assert (= temp___2801 o2))
(assert (= (mk___rep (mk___split_fields temp___280 temp___2801)) null_stack))
...
(assert (= dst__split_fields9 (mk___split_fields__ref1 dst__split_fields11)))
(assert (= dst__split_fields10 dst__split_fields11))
(assert (not (= (bool_eq2 (mk___rep1 (us_split_fields__content1 dst__split_fields9)) (mk___rep1 (mk___split_fields1 (bool_eq1 src null_stack) src))) true)))
(check-sat)
(exit)
