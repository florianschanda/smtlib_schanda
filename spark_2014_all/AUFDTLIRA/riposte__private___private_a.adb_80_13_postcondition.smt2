...
(define-fun dynamic_invariant1 ((temp___expr_155 Int) (temp___is_init_152 Bool) (temp___skip_constant_153 Bool) (temp___do_toplevel_154 Bool)) Bool (=> (or (= temp___is_init_152 true) (<= 0 100)) (in_range temp___expr_155)))
(assert (= null_stack (mk___rep (mk___split_fields (of_rep 0) (temp___133 (- 2147483648))))))
...
(declare-const temp___249 length_t)
(declare-const temp___2491 (Array Int integer))
...
(assert (= (mk___rep (mk___split_fields temp___249 temp___2491)) null_stack))
...
(assert (= dst__split_fields9 (mk___split_fields__ref1 (mk___split_fields1 dst__split_fields6 (mk___rep (mk___split_fields dst__split_fields7 dst__split_fields8))))))
(assert (= dst__split_fields10 (mk___split_fields1 dst__split_fields6 (mk___rep (mk___split_fields dst__split_fields7 dst__split_fields8)))))
