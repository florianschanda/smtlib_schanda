...
(assert (<= 0 i4))
(assert (<= i4 149))
(assert (and (<= 0 i5) (<= i5 149)))
(assert (and (= temp___1511 (+ (to_rep1 (first (rt description))) i5)) (in_range1 (+ (to_rep1 (first (rt description))) i5))))
(assert (not (<= (to_rep1 (first (rt description))) temp___1511)))
(check-sat)
(exit)
