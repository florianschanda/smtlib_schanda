...
(assert (forall ((stack_14__pointer Int)) (forall ((stack_14__s (Array Int integer))) (! (=> (and (dynamic_invariant1 stack_14__pointer true true true) (not (= (is_empty stack_14__pointer) true))) (dynamic_invariant (top stack_14__pointer stack_14__s) true false true)) :pattern ((top stack_14__pointer stack_14__s))))))
(assert (forall ((stack_14__pointer Int)) (forall ((stack_14__s (Array Int integer))) (! (=> (dynamic_invariant1 stack_14__pointer true true true) (= (top stack_14__pointer stack_14__s) (to_rep (select stack_14__s stack_14__pointer)))) :pattern ((top stack_14__pointer stack_14__s))))))
(declare-const x Int)
...
(declare-const s2 (Array Int integer))
(declare-const pointer2 Int)
(declare-const s3 (Array Int integer))
