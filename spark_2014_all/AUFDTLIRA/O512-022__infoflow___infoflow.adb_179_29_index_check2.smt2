...
(declare-const temp___476 (Array Int integer))
(declare-const o Int)
...
(define-fun a_v18 () map__ref (mk_map__ref a_v16))
...
(assert (= i_v11 (to_rep a_v1__first)))
(assert (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1)) (= temp___478 i_v11)))
(assert (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1)) (= temp___476 a_v1)))
(assert (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1)) (forall ((m1 Int)) (=> (and (<= (to_rep a_v1__first) m1) (<= m1 (- i_v12 1))) (= (to_rep (select a_v12 m1)) (to_rep (select (elts b_v1) m1)))))))
(assert (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1)) (and (and (forall ((temp___477 Int)) (=> (and (<= (to_rep a_v1__first) temp___477) (<= temp___477 (to_rep a_v1__last))) (=> (or (< k_1 temp___477) (or (< temp___477 (to_rep a_v1__first)) (<= i_v12 temp___477))) (= (select a_v12 temp___477) (select temp___476 temp___477))))) (=> (<= (to_rep a_v1__first) k_1) (dynamic_property1 (to_rep a_v1__first) k_1 i_v12))) (and (<= (to_rep a_v1__first) i_v12) (<= i_v12 k_1)))))
(assert (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1)) (and (<= (to_rep (first (rt b_v1))) i_v12) (<= i_v12 (to_rep (last (rt b_v1)))))))
(assert (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1)) (= o i_v12)))
(assert (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1)) (= o1 (select (elts b_v1) o))))
(assert (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1)) (= o2 (to_rep o1))))
(assert (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1)) (= (to_rep o3) o2)))
(assert (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1)) (and (<= (to_rep a_v1__first) i_v12) (<= i_v12 (to_rep a_v1__last)))))
(assert (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1)) (= o4 i_v12)))
(assert (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1)) (= o5 (store a_v12 o4 o3))))
(assert (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1)) (= a_v12 result1)))
(assert (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1)) (= a_v13 o5)))
(assert (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1)) (= i_v12 k_1)))
(assert (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1)) (= i_v12 i_v13)))
(assert (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1)) (= a_v13 a_v14)))
(assert (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1)) (= i_v14 i_v12)))
(assert (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1)) (= a_v15 a_v13)))
(assert (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1)) (= (mk_int__ref i_v15) (mk_int__ref i_v13))))
(assert (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1)) (= a_v18 (mk_map__ref a_v14))))
(assert (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1)) (= i_v16 i_v14)))
(assert (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1)) (= a_v17 a_v15)))
(assert (=> (not (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1))) (= i_v11 i_v15)))
(assert (=> (not (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1))) (= a_v18 (mk_map__ref a_v1))))
(assert (=> (not (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1))) (= i_v16 i_v11)))
(assert (=> (not (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1))) (= a_v17 a_v11)))
(assert (<= (to_rep a_v1__first) m))
(assert (<= m k_1))
(assert (not (<= (to_rep (first (rt b_v1))) m)))
(check-sat)
(exit)
