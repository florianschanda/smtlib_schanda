...
(declare-const temp___2029 Int)
(declare-const temp___2030 Int)
(declare-const o Int)
...
(assert (and (= o25 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (= o26 (ite (<= index o25) true false)))
(assert (and (= o24 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (= o27 (ite (<= o24 index) true false)))
(assert (= result (ite (= o27 true) o26 false)))
(assert (= (= o28 true) (forall ((index1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 7) index1) (<= index1 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index1))) true)))))
(assert (and (= temp___2035 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (<= (to_rep1 (first (rt source))) temp___2035) (<= temp___2035 (to_rep1 (last (rt source))))))
(assert (= o20 temp___2035))
(assert (= o21 (select (elts source) o20)))
(assert (= o22 (to_rep o21)))
(assert (= o23 (ite (< o22 51) true false)))
(assert (and (= temp___2034 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (<= (to_rep1 (first (rt source))) temp___2034) (<= temp___2034 (to_rep1 (last (rt source))))))
(assert (= o16 temp___2034))
(assert (= o17 (select (elts source) o16)))
(assert (= o18 (to_rep o17)))
(assert (= o19 (ite (= o18 56) true false)))
(assert (and (= temp___2033 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 (first (rt source))) temp___2033) (<= temp___2033 (to_rep1 (last (rt source))))))
(assert (= o12 temp___2033))
(assert (= o13 (select (elts source) o12)))
(assert (= o14 (to_rep o13)))
(assert (= o15 (ite (= o14 52) true false)))
(assert (and (= temp___2032 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 (first (rt source))) temp___2032) (<= temp___2032 (to_rep1 (last (rt source))))))
(assert (= o8 temp___2032))
(assert (= o9 (select (elts source) o8)))
(assert (= o10 (to_rep o9)))
(assert (= o11 (ite (= o10 55) true false)))
(assert (and (= temp___2031 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 (first (rt source))) temp___2031) (<= temp___2031 (to_rep1 (last (rt source))))))
(assert (= o4 temp___2031))
(assert (= o5 (select (elts source) o4)))
(assert (= o6 (to_rep o5)))
(assert (= o7 (ite (= o6 52) true false)))
(assert (and (= temp___2030 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 (first (rt source))) temp___2030) (<= temp___2030 (to_rep1 (last (rt source))))))
(assert (= o temp___2030))
(assert (= o1 (select (elts source) o)))
(assert (= o2 (to_rep o1)))
(assert (= o3 (ite (= o2 49) true false)))
(assert (and (= temp___2029 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (not (<= (to_rep1 (first (rt source))) temp___2029)))
(check-sat)
(exit)
