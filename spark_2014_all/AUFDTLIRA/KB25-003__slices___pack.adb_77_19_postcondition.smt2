...
(assert (forall ((temp___510 Int) (temp___511 Int) (temp___512 Int)) (let ((temp___509 (temp___508 temp___510 temp___511 temp___512))) (and (=> (dynamic_property 0 2147483647 temp___511 temp___512) (and (= (first3 temp___509) temp___511) (= (last3 temp___509) temp___512))) (forall ((temp___513 Int)) (= (select (to_array1 temp___509) temp___513) (of_rep temp___510)))))))
...
(define-fun dynamic_invariant2 ((temp___expr_169 us_t) (temp___is_init_166 Bool) (temp___skip_constant_167 Bool) (temp___do_toplevel_168 Bool)) Bool (=> (not (= temp___skip_constant_167 true)) (dynamic_property 0 2147483647 (first1 temp___expr_169) (last1 temp___expr_169))))
...
(assert (= (to_rep (first2 (rt1 (temp___508 1 (to_rep a__first) (to_rep a__last))))) (to_rep a__first)))
(assert (= (to_rep (last2 (rt1 (temp___508 1 (to_rep a__first) (to_rep a__last))))) (to_rep a__last)))
(assert (= (mk___t1 temp___515 temp___5151) (temp___508 1 (to_rep a__first) (to_rep a__last))))
(assert (= temp___515 temp___516))
(assert (= (mk (to_rep (first2 temp___5151)) (to_rep (last2 temp___5151))) temp___5161))
(assert (= (ite (<= (to_rep (first temp___5161)) (to_rep (last temp___5161))) (+ (- (to_rep (last temp___5161)) (to_rep (first temp___5161))) 1) 0) (ite (<= (to_rep a__first) (to_rep a__last)) (+ (- (to_rep a__last) (to_rep a__first)) 1) 0)))
(assert (= (mk___t temp___517 temp___5171) (mk___t temp___516 temp___5161)))
(assert (= o (slide temp___517 (to_rep (first temp___5171)) (to_rep a__first))))
...
(assert (not (= (to_rep (select a2 j)) 1)))
(check-sat)
(exit)
