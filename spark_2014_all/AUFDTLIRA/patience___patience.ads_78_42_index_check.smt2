...
(assert (= o20 (ite (<= o19 (- (to_rep (rec__patience__state__numstacks (us_split_fields1 s))) 1)) true false)))
(assert (and (<= 0 i) (<= i 99)))
(assert (= o14 i))
(assert (= o15 (select (rec__patience__state__posstack (us_split_fields1 s)) o14)))
...
(assert (=> (= result2 true) (= o6 (select (rec__patience__state__posstack (us_split_fields1 s)) o5))))
(assert (=> (= result2 true) (= temp___438 (to_rep o6))))
(assert (=> (= result2 true) (and (<= 0 temp___438) (<= temp___438 99))))
(assert (=> (= result2 true) (= o7 temp___438)))
(assert (=> (= result2 true) (= o8 (select (rec__patience__state__stacksizes (us_split_fields1 s)) o7))))
(assert (=> (= result2 true) (= o9 (to_rep o8))))
...
(assert (=> (= result2 true) (= o11 (to_rep o4))))
(assert (=> (= result2 true) (= o12 (ite (<= o11 o10) true false))))
(assert (=> (= result2 true) (and (<= 0 i) (<= i 99))))
(assert (=> (= result2 true) (= o i)))
(assert (=> (= result2 true) (= o1 (select (rec__patience__state__posheight (us_split_fields1 s)) o))))
(assert (=> (= result2 true) (= o2 (to_rep o1))))
