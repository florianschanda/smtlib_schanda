...
(assert (= o28 (select temp___1605 i2)))
...
(assert (= o32 (+ o31 1)))
(assert (and (= o33 o32) (in_range8 o32)))
(assert (and (= temp___1604 (model__ f_old v)) (and (dynamic_invariant5 temp___1604 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1604 v))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1604 v)))) 0) (and (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (=> (not (= i3 v)) (ite (and (not (= (parent f_old i3) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1604 (parent f_old i3)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1604 i3))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1604 i3))) true)))))) (and (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1604 i3))) true) (not (= i3 v))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select temp___1604 (parent f_old i3)))) (position f_old i3) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1604 i3)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1604 i3)))) 0)))) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1604 i3))) true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1604 j2))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select temp___1604 i3))) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1604 j2)))) true)) (= j2 i3))))))))))))))
(assert (= o25 (select temp___1604 j1)))
(assert (= o26 (us_split_fields5 o25)))
(assert (= o27 (rec__tree_model__path_type__a o26)))
(assert (and (= o34 (get o27 o33)) (in_range3 o34)))
(assert (and (= temp___1603 (model__ f root)) (and (dynamic_invariant5 temp___1603 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1603 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1603 root)))) 0) (and (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (=> (not (= i3 root)) (ite (and (not (= (parent f i3) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1603 (parent f i3)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1603 i3))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1603 i3))) true)))))) (and (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1603 i3))) true) (not (= i3 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select temp___1603 (parent f i3)))) (position f i3) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1603 i3)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1603 i3)))) 0)))) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1603 i3))) true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1603 j2))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select temp___1603 i3))) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1603 j2)))) true)) (= j2 i3))))))))))))))
(assert (= o20 (select temp___1603 i2)))
