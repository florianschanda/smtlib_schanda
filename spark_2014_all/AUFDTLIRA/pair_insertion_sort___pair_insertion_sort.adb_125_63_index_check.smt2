...
(assert (=> (= result1 true) (and (= temp___264 (+ (int__content j7) 2)) (in_range1 (+ (int__content j7) 2)))))
...
(assert (=> (= result1 true) (=> (= result12 true) (= temp___268 (map__content a9)))))
(assert (=> (= result1 true) (=> (= result12 true) (= temp___265 (int__content j7)))))
...
(assert (< 0 j21))
(assert (and (= temp___285 (- j21 1)) (in_range1 (- j21 1))))
