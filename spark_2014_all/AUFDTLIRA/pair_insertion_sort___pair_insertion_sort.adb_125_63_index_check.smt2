...
(assert (=> (= result1 true) (= (mk_int__ref result2) (mk_int__ref x))))
(assert (=> (= result1 true) (= x2 o5)))
(assert (=> (= result1 true) (and (= temp___254 (+ i1 1)) (in_range1 (+ i1 1)))))
(assert (=> (= result1 true) (and (<= (to_rep a__first) temp___254) (<= temp___254 (to_rep a__last)))))
(assert (=> (= result1 true) (= o6 temp___254)))
(assert (=> (= result1 true) (= o7 (select a o6))))
(assert (=> (= result1 true) (= o8 (to_rep o7))))
(assert (=> (= result1 true) (= (mk_int__ref result3) (mk_int__ref y))))
(assert (=> (= result1 true) (= y2 o8)))
(assert (=> (= result1 true) (=> (< x2 y2) (= (mk_int__ref result4) (mk_int__ref z)))))
...
(assert (=> (= result1 true) (= (mk_int__ref result7) (mk_int__ref j))))
...
(assert (=> (= result1 true) (=> (= result8 true) (and (and (= temp___258 a) (and (= temp___255 j2) (and (and (and (= o15 j2) (in_range2 j2)) (and (and (and (= o13 (+ j2 2)) (in_range1 (+ j2 2))) (and (= o14 o13) (in_range2 o13))) (and (and (= (is_perm (mk___t a (mk (to_rep a__first) (to_rep a__last))) (mk___t a2 (mk (to_rep a__first) (to_rep a__last)))) true) (and (= (to_rep (select a2 o14)) (to_rep (select a o15))) (and (= (to_rep (select a2 o15)) (to_rep (select a o14))) (forall ((z15 Int)) (=> (and (<= (to_rep a__first) z15) (<= z15 (to_rep a__last))) (=> (and (not (= z15 o14)) (not (= z15 o15))) (= (to_rep (select a2 z15)) (to_rep (select a z15))))))))) (= (to_rep a__first) 0)))) (and (and (and (<= 0 j3) (<= j3 (- (ite (<= (to_rep a__first) (to_rep a__last)) (+ (- (to_rep a__last) (to_rep a__first)) 1) 0) 3))) (and (= (sorted (mk___t a3 (mk (to_rep a__first) (to_rep a__last))) 0 (- j3 1)) true) (and (= (sorted (mk___t a3 (mk (to_rep a__first) (to_rep a__last))) (+ j3 2) (+ i1 1)) true) (and (=> (< 0 j3) (<= (to_rep (select a3 (- j3 1))) (to_rep (select a3 (+ j3 2))))) (and (< x3 (to_rep (select a3 (+ j3 2)))) (and (= (is_perm (mk___t (elts1 b) (mk (to_rep (first2 (rt1 b))) (to_rep (last2 (rt1 b))))) (mk___t a3 (mk (to_rep a__first) (to_rep a__last)))) true) (or (and (= (to_rep (select a3 j3)) x3) (= (to_rep (select a3 (+ j3 1))) y3)) (and (= (to_rep (select a3 j3)) y3) (= (to_rep (select a3 (+ j3 1))) x3))))))))) (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 j3)) (= (to_rep a__first) 0)) (and (and (and (= o37 (- j3 1)) (in_range1 (- j3 1))) (and (= j3 result9) (= j4 o37))) (and (and (ite (<= 0 j4) (and (and (and (and (and (<= (to_rep a__first) j4) (<= j4 (to_rep a__last))) (= o38 j4)) (= o39 (select a3 o38))) (= o40 (to_rep o39))) (= o41 (ite (< x3 o40) true false))) (= o41 false)) (= result10 (ite (not (= o41 true)) true false))) (= result10 true)))))))) (and (and (= j4 j7) (= a3 a7)) (and (= j8 j4) (= a8 a3)))))))
(assert (=> (= result1 true) (=> (= result8 true) (= j9 (mk_int__ref j7)))))
(assert (=> (= result1 true) (=> (= result8 true) (= (mk_map__ref a9) (mk_map__ref a7)))))
(assert (=> (= result1 true) (=> (= result8 true) (= j10 j8))))
(assert (=> (= result1 true) (=> (= result8 true) (= a10 a8))))
(assert (=> (= result1 true) (=> (not (= result8 true)) (= j9 (mk_int__ref j2)))))
(assert (=> (= result1 true) (=> (not (= result8 true)) (= (mk_map__ref a9) (mk_map__ref a)))))
(assert (=> (= result1 true) (=> (not (= result8 true)) (= j10 j2))))
(assert (=> (= result1 true) (=> (not (= result8 true)) (= a10 a1))))
(assert (=> (= result1 true) (and (= temp___264 (+ (int__content j9) 2)) (in_range1 (+ (int__content j9) 2)))))
(assert (=> (= result1 true) (and (<= (to_rep a__first) temp___264) (<= temp___264 (to_rep a__last)))))
(assert (=> (= result1 true) (= o45 temp___264)))
(assert (=> (= result1 true) (= o46 (select a9 o45))))
(assert (=> (= result1 true) (= o47 (to_rep o46))))
(assert (=> (= result1 true) (= o48 (ite (= o47 x3) true false))))
(assert (=> (= result1 true) (= result11 (ite (not (= o48 true)) true false))))
(assert (=> (= result1 true) (=> (= result11 true) (and (= o51 (+ (int__content j9) 1)) (in_range1 (+ (int__content j9) 1))))))
(assert (=> (= result1 true) (=> (= result11 true) (and (= o52 o51) (in_range2 o51)))))
(assert (=> (= result1 true) (=> (= result11 true) (and (= o49 (+ (int__content j9) 2)) (in_range1 (+ (int__content j9) 2))))))
(assert (=> (= result1 true) (=> (= result11 true) (and (= o50 o49) (in_range2 o49)))))
(assert (=> (= result1 true) (=> (= result11 true) (and (and (= (is_perm (mk___t a9 (mk (to_rep a__first) (to_rep a__last))) (mk___t a11 (mk (to_rep a__first) (to_rep a__last)))) true) (and (= (to_rep (select a11 o50)) (to_rep (select a9 o52))) (and (= (to_rep (select a11 o52)) (to_rep (select a9 o50))) (forall ((z15 Int)) (=> (and (<= (to_rep a__first) z15) (<= z15 (to_rep a__last))) (=> (and (not (= z15 o50)) (not (= z15 o52))) (= (to_rep (select a11 z15)) (to_rep (select a9 z15))))))))) (= (to_rep a__first) 0)))))
(assert (=> (= result1 true) (=> (= result11 true) (= a12 (mk_map__ref a11)))))
(assert (=> (= result1 true) (=> (= result11 true) (= a13 a11))))
(assert (=> (= result1 true) (=> (not (= result11 true)) (= a12 (mk_map__ref a9)))))
(assert (=> (= result1 true) (=> (not (= result11 true)) (= a13 a10))))
(assert (=> (= result1 true) (=> (<= 0 (int__content j9)) (and (<= (to_rep a__first) (int__content j9)) (<= (int__content j9) (to_rep a__last))))))
(assert (=> (= result1 true) (=> (<= 0 (int__content j9)) (= o53 (int__content j9)))))
(assert (=> (= result1 true) (=> (<= 0 (int__content j9)) (= o54 (select (map__content a12) o53)))))
(assert (=> (= result1 true) (=> (<= 0 (int__content j9)) (= o55 (to_rep o54)))))
(assert (=> (= result1 true) (=> (<= 0 (int__content j9)) (= result12 (ite (< y3 o55) true false)))))
(assert (=> (= result1 true) (=> (not (<= 0 (int__content j9))) (= result12 false))))
(assert (=> (= result1 true) (=> (= result12 true) (and (and (= temp___268 (map__content a12)) (and (= temp___265 (int__content j9)) (and (and (and (= o58 (int__content j9)) (in_range2 (int__content j9))) (and (and (and (= o56 (+ (int__content j9) 1)) (in_range1 (+ (int__content j9) 1))) (and (= o57 o56) (in_range2 o56))) (and (and (= (is_perm (mk___t (map__content a12) (mk (to_rep a__first) (to_rep a__last))) (mk___t a14 (mk (to_rep a__first) (to_rep a__last)))) true) (and (= (to_rep (select a14 o57)) (to_rep (select (map__content a12) o58))) (and (= (to_rep (select a14 o58)) (to_rep (select (map__content a12) o57))) (forall ((z15 Int)) (=> (and (<= (to_rep a__first) z15) (<= z15 (to_rep a__last))) (=> (and (not (= z15 o57)) (not (= z15 o58))) (= (to_rep (select a14 z15)) (to_rep (select (map__content a12) z15))))))))) (= (to_rep a__first) 0)))) (and (and (and (<= 0 j11) (<= j11 (- (ite (<= (to_rep a__first) (to_rep a__last)) (+ (- (to_rep a__last) (to_rep a__first)) 1) 0) 3))) (and (= (sorted (mk___t a15 (mk (to_rep a__first) (to_rep a__last))) 0 (- j11 1)) true) (and (= (sorted (mk___t a15 (mk (to_rep a__first) (to_rep a__last))) (+ j11 1) (+ i1 1)) true) (and (=> (< 0 j11) (<= (to_rep (select a15 (- j11 1))) (to_rep (select a15 (+ j11 1))))) (and (< y3 (to_rep (select a15 (+ j11 1)))) (and (= (is_perm (mk___t (elts1 b) (mk (to_rep (first2 (rt1 b))) (to_rep (last2 (rt1 b))))) (mk___t a15 (mk (to_rep a__first) (to_rep a__last)))) true) (= (to_rep (select a15 j11)) y3))))))) (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 j11)) (= (to_rep a__first) 0)) (and (and (and (= o67 (- j11 1)) (in_range1 (- j11 1))) (and (= result13 (mk_int__ref j11)) (= j12 o67))) (and (and (ite (<= 0 j12) (and (and (and (and (and (<= (to_rep a__first) j12) (<= j12 (to_rep a__last))) (= o68 j12)) (= o69 (select a15 o68))) (= o70 (to_rep o69))) (= o71 (ite (< y3 o70) true false))) (= o71 false)) (= result14 (ite (not (= o71 true)) true false))) (= result14 true)))))))) (and (and (= j17 (mk_int__ref j12)) (= a21 (mk_map__ref a15))) (and (= j18 j12) (= a22 a15)))))))
(assert (=> (= result1 true) (=> (= result12 true) (= j19 j17))))
(assert (=> (= result1 true) (=> (= result12 true) (= a23 a21))))
(assert (=> (= result1 true) (=> (= result12 true) (= j20 j18))))
(assert (=> (= result1 true) (=> (= result12 true) (= a24 a22))))
(assert (=> (= result1 true) (=> (not (= result12 true)) (= j19 j9))))
(assert (=> (= result1 true) (=> (not (= result12 true)) (= a23 a12))))
(assert (=> (= result1 true) (=> (not (= result12 true)) (= j20 j10))))
(assert (=> (= result1 true) (=> (not (= result12 true)) (= a24 a13))))
(assert (=> (= result1 true) (and (<= 0 i2) (<= i2 (- (ite (<= (to_rep a__first) (to_rep a__last)) (+ (- (to_rep a__last) (to_rep a__first)) 1) 0) 2)))))
(assert (=> (= result1 true) (and (<= (- 1) j21) (<= j21 (- (ite (<= (to_rep a__first) (to_rep a__last)) (+ (- (to_rep a__last) (to_rep a__first)) 1) 0) 3)))))
(assert (=> (= result1 true) (= (sorted (mk___t a25 (mk (to_rep a__first) (to_rep a__last))) 0 (+ i2 1)) true)))
(assert (=> (= result1 true) (= (is_perm (mk___t (elts1 b) (mk (to_rep (first2 (rt1 b))) (to_rep (last2 (rt1 b))))) (mk___t a25 (mk (to_rep a__first) (to_rep a__last)))) true)))
(assert (=> (= result1 true) (and (and (and (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 j21)) (=> (<= (- 2147483648) 2147483647) (in_range1 x4))) (=> (<= (- 2147483648) 2147483647) (in_range1 y4))) (=> (<= (- 2147483648) 2147483647) (in_range1 z3))) (= (to_rep a__first) 0)) (=> (<= (- 2147483648) 2147483647) (in_range1 i2)))))
(assert (=> (= result1 true) (and (= o80 (+ i2 2)) (in_range1 (+ i2 2)))))
(assert (=> (= result1 true) (= result15 (mk_int__ref i2))))
(assert (=> (= result1 true) (= i3 o80)))
(assert (=> (= result1 true) (=> (<= (to_rep a__first) (to_rep a__last)) (= o81 (+ (- (to_rep a__last) (to_rep a__first)) 1)))))
(assert (=> (= result1 true) (=> (not (<= (to_rep a__first) (to_rep a__last))) (= o81 0))))
(assert (=> (= result1 true) (and (= o82 o81) (in_range1 o81))))
(assert (=> (= result1 true) (= o83 (- o82 1))))
(assert (=> (= result1 true) (= o84 (ite (< i3 o83) true false))))
(assert (=> (= result1 true) (= result16 (ite (not (= o84 true)) true false))))
(assert (=> (= result1 true) (= result16 true)))
(assert (=> (= result1 true) (= z9 (mk_int__ref z3))))
(assert (=> (= result1 true) (= y11 (mk_int__ref y4))))
(assert (=> (= result1 true) (= x11 (mk_int__ref x4))))
(assert (=> (= result1 true) (= j45 (mk_int__ref j21))))
(assert (=> (= result1 true) (= i6 (mk_int__ref i3))))
(assert (=> (= result1 true) (= a53 (mk_map__ref a25))))
(assert (=> (= result1 true) (= z10 z3)))
(assert (=> (= result1 true) (= y12 y4)))
(assert (=> (= result1 true) (= x12 x4)))
(assert (=> (= result1 true) (= j46 j21)))
(assert (=> (= result1 true) (= i7 i3)))
(assert (=> (= result1 true) (= a54 a25)))
(assert (=> (= result1 true) (= z11 z9)))
(assert (=> (= result1 true) (= y13 y11)))
(assert (=> (= result1 true) (= x13 x11)))
(assert (=> (= result1 true) (= j47 j45)))
(assert (=> (= result1 true) (= i8 i6)))
(assert (=> (= result1 true) (= a55 a53)))
(assert (=> (= result1 true) (= z12 z10)))
(assert (=> (= result1 true) (= y14 y12)))
(assert (=> (= result1 true) (= x14 x12)))
(assert (=> (= result1 true) (= j48 j46)))
(assert (=> (= result1 true) (= i9 i7)))
(assert (=> (= result1 true) (= a56 a54)))
(assert (=> (not (= result1 true)) (= z11 (mk_int__ref z))))
(assert (=> (not (= result1 true)) (= y13 (mk_int__ref y))))
(assert (=> (not (= result1 true)) (= x13 (mk_int__ref x))))
(assert (=> (not (= result1 true)) (= j47 (mk_int__ref j))))
(assert (=> (not (= result1 true)) (= i8 (mk_int__ref i1))))
(assert (=> (not (= result1 true)) (= a55 (mk_map__ref a))))
(assert (=> (not (= result1 true)) (= z12 z1)))
(assert (=> (not (= result1 true)) (= y14 y1)))
(assert (=> (not (= result1 true)) (= x14 x1)))
(assert (=> (not (= result1 true)) (= j48 j1)))
(assert (=> (not (= result1 true)) (= i9 i1)))
(assert (=> (not (= result1 true)) (= a56 a1)))
(assert (=> (<= (to_rep a__first) (to_rep a__last)) (= o157 (+ (- (to_rep a__last) (to_rep a__first)) 1))))
(assert (=> (not (<= (to_rep a__first) (to_rep a__last))) (= o157 0)))
(assert (and (= o158 o157) (in_range1 o157)))
(assert (= o159 (- o158 1)))
(assert (= result30 (ite (= (int__content i8) o159) true false)))
(assert (= result30 true))
(assert (and (<= (to_rep a__first) (int__content i8)) (<= (int__content i8) (to_rep a__last))))
(assert (= o160 (int__content i8)))
(assert (= o161 (select (map__content a55) o160)))
(assert (= o162 (to_rep o161)))
(assert (= result31 y13))
(assert (= y15 o162))
(assert (and (= o163 (- (int__content i8) 1)) (in_range1 (- (int__content i8) 1))))
(assert (= result32 j47))
(assert (= j49 o163))
(assert (=> (<= 0 j49) (and (<= (to_rep a__first) j49) (<= j49 (to_rep a__last)))))
(assert (=> (<= 0 j49) (= o164 j49)))
(assert (=> (<= 0 j49) (= o165 (select (map__content a55) o164))))
(assert (=> (<= 0 j49) (= o166 (to_rep o165))))
(assert (=> (<= 0 j49) (= result33 (ite (< y15 o166) true false))))
(assert (=> (not (<= 0 j49)) (= result33 false)))
(assert (= result33 true))
(assert (and (= o169 j49) (in_range2 j49)))
(assert (and (= o167 (+ j49 1)) (in_range1 (+ j49 1))))
(assert (and (= o168 o167) (in_range2 o167)))
(assert (and (and (= (is_perm (mk___t (map__content a55) (mk (to_rep a__first) (to_rep a__last))) (mk___t a57 (mk (to_rep a__first) (to_rep a__last)))) true) (and (= (to_rep (select a57 o168)) (to_rep (select (map__content a55) o169))) (and (= (to_rep (select a57 o169)) (to_rep (select (map__content a55) o168))) (forall ((z15 Int)) (=> (and (<= (to_rep a__first) z15) (<= z15 (to_rep a__last))) (=> (and (not (= z15 o168)) (not (= z15 o169))) (= (to_rep (select a57 z15)) (to_rep (select (map__content a55) z15))))))))) (= (to_rep a__first) 0)))
(assert (and (<= 0 j50) (<= j50 (- (ite (<= (to_rep a__first) (to_rep a__last)) (+ (- (to_rep a__last) (to_rep a__first)) 1) 0) 2))))
(assert (= (sorted (mk___t a58 (mk (to_rep a__first) (to_rep a__last))) 0 (- j50 1)) true))
(assert (= (sorted (mk___t a58 (mk (to_rep a__first) (to_rep a__last))) (+ j50 1) (- (ite (<= (to_rep a__first) (to_rep a__last)) (+ (- (to_rep a__last) (to_rep a__first)) 1) 0) 1)) true))
(assert (=> (< 0 j50) (<= (to_rep (select a58 (- j50 1))) (to_rep (select a58 (+ j50 1))))))
(assert (< y15 (to_rep (select a58 (+ j50 1)))))
(assert (= (is_perm (mk___t (elts1 b) (mk (to_rep (first2 (rt1 b))) (to_rep (last2 (rt1 b))))) (mk___t a58 (mk (to_rep a__first) (to_rep a__last)))) true))
(assert (= (to_rep (select a58 j50)) y15))
(assert (and (=> (<= (- 2147483648) 2147483647) (in_range1 j50)) (= (to_rep a__first) 0)))
(assert (< 0 j50))
(assert (and (= temp___285 (- j50 1)) (in_range1 (- j50 1))))
(assert (not (<= (to_rep a__first) temp___285)))
(check-sat)
(exit)
