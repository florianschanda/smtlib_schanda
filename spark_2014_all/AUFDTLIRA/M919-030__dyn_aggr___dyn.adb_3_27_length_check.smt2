...
(assert (= (mk___t1 temp___183 temp___1831) (dyn__x__aggregate_def 48 r3b r3b)))
(assert (not (= (ite (<= (to_rep1 (first2 temp___1831)) (to_rep1 (last2 temp___1831))) (+ (- (to_rep1 (last2 temp___1831)) (to_rep1 (first2 temp___1831))) 1) 0) (ite (<= r1b r2b) (+ (- r2b r1b) 1) 0))))
(check-sat)
(exit)
