...
(assert (and (= o11 (to_rep1 (rec__search_trees__search_tree__root t__split_fields7))) (in_range5 (to_rep1 (rec__search_trees__search_tree__root t__split_fields7)))))
(assert (not (= (valid_root (rec__search_trees__search_tree__struct t__split_fields7) o11) true)))
(check-sat)
(exit)
