...
(assert (and (= o37 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i 0)) (and (in_range3 o37) (= o37 (peek1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) i 0)))))
(assert (= (mk___rep5 (mk___split_fields5 o38 o39 o40)) (select res2 o37)))
(assert (= o41 (mk___split_fields5 o38 o39 o40)))
(assert (= o42 (rec__red_black_trees__black_count__count o41)))
(assert (= o43 (to_rep o42)))
(assert (=> (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) i)) 0) (= o44 1)))
(assert (=> (not (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) i)) 0)) (= o44 0)))
(assert (= o45 (+ o44 o43)))
(assert (and (= o46 o45) (in_range1 o45)))
(assert (= o47 (ite (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res2 i)))) o46) true false)))
