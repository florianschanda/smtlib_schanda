...
(declare-const temp___263 token_kind)
(declare-const temp___2631 integer)
(declare-const temp___2632 operation)
(declare-const temp___2633 instruction)
(declare-const temp___2634 Bool)
...
(assert (= (mk___rep (mk___split_fields o18)) (read1 (mk___t word1 (mk (to_rep1 word__first) (to_rep1 word__last))))))
(assert (= o19 o18))
(assert (= dummy6 o20))
(assert (= dummy4 o21))
(assert (= (to_rep4 o17) 0))
(assert (= o17 o22))
(assert (= temp___263 o22))
(assert (= temp___2631 o19))
(assert (= temp___2632 o20))
(assert (= temp___2633 o21))
(assert (= true temp___2634))
(assert (= v__attr__constrained true))
(assert (not (= temp___263 (rec__tokens__token__kind v__split_discrs))))
(check-sat)
(exit)
