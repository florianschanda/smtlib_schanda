...
(assert (and (= o24 (remove (mk___t values2 (mk 1 100)) o16)) (and (dynamic_invariant4 o24 true false true) (and (= (invariant__ o24) true) (and (= (to_rep1 (last o18)) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o16 1))) (= (to_rep (select values2 k)) (to_rep (select o17 k))))) (and (forall ((k Int)) (=> (and (<= (+ o16 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select o17 (- k 1)))))) (forall ((k Int)) (=> (and (<= o16 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select o17 k))))))))))))
(assert (and (= o13 y) (in_range5 y)))
(assert (and (= o25 (remove (mk___t interm1 (mk 1 100)) o13)) (and (dynamic_invariant4 o25 true false true) (and (= (invariant__ o25) true) (and (= (to_rep1 (last o15)) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o13 1))) (= (to_rep (select interm1 k)) (to_rep (select o14 k))))) (and (forall ((k Int)) (=> (and (<= (+ o13 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select interm1 k)) (to_rep (select o14 (- k 1)))))) (forall ((k Int)) (=> (and (<= o13 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select interm1 (+ k 1))) (to_rep (select o14 k))))))))))))
(assert (and (= o20 (remove_eq o25 o24 o19)) (and (in_range4 o20) (=> (= (of_int o20) true) (= (let ((temp___163 (remove o24 o19))) (let ((temp___162 (remove o25 o19))) (bool_eq (elts temp___162) (to_rep1 (first (rt temp___162))) (to_rep1 (last (rt temp___162))) (elts temp___163) (to_rep1 (first (rt temp___163))) (to_rep1 (last (rt temp___163)))))) true)))))
