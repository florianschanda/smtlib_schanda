...
(assert (= (occupied_tracks_on_red cur_num_trains trains2 track_signals) true))
(assert (= (previous_tracks_on_orange_or_red cur_num_trains trains2 track_signals) true))
(assert (not (= (safe_signaling cur_num_trains trains2 track_signals) true)))
(check-sat)
(exit)
