...
(assert (<= 1 j16))
(assert (<= j16 100))
(assert (= (rec__tree_model__path_type__k (us_split_fields1 (select r1 j16))) true))
(declare-const k Int)
(assert (<= 1 k))
(assert (<= k 100))
(assert (= (rec__tree_model__path_type__k (us_split_fields1 (select r1 k))) true))
(assert (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select r1 k))) (rec__tree_model__path_type__a (us_split_fields1 (select r1 j16)))) true))
(assert (not (= j16 k)))
(check-sat)
(exit)
