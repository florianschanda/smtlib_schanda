...
(assert (and (= o14 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range4 o14)))
(assert (= result (ite (= o14 1) true false)))
(assert (=> (= result true) (= o18 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))
(assert (=> (= result true) (= o19 (ite (not (= o18 true)) true false))))
(assert (=> (= result true) (and (= o15 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range6 o15))))
(assert (=> (= result true) (= o16 (ite (= o15 3) true false))))
(assert (=> (= result true) (= o17 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))
...
(assert (and (= o9 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range6 o9)))
(assert (= o10 (ite (= o9 3) true false)))
(assert (= o11 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))))
(assert (= result1 (ite (= o11 true) o10 false)))
(assert (=> (= result1 true) (and (= o12 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range4 o12))))
(assert (=> (= result1 true) (= o13 (ite (= o12 1) true false))))
(assert (=> (not (= result1 true)) (= o13 (of_int 1))))
(assert (and (= o2 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range4 o2)))
(assert (= result2 (ite (= o2 1) true false)))
(assert (=> (= result2 true) (and (= o5 (theauthcertrole state)) (in_range4 o5))))
