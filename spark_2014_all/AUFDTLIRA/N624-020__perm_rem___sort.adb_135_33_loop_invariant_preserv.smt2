...
(assert (= smallest2 o1))
(assert (=> (not (= smallest2 current1)) (= prec1 result4)))
(assert (=> (not (= smallest2 current1)) (= prec2 values)))
(assert (=> (not (= smallest2 current1)) (= (is_perm (mk___t values (mk 1 100)) (mk___t values2 (mk 1 100))) true)))
(assert (=> (not (= smallest2 current1)) (and (= o2 (perm_transitive (mk___t init (mk 1 100)) (mk___t prec2 (mk 1 100)) (mk___t values2 (mk 1 100)))) (and (in_range2 o2) (=> (= (of_int o2) true) (= (is_perm (mk___t init (mk 1 100)) (mk___t values2 (mk 1 100))) true))))))
(assert (=> (not (= smallest2 current1)) (= hr1 result5)))
(assert (=> (not (= smallest2 current1)) (= hr2 o2)))
(assert (=> (= smallest2 current1) (= hr2 hr1)))
(assert (=> (= smallest2 current1) (= prec2 prec1)))
...
(assert (and (and (and (=> (<= 1 1) (in_range2 hr3)) (=> (<= 1 2147483647) (in_range1 smallest3))) (=> (<= 1 99) (in_range7 current2))) (and (<= 1 current2) (<= current2 99))))
...
(assert (= smallest3 result7))
(assert (= smallest4 o3))
(assert (=> (not (= smallest4 current3)) (= prec3 result8)))
(assert (=> (not (= smallest4 current3)) (= prec4 values3)))
(assert (=> (not (= smallest4 current3)) (= (is_perm (mk___t values3 (mk 1 100)) (mk___t values4 (mk 1 100))) true)))
(assert (=> (not (= smallest4 current3)) (and (= o4 (perm_transitive (mk___t init (mk 1 100)) (mk___t prec4 (mk 1 100)) (mk___t values4 (mk 1 100)))) (and (in_range2 o4) (=> (= (of_int o4) true) (= (is_perm (mk___t init (mk 1 100)) (mk___t values4 (mk 1 100))) true))))))
(assert (=> (not (= smallest4 current3)) (= result9 hr3)))
(assert (=> (not (= smallest4 current3)) (= hr4 o4)))
(assert (=> (= smallest4 current3) (= hr4 hr3)))
(assert (=> (= smallest4 current3) (= prec4 prec3)))
