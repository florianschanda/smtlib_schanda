...
(assert (=> (not (= smallest1 current1)) (and (= o2 (perm_transitive (mk___t init (mk 1 100)) (mk___t prec2 (mk 1 100)) (mk___t values2 (mk 1 100)))) (and (in_range2 o2) (=> (= (of_int o2) true) (= (is_perm (mk___t init (mk 1 100)) (mk___t values2 (mk 1 100))) true))))))
...
(assert (=> (not (= smallest3 current3)) (and (= o4 (perm_transitive (mk___t init (mk 1 100)) (mk___t prec4 (mk 1 100)) (mk___t values4 (mk 1 100)))) (and (in_range2 o4) (=> (= (of_int o4) true) (= (is_perm (mk___t init (mk 1 100)) (mk___t values4 (mk 1 100))) true))))))
