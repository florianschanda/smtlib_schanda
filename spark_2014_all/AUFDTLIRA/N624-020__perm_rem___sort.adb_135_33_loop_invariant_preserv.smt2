...
(assert (=> (not (= smallest3 current3)) (and (= o4 (perm_transitive (mk___t init (mk 1 100)) (mk___t prec4 (mk 1 100)) (mk___t values4 (mk 1 100)))) (and (in_range2 o4) (=> (= (distinct o4 0) true) (= (is_perm (mk___t init (mk 1 100)) (mk___t values4 (mk 1 100))) true))))))
