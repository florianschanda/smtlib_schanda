...
(assert (= o11 i))
(assert (= o12 (select change3 o11)))
(assert (= o13 (to_rep o12)))
(assert (= o14 (ite (= o13 0) true false)))
(assert (=> (< (to_rep1 (first (rt new_val))) 0) (= result3 true)))
(assert (=> (not (< (to_rep1 (first (rt new_val))) 0)) (and (= o9 (- 2147483647 (to_rep1 (first (rt new_val))))) (in_range1 (- 2147483647 (to_rep1 (first (rt new_val))))))))
(assert (=> (not (< (to_rep1 (first (rt new_val))) 0)) (and (= o10 (- i (to_rep1 change__first))) (in_range1 (- i (to_rep1 change__first))))))
(assert (=> (not (< (to_rep1 (first (rt new_val))) 0)) (= result3 (ite (<= o10 o9) true false))))
(assert (= result3 true))
