...
(assert (and (and (and (and (<= (to_rep1 (first (rt s))) courant3) (<= courant3 (to_rep1 (last (rt s))))) (not (exists ((i4 Int)) (and (and (<= (to_rep1 (first (rt s))) i4) (<= i4 (- courant3 1))) (exists ((j6 Int)) (and (and (<= (to_rep1 (first (rt c))) j6) (<= j6 (to_rep1 (last (rt c))))) (= (to_rep (select (elts s) i4)) (to_rep (select (elts c) j6))))))))) (and (<= (to_rep1 (first (rt c))) possible4) (<= possible4 (to_rep1 (last (rt c)))))) (not (exists ((j6 Int)) (and (and (<= (to_rep1 (first (rt c))) j6) (<= j6 (- possible4 1))) (= (to_rep (select (elts s) courant3)) (to_rep (select (elts c) j6))))))))
(assert (=> (<= 1 2147483647) (in_range2 possible4)))
(assert (and (<= (to_rep1 (first (rt c))) possible4) (<= possible4 (to_rep1 (last (rt c))))))
(assert (= o14 possible4))
(assert (= o15 (select (elts c) o14)))
(assert (= o16 (to_rep o15)))
(assert (and (<= (to_rep1 (first (rt s))) courant3) (<= courant3 (to_rep1 (last (rt s))))))
(assert (= o12 courant3))
(assert (= o13 (select (elts s) o12)))
(assert (= o17 (to_rep o13)))
(assert (= result6 (ite (= o17 o16) true false)))
(assert (not (= result6 true)))
(assert (< possible4 (to_rep1 (last (rt c)))))
(assert (not (not (= possible4 2147483647))))
(check-sat)
(exit)
