...
(declare-const binary_trees__valid_root__result Bool)
(declare-const result Bool)
(declare-const binary_trees__valid_root__result1 Bool)
(declare-const binary_trees__valid_root__result2 Bool)
(declare-const binary_trees__valid_root__result3 Bool)
(declare-const binary_trees__valid_root__result4 Bool)
(declare-const binary_trees__valid_root__result5 Bool)
(declare-const result1 Bool)
(assert (in_range1 i))
(assert (= (tree_structure f) true))
(assert (= binary_trees__valid_root__result1 binary_trees__valid_root__result2))
(assert (= binary_trees__valid_root__result3 binary_trees__valid_root__result1))
(assert (= (mk_bool__ref result) (mk_bool__ref binary_trees__valid_root__result)))
(assert (= binary_trees__valid_root__result1 (ite (and (<= i (to_rep (rec__binary_trees__forest__s (us_split_fields3 f)))) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 f)) i)))) 2)) true false)))
(assert (= (mk_bool__ref binary_trees__valid_root__result4) (mk_bool__ref binary_trees__valid_root__result2)))
(assert (= binary_trees__valid_root__result5 binary_trees__valid_root__result3))
(assert (= result1 binary_trees__valid_root__result4))
(assert (< (size f) i))
(assert (not (not (= binary_trees__valid_root__result4 true))))
(check-sat)
(exit)
