...
(assert (= (ite (<= (to_rep2 (first4 temp___3321)) (to_rep2 (last4 temp___3321))) (+ (- (to_rep2 (last4 temp___3321)) (to_rep2 (first4 temp___3321))) 1) 0) (ite (<= 1 r4b) (+ (- r4b 1) 1) 0)))
(assert (= temp___332 temp___333))
(assert (= (mk1 (to_rep2 (first4 temp___3321)) (to_rep2 (last4 temp___3321))) temp___3331))
(assert (not (= (ite (<= (to_rep2 (first2 temp___3331)) (to_rep2 (last2 temp___3331))) (+ (- (to_rep2 (last2 temp___3331)) (to_rep2 (first2 temp___3331))) 1) 0) (ite (<= (to_rep2 (first com__split_fields1)) (to_rep2 (last com__split_fields1))) (+ (- (to_rep2 (last com__split_fields1)) (to_rep2 (first com__split_fields1))) 1) 0))))
(check-sat)
(exit)
