...
(assert (= (ite (<= (to_rep2 (first4 temp___3611)) (to_rep2 (last4 temp___3611))) (+ (- (to_rep2 (last4 temp___3611)) (to_rep2 (first4 temp___3611))) 1) 0) (ite (<= 1 r4b) (+ (- r4b 1) 1) 0)))
(assert (= temp___361 temp___362))
(assert (= (mk1 (to_rep2 (first4 temp___3611)) (to_rep2 (last4 temp___3611))) temp___3621))
(assert (not (= (ite (<= (to_rep2 (first2 temp___3621)) (to_rep2 (last2 temp___3621))) (+ (- (to_rep2 (last2 temp___3621)) (to_rep2 (first2 temp___3621))) 1) 0) (ite (<= (to_rep2 (first com__split_fields1)) (to_rep2 (last com__split_fields1))) (+ (- (to_rep2 (last com__split_fields1)) (to_rep2 (first com__split_fields1))) 1) 0))))
(check-sat)
(exit)
