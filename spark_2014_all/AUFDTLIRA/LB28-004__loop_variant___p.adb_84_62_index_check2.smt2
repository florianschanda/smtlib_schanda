...
(assert (=> (<= j38 b) (forall ((l1 Int)) (=> (and (<= a l1) (<= l1 (- j40 1))) (= (to_rep (select tab33 l1)) l1)))))
(assert (=> (<= j38 b) (forall ((l1 Int)) (=> (and (<= a l1) (<= l1 (- (+ a k19) 1))) (= (to_rep (select tab33 l1)) l1)))))
...
(assert (= k25 o33))
(assert (= j47 (+ a k26)))
(assert (forall ((l1 Int)) (=> (and (<= a l1) (<= l1 (- j47 1))) (= (to_rep (select tab39 l1)) l1))))
(assert (forall ((l1 Int)) (=> (and (<= a l1) (<= l1 (- (+ a k26) 1))) (= (to_rep (select tab39 l1)) l1))))
(assert (and (=> (<= (- 2147483648) 2147483647) (in_range1 j47)) (=> (<= (- 2147483648) 2147483647) (in_range1 k26))))
(assert (and (= o34 (- j47 1)) (in_range1 (- j47 1))))
(assert (= o35 (ite (<= l o34) true false)))
(assert (= result40 (ite (<= a l) o35 false)))
