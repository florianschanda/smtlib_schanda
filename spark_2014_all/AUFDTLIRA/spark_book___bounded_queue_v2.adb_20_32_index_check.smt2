...
(assert (and (= us (to_rep (rec__bounded_queue_v2__queue_type__max_size (us_split_discrs1 queue)))) (in_range (to_rep (rec__bounded_queue_v2__queue_type__max_size (us_split_discrs1 queue))))))
