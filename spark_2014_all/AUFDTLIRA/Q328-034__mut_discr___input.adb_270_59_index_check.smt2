...
(assert (and (forall ((temp___691 Int)) (=> (and (<= (to_rep1 s__first) temp___691) (<= temp___691 (to_rep1 s__last))) (=> (<= i2 temp___691) (= (select s2 temp___691) (select s1 temp___691))))) (and (<= (to_rep1 s__first) i2) (<= i2 (to_rep1 s__last)))))
