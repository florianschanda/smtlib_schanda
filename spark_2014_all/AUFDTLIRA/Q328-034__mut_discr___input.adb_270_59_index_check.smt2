...
(assert (and (forall ((temp___619 Int)) (=> (and (<= (to_rep1 s__first) temp___619) (<= temp___619 (to_rep1 s__last))) (=> (<= i2 temp___619) (= (select s2 temp___619) (select s1 temp___619))))) (and (<= (to_rep1 s__first) i2) (<= i2 (to_rep1 s__last)))))
