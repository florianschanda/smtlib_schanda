...
(assert (and (forall ((temp___613 Int)) (=> (and (<= (to_rep1 s__first) temp___613) (<= temp___613 (to_rep1 s__last))) (=> (<= i2 temp___613) (= (select s2 temp___613) (select s1 temp___613))))) (and (<= (to_rep1 s__first) i2) (<= i2 (to_rep1 s__last)))))
