...
(assert (and (forall ((temp___686 Int)) (=> (and (<= (to_rep1 s__first) temp___686) (<= temp___686 (to_rep1 s__last))) (=> (or (< (to_rep1 s__last) temp___686) (or (< temp___686 (to_rep1 s__first)) (<= i2 temp___686))) (= (select s2 temp___686) (select s1 temp___686))))) (and (<= (to_rep1 s__first) i2) (<= i2 (to_rep1 s__last)))))
(assert (not (<= i2 (to_rep1 s__last))))
(check-sat)
(exit)
