...
(assert (=> (not (= (to_rep (select buffer i2)) erase_character)) (= (to_rep o) (to_rep (select buffer i2)))))
(assert (=> (not (= (to_rep (select buffer i2)) erase_character)) (and (<= 1 (+ 1 offset2)) (<= (+ 1 offset2) 1024))))
(assert (=> (not (= (to_rep (select buffer i2)) erase_character)) (= o1 (+ 1 offset2))))
(assert (=> (not (= (to_rep (select buffer i2)) erase_character)) (= o2 (store workspace2 o1 o))))
(assert (=> (not (= (to_rep (select buffer i2)) erase_character)) (= workspace2 result3)))
(assert (=> (not (= (to_rep (select buffer i2)) erase_character)) (= workspace3 o2)))
(assert (=> (not (= (to_rep (select buffer i2)) erase_character)) (and (= o3 (+ offset2 1)) (in_range2 (+ offset2 1)))))
(assert (=> (not (= (to_rep (select buffer i2)) erase_character)) (= offset2 result4)))
(assert (=> (not (= (to_rep (select buffer i2)) erase_character)) (= offset3 o3)))
(assert (=> (not (not (= (to_rep (select buffer i2)) erase_character))) (= offset3 offset2)))
(assert (=> (not (not (= (to_rep (select buffer i2)) erase_character))) (= workspace3 workspace2)))
(assert (not (= i2 1024)))
(assert (= result5 i2))
(assert (= i3 (+ i2 1)))
(assert (not (< offset3 i3)))
(check-sat)
(exit)
