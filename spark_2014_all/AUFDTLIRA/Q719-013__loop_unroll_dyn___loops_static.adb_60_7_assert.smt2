...
(assert (not (not (and (and (= (mk_int__ref result1) (mk_int__ref i)) (= i1 1)) (and (and (and (= (to_rep o) 0) (and (and (and (<= (to_rep1 a__first) i1) (<= i1 (to_rep1 a__last))) (= o1 i1)) (= o2 (store a o1 o)))) (and (= (mk_map__ref result2) (mk_map__ref a)) (= a1 o2))) (and (and (and (= (mk_int__ref result3) (mk_int__ref j)) (= j1 (to_rep1 a__first))) (ite (and (<= (to_rep1 a__first) j1) (<= j1 i1)) (and (and (and (= temp___299 bad1) (and (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (and (and (and (and (and (and (and (and (<= (to_rep1 a__first) j2) (<= j2 (to_rep1 a__last))) (= o3 j2)) (= o4 (select a1 o3))) (= o5 (to_rep o4))) (= o6 (ite (= o5 0) true false))) (= result4 (ite (not (= o6 true)) true false))) (ite (= result4 true) (and (= bad2 result5) (= bad3 (of_int 1))) (= bad3 bad2))) (= j2 i1)))) (and (and (= j2 j3) (= bad3 bad4)) (and (= j4 j2) (= bad5 bad3)))) (and (and (= j13 (mk_int__ref j3)) (= bad16 (mk_bool__ref bad4))) (and (= j6 j4) (= bad7 bad5)))) (and (and (= j1 j5) (= bad1 bad6)) (and (= j6 j1) (= bad7 bad1))))) (and (forall ((j14 Int)) (=> (and (<= (to_rep1 a__first) j14) (<= j14 i1)) (= (to_rep (select a1 j14)) 0))) (and (and (= i1 result6) (= i2 2)) (and (and (and (= (to_rep o7) 0) (and (and (and (<= (to_rep1 a__first) i2) (<= i2 (to_rep1 a__last))) (= o8 i2)) (= o9 (store a1 o8 o7)))) (and (= a1 result7) (= a2 o9))) (and (and (and (= (mk_int__ref result8) j13) (= j7 (to_rep1 a__first))) (ite (and (<= (to_rep1 a__first) j7) (<= j7 i2)) (and (and (and (= temp___2991 bad6) (and (and (<= (to_rep1 a__first) j8) (<= j8 i2)) (and (and (and (and (and (and (and (and (<= (to_rep1 a__first) j8) (<= j8 (to_rep1 a__last))) (= o10 j8)) (= o11 (select a2 o10))) (= o12 (to_rep o11))) (= o13 (ite (= o12 0) true false))) (= result9 (ite (not (= o13 true)) true false))) (ite (= result9 true) (and (and (= bad8 result10) (= bad9 (of_int 1))) (and (= bad9 bad10) (= bad11 bad9))) (and (= bad8 bad10) (= bad11 bad8)))) (= j8 i2)))) (and (and (= j9 (mk_int__ref j8)) (= bad12 (mk_bool__ref bad10))) (and (= j10 j8) (= bad13 bad11)))) (and (and (= j11 j9) (= bad14 bad12)) (and (= j12 j10) (= bad15 bad13)))) (and (and (= j11 (mk_int__ref j7)) (= bad14 bad16)) (and (= j12 j7) (= bad15 bad7))))) (forall ((j14 Int)) (=> (and (<= (to_rep1 a__first) j14) (<= j14 i2)) (= (to_rep (select a2 j14)) 0)))))))))))))
(check-sat)
(exit)
