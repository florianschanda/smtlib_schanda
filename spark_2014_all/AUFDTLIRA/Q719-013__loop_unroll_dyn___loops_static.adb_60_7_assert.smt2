...
(declare-const temp___2991 Bool)
...
(assert (= j3 (to_rep1 a__first)))
(assert (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (= temp___299 bad1)))
(assert (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (and (<= (to_rep1 a__first) j4) (<= j4 i1))))
(assert (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (and (<= (to_rep1 a__first) j4) (<= j4 (to_rep1 a__last)))))
(assert (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (= o3 j4)))
(assert (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (= o4 (select a1 o3))))
(assert (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (= o5 (to_rep o4))))
(assert (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (= o6 (ite (= o5 0) true false))))
(assert (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (= result4 (ite (not (= o6 true)) true false))))
(assert (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (=> (= result4 true) (= bad2 result5))))
(assert (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (=> (= result4 true) (= bad3 (of_int 1)))))
(assert (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (=> (not (= result4 true)) (= bad3 bad2))))
(assert (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (= j4 i1)))
(assert (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (= j4 j5)))
(assert (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (= bad3 bad4)))
(assert (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (= j6 j4)))
(assert (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (= bad5 bad3)))
(assert (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (= (mk_int__ref j7) (mk_int__ref j5))))
(assert (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (= (mk_bool__ref bad6) (mk_bool__ref bad4))))
(assert (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (= j8 j6)))
(assert (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (= bad7 bad5)))
(assert (=> (not (and (<= (to_rep1 a__first) j3) (<= j3 i1))) (= j3 j7)))
(assert (=> (not (and (<= (to_rep1 a__first) j3) (<= j3 i1))) (= bad1 bad6)))
(assert (=> (not (and (<= (to_rep1 a__first) j3) (<= j3 i1))) (= j8 j3)))
(assert (=> (not (and (<= (to_rep1 a__first) j3) (<= j3 i1))) (= bad7 bad1)))
(assert (forall ((j15 Int)) (=> (and (<= (to_rep1 a__first) j15) (<= j15 i1)) (= (to_rep (select a1 j15)) 0))))
(assert (= i1 result6))
(assert (= i2 2))
(assert (= (to_rep o7) 0))
...
(assert (= a1 result7))
(assert (= a2 o9))
(assert (= (mk_int__ref result8) (mk_int__ref j7)))
(assert (= j9 (to_rep1 a__first)))
(assert (=> (and (<= (to_rep1 a__first) j9) (<= j9 i2)) (= temp___2991 bad6)))
(assert (=> (and (<= (to_rep1 a__first) j9) (<= j9 i2)) (and (<= (to_rep1 a__first) j10) (<= j10 i2))))
(assert (=> (and (<= (to_rep1 a__first) j9) (<= j9 i2)) (and (<= (to_rep1 a__first) j10) (<= j10 (to_rep1 a__last)))))
(assert (=> (and (<= (to_rep1 a__first) j9) (<= j9 i2)) (= o10 j10)))
(assert (=> (and (<= (to_rep1 a__first) j9) (<= j9 i2)) (= o11 (select a2 o10))))
(assert (=> (and (<= (to_rep1 a__first) j9) (<= j9 i2)) (= o12 (to_rep o11))))
(assert (=> (and (<= (to_rep1 a__first) j9) (<= j9 i2)) (= o13 (ite (= o12 0) true false))))
(assert (=> (and (<= (to_rep1 a__first) j9) (<= j9 i2)) (= result9 (ite (not (= o13 true)) true false))))
(assert (=> (and (<= (to_rep1 a__first) j9) (<= j9 i2)) (=> (= result9 true) (= bad8 result10))))
(assert (=> (and (<= (to_rep1 a__first) j9) (<= j9 i2)) (=> (= result9 true) (= bad9 (of_int 1)))))
(assert (=> (and (<= (to_rep1 a__first) j9) (<= j9 i2)) (=> (= result9 true) (= bad9 bad10))))
(assert (=> (and (<= (to_rep1 a__first) j9) (<= j9 i2)) (=> (= result9 true) (= bad11 bad9))))
(assert (=> (and (<= (to_rep1 a__first) j9) (<= j9 i2)) (=> (not (= result9 true)) (= bad8 bad10))))
(assert (=> (and (<= (to_rep1 a__first) j9) (<= j9 i2)) (=> (not (= result9 true)) (= bad11 bad8))))
(assert (=> (and (<= (to_rep1 a__first) j9) (<= j9 i2)) (= j10 i2)))
(assert (=> (and (<= (to_rep1 a__first) j9) (<= j9 i2)) (= j11 (mk_int__ref j10))))
(assert (=> (and (<= (to_rep1 a__first) j9) (<= j9 i2)) (= bad12 (mk_bool__ref bad10))))
(assert (=> (and (<= (to_rep1 a__first) j9) (<= j9 i2)) (= j12 j10)))
(assert (=> (and (<= (to_rep1 a__first) j9) (<= j9 i2)) (= bad13 bad11)))
(assert (=> (and (<= (to_rep1 a__first) j9) (<= j9 i2)) (= j13 j11)))
(assert (=> (and (<= (to_rep1 a__first) j9) (<= j9 i2)) (= bad14 bad12)))
(assert (=> (and (<= (to_rep1 a__first) j9) (<= j9 i2)) (= j14 j12)))
(assert (=> (and (<= (to_rep1 a__first) j9) (<= j9 i2)) (= bad15 bad13)))
(assert (=> (not (and (<= (to_rep1 a__first) j9) (<= j9 i2))) (= j13 (mk_int__ref j9))))
(assert (=> (not (and (<= (to_rep1 a__first) j9) (<= j9 i2))) (= bad14 (mk_bool__ref bad6))))
(assert (=> (not (and (<= (to_rep1 a__first) j9) (<= j9 i2))) (= j14 j9)))
(assert (=> (not (and (<= (to_rep1 a__first) j9) (<= j9 i2))) (= bad15 bad7)))
(assert (forall ((j15 Int)) (=> (and (<= (to_rep1 a__first) j15) (<= j15 i2)) (= (to_rep (select a2 j15)) 0))))
(assert (not false))
(check-sat)
(exit)
