...
(define-fun dynamic_invariant2 ((temp___expr_159 us_t1) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool) (temp___do_typ_inv_158 Bool)) Bool (=> (not (= temp___skip_constant_156 true)) (dynamic_property2 (- 2147483648) 2147483647 (first3 temp___expr_159) (last4 temp___expr_159))))
(declare-const y Int)
...
(declare-const formals_arr_split__f__a__compl (Array Int natural))
(declare-const formals_arr_split__f__a__compl1 t)
(declare-const o integer)
(declare-const o1 integer)
(assert (dynamic_property2 (- 2147483648) 2147483647 (to_rep a__first) (to_rep a__last)))
...
(assert (= a formals_arr_split__f__a__compl))
(assert (= (mk (to_rep a__first) (to_rep a__last)) formals_arr_split__f__a__compl1))
(assert (= (to_rep o1) (to_rep (last1 formals_arr_split__f__a__compl1))))
(assert (= (to_rep o) (to_rep (first formals_arr_split__f__a__compl1))))
