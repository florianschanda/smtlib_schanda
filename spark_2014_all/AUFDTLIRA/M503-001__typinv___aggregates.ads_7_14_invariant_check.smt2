...
(declare-fun temp_____aggregate_def_198 (Int Int) (Array Int t))
...
(assert (forall ((temp___200 Int) (temp___201 Int)) (let ((temp___199 (temp_____aggregate_def_198 temp___200 temp___201))) (=> (and (dynamic_invariant temp___200 true true true true) (dynamic_invariant temp___201 true true true true)) (and (= (select temp___199 1) rliteral) (= (select temp___199 2) rliteral))))))
...
(assert (= result x))
(assert (= x1 (temp_____aggregate_def_198 1 1)))
(assert (= x1 x2))
(assert (= x3 x1))
(declare-const temp___203 Int)
(assert (<= 1 temp___203))
(assert (<= temp___203 2))
(assert (not (type_invariant (to_rep (select x2 temp___203)))))
(check-sat)
(exit)
