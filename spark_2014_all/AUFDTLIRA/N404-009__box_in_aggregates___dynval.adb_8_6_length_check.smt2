...
(assert (and (and (dynamic_property1 first last (to_rep x__first) (to_rep x__last)) (and (= (to_rep x__first) l) (= (to_rep x__last) u))) (forall ((temp___149 Int)) (=> (and (<= (to_rep x__first) temp___149) (<= temp___149 (to_rep x__last))) (=> (<= first last) (dynamic_property first last (to_rep (select x temp___149))))))))
...
(assert (= (ite (<= (to_rep (first3 temp___1561)) (to_rep (last3 temp___1561))) (+ (- (to_rep (last3 temp___1561)) (to_rep (first3 temp___1561))) 1) 0) (ite (<= first last) (+ (- last first) 1) 0)))
(assert (= (slide temp___156 (to_rep (first3 temp___1561)) first) temp___157))
(assert (= (mk first last) temp___1571))
(assert (not (= (ite (<= (to_rep (first1 temp___1571)) (to_rep (last1 temp___1571))) (+ (- (to_rep (last1 temp___1571)) (to_rep (first1 temp___1571))) 1) 0) (ite (<= (to_rep x__first) (to_rep x__last)) (+ (- (to_rep x__last) (to_rep x__first)) 1) 0))))
(check-sat)
(exit)
