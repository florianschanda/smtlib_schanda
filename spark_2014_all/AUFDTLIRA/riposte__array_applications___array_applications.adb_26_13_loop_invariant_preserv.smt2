...
(assert (= i2 result4))
(assert (= i3 (+ i2 1)))
(assert (and (= o15 (+ (to_rep (select a4 (- i3 1))) (to_rep (select a4 (- i3 2))))) (in_range1 (+ (to_rep (select a4 (- i3 1))) (to_rep (select a4 (- i3 2)))))))
(assert (= (to_rep o16) o15))
(assert (= o17 (store a4 i3 o16)))
(assert (= result5 a4))
(assert (= a5 o17))
(declare-const j1 Int)
(assert (<= 2 j1))
(assert (<= j1 i3))
(assert (not (= (to_rep (select a5 j1)) (+ (to_rep (select a5 (- j1 1))) (to_rep (select a5 (- j1 2)))))))
(check-sat)
(exit)
