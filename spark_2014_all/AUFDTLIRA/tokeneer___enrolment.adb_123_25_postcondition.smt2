...
(assert (forall ((x issueridt)) (! (in_range5 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(define-fun bool_eq3 ((a us_rep1) (b us_rep1)) Bool (ite (and (and (= (to_rep2 (rec__cryptotypes__issuert__id (us_split_fields1 a))) (to_rep2 (rec__cryptotypes__issuert__id (us_split_fields1 b)))) (= (to_rep3 (rec__cryptotypes__issuert__namelength (us_split_fields1 a))) (to_rep3 (rec__cryptotypes__issuert__namelength (us_split_fields1 b))))) (= (bool_eq (rec__cryptotypes__issuert__name (us_split_fields1 a)) 1 40 (rec__cryptotypes__issuert__name (us_split_fields1 b)) 1 40) true)) true false))
...
(assert (forall ((x algorithmt)) (! (in_range7 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(assert (forall ((temp___150 Int)) (forall ((temp___151 Int)) (= (select (certtypes__nullrawcertificate__aggregate_def temp___150) temp___151) (of_rep temp___150)))))
...
(assert (forall ((x yearst)) (! (in_range11 (to_rep7 x)) :pattern ((to_rep7 x)))))
...
(assert (forall ((x monthst)) (! (in_range12 (to_rep8 x)) :pattern ((to_rep8 x)))))
...
(assert (forall ((x dayst)) (! (in_range13 (to_rep9 x)) :pattern ((to_rep9 x)))))
...
(assert (forall ((x millisecst)) (! (in_range14 (to_rep10 x)) :pattern ((to_rep10 x)))))
...
(assert (forall ((x serialnumbert)) (! (in_range15 (to_rep11 x)) :pattern ((to_rep11 x)))))
(assert (forall ((x Int)) (! (=> (in_range15 x) (= (to_rep11 (of_rep11 x)) x)) :pattern ((to_rep11 (of_rep11 x))))))
(declare-datatypes () ((us_split_fields6 (mk___split_fields3 (rec__certtypes__idt__issuer us_rep1) (rec__certtypes__idt__serialnumber serialnumbert)))))
(define-fun us_split_fields_Issuer__projection ((a us_split_fields6)) us_rep1 (rec__certtypes__idt__issuer a))
...
(define-fun bool_eq6 ((a us_rep4) (b us_rep4)) Bool (ite (and (= (bool_eq3 (rec__certtypes__idt__issuer (us_split_fields7 a)) (rec__certtypes__idt__issuer (us_split_fields7 b))) true) (= (to_rep11 (rec__certtypes__idt__serialnumber (us_split_fields7 a))) (to_rep11 (rec__certtypes__idt__serialnumber (us_split_fields7 b))))) true false))
...
(declare-datatypes () ((us_split_fields8 (mk___split_fields4 (rec__cert__contentst__id us_rep4) (rec__cert__contentst__notbefore us_rep3) (rec__cert__contentst__notafter us_rep3) (rec__cert__contentst__mechanism algorithmt)))))
(define-fun us_split_fields_ID__3__projection ((a us_split_fields8)) us_rep4 (rec__cert__contentst__id a))
...
(define-fun bool_eq7 ((a us_rep5) (b us_rep5)) Bool (ite (and (and (and (= (bool_eq6 (rec__cert__contentst__id (us_split_fields9 a)) (rec__cert__contentst__id (us_split_fields9 b))) true) (= (bool_eq5 (rec__cert__contentst__notbefore (us_split_fields9 a)) (rec__cert__contentst__notbefore (us_split_fields9 b))) true)) (= (bool_eq5 (rec__cert__contentst__notafter (us_split_fields9 a)) (rec__cert__contentst__notafter (us_split_fields9 b))) true)) (= (to_rep4 (rec__cert__contentst__mechanism (us_split_fields9 a))) (to_rep4 (rec__cert__contentst__mechanism (us_split_fields9 b))))) true false))
...
(define-fun contentst__ref___projection ((a contentst__ref)) us_rep5 (contentst__content a))
(declare-fun theissuer (us_rep5) us_rep1)
(declare-fun theissuer__function_guard (us_rep1 us_rep5) Bool)
(assert true)
(declare-datatypes () ((us_split_fields10 (mk___split_fields5 (rec__cert__id__contentst__id us_rep4) (rec__cert__id__contentst__notbefore us_rep3) (rec__cert__id__contentst__notafter us_rep3) (rec__cert__id__contentst__mechanism algorithmt) (rec__cert__id__contentst__subject us_rep1) (rec__cert__id__contentst__subjectpublickey us_rep2)))))
(define-fun us_split_fields_ID__4__projection ((a us_split_fields10)) us_rep4 (rec__cert__id__contentst__id a))
(define-fun us_split_fields_NotBefore__2__projection ((a us_split_fields10)) us_rep3 (rec__cert__id__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__2__projection ((a us_split_fields10)) us_rep3 (rec__cert__id__contentst__notafter a))
...
(define-fun us_split_fields_SubjectPublicKey__projection ((a us_split_fields10)) us_rep2 (rec__cert__id__contentst__subjectpublickey a))
...
(define-fun bool_eq8 ((a us_rep6) (b us_rep6)) Bool (ite (and (and (and (and (and (= (bool_eq6 (rec__cert__id__contentst__id (us_split_fields11 a)) (rec__cert__id__contentst__id (us_split_fields11 b))) true) (= (bool_eq5 (rec__cert__id__contentst__notbefore (us_split_fields11 a)) (rec__cert__id__contentst__notbefore (us_split_fields11 b))) true)) (= (bool_eq5 (rec__cert__id__contentst__notafter (us_split_fields11 a)) (rec__cert__id__contentst__notafter (us_split_fields11 b))) true)) (= (to_rep4 (rec__cert__id__contentst__mechanism (us_split_fields11 a))) (to_rep4 (rec__cert__id__contentst__mechanism (us_split_fields11 b))))) (= (bool_eq3 (rec__cert__id__contentst__subject (us_split_fields11 a)) (rec__cert__id__contentst__subject (us_split_fields11 b))) true)) (= (bool_eq4 (rec__cert__id__contentst__subjectpublickey (us_split_fields11 a)) (rec__cert__id__contentst__subjectpublickey (us_split_fields11 b))) true)) true false))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1083 us_void_param) 1)) 67) (= (to_rep (select (temp___String_Literal_1083 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_1083 us_void_param) 3)) 114)) (= (to_rep (select (temp___String_Literal_1083 us_void_param) 4)) 116)) (= (to_rep (select (temp___String_Literal_1083 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_1083 us_void_param) 6)) 102)) (= (to_rep (select (temp___String_Literal_1083 us_void_param) 7)) 105)) (= (to_rep (select (temp___String_Literal_1083 us_void_param) 8)) 99)) (= (to_rep (select (temp___String_Literal_1083 us_void_param) 9)) 97)) (= (to_rep (select (temp___String_Literal_1083 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_1083 us_void_param) 11)) 101)) (= (to_rep (select (temp___String_Literal_1083 us_void_param) 12)) 32)) (= (to_rep (select (temp___String_Literal_1083 us_void_param) 13)) 99)) (= (to_rep (select (temp___String_Literal_1083 us_void_param) 14)) 111)) (= (to_rep (select (temp___String_Literal_1083 us_void_param) 15)) 117)) (= (to_rep (select (temp___String_Literal_1083 us_void_param) 16)) 108)) (= (to_rep (select (temp___String_Literal_1083 us_void_param) 17)) 100)) (= (to_rep (select (temp___String_Literal_1083 us_void_param) 18)) 32)) (= (to_rep (select (temp___String_Literal_1083 us_void_param) 19)) 110)) (= (to_rep (select (temp___String_Literal_1083 us_void_param) 20)) 111)) (= (to_rep (select (temp___String_Literal_1083 us_void_param) 21)) 116)) (= (to_rep (select (temp___String_Literal_1083 us_void_param) 22)) 32)) (= (to_rep (select (temp___String_Literal_1083 us_void_param) 23)) 98)) (= (to_rep (select (temp___String_Literal_1083 us_void_param) 24)) 101)) (= (to_rep (select (temp___String_Literal_1083 us_void_param) 25)) 32)) (= (to_rep (select (temp___String_Literal_1083 us_void_param) 26)) 118)) (= (to_rep (select (temp___String_Literal_1083 us_void_param) 27)) 101)) (= (to_rep (select (temp___String_Literal_1083 us_void_param) 28)) 114)) (= (to_rep (select (temp___String_Literal_1083 us_void_param) 29)) 105)) (= (to_rep (select (temp___String_Literal_1083 us_void_param) 30)) 102)) (= (to_rep (select (temp___String_Literal_1083 us_void_param) 31)) 105)) (= (to_rep (select (temp___String_Literal_1083 us_void_param) 32)) 101)) (= (to_rep (select (temp___String_Literal_1083 us_void_param) 33)) 100)) :pattern ((temp___String_Literal_1083 us_void_param)))))
(declare-fun temp___String_Literal_1084 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1084 us_void_param) 1)) 75) (= (to_rep (select (temp___String_Literal_1084 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_1084 us_void_param) 3)) 121)) (= (to_rep (select (temp___String_Literal_1084 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_1084 us_void_param) 5)) 99)) (= (to_rep (select (temp___String_Literal_1084 us_void_param) 6)) 111)) (= (to_rep (select (temp___String_Literal_1084 us_void_param) 7)) 117)) (= (to_rep (select (temp___String_Literal_1084 us_void_param) 8)) 108)) (= (to_rep (select (temp___String_Literal_1084 us_void_param) 9)) 100)) (= (to_rep (select (temp___String_Literal_1084 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_1084 us_void_param) 11)) 110)) (= (to_rep (select (temp___String_Literal_1084 us_void_param) 12)) 111)) (= (to_rep (select (temp___String_Literal_1084 us_void_param) 13)) 116)) (= (to_rep (select (temp___String_Literal_1084 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_1084 us_void_param) 15)) 98)) (= (to_rep (select (temp___String_Literal_1084 us_void_param) 16)) 101)) (= (to_rep (select (temp___String_Literal_1084 us_void_param) 17)) 32)) (= (to_rep (select (temp___String_Literal_1084 us_void_param) 18)) 97)) (= (to_rep (select (temp___String_Literal_1084 us_void_param) 19)) 100)) (= (to_rep (select (temp___String_Literal_1084 us_void_param) 20)) 100)) (= (to_rep (select (temp___String_Literal_1084 us_void_param) 21)) 101)) (= (to_rep (select (temp___String_Literal_1084 us_void_param) 22)) 100)) (= (to_rep (select (temp___String_Literal_1084 us_void_param) 23)) 32)) (= (to_rep (select (temp___String_Literal_1084 us_void_param) 24)) 116)) (= (to_rep (select (temp___String_Literal_1084 us_void_param) 25)) 111)) (= (to_rep (select (temp___String_Literal_1084 us_void_param) 26)) 32)) (= (to_rep (select (temp___String_Literal_1084 us_void_param) 27)) 116)) (= (to_rep (select (temp___String_Literal_1084 us_void_param) 28)) 104)) (= (to_rep (select (temp___String_Literal_1084 us_void_param) 29)) 101)) (= (to_rep (select (temp___String_Literal_1084 us_void_param) 30)) 32)) (= (to_rep (select (temp___String_Literal_1084 us_void_param) 31)) 75)) (= (to_rep (select (temp___String_Literal_1084 us_void_param) 32)) 101)) (= (to_rep (select (temp___String_Literal_1084 us_void_param) 33)) 121)) (= (to_rep (select (temp___String_Literal_1084 us_void_param) 34)) 32)) (= (to_rep (select (temp___String_Literal_1084 us_void_param) 35)) 83)) (= (to_rep (select (temp___String_Literal_1084 us_void_param) 36)) 116)) (= (to_rep (select (temp___String_Literal_1084 us_void_param) 37)) 111)) (= (to_rep (select (temp___String_Literal_1084 us_void_param) 38)) 114)) (= (to_rep (select (temp___String_Literal_1084 us_void_param) 39)) 101)) :pattern ((temp___String_Literal_1084 us_void_param)))))
(declare-fun temp___String_Literal_1085 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1085 us_void_param) 1)) 67) (= (to_rep (select (temp___String_Literal_1085 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_1085 us_void_param) 3)) 114)) (= (to_rep (select (temp___String_Literal_1085 us_void_param) 4)) 116)) (= (to_rep (select (temp___String_Literal_1085 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_1085 us_void_param) 6)) 102)) (= (to_rep (select (temp___String_Literal_1085 us_void_param) 7)) 105)) (= (to_rep (select (temp___String_Literal_1085 us_void_param) 8)) 99)) (= (to_rep (select (temp___String_Literal_1085 us_void_param) 9)) 97)) (= (to_rep (select (temp___String_Literal_1085 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_1085 us_void_param) 11)) 101)) (= (to_rep (select (temp___String_Literal_1085 us_void_param) 12)) 32)) (= (to_rep (select (temp___String_Literal_1085 us_void_param) 13)) 99)) (= (to_rep (select (temp___String_Literal_1085 us_void_param) 14)) 111)) (= (to_rep (select (temp___String_Literal_1085 us_void_param) 15)) 110)) (= (to_rep (select (temp___String_Literal_1085 us_void_param) 16)) 116)) (= (to_rep (select (temp___String_Literal_1085 us_void_param) 17)) 101)) (= (to_rep (select (temp___String_Literal_1085 us_void_param) 18)) 110)) (= (to_rep (select (temp___String_Literal_1085 us_void_param) 19)) 116)) (= (to_rep (select (temp___String_Literal_1085 us_void_param) 20)) 115)) (= (to_rep (select (temp___String_Literal_1085 us_void_param) 21)) 32)) (= (to_rep (select (temp___String_Literal_1085 us_void_param) 22)) 99)) (= (to_rep (select (temp___String_Literal_1085 us_void_param) 23)) 111)) (= (to_rep (select (temp___String_Literal_1085 us_void_param) 24)) 117)) (= (to_rep (select (temp___String_Literal_1085 us_void_param) 25)) 108)) (= (to_rep (select (temp___String_Literal_1085 us_void_param) 26)) 100)) (= (to_rep (select (temp___String_Literal_1085 us_void_param) 27)) 32)) (= (to_rep (select (temp___String_Literal_1085 us_void_param) 28)) 110)) (= (to_rep (select (temp___String_Literal_1085 us_void_param) 29)) 111)) (= (to_rep (select (temp___String_Literal_1085 us_void_param) 30)) 116)) (= (to_rep (select (temp___String_Literal_1085 us_void_param) 31)) 32)) (= (to_rep (select (temp___String_Literal_1085 us_void_param) 32)) 98)) (= (to_rep (select (temp___String_Literal_1085 us_void_param) 33)) 101)) (= (to_rep (select (temp___String_Literal_1085 us_void_param) 34)) 32)) (= (to_rep (select (temp___String_Literal_1085 us_void_param) 35)) 101)) (= (to_rep (select (temp___String_Literal_1085 us_void_param) 36)) 120)) (= (to_rep (select (temp___String_Literal_1085 us_void_param) 37)) 116)) (= (to_rep (select (temp___String_Literal_1085 us_void_param) 38)) 114)) (= (to_rep (select (temp___String_Literal_1085 us_void_param) 39)) 97)) (= (to_rep (select (temp___String_Literal_1085 us_void_param) 40)) 99)) (= (to_rep (select (temp___String_Literal_1085 us_void_param) 41)) 116)) (= (to_rep (select (temp___String_Literal_1085 us_void_param) 42)) 101)) (= (to_rep (select (temp___String_Literal_1085 us_void_param) 43)) 100)) :pattern ((temp___String_Literal_1085 us_void_param)))))
...
(define-fun dynamic_invariant5 ((temp___expr_246 Int) (temp___is_init_243 Bool) (temp___skip_constant_244 Bool) (temp___do_toplevel_245 Bool)) Bool (=> (or (= temp___is_init_243 true) (<= 1901 2099)) (in_range11 temp___expr_246)))
(define-fun dynamic_invariant6 ((temp___expr_252 Int) (temp___is_init_249 Bool) (temp___skip_constant_250 Bool) (temp___do_toplevel_251 Bool)) Bool (=> (or (= temp___is_init_249 true) (<= 1 12)) (in_range12 temp___expr_252)))
(define-fun dynamic_invariant7 ((temp___expr_258 Int) (temp___is_init_255 Bool) (temp___skip_constant_256 Bool) (temp___do_toplevel_257 Bool)) Bool (=> (or (= temp___is_init_255 true) (<= 1 31)) (in_range13 temp___expr_258)))
(define-fun dynamic_invariant8 ((temp___expr_282 Int) (temp___is_init_279 Bool) (temp___skip_constant_280 Bool) (temp___do_toplevel_281 Bool)) Bool (=> (or (= temp___is_init_279 true) (<= 0 86399999)) (in_range14 temp___expr_282)))
(define-fun dynamic_invariant9 ((temp___expr_666 Int) (temp___is_init_663 Bool) (temp___skip_constant_664 Bool) (temp___do_toplevel_665 Bool)) Bool (=> (or (= temp___is_init_663 true) (<= 0 40)) (in_range6 temp___expr_666)))
(define-fun dynamic_invariant10 ((temp___expr_687 Int) (temp___is_init_684 Bool) (temp___skip_constant_685 Bool) (temp___do_toplevel_686 Bool)) Bool (=> (or (= temp___is_init_684 true) (<= 0 4294967295)) (in_range5 temp___expr_687)))
(define-fun dynamic_invariant11 ((temp___expr_705 Int) (temp___is_init_702 Bool) (temp___skip_constant_703 Bool) (temp___do_toplevel_704 Bool)) Bool (=> (or (= temp___is_init_702 true) (<= 0 10)) (in_range7 temp___expr_705)))
(define-fun dynamic_invariant12 ((temp___expr_717 Int) (temp___is_init_714 Bool) (temp___skip_constant_715 Bool) (temp___do_toplevel_716 Bool)) Bool (=> (or (= temp___is_init_714 true) (<= 0 4294967295)) (in_range8 temp___expr_717)))
(define-fun dynamic_invariant13 ((temp___expr_723 Int) (temp___is_init_720 Bool) (temp___skip_constant_721 Bool) (temp___do_toplevel_722 Bool)) Bool (=> (or (= temp___is_init_720 true) (<= 0 128)) (in_range9 temp___expr_723)))
(define-fun dynamic_invariant14 ((temp___expr_843 Int) (temp___is_init_840 Bool) (temp___skip_constant_841 Bool) (temp___do_toplevel_842 Bool)) Bool (=> (or (= temp___is_init_840 true) (<= 1 4096)) (in_range10 temp___expr_843)))
(assert (= nullrawcertificate (certtypes__nullrawcertificate__aggregate_def 32)))
(define-fun dynamic_invariant15 ((temp___expr_901 Int) (temp___is_init_898 Bool) (temp___skip_constant_899 Bool) (temp___do_toplevel_900 Bool)) Bool (=> (or (= temp___is_init_898 true) (<= 0 4294967295)) (in_range15 temp___expr_901)))
...
(assert (=> (= result5 true) (and (=> (<= 0 2147483647) (in_range4 stop2)) (and (= stop2 0) (not (= (endoffile thefile2) true))))))
...
(assert (= (mk___rep (mk___split_fields temp___1080 temp___10801 temp___10802)) (thesubject (mk___rep5 (let ((subject thecontents__split_fields)) thecontents__split_fields1)))))
...
(assert (= thesubject__split_fields3 (mk___split_fields temp___1080 temp___10801 temp___10802)))
(assert (= o7 (cert_id_to_cert (mk___rep5 (let ((subject thecontents__split_fields)) thecontents__split_fields1)))))
...
(assert (= temp___1082 (thepublickey (mk___rep5 (let ((subject thecontents__split_fields)) thecontents__split_fields1)))))
(assert (= result10 (mk___split_fields__ref1 (mk___split_fields1 thepublickey__split_fields thepublickey__split_fields1 thepublickey__split_fields2))))
(assert (= thepublickey__split_fields3 (us_split_fields3 temp___1082)))
(assert (=> (= extracted true) (=> (= (to_rep2 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep2 (rec__cryptotypes__issuert__id theissuer__split_fields3))) (ite (= (ite (= (ite (= addedok2 true) (ite (= (of_int 1) false) (privatekeypresent state5) false) false) false) (ite (= addedok2 true) (ite (= (of_int 1) false) false (= (to_int1 (privatekeypresent state5)) (to_int1 (privatekeypresent state1)))) (= (to_int1 (privatekeypresent state5)) (to_int1 (privatekeypresent state1)))) true) true) (ite (= (ite (= (ite (= addedok2 true) (ite (= (of_int 1) false) (privatekeypresent state5) false) false) true) (ite (= addedok2 true) (ite (= (of_int 1) false) false (= (to_int1 (privatekeypresent state5)) (to_int1 (privatekeypresent state1)))) (= (to_int1 (privatekeypresent state5)) (to_int1 (privatekeypresent state1)))) false) false) true false) true))))
(assert (=> (= extracted true) (=> (= (to_rep2 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep2 (rec__cryptotypes__issuert__id theissuer__split_fields3))) (ite (= (ite (= (ite (= addedok2 true) (ite (= (of_int 1) false) (privatekeypresent state5) false) false) false) (ite (= addedok2 true) (ite (= (of_int 1) false) false (= (to_int1 (privatekeypresent state5)) (to_int1 (privatekeypresent state1)))) (= (to_int1 (privatekeypresent state5)) (to_int1 (privatekeypresent state1)))) true) true) true false))))
(assert (=> (= extracted true) (=> (= (to_rep2 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep2 (rec__cryptotypes__issuert__id theissuer__split_fields3))) (= store4 (mk___private__ref store3)))))
(assert (=> (= extracted true) (=> (= (to_rep2 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep2 (rec__cryptotypes__issuert__id theissuer__split_fields3))) (= state7 (mk___private__ref state5)))))
(assert (=> (= extracted true) (=> (= (to_rep2 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep2 (rec__cryptotypes__issuert__id theissuer__split_fields3))) (= filestate3 (mk___private__ref filestate2)))))
(assert (=> (= extracted true) (=> (= (to_rep2 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep2 (rec__cryptotypes__issuert__id theissuer__split_fields3))) (= state6 (mk___private__ref state4)))))
(assert (=> (= extracted true) (=> (= (to_rep2 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep2 (rec__cryptotypes__issuert__id theissuer__split_fields3))) (= addedok3 (mk_bool__ref addedok2)))))
(assert (=> (= extracted true) (=> (= (to_rep2 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep2 (rec__cryptotypes__issuert__id theissuer__split_fields3))) (= store5 store3))))
(assert (=> (= extracted true) (=> (= (to_rep2 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep2 (rec__cryptotypes__issuert__id theissuer__split_fields3))) (= state9 state5))))
(assert (=> (= extracted true) (=> (= (to_rep2 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep2 (rec__cryptotypes__issuert__id theissuer__split_fields3))) (= filestate4 filestate2))))
(assert (=> (= extracted true) (=> (= (to_rep2 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep2 (rec__cryptotypes__issuert__id theissuer__split_fields3))) (= state8 state4))))
(assert (=> (= extracted true) (=> (= (to_rep2 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep2 (rec__cryptotypes__issuert__id theissuer__split_fields3))) (= addedok4 addedok2))))
(assert (=> (= extracted true) (=> (not (= (to_rep2 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep2 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= store4 store16))))
(assert (=> (= extracted true) (=> (not (= (to_rep2 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep2 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= state7 state33))))
(assert (=> (= extracted true) (=> (not (= (to_rep2 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep2 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= filestate3 filestate18))))
(assert (=> (= extracted true) (=> (not (= (to_rep2 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep2 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= state6 state34))))
(assert (=> (= extracted true) (=> (not (= (to_rep2 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep2 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= addedok3 (mk_bool__ref addedok1)))))
(assert (=> (= extracted true) (=> (not (= (to_rep2 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep2 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= store5 store2))))
(assert (=> (= extracted true) (=> (not (= (to_rep2 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep2 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= state9 state3))))
(assert (=> (= extracted true) (=> (not (= (to_rep2 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep2 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= filestate4 filestate1))))
(assert (=> (= extracted true) (=> (not (= (to_rep2 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep2 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= state8 state2))))
(assert (=> (= extracted true) (=> (not (= (to_rep2 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep2 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= addedok4 addedok1))))
...
(assert (=> (= (ite (= extracted true) (bool__content addedok5) false) true) (= o8 (cert_id_to_cert (mk___rep5 (let ((subject thecontents__split_fields)) thecontents__split_fields1))))))
(assert (=> (= (ite (= extracted true) (bool__content addedok5) false) true) (= filestate8 (mk___private__ref filestate7))))
(assert (=> (= (ite (= extracted true) (bool__content addedok5) false) true) (= state15 (mk___private__ref state14))))
(assert (=> (= (ite (= extracted true) (bool__content addedok5) false) true) (= verifiedok3 (mk_bool__ref verifiedok2))))
(assert (=> (= (ite (= extracted true) (bool__content addedok5) false) true) (= filestate9 filestate7)))
(assert (=> (= (ite (= extracted true) (bool__content addedok5) false) true) (= state16 state14)))
(assert (=> (= (ite (= extracted true) (bool__content addedok5) false) true) (= verifiedok4 verifiedok2)))
(assert (=> (not (= (ite (= extracted true) (bool__content addedok5) false) true)) (= filestate8 filestate5)))
(assert (=> (not (= (ite (= extracted true) (bool__content addedok5) false) true)) (= state15 state10)))
(assert (=> (not (= (ite (= extracted true) (bool__content addedok5) false) true)) (= verifiedok3 (mk_bool__ref verifiedok1))))
(assert (=> (not (= (ite (= extracted true) (bool__content addedok5) false) true)) (= filestate9 filestate6)))
(assert (=> (not (= (ite (= extracted true) (bool__content addedok5) false) true)) (= state16 state12)))
(assert (=> (not (= (ite (= extracted true) (bool__content addedok5) false) true)) (= verifiedok4 verifiedok1)))
(assert (=> (ite (= (bool__content verifiedok3) true) (not (= (to_rep2 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep2 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false) (ite (= (ite (= (ite (= addedok7 true) (ite (= (of_int 1) false) (privatekeypresent state18) false) false) false) (ite (= addedok7 true) (ite (= (of_int 1) false) false (= (to_int1 (privatekeypresent state18)) (to_int1 (privatekeypresent (us_private__content state11))))) (= (to_int1 (privatekeypresent state18)) (to_int1 (privatekeypresent (us_private__content state11))))) true) true) (ite (= (ite (= (ite (= addedok7 true) (ite (= (of_int 1) false) (privatekeypresent state18) false) false) true) (ite (= addedok7 true) (ite (= (of_int 1) false) false (= (to_int1 (privatekeypresent state18)) (to_int1 (privatekeypresent (us_private__content state11))))) (= (to_int1 (privatekeypresent state18)) (to_int1 (privatekeypresent (us_private__content state11))))) false) false) true false) true)))
(assert (=> (ite (= (bool__content verifiedok3) true) (not (= (to_rep2 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep2 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false) (ite (= (ite (= (ite (= addedok7 true) (ite (= (of_int 1) false) (privatekeypresent state18) false) false) false) (ite (= addedok7 true) (ite (= (of_int 1) false) false (= (to_int1 (privatekeypresent state18)) (to_int1 (privatekeypresent (us_private__content state11))))) (= (to_int1 (privatekeypresent state18)) (to_int1 (privatekeypresent (us_private__content state11))))) true) true) true false)))
(assert (=> (ite (= (bool__content verifiedok3) true) (not (= (to_rep2 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep2 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false) (= store9 (mk___private__ref store8))))
(assert (=> (ite (= (bool__content verifiedok3) true) (not (= (to_rep2 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep2 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false) (= state20 (mk___private__ref state18))))
(assert (=> (ite (= (bool__content verifiedok3) true) (not (= (to_rep2 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep2 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false) (= filestate11 (mk___private__ref filestate10))))
(assert (=> (ite (= (bool__content verifiedok3) true) (not (= (to_rep2 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep2 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false) (= state19 (mk___private__ref state17))))
(assert (=> (ite (= (bool__content verifiedok3) true) (not (= (to_rep2 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep2 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false) (= addedok8 (mk_bool__ref addedok7))))
...
(assert (=> (= (ite (= (ite (= (bool__content verifiedok3) true) (bool__content addedok8) false) true) istis false) true) (ite (= (ite (= (ite (= addedok10 true) (ite (= (of_int 0) false) (privatekeypresent state24) false) false) false) (ite (= addedok10 true) (ite (= (of_int 0) false) false (= (to_int1 (privatekeypresent state24)) (to_int1 (privatekeypresent (us_private__content state20))))) (= (to_int1 (privatekeypresent state24)) (to_int1 (privatekeypresent (us_private__content state20))))) true) true) (ite (= (ite (= (ite (= addedok10 true) (ite (= (of_int 0) false) (privatekeypresent state24) false) false) true) (ite (= addedok10 true) (ite (= (of_int 0) false) false (= (to_int1 (privatekeypresent state24)) (to_int1 (privatekeypresent (us_private__content state20))))) (= (to_int1 (privatekeypresent state24)) (to_int1 (privatekeypresent (us_private__content state20))))) false) false) true false) true)))
(assert (=> (= (ite (= (ite (= (bool__content verifiedok3) true) (bool__content addedok8) false) true) istis false) true) (ite (= (ite (= (ite (= addedok10 true) (ite (= (of_int 0) false) (privatekeypresent state24) false) false) false) (ite (= addedok10 true) (ite (= (of_int 0) false) false (= (to_int1 (privatekeypresent state24)) (to_int1 (privatekeypresent (us_private__content state20))))) (= (to_int1 (privatekeypresent state24)) (to_int1 (privatekeypresent (us_private__content state20))))) true) true) true false)))
(assert (=> (= (ite (= (ite (= (bool__content verifiedok3) true) (bool__content addedok8) false) true) istis false) true) (= store12 (mk___private__ref store11))))
(assert (=> (= (ite (= (ite (= (bool__content verifiedok3) true) (bool__content addedok8) false) true) istis false) true) (= state26 (mk___private__ref state24))))
(assert (=> (= (ite (= (ite (= (bool__content verifiedok3) true) (bool__content addedok8) false) true) istis false) true) (= filestate14 (mk___private__ref filestate13))))
(assert (=> (= (ite (= (ite (= (bool__content verifiedok3) true) (bool__content addedok8) false) true) istis false) true) (= state25 (mk___private__ref state23))))
(assert (=> (= (ite (= (ite (= (bool__content verifiedok3) true) (bool__content addedok8) false) true) istis false) true) (= addedok11 (mk_bool__ref addedok10))))
...
(assert (=> (not (= extracted true)) (= o9 (makedescription (mk___t (temp___String_Literal_1085 Tuple0) (mk 1 43)) certno))))
(assert (=> (not (= extracted true)) (= result11 (mk_map__ref description1))))
(assert (=> (not (= extracted true)) (= description2 o9)))
(assert (=> (not (= extracted true)) (= description9 (mk_map__ref description2))))
(assert (=> (not (= extracted true)) (= description10 description2)))
(assert (=> (not (not (= extracted true))) (=> (not (= (bool__content addedok11) true)) (= o10 (makedescription (mk___t (temp___String_Literal_1084 Tuple0) (mk 1 39)) certno)))))
(assert (=> (not (not (= extracted true))) (=> (not (= (bool__content addedok11) true)) (= result12 (mk_map__ref description1)))))
(assert (=> (not (not (= extracted true))) (=> (not (= (bool__content addedok11) true)) (= description3 o10))))
(assert (=> (not (not (= extracted true))) (=> (not (= (bool__content addedok11) true)) (= description7 (mk_map__ref description3)))))
(assert (=> (not (not (= extracted true))) (=> (not (= (bool__content addedok11) true)) (= description8 description3))))
(assert (=> (not (not (= extracted true))) (=> (not (not (= (bool__content addedok11) true))) (=> (not (= (bool__content verifiedok3) true)) (= o11 (makedescription (mk___t (temp___String_Literal_1083 Tuple0) (mk 1 33)) certno))))))
(assert (=> (not (not (= extracted true))) (=> (not (not (= (bool__content addedok11) true))) (=> (not (= (bool__content verifiedok3) true)) (= result13 (mk_map__ref description1))))))
(assert (=> (not (not (= extracted true))) (=> (not (not (= (bool__content addedok11) true))) (=> (not (= (bool__content verifiedok3) true)) (= description4 o11)))))
(assert (=> (not (not (= extracted true))) (=> (not (not (= (bool__content addedok11) true))) (=> (not (= (bool__content verifiedok3) true)) (= description5 (mk_map__ref description4))))))
(assert (=> (not (not (= extracted true))) (=> (not (not (= (bool__content addedok11) true))) (=> (not (= (bool__content verifiedok3) true)) (= description6 description4)))))
(assert (=> (not (not (= extracted true))) (=> (not (not (= (bool__content addedok11) true))) (=> (not (not (= (bool__content verifiedok3) true))) (= description5 (mk_map__ref description1))))))
(assert (=> (not (not (= extracted true))) (=> (not (not (= (bool__content addedok11) true))) (=> (not (not (= (bool__content verifiedok3) true))) (= description6 description1)))))
(assert (=> (not (not (= extracted true))) (=> (not (not (= (bool__content addedok11) true))) (= description7 description5))))
(assert (=> (not (not (= extracted true))) (=> (not (not (= (bool__content addedok11) true))) (= description8 description6))))
...
(assert (= thepublickey__split_fields4 (mk___split_fields__ref1 thepublickey__split_fields3)))
...
(assert (= thecontents__split_fields2 (let ((subject thecontents__split_fields)) (mk___split_fields__ref5 thecontents__split_fields1))))
...
(assert (not (<= (to_int1 (ite (= istis true) (bool__content keyadded2) false)) (to_int1 (privatekeypresent (us_private__content state30))))))
(check-sat)
(exit)
