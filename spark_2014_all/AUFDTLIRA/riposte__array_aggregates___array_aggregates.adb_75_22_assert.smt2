...
(declare-fun temp_____aggregate_def_458 (Int Int) (Array Int enum_t))
(define-fun dynamic_invariant ((temp___expr_233 Int) (temp___is_init_229 Bool) (temp___skip_constant_230 Bool) (temp___do_toplevel_231 Bool) (temp___do_typ_inv_232 Bool)) Bool (=> (or (= temp___is_init_229 true) (<= 0 2)) (in_range temp___expr_233)))
(assert (forall ((temp___460 Int) (temp___461 Int)) (let ((temp___459 (temp_____aggregate_def_458 temp___460 temp___461))) (=> (and (dynamic_invariant temp___460 true true true true) (dynamic_invariant temp___461 true true true true)) (forall ((temp___462 Int)) (ite (or (= temp___462 1) (= temp___462 2)) (= (to_rep (select temp___459 temp___462)) temp___461) (=> (= temp___462 0) (= (to_rep (select temp___459 temp___462)) temp___460))))))))
(declare-const m (Array Int enum_t))
(declare-const result (Array Int enum_t))
(declare-const m1 (Array Int enum_t))
(assert (= result m))
(assert (= m1 (temp_____aggregate_def_458 0 1)))
