...
(assert (forall ((ka Int)) (=> (and (<= 1 ka) (<= ka ia2)) (forall ((kb Int)) (=> (and (<= (to_rep2 (first (rt b))) kb) (<= kb (to_rep2 (last (rt b))))) (not (and (= (to_rep (select (elts a) ka)) (to_rep (select (elts b) kb))) (= (is_perm (remove a ka) (remove b kb)) true))))))))
...
(assert (= ia3 (+ ia2 1)))
(assert (= (= result3 true) (exists ((ib Int)) (and (and (<= (to_rep2 (first (rt b))) ib) (<= ib (to_rep2 (last (rt b))))) (and (= (to_rep (select (elts a) ia3)) (to_rep (select (elts b) ib))) (= (is_perm (remove a ia3) (remove b ib)) true))))))
...
(assert (not (not (and (= (to_rep (select (elts a) ka)) (to_rep (select (elts b) kb))) (= (is_perm (remove a ka) (remove b kb)) true)))))
(check-sat)
(exit)
