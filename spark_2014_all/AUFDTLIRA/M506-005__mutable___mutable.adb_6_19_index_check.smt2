...
(define-fun dynamic_invariant1 ((temp___expr_175 us_rep) (temp___is_init_171 Bool) (temp___skip_constant_172 Bool) (temp___do_toplevel_173 Bool) (temp___do_typ_inv_174 Bool)) Bool (let ((temp___176 (rec__mutable__t__k (us_split_discrs1 temp___expr_175)))) (and (dynamic_property1 1 (to_rep1 temp___176) (first1 (rec__mutable__t__arr (us_split_fields1 temp___expr_175))) (last1 (rec__mutable__t__arr (us_split_fields1 temp___expr_175)))) (and (= (first1 (rec__mutable__t__arr (us_split_fields1 temp___expr_175))) 1) (= (last1 (rec__mutable__t__arr (us_split_fields1 temp___expr_175))) (to_rep1 temp___176))))))
(define-fun default_initial_assumption ((temp___expr_178 us_rep) (temp___skip_top_level_179 Bool)) Bool (and (= (attr__constrained temp___expr_178) false) (= (to_rep1 (rec__mutable__t__k (us_split_discrs1 temp___expr_178))) 10)))
(declare-const x us_rep)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(define-fun dynamic_invariant2 ((temp___expr_162 Int) (temp___is_init_158 Bool) (temp___skip_constant_159 Bool) (temp___do_toplevel_160 Bool) (temp___do_typ_inv_161 Bool)) Bool (=> (or (= temp___is_init_158 true) (<= 1 10)) (in_range1 temp___expr_162)))
(declare-const z Int)
(declare-const us Int)
(assert (dynamic_invariant1 x true false true true))
(assert (and (= us (to_rep1 (rec__mutable__t__k (us_split_discrs1 x)))) (in_range1 (to_rep1 (rec__mutable__t__k (us_split_discrs1 x))))))
(assert (=> (<= (- 2147483648) 2147483647) (in_range z)))
(assert (< 0 (to_rep1 (rec__mutable__t__k (us_split_discrs1 x)))))
(assert (not (<= (to_rep2 (first (rt (rec__mutable__t__arr (us_split_fields1 x))))) 1)))
(check-sat)
(exit)
