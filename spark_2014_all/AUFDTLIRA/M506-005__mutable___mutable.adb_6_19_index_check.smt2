...
(define-fun dynamic_invariant1 ((temp___expr_150 us_rep) (temp___is_init_147 Bool) (temp___skip_constant_148 Bool) (temp___do_toplevel_149 Bool)) Bool (let ((temp___151 (rec__mutable__t__k (us_split_discrs1 temp___expr_150)))) (and (dynamic_property1 1 (to_rep1 temp___151) (first1 (rec__mutable__t__arr (us_split_fields1 temp___expr_150))) (last1 (rec__mutable__t__arr (us_split_fields1 temp___expr_150)))) (and (= (first1 (rec__mutable__t__arr (us_split_fields1 temp___expr_150))) 1) (= (last1 (rec__mutable__t__arr (us_split_fields1 temp___expr_150))) (to_rep1 temp___151))))))
(define-fun default_initial_assumption ((temp___expr_153 us_rep) (temp___skip_top_level_154 Bool)) Bool (and (= (attr__constrained temp___expr_153) false) (= (to_rep1 (rec__mutable__t__k (us_split_discrs1 temp___expr_153))) 10)))
(declare-const x us_rep)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(define-fun dynamic_invariant2 ((temp___expr_139 Int) (temp___is_init_136 Bool) (temp___skip_constant_137 Bool) (temp___do_toplevel_138 Bool)) Bool (=> (or (= temp___is_init_136 true) (<= 1 10)) (in_range1 temp___expr_139)))
(declare-const z Int)
