...
(assert (not (= (ite (<= (to_rep1 (first4 temp___19711)) (to_rep1 (last4 temp___19711))) (+ (- (to_rep1 (last4 temp___19711)) (to_rep1 (first4 temp___19711))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 8) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 8)) 1) 0))))
(check-sat)
(exit)
