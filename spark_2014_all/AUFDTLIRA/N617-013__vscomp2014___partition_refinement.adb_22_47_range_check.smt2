...
(assert (= f1 o9))
(assert (forall ((j3 Int)) (=> (and (<= (to_rep2 (rec__partition_refinement__interval__first p_prime__split_fields3)) j3) (<= j3 i2)) (= (to_rep3 (select f2 j3)) p_prime_index2))))
(assert (forall ((j3 Int)) (=> (and (<= 0 j3) (<= j3 (- (to_rep2 (rec__partition_refinement__interval__first p_prime__split_fields3)) 1))) (= (to_rep3 (select f2 j3)) (to_rep3 (select f j3))))))
(assert (forall ((j3 Int)) (=> (and (<= (+ i2 1) j3) (<= j3 5)) (= (to_rep3 (select f2 j3)) (to_rep3 (select f j3))))))
...
(assert (<= 0 (- (to_rep2 (rec__partition_refinement__interval__first p_prime__split_fields3)) 1)))
(assert (not (<= (- (to_rep2 (rec__partition_refinement__interval__first p_prime__split_fields3)) 1) 5)))
(check-sat)
(exit)
