...
(assert (and (= o11 (+ a_first length1)) (in_range1 (+ a_first length1))))
(assert (= o12 (sorted (mk___t a (mk (to_rep a__first) (to_rep a__last))) o11 length2)))
(assert (= o10 (sorted (mk___t a (mk (to_rep a__first) (to_rep a__last))) a_first length1)))
(assert (and (= o8 (+ length1 length2)) (in_range1 (+ length1 length2))))
(assert (= o9 (ite (<= o8 2147483647) true false)))
(assert (=> (<= (to_rep b__first) (to_rep b__last)) (= o4 (+ (- (to_rep b__last) (to_rep b__first)) 1))))
(assert (=> (not (<= (to_rep b__first) (to_rep b__last))) (= o4 0)))
(assert (and (= o5 o4) (in_range1 o4)))
(assert (and (= o6 (+ length1 length2)) (in_range1 (+ length1 length2))))
