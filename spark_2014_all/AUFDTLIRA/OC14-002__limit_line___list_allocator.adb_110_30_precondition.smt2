...
(assert (and (= o54 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (in_range7 o54)))
(assert (= result12 (ite (in_range4 o54) true false)))
(assert (=> (= result12 true) (and (= o50 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range6 o50))))
(assert (=> (= result12 true) (= result13 (ite (< j o50) true false))))
(assert (=> (= result12 true) (=> (= result13 true) (and (= o51 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result12 true) (=> (= result13 true) (and (= o52 (get (rec__list_allocator__m__t__available model____split_fields3) o51)) (in_range7 o52)))))
(assert (=> (= result12 true) (=> (not (= result13 true)) (= o52 0))))
(assert (=> (= result12 true) (and (= temp___431 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (in_range7 temp___431))))
(assert (=> (= result12 true) (and (<= 1 temp___431) (<= temp___431 3))))
(assert (=> (= result12 true) (= o46 temp___431)))
(assert (=> (= result12 true) (= o47 (select data3 o46))))
(assert (=> (= result12 true) (= o48 (us_split_fields1 o47))))
(assert (=> (= result12 true) (= o49 (rec__list_allocator__cell__next o48))))
(assert (=> (= result12 true) (= o53 (to_rep o49))))
(assert (=> (= result12 true) (= result11 (ite (= o53 o52) true false))))
(assert (=> (not (= result12 true)) (= result11 false)))
(assert (= result11 true))
(assert (< 1 j))
(assert (and (= o45 (- j 1)) (in_range2 (- j 1))))
(assert (not (<= 1 o45)))
(check-sat)
(exit)
