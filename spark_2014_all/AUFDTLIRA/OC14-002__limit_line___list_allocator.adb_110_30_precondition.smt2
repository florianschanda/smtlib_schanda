...
(assert (=> (= result12 true) (and (= temp___398 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (in_range7 temp___398))))
(assert (=> (= result12 true) (and (<= 1 temp___398) (<= temp___398 3))))
(assert (=> (= result12 true) (= o46 temp___398)))
