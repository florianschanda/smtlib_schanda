...
(assert (and (and (and (= us (to_rep1 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 within)))) (in_range3 (to_rep1 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 within))))) (and (and (= (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 within))) r171b) (in_range3 r171b)) (or (and (and (and (= (mk_int__ref bounded_dynamic_strings__location__3__result16) (mk_int__ref bounded_dynamic_strings__location__3__result7)) (= (mk_int__ref k12) (mk_int__ref k6))) (and (= bounded_dynamic_strings__location__3__result17 bounded_dynamic_strings__location__3__result8) (= k13 k7))) (and (= temp___1256 1) (and (= temp___1257 r171b) (and (and (= (mk_int__ref result) (mk_int__ref k)) (= k1 temp___1256)) (and (and (<= temp___1256 k1) (<= k1 temp___1257)) (and (= temp___1252 k1) (or (and (and (and (= bounded_dynamic_strings__location__3__result2 bounded_dynamic_strings__location__3__result7) (= k1 k6)) (and (= bounded_dynamic_strings__location__3__result8 bounded_dynamic_strings__location__3__result2) (= k7 k1))) (and (and (and (and (and (and (<= (to_rep2 (first (rt (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))) k1) (<= k1 (to_rep2 (last (rt (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))))) (= o k1)) (= o1 (select (elts (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))) o))) (= o2 (to_rep o1))) (= result1 (ite (= o2 fragment) true false))) (and (= result1 true) (and (= result2 bounded_dynamic_strings__location__3__result) (= bounded_dynamic_strings__location__3__result2 k1))))) (and (and (and (and (and (and (and (<= (to_rep2 (first (rt (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))) k1) (<= k1 (to_rep2 (last (rt (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))))) (= o k1)) (= o1 (select (elts (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))) o))) (= o2 (to_rep o1))) (= result1 (ite (= o2 fragment) true false))) (and (not (= result1 true)) (and (= bounded_dynamic_strings__location__3__result2 bounded_dynamic_strings__location__3__result) (= bounded_dynamic_strings__location__3__result2 bounded_dynamic_strings__location__3__result1)))) (and (and (and (= bounded_dynamic_strings__location__3__result4 bounded_dynamic_strings__location__3__result7) (= k3 k6)) (and (= bounded_dynamic_strings__location__3__result8 bounded_dynamic_strings__location__3__result4) (= k7 k3))) (and (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 k2)) (not (= (to_rep (select (elts (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))) j1)) fragment)))) (and (and (=> (<= 1 r171b) (dynamic_property2 1 r171b k2)) (and (<= 1 k2) (<= k2 r171b))) (and (not (= k2 temp___1257)) (and (and (= k2 result3) (= k3 (+ k2 1))) (and (and (and (and (and (and (<= (to_rep2 (first (rt (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))) k3) (<= k3 (to_rep2 (last (rt (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))))) (= o3 k3)) (= o4 (select (elts (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))) o3))) (= o5 (to_rep o4))) (= result4 (ite (= o5 fragment) true false))) (and (= result4 true) (and (= result5 bounded_dynamic_strings__location__3__result3) (= bounded_dynamic_strings__location__3__result4 k3))))))))))))))))) (and (and (and (= (mk_int__ref result) (mk_int__ref k)) (= k1 1)) (ite (and (<= 1 k1) (<= k1 r171b)) (and (and (and (= temp___1252 k1) (and (and (and (and (and (and (and (<= (to_rep2 (first (rt (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))) k1) (<= k1 (to_rep2 (last (rt (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))))) (= o k1)) (= o1 (select (elts (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))) o))) (= o2 (to_rep o1))) (= result1 (ite (= o2 fragment) true false))) (and (not (= result1 true)) (and (= bounded_dynamic_strings__location__3__result2 bounded_dynamic_strings__location__3__result) (= bounded_dynamic_strings__location__3__result2 bounded_dynamic_strings__location__3__result1)))) (and (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 k2)) (not (= (to_rep (select (elts (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))) j1)) fragment)))) (and (and (=> (<= 1 r171b) (dynamic_property2 1 r171b k2)) (and (<= 1 k2) (<= k2 r171b))) (= k2 r171b))))) (and (and (= bounded_dynamic_strings__location__3__result3 bounded_dynamic_strings__location__3__result9) (= k2 k8)) (and (= bounded_dynamic_strings__location__3__result10 bounded_dynamic_strings__location__3__result3) (= k9 k2)))) (and (and (= (mk_int__ref bounded_dynamic_strings__location__3__result11) (mk_int__ref bounded_dynamic_strings__location__3__result9)) (= (mk_int__ref k10) (mk_int__ref k8))) (and (= bounded_dynamic_strings__location__3__result12 bounded_dynamic_strings__location__3__result10) (= k11 k9)))) (and (and (= (mk_int__ref bounded_dynamic_strings__location__3__result11) (mk_int__ref bounded_dynamic_strings__location__3__result)) (= k1 k10)) (and (= bounded_dynamic_strings__location__3__result12 bounded_dynamic_strings__location__3__result1) (= k11 k1))))) (and (and (and (= (mk_int__ref bounded_dynamic_strings__location__3__result16) (mk_int__ref bounded_dynamic_strings__location__3__result14)) (= (mk_int__ref k12) (mk_int__ref k10))) (and (= bounded_dynamic_strings__location__3__result17 bounded_dynamic_strings__location__3__result15) (= k13 k11))) (and (and (= bounded_dynamic_strings__location__3__result13 bounded_dynamic_strings__location__3__result14) (= bounded_dynamic_strings__location__3__result15 bounded_dynamic_strings__location__3__result13)) (and (= result6 bounded_dynamic_strings__location__3__result11) (= bounded_dynamic_strings__location__3__result13 0)))))))) (and (and (= (mk_int__ref bounded_dynamic_strings__location__3__result18) (mk_int__ref bounded_dynamic_strings__location__3__result16)) (= (mk_int__ref k14) (mk_int__ref k12))) (and (= bounded_dynamic_strings__location__3__result19 bounded_dynamic_strings__location__3__result17) (= k15 k13)))))
(assert (= result7 bounded_dynamic_strings__location__3__result18))
(assert (not (<= 0 bounded_dynamic_strings__location__3__result18)))
(check-sat)
(exit)
