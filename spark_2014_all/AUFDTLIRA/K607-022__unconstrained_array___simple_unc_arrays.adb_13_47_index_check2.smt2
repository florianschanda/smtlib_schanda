...
(assert (<= 1 i1))
(assert (<= i1 r7b))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- i2 1))) (= (to_rep2 (select (elts1 (rec__simple_unc_arrays__table__v1 c__split_fields2)) j1)) (+ (to_rep2 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) j1)) (to_rep2 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 b))) j1)))))))
(assert (and (and (and (dynamic_invariant2 (mk___rep1 c__split_discrs c__split_fields2) false true true true) (forall ((temp___861 Int)) (=> (and (<= (to_rep1 (first2 (rt1 (rec__simple_unc_arrays__table__v1 c__split_fields2)))) temp___861) (<= temp___861 (to_rep1 (last2 (rt1 (rec__simple_unc_arrays__table__v1 c__split_fields2)))))) (=> (or (< r7b temp___861) (or (< temp___861 1) (<= i2 temp___861))) (= (select (elts1 (rec__simple_unc_arrays__table__v1 c__split_fields2)) temp___861) (select c__split_fields temp___861)))))) (=> (<= 1 r7b) (dynamic_property4 1 r7b i2))) (and (<= 1 i2) (<= i2 r7b))))
(assert (<= 1 j))
(assert (<= j (- i2 1)))
...
(assert (and (<= (to_rep1 (first (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))) j) (<= j (to_rep1 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))))))
(assert (= o j))
...
(assert (not (<= (to_rep1 (first2 (rt1 (rec__simple_unc_arrays__table__v1 c__split_fields2)))) j)))
(check-sat)
(exit)
