...
(define-fun i27 () int__ref (mk_int__ref i1))
(define-fun i28 () int__ref (mk_int__ref i))
...
(assert (and (and (and (and (<= begidx2 endidx1) (<= begidx2 zlength)) (<= endidx1 zlength)) (=> (= foundtype1 1) (forall ((i29 Int)) (=> (and (<= begidx2 i29) (<= i29 endidx1)) (and (<= 48 (to_rep (select zonefileline i29))) (<= (to_rep (select zonefileline i29)) 57)))))) (and (and (in_range4 begidx2) (in_range4 endidx1)) (in_range3 foundtype1))))
...
(assert (=> (and (not (= foundtype1 3)) (< endidx1 zlength)) (and (and (and (and (<= begidx5 endidx3) (<= begidx5 zlength)) (<= endidx3 zlength)) (=> (= foundtype3 1) (forall ((i29 Int)) (=> (and (<= begidx5 i29) (<= i29 endidx3)) (and (<= 48 (to_rep (select zonefileline i29))) (<= (to_rep (select zonefileline i29)) 57)))))) (and (and (in_range4 begidx5) (in_range4 endidx3)) (in_range3 foundtype3)))))
...
(assert (= begidx10 o1))
(assert (and (and (and (and (<= begidx11 endidx8) (<= begidx11 zlength)) (<= endidx8 zlength)) (=> (= foundtype8 1) (forall ((i29 Int)) (=> (and (<= begidx11 i29) (<= i29 endidx8)) (and (<= 48 (to_rep (select zonefileline i29))) (<= (to_rep (select zonefileline i29)) 57)))))) (and (and (in_range4 begidx11) (in_range4 endidx8)) (in_range3 foundtype8))))
...
(assert (=> (< 128 lengthoftoken1) (= i18 i27)))
(assert (=> (< 128 lengthoftoken1) (= i17 i28)))
...
(assert (=> (not (< 128 lengthoftoken1)) (= result7 i28)))
(assert (=> (not (< 128 lengthoftoken1)) (= i5 r23b)))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r23b i5) (<= i5 r24b)) (= temp___1619 i5))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r23b i5) (<= i5 r24b)) (= temp___1617 newdomainname1))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r23b i5) (<= i5 r24b)) (= temp___1620 endidx8))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r23b i5) (<= i5 r24b)) (and (and (<= 1 begidx11) (<= (+ (- endidx8 begidx11) 1) 128)) (= endidx8 temp___1620)))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r23b i5) (<= i5 r24b)) (and (=> (<= r23b r24b) (dynamic_property r23b r24b i6)) (and (<= r23b i6) (<= i6 r24b))))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r23b i5) (<= i5 r24b)) (= (to_rep o5) (to_rep (select zonefileline i6))))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r23b i5) (<= i5 r24b)) (and (= o3 (+ i6 1)) (in_range1 (+ i6 1))))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r23b i5) (<= i5 r24b)) (= o4 (- o3 begidx11)))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r23b i5) (<= i5 r24b)) (and (= temp___1616 o4) (in_range1 o4)))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r23b i5) (<= i5 r24b)) (and (<= 1 temp___1616) (<= temp___1616 128)))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r23b i5) (<= i5 r24b)) (= o6 temp___1616))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r23b i5) (<= i5 r24b)) (= o7 (store newdomainname2 o6 o5)))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r23b i5) (<= i5 r24b)) (= result8 (mk_map__ref newdomainname2)))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r23b i5) (<= i5 r24b)) (= newdomainname3 o7))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r23b i5) (<= i5 r24b)) (= i6 r24b))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r23b i5) (<= i5 r24b)) (= i7 (mk_int__ref i6)))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r23b i5) (<= i5 r24b)) (= newdomainname4 (mk_map__ref newdomainname3)))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r23b i5) (<= i5 r24b)) (= i8 i6))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r23b i5) (<= i5 r24b)) (= newdomainname5 newdomainname3))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r23b i5) (<= i5 r24b)) (= i9 i7))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r23b i5) (<= i5 r24b)) (= newdomainname6 newdomainname4))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r23b i5) (<= i5 r24b)) (= i10 i8))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r23b i5) (<= i5 r24b)) (= newdomainname7 newdomainname5))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (not (and (<= r23b i5) (<= i5 r24b))) (= i9 (mk_int__ref i5)))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (not (and (<= r23b i5) (<= i5 r24b))) (= newdomainname6 (mk_map__ref newdomainname1)))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (not (and (<= r23b i5) (<= i5 r24b))) (= i10 i5))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (not (and (<= r23b i5) (<= i5 r24b))) (= newdomainname7 newdomainname1))))
(assert (=> (not (< 128 lengthoftoken1)) (= (+ endidx8 1) r26b)))
(assert (=> (not (< 128 lengthoftoken1)) (in_range1 r26b)))
(assert (=> (not (< 128 lengthoftoken1)) (= result9 i27)))
(assert (=> (not (< 128 lengthoftoken1)) (= i11 r26b)))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r26b i11) (<= i11 128)) (= temp___1625 i11))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r26b i11) (<= i11 128)) (= temp___1623 (map__content newdomainname6)))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r26b i11) (<= i11 128)) (<= 1 endidx8))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r26b i11) (<= i11 128)) (and (and (forall ((temp___1624 Int)) (=> (and (<= 1 temp___1624) (<= temp___1624 128)) (=> (<= i12 temp___1624) (= (select newdomainname8 temp___1624) (select temp___1623 temp___1624))))) (=> (<= r26b 128) (dynamic_property1 r26b 128 i12))) (and (<= r26b i12) (<= i12 128))))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r26b i11) (<= i11 128)) (= (to_rep o8) 32))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r26b i11) (<= i11 128)) (= o9 (store newdomainname8 i12 o8)))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r26b i11) (<= i11 128)) (= result10 (mk_map__ref newdomainname8)))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r26b i11) (<= i11 128)) (= newdomainname9 o9))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r26b i11) (<= i11 128)) (= i12 128))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r26b i11) (<= i11 128)) (= i13 (mk_int__ref i12)))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r26b i11) (<= i11 128)) (= newdomainname10 (mk_map__ref newdomainname9)))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r26b i11) (<= i11 128)) (= i14 i12))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r26b i11) (<= i11 128)) (= newdomainname11 newdomainname9))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r26b i11) (<= i11 128)) (= i15 i13))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r26b i11) (<= i11 128)) (= newdomainname12 newdomainname10))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r26b i11) (<= i11 128)) (= i16 i14))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r26b i11) (<= i11 128)) (= newdomainname13 newdomainname11))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (not (and (<= r26b i11) (<= i11 128))) (= i15 (mk_int__ref i11)))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (not (and (<= r26b i11) (<= i11 128))) (= newdomainname12 newdomainname6))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (not (and (<= r26b i11) (<= i11 128))) (= i16 i11))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (not (and (<= r26b i11) (<= i11 128))) (= newdomainname13 newdomainname7))))
(assert (=> (not (< 128 lengthoftoken1)) (= i18 i15)))
(assert (=> (not (< 128 lengthoftoken1)) (= i17 i9)))
(assert (=> (not (< 128 lengthoftoken1)) (= success3 success5)))
(assert (=> (not (< 128 lengthoftoken1)) (= newdomainname14 newdomainname12)))
(assert (=> (not (< 128 lengthoftoken1)) (= i20 i16)))
(assert (=> (not (< 128 lengthoftoken1)) (= i19 i10)))
...
(assert (= begidx12 o10))
(assert (and (and (and (and (<= begidx13 endidx9) (<= begidx13 zlength)) (<= endidx9 zlength)) (=> (= foundtype9 1) (forall ((i29 Int)) (=> (and (<= begidx13 i29) (<= i29 endidx9)) (and (<= 48 (to_rep (select zonefileline i29))) (<= (to_rep (select zonefileline i29)) 57)))))) (and (and (in_range4 begidx13) (in_range4 endidx9)) (in_range3 foundtype9))))
...
(assert (= i21 r28b))
(assert (=> (and (<= r28b i21) (<= i21 r29b)) (= temp___1632 endidx9)))
(assert (=> (and (<= r28b i21) (<= i21 r29b)) (= temp___1630 rrstring1)))
(assert (=> (and (<= r28b i21) (<= i21 r29b)) (= temp___1629 i21)))
(assert (=> (and (<= r28b i21) (<= i21 r29b)) (and (and (<= 1 begidx13) (<= (+ (- endidx9 begidx13) 1) 128)) (= endidx9 temp___1632))))
(assert (=> (and (<= r28b i21) (<= i21 r29b)) (and (=> (<= r28b r29b) (dynamic_property2 r28b r29b i22)) (and (<= r28b i22) (<= i22 r29b)))))
(assert (=> (and (<= r28b i21) (<= i21 r29b)) (= (to_rep o14) (to_rep (select zonefileline i22)))))
(assert (=> (and (<= r28b i21) (<= i21 r29b)) (and (= o12 (+ i22 1)) (in_range1 (+ i22 1)))))
(assert (=> (and (<= r28b i21) (<= i21 r29b)) (= o13 (- o12 begidx13))))
(assert (=> (and (<= r28b i21) (<= i21 r29b)) (and (= temp___1628 o13) (in_range1 o13))))
(assert (=> (and (<= r28b i21) (<= i21 r29b)) (and (<= 1 temp___1628) (<= temp___1628 256))))
(assert (=> (and (<= r28b i21) (<= i21 r29b)) (= o15 temp___1628)))
(assert (=> (and (<= r28b i21) (<= i21 r29b)) (= o16 (store rrstring2 o15 o14))))
(assert (=> (and (<= r28b i21) (<= i21 r29b)) (= result14 (mk_map__ref rrstring2))))
(assert (=> (and (<= r28b i21) (<= i21 r29b)) (= rrstring3 o16)))
(assert (=> (and (<= r28b i21) (<= i21 r29b)) (= i22 r29b)))
(assert (=> (and (<= r28b i21) (<= i21 r29b)) (= i23 (mk_int__ref i22))))
(assert (=> (and (<= r28b i21) (<= i21 r29b)) (= rrstring4 (mk_map__ref rrstring3))))
(assert (=> (and (<= r28b i21) (<= i21 r29b)) (= i24 i22)))
(assert (=> (and (<= r28b i21) (<= i21 r29b)) (= rrstring5 rrstring3)))
(assert (=> (and (<= r28b i21) (<= i21 r29b)) (= i25 i23)))
(assert (=> (and (<= r28b i21) (<= i21 r29b)) (= rrstring6 rrstring4)))
(assert (=> (and (<= r28b i21) (<= i21 r29b)) (= i26 i24)))
(assert (=> (and (<= r28b i21) (<= i21 r29b)) (= rrstring7 rrstring5)))
(assert (=> (not (and (<= r28b i21) (<= i21 r29b))) (= i25 (mk_int__ref i21))))
(assert (=> (not (and (<= r28b i21) (<= i21 r29b))) (= rrstring6 (mk_map__ref rrstring1))))
(assert (=> (not (and (<= r28b i21) (<= i21 r29b))) (= i26 i21)))
(assert (=> (not (and (<= r28b i21) (<= i21 r29b))) (= rrstring7 rrstring1)))
(assert (= (- (+ endidx9 2) begidx13) r31b))
(assert (in_range1 r31b))
(assert (<= r31b 256))
(assert (not (<= (- 2147483648) r31b)))
(check-sat)
(exit)
