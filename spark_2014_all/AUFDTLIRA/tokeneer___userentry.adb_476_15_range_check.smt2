...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1703 us_void_param) 1)) 65) (= (to_rep (select (temp___String_Literal_1703 us_void_param) 2)) 99)) (= (to_rep (select (temp___String_Literal_1703 us_void_param) 3)) 104)) (= (to_rep (select (temp___String_Literal_1703 us_void_param) 4)) 101)) (= (to_rep (select (temp___String_Literal_1703 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_1703 us_void_param) 6)) 118)) (= (to_rep (select (temp___String_Literal_1703 us_void_param) 7)) 101)) (= (to_rep (select (temp___String_Literal_1703 us_void_param) 8)) 100)) (= (to_rep (select (temp___String_Literal_1703 us_void_param) 9)) 32)) (= (to_rep (select (temp___String_Literal_1703 us_void_param) 10)) 70)) (= (to_rep (select (temp___String_Literal_1703 us_void_param) 11)) 65)) (= (to_rep (select (temp___String_Literal_1703 us_void_param) 12)) 82)) (= (to_rep (select (temp___String_Literal_1703 us_void_param) 13)) 32)) (= (to_rep (select (temp___String_Literal_1703 us_void_param) 14)) 58)) (= (to_rep (select (temp___String_Literal_1703 us_void_param) 15)) 32)) :pattern ((temp___String_Literal_1703 us_void_param)))))
...
(define-fun dynamic_invariant5 ((temp___expr_334 Int) (temp___is_init_331 Bool) (temp___skip_constant_332 Bool) (temp___do_toplevel_333 Bool)) Bool (=> (or (= temp___is_init_331 true) (<= 1 150)) (in_range4 temp___expr_334)))
...
(assert (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 achievedfar))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 achievedfar)))))) (= o (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 achievedfar))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 achievedfar)))))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 achievedfar))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 achievedfar))))))) (= o 0)))
