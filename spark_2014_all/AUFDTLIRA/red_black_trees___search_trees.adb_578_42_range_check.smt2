...
(assert (and (= result (valid_root (rec__search_trees__search_tree__struct (us_split_fields7 t1)) o)) (=> (< (size (rec__search_trees__search_tree__struct (us_split_fields7 t1))) o) (not (= result true)))))
(assert (= result true))
