...
(assert (dynamic_property1 (- 2147483648) 2147483647 (to_rep (first temp___2441)) (to_rep (last temp___2441))))
(assert (= temp___244 o))
(assert (= (mk1 (to_rep (first temp___2441)) (to_rep (last temp___2441))) o1))
(declare-const i Int)
(assert (<= (to_rep (first2 o1)) i))
(assert (<= i (to_rep (last2 o1))))
(assert (not (= i (to_rep (first2 o1)))))
