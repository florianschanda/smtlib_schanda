...
(assert (dynamic_property1 (- 2147483648) 2147483647 (to_rep (first temp___2811)) (to_rep (last temp___2811))))
(assert (= temp___281 o))
(assert (= (mk1 (to_rep (first temp___2811)) (to_rep (last temp___2811))) o1))
(declare-const i Int)
