...
(assert (= (ite (<= (to_rep1 (first4 temp___3111)) (to_rep1 (last4 temp___3111))) (+ (- (to_rep1 (last4 temp___3111)) (to_rep1 (first4 temp___3111))) 1) 0) (ite (<= 0 r6b) (+ (- r6b 0) 1) 0)))
(assert (= temp___311 temp___312))
(assert (= (mk1 (to_rep1 (first4 temp___3111)) (to_rep1 (last4 temp___3111))) temp___3121))
(assert (not (= (ite (<= (to_rep1 (first2 temp___3121)) (to_rep1 (last2 temp___3121))) (+ (- (to_rep1 (last2 temp___3121)) (to_rep1 (first2 temp___3121))) 1) 0) (ite (<= (to_rep1 (first d__split_fields1)) (to_rep1 (last d__split_fields1))) (+ (- (to_rep1 (last d__split_fields1)) (to_rep1 (first d__split_fields1))) 1) 0))))
(check-sat)
(exit)
