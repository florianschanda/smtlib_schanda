...
(declare-const temp___360 (Array Int Bool))
(declare-const temp___3601 t1)
...
(assert (= (ite (<= (to_rep1 (first4 temp___3591)) (to_rep1 (last4 temp___3591))) (+ (- (to_rep1 (last4 temp___3591)) (to_rep1 (first4 temp___3591))) 1) 0) (ite (<= 0 r6b) (+ (- r6b 0) 1) 0)))
(assert (= temp___359 temp___360))
(assert (= (mk1 (to_rep1 (first4 temp___3591)) (to_rep1 (last4 temp___3591))) temp___3601))
(assert (not (= (ite (<= (to_rep1 (first2 temp___3601)) (to_rep1 (last2 temp___3601))) (+ (- (to_rep1 (last2 temp___3601)) (to_rep1 (first2 temp___3601))) 1) 0) (ite (<= (to_rep1 (first d__split_fields1)) (to_rep1 (last d__split_fields1))) (+ (- (to_rep1 (last d__split_fields1)) (to_rep1 (first d__split_fields1))) 1) 0))))
(check-sat)
(exit)
