...
(define-fun dynamic_invariant ((temp___expr_164 Int) (temp___is_init_160 Bool) (temp___skip_constant_161 Bool) (temp___do_toplevel_162 Bool) (temp___do_typ_inv_163 Bool)) Bool (=> (or (= temp___is_init_160 true) (<= (- 2147483648) 2147483647)) (in_range temp___expr_164)))
...
(define-fun dynamic_invariant2 ((temp___expr_178 Int) (temp___is_init_174 Bool) (temp___skip_constant_175 Bool) (temp___do_toplevel_176 Bool) (temp___do_typ_inv_177 Bool)) Bool (=> (or (= temp___is_init_174 true) (<= 0 128)) (in_range3 temp___expr_178)))
(declare-const it Int)
(declare-const attr__ATTRIBUTE_ADDRESS4 Int)
(declare-const item Int)
(declare-const attr__ATTRIBUTE_ADDRESS5 Int)
(declare-const attr__ATTRIBUTE_ADDRESS6 Int)
(define-fun dynamic_invariant3 ((temp___expr_190 Int) (temp___is_init_186 Bool) (temp___skip_constant_187 Bool) (temp___do_toplevel_188 Bool) (temp___do_typ_inv_189 Bool)) Bool (=> (or (= temp___is_init_186 true) (<= 0 128)) (in_range1 temp___expr_190)))
...
(declare-const o10 element_type)
(declare-const o11 index_type)
(declare-const o12 index_type)
(declare-const o13 element_type)
(declare-const o14 index_type)
(declare-const o15 index_type)
(declare-const o16 (Array Int us_rep))
(declare-const o17 index_type)
(declare-const o18 element_type)
(declare-const o19 index_type)
(declare-const o20 index_type)
(declare-const o21 element_type)
...
(assert (= o1 o2))
(assert (= o o3))
(assert (= (rec__list_handler__integer_list__list_node__previous (us_split_fields1 (select memory it))) o4))
(assert (= o5 o2))
(assert (= o6 o3))
(assert (= o7 o4))
(assert (= o8 (store memory new_pointer1 (mk___rep (mk___split_fields o5 o6 o7)))))
(assert (= result3 memory))
(assert (= memory1 o8))
(assert (= (to_rep1 o9) new_pointer1))
(assert (= (rec__list_handler__integer_list__list_node__value (us_split_fields1 (select memory1 (to_rep1 (rec__list_handler__integer_list__list_node__previous (us_split_fields1 (select memory1 it))))))) o10))
(assert (= o9 o11))
(assert (= (rec__list_handler__integer_list__list_node__previous (us_split_fields1 (select memory1 (to_rep1 (rec__list_handler__integer_list__list_node__previous (us_split_fields1 (select memory1 it))))))) o12))
(assert (= o13 o10))
(assert (= o14 o11))
(assert (= o15 o12))
(assert (= o16 (store memory1 (to_rep1 (rec__list_handler__integer_list__list_node__previous (us_split_fields1 (select memory1 it)))) (mk___rep (mk___split_fields o13 o14 o15)))))
(assert (= result4 memory1))
(assert (= memory2 o16))
(assert (= (to_rep1 o17) new_pointer1))
(assert (= (rec__list_handler__integer_list__list_node__value (us_split_fields1 (select memory2 it))) o18))
(assert (= (rec__list_handler__integer_list__list_node__next (us_split_fields1 (select memory2 it))) o19))
(assert (= o17 o20))
(assert (= o21 o18))
(assert (= o22 o19))
(assert (= o23 o20))
(assert (= o24 (store memory2 it (mk___rep (mk___split_fields o21 o22 o23)))))
