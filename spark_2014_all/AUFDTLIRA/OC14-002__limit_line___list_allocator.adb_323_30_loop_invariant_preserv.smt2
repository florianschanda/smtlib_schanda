...
(assert (not (= r10 3)))
(assert (= result11 (mk_int__ref r10)))
(assert (= r11 (+ r10 1)))
(assert (and (= o49 (add (rec__list_allocator__m__t__available model____split_fields4) r11)) (= (is_add (rec__list_allocator__m__t__available model____split_fields4) r11 o49) true)))
(assert (= o50 (mk___split_fields1 o49 (rec__list_allocator__m__t__allocated model____split_fields4))))
(assert (= temp___3631 (mk___rep1 o50)))
(assert (= result12 (mk___split_fields__ref1 model____split_fields4)))
(assert (= model____split_fields5 (us_split_fields3 temp___3631)))
...
(assert (<= 1 rr3))
(assert (<= rr3 (int__content r12)))
(assert (not (= (mem (rec__list_allocator__m__t__available (us_split_fields__content1 model____split_fields6)) rr3) true)))
(check-sat)
(exit)
