...
(declare-const temp___3981 us_rep2)
...
(assert (= r10 (+ r9 1)))
(assert (and (= o27 (add (rec__list_allocator__m__t__available model____split_fields3) r10)) (= (is_add (rec__list_allocator__m__t__available model____split_fields3) r10 o27) true)))
(assert (= o28 (mk___split_fields1 o27 (rec__list_allocator__m__t__allocated model____split_fields3))))
(assert (= temp___3981 (mk___rep1 o28)))
(assert (= result9 (mk___split_fields__ref1 model____split_fields3)))
(assert (= model____split_fields4 (us_split_fields3 temp___3981)))
