...
(declare-const temp___3961 us_rep2)
...
(assert (forall ((rr Int)) (=> (and (<= 1 rr) (<= rr r9)) (= (mem (rec__list_allocator__m__t__available model____split_fields3) rr) true))))
...
(assert (= r10 (+ r9 1)))
(assert (and (= o29 (add (rec__list_allocator__m__t__available model____split_fields3) r10)) (= (is_add (rec__list_allocator__m__t__available model____split_fields3) r10 o29) true)))
(assert (= o30 (mk___split_fields1 o29 (rec__list_allocator__m__t__allocated model____split_fields3))))
(assert (= temp___3961 (mk___rep1 o30)))
(assert (= result9 (mk___split_fields__ref1 model____split_fields3)))
(assert (= model____split_fields4 (us_split_fields3 temp___3961)))
...
(assert (not (= (mem (rec__list_allocator__m__t__available (us_split_fields__content1 model____split_fields5)) rr) true)))
(check-sat)
(exit)
