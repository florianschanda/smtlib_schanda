...
(assert (dynamic_property 1 2147483647 (to_rep1 (first2 temp___5081)) (to_rep1 (last2 temp___5081))))
(assert (= temp___508 o1))
(assert (= (mk (to_rep1 (first2 temp___5081)) (to_rep1 (last2 temp___5081))) o2))
