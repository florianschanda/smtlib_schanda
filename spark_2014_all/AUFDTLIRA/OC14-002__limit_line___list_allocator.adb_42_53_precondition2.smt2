...
(assert (=> (not (= first_available 0)) (and (= o9 (length model____split_fields)) (in_range3 o9))))
(assert (=> (not (= first_available 0)) (= result2 (ite (< 0 o9) true false))))
(assert (=> (not (= first_available 0)) (=> (= result2 true) (and (= o8 (get model____split_fields 1)) (in_range4 o8)))))
(assert (=> (not (= first_available 0)) (=> (= result2 true) (= result1 (ite (= o8 first_available) true false)))))
(assert (=> (not (= first_available 0)) (=> (not (= result2 true)) (= result1 false))))
(assert (=> (not (not (= first_available 0))) (and (= o10 (length model____split_fields)) (in_range3 o10))))
(assert (=> (not (not (= first_available 0))) (= result1 (ite (= o10 0) true false))))
(assert (=> (= result1 true) (=> (not (= first_allocated 0)) (and (= o6 (length model____split_fields1)) (in_range3 o6)))))
(assert (=> (= result1 true) (=> (not (= first_allocated 0)) (= result3 (ite (< 0 o6) true false)))))
(assert (=> (= result1 true) (=> (not (= first_allocated 0)) (=> (= result3 true) (and (= o5 (get model____split_fields1 1)) (in_range4 o5))))))
(assert (=> (= result1 true) (=> (not (= first_allocated 0)) (=> (= result3 true) (= result (ite (= o5 first_allocated) true false))))))
(assert (=> (= result1 true) (=> (not (= first_allocated 0)) (=> (not (= result3 true)) (= result false)))))
(assert (=> (= result1 true) (=> (not (not (= first_allocated 0))) (and (= o7 (length model____split_fields1)) (in_range3 o7)))))
(assert (=> (= result1 true) (=> (not (not (= first_allocated 0))) (= result (ite (= o7 0) true false)))))
...
(assert (= result4 true))
(assert (and (= o4 (get model____split_fields j)) (in_range4 o4)))
(assert (= result5 (ite (in_range6 o4) true false)))
(assert (= result5 true))
