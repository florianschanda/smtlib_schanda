...
(assert (not (= (let ((temp___402 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 (us_split_fields__content4 current__split_fields6)))))) (bool_eq (elts2 temp___402) (to_rep1 (first4 (rt2 temp___402))) (to_rep1 (last4 (rt2 temp___402))) current__split_fields2 (to_rep1 (first4 current__split_fields3)) (to_rep1 (last4 current__split_fields3)))) true)))
(check-sat)
(exit)
