...
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o71 (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) t)) (and (dynamic_invariant3 o71 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o71 t))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select o71 t)))) 0) (and (forall ((i8 Int)) (=> (and (<= 1 i8) (<= i8 100)) (=> (not (= i8 t)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i8) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select o71 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i8)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select o71 i8))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select o71 i8))) true)))))) (and (forall ((i8 Int)) (=> (and (<= 1 i8) (<= i8 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o71 i8))) true) (not (= i8 t))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select o71 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i8)))) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i8) (rec__tree_model__path_type__a (us_split_fields1 (select o71 i8)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select o71 i8)))) 0)))) (forall ((i8 Int)) (=> (and (<= 1 i8) (<= i8 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select o71 i8))) true) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o71 j3))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select o71 i8))) (rec__tree_model__path_type__a (us_split_fields1 (select o71 j3)))) true)) (= j3 i8))))))))))))))
