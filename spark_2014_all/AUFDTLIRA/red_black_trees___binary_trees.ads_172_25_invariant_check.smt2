...
(declare-const o46 (Array Int us_rep1))
...
(assert (= result6 (ite (= o48 (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)))) true false)))
(assert (= result6 true))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
...
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= o47 (peek (mk___rep2 (us_split_fields__content2 f__split_fields7)) i d)) (and (in_range2 o47) (and (= o47 (ite (= d 0) (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) i)))) (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) i)))))) (and (ite (not (= o47 0)) (and (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) o47) d) (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) o47) i)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j) i) (not (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) j) d)))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j) i) (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) j) d)) (= o47 j)))))))))
(assert (= result8 (ite (= o47 0) true false)))
(assert (= result8 true))
...
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o46 (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) t)) (and (dynamic_invariant3 o46 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o46 t))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select o46 t)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 t)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select o46 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select o46 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select o46 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o46 i1))) true) (not (= i1 t))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select o46 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1)))) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select o46 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select o46 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select o46 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o46 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select o46 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select o46 j)))) true)) (= j i1))))))))))))))
