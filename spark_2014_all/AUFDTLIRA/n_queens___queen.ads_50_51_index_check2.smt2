...
(assert (in_range1 i))
(assert (=> (< 1 i) (and (= o (- i 1)) (in_range1 (- i 1)))))
(assert (=> (< 1 i) (and (= o1 (consistent b o)) (= (= o1 true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 o)) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- i1 1))) (and (and (not (= (to_rep (select b i1)) (to_rep (select b j1)))) (not (= (- i1 j1) (- (to_rep (select b i1)) (to_rep (select b j1)))))) (not (= (- i1 j1) (- (to_rep (select b j1)) (to_rep (select b i1))))))))))))))
(assert (=> (not (< 1 i)) (= o1 (distinct 1 0))))
(assert (<= 1 j))
(assert (<= j (- i 1)))
(assert (not (<= 1 j)))
(check-sat)
