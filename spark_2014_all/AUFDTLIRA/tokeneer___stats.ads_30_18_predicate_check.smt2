...
(define-fun dynamic_invariant1 ((temp___expr_285 Int) (temp___is_init_282 Bool) (temp___skip_constant_283 Bool) (temp___do_toplevel_284 Bool)) Bool (=> (or (= temp___is_init_282 true) (<= 0 2147483647)) (in_range3 temp___expr_285)))
(declare-const x Int)
...
(declare-const temp___304 (Array Int character))
(declare-const temp___3041 t1)
(assert (in_range3 x))
...
(assert (= (elts (to_string (attr__ATTRIBUTE_IMAGE3 x))) temp___304))
(assert (= (mk1 (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 x))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 x)))))) temp___3041))
(assert (not (dynamic_predicate (mk___t1 temp___304 temp___3041))))
(check-sat)
(exit)
