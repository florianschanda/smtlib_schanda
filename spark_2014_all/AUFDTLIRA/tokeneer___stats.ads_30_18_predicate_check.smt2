...
(declare-const temp___344 (Array Int character))
(declare-const temp___3441 t1)
(assert (in_range3 x))
...
(assert (= (elts (to_string (attr__ATTRIBUTE_IMAGE3 x))) temp___344))
(assert (= (mk1 (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 x))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 x)))))) temp___3441))
(assert (not (dynamic_predicate (mk___t1 temp___344 temp___3441))))
(check-sat)
(exit)
