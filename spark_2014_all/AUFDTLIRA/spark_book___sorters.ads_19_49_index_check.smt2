...
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___217)) (= temp___227 values)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___217)) (= temp___225 current1)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___217)) (= temp___221 values)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___217)) (= temp___224 smallest)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___217)) (= temp___223 values_last)))
...
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___217)) (and (and (=> (<= 1 2147483647) (in_range2 smallest3)) (=> (<= (to_rep values__first) (- (to_rep values__last) 1)) (dynamic_property3 (to_rep values__first) (- (to_rep values__last) 1) current2))) (and (<= (to_rep values__first) current2) (<= current2 (- (to_rep values__last) 1))))))
...
(assert (not (<= temp___232 (to_rep values__last))))
(check-sat)
(exit)
