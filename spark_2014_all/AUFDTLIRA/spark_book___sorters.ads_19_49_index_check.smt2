...
(assert (and (= temp___229 (- (to_rep values__last) 1)) (in_range1 (- (to_rep values__last) 1))))
(assert (= (mk_int__ref result) (mk_int__ref current)))
(assert (= current1 (to_rep values__first)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (= temp___226 values)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (= temp___225 values)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (= temp___223 current1)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (= temp___219 values)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (= temp___222 smallest)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (= temp___221 values_last)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (= (slide values (to_rep values__first) (to_rep values__first)) temp___216)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (= (mk1 (to_rep values__first) (to_rep values__last)) temp___2161)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (= (ite (<= (to_rep (first2 temp___2161)) (to_rep (last2 temp___2161))) (+ (- (to_rep (last2 temp___2161)) (to_rep (first2 temp___2161))) 1) 0) (ite (<= (to_rep values_last__first) (to_rep values_last__last)) (+ (- (to_rep values_last__last) (to_rep values_last__first)) 1) 0))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (= (mk___t1 o o1) (mk___t1 temp___216 temp___2161))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (= o2 o)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (= (mk_map__ref result1) values_last10)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (= values_last2 o2)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (=> (<= current1 (to_rep values__last)) (and (and (<= (to_rep values__first) current1) (<= current1 (to_rep values__last))) (and (<= (to_rep values__first) (to_rep values__last)) (<= (to_rep values__last) (to_rep values__last)))))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (= o3 values)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (= o3 temp___218)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (= (mk2 current1 (to_rep values__last)) temp___2181)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (= temp___218 o4)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (= (mk (to_rep (first4 temp___2181)) (to_rep (last4 temp___2181))) o5)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (and (= o6 (index_of_minimum (mk___t o4 o5))) (and (in_range2 o6) (and (and (<= (to_rep (first o5)) o6) (<= o6 (to_rep (last o5)))) (forall ((j1 Int)) (=> (and (<= (to_rep (first o5)) j1) (<= j1 (to_rep (last o5)))) (<= (to_rep (select o4 o6)) (to_rep (select o4 j1))))))))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (= (mk_int__ref result2) smallest10)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (= smallest2 o6)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (=> (not (= smallest2 current1)) (and (= o7 current1) (in_range2 current1)))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (=> (not (= smallest2 current1)) (and (= (perm (mk___t values (mk (to_rep values__first) (to_rep values__last))) (mk___t values2 (mk (to_rep values__first) (to_rep values__last)))) true) (and (= (to_rep (select values2 o7)) (to_rep (select values smallest2))) (and (= (to_rep (select values2 smallest2)) (to_rep (select values o7))) (forall ((j1 Int)) (=> (and (<= (to_rep values__first) j1) (<= j1 (to_rep values__last))) (=> (and (not (= j1 o7)) (not (= j1 smallest2))) (= (to_rep (select values2 j1)) (to_rep (select values j1))))))))))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (=> (not (not (= smallest2 current1))) (= values2 values))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (=> (not (not (= smallest2 current1))) (= values2 values1))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (= (perm_transitive (mk___t temp___219 (mk (to_rep values__first) (to_rep values__last))) (mk___t values_last2 (mk (to_rep values_last__first) (to_rep values_last__last))) (mk___t values2 (mk (to_rep values__first) (to_rep values__last)))) true)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (= (perm (mk___t temp___226 (mk (to_rep values__first) (to_rep values__last))) (mk___t values3 (mk (to_rep values__first) (to_rep values__last)))) true)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (forall ((j1 Int)) (=> (and (<= current2 j1) (<= j1 (to_rep values__last))) (<= (to_rep (select values3 current2)) (to_rep (select values3 j1)))))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (forall ((j1 Int)) (=> (and (<= (to_rep values__first) j1) (<= j1 current2)) (<= (to_rep (select values3 j1)) (to_rep (select values3 (+ j1 1))))))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (and (and (=> (<= 1 2147483647) (in_range2 smallest3)) (=> (<= (to_rep values__first) (- (to_rep values__last) 1)) (dynamic_property3 (to_rep values__first) (- (to_rep values__last) 1) current2))) (and (<= (to_rep values__first) current2) (<= current2 (- (to_rep values__last) 1))))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (= current2 temp___229)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (= current3 (mk_int__ref current2))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (= smallest4 (mk_int__ref smallest3))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (= values_last4 (mk_map__ref values_last3))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (= values4 (mk_map__ref values3))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (= current4 current2)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (= smallest5 smallest3)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (= values_last5 values_last3)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (= values5 values3)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (= current5 current3)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (= smallest6 smallest4)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (= values_last6 values_last4)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (= values6 values4)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (= current6 current4)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (= smallest7 smallest5)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (= values_last7 values_last5)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (= values7 values5)))
(assert (=> (not (and (<= (to_rep values__first) current1) (<= current1 temp___229))) (= current5 (mk_int__ref current1))))
(assert (=> (not (and (<= (to_rep values__first) current1) (<= current1 temp___229))) (= smallest6 smallest10)))
(assert (=> (not (and (<= (to_rep values__first) current1) (<= current1 temp___229))) (= values_last6 values_last10)))
(assert (=> (not (and (<= (to_rep values__first) current1) (<= current1 temp___229))) (= values6 (mk_map__ref values))))
(assert (=> (not (and (<= (to_rep values__first) current1) (<= current1 temp___229))) (= current6 current1)))
(assert (=> (not (and (<= (to_rep values__first) current1) (<= current1 temp___229))) (= smallest7 smallest1)))
(assert (=> (not (and (<= (to_rep values__first) current1) (<= current1 temp___229))) (= values_last7 values_last1)))
(assert (=> (not (and (<= (to_rep values__first) current1) (<= current1 temp___229))) (= values7 values1)))
...
(assert (= result3 true))
(assert (and (= temp___232 (+ j 1)) (in_range1 (+ j 1))))
(assert (not (<= (to_rep values__first) temp___232)))
(check-sat)
(exit)
