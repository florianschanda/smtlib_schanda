...
(assert (forall ((a us_t) (b us_t) (c us_t)) (! (=> (and (and (dynamic_invariant1 a true true true) (dynamic_invariant1 b true true true)) (dynamic_invariant1 c true true true)) (=> (and (and (= (perm_transitive a b c) true) (= (perm a b) true)) (= (perm b c) true)) (= (perm a c) true))) :pattern ((perm_transitive a b c)))))
(declare-fun index_of_minimum (us_t) Int)
(declare-fun index_of_minimum__function_guard (Int us_t) Bool)
(assert (forall ((unsorted us_t)) (! (=> (and (dynamic_invariant1 unsorted true true true) (<= (first1 unsorted) (last1 unsorted))) (let ((result (index_of_minimum unsorted))) (and (and (and (<= (first1 unsorted) result) (<= result (last1 unsorted))) (forall ((j Int)) (=> (and (<= (first1 unsorted) j) (<= j (last1 unsorted))) (<= (to_rep (select (to_array unsorted) result)) (to_rep (select (to_array unsorted) j)))))) (dynamic_invariant result true false true)))) :pattern ((index_of_minimum unsorted)))))
...
(define-fun dynamic_invariant2 ((temp___expr_179 us_t1) (temp___is_init_176 Bool) (temp___skip_constant_177 Bool) (temp___do_toplevel_178 Bool)) Bool (=> (not (= temp___skip_constant_177 true)) (and (dynamic_property2 (to_rep values__first) (to_rep values__last) (first3 temp___expr_179) (last3 temp___expr_179)) (and (= (first3 temp___expr_179) (to_rep values__first)) (= (last3 temp___expr_179) (to_rep values__last))))))
...
(declare-const temp___1892 (Array Int integer))
(declare-const temp___1893 t1)
...
(declare-const temp___1912 (Array Int integer))
(declare-const temp___1913 t2)
...
(assert (and (= temp___202 (- (to_rep values__last) 1)) (in_range1 (- (to_rep values__last) 1))))
(assert (= (mk_int__ref result) (mk_int__ref current)))
(assert (= current1 (to_rep values__first)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= temp___199 values)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= temp___198 values)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= temp___196 current1)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= temp___192 values)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= temp___195 smallest)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= temp___194 values_last)))
(assert true)
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= (slide values (to_rep values__first) (to_rep values__first)) temp___189)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= (mk1 (to_rep values__first) (to_rep values__last)) temp___1891)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= (ite (<= (to_rep (first2 temp___1891)) (to_rep (last2 temp___1891))) (+ (- (to_rep (last2 temp___1891)) (to_rep (first2 temp___1891))) 1) 0) (ite (<= (to_rep values_last__first) (to_rep values_last__last)) (+ (- (to_rep values_last__last) (to_rep values_last__first)) 1) 0))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= (mk___t1 o o1) (mk___t1 temp___189 temp___1891))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= o2 o)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= (mk_map__ref result1) (mk_map__ref values_last))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= values_last2 o2)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (=> (<= current1 (to_rep values__last)) (and (and (<= (to_rep values__first) current1) (<= current1 (to_rep values__last))) (and (<= (to_rep values__first) (to_rep values__last)) (<= (to_rep values__last) (to_rep values__last)))))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= o3 values)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= o3 temp___191)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= (mk2 current1 (to_rep values__last)) temp___1911)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= temp___191 o4)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= (mk (to_rep (first4 temp___1911)) (to_rep (last4 temp___1911))) o5)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (and (= o6 (index_of_minimum (mk___t o4 o5))) (and (in_range2 o6) (and (and (<= (to_rep (first o5)) o6) (<= o6 (to_rep (last o5)))) (forall ((j3 Int)) (=> (and (<= (to_rep (first o5)) j3) (<= j3 (to_rep (last o5)))) (<= (to_rep (select o4 o6)) (to_rep (select o4 j3))))))))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= (mk_int__ref result2) (mk_int__ref smallest))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= smallest2 o6)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (=> (not (= smallest2 current1)) (and (= o7 current1) (in_range2 current1)))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (=> (not (= smallest2 current1)) (and (= (perm (mk___t values (mk (to_rep values__first) (to_rep values__last))) (mk___t values2 (mk (to_rep values__first) (to_rep values__last)))) true) (and (= (to_rep (select values2 o7)) (to_rep (select values smallest2))) (and (= (to_rep (select values2 smallest2)) (to_rep (select values o7))) (forall ((j3 Int)) (=> (and (<= (to_rep values__first) j3) (<= j3 (to_rep values__last))) (=> (and (not (= j3 o7)) (not (= j3 smallest2))) (= (to_rep (select values2 j3)) (to_rep (select values j3))))))))))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (=> (= smallest2 current1) (= values2 values))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (=> (= smallest2 current1) (= values2 values1))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= (perm_transitive (mk___t temp___192 (mk (to_rep values__first) (to_rep values__last))) (mk___t values_last2 (mk (to_rep values_last__first) (to_rep values_last__last))) (mk___t values2 (mk (to_rep values__first) (to_rep values__last)))) true)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= (perm (mk___t temp___199 (mk (to_rep values__first) (to_rep values__last))) (mk___t values3 (mk (to_rep values__first) (to_rep values__last)))) true)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (forall ((j3 Int)) (=> (and (<= current2 j3) (<= j3 (to_rep values__last))) (<= (to_rep (select values3 current2)) (to_rep (select values3 j3)))))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (forall ((j3 Int)) (=> (and (<= (to_rep values__first) j3) (<= j3 current2)) (<= (to_rep (select values3 j3)) (to_rep (select values3 (+ j3 1))))))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (and (and (=> (<= 1 2147483647) (in_range2 smallest3)) (=> (<= (to_rep values__first) (- (to_rep values__last) 1)) (dynamic_property3 (to_rep values__first) (- (to_rep values__last) 1) current2))) (and (<= (to_rep values__first) current2) (<= current2 (- (to_rep values__last) 1))))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= current2 temp___202)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= current4 (mk_int__ref current2))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= smallest5 (mk_int__ref smallest3))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= values_last5 (mk_map__ref values_last3))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= values5 (mk_map__ref values3))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= current5 current2)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= smallest6 smallest3)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= values_last6 values_last3)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= values6 values3)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= current6 current4)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= smallest7 smallest5)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= values_last7 values_last5)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= values7 values5)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= current7 current5)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= smallest8 smallest6)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= values_last8 values_last6)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= values8 values6)))
(assert (=> (not (and (<= (to_rep values__first) current1) (<= current1 temp___202))) (= current6 (mk_int__ref current1))))
(assert (=> (not (and (<= (to_rep values__first) current1) (<= current1 temp___202))) (= smallest7 (mk_int__ref smallest))))
(assert (=> (not (and (<= (to_rep values__first) current1) (<= current1 temp___202))) (= values_last7 (mk_map__ref values_last))))
(assert (=> (not (and (<= (to_rep values__first) current1) (<= current1 temp___202))) (= values7 (mk_map__ref values))))
(assert (=> (not (and (<= (to_rep values__first) current1) (<= current1 temp___202))) (= current7 current1)))
(assert (=> (not (and (<= (to_rep values__first) current1) (<= current1 temp___202))) (= smallest8 smallest1)))
(assert (=> (not (and (<= (to_rep values__first) current1) (<= current1 temp___202))) (= values_last8 values_last1)))
(assert (=> (not (and (<= (to_rep values__first) current1) (<= current1 temp___202))) (= values8 values1)))
...
(assert (= values_last10 values_last8))
(assert (= values10 values8))
(assert (and (= o22 (- (to_rep values__last) 1)) (in_range1 (- (to_rep values__last) 1))))
(assert (= o23 (ite (<= j2 o22) true false)))
(assert (= result6 (ite (<= (to_rep values__first) j2) o23 false)))
(assert (= result6 true))
(assert (and (= temp___205 (+ j2 1)) (in_range1 (+ j2 1))))
(assert (not (<= (to_rep values__first) temp___205)))
(check-sat)
(exit)
