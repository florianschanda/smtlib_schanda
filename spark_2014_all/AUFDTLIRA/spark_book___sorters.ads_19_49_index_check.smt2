...
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= (mk_map__ref result1) values_last10)))
...
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (and (= o6 (index_of_minimum (mk___t o4 o5))) (and (in_range2 o6) (and (and (<= (to_rep (first o5)) o6) (<= o6 (to_rep (last o5)))) (forall ((j1 Int)) (=> (and (<= (to_rep (first o5)) j1) (<= j1 (to_rep (last o5)))) (<= (to_rep (select o4 o6)) (to_rep (select o4 j1))))))))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= (mk_int__ref result2) smallest10)))
...
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (=> (not (= smallest2 current1)) (and (= (perm (mk___t values (mk (to_rep values__first) (to_rep values__last))) (mk___t values2 (mk (to_rep values__first) (to_rep values__last)))) true) (and (= (to_rep (select values2 o7)) (to_rep (select values smallest2))) (and (= (to_rep (select values2 smallest2)) (to_rep (select values o7))) (forall ((j1 Int)) (=> (and (<= (to_rep values__first) j1) (<= j1 (to_rep values__last))) (=> (and (not (= j1 o7)) (not (= j1 smallest2))) (= (to_rep (select values2 j1)) (to_rep (select values j1))))))))))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (=> (not (not (= smallest2 current1))) (= values2 values))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (=> (not (not (= smallest2 current1))) (= values2 values1))))
...
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (forall ((j1 Int)) (=> (and (<= current2 j1) (<= j1 (to_rep values__last))) (<= (to_rep (select values3 current2)) (to_rep (select values3 j1)))))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (forall ((j1 Int)) (=> (and (<= (to_rep values__first) j1) (<= j1 current2)) (<= (to_rep (select values3 j1)) (to_rep (select values3 (+ j1 1))))))))
...
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= current3 (mk_int__ref current2))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= smallest4 (mk_int__ref smallest3))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= values_last4 (mk_map__ref values_last3))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= values4 (mk_map__ref values3))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= current4 current2)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= smallest5 smallest3)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= values_last5 values_last3)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= values5 values3)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= current5 current3)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= smallest6 smallest4)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= values_last6 values_last4)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= values6 values4)))
...
(assert (=> (not (and (<= (to_rep values__first) current1) (<= current1 temp___202))) (= current5 (mk_int__ref current1))))
(assert (=> (not (and (<= (to_rep values__first) current1) (<= current1 temp___202))) (= smallest6 smallest10)))
(assert (=> (not (and (<= (to_rep values__first) current1) (<= current1 temp___202))) (= values_last6 values_last10)))
(assert (=> (not (and (<= (to_rep values__first) current1) (<= current1 temp___202))) (= values6 (mk_map__ref values))))
(assert (=> (not (and (<= (to_rep values__first) current1) (<= current1 temp___202))) (= current6 current1)))
(assert (=> (not (and (<= (to_rep values__first) current1) (<= current1 temp___202))) (= smallest7 smallest1)))
(assert (=> (not (and (<= (to_rep values__first) current1) (<= current1 temp___202))) (= values_last7 values_last1)))
(assert (=> (not (and (<= (to_rep values__first) current1) (<= current1 temp___202))) (= values7 values1)))
...
(assert (= result3 (ite (<= (to_rep values__first) j) o9 false)))
(assert (= result3 true))
(assert (and (= temp___205 (+ j 1)) (in_range1 (+ j 1))))
