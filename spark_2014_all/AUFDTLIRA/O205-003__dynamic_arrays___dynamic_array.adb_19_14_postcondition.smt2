...
(assert (=> (= c 0) (= usq_2 o7)))
(assert (=> (= c 0) (= false o8)))
(assert (=> (= c 0) (= o9 (temp___238 (mk___rep (mk___split_discrs o5) (mk___split_fields o6 o7) o8)))))
(assert (=> (= c 0) (= o9 o10)))
...
(assert (=> (= c 0) (= dynamic_array__new_holder__result3 (mk___rep1 (mk___split_discrs1 o14) (mk___split_fields1 (mk___t o15 o16))))))
...
(assert (=> (not (= c 0)) (= usq_4 (mk___rep (mk___split_discrs (of_int 1)) o20 true))))
(assert (=> (not (= c 0)) (= o21 (mk___rep (us_split_discrs1 usq_4) (us_split_fields1 usq_4) false))))
...
(assert (=> (not (= c 0)) (= (ite (<= (to_rep1 (first4 (rt2 temp___237))) (to_rep1 (last5 (rt2 temp___237)))) (+ (- (to_rep1 (last5 (rt2 temp___237))) (to_rep1 (first4 (rt2 temp___237)))) 1) 0) (ite (<= 1 d) (+ (- d 1) 1) 0))))
(assert (=> (not (= c 0)) (= o22 (mk___t1 (elts2 temp___237) (mk1 (to_rep1 (first4 (rt2 temp___237))) (to_rep1 (last5 (rt2 temp___237))))))))
