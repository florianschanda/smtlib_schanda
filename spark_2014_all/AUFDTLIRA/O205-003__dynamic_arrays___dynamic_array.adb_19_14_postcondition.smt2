...
(assert (=> (= c 0) (= usq_2 o7)))
(assert (=> (= c 0) (= false o8)))
(assert (=> (= c 0) (= o9 (temp___265 (mk___rep (mk___split_discrs o5) (mk___split_fields o6 o7) o8)))))
(assert (=> (= c 0) (= o9 o10)))
...
(assert (=> (not (= c 0)) (= usq_4 (mk___rep (mk___split_discrs (distinct 1 0)) o20 true))))
(assert (=> (not (= c 0)) (= o21 (mk___rep (us_split_discrs1 usq_4) (us_split_fields1 usq_4) false))))
(assert (=> (not (= c 0)) (= temp___263 (temp___257 o21 1 d))))
...
(assert (=> (not (= c 0)) (= o22 (mk___t1 (elts2 temp___264) (mk1 (to_rep1 (first4 (rt2 temp___264))) (to_rep1 (last5 (rt2 temp___264))))))))
