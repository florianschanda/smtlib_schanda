...
(assert (in_range1 c))
(assert (in_range1 d))
(assert (and (and (= dynamic_array__new_holder__result7 dynamic_array__new_holder__result5) (= dynamic_array__new_holder__result8 dynamic_array__new_holder__result6)) (ite (= c 0) (and (and (= dynamic_array__new_holder__result5 (mk_holder__ref dynamic_array__new_holder__result3)) (= dynamic_array__new_holder__result6 dynamic_array__new_holder__result3)) (and (and (and (and (and (and (and (and (and (and (and (= us c) (dynamic_property 0 last c)) (= o1 c)) (= o2 (of_rep1 o1))) (and (= o2 o3) (= dummy3 o4))) (and (= (of_int 1) usq_) (and (and (= usq_1 o3) (= usq_2 o4)) (= true usq_3)))) (and (= usq_ o5) (and (and (= usq_1 o6) (= usq_2 o7)) (= false o8)))) (= o9 (temp___238 (mk___rep (mk___split_discrs o5) (mk___split_fields o6 o7) o8)))) (= o9 o10)) (and (and (= (to_rep o) 0) (= o o11)) (and (= o12 o11) (= o13 o10)))) (and (= o12 o14) (and (= o13 o15) (= (mk 1 0) o16)))) (and (= result (mk_holder__ref (mk___rep1 (mk___split_discrs1 dynamic_array__new_holder__result) (mk___split_fields1 (mk___t dynamic_array__new_holder__result1 dynamic_array__new_holder__result2))))) (= dynamic_array__new_holder__result3 (mk___rep1 (mk___split_discrs1 o14) (mk___split_fields1 (mk___t o15 o16))))))) (and (and (= dynamic_array__new_holder__result5 (mk_holder__ref dynamic_array__new_holder__result4)) (= dynamic_array__new_holder__result6 dynamic_array__new_holder__result4)) (and (and (and (and (and (and (and (and (and (and (and (and (and (= us1 c) (dynamic_property 0 last c)) (= o18 c)) (= o19 (of_rep1 o18))) (= o20 (mk___split_fields o19 dummy3))) (= usq_4 (mk___rep (mk___split_discrs (of_int 1)) o20 true))) (= o21 (mk___rep (us_split_discrs1 usq_4) (us_split_fields1 usq_4) false))) (= temp___236 (temp___230 o21 1 d))) (and (= (to_rep1 (first4 (rt2 temp___236))) 1) (and (= (to_rep1 (last5 (rt2 temp___236))) d) (= temp___237 temp___236)))) (and (= (ite (<= (to_rep1 (first4 (rt2 temp___237))) (to_rep1 (last5 (rt2 temp___237)))) (+ (- (to_rep1 (last5 (rt2 temp___237))) (to_rep1 (first4 (rt2 temp___237)))) 1) 0) (ite (<= 1 d) (+ (- d 1) 1) 0)) (= o22 (mk___t1 (elts2 temp___237) (mk1 (to_rep1 (first4 (rt2 temp___237))) (to_rep1 (last5 (rt2 temp___237)))))))) (= o23 (mk___split_fields3 o22))) (and (and (= (to_rep o17) d) (= o24 (mk___split_discrs1 o17))) (= o25 (mk___rep3 o24 o23)))) (= o26 (to_base1 o25))) (and (= result1 (mk_holder__ref (mk___rep1 (mk___split_discrs1 dynamic_array__new_holder__result) (mk___split_fields1 (mk___t dynamic_array__new_holder__result1 dynamic_array__new_holder__result2))))) (= dynamic_array__new_holder__result4 o26)))))))
