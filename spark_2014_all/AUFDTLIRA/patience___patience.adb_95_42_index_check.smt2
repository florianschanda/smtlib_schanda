...
(assert (= o125 (ite (<= o124 (- (to_rep1 (rec__patience__state__numstacks (us_split_fields__content s__split_fields20))) 1)) true false)))
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o119 i1))
(assert (= o120 (select (rec__patience__state__posstack (us_split_fields__content s__split_fields20)) o119)))
(assert (= o121 (to_rep1 o120)))
(assert (= o126 (ite (<= 0 o121) true false)))
(assert (= result23 (ite (= o126 true) o125 false)))
(assert (=> (= result23 true) (and (<= 0 i1) (<= i1 99))))
(assert (=> (= result23 true) (= o110 i1)))
(assert (=> (= result23 true) (= o111 (select (rec__patience__state__posstack (us_split_fields__content s__split_fields20)) o110))))
(assert (=> (= result23 true) (= temp___651 (to_rep1 o111))))
(assert (=> (= result23 true) (and (<= 0 temp___651) (<= temp___651 99))))
(assert (=> (= result23 true) (= o112 temp___651)))
(assert (=> (= result23 true) (= o113 (select (rec__patience__state__stacksizes (us_split_fields__content s__split_fields20)) o112))))
(assert (=> (= result23 true) (= o114 (to_rep1 o113))))
(assert (=> (= result23 true) (= o115 (- o114 1))))
(assert (=> (= result23 true) (and (<= 0 i1) (<= i1 99))))
...
(assert (=> (= result23 true) (= o116 (to_rep1 o109))))
(assert (=> (= result23 true) (= o117 (ite (<= o116 o115) true false))))
(assert (=> (= result23 true) (and (<= 0 i1) (<= i1 99))))
(assert (=> (= result23 true) (= o105 i1)))
(assert (=> (= result23 true) (= o106 (select (rec__patience__state__posheight (us_split_fields__content s__split_fields20)) o105))))
(assert (=> (= result23 true) (= o107 (to_rep1 o106))))
(assert (=> (= result23 true) (= o118 (ite (<= 0 o107) true false))))
(assert (=> (= result23 true) (= result22 (ite (= o118 true) o117 false))))
