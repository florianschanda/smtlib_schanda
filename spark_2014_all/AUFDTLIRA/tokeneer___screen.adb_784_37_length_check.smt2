...
(assert (and (= temp___1833 (- (to_rep1 data__last) 1)) (in_range (- (to_rep1 data__last) 1))))
(assert (=> (<= 1 temp___1833) (and (and (<= 1 1) (<= 1 10)) (and (<= 1 temp___1833) (<= temp___1833 10)))))
(assert (= o1 result__1))
(assert (= o1 temp___1834))
(assert (= (mk3 1 temp___1833) temp___18341))
(assert (not (= (ite (<= (to_rep1 (first6 temp___18311)) (to_rep1 (last6 temp___18311))) (+ (- (to_rep1 (last6 temp___18311)) (to_rep1 (first6 temp___18311))) 1) 0) (ite (<= (to_rep1 (first6 temp___18341)) (to_rep1 (last6 temp___18341))) (+ (- (to_rep1 (last6 temp___18341)) (to_rep1 (first6 temp___18341))) 1) 0))))
(check-sat)
(exit)
