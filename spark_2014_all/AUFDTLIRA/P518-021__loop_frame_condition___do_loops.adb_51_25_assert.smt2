...
(assert (=> (and (<= 1 i3) (<= i3 100)) (= d__split_fields4 (us_split_fields3 temp___234))))
(assert (=> (and (<= 1 i3) (<= i3 100)) (= (to_rep (rec__do_loops__r__f2 (us_split_fields1 (select (rec__do_loops__r_array_record__f3 d__split_fields4) i4)))) (to_rep (rec__do_loops__r__f2 (us_split_fields1 (select temp___236 i4)))))))
(assert (=> (and (<= 1 i3) (<= i3 100)) (= (bool_eq1 (rec__do_loops__r_array_record__f4 d__split_fields4) 1 100 temp___238 1 100) true)))
...
(assert (= i9 1))
(assert (=> (and (<= 1 i9) (<= i9 100)) (= temp___261 (mk___rep1 (us_split_fields__content1 d__split_fields7)))))
(assert (=> (and (<= 1 i9) (<= i9 100)) (= temp___258 (rec__do_loops__r_array_record__f4 (us_split_fields__content1 d__split_fields7)))))
(assert (=> (and (<= 1 i9) (<= i9 100)) (= temp___256 (rec__do_loops__r_array_record__f3 (us_split_fields__content1 d__split_fields7)))))
(assert (=> (and (<= 1 i9) (<= i9 100)) (and (and (forall ((temp___262 Int)) (=> (and (<= 1 temp___262) (<= temp___262 100)) (ite (<= i10 temp___262) (= (select (rec__do_loops__r_array_record__f3 d__split_fields9) temp___262) (select (rec__do_loops__r_array_record__f3 (us_split_fields3 temp___261)) temp___262)) (= (rec__do_loops__r__f2 (us_split_fields1 (select (rec__do_loops__r_array_record__f3 d__split_fields9) temp___262))) (rec__do_loops__r__f2 (us_split_fields1 (select (rec__do_loops__r_array_record__f3 (us_split_fields3 temp___261)) temp___262))))))) (forall ((temp___263 Int)) (=> (and (<= 1 temp___263) (<= temp___263 100)) (ite (<= i10 temp___263) (= (select (rec__do_loops__r_array_record__f4 d__split_fields9) temp___263) (select (rec__do_loops__r_array_record__f4 (us_split_fields3 temp___261)) temp___263)) (= (rec__do_loops__r__f2 (us_split_fields1 (select (rec__do_loops__r_array_record__f4 d__split_fields9) temp___263))) (rec__do_loops__r__f2 (us_split_fields1 (select (rec__do_loops__r_array_record__f4 (us_split_fields3 temp___261)) temp___263)))))))) (and (<= 1 i10) (<= i10 100)))))
...
(assert (=> (and (<= 1 i9) (<= i9 100)) (= d__split_fields10 (us_split_fields3 temp___249))))
...
(assert (=> (and (<= 1 i9) (<= i9 100)) (= d__split_fields11 (us_split_fields3 temp___254))))
(assert (=> (and (<= 1 i9) (<= i9 100)) (= (to_rep (rec__do_loops__r__f2 (us_split_fields1 (select (rec__do_loops__r_array_record__f3 d__split_fields11) i10)))) (to_rep (rec__do_loops__r__f2 (us_split_fields1 (select temp___256 i10)))))))
(assert (=> (and (<= 1 i9) (<= i9 100)) (= (bool_eq1 (rec__do_loops__r_array_record__f4 d__split_fields11) 1 100 temp___258 1 100) true)))
