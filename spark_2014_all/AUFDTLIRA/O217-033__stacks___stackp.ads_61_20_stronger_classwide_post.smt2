...
(define-fun dynamic_property ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range2 low) (and (in_range2 high) (=> (<= low high) (and (in_range low) (in_range high))))))
...
(declare-fun to_rep2 (less_than_max) Int)
...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (= (bool_eq (rec__stackp__stack_root__content (us_split_fields1 a)) 1 100 (rec__stackp__stack_root__content (us_split_fields1 b)) 1 100) true) (= (to_rep2 (rec__stackp__stack_root__length (us_split_fields1 a))) (to_rep2 (rec__stackp__stack_root__length (us_split_fields1 b))))) true false))
...
(define-fun default_initial_assumption ((temp___expr_361 us_rep1) (temp___skip_top_level_362 Bool)) Bool (and (and (= (attr__tag1 temp___expr_361) us_tag1) (and (= (to_rep3 (rec__stackp__buffer__first (us_split_fields3 temp___expr_361))) 1) (= (to_rep2 (rec__stackp__stack_root__length1 (us_split_fields3 temp___expr_361))) 0))) (=> (not (= temp___skip_top_level_362 true)) (= (size (to_base temp___expr_361)) 0))))
...
(define-fun dynamic_property1 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range2 low) (and (in_range2 high) (=> (<= low high) (and (in_range5 low) (in_range5 high))))))
...
(define-fun dynamic_invariant1 ((temp___expr_168 us_t) (temp___is_init_165 Bool) (temp___skip_constant_166 Bool) (temp___do_toplevel_167 Bool)) Bool (=> (not (= temp___skip_constant_166 true)) (dynamic_property 1 2147483647 (first1 temp___expr_168) (last1 temp___expr_168))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range2 f) (=> (in_range2 l) (and (= (to_rep1 (first4 (mk2 f l))) f) (= (to_rep1 (last6 (mk2 f l))) l)))) :pattern ((mk2 f l)))))
...
(define-fun bool_eq5 ((x us_t2) (y us_t2)) Bool (bool_eq (elts2 x) (to_rep1 (first4 (rt2 x))) (to_rep1 (last6 (rt2 x))) (elts2 y) (to_rep1 (first4 (rt2 y))) (to_rep1 (last6 (rt2 y)))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range2 f) (=> (in_range2 l) (and (= (to_rep1 (first6 (mk3 f l))) f) (= (to_rep1 (last8 (mk3 f l))) l)))) :pattern ((mk3 f l)))))
...
(define-fun bool_eq6 ((x us_t3) (y us_t3)) Bool (bool_eq (elts3 x) (to_rep1 (first6 (rt3 x))) (to_rep1 (last8 (rt3 x))) (elts3 y) (to_rep1 (first6 (rt3 y))) (to_rep1 (last8 (rt3 y)))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range2 f) (=> (in_range2 l) (and (= (to_rep1 (first8 (mk4 f l))) f) (= (to_rep1 (last10 (mk4 f l))) l)))) :pattern ((mk4 f l)))))
...
(define-fun bool_eq7 ((x us_t4) (y us_t4)) Bool (bool_eq (elts4 x) (to_rep1 (first8 (rt4 x))) (to_rep1 (last10 (rt4 x))) (elts4 y) (to_rep1 (first8 (rt4 y))) (to_rep1 (last10 (rt4 y)))))
...
(assert (forall ((s us_rep1)) (! (let ((result (get_model__3 s))) (and (= (length result) (size (to_base s))) (dynamic_invariant1 result true false true))) :pattern ((get_model__3 s)))))
(assert (forall ((attr__tag2 Int)) (forall ((s us_rep1)) (! (let ((result (get_model__31 attr__tag2 s))) (and (= (length result) (size (to_base s))) (dynamic_invariant1 result true false true))) :pattern ((get_model__31 attr__tag2 s))))))
(assert (forall ((s us_rep1)) (! (= (get_model__3 s) (get_model__31 us_tag1 s)) :pattern ((get_model__31 us_tag1 s)))))
(assert (forall ((s us_rep1)) (! (= (get_model__3 s) (ite (= (wraps_around s) true) (let ((stackp__get_model__3__R84s (last4 s))) (let ((temp___394 (let ((temp___393 (let ((temp___390 1)) (let ((temp___391 (rec__stackp__stack_root__content1 (us_split_fields3 s)))) (of_array3 temp___391 temp___390 stackp__get_model__3__R84s))))) (let ((temp___392 (let ((temp___388 100)) (let ((temp___387 (to_rep3 (rec__stackp__buffer__first (us_split_fields3 s))))) (let ((temp___389 (rec__stackp__stack_root__content1 (us_split_fields3 s)))) (of_array2 temp___389 temp___387 temp___388)))))) (ite (= (length2 temp___392) 0) (of_array1 (to_array3 temp___393) (first7 temp___393) (last9 temp___393)) (of_array1 (slide (concat1 (to_array2 temp___392) (first5 temp___392) (last7 temp___392) (to_array3 temp___393) (first7 temp___393) (last9 temp___393)) (first5 temp___392) 1) 1 (- (+ 1 (+ (ite (<= (first5 temp___392) (last7 temp___392)) (+ (- (last7 temp___392) (first5 temp___392)) 1) 0) (ite (<= (first7 temp___393) (last9 temp___393)) (+ (- (last9 temp___393) (first7 temp___393)) 1) 0))) 1))))))) (of_array (to_array1 temp___394) (first3 temp___394) (last3 temp___394)))) (let ((stackp__get_model__3__R87s (last4 s))) (let ((temp___397 (let ((temp___395 (to_rep3 (rec__stackp__buffer__first (us_split_fields3 s))))) (let ((temp___396 (rec__stackp__stack_root__content1 (us_split_fields3 s)))) (of_array4 temp___396 temp___395 stackp__get_model__3__R87s))))) (of_array (to_array4 temp___397) (first9 temp___397) (last11 temp___397)))))) :pattern ((get_model__3 s)))))
...
(declare-fun user_eq17 (t77s t77s) Bool)
(declare-const dummy17 t77s)
...
(declare-fun user_eq18 (t25s t25s) Bool)
(declare-const dummy18 t25s)
...
(assert (forall ((temp___266 Int)) (= (select (temp___264 temp___266) 1) (of_rep temp___266))))
(declare-fun temp___612 (Int) (Array Int element))
(assert (forall ((temp___614 Int)) (= (select (temp___612 temp___614) 1) (of_rep temp___614))))
(define-fun dynamic_invariant2 ((temp___expr_39 Int) (temp___is_init_36 Bool) (temp___skip_constant_37 Bool) (temp___do_toplevel_38 Bool)) Bool (=> (or (= temp___is_init_36 true) (<= 1 2147483647)) (in_range temp___expr_39)))
...
(define-fun dynamic_invariant4 ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= 0 100)) (in_range3 temp___expr_136)))
(define-fun default_initial_assumption1 ((temp___expr_159 us_rep) (temp___skip_top_level_160 Bool)) Bool (and (and (= (attr__tag temp___expr_159) us_tag) (= (to_rep2 (rec__stackp__stack_root__length (us_split_fields1 temp___expr_159))) 0)) (=> (not (= temp___skip_top_level_160 true)) (= (size temp___expr_159) 0))))
(assert (forall ((s us_rep)) (! (dynamic_invariant4 (size s) true false true) :pattern ((size s)))))
(assert (forall ((s us_rep)) (! (= (size s) (to_rep2 (rec__stackp__stack_root__length (us_split_fields1 s)))) :pattern ((size s)))))
(define-fun dynamic_invariant5 ((temp___expr_353 Int) (temp___is_init_350 Bool) (temp___skip_constant_351 Bool) (temp___do_toplevel_352 Bool)) Bool (=> (or (= temp___is_init_350 true) (<= 1 100)) (in_range4 temp___expr_353)))
(define-fun to_int1 ((b Bool)) Int (ite (= b true) 1 0))
(define-fun of_int ((i Int)) Bool (ite (= i 0) false true))
(define-fun in_range8 ((x Int)) Bool (or (= x 0) (= x 1)))
(declare-fun attr__ATTRIBUTE_IMAGE11 (Bool) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check11 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE11 (us_image) Bool)
(assert true)
(assert true)
(assert (forall ((s us_rep1)) (! (= (to_int1 (wraps_around s)) (to_int1 (wraps_around1 us_tag1 s))) :pattern ((wraps_around1 us_tag1 s)))))
(assert (forall ((s us_rep1)) (! (= (= (wraps_around s) true) (< 100 (- (+ (to_rep3 (rec__stackp__buffer__first (us_split_fields3 s))) (to_rep2 (rec__stackp__stack_root__length1 (us_split_fields3 s)))) 1))) :pattern ((wraps_around s)))))
(assert (forall ((s us_rep1)) (! (dynamic_invariant4 (last4 s) true false true) :pattern ((last4 s)))))
(assert (forall ((attr__tag2 Int)) (forall ((s us_rep1)) (! (dynamic_invariant4 (last5 attr__tag2 s) true false true) :pattern ((last5 attr__tag2 s))))))
(assert (forall ((s us_rep1)) (! (= (last4 s) (last5 us_tag1 s)) :pattern ((last5 us_tag1 s)))))
(assert (forall ((s us_rep1)) (! (= (last4 s) (ite (not (= (wraps_around s) true)) (- (+ (to_rep3 (rec__stackp__buffer__first (us_split_fields3 s))) (to_rep2 (rec__stackp__stack_root__length1 (us_split_fields3 s)))) 1) (- (- (+ (to_rep3 (rec__stackp__buffer__first (us_split_fields3 s))) (to_rep2 (rec__stackp__stack_root__length1 (us_split_fields3 s)))) 1) 100))) :pattern ((last4 s)))))
...
(assert (in_range1 e))
(assert (= (let ((temp___621 (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields4 s__split_fields5 s__split_fields6 s__split_fields7) s__attr__tag)))) (bool_eq (elts temp___621) (to_rep1 (first (rt temp___621))) (to_rep1 (last (rt temp___621))) (let ((temp___620 (temp___264 e))) (ite (= (length (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag))) 0) temp___620 (concat1 (elts (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag))) (to_rep1 (first (rt (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag))))) (to_rep1 (last (rt (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag))))) temp___620 1 1))) (to_rep1 (first (ite (= (length (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag))) 0) (mk 1 1) (mk (to_rep1 (first (rt (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag))))) (- (+ (to_rep1 (first (rt (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag))))) (+ (ite (<= (to_rep1 (first (rt (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag))))) (to_rep1 (last (rt (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag)))))) (+ (- (to_rep1 (last (rt (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag))))) (to_rep1 (first (rt (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag)))))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0))) 1))))) (to_rep1 (last (ite (= (length (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag))) 0) (mk 1 1) (mk (to_rep1 (first (rt (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag))))) (- (+ (to_rep1 (first (rt (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag))))) (+ (ite (<= (to_rep1 (first (rt (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag))))) (to_rep1 (last (rt (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag)))))) (+ (- (to_rep1 (last (rt (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag))))) (to_rep1 (first (rt (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag)))))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0))) 1))))))) true))
(assert (not (= (let ((temp___617 (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields4 s__split_fields5 s__split_fields6 s__split_fields7) s__attr__tag)))) (bool_eq (elts temp___617) (to_rep1 (first (rt temp___617))) (to_rep1 (last (rt temp___617))) (let ((temp___616 (temp___612 e))) (ite (= (length (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag))) 0) temp___616 (concat1 (elts (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag))) (to_rep1 (first (rt (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag))))) (to_rep1 (last (rt (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag))))) temp___616 1 1))) (to_rep1 (first (ite (= (length (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag))) 0) (mk 1 1) (mk (to_rep1 (first (rt (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag))))) (- (+ (to_rep1 (first (rt (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag))))) (+ (ite (<= (to_rep1 (first (rt (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag))))) (to_rep1 (last (rt (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag)))))) (+ (- (to_rep1 (last (rt (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag))))) (to_rep1 (first (rt (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag)))))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0))) 1))))) (to_rep1 (last (ite (= (length (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag))) 0) (mk 1 1) (mk (to_rep1 (first (rt (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag))))) (- (+ (to_rep1 (first (rt (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag))))) (+ (ite (<= (to_rep1 (first (rt (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag))))) (to_rep1 (last (rt (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag)))))) (+ (- (to_rep1 (last (rt (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag))))) (to_rep1 (first (rt (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag)))))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0))) 1))))))) true)))
(check-sat)
(exit)
