...
(assert (and (and (=> (<= 1 100) (in_range3 i2)) (forall ((temp___176 Int)) (=> (and (<= 1 temp___176) (<= temp___176 100)) (=> (< i2 temp___176) (= (select c3 temp___176) (select c temp___176)))))) (and (<= 1 i2) (<= i2 100))))
(assert (<= 1 j))
(assert (<= j i2))
(assert (not (<= 1 j)))
(check-sat)
