...
(assert (= o8 min3))
(assert (= o9 (select (elts values) o8)))
(assert (= o10 (to_rep o9)))
(assert (= result5 (ite (< (to_rep (select (elts values) index4)) o10) true false)))
(assert (=> (= result5 true) (and (= o11 index4) (in_range2 index4))))
(assert (=> (= result5 true) (= result6 min3)))
(assert (=> (= result5 true) (= min4 o11)))
(assert (=> (not (= result5 true)) (= min4 min3)))
(assert (not (<= (to_rep1 (first (rt values))) min4)))
(check-sat)
(exit)
