...
(declare-const o127 cardindex)
(declare-const o128 Int)
(declare-const o129 Int)
(declare-const o130 cardindex)
...
(assert (= o129 i1))
(assert (= o130 (select (rec__patience__state__preds (us_split_fields__content s__split_fields20)) o129)))
(assert (= o131 (to_rep o130)))
(assert (= o132 (ite (<= o131 (- (to_rep (rec__patience__state__numelts (us_split_fields__content s__split_fields20))) 1)) true false)))
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o126 i1))
(assert (= o127 (select (rec__patience__state__preds (us_split_fields__content s__split_fields20)) o126)))
(assert (= o128 (to_rep o127)))
(assert (= o133 (ite (<= (- 1) o128) true false)))
(assert (= result27 (ite (= o133 true) o132 false)))
(assert (=> (= result27 true) (and (<= 0 i1) (<= i1 99))))
(assert (=> (= result27 true) (= o123 i1)))
(assert (=> (= result27 true) (= o124 (select (rec__patience__state__preds (us_split_fields__content s__split_fields20)) o123))))
(assert (=> (= result27 true) (= o125 (to_rep o124))))
(assert (=> (= result27 true) (= result26 (ite (< o125 i1) true false))))
...
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o115 i1))
(assert (= o116 (select (rec__patience__state__preds (us_split_fields__content s__split_fields20)) o115)))
(assert (= temp___780 (to_rep o116)))
(assert (and (<= 0 temp___780) (<= temp___780 99)))
(assert (= o117 temp___780))
(assert (= o118 (select (rec__patience__state__values (us_split_fields__content s__split_fields20)) o117)))
(assert (= o122 (to_rep1 o118)))
(assert (= result30 (ite (< o122 o121) true false)))
(assert (=> (= result30 true) (and (<= 0 i1) (<= i1 99))))
(assert (=> (= result30 true) (= o112 i1)))
(assert (=> (= result30 true) (= o113 (select (rec__patience__state__posstack (us_split_fields__content s__split_fields20)) o112))))
(assert (=> (= result30 true) (= o114 (to_rep o113))))
(assert (=> (= result30 true) (= result29 (ite (< 0 o114) true false))))
...
(assert (= temp___785 (to_rep o107)))
(assert (not (<= temp___785 99)))
(check-sat)
(exit)
