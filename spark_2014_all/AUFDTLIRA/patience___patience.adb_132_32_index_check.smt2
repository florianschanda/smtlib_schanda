...
(assert (and (<= 0 i3) (<= i3 99)))
(assert (= o172 i3))
(assert (= o173 (select (rec__patience__state__values (us_split_fields__content s__split_fields20)) o172)))
(assert (= o174 (to_rep o173)))
(assert (and (<= 0 i3) (<= i3 99)))
(assert (= o168 i3))
(assert (= o169 (select (rec__patience__state__preds (us_split_fields__content s__split_fields20)) o168)))
(assert (= temp___750 (to_rep1 o169)))
(assert (and (<= 0 temp___750) (<= temp___750 99)))
(assert (= o170 temp___750))
(assert (= o171 (select (rec__patience__state__values (us_split_fields__content s__split_fields20)) o170)))
(assert (= o175 (to_rep o171)))
(assert (= result46 (ite (< o175 o174) true false)))
(assert (=> (= result46 true) (and (<= 0 i3) (<= i3 99))))
(assert (=> (= result46 true) (= o165 i3)))
(assert (=> (= result46 true) (= o166 (select (rec__patience__state__posstack (us_split_fields__content s__split_fields20)) o165))))
(assert (=> (= result46 true) (= o167 (to_rep1 o166))))
(assert (=> (= result46 true) (= result45 (ite (< 0 o167) true false))))
(assert (=> (not (= result46 true)) (= result45 false)))
(assert (= result45 true))
(assert (and (<= 0 i3) (<= i3 99)))
(assert (= o161 i3))
(assert (= o162 (select (rec__patience__state__posstack (us_split_fields__content s__split_fields20)) o161)))
(assert (= o163 (to_rep1 o162)))
(assert (= o164 (- o163 1)))
(assert (and (<= 0 i3) (<= i3 99)))
(assert (= o159 i3))
(assert (= o160 (select (rec__patience__state__preds (us_split_fields__content s__split_fields20)) o159)))
(assert (= temp___755 (to_rep1 o160)))
