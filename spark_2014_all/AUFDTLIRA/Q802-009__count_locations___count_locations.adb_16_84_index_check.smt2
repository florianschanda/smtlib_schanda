...
(declare-const count_locations__check_selected_locations__result Bool)
...
(declare-const st_count3 Int)
(declare-const result6 Int)
(declare-const lowest_max3 Int)
(declare-const result7 Int)
(declare-const st3 Int)
(declare-const st_count4 Int)
(declare-const lowest_max4 Int)
(declare-const st4 Int)
(declare-const st_count5 Int)
(declare-const lowest_max5 Int)
(declare-const st5 Int)
(declare-const st_count6 Int)
(declare-const lowest_max6 Int)
(declare-const st6 Int)
(declare-const st_count7 Int)
(declare-const lowest_max7 Int)
(declare-const st7 Int)
(declare-const result8 Bool)
(declare-const count_locations__check_selected_locations__result1 Bool)
(declare-const count_locations__check_selected_locations__result2 Bool)
(declare-const count_locations__check_selected_locations__result3 Bool)
(declare-const st_count8 int__ref)
(declare-const lowest_max8 int__ref)
(declare-const st8 int__ref)
(declare-const count_locations__check_selected_locations__result4 bool__ref)
(declare-const st_count9 Int)
(declare-const lowest_max9 Int)
(declare-const st9 Int)
(declare-const count_locations__check_selected_locations__result5 Bool)
...
(assert (forall ((s3 Int)) (=> (and (<= 1 s3) (<= s3 (- st2 1))) (=> (= (select sel s3) true) (<= lowest_max2 (to_rep (select max s3)))))))
(assert (or (and (forall ((s3 Int)) (=> (and (<= 1 s3) (<= s3 (- st2 1))) (not (= (select sel s3) true)))) (= lowest_max2 2147483647)) (exists ((s3 Int)) (and (and (<= 1 s3) (<= s3 (- st2 1))) (and (= (select sel s3) true) (= (to_rep (select max s3)) lowest_max2))))))
