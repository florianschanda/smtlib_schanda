...
(assert (in_range1 e1))
(assert (and (= (mk___t temp___506 temp___5061) (get_model__2 (mk___rep (mk___split_fields s__split_fields3 s__split_fields4 s__split_fields5) s__attr__tag))) (and (dynamic_invariant1 (mk___t temp___506 temp___5061) true false true) (and (and (= s__split_fields3 temp___506) (= (mk (to_rep1 (first2 (mk1 1 (to_rep2 s__split_fields4)))) (to_rep1 (last2 (mk1 1 (to_rep2 s__split_fields4))))) temp___5061)) (= (length (mk___t temp___506 temp___5061)) (size (mk___rep (mk___split_fields s__split_fields3 s__split_fields4 s__split_fields5) s__attr__tag)))))))
(assert (not (= (length (mk___t temp___506 temp___5061)) 0)))
(assert (=> (<= 1 1) (= o (+ (- 1 1) 1))))
(assert (=> (not (<= 1 1)) (= o 0)))
(assert (=> (<= (to_rep1 (first temp___5061)) (to_rep1 (last temp___5061))) (= o1 (+ (- (to_rep1 (last temp___5061)) (to_rep1 (first temp___5061))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___5061)) (to_rep1 (last temp___5061)))) (= o1 0)))
(assert (= o2 (+ o1 o)))
(assert (= o3 (+ (to_rep1 (first temp___5061)) o2)))
(assert (= o4 (- o3 1)))
