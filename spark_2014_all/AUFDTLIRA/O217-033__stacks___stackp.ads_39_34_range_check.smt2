...
(assert (in_range1 e1))
(assert (and (= temp___5062 (get_model__2 (mk___rep s__split_fields3 s__attr__tag))) (and (dynamic_invariant1 temp___5062 true false true) (and (and (= s__split_fields temp___506) (= (mk (to_rep1 (first2 (mk1 1 (to_rep2 s__split_fields1)))) (to_rep1 (last2 (mk1 1 (to_rep2 s__split_fields1))))) temp___5061)) (= (length temp___5062) (size (mk___rep s__split_fields3 s__attr__tag)))))))
(assert (not (= (length temp___5062) 0)))
(assert (=> (<= 1 1) (= o (+ (- 1 1) 1))))
(assert (=> (not (<= 1 1)) (= o 0)))
