...
(define-fun default_initial_assumption ((temp___expr_153 (Array Int us_rep)) (temp___skip_top_level_154 Bool)) Bool (forall ((temp___155 Int)) (=> (and (<= 1 temp___155) (<= temp___155 10)) (= (to_rep (rec__main__rec__comp (us_split_fields1 (select temp___expr_153 temp___155)))) 1234))))
(declare-const result__ (Array Int us_rep))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-fun main__get_arr__result__aggregate_def (us_rep) (Array Int us_rep))
(assert (forall ((temp___134 us_rep)) (forall ((temp___135 Int)) (= (select (main__get_arr__result__aggregate_def temp___134) temp___135) temp___134))))
...
(define-fun default_initial_assumption1 ((temp___expr_140 us_rep) (temp___skip_top_level_141 Bool)) Bool (= (to_rep (rec__main__rec__comp (us_split_fields1 temp___expr_140))) 1234))
(define-fun dynamic_invariant1 ((temp___expr_145 Int) (temp___is_init_142 Bool) (temp___skip_constant_143 Bool) (temp___do_toplevel_144 Bool)) Bool (=> (or (= temp___is_init_142 true) (<= 1 10)) (in_range1 temp___expr_145)))
...
(assert (not (= (bool_eq1 main__get_arr__result4 1 10 (temp___157 (mk___rep (mk___split_fields (of_rep 9012)))) 1 10) true)))
(check-sat)
(exit)
