...
(assert (= result__ (main__get_arr__result__aggregate_def (mk___rep (mk___split_fields rliteral)))))
...
(assert (= (main__get_arr__result__aggregate_def (mk___rep (mk___split_fields rliteral))) result__))
...
(assert (not (= (bool_eq1 main__get_arr__result4 1 10 (temp_____aggregate_def_182 (mk___rep (mk___split_fields rliteral))) 1 10) true)))
(check-sat)
(exit)
