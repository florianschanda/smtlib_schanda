...
(assert (and (= perm__extended_perm__B_6__aa__assume2 (remove a (to_rep2 (rec__perm__witnesses__ia (us_split_fields1 w))))) (and (dynamic_invariant perm__extended_perm__B_6__aa__assume2 true false true true) (and (= (invariant__ perm__extended_perm__B_6__aa__assume2) true) (and (= (to_rep1 (last perm__extended_perm__B_6__aa__assume1)) (- (to_rep1 (last (rt a))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- (to_rep2 (rec__perm__witnesses__ia (us_split_fields1 w))) 1))) (= (to_rep (select (elts a) k1)) (to_rep (select perm__extended_perm__B_6__aa__assume k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ (to_rep2 (rec__perm__witnesses__ia (us_split_fields1 w))) 1) k1) (<= k1 (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) k1)) (to_rep (select perm__extended_perm__B_6__aa__assume (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= (to_rep2 (rec__perm__witnesses__ia (us_split_fields1 w))) k1) (<= k1 (- (to_rep1 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k1 1))) (to_rep (select perm__extended_perm__B_6__aa__assume k1))))))))))))
(assert (= perm__extended_perm__B_6__aa__assume2 aa))
(assert (dynamic_invariant aa true false true true))
(assert (and (= perm__extended_perm__B_6__bb__assume2 (remove b (to_rep2 (rec__perm__witnesses__ib (us_split_fields1 w))))) (and (dynamic_invariant perm__extended_perm__B_6__bb__assume2 true false true true) (and (= (invariant__ perm__extended_perm__B_6__bb__assume2) true) (and (= (to_rep1 (last perm__extended_perm__B_6__bb__assume1)) (- (to_rep1 (last (rt b))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- (to_rep2 (rec__perm__witnesses__ib (us_split_fields1 w))) 1))) (= (to_rep (select (elts b) k1)) (to_rep (select perm__extended_perm__B_6__bb__assume k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ (to_rep2 (rec__perm__witnesses__ib (us_split_fields1 w))) 1) k1) (<= k1 (to_rep1 (last (rt b))))) (= (to_rep (select (elts b) k1)) (to_rep (select perm__extended_perm__B_6__bb__assume (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= (to_rep2 (rec__perm__witnesses__ib (us_split_fields1 w))) k1) (<= k1 (- (to_rep1 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k1 1))) (to_rep (select perm__extended_perm__B_6__bb__assume k1))))))))))))
(assert (= perm__extended_perm__B_6__bb__assume2 bb))
(assert (dynamic_invariant bb true false true true))
(assert (and (= o (extended_perm aa bb)) (and (in_range4 o) (=> (= (distinct o 0) true) (forall ((ia3 Int)) (=> (and (<= (to_rep1 (first (rt aa))) ia3) (<= ia3 (to_rep1 (last (rt aa))))) (exists ((ib2 Int)) (and (and (<= (to_rep1 (first (rt bb))) ib2) (<= ib2 (to_rep1 (last (rt bb))))) (and (= (to_rep (select (elts aa) ia3)) (to_rep (select (elts bb) ib2))) (= (is_perm (remove aa ia3) (remove bb ib2)) true))))))))))
...
(assert (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 ia2)) (exists ((ib2 Int)) (and (and (<= (to_rep1 (first (rt b))) ib2) (<= ib2 (to_rep1 (last (rt b))))) (and (= (to_rep (select (elts a) k1)) (to_rep (select (elts b) ib2))) (= (is_perm (remove a k1) (remove b ib2)) true)))))))
(assert (and (and (and (=> (<= 1 1) (in_range4 ih2)) (=> (<= (to_rep1 (first (rt a))) (to_rep1 (last (rt a)))) (dynamic_property1 (to_rep1 (first (rt a))) (to_rep1 (last (rt a))) ia2))) (=> (<= 1 100) (in_range3 ib1))) (and (<= (to_rep1 (first (rt a))) ia2) (<= ia2 (to_rep1 (last (rt a)))))))
(assert (<= 1 k))
(assert (<= k ia2))
...
(assert (= o8 (to_rep o7)))
(assert (and (<= (to_rep1 (first (rt a))) k) (<= k (to_rep1 (last (rt a))))))
(assert (= o4 k))
(assert (= o5 (select (elts a) o4)))
(assert (= o9 (to_rep o5)))
(assert (= result2 (ite (= o9 o8) true false)))
(assert (= result2 true))
(assert (and (= o2 ib) (in_range3 ib)))
(assert (and (= o3 (remove b o2)) (and (dynamic_invariant o3 true false true true) (and (= (invariant__ o3) true) (and (= (to_rep1 (last (rt o3))) (- (to_rep1 (last (rt b))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- o2 1))) (= (to_rep (select (elts b) k1)) (to_rep (select (elts o3) k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ o2 1) k1) (<= k1 (to_rep1 (last (rt b))))) (= (to_rep (select (elts b) k1)) (to_rep (select (elts o3) (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= o2 k1) (<= k1 (- (to_rep1 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k1 1))) (to_rep (select (elts o3) k1))))))))))))
(assert (and (= o1 k) (in_range3 k)))
(assert (not (<= (to_rep1 (first (rt a))) o1)))
(check-sat)
(exit)
