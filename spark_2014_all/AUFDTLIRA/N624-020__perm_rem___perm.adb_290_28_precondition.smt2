...
(assert (exists ((ib29 Int)) (and (and (<= (to_rep2 (first (rt b))) ib29) (<= ib29 (to_rep2 (last (rt b))))) (and (= (to_rep (select (elts a) ia3)) (to_rep (select (elts b) ib29))) (= (is_perm (remove a ia3) (remove b ib29)) true)))))
(assert (=> (<= (to_rep2 (first (rt a))) (to_rep2 (last (rt a)))) (dynamic_property1 (to_rep2 (first (rt a))) (to_rep2 (last (rt a))) ia3)))
(assert (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 ia4)) (exists ((ib29 Int)) (and (and (<= (to_rep2 (first (rt b))) ib29) (<= ib29 (to_rep2 (last (rt b))))) (and (= (to_rep (select (elts a) k1)) (to_rep (select (elts b) ib29))) (= (is_perm (remove a k1) (remove b ib29)) true)))))))
(assert (and (and (and (=> (<= 1 1) (in_range3 ih15)) (=> (<= (to_rep2 (first (rt a))) (to_rep2 (last (rt a)))) (dynamic_property1 (to_rep2 (first (rt a))) (to_rep2 (last (rt a))) ia4))) (=> (<= 1 100) (in_range4 ib11))) (and (<= (to_rep2 (first (rt a))) ia4) (<= ia4 (to_rep2 (last (rt a)))))))
(assert (<= 1 k))
(assert (<= k ia4))
(assert (<= (to_rep2 (first (rt b))) ib2))
(assert (<= ib2 (to_rep2 (last (rt b)))))
(assert (and (<= (to_rep2 (first (rt b))) ib2) (<= ib2 (to_rep2 (last (rt b))))))
(assert (= o131 ib2))
(assert (= o132 (select (elts b) o131)))
(assert (= o133 (to_rep o132)))
(assert (and (<= (to_rep2 (first (rt a))) k) (<= k (to_rep2 (last (rt a))))))
(assert (= o129 k))
(assert (= o130 (select (elts a) o129)))
(assert (= o134 (to_rep o130)))
(assert (= result23 (ite (= o134 o133) true false)))
(assert (= result23 true))
(assert (and (= o127 ib2) (in_range4 ib2)))
(assert (and (= o128 (remove b o127)) (and (dynamic_invariant2 o128 true false true) (and (= (invariant__ o128) true) (and (= (to_rep2 (last (rt o128))) (- (to_rep2 (last (rt b))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- o127 1))) (= (to_rep (select (elts b) k1)) (to_rep (select (elts o128) k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ o127 1) k1) (<= k1 (to_rep2 (last (rt b))))) (= (to_rep (select (elts b) k1)) (to_rep (select (elts o128) (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= o127 k1) (<= k1 (- (to_rep2 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k1 1))) (to_rep (select (elts o128) k1))))))))))))
(assert (and (= o125 k) (in_range4 k)))
