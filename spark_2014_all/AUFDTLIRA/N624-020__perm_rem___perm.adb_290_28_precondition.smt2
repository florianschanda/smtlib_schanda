...
(assert (and (= o (extended_perm aa bb)) (and (in_range3 o) (=> (= (of_int o) true) (forall ((ia3 Int)) (=> (and (<= (to_rep2 (first (rt aa))) ia3) (<= ia3 (to_rep2 (last (rt aa))))) (exists ((ib2 Int)) (and (and (<= (to_rep2 (first (rt bb))) ib2) (<= ib2 (to_rep2 (last (rt bb))))) (and (= (to_rep (select (elts aa) ia3)) (to_rep (select (elts bb) ib2))) (= (is_perm (remove aa ia3) (remove bb ib2)) true))))))))))
...
(assert (and (= o3 (remove b o2)) (and (dynamic_invariant2 o3 true false true) (and (= (invariant__ o3) true) (and (= (to_rep2 (last (rt o3))) (- (to_rep2 (last (rt b))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- o2 1))) (= (to_rep (select (elts b) k1)) (to_rep (select (elts o3) k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ o2 1) k1) (<= k1 (to_rep2 (last (rt b))))) (= (to_rep (select (elts b) k1)) (to_rep (select (elts o3) (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= o2 k1) (<= k1 (- (to_rep2 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k1 1))) (to_rep (select (elts o3) k1))))))))))))
