...
(assert (and (= o (extended_perm aa bb)) (and (in_range3 o) (=> (= (distinct o 0) true) (forall ((ia3 Int)) (=> (and (<= (to_rep2 (first (rt aa))) ia3) (<= ia3 (to_rep2 (last (rt aa))))) (exists ((ib2 Int)) (and (and (<= (to_rep2 (first (rt bb))) ib2) (<= ib2 (to_rep2 (last (rt bb))))) (and (= (to_rep (select (elts aa) ia3)) (to_rep (select (elts bb) ib2))) (= (is_perm (remove aa ia3) (remove bb ib2)) true))))))))))
...
(assert (exists ((ib2 Int)) (and (and (<= (to_rep2 (first (rt b))) ib2) (<= ib2 (to_rep2 (last (rt b))))) (and (= (to_rep (select (elts a) ia1)) (to_rep (select (elts b) ib2))) (= (is_perm (remove a ia1) (remove b ib2)) true)))))
(assert (=> (<= (to_rep2 (first (rt a))) (to_rep2 (last (rt a)))) (dynamic_property1 (to_rep2 (first (rt a))) (to_rep2 (last (rt a))) ia1)))
(assert (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 ia2)) (exists ((ib2 Int)) (and (and (<= (to_rep2 (first (rt b))) ib2) (<= ib2 (to_rep2 (last (rt b))))) (and (= (to_rep (select (elts a) k1)) (to_rep (select (elts b) ib2))) (= (is_perm (remove a k1) (remove b ib2)) true)))))))
(assert (and (and (and (=> (<= 1 1) (in_range3 ih2)) (=> (<= (to_rep2 (first (rt a))) (to_rep2 (last (rt a)))) (dynamic_property1 (to_rep2 (first (rt a))) (to_rep2 (last (rt a))) ia2))) (=> (<= 1 100) (in_range4 ib1))) (and (<= (to_rep2 (first (rt a))) ia2) (<= ia2 (to_rep2 (last (rt a)))))))
(assert (<= 1 k))
(assert (<= k ia2))
(assert (<= (to_rep2 (first (rt b))) ib))
(assert (<= ib (to_rep2 (last (rt b)))))
(assert (and (<= (to_rep2 (first (rt b))) ib) (<= ib (to_rep2 (last (rt b))))))
(assert (= o6 ib))
(assert (= o7 (select (elts b) o6)))
(assert (= o8 (to_rep o7)))
(assert (and (<= (to_rep2 (first (rt a))) k) (<= k (to_rep2 (last (rt a))))))
(assert (= o4 k))
(assert (= o5 (select (elts a) o4)))
(assert (= o9 (to_rep o5)))
(assert (= result2 (ite (= o9 o8) true false)))
(assert (= result2 true))
(assert (and (= o2 ib) (in_range4 ib)))
(assert (and (= o3 (remove b o2)) (and (dynamic_invariant2 o3 true false true true) (and (= (invariant__ o3) true) (and (= (to_rep2 (last (rt o3))) (- (to_rep2 (last (rt b))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- o2 1))) (= (to_rep (select (elts b) k1)) (to_rep (select (elts o3) k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ o2 1) k1) (<= k1 (to_rep2 (last (rt b))))) (= (to_rep (select (elts b) k1)) (to_rep (select (elts o3) (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= o2 k1) (<= k1 (- (to_rep2 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k1 1))) (to_rep (select (elts o3) k1))))))))))))
(assert (and (= o1 k) (in_range4 k)))
