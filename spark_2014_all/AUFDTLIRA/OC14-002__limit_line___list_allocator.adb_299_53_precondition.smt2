...
(assert (=> (not (= first_available1 0)) (and (= o69 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range6 o69))))
(assert (=> (not (= first_available1 0)) (= result13 (ite (< 0 o69) true false))))
(assert (=> (not (= first_available1 0)) (=> (= result13 true) (and (= o68 (get (rec__list_allocator__m__t__available model____split_fields3) 1)) (in_range7 o68)))))
...
(assert (=> (not (not (= first_available1 0))) (and (= o70 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range6 o70))))
(assert (=> (not (not (= first_available1 0))) (= result12 (ite (= o70 0) true false))))
(assert (=> (= result12 true) (=> (not (= first_allocated2 0)) (and (= o66 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range6 o66)))))
(assert (=> (= result12 true) (=> (not (= first_allocated2 0)) (= result14 (ite (< 0 o66) true false)))))
(assert (=> (= result12 true) (=> (not (= first_allocated2 0)) (=> (= result14 true) (and (= o65 (get (rec__list_allocator__m__t__allocated model____split_fields3) 1)) (in_range7 o65))))))
...
(assert (=> (= result12 true) (=> (not (not (= first_allocated2 0))) (and (= o67 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range6 o67)))))
(assert (=> (= result12 true) (=> (not (not (= first_allocated2 0))) (= result11 (ite (= o67 0) true false)))))
(assert (=> (not (= result12 true)) (= result11 false)))
(assert (=> (= result11 true) (and (= o63 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range6 o63))))
