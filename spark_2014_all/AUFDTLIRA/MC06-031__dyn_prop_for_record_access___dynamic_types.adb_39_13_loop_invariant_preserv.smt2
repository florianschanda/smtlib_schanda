...
(define-fun dynamic_invariant2 ((temp___expr_177 Int) (temp___is_init_173 Bool) (temp___skip_constant_174 Bool) (temp___do_toplevel_175 Bool) (temp___do_typ_inv_176 Bool)) Bool (=> (or (= temp___is_init_173 true) (<= first2 last2)) (dynamic_property1 first2 last2 temp___expr_177)))
...
(define-fun dynamic_invariant3 ((temp___expr_194 us_rep) (temp___is_init_190 Bool) (temp___skip_constant_191 Bool) (temp___do_toplevel_192 Bool) (temp___do_typ_inv_193 Bool)) Bool (forall ((temp___195 Int)) (=> (and (<= 1 temp___195) (<= temp___195 1)) (=> (or (= temp___is_init_190 true) (<= first2 last2)) (dynamic_property1 first2 last2 (to_rep1 (select (rec__dynamic_types__search__result_type__from (us_split_fields1 temp___expr_194)) temp___195)))))))
(declare-fun search_range (Int) us_rep)
(declare-fun search_range__function_guard (us_rep Int) Bool)
(assert (forall ((from Int)) (! (=> (and (dynamic_invariant from true true true true) (and (<= (first1 a) from) (<= from (last1 a)))) (let ((result (search_range from))) (and (or (and (= (to_rep (rec__dynamic_types__search__result_type__result (us_split_fields1 result))) 0) (forall ((i Int)) (=> (and (<= from i) (<= i (to_rep1 (let ((temp___203 (rec__dynamic_types__search__result_type__from (us_split_fields1 result)))) (select temp___203 1))))) (not (= (to_rep (select (to_array a) i)) c))))) (and (and (<= (first1 a) (to_rep (rec__dynamic_types__search__result_type__result (us_split_fields1 result)))) (<= (to_rep (rec__dynamic_types__search__result_type__result (us_split_fields1 result))) (last1 a))) (= (to_rep (select (to_array a) (to_rep (rec__dynamic_types__search__result_type__result (us_split_fields1 result))))) c))) (dynamic_invariant3 result true false true true)))) :pattern ((search_range from)))))
...
(assert (dynamic_invariant3 (mk___rep (mk___split_fields tmp__split_fields tmp__split_fields1)) false false true true))
(assert (forall ((i Int)) (=> (and (<= (to_rep1 (first (rt a))) i) (<= i (- from2 1))) (not (= (to_rep (select (elts a) i)) c)))))
(assert (and (and (=> (<= first2 last2) (dynamic_property1 first2 last2 from2)) (=> (<= 0 2147483647) (in_range2 result__1))) (dynamic_invariant3 (mk___rep (mk___split_fields tmp__split_fields2 tmp__split_fields3)) false true true true)))
(assert (and (= o1 from2) (in_range2 from2)))
(assert (and (= temp___2072 (search_range o1)) (and (dynamic_invariant3 temp___2072 true false true true) (or (and (= (to_rep temp___2071) 0) (forall ((i Int)) (=> (and (<= o1 i) (<= i (to_rep1 (select temp___207 1)))) (not (= (to_rep (select (elts a) i)) c))))) (and (and (<= (to_rep1 (first (rt a))) (to_rep temp___2071)) (<= (to_rep temp___2071) (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) (to_rep temp___2071))) c))))))
...
(assert (and (= temp___209 (+ from3 1)) (in_range1 (+ from3 1))))
(assert (and (= us1 temp___209) (dynamic_property1 first2 last2 temp___209)))
(assert (= o2 temp___209))
