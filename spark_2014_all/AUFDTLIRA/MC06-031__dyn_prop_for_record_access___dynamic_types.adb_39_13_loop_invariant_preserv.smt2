...
(assert (forall ((i1 Int)) (=> (and (<= (to_rep1 (first (rt a))) i1) (<= i1 (- from2 1))) (not (= (to_rep (select (elts a) i1)) c)))))
(assert (and (and (=> (<= first2 last2) (dynamic_property1 first2 last2 from2)) (=> (<= 0 2147483647) (in_range2 result__1))) (dynamic_invariant3 (mk___rep (mk___split_fields tmp__split_fields2 tmp__split_fields3)) false true true)))
(assert (and (= o3 from2) (in_range2 from2)))
(assert (and (= (mk___rep (mk___split_fields temp___180 temp___1801)) (search_range o3)) (and (dynamic_invariant3 (mk___rep (mk___split_fields temp___180 temp___1801)) true false true) (or (and (= (to_rep temp___1801) 0) (forall ((i1 Int)) (=> (and (<= o3 i1) (<= i1 (to_rep1 (select temp___180 1)))) (not (= (to_rep (select (elts a) i1)) c))))) (and (and (<= (to_rep1 (first (rt a))) (to_rep temp___1801)) (<= (to_rep temp___1801) (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) (to_rep temp___1801))) c))))))
(assert (= result2 tmp__split_fields2))
(assert (= result3 tmp__split_fields3))
(assert (= temp___180 tmp__split_fields4))
(assert (= temp___1801 tmp__split_fields5))
(assert (= result__1 result4))
(assert (= result__2 (to_rep tmp__split_fields5)))
(assert (= from2 result5))
(assert (= from3 (to_rep1 (select tmp__split_fields4 1))))
(assert (not (< 0 result__2)))
(assert (= dynamic_types__search__result1 dynamic_types__search__result))
(assert (not (= from3 (to_rep1 (last (rt a))))))
(assert (and (= temp___182 (+ from3 1)) (in_range1 (+ from3 1))))
(assert (and (= us1 temp___182) (dynamic_property1 first2 last2 temp___182)))
(assert (= o4 temp___182))
(assert (= from3 result8))
(assert (= from4 o4))
(assert (= dynamic_types__search__result2 dynamic_types__search__result1))
(declare-const i1 Int)
(assert (<= (to_rep1 (first (rt a))) i1))
(assert (<= i1 (- from4 1)))
(assert (not (not (= (to_rep (select (elts a) i1)) c))))
(check-sat)
(exit)
