...
(assert (=> (= (to_rep3 (rec__file_io__read_result__status next_read__split_discrs8)) 0) (= result12 (ite (= (to_rep (rec__file_io__read_result__c next_read__split_fields8)) 34) true false))))
(assert (=> (not (= (to_rep3 (rec__file_io__read_result__status next_read__split_discrs8)) 0)) (= result12 false)))
