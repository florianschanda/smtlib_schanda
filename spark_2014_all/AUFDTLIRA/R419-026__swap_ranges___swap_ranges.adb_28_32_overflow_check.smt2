...
(assert (=> (< k2 (to_rep a__last)) (let ((swap_ranges__swap_ranges_with_error__L_1__R41b1 (+ k2 1))) (let ((swap_ranges__swap_ranges_with_error__L_1__R38b (+ k2 1))) (= (bool_eq a (to_rep (first14 (mk7 swap_ranges__swap_ranges_with_error__L_1__R38b (to_rep a__last)))) (to_rep (last14 (mk7 swap_ranges__swap_ranges_with_error__L_1__R38b (to_rep a__last)))) a2 (to_rep (first16 (mk8 swap_ranges__swap_ranges_with_error__L_1__R41b1 (to_rep a__last)))) (to_rep (last16 (mk8 swap_ranges__swap_ranges_with_error__L_1__R41b1 (to_rep a__last))))) true)))))
