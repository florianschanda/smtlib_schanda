...
(assert (and (and (forall ((temp___173 Int)) (=> (and (<= 1 temp___173) (<= temp___173 100)) (=> (< i2 temp___173) (= (select c3 temp___173) (select c temp___173))))) (=> (<= 1 100) (in_range3 i2))) (and (<= 1 i2) (<= i2 100))))
(assert (<= 1 j))
(assert (<= j i2))
(assert (not (<= 1 j)))
(check-sat)
