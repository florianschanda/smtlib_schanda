...
(assert (and (and (forall ((temp___198 Int)) (=> (and (<= 1 temp___198) (<= temp___198 100)) (=> (< i2 temp___198) (= (select c3 temp___198) (select c temp___198))))) (=> (<= 1 100) (in_range3 i2))) (and (<= 1 i2) (<= i2 100))))
(assert (<= 1 j))
(assert (<= j i2))
(assert (not (<= 1 j)))
(check-sat)
