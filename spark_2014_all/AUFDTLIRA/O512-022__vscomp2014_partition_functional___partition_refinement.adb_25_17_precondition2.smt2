...
(assert (= result1 true))
(assert (and (= o (length1 (mk___rep2 p__split_discrs (mk___split_fields2 p__split_fields)))) (and (in_range5 o) (<= o (capacity (mk___rep2 p__split_discrs (mk___split_fields2 p__split_fields)))))))
(assert (= o1 (- o 1)))
