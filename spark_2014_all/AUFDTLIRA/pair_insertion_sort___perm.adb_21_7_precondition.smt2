...
(assert (and (= (mk___t o5 o6) (remove_last b)) (and (dynamic_invariant1 (mk___t o5 o6) true false true) (and (= (elts b) o5) (= (mk (to_rep (first2 (mk1 (to_rep (first (rt b))) (- (to_rep (last (rt b))) 1)))) (to_rep (last2 (mk1 (to_rep (first (rt b))) (- (to_rep (last (rt b))) 1))))) o6)))))
(assert (and (= (mk___t o3 o4) (remove_last a)) (and (dynamic_invariant1 (mk___t o3 o4) true false true) (and (= (elts a) o3) (= (mk (to_rep (first2 (mk1 (to_rep (first (rt a))) (- (to_rep (last (rt a))) 1)))) (to_rep (last2 (mk1 (to_rep (first (rt a))) (- (to_rep (last (rt a))) 1))))) o4)))))
(assert (not (= (bool_eq o3 (to_rep (first o4)) (to_rep (last o4)) o5 (to_rep (first o6)) (to_rep (last o6))) true)))
(check-sat)
(exit)
