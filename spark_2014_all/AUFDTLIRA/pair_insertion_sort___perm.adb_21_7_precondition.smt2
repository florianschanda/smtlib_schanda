...
(assert (and (= o7 (remove_last b)) (and (dynamic_invariant1 o7 true false true true) (and (= (elts b) o5) (= (mk (to_rep (first2 (mk1 (to_rep (first (rt b))) (- (to_rep (last (rt b))) 1)))) (to_rep (last2 (mk1 (to_rep (first (rt b))) (- (to_rep (last (rt b))) 1))))) o6)))))
(assert (and (= o8 (remove_last a)) (and (dynamic_invariant1 o8 true false true true) (and (= (elts a) o3) (= (mk (to_rep (first2 (mk1 (to_rep (first (rt a))) (- (to_rep (last (rt a))) 1)))) (to_rep (last2 (mk1 (to_rep (first (rt a))) (- (to_rep (last (rt a))) 1))))) o4)))))
