...
(declare-const temp___1528 (Array Int character))
(declare-const temp___15281 t3)
...
(assert (= o30 result__))
(assert (= o30 temp___1528))
(assert (= (mk3 1 (to_rep1 fullstring__last)) temp___15281))
(assert (not (= (ite (<= (to_rep1 (first6 temp___15251)) (to_rep1 (last6 temp___15251))) (+ (- (to_rep1 (last6 temp___15251)) (to_rep1 (first6 temp___15251))) 1) 0) (ite (<= (to_rep1 (first6 temp___15281)) (to_rep1 (last6 temp___15281))) (+ (- (to_rep1 (last6 temp___15281)) (to_rep1 (first6 temp___15281))) 1) 0))))
(check-sat)
(exit)
