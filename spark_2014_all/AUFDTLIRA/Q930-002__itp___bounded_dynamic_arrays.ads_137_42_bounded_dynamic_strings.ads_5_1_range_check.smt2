...
(declare-const temp___1174 us_t2)
(declare-const temp___1173 us_t2)
...
(assert (and (= o23 (length2 tail)) (and (in_range4 o23) (= o23 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 tail)))))))
...
(assert (and (= temp___1174 (value tail)) (and (dynamic_invariant2 temp___1174 true false true true) (and (= temp___1174 (mk___t2 (elts1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 tail))) (mk2 (to_rep1 (first6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 tail)))))) (to_rep1 (last6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 tail))))))))) (and (and (and (= (length3 temp___1174) (length2 tail)) (= (to_rep1 (first4 (rt2 temp___1174))) 1)) (= (to_rep1 (last4 (rt2 temp___1174))) (length2 tail))) (= (< 0 (length2 tail)) (not (= (empty tail) true))))))))
(assert (and (= temp___1173 (value (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t1 to____split_fields1 to____split_fields2))))) (and (dynamic_invariant2 temp___1173 true false true true) (and (= temp___1173 (mk___t2 to____split_fields1 (mk2 (to_rep1 (first6 (mk3 1 (to_rep2 to____split_fields)))) (to_rep1 (last6 (mk3 1 (to_rep2 to____split_fields))))))) (and (and (and (= (length3 temp___1173) (length2 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t1 to____split_fields1 to____split_fields2))))) (= (to_rep1 (first4 (rt2 temp___1173))) 1)) (= (to_rep1 (last4 (rt2 temp___1173))) (length2 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t1 to____split_fields1 to____split_fields2)))))) (= (< 0 (length2 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t1 to____split_fields1 to____split_fields2))))) (not (= (empty (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t1 to____split_fields1 to____split_fields2)))) true))))))))
(assert (not (= (length3 temp___1173) 0)))
(assert (=> (<= (to_rep1 (first4 (rt2 temp___1174))) (to_rep1 (last4 (rt2 temp___1174)))) (= o18 (+ (- (to_rep1 (last4 (rt2 temp___1174))) (to_rep1 (first4 (rt2 temp___1174)))) 1))))
(assert (=> (not (<= (to_rep1 (first4 (rt2 temp___1174))) (to_rep1 (last4 (rt2 temp___1174))))) (= o18 0)))
(assert (=> (<= (to_rep1 (first4 (rt2 temp___1173))) (to_rep1 (last4 (rt2 temp___1173)))) (= o19 (+ (- (to_rep1 (last4 (rt2 temp___1173))) (to_rep1 (first4 (rt2 temp___1173)))) 1))))
(assert (=> (not (<= (to_rep1 (first4 (rt2 temp___1173))) (to_rep1 (last4 (rt2 temp___1173))))) (= o19 0)))
(assert (= o20 (+ o19 o18)))
(assert (= o21 (+ (to_rep1 (first4 (rt2 temp___1173))) o20)))
(assert (= o22 (- o21 1)))
