...
(assert (and (= o24 (length3 tail)) (and (in_range4 o24) (= o24 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 tail)))))))
(assert (and (= o25 (length3 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2))))) (and (in_range4 o25) (= o25 (to_rep2 to____split_fields)))))
(assert (= o26 (+ o25 o24)))
(assert (and (= o27 (length3 (mk___rep to____split_discrs (us_split_fields__content to____split_fields5)))) (and (in_range4 o27) (= o27 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields__content to____split_fields5)))))))
(assert (= o28 (ite (= o27 o26) true false)))
(assert (and (= temp___1105 (value tail)) (and (dynamic_invariant3 temp___1105 true false true) (and (= temp___1105 (mk___t1 (elts2 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 tail))) (mk1 (to_rep1 (first6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 tail)))))) (to_rep1 (last6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 tail))))))))) (and (and (and (= (length1 temp___1105) (length3 tail)) (= (to_rep1 (first2 (rt1 temp___1105))) 1)) (= (to_rep1 (last2 (rt1 temp___1105))) (length3 tail))) (= (< 0 (length3 tail)) (not (= (empty tail) true))))))))
(assert (and (= temp___1104 (value (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2))))) (and (dynamic_invariant3 temp___1104 true false true) (and (= temp___1104 (mk___t1 to____split_fields1 (mk1 (to_rep1 (first6 (mk3 1 (to_rep2 to____split_fields)))) (to_rep1 (last6 (mk3 1 (to_rep2 to____split_fields))))))) (and (and (and (= (length1 temp___1104) (length3 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2))))) (= (to_rep1 (first2 (rt1 temp___1104))) 1)) (= (to_rep1 (last2 (rt1 temp___1104))) (length3 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2)))))) (= (< 0 (length3 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2))))) (not (= (empty (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2)))) true))))))))
(assert (not (= (length1 temp___1104) 0)))
(assert (=> (<= (to_rep1 (first2 (rt1 temp___1105))) (to_rep1 (last2 (rt1 temp___1105)))) (= o18 (+ (- (to_rep1 (last2 (rt1 temp___1105))) (to_rep1 (first2 (rt1 temp___1105)))) 1))))
(assert (=> (not (<= (to_rep1 (first2 (rt1 temp___1105))) (to_rep1 (last2 (rt1 temp___1105))))) (= o18 0)))
(assert (=> (<= (to_rep1 (first2 (rt1 temp___1104))) (to_rep1 (last2 (rt1 temp___1104)))) (= o19 (+ (- (to_rep1 (last2 (rt1 temp___1104))) (to_rep1 (first2 (rt1 temp___1104)))) 1))))
(assert (=> (not (<= (to_rep1 (first2 (rt1 temp___1104))) (to_rep1 (last2 (rt1 temp___1104))))) (= o19 0)))
(assert (= o20 (+ o19 o18)))
(assert (= o21 (+ (to_rep1 (first2 (rt1 temp___1104))) o20)))
(assert (= o22 (- o21 1)))
