...
(define-fun o23 () us_rep3 (mk___rep1 (mk___split_fields1 o18 o19)))
(define-fun o24 () us_rep3 (mk___rep1 (mk___split_fields1 o14 o15)))
...
(assert (and (= o24 (model__ (map__content data6) first_available1)) (= (model_is_well_formed o24 (map__content data6) first_available1) true)))
(assert (= o14 o16))
(assert (= o15 o17))
...
(assert (and (= o23 (model__ (map__content data6) first_available1)) (= (model_is_well_formed o23 (map__content data6) first_available1) true)))
(assert (= o20 (mk___split_fields1 o18 o19)))
(assert (= o21 (rec__list_mod_allocator__m__t__available o20)))
(assert (and (= o22 (length o21)) (and (in_range6 o22) (<= (+ 0 o22) 2147483647))))
