...
(assert (= g21 1))
(assert (=> (and (<= 1 g21) (<= g21 64)) (= temp___575 result__1)))
(assert (=> (and (<= 1 g21) (<= g21 64)) (= temp___574 g21)))
(assert (=> (and (<= 1 g21) (<= g21 64)) (forall ((prev Int)) (=> (and (<= 1 prev) (<= prev (- g22 1))) (= (bool_eq2 (select result__2 prev) 1 64 (invert_1 (select r2 prev)) 1 64) true)))))
(assert (=> (and (<= 1 g21) (<= g21 64)) (and (and (=> (<= 1 64) (in_range2 g22)) (forall ((temp___576 Int)) (=> (and (<= 1 temp___576) (<= temp___576 64)) (=> (<= g22 temp___576) (= (select result__2 temp___576) (select temp___575 temp___576)))))) (and (<= 1 g22) (<= g22 64)))))
...
(assert (<= 1 g210))
(assert (<= g210 64))
(assert (not (= (bool_eq2 (select stable_marriage__matching__invert__result4 g210) 1 64 (invert_1 (select r2 g210)) 1 64) true)))
(check-sat)
(exit)
