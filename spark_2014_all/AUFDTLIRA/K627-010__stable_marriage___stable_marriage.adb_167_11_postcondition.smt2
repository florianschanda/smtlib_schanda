...
(declare-const result5 (Array Int (Array Int ranking)))
...
(assert (= result5 stable_marriage__matching__invert__result4))
(declare-const g213 Int)
(assert (<= 1 g213))
(assert (<= g213 64))
(assert (not (= (bool_eq2 (select stable_marriage__matching__invert__result4 g213) 1 64 (invert_1 (select r2 g213)) 1 64) true)))
(check-sat)
(exit)
