...
(assert (=> (and (<= 1 g21) (<= g21 64)) (and (and (=> (<= 1 64) (in_range2 g22)) (forall ((temp___534 Int)) (=> (and (<= 1 temp___534) (<= temp___534 64)) (=> (<= g22 temp___534) (= (select result__2 temp___534) (select temp___533 temp___534)))))) (and (<= 1 g22) (<= g22 64)))))
