...
(assert (forall ((g210 Int)) (=> (and (<= 1 g210) (<= g210 64)) (= (is_permutation_1 (select r2 g210)) true))))
...
(assert (= g21 1))
(assert (=> (and (<= 1 g21) (<= g21 64)) (= temp___577 result__1)))
(assert (=> (and (<= 1 g21) (<= g21 64)) (= temp___576 g21)))
(assert (=> (and (<= 1 g21) (<= g21 64)) (forall ((prev Int)) (=> (and (<= 1 prev) (<= prev (- g22 1))) (= (bool_eq1 (select result__2 prev) 1 64 (invert_1 (select r2 prev)) 1 64) true)))))
(assert (=> (and (<= 1 g21) (<= g21 64)) (and (and (=> (<= 1 64) (in_range3 g22)) (forall ((temp___578 Int)) (=> (and (<= 1 temp___578) (<= temp___578 64)) (=> (or (< 64 temp___578) (or (< temp___578 1) (<= g22 temp___578))) (= (select result__2 temp___578) (select temp___577 temp___578)))))) (and (<= 1 g22) (<= g22 64)))))
(assert (=> (and (<= 1 g21) (<= g21 64)) (and (= o (invert_1 (select r2 g22))) (and (forall ((rank Int)) (=> (and (<= 1 rank) (<= rank 64)) (= (to_rep1 (select o (to_rep (select (select r2 g22) rank)))) rank))) (forall ((g1 Int)) (=> (and (<= 1 g1) (<= g1 64)) (= (to_rep (select (select r2 g22) (to_rep1 (select o g1)))) g1)))))))
...
(assert (=> (and (<= 1 g21) (<= g21 64)) (= result__10 (mk_map__ref3 result__4))))
...
(assert (<= 1 g210))
(assert (<= g210 64))
(assert (not (= (bool_eq1 (select stable_marriage__matching__invert__result4 g210) 1 64 (invert_1 (select r2 g210)) 1 64) true)))
(check-sat)
(exit)
