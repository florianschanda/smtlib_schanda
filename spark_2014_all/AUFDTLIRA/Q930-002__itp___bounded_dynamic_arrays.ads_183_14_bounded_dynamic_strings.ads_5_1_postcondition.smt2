...
(assert (and (and (and (= us (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 within)))) (in_range4 (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 within))))) (or (and (and (and (= bounded_dynamic_strings__location__2__result18 (mk_int__ref bounded_dynamic_strings__location__2__result7)) (= (mk_int__ref k15) (mk_int__ref k7))) (and (= bounded_dynamic_strings__location__2__result19 bounded_dynamic_strings__location__2__result8) (= k16 k8))) (and (and (and (and (= o1 (length fragment)) (in_range1 (length fragment))) (= o2 (ite (<= o1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 within)))) true false))) (and (and (and (= o (length fragment)) (in_range1 (length fragment))) (= o3 (ite (<= 1 o) true false))) (= result (ite (= o3 true) o2 false)))) (and (= result true) (and (= temp___1242 1) (and (and (and (and (= o4 (length fragment)) (in_range1 (length fragment))) (= o5 (- (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 within))) o4))) (= temp___1243 (+ o5 1))) (and (and (= (mk_int__ref result1) (mk_int__ref k)) (= k2 temp___1242)) (and (and (<= temp___1242 k2) (<= k2 temp___1243)) (and (= temp___1232 k2) (or (and (and (and (= bounded_dynamic_strings__location__2__result2 bounded_dynamic_strings__location__2__result7) (= k2 k7)) (and (= bounded_dynamic_strings__location__2__result8 bounded_dynamic_strings__location__2__result2) (= k8 k2))) (and (and (and (and (and (and (= o6 (length fragment)) (in_range1 (length fragment))) (= o7 (+ k2 o6))) (= temp___1229 (- o7 1))) (and (and (=> (<= k2 temp___1229) (and (and (<= (to_rep1 (first2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))) k2) (<= k2 (to_rep1 (last2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))))) (and (<= (to_rep1 (first2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))) temp___1229) (<= temp___1229 (to_rep1 (last2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))))))) (= o8 (elts1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))) (and (= o8 temp___1231) (= (mk3 k2 temp___1229) temp___12311)))) (= result2 (bool_eq temp___1231 (to_rep1 (first6 temp___12311)) (to_rep1 (last6 temp___12311)) (elts fragment) (to_rep1 (first (rt fragment))) (to_rep1 (last (rt fragment)))))) (and (= result2 true) (and (= result3 bounded_dynamic_strings__location__2__result) (= bounded_dynamic_strings__location__2__result2 k2))))) (and (and (and (and (and (and (and (= o6 (length fragment)) (in_range1 (length fragment))) (= o7 (+ k2 o6))) (= temp___1229 (- o7 1))) (and (and (=> (<= k2 temp___1229) (and (and (<= (to_rep1 (first2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))) k2) (<= k2 (to_rep1 (last2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))))) (and (<= (to_rep1 (first2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))) temp___1229) (<= temp___1229 (to_rep1 (last2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))))))) (= o8 (elts1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))) (and (= o8 temp___1231) (= (mk3 k2 temp___1229) temp___12311)))) (= result2 (bool_eq temp___1231 (to_rep1 (first6 temp___12311)) (to_rep1 (last6 temp___12311)) (elts fragment) (to_rep1 (first (rt fragment))) (to_rep1 (last (rt fragment)))))) (and (not (= result2 true)) (and (= bounded_dynamic_strings__location__2__result2 bounded_dynamic_strings__location__2__result) (= bounded_dynamic_strings__location__2__result2 bounded_dynamic_strings__location__2__result1)))) (and (and (and (= bounded_dynamic_strings__location__2__result4 bounded_dynamic_strings__location__2__result7) (= k4 k7)) (and (= bounded_dynamic_strings__location__2__result8 bounded_dynamic_strings__location__2__result4) (= k8 k4))) (and (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 k3)) (not (= (bool_eq (elts1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))) (to_rep1 (first8 (mk4 j1 (- (+ j1 (length fragment)) 1)))) (to_rep1 (last8 (mk4 j1 (- (+ j1 (length fragment)) 1)))) (elts fragment) (to_rep1 (first (rt fragment))) (to_rep1 (last (rt fragment)))) true)))) (and (and (=> (<= 1 (+ (- (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 within))) (length fragment)) 1)) (dynamic_property5 1 (+ (- (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 within))) (length fragment)) 1) k3)) (and (<= 1 k3) (<= k3 (+ (- (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 within))) (length fragment)) 1)))) (and (not (= k3 temp___1243)) (and (and (= k3 result4) (= k4 (+ k3 1))) (and (and (and (and (and (and (= o11 (length fragment)) (in_range1 (length fragment))) (= o12 (+ k4 o11))) (= temp___12291 (- o12 1))) (and (and (=> (<= k4 temp___12291) (and (and (<= (to_rep1 (first2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))) k4) (<= k4 (to_rep1 (last2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))))) (and (<= (to_rep1 (first2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))) temp___12291) (<= temp___12291 (to_rep1 (last2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))))))) (= o13 (elts1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))) (and (= o13 temp___12312) (= (mk3 k4 temp___12291) temp___12313)))) (= result5 (bool_eq temp___12312 (to_rep1 (first6 temp___12313)) (to_rep1 (last6 temp___12313)) (elts fragment) (to_rep1 (first (rt fragment))) (to_rep1 (last (rt fragment)))))) (and (= result5 true) (and (= result6 bounded_dynamic_strings__location__2__result3) (= bounded_dynamic_strings__location__2__result4 k4))))))))))))))))))) (and (and (and (and (and (= o1 (length fragment)) (in_range1 (length fragment))) (= o2 (ite (<= o1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 within)))) true false))) (and (and (and (= o (length fragment)) (in_range1 (length fragment))) (= o3 (ite (<= 1 o) true false))) (= result (ite (= o3 true) o2 false)))) (ite (= result true) (and (and (and (and (and (= o4 (length fragment)) (in_range1 (length fragment))) (= o5 (- (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 within))) o4))) (= temp___1243 (+ o5 1))) (and (and (= (mk_int__ref result1) (mk_int__ref k)) (= k2 1)) (ite (and (<= 1 k2) (<= k2 temp___1243)) (and (and (and (= temp___1232 k2) (and (and (and (and (and (and (and (= o6 (length fragment)) (in_range1 (length fragment))) (= o7 (+ k2 o6))) (= temp___1229 (- o7 1))) (and (and (=> (<= k2 temp___1229) (and (and (<= (to_rep1 (first2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))) k2) (<= k2 (to_rep1 (last2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))))) (and (<= (to_rep1 (first2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))) temp___1229) (<= temp___1229 (to_rep1 (last2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))))))) (= o8 (elts1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))) (and (= o8 temp___1231) (= (mk3 k2 temp___1229) temp___12311)))) (= result2 (bool_eq temp___1231 (to_rep1 (first6 temp___12311)) (to_rep1 (last6 temp___12311)) (elts fragment) (to_rep1 (first (rt fragment))) (to_rep1 (last (rt fragment)))))) (and (not (= result2 true)) (and (= bounded_dynamic_strings__location__2__result2 bounded_dynamic_strings__location__2__result) (= bounded_dynamic_strings__location__2__result2 bounded_dynamic_strings__location__2__result1)))) (and (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 k3)) (not (= (bool_eq (elts1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))) (to_rep1 (first8 (mk4 j1 (- (+ j1 (length fragment)) 1)))) (to_rep1 (last8 (mk4 j1 (- (+ j1 (length fragment)) 1)))) (elts fragment) (to_rep1 (first (rt fragment))) (to_rep1 (last (rt fragment)))) true)))) (and (and (=> (<= 1 (+ (- (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 within))) (length fragment)) 1)) (dynamic_property5 1 (+ (- (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 within))) (length fragment)) 1) k3)) (and (<= 1 k3) (<= k3 (+ (- (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 within))) (length fragment)) 1)))) (= k3 temp___1243))))) (and (and (= bounded_dynamic_strings__location__2__result3 bounded_dynamic_strings__location__2__result9) (= k3 k9)) (and (= bounded_dynamic_strings__location__2__result10 bounded_dynamic_strings__location__2__result3) (= k10 k3)))) (and (and (= (mk_int__ref bounded_dynamic_strings__location__2__result11) (mk_int__ref bounded_dynamic_strings__location__2__result9)) (= (mk_int__ref k11) (mk_int__ref k9))) (and (= bounded_dynamic_strings__location__2__result12 bounded_dynamic_strings__location__2__result10) (= k12 k10)))) (and (and (= (mk_int__ref bounded_dynamic_strings__location__2__result11) (mk_int__ref bounded_dynamic_strings__location__2__result)) (= k2 k11)) (and (= bounded_dynamic_strings__location__2__result12 bounded_dynamic_strings__location__2__result1) (= k12 k2)))))) (and (and (= (mk_int__ref bounded_dynamic_strings__location__2__result13) (mk_int__ref bounded_dynamic_strings__location__2__result11)) (= (mk_int__ref k13) (mk_int__ref k11))) (and (= bounded_dynamic_strings__location__2__result14 bounded_dynamic_strings__location__2__result12) (= k14 k12)))) (and (and (= (mk_int__ref bounded_dynamic_strings__location__2__result13) (mk_int__ref bounded_dynamic_strings__location__2__result)) (= (mk_int__ref k13) (mk_int__ref k))) (and (= bounded_dynamic_strings__location__2__result14 bounded_dynamic_strings__location__2__result1) (= k14 k1))))) (and (and (and (= bounded_dynamic_strings__location__2__result18 (mk_int__ref bounded_dynamic_strings__location__2__result16)) (= (mk_int__ref k15) (mk_int__ref k13))) (and (= bounded_dynamic_strings__location__2__result19 bounded_dynamic_strings__location__2__result17) (= k16 k14))) (and (not (= (contains__2 within fragment) true)) (and (and (= bounded_dynamic_strings__location__2__result15 bounded_dynamic_strings__location__2__result16) (= bounded_dynamic_strings__location__2__result17 bounded_dynamic_strings__location__2__result15)) (and (= result7 bounded_dynamic_strings__location__2__result13) (= bounded_dynamic_strings__location__2__result15 0)))))))) (and (and (= bounded_dynamic_strings__location__2__result20 bounded_dynamic_strings__location__2__result18) (= k17 (mk_int__ref k15))) (and (= bounded_dynamic_strings__location__2__result21 bounded_dynamic_strings__location__2__result19) (= k18 k16)))))
(assert (= result8 (int__content bounded_dynamic_strings__location__2__result20)))
(assert (not (<= 0 (int__content bounded_dynamic_strings__location__2__result20))))
(check-sat)
(exit)
