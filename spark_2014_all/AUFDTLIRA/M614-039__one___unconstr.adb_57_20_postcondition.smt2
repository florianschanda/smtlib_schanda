...
(assert (= (mk___t2 temp___225 temp___2251) (unconstr__unconstr_return__s__aggregate_def 32 1 x)))
(assert (= (ite (<= (to_rep1 (first4 temp___2251)) (to_rep1 (last4 temp___2251))) (+ (- (to_rep1 (last4 temp___2251)) (to_rep1 (first4 temp___2251))) 1) 0) (ite (<= 1 x) (+ (- x 1) 1) 0)))
(assert (= temp___225 unconstr__unconstr_return__s__assume))
(assert (= (mk1 (to_rep1 (first4 temp___2251)) (to_rep1 (last4 temp___2251))) unconstr__unconstr_return__s__assume1))
(assert (= result s))
