...
(declare-fun temp___590 ((Array Int unsigned_byte)) (Array Int (Array Int unsigned_byte)))
(declare-fun temp___594 (Int) (Array Int unsigned_byte))
...
(assert (forall ((temp___592 (Array Int unsigned_byte))) (forall ((temp___593 Int)) (= (select (temp___590 temp___592) temp___593) temp___592))))
(assert (forall ((temp___596 Int)) (=> (dynamic_invariant temp___596 true true true true) (forall ((temp___597 Int)) (= (to_rep (select (temp___594 temp___596) temp___597)) temp___596)))))
...
(assert (= result x))
(assert (= x1 (temp___590 (temp___594 12))))
