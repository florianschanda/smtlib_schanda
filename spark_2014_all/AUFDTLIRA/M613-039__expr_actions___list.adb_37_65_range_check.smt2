...
(assert (and (= o10 (to__ (mk___rep s__split_fields10))) (dynamic_invariant1 o10 true false true true)))
...
(assert (=> (= result4 true) (= temp___518 (mk___t2 o8 (mk2 first2 temp___516)))))
...
(assert (=> (= result4 true) (= temp___517 (mk___t1 o9 (mk1 first2 temp___515)))))
