...
(assert (and (= o23 j3) (in_range2 j3)))
(assert (and (= o21 (+ j3 2)) (in_range1 (+ j3 2))))
(assert (and (= o22 o21) (in_range2 o21)))
(assert (and (and (= (is_perm (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) (mk___t a3 (mk (to_rep a__first) (to_rep a__last)))) true) (and (= (to_rep (select a3 o22)) (to_rep (select a2 o23))) (and (= (to_rep (select a3 o23)) (to_rep (select a2 o22))) (forall ((z3 Int)) (=> (and (<= (to_rep a__first) z3) (<= z3 (to_rep a__last))) (=> (and (not (= z3 o22)) (not (= z3 o23))) (= (to_rep (select a3 z3)) (to_rep (select a2 z3))))))))) (= (to_rep a__first) 0)))
(assert (not (< x2 (to_rep (select a3 (+ j3 2))))))
(check-sat)
(exit)
