...
(assert (and (= o37 (- j3 1)) (in_range1 (- j3 1))))
(assert (= j3 result9))
(assert (= j4 o37))
(assert (=> (<= 0 j4) (and (<= (to_rep a__first) j4) (<= j4 (to_rep a__last)))))
(assert (=> (<= 0 j4) (= o38 j4)))
(assert (=> (<= 0 j4) (= o39 (select a3 o38))))
(assert (=> (<= 0 j4) (= o40 (to_rep o39))))
(assert (=> (<= 0 j4) (= o41 (ite (< x3 o40) true false))))
(assert (=> (not (<= 0 j4)) (= o41 false)))
(assert (= result10 (ite (not (= o41 true)) true false)))
(assert (not (= result10 true)))
(assert (and (= o44 j4) (in_range2 j4)))
(assert (and (= o42 (+ j4 2)) (in_range1 (+ j4 2))))
(assert (and (= o43 o42) (in_range2 o42)))
(assert (and (and (= (is_perm (mk___t a3 (mk (to_rep a__first) (to_rep a__last))) (mk___t a4 (mk (to_rep a__first) (to_rep a__last)))) true) (and (= (to_rep (select a4 o43)) (to_rep (select a3 o44))) (and (= (to_rep (select a4 o44)) (to_rep (select a3 o43))) (forall ((z15 Int)) (=> (and (<= (to_rep a__first) z15) (<= z15 (to_rep a__last))) (=> (and (not (= z15 o43)) (not (= z15 o44))) (= (to_rep (select a4 z15)) (to_rep (select a3 z15))))))))) (= (to_rep a__first) 0)))
(assert (not (< x3 (to_rep (select a4 (+ j4 2))))))
(check-sat)
(exit)
