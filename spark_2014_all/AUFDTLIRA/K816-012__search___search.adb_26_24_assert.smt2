...
(assert (<= (to_rep (first (rt table))) i1))
(assert (<= i1 (to_rep (last (rt table)))))
(assert (and (and (and (=> (<= 0 2147483647) (in_range2 found4)) (=> (<= (- 2147483648) 2147483647) (in_range1 index12))) (=> (<= (- 2147483648) 2147483647) (in_range1 index22))) (and (<= (to_rep (first (rt table))) i2) (<= i2 (to_rep (last (rt table)))))))
(assert (or (or (and (and (= found4 0) (not (= found12 true))) (not (= found22 true))) (and (= found4 1) (or (= found12 true) (= found22 true)))) (and (and (= found4 2) (= found12 true)) (= found22 true))))
(assert (or (not (= found12 true)) (not (= found22 true))))
(assert (or (not (= found12 true)) (= (to_rep (select (elts table) index12)) value1)))
(assert (or (not (= found22 true)) (= (to_rep (select (elts table) index22)) value2)))
(assert (not (< found4 2)))
(check-sat)
(exit)
