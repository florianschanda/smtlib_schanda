...
(declare-const temp___241 positive)
(declare-const temp___2411 natural)
(declare-const temp___2412 (Array Int element))
(declare-const temp___2413 t)
(declare-const temp___2414 us_private)
...
(define-fun s__split_fields14 () us_split_fields__ref (mk___split_fields__ref (mk___split_fields s__split_fields (mk___t s__split_fields1 s__split_fields2) s__split_fields3)))
...
(assert (or (and (and (and (= s__split_fields10 s__split_fields14) (= mystate3 (mk_int__ref mystate2))) (and (= s__split_fields11 (mk___split_fields s__split_fields4 (mk___t s__split_fields5 s__split_fields6) s__split_fields7)) (= mystate4 mystate2))) (and (and (= result (is_full (mk___rep s__split_discrs (mk___split_fields s__split_fields (mk___t s__split_fields1 s__split_fields2) s__split_fields3) s__attr__tag))) (= (= result true) (= (size (mk___rep s__split_discrs (mk___split_fields s__split_fields (mk___t s__split_fields1 s__split_fields2) s__split_fields3) s__attr__tag)) (to_rep3 (rec__stacks__stack__max s__split_discrs))))) (and (= result true) (in_range2 mystate2)))) (and (and (and (= result (is_full (mk___rep s__split_discrs (mk___split_fields s__split_fields (mk___t s__split_fields1 s__split_fields2) s__split_fields3) s__attr__tag))) (= (= result true) (= (size (mk___rep s__split_discrs (mk___split_fields s__split_fields (mk___t s__split_fields1 s__split_fields2) s__split_fields3) s__attr__tag)) (to_rep3 (rec__stacks__stack__max s__split_discrs))))) (and (not (= result true)) (and (= mystate2 mystate) (= mystate2 mystate1)))) (and (and (and (= s__split_fields10 (mk___split_fields__ref s__split_fields9)) (= mystate3 (mk_int__ref mystate2))) (and (= s__split_fields11 s__split_fields9) (= mystate4 mystate2))) (and (and (and (and (and (and (= o (+ (to_rep s__split_fields) 1)) (in_range (+ (to_rep s__split_fields) 1))) (= (to_rep o1) o)) (and (= o1 o2) (and (and (= s__split_fields1 o3) (= s__split_fields2 o4)) (= s__split_fields3 o5)))) (and (= s__split_discrs (mk___split_discrs temp___237)) (and (and (= temp___2371 o2) (and (and (= temp___2372 o3) (= temp___2373 o4)) (= temp___2374 o5))) (= s__attr__tag temp___2375)))) (and (and (= (mk___split_fields__ref (mk___split_fields result1 (mk___t result2 result3) result4)) s__split_fields14) (= s__split_fields8 (mk___split_fields temp___2371 (mk___t temp___2372 temp___2373) temp___2374))) (= s__split_discrs (mk___split_discrs temp___237)))) (and (and (and (and (and (= (to_rep1 o6) e) (and (and (and (<= (to_rep2 (first (rt (rec__stacks__stack__data s__split_fields8)))) (to_rep (rec__stacks__stack__top s__split_fields8))) (<= (to_rep (rec__stacks__stack__top s__split_fields8)) (to_rep2 (last (rt (rec__stacks__stack__data s__split_fields8)))))) (= o7 (to_rep (rec__stacks__stack__top s__split_fields8)))) (= o8 (store (elts (rec__stacks__stack__data s__split_fields8)) o7 o6)))) (and (= o8 o9) (= (rt (rec__stacks__stack__data s__split_fields8)) o10))) (and (= (rec__stacks__stack__top s__split_fields8) o11) (and (and (= o12 o9) (= o13 o10)) (= (rec__ext__ s__split_fields8) o14)))) (and (= s__split_discrs (mk___split_discrs temp___241)) (and (and (= temp___2411 o11) (and (and (= temp___2412 o12) (= temp___2413 o13)) (= temp___2414 o14))) (= s__attr__tag temp___2415)))) (and (and (= result5 (mk___split_fields__ref s__split_fields8)) (= s__split_fields9 (mk___split_fields temp___2411 (mk___t temp___2412 temp___2413) temp___2414))) (= s__split_discrs (mk___split_discrs temp___241)))))))))
...
(assert (not (= (size (mk___rep s__split_discrs (us_split_fields__content s__split_fields12) s__attr__tag)) (+ (size (mk___rep s__split_discrs (mk___split_fields s__split_fields (mk___t s__split_fields1 s__split_fields2) s__split_fields3) s__attr__tag)) 1))))
(check-sat)
(exit)
