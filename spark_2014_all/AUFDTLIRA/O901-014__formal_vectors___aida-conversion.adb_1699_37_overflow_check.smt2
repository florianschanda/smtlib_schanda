...
(assert (= o14 (ite (<= index1 o13) true false)))
(assert (and (= o12 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (= o15 (ite (<= o12 index1) true false)))
(assert (= result (ite (= o15 true) o14 false)))
(assert (= (= o16 true) (forall ((index11 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 3) index11) (<= index11 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index11))) true)))))
(assert (and (= temp___2091 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 (first (rt source))) temp___2091) (<= temp___2091 (to_rep1 (last (rt source))))))
(assert (= o8 temp___2091))
(assert (= o9 (select (elts source) o8)))
(assert (= o10 (to_rep o9)))
(assert (= o11 (ite (< o10 52) true false)))
(assert (and (= temp___2090 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 (first (rt source))) temp___2090) (<= temp___2090 (to_rep1 (last (rt source))))))
