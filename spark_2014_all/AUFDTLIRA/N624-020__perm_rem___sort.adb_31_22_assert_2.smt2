...
(assert (= values2 o12))
(assert (not (= (let ((temp___245 (remove (mk___t values2 (mk 1 100)) y))) (let ((temp___244 (remove (mk___t interm1 (mk 1 100)) y))) (bool_eq (elts temp___244) (to_rep1 (first (rt temp___244))) (to_rep1 (last (rt temp___244))) (elts temp___245) (to_rep1 (first (rt temp___245))) (to_rep1 (last (rt temp___245)))))) true)))
(check-sat)
(exit)
