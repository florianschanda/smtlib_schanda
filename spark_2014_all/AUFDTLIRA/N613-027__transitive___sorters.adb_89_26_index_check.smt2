...
(assert (and (= o6 (index_of_minimum (mk___t o4 o5))) (and (in_range2 o6) (and (and (<= (to_rep (first o5)) o6) (<= o6 (to_rep (last o5)))) (forall ((j1 Int)) (=> (and (<= (to_rep (first o5)) j1) (<= j1 (to_rep (last o5)))) (<= (to_rep (select o4 o6)) (to_rep (select o4 j1)))))))))
(assert (= (mk_int__ref result2) (mk_int__ref smallest)))
(assert (= smallest1 o6))
(assert (=> (not (= smallest1 current1)) (and (= o7 current1) (in_range2 current1))))
(assert (=> (not (= smallest1 current1)) (and (= (perm (mk___t values (mk (to_rep values__first) (to_rep values__last))) (mk___t values2 (mk (to_rep values__first) (to_rep values__last)))) true) (and (= (to_rep (select values2 o7)) (to_rep (select values smallest1))) (and (= (to_rep (select values2 smallest1)) (to_rep (select values o7))) (forall ((j1 Int)) (=> (and (<= (to_rep values__first) j1) (<= j1 (to_rep values__last))) (=> (and (not (= j1 o7)) (not (= j1 smallest1))) (= (to_rep (select values2 j1)) (to_rep (select values j1)))))))))))
...
(assert (forall ((j1 Int)) (=> (and (<= current2 j1) (<= j1 (to_rep values__last))) (<= (to_rep (select values3 current2)) (to_rep (select values3 j1))))))
(assert (forall ((j1 Int)) (=> (and (<= (to_rep values__first) j1) (<= j1 current2)) (<= (to_rep (select values3 j1)) (to_rep (select values3 (+ j1 1)))))))
