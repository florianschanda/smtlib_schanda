...
(declare-datatypes () ((t29b__ref (mk_t29b__ref (t29b__content us_t2)))))
(define-fun t29b__ref___projection ((a t29b__ref)) us_t2 (t29b__content a))
...
(declare-const temp___196 (Array Int integer))
...
(assert (and (<= (to_rep values__first) j) (<= j (to_rep values__last))))
(assert (= o8 j))
(assert (= o9 (select values3 o8)))
(assert (= o10 (to_rep o9)))
(assert (not (<= (to_rep values__first) current2)))
(check-sat)
(exit)
