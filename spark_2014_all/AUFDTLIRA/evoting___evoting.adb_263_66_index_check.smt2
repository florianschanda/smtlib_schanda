...
(assert (=> (and (<= 2 i2) (<= i2 last_candidate)) (=> (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i3))) (=> (and (<= 0 j4) (<= j4 (- i3 1))) (= temp___706 winners3)))))
(assert (=> (and (<= 2 i2) (<= i2 last_candidate)) (=> (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i3))) (=> (and (<= 0 j4) (<= j4 (- i3 1))) (= temp___705 j4)))))
...
(assert (=> (and (<= 2 i2) (<= i2 last_candidate)) (=> (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i3))) (=> (and (<= 0 j4) (<= j4 (- i3 1))) (and (and (=> (<= 0 (- i3 1)) (dynamic_property1 0 (- i3 1) j5)) (forall ((temp___707 Int)) (=> (and (<= 0 temp___707) (<= temp___707 20)) (=> (<= j5 temp___707) (= (select winners4 temp___707) (select temp___706 temp___707)))))) (and (<= 0 j5) (<= j5 (- i3 1))))))))
...
(assert (=> (and (<= 2 i2) (<= i2 last_candidate)) (=> (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i3))) (=> (and (<= 0 j4) (<= j4 (- i3 1))) (= o1 (store winners4 o (of_int 0)))))))
