...
(assert (not (<= (to_rep1 (first2 (rt1 (rec__static_discr__i_holder__content1 (us_split_fields3 (rec__static_discr__holder__content (us_split_fields5 a))))))) (int__content static_discr__search__result4))))
(check-sat)
(exit)
