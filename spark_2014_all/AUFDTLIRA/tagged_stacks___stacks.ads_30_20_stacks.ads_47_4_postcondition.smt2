...
(declare-const temp___523 (Array Int element))
(declare-const temp___5231 less_than_max)
(declare-const temp___5232 us_private)
(declare-const temp___5233 Int)
...
(assert (and (<= 1 (to_rep s__split_fields1)) (<= (to_rep s__split_fields1) 100)))
...
(assert (= e1 o2))
(assert (and (= o3 (- (to_rep s__split_fields1) 1)) (in_range (- (to_rep s__split_fields1) 1))))
(assert (= (to_rep o4) o3))
(assert (= s__split_fields o5))
(assert (= o4 o6))
(assert (= s__split_fields2 o7))
(assert (= temp___523 o5))
(assert (= temp___5231 o6))
(assert (= temp___5232 o7))
(assert (= s__attr__tag temp___5233))
(assert (= result1 s__split_fields))
(assert (= result2 s__split_fields1))
(assert (= result3 s__split_fields2))
(assert (= temp___523 s__split_fields3))
(assert (= temp___5231 s__split_fields4))
(assert (= temp___5232 s__split_fields5))
(assert (= e1 e2))
...
(assert (not (= e2 (peek__2 (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag)))))
(check-sat)
(exit)
