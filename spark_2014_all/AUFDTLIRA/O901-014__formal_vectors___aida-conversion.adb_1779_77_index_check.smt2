...
(assert (and (= o28 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (= o29 (ite (<= o28 j) true false)))
(assert (= result6 (ite (= o29 true) (ite (<= j index3) true false) false)))
(assert (= result6 true))
(assert (and (<= (to_rep1 int_array__first) j) (<= j (to_rep1 int_array__last))))
(assert (= o30 j))
(assert (= o31 (select int_array1 o30)))
