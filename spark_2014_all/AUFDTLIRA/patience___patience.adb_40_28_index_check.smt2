...
(assert (=> (= result9 true) (= result8 (ite (< o31 (to_rep1 s__split_fields2)) true false))))
...
(assert (=> (= result7 true) (= temp___574 (to_rep1 o21))))
...
(assert (=> (= result6 true) (= temp___577 (to_rep1 o11))))
...
(assert (=> (= result6 true) (= temp___580 (to_rep1 o14))))
