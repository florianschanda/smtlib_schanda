...
(assert (=> (= result9 true) (and (<= 0 topstacki3) (<= topstacki3 99))))
(assert (=> (= result9 true) (= o24 topstacki3)))
(assert (=> (= result9 true) (= o25 (select s__split_fields5 o24))))
(assert (=> (= result9 true) (= temp___547 (to_rep1 o25))))
(assert (=> (= result9 true) (and (<= 0 temp___547) (<= temp___547 99))))
(assert (=> (= result9 true) (= o26 temp___547)))
(assert (=> (= result9 true) (= temp___548 (select s__split_fields4 o26))))
(assert (=> (= result9 true) (and (<= 0 topstacki3) (<= topstacki3 99))))
(assert (=> (= result9 true) (= o27 topstacki3)))
(assert (=> (= result9 true) (= o28 (select s__split_fields6 o27))))
(assert (=> (= result9 true) (= temp___550 (to_rep1 o28))))
(assert (=> (= result9 true) (and (<= 0 temp___550) (<= temp___550 99))))
(assert (=> (= result9 true) (= o29 temp___550)))
(assert (=> (= result9 true) (= o30 (select temp___548 o29))))
(assert (=> (= result9 true) (= o31 (to_rep1 o30))))
(assert (=> (= result9 true) (= result8 (ite (= o31 topstacki3) true false))))
