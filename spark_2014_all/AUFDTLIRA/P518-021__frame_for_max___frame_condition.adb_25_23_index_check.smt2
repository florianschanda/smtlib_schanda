...
(assert (= o29 j))
(assert (= (mk___rep (mk___split_fields o30 o31 o32)) (select a3 o29)))
(assert (= o30 o33))
(assert (= o31 o34))
(assert (= o32 o35))
(assert (= o36 o34))
