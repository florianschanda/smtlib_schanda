...
(assert (= (int__content i14) (to_rep1 (rec__patience__state__numstacks s__split_fields10))))
(assert (= result19 i14))
(assert (= i16 (to_rep1 (rec__patience__state__numstacks s__split_fields10))))
(assert (and (= o84 (+ (to_rep1 (rec__patience__state__numstacks s__split_fields10)) 1)) (in_range3 (+ (to_rep1 (rec__patience__state__numstacks s__split_fields10)) 1))))
(assert (= (to_rep1 o85) o84))
(assert (= (rec__patience__state__numelts s__split_fields10) o86))
(assert (= (rec__patience__state__values s__split_fields10) o87))
(assert (= o85 o88))
(assert (= (rec__patience__state__stacksizes s__split_fields10) o89))
(assert (= (rec__patience__state__stacks s__split_fields10) o90))
(assert (= (rec__patience__state__posstack s__split_fields10) o91))
(assert (= (rec__patience__state__posheight s__split_fields10) o92))
(assert (= (rec__patience__state__preds s__split_fields10) o93))
(assert (= temp___606 o86))
(assert (= temp___6061 o87))
(assert (= temp___6062 o88))
(assert (= temp___6063 o89))
(assert (= temp___6064 o90))
(assert (= temp___6065 o91))
(assert (= temp___6066 o92))
(assert (= temp___6067 o93))
(assert (= result20 (mk___split_fields__ref s__split_fields10)))
(assert (= s__split_fields11 (mk___split_fields temp___606 temp___6061 temp___6062 temp___6063 temp___6064 temp___6065 temp___6066 temp___6067)))
(assert (= (to_rep1 o94) 1))
(assert (and (<= 0 i16) (<= i16 99)))
(assert (= o95 i16))
(assert (= o96 (store (rec__patience__state__stacksizes s__split_fields11) o95 o94)))
(assert (= (rec__patience__state__numelts s__split_fields11) o97))
(assert (= (rec__patience__state__values s__split_fields11) o98))
(assert (= (rec__patience__state__numstacks s__split_fields11) o99))
(assert (= o96 o100))
(assert (= (rec__patience__state__stacks s__split_fields11) o101))
(assert (= (rec__patience__state__posstack s__split_fields11) o102))
(assert (= (rec__patience__state__posheight s__split_fields11) o103))
(assert (= (rec__patience__state__preds s__split_fields11) o104))
(assert (= temp___609 o97))
(assert (= temp___6091 o98))
(assert (= temp___6092 o99))
(assert (= temp___6093 o100))
(assert (= temp___6094 o101))
(assert (= temp___6095 o102))
(assert (= temp___6096 o103))
(assert (= temp___6097 o104))
(assert (= result21 (mk___split_fields__ref s__split_fields11)))
(assert (= s__split_fields12 (mk___split_fields temp___609 temp___6091 temp___6092 temp___6093 temp___6094 temp___6095 temp___6096 temp___6097)))
(assert (and (= o105 idx1) (in_range3 idx1)))
(assert (= (to_rep1 o106) o105))
(assert (= o107 (store (select (rec__patience__state__stacks s__split_fields12) i16) 0 o106)))
(assert (and (<= 0 i16) (<= i16 99)))
(assert (= o108 i16))
(assert (= o109 (store (rec__patience__state__stacks s__split_fields12) o108 o107)))
(assert (= o110 (mk___split_fields (rec__patience__state__numelts s__split_fields12) (rec__patience__state__values s__split_fields12) (rec__patience__state__numstacks s__split_fields12) (rec__patience__state__stacksizes s__split_fields12) o109 (rec__patience__state__posstack s__split_fields12) (rec__patience__state__posheight s__split_fields12) (rec__patience__state__preds s__split_fields12))))
(assert (= temp___614 (mk___rep o110)))
(assert (= result22 (mk___split_fields__ref s__split_fields12)))
(assert (= s__split_fields13 (us_split_fields1 temp___614)))
(assert (and (= o111 i16) (in_range3 i16)))
(assert (= (to_rep1 o112) o111))
(assert (not (<= 0 idx1)))
(check-sat)
(exit)
