...
(assert (=> (< i1 (to_rep1 s__split_fields2)) (= temp___535 (select s__split_fields4 o3))))
...
(assert (=> (< i1 (to_rep1 s__split_fields2)) (= o5 (select temp___535 o4))))
...
(assert (= o56 i10))
(assert (= o57 (store (rec__patience__state__stacksizes s__split_fields11) o56 o55)))
(assert (= (rec__patience__state__numelts s__split_fields11) o58))
(assert (= (rec__patience__state__values s__split_fields11) o59))
(assert (= (rec__patience__state__numstacks s__split_fields11) o60))
(assert (= o57 o61))
(assert (= (rec__patience__state__stacks s__split_fields11) o62))
(assert (= (rec__patience__state__posstack s__split_fields11) o63))
(assert (= (rec__patience__state__posheight s__split_fields11) o64))
(assert (= (rec__patience__state__preds s__split_fields11) o65))
(assert (= temp___609 o58))
(assert (= temp___6091 o59))
(assert (= temp___6092 o60))
(assert (= temp___6093 o61))
(assert (= temp___6094 o62))
(assert (= temp___6095 o63))
(assert (= temp___6096 o64))
(assert (= temp___6097 o65))
