...
(assert (and (and (forall ((temp___177 Int)) (=> (and (<= 1 temp___177) (<= temp___177 8)) (=> (<= j2 temp___177) (= (select r2 temp___177) (select r1 temp___177))))) (=> (<= 1 i) (dynamic_property 1 i j2))) (and (<= 1 j2) (<= j2 i))))
(assert (<= 1 k))
(assert (<= k (- j2 1)))
(assert (and (<= 1 k) (<= k 8)))
(assert (= o k))
