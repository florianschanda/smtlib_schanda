...
(assert (forall ((temp___198 Int)) (=> (dynamic_invariant temp___198 true true true true) (forall ((temp___199 Int)) (= (to_rep (select (queen__copy_until__r__aggregate_def temp___198) temp___199)) temp___198)))))
...
(assert (and (and (forall ((temp___201 Int)) (=> (and (<= 1 temp___201) (<= temp___201 8)) (=> (<= j2 temp___201) (= (select r2 temp___201) (select r1 temp___201))))) (=> (<= 1 i) (dynamic_property 1 i j2))) (and (<= 1 j2) (<= j2 i))))
(assert (<= 1 k))
(assert (<= k (- j2 1)))
(assert (and (<= 1 k) (<= k 8)))
(assert (= o k))
