...
(assert (<= 1 j3))
(assert (<= j3 i))
(assert (forall ((k2 Int)) (=> (and (<= 1 k2) (<= k2 (- j4 1))) (= (to_rep (select r2 k2)) (to_rep (select b k2))))))
(assert (and (and (forall ((temp___177 Int)) (=> (and (<= 1 temp___177) (<= temp___177 8)) (=> (<= j4 temp___177) (= (select r2 temp___177) (select r1 temp___177))))) (=> (<= 1 i) (dynamic_property 1 i j4))) (and (<= 1 j4) (<= j4 i))))
(assert (<= 1 k))
(assert (<= k (- j4 1)))
(assert (and (<= 1 k) (<= k 8)))
(assert (= o k))
