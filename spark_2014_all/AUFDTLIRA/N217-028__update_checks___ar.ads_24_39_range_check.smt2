...
(define-fun dynamic_invariant ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= 1 10)) (in_range1 temp___expr_142)))
(declare-sort et1 0)
...
(define-fun dynamic_invariant1 ((temp___expr_148 Int) (temp___is_init_145 Bool) (temp___skip_constant_146 Bool) (temp___do_toplevel_147 Bool)) Bool (=> (or (= temp___is_init_145 true) (<= 0 99)) (in_range2 temp___expr_148)))
...
(declare-fun temp___188 ((Array Int et1) Int Int Int Int Int Int) (Array Int et1))
(assert (forall ((temp___190 (Array Int et1))) (forall ((temp___191 Int) (temp___192 Int) (temp___193 Int) (temp___194 Int) (temp___195 Int) (temp___196 Int)) (let ((temp___189 (temp___188 temp___190 temp___191 temp___192 temp___193 temp___194 temp___195 temp___196))) (forall ((temp___197 Int)) (ite (= temp___197 temp___195) (= (select temp___189 temp___197) (of_rep temp___196)) (ite (or (= temp___197 temp___191) (and (<= temp___192 temp___197) (<= temp___197 temp___193))) (= (select temp___189 temp___197) (of_rep temp___194)) (= (select temp___189 temp___197) (select temp___190 temp___197)))))))))
(declare-fun temp___216 ((Array Int et1) Int Int Int Int Int Int) (Array Int et1))
(assert (forall ((temp___218 (Array Int et1))) (forall ((temp___219 Int) (temp___220 Int) (temp___221 Int) (temp___222 Int) (temp___223 Int) (temp___224 Int)) (let ((temp___217 (temp___216 temp___218 temp___219 temp___220 temp___221 temp___222 temp___223 temp___224))) (forall ((temp___225 Int)) (ite (= temp___225 temp___223) (= (select temp___217 temp___225) (of_rep temp___224)) (ite (or (= temp___225 temp___219) (and (<= temp___220 temp___225) (<= temp___225 temp___221))) (= (select temp___217 temp___225) (of_rep temp___222)) (= (select temp___217 temp___225) (select temp___218 temp___225)))))))))
...
(assert (=> (and (< 1 i) (and (< j 0) (< 0 e))) (= o5 (temp___216 a o4 i o3 o2 o1 o))))
