...
(define-fun dynamic_property3 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range1 low) (and (in_range1 high) (=> (<= low high) (and (in_range5 low) (in_range5 high))))))
...
(assert (forall ((s us_rep1)) (! (dynamic_invariant4 (last4 s) true false true true) :pattern ((last4 s)))))
(assert (forall ((attr__tag2 Int)) (forall ((s us_rep1)) (! (dynamic_invariant4 (last5 attr__tag2 s) true false true true) :pattern ((last5 attr__tag2 s))))))
...
(assert (=> (<= (to_rep (first (rt (get_model (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag))))) (to_rep (last (rt (get_model (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag)))))) (= o (+ (- (to_rep (last (rt (get_model (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag))))) (to_rep (first (rt (get_model (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag)))))) 1))))
(assert (=> (not (<= (to_rep (first (rt (get_model (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag))))) (to_rep (last (rt (get_model (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag))))))) (= o 0)))
(assert (= o1 (+ o 1)))
(assert (= o2 (+ (to_rep (first (rt (get_model (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag))))) o1)))
(assert (= o3 (- o2 1)))
