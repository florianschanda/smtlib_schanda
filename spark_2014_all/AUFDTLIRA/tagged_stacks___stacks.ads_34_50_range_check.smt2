...
(assert (forall ((x less_than_max)) (! (in_range2 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun dynamic_property ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range3 low) (and (in_range3 high) (=> (<= low high) (and (in_range low) (in_range high))))))
...
(assert (forall ((s us_rep)) (! (let ((result (get_model s))) (and (and (in_range2 (first1 result)) (and (in_range2 (last1 result)) (= (length result) (size s)))) (dynamic_invariant1 result true false true true))) :pattern ((get_model s)))))
(assert (forall ((attr__tag2 Int)) (forall ((s us_rep)) (! (let ((result (get_model1 attr__tag2 s))) (and (and (in_range2 (first1 result)) (and (in_range2 (last1 result)) (= (length result) (size s)))) (dynamic_invariant1 result true false true true))) :pattern ((get_model1 attr__tag2 s))))))
...
(define-fun dynamic_invariant4 ((temp___expr_159 Int) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool) (temp___do_typ_inv_158 Bool)) Bool (=> (or (= temp___is_init_155 true) (<= 0 100)) (in_range2 temp___expr_159)))
...
(assert (forall ((s us_rep)) (! (let ((result (get_model__2 s))) (and (and (= (length result) (size s)) (and (in_range2 (last1 result)) (in_range2 (first1 result)))) (dynamic_invariant1 result true false true true))) :pattern ((get_model__2 s)))))
(assert (forall ((attr__tag2 Int)) (forall ((s us_rep)) (! (let ((result (get_model__21 attr__tag2 s))) (and (and (= (length result) (size s)) (and (in_range2 (last1 result)) (in_range2 (first1 result)))) (dynamic_invariant1 result true false true true))) :pattern ((get_model__21 attr__tag2 s))))))
...
(assert (forall ((s us_rep)) (! (= (get_model__2 s) (let ((temp___310 (let ((temp___308 (to_rep1 (rec__stacks__stack_root__length (us_split_fields1 s))))) (let ((temp___307 1)) (let ((temp___309 (rec__stacks__stack_root__content (us_split_fields1 s)))) (of_array1 temp___309 temp___307 temp___308)))))) (of_array (to_array1 temp___310) (first3 temp___310) (last3 temp___310)))) :pattern ((get_model__2 s)))))
(declare-sort telement_arrayD1 0)
(define-fun in_range5 ((x Int)) Bool (and (<= 1 x) (<= x 100)))
(declare-fun attr__ATTRIBUTE_IMAGE6 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check6 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE6 (us_image) Int)
(declare-fun user_eq12 (telement_arrayD1 telement_arrayD1) Bool)
(declare-const dummy12 telement_arrayD1)
...
(define-fun dynamic_property3 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range3 low) (and (in_range3 high) (=> (<= low high) (and (in_range5 low) (in_range5 high))))))
...
(assert (=> (<= (to_rep2 (first (rt (get_model (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag))))) (to_rep2 (last (rt (get_model (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag)))))) (= o (+ (- (to_rep2 (last (rt (get_model (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag))))) (to_rep2 (first (rt (get_model (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag)))))) 1))))
(assert (=> (not (<= (to_rep2 (first (rt (get_model (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag))))) (to_rep2 (last (rt (get_model (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag))))))) (= o 0)))
(assert (= o1 (+ o 1)))
(assert (= o2 (+ (to_rep2 (first (rt (get_model (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag))))) o1)))
(assert (= o3 (- o2 1)))
