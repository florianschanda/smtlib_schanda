...
(assert (<= 1 i10))
(assert (<= i10 100))
(assert (and (= temp___703 (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)))) (and (dynamic_invariant5 temp___703 true false true) (= temp___703 (model__1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)))) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 c106b))))))))))
(assert (= o352 (select temp___703 i10)))
(assert (= o353 (us_split_fields1 o352)))
(assert (= result85 (rec__tree_model__path_type__k o353)))
(assert (=> (= result85 true) (and (= temp___704 (nb_blacks c106b)) (and (= (bool_eq11 (select temp___704 0) (mk___rep5 (mk___split_fields5 (of_int 1) (of_rep 0) (of_rep 0)))) true) (forall ((i14 Int)) (=> (and (<= 1 i14) (<= i14 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c106b))) i14))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___704 i14))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___704 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___704 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i14 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___704 i14)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___704 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___704 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i14 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___704 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i14 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___704 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i14 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___704 i14)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c106b)) i14)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___704 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i14 0)))))))))))))))
(assert (=> (= result85 true) (= o348 (select temp___704 i10))))
(assert (=> (= result85 true) (= o349 (us_split_fields11 o348))))
(assert (=> (= result85 true) (= o350 (rec__red_black_trees__black_count__depth o349))))
(assert (=> (= result85 true) (= o351 (to_rep o350))))
(assert (=> (= result85 true) (= o354 (ite (< o351 (let ((subject n7)) n110)) true false))))
(assert (=> (not (= result85 true)) (= o354 false)))
(assert (= o355 (ite (and (= o354 true) (not (= i10 y3))) true false)))
(assert (= result84 (ite (and (= o355 true) (not (= i10 c108b))) true false)))
(assert (= result84 true))
(assert (and (= temp___702 (nb_blacks c106b)) (and (= (bool_eq11 (select temp___702 0) (mk___rep5 (mk___split_fields5 (of_int 1) (of_rep 0) (of_rep 0)))) true) (forall ((i14 Int)) (=> (and (<= 1 i14) (<= i14 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c106b))) i14))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___702 i14))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___702 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___702 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i14 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___702 i14)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___702 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___702 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i14 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___702 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i14 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___702 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i14 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___702 i14)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c106b)) i14)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___702 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i14 0))))))))))))))
(assert (= o356 (select temp___702 i10)))
