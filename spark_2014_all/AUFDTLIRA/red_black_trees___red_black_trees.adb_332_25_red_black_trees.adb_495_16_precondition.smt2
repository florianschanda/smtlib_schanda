...
(declare-const temp___752 (Array Int us_rep1))
(declare-const o54 us_rep1)
(declare-const o55 us_split_fields)
(declare-const o56 Bool)
(declare-const o57 Bool)
(declare-const temp___751 (Array Int us_rep7))
(declare-const o58 us_rep7)
...
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (and (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c106b))) i1))) true) (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c106b) i1)))) (let ((subject n1)) n12))) (not (= i1 y3))) (not (= i1 c108b))) (= (eq (select (nb_blacks c107b) i1) (select (nb_blacks c106b) i1)) true)))))
...
(assert (<= 1 i))
(assert (<= i 100))
(assert (and (= temp___752 (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)))) (and (dynamic_invariant5 temp___752 true false true true) (= temp___752 (model__1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)))) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 c106b))))))))))
(assert (= o54 (select temp___752 i)))
(assert (= o55 (us_split_fields1 o54)))
(assert (= result18 (rec__tree_model__path_type__k o55)))
(assert (=> (= result18 true) (and (= temp___753 (nb_blacks c106b)) (and (= (bool_eq11 (select temp___753 0) (mk___rep5 (mk___split_fields5 (distinct 1 0) (of_rep 0) (of_rep 0)))) true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c106b))) i1))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___753 i1))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___753 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i1 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___753 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i1 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___753 i1)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___753 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i1 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___753 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i1 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___753 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i1 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___753 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i1 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___753 i1)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c106b)) i1)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___753 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i1 0)))))))))))))))
(assert (=> (= result18 true) (= o50 (select temp___753 i))))
(assert (=> (= result18 true) (= o51 (us_split_fields11 o50))))
(assert (=> (= result18 true) (= o52 (rec__red_black_trees__black_count__depth o51))))
(assert (=> (= result18 true) (= o53 (to_rep o52))))
(assert (=> (= result18 true) (= o56 (ite (< o53 (let ((subject n1)) n12)) true false))))
(assert (=> (not (= result18 true)) (= o56 false)))
(assert (= o57 (ite (and (= o56 true) (not (= i y3))) true false)))
(assert (= result17 (ite (and (= o57 true) (not (= i c108b))) true false)))
(assert (= result17 true))
(assert (and (= temp___751 (nb_blacks c106b)) (and (= (bool_eq11 (select temp___751 0) (mk___rep5 (mk___split_fields5 (distinct 1 0) (of_rep 0) (of_rep 0)))) true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c106b))) i1))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___751 i1))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___751 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i1 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___751 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i1 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___751 i1)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___751 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i1 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___751 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i1 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___751 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i1 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___751 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i1 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___751 i1)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c106b)) i1)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___751 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i1 0))))))))))))))
(assert (= o58 (select temp___751 i)))
