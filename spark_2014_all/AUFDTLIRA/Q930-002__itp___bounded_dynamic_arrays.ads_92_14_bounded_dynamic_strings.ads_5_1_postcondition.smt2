...
(define-fun o14 () us_rep (mk___rep (mk___split_discrs o10) (mk___split_fields o11 (mk___t1 o12 o13))))
(define-fun o15 () us_t2 (mk___t2 o8 o9))
...
(assert (and (= o14 (instance o1 o15)) (and (dynamic_invariant1 o14 true false true true) (and (and (= (to_rep2 o10) o1) (= (length2 o14) (length3 o15))) (= (let ((temp___274 (value o14))) (bool_eq (elts2 temp___274) (to_rep1 (first4 (rt2 temp___274))) (to_rep1 (last4 (rt2 temp___274))) o8 (to_rep1 (first4 o9)) (to_rep1 (last4 o9)))) true)))))
...
(assert (= bounded_dynamic_strings__Oconcat__2__result12 o14))
...
(assert (= (mk___rep (mk___split_discrs result4) (mk___split_fields result5 (mk___t1 result6 result7))) (sequence__content bounded_dynamic_strings__Oconcat__2__result10)))
(assert (not (= (length2 (sequence__content bounded_dynamic_strings__Oconcat__2__result10)) (+ (length2 left) (length3 right)))))
(check-sat)
(exit)
