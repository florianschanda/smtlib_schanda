...
(declare-const i Int)
(declare-const temp___225 (Array Int natural))
...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 100)) (= temp___225 c)))
(assert (=> (and (<= 1 i1) (<= i1 100)) (= temp___224 i1)))
(assert (=> (and (<= 1 i1) (<= i1 100)) (=> (= (to_rep (select c i1)) 0) (= (mk_map__ref result1) c11))))
(assert (=> (and (<= 1 i1) (<= i1 100)) (=> (= (to_rep (select c i1)) 0) (= c2 (store c i1 rliteral)))))
...
(assert (=> (and (<= 1 i1) (<= i1 100)) (and (and (=> (<= 1 100) (in_range3 i2)) (forall ((temp___226 Int)) (=> (and (<= 1 temp___226) (<= temp___226 100)) (=> (or (< 100 temp___226) (or (< temp___226 1) (< i2 temp___226))) (= (select c3 temp___226) (select temp___225 temp___226)))))) (and (<= 1 i2) (<= i2 100)))))
...
(assert (= i8 i6))
(assert (= c9 c7))
(define-fun temp___234 () (Array Int natural) (get_model c8))
(declare-const temp___233 Int)
(assert (in_range1 temp___233))
(assert (= (m_has_element temp___234 temp___233) true))
(assert (not (= (valid (m_element temp___234 temp___233)) true)))
(check-sat)
(exit)
