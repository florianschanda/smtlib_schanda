...
(declare-const i Int)
(declare-const temp___223 (Array Int natural))
...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 100)) (= temp___223 c)))
(assert (=> (and (<= 1 i1) (<= i1 100)) (= temp___222 i1)))
...
(assert (=> (and (<= 1 i1) (<= i1 100)) (and (and (=> (<= 1 100) (in_range3 i2)) (forall ((temp___224 Int)) (=> (and (<= 1 temp___224) (<= temp___224 100)) (=> (< i2 temp___224) (= (select c3 temp___224) (select temp___223 temp___224)))))) (and (<= 1 i2) (<= i2 100)))))
