...
(assert (=> (and (<= 1 i1) (<= i1 100)) (and (and (=> (<= 1 100) (in_range3 i2)) (forall ((temp___198 Int)) (=> (and (<= 1 temp___198) (<= temp___198 100)) (=> (< i2 temp___198) (= (select c3 temp___198) (select temp___197 temp___198)))))) (and (<= 1 i2) (<= i2 100)))))
...
(assert (not (= (valid (m_element temp___208 temp___207)) true)))
(check-sat)
(exit)
