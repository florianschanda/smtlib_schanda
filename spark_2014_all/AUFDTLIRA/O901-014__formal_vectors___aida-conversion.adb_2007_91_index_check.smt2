...
(assert (and (and (forall ((temp___2379 Int)) (=> (and (<= (to_rep1 n__first) temp___2379) (<= temp___2379 (to_rep1 n__last))) (=> (< index2 temp___2379) (= (select n3 temp___2379) (select n1 temp___2379))))) (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 7)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 7) index2))) (and (<= (+ (to_rep1 (first (rt source))) 1) index2) (<= index2 (+ (to_rep1 (first (rt source))) 7)))))
