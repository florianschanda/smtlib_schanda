...
(declare-fun temp___179 (Int) (Array Int integer))
(assert (forall ((temp___181 Int)) (forall ((temp___182 Int)) (= (select (temp___179 temp___181) temp___182) (of_rep temp___181)))))
...
(declare-const result12 (Array Int integer))
