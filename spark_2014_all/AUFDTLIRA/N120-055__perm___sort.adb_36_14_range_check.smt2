...
(assert (=> (and (<= (to_rep1 (first (rt values))) index2) (<= index2 (to_rep1 (last (rt values))))) (= temp___182 min1)))
(assert (=> (and (<= (to_rep1 (first (rt values))) index2) (<= index2 (to_rep1 (last (rt values))))) (= temp___181 index2)))
(assert (=> (and (<= (to_rep1 (first (rt values))) index2) (<= index2 (to_rep1 (last (rt values))))) (and (<= (to_rep1 (first (rt values))) min2) (<= min2 (to_rep1 (last (rt values)))))))
(assert (=> (and (<= (to_rep1 (first (rt values))) index2) (<= index2 (to_rep1 (last (rt values))))) (and (and (=> (<= (to_rep1 (first (rt values))) (to_rep1 (last (rt values)))) (dynamic_property1 (to_rep1 (first (rt values))) (to_rep1 (last (rt values))) index3)) (=> (<= 1 2147483647) (in_range2 min2))) (and (<= (to_rep1 (first (rt values))) index3) (<= index3 (to_rep1 (last (rt values))))))))
(assert (=> (and (<= (to_rep1 (first (rt values))) index2) (<= index2 (to_rep1 (last (rt values))))) (and (<= (to_rep1 (first (rt values))) min2) (<= min2 (to_rep1 (last (rt values)))))))
(assert (=> (and (<= (to_rep1 (first (rt values))) index2) (<= index2 (to_rep1 (last (rt values))))) (= o1 min2)))
...
(assert (=> (and (<= (to_rep1 (first (rt values))) index2) (<= index2 (to_rep1 (last (rt values))))) (= result2 (ite (< (to_rep (select (elts values) index3)) o3) true false))))
(assert (=> (and (<= (to_rep1 (first (rt values))) index2) (<= index2 (to_rep1 (last (rt values))))) (=> (= result2 true) (and (= o4 index3) (in_range2 index3)))))
(assert (=> (and (<= (to_rep1 (first (rt values))) index2) (<= index2 (to_rep1 (last (rt values))))) (=> (= result2 true) (= min2 result3))))
(assert (=> (and (<= (to_rep1 (first (rt values))) index2) (<= index2 (to_rep1 (last (rt values))))) (=> (= result2 true) (= min3 o4))))
(assert (=> (and (<= (to_rep1 (first (rt values))) index2) (<= index2 (to_rep1 (last (rt values))))) (=> (not (= result2 true)) (= min3 min2))))
...
(assert (=> (and (<= (to_rep1 (first (rt values))) index2) (<= index2 (to_rep1 (last (rt values))))) (= (mk_int__ref index6) (mk_int__ref index4))))
(assert (=> (and (<= (to_rep1 (first (rt values))) index2) (<= index2 (to_rep1 (last (rt values))))) (= (mk_int__ref min6) (mk_int__ref min4))))
