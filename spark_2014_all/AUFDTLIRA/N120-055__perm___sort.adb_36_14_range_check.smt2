...
(assert (=> (and (<= (to_rep1 (first (rt values))) index2) (<= index2 (to_rep1 (last (rt values))))) (and (and (= temp___182 min1) (and (= temp___181 index2) (and (and (<= (to_rep1 (first (rt values))) min2) (<= min2 (to_rep1 (last (rt values))))) (and (and (and (=> (<= (to_rep1 (first (rt values))) (to_rep1 (last (rt values)))) (dynamic_property1 (to_rep1 (first (rt values))) (to_rep1 (last (rt values))) index3)) (=> (<= 1 2147483647) (in_range2 min2))) (and (<= (to_rep1 (first (rt values))) index3) (<= index3 (to_rep1 (last (rt values)))))) (and (and (and (and (and (and (and (<= (to_rep1 (first (rt values))) min2) (<= min2 (to_rep1 (last (rt values))))) (= o1 min2)) (= o2 (select (elts values) o1))) (= o3 (to_rep o2))) (= result2 (ite (< (to_rep (select (elts values) index3)) o3) true false))) (ite (= result2 true) (and (and (= o4 index3) (in_range2 index3)) (and (= min2 result3) (= min3 o4))) (= min3 min2))) (= index3 (to_rep1 (last (rt values))))))))) (and (and (= index3 index7) (= min3 min6)) (and (= index8 index3) (= min7 min3))))))
(assert (=> (and (<= (to_rep1 (first (rt values))) index2) (<= index2 (to_rep1 (last (rt values))))) (= (mk_int__ref index9) (mk_int__ref index7))))
(assert (=> (and (<= (to_rep1 (first (rt values))) index2) (<= index2 (to_rep1 (last (rt values))))) (= (mk_int__ref min8) (mk_int__ref min6))))
(assert (=> (and (<= (to_rep1 (first (rt values))) index2) (<= index2 (to_rep1 (last (rt values))))) (= index10 index8)))
(assert (=> (and (<= (to_rep1 (first (rt values))) index2) (<= index2 (to_rep1 (last (rt values))))) (= min9 min7)))
(assert (=> (not (and (<= (to_rep1 (first (rt values))) index2) (<= index2 (to_rep1 (last (rt values)))))) (= index2 index9)))
(assert (=> (not (and (<= (to_rep1 (first (rt values))) index2) (<= index2 (to_rep1 (last (rt values)))))) (= min1 min8)))
(assert (=> (not (and (<= (to_rep1 (first (rt values))) index2) (<= index2 (to_rep1 (last (rt values)))))) (= index10 index2)))
(assert (=> (not (and (<= (to_rep1 (first (rt values))) index2) (<= index2 (to_rep1 (last (rt values)))))) (= min9 min1)))
(assert (not (in_range4 min8)))
(check-sat)
(exit)
