...
(assert (and (= temp___229 (remove o26 o27)) (and (dynamic_invariant4 temp___229 true false true) (and (= (invariant__ temp___229) true) (and (= (to_rep1 (last (rt temp___229))) (- (to_rep1 (last (rt o26))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o27 1))) (= (to_rep (select (elts o26) k)) (to_rep (select (elts temp___229) k))))) (and (forall ((k Int)) (=> (and (<= (+ o27 1) k) (<= k (to_rep1 (last (rt o26))))) (= (to_rep (select (elts o26) k)) (to_rep (select (elts temp___229) (- k 1)))))) (forall ((k Int)) (=> (and (<= o27 k) (<= k (- (to_rep1 (last (rt o26))) 1))) (= (to_rep (select (elts o26) (+ k 1))) (to_rep (select (elts temp___229) k))))))))))))
(assert (and (= o30 (- y 1)) (in_range5 (- y 1))))
(assert (and (= o28 x) (in_range5 x)))
(assert (and (= o29 (remove (mk___t interm1 (mk 1 100)) o28)) (and (dynamic_invariant4 o29 true false true) (and (= (invariant__ o29) true) (and (= (to_rep1 (last (rt o29))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o28 1))) (= (to_rep (select interm1 k)) (to_rep (select (elts o29) k))))) (and (forall ((k Int)) (=> (and (<= (+ o28 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select interm1 k)) (to_rep (select (elts o29) (- k 1)))))) (forall ((k Int)) (=> (and (<= o28 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select interm1 (+ k 1))) (to_rep (select (elts o29) k))))))))))))
