...
(assert (and (= temp___229 (remove o134 o135)) (and (dynamic_invariant4 temp___229 true false true) (and (= (invariant__ temp___229) true) (and (= (to_rep1 (last (rt temp___229))) (- (to_rep1 (last (rt o134))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o135 1))) (= (to_rep (select (elts o134) k)) (to_rep (select (elts temp___229) k))))) (and (forall ((k Int)) (=> (and (<= (+ o135 1) k) (<= k (to_rep1 (last (rt o134))))) (= (to_rep (select (elts o134) k)) (to_rep (select (elts temp___229) (- k 1)))))) (forall ((k Int)) (=> (and (<= o135 k) (<= k (- (to_rep1 (last (rt o134))) 1))) (= (to_rep (select (elts o134) (+ k 1))) (to_rep (select (elts temp___229) k))))))))))))
(assert (and (= o138 (- y 1)) (in_range5 (- y 1))))
(assert (and (= o136 x) (in_range5 x)))
(assert (and (= o137 (remove (mk___t interm1 (mk 1 100)) o136)) (and (dynamic_invariant4 o137 true false true) (and (= (invariant__ o137) true) (and (= (to_rep1 (last (rt o137))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o136 1))) (= (to_rep (select interm1 k)) (to_rep (select (elts o137) k))))) (and (forall ((k Int)) (=> (and (<= (+ o136 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select interm1 k)) (to_rep (select (elts o137) (- k 1)))))) (forall ((k Int)) (=> (and (<= o136 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select interm1 (+ k 1))) (to_rep (select (elts o137) k))))))))))))
(assert (not (= (invariant__ o137) true)))
(check-sat)
(exit)
