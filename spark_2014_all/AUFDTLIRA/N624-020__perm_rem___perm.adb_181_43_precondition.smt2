...
(assert (and (and (= (of_int (perm_symmetric a b)) true) (and (= (of_int (shift_perm_l b a c)) true) (and (= (of_int (perm_symmetric c a)) true) (and (and (= perm__shift_perm_r__result1 perm__shift_perm_r__result2) (= perm__shift_perm_r__result3 perm__shift_perm_r__result1)) (and (= (mk_int__ref result3) (mk_int__ref perm__shift_perm_r__result)) (= perm__shift_perm_r__result1 1)))))) (and (= (mk_int__ref perm__shift_perm_r__result4) (mk_int__ref perm__shift_perm_r__result2)) (= perm__shift_perm_r__result5 perm__shift_perm_r__result3))))
