...
(assert (= (= o17 true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (count (state__2 (mk___split_fields my_stack__split_fields4 my_stack__split_fields5))))) (= (stack_entry (state__2 (mk___split_fields my_stack__split_fields4 my_stack__split_fields5)) i1) (stack_entry (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1)) i1))))))
