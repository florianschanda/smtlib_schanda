...
(define-fun to_base1 ((a us_rep3)) us_rep (mk___rep (us_split_discrs5 a) (mk___split_fields (let ((temp___147 (rec__static_discr__i_holder__content2 (us_split_fields7 a)))) (of_array (to_array2 temp___147) (first5 temp___147) (last5 temp___147))))))
(define-fun of_base1 ((r us_rep)) us_rep3 (mk___rep3 (us_split_discrs1 r) (mk___split_fields3 (let ((temp___146 (rec__static_discr__i_holder__content (us_split_fields1 r)))) (of_array2 (to_array temp___146) (first1 temp___146) (last1 temp___146))))))
...
(define-fun dynamic_invariant4 ((temp___expr_272 us_rep3) (temp___is_init_269 Bool) (temp___skip_constant_270 Bool) (temp___do_toplevel_271 Bool)) Bool (and (=> (not (= temp___skip_constant_270 true)) (in_range4 r43b r44b (to_base1 temp___expr_272))) (and (dynamic_property5 1 r44b (first5 (rec__static_discr__i_holder__content2 (us_split_fields7 temp___expr_272))) (last5 (rec__static_discr__i_holder__content2 (us_split_fields7 temp___expr_272)))) (and (= (first5 (rec__static_discr__i_holder__content2 (us_split_fields7 temp___expr_272))) 1) (= (last5 (rec__static_discr__i_holder__content2 (us_split_fields7 temp___expr_272))) r44b)))))
(define-fun default_initial_assumption ((temp___expr_276 us_rep3) (temp___skip_top_level_277 Bool)) Bool (and (= (to_rep (rec__static_discr__i_holder__unused (us_split_discrs5 temp___expr_276))) r43b) (= (to_rep (rec__static_discr__i_holder__c (us_split_discrs5 temp___expr_276))) r44b)))
...
(assert (dynamic_invariant1 (mk___rep2 current__split_discrs (mk___split_fields2 (mk___rep1 (mk___split_discrs current__split_fields current__split_fields1) (mk___split_fields1 (mk___t1 current__split_fields2 current__split_fields3))) current__split_fields4)) true false true))
...
(assert (= o4 o9))
(assert (= current__split_discrs (mk___split_discrs1 temp___407 temp___4071)))
...
(assert (= current__split_fields5 (mk___split_fields2 (mk___rep1 (mk___split_discrs temp___4072 temp___4073) (mk___split_fields1 (mk___t1 temp___4074 temp___4075))) temp___4076)))
(assert (= current__split_discrs (mk___split_discrs1 temp___407 temp___4071)))
