...
(assert (=> (not (= (int__content i14) 0)) (= o39 (select temp___776 o38))))
(assert (=> (not (= (int__content i14) 0)) (= o40 (us_split_fields1 o39))))
...
(assert (=> (= result26 true) (and (= o36 (root (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)))) (and (in_range3 o36) (= o36 (to_rep1 t__split_fields))))))
(assert (=> (= result26 true) (type_invariant1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))))
(assert (=> (= result26 true) (and (= o37 (root (mk___rep3 (us_split_fields__content3 t__split_fields14)))) (and (in_range3 o37) (= o37 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields__content3 t__split_fields14))))))))
...
(assert (=> (= result25 true) (and (= o35 (size1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))) (and (in_range4 o35) (= o35 (size (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14))))))))
(assert (=> (= result25 true) (= result24 (ite (= o35 (+ (size1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3))) 1)) true false))))
...
(assert (=> (= result24 true) (and (= o34 (values1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))) (ite (= (size (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14))) 0) (= (is_empty o34) true) (and (forall ((i16 Int)) (=> (and (<= 1 i16) (<= i16 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields__content3 t__split_fields14)))) i16))) true) (= (contains o34 (to_rep (select (rec__search_trees__search_tree__values (us_split_fields__content3 t__split_fields14)) i16))) true)))) (forall ((v1 Int)) (=> (and (<= 0 v1) (<= v1 2147483647)) (=> (= (contains o34 v1) true) (exists ((i16 Int)) (and (and (<= 1 i16) (<= i16 100)) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields__content3 t__split_fields14)))) i16))) true) (= (to_rep (select (rec__search_trees__search_tree__values (us_split_fields__content3 t__split_fields14)) i16)) v1))))))))))))
...
(assert (=> (= result24 true) (and (= o33 (values1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)))) (ite (= (size (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2))) 0) (= (is_empty o33) true) (and (forall ((i16 Int)) (=> (and (<= 1 i16) (<= i16 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) (to_rep1 t__split_fields)) i16))) true) (= (contains o33 (to_rep (select t__split_fields3 i16))) true)))) (forall ((v1 Int)) (=> (and (<= 0 v1) (<= v1 2147483647)) (=> (= (contains o33 v1) true) (exists ((i16 Int)) (and (and (<= 1 i16) (<= i16 100)) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) (to_rep1 t__split_fields)) i16))) true) (= (to_rep (select t__split_fields3 i16)) v1))))))))))))
