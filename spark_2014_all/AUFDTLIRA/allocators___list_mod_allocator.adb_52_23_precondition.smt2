...
(assert (=> (= result2 true) (=> (not (= first_available 0)) (and (= o5 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (and (in_range5 o5) (<= (+ 0 o5) 2147483647))))))
(assert (=> (= result2 true) (=> (not (= first_available 0)) (= result3 (ite (< 0 o5) true false)))))
(assert (=> (= result2 true) (=> (not (= first_available 0)) (=> (= result3 true) (and (= o4 (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m)) 1)) (in_range6 o4))))))
...
(assert (=> (= result2 true) (=> (not (not (= first_available 0))) (and (= o6 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (and (in_range5 o6) (<= (+ 0 o6) 2147483647))))))
(assert (=> (= result2 true) (=> (not (not (= first_available 0))) (= result1 (ite (= o6 0) true false)))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (=> (= result1 true) (and (= o2 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (and (in_range5 o2) (<= (+ 0 o2) 2147483647)))))
