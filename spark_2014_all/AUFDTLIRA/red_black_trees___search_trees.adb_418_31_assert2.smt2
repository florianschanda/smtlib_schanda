...
(assert (not (= (get (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) j1))) (+ (length (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) i2)))) 1)) (get (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f_old v) j1))) (+ (length (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f_old v) i2)))) 1)))))
(check-sat)
(exit)
