...
(assert (= result2 (ite (<= o4 1000) true false)))
(assert (=> (= result2 true) (and (= o3 (+ y l1)) (in_range1 (+ y l1)))))
(assert (=> (= result2 true) (= result1 (ite (<= o3 1000) true false))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (= result1 true))
(assert (and (= temp___193 (+ y l1)) (in_range1 (+ y l1))))
(assert (and (<= 1 temp___193) (<= temp___193 1000)))
(assert (= o temp___193))
(assert (= o1 (select a o)))
(assert (= o2 (to_rep o1)))
(assert (and (= temp___192 (+ x l1)) (in_range1 (+ x l1))))
(assert (not (<= 1 temp___192)))
(check-sat)
(exit)
