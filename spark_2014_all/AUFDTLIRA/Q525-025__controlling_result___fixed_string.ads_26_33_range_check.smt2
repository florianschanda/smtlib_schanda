...
(assert (forall ((temp___141 Int)) (forall ((temp___142 Int)) (= (select (temp___139 temp___141) temp___142) (of_rep temp___141)))))
(define-fun default_initial_assumption ((temp___expr_137 us_rep) (temp___skip_top_level_138 Bool)) Bool (and (= (attr__tag temp___expr_137) us_tag) (and (= (to_rep2 (rec__fixed_string__object__width (us_split_fields1 temp___expr_137))) 0) (= (rec__fixed_string__object__name (us_split_fields1 temp___expr_137)) (temp___139 0)))))
...
(assert (forall ((temp___222 Int) (temp___223 Int) (temp___224 Int)) (let ((temp___221 (fixed_string__null_string__value__aggregate_def temp___222 temp___223 temp___224))) (and (=> (dynamic_property 1 2147483647 temp___223 temp___224) (and (= (first5 temp___221) temp___223) (= (last5 temp___221) temp___224))) (forall ((temp___225 Int)) (= (select (to_array2 temp___221) temp___225) (of_rep temp___222)))))))
...
(define-fun dynamic_invariant5 ((temp___expr_195 us_t1) (temp___is_init_192 Bool) (temp___skip_constant_193 Bool) (temp___do_toplevel_194 Bool)) Bool (=> (not (= temp___skip_constant_193 true)) (and (dynamic_property2 1 (to_rep2 (rec__fixed_string__object__width (us_split_fields1 this))) (first3 temp___expr_195) (last3 temp___expr_195)) (and (= (first3 temp___expr_195) 1) (= (last3 temp___expr_195) (to_rep2 (rec__fixed_string__object__width (us_split_fields1 this))))))))
...
(assert (= (mk___t2 temp___227 temp___2271) (fixed_string__null_string__value__aggregate_def 0 1 (to_rep2 (rec__fixed_string__object__width (us_split_fields1 this))))))
(assert (= (ite (<= (to_rep1 (first4 temp___2271)) (to_rep1 (last4 temp___2271))) (+ (- (to_rep1 (last4 temp___2271)) (to_rep1 (first4 temp___2271))) 1) 0) (ite (<= 1 (to_rep2 (rec__fixed_string__object__width (us_split_fields1 this)))) (+ (- (to_rep2 (rec__fixed_string__object__width (us_split_fields1 this))) 1) 1) 0)))
(assert (= temp___227 fixed_string__null_string__value__assume))
(assert (= (mk1 (to_rep1 (first4 temp___2271)) (to_rep1 (last4 temp___2271))) fixed_string__null_string__value__assume1))
