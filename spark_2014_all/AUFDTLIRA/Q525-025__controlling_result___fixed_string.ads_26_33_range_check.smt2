...
(declare-fun temp_____aggregate_def_162 (Int) (Array Int character))
(define-fun default_initial_assumption ((temp___expr_160 us_rep) (temp___skip_top_level_161 Bool)) Bool (and (= (attr__tag temp___expr_160) us_tag) (and (= (to_rep2 (rec__fixed_string__object__width (us_split_fields1 temp___expr_160))) 0) (= (rec__fixed_string__object__name (us_split_fields1 temp___expr_160)) (temp_____aggregate_def_162 0)))))
...
(assert (forall ((temp___164 Int)) (=> (dynamic_invariant2 temp___164 true true true true) (forall ((temp___165 Int)) (= (to_rep (select (temp_____aggregate_def_162 temp___164) temp___165)) temp___164)))))
