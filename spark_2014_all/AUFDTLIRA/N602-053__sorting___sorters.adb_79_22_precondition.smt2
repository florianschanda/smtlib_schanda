...
(assert (=> (not (= smallest1 current1)) (and (= (to_rep (select o8 o4)) (to_rep (select values smallest1))) (and (= (to_rep (select o8 smallest1)) (to_rep (select values o4))) (forall ((j Int)) (=> (and (<= (to_rep values__first) j) (<= j (to_rep values__last))) (=> (and (not (= j o4)) (not (= j smallest1))) (= (to_rep (select o8 j)) (to_rep (select values j))))))))))
...
(assert (not (<= (to_rep (first o7)) (to_rep (last o7)))))
(check-sat)
(exit)
