...
(assert (and (= o17 (length2 (mk___rep1 res__split_discrs res__split_fields2))) (and (in_range5 o17) (<= o17 (capacity (mk___rep1 res__split_discrs res__split_fields2))))))
(assert (= result6 (ite (= o17 o16) true false)))
(assert (=> (= result6 true) (and (= o12 (- last5 i9)) (in_range1 (- last5 i9)))))
(assert (=> (= result6 true) (= o13 (+ o12 1))))
(assert (=> (= result6 true) (and (= o14 o13) (in_range1 o13))))
(assert (=> (= result6 true) (and (= o11 (to__ (mk___rep s__split_fields9))) (and (dynamic_invariant1 o11 true false true true) (and (= (to_rep (first (rt o11))) 1) (<= 0 (to_rep (last (rt o11)))))))))
