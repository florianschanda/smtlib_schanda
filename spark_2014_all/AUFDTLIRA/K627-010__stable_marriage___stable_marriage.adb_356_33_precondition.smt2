...
(assert (and (<= 1 rank1) (<= rank1 64)))
(assert (= o43 rank1))
(assert (= o44 (select (select ranking_1 g1_id) o43)))
(assert (= o45 (to_rep1 o44)))
(assert (= o46 (select ranking_2 o45)))
(assert (and (<= 1 rank1) (<= rank1 64)))
(assert (= o38 rank1))
(assert (= o39 (select (select ranking_1 g1_id) o38)))
(assert (= o40 (to_rep1 o39)))
(assert (= o41 (select result__2 o40)))
(assert (= o42 (to_rep o41)))
(assert (not (= (is_permutation_1 o46) true)))
(check-sat)
(exit)
