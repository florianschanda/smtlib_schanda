...
(assert (and (<= 1 rank1) (<= rank1 64)))
(assert (= o53 rank1))
(assert (= o54 (select (select ranking_1 g1_id) o53)))
(assert (= o55 (to_rep1 o54)))
(assert (= o56 (select ranking_2 o55)))
(assert (and (<= 1 rank1) (<= rank1 64)))
(assert (= o48 rank1))
(assert (= o49 (select (select ranking_1 g1_id) o48)))
(assert (= o50 (to_rep1 o49)))
(assert (= o51 (select result__2 o50)))
(assert (= o52 (to_rep o51)))
(assert (not (= (is_permutation_1 o56) true)))
(check-sat)
(exit)
