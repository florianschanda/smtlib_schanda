...
(assert (= 1 0))
(assert (= (to_rep o38) c205b1))
(assert (= o39 (mk___split_fields (rec__frame_condition__cell__value (us_split_fields1 (select (map__content a5) c204b1))) o38 (rec__frame_condition__cell__max_right (us_split_fields1 (select (map__content a5) c204b1))))))
(assert (= o40 (mk___rep o39)))
(assert (not (<= (to_rep1 a__first) c204b1)))
(check-sat)
(exit)
