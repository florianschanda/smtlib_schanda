...
(assert (= i1 11))
(assert (=> (and (<= 11 i1) (<= i1 r6b)) (= temp___213 i1)))
(assert (=> (and (<= 11 i1) (<= i1 r6b)) (= temp___211 a1)))
(assert (=> (and (<= 11 i1) (<= i1 r6b)) (= temp___209 v1)))
(assert (=> (and (<= 11 i1) (<= i1 r6b)) (and (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 v2)) (forall ((temp___212 Int)) (=> (and (<= (to_rep a__first) temp___212) (<= temp___212 (to_rep a__last))) (=> (or (< r6b temp___212) (or (< temp___212 11) (<= i2 temp___212))) (= (select a2 temp___212) (select temp___211 temp___212)))))) (=> (<= 11 r6b) (dynamic_property1 11 r6b i2))) (and (<= 11 i2) (<= i2 r6b)))))
(assert (=> (and (<= 11 i1) (<= i1 r6b)) (= v2 result3)))
(assert (=> (and (<= 11 i1) (<= i1 r6b)) (= v3 0)))
(assert (=> (and (<= 11 i1) (<= i1 r6b)) (and (<= (to_rep a__first) i2) (<= i2 (to_rep a__last)))))
(assert (=> (and (<= 11 i1) (<= i1 r6b)) (= o i2)))
(assert (=> (and (<= 11 i1) (<= i1 r6b)) (= o1 (store a2 o rliteral1))))
(assert (=> (and (<= 11 i1) (<= i1 r6b)) (= result4 a2)))
(assert (=> (and (<= 11 i1) (<= i1 r6b)) (= a3 o1)))
(assert (=> (and (<= 11 i1) (<= i1 r6b)) (= i2 r6b)))
(assert (=> (and (<= 11 i1) (<= i1 r6b)) (= i2 i3)))
(assert (=> (and (<= 11 i1) (<= i1 r6b)) (= a3 a4)))
(assert (=> (and (<= 11 i1) (<= i1 r6b)) (= v3 v4)))
(assert (=> (and (<= 11 i1) (<= i1 r6b)) (= i4 i2)))
(assert (=> (and (<= 11 i1) (<= i1 r6b)) (= a5 a3)))
(assert (=> (and (<= 11 i1) (<= i1 r6b)) (= v5 v3)))
(assert (=> (and (<= 11 i1) (<= i1 r6b)) (= i5 (mk_int__ref i3))))
(assert (=> (and (<= 11 i1) (<= i1 r6b)) (= a6 (mk_map__ref a4))))
(assert (=> (and (<= 11 i1) (<= i1 r6b)) (= (mk_int__ref v6) (mk_int__ref v4))))
(assert (=> (and (<= 11 i1) (<= i1 r6b)) (= i6 i4)))
(assert (=> (and (<= 11 i1) (<= i1 r6b)) (= a7 a5)))
(assert (=> (and (<= 11 i1) (<= i1 r6b)) (= v7 v5)))
(assert (=> (not (and (<= 11 i1) (<= i1 r6b))) (= i5 (mk_int__ref i1))))
(assert (=> (not (and (<= 11 i1) (<= i1 r6b))) (= a6 (mk_map__ref a1))))
(assert (=> (not (and (<= 11 i1) (<= i1 r6b))) (= v1 v6)))
(assert (=> (not (and (<= 11 i1) (<= i1 r6b))) (= i6 i1)))
(assert (=> (not (and (<= 11 i1) (<= i1 r6b))) (= a7 a1)))
(assert (=> (not (and (<= 11 i1) (<= i1 r6b))) (= v7 v1)))
