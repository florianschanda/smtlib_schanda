...
(assert (forall ((x et2)) (! (in_range4 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(assert (forall ((x enum1t)) (! (in_range5 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(define-fun bool_eq3 ((a (Array Int us_rep1)) (a__first Int) (a__last Int) (b (Array Int us_rep1)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_142 Int)) (=> (and (<= a__first temp___idx_142) (<= temp___idx_142 a__last)) (= (bool_eq2 (select a temp___idx_142) (select b (+ (- b__first a__first) temp___idx_142))) true)))) true false))
(assert (forall ((a (Array Int us_rep1)) (b (Array Int us_rep1))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq3 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_142 Int)) (=> (and (<= a__first temp___idx_142) (<= temp___idx_142 a__last)) (= (bool_eq2 (select a temp___idx_142) (select b (+ (- b__first a__first) temp___idx_142))) true))))))))
...
(define-fun dynamic_invariant3 ((temp___expr_182 Int) (temp___is_init_179 Bool) (temp___skip_constant_180 Bool) (temp___do_toplevel_181 Bool)) Bool (=> (or (= temp___is_init_179 true) (<= 1 25)) (in_range4 temp___expr_182)))
(define-fun dynamic_invariant4 ((temp___expr_200 Int) (temp___is_init_197 Bool) (temp___skip_constant_198 Bool) (temp___do_toplevel_199 Bool)) Bool (=> (or (= temp___is_init_197 true) (<= 0 6)) (in_range5 temp___expr_200)))
...
(assert (<= 1 n))
(assert (<= n 10))
(assert (not (in_range3 (to_rep (rec__ar__rec1t__f1 (us_split_fields1 (select (rec__ar__rofaofr1__a1 (us_split_fields3 (select a2 m))) n)))))))
(check-sat)
(exit)
