...
(define-fun dynamic_invariant4 ((temp___expr_232 Int) (temp___is_init_228 Bool) (temp___skip_constant_229 Bool) (temp___do_toplevel_230 Bool) (temp___do_typ_inv_231 Bool)) Bool (=> (or (= temp___is_init_228 true) (<= 0 6)) (in_range5 temp___expr_232)))
...
(assert (<= 1 n))
(assert (<= n 10))
(assert (not (in_range4 (to_rep1 (rec__ar__rec1t__g1 (us_split_fields1 (select (rec__ar__rofaofr1__a1 (us_split_fields3 (select a2 m))) n)))))))
(check-sat)
(exit)
