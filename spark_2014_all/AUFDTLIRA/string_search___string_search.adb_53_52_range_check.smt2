...
(assert (= o19 (ite (<= o18 k) true false)))
(assert (= result4 (ite (= o19 true) (ite (<= k j2) true false) false)))
(assert (= (= o20 true) (forall ((k1 Int)) (=> (and (<= (+ (- (length needle) (to_rep (select bad_shift3 c))) 2) k1) (<= k1 j2)) (not (= (to_rep1 (select (elts needle) k1)) c))))))
