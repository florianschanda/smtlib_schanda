...
(define-fun default_initial_assumption1 ((temp___expr_275 us_rep1) (temp___skip_top_level_276 Bool)) Bool (and (and (= (to_rep (rec__binary_trees__forest__s (us_split_fields3 temp___expr_275))) 0) (forall ((temp___278 Int)) (=> (and (<= 1 temp___278) (<= temp___278 100)) (and (and (and (= (to_rep (rec__binary_trees__cell__left (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 temp___expr_275)) temp___278)))) 0) (= (to_rep (rec__binary_trees__cell__right (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 temp___expr_275)) temp___278)))) 0)) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 temp___expr_275)) temp___278)))) 0)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 temp___expr_275)) temp___278)))) 2))))) (=> (not (= temp___skip_top_level_276 true)) (= (size temp___expr_275) 0))))
(define-fun type_invariant ((temp___281 us_rep1)) Bool (= (tree_structure temp___281) true))
(define-fun dynamic_invariant ((temp___expr_156 Int) (temp___is_init_153 Bool) (temp___skip_constant_154 Bool) (temp___do_toplevel_155 Bool)) Bool (=> (or (= temp___is_init_153 true) (<= 0 100)) (in_range1 temp___expr_156)))
(assert (forall ((f us_rep1)) (! (=> (type_invariant f) (dynamic_invariant (size f) true false true)) :pattern ((size f)))))
(assert (forall ((f us_rep1)) (! (= (size f) (to_rep (rec__binary_trees__forest__s (us_split_fields3 f)))) :pattern ((size f)))))
(define-fun default_initial_assumption2 ((temp___expr_259 us_rep) (temp___skip_top_level_260 Bool)) Bool (and (and (and (= (to_rep (rec__binary_trees__cell__left (us_split_fields1 temp___expr_259))) 0) (= (to_rep (rec__binary_trees__cell__right (us_split_fields1 temp___expr_259))) 0)) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields1 temp___expr_259))) 0)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields1 temp___expr_259))) 2)))
(assert true)
(assert (forall ((f us_rep1)) (! (= (= (tree_structure f) true) (and (and (and (and (and (and (and (and (forall ((i Int)) (=> (and (<= (+ (to_rep (rec__binary_trees__forest__s (us_split_fields3 f))) 1) i) (<= i 100)) (= (bool_eq (let ((temp___397 (rec__binary_trees__forest__c (us_split_fields3 f)))) (select temp___397 i)) (mk___rep (mk___split_fields (of_rep 0) (of_rep 0) (of_rep 0) (of_rep1 2)))) true))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (and (<= 0 (to_rep (rec__binary_trees__cell__parent (us_split_fields1 (let ((temp___398 (rec__binary_trees__forest__c (us_split_fields3 f)))) (select temp___398 i)))))) (<= (to_rep (rec__binary_trees__cell__parent (us_split_fields1 (let ((temp___398 (rec__binary_trees__forest__c (us_split_fields3 f)))) (select temp___398 i))))) (to_rep (rec__binary_trees__forest__s (us_split_fields3 f)))))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (and (<= 0 (to_rep (rec__binary_trees__cell__left (us_split_fields1 (let ((temp___399 (rec__binary_trees__forest__c (us_split_fields3 f)))) (select temp___399 i)))))) (<= (to_rep (rec__binary_trees__cell__left (us_split_fields1 (let ((temp___399 (rec__binary_trees__forest__c (us_split_fields3 f)))) (select temp___399 i))))) (to_rep (rec__binary_trees__forest__s (us_split_fields3 f)))))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (and (<= 0 (to_rep (rec__binary_trees__cell__right (us_split_fields1 (let ((temp___400 (rec__binary_trees__forest__c (us_split_fields3 f)))) (select temp___400 i)))))) (<= (to_rep (rec__binary_trees__cell__right (us_split_fields1 (let ((temp___400 (rec__binary_trees__forest__c (us_split_fields3 f)))) (select temp___400 i))))) (to_rep (rec__binary_trees__forest__s (us_split_fields3 f)))))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields1 (let ((temp___402 (rec__binary_trees__forest__c (us_split_fields3 f)))) (select temp___402 i))))) 2) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields1 (let ((temp___401 (rec__binary_trees__forest__c (us_split_fields3 f)))) (select temp___401 i))))) 0))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= (to_rep (rec__binary_trees__cell__left (us_split_fields1 (let ((temp___407 (rec__binary_trees__forest__c (us_split_fields3 f)))) (select temp___407 i))))) 0)) (and (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields1 (let ((temp___403 (rec__binary_trees__forest__c (us_split_fields3 f)))) (select temp___403 (to_rep (rec__binary_trees__cell__left (us_split_fields1 (let ((temp___404 (rec__binary_trees__forest__c (us_split_fields3 f)))) (select temp___404 i)))))))))) 0) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields1 (let ((temp___405 (rec__binary_trees__forest__c (us_split_fields3 f)))) (select temp___405 (to_rep (rec__binary_trees__cell__left (us_split_fields1 (let ((temp___406 (rec__binary_trees__forest__c (us_split_fields3 f)))) (select temp___406 i)))))))))) i)))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= (to_rep (rec__binary_trees__cell__right (us_split_fields1 (let ((temp___412 (rec__binary_trees__forest__c (us_split_fields3 f)))) (select temp___412 i))))) 0)) (and (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields1 (let ((temp___408 (rec__binary_trees__forest__c (us_split_fields3 f)))) (select temp___408 (to_rep (rec__binary_trees__cell__right (us_split_fields1 (let ((temp___409 (rec__binary_trees__forest__c (us_split_fields3 f)))) (select temp___409 i)))))))))) 1) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields1 (let ((temp___410 (rec__binary_trees__forest__c (us_split_fields3 f)))) (select temp___410 (to_rep (rec__binary_trees__cell__right (us_split_fields1 (let ((temp___411 (rec__binary_trees__forest__c (us_split_fields3 f)))) (select temp___411 i)))))))))) i)))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (and (not (= (to_rep (rec__binary_trees__cell__parent (us_split_fields1 (let ((temp___415 (rec__binary_trees__forest__c (us_split_fields3 f)))) (select temp___415 i))))) 0)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields1 (let ((temp___416 (rec__binary_trees__forest__c (us_split_fields3 f)))) (select temp___416 i))))) 0)) (= (to_rep (rec__binary_trees__cell__left (us_split_fields1 (let ((temp___413 (rec__binary_trees__forest__c (us_split_fields3 f)))) (select temp___413 (to_rep (rec__binary_trees__cell__parent (us_split_fields1 (let ((temp___414 (rec__binary_trees__forest__c (us_split_fields3 f)))) (select temp___414 i)))))))))) i))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (and (not (= (to_rep (rec__binary_trees__cell__parent (us_split_fields1 (let ((temp___419 (rec__binary_trees__forest__c (us_split_fields3 f)))) (select temp___419 i))))) 0)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields1 (let ((temp___420 (rec__binary_trees__forest__c (us_split_fields3 f)))) (select temp___420 i))))) 1)) (= (to_rep (rec__binary_trees__cell__right (us_split_fields1 (let ((temp___417 (rec__binary_trees__forest__c (us_split_fields3 f)))) (select temp___417 (to_rep (rec__binary_trees__cell__parent (us_split_fields1 (let ((temp___418 (rec__binary_trees__forest__c (us_split_fields3 f)))) (select temp___418 i)))))))))) i)))))) :pattern ((tree_structure f)))))
(define-fun dynamic_invariant1 ((temp___expr_150 Int) (temp___is_init_147 Bool) (temp___skip_constant_148 Bool) (temp___do_toplevel_149 Bool)) Bool (=> (or (= temp___is_init_147 true) (<= 1 100)) (in_range temp___expr_150)))
(define-fun dynamic_invariant2 ((temp___expr_162 Int) (temp___is_init_159 Bool) (temp___skip_constant_160 Bool) (temp___do_toplevel_161 Bool)) Bool (=> (or (= temp___is_init_159 true) (<= 0 2)) (in_range2 temp___expr_162)))
(declare-const temp___574 extended_index_type)
(declare-const temp___5741 (Array Int us_rep))
(assert (and (= (to_rep temp___574) 0) (default_initial_assumption temp___5741 false)))
(assert (not (= (tree_structure (mk___rep1 (mk___split_fields1 temp___574 temp___5741))) true)))
(check-sat)
(exit)
