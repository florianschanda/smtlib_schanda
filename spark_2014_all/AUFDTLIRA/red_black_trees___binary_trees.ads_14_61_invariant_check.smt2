...
(assert (and (= (to_rep temp___620) 0) (default_initial_assumption1 temp___6201 false)))
(assert (not (= (tree_structure (mk___rep1 (mk___split_fields1 temp___620 temp___6201))) true)))
(check-sat)
(exit)
