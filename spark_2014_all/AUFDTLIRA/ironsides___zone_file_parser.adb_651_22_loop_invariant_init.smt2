...
(define-fun i22 () int__ref (mk_int__ref i1))
(define-fun i23 () int__ref (mk_int__ref i))
...
(assert (and (and (and (and (<= begidx2 endidx1) (<= begidx2 zlength)) (<= endidx1 zlength)) (=> (= foundtype1 1) (forall ((i24 Int)) (=> (and (<= begidx2 i24) (<= i24 endidx1)) (and (<= 48 (to_rep (select zonefileline i24))) (<= (to_rep (select zonefileline i24)) 57)))))) (and (and (in_range4 begidx2) (in_range4 endidx1)) (in_range3 foundtype1))))
...
(assert (=> (and (not (= foundtype1 3)) (< endidx1 zlength)) (and (and (and (and (<= begidx5 endidx3) (<= begidx5 zlength)) (<= endidx3 zlength)) (=> (= foundtype3 1) (forall ((i24 Int)) (=> (and (<= begidx5 i24) (<= i24 endidx3)) (and (<= 48 (to_rep (select zonefileline i24))) (<= (to_rep (select zonefileline i24)) 57)))))) (and (and (in_range4 begidx5) (in_range4 endidx3)) (in_range3 foundtype3)))))
...
(assert (= begidx10 o1))
(assert (and (and (and (and (<= begidx11 endidx8) (<= begidx11 zlength)) (<= endidx8 zlength)) (=> (= foundtype8 1) (forall ((i24 Int)) (=> (and (<= begidx11 i24) (<= i24 endidx8)) (and (<= 48 (to_rep (select zonefileline i24))) (<= (to_rep (select zonefileline i24)) 57)))))) (and (and (in_range4 begidx11) (in_range4 endidx8)) (in_range3 foundtype8))))
...
(assert (=> (< 128 lengthoftoken1) (= i18 i22)))
(assert (=> (< 128 lengthoftoken1) (= i17 i23)))
...
(assert (=> (not (< 128 lengthoftoken1)) (= result7 i23)))
...
(assert (=> (not (< 128 lengthoftoken1)) (= result9 i22)))
...
(assert (= begidx12 o10))
(assert (and (and (and (and (<= begidx13 endidx9) (<= begidx13 zlength)) (<= endidx9 zlength)) (=> (= foundtype9 1) (forall ((i24 Int)) (=> (and (<= begidx13 i24) (<= i24 endidx9)) (and (<= 48 (to_rep (select zonefileline i24))) (<= (to_rep (select zonefileline i24)) 57)))))) (and (and (in_range4 begidx13) (in_range4 endidx9)) (in_range3 foundtype9))))
...
(assert (<= r28b i21))
(assert (<= i21 r29b))
(assert (not (<= (+ (- endidx9 begidx13) 1) 128)))
(check-sat)
(exit)
