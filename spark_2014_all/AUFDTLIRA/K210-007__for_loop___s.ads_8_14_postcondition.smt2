...
(assert (or (and (and (and (= s__contains__result3 s__contains__result13) (= index2 index10)) (and (= s__contains__result14 s__contains__result3) (= index11 index2))) (and (= temp___159 1) (and (= temp___160 10) (and (and (= (mk_int__ref result) (mk_int__ref index)) (= index1 temp___159)) (and (and (<= temp___159 index1) (<= index1 temp___160)) (and (= temp___158 index1) (and (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- index2 1))) (not (= (to_rep (select table j1)) value)))) (and (and (=> (<= 1 10) (in_range3 index2)) (and (<= 1 index2) (<= index2 10))) (and (= (to_rep (select table index2)) value) (and (= result1 s__contains__result2) (= s__contains__result3 (of_int 1)))))))))))) (and (and (and (= (mk_int__ref result) (mk_int__ref index)) (= index1 1)) (ite (and (<= 1 index1) (<= index1 10)) (and (and (and (= temp___158 index1) (and (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- index2 1))) (not (= (to_rep (select table j1)) value)))) (and (and (=> (<= 1 10) (in_range3 index2)) (and (<= 1 index2) (<= index2 10))) (and (and (not (= (to_rep (select table index2)) value)) (= s__contains__result3 s__contains__result2)) (= index2 10))))) (and (and (= s__contains__result3 s__contains__result6) (= index2 index6)) (and (= s__contains__result7 s__contains__result3) (= index7 index2)))) (and (and (= (mk_bool__ref s__contains__result8) (mk_bool__ref s__contains__result6)) (= (mk_int__ref index8) (mk_int__ref index6))) (and (= s__contains__result9 s__contains__result7) (= index9 index7)))) (and (and (= (mk_bool__ref s__contains__result8) (mk_bool__ref s__contains__result)) (= index1 index8)) (and (= s__contains__result9 s__contains__result1) (= index9 index1))))) (and (and (and (= (mk_bool__ref s__contains__result13) (mk_bool__ref s__contains__result11)) (= (mk_int__ref index10) (mk_int__ref index8))) (and (= s__contains__result14 s__contains__result12) (= index11 index9))) (and (and (= s__contains__result10 s__contains__result11) (= s__contains__result12 s__contains__result10)) (and (= result3 s__contains__result8) (= s__contains__result10 (of_int 0))))))))
(assert (= (mk_bool__ref s__contains__result15) (mk_bool__ref s__contains__result13)))
(assert (= index12 index10))
(assert (= s__contains__result16 s__contains__result14))
(assert (= index13 index11))
(assert (= result4 s__contains__result15))
(assert (= s__contains__result15 true))
(assert (not (exists ((j1 Int)) (and (and (<= 1 j1) (<= j1 10)) (= (to_rep (select table j1)) value)))))
(check-sat)
(exit)
