...
(assert (= result1 true))
(assert (and (= o11 (+ x l1)) (in_range1 (+ x l1))))
(assert (= o12 (- o11 1)))
(assert (and (= o13 o12) (in_range1 o12)))
(assert (= (mk_int__ref result4) (mk_int__ref r6b)))
(assert (= r6b2 o13))
(assert (in_range1 r6b2))
(assert (and (= o14 (+ y l1)) (in_range1 (+ y l1))))
(assert (= o15 (- o14 1)))
(assert (and (= o16 o15) (in_range1 o15)))
(assert (= (mk_int__ref result5) (mk_int__ref r9b)))
(assert (= r9b2 o16))
(assert (in_range1 r9b2))
(assert (= (bool_eq (elts a) (to_rep (first6 (mk3 x r6b3))) (to_rep (last6 (mk3 x r6b3))) (elts a) (to_rep (first8 (mk4 y r9b3))) (to_rep (last8 (mk4 y r9b3)))) true))
(assert (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 r6b3)) (=> (<= 0 2147483647) (in_range2 l2))) (=> (<= (- 2147483648) 2147483647) (in_range1 r9b3))))
(assert (= temp___1731 result6))
(assert (= temp___1732 l2))
(assert (and (= o18 (+ l2 1)) (in_range1 (+ l2 1))))
(assert (= l2 result7))
(assert (= l3 o18))
(assert (and (= o26 (+ x l3)) (in_range1 (+ x l3))))
(assert (= result10 (ite (<= o26 (to_rep (last (rt a)))) true false)))
(assert (=> (= result10 true) (and (= o25 (+ y l3)) (in_range1 (+ y l3)))))
(assert (=> (= result10 true) (= result9 (ite (<= o25 (to_rep (last (rt a)))) true false))))
(assert (=> (not (= result10 true)) (= result9 false)))
(assert (=> (= result9 true) (and (= temp___1751 (+ y l3)) (in_range1 (+ y l3)))))
(assert (=> (= result9 true) (and (<= (to_rep (first (rt a))) temp___1751) (<= temp___1751 (to_rep (last (rt a)))))))
(assert (=> (= result9 true) (= o21 temp___1751)))
(assert (=> (= result9 true) (= o22 (select (elts a) o21))))
(assert (=> (= result9 true) (= o23 (to_rep o22))))
(assert (=> (= result9 true) (and (= temp___1741 (+ x l3)) (in_range1 (+ x l3)))))
(assert (=> (= result9 true) (and (<= (to_rep (first (rt a))) temp___1741) (<= temp___1741 (to_rep (last (rt a)))))))
(assert (=> (= result9 true) (= o19 temp___1741)))
(assert (=> (= result9 true) (= o20 (select (elts a) o19))))
(assert (=> (= result9 true) (= o24 (to_rep o20))))
(assert (=> (= result9 true) (= o27 (ite (= o24 o23) true false))))
(assert (=> (not (= result9 true)) (= o27 false)))
(assert (= result8 (ite (not (= o27 true)) true false)))
(assert (not (= result8 true)))
(assert (and (= o28 (+ x l3)) (in_range1 (+ x l3))))
(assert (= o29 (- o28 1)))
(assert (and (= o30 o29) (in_range1 o29)))
(assert (= r6b3 result11))
(assert (= r6b4 o30))
(assert (in_range1 r6b4))
(assert (and (= o31 (+ y l3)) (in_range1 (+ y l3))))
(assert (= o32 (- o31 1)))
(assert (and (= o33 o32) (in_range1 o32)))
(assert (= r9b3 result12))
(assert (= r9b4 o33))
(assert (in_range1 r9b4))
(assert (not (= (bool_eq (elts a) (to_rep (first6 (mk3 x r6b4))) (to_rep (last6 (mk3 x r6b4))) (elts a) (to_rep (first8 (mk4 y r9b4))) (to_rep (last8 (mk4 y r9b4)))) true)))
(check-sat)
(exit)
