...
(assert (and (and (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 r6b2)) (=> (<= 0 2147483647) (in_range2 l2))) (=> (<= (- 2147483648) 2147483647) (in_range1 r9b2))) (= (- (+ x l2) 1) r6b2)) (= (- (+ y l2) 1) r9b2)))
(assert (= temp___198 result6))
(assert (= temp___1981 l2))
...
(assert (=> (= result9 true) (and (= temp___2001 (+ y l3)) (in_range1 (+ y l3)))))
(assert (=> (= result9 true) (and (<= (to_rep (first (rt a))) temp___2001) (<= temp___2001 (to_rep (last (rt a)))))))
(assert (=> (= result9 true) (= o17 temp___2001)))
(assert (=> (= result9 true) (= o18 (select (elts a) o17))))
(assert (=> (= result9 true) (= o19 (to_rep o18))))
(assert (=> (= result9 true) (and (= temp___1991 (+ x l3)) (in_range1 (+ x l3)))))
(assert (=> (= result9 true) (and (<= (to_rep (first (rt a))) temp___1991) (<= temp___1991 (to_rep (last (rt a)))))))
(assert (=> (= result9 true) (= o15 temp___1991)))
