...
(assert (= result1 true))
(assert (and (= o8 (+ x l1)) (in_range1 (+ x l1))))
(assert (= o9 (- o8 1)))
(assert (and (= o10 o9) (in_range1 o9)))
(assert (= (mk_int__ref result4) (mk_int__ref r6b)))
(assert (= r6b1 o10))
(assert (in_range1 r6b1))
(assert (and (= o11 (+ y l1)) (in_range1 (+ y l1))))
(assert (= o12 (- o11 1)))
(assert (and (= o13 o12) (in_range1 o12)))
(assert (= (mk_int__ref result5) (mk_int__ref r9b)))
(assert (= r9b1 o13))
(assert (in_range1 r9b1))
(assert (= (bool_eq (elts a) (to_rep (first6 (mk3 x r6b2))) (to_rep (last6 (mk3 x r6b2))) (elts a) (to_rep (first8 (mk4 y r9b2))) (to_rep (last8 (mk4 y r9b2)))) true))
(assert (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 r6b2)) (=> (<= (- 2147483648) 2147483647) (in_range1 r9b2))) (=> (<= 0 2147483647) (in_range2 l2))))
(assert (= temp___173 result6))
(assert (= temp___1731 l2))
(assert (and (= o14 (+ l2 1)) (in_range1 (+ l2 1))))
(assert (= l2 result7))
(assert (= l3 o14))
(assert (and (= o22 (+ x l3)) (in_range1 (+ x l3))))
(assert (= result10 (ite (<= o22 (to_rep (last (rt a)))) true false)))
(assert (=> (= result10 true) (and (= o21 (+ y l3)) (in_range1 (+ y l3)))))
(assert (=> (= result10 true) (= result9 (ite (<= o21 (to_rep (last (rt a)))) true false))))
...
(assert (=> (= result9 true) (= o17 temp___1751)))
(assert (=> (= result9 true) (= o18 (select (elts a) o17))))
(assert (=> (= result9 true) (= o19 (to_rep o18))))
...
(assert (=> (= result9 true) (= o15 temp___1741)))
(assert (=> (= result9 true) (= o16 (select (elts a) o15))))
(assert (=> (= result9 true) (= o20 (to_rep o16))))
(assert (=> (= result9 true) (= o23 (ite (= o20 o19) true false))))
(assert (=> (not (= result9 true)) (= o23 false)))
(assert (= result8 (ite (not (= o23 true)) true false)))
(assert (not (= result8 true)))
(assert (and (= o24 (+ x l3)) (in_range1 (+ x l3))))
(assert (= o25 (- o24 1)))
(assert (and (= o26 o25) (in_range1 o25)))
(assert (= r6b2 result11))
(assert (= r6b3 o26))
(assert (in_range1 r6b3))
(assert (and (= o27 (+ y l3)) (in_range1 (+ y l3))))
(assert (= o28 (- o27 1)))
(assert (and (= o29 o28) (in_range1 o28)))
(assert (= r9b2 result12))
(assert (= r9b3 o29))
(assert (in_range1 r9b3))
(assert (not (= (bool_eq (elts a) (to_rep (first6 (mk3 x r6b3))) (to_rep (last6 (mk3 x r6b3))) (elts a) (to_rep (first8 (mk4 y r9b3))) (to_rep (last8 (mk4 y r9b3)))) true)))
(check-sat)
(exit)
