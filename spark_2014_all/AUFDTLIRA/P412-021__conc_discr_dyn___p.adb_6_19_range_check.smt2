...
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (us_split_discrs2 a) (mk___split_fields (let ((temp___134 (rec__p__my_rec__content1 (us_split_fields3 a)))) (of_array (to_array1 temp___134) (first3 temp___134) (last3 temp___134))))))
(define-fun of_base ((r us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r) (mk___split_fields1 (let ((temp___133 (rec__p__my_rec__content (us_split_fields1 r)))) (of_array1 (to_array temp___133) (first1 temp___133) (last1 temp___133))))))
...
(define-fun dynamic_invariant ((temp___expr_187 us_rep2) (temp___is_init_184 Bool) (temp___skip_constant_185 Bool) (temp___do_toplevel_186 Bool)) Bool (let ((temp___189 (rec__p__pp__c (us_split_discrs4 temp___expr_187)))) (and (in_range2 (to_rep temp___189) (to_base (rec__p__pp__r (us_split_fields5 temp___expr_187)))) (and (dynamic_property3 1 (to_rep temp___189) (first3 (rec__p__my_rec__content1 (us_split_fields3 (rec__p__pp__r (us_split_fields5 temp___expr_187))))) (last3 (rec__p__my_rec__content1 (us_split_fields3 (rec__p__pp__r (us_split_fields5 temp___expr_187)))))) (and (= (first3 (rec__p__my_rec__content1 (us_split_fields3 (rec__p__pp__r (us_split_fields5 temp___expr_187))))) 1) (= (last3 (rec__p__my_rec__content1 (us_split_fields3 (rec__p__pp__r (us_split_fields5 temp___expr_187))))) (to_rep temp___189)))))))
(declare-sort ttB 0)
...
(define-fun dynamic_invariant1 ((temp___expr_195 Int) (temp___is_init_192 Bool) (temp___skip_constant_193 Bool) (temp___do_toplevel_194 Bool) (self__ us_rep2)) Bool (=> (or (= temp___is_init_192 true) (<= 1 (last4 self__))) (dynamic_property4 1 (last4 self__) temp___expr_195)))
...
(define-fun dynamic_invariant4 ((temp___expr_181 us_rep) (temp___is_init_178 Bool) (temp___skip_constant_179 Bool) (temp___do_toplevel_180 Bool)) Bool (let ((temp___182 (rec__p__my_rec__c (us_split_discrs1 temp___expr_181)))) (and (dynamic_property1 1 (to_rep temp___182) (first1 (rec__p__my_rec__content (us_split_fields1 temp___expr_181))) (last1 (rec__p__my_rec__content (us_split_fields1 temp___expr_181)))) (and (= (first1 (rec__p__my_rec__content (us_split_fields1 temp___expr_181))) 1) (= (last1 (rec__p__my_rec__content (us_split_fields1 temp___expr_181))) (to_rep temp___182))))))
