...
(assert (<= 1 i))
(assert (<= i 100))
(assert (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c75b))) i))) true))
(assert (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c75b) i)))) n5))
(assert (= (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c76b)) i) c77b))
(assert (not (= (rec__red_black_trees__black_count__status (us_split_fields11 (select (nb_blacks c76b) i))) true)))
(check-sat)
(exit)
