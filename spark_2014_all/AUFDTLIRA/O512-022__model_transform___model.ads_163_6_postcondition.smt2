...
(declare-const t Int)
(declare-const temp___438 (Array Int us_rep))
(declare-const o Int)
(declare-const o1 name_t)
(declare-const o2 Int)
(declare-const temp___434 (Array Int us_rep))
(declare-const o3 name_t)
(declare-const o4 Int)
(declare-const o5 name_t)
(declare-const o6 name_t)
(declare-const o7 name_t)
(declare-const o8 (Array Int us_rep3))
(declare-const model__transform__L_2__R7b__assume (Array Int us_rep1))
(declare-const temp___446 (Array Int us_rep4))
(declare-const temp___445 Int)
(declare-const t1 Int)
(declare-const temp___448 (Array Int us_rep))
(declare-const temp___449 (Array Int us_rep1))
(declare-const o9 Int)
(declare-const o10 uml_action_access)
(declare-const o11 uml_action_access)
(declare-const o12 Int)
(declare-const o13 name_t)
(declare-const o14 Int)
(declare-const temp___450 (Array Int us_rep))
(declare-const temp___451 (Array Int us_rep1))
(declare-const o15 Int)
(declare-const o16 uml_state_access)
(declare-const o17 uml_state_access)
(declare-const o18 Int)
(declare-const o19 us_rep)
(declare-const o20 Int)
(declare-const o21 us_rep4)
(declare-const o22 Int)
(declare-const o23 us_rep3)
(declare-const o24 Int)
(declare-const o25 Int)
(declare-const o26 Bool)
(declare-const temp___443 (Array Int us_rep1))
(declare-const o27 us_rep1)
(declare-const o28 Int)
(declare-const temp___444 (Array Int us_rep1))
...
(declare-const s16 int__ref)
(declare-const cfv8 (Array Int us_rep4))
(declare-const s17 Int)
(declare-const cfv9 map__ref3)
(declare-const s18 int__ref)
(declare-const cfv10 (Array Int us_rep4))
(declare-const s19 Int)
(declare-const cfv11 map__ref3)
(declare-const s20 int__ref)
(declare-const cfv12 (Array Int us_rep4))
(declare-const s21 Int)
(declare-const act__split_fields3 us_split_fields10)
(declare-const act__split_fields4 us_split_fields10)
(declare-const result10 uml_activity__ref)
...
(declare-const av10 map__ref2)
(declare-const cfv13 map__ref3)
(declare-const act__split_fields5 us_split_fields__ref5)
(declare-const s22 int__ref)
(declare-const s23 int__ref)
(declare-const model__transform__result5 uml_activity__ref)
(declare-const av11 (Array Int us_rep3))
(declare-const cfv14 (Array Int us_rep4))
(declare-const act__split_fields6 us_split_fields10)
(declare-const s24 Int)
(declare-const s25 Int)
(declare-const model__transform__result6 us_rep5)
(declare-const result11 (Array Int us_rep3))
(declare-const result12 (Array Int us_rep4))
...
(assert (= s2 0))
(assert (=> (and (<= 0 s2) (<= s2 100)) (and (and (= temp___436 av1) (and (= temp___435 s2) (and (forall ((t2 Int)) (=> (and (<= 0 t2) (<= t2 (- s3 1))) (= (name (select (owned_state sm) t2)) (name__2 (select av2 t2))))) (and (and (=> (<= 0 100) (in_range6 s3)) (and (<= 0 s3) (<= s3 100))) (and (and (and (and (and (and (and (and (and (= temp___434 (owned_state sm)) (= temp___434 (rec__model__uml_state_machine__owned_state_data (us_split_fields5 sm)))) (= (mk___rep (mk___split_fields o3)) (select temp___434 s3))) (and (= o4 (name (mk___rep (mk___split_fields o3)))) (and (in_range1 o4) (= o4 (to_rep o3))))) (= (to_rep o5) o4)) (= o5 o6)) (= o7 o6)) (= o8 (store av2 s3 (mk___rep3 (mk___split_fields3 o7))))) (and (= result4 (mk_map__ref2 av2)) (= av3 o8))) (= s3 100)))))) (and (and (= s7 (mk_int__ref s3)) (= av6 (mk_map__ref2 av3))) (and (= s8 s3) (= av7 av3))))))
(assert (=> (and (<= 0 s2) (<= s2 100)) (= s9 s7)))
(assert (=> (and (<= 0 s2) (<= s2 100)) (= av8 av6)))
(assert (=> (and (<= 0 s2) (<= s2 100)) (= s10 s8)))
(assert (=> (and (<= 0 s2) (<= s2 100)) (= av9 av7)))
(assert (=> (not (and (<= 0 s2) (<= s2 100))) (= s9 (mk_int__ref s2))))
(assert (=> (not (and (<= 0 s2) (<= s2 100))) (= av8 (mk_map__ref2 av1))))
(assert (=> (not (and (<= 0 s2) (<= s2 100))) (= s10 s2)))
(assert (=> (not (and (<= 0 s2) (<= s2 100))) (= av9 av1)))
...
(assert (= result6 (mk_int__ref s1)))
(assert (= s11 0))
(assert (=> (and (<= 0 s11) (<= s11 100)) (and (and (= temp___446 cfv1) (and (= temp___445 s11) (and (forall ((t2 Int)) (=> (and (<= 0 t2) (<= t2 (- s12 1))) (and (= (name (select (owned_state sm) (from (select (owned_transition sm) t2)))) (name__2 (select (map__content2 av8) (from__2 (select cfv2 t2))))) (= (name (select (owned_state sm) (to__ (select (owned_transition sm) t2)))) (name__2 (select (map__content2 av8) (to__2 (select cfv2 t2)))))))) (and (and (=> (<= 0 100) (in_range7 s12)) (and (<= 0 s12) (<= s12 100))) (and (and (and (and (and (and (= temp___443 (owned_transition sm)) (= temp___443 (rec__model__uml_state_machine__owned_transition_data (us_split_fields5 sm)))) (= o27 (select temp___443 s12))) (and (= o28 (from o27)) (and (in_range2 o28) (= o28 (to_rep1 (rec__model__uml_transition__from_data (us_split_fields3 o27))))))) (and (= (from__2 (mk___rep4 model__set_from__2__self__fields)) o28) (= (to__2 (mk___rep4 model__set_from__2__self__fields)) (to__2 (mk___rep4 (us_split_fields9 (select cfv2 s12))))))) (and (= result7 (mk_map__ref3 cfv2)) (= cfv3 (store cfv2 s12 (mk___rep4 model__set_from__2__self__fields))))) (and (and (and (and (and (and (= temp___444 (owned_transition sm)) (= temp___444 (rec__model__uml_state_machine__owned_transition_data (us_split_fields5 sm)))) (= o29 (select temp___444 s12))) (and (= o30 (to__ o29)) (and (in_range2 o30) (= o30 (to_rep1 (rec__model__uml_transition__to_data (us_split_fields3 o29))))))) (and (= (to__2 (mk___rep4 model__set_to__2__self__fields)) o30) (= (from__2 (mk___rep4 model__set_to__2__self__fields)) (from__2 (mk___rep4 (us_split_fields9 (select cfv3 s12))))))) (and (= result8 (mk_map__ref3 cfv3)) (= cfv4 (store cfv3 s12 (mk___rep4 model__set_to__2__self__fields))))) (= s12 100))))))) (and (and (= s18 (mk_int__ref s12)) (= cfv9 (mk_map__ref3 cfv4))) (and (= s19 s12) (= cfv10 cfv4))))))
(assert (=> (and (<= 0 s11) (<= s11 100)) (= s20 s18)))
(assert (=> (and (<= 0 s11) (<= s11 100)) (= cfv11 cfv9)))
(assert (=> (and (<= 0 s11) (<= s11 100)) (= s21 s19)))
(assert (=> (and (<= 0 s11) (<= s11 100)) (= cfv12 cfv10)))
(assert (=> (not (and (<= 0 s11) (<= s11 100))) (= s20 (mk_int__ref s11))))
(assert (=> (not (and (<= 0 s11) (<= s11 100))) (= cfv11 (mk_map__ref3 cfv1))))
(assert (=> (not (and (<= 0 s11) (<= s11 100))) (= s21 s11)))
(assert (=> (not (and (<= 0 s11) (<= s11 100))) (= cfv12 cfv1)))
(assert (and (= (bool_eq6 (owned_action (mk___rep5 act__split_fields3)) 0 100 (map__content2 av8) 0 100) true) (= (bool_eq8 (owned_flow (mk___rep5 act__split_fields3)) 0 100 (owned_flow (mk___rep5 act__split_fields2)) 0 100) true)))
(assert (and (= (bool_eq8 (owned_flow (mk___rep5 act__split_fields4)) 0 100 (map__content3 cfv11) 0 100) true) (= (bool_eq6 (owned_action (mk___rep5 act__split_fields4)) 0 100 (owned_action (mk___rep5 act__split_fields3)) 0 100) true)))
...
(assert (= result10 (mk_uml_activity__ref (mk___rep5 (mk___split_fields5 model__transform__result model__transform__result1)))))
...
(assert (= cfv14 cfv12))
(assert (= av11 av9))
(assert (= (mk___rep5 (mk___split_fields5 result11 result12)) (uml_activity__content model__transform__result5)))
(declare-const t2 Int)
(assert (<= 0 t2))
(assert (<= t2 100))
(assert (not (= (name (select (owned_state sm) (from (select (owned_transition sm) t2)))) (name__2 (select (owned_action (uml_activity__content model__transform__result5)) (from__2 (select (owned_flow (uml_activity__content model__transform__result5)) t2)))))))
(check-sat)
(exit)
