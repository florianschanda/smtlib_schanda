...
(assert (<= 0 t))
(assert (<= t 100))
(assert (not (= (name (select (owned_state sm) (to__ (select (owned_transition sm) t)))) (name__2 (select (owned_action (uml_activity__content model__transform__result5)) (to__2 (select (owned_flow (uml_activity__content model__transform__result5)) t)))))))
(check-sat)
(exit)
