...
(assert (forall ((a (Array Int us_rep3)) (b (Array Int us_rep3))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq6 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_156 Int)) (=> (and (<= a__first temp___idx_156) (<= temp___idx_156 a__last)) (= (bool_eq5 (select a temp___idx_156) (select b (+ (- b__first a__first) temp___idx_156))) true))))))))
...
(define-fun bool_eq8 ((a (Array Int us_rep4)) (a__first Int) (a__last Int) (b (Array Int us_rep4)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_160 Int)) (=> (and (<= a__first temp___idx_160) (<= temp___idx_160 a__last)) (= (bool_eq7 (select a temp___idx_160) (select b (+ (- b__first a__first) temp___idx_160))) true)))) true false))
(assert (forall ((a (Array Int us_rep4)) (b (Array Int us_rep4))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq8 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_160 Int)) (=> (and (<= a__first temp___idx_160) (<= temp___idx_160 a__last)) (= (bool_eq7 (select a temp___idx_160) (select b (+ (- b__first a__first) temp___idx_160))) true))))))))
...
(define-fun dynamic_invariant2 ((temp___expr_286 Int) (temp___is_init_282 Bool) (temp___skip_constant_283 Bool) (temp___do_toplevel_284 Bool) (temp___do_typ_inv_285 Bool)) Bool (=> (or (= temp___is_init_282 true) (<= 0 100)) (in_range4 temp___expr_286)))
...
(define-fun dynamic_invariant3 ((temp___expr_210 Int) (temp___is_init_206 Bool) (temp___skip_constant_207 Bool) (temp___do_toplevel_208 Bool) (temp___do_typ_inv_209 Bool)) Bool (=> (or (= temp___is_init_206 true) (<= 0 100)) (in_range3 temp___expr_210)))
...
(define-fun dynamic_invariant4 ((temp___expr_313 Int) (temp___is_init_309 Bool) (temp___skip_constant_310 Bool) (temp___do_toplevel_311 Bool) (temp___do_typ_inv_312 Bool)) Bool (=> (or (= temp___is_init_309 true) (<= 0 100)) (in_range5 temp___expr_313)))
...
(declare-const temp___475 (Array Int us_rep3))
(declare-const temp___474 Int)
(declare-const temp___473 (Array Int us_rep))
...
(declare-const temp___485 (Array Int us_rep4))
(declare-const temp___484 Int)
(declare-const temp___482 (Array Int us_rep1))
(declare-const o6 us_rep1)
(declare-const o7 Int)
(declare-const temp___483 (Array Int us_rep1))
...
(assert (= s2 0))
(assert (=> (and (<= 0 s2) (<= s2 100)) (= temp___475 av1)))
(assert (=> (and (<= 0 s2) (<= s2 100)) (= temp___474 s2)))
...
(assert (=> (and (<= 0 s2) (<= s2 100)) (and (= temp___473 (owned_state sm)) (= temp___473 (rec__model__uml_state_machine__owned_state_data (us_split_fields5 sm))))))
(assert (=> (and (<= 0 s2) (<= s2 100)) (= o10 (select temp___473 s3))))
...
(assert (= s8 0))
(assert (=> (and (<= 0 s8) (<= s8 100)) (= temp___485 cfv1)))
(assert (=> (and (<= 0 s8) (<= s8 100)) (= temp___484 s8)))
...
(assert (=> (and (<= 0 s8) (<= s8 100)) (and (= temp___482 (owned_transition sm)) (= temp___482 (rec__model__uml_state_machine__owned_transition_data (us_split_fields5 sm))))))
(assert (=> (and (<= 0 s8) (<= s8 100)) (= o6 (select temp___482 s9))))
...
(assert (=> (and (<= 0 s8) (<= s8 100)) (and (= temp___483 (owned_transition sm)) (= temp___483 (rec__model__uml_state_machine__owned_transition_data (us_split_fields5 sm))))))
(assert (=> (and (<= 0 s8) (<= s8 100)) (= o8 (select temp___483 s9))))
...
(assert (and (= (bool_eq6 (owned_action (mk___rep5 act__split_fields3)) 0 100 (map__content2 av6) 0 100) true) (= (bool_eq8 (owned_flow (mk___rep5 act__split_fields3)) 0 100 (owned_flow (mk___rep5 act__split_fields2)) 0 100) true)))
(assert (and (= (bool_eq8 (owned_flow (mk___rep5 act__split_fields4)) 0 100 (map__content3 cfv7) 0 100) true) (= (bool_eq6 (owned_action (mk___rep5 act__split_fields4)) 0 100 (owned_action (mk___rep5 act__split_fields3)) 0 100) true)))
