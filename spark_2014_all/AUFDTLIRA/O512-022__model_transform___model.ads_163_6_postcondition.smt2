...
(assert (=> (and (<= 0 s8) (<= s8 100)) (and (= temp___443 (owned_transition sm)) (= temp___443 (rec__model__uml_state_machine__owned_transition_data (us_split_fields5 sm))))))
...
(assert (=> (and (<= 0 s8) (<= s8 100)) (and (= temp___444 (owned_transition sm)) (= temp___444 (rec__model__uml_state_machine__owned_transition_data (us_split_fields5 sm))))))
