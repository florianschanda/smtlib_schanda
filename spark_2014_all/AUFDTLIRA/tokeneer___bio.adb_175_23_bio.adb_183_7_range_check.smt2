...
(assert (=> (= (length (mk___t temp___919 temp___9191)) 0) (= (elts (to_string (attr__ATTRIBUTE_IMAGE4 returnvalue))) temp___922)))
(assert (=> (= (length (mk___t temp___919 temp___9191)) 0) (= (mk (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE4 returnvalue))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE4 returnvalue)))))) temp___9221)))
(assert (=> (not (= (length (mk___t temp___919 temp___9191)) 0)) (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE4 returnvalue))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE4 returnvalue)))))) (= o19 (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE4 returnvalue))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE4 returnvalue)))))) 1)))))
(assert (=> (not (= (length (mk___t temp___919 temp___9191)) 0)) (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE4 returnvalue))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE4 returnvalue))))))) (= o19 0))))
(assert (=> (not (= (length (mk___t temp___919 temp___9191)) 0)) (=> (<= (to_rep1 (first temp___9191)) (to_rep1 (last temp___9191))) (= o20 (+ (- (to_rep1 (last temp___9191)) (to_rep1 (first temp___9191))) 1)))))
(assert (=> (not (= (length (mk___t temp___919 temp___9191)) 0)) (=> (not (<= (to_rep1 (first temp___9191)) (to_rep1 (last temp___9191)))) (= o20 0))))
(assert (=> (not (= (length (mk___t temp___919 temp___9191)) 0)) (= o21 (+ o20 o19))))
(assert (=> (not (= (length (mk___t temp___919 temp___9191)) 0)) (= o22 (+ (to_rep1 (first temp___9191)) o21))))
(assert (=> (not (= (length (mk___t temp___919 temp___9191)) 0)) (= o23 (- o22 1))))
(assert (=> (not (= (length (mk___t temp___919 temp___9191)) 0)) (and (= o24 o23) (in_range2 o23))))
(assert (=> (not (= (length (mk___t temp___919 temp___9191)) 0)) (= (concat1 temp___919 (to_rep1 (first temp___9191)) (to_rep1 (last temp___9191)) (elts (to_string (attr__ATTRIBUTE_IMAGE4 returnvalue))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE4 returnvalue))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE4 returnvalue)))))) temp___922)))
(assert (=> (not (= (length (mk___t temp___919 temp___9191)) 0)) (= (mk (to_rep1 (first temp___9191)) o24) temp___9221)))
(assert (=> (= (length (mk___t temp___922 temp___9221)) 0) (= (temp___String_Literal_921 Tuple0) bio__makedescription__B33b__fullstring__assume)))
(assert (=> (= (length (mk___t temp___922 temp___9221)) 0) (= (mk 1 2) bio__makedescription__B33b__fullstring__assume1)))
(assert (=> (not (= (length (mk___t temp___922 temp___9221)) 0)) (=> (<= 1 2) (= o25 (+ (- 2 1) 1)))))
(assert (=> (not (= (length (mk___t temp___922 temp___9221)) 0)) (=> (not (<= 1 2)) (= o25 0))))
(assert (=> (not (= (length (mk___t temp___922 temp___9221)) 0)) (=> (<= (to_rep1 (first temp___9221)) (to_rep1 (last temp___9221))) (= o26 (+ (- (to_rep1 (last temp___9221)) (to_rep1 (first temp___9221))) 1)))))
(assert (=> (not (= (length (mk___t temp___922 temp___9221)) 0)) (=> (not (<= (to_rep1 (first temp___9221)) (to_rep1 (last temp___9221)))) (= o26 0))))
(assert (=> (not (= (length (mk___t temp___922 temp___9221)) 0)) (= o27 (+ o26 o25))))
(assert (=> (not (= (length (mk___t temp___922 temp___9221)) 0)) (= o28 (+ (to_rep1 (first temp___9221)) o27))))
(assert (=> (not (= (length (mk___t temp___922 temp___9221)) 0)) (= o29 (- o28 1))))
(assert (=> (not (= (length (mk___t temp___922 temp___9221)) 0)) (and (= o30 o29) (in_range2 o29))))
(assert (=> (not (= (length (mk___t temp___922 temp___9221)) 0)) (= (concat1 temp___922 (to_rep1 (first temp___9221)) (to_rep1 (last temp___9221)) (temp___String_Literal_921 Tuple0) 1 2) bio__makedescription__B33b__fullstring__assume)))
(assert (=> (not (= (length (mk___t temp___922 temp___9221)) 0)) (= (mk (to_rep1 (first temp___9221)) o30) bio__makedescription__B33b__fullstring__assume1)))
(assert (= result6 (mk_map__ref fullstring)))
(assert (= fullstring1 bio__makedescription__B33b__fullstring__assume))
(assert (= (to_rep1 fullstring__first) (to_rep1 (first bio__makedescription__B33b__fullstring__assume1))))
(assert (= (to_rep1 fullstring__last) (to_rep1 (last bio__makedescription__B33b__fullstring__assume1))))
