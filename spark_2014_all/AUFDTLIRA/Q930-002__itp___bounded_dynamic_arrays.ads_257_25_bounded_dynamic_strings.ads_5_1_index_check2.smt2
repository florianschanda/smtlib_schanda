...
(define-fun dynamic_invariant2 ((temp___expr_192 Int) (temp___is_init_188 Bool) (temp___skip_constant_189 Bool) (temp___do_toplevel_190 Bool) (temp___do_typ_inv_191 Bool)) Bool (=> (or (= temp___is_init_188 true) (<= 0 255)) (in_range4 temp___expr_192)))
...
(assert (and (= o (length1 within)) (and (in_range2 o) (= o (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 within)))))))
(assert (= o1 (ite (<= k o) true false)))
(assert (= result (ite (<= 1 k) o1 false)))
(assert (= result true))
(assert (not (<= (to_rep2 (first (rt (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))) k)))
(check-sat)
(exit)
