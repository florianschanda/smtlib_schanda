...
(assert (forall ((i t29b)) (and (<= 6 (t29bqtint i)) (<= (t29bqtint i) 10))))
...
(assert (forall ((i t31b)) (and (<= 1 (t31bqtint i)) (<= (t31bqtint i) 5))))
...
(assert (forall ((i t36b)) (and (<= 6 (t36bqtint i)) (<= (t36bqtint i) 10))))
...
(declare-sort t38b 0)
(declare-fun t38bqtint (t38b) Int)
(assert (forall ((i t38b)) (and (<= 1 (t38bqtint i)) (<= (t38bqtint i) 5))))
...
(assert (= temp___223 x))
(assert (=> (<= 6 10) (and (and (<= 1 6) (<= 6 10)) (and (<= 1 10) (<= 10 10)))))
(assert (= temp___222 x))
(assert (=> (<= 1 5) (= o (+ (- 5 1) 1))))
(assert (=> (not (<= 1 5)) (= o 0)))
...
(assert (= (concat1 temp___222 6 10 temp___223 1 5) temp___224))
(assert (= (mk 6 o5) temp___2241))
(assert (= (ite (<= (to_rep (first temp___2241)) (to_rep (last temp___2241))) (+ (- (to_rep (last temp___2241)) (to_rep (first temp___2241))) 1) 0) (ite (<= 1 10) (+ (- 10 1) 1) 0)))
(assert (= o6 (slide temp___224 (to_rep (first temp___2241)) 1)))
(assert (= (mk_map__ref result) (mk_map__ref d)))
(assert (= d1 o6))
(assert (= (to_rep (select d1 1)) (to_rep (select x 6))))
(assert (= (to_rep (select d1 6)) (to_rep (select x 1))))
(assert (<= 1 5))
(assert (not (<= 1 1)))
(check-sat)
(exit)
