...
(define-fun o8 () us_rep1 (mk___rep1 (mk___split_discrs o4) (mk___split_fields1 o5)))
...
(assert (= o8 temp___2472))
(assert (= (mk___rep1 (mk___split_discrs o6) (mk___split_fields1 o7)) o8))
(assert (not (= 101 (to_rep o6))))
(check-sat)
(exit)
