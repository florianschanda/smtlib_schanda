...
(assert (and (= o41 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (and (in_range5 o41) (<= (+ 0 o41) 2147483647))))
(assert (= result6 (ite (< 0 o41) true false)))
(assert (= result6 true))
(assert (not (<= 1 1)))
(check-sat)
(exit)
