...
(assert (and (= o1 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (and (in_range5 o1) (<= (+ 0 o1) 2147483647))))
(assert (= result (ite (<= o1 10000) true false)))
(assert (= result true))
