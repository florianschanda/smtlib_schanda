...
(declare-fun temp___967 ((Array Int (Array Int et1)) Int (Array Int et1) Int (Array Int et1)) (Array Int (Array Int et1)))
(assert (forall ((temp___969 (Array Int (Array Int et1)))) (forall ((temp___970 Int) (temp___972 Int)) (forall ((temp___971 (Array Int et1)) (temp___973 (Array Int et1))) (let ((temp___968 (temp___967 temp___969 temp___970 temp___971 temp___972 temp___973))) (forall ((temp___974 Int)) (ite (= temp___974 temp___972) (= (select temp___968 temp___974) temp___973) (ite (= temp___974 temp___970) (= (select temp___968 temp___974) temp___971) (= (select temp___968 temp___974) (select temp___969 temp___974))))))))))
(declare-fun temp___975 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___977 (Array Int et1))) (forall ((temp___978 Int) (temp___979 Int)) (let ((temp___976 (temp___975 temp___977 temp___978 temp___979))) (forall ((temp___980 Int)) (ite (= temp___980 temp___978) (= (select temp___976 temp___980) (of_rep temp___979)) (= (select temp___976 temp___980) (select temp___977 temp___980))))))))
(declare-fun temp___982 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___984 (Array Int et1))) (forall ((temp___985 Int) (temp___986 Int)) (let ((temp___983 (temp___982 temp___984 temp___985 temp___986))) (forall ((temp___987 Int)) (ite (= temp___987 temp___985) (= (select temp___983 temp___987) (of_rep temp___986)) (= (select temp___983 temp___987) (select temp___984 temp___987))))))))
(declare-fun temp___990 ((Array Int (Array Int et1)) Int (Array Int et1) Int (Array Int et1)) (Array Int (Array Int et1)))
(assert (forall ((temp___992 (Array Int (Array Int et1)))) (forall ((temp___993 Int) (temp___995 Int)) (forall ((temp___994 (Array Int et1)) (temp___996 (Array Int et1))) (let ((temp___991 (temp___990 temp___992 temp___993 temp___994 temp___995 temp___996))) (forall ((temp___997 Int)) (ite (= temp___997 temp___995) (= (select temp___991 temp___997) temp___996) (ite (= temp___997 temp___993) (= (select temp___991 temp___997) temp___994) (= (select temp___991 temp___997) (select temp___992 temp___997))))))))))
(declare-fun temp___998 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___1000 (Array Int et1))) (forall ((temp___1001 Int) (temp___1002 Int)) (let ((temp___999 (temp___998 temp___1000 temp___1001 temp___1002))) (forall ((temp___1003 Int)) (ite (= temp___1003 temp___1001) (= (select temp___999 temp___1003) (of_rep temp___1002)) (= (select temp___999 temp___1003) (select temp___1000 temp___1003))))))))
(declare-fun temp___1005 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___1007 (Array Int et1))) (forall ((temp___1008 Int) (temp___1009 Int)) (let ((temp___1006 (temp___1005 temp___1007 temp___1008 temp___1009))) (forall ((temp___1010 Int)) (ite (= temp___1010 temp___1008) (= (select temp___1006 temp___1010) (of_rep temp___1009)) (= (select temp___1006 temp___1010) (select temp___1007 temp___1010))))))))
(declare-fun temp___1013 ((Array Int (Array Int et1)) Int (Array Int et1) Int (Array Int et1)) (Array Int (Array Int et1)))
(assert (forall ((temp___1015 (Array Int (Array Int et1)))) (forall ((temp___1016 Int) (temp___1018 Int)) (forall ((temp___1017 (Array Int et1)) (temp___1019 (Array Int et1))) (let ((temp___1014 (temp___1013 temp___1015 temp___1016 temp___1017 temp___1018 temp___1019))) (forall ((temp___1020 Int)) (ite (= temp___1020 temp___1018) (= (select temp___1014 temp___1020) temp___1019) (ite (= temp___1020 temp___1016) (= (select temp___1014 temp___1020) temp___1017) (= (select temp___1014 temp___1020) (select temp___1015 temp___1020))))))))))
(declare-fun temp___1021 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___1023 (Array Int et1))) (forall ((temp___1024 Int) (temp___1025 Int)) (let ((temp___1022 (temp___1021 temp___1023 temp___1024 temp___1025))) (forall ((temp___1026 Int)) (ite (= temp___1026 temp___1024) (= (select temp___1022 temp___1026) (of_rep temp___1025)) (= (select temp___1022 temp___1026) (select temp___1023 temp___1026))))))))
(declare-fun temp___1028 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___1030 (Array Int et1))) (forall ((temp___1031 Int) (temp___1032 Int)) (let ((temp___1029 (temp___1028 temp___1030 temp___1031 temp___1032))) (forall ((temp___1033 Int)) (ite (= temp___1033 temp___1031) (= (select temp___1029 temp___1033) (of_rep temp___1032)) (= (select temp___1029 temp___1033) (select temp___1030 temp___1033))))))))
(declare-fun temp___1036 ((Array Int (Array Int et1)) Int (Array Int et1) Int (Array Int et1)) (Array Int (Array Int et1)))
(assert (forall ((temp___1038 (Array Int (Array Int et1)))) (forall ((temp___1039 Int) (temp___1041 Int)) (forall ((temp___1040 (Array Int et1)) (temp___1042 (Array Int et1))) (let ((temp___1037 (temp___1036 temp___1038 temp___1039 temp___1040 temp___1041 temp___1042))) (forall ((temp___1043 Int)) (ite (= temp___1043 temp___1041) (= (select temp___1037 temp___1043) temp___1042) (ite (= temp___1043 temp___1039) (= (select temp___1037 temp___1043) temp___1040) (= (select temp___1037 temp___1043) (select temp___1038 temp___1043))))))))))
(declare-fun temp___1044 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___1046 (Array Int et1))) (forall ((temp___1047 Int) (temp___1048 Int)) (let ((temp___1045 (temp___1044 temp___1046 temp___1047 temp___1048))) (forall ((temp___1049 Int)) (ite (= temp___1049 temp___1047) (= (select temp___1045 temp___1049) (of_rep temp___1048)) (= (select temp___1045 temp___1049) (select temp___1046 temp___1049))))))))
(declare-fun temp___1051 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___1053 (Array Int et1))) (forall ((temp___1054 Int) (temp___1055 Int)) (let ((temp___1052 (temp___1051 temp___1053 temp___1054 temp___1055))) (forall ((temp___1056 Int)) (ite (= temp___1056 temp___1054) (= (select temp___1052 temp___1056) (of_rep temp___1055)) (= (select temp___1052 temp___1056) (select temp___1053 temp___1056))))))))
(declare-fun temp___4639 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
(assert (forall ((temp___4641 (Array Int (Array Int et1)))) (forall ((temp___4642 Int)) (forall ((temp___4643 (Array Int et1))) (let ((temp___4640 (temp___4639 temp___4641 temp___4642 temp___4643))) (forall ((temp___4644 Int)) (ite (= temp___4644 temp___4642) (= (select temp___4640 temp___4644) temp___4643) (= (select temp___4640 temp___4644) (select temp___4641 temp___4644)))))))))
(declare-fun temp___4645 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___4647 (Array Int et1))) (forall ((temp___4648 Int) (temp___4649 Int)) (let ((temp___4646 (temp___4645 temp___4647 temp___4648 temp___4649))) (forall ((temp___4650 Int)) (ite (= temp___4650 temp___4648) (= (select temp___4646 temp___4650) (of_rep temp___4649)) (= (select temp___4646 temp___4650) (select temp___4647 temp___4650))))))))
...
(declare-const temp___4667 (Array Int (Array Int et1)))
(declare-const o13 Int)
(declare-const o14 Int)
(declare-const o15 (Array Int et1))
(declare-const o16 (Array Int et1))
(declare-const o17 Int)
(declare-const temp___4662 (Array Int (Array Int et1)))
...
(assert (in_range1 j))
(assert (in_range2 e))
(assert (and (and (=> (<= 5 50) (in_range1 j_next)) (and (=> (<= 0 99) (in_range2 f)) (and (= (bool_eq1 a1 5 50 (temp___4639 t1 j (temp___4645 (select t1 j) i e)) 5 50) true) (and (ite (= j 50) (and (= (mk_int__ref result2) (mk_int__ref j_next)) (= j_next1 5)) (and (and (and (= o3 (+ j 1)) (in_range1 (+ j 1))) (and (= (mk_int__ref result3) (mk_int__ref j_next)) (= j_next2 o3))) (= j_next1 j_next2))) (and (ite (= e 0) (and (= (mk_int__ref result4) (mk_int__ref f)) (= f1 99)) (and (and (and (= o4 (- e 1)) (in_range2 (- e 1))) (and (= (mk_int__ref result5) (mk_int__ref f)) (= f2 o4))) (= f1 f2))) (and (and (and (= (to_rep o5) f1) (= o6 (store (select a1 j_next1) i o5))) (= o7 (store a1 j_next1 o6))) (and (= a1 result6) (= a2 o7)))))))) (and (and (= t1 t2) (and (= f1 f3) (and (= j_next1 j_next3) (= a2 a3)))) (and (= t3 t1) (and (= f4 f1) (and (= j_next4 j_next1) (= a4 a2)))))))
(assert (=> (< j 50) (=> (< 0 e) (and (= o14 (- e 1)) (in_range2 (- e 1))))))
(assert (=> (< j 50) (=> (< 0 e) (and (<= 5 (+ j 1)) (<= (+ j 1) 50)))))
(assert (=> (< j 50) (=> (< 0 e) (= o13 (+ j 1)))))
(assert (=> (< j 50) (=> (< 0 e) (= o15 (select a o13)))))
(assert (=> (< j 50) (=> (< 0 e) (= o16 (temp___982 o15 i o14)))))
(assert (=> (< j 50) (=> (< 0 e) (and (= o17 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (< j 50) (=> (< 0 e) (= temp___4662 (temp___967 a j (temp___975 (select a j) i e) o17 o16)))))
(assert (=> (< j 50) (=> (< 0 e) (= result8 (bool_eq1 a3 5 50 temp___4662 5 50)))))
(assert (=> (< j 50) (=> (not (< 0 e)) (= result8 false))))
(assert (=> (< j 50) (=> (= result8 true) (= result7 true))))
(assert (=> (< j 50) (=> (not (= result8 true)) (=> (= e 0) (and (<= 5 (+ j 1)) (<= (+ j 1) 50))))))
(assert (=> (< j 50) (=> (not (= result8 true)) (=> (= e 0) (= o9 (+ j 1))))))
(assert (=> (< j 50) (=> (not (= result8 true)) (=> (= e 0) (= o10 (select a o9))))))
(assert (=> (< j 50) (=> (not (= result8 true)) (=> (= e 0) (= o11 (temp___1005 o10 i 99))))))
(assert (=> (< j 50) (=> (not (= result8 true)) (=> (= e 0) (and (= o12 (+ j 1)) (in_range1 (+ j 1)))))))
(assert (=> (< j 50) (=> (not (= result8 true)) (=> (= e 0) (= temp___4667 (temp___990 a j (temp___998 (select a j) i e) o12 o11))))))
(assert (=> (< j 50) (=> (not (= result8 true)) (=> (= e 0) (= result7 (bool_eq1 a3 5 50 temp___4667 5 50))))))
(assert (=> (< j 50) (=> (not (= result8 true)) (=> (not (= e 0)) (= result7 false)))))
(assert (=> (not (< j 50)) (= result7 false)))
