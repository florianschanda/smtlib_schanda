...
(declare-const temp___5441 less_than_max)
(declare-const temp___5442 us_private)
(declare-const temp___5443 Int)
...
(assert (= (to_rep1 o5) e))
(assert (and (<= 1 (to_rep2 s__split_fields4)) (<= (to_rep2 s__split_fields4) 100)))
(assert (= o6 (to_rep2 s__split_fields4)))
(assert (= o7 (store s__split_fields3 o6 o5)))
(assert (= o7 o8))
(assert (= s__split_fields4 o9))
(assert (= s__split_fields5 o10))
(assert (= temp___544 o8))
(assert (= temp___5441 o9))
(assert (= temp___5442 o10))
(assert (= s__attr__tag temp___5443))
(assert (= result3 s__split_fields3))
(assert (= result4 s__split_fields4))
(assert (= result5 s__split_fields5))
(assert (= temp___544 s__split_fields6))
(assert (= temp___5441 s__split_fields7))
(assert (= temp___5442 s__split_fields8))
...
(assert (not (= (let ((temp___548 (get_model__2 (mk___rep (mk___split_fields s__split_fields9 s__split_fields10 s__split_fields11) s__attr__tag)))) (bool_eq (elts temp___548) (to_rep (first (rt temp___548))) (to_rep (last (rt temp___548))) (let ((temp___547 (get_model__2 (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag)))) (ite (= (length temp___547) 0) (singleton1 (of_rep1 e) 1) (concat_singleton_right (elts temp___547) (to_rep (first (rt temp___547))) (to_rep (last (rt temp___547))) (of_rep1 e)))) (to_rep (first (let ((temp___547 (get_model__2 (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag)))) (ite (= (length temp___547) 0) (mk 1 1) (mk (to_rep (first (rt temp___547))) (- (+ (to_rep (first (rt temp___547))) (+ (ite (<= (to_rep (first (rt temp___547))) (to_rep (last (rt temp___547)))) (+ (- (to_rep (last (rt temp___547))) (to_rep (first (rt temp___547)))) 1) 0) 1)) 1)))))) (to_rep (last (let ((temp___547 (get_model__2 (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag)))) (ite (= (length temp___547) 0) (mk 1 1) (mk (to_rep (first (rt temp___547))) (- (+ (to_rep (first (rt temp___547))) (+ (ite (<= (to_rep (first (rt temp___547))) (to_rep (last (rt temp___547)))) (+ (- (to_rep (last (rt temp___547))) (to_rep (first (rt temp___547)))) 1) 0) 1)) 1)))))))) true)))
(check-sat)
(exit)
