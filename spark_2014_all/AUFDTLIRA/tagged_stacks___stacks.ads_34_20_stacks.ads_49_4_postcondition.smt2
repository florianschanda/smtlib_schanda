...
(assert (and (= o (+ (to_rep s__split_fields1) 1)) (in_range1 (+ (to_rep s__split_fields1) 1))))
(assert (= (to_rep o1) o))
...
(assert (not (= (let ((temp___548 (get_model__2 (mk___rep (mk___split_fields s__split_fields9 s__split_fields10 s__split_fields11) s__attr__tag)))) (bool_eq (elts temp___548) (to_rep2 (first (rt temp___548))) (to_rep2 (last (rt temp___548))) (let ((temp___547 (get_model__2 (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag)))) (ite (= (length temp___547) 0) (singleton1 (of_rep1 e) 1) (concat_singleton_right (elts temp___547) (to_rep2 (first (rt temp___547))) (to_rep2 (last (rt temp___547))) (of_rep1 e)))) (to_rep2 (first (let ((temp___547 (get_model__2 (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag)))) (ite (= (length temp___547) 0) (mk 1 1) (mk (to_rep2 (first (rt temp___547))) (- (+ (to_rep2 (first (rt temp___547))) (+ (ite (<= (to_rep2 (first (rt temp___547))) (to_rep2 (last (rt temp___547)))) (+ (- (to_rep2 (last (rt temp___547))) (to_rep2 (first (rt temp___547)))) 1) 0) 1)) 1)))))) (to_rep2 (last (let ((temp___547 (get_model__2 (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag)))) (ite (= (length temp___547) 0) (mk 1 1) (mk (to_rep2 (first (rt temp___547))) (- (+ (to_rep2 (first (rt temp___547))) (+ (ite (<= (to_rep2 (first (rt temp___547))) (to_rep2 (last (rt temp___547)))) (+ (- (to_rep2 (last (rt temp___547))) (to_rep2 (first (rt temp___547)))) 1) 0) 1)) 1)))))))) true)))
(check-sat)
(exit)
