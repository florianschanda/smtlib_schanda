...
(assert (= rank3 o9))
(assert (and (<= 1 (- rank3 1)) (<= (- rank3 1) 64)))
(assert (= o15 (- rank3 1)))
(assert (= o16 (select (select ranking_1 g11) o15)))
(assert (= o17 (to_rep1 o16)))
(assert (= o18 (select ranking_2 o17)))
(assert (and (<= 1 (- rank3 1)) (<= (- rank3 1) 64)))
(assert (= o10 (- rank3 1)))
(assert (= o11 (select (select ranking_1 g11) o10)))
(assert (= o12 (to_rep1 o11)))
(assert (= o13 (select result__ o12)))
(assert (= o14 (to_rep o13)))
(assert (not (= (is_permutation_1 o18) true)))
(check-sat)
(exit)
