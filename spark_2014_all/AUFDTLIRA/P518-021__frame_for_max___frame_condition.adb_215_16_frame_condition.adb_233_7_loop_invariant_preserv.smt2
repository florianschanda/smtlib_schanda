...
(assert (not (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a4 j5)))) (to_rep (rec__frame_condition__cell__max_right (us_split_fields1 (select a4 i11)))))))
(check-sat)
(exit)
