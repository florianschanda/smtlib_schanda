...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_523 us_void_param) 1)) 69) (= (to_rep (select (temp___String_Literal_523 us_void_param) 2)) 110)) (= (to_rep (select (temp___String_Literal_523 us_void_param) 3)) 116)) (= (to_rep (select (temp___String_Literal_523 us_void_param) 4)) 101)) (= (to_rep (select (temp___String_Literal_523 us_void_param) 5)) 114)) (= (to_rep (select (temp___String_Literal_523 us_void_param) 6)) 32)) (= (to_rep (select (temp___String_Literal_523 us_void_param) 7)) 97)) (= (to_rep (select (temp___String_Literal_523 us_void_param) 8)) 32)) (= (to_rep (select (temp___String_Literal_523 us_void_param) 9)) 108)) (= (to_rep (select (temp___String_Literal_523 us_void_param) 10)) 105)) (= (to_rep (select (temp___String_Literal_523 us_void_param) 11)) 110)) (= (to_rep (select (temp___String_Literal_523 us_void_param) 12)) 101)) (= (to_rep (select (temp___String_Literal_523 us_void_param) 13)) 46)) :pattern ((temp___String_Literal_523 us_void_param)))))
(declare-fun temp___String_Literal_534 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_534 us_void_param) 1)) 105) (= (to_rep (select (temp___String_Literal_534 us_void_param) 2)) 115)) (= (to_rep (select (temp___String_Literal_534 us_void_param) 3)) 32)) (= (to_rep (select (temp___String_Literal_534 us_void_param) 4)) 110)) (= (to_rep (select (temp___String_Literal_534 us_void_param) 5)) 111)) (= (to_rep (select (temp___String_Literal_534 us_void_param) 6)) 116)) (= (to_rep (select (temp___String_Literal_534 us_void_param) 7)) 32)) (= (to_rep (select (temp___String_Literal_534 us_void_param) 8)) 97)) (= (to_rep (select (temp___String_Literal_534 us_void_param) 9)) 32)) (= (to_rep (select (temp___String_Literal_534 us_void_param) 10)) 112)) (= (to_rep (select (temp___String_Literal_534 us_void_param) 11)) 97)) (= (to_rep (select (temp___String_Literal_534 us_void_param) 12)) 108)) (= (to_rep (select (temp___String_Literal_534 us_void_param) 13)) 105)) (= (to_rep (select (temp___String_Literal_534 us_void_param) 14)) 110)) (= (to_rep (select (temp___String_Literal_534 us_void_param) 15)) 100)) (= (to_rep (select (temp___String_Literal_534 us_void_param) 16)) 114)) (= (to_rep (select (temp___String_Literal_534 us_void_param) 17)) 111)) (= (to_rep (select (temp___String_Literal_534 us_void_param) 18)) 109)) (= (to_rep (select (temp___String_Literal_534 us_void_param) 19)) 101)) :pattern ((temp___String_Literal_534 us_void_param)))))
(declare-fun temp___String_Literal_535 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_535 us_void_param) 1)) 105) (= (to_rep (select (temp___String_Literal_535 us_void_param) 2)) 115)) (= (to_rep (select (temp___String_Literal_535 us_void_param) 3)) 32)) (= (to_rep (select (temp___String_Literal_535 us_void_param) 4)) 97)) (= (to_rep (select (temp___String_Literal_535 us_void_param) 5)) 32)) (= (to_rep (select (temp___String_Literal_535 us_void_param) 6)) 112)) (= (to_rep (select (temp___String_Literal_535 us_void_param) 7)) 97)) (= (to_rep (select (temp___String_Literal_535 us_void_param) 8)) 108)) (= (to_rep (select (temp___String_Literal_535 us_void_param) 9)) 105)) (= (to_rep (select (temp___String_Literal_535 us_void_param) 10)) 110)) (= (to_rep (select (temp___String_Literal_535 us_void_param) 11)) 100)) (= (to_rep (select (temp___String_Literal_535 us_void_param) 12)) 114)) (= (to_rep (select (temp___String_Literal_535 us_void_param) 13)) 111)) (= (to_rep (select (temp___String_Literal_535 us_void_param) 14)) 109)) (= (to_rep (select (temp___String_Literal_535 us_void_param) 15)) 101)) :pattern ((temp___String_Literal_535 us_void_param)))))
...
(declare-const temp___529 (Array Int character))
(declare-const temp___5291 t3)
(declare-const o9 Int)
(declare-const o10 character)
(declare-const o11 (Array Int character))
(declare-const temp___531 (Array Int character))
(declare-const temp___5311 t4)
...
(assert (=> (not (<= right_index2 left_index2)) (= o11 temp___531)))
(assert (=> (not (<= right_index2 left_index2)) (= (mk4 1 r5b) temp___5311)))
(assert (=> (not (<= right_index2 left_index2)) (and (<= (to_rep1 (first8 temp___5311)) left_index2) (<= left_index2 (to_rep1 (last8 temp___5311))))))
(assert (=> (not (<= right_index2 left_index2)) (= o12 left_index2)))
(assert (=> (not (<= right_index2 left_index2)) (= o13 (select temp___531 o12))))
(assert (=> (not (<= right_index2 left_index2)) (= o14 (to_rep o13))))
(assert (=> (not (<= right_index2 left_index2)) (=> (<= 1 r5b) (and (and (<= 1 1) (<= 1 100)) (and (<= 1 r5b) (<= r5b 100))))))
(assert (=> (not (<= right_index2 left_index2)) (= o8 line1)))
(assert (=> (not (<= right_index2 left_index2)) (= o8 temp___529)))
(assert (=> (not (<= right_index2 left_index2)) (= (mk3 1 r5b) temp___5291)))
(assert (=> (not (<= right_index2 left_index2)) (and (<= (to_rep1 (first6 temp___5291)) right_index2) (<= right_index2 (to_rep1 (last6 temp___5291))))))
(assert (=> (not (<= right_index2 left_index2)) (= o9 right_index2)))
(assert (=> (not (<= right_index2 left_index2)) (= o10 (select temp___529 o9))))
...
(assert (not (in_range (+ left_index2 1))))
(check-sat)
(exit)
