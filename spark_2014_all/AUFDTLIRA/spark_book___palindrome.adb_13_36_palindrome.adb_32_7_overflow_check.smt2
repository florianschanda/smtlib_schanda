...
(declare-const temp___535 (Array Int character))
(declare-const temp___5351 t3)
...
(assert (=> (not (<= right_index2 left_index2)) (= o11 temp___537)))
(assert (=> (not (<= right_index2 left_index2)) (= (mk4 1 r5b) temp___5371)))
(assert (=> (not (<= right_index2 left_index2)) (and (<= (to_rep1 (first8 temp___5371)) left_index2) (<= left_index2 (to_rep1 (last8 temp___5371))))))
(assert (=> (not (<= right_index2 left_index2)) (= o12 left_index2)))
(assert (=> (not (<= right_index2 left_index2)) (= o13 (select temp___537 o12))))
(assert (=> (not (<= right_index2 left_index2)) (= o14 (to_rep o13))))
(assert (=> (not (<= right_index2 left_index2)) (=> (<= 1 r5b) (and (and (<= 1 1) (<= 1 100)) (and (<= 1 r5b) (<= r5b 100))))))
(assert (=> (not (<= right_index2 left_index2)) (= o8 line1)))
(assert (=> (not (<= right_index2 left_index2)) (= o8 temp___535)))
(assert (=> (not (<= right_index2 left_index2)) (= (mk3 1 r5b) temp___5351)))
(assert (=> (not (<= right_index2 left_index2)) (and (<= (to_rep1 (first6 temp___5351)) right_index2) (<= right_index2 (to_rep1 (last6 temp___5351))))))
(assert (=> (not (<= right_index2 left_index2)) (= o9 right_index2)))
(assert (=> (not (<= right_index2 left_index2)) (= o10 (select temp___535 o9))))
