...
(assert (=> (= result4 true) (and (= (has_element (mk___rep c1__split_fields2) temp___2742) true) (= e5 (element (mk___rep c1__split_fields2) temp___2742)))))
(assert (=> (= result4 true) (= e5 1)))
(assert (=> (= result4 true) (and (= o8 (next (mk___rep c1__split_fields2) temp___2742)) (= o8 (temp___176 (+ (to_rep (select temp___2742 1)) 1))))))
(assert (=> (= result4 true) (and (= o9 (has_element (mk___rep c1__split_fields2) o8)) (= (= o9 true) (and (<= 1 (to_rep (select o8 1))) (<= (to_rep (select o8 1)) (to_rep (rec__composite_cursors__cont1__length c1__split_fields2))))))))
(assert (=> (= result4 true) (= result5 (ite (not (= o9 true)) true false))))
(assert (=> (= result4 true) (= result5 true)))
(assert (=> (= result4 true) (= temp___2744 (mk_map__ref temp___2742))))
(assert (=> (= result4 true) (= e6 (mk_int__ref e5))))
(assert (=> (= result4 true) (= temp___2745 temp___2742)))
(assert (=> (= result4 true) (= e7 e5)))
(assert (=> (= result4 true) (= temp___2746 temp___2744)))
(assert (=> (= result4 true) (= e8 e6)))
(assert (=> (= result4 true) (= temp___2747 temp___2745)))
(assert (=> (= result4 true) (= e9 e7)))
(assert (=> (not (= result4 true)) (= temp___2746 (mk_map__ref temp___274))))
(assert (=> (not (= result4 true)) (= e8 (mk_int__ref e4))))
(assert (=> (not (= result4 true)) (= temp___2747 temp___2741)))
(assert (=> (not (= result4 true)) (= e9 e4)))
(assert (and (= (mk___rep1 (mk___split_fields1 o12)) (first__2 (mk___rep2 c2__split_fields2))) (= (of_rep 1) o12)))
(assert (= temp___277 o12))
(assert (and (= result8 (has_element__2 (mk___rep2 c2__split_fields2) (mk___rep1 (mk___split_fields1 temp___277)))) (= (= result8 true) (and (<= 1 (to_rep temp___277)) (<= (to_rep temp___277) (to_rep (rec__composite_cursors__cont2__length c2__split_fields2)))))))
(assert (=> (= result8 true) (and (= o13 (element__2 (mk___rep2 c2__split_fields2) (mk___rep1 (mk___split_fields1 temp___277)))) (and (in_range1 o13) (= o13 (to_rep (select (rec__composite_cursors__cont2__content c2__split_fields2) (to_rep temp___277))))))))
(assert (=> (= result8 true) (= result9 (mk_int__ref e1))))
(assert (=> (= result8 true) (= e10 o13)))
(assert (=> (= result8 true) (= e11 (mk_int__ref e10))))
(assert (=> (= result8 true) (= e12 e10)))
(assert (=> (not (= result8 true)) (= e11 (mk_int__ref e1))))
(assert (=> (not (= result8 true)) (= e12 e3)))
(assert (and (= result10 (has_element__2 (mk___rep2 c2__split_fields2) (mk___rep1 (mk___split_fields1 temp___277)))) (= (= result10 true) (and (<= 1 (to_rep temp___277)) (<= (to_rep temp___277) (to_rep (rec__composite_cursors__cont2__length c2__split_fields2)))))))
(assert (= result10 true))
(assert (and (= (has_element__2 (mk___rep2 c2__split_fields2) temp___2771) true) (= e13 (element__2 (mk___rep2 c2__split_fields2) temp___2771))))
(assert (= e13 1))
(assert (and (= o14 (next__2 (mk___rep2 c2__split_fields2) temp___2771)) (= o14 (mk___rep1 (mk___split_fields1 (of_rep (+ (to_rep (rec__composite_cursors__rec_cursor__content (us_split_fields3 temp___2771))) 1)))))))
(assert (not true))
(check-sat)
(exit)
