...
(assert (= (to_rep o) 32))
(assert (and (<= (to_rep1 a__first) (to_rep1 a__first)) (<= (to_rep1 a__first) (to_rep1 a__last))))
(assert (= o1 (to_rep1 a__first)))
(assert (= o2 (store a o1 o)))
(assert (= result a))
(assert (= a1 o2))
(assert (=> (<= (to_rep1 a__first) (to_rep1 a__last)) (= o3 (+ (- (to_rep1 a__last) (to_rep1 a__first)) 1))))
(assert (=> (not (<= (to_rep1 a__first) (to_rep1 a__last))) (= o3 0)))
