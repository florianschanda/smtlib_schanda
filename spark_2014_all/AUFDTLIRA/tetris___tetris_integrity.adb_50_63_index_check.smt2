...
(assert (<= 0 x1))
(assert (<= x1 3))
(assert (and (forall ((temp___777 Int)) (=> (and (<= 1 temp___777) (<= temp___777 50)) (=> (not (= (+ (to_rep2 cur_piece__split_fields3) y2) temp___777)) (= (select cur_board1 temp___777) (select cur_board temp___777))))) (and (<= 0 x2) (<= x2 3))))
