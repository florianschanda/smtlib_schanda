...
(assert (<= 0 x1))
(assert (<= x1 3))
(assert (and (forall ((temp___773 Int)) (=> (and (<= 1 temp___773) (<= temp___773 50)) (=> (not (= (+ (to_rep3 cur_piece__split_fields3) y2) temp___773)) (= (select cur_board1 temp___773) (select cur_board temp___773))))) (and (<= 0 x2) (<= x2 3))))
