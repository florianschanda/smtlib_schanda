...
(assert (=> (not (= result true)) (and (and (<= (to_rep1 (first (rt s))) courant3) (<= courant3 (to_rep1 (last (rt s))))) (not (exists ((i Int)) (and (and (<= (to_rep1 (first (rt s))) i) (<= i (- courant3 1))) (exists ((j1 Int)) (and (and (<= (to_rep1 (first (rt c))) j1) (<= j1 (to_rep1 (last (rt c))))) (= (to_rep (select (elts s) i)) (to_rep (select (elts c) j1)))))))))))
...
(assert (=> (not (= result true)) (or (and (and (and (= indexbis__result11 (mk_int__ref indexbis__result3)) (= possible4 possible11)) (and (= indexbis__result12 indexbis__result3) (= possible12 possible4))) (and (= temp___176 possible3) (and (and (and (and (and (<= (to_rep1 (first (rt s))) courant3) (<= courant3 (to_rep1 (last (rt s))))) (not (exists ((i Int)) (and (and (<= (to_rep1 (first (rt s))) i) (<= i (- courant3 1))) (exists ((j1 Int)) (and (and (<= (to_rep1 (first (rt c))) j1) (<= j1 (to_rep1 (last (rt c))))) (= (to_rep (select (elts s) i)) (to_rep (select (elts c) j1))))))))) (and (<= (to_rep1 (first (rt c))) possible4) (<= possible4 (to_rep1 (last (rt c)))))) (not (exists ((j1 Int)) (and (and (<= (to_rep1 (first (rt c))) j1) (<= j1 (- possible4 1))) (= (to_rep (select (elts s) courant3)) (to_rep (select (elts c) j1))))))) (and (=> (<= 1 2147483647) (in_range2 possible4)) (and (and (and (and (and (and (<= (to_rep1 (first (rt c))) possible4) (<= possible4 (to_rep1 (last (rt c))))) (= o4 possible4)) (= o5 (select (elts c) o4))) (= o6 (to_rep o5))) (and (and (and (and (and (<= (to_rep1 (first (rt s))) courant3) (<= courant3 (to_rep1 (last (rt s))))) (= o2 courant3)) (= o3 (select (elts s) o2))) (= o7 (to_rep o3))) (= result4 (ite (= o7 o6) true false)))) (and (= result4 true) (and (= indexbis__result2 result5) (= indexbis__result3 courant3)))))))) (and (and (and (and (= temp___176 possible3) (and (and (and (and (and (<= (to_rep1 (first (rt s))) courant3) (<= courant3 (to_rep1 (last (rt s))))) (not (exists ((i Int)) (and (and (<= (to_rep1 (first (rt s))) i) (<= i (- courant3 1))) (exists ((j1 Int)) (and (and (<= (to_rep1 (first (rt c))) j1) (<= j1 (to_rep1 (last (rt c))))) (= (to_rep (select (elts s) i)) (to_rep (select (elts c) j1))))))))) (and (<= (to_rep1 (first (rt c))) possible4) (<= possible4 (to_rep1 (last (rt c)))))) (not (exists ((j1 Int)) (and (and (<= (to_rep1 (first (rt c))) j1) (<= j1 (- possible4 1))) (= (to_rep (select (elts s) courant3)) (to_rep (select (elts c) j1))))))) (and (=> (<= 1 2147483647) (in_range2 possible4)) (and (and (and (= indexbis__result2 indexbis__result4) (= possible4 possible5)) (and (= indexbis__result5 indexbis__result2) (= possible6 possible4))) (and (and (and (and (and (and (<= (to_rep1 (first (rt c))) possible4) (<= possible4 (to_rep1 (last (rt c))))) (= o4 possible4)) (= o5 (select (elts c) o4))) (= o6 (to_rep o5))) (and (and (and (and (and (<= (to_rep1 (first (rt s))) courant3) (<= courant3 (to_rep1 (last (rt s))))) (= o2 courant3)) (= o3 (select (elts s) o2))) (= o7 (to_rep o3))) (= result4 (ite (= o7 o6) true false)))) (and (not (= result4 true)) (not (< possible4 (to_rep1 (last (rt c))))))))))) (and (and (= indexbis__result20 (mk_int__ref indexbis__result4)) (= possible21 (mk_int__ref possible5))) (and (= indexbis__result7 indexbis__result5) (= possible8 possible6)))) (and (and (= indexbis__result19 indexbis__result20) (= possible20 possible21)) (and (= indexbis__result9 indexbis__result7) (= possible10 possible8)))) (and (and (and (= indexbis__result11 (mk_int__ref indexbis__result10)) (= possible19 possible20)) (and (= indexbis__result12 indexbis__result10) (= possible12 possible10))) (and (not (< courant3 (to_rep1 (last (rt s))))) (and (= (mk_int__ref result6) indexbis__result19) (= indexbis__result10 0))))))))
...
(assert (=> (and (<= (to_rep1 (first (rt s))) (int__content indexbis__result17)) (<= (int__content indexbis__result17) (to_rep1 (last (rt s))))) (= (= o8 true) (exists ((i Int)) (and (and (<= (to_rep1 (first (rt s))) i) (<= i (- (int__content indexbis__result17) 1))) (exists ((j1 Int)) (and (and (<= (to_rep1 (first (rt c))) j1) (<= j1 (to_rep1 (last (rt c))))) (= (to_rep (select (elts s) i)) (to_rep (select (elts c) j1))))))))))
(assert (=> (and (<= (to_rep1 (first (rt s))) (int__content indexbis__result17)) (<= (int__content indexbis__result17) (to_rep1 (last (rt s))))) (= result7 (ite (not (= o8 true)) true false))))
(assert (=> (not (and (<= (to_rep1 (first (rt s))) (int__content indexbis__result17)) (<= (int__content indexbis__result17) (to_rep1 (last (rt s)))))) (= result7 false)))
(assert (= result7 true))
