...
(assert (=> (not (= first_available 0)) (and (= o12 (length model____split_fields)) (in_range6 o12))))
(assert (=> (not (= first_available 0)) (= result3 (ite (< 0 o12) true false))))
(assert (=> (not (= first_available 0)) (=> (= result3 true) (and (= o11 (get model____split_fields 1)) (in_range7 o11)))))
...
(assert (=> (not (not (= first_available 0))) (and (= o13 (length model____split_fields)) (in_range6 o13))))
(assert (=> (not (not (= first_available 0))) (= result2 (ite (= o13 0) true false))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (and (= o9 (length model____split_fields1)) (in_range6 o9)))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (= result4 (ite (< 0 o9) true false)))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (=> (= result4 true) (and (= o8 (get model____split_fields1 1)) (in_range7 o8))))))
...
(assert (=> (= result2 true) (=> (not (not (= first_allocated 0))) (and (= o10 (length model____split_fields1)) (in_range6 o10)))))
(assert (=> (= result2 true) (=> (not (not (= first_allocated 0))) (= result1 (ite (= o10 0) true false)))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (=> (= result1 true) (and (= o6 (length model____split_fields)) (in_range6 o6))))
...
(assert (=> (= result8 true) (and (= o4 (get model____split_fields1 o3)) (in_range7 o4))))
(assert (=> (not (= result8 true)) (= o4 0)))
(assert (and (= temp___387 (get model____split_fields1 j)) (in_range7 temp___387)))
(assert (not (<= 1 temp___387)))
(check-sat)
(exit)
