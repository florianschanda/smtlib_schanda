...
(assert (= perm__get_witness__result13 (mk_int__ref perm__get_witness__result7)))
(assert (= ib13 (mk_int__ref ib7)))
(assert (= perm__get_witness__result14 perm__get_witness__result8))
(assert (= ib14 ib8))
(assert (= temp___584 (to_rep1 (first (rt b)))))
(assert (= temp___585 (to_rep1 (last (rt b)))))
(assert (= (mk_int__ref result3) (mk_int__ref ib)))
(assert (= ib2 temp___584))
(assert (<= temp___584 ib2))
(assert (<= ib2 temp___585))
(assert (= temp___583 ib2))
(assert (or (and (and (and (= perm__get_witness__result2 perm__get_witness__result7) (= ib2 ib7)) (and (= perm__get_witness__result8 perm__get_witness__result2) (= ib8 ib2))) (and (and (and (and (and (and (and (<= (to_rep1 (first (rt a))) ia) (<= ia (to_rep1 (last (rt a))))) (= o16 ia)) (= o17 (select (elts a) o16))) (= o18 (to_rep o17))) (= result5 (ite (= o18 (to_rep (select (elts b) ib2))) true false))) (ite (= result5 true) (and (and (and (= o13 ib2) (in_range2 ib2)) (and (= (mk___t o14 o15) (remove b o13)) (and (dynamic_invariant1 (mk___t o14 o15) true false true) (and (= (invariant__ (mk___t o14 o15)) true) (and (= (to_rep1 (last o15)) (- (to_rep1 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o13 1))) (= (to_rep (select (elts b) k)) (to_rep (select o14 k))))) (and (forall ((k Int)) (=> (and (<= (+ o13 1) k) (<= k (to_rep1 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select o14 (- k 1)))))) (forall ((k Int)) (=> (and (<= o13 k) (<= k (- (to_rep1 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o14 k)))))))))))) (and (and (= (mk___t o11 o12) (remove a ia)) (and (dynamic_invariant1 (mk___t o11 o12) true false true) (and (= (invariant__ (mk___t o11 o12)) true) (and (= (to_rep1 (last o12)) (- (to_rep1 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ia 1))) (= (to_rep (select (elts a) k)) (to_rep (select o11 k))))) (and (forall ((k Int)) (=> (and (<= (+ ia 1) k) (<= k (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select o11 (- k 1)))))) (forall ((k Int)) (=> (and (<= ia k) (<= k (- (to_rep1 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select o11 k))))))))))) (and (= result4 (is_perm (mk___t o11 o12) (mk___t o14 o15))) (= (= result4 true) (or (and (= (length (mk___t o11 o12)) 0) (= (length (mk___t o14 o15)) 0)) (exists ((ia1 Int)) (and (and (<= (to_rep1 (first o12)) ia1) (<= ia1 (to_rep1 (last o12)))) (exists ((ib17 Int)) (and (and (<= (to_rep1 (first o15)) ib17) (<= ib17 (to_rep1 (last o15)))) (and (= (to_rep (select o11 ia1)) (to_rep (select o14 ib17))) (= (is_perm (remove (mk___t o11 o12) ia1) (remove (mk___t o14 o15) ib17)) true))))))))))) (= result4 false))) (and (= result4 true) (and (and (= o19 ib2) (in_range2 ib2)) (and (= (mk_int__ref result6) (mk_int__ref perm__get_witness__result)) (= perm__get_witness__result2 o19)))))) (and (and (and (and (and (and (and (and (<= (to_rep1 (first (rt a))) ia) (<= ia (to_rep1 (last (rt a))))) (= o16 ia)) (= o17 (select (elts a) o16))) (= o18 (to_rep o17))) (= result5 (ite (= o18 (to_rep (select (elts b) ib2))) true false))) (ite (= result5 true) (and (and (and (= o13 ib2) (in_range2 ib2)) (and (= (mk___t o14 o15) (remove b o13)) (and (dynamic_invariant1 (mk___t o14 o15) true false true) (and (= (invariant__ (mk___t o14 o15)) true) (and (= (to_rep1 (last o15)) (- (to_rep1 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o13 1))) (= (to_rep (select (elts b) k)) (to_rep (select o14 k))))) (and (forall ((k Int)) (=> (and (<= (+ o13 1) k) (<= k (to_rep1 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select o14 (- k 1)))))) (forall ((k Int)) (=> (and (<= o13 k) (<= k (- (to_rep1 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o14 k)))))))))))) (and (and (= (mk___t o11 o12) (remove a ia)) (and (dynamic_invariant1 (mk___t o11 o12) true false true) (and (= (invariant__ (mk___t o11 o12)) true) (and (= (to_rep1 (last o12)) (- (to_rep1 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ia 1))) (= (to_rep (select (elts a) k)) (to_rep (select o11 k))))) (and (forall ((k Int)) (=> (and (<= (+ ia 1) k) (<= k (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select o11 (- k 1)))))) (forall ((k Int)) (=> (and (<= ia k) (<= k (- (to_rep1 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select o11 k))))))))))) (and (= result4 (is_perm (mk___t o11 o12) (mk___t o14 o15))) (= (= result4 true) (or (and (= (length (mk___t o11 o12)) 0) (= (length (mk___t o14 o15)) 0)) (exists ((ia1 Int)) (and (and (<= (to_rep1 (first o12)) ia1) (<= ia1 (to_rep1 (last o12)))) (exists ((ib17 Int)) (and (and (<= (to_rep1 (first o15)) ib17) (<= ib17 (to_rep1 (last o15)))) (and (= (to_rep (select o11 ia1)) (to_rep (select o14 ib17))) (= (is_perm (remove (mk___t o11 o12) ia1) (remove (mk___t o14 o15) ib17)) true))))))))))) (= result4 false))) (and (not (= result4 true)) (and (= perm__get_witness__result2 perm__get_witness__result) (= perm__get_witness__result2 perm__get_witness__result1)))) (and (and (and (= perm__get_witness__result4 perm__get_witness__result7) (= ib4 ib7)) (and (= perm__get_witness__result8 perm__get_witness__result4) (= ib8 ib4))) (and (forall ((kb1 Int)) (=> (and (<= 1 kb1) (<= kb1 ib3)) (not (and (= (to_rep (select (elts a) ia)) (to_rep (select (elts b) kb1))) (= (is_perm (remove a ia) (remove b kb1)) true))))) (and (and (=> (<= (to_rep1 (first (rt b))) (to_rep1 (last (rt b)))) (dynamic_property1 (to_rep1 (first (rt b))) (to_rep1 (last (rt b))) ib3)) (and (<= (to_rep1 (first (rt b))) ib3) (<= ib3 (to_rep1 (last (rt b)))))) (and (not (= ib3 temp___585)) (and (and (= ib3 result8) (= ib4 (+ ib3 1))) (and (and (and (and (and (and (and (<= (to_rep1 (first (rt a))) ia) (<= ia (to_rep1 (last (rt a))))) (= o36 ia)) (= o37 (select (elts a) o36))) (= o38 (to_rep o37))) (= result10 (ite (= o38 (to_rep (select (elts b) ib4))) true false))) (ite (= result10 true) (and (and (and (= o33 ib4) (in_range2 ib4)) (and (= (mk___t o34 o35) (remove b o33)) (and (dynamic_invariant1 (mk___t o34 o35) true false true) (and (= (invariant__ (mk___t o34 o35)) true) (and (= (to_rep1 (last o35)) (- (to_rep1 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o33 1))) (= (to_rep (select (elts b) k)) (to_rep (select o34 k))))) (and (forall ((k Int)) (=> (and (<= (+ o33 1) k) (<= k (to_rep1 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select o34 (- k 1)))))) (forall ((k Int)) (=> (and (<= o33 k) (<= k (- (to_rep1 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o34 k)))))))))))) (and (and (= (mk___t o31 o32) (remove a ia)) (and (dynamic_invariant1 (mk___t o31 o32) true false true) (and (= (invariant__ (mk___t o31 o32)) true) (and (= (to_rep1 (last o32)) (- (to_rep1 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ia 1))) (= (to_rep (select (elts a) k)) (to_rep (select o31 k))))) (and (forall ((k Int)) (=> (and (<= (+ ia 1) k) (<= k (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select o31 (- k 1)))))) (forall ((k Int)) (=> (and (<= ia k) (<= k (- (to_rep1 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select o31 k))))))))))) (and (= result9 (is_perm (mk___t o31 o32) (mk___t o34 o35))) (= (= result9 true) (or (and (= (length (mk___t o31 o32)) 0) (= (length (mk___t o34 o35)) 0)) (exists ((ia1 Int)) (and (and (<= (to_rep1 (first o32)) ia1) (<= ia1 (to_rep1 (last o32)))) (exists ((ib17 Int)) (and (and (<= (to_rep1 (first o35)) ib17) (<= ib17 (to_rep1 (last o35)))) (and (= (to_rep (select o31 ia1)) (to_rep (select o34 ib17))) (= (is_perm (remove (mk___t o31 o32) ia1) (remove (mk___t o34 o35) ib17)) true))))))))))) (= result9 false))) (and (= result9 true) (and (and (= o39 ib4) (in_range2 ib4)) (and (= perm__get_witness__result3 result11) (= perm__get_witness__result4 o39)))))))))))))
(assert (= perm__get_witness__result15 perm__get_witness__result13))
(assert (= ib15 ib13))
(assert (= perm__get_witness__result16 perm__get_witness__result14))
(assert (= ib16 ib14))
(assert (<= (to_rep1 (first (rt b))) (int__content perm__get_witness__result15)))
(assert (<= (int__content perm__get_witness__result15) (to_rep1 (last (rt b)))))
(assert (and (<= (to_rep1 (first (rt b))) (int__content perm__get_witness__result15)) (<= (int__content perm__get_witness__result15) (to_rep1 (last (rt b))))))
(assert (= o46 (int__content perm__get_witness__result15)))
(assert (= o47 (select (elts b) o46)))
(assert (= o48 (to_rep o47)))
(assert (and (<= (to_rep1 (first (rt a))) ia) (<= ia (to_rep1 (last (rt a))))))
(assert (= o44 ia))
(assert (= o45 (select (elts a) o44)))
(assert (= o49 (to_rep o45)))
(assert (= result12 (ite (= o49 o48) true false)))
(assert (= result12 true))
(assert (and (= (mk___t o42 o43) (remove b (int__content perm__get_witness__result15))) (and (dynamic_invariant1 (mk___t o42 o43) true false true) (and (= (invariant__ (mk___t o42 o43)) true) (and (= (to_rep1 (last o43)) (- (to_rep1 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- (int__content perm__get_witness__result15) 1))) (= (to_rep (select (elts b) k)) (to_rep (select o42 k))))) (and (forall ((k Int)) (=> (and (<= (+ (int__content perm__get_witness__result15) 1) k) (<= k (to_rep1 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select o42 (- k 1)))))) (forall ((k Int)) (=> (and (<= (int__content perm__get_witness__result15) k) (<= k (- (to_rep1 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o42 k))))))))))))
