...
(assert (forall ((temp___231 Int)) (=> (dynamic_invariant1 temp___231 true true true true) (forall ((temp___232 Int)) (= (to_rep1 (select (main__my_array__aggregate_def temp___231) temp___232)) temp___231)))))
(define-fun dynamic_invariant2 ((temp___expr_166 Int) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool (=> (or (= temp___is_init_162 true) (<= 1 10000)) (in_range2 temp___expr_166)))
