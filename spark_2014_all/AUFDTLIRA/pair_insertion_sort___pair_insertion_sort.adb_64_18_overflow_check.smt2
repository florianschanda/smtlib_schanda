...
(assert (=> (= result8 true) (and (and (= (is_perm (mk___t a (mk (to_rep a__first) (to_rep a__last))) (mk___t o48 (mk (to_rep a__first) (to_rep a__last)))) true) (and (= (to_rep (select o48 o14)) (to_rep (select a o15))) (and (= (to_rep (select o48 o15)) (to_rep (select a o14))) (forall ((z4 Int)) (=> (and (<= (to_rep a__first) z4) (<= z4 (to_rep a__last))) (=> (and (not (= z4 o14)) (not (= z4 o15))) (= (to_rep (select o48 z4)) (to_rep (select a z4))))))))) (= (to_rep a__first) 0))))
...
(assert (=> (= result8 true) (= (sorted (mk___t o49 (mk (to_rep a__first) (to_rep a__last))) 0 (- j2 1)) true)))
(assert (=> (= result8 true) (= (sorted (mk___t o49 (mk (to_rep a__first) (to_rep a__last))) (+ j2 2) (+ i1 1)) true)))
(assert (=> (= result8 true) (=> (< 0 j2) (<= (to_rep (select o49 (- j2 1))) (to_rep (select o49 (+ j2 2)))))))
(assert (=> (= result8 true) (< x2 (to_rep (select o49 (+ j2 2))))))
(assert (=> (= result8 true) (= (is_perm (mk___t (elts1 b) (mk (to_rep (first2 (rt1 b))) (to_rep (last2 (rt1 b))))) (mk___t o49 (mk (to_rep a__first) (to_rep a__last)))) true)))
(assert (=> (= result8 true) (or (and (= (to_rep (select o49 j2)) x2) (= (to_rep (select o49 (+ j2 1))) y2)) (and (= (to_rep (select o49 j2)) y2) (= (to_rep (select o49 (+ j2 1))) x2)))))
...
(assert (=> (= result8 true) (=> (<= 0 j3) (= o18 (select o49 o17)))))
...
(assert (=> (= result8 true) (= a2 (mk_map__ref o49))))
(assert (=> (= result8 true) (= j5 j3)))
(assert (=> (= result8 true) (= a3 o49)))
...
(assert (=> (= result12 true) (= (sorted (mk___t o52 (mk (to_rep a__first) (to_rep a__last))) 0 (- j8 1)) true)))
(assert (=> (= result12 true) (= (sorted (mk___t o52 (mk (to_rep a__first) (to_rep a__last))) (+ j8 1) (+ i1 1)) true)))
(assert (=> (= result12 true) (=> (< 0 j8) (<= (to_rep (select o52 (- j8 1))) (to_rep (select o52 (+ j8 1)))))))
(assert (=> (= result12 true) (< y2 (to_rep (select o52 (+ j8 1))))))
(assert (=> (= result12 true) (= (is_perm (mk___t (elts1 b) (mk (to_rep (first2 (rt1 b))) (to_rep (last2 (rt1 b))))) (mk___t o52 (mk (to_rep a__first) (to_rep a__last)))) true)))
(assert (=> (= result12 true) (= (to_rep (select o52 j8)) y2)))
...
(assert (=> (= result12 true) (=> (<= 0 j9) (= o37 (select o52 o36)))))
...
(assert (=> (= result12 true) (= a8 (mk_map__ref o52))))
(assert (=> (= result12 true) (= j11 j9)))
(assert (=> (= result12 true) (= a9 o52)))
