...
(declare-const temp___1070 (Array Int character))
(declare-const temp___10701 t2)
...
(define-fun temp___10702 () us_t2 (mk___t2 temp___1070 temp___10701))
(define-fun o26 () us_rep (mk___rep (mk___split_discrs o11) (mk___split_fields o12 (mk___t1 o13 o14))))
(define-fun o27 () us_t2 (mk___t2 o9 o10))
...
(assert (and (= o26 (instance (+ (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 left))) 1) o27)) (and (dynamic_invariant1 o26 true false true true) (and (and (= (to_rep2 o11) (+ (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 left))) 1)) (= (length2 o26) (length3 o27))) (= (let ((temp___274 (value o26))) (bool_eq (elts2 temp___274) (to_rep1 (first4 (rt2 temp___274))) (to_rep1 (last4 (rt2 temp___274))) o9 (to_rep1 (first4 o10)) (to_rep1 (last4 o10)))) true)))))
...
(assert (= bounded_dynamic_strings__Oconcat__4__result12 o26))
...
(assert (= o24 (+ o23 1)))
(assert (= o25 (ite (= (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 (sequence__content bounded_dynamic_strings__Oconcat__4__result10)))) o24) true false)))
(assert (and (= o19 (length2 left)) (and (in_range4 o19) (= o19 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 left)))))))
(assert (= o20 (+ o19 1)))
(assert (and (= o21 (length2 (sequence__content bounded_dynamic_strings__Oconcat__4__result10))) (and (in_range4 o21) (= o21 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 (sequence__content bounded_dynamic_strings__Oconcat__4__result10))))))))
(assert (= o22 (ite (= o21 o20) true false)))
(assert (and (= temp___10702 (value left)) (and (dynamic_invariant2 temp___10702 true false true true) (and (and (= (elts1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 left))) temp___1070) (= (mk2 (to_rep1 (first6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 left)))))) (to_rep1 (last6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 left))))))) temp___10701)) (and (and (and (= (length3 temp___10702) (length2 left)) (= (to_rep1 (first4 temp___10701)) 1)) (= (to_rep1 (last4 temp___10701)) (length2 left))) (= (< 0 (length2 left)) (not (= (empty left) true))))))))
(assert (not (= (length3 temp___10702) 0)))
(assert (=> (<= (to_rep1 (first4 temp___10701)) (to_rep1 (last4 temp___10701))) (= o15 (+ (- (to_rep1 (last4 temp___10701)) (to_rep1 (first4 temp___10701))) 1))))
(assert (=> (not (<= (to_rep1 (first4 temp___10701)) (to_rep1 (last4 temp___10701)))) (= o15 0)))
(assert (= o16 (+ o15 1)))
(assert (= o17 (+ (to_rep1 (first4 temp___10701)) o16)))
(assert (= o18 (- o17 1)))
