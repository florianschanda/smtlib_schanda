...
(assert (and (= temp___1092 (model__ f1 root)) (and (dynamic_invariant2 temp___1092 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1092 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1092 root)))) 0) (and (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (not (= i5 root)) (ite (and (not (= (parent f1 i5) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1092 (parent f1 i5)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1092 i5))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1092 i5))) true)))))) (and (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1092 i5))) true) (not (= i5 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1092 (parent f1 i5)))) (position f1 i5) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1092 i5)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1092 i5)))) 0)))) (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1092 i5))) true) (forall ((j20 Int)) (=> (and (<= 1 j20) (<= j20 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1092 j20))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1092 i5))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1092 j20)))) true)) (= j20 i5))))))))))))))
(assert (= (mk___rep (mk___split_fields o16 o17)) (select temp___1092 i2)))
(assert (= o16 o18))
(assert (= o17 o19))
(assert (= o20 o18))
(assert (and (= o21 (length o20)) (and (in_range5 o21) (<= (+ 0 o21) 2147483647))))
(assert (= o22 (ite (< o21 n2) true false)))
(assert (= (tree_structure f1) true))
(assert (and (= temp___1091 (model__ f1 root)) (and (dynamic_invariant2 temp___1091 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1091 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1091 root)))) 0) (and (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (not (= i5 root)) (ite (and (not (= (parent f1 i5) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1091 (parent f1 i5)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1091 i5))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1091 i5))) true)))))) (and (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1091 i5))) true) (not (= i5 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1091 (parent f1 i5)))) (position f1 i5) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1091 i5)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1091 i5)))) 0)))) (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1091 i5))) true) (forall ((j20 Int)) (=> (and (<= 1 j20) (<= j20 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1091 j20))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1091 i5))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1091 j20)))) true)) (= j20 i5))))))))))))))
(assert (= (mk___rep (mk___split_fields o12 o13)) (select temp___1091 i2)))
(assert (= o12 o14))
(assert (= o13 o15))
(assert (= o23 o15))
