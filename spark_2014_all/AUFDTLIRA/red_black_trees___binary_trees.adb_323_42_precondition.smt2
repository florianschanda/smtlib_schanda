...
(declare-const n Int)
(declare-const i Int)
(declare-const temp___1137 (Array Int us_rep1))
...
(assert (= (tree_structure f1) true))
(assert (and (= temp___1137 (model__ f1 root)) (and (dynamic_invariant2 temp___1137 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1137 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1137 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent f1 i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1137 (parent f1 i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1137 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1137 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1137 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1137 (parent f1 i1)))) (position f1 i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1137 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1137 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1137 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1137 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1137 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1137 j)))) true)) (= j i1))))))))))))))
(assert (= (mk___rep (mk___split_fields o o1)) (select temp___1137 i)))
(assert (= o o2))
(assert (= o1 o3))
(assert (= o11 o3))
