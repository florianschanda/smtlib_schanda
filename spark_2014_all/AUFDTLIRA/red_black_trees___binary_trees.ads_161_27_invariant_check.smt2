...
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o74 (peek (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j e)) (and (in_range2 o74) (and (= o74 (ite (= e 0) (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select f__split_fields1 j)))) (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select f__split_fields1 j)))))) (and (ite (not (= o74 0)) (and (= (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o74) e) (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o74) j)) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 100)) (=> (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j3) j) (not (= (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j3) e)))))) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 100)) (=> (and (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j3) j) (= (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j3) e)) (= o74 j3)))))))))
