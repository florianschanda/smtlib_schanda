...
(assert (= result39 (mk_int__ref temp___1731)))
(assert (= temp___1732 j43))
(assert (<= j43 b))
(assert (= (to_rep o47) j43))
(assert (and (<= (to_rep tab__first) j43) (<= j43 (to_rep tab__last))))
(assert (= o48 j43))
(assert (= o49 (store tab35 o48 o47)))
(assert (= result40 (mk_map__ref tab35)))
(assert (= tab36 o49))
(assert (and (= o50 (+ j43 1)) (in_range1 (+ j43 1))))
(assert (= result41 (mk_int__ref j43)))
(assert (= j44 o50))
(assert (= temp___1733 (mk_int__ref temp___1732)))
(assert (= j45 (mk_int__ref j44)))
(assert (= tab37 (mk_map__ref tab36)))
(assert (= temp___1734 temp___1732))
(assert (= j46 j44))
(assert (= tab38 tab36))
(declare-const l8 Int)
(assert (<= a l8))
(assert (<= l8 (- (int__content j45) 1)))
(assert (not (= (to_rep (select (map__content tab37) l8)) l8)))
(check-sat)
(exit)
