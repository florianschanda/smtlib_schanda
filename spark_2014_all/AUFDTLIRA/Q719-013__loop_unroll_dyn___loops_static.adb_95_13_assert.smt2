...
(assert (=> (< (to_rep1 a__first) i1) (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (= temp___325 bad1))))
...
(assert (=> (< (to_rep1 a__first) i1) (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (= o3 j3))))
(assert (=> (< (to_rep1 a__first) i1) (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (= o4 (select a1 o3)))))
(assert (=> (< (to_rep1 a__first) i1) (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (= o5 (to_rep o4)))))
(assert (=> (< (to_rep1 a__first) i1) (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (= o6 (ite (= o5 0) true false)))))
(assert (=> (< (to_rep1 a__first) i1) (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (= result4 (ite (not (= o6 true)) true false)))))
(assert (=> (< (to_rep1 a__first) i1) (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (=> (= result4 true) (= bad2 result5)))))
(assert (=> (< (to_rep1 a__first) i1) (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (=> (= result4 true) (= bad3 (of_int 1))))))
