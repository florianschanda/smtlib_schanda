...
(assert (=> (<= zlength (int__content endidx6)) (= i26 i30)))
(assert (=> (<= zlength (int__content endidx6)) (= i25 i31)))
...
(assert (=> (not (<= zlength (int__content endidx6))) (and (and (and (and (<= begidx11 endidx8) (<= begidx11 zlength)) (<= endidx8 zlength)) (=> (= foundtype8 1) (forall ((i32 Int)) (=> (and (<= begidx11 i32) (<= i32 endidx8)) (and (<= 48 (to_rep (select zonefileline i32))) (<= (to_rep (select zonefileline i32)) 57)))))) (and (and (in_range4 begidx11) (in_range4 endidx8)) (in_range3 foundtype8)))))
...
(assert (=> (not (<= zlength (int__content endidx6))) (=> (not (= foundtype8 0)) (= i22 i30))))
(assert (=> (not (<= zlength (int__content endidx6))) (=> (not (= foundtype8 0)) (= i21 i31))))
...
(assert (=> (not (<= zlength (int__content endidx6))) (=> (not (not (= foundtype8 0))) (=> (< 128 lengthoftoken2) (= i18 i30)))))
(assert (=> (not (<= zlength (int__content endidx6))) (=> (not (not (= foundtype8 0))) (=> (< 128 lengthoftoken2) (= i17 i31)))))
...
(assert (=> (not (<= zlength (int__content endidx6))) (=> (not (not (= foundtype8 0))) (=> (not (< 128 lengthoftoken2)) (= result9 i31)))))
...
(assert (=> (not (<= zlength (int__content endidx6))) (=> (not (not (= foundtype8 0))) (=> (not (< 128 lengthoftoken2)) (= result11 i30)))))
...
(assert (= begidx14 o10))
(assert (and (and (and (and (<= begidx15 endidx11) (<= begidx15 zlength)) (<= endidx11 zlength)) (=> (= foundtype11 1) (forall ((i32 Int)) (=> (and (<= begidx15 i32) (<= i32 endidx11)) (and (<= 48 (to_rep (select zonefileline i32))) (<= (to_rep (select zonefileline i32)) 57)))))) (and (and (in_range4 begidx15) (in_range4 endidx11)) (in_range3 foundtype11))))
