...
(assert (not (<= (+ (+ (+ (+ (+ (+ (+ (+ (+ 0 (ite (= (= (length source) 1) true) 1 0)) (ite (= (= (length source) 2) true) 1 0)) (ite (= (= (length source) 3) true) 1 0)) (ite (= (= (length source) 4) true) 1 0)) (ite (= (= (length source) 5) true) 1 0)) (ite (= (= (length source) 6) true) 1 0)) (ite (= (= (length source) 7) true) 1 0)) (ite (= (= (length source) 8) true) 1 0)) (ite (= (= (length source) 9) true) 1 0)) 1)))
(check-sat)
(exit)
