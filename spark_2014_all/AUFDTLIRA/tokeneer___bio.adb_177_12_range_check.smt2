...
(assert (not (= (length (mk___t temp___1301 temp___13011)) 0)))
(assert (=> (<= (to_rep1 (first2 temp___13021)) (to_rep1 (last2 temp___13021))) (= o6 (+ (- (to_rep1 (last2 temp___13021)) (to_rep1 (first2 temp___13021))) 1))))
(assert (=> (not (<= (to_rep1 (first2 temp___13021)) (to_rep1 (last2 temp___13021)))) (= o6 0)))
(assert (=> (<= (to_rep1 (first temp___13011)) (to_rep1 (last temp___13011))) (= o7 (+ (- (to_rep1 (last temp___13011)) (to_rep1 (first temp___13011))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___13011)) (to_rep1 (last temp___13011)))) (= o7 0)))
(assert (= o8 (+ o7 o6)))
(assert (= o9 (+ (to_rep1 (first temp___13011)) o8)))
(assert (= o10 (- o9 1)))
