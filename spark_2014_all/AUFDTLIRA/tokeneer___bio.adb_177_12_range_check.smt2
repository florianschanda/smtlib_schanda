...
(assert (=> (<= (to_rep1 (first2 temp___13581)) (to_rep1 (last2 temp___13581))) (= o6 (+ (- (to_rep1 (last2 temp___13581)) (to_rep1 (first2 temp___13581))) 1))))
(assert (=> (not (<= (to_rep1 (first2 temp___13581)) (to_rep1 (last2 temp___13581)))) (= o6 0)))
(assert (=> (<= (to_rep1 (first temp___13571)) (to_rep1 (last temp___13571))) (= o7 (+ (- (to_rep1 (last temp___13571)) (to_rep1 (first temp___13571))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___13571)) (to_rep1 (last temp___13571)))) (= o7 0)))
(assert (= o8 (+ o7 o6)))
(assert (= o9 (+ (to_rep1 (first temp___13571)) o8)))
(assert (= o10 (- o9 1)))
