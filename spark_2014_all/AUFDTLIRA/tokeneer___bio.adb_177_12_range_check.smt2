...
(assert (not (= (length (mk___t temp___1518 temp___15181)) 0)))
(assert (=> (<= (to_rep1 (first2 temp___15191)) (to_rep1 (last2 temp___15191))) (= o6 (+ (- (to_rep1 (last2 temp___15191)) (to_rep1 (first2 temp___15191))) 1))))
(assert (=> (not (<= (to_rep1 (first2 temp___15191)) (to_rep1 (last2 temp___15191)))) (= o6 0)))
(assert (=> (<= (to_rep1 (first temp___15181)) (to_rep1 (last temp___15181))) (= o7 (+ (- (to_rep1 (last temp___15181)) (to_rep1 (first temp___15181))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___15181)) (to_rep1 (last temp___15181)))) (= o7 0)))
(assert (= o8 (+ o7 o6)))
(assert (= o9 (+ (to_rep1 (first temp___15181)) o8)))
(assert (= o10 (- o9 1)))
