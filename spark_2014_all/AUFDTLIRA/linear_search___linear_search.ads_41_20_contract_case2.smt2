...
(declare-const temp___207 Bool)
(declare-const temp___2071 index)
(declare-const temp___2072 Bool)
...
(declare-const temp___203 Bool)
(declare-const temp___2031 index)
(declare-const temp___2032 Bool)
(declare-const usq_ Bool)
(declare-const usq_1 index)
(declare-const usq_2 Bool)
(declare-const temp___205 Bool)
(declare-const temp___2051 index)
(declare-const temp___2052 Bool)
(declare-const o6 Int)
(declare-const o7 Int)
(declare-const o8 element)
(declare-const o9 Int)
(declare-const o10 Int)
(declare-const o11 index)
(declare-const o12 us_split_fields)
(declare-const temp___2033 us_rep)
(declare-const usq_3 us_rep)
(declare-const temp___2053 us_rep)
...
(declare-const temp___2084 int__ref)
...
(declare-const res__split_discrs11 us_split_discrs)
(declare-const result13 search_result__ref)
(declare-const linear_search__search__result13 us_rep)
(declare-const linear_search__search__result14 search_result__ref)
...
(declare-const res__split_discrs12 us_split_discrs__ref)
...
(define-fun linear_search__search__result20 () search_result__ref (mk_search_result__ref (mk___rep (mk___split_discrs linear_search__search__result) (mk___split_fields linear_search__search__result1) linear_search__search__result2)))
(define-fun res__split_discrs16 () us_split_discrs__ref (mk___split_discrs__ref (mk___split_discrs res__split_discrs)))
(define-fun res__split_fields16 () us_split_fields__ref (mk___split_fields__ref (mk___split_fields res__split_fields)))
...
(assert (or (and (and (and (= linear_search__search__result16 linear_search__search__result7) (and (= res__split_discrs12 res__split_discrs5) (and (= res__split_fields12 res__split_fields5) (= pos10 pos4)))) (and (= linear_search__search__result17 linear_search__search__result8) (and (= res__split_discrs13 res__split_discrs6) (and (= res__split_fields13 res__split_fields6) (= pos11 pos5))))) (and (<= pos1 10) (and (and (= res__split_discrs temp___207) (and (= res__split_fields temp___2071) (= res__attr__constrained temp___2072))) (and (= temp___206 pos1) (and (= 0 temp___208) (or (and (and (and (= temp___2084 (mk_int__ref temp___208)) (and (= linear_search__search__result7 (mk_search_result__ref linear_search__search__result4)) (and (= res__split_discrs5 (mk___split_discrs__ref res__split_discrs2)) (and (= res__split_fields5 (mk___split_fields__ref res__split_fields2)) (= pos4 (mk_int__ref pos1)))))) (and (= temp___2085 temp___2081) (and (= linear_search__search__result8 linear_search__search__result4) (and (= res__split_discrs6 res__split_discrs2) (and (= res__split_fields6 res__split_fields2) (= pos5 pos1)))))) (and (and (and (and (and (and (<= 1 pos1) (<= pos1 10)) (= o pos1)) (= o1 (select a o))) (= o2 (to_rep o1))) (= result1 (ite (= o2 val__) true false))) (and (= result1 true) (and (and (and (and (and (and (and (and (= o3 pos1) (in_range2 pos1)) (= (to_rep1 o4) o3)) (= o4 o5)) (and (= (distinct 1 0) temp___203) (and (= temp___2031 o5) (= true temp___2032)))) (and (=> (= res__attr__constrained true) (= temp___203 res__split_discrs)) (= (mk___rep (mk___split_discrs usq_) (mk___split_fields usq_1) usq_2) (mk___rep (mk___split_discrs temp___203) (mk___split_fields temp___2031) temp___2032)))) (and (= usq_ temp___205) (and (= usq_1 temp___2051) (= res__attr__constrained temp___2052)))) (and (and (= result2 res__split_fields16) (= res__split_fields2 (mk___split_fields temp___2051))) (and (= result3 res__split_discrs16) (= res__split_discrs2 (mk___split_discrs temp___205))))) (and (= result4 linear_search__search__result20) (= linear_search__search__result4 (mk___rep res__split_discrs2 res__split_fields2 res__attr__constrained))))))) (and (and (and (and (and (and (and (<= 1 pos1) (<= pos1 10)) (= o pos1)) (= o1 (select a o))) (= o2 (to_rep o1))) (= result1 (ite (= o2 val__) true false))) (and (not (= result1 true)) (and (and (= linear_search__search__result4 (mk___rep (mk___split_discrs linear_search__search__result) (mk___split_fields linear_search__search__result1) linear_search__search__result2)) (and (= res__split_discrs2 (mk___split_discrs res__split_discrs)) (= res__split_fields2 (mk___split_fields res__split_fields)))) (and (= linear_search__search__result4 linear_search__search__result3) (and (= res__split_discrs2 res__split_discrs1) (= res__split_fields2 res__split_fields1)))))) (and (and (and (= temp___2084 (mk_int__ref temp___2083)) (and (= linear_search__search__result7 (mk_search_result__ref linear_search__search__result6)) (and (= res__split_discrs5 (mk___split_discrs__ref res__split_discrs4)) (and (= res__split_fields5 (mk___split_fields__ref res__split_fields4)) (= pos4 (mk_int__ref pos3)))))) (and (= temp___2085 temp___2083) (and (= linear_search__search__result8 linear_search__search__result6) (and (= res__split_discrs6 res__split_discrs4) (and (= res__split_fields6 res__split_fields4) (= pos5 pos3)))))) (and (and (and (<= 1 pos2) (<= pos2 10)) (not (= (value_found_in_range a val__ 1 pos2) true))) (and (=> (<= (- 128) 127) (in_range3 pos2)) (and (and (= result5 (mk_int__ref temp___2082)) (= temp___2083 pos2)) (and (and (and (= o6 (+ pos2 1)) (in_range3 (+ pos2 1))) (and (= result6 (mk_int__ref pos2)) (= pos3 o6))) (and (<= pos3 10) (and (and (and (and (and (and (<= 1 pos3) (<= pos3 10)) (= o7 pos3)) (= o8 (select a o7))) (= o9 (to_rep o8))) (= result7 (ite (= o9 val__) true false))) (and (= result7 true) (and (and (and (and (and (and (and (and (= o10 pos3) (in_range2 pos3)) (= (to_rep1 o11) o10)) (= o12 (mk___split_fields o11))) (= temp___2033 (mk___rep (mk___split_discrs (distinct 1 0)) o12 true))) (and (=> (= res__attr__constrained true) (= (rec__linear_search__search_result__found (us_split_discrs1 temp___2033)) (rec__linear_search__search_result__found res__split_discrs3))) (= usq_3 temp___2033))) (= temp___2053 (mk___rep (us_split_discrs1 usq_3) (us_split_fields1 usq_3) res__attr__constrained))) (and (and (= result8 (mk___split_fields__ref res__split_fields3)) (= res__split_fields4 (us_split_fields1 temp___2053))) (and (= result9 (mk___split_discrs__ref res__split_discrs3)) (= res__split_discrs4 (us_split_discrs1 temp___2053))))) (and (= result10 (mk_search_result__ref linear_search__search__result5)) (= linear_search__search__result6 (mk___rep res__split_discrs4 res__split_fields4 res__attr__constrained))))))))))))))))))) (and (ite (<= pos1 10) (and (and (and (and (= res__split_discrs temp___207) (and (= res__split_fields temp___2071) (= res__attr__constrained temp___2072))) (and (= temp___206 pos1) (and (= 0 temp___208) (and (and (and (and (and (and (and (<= 1 pos1) (<= pos1 10)) (= o pos1)) (= o1 (select a o))) (= o2 (to_rep o1))) (= result1 (ite (= o2 val__) true false))) (and (not (= result1 true)) (and (and (= linear_search__search__result4 (mk___rep (mk___split_discrs linear_search__search__result) (mk___split_fields linear_search__search__result1) linear_search__search__result2)) (and (= res__split_discrs2 (mk___split_discrs res__split_discrs)) (= res__split_fields2 (mk___split_fields res__split_fields)))) (and (= linear_search__search__result4 linear_search__search__result3) (and (= res__split_discrs2 res__split_discrs1) (= res__split_fields2 res__split_fields1)))))) (and (and (and (<= 1 pos2) (<= pos2 10)) (not (= (value_found_in_range a val__ 1 pos2) true))) (and (=> (<= (- 128) 127) (in_range3 pos2)) (and (and (= result5 (mk_int__ref temp___2082)) (= temp___2083 pos2)) (and (and (and (= o6 (+ pos2 1)) (in_range3 (+ pos2 1))) (and (= result6 (mk_int__ref pos2)) (= pos3 o6))) (not (<= pos3 10)))))))))) (and (and (= linear_search__search__result9 (mk_search_result__ref linear_search__search__result5)) (and (= res__split_discrs7 (mk___split_discrs__ref res__split_discrs3)) (and (= res__split_fields7 (mk___split_fields__ref res__split_fields3)) (= pos6 (mk_int__ref pos3))))) (and (= linear_search__search__result10 linear_search__search__result5) (and (= res__split_discrs8 res__split_discrs3) (and (= res__split_fields8 res__split_fields3) (= pos7 pos3)))))) (and (and (= linear_search__search__result11 linear_search__search__result9) (and (= res__split_discrs9 res__split_discrs7) (and (= res__split_fields9 res__split_fields7) (= pos8 pos6)))) (and (= linear_search__search__result12 linear_search__search__result10) (and (= res__split_discrs10 res__split_discrs8) (and (= res__split_fields10 res__split_fields8) (= pos9 pos7)))))) (and (and (= linear_search__search__result11 linear_search__search__result20) (and (= res__split_discrs9 res__split_discrs16) (and (= res__split_fields9 res__split_fields16) (= pos8 (mk_int__ref pos1))))) (and (= linear_search__search__result12 linear_search__search__result3) (and (= res__split_discrs10 res__split_discrs1) (and (= res__split_fields10 res__split_fields1) (= pos9 pos1)))))) (and (and (and (= linear_search__search__result16 linear_search__search__result14) (and (= res__split_discrs12 (mk___split_discrs__ref res__split_discrs11)) (and (= res__split_fields12 (mk___split_fields__ref res__split_fields11)) (= pos10 pos8)))) (and (= linear_search__search__result17 linear_search__search__result15) (and (= res__split_discrs13 res__split_discrs11) (and (= res__split_fields13 res__split_fields11) (= pos11 pos9))))) (and (and (and (and (=> (= res__attr__constrained true) (= (distinct 0 0) (rec__linear_search__search_result__found (us_split_discrs__content res__split_discrs9)))) (= usq_4 (mk___rep (mk___split_discrs (distinct 0 0)) (mk___split_fields dummy1) true))) (= temp___211 (mk___rep (us_split_discrs1 usq_4) (us_split_fields1 usq_4) res__attr__constrained))) (and (and (= result11 res__split_fields9) (= res__split_fields11 (us_split_fields1 temp___211))) (and (= result12 res__split_discrs9) (= res__split_discrs11 (us_split_discrs1 temp___211))))) (and (and (= linear_search__search__result14 (mk_search_result__ref linear_search__search__result13)) (= linear_search__search__result15 linear_search__search__result13)) (and (= result13 linear_search__search__result11) (= linear_search__search__result13 (mk___rep res__split_discrs11 res__split_fields11 res__attr__constrained)))))))))
(assert (= linear_search__search__result18 linear_search__search__result16))
(assert (= res__split_discrs14 res__split_discrs12))
(assert (= res__split_fields14 res__split_fields12))
(assert (= pos12 pos10))
(assert (= linear_search__search__result19 linear_search__search__result17))
(assert (= res__split_discrs15 res__split_discrs13))
(assert (= res__split_fields15 res__split_fields13))
(assert (= pos13 pos11))
(assert (= (= (to_rep (select a 1)) val__) true))
(assert (not (= (to_rep1 (rec__linear_search__search_result__at_index (us_split_fields1 (search_result__content linear_search__search__result18)))) 1)))
(check-sat)
(exit)
