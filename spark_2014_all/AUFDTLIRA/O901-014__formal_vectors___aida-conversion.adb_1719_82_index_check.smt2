...
(assert (= n1 result3))
(assert (= n2 o8))
(assert (forall ((i1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 3) i1) (<= i1 index2)) (and (<= 0 (to_rep1 (select n3 i1))) (<= (to_rep1 (select n3 i1)) 9)))))
...
(assert (and (= o9 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
