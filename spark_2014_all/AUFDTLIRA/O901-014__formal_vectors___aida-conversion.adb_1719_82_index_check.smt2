...
(assert (and (= o26 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (= o27 (ite (<= o26 i) true false)))
(assert (= result5 (ite (= o27 true) (ite (<= i index3) true false) false)))
(assert (= result5 true))
(assert (and (<= (to_rep1 n__first) i) (<= i (to_rep1 n__last))))
(assert (= o28 i))
(assert (= o29 (select n3 o28)))
(assert (= o30 (to_rep1 o29)))
(assert (= o31 (ite (<= o30 9) true false)))
