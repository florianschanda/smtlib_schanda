...
(assert (forall ((j15 Int)) (=> (and (<= 1 j15) (<= j15 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 f_3__split_fields3) y1) j15))) true) (< (to_rep (select (rec__search_trees__search_tree__values t__split_fields8) x1)) (to_rep (select (rec__search_trees__search_tree__values t__split_fields8) j15)))))))
(assert (= (ordered_leafs (mk___rep2 f_3__split_fields3) x1 (rec__search_trees__search_tree__values t__split_fields8)) true))
(assert (and (= o28 yl1) (in_range3 yl1)))
(assert (not (= (valid_root (mk___rep2 f_3__split_fields3) o28) true)))
(check-sat)
(exit)
