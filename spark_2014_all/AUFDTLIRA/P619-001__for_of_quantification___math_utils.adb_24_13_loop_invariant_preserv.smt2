...
(assert (forall ((k2 Int)) (=> (and (<= (to_rep1 (first (rt v))) k2) (<= k2 i2)) (<= (to_rep (select (elts v) k2)) result__3))))
(assert (exists ((k2 Int)) (and (and (<= (to_rep1 (first (rt v))) k2) (<= k2 i2)) (= result__3 (to_rep (select (elts v) k2))))))
...
(assert (= temp___1611 result3))
(assert (= temp___1612 i2))
...
(assert (not (exists ((k2 Int)) (and (and (<= (to_rep1 (first (rt v))) k2) (<= k2 i3)) (= result__4 (to_rep (select (elts v) k2)))))))
(check-sat)
(exit)
