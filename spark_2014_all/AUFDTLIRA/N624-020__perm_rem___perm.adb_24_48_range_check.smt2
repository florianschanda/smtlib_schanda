...
(assert (in_range3 ia))
(assert (and (= (invariant__ a) true) (and (= (invariant__ b) true) (and (and (<= (to_rep1 (first (rt a))) ia) (<= ia (to_rep1 (last (rt a))))) (exists ((ib4 Int)) (and (and (<= (to_rep1 (first (rt b))) ib4) (<= ib4 (to_rep1 (last (rt b))))) (and (= (to_rep (select (elts a) ia)) (to_rep (select (elts b) ib4))) (= (is_perm (remove a ia) (remove b ib4)) true))))))))
...
(assert (forall ((kb Int)) (=> (and (<= 1 kb) (<= kb ib2)) (not (and (= (to_rep (select (elts a) ia)) (to_rep (select (elts b) kb))) (= (is_perm (remove a ia) (remove b kb)) true))))))
...
(assert (= result4 (ite (= o10 (to_rep (select (elts b) ib3))) true false)))
(assert (= result4 true))
(assert (not (in_range3 ib3)))
(check-sat)
(exit)
