...
(assert (forall ((i category)) (and (<= 1 (categoryqtint i)) (<= (categoryqtint i) 8))))
...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep1 (rec__counter_example__item__cat (us_split_fields1 a))) (to_rep1 (rec__counter_example__item__cat (us_split_fields1 b)))) (= (to_rep (rec__counter_example__item__idx (us_split_fields1 a))) (to_rep (rec__counter_example__item__idx (us_split_fields1 b))))) true false))
...
(assert (forall ((temp___156 Int) (temp___157 Int) (temp___158 Int) (temp___159 Int) (temp___160 Int) (temp___161 Int) (temp___162 Int) (temp___163 Int)) (let ((temp___155 (counter_example__num_item_per_category__aggregate_def temp___156 temp___157 temp___158 temp___159 temp___160 temp___161 temp___162 temp___163))) (=> (and (and (and (and (and (and (and (dynamic_invariant2 temp___156 true true true true) (dynamic_invariant2 temp___157 true true true true)) (dynamic_invariant2 temp___158 true true true true)) (dynamic_invariant2 temp___159 true true true true)) (dynamic_invariant2 temp___160 true true true true)) (dynamic_invariant2 temp___161 true true true true)) (dynamic_invariant2 temp___162 true true true true)) (dynamic_invariant2 temp___163 true true true true)) (and (and (and (and (and (and (and (= (select temp___155 1) rliteral) (= (select temp___155 2) rliteral1)) (= (select temp___155 3) rliteral2)) (= (select temp___155 4) rliteral3)) (= (select temp___155 5) rliteral4)) (= (select temp___155 6) rliteral5)) (= (select temp___155 7) rliteral6)) (= (select temp___155 8) rliteral7))))))
...
(assert (not (<= (to_rep1 (rec__counter_example__item__cat (us_split_fields1 i5s))) (to_rep2 (last (rt num_item_per_category))))))
(check-sat)
(exit)
