...
(define-fun dynamic_invariant ((temp___expr_152 us_t) (temp___is_init_149 Bool) (temp___skip_constant_150 Bool) (temp___do_toplevel_151 Bool)) Bool (=> (not (= temp___skip_constant_150 true)) (dynamic_property 1 8 (first1 temp___expr_152) (last1 temp___expr_152))))
(declare-sort t3s 0)
...
(assert (forall ((temp___134 Int) (temp___135 Int) (temp___136 Int) (temp___137 Int) (temp___138 Int) (temp___139 Int) (temp___140 Int) (temp___141 Int)) (let ((temp___133 (counter_example__num_item_per_category__aggregate_def temp___134 temp___135 temp___136 temp___137 temp___138 temp___139 temp___140 temp___141))) (and (and (and (and (and (and (and (= (select temp___133 1) (of_rep temp___134)) (= (select temp___133 2) (of_rep temp___135))) (= (select temp___133 3) (of_rep temp___136))) (= (select temp___133 4) (of_rep temp___137))) (= (select temp___133 5) (of_rep temp___138))) (= (select temp___133 6) (of_rep temp___139))) (= (select temp___133 7) (of_rep temp___140))) (= (select temp___133 8) (of_rep temp___141))))))
...
(define-fun dynamic_invariant1 ((temp___expr_157 us_rep) (temp___is_init_154 Bool) (temp___skip_constant_155 Bool) (temp___do_toplevel_156 Bool)) Bool (=> (= temp___do_toplevel_156 true) (=> (= temp___is_init_154 true) (<= (to_rep (rec__counter_example__item__idx (us_split_fields1 temp___expr_157))) (to_rep (select (to_array num_item_per_category) (to_rep1 (rec__counter_example__item__cat (us_split_fields1 temp___expr_157)))))))))
(define-fun dynamic_predicate ((temp___163 us_rep)) Bool (<= (to_rep (rec__counter_example__item__idx (us_split_fields1 temp___163))) (to_rep (select (to_array num_item_per_category) (to_rep1 (rec__counter_example__item__cat (us_split_fields1 temp___163)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_146 Int) (temp___is_init_143 Bool) (temp___skip_constant_144 Bool) (temp___do_toplevel_145 Bool)) Bool (=> (or (= temp___is_init_143 true) (<= 1 8)) (in_range1 temp___expr_146)))
