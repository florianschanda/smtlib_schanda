...
(define-fun dynamic_invariant2 ((temp___expr_1418 Int) (temp___is_init_1414 Bool) (temp___skip_constant_1415 Bool) (temp___do_toplevel_1416 Bool) (temp___do_typ_inv_1417 Bool)) Bool (=> (or (= temp___is_init_1414 true) (<= 0 16)) (in_range6 temp___expr_1418)))
...
(assert (forall ((x Int)) (! (=> (dynamic_invariant2 x true true true true) (= (returnt_image x) (let ((temp___1422 (to_string (attr__ATTRIBUTE_IMAGE6 x)))) (of_array1 (to_array temp___1422) (first1 temp___1422) (last1 temp___1422))))) :pattern ((returnt_image x)))))
...
(declare-fun temp___String_Literal_1516 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_1516 us_void_param) 1)) 58) (= (to_rep (select (temp___String_Literal_1516 us_void_param) 2)) 32)) :pattern ((temp___String_Literal_1516 us_void_param)))))
(declare-fun temp___String_Literal_1520 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (= (to_rep (select (temp___String_Literal_1520 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_1520 us_void_param) 2)) 40)) (= (to_rep (select (temp___String_Literal_1520 us_void_param) 3)) 32)) :pattern ((temp___String_Literal_1520 us_void_param)))))
(declare-fun temp___String_Literal_1525 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_1525 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_1525 us_void_param) 2)) 41)) :pattern ((temp___String_Literal_1525 us_void_param)))))
...
(define-fun dynamic_invariant7 ((temp___expr_586 Int) (temp___is_init_582 Bool) (temp___skip_constant_583 Bool) (temp___do_toplevel_584 Bool) (temp___do_typ_inv_585 Bool)) Bool (=> (or (= temp___is_init_582 true) (<= 1 150)) (in_range5 temp___expr_586)))
...
(declare-const temp___1524 (Array Int character))
(declare-const temp___15241 t1)
(declare-const temp___1519 (Array Int character))
(declare-const temp___15191 t1)
(declare-const o Int)
...
(declare-const temp___1518 (Array Int character))
(declare-const temp___15181 t)
...
(declare-const temp___1521 (Array Int character))
(declare-const temp___15211 t)
...
(declare-const temp___1523 (Array Int character))
(declare-const temp___15231 t)
...
(declare-const temp___1526 (Array Int character))
(declare-const temp___15261 t)
(declare-const o24 Int)
(declare-const o25 Int)
(declare-const o26 Int)
(declare-const o27 Int)
(declare-const o28 Int)
(define-fun temp___15192 () us_t1 (mk___t1 temp___1519 temp___15191))
(define-fun temp___15242 () us_t1 (mk___t1 temp___1524 temp___15241))
...
(assert (and (= temp___15242 (unsigned32t_image returnvalue)) (and (dynamic_invariant1 temp___15242 true false true true) (= temp___15242 (let ((temp___388 (to_string (attr__ATTRIBUTE_IMAGE4 returnvalue)))) (mk___t1 (elts temp___388) (mk1 (to_rep1 (first (rt temp___388))) (to_rep1 (last (rt temp___388))))))))))
(assert (and (= temp___15192 (returnt_image thecodename)) (and (dynamic_invariant1 temp___15192 true false true true) (= temp___15192 (let ((temp___1421 (to_string (attr__ATTRIBUTE_IMAGE6 thecodename)))) (mk___t1 (elts temp___1421) (mk1 (to_rep1 (first (rt temp___1421))) (to_rep1 (last (rt temp___1421))))))))))
(assert (=> (= (length1 text) 0) (= (temp___String_Literal_1516 Tuple0) temp___1518)))
(assert (=> (= (length1 text) 0) (= (mk 1 2) temp___15181)))
...
(assert (=> (not (= (length1 text) 0)) (= (concat1 (elts1 text) (to_rep1 (first2 (rt1 text))) (to_rep1 (last2 (rt1 text))) (temp___String_Literal_1516 Tuple0) 1 2) temp___1518)))
(assert (=> (not (= (length1 text) 0)) (= (mk (to_rep1 (first2 (rt1 text))) o5) temp___15181)))
(assert (=> (= (length (mk___t temp___1518 temp___15181)) 0) (= temp___1519 temp___1521)))
(assert (=> (= (length (mk___t temp___1518 temp___15181)) 0) (= (mk (to_rep1 (first2 temp___15191)) (to_rep1 (last2 temp___15191))) temp___15211)))
(assert (=> (not (= (length (mk___t temp___1518 temp___15181)) 0)) (=> (<= (to_rep1 (first2 temp___15191)) (to_rep1 (last2 temp___15191))) (= o6 (+ (- (to_rep1 (last2 temp___15191)) (to_rep1 (first2 temp___15191))) 1)))))
(assert (=> (not (= (length (mk___t temp___1518 temp___15181)) 0)) (=> (not (<= (to_rep1 (first2 temp___15191)) (to_rep1 (last2 temp___15191)))) (= o6 0))))
(assert (=> (not (= (length (mk___t temp___1518 temp___15181)) 0)) (=> (<= (to_rep1 (first temp___15181)) (to_rep1 (last temp___15181))) (= o7 (+ (- (to_rep1 (last temp___15181)) (to_rep1 (first temp___15181))) 1)))))
(assert (=> (not (= (length (mk___t temp___1518 temp___15181)) 0)) (=> (not (<= (to_rep1 (first temp___15181)) (to_rep1 (last temp___15181)))) (= o7 0))))
(assert (=> (not (= (length (mk___t temp___1518 temp___15181)) 0)) (= o8 (+ o7 o6))))
(assert (=> (not (= (length (mk___t temp___1518 temp___15181)) 0)) (= o9 (+ (to_rep1 (first temp___15181)) o8))))
(assert (=> (not (= (length (mk___t temp___1518 temp___15181)) 0)) (= o10 (- o9 1))))
(assert (=> (not (= (length (mk___t temp___1518 temp___15181)) 0)) (and (= o11 o10) (in_range2 o10))))
(assert (=> (not (= (length (mk___t temp___1518 temp___15181)) 0)) (= (concat1 temp___1518 (to_rep1 (first temp___15181)) (to_rep1 (last temp___15181)) temp___1519 (to_rep1 (first2 temp___15191)) (to_rep1 (last2 temp___15191))) temp___1521)))
(assert (=> (not (= (length (mk___t temp___1518 temp___15181)) 0)) (= (mk (to_rep1 (first temp___15181)) o11) temp___15211)))
(assert (=> (= (length (mk___t temp___1521 temp___15211)) 0) (= (temp___String_Literal_1520 Tuple0) temp___1523)))
(assert (=> (= (length (mk___t temp___1521 temp___15211)) 0) (= (mk 1 3) temp___15231)))
(assert (=> (not (= (length (mk___t temp___1521 temp___15211)) 0)) (=> (<= 1 3) (= o12 (+ (- 3 1) 1)))))
(assert (=> (not (= (length (mk___t temp___1521 temp___15211)) 0)) (=> (not (<= 1 3)) (= o12 0))))
(assert (=> (not (= (length (mk___t temp___1521 temp___15211)) 0)) (=> (<= (to_rep1 (first temp___15211)) (to_rep1 (last temp___15211))) (= o13 (+ (- (to_rep1 (last temp___15211)) (to_rep1 (first temp___15211))) 1)))))
(assert (=> (not (= (length (mk___t temp___1521 temp___15211)) 0)) (=> (not (<= (to_rep1 (first temp___15211)) (to_rep1 (last temp___15211)))) (= o13 0))))
(assert (=> (not (= (length (mk___t temp___1521 temp___15211)) 0)) (= o14 (+ o13 o12))))
(assert (=> (not (= (length (mk___t temp___1521 temp___15211)) 0)) (= o15 (+ (to_rep1 (first temp___15211)) o14))))
(assert (=> (not (= (length (mk___t temp___1521 temp___15211)) 0)) (= o16 (- o15 1))))
(assert (=> (not (= (length (mk___t temp___1521 temp___15211)) 0)) (and (= o17 o16) (in_range2 o16))))
(assert (=> (not (= (length (mk___t temp___1521 temp___15211)) 0)) (= (concat1 temp___1521 (to_rep1 (first temp___15211)) (to_rep1 (last temp___15211)) (temp___String_Literal_1520 Tuple0) 1 3) temp___1523)))
(assert (=> (not (= (length (mk___t temp___1521 temp___15211)) 0)) (= (mk (to_rep1 (first temp___15211)) o17) temp___15231)))
(assert (=> (= (length (mk___t temp___1523 temp___15231)) 0) (= temp___1524 temp___1526)))
(assert (=> (= (length (mk___t temp___1523 temp___15231)) 0) (= (mk (to_rep1 (first2 temp___15241)) (to_rep1 (last2 temp___15241))) temp___15261)))
(assert (=> (not (= (length (mk___t temp___1523 temp___15231)) 0)) (=> (<= (to_rep1 (first2 temp___15241)) (to_rep1 (last2 temp___15241))) (= o18 (+ (- (to_rep1 (last2 temp___15241)) (to_rep1 (first2 temp___15241))) 1)))))
(assert (=> (not (= (length (mk___t temp___1523 temp___15231)) 0)) (=> (not (<= (to_rep1 (first2 temp___15241)) (to_rep1 (last2 temp___15241)))) (= o18 0))))
(assert (=> (not (= (length (mk___t temp___1523 temp___15231)) 0)) (=> (<= (to_rep1 (first temp___15231)) (to_rep1 (last temp___15231))) (= o19 (+ (- (to_rep1 (last temp___15231)) (to_rep1 (first temp___15231))) 1)))))
(assert (=> (not (= (length (mk___t temp___1523 temp___15231)) 0)) (=> (not (<= (to_rep1 (first temp___15231)) (to_rep1 (last temp___15231)))) (= o19 0))))
(assert (=> (not (= (length (mk___t temp___1523 temp___15231)) 0)) (= o20 (+ o19 o18))))
(assert (=> (not (= (length (mk___t temp___1523 temp___15231)) 0)) (= o21 (+ (to_rep1 (first temp___15231)) o20))))
(assert (=> (not (= (length (mk___t temp___1523 temp___15231)) 0)) (= o22 (- o21 1))))
(assert (=> (not (= (length (mk___t temp___1523 temp___15231)) 0)) (and (= o23 o22) (in_range2 o22))))
(assert (=> (not (= (length (mk___t temp___1523 temp___15231)) 0)) (= (concat1 temp___1523 (to_rep1 (first temp___15231)) (to_rep1 (last temp___15231)) temp___1524 (to_rep1 (first2 temp___15241)) (to_rep1 (last2 temp___15241))) temp___1526)))
(assert (=> (not (= (length (mk___t temp___1523 temp___15231)) 0)) (= (mk (to_rep1 (first temp___15231)) o23) temp___15261)))
(assert (not (= (length (mk___t temp___1526 temp___15261)) 0)))
(assert (=> (<= 1 2) (= o24 (+ (- 2 1) 1))))
(assert (=> (not (<= 1 2)) (= o24 0)))
(assert (=> (<= (to_rep1 (first temp___15261)) (to_rep1 (last temp___15261))) (= o25 (+ (- (to_rep1 (last temp___15261)) (to_rep1 (first temp___15261))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___15261)) (to_rep1 (last temp___15261)))) (= o25 0)))
(assert (= o26 (+ o25 o24)))
(assert (= o27 (+ (to_rep1 (first temp___15261)) o26)))
(assert (= o28 (- o27 1)))
