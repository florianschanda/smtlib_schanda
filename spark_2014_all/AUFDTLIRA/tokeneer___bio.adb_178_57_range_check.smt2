...
(define-fun dynamic_invariant ((temp___expr_167 Int) (temp___is_init_164 Bool) (temp___skip_constant_165 Bool) (temp___do_toplevel_166 Bool)) Bool (=> (or (= temp___is_init_164 true) (<= 0 4294967295)) (in_range4 temp___expr_167)))
(declare-sort t1 0)
...
(assert (forall ((x Int)) (! (=> (dynamic_invariant x true true true) (dynamic_invariant1 (unsigned32t_image x) true false true)) :pattern ((unsigned32t_image x)))))
(assert (forall ((x Int)) (! (=> (dynamic_invariant x true true true) (= (unsigned32t_image x) (let ((temp___348 (to_string (attr__ATTRIBUTE_IMAGE4 x)))) (of_array1 (to_array temp___348) (first1 temp___348) (last1 temp___348))))) :pattern ((unsigned32t_image x)))))
...
(declare-fun user_eq8 (returnt returnt) Bool)
(declare-const dummy8 returnt)
...
(define-fun dynamic_invariant2 ((temp___expr_1266 Int) (temp___is_init_1263 Bool) (temp___skip_constant_1264 Bool) (temp___do_toplevel_1265 Bool)) Bool (=> (or (= temp___is_init_1263 true) (<= 0 16)) (in_range6 temp___expr_1266)))
(declare-fun returnt_image (Int) us_t1)
(declare-fun returnt_image__function_guard (us_t1 Int) Bool)
(assert (forall ((x Int)) (! (=> (dynamic_invariant2 x true true true) (dynamic_invariant1 (returnt_image x) true false true)) :pattern ((returnt_image x)))))
(assert (forall ((x Int)) (! (=> (dynamic_invariant2 x true true true) (= (returnt_image x) (let ((temp___1270 (to_string (attr__ATTRIBUTE_IMAGE6 x)))) (of_array1 (to_array temp___1270) (first1 temp___1270) (last1 temp___1270))))) :pattern ((returnt_image x)))))
...
(declare-fun temp___String_Literal_1355 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_1355 us_void_param) 1)) 58) (= (to_rep (select (temp___String_Literal_1355 us_void_param) 2)) 32)) :pattern ((temp___String_Literal_1355 us_void_param)))))
(declare-fun temp___String_Literal_1359 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (= (to_rep (select (temp___String_Literal_1359 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_1359 us_void_param) 2)) 40)) (= (to_rep (select (temp___String_Literal_1359 us_void_param) 3)) 32)) :pattern ((temp___String_Literal_1359 us_void_param)))))
(declare-fun temp___String_Literal_1364 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_1364 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_1364 us_void_param) 2)) 41)) :pattern ((temp___String_Literal_1364 us_void_param)))))
...
(define-fun dynamic_invariant7 ((temp___expr_522 Int) (temp___is_init_519 Bool) (temp___skip_constant_520 Bool) (temp___do_toplevel_521 Bool)) Bool (=> (or (= temp___is_init_519 true) (<= 1 150)) (in_range5 temp___expr_522)))
(define-fun dynamic_invariant8 ((temp___expr_260 us_t2) (temp___is_init_257 Bool) (temp___skip_constant_258 Bool) (temp___do_toplevel_259 Bool)) Bool (and (=> (not (= temp___skip_constant_258 true)) (dynamic_property2 1 2147483647 (first5 temp___expr_260) (last5 temp___expr_260))) (=> (= temp___do_toplevel_259 true) (=> (= temp___is_init_257 true) (and (= (first5 temp___expr_260) 1) (<= 0 (last5 temp___expr_260)))))))
...
(declare-const temp___1363 (Array Int character))
(declare-const temp___13631 t1)
(declare-const temp___1358 (Array Int character))
(declare-const temp___13581 t1)
(declare-const o Int)
...
(declare-const temp___1357 (Array Int character))
(declare-const temp___13571 t)
...
(declare-const temp___1360 (Array Int character))
(declare-const temp___13601 t)
...
(declare-const temp___1362 (Array Int character))
(declare-const temp___13621 t)
...
(declare-const temp___1365 (Array Int character))
(declare-const temp___13651 t)
...
(declare-const temp___1371 (Array Int character))
(declare-const temp___13711 t3)
(declare-const o30 (Array Int character))
(declare-const temp___1374 (Array Int character))
(declare-const temp___13741 t3)
...
(assert (in_range6 thecodename))
(assert (and (= (mk___t1 temp___1363 temp___13631) (unsigned32t_image returnvalue)) (and (dynamic_invariant1 (mk___t1 temp___1363 temp___13631) true false true) (= (mk___t1 temp___1363 temp___13631) (let ((temp___346 (to_string (attr__ATTRIBUTE_IMAGE4 returnvalue)))) (mk___t1 (elts temp___346) (mk1 (to_rep1 (first (rt temp___346))) (to_rep1 (last (rt temp___346))))))))))
(assert (and (= (mk___t1 temp___1358 temp___13581) (returnt_image thecodename)) (and (dynamic_invariant1 (mk___t1 temp___1358 temp___13581) true false true) (= (mk___t1 temp___1358 temp___13581) (let ((temp___1269 (to_string (attr__ATTRIBUTE_IMAGE6 thecodename)))) (mk___t1 (elts temp___1269) (mk1 (to_rep1 (first (rt temp___1269))) (to_rep1 (last (rt temp___1269))))))))))
(assert (=> (= (length1 text) 0) (= (temp___String_Literal_1355 Tuple0) temp___1357)))
(assert (=> (= (length1 text) 0) (= (mk 1 2) temp___13571)))
...
(assert (=> (not (= (length1 text) 0)) (= (concat1 (elts1 text) (to_rep1 (first2 (rt1 text))) (to_rep1 (last2 (rt1 text))) (temp___String_Literal_1355 Tuple0) 1 2) temp___1357)))
(assert (=> (not (= (length1 text) 0)) (= (mk (to_rep1 (first2 (rt1 text))) o5) temp___13571)))
(assert (=> (= (length (mk___t temp___1357 temp___13571)) 0) (= temp___1358 temp___1360)))
(assert (=> (= (length (mk___t temp___1357 temp___13571)) 0) (= (mk (to_rep1 (first2 temp___13581)) (to_rep1 (last2 temp___13581))) temp___13601)))
(assert (=> (not (= (length (mk___t temp___1357 temp___13571)) 0)) (=> (<= (to_rep1 (first2 temp___13581)) (to_rep1 (last2 temp___13581))) (= o6 (+ (- (to_rep1 (last2 temp___13581)) (to_rep1 (first2 temp___13581))) 1)))))
(assert (=> (not (= (length (mk___t temp___1357 temp___13571)) 0)) (=> (not (<= (to_rep1 (first2 temp___13581)) (to_rep1 (last2 temp___13581)))) (= o6 0))))
(assert (=> (not (= (length (mk___t temp___1357 temp___13571)) 0)) (=> (<= (to_rep1 (first temp___13571)) (to_rep1 (last temp___13571))) (= o7 (+ (- (to_rep1 (last temp___13571)) (to_rep1 (first temp___13571))) 1)))))
(assert (=> (not (= (length (mk___t temp___1357 temp___13571)) 0)) (=> (not (<= (to_rep1 (first temp___13571)) (to_rep1 (last temp___13571)))) (= o7 0))))
(assert (=> (not (= (length (mk___t temp___1357 temp___13571)) 0)) (= o8 (+ o7 o6))))
(assert (=> (not (= (length (mk___t temp___1357 temp___13571)) 0)) (= o9 (+ (to_rep1 (first temp___13571)) o8))))
(assert (=> (not (= (length (mk___t temp___1357 temp___13571)) 0)) (= o10 (- o9 1))))
(assert (=> (not (= (length (mk___t temp___1357 temp___13571)) 0)) (and (= o11 o10) (in_range2 o10))))
(assert (=> (not (= (length (mk___t temp___1357 temp___13571)) 0)) (= (concat1 temp___1357 (to_rep1 (first temp___13571)) (to_rep1 (last temp___13571)) temp___1358 (to_rep1 (first2 temp___13581)) (to_rep1 (last2 temp___13581))) temp___1360)))
(assert (=> (not (= (length (mk___t temp___1357 temp___13571)) 0)) (= (mk (to_rep1 (first temp___13571)) o11) temp___13601)))
(assert (=> (= (length (mk___t temp___1360 temp___13601)) 0) (= (temp___String_Literal_1359 Tuple0) temp___1362)))
(assert (=> (= (length (mk___t temp___1360 temp___13601)) 0) (= (mk 1 3) temp___13621)))
(assert (=> (not (= (length (mk___t temp___1360 temp___13601)) 0)) (=> (<= 1 3) (= o12 (+ (- 3 1) 1)))))
(assert (=> (not (= (length (mk___t temp___1360 temp___13601)) 0)) (=> (not (<= 1 3)) (= o12 0))))
(assert (=> (not (= (length (mk___t temp___1360 temp___13601)) 0)) (=> (<= (to_rep1 (first temp___13601)) (to_rep1 (last temp___13601))) (= o13 (+ (- (to_rep1 (last temp___13601)) (to_rep1 (first temp___13601))) 1)))))
(assert (=> (not (= (length (mk___t temp___1360 temp___13601)) 0)) (=> (not (<= (to_rep1 (first temp___13601)) (to_rep1 (last temp___13601)))) (= o13 0))))
(assert (=> (not (= (length (mk___t temp___1360 temp___13601)) 0)) (= o14 (+ o13 o12))))
(assert (=> (not (= (length (mk___t temp___1360 temp___13601)) 0)) (= o15 (+ (to_rep1 (first temp___13601)) o14))))
(assert (=> (not (= (length (mk___t temp___1360 temp___13601)) 0)) (= o16 (- o15 1))))
(assert (=> (not (= (length (mk___t temp___1360 temp___13601)) 0)) (and (= o17 o16) (in_range2 o16))))
(assert (=> (not (= (length (mk___t temp___1360 temp___13601)) 0)) (= (concat1 temp___1360 (to_rep1 (first temp___13601)) (to_rep1 (last temp___13601)) (temp___String_Literal_1359 Tuple0) 1 3) temp___1362)))
(assert (=> (not (= (length (mk___t temp___1360 temp___13601)) 0)) (= (mk (to_rep1 (first temp___13601)) o17) temp___13621)))
(assert (=> (= (length (mk___t temp___1362 temp___13621)) 0) (= temp___1363 temp___1365)))
(assert (=> (= (length (mk___t temp___1362 temp___13621)) 0) (= (mk (to_rep1 (first2 temp___13631)) (to_rep1 (last2 temp___13631))) temp___13651)))
(assert (=> (not (= (length (mk___t temp___1362 temp___13621)) 0)) (=> (<= (to_rep1 (first2 temp___13631)) (to_rep1 (last2 temp___13631))) (= o18 (+ (- (to_rep1 (last2 temp___13631)) (to_rep1 (first2 temp___13631))) 1)))))
(assert (=> (not (= (length (mk___t temp___1362 temp___13621)) 0)) (=> (not (<= (to_rep1 (first2 temp___13631)) (to_rep1 (last2 temp___13631)))) (= o18 0))))
(assert (=> (not (= (length (mk___t temp___1362 temp___13621)) 0)) (=> (<= (to_rep1 (first temp___13621)) (to_rep1 (last temp___13621))) (= o19 (+ (- (to_rep1 (last temp___13621)) (to_rep1 (first temp___13621))) 1)))))
(assert (=> (not (= (length (mk___t temp___1362 temp___13621)) 0)) (=> (not (<= (to_rep1 (first temp___13621)) (to_rep1 (last temp___13621)))) (= o19 0))))
(assert (=> (not (= (length (mk___t temp___1362 temp___13621)) 0)) (= o20 (+ o19 o18))))
(assert (=> (not (= (length (mk___t temp___1362 temp___13621)) 0)) (= o21 (+ (to_rep1 (first temp___13621)) o20))))
(assert (=> (not (= (length (mk___t temp___1362 temp___13621)) 0)) (= o22 (- o21 1))))
(assert (=> (not (= (length (mk___t temp___1362 temp___13621)) 0)) (and (= o23 o22) (in_range2 o22))))
(assert (=> (not (= (length (mk___t temp___1362 temp___13621)) 0)) (= (concat1 temp___1362 (to_rep1 (first temp___13621)) (to_rep1 (last temp___13621)) temp___1363 (to_rep1 (first2 temp___13631)) (to_rep1 (last2 temp___13631))) temp___1365)))
(assert (=> (not (= (length (mk___t temp___1362 temp___13621)) 0)) (= (mk (to_rep1 (first temp___13621)) o23) temp___13651)))
(assert (not (= (length (mk___t temp___1365 temp___13651)) 0)))
(assert (=> (<= 1 2) (= o24 (+ (- 2 1) 1))))
(assert (=> (not (<= 1 2)) (= o24 0)))
(assert (=> (<= (to_rep1 (first temp___13651)) (to_rep1 (last temp___13651))) (= o25 (+ (- (to_rep1 (last temp___13651)) (to_rep1 (first temp___13651))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___13651)) (to_rep1 (last temp___13651)))) (= o25 0)))
(assert (= o26 (+ o25 o24)))
(assert (= o27 (+ (to_rep1 (first temp___13651)) o26)))
(assert (= o28 (- o27 1)))
