...
(assert (= current1 1))
(assert (=> (and (<= 1 current1) (<= current1 limit)) (= temp___161 current1)))
(assert (=> (and (<= 1 current1) (<= current1 limit)) (= temp___160 smallest)))
(assert (=> (and (<= 1 current1) (<= current1 limit)) (= temp___159 values)))
(assert (=> (and (<= 1 current1) (<= current1 limit)) (and (= o (index_of_minimum current1 limit values)) (and (in_range2 o) (and (and (<= current1 o) (<= o limit)) (forall ((j1 Int)) (=> (and (<= current1 j1) (<= j1 limit)) (<= (to_rep (select values o)) (to_rep (select values j1))))))))))
(assert (=> (and (<= 1 current1) (<= current1 limit)) (= (mk_int__ref result1) smallest11)))
(assert (=> (and (<= 1 current1) (<= current1 limit)) (= smallest2 o)))
(assert (=> (and (<= 1 current1) (<= current1 limit)) (=> (not (= smallest2 current1)) (and (and (= (to_rep (select values2 current1)) (to_rep (select values smallest2))) (= (to_rep (select values2 smallest2)) (to_rep (select values current1)))) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 64)) (=> (and (not (= j1 current1)) (not (= j1 smallest2))) (= (to_rep (select values2 j1)) (to_rep (select values j1))))))))))
(assert (=> (and (<= 1 current1) (<= current1 limit)) (=> (not (not (= smallest2 current1))) (= values2 values))))
(assert (=> (and (<= 1 current1) (<= current1 limit)) (=> (not (not (= smallest2 current1))) (= values2 values1))))
(assert (=> (and (<= 1 current1) (<= current1 limit)) (and (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- current2 1))) (<= (to_rep (select values3 j1)) (to_rep (select values3 (+ j1 1)))))) (forall ((j1 Int)) (=> (and (<= current2 j1) (<= j1 limit)) (<= (to_rep (select values3 current2)) (to_rep (select values3 j1))))))))
(assert (=> (and (<= 1 current1) (<= current1 limit)) (and (and (=> (<= 1 64) (in_range2 smallest3)) (=> (<= 1 limit) (dynamic_property 1 limit current2))) (and (<= 1 current2) (<= current2 limit)))))
(assert (=> (and (<= 1 current1) (<= current1 limit)) (= current2 limit)))
(assert (=> (and (<= 1 current1) (<= current1 limit)) (= current2 current3)))
(assert (=> (and (<= 1 current1) (<= current1 limit)) (= smallest3 smallest4)))
(assert (=> (and (<= 1 current1) (<= current1 limit)) (= values3 values4)))
(assert (=> (and (<= 1 current1) (<= current1 limit)) (= current4 current2)))
(assert (=> (and (<= 1 current1) (<= current1 limit)) (= smallest5 smallest3)))
(assert (=> (and (<= 1 current1) (<= current1 limit)) (= values5 values3)))
(assert (=> (and (<= 1 current1) (<= current1 limit)) (= current9 (mk_int__ref current3))))
(assert (=> (and (<= 1 current1) (<= current1 limit)) (= smallest10 (mk_int__ref smallest4))))
(assert (=> (and (<= 1 current1) (<= current1 limit)) (= values10 (mk_map__ref values4))))
(assert (=> (and (<= 1 current1) (<= current1 limit)) (= current6 current4)))
(assert (=> (and (<= 1 current1) (<= current1 limit)) (= smallest7 smallest5)))
(assert (=> (and (<= 1 current1) (<= current1 limit)) (= values7 values5)))
(assert (=> (not (and (<= 1 current1) (<= current1 limit))) (= current1 current5)))
(assert (=> (not (and (<= 1 current1) (<= current1 limit))) (= smallest10 smallest11)))
(assert (=> (not (and (<= 1 current1) (<= current1 limit))) (= values10 (mk_map__ref values))))
(assert (=> (not (and (<= 1 current1) (<= current1 limit))) (= current6 current1)))
(assert (=> (not (and (<= 1 current1) (<= current1 limit))) (= smallest7 smallest1)))
(assert (=> (not (and (<= 1 current1) (<= current1 limit))) (= values7 values1)))
