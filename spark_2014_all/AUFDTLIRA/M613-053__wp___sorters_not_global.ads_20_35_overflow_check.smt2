...
(define-fun dynamic_invariant ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= 1 64)) (in_range2 temp___expr_142)))
...
(declare-fun index_of_minimum__function_guard (Int Int Int (Array Int integer)) Bool)
(assert (forall ((starting_at Int) (limit1 Int)) (forall ((values (Array Int integer))) (! (=> (and (and (dynamic_invariant starting_at true true true) (dynamic_invariant limit1 true true true)) (<= starting_at limit1)) (let ((result (index_of_minimum starting_at limit1 values))) (and (and (and (<= starting_at result) (<= result limit1)) (forall ((j Int)) (=> (and (<= starting_at j) (<= j limit1)) (<= (to_rep (select values result)) (to_rep (select values j)))))) (dynamic_invariant result true false true)))) :pattern ((index_of_minimum starting_at limit1 values))))))
...
(assert (= current1 1))
(assert (=> (and (<= 1 current1) (<= current1 limit)) (and (and (= temp___161 current1) (and (= temp___160 smallest) (and (= temp___159 values) (and (and (and (= o (index_of_minimum current1 limit values)) (and (in_range2 o) (and (and (<= current1 o) (<= o limit)) (forall ((j3 Int)) (=> (and (<= current1 j3) (<= j3 limit)) (<= (to_rep (select values o)) (to_rep (select values j3)))))))) (and (= (mk_int__ref result1) (mk_int__ref smallest)) (= smallest2 o))) (and (ite (not (= smallest2 current1)) (and (and (= (to_rep (select values2 current1)) (to_rep (select values smallest2))) (= (to_rep (select values2 smallest2)) (to_rep (select values current1)))) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 64)) (=> (and (not (= j3 current1)) (not (= j3 smallest2))) (= (to_rep (select values2 j3)) (to_rep (select values j3))))))) (and (= values2 values) (= values2 values1))) (and (and (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 (- current2 1))) (<= (to_rep (select values3 j3)) (to_rep (select values3 (+ j3 1)))))) (forall ((j3 Int)) (=> (and (<= current2 j3) (<= j3 limit)) (<= (to_rep (select values3 current2)) (to_rep (select values3 j3)))))) (and (and (and (=> (<= 1 64) (in_range2 smallest3)) (=> (<= 1 limit) (dynamic_property 1 limit current2))) (and (<= 1 current2) (<= current2 limit))) (= current2 limit)))))))) (and (and (= current2 current6) (and (= smallest3 smallest7) (= values3 values7))) (and (= current7 current2) (and (= smallest8 smallest3) (= values8 values3)))))))
(assert (=> (and (<= 1 current1) (<= current1 limit)) (= (mk_int__ref current8) (mk_int__ref current6))))
(assert (=> (and (<= 1 current1) (<= current1 limit)) (= (mk_int__ref smallest9) (mk_int__ref smallest7))))
(assert (=> (and (<= 1 current1) (<= current1 limit)) (= (mk_map__ref values9) (mk_map__ref values7))))
(assert (=> (and (<= 1 current1) (<= current1 limit)) (= current9 current7)))
(assert (=> (and (<= 1 current1) (<= current1 limit)) (= smallest10 smallest8)))
(assert (=> (and (<= 1 current1) (<= current1 limit)) (= values10 values8)))
(assert (=> (not (and (<= 1 current1) (<= current1 limit))) (= current1 current8)))
(assert (=> (not (and (<= 1 current1) (<= current1 limit))) (= (mk_int__ref smallest9) (mk_int__ref smallest))))
(assert (=> (not (and (<= 1 current1) (<= current1 limit))) (= (mk_map__ref values9) (mk_map__ref values))))
(assert (=> (not (and (<= 1 current1) (<= current1 limit))) (= current9 current1)))
(assert (=> (not (and (<= 1 current1) (<= current1 limit))) (= smallest10 smallest1)))
(assert (=> (not (and (<= 1 current1) (<= current1 limit))) (= values10 values1)))
(assert (= (mk_int__ref current10) (mk_int__ref current8)))
(assert (= (mk_int__ref smallest11) (mk_int__ref smallest9)))
