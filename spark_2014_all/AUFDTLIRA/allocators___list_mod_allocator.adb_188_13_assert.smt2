...
(assert (<= 1 r1))
(assert (<= r1 10000))
(assert (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data2 r1)))) 0))
(assert (not (= (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select data2 r1)))) 0)))
(assert (not (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data2 (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select data2 r1)))))))) 0)))
(check-sat)
(exit)
