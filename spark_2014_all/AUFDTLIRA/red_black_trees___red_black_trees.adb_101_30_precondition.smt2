...
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select m i))) true) (< n2 (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 i)))))) (< (length (rec__tree_model__path_type__a (us_split_fields1 (select m i)))) (- 100 n2)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select m i))) true) (and (and (and (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 i)))) n2) (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select res2 i))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res2 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res2 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i 1)))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 i)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res2 i)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) i)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res2 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i 0)))))))))))))
