...
(assert (forall ((temp___168 Int)) (forall ((temp___169 Int)) (= (select (array_logical_ops__test_ok4__w__aggregate_def temp___168) temp___169) (of_rep temp___168)))))
(declare-sort t29b 0)
...
(assert (forall ((temp___171 Int)) (forall ((temp___172 Int)) (= (select (array_logical_ops__test_ok4__z__aggregate_def temp___171) temp___172) (of_rep temp___171)))))
...
(assert (dynamic_invariant r4 true false true))
