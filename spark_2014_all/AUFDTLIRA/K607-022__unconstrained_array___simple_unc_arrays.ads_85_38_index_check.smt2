...
(assert (forall ((a (Array Int value)) (b (Array Int value))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep2 (select a (+ i 1))) (to_rep2 (select b (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int value)) (b (Array Int value))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep2 (select b (+ i 1))) (to_rep2 (select a (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
...
(define-fun dynamic_invariant2 ((temp___expr_536 us_rep) (temp___is_init_533 Bool) (temp___skip_constant_534 Bool) (temp___do_toplevel_535 Bool)) Bool (let ((temp___537 (rec__simple_unc_arrays__table__last (us_split_discrs1 temp___expr_536)))) (and (dynamic_property2 1 (to_rep temp___537) (first3 (rec__simple_unc_arrays__table__v (us_split_fields1 temp___expr_536))) (last3 (rec__simple_unc_arrays__table__v (us_split_fields1 temp___expr_536)))) (and (= (first3 (rec__simple_unc_arrays__table__v (us_split_fields1 temp___expr_536))) 1) (= (last3 (rec__simple_unc_arrays__table__v (us_split_fields1 temp___expr_536))) (to_rep temp___537))))))
...
(define-fun dynamic_invariant5 ((temp___expr_531 us_t) (temp___is_init_528 Bool) (temp___skip_constant_529 Bool) (temp___do_toplevel_530 Bool)) Bool (=> (not (= temp___skip_constant_529 true)) (dynamic_property 1 2147483647 (first1 temp___expr_531) (last1 temp___expr_531))))
(define-fun dynamic_invariant6 ((temp___expr_738 us_t2) (temp___is_init_735 Bool) (temp___skip_constant_736 Bool) (temp___do_toplevel_737 Bool)) Bool (=> (not (= temp___skip_constant_736 true)) (and (dynamic_property4 1 r59b (first5 temp___expr_738) (last5 temp___expr_738)) (and (= (first5 temp___expr_738) 1) (= (last5 temp___expr_738) r59b)))))
(declare-const bull Bool)
(declare-const res__split_fields (Array Int value))
(declare-const res__split_fields1 t1)
(declare-const i Int)
...
(declare-const simple_unc_arrays__bubble_sort__result2 t1)
(declare-const us Int)
(declare-const temp___913 natural)
(declare-const temp___9131 (Array Int value))
(declare-const temp___9132 t1)
(declare-const temp___912 Bool)
(declare-const temp___908 natural)
(declare-const temp___9081 (Array Int value))
(declare-const temp___9082 t1)
(declare-const temp___907 Bool)
...
(assert (and (and (and (= us (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a)))) (in_range2 (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))))) (and (and (= (mk_bool__ref result) (mk_bool__ref bull)) (= bull1 (of_int 1))) (and (and (and (= (mk___split_fields__ref (mk___split_fields (mk___t1 result1 result2))) (mk___split_fields__ref (mk___split_fields (mk___t1 res__split_fields res__split_fields1)))) (= res__split_fields2 (us_split_fields1 a))) (= res__split_discrs (us_split_discrs1 a))) (and (dynamic_invariant2 (mk___rep res__split_discrs res__split_fields2) true false true) (and (ite (= bull1 true) (and (and (and (and (= res__split_discrs (mk___split_discrs temp___913)) (= res__split_fields2 (mk___split_fields (mk___t1 temp___9131 temp___9132)))) (and (= temp___912 bull1) (and (and (and (dynamic_invariant2 (mk___rep res__split_discrs res__split_fields3) false true true) (= (rec__simple_unc_arrays__table__last res__split_discrs) temp___913)) (= bull2 true)) (and (and (= result3 (mk_bool__ref bull2)) (= bull3 (of_int 0))) (and (and (= (- (to_rep (rec__simple_unc_arrays__table__last res__split_discrs)) 1) r56b) (in_range1 r56b)) (and (and (and (= result4 (mk_int__ref i2)) (= i3 1)) (ite (and (<= 1 i3) (<= i3 r56b)) (and (and (and (and (= res__split_discrs (mk___split_discrs temp___908)) (= res__split_fields3 (mk___split_fields (mk___t1 temp___9081 temp___9082)))) (and (= temp___907 bull3) (and (and (and (dynamic_invariant2 (mk___rep res__split_discrs res__split_fields4) false true true) (= (rec__simple_unc_arrays__table__last res__split_discrs) temp___908)) (and (<= 1 i4) (<= i4 r56b))) (and (and (and (and (and (and (and (<= (to_rep1 (first2 (rt1 (rec__simple_unc_arrays__table__v res__split_fields4)))) i4) (<= i4 (to_rep1 (last2 (rt1 (rec__simple_unc_arrays__table__v res__split_fields4)))))) (= o2 i4)) (= o3 (select (elts1 (rec__simple_unc_arrays__table__v res__split_fields4)) o2))) (= o4 (to_rep2 o3))) (and (and (and (and (and (= temp___900 (+ i4 1)) (in_range1 (+ i4 1))) (and (and (<= (to_rep1 (first2 (rt1 (rec__simple_unc_arrays__table__v res__split_fields4)))) temp___900) (<= temp___900 (to_rep1 (last2 (rt1 (rec__simple_unc_arrays__table__v res__split_fields4)))))) (= o temp___900))) (= o1 (select (elts1 (rec__simple_unc_arrays__table__v res__split_fields4)) o))) (= o5 (to_rep2 o1))) (= result5 (ite (< o5 o4) true false)))) (ite (= result5 true) (and (and (= (to_rep (rec__simple_unc_arrays__table__last res__split_discrs)) r59b) (in_range2 r59b)) (and (and (and (= (ite (<= (to_rep1 (first2 (rt1 (rec__simple_unc_arrays__table__v res__split_fields4)))) (to_rep1 (last2 (rt1 (rec__simple_unc_arrays__table__v res__split_fields4))))) (+ (- (to_rep1 (last2 (rt1 (rec__simple_unc_arrays__table__v res__split_fields4)))) (to_rep1 (first2 (rt1 (rec__simple_unc_arrays__table__v res__split_fields4))))) 1) 0) (ite (<= 1 r59b) (+ (- r59b 1) 1) 0)) (and (= (elts1 (rec__simple_unc_arrays__table__v res__split_fields4)) simple_unc_arrays__swap_cells__a__compl) (= (mk2 (to_rep1 (first2 (rt1 (rec__simple_unc_arrays__table__v res__split_fields4)))) (to_rep1 (last2 (rt1 (rec__simple_unc_arrays__table__v res__split_fields4))))) simple_unc_arrays__swap_cells__a__compl1))) (and (and (and (= o8 (+ i4 1)) (in_range1 (+ i4 1))) (and (= (to_rep1 o7) (to_rep1 (last4 simple_unc_arrays__swap_cells__a__compl1))) (and (= (to_rep1 o6) (to_rep1 (first4 simple_unc_arrays__swap_cells__a__compl1))) (and (and (= (to_rep2 (select simple_unc_arrays__swap_cells__a i4)) (to_rep2 (select simple_unc_arrays__swap_cells__a__compl o8))) (= (to_rep2 (select simple_unc_arrays__swap_cells__a o8)) (to_rep2 (select simple_unc_arrays__swap_cells__a__compl i4)))) (forall ((k1 Int)) (=> (and (<= (to_rep1 o6) k1) (<= k1 (to_rep1 o7))) (=> (and (not (= k1 i4)) (not (= k1 o8))) (= (to_rep2 (select simple_unc_arrays__swap_cells__a k1)) (to_rep2 (select simple_unc_arrays__swap_cells__a__compl k1)))))))))) (and (= result6 (mk___split_fields__ref res__split_fields4)) (= res__split_fields5 (mk___split_fields (mk___t1 (slide simple_unc_arrays__swap_cells__a (to_rep1 (first (mk (to_rep1 (first4 simple_unc_arrays__swap_cells__a__compl1)) (to_rep1 (last4 simple_unc_arrays__swap_cells__a__compl1))))) 1) (mk1 (to_rep1 (first4 (mk2 1 r59b))) (to_rep1 (last4 (mk2 1 r59b)))))))))) (and (= result7 (mk_bool__ref bull4)) (= bull5 (of_int 1))))) (and (and (= res__split_fields5 res__split_fields4) (= bull5 bull4)) (and (= simple_unc_arrays__swap_cells__a rho1) (and (= res__split_fields5 res__split_fields4) (= bull5 bull4)))))) (= i4 r56b))))) (and (and (= i5 (mk_int__ref i4)) (and (= res__split_fields6 (mk___split_fields__ref res__split_fields5)) (= bull6 (mk_bool__ref bull5)))) (and (= rho2 simple_unc_arrays__swap_cells__a) (and (= i6 i4) (and (= res__split_fields7 res__split_fields5) (= bull7 bull5)))))) (and (and (= i7 i5) (and (= res__split_fields8 res__split_fields6) (= bull8 bull6))) (and (= rho3 rho2) (and (= i8 i6) (and (= res__split_fields9 res__split_fields7) (= bull9 bull7)))))) (and (and (= i7 (mk_int__ref i3)) (and (= res__split_fields8 (mk___split_fields__ref res__split_fields3)) (= bull8 (mk_bool__ref bull3)))) (and (= rho3 rho) (and (= i8 i3) (and (= res__split_fields9 res__split_fields3) (= bull9 bull3))))))) (not (= (bool__content bull8) true)))))))) (and (and (= i9 i7) (and (= res__split_fields10 res__split_fields8) (= bull10 bull8))) (and (= i10 i8) (and (= res__split_fields11 res__split_fields9) (= bull11 bull9))))) (and (and (= i11 i9) (and (= res__split_fields12 res__split_fields10) (= bull12 bull10))) (and (= i12 i10) (and (= res__split_fields13 res__split_fields11) (= bull13 bull11))))) (and (and (= i11 (mk_int__ref i)) (and (= res__split_fields12 (mk___split_fields__ref res__split_fields2)) (= bull12 (mk_bool__ref bull1)))) (and (= i12 i1) (and (= res__split_fields13 res__split_fields2) (= bull13 bull1))))) (and (and (= simple_unc_arrays__bubble_sort__result4 (mk_table__ref simple_unc_arrays__bubble_sort__result3)) (= simple_unc_arrays__bubble_sort__result5 simple_unc_arrays__bubble_sort__result3)) (and (= result8 (mk_table__ref (mk___rep (mk___split_discrs simple_unc_arrays__bubble_sort__result) (mk___split_fields (mk___t1 simple_unc_arrays__bubble_sort__result1 simple_unc_arrays__bubble_sort__result2))))) (= simple_unc_arrays__bubble_sort__result3 (mk___rep res__split_discrs (us_split_fields__content res__split_fields12)))))))))) (and (and (= simple_unc_arrays__bubble_sort__result6 simple_unc_arrays__bubble_sort__result4) (and (= i13 i11) (and (= res__split_fields14 res__split_fields12) (= bull14 bull12)))) (and (= simple_unc_arrays__bubble_sort__result7 simple_unc_arrays__bubble_sort__result5) (and (= i14 i12) (and (= res__split_fields15 res__split_fields13) (= bull15 bull13)))))))
(assert (<= 1 j1))
(assert (<= j1 (- (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))) 1)))
(assert (and (= temp___925 (+ j1 1)) (in_range1 (+ j1 1))))
(assert (and (<= (to_rep1 (first2 (rt1 (rec__simple_unc_arrays__table__v (us_split_fields1 (table__content simple_unc_arrays__bubble_sort__result6)))))) temp___925) (<= temp___925 (to_rep1 (last2 (rt1 (rec__simple_unc_arrays__table__v (us_split_fields1 (table__content simple_unc_arrays__bubble_sort__result6)))))))))
(assert (= o12 temp___925))
(assert (= o13 (select (elts1 (rec__simple_unc_arrays__table__v (us_split_fields1 (table__content simple_unc_arrays__bubble_sort__result6)))) o12)))
(assert (= o14 (to_rep2 o13)))
(assert (not (<= (to_rep1 (first2 (rt1 (rec__simple_unc_arrays__table__v (us_split_fields1 (table__content simple_unc_arrays__bubble_sort__result6)))))) j1)))
(check-sat)
(exit)
