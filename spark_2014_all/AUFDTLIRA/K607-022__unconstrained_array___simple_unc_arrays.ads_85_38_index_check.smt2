...
(define-fun dynamic_invariant6 ((temp___expr_821 us_t2) (temp___is_init_817 Bool) (temp___skip_constant_818 Bool) (temp___do_toplevel_819 Bool) (temp___do_typ_inv_820 Bool)) Bool (=> (not (= temp___skip_constant_818 true)) (and (dynamic_property4 1 r59b (first5 temp___expr_821) (last5 temp___expr_821)) (and (= (first5 temp___expr_821) 1) (= (last5 temp___expr_821) r59b)))))
...
(declare-const temp___998 natural)
(declare-const temp___9981 (Array Int value))
(declare-const temp___9982 t1)
(declare-const temp___997 Bool)
(declare-const temp___993 natural)
(declare-const temp___9931 (Array Int value))
(declare-const temp___9932 t1)
(declare-const temp___992 Bool)
...
(assert (=> (= bull1 true) (and (= res__split_discrs (mk___split_discrs temp___998)) (= res__split_fields2 (mk___split_fields (mk___t1 temp___9981 temp___9982))))))
(assert (=> (= bull1 true) (= temp___997 bull1)))
(assert (=> (= bull1 true) (and (and (dynamic_invariant2 (mk___rep res__split_discrs res__split_fields3) false true true true) (= (rec__simple_unc_arrays__table__last res__split_discrs) temp___998)) (= bull2 true))))
...
(assert (=> (= bull1 true) (=> (and (<= 1 i3) (<= i3 r56b)) (and (= res__split_discrs (mk___split_discrs temp___993)) (= res__split_fields3 (mk___split_fields (mk___t1 temp___9931 temp___9932)))))))
(assert (=> (= bull1 true) (=> (and (<= 1 i3) (<= i3 r56b)) (= temp___992 bull3))))
(assert (=> (= bull1 true) (=> (and (<= 1 i3) (<= i3 r56b)) (and (and (dynamic_invariant2 (mk___rep res__split_discrs res__split_fields4) false true true true) (= (rec__simple_unc_arrays__table__last res__split_discrs) temp___993)) (and (<= 1 i4) (<= i4 r56b))))))
...
(assert (=> (= bull1 true) (=> (and (<= 1 i3) (<= i3 r56b)) (and (= temp___985 (+ i4 1)) (in_range1 (+ i4 1))))))
(assert (=> (= bull1 true) (=> (and (<= 1 i3) (<= i3 r56b)) (and (<= (to_rep1 (first2 (rt1 (rec__simple_unc_arrays__table__v res__split_fields4)))) temp___985) (<= temp___985 (to_rep1 (last2 (rt1 (rec__simple_unc_arrays__table__v res__split_fields4)))))))))
(assert (=> (= bull1 true) (=> (and (<= 1 i3) (<= i3 r56b)) (= o temp___985))))
...
(assert (and (= temp___1010 (+ j 1)) (in_range1 (+ j 1))))
(assert (and (<= (to_rep1 (first2 (rt1 (rec__simple_unc_arrays__table__v (us_split_fields1 (table__content simple_unc_arrays__bubble_sort__result6)))))) temp___1010) (<= temp___1010 (to_rep1 (last2 (rt1 (rec__simple_unc_arrays__table__v (us_split_fields1 (table__content simple_unc_arrays__bubble_sort__result6)))))))))
(assert (= o9 temp___1010))
