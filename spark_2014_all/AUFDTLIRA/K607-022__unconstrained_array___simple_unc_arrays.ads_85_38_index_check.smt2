...
(assert (and (= temp___1003 (+ j 1)) (in_range1 (+ j 1))))
(assert (and (<= (to_rep1 (first (rt (rec__simple_unc_arrays__table__v (us_split_fields1 (table__content simple_unc_arrays__bubble_sort__result6)))))) temp___1003) (<= temp___1003 (to_rep1 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 (table__content simple_unc_arrays__bubble_sort__result6)))))))))
(assert (= o9 temp___1003))
(assert (= o10 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 (table__content simple_unc_arrays__bubble_sort__result6)))) o9)))
(assert (= o11 (to_rep2 o10)))
(assert (not (<= j (to_rep1 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 (table__content simple_unc_arrays__bubble_sort__result6)))))))))
(check-sat)
(exit)
