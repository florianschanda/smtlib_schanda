...
(define-fun dynamic_invariant2 ((temp___expr_542 us_rep) (temp___is_init_539 Bool) (temp___skip_constant_540 Bool) (temp___do_toplevel_541 Bool)) Bool (let ((temp___543 (rec__simple_unc_arrays__table__last (us_split_discrs1 temp___expr_542)))) (and (dynamic_property2 1 (to_rep temp___543) (first3 (rec__simple_unc_arrays__table__v (us_split_fields1 temp___expr_542))) (last3 (rec__simple_unc_arrays__table__v (us_split_fields1 temp___expr_542)))) (and (= (first3 (rec__simple_unc_arrays__table__v (us_split_fields1 temp___expr_542))) 1) (= (last3 (rec__simple_unc_arrays__table__v (us_split_fields1 temp___expr_542))) (to_rep temp___543))))))
...
(define-fun dynamic_invariant5 ((temp___expr_537 us_t) (temp___is_init_534 Bool) (temp___skip_constant_535 Bool) (temp___do_toplevel_536 Bool)) Bool (=> (not (= temp___skip_constant_535 true)) (dynamic_property 1 2147483647 (first1 temp___expr_537) (last1 temp___expr_537))))
(define-fun dynamic_invariant6 ((temp___expr_744 us_t2) (temp___is_init_741 Bool) (temp___skip_constant_742 Bool) (temp___do_toplevel_743 Bool)) Bool (=> (not (= temp___skip_constant_742 true)) (and (dynamic_property4 1 r59b (first5 temp___expr_744) (last5 temp___expr_744)) (and (= (first5 temp___expr_744) 1) (= (last5 temp___expr_744) r59b)))))
...
(declare-const temp___919 natural)
(declare-const temp___9191 (Array Int value))
(declare-const temp___9192 t1)
(declare-const temp___918 Bool)
(declare-const temp___914 natural)
(declare-const temp___9141 (Array Int value))
(declare-const temp___9142 t1)
(declare-const temp___913 Bool)
...
(assert (and (= us (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a)))) (in_range2 (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))))))
(assert (= (mk_bool__ref result) (mk_bool__ref bull)))
(assert (= bull1 (of_int 1)))
(assert (= (mk___split_fields__ref (mk___split_fields (mk___t1 result1 result2))) (mk___split_fields__ref (mk___split_fields (mk___t1 res__split_fields res__split_fields1)))))
(assert (= res__split_fields2 (us_split_fields1 a)))
(assert (= res__split_discrs (us_split_discrs1 a)))
(assert (dynamic_invariant2 (mk___rep res__split_discrs res__split_fields2) true false true))
(assert (=> (= bull1 true) (and (= res__split_discrs (mk___split_discrs temp___919)) (= res__split_fields2 (mk___split_fields (mk___t1 temp___9191 temp___9192))))))
(assert (=> (= bull1 true) (= temp___918 bull1)))
(assert (=> (= bull1 true) (and (and (dynamic_invariant2 (mk___rep res__split_discrs res__split_fields3) false true true) (= (rec__simple_unc_arrays__table__last res__split_discrs) temp___919)) (= bull2 true))))
(assert (=> (= bull1 true) (= result3 (mk_bool__ref bull2))))
(assert (=> (= bull1 true) (= bull3 (of_int 0))))
...
(assert (=> (= bull1 true) (=> (and (<= 1 i3) (<= i3 r56b)) (and (= res__split_discrs (mk___split_discrs temp___914)) (= res__split_fields3 (mk___split_fields (mk___t1 temp___9141 temp___9142)))))))
(assert (=> (= bull1 true) (=> (and (<= 1 i3) (<= i3 r56b)) (= temp___913 bull3))))
(assert (=> (= bull1 true) (=> (and (<= 1 i3) (<= i3 r56b)) (and (and (dynamic_invariant2 (mk___rep res__split_discrs res__split_fields4) false true true) (= (rec__simple_unc_arrays__table__last res__split_discrs) temp___914)) (and (<= 1 i4) (<= i4 r56b))))))
(assert (=> (= bull1 true) (=> (and (<= 1 i3) (<= i3 r56b)) (and (<= (to_rep1 (first2 (rt1 (rec__simple_unc_arrays__table__v res__split_fields4)))) i4) (<= i4 (to_rep1 (last2 (rt1 (rec__simple_unc_arrays__table__v res__split_fields4)))))))))
(assert (=> (= bull1 true) (=> (and (<= 1 i3) (<= i3 r56b)) (= o2 i4))))
(assert (=> (= bull1 true) (=> (and (<= 1 i3) (<= i3 r56b)) (= o3 (select (elts1 (rec__simple_unc_arrays__table__v res__split_fields4)) o2)))))
(assert (=> (= bull1 true) (=> (and (<= 1 i3) (<= i3 r56b)) (= o4 (to_rep2 o3)))))
(assert (=> (= bull1 true) (=> (and (<= 1 i3) (<= i3 r56b)) (and (= temp___906 (+ i4 1)) (in_range1 (+ i4 1))))))
(assert (=> (= bull1 true) (=> (and (<= 1 i3) (<= i3 r56b)) (and (<= (to_rep1 (first2 (rt1 (rec__simple_unc_arrays__table__v res__split_fields4)))) temp___906) (<= temp___906 (to_rep1 (last2 (rt1 (rec__simple_unc_arrays__table__v res__split_fields4)))))))))
(assert (=> (= bull1 true) (=> (and (<= 1 i3) (<= i3 r56b)) (= o temp___906))))
(assert (=> (= bull1 true) (=> (and (<= 1 i3) (<= i3 r56b)) (= o1 (select (elts1 (rec__simple_unc_arrays__table__v res__split_fields4)) o)))))
...
(assert (=> (= bull1 true) (=> (and (<= 1 i3) (<= i3 r56b)) (=> (= result5 true) (= (ite (<= (to_rep1 (first2 (rt1 (rec__simple_unc_arrays__table__v res__split_fields4)))) (to_rep1 (last2 (rt1 (rec__simple_unc_arrays__table__v res__split_fields4))))) (+ (- (to_rep1 (last2 (rt1 (rec__simple_unc_arrays__table__v res__split_fields4)))) (to_rep1 (first2 (rt1 (rec__simple_unc_arrays__table__v res__split_fields4))))) 1) 0) (ite (<= 1 r59b) (+ (- r59b 1) 1) 0))))))
(assert (=> (= bull1 true) (=> (and (<= 1 i3) (<= i3 r56b)) (=> (= result5 true) (= (elts1 (rec__simple_unc_arrays__table__v res__split_fields4)) simple_unc_arrays__swap_cells__a__compl)))))
(assert (=> (= bull1 true) (=> (and (<= 1 i3) (<= i3 r56b)) (=> (= result5 true) (= (mk2 (to_rep1 (first2 (rt1 (rec__simple_unc_arrays__table__v res__split_fields4)))) (to_rep1 (last2 (rt1 (rec__simple_unc_arrays__table__v res__split_fields4))))) simple_unc_arrays__swap_cells__a__compl1)))))
...
(assert (=> (= bull1 true) (=> (and (<= 1 i3) (<= i3 r56b)) (=> (= result5 true) (= res__split_fields5 (mk___split_fields (mk___t1 (slide simple_unc_arrays__swap_cells__a (to_rep1 (first (mk (to_rep1 (first4 simple_unc_arrays__swap_cells__a__compl1)) (to_rep1 (last4 simple_unc_arrays__swap_cells__a__compl1))))) 1) (mk1 (to_rep1 (first4 (mk2 1 r59b))) (to_rep1 (last4 (mk2 1 r59b)))))))))))
(assert (=> (= bull1 true) (=> (and (<= 1 i3) (<= i3 r56b)) (=> (= result5 true) (= result7 (mk_bool__ref bull4))))))
(assert (=> (= bull1 true) (=> (and (<= 1 i3) (<= i3 r56b)) (=> (= result5 true) (= bull5 (of_int 1))))))
...
(assert (= result8 (mk_table__ref (mk___rep (mk___split_discrs simple_unc_arrays__bubble_sort__result) (mk___split_fields (mk___t1 simple_unc_arrays__bubble_sort__result1 simple_unc_arrays__bubble_sort__result2))))))
...
(assert (and (= temp___931 (+ j 1)) (in_range1 (+ j 1))))
(assert (and (<= (to_rep1 (first2 (rt1 (rec__simple_unc_arrays__table__v (us_split_fields1 (table__content simple_unc_arrays__bubble_sort__result6)))))) temp___931) (<= temp___931 (to_rep1 (last2 (rt1 (rec__simple_unc_arrays__table__v (us_split_fields1 (table__content simple_unc_arrays__bubble_sort__result6)))))))))
(assert (= o9 temp___931))
(assert (= o10 (select (elts1 (rec__simple_unc_arrays__table__v (us_split_fields1 (table__content simple_unc_arrays__bubble_sort__result6)))) o9)))
(assert (= o11 (to_rep2 o10)))
(assert (not (<= (to_rep1 (first2 (rt1 (rec__simple_unc_arrays__table__v (us_split_fields1 (table__content simple_unc_arrays__bubble_sort__result6)))))) j)))
(check-sat)
(exit)
