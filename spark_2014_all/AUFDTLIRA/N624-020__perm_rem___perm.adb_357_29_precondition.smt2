...
(define-fun o11 () us_t (mk___t o9 o10))
(define-fun o12 () us_t (mk___t o7 o8))
...
(assert (and (= o1 (perm_symmetric aa bb2)) (and (in_range2 o1) (=> (= (distinct o1 0) true) (= (is_perm bb2 aa) true)))))
(assert (= h1 result1))
(assert (= h2 o1))
...
(assert (= ia21 o4))
(assert (and (= o5 (remove_swap b ib2 ib)) (and (in_range2 o5) (=> (= (distinct o5 0) true) (= (let ((temp___182 (remove (remove b ib) ib2))) (let ((temp___181 (remove (remove b ib2) (- ib 1)))) (bool_eq (elts temp___181) (to_rep1 (first (rt temp___181))) (to_rep1 (last (rt temp___181))) (elts temp___182) (to_rep1 (first (rt temp___182))) (to_rep1 (last (rt temp___182)))))) true)))))
(assert (= result4 (mk_int__ref h3)))
(assert (= h4 o5))
(assert (= (distinct h4 0) true))
(assert (and (= o11 (remove bb ib2)) (and (dynamic_invariant2 o11 true false true true) (and (= (invariant__ o11) true) (and (= (to_rep1 (last o10)) (- (to_rep1 (last (rt bb))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib2 1))) (= (to_rep (select (elts bb) k)) (to_rep (select o9 k))))) (and (forall ((k Int)) (=> (and (<= (+ ib2 1) k) (<= k (to_rep1 (last (rt bb))))) (= (to_rep (select (elts bb) k)) (to_rep (select o9 (- k 1)))))) (forall ((k Int)) (=> (and (<= ib2 k) (<= k (- (to_rep1 (last (rt bb))) 1))) (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select o9 k))))))))))))
(assert (and (= o12 (remove aa ia21)) (and (dynamic_invariant2 o12 true false true true) (and (= (invariant__ o12) true) (and (= (to_rep1 (last o8)) (- (to_rep1 (last (rt aa))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ia21 1))) (= (to_rep (select (elts aa) k)) (to_rep (select o7 k))))) (and (forall ((k Int)) (=> (and (<= (+ ia21 1) k) (<= k (to_rep1 (last (rt aa))))) (= (to_rep (select (elts aa) k)) (to_rep (select o7 (- k 1)))))) (forall ((k Int)) (=> (and (<= ia21 k) (<= k (- (to_rep1 (last (rt aa))) 1))) (= (to_rep (select (elts aa) (+ k 1))) (to_rep (select o7 k))))))))))))
(assert (and (= o6 (- ib 1)) (in_range3 (- ib 1))))
(assert (not (= (invariant__ bb2) true)))
(check-sat)
(exit)
