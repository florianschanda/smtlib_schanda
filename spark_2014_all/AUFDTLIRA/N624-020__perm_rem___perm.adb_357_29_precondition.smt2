...
(assert (and (= o3 (extended_perm a b)) (and (in_range2 o3) (=> (= (of_int o3) true) (forall ((ia3 Int)) (=> (and (<= (to_rep1 (first (rt a))) ia3) (<= ia3 (to_rep1 (last (rt a))))) (exists ((ib3 Int)) (and (and (<= (to_rep1 (first (rt b))) ib3) (<= ib3 (to_rep1 (last (rt b))))) (and (= (to_rep (select (elts a) ia3)) (to_rep (select (elts b) ib3))) (= (is_perm (remove a ia3) (remove b ib3)) true))))))))))
(assert (= (mk_int__ref result3) (mk_int__ref h)))
(assert (= h1 o3))
(assert (in_range2 h1))
...
(assert (and (= (mk___t perm__remove_perm__aa__assume perm__remove_perm__aa__assume1) (remove a ia)) (and (dynamic_invariant2 (mk___t perm__remove_perm__aa__assume perm__remove_perm__aa__assume1) true false true) (and (= (invariant__ (mk___t perm__remove_perm__aa__assume perm__remove_perm__aa__assume1)) true) (and (= (to_rep1 (last perm__remove_perm__aa__assume1)) (- (to_rep1 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ia 1))) (= (to_rep (select (elts a) k)) (to_rep (select perm__remove_perm__aa__assume k))))) (and (forall ((k Int)) (=> (and (<= (+ ia 1) k) (<= k (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select perm__remove_perm__aa__assume (- k 1)))))) (forall ((k Int)) (=> (and (<= ia k) (<= k (- (to_rep1 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select perm__remove_perm__aa__assume k))))))))))))
(assert (= (mk___t perm__remove_perm__aa__assume perm__remove_perm__aa__assume1) aa))
(assert (dynamic_invariant2 aa true false true))
(assert (and (= (mk___t perm__remove_perm__bb__assume perm__remove_perm__bb__assume1) (remove b ib)) (and (dynamic_invariant2 (mk___t perm__remove_perm__bb__assume perm__remove_perm__bb__assume1) true false true) (and (= (invariant__ (mk___t perm__remove_perm__bb__assume perm__remove_perm__bb__assume1)) true) (and (= (to_rep1 (last perm__remove_perm__bb__assume1)) (- (to_rep1 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib 1))) (= (to_rep (select (elts b) k)) (to_rep (select perm__remove_perm__bb__assume k))))) (and (forall ((k Int)) (=> (and (<= (+ ib 1) k) (<= k (to_rep1 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select perm__remove_perm__bb__assume (- k 1)))))) (forall ((k Int)) (=> (and (<= ib k) (<= k (- (to_rep1 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select perm__remove_perm__bb__assume k))))))))))))
(assert (= (mk___t perm__remove_perm__bb__assume perm__remove_perm__bb__assume1) bb))
(assert (dynamic_invariant2 bb true false true))
(assert (and (= (mk___t perm__remove_perm__bb2__assume perm__remove_perm__bb2__assume1) (remove b ib2)) (and (dynamic_invariant2 (mk___t perm__remove_perm__bb2__assume perm__remove_perm__bb2__assume1) true false true) (and (= (invariant__ (mk___t perm__remove_perm__bb2__assume perm__remove_perm__bb2__assume1)) true) (and (= (to_rep1 (last perm__remove_perm__bb2__assume1)) (- (to_rep1 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib2 1))) (= (to_rep (select (elts b) k)) (to_rep (select perm__remove_perm__bb2__assume k))))) (and (forall ((k Int)) (=> (and (<= (+ ib2 1) k) (<= k (to_rep1 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select perm__remove_perm__bb2__assume (- k 1)))))) (forall ((k Int)) (=> (and (<= ib2 k) (<= k (- (to_rep1 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select perm__remove_perm__bb2__assume k))))))))))))
(assert (= (mk___t perm__remove_perm__bb2__assume perm__remove_perm__bb2__assume1) bb2))
...
(assert (and (= o4 (perm_symmetric aa bb2)) (and (in_range2 o4) (=> (= (of_int o4) true) (= (is_perm bb2 aa) true)))))
(assert (= h1 result5))
(assert (= h2 o4))
(assert (= (of_int h2) true))
(assert (and (= o5 (extended_perm bb2 aa)) (and (in_range2 o5) (=> (= (of_int o5) true) (forall ((ia3 Int)) (=> (and (<= (to_rep1 (first (rt bb2))) ia3) (<= ia3 (to_rep1 (last (rt bb2))))) (exists ((ib3 Int)) (and (and (<= (to_rep1 (first (rt aa))) ib3) (<= ib3 (to_rep1 (last (rt aa))))) (and (= (to_rep (select (elts bb2) ia3)) (to_rep (select (elts aa) ib3))) (= (is_perm (remove bb2 ia3) (remove aa ib3)) true))))))))))
(assert (= h2 result6))
(assert (= h3 o5))
(assert (= (of_int h3) true))
(assert (not (< ib ib2)))
(assert (and (= o16 (- ib 1)) (in_range3 (- ib 1))))
(assert (and (= o17 (get_witness bb2 aa o16)) (and (in_range3 o17) (and (and (<= (to_rep1 (first (rt aa))) o17) (<= o17 (to_rep1 (last (rt aa))))) (and (= (to_rep (select (elts bb2) o16)) (to_rep (select (elts aa) o17))) (= (is_perm (remove bb2 o16) (remove aa o17)) true))))))
(assert (= result10 (mk_int__ref ia2)))
(assert (= ia23 o17))
(assert (and (= o18 (remove_swap b ib2 ib)) (and (in_range2 o18) (=> (= (of_int o18) true) (= (let ((temp___157 (remove (remove b ib) ib2))) (let ((temp___156 (remove (remove b ib2) (- ib 1)))) (bool_eq (elts temp___156) (to_rep1 (first (rt temp___156))) (to_rep1 (last (rt temp___156))) (elts temp___157) (to_rep1 (first (rt temp___157))) (to_rep1 (last (rt temp___157)))))) true)))))
(assert (= result11 (mk_int__ref h3)))
(assert (= h6 o18))
(assert (= (of_int h6) true))
(assert (and (= (mk___t o24 o25) (remove bb ib2)) (and (dynamic_invariant2 (mk___t o24 o25) true false true) (and (= (invariant__ (mk___t o24 o25)) true) (and (= (to_rep1 (last o25)) (- (to_rep1 (last (rt bb))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib2 1))) (= (to_rep (select (elts bb) k)) (to_rep (select o24 k))))) (and (forall ((k Int)) (=> (and (<= (+ ib2 1) k) (<= k (to_rep1 (last (rt bb))))) (= (to_rep (select (elts bb) k)) (to_rep (select o24 (- k 1)))))) (forall ((k Int)) (=> (and (<= ib2 k) (<= k (- (to_rep1 (last (rt bb))) 1))) (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select o24 k))))))))))))
(assert (and (= (mk___t o22 o23) (remove aa ia23)) (and (dynamic_invariant2 (mk___t o22 o23) true false true) (and (= (invariant__ (mk___t o22 o23)) true) (and (= (to_rep1 (last o23)) (- (to_rep1 (last (rt aa))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ia23 1))) (= (to_rep (select (elts aa) k)) (to_rep (select o22 k))))) (and (forall ((k Int)) (=> (and (<= (+ ia23 1) k) (<= k (to_rep1 (last (rt aa))))) (= (to_rep (select (elts aa) k)) (to_rep (select o22 (- k 1)))))) (forall ((k Int)) (=> (and (<= ia23 k) (<= k (- (to_rep1 (last (rt aa))) 1))) (= (to_rep (select (elts aa) (+ k 1))) (to_rep (select o22 k))))))))))))
(assert (and (= o19 (- ib 1)) (in_range3 (- ib 1))))
