...
(assert (forall ((b (Array Int index)) (c (Array Int index))) (forall ((i Int)) (! (=> (dynamic_invariant i true true true) (forall ((j Int)) (=> (and (<= 1 j) (<= j i)) (= (to_rep (select (copy_until b i c) j)) (to_rep (select b j)))))) :pattern ((copy_until b i c))))))
...
(declare-const temp___192 (Array Int index))
(declare-const temp___191 Bool)
(declare-const temp___190 Int)
(declare-const temp___189 (Array Int index))
...
(declare-const o12 (Array Int index))
...
(declare-const b7 (Array Int index))
(declare-const done__6 Bool)
(declare-const r5 Int)
(declare-const b8 (Array Int index))
(declare-const done__7 Bool)
(declare-const r6 Int)
(declare-const b9 (Array Int index))
(declare-const done__8 Bool)
(declare-const r7 Int)
(declare-const b10 (Array Int index))
(declare-const done__9 Bool)
(declare-const r8 Int)
(declare-const b11 (Array Int index))
(declare-const done__10 Bool)
(declare-const r9 Int)
(declare-const b12 (Array Int index))
(declare-const done__11 Bool)
(declare-const r10 Int)
(declare-const b13 (Array Int index))
(declare-const done__12 Bool)
(declare-const r11 Int)
(assert (in_range1 i))
(assert (and (and (not (= done__ true)) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 (- i 1))) (= (to_rep (select c j3)) (to_rep (select b j3)))))) (=> (< 1 i) (= (consistent b (- i 1)) true))))
(assert (= (mk_int__ref result) (mk_int__ref r)))
(assert (= r1 1))
(assert (<= 1 r1))
(assert (<= r1 8))
(assert (and (and (not (= done__2 true)) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 (- i 1))) (= (to_rep (select b2 j3)) (to_rep (select b j3)))))) (=> (< (to_rep (select c i)) r2) (not (= (consistent c 8) true)))))
(assert (and (=> (<= 1 8) (in_range1 r2)) (and (<= 1 r2) (<= r2 8))))
(assert (=> (< (to_rep (select c i)) r2) (and (= o8 (consistent c 8)) (= (= o8 true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 8)) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 (- i1 1))) (and (and (not (= (to_rep (select c i1)) (to_rep (select c j3)))) (not (= (- i1 j3) (- (to_rep (select c i1)) (to_rep (select c j3)))))) (not (= (- i1 j3) (- (to_rep (select c j3)) (to_rep (select c i1))))))))))))))
(assert (=> (< (to_rep (select c i)) r2) (= o9 (ite (not (= o8 true)) true false))))
(assert (=> (not (< (to_rep (select c i)) r2)) (= o9 (of_int 1))))
(assert (<= 1 j1))
(assert (<= j1 (- i 1)))
(assert (and (<= 1 j1) (<= j1 8)))
(assert (= o5 j1))
