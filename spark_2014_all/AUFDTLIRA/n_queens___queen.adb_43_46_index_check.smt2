...
(assert (in_range1 i))
(assert (and (and (not (= done__ true)) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- i 1))) (= (to_rep (select c j1)) (to_rep (select b j1)))))) (=> (< 1 i) (= (consistent b (- i 1)) true))))
(assert (= (mk_int__ref result) (mk_int__ref r)))
(assert (= r1 1))
(assert (<= 1 r1))
(assert (<= r1 8))
(assert (and (and (not (= done__1 true)) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- i 1))) (= (to_rep (select b1 j1)) (to_rep (select b j1)))))) (=> (< (to_rep (select c i)) r2) (not (= (consistent c 8) true)))))
(assert (and (=> (<= 1 8) (in_range1 r2)) (and (<= 1 r2) (<= r2 8))))
(assert (=> (< (to_rep (select c i)) r2) (and (= o3 (consistent c 8)) (= (= o3 true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 8)) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- i1 1))) (and (and (not (= (to_rep (select c i1)) (to_rep (select c j1)))) (not (= (- i1 j1) (- (to_rep (select c i1)) (to_rep (select c j1)))))) (not (= (- i1 j1) (- (to_rep (select c j1)) (to_rep (select c i1))))))))))))))
(assert (=> (< (to_rep (select c i)) r2) (= o4 (ite (not (= o3 true)) true false))))
(assert (=> (not (< (to_rep (select c i)) r2)) (= o4 (of_int 1))))
(assert (<= 1 j))
(assert (<= j (- i 1)))
(assert (and (<= 1 j) (<= j 8)))
(assert (= o j))
