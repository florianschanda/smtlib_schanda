...
(assert (=> (not (= (int__content i15) 0)) (= result21 (ite (= o32 1) true false))))
...
(assert (=> (= result21 true) (and (= o31 (root (mk___rep3 (us_split_fields__content3 t__split_fields14)))) (and (in_range3 o31) (= o31 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields__content3 t__split_fields14))))))))
(assert (=> (= result21 true) (= result20 (ite (= o31 (int__content i15)) true false))))
