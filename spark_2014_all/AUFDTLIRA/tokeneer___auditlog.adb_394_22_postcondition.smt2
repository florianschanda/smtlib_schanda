...
(define-fun dynamic_invariant ((temp___expr_1016 Int) (temp___is_init_1013 Bool) (temp___skip_constant_1014 Bool) (temp___do_toplevel_1015 Bool)) Bool (=> (or (= temp___is_init_1013 true) (<= 1 17)) (in_range1 temp___expr_1016)))
...
(define-fun dynamic_invariant1 ((temp___expr_1128 Int) (temp___is_init_1125 Bool) (temp___skip_constant_1126 Bool) (temp___do_toplevel_1127 Bool)) Bool (=> (or (= temp___is_init_1125 true) (<= 0 2)) (in_range3 temp___expr_1128)))
(define-fun dynamic_invariant2 ((temp___expr_1056 Int) (temp___is_init_1053 Bool) (temp___skip_constant_1054 Bool) (temp___do_toplevel_1055 Bool)) Bool (=> (or (= temp___is_init_1053 true) (<= 0 1024)) (in_range2 temp___expr_1056)))
