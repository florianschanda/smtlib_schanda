...
(declare-fun temp___3858 ((Array Int us_rep) Int us_rep) (Array Int us_rep))
(declare-fun temp___3865 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
(declare-fun temp___3872 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___3860 (Array Int us_rep))) (forall ((temp___3861 Int)) (forall ((temp___3862 us_rep)) (let ((temp___3859 (temp___3858 temp___3860 temp___3861 temp___3862))) (=> (dynamic_invariant2 temp___3861 true true true true) (forall ((temp___3863 Int)) (ite (= temp___3863 temp___3861) (= (select temp___3859 temp___3863) temp___3862) (= (select temp___3859 temp___3863) (select temp___3860 temp___3863))))))))))
(assert (forall ((temp___3867 (Array Int (Array Int et1)))) (forall ((temp___3868 Int)) (forall ((temp___3869 (Array Int et1))) (let ((temp___3866 (temp___3865 temp___3867 temp___3868 temp___3869))) (=> (dynamic_invariant1 temp___3868 true true true true) (forall ((temp___3870 Int)) (ite (= temp___3870 temp___3868) (= (select temp___3866 temp___3870) temp___3869) (= (select temp___3866 temp___3870) (select temp___3867 temp___3870))))))))))
(assert (forall ((temp___3874 (Array Int et1))) (forall ((temp___3875 Int) (temp___3876 Int)) (let ((temp___3873 (temp___3872 temp___3874 temp___3875 temp___3876))) (=> (and (dynamic_invariant temp___3875 true true true true) (dynamic_invariant3 temp___3876 true true true true)) (forall ((temp___3877 Int)) (ite (= temp___3877 temp___3875) (= (to_rep (select temp___3873 temp___3877)) temp___3876) (= (select temp___3873 temp___3877) (select temp___3874 temp___3877)))))))))
...
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (bool_eq3 a2 90 99 (temp___3858 a i (mk___rep (mk___split_fields (rec__ar__rofa4__s4 (us_split_fields1 (select a i))) (temp___3865 (rec__ar__rofa4__t4 (us_split_fields1 (select a i))) j (temp___3872 (select (rec__ar__rofa4__t4 (us_split_fields1 (select a i))) j) k e))))) 90 99) true)))
(check-sat)
(exit)
