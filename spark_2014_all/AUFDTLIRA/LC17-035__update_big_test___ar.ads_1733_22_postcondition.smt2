...
(assert (forall ((temp___3801 (Array Int us_rep))) (forall ((temp___3802 Int)) (forall ((temp___3803 us_rep)) (let ((temp___3800 (temp___3799 temp___3801 temp___3802 temp___3803))) (forall ((temp___3804 Int)) (ite (= temp___3804 temp___3802) (= (select temp___3800 temp___3804) temp___3803) (= (select temp___3800 temp___3804) (select temp___3801 temp___3804)))))))))
(declare-fun temp___3806 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
(assert (forall ((temp___3808 (Array Int (Array Int et1)))) (forall ((temp___3809 Int)) (forall ((temp___3810 (Array Int et1))) (let ((temp___3807 (temp___3806 temp___3808 temp___3809 temp___3810))) (forall ((temp___3811 Int)) (ite (= temp___3811 temp___3809) (= (select temp___3807 temp___3811) temp___3810) (= (select temp___3807 temp___3811) (select temp___3808 temp___3811)))))))))
(declare-fun temp___3813 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___3815 (Array Int et1))) (forall ((temp___3816 Int) (temp___3817 Int)) (let ((temp___3814 (temp___3813 temp___3815 temp___3816 temp___3817))) (forall ((temp___3818 Int)) (ite (= temp___3818 temp___3816) (= (select temp___3814 temp___3818) (of_rep temp___3817)) (= (select temp___3814 temp___3818) (select temp___3815 temp___3818))))))))
...
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (bool_eq3 a2 90 99 (temp___3799 a i (mk___rep (mk___split_fields (rec__ar__rofa4__s4 (us_split_fields1 (select a i))) (temp___3806 (rec__ar__rofa4__t4 (us_split_fields1 (select a i))) j (temp___3813 (select (rec__ar__rofa4__t4 (us_split_fields1 (select a i))) j) k e))))) 90 99) true)))
(check-sat)
(exit)
