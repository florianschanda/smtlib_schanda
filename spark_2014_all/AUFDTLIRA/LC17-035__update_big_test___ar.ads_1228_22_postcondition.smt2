...
(declare-fun temp_____aggregate_def_2867 ((Array Int us_rep) Int us_rep Int us_rep) (Array Int us_rep))
...
(assert (forall ((temp___2869 (Array Int us_rep))) (forall ((temp___2870 Int) (temp___2872 Int)) (forall ((temp___2871 us_rep) (temp___2873 us_rep)) (let ((temp___2868 (temp_____aggregate_def_2867 temp___2869 temp___2870 temp___2871 temp___2872 temp___2873))) (=> (and (dynamic_invariant temp___2870 true true true true) (dynamic_invariant temp___2872 true true true true)) (forall ((temp___2874 Int)) (ite (= temp___2874 temp___2872) (= (select temp___2868 temp___2874) temp___2873) (ite (= temp___2874 temp___2870) (= (select temp___2868 temp___2874) temp___2871) (= (select temp___2868 temp___2874) (select temp___2869 temp___2874)))))))))))
...
(assert (= a2 a3))
(assert (= a4 a2))
(assert (not (= (bool_eq1 a3 1 10 (temp_____aggregate_def_2867 a i (mk___rep (mk___split_fields (of_rep f) (rec__ar__rec1t__g1 (us_split_fields1 (select a i))))) j (mk___rep (mk___split_fields (of_rep g) (rec__ar__rec1t__g1 (us_split_fields1 (select a j)))))) 1 10) true)))
(check-sat)
(exit)
