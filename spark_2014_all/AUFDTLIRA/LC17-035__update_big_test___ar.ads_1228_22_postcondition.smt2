...
(declare-fun temp___2808 ((Array Int us_rep) Int us_rep Int us_rep) (Array Int us_rep))
(assert (forall ((temp___2810 (Array Int us_rep))) (forall ((temp___2811 Int) (temp___2813 Int)) (forall ((temp___2812 us_rep) (temp___2814 us_rep)) (let ((temp___2809 (temp___2808 temp___2810 temp___2811 temp___2812 temp___2813 temp___2814))) (forall ((temp___2815 Int)) (ite (= temp___2815 temp___2813) (= (select temp___2809 temp___2815) temp___2814) (ite (= temp___2815 temp___2811) (= (select temp___2809 temp___2815) temp___2812) (= (select temp___2809 temp___2815) (select temp___2810 temp___2815))))))))))
...
(assert (= a2 a3))
(assert (= a4 a2))
(assert (not (= (bool_eq1 a3 1 10 (temp___2808 a i (mk___rep (mk___split_fields (of_rep f) (rec__ar__rec1t__g1 (us_split_fields1 (select a i))))) j (mk___rep (mk___split_fields (of_rep g) (rec__ar__rec1t__g1 (us_split_fields1 (select a j)))))) 1 10) true)))
(check-sat)
(exit)
