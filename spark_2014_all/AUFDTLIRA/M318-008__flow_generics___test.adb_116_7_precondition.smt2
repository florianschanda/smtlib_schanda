...
(declare-const i Int)
(declare-const mixed_basket__split_fields item_t)
(declare-const mixed_basket__split_fields1 item_t)
(declare-const mixed_basket__split_fields2 item_t)
(declare-const mixed_basket__split_fields3 (Array Int item_t))
(declare-const mixed_basket__split_discrs1 natural)
(declare-const result Bool)
(declare-const has_apple1 Bool)
(declare-const result1 Int)
(declare-const i1 Int)
(declare-const has_apple2 Bool)
(declare-const result2 Int)
(declare-const i2 Int)
(declare-const has_apple3 Bool)
(declare-const result3 Int)
(declare-const i3 Int)
(declare-const has_apple4 Bool)
(declare-const result4 Int)
(declare-const i4 Int)
(declare-const has_apple5 Bool)
