...
(define-fun dynamic_invariant ((temp___expr_330 us_rep) (temp___is_init_326 Bool) (temp___skip_constant_327 Bool) (temp___do_toplevel_328 Bool) (temp___do_typ_inv_329 Bool)) Bool (and (=> (not (= temp___skip_constant_327 true)) (in_range3 0 temp___expr_330)) (= (attr__constrained temp___expr_330) true)))
...
(define-fun dynamic_invariant2 ((temp___expr_275 Int) (temp___is_init_271 Bool) (temp___skip_constant_272 Bool) (temp___do_toplevel_273 Bool) (temp___do_typ_inv_274 Bool)) Bool (=> (or (= temp___is_init_271 true) (<= 0 9)) (in_range2 temp___expr_275)))
