...
(assert (and (= temp___810 (model__ (mk___rep2 f_1__split_fields3) x1)) (and (dynamic_invariant6 temp___810 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___810 x1))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___810 x1)))) 0) (and (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (not (= i5 x1)) (ite (and (not (= (parent (mk___rep2 f_1__split_fields3) i5) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___810 (parent (mk___rep2 f_1__split_fields3) i5)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___810 i5))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___810 i5))) true)))))) (and (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___810 i5))) true) (not (= i5 x1))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___810 (parent (mk___rep2 f_1__split_fields3) i5)))) (position (mk___rep2 f_1__split_fields3) i5) (rec__tree_model__path_type__a (us_split_fields1 (select temp___810 i5)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___810 i5)))) 0)))) (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___810 i5))) true) (forall ((j15 Int)) (=> (and (<= 1 j15) (<= j15 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___810 j15))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___810 i5))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___810 j15)))) true)) (= j15 i5))))))))))))))
(assert (= o11 (select temp___810 y1)))
