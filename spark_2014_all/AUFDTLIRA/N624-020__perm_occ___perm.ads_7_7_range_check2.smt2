...
(define-fun dynamic_invariant ((temp___expr_166 us_t) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool (=> (not (= temp___skip_constant_163 true)) (dynamic_property 1 100 (first1 temp___expr_166) (last1 temp___expr_166))))
...
(define-fun dynamic_invariant3 ((temp___expr_159 Int) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool) (temp___do_typ_inv_158 Bool)) Bool (=> (or (= temp___is_init_155 true) (<= 1 100)) (in_range2 temp___expr_159)))
(declare-const temp___239 Int)
(assert (dynamic_invariant a true false true true))
(assert (< 0 (length a)))
(assert (and (= temp___239 (- (to_rep (last (rt a))) 1)) (in_range (- (to_rep (last (rt a))) 1))))
(assert (<= (to_rep (first (rt a))) temp___239))
(assert (not (<= (to_rep (first (rt a))) (to_rep (first (rt a))))))
(check-sat)
(exit)
