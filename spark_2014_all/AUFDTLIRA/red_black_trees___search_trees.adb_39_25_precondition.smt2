...
(assert (<= 0 v))
(assert (<= v 2147483647))
(assert (and (= result6 (contains s3 v)) (=> (= (of_int 1) true) (=> (exists ((e Int)) (and (and (in_range4 e) (= (contains s3 e) true)) (= e v))) (= result6 true)))))
(assert (= result6 true))
(assert (<= 1 i1))
(assert (<= i1 100))
(assert (and (= o14 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) (in_range2 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))))))
(assert (not (= (valid_root (rec__search_trees__search_tree__struct (us_split_fields7 t)) o14) true)))
(check-sat)
(exit)
