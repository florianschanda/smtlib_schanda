...
(assert (in_range n))
(assert (and (and (and (and (= (mk___rep (mk___split_fields temp___229 temp___2291)) (create_stack Tuple0)) (= (get_length (mk___rep (mk___split_fields temp___229 temp___2291))) 0)) (and (= (mk___split_fields__ref (mk___split_fields result result1)) (mk___split_fields__ref (mk___split_fields s__split_fields s__split_fields1))) (and (= temp___229 s__split_fields2) (= temp___2291 s__split_fields3)))) (and (and (= (get_length (mk___rep (mk___split_fields s__split_fields4 s__split_fields5))) (+ (get_length (mk___rep (mk___split_fields s__split_fields2 s__split_fields3))) 1)) (= (top (mk___rep (mk___split_fields s__split_fields4 s__split_fields5))) n)) (and (and (= o (top (mk___rep (mk___split_fields s__split_fields4 s__split_fields5)))) (in_range o)) (and (= result2 n) (= n1 o))))) (and (and (and (= s__split_fields6 s__split_fields4) (= s__split_fields7 s__split_fields5)) (= n1 n2)) (and (= (mk___split_fields s__split_fields8 s__split_fields9) (mk___split_fields s__split_fields4 s__split_fields5)) (= n3 n1)))))
(assert (not (= n2 n)))
(check-sat)
(exit)
