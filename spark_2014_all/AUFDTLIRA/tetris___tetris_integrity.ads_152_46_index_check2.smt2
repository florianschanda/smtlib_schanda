...
(assert (not (= (to_rep1 (rec__tetris_integrity__piece__s (us_split_fields1 p))) 2)))
(assert (not (= (to_rep1 (rec__tetris_integrity__piece__s (us_split_fields1 p))) 1)))
(assert (<= 0 y))
(assert (<= y 2))
(assert (<= 0 x))
(assert (<= x 2))
(assert (not (<= 3 (to_rep1 (rec__tetris_integrity__piece__s (us_split_fields1 p))))))
(check-sat)
(exit)
