...
(assert (and (and (and (and (in_range8 last_char2) (=> (<= 0 255) (in_range3 current_char2))) (in_range4 line_num2)) (in_range7 first_char2)) (<= first_char2 1024)))
(assert (not (<= first_char2 1024)))
(check-sat)
(exit)
