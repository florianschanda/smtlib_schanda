...
(assert (and (and (and (and (in_range6 last_char1) (in_range4 line_num1)) (=> (<= 0 255) (in_range3 current_char1))) (in_range5 first_char1)) (<= first_char1 1024)))
(assert (not (<= first_char1 1024)))
(check-sat)
(exit)
