...
(assert (=> (= (to_rep (first (rt r))) (to_rep (first (rt a)))) (= result (ite (= (to_rep (last (rt r))) (to_rep (last (rt a)))) true false))))
(assert (=> (not (= (to_rep (first (rt r))) (to_rep (first (rt a))))) (= result false)))
(assert (= result true))
(assert (not (<= (to_rep (first (rt r))) i)))
(check-sat)
(exit)
