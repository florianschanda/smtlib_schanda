...
(assert (or (and (and (and (= j11 j16) (and (= i10 i15) (= a8 a13))) (and (= j12 j2) (and (= i11 i1) (= a9 a1)))) (< (to_rep a__last) (to_rep a__first))) (and (not (< (to_rep a__last) (to_rep a__first))) (and (and (and (= j11 j15) (and (= i10 i14) (= a8 a12))) (and (= j12 j10) (and (= i11 i9) (= a9 a7)))) (and (and (and (= o (to_rep a__first)) (in_range2 (to_rep a__first))) (and (= (mk_int__ref result) i15) (= i2 o))) (and (and (and (= o1 (to_rep a__last)) (in_range2 (to_rep a__last))) (and (= (mk_int__ref result1) j16) (= j3 o1))) (ite (<= i2 j3) (and (and (and (= temp___170 j3) (and (= temp___169 i2) (and (= temp___168 a) (and (= 0 temp___171) (and (and (and (and (and (<= (to_rep a__first) i3) (<= i3 (to_rep a__last))) (and (<= (to_rep a__first) j4) (<= j4 (to_rep a__last)))) (forall ((k1 Int)) (=> (and (<= (to_rep a__first) k1) (<= k1 (- i3 1))) (not (= (select a2 k1) true))))) (forall ((k1 Int)) (=> (and (<= (+ j4 1) k1) (<= k1 (to_rep a__last))) (= (select a2 k1) true)))) (and (and (and (=> (<= 0 1000000) (in_range2 i3)) (=> (<= 0 1000000) (in_range2 j4))) (<= i3 j4)) (and (and (= temp___1711 result2) (= temp___1712 (- j4 i3))) (and (and (and (and (and (and (<= (to_rep a__first) i3) (<= i3 (to_rep a__last))) (= o2 i3)) (= o3 (select a2 o2))) (= result3 (ite (not (= o3 true)) true false))) (ite (= result3 true) (and (and (and (= o4 (+ i3 1)) (in_range2 (+ i3 1))) (and (= i3 result4) (= i4 o4))) (and (= j5 j4) (= a3 a2))) (and (and (and (and (and (<= (to_rep a__first) j4) (<= j4 (to_rep a__last))) (= o5 j4)) (= result5 (select a2 o5))) (ite (= result5 true) (and (and (and (= o6 (- j4 1)) (in_range2 (- j4 1))) (and (= j4 result6) (= j5 o6))) (and (= i5 i3) (= a3 a2))) (and (and (and (and (= (= (select a3 i3) true) (= (select a2 j4) true)) (= (= (select a3 j4) true) (= (select a2 i3) true))) (forall ((k1 Int)) (=> (and (<= (to_rep a__first) k1) (<= k1 (to_rep a__last))) (=> (and (not (= k1 i3)) (not (= k1 j4))) (= (= (select a3 k1) true) (= (select a2 k1) true)))))) (and (and (and (= o7 (+ i3 1)) (in_range2 (+ i3 1))) (and (= i3 result7) (= i5 o7))) (and (and (= o8 (- j4 1)) (in_range2 (- j4 1))) (and (= j4 result8) (= j6 o8))))) (= j5 j6)))) (= i4 i5)))) (not (<= i4 j5)))))))))) (and (and (= j5 j7) (and (= i4 i6) (= a3 a4))) (and (= j8 j5) (and (= i7 i4) (= a5 a3))))) (and (and (= j15 (mk_int__ref j7)) (and (= i14 (mk_int__ref i6)) (= a12 (mk_map__ref a4)))) (and (= j10 j8) (and (= i9 i7) (= a7 a5))))) (and (and (= j3 j9) (and (= i2 i8) (= a12 a13))) (and (= j10 j3) (and (= i9 i2) (= a7 a1)))))))))))
(assert (= j13 j11))
(assert (= i12 i10))
(assert (= a10 a8))
(assert (= j14 j12))
...
(assert (= (= result9 true) (forall ((j17 Int)) (=> (and (<= (to_rep a__first) j17) (<= j17 k)) (not (= (select (map__content a10) j17) true))))))
(assert (= result9 true))
(assert (and (= o9 (+ k 1)) (in_range1 (+ k 1))))
(assert (= o10 (ite (<= o9 j1) true false)))
(assert (= result10 (ite (= o10 true) (ite (<= j1 (to_rep a__last)) true false) false)))
