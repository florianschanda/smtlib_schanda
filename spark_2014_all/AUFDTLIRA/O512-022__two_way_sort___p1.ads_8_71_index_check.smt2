...
(declare-const o11 (Array Int Bool))
...
(assert (= (= result9 true) (forall ((j17 Int)) (=> (and (<= (to_rep a__first) j17) (<= j17 k)) (not (= (select (map__content a9) j17) true))))))
(assert (= result9 true))
