...
(assert (= o72 (select temp___1629 i2)))
(assert (= o73 (us_split_fields5 o72)))
(assert (= o74 (rec__tree_model__path_type__a o73)))
(assert (and (= o75 (length o74)) (and (in_range2 o75) (<= (+ 0 o75) 2147483647))))
(assert (= o76 (+ o75 1)))
(assert (and (= o77 o76) (in_range8 o76)))
...
(assert (= o69 (select temp___1628 v)))
(assert (= o70 (us_split_fields5 o69)))
(assert (= o71 (rec__tree_model__path_type__a o70)))
(assert (and (= o78 (get o71 o77)) (in_range3 o78)))
