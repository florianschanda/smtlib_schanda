...
(assert (= (mk___t stack__model__to__result6 stack__model__to__result7) (mk___t stack__model__to__result2 stack__model__to__result3)))
(assert (=> (<= 1 (to_rep (rec__stack__stack__top (us_split_fields1 s)))) (and (and (<= 1 1) (<= 1 100)) (and (<= 1 (to_rep (rec__stack__stack__top (us_split_fields1 s)))) (<= (to_rep (rec__stack__stack__top (us_split_fields1 s))) 100)))))
(assert (= o (rec__stack__stack__content (us_split_fields1 s))))
(assert (= o temp___211))
(assert (= (mk1 1 (to_rep (rec__stack__stack__top (us_split_fields1 s)))) temp___2111))
(assert (dynamic_property 1 2147483647 (to_rep1 (first2 temp___2111)) (to_rep1 (last2 temp___2111))))
(assert (= temp___211 o1))
(assert (= (mk (to_rep1 (first2 temp___2111)) (to_rep1 (last2 temp___2111))) o2))
(assert (= result stack__model__to__result))
(assert (= result1 stack__model__to__result1))
(assert (= (mk___t stack__model__to__result2 stack__model__to__result3) (mk___t o1 o2)))
...
(assert (not (= (to_rep1 (first stack__model__to__result9)) 1)))
(check-sat)
(exit)
