...
(assert (= o temp___238))
(assert (= (mk1 1 (to_rep (rec__stack__stack__top (us_split_fields1 s)))) temp___2381))
(assert (dynamic_property 1 2147483647 (to_rep1 (first2 temp___2381)) (to_rep1 (last2 temp___2381))))
(assert (= temp___238 o1))
(assert (= (mk (to_rep1 (first2 temp___2381)) (to_rep1 (last2 temp___2381))) o2))
