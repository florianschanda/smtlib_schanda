...
(assert (in_range1 e))
(assert (not (= (length (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag))) 0)))
(assert (=> (<= 1 1) (= o (+ (- 1 1) 1))))
(assert (=> (not (<= 1 1)) (= o 0)))
(assert (=> (<= (to_rep1 (first (rt (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag))))) (to_rep1 (last (rt (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag)))))) (= o1 (+ (- (to_rep1 (last (rt (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag))))) (to_rep1 (first (rt (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag)))))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag))))) (to_rep1 (last (rt (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag))))))) (= o1 0)))
(assert (= o2 (+ o1 o)))
(assert (= o3 (+ (to_rep1 (first (rt (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag))))) o2)))
(assert (= o4 (- o3 1)))
