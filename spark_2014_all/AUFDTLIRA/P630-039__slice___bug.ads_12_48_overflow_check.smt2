...
(assert (<= 0 i))
(assert (<= i (- size 1)))
(assert (and (= temp___169 (+ (to_rep1 (first (rt b))) i)) (in_range1 (+ (to_rep1 (first (rt b))) i))))
(assert (and (<= (to_rep1 (first (rt b))) temp___169) (<= temp___169 (to_rep1 (last (rt b))))))
(assert (= o3 temp___169))
