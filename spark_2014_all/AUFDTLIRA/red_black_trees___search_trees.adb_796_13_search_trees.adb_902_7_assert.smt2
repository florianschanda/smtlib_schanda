...
(assert (not (<= (to_rep (select (rec__search_trees__search_tree__values t__split_fields9) j15)) (to_rep (select (rec__search_trees__search_tree__values t__split_fields9) x1)))))
(check-sat)
(exit)
