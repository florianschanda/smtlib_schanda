...
(define-fun dynamic_invariant4 ((temp___expr_143 Int) (temp___is_init_140 Bool) (temp___skip_constant_141 Bool) (temp___do_toplevel_142 Bool)) Bool (=> (or (= temp___is_init_140 true) (<= (- 2147483648) 2147483647)) (in_range1 temp___expr_143)))
...
(assert true)
(assert true)
(assert (forall ((s1 us_rep)) (! (= (to_int1 (is_empty s1)) (to_int1 (is_empty1 us_tag s1))) :pattern ((is_empty1 us_tag s1)))))
(assert (forall ((s1 us_rep)) (! (= (= (is_empty s1) true) (= (size s1) 0)) :pattern ((is_empty s1)))))
(assert (forall ((s1 us_rep)) (! (=> (dynamic_invariant s1 true true true) (dynamic_invariant1 (size s1) true false true)) :pattern ((size s1)))))
(assert (forall ((attr__tag1 Int)) (forall ((s1 us_rep)) (! (=> (dynamic_invariant s1 true true true) (dynamic_invariant1 (size1 attr__tag1 s1) true false true)) :pattern ((size1 attr__tag1 s1))))))
(assert (forall ((s1 us_rep)) (! (= (size s1) (size1 us_tag s1)) :pattern ((size1 us_tag s1)))))
(assert (forall ((s1 us_rep)) (! (=> (dynamic_invariant s1 true true true) (= (size s1) (to_rep (rec__stacks__stack__top (us_split_fields1 s1))))) :pattern ((size s1)))))
