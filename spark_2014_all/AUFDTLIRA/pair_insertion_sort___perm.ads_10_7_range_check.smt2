...
(define-fun dynamic_invariant2 ((temp___expr_159 Int) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool) (temp___do_typ_inv_158 Bool)) Bool (=> (or (= temp___is_init_155 true) (<= 0 2147483646)) (in_range1 temp___expr_159)))
(declare-const temp___256 Int)
(assert (dynamic_invariant a true false true true))
(assert (< 0 (length a)))
(assert (and (= temp___256 (- (to_rep (last (rt a))) 1)) (in_range (- (to_rep (last (rt a))) 1))))
(assert (<= (to_rep (first (rt a))) temp___256))
