...
(assert (and (and (= dynamic_types__search__search_range__result9 (mk_result_type__ref (mk___rep (mk___split_fields dynamic_types__search__search_range__result6 dynamic_types__search__search_range__result7)))) (= dynamic_types__search__search_range__result10 dynamic_types__search__search_range__result8)) (and (and (and (and (and (and (<= (to_rep1 (first (rt a))) from) (<= from (to_rep1 (last (rt a))))) (= o from)) (= o1 (select (elts a) o))) (= o2 (to_rep o1))) (= result (ite (= o2 c) true false))) (ite (= result true) (and (and (and (= dynamic_types__search__search_range__result6 dynamic_types__search__search_range__result2) (= dynamic_types__search__search_range__result7 dynamic_types__search__search_range__result3)) (= dynamic_types__search__search_range__result8 (mk___rep (mk___split_fields dynamic_types__search__search_range__result2 dynamic_types__search__search_range__result3)))) (and (and (and (= (to_rep o4) from) (and (and (and (and (= us from) (dynamic_property1 first2 last2 from)) (= o3 from)) (= o5 (temp___191 o3))) (and (= o5 o6) (= o4 o7)))) (and (= o8 o6) (= o9 o7))) (and (= (mk_result_type__ref (mk___rep (mk___split_fields result1 result2))) (mk_result_type__ref (mk___rep (mk___split_fields dynamic_types__search__search_range__result dynamic_types__search__search_range__result1)))) (= (mk___rep (mk___split_fields dynamic_types__search__search_range__result2 dynamic_types__search__search_range__result3)) (mk___rep (mk___split_fields o8 o9)))))) (and (and (and (= dynamic_types__search__search_range__result6 dynamic_types__search__search_range__result4) (= dynamic_types__search__search_range__result7 dynamic_types__search__search_range__result5)) (= dynamic_types__search__search_range__result8 (mk___rep (mk___split_fields dynamic_types__search__search_range__result4 dynamic_types__search__search_range__result5)))) (and (and (and (= (to_rep o11) 0) (and (and (and (and (= us1 from) (dynamic_property1 first2 last2 from)) (= o10 from)) (= o12 (temp___187 o10))) (and (= o12 o13) (= o11 o14)))) (and (= o15 o13) (= o16 o14))) (and (= (mk_result_type__ref (mk___rep (mk___split_fields result3 result4))) (mk_result_type__ref (mk___rep (mk___split_fields dynamic_types__search__search_range__result dynamic_types__search__search_range__result1)))) (= (mk___rep (mk___split_fields dynamic_types__search__search_range__result4 dynamic_types__search__search_range__result5)) (mk___rep (mk___split_fields o15 o16))))))))))
