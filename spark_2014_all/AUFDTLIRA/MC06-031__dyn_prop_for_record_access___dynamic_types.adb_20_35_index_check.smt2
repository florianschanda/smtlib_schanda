...
(assert (forall ((temp___189 Int)) (= (select (temp___187 temp___189) 1) (of_rep1 temp___189))))
(declare-fun temp___191 (Int) (Array Int integer))
(assert (forall ((temp___193 Int)) (= (select (temp___191 temp___193) 1) (of_rep1 temp___193))))
...
(define-fun dynamic_invariant4 ((temp___expr_152 Int) (temp___is_init_149 Bool) (temp___skip_constant_150 Bool) (temp___do_toplevel_151 Bool)) Bool (=> (or (= temp___is_init_149 true) (<= first2 last2)) (dynamic_property1 first2 last2 temp___expr_152)))
...
(declare-const dynamic_types__search__search_range__result2 (Array Int integer))
(declare-const dynamic_types__search__search_range__result3 natural)
(declare-const result3 (Array Int integer))
(declare-const result4 natural)
(declare-const dynamic_types__search__search_range__result4 (Array Int integer))
(declare-const dynamic_types__search__search_range__result5 natural)
(declare-const dynamic_types__search__search_range__result6 (Array Int integer))
(declare-const dynamic_types__search__search_range__result7 natural)
(declare-const dynamic_types__search__search_range__result8 us_rep)
(declare-const dynamic_types__search__search_range__result9 result_type__ref)
(declare-const dynamic_types__search__search_range__result10 us_rep)
(declare-const dynamic_types__search__search_range__result11 result_type__ref)
(declare-const dynamic_types__search__search_range__result12 us_rep)
(define-fun dynamic_types__search__search_range__result13 () us_rep (mk___rep (mk___split_fields dynamic_types__search__search_range__result4 dynamic_types__search__search_range__result5)))
(define-fun dynamic_types__search__search_range__result14 () us_rep (mk___rep (mk___split_fields dynamic_types__search__search_range__result2 dynamic_types__search__search_range__result3)))
(define-fun dynamic_types__search__search_range__result15 () result_type__ref (mk_result_type__ref (mk___rep (mk___split_fields dynamic_types__search__search_range__result dynamic_types__search__search_range__result1))))
(assert (in_range1 from))
(assert (dynamic_invariant1 a true false true))
(assert (in_range1 c))
(assert (and (<= (to_rep1 (first (rt a))) from) (<= from (to_rep1 (last (rt a))))))
(assert (= dynamic_types__search__search_range__result9 (mk_result_type__ref (mk___rep (mk___split_fields dynamic_types__search__search_range__result6 dynamic_types__search__search_range__result7)))))
(assert (= dynamic_types__search__search_range__result10 dynamic_types__search__search_range__result8))
(assert (and (<= (to_rep1 (first (rt a))) from) (<= from (to_rep1 (last (rt a))))))
(assert (= o from))
(assert (= o1 (select (elts a) o)))
(assert (= o2 (to_rep o1)))
(assert (= result (ite (= o2 c) true false)))
(assert (=> (= result true) (= dynamic_types__search__search_range__result6 dynamic_types__search__search_range__result2)))
(assert (=> (= result true) (= dynamic_types__search__search_range__result7 dynamic_types__search__search_range__result3)))
(assert (=> (= result true) (= dynamic_types__search__search_range__result8 dynamic_types__search__search_range__result14)))
(assert (=> (= result true) (= (to_rep o4) from)))
(assert (=> (= result true) (and (= us from) (dynamic_property1 first2 last2 from))))
...
(assert (=> (= result true) (= (mk_result_type__ref (mk___rep (mk___split_fields result1 result2))) dynamic_types__search__search_range__result15)))
(assert (=> (= result true) (= dynamic_types__search__search_range__result14 (mk___rep (mk___split_fields o8 o9)))))
(assert (=> (not (= result true)) (= dynamic_types__search__search_range__result6 dynamic_types__search__search_range__result4)))
(assert (=> (not (= result true)) (= dynamic_types__search__search_range__result7 dynamic_types__search__search_range__result5)))
(assert (=> (not (= result true)) (= dynamic_types__search__search_range__result8 dynamic_types__search__search_range__result13)))
(assert (=> (not (= result true)) (= (to_rep o11) 0)))
(assert (=> (not (= result true)) (and (= us1 from) (dynamic_property1 first2 last2 from))))
...
(assert (=> (not (= result true)) (= (mk_result_type__ref (mk___rep (mk___split_fields result3 result4))) dynamic_types__search__search_range__result15)))
(assert (=> (not (= result true)) (= dynamic_types__search__search_range__result13 (mk___rep (mk___split_fields o15 o16)))))
(assert (= dynamic_types__search__search_range__result11 dynamic_types__search__search_range__result9))
(assert (= dynamic_types__search__search_range__result12 dynamic_types__search__search_range__result10))
(assert (= (to_rep (rec__dynamic_types__search__result_type__result (us_split_fields1 (result_type__content dynamic_types__search__search_range__result11)))) 0))
(assert (<= from i))
(assert (<= i (to_rep1 (select (rec__dynamic_types__search__result_type__from (us_split_fields1 (result_type__content dynamic_types__search__search_range__result11))) 1))))
