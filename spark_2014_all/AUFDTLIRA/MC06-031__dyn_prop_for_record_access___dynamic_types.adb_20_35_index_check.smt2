...
(define-fun dynamic_invariant1 ((temp___expr_160 us_t) (temp___is_init_156 Bool) (temp___skip_constant_157 Bool) (temp___do_toplevel_158 Bool) (temp___do_typ_inv_159 Bool)) Bool (=> (not (= temp___skip_constant_157 true)) (dynamic_property 1 2147483647 (first1 temp___expr_160) (last1 temp___expr_160))))
...
(define-fun bool_eq2 ((a1 (Array Int integer)) (a__first Int) (a__last Int) (b (Array Int integer)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_155 Int)) (=> (and (<= a__first temp___idx_155) (<= temp___idx_155 a__last)) (= (to_rep1 (select a1 temp___idx_155)) (to_rep1 (select b (+ (- b__first a__first) temp___idx_155))))))) true false))
(assert (forall ((a1 (Array Int integer)) (b (Array Int integer))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq2 b b__first b__last a1 a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_155 Int)) (=> (and (<= a__first temp___idx_155) (<= temp___idx_155 a__last)) (= (to_rep1 (select a1 temp___idx_155)) (to_rep1 (select b (+ (- b__first a__first) temp___idx_155)))))))))))
...
(declare-fun temp___214 (Int) (Array Int integer))
(declare-fun temp___218 (Int) (Array Int integer))
...
(define-fun dynamic_invariant4 ((temp___expr_177 Int) (temp___is_init_173 Bool) (temp___skip_constant_174 Bool) (temp___do_toplevel_175 Bool) (temp___do_typ_inv_176 Bool)) Bool (=> (or (= temp___is_init_173 true) (<= first2 last2)) (dynamic_property1 first2 last2 temp___expr_177)))
...
(define-fun dynamic_invariant5 ((temp___expr_184 (Array Int integer)) (temp___is_init_180 Bool) (temp___skip_constant_181 Bool) (temp___do_toplevel_182 Bool) (temp___do_typ_inv_183 Bool)) Bool (forall ((temp___185 Int)) (=> (and (<= 1 temp___185) (<= temp___185 1)) (=> (or (= temp___is_init_180 true) (<= first2 last2)) (dynamic_property1 first2 last2 (to_rep1 (select temp___expr_184 temp___185)))))))
(define-fun dynamic_invariant6 ((temp___expr_194 us_rep) (temp___is_init_190 Bool) (temp___skip_constant_191 Bool) (temp___do_toplevel_192 Bool) (temp___do_typ_inv_193 Bool)) Bool (forall ((temp___195 Int)) (=> (and (<= 1 temp___195) (<= temp___195 1)) (=> (or (= temp___is_init_190 true) (<= first2 last2)) (dynamic_property1 first2 last2 (to_rep1 (select (rec__dynamic_types__search__result_type__from (us_split_fields1 temp___expr_194)) temp___195)))))))
(assert (forall ((temp___220 Int)) (=> (dynamic_invariant4 temp___220 true true true true) (= (to_rep1 (select (temp___218 temp___220) 1)) temp___220))))
(assert (forall ((temp___216 Int)) (=> (dynamic_invariant4 temp___216 true true true true) (= (to_rep1 (select (temp___214 temp___216) 1)) temp___216))))
...
(assert (=> (= result true) (= o5 (temp___218 o3))))
...
(assert (=> (not (= result true)) (= o12 (temp___214 o10))))
