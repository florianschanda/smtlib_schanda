...
(define-fun dynamic_invariant ((temp___expr_156 Int) (temp___is_init_153 Bool) (temp___skip_constant_154 Bool) (temp___do_toplevel_155 Bool)) Bool (=> (or (= temp___is_init_153 true) (<= 0 100)) (in_range temp___expr_156)))
...
(declare-const temp___5681 (Array Int us_rep))
(assert (and (= (to_rep temp___568) 0) (default_initial_assumption temp___5681 false)))
(assert (not (= (tree_structure (mk___rep1 (mk___split_fields1 temp___568 temp___5681))) true)))
(check-sat)
(exit)
