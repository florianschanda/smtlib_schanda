...
(assert (= o9 i))
(assert (= (mk___rep (mk___split_fields o10 o11 o12)) (select a6 o9)))
(assert (= o10 o13))
(assert (= o11 o14))
(assert (= o12 o15))
(assert (= o16 o15))
