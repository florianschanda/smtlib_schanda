...
(assert (= result2 r1))
(assert (= r2 o2))
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 y2)) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (< (+ i1 j1) (+ (+ x2 y2) 1)))))))
(assert (and (and (=> (<= 1 200) (in_range2 y2)) (forall ((temp___163 Int)) (=> (and (<= (- 2147483648) temp___163) (<= temp___163 2147483647)) (=> (not (= x2 temp___163)) (= (select r3 temp___163) (select r1 temp___163)))))) (and (<= 1 y2) (<= y2 200))))
(assert (not (= y2 200)))
(assert (= y2 result3))
(assert (= y3 (+ y2 1)))
(assert (and (= o4 (+ (to_rep (select r3 x2)) y3)) (in_range1 (+ (to_rep (select r3 x2)) y3))))
(assert (= (to_rep o5) o4))
(assert (= o6 (store r3 x2 o5)))
(assert (= result4 r3))
(assert (= r4 o6))
