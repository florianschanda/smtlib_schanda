...
(assert (and (and (=> (<= 1 200) (in_range2 y2)) (forall ((temp___187 Int)) (=> (and (<= (- 2147483648) temp___187) (<= temp___187 2147483647)) (=> (not (= x2 temp___187)) (= (select r3 temp___187) (select r1 temp___187)))))) (and (<= 1 y2) (<= y2 200))))
(assert (not (= y2 200)))
(assert (= y2 result3))
(assert (= y3 (+ y2 1)))
