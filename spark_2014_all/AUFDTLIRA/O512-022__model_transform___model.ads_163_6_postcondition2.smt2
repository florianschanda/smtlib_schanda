...
(assert (forall ((i name_t)) (and (<= 0 (name_tqtint i)) (<= (name_tqtint i) 2147483647))))
...
(assert (forall ((self us_rep)) (! (dynamic_invariant (name self) true false true true) :pattern ((name self)))))
...
(assert (forall ((i uml_state_access)) (and (<= 0 (uml_state_accessqtint i)) (<= (uml_state_accessqtint i) 100))))
...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (and (= (to_rep1 (rec__model__uml_transition__from_data (us_split_fields3 a))) (to_rep1 (rec__model__uml_transition__from_data (us_split_fields3 b)))) (= (to_rep1 (rec__model__uml_transition__to_data (us_split_fields3 a))) (to_rep1 (rec__model__uml_transition__to_data (us_split_fields3 b))))) true false))
...
(define-fun dynamic_invariant1 ((temp___expr_183 Int) (temp___is_init_179 Bool) (temp___skip_constant_180 Bool) (temp___do_toplevel_181 Bool) (temp___do_typ_inv_182 Bool)) Bool (=> (or (= temp___is_init_179 true) (<= 0 100)) (in_range2 temp___expr_183)))
(assert (forall ((self us_rep1)) (! (dynamic_invariant1 (from self) true false true true) :pattern ((from self)))))
...
(assert (forall ((self us_rep1)) (! (dynamic_invariant1 (to__ self) true false true true) :pattern ((to__ self)))))
...
(assert (forall ((a (Array Int us_rep)) (b (Array Int us_rep))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq2 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (bool_eq (select a temp___idx_154) (select b (+ (- b__first a__first) temp___idx_154))) true))))))))
...
(assert (forall ((self us_rep3)) (! (dynamic_invariant (name__2 self) true false true true) :pattern ((name__2 self)))))
...
(assert (forall ((i uml_action_access)) (and (<= 0 (uml_action_accessqtint i)) (<= (uml_action_accessqtint i) 100))))
...
(assert (forall ((x uml_action_access)) (! (in_range3 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(define-fun dynamic_invariant2 ((temp___expr_286 Int) (temp___is_init_282 Bool) (temp___skip_constant_283 Bool) (temp___do_toplevel_284 Bool) (temp___do_typ_inv_285 Bool)) Bool (=> (or (= temp___is_init_282 true) (<= 0 100)) (in_range3 temp___expr_286)))
(assert (forall ((self us_rep4)) (! (dynamic_invariant2 (from__2 self) true false true true) :pattern ((from__2 self)))))
...
(assert (forall ((self us_rep4)) (! (dynamic_invariant2 (to__2 self) true false true true) :pattern ((to__2 self)))))
...
(define-fun bool_eq7 ((a (Array Int us_rep3)) (a__first Int) (a__last Int) (b (Array Int us_rep3)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_156 Int)) (=> (and (<= a__first temp___idx_156) (<= temp___idx_156 a__last)) (= (bool_eq5 (select a temp___idx_156) (select b (+ (- b__first a__first) temp___idx_156))) true)))) true false))
(assert (forall ((a (Array Int us_rep3)) (b (Array Int us_rep3))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq7 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_156 Int)) (=> (and (<= a__first temp___idx_156) (<= temp___idx_156 a__last)) (= (bool_eq5 (select a temp___idx_156) (select b (+ (- b__first a__first) temp___idx_156))) true))))))))
...
(define-fun bool_eq8 ((a (Array Int us_rep4)) (a__first Int) (a__last Int) (b (Array Int us_rep4)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_160 Int)) (=> (and (<= a__first temp___idx_160) (<= temp___idx_160 a__last)) (= (bool_eq6 (select a temp___idx_160) (select b (+ (- b__first a__first) temp___idx_160))) true)))) true false))
(assert (forall ((a (Array Int us_rep4)) (b (Array Int us_rep4))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq8 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_160 Int)) (=> (and (<= a__first temp___idx_160) (<= temp___idx_160 a__last)) (= (bool_eq6 (select a temp___idx_160) (select b (+ (- b__first a__first) temp___idx_160))) true))))))))
...
(define-fun bool_eq9 ((a us_rep5) (b us_rep5)) Bool (ite (and (= (bool_eq7 (rec__model__uml_activity__owned_action_data (us_split_fields11 a)) 0 100 (rec__model__uml_activity__owned_action_data (us_split_fields11 b)) 0 100) true) (= (bool_eq8 (rec__model__uml_activity__owned_flow_data (us_split_fields11 a)) 0 100 (rec__model__uml_activity__owned_flow_data (us_split_fields11 b)) 0 100) true)) true false))
...
(assert (forall ((i uml_control_flow_access)) (and (<= 0 (uml_control_flow_accessqtint i)) (<= (uml_control_flow_accessqtint i) 100))))
(define-fun in_range4 ((x Int)) Bool (and (<= 0 x) (<= x 100)))
(declare-fun attr__ATTRIBUTE_IMAGE4 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check4 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE4 (us_image) Int)
(declare-fun user_eq13 (uml_control_flow_access uml_control_flow_access) Bool)
...
(assert (forall ((i uml_transition_access)) (and (<= 0 (uml_transition_accessqtint i)) (<= (uml_transition_accessqtint i) 100))))
...
(define-fun dynamic_invariant3 ((temp___expr_210 Int) (temp___is_init_206 Bool) (temp___skip_constant_207 Bool) (temp___do_toplevel_208 Bool) (temp___do_typ_inv_209 Bool)) Bool (=> (or (= temp___is_init_206 true) (<= 0 100)) (in_range5 temp___expr_210)))
(declare-const rliteral name_t)
(assert (= (name_tqtint rliteral) 0))
(assert (= no_uml_action (mk___rep3 (mk___split_fields3 rliteral))))
(assert (= no_uml_action_vector (model__no_uml_action_vector__aggregate_def no_uml_action)))
(assert (forall ((temp___158 us_rep3)) (forall ((temp___159 Int)) (= (select (model__no_uml_action_vector__aggregate_def temp___158) temp___159) temp___158))))
(declare-const rliteral1 uml_action_access)
(assert (= (uml_action_accessqtint rliteral1) 0))
(assert (= no_uml_control_flow (mk___rep4 (mk___split_fields4 rliteral1 rliteral1))))
(define-fun dynamic_invariant4 ((temp___expr_313 Int) (temp___is_init_309 Bool) (temp___skip_constant_310 Bool) (temp___do_toplevel_311 Bool) (temp___do_typ_inv_312 Bool)) Bool (=> (or (= temp___is_init_309 true) (<= 0 100)) (in_range4 temp___expr_313)))
(assert (= no_uml_control_flow_vector (model__no_uml_control_flow_vector__aggregate_def no_uml_control_flow)))
(assert (forall ((temp___162 us_rep4)) (forall ((temp___163 Int)) (= (select (model__no_uml_control_flow_vector__aggregate_def temp___162) temp___163) temp___162))))
...
(declare-const model__transform__result (Array Int us_rep3))
(declare-const model__transform__result1 (Array Int us_rep4))
(declare-const model__transform__L_1__R1b__assume (Array Int us_rep))
(declare-const temp___477 (Array Int us_rep3))
(declare-const temp___476 Int)
(declare-const temp___475 (Array Int us_rep))
...
(declare-const temp___487 (Array Int us_rep4))
(declare-const temp___486 Int)
(declare-const temp___484 (Array Int us_rep1))
(declare-const o6 us_rep1)
(declare-const o7 Int)
(declare-const temp___485 (Array Int us_rep1))
...
(declare-const model__set_from__2__self__fields us_split_fields8)
(declare-const result6 map__ref3)
(declare-const cfv3 (Array Int us_rep4))
(declare-const model__set_to__2__self__fields us_split_fields8)
(declare-const result7 map__ref3)
(declare-const cfv4 (Array Int us_rep4))
(declare-const cfv5 map__ref3)
(declare-const s10 int__ref)
(declare-const cfv6 (Array Int us_rep4))
(declare-const s11 Int)
(declare-const cfv7 map__ref3)
(declare-const s12 int__ref)
(declare-const cfv8 (Array Int us_rep4))
(declare-const s13 Int)
(declare-const act__split_fields3 us_split_fields10)
(declare-const act__split_fields4 us_split_fields10)
(declare-const result8 uml_activity__ref)
(declare-const model__transform__result2 us_rep5)
(declare-const model__transform__result3 uml_activity__ref)
(declare-const model__transform__result4 us_rep5)
(declare-const av8 map__ref2)
(declare-const cfv9 map__ref3)
(declare-const act__split_fields5 us_split_fields__ref5)
(declare-const s14 int__ref)
(declare-const s15 int__ref)
(declare-const model__transform__result5 uml_activity__ref)
(declare-const av9 (Array Int us_rep3))
(declare-const cfv10 (Array Int us_rep4))
(declare-const act__split_fields6 us_split_fields10)
(declare-const s16 Int)
(declare-const s17 Int)
(declare-const model__transform__result6 us_rep5)
(define-fun o10 () us_rep (mk___rep (mk___split_fields o)))
(declare-const result9 (Array Int us_rep3))
(declare-const result10 (Array Int us_rep4))
...
(assert (= s2 0))
(assert (=> (and (<= 0 s2) (<= s2 100)) (= temp___477 av1)))
(assert (=> (and (<= 0 s2) (<= s2 100)) (= temp___476 s2)))
(assert (=> (and (<= 0 s2) (<= s2 100)) (forall ((t Int)) (=> (and (<= 0 t) (<= t (- s3 1))) (= (name (select (owned_state sm) t)) (name__2 (select av2 t)))))))
(assert (=> (and (<= 0 s2) (<= s2 100)) (and (=> (<= 0 100) (in_range6 s3)) (and (<= 0 s3) (<= s3 100)))))
(assert (=> (and (<= 0 s2) (<= s2 100)) (and (= temp___475 (owned_state sm)) (= temp___475 (rec__model__uml_state_machine__owned_state_data (us_split_fields5 sm))))))
(assert (=> (and (<= 0 s2) (<= s2 100)) (= o10 (select temp___475 s3))))
(assert (=> (and (<= 0 s2) (<= s2 100)) (and (= o1 (name o10)) (and (in_range1 o1) (= o1 (to_rep o))))))
...
(assert (= s8 0))
(assert (=> (and (<= 0 s8) (<= s8 100)) (= temp___487 cfv1)))
(assert (=> (and (<= 0 s8) (<= s8 100)) (= temp___486 s8)))
(assert (=> (and (<= 0 s8) (<= s8 100)) (forall ((t Int)) (=> (and (<= 0 t) (<= t (- s9 1))) (and (= (name (select (owned_state sm) (from (select (owned_transition sm) t)))) (name__2 (select (map__content2 av6) (from__2 (select cfv2 t))))) (= (name (select (owned_state sm) (to__ (select (owned_transition sm) t)))) (name__2 (select (map__content2 av6) (to__2 (select cfv2 t))))))))))
(assert (=> (and (<= 0 s8) (<= s8 100)) (and (=> (<= 0 100) (in_range7 s9)) (and (<= 0 s9) (<= s9 100)))))
(assert (=> (and (<= 0 s8) (<= s8 100)) (and (= temp___484 (owned_transition sm)) (= temp___484 (rec__model__uml_state_machine__owned_transition_data (us_split_fields5 sm))))))
(assert (=> (and (<= 0 s8) (<= s8 100)) (= o6 (select temp___484 s9))))
(assert (=> (and (<= 0 s8) (<= s8 100)) (and (= o7 (from o6)) (and (in_range2 o7) (= o7 (to_rep1 (rec__model__uml_transition__from_data (us_split_fields3 o6))))))))
(assert (=> (and (<= 0 s8) (<= s8 100)) (and (= (from__2 (mk___rep4 model__set_from__2__self__fields)) o7) (= (to__2 (mk___rep4 model__set_from__2__self__fields)) (to__2 (mk___rep4 (us_split_fields9 (select cfv2 s9))))))))
(assert (=> (and (<= 0 s8) (<= s8 100)) (= result6 (mk_map__ref3 cfv2))))
(assert (=> (and (<= 0 s8) (<= s8 100)) (= cfv3 (store cfv2 s9 (mk___rep4 model__set_from__2__self__fields)))))
(assert (=> (and (<= 0 s8) (<= s8 100)) (and (= temp___485 (owned_transition sm)) (= temp___485 (rec__model__uml_state_machine__owned_transition_data (us_split_fields5 sm))))))
(assert (=> (and (<= 0 s8) (<= s8 100)) (= o8 (select temp___485 s9))))
(assert (=> (and (<= 0 s8) (<= s8 100)) (and (= o9 (to__ o8)) (and (in_range2 o9) (= o9 (to_rep1 (rec__model__uml_transition__to_data (us_split_fields3 o8))))))))
(assert (=> (and (<= 0 s8) (<= s8 100)) (and (= (to__2 (mk___rep4 model__set_to__2__self__fields)) o9) (= (from__2 (mk___rep4 model__set_to__2__self__fields)) (from__2 (mk___rep4 (us_split_fields9 (select cfv3 s9))))))))
(assert (=> (and (<= 0 s8) (<= s8 100)) (= result7 (mk_map__ref3 cfv3))))
(assert (=> (and (<= 0 s8) (<= s8 100)) (= cfv4 (store cfv3 s9 (mk___rep4 model__set_to__2__self__fields)))))
(assert (=> (and (<= 0 s8) (<= s8 100)) (= s9 100)))
(assert (=> (and (<= 0 s8) (<= s8 100)) (= s10 (mk_int__ref s9))))
(assert (=> (and (<= 0 s8) (<= s8 100)) (= cfv5 (mk_map__ref3 cfv4))))
(assert (=> (and (<= 0 s8) (<= s8 100)) (= s11 s9)))
(assert (=> (and (<= 0 s8) (<= s8 100)) (= cfv6 cfv4)))
(assert (=> (and (<= 0 s8) (<= s8 100)) (= s12 s10)))
(assert (=> (and (<= 0 s8) (<= s8 100)) (= cfv7 cfv5)))
(assert (=> (and (<= 0 s8) (<= s8 100)) (= s13 s11)))
(assert (=> (and (<= 0 s8) (<= s8 100)) (= cfv8 cfv6)))
(assert (=> (not (and (<= 0 s8) (<= s8 100))) (= s12 (mk_int__ref s8))))
(assert (=> (not (and (<= 0 s8) (<= s8 100))) (= cfv7 (mk_map__ref3 cfv1))))
(assert (=> (not (and (<= 0 s8) (<= s8 100))) (= s13 s8)))
(assert (=> (not (and (<= 0 s8) (<= s8 100))) (= cfv8 cfv1)))
(assert (and (= (bool_eq7 (owned_action (mk___rep5 act__split_fields3)) 0 100 (map__content2 av6) 0 100) true) (= (bool_eq8 (owned_flow (mk___rep5 act__split_fields3)) 0 100 (owned_flow (mk___rep5 act__split_fields2)) 0 100) true)))
(assert (and (= (bool_eq8 (owned_flow (mk___rep5 act__split_fields4)) 0 100 (map__content3 cfv7) 0 100) true) (= (bool_eq7 (owned_action (mk___rep5 act__split_fields4)) 0 100 (owned_action (mk___rep5 act__split_fields3)) 0 100) true)))
(assert (= model__transform__result3 (mk_uml_activity__ref model__transform__result2)))
(assert (= model__transform__result4 model__transform__result2))
(assert (= result8 (mk_uml_activity__ref (mk___rep5 (mk___split_fields5 model__transform__result model__transform__result1)))))
(assert (= model__transform__result2 (mk___rep5 act__split_fields4)))
(assert (= model__transform__result5 model__transform__result3))
(assert (= s15 s12))
(assert (= s14 s6))
(assert (= act__split_fields5 (mk___split_fields__ref5 act__split_fields4)))
(assert (= cfv9 cfv7))
(assert (= av8 av6))
(assert (= model__transform__result6 model__transform__result4))
(assert (= s17 s13))
(assert (= s16 s7))
(assert (= act__split_fields6 act__split_fields4))
(assert (= cfv10 cfv8))
(assert (= av9 av7))
(assert (= (mk___rep5 (mk___split_fields5 result9 result10)) (uml_activity__content model__transform__result5)))
(declare-const t Int)
(assert (<= 0 t))
(assert (<= t 100))
(assert (not (= (name (select (owned_state sm) (from (select (owned_transition sm) t)))) (name__2 (select (owned_action (uml_activity__content model__transform__result5)) (from__2 (select (owned_flow (uml_activity__content model__transform__result5)) t)))))))
(check-sat)
(exit)
