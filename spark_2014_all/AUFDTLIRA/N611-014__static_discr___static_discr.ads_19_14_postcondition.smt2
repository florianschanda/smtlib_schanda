...
(assert (=> (and (= result__1 0) (< 0 (to_rep current__split_fields7))) (and (= current__split_discrs (mk___split_discrs1 temp___320 temp___3201)) (and (and (and (= temp___3202 current__split_fields4) (= temp___3203 current__split_fields5)) (= temp___3204 current__split_fields6)) (= temp___3205 current__split_fields7)))))
(assert (=> (and (= result__1 0) (< 0 (to_rep current__split_fields7))) (= temp___319 result__1)))
