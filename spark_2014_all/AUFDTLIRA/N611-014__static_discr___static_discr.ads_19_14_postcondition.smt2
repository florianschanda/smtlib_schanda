...
(assert (=> (and (= result__1 0) (< 0 (to_rep current__split_fields7))) (and (and (and (= current__split_discrs (mk___split_discrs1 temp___320 temp___3201)) (and (and (and (= temp___3202 current__split_fields4) (= temp___3203 current__split_fields5)) (= temp___3204 current__split_fields6)) (= temp___3205 current__split_fields7))) (and (= temp___319 result__1) (and (and (and (and (<= 1 (to_rep (rec__static_discr__holder__length1 current__split_fields8))) (<= (to_rep (rec__static_discr__holder__length1 current__split_fields8)) (to_rep (rec__static_discr__holder__length1 (us_split_fields9 a))))) (= (bool_eq (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 (us_split_fields9 a)))) 1 100 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 current__split_fields8))) 1 100) true)) (forall ((i2 Int)) (=> (and (<= (+ (to_rep (rec__static_discr__holder__length1 current__split_fields8)) 1) i2) (<= i2 (to_rep (rec__static_discr__holder__length1 (us_split_fields9 a))))) (not (= (to_rep (select (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 (us_split_fields9 a)))) i2)) e))))) (and (and (and (=> (<= 0 2147483647) (in_range2 result__2)) (and (= 100 (to_rep (rec__static_discr__i_holder__unused (us_split_discrs5 (rec__static_discr__holder__content1 current__split_fields8))))) (= 100 (to_rep (rec__static_discr__i_holder__c (us_split_discrs5 (rec__static_discr__holder__content1 current__split_fields8))))))) (and (= result__2 0) (< 0 (to_rep (rec__static_discr__holder__length1 current__split_fields8))))) (and (= (to_rep (rec__static_discr__holder__unused current__split_discrs)) 100) (and (and (and (= (bool_eq (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 current__split_fields9))) 1 100 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 current__split_fields8))) 1 100) true) (and (< (to_rep (rec__static_discr__holder__length1 current__split_fields9)) (to_rep (rec__static_discr__holder__length1 current__split_fields8))) (ite (= result__3 0) (forall ((i2 Int)) (=> (and (<= (+ (to_rep (rec__static_discr__holder__length1 current__split_fields9)) 1) i2) (<= i2 (to_rep (rec__static_discr__holder__length1 current__split_fields8)))) (not (= (to_rep (select (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 current__split_fields9))) i2)) e)))) (and (and (<= (to_rep (rec__static_discr__holder__length1 current__split_fields9)) result__3) (<= result__3 (to_rep (rec__static_discr__holder__length1 current__split_fields8)))) (= (to_rep (select (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 current__split_fields9))) result__3)) e))))) (and (and (= 100 (to_rep (rec__static_discr__i_holder__unused (us_split_discrs5 (rec__static_discr__holder__content1 current__split_fields9))))) (= 100 (to_rep (rec__static_discr__i_holder__c (us_split_discrs5 (rec__static_discr__holder__content1 current__split_fields9)))))) (in_range2 result__3))) (and (= (to_rep (rec__static_discr__holder__unused current__split_discrs)) 100) (and (= (bool_eq (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 (us_split_fields9 a)))) 1 100 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 current__split_fields9))) 1 100) true) (not (and (= result__3 0) (< 0 (to_rep (rec__static_discr__holder__length1 current__split_fields9))))))))))))) (and (and (= result__6 (mk_int__ref result__3)) (= current__split_fields12 (mk___split_fields__ref4 current__split_fields9))) (and (= result__7 result__3) (= current__split_fields13 current__split_fields9))))))
(assert (=> (and (= result__1 0) (< 0 (to_rep current__split_fields7))) (= result__8 result__6)))
(assert (=> (and (= result__1 0) (< 0 (to_rep current__split_fields7))) (= current__split_fields14 current__split_fields12)))
(assert (=> (and (= result__1 0) (< 0 (to_rep current__split_fields7))) (= result__9 result__7)))
(assert (=> (and (= result__1 0) (< 0 (to_rep current__split_fields7))) (= current__split_fields15 current__split_fields13)))
(assert (=> (not (and (= result__1 0) (< 0 (to_rep current__split_fields7)))) (= result__8 (mk_int__ref result__1))))
(assert (=> (not (and (= result__1 0) (< 0 (to_rep current__split_fields7)))) (= current__split_fields14 (mk___split_fields__ref4 (mk___split_fields4 (mk___rep3 (mk___split_discrs current__split_fields4 current__split_fields5) (mk___split_fields3 current__split_fields6)) current__split_fields7)))))
(assert (=> (not (and (= result__1 0) (< 0 (to_rep current__split_fields7)))) (= result__9 result__1)))
(assert (=> (not (and (= result__1 0) (< 0 (to_rep current__split_fields7)))) (= current__split_fields15 (mk___split_fields4 (mk___rep3 (mk___split_discrs current__split_fields4 current__split_fields5) (mk___split_fields3 current__split_fields6)) current__split_fields7))))
...
(assert (= result6 (mk_int__ref static_discr__search_max__result)))
(assert (= static_discr__search_max__result1 (int__content result__8)))
(assert (= static_discr__search_max__result4 static_discr__search_max__result2))
(assert (= result__10 result__8))
(assert (= current__split_fields16 current__split_fields14))
(assert (= static_discr__search_max__result5 static_discr__search_max__result3))
(assert (= result__11 result__9))
(assert (= current__split_fields17 current__split_fields15))
(assert (= result7 (int__content static_discr__search_max__result4)))
