...
(assert (= result6 (ite (= o51 (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)))) true false)))
(assert (= result6 true))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
...
(assert (=> (not (= (int__content v2) 0)) (and (= o48 (int__content v2)) (in_range1 (int__content v2)))))
...
(assert (=> (not (= (int__content v2) 0)) (and (= result14 (valid_root (mk___rep2 (us_split_fields__content2 f__split_fields7)) o49)) (and (= (= result14 true) (and (<= o49 (to_rep (rec__binary_trees__forest__s (us_split_fields__content2 f__split_fields7)))) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) o49)))) 2))) (=> (< (size (mk___rep2 (us_split_fields__content2 f__split_fields7))) o49) (not (= result14 true)))))))
...
(assert (=> (not (= (int__content v2) 0)) (= o44 (int__content v2))))
(assert (=> (not (= (int__content v2) 0)) (= o45 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root) o44))))
(assert (=> (not (= (int__content v2) 0)) (= o46 (us_split_fields1 o45))))
(assert (=> (not (= (int__content v2) 0)) (= o47 (rec__tree_model__path_type__a o46))))
(assert (=> (not (= (int__content v2) 0)) (and (= result15 (ole o47 (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root) i1))))) (= (= result15 true) (and (<= (length o47) (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root) i1))))) (forall ((n Int)) (=> (and (<= 1 n) (<= n (last o47))) (= (get o47 n) (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root) i1))) n)))))))))
