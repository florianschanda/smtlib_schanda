...
(assert (=> (not (= (int__content v2) 0)) (= o61 (int__content v2))))
(assert (=> (not (= (int__content v2) 0)) (= o62 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root) o61))))
(assert (=> (not (= (int__content v2) 0)) (= o63 (us_split_fields1 o62))))
(assert (=> (not (= (int__content v2) 0)) (= o64 (rec__tree_model__path_type__a o63))))
(assert (=> (not (= (int__content v2) 0)) (and (= result20 (ole o64 (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root) i7))))) (= (= result20 true) (and (<= (length o64) (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root) i7))))) (forall ((n Int)) (=> (and (<= 1 n) (<= n (last o64))) (= (get o64 n) (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root) i7))) n)))))))))
(assert (=> (= (int__content v2) 0) (= result20 false)))
