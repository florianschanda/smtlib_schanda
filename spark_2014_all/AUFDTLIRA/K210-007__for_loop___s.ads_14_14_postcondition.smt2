...
(assert (= index1 1))
(assert (=> (and (<= 1 index1) (<= index1 10)) (= temp___198 index1)))
(assert (=> (and (<= 1 index1) (<= index1 10)) (= temp___199 src)))
(assert (=> (and (<= 1 index1) (<= index1 10)) (= temp___196 src)))
(assert (=> (and (<= 1 index1) (<= index1 10)) (= temp___194 dest)))
(assert (=> (and (<= 1 index1) (<= index1 10)) (= temp___200 src)))
...
(assert (=> (and (<= 1 index1) (<= index1 10)) (and (forall ((j Int)) (=> (and (<= 1 j) (<= j index2)) (= (to_rep (select dest3 j)) (to_rep (select temp___199 j))))) (forall ((j Int)) (=> (and (<= (+ index2 1) j) (<= j 10)) (= (to_rep (select src3 j)) (to_rep (select temp___200 j))))))))
(assert (=> (and (<= 1 index1) (<= index1 10)) (and (and (and (forall ((temp___195 Int)) (=> (and (<= 1 temp___195) (<= temp___195 10)) (=> (< index2 temp___195) (= (select dest3 temp___195) (select temp___194 temp___195))))) (forall ((temp___197 Int)) (=> (and (<= 1 temp___197) (<= temp___197 10)) (=> (< index2 temp___197) (= (select src3 temp___197) (select temp___196 temp___197)))))) (=> (<= 1 10) (in_range3 index2))) (and (<= 1 index2) (<= index2 10)))))
