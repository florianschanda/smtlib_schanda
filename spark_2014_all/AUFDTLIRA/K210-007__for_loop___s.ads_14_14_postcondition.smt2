...
(assert (=> (and (<= 1 index1) (<= index1 10)) (and (forall ((j Int)) (=> (and (<= 1 j) (<= j index2)) (= (to_rep (select dest3 j)) (to_rep (select temp___175 j))))) (forall ((j Int)) (=> (and (<= (+ index2 1) j) (<= j 10)) (= (to_rep (select src3 j)) (to_rep (select temp___176 j))))))))
(assert (=> (and (<= 1 index1) (<= index1 10)) (and (and (and (forall ((temp___171 Int)) (=> (and (<= 1 temp___171) (<= temp___171 10)) (=> (< index2 temp___171) (= (select dest3 temp___171) (select temp___170 temp___171))))) (forall ((temp___173 Int)) (=> (and (<= 1 temp___173) (<= temp___173 10)) (=> (< index2 temp___173) (= (select src3 temp___173) (select temp___172 temp___173)))))) (=> (<= 1 10) (in_range3 index2))) (and (<= 1 index2) (<= index2 10)))))
