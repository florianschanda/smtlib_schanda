...
(assert (and (= o16 (index_of_minimum (mk___t o14 o15))) (and (in_range2 o16) (and (and (<= (to_rep (first o15)) o16) (<= o16 (to_rep (last o15)))) (forall ((j3 Int)) (=> (and (<= (to_rep (first o15)) j3) (<= j3 (to_rep (last o15)))) (<= (to_rep (select o14 o16)) (to_rep (select o14 j3)))))))))
(assert (= smallest3 result6))
(assert (= smallest4 o16))
(assert (=> (not (= smallest4 current3)) (and (= o17 current3) (in_range2 current3))))
(assert (=> (not (= smallest4 current3)) (and (= (to_rep (select values4 o17)) (to_rep (select values3 smallest4))) (and (= (to_rep (select values4 smallest4)) (to_rep (select values3 o17))) (forall ((j3 Int)) (=> (and (<= (to_rep values__first) j3) (<= j3 (to_rep values__last))) (=> (and (not (= j3 o17)) (not (= j3 smallest4))) (= (to_rep (select values4 j3)) (to_rep (select values3 j3))))))))))
