...
(assert (and (= o4 (index_of_minimum (mk___t o2 o3))) (and (in_range3 o4) (and (and (<= (to_rep1 (first o3)) o4) (<= o4 (to_rep1 (last o3)))) (forall ((i Int)) (=> (and (<= (to_rep1 (first o3)) i) (<= i (to_rep1 (last o3)))) (<= (to_rep (select o2 o4)) (to_rep (select o2 i)))))))))
...
(assert (= previous1 o7))
(assert (and (= o8 current1) (in_range3 current1)))
