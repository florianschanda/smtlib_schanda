...
(assert (forall ((values us_t)) (! (=> (and (dynamic_invariant1 values true true true) (< 0 (length values))) (let ((result (index_of_minimum values))) (and (and (and (<= (first1 values) result) (<= result (last1 values))) (forall ((i Int)) (=> (and (<= (first1 values) i) (<= i (last1 values))) (<= (to_rep (select (to_array values) result)) (to_rep (select (to_array values) i)))))) (dynamic_invariant result true false true)))) :pattern ((index_of_minimum values)))))
...
(define-fun dynamic_invariant2 ((temp___expr_230 us_t1) (temp___is_init_227 Bool) (temp___skip_constant_228 Bool) (temp___do_toplevel_229 Bool)) Bool (=> (not (= temp___skip_constant_228 true)) (and (dynamic_property2 (to_rep1 values__first) (to_rep1 values__last) (first3 temp___expr_230) (last3 temp___expr_230)) (and (= (first3 temp___expr_230) (to_rep1 values__first)) (= (last3 temp___expr_230) (to_rep1 values__last))))))
...
(define-fun dynamic_invariant5 ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= 1 100)) (in_range4 temp___expr_136)))
...
(define-fun dynamic_invariant6 ((temp___expr_147 Int) (temp___is_init_144 Bool) (temp___skip_constant_145 Bool) (temp___do_toplevel_146 Bool)) Bool (=> (or (= temp___is_init_144 true) (<= 0 100)) (in_range5 temp___expr_147)))
...
(assert (forall ((a us_t)) (! (=> (dynamic_invariant1 a true true true) (= (remove_last a) (let ((temp___159 (let ((temp___158 (- (last1 a) 1))) (let ((temp___157 (first1 a))) (of_array3 (to_array a) temp___157 temp___158))))) (of_array (to_array3 temp___159) (first7 temp___159) (last7 temp___159))))) :pattern ((remove_last a)))))
(declare-fun occ_def (us_t Int) Int)
(declare-fun occ_def__function_guard (Int us_t Int) Bool)
(assert (forall ((a us_t)) (forall ((e Int)) (! (=> (and (dynamic_invariant1 a true true true) (dynamic_invariant3 e true true true)) (= (occ_def a e) (ite (= (length a) 0) 0 (ite (= (to_rep (select (to_array a) (last1 a))) e) (+ (occ_def (remove_last a) e) 1) (occ_def (remove_last a) e))))) :pattern ((occ_def a e))))))
(assert (forall ((a us_t)) (forall ((e Int)) (! (=> (and (dynamic_invariant1 a true true true) (dynamic_invariant3 e true true true)) (let ((result (occ a e))) (and (<= result (length a)) (dynamic_invariant6 result true false true)))) :pattern ((occ a e))))))
(assert (forall ((a us_t)) (forall ((e Int)) (! (=> (and (dynamic_invariant1 a true true true) (dynamic_invariant3 e true true true)) (= (occ a e) (occ_def a e))) :pattern ((occ a e))))))
...
(declare-const temp___2392 (Array Int natural))
(declare-const temp___2393 t2)
(declare-const o15 (Array Int natural))
(declare-const o16 t)
(declare-const o17 Int)
(declare-const temp___2402 (Array Int natural))
(declare-const temp___2403 t1)
...
(declare-const previous3 (Array Int natural))
...
(assert (and (= temp___249 (- (to_rep1 values__last) 1)) (in_range1 (- (to_rep1 values__last) 1))))
(assert (= (mk_int__ref result1) (mk_int__ref current)))
(assert (= current2 (to_rep1 values__first)))
(assert (<= (to_rep1 values__first) current2))
(assert (<= current2 temp___249))
(assert (=> (<= current2 (to_rep1 values__last)) (and (and (<= (to_rep1 values__first) current2) (<= current2 (to_rep1 values__last))) (and (<= (to_rep1 values__first) (to_rep1 values__last)) (<= (to_rep1 values__last) (to_rep1 values__last))))))
(assert (= o1 values))
(assert (= o1 temp___239))
(assert (= (mk2 current2 (to_rep1 values__last)) temp___2391))
(assert (= temp___239 o2))
(assert (= (mk (to_rep1 (first4 temp___2391)) (to_rep1 (last4 temp___2391))) o3))
(assert (and (= o4 (index_of_minimum (mk___t o2 o3))) (and (in_range3 o4) (and (and (<= (to_rep1 (first o3)) o4) (<= o4 (to_rep1 (last o3)))) (forall ((i2 Int)) (=> (and (<= (to_rep1 (first o3)) i2) (<= i2 (to_rep1 (last o3)))) (<= (to_rep (select o2 o4)) (to_rep (select o2 i2)))))))))
(assert (= (mk_int__ref result2) (mk_int__ref smallest)))
(assert (= smallest2 o4))
(assert (not (= smallest2 current2)))
(assert true)
(assert (= (slide values (to_rep1 values__first) (to_rep1 values__first)) temp___240))
(assert (= (mk1 (to_rep1 values__first) (to_rep1 values__last)) temp___2401))
(assert (= (ite (<= (to_rep1 (first2 temp___2401)) (to_rep1 (last2 temp___2401))) (+ (- (to_rep1 (last2 temp___2401)) (to_rep1 (first2 temp___2401))) 1) 0) (ite (<= (to_rep1 previous__first) (to_rep1 previous__last)) (+ (- (to_rep1 previous__last) (to_rep1 previous__first)) 1) 0)))
(assert (= (mk___t1 o5 o6) (mk___t1 temp___240 temp___2401)))
(assert (= o7 o5))
(assert (= (mk_map__ref result3) (mk_map__ref previous)))
(assert (= previous2 o7))
(assert (and (= o8 current2) (in_range3 current2)))
(assert (not (<= (to_rep1 values__first) o8)))
(check-sat)
(exit)
