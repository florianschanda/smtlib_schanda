...
(declare-const temp___270 (Array Int natural))
(declare-const temp___2701 t2)
(declare-const o2 (Array Int natural))
(declare-const o3 t)
(declare-const o4 Int)
(declare-const temp___271 (Array Int natural))
(declare-const temp___2711 t1)
...
(assert (= o1 values))
(assert (= o1 temp___270))
(assert (= (mk2 current1 (to_rep1 values__last)) temp___2701))
(assert (= temp___270 o2))
(assert (= (mk (to_rep1 (first4 temp___2701)) (to_rep1 (last4 temp___2701))) o3))
...
(assert (= (slide values (to_rep1 values__first) (to_rep1 values__first)) temp___271))
(assert (= (mk1 (to_rep1 values__first) (to_rep1 values__last)) temp___2711))
(assert (= (ite (<= (to_rep1 (first2 temp___2711)) (to_rep1 (last2 temp___2711))) (+ (- (to_rep1 (last2 temp___2711)) (to_rep1 (first2 temp___2711))) 1) 0) (ite (<= (to_rep1 previous__first) (to_rep1 previous__last)) (+ (- (to_rep1 previous__last) (to_rep1 previous__first)) 1) 0)))
(assert (= (mk___t1 o5 o6) (mk___t1 temp___271 temp___2711)))
(assert (= o7 o5))
