...
(assert (and (<= (to_rep2 (first2 (rt1 (rec__simple_unc_arrays__table__v1 c__split_fields4)))) i2) (<= i2 (to_rep2 (last2 (rt1 (rec__simple_unc_arrays__table__v1 c__split_fields4)))))))
(assert (= o17 i2))
(assert (= o18 (store (elts1 (rec__simple_unc_arrays__table__v1 c__split_fields4)) o17 o16)))
(assert (= o18 o19))
(assert (= (rt1 (rec__simple_unc_arrays__table__v1 c__split_fields4)) o20))
(assert (= o21 o19))
(assert (= o22 o20))
(assert (= c__split_discrs (mk___split_discrs temp___778)))
(assert (= temp___7781 o21))
(assert (= temp___7782 o22))
(assert (= result1 (mk___split_fields__ref1 c__split_fields4)))
(assert (= c__split_fields5 (mk___split_fields1 (mk___t1 temp___7781 temp___7782))))
(assert (= c__split_discrs (mk___split_discrs temp___778)))
(assert (not (= i2 r7b)))
...
(assert (<= 1 j2))
(assert (<= j2 (- i3 1)))
(assert (not (= (to_rep1 (select (elts1 (rec__simple_unc_arrays__table__v1 c__split_fields5)) j2)) (+ (to_rep1 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) j2)) (to_rep1 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 b))) j2))))))
(check-sat)
(exit)
