...
(assert (= o13 o11))
(assert (= o14 o12))
(assert (= c__split_discrs (mk___split_discrs temp___863)))
(assert (= temp___8631 o13))
(assert (= temp___8632 o14))
(assert (= result1 (mk___split_fields__ref1 c__split_fields2)))
(assert (= c__split_fields3 (mk___split_fields1 (mk___t1 temp___8631 temp___8632))))
(assert (= c__split_discrs (mk___split_discrs temp___863)))
(assert (not (= i2 r7b)))
