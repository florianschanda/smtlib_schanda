...
(assert (and (<= (to_rep1 (first2 (rt1 (rec__simple_unc_arrays__table__v1 c__split_fields2)))) i2) (<= i2 (to_rep1 (last2 (rt1 (rec__simple_unc_arrays__table__v1 c__split_fields2)))))))
(assert (= o9 i2))
...
(assert (= o13 o11))
(assert (= o14 o12))
(assert (= c__split_discrs (mk___split_discrs temp___858)))
(assert (= temp___8581 o13))
(assert (= temp___8582 o14))
(assert (= result1 (mk___split_fields__ref1 c__split_fields2)))
(assert (= c__split_fields3 (mk___split_fields1 (mk___t1 temp___8581 temp___8582))))
(assert (= c__split_discrs (mk___split_discrs temp___858)))
(assert (not (= i2 r7b)))
...
(assert (<= 1 j))
(assert (<= j (- i3 1)))
(assert (not (= (to_rep2 (select (elts1 (rec__simple_unc_arrays__table__v1 c__split_fields3)) j)) (+ (to_rep2 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) j)) (to_rep2 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 b))) j))))))
(check-sat)
(exit)
