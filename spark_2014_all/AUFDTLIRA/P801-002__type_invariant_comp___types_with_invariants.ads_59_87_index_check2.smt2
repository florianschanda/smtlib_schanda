...
(assert (dynamic_invariant3 (mk___t3 temp___255 temp___2551) true false true true))
(assert (and (<= (to_rep (first6 temp___2551)) (to_rep (first6 temp___2551))) (<= (to_rep (first6 temp___2551)) (to_rep (last6 temp___2551)))))
(assert (= o (to_rep (first6 temp___2551))))
(assert (= o1 (select temp___255 o)))
(assert (= o2 (to_rep o1)))
(assert (= o3 (ite (= o2 1) true false)))
(assert (= result (ite (not (= o3 true)) true false)))
(assert (= result true))
(assert (<= (to_rep (first6 temp___2551)) i))
(assert (<= i (to_rep (last6 temp___2551))))
(assert (not (<= (to_rep (first6 temp___2551)) i)))
(check-sat)
(exit)
