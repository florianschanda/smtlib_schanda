...
(assert (=> (<= 1 2) (= o1 (+ (- 2 1) 1))))
(assert (=> (not (<= 1 2)) (= o1 0)))
(assert (=> (<= (to_rep1 (first (rt text))) (to_rep1 (last (rt text)))) (= o2 (+ (- (to_rep1 (last (rt text))) (to_rep1 (first (rt text)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt text))) (to_rep1 (last (rt text))))) (= o2 0)))
(assert (= o3 (+ o2 o1)))
