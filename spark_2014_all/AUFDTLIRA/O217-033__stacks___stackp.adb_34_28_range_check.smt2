...
(assert (forall ((temp___266 Int)) (= (select (temp___264 temp___266) 1) (of_rep1 temp___266))))
...
(declare-const temp___600 positive_less_than_max)
(declare-const temp___6001 (Array Int element))
(declare-const temp___6002 less_than_max)
(declare-const temp___6003 us_private)
(declare-const temp___6004 Int)
(declare-const temp___602 Int)
(declare-const o6 element)
(declare-const o7 Int)
(declare-const o8 (Array Int element))
(declare-const o9 positive_less_than_max)
(declare-const o10 (Array Int element))
(declare-const o11 less_than_max)
(declare-const o12 us_private)
(declare-const temp___604 positive_less_than_max)
(declare-const temp___6041 (Array Int element))
(declare-const temp___6042 less_than_max)
(declare-const temp___6043 us_private)
(declare-const temp___6044 Int)
...
(assert (in_range1 e))
(assert (not (= (is_full (mk___rep (mk___split_fields s__split_fields1 s__split_fields2 (hide_ext__ s__split_fields s__split_fields3)) s__attr__tag)) true)))
(assert (not (in_range (+ (to_rep s__split_fields2) 1))))
(check-sat)
(exit)
