...
(assert (= result2 true))
(assert (and (= o18 (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 ki1))))) (in_range4 (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 ki1)))))))
...
(assert (= o15 (select temp___1518 ki1)))
...
(assert (= o12 (select temp___1517 ki1)))
...
(assert (= o9 (select temp___1514 o8)))
