...
(assert (= (= result20 true) (forall ((winner1 Int)) (=> (and (<= 0 winner1) (<= winner1 20)) (forall ((i30 Int)) (=> (and (<= 1 i30) (<= i30 last_candidate)) (and (=> (and (= (select (map__content1 winners35) winner1) true) (not (= (select (map__content1 winners35) i30) true))) (< (to_rep (select counters i30)) (to_rep (select counters winner1)))) (=> (and (= (select (map__content1 winners35) winner1) true) (= (select (map__content1 winners35) i30) true)) (= (to_rep (select counters winner1)) (to_rep (select counters i30)))))))))))
