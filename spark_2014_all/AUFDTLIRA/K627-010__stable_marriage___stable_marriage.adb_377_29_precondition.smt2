...
(assert (and (forall ((g1 Int)) (=> (and (<= 1 g1) (<= g1 64)) (= (is_permutation_2 (select ranking_1 g1)) true))) (forall ((g2 Int)) (=> (and (<= 1 g2) (<= g2 64)) (= (is_permutation_1 (select ranking_2 g2)) true)))))
