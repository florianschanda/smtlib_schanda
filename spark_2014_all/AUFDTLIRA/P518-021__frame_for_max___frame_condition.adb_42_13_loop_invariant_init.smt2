...
(assert (not (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a9 j3)))) (to_rep (rec__frame_condition__cell__max_right (us_split_fields1 (select a9 i5)))))))
(check-sat)
(exit)
