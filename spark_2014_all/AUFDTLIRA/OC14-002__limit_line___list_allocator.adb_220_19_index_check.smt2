...
(assert (= (to_rep o47) prev_alloc1))
(assert (= o48 (mk___split_fields (rec__list_allocator__cell__stat (us_split_fields1 (select data2 next_alloc1))) o47 (rec__list_allocator__cell__next (us_split_fields1 (select data2 next_alloc1))))))
