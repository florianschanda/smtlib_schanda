...
(assert (not (= next_alloc1 0)))
(assert (= (to_rep o46) prev_alloc1))
(assert (= o47 (mk___split_fields1 (rec__list_allocator__cell__stat (us_split_fields3 (select data2 next_alloc1))) o46 (rec__list_allocator__cell__next (us_split_fields3 (select data2 next_alloc1))))))
(assert (= o48 (mk___rep1 o47)))
(assert (not (<= next_alloc1 3)))
(check-sat)
(exit)
