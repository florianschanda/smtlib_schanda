...
(assert (not (= next_alloc2 0)))
(assert (= (to_rep o47) prev_alloc2))
(assert (= o48 (mk___split_fields (rec__list_allocator__cell__stat (us_split_fields1 (select data3 next_alloc2))) o47 (rec__list_allocator__cell__next (us_split_fields1 (select data3 next_alloc2))))))
(assert (= o49 (mk___rep o48)))
(assert (not (<= 1 next_alloc2)))
(check-sat)
(exit)
