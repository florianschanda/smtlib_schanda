...
(assert (< 0 (ite (<= (to_rep1 values__first) (to_rep1 values__last)) (+ (- (to_rep1 values__last) (to_rep1 values__first)) 1) 0)))
(declare-const i Int)
(assert (<= (to_rep1 values__first) i))
(assert (<= i (- (to_rep1 values__last) 1)))
(assert (not (<= (to_rep (select (map__content values9) i)) (to_rep (select (map__content values9) (+ i 1))))))
(check-sat)
(exit)
