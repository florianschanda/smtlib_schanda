...
(declare-fun single_char_set_broken (Int) (Array Int Bool))
(declare-fun single_char_set_broken__function_guard ((Array Int Bool) Int) Bool)
(assert (forall ((c Int)) (! (=> (dynamic_invariant c true true true) (forall ((i Int)) (=> (and (<= 0 i) (<= i 255)) (= (= (select (single_char_set_broken c) i) true) (< c i))))) :pattern ((single_char_set_broken c)))))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const a (Array Int Bool))
(declare-const o (Array Int Bool))
(declare-const result (Array Int Bool))
(declare-const a1 (Array Int Bool))
(assert (and (= o (single_char_set_broken 68)) (forall ((i Int)) (=> (and (<= 0 i) (<= i 255)) (= (= (select o i) true) (< 68 i))))))
(assert (= result a))
(assert (= a1 o))
(assert (not (= (select a1 65) true)))
(check-sat)
(exit)
