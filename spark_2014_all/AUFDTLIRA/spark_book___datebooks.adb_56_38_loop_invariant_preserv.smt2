...
(assert (and (= o7 (- i12 (to_rep1 (first (rt description))))) (in_range1 (- i12 (to_rep1 (first (rt description)))))))
(assert (= o8 (+ 1 o7)))
(assert (and (= temp___372 o8) (in_range1 o8)))
(assert (and (<= 1 temp___372) (<= temp___372 128)))
(assert (= o10 temp___372))
(assert (= o11 (store (rec__datebooks__event_record__description_text (us_split_fields7 (select book2 (to_rep9 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields11)))))) o10 o9)))
(assert (= o11 o12))
(assert (= (rec__datebooks__event_record__description_size (us_split_fields7 (select book2 (to_rep9 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields11)))))) o13))
(assert (= (rec__datebooks__event_record__date (us_split_fields7 (select book2 (to_rep9 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields11)))))) (mk___rep2 (mk___split_fields2 (mk___rep (mk___split_fields o14 o15 o16)) (mk___rep1 (mk___split_fields1 o17 o18 o19))))))
(assert (= (rec__datebooks__event_record__is_used (us_split_fields7 (select book2 (to_rep9 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields11)))))) o20))
(assert (= o21 (mk___rep3 (mk___split_fields3 o12 o13 (mk___rep2 (mk___split_fields2 (mk___rep (mk___split_fields o14 o15 o16)) (mk___rep1 (mk___split_fields1 o17 o18 o19)))) o20))))
(assert (= o22 (store book2 (to_rep9 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields11))) o21)))
(assert (= result6 (mk_map__ref1 book2)))
(assert (= book3 o22))
(assert (not (= i12 (to_rep1 (last (rt description))))))
(assert (= result7 (mk_int__ref i12)))
(assert (= i13 (+ i12 1)))
(assert (= i14 (mk_int__ref i13)))
