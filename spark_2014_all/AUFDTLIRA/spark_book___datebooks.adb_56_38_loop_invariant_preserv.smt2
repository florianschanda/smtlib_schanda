...
(assert (and (= o6 (- i9 (to_rep1 (first (rt description))))) (in_range1 (- i9 (to_rep1 (first (rt description)))))))
(assert (= o7 (+ 1 o6)))
(assert (and (= temp___416 o7) (in_range1 o7)))
(assert (and (<= 1 temp___416) (<= temp___416 128)))
(assert (= o9 temp___416))
(assert (= o10 (store (rec__datebooks__event_record__description_text (us_split_fields7 (select book2 (to_rep8 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields9)))))) o9 o8)))
(assert (= o10 o11))
(assert (= (rec__datebooks__event_record__description_size (us_split_fields7 (select book2 (to_rep8 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields9)))))) o12))
(assert (= (rec__datebooks__event_record__date (us_split_fields7 (select book2 (to_rep8 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields9)))))) (mk___rep2 (mk___split_fields2 (mk___rep (mk___split_fields o13 o14 o15)) (mk___rep1 (mk___split_fields1 o16 o17 o18))))))
(assert (= (rec__datebooks__event_record__is_used (us_split_fields7 (select book2 (to_rep8 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields9)))))) o19))
(assert (= o20 (mk___rep3 (mk___split_fields3 o11 o12 (mk___rep2 (mk___split_fields2 (mk___rep (mk___split_fields o13 o14 o15)) (mk___rep1 (mk___split_fields1 o16 o17 o18)))) o19))))
(assert (= o21 (store book2 (to_rep8 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields9))) o20)))
