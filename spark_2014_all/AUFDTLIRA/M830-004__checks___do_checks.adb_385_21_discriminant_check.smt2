...
(define-fun dynamic_invariant1 ((temp___expr_509 us_rep) (temp___is_init_506 Bool) (temp___skip_constant_507 Bool) (temp___do_toplevel_508 Bool)) Bool (let ((temp___510 (rec__do_checks__do_discriminant_check__r1__j (us_split_discrs1 temp___expr_509)))) (=> (do_checks__do_discriminant_check__r1__arr__pred temp___expr_509) (and (dynamic_property1 1 (to_rep temp___510) (first1 (rec__do_checks__do_discriminant_check__r1__arr (us_split_fields1 temp___expr_509))) (last1 (rec__do_checks__do_discriminant_check__r1__arr (us_split_fields1 temp___expr_509)))) (and (= (first1 (rec__do_checks__do_discriminant_check__r1__arr (us_split_fields1 temp___expr_509))) 1) (= (last1 (rec__do_checks__do_discriminant_check__r1__arr (us_split_fields1 temp___expr_509))) (to_rep temp___510)))))))
...
(define-fun dynamic_invariant2 ((temp___expr_515 us_rep1) (temp___is_init_512 Bool) (temp___skip_constant_513 Bool) (temp___do_toplevel_514 Bool)) Bool (=> (not (= temp___skip_constant_513 true)) (in_range3 10 (to_base temp___expr_515))))
...
(assert (dynamic_invariant1 (mk___rep x__split_discrs (mk___split_fields (mk___t x__split_fields x__split_fields1))) true false true))
