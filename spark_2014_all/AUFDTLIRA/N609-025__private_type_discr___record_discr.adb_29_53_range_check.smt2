...
(assert (not (= (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 0)))
(assert (not (in_range2 (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))))))
(check-sat)
(exit)
