...
(assert (forall ((temp___463 us_rep) (temp___464 us_rep)) (let ((temp___462 (temp___461 temp___463 temp___464))) (forall ((temp___465 Int)) (ite (or (= temp___465 2) (and (<= 4 temp___465) (<= temp___465 6))) (= (select temp___462 temp___465) temp___463) (= (select temp___462 temp___465) temp___464))))))
...
(assert (= o14 o3))
(assert (= o15 o4))
(assert (= o16 (temp___461 (mk___rep (mk___split_fields o13 o14 o15)) (mk___rep (mk___split_fields o10 o11 o12)))))
(assert (= result x))
(assert (= x1 o16))
