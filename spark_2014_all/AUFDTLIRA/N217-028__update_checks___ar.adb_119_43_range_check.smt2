...
(declare-fun temp_____aggregate_def_299 ((Array Int et1) Int Int Int) (Array Int et1))
(assert (forall ((temp___301 (Array Int et1))) (forall ((temp___302 Int) (temp___303 Int) (temp___304 Int)) (let ((temp___300 (temp_____aggregate_def_299 temp___301 temp___302 temp___303 temp___304))) (=> (and (and (dynamic_invariant temp___302 true true true true) (dynamic_invariant temp___303 true true true true)) (dynamic_invariant1 temp___304 true true true true)) (forall ((temp___305 Int)) (ite (and (<= temp___302 temp___305) (<= temp___305 temp___303)) (= (to_rep (select temp___300 temp___305)) temp___304) (= (select temp___300 temp___305) (select temp___301 temp___305)))))))))
(assert (in_range i))
(assert (in_range j))
(assert (in_range1 e))
