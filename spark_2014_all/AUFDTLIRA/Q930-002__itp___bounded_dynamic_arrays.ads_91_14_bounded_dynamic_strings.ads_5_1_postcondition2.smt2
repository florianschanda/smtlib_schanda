...
(assert (not (= (let ((temp___1051 (value (sequence__content bounded_dynamic_strings__Oconcat__2__result10)))) (bool_eq (elts2 temp___1051) (to_rep1 (first4 (rt2 temp___1051))) (to_rep1 (last4 (rt2 temp___1051))) (let ((temp___1050 (value left))) (ite (= (length3 temp___1050) 0) (elts2 right) (concat1 (elts2 temp___1050) (to_rep1 (first4 (rt2 temp___1050))) (to_rep1 (last4 (rt2 temp___1050))) (elts2 right) (to_rep1 (first4 (rt2 right))) (to_rep1 (last4 (rt2 right)))))) (to_rep1 (first (let ((temp___1050 (value left))) (ite (= (length3 temp___1050) 0) (mk (to_rep1 (first4 (rt2 right))) (to_rep1 (last4 (rt2 right)))) (mk (to_rep1 (first4 (rt2 temp___1050))) (- (+ (to_rep1 (first4 (rt2 temp___1050))) (+ (ite (<= (to_rep1 (first4 (rt2 temp___1050))) (to_rep1 (last4 (rt2 temp___1050)))) (+ (- (to_rep1 (last4 (rt2 temp___1050))) (to_rep1 (first4 (rt2 temp___1050)))) 1) 0) (ite (<= (to_rep1 (first4 (rt2 right))) (to_rep1 (last4 (rt2 right)))) (+ (- (to_rep1 (last4 (rt2 right))) (to_rep1 (first4 (rt2 right)))) 1) 0))) 1)))))) (to_rep1 (last (let ((temp___1050 (value left))) (ite (= (length3 temp___1050) 0) (mk (to_rep1 (first4 (rt2 right))) (to_rep1 (last4 (rt2 right)))) (mk (to_rep1 (first4 (rt2 temp___1050))) (- (+ (to_rep1 (first4 (rt2 temp___1050))) (+ (ite (<= (to_rep1 (first4 (rt2 temp___1050))) (to_rep1 (last4 (rt2 temp___1050)))) (+ (- (to_rep1 (last4 (rt2 temp___1050))) (to_rep1 (first4 (rt2 temp___1050)))) 1) 0) (ite (<= (to_rep1 (first4 (rt2 right))) (to_rep1 (last4 (rt2 right)))) (+ (- (to_rep1 (last4 (rt2 right))) (to_rep1 (first4 (rt2 right)))) 1) 0))) 1)))))))) true)))
(check-sat)
(exit)
