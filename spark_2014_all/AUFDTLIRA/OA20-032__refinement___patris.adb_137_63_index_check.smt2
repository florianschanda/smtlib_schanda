...
(declare-const x Int)
(declare-const o Int)
(declare-const temp___2410 map1)
...
(assert (forall ((yy Int)) (=> (and (<= 0 yy) (<= yy 2)) (forall ((xx Int)) (=> (and (<= 0 xx) (<= xx 2)) (=> (= (get (get1 possible_three_shapes (to_rep cur_piece__split_fields) (to_rep3 cur_piece__split_fields1)) yy xx) true) (= (is_empty cur_board (+ (to_rep2 cur_piece__split_fields3) yy) (+ (to_rep1 cur_piece__split_fields2) xx)) true)))))))
...
(assert (= temp___2410 (get1 possible_three_shapes o (to_rep3 cur_piece__split_fields1))))
(assert (= result2 (get temp___2410 y1 x1)))
(assert (= result2 true))
(assert (= (to_rep4 o1) (to_rep cur_piece__split_fields)))
(assert (not (<= (+ (to_rep1 cur_piece__split_fields2) x1) 10)))
(check-sat)
(exit)
