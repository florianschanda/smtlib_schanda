...
(assert (<= i6 ki4))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= temp___1491 (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root)) (and (dynamic_invariant3 temp___1491 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1491 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1491 root)))) 0) (and (forall ((i15 Int)) (=> (and (<= 1 i15) (<= i15 100)) (=> (not (= i15 root)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i15) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1491 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i15)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1491 i15))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1491 i15))) true)))))) (and (forall ((i15 Int)) (=> (and (<= 1 i15) (<= i15 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1491 i15))) true) (not (= i15 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1491 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i15)))) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i15) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1491 i15)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1491 i15)))) 0)))) (forall ((i15 Int)) (=> (and (<= 1 i15) (<= i15 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1491 i15))) true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1491 j2))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1491 i15))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1491 j2)))) true)) (= j2 i15))))))))))))))
(assert (and (<= 1 i6) (<= i6 100)))
(assert (= o191 i6))
(assert (= o192 (select temp___1491 o191)))
(assert (= o193 (us_split_fields1 o192)))
(assert (= result32 (rec__tree_model__path_type__k o193)))
(assert (=> (= result32 true) (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true)))
(assert (=> (= result32 true) (and (= temp___1492 (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root)) (and (dynamic_invariant3 temp___1492 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1492 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1492 root)))) 0) (and (forall ((i15 Int)) (=> (and (<= 1 i15) (<= i15 100)) (=> (not (= i15 root)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i15) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1492 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i15)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1492 i15))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1492 i15))) true)))))) (and (forall ((i15 Int)) (=> (and (<= 1 i15) (<= i15 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1492 i15))) true) (not (= i15 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1492 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i15)))) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i15) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1492 i15)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1492 i15)))) 0)))) (forall ((i15 Int)) (=> (and (<= 1 i15) (<= i15 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1492 i15))) true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1492 j2))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1492 i15))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1492 j2)))) true)) (= j2 i15)))))))))))))))
(assert (=> (= result32 true) (and (<= 1 i6) (<= i6 100))))
(assert (=> (= result32 true) (= o186 i6)))
(assert (=> (= result32 true) (= o187 (select temp___1492 o186))))
(assert (=> (= result32 true) (= o188 (us_split_fields1 o187))))
(assert (=> (= result32 true) (= o189 (rec__tree_model__path_type__a o188))))
(assert (=> (= result32 true) (and (= o190 (length o189)) (and (in_range5 o190) (<= (+ 0 o190) 2147483647)))))
(assert (=> (= result32 true) (= result31 (ite (<= o190 n2) true false))))
