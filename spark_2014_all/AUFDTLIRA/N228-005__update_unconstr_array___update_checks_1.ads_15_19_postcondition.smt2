...
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (let ((temp___441 (temp___245 (mk___t a (mk (to_rep a__first) (to_rep a__last))) 1 i 0 j k l new_val))) (bool_eq a2 (to_rep a__first) (to_rep a__last) (elts temp___441) (to_rep (first (rt temp___441))) (to_rep (last (rt temp___441))))) true)))
(check-sat)
(exit)
