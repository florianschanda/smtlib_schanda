...
(assert (<= index2 temp___1271))
(assert (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))))
(assert (= o29 index2))
(assert (= o30 (select n1 o29)))
(assert (= o31 (to_rep1 o30)))
(assert (= o31 aida__conversion__convert_character_digit_to_integer__2__target))
...
(assert (= (to_rep1 o35) aida__conversion__convert_character_digit_to_integer__2__target2))
(assert (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))))
(assert (= o36 index2))
(assert (= o37 (store n1 o36 o35)))
(assert (= n1 result3))
(assert (= n2 o37))
