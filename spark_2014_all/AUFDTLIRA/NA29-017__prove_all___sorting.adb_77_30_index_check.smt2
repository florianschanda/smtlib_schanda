...
(assert (and (= o65 (+ a_first length1)) (in_range1 (+ a_first length1))))
(assert (= o66 (+ o65 length2)))
(assert (and (= o67 o66) (in_range1 o66)))
(assert (= o68 (- o67 1)))
(assert (= o69 (ite (<= k o68) true false)))
(assert (= o70 (ite (<= a_first k) o69 false)))
(assert (= result7 (ite (not (= o70 true)) true false)))
(assert (= result7 true))
