...
(define-fun log__split_fields3 () us_split_fields (mk___split_fields log__split_fields log__split_fields1 log__split_fields2))
(assert (= (log_size (mk___rep log__split_fields3 log__attr__tag)) 0))
(assert (not (< (log_size (mk___rep log__split_fields3 log__attr__tag)) 10000)))
(check-sat)
(exit)
