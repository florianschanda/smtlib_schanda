...
(assert (forall ((log us_rep)) (! (= (log_size log) (to_rep (rec__logging__log_type__log_size (us_split_fields1 log)))) :pattern ((log_size log)))))
...
(assert (= (log_size (mk___rep (mk___split_fields log__split_fields log__split_fields1 log__split_fields2) log__attr__tag)) 0))
(assert (not (< (log_size (mk___rep (mk___split_fields log__split_fields log__split_fields1 log__split_fields2) log__attr__tag)) 10000)))
(check-sat)
(exit)
