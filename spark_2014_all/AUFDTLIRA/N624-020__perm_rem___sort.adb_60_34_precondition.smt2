...
(assert (and (= o72 y) (in_range5 y)))
(assert (and (= o70 x) (in_range5 x)))
(assert (and (= o71 (remove (mk___t values2 (mk 1 100)) o70)) (and (dynamic_invariant4 o71 true false true) (and (= (invariant__ o71) true) (and (= (to_rep1 (last (rt o71))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o70 1))) (= (to_rep (select values2 k)) (to_rep (select (elts o71) k))))) (and (forall ((k Int)) (=> (and (<= (+ o70 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select (elts o71) (- k 1)))))) (forall ((k Int)) (=> (and (<= o70 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts o71) k))))))))))))
(assert (and (= o73 (remove o71 o72)) (and (dynamic_invariant4 o73 true false true) (and (= (invariant__ o73) true) (and (= (to_rep1 (last (rt o73))) (- (to_rep1 (last (rt o71))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o72 1))) (= (to_rep (select (elts o71) k)) (to_rep (select (elts o73) k))))) (and (forall ((k Int)) (=> (and (<= (+ o72 1) k) (<= k (to_rep1 (last (rt o71))))) (= (to_rep (select (elts o71) k)) (to_rep (select (elts o73) (- k 1)))))) (forall ((k Int)) (=> (and (<= o72 k) (<= k (- (to_rep1 (last (rt o71))) 1))) (= (to_rep (select (elts o71) (+ k 1))) (to_rep (select (elts o73) k))))))))))))
(assert (and (= o68 y) (in_range5 y)))
(assert (and (= o66 x) (in_range5 x)))
(assert (and (= o67 (remove (mk___t init (mk 1 100)) o66)) (and (dynamic_invariant4 o67 true false true) (and (= (invariant__ o67) true) (and (= (to_rep1 (last (rt o67))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o66 1))) (= (to_rep (select init k)) (to_rep (select (elts o67) k))))) (and (forall ((k Int)) (=> (and (<= (+ o66 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select init k)) (to_rep (select (elts o67) (- k 1)))))) (forall ((k Int)) (=> (and (<= o66 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select init (+ k 1))) (to_rep (select (elts o67) k))))))))))))
(assert (and (= o69 (remove o67 o68)) (and (dynamic_invariant4 o69 true false true) (and (= (invariant__ o69) true) (and (= (to_rep1 (last (rt o69))) (- (to_rep1 (last (rt o67))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o68 1))) (= (to_rep (select (elts o67) k)) (to_rep (select (elts o69) k))))) (and (forall ((k Int)) (=> (and (<= (+ o68 1) k) (<= k (to_rep1 (last (rt o67))))) (= (to_rep (select (elts o67) k)) (to_rep (select (elts o69) (- k 1)))))) (forall ((k Int)) (=> (and (<= o68 k) (<= k (- (to_rep1 (last (rt o67))) 1))) (= (to_rep (select (elts o67) (+ k 1))) (to_rep (select (elts o69) k))))))))))))
(assert (and (= o74 (perm_reflexive o69 o73)) (and (in_range4 o74) (=> (= (of_int o74) true) (= (is_perm o69 o73) true)))))
(assert (= result8 (mk_int__ref hr)))
(assert (= hr9 o74))
(assert (and (= o76 x) (in_range5 x)))
(assert (and (= o75 y) (in_range5 y)))
(assert (and (= o77 (remove_swap (mk___t values2 (mk 1 100)) o75 o76)) (and (in_range4 o77) (=> (= (of_int o77) true) (= (let ((temp___157 (remove (remove (mk___t values2 (mk 1 100)) o76) o75))) (let ((temp___156 (remove (remove (mk___t values2 (mk 1 100)) o75) (- o76 1)))) (bool_eq (elts temp___156) (to_rep1 (first (rt temp___156))) (to_rep1 (last (rt temp___156))) (elts temp___157) (to_rep1 (first (rt temp___157))) (to_rep1 (last (rt temp___157)))))) true)))))
(assert (= result9 (mk_int__ref hr9)))
(assert (= hr10 o77))
(assert (and (= o84 (- x 1)) (in_range5 (- x 1))))
(assert (and (= o82 y) (in_range5 y)))
(assert (and (= o83 (remove (mk___t values2 (mk 1 100)) o82)) (and (dynamic_invariant4 o83 true false true) (and (= (invariant__ o83) true) (and (= (to_rep1 (last (rt o83))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o82 1))) (= (to_rep (select values2 k)) (to_rep (select (elts o83) k))))) (and (forall ((k Int)) (=> (and (<= (+ o82 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select (elts o83) (- k 1)))))) (forall ((k Int)) (=> (and (<= o82 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts o83) k))))))))))))
(assert (and (= o85 (remove o83 o84)) (and (dynamic_invariant4 o85 true false true) (and (= (invariant__ o85) true) (and (= (to_rep1 (last (rt o85))) (- (to_rep1 (last (rt o83))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o84 1))) (= (to_rep (select (elts o83) k)) (to_rep (select (elts o85) k))))) (and (forall ((k Int)) (=> (and (<= (+ o84 1) k) (<= k (to_rep1 (last (rt o83))))) (= (to_rep (select (elts o83) k)) (to_rep (select (elts o85) (- k 1)))))) (forall ((k Int)) (=> (and (<= o84 k) (<= k (- (to_rep1 (last (rt o83))) 1))) (= (to_rep (select (elts o83) (+ k 1))) (to_rep (select (elts o85) k))))))))))))
(assert (and (= o80 y) (in_range5 y)))
(assert (and (= o78 x) (in_range5 x)))
(assert (and (= o79 (remove (mk___t values2 (mk 1 100)) o78)) (and (dynamic_invariant4 o79 true false true) (and (= (invariant__ o79) true) (and (= (to_rep1 (last (rt o79))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o78 1))) (= (to_rep (select values2 k)) (to_rep (select (elts o79) k))))) (and (forall ((k Int)) (=> (and (<= (+ o78 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select (elts o79) (- k 1)))))) (forall ((k Int)) (=> (and (<= o78 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts o79) k))))))))))))
(assert (and (= o81 (remove o79 o80)) (and (dynamic_invariant4 o81 true false true) (and (= (invariant__ o81) true) (and (= (to_rep1 (last (rt o81))) (- (to_rep1 (last (rt o79))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o80 1))) (= (to_rep (select (elts o79) k)) (to_rep (select (elts o81) k))))) (and (forall ((k Int)) (=> (and (<= (+ o80 1) k) (<= k (to_rep1 (last (rt o79))))) (= (to_rep (select (elts o79) k)) (to_rep (select (elts o81) (- k 1)))))) (forall ((k Int)) (=> (and (<= o80 k) (<= k (- (to_rep1 (last (rt o79))) 1))) (= (to_rep (select (elts o79) (+ k 1))) (to_rep (select (elts o81) k))))))))))))
(assert (and (= o86 (perm_reflexive o81 o85)) (and (in_range4 o86) (=> (= (of_int o86) true) (= (is_perm o81 o85) true)))))
(assert (= result10 (mk_int__ref hr10)))
(assert (= hr11 o86))
(assert (and (= o97 (- x 1)) (in_range5 (- x 1))))
(assert (and (= o95 y) (in_range5 y)))
(assert (and (= o96 (remove (mk___t values2 (mk 1 100)) o95)) (and (dynamic_invariant4 o96 true false true) (and (= (invariant__ o96) true) (and (= (to_rep1 (last (rt o96))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o95 1))) (= (to_rep (select values2 k)) (to_rep (select (elts o96) k))))) (and (forall ((k Int)) (=> (and (<= (+ o95 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select (elts o96) (- k 1)))))) (forall ((k Int)) (=> (and (<= o95 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts o96) k))))))))))))
(assert (and (= o98 (remove o96 o97)) (and (dynamic_invariant4 o98 true false true) (and (= (invariant__ o98) true) (and (= (to_rep1 (last (rt o98))) (- (to_rep1 (last (rt o96))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o97 1))) (= (to_rep (select (elts o96) k)) (to_rep (select (elts o98) k))))) (and (forall ((k Int)) (=> (and (<= (+ o97 1) k) (<= k (to_rep1 (last (rt o96))))) (= (to_rep (select (elts o96) k)) (to_rep (select (elts o98) (- k 1)))))) (forall ((k Int)) (=> (and (<= o97 k) (<= k (- (to_rep1 (last (rt o96))) 1))) (= (to_rep (select (elts o96) (+ k 1))) (to_rep (select (elts o98) k))))))))))))
(assert (and (= o93 y) (in_range5 y)))
(assert (and (= o91 x) (in_range5 x)))
(assert (and (= o92 (remove (mk___t values2 (mk 1 100)) o91)) (and (dynamic_invariant4 o92 true false true) (and (= (invariant__ o92) true) (and (= (to_rep1 (last (rt o92))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o91 1))) (= (to_rep (select values2 k)) (to_rep (select (elts o92) k))))) (and (forall ((k Int)) (=> (and (<= (+ o91 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select (elts o92) (- k 1)))))) (forall ((k Int)) (=> (and (<= o91 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts o92) k))))))))))))
(assert (and (= o94 (remove o92 o93)) (and (dynamic_invariant4 o94 true false true) (and (= (invariant__ o94) true) (and (= (to_rep1 (last (rt o94))) (- (to_rep1 (last (rt o92))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o93 1))) (= (to_rep (select (elts o92) k)) (to_rep (select (elts o94) k))))) (and (forall ((k Int)) (=> (and (<= (+ o93 1) k) (<= k (to_rep1 (last (rt o92))))) (= (to_rep (select (elts o92) k)) (to_rep (select (elts o94) (- k 1)))))) (forall ((k Int)) (=> (and (<= o93 k) (<= k (- (to_rep1 (last (rt o92))) 1))) (= (to_rep (select (elts o92) (+ k 1))) (to_rep (select (elts o94) k))))))))))))
(assert (and (= o89 y) (in_range5 y)))
(assert (and (= o87 x) (in_range5 x)))
(assert (and (= o88 (remove (mk___t init (mk 1 100)) o87)) (and (dynamic_invariant4 o88 true false true) (and (= (invariant__ o88) true) (and (= (to_rep1 (last (rt o88))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o87 1))) (= (to_rep (select init k)) (to_rep (select (elts o88) k))))) (and (forall ((k Int)) (=> (and (<= (+ o87 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select init k)) (to_rep (select (elts o88) (- k 1)))))) (forall ((k Int)) (=> (and (<= o87 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select init (+ k 1))) (to_rep (select (elts o88) k))))))))))))
(assert (and (= o90 (remove o88 o89)) (and (dynamic_invariant4 o90 true false true) (and (= (invariant__ o90) true) (and (= (to_rep1 (last (rt o90))) (- (to_rep1 (last (rt o88))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o89 1))) (= (to_rep (select (elts o88) k)) (to_rep (select (elts o90) k))))) (and (forall ((k Int)) (=> (and (<= (+ o89 1) k) (<= k (to_rep1 (last (rt o88))))) (= (to_rep (select (elts o88) k)) (to_rep (select (elts o90) (- k 1)))))) (forall ((k Int)) (=> (and (<= o89 k) (<= k (- (to_rep1 (last (rt o88))) 1))) (= (to_rep (select (elts o88) (+ k 1))) (to_rep (select (elts o90) k))))))))))))
(assert (and (= o99 (perm_transitive o90 o94 o98)) (and (in_range4 o99) (=> (= (of_int o99) true) (= (is_perm o90 o98) true)))))
(assert (= result11 (mk_int__ref hr11)))
(assert (= hr12 o99))
(assert (= (to_rep (select (elts (remove (mk___t init (mk 1 100)) x)) y)) (to_rep (select (elts (remove (mk___t values2 (mk 1 100)) y)) (- x 1)))))
(assert (and (= o107 y) (in_range5 y)))
(assert (and (= o108 (remove (mk___t values2 (mk 1 100)) o107)) (and (dynamic_invariant4 o108 true false true) (and (= (invariant__ o108) true) (and (= (to_rep1 (last (rt o108))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o107 1))) (= (to_rep (select values2 k)) (to_rep (select (elts o108) k))))) (and (forall ((k Int)) (=> (and (<= (+ o107 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select (elts o108) (- k 1)))))) (forall ((k Int)) (=> (and (<= o107 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts o108) k))))))))))))
(assert (and (= o105 x) (in_range5 x)))
