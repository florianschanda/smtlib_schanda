...
(define-fun dynamic_invariant ((temp___expr_231 Int) (temp___is_init_228 Bool) (temp___skip_constant_229 Bool) (temp___do_toplevel_230 Bool)) Bool (=> (or (= temp___is_init_228 true) (<= 1 10)) (in_range2 temp___expr_231)))
...
(define-fun bool_eq1 ((a (Array Int us_rep)) (a__first Int) (a__last Int) (b (Array Int us_rep)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_182 Int)) (=> (and (<= a__first temp___idx_182) (<= temp___idx_182 a__last)) (= (bool_eq (select a temp___idx_182) (select b (+ (- b__first a__first) temp___idx_182))) true)))) true false))
(assert (forall ((a (Array Int us_rep)) (b (Array Int us_rep))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq1 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_182 Int)) (=> (and (<= a__first temp___idx_182) (<= temp___idx_182 a__last)) (= (bool_eq (select a temp___idx_182) (select b (+ (- b__first a__first) temp___idx_182))) true))))))))
...
(define-fun dynamic_invariant2 ((temp___expr_208 Int) (temp___is_init_205 Bool) (temp___skip_constant_206 Bool) (temp___do_toplevel_207 Bool)) Bool (=> (or (= temp___is_init_205 true) (<= 1 8)) (in_range1 temp___expr_208)))
...
(declare-const o40 track_id)
(declare-const o41 natural)
(declare-const o42 track_id)
(declare-const o43 track_id)
(declare-const o44 Int)
(declare-const o45 Int)
(declare-const o46 Bool)
(declare-const o47 Int)
(declare-const o48 track_id)
(declare-const o49 natural)
(declare-const o50 track_id)
(declare-const o51 track_id)
(declare-const o52 natural)
(declare-const o53 track_id)
(declare-const o54 track_id)
(declare-const o55 Int)
(declare-const o56 track_id)
(declare-const o57 natural)
(declare-const o58 track_id)
(declare-const o59 us_split_fields)
(declare-const o60 track_id)
...
(assert (= (mk___rep (mk___split_fields o56 o57 o58)) (select trains o55)))
