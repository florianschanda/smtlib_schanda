...
(assert (and (= o7 (remove b (to_rep (rec__perm__witnesses__ib (us_split_fields1 w))))) (and (dynamic_invariant1 o7 true false true) (and (= (invariant__ o7) true) (and (= (to_rep2 (last o3)) (- (to_rep2 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- (to_rep (rec__perm__witnesses__ib (us_split_fields1 w))) 1))) (= (to_rep1 (select (elts b) k)) (to_rep1 (select o2 k))))) (and (forall ((k Int)) (=> (and (<= (+ (to_rep (rec__perm__witnesses__ib (us_split_fields1 w))) 1) k) (<= k (to_rep2 (last (rt b))))) (= (to_rep1 (select (elts b) k)) (to_rep1 (select o2 (- k 1)))))) (forall ((k Int)) (=> (and (<= (to_rep (rec__perm__witnesses__ib (us_split_fields1 w))) k) (<= k (- (to_rep2 (last (rt b))) 1))) (= (to_rep1 (select (elts b) (+ k 1))) (to_rep1 (select o2 k))))))))))))
(assert (and (= o8 (remove a (to_rep (rec__perm__witnesses__ia (us_split_fields1 w))))) (and (dynamic_invariant1 o8 true false true) (and (= (invariant__ o8) true) (and (= (to_rep2 (last o1)) (- (to_rep2 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- (to_rep (rec__perm__witnesses__ia (us_split_fields1 w))) 1))) (= (to_rep1 (select (elts a) k)) (to_rep1 (select o k))))) (and (forall ((k Int)) (=> (and (<= (+ (to_rep (rec__perm__witnesses__ia (us_split_fields1 w))) 1) k) (<= k (to_rep2 (last (rt a))))) (= (to_rep1 (select (elts a) k)) (to_rep1 (select o (- k 1)))))) (forall ((k Int)) (=> (and (<= (to_rep (rec__perm__witnesses__ia (us_split_fields1 w))) k) (<= k (- (to_rep2 (last (rt a))) 1))) (= (to_rep1 (select (elts a) (+ k 1))) (to_rep1 (select o k))))))))))))
(assert (and (= perm__shift_perm_l__induction_hypothesis__B_5__ih__assume (induction_hypothesis o8 o7 o6)) (and (in_range1 perm__shift_perm_l__induction_hypothesis__B_5__ih__assume) (=> (= (of_int perm__shift_perm_l__induction_hypothesis__B_5__ih__assume) true) (= (is_perm o6 o7) true)))))
