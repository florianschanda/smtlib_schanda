...
(assert (<= (to_rep a_v1__first) i_v11))
(assert (<= i_v11 k_1))
(assert (forall ((m1 Int)) (=> (and (<= (to_rep a_v1__first) m1) (<= m1 (- i_v12 1))) (= (to_rep (select a_v11 m1)) (to_rep (select (elts b_v1) m1))))))
(assert (and (and (forall ((temp___477 Int)) (=> (and (<= (to_rep a_v1__first) temp___477) (<= temp___477 (to_rep a_v1__last))) (=> (or (< k_1 temp___477) (or (< temp___477 (to_rep a_v1__first)) (<= i_v12 temp___477))) (= (select a_v11 temp___477) (select a_v1 temp___477))))) (=> (<= (to_rep a_v1__first) k_1) (dynamic_property1 (to_rep a_v1__first) k_1 i_v12))) (and (<= (to_rep a_v1__first) i_v12) (<= i_v12 k_1))))
(assert (<= (to_rep a_v1__first) m))
(assert (<= m (- i_v12 1)))
(assert (and (<= (to_rep (first (rt b_v1))) m) (<= m (to_rep (last (rt b_v1))))))
(assert (= o m))
(assert (= o1 (select (elts b_v1) o)))
(assert (= o2 (to_rep o1)))
(assert (not (<= (to_rep a_v1__first) m)))
(check-sat)
(exit)
