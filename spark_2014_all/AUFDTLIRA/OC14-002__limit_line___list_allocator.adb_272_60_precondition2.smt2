...
(assert (and (= o76 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (in_range4 o76)))
(assert (= result13 (ite (in_range7 o76) true false)))
(assert (=> (= result13 true) (and (= o72 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range3 o72))))
(assert (=> (= result13 true) (= result14 (ite (< j o72) true false))))
(assert (=> (= result13 true) (=> (= result14 true) (and (= o73 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result13 true) (=> (= result14 true) (and (= o74 (get (rec__list_allocator__m__t__allocated model____split_fields3) o73)) (in_range4 o74)))))
...
(assert (=> (= result13 true) (= o68 temp___462)))
...
(assert (=> (= result12 true) (=> (< 1 j) (and (= o66 (get (rec__list_allocator__m__t__allocated model____split_fields3) o65)) (in_range4 o66)))))
...
(assert (=> (= result12 true) (= o61 temp___463)))
