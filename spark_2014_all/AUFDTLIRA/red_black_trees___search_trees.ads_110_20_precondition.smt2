...
(assert (and (= o95 (int__content i18)) (in_range3 (int__content i18))))
(assert (type_invariant1 (mk___rep3 (us_split_fields__content3 t__split_fields14))))
(assert (and (= o96 (int__content i18)) (in_range3 (int__content i18))))
(assert (and (= o97 (position1 (mk___rep3 (us_split_fields__content3 t__split_fields14)) o96)) (and (in_range5 o97) (= o97 (position (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14)) o96)))))
(assert (and (= o91 (int__content i18)) (in_range3 (int__content i18))))
(assert (type_invariant1 (mk___rep3 (us_split_fields__content3 t__split_fields14))))
(assert (and (= o92 (int__content i18)) (in_range3 (int__content i18))))
(assert (and (= o93 (parent1 (mk___rep3 (us_split_fields__content3 t__split_fields14)) o92)) (and (in_range4 o93) (and (= o93 (parent (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14)) o92)) (=> (= (size1 (mk___rep3 (us_split_fields__content3 t__split_fields14))) 0) (= o93 0))))))
(assert (and (= o94 o93) (in_range3 o93)))
(assert (type_invariant1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3))))
(assert (and (= o102 (int__content i18)) (in_range3 (int__content i18))))
(assert (type_invariant1 (mk___rep3 (us_split_fields__content3 t__split_fields14))))
(assert (and (= o103 (int__content i18)) (in_range3 (int__content i18))))
(assert (and (= o104 (position1 (mk___rep3 (us_split_fields__content3 t__split_fields14)) o103)) (and (in_range5 o104) (= o104 (position (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14)) o103)))))
(assert (and (= o98 (int__content i18)) (in_range3 (int__content i18))))
(assert (type_invariant1 (mk___rep3 (us_split_fields__content3 t__split_fields14))))
(assert (and (= o99 (int__content i18)) (in_range3 (int__content i18))))
(assert (and (= o100 (parent1 (mk___rep3 (us_split_fields__content3 t__split_fields14)) o99)) (and (in_range4 o100) (and (= o100 (parent (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14)) o99)) (=> (= (size1 (mk___rep3 (us_split_fields__content3 t__split_fields14))) 0) (= o100 0))))))
(assert (and (= o101 o100) (in_range3 o100)))
