...
(assert (forall ((j1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 8) j1) (<= j1 index2)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1))))))
...
(assert (and (= o9 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
