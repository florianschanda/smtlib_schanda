...
(assert (and (= o52 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (= o53 (ite (<= o52 j) true false)))
(assert (= result6 (ite (= o53 true) (ite (<= j index3) true false) false)))
(assert (= result6 true))
(assert (and (<= (to_rep1 int_array__first) j) (<= j (to_rep1 int_array__last))))
(assert (= o54 j))
(assert (= o55 (select int_array1 o54)))
