...
(assert (=> (< l u) (=> (and (<= (+ l 1) i2) (<= i2 u)) (and (and (and (and (and (and (<= (+ l 1) i3) (<= i3 u)) (= l temp___213)) (= u temp___214)) (< l u)) (forall ((x Int)) (=> (and (<= l x) (<= x i3)) (<= (to_rep (select arr k3)) (to_rep (select arr x)))))) (and (<= l k3) (<= k3 u))))))
