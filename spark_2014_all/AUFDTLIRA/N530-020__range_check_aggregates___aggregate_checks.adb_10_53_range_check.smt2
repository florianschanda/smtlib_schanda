...
(define-fun dynamic_invariant1 ((temp___expr_175 us_rep) (temp___is_init_172 Bool) (temp___skip_constant_173 Bool) (temp___do_toplevel_174 Bool)) Bool (=> (or (= temp___is_init_172 true) (<= first2 last2)) (dynamic_property1 first2 last2 (to_rep (rec__aggregate_checks__do_wrong_aggregate__wrapper__content (us_split_fields1 temp___expr_175))))))
...
(define-fun dynamic_invariant5 ((temp___expr_169 Int) (temp___is_init_166 Bool) (temp___skip_constant_167 Bool) (temp___do_toplevel_168 Bool)) Bool (=> (or (= temp___is_init_166 true) (<= first2 last2)) (dynamic_property1 first2 last2 temp___expr_169)))
