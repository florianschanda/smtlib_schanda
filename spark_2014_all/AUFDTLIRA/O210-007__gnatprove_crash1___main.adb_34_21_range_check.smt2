...
(define-fun dynamic_invariant2 ((temp___expr_195 us_rep1) (temp___is_init_192 Bool) (temp___skip_constant_193 Bool) (temp___do_toplevel_194 Bool)) Bool (=> (not (= temp___skip_constant_193 true)) (in_range3 7 (to_base temp___expr_195))))
(define-fun default_initial_assumption ((temp___expr_198 us_rep1) (temp___skip_top_level_199 Bool)) Bool (= (to_rep (rec__main__branch_type__m_height (us_split_discrs2 temp___expr_198))) 7))
