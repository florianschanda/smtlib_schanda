...
(assert (and (=> (<= 1 256) (in_range4 result__2)) (and (< result__2 128) (not (= (to_rep (select domainnameversion result__2)) 46)))))
(assert (and (= o6 (+ result__2 1)) (in_range4 (+ result__2 1))))
