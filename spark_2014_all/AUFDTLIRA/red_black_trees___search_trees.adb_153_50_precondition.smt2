...
(assert (<= 1 i3))
(assert (<= i3 100))
(assert (and (= temp___1487 (model__ f root)) (and (dynamic_invariant5 temp___1487 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1487 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1487 root)))) 0) (and (forall ((i34 Int)) (=> (and (<= 1 i34) (<= i34 100)) (=> (not (= i34 root)) (ite (and (not (= (parent f i34) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1487 (parent f i34)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1487 i34))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1487 i34))) true)))))) (and (forall ((i34 Int)) (=> (and (<= 1 i34) (<= i34 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1487 i34))) true) (not (= i34 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1487 (parent f i34)))) (position f i34) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1487 i34)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1487 i34)))) 0)))) (forall ((i34 Int)) (=> (and (<= 1 i34) (<= i34 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1487 i34))) true) (forall ((j52 Int)) (=> (and (<= 1 j52) (<= j52 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1487 j52))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1487 i34))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1487 j52)))) true)) (= j52 i34))))))))))))))
(assert (= (mk___rep (mk___split_fields o19 o20)) (select temp___1487 i3)))
(assert (= o19 o21))
(assert (= o20 o22))
(assert (= result14 o22))
(assert (= result14 true))
(assert (and (= temp___1486 (model__ f_old root)) (and (dynamic_invariant5 temp___1486 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1486 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1486 root)))) 0) (and (forall ((i34 Int)) (=> (and (<= 1 i34) (<= i34 100)) (=> (not (= i34 root)) (ite (and (not (= (parent f_old i34) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1486 (parent f_old i34)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1486 i34))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1486 i34))) true)))))) (and (forall ((i34 Int)) (=> (and (<= 1 i34) (<= i34 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1486 i34))) true) (not (= i34 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1486 (parent f_old i34)))) (position f_old i34) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1486 i34)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1486 i34)))) 0)))) (forall ((i34 Int)) (=> (and (<= 1 i34) (<= i34 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1486 i34))) true) (forall ((j52 Int)) (=> (and (<= 1 j52) (<= j52 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1486 j52))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1486 i34))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1486 j52)))) true)) (= j52 i34))))))))))))))
(assert (= (mk___rep (mk___split_fields o23 o24)) (select temp___1486 i3)))
(assert (= o25 (mk___split_fields o23 o24)))
