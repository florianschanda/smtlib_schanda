...
(assert (=> (not (= first_available 0)) (and (= o2 (length model____split_fields)) (in_range3 o2))))
(assert (=> (not (= first_available 0)) (= result1 (ite (< 0 o2) true false))))
(assert (=> (not (= first_available 0)) (=> (= result1 true) (and (= o1 (get model____split_fields 1)) (in_range4 o1)))))
...
(assert (=> (not (not (= first_available 0))) (and (= o3 (length model____split_fields)) (in_range3 o3))))
...
(assert (= result2 true))
(assert (not (<= 1 (length model____split_fields1))))
(check-sat)
(exit)
