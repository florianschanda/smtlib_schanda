...
(assert (=> (<= (to_rep1 (first2 temp___10471)) (to_rep1 (last2 temp___10471))) (= o (+ (- (to_rep1 (last2 temp___10471)) (to_rep1 (first2 temp___10471))) 1))))
(assert (=> (not (<= (to_rep1 (first2 temp___10471)) (to_rep1 (last2 temp___10471)))) (= o 0)))
(assert (=> (<= (to_rep1 (first2 (rt1 left))) (to_rep1 (last2 (rt1 left)))) (= o1 (+ (- (to_rep1 (last2 (rt1 left))) (to_rep1 (first2 (rt1 left)))) 1))))
(assert (=> (not (<= (to_rep1 (first2 (rt1 left))) (to_rep1 (last2 (rt1 left))))) (= o1 0)))
(assert (= o2 (+ o1 o)))
(assert (= o3 (+ (to_rep1 (first2 (rt1 left))) o2)))
(assert (= o4 (- o3 1)))
