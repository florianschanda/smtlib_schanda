...
(assert (=> (<= (to_rep1 (first2 temp___9841)) (to_rep1 (last2 temp___9841))) (= o4 (+ (- (to_rep1 (last2 temp___9841)) (to_rep1 (first2 temp___9841))) 1))))
(assert (=> (not (<= (to_rep1 (first2 temp___9841)) (to_rep1 (last2 temp___9841)))) (= o4 0)))
(assert (=> (<= (to_rep1 (first2 (rt1 left))) (to_rep1 (last2 (rt1 left)))) (= o5 (+ (- (to_rep1 (last2 (rt1 left))) (to_rep1 (first2 (rt1 left)))) 1))))
(assert (=> (not (<= (to_rep1 (first2 (rt1 left))) (to_rep1 (last2 (rt1 left))))) (= o5 0)))
(assert (= o6 (+ o5 o4)))
(assert (= o7 (+ (to_rep1 (first2 (rt1 left))) o6)))
(assert (= o8 (- o7 1)))
