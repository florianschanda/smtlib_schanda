...
(assert (<= 1 i1))
(assert (<= i1 100))
(assert (and (= temp___866 (model__ (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) y1)) (and (dynamic_invariant6 temp___866 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___866 y1))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___866 y1)))) 0) (and (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (not (= i5 y1)) (ite (and (not (= (parent (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) i5) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___866 (parent (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) i5)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___866 i5))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___866 i5))) true)))))) (and (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___866 i5))) true) (not (= i5 y1))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___866 (parent (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) i5)))) (position (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) i5) (rec__tree_model__path_type__a (us_split_fields1 (select temp___866 i5)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___866 i5)))) 0)))) (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___866 i5))) true) (forall ((j15 Int)) (=> (and (<= 1 j15) (<= j15 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___866 j15))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___866 i5))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___866 j15)))) true)) (= j15 i5))))))))))))))
(assert (= o59 (select temp___866 i1)))
(assert (= o60 (us_split_fields1 o59)))
(assert (= result28 (rec__tree_model__path_type__k o60)))
