...
(assert (and (and (= (= (select o6 i2) true) (= (select a j2) true)) (= (= (select o6 j2) true) (= (select a i2) true))) (forall ((k Int)) (=> (and (<= (to_rep a__first) k) (<= k (to_rep a__last))) (=> (and (not (= k i2)) (not (= k j2))) (= (= (select o6 k) true) (= (select a k) true)))))))
