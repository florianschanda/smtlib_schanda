...
(declare-fun temp___200 (Int Int Int) us_t1)
...
(assert (forall ((temp___202 Int) (temp___203 Int) (temp___204 Int)) (let ((temp___201 (temp___200 temp___202 temp___203 temp___204))) (=> (dynamic_invariant1 temp___202 true true true true) (and (=> (dynamic_property (- 2147483648) 2147483647 temp___203 temp___204) (and (= (first3 temp___201) temp___203) (= (last3 temp___201) temp___204))) (forall ((temp___205 Int)) (= (to_rep1 (select (to_array1 temp___201) temp___205)) temp___202)))))))
...
(assert (= (to_rep (first2 (rt1 (temp___200 0 (to_rep x__first) (to_rep x__last))))) (to_rep x__first)))
(assert (= (to_rep (last2 (rt1 (temp___200 0 (to_rep x__first) (to_rep x__last))))) (to_rep x__last)))
(assert (= (mk___t1 temp___207 temp___2071) (temp___200 0 (to_rep x__first) (to_rep x__last))))
(assert (= temp___207 temp___208))
(assert (= (mk (to_rep (first2 temp___2071)) (to_rep (last2 temp___2071))) temp___2081))
(assert (not (= (ite (<= (to_rep (first temp___2081)) (to_rep (last temp___2081))) (+ (- (to_rep (last temp___2081)) (to_rep (first temp___2081))) 1) 0) (ite (<= (to_rep x__first) (to_rep x__last)) (+ (- (to_rep x__last) (to_rep x__first)) 1) 0))))
(check-sat)
(exit)
