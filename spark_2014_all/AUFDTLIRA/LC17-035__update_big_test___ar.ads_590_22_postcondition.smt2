...
(define-fun dynamic_invariant3 ((temp___expr_170 Int) (temp___is_init_167 Bool) (temp___skip_constant_168 Bool) (temp___do_toplevel_169 Bool)) Bool (=> (or (= temp___is_init_167 true) (<= 90 99)) (in_range4 temp___expr_170)))
(declare-sort et1 0)
...
(assert (<= 90 m))
(assert (<= m 99))
(assert (not (in_range5 (to_rep (select (select (select (select a3 m) n) o10) p)))))
(check-sat)
(exit)
