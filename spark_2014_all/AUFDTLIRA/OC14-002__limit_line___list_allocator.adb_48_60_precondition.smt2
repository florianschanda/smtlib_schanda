...
(assert (=> (not (= first_available 0)) (and (= o32 (length model____split_fields)) (in_range6 o32))))
(assert (=> (not (= first_available 0)) (= result2 (ite (< 0 o32) true false))))
(assert (=> (not (= first_available 0)) (=> (= result2 true) (and (= o31 (get model____split_fields 1)) (in_range7 o31)))))
...
(assert (=> (not (not (= first_available 0))) (and (= o33 (length model____split_fields)) (in_range6 o33))))
(assert (=> (not (not (= first_available 0))) (= result1 (ite (= o33 0) true false))))
(assert (=> (= result1 true) (=> (not (= first_allocated 0)) (and (= o29 (length model____split_fields1)) (in_range6 o29)))))
(assert (=> (= result1 true) (=> (not (= first_allocated 0)) (= result3 (ite (< 0 o29) true false)))))
(assert (=> (= result1 true) (=> (not (= first_allocated 0)) (=> (= result3 true) (and (= o28 (get model____split_fields1 1)) (in_range7 o28))))))
...
(assert (=> (= result1 true) (=> (not (not (= first_allocated 0))) (and (= o30 (length model____split_fields1)) (in_range6 o30)))))
...
(assert (=> (= result7 true) (and (= o23 (length model____split_fields)) (in_range6 o23))))
(assert (=> (= result7 true) (= result8 (ite (< j o23) true false))))
(assert (=> (= result7 true) (=> (= result8 true) (and (= o24 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result7 true) (=> (= result8 true) (and (= o25 (get model____split_fields o24)) (in_range7 o25)))))
...
(assert (=> (= result6 true) (=> (< 1 j) (and (= o13 (get model____split_fields o12)) (in_range7 o13)))))
