...
(assert (<= 1 n1))
(assert (<= n1 100))
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f root) i))) true) (forall ((d Int)) (=> (and (<= 0 d) (<= d 1)) (=> (= (peek f i d) 0) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f root) j))) true) (= (olt (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) i))) (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) j)))) true)) (<= (length (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) j)))) (+ (length (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) i)))) n2))) (not (= (get (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) j))) (+ (length (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) i)))) 1)) d))))))))))))
...
(assert (<= (length (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) j)))) (+ (length (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) i)))) n3)))
