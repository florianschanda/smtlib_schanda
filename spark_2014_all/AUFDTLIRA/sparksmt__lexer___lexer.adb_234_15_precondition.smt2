...
(define-fun dynamic_invariant3 ((temp___expr_651 Int) (temp___is_init_648 Bool) (temp___skip_constant_649 Bool) (temp___do_toplevel_650 Bool)) Bool (=> (or (= temp___is_init_648 true) (<= 0 2147483647)) (in_range4 temp___expr_651)))
...
(assert (forall ((n Int)) (forall ((names__name_table us_private)) (! (=> (and (dynamic_invariant3 n true true true) (= (invariant__ names__name_table) true)) (dynamic_invariant2 (to_string1 n names__name_table) true false true)) :pattern ((to_string1 n names__name_table))))))
...
(define-fun dynamic_invariant4 ((temp___expr_714 Int) (temp___is_init_711 Bool) (temp___skip_constant_712 Bool) (temp___do_toplevel_713 Bool)) Bool (=> (or (= temp___is_init_711 true) (<= 0 1)) (in_range5 temp___expr_714)))
...
(assert (forall ((us_void_param tuple0)) (! (= (to_rep (select (temp___String_Literal_941 us_void_param) 1)) 58) :pattern ((temp___String_Literal_941 us_void_param)))))
(declare-fun temp___String_Literal_942 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (= (to_rep (select (temp___String_Literal_942 us_void_param) 1)) 58) :pattern ((temp___String_Literal_942 us_void_param)))))
(declare-fun temp___String_Literal_943 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_943 us_void_param) 1)) 58) (= (to_rep (select (temp___String_Literal_943 us_void_param) 2)) 32)) :pattern ((temp___String_Literal_943 us_void_param)))))
