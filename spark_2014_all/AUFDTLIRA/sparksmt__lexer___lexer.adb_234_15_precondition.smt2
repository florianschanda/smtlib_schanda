...
(define-fun dynamic_invariant3 ((temp___expr_645 Int) (temp___is_init_642 Bool) (temp___skip_constant_643 Bool) (temp___do_toplevel_644 Bool)) Bool (=> (or (= temp___is_init_642 true) (<= 0 2147483647)) (in_range4 temp___expr_645)))
...
(define-fun dynamic_invariant4 ((temp___expr_706 Int) (temp___is_init_703 Bool) (temp___skip_constant_704 Bool) (temp___do_toplevel_705 Bool)) Bool (=> (or (= temp___is_init_703 true) (<= 0 1)) (in_range5 temp___expr_706)))
...
(assert (forall ((us_void_param tuple0)) (! (= (to_rep (select (temp___String_Literal_931 us_void_param) 1)) 58) :pattern ((temp___String_Literal_931 us_void_param)))))
(declare-fun temp___String_Literal_932 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (= (to_rep (select (temp___String_Literal_932 us_void_param) 1)) 58) :pattern ((temp___String_Literal_932 us_void_param)))))
(declare-fun temp___String_Literal_933 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_933 us_void_param) 1)) 58) (= (to_rep (select (temp___String_Literal_933 us_void_param) 2)) 32)) :pattern ((temp___String_Literal_933 us_void_param)))))
