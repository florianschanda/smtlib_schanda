...
(assert (and (and (= (length source) 10) (and (and (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 50) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 49)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 3))) 55)) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 4))) 52))) (forall ((index4 Int)) (=> (and (<= (to_rep1 (first (rt source))) index4) (<= index4 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index4))) true)))))
...
(assert (and (and (forall ((temp___1496 Int)) (=> (and (<= (to_rep1 n__first) temp___1496) (<= temp___1496 (to_rep1 n__last))) (=> (< index2 temp___1496) (= (select n3 temp___1496) (select n1 temp___1496))))) (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (dynamic_property9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) index2))) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (+ (to_rep1 (first (rt source))) 9)))))
(assert (not (= index2 temp___1499)))
