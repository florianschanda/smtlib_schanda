...
(assert (and (and (forall ((temp___1394 Int)) (=> (and (<= (to_rep1 n__first) temp___1394) (<= temp___1394 (to_rep1 n__last))) (=> (< index3 temp___1394) (= (select n3 temp___1394) (select n1 temp___1394))))) (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (dynamic_property9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) index3))) (and (<= (to_rep1 (first (rt source))) index3) (<= index3 (+ (to_rep1 (first (rt source))) 9)))))
(assert (not (= index3 temp___1397)))
