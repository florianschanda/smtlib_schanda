...
(assert (not (= (ite (<= (to_rep1 (first2 a__split_fields3)) (to_rep1 (last2 a__split_fields3))) (+ (- (to_rep1 (last2 a__split_fields3)) (to_rep1 (first2 a__split_fields3))) 1) 0) (ite (<= 1 r22b) (+ (- r22b 1) 1) 0))))
(check-sat)
(exit)
