...
(assert (not (= (ite (<= (to_rep1 (first a__split_fields3)) (to_rep1 (last a__split_fields3))) (+ (- (to_rep1 (last a__split_fields3)) (to_rep1 (first a__split_fields3))) 1) 0) (ite (<= 1 r22b) (+ (- r22b 1) 1) 0))))
(check-sat)
(exit)
