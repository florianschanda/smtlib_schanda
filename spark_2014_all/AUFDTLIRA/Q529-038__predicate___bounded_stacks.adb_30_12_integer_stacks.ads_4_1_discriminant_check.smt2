...
(assert (= us_tag1 o7))
(assert (= (mk___rep (mk___split_discrs temp___305) (mk___split_fields (mk___t temp___3051 temp___3052) temp___3053 temp___3054) temp___3055) (to_base (mk___rep1 (mk___split_discrs o2) (mk___split_fields1 (mk___t1 o3 o4) o5 o6) o7))))
(assert (not (= temp___305 (rec__integer_stacks__stack__capacity this__split_discrs))))
(check-sat)
(exit)
