...
(assert (= (mk___rep (mk___split_discrs temp___277) (mk___split_fields (mk___t temp___2771 temp___2772) temp___2773 temp___2774) temp___2775) (to_base o13)))
(assert (not (= temp___277 (rec__integer_stacks__stack__capacity this__split_discrs))))
(check-sat)
(exit)
