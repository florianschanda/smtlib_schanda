...
(assert (and (= (mk___t temp___217 temp___2171) (remove (mk___t values2 (mk 1 100)) o15)) (and (dynamic_invariant4 (mk___t temp___217 temp___2171) true false true) (and (= (invariant__ (mk___t temp___217 temp___2171)) true) (and (= (to_rep1 (last temp___2171)) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o15 1))) (= (to_rep (select values2 k)) (to_rep (select temp___217 k))))) (and (forall ((k Int)) (=> (and (<= (+ o15 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select temp___217 (- k 1)))))) (forall ((k Int)) (=> (and (<= o15 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select temp___217 k))))))))))))
