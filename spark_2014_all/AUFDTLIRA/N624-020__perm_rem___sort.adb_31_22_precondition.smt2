...
(define-fun temp___2172 () us_t (mk___t temp___217 temp___2171))
(assert (in_range3 x))
(assert (in_range3 y))
...
(assert (and (= temp___2172 (remove (mk___t values2 (mk 1 100)) o13)) (and (dynamic_invariant4 temp___2172 true false true) (and (= (invariant__ temp___2172) true) (and (= (to_rep1 (last temp___2171)) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o13 1))) (= (to_rep (select values2 k)) (to_rep (select temp___217 k))))) (and (forall ((k Int)) (=> (and (<= (+ o13 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select temp___217 (- k 1)))))) (forall ((k Int)) (=> (and (<= o13 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select temp___217 k))))))))))))
