...
(assert (not (= (let ((temp___252 (remove (remove (mk___t values2 (mk 1 100)) y) (- x 1)))) (let ((temp___251 (remove (remove (mk___t interm1 (mk 1 100)) x) y))) (bool_eq (elts temp___251) (to_rep1 (first (rt temp___251))) (to_rep1 (last (rt temp___251))) (elts temp___252) (to_rep1 (first (rt temp___252))) (to_rep1 (last (rt temp___252)))))) true)))
(check-sat)
(exit)
