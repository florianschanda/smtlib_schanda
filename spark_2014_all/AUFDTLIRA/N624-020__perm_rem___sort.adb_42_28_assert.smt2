...
(assert (not (= (let ((temp___278 (remove (remove (mk___t values2 (mk 1 100)) y) (- x 1)))) (let ((temp___277 (remove (remove (mk___t interm1 (mk 1 100)) x) y))) (bool_eq (elts temp___277) (to_rep1 (first (rt temp___277))) (to_rep1 (last (rt temp___277))) (elts temp___278) (to_rep1 (first (rt temp___278))) (to_rep1 (last (rt temp___278)))))) true)))
(check-sat)
(exit)
