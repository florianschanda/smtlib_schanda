...
(assert (and (= o54 (length needle)) (in_range1 (length needle))))
(assert (= o55 (+ i2 o54)))
(assert (and (= temp___310 o55) (in_range1 o55)))
(assert (and (<= (to_rep2 (first (rt haystack))) temp___310) (<= temp___310 (to_rep2 (last (rt haystack))))))
(assert (= o56 temp___310))
(assert (= o57 (select (elts haystack) o56)))
(assert (= o58 (to_rep1 o57)))
(assert (= o59 (select bad_shift o58)))
(assert (= o60 (to_rep o59)))
(assert (= o61 (+ i2 o60)))
(assert (not (in_range1 o61)))
(check-sat)
(exit)
