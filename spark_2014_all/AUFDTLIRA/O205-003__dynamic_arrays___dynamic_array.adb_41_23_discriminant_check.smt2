...
(assert (= result2 true))
(assert (and (= o21 (new_holder c)) (and (dynamic_invariant2 o21 true false true) (ite (= c 0) (= (to_rep (rec__dynamic_array__holder__d (us_split_discrs3 o21))) 0) (= (to_rep (rec__dynamic_array__holder__d (us_split_discrs3 o21))) c)))))
(assert (= o22 (us_split_fields3 o21)))
(assert (= temp___218 (rec__dynamic_array__holder__content o22)))
(assert (and (<= (to_rep1 (first (rt temp___218))) j) (<= j (to_rep1 (last1 (rt temp___218))))))
(assert (= o23 j))
(assert (= o24 (select (elts temp___218) o23)))
...
(assert (not (= (to_int1 (rec__dynamic_array__rec__b (us_split_discrs1 o20))) 1)))
(check-sat)
(exit)
