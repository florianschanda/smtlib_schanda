...
(assert (= result2 true))
(assert (and (= o21 (new_holder c)) (and (dynamic_invariant2 o21 true false true true) (ite (= c 0) (= (to_rep (rec__dynamic_array__holder__d (us_split_discrs3 o21))) 0) (= (to_rep (rec__dynamic_array__holder__d (us_split_discrs3 o21))) c)))))
(assert (= o22 (us_split_fields3 o21)))
(assert (= temp___245 (rec__dynamic_array__holder__content o22)))
(assert (and (<= (to_rep1 (first (rt temp___245))) j) (<= j (to_rep1 (last1 (rt temp___245))))))
(assert (= o23 j))
(assert (= o24 (select (elts temp___245) o23)))
