...
(assert (=> (not (= first_available 0)) (and (= o19 (length model____split_fields)) (in_range6 o19))))
(assert (=> (not (= first_available 0)) (= result2 (ite (< 0 o19) true false))))
(assert (=> (not (= first_available 0)) (=> (= result2 true) (and (= o18 (get model____split_fields 1)) (in_range7 o18)))))
...
(assert (=> (not (not (= first_available 0))) (and (= o20 (length model____split_fields)) (in_range6 o20))))
(assert (=> (not (not (= first_available 0))) (= result1 (ite (= o20 0) true false))))
(assert (=> (= result1 true) (=> (not (= first_allocated 0)) (and (= o16 (length model____split_fields1)) (in_range6 o16)))))
(assert (=> (= result1 true) (=> (not (= first_allocated 0)) (= result3 (ite (< 0 o16) true false)))))
(assert (=> (= result1 true) (=> (not (= first_allocated 0)) (=> (= result3 true) (and (= o15 (get model____split_fields1 1)) (in_range7 o15))))))
...
(assert (=> (= result1 true) (=> (not (not (= first_allocated 0))) (and (= o17 (length model____split_fields1)) (in_range6 o17)))))
...
(assert (=> (= result6 true) (and (= o10 (length model____split_fields)) (in_range6 o10))))
(assert (=> (= result6 true) (= result7 (ite (< j o10) true false))))
(assert (=> (= result6 true) (=> (= result7 true) (and (= o11 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result6 true) (=> (= result7 true) (and (= o12 (get model____split_fields o11)) (in_range7 o12)))))
