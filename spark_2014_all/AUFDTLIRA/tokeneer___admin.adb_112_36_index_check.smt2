...
(define-fun dynamic_invariant ((temp___expr_377 Int) (temp___is_init_374 Bool) (temp___skip_constant_375 Bool) (temp___do_toplevel_376 Bool)) Bool (=> (or (= temp___is_init_374 true) (<= 0 4)) (in_range5 temp___expr_377)))
(declare-sort opt 0)
...
(define-fun dynamic_invariant1 ((temp___expr_383 Int) (temp___is_init_380 Bool) (temp___skip_constant_381 Bool) (temp___do_toplevel_382 Bool)) Bool (=> (or (= temp___is_init_380 true) (<= 1 4)) (in_range6 temp___expr_383)))
...
(assert true)
(assert (forall ((theadmin us_rep1)) (forall ((op Int)) (! (= (= (allowedop theadmin op) true) (= (let ((temp___401 (select isavailable (to_rep (rec__admin__t__rolepresent (us_split_fields3 theadmin)))))) (select temp___401 op)) true)) :pattern ((allowedop theadmin op))))))
...
(define-fun dynamic_invariant3 ((temp___expr_428 Int) (temp___is_init_425 Bool) (temp___skip_constant_426 Bool) (temp___do_toplevel_427 Bool)) Bool (=> (or (= temp___is_init_425 true) (<= 0 18)) (in_range7 temp___expr_428)))
(define-fun dynamic_invariant4 ((temp___expr_434 Int) (temp___is_init_431 Bool) (temp___skip_constant_432 Bool) (temp___do_toplevel_433 Bool)) Bool (=> (or (= temp___is_init_431 true) (<= 1 18)) (in_range8 temp___expr_434)))
...
(define-fun dynamic_invariant5 ((temp___expr_170 Int) (temp___is_init_167 Bool) (temp___skip_constant_168 Bool) (temp___do_toplevel_169 Bool)) Bool (=> (or (= temp___is_init_167 true) (<= 0 3)) (in_range1 temp___expr_170)))
(define-fun dynamic_invariant6 ((temp___expr_176 Int) (temp___is_init_173 Bool) (temp___skip_constant_174 Bool) (temp___do_toplevel_175 Bool)) Bool (=> (or (= temp___is_init_173 true) (<= 1 3)) (in_range2 temp___expr_176)))
(define-fun dynamic_invariant7 ((temp___expr_344 Int) (temp___is_init_341 Bool) (temp___skip_constant_342 Bool) (temp___do_toplevel_343 Bool)) Bool (=> (or (= temp___is_init_341 true) (<= 0 78)) (in_range3 temp___expr_344)))
...
(declare-const o Int)
(declare-const temp___485 (Array Int Bool))
...
(assert (<= op3 4))
(assert (= theop2 0))
(assert (and (and (=> (<= 0 4) (in_range5 theop2)) (=> (<= 1 4) (in_range6 op4))) (and (<= 1 op4) (<= op4 4))))
(assert (and (= result2 (str_comp keyedop op4)) (= (= result2 true) (and (and (<= (to_rep5 (rec__admin__datat__minmatchlength (us_split_fields5 (select optokeyed op4)))) (to_rep1 (rec__keyboard__datat__length (us_split_fields1 keyedop)))) (<= (to_rep1 (rec__keyboard__datat__length (us_split_fields1 keyedop))) (to_rep4 (rec__admin__datat__length (us_split_fields5 (select optokeyed op4)))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (to_rep1 (rec__keyboard__datat__length (us_split_fields1 keyedop))))) (= (to_rep2 (select (rec__admin__datat__text (us_split_fields5 (select optokeyed op4))) i)) (to_rep2 (select (rec__keyboard__datat__text (us_split_fields1 keyedop)) i)))))))))
(assert (= result2 true))
(assert (not (<= 1 (to_rep (rec__admin__t__rolepresent (us_split_fields3 theadmin))))))
(check-sat)
(exit)
