...
(assert (not (= (let ((temp___227 (remove (remove (mk___t values2 (mk 1 100)) y) x))) (let ((temp___226 (remove (remove (mk___t interm1 (mk 1 100)) x) (- y 1)))) (bool_eq (elts temp___226) (to_rep1 (first (rt temp___226))) (to_rep1 (last (rt temp___226))) (elts temp___227) (to_rep1 (first (rt temp___227))) (to_rep1 (last (rt temp___227)))))) true)))
(check-sat)
(exit)
