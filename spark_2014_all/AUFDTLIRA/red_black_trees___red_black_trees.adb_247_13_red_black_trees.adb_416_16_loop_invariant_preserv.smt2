...
(assert (=> (= result14 true) (= (rec__red_black_trees__black_count__status (us_split_fields11 (select (nb_blacks c76b) c77b))) true)))
(assert (=> (= result14 true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (nb_blacks c76b) c77b)))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (nb_blacks c75b) c77b)))))))
(assert (not (= n6 100)))
...
(assert (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c75b) i)))) (int__content n8)))
