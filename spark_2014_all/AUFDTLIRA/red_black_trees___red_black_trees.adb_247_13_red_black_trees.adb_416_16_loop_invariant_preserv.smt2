...
(assert (=> (= result31 true) (= (rec__red_black_trees__black_count__status (us_split_fields11 (select (nb_blacks c76b) c77b))) true)))
(assert (=> (= result31 true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (nb_blacks c76b) c77b)))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (nb_blacks c75b) c77b)))))))
(assert (not (= n51 100)))
(assert (= result32 (mk_int__ref n51)))
(assert (= n52 (+ n51 1)))
(assert (= n53 (mk_int__ref n52)))
(assert (= n54 n52))
...
(assert (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c75b) i14)))) (int__content n53)))
