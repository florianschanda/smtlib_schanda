...
(assert (= (to_rep3 o26) n1))
(assert (= (to_rep o27) t_length))
(assert (= (to_rep o28) first_col))
(assert (= (to_rep o29) first_line))
(assert (= o30 (mk___split_fields o29 o28 o27 o26)))
(assert (= (to_rep4 o25) 6))
(assert (= o31 (mk___split_discrs o25)))
(assert (= temp___950 (mk___rep o31 o30 true)))
(assert (= t__attr__constrained true))
(assert (not (= (rec__lexer__token__kind (us_split_discrs1 temp___950)) t__split_discrs)))
(check-sat)
(exit)
