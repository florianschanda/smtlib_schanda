...
(assert (not (= (length (mk___t temp___1704 temp___17041)) 0)))
(assert (=> (<= (to_rep1 (first4 temp___17051)) (to_rep1 (last4 temp___17051))) (= o12 (+ (- (to_rep1 (last4 temp___17051)) (to_rep1 (first4 temp___17051))) 1))))
(assert (=> (not (<= (to_rep1 (first4 temp___17051)) (to_rep1 (last4 temp___17051)))) (= o12 0)))
(assert (=> (<= (to_rep1 (first temp___17041)) (to_rep1 (last temp___17041))) (= o13 (+ (- (to_rep1 (last temp___17041)) (to_rep1 (first temp___17041))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___17041)) (to_rep1 (last temp___17041)))) (= o13 0)))
(assert (= o14 (+ o13 o12)))
(assert (= o15 (+ (to_rep1 (first temp___17041)) o14)))
(assert (= o16 (- o15 1)))
