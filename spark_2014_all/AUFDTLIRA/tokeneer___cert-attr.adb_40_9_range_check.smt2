...
(assert (not (= (length (mk___t temp___1541 temp___15411)) 0)))
(assert (=> (<= (to_rep1 (first4 temp___15421)) (to_rep1 (last4 temp___15421))) (= o12 (+ (- (to_rep1 (last4 temp___15421)) (to_rep1 (first4 temp___15421))) 1))))
(assert (=> (not (<= (to_rep1 (first4 temp___15421)) (to_rep1 (last4 temp___15421)))) (= o12 0)))
(assert (=> (<= (to_rep1 (first temp___15411)) (to_rep1 (last temp___15411))) (= o13 (+ (- (to_rep1 (last temp___15411)) (to_rep1 (first temp___15411))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___15411)) (to_rep1 (last temp___15411)))) (= o13 0)))
(assert (= o14 (+ o13 o12)))
(assert (= o15 (+ (to_rep1 (first temp___15411)) o14)))
(assert (= o16 (- o15 1)))
