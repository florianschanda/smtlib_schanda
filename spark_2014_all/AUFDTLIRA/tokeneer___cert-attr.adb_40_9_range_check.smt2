...
(assert (not (= (length (mk___t temp___1485 temp___14851)) 0)))
(assert (=> (<= (to_rep1 (first2 temp___14861)) (to_rep1 (last2 temp___14861))) (= o12 (+ (- (to_rep1 (last2 temp___14861)) (to_rep1 (first2 temp___14861))) 1))))
(assert (=> (not (<= (to_rep1 (first2 temp___14861)) (to_rep1 (last2 temp___14861)))) (= o12 0)))
(assert (=> (<= (to_rep1 (first temp___14851)) (to_rep1 (last temp___14851))) (= o13 (+ (- (to_rep1 (last temp___14851)) (to_rep1 (first temp___14851))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___14851)) (to_rep1 (last temp___14851)))) (= o13 0)))
(assert (= o14 (+ o13 o12)))
(assert (= o15 (+ (to_rep1 (first temp___14851)) o14)))
(assert (= o16 (- o15 1)))
