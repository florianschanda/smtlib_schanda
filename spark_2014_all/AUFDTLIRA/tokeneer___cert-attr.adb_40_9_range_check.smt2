...
(assert (=> (= (length (mk___t temp___1032 temp___10321)) 0) (= (temp___String_Literal_1031 Tuple0) temp___1034)))
(assert (=> (= (length (mk___t temp___1032 temp___10321)) 0) (= (mk 1 12) temp___10341)))
(assert (=> (not (= (length (mk___t temp___1032 temp___10321)) 0)) (=> (<= 1 12) (= o6 (+ (- 12 1) 1)))))
(assert (=> (not (= (length (mk___t temp___1032 temp___10321)) 0)) (=> (not (<= 1 12)) (= o6 0))))
(assert (=> (not (= (length (mk___t temp___1032 temp___10321)) 0)) (=> (<= (to_rep1 (first temp___10321)) (to_rep1 (last temp___10321))) (= o7 (+ (- (to_rep1 (last temp___10321)) (to_rep1 (first temp___10321))) 1)))))
(assert (=> (not (= (length (mk___t temp___1032 temp___10321)) 0)) (=> (not (<= (to_rep1 (first temp___10321)) (to_rep1 (last temp___10321)))) (= o7 0))))
(assert (=> (not (= (length (mk___t temp___1032 temp___10321)) 0)) (= o8 (+ o7 o6))))
(assert (=> (not (= (length (mk___t temp___1032 temp___10321)) 0)) (= o9 (+ (to_rep1 (first temp___10321)) o8))))
(assert (=> (not (= (length (mk___t temp___1032 temp___10321)) 0)) (= o10 (- o9 1))))
(assert (=> (not (= (length (mk___t temp___1032 temp___10321)) 0)) (and (= o11 o10) (in_range1 o10))))
(assert (=> (not (= (length (mk___t temp___1032 temp___10321)) 0)) (= (concat1 temp___1032 (to_rep1 (first temp___10321)) (to_rep1 (last temp___10321)) (temp___String_Literal_1031 Tuple0) 1 12) temp___1034)))
(assert (=> (not (= (length (mk___t temp___1032 temp___10321)) 0)) (= (mk (to_rep1 (first temp___10321)) o11) temp___10341)))
(assert (not (= (length (mk___t temp___1034 temp___10341)) 0)))
(assert (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE6 (to_rep4 (rec__certtypes__idt__serialnumber (us_split_fields3 (rec__cert__attr__contentst__basecertid (us_split_fields7 contents)))))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE6 (to_rep4 (rec__certtypes__idt__serialnumber (us_split_fields3 (rec__cert__attr__contentst__basecertid (us_split_fields7 contents))))))))))) (= o12 (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE6 (to_rep4 (rec__certtypes__idt__serialnumber (us_split_fields3 (rec__cert__attr__contentst__basecertid (us_split_fields7 contents)))))))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE6 (to_rep4 (rec__certtypes__idt__serialnumber (us_split_fields3 (rec__cert__attr__contentst__basecertid (us_split_fields7 contents))))))))))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE6 (to_rep4 (rec__certtypes__idt__serialnumber (us_split_fields3 (rec__cert__attr__contentst__basecertid (us_split_fields7 contents)))))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE6 (to_rep4 (rec__certtypes__idt__serialnumber (us_split_fields3 (rec__cert__attr__contentst__basecertid (us_split_fields7 contents)))))))))))) (= o12 0)))
(assert (=> (<= (to_rep1 (first temp___10341)) (to_rep1 (last temp___10341))) (= o13 (+ (- (to_rep1 (last temp___10341)) (to_rep1 (first temp___10341))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___10341)) (to_rep1 (last temp___10341)))) (= o13 0)))
(assert (= o14 (+ o13 o12)))
