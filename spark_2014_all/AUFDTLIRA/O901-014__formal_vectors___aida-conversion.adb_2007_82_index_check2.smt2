...
(assert (= n1 result3))
(assert (= n2 o8))
(assert (forall ((i1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) i1) (<= i1 index2)) (and (<= 0 (to_rep1 (select n3 i1))) (<= (to_rep1 (select n3 i1)) 9)))))
...
(assert (= o11 i))
(assert (= o12 (select n3 o11)))
(assert (= o13 (to_rep1 o12)))
(assert (= o14 (ite (<= o13 9) true false)))
