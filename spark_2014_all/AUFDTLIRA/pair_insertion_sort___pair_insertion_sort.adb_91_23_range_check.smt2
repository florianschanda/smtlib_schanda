...
(define-fun a11 () map__ref (mk_map__ref a6))
...
(assert (=> (not (= result11 true)) (= a9 a11)))
...
(assert (and (= o33 (int__content j6)) (in_range2 (int__content j6))))
