...
(assert (= b__split_discrs (mk___split_discrs temp___230)))
(assert (not (= (ite (<= (to_rep1 (first (rt initializer))) (to_rep1 (last (rt initializer)))) (+ (- (to_rep1 (last (rt initializer))) (to_rep1 (first (rt initializer)))) 1) 0) (ite (<= 1 (length initializer)) (+ (- (length initializer) 1) 1) 0))))
(check-sat)
(exit)
