...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep (rec__main__branch_type__m_height (us_split_discrs1 a))) (to_rep (rec__main__branch_type__m_height (us_split_discrs1 b)))) (= (bool_eq1 (rec__main__branch_type__m_nodes (us_split_fields1 a)) (rec__main__branch_type__m_nodes (us_split_fields1 b))) true)) true false))
...
(define-fun dynamic_invariant2 ((temp___expr_207 us_rep) (temp___is_init_203 Bool) (temp___skip_constant_204 Bool) (temp___do_toplevel_205 Bool) (temp___do_typ_inv_206 Bool)) Bool (let ((temp___208 (rec__main__branch_type__m_height (us_split_discrs1 temp___expr_207)))) (and (dynamic_property1 0 (to_rep temp___208) (first1 (rec__main__branch_type__m_nodes (us_split_fields1 temp___expr_207))) (last1 (rec__main__branch_type__m_nodes (us_split_fields1 temp___expr_207)))) (and (= (first1 (rec__main__branch_type__m_nodes (us_split_fields1 temp___expr_207))) 0) (= (last1 (rec__main__branch_type__m_nodes (us_split_fields1 temp___expr_207))) (to_rep temp___208))))))
...
(declare-fun temp_____aggregate_def_223 (Int Int Int) us_t2)
(declare-sort t3 0)
...
(assert (forall ((temp___225 Int) (temp___226 Int) (temp___227 Int)) (let ((temp___224 (temp_____aggregate_def_223 temp___225 temp___226 temp___227))) (=> (dynamic_invariant1 temp___225 true true true true) (and (=> (dynamic_property7 0 2147483647 temp___226 temp___227) (and (= (first5 temp___224) temp___226) (= (last5 temp___224) temp___227))) (forall ((temp___228 Int)) (= (select (to_array2 temp___224) temp___228) rliteral)))))))
...
(assert (= (to_rep (rec__main__branch_type__m_height branch__split_discrs)) r7b))
(assert (in_range2 r7b))
(assert (= (to_rep1 (first4 (rt2 (temp_____aggregate_def_223 0 0 r7b)))) 0))
(assert (= (to_rep1 (last4 (rt2 (temp_____aggregate_def_223 0 0 r7b)))) r7b))
(assert (= (mk___t2 temp___230 temp___2301) (temp_____aggregate_def_223 0 0 r7b)))
(assert (= (ite (<= (to_rep1 (first4 temp___2301)) (to_rep1 (last4 temp___2301))) (+ (- (to_rep1 (last4 temp___2301)) (to_rep1 (first4 temp___2301))) 1) 0) (ite (<= 0 r7b) (+ (- r7b 0) 1) 0)))
(assert (= temp___230 temp___231))
(assert (= (mk1 (to_rep1 (first4 temp___2301)) (to_rep1 (last4 temp___2301))) temp___2311))
(assert (= (ite (<= (to_rep1 (first2 temp___2311)) (to_rep1 (last2 temp___2311))) (+ (- (to_rep1 (last2 temp___2311)) (to_rep1 (first2 temp___2311))) 1) 0) (ite (<= (to_rep1 (first branch__split_fields1)) (to_rep1 (last branch__split_fields1))) (+ (- (to_rep1 (last branch__split_fields1)) (to_rep1 (first branch__split_fields1))) 1) 0)))
(assert (= (mk___t1 temp___233 temp___2331) (mk___t1 temp___231 temp___2311)))
(assert (= temp___233 o))
(assert (= (mk (to_rep1 (first2 temp___2331)) (to_rep1 (last2 temp___2331))) o1))
(assert (= o2 o))
(assert (= o3 o1))
...
(assert (= branch__split_discrs (mk___split_discrs temp___235)))
(assert (= (to_rep1 (last (rt (rec__main__branch_type__m_nodes branch__split_fields2)))) r10b))
(assert (in_range1 r10b))
(assert (= result1 (mk_int__ref i)))
(assert (= i1 0))
(assert (<= 0 i1))
(assert (<= i1 r10b))
(assert (and (and (<= 0 i2) (<= i2 (to_rep1 (last (rt (rec__main__branch_type__m_nodes branch__split_fields3)))))) (= (to_rep1 (last (rt (rec__main__branch_type__m_nodes branch__split_fields3)))) (to_rep1 (last (rt (rec__main__branch_type__m_nodes branch__split_fields2)))))))
(assert (and (and (and (dynamic_invariant2 (mk___rep branch__split_discrs branch__split_fields3) false true true true) (forall ((temp___243 Int)) (=> (and (<= (to_rep1 (first (rt (rec__main__branch_type__m_nodes branch__split_fields3)))) temp___243) (<= temp___243 (to_rep1 (last (rt (rec__main__branch_type__m_nodes branch__split_fields3)))))) (=> (or (< r10b temp___243) (or (< temp___243 0) (<= i2 temp___243))) (= (select (elts (rec__main__branch_type__m_nodes branch__split_fields3)) temp___243) (select (elts (rec__main__branch_type__m_nodes branch__split_fields2)) temp___243)))))) (=> (<= 0 r10b) (dynamic_property6 0 r10b i2))) (and (<= 0 i2) (<= i2 r10b))))
(assert (= i2 (to_rep1 (last (rt (rec__main__branch_type__m_nodes branch__split_fields3))))))
(assert (= (to_rep1 (last (rt (rec__main__branch_type__m_nodes branch__split_fields3)))) r12b))
(assert (in_range1 r12b))
(assert (and (<= 0 i2) (<= i2 r12b)))
(assert (not (<= i2 (to_rep1 (last (rt (rec__main__branch_type__m_nodes branch__split_fields3)))))))
(check-sat)
(exit)
