...
(define-fun dynamic_invariant2 ((temp___expr_177 us_rep) (temp___is_init_174 Bool) (temp___skip_constant_175 Bool) (temp___do_toplevel_176 Bool)) Bool (let ((temp___178 (rec__main__branch_type__m_height (us_split_discrs1 temp___expr_177)))) (and (dynamic_property1 0 (to_rep1 temp___178) (first1 (rec__main__branch_type__m_nodes (us_split_fields1 temp___expr_177))) (last1 (rec__main__branch_type__m_nodes (us_split_fields1 temp___expr_177)))) (and (= (first1 (rec__main__branch_type__m_nodes (us_split_fields1 temp___expr_177))) 0) (= (last1 (rec__main__branch_type__m_nodes (us_split_fields1 temp___expr_177))) (to_rep1 temp___178))))))
...
(assert (forall ((temp___194 Int) (temp___195 Int) (temp___196 Int)) (let ((temp___193 (temp___192 temp___194 temp___195 temp___196))) (and (=> (dynamic_property7 0 2147483647 temp___195 temp___196) (and (= (first5 temp___193) temp___195) (= (last5 temp___193) temp___196))) (forall ((temp___197 Int)) (= (select (to_array2 temp___193) temp___197) (of_rep temp___194)))))))
(define-fun dynamic_invariant3 ((temp___expr_185 us_t1) (temp___is_init_182 Bool) (temp___skip_constant_183 Bool) (temp___do_toplevel_184 Bool)) Bool (=> (not (= temp___skip_constant_183 true)) (and (dynamic_property3 0 r7b (first3 temp___expr_185) (last3 temp___expr_185)) (and (= (first3 temp___expr_185) 0) (= (last3 temp___expr_185) r7b)))))
...
(declare-const temp___2021 t1)
(declare-const o (Array Int integer))
(declare-const o1 t)
(declare-const o2 (Array Int integer))
(declare-const o3 t)
(declare-const temp___204 natural)
(declare-const temp___2041 (Array Int integer))
(declare-const temp___2042 t)
...
(declare-const o10 t)
(declare-const temp___207 natural)
(declare-const temp___2071 (Array Int integer))
(declare-const temp___2072 t)
...
(declare-const branch__split_fields4 us_split_fields)
(declare-const result3 int__ref)
(declare-const i3 Int)
(assert (dynamic_invariant2 (mk___rep branch__split_discrs (mk___split_fields (mk___t branch__split_fields branch__split_fields1))) false false true))
...
(assert (= (ite (<= (to_rep (first4 temp___1991)) (to_rep (last4 temp___1991))) (+ (- (to_rep (last4 temp___1991)) (to_rep (first4 temp___1991))) 1) 0) (ite (<= 0 r7b) (+ (- r7b 0) 1) 0)))
(assert (= temp___199 temp___200))
(assert (= (mk1 (to_rep (first4 temp___1991)) (to_rep (last4 temp___1991))) temp___2001))
(assert (= (ite (<= (to_rep (first2 temp___2001)) (to_rep (last2 temp___2001))) (+ (- (to_rep (last2 temp___2001)) (to_rep (first2 temp___2001))) 1) 0) (ite (<= (to_rep (first branch__split_fields1)) (to_rep (last branch__split_fields1))) (+ (- (to_rep (last branch__split_fields1)) (to_rep (first branch__split_fields1))) 1) 0)))
(assert (= (mk___t1 temp___202 temp___2021) (mk___t1 temp___200 temp___2001)))
(assert (= temp___202 o))
(assert (= (mk (to_rep (first2 temp___2021)) (to_rep (last2 temp___2021))) o1))
(assert (= o2 o))
(assert (= o3 o1))
(assert (= branch__split_discrs (mk___split_discrs temp___204)))
...
(assert (= branch__split_fields2 (mk___split_fields (mk___t temp___2041 temp___2042))))
(assert (= branch__split_discrs (mk___split_discrs temp___204)))
...
(assert (and (and (and (dynamic_invariant2 (mk___rep branch__split_discrs branch__split_fields3) false true true) (forall ((temp___210 Int)) (=> (and (<= (to_rep (first (rt (rec__main__branch_type__m_nodes branch__split_fields3)))) temp___210) (<= temp___210 (to_rep (last (rt (rec__main__branch_type__m_nodes branch__split_fields3)))))) (=> (<= i2 temp___210) (= (select (elts (rec__main__branch_type__m_nodes branch__split_fields3)) temp___210) (select (elts (rec__main__branch_type__m_nodes branch__split_fields2)) temp___210)))))) (=> (<= 0 r10b) (dynamic_property6 0 r10b i2))) (and (<= 0 i2) (<= i2 r10b))))
