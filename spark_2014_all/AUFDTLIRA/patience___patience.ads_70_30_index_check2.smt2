...
(declare-const temp___421 (Array Int cardindex))
...
(assert (and (<= 0 i) (<= i 99)))
(assert (= o5 i))
(assert (= temp___421 (select (rec__patience__state__stacks (us_split_fields1 s)) o5)))
(assert (and (<= 0 j) (<= j 99)))
(assert (= o6 j))
(assert (= o7 (select temp___421 o6)))
(assert (= o8 (to_rep o7)))
(assert (= o9 (ite (< o8 (to_rep (rec__patience__state__numelts (us_split_fields1 s)))) true false)))
(assert (not (<= 0 i)))
(check-sat)
(exit)
