...
(assert (not (= (ite (<= (to_rep1 (first (rt text))) (to_rep1 (last (rt text)))) (+ (- (to_rep1 (last (rt text))) (to_rep1 (first (rt text)))) 1) 0) (ite (<= 1 (to_rep1 (last (rt text)))) (+ (- (to_rep1 (last (rt text))) 1) 1) 0))))
(check-sat)
(exit)
