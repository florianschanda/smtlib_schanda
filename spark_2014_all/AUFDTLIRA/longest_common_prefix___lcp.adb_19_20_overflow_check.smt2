...
(assert (= result7 (ite (<= o13 (to_rep (last (rt a)))) true false)))
(assert (=> (= result7 true) (and (= o12 (+ y l3)) (in_range1 (+ y l3)))))
(assert (=> (= result7 true) (= result6 (ite (<= o12 (to_rep (last (rt a)))) true false))))
(assert (=> (not (= result7 true)) (= result6 false)))
(assert (= result6 true))
(assert (and (= temp___1881 (+ y l3)) (in_range1 (+ y l3))))
(assert (and (<= (to_rep (first (rt a))) temp___1881) (<= temp___1881 (to_rep (last (rt a))))))
(assert (= o9 temp___1881))
