...
(assert (and (= o14 (remove a o7)) (and (dynamic_invariant2 o14 true false true true) (and (= (invariant__ o14) true) (and (= (to_rep2 (last o9)) (- (to_rep2 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o7 1))) (= (to_rep (select (elts a) k)) (to_rep (select o8 k))))) (and (forall ((k Int)) (=> (and (<= (+ o7 1) k) (<= k (to_rep2 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select o8 (- k 1)))))) (forall ((k Int)) (=> (and (<= o7 k) (<= k (- (to_rep2 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select o8 k))))))))))))
(assert (and (= o13 (remove o14 o10)) (and (dynamic_invariant2 o13 true false true true) (and (= (invariant__ o13) true) (and (= (to_rep2 (last o12)) (- (to_rep2 (last o9)) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o10 1))) (= (to_rep (select o8 k)) (to_rep (select o11 k))))) (and (forall ((k Int)) (=> (and (<= (+ o10 1) k) (<= k (to_rep2 (last o9)))) (= (to_rep (select o8 k)) (to_rep (select o11 (- k 1)))))) (forall ((k Int)) (=> (and (<= o10 k) (<= k (- (to_rep2 (last o9)) 1))) (= (to_rep (select o8 (+ k 1))) (to_rep (select o11 k))))))))))))
(assert (and (= o15 (remove bb ib1)) (and (dynamic_invariant2 o15 true false true true) (and (= (invariant__ o15) true) (and (= (to_rep2 (last o6)) (- (to_rep2 (last (rt bb))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib1 1))) (= (to_rep (select (elts bb) k)) (to_rep (select o5 k))))) (and (forall ((k Int)) (=> (and (<= (+ ib1 1) k) (<= k (to_rep2 (last (rt bb))))) (= (to_rep (select (elts bb) k)) (to_rep (select o5 (- k 1)))))) (forall ((k Int)) (=> (and (<= ib1 k) (<= k (- (to_rep2 (last (rt bb))) 1))) (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select o5 k))))))))))))
