...
(assert (and (= o6 ia3) (in_range3 ia3)))
...
(assert (and (= o9 (remove o7 o8)) (and (dynamic_invariant o9 true false true true) (and (= (invariant__ o9) true) (and (= (to_rep1 (last (rt o9))) (- (to_rep1 (last (rt o7))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o8 1))) (= (to_rep (select (elts o7) k)) (to_rep (select (elts o9) k))))) (and (forall ((k Int)) (=> (and (<= (+ o8 1) k) (<= k (to_rep1 (last (rt o7))))) (= (to_rep (select (elts o7) k)) (to_rep (select (elts o9) (- k 1)))))) (forall ((k Int)) (=> (and (<= o8 k) (<= k (- (to_rep1 (last (rt o7))) 1))) (= (to_rep (select (elts o7) (+ k 1))) (to_rep (select (elts o9) k))))))))))))
(assert (and (= o5 (remove bb ib1)) (and (dynamic_invariant o5 true false true true) (and (= (invariant__ o5) true) (and (= (to_rep1 (last (rt o5))) (- (to_rep1 (last (rt bb))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib1 1))) (= (to_rep (select (elts bb) k)) (to_rep (select (elts o5) k))))) (and (forall ((k Int)) (=> (and (<= (+ ib1 1) k) (<= k (to_rep1 (last (rt bb))))) (= (to_rep (select (elts bb) k)) (to_rep (select (elts o5) (- k 1)))))) (forall ((k Int)) (=> (and (<= ib1 k) (<= k (- (to_rep1 (last (rt bb))) 1))) (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select (elts o5) k))))))))))))
