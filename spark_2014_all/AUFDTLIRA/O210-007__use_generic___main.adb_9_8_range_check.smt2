...
(define-fun dynamic_invariant1 ((temp___expr_184 us_rep1) (temp___is_init_181 Bool) (temp___skip_constant_182 Bool) (temp___do_toplevel_183 Bool)) Bool (=> (not (= temp___skip_constant_182 true)) (in_range3 7 (to_base temp___expr_184))))
(define-fun default_initial_assumption ((temp___expr_187 us_rep1) (temp___skip_top_level_188 Bool)) Bool (= (to_rep (rec__main__branch_type__m_height (us_split_discrs2 temp___expr_187))) 7))
