...
(define-fun bool_eq3 ((a us_rep1) (b us_rep1)) Bool (ite (and (= (to_rep (rec__main__branch_type__m_height (us_split_discrs2 a))) (to_rep (rec__main__branch_type__m_height (us_split_discrs2 b)))) (= (bool_eq (rec__main__branch_type__m_nodes1 (us_split_fields3 a)) 0 7 (rec__main__branch_type__m_nodes1 (us_split_fields3 b)) 0 7) true)) true false))
(define-fun in_range3 ((rec__main__branch_type__m_height1 Int) (a us_rep)) Bool (= rec__main__branch_type__m_height1 (to_rep (rec__main__branch_type__m_height (us_split_discrs1 a)))))
...
(define-fun dynamic_invariant1 ((temp___expr_215 us_rep1) (temp___is_init_211 Bool) (temp___skip_constant_212 Bool) (temp___do_toplevel_213 Bool) (temp___do_typ_inv_214 Bool)) Bool (=> (not (= temp___skip_constant_212 true)) (in_range3 7 (to_base temp___expr_215))))
(define-fun default_initial_assumption ((temp___expr_218 us_rep1) (temp___skip_top_level_219 Bool)) Bool (= (to_rep (rec__main__branch_type__m_height (us_split_discrs2 temp___expr_218))) 7))
...
(declare-const temp___m_height_228 Int)
(assert (in_range temp___m_height_228))
(assert (<= 0 temp___m_height_228))
(assert (not (<= temp___m_height_228 2147483647)))
(check-sat)
(exit)
