...
(assert (= (previous_tracks_on_orange_or_red cur_num_trains trains3 (map__content4 track_signals10)) true))
(assert (not (= (safe_signaling cur_num_trains trains3 (map__content4 track_signals10)) true)))
(check-sat)
(exit)
