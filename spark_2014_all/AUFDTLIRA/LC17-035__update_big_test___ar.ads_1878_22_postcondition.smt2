...
(declare-const temp___10041 (Array Int us_rep))
(declare-const temp___100411 (Array Int et1))
...
(assert (= temp___10041 o7))
(assert (= temp___100411 o8))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= temp___10041 r__split_fields2))
(assert (= temp___100411 r__split_fields3))
...
(assert (<= 1 m))
(assert (<= m 16))
(assert (not (in_range4 (to_rep1 (rec__ar__rofa1__t1 (us_split_fields1 (select r__split_fields4 m)))))))
(check-sat)
(exit)
