...
(assert (forall ((temp___3006 (Array Int et1))) (forall ((temp___3007 Int) (temp___3008 Int)) (let ((temp___3005 (temp___3004 temp___3006 temp___3007 temp___3008))) (forall ((temp___3009 Int)) (ite (= temp___3009 temp___3007) (= (select temp___3005 temp___3009) (of_rep temp___3008)) (= (select temp___3005 temp___3009) (select temp___3006 temp___3009))))))))
...
(assert (not (= (bool_eq1 (mk___rep (mk___split_fields r__split_fields4 r__split_fields5)) (mk___rep (mk___split_fields (temp___3004 r__split_fields i e) r__split_fields1))) true)))
(check-sat)
(exit)
