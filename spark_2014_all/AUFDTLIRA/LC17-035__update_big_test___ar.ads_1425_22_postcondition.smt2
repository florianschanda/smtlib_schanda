...
(declare-fun temp___3063 ((Array Int et1) Int Int) (Array Int et1))
...
(assert (not (= (bool_eq1 (mk___rep (mk___split_fields r__split_fields4 r__split_fields5)) (mk___rep (mk___split_fields (temp___3063 r__split_fields i e) r__split_fields1))) true)))
(check-sat)
(exit)
