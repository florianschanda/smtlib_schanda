...
(assert (= a2 (store a i1 (mk___rep (mk___split_fields (ite (= (rec__foo__r__x (us_split_fields1 (select a i1))) false) (ite (not (= (rec__foo__r__x (us_split_fields1 (select a i1))) true)) true false) true))))))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 i2)) (= (rec__foo__r__x (us_split_fields1 (select a3 j1))) true))))
(assert (and (and (=> (<= 1 10) (in_range2 i2)) (forall ((temp___168 Int)) (=> (and (<= 1 temp___168) (<= temp___168 10)) (=> (< i2 temp___168) (= (select a3 temp___168) (select a temp___168)))))) (and (<= 1 i2) (<= i2 10))))
(assert (not (= i2 10)))
(assert (= result2 i2))
(assert (= i3 (+ i2 1)))
(assert (= result3 a3))
(assert (= a4 (store a3 i3 (mk___rep (mk___split_fields (ite (= (rec__foo__r__x (us_split_fields1 (select a3 i3))) false) (ite (not (= (rec__foo__r__x (us_split_fields1 (select a3 i3))) true)) true false) true))))))
(declare-const j1 Int)
(assert (<= 1 j1))
(assert (<= j1 i3))
(assert (not (= (rec__foo__r__x (us_split_fields1 (select a4 j1))) true)))
(check-sat)
(exit)
