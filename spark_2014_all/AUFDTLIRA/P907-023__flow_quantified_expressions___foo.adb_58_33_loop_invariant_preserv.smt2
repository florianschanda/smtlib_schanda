...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__foo__r__x Bool)))))
(define-fun us_split_fields_X__projection ((a us_split_fields)) Bool (rec__foo__r__x a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (= (rec__foo__r__x (us_split_fields1 a)) (rec__foo__r__x (us_split_fields1 b))) true false))
...
(assert (forall ((i tctD1)) (and (<= 1 (tctD1qtint i)) (<= (tctD1qtint i) 10))))
...
(declare-datatypes () ((tctD1__ref (mk_tctD1__ref (tctD1__content tctD1)))))
...
(assert (forall ((i t29b)) (and (<= 1 (t29bqtint i)) (<= (t29bqtint i) 10))))
...
(assert (= a1 (store a i1 (mk___rep (mk___split_fields (ite (= (rec__foo__r__x (us_split_fields1 (select a i1))) false) (ite (not (= (rec__foo__r__x (us_split_fields1 (select a i1))) true)) true false) true))))))
(assert (forall ((j Int)) (=> (and (<= 1 j) (<= j i2)) (= (rec__foo__r__x (us_split_fields1 (select a2 j))) true))))
(assert (and (and (=> (<= 1 10) (in_range2 i2)) (forall ((temp___196 Int)) (=> (and (<= 1 temp___196) (<= temp___196 10)) (=> (or (< 10 temp___196) (or (< temp___196 1) (< i2 temp___196))) (= (select a2 temp___196) (select a temp___196)))))) (and (<= 1 i2) (<= i2 10))))
(assert (not (= i2 10)))
(assert (= result2 i2))
(assert (= i3 (+ i2 1)))
(assert (= result3 a2))
(assert (= a3 (store a2 i3 (mk___rep (mk___split_fields (ite (= (rec__foo__r__x (us_split_fields1 (select a2 i3))) false) (ite (not (= (rec__foo__r__x (us_split_fields1 (select a2 i3))) true)) true false) true))))))
(declare-const j Int)
(assert (<= 1 j))
(assert (<= j i3))
(assert (not (= (rec__foo__r__x (us_split_fields1 (select a3 j))) true)))
(check-sat)
(exit)
