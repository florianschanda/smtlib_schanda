...
(assert (and (and (=> (<= 1 10) (in_range2 i2)) (forall ((temp___194 Int)) (=> (and (<= 1 temp___194) (<= temp___194 10)) (=> (< i2 temp___194) (= (select a2 temp___194) (select a temp___194)))))) (and (<= 1 i2) (<= i2 10))))
(assert (not (= i2 10)))
(assert (= result2 i2))
(assert (= i3 (+ i2 1)))
(assert (= result3 a2))
