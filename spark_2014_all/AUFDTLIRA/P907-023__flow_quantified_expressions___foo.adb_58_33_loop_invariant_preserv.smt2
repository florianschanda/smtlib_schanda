...
(assert (and (and (=> (<= 1 10) (in_range2 i2)) (forall ((temp___168 Int)) (=> (and (<= 1 temp___168) (<= temp___168 10)) (=> (< i2 temp___168) (= (select a2 temp___168) (select a temp___168)))))) (and (<= 1 i2) (<= i2 10))))
(assert (not (= i2 10)))
(assert (= result2 i2))
(assert (= i3 (+ i2 1)))
(assert (= result3 a2))
