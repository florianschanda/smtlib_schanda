...
(assert (= b1 o13))
(assert (not (= (bool_eq b (to_rep (first2 (mk1 (to_rep b__first) (+ (to_rep b__first) j1)))) (to_rep (last2 (mk1 (to_rep b__first) (+ (to_rep b__first) j1)))) a1 (to_rep (first4 (mk2 (to_rep a__first) (+ (to_rep a__first) j1)))) (to_rep (last4 (mk2 (to_rep a__first) (+ (to_rep a__first) j1))))) true)))
(check-sat)
(exit)
