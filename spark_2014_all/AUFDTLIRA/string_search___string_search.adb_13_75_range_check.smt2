...
(define-fun diff17 () bool__ref (mk_bool__ref diff9))
(define-fun j16 () int__ref (mk_int__ref j6))
(define-fun diff18 () bool__ref (mk_bool__ref diff7))
...
(assert (=> (and (<= (to_rep1 (first (rt needle))) j1) (<= j1 (to_rep1 (last (rt needle))))) (= (mk_int__ref j10) j15)))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j1) (<= j1 (to_rep1 (last (rt needle))))) (= (mk_bool__ref diff11) diff17)))
...
(assert (= (partial_match_at needle haystack i3 j14) true))
(assert (= (= diff16 true) (not (= (to_rep (select (elts needle) j14)) (to_rep (select (elts haystack) (+ j14 (- i3 1))))))))
(assert (and (=> (<= (to_rep1 (first (rt needle))) (to_rep1 (last (rt needle)))) (dynamic_property2 (to_rep1 (first (rt needle))) (to_rep1 (last (rt needle))) j14)) (and (<= (to_rep1 (first (rt needle))) j14) (<= j14 (to_rep1 (last (rt needle)))))))
(assert (not (in_range2 j14)))
(check-sat)
(exit)
