...
(assert (= o198 (- o197 1)))
(assert (and (= temp___829 (nb_blacks c88b)) (and (= (bool_eq11 (select temp___829 0) (mk___rep5 (mk___split_fields5 (of_int 1) (of_rep 0) (of_rep 0)))) true) (forall ((i14 Int)) (=> (and (<= 1 i14) (<= i14 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c88b))) i14))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___829 i14))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___829 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c88b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___829 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c88b)) i14 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___829 i14)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___829 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c88b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___829 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c88b)) i14 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___829 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c88b)) i14 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___829 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c88b)) i14 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___829 i14)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c88b)) i14)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___829 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c88b)) i14 0))))))))))))))
(assert (= o191 (select temp___829 c89b)))
(assert (= o192 (us_split_fields11 o191)))
(assert (= o193 (rec__red_black_trees__black_count__count o192)))
(assert (= o199 (to_rep o193)))
(assert (= o200 (ite (= o199 o198) true false)))
