...
(assert (and (and (=> (<= 2 30) (in_range4 i2)) (forall ((temp___181 Int)) (=> (and (<= 0 temp___181) (<= temp___181 30)) (=> (< i2 temp___181) (= (select a4 temp___181) (select a2 temp___181)))))) (and (<= 2 i2) (<= i2 30))))
(assert (<= 2 j))
(assert (<= j i2))
(assert (not (<= 0 (- j 2))))
(check-sat)
