...
(assert (=> (= result7 true) (and (= temp___1760 (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) root)) (and (dynamic_invariant3 temp___1760 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1760 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1760 root)))) 0) (and (forall ((i7 Int)) (=> (and (<= 1 i7) (<= i7 100)) (=> (not (= i7 root)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i7) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1760 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i7)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1760 i7))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1760 i7))) true)))))) (and (forall ((i7 Int)) (=> (and (<= 1 i7) (<= i7 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1760 i7))) true) (not (= i7 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1760 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i7)))) (position (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i7) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1760 i7)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1760 i7)))) 0)))) (forall ((i7 Int)) (=> (and (<= 1 i7) (<= i7 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1760 i7))) true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1760 j2))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1760 i7))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1760 j2)))) true)) (= j2 i7)))))))))))))))
(assert (=> (= result7 true) (= (mk___rep (mk___split_fields o10 o11)) (select temp___1760 i))))
(assert (=> (= result7 true) (= o10 o12)))
(assert (=> (= result7 true) (= o11 o13)))
(assert (=> (= result7 true) (= o14 o12)))
(assert (=> (= result7 true) (and (= o15 (length o14)) (and (in_range5 o15) (<= (+ 0 o15) 2147483647)))))
(assert (=> (= result7 true) (= result6 (ite (< o15 n2) true false))))
