...
(declare-const temp___254 (Array Int natural))
(declare-const temp___2541 t7)
(declare-const temp___255 (Array Int natural))
...
(assert (not (= b1 true)))
(assert (not (= b2 true)))
(assert (= (to_rep (first14 (rt7 (temp_____aggregate_def_247 1 0 y)))) 0))
(assert (= (to_rep (last14 (rt7 (temp_____aggregate_def_247 1 0 y)))) y))
(assert (= (mk___t7 temp___254 temp___2541) (temp_____aggregate_def_247 1 0 y)))
(assert (= (ite (<= (to_rep (first14 temp___2541)) (to_rep (last14 temp___2541))) (+ (- (to_rep (last14 temp___2541)) (to_rep (first14 temp___2541))) 1) 0) (ite (<= 0 y) (+ (- y 0) 1) 0)))
(assert (= temp___254 temp___255))
(assert (= (mk2 (to_rep (first14 temp___2541)) (to_rep (last14 temp___2541))) temp___2551))
(assert (not (= (ite (<= (to_rep v__first) (to_rep v__last)) (+ (- (to_rep v__last) (to_rep v__first)) 1) 0) (ite (<= 0 y) (+ (- y 0) 1) 0))))
(check-sat)
(exit)
