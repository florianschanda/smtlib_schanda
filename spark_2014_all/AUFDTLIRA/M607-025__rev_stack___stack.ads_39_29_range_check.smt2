...
(assert (forall ((s us_rep)) (! (let ((result (to__ s))) (and (and (= (first1 result) 1) (<= 0 (last1 result))) (dynamic_invariant result true false true))) :pattern ((to__ s)))))
...
(assert (and (= o (- (to_rep s__split_fields) 1)) (in_range1 (- (to_rep s__split_fields) 1))))
(assert (= (to_rep o1) o))
(assert (= o1 o2))
(assert (= s__split_fields1 o3))
(assert (= temp___250 o2))
(assert (= temp___2501 o3))
...
(assert (= temp___250 s__split_fields2))
(assert (= temp___2501 s__split_fields3))
...
(assert (and (= temp___254 (- (to_rep1 (last (rt (to__ (mk___rep (mk___split_fields s__split_fields s__split_fields1)))))) 1)) (in_range (- (to_rep1 (last (rt (to__ (mk___rep (mk___split_fields s__split_fields s__split_fields1)))))) 1))))
(assert (<= 1 temp___254))
(assert (not (<= (to_rep1 (first (rt (to__ (mk___rep (mk___split_fields s__split_fields s__split_fields1)))))) 1)))
(check-sat)
(exit)
