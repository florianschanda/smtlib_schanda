...
(assert (and (= temp___281 (- (to_rep1 (last (rt (to__ (mk___rep (mk___split_fields s__split_fields s__split_fields1)))))) 1)) (in_range (- (to_rep1 (last (rt (to__ (mk___rep (mk___split_fields s__split_fields s__split_fields1)))))) 1))))
(assert (<= 1 temp___281))
