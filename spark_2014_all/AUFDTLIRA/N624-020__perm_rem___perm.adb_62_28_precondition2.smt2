...
(assert (= (= result1 true) (exists ((ib Int)) (and (and (<= (to_rep1 (first (rt b))) ib) (<= ib (to_rep1 (last (rt b))))) (and (= (to_rep (select (elts a) ia1)) (to_rep (select (elts b) ib))) (= (is_perm (remove a ia1) (remove b ib)) true))))))
...
(assert (forall ((ka1 Int)) (=> (and (<= 1 ka1) (<= ka1 ia2)) (forall ((kb1 Int)) (=> (and (<= (to_rep1 (first (rt b))) kb1) (<= kb1 (to_rep1 (last (rt b))))) (not (and (= (to_rep (select (elts a) ka1)) (to_rep (select (elts b) kb1))) (= (is_perm (remove a ka1) (remove b kb1)) true))))))))
(assert (and (=> (<= (to_rep1 (first (rt a))) (to_rep1 (last (rt a)))) (dynamic_property1 (to_rep1 (first (rt a))) (to_rep1 (last (rt a))) ia2)) (and (<= (to_rep1 (first (rt a))) ia2) (<= ia2 (to_rep1 (last (rt a)))))))
(assert (<= 1 ka))
(assert (<= ka ia2))
(assert (<= (to_rep1 (first (rt b))) kb))
(assert (<= kb (to_rep1 (last (rt b)))))
(assert (and (<= (to_rep1 (first (rt b))) kb) (<= kb (to_rep1 (last (rt b))))))
(assert (= o6 kb))
(assert (= o7 (select (elts b) o6)))
(assert (= o8 (to_rep o7)))
(assert (and (<= (to_rep1 (first (rt a))) ka) (<= ka (to_rep1 (last (rt a))))))
(assert (= o4 ka))
(assert (= o5 (select (elts a) o4)))
(assert (= o9 (to_rep o5)))
(assert (= result2 (ite (= o9 o8) true false)))
(assert (= result2 true))
(assert (and (= o1 kb) (in_range3 kb)))
