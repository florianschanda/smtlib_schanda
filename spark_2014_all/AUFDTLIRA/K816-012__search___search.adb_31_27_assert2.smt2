...
(assert (< found4 2))
(assert (not (= found12 true)))
(assert (= (to_rep (select (elts table) i2)) value1))
(assert (= found12 result6))
(assert (= found13 (distinct 1 0)))
(assert (= index12 result7))
(assert (= index13 i2))
(assert (and (= o (+ found4 1)) (in_range1 (+ found4 1))))
(assert (= found4 result8))
(assert (= found5 o))
(assert (not (= found13 true)))
(check-sat)
(exit)
