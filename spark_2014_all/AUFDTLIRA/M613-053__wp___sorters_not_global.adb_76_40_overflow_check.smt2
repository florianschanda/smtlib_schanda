...
(assert (and (= o (index_of_minimum current1 limit values)) (and (in_range2 o) (and (and (<= current1 o) (<= o limit)) (forall ((j1 Int)) (=> (and (<= current1 j1) (<= j1 limit)) (<= (to_rep (select values o)) (to_rep (select values j1)))))))))
(assert (= (mk_int__ref result1) (mk_int__ref smallest)))
(assert (= smallest1 o))
(assert (=> (not (= smallest1 current1)) (and (and (= (to_rep (select values2 current1)) (to_rep (select values smallest1))) (= (to_rep (select values2 smallest1)) (to_rep (select values current1)))) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 64)) (=> (and (not (= j1 current1)) (not (= j1 smallest1))) (= (to_rep (select values2 j1)) (to_rep (select values j1)))))))))
(assert (=> (not (not (= smallest1 current1))) (= values2 values)))
(assert (=> (not (not (= smallest1 current1))) (= values2 values1)))
(assert (and (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- current2 1))) (<= (to_rep (select values3 j1)) (to_rep (select values3 (+ j1 1)))))) (forall ((j1 Int)) (=> (and (<= current2 j1) (<= j1 limit)) (<= (to_rep (select values3 current2)) (to_rep (select values3 j1)))))))
