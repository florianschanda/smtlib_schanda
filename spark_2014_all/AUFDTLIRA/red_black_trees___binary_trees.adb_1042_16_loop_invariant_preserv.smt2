...
(assert (not (= r3 r299b)))
(assert (= result23 (mk_int__ref r3)))
(assert (= r4 (+ r3 1)))
(assert (=> (and (not (= r4 root)) (and (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f_old__split_fields1 r4)))) 2) (not (= r4 v)))) (= (tree_structure (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))) true)))
(assert (=> (and (not (= r4 root)) (and (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f_old__split_fields1 r4)))) 2) (not (= r4 v)))) (forall ((i7 Int)) (=> (and (<= 1 i7) (<= i7 100)) (or (not (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) root) i7))) true)) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) r4) i7))) true)))))))
(assert (=> (and (not (= r4 root)) (and (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f_old__split_fields1 r4)))) 2) (not (= r4 v)))) (and (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 r4)))) 2) (= (oeq1 (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) r4) (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) r4)) true))))
