...
(define-fun dynamic_invariant ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= 0 10)) (in_range temp___expr_136)))
...
(assert (forall ((top Int)) (forall ((data (Array Int integer))) (! (=> (dynamic_invariant top true true true) (dynamic_invariant1 (size top data) true false true)) :pattern ((size top data))))))
(assert (forall ((top Int)) (forall ((data (Array Int integer))) (! (=> (dynamic_invariant top true true true) (= (size top data) top)) :pattern ((size top data))))))
...
(assert (= top1 top2))
(assert (= top3 top1))
(assert (not (= (size top2 data) (- (size top data) 1))))
(check-sat)
(exit)
