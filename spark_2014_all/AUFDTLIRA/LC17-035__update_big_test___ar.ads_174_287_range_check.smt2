...
(assert (= a1 o1))
(assert (=> (= i 10) (= (mk_int__ref result1) (mk_int__ref j))))
(assert (=> (= i 10) (= j1 1)))
(assert (=> (not (= i 10)) (and (= o2 (+ i 1)) (in_range (+ i 1)))))
(assert (=> (not (= i 10)) (= (mk_int__ref result2) (mk_int__ref j))))
...
(assert (=> (< i 10) (=> (< 0 e) (= temp___4341 (temp___601 a i e o9 o8)))))
(assert (=> (< i 10) (=> (< 0 e) (= result7 (bool_eq a3 1 10 temp___4341 1 10)))))
(assert (=> (< i 10) (=> (not (< 0 e)) (= result7 false))))
(assert (=> (< i 10) (=> (= result7 true) (= result6 true))))
(assert (=> (< i 10) (=> (not (= result7 true)) (=> (= e 0) (and (= o7 (+ i 1)) (in_range (+ i 1)))))))
(assert (=> (< i 10) (=> (not (= result7 true)) (=> (= e 0) (= temp___4343 (temp___610 a i e o7 99))))))
(assert (=> (< i 10) (=> (not (= result7 true)) (=> (= e 0) (= result6 (bool_eq a3 1 10 temp___4343 1 10))))))
