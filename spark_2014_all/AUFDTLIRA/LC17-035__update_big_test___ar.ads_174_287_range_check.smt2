...
(declare-fun temp_____aggregate_def_660 ((Array Int et1) Int Int Int Int) (Array Int et1))
(declare-fun temp_____aggregate_def_669 ((Array Int et1) Int Int Int Int) (Array Int et1))
(declare-fun temp_____aggregate_def_678 ((Array Int et1) Int Int Int Int) (Array Int et1))
(declare-fun temp_____aggregate_def_687 ((Array Int et1) Int Int Int Int) (Array Int et1))
(assert (forall ((temp___662 (Array Int et1))) (forall ((temp___663 Int) (temp___664 Int) (temp___665 Int) (temp___666 Int)) (let ((temp___661 (temp_____aggregate_def_660 temp___662 temp___663 temp___664 temp___665 temp___666))) (=> (and (and (and (dynamic_invariant temp___663 true true true true) (dynamic_invariant1 temp___664 true true true true)) (dynamic_invariant temp___665 true true true true)) (dynamic_invariant1 temp___666 true true true true)) (forall ((temp___667 Int)) (ite (= temp___667 temp___665) (= (to_rep (select temp___661 temp___667)) temp___666) (ite (= temp___667 temp___663) (= (to_rep (select temp___661 temp___667)) temp___664) (= (select temp___661 temp___667) (select temp___662 temp___667))))))))))
(declare-const rliteral et1)
(assert (= (et1qtint rliteral) 99))
(assert (forall ((temp___671 (Array Int et1))) (forall ((temp___672 Int) (temp___673 Int) (temp___674 Int) (temp___675 Int)) (let ((temp___670 (temp_____aggregate_def_669 temp___671 temp___672 temp___673 temp___674 temp___675))) (=> (and (and (and (dynamic_invariant temp___672 true true true true) (dynamic_invariant1 temp___673 true true true true)) (dynamic_invariant temp___674 true true true true)) (dynamic_invariant1 temp___675 true true true true)) (forall ((temp___676 Int)) (ite (= temp___676 temp___674) (= (select temp___670 temp___676) rliteral) (ite (= temp___676 temp___672) (= (to_rep (select temp___670 temp___676)) temp___673) (= (select temp___670 temp___676) (select temp___671 temp___676))))))))))
(assert (forall ((temp___680 (Array Int et1))) (forall ((temp___681 Int) (temp___682 Int) (temp___683 Int) (temp___684 Int)) (let ((temp___679 (temp_____aggregate_def_678 temp___680 temp___681 temp___682 temp___683 temp___684))) (=> (and (and (and (dynamic_invariant temp___681 true true true true) (dynamic_invariant1 temp___682 true true true true)) (dynamic_invariant temp___683 true true true true)) (dynamic_invariant1 temp___684 true true true true)) (forall ((temp___685 Int)) (ite (= temp___685 temp___683) (= (to_rep (select temp___679 temp___685)) temp___684) (ite (= temp___685 temp___681) (= (to_rep (select temp___679 temp___685)) temp___682) (= (select temp___679 temp___685) (select temp___680 temp___685))))))))))
(assert (forall ((temp___689 (Array Int et1))) (forall ((temp___690 Int) (temp___691 Int) (temp___692 Int) (temp___693 Int)) (let ((temp___688 (temp_____aggregate_def_687 temp___689 temp___690 temp___691 temp___692 temp___693))) (=> (and (and (and (dynamic_invariant temp___690 true true true true) (dynamic_invariant1 temp___691 true true true true)) (dynamic_invariant temp___692 true true true true)) (dynamic_invariant1 temp___693 true true true true)) (forall ((temp___694 Int)) (ite (= temp___694 temp___692) (= (select temp___688 temp___694) rliteral) (ite (= temp___694 temp___690) (= (to_rep (select temp___688 temp___694)) temp___691) (= (select temp___688 temp___694) (select temp___689 temp___694))))))))))
...
(assert (=> (< i 10) (=> (< 0 e) (= temp___4400 (temp_____aggregate_def_660 a i e o8 o7)))))
...
(assert (=> (< i 10) (=> (not (= result7 true)) (=> (= e 0) (= temp___4402 (temp_____aggregate_def_669 a i e o6 99))))))
