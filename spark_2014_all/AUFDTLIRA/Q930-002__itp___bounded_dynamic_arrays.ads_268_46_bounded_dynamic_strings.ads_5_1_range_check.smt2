...
(assert (and (= o5 (length fragment)) (in_range1 (length fragment))))
(assert (= o6 (ite (<= o5 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 within)))) true false)))
(assert (and (= o4 (length fragment)) (in_range1 (length fragment))))
(assert (= o7 (ite (<= 1 o4) true false)))
