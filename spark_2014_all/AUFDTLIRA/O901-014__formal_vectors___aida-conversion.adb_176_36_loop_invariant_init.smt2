...
(assert (and (= temp___883 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (= (mk_int__ref result7) (mk_int__ref i)))
(assert (= i4 temp___883))
(assert (<= temp___883 i4))
(assert (<= i4 (to_rep1 (last (rt source)))))
(assert (and (<= (to_rep1 (first (rt source))) i4) (<= i4 (to_rep1 (last (rt source))))))
(assert (= o3 i4))
...
(assert (<= (+ (to_rep1 (first (rt source))) 1) j2))
(assert (<= j2 i4))
