...
(define-fun dynamic_invariant ((temp___expr_173 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool) (temp___do_typ_inv_172 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= 0 200)) (in_range4 temp___expr_173)))
(assert true)
...
(assert (forall ((v us_rep)) (! (dynamic_invariant1 (to_string1 v) true false true true) :pattern ((to_string1 v)))))
...
(define-fun dynamic_invariant2 ((temp___expr_183 Int) (temp___is_init_179 Bool) (temp___skip_constant_180 Bool) (temp___do_toplevel_181 Bool) (temp___do_typ_inv_182 Bool)) Bool (=> (or (= temp___is_init_179 true) (<= 0 2)) (in_range5 temp___expr_183)))
(declare-const i Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-fun temp___String_Literal_202 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (= (to_rep (select (temp___String_Literal_202 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_202 us_void_param) 2)) 45)) (= (to_rep (select (temp___String_Literal_202 us_void_param) 3)) 62)) (= (to_rep (select (temp___String_Literal_202 us_void_param) 4)) 32)) :pattern ((temp___String_Literal_202 us_void_param)))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_205 us_void_param) 1)) 115) (= (to_rep (select (temp___String_Literal_205 us_void_param) 2)) 116)) (= (to_rep (select (temp___String_Literal_205 us_void_param) 3)) 97)) (= (to_rep (select (temp___String_Literal_205 us_void_param) 4)) 99)) (= (to_rep (select (temp___String_Literal_205 us_void_param) 5)) 107)) (= (to_rep (select (temp___String_Literal_205 us_void_param) 6)) 32)) (= (to_rep (select (temp___String_Literal_205 us_void_param) 7)) 105)) (= (to_rep (select (temp___String_Literal_205 us_void_param) 8)) 115)) (= (to_rep (select (temp___String_Literal_205 us_void_param) 9)) 32)) (= (to_rep (select (temp___String_Literal_205 us_void_param) 10)) 101)) (= (to_rep (select (temp___String_Literal_205 us_void_param) 11)) 109)) (= (to_rep (select (temp___String_Literal_205 us_void_param) 12)) 112)) (= (to_rep (select (temp___String_Literal_205 us_void_param) 13)) 116)) (= (to_rep (select (temp___String_Literal_205 us_void_param) 14)) 121)) :pattern ((temp___String_Literal_205 us_void_param)))))
...
(assert (not (not (= (empty last2) true))))
(check-sat)
(exit)
