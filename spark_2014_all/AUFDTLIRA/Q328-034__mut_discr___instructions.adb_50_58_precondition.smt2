...
(define-fun dynamic_invariant ((temp___expr_149 Int) (temp___is_init_146 Bool) (temp___skip_constant_147 Bool) (temp___do_toplevel_148 Bool)) Bool (=> (or (= temp___is_init_146 true) (<= 0 200)) (in_range4 temp___expr_149)))
(assert true)
...
(assert (forall ((v us_rep)) (! (dynamic_invariant1 (to_string1 v) true false true) :pattern ((to_string1 v)))))
...
(define-fun dynamic_invariant2 ((temp___expr_158 Int) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool)) Bool (=> (or (= temp___is_init_155 true) (<= 0 2)) (in_range5 temp___expr_158)))
(declare-const i Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-fun temp___String_Literal_176 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (= (to_rep (select (temp___String_Literal_176 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_176 us_void_param) 2)) 45)) (= (to_rep (select (temp___String_Literal_176 us_void_param) 3)) 62)) (= (to_rep (select (temp___String_Literal_176 us_void_param) 4)) 32)) :pattern ((temp___String_Literal_176 us_void_param)))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_179 us_void_param) 1)) 115) (= (to_rep (select (temp___String_Literal_179 us_void_param) 2)) 116)) (= (to_rep (select (temp___String_Literal_179 us_void_param) 3)) 97)) (= (to_rep (select (temp___String_Literal_179 us_void_param) 4)) 99)) (= (to_rep (select (temp___String_Literal_179 us_void_param) 5)) 107)) (= (to_rep (select (temp___String_Literal_179 us_void_param) 6)) 32)) (= (to_rep (select (temp___String_Literal_179 us_void_param) 7)) 105)) (= (to_rep (select (temp___String_Literal_179 us_void_param) 8)) 115)) (= (to_rep (select (temp___String_Literal_179 us_void_param) 9)) 32)) (= (to_rep (select (temp___String_Literal_179 us_void_param) 10)) 101)) (= (to_rep (select (temp___String_Literal_179 us_void_param) 11)) 109)) (= (to_rep (select (temp___String_Literal_179 us_void_param) 12)) 112)) (= (to_rep (select (temp___String_Literal_179 us_void_param) 13)) 116)) (= (to_rep (select (temp___String_Literal_179 us_void_param) 14)) 121)) :pattern ((temp___String_Literal_179 us_void_param)))))
