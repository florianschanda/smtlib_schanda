...
(declare-const string_search__qs__result4 int__ref)
(declare-const string_search__qs__result5 Int)
...
(declare-const r52b4 int__ref)
(declare-const r53b4 int__ref)
(declare-const shift4 int__ref)
(declare-const r58b4 int__ref)
(declare-const r59b4 int__ref)
(declare-const k14 int__ref)
(declare-const string_search__qs__result6 int__ref)
(declare-const temp___3422 int__ref)
(declare-const i5 Int)
(declare-const r52b5 Int)
(declare-const r53b5 Int)
(declare-const shift5 Int)
(declare-const r58b5 Int)
(declare-const r59b5 Int)
(declare-const k15 Int)
(declare-const string_search__qs__result7 Int)
...
(assert (and (forall ((c Int)) (=> (and (<= 0 c) (<= c 255)) (and (<= 1 (to_rep (select bad_shift c))) (<= (to_rep (select bad_shift c)) (+ (length needle) 1))))) (forall ((c Int)) (=> (and (<= 0 c) (<= c 255)) (ite (= (to_rep (select bad_shift c)) (+ (length needle) 1)) (forall ((k16 Int)) (=> (and (<= (to_rep2 (first (rt needle))) k16) (<= k16 (to_rep2 (last (rt needle))))) (not (= c (to_rep1 (select (elts needle) k16)))))) (and (= (to_rep1 (select (elts needle) (+ (- (length needle) (to_rep (select bad_shift c))) 1))) c) (forall ((k16 Int)) (=> (and (<= (+ (- (length needle) (to_rep (select bad_shift c))) 2) k16) (<= k16 (to_rep2 (last (rt needle))))) (not (= (to_rep1 (select (elts needle) k16)) c))))))))))
...
(assert (= o9 temp___327))
(assert (= (mk1 r52b1 r53b1) temp___3271))
(assert (= result4 (bool_eq (elts needle) (to_rep2 (first (rt needle))) (to_rep2 (last (rt needle))) temp___327 (to_rep2 (first2 temp___3271)) (to_rep2 (last2 temp___3271)))))
...
(assert (= o17 (+ i1 o16)))
(assert (and (= temp___328 o17) (in_range1 o17)))
(assert (and (<= (to_rep2 (first (rt haystack))) temp___328) (<= temp___328 (to_rep2 (last (rt haystack))))))
(assert (= o18 temp___328))
...
(assert (= k1 r58b1))
(assert (=> (and (<= r58b1 k1) (<= k1 r59b1)) (= temp___333 k1)))
(assert (=> (and (<= r58b1 k1) (<= k1 r59b1)) (not (= (to_rep1 (select (elts haystack) (+ i1 (length needle)))) (to_rep1 (select (elts needle) (+ (- (+ i1 (length needle)) k1) 1)))))))
(assert (=> (and (<= r58b1 k1) (<= k1 r59b1)) (forall ((l Int)) (=> (and (<= 1 l) (<= l k2)) (not (= (match_at needle haystack l) true))))))
(assert (=> (and (<= r58b1 k1) (<= k1 r59b1)) (and (=> (<= r58b1 r59b1) (dynamic_property3 r58b1 r59b1 k2)) (and (<= r58b1 k2) (<= k2 r59b1)))))
(assert (=> (and (<= r58b1 k1) (<= k1 r59b1)) (= k2 r59b1)))
(assert (=> (and (<= r58b1 k1) (<= k1 r59b1)) (= k3 (mk_int__ref k2))))
(assert (=> (and (<= r58b1 k1) (<= k1 r59b1)) (= k4 k2)))
(assert (=> (and (<= r58b1 k1) (<= k1 r59b1)) (= k5 k3)))
(assert (=> (and (<= r58b1 k1) (<= k1 r59b1)) (= k6 k4)))
(assert (=> (not (and (<= r58b1 k1) (<= k1 r59b1))) (= k5 (mk_int__ref k1))))
(assert (=> (not (and (<= r58b1 k1) (<= k1 r59b1))) (= k6 k1)))
(assert (<= i2 (- (length haystack) (length needle))))
(assert (forall ((k16 Int)) (=> (and (<= 1 k16) (<= k16 (- (+ i2 (to_rep (select bad_shift (to_rep1 (select (elts haystack) (+ i2 (length needle))))))) 1))) (not (= (match_at needle haystack k16) true)))))
(assert (and (and (and (and (and (=> (<= 1 2147483647) (in_range2 i2)) (=> (<= 1 2147483647) (in_range2 shift2))) (=> (<= 1 2147483647) (in_range2 r52b2))) (=> (<= (- 2147483648) 2147483647) (in_range1 r53b2))) (=> (<= (- 2147483648) 2147483647) (in_range1 r58b2))) (=> (<= (- 2147483648) 2147483647) (in_range1 r59b2))))
(assert (= result10 (mk_int__ref temp___342)))
(assert (= temp___3421 i2))
(assert (and (= o26 (length needle)) (in_range1 (length needle))))
(assert (= o27 (+ i2 o26)))
(assert (and (= temp___334 o27) (in_range1 o27)))
(assert (and (<= (to_rep2 (first (rt haystack))) temp___334) (<= temp___334 (to_rep2 (last (rt haystack))))))
(assert (= o28 temp___334))
(assert (= o29 (select (elts haystack) o28)))
(assert (= o30 (to_rep1 o29)))
(assert (= o31 (select bad_shift o30)))
...
(assert (= o41 (ite (<= i3 o40) true false)))
(assert (= result12 (ite (not (= o41 true)) true false)))
(assert (not (= result12 true)))
(assert (= result13 (mk_int__ref r52b2)))
(assert (= r52b3 i3))
(assert (in_range2 r52b3))
(assert (and (= o42 (- (to_rep2 (last (rt needle))) 1)) (in_range1 (- (to_rep2 (last (rt needle))) 1))))
(assert (= o43 (+ i3 o42)))
(assert (and (= o44 o43) (in_range1 o43)))
(assert (= result14 (mk_int__ref r53b2)))
(assert (= r53b3 o44))
(assert (in_range1 r53b3))
(assert (=> (<= r52b3 r53b3) (and (and (<= (to_rep2 (first (rt haystack))) r52b3) (<= r52b3 (to_rep2 (last (rt haystack))))) (and (<= (to_rep2 (first (rt haystack))) r53b3) (<= r53b3 (to_rep2 (last (rt haystack))))))))
(assert (= o45 (elts haystack)))
(assert (= o45 temp___3272))
(assert (= (mk1 r52b3 r53b3) temp___3273))
(assert (= result15 (bool_eq (elts needle) (to_rep2 (first (rt needle))) (to_rep2 (last (rt needle))) temp___3272 (to_rep2 (first2 temp___3273)) (to_rep2 (last2 temp___3273)))))
(assert (not (= result15 true)))
(assert (= string_search__qs__result4 (mk_int__ref string_search__qs__result3)))
(assert (= string_search__qs__result5 string_search__qs__result3))
(assert (and (= o46 (length needle)) (in_range1 (length needle))))
(assert (and (= o47 (length haystack)) (in_range1 (length haystack))))
(assert (= o48 (- o47 o46)))
(assert (and (= o49 o48) (in_range1 o48)))
(assert (= o50 (+ o49 1)))
(assert (and (= o51 o50) (in_range1 o50)))
(assert (= result16 (ite (= i3 o51) true false)))
(assert (not (= result16 true)))
(assert (and (= o52 (length needle)) (in_range1 (length needle))))
(assert (= o53 (+ i3 o52)))
(assert (and (= temp___3281 o53) (in_range1 o53)))
(assert (and (<= (to_rep2 (first (rt haystack))) temp___3281) (<= temp___3281 (to_rep2 (last (rt haystack))))))
(assert (= o54 temp___3281))
(assert (= o55 (select (elts haystack) o54)))
(assert (= o56 (to_rep1 o55)))
(assert (= o57 (select bad_shift o56)))
(assert (= o58 (to_rep o57)))
(assert (= result17 (mk_int__ref shift2)))
(assert (= shift3 o58))
(assert (in_range2 shift3))
(assert (and (= o59 (+ i3 1)) (in_range1 (+ i3 1))))
(assert (= result18 (mk_int__ref r58b2)))
(assert (= r58b3 o59))
(assert (in_range1 r58b3))
(assert (and (= o60 (+ i3 shift3)) (in_range1 (+ i3 shift3))))
(assert (= o61 (- o60 1)))
(assert (= result19 (mk_int__ref r59b2)))
(assert (= r59b3 o61))
(assert (in_range1 r59b3))
(assert (= result20 (mk_int__ref k7)))
(assert (= k8 r58b3))
(assert (=> (and (<= r58b3 k8) (<= k8 r59b3)) (= temp___3331 k8)))
(assert (=> (and (<= r58b3 k8) (<= k8 r59b3)) (not (= (to_rep1 (select (elts haystack) (+ i3 (length needle)))) (to_rep1 (select (elts needle) (+ (- (+ i3 (length needle)) k8) 1)))))))
(assert (=> (and (<= r58b3 k8) (<= k8 r59b3)) (forall ((l Int)) (=> (and (<= 1 l) (<= l k9)) (not (= (match_at needle haystack l) true))))))
(assert (=> (and (<= r58b3 k8) (<= k8 r59b3)) (and (=> (<= r58b3 r59b3) (dynamic_property3 r58b3 r59b3 k9)) (and (<= r58b3 k9) (<= k9 r59b3)))))
(assert (=> (and (<= r58b3 k8) (<= k8 r59b3)) (= k9 r59b3)))
(assert (=> (and (<= r58b3 k8) (<= k8 r59b3)) (= k10 (mk_int__ref k9))))
(assert (=> (and (<= r58b3 k8) (<= k8 r59b3)) (= k11 k9)))
(assert (=> (and (<= r58b3 k8) (<= k8 r59b3)) (= k12 k10)))
(assert (=> (and (<= r58b3 k8) (<= k8 r59b3)) (= k13 k11)))
(assert (=> (not (and (<= r58b3 k8) (<= k8 r59b3))) (= k12 (mk_int__ref k8))))
(assert (=> (not (and (<= r58b3 k8) (<= k8 r59b3))) (= k13 k8)))
(assert (= temp___3422 (mk_int__ref temp___3421)))
(assert (= string_search__qs__result6 string_search__qs__result4))
(assert (= k14 k12))
(assert (= r59b4 (mk_int__ref r59b3)))
(assert (= r58b4 (mk_int__ref r58b3)))
(assert (= shift4 (mk_int__ref shift3)))
(assert (= r53b4 (mk_int__ref r53b3)))
(assert (= r52b4 (mk_int__ref r52b3)))
(assert (= i4 (mk_int__ref i3)))
(assert (= temp___3423 temp___3421))
(assert (= string_search__qs__result7 string_search__qs__result5))
(assert (= k15 k13))
(assert (= r59b5 r59b3))
(assert (= r58b5 r58b3))
(assert (= shift5 shift3))
(assert (= r53b5 r53b3))
(assert (= r52b5 r52b3))
(assert (= i5 i3))
(declare-const k16 Int)
(assert (<= 1 k16))
(assert (<= k16 (- (+ (int__content i4) (to_rep (select bad_shift (to_rep1 (select (elts haystack) (+ (int__content i4) (length needle))))))) 1)))
(assert (not (not (= (match_at needle haystack k16) true))))
(check-sat)
(exit)
