...
(declare-const temp___3112 int__ref)
...
(assert (= k1 r58b1))
(assert (=> (and (<= r58b1 k1) (<= k1 r59b1)) (= temp___300 k1)))
...
(assert (and (and (and (and (and (=> (<= 1 2147483647) (in_range2 i2)) (=> (<= 1 2147483647) (in_range2 r52b2))) (=> (<= (- 2147483648) 2147483647) (in_range1 r53b2))) (=> (<= (- 2147483648) 2147483647) (in_range1 r58b2))) (=> (<= (- 2147483648) 2147483647) (in_range1 r59b2))) (=> (<= 1 2147483647) (in_range2 shift2))))
(assert (= result10 (mk_int__ref temp___311)))
(assert (= temp___3111 i2))
(assert (and (= o26 (length needle)) (in_range1 (length needle))))
(assert (= o27 (+ i2 o26)))
(assert (and (= temp___303 o27) (in_range1 o27)))
(assert (and (<= (to_rep2 (first (rt haystack))) temp___303) (<= temp___303 (to_rep2 (last (rt haystack))))))
(assert (= o28 temp___303))
...
(assert (= o45 temp___2962))
(assert (= (mk1 r52b3 r53b3) temp___2963))
(assert (= result15 (bool_eq (elts needle) (to_rep2 (first (rt needle))) (to_rep2 (last (rt needle))) temp___2962 (to_rep2 (first2 temp___2963)) (to_rep2 (last2 temp___2963)))))
...
(assert (= o53 (+ i3 o52)))
(assert (and (= temp___2971 o53) (in_range1 o53)))
(assert (and (<= (to_rep2 (first (rt haystack))) temp___2971) (<= temp___2971 (to_rep2 (last (rt haystack))))))
(assert (= o54 temp___2971))
...
(assert (= k8 r58b3))
(assert (=> (and (<= r58b3 k8) (<= k8 r59b3)) (= temp___3001 k8)))
...
(assert (= temp___3112 (mk_int__ref temp___3111)))
...
(assert (= temp___3113 temp___3111))
