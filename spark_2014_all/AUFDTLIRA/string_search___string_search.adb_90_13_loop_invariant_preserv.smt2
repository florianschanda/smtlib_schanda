...
(assert (= result13 (mk_int__ref temp___3112)))
(assert (= temp___3113 i2))
(assert (and (= o63 (length needle)) (in_range1 (length needle))))
(assert (= o64 (+ i2 o63)))
(assert (and (= temp___303 o64) (in_range1 o64)))
(assert (and (<= (to_rep2 (first (rt haystack))) temp___303) (<= temp___303 (to_rep2 (last (rt haystack))))))
(assert (= o65 temp___303))
(assert (= o66 (select (elts haystack) o65)))
(assert (= o67 (to_rep1 o66)))
(assert (= o68 (select bad_shift o67)))
(assert (= o69 (to_rep o68)))
(assert (= o70 (+ i2 o69)))
(assert (and (= o71 o70) (in_range1 o70)))
(assert (= result14 (mk_int__ref i2)))
(assert (= i3 o71))
(assert (and (= o72 (length needle)) (in_range1 (length needle))))
(assert (and (= o73 (length haystack)) (in_range1 (length haystack))))
(assert (= o74 (- o73 o72)))
(assert (and (= o75 o74) (in_range1 o74)))
(assert (= o76 (+ o75 1)))
(assert (and (= o77 o76) (in_range1 o76)))
(assert (= o78 (ite (<= i3 o77) true false)))
(assert (= result15 (ite (not (= o78 true)) true false)))
(assert (not (= result15 true)))
(assert (= result16 (mk_int__ref r52b3)))
(assert (= r52b4 i3))
(assert (in_range2 r52b4))
(assert (and (= o79 (- (to_rep2 (last (rt needle))) 1)) (in_range1 (- (to_rep2 (last (rt needle))) 1))))
(assert (= o80 (+ i3 o79)))
(assert (and (= o81 o80) (in_range1 o80)))
(assert (= result17 (mk_int__ref r53b3)))
(assert (= r53b4 o81))
(assert (in_range1 r53b4))
(assert (=> (<= r52b4 r53b4) (and (and (<= (to_rep2 (first (rt haystack))) r52b4) (<= r52b4 (to_rep2 (last (rt haystack))))) (and (<= (to_rep2 (first (rt haystack))) r53b4) (<= r53b4 (to_rep2 (last (rt haystack))))))))
(assert (= o82 (elts haystack)))
(assert (= o82 temp___2962))
(assert (= (mk1 r52b4 r53b4) temp___2963))
(assert (= result18 (bool_eq (elts needle) (to_rep2 (first (rt needle))) (to_rep2 (last (rt needle))) temp___2962 (to_rep2 (first2 temp___2963)) (to_rep2 (last2 temp___2963)))))
(assert (not (= result18 true)))
(assert (= string_search__qs__result5 (mk_int__ref string_search__qs__result3)))
(assert (= string_search__qs__result6 string_search__qs__result3))
(assert (and (= o83 (length needle)) (in_range1 (length needle))))
(assert (and (= o84 (length haystack)) (in_range1 (length haystack))))
(assert (= o85 (- o84 o83)))
(assert (and (= o86 o85) (in_range1 o85)))
(assert (= o87 (+ o86 1)))
(assert (and (= o88 o87) (in_range1 o87)))
(assert (= result20 (ite (= i3 o88) true false)))
(assert (not (= result20 true)))
(assert (and (= o89 (length needle)) (in_range1 (length needle))))
(assert (= o90 (+ i3 o89)))
(assert (and (= temp___2971 o90) (in_range1 o90)))
(assert (and (<= (to_rep2 (first (rt haystack))) temp___2971) (<= temp___2971 (to_rep2 (last (rt haystack))))))
(assert (= o91 temp___2971))
(assert (= o92 (select (elts haystack) o91)))
(assert (= o93 (to_rep1 o92)))
(assert (= o94 (select bad_shift o93)))
(assert (= o95 (to_rep o94)))
(assert (= result21 (mk_int__ref shift3)))
(assert (= shift4 o95))
(assert (in_range2 shift4))
(assert (and (= o96 (+ i3 1)) (in_range1 (+ i3 1))))
(assert (= result22 (mk_int__ref r58b3)))
(assert (= r58b4 o96))
(assert (in_range1 r58b4))
(assert (and (= o97 (+ i3 shift4)) (in_range1 (+ i3 shift4))))
(assert (= o98 (- o97 1)))
(assert (= result23 (mk_int__ref r59b3)))
(assert (= r59b4 o98))
(assert (in_range1 r59b4))
(assert (= result24 (mk_int__ref k12)))
(assert (= k13 r58b4))
(assert (=> (and (<= r58b4 k13) (<= k13 r59b4)) (and (and (= temp___3001 k13) (and (not (= (to_rep1 (select (elts haystack) (+ i3 (length needle)))) (to_rep1 (select (elts needle) (+ (- (+ i3 (length needle)) k13) 1))))) (and (forall ((l Int)) (=> (and (<= 1 l) (<= l k14)) (not (= (match_at needle haystack l) true)))) (and (and (=> (<= r58b4 r59b4) (dynamic_property3 r58b4 r59b4 k14)) (and (<= r58b4 k14) (<= k14 r59b4))) (= k14 r59b4))))) (and (= k20 (mk_int__ref k14)) (= k21 k14)))))
(assert (=> (and (<= r58b4 k13) (<= k13 r59b4)) (= k22 k20)))
(assert (=> (and (<= r58b4 k13) (<= k13 r59b4)) (= k23 k21)))
(assert (=> (not (and (<= r58b4 k13) (<= k13 r59b4))) (= k22 (mk_int__ref k13))))
(assert (=> (not (and (<= r58b4 k13) (<= k13 r59b4))) (= k23 k13)))
(assert (= temp___3114 (mk_int__ref temp___3113)))
(assert (= string_search__qs__result9 string_search__qs__result5))
(assert (= k24 k22))
(assert (= r59b5 (mk_int__ref r59b4)))
(assert (= r58b5 (mk_int__ref r58b4)))
(assert (= shift5 (mk_int__ref shift4)))
(assert (= r53b7 (mk_int__ref r53b4)))
(assert (= r52b7 (mk_int__ref r52b4)))
(assert (= i4 (mk_int__ref i3)))
(assert (= temp___3115 temp___3113))
(assert (= string_search__qs__result10 string_search__qs__result6))
(assert (= k25 k23))
(assert (= r59b6 r59b4))
(assert (= r58b6 r58b4))
(assert (= shift6 shift4))
(assert (= r53b8 r53b4))
(assert (= r52b8 r52b4))
(assert (= i5 i3))
(declare-const k38 Int)
(assert (<= 1 k38))
(assert (<= k38 (- (+ (int__content i4) (to_rep (select bad_shift (to_rep1 (select (elts haystack) (+ (int__content i4) (length needle))))))) 1)))
(assert (not (not (= (match_at needle haystack k38) true))))
(check-sat)
(exit)
