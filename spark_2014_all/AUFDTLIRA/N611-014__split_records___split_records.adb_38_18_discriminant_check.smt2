...
(assert (= (attr__constrained (rec__split_records__mutable_holder__content h2__split_fields3)) true))
(assert (not (= (distinct 0 0) (rec__split_records__record_with_mutable_discrs__present (us_split_discrs1 (rec__split_records__mutable_holder__content h2__split_fields3))))))
(check-sat)
(exit)
