...
(assert (=> (<= (to_rep (first (rt y))) (to_rep (last (rt y)))) (= o2 (+ (- (to_rep (last (rt y))) (to_rep (first (rt y)))) 1))))
(assert (=> (not (<= (to_rep (first (rt y))) (to_rep (last (rt y))))) (= o2 0)))
(assert (= o3 (+ 1 o2)))
...
(assert (= o7 (concat1 o1 (- 2147483648) (- 2147483648) (elts y) (to_rep (first (rt y))) (to_rep (last (rt y))))))
