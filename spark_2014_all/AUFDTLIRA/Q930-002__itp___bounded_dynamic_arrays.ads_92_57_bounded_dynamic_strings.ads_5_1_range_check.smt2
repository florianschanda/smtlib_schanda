...
(declare-const temp___1034 (Array Int character))
(declare-const temp___10341 t1)
...
(declare-const temp___1035 (Array Int character))
(declare-const temp___10351 t)
...
(define-fun bounded_dynamic_strings__Oconcat__2__result12 () us_rep (mk___rep (mk___split_discrs bounded_dynamic_strings__Oconcat__2__result4) (mk___split_fields bounded_dynamic_strings__Oconcat__2__result5 (mk___t2 bounded_dynamic_strings__Oconcat__2__result6 bounded_dynamic_strings__Oconcat__2__result7))))
(define-fun o18 () us_rep (mk___rep (mk___split_discrs o10) (mk___split_fields o11 (mk___t2 o12 o13))))
(define-fun o19 () us_t1 (mk___t1 o8 o9))
(define-fun temp___10342 () us_t1 (mk___t1 temp___1034 temp___10341))
...
(assert (and (= us (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 left)))) (in_range4 (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 left))))))
(assert (= bounded_dynamic_strings__Oconcat__2__result8 (mk_sequence__ref bounded_dynamic_strings__Oconcat__2__result12)))
(assert (= bounded_dynamic_strings__Oconcat__2__result9 bounded_dynamic_strings__Oconcat__2__result12))
(assert (and (= temp___10342 (value left)) (and (dynamic_invariant temp___10342 true false true true) (and (and (= (elts2 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 left))) temp___1034) (= (mk1 (to_rep1 (first6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 left)))))) (to_rep1 (last6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 left))))))) temp___10341)) (and (and (and (= (length1 temp___10342) (length3 left)) (= (to_rep1 (first2 temp___10341)) 1)) (= (to_rep1 (last2 temp___10341)) (length3 left))) (= (< 0 (length3 left)) (not (= (empty left) true))))))))
(assert (=> (= (length1 temp___10342) 0) (= (elts1 right) temp___1035)))
(assert (=> (= (length1 temp___10342) 0) (= (mk (to_rep1 (first2 (rt1 right))) (to_rep1 (last2 (rt1 right)))) temp___10351)))
(assert (=> (not (= (length1 temp___10342) 0)) (=> (<= (to_rep1 (first2 (rt1 right))) (to_rep1 (last2 (rt1 right)))) (= o2 (+ (- (to_rep1 (last2 (rt1 right))) (to_rep1 (first2 (rt1 right)))) 1)))))
(assert (=> (not (= (length1 temp___10342) 0)) (=> (not (<= (to_rep1 (first2 (rt1 right))) (to_rep1 (last2 (rt1 right))))) (= o2 0))))
(assert (=> (not (= (length1 temp___10342) 0)) (=> (<= (to_rep1 (first2 temp___10341)) (to_rep1 (last2 temp___10341))) (= o3 (+ (- (to_rep1 (last2 temp___10341)) (to_rep1 (first2 temp___10341))) 1)))))
(assert (=> (not (= (length1 temp___10342) 0)) (=> (not (<= (to_rep1 (first2 temp___10341)) (to_rep1 (last2 temp___10341)))) (= o3 0))))
(assert (=> (not (= (length1 temp___10342) 0)) (= o4 (+ o3 o2))))
(assert (=> (not (= (length1 temp___10342) 0)) (= o5 (+ (to_rep1 (first2 temp___10341)) o4))))
(assert (=> (not (= (length1 temp___10342) 0)) (= o6 (- o5 1))))
(assert (=> (not (= (length1 temp___10342) 0)) (and (= o7 o6) (in_range2 o6))))
(assert (=> (not (= (length1 temp___10342) 0)) (= (concat1 temp___1034 (to_rep1 (first2 temp___10341)) (to_rep1 (last2 temp___10341)) (elts1 right) (to_rep1 (first2 (rt1 right))) (to_rep1 (last2 (rt1 right)))) temp___1035)))
(assert (=> (not (= (length1 temp___10342) 0)) (= (mk (to_rep1 (first2 temp___10341)) o7) temp___10351)))
(assert (dynamic_property1 1 2147483647 (to_rep1 (first temp___10351)) (to_rep1 (last temp___10351))))
(assert (= temp___1035 o8))
(assert (= (mk1 (to_rep1 (first temp___10351)) (to_rep1 (last temp___10351))) o9))
(assert (and (= o (length1 right)) (in_range1 (length1 right))))
(assert (= o1 (+ (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 left))) o)))
(assert (and (= o18 (instance o1 o19)) (and (dynamic_invariant1 o18 true false true true) (and (and (= (to_rep2 o10) o1) (= (length3 o18) (length1 o19))) (= (let ((temp___270 (value o18))) (bool_eq (elts1 temp___270) (to_rep1 (first2 (rt1 temp___270))) (to_rep1 (last2 (rt1 temp___270))) o8 (to_rep1 (first2 o9)) (to_rep1 (last2 o9)))) true)))))
(assert (= (mk_sequence__ref (mk___rep (mk___split_discrs result) (mk___split_fields result1 (mk___t2 result2 result3)))) (mk_sequence__ref (mk___rep (mk___split_discrs bounded_dynamic_strings__Oconcat__2__result) (mk___split_fields bounded_dynamic_strings__Oconcat__2__result1 (mk___t2 bounded_dynamic_strings__Oconcat__2__result2 bounded_dynamic_strings__Oconcat__2__result3))))))
(assert (= bounded_dynamic_strings__Oconcat__2__result12 o18))
(assert (= bounded_dynamic_strings__Oconcat__2__result10 bounded_dynamic_strings__Oconcat__2__result8))
(assert (= bounded_dynamic_strings__Oconcat__2__result11 bounded_dynamic_strings__Oconcat__2__result9))
(assert (and (= o14 (length1 right)) (in_range1 (length1 right))))
(assert (and (= o15 (length3 left)) (and (in_range4 o15) (= o15 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 left)))))))
(assert (= o16 (+ o15 o14)))
(assert (= o17 (ite (= (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 (sequence__content bounded_dynamic_strings__Oconcat__2__result10)))) o16) true false)))
