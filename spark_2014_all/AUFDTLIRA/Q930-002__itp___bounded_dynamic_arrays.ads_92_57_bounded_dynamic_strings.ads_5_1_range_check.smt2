...
(declare-const bounded_dynamic_strings__Oconcat__2__result3 t1)
(declare-const o Int)
...
(declare-const bounded_dynamic_strings__Oconcat__2__result7 t1)
...
(define-fun bounded_dynamic_strings__Oconcat__2__result12 () us_rep (mk___rep (mk___split_discrs bounded_dynamic_strings__Oconcat__2__result4) (mk___split_fields bounded_dynamic_strings__Oconcat__2__result5 (mk___t1 bounded_dynamic_strings__Oconcat__2__result6 bounded_dynamic_strings__Oconcat__2__result7))))
(define-fun o18 () us_rep (mk___rep (mk___split_discrs o10) (mk___split_fields o11 (mk___t1 o12 o13))))
(define-fun o19 () us_t2 (mk___t2 o8 o9))
...
(assert (=> (not (= (length3 temp___10402) 0)) (=> (<= (to_rep1 (first4 (rt2 right))) (to_rep1 (last4 (rt2 right)))) (= o2 (+ (- (to_rep1 (last4 (rt2 right))) (to_rep1 (first4 (rt2 right)))) 1)))))
(assert (=> (not (= (length3 temp___10402) 0)) (=> (not (<= (to_rep1 (first4 (rt2 right))) (to_rep1 (last4 (rt2 right))))) (= o2 0))))
(assert (=> (not (= (length3 temp___10402) 0)) (=> (<= (to_rep1 (first4 temp___10401)) (to_rep1 (last4 temp___10401))) (= o3 (+ (- (to_rep1 (last4 temp___10401)) (to_rep1 (first4 temp___10401))) 1)))))
(assert (=> (not (= (length3 temp___10402) 0)) (=> (not (<= (to_rep1 (first4 temp___10401)) (to_rep1 (last4 temp___10401)))) (= o3 0))))
(assert (=> (not (= (length3 temp___10402) 0)) (= o4 (+ o3 o2))))
(assert (=> (not (= (length3 temp___10402) 0)) (= o5 (+ (to_rep1 (first4 temp___10401)) o4))))
(assert (=> (not (= (length3 temp___10402) 0)) (= o6 (- o5 1))))
(assert (=> (not (= (length3 temp___10402) 0)) (and (= o7 o6) (in_range2 o6))))
...
(assert (=> (not (= (length3 temp___10402) 0)) (= (mk (to_rep1 (first4 temp___10401)) o7) temp___10411)))
(assert (dynamic_property3 1 2147483647 (to_rep1 (first temp___10411)) (to_rep1 (last temp___10411))))
(assert (= temp___1041 o8))
(assert (= (mk2 (to_rep1 (first temp___10411)) (to_rep1 (last temp___10411))) o9))
(assert (and (= o (length3 right)) (in_range1 (length3 right))))
(assert (= o1 (+ (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 left))) o)))
(assert (and (= o18 (instance o1 o19)) (and (dynamic_invariant1 o18 true false true true) (and (and (= (to_rep2 o10) o1) (= (length2 o18) (length3 o19))) (= (let ((temp___274 (value o18))) (bool_eq (elts2 temp___274) (to_rep1 (first4 (rt2 temp___274))) (to_rep1 (last4 (rt2 temp___274))) o8 (to_rep1 (first4 o9)) (to_rep1 (last4 o9)))) true)))))
(assert (= (mk_sequence__ref (mk___rep (mk___split_discrs result) (mk___split_fields result1 (mk___t1 result2 result3)))) (mk_sequence__ref (mk___rep (mk___split_discrs bounded_dynamic_strings__Oconcat__2__result) (mk___split_fields bounded_dynamic_strings__Oconcat__2__result1 (mk___t1 bounded_dynamic_strings__Oconcat__2__result2 bounded_dynamic_strings__Oconcat__2__result3))))))
...
(assert (and (= o14 (length3 right)) (in_range1 (length3 right))))
(assert (and (= o15 (length2 left)) (and (in_range4 o15) (= o15 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 left)))))))
(assert (= o16 (+ o15 o14)))
