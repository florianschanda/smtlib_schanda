...
(assert (and (and (and (= us (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 left)))) (in_range4 (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 left))))) (and (and (= bounded_dynamic_strings__Oconcat__2__result8 (mk_sequence__ref (mk___rep (mk___split_discrs bounded_dynamic_strings__Oconcat__2__result4) (mk___split_fields bounded_dynamic_strings__Oconcat__2__result5 (mk___t2 bounded_dynamic_strings__Oconcat__2__result6 bounded_dynamic_strings__Oconcat__2__result7))))) (= bounded_dynamic_strings__Oconcat__2__result9 (mk___rep (mk___split_discrs bounded_dynamic_strings__Oconcat__2__result4) (mk___split_fields bounded_dynamic_strings__Oconcat__2__result5 (mk___t2 bounded_dynamic_strings__Oconcat__2__result6 bounded_dynamic_strings__Oconcat__2__result7))))) (and (and (and (and (and (= (mk___t1 temp___971 temp___9711) (value left)) (and (dynamic_invariant (mk___t1 temp___971 temp___9711) true false true) (and (and (= (elts2 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 left))) temp___971) (= (mk1 (to_rep1 (first6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 left)))))) (to_rep1 (last6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 left))))))) temp___9711)) (and (and (and (= (length1 (mk___t1 temp___971 temp___9711)) (length3 left)) (= (to_rep1 (first2 temp___9711)) 1)) (= (to_rep1 (last2 temp___9711)) (length3 left))) (= (< 0 (length3 left)) (not (= (empty left) true))))))) (ite (= (length1 (mk___t1 temp___971 temp___9711)) 0) (and (= (elts1 right) temp___972) (= (mk (to_rep1 (first2 (rt1 right))) (to_rep1 (last2 (rt1 right)))) temp___9721)) (and (and (and (and (and (ite (<= (to_rep1 (first2 (rt1 right))) (to_rep1 (last2 (rt1 right)))) (= o3 (+ (- (to_rep1 (last2 (rt1 right))) (to_rep1 (first2 (rt1 right)))) 1)) (= o3 0)) (and (ite (<= (to_rep1 (first2 temp___9711)) (to_rep1 (last2 temp___9711))) (= o4 (+ (- (to_rep1 (last2 temp___9711)) (to_rep1 (first2 temp___9711))) 1)) (= o4 0)) (= o5 (+ o4 o3)))) (= o6 (+ (to_rep1 (first2 temp___9711)) o5))) (= o7 (- o6 1))) (and (= o8 o7) (in_range2 o7))) (and (= (concat1 temp___971 (to_rep1 (first2 temp___9711)) (to_rep1 (last2 temp___9711)) (elts1 right) (to_rep1 (first2 (rt1 right))) (to_rep1 (last2 (rt1 right)))) temp___972) (= (mk (to_rep1 (first2 temp___9711)) o8) temp___9721))))) (and (dynamic_property1 1 2147483647 (to_rep1 (first temp___9721)) (to_rep1 (last temp___9721))) (and (= temp___972 o9) (= (mk1 (to_rep1 (first temp___9721)) (to_rep1 (last temp___9721))) o10)))) (and (and (and (= o1 (length1 right)) (in_range1 (length1 right))) (= o2 (+ (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 left))) o1))) (and (= (mk___rep (mk___split_discrs o11) (mk___split_fields o12 (mk___t2 o13 o14))) (instance o2 (mk___t1 o9 o10))) (and (dynamic_invariant1 (mk___rep (mk___split_discrs o11) (mk___split_fields o12 (mk___t2 o13 o14))) true false true) (and (and (= (to_rep2 o11) o2) (= (length3 (mk___rep (mk___split_discrs o11) (mk___split_fields o12 (mk___t2 o13 o14)))) (length1 (mk___t1 o9 o10)))) (= (let ((temp___241 (value (mk___rep (mk___split_discrs o11) (mk___split_fields o12 (mk___t2 o13 o14)))))) (bool_eq (elts1 temp___241) (to_rep1 (first2 (rt1 temp___241))) (to_rep1 (last2 (rt1 temp___241))) o9 (to_rep1 (first2 o10)) (to_rep1 (last2 o10)))) true)))))) (and (= (mk_sequence__ref (mk___rep (mk___split_discrs result) (mk___split_fields result1 (mk___t2 result2 result3)))) (mk_sequence__ref (mk___rep (mk___split_discrs bounded_dynamic_strings__Oconcat__2__result) (mk___split_fields bounded_dynamic_strings__Oconcat__2__result1 (mk___t2 bounded_dynamic_strings__Oconcat__2__result2 bounded_dynamic_strings__Oconcat__2__result3))))) (= (mk___rep (mk___split_discrs bounded_dynamic_strings__Oconcat__2__result4) (mk___split_fields bounded_dynamic_strings__Oconcat__2__result5 (mk___t2 bounded_dynamic_strings__Oconcat__2__result6 bounded_dynamic_strings__Oconcat__2__result7))) (mk___rep (mk___split_discrs o11) (mk___split_fields o12 (mk___t2 o13 o14)))))))) (and (= bounded_dynamic_strings__Oconcat__2__result10 bounded_dynamic_strings__Oconcat__2__result8) (= bounded_dynamic_strings__Oconcat__2__result11 bounded_dynamic_strings__Oconcat__2__result9))))
(assert (and (= o26 (length1 right)) (in_range1 (length1 right))))
(assert (and (= o27 (length3 left)) (and (in_range4 o27) (= o27 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 left)))))))
(assert (= o28 (+ o27 o26)))
(assert (= o29 (ite (= (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 (sequence__content bounded_dynamic_strings__Oconcat__2__result10)))) o28) true false)))
