...
(declare-const result12 us_rep)
(declare-const result13 us_rep)
(assert (= (is_empty avail) true))
(assert (= (is_empty alloc) true))
(assert (= (mk_int__ref result) (mk_int__ref r)))
(assert (= r1 1))
(assert (=> (and (<= 1 r1) (<= r1 3)) (and (and (= temp___368 alloc) (and (= temp___367 avail) (and (= temp___366 r1) (and (ite (= (to_rep (select data r1)) 0) (and (and (and (= o (add avail r1)) (= (is_add avail r1 o) true)) (and (= (mk_set__ref result1) (mk_set__ref avail)) (= avail2 o))) (and (= alloc2 alloc) (= alloc2 alloc1))) (and (and (and (= o1 (add alloc r1)) (= (is_add alloc r1 o1) true)) (and (= (mk_set__ref result2) (mk_set__ref alloc)) (= alloc2 o1))) (and (= avail2 avail) (= avail2 avail1)))) (and (and (and (forall ((e2 Int)) (=> (and (in_range3 e2) (= (mem avail3 e2) true)) (and (<= 1 e2) (<= e2 r2)))) (forall ((e2 Int)) (=> (and (in_range3 e2) (= (mem alloc3 e2) true)) (and (<= 1 e2) (<= e2 r2))))) (forall ((rr1 Int)) (=> (and (<= 1 rr1) (<= rr1 r2)) (ite (= (to_rep (select data rr1)) 0) (and (= (mem avail3 rr1) true) (not (= (mem alloc3 rr1) true))) (and (not (= (mem avail3 rr1) true)) (= (mem alloc3 rr1) true)))))) (and (and (=> (<= 1 3) (in_range1 r2)) (and (<= 1 r2) (<= r2 3))) (= r2 3))))))) (and (and (= r2 r6) (and (= alloc3 alloc7) (= avail3 avail7))) (and (= r7 r2) (and (= alloc8 alloc3) (= avail8 avail3)))))))
(assert (=> (and (<= 1 r1) (<= r1 3)) (= r8 (mk_int__ref r6))))
(assert (=> (and (<= 1 r1) (<= r1 3)) (= (mk_set__ref alloc9) (mk_set__ref alloc7))))
(assert (=> (and (<= 1 r1) (<= r1 3)) (= (mk_set__ref avail9) (mk_set__ref avail7))))
(assert (=> (and (<= 1 r1) (<= r1 3)) (= r9 r7)))
(assert (=> (and (<= 1 r1) (<= r1 3)) (= alloc10 alloc8)))
(assert (=> (and (<= 1 r1) (<= r1 3)) (= avail10 avail8)))
(assert (=> (not (and (<= 1 r1) (<= r1 3))) (= r8 (mk_int__ref r1))))
(assert (=> (not (and (<= 1 r1) (<= r1 3))) (= (mk_set__ref alloc9) (mk_set__ref alloc))))
(assert (=> (not (and (<= 1 r1) (<= r1 3))) (= (mk_set__ref avail9) (mk_set__ref avail))))
(assert (=> (not (and (<= 1 r1) (<= r1 3))) (= r9 r1)))
(assert (=> (not (and (<= 1 r1) (<= r1 3))) (= alloc10 alloc1)))
(assert (=> (not (and (<= 1 r1) (<= r1 3))) (= avail10 avail1)))
...
(assert (= result11 (mk_t__ref (mk___rep (mk___split_fields allocator__m__model__result allocator__m__model__result1)))))
(assert (= allocator__m__model__result2 (mk___rep (mk___split_fields avail9 alloc9))))
(assert (= allocator__m__model__result5 allocator__m__model__result3))
(assert (= r10 r8))
(assert (= alloc11 (mk_set__ref alloc9)))
(assert (= avail11 (mk_set__ref avail9)))
(assert (= allocator__m__model__result6 allocator__m__model__result4))
(assert (= r11 r9))
(assert (= alloc12 alloc10))
(assert (= avail12 avail10))
(assert (= (mk___rep (mk___split_fields result12 result13)) (t__content allocator__m__model__result5)))
