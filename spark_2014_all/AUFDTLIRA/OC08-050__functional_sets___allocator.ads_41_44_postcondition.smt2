...
(declare-const temp___400 us_rep)
(declare-const temp___399 us_rep)
...
(define-fun alloc10 () set__ref (mk_set__ref alloc6))
(define-fun avail10 () set__ref (mk_set__ref avail6))
(define-fun alloc11 () set__ref (mk_set__ref alloc))
(define-fun avail11 () set__ref (mk_set__ref avail))
...
(assert (= r1 1))
(assert (=> (and (<= 1 r1) (<= r1 3)) (= temp___400 alloc)))
(assert (=> (and (<= 1 r1) (<= r1 3)) (= temp___399 avail)))
(assert (=> (and (<= 1 r1) (<= r1 3)) (= temp___398 r1)))
(assert (=> (and (<= 1 r1) (<= r1 3)) (=> (= (to_rep (select data r1)) 0) (and (= o (add avail r1)) (= (is_add avail r1 o) true)))))
(assert (=> (and (<= 1 r1) (<= r1 3)) (=> (= (to_rep (select data r1)) 0) (= (mk_set__ref result1) avail11))))
(assert (=> (and (<= 1 r1) (<= r1 3)) (=> (= (to_rep (select data r1)) 0) (= avail2 o))))
(assert (=> (and (<= 1 r1) (<= r1 3)) (=> (= (to_rep (select data r1)) 0) (= alloc2 alloc))))
(assert (=> (and (<= 1 r1) (<= r1 3)) (=> (= (to_rep (select data r1)) 0) (= alloc2 alloc1))))
(assert (=> (and (<= 1 r1) (<= r1 3)) (=> (not (= (to_rep (select data r1)) 0)) (and (= o1 (add alloc r1)) (= (is_add alloc r1 o1) true)))))
(assert (=> (and (<= 1 r1) (<= r1 3)) (=> (not (= (to_rep (select data r1)) 0)) (= (mk_set__ref result2) alloc11))))
(assert (=> (and (<= 1 r1) (<= r1 3)) (=> (not (= (to_rep (select data r1)) 0)) (= alloc2 o1))))
(assert (=> (and (<= 1 r1) (<= r1 3)) (=> (not (= (to_rep (select data r1)) 0)) (= avail2 avail))))
(assert (=> (and (<= 1 r1) (<= r1 3)) (=> (not (= (to_rep (select data r1)) 0)) (= avail2 avail1))))
(assert (=> (and (<= 1 r1) (<= r1 3)) (and (and (forall ((e Int)) (=> (and (in_range3 e) (= (mem avail3 e) true)) (and (<= 1 e) (<= e r2)))) (forall ((e Int)) (=> (and (in_range3 e) (= (mem alloc3 e) true)) (and (<= 1 e) (<= e r2))))) (forall ((rr Int)) (=> (and (<= 1 rr) (<= rr r2)) (ite (= (to_rep (select data rr)) 0) (and (= (mem avail3 rr) true) (not (= (mem alloc3 rr) true))) (and (not (= (mem avail3 rr) true)) (= (mem alloc3 rr) true))))))))
(assert (=> (and (<= 1 r1) (<= r1 3)) (and (=> (<= 1 3) (in_range1 r2)) (and (<= 1 r2) (<= r2 3)))))
(assert (=> (and (<= 1 r1) (<= r1 3)) (= r2 3)))
(assert (=> (and (<= 1 r1) (<= r1 3)) (= r2 r3)))
(assert (=> (and (<= 1 r1) (<= r1 3)) (= alloc3 alloc4)))
(assert (=> (and (<= 1 r1) (<= r1 3)) (= avail3 avail4)))
(assert (=> (and (<= 1 r1) (<= r1 3)) (= r4 r2)))
(assert (=> (and (<= 1 r1) (<= r1 3)) (= alloc5 alloc3)))
(assert (=> (and (<= 1 r1) (<= r1 3)) (= avail5 avail3)))
(assert (=> (and (<= 1 r1) (<= r1 3)) (= r5 (mk_int__ref r3))))
(assert (=> (and (<= 1 r1) (<= r1 3)) (= alloc10 (mk_set__ref alloc4))))
(assert (=> (and (<= 1 r1) (<= r1 3)) (= avail10 (mk_set__ref avail4))))
(assert (=> (and (<= 1 r1) (<= r1 3)) (= r6 r4)))
(assert (=> (and (<= 1 r1) (<= r1 3)) (= alloc7 alloc5)))
(assert (=> (and (<= 1 r1) (<= r1 3)) (= avail7 avail5)))
(assert (=> (not (and (<= 1 r1) (<= r1 3))) (= r5 (mk_int__ref r1))))
(assert (=> (not (and (<= 1 r1) (<= r1 3))) (= alloc10 alloc11)))
(assert (=> (not (and (<= 1 r1) (<= r1 3))) (= avail10 avail11)))
(assert (=> (not (and (<= 1 r1) (<= r1 3))) (= r6 r1)))
(assert (=> (not (and (<= 1 r1) (<= r1 3))) (= alloc7 alloc1)))
(assert (=> (not (and (<= 1 r1) (<= r1 3))) (= avail7 avail1)))
(assert (= allocator__m__model__result3 (mk_t__ref allocator__m__model__result2)))
(assert (= allocator__m__model__result4 allocator__m__model__result2))
(assert (= result3 (mk_t__ref (mk___rep (mk___split_fields allocator__m__model__result allocator__m__model__result1)))))
(assert (= allocator__m__model__result2 (mk___rep (mk___split_fields avail6 alloc6))))
(assert (= allocator__m__model__result5 allocator__m__model__result3))
(assert (= r7 r5))
(assert (= alloc8 alloc10))
(assert (= avail8 avail10))
(assert (= allocator__m__model__result6 allocator__m__model__result4))
(assert (= r8 r6))
(assert (= alloc9 alloc7))
(assert (= avail9 avail7))
(assert (= (mk___rep (mk___split_fields result4 result5)) (t__content allocator__m__model__result5)))
(assert (not (= (is_valid (t__content allocator__m__model__result5) data) true)))
(check-sat)
(exit)
