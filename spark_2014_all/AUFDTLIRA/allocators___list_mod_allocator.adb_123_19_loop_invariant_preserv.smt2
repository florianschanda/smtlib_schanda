...
(assert (not (= (int__content r13) (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select data (get (sequence__content avail5) (length (sequence__content avail5))))))))))
(check-sat)
(exit)
