...
(assert (<= i_v12 k_1))
(assert (forall ((m12 Int)) (=> (and (<= (to_rep a_v1__first) m12) (<= m12 (- i_v13 1))) (= (to_rep (select a_v12 m12)) (to_rep (select (elts b_v1) m12))))))
(assert (and (and (forall ((temp___432 Int)) (=> (and (<= (to_rep a_v1__first) temp___432) (<= temp___432 (to_rep a_v1__last))) (=> (<= i_v13 temp___432) (= (select a_v12 temp___432) (select a_v1 temp___432))))) (=> (<= (to_rep a_v1__first) k_1) (dynamic_property1 (to_rep a_v1__first) k_1 i_v13))) (and (<= (to_rep a_v1__first) i_v13) (<= i_v13 k_1))))
(assert (and (<= (to_rep (first (rt b_v1))) i_v13) (<= i_v13 (to_rep (last (rt b_v1))))))
(assert (= o9 i_v13))
(assert (= o10 (select (elts b_v1) o9)))
(assert (= o11 (to_rep o10)))
(assert (= (to_rep o12) o11))
(assert (not (<= (to_rep a_v1__first) i_v13)))
(check-sat)
(exit)
