...
(assert (and (and (forall ((temp___475 Int)) (=> (and (<= (to_rep a_v1__first) temp___475) (<= temp___475 (to_rep a_v1__last))) (=> (<= i_v12 temp___475) (= (select a_v11 temp___475) (select a_v1 temp___475))))) (=> (<= (to_rep a_v1__first) k_1) (dynamic_property1 (to_rep a_v1__first) k_1 i_v12))) (and (<= (to_rep a_v1__first) i_v12) (<= i_v12 k_1))))
