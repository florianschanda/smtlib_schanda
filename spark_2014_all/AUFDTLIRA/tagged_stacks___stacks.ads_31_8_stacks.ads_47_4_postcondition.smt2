...
(define-fun dynamic_property5 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range low) (and (in_range high) (=> (<= low high) (and (in_range4 low) (in_range4 high))))))
...
(assert (and (<= 1 (to_rep2 s__split_fields1)) (<= (to_rep2 s__split_fields1) 100)))
(assert (= o (to_rep2 s__split_fields1)))
(assert (= o1 (select s__split_fields o)))
(assert (= o2 (to_rep1 o1)))
(assert (= (mk_int__ref result) (mk_int__ref e)))
(assert (= e1 o2))
(assert (and (= o3 (- (to_rep2 s__split_fields1) 1)) (in_range3 (- (to_rep2 s__split_fields1) 1))))
...
(assert (not (= (let ((temp___529 (get_model__2 (mk___rep (mk___split_fields s__split_fields6 s__split_fields7 s__split_fields8) s__attr__tag)))) (bool_eq (elts temp___529) (to_rep (first (rt temp___529))) (to_rep (last (rt temp___529))) (elts (get_model__2 (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag))) (to_rep (first2 (mk1 (to_rep (first (rt (get_model__2 (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag))))) (- (to_rep (last (rt (get_model__2 (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag))))) 1)))) (to_rep (last2 (mk1 (to_rep (first (rt (get_model__2 (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag))))) (- (to_rep (last (rt (get_model__2 (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag))))) 1)))))) true)))
(check-sat)
(exit)
