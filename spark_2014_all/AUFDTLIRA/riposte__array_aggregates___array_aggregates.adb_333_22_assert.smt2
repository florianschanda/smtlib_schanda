...
(declare-fun temp___642 (Int Int Int) (Array Int enum_t))
...
(assert (forall ((temp___644 Int) (temp___645 Int) (temp___646 Int)) (let ((temp___643 (temp___642 temp___644 temp___645 temp___646))) (=> (and (and (dynamic_invariant1 temp___644 true true true true) (dynamic_invariant1 temp___645 true true true true)) (dynamic_invariant1 temp___646 true true true true)) (forall ((temp___647 Int)) (ite (= temp___647 1000) (= (to_rep (select temp___643 temp___647)) temp___645) (ite (or (= temp___647 2) (and (<= 4 temp___647) (<= temp___647 6))) (= (to_rep (select temp___643 temp___647)) temp___644) (= (to_rep (select temp___643 temp___647)) temp___646))))))))
(declare-const x (Array Int enum_t))
(declare-const result (Array Int enum_t))
(declare-const x1 (Array Int enum_t))
(assert (in_range2 n))
(assert (= result x))
(assert (= x1 (temp___642 0 2 1)))
(assert (not (= (to_rep (select x1 n)) 2)))
(check-sat)
(exit)
