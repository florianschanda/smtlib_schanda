...
(assert (forall ((temp___644 Int) (temp___645 Int) (temp___646 Int)) (let ((temp___643 (temp_____aggregate_def_642 temp___644 temp___645 temp___646))) (=> (and (and (dynamic_invariant1 temp___644 true true true true) (dynamic_invariant1 temp___645 true true true true)) (dynamic_invariant1 temp___646 true true true true)) (forall ((temp___647 Int)) (ite (= temp___647 1000) (= (to_rep (select temp___643 temp___647)) temp___645) (ite (or (= temp___647 2) (and (<= 4 temp___647) (<= temp___647 6))) (= (to_rep (select temp___643 temp___647)) temp___644) (= (to_rep (select temp___643 temp___647)) temp___646))))))))
