...
(declare-fun add__2 (us_rep Int Int) us_rep)
(declare-fun add__2__function_guard (us_rep us_rep Int Int) Bool)
...
(define-fun dynamic_invariant ((temp___expr_193 Int) (temp___is_init_189 Bool) (temp___skip_constant_190 Bool) (temp___do_toplevel_191 Bool) (temp___do_typ_inv_192 Bool)) Bool (=> (or (= temp___is_init_189 true) (<= 1 2147483647)) (in_range1 temp___expr_193)))
...
(define-fun dynamic_invariant2 ((temp___expr_222 Int) (temp___is_init_218 Bool) (temp___skip_constant_219 Bool) (temp___do_toplevel_220 Bool) (temp___do_typ_inv_221 Bool)) Bool (=> (or (= temp___is_init_218 true) (<= 0 10000)) (in_range3 temp___expr_222)))
...
(assert (forall ((container us_rep1)) (forall ((item Int)) (! (=> (dynamic_invariant2 item true true true true) (=> (= (distinct 1 0) true) (=> (exists ((e Int)) (and (and (in_range3 e) (= (contains container e) true)) (= e item))) (= (contains container item) true)))) :pattern ((contains container item))))))
...
(assert (forall ((container us_rep1)) (forall ((item Int)) (! (=> (and (dynamic_invariant2 item true true true true) (= (contains container item) true)) (let ((result (remove container item))) (and (and (and (= (length1 result) (- (length1 container) 1)) (not (= (contains result item) true))) (= (ole result container) true)) (= (included_except container result item) true)))) :pattern ((remove container item))))))
...
(assert (forall ((container us_rep)) (forall ((position Int)) (! (=> (and (dynamic_invariant7 position true true true true) (and (<= 1 position) (<= position (last container)))) (dynamic_invariant1 (get container position) true false true true)) :pattern ((get container position))))))
(assert (forall ((container us_rep1)) (! (dynamic_invariant6 (length1 container) true false true true) :pattern ((length1 container)))))
...
(assert (forall ((container us_rep1)) (! (let ((result (is_empty container))) (and (= (= result true) (forall ((item Int)) (not (and (in_range3 item) (= (contains container item) true))))) (= (= result true) (= (length1 container) 0)))) :pattern ((is_empty container)))))
(assert (forall ((left us_rep1) (right us_rep1)) (forall ((item Int)) (! (=> (dynamic_invariant2 item true true true true) (= (= (included_except left right item) true) (forall ((e Int)) (=> (and (in_range3 e) (= (contains left e) true)) (or (= (contains right e) true) (= e item)))))) :pattern ((included_except left right item))))))
...
(assert (=> (not (= res 0)) (= (mk___rep1 (mk___split_fields1 o1 o2)) (select data o))))
...
(assert (= o13 res))
(assert (= o14 (store data o13 (mk___rep1 (mk___split_fields1 o11 o12)))))
...
(assert (and (= o15 (remove model____split_fields1 res)) (and (and (and (= (length1 o15) (- (length1 model____split_fields1) 1)) (not (= (contains o15 res) true))) (= (ole o15 model____split_fields1) true)) (= (included_except model____split_fields1 o15 res) true))))
(assert (= model____split_fields o16))
(assert (= o15 o17))
(assert (= temp___331 o16))
(assert (= temp___3311 o17))
(assert (= (mk___split_fields__ref (mk___split_fields result3 result4)) (mk___split_fields__ref (mk___split_fields model____split_fields model____split_fields1))))
(assert (= model____split_fields2 (mk___split_fields temp___331 temp___3311)))
(assert (not (< (last (rec__list_allocator__m__t__available model____split_fields2)) 2147483647)))
(check-sat)
(exit)
