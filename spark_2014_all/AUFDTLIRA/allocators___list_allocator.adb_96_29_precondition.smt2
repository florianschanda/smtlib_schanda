...
(assert (= o15 o17))
(assert (= temp___294 o16))
(assert (= temp___2941 o17))
(assert (= (mk___split_fields__ref1 (mk___split_fields1 result3 result4)) (mk___split_fields__ref1 (mk___split_fields1 model____split_fields model____split_fields1))))
(assert (= model____split_fields4 (mk___split_fields1 temp___294 temp___2941)))
(assert (not (< (length (rec__list_allocator__m__t__available model____split_fields4)) 2147483647)))
(check-sat)
(exit)
