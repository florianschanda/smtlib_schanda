...
(assert (= model____split_fields2 (mk___split_fields1 temp___331 temp___3311)))
(assert (not (< (length (rec__list_allocator__m__t__available model____split_fields2)) 2147483647)))
(check-sat)
(exit)
