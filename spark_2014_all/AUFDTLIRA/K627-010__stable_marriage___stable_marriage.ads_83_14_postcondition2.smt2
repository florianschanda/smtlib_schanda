...
(assert (and (= o (invert_2 r2)) (and (forall ((rank Int)) (=> (and (<= 1 rank) (<= rank 64)) (= (to_rep1 (select o (to_rep (select r2 rank)))) rank))) (forall ((g2 Int)) (=> (and (<= 1 g2) (<= g2 64)) (= (to_rep (select r2 (to_rep1 (select o g2)))) g2))))))
(assert (= (mk_map__ref1 result) (mk_map__ref1 inverted)))
(assert (= inverted1 o))
(assert (= stable_marriage__is_preferred_2__result1 stable_marriage__is_preferred_2__result2))
(assert (= stable_marriage__is_preferred_2__result3 stable_marriage__is_preferred_2__result1))
(assert (= (mk_bool__ref result1) (mk_bool__ref stable_marriage__is_preferred_2__result)))
(assert (= stable_marriage__is_preferred_2__result1 (ite (<= (to_rep1 (select inverted1 g2_a)) (to_rep1 (select inverted1 g2_b))) true false)))
(assert (= (mk_bool__ref stable_marriage__is_preferred_2__result4) (mk_bool__ref stable_marriage__is_preferred_2__result2)))
(assert (= inverted1 inverted2))
(assert (= stable_marriage__is_preferred_2__result5 stable_marriage__is_preferred_2__result3))
...
(assert (not (<= (to_rep1 (select (invert_2 r2) g2_a)) (to_rep1 (select (invert_2 r2) g2_b)))))
(check-sat)
(exit)
