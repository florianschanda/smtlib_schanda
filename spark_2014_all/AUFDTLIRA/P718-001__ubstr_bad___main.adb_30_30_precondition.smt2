...
(define-fun default_initial_assumption ((temp___expr_814 us_rep) (temp___skip_top_level_815 Bool)) Bool (=> (not (= temp___skip_top_level_815 true)) (= (length1 temp___expr_814) 0)))
...
(define-fun dynamic_invariant ((temp___expr_158 Int) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool)) Bool (=> (or (= temp___is_init_155 true) (<= 0 2147483647)) (in_range3 temp___expr_158)))
...
(define-fun default_initial_assumption1 ((temp___expr_829 us_rep1) (temp___skip_top_level_830 Bool)) Bool (= (length1 (rec__vk__tag__t__my_name (us_split_fields1 temp___expr_829))) 0))
...
(define-fun default_initial_assumption2 ((temp___expr_840 us_rep) (temp___skip_top_level_841 Bool)) Bool (=> (not (= temp___skip_top_level_841 true)) (= (length1 temp___expr_840) 0)))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-fun temp___String_Literal_848 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (= (to_rep (select (temp___String_Literal_848 us_void_param) 1)) 72) (= (to_rep (select (temp___String_Literal_848 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_848 us_void_param) 3)) 108)) (= (to_rep (select (temp___String_Literal_848 us_void_param) 4)) 108)) (= (to_rep (select (temp___String_Literal_848 us_void_param) 5)) 111)) :pattern ((temp___String_Literal_848 us_void_param)))))
(declare-fun temp___String_Literal_849 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (= (to_rep (select (temp___String_Literal_849 us_void_param) 1)) 66) (= (to_rep (select (temp___String_Literal_849 us_void_param) 2)) 121)) (= (to_rep (select (temp___String_Literal_849 us_void_param) 3)) 101)) :pattern ((temp___String_Literal_849 us_void_param)))))
...
(define-fun default_initial_assumption3 ((temp___expr_822 us_rep) (temp___skip_top_level_823 Bool)) Bool (=> (not (= temp___skip_top_level_823 true)) (= (length1 temp___expr_822) 0)))
...
(assert (= result n))
(assert (= n1 o))
(assert (= (length (mk___t (temp___String_Literal_849 Tuple0) (mk 1 3))) (length1 extension__mutable_tag_name__initialize__this)))
(assert (= result1 n1))
