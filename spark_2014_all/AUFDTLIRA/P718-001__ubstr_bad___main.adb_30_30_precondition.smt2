...
(assert (= (length1 n) 0))
(assert (and (= o (name (mk___rep (mk___split_fields tag_v__split_fields1)))) (= o tag_v__split_fields1)))
(assert (= result n))
(assert (= n1 o))
...
(assert (and (= o1 (name (mk___rep (mk___split_fields tag_v__split_fields1)))) (= o1 tag_v__split_fields1)))
(assert (and (= o2 (length1 o1)) (in_range3 o2)))
(assert (= result2 (ite (< o2 500000) true false)))
(assert (= result2 true))
(assert (and (= o3 (name (mk___rep (mk___split_fields tag_v__split_fields1)))) (= o3 tag_v__split_fields1)))
