...
(define-fun dynamic_invariant1 ((temp___expr_201 us_t) (temp___is_init_197 Bool) (temp___skip_constant_198 Bool) (temp___do_toplevel_199 Bool) (temp___do_typ_inv_200 Bool)) Bool (=> (not (= temp___skip_constant_198 true)) (dynamic_property 1 2147483647 (first1 temp___expr_201) (last1 temp___expr_201))))
(declare-fun index_of_minimum (us_t) Int)
(declare-fun index_of_minimum__function_guard (Int us_t) Bool)
(assert (forall ((unsorted us_t)) (! (=> (dynamic_invariant1 unsorted true true true true) (dynamic_invariant (index_of_minimum unsorted) true false true true)) :pattern ((index_of_minimum unsorted)))))
(assert (forall ((unsorted us_t)) (! (=> (dynamic_invariant1 unsorted true true true true) (= (index_of_minimum unsorted) 3)) :pattern ((index_of_minimum unsorted)))))
...
(assert (not (<= (to_rep values__first) 5)))
(check-sat)
(exit)
