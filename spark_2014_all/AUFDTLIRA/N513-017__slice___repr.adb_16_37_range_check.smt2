...
(define-fun dynamic_invariant1 ((temp___expr_172 us_t) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool)) Bool (=> (not (= temp___skip_constant_170 true)) (dynamic_property 1 2147483647 (first1 temp___expr_172) (last1 temp___expr_172))))
(declare-fun index_of_minimum (us_t) Int)
(declare-fun index_of_minimum__function_guard (Int us_t) Bool)
(assert (forall ((unsorted us_t)) (! (=> (dynamic_invariant1 unsorted true true true) (dynamic_invariant (index_of_minimum unsorted) true false true)) :pattern ((index_of_minimum unsorted)))))
(assert (forall ((unsorted us_t)) (! (=> (dynamic_invariant1 unsorted true true true) (= (index_of_minimum unsorted) 3)) :pattern ((index_of_minimum unsorted)))))
