...
(assert (= result2 true))
(assert (and (= o1 (model__ f1 root)) (and (dynamic_invariant4 o1 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o1 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select o1 root)))) 0) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (not (= i2 root)) (ite (and (not (= (parent f1 i2) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select o1 (parent f1 i2)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select o1 i2))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select o1 i2))) true)))))) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o1 i2))) true) (not (= i2 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select o1 (parent f1 i2)))) (position f1 i2) (rec__tree_model__path_type__a (us_split_fields1 (select o1 i2)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select o1 i2)))) 0)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select o1 i2))) true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o1 j2))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select o1 i2))) (rec__tree_model__path_type__a (us_split_fields1 (select o1 j2)))) true)) (= j2 i2))))))))))))))
