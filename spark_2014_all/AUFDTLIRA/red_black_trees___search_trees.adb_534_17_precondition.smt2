...
(assert (= result2 true))
(assert (and (= o (model__ f1 root)) (and (dynamic_invariant4 o true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select o root)))) 0) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= i root)) (ite (and (not (= (parent f1 i) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select o (parent f1 i)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select o i))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select o i))) true)))))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o i))) true) (not (= i root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select o (parent f1 i)))) (position f1 i) (rec__tree_model__path_type__a (us_split_fields1 (select o i)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select o i)))) 0)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select o i))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select o i))) (rec__tree_model__path_type__a (us_split_fields1 (select o j)))) true)) (= j i))))))))))))))
