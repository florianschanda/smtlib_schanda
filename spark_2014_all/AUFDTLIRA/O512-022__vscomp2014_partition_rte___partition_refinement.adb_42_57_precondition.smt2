...
(assert (= result5 true))
(assert (and (= o6 (capacity (mk___rep3 p__split_discrs (us_split_fields__content3 p__split_fields2)))) (and (in_range10 o6) (= o6 (ite (= (distinct 1 0) true) (to_rep5 (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
(assert (= result6 (ite (= o6 (capacity (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields)))) true false)))
(assert (= result6 true))
(assert (and (= o5 (length3 (mk___rep3 p__split_discrs (us_split_fields__content3 p__split_fields2)))) (and (in_range10 o5) (<= o5 (capacity (mk___rep3 p__split_discrs (us_split_fields__content3 p__split_fields2)))))))
(assert (= result7 (ite (= o5 (length3 (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields)))) true false)))
(assert (= result7 true))
