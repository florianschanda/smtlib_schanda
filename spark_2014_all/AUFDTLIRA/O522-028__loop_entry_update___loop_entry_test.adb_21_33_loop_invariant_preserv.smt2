...
(declare-const o3 component_t)
(declare-const o4 (Array Int component_t))
...
(declare-const a10 (Array Int component_t))
(declare-const j9 Int)
(declare-const a11 (Array Int component_t))
(declare-const a_loop_entry2 (Array Int component_t))
(declare-const j10 Int)
(declare-const a12 (Array Int component_t))
...
(assert (= a2 o1))
(assert (= (bool_eq a3 1 1000 (temp___564 a_loop_entry1 first j2 0) 1 1000) true))
(assert (and (and (=> (<= first last) (dynamic_property first last j2)) (forall ((temp___563 Int)) (=> (and (<= 1 temp___563) (<= temp___563 1000)) (=> (< j2 temp___563) (= (select a3 temp___563) (select a temp___563)))))) (and (<= first j2) (<= j2 last))))
(assert (not (= j2 last)))
(assert (= result3 j2))
(assert (= j3 (+ j2 1)))
(assert (= (to_rep o3) 0))
(assert (= o4 (store a3 j3 o3)))
(assert (= result4 a3))
(assert (= a4 o4))
(assert (not (= (bool_eq a4 1 1000 (temp___564 a_loop_entry1 first j3 0) 1 1000) true)))
(check-sat)
(exit)
