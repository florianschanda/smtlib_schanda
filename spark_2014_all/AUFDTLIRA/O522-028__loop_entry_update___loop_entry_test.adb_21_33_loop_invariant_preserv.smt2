...
(declare-fun temp_____aggregate_def_599 ((Array Int component_t) Int Int Int) (Array Int component_t))
(declare-fun temp_____aggregate_def_623 ((Array Int component_t) Int Int Int) (Array Int component_t))
...
(assert (forall ((temp___625 (Array Int component_t))) (forall ((temp___626 Int) (temp___627 Int) (temp___628 Int)) (let ((temp___624 (temp_____aggregate_def_623 temp___625 temp___626 temp___627 temp___628))) (=> (and (and (dynamic_invariant temp___626 true true true true) (dynamic_invariant temp___627 true true true true)) (dynamic_invariant2 temp___628 true true true true)) (forall ((temp___629 Int)) (ite (and (<= temp___626 temp___629) (<= temp___629 temp___627)) (= (select temp___624 temp___629) rliteral) (= (select temp___624 temp___629) (select temp___625 temp___629)))))))))
(assert (forall ((temp___601 (Array Int component_t))) (forall ((temp___602 Int) (temp___603 Int) (temp___604 Int)) (let ((temp___600 (temp_____aggregate_def_599 temp___601 temp___602 temp___603 temp___604))) (=> (and (and (dynamic_invariant temp___602 true true true true) (dynamic_invariant temp___603 true true true true)) (dynamic_invariant2 temp___604 true true true true)) (forall ((temp___605 Int)) (ite (and (<= temp___602 temp___605) (<= temp___605 temp___603)) (= (select temp___600 temp___605) rliteral) (= (select temp___600 temp___605) (select temp___601 temp___605)))))))))
...
(assert (= a1 (store a j1 rliteral)))
(assert (= (bool_eq a2 1 1000 (temp_____aggregate_def_623 a_loop_entry1 first j2 0) 1 1000) true))
(assert (and (and (=> (<= first last) (dynamic_property first last j2)) (forall ((temp___622 Int)) (=> (and (<= 1 temp___622) (<= temp___622 1000)) (=> (or (< last temp___622) (or (< temp___622 first) (< j2 temp___622))) (= (select a2 temp___622) (select a temp___622)))))) (and (<= first j2) (<= j2 last))))
(assert (not (= j2 last)))
(assert (= result3 j2))
(assert (= j3 (+ j2 1)))
(assert (= result4 a2))
(assert (= a3 (store a2 j3 rliteral)))
(assert (not (= (bool_eq a3 1 1000 (temp_____aggregate_def_623 a_loop_entry1 first j3 0) 1 1000) true)))
(check-sat)
(exit)
