...
(assert (= a1 o1))
(assert (= (bool_eq a2 1 1000 (temp___564 a_loop_entry1 first j2 0) 1 1000) true))
(assert (and (and (=> (<= first last) (dynamic_property first last j2)) (forall ((temp___563 Int)) (=> (and (<= 1 temp___563) (<= temp___563 1000)) (=> (< j2 temp___563) (= (select a2 temp___563) (select a temp___563)))))) (and (<= first j2) (<= j2 last))))
(assert (not (= j2 last)))
(assert (= result3 j2))
(assert (= j3 (+ j2 1)))
(assert (= (to_rep o2) 0))
...
(assert (= result4 a2))
(assert (= a3 o3))
(assert (not (= (bool_eq a3 1 1000 (temp___564 a_loop_entry1 first j3 0) 1 1000) true)))
(check-sat)
(exit)
