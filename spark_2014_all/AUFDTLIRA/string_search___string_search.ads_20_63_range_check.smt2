...
(define-fun dynamic_invariant1 ((temp___expr_136 us_t) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (and (=> (not (= temp___skip_constant_134 true)) (dynamic_property 1 2147483647 (first1 temp___expr_136) (last1 temp___expr_136))) (=> (= temp___do_toplevel_135 true) (=> (= temp___is_init_133 true) (= (first1 temp___expr_136) 1)))))
...
(assert (and (= o1 (length needle)) (in_range (length needle))))
(assert (and (= o2 (length haystack)) (in_range (length haystack))))
(assert (= o3 (- o2 o1)))
(assert (and (= o4 o3) (in_range o3)))
(assert (= result (ite (<= (- loc 1) o4) true false)))
(assert (= result true))
