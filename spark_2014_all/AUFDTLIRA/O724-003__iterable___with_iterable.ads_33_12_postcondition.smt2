...
(declare-const with_iterable__set_to_0__first__assume natural)
(declare-const with_iterable__set_to_0__first__assume1 natural)
(declare-const result natural)
(declare-const first__split_fields1 us_split_fields)
(declare-const result1 us_split_fields__ref1)
(declare-const a__split_fields1 us_split_fields2)
(declare-const a__split_fields2 us_split_fields__ref1)
(declare-const first__split_fields2 us_split_fields__ref)
(declare-const a__split_fields3 us_split_fields2)
(declare-const first__split_fields3 us_split_fields)
(define-fun temp___2482 () us_rep (mk___rep (mk___split_discrs temp___248) (mk___split_fields temp___2481)))
(define-fun o6 () us_rep (mk___rep (mk___split_discrs o4) (mk___split_fields o5)))
(define-fun o7 () us_rep (mk___rep (mk___split_discrs o2) (mk___split_fields o3)))
(assert (dynamic_predicate1 (mk___rep (mk___split_discrs rliteral) (mk___split_fields rliteral1))))
(assert (= rliteral o))
(assert (= rliteral1 o1))
(assert (= o7 (mk___rep (mk___split_discrs o) (mk___split_fields o1))))
(assert (= o6 o7))
(assert (= temp___2482 o6))
(assert (dynamic_predicate temp___2482))
(assert (= (mk___rep (mk___split_discrs with_iterable__set_to_0__first__assume) (mk___split_fields with_iterable__set_to_0__first__assume1)) temp___2482))
(assert (= (mk___split_fields__ref (mk___split_fields result)) (mk___split_fields__ref (mk___split_fields first__split_fields))))
(assert (= first__split_fields1 (mk___split_fields with_iterable__set_to_0__first__assume1)))
(assert (= first__split_discrs (mk___split_discrs with_iterable__set_to_0__first__assume)))
(assert (dynamic_invariant (mk___rep first__split_discrs first__split_fields1) true false true true))
(assert (= result1 (mk___split_fields__ref1 (mk___split_fields1 a__split_fields))))
(assert (= a__split_fields1 (mk___split_fields1 (store a__split_fields 1 rliteral2))))
(assert (= (has_element (mk___rep1 a__split_fields1) (mk___rep first__split_discrs first__split_fields1)) true))
(assert (= first__split_fields2 (mk___split_fields__ref first__split_fields1)))
(assert (= a__split_fields2 (mk___split_fields__ref1 a__split_fields1)))
(assert (= first__split_fields3 first__split_fields1))
(assert (= a__split_fields3 a__split_fields1))
(assert (not (= (contains_0 (mk___rep1 (us_split_fields__content1 a__split_fields2))) true)))
(check-sat)
(exit)
