...
(define-fun temp___2222 () us_rep1 (mk___rep1 (mk___split_discrs temp___222) (mk___split_fields1 temp___2221)))
...
(define-fun temp___2212 () us_rep1 (mk___rep1 (mk___split_discrs temp___221) (mk___split_fields1 temp___2211)))
(assert (= (to_rep o1) 1))
(assert (= o1 o2))
(assert (= (to_rep o) 101))
(assert (= o o3))
...
(assert (dynamic_invariant (mk___rep1 first__split_discrs first__split_fields1) true false true))
(assert (= (to_rep o10) 0))
...
(assert (= (has_element (mk___rep a__split_fields1) (mk___rep1 first__split_discrs first__split_fields1)) true))
(assert (= first__split_fields2 (mk___split_fields__ref1 first__split_fields1)))
