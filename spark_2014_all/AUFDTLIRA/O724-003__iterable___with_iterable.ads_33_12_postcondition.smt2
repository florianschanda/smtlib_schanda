...
(assert true)
(assert (forall ((a us_rep)) (! (= (= (contains_0 a) true) (exists ((cu us_rep1)) (and (and (dynamic_invariant cu true false true) (= (has_element a cu) true)) (= (get a (to_rep (rec__with_iterable__cursor__i (us_split_fields3 cu)))) 0)))) :pattern ((contains_0 a)))))
...
(define-fun dynamic_predicate1 ((temp___202 us_rep1)) Bool (and (<= 1 (to_rep (rec__with_iterable__cursor__i (us_split_fields3 temp___202)))) (<= (to_rep (rec__with_iterable__cursor__i (us_split_fields3 temp___202))) (to_rep (rec__with_iterable__cursor__c (us_split_discrs1 temp___202))))))
...
(assert (and (and (and (and (and (and (and (and (and (and (= (to_rep o1) 1) (= o1 o2)) (and (and (= (to_rep o) 101) (= o o3)) (and (= temp___221 o3) (= temp___2211 o2)))) (and (dynamic_predicate1 (mk___rep1 (mk___split_discrs temp___221) (mk___split_fields1 temp___2211))) (= (mk___rep1 (mk___split_discrs o4) (mk___split_fields1 o5)) (mk___rep1 (mk___split_discrs temp___221) (mk___split_fields1 temp___2211))))) (= (mk___rep1 (mk___split_discrs o6) (mk___split_fields1 o7)) (mk___rep1 (mk___split_discrs o4) (mk___split_fields1 o5)))) (= (mk___rep1 (mk___split_discrs o8) (mk___split_fields1 o9)) (mk___rep1 (mk___split_discrs o6) (mk___split_fields1 o7)))) (= (mk___rep1 (mk___split_discrs temp___222) (mk___split_fields1 temp___2221)) (mk___rep1 (mk___split_discrs o8) (mk___split_fields1 o9)))) (and (dynamic_predicate (mk___rep1 (mk___split_discrs temp___222) (mk___split_fields1 temp___2221))) (= with_iterable__set_to_0__first__assume (mk___rep1 (mk___split_discrs temp___222) (mk___split_fields1 temp___2221))))) (and (and (= result (mk___split_fields__ref1 (mk___split_fields1 first__split_fields))) (= first__split_fields1 (us_split_fields3 with_iterable__set_to_0__first__assume))) (= first__split_discrs (us_split_discrs1 with_iterable__set_to_0__first__assume)))) (and (dynamic_invariant (mk___rep1 first__split_discrs first__split_fields1) true false true) (and (and (and (and (and (= (to_rep o10) 0) (= o11 (store a__split_fields 1 o10))) (= o12 (mk___split_fields o11))) (= temp___225 (mk___rep o12))) (and (= result1 (mk___split_fields__ref (mk___split_fields a__split_fields))) (= a__split_fields1 (us_split_fields1 temp___225)))) (= (has_element (mk___rep a__split_fields1) (mk___rep1 first__split_discrs first__split_fields1)) true)))) (and (and (= first__split_fields2 (mk___split_fields__ref1 first__split_fields1)) (= a__split_fields2 (mk___split_fields__ref a__split_fields1))) (and (= first__split_fields3 first__split_fields1) (= a__split_fields3 a__split_fields1)))))
(assert (not (= (contains_0 (mk___rep (us_split_fields__content a__split_fields2))) true)))
(check-sat)
(exit)
