...
(assert (and (= o80 (key (mk___rep d__split_discrs d__split_fields2) c4)) (and (in_range7 o80) (= o80 (get (keys (mk___rep d__split_discrs d__split_fields2)) (get1 (positions (mk___rep d__split_discrs d__split_fields2)) c4))))))
(assert (= o81 (ite (= o80 (to_rep (select a1 j))) true false)))
(assert (= o82 (ite (not (= o81 true)) true false)))
(assert (and (= o78 (key (mk___rep d__split_discrs d__split_fields2) c4)) (and (in_range7 o78) (= o78 (get (keys (mk___rep d__split_discrs d__split_fields2)) (get1 (positions (mk___rep d__split_discrs d__split_fields2)) c4))))))
