...
(assert (and (and (=> (<= 0 64) (in_range1 count2)) (=> (<= 1 64) (in_range10 index2))) (and (<= 1 index2) (<= index2 64))))
(assert (=> (= (rec__datebook__event_record__is_used (us_split_fields7 (select event_array index2))) true) (and (= o (+ count2 1)) (in_range1 (+ count2 1)))))
(assert (=> (= (rec__datebook__event_record__is_used (us_split_fields7 (select event_array index2))) true) (= result2 count2)))
(assert (=> (= (rec__datebook__event_record__is_used (us_split_fields7 (select event_array index2))) true) (= count3 o)))
(assert (=> (not (= (rec__datebook__event_record__is_used (us_split_fields7 (select event_array index2))) true)) (= count3 count2)))
