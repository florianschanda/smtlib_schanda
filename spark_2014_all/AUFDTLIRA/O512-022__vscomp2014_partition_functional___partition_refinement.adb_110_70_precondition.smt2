...
(assert (and (= o71 (has_key (positions (mk___rep d__split_discrs d__split_fields1)) c3)) (= (= o71 true) (= (has_key (positions (mk___rep d__split_discrs d__split_fields1)) c3) true))))
(assert (= o72 true))
(assert (= result11 (ite (= o72 true) o71 false)))
(assert (= result11 true))
(assert (and (= o73 (key (mk___rep d__split_discrs d__split_fields1) c3)) (and (in_range5 o73) (= o73 (get (keys (mk___rep d__split_discrs d__split_fields1)) (get1 (positions (mk___rep d__split_discrs d__split_fields1)) c3))))))
(assert (= result12 (ite (= o73 (to_rep (select a1 i))) true false)))
(assert (= result12 true))
(assert (and (= o75 (key (mk___rep d__split_discrs d__split_fields1) c3)) (and (in_range5 o75) (= o75 (get (keys (mk___rep d__split_discrs d__split_fields1)) (get1 (positions (mk___rep d__split_discrs d__split_fields1)) c3))))))
(assert (not (= (has_key (positions (mk___rep d__split_discrs d__split_fields1)) c3) true)))
(check-sat)
(exit)
