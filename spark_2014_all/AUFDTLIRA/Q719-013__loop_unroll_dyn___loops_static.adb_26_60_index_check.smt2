...
(assert (<= 1 i2))
(assert (<= i2 2))
(assert (and (forall ((temp___428 Int)) (=> (and (<= (to_rep1 a__first) temp___428) (<= temp___428 (to_rep1 a__last))) (=> (<= i3 temp___428) (= (select a1 temp___428) (select a temp___428))))) (and (<= 1 i3) (<= i3 2))))
(assert (= j result1))
(assert (= j1 1))
(assert (<= 1 j1))
(assert (<= j1 2))
(assert (and (forall ((temp___423 Int)) (=> (and (<= (to_rep1 a__first) temp___423) (<= temp___423 (to_rep1 a__last))) (=> (not (= i3 temp___423)) (= (select a2 temp___423) (select a1 temp___423))))) (and (<= 1 j2) (<= j2 2))))
(assert (= (to_rep o) 0))
...
(assert (= (mk1 (to_rep1 a__first) i3) temp___4201))
