...
(assert (and (= o6 (index_of_minimum (mk___t o4 o5))) (and (in_range2 o6) (and (and (<= (to_rep (first o5)) o6) (<= o6 (to_rep (last o5)))) (forall ((j Int)) (=> (and (<= (to_rep (first o5)) j) (<= j (to_rep (last o5)))) (<= (to_rep (select o4 o6)) (to_rep (select o4 j)))))))))
(assert (= (mk_int__ref result2) (mk_int__ref smallest)))
(assert (= smallest1 o6))
(assert (=> (not (= smallest1 current1)) (and (= o7 current1) (in_range2 current1))))
(assert (=> (not (= smallest1 current1)) (and (= (perm (mk___t values (mk (to_rep values__first) (to_rep values__last))) (mk___t values2 (mk (to_rep values__first) (to_rep values__last)))) true) (and (= (to_rep (select values2 o7)) (to_rep (select values smallest1))) (and (= (to_rep (select values2 smallest1)) (to_rep (select values o7))) (forall ((j Int)) (=> (and (<= (to_rep values__first) j) (<= j (to_rep values__last))) (=> (and (not (= j o7)) (not (= j smallest1))) (= (to_rep (select values2 j)) (to_rep (select values j)))))))))))
(assert (=> (not (not (= smallest1 current1))) (= values2 values)))
(assert (=> (not (not (= smallest1 current1))) (= values2 values1)))
(assert (= (perm_transitive (mk___t values (mk (to_rep values__first) (to_rep values__last))) (mk___t values_last1 (mk (to_rep values_last__first) (to_rep values_last__last))) (mk___t values2 (mk (to_rep values__first) (to_rep values__last)))) true))
...
(assert (forall ((j Int)) (=> (and (<= current2 j) (<= j (to_rep values__last))) (<= (to_rep (select values3 current2)) (to_rep (select values3 j))))))
(assert (forall ((j Int)) (=> (and (<= (to_rep values__first) j) (<= j current2)) (<= (to_rep (select values3 j)) (to_rep (select values3 (+ j 1)))))))
(assert (and (and (=> (<= 1 2147483647) (in_range2 smallest2)) (=> (<= (to_rep values__first) (- (to_rep values__last) 1)) (dynamic_property3 (to_rep values__first) (- (to_rep values__last) 1) current2))) (and (<= (to_rep values__first) current2) (<= current2 (- (to_rep values__last) 1)))))
...
(assert (= (mk___t1 o8 o9) (mk___t1 temp___1892 temp___1893)))
(assert (= o10 o8))
(assert (= values_last2 result4))
(assert (= values_last3 o10))
...
(assert (= o11 values3))
(assert (= o11 temp___1912))
(assert (= (mk2 current3 (to_rep values__last)) temp___1913))
(assert (= temp___1912 o12))
(assert (= (mk (to_rep (first4 temp___1913)) (to_rep (last4 temp___1913))) o13))
(assert (and (= o14 (index_of_minimum (mk___t o12 o13))) (and (in_range2 o14) (and (and (<= (to_rep (first o13)) o14) (<= o14 (to_rep (last o13)))) (forall ((j Int)) (=> (and (<= (to_rep (first o13)) j) (<= j (to_rep (last o13)))) (<= (to_rep (select o12 o14)) (to_rep (select o12 j)))))))))
(assert (= smallest2 result5))
(assert (= smallest3 o14))
(assert (=> (not (= smallest3 current3)) (and (= o15 current3) (in_range2 current3))))
(assert (=> (not (= smallest3 current3)) (and (= (perm (mk___t values3 (mk (to_rep values__first) (to_rep values__last))) (mk___t values4 (mk (to_rep values__first) (to_rep values__last)))) true) (and (= (to_rep (select values4 o15)) (to_rep (select values3 smallest3))) (and (= (to_rep (select values4 smallest3)) (to_rep (select values3 o15))) (forall ((j Int)) (=> (and (<= (to_rep values__first) j) (<= j (to_rep values__last))) (=> (and (not (= j o15)) (not (= j smallest3))) (= (to_rep (select values4 j)) (to_rep (select values3 j)))))))))))
(assert (=> (not (not (= smallest3 current3))) (= values4 values3)))
(assert (= (perm_transitive (mk___t values (mk (to_rep values__first) (to_rep values__last))) (mk___t values_last3 (mk (to_rep values_last__first) (to_rep values_last__last))) (mk___t values4 (mk (to_rep values__first) (to_rep values__last)))) true))
