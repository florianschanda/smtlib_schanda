...
(assert (<= current1 temp___217))
(assert (= (slide values (to_rep values__first) (to_rep values__first)) temp___218))
(assert (= (mk1 (to_rep values__first) (to_rep values__last)) temp___2181))
(assert (= (ite (<= (to_rep (first2 temp___2181)) (to_rep (last2 temp___2181))) (+ (- (to_rep (last2 temp___2181)) (to_rep (first2 temp___2181))) 1) 0) (ite (<= (to_rep values_last__first) (to_rep values_last__last)) (+ (- (to_rep values_last__last) (to_rep values_last__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___218 temp___2181)))
(assert (= o2 o))
...
(assert (= o3 values))
(assert (= o3 temp___220))
(assert (= (mk2 current1 (to_rep values__last)) temp___2201))
(assert (= temp___220 o4))
(assert (= (mk (to_rep (first4 temp___2201)) (to_rep (last4 temp___2201))) o5))
...
(assert (=> (not (= smallest1 current1)) (and (= (perm (mk___t values (mk (to_rep values__first) (to_rep values__last))) (mk___t o16 (mk (to_rep values__first) (to_rep values__last)))) true) (and (= (to_rep (select o16 o7)) (to_rep (select values smallest1))) (and (= (to_rep (select o16 smallest1)) (to_rep (select values o7))) (forall ((j Int)) (=> (and (<= (to_rep values__first) j) (<= j (to_rep values__last))) (=> (and (not (= j o7)) (not (= j smallest1))) (= (to_rep (select o16 j)) (to_rep (select values j)))))))))))
(assert (=> (not (not (= smallest1 current1))) (= o16 values)))
(assert (=> (not (not (= smallest1 current1))) (= o16 values1)))
(assert (= (perm_transitive (mk___t values (mk (to_rep values__first) (to_rep values__last))) (mk___t values_last1 (mk (to_rep values_last__first) (to_rep values_last__last))) (mk___t o16 (mk (to_rep values__first) (to_rep values__last)))) true))
(assert (= (perm (mk___t values (mk (to_rep values__first) (to_rep values__last))) (mk___t values2 (mk (to_rep values__first) (to_rep values__last)))) true))
(assert (forall ((j Int)) (=> (and (<= current2 j) (<= j (to_rep values__last))) (<= (to_rep (select values2 current2)) (to_rep (select values2 j))))))
(assert (forall ((j Int)) (=> (and (<= (to_rep values__first) j) (<= j current2)) (<= (to_rep (select values2 j)) (to_rep (select values2 (+ j 1)))))))
...
(assert (not (= current2 temp___217)))
(assert (= current2 result3))
(assert (= current3 (+ current2 1)))
(assert (= (slide values2 (to_rep values__first) (to_rep values__first)) temp___2182))
(assert (= (mk1 (to_rep values__first) (to_rep values__last)) temp___2183))
(assert (= (ite (<= (to_rep (first2 temp___2183)) (to_rep (last2 temp___2183))) (+ (- (to_rep (last2 temp___2183)) (to_rep (first2 temp___2183))) 1) 0) (ite (<= (to_rep values_last__first) (to_rep values_last__last)) (+ (- (to_rep values_last__last) (to_rep values_last__first)) 1) 0)))
(assert (= (mk___t1 o8 o9) (mk___t1 temp___2182 temp___2183)))
(assert (= o10 o8))
...
(assert (= o11 values2))
(assert (= o11 temp___2202))
(assert (= (mk2 current3 (to_rep values__last)) temp___2203))
(assert (= temp___2202 o12))
(assert (= (mk (to_rep (first4 temp___2203)) (to_rep (last4 temp___2203))) o13))
...
(assert (=> (not (= smallest3 current3)) (and (= (perm (mk___t values2 (mk (to_rep values__first) (to_rep values__last))) (mk___t o17 (mk (to_rep values__first) (to_rep values__last)))) true) (and (= (to_rep (select o17 o15)) (to_rep (select values2 smallest3))) (and (= (to_rep (select o17 smallest3)) (to_rep (select values2 o15))) (forall ((j Int)) (=> (and (<= (to_rep values__first) j) (<= j (to_rep values__last))) (=> (and (not (= j o15)) (not (= j smallest3))) (= (to_rep (select o17 j)) (to_rep (select values2 j)))))))))))
(assert (=> (not (not (= smallest3 current3))) (= o17 values2)))
(assert (= (perm_transitive (mk___t values (mk (to_rep values__first) (to_rep values__last))) (mk___t values_last3 (mk (to_rep values_last__first) (to_rep values_last__last))) (mk___t o17 (mk (to_rep values__first) (to_rep values__last)))) true))
(assert (not (= (perm (mk___t values (mk (to_rep values__first) (to_rep values__last))) (mk___t o17 (mk (to_rep values__first) (to_rep values__last)))) true)))
(check-sat)
(exit)
