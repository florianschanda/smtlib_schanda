...
(declare-const temp___2162 (Array Int integer))
(declare-const temp___2163 t1)
(declare-const o8 (Array Int integer))
(declare-const o9 t1)
(declare-const o10 (Array Int integer))
(declare-const o11 (Array Int integer))
(declare-const temp___2182 (Array Int integer))
(declare-const temp___2183 t2)
...
(assert (<= current1 temp___229))
(assert (= (slide values (to_rep values__first) (to_rep values__first)) temp___216))
(assert (= (mk1 (to_rep values__first) (to_rep values__last)) temp___2161))
(assert (= (ite (<= (to_rep (first2 temp___2161)) (to_rep (last2 temp___2161))) (+ (- (to_rep (last2 temp___2161)) (to_rep (first2 temp___2161))) 1) 0) (ite (<= (to_rep values_last__first) (to_rep values_last__last)) (+ (- (to_rep values_last__last) (to_rep values_last__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___216 temp___2161)))
(assert (= o2 o))
...
(assert (= o3 values))
(assert (= o3 temp___218))
(assert (= (mk2 current1 (to_rep values__last)) temp___2181))
(assert (= temp___218 o4))
(assert (= (mk (to_rep (first4 temp___2181)) (to_rep (last4 temp___2181))) o5))
...
(assert (not (= current2 temp___229)))
(assert (= current2 result3))
(assert (= current3 (+ current2 1)))
(assert (= (slide values3 (to_rep values__first) (to_rep values__first)) temp___2162))
(assert (= (mk1 (to_rep values__first) (to_rep values__last)) temp___2163))
(assert (= (ite (<= (to_rep (first2 temp___2163)) (to_rep (last2 temp___2163))) (+ (- (to_rep (last2 temp___2163)) (to_rep (first2 temp___2163))) 1) 0) (ite (<= (to_rep values_last__first) (to_rep values_last__last)) (+ (- (to_rep values_last__last) (to_rep values_last__first)) 1) 0)))
(assert (= (mk___t1 o8 o9) (mk___t1 temp___2162 temp___2163)))
(assert (= o10 o8))
...
(assert (= o11 values3))
(assert (= o11 temp___2182))
(assert (= (mk2 current3 (to_rep values__last)) temp___2183))
(assert (= temp___2182 o12))
(assert (= (mk (to_rep (first4 temp___2183)) (to_rep (last4 temp___2183))) o13))
