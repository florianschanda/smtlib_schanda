...
(assert true)
(assert (= (slide values (to_rep values__first) (to_rep values__first)) temp___189))
(assert (= (mk1 (to_rep values__first) (to_rep values__last)) temp___1891))
(assert (= (ite (<= (to_rep (first2 temp___1891)) (to_rep (last2 temp___1891))) (+ (- (to_rep (last2 temp___1891)) (to_rep (first2 temp___1891))) 1) 0) (ite (<= (to_rep values_last__first) (to_rep values_last__last)) (+ (- (to_rep values_last__last) (to_rep values_last__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___189 temp___1891)))
(assert (= o2 o))
(assert (= (mk_map__ref result1) (mk_map__ref values_last)))
(assert (= values_last2 o2))
...
(assert (= (mk (to_rep (first4 temp___1911)) (to_rep (last4 temp___1911))) o5))
(assert (and (= o6 (index_of_minimum (mk___t o4 o5))) (and (in_range2 o6) (and (and (<= (to_rep (first o5)) o6) (<= o6 (to_rep (last o5)))) (forall ((j3 Int)) (=> (and (<= (to_rep (first o5)) j3) (<= j3 (to_rep (last o5)))) (<= (to_rep (select o4 o6)) (to_rep (select o4 j3)))))))))
(assert (= (mk_int__ref result2) (mk_int__ref smallest)))
(assert (= smallest2 o6))
(assert (=> (not (= smallest2 current1)) (and (= o7 current1) (in_range2 current1))))
(assert (=> (not (= smallest2 current1)) (and (= (perm (mk___t values (mk (to_rep values__first) (to_rep values__last))) (mk___t values2 (mk (to_rep values__first) (to_rep values__last)))) true) (and (= (to_rep (select values2 o7)) (to_rep (select values smallest2))) (and (= (to_rep (select values2 smallest2)) (to_rep (select values o7))) (forall ((j3 Int)) (=> (and (<= (to_rep values__first) j3) (<= j3 (to_rep values__last))) (=> (and (not (= j3 o7)) (not (= j3 smallest2))) (= (to_rep (select values2 j3)) (to_rep (select values j3)))))))))))
(assert (=> (= smallest2 current1) (= values2 values)))
(assert (=> (= smallest2 current1) (= values2 values1)))
(assert (= (perm_transitive (mk___t values (mk (to_rep values__first) (to_rep values__last))) (mk___t values_last2 (mk (to_rep values_last__first) (to_rep values_last__last))) (mk___t values2 (mk (to_rep values__first) (to_rep values__last)))) true))
(assert (= (perm (mk___t values (mk (to_rep values__first) (to_rep values__last))) (mk___t values3 (mk (to_rep values__first) (to_rep values__last)))) true))
(assert (forall ((j3 Int)) (=> (and (<= current2 j3) (<= j3 (to_rep values__last))) (<= (to_rep (select values3 current2)) (to_rep (select values3 j3))))))
(assert (forall ((j3 Int)) (=> (and (<= (to_rep values__first) j3) (<= j3 current2)) (<= (to_rep (select values3 j3)) (to_rep (select values3 (+ j3 1)))))))
(assert (and (and (=> (<= 1 2147483647) (in_range2 smallest3)) (=> (<= (to_rep values__first) (- (to_rep values__last) 1)) (dynamic_property3 (to_rep values__first) (- (to_rep values__last) 1) current2))) (and (<= (to_rep values__first) current2) (<= current2 (- (to_rep values__last) 1)))))
(assert (not (= current2 temp___202)))
(assert (= current2 result3))
(assert (= current3 (+ current2 1)))
(assert true)
(assert (= (slide values3 (to_rep values__first) (to_rep values__first)) temp___1892))
(assert (= (mk1 (to_rep values__first) (to_rep values__last)) temp___1893))
(assert (= (ite (<= (to_rep (first2 temp___1893)) (to_rep (last2 temp___1893))) (+ (- (to_rep (last2 temp___1893)) (to_rep (first2 temp___1893))) 1) 0) (ite (<= (to_rep values_last__first) (to_rep values_last__last)) (+ (- (to_rep values_last__last) (to_rep values_last__first)) 1) 0)))
(assert (= (mk___t1 o14 o15) (mk___t1 temp___1892 temp___1893)))
(assert (= o16 o14))
(assert (= values_last3 result4))
(assert (= values_last4 o16))
...
(assert (= o17 values3))
(assert (= o17 temp___1912))
(assert (= (mk2 current3 (to_rep values__last)) temp___1913))
(assert (= temp___1912 o18))
(assert (= (mk (to_rep (first4 temp___1913)) (to_rep (last4 temp___1913))) o19))
(assert (and (= o20 (index_of_minimum (mk___t o18 o19))) (and (in_range2 o20) (and (and (<= (to_rep (first o19)) o20) (<= o20 (to_rep (last o19)))) (forall ((j3 Int)) (=> (and (<= (to_rep (first o19)) j3) (<= j3 (to_rep (last o19)))) (<= (to_rep (select o18 o20)) (to_rep (select o18 j3)))))))))
(assert (= smallest3 result5))
(assert (= smallest4 o20))
(assert (=> (not (= smallest4 current3)) (and (= o21 current3) (in_range2 current3))))
(assert (=> (not (= smallest4 current3)) (and (= (perm (mk___t values3 (mk (to_rep values__first) (to_rep values__last))) (mk___t values4 (mk (to_rep values__first) (to_rep values__last)))) true) (and (= (to_rep (select values4 o21)) (to_rep (select values3 smallest4))) (and (= (to_rep (select values4 smallest4)) (to_rep (select values3 o21))) (forall ((j3 Int)) (=> (and (<= (to_rep values__first) j3) (<= j3 (to_rep values__last))) (=> (and (not (= j3 o21)) (not (= j3 smallest4))) (= (to_rep (select values4 j3)) (to_rep (select values3 j3)))))))))))
(assert (=> (= smallest4 current3) (= values4 values3)))
(assert (= (perm_transitive (mk___t values (mk (to_rep values__first) (to_rep values__last))) (mk___t values_last4 (mk (to_rep values_last__first) (to_rep values_last__last))) (mk___t values4 (mk (to_rep values__first) (to_rep values__last)))) true))
(assert (not (= (perm (mk___t values (mk (to_rep values__first) (to_rep values__last))) (mk___t values4 (mk (to_rep values__first) (to_rep values__last)))) true)))
(check-sat)
(exit)
