...
(declare-fun temp___3703 ((Array Int us_rep) Int us_rep Int us_rep) (Array Int us_rep))
(declare-fun temp___3711 ((Array Int et1) Int Int) (Array Int et1))
...
(assert (forall ((temp___3705 (Array Int us_rep))) (forall ((temp___3706 Int) (temp___3708 Int)) (forall ((temp___3707 us_rep) (temp___3709 us_rep)) (let ((temp___3704 (temp___3703 temp___3705 temp___3706 temp___3707 temp___3708 temp___3709))) (=> (and (dynamic_invariant1 temp___3706 true true true true) (dynamic_invariant1 temp___3708 true true true true)) (forall ((temp___3710 Int)) (ite (= temp___3710 temp___3708) (= (select temp___3704 temp___3710) temp___3709) (ite (= temp___3710 temp___3706) (= (select temp___3704 temp___3710) temp___3707) (= (select temp___3704 temp___3710) (select temp___3705 temp___3710)))))))))))
(assert (forall ((temp___3713 (Array Int et1))) (forall ((temp___3714 Int) (temp___3715 Int)) (let ((temp___3712 (temp___3711 temp___3713 temp___3714 temp___3715))) (=> (and (dynamic_invariant temp___3714 true true true true) (dynamic_invariant2 temp___3715 true true true true)) (forall ((temp___3716 Int)) (ite (= temp___3716 temp___3714) (= (to_rep (select temp___3712 temp___3716)) temp___3715) (= (select temp___3712 temp___3716) (select temp___3713 temp___3716)))))))))
...
(assert (= a2 a3))
(assert (= a4 a2))
(assert (not (= (bool_eq2 a3 1 16 (temp___3703 a i (mk___rep (mk___split_fields (temp___3711 (rec__ar__rofa1__s1 (us_split_fields1 (select a i))) j e) (rec__ar__rofa1__t1 (us_split_fields1 (select a i))))) x r) 1 16) true)))
(check-sat)
(exit)
