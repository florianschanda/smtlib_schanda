...
(define-fun bool_eq3 ((a us_rep1) (b us_rep1)) Bool (ite (and (= (to_rep1 (rec__mutable__t__k (us_split_discrs2 a))) (to_rep1 (rec__mutable__t__k (us_split_discrs2 b)))) (and (= (to_rep (rec__mutable__t__som1 (us_split_fields3 a))) (to_rep (rec__mutable__t__som1 (us_split_fields3 b)))) (= (bool_eq (rec__mutable__t__arr1 (us_split_fields3 a)) 1 5 (rec__mutable__t__arr1 (us_split_fields3 b)) 1 5) true))) true false))
