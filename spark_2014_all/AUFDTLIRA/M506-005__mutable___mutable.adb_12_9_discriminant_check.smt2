...
(declare-fun temp___216 (Int) (Array Int integer))
...
(assert (forall ((temp___218 Int)) (=> (dynamic_invariant2 temp___218 true true true true) (forall ((temp___219 Int)) (= (to_rep (select (temp___216 temp___218) temp___219)) temp___218)))))
...
(declare-const temp___220 d)
(declare-const temp___2201 integer)
(declare-const temp___2202 (Array Int integer))
(declare-const temp___2203 t)
(declare-const temp___2204 Bool)
...
(assert (= o7 o3))
(assert (= true o8))
(assert (= o5 temp___220))
(assert (= o6 temp___2201))
(assert (= o7 temp___2202))
(assert (= (mk 1 5) temp___2203))
(assert (= o8 temp___2204))
(assert (= x__attr__constrained true))
(assert (not (= temp___220 x__split_discrs)))
(check-sat)
(exit)
