...
(define-fun dynamic_invariant ((temp___expr_139 Int) (temp___is_init_136 Bool) (temp___skip_constant_137 Bool) (temp___do_toplevel_138 Bool)) Bool (=> (or (= temp___is_init_136 true) (<= 1 10)) (in_range1 temp___expr_139)))
...
(define-fun of_base ((r us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r) (mk___split_fields1 (rec__mutable__t__som (us_split_fields1 r)) (let ((temp___135 (rec__mutable__t__arr (us_split_fields1 r)))) (to_array temp___135))) (attr__constrained r)))
(define-fun bool_eq3 ((a us_rep1) (b us_rep1)) Bool (ite (and (and (= (to_rep1 (rec__mutable__t__k (us_split_discrs2 a))) (to_rep1 (rec__mutable__t__k (us_split_discrs2 b)))) (= (to_rep (rec__mutable__t__som1 (us_split_fields3 a))) (to_rep (rec__mutable__t__som1 (us_split_fields3 b))))) (= (bool_eq (rec__mutable__t__arr1 (us_split_fields3 a)) 1 5 (rec__mutable__t__arr1 (us_split_fields3 b)) 1 5) true)) true false))
(define-fun in_range4 ((rec__mutable__t__k1 Int) (a us_rep)) Bool (= rec__mutable__t__k1 (to_rep1 (rec__mutable__t__k (us_split_discrs1 a)))))
...
(assert (forall ((temp___192 Int)) (forall ((temp___193 Int)) (= (select (temp___190 temp___192) temp___193) (of_rep temp___192)))))
...
(assert (dynamic_invariant1 (mk___rep (mk___split_discrs x__split_discrs) (mk___split_fields x__split_fields (mk___t x__split_fields1 x__split_fields2)) x__attr__constrained) true false true))
...
(assert (not (= temp___194 x__split_discrs)))
(check-sat)
(exit)
