...
(assert (= a8 result8))
(assert (= a9 o16))
(assert (and (= o17 (- (to_rep (select b 2)) (to_rep (select a9 2)))) (in_range (- (to_rep (select b 2)) (to_rep (select a9 2))))))
...
(assert (= a10 result10))
(assert (= a11 o21))
(assert (and (= o22 (- (to_rep (select a11 3)) (to_rep (select b 6)))) (in_range (- (to_rep (select a11 3)) (to_rep (select b 6))))))
...
(assert (= a13 a14))
(assert (= a15 a13))
(assert (not (in_range (to_rep (select a14 1)))))
(check-sat)
(exit)
