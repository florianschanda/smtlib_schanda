...
(assert (and (= (length source) 5) (forall ((index3 Int)) (=> (and (<= (to_rep1 (first (rt source))) index3) (<= index3 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index3))) true)))))
...
(assert (= n1 result2))
(assert (= n2 o8))
(assert (forall ((j1 Int)) (=> (and (<= (to_rep1 (first (rt source))) j1) (<= j1 index2)) (= (to_rep1 (select n3 j1)) (convert_character_digit_to_integer (to_rep (select (elts source) j1)))))))
...
(assert (<= j index2))
(assert (and (<= (to_rep1 (first (rt source))) j) (<= j (to_rep1 (last (rt source))))))
(assert (= o9 j))
(assert (= o10 (select (elts source) o9)))
(assert (= o11 (to_rep o10)))
(assert (and (= o12 (convert_character_digit_to_integer o11)) (and (in_range1 o12) (and (and (<= 0 o12) (<= o12 9)) (ite (= (= o11 48) true) (= o12 0) (ite (= (= o11 49) true) (= o12 1) (ite (= (= o11 50) true) (= o12 2) (ite (= (= o11 51) true) (= o12 3) (ite (= (= o11 52) true) (= o12 4) (ite (= (= o11 53) true) (= o12 5) (ite (= (= o11 54) true) (= o12 6) (ite (= (= o11 55) true) (= o12 7) (ite (= (= o11 56) true) (= o12 8) (=> (= (= o11 57) true) (= o12 9)))))))))))))))
