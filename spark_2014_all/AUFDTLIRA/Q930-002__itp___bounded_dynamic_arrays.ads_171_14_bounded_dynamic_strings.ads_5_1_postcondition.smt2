...
(assert (not (= (length1 (mk___rep this__split_discrs (mk___split_fields this__split_fields6 (mk___t this__split_fields7 this__split_fields8)))) (length1 (mk___rep this__split_discrs (mk___split_fields this__split_fields (mk___t this__split_fields1 this__split_fields2)))))))
(check-sat)
(exit)
