...
(assert (=> (= (length (mk___t temp___603 temp___6031)) 0) (= (temp___String_Literal_602 Tuple0) temp___605)))
(assert (=> (= (length (mk___t temp___603 temp___6031)) 0) (= (mk 1 9) temp___6051)))
(assert (=> (not (= (length (mk___t temp___603 temp___6031)) 0)) (=> (<= 1 9) (= o26 (+ (- 9 1) 1)))))
(assert (=> (not (= (length (mk___t temp___603 temp___6031)) 0)) (=> (not (<= 1 9)) (= o26 0))))
(assert (=> (not (= (length (mk___t temp___603 temp___6031)) 0)) (=> (<= (to_rep1 (first temp___6031)) (to_rep1 (last temp___6031))) (= o27 (+ (- (to_rep1 (last temp___6031)) (to_rep1 (first temp___6031))) 1)))))
(assert (=> (not (= (length (mk___t temp___603 temp___6031)) 0)) (=> (not (<= (to_rep1 (first temp___6031)) (to_rep1 (last temp___6031)))) (= o27 0))))
(assert (=> (not (= (length (mk___t temp___603 temp___6031)) 0)) (= o28 (+ o27 o26))))
(assert (=> (not (= (length (mk___t temp___603 temp___6031)) 0)) (= o29 (+ (to_rep1 (first temp___6031)) o28))))
(assert (=> (not (= (length (mk___t temp___603 temp___6031)) 0)) (= o30 (- o29 1))))
(assert (=> (not (= (length (mk___t temp___603 temp___6031)) 0)) (and (= o31 o30) (in_range1 o30))))
(assert (=> (not (= (length (mk___t temp___603 temp___6031)) 0)) (= (concat1 temp___603 (to_rep1 (first temp___6031)) (to_rep1 (last temp___6031)) (temp___String_Literal_602 Tuple0) 1 9) temp___605)))
(assert (=> (not (= (length (mk___t temp___603 temp___6031)) 0)) (= (mk (to_rep1 (first temp___6031)) o31) temp___6051)))
(assert (=> (= (length (mk___t temp___605 temp___6051)) 0) (= (elts (to_string (attr__ATTRIBUTE_IMAGE (to_rep1 (rec__ints__int__value1 (us_split_fields3 arg)))))) temp___608)))
(assert (=> (= (length (mk___t temp___605 temp___6051)) 0) (= (mk (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE (to_rep1 (rec__ints__int__value1 (us_split_fields3 arg)))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE (to_rep1 (rec__ints__int__value1 (us_split_fields3 arg))))))))) temp___6081)))
(assert (=> (not (= (length (mk___t temp___605 temp___6051)) 0)) (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE (to_rep1 (rec__ints__int__value1 (us_split_fields3 arg)))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE (to_rep1 (rec__ints__int__value1 (us_split_fields3 arg))))))))) (= o32 (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE (to_rep1 (rec__ints__int__value1 (us_split_fields3 arg)))))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE (to_rep1 (rec__ints__int__value1 (us_split_fields3 arg))))))))) 1)))))
(assert (=> (not (= (length (mk___t temp___605 temp___6051)) 0)) (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE (to_rep1 (rec__ints__int__value1 (us_split_fields3 arg)))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE (to_rep1 (rec__ints__int__value1 (us_split_fields3 arg)))))))))) (= o32 0))))
(assert (=> (not (= (length (mk___t temp___605 temp___6051)) 0)) (=> (<= (to_rep1 (first temp___6051)) (to_rep1 (last temp___6051))) (= o33 (+ (- (to_rep1 (last temp___6051)) (to_rep1 (first temp___6051))) 1)))))
(assert (=> (not (= (length (mk___t temp___605 temp___6051)) 0)) (=> (not (<= (to_rep1 (first temp___6051)) (to_rep1 (last temp___6051)))) (= o33 0))))
(assert (=> (not (= (length (mk___t temp___605 temp___6051)) 0)) (= o34 (+ o33 o32))))
(assert (=> (not (= (length (mk___t temp___605 temp___6051)) 0)) (= o35 (+ (to_rep1 (first temp___6051)) o34))))
(assert (=> (not (= (length (mk___t temp___605 temp___6051)) 0)) (= o36 (- o35 1))))
(assert (=> (not (= (length (mk___t temp___605 temp___6051)) 0)) (and (= o37 o36) (in_range1 o36))))
(assert (=> (not (= (length (mk___t temp___605 temp___6051)) 0)) (= (concat1 temp___605 (to_rep1 (first temp___6051)) (to_rep1 (last temp___6051)) (elts (to_string (attr__ATTRIBUTE_IMAGE (to_rep1 (rec__ints__int__value1 (us_split_fields3 arg)))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE (to_rep1 (rec__ints__int__value1 (us_split_fields3 arg)))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE (to_rep1 (rec__ints__int__value1 (us_split_fields3 arg))))))))) temp___608)))
(assert (=> (not (= (length (mk___t temp___605 temp___6051)) 0)) (= (mk (to_rep1 (first temp___6051)) o37) temp___6081)))
(assert (not (= (length (mk___t temp___608 temp___6081)) 0)))
(assert (=> (<= 1 13) (= o38 (+ (- 13 1) 1))))
(assert (=> (not (<= 1 13)) (= o38 0)))
(assert (=> (<= (to_rep1 (first temp___6081)) (to_rep1 (last temp___6081))) (= o39 (+ (- (to_rep1 (last temp___6081)) (to_rep1 (first temp___6081))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___6081)) (to_rep1 (last temp___6081)))) (= o39 0)))
(assert (= o40 (+ o39 o38)))
(assert (= o41 (+ (to_rep1 (first temp___6081)) o40)))
(assert (= o42 (- o41 1)))
