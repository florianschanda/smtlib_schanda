...
(assert (=> (= (length (mk___t temp___1675 temp___16751)) 0) (= (temp___String_Literal_1674 Tuple0) temp___1677)))
(assert (=> (= (length (mk___t temp___1675 temp___16751)) 0) (= (mk 1 12) temp___16771)))
(assert (=> (not (= (length (mk___t temp___1675 temp___16751)) 0)) (=> (<= 1 12) (= o6 (+ (- 12 1) 1)))))
(assert (=> (not (= (length (mk___t temp___1675 temp___16751)) 0)) (=> (not (<= 1 12)) (= o6 0))))
(assert (=> (not (= (length (mk___t temp___1675 temp___16751)) 0)) (=> (<= (to_rep1 (first temp___16751)) (to_rep1 (last temp___16751))) (= o7 (+ (- (to_rep1 (last temp___16751)) (to_rep1 (first temp___16751))) 1)))))
(assert (=> (not (= (length (mk___t temp___1675 temp___16751)) 0)) (=> (not (<= (to_rep1 (first temp___16751)) (to_rep1 (last temp___16751)))) (= o7 0))))
(assert (=> (not (= (length (mk___t temp___1675 temp___16751)) 0)) (= o8 (+ o7 o6))))
(assert (=> (not (= (length (mk___t temp___1675 temp___16751)) 0)) (= o9 (+ (to_rep1 (first temp___16751)) o8))))
(assert (=> (not (= (length (mk___t temp___1675 temp___16751)) 0)) (= o10 (- o9 1))))
(assert (=> (not (= (length (mk___t temp___1675 temp___16751)) 0)) (and (= o11 o10) (in_range1 o10))))
(assert (=> (not (= (length (mk___t temp___1675 temp___16751)) 0)) (= (concat1 temp___1675 (to_rep1 (first temp___16751)) (to_rep1 (last temp___16751)) (temp___String_Literal_1674 Tuple0) 1 12) temp___1677)))
(assert (=> (not (= (length (mk___t temp___1675 temp___16751)) 0)) (= (mk (to_rep1 (first temp___16751)) o11) temp___16771)))
(assert (=> (= (length (mk___t temp___1677 temp___16771)) 0) (= temp___1678 cert__extractuser__fullstring__assume)))
(assert (=> (= (length (mk___t temp___1677 temp___16771)) 0) (= (mk (to_rep1 (first2 temp___16781)) (to_rep1 (last2 temp___16781))) cert__extractuser__fullstring__assume1)))
(assert (=> (not (= (length (mk___t temp___1677 temp___16771)) 0)) (=> (<= (to_rep1 (first2 temp___16781)) (to_rep1 (last2 temp___16781))) (= o12 (+ (- (to_rep1 (last2 temp___16781)) (to_rep1 (first2 temp___16781))) 1)))))
(assert (=> (not (= (length (mk___t temp___1677 temp___16771)) 0)) (=> (not (<= (to_rep1 (first2 temp___16781)) (to_rep1 (last2 temp___16781)))) (= o12 0))))
(assert (=> (not (= (length (mk___t temp___1677 temp___16771)) 0)) (=> (<= (to_rep1 (first temp___16771)) (to_rep1 (last temp___16771))) (= o13 (+ (- (to_rep1 (last temp___16771)) (to_rep1 (first temp___16771))) 1)))))
(assert (=> (not (= (length (mk___t temp___1677 temp___16771)) 0)) (=> (not (<= (to_rep1 (first temp___16771)) (to_rep1 (last temp___16771)))) (= o13 0))))
(assert (=> (not (= (length (mk___t temp___1677 temp___16771)) 0)) (= o14 (+ o13 o12))))
(assert (=> (not (= (length (mk___t temp___1677 temp___16771)) 0)) (= o15 (+ (to_rep1 (first temp___16771)) o14))))
(assert (=> (not (= (length (mk___t temp___1677 temp___16771)) 0)) (= o16 (- o15 1))))
(assert (=> (not (= (length (mk___t temp___1677 temp___16771)) 0)) (and (= o17 o16) (in_range1 o16))))
(assert (=> (not (= (length (mk___t temp___1677 temp___16771)) 0)) (= (concat1 temp___1677 (to_rep1 (first temp___16771)) (to_rep1 (last temp___16771)) temp___1678 (to_rep1 (first2 temp___16781)) (to_rep1 (last2 temp___16781))) cert__extractuser__fullstring__assume)))
(assert (=> (not (= (length (mk___t temp___1677 temp___16771)) 0)) (= (mk (to_rep1 (first temp___16771)) o17) cert__extractuser__fullstring__assume1)))
