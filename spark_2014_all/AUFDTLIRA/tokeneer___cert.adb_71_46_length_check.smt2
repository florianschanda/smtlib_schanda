...
(define-fun dynamic_invariant1 ((temp___expr_380 Int) (temp___is_init_377 Bool) (temp___skip_constant_378 Bool) (temp___do_toplevel_379 Bool)) Bool (=> (or (= temp___is_init_377 true) (<= 0 4294967295)) (in_range3 temp___expr_380)))
...
(assert (forall ((x Int)) (! (=> (dynamic_invariant1 x true true true) (= (issueridt_image x) (let ((temp___386 (to_string (attr__ATTRIBUTE_IMAGE3 x)))) (of_array1 (to_array temp___386) (first1 temp___386) (last1 temp___386))))) :pattern ((issueridt_image x)))))
...
(define-fun dynamic_invariant3 ((temp___expr_493 Int) (temp___is_init_490 Bool) (temp___skip_constant_491 Bool) (temp___do_toplevel_492 Bool)) Bool (=> (or (= temp___is_init_490 true) (<= 0 4294967295)) (in_range5 temp___expr_493)))
...
(assert (forall ((x Int)) (! (=> (dynamic_invariant3 x true true true) (= (serialnumbert_image x) (let ((temp___499 (to_string (attr__ATTRIBUTE_IMAGE5 x)))) (of_array2 (to_array temp___499) (first1 temp___499) (last1 temp___499))))) :pattern ((serialnumbert_image x)))))
...
(define-fun bool_eq8 ((a us_rep3) (b us_rep3)) Bool (ite (and (and (and (= (bool_eq6 (rec__cert__contentst__id (us_split_fields7 a)) (rec__cert__contentst__id (us_split_fields7 b))) true) (= (bool_eq7 (rec__cert__contentst__notbefore (us_split_fields7 a)) (rec__cert__contentst__notbefore (us_split_fields7 b))) true)) (= (bool_eq7 (rec__cert__contentst__notafter (us_split_fields7 a)) (rec__cert__contentst__notafter (us_split_fields7 b))) true)) (= (to_rep5 (rec__cert__contentst__mechanism (us_split_fields7 a))) (to_rep5 (rec__cert__contentst__mechanism (us_split_fields7 b))))) true false))
...
(declare-fun temp___String_Literal_1726 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1726 us_void_param) 1)) 78) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 3)) 85)) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 4)) 115)) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 7)) 32)) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 8)) 32)) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 9)) 32)) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 11)) 32)) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 12)) 32)) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 13)) 32)) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 16)) 32)) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 17)) 32)) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 18)) 32)) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 19)) 32)) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 20)) 32)) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 21)) 32)) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 22)) 32)) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 23)) 32)) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 24)) 32)) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 25)) 32)) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 26)) 32)) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 27)) 32)) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 28)) 32)) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 29)) 32)) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 30)) 32)) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 31)) 32)) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 32)) 32)) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 33)) 32)) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 34)) 32)) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 35)) 32)) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 36)) 32)) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 37)) 32)) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 38)) 32)) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 39)) 32)) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 40)) 32)) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 41)) 32)) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 42)) 32)) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 43)) 32)) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 44)) 32)) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 45)) 32)) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 46)) 32)) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 47)) 32)) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 48)) 32)) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 49)) 32)) (= (to_rep (select (temp___String_Literal_1726 us_void_param) 50)) 32)) :pattern ((temp___String_Literal_1726 us_void_param)))))
(declare-fun temp___String_Literal_1727 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1727 us_void_param) 1)) 73) (= (to_rep (select (temp___String_Literal_1727 us_void_param) 2)) 115)) (= (to_rep (select (temp___String_Literal_1727 us_void_param) 3)) 115)) (= (to_rep (select (temp___String_Literal_1727 us_void_param) 4)) 117)) (= (to_rep (select (temp___String_Literal_1727 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_1727 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_1727 us_void_param) 7)) 58)) (= (to_rep (select (temp___String_Literal_1727 us_void_param) 8)) 32)) :pattern ((temp___String_Literal_1727 us_void_param)))))
(declare-fun temp___String_Literal_1730 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1730 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_1730 us_void_param) 2)) 83)) (= (to_rep (select (temp___String_Literal_1730 us_void_param) 3)) 101)) (= (to_rep (select (temp___String_Literal_1730 us_void_param) 4)) 114)) (= (to_rep (select (temp___String_Literal_1730 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_1730 us_void_param) 6)) 97)) (= (to_rep (select (temp___String_Literal_1730 us_void_param) 7)) 108)) (= (to_rep (select (temp___String_Literal_1730 us_void_param) 8)) 78)) (= (to_rep (select (temp___String_Literal_1730 us_void_param) 9)) 111)) (= (to_rep (select (temp___String_Literal_1730 us_void_param) 10)) 58)) (= (to_rep (select (temp___String_Literal_1730 us_void_param) 11)) 32)) (= (to_rep (select (temp___String_Literal_1730 us_void_param) 12)) 32)) :pattern ((temp___String_Literal_1730 us_void_param)))))
...
(define-fun dynamic_invariant8 ((temp___expr_972 Int) (temp___is_init_969 Bool) (temp___skip_constant_970 Bool) (temp___do_toplevel_971 Bool)) Bool (=> (or (= temp___is_init_969 true) (<= 1 50)) (in_range6 temp___expr_972)))
...
(define-fun dynamic_invariant10 ((temp___expr_851 Int) (temp___is_init_848 Bool) (temp___skip_constant_849 Bool) (temp___do_toplevel_850 Bool)) Bool (=> (or (= temp___is_init_848 true) (<= 1901 2099)) (in_range8 temp___expr_851)))
(define-fun dynamic_invariant11 ((temp___expr_857 Int) (temp___is_init_854 Bool) (temp___skip_constant_855 Bool) (temp___do_toplevel_856 Bool)) Bool (=> (or (= temp___is_init_854 true) (<= 1 12)) (in_range9 temp___expr_857)))
(define-fun dynamic_invariant12 ((temp___expr_863 Int) (temp___is_init_860 Bool) (temp___skip_constant_861 Bool) (temp___do_toplevel_862 Bool)) Bool (=> (or (= temp___is_init_860 true) (<= 1 31)) (in_range10 temp___expr_863)))
(define-fun dynamic_invariant13 ((temp___expr_891 Int) (temp___is_init_888 Bool) (temp___skip_constant_889 Bool) (temp___do_toplevel_890 Bool)) Bool (=> (or (= temp___is_init_888 true) (<= 0 86399999)) (in_range11 temp___expr_891)))
(define-fun dynamic_invariant14 ((temp___expr_359 Int) (temp___is_init_356 Bool) (temp___skip_constant_357 Bool) (temp___do_toplevel_358 Bool)) Bool (=> (or (= temp___is_init_356 true) (<= 0 40)) (in_range4 temp___expr_359)))
(define-fun dynamic_invariant15 ((temp___expr_402 Int) (temp___is_init_399 Bool) (temp___skip_constant_400 Bool) (temp___do_toplevel_401 Bool)) Bool (=> (or (= temp___is_init_399 true) (<= 0 10)) (in_range7 temp___expr_402)))
...
(declare-const temp___17341 t2)
(declare-const temp___1729 (Array Int character))
(declare-const temp___17291 t1)
(declare-const o Int)
...
(declare-const temp___1731 (Array Int character))
(declare-const temp___17311 t)
...
(declare-const temp___1733 (Array Int character))
(declare-const temp___17331 t)
...
(declare-const temp___1739 (Array Int character))
(declare-const temp___17391 t4)
(declare-const o18 (Array Int character))
(declare-const temp___1742 (Array Int character))
(declare-const temp___17421 t4)
...
(assert (= localuser1 (temp___String_Literal_1726 Tuple0)))
(assert (and (= (mk___t2 temp___1734 temp___17341) (serialnumbert_image (to_rep4 (rec__certtypes__idt__serialnumber (us_split_fields3 (rec__cert__contentst__id (us_split_fields7 contents))))))) (and (dynamic_invariant2 (mk___t2 temp___1734 temp___17341) true false true) (= (mk___t2 temp___1734 temp___17341) (let ((temp___497 (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep4 (rec__certtypes__idt__serialnumber (us_split_fields3 (rec__cert__contentst__id (us_split_fields7 contents))))))))) (mk___t2 (elts temp___497) (mk2 (to_rep1 (first (rt temp___497))) (to_rep1 (last (rt temp___497))))))))))
(assert (and (= (mk___t1 temp___1729 temp___17291) (issueridt_image (to_rep2 (rec__cryptotypes__issuert__id (us_split_fields1 (rec__certtypes__idt__issuer (us_split_fields3 (rec__cert__contentst__id (us_split_fields7 contents))))))))) (and (dynamic_invariant (mk___t1 temp___1729 temp___17291) true false true) (= (mk___t1 temp___1729 temp___17291) (let ((temp___384 (to_string (attr__ATTRIBUTE_IMAGE3 (to_rep2 (rec__cryptotypes__issuert__id (us_split_fields1 (rec__certtypes__idt__issuer (us_split_fields3 (rec__cert__contentst__id (us_split_fields7 contents))))))))))) (mk___t1 (elts temp___384) (mk1 (to_rep1 (first (rt temp___384))) (to_rep1 (last (rt temp___384))))))))))
(assert (=> (<= (to_rep1 (first2 temp___17291)) (to_rep1 (last2 temp___17291))) (= o (+ (- (to_rep1 (last2 temp___17291)) (to_rep1 (first2 temp___17291))) 1))))
(assert (=> (not (<= (to_rep1 (first2 temp___17291)) (to_rep1 (last2 temp___17291)))) (= o 0)))
(assert (=> (<= 1 8) (= o1 (+ (- 8 1) 1))))
(assert (=> (not (<= 1 8)) (= o1 0)))
(assert (= o2 (+ o1 o)))
(assert (= o3 (+ 1 o2)))
...
(assert (= (concat1 (temp___String_Literal_1727 Tuple0) 1 8 temp___1729 (to_rep1 (first2 temp___17291)) (to_rep1 (last2 temp___17291))) temp___1731))
(assert (= (mk 1 o5) temp___17311))
(assert (=> (= (length (mk___t temp___1731 temp___17311)) 0) (= (temp___String_Literal_1730 Tuple0) temp___1733)))
(assert (=> (= (length (mk___t temp___1731 temp___17311)) 0) (= (mk 1 12) temp___17331)))
(assert (=> (not (= (length (mk___t temp___1731 temp___17311)) 0)) (=> (<= 1 12) (= o6 (+ (- 12 1) 1)))))
(assert (=> (not (= (length (mk___t temp___1731 temp___17311)) 0)) (=> (not (<= 1 12)) (= o6 0))))
(assert (=> (not (= (length (mk___t temp___1731 temp___17311)) 0)) (=> (<= (to_rep1 (first temp___17311)) (to_rep1 (last temp___17311))) (= o7 (+ (- (to_rep1 (last temp___17311)) (to_rep1 (first temp___17311))) 1)))))
(assert (=> (not (= (length (mk___t temp___1731 temp___17311)) 0)) (=> (not (<= (to_rep1 (first temp___17311)) (to_rep1 (last temp___17311)))) (= o7 0))))
(assert (=> (not (= (length (mk___t temp___1731 temp___17311)) 0)) (= o8 (+ o7 o6))))
(assert (=> (not (= (length (mk___t temp___1731 temp___17311)) 0)) (= o9 (+ (to_rep1 (first temp___17311)) o8))))
(assert (=> (not (= (length (mk___t temp___1731 temp___17311)) 0)) (= o10 (- o9 1))))
(assert (=> (not (= (length (mk___t temp___1731 temp___17311)) 0)) (and (= o11 o10) (in_range1 o10))))
(assert (=> (not (= (length (mk___t temp___1731 temp___17311)) 0)) (= (concat1 temp___1731 (to_rep1 (first temp___17311)) (to_rep1 (last temp___17311)) (temp___String_Literal_1730 Tuple0) 1 12) temp___1733)))
(assert (=> (not (= (length (mk___t temp___1731 temp___17311)) 0)) (= (mk (to_rep1 (first temp___17311)) o11) temp___17331)))
(assert (=> (= (length (mk___t temp___1733 temp___17331)) 0) (= temp___1734 cert__extractuser__fullstring__assume)))
(assert (=> (= (length (mk___t temp___1733 temp___17331)) 0) (= (mk (to_rep1 (first4 temp___17341)) (to_rep1 (last4 temp___17341))) cert__extractuser__fullstring__assume1)))
(assert (=> (not (= (length (mk___t temp___1733 temp___17331)) 0)) (=> (<= (to_rep1 (first4 temp___17341)) (to_rep1 (last4 temp___17341))) (= o12 (+ (- (to_rep1 (last4 temp___17341)) (to_rep1 (first4 temp___17341))) 1)))))
(assert (=> (not (= (length (mk___t temp___1733 temp___17331)) 0)) (=> (not (<= (to_rep1 (first4 temp___17341)) (to_rep1 (last4 temp___17341)))) (= o12 0))))
(assert (=> (not (= (length (mk___t temp___1733 temp___17331)) 0)) (=> (<= (to_rep1 (first temp___17331)) (to_rep1 (last temp___17331))) (= o13 (+ (- (to_rep1 (last temp___17331)) (to_rep1 (first temp___17331))) 1)))))
(assert (=> (not (= (length (mk___t temp___1733 temp___17331)) 0)) (=> (not (<= (to_rep1 (first temp___17331)) (to_rep1 (last temp___17331)))) (= o13 0))))
(assert (=> (not (= (length (mk___t temp___1733 temp___17331)) 0)) (= o14 (+ o13 o12))))
(assert (=> (not (= (length (mk___t temp___1733 temp___17331)) 0)) (= o15 (+ (to_rep1 (first temp___17331)) o14))))
(assert (=> (not (= (length (mk___t temp___1733 temp___17331)) 0)) (= o16 (- o15 1))))
(assert (=> (not (= (length (mk___t temp___1733 temp___17331)) 0)) (and (= o17 o16) (in_range1 o16))))
(assert (=> (not (= (length (mk___t temp___1733 temp___17331)) 0)) (= (concat1 temp___1733 (to_rep1 (first temp___17331)) (to_rep1 (last temp___17331)) temp___1734 (to_rep1 (first4 temp___17341)) (to_rep1 (last4 temp___17341))) cert__extractuser__fullstring__assume)))
(assert (=> (not (= (length (mk___t temp___1733 temp___17331)) 0)) (= (mk (to_rep1 (first temp___17331)) o17) cert__extractuser__fullstring__assume1)))
