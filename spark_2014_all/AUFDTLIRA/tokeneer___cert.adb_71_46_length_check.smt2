...
(define-fun dynamic_invariant3 ((temp___expr_553 Int) (temp___is_init_549 Bool) (temp___skip_constant_550 Bool) (temp___do_toplevel_551 Bool) (temp___do_typ_inv_552 Bool)) Bool (=> (or (= temp___is_init_549 true) (<= 0 4294967295)) (in_range5 temp___expr_553)))
...
(assert (forall ((x Int)) (! (=> (dynamic_invariant3 x true true true true) (= (serialnumbert_image x) (let ((temp___559 (to_string (attr__ATTRIBUTE_IMAGE5 x)))) (of_array2 (to_array temp___559) (first1 temp___559) (last1 temp___559))))) :pattern ((serialnumbert_image x)))))
...
(declare-fun temp___String_Literal_1896 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1896 us_void_param) 1)) 78) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 3)) 85)) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 4)) 115)) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 7)) 32)) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 8)) 32)) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 9)) 32)) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 11)) 32)) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 12)) 32)) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 13)) 32)) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 16)) 32)) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 17)) 32)) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 18)) 32)) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 19)) 32)) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 20)) 32)) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 21)) 32)) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 22)) 32)) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 23)) 32)) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 24)) 32)) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 25)) 32)) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 26)) 32)) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 27)) 32)) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 28)) 32)) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 29)) 32)) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 30)) 32)) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 31)) 32)) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 32)) 32)) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 33)) 32)) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 34)) 32)) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 35)) 32)) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 36)) 32)) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 37)) 32)) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 38)) 32)) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 39)) 32)) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 40)) 32)) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 41)) 32)) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 42)) 32)) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 43)) 32)) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 44)) 32)) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 45)) 32)) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 46)) 32)) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 47)) 32)) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 48)) 32)) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 49)) 32)) (= (to_rep (select (temp___String_Literal_1896 us_void_param) 50)) 32)) :pattern ((temp___String_Literal_1896 us_void_param)))))
(declare-fun temp___String_Literal_1897 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1897 us_void_param) 1)) 73) (= (to_rep (select (temp___String_Literal_1897 us_void_param) 2)) 115)) (= (to_rep (select (temp___String_Literal_1897 us_void_param) 3)) 115)) (= (to_rep (select (temp___String_Literal_1897 us_void_param) 4)) 117)) (= (to_rep (select (temp___String_Literal_1897 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_1897 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_1897 us_void_param) 7)) 58)) (= (to_rep (select (temp___String_Literal_1897 us_void_param) 8)) 32)) :pattern ((temp___String_Literal_1897 us_void_param)))))
(declare-fun temp___String_Literal_1900 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1900 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_1900 us_void_param) 2)) 83)) (= (to_rep (select (temp___String_Literal_1900 us_void_param) 3)) 101)) (= (to_rep (select (temp___String_Literal_1900 us_void_param) 4)) 114)) (= (to_rep (select (temp___String_Literal_1900 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_1900 us_void_param) 6)) 97)) (= (to_rep (select (temp___String_Literal_1900 us_void_param) 7)) 108)) (= (to_rep (select (temp___String_Literal_1900 us_void_param) 8)) 78)) (= (to_rep (select (temp___String_Literal_1900 us_void_param) 9)) 111)) (= (to_rep (select (temp___String_Literal_1900 us_void_param) 10)) 58)) (= (to_rep (select (temp___String_Literal_1900 us_void_param) 11)) 32)) (= (to_rep (select (temp___String_Literal_1900 us_void_param) 12)) 32)) :pattern ((temp___String_Literal_1900 us_void_param)))))
...
(define-fun dynamic_invariant10 ((temp___expr_933 Int) (temp___is_init_929 Bool) (temp___skip_constant_930 Bool) (temp___do_toplevel_931 Bool) (temp___do_typ_inv_932 Bool)) Bool (=> (or (= temp___is_init_929 true) (<= 1901 2099)) (in_range8 temp___expr_933)))
(define-fun dynamic_invariant11 ((temp___expr_940 Int) (temp___is_init_936 Bool) (temp___skip_constant_937 Bool) (temp___do_toplevel_938 Bool) (temp___do_typ_inv_939 Bool)) Bool (=> (or (= temp___is_init_936 true) (<= 1 12)) (in_range9 temp___expr_940)))
(define-fun dynamic_invariant12 ((temp___expr_947 Int) (temp___is_init_943 Bool) (temp___skip_constant_944 Bool) (temp___do_toplevel_945 Bool) (temp___do_typ_inv_946 Bool)) Bool (=> (or (= temp___is_init_943 true) (<= 1 31)) (in_range10 temp___expr_947)))
(define-fun dynamic_invariant13 ((temp___expr_979 Int) (temp___is_init_975 Bool) (temp___skip_constant_976 Bool) (temp___do_toplevel_977 Bool) (temp___do_typ_inv_978 Bool)) Bool (=> (or (= temp___is_init_975 true) (<= 0 86399999)) (in_range11 temp___expr_979)))
(define-fun dynamic_invariant14 ((temp___expr_402 Int) (temp___is_init_398 Bool) (temp___skip_constant_399 Bool) (temp___do_toplevel_400 Bool) (temp___do_typ_inv_401 Bool)) Bool (=> (or (= temp___is_init_398 true) (<= 0 40)) (in_range4 temp___expr_402)))
(define-fun dynamic_invariant15 ((temp___expr_450 Int) (temp___is_init_446 Bool) (temp___skip_constant_447 Bool) (temp___do_toplevel_448 Bool) (temp___do_typ_inv_449 Bool)) Bool (=> (or (= temp___is_init_446 true) (<= 0 10)) (in_range7 temp___expr_450)))
(declare-const localuser (Array Int character))
(declare-const fullstring (Array Int character))
(declare-const temp___1904 (Array Int character))
(declare-const temp___19041 t2)
(declare-const temp___1899 (Array Int character))
(declare-const temp___18991 t1)
(declare-const o Int)
...
(declare-const temp___1901 (Array Int character))
(declare-const temp___19011 t)
...
(declare-const temp___1903 (Array Int character))
(declare-const temp___19031 t)
...
(define-fun temp___18992 () us_t1 (mk___t1 temp___1899 temp___18991))
(define-fun temp___19042 () us_t2 (mk___t2 temp___1904 temp___19041))
(assert (= result localuser))
(assert (= localuser1 (temp___String_Literal_1896 Tuple0)))
(assert (and (= temp___19042 (serialnumbert_image (to_rep4 (rec__certtypes__idt__serialnumber (us_split_fields3 (rec__cert__contentst__id (us_split_fields7 contents))))))) (and (dynamic_invariant2 temp___19042 true false true true) (= temp___19042 (let ((temp___557 (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep4 (rec__certtypes__idt__serialnumber (us_split_fields3 (rec__cert__contentst__id (us_split_fields7 contents))))))))) (mk___t2 (elts temp___557) (mk2 (to_rep1 (first (rt temp___557))) (to_rep1 (last (rt temp___557))))))))))
(assert (and (= temp___18992 (issueridt_image (to_rep2 (rec__cryptotypes__issuert__id (us_split_fields1 (rec__certtypes__idt__issuer (us_split_fields3 (rec__cert__contentst__id (us_split_fields7 contents))))))))) (and (dynamic_invariant temp___18992 true false true true) (= temp___18992 (let ((temp___430 (to_string (attr__ATTRIBUTE_IMAGE3 (to_rep2 (rec__cryptotypes__issuert__id (us_split_fields1 (rec__certtypes__idt__issuer (us_split_fields3 (rec__cert__contentst__id (us_split_fields7 contents))))))))))) (mk___t1 (elts temp___430) (mk1 (to_rep1 (first (rt temp___430))) (to_rep1 (last (rt temp___430))))))))))
(assert (=> (<= (to_rep1 (first2 temp___18991)) (to_rep1 (last2 temp___18991))) (= o (+ (- (to_rep1 (last2 temp___18991)) (to_rep1 (first2 temp___18991))) 1))))
(assert (=> (not (<= (to_rep1 (first2 temp___18991)) (to_rep1 (last2 temp___18991)))) (= o 0)))
(assert (=> (<= 1 8) (= o1 (+ (- 8 1) 1))))
(assert (=> (not (<= 1 8)) (= o1 0)))
(assert (= o2 (+ o1 o)))
(assert (= o3 (+ 1 o2)))
...
(assert (= (concat1 (temp___String_Literal_1897 Tuple0) 1 8 temp___1899 (to_rep1 (first2 temp___18991)) (to_rep1 (last2 temp___18991))) temp___1901))
(assert (= (mk 1 o5) temp___19011))
(assert (=> (= (length (mk___t temp___1901 temp___19011)) 0) (= (temp___String_Literal_1900 Tuple0) temp___1903)))
(assert (=> (= (length (mk___t temp___1901 temp___19011)) 0) (= (mk 1 12) temp___19031)))
(assert (=> (not (= (length (mk___t temp___1901 temp___19011)) 0)) (=> (<= 1 12) (= o6 (+ (- 12 1) 1)))))
(assert (=> (not (= (length (mk___t temp___1901 temp___19011)) 0)) (=> (not (<= 1 12)) (= o6 0))))
(assert (=> (not (= (length (mk___t temp___1901 temp___19011)) 0)) (=> (<= (to_rep1 (first temp___19011)) (to_rep1 (last temp___19011))) (= o7 (+ (- (to_rep1 (last temp___19011)) (to_rep1 (first temp___19011))) 1)))))
(assert (=> (not (= (length (mk___t temp___1901 temp___19011)) 0)) (=> (not (<= (to_rep1 (first temp___19011)) (to_rep1 (last temp___19011)))) (= o7 0))))
(assert (=> (not (= (length (mk___t temp___1901 temp___19011)) 0)) (= o8 (+ o7 o6))))
(assert (=> (not (= (length (mk___t temp___1901 temp___19011)) 0)) (= o9 (+ (to_rep1 (first temp___19011)) o8))))
(assert (=> (not (= (length (mk___t temp___1901 temp___19011)) 0)) (= o10 (- o9 1))))
(assert (=> (not (= (length (mk___t temp___1901 temp___19011)) 0)) (and (= o11 o10) (in_range1 o10))))
(assert (=> (not (= (length (mk___t temp___1901 temp___19011)) 0)) (= (concat1 temp___1901 (to_rep1 (first temp___19011)) (to_rep1 (last temp___19011)) (temp___String_Literal_1900 Tuple0) 1 12) temp___1903)))
(assert (=> (not (= (length (mk___t temp___1901 temp___19011)) 0)) (= (mk (to_rep1 (first temp___19011)) o11) temp___19031)))
(assert (=> (= (length (mk___t temp___1903 temp___19031)) 0) (= temp___1904 cert__extractuser__fullstring__assume)))
(assert (=> (= (length (mk___t temp___1903 temp___19031)) 0) (= (mk (to_rep1 (first4 temp___19041)) (to_rep1 (last4 temp___19041))) cert__extractuser__fullstring__assume1)))
(assert (=> (not (= (length (mk___t temp___1903 temp___19031)) 0)) (=> (<= (to_rep1 (first4 temp___19041)) (to_rep1 (last4 temp___19041))) (= o12 (+ (- (to_rep1 (last4 temp___19041)) (to_rep1 (first4 temp___19041))) 1)))))
(assert (=> (not (= (length (mk___t temp___1903 temp___19031)) 0)) (=> (not (<= (to_rep1 (first4 temp___19041)) (to_rep1 (last4 temp___19041)))) (= o12 0))))
(assert (=> (not (= (length (mk___t temp___1903 temp___19031)) 0)) (=> (<= (to_rep1 (first temp___19031)) (to_rep1 (last temp___19031))) (= o13 (+ (- (to_rep1 (last temp___19031)) (to_rep1 (first temp___19031))) 1)))))
(assert (=> (not (= (length (mk___t temp___1903 temp___19031)) 0)) (=> (not (<= (to_rep1 (first temp___19031)) (to_rep1 (last temp___19031)))) (= o13 0))))
(assert (=> (not (= (length (mk___t temp___1903 temp___19031)) 0)) (= o14 (+ o13 o12))))
(assert (=> (not (= (length (mk___t temp___1903 temp___19031)) 0)) (= o15 (+ (to_rep1 (first temp___19031)) o14))))
(assert (=> (not (= (length (mk___t temp___1903 temp___19031)) 0)) (= o16 (- o15 1))))
(assert (=> (not (= (length (mk___t temp___1903 temp___19031)) 0)) (and (= o17 o16) (in_range1 o16))))
(assert (=> (not (= (length (mk___t temp___1903 temp___19031)) 0)) (= (concat1 temp___1903 (to_rep1 (first temp___19031)) (to_rep1 (last temp___19031)) temp___1904 (to_rep1 (first4 temp___19041)) (to_rep1 (last4 temp___19041))) cert__extractuser__fullstring__assume)))
(assert (=> (not (= (length (mk___t temp___1903 temp___19031)) 0)) (= (mk (to_rep1 (first temp___19031)) o17) cert__extractuser__fullstring__assume1)))
