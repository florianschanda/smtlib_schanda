...
(assert (and (= k1 l) (forall ((x3 Int)) (=> (and (<= l x3) (<= x3 l)) (<= (to_rep (select arr k1)) (to_rep (select arr x3)))))))
...
(assert (<= (+ l 1) i2))
(assert (<= i2 u))
(assert (=> (< (to_rep (select arr i2)) (to_rep (select arr k1))) (= k1 result2)))
(assert (=> (< (to_rep (select arr i2)) (to_rep (select arr k1))) (= k2 i2)))
(assert (=> (not (< (to_rep (select arr i2)) (to_rep (select arr k1)))) (= k2 k1)))
(assert (not (<= (+ l 1) i2)))
(check-sat)
(exit)
