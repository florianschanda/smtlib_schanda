...
(define-fun dynamic_invariant1 ((temp___expr_190 Int) (temp___is_init_186 Bool) (temp___skip_constant_187 Bool) (temp___do_toplevel_188 Bool) (temp___do_typ_inv_189 Bool)) Bool (=> (or (= temp___is_init_186 true) (<= 0 128)) (in_range2 temp___expr_190)))
...
(declare-fun temp___240 (us_rep) (Array Int us_rep))
(declare-fun temp___244 (Int) (Array Int index_type))
(define-fun dynamic_invariant2 ((temp___expr_164 Int) (temp___is_init_160 Bool) (temp___skip_constant_161 Bool) (temp___do_toplevel_162 Bool) (temp___do_typ_inv_163 Bool)) Bool (=> (or (= temp___is_init_160 true) (<= (- 2147483648) 2147483647)) (in_range1 temp___expr_164)))
(assert (forall ((temp___242 us_rep)) (forall ((temp___243 Int)) (= (select (temp___240 temp___242) temp___243) temp___242))))
(assert (forall ((temp___246 Int)) (=> (dynamic_invariant1 temp___246 true true true true) (forall ((temp___247 Int)) (= (to_rep1 (select (temp___244 temp___246) temp___247)) temp___246)))))
...
(declare-const temp___248 (Array Int index_type))
...
(assert (= o7 o4))
(assert (= o8 o5))
(assert (= o9 (temp___240 (mk___rep (mk___split_fields o6 o7 o8)))))
(assert (= result memory))
(assert (= memory1 o9))
(assert (= result1 count))
(assert (= count1 0))
(assert (= result2 free_list))
(assert (= free_list1 (temp___244 0)))
(assert (= result3 free))
(assert (= free1 1))
(assert (= result4 index))
(assert (= index1 1))
(assert (=> (and (<= 1 index1) (<= index1 127)) (= temp___248 free_list1)))
(assert (=> (and (<= 1 index1) (<= index1 127)) (and (forall ((temp___249 Int)) (=> (and (<= 0 temp___249) (<= temp___249 128)) (=> (<= index2 temp___249) (= (select free_list2 temp___249) (select temp___248 temp___249))))) (and (<= 1 index2) (<= index2 127)))))
