...
(assert (forall ((x element_type)) (! (in_range1 (to_rep x)) :pattern ((to_rep x)))))
...
(define-fun dynamic_invariant1 ((temp___expr_164 Int) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool)) Bool (=> (or (= temp___is_init_161 true) (<= 0 128)) (in_range2 temp___expr_164)))
(assert (forall ((list_handler__integer_list__count Int)) (! (=> (dynamic_invariant1 list_handler__integer_list__count true true true) (dynamic_invariant (size list_handler__integer_list__count) true false true)) :pattern ((size list_handler__integer_list__count)))))
(assert (forall ((list_handler__integer_list__count Int)) (! (=> (dynamic_invariant1 list_handler__integer_list__count true true true) (= (size list_handler__integer_list__count) list_handler__integer_list__count)) :pattern ((size list_handler__integer_list__count)))))
(declare-const attr__ATTRIBUTE_ADDRESS4 Int)
(declare-fun temp___211 (us_rep) (Array Int us_rep))
(assert (forall ((temp___213 us_rep)) (forall ((temp___214 Int)) (= (select (temp___211 temp___213) temp___214) temp___213))))
(declare-fun temp___215 (Int) (Array Int index_type))
(assert (forall ((temp___217 Int)) (forall ((temp___218 Int)) (= (select (temp___215 temp___217) temp___218) (of_rep1 temp___217)))))
(define-fun dynamic_invariant2 ((temp___expr_141 Int) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool (=> (or (= temp___is_init_138 true) (<= (- 2147483648) 2147483647)) (in_range1 temp___expr_141)))
...
(declare-const temp___219 (Array Int index_type))
...
(assert (=> (and (<= 1 index1) (<= index1 127)) (and (forall ((temp___220 Int)) (=> (and (<= 0 temp___220) (<= temp___220 128)) (=> (<= index2 temp___220) (= (select free_list2 temp___220) (select temp___219 temp___220))))) (and (<= 1 index2) (<= index2 127)))))
(assert (=> (and (<= 1 index1) (<= index1 127)) (= (to_rep1 o10) (+ index2 1))))
(assert (=> (and (<= 1 index1) (<= index1 127)) (= o11 (store free_list2 index2 o10))))
...
(assert (=> (and (<= 1 index1) (<= index1 127)) (= (mk_int__ref index5) (mk_int__ref index3))))
(assert (=> (and (<= 1 index1) (<= index1 127)) (= (mk_map__ref1 free_list6) (mk_map__ref1 free_list4))))
...
(assert (= index7 (mk_int__ref index5)))
(assert (= free2 (mk_int__ref free1)))
(assert (= free_list8 (mk_map__ref1 free_list6)))
...
(assert (not (= (size (int__content count2)) 0)))
(check-sat)
(exit)
