...
(declare-fun temp_____aggregate_def_240 (us_rep) (Array Int us_rep))
(declare-fun temp_____aggregate_def_244 (Int) (Array Int index_type))
...
(assert (forall ((temp___242 us_rep)) (forall ((temp___243 Int)) (= (select (temp_____aggregate_def_240 temp___242) temp___243) temp___242))))
(declare-const rliteral index_type)
(assert (= (index_typeqtint rliteral) 0))
(assert (forall ((temp___246 Int)) (=> (dynamic_invariant1 temp___246 true true true true) (forall ((temp___247 Int)) (= (select (temp_____aggregate_def_244 temp___246) temp___247) rliteral)))))
...
(declare-const temp___250 (Array Int index_type))
...
(assert (= memory1 (temp_____aggregate_def_240 (mk___rep (mk___split_fields rliteral1 rliteral rliteral)))))
(assert (= result1 count))
(assert (= count1 0))
(assert (= result2 free_list))
(assert (= free_list1 (temp_____aggregate_def_244 0)))
(assert (= result3 free))
(assert (= free1 1))
(assert (= result4 index))
(assert (= index1 1))
(assert (=> (and (<= 1 index1) (<= index1 127)) (= temp___250 free_list1)))
(assert (=> (and (<= 1 index1) (<= index1 127)) (and (forall ((temp___251 Int)) (=> (and (<= 0 temp___251) (<= temp___251 128)) (=> (or (< 127 temp___251) (or (< temp___251 1) (<= index2 temp___251))) (= (select free_list2 temp___251) (select temp___250 temp___251))))) (and (<= 1 index2) (<= index2 127)))))
