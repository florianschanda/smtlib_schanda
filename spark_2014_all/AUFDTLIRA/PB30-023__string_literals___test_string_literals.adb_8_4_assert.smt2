...
(assert (forall ((x us_t)) (! (=> (dynamic_invariant x true true true true) (dynamic_invariant (id x) true false true true)) :pattern ((id x)))))
(assert (forall ((x us_t)) (! (=> (dynamic_invariant x true true true true) (= (id x) x)) :pattern ((id x)))))
...
(assert (forall ((i tTtSP1)) (and (<= 5 (tTtSP1qtint i)) (<= (tTtSP1qtint i) 8))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (= (to_rep (select (temp___String_Literal_210 us_void_param) 1)) 116) (= (to_rep (select (temp___String_Literal_210 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_210 us_void_param) 3)) 116)) (= (to_rep (select (temp___String_Literal_210 us_void_param) 4)) 111)) :pattern ((temp___String_Literal_210 us_void_param)))))
(declare-fun temp___String_Literal_212 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (= (to_rep (select (temp___String_Literal_212 us_void_param) 5)) 116) (= (to_rep (select (temp___String_Literal_212 us_void_param) 6)) 111)) (= (to_rep (select (temp___String_Literal_212 us_void_param) 7)) 116)) (= (to_rep (select (temp___String_Literal_212 us_void_param) 8)) 111)) :pattern ((temp___String_Literal_212 us_void_param)))))
...
(assert (= result s))
(assert (= s1 (temp___String_Literal_210 Tuple0)))
...
(assert (= result1 t1))
(assert (= t2 (temp___String_Literal_212 Tuple0)))
(assert (= (to_rep1 (first (rt (id (mk___t s1 (mk (to_rep1 s__first) (to_rep1 s__last))))))) 1))
(assert (not (= (to_rep1 (first (rt (id (mk___t t2 (mk 5 8)))))) 5)))
(check-sat)
(exit)
