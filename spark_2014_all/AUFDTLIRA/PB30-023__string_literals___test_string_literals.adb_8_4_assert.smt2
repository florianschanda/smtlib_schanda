...
(assert (forall ((x us_t)) (! (=> (dynamic_invariant x true true true) (dynamic_invariant (id x) true false true)) :pattern ((id x)))))
(assert (forall ((x us_t)) (! (=> (dynamic_invariant x true true true) (= (id x) x)) :pattern ((id x)))))
(declare-fun temp___String_Literal_181 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (= (to_rep (select (temp___String_Literal_181 us_void_param) 1)) 116) (= (to_rep (select (temp___String_Literal_181 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 3)) 116)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 4)) 111)) :pattern ((temp___String_Literal_181 us_void_param)))))
(declare-fun temp___String_Literal_183 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (= (to_rep (select (temp___String_Literal_183 us_void_param) 5)) 116) (= (to_rep (select (temp___String_Literal_183 us_void_param) 6)) 111)) (= (to_rep (select (temp___String_Literal_183 us_void_param) 7)) 116)) (= (to_rep (select (temp___String_Literal_183 us_void_param) 8)) 111)) :pattern ((temp___String_Literal_183 us_void_param)))))
