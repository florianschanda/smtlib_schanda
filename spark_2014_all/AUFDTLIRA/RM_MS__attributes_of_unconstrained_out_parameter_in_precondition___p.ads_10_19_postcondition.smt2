...
(declare-fun temp___173 (Int Int Int Int Int) us_t1)
...
(assert (forall ((temp___175 Int) (temp___176 Int) (temp___177 Int) (temp___178 Int) (temp___179 Int)) (let ((temp___174 (temp___173 temp___175 temp___176 temp___177 temp___178 temp___179))) (=> (and (and (dynamic_invariant temp___175 true true true true) (dynamic_invariant temp___176 true true true true)) (dynamic_invariant temp___177 true true true true)) (and (=> (dynamic_property 1 2147483647 temp___178 temp___179) (and (= (first3 temp___174) temp___178) (= (last3 temp___174) temp___179))) (forall ((temp___180 Int)) (ite (= temp___180 20) (= (to_rep (select (to_array1 temp___174) temp___180)) temp___176) (ite (= temp___180 1) (= (to_rep (select (to_array1 temp___174) temp___180)) temp___175) (= (to_rep (select (to_array1 temp___174) temp___180)) temp___177)))))))))
...
(assert (= (to_rep (first2 (rt1 (temp___173 (to_rep x__last) (- 1) 0 (to_rep x__first) (to_rep x__last))))) (to_rep x__first)))
(assert (= (to_rep (last2 (rt1 (temp___173 (to_rep x__last) (- 1) 0 (to_rep x__first) (to_rep x__last))))) (to_rep x__last)))
(assert (= (mk___t1 temp___182 temp___1821) (temp___173 (to_rep x__last) (- 1) 0 (to_rep x__first) (to_rep x__last))))
