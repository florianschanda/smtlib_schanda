...
(assert (forall ((temp___151 Int) (temp___152 Int) (temp___153 Int) (temp___154 Int) (temp___155 Int)) (let ((temp___150 (temp___149 temp___151 temp___152 temp___153 temp___154 temp___155))) (and (=> (dynamic_property 1 2147483647 temp___154 temp___155) (and (= (first3 temp___150) temp___154) (= (last3 temp___150) temp___155))) (forall ((temp___156 Int)) (ite (= temp___156 20) (= (select (to_array1 temp___150) temp___156) (of_rep temp___152)) (ite (= temp___156 1) (= (select (to_array1 temp___150) temp___156) (of_rep temp___151)) (= (select (to_array1 temp___150) temp___156) (of_rep temp___153)))))))))
...
(assert (= (to_rep (first2 (rt1 (temp___149 (to_rep x__last) (- 1) 0 (to_rep x__first) (to_rep x__last))))) (to_rep x__first)))
(assert (= (to_rep (last2 (rt1 (temp___149 (to_rep x__last) (- 1) 0 (to_rep x__first) (to_rep x__last))))) (to_rep x__last)))
(assert (= (mk___t1 temp___158 temp___1581) (temp___149 (to_rep x__last) (- 1) 0 (to_rep x__first) (to_rep x__last))))
(assert (= temp___158 temp___159))
(assert (= (mk (to_rep (first2 temp___1581)) (to_rep (last2 temp___1581))) temp___1591))
(assert (= (ite (<= (to_rep (first temp___1591)) (to_rep (last temp___1591))) (+ (- (to_rep (last temp___1591)) (to_rep (first temp___1591))) 1) 0) (ite (<= (to_rep x__first) (to_rep x__last)) (+ (- (to_rep x__last) (to_rep x__first)) 1) 0)))
(assert (= (mk___t temp___160 temp___1601) (mk___t temp___159 temp___1591)))
(assert (= o (slide temp___160 (to_rep (first temp___1601)) (to_rep x__first))))
(assert (= (mk_map__ref result) (mk_map__ref x)))
(assert (= x1 o))
(assert (= x1 x2))
(assert (= x3 x1))
(declare-const i1 Int)
(assert (<= (to_rep x__first) i1))
(assert (<= i1 (to_rep x__last)))
(assert (= i1 1))
(assert (not (= (to_rep (select x2 i1)) (to_rep x__last))))
(check-sat)
(exit)
