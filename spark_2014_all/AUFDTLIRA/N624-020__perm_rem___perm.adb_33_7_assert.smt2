...
(declare-const perm__get_witness__result4 int__ref)
(declare-const ib4 Int)
(declare-const perm__get_witness__result5 Int)
(declare-const ib5 int__ref)
(declare-const perm__get_witness__result6 int__ref)
...
(assert (in_range2 ia))
(assert (and (= (invariant__ a) true) (and (= (invariant__ b) true) (and (and (<= (to_rep1 (first (rt a))) ia) (<= ia (to_rep1 (last (rt a))))) (exists ((ib7 Int)) (and (and (<= (to_rep1 (first (rt b))) ib7) (<= ib7 (to_rep1 (last (rt b))))) (and (= (to_rep (select (elts a) ia)) (to_rep (select (elts b) ib7))) (= (is_perm (remove a ia) (remove b ib7)) true))))))))
(assert (not (not (and (and (= (mk_int__ref result) (mk_int__ref ib)) (= ib1 (to_rep1 (first (rt b))))) (ite (and (<= (to_rep1 (first (rt b))) ib1) (<= ib1 (to_rep1 (last (rt b))))) (and (and (and (= temp___647 ib1) (and (and (and (and (and (and (and (and (<= (to_rep1 (first (rt a))) ia) (<= ia (to_rep1 (last (rt a))))) (= o5 ia)) (= o6 (select (elts a) o5))) (= o7 (to_rep o6))) (= result2 (ite (= o7 (to_rep (select (elts b) ib1))) true false))) (ite (= result2 true) (and (and (and (= o2 ib1) (in_range2 ib1)) (and (= o8 (remove b o2)) (and (dynamic_invariant1 o8 true false true true) (and (= (invariant__ o8) true) (and (= (to_rep1 (last o4)) (- (to_rep1 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o2 1))) (= (to_rep (select (elts b) k)) (to_rep (select o3 k))))) (and (forall ((k Int)) (=> (and (<= (+ o2 1) k) (<= k (to_rep1 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select o3 (- k 1)))))) (forall ((k Int)) (=> (and (<= o2 k) (<= k (- (to_rep1 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o3 k)))))))))))) (and (and (= o9 (remove a ia)) (and (dynamic_invariant1 o9 true false true true) (and (= (invariant__ o9) true) (and (= (to_rep1 (last o1)) (- (to_rep1 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ia 1))) (= (to_rep (select (elts a) k)) (to_rep (select o k))))) (and (forall ((k Int)) (=> (and (<= (+ ia 1) k) (<= k (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select o (- k 1)))))) (forall ((k Int)) (=> (and (<= ia k) (<= k (- (to_rep1 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select o k))))))))))) (and (= result1 (is_perm o9 o8)) (= (= result1 true) (or (and (= (length o9) 0) (= (length o8) 0)) (exists ((ia1 Int)) (and (and (<= (to_rep1 (first o1)) ia1) (<= ia1 (to_rep1 (last o1)))) (exists ((ib7 Int)) (and (and (<= (to_rep1 (first o4)) ib7) (<= ib7 (to_rep1 (last o4)))) (and (= (to_rep (select o ia1)) (to_rep (select o3 ib7))) (= (is_perm (remove o9 ia1) (remove o8 ib7)) true))))))))))) (= result1 false))) (and (not (= result1 true)) (and (= perm__get_witness__result2 perm__get_witness__result) (= perm__get_witness__result2 perm__get_witness__result1)))) (and (forall ((kb Int)) (=> (and (<= 1 kb) (<= kb ib2)) (not (and (= (to_rep (select (elts a) ia)) (to_rep (select (elts b) kb))) (= (is_perm (remove a ia) (remove b kb)) true))))) (and (and (=> (<= (to_rep1 (first (rt b))) (to_rep1 (last (rt b)))) (dynamic_property1 (to_rep1 (first (rt b))) (to_rep1 (last (rt b))) ib2)) (and (<= (to_rep1 (first (rt b))) ib2) (<= ib2 (to_rep1 (last (rt b)))))) (= ib2 (to_rep1 (last (rt b)))))))) (and (and (= perm__get_witness__result4 (mk_int__ref perm__get_witness__result3)) (= ib2 ib3)) (and (= perm__get_witness__result5 perm__get_witness__result3) (= ib4 ib2)))) (and (and (= perm__get_witness__result6 perm__get_witness__result4) (= ib5 (mk_int__ref ib3))) (and (= perm__get_witness__result7 perm__get_witness__result5) (= ib6 ib4)))) (and (and (= perm__get_witness__result6 (mk_int__ref perm__get_witness__result)) (= ib5 (mk_int__ref ib1))) (and (= perm__get_witness__result7 perm__get_witness__result1) (= ib6 ib1))))))))
(check-sat)
(exit)
