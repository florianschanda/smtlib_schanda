...
(assert (=> (and (<= (to_rep1 (first (rt b))) ib2) (<= ib2 (to_rep1 (last (rt b))))) (and (and (= temp___583 ib2) (and (and (and (and (and (and (and (and (<= (to_rep1 (first (rt a))) ia) (<= ia (to_rep1 (last (rt a))))) (= o16 ia)) (= o17 (select (elts a) o16))) (= o18 (to_rep o17))) (= result5 (ite (= o18 (to_rep (select (elts b) ib2))) true false))) (ite (= result5 true) (and (and (and (= o13 ib2) (in_range2 ib2)) (and (= (mk___t o14 o15) (remove b o13)) (and (dynamic_invariant1 (mk___t o14 o15) true false true) (and (= (invariant__ (mk___t o14 o15)) true) (and (= (to_rep1 (last o15)) (- (to_rep1 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o13 1))) (= (to_rep (select (elts b) k)) (to_rep (select o14 k))))) (and (forall ((k Int)) (=> (and (<= (+ o13 1) k) (<= k (to_rep1 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select o14 (- k 1)))))) (forall ((k Int)) (=> (and (<= o13 k) (<= k (- (to_rep1 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o14 k)))))))))))) (and (and (= (mk___t o11 o12) (remove a ia)) (and (dynamic_invariant1 (mk___t o11 o12) true false true) (and (= (invariant__ (mk___t o11 o12)) true) (and (= (to_rep1 (last o12)) (- (to_rep1 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ia 1))) (= (to_rep (select (elts a) k)) (to_rep (select o11 k))))) (and (forall ((k Int)) (=> (and (<= (+ ia 1) k) (<= k (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select o11 (- k 1)))))) (forall ((k Int)) (=> (and (<= ia k) (<= k (- (to_rep1 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select o11 k))))))))))) (and (= result4 (is_perm (mk___t o11 o12) (mk___t o14 o15))) (= (= result4 true) (or (and (= (length (mk___t o11 o12)) 0) (= (length (mk___t o14 o15)) 0)) (exists ((ia1 Int)) (and (and (<= (to_rep1 (first o12)) ia1) (<= ia1 (to_rep1 (last o12)))) (exists ((ib17 Int)) (and (and (<= (to_rep1 (first o15)) ib17) (<= ib17 (to_rep1 (last o15)))) (and (= (to_rep (select o11 ia1)) (to_rep (select o14 ib17))) (= (is_perm (remove (mk___t o11 o12) ia1) (remove (mk___t o14 o15) ib17)) true))))))))))) (= result4 false))) (and (not (= result4 true)) (and (= perm__get_witness__result2 perm__get_witness__result) (= perm__get_witness__result2 perm__get_witness__result1)))) (and (forall ((kb1 Int)) (=> (and (<= 1 kb1) (<= kb1 ib3)) (not (and (= (to_rep (select (elts a) ia)) (to_rep (select (elts b) kb1))) (= (is_perm (remove a ia) (remove b kb1)) true))))) (and (and (=> (<= (to_rep1 (first (rt b))) (to_rep1 (last (rt b)))) (dynamic_property1 (to_rep1 (first (rt b))) (to_rep1 (last (rt b))) ib3)) (and (<= (to_rep1 (first (rt b))) ib3) (<= ib3 (to_rep1 (last (rt b)))))) (= ib3 (to_rep1 (last (rt b)))))))) (and (and (= perm__get_witness__result9 (mk_int__ref perm__get_witness__result3)) (= ib3 ib9)) (and (= perm__get_witness__result10 perm__get_witness__result3) (= ib10 ib3))))))
(assert (=> (and (<= (to_rep1 (first (rt b))) ib2) (<= ib2 (to_rep1 (last (rt b))))) (= perm__get_witness__result11 perm__get_witness__result9)))
(assert (=> (and (<= (to_rep1 (first (rt b))) ib2) (<= ib2 (to_rep1 (last (rt b))))) (= ib11 (mk_int__ref ib9))))
(assert (=> (and (<= (to_rep1 (first (rt b))) ib2) (<= ib2 (to_rep1 (last (rt b))))) (= perm__get_witness__result12 perm__get_witness__result10)))
(assert (=> (and (<= (to_rep1 (first (rt b))) ib2) (<= ib2 (to_rep1 (last (rt b))))) (= ib12 ib10)))
(assert (=> (not (and (<= (to_rep1 (first (rt b))) ib2) (<= ib2 (to_rep1 (last (rt b)))))) (= perm__get_witness__result11 (mk_int__ref perm__get_witness__result))))
(assert (=> (not (and (<= (to_rep1 (first (rt b))) ib2) (<= ib2 (to_rep1 (last (rt b)))))) (= ib11 (mk_int__ref ib2))))
(assert (=> (not (and (<= (to_rep1 (first (rt b))) ib2) (<= ib2 (to_rep1 (last (rt b)))))) (= perm__get_witness__result12 perm__get_witness__result1)))
(assert (=> (not (and (<= (to_rep1 (first (rt b))) ib2) (<= ib2 (to_rep1 (last (rt b)))))) (= ib12 ib2)))
(assert (not false))
(check-sat)
(exit)
