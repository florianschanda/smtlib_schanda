...
(define-fun dynamic_invariant4 ((temp___expr_183 us_t1) (temp___is_init_179 Bool) (temp___skip_constant_180 Bool) (temp___do_toplevel_181 Bool) (temp___do_typ_inv_182 Bool)) Bool (=> (not (= temp___skip_constant_180 true)) (and (dynamic_property2 1 b_max (first3 temp___expr_183) (last3 temp___expr_183)) (and (= (first3 temp___expr_183) 1) (= (last3 temp___expr_183) b_max)))))
(define-fun dynamic_invariant5 ((temp___expr_193 us_t2) (temp___is_init_189 Bool) (temp___skip_constant_190 Bool) (temp___do_toplevel_191 Bool) (temp___do_typ_inv_192 Bool)) Bool (=> (not (= temp___skip_constant_190 true)) (and (dynamic_property4 1 b_max (first5 temp___expr_193) (last5 temp___expr_193)) (and (= (first5 temp___expr_193) 1) (= (last5 temp___expr_193) b_max)))))
(define-fun dynamic_invariant6 ((temp___expr_203 us_t3) (temp___is_init_199 Bool) (temp___skip_constant_200 Bool) (temp___do_toplevel_201 Bool) (temp___do_typ_inv_202 Bool)) Bool (=> (not (= temp___skip_constant_200 true)) (and (dynamic_property6 1 b_max (first7 temp___expr_203) (last7 temp___expr_203)) (and (= (first7 temp___expr_203) 1) (= (last7 temp___expr_203) b_max)))))
