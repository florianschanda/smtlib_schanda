...
(assert (=> (and (<= (- 2147483648) e1) (<= e1 2147483647)) (and (and (= temp___313 e1) (and (and (and (and (and (and (<= (to_rep (first2 (rt1 init))) y) (<= y (to_rep (last2 (rt1 init))))) (= o6 y)) (= o7 (select (elts1 init) o6))) (= o8 (to_rep o7))) (ite (= o8 (to_rep (select (elts1 init) x))) (= (occ (mk___t interm (mk (to_rep interm__first) (to_rep interm__last))) e1) (occ (mk___t (elts1 init) (mk (to_rep (first2 (rt1 init))) (to_rep (last2 (rt1 init))))) e1)) (ite (= o8 e1) (= (occ (mk___t interm (mk (to_rep interm__first) (to_rep interm__last))) e1) (+ (occ (mk___t (elts1 init) (mk (to_rep (first2 (rt1 init))) (to_rep (last2 (rt1 init))))) e1) 1)) (ite (= (to_rep (select (elts1 init) x)) e1) (= (occ (mk___t interm (mk (to_rep interm__first) (to_rep interm__last))) e1) (- (occ (mk___t (elts1 init) (mk (to_rep (first2 (rt1 init))) (to_rep (last2 (rt1 init))))) e1) 1)) (= (occ (mk___t interm (mk (to_rep interm__first) (to_rep interm__last))) e1) (occ (mk___t (elts1 init) (mk (to_rep (first2 (rt1 init))) (to_rep (last2 (rt1 init))))) e1)))))) (and (and (and (and (and (and (<= (to_rep (first2 (rt1 init))) x) (<= x (to_rep (last2 (rt1 init))))) (= o9 x)) (= o10 (select (elts1 init) o9))) (= o11 (to_rep o10))) (ite (= o11 (to_rep (select interm y))) (= (occ (mk___t values (mk (to_rep values__first) (to_rep values__last))) e1) (occ (mk___t interm (mk (to_rep interm__first) (to_rep interm__last))) e1)) (ite (= o11 e1) (= (occ (mk___t values (mk (to_rep values__first) (to_rep values__last))) e1) (+ (occ (mk___t interm (mk (to_rep interm__first) (to_rep interm__last))) e1) 1)) (ite (= (to_rep (select interm y)) e1) (= (occ (mk___t values (mk (to_rep values__first) (to_rep values__last))) e1) (- (occ (mk___t interm (mk (to_rep interm__first) (to_rep interm__last))) e1) 1)) (= (occ (mk___t values (mk (to_rep values__first) (to_rep values__last))) e1) (occ (mk___t interm (mk (to_rep interm__first) (to_rep interm__last))) e1)))))) (and (forall ((f Int)) (=> (and (<= (- 2147483648) f) (<= f e2)) (= (occ (mk___t values (mk (to_rep values__first) (to_rep values__last))) f) (occ (mk___t (elts1 init) (mk (to_rep (first2 (rt1 init))) (to_rep (last2 (rt1 init))))) f)))) (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 e2)) (and (<= (- 2147483648) e2) (<= e2 2147483647))) (= e2 2147483647)))))) (and (= e2 e6) (= e7 e2)))))
(assert (=> (and (<= (- 2147483648) e1) (<= e1 2147483647)) (= (mk_int__ref e8) (mk_int__ref e6))))
(assert (=> (and (<= (- 2147483648) e1) (<= e1 2147483647)) (= e9 e7)))
(assert (=> (not (and (<= (- 2147483648) e1) (<= e1 2147483647))) (= e1 e8)))
(assert (=> (not (and (<= (- 2147483648) e1) (<= e1 2147483647))) (= e9 e1)))
(assert (= e10 e8))
(assert (= e11 e9))
