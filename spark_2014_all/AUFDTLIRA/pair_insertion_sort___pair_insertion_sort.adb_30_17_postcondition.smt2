...
(assert (=> (and (<= (- 2147483648) e1) (<= e1 2147483647)) (= temp___349 e1)))
(assert (=> (and (<= (- 2147483648) e1) (<= e1 2147483647)) (and (<= (to_rep (first2 (rt1 init))) y) (<= y (to_rep (last2 (rt1 init)))))))
(assert (=> (and (<= (- 2147483648) e1) (<= e1 2147483647)) (= o y)))
(assert (=> (and (<= (- 2147483648) e1) (<= e1 2147483647)) (= o1 (select (elts1 init) o))))
(assert (=> (and (<= (- 2147483648) e1) (<= e1 2147483647)) (= o2 (to_rep o1))))
(assert (=> (and (<= (- 2147483648) e1) (<= e1 2147483647)) (ite (= o2 (to_rep (select (elts1 init) x))) (= (occ (mk___t interm (mk (to_rep interm__first) (to_rep interm__last))) e1) (occ (mk___t (elts1 init) (mk (to_rep (first2 (rt1 init))) (to_rep (last2 (rt1 init))))) e1)) (ite (= o2 e1) (= (occ (mk___t interm (mk (to_rep interm__first) (to_rep interm__last))) e1) (+ (occ (mk___t (elts1 init) (mk (to_rep (first2 (rt1 init))) (to_rep (last2 (rt1 init))))) e1) 1)) (ite (= (to_rep (select (elts1 init) x)) e1) (= (occ (mk___t interm (mk (to_rep interm__first) (to_rep interm__last))) e1) (- (occ (mk___t (elts1 init) (mk (to_rep (first2 (rt1 init))) (to_rep (last2 (rt1 init))))) e1) 1)) (= (occ (mk___t interm (mk (to_rep interm__first) (to_rep interm__last))) e1) (occ (mk___t (elts1 init) (mk (to_rep (first2 (rt1 init))) (to_rep (last2 (rt1 init))))) e1)))))))
(assert (=> (and (<= (- 2147483648) e1) (<= e1 2147483647)) (and (<= (to_rep (first2 (rt1 init))) x) (<= x (to_rep (last2 (rt1 init)))))))
(assert (=> (and (<= (- 2147483648) e1) (<= e1 2147483647)) (= o3 x)))
(assert (=> (and (<= (- 2147483648) e1) (<= e1 2147483647)) (= o4 (select (elts1 init) o3))))
(assert (=> (and (<= (- 2147483648) e1) (<= e1 2147483647)) (= o5 (to_rep o4))))
...
(assert (=> (and (<= (- 2147483648) e1) (<= e1 2147483647)) (forall ((f Int)) (=> (and (<= (- 2147483648) f) (<= f e2)) (= (occ (mk___t values (mk (to_rep values__first) (to_rep values__last))) f) (occ (mk___t (elts1 init) (mk (to_rep (first2 (rt1 init))) (to_rep (last2 (rt1 init))))) f))))))
(assert (=> (and (<= (- 2147483648) e1) (<= e1 2147483647)) (and (=> (<= (- 2147483648) 2147483647) (in_range1 e2)) (and (<= (- 2147483648) e2) (<= e2 2147483647)))))
(assert (=> (and (<= (- 2147483648) e1) (<= e1 2147483647)) (= e2 2147483647)))
(assert (=> (and (<= (- 2147483648) e1) (<= e1 2147483647)) (= e2 e3)))
(assert (=> (and (<= (- 2147483648) e1) (<= e1 2147483647)) (= e4 e2)))
(assert (=> (and (<= (- 2147483648) e1) (<= e1 2147483647)) (= (mk_int__ref e5) (mk_int__ref e3))))
(assert (=> (and (<= (- 2147483648) e1) (<= e1 2147483647)) (= e6 e4)))
(assert (=> (not (and (<= (- 2147483648) e1) (<= e1 2147483647))) (= e1 e5)))
(assert (=> (not (and (<= (- 2147483648) e1) (<= e1 2147483647))) (= e6 e1)))
(assert (= e7 e5))
(assert (= e8 e6))
(assert (not (= (is_perm (mk___t (elts1 init) (mk (to_rep (first2 (rt1 init))) (to_rep (last2 (rt1 init))))) (mk___t values (mk (to_rep values__first) (to_rep values__last)))) true)))
(check-sat)
(exit)
