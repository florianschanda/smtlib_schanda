...
(assert (not (= (length (mk___t temp___1187 temp___11871)) 0)))
(assert (=> (<= 1 2) (= o12 (+ (- 2 1) 1))))
(assert (=> (not (<= 1 2)) (= o12 0)))
(assert (=> (<= (to_rep1 (first temp___11871)) (to_rep1 (last temp___11871))) (= o13 (+ (- (to_rep1 (last temp___11871)) (to_rep1 (first temp___11871))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___11871)) (to_rep1 (last temp___11871)))) (= o13 0)))
(assert (= o14 (+ o13 o12)))
(assert (= o15 (+ (to_rep1 (first temp___11871)) o14)))
(assert (= o16 (- o15 1)))
