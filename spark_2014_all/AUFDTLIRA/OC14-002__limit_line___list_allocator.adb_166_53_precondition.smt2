...
(assert (and (= o124 (length (rec__list_allocator__m__t__allocated model____split_fields4))) (in_range6 o124)))
(assert (= o125 (ite (<= j9 o124) true false)))
(assert (= result33 (ite (<= 1 j9) o125 false)))
(assert (= result33 true))
(assert (and (= o129 (get (rec__list_allocator__m__t__allocated model____split_fields4) j9)) (in_range7 o129)))
(assert (= result34 (ite (in_range4 o129) true false)))
(assert (= result34 true))
(assert (and (= o126 (length (rec__list_allocator__m__t__allocated model____split_fields4))) (in_range6 o126)))
(assert (= result35 (ite (< j9 o126) true false)))
(assert (= result35 true))
(assert (and (= o127 (+ j9 1)) (in_range1 (+ j9 1))))
(assert (not (<= 1 o127)))
(check-sat)
(exit)
