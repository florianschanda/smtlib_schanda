...
(assert (and (= o40 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (in_range4 o40)))
...
(assert (not (<= o39 (length (rec__list_allocator__m__t__allocated model____split_fields3)))))
(check-sat)
(exit)
