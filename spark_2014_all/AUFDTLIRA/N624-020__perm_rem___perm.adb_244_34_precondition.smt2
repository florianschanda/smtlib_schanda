...
(assert (and (= o61 (remove b ib8)) (and (dynamic_invariant2 o61 true false true) (and (= (invariant__ o61) true) (and (= (to_rep2 (last (rt o61))) (- (to_rep2 (last (rt b))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- ib8 1))) (= (to_rep (select (elts b) k1)) (to_rep (select (elts o61) k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ ib8 1) k1) (<= k1 (to_rep2 (last (rt b))))) (= (to_rep (select (elts b) k1)) (to_rep (select (elts o61) (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= ib8 k1) (<= k1 (- (to_rep2 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k1 1))) (to_rep (select (elts o61) k1))))))))))))
(assert (and (= o62 (remove o61 (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))))) (and (dynamic_invariant2 o62 true false true) (and (= (invariant__ o62) true) (and (= (to_rep2 (last (rt o62))) (- (to_rep2 (last (rt o61))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1))) (= (to_rep (select (elts o61) k1)) (to_rep (select (elts o62) k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1) k1) (<= k1 (to_rep2 (last (rt o61))))) (= (to_rep (select (elts o61) k1)) (to_rep (select (elts o62) (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) k1) (<= k1 (- (to_rep2 (last (rt o61))) 1))) (= (to_rep (select (elts o61) (+ k1 1))) (to_rep (select (elts o62) k1))))))))))))
(assert (and (= o59 (- (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) 1)) (in_range4 (- (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) 1))))
(assert (and (= o57 ia3) (in_range4 ia3)))
(assert (and (= o58 (remove a o57)) (and (dynamic_invariant2 o58 true false true) (and (= (invariant__ o58) true) (and (= (to_rep2 (last (rt o58))) (- (to_rep2 (last (rt a))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- o57 1))) (= (to_rep (select (elts a) k1)) (to_rep (select (elts o58) k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ o57 1) k1) (<= k1 (to_rep2 (last (rt a))))) (= (to_rep (select (elts a) k1)) (to_rep (select (elts o58) (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= o57 k1) (<= k1 (- (to_rep2 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k1 1))) (to_rep (select (elts o58) k1))))))))))))
(assert (not (= (invariant__ o58) true)))
(check-sat)
(exit)
