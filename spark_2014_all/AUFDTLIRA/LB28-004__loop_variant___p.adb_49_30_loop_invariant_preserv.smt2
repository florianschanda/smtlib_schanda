...
(assert (= j29 a))
(assert (<= j29 b))
(assert (= (to_rep o31) j29))
(assert (and (<= (to_rep tab__first) j29) (<= j29 (to_rep tab__last))))
(assert (= o32 j29))
(assert (= o33 (store (map__content tab21) o32 o31)))
(assert (= result29 tab21))
(assert (= tab23 o33))
(assert (and (= o34 (+ j29 1)) (in_range1 (+ j29 1))))
(assert (= result30 (mk_int__ref j29)))
(assert (= j30 o34))
(assert (forall ((l8 Int)) (=> (and (<= a l8) (<= l8 (- j31 1))) (= (to_rep (select tab24 l8)) l8))))
(assert (=> (<= (- 2147483648) 2147483647) (in_range1 j31)))
(assert (= result32 (mk_int__ref temp___1681)))
(assert (= temp___1682 j31))
(assert (<= j31 b))
(assert (= (to_rep o37) j31))
(assert (and (<= (to_rep tab__first) j31) (<= j31 (to_rep tab__last))))
(assert (= o38 j31))
(assert (= o39 (store tab24 o38 o37)))
(assert (= result33 (mk_map__ref tab24)))
(assert (= tab25 o39))
(assert (and (= o40 (+ j31 1)) (in_range1 (+ j31 1))))
(assert (= result34 (mk_int__ref j31)))
(assert (= j32 o40))
(assert (= temp___1683 (mk_int__ref temp___1682)))
(assert (= j33 (mk_int__ref j32)))
(assert (= tab26 (mk_map__ref tab25)))
(assert (= temp___1684 temp___1682))
(assert (= j34 j32))
(assert (= tab27 tab25))
(declare-const l8 Int)
(assert (<= a l8))
(assert (<= l8 (- (int__content j33) 1)))
(assert (not (= (to_rep (select (map__content tab26) l8)) l8)))
(check-sat)
(exit)
