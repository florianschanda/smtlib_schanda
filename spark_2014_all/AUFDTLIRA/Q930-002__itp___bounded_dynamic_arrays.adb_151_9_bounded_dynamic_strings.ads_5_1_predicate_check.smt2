...
(declare-const temp___1149 (Array Int character))
(declare-const temp___11491 t1)
(declare-const temp___1148 (Array Int character))
(declare-const temp___11481 t1)
...
(declare-const temp___1150 (Array Int character))
(declare-const temp___11501 t)
(declare-const temp___1151 (Array Int character))
(declare-const temp___11511 t4)
...
(declare-const temp___1159 natural_index)
(declare-const temp___11591 natural_index)
(declare-const temp___11592 (Array Int character))
(declare-const temp___11593 t2)
(define-fun temp___11482 () us_t1 (mk___t1 temp___1148 temp___11481))
(define-fun temp___11492 () us_t1 (mk___t1 temp___1149 temp___11491))
...
(assert (and (= temp___11492 (value tail)) (and (dynamic_invariant3 temp___11492 true false true true) (and (and (= (elts2 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 tail))) temp___1149) (= (mk1 (to_rep1 (first6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 tail)))))) (to_rep1 (last6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 tail))))))) temp___11491)) (and (and (and (= (length1 temp___11492) (length3 tail)) (= (to_rep1 (first2 temp___11491)) 1)) (= (to_rep1 (last2 temp___11491)) (length3 tail))) (= (< 0 (length3 tail)) (not (= (empty tail) true))))))))
(assert (and (= temp___11482 (value (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2))))) (and (dynamic_invariant3 temp___11482 true false true true) (and (and (= to____split_fields1 temp___1148) (= (mk1 (to_rep1 (first6 (mk3 1 (to_rep2 to____split_fields)))) (to_rep1 (last6 (mk3 1 (to_rep2 to____split_fields))))) temp___11481)) (and (and (and (= (length1 temp___11482) (length3 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2))))) (= (to_rep1 (first2 temp___11481)) 1)) (= (to_rep1 (last2 temp___11481)) (length3 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2)))))) (= (< 0 (length3 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2))))) (not (= (empty (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2)))) true))))))))
(assert (=> (= (length1 temp___11482) 0) (= temp___1149 temp___1150)))
(assert (=> (= (length1 temp___11482) 0) (= (mk (to_rep1 (first2 temp___11491)) (to_rep1 (last2 temp___11491))) temp___11501)))
(assert (=> (not (= (length1 temp___11482) 0)) (=> (<= (to_rep1 (first2 temp___11491)) (to_rep1 (last2 temp___11491))) (= o2 (+ (- (to_rep1 (last2 temp___11491)) (to_rep1 (first2 temp___11491))) 1)))))
(assert (=> (not (= (length1 temp___11482) 0)) (=> (not (<= (to_rep1 (first2 temp___11491)) (to_rep1 (last2 temp___11491)))) (= o2 0))))
(assert (=> (not (= (length1 temp___11482) 0)) (=> (<= (to_rep1 (first2 temp___11481)) (to_rep1 (last2 temp___11481))) (= o3 (+ (- (to_rep1 (last2 temp___11481)) (to_rep1 (first2 temp___11481))) 1)))))
(assert (=> (not (= (length1 temp___11482) 0)) (=> (not (<= (to_rep1 (first2 temp___11481)) (to_rep1 (last2 temp___11481)))) (= o3 0))))
(assert (=> (not (= (length1 temp___11482) 0)) (= o4 (+ o3 o2))))
(assert (=> (not (= (length1 temp___11482) 0)) (= o5 (+ (to_rep1 (first2 temp___11481)) o4))))
(assert (=> (not (= (length1 temp___11482) 0)) (= o6 (- o5 1))))
(assert (=> (not (= (length1 temp___11482) 0)) (and (= o7 o6) (in_range2 o6))))
(assert (=> (not (= (length1 temp___11482) 0)) (= (concat1 temp___1148 (to_rep1 (first2 temp___11481)) (to_rep1 (last2 temp___11481)) temp___1149 (to_rep1 (first2 temp___11491)) (to_rep1 (last2 temp___11491))) temp___1150)))
(assert (=> (not (= (length1 temp___11482) 0)) (= (mk (to_rep1 (first2 temp___11481)) o7) temp___11501)))
(assert (= (ite (<= (to_rep1 (first temp___11501)) (to_rep1 (last temp___11501))) (+ (- (to_rep1 (last temp___11501)) (to_rep1 (first temp___11501))) 1) 0) (ite (<= 1 new_length) (+ (- new_length 1) 1) 0)))
(assert (= (slide temp___1150 (to_rep1 (first temp___11501)) 1) temp___1151))
(assert (= (mk4 1 new_length) temp___11511))
(assert (=> (<= 1 new_length) (and (and (<= (to_rep1 (first4 to____split_fields2)) 1) (<= 1 (to_rep1 (last4 to____split_fields2)))) (and (<= (to_rep1 (first4 to____split_fields2)) new_length) (<= new_length (to_rep1 (last4 to____split_fields2)))))))
(assert (= o8 to____split_fields1))
(assert (= o8 temp___1154))
(assert (= (mk4 1 new_length) temp___11541))
(assert (= (ite (<= (to_rep1 (first8 temp___11511)) (to_rep1 (last8 temp___11511))) (+ (- (to_rep1 (last8 temp___11511)) (to_rep1 (first8 temp___11511))) 1) 0) (ite (<= (to_rep1 (first8 temp___11541)) (to_rep1 (last8 temp___11541))) (+ (- (to_rep1 (last8 temp___11541)) (to_rep1 (first8 temp___11541))) 1) 0)))
(assert (= (mk___t4 temp___1156 temp___11561) (mk___t4 temp___1151 temp___11511)))
(assert (and (and (= (to_rep1 (first4 to____split_fields2)) (to_rep1 (first4 o10))) (= (to_rep1 (last4 to____split_fields2)) (to_rep1 (last4 o10)))) (forall ((temp___1157 Int)) (ite (and (<= 1 temp___1157) (<= temp___1157 new_length)) (= (select o9 temp___1157) (select temp___1156 temp___1157)) (= (select o9 temp___1157) (select to____split_fields1 temp___1157))))))
(assert (= to____split_fields o11))
(assert (= o12 o9))
(assert (= o13 o10))
(assert (= to____split_discrs (mk___split_discrs temp___1159)))
(assert (= temp___11591 o11))
(assert (= temp___11592 o12))
(assert (= temp___11593 o13))
(assert (not (dynamic_predicate (mk___rep (mk___split_discrs temp___1159) (mk___split_fields temp___11591 (mk___t2 temp___11592 temp___11593))))))
(check-sat)
(exit)
