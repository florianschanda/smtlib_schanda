...
(assert (and (= (mk___t1 temp___1086 temp___10861) (value tail)) (and (dynamic_invariant3 (mk___t1 temp___1086 temp___10861) true false true) (and (and (= (elts2 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 tail))) temp___1086) (= (mk1 (to_rep1 (first6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 tail)))))) (to_rep1 (last6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 tail))))))) temp___10861)) (and (and (and (= (length1 (mk___t1 temp___1086 temp___10861)) (length3 tail)) (= (to_rep1 (first2 temp___10861)) 1)) (= (to_rep1 (last2 temp___10861)) (length3 tail))) (= (< 0 (length3 tail)) (not (= (empty tail) true))))))))
(assert (and (= (mk___t1 temp___1085 temp___10851) (value (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2))))) (and (dynamic_invariant3 (mk___t1 temp___1085 temp___10851) true false true) (and (and (= to____split_fields1 temp___1085) (= (mk1 (to_rep1 (first6 (mk3 1 (to_rep2 to____split_fields)))) (to_rep1 (last6 (mk3 1 (to_rep2 to____split_fields))))) temp___10851)) (and (and (and (= (length1 (mk___t1 temp___1085 temp___10851)) (length3 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2))))) (= (to_rep1 (first2 temp___10851)) 1)) (= (to_rep1 (last2 temp___10851)) (length3 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2)))))) (= (< 0 (length3 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2))))) (not (= (empty (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2)))) true))))))))
(assert (=> (= (length1 (mk___t1 temp___1085 temp___10851)) 0) (= temp___1086 temp___1087)))
(assert (=> (= (length1 (mk___t1 temp___1085 temp___10851)) 0) (= (mk (to_rep1 (first2 temp___10861)) (to_rep1 (last2 temp___10861))) temp___10871)))
(assert (=> (not (= (length1 (mk___t1 temp___1085 temp___10851)) 0)) (=> (<= (to_rep1 (first2 temp___10861)) (to_rep1 (last2 temp___10861))) (= o2 (+ (- (to_rep1 (last2 temp___10861)) (to_rep1 (first2 temp___10861))) 1)))))
(assert (=> (not (= (length1 (mk___t1 temp___1085 temp___10851)) 0)) (=> (not (<= (to_rep1 (first2 temp___10861)) (to_rep1 (last2 temp___10861)))) (= o2 0))))
(assert (=> (not (= (length1 (mk___t1 temp___1085 temp___10851)) 0)) (=> (<= (to_rep1 (first2 temp___10851)) (to_rep1 (last2 temp___10851))) (= o3 (+ (- (to_rep1 (last2 temp___10851)) (to_rep1 (first2 temp___10851))) 1)))))
(assert (=> (not (= (length1 (mk___t1 temp___1085 temp___10851)) 0)) (=> (not (<= (to_rep1 (first2 temp___10851)) (to_rep1 (last2 temp___10851)))) (= o3 0))))
(assert (=> (not (= (length1 (mk___t1 temp___1085 temp___10851)) 0)) (= o4 (+ o3 o2))))
(assert (=> (not (= (length1 (mk___t1 temp___1085 temp___10851)) 0)) (= o5 (+ (to_rep1 (first2 temp___10851)) o4))))
(assert (=> (not (= (length1 (mk___t1 temp___1085 temp___10851)) 0)) (= o6 (- o5 1))))
(assert (=> (not (= (length1 (mk___t1 temp___1085 temp___10851)) 0)) (and (= o7 o6) (in_range2 o6))))
(assert (=> (not (= (length1 (mk___t1 temp___1085 temp___10851)) 0)) (= (concat1 temp___1085 (to_rep1 (first2 temp___10851)) (to_rep1 (last2 temp___10851)) temp___1086 (to_rep1 (first2 temp___10861)) (to_rep1 (last2 temp___10861))) temp___1087)))
(assert (=> (not (= (length1 (mk___t1 temp___1085 temp___10851)) 0)) (= (mk (to_rep1 (first2 temp___10851)) o7) temp___10871)))
(assert (= (ite (<= (to_rep1 (first temp___10871)) (to_rep1 (last temp___10871))) (+ (- (to_rep1 (last temp___10871)) (to_rep1 (first temp___10871))) 1) 0) (ite (<= 1 new_length) (+ (- new_length 1) 1) 0)))
(assert (= (slide temp___1087 (to_rep1 (first temp___10871)) 1) temp___1088))
(assert (= (mk4 1 new_length) temp___10881))
...
(assert (= o8 temp___1091))
(assert (= (mk4 1 new_length) temp___10911))
(assert (= (ite (<= (to_rep1 (first8 temp___10881)) (to_rep1 (last8 temp___10881))) (+ (- (to_rep1 (last8 temp___10881)) (to_rep1 (first8 temp___10881))) 1) 0) (ite (<= (to_rep1 (first8 temp___10911)) (to_rep1 (last8 temp___10911))) (+ (- (to_rep1 (last8 temp___10911)) (to_rep1 (first8 temp___10911))) 1) 0)))
(assert (= (mk___t4 temp___1093 temp___10931) (mk___t4 temp___1088 temp___10881)))
(assert (and (and (= (to_rep1 (first4 to____split_fields2)) (to_rep1 (first4 o10))) (= (to_rep1 (last4 to____split_fields2)) (to_rep1 (last4 o10)))) (forall ((temp___1094 Int)) (ite (and (<= 1 temp___1094) (<= temp___1094 new_length)) (= (select o9 temp___1094) (select temp___1093 temp___1094)) (= (select o9 temp___1094) (select to____split_fields1 temp___1094))))))
(assert (= to____split_fields o11))
(assert (= o12 o9))
(assert (= o13 o10))
(assert (= to____split_discrs (mk___split_discrs temp___1096)))
(assert (= temp___10961 o11))
(assert (= temp___10962 o12))
(assert (= temp___10963 o13))
(assert (not (dynamic_predicate (mk___rep (mk___split_discrs temp___1096) (mk___split_fields temp___10961 (mk___t2 temp___10962 temp___10963))))))
(check-sat)
(exit)
