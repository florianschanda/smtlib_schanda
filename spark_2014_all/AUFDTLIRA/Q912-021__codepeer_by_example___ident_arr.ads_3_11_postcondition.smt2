...
(assert (= j1 1))
(assert (= (to_rep o) j1))
(assert (= o1 (store x j1 o)))
(assert (= result1 x))
(assert (= x1 o1))
(assert (= result2 j1))
(assert (= j2 2))
(assert (= (to_rep o2) j2))
(assert (= o3 (store x1 j2 o2)))
(assert (= result3 x1))
(assert (= x2 o3))
(assert (= result4 j2))
(assert (= j3 3))
(assert (= (to_rep o4) j3))
(assert (= o5 (store x2 j3 o4)))
(assert (= result5 x2))
(assert (= x3 o5))
(assert (= result6 j3))
(assert (= j4 4))
(assert (= (to_rep o6) j4))
(assert (= o7 (store x3 j4 o6)))
(assert (= result7 x3))
(assert (= x4 o7))
(assert (= result8 j4))
(assert (= j5 5))
(assert (= (to_rep o8) j5))
(assert (= o9 (store x4 j5 o8)))
(assert (= result9 x4))
(assert (= x5 o9))
(assert (= result10 j5))
(assert (= j6 6))
(assert (= (to_rep o10) j6))
(assert (= o11 (store x5 j6 o10)))
(assert (= result11 x5))
(assert (= x6 o11))
(assert (= result12 j6))
(assert (= j7 7))
(assert (= (to_rep o12) j7))
(assert (= o13 (store x6 j7 o12)))
(assert (= result13 x6))
(assert (= x7 o13))
(assert (= result14 j7))
(assert (= j8 8))
(assert (= (to_rep o14) j8))
(assert (= o15 (store x7 j8 o14)))
(assert (= result15 x7))
(assert (= x8 o15))
(assert (= result16 j8))
(assert (= j9 9))
(assert (= (to_rep o16) j9))
(assert (= o17 (store x8 j9 o16)))
(assert (= result17 x8))
(assert (= x9 o17))
(assert (= result18 j9))
(assert (= j10 10))
(assert (= (to_rep o18) j10))
(assert (= o19 (store x9 j10 o18)))
(assert (= result19 (mk_map__ref x9)))
(assert (= x10 o19))
(assert (= j11 (mk_int__ref j10)))
...
(assert (<= 1 j13))
(assert (<= j13 10))
(assert (not (= (to_rep (select (map__content x11) j13)) j13)))
(check-sat)
(exit)
