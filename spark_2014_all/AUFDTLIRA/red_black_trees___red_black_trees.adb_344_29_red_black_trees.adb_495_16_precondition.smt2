...
(assert (and (= temp___679 (nb_blacks c106b)) (and (= (bool_eq11 (select temp___679 0) (mk___rep5 (mk___split_fields5 (of_int 1) (of_rep 0) (of_rep 0)))) true) (forall ((i14 Int)) (=> (and (<= 1 i14) (<= i14 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c106b))) i14))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___679 i14))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___679 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___679 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i14 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___679 i14)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___679 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___679 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i14 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___679 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i14 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___679 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i14 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___679 i14)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c106b)) i14)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___679 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i14 0))))))))))))))
(assert (= o383 (select temp___679 c108b)))
(assert (= o384 (us_split_fields11 o383)))
(assert (= o385 (rec__red_black_trees__black_count__depth o384)))
(assert (= o386 (to_rep o385)))
(assert (= result88 (ite (<= o386 (let ((subject n7)) n110)) true false)))
(assert (= result88 true))
(assert (and (= temp___678 (nb_blacks c106b)) (and (= (bool_eq11 (select temp___678 0) (mk___rep5 (mk___split_fields5 (of_int 1) (of_rep 0) (of_rep 0)))) true) (forall ((i14 Int)) (=> (and (<= 1 i14) (<= i14 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c106b))) i14))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___678 i14))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___678 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___678 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i14 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___678 i14)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___678 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___678 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i14 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___678 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i14 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___678 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i14 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___678 i14)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c106b)) i14)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___678 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i14 0))))))))))))))
(assert (= o390 (select temp___678 c108b)))
(assert (= o391 (us_split_fields11 o390)))
(assert (= o392 (rec__red_black_trees__black_count__count o391)))
(assert (= o393 (to_rep o392)))
(assert (= o394 (- o393 1)))
