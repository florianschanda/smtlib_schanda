...
(assert (< (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length this__split_fields3)) last8))
(assert (= (to_rep2 o14) last8))
(assert (= o14 o15))
(assert (= (rec__bounded_dynamic_strings__sequence__content this__split_fields3) (mk___t1 o16 o17)))
(assert (= this__split_discrs (mk___split_discrs temp___1190)))
(assert (= temp___11901 o15))
(assert (= temp___11902 o16))
(assert (= temp___11903 o17))
(assert (not (dynamic_predicate (mk___rep (mk___split_discrs temp___1190) (mk___split_fields temp___11901 (mk___t1 temp___11902 temp___11903))))))
(check-sat)
(exit)
