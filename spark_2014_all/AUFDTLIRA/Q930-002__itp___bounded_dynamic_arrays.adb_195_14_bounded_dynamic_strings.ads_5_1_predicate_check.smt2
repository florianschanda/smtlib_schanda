...
(assert (= (to_rep2 o9) last8))
(assert (= o9 o10))
(assert (= (rec__bounded_dynamic_strings__sequence__content this__split_fields3) (mk___t1 o11 o12)))
(assert (= this__split_discrs (mk___split_discrs temp___1253)))
(assert (= temp___12531 o10))
(assert (= temp___12532 o11))
(assert (= temp___12533 o12))
(assert (not (dynamic_predicate (mk___rep (mk___split_discrs temp___1253) (mk___split_fields temp___12531 (mk___t1 temp___12532 temp___12533))))))
(check-sat)
(exit)
