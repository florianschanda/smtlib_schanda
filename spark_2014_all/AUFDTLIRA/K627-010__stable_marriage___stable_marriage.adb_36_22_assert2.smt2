...
(declare-const temp___467 (Array Int Bool))
...
(assert (= rank1 1))
(assert (=> (and (<= 1 rank1) (<= rank1 64)) (= temp___467 seen1)))
(assert (=> (and (<= 1 rank1) (<= rank1 64)) (= temp___466 rank1)))
...
(assert (= (bool_eq1 seen6 1 64 (temp_____aggregate_def_469 (distinct 1 0)) 1 64) true))
(declare-const g2 Int)
(assert (<= 1 g2))
(assert (<= g2 64))
(assert (not (= (select seen6 g2) true)))
(check-sat)
(exit)
