...
(assert (= i1 2))
(assert (=> (and (<= 2 i1) (<= i1 30)) (= temp___175 a2)))
(assert (=> (and (<= 2 i1) (<= i1 30)) (= temp___174 i1)))
(assert (=> (and (<= 2 i1) (<= i1 30)) (and (= o (+ (to_rep (select a2 (- i1 1))) (to_rep (select a2 (- i1 2))))) (in_range1 (+ (to_rep (select a2 (- i1 1))) (to_rep (select a2 (- i1 2))))))))
(assert (=> (and (<= 2 i1) (<= i1 30)) (= (to_rep o1) o)))
(assert (=> (and (<= 2 i1) (<= i1 30)) (= o2 (store a2 i1 o1))))
(assert (=> (and (<= 2 i1) (<= i1 30)) (= a2 result3)))
(assert (=> (and (<= 2 i1) (<= i1 30)) (= a3 o2)))
(assert (=> (and (<= 2 i1) (<= i1 30)) (and (and (forall ((j Int)) (=> (and (<= 2 j) (<= j i2)) (= (to_rep (select a4 j)) (+ (to_rep (select a4 (- j 1))) (to_rep (select a4 (- j 2))))))) (= (to_rep (select a4 0)) 0)) (= (to_rep (select a4 1)) 1))))
(assert (=> (and (<= 2 i1) (<= i1 30)) (and (and (=> (<= 2 30) (in_range4 i2)) (forall ((temp___176 Int)) (=> (and (<= 0 temp___176) (<= temp___176 30)) (=> (or (< 30 temp___176) (or (< temp___176 2) (< i2 temp___176))) (= (select a4 temp___176) (select temp___175 temp___176)))))) (and (<= 2 i2) (<= i2 30)))))
...
(assert (= i8 i6))
(assert (= a10 a8))
(assert (not (not (= (to_rep (select a9 30)) 832040))))
(check-sat)
(exit)
