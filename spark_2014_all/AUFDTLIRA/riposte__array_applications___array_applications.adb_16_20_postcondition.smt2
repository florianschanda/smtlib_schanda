...
(assert (= i1 2))
(assert (=> (and (<= 2 i1) (<= i1 30)) (= temp___149 a2)))
(assert (=> (and (<= 2 i1) (<= i1 30)) (= temp___148 i1)))
...
(assert (=> (and (<= 2 i1) (<= i1 30)) (and (and (=> (<= 2 30) (in_range4 i2)) (forall ((temp___150 Int)) (=> (and (<= 0 temp___150) (<= temp___150 30)) (=> (< i2 temp___150) (= (select a4 temp___150) (select temp___149 temp___150)))))) (and (<= 2 i2) (<= i2 30)))))
