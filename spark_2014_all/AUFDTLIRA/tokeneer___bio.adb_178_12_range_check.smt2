...
(assert (not (= (length (mk___t temp___1523 temp___15231)) 0)))
(assert (=> (<= (to_rep1 (first2 temp___15241)) (to_rep1 (last2 temp___15241))) (= o18 (+ (- (to_rep1 (last2 temp___15241)) (to_rep1 (first2 temp___15241))) 1))))
(assert (=> (not (<= (to_rep1 (first2 temp___15241)) (to_rep1 (last2 temp___15241)))) (= o18 0)))
(assert (=> (<= (to_rep1 (first temp___15231)) (to_rep1 (last temp___15231))) (= o19 (+ (- (to_rep1 (last temp___15231)) (to_rep1 (first temp___15231))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___15231)) (to_rep1 (last temp___15231)))) (= o19 0)))
(assert (= o20 (+ o19 o18)))
(assert (= o21 (+ (to_rep1 (first temp___15231)) o20)))
(assert (= o22 (- o21 1)))
