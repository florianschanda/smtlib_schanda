...
(assert (= result5 o4))
(assert (= result5 true))
(assert (and (= o5 (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t1)))) (in_range1 (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t1))))))
(assert (not (= (valid_root (rec__search_trees__search_tree__struct (us_split_fields7 t1)) o5) true)))
(check-sat)
(exit)
