...
(assert (not (= (contains (rec__list_mod_allocator__m__t__allocated (us_split_fields3 (model__ data first_available))) res) true)))
(assert (not (= (is_well_formed data first_available) true)))
(check-sat)
(exit)
