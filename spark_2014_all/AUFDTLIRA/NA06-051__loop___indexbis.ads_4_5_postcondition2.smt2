...
(assert (=> (not (= result true)) (and (and (<= (to_rep1 (first (rt s))) courant3) (<= courant3 (to_rep1 (last (rt s))))) (not (exists ((i Int)) (and (and (<= (to_rep1 (first (rt s))) i) (<= i (- courant3 1))) (exists ((j Int)) (and (and (<= (to_rep1 (first (rt c))) j) (<= j (to_rep1 (last (rt c))))) (= (to_rep (select (elts s) i)) (to_rep (select (elts c) j)))))))))))
...
(assert (not (not (exists ((i Int)) (and (and (<= (to_rep1 (first (rt s))) i) (<= i (to_rep1 (last (rt s))))) (exists ((j Int)) (and (and (<= (to_rep1 (first (rt c))) j) (<= j (to_rep1 (last (rt c))))) (= (to_rep (select (elts s) i)) (to_rep (select (elts c) j))))))))))
(check-sat)
(exit)
