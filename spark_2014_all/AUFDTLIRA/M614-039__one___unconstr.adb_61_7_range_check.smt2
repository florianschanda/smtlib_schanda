...
(assert (forall ((temp___220 Int) (temp___221 Int) (temp___222 Int)) (let ((temp___219 (unconstr__unconstr_return__s__aggregate_def temp___220 temp___221 temp___222))) (and (=> (dynamic_property 1 2147483647 temp___221 temp___222) (and (= (first5 temp___219) temp___221) (= (last5 temp___219) temp___222))) (forall ((temp___223 Int)) (= (select (to_array2 temp___219) temp___223) (of_rep temp___220)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_198 us_t1) (temp___is_init_195 Bool) (temp___skip_constant_196 Bool) (temp___do_toplevel_197 Bool)) Bool (=> (not (= temp___skip_constant_196 true)) (and (dynamic_property2 1 x (first3 temp___expr_198) (last3 temp___expr_198)) (and (= (first3 temp___expr_198) 1) (= (last3 temp___expr_198) x)))))
(assert (in_range1 x))
(assert (<= 1 x))
(assert (not (<= 1 1)))
(check-sat)
