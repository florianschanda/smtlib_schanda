...
(assert (forall ((temp___560 (Array Int unsigned_byte))) (forall ((temp___561 Int)) (= (select (temp_____aggregate_def_558 temp___560) temp___561) temp___560))))
...
(assert (forall ((temp___564 Int) (temp___565 Int)) (let ((temp___563 (temp_____aggregate_def_562 temp___564 temp___565))) (=> (and (dynamic_invariant temp___564 true true true true) (dynamic_invariant temp___565 true true true true)) (forall ((temp___566 Int)) (ite (= temp___566 5) (= (select temp___563 temp___566) rliteral) (= (select temp___563 temp___566) rliteral1)))))))
...
(assert (= result x))
(assert (= x1 (temp_____aggregate_def_558 (temp_____aggregate_def_562 10 12))))
