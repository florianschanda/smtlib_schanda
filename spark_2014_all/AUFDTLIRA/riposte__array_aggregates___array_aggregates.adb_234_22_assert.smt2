...
(declare-fun temp___558 ((Array Int unsigned_byte)) (Array Int (Array Int unsigned_byte)))
(declare-fun temp___562 (Int Int) (Array Int unsigned_byte))
...
(assert (forall ((temp___560 (Array Int unsigned_byte))) (forall ((temp___561 Int)) (= (select (temp___558 temp___560) temp___561) temp___560))))
(assert (forall ((temp___564 Int) (temp___565 Int)) (let ((temp___563 (temp___562 temp___564 temp___565))) (=> (and (dynamic_invariant temp___564 true true true true) (dynamic_invariant temp___565 true true true true)) (forall ((temp___566 Int)) (ite (= temp___566 5) (= (to_rep (select temp___563 temp___566)) temp___564) (= (to_rep (select temp___563 temp___566)) temp___565)))))))
...
(assert (= result x))
(assert (= x1 (temp___558 (temp___562 10 12))))
