...
(define-fun dynamic_invariant3 ((temp___expr_531 us_t) (temp___is_init_528 Bool) (temp___skip_constant_529 Bool) (temp___do_toplevel_530 Bool)) Bool (=> (not (= temp___skip_constant_529 true)) (dynamic_property 1 2147483647 (first1 temp___expr_531) (last1 temp___expr_531))))
