...
(assert (=> (<= (- 2147483648) 2147483647) (in_range1 pos)))
(assert (= result i))
(assert (= i1 (to_rep1 (first (rt str)))))
(assert (<= (to_rep1 (first (rt str))) i1))
(assert (<= i1 (to_rep1 (last (rt str)))))
(assert (and (and (forall ((temp___217 Int)) (=> (and (<= (to_rep1 ret__first) temp___217) (<= temp___217 (to_rep1 ret__last))) (=> (<= i2 temp___217) (= (select ret1 temp___217) (select ret temp___217))))) (=> (<= (- 2147483648) 2147483647) (in_range1 pos1))) (and (<= (to_rep1 (first (rt str))) i2) (<= i2 (to_rep1 (last (rt str)))))))
(assert (in_range4 (to_rep (select (elts str) i2))))
(assert (= result1 pos1))
(assert (= pos2 (+ 65 (- (to_rep (select (elts str) i2)) 97))))
(assert (not (in_range3 pos2)))
(check-sat)
(exit)
