...
(assert (and (and (forall ((temp___247 Int)) (=> (and (<= (to_rep1 ret__first) temp___247) (<= temp___247 (to_rep1 ret__last))) (=> (<= i2 temp___247) (= (select ret1 temp___247) (select ret temp___247))))) (=> (<= (- 2147483648) 2147483647) (in_range1 pos1))) (and (<= (to_rep1 (first (rt str))) i2) (<= i2 (to_rep1 (last (rt str)))))))
