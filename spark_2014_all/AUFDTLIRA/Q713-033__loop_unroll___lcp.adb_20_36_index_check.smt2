...
(assert (= j1 1))
(assert (and (= o4 (+ x l1)) (in_range1 (+ x l1))))
(assert (= result3 (ite (<= o4 (to_rep (last (rt a)))) true false)))
(assert (=> (= result3 true) (and (= o3 (+ y l1)) (in_range1 (+ y l1)))))
(assert (=> (= result3 true) (= result2 (ite (<= o3 (to_rep (last (rt a)))) true false))))
(assert (=> (not (= result3 true)) (= result2 false)))
(assert (= result2 true))
(assert (and (= temp___184 (+ y l1)) (in_range1 (+ y l1))))
(assert (and (<= (to_rep (first (rt a))) temp___184) (<= temp___184 (to_rep (last (rt a))))))
(assert (= o temp___184))
(assert (= o1 (select (elts a) o)))
(assert (= o2 (to_rep o1)))
(assert (and (= temp___183 (+ x l1)) (in_range1 (+ x l1))))
(assert (not (<= (to_rep (first (rt a))) temp___183)))
(check-sat)
(exit)
