...
(assert (= o1 (to_rep (last (rt a)))))
(assert (= o2 (select (elts a) o1)))
(assert (= o3 (to_rep o2)))
(assert (= result (ite (= o3 0) true false)))
(assert (not (= result true)))
(assert (and (= temp___245 (- (to_rep (last (rt a))) 1)) (in_range1 (- (to_rep (last (rt a))) 1))))
(assert (and (<= (to_rep (first (rt a))) temp___245) (<= temp___245 (to_rep (last (rt a))))))
(assert (= o5 temp___245))
(assert (= o6 (select (elts a) o5)))
(assert (= o7 (to_rep o6)))
(assert (= result2 (ite (= o7 0) true false)))
(assert (not (= result2 true)))
(assert (not (<= c (to_rep (last (rt a))))))
(check-sat)
(exit)
