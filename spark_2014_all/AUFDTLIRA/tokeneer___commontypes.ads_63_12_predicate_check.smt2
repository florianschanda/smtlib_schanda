...
(declare-const temp___286 (Array Int character))
(declare-const temp___2861 t)
(assert (dynamic_invariant1 i15s true false false))
(assert (dynamic_property 1 2147483647 (to_rep1 (first2 (rt1 i15s))) (to_rep1 (last2 (rt1 i15s)))))
(assert (= (elts1 i15s) temp___286))
(assert (= (mk (to_rep1 (first2 (rt1 i15s))) (to_rep1 (last2 (rt1 i15s)))) temp___2861))
(assert (not (= (to_rep1 (first temp___2861)) 1)))
(check-sat)
(exit)
