...
(assert (= x1 0))
(assert (=> (and (<= 0 x1) (<= x1 255)) (and (and (= temp___311 x1) (and (= temp___309 r) (and (and (= (mk_map__ref result1) (mk_map__ref r)) (= r2 (store r x1 (ite (= x1 c) true false)))) (and (forall ((i Int)) (=> (and (<= 0 i) (<= i x2)) (= (= (select r3 i) true) (= i c)))) (and (and (and (forall ((temp___310 Int)) (=> (and (<= 0 temp___310) (<= temp___310 255)) (=> (< x2 temp___310) (= (select r3 temp___310) (select temp___309 temp___310))))) (=> (<= 0 255) (in_range1 x2))) (and (<= 0 x2) (<= x2 255))) (= x2 255)))))) (and (and (= x2 x6) (= r3 r7)) (and (= x7 x2) (= r8 r3))))))
...
(assert (= result4 arrays__single_char_set__result))
(assert (= arrays__single_char_set__result1 r9))
...
(assert (= x11 x9))
(assert (= r12 r10))
(assert (= result5 arrays__single_char_set__result4))
(declare-const i Int)
(assert (<= 0 i))
(assert (<= i 255))
