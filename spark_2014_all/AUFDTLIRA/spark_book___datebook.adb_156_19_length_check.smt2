...
(assert (not (= (ite (<= (to_rep1 (first temp___3981)) (to_rep1 (last temp___3981))) (+ (- (to_rep1 (last temp___3981)) (to_rep1 (first temp___3981))) 1) 0) (ite (<= (to_rep1 description__first) (to_rep1 description__last)) (+ (- (to_rep1 description__last) (to_rep1 description__first)) 1) 0))))
(check-sat)
(exit)
