...
(declare-const temp___16391 (Array Int us_rep3))
(declare-const o64 us_rep3)
(declare-const o65 us_split_fields4)
(declare-const temp___16381 (Array Int us_rep3))
...
(assert (=> (= result20 true) (= (ole (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) v))) (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) j3)))) true)))
(assert (=> (= result20 true) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (or (not (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f_old root) i3))) true)) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f_old v) i3))) true)))))))
(assert (=> (= result20 true) (= (olt (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f_old root) i2))) (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) v)))) true)))
(assert (=> (= result20 true) (ite (= (get (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) j3))) (+ (length (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) i2)))) 1)) 0) (< (to_rep (select values j3)) (to_rep (select values i2))) (< (to_rep (select values i2)) (to_rep (select values j3))))))
(assert (and (= temp___16381 (model__ f_old v)) (and (dynamic_invariant5 temp___16381 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___16381 v))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___16381 v)))) 0) (and (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (=> (not (= i3 v)) (ite (and (not (= (parent f_old i3) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___16381 (parent f_old i3)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___16381 i3))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___16381 i3))) true)))))) (and (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___16381 i3))) true) (not (= i3 v))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select temp___16381 (parent f_old i3)))) (position f_old i3) (rec__tree_model__path_type__a (us_split_fields5 (select temp___16381 i3)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___16381 i3)))) 0)))) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___16381 i3))) true) (forall ((j4 Int)) (=> (and (<= 1 j4) (<= j4 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___16381 j4))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select temp___16381 i3))) (rec__tree_model__path_type__a (us_split_fields5 (select temp___16381 j4)))) true)) (= j4 i3))))))))))))))
(assert (= o66 (select temp___16381 i2)))
(assert (= o67 (us_split_fields5 o66)))
(assert (= result24 (rec__tree_model__path_type__k o67)))
(assert (=> (= result24 true) (and (= temp___16391 (model__ f_old root)) (and (dynamic_invariant5 temp___16391 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___16391 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___16391 root)))) 0) (and (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (=> (not (= i3 root)) (ite (and (not (= (parent f_old i3) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___16391 (parent f_old i3)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___16391 i3))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___16391 i3))) true)))))) (and (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___16391 i3))) true) (not (= i3 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select temp___16391 (parent f_old i3)))) (position f_old i3) (rec__tree_model__path_type__a (us_split_fields5 (select temp___16391 i3)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___16391 i3)))) 0)))) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___16391 i3))) true) (forall ((j4 Int)) (=> (and (<= 1 j4) (<= j4 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___16391 j4))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select temp___16391 i3))) (rec__tree_model__path_type__a (us_split_fields5 (select temp___16391 j4)))) true)) (= j4 i3)))))))))))))))
(assert (=> (= result24 true) (= o64 (select temp___16391 j3))))
(assert (=> (= result24 true) (= o65 (us_split_fields5 o64))))
(assert (=> (= result24 true) (= result23 (rec__tree_model__path_type__k o65))))
(assert (=> (not (= result24 true)) (= result23 false)))
(assert (=> (= result23 true) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (or (not (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f_old root) i3))) true)) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f_old v) i3))) true)))))))
(assert (=> (= result23 true) (not (= (olt (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) i2))) (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) j3)))) true))))
(declare-const k Int)
(assert (<= 1 k))
(assert (<= k j3))
