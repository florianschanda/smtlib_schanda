...
(assert (and (forall ((n1 Int)) (=> (and (<= l n1) (<= n1 i2)) (= (to_rep (select a2 n1)) 0))) (forall ((n1 Int)) (=> (and (<= 1 n1) (<= n1 100)) (=> (or (< n1 l) (< i2 n1)) (= (to_rep (select a2 n1)) (to_rep (select a n1))))))))
(assert (and (and (forall ((temp___185 Int)) (=> (and (<= 1 temp___185) (<= temp___185 100)) (=> (or (< u temp___185) (or (< temp___185 l) (< i2 temp___185))) (= (select a2 temp___185) (select a temp___185))))) (=> (<= l u) (dynamic_property l u i2))) (and (<= l i2) (<= i2 u))))
(assert (= (= o true) (forall ((n1 Int)) (=> (and (<= 1 n1) (<= n1 100)) (=> (or (< n1 l) (< i2 n1)) (= (to_rep (select a2 n1)) (to_rep (select a n1))))))))
(assert (<= l n))
(assert (<= n i2))
(assert (not (<= 1 n)))
(check-sat)
