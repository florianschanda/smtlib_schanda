...
(assert (not (= (length3 temp___10402) 0)))
(assert (=> (<= (to_rep1 (first4 (rt2 right))) (to_rep1 (last4 (rt2 right)))) (= o (+ (- (to_rep1 (last4 (rt2 right))) (to_rep1 (first4 (rt2 right)))) 1))))
(assert (=> (not (<= (to_rep1 (first4 (rt2 right))) (to_rep1 (last4 (rt2 right))))) (= o 0)))
(assert (=> (<= (to_rep1 (first4 temp___10401)) (to_rep1 (last4 temp___10401))) (= o1 (+ (- (to_rep1 (last4 temp___10401)) (to_rep1 (first4 temp___10401))) 1))))
(assert (=> (not (<= (to_rep1 (first4 temp___10401)) (to_rep1 (last4 temp___10401)))) (= o1 0)))
(assert (= o2 (+ o1 o)))
(assert (= o3 (+ (to_rep1 (first4 temp___10401)) o2)))
(assert (= o4 (- o3 1)))
