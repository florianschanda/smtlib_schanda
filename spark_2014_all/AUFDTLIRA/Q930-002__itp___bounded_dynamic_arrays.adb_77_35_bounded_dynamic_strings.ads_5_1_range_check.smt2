...
(assert (not (= (length1 (mk___t1 temp___971 temp___9711)) 0)))
(assert (=> (<= (to_rep1 (first2 (rt1 right))) (to_rep1 (last2 (rt1 right)))) (= o3 (+ (- (to_rep1 (last2 (rt1 right))) (to_rep1 (first2 (rt1 right)))) 1))))
(assert (=> (not (<= (to_rep1 (first2 (rt1 right))) (to_rep1 (last2 (rt1 right))))) (= o3 0)))
(assert (=> (<= (to_rep1 (first2 temp___9711)) (to_rep1 (last2 temp___9711))) (= o4 (+ (- (to_rep1 (last2 temp___9711)) (to_rep1 (first2 temp___9711))) 1))))
(assert (=> (not (<= (to_rep1 (first2 temp___9711)) (to_rep1 (last2 temp___9711)))) (= o4 0)))
(assert (= o5 (+ o4 o3)))
(assert (= o6 (+ (to_rep1 (first2 temp___9711)) o5)))
(assert (= o7 (- o6 1)))
