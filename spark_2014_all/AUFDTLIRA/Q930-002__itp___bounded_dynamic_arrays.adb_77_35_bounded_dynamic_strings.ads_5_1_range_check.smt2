...
(assert (not (= (length1 temp___10342) 0)))
(assert (=> (<= (to_rep1 (first2 (rt1 right))) (to_rep1 (last2 (rt1 right)))) (= o (+ (- (to_rep1 (last2 (rt1 right))) (to_rep1 (first2 (rt1 right)))) 1))))
(assert (=> (not (<= (to_rep1 (first2 (rt1 right))) (to_rep1 (last2 (rt1 right))))) (= o 0)))
(assert (=> (<= (to_rep1 (first2 temp___10341)) (to_rep1 (last2 temp___10341))) (= o1 (+ (- (to_rep1 (last2 temp___10341)) (to_rep1 (first2 temp___10341))) 1))))
(assert (=> (not (<= (to_rep1 (first2 temp___10341)) (to_rep1 (last2 temp___10341)))) (= o1 0)))
(assert (= o2 (+ o1 o)))
(assert (= o3 (+ (to_rep1 (first2 temp___10341)) o2)))
(assert (= o4 (- o3 1)))
