...
(declare-const temp___1160 natural_index)
(declare-const temp___11601 natural_index)
(declare-const temp___11602 (Array Int character))
(declare-const temp___11603 t2)
(declare-const o14 natural_index)
(declare-const o15 natural_index)
(declare-const o16 (Array Int character))
(declare-const o17 t2)
(declare-const temp___1162 us_rep)
...
(define-fun temp___11594 () us_rep (mk___rep (mk___split_discrs temp___1159) (mk___split_fields temp___11591 (mk___t2 temp___11592 temp___11593))))
...
(assert (dynamic_predicate temp___11594))
(assert (= (mk___rep (mk___split_discrs temp___1160) (mk___split_fields temp___11601 (mk___t2 temp___11602 temp___11603))) temp___11594))
...
(assert (= to____split_fields3 (mk___split_fields temp___11601 (mk___t2 temp___11602 temp___11603))))
(assert (= to____split_discrs (mk___split_discrs temp___1160)))
(assert (= (to_rep2 o14) new_length))
(assert (= o14 o15))
(assert (= (rec__bounded_dynamic_strings__sequence__content to____split_fields3) (mk___t2 o16 o17)))
(assert (= temp___1162 (mk___rep to____split_discrs (mk___split_fields o15 (mk___t2 o16 o17)))))
(assert (dynamic_predicate temp___1162))
(assert (= temp___1163 temp___1162))
(assert (= result1 (mk___split_fields__ref to____split_fields3)))
(assert (= to____split_fields4 (us_split_fields1 temp___1163)))
(assert (= to____split_discrs (us_split_discrs1 temp___1163)))
(assert (= to____split_fields5 (mk___split_fields__ref to____split_fields4)))
(assert (= to____split_fields6 to____split_fields4))
(assert (not (= (let ((temp___1178 (value (mk___rep to____split_discrs (us_split_fields__content to____split_fields5))))) (bool_eq (elts1 temp___1178) (to_rep1 (first2 (rt1 temp___1178))) (to_rep1 (last2 (rt1 temp___1178))) (let ((temp___1177 (value tail))) (let ((temp___1176 (value (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2)))))) (ite (= (length1 temp___1176) 0) (elts1 temp___1177) (concat1 (elts1 temp___1176) (to_rep1 (first2 (rt1 temp___1176))) (to_rep1 (last2 (rt1 temp___1176))) (elts1 temp___1177) (to_rep1 (first2 (rt1 temp___1177))) (to_rep1 (last2 (rt1 temp___1177))))))) (to_rep1 (first (let ((temp___1177 (value tail))) (let ((temp___1176 (value (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2)))))) (ite (= (length1 temp___1176) 0) (mk (to_rep1 (first2 (rt1 temp___1177))) (to_rep1 (last2 (rt1 temp___1177)))) (mk (to_rep1 (first2 (rt1 temp___1176))) (- (+ (to_rep1 (first2 (rt1 temp___1176))) (+ (ite (<= (to_rep1 (first2 (rt1 temp___1176))) (to_rep1 (last2 (rt1 temp___1176)))) (+ (- (to_rep1 (last2 (rt1 temp___1176))) (to_rep1 (first2 (rt1 temp___1176)))) 1) 0) (ite (<= (to_rep1 (first2 (rt1 temp___1177))) (to_rep1 (last2 (rt1 temp___1177)))) (+ (- (to_rep1 (last2 (rt1 temp___1177))) (to_rep1 (first2 (rt1 temp___1177)))) 1) 0))) 1))))))) (to_rep1 (last (let ((temp___1177 (value tail))) (let ((temp___1176 (value (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2)))))) (ite (= (length1 temp___1176) 0) (mk (to_rep1 (first2 (rt1 temp___1177))) (to_rep1 (last2 (rt1 temp___1177)))) (mk (to_rep1 (first2 (rt1 temp___1176))) (- (+ (to_rep1 (first2 (rt1 temp___1176))) (+ (ite (<= (to_rep1 (first2 (rt1 temp___1176))) (to_rep1 (last2 (rt1 temp___1176)))) (+ (- (to_rep1 (last2 (rt1 temp___1176))) (to_rep1 (first2 (rt1 temp___1176)))) 1) 0) (ite (<= (to_rep1 (first2 (rt1 temp___1177))) (to_rep1 (last2 (rt1 temp___1177)))) (+ (- (to_rep1 (last2 (rt1 temp___1177))) (to_rep1 (first2 (rt1 temp___1177)))) 1) 0))) 1))))))))) true)))
(check-sat)
(exit)
