...
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= o48 (peek (mk___rep2 (us_split_fields__content2 f__split_fields7)) i d)) (and (in_range2 o48) (and (= o48 (ite (= d 0) (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) i)))) (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) i)))))) (and (ite (not (= o48 0)) (and (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) o48) d) (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) o48) i)) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j1) i) (not (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) j1) d)))))) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j1) i) (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) j1) d)) (= o48 j1)))))))))
...
(assert (<= j 100))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= o44 (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j)) (and (in_range2 o44) (and (= o44 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) j))))) (and (=> (= (valid_root (mk___rep2 (us_split_fields__content2 f__split_fields7)) j) true) (= o44 0)) (=> (= (size (mk___rep2 (us_split_fields__content2 f__split_fields7))) 0) (= o44 0)))))))
...
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o47 (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j)) (and (in_range4 o47) (= o47 (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 j))))))))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
