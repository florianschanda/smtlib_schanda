...
(assert (<= j1 100))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= o75 (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j1)) (and (in_range2 o75) (and (= o75 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) j1))))) (and (=> (= (valid_root (mk___rep2 (us_split_fields__content2 f__split_fields7)) j1) true) (= o75 0)) (=> (= (size (mk___rep2 (us_split_fields__content2 f__split_fields7))) 0) (= o75 0)))))))
(assert (= o76 (ite (= o75 0) true false)))
(assert (= o77 (ite (not (= o76 true)) true false)))
(assert (= result12 (ite (not (= j1 (int__content v2))) o77 false)))
(assert (= result12 true))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o78 (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j1)) (and (in_range4 o78) (= o78 (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 j1))))))))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (not (not (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j1) 0))))
(check-sat)
(exit)
