...
(assert (<= 1 j1))
(assert (<= j1 r12b))
(assert (not (<= (to_rep8 (rec__datebooks__event_record__description_size (us_split_fields7 (select book i2)))) (ite (<= (to_rep1 description__first) (to_rep1 description__last)) (+ (- (to_rep1 description__last) (to_rep1 description__first)) 1) 0))))
(check-sat)
(exit)
