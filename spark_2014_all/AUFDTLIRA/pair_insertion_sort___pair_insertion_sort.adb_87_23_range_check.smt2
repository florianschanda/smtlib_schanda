...
(define-fun a8 () map__ref (mk_map__ref a6))
...
(assert (and (= o26 (+ (int__content j6) 1)) (in_range1 (+ (int__content j6) 1))))
(assert (and (= o27 o26) (in_range2 o26)))
(assert (and (= o25 (+ (int__content j6) 2)) (in_range1 (+ (int__content j6) 2))))
