...
(declare-const temp___317 (Array Int natural))
(declare-const o natural)
(declare-const o1 Int)
(declare-const o2 (Array Int natural))
(declare-const j1 Int)
(declare-const o3 (Array Int natural))
(declare-const temp___312 (Array Int natural))
(declare-const temp___3121 t1)
(declare-const loops_static__loop4__B_11__a_begins__assume (Array Int natural))
(declare-const loops_static__loop4__B_11__a_begins__assume1 t)
(declare-const temp___313 Bool)
...
(assert (<= 1 i1))
(assert (<= i1 2))
(assert (and (forall ((temp___318 Int)) (=> (and (<= (to_rep1 a__first) temp___318) (<= temp___318 (to_rep1 a__last))) (=> (<= i2 temp___318) (= (select a2 temp___318) (select a temp___318))))) (and (<= 1 i2) (<= i2 2))))
(assert (= (to_rep o) 0))
(assert (and (<= (to_rep1 a__first) i2) (<= i2 (to_rep1 a__last))))
(assert (= o1 i2))
(assert (= o2 (store a2 o1 o)))
(assert (= a2 result1))
(assert (= a3 o2))
(declare-const j14 Int)
(assert (<= (to_rep1 a__first) j14))
(assert (<= j14 i2))
(assert (not (= (to_rep (select a3 j14)) 0)))
(check-sat)
(exit)
