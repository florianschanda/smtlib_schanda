...
(assert (<= 1 i1))
(assert (<= i1 2))
(assert (and (forall ((temp___355 Int)) (=> (and (<= (to_rep1 a__first) temp___355) (<= temp___355 (to_rep1 a__last))) (=> (or (< 2 temp___355) (or (< temp___355 1) (<= i2 temp___355))) (= (select a1 temp___355) (select a temp___355))))) (and (<= 1 i2) (<= i2 2))))
...
(assert (= a2 o1))
(declare-const j Int)
(assert (<= (to_rep1 a__first) j))
(assert (<= j i2))
(assert (not (= (to_rep (select a2 j)) 0)))
(check-sat)
(exit)
