...
(assert (<= 1 i1))
(assert (<= i1 2))
(assert (and (forall ((temp___353 Int)) (=> (and (<= (to_rep1 a__first) temp___353) (<= temp___353 (to_rep1 a__last))) (=> (<= i2 temp___353) (= (select a1 temp___353) (select a temp___353))))) (and (<= 1 i2) (<= i2 2))))
(assert (= (to_rep o) 0))
