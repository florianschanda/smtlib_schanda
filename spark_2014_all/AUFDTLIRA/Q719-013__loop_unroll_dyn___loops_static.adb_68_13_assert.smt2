...
(assert (<= 1 i1))
(assert (<= i1 2))
(assert (and (forall ((temp___318 Int)) (=> (and (<= (to_rep1 a__first) temp___318) (<= temp___318 (to_rep1 a__last))) (=> (<= i2 temp___318) (= (select a1 temp___318) (select a temp___318))))) (and (<= 1 i2) (<= i2 2))))
(assert (= (to_rep o) 0))
