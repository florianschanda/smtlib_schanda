...
(define-fun dynamic_invariant ((temp___expr_143 us_rep) (temp___is_init_140 Bool) (temp___skip_constant_141 Bool) (temp___do_toplevel_142 Bool)) Bool (let ((temp___144 (rec__stacks__stack_type__max_size (us_split_discrs1 temp___expr_143)))) (and (dynamic_property1 1 (to_rep2 temp___144) (first1 (rec__stacks__stack_type__items (us_split_fields1 temp___expr_143))) (last1 (rec__stacks__stack_type__items (us_split_fields1 temp___expr_143)))) (and (= (first1 (rec__stacks__stack_type__items (us_split_fields1 temp___expr_143))) 1) (= (last1 (rec__stacks__stack_type__items (us_split_fields1 temp___expr_143))) (to_rep2 temp___144))))))
