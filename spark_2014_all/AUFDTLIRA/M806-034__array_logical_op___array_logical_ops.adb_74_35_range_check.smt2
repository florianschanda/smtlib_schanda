...
(assert (forall ((temp___205 Int)) (=> (dynamic_invariant2 temp___205 true true true true) (forall ((temp___206 Int)) (= (to_rep (select (array_logical_ops__failing_content_check__w__aggregate_def temp___205) temp___206)) temp___205)))))
(assert (= v (of_array (array_logical_ops__failing_content_check__v__aggregate_def 1) 6 25)))
(assert (forall ((temp___208 Int)) (=> (dynamic_invariant2 temp___208 true true true true) (forall ((temp___209 Int)) (= (to_rep (select (array_logical_ops__failing_content_check__v__aggregate_def temp___208) temp___209)) temp___208)))))
...
(assert (= (mk___t (xorb (elts v) (to_rep1 (first (rt v))) (to_rep1 (last (rt v))) (elts w) (to_rep1 (first (rt w))) (to_rep1 (last (rt w)))) (mk (to_rep1 (first (rt v))) (to_rep1 (last (rt v))))) r1))
