...
(declare-const temp___404 index)
(declare-const temp___4041 (Array Int value))
(declare-const temp___4042 (Array Int value))
...
(declare-const temp___407 index)
(declare-const temp___4071 (Array Int value))
(declare-const temp___4072 (Array Int value))
...
(assert (= temp___404 o2))
(assert (= temp___4041 o3))
(assert (= temp___4042 o4))
(assert (= result1 a__split_fields))
(assert (= result2 a__split_fields1))
(assert (= result3 a__split_fields2))
(assert (= temp___404 a__split_fields3))
(assert (= temp___4041 a__split_fields4))
(assert (= temp___4042 a__split_fields5))
(assert (= (to_rep o5) tmp1))
(assert (= o6 (store b__split_fields2 j o5)))
(assert (= b__split_fields o7))
(assert (= b__split_fields1 o8))
(assert (= o6 o9))
(assert (= temp___407 o7))
(assert (= temp___4071 o8))
(assert (= temp___4072 o9))
(assert (= result4 b__split_fields))
(assert (= result5 b__split_fields1))
(assert (= result6 b__split_fields2))
(assert (= temp___407 b__split_fields3))
(assert (= temp___4071 b__split_fields4))
(assert (= temp___4072 b__split_fields5))
