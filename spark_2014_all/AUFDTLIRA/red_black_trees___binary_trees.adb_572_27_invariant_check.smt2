...
(assert (= o28 (select temp___1269 ki1)))
(assert (= o29 (us_split_fields1 o28)))
(assert (= result6 (rec__tree_model__path_type__k o29)))
...
(assert (=> (= result6 true) (= o24 (select temp___1270 ki1))))
(assert (=> (= result6 true) (= o25 (us_split_fields1 o24))))
(assert (=> (= result6 true) (= o26 (rec__tree_model__path_type__a o25))))
(assert (=> (= result6 true) (and (= o27 (length o26)) (and (in_range5 o27) (<= (+ 0 o27) 2147483647)))))
(assert (=> (= result6 true) (= result5 (ite (= o27 n2) true false))))
