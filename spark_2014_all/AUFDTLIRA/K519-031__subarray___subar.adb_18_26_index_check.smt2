...
(define-fun dynamic_invariant ((temp___expr_168 us_t) (temp___is_init_165 Bool) (temp___skip_constant_166 Bool) (temp___do_toplevel_167 Bool)) Bool (=> (not (= temp___skip_constant_166 true)) (dynamic_property (- 2147483648) 2147483647 (first1 temp___expr_168) (last1 temp___expr_168))))
...
(define-fun dynamic_invariant2 ((temp___expr_144 Int) (temp___is_init_141 Bool) (temp___skip_constant_142 Bool) (temp___do_toplevel_143 Bool)) Bool (=> (or (= temp___is_init_141 true) (<= 1 10)) (in_range temp___expr_144)))
(assert (dynamic_invariant x true false true))
(assert (= (to_rep (select (elts x) (to_rep1 (first (rt x))))) 1))
(assert (not (<= (to_rep1 (first (rt x))) (to_rep1 (first (rt x))))))
(check-sat)
(exit)
