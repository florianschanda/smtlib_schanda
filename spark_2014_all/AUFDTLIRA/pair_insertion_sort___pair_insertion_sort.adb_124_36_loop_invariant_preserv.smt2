...
(assert (= j24 j22))
(assert (= a26 a24))
(assert (not (= (sorted (mk___t (map__content a25) (mk (to_rep a__first) (to_rep a__last))) (+ (int__content j23) 1) (- (ite (<= (to_rep a__first) (to_rep a__last)) (+ (- (to_rep a__last) (to_rep a__first)) 1) 0) 1)) true)))
(check-sat)
(exit)
