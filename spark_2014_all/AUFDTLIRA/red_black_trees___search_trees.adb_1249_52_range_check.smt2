...
(assert (and (= o4 (size (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)))) (in_range4 o4)))
(assert (= result (ite (< 0 o4) true false)))
(assert (= result true))
(assert (not (= (to_rep (select t_old__split_fields3 l)) v)))
(assert (and (= o1 (to_rep1 t_old__split_fields)) (in_range3 (to_rep1 t_old__split_fields))))
(assert (and (= temp___2136 (model__ (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) o1)) (and (dynamic_invariant8 temp___2136 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2136 o1))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___2136 o1)))) 0) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (not (= i2 o1)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) i2) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2136 (parent (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) i2)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2136 i2))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2136 i2))) true)))))) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2136 i2))) true) (not (= i2 o1))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___2136 (parent (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) i2)))) (position (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) i2) (rec__tree_model__path_type__a (us_split_fields1 (select temp___2136 i2)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___2136 i2)))) 0)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2136 i2))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2136 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___2136 i2))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___2136 j)))) true)) (= j i2))))))))))))))
(assert (= o2 (select temp___2136 l)))
