...
(declare-fun temp___286 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___288 (Array Int et1))) (forall ((temp___289 Int) (temp___290 Int)) (let ((temp___287 (temp___286 temp___288 temp___289 temp___290))) (=> (and (dynamic_invariant temp___289 true true true true) (dynamic_invariant1 temp___290 true true true true)) (forall ((temp___291 Int)) (ite (= temp___291 temp___289) (= (to_rep (select temp___287 temp___291)) temp___290) (= (select temp___287 temp___291) (select temp___288 temp___291)))))))))
(assert (in_range1 i))
(assert (in_range2 e))
(assert (< i 10))
(assert (< 0 e))
