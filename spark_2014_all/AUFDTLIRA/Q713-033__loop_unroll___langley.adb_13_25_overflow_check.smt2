...
(assert (forall ((i3 Int)) (=> (and (<= 0 i3) (<= i3 9)) (and (and (and (< (to_rep (select x i3)) 1073741824) (< (- 1073741824) (to_rep (select x i3)))) (< (to_rep (select y i3)) 1073741824)) (< (- 1073741824) (to_rep (select y i3)))))))
