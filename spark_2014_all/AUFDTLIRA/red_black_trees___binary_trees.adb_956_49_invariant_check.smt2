...
(assert (and (= temp___1811 (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) root)) (and (dynamic_invariant3 temp___1811 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1811 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1811 root)))) 0) (and (forall ((i7 Int)) (=> (and (<= 1 i7) (<= i7 100)) (=> (not (= i7 root)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i7) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1811 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i7)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1811 i7))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1811 i7))) true)))))) (and (forall ((i7 Int)) (=> (and (<= 1 i7) (<= i7 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1811 i7))) true) (not (= i7 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1811 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i7)))) (position (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i7) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1811 i7)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1811 i7)))) 0)))) (forall ((i7 Int)) (=> (and (<= 1 i7) (<= i7 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1811 i7))) true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1811 j2))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1811 i7))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1811 j2)))) true)) (= j2 i7))))))))))))))
(assert (= o125 (select temp___1811 i6)))
(assert (= o126 (us_split_fields1 o125)))
(assert (= result25 (rec__tree_model__path_type__k o126)))
