...
(assert (=> (not (= smallest1 current1)) (= (is_perm__logic (mk___t values (mk (to_rep values__first) (to_rep values__last))) (mk___t o10 (mk (to_rep values__first) (to_rep values__last)))) true)))
...
(assert (not (< 0 (length (mk___t o8 o9)))))
(check-sat)
(exit)
