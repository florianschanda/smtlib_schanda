...
(define-fun dynamic_invariant4 ((temp___expr_633 us_rep1) (temp___is_init_629 Bool) (temp___skip_constant_630 Bool) (temp___do_toplevel_631 Bool) (temp___do_typ_inv_632 Bool)) Bool (=> (not (= temp___skip_constant_630 true)) (in_range7 100 (to_base temp___expr_633))))
(define-fun default_initial_assumption ((temp___expr_636 us_rep1) (temp___skip_top_level_637 Bool)) Bool (= (to_rep3 (rec__bounded_queue_v1__queue_type__max_size (us_split_discrs2 temp___expr_636))) 100))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_659 us_void_param) 1)) 83) (= (to_rep (select (temp___String_Literal_659 us_void_param) 2)) 105)) (= (to_rep (select (temp___String_Literal_659 us_void_param) 3)) 122)) (= (to_rep (select (temp___String_Literal_659 us_void_param) 4)) 101)) (= (to_rep (select (temp___String_Literal_659 us_void_param) 5)) 32)) (= (to_rep (select (temp___String_Literal_659 us_void_param) 6)) 111)) (= (to_rep (select (temp___String_Literal_659 us_void_param) 7)) 102)) (= (to_rep (select (temp___String_Literal_659 us_void_param) 8)) 32)) (= (to_rep (select (temp___String_Literal_659 us_void_param) 9)) 99)) (= (to_rep (select (temp___String_Literal_659 us_void_param) 10)) 108)) (= (to_rep (select (temp___String_Literal_659 us_void_param) 11)) 101)) (= (to_rep (select (temp___String_Literal_659 us_void_param) 12)) 97)) (= (to_rep (select (temp___String_Literal_659 us_void_param) 13)) 114)) (= (to_rep (select (temp___String_Literal_659 us_void_param) 14)) 101)) (= (to_rep (select (temp___String_Literal_659 us_void_param) 15)) 100)) (= (to_rep (select (temp___String_Literal_659 us_void_param) 16)) 32)) (= (to_rep (select (temp___String_Literal_659 us_void_param) 17)) 113)) (= (to_rep (select (temp___String_Literal_659 us_void_param) 18)) 117)) (= (to_rep (select (temp___String_Literal_659 us_void_param) 19)) 101)) (= (to_rep (select (temp___String_Literal_659 us_void_param) 20)) 117)) (= (to_rep (select (temp___String_Literal_659 us_void_param) 21)) 101)) (= (to_rep (select (temp___String_Literal_659 us_void_param) 22)) 32)) (= (to_rep (select (temp___String_Literal_659 us_void_param) 23)) 105)) (= (to_rep (select (temp___String_Literal_659 us_void_param) 24)) 115)) (= (to_rep (select (temp___String_Literal_659 us_void_param) 25)) 32)) :pattern ((temp___String_Literal_659 us_void_param)))))
...
(declare-const temp___650 positive)
(declare-const temp___6501 natural)
(declare-const temp___6502 positive)
(declare-const temp___6503 positive)
(declare-const temp___6504 (Array Int element_type))
