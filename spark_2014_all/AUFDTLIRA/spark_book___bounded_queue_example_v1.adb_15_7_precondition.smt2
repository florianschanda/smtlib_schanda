...
(declare-fun concat2 ((Array Int element_type) Int Int (Array Int element_type) Int Int) (Array Int element_type))
...
(assert (forall ((v element_type)) (forall ((i Int)) (! (= (select (singleton2 v i) i) v) :pattern ((select (singleton2 v i) i))))))
(define-fun bool_eq2 ((a (Array Int element_type)) (a__first Int) (a__last Int) (b (Array Int element_type)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_132 Int)) (=> (and (<= a__first temp___idx_132) (<= temp___idx_132 a__last)) (= (to_rep4 (select a temp___idx_132)) (to_rep4 (select b (+ (- b__first a__first) temp___idx_132))))))) true false))
(assert (forall ((a (Array Int element_type)) (b (Array Int element_type))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq2 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_132 Int)) (=> (and (<= a__first temp___idx_132) (<= temp___idx_132 a__last)) (= (to_rep4 (select a temp___idx_132)) (to_rep4 (select b (+ (- b__first a__first) temp___idx_132)))))))))))
(declare-fun compare1 ((Array Int element_type) Int Int (Array Int element_type) Int Int) Int)
(assert (forall ((a (Array Int element_type)) (b (Array Int element_type))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare1 a a_first a_last b b_first b_last) 0) (= (bool_eq2 a a_first a_last b b_first b_last) true)) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int element_type)) (b (Array Int element_type))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare1 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq2 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep4 (select a (+ i 1))) (to_rep4 (select b (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int element_type)) (b (Array Int element_type))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare1 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq2 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep4 (select b (+ i 1))) (to_rep4 (select a (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
...
(define-fun dynamic_invariant2 ((temp___expr_167 us_rep) (temp___is_init_164 Bool) (temp___skip_constant_165 Bool) (temp___do_toplevel_166 Bool)) Bool (let ((temp___168 (rec__bounded_queue_v1__queue_type__max_size (us_split_discrs1 temp___expr_167)))) (and (dynamic_property2 1 (to_rep3 temp___168) (first3 (rec__bounded_queue_v1__queue_type__items (us_split_fields1 temp___expr_167))) (last3 (rec__bounded_queue_v1__queue_type__items (us_split_fields1 temp___expr_167)))) (and (= (first3 (rec__bounded_queue_v1__queue_type__items (us_split_fields1 temp___expr_167))) 1) (= (last3 (rec__bounded_queue_v1__queue_type__items (us_split_fields1 temp___expr_167))) (to_rep3 temp___168))))))
(declare-fun size (us_rep) Int)
(declare-fun size__function_guard (Int us_rep) Bool)
(assert (forall ((queue us_rep)) (! (=> (dynamic_invariant2 queue true true true) (dynamic_invariant1 (size queue) true false true)) :pattern ((size queue)))))
...
(define-fun dynamic_invariant3 ((temp___expr_156 Int) (temp___is_init_153 Bool) (temp___skip_constant_154 Bool) (temp___do_toplevel_155 Bool)) Bool (=> (or (= temp___is_init_153 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_156)))
...
(define-fun of_base ((r us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r) (mk___split_fields1 (rec__bounded_queue_v1__queue_type__count (us_split_fields1 r)) (rec__bounded_queue_v1__queue_type__front (us_split_fields1 r)) (rec__bounded_queue_v1__queue_type__rear (us_split_fields1 r)) (let ((temp___152 (rec__bounded_queue_v1__queue_type__items (us_split_fields1 r)))) (to_array1 temp___152)))))
...
(define-fun dynamic_invariant4 ((temp___expr_559 us_rep1) (temp___is_init_556 Bool) (temp___skip_constant_557 Bool) (temp___do_toplevel_558 Bool)) Bool (=> (not (= temp___skip_constant_557 true)) (in_range7 100 (to_base temp___expr_559))))
(define-fun default_initial_assumption ((temp___expr_562 us_rep1) (temp___skip_top_level_563 Bool)) Bool (= (to_rep3 (rec__bounded_queue_v1__queue_type__max_size (us_split_discrs2 temp___expr_562))) 100))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_585 us_void_param) 1)) 83) (= (to_rep (select (temp___String_Literal_585 us_void_param) 2)) 105)) (= (to_rep (select (temp___String_Literal_585 us_void_param) 3)) 122)) (= (to_rep (select (temp___String_Literal_585 us_void_param) 4)) 101)) (= (to_rep (select (temp___String_Literal_585 us_void_param) 5)) 32)) (= (to_rep (select (temp___String_Literal_585 us_void_param) 6)) 111)) (= (to_rep (select (temp___String_Literal_585 us_void_param) 7)) 102)) (= (to_rep (select (temp___String_Literal_585 us_void_param) 8)) 32)) (= (to_rep (select (temp___String_Literal_585 us_void_param) 9)) 99)) (= (to_rep (select (temp___String_Literal_585 us_void_param) 10)) 108)) (= (to_rep (select (temp___String_Literal_585 us_void_param) 11)) 101)) (= (to_rep (select (temp___String_Literal_585 us_void_param) 12)) 97)) (= (to_rep (select (temp___String_Literal_585 us_void_param) 13)) 114)) (= (to_rep (select (temp___String_Literal_585 us_void_param) 14)) 101)) (= (to_rep (select (temp___String_Literal_585 us_void_param) 15)) 100)) (= (to_rep (select (temp___String_Literal_585 us_void_param) 16)) 32)) (= (to_rep (select (temp___String_Literal_585 us_void_param) 17)) 113)) (= (to_rep (select (temp___String_Literal_585 us_void_param) 18)) 117)) (= (to_rep (select (temp___String_Literal_585 us_void_param) 19)) 101)) (= (to_rep (select (temp___String_Literal_585 us_void_param) 20)) 117)) (= (to_rep (select (temp___String_Literal_585 us_void_param) 21)) 101)) (= (to_rep (select (temp___String_Literal_585 us_void_param) 22)) 32)) (= (to_rep (select (temp___String_Literal_585 us_void_param) 23)) 105)) (= (to_rep (select (temp___String_Literal_585 us_void_param) 24)) 115)) (= (to_rep (select (temp___String_Literal_585 us_void_param) 25)) 32)) :pattern ((temp___String_Literal_585 us_void_param)))))
...
(assert true)
(assert true)
(assert (forall ((queue us_rep)) (! (=> (and (dynamic_invariant2 queue true true true) (not (= (empty queue) true))) (dynamic_invariant3 (first_element queue) true false true)) :pattern ((first_element queue)))))
(assert (forall ((queue us_rep)) (! (=> (and (dynamic_invariant2 queue true true true) (not (= (empty queue) true))) (dynamic_invariant3 (last_element queue) true false true)) :pattern ((last_element queue)))))
...
(declare-const temp___576 positive)
(declare-const temp___5761 natural)
(declare-const temp___5762 positive)
(declare-const temp___5763 positive)
(declare-const temp___5764 (Array Int element_type))
(declare-const o Int)
...
(declare-const bounded_queue_v1__enqueue__queue__fields natural)
(declare-const bounded_queue_v1__enqueue__queue__fields1 positive)
(declare-const bounded_queue_v1__enqueue__queue__fields2 positive)
(declare-const bounded_queue_v1__enqueue__queue__fields3 (Array Int element_type))
(declare-const bounded_queue_v1__enqueue__queue__fields4 t1)
...
(declare-const bounded_queue_v1__dequeue__item Int)
(declare-const bounded_queue_v1__dequeue__queue__fields us_split_fields)
...
(declare-const bounded_queue_v1__dequeue__item1 Int)
(declare-const bounded_queue_v1__dequeue__queue__fields1 us_split_fields)
...
(declare-const bounded_queue_v1__dequeue__item2 Int)
(declare-const bounded_queue_v1__dequeue__queue__fields2 us_split_fields)
...
(declare-const bounded_queue_v1__dequeue__item3 Int)
(declare-const bounded_queue_v1__dequeue__queue__fields3 us_split_fields)
...
(declare-const bounded_queue_v1__dequeue__item4 Int)
(declare-const bounded_queue_v1__dequeue__queue__fields4 us_split_fields)
...
(declare-const bounded_queue_v1__clear__queue__fields5 us_split_fields)
...
(assert (and (and (= (empty (mk___rep my_queue__split_discrs (mk___split_fields bounded_queue_v1__clear__queue__fields bounded_queue_v1__clear__queue__fields1 bounded_queue_v1__clear__queue__fields2 (mk___t1 bounded_queue_v1__clear__queue__fields3 bounded_queue_v1__clear__queue__fields4)))) true) (= (size (mk___rep my_queue__split_discrs (mk___split_fields bounded_queue_v1__clear__queue__fields bounded_queue_v1__clear__queue__fields1 bounded_queue_v1__clear__queue__fields2 (mk___t1 bounded_queue_v1__clear__queue__fields3 bounded_queue_v1__clear__queue__fields4)))) 0)) (dynamic_invariant2 (mk___rep my_queue__split_discrs (mk___split_fields bounded_queue_v1__clear__queue__fields bounded_queue_v1__clear__queue__fields1 bounded_queue_v1__clear__queue__fields2 (mk___t1 bounded_queue_v1__clear__queue__fields3 bounded_queue_v1__clear__queue__fields4))) true true true)))
...
(assert (= count2 17))
(assert (=> (and (<= 17 count2) (<= count2 52)) (and (= (mk___split_discrs temp___576) my_queue__split_discrs) (and (= temp___5761 my_queue__split_fields4) (and (= temp___5762 my_queue__split_fields5) (and (= temp___5763 my_queue__split_fields6) (= temp___5764 my_queue__split_fields7)))))))
(assert (=> (and (<= 17 count2) (<= count2 52)) (and (<= 17 count3) (<= count3 52))))
(assert (=> (and (<= 17 count2) (<= count2 52)) (and (and (not (= (empty (mk___rep my_queue__split_discrs (mk___split_fields bounded_queue_v1__enqueue__queue__fields bounded_queue_v1__enqueue__queue__fields1 bounded_queue_v1__enqueue__queue__fields2 (mk___t1 bounded_queue_v1__enqueue__queue__fields3 bounded_queue_v1__enqueue__queue__fields4)))) true)) (and (= (size (mk___rep my_queue__split_discrs (mk___split_fields bounded_queue_v1__enqueue__queue__fields bounded_queue_v1__enqueue__queue__fields1 bounded_queue_v1__enqueue__queue__fields2 (mk___t1 bounded_queue_v1__enqueue__queue__fields3 bounded_queue_v1__enqueue__queue__fields4)))) (+ (size (mk___rep my_queue__split_discrs (mk___split_fields my_queue__split_fields8 my_queue__split_fields9 my_queue__split_fields10 (mk___t1 my_queue__split_fields11 (mk1 1 100))))) 1)) (= (last_element (mk___rep my_queue__split_discrs (mk___split_fields bounded_queue_v1__enqueue__queue__fields bounded_queue_v1__enqueue__queue__fields1 bounded_queue_v1__enqueue__queue__fields2 (mk___t1 bounded_queue_v1__enqueue__queue__fields3 bounded_queue_v1__enqueue__queue__fields4)))) count3))) (dynamic_invariant2 (mk___rep my_queue__split_discrs (mk___split_fields bounded_queue_v1__enqueue__queue__fields bounded_queue_v1__enqueue__queue__fields1 bounded_queue_v1__enqueue__queue__fields2 (mk___t1 bounded_queue_v1__enqueue__queue__fields3 bounded_queue_v1__enqueue__queue__fields4))) true true true))))
...
(assert (=> (and (<= 17 count2) (<= count2 52)) (= bounded_queue_v1__enqueue__queue__fields my_queue__split_fields12)))
(assert (=> (and (<= 17 count2) (<= count2 52)) (= bounded_queue_v1__enqueue__queue__fields1 my_queue__split_fields13)))
(assert (=> (and (<= 17 count2) (<= count2 52)) (= bounded_queue_v1__enqueue__queue__fields2 my_queue__split_fields14)))
(assert (=> (and (<= 17 count2) (<= count2 52)) (= bounded_queue_v1__enqueue__queue__fields3 my_queue__split_fields15)))
(assert (=> (and (<= 17 count2) (<= count2 52)) (= count3 52)))
(assert (=> (and (<= 17 count2) (<= count2 52)) (= count4 (mk_int__ref count3))))
(assert (=> (and (<= 17 count2) (<= count2 52)) (= my_queue__split_fields16 (mk___split_fields__ref1 (mk___split_fields1 my_queue__split_fields12 my_queue__split_fields13 my_queue__split_fields14 my_queue__split_fields15)))))
(assert (=> (and (<= 17 count2) (<= count2 52)) (= count5 count3)))
(assert (=> (and (<= 17 count2) (<= count2 52)) (= my_queue__split_fields17 (mk___split_fields1 my_queue__split_fields12 my_queue__split_fields13 my_queue__split_fields14 my_queue__split_fields15))))
...
(assert (=> (not (and (<= 17 count2) (<= count2 52))) (= my_queue__split_fields18 (mk___split_fields__ref1 (mk___split_fields1 my_queue__split_fields4 my_queue__split_fields5 my_queue__split_fields6 my_queue__split_fields7)))))
(assert (=> (not (and (<= 17 count2) (<= count2 52))) (= count7 count2)))
(assert (=> (not (and (<= 17 count2) (<= count2 52))) (= my_queue__split_fields19 (mk___split_fields1 my_queue__split_fields4 my_queue__split_fields5 my_queue__split_fields6 my_queue__split_fields7))))
(assert (= result9 (mk_int__ref count1)))
(assert (= count8 1))
(assert (not (not (= (empty (mk___rep my_queue__split_discrs (mk___split_fields (rec__bounded_queue_v1__queue_type__count1 (us_split_fields__content1 my_queue__split_fields18)) (rec__bounded_queue_v1__queue_type__front1 (us_split_fields__content1 my_queue__split_fields18)) (rec__bounded_queue_v1__queue_type__rear1 (us_split_fields__content1 my_queue__split_fields18)) (mk___t1 (rec__bounded_queue_v1__queue_type__items1 (us_split_fields__content1 my_queue__split_fields18)) (mk1 1 100))))) true))))
(check-sat)
(exit)
