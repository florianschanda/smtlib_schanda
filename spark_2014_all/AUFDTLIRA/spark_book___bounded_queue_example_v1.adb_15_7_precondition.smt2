...
(define-fun bool_eq5 ((a us_rep1) (b us_rep1)) Bool (ite (and (and (and (and (= (to_rep3 (rec__bounded_queue_v1__queue_type__max_size (us_split_discrs2 a))) (to_rep3 (rec__bounded_queue_v1__queue_type__max_size (us_split_discrs2 b)))) (= (to_rep2 (rec__bounded_queue_v1__queue_type__count1 (us_split_fields3 a))) (to_rep2 (rec__bounded_queue_v1__queue_type__count1 (us_split_fields3 b))))) (= (to_rep3 (rec__bounded_queue_v1__queue_type__front1 (us_split_fields3 a))) (to_rep3 (rec__bounded_queue_v1__queue_type__front1 (us_split_fields3 b))))) (= (to_rep3 (rec__bounded_queue_v1__queue_type__rear1 (us_split_fields3 a))) (to_rep3 (rec__bounded_queue_v1__queue_type__rear1 (us_split_fields3 b))))) (= (bool_eq2 (rec__bounded_queue_v1__queue_type__items1 (us_split_fields3 a)) 1 100 (rec__bounded_queue_v1__queue_type__items1 (us_split_fields3 b)) 1 100) true)) true false))
...
(define-fun dynamic_invariant4 ((temp___expr_565 us_rep1) (temp___is_init_562 Bool) (temp___skip_constant_563 Bool) (temp___do_toplevel_564 Bool)) Bool (=> (not (= temp___skip_constant_563 true)) (in_range7 100 (to_base temp___expr_565))))
(define-fun default_initial_assumption ((temp___expr_568 us_rep1) (temp___skip_top_level_569 Bool)) Bool (= (to_rep3 (rec__bounded_queue_v1__queue_type__max_size (us_split_discrs2 temp___expr_568))) 100))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_591 us_void_param) 1)) 83) (= (to_rep (select (temp___String_Literal_591 us_void_param) 2)) 105)) (= (to_rep (select (temp___String_Literal_591 us_void_param) 3)) 122)) (= (to_rep (select (temp___String_Literal_591 us_void_param) 4)) 101)) (= (to_rep (select (temp___String_Literal_591 us_void_param) 5)) 32)) (= (to_rep (select (temp___String_Literal_591 us_void_param) 6)) 111)) (= (to_rep (select (temp___String_Literal_591 us_void_param) 7)) 102)) (= (to_rep (select (temp___String_Literal_591 us_void_param) 8)) 32)) (= (to_rep (select (temp___String_Literal_591 us_void_param) 9)) 99)) (= (to_rep (select (temp___String_Literal_591 us_void_param) 10)) 108)) (= (to_rep (select (temp___String_Literal_591 us_void_param) 11)) 101)) (= (to_rep (select (temp___String_Literal_591 us_void_param) 12)) 97)) (= (to_rep (select (temp___String_Literal_591 us_void_param) 13)) 114)) (= (to_rep (select (temp___String_Literal_591 us_void_param) 14)) 101)) (= (to_rep (select (temp___String_Literal_591 us_void_param) 15)) 100)) (= (to_rep (select (temp___String_Literal_591 us_void_param) 16)) 32)) (= (to_rep (select (temp___String_Literal_591 us_void_param) 17)) 113)) (= (to_rep (select (temp___String_Literal_591 us_void_param) 18)) 117)) (= (to_rep (select (temp___String_Literal_591 us_void_param) 19)) 101)) (= (to_rep (select (temp___String_Literal_591 us_void_param) 20)) 117)) (= (to_rep (select (temp___String_Literal_591 us_void_param) 21)) 101)) (= (to_rep (select (temp___String_Literal_591 us_void_param) 22)) 32)) (= (to_rep (select (temp___String_Literal_591 us_void_param) 23)) 105)) (= (to_rep (select (temp___String_Literal_591 us_void_param) 24)) 115)) (= (to_rep (select (temp___String_Literal_591 us_void_param) 25)) 32)) :pattern ((temp___String_Literal_591 us_void_param)))))
...
(declare-const temp___582 positive)
(declare-const temp___5821 natural)
(declare-const temp___5822 positive)
(declare-const temp___5823 positive)
(declare-const temp___5824 (Array Int element_type))
...
(define-fun my_queue__split_fields20 () us_split_fields2 (mk___split_fields1 my_queue__split_fields12 my_queue__split_fields13 my_queue__split_fields14 my_queue__split_fields15))
(define-fun bounded_queue_v1__enqueue__queue__fields5 () us_split_fields (mk___split_fields bounded_queue_v1__enqueue__queue__fields bounded_queue_v1__enqueue__queue__fields1 bounded_queue_v1__enqueue__queue__fields2 (mk___t1 bounded_queue_v1__enqueue__queue__fields3 bounded_queue_v1__enqueue__queue__fields4)))
(define-fun my_queue__split_fields21 () us_split_fields2 (mk___split_fields1 my_queue__split_fields4 my_queue__split_fields5 my_queue__split_fields6 my_queue__split_fields7))
...
(assert (and (and (= (empty (mk___rep my_queue__split_discrs bounded_queue_v1__clear__queue__fields5)) true) (= (size (mk___rep my_queue__split_discrs bounded_queue_v1__clear__queue__fields5)) 0)) (dynamic_invariant2 (mk___rep my_queue__split_discrs bounded_queue_v1__clear__queue__fields5) true true true)))
...
(assert (= count2 17))
(assert (=> (and (<= 17 count2) (<= count2 52)) (and (= (mk___split_discrs temp___582) my_queue__split_discrs) (and (= temp___5821 my_queue__split_fields4) (and (= temp___5822 my_queue__split_fields5) (and (= temp___5823 my_queue__split_fields6) (= temp___5824 my_queue__split_fields7)))))))
(assert (=> (and (<= 17 count2) (<= count2 52)) (and (<= 17 count3) (<= count3 52))))
(assert (=> (and (<= 17 count2) (<= count2 52)) (and (and (not (= (empty (mk___rep my_queue__split_discrs bounded_queue_v1__enqueue__queue__fields5)) true)) (and (= (size (mk___rep my_queue__split_discrs bounded_queue_v1__enqueue__queue__fields5)) (+ (size (mk___rep my_queue__split_discrs (mk___split_fields my_queue__split_fields8 my_queue__split_fields9 my_queue__split_fields10 (mk___t1 my_queue__split_fields11 (mk1 1 100))))) 1)) (= (last_element (mk___rep my_queue__split_discrs bounded_queue_v1__enqueue__queue__fields5)) count3))) (dynamic_invariant2 (mk___rep my_queue__split_discrs bounded_queue_v1__enqueue__queue__fields5) true true true))))
...
(assert (=> (and (<= 17 count2) (<= count2 52)) (= my_queue__split_fields16 (mk___split_fields__ref1 my_queue__split_fields20))))
(assert (=> (and (<= 17 count2) (<= count2 52)) (= count5 count3)))
(assert (=> (and (<= 17 count2) (<= count2 52)) (= my_queue__split_fields17 my_queue__split_fields20)))
...
(assert (=> (not (and (<= 17 count2) (<= count2 52))) (= my_queue__split_fields18 (mk___split_fields__ref1 my_queue__split_fields21))))
(assert (=> (not (and (<= 17 count2) (<= count2 52))) (= count7 count2)))
(assert (=> (not (and (<= 17 count2) (<= count2 52))) (= my_queue__split_fields19 my_queue__split_fields21)))
