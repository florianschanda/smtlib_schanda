...
(declare-const temp___645 positive)
(declare-const temp___6451 natural)
(declare-const temp___6452 positive)
(declare-const temp___6453 positive)
(declare-const temp___6454 (Array Int element_type))
...
(assert (= count2 17))
(assert (=> (and (<= 17 count2) (<= count2 52)) (and (= (mk___split_discrs temp___645) my_queue__split_discrs) (and (= temp___6451 my_queue__split_fields4) (and (= temp___6452 my_queue__split_fields5) (and (= temp___6453 my_queue__split_fields6) (= temp___6454 my_queue__split_fields7)))))))
...
(assert (= count8 1))
(assert (and (and (= bounded_queue_v1__dequeue__item (first_element (mk___rep my_queue__split_discrs (mk___split_fields (rec__bounded_queue_v1__queue_type__count1 (us_split_fields__content1 my_queue__split_fields18)) (rec__bounded_queue_v1__queue_type__front1 (us_split_fields__content1 my_queue__split_fields18)) (rec__bounded_queue_v1__queue_type__rear1 (us_split_fields__content1 my_queue__split_fields18)) (mk___t1 (rec__bounded_queue_v1__queue_type__items1 (us_split_fields__content1 my_queue__split_fields18)) (mk1 1 100)))))) (= (size (mk___rep my_queue__split_discrs bounded_queue_v1__dequeue__queue__fields)) (- (size (mk___rep my_queue__split_discrs (mk___split_fields (rec__bounded_queue_v1__queue_type__count1 (us_split_fields__content1 my_queue__split_fields18)) (rec__bounded_queue_v1__queue_type__front1 (us_split_fields__content1 my_queue__split_fields18)) (rec__bounded_queue_v1__queue_type__rear1 (us_split_fields__content1 my_queue__split_fields18)) (mk___t1 (rec__bounded_queue_v1__queue_type__items1 (us_split_fields__content1 my_queue__split_fields18)) (mk1 1 100))))) 1))) (and (dynamic_invariant2 (mk___rep my_queue__split_discrs bounded_queue_v1__dequeue__queue__fields) true true true true) (in_range5 bounded_queue_v1__dequeue__item))))
(assert (= result10 my_queue__split_fields18))
(assert (= my_queue__split_fields20 (mk___split_fields1 (rec__bounded_queue_v1__queue_type__count bounded_queue_v1__dequeue__queue__fields) (rec__bounded_queue_v1__queue_type__front bounded_queue_v1__dequeue__queue__fields) (rec__bounded_queue_v1__queue_type__rear bounded_queue_v1__dequeue__queue__fields) (elts1 (rec__bounded_queue_v1__queue_type__items bounded_queue_v1__dequeue__queue__fields)))))
(assert (= result11 (mk_int__ref value)))
(assert (= value1 bounded_queue_v1__dequeue__item))
(assert (= result12 (mk_int__ref count8)))
(assert (= count9 2))
(assert (not (not (= (empty (mk___rep my_queue__split_discrs (mk___split_fields (rec__bounded_queue_v1__queue_type__count1 my_queue__split_fields20) (rec__bounded_queue_v1__queue_type__front1 my_queue__split_fields20) (rec__bounded_queue_v1__queue_type__rear1 my_queue__split_fields20) (mk___t1 (rec__bounded_queue_v1__queue_type__items1 my_queue__split_fields20) (mk1 1 100))))) true))))
(check-sat)
(exit)
