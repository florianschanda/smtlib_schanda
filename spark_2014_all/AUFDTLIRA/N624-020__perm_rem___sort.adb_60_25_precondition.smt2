...
(assert (and (= o50 (remove (mk___t values2 (mk 1 100)) o49)) (and (dynamic_invariant4 o50 true false true) (and (= (invariant__ o50) true) (and (= (to_rep1 (last (rt o50))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o49 1))) (= (to_rep (select values2 k)) (to_rep (select (elts o50) k))))) (and (forall ((k Int)) (=> (and (<= (+ o49 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select (elts o50) (- k 1)))))) (forall ((k Int)) (=> (and (<= o49 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts o50) k))))))))))))
