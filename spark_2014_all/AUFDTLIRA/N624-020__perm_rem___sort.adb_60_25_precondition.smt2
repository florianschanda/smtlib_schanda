...
(assert (and (= o106 (remove (mk___t init (mk 1 100)) o105)) (and (dynamic_invariant4 o106 true false true) (and (= (invariant__ o106) true) (and (= (to_rep1 (last (rt o106))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o105 1))) (= (to_rep (select init k)) (to_rep (select (elts o106) k))))) (and (forall ((k Int)) (=> (and (<= (+ o105 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select init k)) (to_rep (select (elts o106) (- k 1)))))) (forall ((k Int)) (=> (and (<= o105 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select init (+ k 1))) (to_rep (select (elts o106) k))))))))))))
(assert (not (= (invariant__ o106) true)))
(check-sat)
(exit)
