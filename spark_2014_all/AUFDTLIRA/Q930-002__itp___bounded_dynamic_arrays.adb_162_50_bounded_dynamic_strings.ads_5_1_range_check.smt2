...
(assert (not (= (length3 temp___11862) 0)))
(assert (=> (<= (to_rep1 (first4 (rt2 tail))) (to_rep1 (last4 (rt2 tail)))) (= o2 (+ (- (to_rep1 (last4 (rt2 tail))) (to_rep1 (first4 (rt2 tail)))) 1))))
(assert (=> (not (<= (to_rep1 (first4 (rt2 tail))) (to_rep1 (last4 (rt2 tail))))) (= o2 0)))
(assert (=> (<= (to_rep1 (first4 temp___11861)) (to_rep1 (last4 temp___11861))) (= o3 (+ (- (to_rep1 (last4 temp___11861)) (to_rep1 (first4 temp___11861))) 1))))
(assert (=> (not (<= (to_rep1 (first4 temp___11861)) (to_rep1 (last4 temp___11861)))) (= o3 0)))
(assert (= o4 (+ o3 o2)))
(assert (= o5 (+ (to_rep1 (first4 temp___11861)) o4)))
(assert (= o6 (- o5 1)))
