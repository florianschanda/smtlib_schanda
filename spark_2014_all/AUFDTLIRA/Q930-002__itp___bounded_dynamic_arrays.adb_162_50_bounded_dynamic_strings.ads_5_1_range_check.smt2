...
(assert (not (= (length1 temp___11802) 0)))
(assert (=> (<= (to_rep1 (first2 (rt1 tail))) (to_rep1 (last2 (rt1 tail)))) (= o2 (+ (- (to_rep1 (last2 (rt1 tail))) (to_rep1 (first2 (rt1 tail)))) 1))))
(assert (=> (not (<= (to_rep1 (first2 (rt1 tail))) (to_rep1 (last2 (rt1 tail))))) (= o2 0)))
(assert (=> (<= (to_rep1 (first2 temp___11801)) (to_rep1 (last2 temp___11801))) (= o3 (+ (- (to_rep1 (last2 temp___11801)) (to_rep1 (first2 temp___11801))) 1))))
(assert (=> (not (<= (to_rep1 (first2 temp___11801)) (to_rep1 (last2 temp___11801)))) (= o3 0)))
(assert (= o4 (+ o3 o2)))
(assert (= o5 (+ (to_rep1 (first2 temp___11801)) o4)))
(assert (= o6 (- o5 1)))
