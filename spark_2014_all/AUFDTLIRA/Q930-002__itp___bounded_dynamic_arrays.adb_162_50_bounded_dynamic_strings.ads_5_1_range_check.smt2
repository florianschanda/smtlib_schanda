...
(assert (not (= (length1 (mk___t1 temp___1117 temp___11171)) 0)))
(assert (=> (<= (to_rep1 (first2 (rt1 tail))) (to_rep1 (last2 (rt1 tail)))) (= o8 (+ (- (to_rep1 (last2 (rt1 tail))) (to_rep1 (first2 (rt1 tail)))) 1))))
(assert (=> (not (<= (to_rep1 (first2 (rt1 tail))) (to_rep1 (last2 (rt1 tail))))) (= o8 0)))
(assert (=> (<= (to_rep1 (first2 temp___11171)) (to_rep1 (last2 temp___11171))) (= o9 (+ (- (to_rep1 (last2 temp___11171)) (to_rep1 (first2 temp___11171))) 1))))
(assert (=> (not (<= (to_rep1 (first2 temp___11171)) (to_rep1 (last2 temp___11171)))) (= o9 0)))
(assert (= o10 (+ o9 o8)))
(assert (= o11 (+ (to_rep1 (first2 temp___11171)) o10)))
(assert (= o12 (- o11 1)))
