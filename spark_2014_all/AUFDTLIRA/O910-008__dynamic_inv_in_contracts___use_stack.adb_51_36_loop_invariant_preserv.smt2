...
(assert (= content1 o2))
(assert (forall ((j Int)) (=> (and (<= 1 j) (<= j i2)) (= (to_rep (select content2 j)) e))))
(assert (and (and (forall ((temp___253 Int)) (=> (and (<= (to_rep1 content__first) temp___253) (<= temp___253 (to_rep1 content__last))) (=> (< i2 temp___253) (= (select content2 temp___253) (select content temp___253))))) (=> (<= 1 (to_rep1 content__last)) (dynamic_property3 1 (to_rep1 content__last) i2))) (and (<= 1 i2) (<= i2 (to_rep1 content__last)))))
...
(assert (<= 1 j))
(assert (<= j i3))
(assert (not (= (to_rep (select content3 j)) e)))
(check-sat)
(exit)
