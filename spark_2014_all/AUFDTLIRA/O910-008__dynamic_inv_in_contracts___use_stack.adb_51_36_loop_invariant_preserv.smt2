...
(assert (and (and (forall ((temp___223 Int)) (=> (and (<= (to_rep1 content__first) temp___223) (<= temp___223 (to_rep1 content__last))) (=> (< i2 temp___223) (= (select content2 temp___223) (select content temp___223))))) (=> (<= 1 (to_rep1 content__last)) (dynamic_property3 1 (to_rep1 content__last) i2))) (and (<= 1 i2) (<= i2 (to_rep1 content__last)))))
