...
(assert (= content2 o2))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 i2)) (= (to_rep (select content3 j1)) e))))
(assert (and (and (forall ((temp___223 Int)) (=> (and (<= (to_rep1 content__first) temp___223) (<= temp___223 (to_rep1 content__last))) (=> (< i2 temp___223) (= (select content3 temp___223) (select content temp___223))))) (=> (<= 1 (to_rep1 content__last)) (dynamic_property3 1 (to_rep1 content__last) i2))) (and (<= 1 i2) (<= i2 (to_rep1 content__last)))))
(assert (not (= i2 (to_rep1 content__last))))
(assert (= result3 i2))
(assert (= i3 (+ i2 1)))
(assert (= (to_rep o3) e))
(assert (= o4 (store content3 i3 o3)))
(assert (= result4 content3))
(assert (= content4 o4))
(declare-const j1 Int)
(assert (<= 1 j1))
(assert (<= j1 i3))
(assert (not (= (to_rep (select content4 j1)) e)))
(check-sat)
(exit)
