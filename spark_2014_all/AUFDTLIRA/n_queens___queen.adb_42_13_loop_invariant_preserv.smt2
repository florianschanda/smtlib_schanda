...
(assert (= b2 result1))
(assert (= b3 o11))
(assert (=> (= (to_rep (select c i)) r2) (and (ite (= done__3 true) (= (consistent b4 8) true) (not (= (consistent c 8) true))) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 i)) (= (to_rep (select b4 j3)) (to_rep (select b3 j3))))))))
(assert (=> (not (= (to_rep (select c i)) r2)) (and (= o12 (copy_until b3 i c)) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 i)) (= (to_rep (select o12 j3)) (to_rep (select b3 j3))))))))
(assert (=> (not (= (to_rep (select c i)) r2)) (and (ite (= done__4 true) (= (consistent b5 8) true) (not (= (consistent o12 8) true))) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 i)) (= (to_rep (select b5 j3)) (to_rep (select b3 j3))))))))
(assert (=> (not (= (to_rep (select c i)) r2)) (= done__3 done__4)))
(assert (=> (not (= (to_rep (select c i)) r2)) (= b4 b5)))
(assert (not (= done__3 true)))
(assert (not (= r2 8)))
(assert (= result2 r2))
(assert (= r3 (+ r2 1)))
(assert (not (not (= done__3 true))))
(check-sat)
(exit)
