...
(assert (= i1 0))
(assert (=> (and (<= 0 i1) (<= i1 (- length1 1))) (= temp___274 b)))
(assert (=> (and (<= 0 i1) (<= i1 (- length1 1))) (= temp___272 i1)))
(assert (=> (and (<= 0 i1) (<= i1 (- length1 1))) (= temp___269 b)))
(assert (=> (and (<= 0 i1) (<= i1 (- length1 1))) (= temp___277 b)))
(assert (=> (and (<= 0 i1) (<= i1 (- length1 1))) (forall ((j1 Int)) (=> (and (<= (to_rep b__first) j1) (<= j1 (to_rep b__last))) (and (=> (and (<= b_first j1) (<= j1 (- (+ b_first i2) 1))) (= (to_rep (select b2 j1)) (to_rep (select (elts a) (- (+ a_first j1) b_first))))) (=> (=> (<= b_first j1) (not (<= j1 (- (+ b_first i2) 1)))) (= (to_rep (select b2 j1)) (to_rep (select temp___277 j1)))))))))
(assert (=> (and (<= 0 i1) (<= i1 (- length1 1))) (and (=> (<= 0 (- length1 1)) (dynamic_property1 0 (- length1 1) i2)) (and (<= 0 i2) (<= i2 (- length1 1))))))
(assert (=> (and (<= 0 i1) (<= i1 (- length1 1))) (forall ((j1 Int)) (=> (and (<= (to_rep b__first) j1) (<= j1 (to_rep b__last))) (and (=> (and (<= b_first j1) (<= j1 (- (+ b_first (+ i2 1)) 1))) (= (to_rep (select b3 j1)) (to_rep (select (elts a) (- (+ a_first j1) b_first))))) (=> (=> (<= b_first j1) (not (<= j1 (- (+ b_first (+ i2 1)) 1)))) (= (to_rep (select b3 j1)) (to_rep (select temp___269 j1)))))))))
