...
(assert (= i1 0))
(assert (=> (and (<= 0 i1) (<= i1 (- length1 1))) (and (and (= temp___245 b) (and (= temp___243 i1) (and (= temp___240 b) (and (= temp___248 b) (and (forall ((j3 Int)) (=> (and (<= (to_rep b__first) j3) (<= j3 (to_rep b__last))) (and (=> (and (<= b_first j3) (<= j3 (- (+ b_first i2) 1))) (= (to_rep (select b2 j3)) (to_rep (select (elts a) (- (+ a_first j3) b_first))))) (=> (=> (<= b_first j3) (not (<= j3 (- (+ b_first i2) 1)))) (= (to_rep (select b2 j3)) (to_rep (select temp___248 j3))))))) (and (and (=> (<= 0 (- length1 1)) (dynamic_property1 0 (- length1 1) i2)) (and (<= 0 i2) (<= i2 (- length1 1)))) (and (forall ((j3 Int)) (=> (and (<= (to_rep b__first) j3) (<= j3 (to_rep b__last))) (and (=> (and (<= b_first j3) (<= j3 (- (+ b_first (+ i2 1)) 1))) (= (to_rep (select b3 j3)) (to_rep (select (elts a) (- (+ a_first j3) b_first))))) (=> (=> (<= b_first j3) (not (<= j3 (- (+ b_first (+ i2 1)) 1)))) (= (to_rep (select b3 j3)) (to_rep (select temp___240 j3))))))) (and (=> (<= 0 (- length1 1)) (dynamic_property1 0 (- length1 1) i2)) (= i2 (- length1 1)))))))))) (and (and (= i2 i6) (= b3 b6)) (and (= i7 i2) (= b7 b3))))))
(assert (=> (and (<= 0 i1) (<= i1 (- length1 1))) (= (mk_int__ref i8) (mk_int__ref i6))))
(assert (=> (and (<= 0 i1) (<= i1 (- length1 1))) (= (mk_map__ref b8) (mk_map__ref b6))))
(assert (=> (and (<= 0 i1) (<= i1 (- length1 1))) (= i9 i7)))
(assert (=> (and (<= 0 i1) (<= i1 (- length1 1))) (= b9 b7)))
(assert (=> (not (and (<= 0 i1) (<= i1 (- length1 1)))) (= i1 i8)))
(assert (=> (not (and (<= 0 i1) (<= i1 (- length1 1)))) (= (mk_map__ref b8) (mk_map__ref b))))
(assert (=> (not (and (<= 0 i1) (<= i1 (- length1 1)))) (= i9 i1)))
(assert (=> (not (and (<= 0 i1) (<= i1 (- length1 1)))) (= b9 b1)))
(assert (= (mk_int__ref i10) (mk_int__ref i8)))
(assert (= (mk_map__ref b10) (mk_map__ref b8)))
(assert (= i11 i9))
(assert (= b11 b9))
(assert (<= (to_rep b__first) j2))
(assert (<= j2 (to_rep b__last)))
(assert (and (= o61 (+ b_first length1)) (in_range1 (+ b_first length1))))
(assert (= o62 (- o61 1)))
(assert (= o63 (ite (<= j2 o62) true false)))
(assert (= o64 (ite (<= b_first j2) o63 false)))
(assert (= result7 (ite (not (= o64 true)) true false)))
(assert (= result7 true))
(assert (not (<= (to_rep b__first) j2)))
(check-sat)
(exit)
