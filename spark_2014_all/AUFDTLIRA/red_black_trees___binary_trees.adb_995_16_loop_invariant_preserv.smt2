...
(assert (=> (and (<= 1 ki1) (<= ki1 100)) (=> (= result3 true) (and (= o3 (length o2)) (and (in_range5 o3) (<= (+ 0 o3) 2147483647))))))
...
(assert (=> (and (<= 1 ki1) (<= ki1 100)) (=> (= result2 true) (and (= o20 (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 ki1))))) (in_range4 (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 ki1)))))))))
...
(assert (=> (and (<= 1 ki1) (<= ki1 100)) (=> (= result2 true) (= o11 (select temp___1782 o10)))))
...
(assert (=> (and (<= 1 ki1) (<= ki1 100)) (=> (= result2 true) (= o7 (select temp___1779 o6)))))
...
(assert (< (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root) i)))) (int__content n4)))
(assert (not (= i v)))
