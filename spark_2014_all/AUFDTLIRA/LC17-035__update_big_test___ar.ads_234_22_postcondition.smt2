...
(assert (= a4 result4))
(assert (= a5 o7))
(assert (and (= o8 (- (to_rep (select a5 5)) (to_rep (select a5 4)))) (in_range1 (- (to_rep (select a5 5)) (to_rep (select a5 4))))))
(assert (= (to_rep o9) o8))
...
(assert (= a8 result8))
(assert (= a9 o16))
(assert (and (= o17 (- (to_rep (select b 2)) (to_rep (select a9 2)))) (in_range1 (- (to_rep (select b 2)) (to_rep (select a9 2))))))
...
(assert (= a10 result10))
(assert (= a11 o21))
(assert (and (= o22 (- (to_rep (select a11 3)) (to_rep (select b 6)))) (in_range1 (- (to_rep (select a11 3)) (to_rep (select b 6))))))
...
(assert (<= 1 n))
(assert (<= n 10))
(assert (not (= (to_rep (select a14 n)) 0)))
(check-sat)
(exit)
