...
(assert (not (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (nb_blacks c88b) y1)))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (nb_blacks c87b) c89b)))))))
(check-sat)
(exit)
