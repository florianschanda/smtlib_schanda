...
(assert (= data2 o19))
(assert (not (= next_avail2 0)))
(assert (= (to_rep o20) 0))
(assert (= (rec__list_allocator__cell__stat (us_split_fields1 (select data2 next_avail2))) o21))
(assert (= o20 o22))
(assert (= (rec__list_allocator__cell__next (us_split_fields1 (select data2 next_avail2))) o23))
(assert (= o24 o21))
(assert (= o25 o22))
(assert (= o26 o23))
(assert (not (<= 1 next_avail2)))
(check-sat)
(exit)
