...
(assert (= r2 result9))
(assert (= r3 (+ r2 1)))
(assert (=> (= (to_rep (select data r3)) 0) (and (= o20 (add avail3 r3)) (and (and (and (= (length o20) (+ (length avail3) 1)) (= (contains o20 r3) true)) (= (ole avail3 o20) true)) (= (included_except o20 avail3 r3) true)))))
(assert (=> (= (to_rep (select data r3)) 0) (= result10 avail3)))
(assert (=> (= (to_rep (select data r3)) 0) (= avail4 o20)))
(assert (=> (= (to_rep (select data r3)) 0) (= alloc4 alloc3)))
(assert (=> (not (= (to_rep (select data r3)) 0)) (and (= o21 (add alloc3 r3)) (and (and (and (= (length o21) (+ (length alloc3) 1)) (= (contains o21 r3) true)) (= (ole alloc3 o21) true)) (= (included_except o21 alloc3 r3) true)))))
(assert (=> (not (= (to_rep (select data r3)) 0)) (= result11 alloc3)))
(assert (=> (not (= (to_rep (select data r3)) 0)) (= alloc4 o21)))
