...
(assert (and (= o16 (values1 t2)) (ite (= (size (rec__search_trees__search_tree__struct (us_split_fields7 t2))) 0) (= (is_empty o16) true) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t2)) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t2)))) i2))) true) (= (contains o16 (to_rep2 (select (rec__search_trees__search_tree__values (us_split_fields7 t2)) i2))) true)))) (forall ((v Int)) (=> (and (<= 0 v) (<= v 2147483647)) (=> (= (contains o16 v) true) (exists ((i2 Int)) (and (and (<= 1 i2) (<= i2 100)) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t2)) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t2)))) i2))) true) (= (to_rep2 (select (rec__search_trees__search_tree__values (us_split_fields7 t2)) i2)) v)))))))))))
(assert (not (type_invariant1 t1)))
(check-sat)
(exit)
