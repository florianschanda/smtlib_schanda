...
(assert (and (= o (values1 t2)) (ite (= (size (rec__search_trees__search_tree__struct (us_split_fields7 t2))) 0) (= (is_empty o) true) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t2)) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t2)))) i))) true) (= (contains o (to_rep2 (select (rec__search_trees__search_tree__values (us_split_fields7 t2)) i))) true)))) (forall ((v Int)) (=> (and (<= 0 v) (<= v 2147483647)) (=> (= (contains o v) true) (exists ((i Int)) (and (and (<= 1 i) (<= i 100)) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t2)) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t2)))) i))) true) (= (to_rep2 (select (rec__search_trees__search_tree__values (us_split_fields7 t2)) i)) v)))))))))))
