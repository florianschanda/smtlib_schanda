...
(assert (= result2 true))
(assert (and (= o5 (valid_root f v)) (=> (< (size f) v) (not (= o5 true)))))
...
(assert (= o3 (select temp___1760 v)))
(assert (= o4 (us_split_fields1 o3)))
(assert (= result4 (rec__tree_model__path_type__k o4)))
(assert (= result4 true))
