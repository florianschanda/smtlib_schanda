...
(assert (and (<= (to_rep1 (first (rt haystack))) temp___267) (<= temp___267 (to_rep1 (last (rt haystack))))))
(assert (= o11 temp___267))
(assert (= o12 (select (elts haystack) o11)))
(assert (= o13 (to_rep o12)))
(assert (not (<= (to_rep1 (first (rt needle))) j3)))
(check-sat)
(exit)
