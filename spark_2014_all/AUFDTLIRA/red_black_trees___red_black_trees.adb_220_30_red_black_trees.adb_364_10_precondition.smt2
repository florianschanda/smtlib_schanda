...
(declare-const o Int)
(declare-const i Int)
(declare-const temp___639 (Array Int us_rep1))
...
(assert (dynamic_invariant6 c61b true false true true))
(assert (= (mk___rep4 t__split_fields5) c62b))
(assert (dynamic_invariant6 c62b true false true true))
...
(assert (<= 1 n1))
(assert (<= n1 100))
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c61b))) i1))) true) (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c61b) i1)))) n2)) (not (= i1 (root (rec__red_black_trees__rbt__struct (us_split_fields9 c62b)))))) (= (eq (select (nb_blacks c62b) i1) (select (nb_blacks c61b) i1)) true)))))
(assert (and (=> (<= 1 100) (in_range2 n2)) (and (<= 1 n2) (<= n2 100))))
(assert (<= 1 i))
(assert (<= i 100))
(assert (and (= temp___639 (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c61b)))) (and (dynamic_invariant5 temp___639 true false true true) (= temp___639 (model__1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 c61b)))) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 c61b))))))))))
(assert (= o1 (select temp___639 i)))
(assert (= o2 (us_split_fields1 o1)))
(assert (= result4 (rec__tree_model__path_type__k o2)))
(assert (= result4 true))
