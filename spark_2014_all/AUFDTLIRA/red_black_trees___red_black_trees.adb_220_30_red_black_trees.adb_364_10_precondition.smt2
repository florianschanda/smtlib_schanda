...
(assert (= x1 0))
(assert (= (mk___rep4 t_old__split_fields5) c61b))
(assert (dynamic_invariant6 c61b true false true))
(assert (= (mk___rep4 t__split_fields5) c62b))
(assert (dynamic_invariant6 c62b true false true))
(assert (and (= o (size (rec__red_black_trees__rbt__struct (us_split_fields9 c61b)))) (and (in_range3 o) (= o (size1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 c61b)))))))))
(assert (= result2 (ite (< 0 o) true false)))
(assert (= result2 true))
(assert (= result3 (mk_int__ref n)))
(assert (= n18 1))
(assert (<= 1 n18))
(assert (<= n18 100))
(assert (forall ((i14 Int)) (=> (and (<= 1 i14) (<= i14 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c61b))) i14))) true) (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c61b) i14)))) n19)) (not (= i14 (root (rec__red_black_trees__rbt__struct (us_split_fields9 c62b)))))) (= (eq (select (nb_blacks c62b) i14) (select (nb_blacks c61b) i14)) true)))))
(assert (and (=> (<= 1 100) (in_range2 n19)) (and (<= 1 n19) (<= n19 100))))
(assert (<= 1 i))
(assert (<= i 100))
(assert (and (= temp___590 (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c61b)))) (and (dynamic_invariant5 temp___590 true false true) (= temp___590 (model__1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 c61b)))) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 c61b))))))))))
(assert (= o7 (select temp___590 i)))
(assert (= o8 (us_split_fields1 o7)))
(assert (= result6 (rec__tree_model__path_type__k o8)))
(assert (= result6 true))
(assert (not (not (= (size (rec__red_black_trees__rbt__struct (us_split_fields9 c61b))) 0))))
(check-sat)
(exit)
