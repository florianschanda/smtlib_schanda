...
(assert (= o127 i1))
(assert (= o128 (select (rec__patience__state__preds (us_split_fields__content s__split_fields20)) o127)))
(assert (= o129 (to_rep o128)))
(assert (= o130 (ite (<= o129 (- (to_rep (rec__patience__state__numelts (us_split_fields__content s__split_fields20))) 1)) true false)))
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o124 i1))
(assert (= o125 (select (rec__patience__state__preds (us_split_fields__content s__split_fields20)) o124)))
(assert (= o126 (to_rep o125)))
(assert (= o131 (ite (<= (- 1) o126) true false)))
(assert (= result27 (ite (= o131 true) o130 false)))
(assert (=> (= result27 true) (and (<= 0 i1) (<= i1 99))))
(assert (=> (= result27 true) (= o121 i1)))
(assert (=> (= result27 true) (= o122 (select (rec__patience__state__preds (us_split_fields__content s__split_fields20)) o121))))
(assert (=> (= result27 true) (= o123 (to_rep o122))))
(assert (=> (= result27 true) (= result26 (ite (< o123 i1) true false))))
...
(assert (= o119 (to_rep1 o118)))
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o113 i1))
(assert (= o114 (select (rec__patience__state__preds (us_split_fields__content s__split_fields20)) o113)))
(assert (= temp___780 (to_rep o114)))
(assert (and (<= 0 temp___780) (<= temp___780 99)))
(assert (= o115 temp___780))
(assert (= o116 (select (rec__patience__state__values (us_split_fields__content s__split_fields20)) o115)))
(assert (= o120 (to_rep1 o116)))
(assert (= result30 (ite (< o120 o119) true false)))
(assert (=> (= result30 true) (and (<= 0 i1) (<= i1 99))))
(assert (=> (= result30 true) (= o110 i1)))
(assert (=> (= result30 true) (= o111 (select (rec__patience__state__posstack (us_split_fields__content s__split_fields20)) o110))))
(assert (=> (= result30 true) (= o112 (to_rep o111))))
(assert (=> (= result30 true) (= result29 (ite (< 0 o112) true false))))
(assert (=> (not (= result30 true)) (= result29 false)))
(assert (= result29 true))
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o106 i1))
(assert (= o107 (select (rec__patience__state__posstack (us_split_fields__content s__split_fields20)) o106)))
