...
(assert (= o131 (to_rep1 o130)))
(assert (= o132 (ite (<= o131 (- (to_rep1 (rec__patience__state__numelts (us_split_fields__content s__split_fields20))) 1)) true false)))
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o126 i1))
(assert (= o127 (select (rec__patience__state__preds (us_split_fields__content s__split_fields20)) o126)))
(assert (= o128 (to_rep1 o127)))
...
(assert (=> (= result27 true) (= o125 (to_rep1 o124))))
...
(assert (=> (= result30 true) (= o114 (to_rep1 o113))))
