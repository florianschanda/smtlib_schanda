...
(assert (= (= o139 true) (forall ((j5 Int)) (=> (and (<= i10 j5) (<= j5 (to_rep1 a__last))) (and (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select (map__content a26) i10)))) (to_rep (rec__frame_condition__cell__max_left (us_split_fields1 (select (map__content a26) j5))))) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select (map__content a26) j5)))) (to_rep (rec__frame_condition__cell__max_right (us_split_fields1 (select (map__content a26) i10))))))))))
