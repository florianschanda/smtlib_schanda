...
(assert (= (= o48 true) (forall ((j Int)) (=> (and (<= i j) (<= j (to_rep1 a__last))) (and (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select (map__content a19) i)))) (to_rep (rec__frame_condition__cell__max_left (us_split_fields1 (select (map__content a19) j))))) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select (map__content a19) j)))) (to_rep (rec__frame_condition__cell__max_right (us_split_fields1 (select (map__content a19) i))))))))))
