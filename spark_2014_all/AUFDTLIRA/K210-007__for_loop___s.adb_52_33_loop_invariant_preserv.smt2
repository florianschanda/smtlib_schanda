...
(assert (and (and (and (forall ((temp___185 Int)) (=> (and (<= 1 temp___185) (<= temp___185 10)) (=> (< temp___185 index2) (= (select dest2 temp___185) (select dest temp___185))))) (forall ((temp___187 Int)) (=> (and (<= 1 temp___187) (<= temp___187 10)) (=> (< temp___187 index2) (= (select src2 temp___187) (select src temp___187)))))) (=> (<= 1 10) (in_range3 index2))) (and (<= 1 index2) (<= index2 10))))
(assert (not (= index2 1)))
