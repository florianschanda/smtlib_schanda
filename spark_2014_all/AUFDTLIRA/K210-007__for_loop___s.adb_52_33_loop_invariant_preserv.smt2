...
(assert (= src2 o3))
(assert (and (forall ((j2 Int)) (=> (and (<= index2 j2) (<= j2 10)) (= (to_rep (select dest3 j2)) (to_rep (select src j2))))) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 (- index2 1))) (= (to_rep (select src3 j2)) (to_rep (select src j2)))))))
(assert (and (and (and (forall ((temp___185 Int)) (=> (and (<= 1 temp___185) (<= temp___185 10)) (=> (< temp___185 index2) (= (select dest3 temp___185) (select dest temp___185))))) (forall ((temp___187 Int)) (=> (and (<= 1 temp___187) (<= temp___187 10)) (=> (< temp___187 index2) (= (select src3 temp___187) (select src temp___187)))))) (=> (<= 1 10) (in_range3 index2))) (and (<= 1 index2) (<= index2 10))))
(assert (not (= index2 1)))
