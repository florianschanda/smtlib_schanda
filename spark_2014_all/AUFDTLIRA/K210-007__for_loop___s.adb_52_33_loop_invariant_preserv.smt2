...
(assert (and (and (and (forall ((temp___209 Int)) (=> (and (<= 1 temp___209) (<= temp___209 10)) (=> (< temp___209 index2) (= (select dest2 temp___209) (select dest temp___209))))) (forall ((temp___211 Int)) (=> (and (<= 1 temp___211) (<= temp___211 10)) (=> (< temp___211 index2) (= (select src2 temp___211) (select src temp___211)))))) (=> (<= 1 10) (in_range3 index2))) (and (<= 1 index2) (<= index2 10))))
(assert (not (= index2 1)))
