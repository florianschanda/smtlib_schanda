...
(assert (and (forall ((j Int)) (=> (and (<= index2 j) (<= j 10)) (= (to_rep (select dest2 j)) (to_rep (select src j))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (- index2 1))) (= (to_rep (select src2 j)) (to_rep (select src j)))))))
(assert (and (and (and (forall ((temp___211 Int)) (=> (and (<= 1 temp___211) (<= temp___211 10)) (=> (or (< 10 temp___211) (or (< temp___211 1) (< temp___211 index2))) (= (select dest2 temp___211) (select dest temp___211))))) (forall ((temp___213 Int)) (=> (and (<= 1 temp___213) (<= temp___213 10)) (=> (or (< 10 temp___213) (or (< temp___213 1) (< temp___213 index2))) (= (select src2 temp___213) (select src temp___213)))))) (=> (<= 1 10) (in_range3 index2))) (and (<= 1 index2) (<= index2 10))))
(assert (not (= index2 1)))
(assert (= result3 index2))
(assert (= index3 (- index2 1)))
(assert (= (to_rep o2) (to_rep (select src2 index3))))
(assert (= o3 (store dest2 index3 o2)))
(assert (= result4 dest2))
(assert (= dest3 o3))
(assert (= result5 src2))
(assert (= src3 (store src2 index3 rliteral)))
(declare-const j Int)
(assert (<= 1 j))
(assert (<= j (- index3 1)))
(assert (not (= (to_rep (select src3 j)) (to_rep (select src j)))))
(check-sat)
(exit)
