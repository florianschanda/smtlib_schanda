...
(assert (= a1 o2))
(assert (and (= o3 (- i2 (to_rep1 a__first))) (in_range1 (- i2 (to_rep1 a__first)))))
(assert (= o4 (+ o3 1)))
...
(assert (<= 1 i1))
(assert (<= i1 a_length1))
(assert (and (= temp___325 (+ (to_rep1 a__first) i1)) (in_range1 (+ (to_rep1 a__first) i1))))
(assert (not (<= (to_rep1 a__first) temp___325)))
(check-sat)
(exit)
