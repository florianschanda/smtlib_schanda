...
(assert (=> (= result1 true) (=> (not (= first_available 0)) (and (= o1 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (and (in_range5 o1) (<= (+ 0 o1) 2147483647))))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (and (= temp___281 (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m)) o1)) (in_range6 temp___281)))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (and (<= 1 temp___281) (<= temp___281 10000)))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (= o2 temp___281))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (= (mk___rep (mk___split_fields o3 o4)) (select data o2)))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (= o3 o5))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (= o4 o6))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (= o7 o6))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (= o8 (to_rep o7)))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (= result14 (ite (in_range3 o8) true false)))))
(assert (=> (= result1 true) (=> (= first_available 0) (= result14 false))))
(assert (=> (= result1 true) (=> (= result14 true) (and (= o9 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (and (in_range5 o9) (<= (+ 0 o9) 2147483647))))))
(assert (=> (= result1 true) (=> (= result14 true) (and (= temp___280 (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m)) o9)) (in_range6 temp___280)))))
(assert (=> (= result1 true) (=> (= result14 true) (and (<= 1 temp___280) (<= temp___280 10000)))))
(assert (=> (= result1 true) (=> (= result14 true) (= o10 temp___280))))
(assert (=> (= result1 true) (=> (= result14 true) (= (mk___rep (mk___split_fields o11 o12)) (select data o10)))))
(assert (=> (= result1 true) (=> (= result14 true) (= o11 o13))))
(assert (=> (= result1 true) (=> (= result14 true) (= o12 o14))))
(assert (=> (= result1 true) (=> (= result14 true) (= o15 o14))))
(assert (=> (= result1 true) (=> (= result14 true) (= o16 (to_rep o15)))))
(assert (=> (= result1 true) (=> (= result14 true) (and (= result (contains1 (rec__list_mod_allocator__m__t__available (us_split_fields3 m)) o16)) (= (= result true) (exists ((i Int)) (and (and (<= 1 i) (<= i (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m))))) (= (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m)) i) o16))))))))
(assert (=> (= result1 true) (=> (not (= result14 true)) (= result (of_int 1)))))
