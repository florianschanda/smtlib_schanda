...
(assert (forall ((s1 us_rep)) (! (let ((result (get_model__2 s1))) (and (and (= (length result) (size s1)) (and (in_range3 (last1 result)) (in_range3 (first1 result)))) (dynamic_invariant result true false true true))) :pattern ((get_model__2 s1)))))
(assert (forall ((attr__tag2 Int)) (forall ((s1 us_rep)) (! (let ((result (get_model__21 attr__tag2 s1))) (and (and (= (length result) (size s1)) (and (in_range3 (last1 result)) (in_range3 (first1 result)))) (dynamic_invariant result true false true true))) :pattern ((get_model__21 attr__tag2 s1))))))
...
(assert (forall ((s1 us_rep1)) (! (let ((result (get_model__3 s1))) (and (and (in_range3 (first1 result)) (and (in_range3 (last1 result)) (= (length result) (size (to_base s1))))) (dynamic_invariant result true false true true))) :pattern ((get_model__3 s1)))))
(assert (forall ((attr__tag2 Int)) (forall ((s1 us_rep1)) (! (let ((result (get_model__31 attr__tag2 s1))) (and (and (in_range3 (first1 result)) (and (in_range3 (last1 result)) (= (length result) (size (to_base s1))))) (dynamic_invariant result true false true true))) :pattern ((get_model__31 attr__tag2 s1))))))
...
(assert (forall ((temp___189 Int)) (=> (dynamic_invariant4 temp___189 true true true true) (forall ((temp___190 Int)) (= (select (temp_____aggregate_def_187 temp___189) temp___190) rliteral)))))
...
(assert (forall ((s1 us_rep1)) (! (dynamic_invariant3 (last4 s1) true false true true) :pattern ((last4 s1)))))
(assert (forall ((attr__tag2 Int)) (forall ((s1 us_rep1)) (! (dynamic_invariant3 (last5 attr__tag2 s1) true false true true) :pattern ((last5 attr__tag2 s1))))))
...
(assert (= result true))
(assert (and (= temp___4832 (get_model s)) (and (dynamic_invariant temp___4832 true false true true) (and (in_range3 (to_rep (first temp___4831))) (and (in_range3 (to_rep (last temp___4831))) (= (length temp___4832) (size s)))))))
(assert (and (= o3 (get_model s)) (and (dynamic_invariant o3 true false true true) (and (in_range3 (to_rep (first o1))) (and (in_range3 (to_rep (last o1))) (= (length o3) (size s)))))))
(assert (= temp___484 (to_rep (last o1))))
(assert (not (<= temp___484 (to_rep (last temp___4831)))))
(check-sat)
(exit)
