...
(assert (forall ((s us_rep)) (! (let ((result (get_model s))) (and (and (in_range1 (first1 result)) (and (in_range1 (last1 result)) (= (length result) (size s)))) (dynamic_invariant result true false true true))) :pattern ((get_model s)))))
(assert (forall ((attr__tag2 Int)) (forall ((s us_rep)) (! (let ((result (get_model1 attr__tag2 s))) (and (and (in_range1 (first1 result)) (and (in_range1 (last1 result)) (= (length result) (size s)))) (dynamic_invariant result true false true true))) :pattern ((get_model1 attr__tag2 s))))))
...
(define-fun dynamic_invariant4 ((temp___expr_166 Int) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool (=> (or (= temp___is_init_162 true) (<= 0 2147483647)) (in_range temp___expr_166)))
(assert (forall ((s1 us_rep)) (! (dynamic_invariant3 (size s1) true false true true) :pattern ((size s1)))))
...
(assert (forall ((s1 us_rep)) (! (let ((result (get_model__2 s1))) (and (and (= (length result) (size s1)) (and (in_range1 (last1 result)) (in_range1 (first1 result)))) (dynamic_invariant result true false true true))) :pattern ((get_model__2 s1)))))
(assert (forall ((attr__tag2 Int)) (forall ((s1 us_rep)) (! (let ((result (get_model__21 attr__tag2 s1))) (and (and (= (length result) (size s1)) (and (in_range1 (last1 result)) (in_range1 (first1 result)))) (dynamic_invariant result true false true true))) :pattern ((get_model__21 attr__tag2 s1))))))
...
(assert (forall ((s1 us_rep)) (! (= (get_model__2 s1) (let ((temp___310 (let ((temp___308 (to_rep1 (rec__stacks__stack_root__length (us_split_fields1 s1))))) (let ((temp___307 1)) (let ((temp___309 (rec__stacks__stack_root__content (us_split_fields1 s1)))) (of_array1 temp___309 temp___307 temp___308)))))) (of_array (to_array1 temp___310) (first3 temp___310) (last3 temp___310)))) :pattern ((get_model__2 s1)))))
...
(define-fun dynamic_property3 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range2 low) (and (in_range2 high) (=> (<= low high) (and (in_range5 low) (in_range5 high))))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range2 f) (=> (in_range2 l) (and (= (to_rep2 (first6 (mk3 f l))) f) (= (to_rep2 (last8 (mk3 f l))) l)))) :pattern ((mk3 f l)))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range2 f) (=> (in_range2 l) (and (= (to_rep2 (first8 (mk4 f l))) f) (= (to_rep2 (last10 (mk4 f l))) l)))) :pattern ((mk4 f l)))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range2 f) (=> (in_range2 l) (and (= (to_rep2 (first10 (mk5 f l))) f) (= (to_rep2 (last12 (mk5 f l))) l)))) :pattern ((mk5 f l)))))
...
(assert (forall ((s1 us_rep1)) (! (dynamic_invariant3 (last6 s1) true false true true) :pattern ((last6 s1)))))
(assert (forall ((attr__tag2 Int)) (forall ((s1 us_rep1)) (! (dynamic_invariant3 (last7 attr__tag2 s1) true false true true) :pattern ((last7 attr__tag2 s1))))))
(assert (forall ((s1 us_rep1)) (! (= (last6 s1) (last7 us_tag2 s1)) :pattern ((last7 us_tag2 s1)))))
(assert (forall ((s1 us_rep1)) (! (= (last6 s1) (ite (not (= (wraps_around s1) true)) (- (+ (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s1))) (to_rep1 (rec__stacks__stack_root__length1 (us_split_fields3 s1)))) 1) (- (- (+ (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s1))) (to_rep1 (rec__stacks__stack_root__length1 (us_split_fields3 s1)))) 1) 100))) :pattern ((last6 s1)))))
(declare-const temp___483 (Array Int element))
(declare-const temp___4831 t)
...
(define-fun temp___4832 () us_t (mk___t temp___483 temp___4831))
(assert (and (= o2 (is_empty s)) (= (= o2 true) (= (size s) 0))))
(assert (= result (ite (not (= o2 true)) true false)))
(assert (= result true))
(assert (and (= temp___4832 (get_model s)) (and (dynamic_invariant temp___4832 true false true true) (and (in_range1 (to_rep2 (first temp___4831))) (and (in_range1 (to_rep2 (last temp___4831))) (= (length temp___4832) (size s)))))))
(assert (and (= o3 (get_model s)) (and (dynamic_invariant o3 true false true true) (and (in_range1 (to_rep2 (first o1))) (and (in_range1 (to_rep2 (last o1))) (= (length o3) (size s)))))))
(assert (= temp___484 (to_rep2 (last o1))))
(assert (not (<= (to_rep2 (first temp___4831)) temp___484)))
(check-sat)
(exit)
