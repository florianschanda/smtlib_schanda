...
(assert (= result5 true))
(assert (and (= o7 (capacity (mk___rep3 p__split_discrs (us_split_fields__content3 p__split_fields2)))) (and (in_range8 o7) (= o7 (ite (= (distinct 1 0) true) (to_rep5 (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
