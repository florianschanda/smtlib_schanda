...
(assert (= result5 true))
(assert (and (= o7 (capacity (mk___rep3 p__split_discrs (us_split_fields__content3 p__split_fields2)))) (and (in_range8 o7) (= o7 (ite (= (of_int 1) true) (to_rep5 (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
(assert (= result6 (ite (= o7 (capacity (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields)))) true false)))
(assert (= result6 true))
(assert (and (= o6 (length1 (mk___rep3 p__split_discrs (us_split_fields__content3 p__split_fields2)))) (and (in_range8 o6) (<= o6 (capacity (mk___rep3 p__split_discrs (us_split_fields__content3 p__split_fields2)))))))
(assert (= result7 (ite (= o6 (length1 (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields)))) true false)))
(assert (= result7 true))
(assert (= (= result8 true) (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 5)) (= (has_key1 (model__ (mk___rep d__split_discrs (us_split_fields__content d__split_fields3))) (to_rep (select (map__content a2) j1))) true)))))
(assert (= result8 true))
...
(assert (= result9 true))
(assert (and (= o5 (key (mk___rep d__split_discrs (us_split_fields__content d__split_fields3)) c)) (and (in_range5 o5) (= o5 (get (keys (mk___rep d__split_discrs (us_split_fields__content d__split_fields3))) (get1 (positions (mk___rep d__split_discrs (us_split_fields__content d__split_fields3))) c))))))
