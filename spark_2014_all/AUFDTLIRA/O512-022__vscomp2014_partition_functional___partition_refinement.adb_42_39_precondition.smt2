...
(assert (and (= o107 (key (mk___rep d__split_discrs (us_split_fields__content d__split_fields3)) c9)) (and (in_range5 o107) (= o107 (get (keys (mk___rep d__split_discrs (us_split_fields__content d__split_fields3))) (get1 (positions (mk___rep d__split_discrs (us_split_fields__content d__split_fields3))) c9))))))
(assert (not (= (has_key (positions (mk___rep d__split_discrs (us_split_fields__content d__split_fields3))) c9) true)))
(check-sat)
(exit)
