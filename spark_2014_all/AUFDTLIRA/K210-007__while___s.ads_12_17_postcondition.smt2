...
(assert (= index1 1))
(assert (=> (<= index1 10) (and (and (= temp___152 found1) (and (= temp___151 index1) (and (not (= found2 true)) (and (and (=> (<= 1 10) (in_range2 index2)) (<= index2 10)) (or (and (and (and (= index2 index6) (= found3 found4)) (and (= index7 index2) (= found5 found3))) (and (= (to_rep (select table index2)) value) (and (= result2 found2) (= found3 (of_int 1))))) (and (and (not (= (to_rep (select table index2)) value)) (= found3 found2)) (and (and (and (= (mk_int__ref index6) (mk_int__ref index4)) (= found3 found4)) (and (= index7 index5) (= found5 found3))) (or (and (and (= index2 index4) (= index5 index2)) (= index2 10)) (and (not (= index2 10)) (and (and (= index3 index4) (= index5 index3)) (and (and (and (= o (+ index2 1)) (in_range2 (+ index2 1))) (and (= index2 result3) (= index3 o))) (not (<= index3 10))))))))))))) (and (and (= (mk_int__ref index10) (mk_int__ref index6)) (= (mk_bool__ref found8) (mk_bool__ref found4))) (and (= index11 index7) (= found9 found5))))))
(assert (=> (<= index1 10) (= (mk_int__ref index12) (mk_int__ref index10))))
(assert (=> (<= index1 10) (= (mk_bool__ref found10) (mk_bool__ref found8))))
(assert (=> (<= index1 10) (= index13 index11)))
(assert (=> (<= index1 10) (= found11 found9)))
(assert (=> (not (<= index1 10)) (= index1 index12)))
(assert (=> (not (<= index1 10)) (= found1 found10)))
(assert (=> (not (<= index1 10)) (= index13 index1)))
(assert (=> (not (<= index1 10)) (= found11 found1)))
(assert (= (mk_int__ref index14) (mk_int__ref index12)))
(assert (= (mk_bool__ref found12) (mk_bool__ref found10)))
(assert (= index15 index13))
(assert (= found13 found11))
(assert (not (or (not (= found12 true)) (= (to_rep (select table index14)) value))))
(check-sat)
(exit)
