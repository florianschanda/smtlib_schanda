...
(assert (= o5 p))
(assert (= (mk___rep1 (mk___split_fields1 o6 o7 o8 o9)) (select f_old__split_fields1 o5)))
(assert (= o6 o10))
(assert (= o7 o11))
(assert (= o8 o12))
(assert (= o9 o13))
...
(assert (= result4 (ite (= o15 2) true false)))
(assert (= result4 true))
(assert (and (= o18 p) (in_range1 p)))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o19 p) (in_range1 p)))
(assert (and (= o20 (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o19)) (and (dynamic_invariant3 o20 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o20 o19))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select o20 o19)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 o19)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select o20 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select o20 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select o20 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o20 i1))) true) (not (= i1 o19))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select o20 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1)))) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select o20 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select o20 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select o20 i1))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o20 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select o20 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select o20 j1)))) true)) (= j1 i1))))))))))))))
(assert (and (= o16 p) (in_range1 p)))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))) true))
(assert (and (= o17 p) (in_range1 p)))
(assert (not (= (valid_root (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) o17) true)))
(check-sat)
(exit)
