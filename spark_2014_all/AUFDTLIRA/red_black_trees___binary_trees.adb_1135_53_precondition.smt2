...
(assert (= result2 true))
(assert (and (= o13 p) (in_range1 p)))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o14 p) (in_range1 p)))
(assert (and (= o15 (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o14)) (and (dynamic_invariant3 o15 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o15 o14))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select o15 o14)))) 0) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= i o14)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select o15 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select o15 i))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select o15 i))) true)))))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o15 i))) true) (not (= i o14))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select o15 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i)))) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i) (rec__tree_model__path_type__a (us_split_fields1 (select o15 i)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select o15 i)))) 0)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select o15 i))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o15 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select o15 i))) (rec__tree_model__path_type__a (us_split_fields1 (select o15 j)))) true)) (= j i))))))))))))))
(assert (and (= o11 p) (in_range1 p)))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))) true))
(assert (and (= o12 p) (in_range1 p)))
(assert (not (= (valid_root (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) o12) true)))
(check-sat)
(exit)
