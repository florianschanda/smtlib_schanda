...
(assert (not (= (length temp___845) 0)))
(assert (=> (<= 1 1) (= o8 (+ (- 1 1) 1))))
(assert (=> (not (<= 1 1)) (= o8 0)))
(assert (=> (<= (to_rep1 (first (rt temp___845))) (to_rep1 (last (rt temp___845)))) (= o9 (+ (- (to_rep1 (last (rt temp___845))) (to_rep1 (first (rt temp___845)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt temp___845))) (to_rep1 (last (rt temp___845))))) (= o9 0)))
(assert (= o10 (+ o9 o8)))
(assert (= o11 (+ (to_rep1 (first (rt temp___845))) o10)))
(assert (= o12 (- o11 1)))
