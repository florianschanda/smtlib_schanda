...
(assert (not (= (length temp___837) 0)))
(assert (=> (<= 1 1) (= o15 (+ (- 1 1) 1))))
(assert (=> (not (<= 1 1)) (= o15 0)))
(assert (=> (<= (to_rep1 (first (rt temp___837))) (to_rep1 (last (rt temp___837)))) (= o16 (+ (- (to_rep1 (last (rt temp___837))) (to_rep1 (first (rt temp___837)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt temp___837))) (to_rep1 (last (rt temp___837))))) (= o16 0)))
(assert (= o17 (+ o16 o15)))
(assert (= o18 (+ (to_rep1 (first (rt temp___837))) o17)))
(assert (= o19 (- o18 1)))
