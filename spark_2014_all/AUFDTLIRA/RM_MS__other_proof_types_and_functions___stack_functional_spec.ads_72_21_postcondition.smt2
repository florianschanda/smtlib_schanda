...
(assert (= x3 x1))
(assert (not (= (count (state__2 (mk___split_fields my_stack__split_fields4 my_stack__split_fields5))) (- (count (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1))) 1))))
(check-sat)
(exit)
