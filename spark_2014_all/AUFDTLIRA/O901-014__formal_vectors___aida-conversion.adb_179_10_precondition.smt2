...
(assert (=> (and (<= temp___883 i1) (<= i1 (to_rep1 (last (rt source))))) (= temp___882 target4)))
(assert (=> (and (<= temp___883 i1) (<= i1 (to_rep1 (last (rt source))))) (= temp___881 i1)))
(assert (=> (and (<= temp___883 i1) (<= i1 (to_rep1 (last (rt source))))) (= temp___880 has_failed4)))
(assert (=> (and (<= temp___883 i1) (<= i1 (to_rep1 (last (rt source))))) (and (<= (to_rep1 (first (rt source))) i1) (<= i1 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= temp___883 i1) (<= i1 (to_rep1 (last (rt source))))) (= o3 i1)))
(assert (=> (and (<= temp___883 i1) (<= i1 (to_rep1 (last (rt source))))) (= o4 (select (elts source) o3))))
(assert (=> (and (<= temp___883 i1) (<= i1 (to_rep1 (last (rt source))))) (= o5 (to_rep o4))))
(assert (=> (and (<= temp___883 i1) (<= i1 (to_rep1 (last (rt source))))) (and (= o6 (is_digit o5)) (ite (= (= o5 48) true) (= o6 true) (ite (= (= o5 49) true) (= o6 true) (ite (= (= o5 50) true) (= o6 true) (ite (= (= o5 51) true) (= o6 true) (ite (= (= o5 52) true) (= o6 true) (ite (= (= o5 53) true) (= o6 true) (ite (= (= o5 54) true) (= o6 true) (ite (= (= o5 55) true) (= o6 true) (ite (= (= o5 56) true) (= o6 true) (ite (= (= o5 57) true) (= o6 true) (ite (= (> o5 57) true) (not (= o6 true)) (=> (= (< o5 48) true) (not (= o6 true)))))))))))))))))
(assert (=> (and (<= temp___883 i1) (<= i1 (to_rep1 (last (rt source))))) (= result2 (ite (not (= o6 true)) true false))))
(assert (=> (and (<= temp___883 i1) (<= i1 (to_rep1 (last (rt source))))) (not (= result2 true))))
(assert (=> (and (<= temp___883 i1) (<= i1 (to_rep1 (last (rt source))))) (= has_failed5 has_failed4)))
(assert (=> (and (<= temp___883 i1) (<= i1 (to_rep1 (last (rt source))))) (= target5 target4)))
(assert (=> (and (<= temp___883 i1) (<= i1 (to_rep1 (last (rt source))))) (forall ((j Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) j) (<= j i2)) (= (is_digit (to_rep (select (elts source) j))) true)))))
(assert (=> (and (<= temp___883 i1) (<= i1 (to_rep1 (last (rt source))))) (and (and (=> (<= (+ (to_rep1 (first (rt source))) 1) (to_rep1 (last (rt source)))) (dynamic_property1 (+ (to_rep1 (first (rt source))) 1) (to_rep1 (last (rt source))) i2)) (=> (<= (- 2147483648) 2147483647) (in_range1 target6))) (and (<= (+ (to_rep1 (first (rt source))) 1) i2) (<= i2 (to_rep1 (last (rt source))))))))
(assert (=> (and (<= temp___883 i1) (<= i1 (to_rep1 (last (rt source))))) (= i2 (to_rep1 (last (rt source))))))
(assert (=> (and (<= temp___883 i1) (<= i1 (to_rep1 (last (rt source))))) (= i3 (mk_int__ref i2))))
(assert (=> (and (<= temp___883 i1) (<= i1 (to_rep1 (last (rt source))))) (= has_failed7 (mk_bool__ref has_failed6))))
(assert (=> (and (<= temp___883 i1) (<= i1 (to_rep1 (last (rt source))))) (= target7 (mk_int__ref target6))))
(assert (=> (and (<= temp___883 i1) (<= i1 (to_rep1 (last (rt source))))) (= i4 i2)))
(assert (=> (and (<= temp___883 i1) (<= i1 (to_rep1 (last (rt source))))) (= has_failed8 has_failed6)))
(assert (=> (and (<= temp___883 i1) (<= i1 (to_rep1 (last (rt source))))) (= target8 target6)))
(assert (=> (and (<= temp___883 i1) (<= i1 (to_rep1 (last (rt source))))) (= i5 i3)))
(assert (=> (and (<= temp___883 i1) (<= i1 (to_rep1 (last (rt source))))) (= has_failed9 has_failed7)))
(assert (=> (and (<= temp___883 i1) (<= i1 (to_rep1 (last (rt source))))) (= target9 target7)))
(assert (=> (and (<= temp___883 i1) (<= i1 (to_rep1 (last (rt source))))) (= i6 i4)))
(assert (=> (and (<= temp___883 i1) (<= i1 (to_rep1 (last (rt source))))) (= has_failed10 has_failed8)))
(assert (=> (and (<= temp___883 i1) (<= i1 (to_rep1 (last (rt source))))) (= target10 target8)))
(assert (=> (not (and (<= temp___883 i1) (<= i1 (to_rep1 (last (rt source)))))) (= i5 (mk_int__ref i1))))
(assert (=> (not (and (<= temp___883 i1) (<= i1 (to_rep1 (last (rt source)))))) (= has_failed9 (mk_bool__ref has_failed4))))
(assert (=> (not (and (<= temp___883 i1) (<= i1 (to_rep1 (last (rt source)))))) (= target9 (mk_int__ref target4))))
(assert (=> (not (and (<= temp___883 i1) (<= i1 (to_rep1 (last (rt source)))))) (= i6 i1)))
(assert (=> (not (and (<= temp___883 i1) (<= i1 (to_rep1 (last (rt source)))))) (= has_failed10 has_failed4)))
(assert (=> (not (and (<= temp___883 i1) (<= i1 (to_rep1 (last (rt source)))))) (= target10 target4)))
