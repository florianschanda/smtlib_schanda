...
(assert (=> (and (<= temp___883 i4) (<= i4 (to_rep1 (last (rt source))))) (and (and (= temp___882 target4) (and (= temp___881 i4) (and (= temp___880 has_failed4) (and (and (and (and (and (and (and (and (<= (to_rep1 (first (rt source))) i4) (<= i4 (to_rep1 (last (rt source))))) (= o3 i4)) (= o4 (select (elts source) o3))) (= o5 (to_rep o4))) (and (= o6 (is_digit o5)) (ite (= (= o5 48) true) (= o6 true) (ite (= (= o5 49) true) (= o6 true) (ite (= (= o5 50) true) (= o6 true) (ite (= (= o5 51) true) (= o6 true) (ite (= (= o5 52) true) (= o6 true) (ite (= (= o5 53) true) (= o6 true) (ite (= (= o5 54) true) (= o6 true) (ite (= (= o5 55) true) (= o6 true) (ite (= (= o5 56) true) (= o6 true) (ite (= (= o5 57) true) (= o6 true) (ite (= (> o5 57) true) (not (= o6 true)) (=> (= (< o5 48) true) (not (= o6 true)))))))))))))))) (= result8 (ite (not (= o6 true)) true false))) (and (not (= result8 true)) (and (= has_failed5 has_failed4) (= target5 target4)))) (and (forall ((j2 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) j2) (<= j2 i5)) (= (is_digit (to_rep (select (elts source) j2))) true))) (and (and (and (=> (<= (+ (to_rep1 (first (rt source))) 1) (to_rep1 (last (rt source)))) (dynamic_property1 (+ (to_rep1 (first (rt source))) 1) (to_rep1 (last (rt source))) i5)) (=> (<= (- 2147483648) 2147483647) (in_range1 target6))) (and (<= (+ (to_rep1 (first (rt source))) 1) i5) (<= i5 (to_rep1 (last (rt source)))))) (= i5 (to_rep1 (last (rt source)))))))))) (and (and (= i11 (mk_int__ref i5)) (and (= has_failed12 (mk_bool__ref has_failed6)) (= target12 (mk_int__ref target6)))) (and (= i12 i5) (and (= has_failed13 has_failed6) (= target13 target6)))))))
(assert (=> (and (<= temp___883 i4) (<= i4 (to_rep1 (last (rt source))))) (= i13 i11)))
(assert (=> (and (<= temp___883 i4) (<= i4 (to_rep1 (last (rt source))))) (= has_failed14 has_failed12)))
(assert (=> (and (<= temp___883 i4) (<= i4 (to_rep1 (last (rt source))))) (= target14 target12)))
(assert (=> (and (<= temp___883 i4) (<= i4 (to_rep1 (last (rt source))))) (= i14 i12)))
(assert (=> (and (<= temp___883 i4) (<= i4 (to_rep1 (last (rt source))))) (= has_failed15 has_failed13)))
(assert (=> (and (<= temp___883 i4) (<= i4 (to_rep1 (last (rt source))))) (= target15 target13)))
(assert (=> (not (and (<= temp___883 i4) (<= i4 (to_rep1 (last (rt source)))))) (= i13 (mk_int__ref i4))))
(assert (=> (not (and (<= temp___883 i4) (<= i4 (to_rep1 (last (rt source)))))) (= has_failed14 (mk_bool__ref has_failed4))))
(assert (=> (not (and (<= temp___883 i4) (<= i4 (to_rep1 (last (rt source)))))) (= target14 (mk_int__ref target4))))
(assert (=> (not (and (<= temp___883 i4) (<= i4 (to_rep1 (last (rt source)))))) (= i14 i4)))
(assert (=> (not (and (<= temp___883 i4) (<= i4 (to_rep1 (last (rt source)))))) (= has_failed15 has_failed4)))
(assert (=> (not (and (<= temp___883 i4) (<= i4 (to_rep1 (last (rt source)))))) (= target15 target4)))
