...
(assert (< (length (rec__tree_model__path_type__a (us_split_fields1 (select r4 j9)))) 100))
(assert (= o52 (mk___rep (mk___split_fields (rec__tree_model__path_type__a (us_split_fields1 (select r4 j9))) (of_int 1)))))
(assert (and (<= 1 j9) (<= j9 100)))
(assert (= o53 j9))
(assert (= o54 (store r4 o53 o52)))
(assert (= result14 (mk_map__ref r4)))
(assert (= r5 o54))
(assert (not (<= 1 j9)))
(check-sat)
(exit)
