...
(assert (< (length (rec__tree_model__path_type__a (us_split_fields1 (select r4 j2)))) 100))
(assert (= o45 (mk___rep (mk___split_fields (rec__tree_model__path_type__a (us_split_fields1 (select r4 j2))) (distinct 1 0)))))
(assert (and (<= 1 j2) (<= j2 100)))
(assert (= o46 j2))
(assert (= o47 (store r4 o46 o45)))
(assert (= result12 (mk_map__ref r4)))
(assert (= r5 o47))
(assert (not (<= 1 j2)))
(check-sat)
(exit)
