...
(assert (< 0 j8))
(assert (and (= temp___300 (- j8 1)) (in_range1 (- j8 1))))
(assert (and (<= (to_rep a__first) temp___300) (<= temp___300 (to_rep a__last))))
(assert (= o35 temp___300))
(assert (= o36 (select a12 o35)))
(assert (= o37 (to_rep o36)))
(assert (and (= temp___299 (+ j8 1)) (in_range1 (+ j8 1))))
(assert (not (<= (to_rep a__first) temp___299)))
(check-sat)
(exit)
