...
(assert (< 0 j11))
(assert (and (= temp___270 (- j11 1)) (in_range1 (- j11 1))))
(assert (and (<= (to_rep a__first) temp___270) (<= temp___270 (to_rep a__last))))
(assert (= o64 temp___270))
(assert (= o65 (select a15 o64)))
(assert (= o66 (to_rep o65)))
(assert (and (= temp___269 (+ j11 1)) (in_range1 (+ j11 1))))
(assert (not (<= (to_rep a__first) temp___269)))
(check-sat)
(exit)
