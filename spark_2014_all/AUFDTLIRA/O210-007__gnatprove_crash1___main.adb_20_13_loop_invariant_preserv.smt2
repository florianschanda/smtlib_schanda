...
(assert (=> (= i2 (to_rep (last (rt (rec__main__branch_type__m_nodes branch__split_fields3))))) (= branch__split_discrs (mk___split_discrs temp___224))))
(assert (=> (= i2 (to_rep (last (rt (rec__main__branch_type__m_nodes branch__split_fields3))))) (= temp___2241 o9)))
(assert (=> (= i2 (to_rep (last (rt (rec__main__branch_type__m_nodes branch__split_fields3))))) (= temp___2242 o10)))
...
(assert (=> (= i2 (to_rep (last (rt (rec__main__branch_type__m_nodes branch__split_fields3))))) (= branch__split_fields4 (mk___split_fields (mk___t temp___2241 temp___2242)))))
(assert (=> (= i2 (to_rep (last (rt (rec__main__branch_type__m_nodes branch__split_fields3))))) (= branch__split_discrs (mk___split_discrs temp___224))))
