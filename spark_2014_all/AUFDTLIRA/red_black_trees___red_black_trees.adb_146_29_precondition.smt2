...
(assert (and (= o22 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j 0)) (and (in_range3 o22) (= o22 (peek1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) j 0)))))
(assert (= o23 (select res3 o22)))
(assert (= o24 (us_split_fields11 o23)))
(assert (= o25 (rec__red_black_trees__black_count__count o24)))
(assert (= o26 (to_rep o25)))
(assert (=> (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) j)) 0) (= o27 1)))
(assert (=> (not (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) j)) 0)) (= o27 0)))
(assert (= o28 (+ o27 o26)))
(assert (and (= o29 o28) (in_range1 o28)))
(assert (= o30 (ite (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res3 j)))) o29) true false)))
(assert (and (= o17 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j 1)) (and (in_range3 o17) (= o17 (peek1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) j 1)))))
