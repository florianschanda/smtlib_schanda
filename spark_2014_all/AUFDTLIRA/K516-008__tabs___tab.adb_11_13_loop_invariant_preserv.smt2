...
(assert (=> (< threshold (to_rep (select b i2))) (and (= o8 (+ cur2 1)) (in_range1 (+ cur2 1)))))
(assert (=> (< threshold (to_rep (select b i2))) (= cur2 result4)))
(assert (=> (< threshold (to_rep (select b i2))) (= cur3 o8)))
(assert (=> (< threshold (to_rep (select b i2))) (= (to_rep o9) (to_rep (select b i2)))))
(assert (=> (< threshold (to_rep (select b i2))) (and (<= 1 cur3) (<= cur3 10))))
(assert (=> (< threshold (to_rep (select b i2))) (= o10 cur3)))
(assert (=> (< threshold (to_rep (select b i2))) (= o11 (store a2 o10 o9))))
(assert (=> (< threshold (to_rep (select b i2))) (= a2 result5)))
(assert (=> (< threshold (to_rep (select b i2))) (= a3 o11)))
(assert (=> (not (< threshold (to_rep (select b i2)))) (= cur3 cur2)))
(assert (=> (not (< threshold (to_rep (select b i2)))) (= a3 a2)))
(assert (not (= i2 10)))
(assert (= result6 i2))
(assert (= i3 (+ i2 1)))
...
(assert (not (exists ((k1 Int)) (and (and (<= 1 k1) (<= k1 cur3)) (= (to_rep (select a3 k1)) (to_rep (select b j1)))))))
(check-sat)
(exit)
