...
(assert (and (= o14 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= o15 (ite (<= o14 j3) true false)))
(assert (= result8 (ite (= o15 true) (ite (<= j3 5) true false) false)))
(assert (= result8 true))
(assert (and (<= 0 j3) (<= j3 5)))
(assert (= o16 j3))
(assert (= o17 (select f o16)))
