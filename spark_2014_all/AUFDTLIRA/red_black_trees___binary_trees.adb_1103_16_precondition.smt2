...
(assert (and (= o32 r1) (in_range1 r1)))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))) true))
(assert (and (= o33 r1) (in_range1 r1)))
(assert (not (= (valid_root (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) o33) true)))
(check-sat)
(exit)
