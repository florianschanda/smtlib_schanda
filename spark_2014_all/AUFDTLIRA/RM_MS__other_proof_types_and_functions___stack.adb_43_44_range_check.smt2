...
(define-fun dynamic_invariant2 ((temp___expr_156 Int) (temp___is_init_153 Bool) (temp___skip_constant_154 Bool) (temp___do_toplevel_155 Bool)) Bool (=> (or (= temp___is_init_153 true) (<= 0 100)) (in_range1 temp___expr_156)))
(define-fun dynamic_invariant3 ((temp___expr_162 Int) (temp___is_init_159 Bool) (temp___skip_constant_160 Bool) (temp___do_toplevel_161 Bool)) Bool (=> (or (= temp___is_init_159 true) (<= 1 100)) (in_range3 temp___expr_162)))
(declare-const x Int)
...
(assert (= x1 o2))
(assert (not (in_range1 (- (to_rep1 my_stack__split_fields1) 1))))
(check-sat)
(exit)
