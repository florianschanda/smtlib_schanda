...
(assert (=> (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last))) (= (mk___private__ref vec6) (mk___private__ref vec4))))
(assert (=> (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last))) (= (mk___private__ref sp6) (mk___private__ref sp4))))
...
(assert (=> (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last))) (= (mk___private__ref vec8) (mk___private__ref vec6))))
(assert (=> (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last))) (= (mk___private__ref sp8) (mk___private__ref sp6))))
...
(assert (=> (not (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last)))) (= (mk___private__ref vec8) (mk___private__ref vec))))
(assert (=> (not (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last)))) (= (mk___private__ref sp8) (mk___private__ref sp))))
...
(assert (and (forall ((temp___166 Int)) (=> (and (<= (to_rep a__first) temp___166) (<= temp___166 (to_rep a__last))) (=> (<= j2 temp___166) (= (select a1 temp___166) (select a temp___166))))) (and (<= (to_rep a__first) j2) (<= j2 (to_rep a__last)))))
