...
(assert (and (forall ((temp___192 Int)) (=> (and (<= (to_rep a__first) temp___192) (<= temp___192 (to_rep a__last))) (=> (<= j2 temp___192) (= (select a1 temp___192) (select a temp___192))))) (and (<= (to_rep a__first) j2) (<= j2 (to_rep a__last)))))
