...
(assert (and (forall ((m Int)) (=> (and (<= (to_rep a_v2__first) m) (<= m k_2)) (= (to_rep (select a_v21 m)) (to_rep (select (elts b_v2) m))))) (forall ((m Int)) (=> (and (<= (+ k_2 1) m) (<= m (- i_v22 1))) (= (to_rep (select a_v21 m)) (to_rep (select (elts c_v2) (- m k_2))))))))
...
(assert (and (= temp___503 (- i_v22 k_2)) (in_range1 (- i_v22 k_2))))
(assert (and (<= (to_rep (first (rt c_v2))) temp___503) (<= temp___503 (to_rep (last (rt c_v2))))))
(assert (= o temp___503))
(assert (= o1 (select (elts c_v2) o)))
(assert (= o2 (to_rep o1)))
(assert (= (to_rep o3) o2))
(assert (not (<= (to_rep a_v2__first) i_v22)))
(check-sat)
(exit)
