...
(assert (<= 1 i14))
(assert (<= i14 100))
(assert (or (= (parent (rec__red_black_trees__rbt__struct t__split_fields27) i14) 0) (= (to_rep3 (select (rec__red_black_trees__rbt__color t__split_fields27) (parent (rec__red_black_trees__rbt__struct t__split_fields27) i14))) 1)))
