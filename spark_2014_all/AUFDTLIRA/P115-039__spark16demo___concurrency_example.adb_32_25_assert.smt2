...
(assert (= value1 data))
(assert (=> (= (bool_eq4 value1 1 1000 all_zeroes 1 1000) true) (= (temp___String_Literal_1764 Tuple0) o1)))
(assert (=> (= (bool_eq4 value1 1 1000 all_zeroes 1 1000) true) (= (mk 1 10) o2)))
(assert (=> (not (= (bool_eq4 value1 1 1000 all_zeroes 1 1000) true)) (=> (= (bool_eq4 value1 1 1000 all_ones 1 1000) true) (= (temp___String_Literal_1765 Tuple0) o1))))
(assert (=> (not (= (bool_eq4 value1 1 1000 all_zeroes 1 1000) true)) (=> (= (bool_eq4 value1 1 1000 all_ones 1 1000) true) (= (mk 1 8) o2))))
(assert (=> (not (= (bool_eq4 value1 1 1000 all_zeroes 1 1000) true)) (=> (not (= (bool_eq4 value1 1 1000 all_ones 1 1000) true)) (= (temp___String_Literal_1766 Tuple0) o1))))
