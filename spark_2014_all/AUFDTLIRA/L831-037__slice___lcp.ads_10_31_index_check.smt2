...
(assert (= r6b9 r6b7))
(assert (= l9 l7))
(assert (and (= o31 (+ y (int__content lcp__result4))) (in_range1 (+ y (int__content lcp__result4)))))
(assert (= o32 (- o31 1)))
...
(assert (and (= o34 (+ x (int__content lcp__result4))) (in_range1 (+ x (int__content lcp__result4)))))
(assert (= o35 (- o34 1)))
...
(assert (= result12 (bool_eq temp___180 (to_rep (first2 temp___1801)) (to_rep (last2 temp___1801)) temp___181 (to_rep (first4 temp___1811)) (to_rep (last4 temp___1811)))))
(assert (= result12 true))
(assert (and (= o29 (+ (to_rep (last (rt a))) 1)) (in_range1 (+ (to_rep (last (rt a))) 1))))
(assert (and (= o30 (+ x (int__content lcp__result4))) (in_range1 (+ x (int__content lcp__result4)))))
(assert (= result14 (ite (= o30 o29) true false)))
(assert (=> (= result14 true) (= result13 true)))
(assert (=> (not (= result14 true)) (and (= o27 (+ (to_rep (last (rt a))) 1)) (in_range1 (+ (to_rep (last (rt a))) 1)))))
(assert (=> (not (= result14 true)) (and (= o28 (+ y (int__content lcp__result4))) (in_range1 (+ y (int__content lcp__result4))))))
(assert (=> (not (= result14 true)) (= result13 (ite (= o28 o27) true false))))
