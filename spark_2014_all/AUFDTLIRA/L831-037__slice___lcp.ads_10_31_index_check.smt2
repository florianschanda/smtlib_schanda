...
(assert (= o32 (- o31 1)))
(assert (and (= temp___204 o32) (in_range1 o32)))
...
(assert (and (= temp___202 (+ y (int__content lcp__result4))) (in_range1 (+ y (int__content lcp__result4)))))
(assert (and (<= (to_rep (first (rt a))) temp___202) (<= temp___202 (to_rep (last (rt a))))))
(assert (= o24 temp___202))
(assert (= o25 (select (elts a) o24)))
(assert (= o26 (to_rep o25)))
(assert (and (= temp___201 (+ x (int__content lcp__result4))) (in_range1 (+ x (int__content lcp__result4)))))
(assert (not (<= (to_rep (first (rt a))) temp___201)))
(check-sat)
(exit)
