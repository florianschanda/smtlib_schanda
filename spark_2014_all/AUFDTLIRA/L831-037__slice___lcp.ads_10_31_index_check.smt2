...
(assert (= r6b12 r6b10))
(assert (= l11 l9))
(assert (and (= o41 (+ y (int__content lcp__result4))) (in_range1 (+ y (int__content lcp__result4)))))
(assert (= o42 (- o41 1)))
(assert (and (= temp___179 o42) (in_range1 o42)))
(assert (=> (<= y temp___179) (and (and (<= (to_rep (first (rt a))) y) (<= y (to_rep (last (rt a))))) (and (<= (to_rep (first (rt a))) temp___179) (<= temp___179 (to_rep (last (rt a))))))))
(assert (= o43 (elts a)))
(assert (= o43 temp___181))
(assert (= (mk2 y temp___179) temp___1811))
(assert (and (= o44 (+ x (int__content lcp__result4))) (in_range1 (+ x (int__content lcp__result4)))))
(assert (= o45 (- o44 1)))
(assert (and (= temp___178 o45) (in_range1 o45)))
(assert (=> (<= x temp___178) (and (and (<= (to_rep (first (rt a))) x) (<= x (to_rep (last (rt a))))) (and (<= (to_rep (first (rt a))) temp___178) (<= temp___178 (to_rep (last (rt a))))))))
(assert (= o46 (elts a)))
(assert (= o46 temp___180))
(assert (= (mk1 x temp___178) temp___1801))
(assert (= result14 (bool_eq temp___180 (to_rep (first2 temp___1801)) (to_rep (last2 temp___1801)) temp___181 (to_rep (first4 temp___1811)) (to_rep (last4 temp___1811)))))
(assert (= result14 true))
(assert (and (= o39 (+ (to_rep (last (rt a))) 1)) (in_range1 (+ (to_rep (last (rt a))) 1))))
(assert (and (= o40 (+ x (int__content lcp__result4))) (in_range1 (+ x (int__content lcp__result4)))))
(assert (= result16 (ite (= o40 o39) true false)))
(assert (=> (= result16 true) (= result15 true)))
(assert (=> (not (= result16 true)) (and (= o37 (+ (to_rep (last (rt a))) 1)) (in_range1 (+ (to_rep (last (rt a))) 1)))))
(assert (=> (not (= result16 true)) (and (= o38 (+ y (int__content lcp__result4))) (in_range1 (+ y (int__content lcp__result4))))))
(assert (=> (not (= result16 true)) (= result15 (ite (= o38 o37) true false))))
(assert (not (= result15 true)))
(assert (and (= temp___177 (+ y (int__content lcp__result4))) (in_range1 (+ y (int__content lcp__result4)))))
(assert (and (<= (to_rep (first (rt a))) temp___177) (<= temp___177 (to_rep (last (rt a))))))
(assert (= o34 temp___177))
(assert (= o35 (select (elts a) o34)))
(assert (= o36 (to_rep o35)))
(assert (and (= temp___176 (+ x (int__content lcp__result4))) (in_range1 (+ x (int__content lcp__result4)))))
(assert (not (<= (to_rep (first (rt a))) temp___176)))
(check-sat)
(exit)
