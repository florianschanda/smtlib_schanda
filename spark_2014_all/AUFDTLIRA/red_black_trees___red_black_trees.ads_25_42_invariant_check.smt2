...
(define-fun dynamic_invariant1 ((temp___expr_270 Int) (temp___is_init_266 Bool) (temp___skip_constant_267 Bool) (temp___do_toplevel_268 Bool) (temp___do_typ_inv_269 Bool)) Bool (=> (or (= temp___is_init_266 true) (<= 0 2147483647)) (in_range2 temp___expr_270)))
...
(assert (forall ((container us_rep)) (forall ((item Int)) (! (=> (dynamic_invariant1 item true true true true) (=> (= (distinct 1 0) true) (=> (exists ((e Int)) (and (and (in_range2 e) (= (contains container e) true)) (= e item))) (= (contains container item) true)))) :pattern ((contains container item))))))
...
(assert (forall ((t us_rep3)) (forall ((v Int)) (! (=> (and (dynamic_invariant2 t true true true true) (dynamic_invariant v true true true true)) (= (= (contains1 t v) true) (= (contains (values t) v) true))) :pattern ((contains1 t v))))))
...
(define-fun dynamic_invariant6 ((temp___expr_177 Int) (temp___is_init_173 Bool) (temp___skip_constant_174 Bool) (temp___do_toplevel_175 Bool) (temp___do_typ_inv_176 Bool)) Bool (=> (or (= temp___is_init_173 true) (<= 1 100)) (in_range5 temp___expr_177)))
(define-fun dynamic_invariant7 ((temp___expr_191 Int) (temp___is_init_187 Bool) (temp___skip_constant_188 Bool) (temp___do_toplevel_189 Bool) (temp___do_typ_inv_190 Bool)) Bool (=> (or (= temp___is_init_187 true) (<= 0 2)) (in_range4 temp___expr_191)))
...
(define-fun dynamic_invariant8 ((temp___expr_198 Int) (temp___is_init_194 Bool) (temp___skip_constant_195 Bool) (temp___do_toplevel_196 Bool) (temp___do_typ_inv_197 Bool)) Bool (=> (or (= temp___is_init_194 true) (<= 0 1)) (in_range7 temp___expr_198)))
(declare-fun length (us_rep6) Int)
(declare-fun length__function_guard (Int us_rep6) Bool)
(define-fun dynamic_invariant9 ((temp___expr_241 us_rep7) (temp___is_init_237 Bool) (temp___skip_constant_238 Bool) (temp___do_toplevel_239 Bool) (temp___do_typ_inv_240 Bool)) Bool (=> (= temp___do_toplevel_239 true) (=> (= temp___is_init_237 true) (< (length (rec__tree_model__path_type__a (us_split_fields11 temp___expr_241))) 100))))
(define-fun default_initial_assumption4 ((temp___expr_243 us_rep7) (temp___skip_top_level_244 Bool)) Bool (and (= (length (rec__tree_model__path_type__a (us_split_fields11 temp___expr_243))) 0) (= (rec__tree_model__path_type__k (us_split_fields11 temp___expr_243)) (distinct 0 0))))
(define-fun dynamic_predicate ((temp___247 us_rep7)) Bool (< (length (rec__tree_model__path_type__a (us_split_fields11 temp___247))) 100))
(define-fun dynamic_invariant10 ((temp___expr_253 (Array Int us_rep7)) (temp___is_init_249 Bool) (temp___skip_constant_250 Bool) (temp___do_toplevel_251 Bool) (temp___do_typ_inv_252 Bool)) Bool (forall ((temp___254 Int)) (=> (and (<= 1 temp___254) (<= temp___254 100)) (=> (= temp___is_init_249 true) (< (length (rec__tree_model__path_type__a (us_split_fields11 (select temp___expr_253 temp___254)))) 100)))))
(define-fun default_initial_assumption5 ((temp___expr_256 (Array Int us_rep7)) (temp___skip_top_level_257 Bool)) Bool (forall ((temp___258 Int)) (=> (and (<= 1 temp___258) (<= temp___258 100)) (and (= (length (rec__tree_model__path_type__a (us_split_fields11 (select temp___expr_256 temp___258)))) 0) (= (rec__tree_model__path_type__k (us_split_fields11 (select temp___expr_256 temp___258))) (distinct 0 0))))))
...
(define-fun olt ((left us_rep6) (right us_rep6)) Bool (and (< (length left) (length right)) (ite (forall ((n Int)) (=> (and (<= 1 n) (<= n (last left))) (= (get left n) (get right n)))) true false)))
...
(define-fun oeq ((left us_rep6) (right us_rep6)) Bool (and (= (length left) (length right)) (ite (forall ((n Int)) (=> (and (<= 1 n) (<= n (last left))) (= (get left n) (get right n)))) true false)))
...
(define-fun default_initial_assumption6 ((temp___expr_234 us_rep6) (temp___skip_top_level_235 Bool)) Bool (=> (not (= temp___skip_top_level_235 true)) (= (length temp___expr_234) 0)))
(assert true)
(assert (forall ((s1 us_rep6) (s2 us_rep6)) (forall ((d Int)) (! (= (= (is_add s1 d s2) true) (and (and (= (- (length s2) 1) (length s1)) (= (olt s1 s2) true)) (= (get s2 (length s2)) d))) :pattern ((is_add s1 d s2))))))
...
(define-fun dynamic_invariant11 ((temp___expr_170 Int) (temp___is_init_166 Bool) (temp___skip_constant_167 Bool) (temp___do_toplevel_168 Bool) (temp___do_typ_inv_169 Bool)) Bool (=> (or (= temp___is_init_166 true) (<= 0 2147483647)) (in_range8 temp___expr_170)))
(assert (forall ((t1 us_rep3)) (! (=> (dynamic_invariant2 t1 true true true true) (dynamic_invariant4 (size1 t1) true false true true)) :pattern ((size1 t1)))))
(assert (forall ((t1 us_rep3)) (! (=> (dynamic_invariant2 t1 true true true true) (= (size1 t1) (size (rec__search_trees__search_tree__struct (us_split_fields5 t1))))) :pattern ((size1 t1)))))
(declare-fun parent1 (us_rep2 Int) Int)
(declare-fun parent__function_guard1 (Int us_rep2 Int) Bool)
(assert (forall ((t1 us_rep3)) (forall ((i Int)) (! (=> (and (dynamic_invariant2 t1 true true true true) (dynamic_invariant6 i true true true true)) (let ((result (parent t1 i))) (and (=> (= (size1 t1) 0) (= result 0)) (dynamic_invariant4 result true false true true)))) :pattern ((parent t1 i))))))
(assert (forall ((t1 us_rep3)) (forall ((i Int)) (! (=> (and (dynamic_invariant2 t1 true true true true) (dynamic_invariant6 i true true true true)) (= (parent t1 i) (parent1 (rec__search_trees__search_tree__struct (us_split_fields5 t1)) i))) :pattern ((parent t1 i))))))
...
(assert (forall ((t1 us_rep3)) (! (=> (and (dynamic_invariant2 t1 true true true true) (not (= (size1 t1) 0))) (dynamic_invariant10 (model__ t1) true false true true)) :pattern ((model__ t1)))))
(assert (forall ((t1 us_rep3)) (! (=> (dynamic_invariant2 t1 true true true true) (= (model__ t1) (model__1 (rec__search_trees__search_tree__struct (us_split_fields5 t1)) (to_rep (rec__search_trees__search_tree__root (us_split_fields5 t1)))))) :pattern ((model__ t1)))))
(declare-fun peek1 (us_rep2 Int Int) Int)
(declare-fun peek__function_guard1 (Int us_rep2 Int Int) Bool)
(assert (forall ((t1 us_rep3)) (forall ((i Int) (d Int)) (! (=> (and (and (and (dynamic_invariant2 t1 true true true true) (dynamic_invariant6 i true true true true)) (dynamic_invariant8 d true true true true)) (and (not (= (size1 t1) 0)) (= (rec__tree_model__path_type__k (us_split_fields11 (let ((temp___466 (model__ t1))) (select temp___466 i)))) true))) (dynamic_invariant4 (peek t1 i d) true false true true)) :pattern ((peek t1 i d))))))
(assert (forall ((t1 us_rep3)) (forall ((i Int) (d Int)) (! (=> (and (and (dynamic_invariant2 t1 true true true true) (dynamic_invariant6 i true true true true)) (dynamic_invariant8 d true true true true)) (= (peek t1 i d) (peek1 (rec__search_trees__search_tree__struct (us_split_fields5 t1)) i d))) :pattern ((peek t1 i d))))))
(assert (forall ((t1 us_rep3)) (! (=> (dynamic_invariant2 t1 true true true true) (=> (= (size1 t1) 0) (= (is_empty (values t1)) true))) :pattern ((values t1)))))
...
(define-fun dynamic_invariant12 ((temp___expr_317 us_rep2) (temp___is_init_313 Bool) (temp___skip_constant_314 Bool) (temp___do_toplevel_315 Bool) (temp___do_typ_inv_316 Bool)) Bool (=> (= temp___do_typ_inv_316 true) (= (tree_structure temp___expr_317) true)))
...
(assert true)
(assert (forall ((f us_rep2)) (! (=> (dynamic_invariant12 f true true true true) (dynamic_invariant4 (size f) true false true true)) :pattern ((size f)))))
(assert (forall ((f us_rep2)) (forall ((i Int)) (! (=> (and (dynamic_invariant12 f true true true true) (dynamic_invariant6 i true true true true)) (=> (< (size f) i) (not (= (valid_root f i) true)))) :pattern ((valid_root f i))))))
(assert (forall ((f us_rep2)) (forall ((i Int)) (! (=> (and (dynamic_invariant12 f true true true true) (dynamic_invariant6 i true true true true)) (let ((result (parent1 f i))) (and (and (=> (= (valid_root f i) true) (= result 0)) (=> (= (size f) 0) (= result 0))) (dynamic_invariant4 result true false true true)))) :pattern ((parent1 f i))))))
(declare-fun position (us_rep2 Int) Int)
(declare-fun position__function_guard (Int us_rep2 Int) Bool)
(assert (forall ((f us_rep2)) (forall ((i Int)) (! (=> (and (and (dynamic_invariant12 f true true true true) (dynamic_invariant6 i true true true true)) (not (= (parent1 f i) 0))) (dynamic_invariant8 (position f i) true false true true)) :pattern ((position f i))))))
(assert (forall ((f us_rep2)) (forall ((i Int) (d Int)) (! (=> (and (and (dynamic_invariant12 f true true true true) (dynamic_invariant6 i true true true true)) (dynamic_invariant8 d true true true true)) (let ((result (peek1 f i d))) (and (and (ite (not (= result 0)) (and (= (position f result) d) (= (parent1 f result) i)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (parent1 f j) i) (not (= (position f j) d)))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (parent1 f j) i) (= (position f j) d)) (= result j))))) (dynamic_invariant4 result true false true true)))) :pattern ((peek1 f i d))))))
(assert (forall ((f us_rep2)) (forall ((root Int)) (! (=> (and (and (dynamic_invariant12 f true true true true) (dynamic_invariant6 root true true true true)) (= (valid_root f root) true)) (let ((result (model__1 f root))) (and (and (= (rec__tree_model__path_type__k (us_split_fields11 (select result root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields11 (select result root)))) 0) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= i root)) (ite (and (not (= (parent1 f i) 0)) (= (rec__tree_model__path_type__k (us_split_fields11 (select result (parent1 f i)))) true)) (= (rec__tree_model__path_type__k (us_split_fields11 (select result i))) true) (not (= (rec__tree_model__path_type__k (us_split_fields11 (select result i))) true)))))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields11 (select result i))) true) (not (= i root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields11 (select result (parent1 f i)))) (position f i) (rec__tree_model__path_type__a (us_split_fields11 (select result i)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields11 (select result i)))) 0)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields11 (select result i))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields11 (select result j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields11 (select result i))) (rec__tree_model__path_type__a (us_split_fields11 (select result j)))) true)) (= j i))))))))))) (dynamic_invariant10 result true false true true)))) :pattern ((model__1 f root))))))
...
(define-fun dynamic_invariant13 ((temp___expr_226 Int) (temp___is_init_222 Bool) (temp___skip_constant_223 Bool) (temp___do_toplevel_224 Bool) (temp___do_typ_inv_225 Bool)) Bool (=> (or (= temp___is_init_222 true) (<= 0 2147483647)) (in_range9 temp___expr_226)))
(assert (forall ((container us_rep6)) (! (let ((result (length container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant11 result true false true true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant14 ((temp___expr_219 Int) (temp___is_init_215 Bool) (temp___skip_constant_216 Bool) (temp___do_toplevel_217 Bool) (temp___do_typ_inv_218 Bool)) Bool (=> (or (= temp___is_init_215 true) (<= 0 1)) (in_range10 temp___expr_219)))
(assert (forall ((container us_rep6)) (forall ((position1 Int)) (! (=> (and (dynamic_invariant13 position1 true true true true) (and (<= 1 position1) (<= position1 (last container)))) (dynamic_invariant14 (get container position1) true false true true)) :pattern ((get container position1))))))
(declare-fun length1 (us_rep) Int)
(declare-fun length__function_guard1 (Int us_rep) Bool)
(assert (forall ((container us_rep)) (! (dynamic_invariant11 (length1 container) true false true true) :pattern ((length1 container)))))
(assert (forall ((container us_rep)) (! (let ((result (is_empty container))) (and (= (= result true) (forall ((item Int)) (not (and (in_range2 item) (= (contains container item) true))))) (= (= result true) (= (length1 container) 0)))) :pattern ((is_empty container)))))
(declare-const red_black_trees__contains__result Bool)
(declare-const o Bool)
(declare-const result Bool)
(declare-const red_black_trees__contains__result1 Bool)
(declare-const red_black_trees__contains__result2 Bool)
(declare-const red_black_trees__contains__result3 Bool)
(declare-const red_black_trees__contains__result4 Bool)
(declare-const red_black_trees__contains__result5 Bool)
(assert (dynamic_invariant3 t true false true true))
(assert (in_range1 v))
(assert (= (invariant__ t) true))
(assert (= red_black_trees__contains__result1 red_black_trees__contains__result2))
(assert (= red_black_trees__contains__result3 red_black_trees__contains__result1))
(assert (and (= o (contains1 (rec__red_black_trees__rbt__struct (us_split_fields7 t)) v)) (= (= o true) (= (contains (values (rec__red_black_trees__rbt__struct (us_split_fields7 t))) v) true))))
(assert (= (mk_bool__ref result) (mk_bool__ref red_black_trees__contains__result)))
(assert (= red_black_trees__contains__result1 o))
(assert (= (mk_bool__ref red_black_trees__contains__result4) (mk_bool__ref red_black_trees__contains__result2)))
(assert (= red_black_trees__contains__result5 red_black_trees__contains__result3))
