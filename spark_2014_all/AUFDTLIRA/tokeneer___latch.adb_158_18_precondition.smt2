...
(define-fun dynamic_invariant ((temp___expr_833 Int) (temp___is_init_830 Bool) (temp___skip_constant_831 Bool) (temp___do_toplevel_832 Bool)) Bool (=> (or (= temp___is_init_830 true) (<= 0 1)) (in_range4 temp___expr_833)))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_842 us_void_param) 1)) 76) (= (to_rep (select (temp___String_Literal_842 us_void_param) 2)) 65)) (= (to_rep (select (temp___String_Literal_842 us_void_param) 3)) 84)) (= (to_rep (select (temp___String_Literal_842 us_void_param) 4)) 67)) (= (to_rep (select (temp___String_Literal_842 us_void_param) 5)) 72)) (= (to_rep (select (temp___String_Literal_842 us_void_param) 6)) 32)) (= (to_rep (select (temp___String_Literal_842 us_void_param) 7)) 83)) (= (to_rep (select (temp___String_Literal_842 us_void_param) 8)) 84)) (= (to_rep (select (temp___String_Literal_842 us_void_param) 9)) 65)) (= (to_rep (select (temp___String_Literal_842 us_void_param) 10)) 84)) (= (to_rep (select (temp___String_Literal_842 us_void_param) 11)) 69)) (= (to_rep (select (temp___String_Literal_842 us_void_param) 12)) 32)) (= (to_rep (select (temp___String_Literal_842 us_void_param) 13)) 67)) (= (to_rep (select (temp___String_Literal_842 us_void_param) 14)) 65)) (= (to_rep (select (temp___String_Literal_842 us_void_param) 15)) 78)) (= (to_rep (select (temp___String_Literal_842 us_void_param) 16)) 78)) (= (to_rep (select (temp___String_Literal_842 us_void_param) 17)) 79)) (= (to_rep (select (temp___String_Literal_842 us_void_param) 18)) 84)) (= (to_rep (select (temp___String_Literal_842 us_void_param) 19)) 32)) (= (to_rep (select (temp___String_Literal_842 us_void_param) 20)) 66)) (= (to_rep (select (temp___String_Literal_842 us_void_param) 21)) 69)) (= (to_rep (select (temp___String_Literal_842 us_void_param) 22)) 32)) (= (to_rep (select (temp___String_Literal_842 us_void_param) 23)) 68)) (= (to_rep (select (temp___String_Literal_842 us_void_param) 24)) 69)) (= (to_rep (select (temp___String_Literal_842 us_void_param) 25)) 84)) (= (to_rep (select (temp___String_Literal_842 us_void_param) 26)) 69)) (= (to_rep (select (temp___String_Literal_842 us_void_param) 27)) 82)) (= (to_rep (select (temp___String_Literal_842 us_void_param) 28)) 77)) (= (to_rep (select (temp___String_Literal_842 us_void_param) 29)) 73)) (= (to_rep (select (temp___String_Literal_842 us_void_param) 30)) 78)) (= (to_rep (select (temp___String_Literal_842 us_void_param) 31)) 69)) (= (to_rep (select (temp___String_Literal_842 us_void_param) 32)) 68)) (= (to_rep (select (temp___String_Literal_842 us_void_param) 33)) 46)) :pattern ((temp___String_Literal_842 us_void_param)))))
