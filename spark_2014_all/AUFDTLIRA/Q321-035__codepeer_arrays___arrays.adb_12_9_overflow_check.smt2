...
(assert (and (<= 1 temp___207) (<= temp___207 10)))
(assert (= o2 temp___207))
(assert (= o3 (store a2 o2 rliteral2)))
(assert (= result3 a2))
(assert (= a3 o3))
(assert (and (= o4 (+ y1 5)) (in_range (+ y1 5))))
(assert (= result4 y1))
(assert (= y2 o4))
(assert (and (<= 1 y2) (<= y2 10)))
(assert (= o5 y2))
(assert (= o6 (store a3 o5 rliteral1)))
(assert (= result5 a3))
(assert (= a4 o6))
(assert (not (in_range (+ y2 1))))
(check-sat)
(exit)
