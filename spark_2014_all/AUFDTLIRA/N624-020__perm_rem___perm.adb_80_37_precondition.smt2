...
(assert (and (= o1 (to_rep (first (rt b)))) (in_range3 (to_rep (first (rt b))))))
(assert (and (= o4 (remove b o1)) (and (dynamic_invariant o4 true false true true) (and (= (invariant__ o4) true) (and (= (to_rep (last o3)) (- (to_rep (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o1 1))) (= (to_rep1 (select (elts b) k)) (to_rep1 (select o2 k))))) (and (forall ((k Int)) (=> (and (<= (+ o1 1) k) (<= k (to_rep (last (rt b))))) (= (to_rep1 (select (elts b) k)) (to_rep1 (select o2 (- k 1)))))) (forall ((k Int)) (=> (and (<= o1 k) (<= k (- (to_rep (last (rt b))) 1))) (= (to_rep1 (select (elts b) (+ k 1))) (to_rep1 (select o2 k))))))))))))
(assert (and (= o (to_rep (first (rt a)))) (in_range3 (to_rep (first (rt a))))))
(assert (not (<= (to_rep (first (rt a))) o)))
(check-sat)
(exit)
