...
(assert (and (= o1 (to_rep1 (first (rt b)))) (in_range2 (to_rep1 (first (rt b))))))
(assert (and (= o4 (remove b o1)) (and (dynamic_invariant1 o4 true false true true) (and (= (invariant__ o4) true) (and (= (to_rep1 (last o3)) (- (to_rep1 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o1 1))) (= (to_rep (select (elts b) k)) (to_rep (select o2 k))))) (and (forall ((k Int)) (=> (and (<= (+ o1 1) k) (<= k (to_rep1 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select o2 (- k 1)))))) (forall ((k Int)) (=> (and (<= o1 k) (<= k (- (to_rep1 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o2 k))))))))))))
