...
(assert (= j8 i))
(assert (=> (and (<= i j8) (<= j8 1001)) (= temp___249 tmp6)))
(assert (=> (and (<= i j8) (<= j8 1001)) (= temp___248 j8)))
...
(assert (=> (and (<= i j8) (<= j8 1001)) (and (and (=> (<= i 1001) (dynamic_property1 i 1001 j9)) (forall ((temp___250 Int)) (=> (and (<= 0 temp___250) (<= temp___250 1001)) (=> (< j9 temp___250) (= (select tmp9 temp___250) (select temp___249 temp___250)))))) (and (<= i j9) (<= j9 1001)))))
