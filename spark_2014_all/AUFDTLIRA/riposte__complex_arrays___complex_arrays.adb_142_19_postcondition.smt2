...
(assert (= j11 i))
(assert (=> (and (<= i j11) (<= j11 1001)) (and (and (= temp___249 tmp9) (and (= temp___248 j11) (and (and (and (= (to_rep o4) 69) (= o5 (store tmp9 j11 o4))) (and (= (mk_map__ref result6) (mk_map__ref tmp9)) (= tmp11 o5))) (and (forall ((k2 Int)) (=> (and (<= 0 k2) (<= k2 j12)) (and (=> (< k2 i) (= (to_rep (select tmp12 k2)) (- 23))) (=> (<= i k2) (= (to_rep (select tmp12 k2)) 69))))) (and (and (and (=> (<= i 1001) (dynamic_property1 i 1001 j12)) (forall ((temp___250 Int)) (=> (and (<= 0 temp___250) (<= temp___250 1001)) (=> (< j12 temp___250) (= (select tmp12 temp___250) (select temp___249 temp___250)))))) (and (<= i j12) (<= j12 1001))) (= j12 1001)))))) (and (and (= j18 (mk_int__ref j12)) (= tmp18 (mk_map__ref tmp12))) (and (= j19 j12) (= tmp19 tmp12))))))
(assert (=> (and (<= i j11) (<= j11 1001)) (= j20 j18)))
(assert (=> (and (<= i j11) (<= j11 1001)) (= tmp20 tmp18)))
(assert (=> (and (<= i j11) (<= j11 1001)) (= j21 j19)))
(assert (=> (and (<= i j11) (<= j11 1001)) (= tmp21 tmp19)))
(assert (=> (not (and (<= i j11) (<= j11 1001))) (= j20 (mk_int__ref j11))))
(assert (=> (not (and (<= i j11) (<= j11 1001))) (= tmp20 (mk_map__ref tmp9))))
(assert (=> (not (and (<= i j11) (<= j11 1001))) (= j21 j11)))
(assert (=> (not (and (<= i j11) (<= j11 1001))) (= tmp21 tmp10)))
...
(assert (= result9 (mk_map__ref complex_arrays__create_step_array__result)))
(assert (= complex_arrays__create_step_array__result1 (map__content tmp20)))
(assert (= complex_arrays__create_step_array__result4 complex_arrays__create_step_array__result2))
(assert (= j23 j20))
(assert (= j22 (mk_int__ref j9)))
(assert (= tmp22 tmp20))
(assert (= complex_arrays__create_step_array__result5 complex_arrays__create_step_array__result3))
(assert (= j25 j21))
(assert (= j24 j10))
(assert (= tmp23 tmp21))
(assert (= result10 (map__content complex_arrays__create_step_array__result4)))
(declare-const j26 Int)
(assert (<= 0 j26))
(assert (<= j26 1001))
(assert (< j26 i))
(assert (not (= (to_rep (select (map__content complex_arrays__create_step_array__result4) j26)) (- 23))))
(check-sat)
(exit)
