...
(declare-fun temp___5482 ((Array Int (Array Int (Array Int et1))) Int (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1))))
(declare-fun temp___5488 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
(declare-fun temp___5494 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___5484 (Array Int (Array Int (Array Int et1))))) (forall ((temp___5485 Int)) (forall ((temp___5486 (Array Int (Array Int et1)))) (let ((temp___5483 (temp___5482 temp___5484 temp___5485 temp___5486))) (=> (dynamic_invariant2 temp___5485 true true true true) (forall ((temp___5487 Int)) (ite (= temp___5487 temp___5485) (= (select temp___5483 temp___5487) temp___5486) (= (select temp___5483 temp___5487) (select temp___5484 temp___5487))))))))))
(assert (forall ((temp___5490 (Array Int (Array Int et1)))) (forall ((temp___5491 Int)) (forall ((temp___5492 (Array Int et1))) (let ((temp___5489 (temp___5488 temp___5490 temp___5491 temp___5492))) (=> (dynamic_invariant1 temp___5491 true true true true) (forall ((temp___5493 Int)) (ite (= temp___5493 temp___5491) (= (select temp___5489 temp___5493) temp___5492) (= (select temp___5489 temp___5493) (select temp___5490 temp___5493))))))))))
(assert (forall ((temp___5496 (Array Int et1))) (forall ((temp___5497 Int) (temp___5498 Int)) (let ((temp___5495 (temp___5494 temp___5496 temp___5497 temp___5498))) (=> (and (dynamic_invariant temp___5497 true true true true) (dynamic_invariant3 temp___5498 true true true true)) (forall ((temp___5499 Int)) (ite (= temp___5499 temp___5497) (= (to_rep (select temp___5495 temp___5499)) temp___5498) (= (select temp___5495 temp___5499) (select temp___5496 temp___5499)))))))))
...
(assert (and (and (= (bool_eq2 a 1 16 (temp___5482 t k (temp___5488 (select t k) j (temp___5494 (select (select t k) j) i e))) 1 16) true) (or (and (= k 16) (= k_next1 1)) (and (< k 16) (= k_next1 (+ k 1))))) (in_range3 k_next1)))
...
(assert (= (to_rep o1) f1))
(assert (= o2 (store (select (select a k_next1) j) i o1)))
(assert (= o3 (store (select a k_next1) j o2)))
(assert (= o4 (store a k_next1 o3)))
(assert (= result2 a))
(assert (= a1 o4))
(assert (= t t1))
(assert (= f1 f3))
...
(assert (<= 1 m))
(assert (<= m 16))
(assert (not (in_range4 (to_rep (select (select (select a2 m) n) o5)))))
(check-sat)
(exit)
