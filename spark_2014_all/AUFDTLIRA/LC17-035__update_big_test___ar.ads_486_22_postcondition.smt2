...
(declare-fun temp___5423 ((Array Int (Array Int (Array Int et1))) Int (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1))))
(assert (forall ((temp___5425 (Array Int (Array Int (Array Int et1))))) (forall ((temp___5426 Int)) (forall ((temp___5427 (Array Int (Array Int et1)))) (let ((temp___5424 (temp___5423 temp___5425 temp___5426 temp___5427))) (forall ((temp___5428 Int)) (ite (= temp___5428 temp___5426) (= (select temp___5424 temp___5428) temp___5427) (= (select temp___5424 temp___5428) (select temp___5425 temp___5428)))))))))
(declare-fun temp___5429 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
(assert (forall ((temp___5431 (Array Int (Array Int et1)))) (forall ((temp___5432 Int)) (forall ((temp___5433 (Array Int et1))) (let ((temp___5430 (temp___5429 temp___5431 temp___5432 temp___5433))) (forall ((temp___5434 Int)) (ite (= temp___5434 temp___5432) (= (select temp___5430 temp___5434) temp___5433) (= (select temp___5430 temp___5434) (select temp___5431 temp___5434)))))))))
(declare-fun temp___5435 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___5437 (Array Int et1))) (forall ((temp___5438 Int) (temp___5439 Int)) (let ((temp___5436 (temp___5435 temp___5437 temp___5438 temp___5439))) (forall ((temp___5440 Int)) (ite (= temp___5440 temp___5438) (= (select temp___5436 temp___5440) (of_rep temp___5439)) (= (select temp___5436 temp___5440) (select temp___5437 temp___5440))))))))
...
(assert (in_range3 k))
(assert (in_range4 e))
(assert (and (and (=> (<= 1 16) (in_range3 k_next)) (and (=> (<= 0 99) (in_range4 f)) (and (and (and (= (bool_eq2 a1 1 16 (temp___5423 t1 k (temp___5429 (select t1 k) j (temp___5435 (select (select t1 k) j) i e))) 1 16) true) (or (and (= k 16) (= k_next1 1)) (and (< k 16) (= k_next1 (+ k 1))))) (in_range3 k_next1)) (and (=> (<= 1 16) (in_range3 k_next1)) (and (ite (= e 0) (and (= result4 f) (= f1 99)) (and (and (and (= o5 (- e 1)) (in_range4 (- e 1))) (and (= result5 f) (= f2 o5))) (= f1 f2))) (and (and (and (and (= (to_rep o6) f1) (= o7 (store (select (select a1 k_next1) j) i o6))) (= o8 (store (select a1 k_next1) j o7))) (= o9 (store a1 k_next1 o8))) (and (= result6 a1) (= a2 o9)))))))) (and (and (= t1 t2) (and (= f1 f3) (and (= k_next1 k_next3) (= a2 a3)))) (and (= t3 t1) (and (= f4 f1) (and (= k_next4 k_next1) (= a4 a2)))))))
...
(assert (<= 1 m))
(assert (<= m 16))
(assert (not (in_range4 (to_rep (select (select (select a3 m) n) o10)))))
(check-sat)
(exit)
