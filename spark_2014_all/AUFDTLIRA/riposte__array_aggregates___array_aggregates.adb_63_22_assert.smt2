...
(assert (forall ((temp___403 Bool) (temp___404 Bool) (temp___405 Bool) (temp___406 Bool) (temp___407 Bool)) (let ((temp___402 (temp___401 temp___403 temp___404 temp___405 temp___406 temp___407))) (forall ((temp___408 Int)) (ite (or (= temp___408 76) (and (<= 67 temp___408) (<= temp___408 69))) (= (select temp___402 temp___408) temp___406) (ite (or (= temp___408 78) (= temp___408 70)) (= (select temp___402 temp___408) temp___405) (ite (= temp___408 65) (= (select temp___402 temp___408) temp___404) (ite (and (<= 97 temp___408) (<= temp___408 122)) (= (select temp___402 temp___408) temp___403) (= (select temp___402 temp___408) temp___407)))))))))
(declare-const m (Array Int Bool))
(declare-const result (Array Int Bool))
(declare-const m1 (Array Int Bool))
(assert (= result m))
(assert (= m1 (temp___401 (of_int 1) (of_int 1) (of_int 1) (of_int 1) (of_int 0))))
