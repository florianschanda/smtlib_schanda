...
(assert (= (= o32 true) (forall ((index Int)) (=> (and (<= (to_rep1 (first (rt source))) index) (<= index (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index))) true)))))
...
(assert (= o28 temp___1300))
(assert (= o29 (select (elts source) o28)))
(assert (= o30 (to_rep o29)))
(assert (= o31 (ite (< o30 56) true false)))
...
(assert (not (<= (to_rep1 (first (rt source))) temp___1292)))
(check-sat)
(exit)
