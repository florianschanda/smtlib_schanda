...
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields7 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c114b))) i))) true) (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c114b) i)))) (let ((subject n7)) n88))) (not (= i (root (rec__red_black_trees__rbt__struct (us_split_fields9 c115b)))))) (= (eq (select (nb_blacks c115b) i) (select (nb_blacks c114b) i)) true)))))
