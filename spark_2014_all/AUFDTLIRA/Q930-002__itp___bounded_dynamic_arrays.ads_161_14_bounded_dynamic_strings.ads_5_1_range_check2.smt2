...
(declare-const temp___1264 us_t1)
...
(assert (and (= o17 (length1 (mk___rep this__split_discrs (mk___split_fields this__split_fields (mk___t this__split_fields1 this__split_fields2))))) (and (in_range3 o17) (= o17 (to_rep1 this__split_fields)))))
(assert (and (= o15 (length2 by__)) (in_range1 (length2 by__))))
(assert (= o16 (+ start o15)))
(assert (= o18 (- o16 1)))
(assert (= result2 (ite (< o17 o18) true false)))
(assert (=> (= result2 true) (and (= o19 (length2 by__)) (in_range1 (length2 by__)))))
(assert (=> (= result2 true) (= o20 (+ start o19))))
(assert (=> (= result2 true) (= o21 (- o20 1))))
(assert (=> (= result2 true) (and (= o22 (length1 (mk___rep this__split_discrs (us_split_fields__content this__split_fields5)))) (and (in_range3 o22) (= o22 (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields__content this__split_fields5))))))))
(assert (=> (= result2 true) (= o25 (ite (= o22 o21) true false))))
(assert (=> (not (= result2 true)) (and (= o23 (length1 (mk___rep this__split_discrs (mk___split_fields this__split_fields (mk___t this__split_fields1 this__split_fields2))))) (and (in_range3 o23) (= o23 (to_rep1 this__split_fields))))))
(assert (=> (not (= result2 true)) (and (= o24 (length1 (mk___rep this__split_discrs (us_split_fields__content this__split_fields5)))) (and (in_range3 o24) (= o24 (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields__content this__split_fields5))))))))
(assert (=> (not (= result2 true)) (= o25 (ite (= o24 o23) true false))))
(assert (and (= o13 (length2 by__)) (in_range1 (length2 by__))))
(assert (= o14 (+ start o13)))
(assert (= temp___1263 (- o14 1)))
(assert (and (= temp___1264 (value (mk___rep this__split_discrs (us_split_fields__content this__split_fields5)))) (and (dynamic_invariant2 temp___1264 true false true true) (and (= temp___1264 (mk___t1 (elts (rec__bounded_dynamic_strings__sequence__content (us_split_fields__content this__split_fields5))) (mk1 (to_rep2 (first4 (mk2 1 (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields__content this__split_fields5)))))) (to_rep2 (last4 (mk2 1 (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields__content this__split_fields5))))))))) (and (and (and (= (length2 temp___1264) (length1 (mk___rep this__split_discrs (us_split_fields__content this__split_fields5)))) (= (to_rep2 (first2 (rt1 temp___1264))) 1)) (= (to_rep2 (last2 (rt1 temp___1264))) (length1 (mk___rep this__split_discrs (us_split_fields__content this__split_fields5))))) (= (< 0 (length1 (mk___rep this__split_discrs (us_split_fields__content this__split_fields5)))) (not (= (empty (mk___rep this__split_discrs (us_split_fields__content this__split_fields5))) true))))))))
(assert (<= start temp___1263))
(assert (not (<= (to_rep2 (first2 (rt1 temp___1264))) start)))
(check-sat)
(exit)
