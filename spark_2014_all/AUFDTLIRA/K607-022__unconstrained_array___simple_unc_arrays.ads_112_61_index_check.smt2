...
(define-fun dynamic_invariant2 ((temp___expr_531 Int) (temp___is_init_528 Bool) (temp___skip_constant_529 Bool) (temp___do_toplevel_530 Bool)) Bool (=> (or (= temp___is_init_528 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_531)))
...
(define-fun dynamic_invariant3 ((temp___expr_542 us_rep) (temp___is_init_539 Bool) (temp___skip_constant_540 Bool) (temp___do_toplevel_541 Bool)) Bool (let ((temp___543 (rec__simple_unc_arrays__table__last (us_split_discrs1 temp___expr_542)))) (and (dynamic_property1 1 (to_rep temp___543) (first1 (rec__simple_unc_arrays__table__v (us_split_fields1 temp___expr_542))) (last1 (rec__simple_unc_arrays__table__v (us_split_fields1 temp___expr_542)))) (and (= (first1 (rec__simple_unc_arrays__table__v (us_split_fields1 temp___expr_542))) 1) (= (last1 (rec__simple_unc_arrays__table__v (us_split_fields1 temp___expr_542))) (to_rep temp___543))))))
