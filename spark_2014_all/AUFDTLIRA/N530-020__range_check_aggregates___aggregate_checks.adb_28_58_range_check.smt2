...
(define-fun bool_eq2 ((a1 (Array Int integer)) (a__first Int) (a__last Int) (b (Array Int integer)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_137 Int)) (=> (and (<= a__first temp___idx_137) (<= temp___idx_137 a__last)) (= (to_rep (select a1 temp___idx_137)) (to_rep (select b (+ (- b__first a__first) temp___idx_137))))))) true false))
(assert (forall ((a1 (Array Int integer)) (b (Array Int integer))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq2 b b__first b__last a1 a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_137 Int)) (=> (and (<= a__first temp___idx_137) (<= temp___idx_137 a__last)) (= (to_rep (select a1 temp___idx_137)) (to_rep (select b (+ (- b__first a__first) temp___idx_137)))))))))))
...
(define-fun dynamic_invariant1 ((temp___expr_221 (Array Int integer)) (temp___is_init_218 Bool) (temp___skip_constant_219 Bool) (temp___do_toplevel_220 Bool)) Bool (forall ((temp___222 Int)) (=> (and (<= 1 temp___222) (<= temp___222 2)) (=> (or (= temp___is_init_218 true) (<= first2 last2)) (dynamic_property1 first2 last2 (to_rep (select temp___expr_221 temp___222)))))))
...
(assert (forall ((temp___139 Int) (temp___140 Int)) (let ((temp___138 (aggregate_checks__do_wrong_aggregate_3__should_fail22__aggregate_def temp___139 temp___140))) (and (= (select temp___138 1) (of_rep temp___139)) (= (select temp___138 2) (of_rep temp___140))))))
...
(define-fun dynamic_invariant5 ((temp___expr_215 Int) (temp___is_init_212 Bool) (temp___skip_constant_213 Bool) (temp___do_toplevel_214 Bool)) Bool (=> (or (= temp___is_init_212 true) (<= first2 last2)) (dynamic_property1 first2 last2 temp___expr_215)))
