...
(assert (= hr14 o117))
(assert (and (= o120 x) (in_range5 x)))
(assert (and (= o118 y) (in_range5 y)))
(assert (and (= o119 (remove (mk___t interm1 (mk 1 100)) o118)) (and (dynamic_invariant4 o119 true false true) (and (= (invariant__ o119) true) (and (= (to_rep1 (last (rt o119))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o118 1))) (= (to_rep (select interm1 k)) (to_rep (select (elts o119) k))))) (and (forall ((k Int)) (=> (and (<= (+ o118 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select interm1 k)) (to_rep (select (elts o119) (- k 1)))))) (forall ((k Int)) (=> (and (<= o118 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select interm1 (+ k 1))) (to_rep (select (elts o119) k))))))))))))
(assert (not (= (invariant__ o119) true)))
(check-sat)
(exit)
