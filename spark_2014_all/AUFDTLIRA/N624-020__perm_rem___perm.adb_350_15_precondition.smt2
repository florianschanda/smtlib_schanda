...
(assert (and (= (mk___t o10 o11) (remove aa ia22)) (and (dynamic_invariant2 (mk___t o10 o11) true false true) (and (= (invariant__ (mk___t o10 o11)) true) (and (= (to_rep1 (last o11)) (- (to_rep1 (last (rt aa))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ia22 1))) (= (to_rep (select (elts aa) k)) (to_rep (select o10 k))))) (and (forall ((k Int)) (=> (and (<= (+ ia22 1) k) (<= k (to_rep1 (last (rt aa))))) (= (to_rep (select (elts aa) k)) (to_rep (select o10 (- k 1)))))) (forall ((k Int)) (=> (and (<= ia22 k) (<= k (- (to_rep1 (last (rt aa))) 1))) (= (to_rep (select (elts aa) (+ k 1))) (to_rep (select o10 k))))))))))))
(assert (and (= (mk___t o8 o9) (remove bb2 ib)) (and (dynamic_invariant2 (mk___t o8 o9) true false true) (and (= (invariant__ (mk___t o8 o9)) true) (and (= (to_rep1 (last o9)) (- (to_rep1 (last (rt bb2))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib 1))) (= (to_rep (select (elts bb2) k)) (to_rep (select o8 k))))) (and (forall ((k Int)) (=> (and (<= (+ ib 1) k) (<= k (to_rep1 (last (rt bb2))))) (= (to_rep (select (elts bb2) k)) (to_rep (select o8 (- k 1)))))) (forall ((k Int)) (=> (and (<= ib k) (<= k (- (to_rep1 (last (rt bb2))) 1))) (= (to_rep (select (elts bb2) (+ k 1))) (to_rep (select o8 k))))))))))))
(assert (not (= (invariant__ (mk___t o8 o9)) true)))
(check-sat)
(exit)
