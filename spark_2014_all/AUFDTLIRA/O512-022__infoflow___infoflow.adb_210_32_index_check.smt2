...
(assert (and (forall ((m12 Int)) (=> (and (<= (to_rep a_v1__first) m12) (<= m12 k_1)) (= (to_rep (select (map__content a_v118) m12)) (to_rep (select (elts b_v1) m12))))) (forall ((m12 Int)) (=> (and (<= (+ k_1 1) m12) (<= m12 (to_rep a_v1__last))) (= (to_rep (select (map__content a_v118) m12)) (to_rep (select (elts c_v1) (- m12 k_1))))))))
(assert (= result10 (mk_int__ref i_v2)))
(assert (= i_v22 (to_rep a_v2__first)))
(assert (=> (and (<= (to_rep a_v2__first) i_v22) (<= i_v22 k_2)) (and (and (= temp___451 i_v22) (and (= temp___449 a_v2) (and (forall ((m12 Int)) (=> (and (<= (to_rep a_v2__first) m12) (<= m12 (- i_v23 1))) (= (to_rep (select a_v22 m12)) (to_rep (select (elts b_v2) m12))))) (and (and (and (forall ((temp___450 Int)) (=> (and (<= (to_rep a_v2__first) temp___450) (<= temp___450 (to_rep a_v2__last))) (=> (<= i_v23 temp___450) (= (select a_v22 temp___450) (select temp___449 temp___450))))) (=> (<= (to_rep a_v2__first) k_2) (dynamic_property3 (to_rep a_v2__first) k_2 i_v23))) (and (<= (to_rep a_v2__first) i_v23) (<= i_v23 k_2))) (and (and (and (and (and (and (and (and (<= (to_rep (first (rt b_v2))) i_v23) (<= i_v23 (to_rep (last (rt b_v2))))) (= o39 i_v23)) (= o40 (select (elts b_v2) o39))) (= o41 (to_rep o40))) (= (to_rep o42) o41)) (and (and (and (<= (to_rep a_v2__first) i_v23) (<= i_v23 (to_rep a_v2__last))) (= o43 i_v23)) (= o44 (store a_v22 o43 o42)))) (and (= result11 (mk_map__ref a_v22)) (= a_v23 o44))) (= i_v23 k_2)))))) (and (and (= i_v29 (mk_int__ref i_v23)) (= a_v28 (mk_map__ref a_v23))) (and (= i_v210 i_v23) (= a_v29 a_v23))))))
(assert (=> (and (<= (to_rep a_v2__first) i_v22) (<= i_v22 k_2)) (= i_v211 i_v29)))
(assert (=> (and (<= (to_rep a_v2__first) i_v22) (<= i_v22 k_2)) (= a_v210 a_v28)))
(assert (=> (and (<= (to_rep a_v2__first) i_v22) (<= i_v22 k_2)) (= i_v212 i_v210)))
(assert (=> (and (<= (to_rep a_v2__first) i_v22) (<= i_v22 k_2)) (= a_v211 a_v29)))
(assert (=> (not (and (<= (to_rep a_v2__first) i_v22) (<= i_v22 k_2))) (= i_v211 (mk_int__ref i_v22))))
(assert (=> (not (and (<= (to_rep a_v2__first) i_v22) (<= i_v22 k_2))) (= a_v210 (mk_map__ref a_v2))))
(assert (=> (not (and (<= (to_rep a_v2__first) i_v22) (<= i_v22 k_2))) (= i_v212 i_v22)))
(assert (=> (not (and (<= (to_rep a_v2__first) i_v22) (<= i_v22 k_2))) (= a_v211 a_v21)))
(assert (= (= result14 true) (forall ((m12 Int)) (=> (and (<= (to_rep a_v1__first) m12) (<= m12 k_1)) (= (to_rep (select (map__content a_v118) m12)) (to_rep (select (elts b_v1) m12)))))))
(assert (= result14 true))
(assert (<= (+ k_1 1) m8))
(assert (<= m8 (to_rep a_v1__last)))
(assert (not (<= (to_rep (first (rt c_v1))) (- m8 k_1))))
(check-sat)
(exit)
