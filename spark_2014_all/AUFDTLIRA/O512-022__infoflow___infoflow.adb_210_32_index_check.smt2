...
(declare-const temp___492 (Array Int integer))
(declare-const o Int)
...
(assert (=> (and (<= (to_rep a_v2__first) i_v21) (<= i_v21 k_2)) (= temp___494 i_v21)))
(assert (=> (and (<= (to_rep a_v2__first) i_v21) (<= i_v21 k_2)) (= temp___492 a_v2)))
...
(assert (=> (and (<= (to_rep a_v2__first) i_v21) (<= i_v21 k_2)) (and (and (forall ((temp___493 Int)) (=> (and (<= (to_rep a_v2__first) temp___493) (<= temp___493 (to_rep a_v2__last))) (=> (<= i_v22 temp___493) (= (select a_v22 temp___493) (select temp___492 temp___493))))) (=> (<= (to_rep a_v2__first) k_2) (dynamic_property3 (to_rep a_v2__first) k_2 i_v22))) (and (<= (to_rep a_v2__first) i_v22) (<= i_v22 k_2)))))
...
(assert (= (= result2 true) (forall ((m1 Int)) (=> (and (<= (to_rep a_v1__first) m1) (<= m1 k_1)) (= (to_rep (select (map__content a_v1) m1)) (to_rep (select (elts b_v1) m1)))))))
(assert (= result2 true))
(assert (<= (+ k_1 1) m))
(assert (<= m (to_rep a_v1__last)))
(assert (not (<= (to_rep (first (rt c_v1))) (- m k_1))))
(check-sat)
(exit)
