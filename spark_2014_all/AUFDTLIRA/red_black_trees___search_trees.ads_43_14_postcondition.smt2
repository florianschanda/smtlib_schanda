...
(assert (= d1 0))
(assert (in_range5 d1))
(assert (or (and (and (and (= search_trees__contains__result11 (mk_bool__ref search_trees__contains__result3)) (and (= d9 (mk_int__ref d2)) (and (= previous8 (mk_int__ref previous3)) (= current9 (mk_int__ref current2))))) (and (= search_trees__contains__result12 search_trees__contains__result3) (and (= d10 d2) (and (= previous9 previous3) (= current10 current2))))) (and (not (= current1 0)) (and (= temp___710 d1) (and (= temp___709 previous1) (and (= temp___708 current1) (and (= 0 temp___734) (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) current2))) true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i))) true) (=> (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) current2)))) true) (ite (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) current2))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i)))) 1)) 0) (< v (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i))) (< (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i)) v))))))) (and (and (and (and (=> (<= 0 100) (in_range4 current2)) (=> (<= 0 100) (in_range4 previous2))) (=> (<= 0 1) (in_range5 d2))) (not (= current2 0))) (and (and (= result3 (mk_int__ref temp___7341)) (= temp___7342 (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) current2)))))) (and (and (= result4 (mk_int__ref previous2)) (= previous3 current2)) (and (and (and (and (and (and (<= 1 current2) (<= current2 100)) (= o current2)) (= o1 (select (rec__search_trees__search_tree__values (us_split_fields7 t)) o))) (= o2 (to_rep o1))) (= result5 (ite (= v o2) true false))) (and (= result5 true) (and (= result6 (mk_bool__ref search_trees__contains__result2)) (= search_trees__contains__result3 (distinct 1 0))))))))))))))) (and (ite (not (= current1 0)) (and (and (and (= temp___710 d1) (and (= temp___709 previous1) (and (= temp___708 current1) (and (= 0 temp___734) (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) current2))) true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i))) true) (=> (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) current2)))) true) (ite (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) current2))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i)))) 1)) 0) (< v (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i))) (< (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i)) v))))))) (and (and (and (and (=> (<= 0 100) (in_range4 current2)) (=> (<= 0 100) (in_range4 previous2))) (=> (<= 0 1) (in_range5 d2))) (not (= current2 0))) (and (and (= result3 (mk_int__ref temp___7341)) (= temp___7342 (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) current2)))))) (and (and (= result4 (mk_int__ref previous2)) (= previous3 current2)) (and (and (and (and (and (and (and (<= 1 current2) (<= current2 100)) (= o current2)) (= o1 (select (rec__search_trees__search_tree__values (us_split_fields7 t)) o))) (= o2 (to_rep o1))) (= result5 (ite (= v o2) true false))) (and (not (= result5 true)) (and (and (and (and (and (and (and (<= 1 current2) (<= current2 100)) (= o3 current2)) (= o4 (select (rec__search_trees__search_tree__values (us_split_fields7 t)) o3))) (= o5 (to_rep o4))) (= result7 (ite (< v o5) true false))) (ite (= result7 true) (and (and (= result8 (mk_int__ref d2)) (= d3 0)) (and (and (and (= o6 current2) (in_range3 current2)) (and (= o7 (peek (rec__search_trees__search_tree__struct (us_split_fields7 t)) o6 0)) (and (in_range4 o7) (and (ite (not (= o7 0)) (and (= (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) o7) 0) (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) o7) o6)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) j) o6) (not (= (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) j) 0)))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) j) o6) (= (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) j) 0)) (= o7 j)))))))) (and (= result9 (mk_int__ref current2)) (= current3 o7)))) (and (and (and (= result10 (mk_int__ref d2)) (= d4 1)) (and (and (and (= o8 current2) (in_range3 current2)) (and (= o9 (peek (rec__search_trees__search_tree__struct (us_split_fields7 t)) o8 1)) (and (in_range4 o9) (and (ite (not (= o9 0)) (and (= (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) o9) 1) (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) o9) o8)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) j) o8) (not (= (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) j) 1)))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) j) o8) (= (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) j) 1)) (= o9 j)))))))) (and (= result11 (mk_int__ref current2)) (= current4 o9)))) (and (= d3 d4) (= current3 current4))))) (= search_trees__contains__result3 search_trees__contains__result2)))) (= current3 0)))))))))) (and (and (= search_trees__contains__result4 (mk_bool__ref search_trees__contains__result3)) (and (= d5 (mk_int__ref d3)) (and (= previous4 (mk_int__ref previous3)) (= current5 (mk_int__ref current3))))) (and (= search_trees__contains__result5 search_trees__contains__result3) (and (= d6 d3) (and (= previous5 previous3) (= current6 current3)))))) (and (and (= search_trees__contains__result6 search_trees__contains__result4) (and (= d7 d5) (and (= previous6 previous4) (= current7 current5)))) (and (= search_trees__contains__result7 search_trees__contains__result5) (and (= d8 d6) (and (= previous7 previous5) (= current8 current6)))))) (and (and (= search_trees__contains__result6 (mk_bool__ref search_trees__contains__result)) (and (= d7 (mk_int__ref d1)) (and (= previous6 (mk_int__ref previous1)) (= current7 (mk_int__ref current1))))) (and (= search_trees__contains__result7 search_trees__contains__result1) (and (= d8 d1) (and (= previous7 previous1) (= current8 current1)))))) (and (and (and (= search_trees__contains__result11 search_trees__contains__result9) (and (= d9 d7) (and (= previous8 previous6) (= current9 current7)))) (and (= search_trees__contains__result12 search_trees__contains__result10) (and (= d10 d8) (and (= previous9 previous7) (= current10 current8))))) (and (and (and (and (= o10 (size (rec__search_trees__search_tree__struct (us_split_fields7 t)))) (in_range4 o10)) (= result12 (ite (< 0 o10) true false))) (=> (= result12 true) (and (and (= o11 (int__content previous6)) (in_range3 (int__content previous6))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i))) true) (not (= (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i)) v)))))))) (and (and (= search_trees__contains__result9 (mk_bool__ref search_trees__contains__result8)) (= search_trees__contains__result10 search_trees__contains__result8)) (and (= result13 search_trees__contains__result6) (= search_trees__contains__result8 (distinct 0 0)))))))))
...
(assert (= (bool__content search_trees__contains__result13) true))
(assert (not (= (contains (values1 t) v) true)))
(check-sat)
(exit)
