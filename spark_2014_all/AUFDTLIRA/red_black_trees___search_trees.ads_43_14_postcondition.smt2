...
(assert (= d1 0))
(assert (in_range5 d1))
(assert (or (and (and (and (= search_trees__contains__result11 (mk_bool__ref search_trees__contains__result3)) (and (= d9 (mk_int__ref d2)) (and (= previous8 (mk_int__ref previous3)) (= current9 (mk_int__ref current2))))) (and (= search_trees__contains__result12 search_trees__contains__result3) (and (= d10 d2) (and (= previous9 previous3) (= current10 current2))))) (and (not (= current1 0)) (and (= temp___666 d1) (and (= temp___665 previous1) (and (= temp___664 current1) (and (= 0 temp___690) (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) current2))) true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i1))) true) (=> (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i1))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) current2)))) true) (ite (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) current2))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i1)))) 1)) 0) (< v (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i1))) (< (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i1)) v))))))) (and (and (and (and (=> (<= 0 100) (in_range4 current2)) (=> (<= 0 100) (in_range4 previous2))) (=> (<= 0 1) (in_range5 d2))) (not (= current2 0))) (and (and (= result5 (mk_int__ref temp___6901)) (= temp___6902 (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) current2)))))) (and (and (= result6 (mk_int__ref previous2)) (= previous3 current2)) (and (and (and (and (and (and (<= 1 current2) (<= current2 100)) (= o36 current2)) (= o37 (select (rec__search_trees__search_tree__values (us_split_fields7 t)) o36))) (= o38 (to_rep o37))) (= result7 (ite (= v o38) true false))) (and (= result7 true) (and (= result8 (mk_bool__ref search_trees__contains__result2)) (= search_trees__contains__result3 (of_int 1))))))))))))))) (and (ite (not (= current1 0)) (and (and (and (= temp___666 d1) (and (= temp___665 previous1) (and (= temp___664 current1) (and (= 0 temp___690) (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) current2))) true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i1))) true) (=> (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i1))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) current2)))) true) (ite (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) current2))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i1)))) 1)) 0) (< v (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i1))) (< (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i1)) v))))))) (and (and (and (and (=> (<= 0 100) (in_range4 current2)) (=> (<= 0 100) (in_range4 previous2))) (=> (<= 0 1) (in_range5 d2))) (not (= current2 0))) (and (and (= result5 (mk_int__ref temp___6901)) (= temp___6902 (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) current2)))))) (and (and (= result6 (mk_int__ref previous2)) (= previous3 current2)) (and (and (and (and (and (and (and (<= 1 current2) (<= current2 100)) (= o36 current2)) (= o37 (select (rec__search_trees__search_tree__values (us_split_fields7 t)) o36))) (= o38 (to_rep o37))) (= result7 (ite (= v o38) true false))) (and (not (= result7 true)) (and (and (and (and (and (and (and (<= 1 current2) (<= current2 100)) (= o39 current2)) (= o40 (select (rec__search_trees__search_tree__values (us_split_fields7 t)) o39))) (= o41 (to_rep o40))) (= result9 (ite (< v o41) true false))) (ite (= result9 true) (and (and (= result10 (mk_int__ref d2)) (= d3 0)) (and (and (and (= o42 current2) (in_range3 current2)) (and (= o43 (peek (rec__search_trees__search_tree__struct (us_split_fields7 t)) o42 0)) (and (in_range4 o43) (and (ite (not (= o43 0)) (and (= (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) o43) 0) (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) o43) o42)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) j) o42) (not (= (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) j) 0)))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) j) o42) (= (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) j) 0)) (= o43 j)))))))) (and (= result11 (mk_int__ref current2)) (= current3 o43)))) (and (and (and (= result12 (mk_int__ref d2)) (= d4 1)) (and (and (and (= o44 current2) (in_range3 current2)) (and (= o45 (peek (rec__search_trees__search_tree__struct (us_split_fields7 t)) o44 1)) (and (in_range4 o45) (and (ite (not (= o45 0)) (and (= (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) o45) 1) (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) o45) o44)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) j) o44) (not (= (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) j) 1)))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) j) o44) (= (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) j) 1)) (= o45 j)))))))) (and (= result13 (mk_int__ref current2)) (= current4 o45)))) (and (= d3 d4) (= current3 current4))))) (= search_trees__contains__result3 search_trees__contains__result2)))) (= current3 0)))))))))) (and (and (= search_trees__contains__result4 (mk_bool__ref search_trees__contains__result3)) (and (= d5 (mk_int__ref d3)) (and (= previous4 (mk_int__ref previous3)) (= current5 (mk_int__ref current3))))) (and (= search_trees__contains__result5 search_trees__contains__result3) (and (= d6 d3) (and (= previous5 previous3) (= current6 current3)))))) (and (and (= search_trees__contains__result6 search_trees__contains__result4) (and (= d7 d5) (and (= previous6 previous4) (= current7 current5)))) (and (= search_trees__contains__result7 search_trees__contains__result5) (and (= d8 d6) (and (= previous7 previous5) (= current8 current6)))))) (and (and (= search_trees__contains__result6 (mk_bool__ref search_trees__contains__result)) (and (= d7 (mk_int__ref d1)) (and (= previous6 (mk_int__ref previous1)) (= current7 (mk_int__ref current1))))) (and (= search_trees__contains__result7 search_trees__contains__result1) (and (= d8 d1) (and (= previous7 previous1) (= current8 current1)))))) (and (and (and (= search_trees__contains__result11 search_trees__contains__result9) (and (= d9 d7) (and (= previous8 previous6) (= current9 current7)))) (and (= search_trees__contains__result12 search_trees__contains__result10) (and (= d10 d8) (and (= previous9 previous7) (= current10 current8))))) (and (and (and (and (= o47 (size (rec__search_trees__search_tree__struct (us_split_fields7 t)))) (in_range4 o47)) (= result14 (ite (< 0 o47) true false))) (=> (= result14 true) (and (and (= o48 (int__content previous6)) (in_range3 (int__content previous6))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i1))) true) (not (= (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i1)) v)))))))) (and (and (= search_trees__contains__result9 (mk_bool__ref search_trees__contains__result8)) (= search_trees__contains__result10 search_trees__contains__result8)) (and (= result15 search_trees__contains__result6) (= search_trees__contains__result8 (of_int 0)))))))))
...
(assert (= result16 (bool__content search_trees__contains__result13)))
