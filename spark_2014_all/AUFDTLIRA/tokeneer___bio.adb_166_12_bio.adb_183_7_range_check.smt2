...
(assert (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE6 thecodename1))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE6 thecodename1)))))) (= o7 (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE6 thecodename1))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE6 thecodename1)))))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE6 thecodename1))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE6 thecodename1))))))) (= o7 0)))
(assert (=> (<= (to_rep1 (first temp___9141)) (to_rep1 (last temp___9141))) (= o8 (+ (- (to_rep1 (last temp___9141)) (to_rep1 (first temp___9141))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___9141)) (to_rep1 (last temp___9141)))) (= o8 0)))
(assert (= o9 (+ o8 o7)))
