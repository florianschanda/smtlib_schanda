...
(assert (not (< (to_rep (select (rec__search_trees__search_tree__values t__split_fields6) x1)) (to_rep (select (rec__search_trees__search_tree__values t__split_fields6) y1)))))
(check-sat)
(exit)
