...
(define-fun bool_eq2 ((a (Array Int fruits_and_weapons)) (a__first Int) (a__last Int) (b (Array Int fruits_and_weapons)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_157 Int)) (=> (and (<= a__first temp___idx_157) (<= temp___idx_157 a__last)) (= (to_rep2 (select a temp___idx_157)) (to_rep2 (select b (+ (- b__first a__first) temp___idx_157))))))) true false))
(assert (forall ((a (Array Int fruits_and_weapons)) (b (Array Int fruits_and_weapons))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq2 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_157 Int)) (=> (and (<= a__first temp___idx_157) (<= temp___idx_157 a__last)) (= (to_rep2 (select a temp___idx_157)) (to_rep2 (select b (+ (- b__first a__first) temp___idx_157)))))))))))
(declare-sort t1 0)
...
(declare-datatypes () ((new_inventory_t__ref (mk_new_inventory_t__ref (new_inventory_t__content us_t1)))))
(define-fun new_inventory_t__ref___projection ((a new_inventory_t__ref)) us_t1 (new_inventory_t__content a))
(declare-sort t2 0)
...
(declare-datatypes () ((fruit_crate__ref (mk_fruit_crate__ref (fruit_crate__content us_t2)))))
(define-fun fruit_crate__ref___projection ((a fruit_crate__ref)) us_t2 (fruit_crate__content a))
(declare-sort t3 0)
...
(declare-datatypes () ((fruit_and_weapons_crate__ref (mk_fruit_and_weapons_crate__ref (fruit_and_weapons_crate__content us_t3)))))
(define-fun fruit_and_weapons_crate__ref___projection ((a fruit_and_weapons_crate__ref)) us_t3 (fruit_and_weapons_crate__content a))
...
(define-fun dynamic_invariant2 ((temp___expr_261 Int) (temp___is_init_257 Bool) (temp___skip_constant_258 Bool) (temp___do_toplevel_259 Bool) (temp___do_typ_inv_260 Bool)) Bool (=> (or (= temp___is_init_257 true) (<= 0 12)) (in_range4 temp___expr_261)))
(define-fun dynamic_invariant3 ((temp___expr_268 Int) (temp___is_init_264 Bool) (temp___skip_constant_265 Bool) (temp___do_toplevel_266 Bool) (temp___do_typ_inv_267 Bool)) Bool (=> (or (= temp___is_init_264 true) (<= 0 9)) (in_range3 temp___expr_268)))
(assert true)
(assert (forall ((fruit Int)) (! (= (= (found_none fruit) true) (= fruit 0)) :pattern ((found_none fruit)))))
(define-fun dynamic_invariant4 ((temp___expr_352 us_t2) (temp___is_init_348 Bool) (temp___skip_constant_349 Bool) (temp___do_toplevel_350 Bool) (temp___do_typ_inv_351 Bool)) Bool (=> (not (= temp___skip_constant_349 true)) (dynamic_property2 1 2147483647 (first5 temp___expr_352) (last5 temp___expr_352))))
(define-fun dynamic_invariant5 ((temp___expr_358 us_t3) (temp___is_init_354 Bool) (temp___skip_constant_355 Bool) (temp___do_toplevel_356 Bool) (temp___do_typ_inv_357 Bool)) Bool (=> (not (= temp___skip_constant_355 true)) (dynamic_property3 1 2147483647 (first7 temp___expr_358) (last7 temp___expr_358))))
(define-fun dynamic_invariant6 ((temp___expr_371 us_t) (temp___is_init_367 Bool) (temp___skip_constant_368 Bool) (temp___do_toplevel_369 Bool) (temp___do_typ_inv_370 Bool)) Bool (=> (not (= temp___skip_constant_368 true)) (dynamic_property 1 2147483647 (first1 temp___expr_371) (last1 temp___expr_371))))
(define-fun dynamic_invariant7 ((temp___expr_419 us_t1) (temp___is_init_415 Bool) (temp___skip_constant_416 Bool) (temp___do_toplevel_417 Bool) (temp___do_typ_inv_418 Bool)) Bool (=> (not (= temp___skip_constant_416 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_419) (last3 temp___expr_419))))
(declare-const o (Array Int fruits))
(assert (dynamic_property2 1 2147483647 (to_rep initial_crate__first) (to_rep initial_crate__last)))
(assert (dynamic_property3 1 2147483647 (to_rep final_crate__first) (to_rep final_crate__last)))
(assert (and (= (to_rep initial_crate__first) (to_rep final_crate__first)) (= (to_rep initial_crate__last) (to_rep final_crate__last))))
(assert (forall ((i Int)) (=> (and (<= (to_rep initial_crate__first) i) (<= i (to_rep initial_crate__last))) (not (= (found_none (to_rep1 (select o i))) true)))))
(assert (not (dynamic_property1 1 2147483647 (to_rep final_crate__first) (to_rep final_crate__last))))
(check-sat)
(exit)
