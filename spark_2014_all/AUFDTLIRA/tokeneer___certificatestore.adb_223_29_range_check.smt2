...
(define-fun dynamic_invariant1 ((temp___expr_1325 Int) (temp___is_init_1322 Bool) (temp___skip_constant_1323 Bool) (temp___do_toplevel_1324 Bool)) Bool (=> (or (= temp___is_init_1322 true) (<= 0 4294967295)) (in_range3 temp___expr_1325)))
(declare-sort t2 0)
...
(define-fun dynamic_invariant2 ((temp___expr_317 us_t1) (temp___is_init_314 Bool) (temp___skip_constant_315 Bool) (temp___do_toplevel_316 Bool)) Bool (and (=> (not (= temp___skip_constant_315 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_317) (last3 temp___expr_317))) (=> (= temp___do_toplevel_316 true) (=> (= temp___is_init_314 true) (and (let ((temp___319 (of_array3 (to_array1 temp___expr_317) (first3 temp___expr_317) (last3 temp___expr_317)))) (and (let ((temp___320 (of_array2 (to_array3 temp___319) (first7 temp___319) (last7 temp___319)))) (and (= (first5 temp___320) 1) (<= 0 (last5 temp___320)))) (<= (last7 temp___319) 1000))) (<= 2 (length1 temp___expr_317)))))))
(define-fun dynamic_predicate ((temp___322 us_t1)) Bool (and (let ((temp___324 (of_array3 (to_array1 temp___322) (first3 temp___322) (last3 temp___322)))) (and (let ((temp___325 (of_array2 (to_array3 temp___324) (first7 temp___324) (last7 temp___324)))) (and (= (first5 temp___325) 1) (<= 0 (last5 temp___325)))) (<= (last7 temp___324) 1000))) (<= 2 (length1 temp___322))))
(declare-fun serialnumbert_image (Int) us_t1)
(declare-fun serialnumbert_image__function_guard (us_t1 Int) Bool)
(assert (forall ((x Int)) (! (=> (dynamic_invariant1 x true true true) (dynamic_invariant2 (serialnumbert_image x) true false true)) :pattern ((serialnumbert_image x)))))
(assert (forall ((x Int)) (! (=> (dynamic_invariant1 x true true true) (= (serialnumbert_image x) (let ((temp___1331 (to_string (attr__ATTRIBUTE_IMAGE3 x)))) (of_array1 (to_array temp___1331) (first1 temp___1331) (last1 temp___1331))))) :pattern ((serialnumbert_image x)))))
...
(define-fun dynamic_invariant3 ((temp___expr_1463 Int) (temp___is_init_1460 Bool) (temp___skip_constant_1461 Bool) (temp___do_toplevel_1462 Bool)) Bool (=> (or (= temp___is_init_1460 true) (<= 1 10)) (in_range4 temp___expr_1463)))
...
(declare-fun temp___1507 (Int Int Int) us_t7)
(assert (forall ((temp___1509 Int) (temp___1510 Int) (temp___1511 Int)) (let ((temp___1508 (temp___1507 temp___1509 temp___1510 temp___1511))) (and (=> (dynamic_property 1 2147483647 temp___1510 temp___1511) (and (= (first15 temp___1508) temp___1510) (= (last15 temp___1508) temp___1511))) (forall ((temp___1512 Int)) (= (select (to_array7 temp___1508) temp___1512) (of_rep temp___1509)))))))
...
(define-fun dynamic_invariant7 ((temp___expr_271 us_t2) (temp___is_init_268 Bool) (temp___skip_constant_269 Bool) (temp___do_toplevel_270 Bool)) Bool (and (=> (not (= temp___skip_constant_269 true)) (dynamic_property2 1 2147483647 (first5 temp___expr_271) (last5 temp___expr_271))) (=> (= temp___do_toplevel_270 true) (=> (= temp___is_init_268 true) (and (= (first5 temp___expr_271) 1) (<= 0 (last5 temp___expr_271)))))))
(define-fun dynamic_predicate1 ((temp___274 us_t2)) Bool (and (= (first5 temp___274) 1) (<= 0 (last5 temp___274))))
(define-fun dynamic_invariant8 ((temp___expr_305 us_t3) (temp___is_init_302 Bool) (temp___skip_constant_303 Bool) (temp___do_toplevel_304 Bool)) Bool (and (=> (not (= temp___skip_constant_303 true)) (dynamic_property3 1 2147483647 (first7 temp___expr_305) (last7 temp___expr_305))) (=> (= temp___do_toplevel_304 true) (=> (= temp___is_init_302 true) (and (let ((temp___307 (of_array2 (to_array3 temp___expr_305) (first7 temp___expr_305) (last7 temp___expr_305)))) (and (= (first5 temp___307) 1) (<= 0 (last5 temp___307)))) (<= (last7 temp___expr_305) 1000))))))
(define-fun dynamic_predicate2 ((temp___309 us_t3)) Bool (and (let ((temp___311 (of_array2 (to_array3 temp___309) (first7 temp___309) (last7 temp___309)))) (and (= (first5 temp___311) 1) (<= 0 (last5 temp___311)))) (<= (last7 temp___309) 1000)))
(declare-const text (Array Int character))
(declare-const length8 Int)
(declare-const str (Array Int character))
(declare-const temp___1498 (Array Int character))
(declare-const temp___14981 t1)
...
(declare-const temp___1501 (Array Int character))
(declare-const temp___15011 t5)
(declare-const temp___1502 (Array Int character))
(declare-const temp___15021 t4)
(declare-const o5 (Array Int character))
(declare-const temp___1504 (Array Int character))
(declare-const temp___15041 t4)
(declare-const temp___1505 (Array Int character))
(declare-const temp___15051 t4)
(declare-const o6 (Array Int character))
(declare-const temp___1514 (Array Int character))
(declare-const temp___15141 t7)
(declare-const temp___1515 (Array Int character))
(declare-const temp___15151 t6)
(declare-const o7 (Array Int character))
(declare-const temp___1517 (Array Int character))
(declare-const temp___15171 t6)
...
(assert (and (= (mk___t1 temp___1498 temp___14981) (serialnumbert_image num)) (and (dynamic_invariant2 (mk___t1 temp___1498 temp___14981) true false true) (= (mk___t1 temp___1498 temp___14981) (let ((temp___1329 (to_string (attr__ATTRIBUTE_IMAGE3 num)))) (mk___t1 (elts temp___1329) (mk1 (to_rep1 (first (rt temp___1329))) (to_rep1 (last (rt temp___1329))))))))))
(assert (= temp___1498 certificatestore__putnextserialnumber__convertfrom32__str__assume))
(assert (= (mk (to_rep1 (first2 temp___14981)) (to_rep1 (last2 temp___14981))) certificatestore__putnextserialnumber__convertfrom32__str__assume1))
(assert (= result str))
