...
(assert (and (and (and (= (+ (length avail3) (length alloc3)) r2) (forall ((e Int)) (=> (and (in_range1 e) (= (contains avail3 e) true)) (and (<= 1 e) (<= e r2))))) (forall ((e Int)) (=> (and (in_range1 e) (= (contains alloc3 e) true)) (and (<= 1 e) (<= e r2))))) (forall ((rr Int)) (=> (and (<= 1 rr) (<= rr r2)) (ite (= (to_rep (select data rr)) 0) (and (= (contains avail3 rr) true) (not (= (contains alloc3 rr) true))) (and (not (= (contains avail3 rr) true)) (= (contains alloc3 rr) true)))))))
(assert (and (=> (<= 1 10000) (in_range4 r2)) (and (<= 1 r2) (<= r2 10000))))
(assert (and (= o2 (length alloc3)) (in_range2 o2)))
(assert (and (= o3 (length avail3)) (in_range2 o3)))
(assert (= o4 (+ o3 o2)))
(assert (not (in_range5 o4)))
(check-sat)
(exit)
