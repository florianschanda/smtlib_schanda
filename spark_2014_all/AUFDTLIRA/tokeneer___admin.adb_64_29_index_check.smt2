...
(define-fun dynamic_invariant ((temp___expr_383 Int) (temp___is_init_380 Bool) (temp___skip_constant_381 Bool) (temp___do_toplevel_382 Bool)) Bool (=> (or (= temp___is_init_380 true) (<= 1 4)) (in_range4 temp___expr_383)))
...
(define-fun bool_eq3 ((a (Array Int us_rep1)) (a__first Int) (a__last Int) (b (Array Int us_rep1)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_156 Int)) (=> (and (<= a__first temp___idx_156) (<= temp___idx_156 a__last)) (= (bool_eq2 (select a temp___idx_156) (select b (+ (- b__first a__first) temp___idx_156))) true)))) true false))
(assert (forall ((a (Array Int us_rep1)) (b (Array Int us_rep1))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq3 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_156 Int)) (=> (and (<= a__first temp___idx_156) (<= temp___idx_156 a__last)) (= (bool_eq2 (select a temp___idx_156) (select b (+ (- b__first a__first) temp___idx_156))) true))))))))
...
(assert (forall ((temp___158 us_rep1) (temp___159 us_rep1) (temp___160 us_rep1) (temp___161 us_rep1)) (let ((temp___157 (admin__optokeyed__aggregate_def temp___158 temp___159 temp___160 temp___161))) (and (and (and (= (select temp___157 1) temp___158) (= (select temp___157 2) temp___159)) (= (select temp___157 3) temp___160)) (= (select temp___157 4) temp___161)))))
(declare-fun temp___String_Literal_163 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_163 us_void_param) 1)) 65) (= (to_rep (select (temp___String_Literal_163 us_void_param) 2)) 82)) (= (to_rep (select (temp___String_Literal_163 us_void_param) 3)) 67)) (= (to_rep (select (temp___String_Literal_163 us_void_param) 4)) 72)) (= (to_rep (select (temp___String_Literal_163 us_void_param) 5)) 73)) (= (to_rep (select (temp___String_Literal_163 us_void_param) 6)) 86)) (= (to_rep (select (temp___String_Literal_163 us_void_param) 7)) 69)) (= (to_rep (select (temp___String_Literal_163 us_void_param) 8)) 32)) (= (to_rep (select (temp___String_Literal_163 us_void_param) 9)) 76)) (= (to_rep (select (temp___String_Literal_163 us_void_param) 10)) 79)) (= (to_rep (select (temp___String_Literal_163 us_void_param) 11)) 71)) (= (to_rep (select (temp___String_Literal_163 us_void_param) 12)) 32)) (= (to_rep (select (temp___String_Literal_163 us_void_param) 13)) 32)) (= (to_rep (select (temp___String_Literal_163 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_163 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_163 us_void_param) 16)) 32)) (= (to_rep (select (temp___String_Literal_163 us_void_param) 17)) 32)) (= (to_rep (select (temp___String_Literal_163 us_void_param) 18)) 32)) :pattern ((temp___String_Literal_163 us_void_param)))))
(declare-fun temp___String_Literal_164 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_164 us_void_param) 1)) 85) (= (to_rep (select (temp___String_Literal_164 us_void_param) 2)) 80)) (= (to_rep (select (temp___String_Literal_164 us_void_param) 3)) 68)) (= (to_rep (select (temp___String_Literal_164 us_void_param) 4)) 65)) (= (to_rep (select (temp___String_Literal_164 us_void_param) 5)) 84)) (= (to_rep (select (temp___String_Literal_164 us_void_param) 6)) 69)) (= (to_rep (select (temp___String_Literal_164 us_void_param) 7)) 32)) (= (to_rep (select (temp___String_Literal_164 us_void_param) 8)) 67)) (= (to_rep (select (temp___String_Literal_164 us_void_param) 9)) 79)) (= (to_rep (select (temp___String_Literal_164 us_void_param) 10)) 78)) (= (to_rep (select (temp___String_Literal_164 us_void_param) 11)) 70)) (= (to_rep (select (temp___String_Literal_164 us_void_param) 12)) 73)) (= (to_rep (select (temp___String_Literal_164 us_void_param) 13)) 71)) (= (to_rep (select (temp___String_Literal_164 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_164 us_void_param) 15)) 68)) (= (to_rep (select (temp___String_Literal_164 us_void_param) 16)) 65)) (= (to_rep (select (temp___String_Literal_164 us_void_param) 17)) 84)) (= (to_rep (select (temp___String_Literal_164 us_void_param) 18)) 65)) :pattern ((temp___String_Literal_164 us_void_param)))))
(declare-fun temp___String_Literal_165 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_165 us_void_param) 1)) 79) (= (to_rep (select (temp___String_Literal_165 us_void_param) 2)) 86)) (= (to_rep (select (temp___String_Literal_165 us_void_param) 3)) 69)) (= (to_rep (select (temp___String_Literal_165 us_void_param) 4)) 82)) (= (to_rep (select (temp___String_Literal_165 us_void_param) 5)) 82)) (= (to_rep (select (temp___String_Literal_165 us_void_param) 6)) 73)) (= (to_rep (select (temp___String_Literal_165 us_void_param) 7)) 68)) (= (to_rep (select (temp___String_Literal_165 us_void_param) 8)) 69)) (= (to_rep (select (temp___String_Literal_165 us_void_param) 9)) 32)) (= (to_rep (select (temp___String_Literal_165 us_void_param) 10)) 76)) (= (to_rep (select (temp___String_Literal_165 us_void_param) 11)) 79)) (= (to_rep (select (temp___String_Literal_165 us_void_param) 12)) 67)) (= (to_rep (select (temp___String_Literal_165 us_void_param) 13)) 75)) (= (to_rep (select (temp___String_Literal_165 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_165 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_165 us_void_param) 16)) 32)) (= (to_rep (select (temp___String_Literal_165 us_void_param) 17)) 32)) (= (to_rep (select (temp___String_Literal_165 us_void_param) 18)) 32)) :pattern ((temp___String_Literal_165 us_void_param)))))
(declare-fun temp___String_Literal_166 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_166 us_void_param) 1)) 83) (= (to_rep (select (temp___String_Literal_166 us_void_param) 2)) 72)) (= (to_rep (select (temp___String_Literal_166 us_void_param) 3)) 85)) (= (to_rep (select (temp___String_Literal_166 us_void_param) 4)) 84)) (= (to_rep (select (temp___String_Literal_166 us_void_param) 5)) 68)) (= (to_rep (select (temp___String_Literal_166 us_void_param) 6)) 79)) (= (to_rep (select (temp___String_Literal_166 us_void_param) 7)) 87)) (= (to_rep (select (temp___String_Literal_166 us_void_param) 8)) 78)) (= (to_rep (select (temp___String_Literal_166 us_void_param) 9)) 32)) (= (to_rep (select (temp___String_Literal_166 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_166 us_void_param) 11)) 32)) (= (to_rep (select (temp___String_Literal_166 us_void_param) 12)) 32)) (= (to_rep (select (temp___String_Literal_166 us_void_param) 13)) 32)) (= (to_rep (select (temp___String_Literal_166 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_166 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_166 us_void_param) 16)) 32)) (= (to_rep (select (temp___String_Literal_166 us_void_param) 17)) 32)) (= (to_rep (select (temp___String_Literal_166 us_void_param) 18)) 32)) :pattern ((temp___String_Literal_166 us_void_param)))))
...
(define-fun dynamic_invariant2 ((temp___expr_428 Int) (temp___is_init_425 Bool) (temp___skip_constant_426 Bool) (temp___do_toplevel_427 Bool)) Bool (=> (or (= temp___is_init_425 true) (<= 0 18)) (in_range5 temp___expr_428)))
(define-fun dynamic_invariant3 ((temp___expr_434 Int) (temp___is_init_431 Bool) (temp___skip_constant_432 Bool) (temp___do_toplevel_433 Bool)) Bool (=> (or (= temp___is_init_431 true) (<= 1 18)) (in_range6 temp___expr_434)))
(assert (= optokeyed (admin__optokeyed__aggregate_def (mk___rep1 (mk___split_fields1 (of_rep2 11) (of_rep3 7) (temp___String_Literal_163 Tuple0))) (mk___rep1 (mk___split_fields1 (of_rep2 18) (of_rep3 6) (temp___String_Literal_164 Tuple0))) (mk___rep1 (mk___split_fields1 (of_rep2 13) (of_rep3 8) (temp___String_Literal_165 Tuple0))) (mk___rep1 (mk___split_fields1 (of_rep2 8) (of_rep3 8) (temp___String_Literal_166 Tuple0))))))
(define-fun dynamic_invariant4 ((temp___expr_344 Int) (temp___is_init_341 Bool) (temp___skip_constant_342 Bool) (temp___do_toplevel_343 Bool)) Bool (=> (or (= temp___is_init_341 true) (<= 0 78)) (in_range2 temp___expr_344)))
(define-fun dynamic_invariant5 ((temp___expr_350 Int) (temp___is_init_347 Bool) (temp___skip_constant_348 Bool) (temp___do_toplevel_349 Bool)) Bool (=> (or (= temp___is_init_347 true) (<= 1 78)) (in_range3 temp___expr_350)))
...
(declare-const temp___479 (Array Int us_rep1))
(declare-const i Int)
...
(assert (= o16 o17))
(assert (= o15 o18))
(assert (= (temp___String_Literal_166 Tuple0) o19))
(assert (= o20 o17))
(assert (= o21 o18))
(assert (= o22 o19))
...
(assert (= o11 o12))
(assert (= o10 o13))
(assert (= (temp___String_Literal_165 Tuple0) o14))
(assert (= o23 o12))
(assert (= o24 o13))
(assert (= o25 o14))
(assert (= (to_rep3 o5) 6))
...
(assert (= o6 o7))
(assert (= o5 o8))
(assert (= (temp___String_Literal_164 Tuple0) o9))
(assert (= o26 o7))
(assert (= o27 o8))
(assert (= o28 o9))
(assert (= (to_rep3 o) 7))
...
(assert (= o1 o2))
(assert (= o o3))
(assert (= (temp___String_Literal_163 Tuple0) o4))
(assert (= o29 o2))
(assert (= o30 o3))
(assert (= o31 o4))
(assert (= temp___479 (admin__optokeyed__aggregate_def (mk___rep1 (mk___split_fields1 o29 o30 o31)) (mk___rep1 (mk___split_fields1 o26 o27 o28)) (mk___rep1 (mk___split_fields1 o23 o24 o25)) (mk___rep1 (mk___split_fields1 o20 o21 o22)))))
(assert (= temp___479 optokeyed))
(assert (in_range4 op))
...
(assert (and (<= 1 i) (<= i 78)))
(assert (= o32 i))
(assert (= o33 (select (rec__keyboard__datat__text (us_split_fields1 keyedop)) o32)))
