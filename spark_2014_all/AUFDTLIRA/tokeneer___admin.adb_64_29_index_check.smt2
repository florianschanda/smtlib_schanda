...
(define-fun dynamic_invariant ((temp___expr_427 Int) (temp___is_init_424 Bool) (temp___skip_constant_425 Bool) (temp___do_toplevel_426 Bool)) Bool (=> (or (= temp___is_init_424 true) (<= 1 4)) (in_range4 temp___expr_427)))
...
(define-fun dynamic_invariant2 ((temp___expr_472 Int) (temp___is_init_469 Bool) (temp___skip_constant_470 Bool) (temp___do_toplevel_471 Bool)) Bool (=> (or (= temp___is_init_469 true) (<= 0 18)) (in_range5 temp___expr_472)))
(define-fun dynamic_invariant3 ((temp___expr_478 Int) (temp___is_init_475 Bool) (temp___skip_constant_476 Bool) (temp___do_toplevel_477 Bool)) Bool (=> (or (= temp___is_init_475 true) (<= 1 18)) (in_range6 temp___expr_478)))
...
(define-fun dynamic_invariant4 ((temp___expr_388 Int) (temp___is_init_385 Bool) (temp___skip_constant_386 Bool) (temp___do_toplevel_387 Bool)) Bool (=> (or (= temp___is_init_385 true) (<= 0 78)) (in_range2 temp___expr_388)))
(define-fun dynamic_invariant5 ((temp___expr_394 Int) (temp___is_init_391 Bool) (temp___skip_constant_392 Bool) (temp___do_toplevel_393 Bool)) Bool (=> (or (= temp___is_init_391 true) (<= 1 78)) (in_range3 temp___expr_394)))
...
(declare-const temp___523 (Array Int us_rep1))
(declare-const i Int)
...
(assert (= o30 o3))
(assert (= o31 o4))
(assert (= temp___523 (admin__optokeyed__aggregate_def (mk___rep1 (mk___split_fields1 o29 o30 o31)) (mk___rep1 (mk___split_fields1 o26 o27 o28)) (mk___rep1 (mk___split_fields1 o23 o24 o25)) (mk___rep1 (mk___split_fields1 o20 o21 o22)))))
(assert (= temp___523 optokeyed))
(assert (in_range4 op))
