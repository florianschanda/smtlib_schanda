...
(declare-fun temp___296 ((Array Int integer) Int Int Int Int Int) (Array Int integer))
(assert (forall ((temp___298 (Array Int integer))) (forall ((temp___299 Int) (temp___300 Int) (temp___301 Int) (temp___302 Int) (temp___303 Int)) (let ((temp___297 (temp___296 temp___298 temp___299 temp___300 temp___301 temp___302 temp___303))) (forall ((temp___304 Int)) (ite (and (<= temp___301 temp___304) (<= temp___304 temp___302)) (= (select temp___297 temp___304) (of_rep temp___303)) (ite (= temp___304 temp___299) (= (select temp___297 temp___304) (of_rep temp___300)) (= (select temp___297 temp___304) (select temp___298 temp___304)))))))))
(declare-fun temp___305 (Int) (Array Int integer))
(assert (forall ((temp___307 Int)) (forall ((temp___308 Int)) (= (select (temp___305 temp___307) temp___308) (of_rep temp___307)))))
(declare-fun temp___430 (Int) (Array Int integer))
(assert (forall ((temp___432 Int)) (forall ((temp___433 Int)) (= (select (temp___430 temp___432) temp___433) (of_rep temp___432)))))
(declare-fun temp___434 ((Array Int integer) Int Int Int Int Int) (Array Int integer))
(assert (forall ((temp___436 (Array Int integer))) (forall ((temp___437 Int) (temp___438 Int) (temp___439 Int) (temp___440 Int) (temp___441 Int)) (let ((temp___435 (temp___434 temp___436 temp___437 temp___438 temp___439 temp___440 temp___441))) (forall ((temp___442 Int)) (ite (and (<= temp___439 temp___442) (<= temp___442 temp___440)) (= (select temp___435 temp___442) (of_rep temp___441)) (ite (= temp___442 temp___437) (= (select temp___435 temp___442) (of_rep temp___438)) (= (select temp___435 temp___442) (select temp___436 temp___442)))))))))
...
(define-fun dynamic_invariant1 ((temp___expr_141 Int) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool (=> (or (= temp___is_init_138 true) (<= 1 8)) (in_range temp___expr_141)))
...
(assert (= result a))
(assert (= a1 (temp___430 1)))
(assert (= result1 a1))
(assert (= a2 (temp___434 a1 3 2 4 5 3)))
(assert (= a2 a3))
(assert (= a4 a2))
(assert (not (= (bool_eq a3 1 8 (temp___296 (temp___305 1) 3 2 4 5 3) 1 8) true)))
(check-sat)
(exit)
