...
(assert (= (ite (<= (to_rep1 (first4 temp___14441)) (to_rep1 (last4 temp___14441))) (+ (- (to_rep1 (last4 temp___14441)) (to_rep1 (first4 temp___14441))) 1) 0) (ite (<= 1 r6b) (+ (- r6b 1) 1) 0)))
(assert (= (slide temp___1444 (to_rep1 (first4 temp___14441)) 1) temp___1445))
(assert (= (mk1 1 r6b) temp___14451))
(assert (=> (<= 1 r6b) (and (and (<= 1 1) (<= 1 10)) (and (<= 1 r6b) (<= r6b 10)))))
(assert (= o5 text))
(assert (= o5 temp___1447))
(assert (= (mk1 1 r6b) temp___14471))
(assert (not (= (ite (<= (to_rep1 (first2 temp___14451)) (to_rep1 (last2 temp___14451))) (+ (- (to_rep1 (last2 temp___14451)) (to_rep1 (first2 temp___14451))) 1) 0) (ite (<= (to_rep1 (first2 temp___14471)) (to_rep1 (last2 temp___14471))) (+ (- (to_rep1 (last2 temp___14471)) (to_rep1 (first2 temp___14471))) 1) 0))))
(check-sat)
(exit)
