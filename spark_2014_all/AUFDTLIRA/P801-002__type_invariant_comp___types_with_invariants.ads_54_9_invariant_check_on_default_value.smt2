...
(assert (and (= us 0) (in_range5 0)))
(assert (dynamic_property3 1 100 (to_rep (first4 temp___2261)) (to_rep (last4 temp___2261))))
(assert false)
(assert (not (type_invariant2 (mk___t2 temp___226 temp___2261))))
(check-sat)
(exit)
