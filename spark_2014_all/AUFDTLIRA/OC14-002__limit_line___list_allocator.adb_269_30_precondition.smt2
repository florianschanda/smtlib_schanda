...
(assert (=> (= result12 true) (and (= temp___429 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (in_range7 temp___429))))
(assert (=> (= result12 true) (and (<= 1 temp___429) (<= temp___429 3))))
(assert (=> (= result12 true) (= o61 temp___429)))
