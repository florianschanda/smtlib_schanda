...
(assert (and (= o95 (length (rec__list_allocator__m__t__allocated model____split_fields4))) (in_range6 o95)))
(assert (= o96 (ite (<= j4 o95) true false)))
(assert (= result23 (ite (<= 1 j4) o96 false)))
(assert (= result23 true))
(assert (and (= o116 (get (rec__list_allocator__m__t__allocated model____split_fields4) j4)) (in_range7 o116)))
(assert (= result26 (ite (in_range4 o116) true false)))
(assert (=> (= result26 true) (and (= o112 (length (rec__list_allocator__m__t__allocated model____split_fields4))) (in_range6 o112))))
(assert (=> (= result26 true) (= result27 (ite (< j4 o112) true false))))
(assert (=> (= result26 true) (=> (= result27 true) (and (= o113 (+ j4 1)) (in_range1 (+ j4 1))))))
(assert (=> (= result26 true) (=> (= result27 true) (and (= o114 (get (rec__list_allocator__m__t__allocated model____split_fields4) o113)) (in_range7 o114)))))
(assert (=> (= result26 true) (=> (not (= result27 true)) (= o114 0))))
(assert (=> (= result26 true) (and (= temp___429 (get (rec__list_allocator__m__t__allocated model____split_fields4) j4)) (in_range7 temp___429))))
(assert (=> (= result26 true) (and (<= 1 temp___429) (<= temp___429 3))))
(assert (=> (= result26 true) (= o108 temp___429)))
(assert (=> (= result26 true) (= o109 (select data4 o108))))
(assert (=> (= result26 true) (= o110 (us_split_fields1 o109))))
(assert (=> (= result26 true) (= o111 (rec__list_allocator__cell__next o110))))
(assert (=> (= result26 true) (= o115 (to_rep o111))))
(assert (=> (= result26 true) (= result25 (ite (= o115 o114) true false))))
(assert (=> (not (= result26 true)) (= result25 false)))
(assert (= result25 true))
(assert (< 1 j4))
(assert (and (= o105 (- j4 1)) (in_range2 (- j4 1))))
(assert (not (<= 1 o105)))
(check-sat)
(exit)
