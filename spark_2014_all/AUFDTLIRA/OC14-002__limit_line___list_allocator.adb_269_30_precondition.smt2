...
(assert (and (= o68 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (in_range4 o68)))
(assert (= result12 (ite (in_range7 o68) true false)))
(assert (=> (= result12 true) (and (= o64 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range3 o64))))
(assert (=> (= result12 true) (= result13 (ite (< j o64) true false))))
(assert (=> (= result12 true) (=> (= result13 true) (and (= o65 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result12 true) (=> (= result13 true) (and (= o66 (get (rec__list_allocator__m__t__allocated model____split_fields3) o65)) (in_range4 o66)))))
(assert (=> (= result12 true) (=> (not (= result13 true)) (= o66 0))))
(assert (=> (= result12 true) (and (= temp___462 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (in_range4 temp___462))))
(assert (=> (= result12 true) (and (<= 1 temp___462) (<= temp___462 3))))
(assert (=> (= result12 true) (= o60 temp___462)))
(assert (=> (= result12 true) (= o61 (select data3 o60))))
(assert (=> (= result12 true) (= o62 (us_split_fields3 o61))))
(assert (=> (= result12 true) (= o63 (rec__list_allocator__cell__next o62))))
(assert (=> (= result12 true) (= o67 (to_rep o63))))
(assert (=> (= result12 true) (= result11 (ite (= o67 o66) true false))))
(assert (=> (not (= result12 true)) (= result11 false)))
(assert (= result11 true))
(assert (< 1 j))
(assert (and (= o59 (- j 1)) (in_range2 (- j 1))))
(assert (not (<= o59 (length (rec__list_allocator__m__t__allocated model____split_fields3)))))
(check-sat)
(exit)
