...
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (length (rec__list_allocator__m__t__allocated model____split_fields3)))) (in_range4 (get (rec__list_allocator__m__t__allocated model____split_fields3) j1)))))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (length (rec__list_allocator__m__t__allocated model____split_fields3)))) (and (in_range4 (get (rec__list_allocator__m__t__allocated model____split_fields3) j1)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data3 (get (rec__list_allocator__m__t__allocated model____split_fields3) j1))))) (ite (< j1 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (get (rec__list_allocator__m__t__allocated model____split_fields3) (+ j1 1)) 0))))))
...
(assert (= result10 (ite (<= 1 j) o59 false)))
(assert (= result10 true))
(assert (and (= o69 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (in_range7 o69)))
(assert (= result12 (ite (in_range4 o69) true false)))
(assert (=> (= result12 true) (and (= o65 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range6 o65))))
(assert (=> (= result12 true) (= result13 (ite (< j o65) true false))))
(assert (=> (= result12 true) (=> (= result13 true) (and (= o66 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result12 true) (=> (= result13 true) (and (= o67 (get (rec__list_allocator__m__t__allocated model____split_fields3) o66)) (in_range7 o67)))))
(assert (=> (= result12 true) (=> (not (= result13 true)) (= o67 0))))
(assert (=> (= result12 true) (and (= temp___462 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (in_range7 temp___462))))
(assert (=> (= result12 true) (and (<= 1 temp___462) (<= temp___462 3))))
(assert (=> (= result12 true) (= o61 temp___462)))
(assert (=> (= result12 true) (= o62 (select data3 o61))))
(assert (=> (= result12 true) (= o63 (us_split_fields1 o62))))
(assert (=> (= result12 true) (= o64 (rec__list_allocator__cell__next o63))))
(assert (=> (= result12 true) (= o68 (to_rep o64))))
(assert (=> (= result12 true) (= result11 (ite (= o68 o67) true false))))
(assert (=> (not (= result12 true)) (= result11 false)))
(assert (= result11 true))
(assert (< 1 j))
(assert (and (= o60 (- j 1)) (in_range2 (- j 1))))
(assert (not (<= 1 o60)))
(check-sat)
(exit)
