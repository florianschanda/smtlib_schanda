...
(declare-const j Int)
(declare-const loops_static__loop9__result Bool)
...
(declare-const loops_static__loop9__result1 Bool)
...
(declare-const loops_static__loop9__result2 Bool)
(declare-const bad4 Bool)
(declare-const j7 Int)
(declare-const loops_static__loop9__result3 Bool)
...
(declare-const loops_static__loop9__result4 Bool)
(declare-const bad7 Bool)
(declare-const j11 Int)
(declare-const loops_static__loop9__result5 Bool)
...
(assert (= o1 i1))
(assert (= o2 (store r1 o1 o)))
(assert (= r1 result2))
(assert (= r2 o2))
(assert (not (= i1 (to_rep1 (last (rt a))))))
(assert (= (mk_bool__ref loops_static__loop9__result2) (mk_bool__ref loops_static__loop9__result)))
(assert (= (mk_int__ref j6) (mk_int__ref j)))
(assert (= (mk_bool__ref bad3) (mk_bool__ref bad)))
(assert (= loops_static__loop9__result3 loops_static__loop9__result1))
(assert (= j7 j3))
(assert (= bad4 bad1))
(assert (<= (to_rep1 (first (rt a))) j1))
(assert (<= j1 i1))
(assert (not (<= (to_rep1 r__first) j1)))
(check-sat)
(exit)
