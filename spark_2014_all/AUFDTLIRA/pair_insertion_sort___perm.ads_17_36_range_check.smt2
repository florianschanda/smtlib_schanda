...
(assert (=> (not (= (length a) 0)) (=> (= result true) (and (= o11 (remove_last a)) (and (dynamic_invariant1 o11 true false true) (and (= (elts a) o3) (= (mk (to_rep (first2 (mk1 (to_rep (first (rt a))) (- (to_rep (last (rt a))) 1)))) (to_rep (last2 (mk1 (to_rep (first (rt a))) (- (to_rep (last (rt a))) 1))))) o4)))))))
...
(assert (=> (not (= (length a) 0)) (=> (not (= result true)) (and (= o10 (remove_last a)) (and (dynamic_invariant1 o10 true false true) (and (= (elts a) o7) (= (mk (to_rep (first2 (mk1 (to_rep (first (rt a))) (- (to_rep (last (rt a))) 1)))) (to_rep (last2 (mk1 (to_rep (first (rt a))) (- (to_rep (last (rt a))) 1))))) o8)))))))
