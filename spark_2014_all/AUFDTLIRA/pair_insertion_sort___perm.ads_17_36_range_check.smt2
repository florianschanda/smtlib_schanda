...
(assert (=> (not (= (length a) 0)) (=> (= result true) (and (= (mk___t o3 o4) (remove_last a)) (and (dynamic_invariant1 (mk___t o3 o4) true false true) (and (= (elts a) o3) (= (mk (to_rep (first2 (mk1 (to_rep (first (rt a))) (- (to_rep (last (rt a))) 1)))) (to_rep (last2 (mk1 (to_rep (first (rt a))) (- (to_rep (last (rt a))) 1))))) o4)))))))
(assert (=> (not (= (length a) 0)) (=> (= result true) (and (= o5 (occ_def (mk___t o3 o4) e)) (and (in_range2 o5) (and (= o5 (ite (= (length (mk___t o3 o4)) 0) 0 (ite (= (to_rep (select o3 (to_rep (last o4)))) e) (+ (occ_def (remove_last (mk___t o3 o4)) e) 1) (occ_def (remove_last (mk___t o3 o4)) e)))) (<= o5 (length (mk___t o3 o4)))))))))
(assert (=> (not (= (length a) 0)) (=> (= result true) (= o6 (+ o5 1)))))
(assert (=> (not (= (length a) 0)) (=> (= result true) (and (= o9 o6) (in_range o6)))))
(assert (=> (not (= (length a) 0)) (=> (not (= result true)) (and (= (mk___t o7 o8) (remove_last a)) (and (dynamic_invariant1 (mk___t o7 o8) true false true) (and (= (elts a) o7) (= (mk (to_rep (first2 (mk1 (to_rep (first (rt a))) (- (to_rep (last (rt a))) 1)))) (to_rep (last2 (mk1 (to_rep (first (rt a))) (- (to_rep (last (rt a))) 1))))) o8)))))))
(assert (=> (not (= (length a) 0)) (=> (not (= result true)) (and (= o9 (occ_def (mk___t o7 o8) e)) (and (in_range2 o9) (and (= o9 (ite (= (length (mk___t o7 o8)) 0) 0 (ite (= (to_rep (select o7 (to_rep (last o8)))) e) (+ (occ_def (remove_last (mk___t o7 o8)) e) 1) (occ_def (remove_last (mk___t o7 o8)) e)))) (<= o9 (length (mk___t o7 o8)))))))))
