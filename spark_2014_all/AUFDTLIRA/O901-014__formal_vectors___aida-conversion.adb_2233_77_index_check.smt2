...
(assert (<= temp___2536 index1))
(assert (<= index1 temp___2537))
...
(assert (and (and (forall ((temp___2534 Int)) (=> (and (<= (to_rep1 n__first) temp___2534) (<= temp___2534 (to_rep1 n__last))) (=> (< index2 temp___2534) (= (select n3 temp___2534) (select n1 temp___2534))))) (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 2)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 2) index2))) (and (<= (+ (to_rep1 (first (rt source))) 1) index2) (<= index2 (+ (to_rep1 (first (rt source))) 2)))))
