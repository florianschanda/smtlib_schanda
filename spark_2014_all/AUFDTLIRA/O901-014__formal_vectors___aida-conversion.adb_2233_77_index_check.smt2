...
(assert (<= temp___2434 index2))
(assert (<= index2 temp___2435))
...
(assert (and (and (forall ((temp___2432 Int)) (=> (and (<= (to_rep1 n__first) temp___2432) (<= temp___2432 (to_rep1 n__last))) (=> (< index3 temp___2432) (= (select n3 temp___2432) (select n1 temp___2432))))) (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 2)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 2) index3))) (and (<= (+ (to_rep1 (first (rt source))) 1) index3) (<= index3 (+ (to_rep1 (first (rt source))) 2)))))
