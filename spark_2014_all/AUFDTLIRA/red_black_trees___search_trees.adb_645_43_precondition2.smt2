...
(assert (and (= o6 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) (in_range7 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))))))
