...
(assert (= result6 (ite (= o52 (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)))) true false)))
(assert (= result6 true))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
...
(assert (= result8 (ite (= o51 0) true false)))
(assert (= result8 true))
...
(assert (=> (not (= (int__content v2) 0)) (and (= o49 (int__content v2)) (in_range1 (int__content v2)))))
...
(assert (=> (not (= (int__content v2) 0)) (and (= result14 (valid_root (mk___rep2 (us_split_fields__content2 f__split_fields7)) o50)) (and (= (= result14 true) (and (<= o50 (to_rep (rec__binary_trees__forest__s (us_split_fields__content2 f__split_fields7)))) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) o50)))) 2))) (=> (< (size (mk___rep2 (us_split_fields__content2 f__split_fields7))) o50) (not (= result14 true)))))))
