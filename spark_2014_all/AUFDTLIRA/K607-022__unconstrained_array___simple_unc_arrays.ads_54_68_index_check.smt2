...
(assert (= i10 i8))
(assert (= res11 res9))
(assert (= (= result5 true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))))) (<= (to_rep1 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) j1)) simple_unc_arrays__max__result4)))))
(assert (= result5 true))
(assert (<= 1 j))
