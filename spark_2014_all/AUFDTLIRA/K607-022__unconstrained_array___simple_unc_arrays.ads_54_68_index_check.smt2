...
(assert (= (= result6 true) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))))) (<= (to_rep1 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) j3)) simple_unc_arrays__max__result4)))))
(assert (= result6 true))
(assert (<= 1 j1))
