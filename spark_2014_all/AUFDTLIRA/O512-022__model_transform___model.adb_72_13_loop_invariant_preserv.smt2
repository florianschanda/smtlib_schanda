...
(assert (and (= temp___443 (owned_transition sm)) (= temp___443 (rec__model__uml_state_machine__owned_transition_data (us_split_fields5 sm)))))
(assert (= o27 (select temp___443 s12)))
(assert (and (= o28 (from o27)) (and (in_range2 o28) (= o28 (to_rep1 (rec__model__uml_transition__from_data (us_split_fields3 o27)))))))
(assert (and (= (from__2 (mk___rep4 model__set_from__2__self__fields)) o28) (= (to__2 (mk___rep4 model__set_from__2__self__fields)) (to__2 (mk___rep4 (us_split_fields9 (select cfv2 s12)))))))
(assert (= result7 (mk_map__ref3 cfv2)))
(assert (= cfv3 (store cfv2 s12 (mk___rep4 model__set_from__2__self__fields))))
(assert (and (= temp___444 (owned_transition sm)) (= temp___444 (rec__model__uml_state_machine__owned_transition_data (us_split_fields5 sm)))))
(assert (= o29 (select temp___444 s12)))
(assert (and (= o30 (to__ o29)) (and (in_range2 o30) (= o30 (to_rep1 (rec__model__uml_transition__to_data (us_split_fields3 o29)))))))
(assert (and (= (to__2 (mk___rep4 model__set_to__2__self__fields)) o30) (= (from__2 (mk___rep4 model__set_to__2__self__fields)) (from__2 (mk___rep4 (us_split_fields9 (select cfv3 s12)))))))
(assert (= result8 (mk_map__ref3 cfv3)))
(assert (= cfv4 (store cfv3 s12 (mk___rep4 model__set_to__2__self__fields))))
(assert (not (= s12 100)))
(assert (= result9 (mk_int__ref s12)))
(assert (= s13 (+ s12 1)))
(assert (= s14 (mk_int__ref s13)))
...
(assert (<= 0 t2))
(assert (<= t2 (- (int__content s14) 1)))
(assert (not (= (name (select (owned_state sm) (from (select (owned_transition sm) t2)))) (name__2 (select (map__content2 av8) (from__2 (select (map__content3 cfv5) t2)))))))
(check-sat)
(exit)
