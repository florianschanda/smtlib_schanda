...
(assert (and (= temp___482 (owned_transition sm)) (= temp___482 (rec__model__uml_state_machine__owned_transition_data (us_split_fields5 sm)))))
(assert (= o6 (select temp___482 s9)))
...
(assert (and (= temp___483 (owned_transition sm)) (= temp___483 (rec__model__uml_state_machine__owned_transition_data (us_split_fields5 sm)))))
(assert (= o8 (select temp___483 s9)))
