...
(declare-const temp___1224 us_t2)
...
(assert (and (= o16 (length2 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t1 to____split_fields1 to____split_fields2))))) (and (in_range4 o16) (= o16 (to_rep2 to____split_fields)))))
(assert (= o17 (+ o16 1)))
(assert (and (= o18 (length2 (mk___rep to____split_discrs (us_split_fields__content to____split_fields5)))) (and (in_range4 o18) (= o18 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields__content to____split_fields5)))))))
(assert (= o19 (ite (= o18 o17) true false)))
(assert (and (= temp___1224 (value (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t1 to____split_fields1 to____split_fields2))))) (and (dynamic_invariant2 temp___1224 true false true true) (and (= temp___1224 (mk___t2 to____split_fields1 (mk2 (to_rep1 (first6 (mk3 1 (to_rep2 to____split_fields)))) (to_rep1 (last6 (mk3 1 (to_rep2 to____split_fields))))))) (and (and (and (= (length3 temp___1224) (length2 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t1 to____split_fields1 to____split_fields2))))) (= (to_rep1 (first4 (rt2 temp___1224))) 1)) (= (to_rep1 (last4 (rt2 temp___1224))) (length2 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t1 to____split_fields1 to____split_fields2)))))) (= (< 0 (length2 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t1 to____split_fields1 to____split_fields2))))) (not (= (empty (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t1 to____split_fields1 to____split_fields2)))) true))))))))
(assert (not (= (length3 temp___1224) 0)))
(assert (=> (<= (to_rep1 (first4 (rt2 temp___1224))) (to_rep1 (last4 (rt2 temp___1224)))) (= o12 (+ (- (to_rep1 (last4 (rt2 temp___1224))) (to_rep1 (first4 (rt2 temp___1224)))) 1))))
(assert (=> (not (<= (to_rep1 (first4 (rt2 temp___1224))) (to_rep1 (last4 (rt2 temp___1224))))) (= o12 0)))
(assert (= o13 (+ o12 1)))
(assert (= o14 (+ (to_rep1 (first4 (rt2 temp___1224))) o13)))
(assert (= o15 (- o14 1)))
