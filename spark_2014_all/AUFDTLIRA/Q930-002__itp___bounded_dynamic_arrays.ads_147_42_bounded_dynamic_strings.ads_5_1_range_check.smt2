...
(assert (and (= o17 (length3 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2))))) (and (in_range5 o17) (= o17 (to_rep2 to____split_fields)))))
(assert (= o18 (+ o17 1)))
(assert (and (= o19 (length3 (mk___rep to____split_discrs (us_split_fields__content to____split_fields5)))) (and (in_range5 o19) (= o19 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields__content to____split_fields5)))))))
(assert (= o20 (ite (= o19 o18) true false)))
(assert (and (= temp___1155 (value (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2))))) (and (dynamic_invariant4 temp___1155 true false true) (and (= temp___1155 (mk___t1 to____split_fields1 (mk1 (to_rep1 (first6 (mk3 1 (to_rep2 to____split_fields)))) (to_rep1 (last6 (mk3 1 (to_rep2 to____split_fields))))))) (and (and (and (= (length1 temp___1155) (length3 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2))))) (= (to_rep1 (first2 (rt1 temp___1155))) 1)) (= (to_rep1 (last2 (rt1 temp___1155))) (length3 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2)))))) (= (< 0 (length3 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2))))) (not (= (empty (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t2 to____split_fields1 to____split_fields2)))) true))))))))
(assert (not (= (length1 temp___1155) 0)))
(assert (=> (<= (to_rep1 (first2 (rt1 temp___1155))) (to_rep1 (last2 (rt1 temp___1155)))) (= o12 (+ (- (to_rep1 (last2 (rt1 temp___1155))) (to_rep1 (first2 (rt1 temp___1155)))) 1))))
(assert (=> (not (<= (to_rep1 (first2 (rt1 temp___1155))) (to_rep1 (last2 (rt1 temp___1155))))) (= o12 0)))
(assert (= o13 (+ o12 1)))
(assert (= o14 (+ (to_rep1 (first2 (rt1 temp___1155))) o13)))
(assert (= o15 (- o14 1)))
