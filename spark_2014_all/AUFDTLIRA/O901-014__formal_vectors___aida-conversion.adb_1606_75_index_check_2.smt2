...
(assert (and (= (length source) 11) (and (and (and (and (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 50)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 49)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 3))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 4))) 55)) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 5))) 52)) (forall ((index2 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 5) index2) (<= index2 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index2))) true))))))
