...
(assert (not (= (ite (<= (to_rep1 (first6 temp___10251)) (to_rep1 (last7 temp___10251))) (+ (- (to_rep1 (last7 temp___10251)) (to_rep1 (first6 temp___10251))) 1) 0) (ite (<= (to_rep1 (first6 temp___10291)) (to_rep1 (last7 temp___10291))) (+ (- (to_rep1 (last7 temp___10291)) (to_rep1 (first6 temp___10291))) 1) 0))))
(check-sat)
(exit)
