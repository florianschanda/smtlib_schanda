...
(declare-fun temp___3490 ((Array Int (Array Int (Array Int et1))) Int (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1))))
(declare-fun temp___3496 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
(declare-fun temp___3502 ((Array Int et1) Int Int) (Array Int et1))
...
(assert (forall ((temp___3492 (Array Int (Array Int (Array Int et1))))) (forall ((temp___3493 Int)) (forall ((temp___3494 (Array Int (Array Int et1)))) (let ((temp___3491 (temp___3490 temp___3492 temp___3493 temp___3494))) (=> (dynamic_invariant2 temp___3493 true true true true) (forall ((temp___3495 Int)) (ite (= temp___3495 temp___3493) (= (select temp___3491 temp___3495) temp___3494) (= (select temp___3491 temp___3495) (select temp___3492 temp___3495))))))))))
(assert (forall ((temp___3498 (Array Int (Array Int et1)))) (forall ((temp___3499 Int)) (forall ((temp___3500 (Array Int et1))) (let ((temp___3497 (temp___3496 temp___3498 temp___3499 temp___3500))) (=> (dynamic_invariant1 temp___3499 true true true true) (forall ((temp___3501 Int)) (ite (= temp___3501 temp___3499) (= (select temp___3497 temp___3501) temp___3500) (= (select temp___3497 temp___3501) (select temp___3498 temp___3501))))))))))
(assert (forall ((temp___3504 (Array Int et1))) (forall ((temp___3505 Int) (temp___3506 Int)) (let ((temp___3503 (temp___3502 temp___3504 temp___3505 temp___3506))) (=> (and (dynamic_invariant temp___3505 true true true true) (dynamic_invariant3 temp___3506 true true true true)) (forall ((temp___3507 Int)) (ite (= temp___3507 temp___3505) (= (to_rep (select temp___3503 temp___3507)) temp___3506) (= (select temp___3503 temp___3507) (select temp___3504 temp___3507)))))))))
