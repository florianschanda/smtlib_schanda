...
(assert (= (to_rep o10) r2))
(assert (= o11 (store b2 i o10)))
(assert (= b2 result1))
(assert (= b3 o11))
(assert (not (= (to_rep (select c i)) r2)))
(assert (and (= o12 (copy_until b3 i c)) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 i)) (= (to_rep (select o12 j3)) (to_rep (select b3 j3)))))))
