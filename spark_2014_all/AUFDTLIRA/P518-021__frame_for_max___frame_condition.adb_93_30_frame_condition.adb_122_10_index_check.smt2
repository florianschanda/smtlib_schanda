...
(assert (= (= o32 true) (forall ((i6 Int)) (=> (and (<= k2 i6) (<= i6 first3)) (forall ((j4 Int)) (=> (and (<= i6 j4) (<= j4 first3)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a2 j4)))) (get_max_left i6 a2))))))))
(assert (<= first3 i2))
(assert (<= i2 k2))
(assert (<= i2 j))
(assert (<= j k2))
(assert (and (= o28 j) (in_range3 j)))
(assert (and (= o29 (get_max_left o28 a2)) (and (in_range2 o29) (= o29 (to_rep (rec__frame_condition__cell__max_left (us_split_fields1 (select a2 o28))))))))
