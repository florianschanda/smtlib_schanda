...
(assert (forall ((temp___247 us_t)) (forall ((temp___248 Int) (temp___249 Int) (temp___250 Int) (temp___251 Int) (temp___252 Int) (temp___253 Int) (temp___254 Int)) (let ((temp___246 (temp___245 temp___247 temp___248 temp___249 temp___250 temp___251 temp___252 temp___253 temp___254))) (and (and (= (first1 temp___246) (first1 temp___247)) (= (last1 temp___246) (last1 temp___247))) (forall ((temp___255 Int)) (ite (or (and (<= temp___251 temp___255) (<= temp___255 temp___252)) (= temp___255 temp___253)) (= (select (to_array temp___246) temp___255) (of_rep1 temp___254)) (ite (and (<= temp___248 temp___255) (<= temp___255 temp___249)) (= (select (to_array temp___246) temp___255) (of_rep1 temp___250)) (= (select (to_array temp___246) temp___255) (select (to_array temp___247) temp___255))))))))))
(declare-fun temp___422 (us_t Int Int Int Int Int Int Int) us_t)
(assert (forall ((temp___424 us_t)) (forall ((temp___425 Int) (temp___426 Int) (temp___427 Int) (temp___428 Int) (temp___429 Int) (temp___430 Int) (temp___431 Int)) (let ((temp___423 (temp___422 temp___424 temp___425 temp___426 temp___427 temp___428 temp___429 temp___430 temp___431))) (and (and (= (first1 temp___423) (first1 temp___424)) (= (last1 temp___423) (last1 temp___424))) (forall ((temp___432 Int)) (ite (or (and (<= temp___428 temp___432) (<= temp___432 temp___429)) (= temp___432 temp___430)) (= (select (to_array temp___423) temp___432) (of_rep1 temp___431)) (ite (and (<= temp___425 temp___432) (<= temp___432 temp___426)) (= (select (to_array temp___423) temp___432) (of_rep1 temp___427)) (= (select (to_array temp___423) temp___432) (select (to_array temp___424) temp___432))))))))))
...
(declare-const temp___433 (Array Int integer))
(declare-const temp___4331 t)
(declare-const temp___434 (Array Int integer))
(declare-const temp___4341 t)
...
(assert (and (= us3 l) (dynamic_property1 (to_rep a__first) (to_rep a__last) l)))
(assert (= o l))
(assert (and (= us2 k) (dynamic_property1 (to_rep a__first) (to_rep a__last) k)))
(assert (= o1 k))
(assert (and (= us1 j) (dynamic_property1 (to_rep a__first) (to_rep a__last) j)))
(assert (= o2 j))
