...
(assert (=> (not (= (= (length model____split_fields) 0) true)) (and (= (is_prepend (rec__list_allocator__m__t__available (us_split_fields__content1 model____split_fields5)) (int__content res3) model____split_fields) true) (= (is_prepend model____split_fields1 (int__content res3) (rec__list_allocator__m__t__allocated (us_split_fields__content1 model____split_fields5))) true))))
