...
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (to_rep2 (rec__simple_unc_arrays__table__last t3__split_discrs)))) (= (to_rep3 (select (rec__simple_unc_arrays__table__v3 t3__split_fields1) i1)) 9))))
(assert (and (= o15 (bubble_sort (mk___rep t1__split_discrs t1__split_fields2))) (and (dynamic_invariant o15 true false true) (and (forall ((j Int)) (=> (and (<= 1 j) (<= j (- (to_rep2 (rec__simple_unc_arrays__table__last t1__split_discrs)) 1))) (<= (to_rep3 (select (elts1 (rec__simple_unc_arrays__table__v (us_split_fields1 o15))) j)) (to_rep3 (select (elts1 (rec__simple_unc_arrays__table__v (us_split_fields1 o15))) (+ j 1)))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (to_rep2 (rec__simple_unc_arrays__table__last t1__split_discrs)))) (exists ((k Int)) (and (and (<= 1 k) (<= k (to_rep2 (rec__simple_unc_arrays__table__last t1__split_discrs)))) (= (to_rep3 (select (elts1 (rec__simple_unc_arrays__table__v t1__split_fields2)) j)) (to_rep3 (select (elts1 (rec__simple_unc_arrays__table__v (us_split_fields1 o15))) k)))))))))))
(assert (not (= 10 (to_rep2 (rec__simple_unc_arrays__table__last (us_split_discrs1 o15))))))
(check-sat)
(exit)
