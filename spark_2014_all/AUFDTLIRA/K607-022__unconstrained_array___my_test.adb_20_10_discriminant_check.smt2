...
(define-fun o14 () us_rep (mk___rep (mk___split_discrs o11) (mk___split_fields (mk___t1 o12 o13))))
(define-fun o15 () us_rep (mk___rep (mk___split_discrs o5) (mk___split_fields (mk___t1 o6 o7))))
...
(assert (and (= o15 (add (mk___rep t1__split_discrs t1__split_fields2) (mk___rep t2__split_discrs t2__split_fields2))) (and (dynamic_invariant o15 true false true true) (and (= (same_range o15 (mk___rep t1__split_discrs t1__split_fields2)) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j (to_rep2 (rec__simple_unc_arrays__table__last t1__split_discrs)))) (= (to_rep3 (select o6 j)) (+ (to_rep3 (select (elts1 (rec__simple_unc_arrays__table__v t1__split_fields2)) j)) (to_rep3 (select (elts1 (rec__simple_unc_arrays__table__v t2__split_fields2)) j))))))))))
(assert (= (mk___rep (mk___split_discrs o8) (mk___split_fields (mk___t1 o9 o10))) o15))
...
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i (to_rep2 (rec__simple_unc_arrays__table__last t3__split_discrs)))) (= (to_rep3 (select (rec__simple_unc_arrays__table__v3 t3__split_fields1) i)) 9))))
(assert (and (= o14 (bubble_sort (mk___rep t1__split_discrs t1__split_fields2))) (and (dynamic_invariant o14 true false true true) (and (forall ((j Int)) (=> (and (<= 1 j) (<= j (- (to_rep2 (rec__simple_unc_arrays__table__last t1__split_discrs)) 1))) (<= (to_rep3 (select o12 j)) (to_rep3 (select o12 (+ j 1)))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (to_rep2 (rec__simple_unc_arrays__table__last t1__split_discrs)))) (exists ((k Int)) (and (and (<= 1 k) (<= k (to_rep2 (rec__simple_unc_arrays__table__last t1__split_discrs)))) (= (to_rep3 (select (elts1 (rec__simple_unc_arrays__table__v t1__split_fields2)) j)) (to_rep3 (select o12 k)))))))))))
(assert (not (= 10 (to_rep2 o11))))
(check-sat)
(exit)
