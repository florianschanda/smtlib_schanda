...
(declare-const bounded_dynamic_strings__Oconcat__4__result natural_index)
(declare-const bounded_dynamic_strings__Oconcat__4__result1 natural_index)
(declare-const bounded_dynamic_strings__Oconcat__4__result2 (Array Int character))
(declare-const bounded_dynamic_strings__Oconcat__4__result3 t2)
(declare-const us Int)
(declare-const temp___997 (Array Int character))
(declare-const temp___9971 t1)
...
(declare-const temp___998 (Array Int character))
(declare-const temp___9981 t)
...
(declare-const bounded_dynamic_strings__Oconcat__4__result4 natural_index)
(declare-const bounded_dynamic_strings__Oconcat__4__result5 natural_index)
(declare-const bounded_dynamic_strings__Oconcat__4__result6 (Array Int character))
(declare-const bounded_dynamic_strings__Oconcat__4__result7 t2)
(declare-const bounded_dynamic_strings__Oconcat__4__result8 sequence__ref)
(declare-const bounded_dynamic_strings__Oconcat__4__result9 us_rep)
(declare-const bounded_dynamic_strings__Oconcat__4__result10 sequence__ref)
(declare-const bounded_dynamic_strings__Oconcat__4__result11 us_rep)
(assert (dynamic_invariant1 i52s true false true))
(assert (dynamic_invariant1 left true false true))
(assert (in_range4 right))
(assert (<= (+ (length3 left) 1) 2147483647))
(assert (not (in_range5 (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 left))))))
(check-sat)
(exit)
