...
(assert (=> (= result26 true) (and (= o35 (root (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)))) (and (in_range3 o35) (= o35 (to_rep1 t__split_fields))))))
(assert (=> (= result26 true) (type_invariant1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))))
(assert (=> (= result26 true) (and (= o36 (root (mk___rep3 (us_split_fields__content3 t__split_fields14)))) (and (in_range3 o36) (= o36 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields__content3 t__split_fields14))))))))
...
(assert (=> (= result25 true) (and (= o34 (size1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))) (and (in_range4 o34) (= o34 (size (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14))))))))
(assert (=> (= result25 true) (= result24 (ite (= o34 (+ (size1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3))) 1)) true false))))
