...
(assert (and (= o64 (length (rec__list_allocator__m__t__allocated model____split_fields4))) (in_range6 o64)))
(assert (= o65 (ite (<= j1 o64) true false)))
(assert (= result13 (ite (<= 1 j1) o65 false)))
