...
(assert (forall ((a us_t)) (forall ((e Int)) (! (=> (and (dynamic_invariant1 a true true true true) (dynamic_invariant e true true true true)) (= (occ_def a e) (ite (= (length a) 0) 0 (ite (= (to_rep1 (select (to_array a) (last1 a))) e) (+ (occ_def (remove_last a) e) 1) (occ_def (remove_last a) e))))) :pattern ((occ_def a e))))))
...
(assert (forall ((a1 us_t)) (! (=> (dynamic_invariant1 a1 true true true true) (= (remove_last a1) (let ((temp___184 (let ((temp___183 (- (last1 a1) 1))) (let ((temp___182 (first1 a1))) (of_array1 (to_array a1) temp___182 temp___183))))) (of_array (to_array1 temp___184) (first3 temp___184) (last3 temp___184))))) :pattern ((remove_last a1)))))
...
(assert (and (= o (occ_def a e)) (and (in_range3 o) (and (= o (ite (= (length a) 0) 0 (ite (= (to_rep1 (select (elts a) (to_rep (last (rt a))))) e) (+ (occ_def (remove_last a) e) 1) (occ_def (remove_last a) e)))) (<= o (length a))))))
