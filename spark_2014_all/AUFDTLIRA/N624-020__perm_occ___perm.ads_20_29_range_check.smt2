...
(assert (forall ((a us_t)) (forall ((e Int)) (! (=> (and (dynamic_invariant1 a true true true) (dynamic_invariant e true true true)) (= (occ_def a e) (ite (= (length a) 0) 0 (ite (= (to_rep1 (select (to_array a) (last1 a))) e) (+ (occ_def (remove_last a) e) 1) (occ_def (remove_last a) e))))) :pattern ((occ_def a e))))))
...
(assert (forall ((a1 us_t)) (! (=> (dynamic_invariant1 a1 true true true) (= (remove_last a1) (let ((temp___159 (let ((temp___158 (- (last1 a1) 1))) (let ((temp___157 (first1 a1))) (of_array1 (to_array a1) temp___157 temp___158))))) (of_array (to_array1 temp___159) (first3 temp___159) (last3 temp___159))))) :pattern ((remove_last a1)))))
