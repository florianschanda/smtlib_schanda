...
(declare-const temp___7925 (Array Int et1))
(declare-const temp___79251 enum2t)
...
(assert (= temp___7925 o2))
(assert (= temp___79251 o3))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= temp___7925 r__split_fields2))
(assert (= temp___79251 r__split_fields3))
...
(assert (<= 1 n))
(assert (<= n 10))
(assert (not (in_range2 (to_rep (select r__split_fields4 n)))))
(check-sat)
(exit)
