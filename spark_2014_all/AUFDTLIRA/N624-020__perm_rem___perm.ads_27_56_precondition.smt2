...
(declare-const temp___565 (Array Int natural))
(declare-const temp___5651 t)
(declare-const temp___564 (Array Int natural))
(declare-const temp___5641 t)
...
(assert (and (and (and (and (= (mk___t perm__remove_eq__aa__assume perm__remove_eq__aa__assume1) (remove a i)) (and (dynamic_invariant1 (mk___t perm__remove_eq__aa__assume perm__remove_eq__aa__assume1) true false true) (and (= (invariant__ (mk___t perm__remove_eq__aa__assume perm__remove_eq__aa__assume1)) true) (and (= (to_rep1 (last perm__remove_eq__aa__assume1)) (- (to_rep1 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- i 1))) (= (to_rep (select (elts a) k)) (to_rep (select perm__remove_eq__aa__assume k))))) (and (forall ((k Int)) (=> (and (<= (+ i 1) k) (<= k (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select perm__remove_eq__aa__assume (- k 1)))))) (forall ((k Int)) (=> (and (<= i k) (<= k (- (to_rep1 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select perm__remove_eq__aa__assume k))))))))))) (= (mk___t perm__remove_eq__aa__assume perm__remove_eq__aa__assume1) aa)) (and (dynamic_invariant1 aa true false true) (and (and (and (= (mk___t perm__remove_eq__bb__assume perm__remove_eq__bb__assume1) (remove b i)) (and (dynamic_invariant1 (mk___t perm__remove_eq__bb__assume perm__remove_eq__bb__assume1) true false true) (and (= (invariant__ (mk___t perm__remove_eq__bb__assume perm__remove_eq__bb__assume1)) true) (and (= (to_rep1 (last perm__remove_eq__bb__assume1)) (- (to_rep1 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- i 1))) (= (to_rep (select (elts b) k)) (to_rep (select perm__remove_eq__bb__assume k))))) (and (forall ((k Int)) (=> (and (<= (+ i 1) k) (<= k (to_rep1 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select perm__remove_eq__bb__assume (- k 1)))))) (forall ((k Int)) (=> (and (<= i k) (<= k (- (to_rep1 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select perm__remove_eq__bb__assume k))))))))))) (= (mk___t perm__remove_eq__bb__assume perm__remove_eq__bb__assume1) bb)) (and (dynamic_invariant1 bb true false true) (and (forall ((j2 Int)) (=> (and (<= (to_rep1 (first (rt a))) j2) (<= j2 (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) j2)) (to_rep (select (elts b) j2))))) (and (forall ((j2 Int)) (=> (and (<= (to_rep1 (first (rt aa))) j2) (<= j2 (to_rep1 (last (rt aa))))) (ite (< j2 i) (and (= (to_rep (select (elts aa) j2)) (to_rep (select (elts a) j2))) (= (to_rep (select (elts aa) j2)) (to_rep (select (elts b) j2)))) (and (= (to_rep (select (elts aa) j2)) (to_rep (select (elts a) (+ j2 1)))) (= (to_rep (select (elts aa) j2)) (to_rep (select (elts b) (+ j2 1)))))))) (and (and (= perm__remove_eq__result1 perm__remove_eq__result2) (= perm__remove_eq__result3 perm__remove_eq__result1)) (and (= (mk_int__ref result2) (mk_int__ref perm__remove_eq__result)) (= perm__remove_eq__result1 1))))))))) (and (= (mk_int__ref perm__remove_eq__result4) (mk_int__ref perm__remove_eq__result2)) (= perm__remove_eq__result5 perm__remove_eq__result3))))
(assert (= (of_int perm__remove_eq__result4) true))
