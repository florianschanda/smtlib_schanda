...
(define-fun o22 () us_rep3 (mk___rep1 (mk___split_fields1 o17 o18)))
(define-fun o23 () us_rep3 (mk___rep1 (mk___split_fields1 o13 o14)))
...
(assert (and (= o22 (model__ (map__content data6) first_available1)) (= (model_is_well_formed o22 (map__content data6) first_available1) true)))
(assert (= o19 (mk___split_fields1 o17 o18)))
(assert (= o20 (rec__list_mod_allocator__m__t__available o19)))
(assert (and (= o21 (length o20)) (and (in_range4 o21) (<= (+ 0 o21) 2147483647))))
