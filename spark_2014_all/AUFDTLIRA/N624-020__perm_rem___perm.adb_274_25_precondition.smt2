...
(assert (and (= o17 (remove b ib2)) (and (dynamic_invariant2 o17 true false true true) (and (= (invariant__ o17) true) (and (= (to_rep2 (last (rt o17))) (- (to_rep2 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib2 1))) (= (to_rep (select (elts b) k)) (to_rep (select (elts o17) k))))) (and (forall ((k Int)) (=> (and (<= (+ ib2 1) k) (<= k (to_rep2 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select (elts o17) (- k 1)))))) (forall ((k Int)) (=> (and (<= ib2 k) (<= k (- (to_rep2 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select (elts o17) k))))))))))))
(assert (and (= o18 (remove o17 (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))))) (and (dynamic_invariant2 o18 true false true true) (and (= (invariant__ o18) true) (and (= (to_rep2 (last (rt o18))) (- (to_rep2 (last (rt o17))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1))) (= (to_rep (select (elts o17) k)) (to_rep (select (elts o18) k))))) (and (forall ((k Int)) (=> (and (<= (+ (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1) k) (<= k (to_rep2 (last (rt o17))))) (= (to_rep (select (elts o17) k)) (to_rep (select (elts o18) (- k 1)))))) (forall ((k Int)) (=> (and (<= (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) k) (<= k (- (to_rep2 (last (rt o17))) 1))) (= (to_rep (select (elts o17) (+ k 1))) (to_rep (select (elts o18) k))))))))))))
