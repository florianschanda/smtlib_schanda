...
(assert (= values2 o15))
(assert (not (= (is_set (mk___t interm1 (mk (to_rep1 interm__first) (to_rep1 interm__last))) y (to_rep (select (elts1 init) x)) (mk___t values2 (mk (to_rep1 values__first) (to_rep1 values__last)))) true)))
(check-sat)
(exit)
