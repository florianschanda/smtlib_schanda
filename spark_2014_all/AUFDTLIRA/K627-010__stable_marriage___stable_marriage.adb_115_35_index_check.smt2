...
(assert (forall ((temp___504 Int)) (=> (dynamic_invariant temp___504 true true true true) (forall ((temp___505 Int)) (= (to_rep1 (select (stable_marriage__invert_map__result__aggregate_def temp___504) temp___505)) temp___504)))))
...
(assert (forall ((g11 Int)) (=> (and (<= 1 g11) (<= g11 64)) (exists ((g23 Int)) (and (and (<= 1 g23) (<= g23 64)) (= (to_rep (select g2_to_g1 g23)) g11))))))
...
(assert (<= 1 g21))
(assert (<= g21 64))
(assert (forall ((prev Int)) (=> (and (<= 1 prev) (<= prev (- g22 1))) (= (to_rep1 (select result__2 (to_rep (select g2_to_g1 prev)))) prev))))
