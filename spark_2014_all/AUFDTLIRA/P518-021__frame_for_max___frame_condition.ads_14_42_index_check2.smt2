...
(assert (= o49 i))
(assert (= o50 (select (map__content a16) o49)))
(assert (= o51 (us_split_fields1 o50)))
(assert (= o52 (rec__frame_condition__cell__max_right o51)))
...
(assert (= o54 (to_rep o48)))
(assert (= o55 (ite (<= o54 o53) true false)))
