...
(assert (= result (bool_eq (elts name) (to_rep1 (first (rt name))) (to_rep1 (last (rt name))) temp___166 (to_rep1 (first2 temp___1661)) (to_rep1 (last2 temp___1661)))))
(assert (= result true))
(assert (not (in_range (+ equals_position1 1))))
(check-sat)
(exit)
