...
(assert (<= temp___2344 index1))
(assert (<= index1 temp___2345))
...
(assert (and (and (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 8)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 8) index2)) (forall ((temp___2343 Int)) (=> (and (<= (to_rep1 n__first) temp___2343) (<= temp___2343 (to_rep1 n__last))) (=> (< index2 temp___2343) (= (select n3 temp___2343) (select n1 temp___2343)))))) (and (<= (+ (to_rep1 (first (rt source))) 1) index2) (<= index2 (+ (to_rep1 (first (rt source))) 8)))))
