...
(assert (<= temp___2242 index2))
(assert (<= index2 temp___2243))
...
(assert (and (and (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 8)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 8) index3)) (forall ((temp___2241 Int)) (=> (and (<= (to_rep1 n__first) temp___2241) (<= temp___2241 (to_rep1 n__last))) (=> (< index3 temp___2241) (= (select n3 temp___2241) (select n1 temp___2241)))))) (and (<= (+ (to_rep1 (first (rt source))) 1) index3) (<= index3 (+ (to_rep1 (first (rt source))) 8)))))
