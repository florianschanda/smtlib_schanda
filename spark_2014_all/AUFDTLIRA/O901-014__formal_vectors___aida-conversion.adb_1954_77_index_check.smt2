...
(assert (and (and (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 8)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 8) index2)) (forall ((temp___2241 Int)) (=> (and (<= (to_rep1 n__first) temp___2241) (<= temp___2241 (to_rep1 n__last))) (=> (< index2 temp___2241) (= (select n3 temp___2241) (select n1 temp___2241)))))) (and (<= (+ (to_rep1 (first (rt source))) 1) index2) (<= index2 (+ (to_rep1 (first (rt source))) 8)))))
