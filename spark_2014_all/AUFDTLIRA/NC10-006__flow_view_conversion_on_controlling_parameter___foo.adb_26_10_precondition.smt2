...
(assert (and (= (log_size1 log__attr__tag (mk___rep (mk___split_fields log__split_fields3 log__split_fields4 log__split_fields5) log__attr__tag)) 0) (init_log__specific_post log__attr__tag (mk___split_fields log__split_fields3 log__split_fields4 log__split_fields5) log__attr__tag (mk___split_fields log__split_fields log__split_fields1 log__split_fields2))))
