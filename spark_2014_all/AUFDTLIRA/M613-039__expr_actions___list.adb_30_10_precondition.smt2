...
(assert (not (< (length2 (mk___rep1 res__split_discrs (mk___split_fields1 res__split_fields))) (capacity (mk___rep1 res__split_discrs (mk___split_fields1 res__split_fields))))))
(check-sat)
(exit)
