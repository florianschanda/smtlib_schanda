...
(assert (and (= temp___2007 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 (first (rt source))) temp___2007) (<= temp___2007 (to_rep1 (last (rt source))))))
