...
(assert (and (= o16 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (= o19 (ite (<= o16 index) true false)))
(assert (= result (ite (= o19 true) o18 false)))
(assert (= (= o20 true) (forall ((index1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 5) index1) (<= index1 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index1))) true)))))
...
(assert (= o4 temp___2110))
(assert (= o5 (select (elts source) o4)))
(assert (= o6 (to_rep o5)))
(assert (= o7 (ite (= o6 52) true false)))
(assert (and (= temp___2109 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 (first (rt source))) temp___2109) (<= temp___2109 (to_rep1 (last (rt source))))))
(assert (= o temp___2109))
