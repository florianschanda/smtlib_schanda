...
(assert (=> (and (<= 2 i1) (<= i1 r35b)) (forall ((j Int)) (=> (and (<= 1 j) (<= j (- i2 1))) (<= (to_rep1 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) j)) res2)))))
...
(assert (not (<= (to_rep1 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) j)) simple_unc_arrays__max__result4)))
(check-sat)
(exit)
