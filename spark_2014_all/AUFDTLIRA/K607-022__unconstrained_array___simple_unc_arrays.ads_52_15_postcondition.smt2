...
(assert (= result7 simple_unc_arrays__max__result4))
(declare-const j3 Int)
(assert (<= 1 j3))
(assert (<= j3 (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a)))))
(assert (not (<= (to_rep1 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) j3)) simple_unc_arrays__max__result4)))
(check-sat)
(exit)
