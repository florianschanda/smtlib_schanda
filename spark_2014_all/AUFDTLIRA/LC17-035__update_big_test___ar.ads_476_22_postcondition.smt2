...
(assert (in_range3 k))
(assert (in_range4 e))
(assert (and (and (=> (<= 1 16) (in_range3 k_next)) (and (=> (<= 0 99) (in_range4 f)) (and (= (bool_eq2 a1 1 16 (temp___5273 t1 k (temp___5279 (select t1 k) j (temp___5285 (select (select t1 k) j) i e))) 1 16) true) (and (ite (= k 16) (and (= (mk_int__ref result2) (mk_int__ref k_next)) (= k_next1 1)) (and (and (and (= o4 (+ k 1)) (in_range3 (+ k 1))) (and (= (mk_int__ref result3) (mk_int__ref k_next)) (= k_next2 o4))) (= k_next1 k_next2))) (and (ite (= e 0) (and (= result4 f) (= f1 99)) (and (and (and (= o5 (- e 1)) (in_range4 (- e 1))) (and (= result5 f) (= f2 o5))) (= f1 f2))) (and (and (and (and (= (to_rep o6) f1) (= o7 (store (select (select a1 k_next1) j) i o6))) (= o8 (store (select a1 k_next1) j o7))) (= o9 (store a1 k_next1 o8))) (and (= result6 a1) (= a2 o9)))))))) (and (and (= t1 t2) (and (= f1 f3) (and (= k_next1 k_next3) (= a2 a3)))) (and (= t3 t1) (and (= f4 f1) (and (= k_next4 k_next1) (= a4 a2)))))))
