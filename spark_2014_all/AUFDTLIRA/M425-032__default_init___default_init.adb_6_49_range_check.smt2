...
(define-fun dynamic_invariant1 ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_136)))
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__default_init__t2__a integer)))))
(define-fun us_split_fields_A__projection ((a us_split_fields)) integer (rec__default_init__t2__a a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (= (to_rep (rec__default_init__t2__a (us_split_fields1 a))) (to_rep (rec__default_init__t2__a (us_split_fields1 b)))) true false))
...
(define-fun default_initial_assumption ((temp___expr_143 us_rep) (temp___skip_top_level_144 Bool)) Bool (= (to_rep (rec__default_init__t2__a (us_split_fields1 temp___expr_143))) 100))
...
(declare-datatypes () ((tt3D1__ref (mk_tt3D1__ref (tt3D1__content tt3D1)))))
(define-fun tt3D1__ref___projection ((a tt3D1__ref)) tt3D1 (tt3D1__content a))
...
(assert (forall ((a (Array Int integer)) (b (Array Int integer))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare a a_first a_last b b_first b_last) 0) (= (bool_eq1 a a_first a_last b b_first b_last) true)) :pattern ((compare a a_first a_last b b_first b_last))))))
...
(define-fun default_initial_assumption1 ((temp___expr_150 (Array Int integer)) (temp___skip_top_level_151 Bool)) Bool (forall ((temp___152 Int)) (=> (and (<= 1 temp___152) (<= temp___152 10)) (= (to_rep (select temp___expr_150 temp___152)) 100))))
