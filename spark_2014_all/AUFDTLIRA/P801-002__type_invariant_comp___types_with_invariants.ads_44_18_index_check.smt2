...
(assert (in_range1 i))
(assert (forall ((temp___256 Int)) (=> (and (<= (to_rep1 (first (rt (rec__types_with_invariants__container__content (us_split_fields3 c))))) temp___256) (<= temp___256 (to_rep1 (last (rt (rec__types_with_invariants__container__content (us_split_fields3 c))))))) (let ((temp___141 (select (elts (rec__types_with_invariants__container__content (us_split_fields3 c))) temp___256))) (=> (= (to_rep (rec__types_with_invariants__my_integer__val (us_split_fields1 temp___141))) 0) (= (rec__types_with_invariants__my_integer__sign (us_split_fields1 temp___141)) true))))))
