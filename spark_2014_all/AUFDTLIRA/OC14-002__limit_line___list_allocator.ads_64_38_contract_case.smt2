...
(define-fun dynamic_invariant ((temp___expr_310 Int) (temp___is_init_306 Bool) (temp___skip_constant_307 Bool) (temp___do_toplevel_308 Bool) (temp___do_typ_inv_309 Bool)) Bool (=> (or (= temp___is_init_306 true) (<= 0 3)) (in_range3 temp___expr_310)))
...
(define-fun dynamic_invariant3 ((temp___expr_330 Int) (temp___is_init_326 Bool) (temp___skip_constant_327 Bool) (temp___do_toplevel_328 Bool) (temp___do_typ_inv_329 Bool)) Bool (=> (or (= temp___is_init_326 true) (<= 0 3)) (in_range7 temp___expr_330)))
(assert (forall ((s us_rep1)) (forall ((n Int)) (! (=> (and (dynamic_invariant2 n true true true true) (and (<= 1 n) (<= n (length s)))) (dynamic_invariant3 (get s n) true false true true)) :pattern ((get s n))))))
(assert (forall ((attr__tag Int) (n Int)) (forall ((s us_rep1)) (! (=> (dynamic_invariant2 n true true true true) (dynamic_invariant3 (get1 attr__tag s n) true false true true)) :pattern ((get1 attr__tag s n))))))
...
(assert (forall ((s us_rep1) (result__ us_rep1)) (forall ((e Int)) (! (=> (dynamic_invariant3 e true true true true) (= (= (is_prepend s e result__) true) (and (and (= (length result__) (+ (length s) 1)) (= (get result__ 1) e)) (forall ((m Int)) (=> (and (<= 2 m) (<= m (length result__))) (= (get result__ m) (get s (- m 1)))))))) :pattern ((is_prepend s e result__))))))
(assert true)
...
(assert (forall ((s us_rep1)) (forall ((e Int)) (! (=> (dynamic_invariant3 e true true true true) (= (is_prepend s e (prepend s e)) true)) :pattern ((prepend s e))))))
(assert true)
...
(assert (forall ((s us_rep1)) (forall ((n Int)) (! (=> (and (dynamic_invariant2 n true true true true) (and (<= 1 n) (<= n (length s)))) (= (is_removed_at s n (remove_at s n)) true)) :pattern ((remove_at s n))))))
(assert true)
...
(define-fun dynamic_invariant5 ((temp___expr_362 Int) (temp___is_init_358 Bool) (temp___skip_constant_359 Bool) (temp___do_toplevel_360 Bool) (temp___do_typ_inv_361 Bool)) Bool (=> (or (= temp___is_init_358 true) (<= 0 1)) (in_range5 temp___expr_362)))
(define-fun dynamic_invariant6 ((temp___expr_317 Int) (temp___is_init_313 Bool) (temp___skip_constant_314 Bool) (temp___do_toplevel_315 Bool) (temp___do_typ_inv_316 Bool)) Bool (=> (or (= temp___is_init_313 true) (<= 1 3)) (in_range4 temp___expr_317)))
...
(declare-const temp___428 us_rep2)
...
(define-fun res5 () int__ref (mk_int__ref res))
...
(assert (=> (not (= first_available 0)) (= result1 res5)))
(assert (=> (not (= first_available 0)) (= res1 first_available)))
(assert (=> (not (= first_available 0)) (and (<= 1 first_available) (<= first_available 3))))
(assert (=> (not (= first_available 0)) (= o first_available)))
(assert (=> (not (= first_available 0)) (= (mk___rep (mk___split_fields o1 o2 o3)) (select data o))))
(assert (=> (not (= first_available 0)) (= o1 o4)))
(assert (=> (not (= first_available 0)) (= o2 o5)))
(assert (=> (not (= first_available 0)) (= o3 o6)))
(assert (=> (not (= first_available 0)) (= o7 o6)))
(assert (=> (not (= first_available 0)) (= o8 (to_rep o7))))
(assert (=> (not (= first_available 0)) (= result2 (mk_int__ref next_avail))))
(assert (=> (not (= first_available 0)) (= next_avail2 o8)))
(assert (=> (not (= first_available 0)) (= (to_rep o9) first_allocated)))
(assert (=> (not (= first_available 0)) (= (to_rep o10) 0)))
(assert (=> (not (= first_available 0)) (= (to_rep1 o11) 1)))
(assert (=> (not (= first_available 0)) (= o11 o12)))
(assert (=> (not (= first_available 0)) (= o10 o13)))
(assert (=> (not (= first_available 0)) (= o9 o14)))
(assert (=> (not (= first_available 0)) (= o15 o12)))
(assert (=> (not (= first_available 0)) (= o16 o13)))
(assert (=> (not (= first_available 0)) (= o17 o14)))
(assert (=> (not (= first_available 0)) (and (<= 1 res1) (<= res1 3))))
(assert (=> (not (= first_available 0)) (= o18 res1)))
(assert (=> (not (= first_available 0)) (= o19 (store data o18 (mk___rep (mk___split_fields o15 o16 o17))))))
(assert (=> (not (= first_available 0)) (= result3 (mk_map__ref data))))
(assert (=> (not (= first_available 0)) (= data2 o19)))
(assert (=> (not (= first_available 0)) (=> (not (= next_avail2 0)) (= (to_rep o20) 0))))
(assert (=> (not (= first_available 0)) (=> (not (= next_avail2 0)) (= (rec__list_allocator__cell__stat (us_split_fields1 (select data2 next_avail2))) o21))))
(assert (=> (not (= first_available 0)) (=> (not (= next_avail2 0)) (= o20 o22))))
(assert (=> (not (= first_available 0)) (=> (not (= next_avail2 0)) (= (rec__list_allocator__cell__next (us_split_fields1 (select data2 next_avail2))) o23))))
(assert (=> (not (= first_available 0)) (=> (not (= next_avail2 0)) (= o24 o21))))
(assert (=> (not (= first_available 0)) (=> (not (= next_avail2 0)) (= o25 o22))))
(assert (=> (not (= first_available 0)) (=> (not (= next_avail2 0)) (= o26 o23))))
(assert (=> (not (= first_available 0)) (=> (not (= next_avail2 0)) (and (<= 1 next_avail2) (<= next_avail2 3)))))
(assert (=> (not (= first_available 0)) (=> (not (= next_avail2 0)) (= o27 next_avail2))))
(assert (=> (not (= first_available 0)) (=> (not (= next_avail2 0)) (= o28 (store data2 o27 (mk___rep (mk___split_fields o24 o25 o26)))))))
(assert (=> (not (= first_available 0)) (=> (not (= next_avail2 0)) (= result4 (mk_map__ref data2)))))
(assert (=> (not (= first_available 0)) (=> (not (= next_avail2 0)) (= data3 o28))))
(assert (=> (not (= first_available 0)) (=> (not (not (= next_avail2 0))) (= data3 data2))))
(assert (=> (not (= first_available 0)) (=> (not (= first_allocated 0)) (= (to_rep o29) first_available))))
(assert (=> (not (= first_available 0)) (=> (not (= first_allocated 0)) (= (rec__list_allocator__cell__stat (us_split_fields1 (select data3 first_allocated))) o30))))
(assert (=> (not (= first_available 0)) (=> (not (= first_allocated 0)) (= o29 o31))))
(assert (=> (not (= first_available 0)) (=> (not (= first_allocated 0)) (= (rec__list_allocator__cell__next (us_split_fields1 (select data3 first_allocated))) o32))))
(assert (=> (not (= first_available 0)) (=> (not (= first_allocated 0)) (= o33 o30))))
(assert (=> (not (= first_available 0)) (=> (not (= first_allocated 0)) (= o34 o31))))
(assert (=> (not (= first_available 0)) (=> (not (= first_allocated 0)) (= o35 o32))))
(assert (=> (not (= first_available 0)) (=> (not (= first_allocated 0)) (and (<= 1 first_allocated) (<= first_allocated 3)))))
(assert (=> (not (= first_available 0)) (=> (not (= first_allocated 0)) (= o36 first_allocated))))
(assert (=> (not (= first_available 0)) (=> (not (= first_allocated 0)) (= o37 (store data3 o36 (mk___rep (mk___split_fields o33 o34 o35)))))))
(assert (=> (not (= first_available 0)) (=> (not (= first_allocated 0)) (= result5 (mk_map__ref data3)))))
(assert (=> (not (= first_available 0)) (=> (not (= first_allocated 0)) (= data4 o37))))
(assert (=> (not (= first_available 0)) (=> (not (not (= first_allocated 0))) (= data4 data3))))
(assert (=> (not (= first_available 0)) (= result6 (mk_int__ref first_allocated))))
(assert (=> (not (= first_available 0)) (= first_allocated2 first_available)))
(assert (=> (not (= first_available 0)) (= result7 (mk_int__ref first_available))))
(assert (=> (not (= first_available 0)) (= first_available2 next_avail2)))
(assert (=> (not (= first_available 0)) (and (= o38 (remove_at model____split_fields 1)) (= (is_removed_at model____split_fields 1 o38) true))))
(assert (=> (not (= first_available 0)) (= o38 o39)))
(assert (=> (not (= first_available 0)) (= model____split_fields1 o40)))
(assert (=> (not (= first_available 0)) (= temp___428 (mk___rep1 (mk___split_fields1 o39 o40)))))
(assert (=> (not (= first_available 0)) (= result8 (mk___split_fields__ref1 (mk___split_fields1 model____split_fields model____split_fields1)))))
(assert (=> (not (= first_available 0)) (= model____split_fields3 (us_split_fields3 temp___428))))
(assert (=> (not (= first_available 0)) (and (= o41 (prepend (rec__list_allocator__m__t__allocated model____split_fields3) res1)) (= (is_prepend (rec__list_allocator__m__t__allocated model____split_fields3) res1 o41) true))))
(assert (=> (not (= first_available 0)) (= o42 (mk___split_fields1 (rec__list_allocator__m__t__available model____split_fields3) o41))))
(assert (=> (not (= first_available 0)) (= temp___430 (mk___rep1 o42))))
(assert (=> (not (= first_available 0)) (= result9 (mk___split_fields__ref1 model____split_fields3))))
(assert (=> (not (= first_available 0)) (= model____split_fields4 (us_split_fields3 temp___430))))
(assert (=> (not (= first_available 0)) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (rec__list_allocator__m__t__available model____split_fields4)))) (and (and (and (in_range4 (get (rec__list_allocator__m__t__available model____split_fields4) j)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data4 (get (rec__list_allocator__m__t__available model____split_fields4) j))))) (ite (< j (length (rec__list_allocator__m__t__available model____split_fields4))) (get (rec__list_allocator__m__t__available model____split_fields4) (+ j 1)) 0))) (= (to_rep (rec__list_allocator__cell__prev (us_split_fields1 (select data4 (get (rec__list_allocator__m__t__available model____split_fields4) j))))) (ite (< 1 j) (get (rec__list_allocator__m__t__available model____split_fields4) (- j 1)) 0))) (forall ((k Int)) (=> (and (<= 1 k) (<= k (length (rec__list_allocator__m__t__available model____split_fields4)))) (=> (not (= j k)) (not (= (get (rec__list_allocator__m__t__available model____split_fields4) j) (get (rec__list_allocator__m__t__available model____split_fields4) k)))))))))))
(assert (=> (not (= first_available 0)) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (rec__list_allocator__m__t__allocated model____split_fields4)))) (and (and (and (in_range4 (get (rec__list_allocator__m__t__allocated model____split_fields4) j)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data4 (get (rec__list_allocator__m__t__allocated model____split_fields4) j))))) (ite (< j (length (rec__list_allocator__m__t__allocated model____split_fields4))) (get (rec__list_allocator__m__t__allocated model____split_fields4) (+ j 1)) 0))) (= (to_rep (rec__list_allocator__cell__prev (us_split_fields1 (select data4 (get (rec__list_allocator__m__t__allocated model____split_fields4) j))))) (ite (< 1 j) (get (rec__list_allocator__m__t__allocated model____split_fields4) (- j 1)) 0))) (forall ((k Int)) (=> (and (<= 1 k) (<= k (length (rec__list_allocator__m__t__allocated model____split_fields4)))) (=> (not (= j k)) (not (= (get (rec__list_allocator__m__t__allocated model____split_fields4) j) (get (rec__list_allocator__m__t__allocated model____split_fields4) k)))))))))))
(assert (=> (not (= first_available 0)) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (rec__list_allocator__m__t__available model____split_fields4)))) (= (bool_eq (select data4 (get (rec__list_allocator__m__t__available model____split_fields4) j)) (select data4 (get ma1 (+ j 1)))) true)))))
(assert (=> (not (= first_available 0)) (forall ((j Int)) (=> (and (<= 1 j) (<= j (- (length ma1) 2))) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data4 (get ma1 (+ j 1)))))) (get ma1 (+ j 2)))))))
(assert (=> (not (= first_available 0)) (forall ((j Int)) (=> (and (<= 1 j) (<= j (- (length (rec__list_allocator__m__t__available model____split_fields4)) 1))) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data4 (get ma1 (+ j 1)))))) (get ma1 (+ j 2)))))))
(assert (=> (not (= first_available 0)) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (rec__list_allocator__m__t__available model____split_fields4)))) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data4 (get ma1 (+ j 1)))))) (ite (< j (length (rec__list_allocator__m__t__available model____split_fields4))) (get ma1 (+ j 2)) 0))))))
(assert (=> (not (= first_available 0)) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (rec__list_allocator__m__t__available model____split_fields4)))) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data4 (get (rec__list_allocator__m__t__available model____split_fields4) j))))) (ite (< j (length (rec__list_allocator__m__t__available model____split_fields4))) (get ma1 (+ j 2)) 0))))))
(assert (=> (not (= first_available 0)) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (rec__list_allocator__m__t__available model____split_fields4)))) (and (in_range4 (get (rec__list_allocator__m__t__available model____split_fields4) j)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data4 (get (rec__list_allocator__m__t__available model____split_fields4) j))))) (ite (< j (length (rec__list_allocator__m__t__available model____split_fields4))) (get (rec__list_allocator__m__t__available model____split_fields4) (+ j 1)) 0)))))))
(assert (=> (not (= first_available 0)) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (rec__list_allocator__m__t__allocated model____split_fields4)))) (in_range4 (get (rec__list_allocator__m__t__allocated model____split_fields4) j))))))
(assert (=> (not (= first_available 0)) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (rec__list_allocator__m__t__allocated model____split_fields4)))) (and (in_range4 (get (rec__list_allocator__m__t__allocated model____split_fields4) j)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data4 (get (rec__list_allocator__m__t__allocated model____split_fields4) j))))) (ite (< j (length (rec__list_allocator__m__t__allocated model____split_fields4))) (get (rec__list_allocator__m__t__allocated model____split_fields4) (+ j 1)) 0)))))))
(assert (=> (not (= first_available 0)) (forall ((r Int)) (=> (and (<= 1 r) (<= r 3)) (ite (= (to_rep1 (rec__list_allocator__cell__stat (us_split_fields1 (select data4 r)))) 0) (and (= (mem (rec__list_allocator__m__t__available model____split_fields4) r) true) (not (= (mem (rec__list_allocator__m__t__allocated model____split_fields4) r) true))) (and (not (= (mem (rec__list_allocator__m__t__available model____split_fields4) r) true)) (= (mem (rec__list_allocator__m__t__allocated model____split_fields4) r) true)))))))
(assert (=> (not (= first_available 0)) (and (and (and (and (ite (not (= first_available2 0)) (and (< 0 (length (rec__list_allocator__m__t__available model____split_fields4))) (= (get (rec__list_allocator__m__t__available model____split_fields4) 1) first_available2)) (= (length (rec__list_allocator__m__t__available model____split_fields4)) 0)) (ite (not (= first_allocated2 0)) (and (< 0 (length (rec__list_allocator__m__t__allocated model____split_fields4))) (= (get (rec__list_allocator__m__t__allocated model____split_fields4) 1) first_allocated2)) (= (length (rec__list_allocator__m__t__allocated model____split_fields4)) 0))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (rec__list_allocator__m__t__available model____split_fields4)))) (and (in_range4 (get (rec__list_allocator__m__t__available model____split_fields4) j)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data4 (get (rec__list_allocator__m__t__available model____split_fields4) j))))) (ite (< j (length (rec__list_allocator__m__t__available model____split_fields4))) (get (rec__list_allocator__m__t__available model____split_fields4) (+ j 1)) 0)))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (rec__list_allocator__m__t__allocated model____split_fields4)))) (and (in_range4 (get (rec__list_allocator__m__t__allocated model____split_fields4) j)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data4 (get (rec__list_allocator__m__t__allocated model____split_fields4) j))))) (ite (< j (length (rec__list_allocator__m__t__allocated model____split_fields4))) (get (rec__list_allocator__m__t__allocated model____split_fields4) (+ j 1)) 0)))))) (forall ((r Int)) (=> (and (<= 1 r) (<= r 3)) (ite (= (to_rep1 (rec__list_allocator__cell__stat (us_split_fields1 (select data4 r)))) 0) (and (= (mem (rec__list_allocator__m__t__available model____split_fields4) r) true) (not (= (mem (rec__list_allocator__m__t__allocated model____split_fields4) r) true))) (and (not (= (mem (rec__list_allocator__m__t__available model____split_fields4) r) true)) (= (mem (rec__list_allocator__m__t__allocated model____split_fields4) r) true))))))))
(assert (=> (not (not (= first_available 0))) (= result10 res5)))
(assert (=> (not (not (= first_available 0))) (= res2 0)))
(assert (=> (not (not (= first_available 0))) (= next_avail2 next_avail)))
(assert (=> (not (not (= first_available 0))) (= first_allocated2 first_allocated)))
(assert (=> (not (not (= first_available 0))) (= first_available2 first_available)))
(assert (=> (not (not (= first_available 0))) (= data4 data)))
(assert (=> (not (not (= first_available 0))) (= res1 res2)))
(assert (=> (not (not (= first_available 0))) (= model____split_fields4 (mk___split_fields1 model____split_fields model____split_fields1))))
(assert (=> (not (not (= first_available 0))) (= next_avail2 next_avail1)))
(assert (=> (not (not (= first_available 0))) (= first_allocated2 first_allocated1)))
(assert (=> (not (not (= first_available 0))) (= first_available2 first_available1)))
(assert (=> (not (not (= first_available 0))) (= data4 data1)))
(assert (=> (not (not (= first_available 0))) (= res1 res2)))
(assert (=> (not (not (= first_available 0))) (= model____split_fields4 model____split_fields2)))
(assert (= ma2 (mk_sequence__ref ma1)))
(assert (= next_avail3 (mk_int__ref next_avail2)))
...
(assert (= res3 (mk_int__ref res1)))
(assert (= model____split_fields5 (mk___split_fields__ref1 model____split_fields4)))
(assert (= ma3 ma1))
(assert (= next_avail4 next_avail2))
...
(assert (= (= (length model____split_fields) 0) true))
(assert (not (= (int__content res3) 0)))
(check-sat)
(exit)
