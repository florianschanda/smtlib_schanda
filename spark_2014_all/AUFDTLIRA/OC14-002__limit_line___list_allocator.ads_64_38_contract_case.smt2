...
(assert (=> (not (= first_available 0)) (= result1 (mk_int__ref res))))
...
(assert (=> (not (= first_available 0)) (=> (= next_avail2 0) (= data3 data2))))
...
(assert (=> (not (= first_available 0)) (=> (= first_allocated 0) (= data4 data3))))
...
(assert (=> (not (= first_available 0)) (forall ((j12 Int)) (=> (and (<= 1 j12) (<= j12 (length (rec__list_allocator__m__t__allocated model____split_fields4)))) (in_range4 (get (rec__list_allocator__m__t__allocated model____split_fields4) j12))))))
(assert (=> (not (= first_available 0)) (forall ((j12 Int)) (=> (and (<= 1 j12) (<= j12 (length (rec__list_allocator__m__t__allocated model____split_fields4)))) (and (in_range4 (get (rec__list_allocator__m__t__allocated model____split_fields4) j12)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data4 (get (rec__list_allocator__m__t__allocated model____split_fields4) j12))))) (ite (< j12 (length (rec__list_allocator__m__t__allocated model____split_fields4))) (get (rec__list_allocator__m__t__allocated model____split_fields4) (+ j12 1)) 0)))))))
...
(assert (=> (not (= first_available 0)) (and (and (and (and (ite (not (= first_available2 0)) (and (< 0 (length (rec__list_allocator__m__t__available model____split_fields4))) (= (get (rec__list_allocator__m__t__available model____split_fields4) 1) first_available2)) (= (length (rec__list_allocator__m__t__available model____split_fields4)) 0)) (ite (not (= first_allocated2 0)) (and (< 0 (length (rec__list_allocator__m__t__allocated model____split_fields4))) (= (get (rec__list_allocator__m__t__allocated model____split_fields4) 1) first_allocated2)) (= (length (rec__list_allocator__m__t__allocated model____split_fields4)) 0))) (forall ((j12 Int)) (=> (and (<= 1 j12) (<= j12 (length (rec__list_allocator__m__t__available model____split_fields4)))) (and (in_range4 (get (rec__list_allocator__m__t__available model____split_fields4) j12)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data4 (get (rec__list_allocator__m__t__available model____split_fields4) j12))))) (ite (< j12 (length (rec__list_allocator__m__t__available model____split_fields4))) (get (rec__list_allocator__m__t__available model____split_fields4) (+ j12 1)) 0)))))) (forall ((j12 Int)) (=> (and (<= 1 j12) (<= j12 (length (rec__list_allocator__m__t__allocated model____split_fields4)))) (and (in_range4 (get (rec__list_allocator__m__t__allocated model____split_fields4) j12)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data4 (get (rec__list_allocator__m__t__allocated model____split_fields4) j12))))) (ite (< j12 (length (rec__list_allocator__m__t__allocated model____split_fields4))) (get (rec__list_allocator__m__t__allocated model____split_fields4) (+ j12 1)) 0)))))) (forall ((r Int)) (=> (and (<= 1 r) (<= r 3)) (ite (= (to_rep1 (rec__list_allocator__cell__stat (us_split_fields1 (select data4 r)))) 0) (and (= (mem (rec__list_allocator__m__t__available model____split_fields4) r) true) (not (= (mem (rec__list_allocator__m__t__allocated model____split_fields4) r) true))) (and (not (= (mem (rec__list_allocator__m__t__available model____split_fields4) r) true)) (= (mem (rec__list_allocator__m__t__allocated model____split_fields4) r) true))))))))
(assert (=> (= first_available 0) (= result47 (mk_int__ref res))))
(assert (=> (= first_available 0) (= res2 0)))
(assert (=> (= first_available 0) (= next_avail2 next_avail)))
(assert (=> (= first_available 0) (= first_allocated2 first_allocated)))
(assert (=> (= first_available 0) (= first_available2 first_available)))
(assert (=> (= first_available 0) (= data4 data)))
(assert (=> (= first_available 0) (= res1 res2)))
(assert (=> (= first_available 0) (= model____split_fields4 (mk___split_fields1 model____split_fields model____split_fields1))))
(assert (=> (= first_available 0) (= next_avail2 next_avail1)))
(assert (=> (= first_available 0) (= first_allocated2 first_allocated1)))
(assert (=> (= first_available 0) (= first_available2 first_available1)))
(assert (=> (= first_available 0) (= data4 data1)))
(assert (=> (= first_available 0) (= res1 res2)))
(assert (=> (= first_available 0) (= model____split_fields4 model____split_fields2)))
