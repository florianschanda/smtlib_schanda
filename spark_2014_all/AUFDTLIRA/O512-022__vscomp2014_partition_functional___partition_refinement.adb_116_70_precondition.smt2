...
(assert (= result4 true))
(assert (and (= o3 (key (mk___rep d__split_discrs d__split_fields2) c)) (and (in_range5 o3) (= o3 (get (keys (mk___rep d__split_discrs d__split_fields2)) (get1 (positions (mk___rep d__split_discrs d__split_fields2)) c))))))
