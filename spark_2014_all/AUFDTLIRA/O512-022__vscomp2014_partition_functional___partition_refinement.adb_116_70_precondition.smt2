...
(assert (and (= o93 (key (mk___rep d__split_discrs d__split_fields2) c6)) (and (in_range5 o93) (= o93 (get (keys (mk___rep d__split_discrs d__split_fields2)) (get1 (positions (mk___rep d__split_discrs d__split_fields2)) c6))))))
(assert (= result19 (ite (= o93 (to_rep (select a1 j))) true false)))
(assert (= result19 true))
(assert (and (= o95 (key (mk___rep d__split_discrs d__split_fields2) c6)) (and (in_range5 o95) (= o95 (get (keys (mk___rep d__split_discrs d__split_fields2)) (get1 (positions (mk___rep d__split_discrs d__split_fields2)) c6))))))
