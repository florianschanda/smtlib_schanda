...
(assert (= pos13 pos11))
(assert (=> (= (= (to_rep1 (select a 1)) val__) true) (= (to_rep (rec__linear_search__search_result__at_index (us_split_fields1 (search_result__content linear_search__search__result18)))) 1)))
(assert (=> (= (ite (= (not (= (to_rep1 (select a 1)) val__)) true) (value_found_in_range a val__ 2 10) false) true) (= (rec__linear_search__search_result__found (us_split_discrs1 (search_result__content linear_search__search__result18))) true)))
(assert (forall ((j Int)) (=> (and (<= 1 j) (<= j 10)) (not (= (to_rep1 (select a j)) val__)))))
(assert (not (not (= (rec__linear_search__search_result__found (us_split_discrs1 (search_result__content linear_search__search__result18))) true))))
(check-sat)
(exit)
