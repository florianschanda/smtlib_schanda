...
(assert (= (bool_eq a1 0 5 a_update 0 5) true))
(assert (forall ((c10 us_rep1)) (=> (= (has_key (positions (mk___rep d__split_discrs d__split_fields2)) c10) true) (=> (and (not (= (key (mk___rep d__split_discrs d__split_fields2) c10) (to_rep (select a1 i)))) (not (= (key (mk___rep d__split_discrs d__split_fields2) c10) (to_rep (select a1 j))))) (= (to_rep (select a1 (element (mk___rep d__split_discrs d__split_fields2) c10))) (key (mk___rep d__split_discrs d__split_fields2) c10))))))
(assert (forall ((c10 us_rep1)) (=> (= (has_key (positions (mk___rep d__split_discrs d__split_fields2)) c10) true) (=> (= (key (mk___rep d__split_discrs d__split_fields2) c10) (to_rep (select a1 i))) (= (to_rep (select a1 (element (mk___rep d__split_discrs d__split_fields2) c10))) (key (mk___rep d__split_discrs d__split_fields2) c10))))))
(assert (and (= o91 (has_key (positions (mk___rep d__split_discrs d__split_fields2)) c6)) (= (= o91 true) (= (has_key (positions (mk___rep d__split_discrs d__split_fields2)) c6) true))))
(assert (= o92 true))
(assert (= result18 (ite (= o92 true) o91 false)))
(assert (= result18 true))
(assert (not (= (has_key (positions (mk___rep d__split_discrs d__split_fields2)) c6) true)))
(check-sat)
(exit)
