...
(declare-fun null_concat__p_bad__a1__aggregate_def (Int) (Array Int integer))
(declare-sort t7b 0)
...
(declare-fun null_concat__p_bad__a2__aggregate_def (Int Int) (Array Int integer))
...
(assert (= a1 (of_array (null_concat__p_bad__a1__aggregate_def 0) 1 (- 5))))
(declare-const rliteral integer)
(assert (= (integerqtint rliteral) 0))
(assert (forall ((temp___164 Int)) (=> (dynamic_invariant1 temp___164 true true true true) (forall ((temp___165 Int)) (= (select (null_concat__p_bad__a1__aggregate_def temp___164) temp___165) rliteral)))))
(assert (= a2 (of_array (null_concat__p_bad__a2__aggregate_def 1 2) 1 10)))
(declare-const rliteral1 integer)
(assert (= (integerqtint rliteral1) 2))
(declare-const rliteral2 integer)
(assert (= (integerqtint rliteral2) 1))
(assert (forall ((temp___167 Int) (temp___168 Int)) (let ((temp___166 (null_concat__p_bad__a2__aggregate_def temp___167 temp___168))) (=> (and (dynamic_invariant1 temp___167 true true true true) (dynamic_invariant1 temp___168 true true true true)) (forall ((temp___169 Int)) (ite (and (<= 6 temp___169) (<= temp___169 10)) (= (select temp___166 temp___169) rliteral1) (=> (and (<= 1 temp___169) (<= temp___169 5)) (= (select temp___166 temp___169) rliteral2))))))))
...
(declare-const null_concat__p_bad__a3__assume (Array Int integer))
(declare-const null_concat__p_bad__a3__assume1 t)
(assert (= (mk___t (null_concat__p_bad__a1__aggregate_def 0) (mk 1 (- 5))) a1))
(assert (dynamic_invariant a1 true false true true))
(assert (= (mk___t (null_concat__p_bad__a2__aggregate_def 1 2) (mk 1 10)) a2))
(assert (dynamic_invariant a2 true false true true))
(assert (=> (= (length a1) 0) (= (elts a2) null_concat__p_bad__a3__assume)))
(assert (=> (= (length a1) 0) (= (mk (to_rep (first (rt a2))) (to_rep (last (rt a2)))) null_concat__p_bad__a3__assume1)))
...
(assert (=> (not (= (length a1) 0)) (= (concat1 (elts a1) (to_rep (first (rt a1))) (to_rep (last (rt a1))) (elts a2) (to_rep (first (rt a2))) (to_rep (last (rt a2)))) null_concat__p_bad__a3__assume)))
(assert (=> (not (= (length a1) 0)) (= (mk (to_rep (first (rt a1))) o5) null_concat__p_bad__a3__assume1)))
(assert (= (mk___t null_concat__p_bad__a3__assume null_concat__p_bad__a3__assume1) a3))
(assert (dynamic_invariant a3 true false true true))
(assert (= (to_rep (first (rt a3))) 1))
(assert (not (<= (to_rep (first (rt a3))) 1)))
(check-sat)
(exit)
