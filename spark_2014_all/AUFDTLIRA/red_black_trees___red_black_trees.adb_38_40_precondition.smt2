...
(declare-const temp___1063 (Array Int us_rep6))
(declare-const temp___1062 Int)
(declare-const temp___1058 Int)
(declare-const temp___1056 (Array Int us_rep6))
(declare-const o Int)
...
(declare-const temp___1069 (Array Int us_rep4))
...
(declare-const o32 us_rep6)
(declare-const o33 us_split_fields10)
...
(assert (= n1 0))
(assert (=> (and (<= 0 n1) (<= n1 99)) (= temp___1063 res1)))
(assert (=> (and (<= 0 n1) (<= n1 99)) (= temp___1062 n1)))
(assert (=> (and (<= 0 n1) (<= n1 99)) (= (bool_eq10 (select res2 0) (mk___rep5 (mk___split_fields5 (distinct 1 0) rliteral rliteral))) true)))
...
(assert (=> (and (<= 0 n1) (<= n1 99)) (forall ((i16 Int)) (=> (and (<= 1 i16) (<= i16 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields7 (select m i16))) true) (< n2 (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 i16)))))) (< (length (rec__tree_model__path_type__a (us_split_fields7 (select m i16)))) (- 100 n2)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select m i16))) true) (and (and (and (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 i16)))) n2) (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select res2 i16))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res2 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i16 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res2 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i16 1)))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 i16)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i16 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i16 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i16 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i16 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res2 i16)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) i16)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res2 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i16 0))))))))))))))
(assert (=> (and (<= 0 n1) (<= n1 99)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields7 (select m j))) true) (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j 0))))) n2)) (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j 1))))) n2)) (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 j)))) n2))))))
...
(assert (=> (and (<= 0 n1) (<= n1 99)) (=> (and (<= 1 i4) (<= i4 100)) (= temp___1058 i4))))
(assert (=> (and (<= 0 n1) (<= n1 99)) (=> (and (<= 1 i4) (<= i4 100)) (= temp___1056 res2))))
(assert (=> (and (<= 0 n1) (<= n1 99)) (=> (and (<= 1 i4) (<= i4 100)) (= (bool_eq10 (select res3 0) (mk___rep5 (mk___split_fields5 (distinct 1 0) rliteral rliteral))) true))))
...
(assert (=> (and (<= 0 n1) (<= n1 99)) (=> (and (<= 1 i4) (<= i4 100)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields7 (select m j))) true) (< n2 (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res3 j)))))) (< (length (rec__tree_model__path_type__a (us_split_fields7 (select m j)))) (- 100 n2))))))))
(assert (=> (and (<= 0 n1) (<= n1 99)) (=> (and (<= 1 i4) (<= i4 100)) (forall ((j Int)) (=> (and (<= 1 j) (<= j (- i5 1))) (=> (and (= (rec__tree_model__path_type__k (us_split_fields7 (select m j))) true) (< (+ n2 1) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res3 j)))))) (< (length (rec__tree_model__path_type__a (us_split_fields7 (select m j)))) (- 100 (+ n2 1)))))))))
(assert (=> (and (<= 0 n1) (<= n1 99)) (=> (and (<= 1 i4) (<= i4 100)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields7 (select m j))) true) (or (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res3 j)))) n2) (and (< j i5) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res3 j)))) (+ n2 1))))) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select res3 j))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res3 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res3 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res3 j)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res3 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res3 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res3 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res3 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res3 j)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) j)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res3 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j 0))))))))))))))
(assert (=> (and (<= 0 n1) (<= n1 99)) (=> (and (<= 1 i4) (<= i4 100)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields7 (select m j))) true) (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res3 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j 0))))) n2)) (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res3 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j 1))))) n2)) (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res3 j)))) n2)))))))
(assert (=> (and (<= 0 n1) (<= n1 99)) (=> (and (<= 1 i4) (<= i4 100)) (forall ((j Int)) (=> (and (<= 1 j) (<= j (- i5 1))) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields7 (select m j))) true) (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res3 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j 0))))) n2)) (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res3 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j 1))))) n2)) (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res3 j)))) (+ n2 1))))))))
(assert (=> (and (<= 0 n1) (<= n1 99)) (=> (and (<= 1 i4) (<= i4 100)) (and (and (forall ((temp___1057 Int)) (=> (and (<= 0 temp___1057) (<= temp___1057 100)) (=> (or (< 100 temp___1057) (or (< temp___1057 1) (<= i5 temp___1057))) (= (select res3 temp___1057) (select temp___1056 temp___1057))))) (=> (<= 1 100) (in_range5 i5))) (and (<= 1 i5) (<= i5 100))))))
(assert (=> (and (<= 0 n1) (<= n1 99)) (=> (and (<= 1 i4) (<= i4 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select m i5))) true) (and (= o (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i5 1)) (and (in_range2 o) (= o (peek1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) i5 1))))))))
(assert (=> (and (<= 0 n1) (<= n1 99)) (=> (and (<= 1 i4) (<= i4 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select m i5))) true) (= red_black_trees__nb_blacks__B_3__count_r__assume (select res3 o))))))
(assert (=> (and (<= 0 n1) (<= n1 99)) (=> (and (<= 1 i4) (<= i4 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select m i5))) true) (= red_black_trees__nb_blacks__B_3__count_r__assume count_r)))))
(assert (=> (and (<= 0 n1) (<= n1 99)) (=> (and (<= 1 i4) (<= i4 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select m i5))) true) (and (= o1 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i5 0)) (and (in_range2 o1) (= o1 (peek1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) i5 0))))))))
(assert (=> (and (<= 0 n1) (<= n1 99)) (=> (and (<= 1 i4) (<= i4 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select m i5))) true) (= red_black_trees__nb_blacks__B_3__count_l__assume (select res3 o1))))))
(assert (=> (and (<= 0 n1) (<= n1 99)) (=> (and (<= 1 i4) (<= i4 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select m i5))) true) (= red_black_trees__nb_blacks__B_3__count_l__assume count_l)))))
(assert (=> (and (<= 0 n1) (<= n1 99)) (=> (and (<= 1 i4) (<= i4 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select m i5))) true) (=> (= (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_r))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_l)))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_l))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_r)))) n2) (= (to_rep o2) (+ n2 1)))))))
(assert (=> (and (<= 0 n1) (<= n1 99)) (=> (and (<= 1 i4) (<= i4 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select m i5))) true) (=> (= (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_r))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_l)))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_l))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_r)))) n2) (= o3 (mk___split_fields5 (rec__red_black_trees__black_count__status (us_split_fields11 (select res3 i5))) o2 (rec__red_black_trees__black_count__count (us_split_fields11 (select res3 i5))))))))))
(assert (=> (and (<= 0 n1) (<= n1 99)) (=> (and (<= 1 i4) (<= i4 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select m i5))) true) (=> (= (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_r))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_l)))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_l))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_r)))) n2) (= o4 (mk___rep5 o3)))))))
(assert (=> (and (<= 0 n1) (<= n1 99)) (=> (and (<= 1 i4) (<= i4 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select m i5))) true) (=> (= (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_r))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_l)))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_l))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_r)))) n2) (= o5 (store res3 i5 o4)))))))
(assert (=> (and (<= 0 n1) (<= n1 99)) (=> (and (<= 1 i4) (<= i4 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select m i5))) true) (=> (= (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_r))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_l)))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_l))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_r)))) n2) (= result3 (mk_map__ref4 res3)))))))
(assert (=> (and (<= 0 n1) (<= n1 99)) (=> (and (<= 1 i4) (<= i4 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select m i5))) true) (=> (= (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_r))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_l)))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_l))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_r)))) n2) (= res4 o5))))))
(assert (=> (and (<= 0 n1) (<= n1 99)) (=> (and (<= 1 i4) (<= i4 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select m i5))) true) (=> (= (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_r))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_l)))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_l))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_r)))) n2) (= result4 (mk_map__ref4 res4)))))))
(assert (=> (and (<= 0 n1) (<= n1 99)) (=> (and (<= 1 i4) (<= i4 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select m i5))) true) (=> (= (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_r))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_l)))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_l))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_r)))) n2) (= res5 (store res4 i5 (mk___rep5 (mk___split_fields5 (ite (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 count_r))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 count_l)))) true false) (rec__red_black_trees__black_count__depth (us_split_fields11 (select res4 i5))) (rec__red_black_trees__black_count__count (us_split_fields11 (select res4 i5))))))))))))
(assert (=> (and (<= 0 n1) (<= n1 99)) (=> (and (<= 1 i4) (<= i4 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select m i5))) true) (=> (= (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_r))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_l)))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_l))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_r)))) n2) (=> (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) i5)) 0) (and (= o6 (+ (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 count_l))) 1)) (in_range2 (+ (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 count_l))) 1)))))))))
(assert (=> (and (<= 0 n1) (<= n1 99)) (=> (and (<= 1 i4) (<= i4 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select m i5))) true) (=> (= (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_r))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_l)))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_l))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_r)))) n2) (=> (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) i5)) 0) (= (to_rep o7) o6)))))))
(assert (=> (and (<= 0 n1) (<= n1 99)) (=> (and (<= 1 i4) (<= i4 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select m i5))) true) (=> (= (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_r))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_l)))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_l))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_r)))) n2) (=> (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) i5)) 0) (= o8 (mk___split_fields5 (rec__red_black_trees__black_count__status (us_split_fields11 (select res5 i5))) (rec__red_black_trees__black_count__depth (us_split_fields11 (select res5 i5))) o7))))))))
(assert (=> (and (<= 0 n1) (<= n1 99)) (=> (and (<= 1 i4) (<= i4 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select m i5))) true) (=> (= (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_r))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_l)))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_l))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_r)))) n2) (=> (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) i5)) 0) (= o9 (mk___rep5 o8))))))))
(assert (=> (and (<= 0 n1) (<= n1 99)) (=> (and (<= 1 i4) (<= i4 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select m i5))) true) (=> (= (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_r))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_l)))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_l))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_r)))) n2) (=> (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) i5)) 0) (= o10 (store res5 i5 o9))))))))
(assert (=> (and (<= 0 n1) (<= n1 99)) (=> (and (<= 1 i4) (<= i4 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select m i5))) true) (=> (= (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_r))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_l)))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_l))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_r)))) n2) (=> (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) i5)) 0) (= result5 (mk_map__ref4 res5))))))))
(assert (=> (and (<= 0 n1) (<= n1 99)) (=> (and (<= 1 i4) (<= i4 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select m i5))) true) (=> (= (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_r))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_l)))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_l))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_r)))) n2) (=> (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) i5)) 0) (= res6 o10)))))))
(assert (=> (and (<= 0 n1) (<= n1 99)) (=> (and (<= 1 i4) (<= i4 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select m i5))) true) (=> (= (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_r))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_l)))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_l))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_r)))) n2) (=> (not (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) i5)) 0)) (= (to_rep o11) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 count_l))))))))))
(assert (=> (and (<= 0 n1) (<= n1 99)) (=> (and (<= 1 i4) (<= i4 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select m i5))) true) (=> (= (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_r))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_l)))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_l))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_r)))) n2) (=> (not (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) i5)) 0)) (= o12 (mk___split_fields5 (rec__red_black_trees__black_count__status (us_split_fields11 (select res5 i5))) (rec__red_black_trees__black_count__depth (us_split_fields11 (select res5 i5))) o11))))))))
(assert (=> (and (<= 0 n1) (<= n1 99)) (=> (and (<= 1 i4) (<= i4 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select m i5))) true) (=> (= (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_r))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_l)))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_l))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_r)))) n2) (=> (not (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) i5)) 0)) (= o13 (mk___rep5 o12))))))))
(assert (=> (and (<= 0 n1) (<= n1 99)) (=> (and (<= 1 i4) (<= i4 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select m i5))) true) (=> (= (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_r))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_l)))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_l))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_r)))) n2) (=> (not (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) i5)) 0)) (= o14 (store res5 i5 o13))))))))
(assert (=> (and (<= 0 n1) (<= n1 99)) (=> (and (<= 1 i4) (<= i4 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select m i5))) true) (=> (= (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_r))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_l)))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_l))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_r)))) n2) (=> (not (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) i5)) 0)) (= result6 (mk_map__ref4 res5))))))))
(assert (=> (and (<= 0 n1) (<= n1 99)) (=> (and (<= 1 i4) (<= i4 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select m i5))) true) (=> (= (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_r))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_l)))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_l))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_r)))) n2) (=> (not (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) i5)) 0)) (= res7 o14)))))))
(assert (=> (and (<= 0 n1) (<= n1 99)) (=> (and (<= 1 i4) (<= i4 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select m i5))) true) (=> (= (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_r))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_l)))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_l))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_r)))) n2) (=> (not (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) i5)) 0)) (= res6 res7)))))))
(assert (=> (and (<= 0 n1) (<= n1 99)) (=> (and (<= 1 i4) (<= i4 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select m i5))) true) (=> (not (= (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_r))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_l)))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_l))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_r)))) n2)) (= res6 res3))))))
(assert (=> (and (<= 0 n1) (<= n1 99)) (=> (and (<= 1 i4) (<= i4 100)) (=> (not (= (rec__tree_model__path_type__k (us_split_fields7 (select m i5))) true)) (= res6 res3)))))
...
(assert (<= 1 i1))
(assert (<= i1 100))
(assert (and (= temp___1069 (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) (and (dynamic_invariant3 temp___1069 true false true true) (= temp___1069 (model__1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) (to_rep (rec__search_trees__search_tree__root (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 t))))))))))
(assert (= o15 (select temp___1069 i1)))
(assert (= o16 (us_split_fields7 o15)))
(assert (= result8 (rec__tree_model__path_type__k o16)))
(assert (= result8 true))
(assert (and (= o31 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i1 0)) (and (in_range2 o31) (= o31 (peek1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) i1 0)))))
(assert (= o32 (select (map__content4 red_black_trees__nb_blacks__result4) o31)))
(assert (= o33 (us_split_fields11 o32)))
(assert (= o34 (rec__red_black_trees__black_count__count o33)))
(assert (= o35 (to_rep o34)))
(assert (=> (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) i1)) 0) (= o36 1)))
(assert (=> (not (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) i1)) 0)) (= o36 0)))
(assert (= o37 (+ o36 o35)))
(assert (and (= o38 o37) (in_range7 o37)))
(assert (= o39 (ite (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (map__content4 red_black_trees__nb_blacks__result4) i1)))) o38) true false)))
(assert (and (= o21 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i1 1)) (and (in_range2 o21) (= o21 (peek1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) i1 1)))))
(assert (= o22 (select (map__content4 red_black_trees__nb_blacks__result4) o21)))
(assert (= o23 (us_split_fields11 o22)))
(assert (= o24 (rec__red_black_trees__black_count__depth o23)))
(assert (= o25 (to_rep o24)))
(assert (and (= o17 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i1 0)) (and (in_range2 o17) (= o17 (peek1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) i1 0)))))
(assert (= o18 (select (map__content4 red_black_trees__nb_blacks__result4) o17)))
...
(assert (= o28 (+ 1 o27)))
(assert (and (= o29 o28) (in_range7 o28)))
(assert (= o30 (ite (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (map__content4 red_black_trees__nb_blacks__result4) i1)))) o29) true false)))
(assert (not (= (rec__tree_model__path_type__k (us_split_fields7 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 t))) i1))) true)))
(check-sat)
(exit)
