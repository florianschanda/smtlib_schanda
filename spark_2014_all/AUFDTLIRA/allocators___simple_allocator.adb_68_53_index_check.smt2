...
(assert (= data2 data1))
(assert (= res2 res1))
(assert (and (= (bool_eq2 data3 1 10000 data 1 10000) true) (forall ((rr1 Int)) (=> (and (<= 1 rr1) (<= rr1 r2)) (= (to_rep (select data3 rr1)) 1)))))
...
(assert (= (bool_eq2 data3 1 10000 data 1 10000) true))
(assert (<= 1 rr))
(assert (<= rr r2))
(assert (not (<= rr 10000)))
(check-sat)
