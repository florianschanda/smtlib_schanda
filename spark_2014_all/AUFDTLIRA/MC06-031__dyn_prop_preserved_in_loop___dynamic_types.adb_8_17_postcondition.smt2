...
(assert (not (or (and (= result__3 0) (forall ((i1 Int)) (=> (and (<= from i1) (<= i1 from)) (not (= (to_rep (select (elts a) i1)) c))))) (and (and (<= (to_rep1 (first (rt a))) result__3) (<= result__3 (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) result__3)) c)))))
(check-sat)
(exit)
