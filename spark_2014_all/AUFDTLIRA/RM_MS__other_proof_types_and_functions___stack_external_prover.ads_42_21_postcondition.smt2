...
(declare-const temp___2211 pointer_range)
...
(assert (= temp___221 o7))
(assert (= temp___2211 o8))
(assert (= result2 my_stack__split_fields2))
(assert (= result3 my_stack__split_fields3))
(assert (= temp___221 my_stack__split_fields4))
(assert (= temp___2211 my_stack__split_fields5))
