...
(assert (<= 1 i2))
(assert (<= i2 100))
(assert (and (= o68 (to_rep1 (rec__search_trees__search_tree__root t__split_fields11))) (in_range3 (to_rep1 (rec__search_trees__search_tree__root t__split_fields11)))))
(assert (and (= temp___876 (model__ (rec__search_trees__search_tree__struct t__split_fields11) o68)) (and (dynamic_invariant6 temp___876 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___876 o68))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___876 o68)))) 0) (and (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (not (= i5 o68)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct t__split_fields11) i5) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___876 (parent (rec__search_trees__search_tree__struct t__split_fields11) i5)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___876 i5))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___876 i5))) true)))))) (and (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___876 i5))) true) (not (= i5 o68))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___876 (parent (rec__search_trees__search_tree__struct t__split_fields11) i5)))) (position (rec__search_trees__search_tree__struct t__split_fields11) i5) (rec__tree_model__path_type__a (us_split_fields1 (select temp___876 i5)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___876 i5)))) 0)))) (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___876 i5))) true) (forall ((j15 Int)) (=> (and (<= 1 j15) (<= j15 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___876 j15))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___876 i5))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___876 j15)))) true)) (= j15 i5))))))))))))))
(assert (= o69 (select temp___876 y1)))
(assert (= o70 (us_split_fields1 o69)))
(assert (= o71 (rec__tree_model__path_type__a o70)))
(assert (and (= o64 (to_rep1 (rec__search_trees__search_tree__root t__split_fields11))) (in_range3 (to_rep1 (rec__search_trees__search_tree__root t__split_fields11)))))
(assert (and (= temp___875 (model__ (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) o64)) (and (dynamic_invariant6 temp___875 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___875 o64))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___875 o64)))) 0) (and (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (not (= i5 o64)) (ite (and (not (= (parent (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) i5) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___875 (parent (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) i5)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___875 i5))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___875 i5))) true)))))) (and (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___875 i5))) true) (not (= i5 o64))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___875 (parent (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) i5)))) (position (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) i5) (rec__tree_model__path_type__a (us_split_fields1 (select temp___875 i5)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___875 i5)))) 0)))) (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___875 i5))) true) (forall ((j15 Int)) (=> (and (<= 1 j15) (<= j15 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___875 j15))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___875 i5))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___875 j15)))) true)) (= j15 i5))))))))))))))
(assert (= o65 (select temp___875 i2)))
(assert (= o66 (us_split_fields1 o65)))
(assert (= o67 (rec__tree_model__path_type__a o66)))
(assert (and (= o72 (olt o67 o71)) (= (= o72 true) (and (< (length o67) (length o71)) (forall ((n Int)) (=> (and (<= 1 n) (<= n (last o67))) (= (get o67 n) (get o71 n))))))))
(assert (and (= o61 (to_rep1 (rec__search_trees__search_tree__root t__split_fields11))) (in_range3 (to_rep1 (rec__search_trees__search_tree__root t__split_fields11)))))
(assert (and (= temp___874 (model__ (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) o61)) (and (dynamic_invariant6 temp___874 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___874 o61))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___874 o61)))) 0) (and (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (not (= i5 o61)) (ite (and (not (= (parent (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) i5) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___874 (parent (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) i5)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___874 i5))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___874 i5))) true)))))) (and (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___874 i5))) true) (not (= i5 o61))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___874 (parent (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) i5)))) (position (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) i5) (rec__tree_model__path_type__a (us_split_fields1 (select temp___874 i5)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___874 i5)))) 0)))) (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___874 i5))) true) (forall ((j15 Int)) (=> (and (<= 1 j15) (<= j15 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___874 j15))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___874 i5))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___874 j15)))) true)) (= j15 i5))))))))))))))
(assert (= o62 (select temp___874 i2)))
(assert (= o63 (us_split_fields1 o62)))
(assert (= o73 (rec__tree_model__path_type__k o63)))
(assert (= result29 (ite (= o73 true) o72 false)))
