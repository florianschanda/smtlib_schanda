...
(assert (<= 1 i3))
(assert (<= i3 100))
(assert (=> (not (= v 0)) (and (= temp___1683 (model__ f_old v)) (and (dynamic_invariant5 temp___1683 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1683 v))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1683 v)))) 0) (and (forall ((i21 Int)) (=> (and (<= 1 i21) (<= i21 100)) (=> (not (= i21 v)) (ite (and (not (= (parent f_old i21) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1683 (parent f_old i21)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1683 i21))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1683 i21))) true)))))) (and (forall ((i21 Int)) (=> (and (<= 1 i21) (<= i21 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1683 i21))) true) (not (= i21 v))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1683 (parent f_old i21)))) (position f_old i21) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1683 i21)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1683 i21)))) 0)))) (forall ((i21 Int)) (=> (and (<= 1 i21) (<= i21 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1683 i21))) true) (forall ((j26 Int)) (=> (and (<= 1 j26) (<= j26 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1683 j26))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1683 i21))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1683 j26)))) true)) (= j26 i21)))))))))))))))
(assert (=> (not (= v 0)) (= (mk___rep (mk___split_fields o28 o29)) (select temp___1683 i3))))
(assert (=> (not (= v 0)) (= o30 (mk___split_fields o28 o29))))
(assert (=> (not (= v 0)) (= result16 (rec__tree_model__path_type__k o30))))
(assert (=> (= v 0) (= result16 false)))
