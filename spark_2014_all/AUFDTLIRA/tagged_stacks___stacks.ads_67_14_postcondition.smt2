...
(assert (not (= (let ((temp___606 (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields8 s__split_fields9 s__split_fields10 s__split_fields11) s__attr__tag)))) (bool_eq (elts temp___606) (to_rep (first (rt temp___606))) (to_rep (last (rt temp___606))) (elts (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag))) (to_rep (first2 (mk1 (to_rep (first (rt (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag))))) (- (to_rep (last (rt (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag))))) 1)))) (to_rep (last4 (mk1 (to_rep (first (rt (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag))))) (- (to_rep (last (rt (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag))))) 1)))))) true)))
(check-sat)
(exit)
