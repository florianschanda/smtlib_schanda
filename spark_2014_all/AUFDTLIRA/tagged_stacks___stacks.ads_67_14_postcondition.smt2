...
(assert (forall ((s us_rep1)) (! (dynamic_invariant1 (last4 s) true false true true) :pattern ((last4 s)))))
(assert (forall ((attr__tag2 Int)) (forall ((s us_rep1)) (! (dynamic_invariant1 (last5 attr__tag2 s) true false true true) :pattern ((last5 attr__tag2 s))))))
...
(assert (forall ((s us_rep1)) (! (= (peek__3 s) (to_rep1 (let ((temp___439 (rec__stacks__stack_root__content1 (us_split_fields3 s)))) (select temp___439 (last4 s))))) :pattern ((peek__3 s)))))
...
(assert (and (= temp___598 (last4 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag))) (and (in_range temp___598) (= temp___598 (ite (not (= (wraps_around (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag)) true)) (- (+ (to_rep3 s__split_fields) (to_rep s__split_fields2)) 1) (- (- (+ (to_rep3 s__split_fields) (to_rep s__split_fields2)) 1) 100))))))
