...
(define-fun default_initial_assumption ((temp___expr_143 us_rep) (temp___skip_top_level_144 Bool)) Bool (= (to_rep (rec__partial_init__t__x (us_split_fields1 temp___expr_143))) 0))
...
(assert (= (temp___157 0) v__split_fields3))
