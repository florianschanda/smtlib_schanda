...
(assert (= i1 r23b))
(assert (=> (and (<= r23b i1) (<= i1 r24b)) (= temp___1621 i1)))
(assert (=> (and (<= r23b i1) (<= i1 r24b)) (= temp___1619 newdomainname1)))
(assert (=> (and (<= r23b i1) (<= i1 r24b)) (= temp___1622 endidx8)))
(assert (=> (and (<= r23b i1) (<= i1 r24b)) (and (and (<= 1 begidx11) (<= (+ (- endidx8 begidx11) 1) 128)) (= endidx8 temp___1622))))
(assert (=> (and (<= r23b i1) (<= i1 r24b)) (and (=> (<= r23b r24b) (dynamic_property r23b r24b i2)) (and (<= r23b i2) (<= i2 r24b)))))
(assert (=> (and (<= r23b i1) (<= i1 r24b)) (= (to_rep o5) (to_rep (select zonefileline i2)))))
(assert (=> (and (<= r23b i1) (<= i1 r24b)) (and (= o3 (+ i2 1)) (in_range1 (+ i2 1)))))
(assert (=> (and (<= r23b i1) (<= i1 r24b)) (= o4 (- o3 begidx11))))
(assert (=> (and (<= r23b i1) (<= i1 r24b)) (and (= temp___1618 o4) (in_range1 o4))))
(assert (=> (and (<= r23b i1) (<= i1 r24b)) (and (<= 1 temp___1618) (<= temp___1618 128))))
(assert (=> (and (<= r23b i1) (<= i1 r24b)) (= o6 temp___1618)))
(assert (=> (and (<= r23b i1) (<= i1 r24b)) (= o7 (store newdomainname2 o6 o5))))
(assert (=> (and (<= r23b i1) (<= i1 r24b)) (= result7 (mk_map__ref newdomainname2))))
(assert (=> (and (<= r23b i1) (<= i1 r24b)) (= newdomainname3 o7)))
(assert (=> (and (<= r23b i1) (<= i1 r24b)) (= i2 r24b)))
(assert (=> (and (<= r23b i1) (<= i1 r24b)) (= i3 (mk_int__ref i2))))
(assert (=> (and (<= r23b i1) (<= i1 r24b)) (= newdomainname4 (mk_map__ref newdomainname3))))
(assert (=> (and (<= r23b i1) (<= i1 r24b)) (= i4 i2)))
(assert (=> (and (<= r23b i1) (<= i1 r24b)) (= newdomainname5 newdomainname3)))
(assert (=> (and (<= r23b i1) (<= i1 r24b)) (= i5 i3)))
(assert (=> (and (<= r23b i1) (<= i1 r24b)) (= newdomainname6 newdomainname4)))
(assert (=> (and (<= r23b i1) (<= i1 r24b)) (= i6 i4)))
(assert (=> (and (<= r23b i1) (<= i1 r24b)) (= newdomainname7 newdomainname5)))
(assert (=> (not (and (<= r23b i1) (<= i1 r24b))) (= i5 (mk_int__ref i1))))
(assert (=> (not (and (<= r23b i1) (<= i1 r24b))) (= newdomainname6 (mk_map__ref newdomainname1))))
(assert (=> (not (and (<= r23b i1) (<= i1 r24b))) (= i6 i1)))
(assert (=> (not (and (<= r23b i1) (<= i1 r24b))) (= newdomainname7 newdomainname1)))
(assert (= (+ endidx8 1) r26b))
(assert (in_range1 r26b))
(assert (<= r26b 128))
(assert (not (<= (- 2147483648) r26b)))
(check-sat)
(exit)
