...
(assert true)
(assert (forall ((left us_rep) (right us_rep)) (! (= (= (oeq__2 left right) true) (= (let ((temp___315 (value right))) (let ((temp___314 (value left))) (bool_eq (to_array1 temp___314) (first3 temp___314) (last3 temp___314) (to_array1 temp___315) (first3 temp___315) (last3 temp___315)))) true)) :pattern ((oeq__2 left right)))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range3 f) (=> (in_range3 l) (and (= (to_rep2 (first6 (mk3 f l))) f) (= (to_rep2 (last7 (mk3 f l))) l)))) :pattern ((mk3 f l)))))
...
(define-fun last8 ((a us_t3)) Int (to_rep2 (last7 (rt3 a))))
...
(define-fun bool_eq5 ((x us_t3) (y us_t3)) Bool (bool_eq (elts3 x) (to_rep2 (first6 (rt3 x))) (to_rep2 (last7 (rt3 x))) (elts3 y) (to_rep2 (first6 (rt3 y))) (to_rep2 (last7 (rt3 y)))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range3 f) (=> (in_range3 l) (and (= (to_rep2 (first8 (mk4 f l))) f) (= (to_rep2 (last9 (mk4 f l))) l)))) :pattern ((mk4 f l)))))
(define-fun dynamic_property7 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range3 low) (and (in_range3 high) (=> (<= low high) (and (dynamic_property5 range_first range_last low) (dynamic_property5 range_first range_last high))))))
...
(define-fun last10 ((a us_t4)) Int (to_rep2 (last9 (rt4 a))))
...
(define-fun bool_eq6 ((x us_t4) (y us_t4)) Bool (bool_eq (elts4 x) (to_rep2 (first8 (rt4 x))) (to_rep2 (last9 (rt4 x))) (elts4 y) (to_rep2 (first8 (rt4 y))) (to_rep2 (last9 (rt4 y)))))
...
(define-fun dynamic_invariant6 ((temp___expr_229 Int) (temp___is_init_225 Bool) (temp___skip_constant_226 Bool) (temp___do_toplevel_227 Bool) (temp___do_typ_inv_228 Bool)) Bool (=> (or (= temp___is_init_225 true) (<= 1 2147483647)) (in_range5 temp___expr_229)))
...
(define-fun dynamic_invariant7 ((temp___expr_709 Int) (temp___is_init_705 Bool) (temp___skip_constant_706 Bool) (temp___do_toplevel_707 Bool) (temp___do_typ_inv_708 Bool)) Bool (=> (or (= temp___is_init_705 true) (<= 1 last6)) (dynamic_property5 1 last6 temp___expr_709)))
(assert (= last6 (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 source)))))
(declare-const to____split_fields natural_index)
(declare-const to____split_fields1 (Array Int character))
(declare-const to____split_fields2 t)
(declare-const o (Array Int character))
(declare-const temp___1093 (Array Int character))
(declare-const temp___10931 t4)
(declare-const temp___1094 (Array Int character))
(declare-const temp___10941 t3)
(declare-const o1 (Array Int character))
(declare-const temp___1098 (Array Int character))
(declare-const temp___10981 t3)
(declare-const temp___1100 (Array Int character))
(declare-const temp___11001 t3)
(declare-const o2 (Array Int character))
(declare-const o3 t)
(declare-const o4 natural_index)
(declare-const o5 (Array Int character))
(declare-const o6 t)
(declare-const temp___1103 natural_index)
(declare-const temp___11031 natural_index)
(declare-const temp___11032 (Array Int character))
(declare-const temp___11033 t)
(declare-const temp___1104 natural_index)
(declare-const temp___11041 natural_index)
(declare-const temp___11042 (Array Int character))
(declare-const temp___11043 t)
(declare-const o7 natural_index)
(declare-const o8 natural_index)
(declare-const o9 (Array Int character))
(declare-const o10 t)
(declare-const temp___1106 natural_index)
(declare-const temp___11061 natural_index)
(declare-const temp___11062 (Array Int character))
(declare-const temp___11063 t)
(declare-const result us_split_fields__ref)
(declare-const to____split_fields3 us_split_fields)
(define-fun temp___11034 () us_rep (mk___rep (mk___split_discrs temp___1103) (mk___split_fields temp___11031 (mk___t temp___11032 temp___11033))))
(assert (dynamic_invariant1 i52s true false true true))
(assert (dynamic_invariant1 source true false true true))
(assert (dynamic_invariant1 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t to____split_fields1 to____split_fields2))) true false true true))
(assert (<= (length1 source) (to_rep1 (rec__bounded_dynamic_strings__sequence__capacity to____split_discrs))))
(assert (= (to_rep1 (rec__bounded_dynamic_strings__sequence__capacity to____split_discrs)) r118b))
(assert (in_range2 r118b))
(assert (=> (<= 1 (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 source)))) (and (and (<= (to_rep2 (first (rt (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 source))))) 1) (<= 1 (to_rep2 (last (rt (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 source))))))) (and (<= (to_rep2 (first (rt (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 source))))) (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 source)))) (<= (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 source))) (to_rep2 (last (rt (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 source))))))))))
(assert (= o (elts (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 source)))))
(assert (= o temp___1093))
(assert (= (mk4 1 (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 source)))) temp___10931))
(assert (= (ite (<= (to_rep2 (first8 temp___10931)) (to_rep2 (last9 temp___10931))) (+ (- (to_rep2 (last9 temp___10931)) (to_rep2 (first8 temp___10931))) 1) 0) (ite (<= 1 last6) (+ (- last6 1) 1) 0)))
(assert (= temp___1093 temp___1094))
(assert (= (mk3 (to_rep2 (first8 temp___10931)) (to_rep2 (last9 temp___10931))) temp___10941))
(assert (=> (<= 1 (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 source)))) (and (and (<= (to_rep2 (first to____split_fields2)) 1) (<= 1 (to_rep2 (last to____split_fields2)))) (and (<= (to_rep2 (first to____split_fields2)) (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 source)))) (<= (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 source))) (to_rep2 (last to____split_fields2)))))))
(assert (= o1 to____split_fields1))
(assert (= o1 temp___1098))
(assert (= (mk3 1 (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 source)))) temp___10981))
(assert (= (ite (<= (to_rep2 (first6 temp___10941)) (to_rep2 (last7 temp___10941))) (+ (- (to_rep2 (last7 temp___10941)) (to_rep2 (first6 temp___10941))) 1) 0) (ite (<= (to_rep2 (first6 temp___10981)) (to_rep2 (last7 temp___10981))) (+ (- (to_rep2 (last7 temp___10981)) (to_rep2 (first6 temp___10981))) 1) 0)))
(assert (= (mk___t3 temp___1100 temp___11001) (mk___t3 temp___1094 temp___10941)))
(assert (and (and (= (to_rep2 (first to____split_fields2)) (to_rep2 (first o3))) (= (to_rep2 (last to____split_fields2)) (to_rep2 (last o3)))) (forall ((temp___1101 Int)) (ite (and (<= 1 temp___1101) (<= temp___1101 (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 source))))) (= (select o2 temp___1101) (select temp___1100 temp___1101)) (= (select o2 temp___1101) (select to____split_fields1 temp___1101))))))
(assert (= to____split_fields o4))
(assert (= o5 o2))
(assert (= o6 o3))
(assert (= to____split_discrs (mk___split_discrs temp___1103)))
(assert (= temp___11031 o4))
(assert (= temp___11032 o5))
(assert (= temp___11033 o6))
(assert (dynamic_predicate temp___11034))
(assert (= (mk___rep (mk___split_discrs temp___1104) (mk___split_fields temp___11041 (mk___t temp___11042 temp___11043))) temp___11034))
(assert (= result (mk___split_fields__ref (mk___split_fields to____split_fields (mk___t to____split_fields1 to____split_fields2)))))
(assert (= to____split_fields3 (mk___split_fields temp___11041 (mk___t temp___11042 temp___11043))))
(assert (= to____split_discrs (mk___split_discrs temp___1104)))
(assert (= (to_rep1 o7) (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 source)))))
(assert (= o7 o8))
(assert (= (rec__bounded_dynamic_strings__sequence__content to____split_fields3) (mk___t o9 o10)))
(assert (= to____split_discrs (mk___split_discrs temp___1106)))
(assert (= temp___11061 o8))
(assert (= temp___11062 o9))
(assert (= temp___11063 o10))
(assert (not (dynamic_predicate (mk___rep (mk___split_discrs temp___1106) (mk___split_fields temp___11061 (mk___t temp___11062 temp___11063))))))
(check-sat)
(exit)
