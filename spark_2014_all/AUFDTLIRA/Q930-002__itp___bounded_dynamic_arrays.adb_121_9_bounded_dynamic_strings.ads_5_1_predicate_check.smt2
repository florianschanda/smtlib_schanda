...
(define-fun dynamic_invariant2 ((temp___expr_206 us_t) (temp___is_init_202 Bool) (temp___skip_constant_203 Bool) (temp___do_toplevel_204 Bool) (temp___do_typ_inv_205 Bool)) Bool (=> (not (= temp___skip_constant_203 true)) (dynamic_property 1 2147483647 (first1 temp___expr_206) (last1 temp___expr_206))))
...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant1 this true true true true) (let ((result (value this))) (and (and (and (and (= (length result) (length2 this)) (= (first1 result) 1)) (= (last1 result) (length2 this))) (= (< 0 (length2 this)) (not (= (empty this) true)))) (dynamic_invariant2 result true false true true)))) :pattern ((value this)))))
...
(assert true)
(assert (forall ((left us_rep) (right us_rep)) (! (= (= (oeq__2 left right) true) (= (let ((temp___311 (value right))) (let ((temp___310 (value left))) (bool_eq (to_array temp___310) (first1 temp___310) (last1 temp___310) (to_array temp___311) (first1 temp___311) (last1 temp___311)))) true)) :pattern ((oeq__2 left right)))))
...
(define-fun dynamic_invariant7 ((temp___expr_705 Int) (temp___is_init_701 Bool) (temp___skip_constant_702 Bool) (temp___do_toplevel_703 Bool) (temp___do_typ_inv_704 Bool)) Bool (=> (or (= temp___is_init_701 true) (<= 1 last6)) (dynamic_property5 1 last6 temp___expr_705)))
...
(declare-const temp___10871 t4)
(declare-const temp___1088 (Array Int character))
(declare-const temp___10881 t3)
(declare-const o1 (Array Int character))
(declare-const temp___1092 (Array Int character))
(declare-const temp___10921 t3)
...
(declare-const o6 t1)
(declare-const temp___1097 natural_index)
(declare-const temp___10971 natural_index)
(declare-const temp___10972 (Array Int character))
(declare-const temp___10973 t1)
(declare-const temp___1098 natural_index)
(declare-const temp___10981 natural_index)
(declare-const temp___10982 (Array Int character))
(declare-const temp___10983 t1)
(declare-const o7 natural_index)
(declare-const o8 natural_index)
(declare-const o9 (Array Int character))
(declare-const o10 t1)
(declare-const temp___1100 natural_index)
(declare-const temp___11001 natural_index)
(declare-const temp___11002 (Array Int character))
(declare-const temp___11003 t1)
(declare-const result us_split_fields__ref)
(declare-const to____split_fields3 us_split_fields)
(define-fun temp___10974 () us_rep (mk___rep (mk___split_discrs temp___1097) (mk___split_fields temp___10971 (mk___t1 temp___10972 temp___10973))))
...
(assert (= o temp___1087))
(assert (= (mk4 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 source)))) temp___10871))
(assert (= (ite (<= (to_rep1 (first8 temp___10871)) (to_rep1 (last9 temp___10871))) (+ (- (to_rep1 (last9 temp___10871)) (to_rep1 (first8 temp___10871))) 1) 0) (ite (<= 1 last6) (+ (- last6 1) 1) 0)))
(assert (= temp___1087 temp___1088))
(assert (= (mk3 (to_rep1 (first8 temp___10871)) (to_rep1 (last9 temp___10871))) temp___10881))
(assert (=> (<= 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 source)))) (and (and (<= (to_rep1 (first2 to____split_fields2)) 1) (<= 1 (to_rep1 (last2 to____split_fields2)))) (and (<= (to_rep1 (first2 to____split_fields2)) (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 source)))) (<= (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 source))) (to_rep1 (last2 to____split_fields2)))))))
(assert (= o1 to____split_fields1))
(assert (= o1 temp___1092))
(assert (= (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 source)))) temp___10921))
(assert (= (ite (<= (to_rep1 (first6 temp___10881)) (to_rep1 (last7 temp___10881))) (+ (- (to_rep1 (last7 temp___10881)) (to_rep1 (first6 temp___10881))) 1) 0) (ite (<= (to_rep1 (first6 temp___10921)) (to_rep1 (last7 temp___10921))) (+ (- (to_rep1 (last7 temp___10921)) (to_rep1 (first6 temp___10921))) 1) 0)))
(assert (= (mk___t3 temp___1094 temp___10941) (mk___t3 temp___1088 temp___10881)))
(assert (and (and (= (to_rep1 (first2 to____split_fields2)) (to_rep1 (first2 o3))) (= (to_rep1 (last2 to____split_fields2)) (to_rep1 (last2 o3)))) (forall ((temp___1095 Int)) (ite (and (<= 1 temp___1095) (<= temp___1095 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 source))))) (= (select o2 temp___1095) (select temp___1094 temp___1095)) (= (select o2 temp___1095) (select to____split_fields1 temp___1095))))))
(assert (= to____split_fields o4))
(assert (= o5 o2))
(assert (= o6 o3))
(assert (= to____split_discrs (mk___split_discrs temp___1097)))
(assert (= temp___10971 o4))
(assert (= temp___10972 o5))
(assert (= temp___10973 o6))
(assert (dynamic_predicate temp___10974))
(assert (= (mk___rep (mk___split_discrs temp___1098) (mk___split_fields temp___10981 (mk___t1 temp___10982 temp___10983))) temp___10974))
...
(assert (= to____split_fields3 (mk___split_fields temp___10981 (mk___t1 temp___10982 temp___10983))))
(assert (= to____split_discrs (mk___split_discrs temp___1098)))
(assert (= (to_rep2 o7) (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 source)))))
(assert (= o7 o8))
(assert (= (rec__bounded_dynamic_strings__sequence__content to____split_fields3) (mk___t1 o9 o10)))
(assert (= to____split_discrs (mk___split_discrs temp___1100)))
(assert (= temp___11001 o8))
(assert (= temp___11002 o9))
(assert (= temp___11003 o10))
(assert (not (dynamic_predicate (mk___rep (mk___split_discrs temp___1100) (mk___split_fields temp___11001 (mk___t1 temp___11002 temp___11003))))))
(check-sat)
(exit)
