...
(assert (= o1 temp___1029))
(assert (= (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 source)))) temp___10291))
(assert (= (ite (<= (to_rep1 (first6 temp___10251)) (to_rep1 (last7 temp___10251))) (+ (- (to_rep1 (last7 temp___10251)) (to_rep1 (first6 temp___10251))) 1) 0) (ite (<= (to_rep1 (first6 temp___10291)) (to_rep1 (last7 temp___10291))) (+ (- (to_rep1 (last7 temp___10291)) (to_rep1 (first6 temp___10291))) 1) 0)))
(assert (= (mk___t3 temp___1031 temp___10311) (mk___t3 temp___1025 temp___10251)))
(assert (and (and (= (to_rep1 (first2 to____split_fields2)) (to_rep1 (first2 o3))) (= (to_rep1 (last2 to____split_fields2)) (to_rep1 (last2 o3)))) (forall ((temp___1032 Int)) (ite (and (<= 1 temp___1032) (<= temp___1032 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 source))))) (= (select o2 temp___1032) (select temp___1031 temp___1032)) (= (select o2 temp___1032) (select to____split_fields1 temp___1032))))))
(assert (= to____split_fields o4))
(assert (= o5 o2))
(assert (= o6 o3))
(assert (= to____split_discrs (mk___split_discrs temp___1034)))
(assert (= temp___10341 o4))
(assert (= temp___10342 o5))
(assert (= temp___10343 o6))
(assert (dynamic_predicate (mk___rep (mk___split_discrs temp___1034) (mk___split_fields temp___10341 (mk___t1 temp___10342 temp___10343)))))
(assert (= (mk___rep (mk___split_discrs temp___1035) (mk___split_fields temp___10351 (mk___t1 temp___10352 temp___10353))) (mk___rep (mk___split_discrs temp___1034) (mk___split_fields temp___10341 (mk___t1 temp___10342 temp___10343)))))
...
(assert (= to____split_fields3 (mk___split_fields temp___10351 (mk___t1 temp___10352 temp___10353))))
(assert (= to____split_discrs (mk___split_discrs temp___1035)))
...
(assert (= to____split_discrs (mk___split_discrs temp___1037)))
(assert (= temp___10371 o8))
(assert (= temp___10372 o9))
(assert (= temp___10373 o10))
(assert (not (dynamic_predicate (mk___rep (mk___split_discrs temp___1037) (mk___split_fields temp___10371 (mk___t1 temp___10372 temp___10373))))))
(check-sat)
(exit)
