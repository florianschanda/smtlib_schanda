...
(assert (= i40 r102b))
(assert (=> (and (<= r102b i40) (<= i40 r103b)) (and (and (= temp___1747 i40) (and (= temp___1748 endidx13) (and (= temp___1745 newemail1) (and (and (and (<= 1 begidx17) (<= (+ (- endidx13 begidx17) 1) 128)) (= endidx13 temp___1748)) (and (and (=> (<= r102b r103b) (dynamic_property2 r102b r103b i41)) (and (<= r102b i41) (<= i41 r103b))) (and (and (and (= (to_rep o14) (to_rep (select zonefileline i41))) (and (and (and (and (and (= o12 (+ i41 1)) (in_range1 (+ i41 1))) (= o13 (- o12 begidx17))) (and (= temp___1744 o13) (in_range1 o13))) (and (and (<= 1 temp___1744) (<= temp___1744 128)) (= o15 temp___1744))) (= o16 (store newemail2 o15 o14)))) (and (= result18 (mk_map__ref newemail2)) (= newemail3 o16))) (= i41 r103b))))))) (and (and (= i47 (mk_int__ref i41)) (= newemail8 (mk_map__ref newemail3))) (and (= i48 i41) (= newemail9 newemail3))))))
(assert (=> (and (<= r102b i40) (<= i40 r103b)) (= i49 i47)))
(assert (=> (and (<= r102b i40) (<= i40 r103b)) (= newemail10 newemail8)))
(assert (=> (and (<= r102b i40) (<= i40 r103b)) (= i50 i48)))
(assert (=> (and (<= r102b i40) (<= i40 r103b)) (= newemail11 newemail9)))
(assert (=> (not (and (<= r102b i40) (<= i40 r103b))) (= i49 (mk_int__ref i40))))
(assert (=> (not (and (<= r102b i40) (<= i40 r103b))) (= newemail10 (mk_map__ref newemail1))))
(assert (=> (not (and (<= r102b i40) (<= i40 r103b))) (= i50 i40)))
(assert (=> (not (and (<= r102b i40) (<= i40 r103b))) (= newemail11 newemail1)))
(assert (= (+ endidx13 1) r105b))
(assert (in_range1 r105b))
(assert (= result20 (mk_int__ref i3)))
(assert (= i51 r105b))
(assert (<= r105b i51))
(assert (<= i51 128))
(assert (<= 1 endidx13))
(assert (and (and (forall ((temp___1752 Int)) (=> (and (<= 1 temp___1752) (<= temp___1752 128)) (=> (<= i52 temp___1752) (= (select newemail12 temp___1752) (select (map__content newemail10) temp___1752))))) (=> (<= r105b 128) (dynamic_property3 r105b 128 i52))) (and (<= r105b i52) (<= i52 128))))
(assert (= (to_rep o17) 32))
(assert (= o18 (store newemail12 i52 o17)))
(assert (= result21 (mk_map__ref newemail12)))
(assert (= newemail13 o18))
(assert (not (= i52 128)))
(assert (= result22 (mk_int__ref i52)))
(assert (= i53 (+ i52 1)))
(assert (= i54 (mk_int__ref i53)))
(assert (= newemail14 (mk_map__ref newemail13)))
(assert (= i55 i53))
(assert (= newemail15 newemail13))
