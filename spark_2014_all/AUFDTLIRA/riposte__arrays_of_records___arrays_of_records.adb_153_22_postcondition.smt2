...
(assert (and (and (and (and (and (and (= (to_rep o) 69) (and (= (rec__arrays_of_records__basic_record__flag (us_split_fields1 (select a 23))) o1) (and (= (rec__arrays_of_records__basic_record__first_value (us_split_fields1 (select a 23))) o2) (= o o3)))) (and (= o4 o1) (and (= o5 o2) (= o6 o3)))) (= o7 (store a 23 (mk___rep (mk___split_fields o4 o5 o6))))) (and (= (mk_map__ref result) (mk_map__ref a)) (= a1 o7))) (and (and (and (and (and (= (to_rep o8) 23) (and (= (rec__arrays_of_records__basic_record__flag (us_split_fields1 (select a1 17))) o9) (and (= o8 o10) (= (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select a1 17))) o11)))) (and (= o12 o9) (and (= o13 o10) (= o14 o11)))) (= o15 (store a1 17 (mk___rep (mk___split_fields o12 o13 o14))))) (and (= a1 result1) (= a2 o15))) (and (and (and (and (and (= (to_rep o16) 42) (and (= (rec__arrays_of_records__basic_record__flag (us_split_fields1 (select a2 5))) o17) (and (= o16 o18) (= (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select a2 5))) o19)))) (and (= o20 o17) (and (= o21 o18) (= o22 o19)))) (= o23 (store a2 5 (mk___rep (mk___split_fields o20 o21 o22))))) (and (= a2 result2) (= a3 o23))) (and (and (= a3 result3) (= a4 (store a3 23 (mk___rep (mk___split_fields (of_int 1) (rec__arrays_of_records__basic_record__first_value (us_split_fields1 (select a3 23))) (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select a3 23)))))))) (= (to_rep (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select a4 23)))) 69))))) (and (= a4 a5) (= a6 a4))))
(assert (not (not (= (to_rep (rec__arrays_of_records__basic_record__first_value (us_split_fields1 (select a5 17)))) 23))))
(check-sat)
(exit)
