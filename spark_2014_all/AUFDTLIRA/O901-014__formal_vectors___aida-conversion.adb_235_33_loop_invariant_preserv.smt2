...
(assert (forall ((temp___1260 Int) (temp___1261 Int) (temp___1262 Int) (temp___1263 Int) (temp___1264 Int) (temp___1265 Int) (temp___1266 Int) (temp___1267 Int) (temp___1268 Int) (temp___1269 Int) (temp___1270 Int) (temp___1271 Int)) (let ((temp___1259 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_647__int_array__aggregate_def temp___1260 temp___1261 temp___1262 temp___1263 temp___1264 temp___1265 temp___1266 temp___1267 temp___1268 temp___1269 temp___1270 temp___1271))) (=> (and (and (and (and (and (and (and (and (and (dynamic_invariant temp___1260 true true true true) (dynamic_invariant temp___1261 true true true true)) (dynamic_invariant temp___1262 true true true true)) (dynamic_invariant temp___1263 true true true true)) (dynamic_invariant temp___1264 true true true true)) (dynamic_invariant temp___1265 true true true true)) (dynamic_invariant temp___1266 true true true true)) (dynamic_invariant temp___1267 true true true true)) (dynamic_invariant temp___1268 true true true true)) (dynamic_invariant temp___1269 true true true true)) (and (=> (dynamic_property10 (first1 source) (+ (first1 source) 9) temp___1270 temp___1271) (and (= (first5 temp___1259) temp___1270) (= (last5 temp___1259) temp___1271))) (and (and (and (and (and (and (and (and (and (= (select (to_array2 temp___1259) (+ (first1 source) 0)) rliteral) (= (select (to_array2 temp___1259) (+ (first1 source) 1)) rliteral1)) (= (select (to_array2 temp___1259) (+ (first1 source) 2)) rliteral2)) (= (select (to_array2 temp___1259) (+ (first1 source) 3)) rliteral3)) (= (select (to_array2 temp___1259) (+ (first1 source) 4)) rliteral2)) (= (select (to_array2 temp___1259) (+ (first1 source) 5)) rliteral4)) (= (select (to_array2 temp___1259) (+ (first1 source) 6)) rliteral5)) (= (select (to_array2 temp___1259) (+ (first1 source) 7)) rliteral6)) (= (select (to_array2 temp___1259) (+ (first1 source) 8)) rliteral2)) (= (select (to_array2 temp___1259) (+ (first1 source) 9)) rliteral3)))))))
(define-fun dynamic_invariant4 ((temp___expr_194 us_t3) (temp___is_init_190 Bool) (temp___skip_constant_191 Bool) (temp___do_toplevel_192 Bool) (temp___do_typ_inv_193 Bool)) Bool (=> (not (= temp___skip_constant_191 true)) (and (dynamic_property6 (first1 source) (+ (first1 source) 9) (first7 temp___expr_194) (last7 temp___expr_194)) (and (= (first7 temp___expr_194) (first1 source)) (= (last7 temp___expr_194) (+ (first1 source) 9))))))
(declare-sort t6 0)
...
(assert (= (integerqtint rliteral7) 0))
(assert (forall ((temp___1277 Int) (temp___1278 Int) (temp___1279 Int)) (let ((temp___1276 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_647__n__aggregate_def temp___1277 temp___1278 temp___1279))) (=> (dynamic_invariant temp___1277 true true true true) (and (=> (dynamic_property11 (first1 source) (+ (first1 source) 9) temp___1278 temp___1279) (and (= (first9 temp___1276) temp___1278) (= (last9 temp___1276) temp___1279))) (forall ((temp___1280 Int)) (= (select (to_array4 temp___1276) temp___1280) rliteral7)))))))
...
(declare-const temp___1274 (Array Int integer))
...
(declare-const temp___1282 (Array Int integer))
(declare-const temp___12821 t4)
...
(assert (and (and (= (length source) 10) (and (and (and (and (and (and (and (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 50) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 49)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 3))) 55)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 4))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 5))) 56)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 6))) 51)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 7))) 54)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 8))) 52)) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 9))) 56))) (forall ((index4 Int)) (=> (and (<= (to_rep1 (first (rt source))) index4) (<= index4 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index4))) true)))))
...
(assert (= (mk___t2 temp___1274 temp___12741) (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_647__int_array__aggregate_def 2 1 4 7 4 8 3 6 4 7 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))
(assert (= (ite (<= (to_rep1 (first4 temp___12741)) (to_rep1 (last4 temp___12741))) (+ (- (to_rep1 (last4 temp___12741)) (to_rep1 (first4 temp___12741))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0)))
(assert (= (slide1 temp___1274 (to_rep1 (first4 temp___12741)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_647__int_array__assume))
...
(assert (= (mk___t4 temp___1282 temp___12821) (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_647__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))
(assert (= (ite (<= (to_rep1 (first8 temp___12821)) (to_rep1 (last8 temp___12821))) (+ (- (to_rep1 (last8 temp___12821)) (to_rep1 (first8 temp___12821))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0)))
(assert (= (slide1 temp___1282 (to_rep1 (first8 temp___12821)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_647__n__assume))
...
(assert (and (and (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (dynamic_property9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) index2)) (forall ((temp___1289 Int)) (=> (and (<= (to_rep1 n__first) temp___1289) (<= temp___1289 (to_rep1 n__last))) (=> (or (< temp___1285 temp___1289) (or (< temp___1289 (to_rep1 (first (rt source)))) (< index2 temp___1289))) (= (select n3 temp___1289) (select n1 temp___1289)))))) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (+ (to_rep1 (first (rt source))) 9)))))
(assert (not (= index2 temp___1285)))
