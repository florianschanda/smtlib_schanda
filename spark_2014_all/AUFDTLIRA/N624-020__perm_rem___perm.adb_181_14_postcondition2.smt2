...
(assert (= (distinct (perm_symmetric c a) 0) true))
(assert (= perm__shift_perm_r__result1 perm__shift_perm_r__result2))
(assert (= perm__shift_perm_r__result3 perm__shift_perm_r__result1))
(assert (= (mk_int__ref result) (mk_int__ref perm__shift_perm_r__result)))
(assert (= perm__shift_perm_r__result1 1))
(assert (= (mk_int__ref perm__shift_perm_r__result4) (mk_int__ref perm__shift_perm_r__result2)))
(assert (= perm__shift_perm_r__result5 perm__shift_perm_r__result3))
(assert (= result1 perm__shift_perm_r__result4))
(assert (= (distinct perm__shift_perm_r__result4 0) true))
(assert (not (= (is_perm a c) true)))
(check-sat)
(exit)
