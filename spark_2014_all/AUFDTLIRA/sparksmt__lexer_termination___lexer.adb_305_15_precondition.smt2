...
(define-fun dynamic_invariant4 ((temp___expr_702 Int) (temp___is_init_699 Bool) (temp___skip_constant_700 Bool) (temp___do_toplevel_701 Bool)) Bool (=> (or (= temp___is_init_699 true) (<= 0 1)) (in_range5 temp___expr_702)))
...
(assert (forall ((us_void_param tuple0)) (! (= (to_rep (select (temp___String_Literal_933 us_void_param) 1)) 58) :pattern ((temp___String_Literal_933 us_void_param)))))
(declare-fun temp___String_Literal_934 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (= (to_rep (select (temp___String_Literal_934 us_void_param) 1)) 58) :pattern ((temp___String_Literal_934 us_void_param)))))
(declare-fun temp___String_Literal_935 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_935 us_void_param) 1)) 58) (= (to_rep (select (temp___String_Literal_935 us_void_param) 2)) 32)) :pattern ((temp___String_Literal_935 us_void_param)))))
