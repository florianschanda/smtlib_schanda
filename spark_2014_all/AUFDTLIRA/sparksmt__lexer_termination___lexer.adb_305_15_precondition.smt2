...
(define-fun dynamic_invariant4 ((temp___expr_710 Int) (temp___is_init_707 Bool) (temp___skip_constant_708 Bool) (temp___do_toplevel_709 Bool)) Bool (=> (or (= temp___is_init_707 true) (<= 0 1)) (in_range5 temp___expr_710)))
...
(assert (forall ((us_void_param tuple0)) (! (= (to_rep (select (temp___String_Literal_943 us_void_param) 1)) 58) :pattern ((temp___String_Literal_943 us_void_param)))))
(declare-fun temp___String_Literal_944 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (= (to_rep (select (temp___String_Literal_944 us_void_param) 1)) 58) :pattern ((temp___String_Literal_944 us_void_param)))))
(declare-fun temp___String_Literal_945 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_945 us_void_param) 1)) 58) (= (to_rep (select (temp___String_Literal_945 us_void_param) 2)) 32)) :pattern ((temp___String_Literal_945 us_void_param)))))
