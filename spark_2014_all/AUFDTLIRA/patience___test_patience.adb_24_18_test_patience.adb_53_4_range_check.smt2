...
(assert (=> (and (<= (to_rep1 input__first) i2) (<= i2 (to_rep1 input__last))) (= (mk___t temp___786 temp___7861) (to_string o17))))
(assert (=> (and (<= (to_rep1 input__first) i2) (<= i2 (to_rep1 input__last))) (=> (<= (to_rep1 (first temp___7861)) (to_rep1 (last temp___7861))) (= o18 (+ (- (to_rep1 (last temp___7861)) (to_rep1 (first temp___7861))) 1)))))
(assert (=> (and (<= (to_rep1 input__first) i2) (<= i2 (to_rep1 input__last))) (=> (not (<= (to_rep1 (first temp___7861)) (to_rep1 (last temp___7861)))) (= o18 0))))
...
(assert (=> (and (<= (to_rep1 input__first) i2) (<= i2 (to_rep1 input__last))) (= o24 (concat1 (temp___String_Literal_784 Tuple0) 1 1 temp___786 (to_rep1 (first temp___7861)) (to_rep1 (last temp___7861))))))
