...
(assert (= i9 0))
(assert (<= 0 i9))
(assert (<= i9 (- (to_rep3 (rec__patience__state__numelts (us_split_fields1 c60b))) 1)))
(assert (and (<= 0 i10) (<= i10 (- (to_rep3 (rec__patience__state__numelts (us_split_fields1 c60b))) 1))))
...
(assert (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (select (rec__patience__state__values (us_split_fields1 c60b)) i10))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (select (rec__patience__state__values (us_split_fields1 c60b)) i10))))))))) (= o34 0)))
