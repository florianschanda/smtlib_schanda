...
(define-fun dynamic_invariant ((temp___expr_596 Int) (temp___is_init_592 Bool) (temp___skip_constant_593 Bool) (temp___do_toplevel_594 Bool) (temp___do_typ_inv_595 Bool)) Bool (=> (or (= temp___is_init_592 true) (<= 1 10)) (in_range4 temp___expr_596)))
...
(define-fun dynamic_invariant1 ((temp___expr_572 Int) (temp___is_init_568 Bool) (temp___skip_constant_569 Bool) (temp___do_toplevel_570 Bool) (temp___do_typ_inv_571 Bool)) Bool (=> (or (= temp___is_init_568 true) (<= 1 10)) (in_range5 temp___expr_572)))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_622 us_void_param) 1)) 84) (= (to_rep (select (temp___String_Literal_622 us_void_param) 2)) 104)) (= (to_rep (select (temp___String_Literal_622 us_void_param) 3)) 101)) (= (to_rep (select (temp___String_Literal_622 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_622 us_void_param) 5)) 118)) (= (to_rep (select (temp___String_Literal_622 us_void_param) 6)) 97)) (= (to_rep (select (temp___String_Literal_622 us_void_param) 7)) 108)) (= (to_rep (select (temp___String_Literal_622 us_void_param) 8)) 117)) (= (to_rep (select (temp___String_Literal_622 us_void_param) 9)) 101)) (= (to_rep (select (temp___String_Literal_622 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_622 us_void_param) 11)) 49)) (= (to_rep (select (temp___String_Literal_622 us_void_param) 12)) 48)) (= (to_rep (select (temp___String_Literal_622 us_void_param) 13)) 32)) (= (to_rep (select (temp___String_Literal_622 us_void_param) 14)) 119)) (= (to_rep (select (temp___String_Literal_622 us_void_param) 15)) 97)) (= (to_rep (select (temp___String_Literal_622 us_void_param) 16)) 115)) (= (to_rep (select (temp___String_Literal_622 us_void_param) 17)) 32)) (= (to_rep (select (temp___String_Literal_622 us_void_param) 18)) 102)) (= (to_rep (select (temp___String_Literal_622 us_void_param) 19)) 111)) (= (to_rep (select (temp___String_Literal_622 us_void_param) 20)) 117)) (= (to_rep (select (temp___String_Literal_622 us_void_param) 21)) 110)) (= (to_rep (select (temp___String_Literal_622 us_void_param) 22)) 100)) (= (to_rep (select (temp___String_Literal_622 us_void_param) 23)) 32)) (= (to_rep (select (temp___String_Literal_622 us_void_param) 24)) 97)) (= (to_rep (select (temp___String_Literal_622 us_void_param) 25)) 116)) (= (to_rep (select (temp___String_Literal_622 us_void_param) 26)) 32)) (= (to_rep (select (temp___String_Literal_622 us_void_param) 27)) 105)) (= (to_rep (select (temp___String_Literal_622 us_void_param) 28)) 110)) (= (to_rep (select (temp___String_Literal_622 us_void_param) 29)) 100)) (= (to_rep (select (temp___String_Literal_622 us_void_param) 30)) 101)) (= (to_rep (select (temp___String_Literal_622 us_void_param) 31)) 120)) (= (to_rep (select (temp___String_Literal_622 us_void_param) 32)) 32)) :pattern ((temp___String_Literal_622 us_void_param)))))
(declare-fun temp___String_Literal_625 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_625 us_void_param) 1)) 84) (= (to_rep (select (temp___String_Literal_625 us_void_param) 2)) 104)) (= (to_rep (select (temp___String_Literal_625 us_void_param) 3)) 101)) (= (to_rep (select (temp___String_Literal_625 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_625 us_void_param) 5)) 118)) (= (to_rep (select (temp___String_Literal_625 us_void_param) 6)) 97)) (= (to_rep (select (temp___String_Literal_625 us_void_param) 7)) 108)) (= (to_rep (select (temp___String_Literal_625 us_void_param) 8)) 117)) (= (to_rep (select (temp___String_Literal_625 us_void_param) 9)) 101)) (= (to_rep (select (temp___String_Literal_625 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_625 us_void_param) 11)) 49)) (= (to_rep (select (temp___String_Literal_625 us_void_param) 12)) 48)) (= (to_rep (select (temp___String_Literal_625 us_void_param) 13)) 32)) (= (to_rep (select (temp___String_Literal_625 us_void_param) 14)) 119)) (= (to_rep (select (temp___String_Literal_625 us_void_param) 15)) 97)) (= (to_rep (select (temp___String_Literal_625 us_void_param) 16)) 115)) (= (to_rep (select (temp___String_Literal_625 us_void_param) 17)) 32)) (= (to_rep (select (temp___String_Literal_625 us_void_param) 18)) 110)) (= (to_rep (select (temp___String_Literal_625 us_void_param) 19)) 111)) (= (to_rep (select (temp___String_Literal_625 us_void_param) 20)) 116)) (= (to_rep (select (temp___String_Literal_625 us_void_param) 21)) 32)) (= (to_rep (select (temp___String_Literal_625 us_void_param) 22)) 102)) (= (to_rep (select (temp___String_Literal_625 us_void_param) 23)) 111)) (= (to_rep (select (temp___String_Literal_625 us_void_param) 24)) 117)) (= (to_rep (select (temp___String_Literal_625 us_void_param) 25)) 110)) (= (to_rep (select (temp___String_Literal_625 us_void_param) 26)) 100)) :pattern ((temp___String_Literal_625 us_void_param)))))
...
(assert (= (naturalqtint rliteral1) 4))
(declare-const rliteral2 natural)
(assert (= (naturalqtint rliteral2) 6))
(declare-const rliteral3 natural)
(assert (= (naturalqtint rliteral3) 8))
(declare-const rliteral4 natural)
(assert (= (naturalqtint rliteral4) 10))
(declare-const rliteral5 natural)
(assert (= (naturalqtint rliteral5) 12))
(declare-const rliteral6 natural)
(assert (= (naturalqtint rliteral6) 14))
(declare-const rliteral7 natural)
(assert (= (naturalqtint rliteral7) 16))
(declare-const rliteral8 natural)
(assert (= (naturalqtint rliteral8) 18))
(declare-const rliteral9 natural)
(assert (= (naturalqtint rliteral9) 20))
(assert (forall ((temp___611 Int) (temp___612 Int) (temp___613 Int) (temp___614 Int) (temp___615 Int) (temp___616 Int) (temp___617 Int) (temp___618 Int) (temp___619 Int) (temp___620 Int)) (let ((temp___610 (search_demo__search_array__aggregate_def temp___611 temp___612 temp___613 temp___614 temp___615 temp___616 temp___617 temp___618 temp___619 temp___620))) (=> (and (and (and (and (and (and (and (and (and (dynamic_invariant3 temp___611 true true true true) (dynamic_invariant3 temp___612 true true true true)) (dynamic_invariant3 temp___613 true true true true)) (dynamic_invariant3 temp___614 true true true true)) (dynamic_invariant3 temp___615 true true true true)) (dynamic_invariant3 temp___616 true true true true)) (dynamic_invariant3 temp___617 true true true true)) (dynamic_invariant3 temp___618 true true true true)) (dynamic_invariant3 temp___619 true true true true)) (dynamic_invariant3 temp___620 true true true true)) (and (and (and (and (and (and (and (and (and (= (select temp___610 1) rliteral) (= (select temp___610 2) rliteral1)) (= (select temp___610 3) rliteral2)) (= (select temp___610 4) rliteral3)) (= (select temp___610 5) rliteral4)) (= (select temp___610 6) rliteral5)) (= (select temp___610 7) rliteral6)) (= (select temp___610 8) rliteral7)) (= (select temp___610 9) rliteral8)) (= (select temp___610 10) rliteral9))))))
...
(assert (=> (<= 1 10) (in_range5 result_index)))
(declare-const j Int)
(assert (<= 1 j))
(assert (<= j 10))
(declare-const k Int)
