...
(assert (forall ((temp___3583 (Array Int us_rep))) (forall ((temp___3584 Int)) (forall ((temp___3585 us_rep)) (let ((temp___3582 (temp___3581 temp___3583 temp___3584 temp___3585))) (forall ((temp___3586 Int)) (ite (= temp___3586 temp___3584) (= (select temp___3582 temp___3586) temp___3585) (= (select temp___3582 temp___3586) (select temp___3583 temp___3586)))))))))
(declare-fun temp___3587 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___3589 (Array Int et1))) (forall ((temp___3590 Int) (temp___3591 Int)) (let ((temp___3588 (temp___3587 temp___3589 temp___3590 temp___3591))) (forall ((temp___3592 Int)) (ite (= temp___3592 temp___3590) (= (select temp___3588 temp___3592) (of_rep temp___3591)) (= (select temp___3588 temp___3592) (select temp___3589 temp___3592))))))))
...
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (bool_eq2 a2 1 16 (temp___3581 a i (mk___rep (mk___split_fields (temp___3587 (rec__ar__rofa1__s1 (us_split_fields1 (select a i))) j e) (rec__ar__rofa1__t1 (us_split_fields1 (select a i)))))) 1 16) true)))
(check-sat)
(exit)
