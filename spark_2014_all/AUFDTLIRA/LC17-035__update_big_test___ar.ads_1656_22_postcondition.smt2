...
(declare-fun temp_____aggregate_def_3640 ((Array Int us_rep) Int us_rep) (Array Int us_rep))
(declare-fun temp_____aggregate_def_3646 ((Array Int et1) Int Int) (Array Int et1))
...
(assert (forall ((temp___3642 (Array Int us_rep))) (forall ((temp___3643 Int)) (forall ((temp___3644 us_rep)) (let ((temp___3641 (temp_____aggregate_def_3640 temp___3642 temp___3643 temp___3644))) (=> (dynamic_invariant1 temp___3643 true true true true) (forall ((temp___3645 Int)) (ite (= temp___3645 temp___3643) (= (select temp___3641 temp___3645) temp___3644) (= (select temp___3641 temp___3645) (select temp___3642 temp___3645))))))))))
(assert (forall ((temp___3648 (Array Int et1))) (forall ((temp___3649 Int) (temp___3650 Int)) (let ((temp___3647 (temp_____aggregate_def_3646 temp___3648 temp___3649 temp___3650))) (=> (and (dynamic_invariant temp___3649 true true true true) (dynamic_invariant2 temp___3650 true true true true)) (forall ((temp___3651 Int)) (ite (= temp___3651 temp___3649) (= (to_rep (select temp___3647 temp___3651)) temp___3650) (= (select temp___3647 temp___3651) (select temp___3648 temp___3651)))))))))
...
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (bool_eq2 a2 1 16 (temp_____aggregate_def_3640 a i (mk___rep (mk___split_fields (temp_____aggregate_def_3646 (rec__ar__rofa1__s1 (us_split_fields1 (select a i))) j e) (rec__ar__rofa1__t1 (us_split_fields1 (select a i)))))) 1 16) true)))
(check-sat)
(exit)
