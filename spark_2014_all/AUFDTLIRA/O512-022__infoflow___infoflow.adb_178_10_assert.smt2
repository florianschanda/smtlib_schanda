...
(declare-const temp___474 (Array Int integer))
(declare-const o Int)
...
(assert (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1)) (= temp___476 i_v11)))
(assert (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1)) (= temp___474 a_v1)))
(assert (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1)) (forall ((m Int)) (=> (and (<= (to_rep a_v1__first) m) (<= m (- i_v12 1))) (= (to_rep (select a_v12 m)) (to_rep (select (elts b_v1) m)))))))
(assert (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1)) (and (and (forall ((temp___475 Int)) (=> (and (<= (to_rep a_v1__first) temp___475) (<= temp___475 (to_rep a_v1__last))) (=> (<= i_v12 temp___475) (= (select a_v12 temp___475) (select temp___474 temp___475))))) (=> (<= (to_rep a_v1__first) k_1) (dynamic_property1 (to_rep a_v1__first) k_1 i_v12))) (and (<= (to_rep a_v1__first) i_v12) (<= i_v12 k_1)))))
...
(assert (<= m k_1))
(assert (not (= (to_rep (select a_v16 m)) (to_rep (select (elts b_v1) m)))))
(check-sat)
(exit)
