...
(assert (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1)) (= temp___433 i_v11)))
(assert (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1)) (= temp___431 a_v1)))
...
(assert (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1)) (and (and (forall ((temp___432 Int)) (=> (and (<= (to_rep a_v1__first) temp___432) (<= temp___432 (to_rep a_v1__last))) (=> (<= i_v12 temp___432) (= (select a_v12 temp___432) (select temp___431 temp___432))))) (=> (<= (to_rep a_v1__first) k_1) (dynamic_property1 (to_rep a_v1__first) k_1 i_v12))) (and (<= (to_rep a_v1__first) i_v12) (<= i_v12 k_1)))))
