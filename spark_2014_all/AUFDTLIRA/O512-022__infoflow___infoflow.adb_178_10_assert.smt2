...
(assert (=> (and (<= (to_rep a_v1__first) i_v12) (<= i_v12 k_1)) (and (and (= temp___433 i_v12) (and (= temp___431 a_v1) (and (forall ((m12 Int)) (=> (and (<= (to_rep a_v1__first) m12) (<= m12 (- i_v13 1))) (= (to_rep (select a_v12 m12)) (to_rep (select (elts b_v1) m12))))) (and (and (and (forall ((temp___432 Int)) (=> (and (<= (to_rep a_v1__first) temp___432) (<= temp___432 (to_rep a_v1__last))) (=> (<= i_v13 temp___432) (= (select a_v12 temp___432) (select temp___431 temp___432))))) (=> (<= (to_rep a_v1__first) k_1) (dynamic_property1 (to_rep a_v1__first) k_1 i_v13))) (and (<= (to_rep a_v1__first) i_v13) (<= i_v13 k_1))) (and (and (and (and (and (and (and (and (<= (to_rep (first (rt b_v1))) i_v13) (<= i_v13 (to_rep (last (rt b_v1))))) (= o9 i_v13)) (= o10 (select (elts b_v1) o9))) (= o11 (to_rep o10))) (= (to_rep o12) o11)) (and (and (and (<= (to_rep a_v1__first) i_v13) (<= i_v13 (to_rep a_v1__last))) (= o13 i_v13)) (= o14 (store a_v12 o13 o12)))) (and (= a_v12 result3) (= a_v13 o14))) (= i_v13 k_1)))))) (and (and (= i_v13 i_v17) (= a_v13 a_v16)) (and (= i_v18 i_v13) (= a_v17 a_v13))))))
(assert (=> (and (<= (to_rep a_v1__first) i_v12) (<= i_v12 k_1)) (= (mk_int__ref i_v19) (mk_int__ref i_v17))))
(assert (=> (and (<= (to_rep a_v1__first) i_v12) (<= i_v12 k_1)) (= (mk_map__ref a_v18) (mk_map__ref a_v16))))
(assert (=> (and (<= (to_rep a_v1__first) i_v12) (<= i_v12 k_1)) (= i_v110 i_v18)))
(assert (=> (and (<= (to_rep a_v1__first) i_v12) (<= i_v12 k_1)) (= a_v19 a_v17)))
(assert (=> (not (and (<= (to_rep a_v1__first) i_v12) (<= i_v12 k_1))) (= i_v12 i_v19)))
(assert (=> (not (and (<= (to_rep a_v1__first) i_v12) (<= i_v12 k_1))) (= (mk_map__ref a_v18) (mk_map__ref a_v1))))
(assert (=> (not (and (<= (to_rep a_v1__first) i_v12) (<= i_v12 k_1))) (= i_v110 i_v12)))
(assert (=> (not (and (<= (to_rep a_v1__first) i_v12) (<= i_v12 k_1))) (= a_v19 a_v11)))
(declare-const m12 Int)
(assert (<= (to_rep a_v1__first) m12))
(assert (<= m12 k_1))
(assert (not (= (to_rep (select a_v18 m12)) (to_rep (select (elts b_v1) m12)))))
(check-sat)
(exit)
