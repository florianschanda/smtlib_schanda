...
(assert (and (= o86 (has_key1 (positions (mk___rep d__split_discrs d__split_fields2)) c5)) (= (= o86 true) (= (has_key1 (positions (mk___rep d__split_discrs d__split_fields2)) c5) true))))
(assert (= o87 true))
(assert (= result16 (ite (= o87 true) o86 false)))
(assert (= result16 true))
(assert (and (= o88 (key (mk___rep d__split_discrs d__split_fields2) c5)) (and (in_range7 o88) (= o88 (get (keys (mk___rep d__split_discrs d__split_fields2)) (get1 (positions (mk___rep d__split_discrs d__split_fields2)) c5))))))
(assert (= result17 (ite (= o88 (to_rep (select a1 i))) true false)))
(assert (= result17 true))
(assert (not (= (has_key1 (positions (mk___rep d__split_discrs d__split_fields2)) c5) true)))
(check-sat)
(exit)
