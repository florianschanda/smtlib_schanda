...
(define-fun bool_eq2 ((a (Array Int us_t)) (a__first Int) (a__last Int) (b (Array Int us_t)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_156 Int)) (=> (and (<= a__first temp___idx_156) (<= temp___idx_156 a__last)) (= (bool_eq1 (select a temp___idx_156) (select b (+ (- b__first a__first) temp___idx_156))) true)))) true false))
...
(assert (forall ((i tarray2D1)) (and (<= 1 (tarray2D1qtint i)) (<= (tarray2D1qtint i) 1))))
...
(define-fun dynamic_invariant1 ((temp___expr_205 (Array Int us_t)) (temp___is_init_201 Bool) (temp___skip_constant_202 Bool) (temp___do_toplevel_203 Bool) (temp___do_typ_inv_204 Bool)) Bool (forall ((temp___206 Int)) (=> (and (<= 1 temp___206) (<= temp___206 1)) (and (dynamic_property1 1 x (first1 (select temp___expr_205 temp___206)) (last1 (select temp___expr_205 temp___206))) (and (= (first1 (select temp___expr_205 temp___206)) 1) (= (last1 (select temp___expr_205 temp___206)) x))))))
...
(define-fun dynamic_invariant2 ((temp___expr_195 us_t) (temp___is_init_191 Bool) (temp___skip_constant_192 Bool) (temp___do_toplevel_193 Bool) (temp___do_typ_inv_194 Bool)) Bool (=> (not (= temp___skip_constant_192 true)) (and (dynamic_property1 1 x (first1 temp___expr_195) (last1 temp___expr_195)) (and (= (first1 temp___expr_195) 1) (= (last1 temp___expr_195) x)))))
(declare-sort t2 0)
...
(assert (forall ((temp___240 Int) (temp___241 Int) (temp___242 Int)) (let ((temp___239 (component_size_attribute__p__a1__aggregate_def temp___240 temp___241 temp___242))) (=> (dynamic_invariant temp___240 true true true true) (and (=> (dynamic_property4 1 x temp___241 temp___242) (and (= (first3 temp___239) temp___241) (= (last3 temp___239) temp___242))) (forall ((temp___243 Int)) (= (select (to_array1 temp___239) temp___243) rliteral)))))))
(assert (forall ((temp___248 us_t)) (=> (dynamic_invariant2 temp___248 true true true true) (forall ((temp___249 Int)) (= (select (component_size_attribute__p__a2__aggregate_def temp___248) temp___249) temp___248)))))
(declare-const temp___245 (Array Int integer))
(declare-const temp___2451 t1)
(assert (in_range x))
...
(assert (= (mk___t1 temp___245 temp___2451) (component_size_attribute__p__a1__aggregate_def 1 1 x)))
(assert (not (= (ite (<= (to_rep (first2 temp___2451)) (to_rep (last2 temp___2451))) (+ (- (to_rep (last2 temp___2451)) (to_rep (first2 temp___2451))) 1) 0) (ite (<= 1 x) (+ (- x 1) 1) 0))))
(check-sat)
(exit)
