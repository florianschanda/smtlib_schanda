...
(define-fun bool_eq2 ((a (Array Int us_t)) (a__first Int) (a__last Int) (b (Array Int us_t)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_134 Int)) (=> (and (<= a__first temp___idx_134) (<= temp___idx_134 a__last)) (= (bool_eq1 (select a temp___idx_134) (select b (+ (- b__first a__first) temp___idx_134))) true)))) true false))
(assert (forall ((a (Array Int us_t)) (b (Array Int us_t))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq2 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_134 Int)) (=> (and (<= a__first temp___idx_134) (<= temp___idx_134 a__last)) (= (bool_eq1 (select a temp___idx_134) (select b (+ (- b__first a__first) temp___idx_134))) true))))))))
...
(define-fun dynamic_invariant1 ((temp___expr_177 (Array Int us_t)) (temp___is_init_174 Bool) (temp___skip_constant_175 Bool) (temp___do_toplevel_176 Bool)) Bool (forall ((temp___178 Int)) (=> (and (<= 1 temp___178) (<= temp___178 1)) (and (dynamic_property1 1 x (first1 (select temp___expr_177 temp___178)) (last1 (select temp___expr_177 temp___178))) (and (= (first1 (select temp___expr_177 temp___178)) 1) (= (last1 (select temp___expr_177 temp___178)) x))))))
...
(declare-fun component_size_attribute__p__a1__aggregate_def (Int Int Int) us_t1)
(assert (forall ((temp___210 Int) (temp___211 Int) (temp___212 Int)) (let ((temp___209 (component_size_attribute__p__a1__aggregate_def temp___210 temp___211 temp___212))) (and (=> (dynamic_property4 1 x temp___211 temp___212) (and (= (first3 temp___209) temp___211) (= (last3 temp___209) temp___212))) (forall ((temp___213 Int)) (= (select (to_array1 temp___209) temp___213) (of_rep temp___210)))))))
(declare-fun component_size_attribute__p__a2__aggregate_def (us_t) (Array Int us_t))
(assert (forall ((temp___218 us_t)) (forall ((temp___219 Int)) (= (select (component_size_attribute__p__a2__aggregate_def temp___218) temp___219) temp___218))))
(define-fun dynamic_invariant2 ((temp___expr_168 us_t) (temp___is_init_165 Bool) (temp___skip_constant_166 Bool) (temp___do_toplevel_167 Bool)) Bool (=> (not (= temp___skip_constant_166 true)) (and (dynamic_property1 1 x (first1 temp___expr_168) (last1 temp___expr_168)) (and (= (first1 temp___expr_168) 1) (= (last1 temp___expr_168) x)))))
...
(assert (in_range x))
(assert (= (to_rep (first2 (rt1 (component_size_attribute__p__a1__aggregate_def 1 1 x)))) 1))
(assert (= (to_rep (last2 (rt1 (component_size_attribute__p__a1__aggregate_def 1 1 x)))) x))
(assert (= (mk___t1 temp___215 temp___2151) (component_size_attribute__p__a1__aggregate_def 1 1 x)))
(assert (not (= (ite (<= (to_rep (first2 temp___2151)) (to_rep (last2 temp___2151))) (+ (- (to_rep (last2 temp___2151)) (to_rep (first2 temp___2151))) 1) 0) (ite (<= 1 x) (+ (- x 1) 1) 0))))
(check-sat)
(exit)
