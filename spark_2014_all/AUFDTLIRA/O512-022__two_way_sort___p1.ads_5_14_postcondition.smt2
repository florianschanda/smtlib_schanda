...
(assert (= i15 i13))
(assert (= a13 a11))
(assert (not (or (< (to_rep a__last) (to_rep a__first)) (exists ((k3 Int)) (and (and (<= (to_rep a__first) k3) (<= k3 (to_rep a__last))) (and (forall ((j18 Int)) (=> (and (<= (to_rep a__first) j18) (<= j18 k3)) (not (= (select (map__content a12) j18) true)))) (forall ((j18 Int)) (=> (and (<= (+ k3 1) j18) (<= j18 (to_rep a__last))) (= (select (map__content a12) j18) true)))))))))
(check-sat)
(exit)
