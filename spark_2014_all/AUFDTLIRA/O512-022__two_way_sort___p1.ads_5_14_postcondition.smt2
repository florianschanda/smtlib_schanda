...
(assert (= i13 i11))
(assert (= a10 a8))
(assert (not (or (< (to_rep a__last) (to_rep a__first)) (exists ((k Int)) (and (and (<= (to_rep a__first) k) (<= k (to_rep a__last))) (and (forall ((j16 Int)) (=> (and (<= (to_rep a__first) j16) (<= j16 k)) (not (= (select (map__content a9) j16) true)))) (forall ((j16 Int)) (=> (and (<= (+ k 1) j16) (<= j16 (to_rep a__last))) (= (select (map__content a9) j16) true)))))))))
(check-sat)
(exit)
