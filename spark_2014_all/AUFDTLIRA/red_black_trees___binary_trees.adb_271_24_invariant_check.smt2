...
(define-fun dynamic_invariant1 ((temp___expr_144 Int) (temp___is_init_141 Bool) (temp___skip_constant_142 Bool) (temp___do_toplevel_143 Bool)) Bool (=> (or (= temp___is_init_141 true) (<= 0 2147483647)) (in_range2 temp___expr_144)))
...
(define-fun dynamic_invariant3 ((temp___expr_156 Int) (temp___is_init_153 Bool) (temp___skip_constant_154 Bool) (temp___do_toplevel_155 Bool)) Bool (=> (or (= temp___is_init_153 true) (<= 0 100)) (in_range3 temp___expr_156)))
(assert (forall ((f1 us_rep3)) (! (=> (type_invariant f1) (dynamic_invariant3 (size f1) true false true)) :pattern ((size f1)))))
(assert (forall ((f1 us_rep3)) (! (= (size f1) (to_rep (rec__binary_trees__forest__s (us_split_fields5 f1)))) :pattern ((size f1)))))
(assert (forall ((f1 us_rep3)) (forall ((i Int)) (! (=> (and (dynamic_invariant i true true true) (type_invariant f1)) (let ((result (parent f1 i))) (and (and (=> (= (valid_root f1 i) true) (= result 0)) (=> (= (size f1) 0) (= result 0))) (dynamic_invariant3 result true false true)))) :pattern ((parent f1 i))))))
...
(define-fun dynamic_invariant4 ((temp___expr_168 Int) (temp___is_init_165 Bool) (temp___skip_constant_166 Bool) (temp___do_toplevel_167 Bool)) Bool (=> (or (= temp___is_init_165 true) (<= 0 1)) (in_range5 temp___expr_168)))
(assert (forall ((f1 us_rep3)) (forall ((i Int)) (! (=> (and (and (dynamic_invariant i true true true) (type_invariant f1)) (not (= (parent f1 i) 0))) (dynamic_invariant4 (position f1 i) true false true)) :pattern ((position f1 i))))))
...
(define-fun dynamic_invariant5 ((temp___expr_162 Int) (temp___is_init_159 Bool) (temp___skip_constant_160 Bool) (temp___do_toplevel_161 Bool)) Bool (=> (or (= temp___is_init_159 true) (<= 0 2)) (in_range4 temp___expr_162)))
...
(declare-const i Int)
(declare-const temp___680 (Array Int us_rep1))
(declare-const o us_rep)
(declare-const o1 Bool)
(declare-const o2 us_rep)
(declare-const o3 Bool)
(declare-const temp___681 (Array Int us_rep1))
...
(declare-const temp___691 (Array Int us_rep1))
...
(assert (<= 1 n1))
(assert (<= n1 100))
(assert (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f t1) i2))) true) (< (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f t1) i2)))) n2)) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f t2) i2))) true))))))
(assert (and (=> (<= 1 100) (in_range1 n2)) (and (<= 1 n2) (<= n2 100))))
(assert (<= 1 i))
(assert (<= i 100))
(assert (= (tree_structure f) true))
(assert (and (= temp___681 (model__ f t1)) (and (dynamic_invariant2 temp___681 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___681 t1))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___681 t1)))) 0) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (not (= i2 t1)) (ite (and (not (= (parent f i2) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___681 (parent f i2)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___681 i2))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___681 i2))) true)))))) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___681 i2))) true) (not (= i2 t1))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___681 (parent f i2)))) (position f i2) (rec__tree_model__path_type__a (us_split_fields1 (select temp___681 i2)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___681 i2)))) 0)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___681 i2))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___681 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___681 i2))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___681 j)))) true)) (= j i2))))))))))))))
(assert (= (mk___rep (mk___split_fields o4 o5)) (select temp___681 i)))
(assert (= o4 o6))
(assert (= o5 o7))
(assert (= o8 o6))
...
(assert (= (tree_structure f) true))
(assert (and (= temp___680 (model__ f t1)) (and (dynamic_invariant2 temp___680 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___680 t1))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___680 t1)))) 0) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (not (= i2 t1)) (ite (and (not (= (parent f i2) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___680 (parent f i2)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___680 i2))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___680 i2))) true)))))) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___680 i2))) true) (not (= i2 t1))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___680 (parent f i2)))) (position f i2) (rec__tree_model__path_type__a (us_split_fields1 (select temp___680 i2)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___680 i2)))) 0)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___680 i2))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___680 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___680 i2))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___680 j)))) true)) (= j i2))))))))))))))
(assert (= (mk___rep (mk___split_fields o o1)) (select temp___680 i)))
(assert (= o o2))
(assert (= o1 o3))
(assert (= o11 o3))
(assert (= result2 (ite (= o11 true) o10 false)))
(assert (= result2 true))
