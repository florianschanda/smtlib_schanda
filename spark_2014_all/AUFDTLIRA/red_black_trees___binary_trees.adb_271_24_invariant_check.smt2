...
(assert (forall ((f1 us_rep3)) (! (=> (type_invariant f1) (dynamic_invariant3 (size f1) true false true true)) :pattern ((size f1)))))
(assert (forall ((f1 us_rep3)) (! (= (size f1) (to_rep (rec__binary_trees__forest__s (us_split_fields5 f1)))) :pattern ((size f1)))))
(assert (forall ((f1 us_rep3)) (forall ((i Int)) (! (=> (and (dynamic_invariant i true true true true) (type_invariant f1)) (let ((result (parent f1 i))) (and (and (=> (= (valid_root f1 i) true) (= result 0)) (=> (= (size f1) 0) (= result 0))) (dynamic_invariant3 result true false true true)))) :pattern ((parent f1 i))))))
...
(assert (forall ((f1 us_rep3)) (forall ((i Int)) (! (=> (and (and (dynamic_invariant i true true true true) (type_invariant f1)) (not (= (parent f1 i) 0))) (dynamic_invariant4 (position f1 i) true false true true)) :pattern ((position f1 i))))))
...
(assert (and (not (= t1 t2)) (and (= (valid_root f t1) true) (= (valid_root f t2) true))))
(assert (= (mk_int__ref result) (mk_int__ref n)))
(assert (= n1 1))
(assert (<= 1 n1))
(assert (<= n1 100))
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f t1) i1))) true) (< (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f t1) i1)))) n2)) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f t2) i1))) true))))))
(assert (and (=> (<= 1 100) (in_range1 n2)) (and (<= 1 n2) (<= n2 100))))
(assert (<= 1 i))
(assert (<= i 100))
(assert (= (tree_structure f) true))
(assert (and (= temp___727 (model__ f t1)) (and (dynamic_invariant2 temp___727 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___727 t1))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___727 t1)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 t1)) (ite (and (not (= (parent f i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___727 (parent f i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___727 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___727 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___727 i1))) true) (not (= i1 t1))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___727 (parent f i1)))) (position f i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___727 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___727 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___727 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___727 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___727 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___727 j)))) true)) (= j i1))))))))))))))
(assert (= (mk___rep (mk___split_fields o4 o5)) (select temp___727 i)))
(assert (= o4 o6))
(assert (= o5 o7))
(assert (= o8 o6))
(assert (and (= o9 (length o8)) (and (in_range2 o9) (<= (+ 0 o9) 2147483647))))
(assert (= o10 (ite (< o9 n2) true false)))
(assert (= (tree_structure f) true))
(assert (and (= temp___726 (model__ f t1)) (and (dynamic_invariant2 temp___726 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___726 t1))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___726 t1)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 t1)) (ite (and (not (= (parent f i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___726 (parent f i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___726 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___726 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___726 i1))) true) (not (= i1 t1))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___726 (parent f i1)))) (position f i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___726 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___726 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___726 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___726 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___726 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___726 j)))) true)) (= j i1))))))))))))))
(assert (= (mk___rep (mk___split_fields o o1)) (select temp___726 i)))
(assert (= o o2))
(assert (= o1 o3))
(assert (= o11 o3))
