...
(assert (and (<= 0 i) (<= i 99)))
(assert (= o12 i))
(assert (= temp___507 (select (rec__patience__state__stacks (us_split_fields1 s)) o12)))
(assert (and (<= 0 k) (<= k 99)))
(assert (= o13 k))
(assert (= o14 (select temp___507 o13)))
(assert (= temp___508 (to_rep1 o14)))
(assert (and (<= 0 temp___508) (<= temp___508 99)))
(assert (= o15 temp___508))
