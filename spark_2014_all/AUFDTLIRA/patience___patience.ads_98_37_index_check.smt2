...
(assert (= result1 true))
(assert (<= 0 i1))
(assert (<= i1 (- (to_rep1 (rec__patience__state__numstacks (us_split_fields1 s))) 1)))
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o31 i1))
(assert (= o32 (select (rec__patience__state__stacksizes (us_split_fields1 s)) o31)))
(assert (= o33 (to_rep1 o32)))
(assert (= o34 (- o33 2)))
(assert (= o35 (ite (<= j o34) true false)))
(assert (= result11 (ite (<= 0 j) o35 false)))
(assert (= result11 true))
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o37 i1))
(assert (= o38 (select (rec__patience__state__stacksizes (us_split_fields1 s)) o37)))
(assert (= o39 (to_rep1 o38)))
(assert (= o40 (- o39 1)))
(assert (= o41 (ite (<= k o40) true false)))
(assert (and (= o36 (+ j 1)) (in_range1 (+ j 1))))
(assert (= o42 (ite (<= o36 k) true false)))
(assert (= result12 (ite (= o42 true) o41 false)))
(assert (= result12 true))
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o46 i1))
(assert (= temp___477 (select (rec__patience__state__stacks (us_split_fields1 s)) o46)))
(assert (and (<= 0 k) (<= k 99)))
(assert (= o47 k))
(assert (= o48 (select temp___477 o47)))
(assert (= temp___478 (to_rep1 o48)))
(assert (and (<= 0 temp___478) (<= temp___478 99)))
(assert (= o49 temp___478))
(assert (= o50 (select (rec__patience__state__values (us_split_fields1 s)) o49)))
