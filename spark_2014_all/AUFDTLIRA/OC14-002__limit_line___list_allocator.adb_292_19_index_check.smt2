...
(assert (=> (not (= first_available1 0)) (= result12 (ite (< 0 o68) true false))))
(assert (=> (not (= first_available1 0)) (=> (= result12 true) (and (= o67 (get (rec__list_allocator__m__t__available model____split_fields3) 1)) (in_range7 o67)))))
(assert (=> (not (= first_available1 0)) (=> (= result12 true) (= result11 (ite (= o67 first_available1) true false)))))
...
(assert (=> (not (not (= first_available1 0))) (= result11 (ite (= o69 0) true false))))
(assert (=> (= result11 true) (=> (not (= first_allocated2 0)) (and (= o65 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range6 o65)))))
(assert (=> (= result11 true) (=> (not (= first_allocated2 0)) (= result13 (ite (< 0 o65) true false)))))
(assert (=> (= result11 true) (=> (not (= first_allocated2 0)) (=> (= result13 true) (and (= o64 (get (rec__list_allocator__m__t__allocated model____split_fields3) 1)) (in_range7 o64))))))
(assert (=> (= result11 true) (=> (not (= first_allocated2 0)) (=> (= result13 true) (= result10 (ite (= o64 first_allocated2) true false))))))
(assert (=> (= result11 true) (=> (not (= first_allocated2 0)) (=> (not (= result13 true)) (= result10 false)))))
(assert (=> (= result11 true) (=> (not (not (= first_allocated2 0))) (and (= o66 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range6 o66)))))
(assert (=> (= result11 true) (=> (not (not (= first_allocated2 0))) (= result10 (ite (= o66 0) true false)))))
...
(assert (=> (= result16 true) (and (= o62 (get (rec__list_allocator__m__t__available model____split_fields3) o61)) (in_range7 o62))))
(assert (=> (not (= result16 true)) (= o62 0)))
(assert (and (= temp___464 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (in_range7 temp___464)))
(assert (not (<= 1 temp___464)))
(check-sat)
(exit)
