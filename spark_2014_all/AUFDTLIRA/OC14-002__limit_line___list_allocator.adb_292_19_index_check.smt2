...
(assert (=> (= result36 true) (and (= o126 (+ j6 1)) (in_range1 (+ j6 1)))))
(assert (=> (= result36 true) (and (= o127 (get (rec__list_allocator__m__t__available model____split_fields4) o126)) (in_range7 o127))))
(assert (=> (not (= result36 true)) (= o127 0)))
(assert (and (= temp___431 (get (rec__list_allocator__m__t__available model____split_fields4) j6)) (in_range7 temp___431)))
