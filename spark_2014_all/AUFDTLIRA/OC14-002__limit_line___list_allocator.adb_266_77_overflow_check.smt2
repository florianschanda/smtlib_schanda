...
(assert (and (= o112 (length (rec__list_allocator__m__t__allocated model____split_fields4))) (in_range6 o112)))
(assert (= result27 (ite (< j4 o112) true false)))
(assert (= result27 true))
(assert (not (in_range1 (+ j4 1))))
(check-sat)
(exit)
