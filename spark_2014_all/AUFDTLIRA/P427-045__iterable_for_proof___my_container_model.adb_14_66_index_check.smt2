...
(assert (and (and (=> (<= 1 100) (in_range3 i2)) (forall ((temp___224 Int)) (=> (and (<= 1 temp___224) (<= temp___224 100)) (=> (< i2 temp___224) (= (select c3 temp___224) (select c temp___224)))))) (and (<= 1 i2) (<= i2 100))))
(assert (<= 1 j))
(assert (<= j i2))
(assert (not (<= 1 j)))
(check-sat)
