...
(assert (= result7 true))
(assert (= (= result8 true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) j))) true) (or (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) j))) true) (= j i)))))))
(assert (= result8 true))
(assert (= (= result9 true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) j))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) j))) true))))))
(assert (= result9 true))
(assert (= (= result10 true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) j))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) j)))) true))))))
...
(assert (and (= temp___2106 (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o)) (and (dynamic_invariant8 temp___2106 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2106 o))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___2106 o)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 o)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2106 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2106 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2106 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2106 i1))) true) (not (= i1 o))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___2106 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))) (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___2106 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___2106 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2106 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2106 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___2106 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___2106 j)))) true)) (= j i1))))))))))))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
