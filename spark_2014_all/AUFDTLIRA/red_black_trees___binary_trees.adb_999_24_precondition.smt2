...
(assert (and (= temp___1780 (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root)) (and (dynamic_invariant3 temp___1780 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1780 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1780 root)))) 0) (and (forall ((i7 Int)) (=> (and (<= 1 i7) (<= i7 100)) (=> (not (= i7 root)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i7) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1780 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i7)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1780 i7))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1780 i7))) true)))))) (and (forall ((i7 Int)) (=> (and (<= 1 i7) (<= i7 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1780 i7))) true) (not (= i7 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1780 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i7)))) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i7) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1780 i7)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1780 i7)))) 0)))) (forall ((i7 Int)) (=> (and (<= 1 i7) (<= i7 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1780 i7))) true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1780 j2))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1780 i7))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1780 j2)))) true)) (= j2 i7))))))))))))))
(assert (= o34 (select temp___1780 i2)))
(assert (= o35 (us_split_fields1 o34)))
(assert (= result11 (rec__tree_model__path_type__k o35)))
(assert (=> (= result11 true) (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true)))
(assert (=> (= result11 true) (and (= temp___1781 (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root)) (and (dynamic_invariant3 temp___1781 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1781 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1781 root)))) 0) (and (forall ((i7 Int)) (=> (and (<= 1 i7) (<= i7 100)) (=> (not (= i7 root)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i7) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1781 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i7)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1781 i7))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1781 i7))) true)))))) (and (forall ((i7 Int)) (=> (and (<= 1 i7) (<= i7 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1781 i7))) true) (not (= i7 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1781 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i7)))) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i7) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1781 i7)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1781 i7)))) 0)))) (forall ((i7 Int)) (=> (and (<= 1 i7) (<= i7 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1781 i7))) true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1781 j2))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1781 i7))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1781 j2)))) true)) (= j2 i7)))))))))))))))
(assert (=> (= result11 true) (= o30 (select temp___1781 i2))))
(assert (=> (= result11 true) (= o31 (us_split_fields1 o30))))
(assert (=> (= result11 true) (= o32 (rec__tree_model__path_type__a o31))))
(assert (=> (= result11 true) (and (= o33 (length o32)) (and (in_range5 o33) (<= (+ 0 o33) 2147483647)))))
(assert (=> (= result11 true) (= o36 (ite (< o33 n2) true false))))
(assert (=> (not (= result11 true)) (= o36 false)))
(assert (= result10 (ite (and (= o36 true) (not (= i2 v))) true false)))
