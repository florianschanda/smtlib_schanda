...
(assert (= o9 (sorted (mk___t a (mk (to_rep a__first) (to_rep a__last))) o8 length2)))
(assert (= o7 (sorted (mk___t a (mk (to_rep a__first) (to_rep a__last))) a_first length1)))
(assert (and (= o5 (+ length1 length2)) (in_range1 (+ length1 length2))))
(assert (= o6 (ite (<= o5 2147483647) true false)))
(assert (=> (<= (to_rep b__first) (to_rep b__last)) (= o1 (+ (- (to_rep b__last) (to_rep b__first)) 1))))
(assert (=> (not (<= (to_rep b__first) (to_rep b__last))) (= o1 0)))
(assert (and (= o2 o1) (in_range1 o1)))
(assert (and (= o3 (+ length1 length2)) (in_range1 (+ length1 length2))))
(assert (= o4 (ite (<= o3 o2) true false)))
(assert (and (= o (+ (to_rep a__last) 1)) (in_range1 (+ (to_rep a__last) 1))))
