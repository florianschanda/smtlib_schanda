...
(assert true)
(assert (forall ((a1 us_rep)) (forall ((cu1 us_rep1)) (! (= (= (has_element a1 cu1) true) (and (<= 1 (to_rep (rec__with_iterable__cursor__i (us_split_fields3 cu1)))) (<= (to_rep (rec__with_iterable__cursor__i (us_split_fields3 cu1))) 100))) :pattern ((has_element a1 cu1))))))
...
(assert (not (in_range (+ (to_rep (rec__with_iterable__cursor__i (us_split_fields3 cu))) 1))))
(check-sat)
(exit)
