...
(declare-fun temp___484 ((Array Int integer) Int Int) (Array Int integer))
(assert (forall ((temp___486 (Array Int integer))) (forall ((temp___487 Int) (temp___488 Int)) (let ((temp___485 (temp___484 temp___486 temp___487 temp___488))) (forall ((temp___489 Int)) (ite (= temp___489 temp___487) (= (select temp___485 temp___489) (of_rep temp___488)) (= (select temp___485 temp___489) (select temp___486 temp___489))))))))
(declare-fun temp___491 ((Array Int integer) Int Int) (Array Int integer))
(assert (forall ((temp___493 (Array Int integer))) (forall ((temp___494 Int) (temp___495 Int)) (let ((temp___492 (temp___491 temp___493 temp___494 temp___495))) (forall ((temp___496 Int)) (ite (= temp___496 temp___494) (= (select temp___492 temp___496) (of_rep temp___495)) (= (select temp___492 temp___496) (select temp___493 temp___496))))))))
(assert (in_range1 i))
...
(assert (= (bool_eq d (- 2147483648) 2147483647 (temp___491 c i 42) (- 2147483648) 2147483647) true))
...
(assert (not (= (to_rep (select e i)) (to_rep (select (temp___484 a i 42) i)))))
(check-sat)
(exit)
