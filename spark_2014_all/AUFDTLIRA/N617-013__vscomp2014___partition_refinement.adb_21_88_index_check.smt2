...
(assert (<= 0 j2))
(assert (<= j2 r1b))
(assert (and (=> (<= 0 10000) (in_range5 p_prime_index1)) (and (<= 0 j3) (<= j3 r1b))))
(assert (and (= temp___5013 (get (model__ (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields))) j3)) (= (bool_eq temp___5013 (get (model__ (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields))) j3)) true)))
...
(assert (= f1 o10))
(assert (forall ((j4 Int)) (=> (and (<= (to_rep1 (rec__partition_refinement__interval__first p_prime__split_fields3)) j4) (<= j4 i2)) (= (to_rep2 (select f2 j4)) p_prime_index2))))
(assert (forall ((j4 Int)) (=> (and (<= 0 j4) (<= j4 (- (to_rep1 (rec__partition_refinement__interval__first p_prime__split_fields3)) 1))) (= (to_rep2 (select f2 j4)) (to_rep2 (select f j4))))))
(assert (forall ((j4 Int)) (=> (and (<= (+ i2 1) j4) (<= j4 5)) (= (to_rep2 (select f2 j4)) (to_rep2 (select f j4))))))
(assert (and (and (=> (<= r3b r4b) (dynamic_property r3b r4b i2)) (forall ((temp___505 Int)) (=> (and (<= 0 temp___505) (<= temp___505 5)) (=> (< i2 temp___505) (= (select f2 temp___505) (select f temp___505)))))) (and (<= r3b i2) (<= i2 r4b))))
(assert (<= (to_rep1 (rec__partition_refinement__interval__first p_prime__split_fields3)) j1))
(assert (<= j1 i2))
(assert (not (<= 0 j1)))
(check-sat)
(exit)
