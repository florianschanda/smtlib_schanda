...
(assert (and (= temp___5413 (get (model__ (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields))) j3)) (= (bool_eq temp___5413 (get (model__ (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields))) j3)) true)))
...
(assert (and (and (=> (<= r3b r4b) (dynamic_property r3b r4b i2)) (forall ((temp___545 Int)) (=> (and (<= 0 temp___545) (<= temp___545 5)) (=> (< i2 temp___545) (= (select f2 temp___545) (select f temp___545)))))) (and (<= r3b i2) (<= i2 r4b))))
