...
(assert (=> (= result9 true) (and (= temp___375 (get_previous_track o25 id1)) (and (in_range1 temp___375) (= temp___375 (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep o22)))))) id1)))))))
(assert (=> (= result9 true) (and (<= 1 temp___375) (<= temp___375 8))))
(assert (=> (= result9 true) (= o23 temp___375)))
(assert (=> (= result9 true) (= o24 (select (map__content4 track_signals6) o23))))
(assert (=> (= result9 true) (= temp___376 (to_rep5 o24))))
