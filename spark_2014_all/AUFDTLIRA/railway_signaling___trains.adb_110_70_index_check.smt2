...
(assert (and (= o17 (get_previous_track o26 id1)) (and (in_range1 o17) (= o17 (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep o16)))))) id1))))))
...
(assert (=> (= result9 true) (and (= temp___407 (get_previous_track o25 id1)) (and (in_range1 temp___407) (= temp___407 (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep o22)))))) id1)))))))
...
(assert (and (= o11 (get_other_previous_track o27 id1)) (and (in_range1 o11) (= o11 (ite (= (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep o8)))))) id1)) (to_rep o10)) 0 (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep o8)))))) id1)))))))
