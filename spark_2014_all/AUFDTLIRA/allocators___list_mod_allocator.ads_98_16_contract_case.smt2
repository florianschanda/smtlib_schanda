...
(assert (= data6 data4))
(assert (= res6 res4))
(assert (=> (= (= (length (rec__list_mod_allocator__m__t__available (us_split_fields3 (model__ data first_available)))) 0) true) (and (= (int__content res5) 0) (= (oeq1 (model__ (map__content data5) (int__content first_available5)) (model__ data first_available)) true))))
(assert (not (= (= (length (rec__list_mod_allocator__m__t__available (us_split_fields3 (model__ data first_available)))) 0) true)))
(assert (not (= (is_prepend (rec__list_mod_allocator__m__t__available (us_split_fields3 (model__ (map__content data5) (int__content first_available5)))) (int__content res5) (rec__list_mod_allocator__m__t__available (us_split_fields3 (model__ data first_available)))) true)))
(check-sat)
(exit)
