...
(declare-const temp___1060 (Array Int character))
...
(declare-const temp___1061 (Array Int character))
(declare-const temp___10611 t)
...
(define-fun bounded_dynamic_strings__Oconcat__4__result12 () us_rep (mk___rep (mk___split_discrs bounded_dynamic_strings__Oconcat__4__result4) (mk___split_fields bounded_dynamic_strings__Oconcat__4__result5 (mk___t2 bounded_dynamic_strings__Oconcat__4__result6 bounded_dynamic_strings__Oconcat__4__result7))))
(define-fun o15 () us_rep (mk___rep (mk___split_discrs o11) (mk___split_fields o12 (mk___t2 o13 o14))))
(define-fun o16 () us_t1 (mk___t1 o9 o10))
(define-fun temp___10602 () us_t1 (mk___t1 temp___1060 temp___10601))
...
(assert (and (= us (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 left)))) (in_range5 (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 left))))))
(assert (= bounded_dynamic_strings__Oconcat__4__result8 (mk_sequence__ref bounded_dynamic_strings__Oconcat__4__result12)))
(assert (= bounded_dynamic_strings__Oconcat__4__result9 bounded_dynamic_strings__Oconcat__4__result12))
(assert (and (= temp___10602 (value left)) (and (dynamic_invariant3 temp___10602 true false true true) (and (and (= (elts2 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 left))) temp___1060) (= (mk1 (to_rep1 (first6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 left)))))) (to_rep1 (last6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 left))))))) temp___10601)) (and (and (and (= (length1 temp___10602) (length3 left)) (= (to_rep1 (first2 temp___10601)) 1)) (= (to_rep1 (last2 temp___10601)) (length3 left))) (= (< 0 (length3 left)) (not (= (empty left) true))))))))
(assert (=> (= (length1 temp___10602) 0) (= (to_rep o) right)))
(assert (=> (= (length1 temp___10602) 0) (= o1 (singleton1 o 1))))
(assert (=> (= (length1 temp___10602) 0) (= o1 temp___1061)))
(assert (=> (= (length1 temp___10602) 0) (= (mk 1 1) temp___10611)))
(assert (=> (not (= (length1 temp___10602) 0)) (=> (<= (to_rep1 (first2 temp___10601)) (to_rep1 (last2 temp___10601))) (= o3 (+ (- (to_rep1 (last2 temp___10601)) (to_rep1 (first2 temp___10601))) 1)))))
(assert (=> (not (= (length1 temp___10602) 0)) (=> (not (<= (to_rep1 (first2 temp___10601)) (to_rep1 (last2 temp___10601)))) (= o3 0))))
(assert (=> (not (= (length1 temp___10602) 0)) (= o4 (+ o3 1))))
(assert (=> (not (= (length1 temp___10602) 0)) (= o5 (+ (to_rep1 (first2 temp___10601)) o4))))
(assert (=> (not (= (length1 temp___10602) 0)) (= o6 (- o5 1))))
(assert (=> (not (= (length1 temp___10602) 0)) (and (= o7 o6) (in_range2 o6))))
(assert (=> (not (= (length1 temp___10602) 0)) (= (to_rep o2) right)))
(assert (=> (not (= (length1 temp___10602) 0)) (= o8 (concat_singleton_right temp___1060 (to_rep1 (first2 temp___10601)) (to_rep1 (last2 temp___10601)) o2))))
(assert (=> (not (= (length1 temp___10602) 0)) (= o8 temp___1061)))
(assert (=> (not (= (length1 temp___10602) 0)) (= (mk (to_rep1 (first2 temp___10601)) o7) temp___10611)))
(assert (dynamic_property1 1 2147483647 (to_rep1 (first temp___10611)) (to_rep1 (last temp___10611))))
(assert (= temp___1061 o9))
(assert (= (mk1 (to_rep1 (first temp___10611)) (to_rep1 (last temp___10611))) o10))
(assert (and (= o15 (instance (+ (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 left))) 1) o16)) (and (dynamic_invariant1 o15 true false true true) (and (and (= (to_rep2 o11) (+ (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 left))) 1)) (= (length3 o15) (length1 o16))) (= (let ((temp___270 (value o15))) (bool_eq (elts1 temp___270) (to_rep1 (first2 (rt1 temp___270))) (to_rep1 (last2 (rt1 temp___270))) o9 (to_rep1 (first2 o10)) (to_rep1 (last2 o10)))) true)))))
(assert (= (mk_sequence__ref (mk___rep (mk___split_discrs result) (mk___split_fields result1 (mk___t2 result2 result3)))) (mk_sequence__ref (mk___rep (mk___split_discrs bounded_dynamic_strings__Oconcat__4__result) (mk___split_fields bounded_dynamic_strings__Oconcat__4__result1 (mk___t2 bounded_dynamic_strings__Oconcat__4__result2 bounded_dynamic_strings__Oconcat__4__result3))))))
(assert (= bounded_dynamic_strings__Oconcat__4__result12 o15))
(assert (= bounded_dynamic_strings__Oconcat__4__result10 bounded_dynamic_strings__Oconcat__4__result8))
(assert (= bounded_dynamic_strings__Oconcat__4__result11 bounded_dynamic_strings__Oconcat__4__result9))
(assert (= (mk___rep (mk___split_discrs result4) (mk___split_fields result5 (mk___t2 result6 result7))) (sequence__content bounded_dynamic_strings__Oconcat__4__result10)))
(assert (not (= (let ((temp___1070 (value (sequence__content bounded_dynamic_strings__Oconcat__4__result10)))) (bool_eq (elts1 temp___1070) (to_rep1 (first2 (rt1 temp___1070))) (to_rep1 (last2 (rt1 temp___1070))) (let ((temp___1069 (value left))) (ite (= (length1 temp___1069) 0) (singleton1 (of_rep right) 1) (concat_singleton_right (elts1 temp___1069) (to_rep1 (first2 (rt1 temp___1069))) (to_rep1 (last2 (rt1 temp___1069))) (of_rep right)))) (to_rep1 (first (let ((temp___1069 (value left))) (ite (= (length1 temp___1069) 0) (mk 1 1) (mk (to_rep1 (first2 (rt1 temp___1069))) (- (+ (to_rep1 (first2 (rt1 temp___1069))) (+ (ite (<= (to_rep1 (first2 (rt1 temp___1069))) (to_rep1 (last2 (rt1 temp___1069)))) (+ (- (to_rep1 (last2 (rt1 temp___1069))) (to_rep1 (first2 (rt1 temp___1069)))) 1) 0) 1)) 1)))))) (to_rep1 (last (let ((temp___1069 (value left))) (ite (= (length1 temp___1069) 0) (mk 1 1) (mk (to_rep1 (first2 (rt1 temp___1069))) (- (+ (to_rep1 (first2 (rt1 temp___1069))) (+ (ite (<= (to_rep1 (first2 (rt1 temp___1069))) (to_rep1 (last2 (rt1 temp___1069)))) (+ (- (to_rep1 (last2 (rt1 temp___1069))) (to_rep1 (first2 (rt1 temp___1069)))) 1) 0) 1)) 1)))))))) true)))
(check-sat)
(exit)
