...
(assert (forall ((temp___198 Int)) (forall ((temp___199 Int)) (= (select (temp___196 temp___198) temp___199) (of_rep1 temp___198)))))
...
(declare-const temp___200 set_length)
(declare-const temp___2001 (Array Int element_t))
