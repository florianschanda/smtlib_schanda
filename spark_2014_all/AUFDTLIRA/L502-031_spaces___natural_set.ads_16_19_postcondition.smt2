...
(declare-fun temp___223 (Int) (Array Int element_t))
...
(assert (forall ((temp___225 Int)) (=> (dynamic_invariant1 temp___225 true true true true) (forall ((temp___226 Int)) (= (to_rep1 (select (temp___223 temp___225) temp___226)) temp___225)))))
...
(declare-const o set_length)
(declare-const o1 set_length)
(declare-const o2 (Array Int element_t))
(declare-const temp___227 set_length)
(declare-const temp___2271 (Array Int element_t))
...
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= (temp___223 (- 1)) o2))
(assert (= temp___227 o1))
(assert (= temp___2271 o2))
(assert (= result s__split_fields))
(assert (= result1 s__split_fields1))
(assert (= temp___227 s__split_fields2))
(assert (= temp___2271 s__split_fields3))
