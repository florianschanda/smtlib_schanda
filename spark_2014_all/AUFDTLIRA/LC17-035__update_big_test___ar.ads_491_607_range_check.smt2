...
(assert (=> (< k 16) (=> (< 0 e) (= o16 (temp___1904 o15 i o14)))))
(assert (=> (< k 16) (=> (< 0 e) (and (<= 1 (+ k 1)) (<= (+ k 1) 16)))))
(assert (=> (< k 16) (=> (< 0 e) (= o12 (+ k 1)))))
(assert (=> (< k 16) (=> (< 0 e) (= o17 (select a o12)))))
(assert (=> (< k 16) (=> (< 0 e) (= o18 (temp___1897 o17 j o16)))))
(assert (=> (< k 16) (=> (< 0 e) (and (= o19 (+ k 1)) (in_range3 (+ k 1))))))
(assert (=> (< k 16) (=> (< 0 e) (= temp___5571 (temp___1874 a k (temp___1882 (select a k) j (temp___1889 (select (select a k) j) i e)) o19 o18)))))
...
(assert (=> (< k 16) (=> (not (= result4 true)) (=> (= e 0) (= o8 (temp___1943 o7 i 99))))))
(assert (=> (< k 16) (=> (not (= result4 true)) (=> (= e 0) (and (<= 1 (+ k 1)) (<= (+ k 1) 16))))))
(assert (=> (< k 16) (=> (not (= result4 true)) (=> (= e 0) (= o5 (+ k 1))))))
(assert (=> (< k 16) (=> (not (= result4 true)) (=> (= e 0) (= o9 (select a o5))))))
(assert (=> (< k 16) (=> (not (= result4 true)) (=> (= e 0) (= o10 (temp___1936 o9 j o8))))))
(assert (=> (< k 16) (=> (not (= result4 true)) (=> (= e 0) (and (= o11 (+ k 1)) (in_range3 (+ k 1)))))))
(assert (=> (< k 16) (=> (not (= result4 true)) (=> (= e 0) (= temp___5581 (temp___1913 a k (temp___1921 (select a k) j (temp___1928 (select (select a k) j) i e)) o11 o10))))))
