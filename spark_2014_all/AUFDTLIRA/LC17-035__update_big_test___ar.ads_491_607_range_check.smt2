...
(assert (=> (< k 16) (=> (< 0 e) (= temp___5511 (select a o13)))))
(assert (=> (< k 16) (=> (< 0 e) (= o15 (select temp___5511 j)))))
(assert (=> (< k 16) (=> (< 0 e) (= o16 (temp___1845 o15 i o14)))))
(assert (=> (< k 16) (=> (< 0 e) (and (<= 1 (+ k 1)) (<= (+ k 1) 16)))))
(assert (=> (< k 16) (=> (< 0 e) (= o12 (+ k 1)))))
(assert (=> (< k 16) (=> (< 0 e) (= o17 (select a o12)))))
(assert (=> (< k 16) (=> (< 0 e) (= o18 (temp___1838 o17 j o16)))))
(assert (=> (< k 16) (=> (< 0 e) (and (= o19 (+ k 1)) (in_range3 (+ k 1))))))
(assert (=> (< k 16) (=> (< 0 e) (= temp___5512 (temp___1815 a k (temp___1823 (select a k) j (temp___1830 (select (select a k) j) i e)) o19 o18)))))
(assert (=> (< k 16) (=> (< 0 e) (= result4 (bool_eq2 a3 1 16 temp___5512 1 16)))))
...
(assert (=> (< k 16) (=> (not (= result4 true)) (=> (= e 0) (= temp___5521 (select a o6))))))
(assert (=> (< k 16) (=> (not (= result4 true)) (=> (= e 0) (= o7 (select temp___5521 j))))))
(assert (=> (< k 16) (=> (not (= result4 true)) (=> (= e 0) (= o8 (temp___1884 o7 i 99))))))
(assert (=> (< k 16) (=> (not (= result4 true)) (=> (= e 0) (and (<= 1 (+ k 1)) (<= (+ k 1) 16))))))
(assert (=> (< k 16) (=> (not (= result4 true)) (=> (= e 0) (= o5 (+ k 1))))))
(assert (=> (< k 16) (=> (not (= result4 true)) (=> (= e 0) (= o9 (select a o5))))))
(assert (=> (< k 16) (=> (not (= result4 true)) (=> (= e 0) (= o10 (temp___1877 o9 j o8))))))
(assert (=> (< k 16) (=> (not (= result4 true)) (=> (= e 0) (and (= o11 (+ k 1)) (in_range3 (+ k 1)))))))
(assert (=> (< k 16) (=> (not (= result4 true)) (=> (= e 0) (= temp___5522 (temp___1854 a k (temp___1862 (select a k) j (temp___1869 (select (select a k) j) i e)) o11 o10))))))
(assert (=> (< k 16) (=> (not (= result4 true)) (=> (= e 0) (= result3 (bool_eq2 a3 1 16 temp___5522 1 16))))))
