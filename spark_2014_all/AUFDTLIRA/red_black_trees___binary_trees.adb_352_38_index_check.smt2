...
(assert (and (= temp___1065 (model__ f2 root)) (and (dynamic_invariant2 temp___1065 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1065 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1065 root)))) 0) (and (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (not (= i5 root)) (ite (and (not (= (parent f2 i5) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1065 (parent f2 i5)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1065 i5))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1065 i5))) true)))))) (and (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1065 i5))) true) (not (= i5 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1065 (parent f2 i5)))) (position f2 i5) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1065 i5)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1065 i5)))) 0)))) (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1065 i5))) true) (forall ((j20 Int)) (=> (and (<= 1 j20) (<= j20 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1065 j20))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1065 i5))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1065 j20)))) true)) (= j20 i5))))))))))))))
(assert (not (<= 1 i4)))
(check-sat)
(exit)
