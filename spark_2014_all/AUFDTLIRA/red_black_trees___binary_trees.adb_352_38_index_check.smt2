...
(assert (and (= temp___1111 (model__ f2 root)) (and (dynamic_invariant2 temp___1111 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1111 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1111 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent f2 i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1111 (parent f2 i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1111 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1111 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1111 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1111 (parent f2 i1)))) (position f2 i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1111 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1111 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1111 i1))) true) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1111 j3))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1111 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1111 j3)))) true)) (= j3 i1))))))))))))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
