...
(assert (= (same_nb_blacks c62b) true))
(assert false)
(assert (= n29 n27))
(assert (= n30 n28))
...
(assert (and (= o25 x1) (in_range2 x1)))
(assert (and (= o26 (parent (rec__red_black_trees__rbt__struct t__split_fields6) o25)) (and (in_range3 o26) (and (= o26 (parent1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields6))) o25)) (=> (= (size (rec__red_black_trees__rbt__struct t__split_fields6)) 0) (= o26 0))))))
(assert (and (= o27 (color (mk___rep4 t__split_fields6) o26)) (and (in_range6 o27) (= o27 (ite (= o26 0) 0 (to_rep3 (select (rec__red_black_trees__rbt__color t__split_fields6) o26)))))))
(assert (= result16 (ite (= o27 1) true false)))
...
(assert (in_range2 y2))
(assert (= (same_nb_blacks c101b) true))
(assert (= result79 (mk___split_fields__ref4 t_old__split_fields7)))
(assert (= t_old__split_fields13 t__split_fields22))
(assert (= n107 n105))
(assert (= t_old__split_fields14 (mk___split_fields__ref4 t_old__split_fields13)))
(assert (= x11 (mk_int__ref x10)))
(assert (= t__split_fields23 (mk___split_fields__ref4 t__split_fields22)))
(assert (= rho7 search_trees__right_rotate__t__fields1))
(assert (= n108 n106))
(assert (= t_old__split_fields15 t_old__split_fields13))
(assert (= x12 x10))
(assert (= t__split_fields24 t__split_fields22))
...
(assert (in_range2 y3))
(assert (= (same_nb_blacks c107b) true))
(assert (= (color (mk___rep4 t__split_fields27) (parent (rec__red_black_trees__rbt__struct t__split_fields27) (int__content x11))) 0))
(declare-const i14 Int)
(assert (<= 1 i14))
(assert (<= i14 100))
(assert (= (to_rep3 (select (rec__red_black_trees__rbt__color t__split_fields27) (parent (rec__red_black_trees__rbt__struct t__split_fields27) i14))) 1))
(assert (not (= (to_rep3 (select (rec__red_black_trees__rbt__color t__split_fields27) i14)) 0)))
(check-sat)
(exit)
