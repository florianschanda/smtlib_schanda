...
(assert (and (<= (to_rep1 n__first) temp___1290) (<= temp___1290 (to_rep1 n__last))))
(assert (= o9 temp___1290))
(assert (= o10 (select (map__content1 n6) o9)))
(assert (= o11 (to_rep1 o10)))
(assert (= result4 (mk_int__ref target)))
(assert (= target1 o11))
(assert (<= target1 7))
(assert (and (= o12 (+ target1 2147483640)) (in_range1 (+ target1 2147483640))))
(assert (= result5 (mk_int__ref target1)))
(assert (= target2 o12))
(assert (not (<= target2 2147483647)))
(check-sat)
(exit)
