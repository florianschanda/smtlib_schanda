...
(assert (and (= o8 (empty this)) (and (= (= o8 true) (= (to_rep (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 this))) 0)) (= (= o8 true) (= (length1 this) 0)))))
(assert (= o9 (ite (not (= o8 true)) true false)))
(assert (= o10 (ite o9 1 0)))
(assert (and (= o6 (length1 this)) (and (in_range3 o6) (= o6 (to_rep (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 this)))))))
(assert (= o7 (ite (< 0 o6) true false)))
(assert (= o11 (ite o7 1 0)))
(assert (= o12 (ite (= o11 o10) true false)))
(assert (and (= o4 (length1 this)) (and (in_range3 o4) (= o4 (to_rep (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 this)))))))
(assert (= o5 (ite (= (to_rep2 (last2 bounded_dynamic_strings__value__result9)) o4) true false)))
(assert (and (= o3 (length1 this)) (and (in_range3 o3) (= o3 (to_rep (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 this)))))))
(assert (not (in_range1 (length2 (mk___t1 bounded_dynamic_strings__value__result8 bounded_dynamic_strings__value__result9)))))
(check-sat)
(exit)
