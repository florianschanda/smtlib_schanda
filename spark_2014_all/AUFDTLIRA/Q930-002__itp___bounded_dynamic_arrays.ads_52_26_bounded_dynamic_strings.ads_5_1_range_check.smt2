...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant this true true true true) (dynamic_invariant1 (length2 this) true false true true)) :pattern ((length2 this)))))
...
(assert (forall ((this1 us_rep)) (! (=> (dynamic_invariant this1 true true true true) (= (= (empty this1) true) (= (length2 this1) 0))) :pattern ((empty this1)))))
(assert (forall ((this1 us_rep)) (! (= (= (empty this1) true) (= (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 this1))) 0)) :pattern ((empty this1)))))
...
(define-fun dynamic_invariant5 ((temp___expr_206 us_t) (temp___is_init_202 Bool) (temp___skip_constant_203 Bool) (temp___do_toplevel_204 Bool) (temp___do_typ_inv_205 Bool)) Bool (=> (not (= temp___skip_constant_203 true)) (dynamic_property 1 2147483647 (first1 temp___expr_206) (last1 temp___expr_206))))
(declare-const bounded_dynamic_strings__value__result (Array Int character))
(declare-const bounded_dynamic_strings__value__result1 t)
(declare-const o (Array Int character))
(declare-const temp___917 (Array Int character))
(declare-const temp___9171 t2)
...
(declare-const bounded_dynamic_strings__value__result3 t)
(declare-const bounded_dynamic_strings__value__result4 (Array Int character))
(declare-const bounded_dynamic_strings__value__result5 t)
(declare-const bounded_dynamic_strings__value__result6 (Array Int character))
(declare-const bounded_dynamic_strings__value__result7 t)
(declare-const bounded_dynamic_strings__value__result8 (Array Int character))
(declare-const bounded_dynamic_strings__value__result9 t)
(declare-const bounded_dynamic_strings__value__result10 (Array Int character))
(declare-const bounded_dynamic_strings__value__result11 t)
(define-fun bounded_dynamic_strings__value__result12 () us_t (mk___t bounded_dynamic_strings__value__result6 bounded_dynamic_strings__value__result7))
(define-fun bounded_dynamic_strings__value__result13 () us_t (mk___t bounded_dynamic_strings__value__result2 bounded_dynamic_strings__value__result3))
...
(assert (=> (<= 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 this)))) (and (and (<= (to_rep1 (first2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 this))))) 1) (<= 1 (to_rep1 (last2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 this))))))) (and (<= (to_rep1 (first2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 this))))) (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 this)))) (<= (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 this))) (to_rep1 (last2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 this))))))))))
(assert (= o (elts1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 this)))))
(assert (= o temp___917))
(assert (= (mk2 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 this)))) temp___9171))
(assert (dynamic_property 1 2147483647 (to_rep1 (first4 temp___9171)) (to_rep1 (last4 temp___9171))))
(assert (= temp___917 o1))
(assert (= (mk (to_rep1 (first4 temp___9171)) (to_rep1 (last4 temp___9171))) o2))
(assert (= (mk_list__ref (mk___t result result1)) (mk_list__ref (mk___t bounded_dynamic_strings__value__result bounded_dynamic_strings__value__result1))))
(assert (= bounded_dynamic_strings__value__result13 (mk___t o1 o2)))
(assert (= (mk_list__ref (mk___t bounded_dynamic_strings__value__result8 bounded_dynamic_strings__value__result9)) (mk_list__ref (mk___t bounded_dynamic_strings__value__result4 bounded_dynamic_strings__value__result5))))
(assert (= (mk___t bounded_dynamic_strings__value__result10 bounded_dynamic_strings__value__result11) bounded_dynamic_strings__value__result12))
(assert (and (= o8 (empty this)) (and (= (= o8 true) (= (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 this))) 0)) (= (= o8 true) (= (length2 this) 0)))))
(assert (= o9 (ite (not (= o8 true)) true false)))
(assert (= o10 (ite o9 1 0)))
(assert (and (= o6 (length2 this)) (and (in_range4 o6) (= o6 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 this)))))))
(assert (= o7 (ite (< 0 o6) true false)))
(assert (= o11 (ite o7 1 0)))
(assert (= o12 (ite (= o11 o10) true false)))
(assert (and (= o4 (length2 this)) (and (in_range4 o4) (= o4 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 this)))))))
(assert (= o5 (ite (= (to_rep1 (last bounded_dynamic_strings__value__result9)) o4) true false)))
(assert (and (= o3 (length2 this)) (and (in_range4 o3) (= o3 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 this)))))))
(assert (not (in_range1 (length (mk___t bounded_dynamic_strings__value__result8 bounded_dynamic_strings__value__result9)))))
(check-sat)
(exit)
