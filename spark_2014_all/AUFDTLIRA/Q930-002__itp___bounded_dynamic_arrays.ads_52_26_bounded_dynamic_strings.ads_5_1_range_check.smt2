...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant this true true true) (dynamic_invariant1 (length2 this) true false true)) :pattern ((length2 this)))))
...
(assert (forall ((this1 us_rep)) (! (=> (dynamic_invariant this1 true true true) (= (= (empty this1) true) (= (length2 this1) 0))) :pattern ((empty this1)))))
...
(define-fun dynamic_invariant5 ((temp___expr_181 us_t) (temp___is_init_178 Bool) (temp___skip_constant_179 Bool) (temp___do_toplevel_180 Bool)) Bool (=> (not (= temp___skip_constant_179 true)) (dynamic_property 1 2147483647 (first1 temp___expr_181) (last1 temp___expr_181))))
...
(assert (= (mk___t bounded_dynamic_strings__value__result6 bounded_dynamic_strings__value__result7) (mk___t bounded_dynamic_strings__value__result2 bounded_dynamic_strings__value__result3)))
...
(assert (= o temp___854))
(assert (= (mk2 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 this)))) temp___8541))
(assert (dynamic_property 1 2147483647 (to_rep1 (first4 temp___8541)) (to_rep1 (last4 temp___8541))))
(assert (= temp___854 o1))
(assert (= (mk (to_rep1 (first4 temp___8541)) (to_rep1 (last4 temp___8541))) o2))
...
(assert (= (mk___t bounded_dynamic_strings__value__result2 bounded_dynamic_strings__value__result3) (mk___t o1 o2)))
...
(assert (= (mk___t bounded_dynamic_strings__value__result10 bounded_dynamic_strings__value__result11) (mk___t bounded_dynamic_strings__value__result6 bounded_dynamic_strings__value__result7)))
(assert (and (= o9 (empty this)) (and (= (= o9 true) (= (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 this))) 0)) (= (= o9 true) (= (length2 this) 0)))))
(assert (= o10 (ite (not (= o9 true)) true false)))
(assert (= o11 (to_int1 o10)))
(assert (and (= o7 (length2 this)) (and (in_range4 o7) (= o7 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 this)))))))
(assert (= o8 (ite (< 0 o7) true false)))
(assert (= o12 (to_int1 o8)))
(assert (= o13 (ite (= o12 o11) true false)))
(assert (and (= o5 (length2 this)) (and (in_range4 o5) (= o5 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 this)))))))
(assert (= o6 (ite (= (to_rep1 (last bounded_dynamic_strings__value__result9)) o5) true false)))
