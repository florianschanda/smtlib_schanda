...
(assert (= j1 0))
(assert (=> (and (<= 0 j1) (<= j1 1001)) (and (and (= temp___254 j1) (and (= temp___253 c1) (and (ite (= (to_rep (select step1 j1)) (- 23)) (and (and (= o1 (+ c1 1)) (in_range1 (+ c1 1))) (and (= c1 result3) (= c2 o1))) (= c2 c1)) (and (and (and (forall ((k Int)) (=> (and (<= 0 k) (<= k 1001)) (and (=> (< k i) (= (to_rep (select step1 k)) (- 23))) (=> (<= i k) (= (to_rep (select step1 k)) 69))))) (=> (< j2 i) (= c3 (+ j2 1)))) (=> (<= i j2) (= c3 i))) (and (and (and (=> (<= 0 1002) (in_range1 c3)) (=> (<= 0 1001) (in_range2 j2))) (and (<= 0 j2) (<= j2 1001))) (= j2 1001)))))) (and (and (= j2 j6) (= c3 c7)) (and (= j7 j2) (= c8 c3))))))
(assert (=> (and (<= 0 j1) (<= j1 1001)) (= (mk_int__ref j8) (mk_int__ref j6))))
(assert (=> (and (<= 0 j1) (<= j1 1001)) (= (mk_int__ref c9) (mk_int__ref c7))))
(assert (=> (and (<= 0 j1) (<= j1 1001)) (= j9 j7)))
(assert (=> (and (<= 0 j1) (<= j1 1001)) (= c10 c8)))
(assert (=> (not (and (<= 0 j1) (<= j1 1001))) (= j1 j8)))
(assert (=> (not (and (<= 0 j1) (<= j1 1001))) (= c1 c9)))
(assert (=> (not (and (<= 0 j1) (<= j1 1001))) (= j9 j1)))
(assert (=> (not (and (<= 0 j1) (<= j1 1001))) (= c10 c1)))
...
(assert (= result6 complex_arrays__use_step_array__result))
(assert (= complex_arrays__use_step_array__result1 c9))
...
(assert (= c12 c10))
(assert (= step3 step1))
(assert (= result7 (int__content complex_arrays__use_step_array__result4)))
