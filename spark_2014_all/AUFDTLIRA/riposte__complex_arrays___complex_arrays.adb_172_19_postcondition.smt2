...
(assert (= j1 0))
(assert (=> (and (<= 0 j1) (<= j1 1001)) (= temp___282 j1)))
(assert (=> (and (<= 0 j1) (<= j1 1001)) (= temp___281 c1)))
(assert (=> (and (<= 0 j1) (<= j1 1001)) (=> (= (to_rep (select step1 j1)) (- 23)) (and (= o1 (+ c1 1)) (in_range1 (+ c1 1))))))
...
(assert (=> (and (<= 0 j1) (<= j1 1001)) (and (and (=> (<= 0 1002) (in_range1 c3)) (=> (<= 0 1001) (in_range2 j2))) (and (<= 0 j2) (<= j2 1001)))))
