...
(assert (= (elts arr) o3))
(assert (= (mk1 (to_rep (first (rt arr))) (to_rep (last (rt arr)))) o4))
(declare-const i2 Int)
(assert (<= (to_rep (first2 o4)) i2))
(assert (<= i2 (to_rep (last2 o4))))
(assert (not (= i2 (to_rep (first2 o4)))))
(assert (not (< (to_rep (select o3 (- i2 1))) (to_rep (select o3 i2)))))
(check-sat)
(exit)
