...
(assert (forall ((temp___182 Int)) (= (select (temp___180 temp___182) 1) (of_rep temp___182))))
(declare-fun temp___185 (Int) (Array Int integer))
(assert (forall ((temp___187 Int)) (= (select (temp___185 temp___187) 1) (of_rep temp___187))))
