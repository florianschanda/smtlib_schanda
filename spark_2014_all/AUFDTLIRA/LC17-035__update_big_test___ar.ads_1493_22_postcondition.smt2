...
(assert (forall ((temp___3099 (Array Int et1))) (forall ((temp___3100 Int) (temp___3101 Int) (temp___3102 Int) (temp___3103 Int)) (let ((temp___3098 (temp___3097 temp___3099 temp___3100 temp___3101 temp___3102 temp___3103))) (forall ((temp___3104 Int)) (ite (= temp___3104 temp___3102) (= (select temp___3098 temp___3104) (of_rep temp___3103)) (ite (= temp___3104 temp___3100) (= (select temp___3098 temp___3104) (of_rep temp___3101)) (= (select temp___3098 temp___3104) (select temp___3099 temp___3104)))))))))
...
(assert (not (= (bool_eq r__split_fields6 1 10 (temp___3097 r__split_fields i e j f) 1 10) true)))
(check-sat)
(exit)
