...
(declare-fun temp___3156 ((Array Int et1) Int Int Int Int) (Array Int et1))
...
(assert (not (= (bool_eq r__split_fields6 1 10 (temp___3156 r__split_fields i e j f) 1 10) true)))
(check-sat)
(exit)
