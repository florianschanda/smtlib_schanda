...
(assert (<= temp___2162 index2))
(assert (<= index2 temp___2163))
(assert (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))))
(assert (= o9 index2))
(assert (= o10 (select n1 o9)))
(assert (= o11 (to_rep1 o10)))
(assert (= o11 aida__conversion__convert_character_digit_to_integer__2__target))
...
(assert (= (to_rep1 o15) aida__conversion__convert_character_digit_to_integer__2__target2))
(assert (not (<= (to_rep1 n__first) index2)))
(check-sat)
(exit)
