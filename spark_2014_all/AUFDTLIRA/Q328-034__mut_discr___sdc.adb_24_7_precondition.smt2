...
(define-fun dynamic_invariant ((temp___expr_193 Int) (temp___is_init_189 Bool) (temp___skip_constant_190 Bool) (temp___do_toplevel_191 Bool) (temp___do_typ_inv_192 Bool)) Bool (=> (or (= temp___is_init_189 true) (<= 0 200)) (in_range4 temp___expr_193)))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_663 us_void_param) 1)) 87) (= (to_rep (select (temp___String_Literal_663 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_663 us_void_param) 3)) 108)) (= (to_rep (select (temp___String_Literal_663 us_void_param) 4)) 99)) (= (to_rep (select (temp___String_Literal_663 us_void_param) 5)) 111)) (= (to_rep (select (temp___String_Literal_663 us_void_param) 6)) 109)) (= (to_rep (select (temp___String_Literal_663 us_void_param) 7)) 101)) (= (to_rep (select (temp___String_Literal_663 us_void_param) 8)) 32)) (= (to_rep (select (temp___String_Literal_663 us_void_param) 9)) 116)) (= (to_rep (select (temp___String_Literal_663 us_void_param) 10)) 111)) (= (to_rep (select (temp___String_Literal_663 us_void_param) 11)) 32)) (= (to_rep (select (temp___String_Literal_663 us_void_param) 12)) 115)) (= (to_rep (select (temp___String_Literal_663 us_void_param) 13)) 100)) (= (to_rep (select (temp___String_Literal_663 us_void_param) 14)) 99)) (= (to_rep (select (temp___String_Literal_663 us_void_param) 15)) 46)) (= (to_rep (select (temp___String_Literal_663 us_void_param) 16)) 32)) (= (to_rep (select (temp___String_Literal_663 us_void_param) 17)) 71)) (= (to_rep (select (temp___String_Literal_663 us_void_param) 18)) 111)) (= (to_rep (select (temp___String_Literal_663 us_void_param) 19)) 32)) (= (to_rep (select (temp___String_Literal_663 us_void_param) 20)) 97)) (= (to_rep (select (temp___String_Literal_663 us_void_param) 21)) 104)) (= (to_rep (select (temp___String_Literal_663 us_void_param) 22)) 101)) (= (to_rep (select (temp___String_Literal_663 us_void_param) 23)) 97)) (= (to_rep (select (temp___String_Literal_663 us_void_param) 24)) 100)) (= (to_rep (select (temp___String_Literal_663 us_void_param) 25)) 32)) (= (to_rep (select (temp___String_Literal_663 us_void_param) 26)) 116)) (= (to_rep (select (temp___String_Literal_663 us_void_param) 27)) 121)) (= (to_rep (select (temp___String_Literal_663 us_void_param) 28)) 112)) (= (to_rep (select (temp___String_Literal_663 us_void_param) 29)) 101)) (= (to_rep (select (temp___String_Literal_663 us_void_param) 30)) 32)) (= (to_rep (select (temp___String_Literal_663 us_void_param) 31)) 121)) (= (to_rep (select (temp___String_Literal_663 us_void_param) 32)) 111)) (= (to_rep (select (temp___String_Literal_663 us_void_param) 33)) 117)) (= (to_rep (select (temp___String_Literal_663 us_void_param) 34)) 114)) (= (to_rep (select (temp___String_Literal_663 us_void_param) 35)) 32)) (= (to_rep (select (temp___String_Literal_663 us_void_param) 36)) 99)) (= (to_rep (select (temp___String_Literal_663 us_void_param) 37)) 111)) (= (to_rep (select (temp___String_Literal_663 us_void_param) 38)) 109)) (= (to_rep (select (temp___String_Literal_663 us_void_param) 39)) 109)) (= (to_rep (select (temp___String_Literal_663 us_void_param) 40)) 97)) (= (to_rep (select (temp___String_Literal_663 us_void_param) 41)) 110)) (= (to_rep (select (temp___String_Literal_663 us_void_param) 42)) 100)) (= (to_rep (select (temp___String_Literal_663 us_void_param) 43)) 115)) (= (to_rep (select (temp___String_Literal_663 us_void_param) 44)) 32)) (= (to_rep (select (temp___String_Literal_663 us_void_param) 45)) 46)) (= (to_rep (select (temp___String_Literal_663 us_void_param) 46)) 46)) (= (to_rep (select (temp___String_Literal_663 us_void_param) 47)) 46)) :pattern ((temp___String_Literal_663 us_void_param)))))
(declare-fun temp___String_Literal_664 (tuple0) (Array Int character))
(assert true)
(declare-fun temp___String_Literal_665 (tuple0) (Array Int character))
(assert true)
...
(define-fun dynamic_invariant6 ((temp___expr_221 Int) (temp___is_init_217 Bool) (temp___skip_constant_218 Bool) (temp___do_toplevel_219 Bool) (temp___do_typ_inv_220 Bool)) Bool (=> (or (= temp___is_init_217 true) (<= 0 2)) (in_range7 temp___expr_221)))
(define-fun dynamic_invariant7 ((temp___expr_200 Int) (temp___is_init_196 Bool) (temp___skip_constant_197 Bool) (temp___do_toplevel_198 Bool) (temp___do_typ_inv_199 Bool)) Bool (=> (or (= temp___is_init_196 true) (<= 0 2)) (in_range5 temp___expr_200)))
(define-fun dynamic_invariant8 ((temp___expr_212 Int) (temp___is_init_208 Bool) (temp___skip_constant_209 Bool) (temp___do_toplevel_210 Bool) (temp___do_typ_inv_211 Bool)) Bool (=> (or (= temp___is_init_208 true) (<= 0 3)) (in_range6 temp___expr_212)))
...
(assert (not (not (= (full last3) true))))
(check-sat)
(exit)
