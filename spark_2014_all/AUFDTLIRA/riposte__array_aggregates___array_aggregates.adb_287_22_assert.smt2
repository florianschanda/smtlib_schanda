...
(assert (forall ((temp___565 us_rep)) (forall ((temp___566 Int)) (= (select (temp___563 temp___565) temp___566) temp___565))))
(declare-fun temp___567 (Int Int Int Int Int) (Array Int character))
(assert (forall ((temp___569 Int) (temp___570 Int) (temp___571 Int) (temp___572 Int) (temp___573 Int)) (let ((temp___568 (temp___567 temp___569 temp___570 temp___571 temp___572 temp___573))) (and (and (and (and (= (select temp___568 1) (of_rep1 temp___569)) (= (select temp___568 2) (of_rep1 temp___570))) (= (select temp___568 3) (of_rep1 temp___571))) (= (select temp___568 4) (of_rep1 temp___572))) (= (select temp___568 5) (of_rep1 temp___573))))))
