...
(declare-fun temp___612 (us_rep) (Array Int us_rep))
(declare-fun temp___616 (Int Int Int Int Int) (Array Int character))
...
(assert (= (to_rep o) 5))
(assert (= o o1))
(assert (= (temp___616 87 111 114 108 100) o2))
(assert (= o3 o1))
(assert (= o4 o2))
(assert (= o5 (temp___612 (mk___rep (mk___split_fields o3 o4)))))
(assert (= result x))
(assert (= x1 o5))
