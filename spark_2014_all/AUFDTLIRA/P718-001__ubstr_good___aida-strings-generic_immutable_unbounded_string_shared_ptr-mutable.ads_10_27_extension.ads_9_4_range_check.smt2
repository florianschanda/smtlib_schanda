...
(define-fun dynamic_invariant1 ((temp___expr_158 Int) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool)) Bool (=> (or (= temp___is_init_155 true) (<= 0 2147483647)) (in_range4 temp___expr_158)))
...
(define-fun default_initial_assumption ((temp___expr_835 us_rep) (temp___skip_top_level_836 Bool)) Bool (and (= (attr__tag temp___expr_835) us_tag2) (=> (not (= temp___skip_top_level_836 true)) (= (length1 temp___expr_835) 0))))
...
(define-fun default_initial_assumption1 ((temp___expr_799 us_rep) (temp___skip_top_level_800 Bool)) Bool (and (= (attr__tag temp___expr_799) us_tag) (=> (not (= temp___skip_top_level_800 true)) (= (length1 temp___expr_799) 0))))
(define-fun default_initial_assumption2 ((temp___expr_811 us_rep) (temp___skip_top_level_812 Bool)) Bool (and (= (attr__tag temp___expr_811) us_tag1) (=> (not (= temp___skip_top_level_812 true)) (= (length1 temp___expr_811) 0))))
(declare-const o Int)
...
(assert (and (= o1 (length1 (mk___rep (mk___split_fields this__split_fields this__split_fields1) this__attr__tag))) (in_range4 o1)))
(assert (not (in_range3 (length text))))
(check-sat)
(exit)
