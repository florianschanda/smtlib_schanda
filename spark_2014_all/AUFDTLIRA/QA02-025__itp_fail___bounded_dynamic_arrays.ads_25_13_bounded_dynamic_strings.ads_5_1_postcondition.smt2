...
(define-fun dynamic_invariant ((temp___expr_205 us_rep) (temp___is_init_201 Bool) (temp___skip_constant_202 Bool) (temp___do_toplevel_203 Bool) (temp___do_typ_inv_204 Bool)) Bool (and (=> (= temp___do_toplevel_203 true) (=> (= temp___is_init_201 true) (and (<= 0 (to_rep (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 temp___expr_205)))) (<= (to_rep (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 temp___expr_205))) (to_rep (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 temp___expr_205))))))) (let ((temp___207 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 temp___expr_205)))) (and (dynamic_property1 1 (to_rep temp___207) (first1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 temp___expr_205))) (last1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 temp___expr_205)))) (and (= (first1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 temp___expr_205))) 1) (= (last1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 temp___expr_205))) (to_rep temp___207)))))))
...
(define-fun dynamic_invariant1 ((temp___expr_191 Int) (temp___is_init_187 Bool) (temp___skip_constant_188 Bool) (temp___do_toplevel_189 Bool) (temp___do_typ_inv_190 Bool)) Bool (=> (or (= temp___is_init_187 true) (<= 0 2147483647)) (in_range1 temp___expr_191)))
(assert (forall ((this1 us_rep)) (! (=> (dynamic_invariant this1 true true true true) (dynamic_invariant1 (length1 this1) true false true true)) :pattern ((length1 this1)))))
(assert (forall ((this1 us_rep)) (! (=> (dynamic_invariant this1 true true true true) (= (length1 this1) (to_rep (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 this1))))) :pattern ((length1 this1)))))
...
(assert (dynamic_invariant i8s true false true true))
