...
(assert (and (and (forall ((temp___450 Int)) (=> (and (<= (to_rep a_v2__first) temp___450) (<= temp___450 (to_rep a_v2__last))) (=> (<= i_v22 temp___450) (= (select a_v21 temp___450) (select a_v2 temp___450))))) (=> (<= (to_rep a_v2__first) k_2) (dynamic_property3 (to_rep a_v2__first) k_2 i_v22))) (and (<= (to_rep a_v2__first) i_v22) (<= i_v22 k_2))))
