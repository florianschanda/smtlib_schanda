...
(assert (and (and (and (and (not (= (select winners3 0) true)) (< latest_highest_score2 i2)) (= (select winners3 latest_highest_score2) true)) (forall ((j4 Int)) (=> (and (<= 1 j4) (<= j4 (- i2 1))) (=> (< latest_highest_score2 j4) (< (to_rep (select counters j4)) (to_rep (select counters latest_highest_score2))))))) (forall ((j4 Int)) (=> (and (<= 1 j4) (<= j4 (- i2 1))) (ite (= (select winners3 j4) true) (= (to_rep (select counters latest_highest_score2)) (to_rep (select counters j4))) (< (to_rep (select counters j4)) (to_rep (select counters latest_highest_score2))))))))
...
(assert (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i2))))
(assert (= j result4))
(assert (= j1 0))
(assert (<= 0 j1))
(assert (<= j1 (- i2 1)))
(assert (forall ((k Int)) (=> (and (<= 0 k) (<= k (- j2 1))) (not (= (select winners4 k) true)))))
(assert (and (and (=> (<= 0 (- i2 1)) (dynamic_property1 0 (- i2 1) j2)) (forall ((temp___778 Int)) (=> (and (<= 0 temp___778) (<= temp___778 20)) (=> (or (< (- i2 1) temp___778) (or (< temp___778 0) (<= j2 temp___778))) (= (select winners4 temp___778) (select winners3 temp___778)))))) (and (<= 0 j2) (<= j2 (- i2 1)))))
(assert (and (<= 0 j2) (<= j2 20)))
(assert (= o j2))
(assert (= o1 (store winners4 o (distinct 0 0))))
...
(assert (<= 0 k))
(assert (<= k (- j3 1)))
(assert (not (not (= (select winners5 k) true))))
(check-sat)
(exit)
