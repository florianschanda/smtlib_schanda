...
(assert (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i5))))
(assert (= j6 result6))
(assert (= j7 0))
(assert (<= 0 j7))
(assert (<= j7 (- i5 1)))
(assert (forall ((k1 Int)) (=> (and (<= 0 k1) (<= k1 (- j8 1))) (not (= (select winners4 k1) true)))))
(assert (and (and (=> (<= 0 (- i5 1)) (dynamic_property1 0 (- i5 1) j8)) (forall ((temp___701 Int)) (=> (and (<= 0 temp___701) (<= temp___701 20)) (=> (<= j8 temp___701) (= (select winners4 temp___701) (select winners3 temp___701)))))) (and (<= 0 j8) (<= j8 (- i5 1)))))
(assert (and (<= 0 j8) (<= j8 20)))
(assert (= o1 j8))
(assert (= o2 (store winners4 o1 (of_int 0))))
(assert (= winners4 result7))
(assert (= winners5 o2))
(assert (not (= j8 (- i5 1))))
(assert (= result8 j8))
(assert (= j9 (+ j8 1)))
...
(assert (<= 0 k1))
(assert (<= k1 (- j9 1)))
(assert (not (not (= (select winners5 k1) true))))
(check-sat)
(exit)
