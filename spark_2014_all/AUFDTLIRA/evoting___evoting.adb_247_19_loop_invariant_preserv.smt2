...
(assert (and (and (=> (<= 0 (- i2 1)) (dynamic_property1 0 (- i2 1) j2)) (forall ((temp___707 Int)) (=> (and (<= 0 temp___707) (<= temp___707 20)) (=> (<= j2 temp___707) (= (select winners4 temp___707) (select winners3 temp___707)))))) (and (<= 0 j2) (<= j2 (- i2 1)))))
