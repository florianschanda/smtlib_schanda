...
(assert (and (and (=> (<= 0 (- i2 1)) (dynamic_property1 0 (- i2 1) j2)) (forall ((temp___781 Int)) (=> (and (<= 0 temp___781) (<= temp___781 20)) (=> (<= j2 temp___781) (= (select winners4 temp___781) (select winners3 temp___781)))))) (and (<= 0 j2) (<= j2 (- i2 1)))))
