...
(assert (= max1 0))
(assert (= temp___228 max1))
(assert (= temp___226 a))
(assert (= temp___224 k1))
...
(assert (and (and (=> (<= 1 2147483647) (in_range3 k2)) (forall ((temp___227 Int)) (=> (and (<= (to_rep1 a__first) temp___227) (<= temp___227 (to_rep1 a__last))) (and (= (rec__frame_condition__cell__value (us_split_fields1 (select a2 temp___227))) (rec__frame_condition__cell__value (us_split_fields1 (select temp___226 temp___227)))) (= (rec__frame_condition__cell__max_right (us_split_fields1 (select a2 temp___227))) (rec__frame_condition__cell__max_right (us_split_fields1 (select temp___226 temp___227)))))))) (=> (<= 0 2147483647) (in_range2 max3))))
...
(assert (and (and (=> (<= 1 2147483647) (in_range3 k10)) (forall ((temp___233 Int)) (=> (and (<= (to_rep1 a__first) temp___233) (<= temp___233 (to_rep1 a__last))) (and (= (rec__frame_condition__cell__value (us_split_fields1 (select a8 temp___233))) (rec__frame_condition__cell__value (us_split_fields1 (select (map__content a5) temp___233)))) (= (rec__frame_condition__cell__max_left (us_split_fields1 (select a8 temp___233))) (rec__frame_condition__cell__max_left (us_split_fields1 (select (map__content a5) temp___233)))))))) (=> (<= 0 2147483647) (in_range2 max12))))
(assert (<= k10 i))
