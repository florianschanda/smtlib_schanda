...
(assert (= max2 0))
(assert (= temp___228 max2))
(assert (= temp___226 a))
(assert (= temp___224 k2))
...
(assert (= result3 (ite (< max2 o10) true false)))
(assert (=> (= result3 true) (and (<= (to_rep1 a__first) k2) (<= k2 (to_rep1 a__last)))))
(assert (=> (= result3 true) (= o11 k2)))
...
(assert (=> (= result3 true) (= max3 o19)))
(assert (=> (not (= result3 true)) (= max3 max2)))
(assert (= (to_rep o20) max3))
(assert (= (rec__frame_condition__cell__value (us_split_fields1 (select a k2))) o21))
(assert (= o20 o22))
(assert (= (rec__frame_condition__cell__max_right (us_split_fields1 (select a k2))) o23))
(assert (= o24 o21))
(assert (= o25 o22))
(assert (= o26 o23))
(assert (and (<= (to_rep1 a__first) k2) (<= k2 (to_rep1 a__last))))
...
(assert (forall ((i5 Int)) (=> (and (<= (to_rep1 a__first) i5) (<= i5 k3)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a3 i5)))) max4))))
(assert (forall ((i5 Int)) (=> (and (<= (to_rep1 a__first) i5) (<= i5 k3)) (forall ((j3 Int)) (=> (and (<= i5 j3) (<= j3 k3)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a3 i5)))) (to_rep (rec__frame_condition__cell__max_left (us_split_fields1 (select a3 j3))))))))))
(assert (and (and (=> (<= 1 2147483647) (in_range3 k3)) (forall ((temp___227 Int)) (=> (and (<= (to_rep1 a__first) temp___227) (<= temp___227 (to_rep1 a__last))) (and (= (rec__frame_condition__cell__value (us_split_fields1 (select a3 temp___227))) (rec__frame_condition__cell__value (us_split_fields1 (select temp___226 temp___227)))) (= (rec__frame_condition__cell__max_right (us_split_fields1 (select a3 temp___227))) (rec__frame_condition__cell__max_right (us_split_fields1 (select temp___226 temp___227)))))))) (=> (<= 0 2147483647) (in_range2 max4))))
(assert (= k5 (mk_int__ref k3)))
(assert (= k6 k3))
(assert (= k3 (to_rep1 a__last)))
(assert (= max6 (mk_int__ref max4)))
(assert (= k7 k5))
...
(assert (= k10 k8))
(assert (= a8 a6))
(assert (and (= o62 (to_rep1 a__last)) (in_range3 (to_rep1 a__last))))
(assert (= result10 k9))
(assert (= k11 o62))
(assert (= result11 max8))
(assert (= max10 0))
(assert (and (<= (to_rep1 a__first) k11) (<= k11 (to_rep1 a__last))))
(assert (= o63 k11))
(assert (= o64 (select (map__content a7) o63)))
(assert (= o65 (us_split_fields1 o64)))
(assert (= o66 (rec__frame_condition__cell__value o65)))
(assert (= o67 (to_rep o66)))
(assert (= result12 (ite (< max10 o67) true false)))
(assert (=> (= result12 true) (and (<= (to_rep1 a__first) k11) (<= k11 (to_rep1 a__last)))))
(assert (=> (= result12 true) (= o68 k11)))
(assert (=> (= result12 true) (= o69 (select (map__content a7) o68))))
(assert (=> (= result12 true) (= o70 (us_split_fields1 o69))))
(assert (=> (= result12 true) (= o71 (rec__frame_condition__cell__value o70))))
(assert (=> (= result12 true) (= o72 (to_rep o71))))
(assert (=> (= result12 true) (= result13 (mk_int__ref max10))))
(assert (=> (= result12 true) (= max11 o72)))
(assert (=> (= result12 true) (= max12 (mk_int__ref max11))))
(assert (=> (= result12 true) (= max13 max11)))
(assert (=> (not (= result12 true)) (= max12 (mk_int__ref max10))))
(assert (=> (not (= result12 true)) (= max13 max10)))
(assert (= (to_rep o73) (int__content max12)))
(assert (= o74 (mk___split_fields (rec__frame_condition__cell__value (us_split_fields1 (select (map__content a7) k11))) (rec__frame_condition__cell__max_left (us_split_fields1 (select (map__content a7) k11))) o73)))
(assert (= o75 (mk___rep o74)))
(assert (and (<= (to_rep1 a__first) k11) (<= k11 (to_rep1 a__last))))
(assert (= o76 k11))
(assert (= o77 (store (map__content a7) o76 o75)))
(assert (= result14 a7))
(assert (= a9 o77))
(assert (and (<= (to_rep1 a__first) k12) (<= k12 (to_rep1 a__last))))
(assert (forall ((i5 Int)) (=> (and (<= k12 i5) (<= i5 (to_rep1 a__last))) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a10 i5)))) max14))))
(assert (forall ((i5 Int)) (=> (and (<= k12 i5) (<= i5 (to_rep1 a__last))) (forall ((j3 Int)) (=> (and (<= i5 j3) (<= j3 (to_rep1 a__last))) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a10 j3)))) (to_rep (rec__frame_condition__cell__max_right (us_split_fields1 (select a10 i5))))))))))
(assert (and (and (=> (<= 1 2147483647) (in_range3 k12)) (forall ((temp___233 Int)) (=> (and (<= (to_rep1 a__first) temp___233) (<= temp___233 (to_rep1 a__last))) (and (= (rec__frame_condition__cell__value (us_split_fields1 (select a10 temp___233))) (rec__frame_condition__cell__value (us_split_fields1 (select (map__content a7) temp___233)))) (= (rec__frame_condition__cell__max_left (us_split_fields1 (select a10 temp___233))) (rec__frame_condition__cell__max_left (us_split_fields1 (select (map__content a7) temp___233)))))))) (=> (<= 0 2147483647) (in_range2 max14))))
(assert (<= k12 i2))
(assert (<= i2 (to_rep1 a__last)))
(assert (not (<= (to_rep1 a__first) i2)))
(check-sat)
(exit)
