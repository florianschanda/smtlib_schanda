...
(assert (= max1 0))
(assert (= temp___256 max1))
(assert (= temp___254 a))
(assert (= temp___252 k1))
...
(assert (=> (= result3 true) (= (mk___rep (mk___split_fields o12 o13 o14)) (select a o11))))
...
(assert (= (rec__frame_condition__cell__value (us_split_fields1 (select a k1))) o21))
(assert (= o20 o22))
(assert (= (rec__frame_condition__cell__max_right (us_split_fields1 (select a k1))) o23))
(assert (= o24 o21))
(assert (= o25 o22))
(assert (= o26 o23))
(assert (and (<= (to_rep1 a__first) k1) (<= k1 (to_rep1 a__last))))
...
(assert (forall ((i1 Int)) (=> (and (<= (to_rep1 a__first) i1) (<= i1 k2)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a2 i1)))) max3))))
(assert (forall ((i1 Int)) (=> (and (<= (to_rep1 a__first) i1) (<= i1 k2)) (forall ((j Int)) (=> (and (<= i1 j) (<= j k2)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a2 i1)))) (to_rep (rec__frame_condition__cell__max_left (us_split_fields1 (select a2 j))))))))))
(assert (and (and (=> (<= 1 2147483647) (in_range3 k2)) (forall ((temp___255 Int)) (=> (and (<= (to_rep1 a__first) temp___255) (<= temp___255 (to_rep1 a__last))) (and (= (rec__frame_condition__cell__value (us_split_fields1 (select a2 temp___255))) (rec__frame_condition__cell__value (us_split_fields1 (select temp___254 temp___255)))) (= (rec__frame_condition__cell__max_right (us_split_fields1 (select a2 temp___255))) (rec__frame_condition__cell__max_right (us_split_fields1 (select temp___254 temp___255)))))))) (=> (<= 0 2147483647) (in_range2 max3))))
(assert (= k3 (mk_int__ref k2)))
(assert (= k4 k2))
(assert (= k2 (to_rep1 a__last)))
...
(assert (= k8 k6))
(assert (= a6 a4))
(assert (and (= o29 (to_rep1 a__last)) (in_range3 (to_rep1 a__last))))
(assert (= result6 k7))
(assert (= k9 o29))
(assert (= result7 max6))
(assert (= max8 0))
(assert (and (<= (to_rep1 a__first) k9) (<= k9 (to_rep1 a__last))))
(assert (= o30 k9))
(assert (= o31 (select (map__content a5) o30)))
(assert (= o32 (us_split_fields1 o31)))
(assert (= o33 (rec__frame_condition__cell__value o32)))
(assert (= o34 (to_rep o33)))
(assert (= result8 (ite (< max8 o34) true false)))
(assert (=> (= result8 true) (and (<= (to_rep1 a__first) k9) (<= k9 (to_rep1 a__last)))))
(assert (=> (= result8 true) (= o35 k9)))
(assert (=> (= result8 true) (= o36 (select (map__content a5) o35))))
(assert (=> (= result8 true) (= o37 (us_split_fields1 o36))))
(assert (=> (= result8 true) (= o38 (rec__frame_condition__cell__value o37))))
(assert (=> (= result8 true) (= o39 (to_rep o38))))
(assert (=> (= result8 true) (= result9 (mk_int__ref max8))))
(assert (=> (= result8 true) (= max9 o39)))
(assert (=> (= result8 true) (= max10 (mk_int__ref max9))))
(assert (=> (= result8 true) (= max11 max9)))
(assert (=> (not (= result8 true)) (= max10 (mk_int__ref max8))))
(assert (=> (not (= result8 true)) (= max11 max8)))
(assert (= (to_rep o40) (int__content max10)))
(assert (= o41 (mk___split_fields (rec__frame_condition__cell__value (us_split_fields1 (select (map__content a5) k9))) (rec__frame_condition__cell__max_left (us_split_fields1 (select (map__content a5) k9))) o40)))
(assert (= o42 (mk___rep o41)))
(assert (and (<= (to_rep1 a__first) k9) (<= k9 (to_rep1 a__last))))
(assert (= o43 k9))
(assert (= o44 (store (map__content a5) o43 o42)))
(assert (= result10 a5))
(assert (= a7 o44))
(assert (and (<= (to_rep1 a__first) k10) (<= k10 (to_rep1 a__last))))
(assert (forall ((i1 Int)) (=> (and (<= k10 i1) (<= i1 (to_rep1 a__last))) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a8 i1)))) max12))))
(assert (forall ((i1 Int)) (=> (and (<= k10 i1) (<= i1 (to_rep1 a__last))) (forall ((j Int)) (=> (and (<= i1 j) (<= j (to_rep1 a__last))) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a8 j)))) (to_rep (rec__frame_condition__cell__max_right (us_split_fields1 (select a8 i1))))))))))
(assert (and (and (=> (<= 1 2147483647) (in_range3 k10)) (forall ((temp___261 Int)) (=> (and (<= (to_rep1 a__first) temp___261) (<= temp___261 (to_rep1 a__last))) (and (= (rec__frame_condition__cell__value (us_split_fields1 (select a8 temp___261))) (rec__frame_condition__cell__value (us_split_fields1 (select (map__content a5) temp___261)))) (= (rec__frame_condition__cell__max_left (us_split_fields1 (select a8 temp___261))) (rec__frame_condition__cell__max_left (us_split_fields1 (select (map__content a5) temp___261)))))))) (=> (<= 0 2147483647) (in_range2 max12))))
(assert (<= k10 i))
