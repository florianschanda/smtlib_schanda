...
(assert (and (= o28 (remove (mk___t values2 (mk 1 100)) o27)) (and (dynamic_invariant4 o28 true false true) (and (= (invariant__ o28) true) (and (= (to_rep1 (last (rt o28))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o27 1))) (= (to_rep (select values2 k)) (to_rep (select (elts o28) k))))) (and (forall ((k Int)) (=> (and (<= (+ o27 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select (elts o28) (- k 1)))))) (forall ((k Int)) (=> (and (<= o27 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts o28) k))))))))))))
(assert (and (= o30 (remove o28 o29)) (and (dynamic_invariant4 o30 true false true) (and (= (invariant__ o30) true) (and (= (to_rep1 (last (rt o30))) (- (to_rep1 (last (rt o28))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o29 1))) (= (to_rep (select (elts o28) k)) (to_rep (select (elts o30) k))))) (and (forall ((k Int)) (=> (and (<= (+ o29 1) k) (<= k (to_rep1 (last (rt o28))))) (= (to_rep (select (elts o28) k)) (to_rep (select (elts o30) (- k 1)))))) (forall ((k Int)) (=> (and (<= o29 k) (<= k (- (to_rep1 (last (rt o28))) 1))) (= (to_rep (select (elts o28) (+ k 1))) (to_rep (select (elts o30) k))))))))))))
