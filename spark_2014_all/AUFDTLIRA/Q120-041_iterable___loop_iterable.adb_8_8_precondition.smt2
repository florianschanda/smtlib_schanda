...
(assert (= e5 1))
(assert (and (= o8 (next (mk___rep c1__split_fields2) temp___2742)) (= o8 (temp___176 (+ (to_rep (select temp___2742 1)) 1)))))
(assert (and (= o9 (has_element (mk___rep c1__split_fields2) o8)) (= (= o9 true) (and (<= 1 (to_rep (select o8 1))) (<= (to_rep (select o8 1)) (to_rep (rec__composite_cursors__cont1__length c1__split_fields2)))))))
(assert (= result5 (ite (not (= o9 true)) true false)))
(assert (not (= result5 true)))
(assert (and (= o10 (next (mk___rep c1__split_fields2) temp___2742)) (= o10 (temp___176 (+ (to_rep (select temp___2742 1)) 1)))))
(assert (= result6 (mk_map__ref temp___2742)))
(assert (= temp___2743 o10))
(assert (and (= result7 (has_element (mk___rep c1__split_fields2) temp___2743)) (= (= result7 true) (and (<= 1 (to_rep (select temp___2743 1))) (<= (to_rep (select temp___2743 1)) (to_rep (rec__composite_cursors__cont1__length c1__split_fields2)))))))
(assert (= result7 true))
(assert (not (= (has_element (mk___rep c1__split_fields2) temp___2743) true)))
(check-sat)
(exit)
