...
(assert (not (= (ite (<= (to_rep1 (first8 temp___12431)) (to_rep1 (last9 temp___12431))) (+ (- (to_rep1 (last9 temp___12431)) (to_rep1 (first8 temp___12431))) 1) 0) (ite (<= (to_rep1 (first8 temp___12451)) (to_rep1 (last9 temp___12451))) (+ (- (to_rep1 (last9 temp___12451)) (to_rep1 (first8 temp___12451))) 1) 0))))
(check-sat)
(exit)
