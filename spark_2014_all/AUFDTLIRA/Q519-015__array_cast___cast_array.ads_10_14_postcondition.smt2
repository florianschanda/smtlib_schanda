...
(assert (=> (and (<= 0 i1) (<= i1 2)) (and (and (forall ((temp___163 Int)) (=> (and (<= 0 temp___163) (<= temp___163 2)) (=> (< i2 temp___163) (= (select result__3 temp___163) (select temp___162 temp___163))))) (=> (<= 0 2) (in_range5 i2))) (and (<= 0 i2) (<= i2 2)))))
