...
(assert (in_range1 i))
(assert (forall ((temp___289 Int)) (=> (and (<= (to_rep1 (first (rt (rec__types_with_invariants__container__content (us_split_fields3 c))))) temp___289) (<= temp___289 (to_rep1 (last (rt (rec__types_with_invariants__container__content (us_split_fields3 c))))))) (let ((temp___164 (select (elts (rec__types_with_invariants__container__content (us_split_fields3 c))) temp___289))) (=> (= (to_rep (rec__types_with_invariants__my_integer__val (us_split_fields1 temp___164))) 0) (= (rec__types_with_invariants__my_integer__sign (us_split_fields1 temp___164)) true))))))
(assert (<= i (to_rep (rec__types_with_invariants__container__c (us_split_discrs1 c)))))
(assert (not (<= (to_rep1 (first (rt (rec__types_with_invariants__container__content (us_split_fields3 c))))) i)))
(check-sat)
(exit)
