...
(assert (and (<= (to_rep2 (first temp___3172)) temp___320) (<= temp___320 (to_rep2 (last temp___3172)))))
(assert (= o temp___320))
(assert (= (mk___rep (mk___split_fields o1 o2)) (select temp___3171 o)))
(assert (= o1 o3))
(assert (= o2 o4))
(assert (= temp___322 o4))
(assert (not (<= (to_rep2 (first temp___3172)) idx)))
(check-sat)
(exit)
