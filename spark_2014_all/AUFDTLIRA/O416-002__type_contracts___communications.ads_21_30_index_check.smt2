...
(assert (and (<= (to_rep2 (first temp___2882)) temp___291) (<= temp___291 (to_rep2 (last temp___2882)))))
(assert (= o temp___291))
(assert (= (mk___rep (mk___split_fields o1 o2)) (select temp___2881 o)))
(assert (= o1 o3))
(assert (= o2 o4))
(assert (= temp___293 o4))
(assert (not (<= (to_rep2 (first temp___2882)) idx)))
(check-sat)
(exit)
