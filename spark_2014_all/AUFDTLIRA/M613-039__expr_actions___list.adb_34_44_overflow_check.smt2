...
(assert (=> (<= first2 temp___516) (and (and (<= (to_rep (first (rt list__reverse_list__L_2__R20b))) first2) (<= first2 (to_rep (last (rt list__reverse_list__L_2__R20b))))) (and (<= (to_rep (first (rt list__reverse_list__L_2__R20b))) temp___516) (<= temp___516 (to_rep (last (rt list__reverse_list__L_2__R20b))))))))
(assert (= o3 (elts list__reverse_list__L_2__R20b)))
(assert (= temp___518 (mk___t2 o3 (mk2 first2 temp___516))))
