...
(assert (=> (<= first2 temp___470) (and (and (<= (to_rep (first (rt list__reverse_list__L_2__R20b))) first2) (<= first2 (to_rep (last (rt list__reverse_list__L_2__R20b))))) (and (<= (to_rep (first (rt list__reverse_list__L_2__R20b))) temp___470) (<= temp___470 (to_rep (last (rt list__reverse_list__L_2__R20b))))))))
(assert (= o22 (elts list__reverse_list__L_2__R20b)))
(assert (= temp___472 (mk___t2 o22 (mk2 first2 temp___470))))
