...
(declare-const temp___1136 (Array Int us_rep1))
...
(assert (= result1 true))
(assert (= (tree_structure f1) true))
(assert (and (= temp___1136 (model__ f1 root)) (and (dynamic_invariant2 temp___1136 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1136 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1136 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent f1 i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1136 (parent f1 i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1136 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1136 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1136 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1136 (parent f1 i1)))) (position f1 i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1136 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1136 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1136 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1136 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1136 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1136 j)))) true)) (= j i1))))))))))))))
(assert (= (mk___rep (mk___split_fields o12 o13)) (select temp___1136 i)))
(assert (= o12 o14))
(assert (= o13 o15))
(assert (= o16 o14))
