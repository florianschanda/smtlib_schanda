...
(declare-fun temp_____aggregate_def_624 (Int Int Int) (Array Int enum_t))
...
(assert (forall ((temp___626 Int) (temp___627 Int) (temp___628 Int)) (let ((temp___625 (temp_____aggregate_def_624 temp___626 temp___627 temp___628))) (=> (and (and (dynamic_invariant temp___626 true true true true) (dynamic_invariant temp___627 true true true true)) (dynamic_invariant temp___628 true true true true)) (forall ((temp___629 Int)) (ite (= temp___629 1000) (= (to_rep (select temp___625 temp___629)) temp___627) (ite (or (= temp___629 2) (and (<= 4 temp___629) (<= temp___629 6))) (= (to_rep (select temp___625 temp___629)) temp___626) (= (to_rep (select temp___625 temp___629)) temp___628))))))))
(declare-const x (Array Int enum_t))
(declare-const result (Array Int enum_t))
(declare-const x1 (Array Int enum_t))
(assert (= result x))
(assert (= x1 (temp_____aggregate_def_624 0 2 1)))
(assert (not (= (to_rep (select x1 1000)) 1)))
(check-sat)
(exit)
