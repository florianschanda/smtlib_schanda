...
(declare-datatypes () ((map__ref2 (mk_map__ref2 (map__content2 us_rep2)))))
(define-fun map__ref___4__projection ((a map__ref2)) us_rep2 (map__content2 a))
...
(define-fun dynamic_invariant2 ((temp___expr_497 Int) (temp___is_init_494 Bool) (temp___skip_constant_495 Bool) (temp___do_toplevel_496 Bool)) Bool (=> (or (= temp___is_init_494 true) (<= 1 2147483647)) (in_range5 temp___expr_497)))
...
(define-fun dynamic_invariant3 ((temp___expr_503 Int) (temp___is_init_500 Bool) (temp___skip_constant_501 Bool) (temp___do_toplevel_502 Bool)) Bool (=> (or (= temp___is_init_500 true) (<= 0 5)) (in_range6 temp___expr_503)))
...
(declare-fun user_eq13 (partition_index partition_index) Bool)
(declare-const dummy13 partition_index)
...
(assert (forall ((x partition_index)) (! (in_range7 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(assert (forall ((x capacity_range)) (! (in_range8 (to_rep5 x)) :pattern ((to_rep5 x)))))
...
(define-fun dynamic_invariant4 ((temp___expr_733 Int) (temp___is_init_730 Bool) (temp___skip_constant_731 Bool) (temp___do_toplevel_732 Bool)) Bool (=> (or (= temp___is_init_730 true) (<= 0 10001)) (in_range8 temp___expr_733)))
(declare-fun length1 (us_rep6) Int)
(declare-fun length__function_guard1 (Int us_rep6) Bool)
(assert (forall ((container us_rep6)) (! (let ((result (length1 container))) (and (<= result (capacity container)) (dynamic_invariant4 result true false true))) :pattern ((length1 container)))))
...
(define-fun equal_except1 ((left us_rep7) (right us_rep7) (position Int)) Bool (and (= (length2 left) (length2 right)) (ite (forall ((i Int)) (=> (and (<= 0 i) (<= i (last1 left))) (=> (not (= i position)) (= (bool_eq6 (get3 left i) (get3 right i)) true)))) true false)))
...
(define-fun dynamic_invariant6 ((temp___expr_706 Int) (temp___is_init_703 Bool) (temp___skip_constant_704 Bool) (temp___do_toplevel_705 Bool)) Bool (=> (or (= temp___is_init_703 true) (<= 0 10000)) (in_range7 temp___expr_706)))
...
(assert (forall ((container us_rep)) (! (let ((result (length3 container))) (and (<= result (to_rep3 (rec__partition_refinement__inverse_sets__map__capacity (us_split_discrs1 container)))) (dynamic_invariant7 result true false true))) :pattern ((length3 container)))))
(assert (forall ((attr__tag Int)) (forall ((container us_rep)) (! (dynamic_invariant7 (length4 attr__tag container) true false true) :pattern ((length4 attr__tag container))))))
(define-fun k_bigger_than_range ((container us_rep3) (fst Int) (lst Int) (key2 Int)) Bool (ite (forall ((i1 Int)) (=> (and (<= fst i1) (<= i1 lst)) (< (get container i1) key2))) true false))
(declare-fun k_bigger_than_range__function_guard (Bool us_rep3 Int Int Int) Bool)
(define-fun k_smaller_than_range ((container us_rep3) (fst Int) (lst Int) (key2 Int)) Bool (ite (forall ((i1 Int)) (=> (and (<= fst i1) (<= i1 lst)) (< key2 (get container i1)))) true false))
...
(define-fun default_initial_assumption ((temp___expr_573 us_rep3) (temp___skip_top_level_574 Bool)) Bool (=> (not (= temp___skip_top_level_574 true)) (= (length temp___expr_573) 0)))
(assert (forall ((container us_rep3)) (forall ((key2 Int)) (! (=> (dynamic_invariant2 key2 true true true) (let ((result (find container key2))) (and (=> (< 0 result) (and (<= result (length container)) (= (equivalent_keys key2 (get container result)) true))) (dynamic_invariant7 result true false true)))) :pattern ((find container key2))))))
...
(define-fun default_initial_assumption1 ((temp___expr_542 us_rep4) (temp___skip_top_level_543 Bool)) Bool (=> (not (= temp___skip_top_level_543 true)) (and (= (is_empty temp___expr_542) true) (= (length5 temp___expr_542) 0))))
(assert true)
...
(assert (forall ((container us_rep)) (! (let ((result (keys container))) (and (and (and (= (length result) (length3 container)) (forall ((temp___607 Int)) (=> (and (in_range10 temp___607) (= (iter_has_element result temp___607) true)) (= (has_key1 (model__ container) (get result temp___607)) true)))) (forall ((key2 Int)) (=> (and (in_range9 key2) (= (has_key1 (model__ container) key2) true)) (and (< 0 (find result key2)) (= (equivalent_keys (get result (find result key2)) key2) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length3 container))) (and (= (find result (get result i1)) i1) (= (k_is_find result (get result i1) i1) true)))))) :pattern ((keys container)))))
(declare-fun length6 (us_rep2) Int)
(declare-fun length__function_guard6 (Int us_rep2) Bool)
(declare-fun is_empty1 (us_rep2) Bool)
(declare-fun is_empty__function_guard1 (Bool us_rep2) Bool)
(define-fun default_initial_assumption2 ((temp___expr_593 us_rep2) (temp___skip_top_level_594 Bool)) Bool (=> (not (= temp___skip_top_level_594 true)) (and (= (is_empty1 temp___expr_593) true) (= (length6 temp___expr_593) 0))))
(assert (forall ((container us_rep)) (! (let ((result (positions container))) (and (not (= (has_key result no_element) true)) (forall ((i1 us_rep1)) (=> (= (has_key result i1) true) (and (and (<= 1 (get1 result i1)) (<= (get1 result i1) (length3 container))) (forall ((j1 us_rep1)) (=> (= (has_key result j1) true) (=> (= (get1 result i1) (get1 result j1)) (= (bool_eq2 i1 j1) true))))))))) :pattern ((positions container)))))
...
(assert true)
(define-fun dynamic_invariant8 ((temp___expr_529 Int) (temp___is_init_526 Bool) (temp___skip_constant_527 Bool) (temp___do_toplevel_528 Bool)) Bool (=> (or (= temp___is_init_526 true) (<= 1 2147483647)) (in_range9 temp___expr_529)))
(assert (forall ((container us_rep4)) (forall ((key2 Int)) (! (=> (dynamic_invariant8 key2 true true true) (=> (= (of_int 1) true) (=> (exists ((k Int)) (and (and (in_range9 k) (= (has_key1 container k) true)) (= (equivalent_keys k key2) true))) (= (has_key1 container key2) true)))) :pattern ((has_key1 container key2))))))
...
(assert (forall ((container us_rep4)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant8 key2 true true true) (= (has_key1 container key2) true)) (let ((result (get2 container key2))) (and (=> (= (of_int 1) true) (and (= result (w_get container (witness container key2))) (forall ((k Int)) (=> (and (in_range9 k) (= (has_key1 container k) true)) (= (= (equivalent_keys k key2) true) (= (witness container key2) (witness container k))))))) (dynamic_invariant9 result true false true)))) :pattern ((get2 container key2))))))
(assert (forall ((container us_rep4)) (! (dynamic_invariant7 (length5 container) true false true) :pattern ((length5 container)))))
(assert (forall ((left us_rep4) (right us_rep4)) (! (= (= (oeq4 left right) true) (and (forall ((key2 Int)) (=> (and (in_range9 key2) (= (has_key1 left key2) true)) (and (= (has_key1 right key2) true) (= (get2 right key2) (get2 left key2))))) (forall ((key2 Int)) (=> (and (in_range9 key2) (= (has_key1 right key2) true)) (= (has_key1 left key2) true))))) :pattern ((oeq4 left right)))))
(assert (forall ((container us_rep4)) (! (= (= (is_empty container) true) (forall ((key2 Int)) (not (and (in_range9 key2) (= (has_key1 container key2) true))))) :pattern ((is_empty container)))))
...
(assert true)
(assert (forall ((container us_rep4)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant8 key2 true true true) (= (has_key1 container key2) true)) (let ((result (witness container key2))) (and (= (has_witness container result) true) (dynamic_invariant7 result true false true)))) :pattern ((witness container key2))))))
(assert (forall ((container us_rep4)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant7 witness1 true true true) (= (has_witness container witness1) true)) (dynamic_invariant9 (w_get container witness1) true false true)) :pattern ((w_get container witness1))))))
(define-fun dynamic_invariant10 ((temp___expr_566 Int) (temp___is_init_563 Bool) (temp___skip_constant_564 Bool) (temp___do_toplevel_565 Bool)) Bool (=> (or (= temp___is_init_563 true) (<= 0 2147483647)) (in_range10 temp___expr_566)))
(assert (forall ((container us_rep3)) (! (let ((result (length container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant7 result true false true))) :pattern ((length container)))))
...
(assert (forall ((container us_rep3)) (forall ((position Int)) (! (=> (and (dynamic_invariant10 position true true true) (and (<= 1 position) (<= position (last container)))) (dynamic_invariant11 (get container position) true false true)) :pattern ((get container position))))))
(assert (forall ((container us_rep2)) (forall ((key2 us_rep1)) (! (=> (= (of_int 0) true) (=> (exists ((k us_rep1)) (and (= (has_key container k) true) (= (bool_eq2 k key2) true))) (= (has_key container key2) true))) :pattern ((has_key container key2))))))
...
(assert (forall ((container us_rep2)) (forall ((key2 us_rep1)) (! (=> (= (has_key container key2) true) (let ((result (get1 container key2))) (and (=> (= (of_int 0) true) (and (= result (w_get1 container (witness1 container key2))) (forall ((k us_rep1)) (=> (= (has_key container k) true) (= (= (bool_eq2 k key2) true) (= (witness1 container key2) (witness1 container k))))))) (dynamic_invariant12 result true false true)))) :pattern ((get1 container key2))))))
(assert (forall ((container us_rep2)) (! (dynamic_invariant7 (length6 container) true false true) :pattern ((length6 container)))))
...
(assert true)
(assert (forall ((container us_rep2)) (forall ((key2 us_rep1)) (! (=> (= (has_key container key2) true) (let ((result (witness1 container key2))) (and (= (has_witness1 container result) true) (dynamic_invariant7 result true false true)))) :pattern ((witness1 container key2))))))
(assert (forall ((container us_rep2)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant7 witness2 true true true) (= (has_witness1 container witness2) true)) (dynamic_invariant12 (w_get1 container witness2) true false true)) :pattern ((w_get1 container witness2))))))
...
(define-fun oeq5 ((left us_rep7) (right us_rep7)) Bool (and (= (length2 left) (length2 right)) (ite (forall ((n Int)) (=> (and (<= 0 n) (<= n (last1 left))) (= (bool_eq6 (get3 left n) (get3 right n)) true))) true false)))
(declare-fun oeq__function_guard5 (Bool us_rep7 us_rep7) Bool)
(assert (forall ((a us_rep7) (b us_rep7)) (! (= (user_eq16 a b) (oeq5 a b)) :pattern ((user_eq16 a b)))))
(define-fun default_initial_assumption3 ((temp___expr_770 us_rep7) (temp___skip_top_level_771 Bool)) Bool (=> (not (= temp___skip_top_level_771 true)) (= (length2 temp___expr_770) 0)))
(assert (forall ((container us_rep6)) (! (= (length2 (model__1 container)) (length1 container)) :pattern ((model__1 container)))))
...
(assert (forall ((container us_rep7)) (! (let ((result (length2 container))) (and (<= (+ (- 1) result) 10000) (dynamic_invariant7 result true false true))) :pattern ((length2 container)))))
(assert true)
...
(declare-const o5 partition_index)
(declare-const o6 Int)
(declare-const o7 Int)
(declare-const o8 partition_index)
...
(declare-const o39 partition_index)
(declare-const o40 Int)
(declare-const o41 index)
(declare-const o42 index)
(declare-const o43 index_count)
(declare-const o44 Int)
(declare-const o45 partition_index)
(declare-const o46 Int)
(declare-const o47 index)
(declare-const o48 index)
(declare-const o49 index_count)
...
(declare-const p_elem__split_fields4 us_split_fields4)
(declare-const partition_refinement__partitions__replace_element__container__fields us_split_fields6)
(declare-const result22 us_split_fields__ref3)
(declare-const p__split_fields1 us_split_fields6)
(declare-const a2 map__ref)
(declare-const d__split_fields3 us_split_fields__ref)
(declare-const p__split_fields2 us_split_fields__ref3)
(declare-const p_elem__split_fields5 us_split_fields__ref2)
(declare-const a3 (Array Int positive))
(declare-const d__split_fields4 us_split_fields)
(declare-const p__split_fields3 us_split_fields6)
(declare-const p_elem__split_fields6 us_split_fields4)
...
(assert (and (< (length1 (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields))) 10000) (and (= (has_key1 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem) true) (and (and (<= 0 (to_rep4 (select f (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem)))) (<= (to_rep4 (select f (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem))) (- (length1 (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields))) 1))) (and (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 5)) (= (has_key1 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) (to_rep (select a j1))) true))) (forall ((c10 us_rep1)) (=> (= (has_key (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields))) c10) true) (= (to_rep (select a (element (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c10))) (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c10)))))))))
...
(assert (in_range3 i))
(assert (and (= (mk___rep2 (mk___split_fields2 partition_refinement__refine_one__p_elem__assume partition_refinement__refine_one__p_elem__assume1 partition_refinement__refine_one__p_elem__assume2)) (get3 (model__1 (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields))) (to_rep4 (select f i)))) (= (bool_eq6 (mk___rep2 (mk___split_fields2 partition_refinement__refine_one__p_elem__assume partition_refinement__refine_one__p_elem__assume1 partition_refinement__refine_one__p_elem__assume2)) (get3 (model__1 (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields))) (to_rep4 (select f i)))) true)))
(assert (= result5 (mk___split_fields__ref2 (mk___split_fields2 p_elem__split_fields p_elem__split_fields1 p_elem__split_fields2))))
...
(assert (forall ((c10 us_rep1)) (=> (= (has_key (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields))) c10) true) (=> (and (not (= (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c10) (to_rep (select a1 i)))) (not (= (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c10) (to_rep (select a1 j))))) (= (to_rep (select a1 (element (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c10))) (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c10))))))
(assert (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 5)) (= (has_key1 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) (to_rep (select a1 j1))) true))))
...
(assert (= result8 (mk___split_fields__ref (mk___split_fields d__split_fields))))
(assert (= d__split_fields1 partition_refinement__inverse_sets__replace__container__fields))
(assert (= (bool_eq a1 0 5 a_update 0 5) true))
(assert (forall ((c10 us_rep1)) (=> (= (has_key (positions (mk___rep d__split_discrs d__split_fields1)) c10) true) (=> (and (not (= (key (mk___rep d__split_discrs d__split_fields1) c10) (to_rep (select a1 i)))) (not (= (key (mk___rep d__split_discrs d__split_fields1) c10) (to_rep (select a1 j))))) (= (to_rep (select a1 (element (mk___rep d__split_discrs d__split_fields1) c10))) (key (mk___rep d__split_discrs d__split_fields1) c10))))))
(assert (forall ((c10 us_rep1)) (=> (= (has_key (positions (mk___rep d__split_discrs d__split_fields1)) c10) true) (=> (= (key (mk___rep d__split_discrs d__split_fields1) c10) (to_rep (select a1 i))) (= (to_rep (select a1 (element (mk___rep d__split_discrs d__split_fields1) c10))) (key (mk___rep d__split_discrs d__split_fields1) c10))))))
...
(assert (= result13 (mk___split_fields__ref d__split_fields1)))
(assert (= d__split_fields2 partition_refinement__inverse_sets__replace__container__fields1))
(assert (= (bool_eq a1 0 5 a_update 0 5) true))
(assert (and (= o76 (has_key (positions (mk___rep d__split_discrs d__split_fields2)) c4)) (= (= o76 true) (= (has_key (positions (mk___rep d__split_discrs d__split_fields2)) c4) true))))
(assert (= o77 true))
(assert (= result14 (ite (= o77 true) o76 false)))
(assert (= result14 true))
(assert (and (= o80 (key (mk___rep d__split_discrs d__split_fields2) c4)) (and (in_range5 o80) (= o80 (get (keys (mk___rep d__split_discrs d__split_fields2)) (get1 (positions (mk___rep d__split_discrs d__split_fields2)) c4))))))
(assert (= o81 (ite (= o80 (to_rep (select a1 j))) true false)))
(assert (= o82 (ite (not (= o81 true)) true false)))
(assert (and (= o78 (key (mk___rep d__split_discrs d__split_fields2) c4)) (and (in_range5 o78) (= o78 (get (keys (mk___rep d__split_discrs d__split_fields2)) (get1 (positions (mk___rep d__split_discrs d__split_fields2)) c4))))))
(assert (= o79 (ite (= o78 (to_rep (select a1 i))) true false)))
(assert (= o83 (ite (not (= o79 true)) true false)))
(assert (= result15 (ite (= o83 true) o82 false)))
(assert (= result15 true))
(assert (and (= o85 (key (mk___rep d__split_discrs d__split_fields2) c4)) (and (in_range5 o85) (= o85 (get (keys (mk___rep d__split_discrs d__split_fields2)) (get1 (positions (mk___rep d__split_discrs d__split_fields2)) c4))))))
(assert (not (= (has_key (positions (mk___rep d__split_discrs d__split_fields2)) c4) true)))
(check-sat)
(exit)
