...
(define-fun dynamic_invariant2 ((temp___expr_540 Int) (temp___is_init_536 Bool) (temp___skip_constant_537 Bool) (temp___do_toplevel_538 Bool) (temp___do_typ_inv_539 Bool)) Bool (=> (or (= temp___is_init_536 true) (<= 1 2147483647)) (in_range5 temp___expr_540)))
(assert (forall ((attr__tag Int)) (forall ((container us_rep)) (forall ((position us_rep1)) (! (dynamic_invariant2 (key1 attr__tag container position) true false true true) :pattern ((key1 attr__tag container position)))))))
...
(define-fun dynamic_invariant3 ((temp___expr_547 Int) (temp___is_init_543 Bool) (temp___skip_constant_544 Bool) (temp___do_toplevel_545 Bool) (temp___do_typ_inv_546 Bool)) Bool (=> (or (= temp___is_init_543 true) (<= 0 5)) (in_range6 temp___expr_547)))
(assert (forall ((attr__tag Int)) (forall ((container us_rep)) (forall ((position us_rep1)) (! (dynamic_invariant3 (element1 attr__tag container position) true false true true) :pattern ((element1 attr__tag container position)))))))
...
(assert (forall ((attr__tag Int) (key2 Int)) (forall ((container us_rep)) (! (=> (dynamic_invariant2 key2 true true true true) (dynamic_invariant3 (element__21 attr__tag container key2) true false true true)) :pattern ((element__21 attr__tag container key2))))))
...
(define-fun capacity ((container us_rep6)) Int (ite (= (distinct 1 0) true) (to_rep5 (rec__partition_refinement__partitions__vector__capacity (us_split_discrs3 container))) 10001))
(declare-fun capacity__function_guard (Int us_rep6) Bool)
(define-fun dynamic_invariant4 ((temp___expr_799 Int) (temp___is_init_795 Bool) (temp___skip_constant_796 Bool) (temp___do_toplevel_797 Bool) (temp___do_typ_inv_798 Bool)) Bool (=> (or (= temp___is_init_795 true) (<= 0 10001)) (in_range8 temp___expr_799)))
(declare-fun length1 (us_rep6) Int)
(declare-fun length__function_guard1 (Int us_rep6) Bool)
(assert (forall ((container us_rep6)) (! (let ((result (length1 container))) (and (<= result (capacity container)) (dynamic_invariant4 result true false true true))) :pattern ((length1 container)))))
...
(assert (forall ((a (Array Int partition_index)) (b (Array Int partition_index))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq8 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_156 Int)) (=> (and (<= a__first temp___idx_156) (<= temp___idx_156 a__last)) (= (to_rep4 (select a temp___idx_156)) (to_rep4 (select b (+ (- b__first a__first) temp___idx_156)))))))))))
(declare-fun temp___954 ((Array Int positive) Int Int Int Int) (Array Int positive))
...
(declare-fun temp___157 ((Array Int positive) Int Int Int Int) (Array Int positive))
(assert (forall ((temp___956 (Array Int positive))) (forall ((temp___957 Int) (temp___958 Int) (temp___959 Int) (temp___960 Int)) (let ((temp___955 (temp___954 temp___956 temp___957 temp___958 temp___959 temp___960))) (=> (and (and (and (dynamic_invariant1 temp___957 true true true true) (dynamic_invariant temp___958 true true true true)) (dynamic_invariant1 temp___959 true true true true)) (dynamic_invariant temp___960 true true true true)) (forall ((temp___961 Int)) (ite (= temp___961 temp___959) (= (to_rep (select temp___955 temp___961)) temp___960) (ite (= temp___961 temp___957) (= (to_rep (select temp___955 temp___961)) temp___958) (= (select temp___955 temp___961) (select temp___956 temp___961))))))))))
(assert (= a_update (temp___157 a_old i (to_rep (select a_old j)) j (to_rep (select a_old i)))))
(assert (forall ((temp___159 (Array Int positive))) (forall ((temp___160 Int) (temp___161 Int) (temp___162 Int) (temp___163 Int)) (let ((temp___158 (temp___157 temp___159 temp___160 temp___161 temp___162 temp___163))) (=> (and (and (and (dynamic_invariant1 temp___160 true true true true) (dynamic_invariant temp___161 true true true true)) (dynamic_invariant1 temp___162 true true true true)) (dynamic_invariant temp___163 true true true true)) (forall ((temp___164 Int)) (ite (= temp___164 temp___162) (= (to_rep (select temp___158 temp___164)) temp___163) (ite (= temp___164 temp___160) (= (to_rep (select temp___158 temp___164)) temp___161) (= (select temp___158 temp___164) (select temp___159 temp___164))))))))))
(define-fun dynamic_invariant5 ((temp___expr_326 Int) (temp___is_init_322 Bool) (temp___skip_constant_323 Bool) (temp___do_toplevel_324 Bool) (temp___do_typ_inv_325 Bool)) Bool (=> (or (= temp___is_init_322 true) (<= 0 6)) (in_range2 temp___expr_326)))
(define-fun dynamic_invariant6 ((temp___expr_768 Int) (temp___is_init_764 Bool) (temp___skip_constant_765 Bool) (temp___do_toplevel_766 Bool) (temp___do_typ_inv_767 Bool)) Bool (=> (or (= temp___is_init_764 true) (<= 0 10000)) (in_range7 temp___expr_768)))
(define-fun dynamic_invariant7 ((temp___expr_176 Int) (temp___is_init_172 Bool) (temp___skip_constant_173 Bool) (temp___do_toplevel_174 Bool) (temp___do_typ_inv_175 Bool)) Bool (=> (or (= temp___is_init_172 true) (<= 0 2147483647)) (in_range4 temp___expr_176)))
...
(assert (forall ((container us_rep)) (! (let ((result (length3 container))) (and (<= result (to_rep3 (rec__partition_refinement__inverse_sets__map__capacity (us_split_discrs1 container)))) (dynamic_invariant7 result true false true true))) :pattern ((length3 container)))))
(assert (forall ((attr__tag Int)) (forall ((container us_rep)) (! (dynamic_invariant7 (length4 attr__tag container) true false true true) :pattern ((length4 attr__tag container))))))
...
(define-fun k_is_find ((container us_rep3) (key2 Int) (position Int)) Bool (and (ite (< 0 position) (k_bigger_than_range container 1 (- position 1) key2) (distinct 1 0)) (ite (< position (length container)) (k_smaller_than_range container (+ position 1) (length container) key2) (distinct 1 0))))
...
(assert (forall ((container us_rep3)) (forall ((key2 Int)) (! (=> (dynamic_invariant2 key2 true true true true) (let ((result (find container key2))) (and (=> (< 0 result) (and (<= result (length container)) (= (equivalent_keys key2 (get container result)) true))) (dynamic_invariant7 result true false true true)))) :pattern ((find container key2))))))
...
(define-fun default_initial_assumption1 ((temp___expr_592 us_rep4) (temp___skip_top_level_593 Bool)) Bool (=> (not (= temp___skip_top_level_593 true)) (and (= (is_empty temp___expr_592) true) (= (length5 temp___expr_592) 0))))
(assert true)
...
(define-fun default_initial_assumption2 ((temp___expr_651 us_rep2) (temp___skip_top_level_652 Bool)) Bool (=> (not (= temp___skip_top_level_652 true)) (and (= (is_empty1 temp___expr_651) true) (= (length6 temp___expr_651) 0))))
...
(assert (forall ((container us_rep4)) (forall ((key2 Int)) (! (=> (dynamic_invariant8 key2 true true true true) (=> (= (distinct 1 0) true) (=> (exists ((k Int)) (and (and (in_range9 k) (= (has_key1 container k) true)) (= (equivalent_keys k key2) true))) (= (has_key1 container key2) true)))) :pattern ((has_key1 container key2))))))
...
(assert (forall ((container us_rep4)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant8 key2 true true true true) (= (has_key1 container key2) true)) (let ((result (get2 container key2))) (and (=> (= (distinct 1 0) true) (and (= result (w_get container (witness container key2))) (forall ((k Int)) (=> (and (in_range9 k) (= (has_key1 container k) true)) (= (= (equivalent_keys k key2) true) (= (witness container key2) (witness container k))))))) (dynamic_invariant9 result true false true true)))) :pattern ((get2 container key2))))))
...
(assert (forall ((container us_rep2)) (forall ((key2 us_rep1)) (! (=> (= (distinct 0 0) true) (=> (exists ((k us_rep1)) (and (= (has_key container k) true) (= (bool_eq2 k key2) true))) (= (has_key container key2) true))) :pattern ((has_key container key2))))))
...
(assert (forall ((container us_rep2)) (forall ((key2 us_rep1)) (! (=> (= (has_key container key2) true) (let ((result (get1 container key2))) (and (=> (= (distinct 0 0) true) (and (= result (w_get1 container (witness1 container key2))) (forall ((k us_rep1)) (=> (= (has_key container k) true) (= (= (bool_eq2 k key2) true) (= (witness1 container key2) (witness1 container k))))))) (dynamic_invariant12 result true false true true)))) :pattern ((get1 container key2))))))
(assert (forall ((container us_rep2)) (! (dynamic_invariant7 (length6 container) true false true true) :pattern ((length6 container)))))
...
(assert true)
(assert (forall ((container us_rep2)) (forall ((key2 us_rep1)) (! (=> (= (has_key container key2) true) (let ((result (witness1 container key2))) (and (= (has_witness1 container result) true) (dynamic_invariant7 result true false true true)))) :pattern ((witness1 container key2))))))
...
(assert (in_range3 j))
(assert (= a a_old))
(assert (= (temp___157 a_old i (to_rep (select a_old j)) j (to_rep (select a_old i))) a_update))
(assert (= (bool_eq a1 0 5 (temp___954 a i (to_rep (select a j)) j (to_rep (select a i))) 0 5) true))
(assert (= (bool_eq a1 0 5 a_update 0 5) true))
(assert (forall ((c1 us_rep1)) (=> (= (has_key (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields))) c1) true) (=> (and (not (= (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c1) (to_rep (select a1 i)))) (not (= (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c1) (to_rep (select a1 j))))) (= (to_rep (select a1 (element (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c1))) (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c1))))))
...
(assert (= (bool_eq a1 0 5 a_update 0 5) true))
(assert (forall ((c1 us_rep1)) (=> (= (has_key (positions (mk___rep d__split_discrs d__split_fields1)) c1) true) (=> (and (not (= (key (mk___rep d__split_discrs d__split_fields1) c1) (to_rep (select a1 i)))) (not (= (key (mk___rep d__split_discrs d__split_fields1) c1) (to_rep (select a1 j))))) (= (to_rep (select a1 (element (mk___rep d__split_discrs d__split_fields1) c1))) (key (mk___rep d__split_discrs d__split_fields1) c1))))))
(assert (forall ((c1 us_rep1)) (=> (= (has_key (positions (mk___rep d__split_discrs d__split_fields1)) c1) true) (=> (= (key (mk___rep d__split_discrs d__split_fields1) c1) (to_rep (select a1 i))) (= (to_rep (select a1 (element (mk___rep d__split_discrs d__split_fields1) c1))) (key (mk___rep d__split_discrs d__split_fields1) c1))))))
...
(assert (= (bool_eq a1 0 5 a_update 0 5) true))
(assert (and (= o (has_key (positions (mk___rep d__split_discrs d__split_fields2)) c)) (= (= o true) (= (has_key (positions (mk___rep d__split_discrs d__split_fields2)) c) true))))
(assert (= o1 true))
(assert (= result3 (ite (= o1 true) o false)))
(assert (= result3 true))
(assert (and (= o4 (key (mk___rep d__split_discrs d__split_fields2) c)) (and (in_range5 o4) (= o4 (get (keys (mk___rep d__split_discrs d__split_fields2)) (get1 (positions (mk___rep d__split_discrs d__split_fields2)) c))))))
(assert (= o5 (ite (= o4 (to_rep (select a1 j))) true false)))
(assert (= o6 (ite (not (= o5 true)) true false)))
(assert (and (= o2 (key (mk___rep d__split_discrs d__split_fields2) c)) (and (in_range5 o2) (= o2 (get (keys (mk___rep d__split_discrs d__split_fields2)) (get1 (positions (mk___rep d__split_discrs d__split_fields2)) c))))))
(assert (= o3 (ite (= o2 (to_rep (select a1 i))) true false)))
(assert (= o7 (ite (not (= o3 true)) true false)))
(assert (= result4 (ite (= o7 true) o6 false)))
(assert (= result4 true))
(assert (and (= o8 (key (mk___rep d__split_discrs d__split_fields2) c)) (and (in_range5 o8) (= o8 (get (keys (mk___rep d__split_discrs d__split_fields2)) (get1 (positions (mk___rep d__split_discrs d__split_fields2)) c))))))
