...
(assert (and (= o78 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (in_range7 o78)))
(assert (= result13 (ite (in_range4 o78) true false)))
(assert (=> (= result13 true) (and (= o74 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range6 o74))))
(assert (=> (= result13 true) (= result14 (ite (< j o74) true false))))
(assert (=> (= result13 true) (=> (= result14 true) (and (= o75 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result13 true) (=> (= result14 true) (and (= o76 (get (rec__list_allocator__m__t__available model____split_fields3) o75)) (in_range7 o76)))))
(assert (=> (= result13 true) (=> (not (= result14 true)) (= o76 0))))
(assert (=> (= result13 true) (and (= temp___427 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (in_range7 temp___427))))
(assert (=> (= result13 true) (and (<= 1 temp___427) (<= temp___427 3))))
(assert (=> (= result13 true) (= o70 temp___427)))
(assert (=> (= result13 true) (= o71 (select data3 o70))))
(assert (=> (= result13 true) (= o72 (us_split_fields1 o71))))
(assert (=> (= result13 true) (= o73 (rec__list_allocator__cell__next o72))))
(assert (=> (= result13 true) (= o77 (to_rep o73))))
(assert (=> (= result13 true) (= result12 (ite (= o77 o76) true false))))
(assert (=> (not (= result13 true)) (= result12 false)))
(assert (=> (= result12 true) (=> (< 1 j) (and (= o67 (- j 1)) (in_range2 (- j 1))))))
(assert (=> (= result12 true) (=> (< 1 j) (and (= o68 (get (rec__list_allocator__m__t__available model____split_fields3) o67)) (in_range7 o68)))))
(assert (=> (= result12 true) (=> (not (< 1 j)) (= o68 0))))
(assert (=> (= result12 true) (and (= temp___428 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (in_range7 temp___428))))
(assert (=> (= result12 true) (and (<= 1 temp___428) (<= temp___428 3))))
(assert (=> (= result12 true) (= o63 temp___428)))
(assert (=> (= result12 true) (= o64 (select data3 o63))))
(assert (=> (= result12 true) (= o65 (us_split_fields1 o64))))
(assert (=> (= result12 true) (= o66 (rec__list_allocator__cell__prev o65))))
(assert (=> (= result12 true) (= o69 (to_rep o66))))
(assert (=> (= result12 true) (= result11 (ite (= o69 o68) true false))))
...
(assert (not (= j k)))
(assert (and (= o62 (get (rec__list_allocator__m__t__available model____split_fields3) k)) (in_range7 o62)))
(assert (not (<= 1 j)))
(check-sat)
(exit)
