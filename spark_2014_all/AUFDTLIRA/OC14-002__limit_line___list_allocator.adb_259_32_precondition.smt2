...
(assert (and (= o73 (length (rec__list_allocator__m__t__available model____split_fields4))) (in_range6 o73)))
(assert (= o74 (ite (<= j3 o73) true false)))
(assert (= result17 (ite (<= 1 j3) o74 false)))
(assert (= result17 true))
(assert (and (= o94 (get (rec__list_allocator__m__t__available model____split_fields4) j3)) (in_range7 o94)))
(assert (= result20 (ite (in_range4 o94) true false)))
(assert (=> (= result20 true) (and (= o90 (length (rec__list_allocator__m__t__available model____split_fields4))) (in_range6 o90))))
(assert (=> (= result20 true) (= result21 (ite (< j3 o90) true false))))
(assert (=> (= result20 true) (=> (= result21 true) (and (= o91 (+ j3 1)) (in_range1 (+ j3 1))))))
(assert (=> (= result20 true) (=> (= result21 true) (and (= o92 (get (rec__list_allocator__m__t__available model____split_fields4) o91)) (in_range7 o92)))))
(assert (=> (= result20 true) (=> (not (= result21 true)) (= o92 0))))
(assert (=> (= result20 true) (and (= temp___427 (get (rec__list_allocator__m__t__available model____split_fields4) j3)) (in_range7 temp___427))))
(assert (=> (= result20 true) (and (<= 1 temp___427) (<= temp___427 3))))
(assert (=> (= result20 true) (= o86 temp___427)))
(assert (=> (= result20 true) (= o87 (select data4 o86))))
(assert (=> (= result20 true) (= o88 (us_split_fields1 o87))))
(assert (=> (= result20 true) (= o89 (rec__list_allocator__cell__next o88))))
(assert (=> (= result20 true) (= o93 (to_rep o89))))
(assert (=> (= result20 true) (= result19 (ite (= o93 o92) true false))))
(assert (=> (not (= result20 true)) (= result19 false)))
(assert (=> (= result19 true) (=> (< 1 j3) (and (= o83 (- j3 1)) (in_range2 (- j3 1))))))
(assert (=> (= result19 true) (=> (< 1 j3) (and (= o84 (get (rec__list_allocator__m__t__available model____split_fields4) o83)) (in_range7 o84)))))
(assert (=> (= result19 true) (=> (not (< 1 j3)) (= o84 0))))
(assert (=> (= result19 true) (and (= temp___428 (get (rec__list_allocator__m__t__available model____split_fields4) j3)) (in_range7 temp___428))))
(assert (=> (= result19 true) (and (<= 1 temp___428) (<= temp___428 3))))
(assert (=> (= result19 true) (= o79 temp___428)))
(assert (=> (= result19 true) (= o80 (select data4 o79))))
(assert (=> (= result19 true) (= o81 (us_split_fields1 o80))))
(assert (=> (= result19 true) (= o82 (rec__list_allocator__cell__prev o81))))
(assert (=> (= result19 true) (= o85 (to_rep o82))))
(assert (=> (= result19 true) (= result18 (ite (= o85 o84) true false))))
(assert (=> (not (= result19 true)) (= result18 false)))
(assert (= result18 true))
(assert (and (= o75 (length (rec__list_allocator__m__t__available model____split_fields4))) (in_range6 o75)))
(assert (= o76 (ite (<= k o75) true false)))
(assert (= result22 (ite (<= 1 k) o76 false)))
(assert (= result22 true))
(assert (not (= j3 k)))
(assert (and (= o77 (get (rec__list_allocator__m__t__available model____split_fields4) k)) (in_range7 o77)))
(assert (not (<= 1 j3)))
(check-sat)
(exit)
