...
(assert (=> (= result13 true) (and (= temp___460 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (in_range7 temp___460))))
(assert (=> (= result13 true) (and (<= 1 temp___460) (<= temp___460 3))))
(assert (=> (= result13 true) (= o70 temp___460)))
...
(assert (=> (= result12 true) (and (= temp___461 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (in_range7 temp___461))))
(assert (=> (= result12 true) (and (<= 1 temp___461) (<= temp___461 3))))
(assert (=> (= result12 true) (= o63 temp___461)))
