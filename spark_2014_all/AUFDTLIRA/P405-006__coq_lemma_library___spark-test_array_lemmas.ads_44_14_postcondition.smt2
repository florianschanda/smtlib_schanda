...
(assert (and (and (and (dynamic_property (- 2147483648) 2147483647 1 10) (and (= arr temp___244) (= (mk 1 10) temp___2441))) (and (dynamic_property1 (- 2147483648) 2147483647 (to_rep (first temp___2441)) (to_rep (last temp___2441))) (and (= temp___244 o) (= (mk1 (to_rep (first temp___2441)) (to_rep (last temp___2441))) o1)))) (forall ((i Int)) (=> (and (<= (to_rep (first2 o1)) i) (<= i (to_rep (last2 o1)))) (forall ((j Int)) (=> (and (<= (to_rep (first2 o1)) j) (<= j (to_rep (last2 o1)))) (=> (< i j) (< (to_rep (select o i)) (to_rep (select o j))))))))))
(declare-const i Int)
(assert (<= 1 i))
(assert (<= i 10))
(declare-const j Int)
