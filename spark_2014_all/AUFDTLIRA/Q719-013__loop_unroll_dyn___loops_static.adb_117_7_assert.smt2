...
(assert (not (not (and (and (= (mk_int__ref result1) (mk_int__ref i)) (= i1 1)) (and (and (and (and (and (<= (to_rep1 a__first) i1) (<= i1 (to_rep1 a__last))) (= o i1)) (= o1 (store a o rliteral))) (and (= (mk_map__ref result2) (mk_map__ref a)) (= a1 o1))) (and (ite (= i1 (to_rep1 a__first)) (and (and (= bad1 result3) (= bad2 (distinct 0 0))) (and (and (= j22 j25) (= bad2 bad11)) (and (= j11 j1) (= bad12 bad2)))) (and (ite (= i1 (to_rep1 a__last)) (and (and (and (= (mk_int__ref result4) j25) (= j2 (to_rep1 a__first))) (ite (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (and (and (and (= temp___376 bad1) (and (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (and (and (and (and (and (and (and (and (<= (to_rep1 a__first) j3) (<= j3 (to_rep1 a__last))) (= o2 j3)) (= o3 (select a1 o2))) (= o4 (to_rep o3))) (= o5 (ite (= o4 0) true false))) (= result5 (ite (not (= o5 true)) true false))) (ite (= result5 true) (and (= bad3 result6) (= bad4 (distinct 1 0))) (= bad4 bad3))) (= j3 i1)))) (and (and (= j3 j4) (= bad4 bad5)) (and (= j5 j3) (= bad6 bad4)))) (and (and (= j24 (mk_int__ref j4)) (= bad28 (mk_bool__ref bad5))) (and (= j7 j5) (= bad8 bad6)))) (and (and (= j2 j6) (= bad1 bad7)) (and (= j7 j2) (= bad8 bad1))))) (and (and (= j23 j24) (= bad27 bad28)) (and (= j9 j7) (= bad10 bad8)))) (and (and (= j23 j25) (= bad1 bad9)) (and (= j9 j1) (= bad10 bad1)))) (and (and (= j22 j23) (= bad26 bad27)) (and (= j11 j9) (= bad12 bad10))))) (and (forall ((j26 Int)) (=> (and (<= (to_rep1 a__first) j26) (<= j26 i1)) (= (to_rep (select a1 j26)) 0))) (and (and (= i1 result7) (= i2 2)) (and (and (and (and (and (<= (to_rep1 a__first) i2) (<= i2 (to_rep1 a__last))) (= o6 i2)) (= o7 (store a1 o6 rliteral))) (and (= result8 (mk_map__ref a1)) (= a2 o7))) (and (ite (= i2 (to_rep1 a__first)) (and (and (= result9 bad26) (= bad13 (distinct 0 0))) (and (and (= j20 j22) (= bad24 (mk_bool__ref bad13))) (and (= j21 j11) (= bad25 bad13)))) (and (ite (= i2 (to_rep1 a__last)) (and (and (and (= result10 j22) (= j12 (to_rep1 a__first))) (ite (and (<= (to_rep1 a__first) j12) (<= j12 i2)) (and (and (and (= temp___3761 bad11) (and (and (<= (to_rep1 a__first) j13) (<= j13 i2)) (and (and (and (and (and (and (and (and (<= (to_rep1 a__first) j13) (<= j13 (to_rep1 a__last))) (= o8 j13)) (= o9 (select a2 o8))) (= o10 (to_rep o9))) (= o11 (ite (= o10 0) true false))) (= result11 (ite (not (= o11 true)) true false))) (ite (= result11 true) (and (and (= result12 (mk_bool__ref bad14)) (= bad15 (distinct 1 0))) (and (= bad16 (mk_bool__ref bad15)) (= bad17 bad15))) (and (= bad16 (mk_bool__ref bad14)) (= bad17 bad14)))) (= j13 i2)))) (and (and (= j14 (mk_int__ref j13)) (= bad18 bad16)) (and (= j15 j13) (= bad19 bad17)))) (and (and (= j16 j14) (= bad20 bad18)) (and (= j17 j15) (= bad21 bad19)))) (and (and (= j16 (mk_int__ref j12)) (= bad20 bad26)) (and (= j17 j12) (= bad21 bad12))))) (and (and (= j18 j16) (= bad22 bad20)) (and (= j19 j17) (= bad23 bad21)))) (and (and (= j18 j22) (= bad22 bad26)) (and (= j19 j11) (= bad23 bad12)))) (and (and (= j20 j18) (= bad24 bad22)) (and (= j21 j19) (= bad25 bad23))))) (forall ((j26 Int)) (=> (and (<= (to_rep1 a__first) j26) (<= j26 i2)) (= (to_rep (select a2 j26)) 0)))))))))))))
(check-sat)
(exit)
