...
(assert (forall ((temp___433 Int)) (=> (dynamic_invariant3 temp___433 true true true true) (forall ((temp___434 Int)) (= (select (temp_____aggregate_def_431 temp___433) temp___434) rliteral)))))
...
(define-fun dynamic_invariant4 ((temp___expr_175 Int) (temp___is_init_171 Bool) (temp___skip_constant_172 Bool) (temp___do_toplevel_173 Bool) (temp___do_typ_inv_174 Bool)) Bool (=> (or (= temp___is_init_171 true) (<= 1 100)) (in_range3 temp___expr_175)))
(assert true)
...
(assert (forall ((f us_rep1)) (! (=> (dynamic_invariant2 f true true true true) (dynamic_invariant (size1 f) true false true true)) :pattern ((size1 f)))))
(assert (forall ((f us_rep1)) (forall ((i Int)) (! (=> (and (dynamic_invariant2 f true true true true) (dynamic_invariant4 i true true true true)) (=> (< (size1 f) i) (not (= (valid_root f i) true)))) :pattern ((valid_root f i))))))
(declare-fun parent (us_rep1 Int) Int)
(declare-fun parent__function_guard (Int us_rep1 Int) Bool)
(assert (forall ((f us_rep1)) (forall ((i Int)) (! (=> (and (dynamic_invariant2 f true true true true) (dynamic_invariant4 i true true true true)) (let ((result (parent f i))) (and (and (=> (= (valid_root f i) true) (= result 0)) (=> (= (size1 f) 0) (= result 0))) (dynamic_invariant result true false true true)))) :pattern ((parent f i))))))
(declare-fun position (us_rep1 Int) Int)
(declare-fun position__function_guard (Int us_rep1 Int) Bool)
(assert (forall ((f us_rep1)) (forall ((i Int)) (! (=> (and (and (dynamic_invariant2 f true true true true) (dynamic_invariant4 i true true true true)) (not (= (parent f i) 0))) (dynamic_invariant6 (position f i) true false true true)) :pattern ((position f i))))))
(assert (forall ((f us_rep1)) (forall ((root Int)) (! (=> (and (and (dynamic_invariant2 f true true true true) (dynamic_invariant4 root true true true true)) (= (valid_root f root) true)) (let ((result (model__ f root))) (and (and (= (rec__tree_model__path_type__k (us_split_fields7 (select result root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields7 (select result root)))) 0) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= i root)) (ite (and (not (= (parent f i) 0)) (= (rec__tree_model__path_type__k (us_split_fields7 (select result (parent f i)))) true)) (= (rec__tree_model__path_type__k (us_split_fields7 (select result i))) true) (not (= (rec__tree_model__path_type__k (us_split_fields7 (select result i))) true)))))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields7 (select result i))) true) (not (= i root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields7 (select result (parent f i)))) (position f i) (rec__tree_model__path_type__a (us_split_fields7 (select result i)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields7 (select result i)))) 0)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select result i))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields7 (select result j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields7 (select result i))) (rec__tree_model__path_type__a (us_split_fields7 (select result j)))) true)) (= j i))))))))))) (dynamic_invariant8 result true false true true)))) :pattern ((model__ f root))))))
...
(assert (and (= (tree_structure (mk___rep1 (mk___split_fields1 temp___6501 temp___6502))) true) (and (and (= (to_rep temp___650) 0) (default_initial_assumption1 (mk___rep1 (mk___split_fields1 temp___6501 temp___6502)) false)) (= temp___6503 (temp_____aggregate_def_431 0)))))
(assert (not (type_invariant (mk___rep2 (mk___split_fields2 temp___650 (mk___rep1 (mk___split_fields1 temp___6501 temp___6502)) temp___6503)))))
(check-sat)
(exit)
