...
(assert (=> (<= (to_rep1 (first4 temp___10531)) (to_rep1 (last4 temp___10531))) (= o (+ (- (to_rep1 (last4 temp___10531)) (to_rep1 (first4 temp___10531))) 1))))
(assert (=> (not (<= (to_rep1 (first4 temp___10531)) (to_rep1 (last4 temp___10531)))) (= o 0)))
(assert (=> (<= (to_rep1 (first4 (rt2 left))) (to_rep1 (last4 (rt2 left)))) (= o1 (+ (- (to_rep1 (last4 (rt2 left))) (to_rep1 (first4 (rt2 left)))) 1))))
(assert (=> (not (<= (to_rep1 (first4 (rt2 left))) (to_rep1 (last4 (rt2 left))))) (= o1 0)))
(assert (= o2 (+ o1 o)))
(assert (= o3 (+ (to_rep1 (first4 (rt2 left))) o2)))
(assert (= o4 (- o3 1)))
