...
(define-fun default_initial_assumption ((temp___expr_167 (Array Int natural)) (temp___skip_top_level_168 Bool)) Bool (and (forall ((temp___169 Int)) (=> (and (<= 1 temp___169) (<= temp___169 3)) (= (to_rep (select temp___expr_167 temp___169)) 0))) (=> (not (= temp___skip_top_level_168 true)) (= (arr_ok temp___expr_167) true))))
(assert true)
...
(assert (forall ((temp___274 Int)) (=> (and (<= 1 temp___274) (<= temp___274 3)) (= (to_rep (select temp___273 temp___274)) 0))))
(assert (not (= (arr_ok temp___273) true)))
(check-sat)
(exit)
