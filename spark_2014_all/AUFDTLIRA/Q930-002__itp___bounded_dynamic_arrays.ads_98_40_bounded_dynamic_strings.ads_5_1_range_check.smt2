...
(define-fun o19 () us_rep (mk___rep (mk___split_discrs o10) (mk___split_fields o11 (mk___t2 o12 o13))))
(define-fun o20 () us_t1 (mk___t1 o8 o9))
...
(assert (and (= o19 (instance o1 o20)) (and (dynamic_invariant1 o19 true false true true) (and (and (= (to_rep2 o10) o1) (= (length3 o19) (length1 o20))) (= (let ((temp___270 (value o19))) (bool_eq (elts1 temp___270) (to_rep1 (first2 (rt1 temp___270))) (to_rep1 (last2 (rt1 temp___270))) o8 (to_rep1 (first2 o9)) (to_rep1 (last2 o9)))) true)))))
...
(assert (= bounded_dynamic_strings__Oconcat__3__result12 o19))
...
(assert (and (= o15 (length3 right)) (and (in_range4 o15) (= o15 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right)))))))
(assert (and (= o16 (length1 left)) (in_range1 (length1 left))))
(assert (= o17 (+ o16 o15)))
(assert (= o18 (ite (= (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 (sequence__content bounded_dynamic_strings__Oconcat__3__result10)))) o17) true false)))
