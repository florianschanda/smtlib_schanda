...
(assert (= result2 true))
(assert (and (= o20 (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 ki1))))) (in_range5 (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 ki1)))))))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))) true))
...
(assert (= o17 (select temp___1790 ki1)))
...
(assert (= o14 (select temp___1789 ki1)))
...
(assert (= o10 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 ki1))))))
(assert (= o11 (select temp___1786 o10)))
