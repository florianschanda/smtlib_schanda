...
(assert (and (= o12 (length2 (mk___rep1 res__split_discrs res__split_fields2))) (and (in_range6 o12) (<= o12 (capacity (mk___rep1 res__split_discrs res__split_fields2))))))
(assert (= result5 (ite (= o12 o11) true false)))
(assert (=> (= result5 true) (and (= o7 (- last5 i9)) (in_range1 (- last5 i9)))))
(assert (=> (= result5 true) (= o8 (+ o7 1))))
(assert (=> (= result5 true) (and (= o9 o8) (in_range1 o8))))
(assert (=> (= result5 true) (and (= o6 (to__ (mk___rep s__split_fields9))) (and (dynamic_invariant1 o6 true false true) (and (= (to_rep (first (rt o6))) 1) (<= 0 (to_rep (last (rt o6)))))))))
...
(assert (not (<= (to_rep (first (rt temp___484))) j)))
(check-sat)
(exit)
