...
(declare-const temp___1433 (Array Int us_rep3))
(declare-const o20 us_rep3)
(declare-const o21 us_split_fields4)
(declare-const o22 us_rep)
(declare-const temp___1434 (Array Int us_rep3))
...
(assert (=> (and (<= 1 i2) (<= i2 100)) (forall ((k Int)) (=> (and (<= 1 k) (<= k (- i3 1))) (forall ((j15 Int)) (=> (and (<= 1 j15) (<= j15 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f root) k))) true) (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f root) j15))) true)) (= (olt (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) k))) (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) j15)))) true)) (ite (= (get (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) j15))) (+ (length (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) k)))) 1)) 0) (< (to_rep (select values j15)) (to_rep (select values k))) (< (to_rep (select values k)) (to_rep (select values j15)))))))))))
...
(assert (= result7 true))
(assert (= (olt (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f_old root) i9))) (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f_old root) j14)))) true))
(assert (and (= temp___1434 (model__ f v)) (and (dynamic_invariant5 temp___1434 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1434 v))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1434 v)))) 0) (and (forall ((i10 Int)) (=> (and (<= 1 i10) (<= i10 100)) (=> (not (= i10 v)) (ite (and (not (= (parent f i10) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1434 (parent f i10)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1434 i10))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1434 i10))) true)))))) (and (forall ((i10 Int)) (=> (and (<= 1 i10) (<= i10 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1434 i10))) true) (not (= i10 v))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select temp___1434 (parent f i10)))) (position f i10) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1434 i10)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1434 i10)))) 0)))) (forall ((i10 Int)) (=> (and (<= 1 i10) (<= i10 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1434 i10))) true) (forall ((j15 Int)) (=> (and (<= 1 j15) (<= j15 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1434 j15))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select temp___1434 i10))) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1434 j15)))) true)) (= j15 i10))))))))))))))
(assert (= o23 (select temp___1434 i9)))
...
(assert (and (= temp___1433 (model__ f v)) (and (dynamic_invariant5 temp___1433 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1433 v))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1433 v)))) 0) (and (forall ((i10 Int)) (=> (and (<= 1 i10) (<= i10 100)) (=> (not (= i10 v)) (ite (and (not (= (parent f i10) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1433 (parent f i10)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1433 i10))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1433 i10))) true)))))) (and (forall ((i10 Int)) (=> (and (<= 1 i10) (<= i10 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1433 i10))) true) (not (= i10 v))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select temp___1433 (parent f i10)))) (position f i10) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1433 i10)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1433 i10)))) 0)))) (forall ((i10 Int)) (=> (and (<= 1 i10) (<= i10 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1433 i10))) true) (forall ((j15 Int)) (=> (and (<= 1 j15) (<= j15 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1433 j15))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select temp___1433 i10))) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1433 j15)))) true)) (= j15 i10))))))))))))))
(assert (= o20 (select temp___1433 j14)))
