...
(define-fun a18 () map__ref (mk_map__ref a6))
...
(assert (=> (= result8 true) (and (and (= (is_perm (mk___t a (mk (to_rep a__first) (to_rep a__last))) (mk___t a2 (mk (to_rep a__first) (to_rep a__last)))) true) (and (= (to_rep (select a2 o14)) (to_rep (select a o15))) (and (= (to_rep (select a2 o15)) (to_rep (select a o14))) (forall ((z4 Int)) (=> (and (<= (to_rep a__first) z4) (<= z4 (to_rep a__last))) (=> (and (not (= z4 o14)) (not (= z4 o15))) (= (to_rep (select a2 z4)) (to_rep (select a z4))))))))) (= (to_rep a__first) 0))))
...
(assert (=> (= result11 true) (and (and (= (is_perm (mk___t a6 (mk (to_rep a__first) (to_rep a__last))) (mk___t a8 (mk (to_rep a__first) (to_rep a__last)))) true) (and (= (to_rep (select a8 o26)) (to_rep (select a6 o28))) (and (= (to_rep (select a8 o28)) (to_rep (select a6 o26))) (forall ((z4 Int)) (=> (and (<= (to_rep a__first) z4) (<= z4 (to_rep a__last))) (=> (and (not (= z4 o26)) (not (= z4 o28))) (= (to_rep (select a8 z4)) (to_rep (select a6 z4))))))))) (= (to_rep a__first) 0))))
(assert (=> (= result11 true) (= a9 (mk_map__ref a8))))
(assert (=> (= result11 true) (= a10 a8)))
(assert (=> (not (= result11 true)) (= a9 a18)))
...
(assert (=> (= result12 true) (= temp___298 (map__content a9))))
(assert (=> (= result12 true) (= temp___295 (int__content j6))))
