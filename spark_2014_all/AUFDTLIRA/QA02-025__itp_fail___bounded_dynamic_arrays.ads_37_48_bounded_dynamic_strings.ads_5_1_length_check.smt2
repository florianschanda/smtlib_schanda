...
(define-fun dynamic_invariant ((temp___expr_191 Int) (temp___is_init_187 Bool) (temp___skip_constant_188 Bool) (temp___do_toplevel_189 Bool) (temp___do_typ_inv_190 Bool)) Bool (=> (or (= temp___is_init_187 true) (<= 0 2147483647)) (in_range temp___expr_191)))
...
(assert (forall ((x natural_index)) (! (in_range (to_rep x)) :pattern ((to_rep x)))))
...
(define-fun bool_eq2 ((x us_t1) (y us_t1)) Bool (bool_eq (elts1 x) (to_rep2 (first2 (rt1 x))) (to_rep2 (last2 (rt1 x))) (elts1 y) (to_rep2 (first2 (rt1 y))) (to_rep2 (last2 (rt1 y)))))
...
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 a))) (to_rep (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 b)))) (and (= (to_rep (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 a))) (to_rep (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 b)))) (= (bool_eq1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 a)) (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 b))) true))) true false))
...
(declare-fun temp___222 (Int Int Int) us_t1)
...
(assert (forall ((temp___224 Int) (temp___225 Int) (temp___226 Int)) (let ((temp___223 (temp___222 temp___224 temp___225 temp___226))) (=> (dynamic_invariant3 temp___224 true true true true) (and (=> (dynamic_property4 1 2147483647 temp___225 temp___226) (and (= (first3 temp___223) temp___225) (= (last3 temp___223) temp___226))) (forall ((temp___227 Int)) (= (to_rep1 (select (to_array1 temp___223) temp___227)) temp___224)))))))
(declare-const temp___221 Int)
(declare-const temp___220 natural_index)
...
(assert (= (to_rep2 (first2 (rt1 (temp___222 32 1 temp___221)))) 1))
(assert (= (to_rep2 (last2 (rt1 (temp___222 32 1 temp___221)))) temp___221))
(assert (= (mk___t1 temp___229 temp___2291) (temp___222 32 1 temp___221)))
(assert (not (= (ite (<= (to_rep2 (first2 temp___2291)) (to_rep2 (last2 temp___2291))) (+ (- (to_rep2 (last2 temp___2291)) (to_rep2 (first2 temp___2291))) 1) 0) (ite (<= 1 temp___221) (+ (- temp___221 1) 1) 0))))
(check-sat)
(exit)
