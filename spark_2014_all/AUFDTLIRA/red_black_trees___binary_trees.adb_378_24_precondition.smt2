...
(define-fun dynamic_invariant ((temp___expr_175 Int) (temp___is_init_171 Bool) (temp___skip_constant_172 Bool) (temp___do_toplevel_173 Bool) (temp___do_typ_inv_174 Bool)) Bool (=> (or (= temp___is_init_171 true) (<= 1 100)) (in_range2 temp___expr_175)))
...
(define-fun dynamic_invariant2 ((temp___expr_217 Int) (temp___is_init_213 Bool) (temp___skip_constant_214 Bool) (temp___do_toplevel_215 Bool) (temp___do_typ_inv_216 Bool)) Bool (=> (or (= temp___is_init_213 true) (<= 0 1)) (in_range4 temp___expr_217)))
...
(define-fun dynamic_invariant3 ((temp___expr_224 Int) (temp___is_init_220 Bool) (temp___skip_constant_221 Bool) (temp___do_toplevel_222 Bool) (temp___do_typ_inv_223 Bool)) Bool (=> (or (= temp___is_init_220 true) (<= 0 2147483647)) (in_range5 temp___expr_224)))
...
(define-fun dynamic_invariant4 ((temp___expr_182 Int) (temp___is_init_178 Bool) (temp___skip_constant_179 Bool) (temp___do_toplevel_180 Bool) (temp___do_typ_inv_181 Bool)) Bool (=> (or (= temp___is_init_178 true) (<= 0 100)) (in_range6 temp___expr_182)))
...
(define-fun dynamic_invariant5 ((temp___expr_196 Int) (temp___is_init_192 Bool) (temp___skip_constant_193 Bool) (temp___do_toplevel_194 Bool) (temp___do_typ_inv_195 Bool)) Bool (=> (or (= temp___is_init_192 true) (<= 0 1)) (in_range8 temp___expr_196)))
...
(assert (forall ((f1 us_rep3)) (! (=> (type_invariant f1) (dynamic_invariant4 (size f1) true false true true)) :pattern ((size f1)))))
(assert (forall ((f1 us_rep3)) (! (= (size f1) (to_rep (rec__binary_trees__forest__s (us_split_fields5 f1)))) :pattern ((size f1)))))
(assert (forall ((f1 us_rep3)) (forall ((i Int)) (! (=> (and (dynamic_invariant i true true true true) (type_invariant f1)) (let ((result (parent f1 i))) (and (and (=> (= (valid_root f1 i) true) (= result 0)) (=> (= (size f1) 0) (= result 0))) (dynamic_invariant4 result true false true true)))) :pattern ((parent f1 i))))))
(assert (forall ((f1 us_rep3)) (forall ((i Int)) (! (=> (dynamic_invariant i true true true true) (= (parent f1 i) (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (let ((temp___334 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___334 i))))))) :pattern ((parent f1 i))))))
(assert (forall ((f1 us_rep3)) (forall ((i Int)) (! (=> (and (and (dynamic_invariant i true true true true) (type_invariant f1)) (not (= (parent f1 i) 0))) (dynamic_invariant5 (position f1 i) true false true true)) :pattern ((position f1 i))))))
(assert (forall ((f1 us_rep3)) (forall ((i Int)) (! (=> (dynamic_invariant i true true true true) (= (position f1 i) (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (let ((temp___338 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___338 i))))))) :pattern ((position f1 i))))))
...
(define-fun dynamic_invariant7 ((temp___expr_189 Int) (temp___is_init_185 Bool) (temp___skip_constant_186 Bool) (temp___do_toplevel_187 Bool) (temp___do_typ_inv_188 Bool)) Bool (=> (or (= temp___is_init_185 true) (<= 0 2)) (in_range7 temp___expr_189)))
...
(assert (= n1 1))
(assert (=> (and (<= 1 n1) (<= n1 100)) (= temp___1171 n1)))
(assert (=> (and (<= 1 n1) (<= n1 100)) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f root) i1))) true) (forall ((d1 Int)) (=> (and (<= 0 d1) (<= d1 1)) (=> (= (peek f i1 d1) 0) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f root) j1))) true) (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) i1))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) j1)))) true)) (<= (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) j1)))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) i1)))) n2))) (not (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) j1))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) i1)))) 1)) d1)))))))))))))
...
(assert (and (= temp___1227 (model__ f root)) (and (dynamic_invariant6 temp___1227 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1227 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1227 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent f i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1227 (parent f i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1227 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1227 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1227 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1227 (parent f i1)))) (position f i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1227 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1227 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1227 i1))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1227 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1227 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1227 j1)))) true)) (= j1 i1))))))))))))))
(assert (= o (select temp___1227 i)))
(assert (= o1 (us_split_fields1 o)))
(assert (= result1 (rec__tree_model__path_type__k o1)))
(assert (= result1 true))
(assert (<= 0 d))
(assert (<= d 1))
(assert (= (tree_structure f) true))
(assert (and (= o2 (peek f i d)) (and (in_range6 o2) (and (= o2 (ite (= d 0) (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) i)))) (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) i)))))) (and (ite (not (= o2 0)) (and (= (position f o2) d) (= (parent f o2) i)) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (= (parent f j1) i) (not (= (position f j1) d)))))) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (parent f j1) i) (= (position f j1) d)) (= o2 j1)))))))))
(assert (= result2 (ite (= o2 0) true false)))
(assert (= result2 true))
(assert (<= 1 j))
(assert (<= j 100))
(assert (= (tree_structure f) true))
(assert (and (= temp___1214 (model__ f root)) (and (dynamic_invariant6 temp___1214 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1214 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1214 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent f i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1214 (parent f i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1214 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1214 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1214 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1214 (parent f i1)))) (position f i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1214 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1214 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1214 i1))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1214 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1214 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1214 j1)))) true)) (= j1 i1))))))))))))))
(assert (= o9 (select temp___1214 j)))
(assert (= o10 (us_split_fields1 o9)))
(assert (= result4 (rec__tree_model__path_type__k o10)))
(assert (=> (= result4 true) (= (tree_structure f) true)))
(assert (=> (= result4 true) (and (= temp___1216 (model__ f root)) (and (dynamic_invariant6 temp___1216 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1216 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1216 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent f i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1216 (parent f i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1216 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1216 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1216 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1216 (parent f i1)))) (position f i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1216 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1216 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1216 i1))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1216 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1216 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1216 j1)))) true)) (= j1 i1)))))))))))))))
(assert (=> (= result4 true) (= o6 (select temp___1216 j))))
(assert (=> (= result4 true) (= o7 (us_split_fields1 o6))))
(assert (=> (= result4 true) (= o8 (rec__tree_model__path_type__a o7))))
(assert (=> (= result4 true) (= (tree_structure f) true)))
(assert (=> (= result4 true) (and (= temp___1215 (model__ f root)) (and (dynamic_invariant6 temp___1215 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1215 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1215 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent f i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1215 (parent f i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1215 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1215 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1215 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1215 (parent f i1)))) (position f i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1215 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1215 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1215 i1))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1215 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1215 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1215 j1)))) true)) (= j1 i1)))))))))))))))
(assert (=> (= result4 true) (= o3 (select temp___1215 i))))
(assert (=> (= result4 true) (= o4 (us_split_fields1 o3))))
(assert (=> (= result4 true) (= o5 (rec__tree_model__path_type__a o4))))
(assert (=> (= result4 true) (and (= result3 (olt o5 o8)) (= (= result3 true) (and (< (length o5) (length o8)) (forall ((n9 Int)) (=> (and (<= 1 n9) (<= n9 (last o5))) (= (get o5 n9) (get o8 n9)))))))))
(assert (=> (not (= result4 true)) (= result3 false)))
(assert (= result3 true))
(assert (= (tree_structure f) true))
(assert (and (= temp___1213 (model__ f root)) (and (dynamic_invariant6 temp___1213 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1213 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1213 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent f i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1213 (parent f i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1213 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1213 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1213 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1213 (parent f i1)))) (position f i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1213 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1213 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1213 i1))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1213 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1213 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1213 j1)))) true)) (= j1 i1))))))))))))))
(assert (= o14 (select temp___1213 i)))
(assert (= o15 (us_split_fields1 o14)))
(assert (= o16 (rec__tree_model__path_type__a o15)))
(assert (and (= o17 (length o16)) (and (in_range3 o17) (<= (+ 0 o17) 2147483647))))
(assert (= o18 (+ o17 1)))
(assert (and (= o19 o18) (in_range1 o18)))
(assert (= (tree_structure f) true))
(assert (and (= temp___1212 (model__ f root)) (and (dynamic_invariant6 temp___1212 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1212 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1212 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent f i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1212 (parent f i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1212 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1212 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1212 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1212 (parent f i1)))) (position f i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1212 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1212 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1212 i1))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1212 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1212 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1212 j1)))) true)) (= j1 i1))))))))))))))
(assert (= o11 (select temp___1212 j)))
