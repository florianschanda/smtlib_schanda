...
(assert (= (ite (= (not (= (to_rep1 (select a 1)) val__)) true) (value_found_in_range a val__ 2 10) false) true))
(assert (not (= (rec__linear_search__search_result__found (us_split_discrs1 (search_result__content linear_search__search__result18))) true)))
(check-sat)
(exit)
