...
(assert (and (= o9 (to_rep1 (rec__search_trees__search_tree__root t__split_fields6))) (in_range5 (to_rep1 (rec__search_trees__search_tree__root t__split_fields6)))))
(assert (not (= (valid_root (mk___rep2 f_1__split_fields3) o9) true)))
(check-sat)
(exit)
