...
(assert (forall ((i t18b)) (and (<= 1 (t18bqtint i)) (<= (t18bqtint i) 9))))
...
(assert (forall ((i t22b)) (and (<= 1 (t22bqtint i)) (<= (t22bqtint i) 9))))
...
(assert (not (<= (to_rep (first (mk 1 10))) (to_rep (last (mk 1 10))))))
(check-sat)
(exit)
