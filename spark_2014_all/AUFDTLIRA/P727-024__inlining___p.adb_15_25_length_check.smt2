...
(assert (forall ((temp___193 Int) (temp___194 Int) (temp___195 Int)) (let ((temp___192 (p__a__aggregate_def temp___193 temp___194 temp___195))) (and (=> (dynamic_property4 (- 2147483648) 2147483647 temp___194 temp___195) (and (= (first3 temp___192) temp___194) (= (last3 temp___192) temp___195))) (forall ((temp___196 Int)) (= (select (to_array1 temp___192) temp___196) (of_rep temp___193)))))))
(define-fun dynamic_invariant1 ((temp___expr_186 us_t) (temp___is_init_183 Bool) (temp___skip_constant_184 Bool) (temp___do_toplevel_185 Bool)) Bool (=> (not (= temp___skip_constant_184 true)) (and (dynamic_property1 r4b 10 (first1 temp___expr_186) (last1 temp___expr_186)) (and (= (first1 temp___expr_186) r4b) (= (last1 temp___expr_186) 10)))))
...
(assert (= (mk___t1 temp___198 temp___1981) (p__a__aggregate_def 0 r4b 10)))
(assert (not (= (ite (<= (to_rep (first2 temp___1981)) (to_rep (last2 temp___1981))) (+ (- (to_rep (last2 temp___1981)) (to_rep (first2 temp___1981))) 1) 0) (ite (<= r4b 10) (+ (- 10 r4b) 1) 0))))
(check-sat)
(exit)
