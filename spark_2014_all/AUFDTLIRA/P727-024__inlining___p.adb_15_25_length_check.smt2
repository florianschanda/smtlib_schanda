...
(assert (not (= (ite (<= (to_rep (first2 temp___2291)) (to_rep (last2 temp___2291))) (+ (- (to_rep (last2 temp___2291)) (to_rep (first2 temp___2291))) 1) 0) (ite (<= r4b 10) (+ (- 10 r4b) 1) 0))))
(check-sat)
(exit)
