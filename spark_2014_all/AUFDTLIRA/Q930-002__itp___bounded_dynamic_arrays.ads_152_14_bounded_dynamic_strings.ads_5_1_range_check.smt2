...
(declare-datatypes () ((t45s__ref (mk_t45s__ref (t45s__content us_t4)))))
(define-fun t45s__ref___projection ((a t45s__ref)) us_t4 (t45s__content a))
...
(declare-const o1 t1)
(declare-const temp___1238 (Array Int character))
(declare-const temp___12381 t1)
(declare-const o2 Int)
(declare-const o3 Int)
(declare-const temp___1235 Int)
(declare-const temp___1236 (Array Int character))
(declare-const temp___12361 t1)
...
(declare-const this__split_fields11 t)
(declare-const result Bool)
(define-fun this__split_fields12 () us_split_fields (mk___split_fields this__split_fields3 (mk___t this__split_fields4 this__split_fields5)))
(define-fun temp___12362 () us_t1 (mk___t1 temp___1236 temp___12361))
(define-fun temp___12382 () us_t1 (mk___t1 temp___1238 temp___12381))
(define-fun o15 () us_t1 (mk___t1 o o1))
...
(assert (and (<= 1 (- (+ start (length1 by__)) 1)) (<= (- (+ start (length1 by__)) 1) (to_rep1 (rec__bounded_dynamic_strings__sequence__capacity this__split_discrs)))))
(assert (and (= o15 (value by__)) (and (dynamic_invariant2 o15 true false true true) (and (and (= (elts (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 by__))) o) (= (mk1 (to_rep2 (first4 (mk2 1 (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 by__)))))) (to_rep2 (last4 (mk2 1 (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 by__))))))) o1)) (and (and (and (= (length2 o15) (length1 by__)) (= (to_rep2 (first2 o1)) 1)) (= (to_rep2 (last2 o1)) (length1 by__))) (= (< 0 (length1 by__)) (not (= (empty by__) true))))))))
(assert (and (and (= (bool_eq (elts1 (value (mk___rep this__split_discrs this__split_fields12))) (to_rep2 (first6 (mk3 start (- (+ start (length2 o15)) 1)))) (to_rep2 (last6 (mk3 start (- (+ start (length2 o15)) 1)))) o (to_rep2 (first2 o1)) (to_rep2 (last2 o1))) true) (ite (< (length1 (mk___rep this__split_discrs (mk___split_fields this__split_fields (mk___t this__split_fields1 this__split_fields2)))) (- (+ start (length2 o15)) 1)) (= (length1 (mk___rep this__split_discrs this__split_fields12)) (- (+ start (length2 o15)) 1)) (= (length1 (mk___rep this__split_discrs this__split_fields12)) (length1 (mk___rep this__split_discrs (mk___split_fields this__split_fields (mk___t this__split_fields1 this__split_fields2))))))) (dynamic_invariant1 (mk___rep this__split_discrs this__split_fields12) true true true true)))
...
(assert (= (mk___split_fields this__split_fields9 (mk___t this__split_fields10 this__split_fields11)) this__split_fields12))
(assert (and (= o6 (length1 (mk___rep this__split_discrs (mk___split_fields this__split_fields (mk___t this__split_fields1 this__split_fields2))))) (and (in_range2 o6) (= o6 (to_rep1 this__split_fields)))))
(assert (and (= o4 (length1 by__)) (and (in_range2 o4) (= o4 (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 by__)))))))
(assert (= o5 (+ start o4)))
(assert (= o7 (- o5 1)))
(assert (= result (ite (< o6 o7) true false)))
(assert (=> (= result true) (and (= o8 (length1 by__)) (and (in_range2 o8) (= o8 (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 by__))))))))
(assert (=> (= result true) (= o9 (+ start o8))))
(assert (=> (= result true) (= o10 (- o9 1))))
(assert (=> (= result true) (and (= o11 (length1 (mk___rep this__split_discrs (mk___split_fields this__split_fields6 (mk___t this__split_fields7 this__split_fields8))))) (and (in_range2 o11) (= o11 (to_rep1 this__split_fields6))))))
(assert (=> (= result true) (= o14 (ite (= o11 o10) true false))))
(assert (=> (not (= result true)) (and (= o12 (length1 (mk___rep this__split_discrs (mk___split_fields this__split_fields (mk___t this__split_fields1 this__split_fields2))))) (and (in_range2 o12) (= o12 (to_rep1 this__split_fields))))))
(assert (=> (not (= result true)) (and (= o13 (length1 (mk___rep this__split_discrs (mk___split_fields this__split_fields6 (mk___t this__split_fields7 this__split_fields8))))) (and (in_range2 o13) (= o13 (to_rep1 this__split_fields6))))))
(assert (=> (not (= result true)) (= o14 (ite (= o13 o12) true false))))
(assert (and (= temp___12382 (value by__)) (and (dynamic_invariant2 temp___12382 true false true true) (and (and (= (elts (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 by__))) temp___1238) (= (mk1 (to_rep2 (first4 (mk2 1 (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 by__)))))) (to_rep2 (last4 (mk2 1 (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 by__))))))) temp___12381)) (and (and (and (= (length2 temp___12382) (length1 by__)) (= (to_rep2 (first2 temp___12381)) 1)) (= (to_rep2 (last2 temp___12381)) (length1 by__))) (= (< 0 (length1 by__)) (not (= (empty by__) true))))))))
(assert (and (= o2 (length1 by__)) (and (in_range2 o2) (= o2 (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 by__)))))))
(assert (= o3 (+ start o2)))
(assert (= temp___1235 (- o3 1)))
(assert (and (= temp___12362 (value (mk___rep this__split_discrs (mk___split_fields this__split_fields6 (mk___t this__split_fields7 this__split_fields8))))) (and (dynamic_invariant2 temp___12362 true false true true) (and (and (= this__split_fields7 temp___1236) (= (mk1 (to_rep2 (first4 (mk2 1 (to_rep1 this__split_fields6)))) (to_rep2 (last4 (mk2 1 (to_rep1 this__split_fields6))))) temp___12361)) (and (and (and (= (length2 temp___12362) (length1 (mk___rep this__split_discrs (mk___split_fields this__split_fields6 (mk___t this__split_fields7 this__split_fields8))))) (= (to_rep2 (first2 temp___12361)) 1)) (= (to_rep2 (last2 temp___12361)) (length1 (mk___rep this__split_discrs (mk___split_fields this__split_fields6 (mk___t this__split_fields7 this__split_fields8)))))) (= (< 0 (length1 (mk___rep this__split_discrs (mk___split_fields this__split_fields6 (mk___t this__split_fields7 this__split_fields8))))) (not (= (empty (mk___rep this__split_discrs (mk___split_fields this__split_fields6 (mk___t this__split_fields7 this__split_fields8)))) true))))))))
(assert (<= start temp___1235))
(assert (not (<= start (to_rep2 (last2 temp___12361)))))
(check-sat)
(exit)
