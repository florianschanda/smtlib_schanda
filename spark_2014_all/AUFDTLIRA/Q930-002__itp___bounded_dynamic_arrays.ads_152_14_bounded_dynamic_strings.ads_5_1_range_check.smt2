...
(define-fun dynamic_invariant ((temp___expr_201 Int) (temp___is_init_198 Bool) (temp___skip_constant_199 Bool) (temp___do_toplevel_200 Bool)) Bool (=> (or (= temp___is_init_198 true) (<= 1 2147483647)) (in_range5 temp___expr_201)))
...
(declare-datatypes () ((t44s__ref (mk_t44s__ref (t44s__content integer)))))
(define-fun t44s__ref___projection ((a t44s__ref)) integer (t44s__content a))
(declare-sort t3 0)
...
(declare-datatypes () ((t45s__ref (mk_t45s__ref (t45s__content us_t3)))))
(define-fun t45s__ref___projection ((a t45s__ref)) us_t3 (t45s__content a))
...
(declare-datatypes () ((t47s__ref (mk_t47s__ref (t47s__content us_t4)))))
(define-fun t47s__ref___projection ((a t47s__ref)) us_t4 (t47s__content a))
...
(declare-const o1 t)
(declare-const temp___1169 (Array Int character))
(declare-const temp___11691 t)
...
(declare-const this__split_fields9 natural_index)
(declare-const this__split_fields10 (Array Int character))
(declare-const this__split_fields11 t1)
(declare-const result Bool)
(assert (dynamic_invariant1 i52s true false true))
(assert (dynamic_invariant1 (mk___rep this__split_discrs (mk___split_fields this__split_fields (mk___t1 this__split_fields1 this__split_fields2))) true false true))
(assert (dynamic_invariant1 by__ true false true))
(assert (in_range5 start))
(assert (and (<= 1 (- (+ start (length2 by__)) 1)) (<= (- (+ start (length2 by__)) 1) (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity this__split_discrs)))))
(assert (and (and (and (= us (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 by__)))) (in_range4 (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 by__))))) (and (and (= (mk___t o o1) (value by__)) (and (dynamic_invariant3 (mk___t o o1) true false true) (and (and (= (elts1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 by__))) o) (= (mk (to_rep1 (first4 (mk2 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 by__)))))) (to_rep1 (last4 (mk2 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 by__))))))) o1)) (and (and (and (= (length (mk___t o o1)) (length2 by__)) (= (to_rep1 (first o1)) 1)) (= (to_rep1 (last o1)) (length2 by__))) (= (< 0 (length2 by__)) (not (= (empty by__) true))))))) (and (and (= (bool_eq (elts (value (mk___rep this__split_discrs (mk___split_fields this__split_fields3 (mk___t1 this__split_fields4 this__split_fields5))))) (to_rep1 (first8 (mk4 start (- (+ start (length (mk___t o o1))) 1)))) (to_rep1 (last8 (mk4 start (- (+ start (length (mk___t o o1))) 1)))) o (to_rep1 (first o1)) (to_rep1 (last o1))) true) (ite (< (length2 (mk___rep this__split_discrs (mk___split_fields this__split_fields (mk___t1 this__split_fields1 this__split_fields2)))) (- (+ start (length (mk___t o o1))) 1)) (= (length2 (mk___rep this__split_discrs (mk___split_fields this__split_fields3 (mk___t1 this__split_fields4 this__split_fields5)))) (- (+ start (length (mk___t o o1))) 1)) (= (length2 (mk___rep this__split_discrs (mk___split_fields this__split_fields3 (mk___t1 this__split_fields4 this__split_fields5)))) (length2 (mk___rep this__split_discrs (mk___split_fields this__split_fields (mk___t1 this__split_fields1 this__split_fields2))))))) (dynamic_invariant1 (mk___rep this__split_discrs (mk___split_fields this__split_fields3 (mk___t1 this__split_fields4 this__split_fields5))) true true true)))) (and (and (= this__split_fields6 this__split_fields3) (and (= this__split_fields7 this__split_fields4) (= this__split_fields8 this__split_fields5))) (= (mk___split_fields this__split_fields9 (mk___t1 this__split_fields10 this__split_fields11)) (mk___split_fields this__split_fields3 (mk___t1 this__split_fields4 this__split_fields5))))))
(assert (and (= o6 (length2 (mk___rep this__split_discrs (mk___split_fields this__split_fields (mk___t1 this__split_fields1 this__split_fields2))))) (and (in_range4 o6) (= o6 (to_rep2 this__split_fields)))))
(assert (and (= o4 (length2 by__)) (and (in_range4 o4) (= o4 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 by__)))))))
(assert (= o5 (+ start o4)))
(assert (= o7 (- o5 1)))
(assert (= result (ite (< o6 o7) true false)))
(assert (=> (= result true) (and (= o8 (length2 by__)) (and (in_range4 o8) (= o8 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 by__))))))))
(assert (=> (= result true) (= o9 (+ start o8))))
(assert (=> (= result true) (= o10 (- o9 1))))
(assert (=> (= result true) (and (= o11 (length2 (mk___rep this__split_discrs (mk___split_fields this__split_fields6 (mk___t1 this__split_fields7 this__split_fields8))))) (and (in_range4 o11) (= o11 (to_rep2 this__split_fields6))))))
(assert (=> (= result true) (= o14 (ite (= o11 o10) true false))))
(assert (=> (not (= result true)) (and (= o12 (length2 (mk___rep this__split_discrs (mk___split_fields this__split_fields (mk___t1 this__split_fields1 this__split_fields2))))) (and (in_range4 o12) (= o12 (to_rep2 this__split_fields))))))
(assert (=> (not (= result true)) (and (= o13 (length2 (mk___rep this__split_discrs (mk___split_fields this__split_fields6 (mk___t1 this__split_fields7 this__split_fields8))))) (and (in_range4 o13) (= o13 (to_rep2 this__split_fields6))))))
(assert (=> (not (= result true)) (= o14 (ite (= o13 o12) true false))))
(assert (and (= (mk___t temp___1169 temp___11691) (value by__)) (and (dynamic_invariant3 (mk___t temp___1169 temp___11691) true false true) (and (and (= (elts1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 by__))) temp___1169) (= (mk (to_rep1 (first4 (mk2 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 by__)))))) (to_rep1 (last4 (mk2 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 by__))))))) temp___11691)) (and (and (and (= (length (mk___t temp___1169 temp___11691)) (length2 by__)) (= (to_rep1 (first temp___11691)) 1)) (= (to_rep1 (last temp___11691)) (length2 by__))) (= (< 0 (length2 by__)) (not (= (empty by__) true))))))))
(assert (and (= o2 (length2 by__)) (and (in_range4 o2) (= o2 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 by__)))))))
(assert (= o3 (+ start o2)))
(assert (= temp___1166 (- o3 1)))
(assert (and (= (mk___t temp___1167 temp___11671) (value (mk___rep this__split_discrs (mk___split_fields this__split_fields6 (mk___t1 this__split_fields7 this__split_fields8))))) (and (dynamic_invariant3 (mk___t temp___1167 temp___11671) true false true) (and (and (= this__split_fields7 temp___1167) (= (mk (to_rep1 (first4 (mk2 1 (to_rep2 this__split_fields6)))) (to_rep1 (last4 (mk2 1 (to_rep2 this__split_fields6))))) temp___11671)) (and (and (and (= (length (mk___t temp___1167 temp___11671)) (length2 (mk___rep this__split_discrs (mk___split_fields this__split_fields6 (mk___t1 this__split_fields7 this__split_fields8))))) (= (to_rep1 (first temp___11671)) 1)) (= (to_rep1 (last temp___11671)) (length2 (mk___rep this__split_discrs (mk___split_fields this__split_fields6 (mk___t1 this__split_fields7 this__split_fields8)))))) (= (< 0 (length2 (mk___rep this__split_discrs (mk___split_fields this__split_fields6 (mk___t1 this__split_fields7 this__split_fields8))))) (not (= (empty (mk___rep this__split_discrs (mk___split_fields this__split_fields6 (mk___t1 this__split_fields7 this__split_fields8)))) true))))))))
(assert (<= start temp___1166))
(assert (not (<= (to_rep1 (first temp___11671)) start)))
(check-sat)
(exit)
