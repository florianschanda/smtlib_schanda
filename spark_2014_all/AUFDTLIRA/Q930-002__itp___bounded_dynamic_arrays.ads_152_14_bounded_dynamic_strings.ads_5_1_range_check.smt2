...
(define-fun dynamic_invariant ((temp___expr_229 Int) (temp___is_init_225 Bool) (temp___skip_constant_226 Bool) (temp___do_toplevel_227 Bool) (temp___do_typ_inv_228 Bool)) Bool (=> (or (= temp___is_init_225 true) (<= 1 2147483647)) (in_range5 temp___expr_229)))
...
(declare-const o1 t)
(declare-const temp___1232 (Array Int character))
(declare-const temp___12321 t)
(declare-const o2 Int)
(declare-const o3 Int)
(declare-const temp___1229 Int)
(declare-const temp___1230 (Array Int character))
(declare-const temp___12301 t)
...
(define-fun this__split_fields12 () us_split_fields (mk___split_fields this__split_fields3 (mk___t1 this__split_fields4 this__split_fields5)))
(define-fun temp___12302 () us_t (mk___t temp___1230 temp___12301))
(define-fun temp___12322 () us_t (mk___t temp___1232 temp___12321))
(define-fun o15 () us_t (mk___t o o1))
(assert (dynamic_invariant1 i52s true false true true))
(assert (dynamic_invariant1 (mk___rep this__split_discrs (mk___split_fields this__split_fields (mk___t1 this__split_fields1 this__split_fields2))) true false true true))
(assert (dynamic_invariant1 by__ true false true true))
...
(assert (and (= us (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 by__)))) (in_range4 (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 by__))))))
(assert (and (= o15 (value by__)) (and (dynamic_invariant3 o15 true false true true) (and (and (= (elts1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 by__))) o) (= (mk (to_rep1 (first4 (mk2 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 by__)))))) (to_rep1 (last4 (mk2 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 by__))))))) o1)) (and (and (and (= (length o15) (length2 by__)) (= (to_rep1 (first o1)) 1)) (= (to_rep1 (last o1)) (length2 by__))) (= (< 0 (length2 by__)) (not (= (empty by__) true))))))))
(assert (and (and (= (bool_eq (elts (value (mk___rep this__split_discrs this__split_fields12))) (to_rep1 (first8 (mk4 start (- (+ start (length o15)) 1)))) (to_rep1 (last8 (mk4 start (- (+ start (length o15)) 1)))) o (to_rep1 (first o1)) (to_rep1 (last o1))) true) (ite (< (length2 (mk___rep this__split_discrs (mk___split_fields this__split_fields (mk___t1 this__split_fields1 this__split_fields2)))) (- (+ start (length o15)) 1)) (= (length2 (mk___rep this__split_discrs this__split_fields12)) (- (+ start (length o15)) 1)) (= (length2 (mk___rep this__split_discrs this__split_fields12)) (length2 (mk___rep this__split_discrs (mk___split_fields this__split_fields (mk___t1 this__split_fields1 this__split_fields2))))))) (dynamic_invariant1 (mk___rep this__split_discrs this__split_fields12) true true true true)))
...
(assert (= (mk___split_fields this__split_fields9 (mk___t1 this__split_fields10 this__split_fields11)) this__split_fields12))
...
(assert (and (= temp___12322 (value by__)) (and (dynamic_invariant3 temp___12322 true false true true) (and (and (= (elts1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 by__))) temp___1232) (= (mk (to_rep1 (first4 (mk2 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 by__)))))) (to_rep1 (last4 (mk2 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 by__))))))) temp___12321)) (and (and (and (= (length temp___12322) (length2 by__)) (= (to_rep1 (first temp___12321)) 1)) (= (to_rep1 (last temp___12321)) (length2 by__))) (= (< 0 (length2 by__)) (not (= (empty by__) true))))))))
...
(assert (= o3 (+ start o2)))
(assert (= temp___1229 (- o3 1)))
(assert (and (= temp___12302 (value (mk___rep this__split_discrs (mk___split_fields this__split_fields6 (mk___t1 this__split_fields7 this__split_fields8))))) (and (dynamic_invariant3 temp___12302 true false true true) (and (and (= this__split_fields7 temp___1230) (= (mk (to_rep1 (first4 (mk2 1 (to_rep2 this__split_fields6)))) (to_rep1 (last4 (mk2 1 (to_rep2 this__split_fields6))))) temp___12301)) (and (and (and (= (length temp___12302) (length2 (mk___rep this__split_discrs (mk___split_fields this__split_fields6 (mk___t1 this__split_fields7 this__split_fields8))))) (= (to_rep1 (first temp___12301)) 1)) (= (to_rep1 (last temp___12301)) (length2 (mk___rep this__split_discrs (mk___split_fields this__split_fields6 (mk___t1 this__split_fields7 this__split_fields8)))))) (= (< 0 (length2 (mk___rep this__split_discrs (mk___split_fields this__split_fields6 (mk___t1 this__split_fields7 this__split_fields8))))) (not (= (empty (mk___rep this__split_discrs (mk___split_fields this__split_fields6 (mk___t1 this__split_fields7 this__split_fields8)))) true))))))))
(assert (<= start temp___1229))
(assert (not (<= (to_rep1 (first temp___12301)) start)))
(check-sat)
(exit)
