...
(assert (=> (= result1 true) (and (and (=> (<= 0 2147483647) (in_range2 l2)) (=> (<= (- 2147483648) 2147483647) (in_range1 r5b3))) (=> (<= (- 2147483648) 2147483647) (in_range1 r8b3)))))
...
(assert (not (= (bool_eq a (to_rep (first (mk x (- (+ x (int__content longest_common_prefix__lcp__result4)) 1)))) (to_rep (last (mk x (- (+ x (int__content longest_common_prefix__lcp__result4)) 1)))) a (to_rep (first2 (mk1 y (- (+ y (int__content longest_common_prefix__lcp__result4)) 1)))) (to_rep (last2 (mk1 y (- (+ y (int__content longest_common_prefix__lcp__result4)) 1))))) true)))
(check-sat)
(exit)
