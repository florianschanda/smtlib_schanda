...
(declare-const temp___1791 t1)
(declare-const o30 (Array Int integer))
(declare-const temp___178 (Array Int integer))
(declare-const temp___1781 t)
...
(assert (= result3 (ite (<= o10 1000) true false)))
(assert (=> (= result3 true) (and (= o9 (+ y l1)) (in_range1 (+ y l1)))))
(assert (=> (= result3 true) (= result2 (ite (<= o9 1000) true false))))
(assert (=> (not (= result3 true)) (= result2 false)))
(assert (=> (= result2 true) (and (= temp___173 (+ y l1)) (in_range1 (+ y l1)))))
(assert (=> (= result2 true) (and (<= 1 temp___173) (<= temp___173 1000))))
(assert (=> (= result2 true) (= o5 temp___173)))
(assert (=> (= result2 true) (= o6 (select a o5))))
(assert (=> (= result2 true) (= o7 (to_rep o6))))
(assert (=> (= result2 true) (and (= temp___172 (+ x l1)) (in_range1 (+ x l1)))))
(assert (=> (= result2 true) (and (<= 1 temp___172) (<= temp___172 1000))))
(assert (=> (= result2 true) (= o3 temp___172)))
(assert (=> (= result2 true) (= o4 (select a o3))))
(assert (=> (= result2 true) (= o8 (to_rep o4))))
(assert (=> (= result2 true) (= result1 (ite (= o8 o7) true false))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (=> (= result1 true) (and (and (= temp___166 r8b) (and (= temp___165 r5b) (and (= temp___164 l1) (and (= 0 temp___171) (and (and (and (and (= o11 (+ x l1)) (in_range1 (+ x l1))) (and (= (mk_int__ref result4) (mk_int__ref r5b)) (= r5b2 o11))) (in_range1 r5b2)) (and (and (and (and (= o12 (+ y l1)) (in_range1 (+ y l1))) (and (= (mk_int__ref result5) (mk_int__ref r8b)) (= r8b2 o12))) (in_range1 r8b2)) (and (= (bool_eq a (to_rep (first4 (mk2 x r5b3))) (to_rep (last4 (mk2 x r5b3))) a (to_rep (first6 (mk3 y r8b3))) (to_rep (last6 (mk3 y r8b3)))) true) (and (and (and (=> (<= 0 2147483647) (in_range2 l2)) (=> (<= (- 2147483648) 2147483647) (in_range1 r5b3))) (=> (<= (- 2147483648) 2147483647) (in_range1 r8b3))) (and (and (= temp___1711 result6) (= temp___1712 l2)) (and (and (and (= o14 (+ l2 1)) (in_range1 (+ l2 1))) (and (= l2 result7) (= l3 o14))) (and (and (and (and (and (and (= o22 (+ x l3)) (in_range1 (+ x l3))) (= result10 (ite (<= o22 1000) true false))) (ite (= result10 true) (and (and (= o21 (+ y l3)) (in_range1 (+ y l3))) (= result9 (ite (<= o21 1000) true false))) (= result9 false))) (ite (= result9 true) (and (and (and (and (and (= temp___1731 (+ y l3)) (in_range1 (+ y l3))) (and (and (<= 1 temp___1731) (<= temp___1731 1000)) (= o17 temp___1731))) (= o18 (select a o17))) (= o19 (to_rep o18))) (and (and (and (and (and (= temp___1721 (+ x l3)) (in_range1 (+ x l3))) (and (and (<= 1 temp___1721) (<= temp___1721 1000)) (= o15 temp___1721))) (= o16 (select a o15))) (= o20 (to_rep o16))) (= o23 (ite (= o20 o19) true false)))) (= o23 false))) (= result8 (ite (not (= o23 true)) true false))) (= result8 true)))))))))))) (and (and (= r8b7 (mk_int__ref r8b3)) (and (= r5b7 (mk_int__ref r5b3)) (= l3 l6))) (and (= r8b8 r8b3) (and (= r5b8 r5b3) (= l7 l3)))))))
(assert (=> (= result1 true) (= r8b9 r8b7)))
(assert (=> (= result1 true) (= r5b9 r5b7)))
(assert (=> (= result1 true) (= l8 (mk_int__ref l6))))
(assert (=> (= result1 true) (= r8b10 r8b8)))
(assert (=> (= result1 true) (= r5b10 r5b8)))
(assert (=> (= result1 true) (= l9 l7)))
(assert (=> (not (= result1 true)) (= r8b9 (mk_int__ref r8b))))
(assert (=> (not (= result1 true)) (= r5b9 (mk_int__ref r5b))))
(assert (=> (not (= result1 true)) (= l8 (mk_int__ref l1))))
(assert (=> (not (= result1 true)) (= r8b10 r8b1)))
(assert (=> (not (= result1 true)) (= r5b10 r5b1)))
...
(assert (= result13 (mk_int__ref longest_common_prefix__lcp__result)))
(assert (= longest_common_prefix__lcp__result1 (int__content l8)))
...
(assert (= result15 (int__content longest_common_prefix__lcp__result4)))
