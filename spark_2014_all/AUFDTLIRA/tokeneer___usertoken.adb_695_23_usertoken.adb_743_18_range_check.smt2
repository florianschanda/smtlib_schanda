...
(define-fun in_range2 ((x Int)) Bool (and (<= 1 x) (<= x 150)))
(declare-fun attr__ATTRIBUTE_IMAGE2 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check2 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE2 (us_image) Int)
(declare-fun user_eq1 (descriptioni descriptioni) Bool)
(declare-const dummy1 descriptioni)
...
(declare-fun user_eq2 (algorithmt algorithmt) Bool)
(declare-const dummy2 algorithmt)
...
(assert (forall ((x algorithmt)) (! (= (of_rep1 (to_rep1 x)) x) :pattern ((to_rep1 x)))))
(assert (forall ((x algorithmt)) (! (in_range3 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(declare-fun user_eq3 (namecountt namecountt) Bool)
(declare-const dummy3 namecountt)
...
(define-fun us_split_fields__ref___24__projection ((a us_split_fields__ref6)) us_split_fields12 (us_split_fields__content6 a))
(declare-datatypes () ((us_rep6 (mk___rep6 (us_split_fields13 us_split_fields12)))))
(define-fun us_rep___25__projection ((a us_rep6)) us_split_fields12 (us_split_fields13 a))
...
(declare-fun temp___String_Literal_2006 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2006 us_void_param) 1)) 73) (= (to_rep (select (temp___String_Literal_2006 us_void_param) 2)) 68)) (= (to_rep (select (temp___String_Literal_2006 us_void_param) 3)) 32)) (= (to_rep (select (temp___String_Literal_2006 us_void_param) 4)) 67)) (= (to_rep (select (temp___String_Literal_2006 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_2006 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_2006 us_void_param) 7)) 116)) (= (to_rep (select (temp___String_Literal_2006 us_void_param) 8)) 105)) (= (to_rep (select (temp___String_Literal_2006 us_void_param) 9)) 102)) (= (to_rep (select (temp___String_Literal_2006 us_void_param) 10)) 105)) (= (to_rep (select (temp___String_Literal_2006 us_void_param) 11)) 99)) (= (to_rep (select (temp___String_Literal_2006 us_void_param) 12)) 97)) (= (to_rep (select (temp___String_Literal_2006 us_void_param) 13)) 116)) (= (to_rep (select (temp___String_Literal_2006 us_void_param) 14)) 101)) (= (to_rep (select (temp___String_Literal_2006 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_2006 us_void_param) 16)) 66)) (= (to_rep (select (temp___String_Literal_2006 us_void_param) 17)) 97)) (= (to_rep (select (temp___String_Literal_2006 us_void_param) 18)) 100)) :pattern ((temp___String_Literal_2006 us_void_param)))))
(declare-fun temp___String_Literal_2011 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2011 us_void_param) 1)) 73) (= (to_rep (select (temp___String_Literal_2011 us_void_param) 2)) 68)) (= (to_rep (select (temp___String_Literal_2011 us_void_param) 3)) 32)) (= (to_rep (select (temp___String_Literal_2011 us_void_param) 4)) 67)) (= (to_rep (select (temp___String_Literal_2011 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_2011 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_2011 us_void_param) 7)) 116)) (= (to_rep (select (temp___String_Literal_2011 us_void_param) 8)) 105)) (= (to_rep (select (temp___String_Literal_2011 us_void_param) 9)) 102)) (= (to_rep (select (temp___String_Literal_2011 us_void_param) 10)) 105)) (= (to_rep (select (temp___String_Literal_2011 us_void_param) 11)) 99)) (= (to_rep (select (temp___String_Literal_2011 us_void_param) 12)) 97)) (= (to_rep (select (temp___String_Literal_2011 us_void_param) 13)) 116)) (= (to_rep (select (temp___String_Literal_2011 us_void_param) 14)) 101)) (= (to_rep (select (temp___String_Literal_2011 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_2011 us_void_param) 16)) 78)) (= (to_rep (select (temp___String_Literal_2011 us_void_param) 17)) 111)) (= (to_rep (select (temp___String_Literal_2011 us_void_param) 18)) 116)) (= (to_rep (select (temp___String_Literal_2011 us_void_param) 19)) 32)) (= (to_rep (select (temp___String_Literal_2011 us_void_param) 20)) 86)) (= (to_rep (select (temp___String_Literal_2011 us_void_param) 21)) 101)) (= (to_rep (select (temp___String_Literal_2011 us_void_param) 22)) 114)) (= (to_rep (select (temp___String_Literal_2011 us_void_param) 23)) 105)) (= (to_rep (select (temp___String_Literal_2011 us_void_param) 24)) 102)) (= (to_rep (select (temp___String_Literal_2011 us_void_param) 25)) 105)) (= (to_rep (select (temp___String_Literal_2011 us_void_param) 26)) 97)) (= (to_rep (select (temp___String_Literal_2011 us_void_param) 27)) 98)) (= (to_rep (select (temp___String_Literal_2011 us_void_param) 28)) 108)) (= (to_rep (select (temp___String_Literal_2011 us_void_param) 29)) 101)) :pattern ((temp___String_Literal_2011 us_void_param)))))
(declare-fun temp___String_Literal_2016 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2016 us_void_param) 1)) 73) (= (to_rep (select (temp___String_Literal_2016 us_void_param) 2)) 68)) (= (to_rep (select (temp___String_Literal_2016 us_void_param) 3)) 32)) (= (to_rep (select (temp___String_Literal_2016 us_void_param) 4)) 67)) (= (to_rep (select (temp___String_Literal_2016 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_2016 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_2016 us_void_param) 7)) 116)) (= (to_rep (select (temp___String_Literal_2016 us_void_param) 8)) 105)) (= (to_rep (select (temp___String_Literal_2016 us_void_param) 9)) 102)) (= (to_rep (select (temp___String_Literal_2016 us_void_param) 10)) 105)) (= (to_rep (select (temp___String_Literal_2016 us_void_param) 11)) 99)) (= (to_rep (select (temp___String_Literal_2016 us_void_param) 12)) 97)) (= (to_rep (select (temp___String_Literal_2016 us_void_param) 13)) 116)) (= (to_rep (select (temp___String_Literal_2016 us_void_param) 14)) 101)) (= (to_rep (select (temp___String_Literal_2016 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_2016 us_void_param) 16)) 78)) (= (to_rep (select (temp___String_Literal_2016 us_void_param) 17)) 111)) (= (to_rep (select (temp___String_Literal_2016 us_void_param) 18)) 116)) (= (to_rep (select (temp___String_Literal_2016 us_void_param) 19)) 32)) (= (to_rep (select (temp___String_Literal_2016 us_void_param) 20)) 67)) (= (to_rep (select (temp___String_Literal_2016 us_void_param) 21)) 117)) (= (to_rep (select (temp___String_Literal_2016 us_void_param) 22)) 114)) (= (to_rep (select (temp___String_Literal_2016 us_void_param) 23)) 114)) (= (to_rep (select (temp___String_Literal_2016 us_void_param) 24)) 101)) (= (to_rep (select (temp___String_Literal_2016 us_void_param) 25)) 110)) (= (to_rep (select (temp___String_Literal_2016 us_void_param) 26)) 116)) :pattern ((temp___String_Literal_2016 us_void_param)))))
...
(define-fun dynamic_invariant1 ((temp___expr_1638 Int) (temp___is_init_1635 Bool) (temp___skip_constant_1636 Bool) (temp___do_toplevel_1637 Bool)) Bool (=> (or (= temp___is_init_1635 true) (<= 0 3)) (in_range13 temp___expr_1638)))
(define-fun dynamic_invariant2 ((temp___expr_384 Int) (temp___is_init_381 Bool) (temp___skip_constant_382 Bool) (temp___do_toplevel_383 Bool)) Bool (=> (or (= temp___is_init_381 true) (<= 1 150)) (in_range2 temp___expr_384)))
...
(define-fun dynamic_invariant7 ((temp___expr_179 Int) (temp___is_init_176 Bool) (temp___skip_constant_177 Bool) (temp___do_toplevel_178 Bool)) Bool (=> (or (= temp___is_init_176 true) (<= 0 40)) (in_range4 temp___expr_179)))
(define-fun dynamic_invariant8 ((temp___expr_200 Int) (temp___is_init_197 Bool) (temp___skip_constant_198 Bool) (temp___do_toplevel_199 Bool)) Bool (=> (or (= temp___is_init_197 true) (<= 0 4294967295)) (in_range5 temp___expr_200)))
(define-fun dynamic_invariant9 ((temp___expr_218 Int) (temp___is_init_215 Bool) (temp___skip_constant_216 Bool) (temp___do_toplevel_217 Bool)) Bool (=> (or (= temp___is_init_215 true) (<= 0 10)) (in_range3 temp___expr_218)))
(define-fun dynamic_invariant10 ((temp___expr_230 Int) (temp___is_init_227 Bool) (temp___skip_constant_228 Bool) (temp___do_toplevel_229 Bool)) Bool (=> (or (= temp___is_init_227 true) (<= 0 4294967295)) (in_range11 temp___expr_230)))
(define-fun dynamic_invariant11 ((temp___expr_236 Int) (temp___is_init_233 Bool) (temp___skip_constant_234 Bool) (temp___do_toplevel_235 Bool)) Bool (=> (or (= temp___is_init_233 true) (<= 0 128)) (in_range12 temp___expr_236)))
(define-fun dynamic_invariant12 ((temp___expr_321 Int) (temp___is_init_318 Bool) (temp___skip_constant_319 Bool) (temp___do_toplevel_320 Bool)) Bool (=> (or (= temp___is_init_318 true) (<= 0 4294967295)) (in_range6 temp___expr_321)))
...
(declare-const temp___2005 us_rep6)
...
(assert (=> (= (rec__usertoken__valididcertt__valid (us_split_fields__content6 idcert__split_fields)) true) (= o1 (iscurrent o currenttime))))
...
(assert (=> (= (rec__usertoken__valididcertt__valid (us_split_fields__content6 idcert__split_fields)) true) (=> (not (= current2 true)) (= temp___2005 (mk___rep6 o3)))))
...
(assert (=> (= (rec__usertoken__valididcertt__valid (us_split_fields__content6 idcert__split_fields)) true) (=> (not (= current2 true)) (= (let ((subject idcert__split_fields)) idcert__split_fields3) (us_split_fields13 temp___2005)))))
...
(assert (not (= (to_rep11 (rec__usertoken__valididcertt__idstatus (let ((subject idcert__split_fields)) idcert__split_fields3))) 1)))
(assert (= (to_rep11 (rec__usertoken__valididcertt__idstatus (let ((subject idcert__split_fields)) idcert__split_fields3))) 2))
