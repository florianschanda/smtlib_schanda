...
(declare-fun user_eq2 (yearst yearst) Bool)
(declare-const dummy2 yearst)
...
(declare-fun to_rep1 (yearst) Int)
(declare-fun of_rep1 (Int) yearst)
(assert (forall ((x yearst)) (! (= (of_rep1 (to_rep1 x)) x) :pattern ((to_rep1 x)))))
(assert (forall ((x yearst)) (! (in_range3 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(declare-fun user_eq3 (monthst monthst) Bool)
(declare-const dummy3 monthst)
...
(declare-fun to_rep2 (monthst) Int)
(declare-fun of_rep2 (Int) monthst)
(assert (forall ((x monthst)) (! (= (of_rep2 (to_rep2 x)) x) :pattern ((to_rep2 x)))))
(assert (forall ((x monthst)) (! (in_range4 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(declare-fun user_eq4 (dayst dayst) Bool)
(declare-const dummy4 dayst)
...
(declare-fun to_rep3 (dayst) Int)
(declare-fun of_rep3 (Int) dayst)
(assert (forall ((x dayst)) (! (= (of_rep3 (to_rep3 x)) x) :pattern ((to_rep3 x)))))
(assert (forall ((x dayst)) (! (in_range5 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(declare-fun to_rep4 (millisecst) Int)
(declare-fun of_rep4 (Int) millisecst)
(assert (forall ((x millisecst)) (! (= (of_rep4 (to_rep4 x)) x) :pattern ((to_rep4 x)))))
(assert (forall ((x millisecst)) (! (in_range6 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(declare-fun to_rep6 (namecountt) Int)
...
(declare-fun to_rep8 (serialnumbert) Int)
...
(define-fun bool_eq3 ((a us_rep2) (b us_rep2)) Bool (ite (and (= (bool_eq2 (rec__certtypes__idt__issuer (us_split_fields5 a)) (rec__certtypes__idt__issuer (us_split_fields5 b))) true) (= (to_rep8 (rec__certtypes__idt__serialnumber (us_split_fields5 a))) (to_rep8 (rec__certtypes__idt__serialnumber (us_split_fields5 b))))) true false))
...
(define-fun bool_eq4 ((a us_rep3) (b us_rep3)) Bool (ite (and (and (and (= (bool_eq3 (rec__cert__contentst__id (us_split_fields7 a)) (rec__cert__contentst__id (us_split_fields7 b))) true) (= (bool_eq1 (rec__cert__contentst__notbefore (us_split_fields7 a)) (rec__cert__contentst__notbefore (us_split_fields7 b))) true)) (= (bool_eq1 (rec__cert__contentst__notafter (us_split_fields7 a)) (rec__cert__contentst__notafter (us_split_fields7 b))) true)) (= (to_rep5 (rec__cert__contentst__mechanism (us_split_fields7 a))) (to_rep5 (rec__cert__contentst__mechanism (us_split_fields7 b))))) true false))
...
(define-fun bool_eq5 ((a us_rep4) (b us_rep4)) Bool (ite (and (and (= (to_rep5 (rec__cryptotypes__keypartt__algorithmid (us_split_fields9 a))) (to_rep5 (rec__cryptotypes__keypartt__algorithmid (us_split_fields9 b)))) (= (to_rep9 (rec__cryptotypes__keypartt__keyid (us_split_fields9 a))) (to_rep9 (rec__cryptotypes__keypartt__keyid (us_split_fields9 b))))) (= (to_rep10 (rec__cryptotypes__keypartt__keylength (us_split_fields9 a))) (to_rep10 (rec__cryptotypes__keypartt__keylength (us_split_fields9 b))))) true false))
...
(declare-fun temp___String_Literal_2651 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2651 us_void_param) 1)) 73) (= (to_rep (select (temp___String_Literal_2651 us_void_param) 2)) 68)) (= (to_rep (select (temp___String_Literal_2651 us_void_param) 3)) 32)) (= (to_rep (select (temp___String_Literal_2651 us_void_param) 4)) 67)) (= (to_rep (select (temp___String_Literal_2651 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_2651 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_2651 us_void_param) 7)) 116)) (= (to_rep (select (temp___String_Literal_2651 us_void_param) 8)) 105)) (= (to_rep (select (temp___String_Literal_2651 us_void_param) 9)) 102)) (= (to_rep (select (temp___String_Literal_2651 us_void_param) 10)) 105)) (= (to_rep (select (temp___String_Literal_2651 us_void_param) 11)) 99)) (= (to_rep (select (temp___String_Literal_2651 us_void_param) 12)) 97)) (= (to_rep (select (temp___String_Literal_2651 us_void_param) 13)) 116)) (= (to_rep (select (temp___String_Literal_2651 us_void_param) 14)) 101)) (= (to_rep (select (temp___String_Literal_2651 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_2651 us_void_param) 16)) 66)) (= (to_rep (select (temp___String_Literal_2651 us_void_param) 17)) 97)) (= (to_rep (select (temp___String_Literal_2651 us_void_param) 18)) 100)) :pattern ((temp___String_Literal_2651 us_void_param)))))
(declare-fun temp___String_Literal_2656 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2656 us_void_param) 1)) 73) (= (to_rep (select (temp___String_Literal_2656 us_void_param) 2)) 68)) (= (to_rep (select (temp___String_Literal_2656 us_void_param) 3)) 32)) (= (to_rep (select (temp___String_Literal_2656 us_void_param) 4)) 67)) (= (to_rep (select (temp___String_Literal_2656 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_2656 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_2656 us_void_param) 7)) 116)) (= (to_rep (select (temp___String_Literal_2656 us_void_param) 8)) 105)) (= (to_rep (select (temp___String_Literal_2656 us_void_param) 9)) 102)) (= (to_rep (select (temp___String_Literal_2656 us_void_param) 10)) 105)) (= (to_rep (select (temp___String_Literal_2656 us_void_param) 11)) 99)) (= (to_rep (select (temp___String_Literal_2656 us_void_param) 12)) 97)) (= (to_rep (select (temp___String_Literal_2656 us_void_param) 13)) 116)) (= (to_rep (select (temp___String_Literal_2656 us_void_param) 14)) 101)) (= (to_rep (select (temp___String_Literal_2656 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_2656 us_void_param) 16)) 78)) (= (to_rep (select (temp___String_Literal_2656 us_void_param) 17)) 111)) (= (to_rep (select (temp___String_Literal_2656 us_void_param) 18)) 116)) (= (to_rep (select (temp___String_Literal_2656 us_void_param) 19)) 32)) (= (to_rep (select (temp___String_Literal_2656 us_void_param) 20)) 86)) (= (to_rep (select (temp___String_Literal_2656 us_void_param) 21)) 101)) (= (to_rep (select (temp___String_Literal_2656 us_void_param) 22)) 114)) (= (to_rep (select (temp___String_Literal_2656 us_void_param) 23)) 105)) (= (to_rep (select (temp___String_Literal_2656 us_void_param) 24)) 102)) (= (to_rep (select (temp___String_Literal_2656 us_void_param) 25)) 105)) (= (to_rep (select (temp___String_Literal_2656 us_void_param) 26)) 97)) (= (to_rep (select (temp___String_Literal_2656 us_void_param) 27)) 98)) (= (to_rep (select (temp___String_Literal_2656 us_void_param) 28)) 108)) (= (to_rep (select (temp___String_Literal_2656 us_void_param) 29)) 101)) :pattern ((temp___String_Literal_2656 us_void_param)))))
(declare-fun temp___String_Literal_2661 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2661 us_void_param) 1)) 73) (= (to_rep (select (temp___String_Literal_2661 us_void_param) 2)) 68)) (= (to_rep (select (temp___String_Literal_2661 us_void_param) 3)) 32)) (= (to_rep (select (temp___String_Literal_2661 us_void_param) 4)) 67)) (= (to_rep (select (temp___String_Literal_2661 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_2661 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_2661 us_void_param) 7)) 116)) (= (to_rep (select (temp___String_Literal_2661 us_void_param) 8)) 105)) (= (to_rep (select (temp___String_Literal_2661 us_void_param) 9)) 102)) (= (to_rep (select (temp___String_Literal_2661 us_void_param) 10)) 105)) (= (to_rep (select (temp___String_Literal_2661 us_void_param) 11)) 99)) (= (to_rep (select (temp___String_Literal_2661 us_void_param) 12)) 97)) (= (to_rep (select (temp___String_Literal_2661 us_void_param) 13)) 116)) (= (to_rep (select (temp___String_Literal_2661 us_void_param) 14)) 101)) (= (to_rep (select (temp___String_Literal_2661 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_2661 us_void_param) 16)) 78)) (= (to_rep (select (temp___String_Literal_2661 us_void_param) 17)) 111)) (= (to_rep (select (temp___String_Literal_2661 us_void_param) 18)) 116)) (= (to_rep (select (temp___String_Literal_2661 us_void_param) 19)) 32)) (= (to_rep (select (temp___String_Literal_2661 us_void_param) 20)) 67)) (= (to_rep (select (temp___String_Literal_2661 us_void_param) 21)) 117)) (= (to_rep (select (temp___String_Literal_2661 us_void_param) 22)) 114)) (= (to_rep (select (temp___String_Literal_2661 us_void_param) 23)) 114)) (= (to_rep (select (temp___String_Literal_2661 us_void_param) 24)) 101)) (= (to_rep (select (temp___String_Literal_2661 us_void_param) 25)) 110)) (= (to_rep (select (temp___String_Literal_2661 us_void_param) 26)) 116)) :pattern ((temp___String_Literal_2661 us_void_param)))))
...
(define-fun dynamic_invariant1 ((temp___expr_2180 Int) (temp___is_init_2177 Bool) (temp___skip_constant_2178 Bool) (temp___do_toplevel_2179 Bool)) Bool (=> (or (= temp___is_init_2177 true) (<= 0 3)) (in_range13 temp___expr_2180)))
(define-fun dynamic_invariant2 ((temp___expr_536 Int) (temp___is_init_533 Bool) (temp___skip_constant_534 Bool) (temp___do_toplevel_535 Bool)) Bool (=> (or (= temp___is_init_533 true) (<= 1 150)) (in_range2 temp___expr_536)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(define-fun dynamic_invariant3 ((temp___expr_578 Int) (temp___is_init_575 Bool) (temp___skip_constant_576 Bool) (temp___do_toplevel_577 Bool)) Bool (=> (or (= temp___is_init_575 true) (<= 1901 2099)) (in_range3 temp___expr_578)))
(define-fun dynamic_invariant4 ((temp___expr_584 Int) (temp___is_init_581 Bool) (temp___skip_constant_582 Bool) (temp___do_toplevel_583 Bool)) Bool (=> (or (= temp___is_init_581 true) (<= 1 12)) (in_range4 temp___expr_584)))
(define-fun dynamic_invariant5 ((temp___expr_590 Int) (temp___is_init_587 Bool) (temp___skip_constant_588 Bool) (temp___do_toplevel_589 Bool)) Bool (=> (or (= temp___is_init_587 true) (<= 1 31)) (in_range5 temp___expr_590)))
(define-fun dynamic_invariant6 ((temp___expr_614 Int) (temp___is_init_611 Bool) (temp___skip_constant_612 Bool) (temp___do_toplevel_613 Bool)) Bool (=> (or (= temp___is_init_611 true) (<= 0 86399999)) (in_range6 temp___expr_614)))
(define-fun dynamic_invariant7 ((temp___expr_319 Int) (temp___is_init_316 Bool) (temp___skip_constant_317 Bool) (temp___do_toplevel_318 Bool)) Bool (=> (or (= temp___is_init_316 true) (<= 0 40)) (in_range8 temp___expr_319)))
(define-fun dynamic_invariant8 ((temp___expr_340 Int) (temp___is_init_337 Bool) (temp___skip_constant_338 Bool) (temp___do_toplevel_339 Bool)) Bool (=> (or (= temp___is_init_337 true) (<= 0 4294967295)) (in_range9 temp___expr_340)))
(define-fun dynamic_invariant9 ((temp___expr_362 Int) (temp___is_init_359 Bool) (temp___skip_constant_360 Bool) (temp___do_toplevel_361 Bool)) Bool (=> (or (= temp___is_init_359 true) (<= 0 10)) (in_range7 temp___expr_362)))
(define-fun dynamic_invariant10 ((temp___expr_374 Int) (temp___is_init_371 Bool) (temp___skip_constant_372 Bool) (temp___do_toplevel_373 Bool)) Bool (=> (or (= temp___is_init_371 true) (<= 0 4294967295)) (in_range11 temp___expr_374)))
(define-fun dynamic_invariant11 ((temp___expr_380 Int) (temp___is_init_377 Bool) (temp___skip_constant_378 Bool) (temp___do_toplevel_379 Bool)) Bool (=> (or (= temp___is_init_377 true) (<= 0 128)) (in_range12 temp___expr_380)))
(define-fun dynamic_invariant12 ((temp___expr_465 Int) (temp___is_init_462 Bool) (temp___skip_constant_463 Bool) (temp___do_toplevel_464 Bool)) Bool (=> (or (= temp___is_init_462 true) (<= 0 4294967295)) (in_range10 temp___expr_465)))
...
(declare-const temp___2650 us_rep6)
...
(assert (=> (= (rec__usertoken__valididcertt__valid (us_split_fields__content6 idcert__split_fields)) true) (=> (not (= current2 true)) (= temp___2650 (mk___rep6 o3)))))
...
(assert (=> (= (rec__usertoken__valididcertt__valid (us_split_fields__content6 idcert__split_fields)) true) (=> (not (= current2 true)) (= (let ((subject idcert__split_fields)) idcert__split_fields3) (us_split_fields13 temp___2650)))))
(assert (=> (= (rec__usertoken__valididcertt__valid (us_split_fields__content6 idcert__split_fields)) true) (=> (= current2 true) (= (let ((subject idcert__split_fields)) (mk___split_fields__ref6 idcert__split_fields3)) (let ((subject idcert__split_fields)) (mk___split_fields__ref6 idcert__split_fields2))))))
(assert (=> (= (rec__usertoken__valididcertt__valid (us_split_fields__content6 idcert__split_fields)) true) (=> (= current2 true) (= idcert__split_fields3 idcert__split_fields2))))
