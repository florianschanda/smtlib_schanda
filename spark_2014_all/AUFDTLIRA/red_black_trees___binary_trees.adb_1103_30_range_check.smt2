...
(declare-const o14 (Array Int us_rep1))
...
(assert (and (= o13 r1) (in_range2 r1)))
(assert (and (= o14 (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o13)) (and (dynamic_invariant1 o14 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o14 o13))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select o14 o13)))) 0) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= i o13)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select o14 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select o14 i))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select o14 i))) true)))))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o14 i))) true) (not (= i o13))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select o14 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i)))) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i) (rec__tree_model__path_type__a (us_split_fields1 (select o14 i)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select o14 i)))) 0)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select o14 i))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o14 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select o14 i))) (rec__tree_model__path_type__a (us_split_fields1 (select o14 j)))) true)) (= j i))))))))))))))
