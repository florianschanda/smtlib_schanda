...
(assert (and (= o35 r1) (in_range1 r1)))
(assert (and (= o36 (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o35)) (and (dynamic_invariant3 o36 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o36 o35))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select o36 o35)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 o35)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select o36 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select o36 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select o36 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o36 i1))) true) (not (= i1 o35))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select o36 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1)))) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select o36 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select o36 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select o36 i1))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o36 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select o36 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select o36 j1)))) true)) (= j1 i1))))))))))))))
