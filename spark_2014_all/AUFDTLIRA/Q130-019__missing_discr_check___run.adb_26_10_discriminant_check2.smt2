...
(define-fun o12 () us_rep (mk___rep (mk___split_discrs o6) (mk___split_fields o7 o8) o9))
...
(assert (= dummy o4))
(assert (= true o5))
(assert (= o12 (mk___rep (mk___split_discrs o2) (mk___split_fields o3 o4) o5)))
(assert (= temp___2684 o12))
...
(assert (not (= (rec__p_init__t__e (us_split_discrs1 c1)) (rec__p_init__t__e y1__split_discrs1))))
(check-sat)
(exit)
