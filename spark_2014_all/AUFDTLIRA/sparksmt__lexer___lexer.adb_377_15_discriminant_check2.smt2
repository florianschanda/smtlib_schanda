...
(assert (or (= (to_rep4 (rec__file_io__read_result__status current_read__split_discrs1)) 1) (= (to_rep4 (rec__file_io__read_result__status current_read__split_discrs1)) 2)))
(assert (< current_col2 2147483647))
(assert (= (to_rep6 (rec__lexer__token__kind t__split_discrs)) r54b))
(assert (in_range9 r54b))
(assert (and (= o1 (+ current_col2 1)) (in_range1 (+ current_col2 1))))
(assert (= (to_rep2 o2) o1))
(assert (= (to_rep2 o3) current_line2))
(assert (= o4 (mk___split_fields2 o3 o2 rliteral dummy11)))
(assert (= (to_rep6 o) 0))
(assert (= o5 (mk___split_discrs2 o)))
(assert (= temp___920 (mk___rep2 o5 o4 true)))
(assert (= t__attr__constrained true))
(assert (not (= (rec__lexer__token__kind (us_split_discrs5 temp___920)) (rec__lexer__token__kind t__split_discrs))))
(check-sat)
(exit)
