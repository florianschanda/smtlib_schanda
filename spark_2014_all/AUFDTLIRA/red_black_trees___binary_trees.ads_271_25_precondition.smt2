...
(declare-const temp___901 (Array Int us_rep1))
...
(assert (=> (not (= v 0)) (and (= temp___901 (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o43)) (and (dynamic_invariant3 temp___901 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___901 o43))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___901 o43)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 o43)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___901 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___901 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___901 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___901 i1))) true) (not (= i1 o43))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___901 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1)))) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___901 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___901 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___901 i1))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___901 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___901 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___901 j1)))) true)) (= j1 i1)))))))))))))))
(assert (=> (not (= v 0)) (= o44 (select temp___901 j))))
(assert (=> (not (= v 0)) (= o45 (us_split_fields1 o44))))
(assert (=> (not (= v 0)) (= result13 (rec__tree_model__path_type__k o45))))
