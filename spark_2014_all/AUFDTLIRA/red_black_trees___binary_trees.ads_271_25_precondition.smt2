...
(assert (<= 1 j2))
(assert (<= j2 100))
(assert (=> (not (= v 0)) (and (= o84 v) (in_range1 v))))
(assert (=> (not (= v 0)) (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true)))
(assert (=> (not (= v 0)) (and (= o85 v) (in_range1 v))))
(assert (=> (not (= v 0)) (and (= temp___855 (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o85)) (and (dynamic_invariant3 temp___855 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___855 o85))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___855 o85)))) 0) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (not (= i2 o85)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i2) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___855 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i2)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___855 i2))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___855 i2))) true)))))) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___855 i2))) true) (not (= i2 o85))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___855 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i2)))) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i2) (rec__tree_model__path_type__a (us_split_fields1 (select temp___855 i2)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___855 i2)))) 0)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___855 i2))) true) (forall ((j9 Int)) (=> (and (<= 1 j9) (<= j9 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___855 j9))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___855 i2))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___855 j9)))) true)) (= j9 i2)))))))))))))))
(assert (=> (not (= v 0)) (= o86 (select temp___855 j2))))
(assert (=> (not (= v 0)) (= o87 (us_split_fields1 o86))))
(assert (=> (not (= v 0)) (= result20 (rec__tree_model__path_type__k o87))))
(assert (=> (= v 0) (= result20 false)))
