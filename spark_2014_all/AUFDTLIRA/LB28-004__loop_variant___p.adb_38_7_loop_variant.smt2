...
(assert (= j18 o14))
(assert (and (= o15 (+ k10 1)) (in_range1 (+ k10 1))))
(assert (= result17 (mk_int__ref k10)))
(assert (= k11 o15))
(assert (and (=> (<= (- 2147483648) 2147483647) (in_range1 j19)) (=> (<= (- 2147483648) 2147483647) (in_range1 k12))))
(assert (= result18 (mk_int__ref temp___185)))
(assert (= temp___1851 j19))
(assert (= result19 (mk_int__ref temp___186)))
(assert (= temp___1861 k12))
(assert (<= j19 b))
(assert (= (to_rep o16) j19))
(assert (and (<= (to_rep tab__first) j19) (<= j19 (to_rep tab__last))))
(assert (= o17 j19))
(assert (= o18 (store tab15 o17 o16)))
(assert (= result20 (mk_map__ref tab15)))
(assert (= tab16 o18))
(assert (and (= o19 (+ j19 1)) (in_range1 (+ j19 1))))
(assert (= result21 (mk_int__ref j19)))
(assert (= j20 o19))
(assert (and (= o20 (+ k12 1)) (in_range1 (+ k12 1))))
(assert (= result22 (mk_int__ref k12)))
(assert (= k13 o20))
(assert (not (< temp___1851 j20)))
(check-sat)
(exit)
