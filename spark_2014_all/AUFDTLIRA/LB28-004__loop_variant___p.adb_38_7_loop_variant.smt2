...
(assert (= k13 0))
(assert (<= j21 b))
(assert (= (to_rep o21) j21))
(assert (and (<= (to_rep tab__first) j21) (<= j21 (to_rep tab__last))))
(assert (= o22 j21))
(assert (= o23 (store (map__content tab14) o22 o21)))
(assert (= result20 tab14))
(assert (= tab16 o23))
(assert (and (= o24 (+ j21 1)) (in_range1 (+ j21 1))))
(assert (= result21 (mk_int__ref j21)))
(assert (= j22 o24))
(assert (and (= o25 (+ k13 1)) (in_range1 (+ k13 1))))
(assert (= result22 (mk_int__ref k13)))
(assert (= k14 o25))
(assert (and (=> (<= (- 2147483648) 2147483647) (in_range1 j23)) (=> (<= (- 2147483648) 2147483647) (in_range1 k15))))
(assert (= result23 (mk_int__ref temp___1621)))
(assert (= temp___1622 j23))
(assert (= result24 (mk_int__ref temp___1631)))
(assert (= temp___1632 k15))
(assert (<= j23 b))
(assert (= (to_rep o26) j23))
(assert (and (<= (to_rep tab__first) j23) (<= j23 (to_rep tab__last))))
(assert (= o27 j23))
(assert (= o28 (store tab17 o27 o26)))
(assert (= result25 (mk_map__ref tab17)))
(assert (= tab18 o28))
(assert (and (= o29 (+ j23 1)) (in_range1 (+ j23 1))))
(assert (= result26 (mk_int__ref j23)))
(assert (= j24 o29))
(assert (and (= o30 (+ k15 1)) (in_range1 (+ k15 1))))
(assert (= result27 (mk_int__ref k15)))
(assert (= k16 o30))
(assert (not (< temp___1622 j24)))
(check-sat)
(exit)
