...
(assert (forall ((s us_rep1)) (! (dynamic_invariant4 (last2 s) true false true true) :pattern ((last2 s)))))
(assert (forall ((attr__tag2 Int)) (forall ((s us_rep1)) (! (dynamic_invariant4 (last3 attr__tag2 s) true false true true) :pattern ((last3 attr__tag2 s))))))
...
(assert (in_range2 e))
(assert (=> (<= (to_rep (first (rt (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag))))) (to_rep (last (rt (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag)))))) (= o (+ (- (to_rep (last (rt (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag))))) (to_rep (first (rt (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag)))))) 1))))
(assert (=> (not (<= (to_rep (first (rt (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag))))) (to_rep (last (rt (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag))))))) (= o 0)))
(assert (= o1 (+ 1 o)))
(assert (= o2 (+ 1 o1)))
(assert (= o3 (- o2 1)))
