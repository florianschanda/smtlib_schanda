...
(assert (= (= result29 true) (forall ((i7 Int)) (=> (and (<= 1 i7) (<= i7 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) root) i7))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root) i7))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) root) i7)))) true))))))
(assert (= result29 true))
(assert (<= 1 r1))
(assert (<= r1 (to_rep f_old__split_fields)))
(assert (and (<= 1 r1) (<= r1 100)))
(assert (= o103 r1))
(assert (= o104 (select f_old__split_fields1 o103)))
(assert (= o105 (us_split_fields3 o104)))
(assert (= o106 (rec__binary_trees__cell__position o105)))
(assert (= o107 (to_rep1 o106)))
(assert (= o108 (ite (= o107 2) true false)))
(assert (= o109 (ite (not (= r1 root)) o108 false)))
(assert (= result31 (ite (= o109 true) (ite (not (= r1 v)) true false) false)))
(assert (= result31 true))
(assert (and (= o112 r1) (in_range1 r1)))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o113 r1) (in_range1 r1)))
(assert (and (= o114 (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o113)) (and (dynamic_invariant3 o114 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o114 o113))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select o114 o113)))) 0) (and (forall ((i7 Int)) (=> (and (<= 1 i7) (<= i7 100)) (=> (not (= i7 o113)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i7) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select o114 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i7)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select o114 i7))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select o114 i7))) true)))))) (and (forall ((i7 Int)) (=> (and (<= 1 i7) (<= i7 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o114 i7))) true) (not (= i7 o113))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select o114 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i7)))) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i7) (rec__tree_model__path_type__a (us_split_fields1 (select o114 i7)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select o114 i7)))) 0)))) (forall ((i7 Int)) (=> (and (<= 1 i7) (<= i7 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select o114 i7))) true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o114 j2))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select o114 i7))) (rec__tree_model__path_type__a (us_split_fields1 (select o114 j2)))) true)) (= j2 i7))))))))))))))
(assert (and (= o110 r1) (in_range1 r1)))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))) true))
(assert (and (= o111 r1) (in_range1 r1)))
(assert (not (= (valid_root (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) o111) true)))
(check-sat)
(exit)
