...
(assert (forall ((temp___493 Int)) (forall ((temp___494 Int)) (= (select (pack__a4__my_s4__aggregate_def temp___493) temp___494) (of_rep temp___493)))))
...
(assert (forall ((temp___496 Int)) (ite (and (<= 1 temp___496) (<= temp___496 4)) (= (select o temp___496) (select g temp___496)) (= (select o temp___496) (select my_s41 temp___496)))))
