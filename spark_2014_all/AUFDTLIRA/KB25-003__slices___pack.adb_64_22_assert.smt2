...
(assert (forall ((i tTmy_s4SP1)) (and (<= 1 (tTmy_s4SP1qtint i)) (<= (tTmy_s4SP1qtint i) 4))))
(define-fun in_range3 ((x Int)) Bool (and (<= 1 x) (<= x 4)))
(declare-fun attr__ATTRIBUTE_IMAGE3 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check3 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE3 (us_image) Int)
(declare-fun user_eq4 (tTmy_s4SP1 tTmy_s4SP1) Bool)
(declare-const dummy4 tTmy_s4SP1)
(declare-datatypes () ((tTmy_s4SP1__ref (mk_tTmy_s4SP1__ref (tTmy_s4SP1__content tTmy_s4SP1)))))
(define-fun tTmy_s4SP1__ref___projection ((a tTmy_s4SP1__ref)) tTmy_s4SP1 (tTmy_s4SP1__content a))
...
(assert (forall ((temp___536 Int)) (=> (dynamic_invariant1 temp___536 true true true true) (forall ((temp___537 Int)) (= (to_rep (select (pack__a4__my_s4__aggregate_def temp___536) temp___537)) temp___536)))))
(declare-const g (Array Int character))
(declare-const my_s4 (Array Int character))
(declare-const o (Array Int character))
(declare-const result (Array Int character))
(declare-const my_s41 (Array Int character))
(declare-const result1 (Array Int character))
(declare-const my_s42 (Array Int character))
...
(assert (forall ((temp___539 Int)) (ite (and (<= 1 temp___539) (<= temp___539 4)) (= (select o temp___539) (select g temp___539)) (= (select o temp___539) (select my_s41 temp___539)))))
(assert (= result1 my_s41))
(assert (= my_s42 o))
(assert (not (= (to_rep (select my_s42 2)) (to_rep (select g 2)))))
(check-sat)
(exit)
