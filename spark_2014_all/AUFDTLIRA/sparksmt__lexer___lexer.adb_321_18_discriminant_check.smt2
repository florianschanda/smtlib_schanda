...
(assert (= (to_rep3 o33) n1))
(assert (= (to_rep o34) t_length))
(assert (= (to_rep o35) first_col))
(assert (= (to_rep o36) first_line))
(assert (= o37 (mk___split_fields o36 o35 o34 o33)))
(assert (= (to_rep4 o32) 7))
(assert (= o38 (mk___split_discrs o32)))
(assert (= temp___953 (mk___rep o38 o37 true)))
(assert (= t__attr__constrained true))
(assert (not (= (rec__lexer__token__kind (us_split_discrs1 temp___953)) t__split_discrs)))
(check-sat)
(exit)
