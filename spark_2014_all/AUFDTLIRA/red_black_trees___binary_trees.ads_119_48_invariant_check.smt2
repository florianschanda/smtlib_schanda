...
(assert (= n1 1))
(assert (=> (and (<= 1 n1) (<= n1 100)) (= temp___726 n1)))
(assert (=> (and (<= 1 n1) (<= n1 100)) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f t1) i1))) true) (< (length (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f t1) i1)))) n2)) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f t2) i1))) true)))))))
(assert (=> (and (<= 1 n1) (<= n1 100)) (and (=> (<= 1 100) (in_range4 n2)) (and (<= 1 n2) (<= n2 100)))))
