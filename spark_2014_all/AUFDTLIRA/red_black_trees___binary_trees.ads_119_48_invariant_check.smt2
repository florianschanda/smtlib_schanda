...
(assert (=> (and (<= 1 n1) (<= n1 100)) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f t1) i1))) true) (< (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f t1) i1)))) n2)) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f t2) i1))) true)))))))
