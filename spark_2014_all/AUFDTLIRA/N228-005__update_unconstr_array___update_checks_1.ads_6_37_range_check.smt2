...
(assert (forall ((temp___216 us_t)) (forall ((temp___217 Int) (temp___218 Int)) (let ((temp___215 (temp___214 temp___216 temp___217 temp___218))) (and (and (= (first1 temp___215) (first1 temp___216)) (= (last1 temp___215) (last1 temp___216))) (forall ((temp___219 Int)) (ite (= temp___219 temp___217) (= (select (to_array temp___215) temp___219) (of_rep1 temp___218)) (= (select (to_array temp___215) temp___219) (select (to_array temp___216) temp___219)))))))))
(declare-fun temp___375 (us_t Int Int) us_t)
(assert (forall ((temp___377 us_t)) (forall ((temp___378 Int) (temp___379 Int)) (let ((temp___376 (temp___375 temp___377 temp___378 temp___379))) (and (and (= (first1 temp___376) (first1 temp___377)) (= (last1 temp___376) (last1 temp___377))) (forall ((temp___380 Int)) (ite (= temp___380 temp___378) (= (select (to_array temp___376) temp___380) (of_rep1 temp___379)) (= (select (to_array temp___376) temp___380) (select (to_array temp___377) temp___380)))))))))
...
(assert (= o i))
(assert (= (mk___t temp___381 temp___3811) (temp___375 (mk___t a (mk (to_rep a__first) (to_rep a__last))) o new_val)))
(assert (= (ite (<= (to_rep (first temp___3811)) (to_rep (last temp___3811))) (+ (- (to_rep (last temp___3811)) (to_rep (first temp___3811))) 1) 0) (ite (<= (to_rep a__first) (to_rep a__last)) (+ (- (to_rep a__last) (to_rep a__first)) 1) 0)))
(assert (= (mk___t temp___382 temp___3821) (mk___t temp___381 temp___3811)))
(assert (= o1 (slide temp___382 (to_rep (first temp___3821)) (to_rep a__first))))
