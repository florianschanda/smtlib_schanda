...
(declare-const g21_id Int)
(assert (<= 1 g21_id))
(assert (<= g21_id 64))
(declare-const g22_id Int)
(assert (<= 1 g22_id))
(assert (<= g22_id 64))
(assert (not (= (select unmatched_g2_set2 g21_id) true)))
(assert (not (= (select unmatched_g2_set2 g22_id) true)))
(assert (not (= g21_id g22_id)))
(assert (not (not (= (to_rep (select result__2 g21_id)) (to_rep (select result__2 g22_id))))))
(check-sat)
(exit)
