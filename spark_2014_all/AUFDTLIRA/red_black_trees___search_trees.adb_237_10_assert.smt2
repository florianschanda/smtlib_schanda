...
(assert (not (= (get (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) j13))) (+ (length (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) k)))) 1)) 0)))
