...
(assert (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) k))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) j13)))) true))
(assert (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) j13))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) k)))) 1)) 0))
