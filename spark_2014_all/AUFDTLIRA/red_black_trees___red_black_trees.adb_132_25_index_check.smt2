...
(assert (<= 1 j3))
(assert (<= j3 (- i6 1)))
(assert (and (<= 0 j3) (<= j3 100)))
(assert (= o81 j3))
(assert (= o82 (select res3 o81)))
(assert (= o83 (us_split_fields11 o82)))
(assert (= o84 (rec__red_black_trees__black_count__depth o83)))
(assert (= o85 (to_rep o84)))
(assert (= o86 (ite (< (+ n2 1) o85) true false)))
(assert (not (<= 1 j3)))
(check-sat)
(exit)
