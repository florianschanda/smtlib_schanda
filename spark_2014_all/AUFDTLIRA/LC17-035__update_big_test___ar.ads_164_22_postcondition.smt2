...
(declare-fun temp___588 ((Array Int et1) Int Int Int Int) (Array Int et1))
(assert (forall ((temp___590 (Array Int et1))) (forall ((temp___591 Int) (temp___592 Int) (temp___593 Int) (temp___594 Int)) (let ((temp___589 (temp___588 temp___590 temp___591 temp___592 temp___593 temp___594))) (forall ((temp___595 Int)) (ite (= temp___595 temp___593) (= (select temp___589 temp___595) (of_rep temp___594)) (ite (= temp___595 temp___591) (= (select temp___589 temp___595) (of_rep temp___592)) (= (select temp___589 temp___595) (select temp___590 temp___595)))))))))
...
(assert (= a2 a3))
(assert (= a4 a2))
(assert (not (= (bool_eq a3 1 10 (temp___588 a i e j f) 1 10) true)))
(check-sat)
(exit)
