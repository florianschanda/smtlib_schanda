...
(declare-fun temp_____aggregate_def_647 ((Array Int et1) Int Int Int Int) (Array Int et1))
(assert (forall ((temp___649 (Array Int et1))) (forall ((temp___650 Int) (temp___651 Int) (temp___652 Int) (temp___653 Int)) (let ((temp___648 (temp_____aggregate_def_647 temp___649 temp___650 temp___651 temp___652 temp___653))) (=> (and (and (and (dynamic_invariant temp___650 true true true true) (dynamic_invariant1 temp___651 true true true true)) (dynamic_invariant temp___652 true true true true)) (dynamic_invariant1 temp___653 true true true true)) (forall ((temp___654 Int)) (ite (= temp___654 temp___652) (= (to_rep (select temp___648 temp___654)) temp___653) (ite (= temp___654 temp___650) (= (to_rep (select temp___648 temp___654)) temp___651) (= (select temp___648 temp___654) (select temp___649 temp___654))))))))))
...
(assert (= a2 a3))
(assert (= a4 a2))
(assert (not (= (bool_eq a3 1 10 (temp_____aggregate_def_647 a i e j f) 1 10) true)))
(check-sat)
(exit)
