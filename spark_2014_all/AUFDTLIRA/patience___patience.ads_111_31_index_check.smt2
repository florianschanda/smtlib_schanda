...
(declare-const temp___449 (Array Int cardindex))
(declare-const o65 Int)
(declare-const temp___451 (Array Int cardindex))
...
(declare-const temp___389 (Array Int cardindex))
(declare-const o121 Int)
(declare-const temp___391 (Array Int cardindex))
(declare-const o122 Int)
(declare-const o123 cardindex)
...
(assert (=> (and (and (and (<= 0 (to_rep1 (rec__patience__state__numstacks (us_split_fields1 s)))) (<= (to_rep1 (rec__patience__state__numstacks (us_split_fields1 s))) (to_rep1 (rec__patience__state__numelts (us_split_fields1 s))))) (<= (to_rep1 (rec__patience__state__numelts (us_split_fields1 s))) 100)) (or (= (to_rep1 (rec__patience__state__numelts (us_split_fields1 s))) 0) (< 0 (to_rep1 (rec__patience__state__numstacks (us_split_fields1 s)))))) (= (= result4 true) (forall ((i5 Int)) (=> (and (<= 0 i5) (<= i5 (- (to_rep1 (rec__patience__state__numstacks (us_split_fields1 s))) 1))) (and (and (<= 1 (to_rep1 (select (rec__patience__state__stacksizes (us_split_fields1 s)) i5))) (<= (to_rep1 (select (rec__patience__state__stacksizes (us_split_fields1 s)) i5)) (to_rep1 (rec__patience__state__numelts (us_split_fields1 s))))) (forall ((j3 Int)) (=> (and (<= 0 j3) (<= j3 (- (to_rep1 (select (rec__patience__state__stacksizes (us_split_fields1 s)) i5)) 1))) (and (<= 0 (to_rep1 (select (select (rec__patience__state__stacks (us_split_fields1 s)) i5) j3))) (< (to_rep1 (select (select (rec__patience__state__stacks (us_split_fields1 s)) i5) j3)) (to_rep1 (rec__patience__state__numelts (us_split_fields1 s)))))))))))))
(assert (=> (not (and (and (and (<= 0 (to_rep1 (rec__patience__state__numstacks (us_split_fields1 s)))) (<= (to_rep1 (rec__patience__state__numstacks (us_split_fields1 s))) (to_rep1 (rec__patience__state__numelts (us_split_fields1 s))))) (<= (to_rep1 (rec__patience__state__numelts (us_split_fields1 s))) 100)) (or (= (to_rep1 (rec__patience__state__numelts (us_split_fields1 s))) 0) (< 0 (to_rep1 (rec__patience__state__numstacks (us_split_fields1 s))))))) (= result4 false)))
(assert (=> (= result4 true) (= (= result3 true) (forall ((i5 Int)) (=> (and (<= 0 i5) (<= i5 (- (to_rep1 (rec__patience__state__numelts (us_split_fields1 s))) 1))) (and (and (and (<= 0 (to_rep1 (select (rec__patience__state__posstack (us_split_fields1 s)) i5))) (<= (to_rep1 (select (rec__patience__state__posstack (us_split_fields1 s)) i5)) (- (to_rep1 (rec__patience__state__numstacks (us_split_fields1 s))) 1))) (and (<= 0 (to_rep1 (select (rec__patience__state__posheight (us_split_fields1 s)) i5))) (<= (to_rep1 (select (rec__patience__state__posheight (us_split_fields1 s)) i5)) (- (to_rep1 (select (rec__patience__state__stacksizes (us_split_fields1 s)) (to_rep1 (select (rec__patience__state__posstack (us_split_fields1 s)) i5)))) 1)))) (= (to_rep1 (select (select (rec__patience__state__stacks (us_split_fields1 s)) (to_rep1 (select (rec__patience__state__posstack (us_split_fields1 s)) i5))) (to_rep1 (select (rec__patience__state__posheight (us_split_fields1 s)) i5)))) i5)))))))
(assert (=> (not (= result4 true)) (= result3 false)))
(assert (=> (= result3 true) (= (= result2 true) (forall ((ist1 Int)) (=> (and (<= 0 ist1) (<= ist1 (- (to_rep1 (rec__patience__state__numstacks (us_split_fields1 s))) 1))) (forall ((ip1 Int)) (=> (and (<= 0 ip1) (<= ip1 (- (to_rep1 (select (rec__patience__state__stacksizes (us_split_fields1 s)) ist1)) 1))) (and (= ist1 (to_rep1 (select (rec__patience__state__posstack (us_split_fields1 s)) (to_rep1 (select (select (rec__patience__state__stacks (us_split_fields1 s)) ist1) ip1))))) (= ip1 (to_rep1 (select (rec__patience__state__posheight (us_split_fields1 s)) (to_rep1 (select (select (rec__patience__state__stacks (us_split_fields1 s)) ist1) ip1)))))))))))))
(assert (=> (not (= result3 true)) (= result2 false)))
(assert (=> (= result2 true) (= (= result1 true) (forall ((i5 Int)) (=> (and (<= 0 i5) (<= i5 (- (to_rep1 (rec__patience__state__numstacks (us_split_fields1 s))) 1))) (forall ((j3 Int)) (=> (and (<= 0 j3) (<= j3 (- (to_rep1 (select (rec__patience__state__stacksizes (us_split_fields1 s)) i5)) 2))) (forall ((k2 Int)) (=> (and (<= (+ j3 1) k2) (<= k2 (- (to_rep1 (select (rec__patience__state__stacksizes (us_split_fields1 s)) i5)) 1))) (< (to_rep1 (select (select (rec__patience__state__stacks (us_split_fields1 s)) i5) j3)) (to_rep1 (select (select (rec__patience__state__stacks (us_split_fields1 s)) i5) k2))))))))))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (=> (= result1 true) (= (= result true) (forall ((i5 Int)) (=> (and (<= 0 i5) (<= i5 (- (to_rep1 (rec__patience__state__numstacks (us_split_fields1 s))) 1))) (forall ((j3 Int)) (=> (and (<= 0 j3) (<= j3 (- (to_rep1 (select (rec__patience__state__stacksizes (us_split_fields1 s)) i5)) 2))) (forall ((k2 Int)) (=> (and (<= (+ j3 1) k2) (<= k2 (- (to_rep1 (select (rec__patience__state__stacksizes (us_split_fields1 s)) i5)) 1))) (<= (to_rep (select (rec__patience__state__values (us_split_fields1 s)) (to_rep1 (select (select (rec__patience__state__stacks (us_split_fields1 s)) i5) k2)))) (to_rep (select (rec__patience__state__values (us_split_fields1 s)) (to_rep1 (select (select (rec__patience__state__stacks (us_split_fields1 s)) i5) j3))))))))))))))
...
(assert (= result14 (ite (= o30 true) o29 false)))
(assert (=> (= result14 true) (and (<= 0 i) (<= i 99))))
(assert (=> (= result14 true) (= o20 i)))
(assert (=> (= result14 true) (= o21 (select (rec__patience__state__preds (us_split_fields1 s)) o20))))
(assert (=> (= result14 true) (= o22 (to_rep1 o21))))
(assert (=> (= result14 true) (= result13 (ite (< o22 i) true false))))
...
(assert (= result15 (ite (< o2 0) true false)))
