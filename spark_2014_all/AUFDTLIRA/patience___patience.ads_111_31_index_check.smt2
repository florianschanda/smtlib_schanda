...
(assert (=> (and (and (and (<= 0 (to_rep (rec__patience__state__numstacks (us_split_fields1 s)))) (<= (to_rep (rec__patience__state__numstacks (us_split_fields1 s))) (to_rep (rec__patience__state__numelts (us_split_fields1 s))))) (<= (to_rep (rec__patience__state__numelts (us_split_fields1 s))) 100)) (or (= (to_rep (rec__patience__state__numelts (us_split_fields1 s))) 0) (< 0 (to_rep (rec__patience__state__numstacks (us_split_fields1 s)))))) (= (= result4 true) (forall ((i1 Int)) (=> (and (<= 0 i1) (<= i1 (- (to_rep (rec__patience__state__numstacks (us_split_fields1 s))) 1))) (and (and (<= 1 (to_rep (select (rec__patience__state__stacksizes (us_split_fields1 s)) i1))) (<= (to_rep (select (rec__patience__state__stacksizes (us_split_fields1 s)) i1)) (to_rep (rec__patience__state__numelts (us_split_fields1 s))))) (forall ((j Int)) (=> (and (<= 0 j) (<= j (- (to_rep (select (rec__patience__state__stacksizes (us_split_fields1 s)) i1)) 1))) (and (<= 0 (to_rep (select (select (rec__patience__state__stacks (us_split_fields1 s)) i1) j))) (< (to_rep (select (select (rec__patience__state__stacks (us_split_fields1 s)) i1) j)) (to_rep (rec__patience__state__numelts (us_split_fields1 s)))))))))))))
(assert (=> (not (and (and (and (<= 0 (to_rep (rec__patience__state__numstacks (us_split_fields1 s)))) (<= (to_rep (rec__patience__state__numstacks (us_split_fields1 s))) (to_rep (rec__patience__state__numelts (us_split_fields1 s))))) (<= (to_rep (rec__patience__state__numelts (us_split_fields1 s))) 100)) (or (= (to_rep (rec__patience__state__numelts (us_split_fields1 s))) 0) (< 0 (to_rep (rec__patience__state__numstacks (us_split_fields1 s))))))) (= result4 false)))
(assert (=> (= result4 true) (= (= result3 true) (forall ((i1 Int)) (=> (and (<= 0 i1) (<= i1 (- (to_rep (rec__patience__state__numelts (us_split_fields1 s))) 1))) (and (and (and (<= 0 (to_rep (select (rec__patience__state__posstack (us_split_fields1 s)) i1))) (<= (to_rep (select (rec__patience__state__posstack (us_split_fields1 s)) i1)) (- (to_rep (rec__patience__state__numstacks (us_split_fields1 s))) 1))) (and (<= 0 (to_rep (select (rec__patience__state__posheight (us_split_fields1 s)) i1))) (<= (to_rep (select (rec__patience__state__posheight (us_split_fields1 s)) i1)) (- (to_rep (select (rec__patience__state__stacksizes (us_split_fields1 s)) (to_rep (select (rec__patience__state__posstack (us_split_fields1 s)) i1)))) 1)))) (= (to_rep (select (select (rec__patience__state__stacks (us_split_fields1 s)) (to_rep (select (rec__patience__state__posstack (us_split_fields1 s)) i1))) (to_rep (select (rec__patience__state__posheight (us_split_fields1 s)) i1)))) i1)))))))
(assert (=> (not (= result4 true)) (= result3 false)))
(assert (=> (= result3 true) (= (= result2 true) (forall ((ist Int)) (=> (and (<= 0 ist) (<= ist (- (to_rep (rec__patience__state__numstacks (us_split_fields1 s))) 1))) (forall ((ip Int)) (=> (and (<= 0 ip) (<= ip (- (to_rep (select (rec__patience__state__stacksizes (us_split_fields1 s)) ist)) 1))) (and (= ist (to_rep (select (rec__patience__state__posstack (us_split_fields1 s)) (to_rep (select (select (rec__patience__state__stacks (us_split_fields1 s)) ist) ip))))) (= ip (to_rep (select (rec__patience__state__posheight (us_split_fields1 s)) (to_rep (select (select (rec__patience__state__stacks (us_split_fields1 s)) ist) ip)))))))))))))
(assert (=> (not (= result3 true)) (= result2 false)))
(assert (=> (= result2 true) (= (= result1 true) (forall ((i1 Int)) (=> (and (<= 0 i1) (<= i1 (- (to_rep (rec__patience__state__numstacks (us_split_fields1 s))) 1))) (forall ((j Int)) (=> (and (<= 0 j) (<= j (- (to_rep (select (rec__patience__state__stacksizes (us_split_fields1 s)) i1)) 2))) (forall ((k Int)) (=> (and (<= (+ j 1) k) (<= k (- (to_rep (select (rec__patience__state__stacksizes (us_split_fields1 s)) i1)) 1))) (< (to_rep (select (select (rec__patience__state__stacks (us_split_fields1 s)) i1) j)) (to_rep (select (select (rec__patience__state__stacks (us_split_fields1 s)) i1) k))))))))))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (=> (= result1 true) (= (= result true) (forall ((i1 Int)) (=> (and (<= 0 i1) (<= i1 (- (to_rep (rec__patience__state__numstacks (us_split_fields1 s))) 1))) (forall ((j Int)) (=> (and (<= 0 j) (<= j (- (to_rep (select (rec__patience__state__stacksizes (us_split_fields1 s)) i1)) 2))) (forall ((k Int)) (=> (and (<= (+ j 1) k) (<= k (- (to_rep (select (rec__patience__state__stacksizes (us_split_fields1 s)) i1)) 1))) (<= (to_rep1 (select (rec__patience__state__values (us_split_fields1 s)) (to_rep (select (select (rec__patience__state__stacks (us_split_fields1 s)) i1) k)))) (to_rep1 (select (rec__patience__state__values (us_split_fields1 s)) (to_rep (select (select (rec__patience__state__stacks (us_split_fields1 s)) i1) j))))))))))))))
(assert (=> (not (= result1 true)) (= result false)))
(assert (= result true))
(assert (<= 0 i))
(assert (<= i (- (to_rep (rec__patience__state__numelts (us_split_fields1 s))) 1)))
(assert (and (<= 0 i) (<= i 99)))
(assert (= o12 i))
(assert (= o13 (select (rec__patience__state__preds (us_split_fields1 s)) o12)))
(assert (= o14 (to_rep o13)))
(assert (= o15 (ite (<= o14 (- (to_rep (rec__patience__state__numelts (us_split_fields1 s))) 1)) true false)))
(assert (and (<= 0 i) (<= i 99)))
(assert (= o9 i))
(assert (= o10 (select (rec__patience__state__preds (us_split_fields1 s)) o9)))
(assert (= o11 (to_rep o10)))
(assert (= o16 (ite (<= (- 1) o11) true false)))
(assert (= result6 (ite (= o16 true) o15 false)))
(assert (=> (= result6 true) (and (<= 0 i) (<= i 99))))
(assert (=> (= result6 true) (= o6 i)))
(assert (=> (= result6 true) (= o7 (select (rec__patience__state__preds (us_split_fields1 s)) o6))))
(assert (=> (= result6 true) (= o8 (to_rep o7))))
(assert (=> (= result6 true) (= result5 (ite (< o8 i) true false))))
...
(assert (and (<= 0 i) (<= i 99)))
(assert (= o3 i))
(assert (= o4 (select (rec__patience__state__values (us_split_fields1 s)) o3)))
