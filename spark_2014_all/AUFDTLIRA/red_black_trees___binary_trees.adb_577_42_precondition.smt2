...
(assert (= result5 true))
(assert (and (= o43 (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 ki1))))) (in_range4 (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 ki1)))))))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))) true))
...
(assert (= o39 v))
(assert (= o40 (select temp___1280 o39)))
...
(assert (= o36 (select temp___1279 ki1)))
