...
(assert (=> (and (< index1 129) (not (= (to_rep (select name index1)) 0))) (and (< index2 129) (forall ((q1 Int)) (=> (and (<= 1 q1) (<= q1 index2)) (not (= (to_rep (select name q1)) 0)))))))
...
(assert (<= 1 q))
(assert (<= q (- rr_type__wirenamelength__result4 1)))
(assert (not (<= 1 q)))
(check-sat)
(exit)
