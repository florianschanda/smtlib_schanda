...
(assert true)
(assert (= (slide values (to_rep values__first) (to_rep values__first)) temp___293))
(assert (= (mk1 (to_rep values__first) (to_rep values__last)) temp___2931))
(assert (= (to_rep (first2 temp___2931)) 0))
(assert (= (mk___t1 pair_insertion_sort__swap__init__assume pair_insertion_sort__swap__init__assume1) (mk___t1 temp___293 temp___2931)))
(assert (= (mk___t1 pair_insertion_sort__swap__init__assume pair_insertion_sort__swap__init__assume1) init))
