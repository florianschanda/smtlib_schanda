...
(declare-const temp___323 (Array Int integer))
(declare-const temp___3231 t1)
...
(assert (= (slide values (to_rep values__first) (to_rep values__first)) temp___323))
(assert (= (mk1 (to_rep values__first) (to_rep values__last)) temp___3231))
(assert (= (to_rep (first2 temp___3231)) 0))
(assert (= pair_insertion_sort__swap__init__assume2 (mk___t1 temp___323 temp___3231)))
...
(assert (and (<= (to_rep values__first) x) (<= x (to_rep values__last))))
(assert (= o7 x))
(assert (= temp___327 (store values o7 o6)))
(assert (= (to_rep values__first) 0))
(assert (= o8 temp___327))
...
(assert (not (<= (to_rep (first (mk (to_rep (first2 (rt1 init))) (to_rep (last2 (rt1 init)))))) x)))
(check-sat)
(exit)
