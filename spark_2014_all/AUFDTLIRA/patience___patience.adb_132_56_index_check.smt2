...
(declare-const o112 card1)
(declare-const o113 Int)
(declare-const o114 card1)
...
(assert (= o123 i1))
(assert (= o124 (select (rec__patience__state__preds (us_split_fields__content s__split_fields20)) o123)))
(assert (= o125 (to_rep o124)))
(assert (= o126 (ite (<= o125 (- (to_rep (rec__patience__state__numelts (us_split_fields__content s__split_fields20))) 1)) true false)))
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o120 i1))
(assert (= o121 (select (rec__patience__state__preds (us_split_fields__content s__split_fields20)) o120)))
(assert (= o122 (to_rep o121)))
(assert (= o127 (ite (<= (- 1) o122) true false)))
(assert (= result27 (ite (= o127 true) o126 false)))
(assert (=> (= result27 true) (and (<= 0 i1) (<= i1 99))))
(assert (=> (= result27 true) (= o117 i1)))
(assert (=> (= result27 true) (= o118 (select (rec__patience__state__preds (us_split_fields__content s__split_fields20)) o117))))
(assert (=> (= result27 true) (= o119 (to_rep o118))))
(assert (=> (= result27 true) (= result26 (ite (< o119 i1) true false))))
...
(assert (= temp___780 (to_rep o110)))
(assert (and (<= 0 temp___780) (<= temp___780 99)))
(assert (= o111 temp___780))
(assert (= o112 (select (rec__patience__state__values (us_split_fields__content s__split_fields20)) o111)))
(assert (= o116 (to_rep1 o112)))
(assert (= result30 (ite (< o116 o115) true false)))
(assert (=> (= result30 true) (and (<= 0 i1) (<= i1 99))))
(assert (=> (= result30 true) (= o106 i1)))
(assert (=> (= result30 true) (= o107 (select (rec__patience__state__posstack (us_split_fields__content s__split_fields20)) o106))))
(assert (=> (= result30 true) (= o108 (to_rep o107))))
(assert (=> (= result30 true) (= result29 (ite (< 0 o108) true false))))
