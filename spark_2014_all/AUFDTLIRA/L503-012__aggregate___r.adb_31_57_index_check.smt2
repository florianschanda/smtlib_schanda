...
(define-fun bool_eq2 ((a (Array Int us_rep)) (a__first Int) (a__last Int) (b (Array Int us_rep)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_133 Int)) (=> (and (<= a__first temp___idx_133) (<= temp___idx_133 a__last)) (= (bool_eq1 (select a temp___idx_133) (select b (+ (- b__first a__first) temp___idx_133))) true)))) true false))
...
(assert (forall ((temp___276 us_rep)) (forall ((temp___277 Int)) (= (select (temp___274 temp___276) temp___277) temp___276))))
(declare-fun temp___278 (Int Int) (Array Int int5))
(assert (forall ((temp___280 Int) (temp___281 Int)) (let ((temp___279 (temp___278 temp___280 temp___281))) (forall ((temp___282 Int)) (ite (= temp___282 2) (= (select temp___279 temp___282) (of_rep temp___280)) (= (select temp___279 temp___282) (of_rep temp___281)))))))
(define-fun dynamic_invariant1 ((temp___expr_174 Int) (temp___is_init_171 Bool) (temp___skip_constant_172 Bool) (temp___do_toplevel_173 Bool)) Bool (=> (or (= temp___is_init_171 true) (<= 1 5)) (in_range2 temp___expr_174)))
(declare-const a (Array Int us_rep))
(declare-const o Int)
(declare-const o1 (Array Int int5))
(declare-const o2 (Array Int int5))
(declare-const temp___283 (Array Int int5))
(assert (in_range1 n))
(assert (and (<= 2 n) (<= n 6)))
(assert (and (<= 1 n) (<= n 5)))
(assert (= o n))
