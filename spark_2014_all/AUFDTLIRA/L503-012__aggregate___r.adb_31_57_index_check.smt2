...
(declare-fun temp___311 (us_rep) (Array Int us_rep))
(declare-fun temp___315 (Int Int) (Array Int int5))
...
(assert (forall ((temp___313 us_rep)) (forall ((temp___314 Int)) (= (select (temp___311 temp___313) temp___314) temp___313))))
(assert (forall ((temp___317 Int) (temp___318 Int)) (let ((temp___316 (temp___315 temp___317 temp___318))) (=> (and (dynamic_invariant1 temp___317 true true true true) (dynamic_invariant1 temp___318 true true true true)) (forall ((temp___319 Int)) (ite (= temp___319 2) (= (to_rep (select temp___316 temp___319)) temp___317) (= (to_rep (select temp___316 temp___319)) temp___318)))))))
(declare-const a (Array Int us_rep))
(declare-const o Int)
(declare-const o1 (Array Int int5))
(declare-const o2 (Array Int int5))
(declare-const temp___320 (Array Int int5))
(assert (in_range1 n))
(assert (and (<= 2 n) (<= n 6)))
(assert (and (<= 1 n) (<= n 5)))
(assert (= o n))
