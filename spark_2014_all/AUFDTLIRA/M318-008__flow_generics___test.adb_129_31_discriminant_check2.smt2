...
(assert (= result1 i))
(assert (= i1 1))
(assert (not (test__fruit_rec__record_t__arr__pred (mk___rep (mk___split_discrs mixed_basket__split_discrs) (mk___split_fields mixed_basket__split_fields mixed_basket__split_fields1 mixed_basket__split_fields2 mixed_basket__split_fields3) mixed_basket__attr__constrained))))
(check-sat)
(exit)
