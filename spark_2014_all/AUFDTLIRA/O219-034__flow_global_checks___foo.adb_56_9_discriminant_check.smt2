...
(declare-fun temp___190 (Bool) (Array Int Bool))
...
(assert (forall ((temp___192 Bool)) (forall ((temp___193 Int)) (= (select (temp___190 temp___192) temp___193) temp___192))))
(declare-const x Int)
(declare-const y Int)
...
(declare-const temp___1871 natural)
(declare-const temp___1872 Bool)
...
(assert (= (to_rep o2) 0))
(assert (= o2 o3))
(assert (= (distinct 0 0) temp___187))
(assert (= temp___1871 o3))
(assert (= true temp___1872))
(assert (= z__attr__constrained true))
(assert (not (= temp___187 z__split_discrs)))
(check-sat)
(exit)
