...
(define-fun default_initial_assumption ((temp___expr_138 us_rep) (temp___skip_top_level_139 Bool)) Bool (and (= (attr__constrained temp___expr_138) false) (= (rec__foo__disc_t__valid (us_split_discrs1 temp___expr_138)) (of_int 0))))
...
(assert (forall ((a (Array Int Bool)) (b (Array Int Bool))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq1 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_132 Int)) (=> (and (<= a__first temp___idx_132) (<= temp___idx_132 a__last)) (= (select a temp___idx_132) (select b (+ (- b__first a__first) temp___idx_132))))))))))
...
(assert (forall ((temp___167 Bool)) (forall ((temp___168 Int)) (= (select (temp___165 temp___167) temp___168) temp___167))))
...
(assert (not (= temp___162 z__split_discrs)))
(check-sat)
(exit)
