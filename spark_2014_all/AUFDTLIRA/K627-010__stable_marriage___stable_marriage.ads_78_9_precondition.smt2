...
(assert (forall ((x group1_id)) (! (= (of_rep1 (to_rep1 x)) x) :pattern ((to_rep1 x)))))
(assert (forall ((x group1_id)) (! (in_range1 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun bool_eq ((a (Array Int group1_id)) (a__first Int) (a__last Int) (b (Array Int group1_id)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_132 Int)) (=> (and (<= a__first temp___idx_132) (<= temp___idx_132 a__last)) (= (to_rep1 (select a temp___idx_132)) (to_rep1 (select b (+ (- b__first a__first) temp___idx_132))))))) true false))
...
(assert (forall ((a (Array Int group1_id)) (b (Array Int group1_id))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep1 (select a (+ i 1))) (to_rep1 (select b (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int group1_id)) (b (Array Int group1_id))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep1 (select b (+ i 1))) (to_rep1 (select a (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
...
(assert (forall ((r1 (Array Int group1_id))) (! (= (= (is_permutation_1 r1) true) (forall ((g1 Int)) (=> (and (<= 1 g1) (<= g1 64)) (exists ((rank Int)) (and (and (<= 1 rank) (<= rank 64)) (= (to_rep1 (select r1 rank)) g1)))))) :pattern ((is_permutation_1 r1)))))
...
(assert (forall ((r1 (Array Int group1_id))) (! (=> (= (is_permutation_1 r1) true) (let ((result (invert_1 r1))) (and (forall ((rank Int)) (=> (and (<= 1 rank) (<= rank 64)) (= (to_rep (select result (to_rep1 (select r1 rank)))) rank))) (forall ((g1 Int)) (=> (and (<= 1 g1) (<= g1 64)) (= (to_rep1 (select r1 (to_rep (select result g1)))) g1)))))) :pattern ((invert_1 r1)))))
...
(declare-const temp___471 (Array Int ranking))
(declare-const temp___472 (Array Int ranking))
...
(assert (and (= o (invert_1 r1)) (and (forall ((rank Int)) (=> (and (<= 1 rank) (<= rank 64)) (= (to_rep (select o (to_rep1 (select r1 rank)))) rank))) (forall ((g1 Int)) (=> (and (<= 1 g1) (<= g1 64)) (= (to_rep1 (select r1 (to_rep (select o g1)))) g1))))))
...
(assert (= stable_marriage__is_preferred_1__result1 (ite (<= (to_rep (select inverted1 g1_a)) (to_rep (select inverted1 g1_b))) true false)))
...
(assert (and (= temp___472 (invert_1 r1)) (and (forall ((rank Int)) (=> (and (<= 1 rank) (<= rank 64)) (= (to_rep (select temp___472 (to_rep1 (select r1 rank)))) rank))) (forall ((g1 Int)) (=> (and (<= 1 g1) (<= g1 64)) (= (to_rep1 (select r1 (to_rep (select temp___472 g1)))) g1))))))
(assert (= o1 (select temp___472 g1_b)))
(assert (= o2 (to_rep o1)))
