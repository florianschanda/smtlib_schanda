...
(assert (= temp___824 (to_string o81)))
...
(assert (= temp___820 (mk___t (concat1 (temp___String_Literal_816 Tuple0) 1 1 (elts (to_string (attr__ATTRIBUTE_IMAGE5 idx2))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE5 idx2))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE5 idx2)))))) (mk 1 o87))))
(assert (=> (= (length temp___820) 0) (= temp___823 (mk___t (temp___String_Literal_819 Tuple0) (mk 1 3)))))
(assert (=> (not (= (length temp___820) 0)) (=> (<= 1 3) (= o88 (+ (- 3 1) 1)))))
(assert (=> (not (= (length temp___820) 0)) (=> (not (<= 1 3)) (= o88 0))))
(assert (=> (not (= (length temp___820) 0)) (=> (<= (to_rep1 (first (rt temp___820))) (to_rep1 (last (rt temp___820)))) (= o89 (+ (- (to_rep1 (last (rt temp___820))) (to_rep1 (first (rt temp___820)))) 1)))))
(assert (=> (not (= (length temp___820) 0)) (=> (not (<= (to_rep1 (first (rt temp___820))) (to_rep1 (last (rt temp___820))))) (= o89 0))))
(assert (=> (not (= (length temp___820) 0)) (= o90 (+ o89 o88))))
(assert (=> (not (= (length temp___820) 0)) (= o91 (+ (to_rep1 (first (rt temp___820))) o90))))
(assert (=> (not (= (length temp___820) 0)) (= o92 (- o91 1))))
(assert (=> (not (= (length temp___820) 0)) (and (= o93 o92) (in_range2 o92))))
(assert (=> (not (= (length temp___820) 0)) (= temp___823 (mk___t (concat1 (elts temp___820) (to_rep1 (first (rt temp___820))) (to_rep1 (last (rt temp___820))) (temp___String_Literal_819 Tuple0) 1 3) (mk (to_rep1 (first (rt temp___820))) o93)))))
(assert (not (= (length temp___823) 0)))
(assert (=> (<= (to_rep1 (first (rt temp___824))) (to_rep1 (last (rt temp___824)))) (= o94 (+ (- (to_rep1 (last (rt temp___824))) (to_rep1 (first (rt temp___824)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt temp___824))) (to_rep1 (last (rt temp___824))))) (= o94 0)))
(assert (=> (<= (to_rep1 (first (rt temp___823))) (to_rep1 (last (rt temp___823)))) (= o95 (+ (- (to_rep1 (last (rt temp___823))) (to_rep1 (first (rt temp___823)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt temp___823))) (to_rep1 (last (rt temp___823))))) (= o95 0)))
(assert (= o96 (+ o95 o94)))
(assert (= o97 (+ (to_rep1 (first (rt temp___823))) o96)))
(assert (= o98 (- o97 1)))
