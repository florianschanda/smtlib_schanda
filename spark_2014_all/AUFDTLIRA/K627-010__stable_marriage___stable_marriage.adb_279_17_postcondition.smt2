...
(define-fun dynamic_invariant2 ((temp___expr_180 Int) (temp___is_init_176 Bool) (temp___skip_constant_177 Bool) (temp___do_toplevel_178 Bool) (temp___do_typ_inv_179 Bool)) Bool (=> (or (= temp___is_init_176 true) (<= 1 64)) (in_range3 temp___expr_180)))
...
(assert (forall ((a (Array Int (Array Int group2_id))) (b (Array Int (Array Int group2_id)))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq2 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_156 Int)) (=> (and (<= a__first temp___idx_156) (<= temp___idx_156 a__last)) (= (bool_eq1 (select a temp___idx_156) 1 64 (select b (+ (- b__first a__first) temp___idx_156)) 1 64) true))))))))
...
(define-fun bool_eq6 ((a (Array Int (Array Int ranking))) (a__first Int) (a__last Int) (b (Array Int (Array Int ranking))) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_160 Int)) (=> (and (<= a__first temp___idx_160) (<= temp___idx_160 a__last)) (= (bool_eq4 (select a temp___idx_160) 1 64 (select b (+ (- b__first a__first) temp___idx_160)) 1 64) true)))) true false))
(assert (forall ((a (Array Int (Array Int ranking))) (b (Array Int (Array Int ranking)))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq6 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_160 Int)) (=> (and (<= a__first temp___idx_160) (<= temp___idx_160 a__last)) (= (bool_eq4 (select a temp___idx_160) 1 64 (select b (+ (- b__first a__first) temp___idx_160)) 1 64) true))))))))
...
(define-fun dynamic_invariant3 ((temp___expr_343 Int) (temp___is_init_339 Bool) (temp___skip_constant_340 Bool) (temp___do_toplevel_341 Bool) (temp___do_typ_inv_342 Bool)) Bool (=> (or (= temp___is_init_339 true) (<= 0 64)) (in_range4 temp___expr_343)))
...
(assert (forall ((r2 (Array Int (Array Int group1_id)))) (! (=> (forall ((g2 Int)) (=> (and (<= 1 g2) (<= g2 64)) (= (is_permutation_1 (select r2 g2)) true))) (forall ((g2 Int)) (=> (and (<= 1 g2) (<= g2 64)) (= (let ((temp___398 (invert_1 (select r2 g2)))) (let ((temp___397 (select (invert r2) g2))) (bool_eq4 temp___397 1 64 temp___398 1 64))) true)))) :pattern ((invert r2)))))
...
(declare-const proposals_made2 map__ref7)
(declare-const unmatched_g1_set__split_fields7 us_split_fields__ref)
(declare-const unmatched_g2_set3 map__ref5)
...
(assert (=> (not (= already_asked1 0)) (and (= o7 already_asked1) (in_range3 already_asked1))))
...
(assert (=> (not (= already_asked1 0)) (not (= (is_preferred_1 g11 (to_rep (select result__ (to_rep1 (select (select ranking_1 g11) (- rank2 1))))) (select ranking_2 (to_rep1 (select (select ranking_1 g11) (- rank2 1))))) true))))
...
(assert (and (= o10 (+ (to_rep3 (select proposals_made g11)) 1)) (in_range4 (+ (to_rep3 (select proposals_made g11)) 1))))
...
(assert (=> (= (select unmatched_g2_set g21) true) (= result8 (mk_map__ref5 unmatched_g2_set))))
...
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21))))) (= result9 accepted6))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21))))) (= accepted2 (distinct 1 0)))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21))))) (= (to_rep (select result__ g21)) c132b))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21))))) (in_range1 c132b))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21))))) (and (= o13 (+ (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields2)) 1)) (in_range4 (+ (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields2)) 1))))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21))))) (= (to_rep3 o14) o13))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21))))) (= (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields2) o15))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21))))) (= o14 o16))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21))))) (= temp___645 o15))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21))))) (= temp___6451 o16))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21))))) (= result10 (mk___split_fields__ref unmatched_g1_set__split_fields2)))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21))))) (= unmatched_g1_set__split_fields3 (mk___split_fields temp___645 temp___6451)))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21))))) (= (to_rep o17) c132b))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21))))) (and (<= 1 (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields3))) (<= (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields3)) 64)))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21))))) (= o18 (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields3))))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21))))) (= o19 (store (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields3) o18 o17)))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21))))) (= o19 o20))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21))))) (= (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields3) o21))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21))))) (= temp___649 o20))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21))))) (= temp___6491 o21))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21))))) (= result11 (mk___split_fields__ref unmatched_g1_set__split_fields3)))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21))))) (= unmatched_g1_set__split_fields4 (mk___split_fields temp___649 temp___6491)))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21))))) (= (is_preferred_1 g11 (to_rep (select result__ g21)) (select ranking_2 g21)) true))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (not (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21)))))) (= result12 accepted6))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (not (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21)))))) (= accepted3 (distinct 0 0)))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (not (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21)))))) (= g11 c134b))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (not (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21)))))) (in_range1 c134b))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (not (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21)))))) (and (= o22 (+ (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields2)) 1)) (in_range4 (+ (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields2)) 1))))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (not (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21)))))) (= (to_rep3 o23) o22))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (not (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21)))))) (= (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields2) o24))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (not (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21)))))) (= o23 o25))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (not (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21)))))) (= temp___637 (mk___rep (mk___split_fields o24 o25))))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (not (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21)))))) (= result13 (mk___split_fields__ref unmatched_g1_set__split_fields2)))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (not (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21)))))) (= unmatched_g1_set__split_fields5 (us_split_fields1 temp___637)))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (not (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21)))))) (= (to_rep o26) c134b))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (not (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21)))))) (and (<= 1 (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields5))) (<= (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields5)) 64)))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (not (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21)))))) (= o27 (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields5))))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (not (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21)))))) (= o28 (store (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields5) o27 o26)))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (not (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21)))))) (= o29 (mk___split_fields o28 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields5))))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (not (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21)))))) (= temp___641 (mk___rep o29)))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (not (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21)))))) (= result14 (mk___split_fields__ref unmatched_g1_set__split_fields5)))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (not (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21)))))) (= unmatched_g1_set__split_fields6 (us_split_fields1 temp___641)))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (not (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21)))))) (= accepted2 accepted3))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (not (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21)))))) (= unmatched_g1_set__split_fields4 unmatched_g1_set__split_fields6))))
...
(assert (forall ((g2_id Int)) (=> (and (<= 1 g2_id) (<= g2_id 64)) (=> (not (= (select unmatched_g2_set2 g2_id) true)) (forall ((idx Int)) (=> (and (<= 1 idx) (<= idx (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields4)))) (not (= (to_rep (select (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields4) idx)) (to_rep (select result__2 g2_id))))))))))
(assert (forall ((g1_id Int)) (=> (and (<= 1 g1_id) (<= g1_id 64)) (forall ((rank5 Int)) (=> (and (<= 1 rank5) (<= rank5 (to_rep3 (select proposals_made1 g1_id)))) (and (not (= (select unmatched_g2_set2 (to_rep1 (select (select ranking_1 g1_id) rank5))) true)) (=> (not (= (to_rep (select result__2 (to_rep1 (select (select ranking_1 g1_id) rank5)))) g1_id)) (not (= (is_preferred_1 g1_id (to_rep (select result__2 (to_rep1 (select (select ranking_1 g1_id) rank5)))) (select ranking_2 (to_rep1 (select (select ranking_1 g1_id) rank5)))) true)))))))))
(assert (forall ((g1_id Int)) (=> (and (<= 1 g1_id) (<= g1_id 64)) (=> (= (to_rep3 (select proposals_made1 g1_id)) 0) (exists ((idx Int)) (and (and (<= 1 idx) (<= idx (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields4)))) (= (to_rep (select (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields4) idx)) g1_id)))))))
(assert (forall ((g1_id Int)) (=> (and (<= 1 g1_id) (<= g1_id 64)) (=> (forall ((idx Int)) (=> (and (<= 1 idx) (<= idx (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields4)))) (not (= (to_rep (select (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields4) idx)) g1_id)))) (and (< 0 (to_rep3 (select proposals_made1 g1_id))) (= (to_rep (select result__2 (to_rep1 (select (select ranking_1 g1_id) (to_rep3 (select proposals_made1 g1_id)))))) g1_id))))))
...
(assert (= unmatched_g2_set3 (mk_map__ref5 unmatched_g2_set2)))
(assert (= unmatched_g1_set__split_fields7 (mk___split_fields__ref unmatched_g1_set__split_fields4)))
(assert (= proposals_made2 (mk_map__ref7 proposals_made1)))
...
(assert (not (= (invariant_holds (us_split_fields__content unmatched_g1_set__split_fields7) (map__content7 proposals_made2) (map__content result__3) (map__content5 unmatched_g2_set3)) true)))
(check-sat)
(exit)
