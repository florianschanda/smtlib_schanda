...
(assert (and (and (=> (<= 1 64) (in_range1 g1)) (and (=> (<= 1 64) (in_range2 g2)) (and (and (= result1 (mk_int__ref rank)) (= rank2 1)) (and (in_range3 rank2) (and (=> (<= 0 64) (in_range4 already_asked)) (and (and (and (and (and (and (<= 1 (to_rep3 unmatched_g1_set__split_fields1)) (<= (to_rep3 unmatched_g1_set__split_fields1) 64)) (= o (to_rep3 unmatched_g1_set__split_fields1))) (= o1 (select unmatched_g1_set__split_fields o))) (= o2 (to_rep o1))) (and (= result2 (mk_int__ref g1)) (= g11 o2))) (and (and (and (and (and (and (= o3 (- (to_rep3 unmatched_g1_set__split_fields1) 1)) (in_range4 (- (to_rep3 unmatched_g1_set__split_fields1) 1))) (= (to_rep3 o4) o3)) (and (= unmatched_g1_set__split_fields o5) (= o4 o6))) (and (= temp___586 o5) (= temp___5861 o6))) (and (= result3 (mk___split_fields__ref (mk___split_fields unmatched_g1_set__split_fields unmatched_g1_set__split_fields1))) (= unmatched_g1_set__split_fields2 (mk___split_fields temp___586 temp___5861)))) (and (< (to_rep3 (select proposals_made g11)) 64) (and (and (= result4 (mk_int__ref already_asked)) (= already_asked1 (to_rep3 (select proposals_made g11)))) (and (ite (not (= already_asked1 0)) (and (and (and (and (and (= o7 already_asked1) (in_range3 already_asked1)) (= o8 (+ o7 1))) (and (= o9 o8) (in_range3 o8))) (and (= result5 (mk_int__ref rank2)) (= rank3 o9))) (not (= (is_preferred_1 g11 (to_rep (select result__ (to_rep1 (select (select ranking_1 g11) (- rank3 1))))) (select ranking_2 (to_rep1 (select (select ranking_1 g11) (- rank3 1))))) true))) (= rank3 rank2)) (and (and (= result6 (mk_int__ref g2)) (= g21 (to_rep1 (select (select ranking_1 g11) rank3)))) (and (and (and (and (and (= o20 (+ (to_rep3 (select proposals_made g11)) 1)) (in_range4 (+ (to_rep3 (select proposals_made g11)) 1))) (= (to_rep3 o21) o20)) (= o22 (store proposals_made g11 o21))) (and (= result7 (mk_map__ref7 proposals_made)) (= proposals_made1 o22))) (and (ite (= (select unmatched_g2_set g21) true) (and (and (and (= result8 (mk_bool__ref accepted)) (= accepted1 (of_int 1))) (and (= result9 (mk_map__ref5 unmatched_g2_set)) (= unmatched_g2_set2 (store unmatched_g2_set g21 (of_int 0))))) (= unmatched_g1_set__split_fields4 unmatched_g1_set__split_fields2)) (and (ite (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21))))) (and (and (= result10 (mk_bool__ref accepted)) (= accepted2 (of_int 1))) (and (and (= (to_rep (select result__ g21)) c132b) (in_range1 c132b)) (and (and (and (and (and (and (= o23 (+ (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields2)) 1)) (in_range4 (+ (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields2)) 1))) (= (to_rep3 o24) o23)) (and (= (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields2) o25) (= o24 o26))) (and (= temp___603 o25) (= temp___6031 o26))) (and (= result11 (mk___split_fields__ref unmatched_g1_set__split_fields2)) (= unmatched_g1_set__split_fields3 (mk___split_fields temp___603 temp___6031)))) (and (and (and (and (and (= (to_rep o27) c132b) (and (and (and (<= 1 (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields3))) (<= (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields3)) 64)) (= o28 (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields3)))) (= o29 (store (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields3) o28 o27)))) (and (= o29 o30) (= (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields3) o31))) (and (= temp___607 o30) (= temp___6071 o31))) (and (= result12 (mk___split_fields__ref unmatched_g1_set__split_fields3)) (= unmatched_g1_set__split_fields4 (mk___split_fields temp___607 temp___6071)))) (= (is_preferred_1 g11 (to_rep (select result__ g21)) (select ranking_2 g21)) true))))) (and (and (and (= result13 (mk_bool__ref accepted)) (= accepted3 (of_int 0))) (and (and (= g11 c134b) (in_range1 c134b)) (and (and (and (and (and (and (= o32 (+ (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields2)) 1)) (in_range4 (+ (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields2)) 1))) (= (to_rep3 o33) o32)) (and (= (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields2) o34) (= o33 o35))) (= temp___595 (mk___rep (mk___split_fields o34 o35)))) (and (= result14 (mk___split_fields__ref unmatched_g1_set__split_fields2)) (= unmatched_g1_set__split_fields5 (us_split_fields1 temp___595)))) (and (and (and (and (= (to_rep o36) c134b) (and (and (and (<= 1 (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields5))) (<= (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields5)) 64)) (= o37 (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields5)))) (= o38 (store (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields5) o37 o36)))) (= o39 (mk___split_fields o38 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields5)))) (= temp___599 (mk___rep o39))) (and (= result15 (mk___split_fields__ref unmatched_g1_set__split_fields5)) (= unmatched_g1_set__split_fields6 (us_split_fields1 temp___599))))))) (and (= accepted2 accepted3) (= unmatched_g1_set__split_fields4 unmatched_g1_set__split_fields6)))) (and (and (= accepted1 accepted2) (= unmatched_g2_set2 unmatched_g2_set)) (and (= accepted1 accepted2) (= unmatched_g2_set2 unmatched_g2_set1))))) (and (ite (= accepted1 true) (and (and (= (to_rep o40) g11) (= o41 (store result__ g21 o40))) (and (= result16 (mk_map__ref result__)) (= result__2 o41))) (and (= result__2 result__) (= result__2 result__1))) (and (= (all_unmatched_g1_set_elements_distinct unmatched_g1_set__split_fields4) true) (and (forall ((g21_id Int)) (=> (and (<= 1 g21_id) (<= g21_id 64)) (forall ((g22_id Int)) (=> (and (<= 1 g22_id) (<= g22_id 64)) (=> (and (and (not (= (select unmatched_g2_set2 g21_id) true)) (not (= (select unmatched_g2_set2 g22_id) true))) (not (= g21_id g22_id))) (not (= (to_rep (select result__2 g21_id)) (to_rep (select result__2 g22_id))))))))) (and (forall ((g2_id1 Int)) (=> (and (<= 1 g2_id1) (<= g2_id1 64)) (=> (not (= (select unmatched_g2_set2 g2_id1) true)) (forall ((idx3 Int)) (=> (and (<= 1 idx3) (<= idx3 (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields4)))) (not (= (to_rep (select (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields4) idx3)) (to_rep (select result__2 g2_id1))))))))) (and (forall ((g1_id3 Int)) (=> (and (<= 1 g1_id3) (<= g1_id3 64)) (forall ((rank6 Int)) (=> (and (<= 1 rank6) (<= rank6 (to_rep3 (select proposals_made1 g1_id3)))) (and (not (= (select unmatched_g2_set2 (to_rep1 (select (select ranking_1 g1_id3) rank6))) true)) (=> (not (= (to_rep (select result__2 (to_rep1 (select (select ranking_1 g1_id3) rank6)))) g1_id3)) (not (= (is_preferred_1 g1_id3 (to_rep (select result__2 (to_rep1 (select (select ranking_1 g1_id3) rank6)))) (select ranking_2 (to_rep1 (select (select ranking_1 g1_id3) rank6)))) true)))))))) (and (forall ((g1_id3 Int)) (=> (and (<= 1 g1_id3) (<= g1_id3 64)) (=> (= (to_rep3 (select proposals_made1 g1_id3)) 0) (exists ((idx3 Int)) (and (and (<= 1 idx3) (<= idx3 (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields4)))) (= (to_rep (select (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields4) idx3)) g1_id3)))))) (forall ((g1_id3 Int)) (=> (and (<= 1 g1_id3) (<= g1_id3 64)) (=> (forall ((idx3 Int)) (=> (and (<= 1 idx3) (<= idx3 (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields4)))) (not (= (to_rep (select (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields4) idx3)) g1_id3)))) (and (< 0 (to_rep3 (select proposals_made1 g1_id3))) (= (to_rep (select result__2 (to_rep1 (select (select ranking_1 g1_id3) (to_rep3 (select proposals_made1 g1_id3)))))) g1_id3)))))))))))))))))))))))) (and (and (= already_asked2 (mk_int__ref already_asked1)) (and (= rank4 (mk_int__ref rank3)) (and (= accepted4 (mk_bool__ref accepted1)) (and (= g22 (mk_int__ref g21)) (and (= g12 (mk_int__ref g11)) (and (= result__3 (mk_map__ref result__2)) (and (= unmatched_g2_set3 (mk_map__ref5 unmatched_g2_set2)) (and (= unmatched_g1_set__split_fields7 (mk___split_fields__ref unmatched_g1_set__split_fields4)) (= proposals_made2 (mk_map__ref7 proposals_made1)))))))))) (and (= already_asked3 already_asked1) (and (= rank5 rank3) (and (= accepted5 accepted1) (and (= g23 g21) (and (= g13 g11) (and (= result__4 result__2) (and (= unmatched_g2_set4 unmatched_g2_set2) (and (= unmatched_g1_set__split_fields8 unmatched_g1_set__split_fields4) (= proposals_made3 proposals_made1))))))))))))
