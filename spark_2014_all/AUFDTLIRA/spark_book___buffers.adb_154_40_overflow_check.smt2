...
(define-fun dynamic_invariant ((temp___expr_135 Int) (temp___is_init_132 Bool) (temp___skip_constant_133 Bool) (temp___do_toplevel_134 Bool)) Bool (=> (or (= temp___is_init_132 true) (<= 0 1024)) (in_range4 temp___expr_135)))
...
(define-fun dynamic_invariant1 ((temp___expr_141 Int) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool (=> (or (= temp___is_init_138 true) (<= 1 1024)) (in_range5 temp___expr_141)))
...
(assert (forall ((temp___277 Int) (temp___278 Int) (temp___279 Int)) (let ((temp___276 (temp___275 temp___277 temp___278 temp___279))) (and (=> (dynamic_property 1 2147483647 temp___278 temp___279) (and (= (first3 temp___276) temp___278) (= (last3 temp___276) temp___279))) (forall ((temp___280 Int)) (= (select (to_array1 temp___276) temp___280) (of_rep temp___277)))))))
...
(assert (= (to_rep1 (first2 (rt1 (temp___275 32 (to_rep1 destination__first) (to_rep1 destination__last))))) (to_rep1 destination__first)))
(assert (= (to_rep1 (last2 (rt1 (temp___275 32 (to_rep1 destination__first) (to_rep1 destination__last))))) (to_rep1 destination__last)))
(assert (= (mk___t1 temp___282 temp___2821) (temp___275 32 (to_rep1 destination__first) (to_rep1 destination__last))))
(assert (= temp___282 temp___283))
(assert (= (mk (to_rep1 (first2 temp___2821)) (to_rep1 (last2 temp___2821))) temp___2831))
(assert (= (ite (<= (to_rep1 (first temp___2831)) (to_rep1 (last temp___2831))) (+ (- (to_rep1 (last temp___2831)) (to_rep1 (first temp___2831))) 1) 0) (ite (<= (to_rep1 destination__first) (to_rep1 destination__last)) (+ (- (to_rep1 destination__last) (to_rep1 destination__first)) 1) 0)))
(assert (= (mk___t temp___284 temp___2841) (mk___t temp___283 temp___2831)))
(assert (= o (slide temp___284 (to_rep1 (first temp___2841)) (to_rep1 destination__first))))
...
(assert (and (= temp___285 (+ point (- i2 1))) (in_range1 (+ point (- i2 1)))))
(assert (and (<= 1 temp___285) (<= temp___285 1024)))
(assert (= o5 temp___285))
(assert (= o6 (select buffer o5)))
(assert (= o7 (to_rep o6)))
(assert (= (to_rep o8) o7))
(assert (not (in_range1 (+ (to_rep1 destination__first) (- i2 1)))))
(check-sat)
(exit)
