...
(assert (= num 1))
(assert (= (to_rep o1) 1))
(assert (= o2 (mk___split_fields1 o1 (temp___233 1 2 3 4))))
(assert (= o3 (mk___rep1 o2)))
(assert (= o4 (mk___split_fields2 dummy2 o3)))
(assert (= (to_rep o) 1))
(assert (= o5 (mk___split_discrs o)))
(assert (= temp___240 (mk___rep2 o5 o4 true)))
(assert (= output__attr__constrained true))
(assert (not (= (rec__use_unchecked_union__myunion__discr (us_split_discrs1 temp___240)) output__split_discrs)))
(check-sat)
(exit)
