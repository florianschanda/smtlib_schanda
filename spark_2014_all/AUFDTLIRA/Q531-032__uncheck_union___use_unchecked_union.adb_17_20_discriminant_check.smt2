...
(assert (= num 1))
(assert (= (to_rep o12) 1))
(assert (= o13 (mk___split_fields1 o12 (temp___206 1 2 3 4))))
(assert (= o14 (mk___rep1 o13)))
(assert (= o15 (mk___split_fields2 dummy2 o14)))
(assert (= (to_rep o11) 1))
(assert (= o16 (mk___split_discrs o11)))
(assert (= temp___213 (mk___rep2 o16 o15 true)))
(assert (= output__attr__constrained true))
(assert (not (= (rec__use_unchecked_union__myunion__discr (us_split_discrs1 temp___213)) output__split_discrs)))
(check-sat)
(exit)
