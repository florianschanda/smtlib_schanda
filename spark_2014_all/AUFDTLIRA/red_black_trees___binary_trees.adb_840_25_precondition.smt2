...
(assert (and (<= 1 i) (<= i 100)))
(assert (= o80 i))
(assert (= o81 (select temp___1551 o80)))
(assert (= o82 (us_split_fields1 o81)))
(assert (= o83 (rec__tree_model__path_type__a o82)))
(assert (and (= o74 v) (in_range1 v)))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))) true))
(assert (and (= o75 v) (in_range1 v)))
(assert (and (= temp___1550 (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) o75)) (and (dynamic_invariant3 temp___1550 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1550 o75))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1550 o75)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 o75)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1550 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1550 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1550 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1550 i1))) true) (not (= i1 o75))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1550 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i1)))) (position (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1550 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1550 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1550 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1550 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1550 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1550 j)))) true)) (= j i1))))))))))))))
(assert (and (<= 1 i) (<= i 100)))
(assert (= o76 i))
(assert (= o77 (select temp___1550 o76)))
...
(assert (= o70 v))
(assert (= o71 (select temp___1549 o70)))
