...
(declare-fun temp_____aggregate_def_3193 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
(declare-fun temp_____aggregate_def_3199 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___3195 (Array Int (Array Int et1)))) (forall ((temp___3196 Int)) (forall ((temp___3197 (Array Int et1))) (let ((temp___3194 (temp_____aggregate_def_3193 temp___3195 temp___3196 temp___3197))) (=> (dynamic_invariant1 temp___3196 true true true true) (forall ((temp___3198 Int)) (ite (= temp___3198 temp___3196) (= (select temp___3194 temp___3198) temp___3197) (= (select temp___3194 temp___3198) (select temp___3195 temp___3198))))))))))
(assert (forall ((temp___3201 (Array Int et1))) (forall ((temp___3202 Int) (temp___3203 Int)) (let ((temp___3200 (temp_____aggregate_def_3199 temp___3201 temp___3202 temp___3203))) (=> (and (dynamic_invariant temp___3202 true true true true) (dynamic_invariant2 temp___3203 true true true true)) (forall ((temp___3204 Int)) (ite (= temp___3204 temp___3202) (= (to_rep (select temp___3200 temp___3204)) temp___3203) (= (select temp___3200 temp___3204) (select temp___3201 temp___3204)))))))))
...
(declare-const temp___8195 (Array Int (Array Int et1)))
(declare-const temp___81951 Bool)
...
(assert (= temp___8195 o3))
(assert (= temp___81951 o4))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= temp___8195 r__split_fields2))
(assert (= temp___81951 r__split_fields3))
...
(assert (not (= (bool_eq2 (mk___rep (mk___split_fields r__split_fields4 r__split_fields5)) (mk___rep (mk___split_fields (temp_____aggregate_def_3193 r__split_fields i (temp_____aggregate_def_3199 (select r__split_fields i) j e)) r__split_fields1))) true)))
(check-sat)
(exit)
