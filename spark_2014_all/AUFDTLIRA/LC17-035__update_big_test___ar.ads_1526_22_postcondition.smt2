...
(declare-fun temp___3134 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
(assert (forall ((temp___3136 (Array Int (Array Int et1)))) (forall ((temp___3137 Int)) (forall ((temp___3138 (Array Int et1))) (let ((temp___3135 (temp___3134 temp___3136 temp___3137 temp___3138))) (forall ((temp___3139 Int)) (ite (= temp___3139 temp___3137) (= (select temp___3135 temp___3139) temp___3138) (= (select temp___3135 temp___3139) (select temp___3136 temp___3139)))))))))
(declare-fun temp___3140 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___3142 (Array Int et1))) (forall ((temp___3143 Int) (temp___3144 Int)) (let ((temp___3141 (temp___3140 temp___3142 temp___3143 temp___3144))) (forall ((temp___3145 Int)) (ite (= temp___3145 temp___3143) (= (select temp___3141 temp___3145) (of_rep temp___3144)) (= (select temp___3141 temp___3145) (select temp___3142 temp___3145))))))))
...
(assert (not (= (bool_eq2 (mk___rep (mk___split_fields r__split_fields4 r__split_fields5)) (mk___rep (mk___split_fields (temp___3134 r__split_fields i (temp___3140 (select r__split_fields i) j e)) r__split_fields1))) true)))
(check-sat)
(exit)
