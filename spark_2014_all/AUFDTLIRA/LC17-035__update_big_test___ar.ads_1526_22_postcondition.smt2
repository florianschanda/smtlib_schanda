...
(assert (not (= (bool_eq2 (mk___rep (mk___split_fields r__split_fields4 r__split_fields5)) (mk___rep (mk___split_fields (temp___3193 r__split_fields i (temp___3199 (select r__split_fields i) j e)) r__split_fields1))) true)))
(check-sat)
(exit)
