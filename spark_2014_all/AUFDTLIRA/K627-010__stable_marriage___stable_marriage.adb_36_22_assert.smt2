...
(assert (= rank1 1))
(assert (=> (and (<= 1 rank1) (<= rank1 64)) (and (and (= temp___423 seen1) (and (= temp___422 rank1) (and (forall ((g21 Int)) (=> (and (<= 1 g21) (<= g21 64)) (= (= (select seen2 g21) true) (exists ((prev1 Int)) (and (and (<= 1 prev1) (<= prev1 (- rank2 1))) (= (to_rep (select r2 prev1)) g21)))))) (and (and (=> (<= 1 64) (in_range2 rank2)) (and (<= 1 rank2) (<= rank2 64))) (and (and (= seen2 result2) (= seen3 (store seen2 (to_rep (select r2 rank2)) (of_int 1)))) (= rank2 64)))))) (and (and (= rank2 rank6) (= seen3 seen6)) (and (= rank7 rank2) (= seen7 seen3))))))
...
(assert (= (bool_eq1 seen8 1 64 (temp___427 (of_int 1)) 1 64) true))
(declare-const g21 Int)
(assert (<= 1 g21))
(assert (<= g21 64))
(assert (not (= (select seen8 g21) true)))
(check-sat)
(exit)
