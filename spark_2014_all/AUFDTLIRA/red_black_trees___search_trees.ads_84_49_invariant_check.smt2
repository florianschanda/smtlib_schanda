...
(assert (=> (not (= (int__content i15) 0)) (and (= o34 (size1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))) (and (in_range4 o34) (= o34 (size (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14))))))))
(assert (=> (not (= (int__content i15) 0)) (= result20 (ite (= o34 1) true false))))
...
(assert (=> (= result20 true) (and (= o33 (root (mk___rep3 (us_split_fields__content3 t__split_fields14)))) (and (in_range3 o33) (= o33 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields__content3 t__split_fields14))))))))
(assert (=> (= result20 true) (= result19 (ite (= o33 (int__content i15)) true false))))
...
(assert (=> (= result19 true) (and (= o32 (values1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))) (ite (= (size (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14))) 0) (= (is_empty o32) true) (and (forall ((i17 Int)) (=> (and (<= 1 i17) (<= i17 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields__content3 t__split_fields14)))) i17))) true) (= (contains o32 (to_rep (select (rec__search_trees__search_tree__values (us_split_fields__content3 t__split_fields14)) i17))) true)))) (forall ((v1 Int)) (=> (and (<= 0 v1) (<= v1 2147483647)) (=> (= (contains o32 v1) true) (exists ((i17 Int)) (and (and (<= 1 i17) (<= i17 100)) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields__content3 t__split_fields14)))) i17))) true) (= (to_rep (select (rec__search_trees__search_tree__values (us_split_fields__content3 t__split_fields14)) i17)) v1))))))))))))
...
(assert (=> (= result19 true) (and (= o31 (values1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)))) (ite (= (size (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2))) 0) (= (is_empty o31) true) (and (forall ((i17 Int)) (=> (and (<= 1 i17) (<= i17 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) (to_rep1 t__split_fields)) i17))) true) (= (contains o31 (to_rep (select t__split_fields3 i17))) true)))) (forall ((v1 Int)) (=> (and (<= 0 v1) (<= v1 2147483647)) (=> (= (contains o31 v1) true) (exists ((i17 Int)) (and (and (<= 1 i17) (<= i17 100)) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) (to_rep1 t__split_fields)) i17))) true) (= (to_rep (select t__split_fields3 i17)) v1))))))))))))
(assert (=> (= result19 true) (and (= result18 (is_add__2 o31 v o32)) (= (= result18 true) (and (and (and (not (= (contains o31 v) true)) (= (contains o32 v) true)) (= (ole o31 o32) true)) (= (included_except o32 o31 v) true))))))
(assert (=> (not (= result19 true)) (= result18 false)))
(assert (= result18 true))
(assert (<= 1 i1))
(assert (<= i1 100))
(assert (type_invariant1 (mk___rep3 (us_split_fields__content3 t__split_fields14))))
(assert (and (= o29 (root (mk___rep3 (us_split_fields__content3 t__split_fields14)))) (and (in_range3 o29) (= o29 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields__content3 t__split_fields14)))))))
(assert (= o30 (ite (= i1 o29) true false)))
(assert (= result21 (ite (not (= o30 true)) true false)))
