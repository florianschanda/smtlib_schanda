...
(assert (<= i4 100))
(assert (type_invariant1 (mk___rep3 (us_split_fields__content3 t__split_fields14))))
(assert (and (= o69 (root (mk___rep3 (us_split_fields__content3 t__split_fields14)))) (and (in_range3 o69) (= o69 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields__content3 t__split_fields14)))))))
(assert (= o70 (ite (= i4 o69) true false)))
