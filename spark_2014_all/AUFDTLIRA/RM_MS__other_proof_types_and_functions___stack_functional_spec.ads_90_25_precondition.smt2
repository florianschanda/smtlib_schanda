...
(assert (= result3 true))
(assert (and (= o46 (stack_entry (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1)) i)) (and (in_range1 o46) (= o46 (to_rep (select (rec__stack_functional_spec__stack_type__s (us_split_fields1 (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1)))) i))))))
(assert (and (= o45 (state__2 (us_split_fields__content my_stack__split_fields4))) (= o45 (mk___rep (us_split_fields__content my_stack__split_fields4)))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
