...
(declare-fun temp_____aggregate_def_4269 ((Array Int us_rep1) Int us_rep1) (Array Int us_rep1))
(declare-fun temp_____aggregate_def_4276 ((Array Int us_rep) Int us_rep) (Array Int us_rep))
...
(assert (forall ((temp___4271 (Array Int us_rep1))) (forall ((temp___4272 Int)) (forall ((temp___4273 us_rep1)) (let ((temp___4270 (temp_____aggregate_def_4269 temp___4271 temp___4272 temp___4273))) (=> (dynamic_invariant1 temp___4272 true true true true) (forall ((temp___4274 Int)) (ite (= temp___4274 temp___4272) (= (select temp___4270 temp___4274) temp___4273) (= (select temp___4270 temp___4274) (select temp___4271 temp___4274))))))))))
(assert (forall ((temp___4278 (Array Int us_rep))) (forall ((temp___4279 Int)) (forall ((temp___4280 us_rep)) (let ((temp___4277 (temp_____aggregate_def_4276 temp___4278 temp___4279 temp___4280))) (=> (dynamic_invariant temp___4279 true true true true) (forall ((temp___4281 Int)) (ite (= temp___4281 temp___4279) (= (select temp___4277 temp___4281) temp___4280) (= (select temp___4277 temp___4281) (select temp___4278 temp___4281))))))))))
...
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (bool_eq3 a2 5 50 (temp_____aggregate_def_4269 a i (mk___rep1 (let ((usq_ (us_split_fields3 (select a i)))) (mk___split_fields1 (temp_____aggregate_def_4276 (rec__ar__rofaofr1__a1 (us_split_fields3 (select a i))) j (mk___rep (mk___split_fields (of_rep e) (rec__ar__rec1t__g1 (us_split_fields1 (select (rec__ar__rofaofr1__a1 (us_split_fields3 (select a i))) j)))))) (rec__ar__rofaofr1__b1 usq_) (rec__ar__rofaofr1__c1 usq_))))) 5 50) true)))
(check-sat)
(exit)
