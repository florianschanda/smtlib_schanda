...
(assert (forall ((x index)) (! (in_range (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun bool_eq1 ((a us_rep) (b us_rep)) Bool (ite (and (and (= (to_rep1 (rec__arrays_in_records__record_with_arrays__counter (us_split_fields1 a))) (to_rep1 (rec__arrays_in_records__record_with_arrays__counter (us_split_fields1 b)))) (= (bool_eq (rec__arrays_in_records__record_with_arrays__first_array (us_split_fields1 a)) 0 1001 (rec__arrays_in_records__record_with_arrays__first_array (us_split_fields1 b)) 0 1001) true)) (= (bool_eq (rec__arrays_in_records__record_with_arrays__second_array (us_split_fields1 a)) 0 1001 (rec__arrays_in_records__record_with_arrays__second_array (us_split_fields1 b)) 0 1001) true)) true false))
...
(assert (= (valueqtint rliteral2) 42))
...
(declare-const a__split_fields9 index)
(declare-const a__split_fields10 (Array Int value))
(declare-const a__split_fields11 (Array Int value))
(declare-const result9 index)
(declare-const result10 (Array Int value))
(declare-const result11 (Array Int value))
(declare-const a__split_fields12 index)
(declare-const a__split_fields13 (Array Int value))
(declare-const a__split_fields14 (Array Int value))
(declare-const a__split_fields15 index)
(declare-const a__split_fields16 (Array Int value))
(declare-const a__split_fields17 (Array Int value))
(declare-const a__split_fields18 index)
(declare-const a__split_fields19 (Array Int value))
(declare-const a__split_fields20 (Array Int value))
...
(assert (= a__split_fields a__split_fields3))
(assert (= a__split_fields1 a__split_fields4))
(assert (= (store a__split_fields2 23 rliteral) a__split_fields5))
(assert (= result3 a__split_fields3))
(assert (= result4 a__split_fields4))
(assert (= result5 a__split_fields5))
(assert (= a__split_fields3 a__split_fields6))
(assert (= (store a__split_fields4 17 rliteral1) a__split_fields7))
(assert (= a__split_fields5 a__split_fields8))
(assert (= result6 a__split_fields6))
(assert (= result7 a__split_fields7))
(assert (= result8 a__split_fields8))
(assert (= a__split_fields6 a__split_fields9))
(assert (= (store a__split_fields7 5 rliteral2) a__split_fields10))
(assert (= a__split_fields8 a__split_fields11))
(assert (= result9 a__split_fields9))
(assert (= result10 a__split_fields10))
(assert (= result11 a__split_fields11))
(assert (= rliteral3 a__split_fields12))
(assert (= a__split_fields10 a__split_fields13))
(assert (= a__split_fields11 a__split_fields14))
(assert (= (to_rep (select a__split_fields14 23)) 69))
(assert (= a__split_fields15 a__split_fields12))
(assert (= a__split_fields16 a__split_fields13))
(assert (= a__split_fields17 a__split_fields14))
(assert (= (mk___split_fields a__split_fields18 a__split_fields19 a__split_fields20) (mk___split_fields a__split_fields12 a__split_fields13 a__split_fields14)))
(assert (not (not (= (to_rep (select a__split_fields16 17)) 23))))
(check-sat)
(exit)
