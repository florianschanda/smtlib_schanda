...
(define-fun bool_eq ((a (Array Int value)) (a__first Int) (a__last Int) (b (Array Int value)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_132 Int)) (=> (and (<= a__first temp___idx_132) (<= temp___idx_132 a__last)) (= (to_rep1 (select a temp___idx_132)) (to_rep1 (select b (+ (- b__first a__first) temp___idx_132))))))) true false))
...
(define-fun dynamic_invariant ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= 0 1001)) (in_range temp___expr_142)))
(define-fun dynamic_invariant1 ((temp___expr_148 Int) (temp___is_init_145 Bool) (temp___skip_constant_146 Bool) (temp___do_toplevel_147 Bool)) Bool (=> (or (= temp___is_init_145 true) (<= (- 23) 69)) (in_range1 temp___expr_148)))
...
(declare-const temp___289 index)
(declare-const temp___2891 (Array Int value))
(declare-const temp___2892 (Array Int value))
...
(declare-const temp___292 index)
(declare-const temp___2921 (Array Int value))
(declare-const temp___2922 (Array Int value))
...
(declare-const temp___295 index)
(declare-const temp___2951 (Array Int value))
(declare-const temp___2952 (Array Int value))
(declare-const o15 index)
(declare-const o16 index)
(declare-const o17 (Array Int value))
(declare-const o18 (Array Int value))
(declare-const temp___297 index)
(declare-const temp___2971 (Array Int value))
(declare-const temp___2972 (Array Int value))
...
(assert (and (and (and (and (and (and (= (to_rep1 o) 69) (= o1 (store a__split_fields2 23 o))) (and (= a__split_fields o2) (and (= a__split_fields1 o3) (= o1 o4)))) (and (= temp___289 o2) (and (= temp___2891 o3) (= temp___2892 o4)))) (and (= (mk___split_fields__ref (mk___split_fields result result1 result2)) (mk___split_fields__ref (mk___split_fields a__split_fields a__split_fields1 a__split_fields2))) (and (= temp___289 a__split_fields3) (and (= temp___2891 a__split_fields4) (= temp___2892 a__split_fields5))))) (and (and (and (and (and (= (to_rep1 o5) 23) (= o6 (store a__split_fields4 17 o5))) (and (= a__split_fields3 o7) (and (= o6 o8) (= a__split_fields5 o9)))) (and (= temp___292 o7) (and (= temp___2921 o8) (= temp___2922 o9)))) (and (and (= result3 a__split_fields3) (and (= result4 a__split_fields4) (= result5 a__split_fields5))) (and (= temp___292 a__split_fields6) (and (= temp___2921 a__split_fields7) (= temp___2922 a__split_fields8))))) (and (and (and (and (and (= (to_rep1 o10) 42) (= o11 (store a__split_fields7 5 o10))) (and (= a__split_fields6 o12) (and (= o11 o13) (= a__split_fields8 o14)))) (and (= temp___295 o12) (and (= temp___2951 o13) (= temp___2952 o14)))) (and (and (= result6 a__split_fields6) (and (= result7 a__split_fields7) (= result8 a__split_fields8))) (= a__split_fields9 (mk___split_fields temp___295 temp___2951 temp___2952)))) (and (and (and (and (= (to_rep o15) 100) (and (= o15 o16) (and (= (rec__arrays_in_records__record_with_arrays__first_array a__split_fields9) o17) (= (rec__arrays_in_records__record_with_arrays__second_array a__split_fields9) o18)))) (and (= temp___297 o16) (and (= temp___2971 o17) (= temp___2972 o18)))) (and (= result9 (mk___split_fields__ref a__split_fields9)) (= a__split_fields10 (mk___split_fields temp___297 temp___2971 temp___2972)))) (= (to_rep1 (select (rec__arrays_in_records__record_with_arrays__second_array a__split_fields10) 23)) 69))))) (and (= a__split_fields11 (mk___split_fields__ref a__split_fields10)) (= a__split_fields12 a__split_fields10))))
