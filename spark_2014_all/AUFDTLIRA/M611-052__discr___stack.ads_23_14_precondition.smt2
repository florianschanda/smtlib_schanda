...
(declare-const temp___2861 t1)
(declare-const temp___285 (Array Int integer))
(declare-const temp___2851 t1)
...
(define-fun temp___2852 () us_t1 (mk___t1 temp___285 temp___2851))
(define-fun temp___2862 () us_t1 (mk___t1 temp___286 temp___2861))
...
(assert (and (= temp___2862 (to__ (mk___rep s__split_discrs (mk___split_fields s__split_fields (mk___t s__split_fields1 s__split_fields2))))) (and (dynamic_invariant2 temp___2862 true false true true) (and (= s__split_fields1 temp___286) (= (mk1 (to_rep (first4 (mk2 1 (to_rep1 s__split_fields)))) (to_rep (last4 (mk2 1 (to_rep1 s__split_fields))))) temp___2861)))))
(assert (and (= temp___2852 (to_but_top (mk___rep s__split_discrs (us_split_fields__content s__split_fields5)))) (and (dynamic_invariant2 temp___2852 true false true true) (and (= (elts (rec__stack__stack__content (us_split_fields__content s__split_fields5))) temp___285) (= (mk1 (to_rep (first6 (mk3 1 (- (to_rep1 (rec__stack__stack__top (us_split_fields__content s__split_fields5))) 1)))) (to_rep (last6 (mk3 1 (- (to_rep1 (rec__stack__stack__top (us_split_fields__content s__split_fields5))) 1))))) temp___2851)))))
(assert (= o13 (bool_eq temp___285 (to_rep (first2 temp___2851)) (to_rep (last2 temp___2851)) temp___286 (to_rep (first2 temp___2861)) (to_rep (last2 temp___2861)))))
(assert (not (not (= (is_empty (mk___rep s__split_discrs (us_split_fields__content s__split_fields5))) true))))
(check-sat)
(exit)
