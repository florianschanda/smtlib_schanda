...
(define-fun temp___2572 () us_t1 (mk___t1 temp___257 temp___2571))
(define-fun temp___2582 () us_t1 (mk___t1 temp___258 temp___2581))
...
(assert (and (= temp___2582 (to__ (mk___rep s__split_discrs (mk___split_fields s__split_fields (mk___t s__split_fields1 s__split_fields2))))) (and (dynamic_invariant2 temp___2582 true false true) (and (= s__split_fields1 temp___258) (= (mk1 (to_rep (first4 (mk2 1 (to_rep1 s__split_fields)))) (to_rep (last4 (mk2 1 (to_rep1 s__split_fields))))) temp___2581)))))
(assert (and (= temp___2572 (to_but_top (mk___rep s__split_discrs (us_split_fields__content s__split_fields5)))) (and (dynamic_invariant2 temp___2572 true false true) (and (= (elts (rec__stack__stack__content (us_split_fields__content s__split_fields5))) temp___257) (= (mk1 (to_rep (first6 (mk3 1 (- (to_rep1 (rec__stack__stack__top (us_split_fields__content s__split_fields5))) 1)))) (to_rep (last6 (mk3 1 (- (to_rep1 (rec__stack__stack__top (us_split_fields__content s__split_fields5))) 1))))) temp___2571)))))
(assert (= o13 (bool_eq temp___257 (to_rep (first2 temp___2571)) (to_rep (last2 temp___2571)) temp___258 (to_rep (first2 temp___2581)) (to_rep (last2 temp___2581)))))
