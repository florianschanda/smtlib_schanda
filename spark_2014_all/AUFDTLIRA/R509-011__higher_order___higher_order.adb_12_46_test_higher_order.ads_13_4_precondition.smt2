...
(assert (= r1 o3))
(assert (forall ((k1 Int)) (=> (and (<= (to_rep1 (first4 (rt2 a))) k1) (<= k1 i2)) (= (to_rep (select r2 k1)) (add_one (to_rep (select (elts2 a) k1)))))))
...
(assert (<= (to_rep1 (first4 (rt2 a))) k))
(assert (<= k i2))
(assert (and (<= (to_rep1 (first4 (rt2 a))) k) (<= k (to_rep1 (last4 (rt2 a))))))
(assert (= o4 k))
(assert (= o5 (select (elts2 a) o4)))
(assert (= o6 (to_rep o5)))
