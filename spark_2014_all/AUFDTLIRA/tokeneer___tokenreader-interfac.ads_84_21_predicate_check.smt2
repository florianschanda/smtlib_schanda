...
(define-fun dynamic_invariant1 ((temp___expr_2071 Int) (temp___is_init_2067 Bool) (temp___skip_constant_2068 Bool) (temp___do_toplevel_2069 Bool) (temp___do_typ_inv_2070 Bool)) Bool (=> (or (= temp___is_init_2067 true) (<= 0 20)) (in_range3 temp___expr_2071)))
(declare-const x Int)
...
(declare-const temp___2098 (Array Int character))
(declare-const temp___20981 t1)
(assert (in_range3 x))
...
(assert (= (elts (to_string (attr__ATTRIBUTE_IMAGE3 x))) temp___2098))
(assert (= (mk1 (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 x))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 x)))))) temp___20981))
(assert (not (dynamic_predicate (mk___t1 temp___2098 temp___20981))))
(check-sat)
(exit)
