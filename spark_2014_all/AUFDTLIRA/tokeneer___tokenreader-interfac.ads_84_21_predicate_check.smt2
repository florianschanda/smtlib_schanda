...
(define-fun dynamic_invariant1 ((temp___expr_1812 Int) (temp___is_init_1809 Bool) (temp___skip_constant_1810 Bool) (temp___do_toplevel_1811 Bool)) Bool (=> (or (= temp___is_init_1809 true) (<= 0 20)) (in_range3 temp___expr_1812)))
(declare-const x Int)
...
(assert (= (elts (to_string (attr__ATTRIBUTE_IMAGE3 x))) temp___1836))
(assert (= (mk1 (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 x))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 x)))))) temp___18361))
(assert (not (dynamic_predicate (mk___t1 temp___1836 temp___18361))))
(check-sat)
(exit)
