...
(define-fun dynamic_invariant1 ((temp___expr_1868 Int) (temp___is_init_1865 Bool) (temp___skip_constant_1866 Bool) (temp___do_toplevel_1867 Bool)) Bool (=> (or (= temp___is_init_1865 true) (<= 0 20)) (in_range3 temp___expr_1868)))
(declare-const x Int)
...
(assert (= (elts (to_string (attr__ATTRIBUTE_IMAGE3 x))) temp___1892))
(assert (= (mk1 (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 x))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 x)))))) temp___18921))
(assert (not (dynamic_predicate (mk___t1 temp___1892 temp___18921))))
(check-sat)
(exit)
