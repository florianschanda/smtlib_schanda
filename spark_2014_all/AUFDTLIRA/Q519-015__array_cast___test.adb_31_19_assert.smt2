...
(define-fun o13 () us_rep (mk___rep (mk___split_discrs o10) (mk___split_fields o11)))
(define-fun o14 () us_rep (mk___rep (mk___split_discrs o8) (mk___split_fields o9)))
(define-fun o15 () us_rep (mk___rep (mk___split_discrs o6) (mk___split_fields o7)))
...
(assert (= o4 o3))
(assert (= o5 o2))
(assert (= o15 (mk___rep (mk___split_discrs o4) (mk___split_fields o5))))
(assert (= o14 o15))
(assert (= o13 o14))
(assert (= o12 (test__w__aggregate_def o13)))
