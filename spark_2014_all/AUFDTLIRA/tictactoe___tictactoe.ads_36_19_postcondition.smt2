...
(declare-fun temp___732 ((Array Int slot)) (Array Int (Array Int slot)))
(assert (forall ((temp___734 (Array Int slot))) (forall ((temp___735 Int)) (= (select (temp___732 temp___734) temp___735) temp___734))))
(declare-fun temp___736 (Int) (Array Int slot))
(assert (forall ((temp___738 Int)) (forall ((temp___739 Int)) (= (select (temp___736 temp___738) temp___739) (of_rep temp___738)))))
...
(define-fun dynamic_invariant2 ((temp___expr_513 Int) (temp___is_init_510 Bool) (temp___skip_constant_511 Bool) (temp___do_toplevel_512 Bool)) Bool (=> (or (= temp___is_init_510 true) (<= 0 2)) (in_range temp___expr_513)))
(declare-sort pos 0)
...
(assert (= my_board1 (temp___732 (temp___736 0))))
