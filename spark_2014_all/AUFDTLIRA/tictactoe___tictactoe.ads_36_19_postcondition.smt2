...
(declare-fun temp_____aggregate_def_804 ((Array Int slot)) (Array Int (Array Int slot)))
(declare-fun temp_____aggregate_def_808 (Int) (Array Int slot))
...
(assert (forall ((temp___806 (Array Int slot))) (forall ((temp___807 Int)) (= (select (temp_____aggregate_def_804 temp___806) temp___807) temp___806))))
(define-fun dynamic_invariant2 ((temp___expr_577 Int) (temp___is_init_573 Bool) (temp___skip_constant_574 Bool) (temp___do_toplevel_575 Bool) (temp___do_typ_inv_576 Bool)) Bool (=> (or (= temp___is_init_573 true) (<= 0 2)) (in_range temp___expr_577)))
(assert (forall ((temp___810 Int)) (=> (dynamic_invariant2 temp___810 true true true true) (forall ((temp___811 Int)) (= (to_rep (select (temp_____aggregate_def_808 temp___810) temp___811)) temp___810)))))
(declare-sort pos 0)
...
(assert (= my_board1 (temp_____aggregate_def_804 (temp_____aggregate_def_808 0))))
