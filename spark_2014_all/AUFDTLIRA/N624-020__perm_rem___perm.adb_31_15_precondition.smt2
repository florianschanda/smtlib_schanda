...
(assert (and (<= (to_rep1 (first (rt a))) ia) (<= ia (to_rep1 (last (rt a))))))
(assert (= o25 ia))
(assert (= o26 (select (elts a) o25)))
(assert (= o30 (to_rep o26)))
(assert (= result7 (ite (= o30 o29) true false)))
(assert (= result7 true))
(assert (and (= o22 kb) (in_range2 kb)))
(assert (and (= (mk___t o23 o24) (remove b o22)) (and (dynamic_invariant1 (mk___t o23 o24) true false true) (and (= (invariant__ (mk___t o23 o24)) true) (and (= (to_rep1 (last o24)) (- (to_rep1 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o22 1))) (= (to_rep (select (elts b) k)) (to_rep (select o23 k))))) (and (forall ((k Int)) (=> (and (<= (+ o22 1) k) (<= k (to_rep1 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select o23 (- k 1)))))) (forall ((k Int)) (=> (and (<= o22 k) (<= k (- (to_rep1 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o23 k))))))))))))
(assert (and (= (mk___t o20 o21) (remove a ia)) (and (dynamic_invariant1 (mk___t o20 o21) true false true) (and (= (invariant__ (mk___t o20 o21)) true) (and (= (to_rep1 (last o21)) (- (to_rep1 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ia 1))) (= (to_rep (select (elts a) k)) (to_rep (select o20 k))))) (and (forall ((k Int)) (=> (and (<= (+ ia 1) k) (<= k (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select o20 (- k 1)))))) (forall ((k Int)) (=> (and (<= ia k) (<= k (- (to_rep1 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select o20 k))))))))))))
