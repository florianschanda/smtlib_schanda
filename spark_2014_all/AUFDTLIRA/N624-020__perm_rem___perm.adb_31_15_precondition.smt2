...
(define-fun o21 () us_t (mk___t o3 o4))
(define-fun o22 () us_t (mk___t o o1))
...
(assert (=> (= result2 true) (and (= o21 (remove b o2)) (and (dynamic_invariant1 o21 true false true true) (and (= (invariant__ o21) true) (and (= (to_rep1 (last o4)) (- (to_rep1 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o2 1))) (= (to_rep (select (elts b) k)) (to_rep (select o3 k))))) (and (forall ((k Int)) (=> (and (<= (+ o2 1) k) (<= k (to_rep1 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select o3 (- k 1)))))) (forall ((k Int)) (=> (and (<= o2 k) (<= k (- (to_rep1 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o3 k)))))))))))))
(assert (=> (= result2 true) (and (= o22 (remove a ia)) (and (dynamic_invariant1 o22 true false true true) (and (= (invariant__ o22) true) (and (= (to_rep1 (last o1)) (- (to_rep1 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ia 1))) (= (to_rep (select (elts a) k)) (to_rep (select o k))))) (and (forall ((k Int)) (=> (and (<= (+ ia 1) k) (<= k (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select o (- k 1)))))) (forall ((k Int)) (=> (and (<= ia k) (<= k (- (to_rep1 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select o k)))))))))))))
(assert (=> (= result2 true) (and (= result1 (is_perm o22 o21)) (= (= result1 true) (or (and (= (length o22) 0) (= (length o21) 0)) (exists ((ia1 Int)) (and (and (<= (to_rep1 (first o1)) ia1) (<= ia1 (to_rep1 (last o1)))) (exists ((ib3 Int)) (and (and (<= (to_rep1 (first o4)) ib3) (<= ib3 (to_rep1 (last o4)))) (and (= (to_rep (select o ia1)) (to_rep (select o3 ib3))) (= (is_perm (remove o22 ia1) (remove o21 ib3)) true)))))))))))
...
(assert (= result3 (ite (= o18 o17) true false)))
(assert (= result3 true))
(assert (and (= o10 kb) (in_range2 kb)))
(assert (and (= o19 (remove b o10)) (and (dynamic_invariant1 o19 true false true true) (and (= (invariant__ o19) true) (and (= (to_rep1 (last o12)) (- (to_rep1 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o10 1))) (= (to_rep (select (elts b) k)) (to_rep (select o11 k))))) (and (forall ((k Int)) (=> (and (<= (+ o10 1) k) (<= k (to_rep1 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select o11 (- k 1)))))) (forall ((k Int)) (=> (and (<= o10 k) (<= k (- (to_rep1 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o11 k))))))))))))
(assert (and (= o20 (remove a ia)) (and (dynamic_invariant1 o20 true false true true) (and (= (invariant__ o20) true) (and (= (to_rep1 (last o9)) (- (to_rep1 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ia 1))) (= (to_rep (select (elts a) k)) (to_rep (select o8 k))))) (and (forall ((k Int)) (=> (and (<= (+ ia 1) k) (<= k (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select o8 (- k 1)))))) (forall ((k Int)) (=> (and (<= ia k) (<= k (- (to_rep1 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select o8 k))))))))))))
