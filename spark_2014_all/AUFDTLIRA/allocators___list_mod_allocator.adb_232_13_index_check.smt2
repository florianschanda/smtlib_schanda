...
(define-fun o27 () us_rep3 (mk___rep1 (mk___split_fields1 o22 o23)))
(define-fun o28 () us_rep3 (mk___rep1 (mk___split_fields1 o17 o18)))
(define-fun o29 () us_rep3 (mk___rep1 (mk___split_fields1 o13 o14)))
...
(assert (and (= o29 (model__ (map__content data6) first_available1)) (= (model_is_well_formed o29 (map__content data6) first_available1) true)))
(assert (= o13 o15))
(assert (= o14 o16))
...
(assert (and (= o27 (model__ (map__content data6) first_available1)) (= (model_is_well_formed o27 (map__content data6) first_available1) true)))
(assert (= o24 (mk___split_fields1 o22 o23)))
(assert (= o25 (rec__list_mod_allocator__m__t__available o24)))
(assert (and (= o26 (length o25)) (and (in_range4 o26) (<= (+ 0 o26) 2147483647))))
(assert (and (= o28 (model__ (map__content data6) first_available1)) (= (model_is_well_formed o28 (map__content data6) first_available1) true)))
(assert (= o17 o19))
(assert (= o18 o20))
(assert (= o21 o19))
(assert (and (= temp___302 (get o21 o26)) (in_range5 temp___302)))
(assert (not (<= temp___302 10000)))
(check-sat)
(exit)
