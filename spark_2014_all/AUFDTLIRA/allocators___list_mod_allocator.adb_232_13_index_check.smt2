...
(define-fun o28 () us_rep3 (mk___rep1 (mk___split_fields1 o23 o24)))
(define-fun o29 () us_rep3 (mk___rep1 (mk___split_fields1 o18 o19)))
(define-fun o30 () us_rep3 (mk___rep1 (mk___split_fields1 o14 o15)))
...
(assert (and (= o30 (model__ (map__content data6) first_available1)) (= (model_is_well_formed o30 (map__content data6) first_available1) true)))
(assert (= o14 o16))
(assert (= o15 o17))
...
(assert (= o25 (mk___split_fields1 o23 o24)))
(assert (= o26 (rec__list_mod_allocator__m__t__available o25)))
(assert (and (= o27 (length o26)) (and (in_range6 o27) (<= (+ 0 o27) 2147483647))))
...
(assert (= o19 o21))
(assert (= o22 o20))
(assert (and (= temp___302 (get o22 o27)) (in_range7 temp___302)))
(assert (not (<= 1 temp___302)))
(check-sat)
(exit)
