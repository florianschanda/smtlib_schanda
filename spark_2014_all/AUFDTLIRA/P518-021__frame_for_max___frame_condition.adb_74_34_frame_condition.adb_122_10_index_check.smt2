...
(assert (and (= o62 (get_max_left o61 (map__content a8))) (and (in_range2 o62) (= o62 (to_rep (rec__frame_condition__cell__max_left (us_split_fields1 (select (map__content a8) o61))))))))
