...
(define-fun dynamic_invariant1 ((temp___expr_222 Int) (temp___is_init_219 Bool) (temp___skip_constant_220 Bool) (temp___do_toplevel_221 Bool)) Bool (=> (or (= temp___is_init_219 true) (<= 0 3)) (in_range10 temp___expr_222)))
...
(define-fun dynamic_invariant2 ((temp___expr_293 Int) (temp___is_init_290 Bool) (temp___skip_constant_291 Bool) (temp___do_toplevel_292 Bool)) Bool (=> (or (= temp___is_init_290 true) (<= 1 64)) (in_range13 temp___expr_293)))
...
(declare-fun temp___354 (Int Int Int) us_t1)
(assert (forall ((temp___356 Int) (temp___357 Int) (temp___358 Int)) (let ((temp___355 (temp___354 temp___356 temp___357 temp___358))) (and (=> (dynamic_property 1 2147483647 temp___357 temp___358) (and (= (first3 temp___355) temp___357) (= (last3 temp___355) temp___358))) (forall ((temp___359 Int)) (= (select (to_array1 temp___355) temp___359) (of_rep temp___356)))))))
...
(define-fun dynamic_invariant6 ((temp___expr_251 Int) (temp___is_init_248 Bool) (temp___skip_constant_249 Bool) (temp___do_toplevel_250 Bool)) Bool (=> (or (= temp___is_init_248 true) (<= 1 128)) (in_range12 temp___expr_251)))
(define-fun dynamic_invariant7 ((temp___expr_257 Int) (temp___is_init_254 Bool) (temp___skip_constant_255 Bool) (temp___do_toplevel_256 Bool)) Bool (=> (or (= temp___is_init_254 true) (<= 0 128)) (in_range11 temp___expr_257)))
...
(declare-const temp___350 Bool)
(declare-const o Int)
(declare-const o1 Int)
(declare-const temp___361 (Array Int character))
(declare-const temp___3611 t1)
...
(declare-const temp___362 (Array Int character))
(declare-const temp___3621 t)
(declare-const o8 (Array Int character))
(declare-const o9 (Array Int character))
(declare-const o10 description_count_type)
(declare-const o11 day_type)
(declare-const o12 month_type)
(declare-const o13 year_type)
(declare-const o14 hour_type)
(declare-const o15 minute_type)
(declare-const o16 second_type)
(declare-const o17 Bool)
(declare-const o18 (Array Int character))
(declare-const o19 description_count_type)
(declare-const o20 day_type)
(declare-const o21 month_type)
(declare-const o22 year_type)
(declare-const o23 hour_type)
(declare-const o24 minute_type)
(declare-const o25 second_type)
(declare-const o26 Bool)
(declare-const o27 (Array Int us_rep3))
...
(declare-const event_array1 (Array Int us_rep3))
