...
(declare-fun temp___397 (Int Int Int) us_t1)
...
(assert (forall ((temp___399 Int) (temp___400 Int) (temp___401 Int)) (let ((temp___398 (temp___397 temp___399 temp___400 temp___401))) (=> (dynamic_invariant4 temp___399 true true true true) (and (=> (dynamic_property 1 2147483647 temp___400 temp___401) (and (= (first3 temp___398) temp___400) (= (last3 temp___398) temp___401))) (forall ((temp___402 Int)) (= (to_rep (select (to_array1 temp___398) temp___402)) temp___399)))))))
...
(assert (= index1 1))
(assert (=> (and (<= 1 index1) (<= index1 64)) (= temp___394 available1)))
(assert (=> (and (<= 1 index1) (<= index1 64)) (= temp___393 found1)))
