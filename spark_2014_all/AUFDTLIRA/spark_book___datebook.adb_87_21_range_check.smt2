...
(define-fun dynamic_invariant1 ((temp___expr_257 Int) (temp___is_init_253 Bool) (temp___skip_constant_254 Bool) (temp___do_toplevel_255 Bool) (temp___do_typ_inv_256 Bool)) Bool (=> (or (= temp___is_init_253 true) (<= 0 3)) (in_range10 temp___expr_257)))
...
(define-fun in_range12 ((x Int)) Bool (and (<= 1 x) (<= x 128)))
(declare-fun attr__ATTRIBUTE_IMAGE12 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check12 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE12 (us_image) Int)
(declare-fun user_eq17 (description_index_type description_index_type) Bool)
(declare-const dummy17 description_index_type)
...
(define-fun in_range13 ((x Int)) Bool (and (<= 1 x) (<= x 64)))
(declare-fun attr__ATTRIBUTE_IMAGE13 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check13 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE13 (us_image) Int)
(declare-fun user_eq18 (event_index_type event_index_type) Bool)
(declare-const dummy18 event_index_type)
...
(define-fun dynamic_invariant2 ((temp___expr_333 Int) (temp___is_init_329 Bool) (temp___skip_constant_330 Bool) (temp___do_toplevel_331 Bool) (temp___do_typ_inv_332 Bool)) Bool (=> (or (= temp___is_init_329 true) (<= 1 64)) (in_range13 temp___expr_333)))
...
(declare-const dummy20 us_t1)
(declare-datatypes () ((t9b__ref (mk_t9b__ref (t9b__content us_t1)))))
(define-fun t9b__ref___projection ((a t9b__ref)) us_t1 (t9b__content a))
(declare-fun temp_____aggregate_def_397 (Int Int Int) us_t1)
...
(define-fun dynamic_invariant6 ((temp___expr_287 Int) (temp___is_init_283 Bool) (temp___skip_constant_284 Bool) (temp___do_toplevel_285 Bool) (temp___do_typ_inv_286 Bool)) Bool (=> (or (= temp___is_init_283 true) (<= 1 128)) (in_range12 temp___expr_287)))
(define-fun dynamic_invariant7 ((temp___expr_294 Int) (temp___is_init_290 Bool) (temp___skip_constant_291 Bool) (temp___do_toplevel_292 Bool) (temp___do_typ_inv_293 Bool)) Bool (=> (or (= temp___is_init_290 true) (<= 0 128)) (in_range11 temp___expr_294)))
(assert (forall ((temp___399 Int) (temp___400 Int) (temp___401 Int)) (let ((temp___398 (temp_____aggregate_def_397 temp___399 temp___400 temp___401))) (=> (dynamic_invariant4 temp___399 true true true true) (and (=> (dynamic_property 1 2147483647 temp___400 temp___401) (and (= (first3 temp___398) temp___400) (= (last3 temp___398) temp___401))) (forall ((temp___402 Int)) (= (to_rep (select (to_array1 temp___398) temp___402)) temp___399)))))))
...
(assert (= index1 1))
(assert (=> (and (<= 1 index1) (<= index1 64)) (= temp___396 available1)))
(assert (=> (and (<= 1 index1) (<= index1 64)) (= temp___395 found1)))
(assert (=> (and (<= 1 index1) (<= index1 64)) (and (=> (<= 1 64) (in_range13 available2)) (and (<= 1 index2) (<= index2 64)))))
(assert (=> (and (<= 1 index1) (<= index1 64)) (or (and (and (and (= available4 (mk_int__ref available3)) (= found4 (mk_bool__ref found3))) (and (= available5 available3) (= found5 found3))) (and (not (= (rec__datebook__event_record__is_used (us_split_fields7 (select event_array index2))) true)) (and (and (= result3 (mk_int__ref available2)) (= available3 index2)) (and (= result4 (mk_bool__ref found2)) (= found3 (distinct 1 0)))))) (and (and (= (rec__datebook__event_record__is_used (us_split_fields7 (select event_array index2))) true) (and (= available3 available2) (= found3 found2))) (and (and (and (= available4 (mk_int__ref available3)) (= found4 (mk_bool__ref found3))) (and (= available5 available3) (= found5 found3))) (= index2 64))))))
(assert (=> (and (<= 1 index1) (<= index1 64)) (= index3 (mk_int__ref index2))))
(assert (=> (and (<= 1 index1) (<= index1 64)) (= available6 available4)))
(assert (=> (and (<= 1 index1) (<= index1 64)) (= found6 found4)))
(assert (=> (and (<= 1 index1) (<= index1 64)) (= index4 index2)))
(assert (=> (and (<= 1 index1) (<= index1 64)) (= available7 available5)))
(assert (=> (and (<= 1 index1) (<= index1 64)) (= found7 found5)))
(assert (=> (and (<= 1 index1) (<= index1 64)) (= index5 index3)))
(assert (=> (and (<= 1 index1) (<= index1 64)) (= available8 available6)))
(assert (=> (and (<= 1 index1) (<= index1 64)) (= found8 found6)))
(assert (=> (and (<= 1 index1) (<= index1 64)) (= index6 index4)))
(assert (=> (and (<= 1 index1) (<= index1 64)) (= available9 available7)))
(assert (=> (and (<= 1 index1) (<= index1 64)) (= found9 found7)))
(assert (=> (not (and (<= 1 index1) (<= index1 64))) (= index5 (mk_int__ref index1))))
(assert (=> (not (and (<= 1 index1) (<= index1 64))) (= available8 (mk_int__ref available1))))
(assert (=> (not (and (<= 1 index1) (<= index1 64))) (= found8 (mk_bool__ref found1))))
(assert (=> (not (and (<= 1 index1) (<= index1 64))) (= index6 index1)))
(assert (=> (not (and (<= 1 index1) (<= index1 64))) (= available9 available1)))
(assert (=> (not (and (<= 1 index1) (<= index1 64))) (= found9 found1)))
(assert (= (bool__content found8) true))
(assert (<= 1 (- 128 (length description))))
(assert (not (<= (- 128 (length description)) 2147483647)))
(check-sat)
(exit)
