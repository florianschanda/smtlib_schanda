...
(declare-const i Int)
(declare-const temp___292 (Array Int integer))
...
(assert (=> (and (<= (- 2147483648) i1) (<= i1 2147483647)) (and (and (= temp___292 a) (and (= temp___291 i1) (and (and (and (= (to_rep o) (to_rep (select b i1))) (= o1 (store a i1 o))) (and (= (mk_map__ref result1) (mk_map__ref a)) (= a2 o1))) (and (forall ((j Int)) (=> (and (<= (- 2147483648) j) (<= j i2)) (= (to_rep (select a3 j)) (to_rep (select b j))))) (and (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 i2)) (forall ((temp___293 Int)) (=> (and (<= (- 2147483648) temp___293) (<= temp___293 2147483647)) (=> (< i2 temp___293) (= (select a3 temp___293) (select temp___292 temp___293)))))) (and (<= (- 2147483648) i2) (<= i2 2147483647))) (= i2 2147483647)))))) (and (and (= i2 i6) (= a3 a7)) (and (= i7 i2) (= a8 a3))))))
(assert (=> (and (<= (- 2147483648) i1) (<= i1 2147483647)) (= (mk_int__ref i8) (mk_int__ref i6))))
(assert (=> (and (<= (- 2147483648) i1) (<= i1 2147483647)) (= (mk_map__ref a9) (mk_map__ref a7))))
(assert (=> (and (<= (- 2147483648) i1) (<= i1 2147483647)) (= i9 i7)))
(assert (=> (and (<= (- 2147483648) i1) (<= i1 2147483647)) (= a10 a8)))
(assert (=> (not (and (<= (- 2147483648) i1) (<= i1 2147483647))) (= i1 i8)))
(assert (=> (not (and (<= (- 2147483648) i1) (<= i1 2147483647))) (= (mk_map__ref a9) (mk_map__ref a))))
(assert (=> (not (and (<= (- 2147483648) i1) (<= i1 2147483647))) (= i9 i1)))
(assert (=> (not (and (<= (- 2147483648) i1) (<= i1 2147483647))) (= a10 a1)))
(assert (= i10 i8))
(assert (= (mk_map__ref a11) (mk_map__ref a9)))
(assert (= i11 i9))
(assert (= a12 a10))
(assert (not (= (bool_eq a11 (- 2147483648) 2147483647 b (- 2147483648) 2147483647) true)))
(check-sat)
(exit)
