...
(declare-const i Int)
(declare-const temp___319 (Array Int integer))
...
(assert (=> (and (<= (- 2147483648) i1) (<= i1 2147483647)) (= temp___319 a)))
(assert (=> (and (<= (- 2147483648) i1) (<= i1 2147483647)) (= temp___318 i1)))
...
(assert (=> (and (<= (- 2147483648) i1) (<= i1 2147483647)) (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 i2)) (forall ((temp___320 Int)) (=> (and (<= (- 2147483648) temp___320) (<= temp___320 2147483647)) (=> (< i2 temp___320) (= (select a3 temp___320) (select temp___319 temp___320)))))) (and (<= (- 2147483648) i2) (<= i2 2147483647)))))
