...
(assert (=> (and (<= (- 2147483648) i1) (<= i1 2147483647)) (= temp___292 a)))
(assert (=> (and (<= (- 2147483648) i1) (<= i1 2147483647)) (= temp___291 i1)))
...
(assert (=> (and (<= (- 2147483648) i1) (<= i1 2147483647)) (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 i2)) (forall ((temp___293 Int)) (=> (and (<= (- 2147483648) temp___293) (<= temp___293 2147483647)) (=> (< i2 temp___293) (= (select a3 temp___293) (select temp___292 temp___293)))))) (and (<= (- 2147483648) i2) (<= i2 2147483647)))))
