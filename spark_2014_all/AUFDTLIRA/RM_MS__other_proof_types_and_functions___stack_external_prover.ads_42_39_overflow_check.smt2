...
(assert (and (= o12 (count (mk___split_fields my_stack__split_fields6 my_stack__split_fields7))) (in_range2 o12)))
(assert (and (= o13 (stack_entry o12 (mk___split_fields my_stack__split_fields6 my_stack__split_fields7))) (in_range1 o13)))
(assert (= o14 (ite (= o13 x) true false)))
(assert (and (= o9 (max_stack_size Tuple0)) (in_range2 o9)))
(assert (and (= o10 (count (mk___split_fields my_stack__split_fields6 my_stack__split_fields7))) (in_range2 o10)))
