...
(assert (and (= o13 (count (mk___split_fields my_stack__split_fields6 my_stack__split_fields7))) (in_range2 o13)))
(assert (and (= o14 (stack_entry o13 (mk___split_fields my_stack__split_fields6 my_stack__split_fields7))) (in_range1 o14)))
(assert (= o15 (ite (= o14 x) true false)))
(assert (and (= o10 (max_stack_size Tuple0)) (in_range2 o10)))
(assert (and (= o11 (count (mk___split_fields my_stack__split_fields6 my_stack__split_fields7))) (in_range2 o11)))
(assert (= o12 (ite (<= o11 o10) true false)))
(assert (not (in_range1 (+ (count (mk___split_fields my_stack__split_fields my_stack__split_fields1)) 1))))
(check-sat)
(exit)
