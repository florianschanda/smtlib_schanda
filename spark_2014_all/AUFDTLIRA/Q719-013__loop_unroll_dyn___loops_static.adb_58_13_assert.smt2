...
(assert (=> (and (<= (to_rep1 a__first) j1) (<= j1 i1)) (= temp___299 bad1)))
...
(assert (=> (and (<= (to_rep1 a__first) j1) (<= j1 i1)) (= o3 j2)))
(assert (=> (and (<= (to_rep1 a__first) j1) (<= j1 i1)) (= o4 (select a1 o3))))
(assert (=> (and (<= (to_rep1 a__first) j1) (<= j1 i1)) (= o5 (to_rep o4))))
(assert (=> (and (<= (to_rep1 a__first) j1) (<= j1 i1)) (= o6 (ite (= o5 0) true false))))
(assert (=> (and (<= (to_rep1 a__first) j1) (<= j1 i1)) (= result4 (ite (not (= o6 true)) true false))))
(assert (=> (and (<= (to_rep1 a__first) j1) (<= j1 i1)) (=> (= result4 true) (= bad2 result5))))
(assert (=> (and (<= (to_rep1 a__first) j1) (<= j1 i1)) (=> (= result4 true) (= bad3 (of_int 1)))))
