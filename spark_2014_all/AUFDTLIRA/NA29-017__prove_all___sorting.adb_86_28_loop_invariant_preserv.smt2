...
(assert (=> (= result2 true) (and (= temp___288 (+ a_first i2)) (in_range1 (+ a_first i2)))))
(assert (=> (= result2 true) (and (<= (to_rep a__first) temp___288) (<= temp___288 (to_rep a__last)))))
(assert (=> (= result2 true) (= o10 temp___288)))
...
(assert (=> (= result2 true) (and (= temp___289 o9) (in_range1 o9))))
(assert (=> (= result2 true) (and (<= (to_rep b__first) temp___289) (<= temp___289 (to_rep b__last)))))
(assert (=> (= result2 true) (= o14 temp___289)))
...
(assert (=> (not (= result2 true)) (and (= temp___284 o20) (in_range1 o20))))
(assert (=> (not (= result2 true)) (and (<= (to_rep a__first) temp___284) (<= temp___284 (to_rep a__last)))))
(assert (=> (not (= result2 true)) (= o21 temp___284)))
...
(assert (=> (not (= result2 true)) (and (= temp___285 o18) (in_range1 o18))))
(assert (=> (not (= result2 true)) (and (<= (to_rep b__first) temp___285) (<= temp___285 (to_rep b__last)))))
(assert (=> (not (= result2 true)) (= o25 temp___285)))
