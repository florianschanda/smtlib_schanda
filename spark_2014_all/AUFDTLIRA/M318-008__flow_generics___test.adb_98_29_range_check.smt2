...
(define-fun dynamic_invariant ((temp___expr_290 us_rep) (temp___is_init_287 Bool) (temp___skip_constant_288 Bool) (temp___do_toplevel_289 Bool)) Bool (and (=> (not (= temp___skip_constant_288 true)) (in_range2 0 temp___expr_290)) (= (attr__constrained temp___expr_290) true)))
...
(assert (forall ((temp___396 Int) (temp___397 Int) (temp___398 Int) (temp___399 Int) (temp___400 Int)) (let ((temp___395 (temp___394 temp___396 temp___397 temp___398 temp___399 temp___400))) (and (and (and (and (= (select temp___395 1) (of_rep1 temp___396)) (= (select temp___395 2) (of_rep1 temp___397))) (= (select temp___395 3) (of_rep1 temp___398))) (= (select temp___395 4) (of_rep1 temp___399))) (= (select temp___395 5) (of_rep1 temp___400))))))
(declare-fun temp___402 (Int Int Int Int Int) (Array Int item_t))
(assert (forall ((temp___404 Int) (temp___405 Int) (temp___406 Int) (temp___407 Int) (temp___408 Int)) (let ((temp___403 (temp___402 temp___404 temp___405 temp___406 temp___407 temp___408))) (and (and (and (and (= (select temp___403 1) (of_rep1 temp___404)) (= (select temp___403 2) (of_rep1 temp___405))) (= (select temp___403 3) (of_rep1 temp___406))) (= (select temp___403 4) (of_rep1 temp___407))) (= (select temp___403 5) (of_rep1 temp___408))))))
...
(define-fun dynamic_invariant2 ((temp___expr_239 Int) (temp___is_init_236 Bool) (temp___skip_constant_237 Bool) (temp___do_toplevel_238 Bool)) Bool (=> (or (= temp___is_init_236 true) (<= 0 9)) (in_range1 temp___expr_239)))
