...
(declare-const temp___238 us_rep2)
...
(assert (=> (= (attr__constrained (select (elts1 (rec__dynamic_array__holder__content1 h__split_fields3)) i2)) true) (= (rec__dynamic_array__rec__b (us_split_discrs1 temp___232)) (rec__dynamic_array__rec__b (us_split_discrs1 (select (elts1 (rec__dynamic_array__holder__content1 h__split_fields3)) i2))))))
(assert (= usq_4 temp___232))
...
(assert (= temp___238 (mk___rep2 h__split_discrs o27)))
(assert (= result5 (mk___split_fields__ref2 h__split_fields3)))
(assert (= h__split_fields4 (us_split_fields5 temp___238)))
(assert (= h__split_discrs (us_split_discrs4 temp___238)))
(assert (not (= i2 c)))
...
(assert (<= 1 j))
(assert (<= j (- i3 1)))
(assert (not (= (rec__dynamic_array__rec__b (us_split_discrs1 (select (elts1 (rec__dynamic_array__holder__content1 h__split_fields4)) j))) true)))
(check-sat)
(exit)
