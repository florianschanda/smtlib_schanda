...
(assert (=> (= (attr__constrained (select (elts1 (rec__dynamic_array__holder__content1 h__split_fields3)) i2)) true) (= (rec__dynamic_array__rec__b (us_split_discrs1 temp___205)) (rec__dynamic_array__rec__b (us_split_discrs1 (select (elts1 (rec__dynamic_array__holder__content1 h__split_fields3)) i2))))))
(assert (= usq_4 temp___205))
(assert (= o35 (mk___rep (us_split_discrs1 usq_4) (us_split_fields1 usq_4) (attr__constrained (select (elts1 (rec__dynamic_array__holder__content1 h__split_fields3)) i2)))))
(assert (= o36 (store (elts1 (rec__dynamic_array__holder__content1 h__split_fields3)) i2 o35)))
(assert (= o37 (mk___t1 o36 (rt1 (rec__dynamic_array__holder__content1 h__split_fields3)))))
(assert (= o38 (mk___split_fields2 o37)))
(assert (= temp___211 (mk___rep2 h__split_discrs o38)))
(assert (= result6 (mk___split_fields__ref2 h__split_fields3)))
...
(assert (<= 1 j2))
(assert (<= j2 (- i3 1)))
(assert (not (= (rec__dynamic_array__rec__b (us_split_discrs1 (select (elts1 (rec__dynamic_array__holder__content1 h__split_fields4)) j2))) true)))
(check-sat)
(exit)
