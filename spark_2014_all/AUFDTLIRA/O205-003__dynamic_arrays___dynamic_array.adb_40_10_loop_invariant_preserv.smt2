...
(declare-const o26 us_t1)
(declare-const o27 us_split_fields4)
(declare-const temp___240 us_rep2)
...
(assert (=> (= (attr__constrained (select (elts1 (rec__dynamic_array__holder__content1 h__split_fields3)) i2)) true) (= (rec__dynamic_array__rec__b (us_split_discrs1 temp___234)) (rec__dynamic_array__rec__b (us_split_discrs1 (select (elts1 (rec__dynamic_array__holder__content1 h__split_fields3)) i2))))))
(assert (= usq_4 temp___234))
(assert (= o24 (mk___rep (us_split_discrs1 usq_4) (us_split_fields1 usq_4) (attr__constrained (select (elts1 (rec__dynamic_array__holder__content1 h__split_fields3)) i2)))))
(assert (= o25 (store (elts1 (rec__dynamic_array__holder__content1 h__split_fields3)) i2 o24)))
(assert (= o26 (mk___t1 o25 (rt1 (rec__dynamic_array__holder__content1 h__split_fields3)))))
(assert (= o27 (mk___split_fields2 o26)))
(assert (= temp___240 (mk___rep2 h__split_discrs o27)))
(assert (= result5 (mk___split_fields__ref2 h__split_fields3)))
(assert (= h__split_fields4 (us_split_fields5 temp___240)))
(assert (= h__split_discrs (us_split_discrs4 temp___240)))
(assert (not (= i2 c)))
...
(assert (<= 1 j))
(assert (<= j (- i3 1)))
(assert (not (= (to_rep1 (rec__dynamic_array__rec__f1 (us_split_fields1 (select (elts1 (rec__dynamic_array__holder__content1 h__split_fields4)) j)))) (increment (select (elts (rec__dynamic_array__holder__content (us_split_fields3 (new_holder c)))) j)))))
(check-sat)
(exit)
