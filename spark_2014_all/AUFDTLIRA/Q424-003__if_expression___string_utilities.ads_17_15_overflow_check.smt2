...
(assert (= result true))
(assert (and (= o8 (tail s2)) (and (dynamic_invariant o8 true false true) (and (= (elts s2) o4) (= (mk (to_rep1 (first2 (mk1 (+ (to_rep1 (first (rt s2))) 1) (to_rep1 (last (rt s2)))))) (to_rep1 (last2 (mk1 (+ (to_rep1 (first (rt s2))) 1) (to_rep1 (last (rt s2))))))) o5)))))
(assert (and (= o9 (tail s1)) (and (dynamic_invariant o9 true false true) (and (= (elts s1) o2) (= (mk (to_rep1 (first2 (mk1 (+ (to_rep1 (first (rt s1))) 1) (to_rep1 (last (rt s1)))))) (to_rep1 (last2 (mk1 (+ (to_rep1 (first (rt s1))) 1) (to_rep1 (last (rt s1))))))) o3)))))
(assert (and (= o6 (slow_lcs_length o9 o8)) (and (in_range4 o6) (= o6 (ite (or (= (bool_eq o2 (to_rep1 (first o3)) (to_rep1 (last o3)) (temp___String_Literal_152 Tuple0) 1 0) true) (= (bool_eq o4 (to_rep1 (first o5)) (to_rep1 (last o5)) (temp___String_Literal_154 Tuple0) 1 0) true)) 0 (ite (= (head o9) (head o8)) (+ 1 (slow_lcs_length (tail o9) (tail o8))) (ite (< (slow_lcs_length o9 (tail o8)) (slow_lcs_length (tail o9) o8)) (slow_lcs_length (tail o9) o8) (slow_lcs_length o9 (tail o8)))))))))
(assert (= o7 (+ 1 o6)))
