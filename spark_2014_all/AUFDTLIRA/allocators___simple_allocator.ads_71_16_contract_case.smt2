...
(define-fun dynamic_invariant2 ((temp___expr_180 Int) (temp___is_init_176 Bool) (temp___skip_constant_177 Bool) (temp___do_toplevel_178 Bool) (temp___do_typ_inv_179 Bool)) Bool (=> (or (= temp___is_init_176 true) (<= 1 10000)) (in_range2 temp___expr_180)))
(assert true)
...
(define-fun dynamic_invariant4 ((temp___expr_193 Int) (temp___is_init_189 Bool) (temp___skip_constant_190 Bool) (temp___do_toplevel_191 Bool) (temp___do_typ_inv_192 Bool)) Bool (=> (or (= temp___is_init_189 true) (<= 0 10000)) (in_range4 temp___expr_193)))
(assert (forall ((container us_rep)) (forall ((item Int)) (! (=> (dynamic_invariant4 item true true true true) (=> (= (distinct 1 0) true) (=> (exists ((e Int)) (and (and (in_range4 e) (= (contains container e) true)) (= e item))) (= (contains container item) true)))) :pattern ((contains container item))))))
...
(assert (forall ((left us_rep) (right us_rep)) (forall ((item Int)) (! (=> (dynamic_invariant4 item true true true true) (= (= (included_except left right item) true) (forall ((e Int)) (=> (and (in_range4 e) (= (contains left e) true)) (or (= (contains right e) true) (= e item)))))) :pattern ((included_except left right item))))))
(declare-const res Int)
(declare-const data (Array Int status))
(declare-const r Int)
(declare-const temp___280 Int)
(declare-const temp___281 Int)
(declare-const temp___277 (Array Int status))
(declare-const temp___279 (Array Int status))
...
(assert (or (and (and (and (= r10 (mk_int__ref r4)) (and (= data11 (mk_map__ref data5)) (= res12 (mk_int__ref res5)))) (and (= r11 r5) (and (= data12 data6) (= res13 res6)))) (and (= temp___280 1) (and (= temp___281 10000) (and (and (= result7 r15) (= r1 temp___280)) (and (and (<= temp___280 r1) (<= r1 temp___281)) (and (= temp___277 data) (and (= temp___279 data) (and (= temp___276 res) (and (= temp___275 r1) (or (and (and (and (= r1 r4) (and (= data2 data5) (= res2 res5))) (and (= r5 r1) (and (= data6 data2) (= res6 res2)))) (and (= (to_rep (select data r1)) 0) (and (and (and (= (to_rep o) 1) (= o1 (store data r1 o))) (and (= result1 data) (= data2 o1))) (and (= result2 res) (= res2 r1))))) (and (and (not (= (to_rep (select data r1)) 0)) (and (and (= data2 data) (= res2 res)) (and (= data2 data1) (= res2 res1)))) (and (and (and (= r3 r4) (and (= data4 data5) (= res4 res5))) (and (= r5 r3) (and (= data6 data4) (= res6 res4)))) (and (and (= (bool_eq data3 1 10000 temp___279 1 10000) true) (forall ((rr Int)) (=> (and (<= 1 rr) (<= rr r2)) (= (to_rep (select data3 rr)) 1)))) (and (and (and (and (=> (<= 1 10000) (in_range2 r2)) (=> (<= 0 10000) (in_range1 res3))) (forall ((temp___278 Int)) (=> (and (<= 1 temp___278) (<= temp___278 10000)) (=> (< r2 temp___278) (= (select data3 temp___278) (select temp___277 temp___278)))))) (and (<= 1 r2) (<= r2 10000))) (and (not (= r2 temp___281)) (and (and (= r2 result3) (= r3 (+ r2 1))) (and (= (to_rep (select data3 r3)) 0) (and (and (and (= (to_rep o2) 1) (= o3 (store data3 r3 o2))) (and (= result4 data3) (= data4 o3))) (and (= result5 res3) (= res4 r3)))))))))))))))))))) (and (and (and (= result7 r15) (= r1 1)) (ite (and (<= 1 r1) (<= r1 10000)) (and (and (and (= temp___277 data) (and (= temp___279 data) (and (= temp___276 res) (and (= temp___275 r1) (and (and (not (= (to_rep (select data r1)) 0)) (and (and (= data2 data) (= res2 res)) (and (= data2 data1) (= res2 res1)))) (and (and (= (bool_eq data3 1 10000 temp___279 1 10000) true) (forall ((rr Int)) (=> (and (<= 1 rr) (<= rr r2)) (= (to_rep (select data3 rr)) 1)))) (and (and (and (and (=> (<= 1 10000) (in_range2 r2)) (=> (<= 0 10000) (in_range1 res3))) (forall ((temp___278 Int)) (=> (and (<= 1 temp___278) (<= temp___278 10000)) (=> (< r2 temp___278) (= (select data3 temp___278) (select temp___277 temp___278)))))) (and (<= 1 r2) (<= r2 10000))) (= r2 10000)))))))) (and (and (= r2 r6) (and (= data3 data7) (= res3 res7))) (and (= r7 r2) (and (= data8 data3) (= res8 res3))))) (and (and (= r14 (mk_int__ref r6)) (and (= data15 (mk_map__ref data7)) (= res16 (mk_int__ref res7)))) (and (= r9 r7) (and (= data10 data8) (= res10 res8))))) (and (and (= r1 r8) (and (= data15 (mk_map__ref data)) (= res16 (mk_int__ref res)))) (and (= r9 r1) (and (= data10 data1) (= res10 res1)))))) (and (and (and (= r10 r14) (and (= data11 data15) (= res12 (mk_int__ref res11)))) (and (= r11 r9) (and (= data12 data10) (= res13 res11)))) (and (= result6 res16) (= res11 0))))))
(assert (= r12 r10))
