...
(assert (or (and (and (and (= r12 (mk_int__ref r6)) (and (= data13 (mk_map__ref data7)) (= res14 (mk_int__ref res7)))) (and (= r13 r7) (and (= data14 data8) (= res15 res8)))) (and (= temp___248 1) (and (= temp___249 10000) (and (and (= (mk_int__ref result) (mk_int__ref r)) (= r1 temp___248)) (and (and (<= temp___248 r1) (<= r1 temp___249)) (and (= temp___245 data) (and (= temp___247 data) (and (= temp___244 res) (and (= temp___243 r1) (or (and (and (and (= r1 r6) (and (= data2 data7) (= res2 res7))) (and (= r7 r1) (and (= data8 data2) (= res8 res2)))) (and (= (to_rep (select data r1)) 0) (and (and (and (= (to_rep o) 1) (= o1 (store data r1 o))) (and (= result1 data) (= data2 o1))) (and (= result2 res) (= res2 r1))))) (and (and (not (= (to_rep (select data r1)) 0)) (and (and (= data2 data) (= res2 res)) (and (= data2 data1) (= res2 res1)))) (and (and (and (= r3 r6) (and (= data4 data7) (= res4 res7))) (and (= r7 r3) (and (= data8 data4) (= res8 res4)))) (and (and (= (bool_eq data3 1 10000 temp___247 1 10000) true) (forall ((rr1 Int)) (=> (and (<= 1 rr1) (<= rr1 r2)) (= (to_rep (select data3 rr1)) 1)))) (and (and (and (and (=> (<= 1 10000) (in_range2 r2)) (=> (<= 0 10000) (in_range1 res3))) (forall ((temp___246 Int)) (=> (and (<= 1 temp___246) (<= temp___246 10000)) (=> (< r2 temp___246) (= (select data3 temp___246) (select temp___245 temp___246)))))) (and (<= 1 r2) (<= r2 10000))) (and (not (= r2 temp___249)) (and (and (= r2 result3) (= r3 (+ r2 1))) (and (= (to_rep (select data3 r3)) 0) (and (and (and (= (to_rep o2) 1) (= o3 (store data3 r3 o2))) (and (= result4 data3) (= data4 o3))) (and (= result5 res3) (= res4 r3)))))))))))))))))))) (and (and (and (= (mk_int__ref result) (mk_int__ref r)) (= r1 1)) (ite (and (<= 1 r1) (<= r1 10000)) (and (and (and (= temp___245 data) (and (= temp___247 data) (and (= temp___244 res) (and (= temp___243 r1) (and (and (not (= (to_rep (select data r1)) 0)) (and (and (= data2 data) (= res2 res)) (and (= data2 data1) (= res2 res1)))) (and (and (= (bool_eq data3 1 10000 temp___247 1 10000) true) (forall ((rr1 Int)) (=> (and (<= 1 rr1) (<= rr1 r2)) (= (to_rep (select data3 rr1)) 1)))) (and (and (and (and (=> (<= 1 10000) (in_range2 r2)) (=> (<= 0 10000) (in_range1 res3))) (forall ((temp___246 Int)) (=> (and (<= 1 temp___246) (<= temp___246 10000)) (=> (< r2 temp___246) (= (select data3 temp___246) (select temp___245 temp___246)))))) (and (<= 1 r2) (<= r2 10000))) (= r2 10000)))))))) (and (and (= r2 r8) (and (= data3 data9) (= res3 res9))) (and (= r9 r2) (and (= data10 data3) (= res10 res3))))) (and (and (= (mk_int__ref r10) (mk_int__ref r8)) (and (= (mk_map__ref data11) (mk_map__ref data9)) (= (mk_int__ref res11) (mk_int__ref res9)))) (and (= r11 r9) (and (= data12 data10) (= res12 res10))))) (and (and (= r1 r10) (and (= (mk_map__ref data11) (mk_map__ref data)) (= (mk_int__ref res11) (mk_int__ref res)))) (and (= r11 r1) (and (= data12 data1) (= res12 res1)))))) (and (and (and (= r12 (mk_int__ref r10)) (and (= data13 (mk_map__ref data11)) (= res14 (mk_int__ref res13)))) (and (= r13 r11) (and (= data14 data12) (= res15 res13)))) (and (= result6 (mk_int__ref res11)) (= res13 0))))))
(assert (= r14 r12))
...
(assert (= res17 res15))
(assert (=> (= (is_empty (rec__simple_allocator__m__t__available (us_split_fields1 (model__ data)))) true) (and (= (int__content res16) 0) (= (oeq (model__ (map__content data15)) (model__ data)) true))))
(assert (not (= (is_empty (rec__simple_allocator__m__t__available (us_split_fields1 (model__ data)))) true)))
(assert (not (= (is_add (rec__simple_allocator__m__t__available (us_split_fields1 (model__ (map__content data15)))) (int__content res16) (rec__simple_allocator__m__t__available (us_split_fields1 (model__ data)))) true)))
(check-sat)
(exit)
