...
(assert (and (and (forall ((temp___1600 Int)) (=> (and (<= (to_rep1 n__first) temp___1600) (<= temp___1600 (to_rep1 n__last))) (=> (< index3 temp___1600) (= (select n3 temp___1600) (select n1 temp___1600))))) (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 7)) (dynamic_property5 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 7) index3))) (and (<= (to_rep1 (first (rt source))) index3) (<= index3 (+ (to_rep1 (first (rt source))) 7)))))
