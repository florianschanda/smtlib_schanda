...
(assert (= result__4 (screen__writestatsdata__B251b__result__aggregate_def 32)))
...
(assert (forall ((temp___1407 Int)) (ite (and (<= 1 temp___1407) (<= temp___1407 (- (to_rep1 data__last) 1))) (= (select o2 temp___1407) (select (elts1 temp___1406) temp___1407)) (= (select o2 temp___1407) (select result__4 temp___1407)))))
...
(assert (= result__6 (screen__writestatsdata__B262b__result__aggregate_def 32)))
...
(assert (forall ((temp___1420 Int)) (ite (and (<= 1 temp___1420) (<= temp___1420 (- (to_rep1 data__last1) 1))) (= (select o9 temp___1420) (select (elts3 temp___1419) temp___1420)) (= (select o9 temp___1420) (select result__6 temp___1420)))))
...
(assert (= result__8 (screen__writestatsdata__B273b__result__aggregate_def 32)))
...
(assert (=> (<= 1 temp___1430) (and (and (<= 1 1) (<= 1 10)) (and (<= 1 temp___1430) (<= temp___1430 10)))))
(assert (= o15 result__8))
(assert (= temp___1431 (mk___t5 o15 (mk5 1 temp___1430))))
(assert (= (ite (<= (to_rep1 (first10 (rt5 temp___1428))) (to_rep1 (last10 (rt5 temp___1428)))) (+ (- (to_rep1 (last10 (rt5 temp___1428))) (to_rep1 (first10 (rt5 temp___1428)))) 1) 0) (ite (<= (to_rep1 (first10 (rt5 temp___1431))) (to_rep1 (last10 (rt5 temp___1431)))) (+ (- (to_rep1 (last10 (rt5 temp___1431))) (to_rep1 (first10 (rt5 temp___1431)))) 1) 0)))
(assert (= temp___1432 temp___1428))
(assert (forall ((temp___1433 Int)) (ite (and (<= 1 temp___1433) (<= temp___1433 (- (to_rep1 data__last2) 1))) (= (select o16 temp___1433) (select (elts5 temp___1432) temp___1433)) (= (select o16 temp___1433) (select result__8 temp___1433)))))
...
(assert (= (to_rep1 data__first3) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE4 c281b)))))))
(assert (= (to_rep1 data__last3) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE4 c281b)))))))
(assert (dynamic_property 1 2147483647 (to_rep1 data__first3) (to_rep1 data__last3)))
(assert (= result16 result__3))
(assert (= (let ((subject result__3)) result__10) (screen__writestatsdata__B284b__result__aggregate_def 32)))
...
(assert (= (ite (<= (to_rep1 (first16 (rt8 temp___1440))) (to_rep1 (last16 (rt8 temp___1440)))) (+ (- (to_rep1 (last16 (rt8 temp___1440))) (to_rep1 (first16 (rt8 temp___1440)))) 1) 0) (ite (<= 1 (- (to_rep1 data__last3) 1)) (+ (- (- (to_rep1 data__last3) 1) 1) 1) 0)))
(assert (= temp___1441 (mk___t7 (slide (elts8 temp___1440) (to_rep1 (first16 (rt8 temp___1440))) 1) (mk7 1 (- (to_rep1 data__last3) 1)))))
