...
(declare-const temp___203 (Array Int contents_type))
(declare-const temp___207 (Array Int contents_type))
(declare-const o Int)
...
(declare-const table4 (Array Int contents_type))
(declare-const key4 Int)
(declare-const low3 Int)
(declare-const table5 (Array Int contents_type))
(declare-const key5 Int)
(declare-const low4 Int)
(declare-const table6 (Array Int contents_type))
(declare-const key6 Int)
(declare-const low5 Int)
(declare-const table7 (Array Int contents_type))
(declare-const key7 Int)
(declare-const low6 Int)
(declare-const table8 (Array Int contents_type))
(declare-const key8 Int)
(declare-const low7 Int)
(declare-const table9 (Array Int contents_type))
(declare-const key9 Int)
(declare-const low8 Int)
(define-fun key10 () int__ref (mk_int__ref key6))
(define-fun table10 () map__ref (mk_map__ref table6))
(define-fun key11 () int__ref (mk_int__ref key))
(assert (=> (<= 1 100) (in_range2 key)))
(assert (= (mk_int__ref result) (mk_int__ref low)))
(assert (= low1 1))
(assert (=> (and (<= 1 low1) (<= low1 99)) (= temp___205 low1)))
(assert (=> (and (<= 1 low1) (<= low1 99)) (= temp___204 key)))
(assert (=> (and (<= 1 low1) (<= low1 99)) (= temp___203 table)))
(assert (=> (and (<= 1 low1) (<= low1 99)) (= temp___207 table)))
(assert (=> (and (<= 1 low1) (<= low1 99)) (and (= o (find_smallest table low1 100)) (and (in_range2 o) (and (and (<= low1 o) (<= o 100)) (forall ((x Int)) (=> (and (<= low1 x) (<= x 100)) (<= (to_rep (select table o)) (to_rep (select table x))))))))))
(assert (=> (and (<= 1 low1) (<= low1 99)) (= (mk_int__ref result1) key11)))
(assert (=> (and (<= 1 low1) (<= low1 99)) (= key2 o)))
(assert (=> (and (<= 1 low1) (<= low1 99)) (=> (not (= key2 low1)) (and (= (to_rep (select table2 low1)) (to_rep (select table key2))) (and (= (to_rep (select table2 key2)) (to_rep (select table low1))) (and (forall ((x Int)) (=> (and (<= 1 x) (<= x 100)) (=> (and (not (= x low1)) (not (= x key2))) (= (to_rep (select table2 x)) (to_rep (select table x)))))) (= (perm table2 table) true)))))))
(assert (=> (and (<= 1 low1) (<= low1 99)) (=> (not (not (= key2 low1))) (= table2 table))))
(assert (=> (and (<= 1 low1) (<= low1 99)) (=> (not (not (= key2 low1))) (= table2 table1))))
(assert (=> (and (<= 1 low1) (<= low1 99)) (and (and (forall ((x Int)) (=> (and (<= 1 x) (<= x low2)) (<= (to_rep (select table3 x)) (to_rep (select table3 (+ x 1)))))) (forall ((x Int)) (=> (and (<= low2 x) (<= x 100)) (<= (to_rep (select table3 low2)) (to_rep (select table3 x)))))) (= (perm table3 temp___207) true))))
(assert (=> (and (<= 1 low1) (<= low1 99)) (and (and (=> (<= 1 100) (in_range2 key3)) (=> (<= 1 99) (in_range4 low2))) (and (<= 1 low2) (<= low2 99)))))
(assert (=> (and (<= 1 low1) (<= low1 99)) (= low2 99)))
(assert (=> (and (<= 1 low1) (<= low1 99)) (= low2 low3)))
(assert (=> (and (<= 1 low1) (<= low1 99)) (= key3 key4)))
(assert (=> (and (<= 1 low1) (<= low1 99)) (= table3 table4)))
(assert (=> (and (<= 1 low1) (<= low1 99)) (= low4 low2)))
(assert (=> (and (<= 1 low1) (<= low1 99)) (= key5 key3)))
(assert (=> (and (<= 1 low1) (<= low1 99)) (= table5 table3)))
(assert (=> (and (<= 1 low1) (<= low1 99)) (= (mk_int__ref low5) (mk_int__ref low3))))
(assert (=> (and (<= 1 low1) (<= low1 99)) (= key10 (mk_int__ref key4))))
(assert (=> (and (<= 1 low1) (<= low1 99)) (= table10 (mk_map__ref table4))))
(assert (=> (and (<= 1 low1) (<= low1 99)) (= low6 low4)))
(assert (=> (and (<= 1 low1) (<= low1 99)) (= key7 key5)))
(assert (=> (and (<= 1 low1) (<= low1 99)) (= table7 table5)))
(assert (=> (not (and (<= 1 low1) (<= low1 99))) (= low1 low5)))
(assert (=> (not (and (<= 1 low1) (<= low1 99))) (= key10 key11)))
(assert (=> (not (and (<= 1 low1) (<= low1 99))) (= table10 (mk_map__ref table))))
(assert (=> (not (and (<= 1 low1) (<= low1 99))) (= low6 low1)))
(assert (=> (not (and (<= 1 low1) (<= low1 99))) (= key7 key1)))
(assert (=> (not (and (<= 1 low1) (<= low1 99))) (= table7 table1)))
(assert (= low7 low5))
(assert (= key8 key6))
(assert (= (mk_map__ref table8) table10))
(assert (= low8 low6))
(assert (= key9 key7))
(assert (= table9 table7))
(assert (not (= (ordered table8 1 100) true)))
(check-sat)
(exit)
