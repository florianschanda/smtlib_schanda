...
(assert (and (<= (to_rep1 (first (rt source))) temp___1814) (<= temp___1814 (to_rep1 (last (rt source))))))
(assert (= o45 temp___1814))
(assert (= o46 (select (elts source) o45)))
(assert (= o47 (to_rep o46)))
(assert (and (and (and (and (<= 0 n1) (<= n1 9)) (= n1 (convert_character_digit_to_integer o47))) (ite (= (= o47 48) true) (= n1 0) (ite (= (= o47 49) true) (= n1 1) (ite (= (= o47 50) true) (= n1 2) (ite (= (= o47 51) true) (= n1 3) (ite (= (= o47 52) true) (= n1 4) (ite (= (= o47 53) true) (= n1 5) (ite (= (= o47 54) true) (= n1 6) (ite (= (= o47 55) true) (= n1 7) (ite (= (= o47 56) true) (= n1 8) (=> (= (= o47 57) true) (= n1 9)))))))))))) (in_range1 n1)))
(assert (and (= o48 (- n1)) (in_range1 (- n1))))
(assert (= (mk_int__ref result1) (mk_int__ref target)))
(assert (= target1 o48))
(assert (<= (- 8) target1))
(assert (not (in_range1 (- target1 2147483640))))
(check-sat)
(exit)
