...
(assert (and (= o7 (- i9 first4)) (in_range1 (- i9 first4))))
(assert (and (= o8 (length2 (mk___rep1 res__split_discrs res__split_fields2))) (and (in_range6 o8) (<= o8 (capacity (mk___rep1 res__split_discrs res__split_fields2))))))
(assert (= result5 (ite (= o8 o7) true false)))
(assert (=> (= result5 true) (and (= o3 (- last5 i9)) (in_range1 (- last5 i9)))))
(assert (=> (= result5 true) (= o4 (+ o3 1))))
(assert (=> (= result5 true) (and (= o5 o4) (in_range1 o4))))
(assert (=> (= result5 true) (and (= o2 (to__ (mk___rep s__split_fields9))) (and (dynamic_invariant1 o2 true false true) (and (= (to_rep (first (rt o2))) 1) (<= 0 (to_rep (last (rt o2)))))))))
(assert (=> (= result5 true) (= o6 (to_rep (last (rt o2))))))
(assert (=> (= result5 true) (= result4 (ite (= o6 o5) true false))))
(assert (=> (not (= result5 true)) (= result4 false)))
(assert (= result4 true))
(assert (not (in_range1 (- last5 i9))))
(check-sat)
(exit)
