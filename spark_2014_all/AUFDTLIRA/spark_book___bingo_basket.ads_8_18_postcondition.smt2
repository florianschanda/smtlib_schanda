...
(declare-const temp___223 (Array Int callable_number))
(declare-const o callable_number)
(declare-const o1 (Array Int callable_number))
(declare-const temp___228 (Array Int callable_number))
...
(assert (= number1 1))
(assert (=> (and (<= 1 number1) (<= number1 75)) (= temp___223 the_basket)))
(assert (=> (and (<= 1 number1) (<= number1 75)) (and (forall ((temp___224 Int)) (=> (and (<= 1 temp___224) (<= temp___224 75)) (=> (<= number2 temp___224) (= (select the_basket2 temp___224) (select temp___223 temp___224))))) (and (<= 1 number2) (<= number2 75)))))
...
(assert (= index1 1))
(assert (=> (and (<= 1 index1) (<= index1 75)) (= temp___228 the_basket6)))
(assert (=> (and (<= 1 index1) (<= index1 75)) (= temp___227 random_index)))
