...
(assert (= number1 1))
(assert (=> (and (<= 1 number1) (<= number1 75)) (= temp___192 the_basket)))
(assert (=> (and (<= 1 number1) (<= number1 75)) (and (forall ((temp___193 Int)) (=> (and (<= 1 temp___193) (<= temp___193 75)) (=> (<= number2 temp___193) (= (select the_basket2 temp___193) (select temp___192 temp___193))))) (and (<= 1 number2) (<= number2 75)))))
...
(assert (=> (and (<= 1 number1) (<= number1 75)) (= (mk_int__ref number5) (mk_int__ref number3))))
(assert (=> (and (<= 1 number1) (<= number1 75)) (= (mk_map__ref the_basket6) (mk_map__ref the_basket4))))
...
(assert (=> (not (and (<= 1 number1) (<= number1 75))) (= (mk_map__ref the_basket6) (mk_map__ref the_basket))))
...
(assert (=> (and (<= 1 index1) (<= index1 75)) (= temp___196 random_index)))
...
(assert (=> (not (and (<= 1 index1) (<= index1 75))) (= the_basket13 (mk_map__ref the_basket6))))
...
(assert (= number7 (mk_int__ref number5)))
