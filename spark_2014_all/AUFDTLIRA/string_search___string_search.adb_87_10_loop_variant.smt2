...
(assert (and (forall ((c Int)) (=> (and (<= 0 c) (<= c 255)) (and (<= 1 (to_rep (select bad_shift c))) (<= (to_rep (select bad_shift c)) (+ (length needle) 1))))) (forall ((c Int)) (=> (and (<= 0 c) (<= c 255)) (ite (= (to_rep (select bad_shift c)) (+ (length needle) 1)) (forall ((k14 Int)) (=> (and (<= (to_rep2 (first (rt needle))) k14) (<= k14 (to_rep2 (last (rt needle))))) (not (= c (to_rep1 (select (elts needle) k14)))))) (and (= (to_rep1 (select (elts needle) (+ (- (length needle) (to_rep (select bad_shift c))) 1))) c) (forall ((k14 Int)) (=> (and (<= (+ (- (length needle) (to_rep (select bad_shift c))) 2) k14) (<= k14 (to_rep2 (last (rt needle))))) (not (= (to_rep1 (select (elts needle) k14)) c))))))))))
...
(assert (forall ((k14 Int)) (=> (and (<= 1 k14) (<= k14 (- (+ i2 (to_rep (select bad_shift (to_rep1 (select (elts haystack) (+ i2 (length needle))))))) 1))) (not (= (match_at needle haystack k14) true)))))
