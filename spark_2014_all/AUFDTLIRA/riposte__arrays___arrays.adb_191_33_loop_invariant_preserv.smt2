...
(assert (and (and (forall ((temp___350 Int)) (=> (and (<= 0 temp___350) (<= temp___350 255)) (=> (or (< 255 temp___350) (or (< temp___350 0) (< x2 temp___350))) (= (select r2 temp___350) (select r temp___350))))) (=> (<= 0 255) (in_range1 x2))) (and (<= 0 x2) (<= x2 255))))
(assert (not (= x2 255)))
(assert (= result2 x2))
(assert (= x3 (+ x2 1)))
(assert (= result3 r2))
