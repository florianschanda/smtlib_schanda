...
(assert (= rank1 1))
(assert (=> (and (<= 1 rank1) (<= rank1 64)) (and (and (= temp___403 rank1) (and (= temp___401 seen1) (and (forall ((g11 Int)) (=> (and (<= 1 g11) (<= g11 64)) (= (= (select seen2 g11) true) (exists ((prev1 Int)) (and (and (<= 1 prev1) (<= prev1 (- rank2 1))) (= (to_rep (select r1 prev1)) g11)))))) (and (and (=> (<= 1 64) (in_range2 rank2)) (and (<= 1 rank2) (<= rank2 64))) (and (and (= seen2 result2) (= seen3 (store seen2 (to_rep (select r1 rank2)) (of_int 1)))) (= rank2 64)))))) (and (and (= rank2 rank6) (= seen3 seen6)) (and (= rank7 rank2) (= seen7 seen3))))))
(assert (=> (and (<= 1 rank1) (<= rank1 64)) (= (mk_int__ref rank8) (mk_int__ref rank6))))
(assert (=> (and (<= 1 rank1) (<= rank1 64)) (= (mk_map__ref1 seen8) (mk_map__ref1 seen6))))
(assert (=> (and (<= 1 rank1) (<= rank1 64)) (= rank9 rank7)))
(assert (=> (and (<= 1 rank1) (<= rank1 64)) (= seen9 seen7)))
(assert (=> (not (and (<= 1 rank1) (<= rank1 64))) (= rank1 rank8)))
(assert (=> (not (and (<= 1 rank1) (<= rank1 64))) (= seen1 seen8)))
(assert (=> (not (and (<= 1 rank1) (<= rank1 64))) (= rank9 rank1)))
(assert (=> (not (and (<= 1 rank1) (<= rank1 64))) (= seen9 seen1)))
(assert (= (bool_eq1 seen8 1 64 (temp___406 (of_int 1)) 1 64) true))
(declare-const g11 Int)
(assert (<= 1 g11))
(assert (<= g11 64))
(assert (not (= (select seen8 g11) true)))
(check-sat)
(exit)
