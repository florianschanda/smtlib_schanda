...
(declare-const temp___443 (Array Int Bool))
...
(assert (= rank1 1))
(assert (=> (and (<= 1 rank1) (<= rank1 64)) (= temp___445 rank1)))
(assert (=> (and (<= 1 rank1) (<= rank1 64)) (= temp___443 seen1)))
...
(assert (= (bool_eq1 seen6 1 64 (temp___448 (distinct 1 0)) 1 64) true))
