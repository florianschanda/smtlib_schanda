...
(assert (forall ((x algorithmt)) (! (in_range6 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(define-fun bool_eq4 ((a us_rep3) (b us_rep3)) Bool (ite (and (and (and (= (bool_eq2 (rec__cert__contentst__id (us_split_fields7 a)) (rec__cert__contentst__id (us_split_fields7 b))) true) (= (bool_eq3 (rec__cert__contentst__notbefore (us_split_fields7 a)) (rec__cert__contentst__notbefore (us_split_fields7 b))) true)) (= (bool_eq3 (rec__cert__contentst__notafter (us_split_fields7 a)) (rec__cert__contentst__notafter (us_split_fields7 b))) true)) (= (to_rep4 (rec__cert__contentst__mechanism (us_split_fields7 a))) (to_rep4 (rec__cert__contentst__mechanism (us_split_fields7 b))))) true false))
...
(assert (forall ((x keyidt)) (! (in_range11 (to_rep9 x)) :pattern ((to_rep9 x)))))
...
(assert (forall ((x keylengtht)) (! (in_range12 (to_rep10 x)) :pattern ((to_rep10 x)))))
...
(define-fun bool_eq5 ((a us_rep4) (b us_rep4)) Bool (ite (and (and (= (to_rep4 (rec__cryptotypes__keypartt__algorithmid (us_split_fields9 a))) (to_rep4 (rec__cryptotypes__keypartt__algorithmid (us_split_fields9 b)))) (= (to_rep9 (rec__cryptotypes__keypartt__keyid (us_split_fields9 a))) (to_rep9 (rec__cryptotypes__keypartt__keyid (us_split_fields9 b))))) (= (to_rep10 (rec__cryptotypes__keypartt__keylength (us_split_fields9 a))) (to_rep10 (rec__cryptotypes__keypartt__keylength (us_split_fields9 b))))) true false))
...
(declare-datatypes () ((us_split_fields10 (mk___split_fields5 (rec__cert__id__contentst__id us_rep1) (rec__cert__id__contentst__notbefore us_rep2) (rec__cert__id__contentst__notafter us_rep2) (rec__cert__id__contentst__mechanism algorithmt) (rec__cert__id__contentst__subject us_rep) (rec__cert__id__contentst__subjectpublickey us_rep4)))))
(define-fun us_split_fields_ID__4__projection ((a us_split_fields10)) us_rep1 (rec__cert__id__contentst__id a))
(define-fun us_split_fields_NotBefore__2__projection ((a us_split_fields10)) us_rep2 (rec__cert__id__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__2__projection ((a us_split_fields10)) us_rep2 (rec__cert__id__contentst__notafter a))
(define-fun us_split_fields_Mechanism__2__projection ((a us_split_fields10)) algorithmt (rec__cert__id__contentst__mechanism a))
(define-fun us_split_fields_Subject__projection ((a us_split_fields10)) us_rep (rec__cert__id__contentst__subject a))
...
(define-fun bool_eq6 ((a us_rep5) (b us_rep5)) Bool (ite (and (and (and (and (and (= (bool_eq2 (rec__cert__id__contentst__id (us_split_fields11 a)) (rec__cert__id__contentst__id (us_split_fields11 b))) true) (= (bool_eq3 (rec__cert__id__contentst__notbefore (us_split_fields11 a)) (rec__cert__id__contentst__notbefore (us_split_fields11 b))) true)) (= (bool_eq3 (rec__cert__id__contentst__notafter (us_split_fields11 a)) (rec__cert__id__contentst__notafter (us_split_fields11 b))) true)) (= (to_rep4 (rec__cert__id__contentst__mechanism (us_split_fields11 a))) (to_rep4 (rec__cert__id__contentst__mechanism (us_split_fields11 b))))) (= (bool_eq1 (rec__cert__id__contentst__subject (us_split_fields11 a)) (rec__cert__id__contentst__subject (us_split_fields11 b))) true)) (= (bool_eq5 (rec__cert__id__contentst__subjectpublickey (us_split_fields11 a)) (rec__cert__id__contentst__subjectpublickey (us_split_fields11 b))) true)) true false))
...
(assert true)
(declare-datatypes () ((us_split_fields12 (mk___split_fields6 (rec__cert__attr__contentst__id us_rep1) (rec__cert__attr__contentst__notbefore us_rep2) (rec__cert__attr__contentst__notafter us_rep2) (rec__cert__attr__contentst__mechanism algorithmt) (rec__cert__attr__contentst__basecertid us_rep1)))))
(define-fun us_split_fields_ID__5__projection ((a us_split_fields12)) us_rep1 (rec__cert__attr__contentst__id a))
(define-fun us_split_fields_NotBefore__3__projection ((a us_split_fields12)) us_rep2 (rec__cert__attr__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__3__projection ((a us_split_fields12)) us_rep2 (rec__cert__attr__contentst__notafter a))
(define-fun us_split_fields_Mechanism__3__projection ((a us_split_fields12)) algorithmt (rec__cert__attr__contentst__mechanism a))
(define-fun us_split_fields_BaseCertID__projection ((a us_split_fields12)) us_rep1 (rec__cert__attr__contentst__basecertid a))
...
(define-fun bool_eq7 ((a us_rep6) (b us_rep6)) Bool (ite (and (and (and (and (= (bool_eq2 (rec__cert__attr__contentst__id (us_split_fields13 a)) (rec__cert__attr__contentst__id (us_split_fields13 b))) true) (= (bool_eq3 (rec__cert__attr__contentst__notbefore (us_split_fields13 a)) (rec__cert__attr__contentst__notbefore (us_split_fields13 b))) true)) (= (bool_eq3 (rec__cert__attr__contentst__notafter (us_split_fields13 a)) (rec__cert__attr__contentst__notafter (us_split_fields13 b))) true)) (= (to_rep4 (rec__cert__attr__contentst__mechanism (us_split_fields13 a))) (to_rep4 (rec__cert__attr__contentst__mechanism (us_split_fields13 b))))) (= (bool_eq2 (rec__cert__attr__contentst__basecertid (us_split_fields13 a)) (rec__cert__attr__contentst__basecertid (us_split_fields13 b))) true)) true false))
...
(assert (forall ((x fart)) (! (= (of_rep11 (to_rep11 x)) x) :pattern ((to_rep11 x)))))
(assert (forall ((x fart)) (! (in_range13 (to_rep11 x)) :pattern ((to_rep11 x)))))
...
(assert (forall ((x bytet)) (! (= (of_rep12 (to_rep12 x)) x) :pattern ((to_rep12 x)))))
(assert (forall ((x bytet)) (! (in_range14 (to_rep12 x)) :pattern ((to_rep12 x)))))
...
(assert (forall ((a (Array Int bytet))) (forall ((first Int)) (! (= (slide1 a first first) a) :pattern ((slide1 a first first))))))
...
(define-fun bool_eq8 ((a (Array Int bytet)) (a__first Int) (a__last Int) (b (Array Int bytet)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_144 Int)) (=> (and (<= a__first temp___idx_144) (<= temp___idx_144 a__last)) (= (to_rep12 (select a temp___idx_144)) (to_rep12 (select b (+ (- b__first a__first) temp___idx_144))))))) true false))
(assert (forall ((a (Array Int bytet)) (b (Array Int bytet))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq8 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_144 Int)) (=> (and (<= a__first temp___idx_144) (<= temp___idx_144 a__last)) (= (to_rep12 (select a temp___idx_144)) (to_rep12 (select b (+ (- b__first a__first) temp___idx_144)))))))))))
(declare-fun compare1 ((Array Int bytet) Int Int (Array Int bytet) Int Int) Int)
(assert (forall ((a (Array Int bytet)) (b (Array Int bytet))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare1 a a_first a_last b b_first b_last) 0) (= (bool_eq8 a a_first a_last b b_first b_last) true)) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int bytet)) (b (Array Int bytet))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare1 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq8 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep12 (select a (+ i 1))) (to_rep12 (select b (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int bytet)) (b (Array Int bytet))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare1 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq8 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep12 (select b (+ i 1))) (to_rep12 (select a (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
...
(declare-fun user_eq23 (templatelengtht templatelengtht) Bool)
(declare-const dummy23 templatelengtht)
...
(assert (forall ((x templatelengtht)) (! (= (of_rep13 (to_rep13 x)) x) :pattern ((to_rep13 x)))))
(assert (forall ((x templatelengtht)) (! (in_range15 (to_rep13 x)) :pattern ((to_rep13 x)))))
(assert (forall ((x Int)) (! (=> (in_range15 x) (= (to_rep13 (of_rep13 x)) x)) :pattern ((to_rep13 (of_rep13 x))))))
(declare-const dummy24 (Array Int character))
...
(declare-fun user_eq24 ((Array Int character) (Array Int character)) Bool)
(declare-datatypes () ((us_split_fields14 (mk___split_fields7 (rec__iandatypes__templatet__length templatelengtht) (rec__iandatypes__templatet__requiredmaxfar fart) (rec__iandatypes__templatet__id (Array Int character)) (rec__iandatypes__templatet__pad (Array Int bytet))))))
(define-fun us_split_fields_Length__projection ((a us_split_fields14)) templatelengtht (rec__iandatypes__templatet__length a))
(define-fun us_split_fields_RequiredMaxFAR__projection ((a us_split_fields14)) fart (rec__iandatypes__templatet__requiredmaxfar a))
(define-fun us_split_fields_ID__2__projection ((a us_split_fields14)) (Array Int character) (rec__iandatypes__templatet__id a))
(define-fun us_split_fields_Pad__projection ((a us_split_fields14)) (Array Int bytet) (rec__iandatypes__templatet__pad a))
(declare-datatypes () ((us_split_fields__ref7 (mk___split_fields__ref7 (us_split_fields__content7 us_split_fields14)))))
(define-fun us_split_fields__ref___9__projection ((a us_split_fields__ref7)) us_split_fields14 (us_split_fields__content7 a))
(declare-datatypes () ((us_rep7 (mk___rep7 (us_split_fields15 us_split_fields14)))))
(define-fun us_rep___10__projection ((a us_rep7)) us_split_fields14 (us_split_fields15 a))
(define-fun bool_eq9 ((a us_rep7) (b us_rep7)) Bool (ite (and (and (and (= (to_rep13 (rec__iandatypes__templatet__length (us_split_fields15 a))) (to_rep13 (rec__iandatypes__templatet__length (us_split_fields15 b)))) (= (to_rep11 (rec__iandatypes__templatet__requiredmaxfar (us_split_fields15 a))) (to_rep11 (rec__iandatypes__templatet__requiredmaxfar (us_split_fields15 b))))) (= (bool_eq (rec__iandatypes__templatet__id (us_split_fields15 a)) 1 40 (rec__iandatypes__templatet__id (us_split_fields15 b)) 1 40) true)) (= (bool_eq8 (rec__iandatypes__templatet__pad (us_split_fields15 a)) 1 452 (rec__iandatypes__templatet__pad (us_split_fields15 b)) 1 452) true)) true false))
...
(declare-datatypes () ((templatet__ref (mk_templatet__ref (templatet__content us_rep7)))))
(define-fun templatet__ref___projection ((a templatet__ref)) us_rep7 (templatet__content a))
(declare-datatypes () ((us_split_fields16 (mk___split_fields8 (rec__cert__attr__ianda__contentst__id us_rep1) (rec__cert__attr__ianda__contentst__notbefore us_rep2) (rec__cert__attr__ianda__contentst__notafter us_rep2) (rec__cert__attr__ianda__contentst__mechanism algorithmt) (rec__cert__attr__ianda__contentst__basecertid us_rep1) (rec__cert__attr__ianda__contentst__template us_rep7)))))
(define-fun us_split_fields_ID__8__projection ((a us_split_fields16)) us_rep1 (rec__cert__attr__ianda__contentst__id a))
(define-fun us_split_fields_NotBefore__6__projection ((a us_split_fields16)) us_rep2 (rec__cert__attr__ianda__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__6__projection ((a us_split_fields16)) us_rep2 (rec__cert__attr__ianda__contentst__notafter a))
(define-fun us_split_fields_Mechanism__6__projection ((a us_split_fields16)) algorithmt (rec__cert__attr__ianda__contentst__mechanism a))
(define-fun us_split_fields_BaseCertID__4__projection ((a us_split_fields16)) us_rep1 (rec__cert__attr__ianda__contentst__basecertid a))
(define-fun us_split_fields_Template__projection ((a us_split_fields16)) us_rep7 (rec__cert__attr__ianda__contentst__template a))
...
(define-fun bool_eq10 ((a us_rep8) (b us_rep8)) Bool (ite (and (and (and (and (and (= (bool_eq2 (rec__cert__attr__ianda__contentst__id (us_split_fields17 a)) (rec__cert__attr__ianda__contentst__id (us_split_fields17 b))) true) (= (bool_eq3 (rec__cert__attr__ianda__contentst__notbefore (us_split_fields17 a)) (rec__cert__attr__ianda__contentst__notbefore (us_split_fields17 b))) true)) (= (bool_eq3 (rec__cert__attr__ianda__contentst__notafter (us_split_fields17 a)) (rec__cert__attr__ianda__contentst__notafter (us_split_fields17 b))) true)) (= (to_rep4 (rec__cert__attr__ianda__contentst__mechanism (us_split_fields17 a))) (to_rep4 (rec__cert__attr__ianda__contentst__mechanism (us_split_fields17 b))))) (= (bool_eq2 (rec__cert__attr__ianda__contentst__basecertid (us_split_fields17 a)) (rec__cert__attr__ianda__contentst__basecertid (us_split_fields17 b))) true)) (= (bool_eq9 (rec__cert__attr__ianda__contentst__template (us_split_fields17 a)) (rec__cert__attr__ianda__contentst__template (us_split_fields17 b))) true)) true false))
...
(define-fun contentst__ref___6__projection ((a contentst__ref3)) us_rep8 (contentst__content3 a))
(declare-fun cert_attr_ianda_to_cert (us_rep8) us_rep3)
(declare-fun cert_attr_ianda_to_cert__function_guard (us_rep3 us_rep8) Bool)
(assert true)
(declare-fun cert_attr_ianda_to_cert_attr (us_rep8) us_rep6)
(declare-fun cert_attr_ianda_to_cert_attr__function_guard (us_rep6 us_rep8) Bool)
(assert true)
...
(declare-fun user_eq27 (certificatestatus certificatestatus) Bool)
(declare-const dummy27 certificatestatus)
...
(assert (forall ((x certificatestatus)) (! (= (of_rep14 (to_rep14 x)) x) :pattern ((to_rep14 x)))))
(assert (forall ((x certificatestatus)) (! (in_range16 (to_rep14 x)) :pattern ((to_rep14 x)))))
(assert (forall ((x Int)) (! (=> (in_range16 x) (= (to_rep14 (of_rep14 x)) x)) :pattern ((to_rep14 (of_rep14 x))))))
(declare-datatypes () ((us_split_fields18 (mk___split_fields9 (rec__usertoken__valididcertt__valid Bool) (rec__usertoken__valididcertt__idstatus certificatestatus) (rec__usertoken__valididcertt__contents us_rep5)))))
(define-fun us_split_fields_Valid__projection ((a us_split_fields18)) Bool (rec__usertoken__valididcertt__valid a))
(define-fun us_split_fields_IDStatus__projection ((a us_split_fields18)) certificatestatus (rec__usertoken__valididcertt__idstatus a))
(define-fun us_split_fields_Contents__projection ((a us_split_fields18)) us_rep5 (rec__usertoken__valididcertt__contents a))
(declare-datatypes () ((us_split_fields__ref9 (mk___split_fields__ref9 (us_split_fields__content9 us_split_fields18)))))
(define-fun us_split_fields__ref___24__projection ((a us_split_fields__ref9)) us_split_fields18 (us_split_fields__content9 a))
(declare-datatypes () ((us_rep9 (mk___rep9 (us_split_fields19 us_split_fields18)))))
(define-fun us_rep___25__projection ((a us_rep9)) us_split_fields18 (us_split_fields19 a))
(define-fun bool_eq11 ((a us_rep9) (b us_rep9)) Bool (ite (and (and (= (rec__usertoken__valididcertt__valid (us_split_fields19 a)) (rec__usertoken__valididcertt__valid (us_split_fields19 b))) (= (to_rep14 (rec__usertoken__valididcertt__idstatus (us_split_fields19 a))) (to_rep14 (rec__usertoken__valididcertt__idstatus (us_split_fields19 b))))) (= (bool_eq6 (rec__usertoken__valididcertt__contents (us_split_fields19 a)) (rec__usertoken__valididcertt__contents (us_split_fields19 b))) true)) true false))
...
(declare-fun temp___String_Literal_2057 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2057 us_void_param) 1)) 73) (= (to_rep (select (temp___String_Literal_2057 us_void_param) 2)) 38)) (= (to_rep (select (temp___String_Literal_2057 us_void_param) 3)) 65)) (= (to_rep (select (temp___String_Literal_2057 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_2057 us_void_param) 5)) 67)) (= (to_rep (select (temp___String_Literal_2057 us_void_param) 6)) 101)) (= (to_rep (select (temp___String_Literal_2057 us_void_param) 7)) 114)) (= (to_rep (select (temp___String_Literal_2057 us_void_param) 8)) 116)) (= (to_rep (select (temp___String_Literal_2057 us_void_param) 9)) 105)) (= (to_rep (select (temp___String_Literal_2057 us_void_param) 10)) 102)) (= (to_rep (select (temp___String_Literal_2057 us_void_param) 11)) 105)) (= (to_rep (select (temp___String_Literal_2057 us_void_param) 12)) 99)) (= (to_rep (select (temp___String_Literal_2057 us_void_param) 13)) 97)) (= (to_rep (select (temp___String_Literal_2057 us_void_param) 14)) 116)) (= (to_rep (select (temp___String_Literal_2057 us_void_param) 15)) 101)) (= (to_rep (select (temp___String_Literal_2057 us_void_param) 16)) 32)) (= (to_rep (select (temp___String_Literal_2057 us_void_param) 17)) 78)) (= (to_rep (select (temp___String_Literal_2057 us_void_param) 18)) 111)) (= (to_rep (select (temp___String_Literal_2057 us_void_param) 19)) 116)) (= (to_rep (select (temp___String_Literal_2057 us_void_param) 20)) 32)) (= (to_rep (select (temp___String_Literal_2057 us_void_param) 21)) 67)) (= (to_rep (select (temp___String_Literal_2057 us_void_param) 22)) 117)) (= (to_rep (select (temp___String_Literal_2057 us_void_param) 23)) 114)) (= (to_rep (select (temp___String_Literal_2057 us_void_param) 24)) 114)) (= (to_rep (select (temp___String_Literal_2057 us_void_param) 25)) 101)) (= (to_rep (select (temp___String_Literal_2057 us_void_param) 26)) 110)) (= (to_rep (select (temp___String_Literal_2057 us_void_param) 27)) 116)) :pattern ((temp___String_Literal_2057 us_void_param)))))
(declare-fun temp___String_Literal_2062 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2062 us_void_param) 1)) 73) (= (to_rep (select (temp___String_Literal_2062 us_void_param) 2)) 38)) (= (to_rep (select (temp___String_Literal_2062 us_void_param) 3)) 65)) (= (to_rep (select (temp___String_Literal_2062 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_2062 us_void_param) 5)) 67)) (= (to_rep (select (temp___String_Literal_2062 us_void_param) 6)) 101)) (= (to_rep (select (temp___String_Literal_2062 us_void_param) 7)) 114)) (= (to_rep (select (temp___String_Literal_2062 us_void_param) 8)) 116)) (= (to_rep (select (temp___String_Literal_2062 us_void_param) 9)) 105)) (= (to_rep (select (temp___String_Literal_2062 us_void_param) 10)) 102)) (= (to_rep (select (temp___String_Literal_2062 us_void_param) 11)) 105)) (= (to_rep (select (temp___String_Literal_2062 us_void_param) 12)) 99)) (= (to_rep (select (temp___String_Literal_2062 us_void_param) 13)) 97)) (= (to_rep (select (temp___String_Literal_2062 us_void_param) 14)) 116)) (= (to_rep (select (temp___String_Literal_2062 us_void_param) 15)) 101)) (= (to_rep (select (temp___String_Literal_2062 us_void_param) 16)) 32)) (= (to_rep (select (temp___String_Literal_2062 us_void_param) 17)) 78)) (= (to_rep (select (temp___String_Literal_2062 us_void_param) 18)) 111)) (= (to_rep (select (temp___String_Literal_2062 us_void_param) 19)) 116)) (= (to_rep (select (temp___String_Literal_2062 us_void_param) 20)) 32)) (= (to_rep (select (temp___String_Literal_2062 us_void_param) 21)) 86)) (= (to_rep (select (temp___String_Literal_2062 us_void_param) 22)) 101)) (= (to_rep (select (temp___String_Literal_2062 us_void_param) 23)) 114)) (= (to_rep (select (temp___String_Literal_2062 us_void_param) 24)) 105)) (= (to_rep (select (temp___String_Literal_2062 us_void_param) 25)) 102)) (= (to_rep (select (temp___String_Literal_2062 us_void_param) 26)) 105)) (= (to_rep (select (temp___String_Literal_2062 us_void_param) 27)) 97)) (= (to_rep (select (temp___String_Literal_2062 us_void_param) 28)) 98)) (= (to_rep (select (temp___String_Literal_2062 us_void_param) 29)) 108)) (= (to_rep (select (temp___String_Literal_2062 us_void_param) 30)) 101)) :pattern ((temp___String_Literal_2062 us_void_param)))))
(declare-fun temp___String_Literal_2067 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2067 us_void_param) 1)) 73) (= (to_rep (select (temp___String_Literal_2067 us_void_param) 2)) 38)) (= (to_rep (select (temp___String_Literal_2067 us_void_param) 3)) 65)) (= (to_rep (select (temp___String_Literal_2067 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_2067 us_void_param) 5)) 67)) (= (to_rep (select (temp___String_Literal_2067 us_void_param) 6)) 101)) (= (to_rep (select (temp___String_Literal_2067 us_void_param) 7)) 114)) (= (to_rep (select (temp___String_Literal_2067 us_void_param) 8)) 116)) (= (to_rep (select (temp___String_Literal_2067 us_void_param) 9)) 105)) (= (to_rep (select (temp___String_Literal_2067 us_void_param) 10)) 102)) (= (to_rep (select (temp___String_Literal_2067 us_void_param) 11)) 105)) (= (to_rep (select (temp___String_Literal_2067 us_void_param) 12)) 99)) (= (to_rep (select (temp___String_Literal_2067 us_void_param) 13)) 97)) (= (to_rep (select (temp___String_Literal_2067 us_void_param) 14)) 116)) (= (to_rep (select (temp___String_Literal_2067 us_void_param) 15)) 101)) (= (to_rep (select (temp___String_Literal_2067 us_void_param) 16)) 32)) (= (to_rep (select (temp___String_Literal_2067 us_void_param) 17)) 66)) (= (to_rep (select (temp___String_Literal_2067 us_void_param) 18)) 97)) (= (to_rep (select (temp___String_Literal_2067 us_void_param) 19)) 100)) :pattern ((temp___String_Literal_2067 us_void_param)))))
...
(define-fun dynamic_invariant1 ((temp___expr_1638 Int) (temp___is_init_1635 Bool) (temp___skip_constant_1636 Bool) (temp___do_toplevel_1637 Bool)) Bool (=> (or (= temp___is_init_1635 true) (<= 0 3)) (in_range16 temp___expr_1638)))
(define-fun dynamic_invariant2 ((temp___expr_384 Int) (temp___is_init_381 Bool) (temp___skip_constant_382 Bool) (temp___do_toplevel_383 Bool)) Bool (=> (or (= temp___is_init_381 true) (<= 1 150)) (in_range5 temp___expr_384)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(define-fun dynamic_invariant3 ((temp___expr_426 Int) (temp___is_init_423 Bool) (temp___skip_constant_424 Bool) (temp___do_toplevel_425 Bool)) Bool (=> (or (= temp___is_init_423 true) (<= 1901 2099)) (in_range7 temp___expr_426)))
(define-fun dynamic_invariant4 ((temp___expr_432 Int) (temp___is_init_429 Bool) (temp___skip_constant_430 Bool) (temp___do_toplevel_431 Bool)) Bool (=> (or (= temp___is_init_429 true) (<= 1 12)) (in_range8 temp___expr_432)))
(define-fun dynamic_invariant5 ((temp___expr_438 Int) (temp___is_init_435 Bool) (temp___skip_constant_436 Bool) (temp___do_toplevel_437 Bool)) Bool (=> (or (= temp___is_init_435 true) (<= 1 31)) (in_range9 temp___expr_438)))
(define-fun dynamic_invariant6 ((temp___expr_462 Int) (temp___is_init_459 Bool) (temp___skip_constant_460 Bool) (temp___do_toplevel_461 Bool)) Bool (=> (or (= temp___is_init_459 true) (<= 0 86399999)) (in_range10 temp___expr_462)))
(define-fun dynamic_invariant7 ((temp___expr_167 Int) (temp___is_init_164 Bool) (temp___skip_constant_165 Bool) (temp___do_toplevel_166 Bool)) Bool (=> (or (= temp___is_init_164 true) (<= 0 255)) (in_range14 temp___expr_167)))
(define-fun dynamic_invariant8 ((temp___expr_846 Int) (temp___is_init_843 Bool) (temp___skip_constant_844 Bool) (temp___do_toplevel_845 Bool)) Bool (=> (or (= temp___is_init_843 true) (<= 0 2147483647)) (in_range13 temp___expr_846)))
(define-fun dynamic_invariant9 ((temp___expr_873 Int) (temp___is_init_870 Bool) (temp___skip_constant_871 Bool) (temp___do_toplevel_872 Bool)) Bool (=> (or (= temp___is_init_870 true) (<= 0 4294967295)) (in_range15 temp___expr_873)))
(define-fun dynamic_invariant10 ((temp___expr_179 Int) (temp___is_init_176 Bool) (temp___skip_constant_177 Bool) (temp___do_toplevel_178 Bool)) Bool (=> (or (= temp___is_init_176 true) (<= 0 40)) (in_range2 temp___expr_179)))
(define-fun dynamic_invariant11 ((temp___expr_200 Int) (temp___is_init_197 Bool) (temp___skip_constant_198 Bool) (temp___do_toplevel_199 Bool)) Bool (=> (or (= temp___is_init_197 true) (<= 0 4294967295)) (in_range3 temp___expr_200)))
(define-fun dynamic_invariant12 ((temp___expr_218 Int) (temp___is_init_215 Bool) (temp___skip_constant_216 Bool) (temp___do_toplevel_217 Bool)) Bool (=> (or (= temp___is_init_215 true) (<= 0 10)) (in_range6 temp___expr_218)))
(define-fun dynamic_invariant13 ((temp___expr_230 Int) (temp___is_init_227 Bool) (temp___skip_constant_228 Bool) (temp___do_toplevel_229 Bool)) Bool (=> (or (= temp___is_init_227 true) (<= 0 4294967295)) (in_range11 temp___expr_230)))
(define-fun dynamic_invariant14 ((temp___expr_236 Int) (temp___is_init_233 Bool) (temp___skip_constant_234 Bool) (temp___do_toplevel_235 Bool)) Bool (=> (or (= temp___is_init_233 true) (<= 0 128)) (in_range12 temp___expr_236)))
(define-fun dynamic_invariant15 ((temp___expr_321 Int) (temp___is_init_318 Bool) (temp___skip_constant_319 Bool) (temp___do_toplevel_320 Bool)) Bool (=> (or (= temp___is_init_318 true) (<= 0 4294967295)) (in_range4 temp___expr_321)))
(declare-const description (Array Int character))
(declare-const idcert__split_fields us_split_fields__ref9)
(declare-const iandacertcontents__split_fields us_split_fields__ref8)
...
(declare-const iandacertcontents__split_fields1 us_split_fields16)
...
(declare-const iandacertcontents__split_fields2 us_split_fields16)
...
(define-fun o14 () us_rep1 (mk___rep1 (mk___split_fields1 (mk___rep (mk___split_fields o6 o7 o8)) o9)))
(define-fun o15 () us_rep1 (mk___rep1 (mk___split_fields1 (mk___rep (mk___split_fields o2 o3 o4)) o5)))
...
(assert (=> (= certfound true) (=> (= extractok2 true) (= (let ((subject idcertcontents__split_fields)) idcertcontents__split_fields2) (us_split_fields11 (rec__usertoken__valididcertt__contents (us_split_fields__content9 idcert__split_fields)))))))
(assert (=> (= certfound true) (=> (= extractok2 true) (= o1 (cert_attr_ianda_to_cert_attr (mk___rep8 (let ((subject iandacertcontents__split_fields)) iandacertcontents__split_fields2)))))))
(assert (=> (= certfound true) (=> (= extractok2 true) (= o15 (thebasecert o1)))))
(assert (=> (= certfound true) (=> (= extractok2 true) (= o (cert_id_to_cert (mk___rep5 (let ((subject idcertcontents__split_fields)) idcertcontents__split_fields2)))))))
(assert (=> (= certfound true) (=> (= extractok2 true) (= o14 (theid o)))))
(assert (=> (= certfound true) (=> (= extractok2 true) (= o10 (bool_eq2 o14 o15)))))
...
(assert (=> (= certfound true) (=> (= extractok2 true) (= o11 (cert_attr_ianda_to_cert (mk___rep8 (let ((subject iandacertcontents__split_fields)) iandacertcontents__split_fields2)))))))
(assert (=> (= certfound true) (=> (= extractok2 true) (= o12 (cert_attr_ianda_to_cert (mk___rep8 (let ((subject iandacertcontents__split_fields)) iandacertcontents__split_fields2)))))))
(assert (=> (= certfound true) (=> (= extractok2 true) (= o13 (iscurrent o12 currenttime)))))
...
(assert (=> (= certfound true) (=> (not (= extractok2 true)) (= (let ((subject idcertcontents__split_fields)) (mk___split_fields__ref5 idcertcontents__split_fields2)) idcertcontents__split_fields))))
...
(assert (=> (not (= certfound true)) (= (let ((subject idcertcontents__split_fields)) (mk___split_fields__ref5 idcertcontents__split_fields2)) idcertcontents__split_fields)))
(assert (=> (not (= certfound true)) (= (let ((subject iandacertcontents__split_fields)) (mk___split_fields__ref8 iandacertcontents__split_fields2)) iandacertcontents__split_fields)))
