...
(assert (and (= o2 (value by__)) (and (dynamic_invariant3 o2 true false true true) (and (and (= (elts1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 by__))) o) (= (mk (to_rep1 (first4 (mk2 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 by__)))))) (to_rep1 (last4 (mk2 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 by__))))))) o1)) (and (and (and (= (length o2) (length2 by__)) (= (to_rep1 (first o1)) 1)) (= (to_rep1 (last o1)) (length2 by__))) (= (< 0 (length2 by__)) (not (= (empty by__) true))))))))
(assert (and (and (= (bool_eq (elts (value (mk___rep this__split_discrs this__split_fields12))) (to_rep1 (first8 (mk4 start (- (+ start (length o2)) 1)))) (to_rep1 (last8 (mk4 start (- (+ start (length o2)) 1)))) o (to_rep1 (first o1)) (to_rep1 (last o1))) true) (ite (< (length2 (mk___rep this__split_discrs (mk___split_fields this__split_fields (mk___t1 this__split_fields1 this__split_fields2)))) (- (+ start (length o2)) 1)) (= (length2 (mk___rep this__split_discrs this__split_fields12)) (- (+ start (length o2)) 1)) (= (length2 (mk___rep this__split_discrs this__split_fields12)) (length2 (mk___rep this__split_discrs (mk___split_fields this__split_fields (mk___t1 this__split_fields1 this__split_fields2))))))) (dynamic_invariant1 (mk___rep this__split_discrs this__split_fields12) true true true true)))
...
(assert (not (= (let ((temp___1242 (value by__))) (bool_eq (elts (value (mk___rep this__split_discrs (mk___split_fields this__split_fields6 (mk___t1 this__split_fields7 this__split_fields8))))) (to_rep1 (first6 (mk3 start (- (+ start (length2 by__)) 1)))) (to_rep1 (last6 (mk3 start (- (+ start (length2 by__)) 1)))) (elts temp___1242) (to_rep1 (first (rt temp___1242))) (to_rep1 (last (rt temp___1242))))) true)))
(check-sat)
(exit)
