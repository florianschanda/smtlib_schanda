...
(assert (not (= (let ((temp___1179 (value by__))) (bool_eq (elts (value (mk___rep this__split_discrs (mk___split_fields this__split_fields6 (mk___t1 this__split_fields7 this__split_fields8))))) (to_rep1 (first6 (mk3 start (- (+ start (length2 by__)) 1)))) (to_rep1 (last6 (mk3 start (- (+ start (length2 by__)) 1)))) (elts temp___1179) (to_rep1 (first (rt temp___1179))) (to_rep1 (last (rt temp___1179))))) true)))
(check-sat)
(exit)
