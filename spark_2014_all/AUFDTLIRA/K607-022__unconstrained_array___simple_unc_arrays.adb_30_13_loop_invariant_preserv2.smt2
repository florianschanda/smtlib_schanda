...
(assert (= (ite (<= (to_rep1 (first a__split_fields3)) (to_rep1 (last a__split_fields3))) (+ (- (to_rep1 (last a__split_fields3)) (to_rep1 (first a__split_fields3))) 1) 0) (ite (<= 1 r22b) (+ (- r22b 1) 1) 0)))
...
(assert (= a__split_fields4 (mk___split_fields (mk___t (slide simple_unc_arrays__swap_cells__a (to_rep1 (first2 (mk1 (to_rep1 (first4 simple_unc_arrays__swap_cells__a__compl1)) (to_rep1 (last4 simple_unc_arrays__swap_cells__a__compl1))))) 1) (mk (to_rep1 (first4 (mk2 1 r22b))) (to_rep1 (last4 (mk2 1 r22b))))))))
...
(assert (<= 1 j))
(assert (<= j (- low3 1)))
(assert (not (= (to_rep2 (select (elts (rec__simple_unc_arrays__table__v a__split_fields4)) j)) (to_rep2 (select a__split_fields (+ (- (to_rep (rec__simple_unc_arrays__table__last a__split_discrs)) j) 1))))))
(check-sat)
(exit)
