...
(assert (and (= o362 v) (in_range1 v)))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))) true))
(assert (and (= o363 v) (in_range1 v)))
(assert (not (= (valid_root (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) o363) true)))
(check-sat)
(exit)
