...
(assert (not (= (ite (<= (to_rep1 (first4 temp___21061)) (to_rep1 (last4 temp___21061))) (+ (- (to_rep1 (last4 temp___21061)) (to_rep1 (first4 temp___21061))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 2) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 2)) 1) 0))))
(check-sat)
(exit)
