...
(assert (<= 1 id5))
(assert (<= id5 3))
(assert (and (= o2 (get_previous_track cur_position id5)) (and (in_range1 o2) (= o2 (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep (rec__trains__train_position__track_end (us_split_fields3 cur_position)))))))) id5))))))
(assert (= result8 (mk_int__ref prev)))
(assert (= prev2 o2))
(assert (=> (not (= prev2 0)) (and (<= 1 prev2) (<= prev2 8))))
(assert (=> (not (= prev2 0)) (= o3 prev2)))
(assert (=> (not (= prev2 0)) (= o4 (select track_signals2 o3))))
(assert (=> (not (= prev2 0)) (= o5 (to_rep5 o4))))
(assert (=> (not (= prev2 0)) (= result9 (ite (= o5 1) true false))))
(assert (=> (= prev2 0) (= result9 false)))
(assert (=> (= result9 true) (and (= o6 prev2) (in_range2 prev2))))
(assert (=> (= result9 true) (and (ite (exists ((t1 Int)) (and (and (<= 1 t1) (<= t1 cur_num_trains)) (= (is_previous_track (select trains3 t1) o6) true))) (= (to_rep5 (select track_signals3 o6)) 1) (= (to_rep5 (select track_signals3 o6)) 0)) (forall ((other_track Int)) (=> (and (<= 1 other_track) (<= other_track 8)) (=> (not (= other_track o6)) (= (to_rep5 (select track_signals3 other_track)) (to_rep5 (select track_signals2 other_track)))))))))
(assert (=> (not (= result9 true)) (= track_signals3 track_signals2)))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 8)) (and (=> (= (to_rep5 (select track_signals2 j1)) 2) (= (to_rep5 (select track_signals4 j1)) 2)) (=> (and (= (to_rep5 (select track_signals2 j1)) 1) (exists ((t1 Int)) (and (and (<= 1 t1) (<= t1 cur_num_trains)) (= (is_previous_track (select trains3 t1) j1) true)))) (= (to_rep5 (select track_signals4 j1)) 1))))))
(assert (and (and (=> (<= 1 3) (in_range3 id6)) (=> (<= 0 8) (in_range1 prev3))) (and (<= 1 id6) (<= id6 3))))
(assert (<= 1 j))
(assert (<= j 8))
(assert (=> (= (to_rep5 (select track_signals2 j)) 2) (= result10 (ite (= (to_rep5 (select track_signals4 j)) 2) true false))))
(assert (=> (not (= (to_rep5 (select track_signals2 j)) 2)) (= result10 (of_int 1))))
(assert (= result10 true))
(assert (= (to_rep5 (select track_signals2 j)) 1))
(assert (<= 1 t))
(assert (<= t cur_num_trains))
(assert (not (<= 1 t)))
(check-sat)
(exit)
