...
(assert (<= 1 id1))
(assert (<= id1 3))
(assert (and (= o2 (get_previous_track cur_position id1)) (and (in_range1 o2) (= o2 (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep (rec__trains__train_position__track_end (us_split_fields3 cur_position)))))))) id1))))))
(assert (= result6 (mk_int__ref prev)))
(assert (= prev1 o2))
...
(assert (=> (not (= prev1 0)) (= result7 (ite (= o5 1) true false))))
(assert (=> (not (not (= prev1 0))) (= result7 false)))
(assert (=> (= result7 true) (and (= o6 prev1) (in_range2 prev1))))
(assert (=> (= result7 true) (and (ite (exists ((t1 Int)) (and (and (<= 1 t1) (<= t1 cur_num_trains)) (= (is_previous_track (select trains1 t1) o6) true))) (= (to_rep5 (select track_signals2 o6)) 1) (= (to_rep5 (select track_signals2 o6)) 0)) (forall ((other_track Int)) (=> (and (<= 1 other_track) (<= other_track 8)) (=> (not (= other_track o6)) (= (to_rep5 (select track_signals2 other_track)) (to_rep5 (select track_signals1 other_track)))))))))
(assert (=> (not (= result7 true)) (= track_signals2 track_signals1)))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 8)) (and (=> (= (to_rep5 (select track_signals1 j1)) 2) (= (to_rep5 (select track_signals3 j1)) 2)) (=> (and (= (to_rep5 (select track_signals1 j1)) 1) (exists ((t1 Int)) (and (and (<= 1 t1) (<= t1 cur_num_trains)) (= (is_previous_track (select trains1 t1) j1) true)))) (= (to_rep5 (select track_signals3 j1)) 1))))))
(assert (and (and (=> (<= 1 3) (in_range3 id2)) (=> (<= 0 8) (in_range1 prev2))) (and (<= 1 id2) (<= id2 3))))
(assert (<= 1 j))
(assert (<= j 8))
(assert (=> (= (to_rep5 (select track_signals1 j)) 2) (= result8 (ite (= (to_rep5 (select track_signals3 j)) 2) true false))))
(assert (=> (not (= (to_rep5 (select track_signals1 j)) 2)) (= result8 (of_int 1))))
(assert (= result8 true))
(assert (= (to_rep5 (select track_signals1 j)) 1))
(assert (<= 1 t))
