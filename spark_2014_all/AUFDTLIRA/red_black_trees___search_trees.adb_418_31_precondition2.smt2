...
(declare-const temp___1602 (Array Int us_rep3))
...
(assert (= o32 (select temp___1605 i2)))
...
(assert (= o23 (select temp___1603 i2)))
...
(assert (and (= temp___1602 (model__ f root)) (and (dynamic_invariant5 temp___1602 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1602 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1602 root)))) 0) (and (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (=> (not (= i3 root)) (ite (and (not (= (parent f i3) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1602 (parent f i3)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1602 i3))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1602 i3))) true)))))) (and (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1602 i3))) true) (not (= i3 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select temp___1602 (parent f i3)))) (position f i3) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1602 i3)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1602 i3)))) 0)))) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1602 i3))) true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1602 j2))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select temp___1602 i3))) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1602 j2)))) true)) (= j2 i3))))))))))))))
(assert (= o20 (select temp___1602 j1)))
