...
(assert (= result12 (int__content indexbis__result32)))
(assert (= (int__content indexbis__result32) 0))
(assert (not (not (exists ((i4 Int)) (and (and (<= (to_rep1 (first (rt s))) i4) (<= i4 (to_rep1 (last (rt s))))) (exists ((j6 Int)) (and (and (<= (to_rep1 (first (rt c))) j6) (<= j6 (to_rep1 (last (rt c))))) (= (to_rep (select (elts s) i4)) (to_rep (select (elts c) j6))))))))))
(check-sat)
(exit)
