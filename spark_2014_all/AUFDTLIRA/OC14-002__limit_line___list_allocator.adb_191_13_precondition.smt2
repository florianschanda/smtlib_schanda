...
(assert (=> (not (= first_available1 0)) (= result13 (ite (< 0 o44) true false))))
(assert (=> (not (= first_available1 0)) (=> (= result13 true) (and (= o43 (get (rec__list_allocator__m__t__available model____split_fields3) 1)) (in_range4 o43)))))
(assert (=> (not (= first_available1 0)) (=> (= result13 true) (= result12 (ite (= o43 first_available1) true false)))))
...
(assert (=> (not (not (= first_available1 0))) (= result12 (ite (= o45 0) true false))))
(assert (=> (= result12 true) (=> (not (= first_allocated1 0)) (and (= o41 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range3 o41)))))
(assert (=> (= result12 true) (=> (not (= first_allocated1 0)) (= result14 (ite (< 0 o41) true false)))))
(assert (=> (= result12 true) (=> (not (= first_allocated1 0)) (=> (= result14 true) (and (= o40 (get (rec__list_allocator__m__t__allocated model____split_fields3) 1)) (in_range4 o40))))))
(assert (=> (= result12 true) (=> (not (= first_allocated1 0)) (=> (= result14 true) (= result11 (ite (= o40 first_allocated1) true false))))))
(assert (=> (= result12 true) (=> (not (= first_allocated1 0)) (=> (not (= result14 true)) (= result11 false)))))
(assert (=> (= result12 true) (=> (not (not (= first_allocated1 0))) (and (= o42 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range3 o42)))))
(assert (=> (= result12 true) (=> (not (not (= first_allocated1 0))) (= result11 (ite (= o42 0) true false)))))
(assert (=> (not (= result12 true)) (= result11 false)))
(assert (=> (= result11 true) (and (= o38 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range3 o38))))
(assert (=> (= result11 true) (= o39 (ite (<= j1 o38) true false))))
(assert (=> (= result11 true) (= result15 (ite (<= 1 j1) o39 false))))
...
(assert (not (<= j (length (rec__list_allocator__m__t__allocated model____split_fields3)))))
(check-sat)
(exit)
