...
(assert (=> (= result37 true) (and (= o136 (length (rec__list_allocator__m__t__available model____split_fields4))) (in_range6 o136))))
(assert (=> (= result37 true) (= o137 (ite (<= j11 o136) true false))))
(assert (=> (= result37 true) (= result41 (ite (<= 1 j11) o137 false))))
(assert (=> (= result37 true) (= (= result36 true) (forall ((j12 Int)) (=> (and (<= 1 j12) (<= j12 (length (rec__list_allocator__m__t__available model____split_fields4)))) (and (in_range4 (get (rec__list_allocator__m__t__available model____split_fields4) j12)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data4 (get (rec__list_allocator__m__t__available model____split_fields4) j12))))) (ite (< j12 (length (rec__list_allocator__m__t__available model____split_fields4))) (get (rec__list_allocator__m__t__available model____split_fields4) (+ j12 1)) 0))))))))
...
(assert (= o131 (ite (<= j10 o130) true false)))
(assert (= result44 (ite (<= 1 j10) o131 false)))
