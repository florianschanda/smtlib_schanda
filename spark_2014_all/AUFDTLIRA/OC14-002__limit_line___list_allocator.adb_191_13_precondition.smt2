...
(assert (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 (length (rec__list_allocator__m__t__available model____split_fields3)))) (= (bool_eq (select data3 (get (rec__list_allocator__m__t__available model____split_fields3) j2)) (select data3 (get ma1 (+ j2 1)))) true))))
(assert (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 (- (length ma1) 2))) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data3 (get ma1 (+ j2 1)))))) (get ma1 (+ j2 2))))))
(assert (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 (- (length (rec__list_allocator__m__t__available model____split_fields3)) 1))) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data3 (get ma1 (+ j2 1)))))) (get ma1 (+ j2 2))))))
(assert (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 (length (rec__list_allocator__m__t__available model____split_fields3)))) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data3 (get ma1 (+ j2 1)))))) (ite (< j2 (length (rec__list_allocator__m__t__available model____split_fields3))) (get ma1 (+ j2 2)) 0)))))
...
(assert (=> (not (= first_available1 0)) (and (= o51 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range6 o51))))
(assert (=> (not (= first_available1 0)) (= result13 (ite (< 0 o51) true false))))
(assert (=> (not (= first_available1 0)) (=> (= result13 true) (and (= o50 (get (rec__list_allocator__m__t__available model____split_fields3) 1)) (in_range7 o50)))))
(assert (=> (not (= first_available1 0)) (=> (= result13 true) (= result12 (ite (= o50 first_available1) true false)))))
(assert (=> (not (= first_available1 0)) (=> (not (= result13 true)) (= result12 false))))
(assert (=> (not (not (= first_available1 0))) (and (= o52 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range6 o52))))
(assert (=> (not (not (= first_available1 0))) (= result12 (ite (= o52 0) true false))))
(assert (=> (= result12 true) (=> (not (= first_allocated1 0)) (and (= o48 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range6 o48)))))
(assert (=> (= result12 true) (=> (not (= first_allocated1 0)) (= result14 (ite (< 0 o48) true false)))))
(assert (=> (= result12 true) (=> (not (= first_allocated1 0)) (=> (= result14 true) (and (= o47 (get (rec__list_allocator__m__t__allocated model____split_fields3) 1)) (in_range7 o47))))))
(assert (=> (= result12 true) (=> (not (= first_allocated1 0)) (=> (= result14 true) (= result11 (ite (= o47 first_allocated1) true false))))))
(assert (=> (= result12 true) (=> (not (= first_allocated1 0)) (=> (not (= result14 true)) (= result11 false)))))
(assert (=> (= result12 true) (=> (not (not (= first_allocated1 0))) (and (= o49 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range6 o49)))))
(assert (=> (= result12 true) (=> (not (not (= first_allocated1 0))) (= result11 (ite (= o49 0) true false)))))
(assert (=> (not (= result12 true)) (= result11 false)))
(assert (=> (= result11 true) (and (= o45 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range6 o45))))
(assert (=> (= result11 true) (= o46 (ite (<= j1 o45) true false))))
(assert (=> (= result11 true) (= result15 (ite (<= 1 j1) o46 false))))
...
(assert (and (= o43 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range6 o43)))
(assert (= o44 (ite (<= j o43) true false)))
(assert (= result16 (ite (<= 1 j) o44 false)))
