...
(assert (and (= o19 (- y 1)) (in_range4 (- y 1))))
...
(assert (and (= o15 (- y 1)) (in_range4 (- y 1))))
...
(assert (= hr2 o21))
(assert (and (= o23 y) (in_range4 y)))
(assert (and (= o22 x) (in_range4 x)))
...
(assert (and (= o27 (- y 1)) (in_range4 (- y 1))))
...
(assert (and (= o36 (- y 1)) (in_range4 (- y 1))))
(assert (and (= o34 x) (in_range4 x)))
(assert (and (= o35 (remove (mk___t values2 (mk 1 100)) o34)) (and (dynamic_invariant3 o35 true false true true) (and (= (invariant__ o35) true) (and (= (to_rep1 (last (rt o35))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o34 1))) (= (to_rep (select values2 k)) (to_rep (select (elts o35) k))))) (and (forall ((k Int)) (=> (and (<= (+ o34 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select (elts o35) (- k 1)))))) (forall ((k Int)) (=> (and (<= o34 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts o35) k))))))))))))
