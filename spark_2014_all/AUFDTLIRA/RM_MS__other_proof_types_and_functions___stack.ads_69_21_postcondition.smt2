...
(assert (= o4 (to_rep1 my_stack__split_fields1)))
(assert (= o5 (select my_stack__split_fields o4)))
(assert (= o6 (to_rep o5)))
...
(assert (= o7 (- (to_rep1 my_stack__split_fields1) 1)))
(assert (= o8 (select my_stack__split_fields o7)))
(assert (= o9 (to_rep o8)))
(assert (= (to_rep o10) o9))
(assert (and (<= 1 (to_rep1 my_stack__split_fields1)) (<= (to_rep1 my_stack__split_fields1) 100)))
(assert (= o11 (to_rep1 my_stack__split_fields1)))
(assert (= o12 (store my_stack__split_fields o11 o10)))
(assert (= o12 o13))
(assert (= my_stack__split_fields1 o14))
(assert (= temp___216 o13))
(assert (= temp___2161 o14))
...
(assert (= temp___216 my_stack__split_fields2))
(assert (= temp___2161 my_stack__split_fields3))
(assert (= (to_rep o15) temp1))
(assert (and (<= 1 (- (to_rep1 my_stack__split_fields3) 1)) (<= (- (to_rep1 my_stack__split_fields3) 1) 100)))
(assert (= o16 (- (to_rep1 my_stack__split_fields3) 1)))
(assert (= o17 (store my_stack__split_fields2 o16 o15)))
(assert (= o17 o18))
(assert (= my_stack__split_fields3 o19))
(assert (= temp___220 o18))
(assert (= temp___2201 o19))
(assert (= result3 my_stack__split_fields2))
(assert (= result4 my_stack__split_fields3))
(assert (= temp___220 my_stack__split_fields4))
(assert (= temp___2201 my_stack__split_fields5))
(assert (= temp1 temp2))
