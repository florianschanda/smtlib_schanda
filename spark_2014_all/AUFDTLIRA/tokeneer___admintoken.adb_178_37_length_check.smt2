...
(declare-const temp___21211 t1)
(declare-const o (Array Int character))
(declare-const temp___2124 (Array Int character))
(declare-const temp___21241 t1)
...
(assert (= (slide (elts text) (to_rep1 (first (rt text))) 1) temp___2121))
(assert (= (mk1 1 (to_rep1 (last (rt text)))) temp___21211))
(assert (=> (<= 1 (to_rep1 (last (rt text)))) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 (to_rep1 (last (rt text)))) (<= (to_rep1 (last (rt text))) 150)))))
(assert (= o result__1))
(assert (= o temp___2124))
(assert (= (mk1 1 (to_rep1 (last (rt text)))) temp___21241))
(assert (not (= (ite (<= (to_rep1 (first2 temp___21211)) (to_rep1 (last2 temp___21211))) (+ (- (to_rep1 (last2 temp___21211)) (to_rep1 (first2 temp___21211))) 1) 0) (ite (<= (to_rep1 (first2 temp___21241)) (to_rep1 (last2 temp___21241))) (+ (- (to_rep1 (last2 temp___21241)) (to_rep1 (first2 temp___21241))) 1) 0))))
(check-sat)
(exit)
