...
(define-fun dynamic_invariant4 ((temp___expr_551 Int) (temp___is_init_548 Bool) (temp___skip_constant_549 Bool) (temp___do_toplevel_550 Bool)) Bool (=> (or (= temp___is_init_548 true) (<= 1 150)) (in_range3 temp___expr_551)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(declare-const result__ (Array Int character))
(declare-const temp___1951 (Array Int character))
(declare-const temp___19511 t1)
(declare-const o (Array Int character))
(declare-const temp___1954 (Array Int character))
(declare-const temp___19541 t1)
...
(assert (= (slide (elts text) (to_rep1 (first (rt text))) 1) temp___1951))
(assert (= (mk1 1 (to_rep1 (last (rt text)))) temp___19511))
(assert (=> (<= 1 (to_rep1 (last (rt text)))) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 (to_rep1 (last (rt text)))) (<= (to_rep1 (last (rt text))) 150)))))
(assert (= o result__1))
(assert (= o temp___1954))
(assert (= (mk1 1 (to_rep1 (last (rt text)))) temp___19541))
(assert (not (= (ite (<= (to_rep1 (first2 temp___19511)) (to_rep1 (last2 temp___19511))) (+ (- (to_rep1 (last2 temp___19511)) (to_rep1 (first2 temp___19511))) 1) 0) (ite (<= (to_rep1 (first2 temp___19541)) (to_rep1 (last2 temp___19541))) (+ (- (to_rep1 (last2 temp___19541)) (to_rep1 (first2 temp___19541))) 1) 0))))
(check-sat)
(exit)
