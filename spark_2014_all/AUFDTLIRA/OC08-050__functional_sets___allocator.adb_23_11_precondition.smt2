...
(assert (and (= o1 (mem (rec__allocator__m__t__available (us_split_fields1 m)) e1)) (=> (= e1 0) (not (= o1 true)))))
(assert (= (= o2 true) (in_range3 e1)))
(assert (= result1 (ite (= o2 true) o1 false)))
(assert (= (= result true) (forall ((e2 Int)) (=> (and (in_range3 e2) (= (mem (rec__allocator__m__t__available (us_split_fields1 m)) e2) true)) (in_range1 e2)))))
(assert (= result true))
(assert (not true))
(check-sat)
(exit)
