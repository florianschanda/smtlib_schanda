...
(define-fun dynamic_invariant ((temp___expr_1035 Int) (temp___is_init_1032 Bool) (temp___skip_constant_1033 Bool) (temp___do_toplevel_1034 Bool)) Bool (=> (or (= temp___is_init_1032 true) (<= 0 3)) (in_range10 temp___expr_1035)))
...
(assert (forall ((admintoken__authcert__fields us_split_fields10)) (! (dynamic_invariant (theauthcertrole admintoken__authcert__fields) true false true) :pattern ((theauthcertrole admintoken__authcert__fields)))))
...
(define-fun dynamic_invariant2 ((temp___expr_319 Int) (temp___is_init_316 Bool) (temp___skip_constant_317 Bool) (temp___do_toplevel_318 Bool)) Bool (=> (or (= temp___is_init_316 true) (<= 0 40)) (in_range2 temp___expr_319)))
(define-fun dynamic_invariant3 ((temp___expr_340 Int) (temp___is_init_337 Bool) (temp___skip_constant_338 Bool) (temp___do_toplevel_339 Bool)) Bool (=> (or (= temp___is_init_337 true) (<= 0 4294967295)) (in_range4 temp___expr_340)))
(define-fun dynamic_invariant4 ((temp___expr_362 Int) (temp___is_init_359 Bool) (temp___skip_constant_360 Bool) (temp___do_toplevel_361 Bool)) Bool (=> (or (= temp___is_init_359 true) (<= 0 10)) (in_range1 temp___expr_362)))
(define-fun dynamic_invariant5 ((temp___expr_374 Int) (temp___is_init_371 Bool) (temp___skip_constant_372 Bool) (temp___do_toplevel_373 Bool)) Bool (=> (or (= temp___is_init_371 true) (<= 0 4294967295)) (in_range12 temp___expr_374)))
(define-fun dynamic_invariant6 ((temp___expr_380 Int) (temp___is_init_377 Bool) (temp___skip_constant_378 Bool) (temp___do_toplevel_379 Bool)) Bool (=> (or (= temp___is_init_377 true) (<= 0 128)) (in_range13 temp___expr_380)))
(define-fun dynamic_invariant7 ((temp___expr_553 Int) (temp___is_init_550 Bool) (temp___skip_constant_551 Bool) (temp___do_toplevel_552 Bool)) Bool (=> (or (= temp___is_init_550 true) (<= 1901 2099)) (in_range6 temp___expr_553)))
(define-fun dynamic_invariant8 ((temp___expr_559 Int) (temp___is_init_556 Bool) (temp___skip_constant_557 Bool) (temp___do_toplevel_558 Bool)) Bool (=> (or (= temp___is_init_556 true) (<= 1 12)) (in_range7 temp___expr_559)))
(define-fun dynamic_invariant9 ((temp___expr_565 Int) (temp___is_init_562 Bool) (temp___skip_constant_563 Bool) (temp___do_toplevel_564 Bool)) Bool (=> (or (= temp___is_init_562 true) (<= 1 31)) (in_range8 temp___expr_565)))
(define-fun dynamic_invariant10 ((temp___expr_589 Int) (temp___is_init_586 Bool) (temp___skip_constant_587 Bool) (temp___do_toplevel_588 Bool)) Bool (=> (or (= temp___is_init_586 true) (<= 0 86399999)) (in_range9 temp___expr_589)))
(define-fun dynamic_invariant11 ((temp___expr_1041 Int) (temp___is_init_1038 Bool) (temp___skip_constant_1039 Bool) (temp___do_toplevel_1040 Bool)) Bool (=> (or (= temp___is_init_1038 true) (<= 1 3)) (in_range temp___expr_1041)))
(define-fun dynamic_invariant12 ((temp___expr_1047 Int) (temp___is_init_1044 Bool) (temp___skip_constant_1045 Bool) (temp___do_toplevel_1046 Bool)) Bool (=> (or (= temp___is_init_1044 true) (<= 0 5)) (in_range11 temp___expr_1047)))
(define-fun dynamic_invariant13 ((temp___expr_453 Int) (temp___is_init_450 Bool) (temp___skip_constant_451 Bool) (temp___do_toplevel_452 Bool)) Bool (=> (or (= temp___is_init_450 true) (<= 0 4294967295)) (in_range5 temp___expr_453)))
