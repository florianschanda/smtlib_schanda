...
(define-fun dynamic_invariant ((temp___expr_1213 Int) (temp___is_init_1209 Bool) (temp___skip_constant_1210 Bool) (temp___do_toplevel_1211 Bool) (temp___do_typ_inv_1212 Bool)) Bool (=> (or (= temp___is_init_1209 true) (<= 0 3)) (in_range10 temp___expr_1213)))
...
(assert (forall ((x keyidt)) (! (in_range11 (to_rep11 x)) :pattern ((to_rep11 x)))))
(assert (forall ((x Int)) (! (=> (in_range11 x) (= (to_rep11 (of_rep11 x)) x)) :pattern ((to_rep11 (of_rep11 x))))))
...
(assert (forall ((x keylengtht)) (! (in_range12 (to_rep12 x)) :pattern ((to_rep12 x)))))
(assert (forall ((x Int)) (! (=> (in_range12 x) (= (to_rep12 (of_rep12 x)) x)) :pattern ((to_rep12 (of_rep12 x))))))
...
(declare-fun user_eq23 (adminprivileget adminprivileget) Bool)
(declare-const dummy23 adminprivileget)
...
(define-fun dynamic_invariant2 ((temp___expr_402 Int) (temp___is_init_398 Bool) (temp___skip_constant_399 Bool) (temp___do_toplevel_400 Bool) (temp___do_typ_inv_401 Bool)) Bool (=> (or (= temp___is_init_398 true) (<= 0 40)) (in_range4 temp___expr_402)))
(define-fun dynamic_invariant3 ((temp___expr_426 Int) (temp___is_init_422 Bool) (temp___skip_constant_423 Bool) (temp___do_toplevel_424 Bool) (temp___do_typ_inv_425 Bool)) Bool (=> (or (= temp___is_init_422 true) (<= 0 4294967295)) (in_range6 temp___expr_426)))
(define-fun dynamic_invariant4 ((temp___expr_450 Int) (temp___is_init_446 Bool) (temp___skip_constant_447 Bool) (temp___do_toplevel_448 Bool) (temp___do_typ_inv_449 Bool)) Bool (=> (or (= temp___is_init_446 true) (<= 0 10)) (in_range9 temp___expr_450)))
(define-fun dynamic_invariant5 ((temp___expr_464 Int) (temp___is_init_460 Bool) (temp___skip_constant_461 Bool) (temp___do_toplevel_462 Bool) (temp___do_typ_inv_463 Bool)) Bool (=> (or (= temp___is_init_460 true) (<= 0 4294967295)) (in_range11 temp___expr_464)))
(define-fun dynamic_invariant6 ((temp___expr_471 Int) (temp___is_init_467 Bool) (temp___skip_constant_468 Bool) (temp___do_toplevel_469 Bool) (temp___do_typ_inv_470 Bool)) Bool (=> (or (= temp___is_init_467 true) (<= 0 128)) (in_range12 temp___expr_471)))
(define-fun dynamic_invariant7 ((temp___expr_670 Int) (temp___is_init_666 Bool) (temp___skip_constant_667 Bool) (temp___do_toplevel_668 Bool) (temp___do_typ_inv_669 Bool)) Bool (=> (or (= temp___is_init_666 true) (<= 1901 2099)) (in_range temp___expr_670)))
(define-fun dynamic_invariant8 ((temp___expr_677 Int) (temp___is_init_673 Bool) (temp___skip_constant_674 Bool) (temp___do_toplevel_675 Bool) (temp___do_typ_inv_676 Bool)) Bool (=> (or (= temp___is_init_673 true) (<= 1 12)) (in_range1 temp___expr_677)))
(define-fun dynamic_invariant9 ((temp___expr_684 Int) (temp___is_init_680 Bool) (temp___skip_constant_681 Bool) (temp___do_toplevel_682 Bool) (temp___do_typ_inv_683 Bool)) Bool (=> (or (= temp___is_init_680 true) (<= 1 31)) (in_range2 temp___expr_684)))
(define-fun dynamic_invariant10 ((temp___expr_716 Int) (temp___is_init_712 Bool) (temp___skip_constant_713 Bool) (temp___do_toplevel_714 Bool) (temp___do_typ_inv_715 Bool)) Bool (=> (or (= temp___is_init_712 true) (<= 0 86399999)) (in_range3 temp___expr_716)))
(define-fun dynamic_invariant11 ((temp___expr_1220 Int) (temp___is_init_1216 Bool) (temp___skip_constant_1217 Bool) (temp___do_toplevel_1218 Bool) (temp___do_typ_inv_1219 Bool)) Bool (=> (or (= temp___is_init_1216 true) (<= 1 3)) (in_range13 temp___expr_1220)))
(define-fun dynamic_invariant12 ((temp___expr_1227 Int) (temp___is_init_1223 Bool) (temp___skip_constant_1224 Bool) (temp___do_toplevel_1225 Bool) (temp___do_typ_inv_1226 Bool)) Bool (=> (or (= temp___is_init_1223 true) (<= 0 5)) (in_range8 temp___expr_1227)))
(define-fun dynamic_invariant13 ((temp___expr_553 Int) (temp___is_init_549 Bool) (temp___skip_constant_550 Bool) (temp___do_toplevel_551 Bool) (temp___do_typ_inv_552 Bool)) Bool (=> (or (= temp___is_init_549 true) (<= 0 4294967295)) (in_range7 temp___expr_553)))
(declare-const authcert__split_fields us_split_fields__ref5)
(declare-const idcert__split_fields us_split_fields__ref8)
(declare-const o Int)
(assert (and (= (isgood (us_split_fields__content8 idcert__split_fields)) true) (and (= (authcertvalid (us_split_fields__content5 authcert__split_fields)) true) (in_range13 (theauthcertrole (us_split_fields__content5 authcert__split_fields))))))
(assert (and (= o (therole (rec__admintoken__validauthcertt__contents (us_split_fields__content5 authcert__split_fields)))) (and (in_range10 o) (= o (to_rep10 (rec__cert__attr__auth__contentst__role (us_split_fields9 (rec__admintoken__validauthcertt__contents (us_split_fields__content5 authcert__split_fields)))))))))
(assert (not (in_range13 o)))
(check-sat)
(exit)
