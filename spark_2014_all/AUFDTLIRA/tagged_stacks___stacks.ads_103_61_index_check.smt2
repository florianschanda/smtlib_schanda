...
(declare-fun user_eq1 (telement_arrayD1 telement_arrayD1) Bool)
(declare-const dummy1 telement_arrayD1)
...
(assert (forall ((s1 us_rep1)) (! (dynamic_invariant (last2 s1) true false true true) :pattern ((last2 s1)))))
(assert (forall ((attr__tag2 Int)) (forall ((s1 us_rep1)) (! (dynamic_invariant (last3 attr__tag2 s1) true false true true) :pattern ((last3 attr__tag2 s1))))))
(assert (forall ((s1 us_rep1)) (! (= (last2 s1) (last3 us_tag1 s1)) :pattern ((last3 us_tag1 s1)))))
(assert (forall ((s1 us_rep1)) (! (= (last2 s1) (ite (not (= (wraps_around s1) true)) (- (+ (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s1))) (to_rep1 (rec__stacks__stack_root__length1 (us_split_fields3 s1)))) 1) (- (- (+ (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s1))) (to_rep1 (rec__stacks__stack_root__length1 (us_split_fields3 s1)))) 1) 100))) :pattern ((last2 s1)))))
...
(define-fun dynamic_invariant3 ((temp___expr_166 Int) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool (=> (or (= temp___is_init_162 true) (<= 0 2147483647)) (in_range temp___expr_166)))
...
(define-fun default_initial_assumption1 ((temp___expr_185 us_rep) (temp___skip_top_level_186 Bool)) Bool (and (and (= (attr__tag temp___expr_185) us_tag) (and (= (rec__stacks__stack_root__content (us_split_fields1 temp___expr_185)) (temp___187 0)) (= (to_rep1 (rec__stacks__stack_root__length (us_split_fields1 temp___expr_185))) 0))) (=> (not (= temp___skip_top_level_186 true)) (= (size temp___expr_185) 0))))
(assert (forall ((s1 us_rep)) (! (dynamic_invariant (size s1) true false true true) :pattern ((size s1)))))
(assert (forall ((s1 us_rep)) (! (= (size s1) (to_rep1 (rec__stacks__stack_root__length (us_split_fields1 s1)))) :pattern ((size s1)))))
(assert true)
(assert (forall ((s1 us_rep)) (! (= (= (is_empty s1) true) (= (size s1) 0)) :pattern ((is_empty s1)))))
...
(define-fun dynamic_property1 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range3 low) (and (in_range3 high) (=> (<= low high) (and (in_range1 low) (in_range1 high))))))
...
(declare-datatypes () ((t85s__ref (mk_t85s__ref (t85s__content us_t2)))))
(define-fun t85s__ref___projection ((a t85s__ref)) us_t2 (t85s__content a))
...
(declare-datatypes () ((t88s__ref (mk_t88s__ref (t88s__content us_t3)))))
(define-fun t88s__ref___projection ((a t88s__ref)) us_t3 (t88s__content a))
...
(declare-datatypes () ((t91s__ref (mk_t91s__ref (t91s__content us_t4)))))
(define-fun t91s__ref___projection ((a t91s__ref)) us_t4 (t91s__content a))
(assert (forall ((s1 us_rep1)) (! (let ((result (get_model__3 s1))) (and (and (in_range2 (first1 result)) (and (in_range2 (last1 result)) (= (length result) (size (to_base s1))))) (dynamic_invariant4 result true false true true))) :pattern ((get_model__3 s1)))))
(assert (forall ((attr__tag2 Int)) (forall ((s1 us_rep1)) (! (let ((result (get_model__31 attr__tag2 s1))) (and (and (in_range2 (first1 result)) (and (in_range2 (last1 result)) (= (length result) (size (to_base s1))))) (dynamic_invariant4 result true false true true))) :pattern ((get_model__31 attr__tag2 s1))))))
(assert (forall ((s1 us_rep1)) (! (= (get_model__3 s1) (get_model__31 us_tag1 s1)) :pattern ((get_model__31 us_tag1 s1)))))
(assert (forall ((s1 us_rep1)) (! (= (get_model__3 s1) (ite (= (wraps_around s1) true) (let ((stacks__get_model__3__R86s (last2 s1))) (let ((temp___413 (let ((temp___412 (let ((temp___409 1)) (let ((temp___410 (rec__stacks__stack_root__content1 (us_split_fields3 s1)))) (of_array3 temp___410 temp___409 stacks__get_model__3__R86s))))) (let ((temp___411 (let ((temp___407 100)) (let ((temp___406 (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s1))))) (let ((temp___408 (rec__stacks__stack_root__content1 (us_split_fields3 s1)))) (of_array2 temp___408 temp___406 temp___407)))))) (ite (= (length2 temp___411) 0) (of_array1 (to_array3 temp___412) (first7 temp___412) (last9 temp___412)) (of_array1 (slide (concat1 (to_array2 temp___411) (first5 temp___411) (last7 temp___411) (to_array3 temp___412) (first7 temp___412) (last9 temp___412)) (first5 temp___411) 1) 1 (- (+ 1 (+ (ite (<= (first5 temp___411) (last7 temp___411)) (+ (- (last7 temp___411) (first5 temp___411)) 1) 0) (ite (<= (first7 temp___412) (last9 temp___412)) (+ (- (last9 temp___412) (first7 temp___412)) 1) 0))) 1))))))) (of_array (to_array1 temp___413) (first3 temp___413) (last5 temp___413)))) (let ((stacks__get_model__3__R89s (last2 s1))) (let ((temp___416 (let ((temp___414 (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s1))))) (let ((temp___415 (rec__stacks__stack_root__content1 (us_split_fields3 s1)))) (of_array4 temp___415 temp___414 stacks__get_model__3__R89s))))) (of_array (to_array4 temp___416) (first9 temp___416) (last11 temp___416)))))) :pattern ((get_model__3 s1)))))
(assert (forall ((temp___189 Int)) (=> (dynamic_invariant3 temp___189 true true true true) (forall ((temp___190 Int)) (= (to_rep (select (temp___187 temp___189) temp___190)) temp___189)))))
...
(assert true)
(assert true)
(assert (forall ((s1 us_rep1)) (! (= (ite (wraps_around s1) 1 0) (ite (wraps_around1 us_tag1 s1) 1 0)) :pattern ((wraps_around1 us_tag1 s1)))))
(assert (forall ((s1 us_rep1)) (! (= (= (wraps_around s1) true) (< 100 (- (+ (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s1))) (to_rep1 (rec__stacks__stack_root__length1 (us_split_fields3 s1)))) 1))) :pattern ((wraps_around s1)))))
(declare-const temp___593 Int)
(assert (not (= (is_empty (mk___rep (mk___split_fields (rec__stacks__stack_root__content1 (us_split_fields3 s)) (rec__stacks__stack_root__length1 (us_split_fields3 s)) (hide_ext__ (rec__stacks__buffer__first (us_split_fields3 s)) (rec__ext__1 (us_split_fields3 s)))) (attr__tag1 s))) true)))
(assert (and (= temp___593 (last2 s)) (and (in_range2 temp___593) (= temp___593 (ite (not (= (wraps_around s) true)) (- (+ (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))) (to_rep1 (rec__stacks__stack_root__length1 (us_split_fields3 s)))) 1) (- (- (+ (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))) (to_rep1 (rec__stacks__stack_root__length1 (us_split_fields3 s)))) 1) 100))))))
(assert (not (<= 1 temp___593)))
(check-sat)
(exit)
