...
(assert (forall ((s us_rep1)) (! (dynamic_invariant (last2 s) true false true true) :pattern ((last2 s)))))
(assert (forall ((attr__tag2 Int)) (forall ((s us_rep1)) (! (dynamic_invariant (last3 attr__tag2 s) true false true true) :pattern ((last3 attr__tag2 s))))))
(assert (forall ((s us_rep1)) (! (= (last2 s) (last3 us_tag1 s)) :pattern ((last3 us_tag1 s)))))
(assert (forall ((s us_rep1)) (! (= (last2 s) (ite (not (= (wraps_around s) true)) (- (+ (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))) (to_rep2 (rec__stacks__stack_root__length1 (us_split_fields3 s)))) 1) (- (- (+ (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))) (to_rep2 (rec__stacks__stack_root__length1 (us_split_fields3 s)))) 1) 100))) :pattern ((last2 s)))))
...
(assert (forall ((s1 us_rep)) (! (= (size s1) (to_rep2 (rec__stacks__stack_root__length (us_split_fields1 s1)))) :pattern ((size s1)))))
(assert true)
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range f) (=> (in_range l) (and (= (to_rep (first2 (mk1 f l))) f) (= (to_rep (last4 (mk1 f l))) l)))) :pattern ((mk1 f l)))))
(define-fun dynamic_property1 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range low) (and (in_range high) (=> (<= low high) (and (in_range5 low) (in_range5 high))))))
...
(define-fun bool_eq4 ((x us_t1) (y us_t1)) Bool (bool_eq (elts1 x) (to_rep (first2 (rt1 x))) (to_rep (last4 (rt1 x))) (elts1 y) (to_rep (first2 (rt1 y))) (to_rep (last4 (rt1 y)))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range f) (=> (in_range l) (and (= (to_rep (first4 (mk2 f l))) f) (= (to_rep (last6 (mk2 f l))) l)))) :pattern ((mk2 f l)))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range f) (=> (in_range l) (and (= (to_rep (first6 (mk3 f l))) f) (= (to_rep (last8 (mk3 f l))) l)))) :pattern ((mk3 f l)))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range f) (=> (in_range l) (and (= (to_rep (first8 (mk4 f l))) f) (= (to_rep (last10 (mk4 f l))) l)))) :pattern ((mk4 f l)))))
...
(assert (forall ((s1 us_rep1)) (! (let ((result (get_model__3 s1))) (and (and (in_range3 (first1 result)) (and (in_range3 (last1 result)) (= (length result) (size (to_base s1))))) (dynamic_invariant4 result true false true true))) :pattern ((get_model__3 s1)))))
(assert (forall ((attr__tag2 Int)) (forall ((s1 us_rep1)) (! (let ((result (get_model__31 attr__tag2 s1))) (and (and (in_range3 (first1 result)) (and (in_range3 (last1 result)) (= (length result) (size (to_base s1))))) (dynamic_invariant4 result true false true true))) :pattern ((get_model__31 attr__tag2 s1))))))
...
(assert (forall ((s1 us_rep1)) (! (= (= (wraps_around s1) true) (< 100 (- (+ (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s1))) (to_rep2 (rec__stacks__stack_root__length1 (us_split_fields3 s1)))) 1))) :pattern ((wraps_around s1)))))
...
(assert (and (= temp___593 (last2 s)) (and (in_range3 temp___593) (= temp___593 (ite (not (= (wraps_around s) true)) (- (+ (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))) (to_rep2 (rec__stacks__stack_root__length1 (us_split_fields3 s)))) 1) (- (- (+ (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))) (to_rep2 (rec__stacks__stack_root__length1 (us_split_fields3 s)))) 1) 100))))))
(assert (not (<= temp___593 100)))
(check-sat)
(exit)
