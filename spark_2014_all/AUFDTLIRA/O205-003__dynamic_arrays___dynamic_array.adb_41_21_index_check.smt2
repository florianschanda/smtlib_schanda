...
(assert (= usq_2 o7))
(assert (= false o8))
(assert (= temp___2022 (temp___196 (mk___rep (mk___split_discrs o5) (mk___split_fields o6 o7) o8) 1 c)))
...
(assert (<= 1 i1))
(assert (<= i1 c))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- i2 1))) (and (= (rec__dynamic_array__rec__b (us_split_discrs1 (select (elts1 (rec__dynamic_array__holder__content1 h__split_fields3)) j1))) true) (= (to_rep1 (rec__dynamic_array__rec__f1 (us_split_fields1 (select (elts1 (rec__dynamic_array__holder__content1 h__split_fields3)) j1)))) (increment (select (elts (rec__dynamic_array__holder__content (us_split_fields3 (new_holder c)))) j1)))))))
(assert (forall ((j1 Int)) (=> (and (<= i2 j1) (<= j1 c)) (not (= (rec__dynamic_array__rec__b (us_split_discrs1 (select (elts1 (rec__dynamic_array__holder__content1 h__split_fields3)) j1))) true)))))
...
(assert (= o24 j))
(assert (= o25 (select (elts1 (rec__dynamic_array__holder__content1 h__split_fields3)) o24)))
(assert (= o26 (us_split_discrs1 o25)))
(assert (= result2 (rec__dynamic_array__rec__b o26)))
(assert (= result2 true))
(assert (and (= o19 (new_holder c)) (and (dynamic_invariant2 o19 true false true) (ite (= c 0) (= (to_rep (rec__dynamic_array__holder__d (us_split_discrs3 o19))) 0) (= (to_rep (rec__dynamic_array__holder__d (us_split_discrs3 o19))) c)))))
(assert (= o20 (us_split_fields3 o19)))
(assert (= temp___218 (rec__dynamic_array__holder__content o20)))
(assert (and (<= (to_rep1 (first (rt temp___218))) j) (<= j (to_rep1 (last1 (rt temp___218))))))
(assert (= o21 j))
(assert (= o22 (select (elts temp___218) o21)))
(assert (and (= o23 (increment o22)) (and (in_range2 o23) (= o23 (ite (= (rec__dynamic_array__rec__b (us_split_discrs1 o22)) true) (ite (< (to_rep1 (rec__dynamic_array__rec__f1 (us_split_fields1 o22))) c) (+ (to_rep1 (rec__dynamic_array__rec__f1 (us_split_fields1 o22))) 1) (to_rep1 (rec__dynamic_array__rec__f1 (us_split_fields1 o22)))) (ite (< (to_rep1 (rec__dynamic_array__rec__f2 (us_split_fields1 o22))) c) (+ (to_rep1 (rec__dynamic_array__rec__f2 (us_split_fields1 o22))) 1) (to_rep1 (rec__dynamic_array__rec__f2 (us_split_fields1 o22)))))))))
