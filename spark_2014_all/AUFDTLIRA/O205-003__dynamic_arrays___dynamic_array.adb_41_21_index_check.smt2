...
(declare-fun temp___223 (us_rep Int Int) us_t3)
...
(assert (forall ((temp___225 us_rep)) (forall ((temp___226 Int) (temp___227 Int)) (let ((temp___224 (temp___223 temp___225 temp___226 temp___227))) (=> (dynamic_invariant1 temp___225 true true true true) (and (=> (dynamic_property10 1 2147483647 temp___226 temp___227) (and (= (first7 temp___224) temp___226) (= (last8 temp___224) temp___227))) (forall ((temp___228 Int)) (= (select (to_array3 temp___224) temp___228) temp___225))))))))
...
(assert (= usq_2 o7))
(assert (= false o8))
(assert (= temp___2292 (temp___223 (mk___rep (mk___split_discrs o5) (mk___split_fields o6 o7) o8) 1 c)))
...
(assert (and (and (and (=> (<= 1 c) (dynamic_property9 1 c i2)) (dynamic_invariant3 (mk___rep2 h__split_discrs h__split_fields3) false true true true)) (forall ((temp___242 Int)) (=> (and (<= (to_rep1 (first2 (rt1 (rec__dynamic_array__holder__content1 h__split_fields3)))) temp___242) (<= temp___242 (to_rep1 (last3 (rt1 (rec__dynamic_array__holder__content1 h__split_fields3)))))) (=> (<= i2 temp___242) (= (select (elts1 (rec__dynamic_array__holder__content1 h__split_fields3)) temp___242) (select (elts1 (rec__dynamic_array__holder__content1 h__split_fields2)) temp___242)))))) (and (<= 1 i2) (<= i2 c))))
(assert (<= 1 j))
(assert (<= j (- i2 1)))
...
(assert (= result2 true))
(assert (and (= o19 (new_holder c)) (and (dynamic_invariant2 o19 true false true true) (ite (= c 0) (= (to_rep (rec__dynamic_array__holder__d (us_split_discrs3 o19))) 0) (= (to_rep (rec__dynamic_array__holder__d (us_split_discrs3 o19))) c)))))
(assert (= o20 (us_split_fields3 o19)))
(assert (= temp___245 (rec__dynamic_array__holder__content o20)))
(assert (and (<= (to_rep1 (first (rt temp___245))) j) (<= j (to_rep1 (last1 (rt temp___245))))))
(assert (= o21 j))
(assert (= o22 (select (elts temp___245) o21)))
