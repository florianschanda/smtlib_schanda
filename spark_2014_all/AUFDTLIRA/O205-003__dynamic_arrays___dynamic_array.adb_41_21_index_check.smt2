...
(define-fun dynamic_invariant1 ((temp___expr_150 us_rep) (temp___is_init_147 Bool) (temp___skip_constant_148 Bool) (temp___do_toplevel_149 Bool)) Bool (and (=> (dynamic_array__rec__f1__pred temp___expr_150) (=> (or (= temp___is_init_147 true) (<= 0 last)) (dynamic_property 0 last (to_rep1 (rec__dynamic_array__rec__f1 (us_split_fields1 temp___expr_150)))))) (=> (dynamic_array__rec__f2__pred temp___expr_150) (=> (or (= temp___is_init_147 true) (<= 0 last)) (dynamic_property 0 last (to_rep1 (rec__dynamic_array__rec__f2 (us_split_fields1 temp___expr_150))))))))
(define-fun default_initial_assumption ((temp___expr_152 us_rep) (temp___skip_top_level_153 Bool)) Bool (and (= (attr__constrained temp___expr_152) false) (= (rec__dynamic_array__rec__b (us_split_discrs1 temp___expr_152)) (of_int 1))))
...
(define-fun dynamic_invariant2 ((temp___expr_166 us_rep1) (temp___is_init_163 Bool) (temp___skip_constant_164 Bool) (temp___do_toplevel_165 Bool)) Bool (let ((temp___167 (rec__dynamic_array__holder__d (us_split_discrs3 temp___expr_166)))) (and (and (dynamic_property2 1 (to_rep temp___167) (first1 (rec__dynamic_array__holder__content (us_split_fields3 temp___expr_166))) (last2 (rec__dynamic_array__holder__content (us_split_fields3 temp___expr_166)))) (and (= (first1 (rec__dynamic_array__holder__content (us_split_fields3 temp___expr_166))) 1) (= (last2 (rec__dynamic_array__holder__content (us_split_fields3 temp___expr_166))) (to_rep temp___167)))) (forall ((temp___168 Int)) (=> (and (<= (first1 (rec__dynamic_array__holder__content (us_split_fields3 temp___expr_166))) temp___168) (<= temp___168 (last2 (rec__dynamic_array__holder__content (us_split_fields3 temp___expr_166))))) (and (and (=> (dynamic_array__rec__f1__pred (select (to_array (rec__dynamic_array__holder__content (us_split_fields3 temp___expr_166))) temp___168)) (=> (or (= temp___is_init_163 true) (<= 0 last)) (dynamic_property 0 last (to_rep1 (rec__dynamic_array__rec__f1 (us_split_fields1 (select (to_array (rec__dynamic_array__holder__content (us_split_fields3 temp___expr_166))) temp___168))))))) (=> (dynamic_array__rec__f2__pred (select (to_array (rec__dynamic_array__holder__content (us_split_fields3 temp___expr_166))) temp___168)) (=> (or (= temp___is_init_163 true) (<= 0 last)) (dynamic_property 0 last (to_rep1 (rec__dynamic_array__rec__f2 (us_split_fields1 (select (to_array (rec__dynamic_array__holder__content (us_split_fields3 temp___expr_166))) temp___168)))))))) (= (attr__constrained (select (to_array (rec__dynamic_array__holder__content (us_split_fields3 temp___expr_166))) temp___168)) false)))))))
(declare-fun new_holder (Int) us_rep1)
(declare-fun new_holder__function_guard (us_rep1 Int) Bool)
(assert (forall ((d Int)) (! (=> (dynamic_invariant d true true true) (let ((result (new_holder d))) (and (ite (= c 0) (= (to_rep (rec__dynamic_array__holder__d (us_split_discrs3 result))) 0) (= (to_rep (rec__dynamic_array__holder__d (us_split_discrs3 result))) d)) (dynamic_invariant2 result true false true)))) :pattern ((new_holder d)))))
(declare-fun increment (us_rep) Int)
(declare-fun increment__function_guard (Int us_rep) Bool)
(assert (forall ((r us_rep)) (! (=> (dynamic_invariant1 r true true true) (dynamic_invariant (increment r) true false true)) :pattern ((increment r)))))
(assert (forall ((r us_rep)) (! (=> (dynamic_invariant1 r true true true) (= (increment r) (ite (= (rec__dynamic_array__rec__b (us_split_discrs1 r)) true) (ite (< (to_rep1 (rec__dynamic_array__rec__f1 (us_split_fields1 r))) c) (+ (to_rep1 (rec__dynamic_array__rec__f1 (us_split_fields1 r))) 1) (to_rep1 (rec__dynamic_array__rec__f1 (us_split_fields1 r)))) (ite (< (to_rep1 (rec__dynamic_array__rec__f2 (us_split_fields1 r))) c) (+ (to_rep1 (rec__dynamic_array__rec__f2 (us_split_fields1 r))) 1) (to_rep1 (rec__dynamic_array__rec__f2 (us_split_fields1 r))))))) :pattern ((increment r)))))
...
(define-fun to_base ((a us_rep2)) us_rep1 (mk___rep1 (us_split_discrs4 a) (mk___split_fields1 (let ((temp___137 (rec__dynamic_array__holder__content1 (us_split_fields5 a)))) (of_array (to_array1 temp___137) (first3 temp___137) (last4 temp___137))))))
(define-fun of_base ((r us_rep1)) us_rep2 (mk___rep2 (us_split_discrs3 r) (mk___split_fields2 (let ((temp___136 (rec__dynamic_array__holder__content (us_split_fields3 r)))) (of_array1 (to_array temp___136) (first1 temp___136) (last2 temp___136))))))
...
(define-fun dynamic_invariant3 ((temp___expr_181 us_rep2) (temp___is_init_178 Bool) (temp___skip_constant_179 Bool) (temp___do_toplevel_180 Bool)) Bool (and (=> (not (= temp___skip_constant_179 true)) (in_range4 c (to_base temp___expr_181))) (and (and (dynamic_property4 1 c (first3 (rec__dynamic_array__holder__content1 (us_split_fields5 temp___expr_181))) (last4 (rec__dynamic_array__holder__content1 (us_split_fields5 temp___expr_181)))) (and (= (first3 (rec__dynamic_array__holder__content1 (us_split_fields5 temp___expr_181))) 1) (= (last4 (rec__dynamic_array__holder__content1 (us_split_fields5 temp___expr_181))) c))) (forall ((temp___183 Int)) (=> (and (<= (first3 (rec__dynamic_array__holder__content1 (us_split_fields5 temp___expr_181))) temp___183) (<= temp___183 (last4 (rec__dynamic_array__holder__content1 (us_split_fields5 temp___expr_181))))) (and (and (=> (dynamic_array__rec__f1__pred (select (to_array1 (rec__dynamic_array__holder__content1 (us_split_fields5 temp___expr_181))) temp___183)) (=> (or (= temp___is_init_178 true) (<= 0 last)) (dynamic_property 0 last (to_rep1 (rec__dynamic_array__rec__f1 (us_split_fields1 (select (to_array1 (rec__dynamic_array__holder__content1 (us_split_fields5 temp___expr_181))) temp___183))))))) (=> (dynamic_array__rec__f2__pred (select (to_array1 (rec__dynamic_array__holder__content1 (us_split_fields5 temp___expr_181))) temp___183)) (=> (or (= temp___is_init_178 true) (<= 0 last)) (dynamic_property 0 last (to_rep1 (rec__dynamic_array__rec__f2 (us_split_fields1 (select (to_array1 (rec__dynamic_array__holder__content1 (us_split_fields5 temp___expr_181))) temp___183)))))))) (= (attr__constrained (select (to_array1 (rec__dynamic_array__holder__content1 (us_split_fields5 temp___expr_181))) temp___183)) false)))))))
(define-fun default_initial_assumption1 ((temp___expr_185 us_rep2) (temp___skip_top_level_186 Bool)) Bool (and (= (to_rep (rec__dynamic_array__holder__d (us_split_discrs4 temp___expr_185))) c) (forall ((temp___189 Int)) (=> (and (<= (first3 (rec__dynamic_array__holder__content1 (us_split_fields5 temp___expr_185))) temp___189) (<= temp___189 (last4 (rec__dynamic_array__holder__content1 (us_split_fields5 temp___expr_185))))) (and (= (attr__constrained (select (to_array1 (rec__dynamic_array__holder__content1 (us_split_fields5 temp___expr_185))) temp___189)) false) (= (rec__dynamic_array__rec__b (us_split_discrs1 (select (to_array1 (rec__dynamic_array__holder__content1 (us_split_fields5 temp___expr_185))) temp___189))) (of_int 1)))))))
...
(define-fun to_base1 ((a us_rep3)) us_rep1 (mk___rep1 (us_split_discrs5 a) (mk___split_fields1 (let ((temp___139 (rec__dynamic_array__holder__content2 (us_split_fields7 a)))) (of_array (to_array2 temp___139) (first5 temp___139) (last6 temp___139))))))
(define-fun of_base1 ((r us_rep1)) us_rep3 (mk___rep3 (us_split_discrs3 r) (mk___split_fields3 (let ((temp___138 (rec__dynamic_array__holder__content (us_split_fields3 r)))) (of_array2 (to_array temp___138) (first1 temp___138) (last2 temp___138))))))
...
(assert (forall ((temp___198 us_rep)) (forall ((temp___199 Int) (temp___200 Int)) (let ((temp___197 (temp___196 temp___198 temp___199 temp___200))) (and (=> (dynamic_property10 1 2147483647 temp___199 temp___200) (and (= (first7 temp___197) temp___199) (= (last8 temp___197) temp___200))) (forall ((temp___201 Int)) (= (select (to_array3 temp___197) temp___201) temp___198)))))))
...
(define-fun dynamic_invariant6 ((temp___expr_144 Int) (temp___is_init_141 Bool) (temp___skip_constant_142 Bool) (temp___do_toplevel_143 Bool)) Bool (=> (or (= temp___is_init_141 true) (<= 0 last)) (dynamic_property 0 last temp___expr_144)))
(assert (= last c))
...
(declare-const temp___218 us_t)
(declare-const o24 Int)
(declare-const o25 us_rep)
(declare-const o26 Int)
(declare-const o27 Int)
(declare-const o28 us_rep)
(declare-const o29 us_split_discrs)
...
(declare-const h__split_fields4 us_split_fields4)
...
(assert (= usq_2 o7))
(assert (= false o8))
(assert (= (mk___t3 temp___202 temp___2021) (temp___196 (mk___rep (mk___split_discrs o5) (mk___split_fields o6 o7) o8) 1 c)))
(assert (= (to_rep1 (first6 temp___2021)) 1))
(assert (= (to_rep1 (last7 temp___2021)) c))
(assert (= (mk___t3 temp___203 temp___2031) (mk___t3 temp___202 temp___2021)))
(assert (= (ite (<= (to_rep1 (first6 temp___2031)) (to_rep1 (last7 temp___2031))) (+ (- (to_rep1 (last7 temp___2031)) (to_rep1 (first6 temp___2031))) 1) 0) (ite (<= 1 c) (+ (- c 1) 1) 0)))
(assert (= temp___203 o9))
(assert (= (mk2 (to_rep1 (first6 temp___2031)) (to_rep1 (last7 temp___2031))) o10))
(assert (= o11 o9))
(assert (= o12 o10))
(assert (= (to_rep o) c))
(assert (= o o13))
...
(assert (dynamic_invariant3 (mk___rep2 h__split_discrs h__split_fields2) true false true))
...
(assert (<= 1 i1))
(assert (<= i1 c))
(assert (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 (- i2 1))) (and (= (rec__dynamic_array__rec__b (us_split_discrs1 (select (elts1 (rec__dynamic_array__holder__content1 h__split_fields3)) j2))) true) (= (to_rep1 (rec__dynamic_array__rec__f1 (us_split_fields1 (select (elts1 (rec__dynamic_array__holder__content1 h__split_fields3)) j2)))) (increment (select (elts (rec__dynamic_array__holder__content (us_split_fields3 (new_holder c)))) j2)))))))
(assert (forall ((j2 Int)) (=> (and (<= i2 j2) (<= j2 c)) (not (= (rec__dynamic_array__rec__b (us_split_discrs1 (select (elts1 (rec__dynamic_array__holder__content1 h__split_fields3)) j2))) true)))))
(assert (and (and (and (=> (<= 1 c) (dynamic_property9 1 c i2)) (dynamic_invariant3 (mk___rep2 h__split_discrs h__split_fields3) false true true)) (forall ((temp___215 Int)) (=> (and (<= (to_rep1 (first2 (rt1 (rec__dynamic_array__holder__content1 h__split_fields3)))) temp___215) (<= temp___215 (to_rep1 (last3 (rt1 (rec__dynamic_array__holder__content1 h__split_fields3)))))) (=> (<= i2 temp___215) (= (select (elts1 (rec__dynamic_array__holder__content1 h__split_fields3)) temp___215) (select (elts1 (rec__dynamic_array__holder__content1 h__split_fields2)) temp___215)))))) (and (<= 1 i2) (<= i2 c))))
(assert (<= 1 j))
(assert (<= j (- i2 1)))
(assert (and (<= (to_rep1 (first2 (rt1 (rec__dynamic_array__holder__content1 h__split_fields3)))) j) (<= j (to_rep1 (last3 (rt1 (rec__dynamic_array__holder__content1 h__split_fields3)))))))
(assert (= o27 j))
(assert (= o28 (select (elts1 (rec__dynamic_array__holder__content1 h__split_fields3)) o27)))
(assert (= o29 (us_split_discrs1 o28)))
(assert (= result2 (rec__dynamic_array__rec__b o29)))
(assert (= result2 true))
(assert (and (= o22 (new_holder c)) (and (dynamic_invariant2 o22 true false true) (ite (= c 0) (= (to_rep (rec__dynamic_array__holder__d (us_split_discrs3 o22))) 0) (= (to_rep (rec__dynamic_array__holder__d (us_split_discrs3 o22))) c)))))
(assert (= o23 (us_split_fields3 o22)))
(assert (= temp___218 (rec__dynamic_array__holder__content o23)))
(assert (and (<= (to_rep1 (first (rt temp___218))) j) (<= j (to_rep1 (last1 (rt temp___218))))))
(assert (= o24 j))
(assert (= o25 (select (elts temp___218) o24)))
(assert (and (= o26 (increment o25)) (and (in_range2 o26) (= o26 (ite (= (rec__dynamic_array__rec__b (us_split_discrs1 o25)) true) (ite (< (to_rep1 (rec__dynamic_array__rec__f1 (us_split_fields1 o25))) c) (+ (to_rep1 (rec__dynamic_array__rec__f1 (us_split_fields1 o25))) 1) (to_rep1 (rec__dynamic_array__rec__f1 (us_split_fields1 o25)))) (ite (< (to_rep1 (rec__dynamic_array__rec__f2 (us_split_fields1 o25))) c) (+ (to_rep1 (rec__dynamic_array__rec__f2 (us_split_fields1 o25))) 1) (to_rep1 (rec__dynamic_array__rec__f2 (us_split_fields1 o25)))))))))
(assert (not (<= (to_rep1 (first2 (rt1 (rec__dynamic_array__holder__content1 h__split_fields3)))) j)))
(check-sat)
(exit)
