...
(assert (and (and (and (forall ((temp___814 Int)) (=> (and (<= 1 temp___814) (<= temp___814 50)) (=> (or (< 50 temp___814) (or (< temp___814 1) (< del_line2 temp___814))) (= (select cur_board3 temp___814) (select cur_board temp___814))))) (=> (<= 1 50) (in_range9 del_line2))) (=> (<= 1 50) (in_range9 to_line3))) (and (<= 1 del_line2) (<= del_line2 50))))
...
(assert (=> (= result8 true) (= has_complete_lines4 (distinct 1 0))))
...
(assert (=> (not (= result8 true)) (= has_complete_lines4 has_complete_lines3)))
