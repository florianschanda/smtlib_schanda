...
(define-fun true_bool__ref___projection ((a1 true_bool__ref)) true_bool (true_bool__content a1))
...
(declare-const perm__perm_reflexive__result Int)
(declare-const o Int)
(declare-const result Int)
(declare-const perm__perm_reflexive__result1 Int)
(declare-const perm__perm_reflexive__result2 Int)
(declare-const perm__perm_reflexive__result3 Int)
(declare-const perm__perm_reflexive__result4 Int)
(declare-const perm__perm_reflexive__result5 Int)
...
(assert (= perm__perm_reflexive__result1 perm__perm_reflexive__result2))
(assert (= perm__perm_reflexive__result3 perm__perm_reflexive__result1))
(assert (and (= o (induction_hypothesis a b)) (and (in_range4 o) (=> (= (distinct o 0) true) (= (is_perm a b) true)))))
(assert (= (mk_int__ref result) (mk_int__ref perm__perm_reflexive__result)))
(assert (= perm__perm_reflexive__result1 o))
(assert (= (mk_int__ref perm__perm_reflexive__result4) (mk_int__ref perm__perm_reflexive__result2)))
(assert (= perm__perm_reflexive__result5 perm__perm_reflexive__result3))
(assert (= result1 perm__perm_reflexive__result4))
(assert (= (distinct perm__perm_reflexive__result4 0) true))
(assert (not (= (is_perm a b) true)))
(check-sat)
(exit)
