...
(assert (and (<= (to_rep2 (first (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))) j) (<= j (to_rep2 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))))))
(assert (= o j))
...
(assert (not (<= (to_rep2 (first2 (rt1 (rec__simple_unc_arrays__table__v1 c__split_fields4)))) j)))
(check-sat)
(exit)
