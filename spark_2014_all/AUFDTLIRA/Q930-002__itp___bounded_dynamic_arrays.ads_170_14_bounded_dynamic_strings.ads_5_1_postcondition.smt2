...
(define-fun dynamic_invariant1 ((temp___expr_229 Int) (temp___is_init_225 Bool) (temp___skip_constant_226 Bool) (temp___do_toplevel_227 Bool) (temp___do_typ_inv_228 Bool)) Bool (=> (or (= temp___is_init_225 true) (<= 1 2147483647)) (in_range5 temp___expr_229)))
...
(define-fun dynamic_invariant3 ((temp___expr_222 Int) (temp___is_init_218 Bool) (temp___skip_constant_219 Bool) (temp___do_toplevel_220 Bool) (temp___do_typ_inv_221 Bool)) Bool (=> (or (= temp___is_init_218 true) (<= 0 2147483647)) (in_range6 temp___expr_222)))
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant2 this true true true true) (dynamic_invariant3 (length2 this) true false true true)) :pattern ((length2 this)))))
...
(define-fun dynamic_invariant4 ((temp___expr_206 us_t) (temp___is_init_202 Bool) (temp___skip_constant_203 Bool) (temp___do_toplevel_204 Bool) (temp___do_typ_inv_205 Bool)) Bool (=> (not (= temp___skip_constant_203 true)) (dynamic_property 1 2147483647 (first1 temp___expr_206) (last1 temp___expr_206))))
...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant2 this true true true true) (let ((result (value this))) (and (and (and (and (= (length result) (length2 this)) (= (first1 result) 1)) (= (last1 result) (length2 this))) (= (< 0 (length2 this)) (not (= (empty this) true)))) (dynamic_invariant4 result true false true true)))) :pattern ((value this)))))
...
(define-fun dynamic_invariant7 ((temp___expr_18 Int) (temp___is_init_14 Bool) (temp___skip_constant_15 Bool) (temp___do_toplevel_16 Bool) (temp___do_typ_inv_17 Bool)) Bool (=> (or (= temp___is_init_14 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_18)))
...
(declare-const o7 t1)
(declare-const temp___1270 natural_index)
(declare-const temp___12701 natural_index)
(declare-const temp___12702 (Array Int character))
(declare-const temp___12703 t1)
(declare-const temp___1271 natural_index)
(declare-const temp___12711 natural_index)
(declare-const temp___12712 (Array Int character))
(declare-const temp___12713 t1)
...
(define-fun temp___12704 () us_rep (mk___rep (mk___split_discrs temp___1270) (mk___split_fields temp___12701 (mk___t1 temp___12702 temp___12703))))
(assert (dynamic_invariant2 i52s true false true true))
(assert (dynamic_invariant2 (mk___rep this__split_discrs (mk___split_fields this__split_fields (mk___t1 this__split_fields1 this__split_fields2))) true false true true))
...
(assert (= o6 o3))
(assert (= o7 o4))
(assert (= this__split_discrs (mk___split_discrs temp___1270)))
(assert (= temp___12701 o5))
(assert (= temp___12702 o6))
(assert (= temp___12703 o7))
(assert (dynamic_predicate temp___12704))
(assert (= (mk___rep (mk___split_discrs temp___1271) (mk___split_fields temp___12711 (mk___t1 temp___12712 temp___12713))) temp___12704))
...
(assert (= temp___12711 this__split_fields3))
(assert (= temp___12712 this__split_fields4))
(assert (= temp___12713 this__split_fields5))
(assert (= this__split_discrs (mk___split_discrs temp___1271)))
