...
(define-fun dynamic_invariant1 ((temp___expr_201 Int) (temp___is_init_198 Bool) (temp___skip_constant_199 Bool) (temp___do_toplevel_200 Bool)) Bool (=> (or (= temp___is_init_198 true) (<= 1 2147483647)) (in_range5 temp___expr_201)))
...
(declare-fun user_eq8 (natural_index natural_index) Bool)
(declare-const dummy8 natural_index)
...
(assert (forall ((x natural_index)) (! (in_range6 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(define-fun dynamic_invariant3 ((temp___expr_195 Int) (temp___is_init_192 Bool) (temp___skip_constant_193 Bool) (temp___do_toplevel_194 Bool)) Bool (=> (or (= temp___is_init_192 true) (<= 0 2147483647)) (in_range6 temp___expr_195)))
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant2 this true true true) (dynamic_invariant3 (length2 this) true false true)) :pattern ((length2 this)))))
...
(define-fun dynamic_invariant4 ((temp___expr_181 us_t) (temp___is_init_178 Bool) (temp___skip_constant_179 Bool) (temp___do_toplevel_180 Bool)) Bool (=> (not (= temp___skip_constant_179 true)) (dynamic_property 1 2147483647 (first1 temp___expr_181) (last1 temp___expr_181))))
...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant2 this true true true) (let ((result (value this))) (and (and (and (and (= (length result) (length2 this)) (= (first1 result) 1)) (= (last1 result) (length2 this))) (= (< 0 (length2 this)) (not (= (empty this) true)))) (dynamic_invariant4 result true false true)))) :pattern ((value this)))))
...
(define-fun dynamic_invariant5 ((temp___expr_39 Int) (temp___is_init_36 Bool) (temp___skip_constant_37 Bool) (temp___do_toplevel_38 Bool)) Bool (=> (or (= temp___is_init_36 true) (<= 1 2147483647)) (in_range4 temp___expr_39)))
(define-fun dynamic_invariant6 ((temp___expr_63 Int) (temp___is_init_60 Bool) (temp___skip_constant_61 Bool) (temp___do_toplevel_62 Bool)) Bool (=> (or (= temp___is_init_60 true) (<= 0 255)) (in_range1 temp___expr_63)))
...
(declare-const this__split_fields2 t1)
...
(declare-const o7 t1)
(declare-const temp___1207 natural_index)
(declare-const temp___12071 natural_index)
(declare-const temp___12072 (Array Int character))
(declare-const temp___12073 t1)
(declare-const temp___1208 natural_index)
(declare-const temp___12081 natural_index)
(declare-const temp___12082 (Array Int character))
(declare-const temp___12083 t1)
(declare-const temp___1211 (Array Int character))
(declare-const temp___12111 t)
(declare-const o8 Int)
(declare-const o9 Bool)
(declare-const result natural_index)
(declare-const result1 (Array Int character))
(declare-const result2 t1)
(declare-const this__split_fields3 natural_index)
(declare-const this__split_fields4 (Array Int character))
(declare-const this__split_fields5 t1)
(declare-const this__split_fields6 natural_index)
(declare-const this__split_fields7 (Array Int character))
(declare-const this__split_fields8 t1)
(declare-const this__split_fields9 us_split_fields)
(assert (dynamic_invariant2 i52s true false true))
(assert (dynamic_invariant2 (mk___rep this__split_discrs (mk___split_fields this__split_fields (mk___t1 this__split_fields1 this__split_fields2))) true false true))
(assert (in_range2 by__))
(assert (in_range5 start))
(assert (<= start (length2 (mk___rep this__split_discrs (mk___split_fields this__split_fields (mk___t1 this__split_fields1 this__split_fields2))))))
(assert (= (to_rep o) by__))
(assert (and (<= (to_rep1 (first2 this__split_fields2)) start) (<= start (to_rep1 (last2 this__split_fields2)))))
(assert (= o1 start))
(assert (= o2 (store this__split_fields1 o1 o)))
(assert (= o2 o3))
(assert (= this__split_fields2 o4))
(assert (= this__split_fields o5))
(assert (= o6 o3))
(assert (= o7 o4))
(assert (= this__split_discrs (mk___split_discrs temp___1207)))
(assert (= temp___12071 o5))
(assert (= temp___12072 o6))
(assert (= temp___12073 o7))
(assert (dynamic_predicate (mk___rep (mk___split_discrs temp___1207) (mk___split_fields temp___12071 (mk___t1 temp___12072 temp___12073)))))
(assert (= (mk___rep (mk___split_discrs temp___1208) (mk___split_fields temp___12081 (mk___t1 temp___12082 temp___12083))) (mk___rep (mk___split_discrs temp___1207) (mk___split_fields temp___12071 (mk___t1 temp___12072 temp___12073)))))
(assert (= (mk___split_fields__ref (mk___split_fields result (mk___t1 result1 result2))) (mk___split_fields__ref (mk___split_fields this__split_fields (mk___t1 this__split_fields1 this__split_fields2)))))
(assert (= temp___12081 this__split_fields3))
(assert (= temp___12082 this__split_fields4))
(assert (= temp___12083 this__split_fields5))
(assert (= this__split_discrs (mk___split_discrs temp___1208)))
(assert (= this__split_fields6 this__split_fields3))
(assert (= this__split_fields7 this__split_fields4))
(assert (= this__split_fields8 this__split_fields5))
(assert (= this__split_fields9 (mk___split_fields this__split_fields3 (mk___t1 this__split_fields4 this__split_fields5))))
(assert (not (= (to_rep (select (elts (value (mk___rep this__split_discrs (mk___split_fields this__split_fields6 (mk___t1 this__split_fields7 this__split_fields8))))) start)) by__)))
(check-sat)
(exit)
