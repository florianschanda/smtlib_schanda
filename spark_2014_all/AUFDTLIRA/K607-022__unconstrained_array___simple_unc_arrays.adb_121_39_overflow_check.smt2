...
(assert (= (ite (<= (to_rep1 (first2 (rt1 (rec__simple_unc_arrays__table__v res__split_fields4)))) (to_rep1 (last2 (rt1 (rec__simple_unc_arrays__table__v res__split_fields4))))) (+ (- (to_rep1 (last2 (rt1 (rec__simple_unc_arrays__table__v res__split_fields4)))) (to_rep1 (first2 (rt1 (rec__simple_unc_arrays__table__v res__split_fields4))))) 1) 0) (ite (<= 1 r59b) (+ (- r59b 1) 1) 0)))
(assert (= (elts1 (rec__simple_unc_arrays__table__v res__split_fields4)) simple_unc_arrays__swap_cells__a__compl))
(assert (= (mk2 (to_rep1 (first2 (rt1 (rec__simple_unc_arrays__table__v res__split_fields4)))) (to_rep1 (last2 (rt1 (rec__simple_unc_arrays__table__v res__split_fields4))))) simple_unc_arrays__swap_cells__a__compl1))
(assert (not (in_range1 (+ i4 1))))
(check-sat)
(exit)
