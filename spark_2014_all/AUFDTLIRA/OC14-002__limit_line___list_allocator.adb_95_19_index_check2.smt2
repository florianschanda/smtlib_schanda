...
(assert (= (to_rep o21) first_available))
(assert (= (rec__list_allocator__cell__stat (us_split_fields3 (select data2 first_allocated))) o22))
(assert (= o21 o23))
(assert (= (rec__list_allocator__cell__next (us_split_fields3 (select data2 first_allocated))) o24))
(assert (= o25 o22))
(assert (= o26 o23))
(assert (= o27 o24))
