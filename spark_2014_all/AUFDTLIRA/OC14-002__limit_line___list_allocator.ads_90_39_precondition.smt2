...
(assert (=> (= result true) (= (mk___rep (mk___split_fields o10 o11 o12)) (select data o9))))
...
(assert (=> (= result true) (= (mk___rep (mk___split_fields o19 o20 o21)) (select data o18))))
...
(assert (=> (= result true) (= o37 (store data o36 (mk___rep (mk___split_fields o33 o34 o35))))))
(assert (=> (= result true) (= result3 (mk_map__ref data))))
(assert (=> (= result true) (= data2 o37)))
(assert (=> (= result true) (=> (not (= prev_alloc2 0)) (= (to_rep o38) next_alloc2))))
(assert (=> (= result true) (=> (not (= prev_alloc2 0)) (= (rec__list_allocator__cell__stat (us_split_fields1 (select data2 prev_alloc2))) o39))))
(assert (=> (= result true) (=> (not (= prev_alloc2 0)) (= (rec__list_allocator__cell__prev (us_split_fields1 (select data2 prev_alloc2))) o40))))
...
(assert (=> (= result true) (=> (not (= prev_alloc2 0)) (= o45 prev_alloc2))))
(assert (=> (= result true) (=> (not (= prev_alloc2 0)) (= o46 (store data2 o45 (mk___rep (mk___split_fields o42 o43 o44)))))))
...
(assert (=> (= result true) (=> (not (= next_alloc2 0)) (= (to_rep o47) prev_alloc2))))
(assert (=> (= result true) (=> (not (= next_alloc2 0)) (= o48 (mk___split_fields (rec__list_allocator__cell__stat (us_split_fields1 (select data3 next_alloc2))) o47 (rec__list_allocator__cell__next (us_split_fields1 (select data3 next_alloc2))))))))
(assert (=> (= result true) (=> (not (= next_alloc2 0)) (= o49 (mk___rep o48)))))
(assert (=> (= result true) (=> (not (= next_alloc2 0)) (and (<= 1 next_alloc2) (<= next_alloc2 3)))))
(assert (=> (= result true) (=> (not (= next_alloc2 0)) (= o50 next_alloc2))))
(assert (=> (= result true) (=> (not (= next_alloc2 0)) (= o51 (store data3 o50 o49)))))
...
(assert (=> (= result true) (and (= o52 (find model____split_fields1 res)) (and (in_range6 o52) (ite (= (mem model____split_fields1 res) true) (and (and (<= 1 o52) (<= o52 (length model____split_fields1))) (= (get model____split_fields1 o52) res)) (= o52 0))))))
(assert (=> (= result true) (and (= o53 o52) (in_range2 o52))))
(assert (=> (= result true) (and (= o54 (remove_at model____split_fields1 o53)) (= (is_removed_at model____split_fields1 o53 o54) true))))
(assert (=> (= result true) (= o55 (mk___split_fields1 model____split_fields o54))))
(assert (=> (= result true) (= temp___455 (mk___rep1 o55))))
(assert (=> (= result true) (= result8 (mk___split_fields__ref1 (mk___split_fields1 model____split_fields model____split_fields1)))))
(assert (=> (= result true) (= model____split_fields3 (us_split_fields3 temp___455))))
(assert (=> (= result true) (and (= o56 (prepend (rec__list_allocator__m__t__available model____split_fields3) res)) (= (is_prepend (rec__list_allocator__m__t__available model____split_fields3) res o56) true))))
(assert (=> (= result true) (= o57 (mk___split_fields1 o56 (rec__list_allocator__m__t__allocated model____split_fields3)))))
(assert (=> (= result true) (= temp___457 (mk___rep1 o57))))
(assert (=> (= result true) (= result9 (mk___split_fields__ref1 model____split_fields3))))
(assert (=> (= result true) (= model____split_fields4 (us_split_fields3 temp___457))))
...
(assert (=> (not (= result true)) (= model____split_fields4 (mk___split_fields1 model____split_fields model____split_fields1))))
...
(assert (and (= result11 (is_prepend model____split_fields res (rec__list_allocator__m__t__available (us_split_fields__content1 model____split_fields5)))) (= (= result11 true) (and (and (= (length (rec__list_allocator__m__t__available (us_split_fields__content1 model____split_fields5))) (+ (length model____split_fields) 1)) (= (get (rec__list_allocator__m__t__available (us_split_fields__content1 model____split_fields5)) 1) res)) (forall ((m Int)) (=> (and (<= 2 m) (<= m (length (rec__list_allocator__m__t__available (us_split_fields__content1 model____split_fields5))))) (= (get (rec__list_allocator__m__t__available (us_split_fields__content1 model____split_fields5)) m) (get model____split_fields (- m 1)))))))))
(assert (=> (= result11 true) (and (= o60 (length (rec__list_allocator__m__t__allocated (us_split_fields__content1 model____split_fields5)))) (in_range6 o60))))
(assert (=> (= result11 true) (= result10 (ite (= o60 (- (length model____split_fields1) 1)) true false))))
(assert (=> (not (= result11 true)) (= result10 false)))
(assert (= result10 true))
(assert (<= 1 j))
(assert (<= j (length model____split_fields1)))
(assert (and (= o58 (get model____split_fields1 j)) (in_range7 o58)))
(assert (= o59 (ite (= o58 res) true false)))
(assert (= result12 (ite (not (= o59 true)) true false)))
