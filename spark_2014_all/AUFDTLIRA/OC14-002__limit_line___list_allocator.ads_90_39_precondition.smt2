...
(assert (=> (= result true) (=> (= prev_alloc2 0) (= data3 data2))))
...
(assert (=> (= result true) (=> (= next_alloc2 0) (= data4 data3))))
...
(assert (=> (= result true) (and (and (and (and (ite (not (= first_available2 0)) (and (< 0 (length (rec__list_allocator__m__t__available model____split_fields4))) (= (get (rec__list_allocator__m__t__available model____split_fields4) 1) first_available2)) (= (length (rec__list_allocator__m__t__available model____split_fields4)) 0)) (ite (not (= first_allocated2 0)) (and (< 0 (length (rec__list_allocator__m__t__allocated model____split_fields4))) (= (get (rec__list_allocator__m__t__allocated model____split_fields4) 1) first_allocated2)) (= (length (rec__list_allocator__m__t__allocated model____split_fields4)) 0))) (forall ((j8 Int)) (=> (and (<= 1 j8) (<= j8 (length (rec__list_allocator__m__t__available model____split_fields4)))) (and (in_range4 (get (rec__list_allocator__m__t__available model____split_fields4) j8)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data4 (get (rec__list_allocator__m__t__available model____split_fields4) j8))))) (ite (< j8 (length (rec__list_allocator__m__t__available model____split_fields4))) (get (rec__list_allocator__m__t__available model____split_fields4) (+ j8 1)) 0)))))) (forall ((j8 Int)) (=> (and (<= 1 j8) (<= j8 (length (rec__list_allocator__m__t__allocated model____split_fields4)))) (and (in_range4 (get (rec__list_allocator__m__t__allocated model____split_fields4) j8)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data4 (get (rec__list_allocator__m__t__allocated model____split_fields4) j8))))) (ite (< j8 (length (rec__list_allocator__m__t__allocated model____split_fields4))) (get (rec__list_allocator__m__t__allocated model____split_fields4) (+ j8 1)) 0)))))) (forall ((r Int)) (=> (and (<= 1 r) (<= r 3)) (ite (= (to_rep1 (rec__list_allocator__cell__stat (us_split_fields1 (select data4 r)))) 0) (and (= (mem (rec__list_allocator__m__t__available model____split_fields4) r) true) (not (= (mem (rec__list_allocator__m__t__allocated model____split_fields4) r) true))) (and (not (= (mem (rec__list_allocator__m__t__available model____split_fields4) r) true)) (= (mem (rec__list_allocator__m__t__allocated model____split_fields4) r) true))))))))
...
(assert (and (= result41 (is_prepend model____split_fields res (rec__list_allocator__m__t__available (us_split_fields__content1 model____split_fields5)))) (= (= result41 true) (and (and (= (length (rec__list_allocator__m__t__available (us_split_fields__content1 model____split_fields5))) (+ (length model____split_fields) 1)) (= (get (rec__list_allocator__m__t__available (us_split_fields__content1 model____split_fields5)) 1) res)) (forall ((m Int)) (=> (and (<= 2 m) (<= m (length (rec__list_allocator__m__t__available (us_split_fields__content1 model____split_fields5))))) (= (get (rec__list_allocator__m__t__available (us_split_fields__content1 model____split_fields5)) m) (get model____split_fields (- m 1)))))))))
(assert (=> (= result41 true) (and (= o138 (length (rec__list_allocator__m__t__allocated (us_split_fields__content1 model____split_fields5)))) (in_range6 o138))))
(assert (=> (= result41 true) (= result40 (ite (= o138 (- (length model____split_fields1) 1)) true false))))
(assert (=> (not (= result41 true)) (= result40 false)))
(assert (= result40 true))
(assert (<= 1 j7))
(assert (<= j7 (length model____split_fields1)))
(assert (and (= o135 (get model____split_fields1 j7)) (in_range7 o135)))
(assert (= o136 (ite (= o135 res) true false)))
(assert (= result42 (ite (not (= o136 true)) true false)))
