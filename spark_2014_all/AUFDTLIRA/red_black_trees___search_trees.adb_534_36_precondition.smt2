...
(assert (= result1 true))
(assert (and (= result2 (ordered_leafs f2 root values)) (= (= result2 true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f2 root) i))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f2 root) j))) true)) (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f2 root) i))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f2 root) j)))) true)) (ite (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f2 root) j))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f2 root) i)))) 1)) 0) (< (to_rep (select values j)) (to_rep (select values i))) (< (to_rep (select values i)) (to_rep (select values j))))))))))))
(assert (= result2 true))
