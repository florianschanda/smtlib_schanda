...
(assert (and (= result (valid_root f1 root)) (=> (< (size f1) root) (not (= result true)))))
(assert (= result true))
(assert (and (= result1 (valid_root f2 root)) (=> (< (size f2) root) (not (= result1 true)))))
(assert (= result1 true))
(assert (and (= result2 (ordered_leafs f2 root values)) (= (= result2 true) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f2 root) i2))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f2 root) j2))) true)) (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f2 root) i2))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f2 root) j2)))) true)) (ite (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f2 root) j2))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f2 root) i2)))) 1)) 0) (< (to_rep (select values j2)) (to_rep (select values i2))) (< (to_rep (select values i2)) (to_rep (select values j2))))))))))))
(assert (= result2 true))
