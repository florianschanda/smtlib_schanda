...
(assert (dynamic_invariant2 arr true false true))
...
(assert (=> (= result true) (= (mk_int__ref result1) (mk_int__ref current_increment))))
(assert (=> (= result true) (= current_increment1 1)))
(assert (=> (not (= result true)) (= (mk_int__ref result2) (mk_int__ref current_increment))))
(assert (=> (not (= result true)) (= current_increment2 0)))
(assert (=> (not (= result true)) (= current_increment1 current_increment2)))
(assert (=> (= index (to_rep (first (rt arr)))) (= (mk_int__ref result3) (mk_int__ref count))))
...
(assert (=> (not (= index (to_rep (first (rt arr))))) (= (mk_int__ref result4) (mk_int__ref count))))
