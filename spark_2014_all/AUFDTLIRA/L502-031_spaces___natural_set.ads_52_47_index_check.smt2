...
(declare-fun user_eq3 (set_length set_length) Bool)
(declare-const dummy3 set_length)
...
(declare-fun to_rep1 (set_length) Int)
(declare-fun of_rep1 (Int) set_length)
(assert (forall ((x set_length)) (! (= (of_rep1 (to_rep1 x)) x) :pattern ((to_rep1 x)))))
(assert (forall ((x set_length)) (! (in_range4 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun bool_eq1 ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep1 (rec__natural_set__t__len (us_split_fields1 a))) (to_rep1 (rec__natural_set__t__len (us_split_fields1 b)))) (= (bool_eq (rec__natural_set__t__m (us_split_fields1 a)) 1 10 (rec__natural_set__t__m (us_split_fields1 b)) 1 10) true)) true false))
...
(assert (forall ((s us_rep)) (! (= (members s) (to_rep1 (rec__natural_set__t__len (us_split_fields1 s)))) :pattern ((members s)))))
...
(define-fun dynamic_invariant2 ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= 0 10)) (in_range4 temp___expr_136)))
(define-fun dynamic_invariant3 ((temp___expr_148 Int) (temp___is_init_145 Bool) (temp___skip_constant_146 Bool) (temp___do_toplevel_147 Bool)) Bool (=> (or (= temp___is_init_145 true) (<= 1 10)) (in_range3 temp___expr_148)))
(declare-const i Int)
(declare-const o Int)
(declare-const o1 Bool)
(declare-const result Bool)
(assert (in_range1 value))
(assert (and (= o (members s)) (and (in_range1 o) (and (= o (to_rep1 (rec__natural_set__t__len (us_split_fields1 s)))) (and (<= 0 o) (<= o 10))))))
