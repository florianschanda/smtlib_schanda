...
(define-fun dynamic_invariant ((temp___expr_1308 Int) (temp___is_init_1305 Bool) (temp___skip_constant_1306 Bool) (temp___do_toplevel_1307 Bool)) Bool (=> (or (= temp___is_init_1305 true) (<= 0 2147483647)) (in_range3 temp___expr_1308)))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_344 us_t1) (temp___is_init_341 Bool) (temp___skip_constant_342 Bool) (temp___do_toplevel_343 Bool)) Bool (and (=> (not (= temp___skip_constant_342 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_344) (last3 temp___expr_344))) (=> (= temp___do_toplevel_343 true) (=> (= temp___is_init_341 true) (and (= (first5 (of_array2 (to_array1 temp___expr_344) (first3 temp___expr_344) (last3 temp___expr_344))) 1) (<= (last3 temp___expr_344) 1000))))))
(define-fun dynamic_predicate ((temp___348 us_t1)) Bool (and (= (first5 (of_array2 (to_array1 temp___348) (first3 temp___348) (last3 temp___348))) 1) (<= (last3 temp___348) 1000)))
(declare-fun statscount_image (Int) us_t1)
(declare-fun statscount_image__function_guard (us_t1 Int) Bool)
(assert (forall ((x Int)) (! (=> (dynamic_invariant x true true true) (dynamic_invariant1 (statscount_image x) true false true)) :pattern ((statscount_image x)))))
(assert (forall ((x Int)) (! (=> (dynamic_invariant x true true true) (= (statscount_image x) (let ((temp___1324 (to_string (attr__ATTRIBUTE_IMAGE3 x)))) (of_array1 (to_array temp___1324) (first1 temp___1324) (last1 temp___1324))))) :pattern ((statscount_image x)))))
(declare-sort statscountstringi 0)
(define-fun in_range4 ((x Int)) Bool (and (<= 1 x) (<= x 10)))
(declare-fun attr__ATTRIBUTE_IMAGE4 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check4 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE4 (us_image) Int)
(declare-fun user_eq7 (statscountstringi statscountstringi) Bool)
(declare-const dummy7 statscountstringi)
(declare-datatypes () ((statscountstringi__ref (mk_statscountstringi__ref (statscountstringi__content statscountstringi)))))
(define-fun statscountstringi__ref___projection ((a statscountstringi__ref)) statscountstringi (statscountstringi__content a))
...
(declare-datatypes () ((t202b__ref (mk_t202b__ref (t202b__content integer)))))
(define-fun t202b__ref___projection ((a t202b__ref)) integer (t202b__content a))
(declare-sort t3 0)
...
(declare-datatypes () ((t203b__ref (mk_t203b__ref (t203b__content us_t3)))))
(define-fun t203b__ref___projection ((a t203b__ref)) us_t3 (t203b__content a))
...
(declare-datatypes () ((t205b__ref (mk_t205b__ref (t205b__content integer)))))
(define-fun t205b__ref___projection ((a t205b__ref)) integer (t205b__content a))
(declare-sort t4 0)
...
(declare-datatypes () ((t206b__ref (mk_t206b__ref (t206b__content us_t4)))))
(define-fun t206b__ref___projection ((a t206b__ref)) us_t4 (t206b__content a))
(declare-fun screen__writestatsdata__statscountstring__result__aggregate_def (Int) (Array Int character))
(assert (forall ((temp___1826 Int)) (forall ((temp___1827 Int)) (= (select (screen__writestatsdata__statscountstring__result__aggregate_def temp___1826) temp___1827) (of_rep temp___1826)))))
...
(define-fun dynamic_invariant6 ((temp___expr_1643 Int) (temp___is_init_1640 Bool) (temp___skip_constant_1641 Bool) (temp___do_toplevel_1642 Bool)) Bool (=> (or (= temp___is_init_1640 true) (<= 1 10)) (in_range4 temp___expr_1643)))
...
(declare-const temp___18231 t1)
(declare-const screen__writestatsdata__statscountstring__data__assume (Array Int character))
(declare-const screen__writestatsdata__statscountstring__data__assume1 t)
(declare-const o (Array Int character))
(declare-const temp___1830 (Array Int character))
(declare-const temp___18301 t4)
(declare-const temp___1831 (Array Int character))
(declare-const temp___18311 t3)
(declare-const temp___1833 Int)
(declare-const o1 (Array Int character))
(declare-const temp___1834 (Array Int character))
(declare-const temp___18341 t3)
...
(assert (and (= (mk___t1 temp___1823 temp___18231) (statscount_image value)) (and (dynamic_invariant1 (mk___t1 temp___1823 temp___18231) true false true) (= (mk___t1 temp___1823 temp___18231) (let ((temp___1322 (to_string (attr__ATTRIBUTE_IMAGE3 value)))) (mk___t1 (elts temp___1322) (mk1 (to_rep1 (first (rt temp___1322))) (to_rep1 (last (rt temp___1322))))))))))
(assert (= temp___1823 screen__writestatsdata__statscountstring__data__assume))
(assert (= (mk (to_rep1 (first2 temp___18231)) (to_rep1 (last2 temp___18231))) screen__writestatsdata__statscountstring__data__assume1))
(assert (= result data))
(assert (= data1 screen__writestatsdata__statscountstring__data__assume))
(assert (= (to_rep1 data__first) (to_rep1 (first screen__writestatsdata__statscountstring__data__assume1))))
(assert (= (to_rep1 data__last) (to_rep1 (last screen__writestatsdata__statscountstring__data__assume1))))
(assert (dynamic_property 1 2147483647 (to_rep1 data__first) (to_rep1 data__last)))
(assert (= result1 result__))
(assert (= result__1 (screen__writestatsdata__statscountstring__result__aggregate_def 32)))
...
(assert (= o data1))
(assert (= o temp___1830))
(assert (= (mk4 2 (to_rep1 data__last)) temp___18301))
(assert (= (ite (<= (to_rep1 (first8 temp___18301)) (to_rep1 (last8 temp___18301))) (+ (- (to_rep1 (last8 temp___18301)) (to_rep1 (first8 temp___18301))) 1) 0) (ite (<= 1 (- (to_rep1 data__last) 1)) (+ (- (- (to_rep1 data__last) 1) 1) 1) 0)))
(assert (= (slide temp___1830 (to_rep1 (first8 temp___18301)) 1) temp___1831))
(assert (= (mk3 1 (- (to_rep1 data__last) 1)) temp___18311))
(assert (not (in_range (- (to_rep1 data__last) 1))))
(check-sat)
(exit)
