...
(define-fun default_initial_assumption2 ((temp___expr_276 us_rep4) (temp___skip_top_level_277 Bool)) Bool (and (and (= (to_rep1 (rec__binary_trees__forest__s (us_split_fields5 temp___expr_276))) 0) (forall ((temp___279 Int)) (=> (and (<= 1 temp___279) (<= temp___279 100)) (and (and (and (= (to_rep1 (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 temp___expr_276)) temp___279)))) 0) (= (to_rep1 (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 temp___expr_276)) temp___279)))) 0)) (= (to_rep1 (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 temp___expr_276)) temp___279)))) 0)) (= (to_rep2 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 temp___expr_276)) temp___279)))) 2))))) (=> (not (= temp___skip_top_level_277 true)) (= (size temp___expr_276) 0))))
...
(define-fun dynamic_invariant8 ((temp___expr_150 Int) (temp___is_init_147 Bool) (temp___skip_constant_148 Bool) (temp___do_toplevel_149 Bool)) Bool (=> (or (= temp___is_init_147 true) (<= 1 100)) (in_range3 temp___expr_150)))
...
(assert (forall ((t1 us_rep5)) (! (=> (and (dynamic_invariant10 t1 true true true) (type_invariant1 t1)) (dynamic_invariant1 (size1 t1) true false true)) :pattern ((size1 t1)))))
(assert (forall ((t1 us_rep5)) (! (=> (dynamic_invariant10 t1 true true true) (= (size1 t1) (size (rec__search_trees__search_tree__struct (us_split_fields7 t1))))) :pattern ((size1 t1)))))
(assert true)
(assert (forall ((f us_rep4)) (forall ((root Int)) (forall ((values2 (Array Int natural))) (! (= (= (ordered_leafs f root values2) true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (let ((temp___482 (model__ f root))) (select temp___482 i)))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (let ((temp___483 (model__ f root))) (select temp___483 j)))) true)) (= (olt (rec__tree_model__path_type__a (us_split_fields1 (let ((temp___484 (model__ f root))) (select temp___484 i)))) (rec__tree_model__path_type__a (us_split_fields1 (let ((temp___485 (model__ f root))) (select temp___485 j))))) true)) (ite (= (get (rec__tree_model__path_type__a (us_split_fields1 (let ((temp___480 (model__ f root))) (select temp___480 j)))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (let ((temp___481 (model__ f root))) (select temp___481 i))))) 1)) 0) (< (to_rep (select values2 j)) (to_rep (select values2 i))) (< (to_rep (select values2 i)) (to_rep (select values2 j)))))))))) :pattern ((ordered_leafs f root values2)))))))
...
(assert (forall ((f us_rep4)) (forall ((i Int)) (! (=> (and (dynamic_invariant7 f true true true) (dynamic_invariant8 i true true true)) (=> (< (size f) i) (not (= (valid_root f i) true)))) :pattern ((valid_root f i))))))
(assert (forall ((f us_rep4)) (forall ((i Int)) (! (=> (and (dynamic_invariant7 f true true true) (dynamic_invariant8 i true true true)) (let ((result (parent f i))) (and (and (=> (= (valid_root f i) true) (= result 0)) (=> (= (size f) 0) (= result 0))) (dynamic_invariant1 result true false true)))) :pattern ((parent f i))))))
(assert (forall ((f us_rep4)) (forall ((i Int)) (! (=> (and (and (dynamic_invariant7 f true true true) (dynamic_invariant8 i true true true)) (not (= (parent f i) 0))) (dynamic_invariant2 (position f i) true false true)) :pattern ((position f i))))))
...
(declare-const temp___664 Int)
(declare-const temp___690 Int)
(declare-const o Int)
(declare-const temp___667 (Array Int us_rep1))
(declare-const i Int)
...
(declare-const temp___673 (Array Int us_rep1))
...
(declare-const temp___671 (Array Int us_rep1))
...
(declare-const temp___672 (Array Int us_rep1))
...
(declare-const temp___693 (Array Int us_rep1))
(declare-const o47 Int)
(declare-const o48 Int)
(declare-const search_trees__contains__result1 Bool)
...
(declare-const search_trees__contains__result2 Bool)
...
(declare-const search_trees__contains__result3 Bool)
...
(declare-const search_trees__contains__result4 bool__ref)
(declare-const current6 Int)
(declare-const previous5 Int)
(declare-const d6 Int)
(declare-const search_trees__contains__result5 Bool)
(declare-const current7 int__ref)
(declare-const previous6 int__ref)
(declare-const d7 int__ref)
(declare-const search_trees__contains__result6 bool__ref)
(declare-const current8 Int)
(declare-const previous7 Int)
(declare-const d8 Int)
(declare-const search_trees__contains__result7 Bool)
(declare-const result14 Bool)
(declare-const result15 bool__ref)
(declare-const search_trees__contains__result8 Bool)
(declare-const search_trees__contains__result9 bool__ref)
(declare-const search_trees__contains__result10 Bool)
(declare-const current9 int__ref)
(declare-const previous8 int__ref)
(declare-const d9 int__ref)
(declare-const search_trees__contains__result11 bool__ref)
(declare-const current10 Int)
(declare-const previous9 Int)
(declare-const d10 Int)
(declare-const search_trees__contains__result12 Bool)
(declare-const current11 int__ref)
(declare-const previous10 int__ref)
(declare-const d11 int__ref)
(declare-const search_trees__contains__result13 bool__ref)
(declare-const current12 Int)
(declare-const previous11 Int)
(declare-const d12 Int)
(declare-const search_trees__contains__result14 Bool)
...
(assert (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) current2))) true))
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i1))) true) (=> (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i1))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) current2)))) true) (ite (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) current2))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i1)))) 1)) 0) (< v (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i1))) (< (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i1)) v)))))))
(assert (and (and (and (=> (<= 0 100) (in_range4 current2)) (=> (<= 0 100) (in_range4 previous2))) (=> (<= 0 1) (in_range5 d2))) (not (= current2 0))))
(assert (<= 1 i))
(assert (<= i 100))
...
(assert (and (= temp___675 (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o1)) (and (dynamic_invariant9 temp___675 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___675 o1))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___675 o1)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 o1)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___675 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___675 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___675 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___675 i1))) true) (not (= i1 o1))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___675 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))) (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___675 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___675 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___675 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___675 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___675 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___675 j)))) true)) (= j i1))))))))))))))
(assert (= (mk___rep (mk___split_fields o2 o3)) (select temp___675 i)))
(assert (= o2 o4))
(assert (= o3 o5))
(assert (= result3 o5))
(assert (= result3 true))
...
(assert (and (= temp___674 (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o12)) (and (dynamic_invariant9 temp___674 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___674 o12))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___674 o12)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 o12)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___674 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___674 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___674 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___674 i1))) true) (not (= i1 o12))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___674 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))) (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___674 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___674 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___674 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___674 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___674 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___674 j)))) true)) (= j i1))))))))))))))
(assert (and (<= 1 current2) (<= current2 100)))
(assert (= o13 current2))
(assert (= (mk___rep (mk___split_fields o14 o15)) (select temp___674 o13)))
(assert (= o14 o16))
(assert (= o15 o17))
(assert (= o18 o16))
(assert (and (= o6 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) (in_range3 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))))))
(assert (and (= temp___673 (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o6)) (and (dynamic_invariant9 temp___673 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___673 o6))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___673 o6)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 o6)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___673 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___673 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___673 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___673 i1))) true) (not (= i1 o6))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___673 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))) (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___673 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___673 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___673 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___673 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___673 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___673 j)))) true)) (= j i1))))))))))))))
(assert (= (mk___rep (mk___split_fields o7 o8)) (select temp___673 i)))
(assert (= o7 o9))
(assert (= o8 o10))
(assert (= o11 o9))
(assert (and (= result4 (olt o11 o18)) (= (= result4 true) (and (< (length o11) (length o18)) (forall ((n Int)) (=> (and (<= 1 n) (<= n (last o11))) (= (get o11 n) (get o18 n))))))))
(assert (= result4 true))
(assert (and (= o26 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) (in_range3 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))))))
(assert (and (= temp___672 (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o26)) (and (dynamic_invariant9 temp___672 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___672 o26))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___672 o26)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 o26)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___672 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___672 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___672 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___672 i1))) true) (not (= i1 o26))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___672 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))) (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___672 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___672 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___672 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___672 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___672 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___672 j)))) true)) (= j i1))))))))))))))
(assert (= (mk___rep (mk___split_fields o27 o28)) (select temp___672 i)))
(assert (= o27 o29))
(assert (= o28 o30))
(assert (= o31 o29))
(assert (and (= o32 (length o31)) (and (in_range6 o32) (<= (+ 0 o32) 2147483647))))
(assert (= o33 (+ o32 1)))
...
(assert (and (= temp___671 (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o19)) (and (dynamic_invariant9 temp___671 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___671 o19))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___671 o19)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 o19)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___671 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___671 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___671 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___671 i1))) true) (not (= i1 o19))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___671 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))) (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___671 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___671 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___671 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___671 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___671 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___671 j)))) true)) (= j i1))))))))))))))
(assert (and (<= 1 current2) (<= current2 100)))
(assert (= o20 current2))
(assert (= (mk___rep (mk___split_fields o21 o22)) (select temp___671 o20)))
(assert (= o21 o23))
(assert (= o22 o24))
(assert (= o25 o23))
(assert (not (<= 1 o34)))
