...
(assert (forall ((this1 us_rep)) (! (=> (dynamic_invariant this1 true true true true) (dynamic_invariant1 (extent this1) true false true true)) :pattern ((extent this1)))))
(assert (forall ((attr__tag4 Int)) (forall ((this1 us_rep)) (! (=> (dynamic_invariant this1 true true true true) (dynamic_invariant1 (extent1 attr__tag4 this1) true false true true)) :pattern ((extent1 attr__tag4 this1))))))
...
(assert (forall ((this1 us_rep)) (! (=> (dynamic_invariant this1 true true true true) (= (extent this1) (to_rep (rec__integer_stacks__stack__top (us_split_fields1 this1))))) :pattern ((extent this1)))))
...
(assert true)
(assert true)
(assert (forall ((this1 us_rep)) (! (= (ite (empty this1) 1 0) (ite (empty1 us_tag this1) 1 0)) :pattern ((empty1 us_tag this1)))))
(assert (forall ((this1 us_rep)) (! (= (ite (empty this1) 1 0) (ite (empty1 us_tag1 this1) 1 0)) :pattern ((empty1 us_tag1 this1)))))
(assert (forall ((this1 us_rep)) (! (= (ite (empty this1) 1 0) (ite (empty1 us_tag3 this1) 1 0)) :pattern ((empty1 us_tag3 this1)))))
(assert (forall ((this1 us_rep)) (! (= (ite (empty this1) 1 0) (ite (empty1 us_tag2 this1) 1 0)) :pattern ((empty1 us_tag2 this1)))))
...
(define-fun dynamic_property8 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range3 low) (and (in_range3 high) (=> (<= low high) (and (in_range1 low) (in_range1 high))))))
...
(define-fun dynamic_invariant4 ((temp___expr_172 us_t4) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool) (temp___do_typ_inv_171 Bool)) Bool (=> (not (= temp___skip_constant_169 true)) (dynamic_property8 1 2147483647 (first9 temp___expr_172) (last9 temp___expr_172))))
(define-fun dynamic_invariant5 ((temp___expr_165 Int) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool) (temp___do_typ_inv_164 Bool)) Bool (=> (or (= temp___is_init_161 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_165)))
...
(define-fun dynamic_property10 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range3 low) (and (in_range3 high) (=> (<= low high) (and (dynamic_property9 range_first range_last low) (dynamic_property9 range_first range_last high))))))
...
(assert (forall ((temp___247 Int) (temp___248 Int) (temp___249 Int)) (let ((temp___246 (temp___245 temp___247 temp___248 temp___249))) (=> (dynamic_invariant5 temp___247 true true true true) (and (=> (dynamic_property8 1 2147483647 temp___248 temp___249) (and (= (first11 temp___246) temp___248) (= (last11 temp___246) temp___249))) (forall ((temp___250 Int)) (= (to_rep2 (select (to_array5 temp___246) temp___250)) temp___247)))))))
