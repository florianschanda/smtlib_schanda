...
(assert (forall ((this1 us_rep)) (! (=> (dynamic_invariant this1 true true true) (dynamic_invariant1 (extent this1) true false true)) :pattern ((extent this1)))))
(assert (forall ((attr__tag4 Int)) (forall ((this1 us_rep)) (! (=> (dynamic_invariant this1 true true true) (dynamic_invariant1 (extent1 attr__tag4 this1) true false true)) :pattern ((extent1 attr__tag4 this1))))))
(assert (forall ((this1 us_rep)) (! (= (extent this1) (extent1 us_tag this1)) :pattern ((extent1 us_tag this1)))))
(assert (forall ((this1 us_rep)) (! (= (extent this1) (extent1 us_tag1 this1)) :pattern ((extent1 us_tag1 this1)))))
(assert (forall ((this1 us_rep)) (! (= (extent this1) (extent1 us_tag3 this1)) :pattern ((extent1 us_tag3 this1)))))
(assert (forall ((this1 us_rep)) (! (= (extent this1) (extent1 us_tag2 this1)) :pattern ((extent1 us_tag2 this1)))))
(assert (forall ((this1 us_rep)) (! (=> (dynamic_invariant this1 true true true) (= (extent this1) (to_rep (rec__integer_stacks__stack__top (us_split_fields1 this1))))) :pattern ((extent this1)))))
...
(assert true)
(assert true)
(assert (forall ((this1 us_rep)) (! (= (to_int1 (empty this1)) (to_int1 (empty1 us_tag this1))) :pattern ((empty1 us_tag this1)))))
(assert (forall ((this1 us_rep)) (! (= (to_int1 (empty this1)) (to_int1 (empty1 us_tag1 this1))) :pattern ((empty1 us_tag1 this1)))))
(assert (forall ((this1 us_rep)) (! (= (to_int1 (empty this1)) (to_int1 (empty1 us_tag3 this1))) :pattern ((empty1 us_tag3 this1)))))
(assert (forall ((this1 us_rep)) (! (= (to_int1 (empty this1)) (to_int1 (empty1 us_tag2 this1))) :pattern ((empty1 us_tag2 this1)))))
(assert (forall ((this1 us_rep)) (! (= (= (empty this1) true) (= (to_rep (rec__integer_stacks__stack__top (us_split_fields1 this1))) 0)) :pattern ((empty this1)))))
(define-fun dynamic_invariant4 ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_142)))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range3 f) (=> (in_range3 l) (and (= (to_rep3 (first8 (mk4 f l))) f) (= (to_rep3 (last8 (mk4 f l))) l)))) :pattern ((mk4 f l)))))
...
(define-fun bool_eq9 ((x us_t4) (y us_t4)) Bool (bool_eq (elts4 x) (to_rep3 (first8 (rt4 x))) (to_rep3 (last8 (rt4 x))) (elts4 y) (to_rep3 (first8 (rt4 y))) (to_rep3 (last8 (rt4 y)))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range3 f) (=> (in_range3 l) (and (= (to_rep3 (first10 (mk5 f l))) f) (= (to_rep3 (last10 (mk5 f l))) l)))) :pattern ((mk5 f l)))))
(define-fun dynamic_property10 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range3 low) (and (in_range3 high) (=> (<= low high) (and (in_range1 low) (in_range1 high))))))
...
(define-fun bool_eq10 ((x us_t5) (y us_t5)) Bool (bool_eq (elts5 x) (to_rep3 (first10 (rt5 x))) (to_rep3 (last10 (rt5 x))) (elts5 y) (to_rep3 (first10 (rt5 y))) (to_rep3 (last10 (rt5 y)))))
...
(assert (forall ((temp___220 Int) (temp___221 Int) (temp___222 Int)) (let ((temp___219 (temp___218 temp___220 temp___221 temp___222))) (and (=> (dynamic_property10 1 2147483647 temp___221 temp___222) (and (= (first9 temp___219) temp___221) (= (last9 temp___219) temp___222))) (forall ((temp___223 Int)) (= (select (to_array4 temp___219) temp___223) (of_rep2 temp___220)))))))
(assert (forall ((a us_rep3) (b us_rep3)) (! (= (user_eq15 a b) (oeq (to_base2 a) (to_base2 b))) :pattern ((user_eq15 a b)))))
(define-fun dynamic_invariant5 ((temp___expr_229 us_rep3) (temp___is_init_226 Bool) (temp___skip_constant_227 Bool) (temp___do_toplevel_228 Bool)) Bool (and (=> (not (= temp___skip_constant_227 true)) (in_range7 (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 left))) (to_base2 temp___expr_229))) (and (dynamic_property7 1 (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 left))) (first7 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_229))) (last7 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_229)))) (and (= (first7 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_229))) 1) (= (last7 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_229))) (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 left))))))))
(define-fun default_initial_assumption ((temp___expr_232 us_rep3) (temp___skip_top_level_233 Bool)) Bool (and (and (= (attr__tag3 temp___expr_232) us_tag3) (and (and (= (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs4 temp___expr_232))) (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 left)))) (= (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_232)) (let ((temp___235 (temp___218 0 1 (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs4 temp___expr_232)))))) (of_array3 (to_array4 temp___235) (first9 temp___235) (last9 temp___235))))) (= (to_rep (rec__integer_stacks__stack__top3 (us_split_fields7 temp___expr_232))) 0))) (=> (not (= temp___skip_top_level_233 true)) (= (empty (to_base2 temp___expr_232)) true))))
