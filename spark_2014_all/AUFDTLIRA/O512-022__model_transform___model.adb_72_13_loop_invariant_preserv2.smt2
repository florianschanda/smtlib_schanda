...
(assert (<= 0 s8))
(assert (<= s8 100))
(assert (forall ((t Int)) (=> (and (<= 0 t) (<= t (- s9 1))) (and (= (name (select (owned_state sm) (from (select (owned_transition sm) t)))) (name__2 (select (map__content2 av6) (from__2 (select cfv2 t))))) (= (name (select (owned_state sm) (to__ (select (owned_transition sm) t)))) (name__2 (select (map__content2 av6) (to__2 (select cfv2 t)))))))))
(assert (and (=> (<= 0 100) (in_range7 s9)) (and (<= 0 s9) (<= s9 100))))
(assert (and (= temp___484 (owned_transition sm)) (= temp___484 (rec__model__uml_state_machine__owned_transition_data (us_split_fields5 sm)))))
(assert (= o6 (select temp___484 s9)))
(assert (and (= o7 (from o6)) (and (in_range2 o7) (= o7 (to_rep1 (rec__model__uml_transition__from_data (us_split_fields3 o6)))))))
(assert (and (= (from__2 (mk___rep4 model__set_from__2__self__fields)) o7) (= (to__2 (mk___rep4 model__set_from__2__self__fields)) (to__2 (mk___rep4 (us_split_fields9 (select cfv2 s9)))))))
(assert (= result6 (mk_map__ref3 cfv2)))
(assert (= cfv3 (store cfv2 s9 (mk___rep4 model__set_from__2__self__fields))))
(assert (and (= temp___485 (owned_transition sm)) (= temp___485 (rec__model__uml_state_machine__owned_transition_data (us_split_fields5 sm)))))
(assert (= o8 (select temp___485 s9)))
(assert (and (= o9 (to__ o8)) (and (in_range2 o9) (= o9 (to_rep1 (rec__model__uml_transition__to_data (us_split_fields3 o8)))))))
(assert (and (= (to__2 (mk___rep4 model__set_to__2__self__fields)) o9) (= (from__2 (mk___rep4 model__set_to__2__self__fields)) (from__2 (mk___rep4 (us_split_fields9 (select cfv3 s9)))))))
(assert (= result7 (mk_map__ref3 cfv3)))
(assert (= cfv4 (store cfv3 s9 (mk___rep4 model__set_to__2__self__fields))))
(assert (not (= s9 100)))
...
(assert (not (= (name (select (owned_state sm) (from (select (owned_transition sm) t)))) (name__2 (select (map__content2 av6) (from__2 (select (map__content3 cfv5) t)))))))
(check-sat)
(exit)
