...
(declare-const o6 signal)
(declare-const o7 Int)
(declare-const o8 (Array Int signal))
(declare-const o9 Int)
(declare-const o10 Int)
(declare-const o11 signal)
(declare-const o12 Int)
(declare-const o13 signal)
(declare-const o14 Int)
(declare-const o15 (Array Int signal))
...
(declare-const result4 map__ref3)
...
(declare-const result13 map__ref4)
...
(assert (=> (= (to_rep5 (select track_signals (to_rep (rec__trains__train_position__track_begin (us_split_fields3 new_position))))) 0) (= result2 result__3)))
(assert (=> (= (to_rep5 (select track_signals (to_rep (rec__trains__train_position__track_begin (us_split_fields3 new_position))))) 0) (= result__1 0)))
(assert (=> (not (= (to_rep5 (select track_signals (to_rep (rec__trains__train_position__track_begin (us_split_fields3 new_position))))) 0)) (= result3 result__3)))
(assert (=> (not (= (to_rep5 (select track_signals (to_rep (rec__trains__train_position__track_begin (us_split_fields3 new_position))))) 0)) (= result__2 1)))
(assert (=> (not (= (to_rep5 (select track_signals (to_rep (rec__trains__train_position__track_begin (us_split_fields3 new_position))))) 0)) (= result__1 result__2)))
(assert (= result4 (mk_map__ref3 trains)))
(assert (= trains1 (store trains train new_position)))
(assert (= (to_rep5 o) 2))
(assert (= o1 (store track_signals (to_rep (rec__trains__train_position__track_begin (us_split_fields3 new_position))) o)))
...
(assert (<= 1 id1))
(assert (<= id1 3))
(assert (and (= o2 (get_other_previous_track new_position id1)) (and (in_range1 o2) (= o2 (ite (= (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep (rec__trains__train_position__track_begin (us_split_fields3 new_position)))))))) id1)) (to_rep (rec__trains__train_position__track_end (us_split_fields3 new_position)))) 0 (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep (rec__trains__train_position__track_begin (us_split_fields3 new_position)))))))) id1)))))))
(assert (= result7 (mk_int__ref prev)))
(assert (= prev1 o2))
(assert (=> (not (= prev1 0)) (and (<= 1 prev1) (<= prev1 8))))
(assert (=> (not (= prev1 0)) (= o3 prev1)))
(assert (=> (not (= prev1 0)) (= o4 (select track_signals1 o3))))
(assert (=> (not (= prev1 0)) (= o5 (to_rep5 o4))))
(assert (=> (not (= prev1 0)) (= result8 (ite (= o5 0) true false))))
(assert (=> (not (not (= prev1 0))) (= result8 false)))
(assert (=> (= result8 true) (= (to_rep5 o6) 1)))
(assert (=> (= result8 true) (and (<= 1 prev1) (<= prev1 8))))
(assert (=> (= result8 true) (= o7 prev1)))
(assert (=> (= result8 true) (= o8 (store track_signals1 o7 o6))))
(assert (=> (= result8 true) (= result9 (mk_map__ref4 track_signals1))))
(assert (=> (= result8 true) (= track_signals2 o8)))
(assert (=> (not (= result8 true)) (= track_signals2 track_signals1)))
(assert (forall ((k Int)) (=> (and (<= 1 k) (<= k id2)) (=> (not (= (get_other_previous_track new_position k) 0)) (let ((temp___362 (to_rep5 (select track_signals3 (get_other_previous_track new_position k))))) (or (= temp___362 1) (= temp___362 2)))))))
(assert (forall ((j Int)) (=> (and (<= 1 j) (<= j 8)) (and (=> (= (to_rep5 (select track_signals1 j)) 2) (= (to_rep5 (select track_signals3 j)) 2)) (=> (= (to_rep5 (select track_signals1 j)) 1) (= (to_rep5 (select track_signals3 j)) 1))))))
(assert (and (and (=> (<= 1 3) (in_range3 id2)) (=> (<= 0 8) (in_range1 prev2))) (and (<= 1 id2) (<= id2 3))))
(assert (not (= id2 3)))
(assert (= result10 (mk_int__ref id2)))
(assert (= id3 (+ id2 1)))
(assert (and (= o9 (get_other_previous_track new_position id3)) (and (in_range1 o9) (= o9 (ite (= (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep (rec__trains__train_position__track_begin (us_split_fields3 new_position)))))))) id3)) (to_rep (rec__trains__train_position__track_end (us_split_fields3 new_position)))) 0 (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep (rec__trains__train_position__track_begin (us_split_fields3 new_position)))))))) id3)))))))
(assert (= result11 (mk_int__ref prev2)))
(assert (= prev3 o9))
(assert (=> (not (= prev3 0)) (and (<= 1 prev3) (<= prev3 8))))
(assert (=> (not (= prev3 0)) (= o10 prev3)))
(assert (=> (not (= prev3 0)) (= o11 (select track_signals3 o10))))
(assert (=> (not (= prev3 0)) (= o12 (to_rep5 o11))))
(assert (=> (not (= prev3 0)) (= result12 (ite (= o12 0) true false))))
(assert (=> (not (not (= prev3 0))) (= result12 false)))
(assert (=> (= result12 true) (= (to_rep5 o13) 1)))
(assert (=> (= result12 true) (and (<= 1 prev3) (<= prev3 8))))
(assert (=> (= result12 true) (= o14 prev3)))
(assert (=> (= result12 true) (= o15 (store track_signals3 o14 o13))))
(assert (=> (= result12 true) (= result13 (mk_map__ref4 track_signals3))))
(assert (=> (= result12 true) (= track_signals4 o15)))
(assert (=> (not (= result12 true)) (= track_signals4 track_signals3)))
(declare-const k Int)
(assert (<= 1 k))
(assert (<= k id3))
(assert (not (= (get_other_previous_track new_position k) 0)))
(define-fun temp___362 () Int (to_rep5 (select track_signals4 (get_other_previous_track new_position k))))
(assert (not (or (= temp___362 1) (= temp___362 2))))
(check-sat)
(exit)
