...
(assert (<= 1 id14))
(assert (<= id14 3))
(assert (and (= o36 (get_other_previous_track new_position id14)) (and (in_range1 o36) (= o36 (ite (= (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep (rec__trains__train_position__track_begin (us_split_fields3 new_position)))))))) id14)) (to_rep (rec__trains__train_position__track_end (us_split_fields3 new_position)))) 0 (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep (rec__trains__train_position__track_begin (us_split_fields3 new_position)))))))) id14)))))))
(assert (= result23 (mk_int__ref prev)))
(assert (= prev11 o36))
(assert (=> (not (= prev11 0)) (and (<= 1 prev11) (<= prev11 8))))
(assert (=> (not (= prev11 0)) (= o37 prev11)))
(assert (=> (not (= prev11 0)) (= o38 (select track_signals12 o37))))
(assert (=> (not (= prev11 0)) (= o39 (to_rep5 o38))))
(assert (=> (not (= prev11 0)) (= result24 (ite (= o39 0) true false))))
(assert (=> (= prev11 0) (= result24 false)))
(assert (=> (= result24 true) (= (to_rep5 o40) 1)))
(assert (=> (= result24 true) (and (<= 1 prev11) (<= prev11 8))))
(assert (=> (= result24 true) (= o41 prev11)))
(assert (=> (= result24 true) (= o42 (store track_signals12 o41 o40))))
(assert (=> (= result24 true) (= result25 (mk_map__ref4 track_signals12))))
(assert (=> (= result24 true) (= track_signals13 o42)))
(assert (=> (not (= result24 true)) (= track_signals13 track_signals12)))
(assert (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 id15)) (=> (not (= (get_other_previous_track new_position k1) 0)) (let ((temp___362 (to_rep5 (select track_signals14 (get_other_previous_track new_position k1))))) (or (= temp___362 1) (= temp___362 2)))))))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 8)) (and (=> (= (to_rep5 (select track_signals12 j1)) 2) (= (to_rep5 (select track_signals14 j1)) 2)) (=> (= (to_rep5 (select track_signals12 j1)) 1) (= (to_rep5 (select track_signals14 j1)) 1))))))
(assert (and (and (=> (<= 1 3) (in_range3 id15)) (=> (<= 0 8) (in_range1 prev12))) (and (<= 1 id15) (<= id15 3))))
(assert (not (= id15 3)))
(assert (= result27 (mk_int__ref id15)))
(assert (= id16 (+ id15 1)))
(assert (and (= o47 (get_other_previous_track new_position id16)) (and (in_range1 o47) (= o47 (ite (= (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep (rec__trains__train_position__track_begin (us_split_fields3 new_position)))))))) id16)) (to_rep (rec__trains__train_position__track_end (us_split_fields3 new_position)))) 0 (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep (rec__trains__train_position__track_begin (us_split_fields3 new_position)))))))) id16)))))))
(assert (= result28 (mk_int__ref prev12)))
(assert (= prev13 o47))
(assert (=> (not (= prev13 0)) (and (<= 1 prev13) (<= prev13 8))))
(assert (=> (not (= prev13 0)) (= o48 prev13)))
(assert (=> (not (= prev13 0)) (= o49 (select track_signals14 o48))))
(assert (=> (not (= prev13 0)) (= o50 (to_rep5 o49))))
(assert (=> (not (= prev13 0)) (= result29 (ite (= o50 0) true false))))
(assert (=> (= prev13 0) (= result29 false)))
(assert (=> (= result29 true) (= (to_rep5 o51) 1)))
(assert (=> (= result29 true) (and (<= 1 prev13) (<= prev13 8))))
(assert (=> (= result29 true) (= o52 prev13)))
(assert (=> (= result29 true) (= o53 (store track_signals14 o52 o51))))
(assert (=> (= result29 true) (= result30 (mk_map__ref4 track_signals14))))
(assert (=> (= result29 true) (= track_signals15 o53)))
(assert (=> (not (= result29 true)) (= track_signals15 track_signals14)))
(declare-const k1 Int)
(assert (<= 1 k1))
(assert (<= k1 id16))
(assert (not (= (get_other_previous_track new_position k1) 0)))
(assert (not (or (= (to_rep5 (select track_signals15 (get_other_previous_track new_position k1))) 1) (= (to_rep5 (select track_signals15 (get_other_previous_track new_position k1))) 2))))
(check-sat)
(exit)
