...
(assert (forall ((k Int)) (=> (and (<= 1 k) (<= k id2)) (=> (not (= (get_other_previous_track new_position k) 0)) (let ((temp___394 (to_rep5 (select track_signals3 (get_other_previous_track new_position k))))) (or (= temp___394 1) (= temp___394 2)))))))
...
(define-fun temp___394 () Int (to_rep5 (select track_signals4 (get_other_previous_track new_position k))))
(assert (not (or (= temp___394 1) (= temp___394 2))))
(check-sat)
(exit)
