...
(define-fun dynamic_invariant ((temp___expr_176 Int) (temp___is_init_173 Bool) (temp___skip_constant_174 Bool) (temp___do_toplevel_175 Bool)) Bool (=> (or (= temp___is_init_173 true) (<= 0 99)) (in_range1 temp___expr_176)))
...
(assert (= a4 result4))
(assert (= a5 o7))
(assert (not (in_range1 (- (to_rep (select a5 5)) (to_rep (select a5 4))))))
(check-sat)
(exit)
