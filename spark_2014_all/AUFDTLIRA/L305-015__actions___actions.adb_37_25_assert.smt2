...
(assert (= b5 true))
(assert (not (<= x 5)))
(assert (and (= o11 (+ y 1)) (in_range1 (+ y 1))))
(assert (= o12 (ite (<= j4 o11) true false)))
(assert (= result7 (ite (<= 6 j4) o12 false)))
(assert (= (= result6 true) (exists ((j6 Int)) (and (and (<= 6 j6) (<= j6 (+ y 1))) (= (to_rep (select a2 j6)) 1)))))
