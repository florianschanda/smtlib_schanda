...
(assert (and (= temp___536 (invert_1 o1)) (and (forall ((rank Int)) (=> (and (<= 1 rank) (<= rank 64)) (= (to_rep1 (select temp___536 (to_rep (select o1 rank)))) rank))) (forall ((g1 Int)) (=> (and (<= 1 g1) (<= g1 64)) (= (to_rep (select o1 (to_rep1 (select temp___536 g1)))) g1))))))
(assert (not (<= 1 prev)))
(check-sat)
(exit)
