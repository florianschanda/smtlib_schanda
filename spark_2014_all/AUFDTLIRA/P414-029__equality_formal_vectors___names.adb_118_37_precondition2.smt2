...
(define-fun last2 ((container us_rep)) Int (+ (- 1) (length1 container)))
...
(define-fun dynamic_invariant1 ((temp___expr_310 Int) (temp___is_init_306 Bool) (temp___skip_constant_307 Bool) (temp___do_toplevel_308 Bool) (temp___do_typ_inv_309 Bool)) Bool (=> (or (= temp___is_init_306 true) (<= 0 255)) (in_range5 temp___expr_310)))
...
(assert (forall ((x name_id)) (! (in_range6 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(assert (forall ((x char_table_index)) (! (in_range7 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(define-fun bool_eq3 ((a us_rep2) (b us_rep2)) Bool (ite (and (and (= (to_rep4 (rec__names__name_entry__table_index (us_split_fields3 a))) (to_rep4 (rec__names__name_entry__table_index (us_split_fields3 b)))) (= (to_rep2 (rec__names__name_entry__length (us_split_fields3 a))) (to_rep2 (rec__names__name_entry__length (us_split_fields3 b))))) (= (to_rep3 (rec__names__name_entry__next_hash (us_split_fields3 a))) (to_rep3 (rec__names__name_entry__next_hash (us_split_fields3 b))))) true false))
...
(define-fun element_type__ref___3__projection ((a element_type__ref1)) us_rep2 (element_type__content1 a))
(declare-datatypes () ((element_type__ref2 (mk_element_type__ref2 (element_type__content2 us_rep2)))))
(define-fun element_type__ref___4__projection ((a element_type__ref2)) us_rep2 (element_type__content2 a))
...
(declare-fun get1 (us_rep3 Int) us_rep2)
(declare-fun get__function_guard1 (us_rep2 us_rep3 Int) Bool)
...
(declare-datatypes () ((us_split_fields4 (mk___split_fields2 (rec__names__entry_tables__vector us_main_type3)))))
(define-fun us_split_fields_Vector__2__projection ((a us_split_fields4)) us_main_type3 (rec__names__entry_tables__vector a))
...
(declare-datatypes () ((us_rep4 (mk___rep2 (us_split_discrs3 us_split_discrs2) (us_split_fields5 us_split_fields4)))))
(define-fun us_rep___4__projection ((a us_rep4)) us_split_discrs2 (us_split_discrs3 a))
(define-fun us_rep___5__projection ((a us_rep4)) us_split_fields4 (us_split_fields5 a))
...
(declare-datatypes () ((vector__ref1 (mk_vector__ref1 (vector__content1 us_rep4)))))
(define-fun vector__ref___2__projection ((a vector__ref1)) us_rep4 (vector__content1 a))
(declare-fun model__1 (us_rep4) us_rep3)
(declare-fun model____function_guard1 (us_rep3 us_rep4) Bool)
...
(define-fun last_index1 ((container us_rep4)) Int (last3 (model__1 container)))
(declare-fun last_index__function_guard1 (Int us_rep4) Bool)
(declare-fun first_index__function_guard1 (Int us_rep4) Bool)
(define-fun element1 ((container us_rep4) (index Int)) us_rep2 (get1 (model__1 container) index))
(declare-fun element__function_guard1 (us_rep2 us_rep4 Int) Bool)
(define-fun dynamic_invariant2 ((temp___expr_210 Int) (temp___is_init_206 Bool) (temp___skip_constant_207 Bool) (temp___do_toplevel_208 Bool) (temp___do_typ_inv_209 Bool)) Bool (=> (or (= temp___is_init_206 true) (<= 0 2147483647)) (in_range6 temp___expr_210)))
(define-fun to_rep5 ((x capacity_range1)) Int (capacity_rangeqtint1 x))
...
(define-fun in_range9 ((rec__names__entry_tables__vector__capacity1 Int) (a us_rep4)) Bool (= rec__names__entry_tables__vector__capacity1 (to_rep5 (rec__names__entry_tables__vector__capacity (us_split_discrs3 a)))))
...
(declare-datatypes () ((tentry_tableS__ref (mk_tentry_tableS__ref (tentry_tableS__content us_rep4)))))
(define-fun tentry_tableS__ref___projection ((a tentry_tableS__ref)) us_rep4 (tentry_tableS__content a))
...
(define-fun dynamic_invariant3 ((temp___expr_631 us_rep4) (temp___is_init_627 Bool) (temp___skip_constant_628 Bool) (temp___do_toplevel_629 Bool) (temp___do_typ_inv_630 Bool)) Bool (=> (not (= temp___skip_constant_628 true)) (in_range9 128 temp___expr_631)))
(define-fun default_initial_assumption ((temp___expr_633 us_rep4) (temp___skip_top_level_634 Bool)) Bool (and (= (to_rep5 (rec__names__entry_tables__vector__capacity (us_split_discrs3 temp___expr_633))) 128) (=> (not (= temp___skip_top_level_634 true)) (= (is_empty temp___expr_633) true))))
(define-fun to_rep6 ((x capacity_range)) Int (capacity_rangeqtint x))
(declare-fun of_rep6 (Int) capacity_range)
(assert (forall ((x capacity_range)) (! (= (of_rep6 (to_rep6 x)) x) :pattern ((to_rep6 x)))))
(assert (forall ((x capacity_range)) (! (in_range4 (to_rep6 x)) :pattern ((to_rep6 x)))))
(assert (forall ((x Int)) (! (=> (in_range4 x) (= (to_rep6 (of_rep6 x)) x)) :pattern ((to_rep6 (of_rep6 x))))))
(define-fun in_range10 ((rec__names__char_tables__vector__capacity1 Int) (a us_rep1)) Bool (= rec__names__char_tables__vector__capacity1 (to_rep6 (rec__names__char_tables__vector__capacity (us_split_discrs1 a)))))
...
(define-fun dynamic_invariant4 ((temp___expr_454 us_rep1) (temp___is_init_450 Bool) (temp___skip_constant_451 Bool) (temp___do_toplevel_452 Bool) (temp___do_typ_inv_453 Bool)) Bool (=> (not (= temp___skip_constant_451 true)) (in_range10 1024 temp___expr_454)))
(define-fun default_initial_assumption1 ((temp___expr_456 us_rep1) (temp___skip_top_level_457 Bool)) Bool (and (= (to_rep6 (rec__names__char_tables__vector__capacity (us_split_discrs1 temp___expr_456))) 1024) (=> (not (= temp___skip_top_level_457 true)) (= (is_empty1 temp___expr_456) true))))
(declare-const n Int)
...
(define-fun bool_eq5 ((x us_t1) (y us_t1)) Bool (bool_eq (elts1 x) (to_rep1 (first2 (rt1 x))) (to_rep1 (last4 (rt1 x))) (elts1 y) (to_rep1 (first2 (rt1 y))) (to_rep1 (last4 (rt1 y)))))
...
(define-fun dynamic_invariant5 ((temp___expr_651 us_t1) (temp___is_init_647 Bool) (temp___skip_constant_648 Bool) (temp___do_toplevel_649 Bool) (temp___do_typ_inv_650 Bool)) Bool (=> (not (= temp___skip_constant_648 true)) (and (dynamic_property2 1 l (first3 temp___expr_651) (last5 temp___expr_651)) (and (= (first3 temp___expr_651) 1) (= (last5 temp___expr_651) l)))))
...
(define-fun dynamic_invariant9 ((temp___expr_296 Int) (temp___is_init_292 Bool) (temp___skip_constant_293 Bool) (temp___do_toplevel_294 Bool) (temp___do_typ_inv_295 Bool)) Bool (=> (or (= temp___is_init_292 true) (<= 0 2147483646)) (in_range7 temp___expr_296)))
(assert (= l (to_rep2 (rec__names__name_entry__length (us_split_fields3 e)))))
...
(define-fun dynamic_invariant11 ((temp___expr_317 Int) (temp___is_init_313 Bool) (temp___skip_constant_314 Bool) (temp___do_toplevel_315 Bool) (temp___do_typ_inv_316 Bool)) Bool (=> (or (= temp___is_init_313 true) (<= (- 1) 2147483647)) (in_range15 temp___expr_317)))
(define-fun dynamic_invariant12 ((temp___expr_324 Int) (temp___is_init_320 Bool) (temp___skip_constant_321 Bool) (temp___do_toplevel_322 Bool) (temp___do_typ_inv_323 Bool)) Bool (=> (or (= temp___is_init_320 true) (<= 0 2147483647)) (in_range4 temp___expr_324)))
(define-fun capacity ((container us_rep1)) Int (ite (= (distinct 0 0) true) (to_rep6 (rec__names__char_tables__vector__capacity (us_split_discrs1 container))) 2147483647))
...
(assert (forall ((container us_rep1)) (! (let ((result (length4 container))) (and (<= result (capacity container)) (dynamic_invariant12 result true false true true))) :pattern ((length4 container)))))
(define-fun oeq ((left us_rep) (right us_rep)) Bool (and (= (length1 left) (length1 right)) (ite (forall ((n1 Int)) (=> (and (<= 0 n1) (<= n1 (last2 left))) (= (get left n1) (get right n1)))) true false)))
(declare-fun oeq__function_guard (Bool us_rep us_rep) Bool)
(assert (forall ((a us_rep) (b us_rep)) (! (= (user_eq4 a b) (oeq a b)) :pattern ((user_eq4 a b)))))
(define-fun default_initial_assumption2 ((temp___expr_363 us_rep) (temp___skip_top_level_364 Bool)) Bool (=> (not (= temp___skip_top_level_364 true)) (= (length1 temp___expr_363) 0)))
(assert (forall ((container us_rep1)) (! (= (length1 (model__ container)) (length4 container)) :pattern ((model__ container)))))
(assert (forall ((container us_rep1)) (! (= (= (is_empty1 container) true) (= (length4 container) 0)) :pattern ((is_empty1 container)))))
(define-fun dynamic_invariant13 ((temp___expr_303 Int) (temp___is_init_299 Bool) (temp___skip_constant_300 Bool) (temp___do_toplevel_301 Bool) (temp___do_typ_inv_302 Bool)) Bool (=> (or (= temp___is_init_299 true) (<= 0 2147483646)) (in_range12 temp___expr_303)))
...
(define-fun dynamic_invariant14 ((temp___expr_355 Int) (temp___is_init_351 Bool) (temp___skip_constant_352 Bool) (temp___do_toplevel_353 Bool) (temp___do_typ_inv_354 Bool)) Bool (=> (or (= temp___is_init_351 true) (<= (- 1) 2147483646)) (in_range16 temp___expr_355)))
(assert (forall ((container us_rep)) (! (let ((result (length1 container))) (and (<= (+ (- 1) result) 2147483646) (dynamic_invariant10 result true false true true))) :pattern ((length1 container)))))
...
(define-fun dynamic_invariant15 ((temp___expr_348 Int) (temp___is_init_344 Bool) (temp___skip_constant_345 Bool) (temp___do_toplevel_346 Bool) (temp___do_typ_inv_347 Bool)) Bool (=> (or (= temp___is_init_344 true) (<= 0 255)) (in_range17 temp___expr_348)))
(assert (forall ((container us_rep)) (forall ((position Int)) (! (=> (and (dynamic_invariant14 position true true true true) (and (<= 0 position) (<= position (last2 container)))) (dynamic_invariant15 (get container position) true false true true)) :pattern ((get container position))))))
...
(define-fun dynamic_invariant16 ((temp___expr_491 Int) (temp___is_init_487 Bool) (temp___skip_constant_488 Bool) (temp___do_toplevel_489 Bool) (temp___do_typ_inv_490 Bool)) Bool (=> (or (= temp___is_init_487 true) (<= 0 2147483647)) (in_range18 temp___expr_491)))
(define-fun dynamic_invariant17 ((temp___expr_498 Int) (temp___is_init_494 Bool) (temp___skip_constant_495 Bool) (temp___do_toplevel_496 Bool) (temp___do_typ_inv_497 Bool)) Bool (=> (or (= temp___is_init_494 true) (<= 0 2147483647)) (in_range8 temp___expr_498)))
(define-fun capacity1 ((container us_rep4)) Int (ite (= (distinct 0 0) true) (to_rep5 (rec__names__entry_tables__vector__capacity (us_split_discrs3 container))) 2147483647))
(declare-fun capacity__function_guard1 (Int us_rep4) Bool)
(declare-fun length5 (us_rep4) Int)
(declare-fun length__function_guard3 (Int us_rep4) Bool)
(assert (forall ((container us_rep4)) (! (let ((result (length5 container))) (and (<= result (capacity1 container)) (dynamic_invariant17 result true false true true))) :pattern ((length5 container)))))
(define-fun oeq1 ((left us_rep3) (right us_rep3)) Bool (and (= (length2 left) (length2 right)) (ite (forall ((n1 Int)) (=> (and (<= 1 n1) (<= n1 (last3 left))) (= (bool_eq3 (get1 left n1) (get1 right n1)) true))) true false)))
...
(define-fun default_initial_assumption3 ((temp___expr_540 us_rep3) (temp___skip_top_level_541 Bool)) Bool (=> (not (= temp___skip_top_level_541 true)) (= (length2 temp___expr_540) 0)))
(assert (forall ((container us_rep4)) (! (= (length2 (model__1 container)) (length5 container)) :pattern ((model__1 container)))))
(assert (forall ((container us_rep4)) (! (= (= (is_empty container) true) (= (length5 container) 0)) :pattern ((is_empty container)))))
(define-fun dynamic_invariant18 ((temp___expr_474 Int) (temp___is_init_470 Bool) (temp___skip_constant_471 Bool) (temp___do_toplevel_472 Bool) (temp___do_typ_inv_473 Bool)) Bool (=> (or (= temp___is_init_470 true) (<= 1 2147483647)) (in_range13 temp___expr_474)))
...
(declare-const dummy26 extended_index3)
...
(assert (= 1024 (to_rep6 (rec__names__char_tables__vector__capacity char_table__split_discrs))))
(assert (= 128 (to_rep5 (rec__names__entry_tables__vector__capacity entry_table__split_discrs))))
(assert (in_range6 n))
