...
(declare-fun temp___308 (Int) (Array Int integer))
(assert (forall ((temp___310 Int)) (= (select (temp___308 temp___310) 1) (of_rep temp___310))))
(declare-fun temp___312 (Int) (Array Int integer))
(assert (forall ((temp___314 Int)) (forall ((temp___315 Int)) (= (select (temp___312 temp___314) temp___315) (of_rep temp___314)))))
...
(assert (=> (= b 1) (= a1 (temp___308 one))))
(assert (=> (not (= b 1)) (= (mk_map__ref result1) a5)))
(assert (=> (not (= b 1)) (= a2 (temp___312 one))))
