...
(assert (< ib7 (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w)))))
(assert (and (= o17 (remove_swap b ib7 (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))))) (and (in_range3 o17) (=> (= (of_int o17) true) (= (let ((temp___157 (remove (remove b (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w)))) ib7))) (let ((temp___156 (remove (remove b ib7) (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1)))) (bool_eq (elts temp___156) (to_rep2 (first (rt temp___156))) (to_rep2 (last (rt temp___156))) (elts temp___157) (to_rep2 (first (rt temp___157))) (to_rep2 (last (rt temp___157)))))) true)))))
(assert (= result9 (mk_int__ref ih4)))
(assert (= ih5 o17))
...
(assert (and (= (mk___t o26 o27) (remove b ib7)) (and (dynamic_invariant2 (mk___t o26 o27) true false true) (and (= (invariant__ (mk___t o26 o27)) true) (and (= (to_rep2 (last o27)) (- (to_rep2 (last (rt b))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- ib7 1))) (= (to_rep (select (elts b) k1)) (to_rep (select o26 k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ ib7 1) k1) (<= k1 (to_rep2 (last (rt b))))) (= (to_rep (select (elts b) k1)) (to_rep (select o26 (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= ib7 k1) (<= k1 (- (to_rep2 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k1 1))) (to_rep (select o26 k1))))))))))))
(assert (and (= (mk___t o29 o30) (remove (mk___t o26 o27) o28)) (and (dynamic_invariant2 (mk___t o29 o30) true false true) (and (= (invariant__ (mk___t o29 o30)) true) (and (= (to_rep2 (last o30)) (- (to_rep2 (last o27)) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- o28 1))) (= (to_rep (select o26 k1)) (to_rep (select o29 k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ o28 1) k1) (<= k1 (to_rep2 (last o27)))) (= (to_rep (select o26 k1)) (to_rep (select o29 (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= o28 k1) (<= k1 (- (to_rep2 (last o27)) 1))) (= (to_rep (select o26 (+ k1 1))) (to_rep (select o29 k1))))))))))))
(assert (and (= (mk___t o24 o25) (remove bb ib7)) (and (dynamic_invariant2 (mk___t o24 o25) true false true) (and (= (invariant__ (mk___t o24 o25)) true) (and (= (to_rep2 (last o25)) (- (to_rep2 (last (rt bb))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- ib7 1))) (= (to_rep (select (elts bb) k1)) (to_rep (select o24 k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ ib7 1) k1) (<= k1 (to_rep2 (last (rt bb))))) (= (to_rep (select (elts bb) k1)) (to_rep (select o24 (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= ib7 k1) (<= k1 (- (to_rep2 (last (rt bb))) 1))) (= (to_rep (select (elts bb) (+ k1 1))) (to_rep (select o24 k1))))))))))))
...
(assert (and (= o18 ia3) (in_range4 ia3)))
(assert (and (= (mk___t o19 o20) (remove a o18)) (and (dynamic_invariant2 (mk___t o19 o20) true false true) (and (= (invariant__ (mk___t o19 o20)) true) (and (= (to_rep2 (last o20)) (- (to_rep2 (last (rt a))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- o18 1))) (= (to_rep (select (elts a) k1)) (to_rep (select o19 k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ o18 1) k1) (<= k1 (to_rep2 (last (rt a))))) (= (to_rep (select (elts a) k1)) (to_rep (select o19 (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= o18 k1) (<= k1 (- (to_rep2 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k1 1))) (to_rep (select o19 k1))))))))))))
(assert (and (= (mk___t o22 o23) (remove (mk___t o19 o20) o21)) (and (dynamic_invariant2 (mk___t o22 o23) true false true) (and (= (invariant__ (mk___t o22 o23)) true) (and (= (to_rep2 (last o23)) (- (to_rep2 (last o20)) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- o21 1))) (= (to_rep (select o19 k1)) (to_rep (select o22 k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ o21 1) k1) (<= k1 (to_rep2 (last o20)))) (= (to_rep (select o19 k1)) (to_rep (select o22 (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= o21 k1) (<= k1 (- (to_rep2 (last o20)) 1))) (= (to_rep (select o19 (+ k1 1))) (to_rep (select o22 k1))))))))))))
(assert (and (= o31 (shift_perm_r (mk___t o22 o23) (mk___t o24 o25) (mk___t o29 o30))) (and (in_range3 o31) (=> (= (of_int o31) true) (= (is_perm (mk___t o22 o23) (mk___t o29 o30)) true)))))
(assert (= result10 (mk_int__ref ih5)))
(assert (= ih6 o31))
(assert (= (of_int ih6) true))
(assert (and (= o40 (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1)) (in_range4 (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1))))
(assert (and (= (mk___t o38 o39) (remove b ib7)) (and (dynamic_invariant2 (mk___t o38 o39) true false true) (and (= (invariant__ (mk___t o38 o39)) true) (and (= (to_rep2 (last o39)) (- (to_rep2 (last (rt b))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- ib7 1))) (= (to_rep (select (elts b) k1)) (to_rep (select o38 k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ ib7 1) k1) (<= k1 (to_rep2 (last (rt b))))) (= (to_rep (select (elts b) k1)) (to_rep (select o38 (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= ib7 k1) (<= k1 (- (to_rep2 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k1 1))) (to_rep (select o38 k1))))))))))))
(assert (not (= (invariant__ (mk___t o38 o39)) true)))
(check-sat)
(exit)
