...
(assert (and (= o42 (remove a o10)) (and (dynamic_invariant2 o42 true false true) (and (= (invariant__ o42) true) (and (= (to_rep2 (last o12)) (- (to_rep2 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o10 1))) (= (to_rep (select (elts a) k)) (to_rep (select o11 k))))) (and (forall ((k Int)) (=> (and (<= (+ o10 1) k) (<= k (to_rep2 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select o11 (- k 1)))))) (forall ((k Int)) (=> (and (<= o10 k) (<= k (- (to_rep2 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select o11 k))))))))))))
(assert (and (= o41 (remove o42 o13)) (and (dynamic_invariant2 o41 true false true) (and (= (invariant__ o41) true) (and (= (to_rep2 (last o15)) (- (to_rep2 (last o12)) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o13 1))) (= (to_rep (select o11 k)) (to_rep (select o14 k))))) (and (forall ((k Int)) (=> (and (<= (+ o13 1) k) (<= k (to_rep2 (last o12)))) (= (to_rep (select o11 k)) (to_rep (select o14 (- k 1)))))) (forall ((k Int)) (=> (and (<= o13 k) (<= k (- (to_rep2 (last o12)) 1))) (= (to_rep (select o11 (+ k 1))) (to_rep (select o14 k))))))))))))
(assert (and (= o43 (remove bb ib1)) (and (dynamic_invariant2 o43 true false true) (and (= (invariant__ o43) true) (and (= (to_rep2 (last o9)) (- (to_rep2 (last (rt bb))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib1 1))) (= (to_rep (select (elts bb) k)) (to_rep (select o8 k))))) (and (forall ((k Int)) (=> (and (<= (+ ib1 1) k) (<= k (to_rep2 (last (rt bb))))) (= (to_rep (select (elts bb) k)) (to_rep (select o8 (- k 1)))))) (forall ((k Int)) (=> (and (<= ib1 k) (<= k (- (to_rep2 (last (rt bb))) 1))) (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select o8 k))))))))))))
(assert (and (= o5 ia1) (in_range4 ia1)))
(assert (and (= o44 (remove aa o5)) (and (dynamic_invariant2 o44 true false true) (and (= (invariant__ o44) true) (and (= (to_rep2 (last o7)) (- (to_rep2 (last (rt aa))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o5 1))) (= (to_rep (select (elts aa) k)) (to_rep (select o6 k))))) (and (forall ((k Int)) (=> (and (<= (+ o5 1) k) (<= k (to_rep2 (last (rt aa))))) (= (to_rep (select (elts aa) k)) (to_rep (select o6 (- k 1)))))) (forall ((k Int)) (=> (and (<= o5 k) (<= k (- (to_rep2 (last (rt aa))) 1))) (= (to_rep (select (elts aa) (+ k 1))) (to_rep (select o6 k))))))))))))
(assert (and (= o16 (shift_perm_l o44 o43 o41)) (and (in_range3 o16) (=> (= (of_int o16) true) (= (is_perm o41 o43) true)))))
...
(assert (and (= o37 (remove b ib1)) (and (dynamic_invariant2 o37 true false true) (and (= (invariant__ o37) true) (and (= (to_rep2 (last o27)) (- (to_rep2 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib1 1))) (= (to_rep (select (elts b) k)) (to_rep (select o26 k))))) (and (forall ((k Int)) (=> (and (<= (+ ib1 1) k) (<= k (to_rep2 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select o26 (- k 1)))))) (forall ((k Int)) (=> (and (<= ib1 k) (<= k (- (to_rep2 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o26 k))))))))))))
(assert (and (= o36 (remove o37 o28)) (and (dynamic_invariant2 o36 true false true) (and (= (invariant__ o36) true) (and (= (to_rep2 (last o30)) (- (to_rep2 (last o27)) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o28 1))) (= (to_rep (select o26 k)) (to_rep (select o29 k))))) (and (forall ((k Int)) (=> (and (<= (+ o28 1) k) (<= k (to_rep2 (last o27)))) (= (to_rep (select o26 k)) (to_rep (select o29 (- k 1)))))) (forall ((k Int)) (=> (and (<= o28 k) (<= k (- (to_rep2 (last o27)) 1))) (= (to_rep (select o26 (+ k 1))) (to_rep (select o29 k))))))))))))
(assert (and (= o38 (remove bb ib1)) (and (dynamic_invariant2 o38 true false true) (and (= (invariant__ o38) true) (and (= (to_rep2 (last o25)) (- (to_rep2 (last (rt bb))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib1 1))) (= (to_rep (select (elts bb) k)) (to_rep (select o24 k))))) (and (forall ((k Int)) (=> (and (<= (+ ib1 1) k) (<= k (to_rep2 (last (rt bb))))) (= (to_rep (select (elts bb) k)) (to_rep (select o24 (- k 1)))))) (forall ((k Int)) (=> (and (<= ib1 k) (<= k (- (to_rep2 (last (rt bb))) 1))) (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select o24 k))))))))))))
...
(assert (and (= o40 (remove a o18)) (and (dynamic_invariant2 o40 true false true) (and (= (invariant__ o40) true) (and (= (to_rep2 (last o20)) (- (to_rep2 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o18 1))) (= (to_rep (select (elts a) k)) (to_rep (select o19 k))))) (and (forall ((k Int)) (=> (and (<= (+ o18 1) k) (<= k (to_rep2 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select o19 (- k 1)))))) (forall ((k Int)) (=> (and (<= o18 k) (<= k (- (to_rep2 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select o19 k))))))))))))
(assert (and (= o39 (remove o40 o21)) (and (dynamic_invariant2 o39 true false true) (and (= (invariant__ o39) true) (and (= (to_rep2 (last o23)) (- (to_rep2 (last o20)) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o21 1))) (= (to_rep (select o19 k)) (to_rep (select o22 k))))) (and (forall ((k Int)) (=> (and (<= (+ o21 1) k) (<= k (to_rep2 (last o20)))) (= (to_rep (select o19 k)) (to_rep (select o22 (- k 1)))))) (forall ((k Int)) (=> (and (<= o21 k) (<= k (- (to_rep2 (last o20)) 1))) (= (to_rep (select o19 (+ k 1))) (to_rep (select o22 k))))))))))))
(assert (and (= o31 (shift_perm_r o39 o38 o36)) (and (in_range3 o31) (=> (= (of_int o31) true) (= (is_perm o39 o36) true)))))
...
(assert (and (= o35 (remove b ib1)) (and (dynamic_invariant2 o35 true false true) (and (= (invariant__ o35) true) (and (= (to_rep2 (last o33)) (- (to_rep2 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib1 1))) (= (to_rep (select (elts b) k)) (to_rep (select o32 k))))) (and (forall ((k Int)) (=> (and (<= (+ ib1 1) k) (<= k (to_rep2 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select o32 (- k 1)))))) (forall ((k Int)) (=> (and (<= ib1 k) (<= k (- (to_rep2 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o32 k))))))))))))
