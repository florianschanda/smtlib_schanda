...
(declare-const r5b2 Int)
(declare-const result5 Int)
(declare-const r8b2 Int)
(declare-const l2 Int)
(declare-const r5b3 Int)
...
(define-fun r5b10 () int__ref (mk_int__ref r5b))
(assert (in_range3 x))
(assert (in_range3 y))
...
(assert (=> (= result2 true) (and (= temp___197 (+ y l1)) (in_range1 (+ y l1)))))
(assert (=> (= result2 true) (and (<= 1 temp___197) (<= temp___197 1000))))
(assert (=> (= result2 true) (= o2 temp___197)))
(assert (=> (= result2 true) (= o3 (select a o2))))
(assert (=> (= result2 true) (= o4 (to_rep o3))))
(assert (=> (= result2 true) (and (= temp___196 (+ x l1)) (in_range1 (+ x l1)))))
(assert (=> (= result2 true) (and (<= 1 temp___196) (<= temp___196 1000))))
(assert (=> (= result2 true) (= o temp___196)))
...
(assert (=> (= result1 true) (= temp___190 r8b)))
(assert (=> (= result1 true) (= temp___189 r5b)))
(assert (=> (= result1 true) (= temp___188 l1)))
(assert (=> (= result1 true) (= 0 temp___195)))
(assert (=> (= result1 true) (and (= o8 (+ x l1)) (in_range1 (+ x l1)))))
(assert (=> (= result1 true) (= (mk_int__ref result4) r5b10)))
(assert (=> (= result1 true) (= r5b2 o8)))
(assert (=> (= result1 true) (in_range1 r5b2)))
(assert (=> (= result1 true) (and (= o9 (+ y l1)) (in_range1 (+ y l1)))))
(assert (=> (= result1 true) (= (mk_int__ref result5) r8b10)))
(assert (=> (= result1 true) (= r8b2 o9)))
(assert (=> (= result1 true) (in_range1 r8b2)))
(assert (=> (= result1 true) (= (bool_eq a (to_rep (first4 (mk2 x r5b3))) (to_rep (last4 (mk2 x r5b3))) a (to_rep (first6 (mk3 y r8b3))) (to_rep (last6 (mk3 y r8b3)))) true)))
(assert (=> (= result1 true) (and (and (and (and (=> (<= 0 2147483647) (in_range2 l2)) (=> (<= (- 2147483648) 2147483647) (in_range1 r5b3))) (=> (<= (- 2147483648) 2147483647) (in_range1 r8b3))) (= (+ x l2) r5b3)) (= (+ y l2) r8b3))))
(assert (=> (= result1 true) (= temp___1951 result6)))
(assert (=> (= result1 true) (= temp___1952 l2)))
(assert (=> (= result1 true) (and (= o10 (+ l2 1)) (in_range1 (+ l2 1)))))
(assert (=> (= result1 true) (= l2 result7)))
(assert (=> (= result1 true) (= l3 o10)))
(assert (=> (= result1 true) (and (= o18 (+ x l3)) (in_range1 (+ x l3)))))
(assert (=> (= result1 true) (= result10 (ite (<= o18 1000) true false))))
(assert (=> (= result1 true) (=> (= result10 true) (and (= o17 (+ y l3)) (in_range1 (+ y l3))))))
(assert (=> (= result1 true) (=> (= result10 true) (= result9 (ite (<= o17 1000) true false)))))
(assert (=> (= result1 true) (=> (not (= result10 true)) (= result9 false))))
(assert (=> (= result1 true) (=> (= result9 true) (and (= temp___1971 (+ y l3)) (in_range1 (+ y l3))))))
(assert (=> (= result1 true) (=> (= result9 true) (and (<= 1 temp___1971) (<= temp___1971 1000)))))
(assert (=> (= result1 true) (=> (= result9 true) (= o13 temp___1971))))
(assert (=> (= result1 true) (=> (= result9 true) (= o14 (select a o13)))))
(assert (=> (= result1 true) (=> (= result9 true) (= o15 (to_rep o14)))))
(assert (=> (= result1 true) (=> (= result9 true) (and (= temp___1961 (+ x l3)) (in_range1 (+ x l3))))))
(assert (=> (= result1 true) (=> (= result9 true) (and (<= 1 temp___1961) (<= temp___1961 1000)))))
(assert (=> (= result1 true) (=> (= result9 true) (= o11 temp___1961))))
(assert (=> (= result1 true) (=> (= result9 true) (= o12 (select a o11)))))
(assert (=> (= result1 true) (=> (= result9 true) (= o16 (to_rep o12)))))
(assert (=> (= result1 true) (=> (= result9 true) (= o19 (ite (= o16 o15) true false)))))
(assert (=> (= result1 true) (=> (not (= result9 true)) (= o19 false))))
(assert (=> (= result1 true) (= result8 (ite (not (= o19 true)) true false))))
(assert (=> (= result1 true) (= result8 true)))
(assert (=> (= result1 true) (= r8b4 (mk_int__ref r8b3))))
(assert (=> (= result1 true) (= r5b4 (mk_int__ref r5b3))))
(assert (=> (= result1 true) (= l3 l4)))
(assert (=> (= result1 true) (= r8b5 r8b3)))
(assert (=> (= result1 true) (= r5b5 r5b3)))
(assert (=> (= result1 true) (= l5 l3)))
(assert (=> (= result1 true) (= r8b6 r8b4)))
(assert (=> (= result1 true) (= r5b6 r5b4)))
(assert (=> (= result1 true) (= l6 (mk_int__ref l4))))
(assert (=> (= result1 true) (= r8b7 r8b5)))
(assert (=> (= result1 true) (= r5b7 r5b5)))
(assert (=> (= result1 true) (= l7 l5)))
(assert (=> (not (= result1 true)) (= r8b6 r8b10)))
(assert (=> (not (= result1 true)) (= r5b6 r5b10)))
(assert (=> (not (= result1 true)) (= l6 (mk_int__ref l1))))
(assert (=> (not (= result1 true)) (= r8b7 r8b1)))
(assert (=> (not (= result1 true)) (= r5b7 r5b1)))
(assert (=> (not (= result1 true)) (= l7 l1)))
(assert (= longest_common_prefix__lcp__result2 (mk_int__ref longest_common_prefix__lcp__result1)))
(assert (= longest_common_prefix__lcp__result3 longest_common_prefix__lcp__result1))
(assert (= result11 (mk_int__ref longest_common_prefix__lcp__result)))
(assert (= longest_common_prefix__lcp__result1 (int__content l6)))
(assert (= longest_common_prefix__lcp__result4 longest_common_prefix__lcp__result2))
(assert (= r8b8 r8b6))
(assert (= r5b8 r5b6))
(assert (= l8 l6))
...
(assert (= r5b9 r5b7))
(assert (= l9 l7))
(assert (=> (<= y (- (+ y (int__content longest_common_prefix__lcp__result4)) 1)) (and (and (<= 1 y) (<= y 1000)) (and (<= 1 (- (+ y (int__content longest_common_prefix__lcp__result4)) 1)) (<= (- (+ y (int__content longest_common_prefix__lcp__result4)) 1) 1000)))))
(assert (= o23 a))
(assert (= o23 temp___203))
(assert (= (mk1 y (- (+ y (int__content longest_common_prefix__lcp__result4)) 1)) temp___2031))
(assert (=> (<= x (- (+ x (int__content longest_common_prefix__lcp__result4)) 1)) (and (and (<= 1 x) (<= x 1000)) (and (<= 1 (- (+ x (int__content longest_common_prefix__lcp__result4)) 1)) (<= (- (+ x (int__content longest_common_prefix__lcp__result4)) 1) 1000)))))
(assert (= o24 a))
(assert (= o24 temp___202))
(assert (= (mk x (- (+ x (int__content longest_common_prefix__lcp__result4)) 1)) temp___2021))
(assert (= result12 (bool_eq temp___202 (to_rep (first temp___2021)) (to_rep (last temp___2021)) temp___203 (to_rep (first2 temp___2031)) (to_rep (last2 temp___2031)))))
(assert (= result12 true))
(assert (not (not (<= 1 (+ (int__content longest_common_prefix__lcp__result4) x)))))
(assert (not (not (<= (+ (int__content longest_common_prefix__lcp__result4) x) 1000))))
(assert (not (not (<= 1 (+ (int__content longest_common_prefix__lcp__result4) y)))))
(assert (not (not (<= (+ (int__content longest_common_prefix__lcp__result4) y) 1000))))
(assert (and (<= 1 (+ y (int__content longest_common_prefix__lcp__result4))) (<= (+ y (int__content longest_common_prefix__lcp__result4)) 1000)))
(assert (= o20 (+ y (int__content longest_common_prefix__lcp__result4))))
(assert (= o21 (select a o20)))
(assert (= o22 (to_rep o21)))
(assert (not (<= 1 (+ x (int__content longest_common_prefix__lcp__result4)))))
(check-sat)
(exit)
