...
(define-fun dynamic_invariant2 ((temp___expr_141 Int) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool (=> (or (= temp___is_init_138 true) (<= 1 1024)) (in_range5 temp___expr_141)))
...
(assert (and (= temp___266 (+ (to_rep1 (first (rt source))) (- i2 1))) (in_range1 (+ (to_rep1 (first (rt source))) (- i2 1)))))
(assert (not (<= (to_rep1 (first (rt source))) temp___266)))
(check-sat)
(exit)
