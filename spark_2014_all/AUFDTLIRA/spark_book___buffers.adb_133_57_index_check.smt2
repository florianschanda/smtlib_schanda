...
(define-fun dynamic_invariant2 ((temp___expr_165 Int) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool) (temp___do_typ_inv_164 Bool)) Bool (=> (or (= temp___is_init_161 true) (<= 1 1024)) (in_range5 temp___expr_165)))
...
(assert (=> (= result1 true) (and (= o1 (length source)) (in_range4 (length source)))))
(assert (=> (= result1 true) (= result2 characters_to_copy1)))
(assert (=> (= result1 true) (= characters_to_copy2 o1)))
(assert (=> (not (= result1 true)) (= characters_to_copy2 characters_to_copy1)))
(assert (=> (< 1024 (+ point (- characters_to_copy2 1))) (= result3 characters_to_copy2)))
(assert (=> (< 1024 (+ point (- characters_to_copy2 1))) (= characters_to_copy3 (+ (- 1024 point) 1))))
(assert (=> (not (< 1024 (+ point (- characters_to_copy2 1)))) (= characters_to_copy3 characters_to_copy2)))
(assert (= characters_to_copy3 r17b))
(assert (in_range4 r17b))
(assert (= result4 i))
(assert (= i1 1))
(assert (<= 1 i1))
(assert (<= i1 r17b))
(assert (and (<= 1 i2) (<= i2 r17b)))
(assert (and (= temp___294 (+ (to_rep1 (first (rt source))) (- i2 1))) (in_range1 (+ (to_rep1 (first (rt source))) (- i2 1)))))
(assert (not (<= (to_rep1 (first (rt source))) temp___294)))
(check-sat)
(exit)
