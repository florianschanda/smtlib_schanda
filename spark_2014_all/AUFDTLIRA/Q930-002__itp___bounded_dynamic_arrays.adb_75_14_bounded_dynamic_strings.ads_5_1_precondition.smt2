...
(assert (and (= o1 (length1 right)) (in_range1 (length1 right))))
(assert (= o2 (+ (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 left))) o1)))
(assert (not (<= (length1 (mk___t1 o9 o10)) o2)))
(check-sat)
(exit)
