...
(assert (=> (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last))) (= temp___255 a)))
(assert (=> (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last))) (= temp___253 i1)))
(assert (=> (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last))) (and (= o i1) (in_range2 i1))))
(assert (=> (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last))) (and (= (to_rep (select a2 o)) 0) (forall ((j1 Int)) (=> (and (<= (to_rep a__first) j1) (<= j1 (to_rep a__last))) (=> (not (= o j1)) (= (to_rep (select a2 j1)) (to_rep (select a j1)))))))))
(assert (=> (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last))) (forall ((j1 Int)) (=> (and (<= (to_rep a__first) j1) (<= j1 i2)) (= (to_rep (select a3 j1)) 0)))))
