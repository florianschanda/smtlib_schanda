...
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (bool_eq3 a2 90 99 (temp___2294 a i4 (temp___2300 (select a i4) i3 (temp___2307 (select (select a i4) i3) i2 (temp___2315 (select (select (select a i4) i3) i2) i1 e)))) 90 99) true)))
(check-sat)
(exit)
