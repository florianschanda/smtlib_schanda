...
(declare-fun temp_____aggregate_def_2294 ((Array Int (Array Int (Array Int (Array Int et1)))) Int (Array Int (Array Int (Array Int et1)))) (Array Int (Array Int (Array Int (Array Int et1)))))
(declare-fun temp_____aggregate_def_2300 ((Array Int (Array Int (Array Int et1))) Int (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1))))
(declare-fun temp_____aggregate_def_2307 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
(declare-fun temp_____aggregate_def_2315 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___2296 (Array Int (Array Int (Array Int (Array Int et1)))))) (forall ((temp___2297 Int)) (forall ((temp___2298 (Array Int (Array Int (Array Int et1))))) (let ((temp___2295 (temp_____aggregate_def_2294 temp___2296 temp___2297 temp___2298))) (=> (dynamic_invariant3 temp___2297 true true true true) (forall ((temp___2299 Int)) (ite (= temp___2299 temp___2297) (= (select temp___2295 temp___2299) temp___2298) (= (select temp___2295 temp___2299) (select temp___2296 temp___2299))))))))))
(assert (forall ((temp___2302 (Array Int (Array Int (Array Int et1))))) (forall ((temp___2303 Int)) (forall ((temp___2304 (Array Int (Array Int et1)))) (let ((temp___2301 (temp_____aggregate_def_2300 temp___2302 temp___2303 temp___2304))) (=> (dynamic_invariant2 temp___2303 true true true true) (forall ((temp___2305 Int)) (ite (= temp___2305 temp___2303) (= (select temp___2301 temp___2305) temp___2304) (= (select temp___2301 temp___2305) (select temp___2302 temp___2305))))))))))
(assert (forall ((temp___2309 (Array Int (Array Int et1)))) (forall ((temp___2310 Int)) (forall ((temp___2311 (Array Int et1))) (let ((temp___2308 (temp_____aggregate_def_2307 temp___2309 temp___2310 temp___2311))) (=> (dynamic_invariant1 temp___2310 true true true true) (forall ((temp___2312 Int)) (ite (= temp___2312 temp___2310) (= (select temp___2308 temp___2312) temp___2311) (= (select temp___2308 temp___2312) (select temp___2309 temp___2312))))))))))
(assert (forall ((temp___2317 (Array Int et1))) (forall ((temp___2318 Int) (temp___2319 Int)) (let ((temp___2316 (temp_____aggregate_def_2315 temp___2317 temp___2318 temp___2319))) (=> (and (dynamic_invariant temp___2318 true true true true) (dynamic_invariant4 temp___2319 true true true true)) (forall ((temp___2320 Int)) (ite (= temp___2320 temp___2318) (= (to_rep (select temp___2316 temp___2320)) temp___2319) (= (select temp___2316 temp___2320) (select temp___2317 temp___2320)))))))))
...
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (bool_eq3 a2 90 99 (temp_____aggregate_def_2294 a i4 (temp_____aggregate_def_2300 (select a i4) i3 (temp_____aggregate_def_2307 (select (select a i4) i3) i2 (temp_____aggregate_def_2315 (select (select (select a i4) i3) i2) i1 e)))) 90 99) true)))
(check-sat)
(exit)
