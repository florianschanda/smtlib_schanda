...
(declare-fun temp___2235 ((Array Int (Array Int (Array Int (Array Int et1)))) Int (Array Int (Array Int (Array Int et1)))) (Array Int (Array Int (Array Int (Array Int et1)))))
(assert (forall ((temp___2237 (Array Int (Array Int (Array Int (Array Int et1)))))) (forall ((temp___2238 Int)) (forall ((temp___2239 (Array Int (Array Int (Array Int et1))))) (let ((temp___2236 (temp___2235 temp___2237 temp___2238 temp___2239))) (forall ((temp___2240 Int)) (ite (= temp___2240 temp___2238) (= (select temp___2236 temp___2240) temp___2239) (= (select temp___2236 temp___2240) (select temp___2237 temp___2240)))))))))
(declare-fun temp___2241 ((Array Int (Array Int (Array Int et1))) Int (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1))))
(assert (forall ((temp___2243 (Array Int (Array Int (Array Int et1))))) (forall ((temp___2244 Int)) (forall ((temp___2245 (Array Int (Array Int et1)))) (let ((temp___2242 (temp___2241 temp___2243 temp___2244 temp___2245))) (forall ((temp___2246 Int)) (ite (= temp___2246 temp___2244) (= (select temp___2242 temp___2246) temp___2245) (= (select temp___2242 temp___2246) (select temp___2243 temp___2246)))))))))
(declare-fun temp___2248 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
(assert (forall ((temp___2250 (Array Int (Array Int et1)))) (forall ((temp___2251 Int)) (forall ((temp___2252 (Array Int et1))) (let ((temp___2249 (temp___2248 temp___2250 temp___2251 temp___2252))) (forall ((temp___2253 Int)) (ite (= temp___2253 temp___2251) (= (select temp___2249 temp___2253) temp___2252) (= (select temp___2249 temp___2253) (select temp___2250 temp___2253)))))))))
(declare-fun temp___2256 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___2258 (Array Int et1))) (forall ((temp___2259 Int) (temp___2260 Int)) (let ((temp___2257 (temp___2256 temp___2258 temp___2259 temp___2260))) (forall ((temp___2261 Int)) (ite (= temp___2261 temp___2259) (= (select temp___2257 temp___2261) (of_rep temp___2260)) (= (select temp___2257 temp___2261) (select temp___2258 temp___2261))))))))
...
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (bool_eq3 a2 90 99 (temp___2235 a i4 (temp___2241 (select a i4) i3 (temp___2248 (select (select a i4) i3) i2 (temp___2256 (select (select (select a i4) i3) i2) i1 e)))) 90 99) true)))
(check-sat)
(exit)
