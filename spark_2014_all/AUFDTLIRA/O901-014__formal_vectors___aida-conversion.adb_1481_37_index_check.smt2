...
(assert (and (= o16 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (= o19 (ite (<= o16 index) true false)))
(assert (= result (ite (= o19 true) o18 false)))
(assert (= (= o20 true) (forall ((index1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 7) index1) (<= index1 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index1))) true)))))
...
(assert (= o4 temp___1931))
(assert (= o5 (select (elts source) o4)))
(assert (= o6 (to_rep o5)))
(assert (= o7 (ite (= o6 52) true false)))
(assert (and (= temp___1930 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1930) (<= temp___1930 (to_rep1 (last (rt source))))))
(assert (= o temp___1930))
(assert (= o1 (select (elts source) o)))
(assert (= o2 (to_rep o1)))
(assert (= o3 (ite (= o2 55) true false)))
(assert (and (= temp___1929 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (not (<= (to_rep1 (first (rt source))) temp___1929)))
(check-sat)
(exit)
