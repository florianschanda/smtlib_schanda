...
(declare-const swap_ranges__swap_ranges_with_error__L_1__R41b Int)
(declare-const swap_ranges__swap_ranges_with_error__L_1__R38b Int)
...
(assert (=> (< k2 (to_rep a__last)) (let ((swap_ranges__swap_ranges_with_error__L_1__R41b1 (+ k2 1))) (let ((swap_ranges__swap_ranges_with_error__L_1__R38b1 (+ k2 1))) (= (bool_eq a (to_rep (first14 (mk7 swap_ranges__swap_ranges_with_error__L_1__R38b1 (to_rep a__last)))) (to_rep (last14 (mk7 swap_ranges__swap_ranges_with_error__L_1__R38b1 (to_rep a__last)))) a2 (to_rep (first16 (mk8 swap_ranges__swap_ranges_with_error__L_1__R41b1 (to_rep a__last)))) (to_rep (last16 (mk8 swap_ranges__swap_ranges_with_error__L_1__R41b1 (to_rep a__last))))) true)))))
...
(assert (and (= swap_ranges__swap_ranges_with_error__L_1__R41b (+ k2 1)) (in_range1 (+ k2 1))))
(assert (and (= swap_ranges__swap_ranges_with_error__L_1__R38b (+ k2 1)) (in_range1 (+ k2 1))))
(assert (<= swap_ranges__swap_ranges_with_error__L_1__R41b (to_rep a__last)))
(assert (not (<= (to_rep a__first) swap_ranges__swap_ranges_with_error__L_1__R41b)))
(check-sat)
(exit)
