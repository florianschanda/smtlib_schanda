...
(declare-fun temp_____aggregate_def_2847 ((Array Int us_rep) Int us_rep) (Array Int us_rep))
...
(assert (forall ((temp___2849 (Array Int us_rep))) (forall ((temp___2850 Int)) (forall ((temp___2851 us_rep)) (let ((temp___2848 (temp_____aggregate_def_2847 temp___2849 temp___2850 temp___2851))) (=> (dynamic_invariant temp___2850 true true true true) (forall ((temp___2852 Int)) (ite (= temp___2852 temp___2850) (= (select temp___2848 temp___2852) temp___2851) (= (select temp___2848 temp___2852) (select temp___2849 temp___2852))))))))))
...
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (bool_eq1 a2 1 10 (temp_____aggregate_def_2847 a i (mk___rep (mk___split_fields (of_rep f) (rec__ar__rec1t__g1 (us_split_fields1 (select a i)))))) 1 10) true)))
(check-sat)
(exit)
