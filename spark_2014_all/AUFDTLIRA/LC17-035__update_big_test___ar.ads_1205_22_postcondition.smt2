...
(declare-fun temp___2847 ((Array Int us_rep) Int us_rep) (Array Int us_rep))
...
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (bool_eq1 a2 1 10 (temp___2847 a i (mk___rep (mk___split_fields (of_rep f) (rec__ar__rec1t__g1 (us_split_fields1 (select a i)))))) 1 10) true)))
(check-sat)
(exit)
