...
(assert (forall ((temp___2790 (Array Int us_rep))) (forall ((temp___2791 Int)) (forall ((temp___2792 us_rep)) (let ((temp___2789 (temp___2788 temp___2790 temp___2791 temp___2792))) (forall ((temp___2793 Int)) (ite (= temp___2793 temp___2791) (= (select temp___2789 temp___2793) temp___2792) (= (select temp___2789 temp___2793) (select temp___2790 temp___2793)))))))))
...
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (bool_eq1 a2 1 10 (temp___2788 a i (mk___rep (mk___split_fields (of_rep f) (rec__ar__rec1t__g1 (us_split_fields1 (select a i)))))) 1 10) true)))
(check-sat)
(exit)
