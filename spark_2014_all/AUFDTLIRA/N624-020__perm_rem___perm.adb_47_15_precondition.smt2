...
(assert (= o22 (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 (witnesses__content perm__get_witnesses__result11))))))
...
(assert (= o20 (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 (witnesses__content perm__get_witnesses__result11))))))
(assert (= o21 (select (elts a) o20)))
(assert (= o25 (to_rep o21)))
(assert (= result6 (ite (= o25 o24) true false)))
(assert (= result6 true))
(assert (and (= o26 (remove b (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 (witnesses__content perm__get_witnesses__result11)))))) (and (dynamic_invariant o26 true false true true) (and (= (invariant__ o26) true) (and (= (to_rep2 (last o19)) (- (to_rep2 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 (witnesses__content perm__get_witnesses__result11)))) 1))) (= (to_rep (select (elts b) k)) (to_rep (select o18 k))))) (and (forall ((k Int)) (=> (and (<= (+ (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 (witnesses__content perm__get_witnesses__result11)))) 1) k) (<= k (to_rep2 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select o18 (- k 1)))))) (forall ((k Int)) (=> (and (<= (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 (witnesses__content perm__get_witnesses__result11)))) k) (<= k (- (to_rep2 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o18 k))))))))))))
