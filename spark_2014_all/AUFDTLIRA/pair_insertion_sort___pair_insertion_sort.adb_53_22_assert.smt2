...
(declare-const temp___329 (Array Int integer))
(declare-const temp___3291 t2)
(declare-const temp___330 (Array Int integer))
(declare-const temp___3301 t2)
...
(define-fun temp___3302 () us_t2 (mk___t2 temp___330 temp___3301))
...
(assert (= (slide values1 (to_rep values__first) (to_rep values__first)) temp___329))
(assert (= (mk2 (to_rep values__first) (to_rep values__last)) temp___3291))
(assert (= (to_rep (first4 temp___3291)) 0))
(assert (= temp___3302 (mk___t2 temp___329 temp___3291)))
(assert (= (ite (<= (to_rep (first4 temp___3301)) (to_rep (last4 temp___3301))) (+ (- (to_rep (last4 temp___3301)) (to_rep (first4 temp___3301))) 1) 0) (ite (<= (to_rep interm__first) (to_rep interm__last)) (+ (- (to_rep interm__last) (to_rep interm__first)) 1) 0)))
(assert (= (mk___t2 o9 o10) temp___3302))
(assert (= o11 o9))
...
(assert (and (<= (to_rep values__first) y) (<= y (to_rep values__last))))
(assert (= o13 y))
(assert (= temp___331 (store values1 o13 o12)))
(assert (= (to_rep values__first) 0))
(assert (= o14 temp___331))
(assert (= values1 result3))
(assert (= values2 o14))
(assert (not (= (is_set (mk___t interm1 (mk (to_rep interm__first) (to_rep interm__last))) y (to_rep (select (elts1 init) x)) (mk___t values2 (mk (to_rep values__first) (to_rep values__last)))) true)))
(check-sat)
(exit)
