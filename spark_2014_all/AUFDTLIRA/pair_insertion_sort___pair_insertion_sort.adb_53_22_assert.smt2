...
(assert true)
(assert (= (slide values1 (to_rep values__first) (to_rep values__first)) temp___299))
(assert (= (mk2 (to_rep values__first) (to_rep values__last)) temp___2991))
(assert (= (to_rep (first4 temp___2991)) 0))
(assert (= (mk___t2 temp___300 temp___3001) (mk___t2 temp___299 temp___2991)))
(assert (= (ite (<= (to_rep (first4 temp___3001)) (to_rep (last4 temp___3001))) (+ (- (to_rep (last4 temp___3001)) (to_rep (first4 temp___3001))) 1) 0) (ite (<= (to_rep interm__first) (to_rep interm__last)) (+ (- (to_rep interm__last) (to_rep interm__first)) 1) 0)))
(assert (= (mk___t2 o12 o13) (mk___t2 temp___300 temp___3001)))
(assert (= o14 o12))
...
(assert (and (<= (to_rep values__first) y) (<= y (to_rep values__last))))
(assert (= o16 y))
(assert (= temp___301 (store values1 o16 o15)))
(assert (= (to_rep values__first) 0))
(assert (= o17 temp___301))
