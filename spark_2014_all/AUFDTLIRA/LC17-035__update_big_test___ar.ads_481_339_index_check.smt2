...
(assert (=> (< 0 e) (= o13 (temp___1734 o12 i o11))))
(assert (=> (< 0 e) (and (<= 1 (+ k 1)) (<= (+ k 1) 16))))
(assert (=> (< 0 e) (= o9 (+ k 1))))
(assert (=> (< 0 e) (= o14 (select a o9))))
(assert (=> (< 0 e) (= o15 (temp___1727 o14 j o13))))
(assert (=> (< 0 e) (and (= o16 (+ k 1)) (in_range2 (+ k 1)))))
(assert (=> (< 0 e) (= temp___5421 (temp___1704 a k (temp___1712 (select a k) j (temp___1719 (select (select a k) j) i e)) o16 o15))))
