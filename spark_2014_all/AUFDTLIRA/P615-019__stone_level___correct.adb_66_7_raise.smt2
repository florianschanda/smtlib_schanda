...
(assert (=> (and (<= (to_rep1 (first (rt s))) j1) (<= j1 (to_rep1 (last (rt s))))) (and (<= (to_rep1 (first (rt s))) j2) (<= j2 (to_rep1 (last (rt s)))))))
(assert (=> (and (<= (to_rep1 (first (rt s))) j1) (<= j1 (to_rep1 (last (rt s))))) (not (= (to_rep (select (elts s) j2)) delim))))
(assert (=> (and (<= (to_rep1 (first (rt s))) j1) (<= j1 (to_rep1 (last (rt s))))) (=> (not (= (to_rep (select (elts s) j2)) delim)) (not (= (to_rep (select (elts s) j2)) c)))))
(assert (=> (and (<= (to_rep1 (first (rt s))) j1) (<= j1 (to_rep1 (last (rt s))))) (=> (not (= (to_rep (select (elts s) j2)) delim)) (= correct__find_before_delim__result3 correct__find_before_delim__result2))))
(assert (=> (and (<= (to_rep1 (first (rt s))) j1) (<= j1 (to_rep1 (last (rt s))))) (= j2 (to_rep1 (last (rt s))))))
(assert (=> (and (<= (to_rep1 (first (rt s))) j1) (<= j1 (to_rep1 (last (rt s))))) (= correct__find_before_delim__result3 correct__find_before_delim__result4)))
(assert (=> (and (<= (to_rep1 (first (rt s))) j1) (<= j1 (to_rep1 (last (rt s))))) (= j2 j3)))
(assert (=> (and (<= (to_rep1 (first (rt s))) j1) (<= j1 (to_rep1 (last (rt s))))) (= correct__find_before_delim__result5 correct__find_before_delim__result3)))
(assert (=> (and (<= (to_rep1 (first (rt s))) j1) (<= j1 (to_rep1 (last (rt s))))) (= j4 j2)))
(assert (=> (and (<= (to_rep1 (first (rt s))) j1) (<= j1 (to_rep1 (last (rt s))))) (= (mk_int__ref correct__find_before_delim__result6) (mk_int__ref correct__find_before_delim__result4))))
(assert (=> (and (<= (to_rep1 (first (rt s))) j1) (<= j1 (to_rep1 (last (rt s))))) (= (mk_int__ref j5) (mk_int__ref j3))))
(assert (=> (and (<= (to_rep1 (first (rt s))) j1) (<= j1 (to_rep1 (last (rt s))))) (= correct__find_before_delim__result7 correct__find_before_delim__result5)))
(assert (=> (and (<= (to_rep1 (first (rt s))) j1) (<= j1 (to_rep1 (last (rt s))))) (= j6 j4)))
(assert (=> (not (and (<= (to_rep1 (first (rt s))) j1) (<= j1 (to_rep1 (last (rt s)))))) (= (mk_int__ref correct__find_before_delim__result6) (mk_int__ref correct__find_before_delim__result))))
(assert (=> (not (and (<= (to_rep1 (first (rt s))) j1) (<= j1 (to_rep1 (last (rt s)))))) (= j1 j5)))
(assert (=> (not (and (<= (to_rep1 (first (rt s))) j1) (<= j1 (to_rep1 (last (rt s)))))) (= correct__find_before_delim__result7 correct__find_before_delim__result1)))
(assert (=> (not (and (<= (to_rep1 (first (rt s))) j1) (<= j1 (to_rep1 (last (rt s)))))) (= j6 j1)))
(assert (not false))
(check-sat)
(exit)
