...
(assert (= result4 true))
(assert (not (<= i (to_rep1 (last6 (rt3 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 (us_split_fields__content4 current__split_fields6))))))))))
(check-sat)
(exit)
