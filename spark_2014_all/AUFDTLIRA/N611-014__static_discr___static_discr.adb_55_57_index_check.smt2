...
(assert (and (= o10 (+ (to_rep (rec__static_discr__holder__length1 (us_split_fields__content4 current__split_fields6))) 1)) (in_range1 (+ (to_rep (rec__static_discr__holder__length1 (us_split_fields__content4 current__split_fields6))) 1))))
(assert (= o11 (ite (<= o10 i) true false)))
(assert (= result4 (ite (= o11 true) (ite (<= i (to_rep current__split_fields4)) true false) false)))
(assert (= result4 true))
(assert (not (<= (to_rep1 (first4 (rt2 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 (us_split_fields__content4 current__split_fields6))))))) i)))
(check-sat)
(exit)
