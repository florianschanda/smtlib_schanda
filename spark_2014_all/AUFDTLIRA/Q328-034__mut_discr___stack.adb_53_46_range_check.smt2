...
(assert (= last3 o1))
(assert (and (= (mk___t temp___181 temp___1811) (to_string1 (mk___rep (mk___split_fields v__split_fields1)))) (dynamic_invariant2 (mk___t temp___181 temp___1811) true false true)))
(assert (=> (<= (to_rep1 (first temp___1811)) (to_rep1 (last temp___1811))) (= o2 (+ (- (to_rep1 (last temp___1811)) (to_rep1 (first temp___1811))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___1811)) (to_rep1 (last temp___1811)))) (= o2 0)))
