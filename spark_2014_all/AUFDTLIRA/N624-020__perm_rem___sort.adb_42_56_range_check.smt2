...
(assert (and (= temp___2502 (remove o28 o27)) (and (dynamic_invariant4 temp___2502 true false true) (and (= (invariant__ temp___2502) true) (and (= (to_rep1 (last temp___2501)) (- (to_rep1 (last o26)) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o27 1))) (= (to_rep (select o25 k)) (to_rep (select temp___250 k))))) (and (forall ((k Int)) (=> (and (<= (+ o27 1) k) (<= k (to_rep1 (last o26)))) (= (to_rep (select o25 k)) (to_rep (select temp___250 (- k 1)))))) (forall ((k Int)) (=> (and (<= o27 k) (<= k (- (to_rep1 (last o26)) 1))) (= (to_rep (select o25 (+ k 1))) (to_rep (select temp___250 k))))))))))))
