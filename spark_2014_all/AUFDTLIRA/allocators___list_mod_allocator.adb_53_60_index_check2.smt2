...
(assert (=> (= result2 true) (=> (not (= first_available 0)) (and (= o6 (length (rec__list_mod_allocator__m__t__available (us_split_fields1 m)))) (and (in_range2 o6) (<= (+ 0 o6) 2147483647))))))
(assert (=> (= result2 true) (=> (not (= first_available 0)) (= result3 (ite (< 0 o6) true false)))))
(assert (=> (= result2 true) (=> (not (= first_available 0)) (=> (= result3 true) (and (= o5 (get (rec__list_mod_allocator__m__t__available (us_split_fields1 m)) 1)) (in_range3 o5))))))
(assert (=> (= result2 true) (=> (not (= first_available 0)) (=> (= result3 true) (= result1 (ite (= o5 first_available) true false))))))
(assert (=> (= result2 true) (=> (not (= first_available 0)) (=> (not (= result3 true)) (= result1 false)))))
(assert (=> (= result2 true) (=> (not (not (= first_available 0))) (and (= o7 (length (rec__list_mod_allocator__m__t__available (us_split_fields1 m)))) (and (in_range2 o7) (<= (+ 0 o7) 2147483647))))))
(assert (=> (= result2 true) (=> (not (not (= first_available 0))) (= result1 (ite (= o7 0) true false)))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (=> (= result1 true) (and (= o3 (length (rec__list_mod_allocator__m__t__available (us_split_fields1 m)))) (and (in_range2 o3) (<= (+ 0 o3) 2147483647)))))
(assert (=> (= result1 true) (= o4 (ite (<= j1 o3) true false))))
(assert (=> (= result1 true) (= result4 (ite (<= 1 j1) o4 false))))
(assert (=> (= result1 true) (= (= result true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 (length (rec__list_mod_allocator__m__t__available (us_split_fields1 m))))) (and (in_range7 (get (rec__list_mod_allocator__m__t__available (us_split_fields1 m)) j2)) (=> (< j2 (length (rec__list_mod_allocator__m__t__available (us_split_fields1 m)))) (= (to_rep (rec__list_mod_allocator__cell__next (us_split_fields3 (select data (get (rec__list_mod_allocator__m__t__available (us_split_fields1 m)) j2))))) (get (rec__list_mod_allocator__m__t__available (us_split_fields1 m)) (+ j2 1))))))))))
...
(assert (= result5 true))
(assert (< 1 j))
(assert (and (= o2 (get (rec__list_mod_allocator__m__t__available (us_split_fields1 m)) (- j 1))) (in_range3 o2)))
(assert (= result6 (ite (in_range7 o2) true false)))
(assert (= result6 true))
(assert (and (= temp___316 (get (rec__list_mod_allocator__m__t__available (us_split_fields1 m)) (- j 1))) (in_range3 temp___316)))
(assert (not (<= 1 temp___316)))
(check-sat)
(exit)
