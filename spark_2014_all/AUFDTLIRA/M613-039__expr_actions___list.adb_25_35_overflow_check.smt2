...
(assert (<= first2 i1))
(assert (<= i1 last3))
(assert (and (= o i1) (in_range4 i1)))
(assert (and (= o1 (get (model__ l) o)) (and (in_range7 o1) (= o1 (get (model__ l) o)))))
(assert (and (= (top (mk___rep s__split_fields2)) o1) (= (let ((temp___181 (to__ (mk___rep (mk___split_fields s__split_fields s__split_fields1))))) (let ((temp___180 (to_but_top (mk___rep s__split_fields2)))) (bool_eq (elts temp___180) (to_rep (first (rt temp___180))) (to_rep (last (rt temp___180))) (elts temp___181) (to_rep (first (rt temp___181))) (to_rep (last (rt temp___181)))))) true)))
(assert (and (= (to_rep (last (rt (to__ (mk___rep s__split_fields3))))) (+ (- i2 first2) 1)) (forall ((j Int)) (=> (and (<= first2 j) (<= j i2)) (= (to_rep (select (elts (to__ (mk___rep s__split_fields3))) j)) (get (model__ l) j))))))
(assert (and (=> (<= first2 last3) (dynamic_property1 first2 last3 i2)) (and (<= first2 i2) (<= i2 last3))))
(assert (not (in_range1 (- i2 first2))))
(check-sat)
(exit)
