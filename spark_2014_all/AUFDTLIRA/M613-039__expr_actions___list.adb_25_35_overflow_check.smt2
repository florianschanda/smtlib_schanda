...
(assert (and (= (top (mk___rep s__split_fields2)) o1) (= (let ((temp___208 (to__ (mk___rep (mk___split_fields s__split_fields s__split_fields1))))) (let ((temp___207 (to_but_top (mk___rep s__split_fields2)))) (bool_eq (elts temp___207) (to_rep (first (rt temp___207))) (to_rep (last (rt temp___207))) (elts temp___208) (to_rep (first (rt temp___208))) (to_rep (last (rt temp___208)))))) true)))
