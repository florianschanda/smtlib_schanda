...
(assert (<= first2 i3))
(assert (<= i3 last3))
(assert (and (= o i3) (in_range4 i3)))
(assert (and (= o1 (get (model__ l) o)) (and (in_range7 o1) (= o1 (get (model__ l) o)))))
(assert (and (= (top (mk___rep s__split_fields3)) o1) (= (let ((temp___181 (to__ (mk___rep (mk___split_fields s__split_fields s__split_fields1))))) (let ((temp___180 (to_but_top (mk___rep s__split_fields3)))) (bool_eq (elts temp___180) (to_rep (first (rt temp___180))) (to_rep (last (rt temp___180))) (elts temp___181) (to_rep (first (rt temp___181))) (to_rep (last (rt temp___181)))))) true)))
(assert (and (= (to_rep (last (rt (to__ (mk___rep s__split_fields4))))) (+ (- i4 first2) 1)) (forall ((j2 Int)) (=> (and (<= first2 j2) (<= j2 i4)) (= (to_rep (select (elts (to__ (mk___rep s__split_fields4))) j2)) (get (model__ l) j2))))))
(assert (and (=> (<= first2 last3) (dynamic_property1 first2 last3 i4)) (and (<= first2 i4) (<= i4 last3))))
(assert (not (in_range1 (- i4 first2))))
(check-sat)
(exit)
