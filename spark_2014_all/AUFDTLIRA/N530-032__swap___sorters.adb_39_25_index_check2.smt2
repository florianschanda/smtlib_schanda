...
(assert (and (and (<= (to_rep (first (rt unsorted))) min2) (<= min2 (to_rep (last (rt unsorted))))) (forall ((j1 Int)) (=> (and (<= (to_rep (first (rt unsorted))) j1) (<= j1 (- index2 1))) (<= (to_rep (select (elts unsorted) min2)) (to_rep (select (elts unsorted) j1)))))))
