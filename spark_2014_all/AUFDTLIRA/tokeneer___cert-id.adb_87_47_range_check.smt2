...
(define-fun to_rep3 ((x unsigned32t)) Int (unsigned32tqtint x))
(declare-fun of_rep3 (Int) unsigned32t)
(assert (forall ((x unsigned32t)) (! (= (of_rep3 (to_rep3 x)) x) :pattern ((to_rep3 x)))))
(assert (forall ((x unsigned32t)) (! (in_range4 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__certprocessing__timet__year unsigned32t) (rec__certprocessing__timet__month unsigned32t) (rec__certprocessing__timet__day unsigned32t) (rec__certprocessing__timet__hour unsigned32t) (rec__certprocessing__timet__minute unsigned32t)))))
(define-fun us_split_fields_Year__projection ((a us_split_fields2)) unsigned32t (rec__certprocessing__timet__year a))
(define-fun us_split_fields_Month__projection ((a us_split_fields2)) unsigned32t (rec__certprocessing__timet__month a))
(define-fun us_split_fields_Day__projection ((a us_split_fields2)) unsigned32t (rec__certprocessing__timet__day a))
(define-fun us_split_fields_Hour__projection ((a us_split_fields2)) unsigned32t (rec__certprocessing__timet__hour a))
(define-fun us_split_fields_Minute__projection ((a us_split_fields2)) unsigned32t (rec__certprocessing__timet__minute a))
...
(define-fun bool_eq2 ((a us_rep1) (b us_rep1)) Bool (ite (and (and (and (and (= (to_rep3 (rec__certprocessing__timet__year (us_split_fields3 a))) (to_rep3 (rec__certprocessing__timet__year (us_split_fields3 b)))) (= (to_rep3 (rec__certprocessing__timet__month (us_split_fields3 a))) (to_rep3 (rec__certprocessing__timet__month (us_split_fields3 b))))) (= (to_rep3 (rec__certprocessing__timet__day (us_split_fields3 a))) (to_rep3 (rec__certprocessing__timet__day (us_split_fields3 b))))) (= (to_rep3 (rec__certprocessing__timet__hour (us_split_fields3 a))) (to_rep3 (rec__certprocessing__timet__hour (us_split_fields3 b))))) (= (to_rep3 (rec__certprocessing__timet__minute (us_split_fields3 a))) (to_rep3 (rec__certprocessing__timet__minute (us_split_fields3 b))))) true false))
...
(declare-datatypes () ((us_split_fields4 (mk___split_fields2 (rec__certprocessing__validityt__notbefore us_rep1) (rec__certprocessing__validityt__notafter us_rep1)))))
(define-fun us_split_fields_NotBefore__projection ((a us_split_fields4)) us_rep1 (rec__certprocessing__validityt__notbefore a))
(define-fun us_split_fields_NotAfter__projection ((a us_split_fields4)) us_rep1 (rec__certprocessing__validityt__notafter a))
...
(define-fun bool_eq3 ((a us_rep2) (b us_rep2)) Bool (ite (and (= (bool_eq2 (rec__certprocessing__validityt__notbefore (us_split_fields5 a)) (rec__certprocessing__validityt__notbefore (us_split_fields5 b))) true) (= (bool_eq2 (rec__certprocessing__validityt__notafter (us_split_fields5 a)) (rec__certprocessing__validityt__notafter (us_split_fields5 b))) true)) true false))
...
(declare-datatypes () ((validityt__ref (mk_validityt__ref (validityt__content us_rep2)))))
(define-fun validityt__ref___projection ((a validityt__ref)) us_rep2 (validityt__content a))
(declare-datatypes () ((us_split_fields6 (mk___split_fields3 (rec__certprocessing__publickeyinfot__algorithmid algorithmt) (rec__certprocessing__publickeyinfot__keyid unsigned32t) (rec__certprocessing__publickeyinfot__keylength unsigned32t)))))
(define-fun us_split_fields_AlgorithmId__projection ((a us_split_fields6)) algorithmt (rec__certprocessing__publickeyinfot__algorithmid a))
(define-fun us_split_fields_KeyID__2__projection ((a us_split_fields6)) unsigned32t (rec__certprocessing__publickeyinfot__keyid a))
(define-fun us_split_fields_KeyLength__2__projection ((a us_split_fields6)) unsigned32t (rec__certprocessing__publickeyinfot__keylength a))
...
(define-fun bool_eq4 ((a us_rep3) (b us_rep3)) Bool (ite (and (and (= (to_rep4 (rec__certprocessing__publickeyinfot__algorithmid (us_split_fields7 a))) (to_rep4 (rec__certprocessing__publickeyinfot__algorithmid (us_split_fields7 b)))) (= (to_rep3 (rec__certprocessing__publickeyinfot__keyid (us_split_fields7 a))) (to_rep3 (rec__certprocessing__publickeyinfot__keyid (us_split_fields7 b))))) (= (to_rep3 (rec__certprocessing__publickeyinfot__keylength (us_split_fields7 a))) (to_rep3 (rec__certprocessing__publickeyinfot__keylength (us_split_fields7 b))))) true false))
...
(declare-datatypes () ((publickeyinfot__ref (mk_publickeyinfot__ref (publickeyinfot__content us_rep3)))))
(define-fun publickeyinfot__ref___projection ((a publickeyinfot__ref)) us_rep3 (publickeyinfot__content a))
(declare-datatypes () ((us_split_fields8 (mk___split_fields4 (rec__certprocessing__idcertdatat__serialnumber unsigned32t) (rec__certprocessing__idcertdatat__sigalgid algorithmt) (rec__certprocessing__idcertdatat__issuer us_rep) (rec__certprocessing__idcertdatat__validity us_rep2) (rec__certprocessing__idcertdatat__subject us_rep) (rec__certprocessing__idcertdatat__subjectpublickeyinfo us_rep3)))))
(define-fun us_split_fields_SerialNumber__2__projection ((a us_split_fields8)) unsigned32t (rec__certprocessing__idcertdatat__serialnumber a))
(define-fun us_split_fields_SigAlgId__projection ((a us_split_fields8)) algorithmt (rec__certprocessing__idcertdatat__sigalgid a))
(define-fun us_split_fields_Issuer__2__projection ((a us_split_fields8)) us_rep (rec__certprocessing__idcertdatat__issuer a))
(define-fun us_split_fields_Validity__projection ((a us_split_fields8)) us_rep2 (rec__certprocessing__idcertdatat__validity a))
(define-fun us_split_fields_Subject__projection ((a us_split_fields8)) us_rep (rec__certprocessing__idcertdatat__subject a))
(define-fun us_split_fields_SubjectPublicKeyInfo__projection ((a us_split_fields8)) us_rep3 (rec__certprocessing__idcertdatat__subjectpublickeyinfo a))
...
(define-fun bool_eq5 ((a us_rep4) (b us_rep4)) Bool (ite (and (and (and (and (and (= (to_rep3 (rec__certprocessing__idcertdatat__serialnumber (us_split_fields9 a))) (to_rep3 (rec__certprocessing__idcertdatat__serialnumber (us_split_fields9 b)))) (= (to_rep4 (rec__certprocessing__idcertdatat__sigalgid (us_split_fields9 a))) (to_rep4 (rec__certprocessing__idcertdatat__sigalgid (us_split_fields9 b))))) (= (bool_eq1 (rec__certprocessing__idcertdatat__issuer (us_split_fields9 a)) (rec__certprocessing__idcertdatat__issuer (us_split_fields9 b))) true)) (= (bool_eq3 (rec__certprocessing__idcertdatat__validity (us_split_fields9 a)) (rec__certprocessing__idcertdatat__validity (us_split_fields9 b))) true)) (= (bool_eq1 (rec__certprocessing__idcertdatat__subject (us_split_fields9 a)) (rec__certprocessing__idcertdatat__subject (us_split_fields9 b))) true)) (= (bool_eq4 (rec__certprocessing__idcertdatat__subjectpublickeyinfo (us_split_fields9 a)) (rec__certprocessing__idcertdatat__subjectpublickeyinfo (us_split_fields9 b))) true)) true false))
...
(declare-datatypes () ((idcertdatat__ref (mk_idcertdatat__ref (idcertdatat__content us_rep4)))))
(define-fun idcertdatat__ref___projection ((a idcertdatat__ref)) us_rep4 (idcertdatat__content a))
...
(assert (forall ((x yearst)) (! (in_range6 (to_rep5 x)) :pattern ((to_rep5 x)))))
...
(assert (forall ((x monthst)) (! (in_range7 (to_rep6 x)) :pattern ((to_rep6 x)))))
...
(assert (forall ((x dayst)) (! (in_range8 (to_rep7 x)) :pattern ((to_rep7 x)))))
...
(assert (forall ((x millisecst)) (! (in_range9 (to_rep8 x)) :pattern ((to_rep8 x)))))
...
(define-fun us_split_fields_Year__2__projection ((a us_split_fields10)) yearst (rec__clock__timet__year a))
(define-fun us_split_fields_Month__2__projection ((a us_split_fields10)) monthst (rec__clock__timet__month a))
(define-fun us_split_fields_Day__2__projection ((a us_split_fields10)) dayst (rec__clock__timet__day a))
...
(define-fun bool_eq6 ((a us_rep5) (b us_rep5)) Bool (ite (and (and (and (= (to_rep5 (rec__clock__timet__year (us_split_fields11 a))) (to_rep5 (rec__clock__timet__year (us_split_fields11 b)))) (= (to_rep6 (rec__clock__timet__month (us_split_fields11 a))) (to_rep6 (rec__clock__timet__month (us_split_fields11 b))))) (= (to_rep7 (rec__clock__timet__day (us_split_fields11 a))) (to_rep7 (rec__clock__timet__day (us_split_fields11 b))))) (= (to_rep8 (rec__clock__timet__millisec (us_split_fields11 a))) (to_rep8 (rec__clock__timet__millisec (us_split_fields11 b))))) true false))
...
(declare-datatypes () ((timet__ref1 (mk_timet__ref1 (timet__content1 us_rep5)))))
(define-fun timet__ref___2__projection ((a timet__ref1)) us_rep5 (timet__content1 a))
...
(assert (forall ((x serialnumbert)) (! (in_range10 (to_rep9 x)) :pattern ((to_rep9 x)))))
(assert (forall ((x Int)) (! (=> (in_range10 x) (= (to_rep9 (of_rep9 x)) x)) :pattern ((to_rep9 (of_rep9 x))))))
(declare-datatypes () ((us_split_fields12 (mk___split_fields6 (rec__certtypes__idt__issuer us_rep) (rec__certtypes__idt__serialnumber serialnumbert)))))
(define-fun us_split_fields_Issuer__projection ((a us_split_fields12)) us_rep (rec__certtypes__idt__issuer a))
...
(define-fun us_rep___5__projection ((a us_rep6)) us_split_fields12 (us_split_fields13 a))
(define-fun bool_eq7 ((a us_rep6) (b us_rep6)) Bool (ite (and (= (bool_eq1 (rec__certtypes__idt__issuer (us_split_fields13 a)) (rec__certtypes__idt__issuer (us_split_fields13 b))) true) (= (to_rep9 (rec__certtypes__idt__serialnumber (us_split_fields13 a))) (to_rep9 (rec__certtypes__idt__serialnumber (us_split_fields13 b))))) true false))
...
(define-fun to_rep10 ((x keyidt)) Int (keyidtqtint x))
(declare-fun of_rep10 (Int) keyidt)
(assert (forall ((x keyidt)) (! (= (of_rep10 (to_rep10 x)) x) :pattern ((to_rep10 x)))))
(assert (forall ((x keyidt)) (! (in_range11 (to_rep10 x)) :pattern ((to_rep10 x)))))
...
(define-fun to_rep11 ((x keylengtht)) Int (keylengthtqtint x))
(declare-fun of_rep11 (Int) keylengtht)
(assert (forall ((x keylengtht)) (! (= (of_rep11 (to_rep11 x)) x) :pattern ((to_rep11 x)))))
(assert (forall ((x keylengtht)) (! (in_range12 (to_rep11 x)) :pattern ((to_rep11 x)))))
...
(define-fun us_rep___2__projection ((a us_rep7)) us_split_fields14 (us_split_fields15 a))
(define-fun bool_eq8 ((a us_rep7) (b us_rep7)) Bool (ite (and (and (= (to_rep4 (rec__cryptotypes__keypartt__algorithmid (us_split_fields15 a))) (to_rep4 (rec__cryptotypes__keypartt__algorithmid (us_split_fields15 b)))) (= (to_rep10 (rec__cryptotypes__keypartt__keyid (us_split_fields15 a))) (to_rep10 (rec__cryptotypes__keypartt__keyid (us_split_fields15 b))))) (= (to_rep11 (rec__cryptotypes__keypartt__keylength (us_split_fields15 a))) (to_rep11 (rec__cryptotypes__keypartt__keylength (us_split_fields15 b))))) true false))
...
(declare-datatypes () ((us_split_fields16 (mk___split_fields8 (rec__cert__id__contentst__id us_rep6) (rec__cert__id__contentst__notbefore us_rep5) (rec__cert__id__contentst__notafter us_rep5) (rec__cert__id__contentst__mechanism algorithmt) (rec__cert__id__contentst__subject us_rep) (rec__cert__id__contentst__subjectpublickey us_rep7)))))
(define-fun us_split_fields_ID__4__projection ((a us_split_fields16)) us_rep6 (rec__cert__id__contentst__id a))
(define-fun us_split_fields_NotBefore__3__projection ((a us_split_fields16)) us_rep5 (rec__cert__id__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__3__projection ((a us_split_fields16)) us_rep5 (rec__cert__id__contentst__notafter a))
...
(define-fun us_split_fields_SubjectPublicKey__projection ((a us_split_fields16)) us_rep7 (rec__cert__id__contentst__subjectpublickey a))
...
(define-fun bool_eq9 ((a us_rep8) (b us_rep8)) Bool (ite (and (and (and (and (and (= (bool_eq7 (rec__cert__id__contentst__id (us_split_fields17 a)) (rec__cert__id__contentst__id (us_split_fields17 b))) true) (= (bool_eq6 (rec__cert__id__contentst__notbefore (us_split_fields17 a)) (rec__cert__id__contentst__notbefore (us_split_fields17 b))) true)) (= (bool_eq6 (rec__cert__id__contentst__notafter (us_split_fields17 a)) (rec__cert__id__contentst__notafter (us_split_fields17 b))) true)) (= (to_rep4 (rec__cert__id__contentst__mechanism (us_split_fields17 a))) (to_rep4 (rec__cert__id__contentst__mechanism (us_split_fields17 b))))) (= (bool_eq1 (rec__cert__id__contentst__subject (us_split_fields17 a)) (rec__cert__id__contentst__subject (us_split_fields17 b))) true)) (= (bool_eq8 (rec__cert__id__contentst__subjectpublickey (us_split_fields17 a)) (rec__cert__id__contentst__subjectpublickey (us_split_fields17 b))) true)) true false))
...
(define-fun dynamic_invariant1 ((temp___expr_193 Int) (temp___is_init_189 Bool) (temp___skip_constant_190 Bool) (temp___do_toplevel_191 Bool) (temp___do_typ_inv_192 Bool)) Bool (=> (or (= temp___is_init_189 true) (<= 0 4294967295)) (in_range4 temp___expr_193)))
(define-fun dynamic_invariant2 ((temp___expr_933 Int) (temp___is_init_929 Bool) (temp___skip_constant_930 Bool) (temp___do_toplevel_931 Bool) (temp___do_typ_inv_932 Bool)) Bool (=> (or (= temp___is_init_929 true) (<= 1901 2099)) (in_range6 temp___expr_933)))
(define-fun dynamic_invariant3 ((temp___expr_940 Int) (temp___is_init_936 Bool) (temp___skip_constant_937 Bool) (temp___do_toplevel_938 Bool) (temp___do_typ_inv_939 Bool)) Bool (=> (or (= temp___is_init_936 true) (<= 1 12)) (in_range7 temp___expr_940)))
(define-fun dynamic_invariant4 ((temp___expr_947 Int) (temp___is_init_943 Bool) (temp___skip_constant_944 Bool) (temp___do_toplevel_945 Bool) (temp___do_typ_inv_946 Bool)) Bool (=> (or (= temp___is_init_943 true) (<= 1 31)) (in_range8 temp___expr_947)))
(define-fun dynamic_invariant5 ((temp___expr_979 Int) (temp___is_init_975 Bool) (temp___skip_constant_976 Bool) (temp___do_toplevel_977 Bool) (temp___do_typ_inv_978 Bool)) Bool (=> (or (= temp___is_init_975 true) (<= 0 86399999)) (in_range9 temp___expr_979)))
(define-fun dynamic_invariant6 ((temp___expr_402 Int) (temp___is_init_398 Bool) (temp___skip_constant_399 Bool) (temp___do_toplevel_400 Bool) (temp___do_typ_inv_401 Bool)) Bool (=> (or (= temp___is_init_398 true) (<= 0 40)) (in_range1 temp___expr_402)))
(define-fun dynamic_invariant7 ((temp___expr_426 Int) (temp___is_init_422 Bool) (temp___skip_constant_423 Bool) (temp___do_toplevel_424 Bool) (temp___do_typ_inv_425 Bool)) Bool (=> (or (= temp___is_init_422 true) (<= 0 4294967295)) (in_range3 temp___expr_426)))
...
(define-fun dynamic_invariant9 ((temp___expr_464 Int) (temp___is_init_460 Bool) (temp___skip_constant_461 Bool) (temp___do_toplevel_462 Bool) (temp___do_typ_inv_463 Bool)) Bool (=> (or (= temp___is_init_460 true) (<= 0 4294967295)) (in_range11 temp___expr_464)))
(define-fun dynamic_invariant10 ((temp___expr_471 Int) (temp___is_init_467 Bool) (temp___skip_constant_468 Bool) (temp___do_toplevel_469 Bool) (temp___do_typ_inv_470 Bool)) Bool (=> (or (= temp___is_init_467 true) (<= 0 128)) (in_range12 temp___expr_471)))
(define-fun dynamic_invariant11 ((temp___expr_553 Int) (temp___is_init_549 Bool) (temp___skip_constant_550 Bool) (temp___do_toplevel_551 Bool) (temp___do_typ_inv_552 Bool)) Bool (=> (or (= temp___is_init_549 true) (<= 0 4294967295)) (in_range10 temp___expr_553)))
(declare-const contents__split_fields us_split_fields__ref8)
(declare-const localcontents__split_fields us_split_fields__ref4)
...
(declare-const temp___1966 us_rep8)
(declare-const o10 algorithmt)
(declare-const o11 us_split_fields16)
(declare-const temp___1968 us_rep8)
...
(declare-const temp___1976 us_rep8)
(declare-const localcontents__split_fields1 us_split_fields8)
...
(assert (= (let ((subject contents__split_fields)) contents__split_fields1) (mk___split_fields8 (mk___rep6 (mk___split_fields6 (rec__certprocessing__idcertdatat__issuer (let ((subject localcontents__split_fields)) localcontents__split_fields1)) (rec__certtypes__idt__serialnumber (us_split_fields13 (rec__cert__id__contentst__id (us_split_fields__content8 contents__split_fields)))))) (rec__cert__id__contentst__notbefore (us_split_fields__content8 contents__split_fields)) (rec__cert__id__contentst__notafter (us_split_fields__content8 contents__split_fields)) (rec__cert__id__contentst__mechanism (us_split_fields__content8 contents__split_fields)) (rec__cert__id__contentst__subject (us_split_fields__content8 contents__split_fields)) (rec__cert__id__contentst__subjectpublickey (us_split_fields__content8 contents__split_fields)))))
(assert (= (to_rep9 o) (to_rep3 (rec__certprocessing__idcertdatat__serialnumber (let ((subject localcontents__split_fields)) localcontents__split_fields1)))))
(assert (= (rec__certtypes__idt__issuer (us_split_fields13 (rec__cert__id__contentst__id (let ((subject contents__split_fields)) contents__split_fields1)))) (mk___rep (mk___split_fields o1 o2 o3))))
(assert (= o o4))
(assert (= o5 o1))
(assert (= o6 o2))
(assert (= o7 o3))
(assert (= o8 o4))
(assert (= o9 (mk___split_fields8 (mk___rep6 (mk___split_fields6 (mk___rep (mk___split_fields o5 o6 o7)) o8)) (rec__cert__id__contentst__notbefore (let ((subject contents__split_fields)) contents__split_fields1)) (rec__cert__id__contentst__notafter (let ((subject contents__split_fields)) contents__split_fields1)) (rec__cert__id__contentst__mechanism (let ((subject contents__split_fields)) contents__split_fields1)) (rec__cert__id__contentst__subject (let ((subject contents__split_fields)) contents__split_fields1)) (rec__cert__id__contentst__subjectpublickey (let ((subject contents__split_fields)) contents__split_fields1)))))
(assert (= temp___1966 (mk___rep8 o9)))
(assert (= result1 (let ((subject contents__split_fields)) (mk___split_fields__ref8 contents__split_fields1))))
(assert (= (let ((subject contents__split_fields)) contents__split_fields2) (us_split_fields17 temp___1966)))
...
(assert (= temp___1968 (mk___rep8 o11)))
(assert (= result2 (let ((subject contents__split_fields)) (mk___split_fields__ref8 contents__split_fields2))))
(assert (= (let ((subject contents__split_fields)) contents__split_fields3) (us_split_fields17 temp___1968)))
...
(assert (= (to_rep4 o12) (to_rep4 (rec__certprocessing__publickeyinfot__algorithmid (us_split_fields7 (rec__certprocessing__idcertdatat__subjectpublickeyinfo (let ((subject localcontents__split_fields)) localcontents__split_fields1)))))))
(assert (= o12 o13))
(assert (= (rec__cryptotypes__keypartt__keyid (us_split_fields15 (rec__cert__id__contentst__subjectpublickey (let ((subject contents__split_fields)) contents__split_fields4)))) o14))
(assert (= (rec__cryptotypes__keypartt__keylength (us_split_fields15 (rec__cert__id__contentst__subjectpublickey (let ((subject contents__split_fields)) contents__split_fields4)))) o15))
(assert (= o16 o13))
(assert (= o17 o14))
(assert (= o18 o15))
(assert (= o19 (mk___split_fields8 (rec__cert__id__contentst__id (let ((subject contents__split_fields)) contents__split_fields4)) (rec__cert__id__contentst__notbefore (let ((subject contents__split_fields)) contents__split_fields4)) (rec__cert__id__contentst__notafter (let ((subject contents__split_fields)) contents__split_fields4)) (rec__cert__id__contentst__mechanism (let ((subject contents__split_fields)) contents__split_fields4)) (rec__cert__id__contentst__subject (let ((subject contents__split_fields)) contents__split_fields4)) (mk___rep7 (mk___split_fields7 o16 o17 o18)))))
(assert (= temp___1973 (mk___rep8 o19)))
(assert (= result4 (let ((subject contents__split_fields)) (mk___split_fields__ref8 contents__split_fields4))))
(assert (= (let ((subject contents__split_fields)) contents__split_fields5) (us_split_fields17 temp___1973)))
(assert (= (to_rep10 o20) (to_rep3 (rec__certprocessing__publickeyinfot__keyid (us_split_fields7 (rec__certprocessing__idcertdatat__subjectpublickeyinfo (let ((subject localcontents__split_fields)) localcontents__split_fields1)))))))
(assert (= (rec__cryptotypes__keypartt__algorithmid (us_split_fields15 (rec__cert__id__contentst__subjectpublickey (let ((subject contents__split_fields)) contents__split_fields5)))) o21))
(assert (= o20 o22))
(assert (= (rec__cryptotypes__keypartt__keylength (us_split_fields15 (rec__cert__id__contentst__subjectpublickey (let ((subject contents__split_fields)) contents__split_fields5)))) o23))
(assert (= o24 o21))
(assert (= o25 o22))
(assert (= o26 o23))
(assert (= o27 (mk___split_fields8 (rec__cert__id__contentst__id (let ((subject contents__split_fields)) contents__split_fields5)) (rec__cert__id__contentst__notbefore (let ((subject contents__split_fields)) contents__split_fields5)) (rec__cert__id__contentst__notafter (let ((subject contents__split_fields)) contents__split_fields5)) (rec__cert__id__contentst__mechanism (let ((subject contents__split_fields)) contents__split_fields5)) (rec__cert__id__contentst__subject (let ((subject contents__split_fields)) contents__split_fields5)) (mk___rep7 (mk___split_fields7 o24 o25 o26)))))
(assert (= temp___1976 (mk___rep8 o27)))
(assert (= result5 (let ((subject contents__split_fields)) (mk___split_fields__ref8 contents__split_fields5))))
(assert (= (let ((subject contents__split_fields)) contents__split_fields6) (us_split_fields17 temp___1976)))
(assert (<= 0 (to_rep3 (rec__certprocessing__publickeyinfot__keylength (us_split_fields7 (rec__certprocessing__idcertdatat__subjectpublickeyinfo (let ((subject localcontents__split_fields)) localcontents__split_fields1)))))))
(assert (<= (to_rep3 (rec__certprocessing__publickeyinfot__keylength (us_split_fields7 (rec__certprocessing__idcertdatat__subjectpublickeyinfo (let ((subject localcontents__split_fields)) localcontents__split_fields1))))) 128))
(assert (not (in_range12 (to_rep3 (rec__certprocessing__publickeyinfot__keylength (us_split_fields7 (rec__certprocessing__idcertdatat__subjectpublickeyinfo (let ((subject localcontents__split_fields)) localcontents__split_fields1))))))))
(check-sat)
(exit)
