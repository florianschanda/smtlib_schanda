...
(assert (in_range2 k))
(assert (and (<= 0 k) (and (<= k 100) (and (forall ((i7 Int)) (=> (and (<= 0 i7) (<= i7 k)) (= (to_rep (select b1 i7)) (to_rep (select b2 i7))))) (forall ((i7 Int)) (=> (and (<= (+ k 1) i7) (<= i7 100)) (= (to_rep (select c1 (- i7 k))) (to_rep (select c2 (- i7 k))))))))))
(assert (= (mk_int__ref result) (mk_int__ref i)))
(assert (= i1 0))
(assert (=> (and (<= 0 i1) (<= i1 k)) (= temp___246 a1)))
(assert (=> (and (<= 0 i1) (<= i1 k)) (and (forall ((temp___247 Int)) (=> (and (<= 0 temp___247) (<= temp___247 100)) (=> (or (< k temp___247) (or (< temp___247 0) (<= i2 temp___247))) (= (select a12 temp___247) (select temp___246 temp___247))))) (and (<= 0 i2) (<= i2 k)))))
(assert (=> (and (<= 0 i1) (<= i1 k)) (and (<= 0 i2) (<= i2 100))))
(assert (=> (and (<= 0 i1) (<= i1 k)) (= o i2)))
(assert (=> (and (<= 0 i1) (<= i1 k)) (= o1 (select b1 o))))
(assert (=> (and (<= 0 i1) (<= i1 k)) (= o2 (to_rep o1))))
(assert (=> (and (<= 0 i1) (<= i1 k)) (= (to_rep o3) o2)))
(assert (=> (and (<= 0 i1) (<= i1 k)) (and (<= 0 i2) (<= i2 100))))
(assert (=> (and (<= 0 i1) (<= i1 k)) (= o4 i2)))
(assert (=> (and (<= 0 i1) (<= i1 k)) (= o5 (store a12 o4 o3))))
(assert (=> (and (<= 0 i1) (<= i1 k)) (= a12 result1)))
(assert (=> (and (<= 0 i1) (<= i1 k)) (= a13 o5)))
(assert (=> (and (<= 0 i1) (<= i1 k)) (= i2 k)))
(assert (=> (and (<= 0 i1) (<= i1 k)) (= i2 i3)))
(assert (=> (and (<= 0 i1) (<= i1 k)) (= a13 a14)))
(assert (=> (and (<= 0 i1) (<= i1 k)) (= i4 i2)))
(assert (=> (and (<= 0 i1) (<= i1 k)) (= a15 a13)))
(assert (=> (and (<= 0 i1) (<= i1 k)) (= (mk_int__ref i5) (mk_int__ref i3))))
(assert (=> (and (<= 0 i1) (<= i1 k)) (= a18 (mk_map__ref a14))))
(assert (=> (and (<= 0 i1) (<= i1 k)) (= i6 i4)))
(assert (=> (and (<= 0 i1) (<= i1 k)) (= a17 a15)))
(assert (=> (not (and (<= 0 i1) (<= i1 k))) (= i1 i5)))
(assert (=> (not (and (<= 0 i1) (<= i1 k))) (= a18 (mk_map__ref a1))))
(assert (=> (not (and (<= 0 i1) (<= i1 k))) (= i6 i1)))
(assert (=> (not (and (<= 0 i1) (<= i1 k))) (= a17 a11)))
