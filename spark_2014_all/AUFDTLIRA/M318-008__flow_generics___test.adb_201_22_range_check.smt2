...
(define-fun dynamic_invariant4 ((temp___expr_352 us_t) (temp___is_init_348 Bool) (temp___skip_constant_349 Bool) (temp___do_toplevel_350 Bool) (temp___do_typ_inv_351 Bool)) Bool (=> (not (= temp___skip_constant_349 true)) (dynamic_property 1 2147483647 (first1 temp___expr_352) (last1 temp___expr_352))))
(define-fun dynamic_invariant5 ((temp___expr_358 us_t1) (temp___is_init_354 Bool) (temp___skip_constant_355 Bool) (temp___do_toplevel_356 Bool) (temp___do_typ_inv_357 Bool)) Bool (=> (not (= temp___skip_constant_355 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_358) (last3 temp___expr_358))))
(define-fun dynamic_invariant6 ((temp___expr_371 us_t2) (temp___is_init_367 Bool) (temp___skip_constant_368 Bool) (temp___do_toplevel_369 Bool) (temp___do_typ_inv_370 Bool)) Bool (=> (not (= temp___skip_constant_368 true)) (dynamic_property2 1 2147483647 (first5 temp___expr_371) (last5 temp___expr_371))))
(define-fun dynamic_invariant7 ((temp___expr_419 us_t3) (temp___is_init_415 Bool) (temp___skip_constant_416 Bool) (temp___do_toplevel_417 Bool) (temp___do_typ_inv_418 Bool)) Bool (=> (not (= temp___skip_constant_416 true)) (dynamic_property3 1 2147483647 (first7 temp___expr_419) (last7 temp___expr_419))))
...
(assert (forall ((i Int)) (=> (and (<= (to_rep initial_crate__first) i) (<= i (to_rep initial_crate__last))) (not (= (found_none (to_rep1 (select initial_crate i))) true)))))
(assert (not (dynamic_property2 1 2147483647 (to_rep initial_crate__first) (to_rep initial_crate__last))))
(check-sat)
(exit)
