...
(assert (=> (= result true) (=> (= status 3) (= (valid_numberlogentries state4) true))))
(assert (=> (= result true) (=> (= status 3) (= status2 status))))
(assert (=> (= result true) (=> (= status 3) (= status2 status1))))
(assert (=> (= result true) (=> (not (= status 3)) (=> (=> (not (= status 6)) (= status 7)) (and (= status2 3) (in_range7 status2))))))
...
(assert (=> (not (= result true)) (= (valid_numberlogentries state8) true)))
...
(assert (=> (not (= result true)) (= state4 state8)))
(assert (=> (not (= result true)) (= status2 status3)))
(assert (and (not (= (ispresent (mk___rep theadmin__split_fields8)) true)) (not (= (isdoingop (mk___rep theadmin__split_fields8)) true))))
