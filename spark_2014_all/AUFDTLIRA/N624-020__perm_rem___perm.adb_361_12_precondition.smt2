...
(assert (=> (< ib ib2) (and (= o6 (get_witness bb2 aa ib)) (and (in_range3 o6) (and (and (<= (to_rep1 (first (rt aa))) o6) (<= o6 (to_rep1 (last (rt aa))))) (and (= (to_rep (select (elts bb2) ib)) (to_rep (select (elts aa) o6))) (= (is_perm (remove bb2 ib) (remove aa o6)) true)))))))
(assert (=> (< ib ib2) (= (mk_int__ref result7) (mk_int__ref ia2))))
(assert (=> (< ib ib2) (= ia22 o6)))
(assert (=> (< ib ib2) (and (= o7 (remove_swap b ib ib2)) (and (in_range2 o7) (=> (= (of_int o7) true) (= (let ((temp___157 (remove (remove b ib2) ib))) (let ((temp___156 (remove (remove b ib) (- ib2 1)))) (bool_eq (elts temp___156) (to_rep1 (first (rt temp___156))) (to_rep1 (last (rt temp___156))) (elts temp___157) (to_rep1 (first (rt temp___157))) (to_rep1 (last (rt temp___157)))))) true))))))
(assert (=> (< ib ib2) (= h3 result8)))
(assert (=> (< ib ib2) (= h4 o7)))
(assert (=> (< ib ib2) (= (of_int h4) true)))
(assert (=> (< ib ib2) (and (= o12 (- ib2 1)) (in_range3 (- ib2 1)))))
(assert (=> (< ib ib2) (and (= (mk___t o13 o14) (remove bb o12)) (and (dynamic_invariant2 (mk___t o13 o14) true false true) (and (= (invariant__ (mk___t o13 o14)) true) (and (= (to_rep1 (last o14)) (- (to_rep1 (last (rt bb))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o12 1))) (= (to_rep (select (elts bb) k)) (to_rep (select o13 k))))) (and (forall ((k Int)) (=> (and (<= (+ o12 1) k) (<= k (to_rep1 (last (rt bb))))) (= (to_rep (select (elts bb) k)) (to_rep (select o13 (- k 1)))))) (forall ((k Int)) (=> (and (<= o12 k) (<= k (- (to_rep1 (last (rt bb))) 1))) (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select o13 k)))))))))))))
(assert (=> (< ib ib2) (and (= (mk___t o10 o11) (remove aa ia22)) (and (dynamic_invariant2 (mk___t o10 o11) true false true) (and (= (invariant__ (mk___t o10 o11)) true) (and (= (to_rep1 (last o11)) (- (to_rep1 (last (rt aa))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ia22 1))) (= (to_rep (select (elts aa) k)) (to_rep (select o10 k))))) (and (forall ((k Int)) (=> (and (<= (+ ia22 1) k) (<= k (to_rep1 (last (rt aa))))) (= (to_rep (select (elts aa) k)) (to_rep (select o10 (- k 1)))))) (forall ((k Int)) (=> (and (<= ia22 k) (<= k (- (to_rep1 (last (rt aa))) 1))) (= (to_rep (select (elts aa) (+ k 1))) (to_rep (select o10 k)))))))))))))
(assert (=> (< ib ib2) (and (= (mk___t o8 o9) (remove bb2 ib)) (and (dynamic_invariant2 (mk___t o8 o9) true false true) (and (= (invariant__ (mk___t o8 o9)) true) (and (= (to_rep1 (last o9)) (- (to_rep1 (last (rt bb2))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib 1))) (= (to_rep (select (elts bb2) k)) (to_rep (select o8 k))))) (and (forall ((k Int)) (=> (and (<= (+ ib 1) k) (<= k (to_rep1 (last (rt bb2))))) (= (to_rep (select (elts bb2) k)) (to_rep (select o8 (- k 1)))))) (forall ((k Int)) (=> (and (<= ib k) (<= k (- (to_rep1 (last (rt bb2))) 1))) (= (to_rep (select (elts bb2) (+ k 1))) (to_rep (select o8 k)))))))))))))
(assert (=> (< ib ib2) (and (= o15 (shift_perm_l (mk___t o8 o9) (mk___t o10 o11) (mk___t o13 o14))) (and (in_range2 o15) (=> (= (of_int o15) true) (= (is_perm (mk___t o13 o14) (mk___t o10 o11)) true))))))
(assert (=> (< ib ib2) (= h4 result9)))
(assert (=> (< ib ib2) (= h5 o15)))
(assert (=> (< ib ib2) (= (of_int h5) true)))
(assert (=> (not (< ib ib2)) (and (= o16 (- ib 1)) (in_range3 (- ib 1)))))
(assert (=> (not (< ib ib2)) (and (= o17 (get_witness bb2 aa o16)) (and (in_range3 o17) (and (and (<= (to_rep1 (first (rt aa))) o17) (<= o17 (to_rep1 (last (rt aa))))) (and (= (to_rep (select (elts bb2) o16)) (to_rep (select (elts aa) o17))) (= (is_perm (remove bb2 o16) (remove aa o17)) true)))))))
(assert (=> (not (< ib ib2)) (= result10 (mk_int__ref ia2))))
(assert (=> (not (< ib ib2)) (= ia23 o17)))
(assert (=> (not (< ib ib2)) (and (= o18 (remove_swap b ib2 ib)) (and (in_range2 o18) (=> (= (of_int o18) true) (= (let ((temp___157 (remove (remove b ib) ib2))) (let ((temp___156 (remove (remove b ib2) (- ib 1)))) (bool_eq (elts temp___156) (to_rep1 (first (rt temp___156))) (to_rep1 (last (rt temp___156))) (elts temp___157) (to_rep1 (first (rt temp___157))) (to_rep1 (last (rt temp___157)))))) true))))))
(assert (=> (not (< ib ib2)) (= result11 (mk_int__ref h3))))
(assert (=> (not (< ib ib2)) (= h6 o18)))
(assert (=> (not (< ib ib2)) (= (of_int h6) true)))
(assert (=> (not (< ib ib2)) (and (= (mk___t o24 o25) (remove bb ib2)) (and (dynamic_invariant2 (mk___t o24 o25) true false true) (and (= (invariant__ (mk___t o24 o25)) true) (and (= (to_rep1 (last o25)) (- (to_rep1 (last (rt bb))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib2 1))) (= (to_rep (select (elts bb) k)) (to_rep (select o24 k))))) (and (forall ((k Int)) (=> (and (<= (+ ib2 1) k) (<= k (to_rep1 (last (rt bb))))) (= (to_rep (select (elts bb) k)) (to_rep (select o24 (- k 1)))))) (forall ((k Int)) (=> (and (<= ib2 k) (<= k (- (to_rep1 (last (rt bb))) 1))) (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select o24 k)))))))))))))
(assert (=> (not (< ib ib2)) (and (= (mk___t o22 o23) (remove aa ia23)) (and (dynamic_invariant2 (mk___t o22 o23) true false true) (and (= (invariant__ (mk___t o22 o23)) true) (and (= (to_rep1 (last o23)) (- (to_rep1 (last (rt aa))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ia23 1))) (= (to_rep (select (elts aa) k)) (to_rep (select o22 k))))) (and (forall ((k Int)) (=> (and (<= (+ ia23 1) k) (<= k (to_rep1 (last (rt aa))))) (= (to_rep (select (elts aa) k)) (to_rep (select o22 (- k 1)))))) (forall ((k Int)) (=> (and (<= ia23 k) (<= k (- (to_rep1 (last (rt aa))) 1))) (= (to_rep (select (elts aa) (+ k 1))) (to_rep (select o22 k)))))))))))))
(assert (=> (not (< ib ib2)) (and (= o19 (- ib 1)) (in_range3 (- ib 1)))))
(assert (=> (not (< ib ib2)) (and (= (mk___t o20 o21) (remove bb2 o19)) (and (dynamic_invariant2 (mk___t o20 o21) true false true) (and (= (invariant__ (mk___t o20 o21)) true) (and (= (to_rep1 (last o21)) (- (to_rep1 (last (rt bb2))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o19 1))) (= (to_rep (select (elts bb2) k)) (to_rep (select o20 k))))) (and (forall ((k Int)) (=> (and (<= (+ o19 1) k) (<= k (to_rep1 (last (rt bb2))))) (= (to_rep (select (elts bb2) k)) (to_rep (select o20 (- k 1)))))) (forall ((k Int)) (=> (and (<= o19 k) (<= k (- (to_rep1 (last (rt bb2))) 1))) (= (to_rep (select (elts bb2) (+ k 1))) (to_rep (select o20 k)))))))))))))
(assert (=> (not (< ib ib2)) (and (= o26 (shift_perm_l (mk___t o20 o21) (mk___t o22 o23) (mk___t o24 o25))) (and (in_range2 o26) (=> (= (of_int o26) true) (= (is_perm (mk___t o24 o25) (mk___t o22 o23)) true))))))
(assert (=> (not (< ib ib2)) (= result12 (mk_int__ref h6))))
(assert (=> (not (< ib ib2)) (= h7 o26)))
(assert (=> (not (< ib ib2)) (= (of_int h7) true)))
(assert (=> (not (< ib ib2)) (= ia22 ia23)))
