...
(assert (= result true))
(assert (= (= o18 true) (forall ((g1_id1 Int)) (=> (and (<= 1 g1_id1) (<= g1_id1 64)) (=> (forall ((idx Int)) (=> (and (<= 1 idx) (<= idx (to_rep3 unmatched_g1_set__split_fields1))) (not (= (to_rep (select unmatched_g1_set__split_fields idx)) g1_id1)))) (and (< 0 (to_rep3 (select proposals_made g1_id1))) (= (to_rep (select result__ (to_rep1 (select (select ranking_1 g1_id1) (to_rep3 (select proposals_made g1_id1)))))) g1_id1)))))))
(assert (= (= o17 true) (forall ((g1_id1 Int)) (=> (and (<= 1 g1_id1) (<= g1_id1 64)) (=> (= (to_rep3 (select proposals_made g1_id1)) 0) (exists ((idx Int)) (and (and (<= 1 idx) (<= idx (to_rep3 unmatched_g1_set__split_fields1))) (= (to_rep (select unmatched_g1_set__split_fields idx)) g1_id1))))))))
(assert (<= 1 g1_id))
(assert (<= g1_id 64))
(assert (<= 1 rank))
...
(assert (=> (= result1 true) (= o8 (to_rep1 o7))))
(assert (=> (= result1 true) (= o9 (select result__ o8))))
(assert (=> (= result1 true) (= o10 (to_rep o9))))
(assert (=> (= result1 true) (and (= o15 (is_preferred_1 g1_id o10 o14)) (= (= o15 true) (<= (to_rep2 (select (invert_1 o14) g1_id)) (to_rep2 (select (invert_1 o14) o10)))))))
(assert (=> (= result1 true) (= o16 (ite (not (= o15 true)) true false))))
(assert (=> (not (= result1 true)) (= o16 (of_int 1))))
(assert (not (<= 1 rank)))
(check-sat)
(exit)
