...
(assert (=> (= result2 true) (and (<= 1 rank) (<= rank 64))))
(assert (=> (= result2 true) (= o12 rank)))
(assert (=> (= result2 true) (= o13 (select (select ranking_1 g1_id) o12))))
(assert (=> (= result2 true) (= o14 (to_rep1 o13))))
(assert (=> (= result2 true) (= o15 (select ranking_2 o14))))
(assert (=> (= result2 true) (and (<= 1 rank) (<= rank 64))))
(assert (=> (= result2 true) (= o7 rank)))
(assert (=> (= result2 true) (= o8 (select (select ranking_1 g1_id) o7))))
(assert (=> (= result2 true) (= o9 (to_rep1 o8))))
(assert (=> (= result2 true) (= o10 (select result__ o9))))
(assert (=> (= result2 true) (= o11 (to_rep o10))))
(assert (=> (= result2 true) (and (= o16 (is_preferred_1 g1_id o11 o15)) (= (= o16 true) (<= (to_rep2 (select (invert_1 o15) g1_id)) (to_rep2 (select (invert_1 o15) o11)))))))
(assert (=> (= result2 true) (= o17 (ite (not (= o16 true)) true false))))
(assert (=> (not (= result2 true)) (= o17 (of_int 1))))
(assert (not (<= 1 rank)))
(check-sat)
(exit)
