...
(assert (= o14 to____split_fields1))
(assert (= o14 temp___1122))
(assert (= (mk4 1 new_length) temp___11221))
(assert (= (ite (<= (to_rep1 (first8 temp___11191)) (to_rep1 (last8 temp___11191))) (+ (- (to_rep1 (last8 temp___11191)) (to_rep1 (first8 temp___11191))) 1) 0) (ite (<= (to_rep1 (first8 temp___11221)) (to_rep1 (last8 temp___11221))) (+ (- (to_rep1 (last8 temp___11221)) (to_rep1 (first8 temp___11221))) 1) 0)))
(assert (= (mk___t4 temp___1124 temp___11241) (mk___t4 temp___1119 temp___11191)))
(assert (and (and (= (to_rep1 (first4 to____split_fields2)) (to_rep1 (first4 o16))) (= (to_rep1 (last4 to____split_fields2)) (to_rep1 (last4 o16)))) (forall ((temp___1125 Int)) (ite (and (<= 1 temp___1125) (<= temp___1125 new_length)) (= (select o15 temp___1125) (select temp___1124 temp___1125)) (= (select o15 temp___1125) (select to____split_fields1 temp___1125))))))
(assert (= to____split_fields o17))
(assert (= o18 o15))
(assert (= o19 o16))
(assert (= to____split_discrs (mk___split_discrs temp___1127)))
(assert (= temp___11271 o17))
(assert (= temp___11272 o18))
(assert (= temp___11273 o19))
(assert (not (dynamic_predicate (mk___rep (mk___split_discrs temp___1127) (mk___split_fields temp___11271 (mk___t2 temp___11272 temp___11273))))))
(check-sat)
(exit)
