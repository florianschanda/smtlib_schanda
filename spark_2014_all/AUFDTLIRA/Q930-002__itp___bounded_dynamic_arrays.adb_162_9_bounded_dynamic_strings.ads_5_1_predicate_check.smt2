...
(declare-const temp___11851 t4)
(declare-const temp___1187 (Array Int character))
(declare-const temp___11871 t4)
...
(assert (= o8 temp___1185))
(assert (= (mk4 1 new_length) temp___11851))
(assert (= (ite (<= (to_rep1 (first8 temp___11821)) (to_rep1 (last8 temp___11821))) (+ (- (to_rep1 (last8 temp___11821)) (to_rep1 (first8 temp___11821))) 1) 0) (ite (<= (to_rep1 (first8 temp___11851)) (to_rep1 (last8 temp___11851))) (+ (- (to_rep1 (last8 temp___11851)) (to_rep1 (first8 temp___11851))) 1) 0)))
(assert (= (mk___t4 temp___1187 temp___11871) (mk___t4 temp___1182 temp___11821)))
(assert (and (and (= (to_rep1 (first4 to____split_fields2)) (to_rep1 (first4 o10))) (= (to_rep1 (last4 to____split_fields2)) (to_rep1 (last4 o10)))) (forall ((temp___1188 Int)) (ite (and (<= 1 temp___1188) (<= temp___1188 new_length)) (= (select o9 temp___1188) (select temp___1187 temp___1188)) (= (select o9 temp___1188) (select to____split_fields1 temp___1188))))))
(assert (= to____split_fields o11))
(assert (= o12 o9))
(assert (= o13 o10))
(assert (= to____split_discrs (mk___split_discrs temp___1190)))
(assert (= temp___11901 o11))
(assert (= temp___11902 o12))
(assert (= temp___11903 o13))
(assert (not (dynamic_predicate (mk___rep (mk___split_discrs temp___1190) (mk___split_fields temp___11901 (mk___t2 temp___11902 temp___11903))))))
(check-sat)
(exit)
