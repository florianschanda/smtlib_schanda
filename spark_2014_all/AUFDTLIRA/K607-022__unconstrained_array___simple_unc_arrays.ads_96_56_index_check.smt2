...
(define-fun dynamic_invariant3 ((temp___expr_596 Int) (temp___is_init_592 Bool) (temp___skip_constant_593 Bool) (temp___do_toplevel_594 Bool) (temp___do_typ_inv_595 Bool)) Bool (=> (or (= temp___is_init_592 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_596)))
...
(assert (and (= temp___1027 (+ j 1)) (in_range1 (+ j 1))))
(assert (and (<= (to_rep2 (first a__split_fields5)) temp___1027) (<= temp___1027 (to_rep2 (last a__split_fields5)))))
(assert (= o temp___1027))
