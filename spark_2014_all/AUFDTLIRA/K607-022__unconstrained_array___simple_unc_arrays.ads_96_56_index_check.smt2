...
(define-fun dynamic_invariant3 ((temp___expr_525 Int) (temp___is_init_522 Bool) (temp___skip_constant_523 Bool) (temp___do_toplevel_524 Bool)) Bool (=> (or (= temp___is_init_522 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_525)))
...
(assert (dynamic_invariant1 (mk___rep a__split_discrs (mk___split_fields (mk___t a__split_fields a__split_fields1))) true false true))
(assert (and (and (and (= (mk_int__ref result) (mk_int__ref tmp)) (= tmp1 (to_rep (rec__simple_unc_arrays__table__last a__split_discrs)))) (and (in_range2 tmp1) (dynamic_invariant1 (mk___rep a__split_discrs (mk___split_fields (mk___t a__split_fields2 a__split_fields3))) true true true))) (and (and (= tmp1 tmp2) (and (= a__split_fields4 a__split_fields2) (= a__split_fields5 a__split_fields3))) (and (= tmp3 tmp1) (= (mk___split_fields (mk___t a__split_fields6 a__split_fields7)) (mk___split_fields (mk___t a__split_fields2 a__split_fields3)))))))
(assert (<= 1 j1))
(assert (<= j1 (- (to_rep (rec__simple_unc_arrays__table__last a__split_discrs)) 1)))
(assert (and (= temp___942 (+ j1 1)) (in_range1 (+ j1 1))))
(assert (and (<= (to_rep2 (first a__split_fields5)) temp___942) (<= temp___942 (to_rep2 (last a__split_fields5)))))
(assert (= o3 temp___942))
(assert (= o4 (select a__split_fields4 o3)))
(assert (= o5 (to_rep1 o4)))
(assert (not (<= (to_rep2 (first a__split_fields5)) j1)))
(check-sat)
(exit)
