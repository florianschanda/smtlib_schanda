...
(assert (and (<= (to_rep1 (first a__split_fields5)) temp___1020) (<= temp___1020 (to_rep1 (last a__split_fields5)))))
(assert (= o temp___1020))
(assert (= o1 (select a__split_fields4 o)))
(assert (= o2 (to_rep2 o1)))
(assert (not (<= j (to_rep1 (last a__split_fields5)))))
(check-sat)
(exit)
