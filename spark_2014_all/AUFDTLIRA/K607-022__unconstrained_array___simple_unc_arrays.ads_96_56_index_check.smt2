...
(define-fun dynamic_invariant3 ((temp___expr_531 Int) (temp___is_init_528 Bool) (temp___skip_constant_529 Bool) (temp___do_toplevel_530 Bool)) Bool (=> (or (= temp___is_init_528 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_531)))
...
(assert (dynamic_invariant1 (mk___rep a__split_discrs a__split_fields8) true true true))
(assert (= tmp1 tmp2))
...
(assert (and (= temp___948 (+ j 1)) (in_range1 (+ j 1))))
(assert (and (<= (to_rep2 (first a__split_fields5)) temp___948) (<= temp___948 (to_rep2 (last a__split_fields5)))))
(assert (= o temp___948))
(assert (= o1 (select a__split_fields4 o)))
(assert (= o2 (to_rep1 o1)))
(assert (not (<= (to_rep2 (first a__split_fields5)) j)))
(check-sat)
(exit)
