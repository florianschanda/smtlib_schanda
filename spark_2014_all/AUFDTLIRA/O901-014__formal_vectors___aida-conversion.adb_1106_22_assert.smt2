...
(assert (and (= (length source) 1) (forall ((index1 Int)) (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index1))) true)))))
