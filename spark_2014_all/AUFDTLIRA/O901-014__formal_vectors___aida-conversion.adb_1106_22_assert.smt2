...
(assert (and (= (length source) 1) (forall ((index Int)) (=> (and (<= (to_rep1 (first (rt source))) index) (<= index (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index))) true)))))
...
(assert (= o2 (to_rep o1)))
(assert (and (and (and (and (<= 0 target1) (<= target1 9)) (= target1 (convert_character_digit_to_integer o2))) (ite (= (= o2 48) true) (= target1 0) (ite (= (= o2 49) true) (= target1 1) (ite (= (= o2 50) true) (= target1 2) (ite (= (= o2 51) true) (= target1 3) (ite (= (= o2 52) true) (= target1 4) (ite (= (= o2 53) true) (= target1 5) (ite (= (= o2 54) true) (= target1 6) (ite (= (= o2 55) true) (= target1 7) (ite (= (= o2 56) true) (= target1 8) (=> (= (= o2 57) true) (= target1 9)))))))))))) (in_range1 target1)))
