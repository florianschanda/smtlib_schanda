...
(assert (<= 1 i13))
(assert (<= i13 100))
(assert (and (and (forall ((temp___262 Int)) (=> (and (<= 1 temp___262) (<= temp___262 100)) (ite (<= i14 temp___262) (= (select (rec__do_loops__r_array_record__f3 d__split_fields9) temp___262) (select (rec__do_loops__r_array_record__f3 (us_split_fields__content1 d__split_fields7)) temp___262)) (= (rec__do_loops__r__f2 (us_split_fields1 (select (rec__do_loops__r_array_record__f3 d__split_fields9) temp___262))) (rec__do_loops__r__f2 (us_split_fields1 (select (rec__do_loops__r_array_record__f3 (us_split_fields__content1 d__split_fields7)) temp___262))))))) (forall ((temp___263 Int)) (=> (and (<= 1 temp___263) (<= temp___263 100)) (ite (<= i14 temp___263) (= (select (rec__do_loops__r_array_record__f4 d__split_fields9) temp___263) (select (rec__do_loops__r_array_record__f4 (us_split_fields__content1 d__split_fields7)) temp___263)) (= (rec__do_loops__r__f2 (us_split_fields1 (select (rec__do_loops__r_array_record__f4 d__split_fields9) temp___263))) (rec__do_loops__r__f2 (us_split_fields1 (select (rec__do_loops__r_array_record__f4 (us_split_fields__content1 d__split_fields7)) temp___263)))))))) (and (<= 1 i14) (<= i14 100))))
(assert (= (to_rep o7) 0))
(assert (= o8 (mk___split_fields o7 (rec__do_loops__r__f2 (us_split_fields1 (select (rec__do_loops__r_array_record__f3 d__split_fields9) i14))))))
(assert (= o9 (mk___rep o8)))
(assert (= o10 (store (rec__do_loops__r_array_record__f3 d__split_fields9) i14 o9)))
(assert (= o11 (mk___split_fields1 o10 (rec__do_loops__r_array_record__f4 d__split_fields9))))
(assert (= temp___249 (mk___rep1 o11)))
(assert (= result4 (mk___split_fields__ref1 d__split_fields9)))
(assert (= d__split_fields10 (us_split_fields3 temp___249)))
(assert (= (to_rep o12) 0))
(assert (= o13 (mk___split_fields o12 (rec__do_loops__r__f2 (us_split_fields1 (select (rec__do_loops__r_array_record__f4 d__split_fields10) i14))))))
(assert (= o14 (mk___rep o13)))
(assert (= o15 (store (rec__do_loops__r_array_record__f4 d__split_fields10) i14 o14)))
(assert (= o16 (mk___split_fields1 (rec__do_loops__r_array_record__f3 d__split_fields10) o15)))
(assert (= temp___254 (mk___rep1 o16)))
(assert (= result5 (mk___split_fields__ref1 d__split_fields10)))
(assert (= d__split_fields11 (us_split_fields3 temp___254)))
(assert (= (to_rep (rec__do_loops__r__f2 (us_split_fields1 (select (rec__do_loops__r_array_record__f3 d__split_fields11) i14)))) (to_rep (rec__do_loops__r__f2 (us_split_fields1 (select (rec__do_loops__r_array_record__f3 (us_split_fields__content1 d__split_fields7)) i14))))))
