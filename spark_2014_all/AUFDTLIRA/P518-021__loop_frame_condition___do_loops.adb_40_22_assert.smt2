...
(assert (= i2 1))
(assert (=> (and (<= 1 i2) (<= i2 100)) (= temp___236 d__split_fields)))
(assert (=> (and (<= 1 i2) (<= i2 100)) (= temp___241 (mk___rep1 (mk___split_fields1 d__split_fields d__split_fields1)))))
(assert (=> (and (<= 1 i2) (<= i2 100)) (= temp___238 d__split_fields1)))
(assert (=> (and (<= 1 i2) (<= i2 100)) (and (and (forall ((temp___242 Int)) (=> (and (<= 1 temp___242) (<= temp___242 100)) (ite (<= i3 temp___242) (= (select (rec__do_loops__r_array_record__f3 d__split_fields3) temp___242) (select (rec__do_loops__r_array_record__f3 (us_split_fields3 temp___241)) temp___242)) (= (rec__do_loops__r__f2 (us_split_fields1 (select (rec__do_loops__r_array_record__f3 d__split_fields3) temp___242))) (rec__do_loops__r__f2 (us_split_fields1 (select (rec__do_loops__r_array_record__f3 (us_split_fields3 temp___241)) temp___242))))))) (= (rec__do_loops__r_array_record__f4 d__split_fields3) (rec__do_loops__r_array_record__f4 (us_split_fields3 temp___241)))) (and (<= 1 i3) (<= i3 100)))))
...
(assert (=> (and (<= 1 i2) (<= i2 100)) (= temp___234 (mk___rep1 o6))))
(assert (=> (and (<= 1 i2) (<= i2 100)) (= result2 (mk___split_fields__ref1 d__split_fields3))))
(assert (=> (and (<= 1 i2) (<= i2 100)) (= d__split_fields4 (us_split_fields3 temp___234))))
(assert (=> (and (<= 1 i2) (<= i2 100)) (= (to_rep (rec__do_loops__r__f2 (us_split_fields1 (select (rec__do_loops__r_array_record__f3 d__split_fields4) i3)))) (to_rep (rec__do_loops__r__f2 (us_split_fields1 (select temp___236 i3)))))))
(assert (=> (and (<= 1 i2) (<= i2 100)) (= (bool_eq1 (rec__do_loops__r_array_record__f4 d__split_fields4) 1 100 temp___238 1 100) true)))
