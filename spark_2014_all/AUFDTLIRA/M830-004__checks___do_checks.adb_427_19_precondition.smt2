...
(define-fun dynamic_invariant ((temp___expr_580 us_rep1) (temp___is_init_576 Bool) (temp___skip_constant_577 Bool) (temp___do_toplevel_578 Bool) (temp___do_typ_inv_579 Bool)) Bool (=> (not (= temp___skip_constant_577 true)) (in_range3 10 (to_base temp___expr_580))))
