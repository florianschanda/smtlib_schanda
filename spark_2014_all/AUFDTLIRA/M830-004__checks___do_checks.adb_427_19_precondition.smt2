...
(declare-fun user_eq4 (tT56bP1 tT56bP1) Bool)
(declare-const dummy4 tT56bP1)
...
(define-fun dynamic_invariant1 ((temp___expr_515 us_rep1) (temp___is_init_512 Bool) (temp___skip_constant_513 Bool) (temp___do_toplevel_514 Bool)) Bool (=> (not (= temp___skip_constant_513 true)) (in_range3 10 (to_base temp___expr_515))))
