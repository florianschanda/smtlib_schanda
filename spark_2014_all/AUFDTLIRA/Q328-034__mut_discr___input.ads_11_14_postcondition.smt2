...
(assert (forall ((item Int)) (! (=> (dynamic_invariant2 item true true true) (dynamic_invariant2 (to_upper item) true false true)) :pattern ((to_upper item)))))
...
(define-fun dynamic_invariant3 ((temp___expr_577 Int) (temp___is_init_574 Bool) (temp___skip_constant_575 Bool) (temp___do_toplevel_576 Bool)) Bool (=> (or (= temp___is_init_574 true) (<= 1 1025)) (in_range7 temp___expr_577)))
...
(define-fun dynamic_invariant4 ((temp___expr_583 Int) (temp___is_init_580 Bool) (temp___skip_constant_581 Bool) (temp___do_toplevel_582 Bool)) Bool (=> (or (= temp___is_init_580 true) (<= 0 1024)) (in_range8 temp___expr_583)))
...
(declare-fun temp___616 (Int Int Int) us_t2)
(assert (forall ((temp___618 Int) (temp___619 Int) (temp___620 Int)) (let ((temp___617 (temp___616 temp___618 temp___619 temp___620))) (and (=> (dynamic_property 1 2147483647 temp___619 temp___620) (and (= (first5 temp___617) temp___619) (= (last5 temp___617) temp___620))) (forall ((temp___621 Int)) (= (select (to_array2 temp___617) temp___621) (of_rep temp___618)))))))
...
(define-fun dynamic_invariant7 ((temp___expr_562 Int) (temp___is_init_559 Bool) (temp___skip_constant_560 Bool) (temp___do_toplevel_561 Bool)) Bool (=> (or (= temp___is_init_559 true) (<= 33 126)) (in_range5 temp___expr_562)))
...
(declare-const temp___626 (Array Int character))
(declare-const temp___6261 t1)
...
(declare-const temp___622 (Array Int character))
(declare-const temp___6221 t2)
(declare-const temp___623 (Array Int character))
(declare-const temp___6231 t2)
...
(declare-const temp___6241 t)
(declare-const temp___625 (Array Int character))
(declare-const temp___6251 t)
...
(assert (=> (<= first_char 1024) (= temp___609 first_char)))
(assert (=> (<= first_char 1024) (= temp___608 line)))
(assert (=> (<= first_char 1024) (= temp___607 line_num)))
(assert (=> (<= first_char 1024) (= temp___606 current_char)))
(assert (=> (<= first_char 1024) (= temp___605 last_char)))
...
(assert (=> (= result3 true) (= temp___610 (int__content first_char10))))
(assert (=> (= result3 true) (and (in_range7 first_char12) (and (<= first_char12 1024) (in_range5 (to_rep (select (map__content line5) first_char12)))))))
(assert (=> (= result3 true) (and (= o4 (+ first_char12 1)) (in_range7 (+ first_char12 1)))))
...
(assert (=> (= result3 true) (=> (<= first_char13 1024) (= o8 (ite (in_range5 o7) true false)))))
...
(assert (= o9 temp___626))
(assert (= (mk1 r25b r26b) temp___6261))
(assert (= temp___626 input__next_word__B_5__s__assume))
(assert (= (mk (to_rep1 (first2 temp___6261)) (to_rep1 (last2 temp___6261))) input__next_word__B_5__s__assume1))
...
(assert (=> (and (<= (to_rep1 s__first) i1) (<= i1 (to_rep1 s__last))) (= temp___612 s1)))
(assert (=> (and (<= (to_rep1 s__first) i1) (<= i1 (to_rep1 s__last))) (and (forall ((temp___613 Int)) (=> (and (<= (to_rep1 s__first) temp___613) (<= temp___613 (to_rep1 s__last))) (=> (<= i2 temp___613) (= (select s2 temp___613) (select temp___612 temp___613))))) (and (<= (to_rep1 s__first) i2) (<= i2 (to_rep1 s__last))))))
...
(assert (=> (<= (to_rep1 s__first) (to_rep1 s__last)) (= o28 (+ (- (to_rep1 s__last) (to_rep1 s__first)) 1))))
(assert (=> (not (<= (to_rep1 s__first) (to_rep1 s__last))) (= o28 0)))
(assert (=> (<= (to_rep1 v__first) (to_rep1 v__last)) (= o29 (+ (- (to_rep1 v__last) (to_rep1 v__first)) 1))))
(assert (=> (not (<= (to_rep1 v__first) (to_rep1 v__last))) (= o29 0)))
(assert (= o30 (- o29 o28)))
(assert (= (mk___t2 temp___622 temp___6221) (temp___616 32 1 o30)))
(assert (= (to_rep1 (first4 temp___6221)) 1))
(assert (= (to_rep1 (last4 temp___6221)) (- (ite (<= (to_rep1 v__first) (to_rep1 v__last)) (+ (- (to_rep1 v__last) (to_rep1 v__first)) 1) 0) (ite (<= (to_rep1 s__first) (to_rep1 s__last)) (+ (- (to_rep1 s__last) (to_rep1 s__first)) 1) 0))))
(assert (= (mk___t2 temp___623 temp___6231) (mk___t2 temp___622 temp___6221)))
(assert (=> (<= (to_rep1 s__first) (to_rep1 s__last)) (= o31 (+ (- (to_rep1 s__last) (to_rep1 s__first)) 1))))
(assert (=> (not (<= (to_rep1 s__first) (to_rep1 s__last))) (= o31 0)))
(assert (= result9 (ite (= o31 0) true false)))
(assert (=> (= result9 true) (= temp___623 temp___624)))
(assert (=> (= result9 true) (= (mk (to_rep1 (first4 temp___6231)) (to_rep1 (last4 temp___6231))) temp___6241)))
(assert (=> (not (= result9 true)) (=> (<= (to_rep1 (first4 temp___6231)) (to_rep1 (last4 temp___6231))) (= o32 (+ (- (to_rep1 (last4 temp___6231)) (to_rep1 (first4 temp___6231))) 1)))))
(assert (=> (not (= result9 true)) (=> (not (<= (to_rep1 (first4 temp___6231)) (to_rep1 (last4 temp___6231)))) (= o32 0))))
(assert (=> (not (= result9 true)) (=> (<= (to_rep1 s__first) (to_rep1 s__last)) (= o33 (+ (- (to_rep1 s__last) (to_rep1 s__first)) 1)))))
(assert (=> (not (= result9 true)) (=> (not (<= (to_rep1 s__first) (to_rep1 s__last))) (= o33 0))))
(assert (=> (not (= result9 true)) (= o34 (+ o33 o32))))
(assert (=> (not (= result9 true)) (= o35 (+ (to_rep1 s__first) o34))))
(assert (=> (not (= result9 true)) (= o36 (- o35 1))))
(assert (=> (not (= result9 true)) (and (= o37 o36) (in_range2 o36))))
(assert (=> (not (= result9 true)) (= (to_rep1 o38) o37)))
(assert (=> (not (= result9 true)) (= o39 (to_rep1 o38))))
(assert (=> (not (= result9 true)) (= (concat1 (map__content s6) (to_rep1 s__first) (to_rep1 s__last) temp___623 (to_rep1 (first4 temp___6231)) (to_rep1 (last4 temp___6231))) temp___624)))
(assert (=> (not (= result9 true)) (= (mk (to_rep1 s__first) o39) temp___6241)))
(assert (= (ite (<= (to_rep1 (first temp___6241)) (to_rep1 (last temp___6241))) (+ (- (to_rep1 (last temp___6241)) (to_rep1 (first temp___6241))) 1) 0) (ite (<= (to_rep1 v__first) (to_rep1 v__last)) (+ (- (to_rep1 v__last) (to_rep1 v__first)) 1) 0)))
(assert (= (mk___t temp___625 temp___6251) (mk___t temp___624 temp___6241)))
(assert (= o40 (slide temp___625 (to_rep1 (first temp___6251)) (to_rep1 v__first))))
(assert (= result10 (mk_map__ref v)))
(assert (= v1 o40))
(assert (=> (<= (to_rep1 s__first) (to_rep1 s__last)) (= o41 (+ (- (to_rep1 s__last) (to_rep1 s__first)) 1))))
(assert (=> (not (<= (to_rep1 s__first) (to_rep1 s__last))) (= o41 0)))
