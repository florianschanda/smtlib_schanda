...
(define-fun dynamic_invariant3 ((temp___expr_583 Int) (temp___is_init_580 Bool) (temp___skip_constant_581 Bool) (temp___do_toplevel_582 Bool)) Bool (=> (or (= temp___is_init_580 true) (<= 1 1025)) (in_range7 temp___expr_583)))
...
(define-fun dynamic_invariant4 ((temp___expr_589 Int) (temp___is_init_586 Bool) (temp___skip_constant_587 Bool) (temp___do_toplevel_588 Bool)) Bool (=> (or (= temp___is_init_586 true) (<= 0 1024)) (in_range8 temp___expr_589)))
...
(assert (forall ((temp___624 Int) (temp___625 Int) (temp___626 Int)) (let ((temp___623 (temp___622 temp___624 temp___625 temp___626))) (and (=> (dynamic_property 1 2147483647 temp___625 temp___626) (and (= (first5 temp___623) temp___625) (= (last5 temp___623) temp___626))) (forall ((temp___627 Int)) (= (select (to_array2 temp___623) temp___627) (of_rep temp___624)))))))
...
(define-fun dynamic_invariant7 ((temp___expr_568 Int) (temp___is_init_565 Bool) (temp___skip_constant_566 Bool) (temp___do_toplevel_567 Bool)) Bool (=> (or (= temp___is_init_565 true) (<= 33 126)) (in_range5 temp___expr_568)))
...
(declare-const temp___632 (Array Int character))
(declare-const temp___6321 t1)
(declare-const input__next_word__B_5__s__assume (Array Int character))
(declare-const input__next_word__B_5__s__assume1 t)
(declare-const temp___618 (Array Int character))
...
(declare-const temp___628 (Array Int character))
(declare-const temp___6281 t2)
(declare-const temp___629 (Array Int character))
(declare-const temp___6291 t2)
...
(declare-const temp___630 (Array Int character))
(declare-const temp___6301 t)
(declare-const temp___631 (Array Int character))
(declare-const temp___6311 t)
...
(define-fun temp___6282 () us_t2 (mk___t2 temp___628 temp___6281))
...
(assert (=> (<= first_char 1024) (and (and (and (in_range3 current_char3) (in_range7 first_char3)) (in_range8 last_char3)) (in_range4 line_num3))))
...
(assert (= (mk (to_rep1 (first2 temp___6321)) (to_rep1 (last2 temp___6321))) input__next_word__B_5__s__assume1))
...
(assert (=> (and (<= (to_rep1 s__first) i1) (<= i1 (to_rep1 s__last))) (= temp___618 s1)))
(assert (=> (and (<= (to_rep1 s__first) i1) (<= i1 (to_rep1 s__last))) (and (forall ((temp___619 Int)) (=> (and (<= (to_rep1 s__first) temp___619) (<= temp___619 (to_rep1 s__last))) (=> (<= i2 temp___619) (= (select s2 temp___619) (select temp___618 temp___619))))) (and (<= (to_rep1 s__first) i2) (<= i2 (to_rep1 s__last))))))
...
(assert (= o19 (- o18 o17)))
(assert (= temp___6282 (temp___622 32 1 o19)))
(assert (= (to_rep1 (first4 temp___6281)) 1))
(assert (= (to_rep1 (last4 temp___6281)) (- (ite (<= (to_rep1 v__first) (to_rep1 v__last)) (+ (- (to_rep1 v__last) (to_rep1 v__first)) 1) 0) (ite (<= (to_rep1 s__first) (to_rep1 s__last)) (+ (- (to_rep1 s__last) (to_rep1 s__first)) 1) 0))))
(assert (= (mk___t2 temp___629 temp___6291) temp___6282))
...
(assert (=> (= result9 true) (= temp___629 temp___630)))
(assert (=> (= result9 true) (= (mk (to_rep1 (first4 temp___6291)) (to_rep1 (last4 temp___6291))) temp___6301)))
(assert (=> (not (= result9 true)) (=> (<= (to_rep1 (first4 temp___6291)) (to_rep1 (last4 temp___6291))) (= o21 (+ (- (to_rep1 (last4 temp___6291)) (to_rep1 (first4 temp___6291))) 1)))))
(assert (=> (not (= result9 true)) (=> (not (<= (to_rep1 (first4 temp___6291)) (to_rep1 (last4 temp___6291)))) (= o21 0))))
...
(assert (=> (not (= result9 true)) (= (concat1 (map__content s6) (to_rep1 s__first) (to_rep1 s__last) temp___629 (to_rep1 (first4 temp___6291)) (to_rep1 (last4 temp___6291))) temp___630)))
(assert (=> (not (= result9 true)) (= (mk (to_rep1 s__first) o28) temp___6301)))
(assert (= (ite (<= (to_rep1 (first temp___6301)) (to_rep1 (last temp___6301))) (+ (- (to_rep1 (last temp___6301)) (to_rep1 (first temp___6301))) 1) 0) (ite (<= (to_rep1 v__first) (to_rep1 v__last)) (+ (- (to_rep1 v__last) (to_rep1 v__first)) 1) 0)))
(assert (= (mk___t temp___631 temp___6311) (mk___t temp___630 temp___6301)))
(assert (= o29 (slide temp___631 (to_rep1 (first temp___6311)) (to_rep1 v__first))))
