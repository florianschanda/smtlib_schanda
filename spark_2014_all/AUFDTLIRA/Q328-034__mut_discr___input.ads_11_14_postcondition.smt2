...
(define-fun dynamic_invariant3 ((temp___expr_645 Int) (temp___is_init_641 Bool) (temp___skip_constant_642 Bool) (temp___do_toplevel_643 Bool) (temp___do_typ_inv_644 Bool)) Bool (=> (or (= temp___is_init_641 true) (<= 1 1025)) (in_range5 temp___expr_645)))
(declare-sort tlast_charS 0)
(declare-fun tlast_charSqtint (tlast_charS) Int)
(assert (forall ((i tlast_charS)) (and (<= 0 (tlast_charSqtint i)) (<= (tlast_charSqtint i) 1024))))
...
(define-fun dynamic_invariant4 ((temp___expr_652 Int) (temp___is_init_648 Bool) (temp___skip_constant_649 Bool) (temp___do_toplevel_650 Bool) (temp___do_typ_inv_651 Bool)) Bool (=> (or (= temp___is_init_648 true) (<= 0 1024)) (in_range6 temp___expr_652)))
...
(assert (forall ((i tTlineSP1)) (and (<= 1 (tTlineSP1qtint i)) (<= (tTlineSP1qtint i) 1024))))
...
(declare-fun temp_____aggregate_def_687 (Int Int Int) us_t2)
...
(define-fun dynamic_invariant7 ((temp___expr_628 Int) (temp___is_init_624 Bool) (temp___skip_constant_625 Bool) (temp___do_toplevel_626 Bool) (temp___do_typ_inv_627 Bool)) Bool (=> (or (= temp___is_init_624 true) (<= 33 126)) (in_range7 temp___expr_628)))
(assert (forall ((temp___689 Int) (temp___690 Int) (temp___691 Int)) (let ((temp___688 (temp_____aggregate_def_687 temp___689 temp___690 temp___691))) (=> (dynamic_invariant2 temp___689 true true true true) (and (=> (dynamic_property 1 2147483647 temp___690 temp___691) (and (= (first5 temp___688) temp___690) (= (last5 temp___688) temp___691))) (forall ((temp___692 Int)) (= (to_rep (select (to_array2 temp___688) temp___692)) temp___689)))))))
(declare-const v (Array Int character))
...
(declare-const temp___697 (Array Int character))
(declare-const temp___6971 t1)
(declare-const input__next_word__B_5__s__assume (Array Int character))
(declare-const input__next_word__B_5__s__assume1 t)
(declare-const temp___685 (Array Int character))
...
(declare-const temp___693 (Array Int character))
(declare-const temp___6931 t2)
(declare-const temp___694 (Array Int character))
(declare-const temp___6941 t2)
...
(declare-const temp___695 (Array Int character))
(declare-const temp___6951 t)
(declare-const temp___696 (Array Int character))
(declare-const temp___6961 t)
...
(declare-const v1 (Array Int character))
(declare-const result11 int__ref)
(declare-const size1 Int)
(declare-const v2 map__ref)
(declare-const size2 int__ref)
(declare-const line7 map__ref)
(declare-const first_char18 int__ref)
(declare-const last_char8 int__ref)
(declare-const line_num8 int__ref)
(declare-const start2 int__ref)
(declare-const current_char8 int__ref)
(declare-const s8 map__ref)
(declare-const i7 int__ref)
(declare-const v3 (Array Int character))
(declare-const size3 Int)
(declare-const line8 (Array Int character))
(declare-const first_char19 Int)
(declare-const last_char9 Int)
(declare-const line_num9 Int)
(declare-const start3 Int)
(declare-const current_char9 Int)
(declare-const s9 (Array Int character))
(declare-const i8 Int)
(define-fun temp___6932 () us_t2 (mk___t2 temp___693 temp___6931))
(assert (in_range5 first_char))
(assert (in_range6 last_char))
...
(assert (=> (<= first_char 1024) (= temp___680 first_char)))
(assert (=> (<= first_char 1024) (= temp___679 line)))
(assert (=> (<= first_char 1024) (= temp___678 current_char)))
(assert (=> (<= first_char 1024) (= temp___677 line_num)))
(assert (=> (<= first_char 1024) (= temp___676 last_char)))
(assert (=> (<= first_char 1024) (and (and (and (and (in_range6 last_char2) (in_range4 line_num2)) (=> (<= 0 255) (in_range3 current_char2))) (in_range5 first_char2)) (<= first_char2 1024))))
(assert (=> (<= first_char 1024) (and (and (and (in_range3 current_char3) (in_range6 last_char3)) (in_range4 line_num3)) (in_range5 first_char3))))
(assert (=> (<= first_char 1024) (or (in_range7 current_char3) (and (not (in_range7 current_char3)) (not (<= first_char3 1024))))))
...
(assert (=> (<= 1 (- (int__content first_char6) 1)) (and (= o (- (int__content first_char6) 1)) (in_range5 (- (int__content first_char6) 1)))))
...
(assert (=> (<= (int__content first_char10) 1024) (= result3 (ite (in_range7 o3) true false))))
(assert (=> (not (<= (int__content first_char10) 1024)) (= result3 false)))
(assert (=> (= result3 true) (= temp___681 (int__content first_char10))))
(assert (=> (= result3 true) (and (in_range5 first_char12) (and (<= first_char12 1024) (in_range7 (to_rep (select (map__content line5) first_char12)))))))
(assert (=> (= result3 true) (and (= o4 (+ first_char12 1)) (in_range5 (+ first_char12 1)))))
(assert (=> (= result3 true) (= result4 (mk_int__ref first_char12))))
(assert (=> (= result3 true) (= first_char13 o4)))
(assert (=> (= result3 true) (=> (<= first_char13 1024) (and (<= 1 first_char13) (<= first_char13 1024)))))
(assert (=> (= result3 true) (=> (<= first_char13 1024) (= o5 first_char13))))
(assert (=> (= result3 true) (=> (<= first_char13 1024) (= o6 (select (map__content line5) o5)))))
(assert (=> (= result3 true) (=> (<= first_char13 1024) (= o7 (to_rep o6)))))
(assert (=> (= result3 true) (=> (<= first_char13 1024) (= o8 (ite (in_range7 o7) true false)))))
(assert (=> (= result3 true) (=> (not (<= first_char13 1024)) (= o8 false))))
(assert (=> (= result3 true) (= result5 (ite (not (= o8 true)) true false))))
...
(assert (=> (<= r25b r26b) (and (and (<= 1 r25b) (<= r25b 1024)) (and (<= 1 r26b) (<= r26b 1024)))))
(assert (= o9 (map__content line5)))
(assert (= o9 temp___697))
(assert (= (mk1 r25b r26b) temp___6971))
(assert (= temp___697 input__next_word__B_5__s__assume))
(assert (= (mk (to_rep1 (first2 temp___6971)) (to_rep1 (last2 temp___6971))) input__next_word__B_5__s__assume1))
(assert (= result6 (mk_map__ref s)))
(assert (= s1 input__next_word__B_5__s__assume))
(assert (= (to_rep1 s__first) (to_rep1 (first input__next_word__B_5__s__assume1))))
(assert (= (to_rep1 s__last) (to_rep1 (last input__next_word__B_5__s__assume1))))
...
(assert (=> (and (<= (to_rep1 s__first) i1) (<= i1 (to_rep1 s__last))) (= temp___685 s1)))
(assert (=> (and (<= (to_rep1 s__first) i1) (<= i1 (to_rep1 s__last))) (and (forall ((temp___686 Int)) (=> (and (<= (to_rep1 s__first) temp___686) (<= temp___686 (to_rep1 s__last))) (=> (or (< (to_rep1 s__last) temp___686) (or (< temp___686 (to_rep1 s__first)) (<= i2 temp___686))) (= (select s2 temp___686) (select temp___685 temp___686))))) (and (<= (to_rep1 s__first) i2) (<= i2 (to_rep1 s__last))))))
(assert (=> (and (<= (to_rep1 s__first) i1) (<= i1 (to_rep1 s__last))) (and (<= (to_rep1 s__first) i2) (<= i2 (to_rep1 s__last)))))
(assert (=> (and (<= (to_rep1 s__first) i1) (<= i1 (to_rep1 s__last))) (= o10 i2)))
(assert (=> (and (<= (to_rep1 s__first) i1) (<= i1 (to_rep1 s__last))) (= o11 (select s2 o10))))
(assert (=> (and (<= (to_rep1 s__first) i1) (<= i1 (to_rep1 s__last))) (= o12 (to_rep o11))))
(assert (=> (and (<= (to_rep1 s__first) i1) (<= i1 (to_rep1 s__last))) (and (= o13 (to_upper o12)) (in_range3 o13))))
(assert (=> (and (<= (to_rep1 s__first) i1) (<= i1 (to_rep1 s__last))) (= (to_rep o14) o13)))
(assert (=> (and (<= (to_rep1 s__first) i1) (<= i1 (to_rep1 s__last))) (and (<= (to_rep1 s__first) i2) (<= i2 (to_rep1 s__last)))))
(assert (=> (and (<= (to_rep1 s__first) i1) (<= i1 (to_rep1 s__last))) (= o15 i2)))
(assert (=> (and (<= (to_rep1 s__first) i1) (<= i1 (to_rep1 s__last))) (= o16 (store s2 o15 o14))))
(assert (=> (and (<= (to_rep1 s__first) i1) (<= i1 (to_rep1 s__last))) (= result8 (mk_map__ref s2))))
(assert (=> (and (<= (to_rep1 s__first) i1) (<= i1 (to_rep1 s__last))) (= s3 o16)))
(assert (=> (and (<= (to_rep1 s__first) i1) (<= i1 (to_rep1 s__last))) (= i2 (to_rep1 s__last))))
(assert (=> (and (<= (to_rep1 s__first) i1) (<= i1 (to_rep1 s__last))) (= i3 (mk_int__ref i2))))
(assert (=> (and (<= (to_rep1 s__first) i1) (<= i1 (to_rep1 s__last))) (= s4 (mk_map__ref s3))))
(assert (=> (and (<= (to_rep1 s__first) i1) (<= i1 (to_rep1 s__last))) (= i4 i2)))
(assert (=> (and (<= (to_rep1 s__first) i1) (<= i1 (to_rep1 s__last))) (= s5 s3)))
(assert (=> (and (<= (to_rep1 s__first) i1) (<= i1 (to_rep1 s__last))) (= i5 i3)))
(assert (=> (and (<= (to_rep1 s__first) i1) (<= i1 (to_rep1 s__last))) (= s6 s4)))
(assert (=> (and (<= (to_rep1 s__first) i1) (<= i1 (to_rep1 s__last))) (= i6 i4)))
(assert (=> (and (<= (to_rep1 s__first) i1) (<= i1 (to_rep1 s__last))) (= s7 s5)))
(assert (=> (not (and (<= (to_rep1 s__first) i1) (<= i1 (to_rep1 s__last)))) (= i5 (mk_int__ref i1))))
(assert (=> (not (and (<= (to_rep1 s__first) i1) (<= i1 (to_rep1 s__last)))) (= s6 (mk_map__ref s1))))
(assert (=> (not (and (<= (to_rep1 s__first) i1) (<= i1 (to_rep1 s__last)))) (= i6 i1)))
(assert (=> (not (and (<= (to_rep1 s__first) i1) (<= i1 (to_rep1 s__last)))) (= s7 s1)))
(assert (=> (<= (to_rep1 s__first) (to_rep1 s__last)) (= o17 (+ (- (to_rep1 s__last) (to_rep1 s__first)) 1))))
(assert (=> (not (<= (to_rep1 s__first) (to_rep1 s__last))) (= o17 0)))
(assert (=> (<= (to_rep1 v__first) (to_rep1 v__last)) (= o18 (+ (- (to_rep1 v__last) (to_rep1 v__first)) 1))))
(assert (=> (not (<= (to_rep1 v__first) (to_rep1 v__last))) (= o18 0)))
(assert (= o19 (- o18 o17)))
(assert (= temp___6932 (temp_____aggregate_def_687 32 1 o19)))
(assert (= (to_rep1 (first4 temp___6931)) 1))
(assert (= (to_rep1 (last4 temp___6931)) (- (ite (<= (to_rep1 v__first) (to_rep1 v__last)) (+ (- (to_rep1 v__last) (to_rep1 v__first)) 1) 0) (ite (<= (to_rep1 s__first) (to_rep1 s__last)) (+ (- (to_rep1 s__last) (to_rep1 s__first)) 1) 0))))
(assert (= (mk___t2 temp___694 temp___6941) temp___6932))
(assert (=> (<= (to_rep1 s__first) (to_rep1 s__last)) (= o20 (+ (- (to_rep1 s__last) (to_rep1 s__first)) 1))))
(assert (=> (not (<= (to_rep1 s__first) (to_rep1 s__last))) (= o20 0)))
(assert (= result9 (ite (= o20 0) true false)))
(assert (=> (= result9 true) (= temp___694 temp___695)))
(assert (=> (= result9 true) (= (mk (to_rep1 (first4 temp___6941)) (to_rep1 (last4 temp___6941))) temp___6951)))
(assert (=> (not (= result9 true)) (=> (<= (to_rep1 (first4 temp___6941)) (to_rep1 (last4 temp___6941))) (= o21 (+ (- (to_rep1 (last4 temp___6941)) (to_rep1 (first4 temp___6941))) 1)))))
(assert (=> (not (= result9 true)) (=> (not (<= (to_rep1 (first4 temp___6941)) (to_rep1 (last4 temp___6941)))) (= o21 0))))
(assert (=> (not (= result9 true)) (=> (<= (to_rep1 s__first) (to_rep1 s__last)) (= o22 (+ (- (to_rep1 s__last) (to_rep1 s__first)) 1)))))
(assert (=> (not (= result9 true)) (=> (not (<= (to_rep1 s__first) (to_rep1 s__last))) (= o22 0))))
(assert (=> (not (= result9 true)) (= o23 (+ o22 o21))))
(assert (=> (not (= result9 true)) (= o24 (+ (to_rep1 s__first) o23))))
(assert (=> (not (= result9 true)) (= o25 (- o24 1))))
(assert (=> (not (= result9 true)) (and (= o26 o25) (in_range2 o25))))
(assert (=> (not (= result9 true)) (= (to_rep1 o27) o26)))
(assert (=> (not (= result9 true)) (= o28 (to_rep1 o27))))
(assert (=> (not (= result9 true)) (= (concat1 (map__content s6) (to_rep1 s__first) (to_rep1 s__last) temp___694 (to_rep1 (first4 temp___6941)) (to_rep1 (last4 temp___6941))) temp___695)))
(assert (=> (not (= result9 true)) (= (mk (to_rep1 s__first) o28) temp___6951)))
(assert (= (ite (<= (to_rep1 (first temp___6951)) (to_rep1 (last temp___6951))) (+ (- (to_rep1 (last temp___6951)) (to_rep1 (first temp___6951))) 1) 0) (ite (<= (to_rep1 v__first) (to_rep1 v__last)) (+ (- (to_rep1 v__last) (to_rep1 v__first)) 1) 0)))
(assert (= (mk___t temp___696 temp___6961) (mk___t temp___695 temp___6951)))
(assert (= o29 (slide temp___696 (to_rep1 (first temp___6961)) (to_rep1 v__first))))
(assert (= result10 (mk_map__ref v)))
(assert (= v1 o29))
(assert (=> (<= (to_rep1 s__first) (to_rep1 s__last)) (= o30 (+ (- (to_rep1 s__last) (to_rep1 s__first)) 1))))
(assert (=> (not (<= (to_rep1 s__first) (to_rep1 s__last))) (= o30 0)))
(assert (and (= o31 o30) (in_range1 o30)))
(assert (= result11 (mk_int__ref size)))
(assert (= size1 o31))
(assert (= i7 i5))
(assert (= s8 s6))
(assert (= current_char8 current_char6))
(assert (= start2 (mk_int__ref start1)))
(assert (= line_num8 line_num6))
(assert (= last_char8 last_char6))
(assert (= first_char18 first_char16))
(assert (= line7 line5))
(assert (= size2 (mk_int__ref size1)))
(assert (= v2 (mk_map__ref v1)))
(assert (= i8 i6))
(assert (= s9 s7))
(assert (= current_char9 current_char7))
(assert (= start3 start1))
(assert (= line_num9 line_num7))
(assert (= last_char9 last_char7))
(assert (= first_char19 first_char17))
(assert (= line8 line6))
(assert (= size3 size1))
(assert (= v3 v1))
