...
(declare-const temp___690 (Array Int character))
...
(declare-const temp___700 (Array Int character))
(declare-const temp___7001 t2)
(declare-const temp___701 (Array Int character))
(declare-const temp___7011 t2)
...
(declare-const temp___702 (Array Int character))
(declare-const temp___7021 t)
(declare-const temp___703 (Array Int character))
(declare-const temp___7031 t)
...
(define-fun temp___7002 () us_t2 (mk___t2 temp___700 temp___7001))
...
(assert (=> (= result3 true) (= temp___688 (int__content first_char10))))
...
(assert (= o9 temp___704))
(assert (= (mk1 r25b r26b) temp___7041))
(assert (= temp___704 input__next_word__B_5__s__assume))
(assert (= (mk (to_rep1 (first2 temp___7041)) (to_rep1 (last2 temp___7041))) input__next_word__B_5__s__assume1))
...
(assert (=> (and (<= (to_rep1 s__first) i1) (<= i1 (to_rep1 s__last))) (= temp___690 s1)))
(assert (=> (and (<= (to_rep1 s__first) i1) (<= i1 (to_rep1 s__last))) (and (forall ((temp___691 Int)) (=> (and (<= (to_rep1 s__first) temp___691) (<= temp___691 (to_rep1 s__last))) (=> (<= i2 temp___691) (= (select s2 temp___691) (select temp___690 temp___691))))) (and (<= (to_rep1 s__first) i2) (<= i2 (to_rep1 s__last))))))
...
(assert (= o19 (- o18 o17)))
(assert (= temp___7002 (temp___694 32 1 o19)))
(assert (= (to_rep1 (first4 temp___7001)) 1))
(assert (= (to_rep1 (last4 temp___7001)) (- (ite (<= (to_rep1 v__first) (to_rep1 v__last)) (+ (- (to_rep1 v__last) (to_rep1 v__first)) 1) 0) (ite (<= (to_rep1 s__first) (to_rep1 s__last)) (+ (- (to_rep1 s__last) (to_rep1 s__first)) 1) 0))))
(assert (= (mk___t2 temp___701 temp___7011) temp___7002))
...
(assert (=> (= result9 true) (= temp___701 temp___702)))
(assert (=> (= result9 true) (= (mk (to_rep1 (first4 temp___7011)) (to_rep1 (last4 temp___7011))) temp___7021)))
(assert (=> (not (= result9 true)) (=> (<= (to_rep1 (first4 temp___7011)) (to_rep1 (last4 temp___7011))) (= o21 (+ (- (to_rep1 (last4 temp___7011)) (to_rep1 (first4 temp___7011))) 1)))))
(assert (=> (not (= result9 true)) (=> (not (<= (to_rep1 (first4 temp___7011)) (to_rep1 (last4 temp___7011)))) (= o21 0))))
...
(assert (=> (not (= result9 true)) (= (concat1 (map__content s6) (to_rep1 s__first) (to_rep1 s__last) temp___701 (to_rep1 (first4 temp___7011)) (to_rep1 (last4 temp___7011))) temp___702)))
(assert (=> (not (= result9 true)) (= (mk (to_rep1 s__first) o28) temp___7021)))
(assert (= (ite (<= (to_rep1 (first temp___7021)) (to_rep1 (last temp___7021))) (+ (- (to_rep1 (last temp___7021)) (to_rep1 (first temp___7021))) 1) 0) (ite (<= (to_rep1 v__first) (to_rep1 v__last)) (+ (- (to_rep1 v__last) (to_rep1 v__first)) 1) 0)))
(assert (= (mk___t temp___703 temp___7031) (mk___t temp___702 temp___7021)))
(assert (= o29 (slide temp___703 (to_rep1 (first temp___7031)) (to_rep1 v__first))))
