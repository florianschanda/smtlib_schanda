...
(assert (= a2 a3))
(assert (= a4 a2))
(assert (not (= (bool_eq3 a3 90 99 (temp___3996 a i (mk___rep (mk___split_fields (temp___4002 (rec__ar__rofa4__s4 (us_split_fields1 (select a i))) k f) (temp___4009 (rec__ar__rofa4__t4 (us_split_fields1 (select a i))) j (temp___4016 (select (rec__ar__rofa4__t4 (us_split_fields1 (select a i))) j) k e))))) 90 99) true)))
(check-sat)
(exit)
