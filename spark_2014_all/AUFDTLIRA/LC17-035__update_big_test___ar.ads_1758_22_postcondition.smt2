...
(declare-fun temp_____aggregate_def_3996 ((Array Int us_rep) Int us_rep) (Array Int us_rep))
(declare-fun temp_____aggregate_def_4002 ((Array Int et1) Int Int) (Array Int et1))
(declare-fun temp_____aggregate_def_4009 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
(declare-fun temp_____aggregate_def_4016 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___3998 (Array Int us_rep))) (forall ((temp___3999 Int)) (forall ((temp___4000 us_rep)) (let ((temp___3997 (temp_____aggregate_def_3996 temp___3998 temp___3999 temp___4000))) (=> (dynamic_invariant2 temp___3999 true true true true) (forall ((temp___4001 Int)) (ite (= temp___4001 temp___3999) (= (select temp___3997 temp___4001) temp___4000) (= (select temp___3997 temp___4001) (select temp___3998 temp___4001))))))))))
(assert (forall ((temp___4004 (Array Int et1))) (forall ((temp___4005 Int) (temp___4006 Int)) (let ((temp___4003 (temp_____aggregate_def_4002 temp___4004 temp___4005 temp___4006))) (=> (and (dynamic_invariant temp___4005 true true true true) (dynamic_invariant3 temp___4006 true true true true)) (forall ((temp___4007 Int)) (ite (= temp___4007 temp___4005) (= (to_rep (select temp___4003 temp___4007)) temp___4006) (= (select temp___4003 temp___4007) (select temp___4004 temp___4007)))))))))
(assert (forall ((temp___4011 (Array Int (Array Int et1)))) (forall ((temp___4012 Int)) (forall ((temp___4013 (Array Int et1))) (let ((temp___4010 (temp_____aggregate_def_4009 temp___4011 temp___4012 temp___4013))) (=> (dynamic_invariant1 temp___4012 true true true true) (forall ((temp___4014 Int)) (ite (= temp___4014 temp___4012) (= (select temp___4010 temp___4014) temp___4013) (= (select temp___4010 temp___4014) (select temp___4011 temp___4014))))))))))
(assert (forall ((temp___4018 (Array Int et1))) (forall ((temp___4019 Int) (temp___4020 Int)) (let ((temp___4017 (temp_____aggregate_def_4016 temp___4018 temp___4019 temp___4020))) (=> (and (dynamic_invariant temp___4019 true true true true) (dynamic_invariant3 temp___4020 true true true true)) (forall ((temp___4021 Int)) (ite (= temp___4021 temp___4019) (= (to_rep (select temp___4017 temp___4021)) temp___4020) (= (select temp___4017 temp___4021) (select temp___4018 temp___4021)))))))))
...
(assert (= a2 a3))
(assert (= a4 a2))
(assert (not (= (bool_eq3 a3 90 99 (temp_____aggregate_def_3996 a i (mk___rep (mk___split_fields (temp_____aggregate_def_4002 (rec__ar__rofa4__s4 (us_split_fields1 (select a i))) k f) (temp_____aggregate_def_4009 (rec__ar__rofa4__t4 (us_split_fields1 (select a i))) j (temp_____aggregate_def_4016 (select (rec__ar__rofa4__t4 (us_split_fields1 (select a i))) j) k e))))) 90 99) true)))
(check-sat)
(exit)
