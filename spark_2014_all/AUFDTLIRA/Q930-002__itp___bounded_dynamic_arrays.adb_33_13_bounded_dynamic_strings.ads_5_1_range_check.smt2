...
(assert (dynamic_invariant3 (mk___rep1 result____split_discrs (mk___split_fields1 result____split_fields (mk___t4 result____split_fields1 result____split_fields2))) false false true))
(assert (and (= o1 (length content)) (in_range4 (length content))))
(assert (= (to_rep2 o2) o1))
(assert (= o2 o3))
(assert (= result____split_fields1 o4))
(assert (= result____split_fields2 o5))
(assert (= result____split_discrs (mk___split_discrs temp___885)))
(assert (= temp___8851 o3))
(assert (= temp___8852 o4))
(assert (= temp___8853 o5))
(assert (dynamic_predicate1 (mk___rep1 (mk___split_discrs temp___885) (mk___split_fields1 temp___8851 (mk___t4 temp___8852 temp___8853)))))
(assert (= temp___886 (mk___rep1 (mk___split_discrs temp___885) (mk___split_fields1 temp___8851 (mk___t4 temp___8852 temp___8853)))))
...
(assert (= result____split_fields3 (us_split_fields3 temp___886)))
(assert (= result____split_discrs (us_split_discrs2 temp___886)))
...
(assert (= temp___887 (mk___t6 (slide (elts content) (to_rep1 (first (rt content))) 1) (mk6 1 r88b))))
(assert (<= 1 r88b))
