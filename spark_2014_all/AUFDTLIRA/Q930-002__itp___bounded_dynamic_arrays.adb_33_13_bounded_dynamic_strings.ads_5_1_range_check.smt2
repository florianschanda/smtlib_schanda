...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant2 this true true true true) (let ((result (value this))) (and (and (and (and (= (length result) (length3 this)) (= (first1 result) 1)) (= (last1 result) (length3 this))) (= (< 0 (length3 this)) (not (= (empty this) true)))) (dynamic_invariant result true false true true)))) :pattern ((value this)))))
...
(define-fun dynamic_invariant3 ((temp___expr_549 us_rep1) (temp___is_init_545 Bool) (temp___skip_constant_546 Bool) (temp___do_toplevel_547 Bool) (temp___do_typ_inv_548 Bool)) Bool (and (and (=> (not (= temp___skip_constant_546 true)) (in_range5 capacity (to_base temp___expr_549))) (=> (= temp___do_toplevel_547 true) (=> (= temp___is_init_545 true) (and (<= 0 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 (to_base temp___expr_549))))) (<= (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 (to_base temp___expr_549)))) (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 (to_base temp___expr_549))))))))) (and (dynamic_property8 1 capacity (first9 (rec__bounded_dynamic_strings__sequence__content1 (us_split_fields3 temp___expr_549))) (last9 (rec__bounded_dynamic_strings__sequence__content1 (us_split_fields3 temp___expr_549)))) (and (= (first9 (rec__bounded_dynamic_strings__sequence__content1 (us_split_fields3 temp___expr_549))) 1) (= (last9 (rec__bounded_dynamic_strings__sequence__content1 (us_split_fields3 temp___expr_549))) capacity)))))
(define-fun default_initial_assumption ((temp___expr_553 us_rep1) (temp___skip_top_level_554 Bool)) Bool (and (and (= (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs2 temp___expr_553))) capacity) (= (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length1 (us_split_fields3 temp___expr_553))) 0)) (= (rec__bounded_dynamic_strings__sequence__content1 (us_split_fields3 temp___expr_553)) (let ((temp___556 (temp___526 32 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs2 temp___expr_553)))))) (of_array4 (to_array1 temp___556) (first3 temp___556) (last3 temp___556))))))
(define-fun dynamic_predicate1 ((temp___557 us_rep1)) Bool (and (<= 0 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 (to_base temp___557))))) (<= (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 (to_base temp___557)))) (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 (to_base temp___557)))))))
...
(define-fun dynamic_property11 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range1 low) (and (in_range1 high) (=> (<= low high) (and (in_range3 low) (in_range3 high))))))
...
(declare-const o4 t4)
(declare-const temp___948 natural_index)
(declare-const temp___9481 natural_index)
(declare-const temp___9482 (Array Int character))
(declare-const temp___9483 t4)
(declare-const temp___949 us_rep1)
(declare-const temp___950 us_t5)
(declare-const result us_split_fields__ref1)
(declare-const result____split_fields3 us_split_fields2)
(define-fun temp___9484 () us_rep1 (mk___rep1 (mk___split_discrs temp___948) (mk___split_fields1 temp___9481 (mk___t4 temp___9482 temp___9483))))
(assert (in_range4 capacity))
(assert (dynamic_invariant content true false true true))
(assert (<= (length content) capacity))
(assert (and (= us capacity) (in_range4 capacity)))
...
(assert (= result____split_discrs (mk___split_discrs temp___948)))
(assert (= temp___9481 o2))
(assert (= temp___9482 o3))
(assert (= temp___9483 o4))
(assert (dynamic_predicate1 temp___9484))
(assert (= temp___949 temp___9484))
...
(assert (= result____split_fields3 (us_split_fields3 temp___949)))
(assert (= result____split_discrs (us_split_discrs2 temp___949)))
(assert (= (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length1 result____split_fields3)) r88b))
(assert (in_range4 r88b))
(assert (= (ite (<= (to_rep1 (first (rt content))) (to_rep1 (last (rt content)))) (+ (- (to_rep1 (last (rt content))) (to_rep1 (first (rt content)))) 1) 0) (ite (<= 1 r88b) (+ (- r88b 1) 1) 0)))
(assert (= temp___950 (mk___t5 (slide (elts content) (to_rep1 (first (rt content))) 1) (mk5 1 r88b))))
(assert (<= 1 r88b))
