...
(assert (= o temp___266))
(assert (= (mk2 1 (- (to_rep (rec__stack__stack__top (us_split_fields1 s))) 1)) temp___2661))
(assert (not (dynamic_property2 1 2147483647 (to_rep1 (first4 temp___2661)) (to_rep1 (last4 temp___2661)))))
(check-sat)
(exit)
