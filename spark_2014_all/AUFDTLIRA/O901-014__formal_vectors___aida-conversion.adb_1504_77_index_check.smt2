...
(assert (and (and (=> (<= (+ (to_rep1 (first (rt source))) 7) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 7) (+ (to_rep1 (first (rt source))) 10) index2)) (forall ((temp___1919 Int)) (=> (and (<= (to_rep1 n__first) temp___1919) (<= temp___1919 (to_rep1 n__last))) (=> (< index2 temp___1919) (= (select n3 temp___1919) (select n1 temp___1919)))))) (and (<= (+ (to_rep1 (first (rt source))) 7) index2) (<= index2 (+ (to_rep1 (first (rt source))) 10)))))
