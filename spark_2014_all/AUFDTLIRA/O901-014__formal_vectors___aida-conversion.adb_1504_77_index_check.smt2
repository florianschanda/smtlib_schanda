...
(assert (<= temp___1920 index2))
(assert (<= index2 temp___1921))
...
(assert (= n1 result4))
(assert (= n2 o41))
(assert (forall ((i2 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 7) i2) (<= i2 index3)) (and (<= 0 (to_rep1 (select n3 i2))) (<= (to_rep1 (select n3 i2)) 9)))))
(assert (forall ((j1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 7) j1) (<= j1 index3)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1))))))
(assert (and (and (=> (<= (+ (to_rep1 (first (rt source))) 7) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 7) (+ (to_rep1 (first (rt source))) 10) index3)) (forall ((temp___1919 Int)) (=> (and (<= (to_rep1 n__first) temp___1919) (<= temp___1919 (to_rep1 n__last))) (=> (< index3 temp___1919) (= (select n3 temp___1919) (select n1 temp___1919)))))) (and (<= (+ (to_rep1 (first (rt source))) 7) index3) (<= index3 (+ (to_rep1 (first (rt source))) 10)))))
(assert (and (= o48 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (= o49 (ite (<= o48 j) true false)))
(assert (= result6 (ite (= o49 true) (ite (<= j index3) true false) false)))
(assert (= result6 true))
(assert (and (<= (to_rep1 int_array__first) j) (<= j (to_rep1 int_array__last))))
(assert (= o50 j))
(assert (= o51 (select int_array1 o50)))
