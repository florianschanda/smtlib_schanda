...
(assert (<= temp___2022 index1))
(assert (<= index1 temp___2023))
...
(assert (and (and (=> (<= (+ (to_rep1 (first (rt source))) 7) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 7) (+ (to_rep1 (first (rt source))) 10) index2)) (forall ((temp___2021 Int)) (=> (and (<= (to_rep1 n__first) temp___2021) (<= temp___2021 (to_rep1 n__last))) (=> (< index2 temp___2021) (= (select n3 temp___2021) (select n1 temp___2021)))))) (and (<= (+ (to_rep1 (first (rt source))) 7) index2) (<= index2 (+ (to_rep1 (first (rt source))) 10)))))
