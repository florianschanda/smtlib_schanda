...
(define-fun dynamic_invariant1 ((temp___expr_135 Int) (temp___is_init_132 Bool) (temp___skip_constant_133 Bool) (temp___do_toplevel_134 Bool)) Bool (=> (or (= temp___is_init_132 true) (<= 0 10)) (in_range3 temp___expr_135)))
...
(define-fun dynamic_invariant5 ((temp___expr_141 Int) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool (=> (or (= temp___is_init_138 true) (<= 1 10)) (in_range4 temp___expr_141)))
...
(declare-const temp___176 str_length)
...
(declare-const temp___178 str_length)
(declare-const temp___1781 (Array Int character))
(declare-const temp___179 (Array Int character))
(declare-const temp___1791 t1)
(declare-const o8 (Array Int character))
(declare-const temp___182 (Array Int character))
