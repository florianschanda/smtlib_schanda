...
(assert (forall ((i str_length)) (and (<= 0 (str_lengthqtint i)) (<= (str_lengthqtint i) 10))))
...
(assert (forall ((i str_index)) (and (<= 1 (str_indexqtint i)) (<= (str_indexqtint i) 10))))
...
(declare-const o2 str_length)
(declare-const o3 str_length)
...
(assert (= rliteral target__split_fields2))
(assert (= target__split_fields1 target__split_fields3))
(assert (and (= o (length source)) (in_range (length source))))
(assert (= result2 (ite (<= o 10) true false)))
(assert (= result2 true))
(assert (and (= o1 (length source)) (in_range3 (length source))))
(assert (= (to_rep2 o2) o1))
(assert (= o2 o3))
(assert (= target__split_fields3 o4))
(assert (= temp___205 o3))
(assert (= temp___2051 o4))
