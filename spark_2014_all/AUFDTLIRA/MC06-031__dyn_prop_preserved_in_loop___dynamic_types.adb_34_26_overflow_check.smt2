...
(assert (and (or (and (= result__2 0) (forall ((i1 Int)) (=> (and (<= from2 i1) (<= i1 from3)) (not (= (to_rep (select (elts a) i1)) c))))) (and (and (<= (to_rep1 (first (rt a))) result__2) (<= result__2 (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) result__2)) c))) (and (dynamic_property1 first2 last2 from3) (in_range2 result__2))))
