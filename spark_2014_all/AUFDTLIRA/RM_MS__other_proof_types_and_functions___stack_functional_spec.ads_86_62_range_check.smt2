...
(assert (and (= o33 (state__2 (us_split_fields__content my_stack__split_fields4))) (= o33 (mk___rep (us_split_fields__content my_stack__split_fields4)))))
(assert (and (= o34 (count o33)) (and (in_range2 o34) (= o34 (to_rep1 (rec__stack_functional_spec__stack_type__pointer (us_split_fields1 o33)))))))
(assert (= o35 (- o34 2)))
(assert (= o36 (ite (<= i o35) true false)))
(assert (= result3 (ite (<= 1 i) o36 false)))
(assert (= (= o37 true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (- (count (state__2 (us_split_fields__content my_stack__split_fields4))) 2))) (= (stack_entry (state__2 (us_split_fields__content my_stack__split_fields4)) i1) (stack_entry (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1)) i1))))))
(assert (and (= o38 (state__2 (us_split_fields__content my_stack__split_fields4))) (= (us_split_fields__content my_stack__split_fields4) (mk___split_fields o27 o28))))
(assert (and (= o29 (count o38)) (and (in_range2 o29) (= o29 (to_rep1 o28)))))
(assert (and (= o30 (stack_entry (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1)) o29)) (and (in_range1 o30) (= o30 (to_rep (select (rec__stack_functional_spec__stack_type__s (us_split_fields1 (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1)))) o29))))))
(assert (and (= o39 (state__2 (us_split_fields__content my_stack__split_fields4))) (= (us_split_fields__content my_stack__split_fields4) (mk___split_fields o22 o23))))
(assert (and (= o24 (count o39)) (and (in_range2 o24) (= o24 (to_rep1 o23)))))
(assert (= o25 (- o24 1)))
(assert (and (= o26 o25) (in_range2 o25)))
(assert (and (= o40 (state__2 (us_split_fields__content my_stack__split_fields4))) (= (us_split_fields__content my_stack__split_fields4) (mk___split_fields o20 o21))))
(assert (and (= o31 (stack_entry o40 o26)) (and (in_range1 o31) (= o31 (to_rep (select o20 o26))))))
(assert (= o32 (ite (= o31 o30) true false)))
(assert (and (= o41 (state__2 (us_split_fields__content my_stack__split_fields4))) (= (us_split_fields__content my_stack__split_fields4) (mk___split_fields o16 o17))))
(assert (and (= o18 (count o41)) (and (in_range2 o18) (= o18 (to_rep1 o17)))))
(assert (= o19 (- o18 1)))
