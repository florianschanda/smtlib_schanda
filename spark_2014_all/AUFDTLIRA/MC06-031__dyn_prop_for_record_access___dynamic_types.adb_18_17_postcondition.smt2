...
(assert (= (mk___rep (mk___split_fields result5 result6)) (result_type__content dynamic_types__search__search_range__result11)))
(assert (not (or (and (= (to_rep (rec__dynamic_types__search__result_type__result (us_split_fields1 (result_type__content dynamic_types__search__search_range__result11)))) 0) (forall ((i Int)) (=> (and (<= from i) (<= i (to_rep1 (select (rec__dynamic_types__search__result_type__from (us_split_fields1 (result_type__content dynamic_types__search__search_range__result11))) 1)))) (not (= (to_rep (select (elts a) i)) c))))) (and (and (<= (to_rep1 (first1 (rt a))) (to_rep (rec__dynamic_types__search__result_type__result (us_split_fields1 (result_type__content dynamic_types__search__search_range__result11))))) (<= (to_rep (rec__dynamic_types__search__result_type__result (us_split_fields1 (result_type__content dynamic_types__search__search_range__result11)))) (to_rep1 (last1 (rt a))))) (= (to_rep (select (elts a) (to_rep (rec__dynamic_types__search__result_type__result (us_split_fields1 (result_type__content dynamic_types__search__search_range__result11)))))) c)))))
(check-sat)
(exit)
