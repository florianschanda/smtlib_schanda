...
(define-fun dynamic_invariant1 ((temp___expr_1269 Int) (temp___is_init_1266 Bool) (temp___skip_constant_1267 Bool) (temp___do_toplevel_1268 Bool)) Bool (=> (or (= temp___is_init_1266 true) (<= 0 4294967295)) (in_range3 temp___expr_1269)))
...
(define-fun dynamic_invariant2 ((temp___expr_1407 Int) (temp___is_init_1404 Bool) (temp___skip_constant_1405 Bool) (temp___do_toplevel_1406 Bool)) Bool (=> (or (= temp___is_init_1404 true) (<= 1 10)) (in_range4 temp___expr_1407)))
...
(declare-fun temp___1450 (Int Int Int) us_t4)
(assert (forall ((temp___1452 Int) (temp___1453 Int) (temp___1454 Int)) (let ((temp___1451 (temp___1450 temp___1452 temp___1453 temp___1454))) (and (=> (dynamic_property 1 2147483647 temp___1453 temp___1454) (and (= (first9 temp___1451) temp___1453) (= (last9 temp___1451) temp___1454))) (forall ((temp___1455 Int)) (= (select (to_array4 temp___1451) temp___1455) (of_rep temp___1452)))))))
...
(declare-const temp___1444 (Array Int character))
(declare-const temp___14441 t2)
(declare-const temp___1445 (Array Int character))
(declare-const temp___14451 t1)
(declare-const o5 (Array Int character))
(declare-const temp___1447 (Array Int character))
(declare-const temp___14471 t1)
(declare-const temp___1448 (Array Int character))
(declare-const temp___14481 t1)
(declare-const o6 (Array Int character))
(declare-const temp___1457 (Array Int character))
(declare-const temp___14571 t4)
(declare-const temp___1458 (Array Int character))
(declare-const temp___14581 t3)
(declare-const o7 (Array Int character))
(declare-const temp___1460 (Array Int character))
(declare-const temp___14601 t3)
...
(assert (= (to_rep1 str__first) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 num)))))))
(assert (= (to_rep1 str__last) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 num)))))))
...
(assert (= o4 str1))
(assert (= o4 temp___1444))
(assert (= (mk2 2 r10b) temp___14441))
(assert (not (= (ite (<= (to_rep1 (first4 temp___14441)) (to_rep1 (last4 temp___14441))) (+ (- (to_rep1 (last4 temp___14441)) (to_rep1 (first4 temp___14441))) 1) 0) (ite (<= 1 r6b) (+ (- r6b 1) 1) 0))))
(check-sat)
(exit)
