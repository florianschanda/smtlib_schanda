...
(assert (= result1 true))
(assert (and (and (and (and (and (and (= (is_open standard_output1) true) (= (mode__2 standard_output1) 1)) (= (let ((temp___802 (name standard_output))) (let ((temp___801 (name standard_output1))) (bool_eq (elts temp___801) (to_rep1 (first (rt temp___801))) (to_rep1 (last (rt temp___801))) (elts temp___802) (to_rep1 (first (rt temp___802))) (to_rep1 (last (rt temp___802)))))) true)) (= (let ((temp___804 (form standard_output))) (let ((temp___803 (form standard_output1))) (bool_eq (elts temp___803) (to_rep1 (first (rt temp___803))) (to_rep1 (last (rt temp___803))) (elts temp___804) (to_rep1 (first (rt temp___804))) (to_rep1 (last (rt temp___804)))))) true)) (= (line_length__2 standard_output1) (line_length__2 standard_output))) (= (page_length__2 standard_output1) (page_length__2 standard_output))) (= (is_standard_output standard_output1) true)))
(assert (= standard_error2 standard_error1))
(assert (and (= o2 (end_of_file__2 standard_input2)) (= (= o2 true) (= (end_of_file standard_input2) true))))
