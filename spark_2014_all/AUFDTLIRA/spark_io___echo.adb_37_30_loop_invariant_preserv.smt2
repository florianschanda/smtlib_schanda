...
(assert (= result1 true))
(assert (and (and (and (and (and (and (= (is_open standard_output2) true) (= (mode__2 standard_output2) 1)) (= (let ((temp___723 (name standard_output1))) (let ((temp___722 (name standard_output2))) (bool_eq (elts temp___722) (to_rep1 (first (rt temp___722))) (to_rep1 (last (rt temp___722))) (elts temp___723) (to_rep1 (first (rt temp___723))) (to_rep1 (last (rt temp___723)))))) true)) (= (let ((temp___725 (form standard_output1))) (let ((temp___724 (form standard_output2))) (bool_eq (elts temp___724) (to_rep1 (first (rt temp___724))) (to_rep1 (last (rt temp___724))) (elts temp___725) (to_rep1 (first (rt temp___725))) (to_rep1 (last (rt temp___725)))))) true)) (= (line_length__2 standard_output2) (line_length__2 standard_output1))) (= (page_length__2 standard_output2) (page_length__2 standard_output1))) (= (is_standard_output standard_output2) true)))
(assert (= standard_error2 standard_error1))
(assert (and (= o4 (end_of_file__2 standard_input2)) (= (= o4 true) (= (end_of_file standard_input2) true))))
