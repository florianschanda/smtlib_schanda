...
(assert (= result1 true))
(assert (and (and (and (and (and (and (= (is_open standard_output1) true) (= (mode__2 standard_output1) 1)) (= (let ((temp___809 (name standard_output))) (let ((temp___808 (name standard_output1))) (bool_eq (elts temp___808) (to_rep1 (first (rt temp___808))) (to_rep1 (last (rt temp___808))) (elts temp___809) (to_rep1 (first (rt temp___809))) (to_rep1 (last (rt temp___809)))))) true)) (= (let ((temp___811 (form standard_output))) (let ((temp___810 (form standard_output1))) (bool_eq (elts temp___810) (to_rep1 (first (rt temp___810))) (to_rep1 (last (rt temp___810))) (elts temp___811) (to_rep1 (first (rt temp___811))) (to_rep1 (last (rt temp___811)))))) true)) (= (line_length__2 standard_output1) (line_length__2 standard_output))) (= (page_length__2 standard_output1) (page_length__2 standard_output))) (= (is_standard_output standard_output1) true)))
