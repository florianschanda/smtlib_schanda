...
(assert (= result1 true))
(assert (and (and (and (and (and (and (= (is_open standard_output2) true) (= (mode__2 standard_output2) 1)) (= (let ((temp___729 (name standard_output1))) (let ((temp___728 (name standard_output2))) (bool_eq (elts temp___728) (to_rep1 (first (rt temp___728))) (to_rep1 (last (rt temp___728))) (elts temp___729) (to_rep1 (first (rt temp___729))) (to_rep1 (last (rt temp___729)))))) true)) (= (let ((temp___731 (form standard_output1))) (let ((temp___730 (form standard_output2))) (bool_eq (elts temp___730) (to_rep1 (first (rt temp___730))) (to_rep1 (last (rt temp___730))) (elts temp___731) (to_rep1 (first (rt temp___731))) (to_rep1 (last (rt temp___731)))))) true)) (= (line_length__2 standard_output2) (line_length__2 standard_output1))) (= (page_length__2 standard_output2) (page_length__2 standard_output1))) (= (is_standard_output standard_output2) true)))
