...
(define-fun dynamic_invariant1 ((temp___expr_139 Int) (temp___is_init_136 Bool) (temp___skip_constant_137 Bool) (temp___do_toplevel_138 Bool)) Bool (=> (or (= temp___is_init_136 true) (<= 0 100)) (in_range1 temp___expr_139)))
...
(define-fun dynamic_invariant2 ((temp___expr_145 Int) (temp___is_init_142 Bool) (temp___skip_constant_143 Bool) (temp___do_toplevel_144 Bool)) Bool (=> (or (= temp___is_init_142 true) (<= 1 100)) (in_range2 temp___expr_145)))
(declare-const x Int)
...
(assert (and (<= 1 pointer) (<= pointer 100)))
(assert (= o pointer))
(assert (= o1 (select s o)))
(assert (= o2 (to_rep o1)))
(assert (= result x))
(assert (= x1 o2))
