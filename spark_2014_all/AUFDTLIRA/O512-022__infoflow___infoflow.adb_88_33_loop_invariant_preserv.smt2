...
(assert (and (and (=> (<= 1 10) (in_range2 i9)) (forall ((temp___412 Int)) (=> (and (<= 1 temp___412) (<= temp___412 10)) (=> (< i9 temp___412) (= (select outkeys_v22 temp___412) (select outkeys_v2 temp___412)))))) (and (<= 1 i9) (<= i9 10))))
(assert (not (= i9 10)))
(assert (= result4 i9))
(assert (= i10 (+ i9 1)))
