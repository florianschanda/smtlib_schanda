...
(assert (forall ((k Int)) (=> (and (<= 1 k) (<= k 10)) (=> (<= k i12) (= (to_rep (select outkeys_v23 k)) (to_rep (select inkeys_v2 k)))))))
(assert (and (and (=> (<= 1 10) (in_range2 i12)) (forall ((temp___369 Int)) (=> (and (<= 1 temp___369) (<= temp___369 10)) (=> (< i12 temp___369) (= (select outkeys_v23 temp___369) (select outkeys_v2 temp___369)))))) (and (<= 1 i12) (<= i12 10))))
(assert (not (= i12 10)))
(assert (= result6 i12))
(assert (= i13 (+ i12 1)))
(assert (= (to_rep o6) (to_rep (select inkeys_v2 i13))))
(assert (= o7 (store outkeys_v23 i13 o6)))
(assert (= result7 outkeys_v23))
(assert (= outkeys_v24 o7))
(assert (= i13 i14))
(assert (= outkeys_v24 outkeys_v25))
(assert (= i15 i13))
(assert (= outkeys_v26 outkeys_v24))
(declare-const k Int)
(assert (<= 1 k))
(assert (<= k 10))
(assert (<= k i14))
(assert (not (= (to_rep (select outkeys_v25 k)) (to_rep (select inkeys_v2 k)))))
(check-sat)
(exit)
