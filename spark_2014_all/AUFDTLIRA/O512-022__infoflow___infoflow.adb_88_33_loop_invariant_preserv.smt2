...
(assert (and (and (=> (<= 1 10) (in_range2 i9)) (forall ((temp___369 Int)) (=> (and (<= 1 temp___369) (<= temp___369 10)) (=> (< i9 temp___369) (= (select outkeys_v22 temp___369) (select outkeys_v2 temp___369)))))) (and (<= 1 i9) (<= i9 10))))
(assert (not (= i9 10)))
(assert (= result4 i9))
(assert (= i10 (+ i9 1)))
