...
(declare-const temp___879 (Array Int character))
(declare-const temp___8791 t)
...
(assert (=> (and (<= (to_rep1 input__first) i3) (<= i3 (to_rep1 input__last))) (= o16 (to_rep3 o15))))
(assert (=> (and (<= (to_rep1 input__first) i3) (<= i3 (to_rep1 input__last))) (= o17 (attr__ATTRIBUTE_IMAGE5 o16))))
(assert (=> (and (<= (to_rep1 input__first) i3) (<= i3 (to_rep1 input__last))) (= (mk___t temp___853 temp___8531) (to_string o17))))
(assert (=> (and (<= (to_rep1 input__first) i3) (<= i3 (to_rep1 input__last))) (=> (<= (to_rep1 (first temp___8531)) (to_rep1 (last temp___8531))) (= o18 (+ (- (to_rep1 (last temp___8531)) (to_rep1 (first temp___8531))) 1)))))
(assert (=> (and (<= (to_rep1 input__first) i3) (<= i3 (to_rep1 input__last))) (=> (not (<= (to_rep1 (first temp___8531)) (to_rep1 (last temp___8531)))) (= o18 0))))
...
(assert (=> (and (<= (to_rep1 input__first) i3) (<= i3 (to_rep1 input__last))) (= o24 (concat1 (temp___String_Literal_851 Tuple0) 1 1 temp___853 (to_rep1 (first temp___8531)) (to_rep1 (last temp___8531))))))
...
(assert (= i9 0))
(assert (=> (and (<= 0 i9) (<= i9 (- (to_rep2 (rec__patience__state__numelts (us_split_fields1 c60b))) 1))) (and (<= 0 i10) (<= i10 (- (to_rep2 (rec__patience__state__numelts (us_split_fields1 c60b))) 1)))))
(assert (=> (and (<= 0 i9) (<= i9 (- (to_rep2 (rec__patience__state__numelts (us_split_fields1 c60b))) 1))) (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep3 (select (rec__patience__state__values (us_split_fields1 c60b)) i10))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep3 (select (rec__patience__state__values (us_split_fields1 c60b)) i10)))))))) (= o34 (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep3 (select (rec__patience__state__values (us_split_fields1 c60b)) i10))))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep3 (select (rec__patience__state__values (us_split_fields1 c60b)) i10)))))))) 1)))))
(assert (=> (and (<= 0 i9) (<= i9 (- (to_rep2 (rec__patience__state__numelts (us_split_fields1 c60b))) 1))) (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep3 (select (rec__patience__state__values (us_split_fields1 c60b)) i10))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep3 (select (rec__patience__state__values (us_split_fields1 c60b)) i10))))))))) (= o34 0))))
(assert (=> (and (<= 0 i9) (<= i9 (- (to_rep2 (rec__patience__state__numelts (us_split_fields1 c60b))) 1))) (=> (<= 1 1) (= o35 (+ (- 1 1) 1)))))
(assert (=> (and (<= 0 i9) (<= i9 (- (to_rep2 (rec__patience__state__numelts (us_split_fields1 c60b))) 1))) (=> (not (<= 1 1)) (= o35 0))))
(assert (=> (and (<= 0 i9) (<= i9 (- (to_rep2 (rec__patience__state__numelts (us_split_fields1 c60b))) 1))) (= o36 (+ o35 o34))))
(assert (=> (and (<= 0 i9) (<= i9 (- (to_rep2 (rec__patience__state__numelts (us_split_fields1 c60b))) 1))) (= o37 (+ 1 o36))))
(assert (=> (and (<= 0 i9) (<= i9 (- (to_rep2 (rec__patience__state__numelts (us_split_fields1 c60b))) 1))) (= o38 (- o37 1))))
(assert (=> (and (<= 0 i9) (<= i9 (- (to_rep2 (rec__patience__state__numelts (us_split_fields1 c60b))) 1))) (and (= o39 o38) (in_range2 o38))))
(assert (=> (and (<= 0 i9) (<= i9 (- (to_rep2 (rec__patience__state__numelts (us_split_fields1 c60b))) 1))) (= o40 (concat1 (temp___String_Literal_864 Tuple0) 1 1 (elts (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep3 (select (rec__patience__state__values (us_split_fields1 c60b)) i10))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep3 (select (rec__patience__state__values (us_split_fields1 c60b)) i10))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep3 (select (rec__patience__state__values (us_split_fields1 c60b)) i10)))))))))))
(assert (=> (and (<= 0 i9) (<= i9 (- (to_rep2 (rec__patience__state__numelts (us_split_fields1 c60b))) 1))) (= o41 (mk 1 o39))))
(assert (=> (and (<= 0 i9) (<= i9 (- (to_rep2 (rec__patience__state__numelts (us_split_fields1 c60b))) 1))) (= i10 (- (to_rep2 (rec__patience__state__numelts (us_split_fields1 c60b))) 1))))
(assert (=> (and (<= 0 i9) (<= i9 (- (to_rep2 (rec__patience__state__numelts (us_split_fields1 c60b))) 1))) (= i11 (mk_int__ref i10))))
(assert (=> (and (<= 0 i9) (<= i9 (- (to_rep2 (rec__patience__state__numelts (us_split_fields1 c60b))) 1))) (= i12 i10)))
(assert (=> (and (<= 0 i9) (<= i9 (- (to_rep2 (rec__patience__state__numelts (us_split_fields1 c60b))) 1))) (= i13 i11)))
(assert (=> (and (<= 0 i9) (<= i9 (- (to_rep2 (rec__patience__state__numelts (us_split_fields1 c60b))) 1))) (= i14 i12)))
(assert (=> (not (and (<= 0 i9) (<= i9 (- (to_rep2 (rec__patience__state__numelts (us_split_fields1 c60b))) 1)))) (= i13 (mk_int__ref i9))))
(assert (=> (not (and (<= 0 i9) (<= i9 (- (to_rep2 (rec__patience__state__numelts (us_split_fields1 c60b))) 1)))) (= i14 i9)))
(assert (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (rec__patience__state__numstacks (us_split_fields1 c60b)))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (rec__patience__state__numstacks (us_split_fields1 c60b))))))))) (= o42 (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (rec__patience__state__numstacks (us_split_fields1 c60b)))))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (rec__patience__state__numstacks (us_split_fields1 c60b))))))))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (rec__patience__state__numstacks (us_split_fields1 c60b)))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (rec__patience__state__numstacks (us_split_fields1 c60b)))))))))) (= o42 0)))
...
(assert (= o48 (concat1 (temp___String_Literal_869 Tuple0) 1 19 (elts (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (rec__patience__state__numstacks (us_split_fields1 c60b)))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (rec__patience__state__numstacks (us_split_fields1 c60b)))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (rec__patience__state__numstacks (us_split_fields1 c60b)))))))))))
(assert (= o49 (mk 1 o47)))
(assert (= result4 (mk_int__ref i2)))
(assert (= i15 0))
(assert (<= 0 i15))
(assert (<= i15 (- (to_rep2 (rec__patience__state__numstacks (us_split_fields1 c60b))) 1)))
(assert (and (<= 0 i16) (<= i16 (- (to_rep2 (rec__patience__state__numstacks (us_split_fields1 c60b))) 1))))
(assert (= result5 (mk_int__ref size)))
(assert (= size1 (to_rep2 (select (rec__patience__state__stacksizes (us_split_fields1 c60b)) i16))))
(assert (in_range4 size1))
(assert (=> (<= (- 1) 100) (in_range4 idx)))
(assert (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE4 i16))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE4 i16)))))) (= o50 (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE4 i16))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE4 i16)))))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE4 i16))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE4 i16))))))) (= o50 0)))
...
(assert (= (concat1 (temp___String_Literal_875 Tuple0) 1 6 (elts (to_string (attr__ATTRIBUTE_IMAGE4 i16))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE4 i16))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE4 i16)))))) temp___879))
(assert (= (mk 1 o55) temp___8791))
(assert (not (= (length (mk___t temp___879 temp___8791)) 0)))
(assert (=> (<= 1 10) (= o56 (+ (- 10 1) 1))))
(assert (=> (not (<= 1 10)) (= o56 0)))
(assert (=> (<= (to_rep1 (first temp___8791)) (to_rep1 (last temp___8791))) (= o57 (+ (- (to_rep1 (last temp___8791)) (to_rep1 (first temp___8791))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___8791)) (to_rep1 (last temp___8791)))) (= o57 0)))
(assert (= o58 (+ o57 o56)))
(assert (= o59 (+ (to_rep1 (first temp___8791)) o58)))
(assert (= o60 (- o59 1)))
(assert (not (in_range2 o60)))
(check-sat)
(exit)
