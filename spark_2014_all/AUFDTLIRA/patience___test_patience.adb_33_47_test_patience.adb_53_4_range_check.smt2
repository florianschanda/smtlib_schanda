...
(assert (=> (and (<= (to_rep1 input__first) i3) (<= i3 (to_rep1 input__last))) (= (mk___t temp___780 temp___7801) (to_string o17))))
(assert (=> (and (<= (to_rep1 input__first) i3) (<= i3 (to_rep1 input__last))) (=> (<= (to_rep1 (first temp___7801)) (to_rep1 (last temp___7801))) (= o18 (+ (- (to_rep1 (last temp___7801)) (to_rep1 (first temp___7801))) 1)))))
(assert (=> (and (<= (to_rep1 input__first) i3) (<= i3 (to_rep1 input__last))) (=> (not (<= (to_rep1 (first temp___7801)) (to_rep1 (last temp___7801)))) (= o18 0))))
...
(assert (=> (and (<= (to_rep1 input__first) i3) (<= i3 (to_rep1 input__last))) (= o24 (concat1 (temp___String_Literal_778 Tuple0) 1 1 temp___780 (to_rep1 (first temp___7801)) (to_rep1 (last temp___7801))))))
...
(assert (and (= (mk___rep (mk___split_fields temp___785 temp___7851 temp___7852 temp___7853 temp___7854 temp___7855 temp___7856 temp___7857)) (playgame (mk___t1 input1 (mk1 (to_rep1 input__first) (to_rep1 input__last))))) (= (inv (mk___rep (mk___split_fields temp___785 temp___7851 temp___7852 temp___7853 temp___7854 temp___7855 temp___7856 temp___7857))) true)))
...
(assert (= s__split_fields8 (mk___split_fields temp___785 temp___7851 temp___7852 temp___7853 temp___7854 temp___7855 temp___7856 temp___7857)))
...
(assert (= o32 (concat1 (temp___String_Literal_787 Tuple0) 1 17 (elts (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep3 (rec__patience__state__numelts (us_split_fields1 c60b)))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep3 (rec__patience__state__numelts (us_split_fields1 c60b)))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep3 (rec__patience__state__numelts (us_split_fields1 c60b)))))))))))
(assert (= o33 (mk 1 o31)))
...
(assert (=> (and (<= 0 i9) (<= i9 (- (to_rep3 (rec__patience__state__numelts (us_split_fields1 c60b))) 1))) (= o40 (concat1 (temp___String_Literal_791 Tuple0) 1 1 (elts (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (select (rec__patience__state__values (us_split_fields1 c60b)) i10))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (select (rec__patience__state__values (us_split_fields1 c60b)) i10))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (select (rec__patience__state__values (us_split_fields1 c60b)) i10)))))))))))
...
(assert (= o48 (concat1 (temp___String_Literal_798 Tuple0) 1 19 (elts (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep3 (rec__patience__state__numstacks (us_split_fields1 c60b)))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep3 (rec__patience__state__numstacks (us_split_fields1 c60b)))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep3 (rec__patience__state__numstacks (us_split_fields1 c60b)))))))))))
(assert (= o49 (mk 1 o47)))
...
(assert (= (concat1 (temp___String_Literal_802 Tuple0) 1 6 (elts (to_string (attr__ATTRIBUTE_IMAGE5 i16))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE5 i16))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE5 i16)))))) temp___806))
(assert (= (mk 1 o55) temp___8061))
(assert (not (= (length (mk___t temp___806 temp___8061)) 0)))
(assert (=> (<= 1 10) (= o56 (+ (- 10 1) 1))))
(assert (=> (not (<= 1 10)) (= o56 0)))
(assert (=> (<= (to_rep1 (first temp___8061)) (to_rep1 (last temp___8061))) (= o57 (+ (- (to_rep1 (last temp___8061)) (to_rep1 (first temp___8061))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___8061)) (to_rep1 (last temp___8061)))) (= o57 0)))
(assert (= o58 (+ o57 o56)))
(assert (= o59 (+ (to_rep1 (first temp___8061)) o58)))
(assert (= o60 (- o59 1)))
