...
(assert (not (= (length (mk___t temp___812 temp___8121)) 0)))
(assert (=> (<= 1 10) (= o56 (+ (- 10 1) 1))))
(assert (=> (not (<= 1 10)) (= o56 0)))
(assert (=> (<= (to_rep1 (first temp___8121)) (to_rep1 (last temp___8121))) (= o57 (+ (- (to_rep1 (last temp___8121)) (to_rep1 (first temp___8121))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___8121)) (to_rep1 (last temp___8121)))) (= o57 0)))
(assert (= o58 (+ o57 o56)))
(assert (= o59 (+ (to_rep1 (first temp___8121)) o58)))
(assert (= o60 (- o59 1)))
