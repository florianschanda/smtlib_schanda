...
(declare-const temp___884 (Array Int character))
(declare-const temp___8841 t)
...
(assert (=> (and (<= (to_rep1 input__first) i3) (<= i3 (to_rep1 input__last))) (= (mk___t temp___858 temp___8581) (to_string o17))))
(assert (=> (and (<= (to_rep1 input__first) i3) (<= i3 (to_rep1 input__last))) (=> (<= (to_rep1 (first temp___8581)) (to_rep1 (last temp___8581))) (= o18 (+ (- (to_rep1 (last temp___8581)) (to_rep1 (first temp___8581))) 1)))))
(assert (=> (and (<= (to_rep1 input__first) i3) (<= i3 (to_rep1 input__last))) (=> (not (<= (to_rep1 (first temp___8581)) (to_rep1 (last temp___8581)))) (= o18 0))))
...
(assert (=> (and (<= (to_rep1 input__first) i3) (<= i3 (to_rep1 input__last))) (= o24 (concat1 (temp___String_Literal_856 Tuple0) 1 1 temp___858 (to_rep1 (first temp___8581)) (to_rep1 (last temp___8581))))))
...
(assert (= o32 (concat1 (temp___String_Literal_865 Tuple0) 1 17 (elts (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep3 (rec__patience__state__numelts (us_split_fields1 c60b)))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep3 (rec__patience__state__numelts (us_split_fields1 c60b)))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep3 (rec__patience__state__numelts (us_split_fields1 c60b)))))))))))
(assert (= o33 (mk 1 o31)))
...
(assert (=> (and (<= 0 i9) (<= i9 (- (to_rep3 (rec__patience__state__numelts (us_split_fields1 c60b))) 1))) (= o40 (concat1 (temp___String_Literal_869 Tuple0) 1 1 (elts (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (select (rec__patience__state__values (us_split_fields1 c60b)) i10))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (select (rec__patience__state__values (us_split_fields1 c60b)) i10))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (select (rec__patience__state__values (us_split_fields1 c60b)) i10)))))))))))
...
(assert (= o48 (concat1 (temp___String_Literal_876 Tuple0) 1 19 (elts (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep3 (rec__patience__state__numstacks (us_split_fields1 c60b)))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep3 (rec__patience__state__numstacks (us_split_fields1 c60b)))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep3 (rec__patience__state__numstacks (us_split_fields1 c60b)))))))))))
(assert (= o49 (mk 1 o47)))
...
(assert (= (concat1 (temp___String_Literal_880 Tuple0) 1 6 (elts (to_string (attr__ATTRIBUTE_IMAGE5 i16))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE5 i16))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE5 i16)))))) temp___884))
(assert (= (mk 1 o55) temp___8841))
(assert (not (= (length (mk___t temp___884 temp___8841)) 0)))
(assert (=> (<= 1 10) (= o56 (+ (- 10 1) 1))))
(assert (=> (not (<= 1 10)) (= o56 0)))
(assert (=> (<= (to_rep1 (first temp___8841)) (to_rep1 (last temp___8841))) (= o57 (+ (- (to_rep1 (last temp___8841)) (to_rep1 (first temp___8841))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___8841)) (to_rep1 (last temp___8841)))) (= o57 0)))
(assert (= o58 (+ o57 o56)))
(assert (= o59 (+ (to_rep1 (first temp___8841)) o58)))
(assert (= o60 (- o59 1)))
