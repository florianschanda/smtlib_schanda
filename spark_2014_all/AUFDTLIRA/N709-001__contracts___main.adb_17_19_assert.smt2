...
(define-fun default_initial_assumption ((temp___expr_155 us_rep) (temp___skip_top_level_156 Bool)) Bool (= (attr__tag temp___expr_155) us_tag))
...
(assert true)
(assert true)
(assert (forall ((x us_rep)) (! (= (to_int1 (is_zero x)) (to_int1 (is_zero1 us_tag x))) :pattern ((is_zero1 us_tag x)))))
(assert (forall ((x us_rep)) (! (= (to_int1 (is_zero2 (of_base x))) (to_int1 (is_zero1 us_tag1 x))) :pattern ((is_zero1 us_tag1 x)))))
...
(assert (forall ((unit1__create__x__fields us_split_fields) (unit1__create__x__old__fields us_split_fields)) (forall ((x__attr__tag Int)) (! (=> (create__specific_post us_tag1 unit1__create__x__fields x__attr__tag unit1__create__x__old__fields) (let ((temp___x_163 (of_base (mk___rep unit1__create__x__fields x__attr__tag)))) (and (= (to_rep1 (rec__unit1__t1__c11 (us_split_fields3 temp___x_163))) 0) (= (to_rep1 (rec__unit2__t2__c2 (us_split_fields3 temp___x_163))) 0)))) :pattern ((create__specific_post us_tag1 unit1__create__x__fields x__attr__tag unit1__create__x__old__fields))))))
...
(assert (forall ((unit1__bump__x__fields us_split_fields) (unit1__bump__x__old__fields us_split_fields)) (forall ((x__attr__tag Int)) (! (=> (bump__specific_post us_tag1 unit1__bump__x__fields x__attr__tag unit1__bump__x__old__fields) (let ((temp___x_168 (of_base (mk___rep unit1__bump__x__old__fields x__attr__tag)))) (let ((temp___x_1681 (of_base (mk___rep unit1__bump__x__fields x__attr__tag)))) (and (= (to_rep1 (rec__unit1__t1__c11 (us_split_fields3 temp___x_1681))) (+ (to_rep1 (rec__unit1__t1__c11 (us_split_fields3 temp___x_168))) 1)) (= (to_rep1 (rec__unit2__t2__c2 (us_split_fields3 temp___x_1681))) (+ (to_rep1 (rec__unit2__t2__c2 (us_split_fields3 temp___x_168))) 1)))))) :pattern ((bump__specific_post us_tag1 unit1__bump__x__fields x__attr__tag unit1__bump__x__old__fields))))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_547 us_void_param) 1)) 83) (= (to_rep (select (temp___String_Literal_547 us_void_param) 2)) 117)) (= (to_rep (select (temp___String_Literal_547 us_void_param) 3)) 99)) (= (to_rep (select (temp___String_Literal_547 us_void_param) 4)) 99)) (= (to_rep (select (temp___String_Literal_547 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_547 us_void_param) 6)) 115)) (= (to_rep (select (temp___String_Literal_547 us_void_param) 7)) 115)) (= (to_rep (select (temp___String_Literal_547 us_void_param) 8)) 33)) :pattern ((temp___String_Literal_547 us_void_param)))))
...
(declare-const x2__split_fields3 integer)
(declare-const x2__split_fields4 integer)
(declare-const x2__split_fields5 us_private)
...
(assert (= (is_zero2 (mk___rep1 (mk___split_fields1 x2__split_fields x2__split_fields1 x2__split_fields2) x2__attr__tag)) true))
(assert (and (= (to_rep1 x2__split_fields4) (+ (to_rep1 x2__split_fields1) 1)) (= (to_rep1 x2__split_fields3) (+ (to_rep1 x2__split_fields) 1))))
(assert (not (not (= (is_max2 (mk___rep1 (mk___split_fields1 x2__split_fields3 x2__split_fields4 x2__split_fields5) x2__attr__tag)) true))))
(check-sat)
(exit)
