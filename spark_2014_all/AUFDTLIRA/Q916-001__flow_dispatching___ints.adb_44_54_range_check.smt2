...
(assert (not (= (length (mk___t temp___609 temp___6091)) 0)))
(assert (=> (<= 1 9) (= o26 (+ (- 9 1) 1))))
(assert (=> (not (<= 1 9)) (= o26 0)))
(assert (=> (<= (to_rep1 (first temp___6091)) (to_rep1 (last temp___6091))) (= o27 (+ (- (to_rep1 (last temp___6091)) (to_rep1 (first temp___6091))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___6091)) (to_rep1 (last temp___6091)))) (= o27 0)))
(assert (= o28 (+ o27 o26)))
(assert (= o29 (+ (to_rep1 (first temp___6091)) o28)))
(assert (= o30 (- o29 1)))
