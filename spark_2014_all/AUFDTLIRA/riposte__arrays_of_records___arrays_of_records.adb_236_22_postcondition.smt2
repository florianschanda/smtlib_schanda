...
(assert (= result1 a))
(assert (= a1 (store a i (mk___rep (mk___split_fields (of_int 0) (rec__arrays_of_records__basic_record__first_value (us_split_fields1 (select a i))) (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select a i))))))))
