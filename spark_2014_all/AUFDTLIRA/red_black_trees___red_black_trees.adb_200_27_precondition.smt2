...
(declare-const dummy5 (Array Int us_rep2))
...
(declare-fun user_eq5 ((Array Int us_rep2) (Array Int us_rep2)) Bool)
...
(define-fun dynamic_invariant ((temp___expr_158 Int) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool)) Bool (=> (or (= temp___is_init_155 true) (<= 0 100)) (in_range1 temp___expr_158)))
...
(define-fun dynamic_invariant1 ((temp___expr_378 us_rep4) (temp___is_init_375 Bool) (temp___skip_constant_376 Bool) (temp___do_toplevel_377 Bool)) Bool (and (ite (= (size (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_378))) 0) (= (to_rep (rec__search_trees__search_tree__root (us_split_fields7 temp___expr_378))) 0) (and (and (not (= (to_rep (rec__search_trees__search_tree__root (us_split_fields7 temp___expr_378))) 0)) (= (valid_root (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_378)) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 temp___expr_378)))) true)) (= (ordered_leafs (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_378)) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 temp___expr_378))) (rec__search_trees__search_tree__values (us_split_fields7 temp___expr_378))) true))) (= (tree_structure (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_378))) true)))
(define-fun default_initial_assumption ((temp___expr_383 us_rep4) (temp___skip_top_level_384 Bool)) Bool (and (and (and (= (to_rep (rec__search_trees__search_tree__root (us_split_fields7 temp___expr_383))) 0) (and (and (= (to_rep (rec__binary_trees__forest__s (us_split_fields5 (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_383))))) 0) (forall ((temp___387 Int)) (=> (and (<= 1 temp___387) (<= temp___387 100)) (and (and (and (= (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_383)))) temp___387)))) 0) (= (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_383)))) temp___387)))) 0)) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_383)))) temp___387)))) 0)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_383)))) temp___387)))) 2))))) (= (size (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_383))) 0))) (= (rec__search_trees__search_tree__values (us_split_fields7 temp___expr_383)) (temp___390 0))) (=> (not (= temp___skip_top_level_384 true)) (= (size1 temp___expr_383) 0))))
(define-fun type_invariant ((temp___395 us_rep4)) Bool (ite (= (size (rec__search_trees__search_tree__struct (us_split_fields7 temp___395))) 0) (= (to_rep (rec__search_trees__search_tree__root (us_split_fields7 temp___395))) 0) (and (and (not (= (to_rep (rec__search_trees__search_tree__root (us_split_fields7 temp___395))) 0)) (= (valid_root (rec__search_trees__search_tree__struct (us_split_fields7 temp___395)) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 temp___395)))) true)) (= (ordered_leafs (rec__search_trees__search_tree__struct (us_split_fields7 temp___395)) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 temp___395))) (rec__search_trees__search_tree__values (us_split_fields7 temp___395))) true))))
(assert (forall ((t us_rep4)) (! (=> (dynamic_invariant1 t true true true) (dynamic_invariant (size1 t) true false true)) :pattern ((size1 t)))))
(assert (forall ((t us_rep4)) (! (=> (dynamic_invariant1 t true true true) (= (size1 t) (size (rec__search_trees__search_tree__struct (us_split_fields7 t))))) :pattern ((size1 t)))))
...
(assert (forall ((t us_rep4)) (! (=> (and (dynamic_invariant1 t true true true) (not (= (size1 t) 0))) (dynamic_invariant2 (model__ t) true false true)) :pattern ((model__ t)))))
(assert (forall ((t us_rep4)) (! (=> (dynamic_invariant1 t true true true) (= (model__ t) (model__1 (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t)))))) :pattern ((model__ t)))))
...
(define-fun dynamic_invariant3 ((temp___expr_487 us_rep5) (temp___is_init_484 Bool) (temp___skip_constant_485 Bool) (temp___do_toplevel_486 Bool)) Bool (and (let ((temp___488 (rec__red_black_trees__rbt__struct (us_split_fields9 temp___expr_487)))) (ite (= (size (rec__search_trees__search_tree__struct (us_split_fields7 temp___488))) 0) (= (to_rep (rec__search_trees__search_tree__root (us_split_fields7 temp___488))) 0) (and (and (not (= (to_rep (rec__search_trees__search_tree__root (us_split_fields7 temp___488))) 0)) (= (valid_root (rec__search_trees__search_tree__struct (us_split_fields7 temp___488)) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 temp___488)))) true)) (= (ordered_leafs (rec__search_trees__search_tree__struct (us_split_fields7 temp___488)) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 temp___488))) (rec__search_trees__search_tree__values (us_split_fields7 temp___488))) true)))) (= (tree_structure (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 temp___expr_487))))) true)))
(define-fun default_initial_assumption2 ((temp___expr_493 us_rep5) (temp___skip_top_level_494 Bool)) Bool (and (and (and (and (= (to_rep (rec__search_trees__search_tree__root (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 temp___expr_493))))) 0) (and (and (= (to_rep (rec__binary_trees__forest__s (us_split_fields5 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 temp___expr_493))))))) 0) (forall ((temp___498 Int)) (=> (and (<= 1 temp___498) (<= temp___498 100)) (and (and (and (= (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 temp___expr_493)))))) temp___498)))) 0) (= (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 temp___expr_493)))))) temp___498)))) 0)) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 temp___expr_493)))))) temp___498)))) 0)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 temp___expr_493)))))) temp___498)))) 2))))) (= (size (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 temp___expr_493))))) 0))) (= (rec__search_trees__search_tree__values (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 temp___expr_493)))) (temp___390 0))) (= (size1 (rec__red_black_trees__rbt__struct (us_split_fields9 temp___expr_493))) 0)) (= (rec__red_black_trees__rbt__color (us_split_fields9 temp___expr_493)) (temp___502 0))))
...
(define-fun dynamic_invariant5 ((temp___expr_472 Int) (temp___is_init_469 Bool) (temp___skip_constant_470 Bool) (temp___do_toplevel_471 Bool)) Bool (=> (or (= temp___is_init_469 true) (<= 0 1)) (in_range5 temp___expr_472)))
(declare-fun same_nb_blacks (us_rep5) Bool)
(declare-fun same_nb_blacks__function_guard (Bool us_rep5) Bool)
(assert true)
(assert (forall ((t1 us_rep5)) (! (= (= (same_nb_blacks t1) true) (or (= (size1 (rec__red_black_trees__rbt__struct (us_split_fields9 t1))) 0) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (let ((temp___538 (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 t1))))) (select temp___538 i)))) true) (= (rec__red_black_trees__black_count__status (us_split_fields11 (let ((temp___537 (nb_blacks t1))) (select temp___537 i)))) true)))))) :pattern ((same_nb_blacks t1)))))
...
(define-fun dynamic_invariant6 ((temp___expr_152 Int) (temp___is_init_149 Bool) (temp___skip_constant_150 Bool) (temp___do_toplevel_151 Bool)) Bool (=> (or (= temp___is_init_149 true) (<= 1 100)) (in_range4 temp___expr_152)))
(define-fun dynamic_invariant7 ((temp___expr_164 Int) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool)) Bool (=> (or (= temp___is_init_161 true) (<= 0 2)) (in_range2 temp___expr_164)))
...
(define-fun dynamic_invariant8 ((temp___expr_170 Int) (temp___is_init_167 Bool) (temp___skip_constant_168 Bool) (temp___do_toplevel_169 Bool)) Bool (=> (or (= temp___is_init_167 true) (<= 0 1)) (in_range6 temp___expr_170)))
...
(define-fun default_initial_assumption3 ((temp___expr_209 us_rep1) (temp___skip_top_level_210 Bool)) Bool (and (= (length (rec__tree_model__path_type__a (us_split_fields1 temp___expr_209))) 0) (= (rec__tree_model__path_type__k (us_split_fields1 temp___expr_209)) (of_int 0))))
...
(define-fun default_initial_assumption4 ((temp___expr_201 us_rep) (temp___skip_top_level_202 Bool)) Bool (=> (not (= temp___skip_top_level_202 true)) (= (length temp___expr_201) 0)))
...
(assert (forall ((t1 us_rep4)) (forall ((i Int)) (! (=> (and (dynamic_invariant1 t1 true true true) (dynamic_invariant6 i true true true)) (let ((result (parent t1 i))) (and (=> (= (size1 t1) 0) (= result 0)) (dynamic_invariant result true false true)))) :pattern ((parent t1 i))))))
(assert (forall ((t1 us_rep4)) (forall ((i Int)) (! (=> (and (dynamic_invariant1 t1 true true true) (dynamic_invariant6 i true true true)) (= (parent t1 i) (parent1 (rec__search_trees__search_tree__struct (us_split_fields7 t1)) i))) :pattern ((parent t1 i))))))
(declare-fun peek1 (us_rep3 Int Int) Int)
(declare-fun peek__function_guard1 (Int us_rep3 Int Int) Bool)
(assert (forall ((t1 us_rep4)) (forall ((i Int) (d Int)) (! (=> (and (and (and (dynamic_invariant1 t1 true true true) (dynamic_invariant6 i true true true)) (dynamic_invariant8 d true true true)) (and (not (= (size1 t1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (let ((temp___422 (model__ t1))) (select temp___422 i)))) true))) (dynamic_invariant (peek t1 i d) true false true)) :pattern ((peek t1 i d))))))
(assert (forall ((t1 us_rep4)) (forall ((i Int) (d Int)) (! (=> (and (and (dynamic_invariant1 t1 true true true) (dynamic_invariant6 i true true true)) (dynamic_invariant8 d true true true)) (= (peek t1 i d) (peek1 (rec__search_trees__search_tree__struct (us_split_fields7 t1)) i d))) :pattern ((peek t1 i d))))))
...
(define-fun default_initial_assumption5 ((temp___expr_278 us_rep3) (temp___skip_top_level_279 Bool)) Bool (and (and (= (to_rep (rec__binary_trees__forest__s (us_split_fields5 temp___expr_278))) 0) (forall ((temp___281 Int)) (=> (and (<= 1 temp___281) (<= temp___281 100)) (and (and (and (= (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 temp___expr_278)) temp___281)))) 0) (= (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 temp___expr_278)) temp___281)))) 0)) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 temp___expr_278)) temp___281)))) 0)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 temp___expr_278)) temp___281)))) 2))))) (=> (not (= temp___skip_top_level_279 true)) (= (size temp___expr_278) 0))))
(define-fun type_invariant2 ((temp___284 us_rep3)) Bool (= (tree_structure temp___284) true))
(assert true)
(assert (forall ((f us_rep3)) (! (=> (dynamic_invariant11 f true true true) (dynamic_invariant (size f) true false true)) :pattern ((size f)))))
(assert (forall ((f us_rep3)) (forall ((i Int)) (! (=> (and (dynamic_invariant11 f true true true) (dynamic_invariant6 i true true true)) (=> (< (size f) i) (not (= (valid_root f i) true)))) :pattern ((valid_root f i))))))
(assert (forall ((f us_rep3)) (forall ((i Int)) (! (=> (and (dynamic_invariant11 f true true true) (dynamic_invariant6 i true true true)) (let ((result (parent1 f i))) (and (and (=> (= (valid_root f i) true) (= result 0)) (=> (= (size f) 0) (= result 0))) (dynamic_invariant result true false true)))) :pattern ((parent1 f i))))))
(declare-fun position (us_rep3 Int) Int)
(declare-fun position__function_guard (Int us_rep3 Int) Bool)
(assert (forall ((f us_rep3)) (forall ((i Int)) (! (=> (and (and (dynamic_invariant11 f true true true) (dynamic_invariant6 i true true true)) (not (= (parent1 f i) 0))) (dynamic_invariant8 (position f i) true false true)) :pattern ((position f i))))))
(assert (forall ((f us_rep3)) (forall ((i Int) (d Int)) (! (=> (and (and (dynamic_invariant11 f true true true) (dynamic_invariant6 i true true true)) (dynamic_invariant8 d true true true)) (let ((result (peek1 f i d))) (and (and (ite (not (= result 0)) (and (= (position f result) d) (= (parent1 f result) i)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (parent1 f j) i) (not (= (position f j) d)))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (parent1 f j) i) (= (position f j) d)) (= result j))))) (dynamic_invariant result true false true)))) :pattern ((peek1 f i d))))))
(assert (forall ((f us_rep3)) (forall ((root Int)) (! (=> (and (and (dynamic_invariant11 f true true true) (dynamic_invariant6 root true true true)) (= (valid_root f root) true)) (let ((result (model__1 f root))) (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select result root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select result root)))) 0) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= i root)) (ite (and (not (= (parent1 f i) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select result (parent1 f i)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select result i))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select result i))) true)))))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select result i))) true) (not (= i root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select result (parent1 f i)))) (position f i) (rec__tree_model__path_type__a (us_split_fields1 (select result i)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select result i)))) 0)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select result i))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select result j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select result i))) (rec__tree_model__path_type__a (us_split_fields1 (select result j)))) true)) (= j i))))))))))) (dynamic_invariant2 result true false true)))) :pattern ((model__1 f root))))))
...
(declare-const i Int)
(declare-const temp___986 (Array Int us_rep1))
(declare-const o us_rep)
(declare-const o1 Bool)
(declare-const o2 us_rep)
(declare-const o3 Bool)
(declare-const temp___985 (Array Int us_rep6))
(declare-const o4 Int)
(declare-const result Bool)
(declare-const result1 Bool)
(assert (dynamic_invariant3 t true false true))
(assert (and (= o4 (size1 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) (and (in_range1 o4) (= o4 (size (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))))))))
(assert (= result (ite (= o4 0) true false)))
(assert (not (= result true)))
(assert (<= 1 i))
(assert (<= i 100))
(assert (and (= temp___986 (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) (and (dynamic_invariant2 temp___986 true false true) (= temp___986 (model__1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 t))))))))))
(assert (= (mk___rep (mk___split_fields o o1)) (select temp___986 i)))
(assert (= o o2))
(assert (= o1 o3))
(assert (= result1 o3))
(assert (= result1 true))
(assert (not (not (= (size1 (rec__red_black_trees__rbt__struct (us_split_fields9 t))) 0))))
(check-sat)
(exit)
