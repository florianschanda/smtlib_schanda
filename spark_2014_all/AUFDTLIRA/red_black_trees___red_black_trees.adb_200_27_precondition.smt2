...
(define-fun dynamic_invariant1 ((temp___expr_422 us_rep4) (temp___is_init_418 Bool) (temp___skip_constant_419 Bool) (temp___do_toplevel_420 Bool) (temp___do_typ_inv_421 Bool)) Bool (and (=> (= temp___do_typ_inv_421 true) (ite (= (size (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_422))) 0) (= (to_rep (rec__search_trees__search_tree__root (us_split_fields7 temp___expr_422))) 0) (and (and (not (= (to_rep (rec__search_trees__search_tree__root (us_split_fields7 temp___expr_422))) 0)) (= (valid_root (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_422)) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 temp___expr_422)))) true)) (= (ordered_leafs (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_422)) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 temp___expr_422))) (rec__search_trees__search_tree__values (us_split_fields7 temp___expr_422))) true)))) (=> (= temp___do_typ_inv_421 true) (= (tree_structure (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_422))) true))))
(define-fun default_initial_assumption ((temp___expr_427 us_rep4) (temp___skip_top_level_428 Bool)) Bool (and (and (and (= (to_rep (rec__search_trees__search_tree__root (us_split_fields7 temp___expr_427))) 0) (and (and (= (to_rep (rec__binary_trees__forest__s (us_split_fields5 (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_427))))) 0) (forall ((temp___431 Int)) (=> (and (<= 1 temp___431) (<= temp___431 100)) (and (and (and (= (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_427)))) temp___431)))) 0) (= (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_427)))) temp___431)))) 0)) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_427)))) temp___431)))) 0)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_427)))) temp___431)))) 2))))) (= (size (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_427))) 0))) (= (rec__search_trees__search_tree__values (us_split_fields7 temp___expr_427)) (temp___434 0))) (=> (not (= temp___skip_top_level_428 true)) (= (size1 temp___expr_427) 0))))
(define-fun type_invariant ((temp___439 us_rep4)) Bool (ite (= (size (rec__search_trees__search_tree__struct (us_split_fields7 temp___439))) 0) (= (to_rep (rec__search_trees__search_tree__root (us_split_fields7 temp___439))) 0) (and (and (not (= (to_rep (rec__search_trees__search_tree__root (us_split_fields7 temp___439))) 0)) (= (valid_root (rec__search_trees__search_tree__struct (us_split_fields7 temp___439)) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 temp___439)))) true)) (= (ordered_leafs (rec__search_trees__search_tree__struct (us_split_fields7 temp___439)) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 temp___439))) (rec__search_trees__search_tree__values (us_split_fields7 temp___439))) true))))
(assert (forall ((t us_rep4)) (! (=> (dynamic_invariant1 t true true true true) (dynamic_invariant (size1 t) true false true true)) :pattern ((size1 t)))))
(assert (forall ((t us_rep4)) (! (=> (dynamic_invariant1 t true true true true) (= (size1 t) (size (rec__search_trees__search_tree__struct (us_split_fields7 t))))) :pattern ((size1 t)))))
...
(assert (forall ((t us_rep4)) (! (=> (and (dynamic_invariant1 t true true true true) (not (= (size1 t) 0))) (dynamic_invariant2 (model__ t) true false true true)) :pattern ((model__ t)))))
(assert (forall ((t us_rep4)) (! (=> (dynamic_invariant1 t true true true true) (= (model__ t) (model__1 (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t)))))) :pattern ((model__ t)))))
...
(define-fun dynamic_invariant3 ((temp___expr_534 us_rep5) (temp___is_init_530 Bool) (temp___skip_constant_531 Bool) (temp___do_toplevel_532 Bool) (temp___do_typ_inv_533 Bool)) Bool (and (=> (= temp___do_typ_inv_533 true) (let ((temp___535 (rec__red_black_trees__rbt__struct (us_split_fields9 temp___expr_534)))) (ite (= (size (rec__search_trees__search_tree__struct (us_split_fields7 temp___535))) 0) (= (to_rep (rec__search_trees__search_tree__root (us_split_fields7 temp___535))) 0) (and (and (not (= (to_rep (rec__search_trees__search_tree__root (us_split_fields7 temp___535))) 0)) (= (valid_root (rec__search_trees__search_tree__struct (us_split_fields7 temp___535)) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 temp___535)))) true)) (= (ordered_leafs (rec__search_trees__search_tree__struct (us_split_fields7 temp___535)) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 temp___535))) (rec__search_trees__search_tree__values (us_split_fields7 temp___535))) true))))) (=> (= temp___do_typ_inv_533 true) (= (tree_structure (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 temp___expr_534))))) true))))
(define-fun default_initial_assumption2 ((temp___expr_540 us_rep5) (temp___skip_top_level_541 Bool)) Bool (and (and (and (and (= (to_rep (rec__search_trees__search_tree__root (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 temp___expr_540))))) 0) (and (and (= (to_rep (rec__binary_trees__forest__s (us_split_fields5 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 temp___expr_540))))))) 0) (forall ((temp___545 Int)) (=> (and (<= 1 temp___545) (<= temp___545 100)) (and (and (and (= (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 temp___expr_540)))))) temp___545)))) 0) (= (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 temp___expr_540)))))) temp___545)))) 0)) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 temp___expr_540)))))) temp___545)))) 0)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 temp___expr_540)))))) temp___545)))) 2))))) (= (size (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 temp___expr_540))))) 0))) (= (rec__search_trees__search_tree__values (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 temp___expr_540)))) (temp___434 0))) (= (size1 (rec__red_black_trees__rbt__struct (us_split_fields9 temp___expr_540))) 0)) (= (rec__red_black_trees__rbt__color (us_split_fields9 temp___expr_540)) (temp___549 0))))
...
(assert (forall ((temp___551 Int)) (=> (dynamic_invariant5 temp___551 true true true true) (forall ((temp___552 Int)) (= (to_rep3 (select (temp___549 temp___551) temp___552)) temp___551)))))
(declare-fun same_nb_blacks (us_rep5) Bool)
(declare-fun same_nb_blacks__function_guard (Bool us_rep5) Bool)
(assert true)
(assert (forall ((t1 us_rep5)) (! (= (= (same_nb_blacks t1) true) (or (= (size1 (rec__red_black_trees__rbt__struct (us_split_fields9 t1))) 0) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (let ((temp___585 (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 t1))))) (select temp___585 i)))) true) (= (rec__red_black_trees__black_count__status (us_split_fields11 (let ((temp___584 (nb_blacks t1))) (select temp___584 i)))) true)))))) :pattern ((same_nb_blacks t1)))))
...
(define-fun default_initial_assumption3 ((temp___expr_243 us_rep1) (temp___skip_top_level_244 Bool)) Bool (and (= (length (rec__tree_model__path_type__a (us_split_fields1 temp___expr_243))) 0) (= (rec__tree_model__path_type__k (us_split_fields1 temp___expr_243)) (distinct 0 0))))
...
(define-fun default_initial_assumption4 ((temp___expr_234 us_rep) (temp___skip_top_level_235 Bool)) Bool (=> (not (= temp___skip_top_level_235 true)) (= (length temp___expr_234) 0)))
...
(assert (forall ((t1 us_rep4)) (forall ((i Int)) (! (=> (and (dynamic_invariant1 t1 true true true true) (dynamic_invariant6 i true true true true)) (let ((result (parent t1 i))) (and (=> (= (size1 t1) 0) (= result 0)) (dynamic_invariant result true false true true)))) :pattern ((parent t1 i))))))
(assert (forall ((t1 us_rep4)) (forall ((i Int)) (! (=> (and (dynamic_invariant1 t1 true true true true) (dynamic_invariant6 i true true true true)) (= (parent t1 i) (parent1 (rec__search_trees__search_tree__struct (us_split_fields7 t1)) i))) :pattern ((parent t1 i))))))
(declare-fun peek1 (us_rep3 Int Int) Int)
(declare-fun peek__function_guard1 (Int us_rep3 Int Int) Bool)
(assert (forall ((t1 us_rep4)) (forall ((i Int) (d Int)) (! (=> (and (and (and (dynamic_invariant1 t1 true true true true) (dynamic_invariant6 i true true true true)) (dynamic_invariant8 d true true true true)) (and (not (= (size1 t1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (let ((temp___466 (model__ t1))) (select temp___466 i)))) true))) (dynamic_invariant (peek t1 i d) true false true true)) :pattern ((peek t1 i d))))))
(assert (forall ((t1 us_rep4)) (forall ((i Int) (d Int)) (! (=> (and (and (dynamic_invariant1 t1 true true true true) (dynamic_invariant6 i true true true true)) (dynamic_invariant8 d true true true true)) (= (peek t1 i d) (peek1 (rec__search_trees__search_tree__struct (us_split_fields7 t1)) i d))) :pattern ((peek t1 i d))))))
(assert (forall ((temp___436 Int)) (=> (dynamic_invariant4 temp___436 true true true true) (forall ((temp___437 Int)) (= (to_rep2 (select (temp___434 temp___436) temp___437)) temp___436)))))
...
(define-fun default_initial_assumption5 ((temp___expr_320 us_rep3) (temp___skip_top_level_321 Bool)) Bool (and (and (= (to_rep (rec__binary_trees__forest__s (us_split_fields5 temp___expr_320))) 0) (forall ((temp___323 Int)) (=> (and (<= 1 temp___323) (<= temp___323 100)) (and (and (and (= (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 temp___expr_320)) temp___323)))) 0) (= (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 temp___expr_320)) temp___323)))) 0)) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 temp___expr_320)) temp___323)))) 0)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 temp___expr_320)) temp___323)))) 2))))) (=> (not (= temp___skip_top_level_321 true)) (= (size temp___expr_320) 0))))
(define-fun type_invariant2 ((temp___326 us_rep3)) Bool (= (tree_structure temp___326) true))
(assert true)
(assert (forall ((f us_rep3)) (! (=> (dynamic_invariant11 f true true true true) (dynamic_invariant (size f) true false true true)) :pattern ((size f)))))
(assert (forall ((f us_rep3)) (forall ((i Int)) (! (=> (and (dynamic_invariant11 f true true true true) (dynamic_invariant6 i true true true true)) (=> (< (size f) i) (not (= (valid_root f i) true)))) :pattern ((valid_root f i))))))
(assert (forall ((f us_rep3)) (forall ((i Int)) (! (=> (and (dynamic_invariant11 f true true true true) (dynamic_invariant6 i true true true true)) (let ((result (parent1 f i))) (and (and (=> (= (valid_root f i) true) (= result 0)) (=> (= (size f) 0) (= result 0))) (dynamic_invariant result true false true true)))) :pattern ((parent1 f i))))))
(declare-fun position (us_rep3 Int) Int)
(declare-fun position__function_guard (Int us_rep3 Int) Bool)
(assert (forall ((f us_rep3)) (forall ((i Int)) (! (=> (and (and (dynamic_invariant11 f true true true true) (dynamic_invariant6 i true true true true)) (not (= (parent1 f i) 0))) (dynamic_invariant8 (position f i) true false true true)) :pattern ((position f i))))))
(assert (forall ((f us_rep3)) (forall ((i Int) (d Int)) (! (=> (and (and (dynamic_invariant11 f true true true true) (dynamic_invariant6 i true true true true)) (dynamic_invariant8 d true true true true)) (let ((result (peek1 f i d))) (and (and (ite (not (= result 0)) (and (= (position f result) d) (= (parent1 f result) i)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (parent1 f j) i) (not (= (position f j) d)))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (parent1 f j) i) (= (position f j) d)) (= result j))))) (dynamic_invariant result true false true true)))) :pattern ((peek1 f i d))))))
(assert (forall ((f us_rep3)) (forall ((root Int)) (! (=> (and (and (dynamic_invariant11 f true true true true) (dynamic_invariant6 root true true true true)) (= (valid_root f root) true)) (let ((result (model__1 f root))) (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select result root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select result root)))) 0) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= i root)) (ite (and (not (= (parent1 f i) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select result (parent1 f i)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select result i))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select result i))) true)))))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select result i))) true) (not (= i root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select result (parent1 f i)))) (position f i) (rec__tree_model__path_type__a (us_split_fields1 (select result i)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select result i)))) 0)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select result i))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select result j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select result i))) (rec__tree_model__path_type__a (us_split_fields1 (select result j)))) true)) (= j i))))))))))) (dynamic_invariant2 result true false true true)))) :pattern ((model__1 f root))))))
...
(assert (<= 1 i))
(assert (<= i 100))
(assert (and (= temp___1035 (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) (and (dynamic_invariant2 temp___1035 true false true true) (= temp___1035 (model__1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 t))))))))))
(assert (= (mk___rep (mk___split_fields o o1)) (select temp___1035 i)))
(assert (= o o2))
(assert (= o1 o3))
(assert (= result1 o3))
(assert (= result1 true))
