...
(assert (not (= (ite (<= (to_rep1 (first (rt v))) (to_rep1 (last (rt v)))) (+ (- (to_rep1 (last (rt v))) (to_rep1 (first (rt v)))) 1) 0) (ite (<= (to_rep1 (first (rt x))) (to_rep1 (last (rt x)))) (+ (- (to_rep1 (last (rt x))) (to_rep1 (first (rt x)))) 1) 0))))
(check-sat)
(exit)
