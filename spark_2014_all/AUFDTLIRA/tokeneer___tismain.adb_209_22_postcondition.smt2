...
(declare-const thestats__split_fields1 us_split_fields__ref1)
(declare-const theadmin__split_fields1 us_split_fields__ref)
...
(declare-const writtenstate1 us_private__ref)
...
(assert (= o (privatekeypresent state4)))
(assert (= o1 (privatekeypresent state4)))
(assert (and (and (not (= (isgood state11) true)) (not (= (authcertvalid state11) true))) (not (in_range7 (theauthcertrole state11)))))
(assert (and (= (= (privatekeypresent state4) true) (not (= (enrolmentisinprogress (let ((subject state)) state12)) true))) (or (= (enrolmentisinprogress (let ((subject state)) state12)) true) (= (statusisenclavequiescent (let ((subject state)) state12)) true))))
(assert (= result (privatekeypresent state4)))
(assert (=> (= result true) (= (valid_numberlogentries state13) true)))
(assert (=> (not (= result true)) (= (valid_numberlogentries state14) true)))
(assert (=> (not (= result true)) (= filestate2 filestate3)))
(assert (=> (not (= result true)) (= state13 state14)))
(assert (= state26 (let ((subject state)) (mk___private__ref state12))))
(assert (= status4 (let ((subject status)) (mk___private__ref status1))))
(assert (= state25 (mk___private__ref state10)))
(assert (= output1 (mk___private__ref output)))
(assert (= state24 (mk___private__ref state6)))
(assert (= writtenstate1 (mk___private__ref writtenstate)))
(assert (= state23 (mk___private__ref state1)))
(assert (= state22 (mk___private__ref state5)))
(assert (= state21 (mk___private__ref state9)))
(assert (= filestate6 (mk___private__ref filestate1)))
(assert (= state20 (mk___private__ref state8)))
(assert (= state19 (mk___private__ref state7)))
(assert (= status3 (mk___private__ref status2)))
(assert (= state18 (mk___private__ref state11)))
(assert (= state17 (mk___private__ref state4)))
(assert (= filestate5 (mk___private__ref filestate2)))
(assert (= state16 (mk___private__ref state13)))
(assert (= state15 (mk___private__ref state2)))
(assert (= filestate4 (mk___private__ref filestate)))
(assert (= theadmin__split_fields1 (mk___split_fields__ref theadmin__split_fields)))
(assert (= thestats__split_fields1 (mk___split_fields__ref1 thestats__split_fields)))
(assert (= state38 state12))
(assert (= status6 status1))
(assert (= state37 state10))
(assert (= output2 output))
(assert (= state36 state6))
(assert (= writtenstate2 writtenstate))
(assert (= state35 state1))
(assert (= state34 state5))
(assert (= state33 state9))
(assert (= filestate9 filestate1))
(assert (= state32 state8))
(assert (= state31 state7))
(assert (= status5 status2))
(assert (= state30 state11))
(assert (= state29 state4))
(assert (= filestate8 filestate2))
(assert (= state28 state13))
(assert (= state27 state2))
(assert (= filestate7 filestate))
(assert (= theadmin__split_fields2 theadmin__split_fields))
(assert (= thestats__split_fields2 thestats__split_fields))
(assert (not (= (enrolmentisinprogress (us_private__content state26)) true)))
(assert (not (= (privatekeypresent (us_private__content state17)) true)))
(check-sat)
(exit)
