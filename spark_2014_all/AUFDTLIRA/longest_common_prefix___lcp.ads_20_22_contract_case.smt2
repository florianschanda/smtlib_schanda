...
(assert (=> (= result1 true) (=> (= result7 true) (and (= temp___1631 (+ y l3)) (in_range1 (+ y l3))))))
(assert (=> (= result1 true) (=> (= result7 true) (and (<= (to_rep (first (rt a))) temp___1631) (<= temp___1631 (to_rep (last (rt a))))))))
...
(assert (=> (= result1 true) (=> (= result7 true) (and (= temp___1621 (+ x l3)) (in_range1 (+ x l3))))))
(assert (=> (= result1 true) (=> (= result7 true) (and (<= (to_rep (first (rt a))) temp___1621) (<= temp___1621 (to_rep (last (rt a))))))))
