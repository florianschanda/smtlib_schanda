...
(assert (forall ((t us_rep2)) (! (=> (and (dynamic_invariant t true true true) (type_invariant t)) (dynamic_invariant1 (size1 t) true false true)) :pattern ((size1 t)))))
(assert (forall ((t us_rep2)) (! (=> (dynamic_invariant t true true true) (= (size1 t) (size (rec__search_trees__search_tree__struct (us_split_fields5 t))))) :pattern ((size1 t)))))
...
(define-fun dynamic_invariant3 ((temp___expr_150 Int) (temp___is_init_147 Bool) (temp___skip_constant_148 Bool) (temp___do_toplevel_149 Bool)) Bool (=> (or (= temp___is_init_147 true) (<= 1 100)) (in_range temp___expr_150)))
...
(assert (forall ((f us_rep1)) (! (=> (dynamic_invariant4 f true true true) (dynamic_invariant1 (size f) true false true)) :pattern ((size f)))))
(assert (forall ((f us_rep1)) (forall ((i Int)) (! (=> (and (dynamic_invariant4 f true true true) (dynamic_invariant3 i true true true)) (=> (< (size f) i) (not (= (valid_root f i) true)))) :pattern ((valid_root f i))))))
(declare-fun parent (us_rep1 Int) Int)
(declare-fun parent__function_guard (Int us_rep1 Int) Bool)
(assert (forall ((f us_rep1)) (forall ((i Int)) (! (=> (and (dynamic_invariant4 f true true true) (dynamic_invariant3 i true true true)) (let ((result (parent f i))) (and (and (=> (= (valid_root f i) true) (= result 0)) (=> (= (size f) 0) (= result 0))) (dynamic_invariant1 result true false true)))) :pattern ((parent f i))))))
(declare-fun position (us_rep1 Int) Int)
(declare-fun position__function_guard (Int us_rep1 Int) Bool)
(assert (forall ((f us_rep1)) (forall ((i Int)) (! (=> (and (and (dynamic_invariant4 f true true true) (dynamic_invariant3 i true true true)) (not (= (parent f i) 0))) (dynamic_invariant6 (position f i) true false true)) :pattern ((position f i))))))
(assert (forall ((f us_rep1)) (forall ((root Int)) (! (=> (and (and (dynamic_invariant4 f true true true) (dynamic_invariant3 root true true true)) (= (valid_root f root) true)) (let ((result (model__ f root))) (and (and (= (rec__tree_model__path_type__k (us_split_fields7 (select result root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields7 (select result root)))) 0) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= i root)) (ite (and (not (= (parent f i) 0)) (= (rec__tree_model__path_type__k (us_split_fields7 (select result (parent f i)))) true)) (= (rec__tree_model__path_type__k (us_split_fields7 (select result i))) true) (not (= (rec__tree_model__path_type__k (us_split_fields7 (select result i))) true)))))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields7 (select result i))) true) (not (= i root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields7 (select result (parent f i)))) (position f i) (rec__tree_model__path_type__a (us_split_fields7 (select result i)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields7 (select result i)))) 0)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select result i))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields7 (select result j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields7 (select result i))) (rec__tree_model__path_type__a (us_split_fields7 (select result j)))) true)) (= j i))))))))))) (dynamic_invariant8 result true false true)))) :pattern ((model__ f root))))))
...
(declare-const o Int)
(assert (= (tree_structure (rec__search_trees__search_tree__struct (us_split_fields5 t))) true))
(assert (type_invariant t))
(assert (not (= (size1 t) 0)))
(assert (not (in_range (to_rep (rec__search_trees__search_tree__root (us_split_fields5 t))))))
(check-sat)
(exit)
