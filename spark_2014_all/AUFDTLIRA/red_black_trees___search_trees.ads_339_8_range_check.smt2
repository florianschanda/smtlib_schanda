...
(define-fun dynamic_invariant ((temp___expr_420 us_rep2) (temp___is_init_416 Bool) (temp___skip_constant_417 Bool) (temp___do_toplevel_418 Bool) (temp___do_typ_inv_419 Bool)) Bool (=> (= temp___do_typ_inv_419 true) (= (tree_structure (rec__search_trees__search_tree__struct (us_split_fields5 temp___expr_420))) true)))
...
(assert (forall ((t us_rep2)) (! (=> (and (dynamic_invariant t true true true true) (type_invariant t)) (dynamic_invariant1 (size1 t) true false true true)) :pattern ((size1 t)))))
(assert (forall ((t us_rep2)) (! (=> (dynamic_invariant t true true true true) (= (size1 t) (size (rec__search_trees__search_tree__struct (us_split_fields5 t))))) :pattern ((size1 t)))))
...
(assert (forall ((temp___433 Int)) (=> (dynamic_invariant2 temp___433 true true true true) (forall ((temp___434 Int)) (= (to_rep2 (select (temp___431 temp___433) temp___434)) temp___433)))))
(define-fun dynamic_invariant3 ((temp___expr_175 Int) (temp___is_init_171 Bool) (temp___skip_constant_172 Bool) (temp___do_toplevel_173 Bool) (temp___do_typ_inv_174 Bool)) Bool (=> (or (= temp___is_init_171 true) (<= 1 100)) (in_range temp___expr_175)))
...
(assert (forall ((f us_rep1)) (! (=> (dynamic_invariant4 f true true true true) (dynamic_invariant1 (size f) true false true true)) :pattern ((size f)))))
(assert (forall ((f us_rep1)) (forall ((i Int)) (! (=> (and (dynamic_invariant4 f true true true true) (dynamic_invariant3 i true true true true)) (=> (< (size f) i) (not (= (valid_root f i) true)))) :pattern ((valid_root f i))))))
(declare-fun parent (us_rep1 Int) Int)
(declare-fun parent__function_guard (Int us_rep1 Int) Bool)
(assert (forall ((f us_rep1)) (forall ((i Int)) (! (=> (and (dynamic_invariant4 f true true true true) (dynamic_invariant3 i true true true true)) (let ((result (parent f i))) (and (and (=> (= (valid_root f i) true) (= result 0)) (=> (= (size f) 0) (= result 0))) (dynamic_invariant1 result true false true true)))) :pattern ((parent f i))))))
