...
(declare-fun temp___479 (Int Int Int) (Array Int unsigned_byte))
...
(assert (forall ((temp___481 Int) (temp___482 Int) (temp___483 Int)) (let ((temp___480 (temp___479 temp___481 temp___482 temp___483))) (=> (and (and (dynamic_invariant temp___481 true true true true) (dynamic_invariant temp___482 true true true true)) (dynamic_invariant temp___483 true true true true)) (forall ((temp___484 Int)) (ite (= temp___484 7) (= (to_rep (select temp___480 temp___484)) temp___482) (ite (= temp___484 2) (= (to_rep (select temp___480 temp___484)) temp___481) (= (to_rep (select temp___480 temp___484)) temp___483))))))))
