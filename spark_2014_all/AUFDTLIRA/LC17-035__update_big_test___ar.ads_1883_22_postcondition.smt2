...
(assert (<= n 10))
(assert (not (= n j)))
(assert (not (= (to_rep (select (rec__ar__rofa1__s1 (us_split_fields1 (select r__split_fields4 i))) n)) (to_rep (select (rec__ar__rofa1__s1 (us_split_fields1 (select r__split_fields i))) n)))))
(check-sat)
(exit)
