...
(assert (= (mk___rep (mk___split_fields o23 o24)) (select temp___1174 j)))
(assert (= o23 o25))
(assert (= o24 o26))
(assert (= result4 o26))
...
(assert (=> (= result4 true) (= (mk___rep (mk___split_fields o18 o19)) (select temp___1176 j))))
(assert (=> (= result4 true) (= o18 o20)))
(assert (=> (= result4 true) (= o19 o21)))
(assert (=> (= result4 true) (= o22 o20)))
(assert (=> (= result4 true) (= (tree_structure f) true)))
...
(assert (=> (= result4 true) (= (mk___rep (mk___split_fields o13 o14)) (select temp___1175 i))))
(assert (=> (= result4 true) (= o13 o15)))
(assert (=> (= result4 true) (= o14 o16)))
(assert (=> (= result4 true) (= o17 o15)))
(assert (=> (= result4 true) (and (= result3 (olt o17 o22)) (= (= result3 true) (and (< (length o17) (length o22)) (forall ((n3 Int)) (=> (and (<= 1 n3) (<= n3 (last o17))) (= (get o17 n3) (get o22 n3)))))))))
