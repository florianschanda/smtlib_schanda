...
(assert (and (= o89 (remove a o88)) (and (dynamic_invariant2 o89 true false true) (and (= (invariant__ o89) true) (and (= (to_rep2 (last (rt o89))) (- (to_rep2 (last (rt a))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- o88 1))) (= (to_rep (select (elts a) k1)) (to_rep (select (elts o89) k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ o88 1) k1) (<= k1 (to_rep2 (last (rt a))))) (= (to_rep (select (elts a) k1)) (to_rep (select (elts o89) (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= o88 k1) (<= k1 (- (to_rep2 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k1 1))) (to_rep (select (elts o89) k1))))))))))))
(assert (and (= o90 (remove o89 (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))))) (and (dynamic_invariant2 o90 true false true) (and (= (invariant__ o90) true) (and (= (to_rep2 (last (rt o90))) (- (to_rep2 (last (rt o89))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) 1))) (= (to_rep (select (elts o89) k1)) (to_rep (select (elts o90) k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) 1) k1) (<= k1 (to_rep2 (last (rt o89))))) (= (to_rep (select (elts o89) k1)) (to_rep (select (elts o90) (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) k1) (<= k1 (- (to_rep2 (last (rt o89))) 1))) (= (to_rep (select (elts o89) (+ k1 1))) (to_rep (select (elts o90) k1))))))))))))
