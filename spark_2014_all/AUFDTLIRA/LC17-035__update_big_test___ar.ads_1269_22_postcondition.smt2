...
(assert (forall ((temp___2861 (Array Int us_rep))) (forall ((temp___2862 Int)) (forall ((temp___2863 us_rep)) (let ((temp___2860 (temp___2859 temp___2861 temp___2862 temp___2863))) (forall ((temp___2864 Int)) (ite (= temp___2864 temp___2862) (= (select temp___2860 temp___2864) temp___2863) (= (select temp___2860 temp___2864) (select temp___2861 temp___2864)))))))))
...
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (bool_eq1 a2 1 10 (temp___2859 a i r) 1 10) true)))
(check-sat)
(exit)
