...
(declare-fun temp___3211 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
(declare-fun temp___3217 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___3213 (Array Int (Array Int et1)))) (forall ((temp___3214 Int)) (forall ((temp___3215 (Array Int et1))) (let ((temp___3212 (temp___3211 temp___3213 temp___3214 temp___3215))) (=> (dynamic_invariant1 temp___3214 true true true true) (forall ((temp___3216 Int)) (ite (= temp___3216 temp___3214) (= (select temp___3212 temp___3216) temp___3215) (= (select temp___3212 temp___3216) (select temp___3213 temp___3216))))))))))
(assert (forall ((temp___3219 (Array Int et1))) (forall ((temp___3220 Int) (temp___3221 Int)) (let ((temp___3218 (temp___3217 temp___3219 temp___3220 temp___3221))) (=> (and (dynamic_invariant temp___3220 true true true true) (dynamic_invariant2 temp___3221 true true true true)) (forall ((temp___3222 Int)) (ite (= temp___3222 temp___3220) (= (to_rep (select temp___3218 temp___3222)) temp___3221) (= (select temp___3218 temp___3222) (select temp___3219 temp___3222)))))))))
...
(declare-const temp___8210 (Array Int (Array Int et1)))
(declare-const temp___82101 Bool)
...
(assert (= temp___8210 o3))
(assert (= temp___82101 o4))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= temp___8210 r__split_fields2))
(assert (= temp___82101 r__split_fields3))
...
(assert (not (= (bool_eq1 r__split_fields4 5 50 (temp___3211 r__split_fields i (temp___3217 (select r__split_fields i) j e)) 5 50) true)))
(check-sat)
(exit)
