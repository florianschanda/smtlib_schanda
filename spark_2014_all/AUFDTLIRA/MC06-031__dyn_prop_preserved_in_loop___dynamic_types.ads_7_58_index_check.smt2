...
(define-fun dynamic_invariant2 ((temp___expr_151 Int) (temp___is_init_148 Bool) (temp___skip_constant_149 Bool) (temp___do_toplevel_150 Bool)) Bool (=> (or (= temp___is_init_148 true) (<= first2 last2)) (dynamic_property1 first2 last2 temp___expr_151)))
...
(declare-const dynamic_types__search__result5 Int)
...
(assert (and (and (and (= (mk_int__ref dynamic_types__search__result11) (mk_int__ref dynamic_types__search__result3)) (and (= result__2 result__9) (= from3 from11))) (and (= dynamic_types__search__result12 dynamic_types__search__result4) (and (= result__10 result__2) (= from12 from3)))) (and (= temp___157 result__) (and (= temp___156 from1) (and (forall ((i1 Int)) (=> (and (<= (to_rep1 (first (rt a))) i1) (<= i1 (- from2 1))) (not (= (to_rep (select (elts a) i1)) c)))) (and (and (=> (<= first2 last2) (dynamic_property1 first2 last2 from2)) (=> (<= 0 2147483647) (in_range2 result__1))) (and (and (or (and (= result__2 0) (forall ((i1 Int)) (=> (and (<= from2 i1) (<= i1 from3)) (not (= (to_rep (select (elts a) i1)) c))))) (and (and (<= (to_rep1 (first (rt a))) result__2) (<= result__2 (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) result__2)) c))) (and (dynamic_property1 first2 last2 from3) (in_range2 result__2))) (or (and (and (= dynamic_types__search__result1 dynamic_types__search__result3) (= dynamic_types__search__result4 dynamic_types__search__result1)) (and (< 0 result__2) (and (= dynamic_types__search__result result2) (= dynamic_types__search__result1 result__2)))) (and (and (not (< 0 result__2)) (= dynamic_types__search__result1 dynamic_types__search__result)) (and (and (= dynamic_types__search__result2 dynamic_types__search__result3) (= dynamic_types__search__result4 dynamic_types__search__result2)) (and (= from3 (to_rep1 (last (rt a)))) (and (= dynamic_types__search__result1 result3) (= dynamic_types__search__result2 0)))))))))))))
(assert (= dynamic_types__search__result13 (mk_int__ref dynamic_types__search__result11)))
(assert (= result__11 (mk_int__ref result__9)))
(assert (= (mk_int__ref from13) (mk_int__ref from11)))
