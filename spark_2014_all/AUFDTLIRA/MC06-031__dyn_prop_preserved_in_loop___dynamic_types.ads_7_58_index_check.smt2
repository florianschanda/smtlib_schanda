...
(define-fun dynamic_invariant1 ((temp___expr_176 Int) (temp___is_init_172 Bool) (temp___skip_constant_173 Bool) (temp___do_toplevel_174 Bool) (temp___do_typ_inv_175 Bool)) Bool (=> (or (= temp___is_init_172 true) (<= first2 last2)) (dynamic_property1 first2 last2 temp___expr_176)))
...
(assert (not (<= (int__content dynamic_types__search__result7) (to_rep1 (last (rt a))))))
(check-sat)
(exit)
