...
(define-fun dynamic_invariant2 ((temp___expr_176 Int) (temp___is_init_172 Bool) (temp___skip_constant_173 Bool) (temp___do_toplevel_174 Bool) (temp___do_typ_inv_175 Bool)) Bool (=> (or (= temp___is_init_172 true) (<= first2 last2)) (dynamic_property1 first2 last2 temp___expr_176)))
...
(define-fun dynamic_types__search__result9 () int__ref (mk_int__ref dynamic_types__search__result5))
...
(assert (= dynamic_types__search__result9 (mk_int__ref dynamic_types__search__result3)))
(assert (= result__2 result__3))
(assert (= from3 from4))
(assert (= dynamic_types__search__result6 dynamic_types__search__result4))
(assert (= result__4 result__2))
(assert (= from5 from3))
(assert (= temp___182 result__))
(assert (= temp___181 from1))
(assert (forall ((i Int)) (=> (and (<= (to_rep1 (first (rt a))) i) (<= i (- from2 1))) (not (= (to_rep (select (elts a) i)) c)))))
(assert (and (=> (<= first2 last2) (dynamic_property1 first2 last2 from2)) (=> (<= 0 2147483647) (in_range2 result__1))))
(assert (and (or (and (= result__2 0) (forall ((i Int)) (=> (and (<= from2 i) (<= i from3)) (not (= (to_rep (select (elts a) i)) c))))) (and (and (<= (to_rep1 (first (rt a))) result__2) (<= result__2 (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) result__2)) c))) (and (dynamic_property1 first2 last2 from3) (in_range2 result__2))))
(assert (or (and (and (= dynamic_types__search__result1 dynamic_types__search__result3) (= dynamic_types__search__result4 dynamic_types__search__result1)) (and (< 0 result__2) (and (= dynamic_types__search__result result1) (= dynamic_types__search__result1 result__2)))) (and (and (not (< 0 result__2)) (= dynamic_types__search__result1 dynamic_types__search__result)) (and (and (= dynamic_types__search__result2 dynamic_types__search__result3) (= dynamic_types__search__result4 dynamic_types__search__result2)) (and (= from3 (to_rep1 (last (rt a)))) (and (= dynamic_types__search__result1 result2) (= dynamic_types__search__result2 0)))))))
(assert (= dynamic_types__search__result7 dynamic_types__search__result9))
(assert (= result__5 (mk_int__ref result__3)))
(assert (= (mk_int__ref from6) (mk_int__ref from4)))
