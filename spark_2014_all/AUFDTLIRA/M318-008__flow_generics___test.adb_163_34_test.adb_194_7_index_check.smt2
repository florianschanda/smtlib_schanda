...
(define-fun dynamic_invariant ((temp___expr_268 Int) (temp___is_init_264 Bool) (temp___skip_constant_265 Bool) (temp___do_toplevel_266 Bool) (temp___do_typ_inv_267 Bool)) Bool (=> (or (= temp___is_init_264 true) (<= 0 9)) (in_range4 temp___expr_268)))
...
(define-fun dynamic_invariant1 ((temp___expr_261 Int) (temp___is_init_257 Bool) (temp___skip_constant_258 Bool) (temp___do_toplevel_259 Bool) (temp___do_typ_inv_260 Bool)) Bool (=> (or (= temp___is_init_257 true) (<= 0 12)) (in_range3 temp___expr_261)))
...
(assert (and (forall ((temp___521 Int)) (=> (and (<= (to_rep new_inventory__first) temp___521) (<= temp___521 (to_rep new_inventory__last))) (=> (<= i2 temp___521) (= (select new_inventory1 temp___521) (select new_inventory temp___521))))) (and (<= (to_rep (first (rt old_inventory))) i2) (<= i2 (to_rep (last (rt old_inventory)))))))
