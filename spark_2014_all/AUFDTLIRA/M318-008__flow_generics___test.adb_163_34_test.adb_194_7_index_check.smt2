...
(assert (forall ((x fruits_and_weapons)) (! (in_range3 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(assert (forall ((x fruits)) (! (in_range4 (to_rep2 x)) :pattern ((to_rep2 x)))))
(assert (forall ((x Int)) (! (=> (in_range4 x) (= (to_rep2 (of_rep2 x)) x)) :pattern ((to_rep2 (of_rep2 x))))))
(define-fun dynamic_invariant ((temp___expr_233 Int) (temp___is_init_230 Bool) (temp___skip_constant_231 Bool) (temp___do_toplevel_232 Bool)) Bool (=> (or (= temp___is_init_230 true) (<= 0 9)) (in_range4 temp___expr_233)))
...
(define-fun dynamic_invariant1 ((temp___expr_227 Int) (temp___is_init_224 Bool) (temp___skip_constant_225 Bool) (temp___do_toplevel_226 Bool)) Bool (=> (or (= temp___is_init_224 true) (<= 0 12)) (in_range3 temp___expr_227)))
(declare-fun fruits_to_fruits_and_weapons (Int) Int)
(declare-fun fruits_to_fruits_and_weapons__function_guard (Int Int) Bool)
(assert (forall ((fruit Int)) (! (=> (dynamic_invariant fruit true true true) (dynamic_invariant1 (fruits_to_fruits_and_weapons fruit) true false true)) :pattern ((fruits_to_fruits_and_weapons fruit)))))
(assert (forall ((fruit Int)) (! (=> (dynamic_invariant fruit true true true) (= (fruits_to_fruits_and_weapons fruit) fruit)) :pattern ((fruits_to_fruits_and_weapons fruit)))))
...
(define-fun bool_eq ((a (Array Int fruits)) (a__first Int) (a__last Int) (b (Array Int fruits)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_134 Int)) (=> (and (<= a__first temp___idx_134) (<= temp___idx_134 a__last)) (= (to_rep2 (select a temp___idx_134)) (to_rep2 (select b (+ (- b__first a__first) temp___idx_134))))))) true false))
...
(assert (forall ((a (Array Int fruits)) (b (Array Int fruits))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep2 (select a (+ i 1))) (to_rep2 (select b (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int fruits)) (b (Array Int fruits))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep2 (select b (+ i 1))) (to_rep2 (select a (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
...
(define-fun bool_eq1 ((a (Array Int fruits_and_weapons)) (a__first Int) (a__last Int) (b (Array Int fruits_and_weapons)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_135 Int)) (=> (and (<= a__first temp___idx_135) (<= temp___idx_135 a__last)) (= (to_rep1 (select a temp___idx_135)) (to_rep1 (select b (+ (- b__first a__first) temp___idx_135))))))) true false))
...
(assert (forall ((a (Array Int fruits_and_weapons)) (b (Array Int fruits_and_weapons))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare1 a a_first a_last b b_first b_last) 0) (= (bool_eq1 a a_first a_last b b_first b_last) true)) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int fruits_and_weapons)) (b (Array Int fruits_and_weapons))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare1 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq1 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep1 (select a (+ i 1))) (to_rep1 (select b (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int fruits_and_weapons)) (b (Array Int fruits_and_weapons))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare1 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq1 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep1 (select b (+ i 1))) (to_rep1 (select a (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(declare-sort t 0)
...
(define-fun dynamic_invariant2 ((temp___expr_327 us_t) (temp___is_init_324 Bool) (temp___skip_constant_325 Bool) (temp___do_toplevel_326 Bool)) Bool (=> (not (= temp___skip_constant_325 true)) (dynamic_property 1 2147483647 (first1 temp___expr_327) (last1 temp___expr_327))))
...
(define-fun dynamic_invariant3 ((temp___expr_364 Int) (temp___is_init_361 Bool) (temp___skip_constant_362 Bool) (temp___do_toplevel_363 Bool)) Bool (=> (or (= temp___is_init_361 true) (<= 0 12)) (in_range5 temp___expr_364)))
(declare-sort t1 0)
...
(define-fun dynamic_invariant6 ((temp___expr_370 us_t1) (temp___is_init_367 Bool) (temp___skip_constant_368 Bool) (temp___do_toplevel_369 Bool)) Bool (=> (not (= temp___skip_constant_368 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_370) (last3 temp___expr_370))))
...
(assert (and (forall ((temp___470 Int)) (=> (and (<= (to_rep new_inventory__first) temp___470) (<= temp___470 (to_rep new_inventory__last))) (=> (<= i2 temp___470) (= (select new_inventory1 temp___470) (select new_inventory temp___470))))) (and (<= (to_rep (first (rt old_inventory))) i2) (<= i2 (to_rep (last (rt old_inventory)))))))
...
(assert (and (= o1 (fruits_to_fruits_and_weapons (to_rep2 (select (elts old_inventory) i2)))) (and (in_range3 o1) (= o1 (to_rep2 (select (elts old_inventory) i2))))))
