...
(declare-fun user_eq1 (enum2t enum2t) Bool)
(declare-const dummy1 enum2t)
...
(define-fun dynamic_invariant ((temp___expr_239 Int) (temp___is_init_235 Bool) (temp___skip_constant_236 Bool) (temp___do_toplevel_237 Bool) (temp___do_typ_inv_238 Bool)) Bool (=> (or (= temp___is_init_235 true) (<= 0 5)) (in_range2 temp___expr_239)))
...
(declare-const temp___8120 (Array Int et1))
(declare-const temp___81201 enum2t)
...
(assert (= o o2))
(assert (= temp___8120 o1))
(assert (= temp___81201 o2))
(assert (= result2 r__split_fields2))
(assert (= result3 r__split_fields3))
(assert (= temp___8120 r__split_fields4))
(assert (= temp___81201 r__split_fields5))
...
(assert (not (in_range2 (to_rep1 r__split_fields7))))
(check-sat)
(exit)
