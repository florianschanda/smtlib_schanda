...
(assert (not (= b1 true)))
(assert (= b2 true))
(assert (not (= (ite (<= (to_rep (first2 (mk1 (to_rep u__first) (to_rep u__last)))) (to_rep (last2 (mk1 (to_rep u__first) (to_rep u__last))))) (+ (- (to_rep (last2 (mk1 (to_rep u__first) (to_rep u__last)))) (to_rep (first2 (mk1 (to_rep u__first) (to_rep u__last))))) 1) 0) (ite (<= 0 x) (+ (- x 0) 1) 0))))
(check-sat)
(exit)
