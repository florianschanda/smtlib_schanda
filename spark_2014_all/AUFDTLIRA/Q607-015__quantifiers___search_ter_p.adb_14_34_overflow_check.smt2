...
(define-fun dynamic_invariant ((temp___expr_136 us_t) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (not (= temp___skip_constant_134 true)) (dynamic_property 1 2147483647 (first1 temp___expr_136) (last1 temp___expr_136))))
...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (= (rec__types__option__exists (us_split_fields1 a)) (rec__types__option__exists (us_split_fields1 b))) (= (to_rep (rec__types__option__value (us_split_fields1 a))) (to_rep (rec__types__option__value (us_split_fields1 b))))) true false))
...
(assert true)
(assert (forall ((a us_t) (b us_t)) (forall ((j Int)) (! (= (= (equal_subrange a j b) true) (= (let ((temp___153 (let ((temp___152 (+ (- j 1) (length b)))) (of_array1 (to_array a) j temp___152)))) (bool_eq (to_array1 temp___153) (first3 temp___153) (last3 temp___153) (to_array b) (first1 b) (last1 b))) true)) :pattern ((equal_subrange a j b))))))
...
(assert (= result____split_fields2 (mk___split_fields search_ter_p__search__result__assume search_ter_p__search__result__assume1)))
(assert (=> (< (length a) (length b)) (= result2 true)))
(assert (=> (not (< (length a) (length b))) (= result2 (ite (= (length b) 0) true false))))
(assert (not (= result2 true)))
(assert (= search_ter_p__search__result4 (mk___rep (mk___split_fields search_ter_p__search__result search_ter_p__search__result1))))
(assert (= search_ter_p__search__result4 (mk___rep (mk___split_fields search_ter_p__search__result2 search_ter_p__search__result3))))
(assert (and (= o3 (length b)) (in_range1 (length b))))
