...
(define-fun bool_eq4 ((a us_rep3) (b us_rep3)) Bool (ite (and (= (user_eq5 (rec__list_allocator__m__t__available (us_split_fields3 a)) (rec__list_allocator__m__t__available (us_split_fields3 b))) true) (= (bool_eq3 (rec__list_allocator__m__t__allocated (us_split_fields3 a)) (rec__list_allocator__m__t__allocated (us_split_fields3 b))) true)) true false))
...
(define-fun default_initial_assumption ((temp___expr_211 us_rep3) (temp___skip_top_level_212 Bool)) Bool (and (= (length (rec__list_allocator__m__t__available (us_split_fields3 temp___expr_211))) 0) (= (is_empty (rec__list_allocator__m__t__allocated (us_split_fields3 temp___expr_211))) true)))
...
(define-fun default_initial_assumption1 ((temp___expr_185 us_rep1) (temp___skip_top_level_186 Bool)) Bool (=> (not (= temp___skip_top_level_186 true)) (= (length temp___expr_185) 0)))
(assert true)
...
(define-fun dynamic_invariant3 ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= 0 2147483647)) (in_range6 temp___expr_142)))
...
(assert (forall ((container us_rep1)) (! (let ((result (length container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant3 result true false true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant5 ((temp___expr_172 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= 0 10000)) (in_range8 temp___expr_172)))
...
(define-fun default_initial_assumption2 ((temp___expr_198 us_rep2) (temp___skip_top_level_199 Bool)) Bool (=> (not (= temp___skip_top_level_199 true)) (= (is_empty temp___expr_198) true)))
(define-fun dynamic_invariant6 ((temp___expr_191 Int) (temp___is_init_188 Bool) (temp___skip_constant_189 Bool) (temp___do_toplevel_190 Bool)) Bool (=> (or (= temp___is_init_188 true) (<= 0 10000)) (in_range5 temp___expr_191)))
(assert (forall ((container us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant6 item true true true) (=> (= (of_int 1) true) (=> (exists ((e Int)) (and (and (in_range5 e) (= (contains1 container e) true)) (= e item))) (= (contains1 container item) true)))) :pattern ((contains1 container item))))))
...
(assert (forall ((left us_rep2) (right us_rep2)) (! (= (= (ole left right) true) (forall ((item Int)) (=> (and (in_range5 item) (= (contains1 left item) true)) (= (contains1 right item) true)))) :pattern ((ole left right)))))
...
(assert (forall ((container us_rep2)) (! (let ((result (is_empty container))) (and (= (= result true) (forall ((item Int)) (not (and (in_range5 item) (= (contains1 container item) true))))) (= (= result true) (= (length1 container) 0)))) :pattern ((is_empty container)))))
...
(assert (= o4 o2))
(assert (= o5 o3))
(assert (= o6 (list_allocator__data__aggregate_def (mk___rep (mk___split_fields o4 o5)))))
...
(assert (<= 1 r1))
(assert (<= r1 10000))
(assert (=> (< r1 10000) (and (= o7 (+ r1 1)) (in_range2 (+ r1 1)))))
(assert (=> (< r1 10000) (= (to_rep o8) o7)))
(assert (=> (< r1 10000) (= (rec__list_allocator__cell__stat (us_split_fields1 (select data1 r1))) o9)))
(assert (=> (< r1 10000) (= o8 o10)))
(assert (=> (< r1 10000) (= o11 o9)))
(assert (=> (< r1 10000) (= o12 o10)))
(assert (=> (< r1 10000) (= o13 (store data1 r1 (mk___rep (mk___split_fields o11 o12))))))
(assert (=> (< r1 10000) (= data1 result3)))
(assert (=> (< r1 10000) (= data2 o13)))
(assert (=> (not (< r1 10000)) (= data2 data1)))
(declare-const rr1 Int)
(assert (<= 1 rr1))
(assert (<= rr1 r1))
(assert (not (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data2 rr1)))) (ite (= rr1 10000) 0 (+ rr1 1)))))
(check-sat)
(exit)
