...
(define-fun dynamic_invariant2 ((temp___expr_166 Int) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool (=> (or (= temp___is_init_162 true) (<= 0 2147483647)) (in_range5 temp___expr_166)))
...
(define-fun dynamic_invariant3 ((temp___expr_200 Int) (temp___is_init_196 Bool) (temp___skip_constant_197 Bool) (temp___do_toplevel_198 Bool) (temp___do_typ_inv_199 Bool)) Bool (=> (or (= temp___is_init_196 true) (<= 0 10000)) (in_range6 temp___expr_200)))
...
(define-fun dynamic_invariant5 ((temp___expr_269 Int) (temp___is_init_265 Bool) (temp___skip_constant_266 Bool) (temp___do_toplevel_267 Bool) (temp___do_typ_inv_268 Bool)) Bool (=> (or (= temp___is_init_265 true) (<= 0 1)) (in_range4 temp___expr_269)))
(define-fun dynamic_invariant6 ((temp___expr_180 Int) (temp___is_init_176 Bool) (temp___skip_constant_177 Bool) (temp___do_toplevel_178 Bool) (temp___do_typ_inv_179 Bool)) Bool (=> (or (= temp___is_init_176 true) (<= 1 10000)) (in_range3 temp___expr_180)))
(assert true)
...
(assert (forall ((container us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant7 item true true true true) (=> (= (distinct 1 0) true) (=> (exists ((e Int)) (and (and (in_range8 e) (= (contains container e) true)) (= e item))) (= (contains container item) true)))) :pattern ((contains container item))))))
...
(assert (forall ((left us_rep2) (right us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant7 item true true true true) (= (= (included_except left right item) true) (forall ((e Int)) (=> (and (in_range8 e) (= (contains left e) true)) (or (= (contains right e) true) (= e item)))))) :pattern ((included_except left right item))))))
...
(define-fun o21 () us_rep3 (mk___rep1 (mk___split_fields1 o o1)))
...
(assert (and (= o21 (model__ data first_available)) (= (model_is_well_formed o21 data first_available) true)))
(assert (= o o2))
(assert (= o1 o3))
...
(assert (=> (not (= first_available 0)) (= (mk___rep (mk___split_fields o5 o6)) (select data o4))))
...
(assert (=> (not (= first_available 0)) (= (to_rep o11) 0)))
(assert (=> (not (= first_available 0)) (= (to_rep1 o12) 1)))
(assert (=> (not (= first_available 0)) (= o12 o13)))
(assert (=> (not (= first_available 0)) (= o11 o14)))
(assert (=> (not (= first_available 0)) (= o15 o13)))
(assert (=> (not (= first_available 0)) (= o16 o14)))
(assert (=> (not (= first_available 0)) (and (<= 1 res1) (<= res1 10000))))
(assert (=> (not (= first_available 0)) (= o17 res1)))
(assert (=> (not (= first_available 0)) (= o18 (store data o17 (mk___rep (mk___split_fields o15 o16))))))
...
(assert (=> (not (= first_available 0)) (forall ((r Int)) (=> (and (<= 1 r) (<= r 10000)) (=> (and (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data2 r)))) 0) (not (= (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select data2 r)))) 0))) (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data2 (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select data2 r)))))))) 0))))))
(assert (=> (not (= first_available 0)) (and (= o19 (model__ data2 first_available2)) (= (model_is_well_formed o19 data2 first_available2) true))))
(assert (=> (not (= first_available 0)) (= o20 (us_split_fields3 o19))))
(assert (=> (not (= first_available 0)) (= list_mod_allocator__alloc__C96b__assume (rec__list_mod_allocator__m__t__available o20))))
(assert (=> (not (= first_available 0)) (= list_mod_allocator__alloc__C96b__assume c96b)))
(assert (=> (not (= first_available 0)) (= ma c97b)))
(assert (=> (not (= first_available 0)) (and (= list_mod_allocator__alloc__B98b__L_4__R99b__assume (length c96b)) (and (in_range5 list_mod_allocator__alloc__B98b__L_4__R99b__assume) (<= (+ 0 list_mod_allocator__alloc__B98b__L_4__R99b__assume) 2147483647)))))
...
(assert (=> (not (= first_available 0)) (=> (and (<= 1 i2) (<= i2 r99b)) (= temp___344 i2))))
...
(assert (=> (not (= first_available 0)) (=> (and (<= 1 i2) (<= i2 r99b)) (forall ((j Int)) (=> (and (<= 1 j) (<= j (+ i3 1))) (not (= (get c97b j) (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select data2 (get c96b i3))))))))))))
...
(assert (= data6 data4))
(assert (= res6 res4))
(assert (= (= (length (rec__list_mod_allocator__m__t__available (us_split_fields3 (model__ data first_available)))) 0) true))
