...
(assert (=> (not (= first_available 0)) (= result (mk_int__ref res))))
...
(assert (=> (not (= first_available 0)) (= o10 first_available)))
(assert (=> (not (= first_available 0)) (= (mk___rep (mk___split_fields o11 o12)) (select data o10))))
(assert (=> (not (= first_available 0)) (= o11 o13)))
(assert (=> (not (= first_available 0)) (= o12 o14)))
(assert (=> (not (= first_available 0)) (= o15 o14)))
(assert (=> (not (= first_available 0)) (= o16 (to_rep o15))))
(assert (=> (not (= first_available 0)) (= result1 (mk_int__ref next_avail))))
(assert (=> (not (= first_available 0)) (= next_avail2 o16)))
(assert (=> (not (= first_available 0)) (= (to_rep o17) 0)))
(assert (=> (not (= first_available 0)) (= (to_rep1 o18) 1)))
(assert (=> (not (= first_available 0)) (= o18 o19)))
(assert (=> (not (= first_available 0)) (= o17 o20)))
(assert (=> (not (= first_available 0)) (= o21 o19)))
(assert (=> (not (= first_available 0)) (= o22 o20)))
(assert (=> (not (= first_available 0)) (and (<= 1 res1) (<= res1 10000))))
(assert (=> (not (= first_available 0)) (= o23 res1)))
(assert (=> (not (= first_available 0)) (= o24 (store data o23 (mk___rep (mk___split_fields o21 o22))))))
(assert (=> (not (= first_available 0)) (= result2 (mk_map__ref data))))
(assert (=> (not (= first_available 0)) (= data2 o24)))
(assert (=> (not (= first_available 0)) (= result3 (mk_int__ref first_available))))
(assert (=> (not (= first_available 0)) (= first_available2 next_avail2)))
(assert (=> (not (= first_available 0)) (forall ((r1 Int)) (=> (and (<= 1 r1) (<= r1 10000)) (=> (and (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data2 r1)))) 0) (not (= (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select data2 r1)))) 0))) (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data2 (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select data2 r1)))))))) 0))))))
(assert (=> (not (= first_available 0)) (and (= o25 (model__ data2 first_available2)) (= (model_is_well_formed o25 data2 first_available2) true))))
(assert (=> (not (= first_available 0)) (= o26 (us_split_fields3 o25))))
(assert (=> (not (= first_available 0)) (= list_mod_allocator__alloc__C96b__assume (rec__list_mod_allocator__m__t__available o26))))
...
(assert (=> (not (= first_available 0)) (= result4 (mk_int__ref i))))
...
(assert (=> (not (= first_available 0)) (=> (and (<= 1 i2) (<= i2 r99b)) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 i3)) (= (get c96b j3) (get c97b (+ j3 1))))))))
(assert (=> (not (= first_available 0)) (=> (and (<= 1 i2) (<= i2 r99b)) (forall ((j3 Int)) (=> (and (<= 2 j3) (<= j3 (+ i3 1))) (= (get c96b (- j3 1)) (get c97b j3)))))))
(assert (=> (not (= first_available 0)) (=> (and (<= 1 i2) (<= i2 r99b)) (and (=> (<= 1 r99b) (dynamic_property 1 r99b i3)) (and (<= 1 i3) (<= i3 r99b))))))
(assert (=> (not (= first_available 0)) (=> (and (<= 1 i2) (<= i2 r99b)) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 (+ i3 1))) (not (= (get c97b j3) (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select data2 (get c96b i3))))))))))))
(assert (=> (not (= first_available 0)) (=> (and (<= 1 i2) (<= i2 r99b)) (= i3 r99b))))
(assert (=> (not (= first_available 0)) (=> (and (<= 1 i2) (<= i2 r99b)) (= i5 (mk_int__ref i3)))))
(assert (=> (not (= first_available 0)) (=> (and (<= 1 i2) (<= i2 r99b)) (= i6 i3))))
(assert (=> (not (= first_available 0)) (=> (and (<= 1 i2) (<= i2 r99b)) (= i7 i5))))
(assert (=> (not (= first_available 0)) (=> (and (<= 1 i2) (<= i2 r99b)) (= i8 i6))))
(assert (=> (not (= first_available 0)) (=> (not (and (<= 1 i2) (<= i2 r99b))) (= i7 (mk_int__ref i2)))))
(assert (=> (not (= first_available 0)) (=> (not (and (<= 1 i2) (<= i2 r99b))) (= i8 i2))))
...
(assert (=> (not (= first_available 0)) (= i10 i8)))
...
(assert (=> (= first_available 0) (= result8 (mk_int__ref res))))
(assert (=> (= first_available 0) (= res2 0)))
(assert (=> (= first_available 0) (= i9 (mk_int__ref i))))
(assert (=> (= first_available 0) (= next_avail3 (mk_int__ref next_avail))))
(assert (=> (= first_available 0) (= first_available3 (mk_int__ref first_available))))
(assert (=> (= first_available 0) (= data3 (mk_map__ref data))))
(assert (=> (= first_available 0) (= res3 (mk_int__ref res2))))
(assert (=> (= first_available 0) (= i10 i1)))
(assert (=> (= first_available 0) (= next_avail4 next_avail1)))
(assert (=> (= first_available 0) (= first_available4 first_available1)))
(assert (=> (= first_available 0) (= data4 data1)))
(assert (=> (= first_available 0) (= res4 res2)))
(assert (= i11 i9))
