...
(assert (and (<= 1 temp___1744) (<= temp___1744 128)))
(assert (= o15 temp___1744))
(assert (= o16 (store newemail2 o15 o14)))
(assert (= result18 (mk_map__ref newemail2)))
(assert (= newemail3 o16))
(assert (not (= i41 r103b)))
(assert (= result19 (mk_int__ref i41)))
(assert (= i42 (+ i41 1)))
(assert (= i43 (mk_int__ref i42)))
