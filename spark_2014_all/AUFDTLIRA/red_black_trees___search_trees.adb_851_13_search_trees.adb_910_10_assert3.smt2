...
(assert (and (= o29 yl1) (in_range3 yl1)))
...
(assert (not (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields11) (to_rep1 (rec__search_trees__search_tree__root t__split_fields11))) y1))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) (to_rep1 (rec__search_trees__search_tree__root t__split_fields11))) i5)))) 1)) 0)))
...
(assert (not (< (to_rep (select (rec__search_trees__search_tree__values t__split_fields11) i5)) (to_rep (select (rec__search_trees__search_tree__values t__split_fields11) j15)))))
(check-sat)
(exit)
