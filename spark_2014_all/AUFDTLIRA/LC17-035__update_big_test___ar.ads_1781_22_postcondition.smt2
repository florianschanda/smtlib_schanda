...
(declare-fun temp_____aggregate_def_4056 ((Array Int us_rep) Int us_rep) (Array Int us_rep))
...
(assert (forall ((temp___4058 (Array Int us_rep))) (forall ((temp___4059 Int)) (forall ((temp___4060 us_rep)) (let ((temp___4057 (temp_____aggregate_def_4056 temp___4058 temp___4059 temp___4060))) (=> (dynamic_invariant temp___4059 true true true true) (forall ((temp___4061 Int)) (ite (= temp___4061 temp___4059) (= (select temp___4057 temp___4061) temp___4060) (= (select temp___4057 temp___4061) (select temp___4058 temp___4061))))))))))
...
(declare-const temp___9389 (Array Int us_rep))
(declare-const temp___93891 Bool)
(declare-const temp___93892 enum1t)
...
(assert (= temp___9389 o6))
(assert (= temp___93891 o7))
(assert (= temp___93892 o8))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= result2 r__split_fields2))
(assert (= temp___9389 r__split_fields3))
(assert (= temp___93891 r__split_fields4))
(assert (= temp___93892 r__split_fields5))
...
(assert (not (= (bool_eq2 (mk___rep1 (mk___split_fields1 r__split_fields6 r__split_fields7 r__split_fields8)) (mk___rep1 (mk___split_fields1 (temp_____aggregate_def_4056 r__split_fields i (mk___rep (mk___split_fields (of_rep e) (rec__ar__rec1t__g1 (us_split_fields1 (select r__split_fields i)))))) r__split_fields1 r__split_fields2))) true)))
(check-sat)
(exit)
