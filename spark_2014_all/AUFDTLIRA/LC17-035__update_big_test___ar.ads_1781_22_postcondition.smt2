...
(declare-fun temp___4056 ((Array Int us_rep) Int us_rep) (Array Int us_rep))
...
(assert (not (= (bool_eq2 (mk___rep1 (mk___split_fields1 r__split_fields6 r__split_fields7 r__split_fields8)) (mk___rep1 (mk___split_fields1 (temp___4056 r__split_fields i (mk___rep (mk___split_fields (of_rep e) (rec__ar__rec1t__g1 (us_split_fields1 (select r__split_fields i)))))) r__split_fields1 r__split_fields2))) true)))
(check-sat)
(exit)
