...
(assert (forall ((temp___3999 (Array Int us_rep))) (forall ((temp___4000 Int)) (forall ((temp___4001 us_rep)) (let ((temp___3998 (temp___3997 temp___3999 temp___4000 temp___4001))) (forall ((temp___4002 Int)) (ite (= temp___4002 temp___4000) (= (select temp___3998 temp___4002) temp___4001) (= (select temp___3998 temp___4002) (select temp___3999 temp___4002)))))))))
...
(assert (not (= (bool_eq2 (mk___rep1 (mk___split_fields1 r__split_fields6 r__split_fields7 r__split_fields8)) (mk___rep1 (mk___split_fields1 (temp___3997 r__split_fields i (mk___rep (mk___split_fields (of_rep e) (rec__ar__rec1t__g1 (us_split_fields1 (select r__split_fields i)))))) r__split_fields1 r__split_fields2))) true)))
(check-sat)
(exit)
