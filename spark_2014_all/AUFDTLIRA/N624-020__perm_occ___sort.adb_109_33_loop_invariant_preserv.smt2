...
(declare-const temp___2702 (Array Int natural))
(declare-const temp___2703 t2)
(declare-const o10 (Array Int natural))
(declare-const o11 t)
(declare-const o12 Int)
(declare-const temp___2712 (Array Int natural))
(declare-const temp___2713 t1)
...
(assert (= smallest1 o4))
(assert (=> (not (= smallest1 current1)) (= (slide values (to_rep1 values__first) (to_rep1 values__first)) temp___271)))
(assert (=> (not (= smallest1 current1)) (= (mk1 (to_rep1 values__first) (to_rep1 values__last)) temp___2711)))
(assert (=> (not (= smallest1 current1)) (= (ite (<= (to_rep1 (first2 temp___2711)) (to_rep1 (last2 temp___2711))) (+ (- (to_rep1 (last2 temp___2711)) (to_rep1 (first2 temp___2711))) 1) 0) (ite (<= (to_rep1 previous__first) (to_rep1 previous__last)) (+ (- (to_rep1 previous__last) (to_rep1 previous__first)) 1) 0))))
(assert (=> (not (= smallest1 current1)) (= (mk___t1 o5 o6) (mk___t1 temp___271 temp___2711))))
...
(assert (forall ((i Int)) (=> (and (<= (to_rep1 values__first) i) (<= i current2)) (forall ((j Int)) (=> (and (<= (+ i 1) j) (<= j (to_rep1 values__last))) (<= (to_rep (select values3 i)) (to_rep (select values3 j))))))))
...
(assert (not (= current2 temp___280)))
(assert (= current2 result4))
(assert (= current3 (+ current2 1)))
(assert (=> (<= current3 (to_rep1 values__last)) (and (and (<= (to_rep1 values__first) current3) (<= current3 (to_rep1 values__last))) (and (<= (to_rep1 values__first) (to_rep1 values__last)) (<= (to_rep1 values__last) (to_rep1 values__last))))))
(assert (= o9 values3))
(assert (= o9 temp___2702))
(assert (= (mk2 current3 (to_rep1 values__last)) temp___2703))
(assert (= temp___2702 o10))
(assert (= (mk (to_rep1 (first4 temp___2703)) (to_rep1 (last4 temp___2703))) o11))
(assert (and (= o12 (index_of_minimum (mk___t o10 o11))) (and (in_range3 o12) (and (and (<= (to_rep1 (first o11)) o12) (<= o12 (to_rep1 (last o11)))) (forall ((i Int)) (=> (and (<= (to_rep1 (first o11)) i) (<= i (to_rep1 (last o11)))) (<= (to_rep (select o10 o12)) (to_rep (select o10 i)))))))))
(assert (= smallest2 result5))
(assert (= smallest3 o12))
(assert (=> (not (= smallest3 current3)) (= (slide values3 (to_rep1 values__first) (to_rep1 values__first)) temp___2712)))
(assert (=> (not (= smallest3 current3)) (= (mk1 (to_rep1 values__first) (to_rep1 values__last)) temp___2713)))
(assert (=> (not (= smallest3 current3)) (= (ite (<= (to_rep1 (first2 temp___2713)) (to_rep1 (last2 temp___2713))) (+ (- (to_rep1 (last2 temp___2713)) (to_rep1 (first2 temp___2713))) 1) 0) (ite (<= (to_rep1 previous__first) (to_rep1 previous__last)) (+ (- (to_rep1 previous__last) (to_rep1 previous__first)) 1) 0))))
(assert (=> (not (= smallest3 current3)) (= (mk___t1 o13 o14) (mk___t1 temp___2712 temp___2713))))
(assert (=> (not (= smallest3 current3)) (= o15 o13)))
(assert (=> (not (= smallest3 current3)) (= previous3 result6)))
(assert (=> (not (= smallest3 current3)) (= previous4 o15)))
(assert (=> (not (= smallest3 current3)) (and (= o16 current3) (in_range3 current3))))
(assert (=> (not (= smallest3 current3)) (and (and (and (= (is_perm (mk___t values3 (mk (to_rep1 values__first) (to_rep1 values__last))) (mk___t values4 (mk (to_rep1 values__first) (to_rep1 values__last)))) true) (= (to_rep (select values4 o16)) (to_rep (select values3 smallest3)))) (= (to_rep (select values4 smallest3)) (to_rep (select values3 o16)))) (forall ((z Int)) (=> (and (<= (to_rep1 values__first) z) (<= z (to_rep1 values__last))) (=> (and (not (= z o16)) (not (= z smallest3))) (= (to_rep (select values4 z)) (to_rep (select values3 z)))))))))
(assert (=> (not (not (= smallest3 current3))) (= previous4 previous3)))
