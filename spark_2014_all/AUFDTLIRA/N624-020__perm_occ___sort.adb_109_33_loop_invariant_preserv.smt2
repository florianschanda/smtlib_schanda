...
(assert (= smallest2 o4))
(assert true)
(assert (=> (not (= smallest2 current2)) (= (slide values (to_rep1 values__first) (to_rep1 values__first)) temp___240)))
(assert (=> (not (= smallest2 current2)) (= (mk1 (to_rep1 values__first) (to_rep1 values__last)) temp___2401)))
(assert (=> (not (= smallest2 current2)) (= (ite (<= (to_rep1 (first2 temp___2401)) (to_rep1 (last2 temp___2401))) (+ (- (to_rep1 (last2 temp___2401)) (to_rep1 (first2 temp___2401))) 1) 0) (ite (<= (to_rep1 previous__first) (to_rep1 previous__last)) (+ (- (to_rep1 previous__last) (to_rep1 previous__first)) 1) 0))))
(assert (=> (not (= smallest2 current2)) (= (mk___t1 o5 o6) (mk___t1 temp___240 temp___2401))))
(assert (=> (not (= smallest2 current2)) (= o7 o5)))
(assert (=> (not (= smallest2 current2)) (= (mk_map__ref result3) (mk_map__ref previous))))
(assert (=> (not (= smallest2 current2)) (= previous2 o7)))
(assert (=> (not (= smallest2 current2)) (and (= o8 current2) (in_range3 current2))))
(assert (=> (not (= smallest2 current2)) (and (and (and (= (is_perm (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last))) (mk___t values2 (mk (to_rep1 values__first) (to_rep1 values__last)))) true) (= (to_rep (select values2 o8)) (to_rep (select values smallest2)))) (= (to_rep (select values2 smallest2)) (to_rep (select values o8)))) (forall ((z Int)) (=> (and (<= (to_rep1 values__first) z) (<= z (to_rep1 values__last))) (=> (and (not (= z o8)) (not (= z smallest2))) (= (to_rep (select values2 z)) (to_rep (select values z)))))))))
(assert (=> (= smallest2 current2) (= previous2 previous)))
(assert (=> (= smallest2 current2) (= values2 values)))
(assert (=> (= smallest2 current2) (= previous2 previous1)))
(assert (=> (= smallest2 current2) (= values2 values1)))
(assert (forall ((i2 Int)) (=> (and (<= (to_rep1 values__first) i2) (<= i2 current3)) (forall ((j1 Int)) (=> (and (<= (+ i2 1) j1) (<= j1 (to_rep1 values__last))) (<= (to_rep (select values3 i2)) (to_rep (select values3 j1))))))))
(assert (= (is_perm (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last))) (mk___t values3 (mk (to_rep1 values__first) (to_rep1 values__last)))) true))
(assert (and (and (=> (<= (to_rep1 values__first) (- (to_rep1 values__last) 1)) (dynamic_property3 (to_rep1 values__first) (- (to_rep1 values__last) 1) current3)) (=> (<= 1 2147483647) (in_range3 smallest3))) (and (<= (to_rep1 values__first) current3) (<= current3 (- (to_rep1 values__last) 1)))))
(assert (not (= current3 temp___249)))
(assert (= current3 result5))
(assert (= current4 (+ current3 1)))
(assert (=> (<= current4 (to_rep1 values__last)) (and (and (<= (to_rep1 values__first) current4) (<= current4 (to_rep1 values__last))) (and (<= (to_rep1 values__first) (to_rep1 values__last)) (<= (to_rep1 values__last) (to_rep1 values__last))))))
(assert (= o14 values3))
(assert (= o14 temp___2392))
(assert (= (mk2 current4 (to_rep1 values__last)) temp___2393))
(assert (= temp___2392 o15))
(assert (= (mk (to_rep1 (first4 temp___2393)) (to_rep1 (last4 temp___2393))) o16))
(assert (and (= o17 (index_of_minimum (mk___t o15 o16))) (and (in_range3 o17) (and (and (<= (to_rep1 (first o16)) o17) (<= o17 (to_rep1 (last o16)))) (forall ((i2 Int)) (=> (and (<= (to_rep1 (first o16)) i2) (<= i2 (to_rep1 (last o16)))) (<= (to_rep (select o15 o17)) (to_rep (select o15 i2)))))))))
(assert (= smallest3 result6))
(assert (= smallest4 o17))
(assert true)
(assert (=> (not (= smallest4 current4)) (= (slide values3 (to_rep1 values__first) (to_rep1 values__first)) temp___2402)))
(assert (=> (not (= smallest4 current4)) (= (mk1 (to_rep1 values__first) (to_rep1 values__last)) temp___2403)))
(assert (=> (not (= smallest4 current4)) (= (ite (<= (to_rep1 (first2 temp___2403)) (to_rep1 (last2 temp___2403))) (+ (- (to_rep1 (last2 temp___2403)) (to_rep1 (first2 temp___2403))) 1) 0) (ite (<= (to_rep1 previous__first) (to_rep1 previous__last)) (+ (- (to_rep1 previous__last) (to_rep1 previous__first)) 1) 0))))
(assert (=> (not (= smallest4 current4)) (= (mk___t1 o18 o19) (mk___t1 temp___2402 temp___2403))))
(assert (=> (not (= smallest4 current4)) (= o20 o18)))
(assert (=> (not (= smallest4 current4)) (= previous3 result7)))
(assert (=> (not (= smallest4 current4)) (= previous4 o20)))
(assert (=> (not (= smallest4 current4)) (and (= o21 current4) (in_range3 current4))))
(assert (=> (not (= smallest4 current4)) (and (and (and (= (is_perm (mk___t values3 (mk (to_rep1 values__first) (to_rep1 values__last))) (mk___t values4 (mk (to_rep1 values__first) (to_rep1 values__last)))) true) (= (to_rep (select values4 o21)) (to_rep (select values3 smallest4)))) (= (to_rep (select values4 smallest4)) (to_rep (select values3 o21)))) (forall ((z Int)) (=> (and (<= (to_rep1 values__first) z) (<= z (to_rep1 values__last))) (=> (and (not (= z o21)) (not (= z smallest4))) (= (to_rep (select values4 z)) (to_rep (select values3 z)))))))))
(assert (=> (= smallest4 current4) (= previous4 previous3)))
(assert (=> (= smallest4 current4) (= values4 values3)))
(assert (not (= (is_perm (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last))) (mk___t values4 (mk (to_rep1 values__first) (to_rep1 values__last)))) true)))
(check-sat)
(exit)
