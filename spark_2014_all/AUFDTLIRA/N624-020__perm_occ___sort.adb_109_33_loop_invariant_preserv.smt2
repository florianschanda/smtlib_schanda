...
(assert (= smallest1 o4))
(assert (=> (not (= smallest1 current1)) (= (slide values (to_rep1 values__first) (to_rep1 values__first)) temp___240)))
(assert (=> (not (= smallest1 current1)) (= (mk1 (to_rep1 values__first) (to_rep1 values__last)) temp___2401)))
(assert (=> (not (= smallest1 current1)) (= (ite (<= (to_rep1 (first2 temp___2401)) (to_rep1 (last2 temp___2401))) (+ (- (to_rep1 (last2 temp___2401)) (to_rep1 (first2 temp___2401))) 1) 0) (ite (<= (to_rep1 previous__first) (to_rep1 previous__last)) (+ (- (to_rep1 previous__last) (to_rep1 previous__first)) 1) 0))))
(assert (=> (not (= smallest1 current1)) (= (mk___t1 o5 o6) (mk___t1 temp___240 temp___2401))))
...
(assert (= (mk (to_rep1 (first4 temp___2393)) (to_rep1 (last4 temp___2393))) o11))
...
(assert (=> (not (= smallest3 current3)) (= (slide values3 (to_rep1 values__first) (to_rep1 values__first)) temp___2402)))
(assert (=> (not (= smallest3 current3)) (= (mk1 (to_rep1 values__first) (to_rep1 values__last)) temp___2403)))
(assert (=> (not (= smallest3 current3)) (= (ite (<= (to_rep1 (first2 temp___2403)) (to_rep1 (last2 temp___2403))) (+ (- (to_rep1 (last2 temp___2403)) (to_rep1 (first2 temp___2403))) 1) 0) (ite (<= (to_rep1 previous__first) (to_rep1 previous__last)) (+ (- (to_rep1 previous__last) (to_rep1 previous__first)) 1) 0))))
(assert (=> (not (= smallest3 current3)) (= (mk___t1 o13 o14) (mk___t1 temp___2402 temp___2403))))
