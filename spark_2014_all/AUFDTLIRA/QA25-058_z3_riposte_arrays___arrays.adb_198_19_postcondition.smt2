...
(declare-const temp___314 (Array Int Bool))
...
(assert (= x1 0))
(assert (=> (and (<= 0 x1) (<= x1 255)) (and (and (= temp___316 x1) (and (= temp___314 r) (and (and (= (mk_map__ref result1) (mk_map__ref r)) (= r2 (store r x1 (ite (= x1 c) true false)))) (and (forall ((i Int)) (=> (and (<= 0 i) (<= i x2)) (= (= (select r3 i) true) (= i c)))) (and (and (and (forall ((temp___315 Int)) (=> (and (<= 0 temp___315) (<= temp___315 255)) (=> (< x2 temp___315) (= (select r3 temp___315) (select temp___314 temp___315))))) (=> (<= 0 255) (in_range1 x2))) (and (<= 0 x2) (<= x2 255))) (= x2 255)))))) (and (and (= x2 x6) (= r3 r7)) (and (= x7 x2) (= r8 r3))))))
(assert (=> (and (<= 0 x1) (<= x1 255)) (= (mk_int__ref x8) (mk_int__ref x6))))
(assert (=> (and (<= 0 x1) (<= x1 255)) (= (mk_map__ref r9) (mk_map__ref r7))))
(assert (=> (and (<= 0 x1) (<= x1 255)) (= x9 x7)))
(assert (=> (and (<= 0 x1) (<= x1 255)) (= r10 r8)))
(assert (=> (not (and (<= 0 x1) (<= x1 255))) (= x1 x8)))
(assert (=> (not (and (<= 0 x1) (<= x1 255))) (= (mk_map__ref r9) (mk_map__ref r))))
(assert (=> (not (and (<= 0 x1) (<= x1 255))) (= x9 x1)))
(assert (=> (not (and (<= 0 x1) (<= x1 255))) (= r10 r1)))
...
(assert (= result4 arrays__single_char_set_broken__result))
(assert (= arrays__single_char_set_broken__result1 r9))
...
(assert (= x11 x9))
(assert (= r12 r10))
(assert (= result5 arrays__single_char_set_broken__result4))
(declare-const i Int)
(assert (<= 0 i))
(assert (<= i 255))
