...
(assert (<= t1 100))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o72 (valid_root (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) t1)) (and (= (= o72 true) (and (<= t1 (to_rep f__split_fields)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 t1)))) 2))) (=> (< (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) t1) (not (= o72 true))))))
(assert (= o73 (ite (and (= o72 true) (not (= i t1))) true false)))
(assert (= result15 (ite (and (= o73 true) (not (= (int__content v2) t1))) true false)))
