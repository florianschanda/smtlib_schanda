...
(assert (and (= o40 (- y 1)) (in_range4 (- y 1))))
...
(assert (= hr5 o46))
(assert (and (= o48 y) (in_range4 y)))
(assert (and (= temp___268 (remove (mk___t values2 (mk 1 100)) o48)) (and (dynamic_invariant3 temp___268 true false true true) (and (= (invariant__ temp___268) true) (and (= (to_rep1 (last (rt temp___268))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o48 1))) (= (to_rep (select values2 k)) (to_rep (select (elts temp___268) k))))) (and (forall ((k Int)) (=> (and (<= (+ o48 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select (elts temp___268) (- k 1)))))) (forall ((k Int)) (=> (and (<= o48 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts temp___268) k))))))))))))
...
(assert (and (= o47 x) (in_range4 x)))
(assert (and (= temp___266 (remove (mk___t init (mk 1 100)) o47)) (and (dynamic_invariant3 temp___266 true false true true) (and (= (invariant__ temp___266) true) (and (= (to_rep1 (last (rt temp___266))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o47 1))) (= (to_rep (select init k)) (to_rep (select (elts temp___266) k))))) (and (forall ((k Int)) (=> (and (<= (+ o47 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select init k)) (to_rep (select (elts temp___266) (- k 1)))))) (forall ((k Int)) (=> (and (<= o47 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select init (+ k 1))) (to_rep (select (elts temp___266) k))))))))))))
(assert (not (<= (- y 1) (to_rep1 (last (rt temp___266))))))
(check-sat)
(exit)
