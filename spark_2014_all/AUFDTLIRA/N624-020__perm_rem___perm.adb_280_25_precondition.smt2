...
(assert (= (is_perm (remove (remove a ia1) (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w)))) (remove (remove b ib2) (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))))) true))
(assert (and (= o26 (remove b ib2)) (and (dynamic_invariant2 o26 true false true) (and (= (invariant__ o26) true) (and (= (to_rep2 (last (rt o26))) (- (to_rep2 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib2 1))) (= (to_rep (select (elts b) k)) (to_rep (select (elts o26) k))))) (and (forall ((k Int)) (=> (and (<= (+ ib2 1) k) (<= k (to_rep2 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select (elts o26) (- k 1)))))) (forall ((k Int)) (=> (and (<= ib2 k) (<= k (- (to_rep2 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select (elts o26) k))))))))))))
...
(assert (not (= (invariant__ o25) true)))
(check-sat)
(exit)
