...
(assert (= (is_perm (remove (remove a ia3) (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w)))) (remove (remove b ib10) (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))))) true))
(assert (and (= o114 (remove b ib10)) (and (dynamic_invariant2 o114 true false true) (and (= (invariant__ o114) true) (and (= (to_rep2 (last (rt o114))) (- (to_rep2 (last (rt b))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- ib10 1))) (= (to_rep (select (elts b) k1)) (to_rep (select (elts o114) k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ ib10 1) k1) (<= k1 (to_rep2 (last (rt b))))) (= (to_rep (select (elts b) k1)) (to_rep (select (elts o114) (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= ib10 k1) (<= k1 (- (to_rep2 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k1 1))) (to_rep (select (elts o114) k1))))))))))))
(assert (and (= o112 ia3) (in_range4 ia3)))
(assert (and (= o113 (remove a o112)) (and (dynamic_invariant2 o113 true false true) (and (= (invariant__ o113) true) (and (= (to_rep2 (last (rt o113))) (- (to_rep2 (last (rt a))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- o112 1))) (= (to_rep (select (elts a) k1)) (to_rep (select (elts o113) k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ o112 1) k1) (<= k1 (to_rep2 (last (rt a))))) (= (to_rep (select (elts a) k1)) (to_rep (select (elts o113) (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= o112 k1) (<= k1 (- (to_rep2 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k1 1))) (to_rep (select (elts o113) k1))))))))))))
(assert (not (= (invariant__ o113) true)))
(check-sat)
(exit)
