...
(assert (and (and (= (to_rep1 (first4 (rt2 (rec__bounded_strings__bounded_string__text1 b__split_fields3)))) (to_rep1 (first4 o8))) (= (to_rep1 (last4 (rt2 (rec__bounded_strings__bounded_string__text1 b__split_fields3)))) (to_rep1 (last4 o8)))) (forall ((temp___211 Int)) (ite (and (<= 1 temp___211) (<= temp___211 (length initializer))) (= (select o7 temp___211) (select temp___210 temp___211)) (= (select o7 temp___211) (select (elts2 (rec__bounded_strings__bounded_string__text1 b__split_fields3)) temp___211))))))
(assert (= o9 (mk___split_fields1 (mk___t2 o7 o8) (rec__bounded_strings__bounded_string__size1 b__split_fields3))))
(assert (= temp___213 (mk___rep1 b__split_discrs o9)))
