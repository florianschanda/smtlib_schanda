...
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5))) true))
(assert (and (= o9 (size (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5)))) (and (in_range2 o9) (= o9 (to_rep f__split_fields4)))))
(assert (= result5 (ite (= o9 (+ (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) 1)) true false)))
(assert (= result5 true))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o8 (valid_root (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root2)) (and (= (= o8 true) (and (<= root2 (to_rep f__split_fields)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 root2)))) 2))) (=> (< (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) root2) (not (= o8 true))))))
...
(assert (<= i 100))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5))) true))
(assert (and (= o5 (parent (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5)) i)) (and (in_range2 o5) (and (= o5 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields5 i))))) (and (=> (= (valid_root (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5)) i) true) (= o5 0)) (=> (= (size (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5))) 0) (= o5 0)))))))
(assert (= o6 (ite (= o5 0) true false)))
(assert (= result9 (ite (not (= o6 true)) true false)))
(assert (= result9 true))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o7 (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i)) (and (in_range4 o7) (= o7 (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 i))))))))
