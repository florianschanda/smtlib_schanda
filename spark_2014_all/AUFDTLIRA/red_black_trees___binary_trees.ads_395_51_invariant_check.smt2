...
(assert (<= i4 100))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5))) true))
(assert (and (= o7 (parent (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5)) i4)) (and (in_range2 o7) (and (= o7 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields5 i4))))) (and (=> (= (valid_root (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5)) i4) true) (= o7 0)) (=> (= (size (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5))) 0) (= o7 0)))))))
(assert (= o8 (ite (= o7 0) true false)))
(assert (= result10 (ite (not (= o8 true)) true false)))
(assert (= result10 true))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o9 (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i4)) (and (in_range4 o9) (= o9 (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 i4))))))))
