...
(assert (and (and (and (= (mk_map__ref result) (mk_map__ref a)) (= a1 (store a 17 (mk___rep (mk___split_fields (of_int 1) (rec__arrays_of_records__basic_record__first_value (us_split_fields1 (select a 17))) (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select a 17)))))))) (and (and (and (and (and (= (to_rep o) 42) (and (= (rec__arrays_of_records__basic_record__flag (us_split_fields1 (select a1 17))) o1) (and (= o o2) (= (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select a1 17))) o3)))) (and (= o4 o1) (and (= o5 o2) (= o6 o3)))) (= o7 (store a1 17 (mk___rep (mk___split_fields o4 o5 o6))))) (and (= a1 result1) (= a2 o7))) (and (and (and (and (and (= (to_rep o8) 23) (and (= (rec__arrays_of_records__basic_record__flag (us_split_fields1 (select a2 101))) o9) (and (= (rec__arrays_of_records__basic_record__first_value (us_split_fields1 (select a2 101))) o10) (= o8 o11)))) (and (= o12 o9) (and (= o13 o10) (= o14 o11)))) (= o15 (store a2 101 (mk___rep (mk___split_fields o12 o13 o14))))) (and (= a2 result2) (= a3 o15))) (= (to_rep (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select a3 101)))) 23)))) (and (= a3 a4) (= a5 a3))))
