...
(declare-const j Int)
(declare-const o Int)
(declare-const temp___2114 (Array Int us_rep1))
...
(assert (= result (ite (< 0 o14) true false)))
(assert (= result true))
...
(assert (= result2 true))
(assert (and (= o10 (peek (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) l d)) (and (in_range4 o10) (and (ite (not (= o10 0)) (and (= (position (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) o10) d) (= (parent (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) o10) l)) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (= (parent (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) j1) l) (not (= (position (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) j1) d)))))) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (parent (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) j1) l) (= (position (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) j1) d)) (= o10 j1))))))))
(assert (= result3 (ite (= o10 0) true false)))
(assert (= result3 true))
...
(assert (= result5 (ite (= o9 o8) true false)))
(assert (= result5 true))
...
(assert (and (= result6 (valid_root (rec__search_trees__search_tree__struct (us_split_fields7 t)) o6)) (=> (< (size (rec__search_trees__search_tree__struct (us_split_fields7 t))) o6) (not (= result6 true)))))
(assert (= result6 true))
(assert (not (= i 0)))
(assert (and (= o5 (peek (rec__search_trees__search_tree__struct (us_split_fields7 t)) l d)) (and (in_range4 o5) (and (ite (not (= o5 0)) (and (= (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) o5) d) (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) o5) l)) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) j1) l) (not (= (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) j1) d)))))) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) j1) l) (= (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) j1) d)) (= o5 j1))))))))
(assert (= result7 (ite (= o5 i) true false)))
(assert (= result7 true))
...
(assert (and (= temp___2114 (model__ (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) o)) (and (dynamic_invariant8 temp___2114 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2114 o))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___2114 o)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 o)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2114 (parent (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2114 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2114 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2114 i1))) true) (not (= i1 o))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___2114 (parent (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) i1)))) (position (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___2114 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___2114 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2114 i1))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2114 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___2114 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___2114 j1)))) true)) (= j1 i1))))))))))))))
(assert (= (mk___rep (mk___split_fields o1 o2)) (select temp___2114 j)))
(assert (= o1 o3))
(assert (= o2 o4))
(assert (= result9 o4))
(assert (= result9 true))
