...
(assert (and (= temp___2070 (model__ (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) o26)) (and (dynamic_invariant8 temp___2070 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2070 o26))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___2070 o26)))) 0) (and (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 100)) (=> (not (= i4 o26)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) i4) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2070 (parent (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) i4)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2070 i4))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2070 i4))) true)))))) (and (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2070 i4))) true) (not (= i4 o26))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___2070 (parent (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) i4)))) (position (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) i4) (rec__tree_model__path_type__a (us_split_fields1 (select temp___2070 i4)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___2070 i4)))) 0)))) (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2070 i4))) true) (forall ((j14 Int)) (=> (and (<= 1 j14) (<= j14 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2070 j14))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___2070 i4))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___2070 j14)))) true)) (= j14 i4))))))))))))))
(assert (= (mk___rep (mk___split_fields o27 o28)) (select temp___2070 j2)))
(assert (= o27 o29))
(assert (= o28 o30))
(assert (= result13 o30))
