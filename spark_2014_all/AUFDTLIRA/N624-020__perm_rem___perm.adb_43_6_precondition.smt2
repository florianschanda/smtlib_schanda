...
(assert (and (= result (invariant__ a)) (= (= result true) (and (= (to_rep2 (first (rt a))) 1) (<= 0 (to_rep2 (last (rt a))))))))
(assert (= result true))
(assert (and (= result1 (invariant__ b)) (= (= result1 true) (and (= (to_rep2 (first (rt b))) 1) (<= 0 (to_rep2 (last (rt b))))))))
(assert (= result1 true))
