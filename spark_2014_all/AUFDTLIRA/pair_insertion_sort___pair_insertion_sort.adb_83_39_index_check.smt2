...
(assert (and (<= (to_rep a__first) temp___262) (<= temp___262 (to_rep a__last))))
(assert (= o24 temp___262))
(assert (= o25 (select a3 o24)))
(assert (= o26 (to_rep o25)))
(assert (= o27 (ite (= o26 y3) true false)))
(assert (not (<= (to_rep a__first) j3)))
(check-sat)
(exit)
