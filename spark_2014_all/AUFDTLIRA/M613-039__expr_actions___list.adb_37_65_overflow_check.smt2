...
(assert (<= first2 i12))
(assert (<= i12 last3))
(assert (and (= o12 (top (mk___rep (us_split_fields__content s__split_fields10)))) (and (in_range1 o12) (= o12 (to_rep1 (rec__stack__stack__top (us_split_fields__content s__split_fields10)))))))
...
(assert (= result4 (mk___split_fields__ref1 (mk___split_fields1 res__split_fields))))
(assert (= res__split_fields2 list__my_lists__append__2__container__fields))
(assert (= (let ((temp___185 (to__ (mk___rep s__split_fields12)))) (let ((temp___184 (to_but_top (mk___rep (us_split_fields__content s__split_fields10))))) (bool_eq (elts temp___184) (to_rep (first (rt temp___184))) (to_rep (last (rt temp___184))) (elts temp___185) (to_rep (first (rt temp___185))) (to_rep (last (rt temp___185)))))) true))
(assert (and (and (= (to_rep (last (rt (to__ (mk___rep s__split_fields13))))) (- last3 i13)) (= (bool_eq (elts (to__ (mk___rep s__split_fields13))) (to_rep (first3 (mk1 first2 (- last3 i13)))) (to_rep (last4 (mk1 first2 (- last3 i13)))) (elts (to__ (mk___rep (us_split_fields__content s__split_fields10)))) (to_rep (first5 (mk2 first2 (- last3 i13)))) (to_rep (last6 (mk2 first2 (- last3 i13))))) true)) (forall ((j2 Int)) (=> (and (<= first2 j2) (<= j2 i13)) (= (get (model__ (mk___rep1 res__split_discrs res__split_fields3)) j2) (get (model__ l) (+ (- (last2 (model__ l)) j2) 1)))))))
(assert (and (=> (<= first2 last3) (dynamic_property2 first2 last3 i13)) (and (<= first2 i13) (<= i13 last3))))
(assert (and (= list__reverse_list__L_2__R20b (to__ (mk___rep (us_split_fields__content s__split_fields10)))) (dynamic_invariant1 list__reverse_list__L_2__R20b true false true)))
(assert (and (= list__reverse_list__L_2__R16b (to__ (mk___rep s__split_fields13))) (dynamic_invariant1 list__reverse_list__L_2__R16b true false true)))
(assert (and (= o25 (- last3 i13)) (in_range1 (- last3 i13))))
(assert (and (= o24 (to__ (mk___rep s__split_fields13))) (dynamic_invariant1 o24 true false true)))
(assert (= o26 (to_rep (last (rt o24)))))
(assert (= result6 (ite (= o26 o25) true false)))
(assert (=> (= result6 true) (and (= temp___470 (- last3 i13)) (in_range1 (- last3 i13)))))
(assert (=> (= result6 true) (=> (<= first2 temp___470) (and (and (<= (to_rep (first (rt list__reverse_list__L_2__R20b))) first2) (<= first2 (to_rep (last (rt list__reverse_list__L_2__R20b))))) (and (<= (to_rep (first (rt list__reverse_list__L_2__R20b))) temp___470) (<= temp___470 (to_rep (last (rt list__reverse_list__L_2__R20b)))))))))
(assert (=> (= result6 true) (= o22 (elts list__reverse_list__L_2__R20b))))
(assert (=> (= result6 true) (= temp___472 (mk___t2 o22 (mk2 first2 temp___470)))))
(assert (=> (= result6 true) (and (= temp___469 (- last3 i13)) (in_range1 (- last3 i13)))))
(assert (=> (= result6 true) (=> (<= first2 temp___469) (and (and (<= (to_rep (first (rt list__reverse_list__L_2__R16b))) first2) (<= first2 (to_rep (last (rt list__reverse_list__L_2__R16b))))) (and (<= (to_rep (first (rt list__reverse_list__L_2__R16b))) temp___469) (<= temp___469 (to_rep (last (rt list__reverse_list__L_2__R16b)))))))))
(assert (=> (= result6 true) (= o23 (elts list__reverse_list__L_2__R16b))))
(assert (=> (= result6 true) (= temp___471 (mk___t1 o23 (mk1 first2 temp___469)))))
(assert (=> (= result6 true) (= result5 (bool_eq (elts1 temp___471) (to_rep (first3 (rt1 temp___471))) (to_rep (last4 (rt1 temp___471))) (elts2 temp___472) (to_rep (first5 (rt2 temp___472))) (to_rep (last6 (rt2 temp___472)))))))
(assert (=> (not (= result6 true)) (= result5 false)))
(assert (= result5 true))
(assert (<= first2 j1))
(assert (<= j1 i13))
(assert (and (= o14 (last2 (model__ l))) (and (in_range6 o14) (= o14 (last2 (model__ l))))))
(assert (= o15 (- o14 j1)))
