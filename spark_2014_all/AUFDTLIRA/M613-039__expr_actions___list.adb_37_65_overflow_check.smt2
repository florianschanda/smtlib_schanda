...
(assert (= i2 first2))
(assert (=> (and (<= first2 i2) (<= i2 last3)) (and (= s__split_fields temp___505) (= s__split_fields1 temp___5051))))
(assert (=> (and (<= first2 i2) (<= i2 last3)) (= temp___504 i2)))
...
(assert (and (= list__reverse_list__L_2__R20b (to__ (mk___rep (us_split_fields__content s__split_fields7)))) (dynamic_invariant1 list__reverse_list__L_2__R20b true false true true)))
(assert (and (= list__reverse_list__L_2__R16b (to__ (mk___rep s__split_fields10))) (dynamic_invariant1 list__reverse_list__L_2__R16b true false true true)))
(assert (and (= o10 (- last3 i9)) (in_range1 (- last3 i9))))
(assert (and (= o9 (to__ (mk___rep s__split_fields10))) (dynamic_invariant1 o9 true false true true)))
(assert (= o11 (to_rep (last (rt o9)))))
(assert (= result4 (ite (= o11 o10) true false)))
(assert (=> (= result4 true) (and (= temp___516 (- last3 i9)) (in_range1 (- last3 i9)))))
(assert (=> (= result4 true) (=> (<= first2 temp___516) (and (and (<= (to_rep (first (rt list__reverse_list__L_2__R20b))) first2) (<= first2 (to_rep (last (rt list__reverse_list__L_2__R20b))))) (and (<= (to_rep (first (rt list__reverse_list__L_2__R20b))) temp___516) (<= temp___516 (to_rep (last (rt list__reverse_list__L_2__R20b)))))))))
(assert (=> (= result4 true) (= o7 (elts list__reverse_list__L_2__R20b))))
(assert (=> (= result4 true) (= temp___518 (mk___t2 o7 (mk2 first2 temp___516)))))
(assert (=> (= result4 true) (and (= temp___515 (- last3 i9)) (in_range1 (- last3 i9)))))
(assert (=> (= result4 true) (=> (<= first2 temp___515) (and (and (<= (to_rep (first (rt list__reverse_list__L_2__R16b))) first2) (<= first2 (to_rep (last (rt list__reverse_list__L_2__R16b))))) (and (<= (to_rep (first (rt list__reverse_list__L_2__R16b))) temp___515) (<= temp___515 (to_rep (last (rt list__reverse_list__L_2__R16b)))))))))
(assert (=> (= result4 true) (= o8 (elts list__reverse_list__L_2__R16b))))
(assert (=> (= result4 true) (= temp___517 (mk___t1 o8 (mk1 first2 temp___515)))))
(assert (=> (= result4 true) (= result3 (bool_eq (elts1 temp___517) (to_rep (first3 (rt1 temp___517))) (to_rep (last4 (rt1 temp___517))) (elts2 temp___518) (to_rep (first5 (rt2 temp___518))) (to_rep (last6 (rt2 temp___518)))))))
