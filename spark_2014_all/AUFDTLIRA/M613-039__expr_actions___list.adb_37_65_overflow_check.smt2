...
(assert (= i2 first2))
(assert (=> (and (<= first2 i2) (<= i2 last3)) (and (= s__split_fields temp___459) (= s__split_fields1 temp___4591))))
(assert (=> (and (<= first2 i2) (<= i2 last3)) (= temp___458 i2)))
(assert (=> (and (<= first2 i2) (<= i2 last3)) (and (= o i2) (in_range4 i2))))
...
(assert (=> (and (<= first2 i2) (<= i2 last3)) (and (= (to_rep (last (rt (to__ (mk___rep s__split_fields4))))) (+ (- i3 first2) 1)) (forall ((j1 Int)) (=> (and (<= first2 j1) (<= j1 i3)) (= (to_rep (select (elts (to__ (mk___rep s__split_fields4))) j1)) (get (model__ l) j1)))))))
...
(assert (= (let ((temp___185 (to__ (mk___rep s__split_fields9)))) (let ((temp___184 (to_but_top (mk___rep (us_split_fields__content s__split_fields7))))) (bool_eq (elts temp___184) (to_rep (first (rt temp___184))) (to_rep (last (rt temp___184))) (elts temp___185) (to_rep (first (rt temp___185))) (to_rep (last (rt temp___185)))))) true))
(assert (and (and (= (to_rep (last (rt (to__ (mk___rep s__split_fields10))))) (- last3 i9)) (= (bool_eq (elts (to__ (mk___rep s__split_fields10))) (to_rep (first3 (mk1 first2 (- last3 i9)))) (to_rep (last4 (mk1 first2 (- last3 i9)))) (elts (to__ (mk___rep (us_split_fields__content s__split_fields7)))) (to_rep (first5 (mk2 first2 (- last3 i9)))) (to_rep (last6 (mk2 first2 (- last3 i9))))) true)) (forall ((j1 Int)) (=> (and (<= first2 j1) (<= j1 i9)) (= (get (model__ (mk___rep1 res__split_discrs res__split_fields2)) j1) (get (model__ l) (+ (- (last2 (model__ l)) j1) 1)))))))
(assert (and (=> (<= first2 last3) (dynamic_property2 first2 last3 i9)) (and (<= first2 i9) (<= i9 last3))))
(assert (and (= list__reverse_list__L_2__R20b (to__ (mk___rep (us_split_fields__content s__split_fields7)))) (dynamic_invariant1 list__reverse_list__L_2__R20b true false true)))
(assert (and (= list__reverse_list__L_2__R16b (to__ (mk___rep s__split_fields10))) (dynamic_invariant1 list__reverse_list__L_2__R16b true false true)))
(assert (and (= o10 (- last3 i9)) (in_range1 (- last3 i9))))
(assert (and (= o9 (to__ (mk___rep s__split_fields10))) (dynamic_invariant1 o9 true false true)))
(assert (= o11 (to_rep (last (rt o9)))))
(assert (= result4 (ite (= o11 o10) true false)))
(assert (=> (= result4 true) (and (= temp___470 (- last3 i9)) (in_range1 (- last3 i9)))))
(assert (=> (= result4 true) (=> (<= first2 temp___470) (and (and (<= (to_rep (first (rt list__reverse_list__L_2__R20b))) first2) (<= first2 (to_rep (last (rt list__reverse_list__L_2__R20b))))) (and (<= (to_rep (first (rt list__reverse_list__L_2__R20b))) temp___470) (<= temp___470 (to_rep (last (rt list__reverse_list__L_2__R20b)))))))))
(assert (=> (= result4 true) (= o7 (elts list__reverse_list__L_2__R20b))))
(assert (=> (= result4 true) (= temp___472 (mk___t2 o7 (mk2 first2 temp___470)))))
(assert (=> (= result4 true) (and (= temp___469 (- last3 i9)) (in_range1 (- last3 i9)))))
(assert (=> (= result4 true) (=> (<= first2 temp___469) (and (and (<= (to_rep (first (rt list__reverse_list__L_2__R16b))) first2) (<= first2 (to_rep (last (rt list__reverse_list__L_2__R16b))))) (and (<= (to_rep (first (rt list__reverse_list__L_2__R16b))) temp___469) (<= temp___469 (to_rep (last (rt list__reverse_list__L_2__R16b)))))))))
(assert (=> (= result4 true) (= o8 (elts list__reverse_list__L_2__R16b))))
(assert (=> (= result4 true) (= temp___471 (mk___t1 o8 (mk1 first2 temp___469)))))
(assert (=> (= result4 true) (= result3 (bool_eq (elts1 temp___471) (to_rep (first3 (rt1 temp___471))) (to_rep (last4 (rt1 temp___471))) (elts2 temp___472) (to_rep (first5 (rt2 temp___472))) (to_rep (last6 (rt2 temp___472)))))))
(assert (=> (not (= result4 true)) (= result3 false)))
(assert (= result3 true))
(assert (<= first2 j))
(assert (<= j i9))
(assert (and (= o3 (last2 (model__ l))) (and (in_range6 o3) (= o3 (last2 (model__ l))))))
(assert (= o4 (- o3 j)))
