...
(assert (<= i2 j))
(assert (<= j k2))
(assert (and (= o28 j) (in_range2 j)))
(assert (and (= o29 (get_max_right o28 a2)) (and (in_range1 o29) (= o29 (to_rep (rec__frame_condition__cell__max_right (us_split_fields1 (select a2 o28))))))))
