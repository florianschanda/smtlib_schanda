...
(define-fun dynamic_invariant ((temp___expr_158 Int) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool)) Bool (=> (or (= temp___is_init_155 true) (<= 0 43)) (in_range4 temp___expr_158)))
...
(declare-const dummy11 t1)
(declare-datatypes () ((t__ref (mk_t__ref (t__content t1)))))
(define-fun t__ref___2__projection ((a t__ref)) t1 (t__content a))
(define-fun dynamic_invariant1 ((temp___expr_833 Int) (temp___is_init_830 Bool) (temp___skip_constant_831 Bool) (temp___do_toplevel_832 Bool)) Bool (=> (or (= temp___is_init_830 true) (<= 0 1)) (in_range10 temp___expr_833)))
...
(assert true)
(define-fun dynamic_invariant6 ((temp___expr_170 Int) (temp___is_init_167 Bool) (temp___skip_constant_168 Bool) (temp___do_toplevel_169 Bool)) Bool (=> (or (= temp___is_init_167 true) (<= 1 150)) (in_range5 temp___expr_170)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(assert (= nouser (temp___String_Literal_135 Tuple0)))
(define-fun dynamic_invariant7 ((temp___expr_236 Int) (temp___is_init_233 Bool) (temp___skip_constant_234 Bool) (temp___do_toplevel_235 Bool)) Bool (=> (or (= temp___is_init_233 true) (<= 1901 2099)) (in_range6 temp___expr_236)))
(define-fun dynamic_invariant8 ((temp___expr_242 Int) (temp___is_init_239 Bool) (temp___skip_constant_240 Bool) (temp___do_toplevel_241 Bool)) Bool (=> (or (= temp___is_init_239 true) (<= 1 12)) (in_range7 temp___expr_242)))
(define-fun dynamic_invariant9 ((temp___expr_248 Int) (temp___is_init_245 Bool) (temp___skip_constant_246 Bool) (temp___do_toplevel_247 Bool)) Bool (=> (or (= temp___is_init_245 true) (<= 1 31)) (in_range8 temp___expr_248)))
(define-fun dynamic_invariant10 ((temp___expr_272 Int) (temp___is_init_269 Bool) (temp___skip_constant_270 Bool) (temp___do_toplevel_271 Bool)) Bool (=> (or (= temp___is_init_269 true) (<= 0 86399999)) (in_range9 temp___expr_272)))
...
(assert (= result (greaterthanorequal o4 (mk___rep (mk___split_fields latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3)))))
(assert (=> (= result true) (= (mk_int__ref result1) locallatch3)))
(assert (=> (= result true) (= locallatch1 0)))
(assert (=> (= result true) (= (mk_int__ref result2) id3)))
(assert (=> (= result true) (= id1 8)))
(assert (=> (not (= result true)) (= (mk_int__ref result3) locallatch3)))
(assert (=> (not (= result true)) (= locallatch2 1)))
(assert (=> (not (= result true)) (= (mk_int__ref result4) id3)))
