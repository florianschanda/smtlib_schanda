...
(assert (forall ((temp___143 us_t)) (forall ((temp___144 Int) (temp___145 Int) (temp___146 Int) (temp___147 Int)) (let ((temp___142 (temp___141 temp___143 temp___144 temp___145 temp___146 temp___147))) (and (and (= (first1 temp___142) (first1 temp___143)) (= (last1 temp___142) (last1 temp___143))) (forall ((temp___148 Int)) (ite (= temp___148 temp___146) (= (select (to_array temp___142) temp___148) (of_rep temp___147)) (ite (= temp___148 temp___144) (= (select (to_array temp___142) temp___148) (of_rep temp___145)) (= (select (to_array temp___142) temp___148) (select (to_array temp___143) temp___148))))))))))
...
(declare-const temp___1812 (Array Int integer))
(declare-const temp___1813 t1)
