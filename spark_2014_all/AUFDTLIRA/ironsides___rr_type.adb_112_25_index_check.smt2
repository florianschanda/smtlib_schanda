...
(define-fun dynamic_invariant4 ((temp___expr_228 Int) (temp___is_init_224 Bool) (temp___skip_constant_225 Bool) (temp___do_toplevel_226 Bool) (temp___do_typ_inv_227 Bool)) Bool (=> (or (= temp___is_init_224 true) (<= 1 128)) (in_range4 temp___expr_228)))
...
(assert (<= (length s) 128))
(assert (= result newdomainname))
(assert (= newdomainname1 blankdomainname))
(assert (and (= temp___382 (length s)) (in_range1 (length s))))
(assert (= result1 i))
(assert (= i1 1))
(assert (<= 1 i1))
(assert (<= i1 temp___382))
(assert (and (forall ((temp___380 Int)) (=> (and (<= 1 temp___380) (<= temp___380 128)) (=> (<= i2 temp___380) (= (select newdomainname2 temp___380) (select newdomainname1 temp___380))))) (and (<= 1 i2) (<= i2 (length s)))))
(assert (and (<= (to_rep1 (first (rt s))) i2) (<= i2 (to_rep1 (last (rt s))))))
(assert (= o i2))
(assert (= o1 (select (elts s) o)))
(assert (= o2 (to_rep o1)))
(assert (= (to_rep o3) o2))
(assert (not (<= 1 i2)))
(check-sat)
