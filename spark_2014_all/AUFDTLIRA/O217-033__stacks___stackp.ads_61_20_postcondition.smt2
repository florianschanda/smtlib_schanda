...
(assert (= (to_rep1 o6) e))
(assert (and (= temp___602 (last2 (mk___rep1 s__split_fields20 s__attr__tag))) (and (in_range temp___602) (= temp___602 (ite (not (= (wraps_around (mk___rep1 s__split_fields20 s__attr__tag)) true)) (- (+ (to_rep3 s__split_fields4) (to_rep s__split_fields6)) 1) (- (- (+ (to_rep3 s__split_fields4) (to_rep s__split_fields6)) 1) 100))))))
