...
(assert (and (= result2 (is_perm a b)) (= (= result2 true) (or (and (= (length a) 0) (= (length b) 0)) (exists ((ia1 Int)) (and (and (<= (to_rep1 (first (rt a))) ia1) (<= ia1 (to_rep1 (last (rt a))))) (exists ((ib1 Int)) (and (and (<= (to_rep1 (first (rt b))) ib1) (<= ib1 (to_rep1 (last (rt b))))) (and (= (to_rep (select (elts a) ia1)) (to_rep (select (elts b) ib1))) (= (is_perm (remove a ia1) (remove b ib1)) true))))))))))
(assert (= result2 true))
