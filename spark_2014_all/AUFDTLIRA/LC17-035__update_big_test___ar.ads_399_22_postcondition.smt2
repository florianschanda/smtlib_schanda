...
(declare-fun temp___1299 ((Array Int (Array Int (Array Int et1))) Int (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1))))
(declare-fun temp___1305 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
(declare-fun temp___1312 ((Array Int et1) Int Int) (Array Int et1))
...
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (bool_eq2 a2 1 16 (temp___1299 a i3 (temp___1305 (select a i3) i2 (temp___1312 (select (select a i3) i2) i1 e))) 1 16) true)))
(check-sat)
(exit)
