...
(declare-fun temp___1240 ((Array Int (Array Int (Array Int et1))) Int (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1))))
(assert (forall ((temp___1242 (Array Int (Array Int (Array Int et1))))) (forall ((temp___1243 Int)) (forall ((temp___1244 (Array Int (Array Int et1)))) (let ((temp___1241 (temp___1240 temp___1242 temp___1243 temp___1244))) (forall ((temp___1245 Int)) (ite (= temp___1245 temp___1243) (= (select temp___1241 temp___1245) temp___1244) (= (select temp___1241 temp___1245) (select temp___1242 temp___1245)))))))))
(declare-fun temp___1246 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
(assert (forall ((temp___1248 (Array Int (Array Int et1)))) (forall ((temp___1249 Int)) (forall ((temp___1250 (Array Int et1))) (let ((temp___1247 (temp___1246 temp___1248 temp___1249 temp___1250))) (forall ((temp___1251 Int)) (ite (= temp___1251 temp___1249) (= (select temp___1247 temp___1251) temp___1250) (= (select temp___1247 temp___1251) (select temp___1248 temp___1251)))))))))
(declare-fun temp___1253 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___1255 (Array Int et1))) (forall ((temp___1256 Int) (temp___1257 Int)) (let ((temp___1254 (temp___1253 temp___1255 temp___1256 temp___1257))) (forall ((temp___1258 Int)) (ite (= temp___1258 temp___1256) (= (select temp___1254 temp___1258) (of_rep temp___1257)) (= (select temp___1254 temp___1258) (select temp___1255 temp___1258))))))))
...
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (bool_eq2 a2 1 16 (temp___1240 a i3 (temp___1246 (select a i3) i2 (temp___1253 (select (select a i3) i2) i1 e))) 1 16) true)))
(check-sat)
(exit)
