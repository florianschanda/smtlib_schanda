...
(assert (forall ((temp___152 Int) (temp___153 Int) (temp___154 Int)) (let ((temp___151 (temp___150 temp___152 temp___153 temp___154))) (and (=> (dynamic_property 1 2147483647 temp___153 temp___154) (and (= (first3 temp___151) temp___153) (= (last3 temp___151) temp___154))) (forall ((temp___155 Int)) (= (select (to_array1 temp___151) temp___155) (of_rep temp___152)))))))
...
(assert (= (to_rep1 (first2 (rt1 (temp___150 120 (to_rep1 x__first) (to_rep1 x__last))))) (to_rep1 x__first)))
(assert (= (to_rep1 (last2 (rt1 (temp___150 120 (to_rep1 x__first) (to_rep1 x__last))))) (to_rep1 x__last)))
(assert (= (mk___t1 temp___157 temp___1571) (temp___150 120 (to_rep1 x__first) (to_rep1 x__last))))
(assert (= temp___157 temp___158))
(assert (= (mk (to_rep1 (first2 temp___1571)) (to_rep1 (last2 temp___1571))) temp___1581))
(assert (not (= (ite (<= (to_rep1 (first temp___1581)) (to_rep1 (last temp___1581))) (+ (- (to_rep1 (last temp___1581)) (to_rep1 (first temp___1581))) 1) 0) (ite (<= (to_rep1 x__first) (to_rep1 x__last)) (+ (- (to_rep1 x__last) (to_rep1 x__first)) 1) 0))))
(check-sat)
(exit)
