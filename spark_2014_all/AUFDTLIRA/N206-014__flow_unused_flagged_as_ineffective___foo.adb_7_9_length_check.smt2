...
(declare-fun temp___174 (Int Int Int) us_t1)
...
(assert (= (to_rep1 (first2 (rt1 (temp___174 120 (to_rep1 x__first) (to_rep1 x__last))))) (to_rep1 x__first)))
(assert (= (to_rep1 (last2 (rt1 (temp___174 120 (to_rep1 x__first) (to_rep1 x__last))))) (to_rep1 x__last)))
(assert (= (mk___t1 temp___181 temp___1811) (temp___174 120 (to_rep1 x__first) (to_rep1 x__last))))
