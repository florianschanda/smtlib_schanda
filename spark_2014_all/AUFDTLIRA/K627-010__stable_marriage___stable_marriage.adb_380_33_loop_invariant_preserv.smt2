...
(assert (= o5 o7))
(assert (= temp___495 o6))
(assert (= temp___4951 o7))
(assert (= result6 (mk___split_fields__ref unmatched_g1_set__split_fields3)))
(assert (= unmatched_g1_set__split_fields4 (mk___split_fields temp___495 temp___4951)))
...
(assert (= temp___499 o11))
(assert (= temp___4991 o12))
(assert (= result7 (mk___split_fields__ref unmatched_g1_set__split_fields4)))
(assert (= unmatched_g1_set__split_fields5 (mk___split_fields temp___499 temp___4991)))
(assert (not (= g12 64)))
