...
(assert (and (= o1 (+ (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields3)) 1)) (in_range4 (+ (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields3)) 1))))
(assert (= (to_rep3 o2) o1))
(assert (= (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields3) o3))
(assert (= o2 o4))
(assert (= temp___539 o3))
(assert (= temp___5391 o4))
(assert (= result7 (mk___split_fields__ref unmatched_g1_set__split_fields3)))
(assert (= unmatched_g1_set__split_fields4 (mk___split_fields temp___539 temp___5391)))
(assert (= (to_rep o5) c175b))
...
(assert (= o6 (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields4))))
(assert (= o7 (store (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields4) o6 o5)))
(assert (= o7 o8))
(assert (= (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields4) o9))
(assert (= temp___543 o8))
(assert (= temp___5431 o9))
(assert (= result8 (mk___split_fields__ref unmatched_g1_set__split_fields4)))
(assert (= unmatched_g1_set__split_fields5 (mk___split_fields temp___543 temp___5431)))
(assert (not (= g12 64)))
(assert (= result9 (mk_int__ref g12)))
(assert (= g13 (+ g12 1)))
