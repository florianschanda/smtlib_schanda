...
(assert (<= 1 g12))
(assert (<= g12 64))
(assert (= (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields3)) (- g13 1)))
(assert (= (all_unmatched_g1_set_elements_distinct unmatched_g1_set__split_fields3) true))
(assert (forall ((prev1 Int)) (=> (and (<= 1 prev1) (<= prev1 (- g13 1))) (= (to_rep (select (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields3) prev1)) prev1))))
(assert (and (=> (<= 1 64) (in_range1 g13)) (and (<= 1 g13) (<= g13 64))))
(assert (= g13 c175b))
(assert (in_range1 c175b))
(assert (and (= o5 (+ (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields3)) 1)) (in_range4 (+ (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields3)) 1))))
(assert (= (to_rep3 o6) o5))
(assert (= (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields3) o7))
(assert (= o6 o8))
(assert (= temp___495 o7))
(assert (= temp___4951 o8))
...
(assert (= o10 (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields4))))
(assert (= o11 (store (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields4) o10 o9)))
(assert (= o11 o12))
(assert (= (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields4) o13))
(assert (= temp___499 o12))
(assert (= temp___4991 o13))
...
(assert (not (= g13 64)))
(assert (= result8 (mk_int__ref g13)))
(assert (= g14 (+ g13 1)))
(assert (not (= (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields5)) (- g14 1))))
(check-sat)
(exit)
