...
(assert (and (forall ((g14 Int)) (=> (and (<= 1 g14) (<= g14 64)) (= (is_permutation_2 (select ranking_1 g14)) true))) (forall ((g2 Int)) (=> (and (<= 1 g2) (<= g2 64)) (= (is_permutation_1 (select ranking_2 g2)) true)))))
...
(assert (<= 1 g11))
(assert (<= g11 64))
(assert (= (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields3)) (- g12 1)))
(assert (= (all_unmatched_g1_set_elements_distinct unmatched_g1_set__split_fields3) true))
(assert (forall ((prev Int)) (=> (and (<= 1 prev) (<= prev (- g12 1))) (= (to_rep (select (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields3) prev)) prev))))
(assert (and (=> (<= 1 64) (in_range1 g12)) (and (<= 1 g12) (<= g12 64))))
(assert (= g12 c175b))
(assert (in_range1 c175b))
(assert (and (= o4 (+ (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields3)) 1)) (in_range4 (+ (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields3)) 1))))
(assert (= (to_rep3 o5) o4))
(assert (= (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields3) o6))
(assert (= o5 o7))
(assert (= temp___537 o6))
(assert (= temp___5371 o7))
(assert (= result6 (mk___split_fields__ref unmatched_g1_set__split_fields3)))
(assert (= unmatched_g1_set__split_fields4 (mk___split_fields temp___537 temp___5371)))
(assert (= (to_rep o8) c175b))
(assert (and (<= 1 (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields4))) (<= (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields4)) 64)))
(assert (= o9 (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields4))))
(assert (= o10 (store (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields4) o9 o8)))
(assert (= o10 o11))
(assert (= (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields4) o12))
(assert (= temp___541 o11))
(assert (= temp___5411 o12))
(assert (= result7 (mk___split_fields__ref unmatched_g1_set__split_fields4)))
(assert (= unmatched_g1_set__split_fields5 (mk___split_fields temp___541 temp___5411)))
(assert (not (= g12 64)))
(assert (= result8 (mk_int__ref g12)))
(assert (= g13 (+ g12 1)))
(assert (not (= (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields5)) (- g13 1))))
(check-sat)
(exit)
