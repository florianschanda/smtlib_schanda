...
(declare-const i__split_fields9 integer)
(declare-const i__split_fields10 integer)
(declare-const i__split_fields11 integer)
(declare-const i__split_fields12 us_private)
(declare-const ai__split_fields10 natural)
(declare-const ai__split_fields11 integer)
(declare-const ai__split_fields12 integer)
(declare-const ai__split_fields13 integer)
(declare-const ai__split_fields14 us_private)
...
(declare-const result10 integer)
(declare-const result11 integer)
(declare-const result12 integer)
(declare-const result13 us_private)
(declare-const ai__split_fields15 natural)
(declare-const ai__split_fields16 integer)
(declare-const ai__split_fields17 integer)
(declare-const ai__split_fields18 integer)
(declare-const ai__split_fields19 us_private)
...
(declare-const i__split_fields13 us_split_fields)
(define-fun i__split_fields14 () us_split_fields (mk___split_fields i__split_fields9 i__split_fields10 i__split_fields11 i__split_fields12))
...
(assert (< (to_rep1 i__split_fields8) (to_rep1 i__split_fields11)))
(assert (< (to_rep1 ai__split_fields8) (to_rep1 ai__split_fields13)))
(assert (< (to_rep1 ai__split_fields13) (to_rep1 ints__bump__arg__fields2)))
(assert (= result9 ai__split_fields10))
(assert (= result10 ai__split_fields11))
(assert (= result11 ai__split_fields12))
(assert (= result12 ai__split_fields13))
(assert (= result13 ai__split_fields14))
(assert (= (mk___split_fields1 ai__split_fields15 ai__split_fields16 ai__split_fields17 ai__split_fields18 ai__split_fields19) (us_split_fields3 (of_base (mk___rep (mk___split_fields ints__bump__arg__fields ints__bump__arg__fields1 ints__bump__arg__fields2 ints__bump__arg__fields3) ai__attr__tag)))))
(assert (= result14 (mk___split_fields__ref (mk___split_fields ic__split_fields ic__split_fields1 ic__split_fields2 ic__split_fields3))))
(assert (= ic__split_fields8 i__split_fields14))
...
(assert (= ic__split_fields10 (mk___split_fields ai__split_fields16 ai__split_fields17 ai__split_fields18 (hide_ext__ ai__split_fields15 ai__split_fields19))))
...
(assert (< (to_rep1 i__split_fields11) (to_rep1 (rec__ints__int__value ints__call_bump__arg__fields))))
(assert (= result16 (mk___split_fields__ref i__split_fields14)))
(assert (= i__split_fields13 ints__call_bump__arg__fields))
(assert (not (< (to_rep1 ai__split_fields18) (- (to_rep1 ai__split_fields17) 10))))
(check-sat)
(exit)
