...
(assert true)
(assert true)
(define-fun default_initial_assumption1 ((temp___expr_156 us_rep1) (temp___skip_top_level_157 Bool)) Bool (= (attr__tag1 temp___expr_156) us_tag1))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_208 us_void_param) 1)) 105) (= (to_rep (select (temp___String_Literal_208 us_void_param) 2)) 110)) (= (to_rep (select (temp___String_Literal_208 us_void_param) 3)) 105)) (= (to_rep (select (temp___String_Literal_208 us_void_param) 4)) 116)) (= (to_rep (select (temp___String_Literal_208 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_208 us_void_param) 6)) 97)) (= (to_rep (select (temp___String_Literal_208 us_void_param) 7)) 108)) :pattern ((temp___String_Literal_208 us_void_param)))))
(declare-fun temp___String_Literal_209 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_209 us_void_param) 1)) 105) (= (to_rep (select (temp___String_Literal_209 us_void_param) 2)) 110)) (= (to_rep (select (temp___String_Literal_209 us_void_param) 3)) 105)) (= (to_rep (select (temp___String_Literal_209 us_void_param) 4)) 116)) (= (to_rep (select (temp___String_Literal_209 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_209 us_void_param) 6)) 97)) (= (to_rep (select (temp___String_Literal_209 us_void_param) 7)) 108)) :pattern ((temp___String_Literal_209 us_void_param)))))
(declare-fun temp___String_Literal_214 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_214 us_void_param) 1)) 105) (= (to_rep (select (temp___String_Literal_214 us_void_param) 2)) 110)) (= (to_rep (select (temp___String_Literal_214 us_void_param) 3)) 116)) (= (to_rep (select (temp___String_Literal_214 us_void_param) 4)) 101)) (= (to_rep (select (temp___String_Literal_214 us_void_param) 5)) 114)) (= (to_rep (select (temp___String_Literal_214 us_void_param) 6)) 109)) (= (to_rep (select (temp___String_Literal_214 us_void_param) 7)) 101)) (= (to_rep (select (temp___String_Literal_214 us_void_param) 8)) 100)) (= (to_rep (select (temp___String_Literal_214 us_void_param) 9)) 105)) (= (to_rep (select (temp___String_Literal_214 us_void_param) 10)) 97)) (= (to_rep (select (temp___String_Literal_214 us_void_param) 11)) 116)) (= (to_rep (select (temp___String_Literal_214 us_void_param) 12)) 101)) :pattern ((temp___String_Literal_214 us_void_param)))))
(declare-fun temp___String_Literal_215 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_215 us_void_param) 1)) 105) (= (to_rep (select (temp___String_Literal_215 us_void_param) 2)) 110)) (= (to_rep (select (temp___String_Literal_215 us_void_param) 3)) 116)) (= (to_rep (select (temp___String_Literal_215 us_void_param) 4)) 101)) (= (to_rep (select (temp___String_Literal_215 us_void_param) 5)) 114)) (= (to_rep (select (temp___String_Literal_215 us_void_param) 6)) 109)) (= (to_rep (select (temp___String_Literal_215 us_void_param) 7)) 101)) (= (to_rep (select (temp___String_Literal_215 us_void_param) 8)) 100)) (= (to_rep (select (temp___String_Literal_215 us_void_param) 9)) 105)) (= (to_rep (select (temp___String_Literal_215 us_void_param) 10)) 97)) (= (to_rep (select (temp___String_Literal_215 us_void_param) 11)) 116)) (= (to_rep (select (temp___String_Literal_215 us_void_param) 12)) 101)) :pattern ((temp___String_Literal_215 us_void_param)))))
(declare-fun temp___String_Literal_217 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_217 us_void_param) 1)) 116) (= (to_rep (select (temp___String_Literal_217 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_217 us_void_param) 3)) 109)) (= (to_rep (select (temp___String_Literal_217 us_void_param) 4)) 112)) (= (to_rep (select (temp___String_Literal_217 us_void_param) 5)) 111)) (= (to_rep (select (temp___String_Literal_217 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_217 us_void_param) 7)) 97)) (= (to_rep (select (temp___String_Literal_217 us_void_param) 8)) 114)) (= (to_rep (select (temp___String_Literal_217 us_void_param) 9)) 121)) :pattern ((temp___String_Literal_217 us_void_param)))))
(declare-fun temp___String_Literal_219 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_219 us_void_param) 1)) 116) (= (to_rep (select (temp___String_Literal_219 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_219 us_void_param) 3)) 109)) (= (to_rep (select (temp___String_Literal_219 us_void_param) 4)) 112)) (= (to_rep (select (temp___String_Literal_219 us_void_param) 5)) 111)) (= (to_rep (select (temp___String_Literal_219 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_219 us_void_param) 7)) 97)) (= (to_rep (select (temp___String_Literal_219 us_void_param) 8)) 114)) (= (to_rep (select (temp___String_Literal_219 us_void_param) 9)) 121)) :pattern ((temp___String_Literal_219 us_void_param)))))
(declare-fun temp___String_Literal_222 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (= (to_rep (select (temp___String_Literal_222 us_void_param) 1)) 102) (= (to_rep (select (temp___String_Literal_222 us_void_param) 2)) 105)) (= (to_rep (select (temp___String_Literal_222 us_void_param) 3)) 110)) (= (to_rep (select (temp___String_Literal_222 us_void_param) 4)) 97)) (= (to_rep (select (temp___String_Literal_222 us_void_param) 5)) 108)) :pattern ((temp___String_Literal_222 us_void_param)))))
(declare-fun temp___String_Literal_223 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (= (to_rep (select (temp___String_Literal_223 us_void_param) 1)) 102) (= (to_rep (select (temp___String_Literal_223 us_void_param) 2)) 105)) (= (to_rep (select (temp___String_Literal_223 us_void_param) 3)) 110)) (= (to_rep (select (temp___String_Literal_223 us_void_param) 4)) 97)) (= (to_rep (select (temp___String_Literal_223 us_void_param) 5)) 108)) :pattern ((temp___String_Literal_223 us_void_param)))))
...
(declare-const ic__split_fields integer)
(declare-const ic__split_fields1 integer)
(declare-const ic__split_fields2 integer)
(declare-const ic__split_fields3 us_private)
(declare-const ic__split_fields4 integer)
(declare-const ic__split_fields5 integer)
(declare-const ic__split_fields6 integer)
(declare-const ic__split_fields7 us_private)
...
(declare-const test_ints__i__assume integer)
(declare-const test_ints__i__assume1 integer)
(declare-const test_ints__i__assume2 integer)
(declare-const test_ints__i__assume3 us_private)
(declare-const test_ints__i__assume4 Int)
...
(declare-const test_ints__ai__assume natural)
(declare-const test_ints__ai__assume1 integer)
(declare-const test_ints__ai__assume2 integer)
(declare-const test_ints__ai__assume3 integer)
(declare-const test_ints__ai__assume4 us_private)
(declare-const test_ints__ai__assume5 Int)
...
(declare-const ints__bump__arg__fields integer)
(declare-const ints__bump__arg__fields1 integer)
(declare-const ints__bump__arg__fields2 integer)
(declare-const ints__bump__arg__fields3 us_private)
(declare-const result9 us_split_fields__ref)
(declare-const i__split_fields8 us_split_fields)
(declare-const ints__bump__arg__fields4 us_split_fields)
(declare-const result10 us_split_fields__ref)
(declare-const i__split_fields9 us_split_fields)
(declare-const ints__bump__2__arg__fields us_split_fields2)
(declare-const result11 us_split_fields__ref1)
(declare-const ai__split_fields10 us_split_fields2)
(declare-const ints__bump__arg__fields5 us_split_fields)
(declare-const result12 us_split_fields__ref1)
(declare-const ai__split_fields11 us_split_fields2)
(declare-const result13 us_split_fields__ref)
(declare-const ic__split_fields8 us_split_fields)
(declare-const ints__bump__arg__fields6 us_split_fields)
(declare-const result14 us_split_fields__ref)
(declare-const ic__split_fields9 us_split_fields)
(declare-const result15 us_split_fields__ref)
(declare-const ic__split_fields10 us_split_fields)
(declare-const ints__bump__arg__fields7 us_split_fields)
(declare-const result16 us_split_fields__ref)
(declare-const ic__split_fields11 us_split_fields)
...
(assert (= test_ints__i__assume o3))
(assert (= test_ints__i__assume1 o4))
(assert (= test_ints__i__assume2 o5))
(assert (= test_ints__i__assume3 o6))
(assert (= us_tag test_ints__i__assume4))
...
(assert (= test_ints__i__assume i__split_fields4))
(assert (= test_ints__i__assume1 i__split_fields5))
(assert (= test_ints__i__assume2 i__split_fields6))
(assert (= test_ints__i__assume3 i__split_fields7))
(assert (= i__attr__tag us_tag))
(assert (= (to_rep2 o7) 5))
(assert (= o7 o8))
(assert (= i__split_fields4 o9))
(assert (= i__split_fields5 o10))
(assert (= i__split_fields6 o11))
(assert (= us_null_ext__ o12))
(assert (= test_ints__ai__assume o8))
(assert (= test_ints__ai__assume1 o9))
(assert (= test_ints__ai__assume2 o10))
(assert (= test_ints__ai__assume3 o11))
(assert (= test_ints__ai__assume4 o12))
(assert (= us_tag1 test_ints__ai__assume5))
...
(assert (= test_ints__ai__assume ai__split_fields5))
(assert (= test_ints__ai__assume1 ai__split_fields6))
(assert (= test_ints__ai__assume2 ai__split_fields7))
(assert (= test_ints__ai__assume3 ai__split_fields8))
(assert (= test_ints__ai__assume4 ai__split_fields9))
(assert (= ai__attr__tag us_tag1))
(assert (< (to_rep1 i__split_fields6) (to_rep1 ints__bump__arg__fields2)))
(assert (= result9 (mk___split_fields__ref (mk___split_fields i__split_fields4 i__split_fields5 i__split_fields6 i__split_fields7))))
(assert (= i__split_fields8 (mk___split_fields ints__bump__arg__fields ints__bump__arg__fields1 ints__bump__arg__fields2 ints__bump__arg__fields3)))
(assert (< (to_rep1 (rec__ints__int__value i__split_fields8)) (to_rep1 (rec__ints__int__value ints__bump__arg__fields4))))
(assert (= result10 (mk___split_fields__ref i__split_fields8)))
(assert (= i__split_fields9 ints__bump__arg__fields4))
(assert (< (to_rep1 ai__split_fields8) (to_rep1 (rec__ints__int__value1 ints__bump__2__arg__fields))))
(assert (= result11 (mk___split_fields__ref1 (mk___split_fields1 ai__split_fields5 ai__split_fields6 ai__split_fields7 ai__split_fields8 ai__split_fields9))))
(assert (= ai__split_fields10 ints__bump__2__arg__fields))
(assert (< (to_rep1 (rec__ints__int__value1 ai__split_fields10)) (to_rep1 (rec__ints__int__value ints__bump__arg__fields5))))
(assert (= result12 (mk___split_fields__ref1 ai__split_fields10)))
(assert (= ai__split_fields11 (us_split_fields3 (of_base (mk___rep ints__bump__arg__fields5 ai__attr__tag)))))
(assert (= result13 (mk___split_fields__ref (mk___split_fields ic__split_fields ic__split_fields1 ic__split_fields2 ic__split_fields3))))
(assert (= ic__split_fields8 i__split_fields9))
(assert (= ic__attr__tag i__attr__tag))
(assert (and (< (to_rep1 (rec__ints__int__value ic__split_fields8)) (to_rep1 (rec__ints__int__value ints__bump__arg__fields6))) (bump__specific_post ic__attr__tag ints__bump__arg__fields6 ic__attr__tag ic__split_fields8)))
(assert (= result14 (mk___split_fields__ref ic__split_fields8)))
(assert (= ic__split_fields9 ints__bump__arg__fields6))
(assert (display__specific_post ic__attr__tag (mk___rep ic__split_fields9 ic__attr__tag) (mk___t (temp___String_Literal_217 Tuple0) (mk 1 9))))
(assert (= result15 (mk___split_fields__ref (mk___split_fields ic__split_fields4 ic__split_fields5 ic__split_fields6 ic__split_fields7))))
(assert (= ic__split_fields10 (mk___split_fields (rec__ints__int__min1 ai__split_fields11) (rec__ints__int__max1 ai__split_fields11) (rec__ints__int__value1 ai__split_fields11) (hide_ext__ (rec__ints__approx_int__precision ai__split_fields11) (rec__ext__1 ai__split_fields11)))))
(assert (= ic__attr__tag1 ai__attr__tag))
(assert (and (< (to_rep1 (rec__ints__int__value ic__split_fields10)) (to_rep1 (rec__ints__int__value ints__bump__arg__fields7))) (bump__specific_post ic__attr__tag1 ints__bump__arg__fields7 ic__attr__tag1 ic__split_fields10)))
(assert (= result16 (mk___split_fields__ref ic__split_fields10)))
(assert (= ic__split_fields11 ints__bump__arg__fields7))
(assert (display__specific_post ic__attr__tag1 (mk___rep ic__split_fields11 ic__attr__tag1) (mk___t (temp___String_Literal_219 Tuple0) (mk 1 9))))
(assert (< (to_rep1 (rec__ints__int__value i__split_fields9)) (to_rep1 (rec__ints__int__value ints__call_bump__arg__fields))))
(assert (= result17 (mk___split_fields__ref i__split_fields9)))
(assert (= i__split_fields10 ints__call_bump__arg__fields))
(assert (not (< (to_rep1 (rec__ints__int__value1 ai__split_fields11)) (- (to_rep1 (rec__ints__int__max1 ai__split_fields11)) 10))))
(check-sat)
(exit)
