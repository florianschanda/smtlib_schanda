...
(assert (< (to_rep1 i__split_fields6) (to_rep1 i__split_fields8)))
(assert (< (to_rep1 i__split_fields8) (to_rep1 (rec__ints__int__value i__split_fields9))))
(assert (< (to_rep1 ai__split_fields8) (to_rep1 (rec__ints__int__value1 ai__split_fields10))))
(assert (< (to_rep1 (rec__ints__int__value1 ai__split_fields10)) (to_rep1 (rec__ints__int__value ints__bump__arg__fields))))
(assert (= result9 (mk___split_fields__ref1 ai__split_fields10)))
(assert (= ai__split_fields11 (us_split_fields3 (of_base (mk___rep ints__bump__arg__fields ai__attr__tag)))))
(assert (= result10 (mk___split_fields__ref (mk___split_fields ic__split_fields ic__split_fields1 ic__split_fields2 ic__split_fields3))))
(assert (= ic__split_fields8 i__split_fields9))
(assert (= ic__attr__tag i__attr__tag))
(assert (and (< (to_rep1 (rec__ints__int__value ic__split_fields8)) (to_rep1 (rec__ints__int__value ic__split_fields9))) (bump__specific_post ic__attr__tag ic__split_fields9 ic__attr__tag ic__split_fields8)))
(assert (display__specific_post ic__attr__tag (mk___rep ic__split_fields9 ic__attr__tag) (mk___t (temp___String_Literal_245 Tuple0) (mk 1 9))))
(assert (= result11 (mk___split_fields__ref (mk___split_fields ic__split_fields4 ic__split_fields5 ic__split_fields6 ic__split_fields7))))
...
(assert (and (< (to_rep1 (rec__ints__int__value ic__split_fields10)) (to_rep1 (rec__ints__int__value ic__split_fields11))) (bump__specific_post ic__attr__tag1 ic__split_fields11 ic__attr__tag1 ic__split_fields10)))
(assert (display__specific_post ic__attr__tag1 (mk___rep ic__split_fields11 ic__attr__tag1) (mk___t (temp___String_Literal_246 Tuple0) (mk 1 9))))
(assert (< (to_rep1 (rec__ints__int__value i__split_fields9)) (to_rep1 (rec__ints__int__value ints__call_bump__arg__fields))))
(assert (= result12 (mk___split_fields__ref i__split_fields9)))
