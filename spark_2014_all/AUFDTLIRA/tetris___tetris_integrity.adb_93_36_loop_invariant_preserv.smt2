...
(assert (=> (= result9 true) (and (= o3 (- to_line8 1)) (in_range3 (- to_line8 1)))))
(assert (=> (= result9 true) (= result12 (mk_int__ref to_line8))))
(assert (=> (= result9 true) (= to_line9 o3)))
(assert (=> (= result9 true) (and (= o4 (+ num_deleted2 1)) (in_range1 (+ num_deleted2 1)))))
(assert (=> (= result9 true) (= result13 (mk_int__ref num_deleted2))))
(assert (=> (= result9 true) (= num_deleted3 o4)))
