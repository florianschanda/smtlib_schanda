...
(define-fun tab28 () map__ref (mk_map__ref tab))
(assert (in_range1 a))
(assert (in_range1 b))
...
(assert (=> (<= j1 b) (= (mk_map__ref result1) tab28)))
(assert (=> (<= j1 b) (= tab2 o2)))
...
(assert (= j31 a))
(assert (<= j31 b))
(assert (= (to_rep o21) j31))
(assert (and (<= (to_rep tab__first) j31) (<= j31 (to_rep tab__last))))
(assert (= o22 j31))
(assert (= o23 (store (map__content tab24) o22 o21)))
(assert (= result25 tab24))
(assert (= tab26 o23))
(assert (and (= o24 (+ j31 1)) (in_range1 (+ j31 1))))
(assert (= result26 (mk_int__ref j31)))
(assert (= j32 o24))
(assert (forall ((l Int)) (=> (and (<= a l) (<= l (- j33 1))) (= (to_rep (select tab27 l)) l))))
(assert (=> (<= (- 2147483648) 2147483647) (in_range1 j33)))
(assert (not (in_range1 (- j33 1))))
(check-sat)
(exit)
