...
(define-fun dynamic_invariant ((temp___expr_1071 Int) (temp___is_init_1068 Bool) (temp___skip_constant_1069 Bool) (temp___do_toplevel_1070 Bool)) Bool (=> (or (= temp___is_init_1068 true) (<= 0 2000)) (in_range4 temp___expr_1071)))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_382 us_t1) (temp___is_init_379 Bool) (temp___skip_constant_380 Bool) (temp___do_toplevel_381 Bool)) Bool (and (=> (not (= temp___skip_constant_380 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_382) (last3 temp___expr_382))) (=> (= temp___do_toplevel_381 true) (=> (= temp___is_init_379 true) (and (let ((temp___384 (of_array3 (to_array1 temp___expr_382) (first3 temp___expr_382) (last3 temp___expr_382)))) (and (let ((temp___385 (of_array2 (to_array3 temp___384) (first7 temp___384) (last7 temp___384)))) (and (= (first5 temp___385) 1) (<= 0 (last5 temp___385)))) (<= (last7 temp___384) 1000))) (<= 3 (length1 temp___expr_382)))))))
(define-fun dynamic_predicate ((temp___387 us_t1)) Bool (and (let ((temp___389 (of_array3 (to_array1 temp___387) (first3 temp___387) (last3 temp___387)))) (and (let ((temp___390 (of_array2 (to_array3 temp___389) (first7 temp___389) (last7 temp___389)))) (and (= (first5 temp___390) 1) (<= 0 (last5 temp___390)))) (<= (last7 temp___389) 1000))) (<= 3 (length1 temp___387))))
(declare-fun durationt_image (Int) us_t1)
(declare-fun durationt_image__function_guard (us_t1 Int) Bool)
(assert (forall ((x Int)) (! (=> (dynamic_invariant x true true true) (dynamic_invariant1 (durationt_image x) true false true)) :pattern ((durationt_image x)))))
(assert (forall ((x Int)) (! (=> (dynamic_invariant x true true true) (= (durationt_image x) (let ((temp___1077 (to_string (attr__ATTRIBUTE_IMAGE4 x)))) (of_array1 (to_array temp___1077) (first1 temp___1077) (last1 temp___1077))))) :pattern ((durationt_image x)))))
...
(declare-fun temp___String_Literal_1789 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1789 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_1789 us_void_param) 2)) 32)) (= (to_rep (select (temp___String_Literal_1789 us_void_param) 3)) 48)) (= (to_rep (select (temp___String_Literal_1789 us_void_param) 4)) 46)) (= (to_rep (select (temp___String_Literal_1789 us_void_param) 5)) 48)) (= (to_rep (select (temp___String_Literal_1789 us_void_param) 6)) 32)) (= (to_rep (select (temp___String_Literal_1789 us_void_param) 7)) 115)) :pattern ((temp___String_Literal_1789 us_void_param)))))
...
(define-fun dynamic_invariant6 ((temp___expr_1611 Int) (temp___is_init_1608 Bool) (temp___skip_constant_1609 Bool) (temp___do_toplevel_1610 Bool)) Bool (=> (or (= temp___is_init_1608 true) (<= 1 7)) (in_range5 temp___expr_1611)))
...
(define-fun dynamic_invariant8 ((temp___expr_356 us_t3) (temp___is_init_353 Bool) (temp___skip_constant_354 Bool) (temp___do_toplevel_355 Bool)) Bool (and (=> (not (= temp___skip_constant_354 true)) (dynamic_property3 1 2147483647 (first7 temp___expr_356) (last7 temp___expr_356))) (=> (= temp___do_toplevel_355 true) (=> (= temp___is_init_353 true) (and (let ((temp___358 (of_array2 (to_array3 temp___expr_356) (first7 temp___expr_356) (last7 temp___expr_356)))) (and (= (first5 temp___358) 1) (<= 0 (last5 temp___358)))) (<= (last7 temp___expr_356) 1000))))))
(define-fun dynamic_predicate2 ((temp___360 us_t3)) Bool (and (let ((temp___362 (of_array2 (to_array3 temp___360) (first7 temp___360) (last7 temp___360)))) (and (= (first5 temp___362) 1) (<= 0 (last5 temp___362)))) (<= (last7 temp___360) 1000)))
(declare-const str (Array Int character))
(declare-const valuestr (Array Int character))
(declare-const temp___1790 (Array Int character))
(declare-const temp___17901 t1)
...
(declare-const temp___17951 t5)
(declare-const temp___1796 (Array Int character))
(declare-const temp___17961 t4)
(declare-const temp___1797 Int)
(declare-const o6 (Array Int character))
(declare-const temp___1799 (Array Int character))
(declare-const temp___17991 t4)
...
(assert (= result str))
(assert (= str1 (temp___String_Literal_1789 Tuple0)))
(assert (and (= (mk___t1 temp___1790 temp___17901) (durationt_image value)) (and (dynamic_invariant1 (mk___t1 temp___1790 temp___17901) true false true) (= (mk___t1 temp___1790 temp___17901) (let ((temp___1075 (to_string (attr__ATTRIBUTE_IMAGE4 value)))) (mk___t1 (elts temp___1075) (mk1 (to_rep1 (first (rt temp___1075))) (to_rep1 (last (rt temp___1075))))))))))
(assert (= temp___1790 screen__writeconfigdata__secondsstring__valuestr__assume))
(assert (= (mk (to_rep1 (first2 temp___17901)) (to_rep1 (last2 temp___17901))) screen__writeconfigdata__secondsstring__valuestr__assume1))
...
(assert (and (= temp___1794 (- (to_rep1 valuestr__last) 1)) (in_range1 (- (to_rep1 valuestr__last) 1))))
(assert (=> (<= 2 temp___1794) (and (and (<= (to_rep1 valuestr__first) 2) (<= 2 (to_rep1 valuestr__last))) (and (<= (to_rep1 valuestr__first) temp___1794) (<= temp___1794 (to_rep1 valuestr__last))))))
(assert (= o5 valuestr1))
(assert (= o5 temp___1795))
(assert (= (mk5 2 temp___1794) temp___17951))
(assert (= (ite (<= (to_rep1 (first10 temp___17951)) (to_rep1 (last10 temp___17951))) (+ (- (to_rep1 (last10 temp___17951)) (to_rep1 (first10 temp___17951))) 1) 0) (ite (<= (- 6 (to_rep1 valuestr__last)) 3) (+ (- 3 (- 6 (to_rep1 valuestr__last))) 1) 0)))
(assert (= (slide temp___1795 (to_rep1 (first10 temp___17951)) (- 6 (to_rep1 valuestr__last))) temp___1796))
(assert (= (mk4 (- 6 (to_rep1 valuestr__last)) 3) temp___17961))
(assert (and (= temp___1797 (- 6 (to_rep1 valuestr__last))) (in_range1 (- 6 (to_rep1 valuestr__last)))))
(assert (<= temp___1797 3))
(assert (not (<= 1 temp___1797)))
(check-sat)
(exit)
