...
(assert (=> (and (<= 0 i2) (<= i2 k)) (and (forall ((temp___222 Int)) (=> (and (<= 0 temp___222) (<= temp___222 100)) (=> (<= i3 temp___222) (= (select a12 temp___222) (select temp___221 temp___222))))) (and (<= 0 i3) (<= i3 k)))))
...
(assert (=> (and (<= temp___228 i8) (<= i8 100)) (and (forall ((temp___227 Int)) (=> (and (<= 0 temp___227) (<= temp___227 100)) (=> (<= i9 temp___227) (= (select a18 temp___227) (select temp___226 temp___227))))) (and (<= (+ k 1) i9) (<= i9 100)))))
(assert (=> (and (<= temp___228 i8) (<= i8 100)) (and (= temp___225 (- i9 k)) (in_range1 (- i9 k)))))
(assert (=> (and (<= temp___228 i8) (<= i8 100)) (and (<= 0 temp___225) (<= temp___225 100))))
...
(assert (=> (and (<= temp___228 i8) (<= i8 100)) (and (<= 0 i9) (<= i9 100))))
(assert (=> (and (<= temp___228 i8) (<= i8 100)) (= o10 i9)))
(assert (=> (and (<= temp___228 i8) (<= i8 100)) (= o11 (store a18 o10 o9))))
...
(assert (=> (and (<= temp___228 i8) (<= i8 100)) (= i12 (mk_int__ref i10))))
(assert (=> (and (<= temp___228 i8) (<= i8 100)) (= a114 (mk_map__ref a110))))
(assert (=> (and (<= temp___228 i8) (<= i8 100)) (= i13 i11)))
(assert (=> (and (<= temp___228 i8) (<= i8 100)) (= a113 a111)))
(assert (=> (not (and (<= temp___228 i8) (<= i8 100))) (= i12 (mk_int__ref i8))))
