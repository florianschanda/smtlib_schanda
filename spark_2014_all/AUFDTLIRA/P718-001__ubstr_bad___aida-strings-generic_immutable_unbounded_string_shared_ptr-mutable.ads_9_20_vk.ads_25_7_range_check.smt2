...
(define-fun default_initial_assumption ((temp___expr_851 us_rep) (temp___skip_top_level_852 Bool)) Bool (=> (not (= temp___skip_top_level_852 true)) (= (length1 temp___expr_851) 0)))
...
(define-fun dynamic_invariant4 ((temp___expr_182 Int) (temp___is_init_178 Bool) (temp___skip_constant_179 Bool) (temp___do_toplevel_180 Bool) (temp___do_typ_inv_181 Bool)) Bool (=> (or (= temp___is_init_178 true) (<= 0 2147483647)) (in_range3 temp___expr_182)))
(define-fun default_initial_assumption1 ((temp___expr_842 us_rep) (temp___skip_top_level_843 Bool)) Bool (=> (not (= temp___skip_top_level_843 true)) (= (length1 temp___expr_842) 0)))
