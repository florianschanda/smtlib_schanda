...
(define-fun default_initial_assumption ((temp___expr_807 us_rep) (temp___skip_top_level_808 Bool)) Bool (=> (not (= temp___skip_top_level_808 true)) (= (length1 temp___expr_807) 0)))
