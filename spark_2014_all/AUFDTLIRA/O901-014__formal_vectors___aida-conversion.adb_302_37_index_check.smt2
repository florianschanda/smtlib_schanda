...
(assert (= (= o16 true) (forall ((index Int)) (=> (and (<= (to_rep1 (first (rt source))) index) (<= index (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index))) true)))))
(assert (= (length source) 10))
(assert (and (= temp___1384 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1384) (<= temp___1384 (to_rep1 (last (rt source))))))
(assert (= o12 temp___1384))
(assert (= o13 (select (elts source) o12)))
(assert (= o14 (to_rep o13)))
(assert (= o15 (ite (< o14 54) true false)))
(assert (and (= temp___1383 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1383) (<= temp___1383 (to_rep1 (last (rt source))))))
(assert (= o8 temp___1383))
(assert (= o9 (select (elts source) o8)))
(assert (= o10 (to_rep o9)))
(assert (= o11 (ite (= o10 51) true false)))
(assert (and (= temp___1382 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1382) (<= temp___1382 (to_rep1 (last (rt source))))))
(assert (= o4 temp___1382))
(assert (= o5 (select (elts source) o4)))
(assert (= o6 (to_rep o5)))
(assert (= o7 (ite (= o6 56) true false)))
(assert (and (= temp___1381 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1381) (<= temp___1381 (to_rep1 (last (rt source))))))
(assert (= o temp___1381))
(assert (= o1 (select (elts source) o)))
(assert (= o2 (to_rep o1)))
(assert (= o3 (ite (= o2 52) true false)))
(assert (and (= temp___1380 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (not (<= temp___1380 (to_rep1 (last (rt source))))))
(check-sat)
(exit)
