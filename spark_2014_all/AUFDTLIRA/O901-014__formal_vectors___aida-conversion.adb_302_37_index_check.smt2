...
(assert (= (= o28 true) (forall ((index11 Int)) (=> (and (<= (to_rep1 (first (rt source))) index11) (<= index11 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index11))) true)))))
(assert (= (length source) 10))
(assert (and (= temp___1282 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1282) (<= temp___1282 (to_rep1 (last (rt source))))))
(assert (= o24 temp___1282))
(assert (= o25 (select (elts source) o24)))
(assert (= o26 (to_rep o25)))
(assert (= o27 (ite (< o26 54) true false)))
(assert (and (= temp___1281 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1281) (<= temp___1281 (to_rep1 (last (rt source))))))
(assert (= o20 temp___1281))
(assert (= o21 (select (elts source) o20)))
(assert (= o22 (to_rep o21)))
(assert (= o23 (ite (= o22 51) true false)))
(assert (and (= temp___1280 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1280) (<= temp___1280 (to_rep1 (last (rt source))))))
(assert (= o16 temp___1280))
(assert (= o17 (select (elts source) o16)))
(assert (= o18 (to_rep o17)))
(assert (= o19 (ite (= o18 56) true false)))
(assert (and (= temp___1279 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1279) (<= temp___1279 (to_rep1 (last (rt source))))))
(assert (= o12 temp___1279))
(assert (= o13 (select (elts source) o12)))
(assert (= o14 (to_rep o13)))
(assert (= o15 (ite (= o14 52) true false)))
(assert (and (= temp___1278 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (not (<= (to_rep1 (first (rt source))) temp___1278)))
(check-sat)
(exit)
