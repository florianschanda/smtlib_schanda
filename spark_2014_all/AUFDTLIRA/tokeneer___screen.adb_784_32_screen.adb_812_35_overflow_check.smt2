...
(assert (=> (<= 2 (to_rep1 data__last1)) (and (and (<= (to_rep1 data__first1) 2) (<= 2 (to_rep1 data__last1))) (and (<= (to_rep1 data__first1) (to_rep1 data__last1)) (<= (to_rep1 data__last1) (to_rep1 data__last1))))))
(assert (= o7 data3))
(assert (= temp___1414 (mk___t4 o7 (mk4 2 (to_rep1 data__last1)))))
(assert (= (ite (<= (to_rep1 (first8 (rt4 temp___1414))) (to_rep1 (last8 (rt4 temp___1414)))) (+ (- (to_rep1 (last8 (rt4 temp___1414))) (to_rep1 (first8 (rt4 temp___1414)))) 1) 0) (ite (<= 1 (- (to_rep1 data__last1) 1)) (+ (- (- (to_rep1 data__last1) 1) 1) 1) 0)))
(assert (= temp___1415 (mk___t3 (slide (elts4 temp___1414) (to_rep1 (first8 (rt4 temp___1414))) 1) (mk3 1 (- (to_rep1 data__last1) 1)))))
(assert (not (in_range1 (- (to_rep1 data__last1) 1))))
(check-sat)
(exit)
