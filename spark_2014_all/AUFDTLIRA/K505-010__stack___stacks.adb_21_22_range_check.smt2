...
(define-fun dynamic_invariant5 ((temp___expr_143 Int) (temp___is_init_140 Bool) (temp___skip_constant_141 Bool) (temp___do_toplevel_142 Bool)) Bool (=> (or (= temp___is_init_140 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_143)))
(assert (forall ((s us_rep)) (! (=> (dynamic_invariant1 s true true true) (dynamic_invariant2 (size s) true false true)) :pattern ((size s)))))
(assert (forall ((attr__tag1 Int)) (forall ((s us_rep)) (! (=> (dynamic_invariant1 s true true true) (dynamic_invariant2 (size1 attr__tag1 s) true false true)) :pattern ((size1 attr__tag1 s))))))
(assert (forall ((s us_rep)) (! (= (size s) (size1 us_tag s)) :pattern ((size1 us_tag s)))))
(assert (forall ((s us_rep)) (! (=> (dynamic_invariant1 s true true true) (= (size s) (to_rep (rec__stacks__stack__top (us_split_fields1 s))))) :pattern ((size s)))))
...
(assert (dynamic_invariant1 (mk___rep s__split_discrs (mk___split_fields s__split_fields (mk___t s__split_fields1 s__split_fields2) s__split_fields3) s__attr__tag) true false true))
