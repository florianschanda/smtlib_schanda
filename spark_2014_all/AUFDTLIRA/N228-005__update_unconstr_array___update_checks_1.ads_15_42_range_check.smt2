...
(assert (= o3 i))
(assert (= temp___4332 (temp___422 (mk___t a (mk (to_rep a__first) (to_rep a__last))) 1 o3 0 o2 o1 o new_val)))
(assert (= (ite (<= (to_rep (first temp___4331)) (to_rep (last temp___4331))) (+ (- (to_rep (last temp___4331)) (to_rep (first temp___4331))) 1) 0) (ite (<= (to_rep a__first) (to_rep a__last)) (+ (- (to_rep a__last) (to_rep a__first)) 1) 0)))
(assert (= (mk___t temp___434 temp___4341) temp___4332))
(assert (= o4 (slide temp___434 (to_rep (first temp___4341)) (to_rep a__first))))
