...
(assert (forall ((rr Int)) (=> (and (<= 1 rr) (<= rr r2)) (= (to_rep (rec__list_allocator__cell__prev (us_split_fields1 (select data4 rr)))) (ite (= rr 1) 0 (- rr 1))))))
(assert (forall ((rr Int)) (=> (and (<= 1 rr) (<= rr r2)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data4 rr)))) (ite (= rr 3) 0 (+ rr 1))))))
(assert (forall ((rr Int)) (=> (and (<= 1 rr) (<= rr 3)) (= (to_rep1 (rec__list_allocator__cell__stat (us_split_fields1 (select data4 rr)))) 0))))
...
(assert (= r3 (+ r2 1)))
(assert (=> (< 1 r3) (= (to_rep o25) (- r3 1))))
(assert (=> (< 1 r3) (= (rec__list_allocator__cell__stat (us_split_fields1 (select data4 r3))) o26)))
(assert (=> (< 1 r3) (= o25 o27)))
(assert (=> (< 1 r3) (= (rec__list_allocator__cell__next (us_split_fields1 (select data4 r3))) o28)))
(assert (=> (< 1 r3) (= o29 o26)))
(assert (=> (< 1 r3) (= o30 o27)))
(assert (=> (< 1 r3) (= o31 o28)))
(assert (=> (< 1 r3) (= o32 (store data4 r3 (mk___rep (mk___split_fields o29 o30 o31))))))
(assert (=> (< 1 r3) (= result7 (mk_map__ref data4))))
(assert (=> (< 1 r3) (= data5 o32)))
(assert (=> (not (< 1 r3)) (= data5 data4)))
(assert (=> (< r3 3) (and (= o33 (+ r3 1)) (in_range1 (+ r3 1)))))
(assert (=> (< r3 3) (= (to_rep o34) o33)))
(assert (=> (< r3 3) (= (rec__list_allocator__cell__stat (us_split_fields1 (select data5 r3))) o35)))
(assert (=> (< r3 3) (= (rec__list_allocator__cell__prev (us_split_fields1 (select data5 r3))) o36)))
(assert (=> (< r3 3) (= o34 o37)))
(assert (=> (< r3 3) (= o38 o35)))
(assert (=> (< r3 3) (= o39 o36)))
(assert (=> (< r3 3) (= o40 o37)))
(assert (=> (< r3 3) (= o41 (store data5 r3 (mk___rep (mk___split_fields o38 o39 o40))))))
(assert (=> (< r3 3) (= result8 (mk_map__ref data5))))
(assert (=> (< r3 3) (= data6 o41)))
(assert (=> (not (< r3 3)) (= data6 data5)))
(declare-const rr Int)
(assert (<= 1 rr))
(assert (<= rr r3))
(assert (not (= (to_rep (rec__list_allocator__cell__prev (us_split_fields1 (select data6 rr)))) (ite (= rr 1) 0 (- rr 1)))))
(check-sat)
(exit)
