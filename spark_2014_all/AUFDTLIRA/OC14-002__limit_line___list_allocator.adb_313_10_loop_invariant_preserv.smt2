...
(assert (not (= r3 3)))
(assert (= result6 (mk_int__ref r3)))
(assert (= r4 (+ r3 1)))
(assert (=> (< 1 r4) (= (to_rep o29) (- r4 1))))
(assert (=> (< 1 r4) (= (rec__list_allocator__cell__stat (us_split_fields1 (select data4 r4))) o30)))
(assert (=> (< 1 r4) (= o29 o31)))
(assert (=> (< 1 r4) (= (rec__list_allocator__cell__next (us_split_fields1 (select data4 r4))) o32)))
(assert (=> (< 1 r4) (= o33 o30)))
(assert (=> (< 1 r4) (= o34 o31)))
(assert (=> (< 1 r4) (= o35 o32)))
(assert (=> (< 1 r4) (= o36 (store data4 r4 (mk___rep (mk___split_fields o33 o34 o35))))))
(assert (=> (< 1 r4) (= result7 (mk_map__ref data4))))
(assert (=> (< 1 r4) (= data5 o36)))
(assert (=> (not (< 1 r4)) (= data5 data4)))
(assert (=> (< r4 3) (and (= o37 (+ r4 1)) (in_range2 (+ r4 1)))))
(assert (=> (< r4 3) (= (to_rep o38) o37)))
(assert (=> (< r4 3) (= (rec__list_allocator__cell__stat (us_split_fields1 (select data5 r4))) o39)))
(assert (=> (< r4 3) (= (rec__list_allocator__cell__prev (us_split_fields1 (select data5 r4))) o40)))
(assert (=> (< r4 3) (= o38 o41)))
(assert (=> (< r4 3) (= o42 o39)))
(assert (=> (< r4 3) (= o43 o40)))
(assert (=> (< r4 3) (= o44 o41)))
(assert (=> (< r4 3) (= o45 (store data5 r4 (mk___rep (mk___split_fields o42 o43 o44))))))
(assert (=> (< r4 3) (= result8 (mk_map__ref data5))))
(assert (=> (< r4 3) (= data6 o45)))
(assert (=> (not (< r4 3)) (= data6 data5)))
(declare-const rr3 Int)
(assert (<= 1 rr3))
(assert (<= rr3 r4))
(assert (not (= (to_rep (rec__list_allocator__cell__prev (us_split_fields1 (select data6 rr3)))) (ite (= rr3 1) 0 (- rr3 1)))))
(check-sat)
(exit)
