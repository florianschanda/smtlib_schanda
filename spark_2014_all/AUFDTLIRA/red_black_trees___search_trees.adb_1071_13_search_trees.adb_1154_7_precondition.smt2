...
(assert (and (= o36 (to_rep1 (rec__search_trees__search_tree__root t__split_fields9))) (in_range3 (to_rep1 (rec__search_trees__search_tree__root t__split_fields9)))))
(assert (not (= (valid_root (rec__search_trees__search_tree__struct t__split_fields9) o36) true)))
(check-sat)
(exit)
