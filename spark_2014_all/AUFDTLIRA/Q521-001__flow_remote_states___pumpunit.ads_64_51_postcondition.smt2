...
(assert (not (= (get_outstanding outstanding3) (+ (get_outstanding outstanding) (get_cur_price (mk___split_fields cur_pump__split_fields12 cur_pump__split_fields13 cur_pump__split_fields14 cur_pump__split_fields15))))))
(check-sat)
(exit)
