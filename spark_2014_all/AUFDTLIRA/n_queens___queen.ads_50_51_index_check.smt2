...
(assert (=> (< 1 i) (and (= o4 (consistent b o3)) (= (= o4 true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 o3)) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 (- i1 1))) (and (and (not (= (to_rep (select b i1)) (to_rep (select b j3)))) (not (= (- i1 j3) (- (to_rep (select b i1)) (to_rep (select b j3)))))) (not (= (- i1 j3) (- (to_rep (select b j3)) (to_rep (select b i1))))))))))))))
(assert (=> (not (< 1 i)) (= o4 (of_int 1))))
(assert (<= 1 j))
(assert (<= j (- i 1)))
(assert (not (<= 1 j)))
(check-sat)
