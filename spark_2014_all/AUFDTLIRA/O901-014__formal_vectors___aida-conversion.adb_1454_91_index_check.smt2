...
(assert (and (= o46 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (= o47 (ite (<= o46 i) true false)))
(assert (= result5 (ite (= o47 true) (ite (<= i index3) true false) false)))
(assert (= result5 true))
