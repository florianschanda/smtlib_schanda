...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_152 us_void_param) 1)) 69) (= (to_rep (select (temp___String_Literal_152 us_void_param) 2)) 110)) (= (to_rep (select (temp___String_Literal_152 us_void_param) 3)) 114)) (= (to_rep (select (temp___String_Literal_152 us_void_param) 4)) 111)) (= (to_rep (select (temp___String_Literal_152 us_void_param) 5)) 108)) (= (to_rep (select (temp___String_Literal_152 us_void_param) 6)) 109)) (= (to_rep (select (temp___String_Literal_152 us_void_param) 7)) 101)) (= (to_rep (select (temp___String_Literal_152 us_void_param) 8)) 110)) (= (to_rep (select (temp___String_Literal_152 us_void_param) 9)) 116)) (= (to_rep (select (temp___String_Literal_152 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_152 us_void_param) 11)) 102)) (= (to_rep (select (temp___String_Literal_152 us_void_param) 12)) 97)) (= (to_rep (select (temp___String_Literal_152 us_void_param) 13)) 105)) (= (to_rep (select (temp___String_Literal_152 us_void_param) 14)) 108)) (= (to_rep (select (temp___String_Literal_152 us_void_param) 15)) 101)) (= (to_rep (select (temp___String_Literal_152 us_void_param) 16)) 100)) (= (to_rep (select (temp___String_Literal_152 us_void_param) 17)) 32)) (= (to_rep (select (temp___String_Literal_152 us_void_param) 18)) 97)) (= (to_rep (select (temp___String_Literal_152 us_void_param) 19)) 116)) (= (to_rep (select (temp___String_Literal_152 us_void_param) 20)) 32)) (= (to_rep (select (temp___String_Literal_152 us_void_param) 21)) 99)) (= (to_rep (select (temp___String_Literal_152 us_void_param) 22)) 101)) (= (to_rep (select (temp___String_Literal_152 us_void_param) 23)) 114)) (= (to_rep (select (temp___String_Literal_152 us_void_param) 24)) 116)) (= (to_rep (select (temp___String_Literal_152 us_void_param) 25)) 105)) (= (to_rep (select (temp___String_Literal_152 us_void_param) 26)) 102)) (= (to_rep (select (temp___String_Literal_152 us_void_param) 27)) 105)) (= (to_rep (select (temp___String_Literal_152 us_void_param) 28)) 99)) (= (to_rep (select (temp___String_Literal_152 us_void_param) 29)) 97)) (= (to_rep (select (temp___String_Literal_152 us_void_param) 30)) 116)) (= (to_rep (select (temp___String_Literal_152 us_void_param) 31)) 101)) :pattern ((temp___String_Literal_152 us_void_param)))))
(declare-fun temp___String_Literal_155 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (= (to_rep (select (temp___String_Literal_155 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_155 us_void_param) 2)) 45)) (= (to_rep (select (temp___String_Literal_155 us_void_param) 3)) 32)) :pattern ((temp___String_Literal_155 us_void_param)))))
...
(define-fun dynamic_invariant4 ((temp___expr_180 Int) (temp___is_init_177 Bool) (temp___skip_constant_178 Bool) (temp___do_toplevel_179 Bool)) Bool (=> (or (= temp___is_init_177 true) (<= 1 150)) (in_range3 temp___expr_180)))
...
(assert (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE1 certno))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE1 certno)))))) (= o (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE1 certno))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE1 certno)))))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE1 certno))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE1 certno))))))) (= o 0)))
...
(assert (= (concat1 (temp___String_Literal_152 Tuple0) 1 31 (elts (to_string (attr__ATTRIBUTE_IMAGE1 certno))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE1 certno))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE1 certno)))))) temp___1055))
(assert (= (mk 1 o5) temp___10551))
(assert (=> (= (length (mk___t temp___1055 temp___10551)) 0) (= (temp___String_Literal_155 Tuple0) temp___1057)))
(assert (=> (= (length (mk___t temp___1055 temp___10551)) 0) (= (mk 1 3) temp___10571)))
(assert (=> (not (= (length (mk___t temp___1055 temp___10551)) 0)) (=> (<= 1 3) (= o6 (+ (- 3 1) 1)))))
(assert (=> (not (= (length (mk___t temp___1055 temp___10551)) 0)) (=> (not (<= 1 3)) (= o6 0))))
(assert (=> (not (= (length (mk___t temp___1055 temp___10551)) 0)) (=> (<= (to_rep1 (first temp___10551)) (to_rep1 (last temp___10551))) (= o7 (+ (- (to_rep1 (last temp___10551)) (to_rep1 (first temp___10551))) 1)))))
(assert (=> (not (= (length (mk___t temp___1055 temp___10551)) 0)) (=> (not (<= (to_rep1 (first temp___10551)) (to_rep1 (last temp___10551)))) (= o7 0))))
(assert (=> (not (= (length (mk___t temp___1055 temp___10551)) 0)) (= o8 (+ o7 o6))))
(assert (=> (not (= (length (mk___t temp___1055 temp___10551)) 0)) (= o9 (+ (to_rep1 (first temp___10551)) o8))))
(assert (=> (not (= (length (mk___t temp___1055 temp___10551)) 0)) (= o10 (- o9 1))))
(assert (=> (not (= (length (mk___t temp___1055 temp___10551)) 0)) (and (= o11 o10) (in_range1 o10))))
(assert (=> (not (= (length (mk___t temp___1055 temp___10551)) 0)) (= (concat1 temp___1055 (to_rep1 (first temp___10551)) (to_rep1 (last temp___10551)) (temp___String_Literal_155 Tuple0) 1 3) temp___1057)))
(assert (=> (not (= (length (mk___t temp___1055 temp___10551)) 0)) (= (mk (to_rep1 (first temp___10551)) o11) temp___10571)))
(assert (not (= (length (mk___t temp___1057 temp___10571)) 0)))
(assert (=> (<= (to_rep1 (first (rt detail))) (to_rep1 (last (rt detail)))) (= o12 (+ (- (to_rep1 (last (rt detail))) (to_rep1 (first (rt detail)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt detail))) (to_rep1 (last (rt detail))))) (= o12 0)))
(assert (=> (<= (to_rep1 (first temp___10571)) (to_rep1 (last temp___10571))) (= o13 (+ (- (to_rep1 (last temp___10571)) (to_rep1 (first temp___10571))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___10571)) (to_rep1 (last temp___10571)))) (= o13 0)))
(assert (= o14 (+ o13 o12)))
