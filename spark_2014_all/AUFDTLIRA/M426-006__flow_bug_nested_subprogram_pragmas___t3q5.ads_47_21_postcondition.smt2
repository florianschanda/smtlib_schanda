...
(declare-const temp___201 (Array Int contents_type))
(declare-const temp___205 (Array Int contents_type))
(declare-const o Int)
...
(assert (= low1 1))
(assert (=> (and (<= 1 low1) (<= low1 99)) (= temp___203 low1)))
(assert (=> (and (<= 1 low1) (<= low1 99)) (= temp___202 key)))
(assert (=> (and (<= 1 low1) (<= low1 99)) (= temp___201 table)))
(assert (=> (and (<= 1 low1) (<= low1 99)) (= temp___205 table)))
...
(assert (=> (and (<= 1 low1) (<= low1 99)) (and (and (forall ((x Int)) (=> (and (<= 1 x) (<= x low2)) (<= (to_rep (select table3 x)) (to_rep (select table3 (+ x 1)))))) (forall ((x Int)) (=> (and (<= low2 x) (<= x 100)) (<= (to_rep (select table3 low2)) (to_rep (select table3 x)))))) (= (perm table3 temp___205) true))))
