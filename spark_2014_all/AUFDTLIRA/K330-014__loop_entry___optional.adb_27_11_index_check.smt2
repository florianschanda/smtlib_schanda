...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_614 us_void_param) 1)) 79) (= (to_rep (select (temp___String_Literal_614 us_void_param) 2)) 112)) (= (to_rep (select (temp___String_Literal_614 us_void_param) 3)) 116)) (= (to_rep (select (temp___String_Literal_614 us_void_param) 4)) 105)) (= (to_rep (select (temp___String_Literal_614 us_void_param) 5)) 111)) (= (to_rep (select (temp___String_Literal_614 us_void_param) 6)) 110)) (= (to_rep (select (temp___String_Literal_614 us_void_param) 7)) 97)) (= (to_rep (select (temp___String_Literal_614 us_void_param) 8)) 108)) :pattern ((temp___String_Literal_614 us_void_param)))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_631 us_void_param) 1)) 69) (= (to_rep (select (temp___String_Literal_631 us_void_param) 2)) 82)) (= (to_rep (select (temp___String_Literal_631 us_void_param) 3)) 82)) (= (to_rep (select (temp___String_Literal_631 us_void_param) 4)) 79)) (= (to_rep (select (temp___String_Literal_631 us_void_param) 5)) 82)) (= (to_rep (select (temp___String_Literal_631 us_void_param) 6)) 32)) (= (to_rep (select (temp___String_Literal_631 us_void_param) 7)) 50)) (= (to_rep (select (temp___String_Literal_631 us_void_param) 8)) 58)) (= (to_rep (select (temp___String_Literal_631 us_void_param) 9)) 32)) (= (to_rep (select (temp___String_Literal_631 us_void_param) 10)) 115)) (= (to_rep (select (temp___String_Literal_631 us_void_param) 11)) 104)) (= (to_rep (select (temp___String_Literal_631 us_void_param) 12)) 111)) (= (to_rep (select (temp___String_Literal_631 us_void_param) 13)) 117)) (= (to_rep (select (temp___String_Literal_631 us_void_param) 14)) 108)) (= (to_rep (select (temp___String_Literal_631 us_void_param) 15)) 100)) (= (to_rep (select (temp___String_Literal_631 us_void_param) 16)) 32)) (= (to_rep (select (temp___String_Literal_631 us_void_param) 17)) 110)) (= (to_rep (select (temp___String_Literal_631 us_void_param) 18)) 111)) (= (to_rep (select (temp___String_Literal_631 us_void_param) 19)) 116)) (= (to_rep (select (temp___String_Literal_631 us_void_param) 20)) 32)) (= (to_rep (select (temp___String_Literal_631 us_void_param) 21)) 103)) (= (to_rep (select (temp___String_Literal_631 us_void_param) 22)) 101)) (= (to_rep (select (temp___String_Literal_631 us_void_param) 23)) 116)) (= (to_rep (select (temp___String_Literal_631 us_void_param) 24)) 32)) (= (to_rep (select (temp___String_Literal_631 us_void_param) 25)) 104)) (= (to_rep (select (temp___String_Literal_631 us_void_param) 26)) 101)) (= (to_rep (select (temp___String_Literal_631 us_void_param) 27)) 114)) (= (to_rep (select (temp___String_Literal_631 us_void_param) 28)) 101)) :pattern ((temp___String_Literal_631 us_void_param)))))
...
(assert (forall ((temp___622 Int)) (=> (dynamic_invariant temp___622 true true true true) (forall ((temp___623 Int)) (= (to_rep2 (select (optional__B_1__ta__aggregate_def temp___622) temp___623)) temp___622)))))
(assert (forall ((temp___633 Int)) (=> (dynamic_invariant temp___633 true true true true) (forall ((temp___634 Int) (temp___635 Int)) (= (to_rep2 (get (optional__B_3__ta__aggregate_def temp___633) temp___634 temp___635)) temp___633)))))
(declare-const ta (Array Int natural))
(declare-const index Int)
(declare-const ta1 map1)
(declare-const temp___617 Int)
(declare-const temp___615 (Array Int natural))
(declare-const temp___618 (Array Int natural))
...
(assert (= index1 1))
(assert (=> (and (<= 1 index1) (<= index1 5)) (= temp___617 index1)))
(assert (=> (and (<= 1 index1) (<= index1 5)) (= temp___615 ta2)))
(assert (=> (and (<= 1 index1) (<= index1 5)) (= temp___618 ta2)))
(assert (=> (and (<= 1 index1) (<= index1 5)) (= (to_rep2 (select temp___618 index2)) 0)))
(assert (=> (and (<= 1 index1) (<= index1 5)) (and (and (forall ((temp___616 Int)) (=> (and (<= 1 temp___616) (<= temp___616 5)) (=> (<= index2 temp___616) (= (select ta3 temp___616) (select temp___615 temp___616))))) (=> (<= 1 5) (in_range6 index2))) (and (<= 1 index2) (<= index2 5)))))
...
(assert (= (to_rep2 o2) 1))
(assert (and (= temp___624 (sum_of 2)) (in_range4 temp___624)))
(assert (not (<= 1 temp___624)))
(check-sat)
(exit)
