...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_546 us_void_param) 1)) 79) (= (to_rep (select (temp___String_Literal_546 us_void_param) 2)) 112)) (= (to_rep (select (temp___String_Literal_546 us_void_param) 3)) 116)) (= (to_rep (select (temp___String_Literal_546 us_void_param) 4)) 105)) (= (to_rep (select (temp___String_Literal_546 us_void_param) 5)) 111)) (= (to_rep (select (temp___String_Literal_546 us_void_param) 6)) 110)) (= (to_rep (select (temp___String_Literal_546 us_void_param) 7)) 97)) (= (to_rep (select (temp___String_Literal_546 us_void_param) 8)) 108)) :pattern ((temp___String_Literal_546 us_void_param)))))
(declare-fun optional__B_1__ta__aggregate_def (Int) (Array Int natural))
(assert (forall ((temp___554 Int)) (forall ((temp___555 Int)) (= (select (optional__B_1__ta__aggregate_def temp___554) temp___555) (of_rep2 temp___554)))))
(declare-fun temp___String_Literal_563 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_563 us_void_param) 1)) 69) (= (to_rep (select (temp___String_Literal_563 us_void_param) 2)) 82)) (= (to_rep (select (temp___String_Literal_563 us_void_param) 3)) 82)) (= (to_rep (select (temp___String_Literal_563 us_void_param) 4)) 79)) (= (to_rep (select (temp___String_Literal_563 us_void_param) 5)) 82)) (= (to_rep (select (temp___String_Literal_563 us_void_param) 6)) 32)) (= (to_rep (select (temp___String_Literal_563 us_void_param) 7)) 50)) (= (to_rep (select (temp___String_Literal_563 us_void_param) 8)) 58)) (= (to_rep (select (temp___String_Literal_563 us_void_param) 9)) 32)) (= (to_rep (select (temp___String_Literal_563 us_void_param) 10)) 115)) (= (to_rep (select (temp___String_Literal_563 us_void_param) 11)) 104)) (= (to_rep (select (temp___String_Literal_563 us_void_param) 12)) 111)) (= (to_rep (select (temp___String_Literal_563 us_void_param) 13)) 117)) (= (to_rep (select (temp___String_Literal_563 us_void_param) 14)) 108)) (= (to_rep (select (temp___String_Literal_563 us_void_param) 15)) 100)) (= (to_rep (select (temp___String_Literal_563 us_void_param) 16)) 32)) (= (to_rep (select (temp___String_Literal_563 us_void_param) 17)) 110)) (= (to_rep (select (temp___String_Literal_563 us_void_param) 18)) 111)) (= (to_rep (select (temp___String_Literal_563 us_void_param) 19)) 116)) (= (to_rep (select (temp___String_Literal_563 us_void_param) 20)) 32)) (= (to_rep (select (temp___String_Literal_563 us_void_param) 21)) 103)) (= (to_rep (select (temp___String_Literal_563 us_void_param) 22)) 101)) (= (to_rep (select (temp___String_Literal_563 us_void_param) 23)) 116)) (= (to_rep (select (temp___String_Literal_563 us_void_param) 24)) 32)) (= (to_rep (select (temp___String_Literal_563 us_void_param) 25)) 104)) (= (to_rep (select (temp___String_Literal_563 us_void_param) 26)) 101)) (= (to_rep (select (temp___String_Literal_563 us_void_param) 27)) 114)) (= (to_rep (select (temp___String_Literal_563 us_void_param) 28)) 101)) :pattern ((temp___String_Literal_563 us_void_param)))))
(declare-fun optional__B_3__ta__aggregate_def (Int) map1)
(assert (forall ((temp___565 Int)) (forall ((temp___566 Int) (temp___567 Int)) (= (get (optional__B_3__ta__aggregate_def temp___565) temp___566 temp___567) (of_rep2 temp___565)))))
...
(declare-const temp___550 (Array Int natural))
...
(assert (=> (and (<= 1 index1) (<= index1 5)) (= (to_rep2 (select temp___550 index2)) 0)))
(assert (=> (and (<= 1 index1) (<= index1 5)) (and (and (forall ((temp___548 Int)) (=> (and (<= 1 temp___548) (<= temp___548 5)) (=> (<= index2 temp___548) (= (select ta3 temp___548) (select temp___547 temp___548))))) (=> (<= 1 5) (in_range6 index2))) (and (<= 1 index2) (<= index2 5)))))
(assert (=> (and (<= 1 index1) (<= index1 5)) (= (to_rep2 o) 1)))
(assert (=> (and (<= 1 index1) (<= index1 5)) (= o1 (store ta3 index2 o))))
(assert (=> (and (<= 1 index1) (<= index1 5)) (= ta3 result2)))
(assert (=> (and (<= 1 index1) (<= index1 5)) (= ta4 o1)))
...
(assert (= (to_rep2 o2) 1))
(assert (and (= temp___556 (sum_of 2)) (in_range4 temp___556)))
(assert (not (<= 1 temp___556)))
(check-sat)
(exit)
