...
(define-fun bool_eq2 ((a (Array Int natural)) (a__first Int) (a__last Int) (b (Array Int natural)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_142 Int)) (=> (and (<= a__first temp___idx_142) (<= temp___idx_142 a__last)) (= (to_rep2 (select a temp___idx_142)) (to_rep2 (select b (+ (- b__first a__first) temp___idx_142))))))) true false))
(assert (forall ((a (Array Int natural)) (b (Array Int natural))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq2 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_142 Int)) (=> (and (<= a__first temp___idx_142) (<= temp___idx_142 a__last)) (= (to_rep2 (select a temp___idx_142)) (to_rep2 (select b (+ (- b__first a__first) temp___idx_142)))))))))))
(declare-fun compare1 ((Array Int natural) Int Int (Array Int natural) Int Int) Int)
(assert (forall ((a (Array Int natural)) (b (Array Int natural))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare1 a a_first a_last b b_first b_last) 0) (= (bool_eq2 a a_first a_last b b_first b_last) true)) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int natural)) (b (Array Int natural))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare1 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq2 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep2 (select a (+ i 1))) (to_rep2 (select b (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int natural)) (b (Array Int natural))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare1 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq2 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep2 (select b (+ i 1))) (to_rep2 (select a (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_540 us_void_param) 1)) 79) (= (to_rep (select (temp___String_Literal_540 us_void_param) 2)) 112)) (= (to_rep (select (temp___String_Literal_540 us_void_param) 3)) 116)) (= (to_rep (select (temp___String_Literal_540 us_void_param) 4)) 105)) (= (to_rep (select (temp___String_Literal_540 us_void_param) 5)) 111)) (= (to_rep (select (temp___String_Literal_540 us_void_param) 6)) 110)) (= (to_rep (select (temp___String_Literal_540 us_void_param) 7)) 97)) (= (to_rep (select (temp___String_Literal_540 us_void_param) 8)) 108)) :pattern ((temp___String_Literal_540 us_void_param)))))
(declare-fun optional__B_1__ta__aggregate_def (Int) (Array Int natural))
(assert (forall ((temp___548 Int)) (forall ((temp___549 Int)) (= (select (optional__B_1__ta__aggregate_def temp___548) temp___549) (of_rep2 temp___548)))))
(declare-fun temp___String_Literal_557 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_557 us_void_param) 1)) 69) (= (to_rep (select (temp___String_Literal_557 us_void_param) 2)) 82)) (= (to_rep (select (temp___String_Literal_557 us_void_param) 3)) 82)) (= (to_rep (select (temp___String_Literal_557 us_void_param) 4)) 79)) (= (to_rep (select (temp___String_Literal_557 us_void_param) 5)) 82)) (= (to_rep (select (temp___String_Literal_557 us_void_param) 6)) 32)) (= (to_rep (select (temp___String_Literal_557 us_void_param) 7)) 50)) (= (to_rep (select (temp___String_Literal_557 us_void_param) 8)) 58)) (= (to_rep (select (temp___String_Literal_557 us_void_param) 9)) 32)) (= (to_rep (select (temp___String_Literal_557 us_void_param) 10)) 115)) (= (to_rep (select (temp___String_Literal_557 us_void_param) 11)) 104)) (= (to_rep (select (temp___String_Literal_557 us_void_param) 12)) 111)) (= (to_rep (select (temp___String_Literal_557 us_void_param) 13)) 117)) (= (to_rep (select (temp___String_Literal_557 us_void_param) 14)) 108)) (= (to_rep (select (temp___String_Literal_557 us_void_param) 15)) 100)) (= (to_rep (select (temp___String_Literal_557 us_void_param) 16)) 32)) (= (to_rep (select (temp___String_Literal_557 us_void_param) 17)) 110)) (= (to_rep (select (temp___String_Literal_557 us_void_param) 18)) 111)) (= (to_rep (select (temp___String_Literal_557 us_void_param) 19)) 116)) (= (to_rep (select (temp___String_Literal_557 us_void_param) 20)) 32)) (= (to_rep (select (temp___String_Literal_557 us_void_param) 21)) 103)) (= (to_rep (select (temp___String_Literal_557 us_void_param) 22)) 101)) (= (to_rep (select (temp___String_Literal_557 us_void_param) 23)) 116)) (= (to_rep (select (temp___String_Literal_557 us_void_param) 24)) 32)) (= (to_rep (select (temp___String_Literal_557 us_void_param) 25)) 104)) (= (to_rep (select (temp___String_Literal_557 us_void_param) 26)) 101)) (= (to_rep (select (temp___String_Literal_557 us_void_param) 27)) 114)) (= (to_rep (select (temp___String_Literal_557 us_void_param) 28)) 101)) :pattern ((temp___String_Literal_557 us_void_param)))))
(declare-fun optional__B_3__ta__aggregate_def (Int) map1)
(assert (forall ((temp___559 Int)) (forall ((temp___560 Int) (temp___561 Int)) (= (get (optional__B_3__ta__aggregate_def temp___559) temp___560 temp___561) (of_rep2 temp___559)))))
...
(declare-const outer Int)
(declare-const inner Int)
(declare-const temp___543 Int)
(declare-const temp___541 (Array Int natural))
(declare-const temp___544 (Array Int natural))
...
(declare-const temp___552 map1)
(declare-const temp___551 Int)
(declare-const temp___5521 map1)
(declare-const temp___5511 Int)
...
(declare-const ta9 (Array Int natural))
(declare-const index8 Int)
(declare-const ta10 (Array Int natural))
(declare-const index9 Int)
(declare-const result4 map1)
(declare-const ta11 map1)
(declare-const result5 map1)
(declare-const ta12 map1)
(declare-const result6 Int)
(declare-const outer1 Int)
(declare-const result7 Int)
(declare-const inner1 Int)
(declare-const inner2 Int)
(declare-const result8 Int)
(declare-const inner3 Int)
(declare-const inner4 Int)
(declare-const inner5 Int)
(declare-const inner6 int__ref)
(declare-const inner7 Int)
(declare-const inner8 int__ref)
(declare-const inner9 Int)
(declare-const inner10 int__ref)
(declare-const inner11 Int)
(declare-const result9 int__ref)
(declare-const outer2 Int)
(declare-const result10 int__ref)
(declare-const inner12 Int)
(declare-const inner13 Int)
(declare-const result11 int__ref)
(declare-const inner14 Int)
(declare-const inner15 int__ref)
(declare-const inner16 Int)
(declare-const inner17 int__ref)
(declare-const inner18 Int)
(declare-const inner19 int__ref)
(declare-const inner20 Int)
(declare-const inner21 int__ref)
(declare-const inner22 Int)
(declare-const result12 int__ref)
(declare-const outer3 Int)
(declare-const result13 int__ref)
(declare-const inner23 Int)
(declare-const inner24 Int)
(declare-const result14 int__ref)
(declare-const inner25 Int)
(declare-const inner26 int__ref)
(declare-const inner27 Int)
...
(assert (= index1 1))
(assert (=> (and (<= 1 index1) (<= index1 5)) (and (and (= temp___543 index1) (and (= temp___541 ta2) (and (= temp___544 ta2) (and (= (to_rep2 (select temp___544 index2)) 0) (and (and (and (forall ((temp___542 Int)) (=> (and (<= 1 temp___542) (<= temp___542 5)) (=> (<= index2 temp___542) (= (select ta3 temp___542) (select temp___541 temp___542))))) (=> (<= 1 5) (in_range6 index2))) (and (<= 1 index2) (<= index2 5))) (and (and (and (= (to_rep2 o) 1) (= o1 (store ta3 index2 o))) (and (= ta3 result2) (= ta4 o1))) (= index2 5))))))) (and (and (= index2 index6) (= ta4 ta7)) (and (= index7 index2) (= ta8 ta4))))))
(assert (=> (and (<= 1 index1) (<= index1 5)) (= (mk_int__ref index8) (mk_int__ref index6))))
(assert (=> (and (<= 1 index1) (<= index1 5)) (= (mk_map__ref1 ta9) (mk_map__ref1 ta7))))
(assert (=> (and (<= 1 index1) (<= index1 5)) (= index9 index7)))
(assert (=> (and (<= 1 index1) (<= index1 5)) (= ta10 ta8)))
(assert (=> (not (and (<= 1 index1) (<= index1 5))) (= index1 index8)))
(assert (=> (not (and (<= 1 index1) (<= index1 5))) (= ta2 ta9)))
(assert (=> (not (and (<= 1 index1) (<= index1 5))) (= index9 index1)))
(assert (=> (not (and (<= 1 index1) (<= index1 5))) (= ta10 ta2)))
(assert (= result4 ta1))
(assert (= ta11 (optional__B_3__ta__aggregate_def 0)))
(assert (= (to_rep2 o2) 1))
(assert (and (= temp___550 (sum_of 2)) (in_range4 temp___550)))
(assert (not (<= 1 temp___550)))
(check-sat)
(exit)
