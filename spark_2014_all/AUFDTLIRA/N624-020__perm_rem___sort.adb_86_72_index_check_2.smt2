...
(assert (and (= temp___268 (remove (mk___t values2 (mk 1 100)) o47)) (and (dynamic_invariant3 temp___268 true false true true) (and (= (invariant__ temp___268) true) (and (= (to_rep1 (last (rt temp___268))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o47 1))) (= (to_rep (select values2 k)) (to_rep (select (elts temp___268) k))))) (and (forall ((k Int)) (=> (and (<= (+ o47 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select (elts temp___268) (- k 1)))))) (forall ((k Int)) (=> (and (<= o47 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts temp___268) k))))))))))))
(assert (not (<= x (to_rep1 (last (rt temp___268))))))
(check-sat)
(exit)
