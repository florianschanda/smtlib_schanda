...
(assert (= (= o28 true) (forall ((index Int)) (=> (and (<= (to_rep1 (first (rt source))) index) (<= index (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index))) true)))))
...
(assert (= o24 temp___1342))
(assert (= o25 (select (elts source) o24)))
(assert (= o26 (to_rep o25)))
(assert (= o27 (ite (< o26 52) true false)))
...
(assert (and (<= (to_rep1 (first (rt source))) temp___1338) (<= temp___1338 (to_rep1 (last (rt source))))))
(assert (= o8 temp___1338))
(assert (= o9 (select (elts source) o8)))
(assert (= o10 (to_rep o9)))
(assert (= o11 (ite (= o10 52) true false)))
(assert (and (= temp___1337 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1337) (<= temp___1337 (to_rep1 (last (rt source))))))
(assert (= o4 temp___1337))
(assert (= o5 (select (elts source) o4)))
(assert (= o6 (to_rep o5)))
(assert (= o7 (ite (= o6 55) true false)))
(assert (and (= temp___1336 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1336) (<= temp___1336 (to_rep1 (last (rt source))))))
(assert (= o temp___1336))
(assert (= o1 (select (elts source) o)))
(assert (= o2 (to_rep o1)))
(assert (= o3 (ite (= o2 52) true false)))
(assert (and (= temp___1335 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (not (<= (to_rep1 (first (rt source))) temp___1335)))
(check-sat)
(exit)
