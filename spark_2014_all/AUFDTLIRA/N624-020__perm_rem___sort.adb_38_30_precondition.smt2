...
(define-fun o18 () us_t (mk___t o15 o16))
(assert (in_range3 x))
(assert (in_range3 y))
...
(assert (and (= o17 (- x 1)) (in_range5 (- x 1))))
(assert (and (= o14 y) (in_range5 y)))
(assert (and (= o18 (remove (mk___t values2 (mk 1 100)) o14)) (and (dynamic_invariant4 o18 true false true true) (and (= (invariant__ o18) true) (and (= (to_rep1 (last o16)) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o14 1))) (= (to_rep (select values2 k)) (to_rep (select o15 k))))) (and (forall ((k Int)) (=> (and (<= (+ o14 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select o15 (- k 1)))))) (forall ((k Int)) (=> (and (<= o14 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select o15 k))))))))))))
