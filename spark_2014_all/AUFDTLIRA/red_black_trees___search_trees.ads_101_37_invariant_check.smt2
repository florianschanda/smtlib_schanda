...
(assert (=> (not (= (int__content i14) 0)) (= result22 (rec__tree_model__path_type__k o36))))
...
(assert (=> (= result22 true) (and (= o32 (root (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)))) (and (in_range3 o32) (= o32 (to_rep1 t__split_fields))))))
(assert (=> (= result22 true) (type_invariant1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))))
(assert (=> (= result22 true) (and (= o33 (root (mk___rep3 (us_split_fields__content3 t__split_fields14)))) (and (in_range3 o33) (= o33 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields__content3 t__split_fields14))))))))
(assert (=> (= result22 true) (= result21 (ite (= o33 o32) true false))))
...
(assert (=> (= result21 true) (and (= o31 (size1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))) (and (in_range4 o31) (= o31 (size (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14))))))))
(assert (=> (= result21 true) (= result20 (ite (= o31 (+ (size1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3))) 1)) true false))))
