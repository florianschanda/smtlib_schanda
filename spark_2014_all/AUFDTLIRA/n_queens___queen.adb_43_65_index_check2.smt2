...
(assert (=> (< (to_rep (select c i)) r2) (and (= o (consistent c 8)) (= (= o true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 8)) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- i1 1))) (and (and (not (= (to_rep (select c i1)) (to_rep (select c j1)))) (not (= (- i1 j1) (- (to_rep (select c i1)) (to_rep (select c j1)))))) (not (= (- i1 j1) (- (to_rep (select c j1)) (to_rep (select c i1))))))))))))))
(assert (=> (< (to_rep (select c i)) r2) (= o1 (ite (not (= o true)) true false))))
(assert (=> (not (< (to_rep (select c i)) r2)) (= o1 (distinct 1 0))))
(assert (<= 1 j))
(assert (<= j (- i 1)))
(assert (not (<= 1 j)))
(check-sat)
