...
(declare-const y (Array Int Bool))
(declare-const x1 (Array Int Bool))
(declare-const y1 (Array Int Bool))
...
(assert (= branch 103))
(assert (= result4 x2))
(assert (= x7 (do_checks__do_length_check__B_22__x__aggregate_def (of_int 0))))
