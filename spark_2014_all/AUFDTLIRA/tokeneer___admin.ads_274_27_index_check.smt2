...
(define-fun dynamic_invariant ((temp___expr_427 Int) (temp___is_init_424 Bool) (temp___skip_constant_425 Bool) (temp___do_toplevel_426 Bool)) Bool (=> (or (= temp___is_init_424 true) (<= 1 4)) (in_range3 temp___expr_427)))
...
(define-fun dynamic_invariant1 ((temp___expr_421 Int) (temp___is_init_418 Bool) (temp___skip_constant_419 Bool) (temp___do_toplevel_420 Bool)) Bool (=> (or (= temp___is_init_418 true) (<= 0 4)) (in_range4 temp___expr_421)))
...
(define-fun dynamic_invariant3 ((temp___expr_365 Int) (temp___is_init_362 Bool) (temp___skip_constant_363 Bool) (temp___do_toplevel_364 Bool)) Bool (=> (or (= temp___is_init_362 true) (<= 1 3)) (in_range2 temp___expr_365)))
