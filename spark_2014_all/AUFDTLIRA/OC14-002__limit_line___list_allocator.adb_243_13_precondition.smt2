...
(assert (and (= o67 (length (rec__list_allocator__m__t__allocated model____split_fields4))) (in_range6 o67)))
(assert (= o68 (ite (<= j2 o67) true false)))
(assert (= result14 (ite (<= 1 j2) o68 false)))
