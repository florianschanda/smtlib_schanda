...
(assert (forall ((temp___179 Int) (temp___180 Int)) (let ((temp___178 (array_logical_ops__failing_length_check__y__aggregate_def temp___179 temp___180))) (forall ((temp___181 Int)) (ite (and (<= 11 temp___181) (<= temp___181 20)) (= (select temp___178 temp___181) (of_rep temp___180)) (=> (and (<= 1 temp___181) (<= temp___181 10)) (= (select temp___178 temp___181) (of_rep temp___179))))))))
