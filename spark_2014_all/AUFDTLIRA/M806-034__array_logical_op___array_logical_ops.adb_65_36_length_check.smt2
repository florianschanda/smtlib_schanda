...
(declare-fun array_logical_ops__failing_length_check__y__aggregate_def (Int Int) (Array Int my_boolean))
...
(assert (= y (of_array (array_logical_ops__failing_length_check__y__aggregate_def 0 1) 1 20)))
...
(assert (forall ((temp___201 Int) (temp___202 Int)) (let ((temp___200 (array_logical_ops__failing_length_check__y__aggregate_def temp___201 temp___202))) (=> (and (dynamic_invariant2 temp___201 true true true true) (dynamic_invariant2 temp___202 true true true true)) (forall ((temp___203 Int)) (ite (and (<= 11 temp___203) (<= temp___203 20)) (= (to_rep (select temp___200 temp___203)) temp___202) (=> (and (<= 1 temp___203) (<= temp___203 10)) (= (to_rep (select temp___200 temp___203)) temp___201))))))))
(assert (= r (of_array (andb (to_array y) (first1 y) (last1 y) (to_array z) (first1 z) (last1 z)) (first1 y) (last1 y))))
(assert (dynamic_invariant z true false true true))
(assert (= (mk___t (array_logical_ops__failing_length_check__y__aggregate_def 0 1) (mk 1 20)) y))
(assert (dynamic_invariant y true false true true))
(assert (not (= (ite (<= (to_rep1 (first (rt y))) (to_rep1 (last (rt y)))) (+ (- (to_rep1 (last (rt y))) (to_rep1 (first (rt y)))) 1) 0) (ite (<= (to_rep1 (first (rt z))) (to_rep1 (last (rt z)))) (+ (- (to_rep1 (last (rt z))) (to_rep1 (first (rt z)))) 1) 0))))
(check-sat)
(exit)
