...
(assert (and (= o9 (length alloc3)) (in_range2 o9)))
(assert (and (= o10 (length avail3)) (in_range2 o10)))
(assert (= o11 (+ o10 o9)))
(assert (and (= o12 o11) (in_range5 o11)))
(assert (= result5 (ite (= o12 r2) true false)))
(assert (=> (= result5 true) (and (= o7 (contains avail3 e1)) (=> (= (distinct 1 0) true) (=> (exists ((e2 Int)) (and (and (in_range1 e2) (= (contains avail3 e2) true)) (= e2 e1))) (= o7 true))))))
(assert (=> (= result5 true) (= (= o8 true) (in_range1 e1))))
...
(assert (=> (= result4 true) (and (= o5 (contains alloc3 e)) (=> (= (distinct 1 0) true) (=> (exists ((e2 Int)) (and (and (in_range1 e2) (= (contains alloc3 e2) true)) (= e2 e))) (= o5 true))))))
