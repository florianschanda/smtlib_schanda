...
(assert (=> (= result5 true) (and (= o7 (contains avail3 e1)) (=> (= (of_int 1) true) (=> (exists ((e2 Int)) (and (and (in_range4 e2) (= (contains avail3 e2) true)) (= e2 e1))) (= o7 true))))))
...
(assert (=> (= result4 true) (and (= o5 (contains alloc3 e)) (=> (= (of_int 1) true) (=> (exists ((e2 Int)) (and (and (in_range4 e2) (= (contains alloc3 e2) true)) (= e2 e))) (= o5 true))))))
