...
(assert (= result4 true))
(assert (and (= o28 (stack_entry (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1)) i)) (and (in_range1 o28) (= o28 (to_rep (select (rec__stack_functional_spec__stack_type__s (us_split_fields1 (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1)))) i))))))
(assert (and (= (mk___rep (mk___split_fields o26 o27)) (state__2 (us_split_fields__content my_stack__split_fields5))) (= (us_split_fields__content my_stack__split_fields5) (mk___split_fields o26 o27))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
