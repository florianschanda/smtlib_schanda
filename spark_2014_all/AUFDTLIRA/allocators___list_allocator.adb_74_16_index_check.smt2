...
(define-fun dynamic_invariant4 ((temp___expr_166 Int) (temp___is_init_163 Bool) (temp___skip_constant_164 Bool) (temp___do_toplevel_165 Bool)) Bool (=> (or (= temp___is_init_163 true) (<= 1 2147483647)) (in_range7 temp___expr_166)))
...
(define-fun dynamic_invariant5 ((temp___expr_191 Int) (temp___is_init_188 Bool) (temp___skip_constant_189 Bool) (temp___do_toplevel_190 Bool)) Bool (=> (or (= temp___is_init_188 true) (<= 0 10000)) (in_range8 temp___expr_191)))
...
(assert (forall ((container us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant5 item true true true) (=> (= (of_int 1) true) (=> (exists ((e Int)) (and (and (in_range8 e) (= (contains container e) true)) (= e item))) (= (contains container item) true)))) :pattern ((contains container item))))))
...
(assert (forall ((left us_rep2) (right us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant5 item true true true) (= (= (included_except left right item) true) (forall ((e Int)) (=> (and (in_range8 e) (= (contains left e) true)) (or (= (contains right e) true) (= e item)))))) :pattern ((included_except left right item))))))
...
(declare-const temp___2831 us_rep2)
(declare-const o18 us_rep2)
(declare-const o19 us_rep1)
(declare-const o20 us_rep2)
(declare-const temp___285 us_rep1)
(declare-const temp___2851 us_rep2)
(declare-const j Int)
