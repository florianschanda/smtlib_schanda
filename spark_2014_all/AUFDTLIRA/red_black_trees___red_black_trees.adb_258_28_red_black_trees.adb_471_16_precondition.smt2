...
(declare-const temp___802 (Array Int us_rep7))
...
(assert (<= 1 n5))
(assert (<= n5 100))
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c94b))) i))) true) (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c94b) i)))) n6)) (ite (= (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c95b)) i) c96b) (and (= (rec__red_black_trees__black_count__status (us_split_fields11 (select (nb_blacks c95b) i))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (nb_blacks c95b) i)))) (+ (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (nb_blacks c94b) i)))) 1))) (= (eq (select (nb_blacks c95b) i) (select (nb_blacks c94b) i)) true))))))
(assert (and (=> (<= 1 100) (in_range2 n6)) (and (<= 1 n6) (<= n6 100))))
(assert (and (= temp___798 (nb_blacks c94b)) (and (= (bool_eq11 (select temp___798 0) (mk___rep5 (mk___split_fields5 (distinct 1 0) (of_rep 0) (of_rep 0)))) true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c94b))) i))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___798 i))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___798 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___798 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___798 i)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___798 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___798 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___798 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___798 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___798 i)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c94b)) i)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___798 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i 0))))))))))))))
(assert (= o38 (select temp___798 c96b)))
...
(assert (and (= temp___802 (nb_blacks c94b)) (and (= (bool_eq11 (select temp___802 0) (mk___rep5 (mk___split_fields5 (distinct 1 0) (of_rep 0) (of_rep 0)))) true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c94b))) i))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___802 i))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___802 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___802 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___802 i)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___802 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___802 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___802 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___802 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___802 i)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c94b)) i)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___802 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i 0))))))))))))))
(assert (= o42 (select temp___802 c96b)))
