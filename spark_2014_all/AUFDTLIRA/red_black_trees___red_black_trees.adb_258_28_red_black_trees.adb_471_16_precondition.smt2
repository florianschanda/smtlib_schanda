...
(assert (and (= temp___791 (parent (rec__red_black_trees__rbt__struct t__split_fields8) o24)) (and (in_range2 temp___791) (and (= temp___791 (parent1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct t__split_fields8))) o24)) (=> (= (size (rec__red_black_trees__rbt__struct t__split_fields8)) 0) (= temp___791 0))))))
...
(assert (and (= temp___795 (parent (rec__red_black_trees__rbt__struct t__split_fields9) o29)) (and (in_range2 temp___795) (and (= temp___795 (parent1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct t__split_fields9))) o29)) (=> (= (size (rec__red_black_trees__rbt__struct t__split_fields9)) 0) (= temp___795 0))))))
...
(assert (and (= red_black_trees__insert__L_8__C96b__assume o37) (in_range4 o37)))
(assert (= red_black_trees__insert__L_8__C96b__assume c96b))
(assert (in_range4 c96b))
(assert (= (same_nb_blacks c94b) true))
(assert (= result13 (mk_int__ref n4)))
(assert (= n5 1))
(assert (<= 1 n5))
(assert (<= n5 100))
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields7 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c94b))) i))) true) (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c94b) i)))) n6)) (ite (= (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c95b)) i) c96b) (and (= (rec__red_black_trees__black_count__status (us_split_fields11 (select (nb_blacks c95b) i))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (nb_blacks c95b) i)))) (+ (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (nb_blacks c94b) i)))) 1))) (= (eq (select (nb_blacks c95b) i) (select (nb_blacks c94b) i)) true))))))
(assert (and (=> (<= 1 100) (in_range4 n6)) (and (<= 1 n6) (<= n6 100))))
(assert (and (= temp___800 (nb_blacks c94b)) (and (= (bool_eq11 (select temp___800 0) (mk___rep5 (mk___split_fields5 (distinct 1 0) rliteral rliteral))) true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c94b))) i))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___800 i))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___800 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___800 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___800 i)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___800 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___800 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___800 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___800 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___800 i)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c94b)) i)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___800 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i 0))))))))))))))
(assert (= o38 (select temp___800 c96b)))
...
(assert (and (= temp___804 (nb_blacks c94b)) (and (= (bool_eq11 (select temp___804 0) (mk___rep5 (mk___split_fields5 (distinct 1 0) rliteral rliteral))) true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c94b))) i))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___804 i))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___804 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___804 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___804 i)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___804 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___804 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___804 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___804 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___804 i)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c94b)) i)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___804 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i 0))))))))))))))
(assert (= o42 (select temp___804 c96b)))
