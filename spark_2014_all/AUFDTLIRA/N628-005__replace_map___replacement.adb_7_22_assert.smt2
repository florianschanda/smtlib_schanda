...
(assert (= (has_key (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields))) c3) true))
(assert (not (= (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c3) k)))
(assert (not (= (to_rep (select (elts a) (element (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c3))) (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c3))))
(check-sat)
(exit)
