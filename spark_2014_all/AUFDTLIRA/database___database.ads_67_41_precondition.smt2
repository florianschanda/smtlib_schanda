...
(assert (and (= result4 (existing (int__content account6) (map__content2 links5))) (= (= result4 true) (not (= (is_available (int__content account6) (map__content2 links5)) true)))))
(assert (= result4 true))
(assert (and (= result5 (belongs_to (int__content account6) customer id (map__content3 accounts5))) (= (= result5 true) (= (bool_eq5 (select (map__content3 accounts5) (int__content account6)) (mk___rep2 (mk___split_fields2 customer id (of_rep4 (int__content account6))))) true))))
(assert (= result5 true))
