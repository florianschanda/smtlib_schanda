...
(declare-fun tTm2SP1qtint (tTm2SP1) Int)
(assert (forall ((i tTm2SP1)) (and (<= 1 (tTm2SP1qtint i)) (<= (tTm2SP1qtint i) 10))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (= (to_rep (select (temp___String_Literal_206 us_void_param) 1)) 49) (= (to_rep (select (temp___String_Literal_206 us_void_param) 2)) 50)) (= (to_rep (select (temp___String_Literal_206 us_void_param) 3)) 51)) (= (to_rep (select (temp___String_Literal_206 us_void_param) 4)) 52)) (= (to_rep (select (temp___String_Literal_206 us_void_param) 5)) 53)) :pattern ((temp___String_Literal_206 us_void_param)))))
...
(assert (= (slide (temp___String_Literal_206 Tuple0) 1 r1b) temp___208))
(assert (= (mk r1b r2b) temp___2081))
(assert (<= r1b r2b))
(assert (not (<= 1 r1b)))
(check-sat)
(exit)
