...
(assert (=> (= result11 true) (and (= o58 (length (rec__list_allocator__m__t__allocated (us_split_fields__content1 model____split_fields5)))) (in_range6 o58))))
(assert (=> (= result11 true) (= result10 (ite (= o58 (- (length model____split_fields1) 1)) true false))))
