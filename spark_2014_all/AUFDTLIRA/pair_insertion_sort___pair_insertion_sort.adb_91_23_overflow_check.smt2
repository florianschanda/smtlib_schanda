...
(assert (=> (= result8 true) (and (and (= (is_perm (mk___t a (mk (to_rep a__first) (to_rep a__last))) (mk___t o41 (mk (to_rep a__first) (to_rep a__last)))) true) (and (= (to_rep (select o41 o14)) (to_rep (select a o15))) (and (= (to_rep (select o41 o15)) (to_rep (select a o14))) (forall ((z3 Int)) (=> (and (<= (to_rep a__first) z3) (<= z3 (to_rep a__last))) (=> (and (not (= z3 o14)) (not (= z3 o15))) (= (to_rep (select o41 z3)) (to_rep (select a z3))))))))) (= (to_rep a__first) 0))))
...
(assert (=> (<= 0 j9) (= o36 j9)))
(assert (=> (<= 0 j9) (= o37 (select o45 o36))))
...
(assert (and (= o40 j9) (in_range2 j9)))
