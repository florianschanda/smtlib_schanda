...
(assert (not (= (ite (<= (to_rep1 (first4 temp___2371)) (to_rep1 (last4 temp___2371))) (+ (- (to_rep1 (last4 temp___2371)) (to_rep1 (first4 temp___2371))) 1) 0) (ite (<= (to_rep1 new_sub__first) (to_rep1 new_sub__last)) (+ (- (to_rep1 new_sub__last) (to_rep1 new_sub__first)) 1) 0))))
(check-sat)
(exit)
