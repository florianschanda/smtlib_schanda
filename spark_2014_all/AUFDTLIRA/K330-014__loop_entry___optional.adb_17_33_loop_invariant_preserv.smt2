...
(assert (and (and (forall ((temp___616 Int)) (=> (and (<= 1 temp___616) (<= temp___616 5)) (=> (<= index2 temp___616) (= (select ta2 temp___616) (select ta1 temp___616))))) (=> (<= 1 5) (in_range6 index2))) (and (<= 1 index2) (<= index2 5))))
(assert (= (to_rep2 o) 1))
