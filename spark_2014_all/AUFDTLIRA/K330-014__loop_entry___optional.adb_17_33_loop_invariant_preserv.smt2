...
(assert (<= 1 index1))
(assert (<= index1 5))
(assert (= (to_rep2 (select ta2 index2)) 0))
(assert (and (and (forall ((temp___542 Int)) (=> (and (<= 1 temp___542) (<= temp___542 5)) (=> (<= index2 temp___542) (= (select ta3 temp___542) (select ta2 temp___542))))) (=> (<= 1 5) (in_range6 index2))) (and (<= 1 index2) (<= index2 5))))
(assert (= (to_rep2 o) 1))
(assert (= o1 (store ta3 index2 o)))
(assert (= ta3 result2))
(assert (= ta4 o1))
(assert (not (= index2 5)))
(assert (= result3 index2))
(assert (= index3 (+ index2 1)))
(assert (not (= (to_rep2 (select ta2 index3)) 0)))
(check-sat)
(exit)
