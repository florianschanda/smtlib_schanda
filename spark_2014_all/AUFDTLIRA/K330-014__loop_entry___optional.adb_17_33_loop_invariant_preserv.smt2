...
(assert (and (and (forall ((temp___548 Int)) (=> (and (<= 1 temp___548) (<= temp___548 5)) (=> (<= index2 temp___548) (= (select ta2 temp___548) (select ta1 temp___548))))) (=> (<= 1 5) (in_range6 index2))) (and (<= 1 index2) (<= index2 5))))
(assert (= (to_rep2 o) 1))
