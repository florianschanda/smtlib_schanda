...
(declare-const temp___1954 Int)
(declare-const temp___1955 Int)
(declare-const o Int)
(declare-const o1 character)
(declare-const o2 Int)
(declare-const o3 Bool)
(declare-const temp___1956 Int)
...
(assert (and (<= (to_rep1 (first (rt source))) temp___1957) (<= temp___1957 (to_rep1 (last (rt source))))))
(assert (= o8 temp___1957))
(assert (= o9 (select (elts source) o8)))
(assert (= o10 (to_rep o9)))
(assert (= o11 (ite (= o10 55) true false)))
(assert (and (= temp___1956 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1956) (<= temp___1956 (to_rep1 (last (rt source))))))
(assert (= o4 temp___1956))
(assert (= o5 (select (elts source) o4)))
(assert (= o6 (to_rep o5)))
(assert (= o7 (ite (= o6 52) true false)))
(assert (and (= temp___1955 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1955) (<= temp___1955 (to_rep1 (last (rt source))))))
(assert (= o temp___1955))
(assert (= o1 (select (elts source) o)))
(assert (= o2 (to_rep o1)))
(assert (= o3 (ite (= o2 49) true false)))
(assert (and (= temp___1954 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (not (<= (to_rep1 (first (rt source))) temp___1954)))
(check-sat)
(exit)
