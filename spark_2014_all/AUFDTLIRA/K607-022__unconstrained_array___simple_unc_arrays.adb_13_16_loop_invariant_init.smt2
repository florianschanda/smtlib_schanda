...
(assert (<= 1 j2))
(assert (<= j2 (- i1 1)))
(assert (not (= (to_rep1 (select c__split_fields j2)) (+ (to_rep1 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) j2)) (to_rep1 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 b))) j2))))))
(check-sat)
(exit)
