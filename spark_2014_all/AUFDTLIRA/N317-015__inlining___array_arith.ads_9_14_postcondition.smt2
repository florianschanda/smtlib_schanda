...
(assert (= result1 x1))
(assert (= x2 (store x1 2 rliteral1)))
(assert (= result2 x2))
(assert (= x3 (store x2 3 rliteral2)))
(assert (= result3 x3))
(assert (= x4 (store x3 4 rliteral3)))
(assert (= result4 x4))
(assert (= x5 (store x4 5 rliteral4)))
(assert (= result5 x5))
(assert (= x6 (store x5 6 rliteral5)))
(assert (= result6 x6))
(assert (= x7 (store x6 7 rliteral6)))
(assert (= result7 x7))
(assert (= x8 (store x7 8 rliteral7)))
(assert (= result8 x8))
(assert (= x9 (store x8 9 rliteral8)))
(assert (= result9 x9))
(assert (= x10 (store x9 10 rliteral9)))
(assert (= x10 x11))
(assert (= x12 x10))
(declare-const j Int)
(assert (<= 1 j))
(assert (<= j 10))
(assert (not (= (to_rep (select x11 j)) j)))
(check-sat)
(exit)
