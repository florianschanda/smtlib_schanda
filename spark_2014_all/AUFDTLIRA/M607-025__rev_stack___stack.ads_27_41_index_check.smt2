...
(assert (and (= (mk___t temp___229 temp___2291) (to__ s)) (and (dynamic_invariant (mk___t temp___229 temp___2291) true false true) (and (and (= (rec__stack__stack__content (us_split_fields1 s)) temp___229) (= (mk (to_rep (first2 (mk1 1 (to_rep1 (rec__stack__stack__top (us_split_fields1 s)))))) (to_rep (last2 (mk1 1 (to_rep1 (rec__stack__stack__top (us_split_fields1 s))))))) temp___2291)) (and (= (to_rep (first temp___2291)) 1) (<= 0 (to_rep (last temp___2291))))))))
(assert (and (= (mk___t o3 o4) (to__ s)) (and (dynamic_invariant (mk___t o3 o4) true false true) (and (and (= (rec__stack__stack__content (us_split_fields1 s)) o3) (= (mk (to_rep (first2 (mk1 1 (to_rep1 (rec__stack__stack__top (us_split_fields1 s)))))) (to_rep (last2 (mk1 1 (to_rep1 (rec__stack__stack__top (us_split_fields1 s))))))) o4)) (and (= (to_rep (first o4)) 1) (<= 0 (to_rep (last o4))))))))
(assert (= temp___230 (to_rep (last o4))))
(assert (not (<= (to_rep (first temp___2291)) temp___230)))
(check-sat)
(exit)
