...
(assert (and (= o5 (occ_def (mk___t o3 o4) e)) (and (in_range2 o5) (and (= o5 (ite (= (length (mk___t o3 o4)) 0) 0 (ite (= (to_rep (select o3 (to_rep (last o4)))) e) (+ (occ_def (remove_last (mk___t o3 o4)) e) 1) (occ_def (remove_last (mk___t o3 o4)) e)))) (<= o5 (length (mk___t o3 o4)))))))
(assert (= o6 (+ o5 1)))
