...
(assert (= result true))
(assert (and (= o7 (remove_last a)) (and (dynamic_invariant1 o7 true false true) (and (= (elts a) o3) (= (mk (to_rep (first2 (mk1 (to_rep (first (rt a))) (- (to_rep (last (rt a))) 1)))) (to_rep (last2 (mk1 (to_rep (first (rt a))) (- (to_rep (last (rt a))) 1))))) o4)))))
(assert (and (= o5 (occ_def o7 e)) (and (in_range2 o5) (and (= o5 (ite (= (length o7) 0) 0 (ite (= (to_rep (select o3 (to_rep (last o4)))) e) (+ (occ_def (remove_last o7) e) 1) (occ_def (remove_last o7) e)))) (<= o5 (length o7))))))
(assert (= o6 (+ o5 1)))
