...
(assert (and (= o320 (int__content x11)) (in_range2 (int__content x11))))
(assert (and (= o321 (parent (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields23)) o320)) (and (in_range3 o321) (and (= o321 (parent1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields23)))) o320)) (=> (= (size (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields23))) 0) (= o321 0))))))
(assert (and (= o322 o321) (in_range2 o321)))
(assert (and (= o323 (parent (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields23)) o322)) (and (in_range3 o323) (and (= o323 (parent1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields23)))) o322)) (=> (= (size (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields23))) 0) (= o323 0))))))
