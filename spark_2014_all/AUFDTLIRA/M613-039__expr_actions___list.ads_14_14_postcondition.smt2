...
(assert (= i8 first2))
(assert (=> (and (<= first2 i8) (<= i8 last3)) (and (= res__split_discrs (mk___split_discrs temp___468)) (= res__split_fields temp___4681))))
(assert (=> (and (<= first2 i8) (<= i8 last3)) (= temp___467 i8)))
(assert (=> (and (<= first2 i8) (<= i8 last3)) (= (us_split_fields__content s__split_fields7) (mk___split_fields temp___473 temp___4731))))
(assert (=> (and (<= first2 i8) (<= i8 last3)) (= (us_split_fields__content s__split_fields7) (mk___split_fields temp___466 temp___4661))))
...
(assert (=> (and (<= first2 i8) (<= i8 last3)) (= (let ((temp___185 (to__ (mk___rep s__split_fields9)))) (let ((temp___184 (to_but_top (mk___rep (us_split_fields__content s__split_fields7))))) (bool_eq (elts temp___184) (to_rep (first (rt temp___184))) (to_rep (last (rt temp___184))) (elts temp___185) (to_rep (first (rt temp___185))) (to_rep (last (rt temp___185)))))) true)))
(assert (=> (and (<= first2 i8) (<= i8 last3)) (and (and (= (to_rep (last (rt (to__ (mk___rep s__split_fields10))))) (- last3 i9)) (= (bool_eq (elts (to__ (mk___rep s__split_fields10))) (to_rep (first3 (mk1 first2 (- last3 i9)))) (to_rep (last4 (mk1 first2 (- last3 i9)))) (elts (to__ (mk___rep (mk___split_fields temp___473 temp___4731)))) (to_rep (first5 (mk2 first2 (- last3 i9)))) (to_rep (last6 (mk2 first2 (- last3 i9))))) true)) (forall ((j Int)) (=> (and (<= first2 j) (<= j i9)) (= (get (model__ (mk___rep1 res__split_discrs res__split_fields3)) j) (get (model__ l) (+ (- (last2 (model__ l)) j) 1))))))))
