...
(declare-const result11 capacity_range)
(declare-const result12 us_main_type)
...
(assert (= (mk___rep1 (mk___split_discrs result11) (mk___split_fields1 result12)) (list__content list__reverse_list__result5)))
(declare-const i31 Int)
(assert (<= 1 i31))
(assert (<= i31 (last2 (model__ l))))
(assert (not (= (get (model__ l) i31) (get (model__ (list__content list__reverse_list__result5)) (+ (- (last2 (model__ l)) i31) 1)))))
(check-sat)
(exit)
