...
(assert (= i8 first2))
(assert (=> (and (<= first2 i8) (<= i8 last3)) (and (= res__split_discrs (mk___split_discrs temp___514)) (= res__split_fields temp___5141))))
(assert (=> (and (<= first2 i8) (<= i8 last3)) (= temp___513 i8)))
(assert (=> (and (<= first2 i8) (<= i8 last3)) (= (us_split_fields__content s__split_fields7) (mk___split_fields temp___519 temp___5191))))
(assert (=> (and (<= first2 i8) (<= i8 last3)) (= (us_split_fields__content s__split_fields7) (mk___split_fields temp___512 temp___5121))))
...
(assert (=> (and (<= first2 i8) (<= i8 last3)) (and (and (= (to_rep (last (rt (to__ (mk___rep s__split_fields10))))) (- last3 i9)) (= (bool_eq (elts (to__ (mk___rep s__split_fields10))) (to_rep (first3 (mk1 first2 (- last3 i9)))) (to_rep (last4 (mk1 first2 (- last3 i9)))) (elts (to__ (mk___rep (mk___split_fields temp___519 temp___5191)))) (to_rep (first5 (mk2 first2 (- last3 i9)))) (to_rep (last6 (mk2 first2 (- last3 i9))))) true)) (forall ((j Int)) (=> (and (<= first2 j) (<= j i9)) (= (get (model__ (mk___rep1 res__split_discrs res__split_fields3)) j) (get (model__ l) (+ (- (last2 (model__ l)) j) 1))))))))
