...
(assert (= i8 first2))
(assert (=> (and (<= first2 i8) (<= i8 last3)) (and (= res__split_discrs (mk___split_discrs temp___516)) (= res__split_fields temp___5161))))
(assert (=> (and (<= first2 i8) (<= i8 last3)) (= temp___515 i8)))
(assert (=> (and (<= first2 i8) (<= i8 last3)) (= (us_split_fields__content s__split_fields7) (mk___split_fields temp___521 temp___5211))))
(assert (=> (and (<= first2 i8) (<= i8 last3)) (= (us_split_fields__content s__split_fields7) (mk___split_fields temp___514 temp___5141))))
(assert (=> (and (<= first2 i8) (<= i8 last3)) (and (= o2 (top (mk___rep (us_split_fields__content s__split_fields7)))) (and (in_range1 o2) (= o2 (to_rep1 (rec__stack__stack__top (us_split_fields__content s__split_fields7))))))))
(assert (=> (and (<= first2 i8) (<= i8 last3)) (and (and (= (length2 (mk___rep1 res__split_discrs list__my_lists__append__2__container__fields)) (+ (length2 (mk___rep1 res__split_discrs (mk___split_fields1 res__split_fields))) 1)) (= (olt (model__ (mk___rep1 res__split_discrs (mk___split_fields1 res__split_fields))) (model__ (mk___rep1 res__split_discrs list__my_lists__append__2__container__fields))) true)) (= (get (model__ (mk___rep1 res__split_discrs list__my_lists__append__2__container__fields)) (+ (last2 (model__ (mk___rep1 res__split_discrs (mk___split_fields1 res__split_fields)))) 1)) o2))))
(assert (=> (and (<= first2 i8) (<= i8 last3)) (= result2 res__split_fields12)))
(assert (=> (and (<= first2 i8) (<= i8 last3)) (= res__split_fields2 list__my_lists__append__2__container__fields)))
(assert (=> (and (<= first2 i8) (<= i8 last3)) (= (let ((temp___212 (to__ (mk___rep s__split_fields9)))) (let ((temp___211 (to_but_top (mk___rep (us_split_fields__content s__split_fields7))))) (bool_eq (elts temp___211) (to_rep (first (rt temp___211))) (to_rep (last (rt temp___211))) (elts temp___212) (to_rep (first (rt temp___212))) (to_rep (last (rt temp___212)))))) true)))
(assert (=> (and (<= first2 i8) (<= i8 last3)) (and (and (= (to_rep (last (rt (to__ (mk___rep s__split_fields10))))) (- last3 i9)) (= (bool_eq (elts (to__ (mk___rep s__split_fields10))) (to_rep (first3 (mk1 first2 (- last3 i9)))) (to_rep (last4 (mk1 first2 (- last3 i9)))) (elts (to__ (mk___rep (mk___split_fields temp___521 temp___5211)))) (to_rep (first5 (mk2 first2 (- last3 i9)))) (to_rep (last6 (mk2 first2 (- last3 i9))))) true)) (forall ((j Int)) (=> (and (<= first2 j) (<= j i9)) (= (get (model__ (mk___rep1 res__split_discrs res__split_fields3)) j) (get (model__ l) (+ (- (last2 (model__ l)) j) 1))))))))
(assert (=> (and (<= first2 i8) (<= i8 last3)) (and (=> (<= first2 last3) (dynamic_property2 first2 last3 i9)) (and (<= first2 i9) (<= i9 last3)))))
(assert (=> (and (<= first2 i8) (<= i8 last3)) (= i9 last3)))
(assert (=> (and (<= first2 i8) (<= i8 last3)) (= i10 (mk_int__ref i9))))
(assert (=> (and (<= first2 i8) (<= i8 last3)) (= res__split_fields4 (mk___split_fields__ref1 res__split_fields3))))
(assert (=> (and (<= first2 i8) (<= i8 last3)) (= s__split_fields11 (mk___split_fields__ref s__split_fields10))))
(assert (=> (and (<= first2 i8) (<= i8 last3)) (= i11 i9)))
(assert (=> (and (<= first2 i8) (<= i8 last3)) (= res__split_fields5 res__split_fields3)))
(assert (=> (and (<= first2 i8) (<= i8 last3)) (= s__split_fields12 s__split_fields10)))
(assert (=> (and (<= first2 i8) (<= i8 last3)) (= i12 i10)))
(assert (=> (and (<= first2 i8) (<= i8 last3)) (= res__split_fields6 res__split_fields4)))
(assert (=> (and (<= first2 i8) (<= i8 last3)) (= s__split_fields13 s__split_fields11)))
(assert (=> (and (<= first2 i8) (<= i8 last3)) (= i13 i11)))
(assert (=> (and (<= first2 i8) (<= i8 last3)) (= res__split_fields7 res__split_fields5)))
(assert (=> (and (<= first2 i8) (<= i8 last3)) (= s__split_fields14 s__split_fields12)))
(assert (=> (not (and (<= first2 i8) (<= i8 last3))) (= i12 (mk_int__ref i8))))
(assert (=> (not (and (<= first2 i8) (<= i8 last3))) (= res__split_fields6 res__split_fields12)))
(assert (=> (not (and (<= first2 i8) (<= i8 last3))) (= s__split_fields13 s__split_fields7)))
(assert (=> (not (and (<= first2 i8) (<= i8 last3))) (= i13 i8)))
(assert (=> (not (and (<= first2 i8) (<= i8 last3))) (= res__split_fields7 res__split_fields1)))
(assert (=> (not (and (<= first2 i8) (<= i8 last3))) (= s__split_fields14 s__split_fields8)))
...
(assert (= (mk___rep1 (mk___split_discrs result4) (mk___split_fields1 result5)) (list__content list__reverse_list__result5)))
(declare-const i22 Int)
(assert (<= 1 i22))
(assert (<= i22 (last2 (model__ l))))
(assert (not (= (get (model__ l) i22) (get (model__ (list__content list__reverse_list__result5)) (+ (- (last2 (model__ l)) i22) 1)))))
(check-sat)
(exit)
