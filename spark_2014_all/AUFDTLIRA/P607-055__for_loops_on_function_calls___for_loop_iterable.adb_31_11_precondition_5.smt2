...
(define-fun g__split_fields2 () us_split_fields (mk___split_fields g__split_fields1))
(assert (= result a))
...
(assert (and (= o (first (mk___rep g__split_fields2))) (and (in_range2 o) (= o 1))))
(assert (= o temp___286))
(assert (and (= result2 (has_element (mk___rep g__split_fields2) temp___286)) (= (= result2 true) (in_range3 temp___286))))
(assert (= result2 true))
(assert (not (= (has_element (mk___rep g__split_fields2) temp___286) true)))
(check-sat)
(exit)
