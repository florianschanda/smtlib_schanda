...
(define-fun dynamic_invariant ((temp___expr_173 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool) (temp___do_typ_inv_172 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= (- 23) 69)) (in_range temp___expr_173)))
...
(assert (= result a))
(assert (= a1 (store a 17 (mk___rep (mk___split_fields (rec__arrays_of_records__basic_record__flag (us_split_fields1 (select a 17))) rliteral (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select a 17))))))))
(assert (= result1 a1))
...
(assert (= a2 a3))
(assert (= a4 a2))
(assert (not (= (to_rep (rec__arrays_of_records__basic_record__first_value (us_split_fields1 (select a3 17)))) 42)))
(check-sat)
(exit)
