...
(assert (and (= temp___299 (+ j1 (- i1 1))) (in_range1 (+ j1 (- i1 1)))))
(assert (and (<= (to_rep1 (first (rt haystack))) temp___299) (<= temp___299 (to_rep1 (last (rt haystack))))))
(assert (= o5 temp___299))
