...
(declare-const temp___1296 Int)
(declare-const o16 Int)
(declare-const o17 character)
(declare-const o18 Int)
(declare-const o19 Bool)
(declare-const temp___1297 Int)
...
(assert (= (= o36 true) (forall ((index Int)) (=> (and (<= (to_rep1 (first (rt source))) index) (<= index (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index))) true)))))
(assert (= (length source) 10))
(assert (and (= temp___1300 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1300) (<= temp___1300 (to_rep1 (last (rt source))))))
(assert (= o32 temp___1300))
(assert (= o33 (select (elts source) o32)))
(assert (= o34 (to_rep o33)))
(assert (= o35 (ite (< o34 56) true false)))
(assert (and (= temp___1299 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1299) (<= temp___1299 (to_rep1 (last (rt source))))))
(assert (= o28 temp___1299))
(assert (= o29 (select (elts source) o28)))
(assert (= o30 (to_rep o29)))
(assert (= o31 (ite (= o30 52) true false)))
(assert (and (= temp___1298 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1298) (<= temp___1298 (to_rep1 (last (rt source))))))
(assert (= o24 temp___1298))
(assert (= o25 (select (elts source) o24)))
(assert (= o26 (to_rep o25)))
(assert (= o27 (ite (= o26 54) true false)))
(assert (and (= temp___1297 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1297) (<= temp___1297 (to_rep1 (last (rt source))))))
(assert (= o20 temp___1297))
(assert (= o21 (select (elts source) o20)))
(assert (= o22 (to_rep o21)))
(assert (= o23 (ite (= o22 51) true false)))
(assert (and (= temp___1296 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1296) (<= temp___1296 (to_rep1 (last (rt source))))))
(assert (= o16 temp___1296))
(assert (= o17 (select (elts source) o16)))
(assert (= o18 (to_rep o17)))
(assert (= o19 (ite (= o18 56) true false)))
(assert (and (= temp___1295 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1295) (<= temp___1295 (to_rep1 (last (rt source))))))
(assert (= o12 temp___1295))
(assert (= o13 (select (elts source) o12)))
(assert (= o14 (to_rep o13)))
(assert (= o15 (ite (= o14 52) true false)))
(assert (and (= temp___1294 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1294) (<= temp___1294 (to_rep1 (last (rt source))))))
(assert (= o8 temp___1294))
(assert (= o9 (select (elts source) o8)))
(assert (= o10 (to_rep o9)))
(assert (= o11 (ite (= o10 55) true false)))
(assert (and (= temp___1293 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1293) (<= temp___1293 (to_rep1 (last (rt source))))))
(assert (= o4 temp___1293))
(assert (= o5 (select (elts source) o4)))
(assert (= o6 (to_rep o5)))
(assert (= o7 (ite (= o6 52) true false)))
(assert (and (= temp___1292 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1292) (<= temp___1292 (to_rep1 (last (rt source))))))
(assert (= o temp___1292))
(assert (= o1 (select (elts source) o)))
(assert (= o2 (to_rep o1)))
(assert (= o3 (ite (= o2 49) true false)))
(assert (and (= temp___1291 (+ (to_rep1 (first (rt source))) 0)) (in_range1 (+ (to_rep1 (first (rt source))) 0))))
(assert (not (<= (to_rep1 (first (rt source))) temp___1291)))
(check-sat)
(exit)
