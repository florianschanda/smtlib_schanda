...
(assert (= (= o36 true) (forall ((index11 Int)) (=> (and (<= (to_rep1 (first (rt source))) index11) (<= index11 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index11))) true)))))
(assert (= (length source) 10))
(assert (and (= temp___1198 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1198) (<= temp___1198 (to_rep1 (last (rt source))))))
(assert (= o32 temp___1198))
(assert (= o33 (select (elts source) o32)))
(assert (= o34 (to_rep o33)))
(assert (= o35 (ite (< o34 56) true false)))
(assert (and (= temp___1197 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1197) (<= temp___1197 (to_rep1 (last (rt source))))))
(assert (= o28 temp___1197))
