...
(assert (<= 1 r))
(assert (<= r 3))
(assert (= (to_rep1 (rec__list_allocator__cell__stat (us_split_fields3 (select data3 r)))) 0))
(assert (not (= (mem (rec__list_allocator__m__t__available model____split_fields3) r) true)))
(check-sat)
(exit)
