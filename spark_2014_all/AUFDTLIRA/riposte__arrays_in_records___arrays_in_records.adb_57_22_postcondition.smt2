...
(declare-const temp___229 index)
(declare-const temp___2291 (Array Int value))
(declare-const temp___2292 (Array Int value))
...
(declare-const temp___232 index)
(declare-const temp___2321 (Array Int value))
(declare-const temp___2322 (Array Int value))
...
(assert (= temp___229 o1))
(assert (= temp___2291 o2))
(assert (= temp___2292 o3))
...
(assert (= temp___229 a__split_fields3))
(assert (= temp___2291 a__split_fields4))
(assert (= temp___2292 a__split_fields5))
...
(assert (= temp___232 a__split_fields6))
(assert (= temp___2321 a__split_fields7))
(assert (= temp___2322 a__split_fields8))
(assert (= (to_rep1 o9) 23))
(assert (= o10 (store a__split_fields8 101 o9)))
(assert (= a__split_fields6 o11))
(assert (= a__split_fields7 o12))
(assert (= o10 o13))
(assert (= temp___235 o11))
(assert (= temp___2351 o12))
(assert (= temp___2352 o13))
(assert (= result6 a__split_fields6))
(assert (= result7 a__split_fields7))
(assert (= result8 a__split_fields8))
(assert (= temp___235 a__split_fields9))
(assert (= temp___2351 a__split_fields10))
(assert (= temp___2352 a__split_fields11))
