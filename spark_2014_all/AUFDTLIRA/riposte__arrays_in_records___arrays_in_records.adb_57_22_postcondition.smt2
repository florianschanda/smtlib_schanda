...
(declare-const temp___202 index)
(declare-const temp___2021 (Array Int value))
(declare-const temp___2022 (Array Int value))
...
(declare-const temp___205 index)
(declare-const temp___2051 (Array Int value))
(declare-const temp___2052 (Array Int value))
...
(declare-const temp___208 index)
(declare-const temp___2081 (Array Int value))
(declare-const temp___2082 (Array Int value))
...
(declare-const a__split_fields15 us_split_fields)
(assert (and (and (and (and (and (= (to_rep o) 100) (and (= o o1) (and (= a__split_fields1 o2) (= a__split_fields2 o3)))) (and (= temp___202 o1) (and (= temp___2021 o2) (= temp___2022 o3)))) (and (= (mk___split_fields__ref (mk___split_fields result result1 result2)) (mk___split_fields__ref (mk___split_fields a__split_fields a__split_fields1 a__split_fields2))) (and (= temp___202 a__split_fields3) (and (= temp___2021 a__split_fields4) (= temp___2022 a__split_fields5))))) (and (and (and (and (and (= (to_rep1 o4) 42) (= o5 (store a__split_fields4 17 o4))) (and (= a__split_fields3 o6) (and (= o5 o7) (= a__split_fields5 o8)))) (and (= temp___205 o6) (and (= temp___2051 o7) (= temp___2052 o8)))) (and (and (= result3 a__split_fields3) (and (= result4 a__split_fields4) (= result5 a__split_fields5))) (and (= temp___205 a__split_fields6) (and (= temp___2051 a__split_fields7) (= temp___2052 a__split_fields8))))) (and (and (and (and (and (= (to_rep1 o9) 23) (= o10 (store a__split_fields8 101 o9))) (and (= a__split_fields6 o11) (and (= a__split_fields7 o12) (= o10 o13)))) (and (= temp___208 o11) (and (= temp___2081 o12) (= temp___2082 o13)))) (and (and (= result6 a__split_fields6) (and (= result7 a__split_fields7) (= result8 a__split_fields8))) (and (= temp___208 a__split_fields9) (and (= temp___2081 a__split_fields10) (= temp___2082 a__split_fields11))))) (= (to_rep1 (select a__split_fields11 101)) 23)))) (and (and (= a__split_fields12 a__split_fields9) (and (= a__split_fields13 a__split_fields10) (= a__split_fields14 a__split_fields11))) (= a__split_fields15 (mk___split_fields a__split_fields9 a__split_fields10 a__split_fields11)))))
(assert (not (= (to_rep1 (select a__split_fields13 17)) 23)))
(check-sat)
(exit)
