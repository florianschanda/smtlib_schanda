...
(declare-fun temp_____aggregate_def_3890 ((Array Int us_rep) Int us_rep) (Array Int us_rep))
(declare-fun temp_____aggregate_def_3897 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
(declare-fun temp_____aggregate_def_3904 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___3892 (Array Int us_rep))) (forall ((temp___3893 Int)) (forall ((temp___3894 us_rep)) (let ((temp___3891 (temp_____aggregate_def_3890 temp___3892 temp___3893 temp___3894))) (=> (dynamic_invariant2 temp___3893 true true true true) (forall ((temp___3895 Int)) (ite (= temp___3895 temp___3893) (= (select temp___3891 temp___3895) temp___3894) (= (select temp___3891 temp___3895) (select temp___3892 temp___3895))))))))))
(assert (forall ((temp___3899 (Array Int (Array Int et1)))) (forall ((temp___3900 Int)) (forall ((temp___3901 (Array Int et1))) (let ((temp___3898 (temp_____aggregate_def_3897 temp___3899 temp___3900 temp___3901))) (=> (dynamic_invariant1 temp___3900 true true true true) (forall ((temp___3902 Int)) (ite (= temp___3902 temp___3900) (= (select temp___3898 temp___3902) temp___3901) (= (select temp___3898 temp___3902) (select temp___3899 temp___3902))))))))))
(assert (forall ((temp___3906 (Array Int et1))) (forall ((temp___3907 Int) (temp___3908 Int)) (let ((temp___3905 (temp_____aggregate_def_3904 temp___3906 temp___3907 temp___3908))) (=> (and (dynamic_invariant temp___3907 true true true true) (dynamic_invariant3 temp___3908 true true true true)) (forall ((temp___3909 Int)) (ite (= temp___3909 temp___3907) (= (to_rep (select temp___3905 temp___3909)) temp___3908) (= (select temp___3905 temp___3909) (select temp___3906 temp___3909)))))))))
...
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (bool_eq3 a2 90 99 (temp_____aggregate_def_3890 a i (mk___rep (mk___split_fields (rec__ar__rofa4__s4 (us_split_fields1 (select a i))) (temp_____aggregate_def_3897 (rec__ar__rofa4__t4 (us_split_fields1 (select a i))) j (temp_____aggregate_def_3904 (select (rec__ar__rofa4__t4 (us_split_fields1 (select a i))) j) k e))))) 90 99) true)))
(check-sat)
(exit)
