...
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (bool_eq3 a2 90 99 (temp___3890 a i (mk___rep (mk___split_fields (rec__ar__rofa4__s4 (us_split_fields1 (select a i))) (temp___3897 (rec__ar__rofa4__t4 (us_split_fields1 (select a i))) j (temp___3904 (select (rec__ar__rofa4__t4 (us_split_fields1 (select a i))) j) k e))))) 90 99) true)))
(check-sat)
(exit)
