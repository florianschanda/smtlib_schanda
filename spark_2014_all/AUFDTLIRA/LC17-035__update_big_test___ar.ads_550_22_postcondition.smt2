...
(declare-fun temp___2189 ((Array Int (Array Int (Array Int et1))) Int (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1))))
(declare-fun temp___2195 ((Array Int (Array Int et1)) Int (Array Int et1) Int (Array Int et1)) (Array Int (Array Int et1)))
(declare-fun temp___2205 ((Array Int (Array Int (Array Int et1))) Int (Array Int (Array Int et1)) Int (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1))))
(declare-fun temp___2213 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
(declare-fun temp___2220 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
...
(assert (= a4 a2))
(assert (not (= i1 i2)))
(assert (not (= (bool_eq2 a3 1 16 (temp___2205 a i1 (temp___2213 (select a i1) j1 b) i2 (temp___2220 (select a i2) j2 c)) 1 16) true)))
(check-sat)
(exit)
