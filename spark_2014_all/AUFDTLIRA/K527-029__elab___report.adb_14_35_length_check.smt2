...
(assert (not (= (ite (<= (to_rep1 (first temp___1531)) (to_rep1 (last temp___1531))) (+ (- (to_rep1 (last temp___1531)) (to_rep1 (first temp___1531))) 1) 0) (ite (<= (to_rep1 (first temp___1551)) (to_rep1 (last temp___1551))) (+ (- (to_rep1 (last temp___1551)) (to_rep1 (first temp___1551))) 1) 0))))
(check-sat)
(exit)
