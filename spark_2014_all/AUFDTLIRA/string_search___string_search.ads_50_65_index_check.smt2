...
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (forall ((c1 Int)) (=> (and (<= 0 c1) (<= c1 255)) (ite (= (to_rep (select bad_shift3 c1)) (+ (length needle) 1)) (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 j2)) (not (= c1 (to_rep1 (select (elts needle) k1)))))) (and (= (to_rep1 (select (elts needle) (+ (- (length needle) (to_rep (select bad_shift3 c1))) 1))) c1) (forall ((k1 Int)) (=> (and (<= (+ (- (length needle) (to_rep (select bad_shift3 c1))) 2) k1) (<= k1 j2)) (not (= (to_rep1 (select (elts needle) k1)) c1))))))))))
...
(assert (= result4 true))
(assert (<= (to_rep2 (first (rt needle))) k))
(assert (<= k (to_rep2 (last (rt needle)))))
(assert (not (<= (to_rep2 (first (rt needle))) k)))
(check-sat)
(exit)
