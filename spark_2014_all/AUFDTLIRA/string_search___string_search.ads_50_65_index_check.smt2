...
(assert (forall ((temp___285 Int)) (forall ((temp___286 Int)) (= (select (temp___283 temp___285) temp___286) (of_rep temp___285)))))
...
(declare-const o4 (Array Int positive))
(declare-const temp___289 Int)
(declare-const temp___287 (Array Int positive))
...
(declare-const o11 positive)
(declare-const o12 (Array Int positive))
(declare-const c Int)
...
(declare-const o35 (Array Int positive))
...
(declare-const result6 (Array Int positive))
(declare-const bad_shift4 (Array Int positive))
(declare-const bad_shift5 (Array Int positive))
(declare-const j4 Int)
(declare-const bad_shift6 (Array Int positive))
(declare-const j5 Int)
(declare-const bad_shift7 (Array Int positive))
(declare-const j6 Int)
(declare-const bad_shift8 (Array Int positive))
(declare-const j7 Int)
(declare-const bad_shift9 (Array Int positive))
(declare-const j8 Int)
(declare-const bad_shift10 (Array Int positive))
...
(assert (and (= o1 (length needle)) (in_range1 (length needle))))
(assert (= o2 (+ o1 1)))
(assert (and (= o3 o2) (in_range1 o2)))
(assert (= o4 (temp___283 o3)))
(assert (= (mk_map__ref1 result) (mk_map__ref1 bad_shift)))
(assert (= bad_shift1 o4))
(assert (= (mk_int__ref result1) (mk_int__ref j)))
(assert (= j1 (to_rep2 (first (rt needle)))))
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (= temp___289 j1)))
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (= temp___287 bad_shift1)))
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (and (= o5 (length needle)) (in_range1 (length needle)))))
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (= o6 (- o5 j1))))
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (and (= o7 o6) (in_range1 o6))))
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (= o8 (+ o7 1))))
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (and (= o9 o8) (in_range1 o8))))
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (and (= o10 o9) (in_range2 o9))))
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (= (to_rep o11) o10)))
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (= o12 (store bad_shift1 (to_rep1 (select (elts needle) j1)) o11))))
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (= bad_shift1 result2)))
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (= bad_shift2 o12)))
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (forall ((c4 Int)) (=> (and (<= 0 c4) (<= c4 255)) (and (<= 1 (to_rep (select bad_shift3 c4))) (<= (to_rep (select bad_shift3 c4)) (+ (length needle) 1)))))))
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (forall ((c4 Int)) (=> (and (<= 0 c4) (<= c4 255)) (ite (= (to_rep (select bad_shift3 c4)) (+ (length needle) 1)) (forall ((k4 Int)) (=> (and (<= 1 k4) (<= k4 j2)) (not (= c4 (to_rep1 (select (elts needle) k4)))))) (and (= (to_rep1 (select (elts needle) (+ (- (length needle) (to_rep (select bad_shift3 c4))) 1))) c4) (forall ((k4 Int)) (=> (and (<= (+ (- (length needle) (to_rep (select bad_shift3 c4))) 2) k4) (<= k4 j2)) (not (= (to_rep1 (select (elts needle) k4)) c4))))))))))
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (and (=> (<= (to_rep2 (first (rt needle))) (to_rep2 (last (rt needle)))) (dynamic_property1 (to_rep2 (first (rt needle))) (to_rep2 (last (rt needle))) j2)) (and (<= (to_rep2 (first (rt needle))) j2) (<= j2 (to_rep2 (last (rt needle))))))))
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (= j2 (to_rep2 (last (rt needle))))))
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (= j2 j4)))
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (= bad_shift3 bad_shift5)))
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (= j5 j2)))
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (= bad_shift6 bad_shift3)))
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (= (mk_int__ref j6) (mk_int__ref j4))))
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (= (mk_map__ref1 bad_shift7) (mk_map__ref1 bad_shift5))))
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (= j7 j5)))
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (= bad_shift8 bad_shift6)))
(assert (=> (not (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle)))))) (= j1 j6)))
(assert (=> (not (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle)))))) (= bad_shift1 bad_shift7)))
(assert (=> (not (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle)))))) (= j7 j1)))
(assert (=> (not (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle)))))) (= bad_shift8 bad_shift1)))
(assert (= (mk_int__ref j8) (mk_int__ref j6)))
(assert (= (mk_map__ref1 bad_shift9) (mk_map__ref1 bad_shift7)))
(assert (= j9 j7))
(assert (= bad_shift10 bad_shift8))
(assert (= (= result7 true) (forall ((c4 Int)) (=> (and (<= 0 c4) (<= c4 255)) (and (<= 1 (to_rep (select bad_shift9 c4))) (<= (to_rep (select bad_shift9 c4)) (+ (length needle) 1)))))))
(assert (= result7 true))
(assert (<= 0 c2))
(assert (<= c2 255))
(assert (and (= o36 (length needle)) (in_range1 (length needle))))
(assert (= o37 (+ o36 1)))
(assert (and (= o38 o37) (in_range1 o37)))
(assert (= result8 (ite (= (to_rep (select bad_shift9 c2)) o38) true false)))
(assert (= result8 true))
(assert (<= (to_rep2 (first (rt needle))) k2))
(assert (<= k2 (to_rep2 (last (rt needle)))))
(assert (not (<= (to_rep2 (first (rt needle))) k2)))
(check-sat)
(exit)
