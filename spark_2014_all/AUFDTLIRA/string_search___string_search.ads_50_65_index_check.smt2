...
(declare-const temp___320 Int)
(declare-const temp___318 (Array Int positive))
...
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (= temp___320 j1)))
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (= temp___318 bad_shift1)))
