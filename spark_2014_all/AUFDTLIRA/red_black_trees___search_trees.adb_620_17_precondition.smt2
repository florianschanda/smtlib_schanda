...
(assert (in_range3 l))
(assert (in_range1 v))
(assert (and (= o3 (size (rec__search_trees__search_tree__struct (us_split_fields7 t)))) (in_range4 o3)))
...
(assert (and (= result1 (valid_root (rec__search_trees__search_tree__struct (us_split_fields7 t)) o2)) (=> (< (size (rec__search_trees__search_tree__struct (us_split_fields7 t))) o2) (not (= result1 true)))))
(assert (= result1 true))
...
(assert (and (= result2 (ordered_leafs (rec__search_trees__search_tree__struct (us_split_fields7 t)) o1 (rec__search_trees__search_tree__values (us_split_fields7 t)))) (= (= result2 true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o1) i))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o1) j))) true)) (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o1) i))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o1) j)))) true)) (ite (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o1) j))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o1) i)))) 1)) 0) (< (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) j)) (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i))) (< (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i)) (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) j))))))))))))
(assert (= result2 true))
