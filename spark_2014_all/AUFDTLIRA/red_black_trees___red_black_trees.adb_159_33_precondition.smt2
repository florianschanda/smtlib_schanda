...
(assert (<= 1 j5))
(assert (<= j5 100))
(assert (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select m j5))) true) (and (= o118 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j5 0)) (and (in_range3 o118) (= o118 (peek1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) j5 0))))))
(assert (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select m j5))) true) (= o119 (select res3 o118))))
(assert (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select m j5))) true) (= o120 (us_split_fields11 o119))))
(assert (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select m j5))) true) (= o121 (rec__red_black_trees__black_count__depth o120))))
(assert (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select m j5))) true) (= o122 (to_rep o121))))
(assert (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select m j5))) true) (= result5 (ite (< o122 n2) true false))))
(assert (=> (not (= (rec__tree_model__path_type__k (us_split_fields1 (select m j5))) true)) (= result5 false)))
(assert (= result5 true))
