...
(assert (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select m j))) true) (= o18 (select res3 o17))))
...
(assert (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select m j))) true) (= result3 (ite (< o21 n2) true false))))
(assert (=> (not (= (rec__tree_model__path_type__k (us_split_fields1 (select m j))) true)) (= result3 false)))
(assert (= result3 true))
