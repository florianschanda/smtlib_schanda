...
(assert (and (= o38 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (= o39 (ite (<= o38 i) true false)))
(assert (= result5 (ite (= o39 true) (ite (<= i index3) true false) false)))
(assert (= result5 true))
(assert (and (<= (to_rep1 n__first) i) (<= i (to_rep1 n__last))))
(assert (= o40 i))
(assert (= o41 (select n3 o40)))
(assert (= o42 (to_rep1 o41)))
(assert (= o43 (ite (<= o42 9) true false)))
