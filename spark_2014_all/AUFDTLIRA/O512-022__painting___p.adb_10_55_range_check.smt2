...
(assert (exists ((c3 Int)) (and (and (<= 0 c3) (<= c3 2)) (= (bool_eq (select p__split_fields c3) d) true))))
...
(assert (and (and (and (= p__split_fields2 p__split_fields) (forall ((temp___208 Int)) (=> (and (<= 0 temp___208) (<= temp___208 2)) (=> (<= c2 temp___208) (= (select p__split_fields3 temp___208) (select p__split_fields1 temp___208)))))) (=> (<= 0 2) (in_range2 c2))) (and (<= 0 c2) (<= c2 2))))
