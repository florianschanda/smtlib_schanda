...
(assert (and (and (and (= p__split_fields2 p__split_fields) (forall ((temp___234 Int)) (=> (and (<= 0 temp___234) (<= temp___234 2)) (=> (<= c2 temp___234) (= (select p__split_fields3 temp___234) (select p__split_fields1 temp___234)))))) (=> (<= 0 2) (in_range2 c2))) (and (<= 0 c2) (<= c2 2))))
