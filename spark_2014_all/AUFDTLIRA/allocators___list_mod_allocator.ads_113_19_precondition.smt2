...
(assert (=> (= result true) (and (= o25 (model__ data2 first_available2)) (= (model_is_well_formed o25 data2 first_available2) true))))
...
(assert (and (= o22 (model__ (map__content data5) (int__content first_available5))) (= (model_is_well_formed o22 (map__content data5) (int__content first_available5)) true)))
(assert (= o23 (us_split_fields3 o22)))
(assert (= o24 (rec__list_mod_allocator__m__t__available o23)))
(assert (and (= result4 (is_prepend (rec__list_mod_allocator__m__t__available (us_split_fields3 (model__ data first_available))) res o24)) (= (= result4 true) (and (and (and (< (length (rec__list_mod_allocator__m__t__available (us_split_fields3 (model__ data first_available)))) 2147483647) (= (length o24) (+ (length (rec__list_mod_allocator__m__t__available (us_split_fields3 (model__ data first_available)))) 1))) (= (get o24 1) res)) (= (range_shifted (rec__list_mod_allocator__m__t__available (us_split_fields3 (model__ data first_available))) o24 1 (last (rec__list_mod_allocator__m__t__available (us_split_fields3 (model__ data first_available)))) 1) true)))))
(assert (= result4 true))
