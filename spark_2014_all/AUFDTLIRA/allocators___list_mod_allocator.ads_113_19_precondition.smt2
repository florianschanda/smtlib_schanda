...
(assert (and (= o45 (model__ (map__content data5) (int__content first_available5))) (= (model_is_well_formed o45 (map__content data5) (int__content first_available5)) true)))
(assert (= o46 (us_split_fields3 o45)))
(assert (= o47 (rec__list_mod_allocator__m__t__available o46)))
(assert (and (= result7 (is_prepend (rec__list_mod_allocator__m__t__available (us_split_fields3 (model__ data first_available))) res o47)) (= (= result7 true) (and (and (and (< (length (rec__list_mod_allocator__m__t__available (us_split_fields3 (model__ data first_available)))) 2147483647) (= (length o47) (+ (length (rec__list_mod_allocator__m__t__available (us_split_fields3 (model__ data first_available)))) 1))) (= (get o47 1) res)) (= (range_shifted (rec__list_mod_allocator__m__t__available (us_split_fields3 (model__ data first_available))) o47 1 (last (rec__list_mod_allocator__m__t__available (us_split_fields3 (model__ data first_available)))) 1) true)))))
(assert (= result7 true))
