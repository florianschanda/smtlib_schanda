...
(assert (and (= o48 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i 0)) (and (in_range3 o48) (= o48 (peek1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) i 0)))))
(assert (= (mk___rep5 (mk___split_fields5 o49 o50 o51)) (select res2 o48)))
(assert (= o52 (mk___split_fields5 o49 o50 o51)))
(assert (= o53 (rec__red_black_trees__black_count__count o52)))
(assert (= o54 (to_rep o53)))
(assert (=> (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) i)) 0) (= o55 1)))
(assert (=> (not (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) i)) 0)) (= o55 0)))
(assert (= o56 (+ o55 o54)))
(assert (and (= o57 o56) (in_range1 o56)))
(assert (= o58 (ite (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res2 i)))) o57) true false)))
(assert (and (= o34 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i 1)) (and (in_range3 o34) (= o34 (peek1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) i 1)))))
(assert (= (mk___rep5 (mk___split_fields5 o35 o36 o37)) (select res2 o34)))
(assert (= o35 o38))
(assert (= o36 o39))
(assert (= o37 o40))
(assert (= o41 o39))
...
(assert (= o29 o32))
(assert (= o33 o31))
(assert (= o43 (to_rep o33)))
(assert (= o44 (ite (< o43 o42) o42 o43)))
(assert (= o45 (+ 1 o44)))
(assert (and (= o46 o45) (in_range1 o45)))
(assert (= o47 (ite (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 i)))) o46) true false)))
