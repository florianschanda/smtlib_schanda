...
(assert (and (= o18 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i1 1)) (and (in_range3 o18) (= o18 (peek1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) i1 1)))))
(assert (= (mk___rep5 (mk___split_fields5 o19 o20 o21)) (select res2 o18)))
(assert (= o19 o22))
(assert (= o20 o23))
(assert (= o21 o24))
(assert (= o25 o24))
