...
(assert (= j7 j3))
(assert (= bad4 bad1))
(assert (forall ((j12 Int)) (=> (and (<= (to_rep1 (first (rt a))) j12) (<= j12 i1)) (= (to_rep (select r2 j12)) 0))))
(assert (= i1 result5))
(assert (= i2 2))
(assert (= (to_rep o3) 0))
(assert (and (<= (to_rep1 r__first) i2) (<= i2 (to_rep1 r__last))))
(assert (= o4 i2))
(assert (= o5 (store r2 o4 o3)))
(assert (= r2 result6))
(assert (= r3 o5))
(assert (not (= i2 (to_rep1 (last (rt a))))))
(assert (= (mk_bool__ref loops_static__loop9__result4) (mk_bool__ref loops_static__loop9__result2)))
(assert (= (mk_int__ref j10) (mk_int__ref j6)))
(assert (= (mk_bool__ref bad6) (mk_bool__ref bad3)))
(assert (= loops_static__loop9__result5 loops_static__loop9__result3))
(assert (= j11 j7))
(assert (= bad7 bad4))
(assert (forall ((j12 Int)) (=> (and (<= (to_rep1 (first (rt a))) j12) (<= j12 i2)) (= (to_rep (select r3 j12)) 0))))
(assert (not false))
(check-sat)
(exit)
