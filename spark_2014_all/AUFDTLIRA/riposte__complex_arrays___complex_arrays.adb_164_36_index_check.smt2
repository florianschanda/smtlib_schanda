...
(assert (=> (and (<= 0 j2) (<= j2 i)) (and (forall ((k1 Int)) (=> (and (<= 0 k1) (<= k1 j3)) (=> (<= k1 j3) (= (to_rep (select tmp3 k1)) (- 23))))) (= i temp___273))))
...
(assert (<= 0 k))
(assert (<= k j9))
(assert (=> (<= i k) (and (<= 0 k) (<= k 1001))))
(assert (=> (<= i k) (= o4 k)))
(assert (=> (<= i k) (= o5 (select tmp9 o4))))
(assert (=> (<= i k) (= o6 (to_rep o5))))
(assert (=> (<= i k) (= o7 (ite (= o6 69) true false))))
(assert (=> (not (<= i k)) (= o7 (distinct 1 0))))
(assert (< k i))
(assert (not (<= 0 k)))
(check-sat)
(exit)
