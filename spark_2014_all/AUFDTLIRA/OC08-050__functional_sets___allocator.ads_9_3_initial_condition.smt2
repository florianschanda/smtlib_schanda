...
(assert (forall ((temp___352 Int)) (forall ((temp___353 Int)) (= (select (allocator__data__aggregate_def temp___352) temp___353) (of_rep temp___352)))))
(define-fun dynamic_invariant1 ((temp___expr_339 Int) (temp___is_init_336 Bool) (temp___skip_constant_337 Bool) (temp___do_toplevel_338 Bool)) Bool (=> (or (= temp___is_init_336 true) (<= 0 1)) (in_range1 temp___expr_339)))
