...
(assert (forall ((x status)) (! (in_range (to_rep x)) :pattern ((to_rep x)))))
...
(assert true)
(assert (forall ((allocator__data (Array Int status))) (! (= (= (all_available allocator__data) true) (forall ((r Int)) (=> (and (<= 1 r) (<= r 3)) (= (to_rep (select allocator__data r)) 0)))) :pattern ((all_available allocator__data)))))
...
(define-fun dynamic_invariant1 ((temp___expr_370 Int) (temp___is_init_366 Bool) (temp___skip_constant_367 Bool) (temp___do_toplevel_368 Bool) (temp___do_typ_inv_369 Bool)) Bool (=> (or (= temp___is_init_366 true) (<= 0 1)) (in_range temp___expr_370)))
(assert (forall ((temp___384 Int)) (=> (dynamic_invariant1 temp___384 true true true true) (forall ((temp___385 Int)) (= (to_rep (select (allocator__data__aggregate_def temp___384) temp___385)) temp___384)))))
...
(assert (and (= result1 (all_available data1)) (= (= result1 true) (forall ((r Int)) (=> (and (<= 1 r) (<= r 3)) (= (to_rep (select data1 r)) 0))))))
(assert (not (= (all_available data1) true)))
(check-sat)
(exit)
