...
(assert (and (= o16 (search_upto (to_base init) e)) (ite (= (rec__private_record__result_ty__found (us_split_discrs1 o16)) true) (and (<= (get_content o16) (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 (to_base init))))) (= (to_rep (select (elts1 (rec__record_discr__interm_result__to_search (us_split_fields3 (to_base init)))) (get_content o16))) e)) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 (to_base init)))))) (not (= (to_rep (select (elts1 (rec__record_discr__interm_result__to_search (us_split_fields3 (to_base init)))) i1)) e)))))))
