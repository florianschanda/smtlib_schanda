...
(declare-fun temp___294 ((Array Int integer) Int Int) (Array Int integer))
(assert (forall ((temp___296 (Array Int integer))) (forall ((temp___297 Int) (temp___298 Int)) (let ((temp___295 (temp___294 temp___296 temp___297 temp___298))) (forall ((temp___299 Int)) (ite (= temp___299 temp___297) (= (select temp___295 temp___299) (of_rep temp___298)) (= (select temp___295 temp___299) (select temp___296 temp___299))))))))
(declare-fun temp___494 ((Array Int integer) Int Int) (Array Int integer))
(assert (forall ((temp___496 (Array Int integer))) (forall ((temp___497 Int) (temp___498 Int)) (let ((temp___495 (temp___494 temp___496 temp___497 temp___498))) (forall ((temp___499 Int)) (ite (= temp___499 temp___497) (= (select temp___495 temp___499) (of_rep temp___498)) (= (select temp___495 temp___499) (select temp___496 temp___499))))))))
...
(assert (= result a))
(assert (= a1 (temp___494 a i new_val)))
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (bool_eq a2 1 8 (temp___294 a i new_val) 1 8) true)))
(check-sat)
(exit)
