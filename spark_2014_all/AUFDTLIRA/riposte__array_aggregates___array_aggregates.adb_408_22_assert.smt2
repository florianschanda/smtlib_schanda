...
(define-fun bool_eq2 ((a (Array Int us_rep)) (a__first Int) (a__last Int) (b (Array Int us_rep)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_147 Int)) (=> (and (<= a__first temp___idx_147) (<= temp___idx_147 a__last)) (= (bool_eq1 (select a temp___idx_147) (select b (+ (- b__first a__first) temp___idx_147))) true)))) true false))
(assert (forall ((a (Array Int us_rep)) (b (Array Int us_rep))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq2 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_147 Int)) (=> (and (<= a__first temp___idx_147) (<= temp___idx_147 a__last)) (= (bool_eq1 (select a temp___idx_147) (select b (+ (- b__first a__first) temp___idx_147))) true))))))))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-fun temp___633 (us_rep) (Array Int us_rep))
(assert (forall ((temp___635 us_rep)) (forall ((temp___636 Int)) (= (select (temp___633 temp___635) temp___636) temp___635))))
(declare-fun temp___637 (Int) (Array Int character))
(assert (forall ((temp___639 Int)) (forall ((temp___640 Int)) (= (select (temp___637 temp___639) temp___640) (of_rep1 temp___639)))))
(declare-fun temp___641 (Int) (Array Int character))
(assert (forall ((temp___643 Int)) (forall ((temp___644 Int)) (= (select (temp___641 temp___643) temp___644) (of_rep1 temp___643)))))
...
(define-fun dynamic_invariant1 ((temp___expr_314 Int) (temp___is_init_311 Bool) (temp___skip_constant_312 Bool) (temp___do_toplevel_313 Bool)) Bool (=> (or (= temp___is_init_311 true) (<= 0 5)) (in_range1 temp___expr_314)))
...
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= (temp___637 32) o2))
(assert (= o3 o1))
(assert (= o4 o2))
(assert (= o5 (temp___633 (mk___rep (mk___split_fields o3 o4)))))
(assert (= result x))
(assert (= x1 o5))
(declare-const n Int)
(assert (<= 1 n))
(assert (<= n 1000))
(assert (not (= (bool_eq1 (select x1 n) (mk___rep (mk___split_fields (of_rep 0) (temp___641 32)))) true)))
(check-sat)
(exit)
