...
(declare-fun temp_____aggregate_def_682 (us_rep) (Array Int us_rep))
(declare-fun temp_____aggregate_def_686 (Int) (Array Int character))
(declare-fun temp_____aggregate_def_690 (Int) (Array Int character))
...
(assert (forall ((temp___684 us_rep)) (forall ((temp___685 Int)) (= (select (temp_____aggregate_def_682 temp___684) temp___685) temp___684))))
(assert (forall ((temp___688 Int)) (=> (dynamic_invariant temp___688 true true true true) (forall ((temp___689 Int)) (= (to_rep1 (select (temp_____aggregate_def_686 temp___688) temp___689)) temp___688)))))
(assert (forall ((temp___692 Int)) (=> (dynamic_invariant temp___692 true true true true) (forall ((temp___693 Int)) (= (to_rep1 (select (temp_____aggregate_def_690 temp___692) temp___693)) temp___692)))))
...
(assert (= result x))
(assert (= x1 (temp_____aggregate_def_682 (mk___rep (mk___split_fields rliteral (temp_____aggregate_def_686 32))))))
(declare-const n Int)
(assert (<= 1 n))
(assert (<= n 1000))
(assert (not (= (bool_eq1 (select x1 n) (mk___rep (mk___split_fields rliteral (temp_____aggregate_def_690 32)))) true)))
(check-sat)
(exit)
