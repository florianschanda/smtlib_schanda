...
(declare-fun temp___682 (us_rep) (Array Int us_rep))
(declare-fun temp___686 (Int) (Array Int character))
(declare-fun temp___690 (Int) (Array Int character))
...
(assert (forall ((temp___684 us_rep)) (forall ((temp___685 Int)) (= (select (temp___682 temp___684) temp___685) temp___684))))
(assert (forall ((temp___688 Int)) (=> (dynamic_invariant temp___688 true true true true) (forall ((temp___689 Int)) (= (to_rep1 (select (temp___686 temp___688) temp___689)) temp___688)))))
(assert (forall ((temp___692 Int)) (=> (dynamic_invariant temp___692 true true true true) (forall ((temp___693 Int)) (= (to_rep1 (select (temp___690 temp___692) temp___693)) temp___692)))))
...
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= (temp___686 32) o2))
(assert (= o3 o1))
(assert (= o4 o2))
(assert (= o5 (temp___682 (mk___rep (mk___split_fields o3 o4)))))
(assert (= result x))
(assert (= x1 o5))
(declare-const n Int)
(assert (<= 1 n))
(assert (<= n 1000))
(assert (not (= (bool_eq1 (select x1 n) (mk___rep (mk___split_fields (of_rep 0) (temp___690 32)))) true)))
(check-sat)
(exit)
