...
(define-fun default_initial_assumption ((temp___expr_531 us_rep1) (temp___skip_top_level_532 Bool)) Bool (and (= (attr__constrained temp___expr_531) false) (= (to_rep2 (rec__file_io__read_result__status (us_split_discrs1 temp___expr_531))) 2)))
...
(define-fun dynamic_invariant3 ((temp___expr_726 Int) (temp___is_init_722 Bool) (temp___skip_constant_723 Bool) (temp___do_toplevel_724 Bool) (temp___do_typ_inv_725 Bool)) Bool (=> (or (= temp___is_init_722 true) (<= 0 2147483647)) (in_range6 temp___expr_726)))
...
(declare-fun invariant__1 (us_private us_split_fields us_split_discrs us_split_fields us_split_discrs) Bool)
(declare-fun invariant____function_guard1 (Bool us_private us_split_fields us_split_discrs us_split_fields us_split_discrs) Bool)
...
(assert true)
(assert (forall ((names__name_table us_private)) (forall ((lexer__current_read__fields us_split_fields) (lexer__next_read__fields us_split_fields)) (forall ((lexer__current_read__discrs us_split_discrs) (lexer__next_read__discrs us_split_discrs)) (! (= (= (invariant__1 names__name_table lexer__current_read__fields lexer__current_read__discrs lexer__next_read__fields lexer__next_read__discrs) true) (and (= (invariant__ names__name_table) true) (= (local_invariant lexer__current_read__fields lexer__current_read__discrs lexer__next_read__fields lexer__next_read__discrs) true))) :pattern ((invariant__1 names__name_table lexer__current_read__fields lexer__current_read__discrs lexer__next_read__fields lexer__next_read__discrs)))))))
...
(define-fun dynamic_invariant6 ((temp___expr_522 Int) (temp___is_init_518 Bool) (temp___skip_constant_519 Bool) (temp___do_toplevel_520 Bool) (temp___do_typ_inv_521 Bool)) Bool (=> (or (= temp___is_init_518 true) (<= 0 2)) (in_range5 temp___expr_522)))
...
(declare-const the_filename2 int__ref)
(declare-const the_file1 file__ref)
(declare-const current_read__split_fields1 us_split_fields__ref)
(declare-const current_read__split_discrs1 us_split_discrs__ref)
(declare-const current_line3 int__ref)
(declare-const current_col3 int__ref)
(declare-const current_pos3 int__ref)
(declare-const next_read__split_fields1 us_split_fields__ref)
(declare-const next_read__split_discrs1 us_split_discrs__ref)
(declare-const name_table2 us_private__ref)
(declare-const the_filename3 Int)
...
(declare-const current_pos4 Int)
...
(define-fun next_read__split_discrs3 () us_split_discrs (mk___split_discrs next_read__split_discrs))
(define-fun next_read__split_fields3 () us_split_fields (mk___split_fields next_read__split_fields))
(define-fun current_read__split_discrs3 () us_split_discrs (mk___split_discrs current_read__split_discrs))
(define-fun current_read__split_fields3 () us_split_fields (mk___split_fields current_read__split_fields))
...
(assert (=> (<= 0 2147483647) (in_range1 current_pos)))
...
(assert (= (mk_int__ref result) (mk_int__ref current_line)))
(assert (= current_line1 1))
(assert (= (mk_int__ref result1) (mk_int__ref current_col)))
(assert (= current_col1 0))
(assert (= (mk_int__ref result2) (mk_int__ref current_pos)))
(assert (= current_pos1 0))
(assert (and (<= current_pos1 current_pos2) (and (and (in_range2 current_line2) (in_range1 current_col2)) (in_range1 current_pos2))))
(assert (= name_table2 (mk___private__ref name_table1)))
(assert (= next_read__split_discrs1 (mk___split_discrs__ref next_read__split_discrs3)))
(assert (= next_read__split_fields1 (mk___split_fields__ref next_read__split_fields3)))
(assert (= current_pos3 (mk_int__ref current_pos2)))
(assert (= current_col3 (mk_int__ref current_col2)))
(assert (= current_line3 (mk_int__ref current_line2)))
(assert (= current_read__split_discrs1 (mk___split_discrs__ref current_read__split_discrs3)))
(assert (= current_read__split_fields1 (mk___split_fields__ref current_read__split_fields3)))
(assert (= the_file1 (mk_file__ref the_file)))
(assert (= the_filename2 (mk_int__ref the_filename1)))
(assert (= name_table3 name_table1))
(assert (= next_read__split_discrs2 next_read__split_discrs3))
(assert (= next_read__split_fields2 next_read__split_fields3))
(assert (= current_pos4 current_pos2))
(assert (= current_col4 current_col2))
(assert (= current_line4 current_line2))
(assert (= current_read__split_discrs2 current_read__split_discrs3))
(assert (= current_read__split_fields2 current_read__split_fields3))
(assert (= the_file2 the_file))
(assert (= the_filename3 the_filename1))
(assert (not (= (invariant__1 (us_private__content name_table2) (us_split_fields__content current_read__split_fields1) (us_split_discrs__content current_read__split_discrs1) (us_split_fields__content next_read__split_fields1) (us_split_discrs__content next_read__split_discrs1)) true)))
(check-sat)
(exit)
