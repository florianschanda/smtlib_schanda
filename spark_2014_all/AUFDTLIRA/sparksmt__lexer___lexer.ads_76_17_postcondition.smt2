...
(define-fun default_initial_assumption ((temp___expr_463 us_rep1) (temp___skip_top_level_464 Bool)) Bool (and (= (attr__constrained temp___expr_463) false) (= (to_rep2 (rec__file_io__read_result__status (us_split_discrs1 temp___expr_463))) 2)))
...
(define-fun dynamic_invariant3 ((temp___expr_645 Int) (temp___is_init_642 Bool) (temp___skip_constant_643 Bool) (temp___do_toplevel_644 Bool)) Bool (=> (or (= temp___is_init_642 true) (<= 0 2147483647)) (in_range6 temp___expr_645)))
...
(define-fun dynamic_invariant6 ((temp___expr_455 Int) (temp___is_init_452 Bool) (temp___skip_constant_453 Bool) (temp___do_toplevel_454 Bool)) Bool (=> (or (= temp___is_init_452 true) (<= 0 2)) (in_range5 temp___expr_455)))
...
(assert (and (and (and (not (= current_read__attr__constrained true)) (not (= next_read__attr__constrained true))) (and (and (= (invariant__ name_table1) true) (in_range6 the_filename1)) (and (and (= (mk_int__ref result) (mk_int__ref current_line)) (= current_line1 1)) (and (and (= (mk_int__ref result1) (mk_int__ref current_col)) (= current_col1 0)) (and (and (= (mk_int__ref result2) (mk_int__ref current_pos)) (= current_pos1 0)) (and (<= current_pos1 current_pos2) (and (and (in_range2 current_line2) (in_range1 current_col2)) (in_range1 current_pos2)))))))) (and (and (= name_table2 (mk___private__ref name_table1)) (and (= next_read__split_discrs1 (mk___split_discrs__ref (mk___split_discrs next_read__split_discrs))) (and (= next_read__split_fields1 (mk___split_fields__ref (mk___split_fields next_read__split_fields))) (and (= current_pos3 (mk_int__ref current_pos2)) (and (= current_col3 (mk_int__ref current_col2)) (and (= current_line3 (mk_int__ref current_line2)) (and (= current_read__split_discrs1 (mk___split_discrs__ref (mk___split_discrs current_read__split_discrs))) (and (= current_read__split_fields1 (mk___split_fields__ref (mk___split_fields current_read__split_fields))) (and (= the_file1 (mk_file__ref the_file)) (= the_filename2 (mk_int__ref the_filename1))))))))))) (and (= name_table3 name_table1) (and (= next_read__split_discrs2 (mk___split_discrs next_read__split_discrs)) (and (= next_read__split_fields2 (mk___split_fields next_read__split_fields)) (and (= current_pos4 current_pos2) (and (= current_col4 current_col2) (and (= current_line4 current_line2) (and (= current_read__split_discrs2 (mk___split_discrs current_read__split_discrs)) (and (= current_read__split_fields2 (mk___split_fields current_read__split_fields)) (and (= the_file2 the_file) (= the_filename3 the_filename1)))))))))))))
