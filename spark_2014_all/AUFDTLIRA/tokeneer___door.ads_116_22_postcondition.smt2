...
(assert (and (and (and (= (and (and (= currentdoor1 0) (= (islocked (us_private__content state1)) true)) (= (greaterthanorequal (thecurrenttime currenttime) (mk___rep (mk___split_fields alarmtimeout__split_fields alarmtimeout__split_fields1 alarmtimeout__split_fields2 alarmtimeout__split_fields3))) true)) (= dooralarm1 0)) (= (= (islocked (us_private__content state1)) true) (= (greaterthanorequal (thecurrenttime currenttime) (latch_timeout (us_private__content state1))) true))) (< (to_int1 (islocked state)) (to_int1 (ite (= (ite (= (= (current_latch (us_private__content state1)) (current_latch state)) true) (bool_eq2 (latch_timeout (us_private__content state1)) (latch_timeout state)) false) true) (islocked (us_private__content state1)) false)))) (= (bool_eq2 (latch_timeout (us_private__content state1)) (latch_timeout state)) true)))
(assert (and (in_range12 currentdoor1) (in_range4 dooralarm1)))
(assert (= (islocked (us_private__content state1)) true))
(assert (= (thecurrentdoor currentdoor1) 0))
