...
(assert (and (= o10 (remove a o9)) (and (dynamic_invariant2 o10 true false true true) (and (= (invariant__ o10) true) (and (= (to_rep2 (last (rt o10))) (- (to_rep2 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o9 1))) (= (to_rep (select (elts a) k)) (to_rep (select (elts o10) k))))) (and (forall ((k Int)) (=> (and (<= (+ o9 1) k) (<= k (to_rep2 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select (elts o10) (- k 1)))))) (forall ((k Int)) (=> (and (<= o9 k) (<= k (- (to_rep2 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select (elts o10) k))))))))))))
(assert (and (= o11 (remove o10 (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))))) (and (dynamic_invariant2 o11 true false true true) (and (= (invariant__ o11) true) (and (= (to_rep2 (last (rt o11))) (- (to_rep2 (last (rt o10))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) 1))) (= (to_rep (select (elts o10) k)) (to_rep (select (elts o11) k))))) (and (forall ((k Int)) (=> (and (<= (+ (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) 1) k) (<= k (to_rep2 (last (rt o10))))) (= (to_rep (select (elts o10) k)) (to_rep (select (elts o11) (- k 1)))))) (forall ((k Int)) (=> (and (<= (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) k) (<= k (- (to_rep2 (last (rt o10))) 1))) (= (to_rep (select (elts o10) (+ k 1))) (to_rep (select (elts o11) k))))))))))))
(assert (and (= o8 (remove bb ib1)) (and (dynamic_invariant2 o8 true false true true) (and (= (invariant__ o8) true) (and (= (to_rep2 (last (rt o8))) (- (to_rep2 (last (rt bb))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib1 1))) (= (to_rep (select (elts bb) k)) (to_rep (select (elts o8) k))))) (and (forall ((k Int)) (=> (and (<= (+ ib1 1) k) (<= k (to_rep2 (last (rt bb))))) (= (to_rep (select (elts bb) k)) (to_rep (select (elts o8) (- k 1)))))) (forall ((k Int)) (=> (and (<= ib1 k) (<= k (- (to_rep2 (last (rt bb))) 1))) (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select (elts o8) k))))))))))))
