...
(assert (not (= k2 last3)))
(assert (and (= o33 (+ k2 1)) (in_range1 (+ k2 1))))
...
(assert (= (to_rep o52) c239b3))
(assert (= (rec__frame_condition__cell__value (us_split_fields1 (select a2 c238b3))) o53))
(assert (= o52 o54))
(assert (= (rec__frame_condition__cell__max_right (us_split_fields1 (select a2 c238b3))) o55))
...
(assert (= a3 o58))
(assert (not (= (frame_left (mk___t a (mk (to_rep1 a__first) (to_rep1 a__last))) a3) true)))
(check-sat)
(exit)
