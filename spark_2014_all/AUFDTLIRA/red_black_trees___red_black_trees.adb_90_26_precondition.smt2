...
(assert (and (= o26 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i 0)) (and (in_range3 o26) (= o26 (peek1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) i 0)))))
(assert (= (mk___rep5 (mk___split_fields5 o27 o28 o29)) (select res2 o26)))
(assert (= o30 (mk___split_fields5 o27 o28 o29)))
(assert (= o31 (rec__red_black_trees__black_count__count o30)))
(assert (= o32 (to_rep o31)))
(assert (=> (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) i)) 0) (= o33 1)))
(assert (=> (not (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) i)) 0)) (= o33 0)))
(assert (= o34 (+ o33 o32)))
(assert (and (= o35 o34) (in_range1 o34)))
(assert (= o36 (ite (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res2 i)))) o35) true false)))
(assert (and (= o17 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i 1)) (and (in_range3 o17) (= o17 (peek1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) i 1)))))
