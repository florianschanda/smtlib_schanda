...
(assert (<= 0 x1))
(assert (<= x1 3))
(assert (and (forall ((temp___757 Int)) (=> (and (<= 1 temp___757) (<= temp___757 50)) (=> (not (= (+ (to_rep3 cur_piece__split_fields3) y2) temp___757)) (= (select cur_board1 temp___757) (select cur_board temp___757))))) (and (<= 0 x2) (<= x2 3))))
