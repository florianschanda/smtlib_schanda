...
(define-fun dynamic_invariant1 ((temp___expr_309 us_t1) (temp___is_init_306 Bool) (temp___skip_constant_307 Bool) (temp___do_toplevel_308 Bool)) Bool (and (=> (not (= temp___skip_constant_307 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_309) (last3 temp___expr_309))) (=> (= temp___do_toplevel_308 true) (=> (= temp___is_init_306 true) (and (= (first1 (of_array (to_array1 temp___expr_309) (first3 temp___expr_309) (last3 temp___expr_309))) 1) (<= (last3 temp___expr_309) 1000))))))
(define-fun dynamic_predicate ((temp___313 us_t1)) Bool (and (= (first1 (of_array (to_array1 temp___313) (first3 temp___313) (last3 temp___313))) 1) (<= (last3 temp___313) 1000)))
...
(define-fun dynamic_invariant2 ((temp___expr_1406 Int) (temp___is_init_1403 Bool) (temp___skip_constant_1404 Bool) (temp___do_toplevel_1405 Bool)) Bool (=> (or (= temp___is_init_1403 true) (<= 0 20)) (in_range5 temp___expr_1406)))
(declare-fun getresponsecode (Int) Int)
(declare-fun getresponsecode__function_guard (Int Int) Bool)
(assert (forall ((responsecode Int)) (! (=> (dynamic_invariant responsecode true true true) (dynamic_invariant2 (getresponsecode responsecode) true false true)) :pattern ((getresponsecode responsecode)))))
(assert (forall ((responsecode Int)) (! (=> (dynamic_invariant responsecode true true true) (= (getresponsecode responsecode) (ite (and (<= 0 responsecode) (<= responsecode 20)) responsecode 20))) :pattern ((getresponsecode responsecode)))))
...
(define-fun dynamic_invariant6 ((temp___expr_287 us_t) (temp___is_init_284 Bool) (temp___skip_constant_285 Bool) (temp___do_toplevel_286 Bool)) Bool (and (=> (not (= temp___skip_constant_285 true)) (dynamic_property 1 2147483647 (first1 temp___expr_287) (last1 temp___expr_287))) (=> (= temp___do_toplevel_286 true) (=> (= temp___is_init_284 true) (= (first1 temp___expr_287) 1)))))
(define-fun dynamic_predicate1 ((temp___290 us_t)) Bool (= (first1 temp___290) 1))
(assert (not true))
(check-sat)
(exit)
