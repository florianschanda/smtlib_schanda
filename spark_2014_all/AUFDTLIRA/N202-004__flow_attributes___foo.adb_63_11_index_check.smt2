...
(declare-fun temp___300 (Int Int Int) us_t1)
...
(assert (forall ((temp___302 Int) (temp___303 Int) (temp___304 Int)) (let ((temp___301 (temp___300 temp___302 temp___303 temp___304))) (=> (dynamic_invariant1 temp___302 true true true true) (and (=> (dynamic_property 1 2147483647 temp___303 temp___304) (and (= (first3 temp___301) temp___303) (= (last3 temp___301) temp___304))) (forall ((temp___305 Int)) (= (to_rep (select (to_array1 temp___301) temp___305)) temp___302)))))))
(declare-const a (Array Int character))
(declare-const temp___307 (Array Int character))
(declare-const temp___3071 t1)
(declare-const temp___308 (Array Int character))
(declare-const temp___3081 t)
(declare-const temp___309 (Array Int character))
(declare-const temp___3091 t)
...
(assert (= (to_rep1 (first2 (rt1 (temp___300 32 (to_rep1 a__first) (to_rep1 a__last))))) (to_rep1 a__first)))
(assert (= (to_rep1 (last2 (rt1 (temp___300 32 (to_rep1 a__first) (to_rep1 a__last))))) (to_rep1 a__last)))
(assert (= (mk___t1 temp___307 temp___3071) (temp___300 32 (to_rep1 a__first) (to_rep1 a__last))))
(assert (= temp___307 temp___308))
(assert (= (mk (to_rep1 (first2 temp___3071)) (to_rep1 (last2 temp___3071))) temp___3081))
(assert (= (ite (<= (to_rep1 (first temp___3081)) (to_rep1 (last temp___3081))) (+ (- (to_rep1 (last temp___3081)) (to_rep1 (first temp___3081))) 1) 0) (ite (<= (to_rep1 a__first) (to_rep1 a__last)) (+ (- (to_rep1 a__last) (to_rep1 a__first)) 1) 0)))
(assert (= (mk___t temp___309 temp___3091) (mk___t temp___308 temp___3081)))
(assert (= o (slide temp___309 (to_rep1 (first temp___3091)) (to_rep1 a__first))))
(assert (= result a))
(assert (= a1 o))
(assert (= (to_rep o1) 120))
