...
(assert (= (to_rep1 (first2 (rt1 (temp___265 32 (to_rep1 a__first) (to_rep1 a__last))))) (to_rep1 a__first)))
(assert (= (to_rep1 (last2 (rt1 (temp___265 32 (to_rep1 a__first) (to_rep1 a__last))))) (to_rep1 a__last)))
(assert (= (mk___t1 temp___272 temp___2721) (temp___265 32 (to_rep1 a__first) (to_rep1 a__last))))
(assert (= temp___272 temp___273))
(assert (= (mk (to_rep1 (first2 temp___2721)) (to_rep1 (last2 temp___2721))) temp___2731))
(assert (= (ite (<= (to_rep1 (first temp___2731)) (to_rep1 (last temp___2731))) (+ (- (to_rep1 (last temp___2731)) (to_rep1 (first temp___2731))) 1) 0) (ite (<= (to_rep1 a__first) (to_rep1 a__last)) (+ (- (to_rep1 a__last) (to_rep1 a__first)) 1) 0)))
(assert (= (mk___t temp___274 temp___2741) (mk___t temp___273 temp___2731)))
(assert (= o (slide temp___274 (to_rep1 (first temp___2741)) (to_rep1 a__first))))
(assert (= result a))
(assert (= a1 o))
