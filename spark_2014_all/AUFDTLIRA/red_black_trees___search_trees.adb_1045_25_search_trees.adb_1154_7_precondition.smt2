...
(assert (and (= temp___1054 (model__ (rec__search_trees__search_tree__struct t__split_fields9) x1)) (and (dynamic_invariant6 temp___1054 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1054 x1))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1054 x1)))) 0) (and (forall ((i6 Int)) (=> (and (<= 1 i6) (<= i6 100)) (=> (not (= i6 x1)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct t__split_fields9) i6) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1054 (parent (rec__search_trees__search_tree__struct t__split_fields9) i6)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1054 i6))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1054 i6))) true)))))) (and (forall ((i6 Int)) (=> (and (<= 1 i6) (<= i6 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1054 i6))) true) (not (= i6 x1))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1054 (parent (rec__search_trees__search_tree__struct t__split_fields9) i6)))) (position (rec__search_trees__search_tree__struct t__split_fields9) i6) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1054 i6)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1054 i6)))) 0)))) (forall ((i6 Int)) (=> (and (<= 1 i6) (<= i6 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1054 i6))) true) (forall ((j15 Int)) (=> (and (<= 1 j15) (<= j15 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1054 j15))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1054 i6))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1054 j15)))) true)) (= j15 i6))))))))))))))
(assert (= o31 (select temp___1054 y1)))
