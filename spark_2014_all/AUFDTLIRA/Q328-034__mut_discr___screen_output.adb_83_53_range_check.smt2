...
(assert (and (= o16 (current_line line last_char)) (dynamic_invariant2 o16 true false true true)))
(assert (= (- pos2 1) r14b))
...
(assert (=> (= (length temp___6832) 0) (= (temp___String_Literal_682 Tuple0) temp___685)))
(assert (=> (= (length temp___6832) 0) (= (mk 1 2) temp___6851)))
(assert (=> (not (= (length temp___6832) 0)) (=> (<= 1 2) (= o5 (+ (- 2 1) 1)))))
(assert (=> (not (= (length temp___6832) 0)) (=> (not (<= 1 2)) (= o5 0))))
(assert (=> (not (= (length temp___6832) 0)) (=> (<= (to_rep1 (first temp___6831)) (to_rep1 (last temp___6831))) (= o6 (+ (- (to_rep1 (last temp___6831)) (to_rep1 (first temp___6831))) 1)))))
(assert (=> (not (= (length temp___6832) 0)) (=> (not (<= (to_rep1 (first temp___6831)) (to_rep1 (last temp___6831)))) (= o6 0))))
(assert (=> (not (= (length temp___6832) 0)) (= o7 (+ o6 o5))))
(assert (=> (not (= (length temp___6832) 0)) (= o8 (+ (to_rep1 (first temp___6831)) o7))))
(assert (=> (not (= (length temp___6832) 0)) (= o9 (- o8 1))))
(assert (=> (not (= (length temp___6832) 0)) (and (= o10 o9) (in_range2 o9))))
(assert (=> (not (= (length temp___6832) 0)) (= (concat1 temp___683 (to_rep1 (first temp___6831)) (to_rep1 (last temp___6831)) (temp___String_Literal_682 Tuple0) 1 2) temp___685)))
(assert (=> (not (= (length temp___6832) 0)) (= (mk (to_rep1 (first temp___6831)) o10) temp___6851)))
(assert (not (= (length (mk___t temp___685 temp___6851)) 0)))
...
(assert (=> (<= (to_rep1 (first temp___6851)) (to_rep1 (last temp___6851))) (= o12 (+ (- (to_rep1 (last temp___6851)) (to_rep1 (first temp___6851))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___6851)) (to_rep1 (last temp___6851)))) (= o12 0)))
(assert (= o13 (+ o12 o11)))
(assert (= o14 (+ (to_rep1 (first temp___6851)) o13)))
(assert (= o15 (- o14 1)))
