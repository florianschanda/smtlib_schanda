...
(assert (and (= temp___768 (model__ (rec__search_trees__search_tree__struct t__split_fields5) o12)) (and (dynamic_invariant9 temp___768 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___768 o12))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___768 o12)))) 0) (and (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (not (= i5 o12)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct t__split_fields5) i5) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___768 (parent (rec__search_trees__search_tree__struct t__split_fields5) i5)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___768 i5))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___768 i5))) true)))))) (and (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___768 i5))) true) (not (= i5 o12))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___768 (parent (rec__search_trees__search_tree__struct t__split_fields5) i5)))) (position (rec__search_trees__search_tree__struct t__split_fields5) i5) (rec__tree_model__path_type__a (us_split_fields1 (select temp___768 i5)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___768 i5)))) 0)))) (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___768 i5))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___768 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___768 i5))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___768 j)))) true)) (= j i5))))))))))))))
(assert (= o13 (select temp___768 i1)))
