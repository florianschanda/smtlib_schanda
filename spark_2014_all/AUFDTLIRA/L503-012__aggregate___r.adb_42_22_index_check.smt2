...
(assert (forall ((temp___291 (Array Int int5))) (forall ((temp___292 Int)) (= (select (temp___289 temp___291) temp___292) temp___291))))
(declare-fun temp___293 (Int Int) (Array Int int5))
(assert (forall ((temp___295 Int) (temp___296 Int)) (let ((temp___294 (temp___293 temp___295 temp___296))) (forall ((temp___297 Int)) (ite (= temp___297 3) (= (select temp___294 temp___297) (of_rep temp___295)) (= (select temp___294 temp___297) (of_rep temp___296)))))))
...
(declare-const i Int)
(declare-const o Int)
(declare-const temp___288 (Array Int int5))
