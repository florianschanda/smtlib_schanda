...
(declare-fun temp___326 ((Array Int int5)) (Array Int (Array Int int5)))
(declare-fun temp___330 (Int Int) (Array Int int5))
...
(assert (forall ((temp___328 (Array Int int5))) (forall ((temp___329 Int)) (= (select (temp___326 temp___328) temp___329) temp___328))))
(assert (forall ((temp___332 Int) (temp___333 Int)) (let ((temp___331 (temp___330 temp___332 temp___333))) (=> (and (dynamic_invariant2 temp___332 true true true true) (dynamic_invariant2 temp___333 true true true true)) (forall ((temp___334 Int)) (ite (= temp___334 3) (= (to_rep (select temp___331 temp___334)) temp___332) (= (to_rep (select temp___331 temp___334)) temp___333)))))))
(assert (in_range1 n))
(assert (and (<= 3 n) (<= n 4)))
(assert (not (<= 3 n)))
(check-sat)
