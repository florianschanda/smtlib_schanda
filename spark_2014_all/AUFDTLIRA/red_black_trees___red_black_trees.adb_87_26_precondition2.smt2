...
(assert (and (= o31 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i 0)) (and (in_range2 o31) (= o31 (peek1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) i 0)))))
(assert (= (mk___rep5 (mk___split_fields5 o32 o33 o34)) (select res2 o31)))
(assert (= o32 o35))
(assert (= o33 o36))
(assert (= o34 o37))
(assert (= o38 o37))
(assert (= o39 (to_rep o38)))
(assert (=> (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) i)) 0) (= o40 1)))
(assert (=> (not (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) i)) 0)) (= o40 0)))
(assert (= o41 (+ o40 o39)))
(assert (and (= o42 o41) (in_range7 o41)))
(assert (= o43 (ite (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res2 i)))) o42) true false)))
(assert (and (= o17 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i 1)) (and (in_range2 o17) (= o17 (peek1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) i 1)))))
...
(assert (and (= o9 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i 0)) (and (in_range2 o9) (= o9 (peek1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) i 0)))))
(assert (= (mk___rep5 (mk___split_fields5 o10 o11 o12)) (select res2 o9)))
(assert (= o10 o13))
(assert (= o11 o14))
(assert (= o12 o15))
(assert (= o16 o14))
(assert (= o26 (to_rep o16)))
(assert (= o27 (ite (< o26 o25) o25 o26)))
(assert (= o28 (+ 1 o27)))
(assert (and (= o29 o28) (in_range7 o28)))
(assert (= o30 (ite (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 i)))) o29) true false)))
(assert (and (= o (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i 1)) (and (in_range2 o) (= o (peek1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) i 1)))))
