...
(declare-const temp___2722 (Array Int natural))
(declare-const temp___2723 t2)
...
(assert (=> (not (= smallest1 current1)) (and (and (and (= (is_perm (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last))) (mk___t o12 (mk (to_rep1 values__first) (to_rep1 values__last)))) true) (= (to_rep (select o12 o8)) (to_rep (select values smallest1)))) (= (to_rep (select o12 smallest1)) (to_rep (select values o8)))) (forall ((z Int)) (=> (and (<= (to_rep1 values__first) z) (<= z (to_rep1 values__last))) (=> (and (not (= z o8)) (not (= z smallest1))) (= (to_rep (select o12 z)) (to_rep (select values z)))))))))
(assert (=> (not (not (= smallest1 current1))) (= previous2 previous)))
(assert (=> (not (not (= smallest1 current1))) (= o12 values)))
(assert (=> (not (not (= smallest1 current1))) (= previous2 previous1)))
(assert (=> (not (not (= smallest1 current1))) (= o12 values1)))
(assert (forall ((i Int)) (=> (and (<= (to_rep1 values__first) i) (<= i current2)) (forall ((j Int)) (=> (and (<= (+ i 1) j) (<= j (to_rep1 values__last))) (<= (to_rep (select values2 i)) (to_rep (select values2 j))))))))
...
(assert (not (= current2 temp___270)))
...
(assert (= o9 values2))
(assert (= o9 temp___2722))
(assert (= (mk2 current3 (to_rep1 values__last)) temp___2723))
(assert (= temp___2722 o10))
(assert (= (mk (to_rep1 (first4 temp___2723)) (to_rep1 (last4 temp___2723))) o11))
(assert (not (< 0 (length (mk___t o10 o11)))))
(check-sat)
(exit)
