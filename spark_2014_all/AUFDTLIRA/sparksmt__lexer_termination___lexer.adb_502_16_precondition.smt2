...
(assert (= o7 (concat1 (temp___String_Literal_849 Tuple0) 1 19 o1 1 1)))
(assert (= temp___852 (mk___t o7 (mk 1 o6))))
(assert (=> (= (length temp___852) 0) (= o14 (mk___t (temp___String_Literal_851 Tuple0) (mk 1 1)))))
(assert (=> (not (= (length temp___852) 0)) (=> (<= 1 1) (= o8 (+ (- 1 1) 1)))))
(assert (=> (not (= (length temp___852) 0)) (=> (not (<= 1 1)) (= o8 0))))
(assert (=> (not (= (length temp___852) 0)) (=> (<= (to_rep1 (first (rt temp___852))) (to_rep1 (last (rt temp___852)))) (= o9 (+ (- (to_rep1 (last (rt temp___852))) (to_rep1 (first (rt temp___852)))) 1)))))
(assert (=> (not (= (length temp___852) 0)) (=> (not (<= (to_rep1 (first (rt temp___852))) (to_rep1 (last (rt temp___852))))) (= o9 0))))
(assert (=> (not (= (length temp___852) 0)) (= o10 (+ o9 o8))))
(assert (=> (not (= (length temp___852) 0)) (= o11 (+ (to_rep1 (first (rt temp___852))) o10))))
(assert (=> (not (= (length temp___852) 0)) (= o12 (- o11 1))))
(assert (=> (not (= (length temp___852) 0)) (and (= o13 o12) (in_range2 o12))))
(assert (=> (not (= (length temp___852) 0)) (= o14 (mk___t (concat1 (elts temp___852) (to_rep1 (first (rt temp___852))) (to_rep1 (last (rt temp___852))) (temp___String_Literal_851 Tuple0) 1 1) (mk (to_rep1 (first (rt temp___852))) o13)))))
