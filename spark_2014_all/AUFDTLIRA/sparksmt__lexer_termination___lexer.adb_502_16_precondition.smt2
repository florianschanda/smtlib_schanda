...
(assert (= result7 (let ((subject c)) (mk_int__ref c2))))
(assert (= (let ((subject c)) c3) (to_rep (rec__file_io__read_result__c current_read__split_fields2))))
(assert (= (length1 (mk___rep1 s__split_discrs s__split_fields3)) 0))
(assert (and (and (and (= (local_invariant the_file3 current_read__split_fields3 current_read__split_discrs3 current_idx3 next_read__split_fields3 next_read__split_discrs3 next_idx3) true) (= (length1 (mk___rep1 s__split_discrs s__split_fields4)) (+ (length1 (mk___rep1 s__split_discrs s__split_fields3)) 1))) (ite (= (to_rep3 (rec__file_io__read_result__status current_read__split_discrs3)) 0) (= current_idx3 (+ current_idx2 1)) (= current_idx3 current_idx2))) (and (and (and (in_range2 current_line3) (in_range4 current_col3)) (in_range4 current_idx3)) (in_range4 next_idx3))))
(assert (not (= (let ((subject c)) c3) 40)))
(assert (not (= (let ((subject c)) c3) 41)))
(assert (not (= (let ((subject c)) c3) 124)))
(assert (not (= (let ((subject c)) c3) 35)))
(assert (not (and (<= 48 (let ((subject c)) c3)) (<= (let ((subject c)) c3) 57))))
(assert (not (and (<= 0 (let ((subject c)) c3)) (<= (let ((subject c)) c3) 255))))
(assert (not (and (<= 0 (let ((subject c)) c3)) (and (<= 0 (let ((subject c)) c3)) (<= (let ((subject c)) c3) 255)))))
(assert (not (and (not (<= 0 (let ((subject c)) c3))) (and (<= 0 (let ((subject c)) c3)) (<= (let ((subject c)) c3) 255)))))
(assert (not (= (let ((subject c)) c3) 34)))
...
(assert (= (to_rep o7) (let ((subject c)) c3)))
(assert (= o8 (singleton1 o7 1)))
(assert (= o14 (concat1 (temp___String_Literal_841 Tuple0) 1 19 o8 1 1)))
(assert (= temp___844 (mk___t o14 (mk 1 o13))))
(assert (=> (= (length temp___844) 0) (= o21 (mk___t (temp___String_Literal_843 Tuple0) (mk 1 1)))))
(assert (=> (not (= (length temp___844) 0)) (=> (<= 1 1) (= o15 (+ (- 1 1) 1)))))
(assert (=> (not (= (length temp___844) 0)) (=> (not (<= 1 1)) (= o15 0))))
(assert (=> (not (= (length temp___844) 0)) (=> (<= (to_rep1 (first (rt temp___844))) (to_rep1 (last (rt temp___844)))) (= o16 (+ (- (to_rep1 (last (rt temp___844))) (to_rep1 (first (rt temp___844)))) 1)))))
(assert (=> (not (= (length temp___844) 0)) (=> (not (<= (to_rep1 (first (rt temp___844))) (to_rep1 (last (rt temp___844))))) (= o16 0))))
(assert (=> (not (= (length temp___844) 0)) (= o17 (+ o16 o15))))
(assert (=> (not (= (length temp___844) 0)) (= o18 (+ (to_rep1 (first (rt temp___844))) o17))))
(assert (=> (not (= (length temp___844) 0)) (= o19 (- o18 1))))
(assert (=> (not (= (length temp___844) 0)) (and (= o20 o19) (in_range2 o19))))
(assert (=> (not (= (length temp___844) 0)) (= o21 (mk___t (concat1 (elts temp___844) (to_rep1 (first (rt temp___844))) (to_rep1 (last (rt temp___844))) (temp___String_Literal_843 Tuple0) 1 1) (mk (to_rep1 (first (rt temp___844))) o20)))))
