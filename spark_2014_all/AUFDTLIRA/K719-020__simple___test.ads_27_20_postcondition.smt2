...
(declare-const temp___2481 Bool)
(declare-const temp___2482 (Array Int integer))
...
(assert (= x__split_fields2 o3))
(assert (= temp___248 o1))
(assert (= temp___2481 o2))
(assert (= temp___2482 o3))
(assert (= result x__split_fields))
(assert (= result1 x__split_fields1))
(assert (= result2 x__split_fields2))
(assert (= temp___248 x__split_fields3))
(assert (= temp___2481 x__split_fields4))
(assert (= temp___2482 x__split_fields5))
...
(assert (not (= (to_rep x__split_fields6) 1)))
(check-sat)
(exit)
