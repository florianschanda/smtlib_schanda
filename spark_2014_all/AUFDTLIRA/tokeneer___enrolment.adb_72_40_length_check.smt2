...
(assert (= o18 temp___1558))
(assert (= (mk3 1 (to_rep1 (last (rt thedesc)))) temp___15581))
(assert (not (= (ite (<= (to_rep1 (first6 temp___15551)) (to_rep1 (last6 temp___15551))) (+ (- (to_rep1 (last6 temp___15551)) (to_rep1 (first6 temp___15551))) 1) 0) (ite (<= (to_rep1 (first6 temp___15581)) (to_rep1 (last6 temp___15581))) (+ (- (to_rep1 (last6 temp___15581)) (to_rep1 (first6 temp___15581))) 1) 0))))
(check-sat)
(exit)
