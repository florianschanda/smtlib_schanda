...
(declare-const trimmed_name3 (Array Int character))
...
(assert (= o11 i2))
(assert (= o12 (store trimmed_name2 o11 o10)))
(assert (= result5 trimmed_name2))
(assert (= trimmed_name3 o12))
(assert (not (= i2 temp___8036)))
(assert (= result6 i2))
(assert (= i3 (+ i2 1)))
(assert (not (<= (+ i3 zone_length1) 129)))
(check-sat)
(exit)
