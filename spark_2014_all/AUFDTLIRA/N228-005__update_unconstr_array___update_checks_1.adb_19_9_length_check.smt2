...
(assert (= o i))
(assert (= (mk___t temp___455 temp___4551) (temp_____aggregate_def_448 (mk___t a (mk (to_rep a__first) (to_rep a__last))) 1 o new_val)))
(assert (not (= (ite (<= (to_rep (first temp___4551)) (to_rep (last temp___4551))) (+ (- (to_rep (last temp___4551)) (to_rep (first temp___4551))) 1) 0) (ite (<= (to_rep a__first) (to_rep a__last)) (+ (- (to_rep a__last) (to_rep a__first)) 1) 0))))
(check-sat)
(exit)
