...
(assert (forall ((temp___274 Int)) (=> (dynamic_invariant temp___274 true true true true) (forall ((temp___275 Int)) (= (to_rep (select (for_loop_iterable__p2__a__aggregate_def temp___274) temp___275)) temp___274)))))
...
(assert (<= 1 c8b1))
(assert (<= c8b1 100))
(assert (and (forall ((temp___277 Int)) (=> (and (<= 1 temp___277) (<= temp___277 100)) (=> (not (= 2 temp___277)) (= (select a2 temp___277) (select a1 temp___277))))) (and (<= 1 c8b2) (<= c8b2 100))))
(assert (= (to_rep o) 1))
