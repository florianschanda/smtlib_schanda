...
(assert (forall ((temp___241 Int)) (forall ((temp___242 Int)) (= (select (for_loop_iterable__p2__a__aggregate_def temp___241) temp___242) (of_rep temp___241)))))
...
(assert (<= 1 c8b1))
(assert (<= c8b1 100))
(assert (and (forall ((temp___244 Int)) (=> (and (<= 1 temp___244) (<= temp___244 100)) (=> (not (= 2 temp___244)) (= (select a2 temp___244) (select a1 temp___244))))) (and (<= 1 c8b2) (<= c8b2 100))))
(assert (= (to_rep o) 1))
