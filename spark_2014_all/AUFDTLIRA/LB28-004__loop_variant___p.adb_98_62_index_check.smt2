...
(assert (=> (<= j45 b) (forall ((l1 Int)) (=> (and (<= a l1) (<= l1 (- j47 1))) (= (to_rep (select tab39 l1)) l1)))))
(assert (=> (<= j45 b) (forall ((l1 Int)) (=> (and (<= a l1) (<= l1 (- (+ a k26) 1))) (= (to_rep (select tab39 l1)) l1)))))
...
(assert (= k32 o38))
(assert (= j54 (+ a k33)))
(assert (forall ((l1 Int)) (=> (and (<= a l1) (<= l1 (- j54 1))) (= (to_rep (select tab45 l1)) l1))))
(assert (forall ((l1 Int)) (=> (and (<= a l1) (<= l1 (- (+ a k33) 1))) (= (to_rep (select tab45 l1)) l1))))
(assert (and (=> (<= (- 2147483648) 2147483647) (in_range1 j54)) (=> (<= (- 2147483648) 2147483647) (in_range1 k33))))
(assert (and (= o39 (- j54 1)) (in_range1 (- j54 1))))
(assert (= o40 (ite (<= l o39) true false)))
(assert (= result47 (ite (<= a l) o40 false)))
(assert (= result47 true))
(assert (not (<= l (to_rep tab__last))))
(check-sat)
(exit)
