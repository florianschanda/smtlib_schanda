...
(assert (and (= o91 (- j75 1)) (in_range1 (- j75 1))))
(assert (= o92 (ite (<= l6 o91) true false)))
(assert (= result71 (ite (<= a l6) o92 false)))
(assert (= result71 true))
(assert (not (<= (to_rep tab__first) l6)))
(check-sat)
(exit)
