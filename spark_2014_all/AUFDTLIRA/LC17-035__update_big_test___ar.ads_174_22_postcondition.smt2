...
(assert (= j4 j1))
(assert (= a4 a2))
(assert (not (or (and (< i 10) (or (and (< 0 e) (= (bool_eq a3 1 10 (temp_____aggregate_def_660 a i e (+ i 1) (- e 1)) 1 10) true)) (and (= e 0) (= (bool_eq a3 1 10 (temp_____aggregate_def_669 a i e (+ i 1) 99) 1 10) true)))) (and (= i 10) (or (and (< 0 e) (= (bool_eq a3 1 10 (temp_____aggregate_def_678 a i e 1 (- e 1)) 1 10) true)) (and (= e 0) (= (bool_eq a3 1 10 (temp_____aggregate_def_687 a i e 1 99) 1 10) true)))))))
(check-sat)
(exit)
