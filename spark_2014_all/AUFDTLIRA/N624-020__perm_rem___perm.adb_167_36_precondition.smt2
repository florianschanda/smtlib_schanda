...
(assert (and (= o2 (remove c (to_rep (rec__perm__witnesses__ia (us_split_fields1 w))))) (and (dynamic_invariant1 o2 true false true) (and (= (invariant__ o2) true) (and (= (to_rep2 (last o1)) (- (to_rep2 (last (rt c))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- (to_rep (rec__perm__witnesses__ia (us_split_fields1 w))) 1))) (= (to_rep1 (select (elts c) k)) (to_rep1 (select o k))))) (and (forall ((k Int)) (=> (and (<= (+ (to_rep (rec__perm__witnesses__ia (us_split_fields1 w))) 1) k) (<= k (to_rep2 (last (rt c))))) (= (to_rep1 (select (elts c) k)) (to_rep1 (select o (- k 1)))))) (forall ((k Int)) (=> (and (<= (to_rep (rec__perm__witnesses__ia (us_split_fields1 w))) k) (<= k (- (to_rep2 (last (rt c))) 1))) (= (to_rep1 (select (elts c) (+ k 1))) (to_rep1 (select o k))))))))))))
