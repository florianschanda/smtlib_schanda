...
(assert (and (= perm__shift_perm_l__induction_hypothesis__B_5__w__assume2 (get_witnesses a b)) (and (and (<= (to_rep2 (first (rt a))) (to_rep perm__shift_perm_l__induction_hypothesis__B_5__w__assume)) (<= (to_rep perm__shift_perm_l__induction_hypothesis__B_5__w__assume) (to_rep2 (last (rt a))))) (and (and (<= (to_rep2 (first (rt b))) (to_rep perm__shift_perm_l__induction_hypothesis__B_5__w__assume1)) (<= (to_rep perm__shift_perm_l__induction_hypothesis__B_5__w__assume1) (to_rep2 (last (rt b))))) (and (= (to_rep1 (select (elts a) (to_rep perm__shift_perm_l__induction_hypothesis__B_5__w__assume))) (to_rep1 (select (elts b) (to_rep perm__shift_perm_l__induction_hypothesis__B_5__w__assume1)))) (= (is_perm (remove a (to_rep perm__shift_perm_l__induction_hypothesis__B_5__w__assume)) (remove b (to_rep perm__shift_perm_l__induction_hypothesis__B_5__w__assume1))) true))))))
(assert (= perm__shift_perm_l__induction_hypothesis__B_5__w__assume2 w))
(assert (and (= o2 (remove c (to_rep (rec__perm__witnesses__ia (us_split_fields1 w))))) (and (dynamic_invariant1 o2 true false true true) (and (= (invariant__ o2) true) (and (= (to_rep2 (last o1)) (- (to_rep2 (last (rt c))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- (to_rep (rec__perm__witnesses__ia (us_split_fields1 w))) 1))) (= (to_rep1 (select (elts c) k)) (to_rep1 (select o k))))) (and (forall ((k Int)) (=> (and (<= (+ (to_rep (rec__perm__witnesses__ia (us_split_fields1 w))) 1) k) (<= k (to_rep2 (last (rt c))))) (= (to_rep1 (select (elts c) k)) (to_rep1 (select o (- k 1)))))) (forall ((k Int)) (=> (and (<= (to_rep (rec__perm__witnesses__ia (us_split_fields1 w))) k) (<= k (- (to_rep2 (last (rt c))) 1))) (= (to_rep1 (select (elts c) (+ k 1))) (to_rep1 (select o k))))))))))))
