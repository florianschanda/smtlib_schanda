...
(assert (= temp___859 first_col))
(assert (= temp___858 (mk___rep2 (mk___split_discrs2 t__split_discrs) (mk___split_fields2 t__split_fields t__split_fields1 t__split_fields2 t__split_fields3) t__attr__constrained)))
(assert (= temp___857 (int__content state)))
(assert (= temp___856 the_file))
(assert (= temp___855 first_line))
(assert (= temp___854 (mk___rep (mk___split_discrs next_read__split_discrs) (mk___split_fields next_read__split_fields) next_read__attr__constrained)))
(assert (= temp___853 (mk___rep1 s__split_discrs (mk___split_fields1 s__split_fields))))
(assert (= temp___852 current_pos))
(assert (= temp___851 current_col))
(assert (= temp___850 current_line))
(assert (= temp___849 (int__content first_pos)))
(assert (= temp___848 (int__content c)))
(assert (= temp___847 (mk___rep (mk___split_discrs current_read__split_discrs) (mk___split_fields current_read__split_fields) current_read__attr__constrained)))
...
(assert (and (and (and (and (= (to_rep3 (rec__file_io__read_result__status current_read__split_discrs7)) 0) (=> (in_range12 (let ((subject state)) state21)) (not (let ((temp___871 (let ((subject state)) state21))) (or (and (<= 2 temp___871) (<= temp___871 2)) (and (<= 9 temp___871) (<= temp___871 9))))))) (<= 1 (length1 (mk___rep1 s__split_discrs s__split_fields7)))) (<= (int__content first_pos5) current_pos8)) (=> (or (= (let ((subject state)) state21) 6) (= (let ((subject state)) state21) 7)) (<= 2 (length1 (mk___rep1 s__split_discrs s__split_fields7))))))
