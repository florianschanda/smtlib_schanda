...
(assert (not (= (let ((subject c)) c10) 98)))
(assert (not (= (let ((subject c)) c10) 120)))
(assert (= result15 (let ((subject state)) (mk_int__ref state21))))
(assert (= (let ((subject state)) state29) 7))
