...
(assert (and (<= (to_rep a__first) temp___290) (<= temp___290 (to_rep a__last))))
(assert (= o16 temp___290))
(assert (= o17 (select a2 o16)))
(assert (= o18 (to_rep o17)))
(assert (and (= temp___289 (+ j2 2)) (in_range1 (+ j2 2))))
(assert (not (<= (to_rep a__first) temp___289)))
(check-sat)
(exit)
