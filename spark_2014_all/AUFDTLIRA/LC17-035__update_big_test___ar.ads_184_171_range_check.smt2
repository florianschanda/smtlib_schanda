...
(assert (= a4 a2))
(assert (< i 10))
(assert (=> (< 0 e) (and (= o4 (- e 1)) (in_range1 (- e 1)))))
(assert (=> (< 0 e) (and (= o5 (+ i 1)) (in_range (+ i 1)))))
(assert (=> (< 0 e) (= temp___4436 (temp___700 a i e o5 o4))))
(assert (=> (< 0 e) (= result5 (bool_eq a3 1 10 temp___4436 1 10))))
