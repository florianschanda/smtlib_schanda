...
(assert (= (to_rep o3) (to_rep (select (rec__datebooks__event_record__description_text (us_split_fields7 (select book i2))) j2))))
(assert (not (in_range1 (+ (to_rep1 description__first) (- j2 1)))))
(check-sat)
(exit)
