...
(define-fun dynamic_invariant1 ((temp___expr_153 Int) (temp___is_init_150 Bool) (temp___skip_constant_151 Bool) (temp___do_toplevel_152 Bool)) Bool (=> (or (= temp___is_init_150 true) (<= 0 100)) (in_range1 temp___expr_153)))
(assert true)
...
(define-fun dynamic_invariant2 ((temp___expr_147 Int) (temp___is_init_144 Bool) (temp___skip_constant_145 Bool) (temp___do_toplevel_146 Bool)) Bool (=> (or (= temp___is_init_144 true) (<= 1 100)) (in_range2 temp___expr_147)))
(declare-const the_ptr Int)
(assert (in_range1 the_ptr))
(assert (in_range v))
(assert (not (in_range1 (+ the_ptr 1))))
(check-sat)
(exit)
