...
(assert (forall ((temp___586 (Array Int integer))) (forall ((temp___587 Int) (temp___588 Int)) (let ((temp___585 (temp___584 temp___586 temp___587 temp___588))) (forall ((temp___589 Int)) (ite (= temp___589 temp___587) (= (select temp___585 temp___589) (of_rep temp___588)) (= (select temp___585 temp___589) (select temp___586 temp___589))))))))
(assert (in_range i))
(assert (in_range x))
(assert (not (= (to_rep (select (temp___584 a i x) i)) x)))
(check-sat)
(exit)
