...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_150 us_void_param) 1)) 49) (= (to_rep (select (temp___String_Literal_150 us_void_param) 2)) 50)) (= (to_rep (select (temp___String_Literal_150 us_void_param) 3)) 51)) (= (to_rep (select (temp___String_Literal_150 us_void_param) 4)) 52)) (= (to_rep (select (temp___String_Literal_150 us_void_param) 5)) 53)) (= (to_rep (select (temp___String_Literal_150 us_void_param) 6)) 54)) (= (to_rep (select (temp___String_Literal_150 us_void_param) 7)) 55)) (= (to_rep (select (temp___String_Literal_150 us_void_param) 8)) 56)) (= (to_rep (select (temp___String_Literal_150 us_void_param) 9)) 57)) (= (to_rep (select (temp___String_Literal_150 us_void_param) 10)) 48)) :pattern ((temp___String_Literal_150 us_void_param)))))
(declare-fun temp___String_Literal_151 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_151 us_void_param) 1)) 49) (= (to_rep (select (temp___String_Literal_151 us_void_param) 2)) 50)) (= (to_rep (select (temp___String_Literal_151 us_void_param) 3)) 51)) (= (to_rep (select (temp___String_Literal_151 us_void_param) 4)) 52)) (= (to_rep (select (temp___String_Literal_151 us_void_param) 5)) 53)) (= (to_rep (select (temp___String_Literal_151 us_void_param) 6)) 54)) (= (to_rep (select (temp___String_Literal_151 us_void_param) 7)) 55)) (= (to_rep (select (temp___String_Literal_151 us_void_param) 8)) 56)) (= (to_rep (select (temp___String_Literal_151 us_void_param) 9)) 57)) (= (to_rep (select (temp___String_Literal_151 us_void_param) 10)) 48)) :pattern ((temp___String_Literal_151 us_void_param)))))
(declare-fun temp___String_Literal_153 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_153 us_void_param) 1)) 49) (= (to_rep (select (temp___String_Literal_153 us_void_param) 2)) 50)) (= (to_rep (select (temp___String_Literal_153 us_void_param) 3)) 51)) (= (to_rep (select (temp___String_Literal_153 us_void_param) 4)) 52)) (= (to_rep (select (temp___String_Literal_153 us_void_param) 5)) 53)) (= (to_rep (select (temp___String_Literal_153 us_void_param) 6)) 54)) (= (to_rep (select (temp___String_Literal_153 us_void_param) 7)) 55)) (= (to_rep (select (temp___String_Literal_153 us_void_param) 8)) 56)) (= (to_rep (select (temp___String_Literal_153 us_void_param) 9)) 57)) (= (to_rep (select (temp___String_Literal_153 us_void_param) 10)) 97)) :pattern ((temp___String_Literal_153 us_void_param)))))
(declare-fun temp___String_Literal_155 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (= (to_rep (select (temp___String_Literal_155 us_void_param) 1)) 49) (= (to_rep (select (temp___String_Literal_155 us_void_param) 2)) 50)) (= (to_rep (select (temp___String_Literal_155 us_void_param) 3)) 51)) (= (to_rep (select (temp___String_Literal_155 us_void_param) 4)) 52)) (= (to_rep (select (temp___String_Literal_155 us_void_param) 5)) 53)) :pattern ((temp___String_Literal_155 us_void_param)))))
...
(assert (= y1 (temp___String_Literal_151 Tuple0)))
...
(assert (= z1 (temp___String_Literal_153 Tuple0)))
