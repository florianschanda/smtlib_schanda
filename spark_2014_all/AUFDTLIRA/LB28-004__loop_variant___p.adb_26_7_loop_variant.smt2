...
(assert (= result8 true))
(assert (= (to_rep o9) 0))
(assert (and (= temp___149 (+ j9 k1)) (in_range1 (+ j9 k1))))
(assert (and (<= (to_rep tab__first) temp___149) (<= temp___149 (to_rep tab__last))))
(assert (= o10 temp___149))
(assert (= o11 (store (map__content tab7) o10 o9)))
(assert (= result9 tab7))
(assert (= tab9 o11))
(assert (=> (< j9 100) (and (= o12 (+ j9 1)) (in_range1 (+ j9 1)))))
(assert (=> (< j9 100) (= result10 (mk_int__ref j9))))
(assert (=> (< j9 100) (= j10 o12)))
(assert (=> (< j9 100) (= k3 (mk_int__ref k1))))
(assert (=> (< j9 100) (= j11 (mk_int__ref j10))))
(assert (=> (< j9 100) (= k4 k1)))
(assert (=> (< j9 100) (= j12 j10)))
(assert (=> (not (< j9 100)) (and (= o13 (+ k1 1)) (in_range1 (+ k1 1)))))
(assert (=> (not (< j9 100)) (= result11 (mk_int__ref k1))))
(assert (=> (not (< j9 100)) (= k2 o13)))
(assert (=> (not (< j9 100)) (= k3 (mk_int__ref k2))))
(assert (=> (not (< j9 100)) (= j11 (mk_int__ref j9))))
(assert (=> (not (< j9 100)) (= k4 k2)))
(assert (=> (not (< j9 100)) (= j12 j9)))
(assert (and (=> (<= (- 2147483648) 2147483647) (in_range1 j13)) (=> (<= (- 2147483648) 2147483647) (in_range1 k5))))
(assert (= result12 (mk_int__ref temp___1561)))
(assert (= temp___1562 j13))
(assert (= result13 (mk_int__ref temp___1551)))
(assert (= temp___1552 k5))
(assert (and (= o14 (+ j13 k5)) (in_range1 (+ j13 k5))))
(assert (= o15 (ite (<= o14 b) true false)))
(assert (= result14 (ite (not (= o15 true)) true false)))
(assert (not (= result14 true)))
(assert (= (to_rep o16) 0))
(assert (and (= temp___1491 (+ j13 k5)) (in_range1 (+ j13 k5))))
(assert (and (<= (to_rep tab__first) temp___1491) (<= temp___1491 (to_rep tab__last))))
(assert (= o17 temp___1491))
(assert (= o18 (store tab10 o17 o16)))
(assert (= result15 (mk_map__ref tab10)))
(assert (= tab11 o18))
(assert (=> (< j13 100) (and (= o19 (+ j13 1)) (in_range1 (+ j13 1)))))
(assert (=> (< j13 100) (= result16 (mk_int__ref j13))))
(assert (=> (< j13 100) (= j14 o19)))
(assert (=> (< j13 100) (= k7 (mk_int__ref k5))))
(assert (=> (< j13 100) (= j15 (mk_int__ref j14))))
(assert (=> (< j13 100) (= k8 k5)))
(assert (=> (< j13 100) (= j16 j14)))
(assert (=> (not (< j13 100)) (and (= o20 (+ k5 1)) (in_range1 (+ k5 1)))))
(assert (=> (not (< j13 100)) (= result17 (mk_int__ref k5))))
(assert (=> (not (< j13 100)) (= k6 o20)))
(assert (=> (not (< j13 100)) (= k7 (mk_int__ref k6))))
(assert (=> (not (< j13 100)) (= j15 (mk_int__ref j13))))
(assert (=> (not (< j13 100)) (= k8 k6)))
(assert (=> (not (< j13 100)) (= j16 j13)))
(assert (not (or (< temp___1562 (int__content j15)) (and (= (int__content j15) temp___1562) (< temp___1552 (int__content k7))))))
(check-sat)
(exit)
