...
(assert (= result7 tab6))
(assert (= tab8 o6))
(assert (=> (< j8 100) (and (= o7 (+ j8 1)) (in_range1 (+ j8 1)))))
...
(assert (=> (not (< j8 100)) (and (= o8 (+ k1 1)) (in_range1 (+ k1 1)))))
(assert (=> (not (< j8 100)) (= result9 (mk_int__ref k1))))
(assert (=> (not (< j8 100)) (= k2 o8)))
...
(assert (and (= o9 (+ j12 k5)) (in_range1 (+ j12 k5))))
(assert (= o10 (ite (<= o9 b) true false)))
(assert (= result12 (ite (not (= o10 true)) true false)))
