...
(assert (= result10 (mk_int__ref temp___156)))
(assert (= temp___1561 j12))
(assert (= result11 (mk_int__ref temp___155)))
(assert (= temp___1551 k5))
...
(assert (not (or (< temp___1561 (int__content j14)) (and (= (int__content j14) temp___1561) (< temp___1551 (int__content k7))))))
(check-sat)
(exit)
