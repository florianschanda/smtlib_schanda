...
(define-fun f__split_fields5 () us_split_fields__ref2 (mk___split_fields__ref2 (mk___split_fields2 f__split_fields f__split_fields1)))
...
(assert (not (= v 0)))
(assert (=> (= d 0) (= (to_rep o) v)))
(assert (=> (= d 0) (= o o1)))
(assert (=> (= d 0) (= (rec__binary_trees__cell__right (us_split_fields3 (select f__split_fields1 i))) o2)))
(assert (=> (= d 0) (= (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i))) o3)))
(assert (=> (= d 0) (= (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 i))) o4)))
(assert (=> (= d 0) (= o5 o1)))
(assert (=> (= d 0) (= o6 o2)))
(assert (=> (= d 0) (= o7 o3)))
(assert (=> (= d 0) (= o8 o4)))
(assert (=> (= d 0) (= o9 (store f__split_fields1 i (mk___rep1 (mk___split_fields1 o5 o6 o7 o8))))))
(assert (=> (= d 0) (= f__split_fields o10)))
(assert (=> (= d 0) (= o9 o11)))
(assert (=> (= d 0) (= temp___854 o10)))
(assert (=> (= d 0) (= temp___8541 o11)))
(assert (=> (= d 0) (= result1 f__split_fields5)))
(assert (=> (= d 0) (= f__split_fields2 (mk___split_fields2 temp___854 temp___8541))))
(assert (=> (not (= d 0)) (= (to_rep o12) v)))
(assert (=> (not (= d 0)) (= (rec__binary_trees__cell__left (us_split_fields3 (select f__split_fields1 i))) o13)))
(assert (=> (not (= d 0)) (= o12 o14)))
(assert (=> (not (= d 0)) (= (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i))) o15)))
(assert (=> (not (= d 0)) (= (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 i))) o16)))
(assert (=> (not (= d 0)) (= o17 o13)))
(assert (=> (not (= d 0)) (= o18 o14)))
(assert (=> (not (= d 0)) (= o19 o15)))
(assert (=> (not (= d 0)) (= o20 o16)))
(assert (=> (not (= d 0)) (= o21 (store f__split_fields1 i (mk___rep1 (mk___split_fields1 o17 o18 o19 o20))))))
(assert (=> (not (= d 0)) (= f__split_fields o22)))
(assert (=> (not (= d 0)) (= o21 o23)))
(assert (=> (not (= d 0)) (= temp___849 o22)))
(assert (=> (not (= d 0)) (= temp___8491 o23)))
(assert (=> (not (= d 0)) (= result2 f__split_fields5)))
(assert (=> (not (= d 0)) (= f__split_fields3 (mk___split_fields2 temp___849 temp___8491))))
(assert (=> (not (= d 0)) (= f__split_fields2 f__split_fields3)))
(assert (= (to_rep1 o24) d))
(assert (= (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields2) v))) o25))
(assert (= (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields2) v))) o26))
(assert (= (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields2) v))) o27))
(assert (= o24 o28))
(assert (= o29 o25))
(assert (= o30 o26))
(assert (= o31 o27))
...
(assert (= o33 v))
(assert (= o34 (store (rec__binary_trees__forest__c f__split_fields2) o33 (mk___rep1 (mk___split_fields1 o29 o30 o31 o32)))))
(assert (= o35 (mk___split_fields2 (rec__binary_trees__forest__s f__split_fields2) o34)))
(assert (= temp___859 (mk___rep2 o35)))
(assert (= result3 (mk___split_fields__ref2 f__split_fields2)))
(assert (= f__split_fields4 (us_split_fields5 temp___859)))
(assert (= (to_rep o36) i))
(assert (= o37 (mk___split_fields1 (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields4) v))) (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields4) v))) o36 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields4) v))))))
(assert (= o38 (mk___rep1 o37)))
(assert (not (<= v 100)))
(check-sat)
(exit)
