...
(assert (not (= v 0)))
(assert (=> (= d 0) (= (to_rep o7) v)))
(assert (=> (= d 0) (= o7 o8)))
(assert (=> (= d 0) (= (rec__binary_trees__cell__right (us_split_fields3 (select f__split_fields1 i))) o9)))
(assert (=> (= d 0) (= (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i))) o10)))
(assert (=> (= d 0) (= (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 i))) o11)))
(assert (=> (= d 0) (= o12 o8)))
(assert (=> (= d 0) (= o13 o9)))
(assert (=> (= d 0) (= o14 o10)))
(assert (=> (= d 0) (= o15 o11)))
(assert (=> (= d 0) (= o16 (store f__split_fields1 i (mk___rep1 (mk___split_fields1 o12 o13 o14 o15))))))
(assert (=> (= d 0) (= f__split_fields o17)))
(assert (=> (= d 0) (= o16 o18)))
(assert (=> (= d 0) (= temp___808 o17)))
(assert (=> (= d 0) (= temp___8081 o18)))
(assert (=> (= d 0) (= result4 (mk___split_fields__ref2 (mk___split_fields2 f__split_fields f__split_fields1)))))
(assert (=> (= d 0) (= f__split_fields3 (mk___split_fields2 temp___808 temp___8081))))
(assert (=> (not (= d 0)) (= (to_rep o19) v)))
(assert (=> (not (= d 0)) (= (rec__binary_trees__cell__left (us_split_fields3 (select f__split_fields1 i))) o20)))
(assert (=> (not (= d 0)) (= o19 o21)))
(assert (=> (not (= d 0)) (= (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i))) o22)))
(assert (=> (not (= d 0)) (= (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 i))) o23)))
(assert (=> (not (= d 0)) (= o24 o20)))
(assert (=> (not (= d 0)) (= o25 o21)))
(assert (=> (not (= d 0)) (= o26 o22)))
(assert (=> (not (= d 0)) (= o27 o23)))
(assert (=> (not (= d 0)) (= o28 (store f__split_fields1 i (mk___rep1 (mk___split_fields1 o24 o25 o26 o27))))))
(assert (=> (not (= d 0)) (= f__split_fields o29)))
(assert (=> (not (= d 0)) (= o28 o30)))
(assert (=> (not (= d 0)) (= temp___803 o29)))
(assert (=> (not (= d 0)) (= temp___8031 o30)))
(assert (=> (not (= d 0)) (= result5 (mk___split_fields__ref2 (mk___split_fields2 f__split_fields f__split_fields1)))))
(assert (=> (not (= d 0)) (= f__split_fields4 (mk___split_fields2 temp___803 temp___8031))))
(assert (=> (not (= d 0)) (= f__split_fields3 f__split_fields4)))
(assert (= (to_rep1 o31) d))
(assert (= (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields3) v))) o32))
(assert (= (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields3) v))) o33))
(assert (= (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields3) v))) o34))
(assert (= o31 o35))
(assert (= o36 o32))
(assert (= o37 o33))
(assert (= o38 o34))
...
(assert (= o40 v))
(assert (= o41 (store (rec__binary_trees__forest__c f__split_fields3) o40 (mk___rep1 (mk___split_fields1 o36 o37 o38 o39)))))
(assert (= o42 (mk___split_fields2 (rec__binary_trees__forest__s f__split_fields3) o41)))
(assert (= temp___813 (mk___rep2 o42)))
(assert (= result6 (mk___split_fields__ref2 f__split_fields3)))
(assert (= f__split_fields5 (us_split_fields5 temp___813)))
(assert (= (to_rep o43) i))
(assert (= o44 (mk___split_fields1 (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields5) v))) (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields5) v))) o43 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields5) v))))))
