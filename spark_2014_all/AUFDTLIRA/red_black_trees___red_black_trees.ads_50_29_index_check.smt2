...
(define-fun dynamic_invariant ((temp___expr_177 Int) (temp___is_init_173 Bool) (temp___skip_constant_174 Bool) (temp___do_toplevel_175 Bool) (temp___do_typ_inv_176 Bool)) Bool (=> (or (= temp___is_init_173 true) (<= 1 100)) (in_range1 temp___expr_177)))
...
(assert (forall ((t us_rep2)) (forall ((i Int)) (! (=> (and (dynamic_invariant2 t true true true true) (dynamic_invariant i true true true true)) (let ((result (parent t i))) (and (=> (= (size1 t) 0) (= result 0)) (dynamic_invariant1 result true false true true)))) :pattern ((parent t i))))))
(assert (forall ((t us_rep2)) (forall ((i Int)) (! (=> (and (dynamic_invariant2 t true true true true) (dynamic_invariant i true true true true)) (= (parent t i) (parent1 (rec__search_trees__search_tree__struct (us_split_fields5 t)) i))) :pattern ((parent t i))))))
...
(define-fun bool_eq9 ((a (Array Int us_rep5)) (a__first Int) (a__last Int) (b (Array Int us_rep5)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (bool_eq8 (select a temp___idx_154) (select b (+ (- b__first a__first) temp___idx_154))) true)))) true false))
(assert (forall ((a (Array Int us_rep5)) (b (Array Int us_rep5))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq9 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (bool_eq8 (select a temp___idx_154) (select b (+ (- b__first a__first) temp___idx_154))) true))))))))
...
(assert true)
(assert (forall ((t us_rep3)) (! (= (= (same_nb_blacks t) true) (or (= (size1 (rec__red_black_trees__rbt__struct (us_split_fields7 t))) 0) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields9 (let ((temp___585 (model__ (rec__red_black_trees__rbt__struct (us_split_fields7 t))))) (select temp___585 i)))) true) (= (rec__red_black_trees__black_count__status (us_split_fields11 (let ((temp___584 (nb_blacks t))) (select temp___584 i)))) true)))))) :pattern ((same_nb_blacks t)))))
...
(assert (forall ((t1 us_rep3)) (! (=> (and (dynamic_invariant3 t1 true true true true) (not (= (size1 (rec__red_black_trees__rbt__struct (us_split_fields7 t1))) 0))) (let ((result (nb_blacks t1))) (and (= (bool_eq10 (select result 0) (mk___rep5 (mk___split_fields5 (distinct 1 0) (of_rep 0) (of_rep 0)))) true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields9 (let ((temp___616 (model__ (rec__red_black_trees__rbt__struct (us_split_fields7 t1))))) (select temp___616 i)))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select result i))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select result (peek (rec__red_black_trees__rbt__struct (us_split_fields7 t1)) i 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select result (peek (rec__red_black_trees__rbt__struct (us_split_fields7 t1)) i 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select result i)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select result (peek (rec__red_black_trees__rbt__struct (us_split_fields7 t1)) i 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select result (peek (rec__red_black_trees__rbt__struct (us_split_fields7 t1)) i 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select result (peek (rec__red_black_trees__rbt__struct (us_split_fields7 t1)) i 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select result (peek (rec__red_black_trees__rbt__struct (us_split_fields7 t1)) i 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select result i)))) (+ (ite (= (to_rep3 (let ((temp___615 (rec__red_black_trees__rbt__color (us_split_fields7 t1)))) (select temp___615 i))) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select result (peek (rec__red_black_trees__rbt__struct (us_split_fields7 t1)) i 0)))))))))))))) :pattern ((nb_blacks t1)))))
...
(define-fun dynamic_invariant8 ((temp___expr_241 us_rep5) (temp___is_init_237 Bool) (temp___skip_constant_238 Bool) (temp___do_toplevel_239 Bool) (temp___do_typ_inv_240 Bool)) Bool (=> (= temp___do_toplevel_239 true) (=> (= temp___is_init_237 true) (< (length (rec__tree_model__path_type__a (us_split_fields9 temp___expr_241))) 100))))
(define-fun default_initial_assumption2 ((temp___expr_243 us_rep5) (temp___skip_top_level_244 Bool)) Bool (and (= (length (rec__tree_model__path_type__a (us_split_fields9 temp___expr_243))) 0) (= (rec__tree_model__path_type__k (us_split_fields9 temp___expr_243)) (distinct 0 0))))
(define-fun dynamic_predicate ((temp___247 us_rep5)) Bool (< (length (rec__tree_model__path_type__a (us_split_fields9 temp___247))) 100))
(define-fun dynamic_invariant9 ((temp___expr_253 (Array Int us_rep5)) (temp___is_init_249 Bool) (temp___skip_constant_250 Bool) (temp___do_toplevel_251 Bool) (temp___do_typ_inv_252 Bool)) Bool (forall ((temp___254 Int)) (=> (and (<= 1 temp___254) (<= temp___254 100)) (=> (= temp___is_init_249 true) (< (length (rec__tree_model__path_type__a (us_split_fields9 (select temp___expr_253 temp___254)))) 100)))))
(define-fun default_initial_assumption3 ((temp___expr_256 (Array Int us_rep5)) (temp___skip_top_level_257 Bool)) Bool (forall ((temp___258 Int)) (=> (and (<= 1 temp___258) (<= temp___258 100)) (and (= (length (rec__tree_model__path_type__a (us_split_fields9 (select temp___expr_256 temp___258)))) 0) (= (rec__tree_model__path_type__k (us_split_fields9 (select temp___expr_256 temp___258))) (distinct 0 0))))))
...
(define-fun default_initial_assumption4 ((temp___expr_234 us_rep4) (temp___skip_top_level_235 Bool)) Bool (=> (not (= temp___skip_top_level_235 true)) (= (length temp___expr_234) 0)))
...
(assert (forall ((t1 us_rep2)) (! (=> (dynamic_invariant2 t1 true true true true) (dynamic_invariant1 (size1 t1) true false true true)) :pattern ((size1 t1)))))
(assert (forall ((t1 us_rep2)) (! (=> (dynamic_invariant2 t1 true true true true) (= (size1 t1) (size (rec__search_trees__search_tree__struct (us_split_fields5 t1))))) :pattern ((size1 t1)))))
...
(assert (forall ((t1 us_rep2)) (! (=> (and (dynamic_invariant2 t1 true true true true) (not (= (size1 t1) 0))) (dynamic_invariant9 (model__ t1) true false true true)) :pattern ((model__ t1)))))
(assert (forall ((t1 us_rep2)) (! (=> (dynamic_invariant2 t1 true true true true) (= (model__ t1) (model__1 (rec__search_trees__search_tree__struct (us_split_fields5 t1)) (to_rep (rec__search_trees__search_tree__root (us_split_fields5 t1)))))) :pattern ((model__ t1)))))
(declare-fun peek1 (us_rep1 Int Int) Int)
(declare-fun peek__function_guard1 (Int us_rep1 Int Int) Bool)
(assert (forall ((t1 us_rep2)) (forall ((i Int) (d Int)) (! (=> (and (and (and (dynamic_invariant2 t1 true true true true) (dynamic_invariant i true true true true)) (dynamic_invariant7 d true true true true)) (and (not (= (size1 t1) 0)) (= (rec__tree_model__path_type__k (us_split_fields9 (let ((temp___466 (model__ t1))) (select temp___466 i)))) true))) (dynamic_invariant1 (peek t1 i d) true false true true)) :pattern ((peek t1 i d))))))
(assert (forall ((t1 us_rep2)) (forall ((i Int) (d Int)) (! (=> (and (and (dynamic_invariant2 t1 true true true true) (dynamic_invariant i true true true true)) (dynamic_invariant7 d true true true true)) (= (peek t1 i d) (peek1 (rec__search_trees__search_tree__struct (us_split_fields5 t1)) i d))) :pattern ((peek t1 i d))))))
...
(assert true)
(assert (forall ((f us_rep1)) (! (=> (dynamic_invariant11 f true true true true) (dynamic_invariant1 (size f) true false true true)) :pattern ((size f)))))
(assert (forall ((f us_rep1)) (forall ((i Int)) (! (=> (and (dynamic_invariant11 f true true true true) (dynamic_invariant i true true true true)) (=> (< (size f) i) (not (= (valid_root f i) true)))) :pattern ((valid_root f i))))))
(assert (forall ((f us_rep1)) (forall ((i Int)) (! (=> (and (dynamic_invariant11 f true true true true) (dynamic_invariant i true true true true)) (let ((result (parent1 f i))) (and (and (=> (= (valid_root f i) true) (= result 0)) (=> (= (size f) 0) (= result 0))) (dynamic_invariant1 result true false true true)))) :pattern ((parent1 f i))))))
(declare-fun position (us_rep1 Int) Int)
(declare-fun position__function_guard (Int us_rep1 Int) Bool)
(assert (forall ((f us_rep1)) (forall ((i Int)) (! (=> (and (and (dynamic_invariant11 f true true true true) (dynamic_invariant i true true true true)) (not (= (parent1 f i) 0))) (dynamic_invariant7 (position f i) true false true true)) :pattern ((position f i))))))
(assert (forall ((f us_rep1)) (forall ((i Int) (d Int)) (! (=> (and (and (dynamic_invariant11 f true true true true) (dynamic_invariant i true true true true)) (dynamic_invariant7 d true true true true)) (let ((result (peek1 f i d))) (and (and (ite (not (= result 0)) (and (= (position f result) d) (= (parent1 f result) i)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (parent1 f j) i) (not (= (position f j) d)))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (parent1 f j) i) (= (position f j) d)) (= result j))))) (dynamic_invariant1 result true false true true)))) :pattern ((peek1 f i d))))))
(assert (forall ((f us_rep1)) (forall ((root Int)) (! (=> (and (and (dynamic_invariant11 f true true true true) (dynamic_invariant root true true true true)) (= (valid_root f root) true)) (let ((result (model__1 f root))) (and (and (= (rec__tree_model__path_type__k (us_split_fields9 (select result root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields9 (select result root)))) 0) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= i root)) (ite (and (not (= (parent1 f i) 0)) (= (rec__tree_model__path_type__k (us_split_fields9 (select result (parent1 f i)))) true)) (= (rec__tree_model__path_type__k (us_split_fields9 (select result i))) true) (not (= (rec__tree_model__path_type__k (us_split_fields9 (select result i))) true)))))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields9 (select result i))) true) (not (= i root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields9 (select result (parent1 f i)))) (position f i) (rec__tree_model__path_type__a (us_split_fields9 (select result i)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields9 (select result i)))) 0)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields9 (select result i))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields9 (select result j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields9 (select result i))) (rec__tree_model__path_type__a (us_split_fields9 (select result j)))) true)) (= j i))))))))))) (dynamic_invariant9 result true false true true)))) :pattern ((model__1 f root))))))
...
(assert (forall ((container us_rep4)) (forall ((position1 Int)) (! (=> (and (dynamic_invariant12 position1 true true true true) (and (<= 1 position1) (<= position1 (last container)))) (dynamic_invariant13 (get container position1) true false true true)) :pattern ((get container position1))))))
(declare-const i Int)
...
(assert (and (= temp___1040 (parent (rec__red_black_trees__rbt__struct (us_split_fields7 t)) i)) (and (in_range2 temp___1040) (and (= temp___1040 (parent1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields7 t)))) i)) (=> (= (size1 (rec__red_black_trees__rbt__struct (us_split_fields7 t))) 0) (= temp___1040 0))))))
(assert (not (<= 1 temp___1040)))
(check-sat)
(exit)
