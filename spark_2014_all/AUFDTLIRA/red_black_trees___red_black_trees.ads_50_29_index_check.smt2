...
(define-fun dynamic_invariant ((temp___expr_177 Int) (temp___is_init_173 Bool) (temp___skip_constant_174 Bool) (temp___do_toplevel_175 Bool) (temp___do_typ_inv_176 Bool)) Bool (=> (or (= temp___is_init_173 true) (<= 1 100)) (in_range4 temp___expr_177)))
(define-fun dynamic_invariant1 ((temp___expr_184 Int) (temp___is_init_180 Bool) (temp___skip_constant_181 Bool) (temp___do_toplevel_182 Bool) (temp___do_typ_inv_183 Bool)) Bool (=> (or (= temp___is_init_180 true) (<= 0 100)) (in_range1 temp___expr_184)))
...
(declare-datatypes () ((us_split_fields8 (mk___split_fields4 (rec__red_black_trees__rbt__struct us_rep2) (rec__red_black_trees__rbt__color (Array Int color_type))))))
(define-fun us_split_fields_Struct__2__projection ((a us_split_fields8)) us_rep2 (rec__red_black_trees__rbt__struct a))
...
(define-fun bool_eq9 ((a us_rep5) (b us_rep5)) Bool (ite (and (= (bool_eq4 (rec__red_black_trees__rbt__struct (us_split_fields9 a)) (rec__red_black_trees__rbt__struct (us_split_fields9 b))) true) (= (bool_eq8 (rec__red_black_trees__rbt__color (us_split_fields9 a)) 1 100 (rec__red_black_trees__rbt__color (us_split_fields9 b)) 1 100) true)) true false))
...
(define-fun dynamic_invariant6 ((temp___expr_191 Int) (temp___is_init_187 Bool) (temp___skip_constant_188 Bool) (temp___do_toplevel_189 Bool) (temp___do_typ_inv_190 Bool)) Bool (=> (or (= temp___is_init_187 true) (<= 0 2)) (in_range2 temp___expr_191)))
...
(define-fun dynamic_invariant8 ((temp___expr_241 us_rep4) (temp___is_init_237 Bool) (temp___skip_constant_238 Bool) (temp___do_toplevel_239 Bool) (temp___do_typ_inv_240 Bool)) Bool (=> (= temp___do_toplevel_239 true) (=> (= temp___is_init_237 true) (< (length (rec__tree_model__path_type__a (us_split_fields7 temp___expr_241))) 100))))
(define-fun default_initial_assumption2 ((temp___expr_243 us_rep4) (temp___skip_top_level_244 Bool)) Bool (and (= (length (rec__tree_model__path_type__a (us_split_fields7 temp___expr_243))) 0) (= (rec__tree_model__path_type__k (us_split_fields7 temp___expr_243)) (distinct 0 0))))
...
(assert (forall ((t1 us_rep2)) (! (=> (dynamic_invariant2 t1 true true true true) (dynamic_invariant1 (size t1) true false true true)) :pattern ((size t1)))))
(assert (forall ((t1 us_rep2)) (! (=> (dynamic_invariant2 t1 true true true true) (= (size t1) (size1 (rec__search_trees__search_tree__struct (us_split_fields5 t1))))) :pattern ((size t1)))))
...
(assert (forall ((t1 us_rep2)) (! (=> (and (dynamic_invariant2 t1 true true true true) (not (= (size t1) 0))) (dynamic_invariant9 (model__ t1) true false true true)) :pattern ((model__ t1)))))
...
(assert (forall ((t1 us_rep2)) (forall ((i Int) (d Int)) (! (=> (and (and (and (dynamic_invariant2 t1 true true true true) (dynamic_invariant i true true true true)) (dynamic_invariant7 d true true true true)) (and (not (= (size t1) 0)) (= (rec__tree_model__path_type__k (us_split_fields7 (let ((temp___466 (model__ t1))) (select temp___466 i)))) true))) (dynamic_invariant1 (peek t1 i d) true false true true)) :pattern ((peek t1 i d))))))
...
(define-fun default_initial_assumption5 ((temp___expr_320 us_rep1) (temp___skip_top_level_321 Bool)) Bool (and (and (= (to_rep (rec__binary_trees__forest__s (us_split_fields3 temp___expr_320))) 0) (forall ((temp___323 Int)) (=> (and (<= 1 temp___323) (<= temp___323 100)) (and (and (and (= (to_rep (rec__binary_trees__cell__left (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 temp___expr_320)) temp___323)))) 0) (= (to_rep (rec__binary_trees__cell__right (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 temp___expr_320)) temp___323)))) 0)) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 temp___expr_320)) temp___323)))) 0)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 temp___expr_320)) temp___323)))) 2))))) (=> (not (= temp___skip_top_level_321 true)) (= (size1 temp___expr_320) 0))))
(define-fun type_invariant2 ((temp___326 us_rep1)) Bool (= (tree_structure temp___326) true))
(assert true)
(assert (forall ((f us_rep1)) (! (=> (dynamic_invariant11 f true true true true) (dynamic_invariant1 (size1 f) true false true true)) :pattern ((size1 f)))))
(assert (forall ((f us_rep1)) (forall ((i Int)) (! (=> (and (dynamic_invariant11 f true true true true) (dynamic_invariant i true true true true)) (=> (< (size1 f) i) (not (= (valid_root f i) true)))) :pattern ((valid_root f i))))))
(assert (forall ((f us_rep1)) (forall ((i Int)) (! (=> (and (dynamic_invariant11 f true true true true) (dynamic_invariant i true true true true)) (let ((result (parent1 f i))) (and (and (=> (= (valid_root f i) true) (= result 0)) (=> (= (size1 f) 0) (= result 0))) (dynamic_invariant1 result true false true true)))) :pattern ((parent1 f i))))))
...
(assert (and (= o1 (same_nb_blacks t)) (= (= o1 true) (or (= (size (rec__red_black_trees__rbt__struct (us_split_fields9 t))) 0) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 t))) i1))) true) (= (rec__red_black_trees__black_count__status (us_split_fields11 (select (nb_blacks t) i1))) true))))))))
(assert (<= 1 i))
(assert (<= i 100))
(assert (and (= o (parent (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i)) (and (in_range1 o) (and (= o (parent1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) i)) (=> (= (size (rec__red_black_trees__rbt__struct (us_split_fields9 t))) 0) (= o 0))))))
(assert (= result (ite (= o 0) true false)))
(assert (not (= result true)))
(assert (and (= temp___1040 (parent (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i)) (and (in_range1 temp___1040) (and (= temp___1040 (parent1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) i)) (=> (= (size (rec__red_black_trees__rbt__struct (us_split_fields9 t))) 0) (= temp___1040 0))))))
(assert (not (<= temp___1040 100)))
(check-sat)
(exit)
