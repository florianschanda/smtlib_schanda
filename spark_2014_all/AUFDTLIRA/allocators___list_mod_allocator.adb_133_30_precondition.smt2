...
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (length avail2))) (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (length avail2))) (=> (= (get avail2 j1) (get avail2 k1)) (= j1 k1)))))))
...
(assert (= result8 true))
(assert (and (= o15 (length avail2)) (and (in_range2 o15) (<= (+ 0 o15) 2147483647))))
(assert (= o16 (ite (<= k o15) true false)))
(assert (= result9 (ite (<= 1 k) o16 false)))
(assert (= result9 true))
(assert (and (= o17 (get avail2 k)) (in_range3 o17)))
