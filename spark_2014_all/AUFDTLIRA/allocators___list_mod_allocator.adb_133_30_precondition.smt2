...
(assert (and (= o45 (length avail3)) (and (in_range5 o45) (<= (+ 0 o45) 2147483647))))
(assert (= o46 (ite (<= j3 o45) true false)))
(assert (= result14 (ite (<= 1 j3) o46 false)))
(assert (= result14 true))
(assert (and (= o47 (length avail3)) (and (in_range5 o47) (<= (+ 0 o47) 2147483647))))
(assert (= o48 (ite (<= k o47) true false)))
(assert (= result15 (ite (<= 1 k) o48 false)))
(assert (= result15 true))
(assert (and (= o49 (get avail3 k)) (in_range6 o49)))
(assert (not (<= 1 j3)))
(check-sat)
(exit)
