...
(declare-const temp___285 (Array Int map1))
(declare-const temp___280 Int)
(declare-const temp___275 (Array Int map1))
(declare-const temp___259 Int)
(declare-const temp___264 (Array Int map1))
(declare-const temp___254 (Array Int map1))
(declare-const temp___238 Int)
(declare-const temp___233 (Array Int map1))
(declare-const temp___243 (Array Int map1))
...
(assert (and (and (forall ((temp___297 Int)) (=> (and (<= 1 temp___297) (<= temp___297 3)) (=> (<= i32 temp___297) (= (select x2 temp___297) (select x1 temp___297))))) (=> (<= 1 3) (in_range2 i32))) (and (<= 1 i32) (<= i32 3))))
(assert (= i21 result2))
(assert (= i211 1))
(assert (=> (and (<= 1 i211) (<= i211 3)) (= temp___285 x2)))
(assert (=> (and (<= 1 i211) (<= i211 3)) (= temp___280 i211)))
(assert (=> (and (<= 1 i211) (<= i211 3)) (= temp___275 x2)))
(assert (=> (and (<= 1 i211) (<= i211 3)) (= (bool_eq2 x3 (to_rep (first4 (mk2 (+ i32 1) 3))) (to_rep (last4 (mk2 (+ i32 1) 3))) temp___285 (to_rep (first6 (mk3 (+ i32 1) 3))) (to_rep (last6 (mk3 (+ i32 1) 3)))) true)))
(assert (=> (and (<= 1 i211) (<= i211 3)) (and (and (forall ((temp___276 Int)) (=> (and (<= 1 temp___276) (<= temp___276 3)) (ite (not (= i32 temp___276)) (= (select x3 temp___276) (select temp___275 temp___276)) (forall ((temp___277 Int) (temp___278 Int)) (=> (and (and (<= 1 temp___277) (<= temp___277 3)) (and (<= 1 temp___278) (<= temp___278 3))) (=> (<= i212 temp___277) (= (get (select x3 temp___276) temp___277 temp___278) (get (select temp___275 temp___276) temp___277 temp___278)))))))) (=> (<= 1 3) (in_range2 i212))) (and (<= 1 i212) (<= i212 3)))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (= i221 result3)))
(assert (=> (and (<= 1 i211) (<= i211 3)) (= i222 1)))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (= temp___259 i222))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (= temp___264 x3))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (= temp___254 x3))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (= (bool_eq2 x4 (to_rep (first8 (mk4 (+ i32 1) 3))) (to_rep (last8 (mk4 (+ i32 1) 3))) temp___264 (to_rep (first10 (mk5 (+ i32 1) 3))) (to_rep (last10 (mk5 (+ i32 1) 3)))) true))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (and (and (forall ((temp___255 Int)) (=> (and (<= 1 temp___255) (<= temp___255 3)) (ite (not (= i32 temp___255)) (= (select x4 temp___255) (select temp___254 temp___255)) (forall ((temp___256 Int) (temp___257 Int)) (=> (and (and (<= 1 temp___256) (<= temp___256 3)) (and (<= 1 temp___257) (<= temp___257 3))) (=> (or (<= i223 temp___257) (not (= i212 temp___256))) (= (get (select x4 temp___255) temp___256 temp___257) (get (select temp___254 temp___255) temp___256 temp___257)))))))) (=> (<= 1 3) (in_range2 i223))) (and (<= 1 i223) (<= i223 3))))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (= i12 result4))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (= i13 1))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (=> (and (<= 1 i13) (<= i13 3)) (= temp___238 i13)))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (=> (and (<= 1 i13) (<= i13 3)) (= temp___233 x4)))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (=> (and (<= 1 i13) (<= i13 3)) (= temp___243 x4)))))
...
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (=> (and (<= 1 i13) (<= i13 3)) (= (bool_eq2 x6 (to_rep (first12 (mk6 (+ i32 1) 3))) (to_rep (last12 (mk6 (+ i32 1) 3))) temp___243 (to_rep (first14 (mk7 (+ i32 1) 3))) (to_rep (last14 (mk7 (+ i32 1) 3)))) true)))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (=> (and (<= 1 i13) (<= i13 3)) (and (and (forall ((temp___234 Int)) (=> (and (<= 1 temp___234) (<= temp___234 3)) (ite (not (= i32 temp___234)) (= (select x6 temp___234) (select temp___233 temp___234)) (forall ((temp___235 Int) (temp___236 Int)) (=> (and (and (<= 1 temp___235) (<= temp___235 3)) (and (<= 1 temp___236) (<= temp___236 3))) (ite (or (not (= i223 temp___236)) (not (= i212 temp___235))) (= (get (select x6 temp___234) temp___235 temp___236) (get (select temp___233 temp___234) temp___235 temp___236)) (forall ((temp___237 Int)) (=> (and (<= 1 temp___237) (<= temp___237 3)) (=> (< i14 temp___237) (= (select (get (select x6 temp___234) temp___235 temp___236) temp___237) (select (get (select temp___233 temp___234) temp___235 temp___236) temp___237))))))))))) (=> (<= 1 3) (in_range2 i14))) (and (<= 1 i14) (<= i14 3)))))))
