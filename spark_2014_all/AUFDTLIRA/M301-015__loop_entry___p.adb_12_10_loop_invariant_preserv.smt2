...
(declare-const temp___321 (Array Int map1))
(declare-const temp___316 Int)
(declare-const temp___311 (Array Int map1))
(declare-const temp___297 Int)
(declare-const temp___302 (Array Int map1))
(declare-const temp___292 (Array Int map1))
(declare-const temp___278 Int)
(declare-const temp___273 (Array Int map1))
(declare-const temp___283 (Array Int map1))
...
(assert (= result x))
(assert (= x1 (p__x__aggregate_def (temp_____aggregate_def_253 (temp_____aggregate_def_258 0)))))
(assert (= result1 i3))
(assert (= i31 1))
(assert (<= 1 i31))
(assert (<= i31 3))
...
(assert (and (and (forall ((temp___331 Int)) (=> (and (<= 1 temp___331) (<= temp___331 3)) (=> (or (< 3 temp___331) (or (< temp___331 1) (<= i32 temp___331))) (= (select x2 temp___331) (select x1 temp___331))))) (=> (<= 1 3) (in_range2 i32))) (and (<= 1 i32) (<= i32 3))))
(assert (= i21 result2))
(assert (= i211 1))
(assert (=> (and (<= 1 i211) (<= i211 3)) (= temp___321 x2)))
(assert (=> (and (<= 1 i211) (<= i211 3)) (= temp___316 i211)))
(assert (=> (and (<= 1 i211) (<= i211 3)) (= temp___311 x2)))
(assert (=> (and (<= 1 i211) (<= i211 3)) (= (bool_eq2 x3 (to_rep (first4 (mk2 (+ i32 1) 3))) (to_rep (last4 (mk2 (+ i32 1) 3))) temp___321 (to_rep (first6 (mk3 (+ i32 1) 3))) (to_rep (last6 (mk3 (+ i32 1) 3)))) true)))
(assert (=> (and (<= 1 i211) (<= i211 3)) (and (and (forall ((temp___312 Int)) (=> (and (<= 1 temp___312) (<= temp___312 3)) (ite (not (= i32 temp___312)) (= (select x3 temp___312) (select temp___311 temp___312)) (forall ((temp___313 Int) (temp___314 Int)) (=> (and (and (<= 1 temp___313) (<= temp___313 3)) (and (<= 1 temp___314) (<= temp___314 3))) (=> (or (< 3 temp___313) (or (< temp___313 1) (<= i212 temp___313))) (= (get (select x3 temp___312) temp___313 temp___314) (get (select temp___311 temp___312) temp___313 temp___314)))))))) (=> (<= 1 3) (in_range2 i212))) (and (<= 1 i212) (<= i212 3)))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (= i221 result3)))
(assert (=> (and (<= 1 i211) (<= i211 3)) (= i222 1)))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (= temp___297 i222))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (= temp___302 x3))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (= temp___292 x3))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (= (bool_eq2 x4 (to_rep (first8 (mk4 (+ i32 1) 3))) (to_rep (last8 (mk4 (+ i32 1) 3))) temp___302 (to_rep (first10 (mk5 (+ i32 1) 3))) (to_rep (last10 (mk5 (+ i32 1) 3)))) true))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (and (and (forall ((temp___293 Int)) (=> (and (<= 1 temp___293) (<= temp___293 3)) (ite (not (= i32 temp___293)) (= (select x4 temp___293) (select temp___292 temp___293)) (forall ((temp___294 Int) (temp___295 Int)) (=> (and (and (<= 1 temp___294) (<= temp___294 3)) (and (<= 1 temp___295) (<= temp___295 3))) (=> (or (< 3 temp___295) (or (< temp___295 1) (or (<= i223 temp___295) (not (= i212 temp___294))))) (= (get (select x4 temp___293) temp___294 temp___295) (get (select temp___292 temp___293) temp___294 temp___295)))))))) (=> (<= 1 3) (in_range2 i223))) (and (<= 1 i223) (<= i223 3))))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (= i12 result4))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (= i13 1))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (=> (and (<= 1 i13) (<= i13 3)) (= temp___278 i13)))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (=> (and (<= 1 i13) (<= i13 3)) (= temp___273 x4)))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (=> (and (<= 1 i13) (<= i13 3)) (= temp___283 x4)))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (=> (and (<= 1 i13) (<= i13 3)) (= x4 result5)))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (=> (and (<= 1 i13) (<= i13 3)) (= x5 (store x4 i32 (set (select x4 i32) i212 i223 (store (get (select x4 i32) i212 i223) i13 rliteral1))))))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (=> (and (<= 1 i13) (<= i13 3)) (= (bool_eq2 x6 (to_rep (first12 (mk6 (+ i32 1) 3))) (to_rep (last12 (mk6 (+ i32 1) 3))) temp___283 (to_rep (first14 (mk7 (+ i32 1) 3))) (to_rep (last14 (mk7 (+ i32 1) 3)))) true)))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (=> (and (<= 1 i13) (<= i13 3)) (and (and (forall ((temp___274 Int)) (=> (and (<= 1 temp___274) (<= temp___274 3)) (ite (not (= i32 temp___274)) (= (select x6 temp___274) (select temp___273 temp___274)) (forall ((temp___275 Int) (temp___276 Int)) (=> (and (and (<= 1 temp___275) (<= temp___275 3)) (and (<= 1 temp___276) (<= temp___276 3))) (ite (or (not (= i223 temp___276)) (not (= i212 temp___275))) (= (get (select x6 temp___274) temp___275 temp___276) (get (select temp___273 temp___274) temp___275 temp___276)) (forall ((temp___277 Int)) (=> (and (<= 1 temp___277) (<= temp___277 3)) (=> (or (< 3 temp___277) (or (< temp___277 1) (< i14 temp___277))) (= (select (get (select x6 temp___274) temp___275 temp___276) temp___277) (select (get (select temp___273 temp___274) temp___275 temp___276) temp___277))))))))))) (=> (<= 1 3) (in_range2 i14))) (and (<= 1 i14) (<= i14 3)))))))
