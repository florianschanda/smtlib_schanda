...
(define-fun bool_eq4 ((x us_t1) (y us_t1)) Bool (bool_eq2 (elts1 x) (to_rep (first2 (rt1 x))) (to_rep (last2 (rt1 x))) (elts1 y) (to_rep (first2 (rt1 y))) (to_rep (last2 (rt1 y)))))
...
(define-fun of_array2 ((a (Array Int map1)) (f Int) (l Int)) us_t2 (mk___t2 a (mk2 f l)))
...
(assert (forall ((a (Array Int map1))) (<= 0 (object__component__size4 a))))
(assert (<= 0 value__alignment4))
(assert (forall ((a (Array Int map1))) (<= 0 (object__alignment4 a))))
(define-fun bool_eq5 ((x us_t2) (y us_t2)) Bool (bool_eq2 (elts2 x) (to_rep (first4 (rt2 x))) (to_rep (last4 (rt2 x))) (elts2 y) (to_rep (first4 (rt2 y))) (to_rep (last4 (rt2 y)))))
...
(define-fun of_array3 ((a (Array Int map1)) (f Int) (l Int)) us_t3 (mk___t3 a (mk3 f l)))
...
(assert (forall ((a (Array Int map1))) (<= 0 (object__component__size5 a))))
(assert (<= 0 value__alignment5))
(assert (forall ((a (Array Int map1))) (<= 0 (object__alignment5 a))))
(define-fun bool_eq6 ((x us_t3) (y us_t3)) Bool (bool_eq2 (elts3 x) (to_rep (first6 (rt3 x))) (to_rep (last6 (rt3 x))) (elts3 y) (to_rep (first6 (rt3 y))) (to_rep (last6 (rt3 y)))))
...
(define-fun of_array4 ((a (Array Int map1)) (f Int) (l Int)) us_t4 (mk___t4 a (mk4 f l)))
...
(assert (forall ((a (Array Int map1))) (<= 0 (object__component__size6 a))))
(assert (<= 0 value__alignment6))
(assert (forall ((a (Array Int map1))) (<= 0 (object__alignment6 a))))
(define-fun bool_eq7 ((x us_t4) (y us_t4)) Bool (bool_eq2 (elts4 x) (to_rep (first8 (rt4 x))) (to_rep (last8 (rt4 x))) (elts4 y) (to_rep (first8 (rt4 y))) (to_rep (last8 (rt4 y)))))
...
(define-fun of_array5 ((a (Array Int map1)) (f Int) (l Int)) us_t5 (mk___t5 a (mk5 f l)))
...
(assert (forall ((a (Array Int map1))) (<= 0 (object__component__size7 a))))
(assert (<= 0 value__alignment7))
(assert (forall ((a (Array Int map1))) (<= 0 (object__alignment7 a))))
(define-fun bool_eq8 ((x us_t5) (y us_t5)) Bool (bool_eq2 (elts5 x) (to_rep (first10 (rt5 x))) (to_rep (last10 (rt5 x))) (elts5 y) (to_rep (first10 (rt5 y))) (to_rep (last10 (rt5 y)))))
...
(define-fun of_array6 ((a (Array Int map1)) (f Int) (l Int)) us_t6 (mk___t6 a (mk6 f l)))
...
(assert (forall ((a (Array Int map1))) (<= 0 (object__component__size8 a))))
(assert (<= 0 value__alignment8))
(assert (forall ((a (Array Int map1))) (<= 0 (object__alignment8 a))))
(define-fun bool_eq9 ((x us_t6) (y us_t6)) Bool (bool_eq2 (elts6 x) (to_rep (first12 (rt6 x))) (to_rep (last12 (rt6 x))) (elts6 y) (to_rep (first12 (rt6 y))) (to_rep (last12 (rt6 y)))))
...
(define-fun of_array7 ((a (Array Int map1)) (f Int) (l Int)) us_t7 (mk___t7 a (mk7 f l)))
...
(assert (forall ((a (Array Int map1))) (<= 0 (object__component__size9 a))))
(assert (<= 0 value__alignment9))
(assert (forall ((a (Array Int map1))) (<= 0 (object__alignment9 a))))
(define-fun bool_eq10 ((x us_t7) (y us_t7)) Bool (bool_eq2 (elts7 x) (to_rep (first14 (rt7 x))) (to_rep (last14 (rt7 x))) (elts7 y) (to_rep (first14 (rt7 y))) (to_rep (last14 (rt7 y)))))
...
(assert (forall ((temp___251 map1)) (forall ((temp___252 Int)) (= (select (p__x__aggregate_def temp___251) temp___252) temp___251))))
...
(declare-const temp___317 (Array Int map1))
(declare-const temp___312 Int)
(declare-const temp___307 (Array Int map1))
(declare-const temp___291 Int)
(declare-const temp___296 (Array Int map1))
(declare-const temp___286 (Array Int map1))
(declare-const temp___270 Int)
(declare-const temp___265 (Array Int map1))
(declare-const temp___275 (Array Int map1))
...
(declare-const x9 map__ref2)
(declare-const i17 int__ref)
(declare-const x10 (Array Int map1))
(declare-const i18 Int)
(declare-const x11 map__ref2)
(declare-const i224 int__ref)
(declare-const i19 int__ref)
(declare-const x12 (Array Int map1))
(declare-const i225 Int)
(declare-const i110 Int)
(declare-const x13 map__ref2)
(declare-const i226 int__ref)
(declare-const i111 int__ref)
(declare-const x14 (Array Int map1))
(declare-const i227 Int)
(declare-const i112 Int)
(declare-const x15 map__ref2)
(declare-const i213 int__ref)
(declare-const i228 int__ref)
(declare-const i113 int__ref)
(declare-const x16 (Array Int map1))
(declare-const i214 Int)
(declare-const i229 Int)
(declare-const i114 Int)
(declare-const x17 map__ref2)
(declare-const i215 int__ref)
(declare-const i2210 int__ref)
(declare-const i115 int__ref)
...
(declare-const x19 map__ref2)
(declare-const i34 int__ref)
(declare-const i217 int__ref)
(declare-const i2212 int__ref)
(declare-const i117 int__ref)
...
(assert (= result x))
(assert (= x1 (p__x__aggregate_def (temp___253 (temp___258 0)))))
(assert (= result1 i3))
(assert (= i31 1))
(assert (<= 1 i31))
(assert (<= i31 3))
(assert (= (bool_eq2 x2 (to_rep (first (mk (+ i32 1) 3))) (to_rep (last (mk (+ i32 1) 3))) x1 (to_rep (first2 (mk1 (+ i32 1) 3))) (to_rep (last2 (mk1 (+ i32 1) 3)))) true))
(assert (and (and (forall ((temp___329 Int)) (=> (and (<= 1 temp___329) (<= temp___329 3)) (=> (<= i32 temp___329) (= (select x2 temp___329) (select x1 temp___329))))) (=> (<= 1 3) (in_range2 i32))) (and (<= 1 i32) (<= i32 3))))
(assert (= i21 result2))
(assert (= i211 1))
(assert (=> (and (<= 1 i211) (<= i211 3)) (= temp___317 x2)))
(assert (=> (and (<= 1 i211) (<= i211 3)) (= temp___312 i211)))
(assert (=> (and (<= 1 i211) (<= i211 3)) (= temp___307 x2)))
(assert (=> (and (<= 1 i211) (<= i211 3)) (= (bool_eq2 x3 (to_rep (first4 (mk2 (+ i32 1) 3))) (to_rep (last4 (mk2 (+ i32 1) 3))) temp___317 (to_rep (first6 (mk3 (+ i32 1) 3))) (to_rep (last6 (mk3 (+ i32 1) 3)))) true)))
(assert (=> (and (<= 1 i211) (<= i211 3)) (and (and (forall ((temp___308 Int)) (=> (and (<= 1 temp___308) (<= temp___308 3)) (ite (not (= i32 temp___308)) (= (select x3 temp___308) (select temp___307 temp___308)) (forall ((temp___309 Int) (temp___310 Int)) (=> (and (and (<= 1 temp___309) (<= temp___309 3)) (and (<= 1 temp___310) (<= temp___310 3))) (=> (<= i212 temp___309) (= (get (select x3 temp___308) temp___309 temp___310) (get (select temp___307 temp___308) temp___309 temp___310)))))))) (=> (<= 1 3) (in_range2 i212))) (and (<= 1 i212) (<= i212 3)))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (= i221 result3)))
(assert (=> (and (<= 1 i211) (<= i211 3)) (= i222 1)))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (= temp___291 i222))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (= temp___296 x3))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (= temp___286 x3))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (= (bool_eq2 x4 (to_rep (first8 (mk4 (+ i32 1) 3))) (to_rep (last8 (mk4 (+ i32 1) 3))) temp___296 (to_rep (first10 (mk5 (+ i32 1) 3))) (to_rep (last10 (mk5 (+ i32 1) 3)))) true))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (and (and (forall ((temp___287 Int)) (=> (and (<= 1 temp___287) (<= temp___287 3)) (ite (not (= i32 temp___287)) (= (select x4 temp___287) (select temp___286 temp___287)) (forall ((temp___288 Int) (temp___289 Int)) (=> (and (and (<= 1 temp___288) (<= temp___288 3)) (and (<= 1 temp___289) (<= temp___289 3))) (=> (or (<= i223 temp___289) (not (= i212 temp___288))) (= (get (select x4 temp___287) temp___288 temp___289) (get (select temp___286 temp___287) temp___288 temp___289)))))))) (=> (<= 1 3) (in_range2 i223))) (and (<= 1 i223) (<= i223 3))))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (= i12 result4))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (= i13 1))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (=> (and (<= 1 i13) (<= i13 3)) (= temp___270 i13)))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (=> (and (<= 1 i13) (<= i13 3)) (= temp___265 x4)))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (=> (and (<= 1 i13) (<= i13 3)) (= temp___275 x4)))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (=> (and (<= 1 i13) (<= i13 3)) (= (to_rep o) 1)))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (=> (and (<= 1 i13) (<= i13 3)) (= o1 (store (get (select x4 i32) i212 i223) i13 o))))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (=> (and (<= 1 i13) (<= i13 3)) (= o2 (set (select x4 i32) i212 i223 o1))))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (=> (and (<= 1 i13) (<= i13 3)) (= o3 (store x4 i32 o2))))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (=> (and (<= 1 i13) (<= i13 3)) (= x4 result5)))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (=> (and (<= 1 i13) (<= i13 3)) (= x5 o3)))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (=> (and (<= 1 i13) (<= i13 3)) (= (bool_eq2 x6 (to_rep (first12 (mk6 (+ i32 1) 3))) (to_rep (last12 (mk6 (+ i32 1) 3))) temp___275 (to_rep (first14 (mk7 (+ i32 1) 3))) (to_rep (last14 (mk7 (+ i32 1) 3)))) true)))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (=> (and (<= 1 i13) (<= i13 3)) (and (and (forall ((temp___266 Int)) (=> (and (<= 1 temp___266) (<= temp___266 3)) (ite (not (= i32 temp___266)) (= (select x6 temp___266) (select temp___265 temp___266)) (forall ((temp___267 Int) (temp___268 Int)) (=> (and (and (<= 1 temp___267) (<= temp___267 3)) (and (<= 1 temp___268) (<= temp___268 3))) (ite (or (not (= i223 temp___268)) (not (= i212 temp___267))) (= (get (select x6 temp___266) temp___267 temp___268) (get (select temp___265 temp___266) temp___267 temp___268)) (forall ((temp___269 Int)) (=> (and (<= 1 temp___269) (<= temp___269 3)) (=> (< i14 temp___269) (= (select (get (select x6 temp___266) temp___267 temp___268) temp___269) (select (get (select temp___265 temp___266) temp___267 temp___268) temp___269))))))))))) (=> (<= 1 3) (in_range2 i14))) (and (<= 1 i14) (<= i14 3)))))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (=> (and (<= 1 i13) (<= i13 3)) (= i14 3)))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (=> (and (<= 1 i13) (<= i13 3)) (= i14 i15)))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (=> (and (<= 1 i13) (<= i13 3)) (= x6 x7)))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (=> (and (<= 1 i13) (<= i13 3)) (= i16 i14)))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (=> (and (<= 1 i13) (<= i13 3)) (= x8 x6)))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (=> (and (<= 1 i13) (<= i13 3)) (= i17 (mk_int__ref i15))))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (=> (and (<= 1 i13) (<= i13 3)) (= x9 (mk_map__ref2 x7))))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (=> (and (<= 1 i13) (<= i13 3)) (= i18 i16)))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (=> (and (<= 1 i13) (<= i13 3)) (= x10 x8)))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (=> (not (and (<= 1 i13) (<= i13 3))) (= i17 (mk_int__ref i13))))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (=> (not (and (<= 1 i13) (<= i13 3))) (= x9 (mk_map__ref2 x4))))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (=> (not (and (<= 1 i13) (<= i13 3))) (= i18 i13)))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (=> (not (and (<= 1 i13) (<= i13 3))) (= x10 x4)))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (= i223 3))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (= i19 i17))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (= i224 (mk_int__ref i223)))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (= x11 x9))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (= i110 i18))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (= i225 i223))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (= x12 x10))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (= i111 i19))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (= i226 i224))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (= x13 x11))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (= i112 i110))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (= i227 i225))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (and (<= 1 i222) (<= i222 3)) (= x14 x12))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (not (and (<= 1 i222) (<= i222 3))) (= i111 (mk_int__ref i11)))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (not (and (<= 1 i222) (<= i222 3))) (= i226 (mk_int__ref i222)))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (not (and (<= 1 i222) (<= i222 3))) (= x13 (mk_map__ref2 x3)))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (not (and (<= 1 i222) (<= i222 3))) (= i112 i11))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (not (and (<= 1 i222) (<= i222 3))) (= i227 i222))))
(assert (=> (and (<= 1 i211) (<= i211 3)) (=> (not (and (<= 1 i222) (<= i222 3))) (= x14 x3))))
...
(assert (=> (not (and (<= 1 i211) (<= i211 3))) (= i2210 (mk_int__ref i22))))
(assert (=> (not (and (<= 1 i211) (<= i211 3))) (= i215 (mk_int__ref i211))))
...
(assert (not (= i32 3)))
(assert (= result6 (mk_int__ref i32)))
(assert (= i33 (+ i32 1)))
(assert (= i117 i115))
(assert (= i2212 i2210))
(assert (= i217 i215))
(assert (= i34 (mk_int__ref i33)))
(assert (= x19 x17))
(assert (= i118 i116))
(assert (= i2213 i2211))
(assert (= i218 i216))
(assert (= i35 i33))
(assert (= x20 x18))
(assert (not (= (bool_eq2 (map__content2 x19) (to_rep (first (mk (+ (int__content i34) 1) 3))) (to_rep (last (mk (+ (int__content i34) 1) 3))) x1 (to_rep (first2 (mk1 (+ (int__content i34) 1) 3))) (to_rep (last2 (mk1 (+ (int__content i34) 1) 3)))) true)))
(check-sat)
(exit)
