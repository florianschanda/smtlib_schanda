...
(assert (=> (not (< 0 (to_rep1 x__split_discrs))) (dynamic_invariant1 (mk___rep (mk___split_discrs x__split_discrs2) (mk___split_fields x__split_fields6 (mk___t x__split_fields7 x__split_fields8)) x__attr__constrained) true true true)))
