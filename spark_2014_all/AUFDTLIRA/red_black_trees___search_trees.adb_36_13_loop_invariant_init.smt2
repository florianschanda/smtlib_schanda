...
(assert (not (exists ((i Int)) (and (and (<= 1 i) (<= i 100)) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i))) true) (= (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i)) v))))))
(check-sat)
(exit)
