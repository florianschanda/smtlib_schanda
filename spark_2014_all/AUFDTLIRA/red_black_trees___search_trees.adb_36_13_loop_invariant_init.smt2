...
(assert (and (= temp___669 (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o1)) (and (dynamic_invariant5 temp___669 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___669 o1))) true) (and (= (length1 (rec__tree_model__path_type__a (us_split_fields1 (select temp___669 o1)))) 0) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= i o1)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___669 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___669 i))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___669 i))) true)))))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___669 i))) true) (not (= i o1))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___669 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i)))) (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i) (rec__tree_model__path_type__a (us_split_fields1 (select temp___669 i)))) true) (= (length1 (rec__tree_model__path_type__a (us_split_fields1 (select temp___669 i)))) 0)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___669 i))) true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___669 j2))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___669 i))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___669 j2)))) true)) (= j2 i))))))))))))))
...
(assert (<= 0 v))
(assert (<= v 2147483647))
(assert (= (contains s2 v) true))
(assert (not (exists ((i Int)) (and (and (<= 1 i) (<= i 100)) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i))) true) (= (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i)) v))))))
(check-sat)
(exit)
