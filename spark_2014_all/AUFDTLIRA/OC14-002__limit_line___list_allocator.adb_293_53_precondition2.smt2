...
(assert (=> (not (= first_available1 0)) (and (= o66 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range3 o66))))
(assert (=> (not (= first_available1 0)) (= result12 (ite (< 0 o66) true false))))
(assert (=> (not (= first_available1 0)) (=> (= result12 true) (and (= o65 (get (rec__list_allocator__m__t__available model____split_fields3) 1)) (in_range4 o65)))))
...
(assert (=> (not (not (= first_available1 0))) (and (= o67 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range3 o67))))
(assert (=> (not (not (= first_available1 0))) (= result11 (ite (= o67 0) true false))))
(assert (=> (= result11 true) (=> (not (= first_allocated2 0)) (and (= o63 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range3 o63)))))
(assert (=> (= result11 true) (=> (not (= first_allocated2 0)) (= result13 (ite (< 0 o63) true false)))))
(assert (=> (= result11 true) (=> (not (= first_allocated2 0)) (=> (= result13 true) (and (= o62 (get (rec__list_allocator__m__t__allocated model____split_fields3) 1)) (in_range4 o62))))))
...
(assert (=> (= result11 true) (=> (not (not (= first_allocated2 0))) (and (= o64 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range3 o64)))))
...
(assert (= result15 (ite (in_range7 o61) true false)))
