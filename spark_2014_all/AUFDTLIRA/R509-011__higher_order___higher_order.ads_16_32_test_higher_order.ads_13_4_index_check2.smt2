...
(assert (= i2 (to_rep1 (first4 (rt2 a)))))
(assert (=> (and (<= (to_rep1 (first4 (rt2 a))) i2) (<= i2 (to_rep1 (last4 (rt2 a))))) (= temp___371 r)))
(assert (=> (and (<= (to_rep1 (first4 (rt2 a))) i2) (<= i2 (to_rep1 (last4 (rt2 a))))) (= temp___369 i2)))
(assert (=> (and (<= (to_rep1 (first4 (rt2 a))) i2) (<= i2 (to_rep1 (last4 (rt2 a))))) (and (= o (add_one (to_rep (select (elts2 a) i2)))) (and (in_range3 o) (= o (+ (to_rep (select (elts2 a) i2)) 1))))))
(assert (=> (and (<= (to_rep1 (first4 (rt2 a))) i2) (<= i2 (to_rep1 (last4 (rt2 a))))) (and (= o1 o) (in_range1 o))))
(assert (=> (and (<= (to_rep1 (first4 (rt2 a))) i2) (<= i2 (to_rep1 (last4 (rt2 a))))) (= (to_rep o2) o1)))
(assert (=> (and (<= (to_rep1 (first4 (rt2 a))) i2) (<= i2 (to_rep1 (last4 (rt2 a))))) (= o3 (store r i2 o2))))
(assert (=> (and (<= (to_rep1 (first4 (rt2 a))) i2) (<= i2 (to_rep1 (last4 (rt2 a))))) (= (mk_map__ref result1) r14)))
(assert (=> (and (<= (to_rep1 (first4 (rt2 a))) i2) (<= i2 (to_rep1 (last4 (rt2 a))))) (= r2 o3)))
(assert (=> (and (<= (to_rep1 (first4 (rt2 a))) i2) (<= i2 (to_rep1 (last4 (rt2 a))))) (forall ((k Int)) (=> (and (<= (to_rep1 (first4 (rt2 a))) k) (<= k i3)) (= (to_rep (select r3 k)) (add_one (to_rep (select (elts2 a) k))))))))
(assert (=> (and (<= (to_rep1 (first4 (rt2 a))) i2) (<= i2 (to_rep1 (last4 (rt2 a))))) (and (and (=> (<= (to_rep1 (first4 (rt2 a))) (to_rep1 (last4 (rt2 a)))) (dynamic_property5 (to_rep1 (first4 (rt2 a))) (to_rep1 (last4 (rt2 a))) i3)) (forall ((temp___372 Int)) (=> (and (<= (to_rep1 r__first) temp___372) (<= temp___372 (to_rep1 r__last))) (=> (or (< (to_rep1 (last4 (rt2 a))) temp___372) (or (< temp___372 (to_rep1 (first4 (rt2 a)))) (< i3 temp___372))) (= (select r3 temp___372) (select temp___371 temp___372)))))) (and (<= (to_rep1 (first4 (rt2 a))) i3) (<= i3 (to_rep1 (last4 (rt2 a))))))))
(assert (=> (and (<= (to_rep1 (first4 (rt2 a))) i2) (<= i2 (to_rep1 (last4 (rt2 a))))) (= i3 (to_rep1 (last4 (rt2 a))))))
(assert (=> (and (<= (to_rep1 (first4 (rt2 a))) i2) (<= i2 (to_rep1 (last4 (rt2 a))))) (= i3 i4)))
(assert (=> (and (<= (to_rep1 (first4 (rt2 a))) i2) (<= i2 (to_rep1 (last4 (rt2 a))))) (= r3 r4)))
(assert (=> (and (<= (to_rep1 (first4 (rt2 a))) i2) (<= i2 (to_rep1 (last4 (rt2 a))))) (= i5 i3)))
(assert (=> (and (<= (to_rep1 (first4 (rt2 a))) i2) (<= i2 (to_rep1 (last4 (rt2 a))))) (= r5 r3)))
(assert (=> (and (<= (to_rep1 (first4 (rt2 a))) i2) (<= i2 (to_rep1 (last4 (rt2 a))))) (= i13 (mk_int__ref i4))))
(assert (=> (and (<= (to_rep1 (first4 (rt2 a))) i2) (<= i2 (to_rep1 (last4 (rt2 a))))) (= r13 (mk_map__ref r4))))
(assert (=> (and (<= (to_rep1 (first4 (rt2 a))) i2) (<= i2 (to_rep1 (last4 (rt2 a))))) (= i7 i5)))
(assert (=> (and (<= (to_rep1 (first4 (rt2 a))) i2) (<= i2 (to_rep1 (last4 (rt2 a))))) (= r7 r5)))
(assert (=> (not (and (<= (to_rep1 (first4 (rt2 a))) i2) (<= i2 (to_rep1 (last4 (rt2 a)))))) (= i2 i6)))
(assert (=> (not (and (<= (to_rep1 (first4 (rt2 a))) i2) (<= i2 (to_rep1 (last4 (rt2 a)))))) (= r13 r14)))
(assert (=> (not (and (<= (to_rep1 (first4 (rt2 a))) i2) (<= i2 (to_rep1 (last4 (rt2 a)))))) (= i7 i2)))
(assert (=> (not (and (<= (to_rep1 (first4 (rt2 a))) i2) (<= i2 (to_rep1 (last4 (rt2 a)))))) (= r7 r1)))
...
(assert (= i11 i9))
(assert (= r11 r9))
(assert (= (to_rep1 (first (rt (array_2__content test_higher_order__add_all__result7)))) (to_rep1 (first4 (rt2 a)))))
(assert (= (to_rep1 (last (rt (array_2__content test_higher_order__add_all__result7)))) (to_rep1 (last4 (rt2 a)))))
(assert (<= (to_rep1 (first4 (rt2 a))) i1))
(assert (<= i1 (to_rep1 (last4 (rt2 a)))))
(assert (and (<= (to_rep1 (first4 (rt2 a))) i1) (<= i1 (to_rep1 (last4 (rt2 a))))))
(assert (= o4 i1))
(assert (= o5 (select (elts2 a) o4)))
(assert (= o6 (to_rep o5)))
(assert (and (= o7 (add_one o6)) (and (in_range3 o7) (= o7 (+ o6 1)))))
(assert (not (<= (to_rep1 (first (rt (array_2__content test_higher_order__add_all__result7)))) i1)))
(check-sat)
(exit)
