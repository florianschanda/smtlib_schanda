...
(assert (forall ((us_void_param tuple0)) (! (= (to_rep (select (temp___String_Literal_902 us_void_param) 1)) 58) :pattern ((temp___String_Literal_902 us_void_param)))))
(declare-fun temp___String_Literal_903 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (= (to_rep (select (temp___String_Literal_903 us_void_param) 1)) 58) :pattern ((temp___String_Literal_903 us_void_param)))))
(declare-fun temp___String_Literal_904 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_904 us_void_param) 1)) 58) (= (to_rep (select (temp___String_Literal_904 us_void_param) 2)) 32)) :pattern ((temp___String_Literal_904 us_void_param)))))
...
(assert (and (= us (to_rep4 (rec__lexer__token__kind (us_split_discrs3 t1)))) (in_range6 (to_rep4 (rec__lexer__token__kind (us_split_discrs3 t1))))))
