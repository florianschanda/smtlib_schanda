...
(assert (and (= o51 (+ a_first length1)) (in_range1 (+ a_first length1))))
(assert (= o52 (+ o51 j2)))
(assert (and (= temp___255 o52) (in_range1 o52)))
(assert (and (<= (to_rep a__first) temp___255) (<= temp___255 (to_rep a__last))))
(assert (= o53 temp___255))
(assert (= o54 (select a o53)))
(assert (= o55 (to_rep o54)))
(assert (= (to_rep o56) o55))
(assert (and (= o49 (+ i2 j2)) (in_range1 (+ i2 j2))))
(assert (= o50 (+ (to_rep b__first) o49)))
(assert (and (= temp___256 o50) (in_range1 o50)))
(assert (and (<= (to_rep b__first) temp___256) (<= temp___256 (to_rep b__last))))
(assert (= o57 temp___256))
(assert (= o58 (store b1 o57 o56)))
(assert (= b1 result5))
(assert (= b3 o58))
