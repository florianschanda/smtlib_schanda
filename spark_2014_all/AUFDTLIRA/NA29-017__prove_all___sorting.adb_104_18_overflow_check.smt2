...
(assert (and (= temp___285 o9) (in_range1 o9)))
(assert (and (<= (to_rep b__first) temp___285) (<= temp___285 (to_rep b__last))))
(assert (= o16 temp___285))
