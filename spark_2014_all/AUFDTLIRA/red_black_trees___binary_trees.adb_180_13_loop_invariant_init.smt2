...
(assert (<= j 100))
(assert (not (= j root)))
(assert (not (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j)))) 0)))
(assert (= (rec__tree_model__path_type__k (us_split_fields1 (select r1 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j))))))) true))
(assert (not (or (= (rec__tree_model__path_type__k (us_split_fields1 (select r1 j))) true) (= (select todo2 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j))))) true))))
(check-sat)
(exit)
