...
(declare-const p__split_fields10 (Array Int us_rep))
(declare-const p__split_fields11 (Array Int us_rep))
(declare-const c5 Int)
(declare-const p__split_fields12 (Array Int us_rep))
(declare-const p__split_fields13 (Array Int us_rep))
(declare-const c6 Int)
(declare-const p__split_fields14 us_split_fields2)
(declare-const c7 Int)
(declare-const p__split_fields15 us_split_fields__ref1)
(declare-const c8 int__ref)
(declare-const p__split_fields16 us_split_fields2)
(declare-const c9 Int)
(declare-const p__split_fields17 us_split_fields__ref1)
(declare-const c10 int__ref)
(declare-const p__split_fields18 us_split_fields2)
(declare-const c11 Int)
(assert (exists ((c12 Int)) (and (and (<= 0 c12) (<= c12 2)) (= (bool_eq (select p__split_fields c12) d) true))))
