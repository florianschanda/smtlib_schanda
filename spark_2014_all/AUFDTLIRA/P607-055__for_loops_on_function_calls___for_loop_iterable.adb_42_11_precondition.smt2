...
(assert (= e3 0))
(assert (and (= o2 (next (rec__for_loop_iterable__container_holder__content h__split_fields3) temp___2621)) (and (in_range3 o2) (= o2 (ite (= temp___2621 100) 0 (+ temp___2621 1))))))
(assert (and (= o3 (has_element (rec__for_loop_iterable__container_holder__content h__split_fields3) o2)) (= (= o3 true) (in_range2 o2))))
(assert (= result7 (ite (not (= o3 true)) true false)))
(assert (not (= result7 true)))
(assert (and (= o4 (next (rec__for_loop_iterable__container_holder__content h__split_fields3) temp___2621)) (and (in_range3 o4) (= o4 (ite (= temp___2621 100) 0 (+ temp___2621 1))))))
(assert (= result8 (mk_int__ref temp___2621)))
