...
(declare-fun temp___281 (Int) (Array Int character))
...
(assert (forall ((temp___283 Int)) (=> (dynamic_invariant3 temp___283 true true true true) (forall ((temp___284 Int)) (= (to_rep (select (temp___281 temp___283) temp___284)) temp___283)))))
...
(assert (and (and (=> (<= 1 r14b) (dynamic_property1 1 r14b index2)) (forall ((temp___288 Int)) (=> (and (<= 1 temp___288) (<= temp___288 1024)) (=> (<= index2 temp___288) (= (select buffer2 temp___288) (select buffer1 temp___288)))))) (and (<= 1 index2) (<= index2 r14b))))
(assert (and (= temp___285 (+ (to_rep1 (first (rt source))) (- index2 1))) (in_range1 (+ (to_rep1 (first (rt source))) (- index2 1)))))
(assert (not (<= (to_rep1 (first (rt source))) temp___285)))
(check-sat)
(exit)
