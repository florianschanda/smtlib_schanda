...
(define-fun dynamic_invariant1 ((temp___expr_135 Int) (temp___is_init_132 Bool) (temp___skip_constant_133 Bool) (temp___do_toplevel_134 Bool)) Bool (=> (or (= temp___is_init_132 true) (<= 0 1024)) (in_range4 temp___expr_135)))
...
(assert (forall ((temp___255 Int)) (forall ((temp___256 Int)) (= (select (temp___253 temp___255) temp___256) (of_rep temp___255)))))
...
(define-fun dynamic_invariant5 ((temp___expr_141 Int) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool (=> (or (= temp___is_init_138 true) (<= 1 1024)) (in_range5 temp___expr_141)))
...
(assert (and (and (=> (<= 1 r14b) (dynamic_property1 1 r14b index2)) (forall ((temp___260 Int)) (=> (and (<= 1 temp___260) (<= temp___260 1024)) (=> (<= index2 temp___260) (= (select buffer2 temp___260) (select buffer1 temp___260)))))) (and (<= 1 index2) (<= index2 r14b))))
(assert (and (= temp___257 (+ (to_rep1 (first (rt source))) (- index2 1))) (in_range1 (+ (to_rep1 (first (rt source))) (- index2 1)))))
(assert (not (<= (to_rep1 (first (rt source))) temp___257)))
(check-sat)
(exit)
