...
(define-fun dynamic_invariant1 ((temp___expr_158 Int) (temp___is_init_154 Bool) (temp___skip_constant_155 Bool) (temp___do_toplevel_156 Bool) (temp___do_typ_inv_157 Bool)) Bool (=> (or (= temp___is_init_154 true) (<= 0 1024)) (in_range4 temp___expr_158)))
...
(declare-fun temp_____aggregate_def_281 (Int) (Array Int character))
...
(assert (forall ((temp___283 Int)) (=> (dynamic_invariant3 temp___283 true true true true) (forall ((temp___284 Int)) (= (to_rep (select (temp_____aggregate_def_281 temp___283) temp___284)) temp___283)))))
(define-fun dynamic_invariant5 ((temp___expr_165 Int) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool) (temp___do_typ_inv_164 Bool)) Bool (=> (or (= temp___is_init_161 true) (<= 1 1024)) (in_range5 temp___expr_165)))
...
(assert (and (and (=> (<= 1 r14b) (dynamic_property1 1 r14b index2)) (forall ((temp___290 Int)) (=> (and (<= 1 temp___290) (<= temp___290 1024)) (=> (or (< r14b temp___290) (or (< temp___290 1) (<= index2 temp___290))) (= (select buffer2 temp___290) (select buffer1 temp___290)))))) (and (<= 1 index2) (<= index2 r14b))))
(assert (and (= temp___287 (+ (to_rep1 (first (rt source))) (- index2 1))) (in_range1 (+ (to_rep1 (first (rt source))) (- index2 1)))))
(assert (not (<= temp___287 (to_rep1 (last (rt source))))))
(check-sat)
(exit)
