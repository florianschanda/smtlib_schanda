...
(define-fun dynamic_invariant2 ((temp___expr_201 us_t) (temp___is_init_197 Bool) (temp___skip_constant_198 Bool) (temp___do_toplevel_199 Bool) (temp___do_typ_inv_200 Bool)) Bool (and (=> (not (= temp___skip_constant_198 true)) (dynamic_property (- 2147483648) 2147483647 (first1 temp___expr_201) (last1 temp___expr_201))) (=> (= temp___do_toplevel_199 true) (=> (= temp___is_init_197 true) (and (<= (first1 temp___expr_201) 1) (<= 3 (last1 temp___expr_201)))))))
(define-fun dynamic_predicate ((temp___204 us_t)) Bool (and (<= (first1 temp___204) 1) (<= 3 (last1 temp___204))))
(assert (and (dynamic_property (- 2147483648) 2147483647 (to_rep a__first) (to_rep a__last)) (and (<= (to_rep a__first) 1) (<= 3 (to_rep a__last)))))
(assert (not (<= 3 (to_rep a__last))))
(check-sat)
(exit)
