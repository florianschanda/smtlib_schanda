...
(declare-const temp___451 (Array Int element))
(declare-const temp___4511 less_than_max)
(declare-const temp___4512 us_private)
(declare-const temp___4513 Int)
(assert (and (= temp___4513 us_tag) (= (to_rep temp___4511) 0)))
(assert (not (= (size (mk___rep (mk___split_fields temp___451 temp___4511 temp___4512) temp___4513)) 0)))
(check-sat)
(exit)
