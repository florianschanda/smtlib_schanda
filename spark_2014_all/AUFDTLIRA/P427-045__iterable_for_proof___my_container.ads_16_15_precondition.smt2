...
(define-fun temp___1781 () us_rep (mk___rep (mk___split_fields temp___178)))
(define-fun c11 () map__ref (mk_map__ref c))
(assert (= (mk_int__ref result) (mk_int__ref i)))
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 100)) (= temp___174 i1)))
(assert (=> (and (<= 1 i1) (<= i1 100)) (= temp___172 c)))
...
(assert (=> (and (<= 1 i1) (<= i1 100)) (and (and (forall ((temp___173 Int)) (=> (and (<= 1 temp___173) (<= temp___173 100)) (=> (< i2 temp___173) (= (select c3 temp___173) (select temp___172 temp___173))))) (=> (<= 1 100) (in_range3 i2))) (and (<= 1 i2) (<= i2 100)))))
...
(assert (= i8 i6))
(assert (= c9 c7))
(assert (and (= o2 (has_element c8 temp___1781)) (= (= o2 true) (and (<= 1 (to_rep temp___178)) (<= (to_rep temp___178) 100)))))
(assert (= o3 true))
(assert (= result2 (ite (= o3 true) o2 false)))
(assert (= result2 true))
(assert (not (= (has_element c8 temp___1781) true)))
(check-sat)
(exit)
