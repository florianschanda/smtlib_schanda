...
(assert (not (= (let ((temp___1132 (value (mk___rep to____split_discrs (us_split_fields__content to____split_fields5))))) (bool_eq (elts temp___1132) (to_rep1 (first (rt temp___1132))) (to_rep1 (last (rt temp___1132))) (elts source) (to_rep1 (first (rt source))) (to_rep1 (last (rt source))))) true)))
(check-sat)
(exit)
