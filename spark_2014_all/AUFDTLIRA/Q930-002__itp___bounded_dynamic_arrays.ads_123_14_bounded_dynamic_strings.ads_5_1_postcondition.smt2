...
(assert (dynamic_predicate (mk___rep (mk___split_discrs temp___1061) (mk___split_fields temp___10611 (mk___t1 temp___10612 temp___10613)))))
(assert (= temp___1062 (mk___rep (mk___split_discrs temp___1061) (mk___split_fields temp___10611 (mk___t1 temp___10612 temp___10613)))))
(assert (= result1 (mk___split_fields__ref to____split_fields3)))
(assert (= to____split_fields4 (us_split_fields1 temp___1062)))
(assert (= to____split_discrs (us_split_discrs1 temp___1062)))
(assert (= to____split_fields5 (mk___split_fields__ref to____split_fields4)))
(assert (= to____split_fields6 to____split_fields4))
(assert (not (= (let ((temp___1069 (value (mk___rep to____split_discrs (us_split_fields__content to____split_fields5))))) (bool_eq (elts temp___1069) (to_rep1 (first (rt temp___1069))) (to_rep1 (last (rt temp___1069))) (elts source) (to_rep1 (first (rt source))) (to_rep1 (last (rt source))))) true)))
(check-sat)
(exit)
