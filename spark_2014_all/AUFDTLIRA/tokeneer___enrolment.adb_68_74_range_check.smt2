...
(assert (not (= (length (mk___t temp___1607 temp___16071)) 0)))
...
(assert (=> (<= (to_rep1 (first temp___16071)) (to_rep1 (last temp___16071))) (= o13 (+ (- (to_rep1 (last temp___16071)) (to_rep1 (first temp___16071))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___16071)) (to_rep1 (last temp___16071)))) (= o13 0)))
(assert (= o14 (+ o13 o12)))
(assert (= o15 (+ (to_rep1 (first temp___16071)) o14)))
(assert (= o16 (- o15 1)))
