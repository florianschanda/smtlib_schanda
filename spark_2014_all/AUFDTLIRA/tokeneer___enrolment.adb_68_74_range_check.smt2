...
(assert (not (= (length (mk___t temp___1771 temp___17711)) 0)))
...
(assert (=> (<= (to_rep1 (first temp___17711)) (to_rep1 (last temp___17711))) (= o13 (+ (- (to_rep1 (last temp___17711)) (to_rep1 (first temp___17711))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___17711)) (to_rep1 (last temp___17711)))) (= o13 0)))
(assert (= o14 (+ o13 o12)))
(assert (= o15 (+ (to_rep1 (first temp___17711)) o14)))
(assert (= o16 (- o15 1)))
