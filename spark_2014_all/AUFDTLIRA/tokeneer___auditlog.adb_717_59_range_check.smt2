...
(assert (forall ((x fileentrycountt)) (! (in_range4 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun dynamic_invariant2 ((temp___expr_925 Int) (temp___is_init_922 Bool) (temp___skip_constant_923 Bool) (temp___do_toplevel_924 Bool)) Bool (=> (or (= temp___is_init_922 true) (<= 1 17)) (in_range6 temp___expr_925)))
...
(define-fun dynamic_invariant3 ((temp___expr_1049 Int) (temp___is_init_1046 Bool) (temp___skip_constant_1047 Bool) (temp___do_toplevel_1048 Bool)) Bool (=> (or (= temp___is_init_1046 true) (<= 0 17408)) (in_range9 temp___expr_1049)))
...
(define-fun dynamic_invariant5 ((temp___expr_919 Int) (temp___is_init_916 Bool) (temp___skip_constant_917 Bool) (temp___do_toplevel_918 Bool)) Bool (=> (or (= temp___is_init_916 true) (<= 0 17)) (in_range5 temp___expr_919)))
(define-fun dynamic_invariant6 ((temp___expr_931 Int) (temp___is_init_928 Bool) (temp___skip_constant_929 Bool) (temp___do_toplevel_930 Bool)) Bool (=> (or (= temp___is_init_928 true) (<= 0 2)) (in_range7 temp___expr_931)))
(define-fun dynamic_invariant7 ((temp___expr_1055 Int) (temp___is_init_1052 Bool) (temp___skip_constant_1053 Bool) (temp___do_toplevel_1054 Bool)) Bool (=> (or (= temp___is_init_1052 true) (<= 0 1024)) (in_range4 temp___expr_1055)))
...
(assert (not (in_range9 (- (to_rep2 usedlogfiles__split_fields) 1))))
(check-sat)
(exit)
