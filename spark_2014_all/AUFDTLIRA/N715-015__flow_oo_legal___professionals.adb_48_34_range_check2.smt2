...
(assert (=> (= (length temp___11442) 0) (= (temp___String_Literal_1143 Tuple0) o7)))
(assert (=> (= (length temp___11442) 0) (= (mk 1 4) o8)))
(assert (=> (not (= (length temp___11442) 0)) (=> (<= 1 4) (= o1 (+ (- 4 1) 1)))))
(assert (=> (not (= (length temp___11442) 0)) (=> (not (<= 1 4)) (= o1 0))))
(assert (=> (not (= (length temp___11442) 0)) (=> (<= (to_rep1 (first temp___11441)) (to_rep1 (last temp___11441))) (= o2 (+ (- (to_rep1 (last temp___11441)) (to_rep1 (first temp___11441))) 1)))))
(assert (=> (not (= (length temp___11442) 0)) (=> (not (<= (to_rep1 (first temp___11441)) (to_rep1 (last temp___11441)))) (= o2 0))))
(assert (=> (not (= (length temp___11442) 0)) (= o3 (+ o2 o1))))
(assert (=> (not (= (length temp___11442) 0)) (= o4 (+ (to_rep1 (first temp___11441)) o3))))
(assert (=> (not (= (length temp___11442) 0)) (= o5 (- o4 1))))
(assert (=> (not (= (length temp___11442) 0)) (and (= o6 o5) (in_range1 o5))))
(assert (=> (not (= (length temp___11442) 0)) (= (concat1 temp___1144 (to_rep1 (first temp___11441)) (to_rep1 (last temp___11441)) (temp___String_Literal_1143 Tuple0) 1 4) o7)))
(assert (=> (not (= (length temp___11442) 0)) (= (mk (to_rep1 (first temp___11441)) o6) o8)))
(assert (= result (is_alive (mk___rep (mk___split_fields (rec__people__person__name1 (us_split_fields3 this)) (rec__people__person__dob1 (us_split_fields3 this)) (rec__people__person__alive1 (us_split_fields3 this)) (hide_ext__ (rec__professionals__professional__profession (us_split_fields3 this)) (rec__professionals__professional__skilled_in (us_split_fields3 this)) (rec__professionals__professional__number_of_people_killed (us_split_fields3 this)) (rec__ext__1 (us_split_fields3 this)))) (attr__tag1 this)))))
(assert (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep3 (rec__professionals__professional__profession (us_split_fields3 this)))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep3 (rec__professionals__professional__profession (us_split_fields3 this))))))))) (= o9 (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep3 (rec__professionals__professional__profession (us_split_fields3 this)))))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep3 (rec__professionals__professional__profession (us_split_fields3 this))))))))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep3 (rec__professionals__professional__profession (us_split_fields3 this)))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep3 (rec__professionals__professional__profession (us_split_fields3 this)))))))))) (= o9 0)))
...
(assert (= o15 (concat1 (temp___String_Literal_1148 Tuple0) 1 12 (elts (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep3 (rec__professionals__professional__profession (us_split_fields3 this)))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep3 (rec__professionals__professional__profession (us_split_fields3 this)))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep3 (rec__professionals__professional__profession (us_split_fields3 this)))))))))))
(assert (= o16 (mk 1 o14)))
(assert (= result1 i))
(assert (= i1 1))
(assert (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep4 (select (rec__professionals__professional__skilled_in (us_split_fields3 this)) i1))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep4 (select (rec__professionals__professional__skilled_in (us_split_fields3 this)) i1)))))))) (= o17 (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep4 (select (rec__professionals__professional__skilled_in (us_split_fields3 this)) i1))))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep4 (select (rec__professionals__professional__skilled_in (us_split_fields3 this)) i1)))))))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep4 (select (rec__professionals__professional__skilled_in (us_split_fields3 this)) i1))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep4 (select (rec__professionals__professional__skilled_in (us_split_fields3 this)) i1))))))))) (= o17 0)))
