...
(define-fun dynamic_invariant1 ((temp___expr_525 Int) (temp___is_init_522 Bool) (temp___skip_constant_523 Bool) (temp___do_toplevel_524 Bool)) Bool (=> (or (= temp___is_init_522 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_525)))
...
(assert (<= 2 i1))
(assert (<= i1 r35b))
(assert (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 (- i2 1))) (<= (to_rep1 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) j3)) res2))))
