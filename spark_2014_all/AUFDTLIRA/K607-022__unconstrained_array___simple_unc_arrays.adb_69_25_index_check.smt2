...
(assert (<= 2 i1))
(assert (<= i1 r35b))
(assert (forall ((j Int)) (=> (and (<= 1 j) (<= j (- i2 1))) (<= (to_rep1 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) j)) res2))))
(assert (and (and (=> (<= (- 2147483648) 2147483647) (in_range2 res2)) (=> (<= 2 r35b) (dynamic_property2 2 r35b i2))) (and (<= 2 i2) (<= i2 r35b))))
...
(assert (= result2 (ite (< res2 o5) true false)))
(assert (= result2 true))
