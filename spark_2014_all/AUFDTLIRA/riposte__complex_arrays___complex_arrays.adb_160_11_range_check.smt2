...
(assert (= j1 0))
(assert (=> (and (<= 0 j1) (<= j1 i)) (= temp___273 i)))
(assert (=> (and (<= 0 j1) (<= j1 i)) (= temp___272 j1)))
(assert (=> (and (<= 0 j1) (<= j1 i)) (= temp___270 tmp1)))
...
(assert (=> (and (<= 0 j1) (<= j1 i)) (and (forall ((k Int)) (=> (and (<= 0 k) (<= k j2)) (=> (<= k j2) (= (to_rep (select tmp3 k)) (- 23))))) (= i temp___273))))
(assert (=> (and (<= 0 j1) (<= j1 i)) (and (and (forall ((temp___271 Int)) (=> (and (<= 0 temp___271) (<= temp___271 1001)) (=> (< j2 temp___271) (= (select tmp3 temp___271) (select temp___270 temp___271))))) (=> (<= 0 i) (dynamic_property 0 i j2))) (and (<= 0 j2) (<= j2 i)))))
