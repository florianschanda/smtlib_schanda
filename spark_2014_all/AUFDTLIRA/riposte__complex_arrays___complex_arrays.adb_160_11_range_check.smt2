...
(assert (= j1 0))
(assert (=> (and (<= 0 j1) (<= j1 i)) (= temp___245 i)))
(assert (=> (and (<= 0 j1) (<= j1 i)) (= temp___244 j1)))
(assert (=> (and (<= 0 j1) (<= j1 i)) (= temp___242 tmp1)))
(assert (=> (and (<= 0 j1) (<= j1 i)) (= (to_rep o) (- 23))))
(assert (=> (and (<= 0 j1) (<= j1 i)) (= o1 (store tmp1 j1 o))))
(assert (=> (and (<= 0 j1) (<= j1 i)) (= tmp1 result2)))
(assert (=> (and (<= 0 j1) (<= j1 i)) (= tmp2 o1)))
(assert (=> (and (<= 0 j1) (<= j1 i)) (and (forall ((k Int)) (=> (and (<= 0 k) (<= k j2)) (=> (<= k j2) (= (to_rep (select tmp3 k)) (- 23))))) (= i temp___245))))
(assert (=> (and (<= 0 j1) (<= j1 i)) (and (and (forall ((temp___243 Int)) (=> (and (<= 0 temp___243) (<= temp___243 1001)) (=> (< j2 temp___243) (= (select tmp3 temp___243) (select temp___242 temp___243))))) (=> (<= 0 i) (dynamic_property 0 i j2))) (and (<= 0 j2) (<= j2 i)))))
