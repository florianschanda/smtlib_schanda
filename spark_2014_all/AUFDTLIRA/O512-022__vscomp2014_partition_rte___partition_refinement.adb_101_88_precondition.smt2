...
(assert (and (= o73 (key (mk___rep d__split_discrs d__split_fields1) c3)) (and (in_range7 o73) (= o73 (get (keys (mk___rep d__split_discrs d__split_fields1)) (get1 (positions (mk___rep d__split_discrs d__split_fields1)) c3))))))
