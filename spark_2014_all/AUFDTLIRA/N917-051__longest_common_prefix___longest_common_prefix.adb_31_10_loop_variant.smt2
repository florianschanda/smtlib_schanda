...
(assert (=> (= result7 true) (and (= temp___1931 (+ y l3)) (in_range1 (+ y l3)))))
(assert (=> (= result7 true) (and (<= 1 temp___1931) (<= temp___1931 1000))))
(assert (=> (= result7 true) (= o11 temp___1931)))
(assert (=> (= result7 true) (= o12 (select a o11))))
(assert (=> (= result7 true) (= o13 (to_rep o12))))
(assert (=> (= result7 true) (and (= temp___1921 (+ x l3)) (in_range1 (+ x l3)))))
(assert (=> (= result7 true) (and (<= 1 temp___1921) (<= temp___1921 1000))))
(assert (=> (= result7 true) (= o9 temp___1921)))
