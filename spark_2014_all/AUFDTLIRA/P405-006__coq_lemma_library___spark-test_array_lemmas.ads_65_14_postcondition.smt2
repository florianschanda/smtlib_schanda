...
(assert (forall ((i Int)) (=> (and (<= (to_rep (first2 o1)) i) (<= i (to_rep (last2 o1)))) (forall ((j Int)) (=> (and (<= (to_rep (first2 o1)) j) (<= j (to_rep (last2 o1)))) (=> (< i j) (< (to_rep (select o i)) (to_rep (select o j)))))))))
(declare-const i Int)
