...
(declare-const o8 count_type)
(declare-const c2 count_type)
...
(assert (in_range1 k))
(assert (and (= (has_key1 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) k) true) (forall ((c3 us_rep1)) (=> (= (has_key (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields))) c3) true) (= (to_rep (select (elts a) (element (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c3))) (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c3))))))
(assert (= (mk___rep d__split_discrs (mk___split_fields d__split_fields)) d_old))
(assert (forall ((c3 us_rep1)) (=> (= (has_key (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields))) c3) true) (=> (not (= (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c3) k)) (= (to_rep (select (elts a) (element (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c3))) (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c3))))))
(assert (and (= (mk___rep1 (mk___split_fields1 o8)) (find1 (mk___rep d__split_discrs (mk___split_fields d__split_fields)) k)) (ite (ite (= (has_key1 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) k) false) true false) (and (not (= (has_key (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields))) (mk___rep1 (mk___split_fields1 o8))) true)) (= (bool_eq3 (mk___rep1 (mk___split_fields1 o8)) no_element) true)) (and (and (= (has_key (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields))) (mk___rep1 (mk___split_fields1 o8))) true) (= (get1 (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields))) (mk___rep1 (mk___split_fields1 o8))) (find (keys (mk___rep d__split_discrs (mk___split_fields d__split_fields))) k))) (= (equivalent_keys (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) (mk___rep1 (mk___split_fields1 o8))) k) true)))))
(assert (and (and (and (and (= (oeq2 (keys (mk___rep d__split_discrs (mk___split_fields replacement__inverse_sets__replace_element__container__fields))) (keys (mk___rep d__split_discrs (mk___split_fields d__split_fields)))) true) (= (oeq3 (positions (mk___rep d__split_discrs (mk___split_fields replacement__inverse_sets__replace_element__container__fields))) (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields)))) true)) (= (element (mk___rep d__split_discrs (mk___split_fields replacement__inverse_sets__replace_element__container__fields)) (mk___rep1 (mk___split_fields1 o8))) 0)) (= (same_keys (model__ (mk___rep d__split_discrs (mk___split_fields replacement__inverse_sets__replace_element__container__fields))) (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields)))) true)) (= (elements_equal_except (model__ (mk___rep d__split_discrs (mk___split_fields replacement__inverse_sets__replace_element__container__fields))) (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) (key (mk___rep d__split_discrs (mk___split_fields replacement__inverse_sets__replace_element__container__fields)) (mk___rep1 (mk___split_fields1 o8)))) true)))
(assert (= result4 d__split_fields))
(assert (= (mk___split_fields d__split_fields1) (mk___split_fields replacement__inverse_sets__replace_element__container__fields)))
(declare-const c3 us_rep1)
(assert (= (has_key (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields1))) c3) true))
(assert (not (= (key (mk___rep d__split_discrs (mk___split_fields d__split_fields1)) c3) k)))
(assert (not (= (to_rep (select (elts a) (element (mk___rep d__split_discrs (mk___split_fields d__split_fields1)) c3))) (key (mk___rep d__split_discrs (mk___split_fields d__split_fields1)) c3))))
(check-sat)
(exit)
