...
(define-fun dynamic_invariant1 ((temp___expr_290 us_t) (temp___is_init_287 Bool) (temp___skip_constant_288 Bool) (temp___do_toplevel_289 Bool)) Bool (=> (not (= temp___skip_constant_288 true)) (dynamic_property (- 2147483648) 2147483647 (first1 temp___expr_290) (last1 temp___expr_290))))
...
(define-fun bool_eq3 ((a us_rep1) (b us_rep1)) Bool (ite (= (to_rep1 (rec__replacement__inverse_sets__cursor__node (us_split_fields3 a))) (to_rep1 (rec__replacement__inverse_sets__cursor__node (us_split_fields3 b)))) true false))
...
(define-fun map__ref___3__projection ((a map__ref2)) us_rep2 (map__content2 a))
...
(define-fun dynamic_invariant2 ((temp___expr_295 Int) (temp___is_init_292 Bool) (temp___skip_constant_293 Bool) (temp___do_toplevel_294 Bool)) Bool (=> (or (= temp___is_init_292 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_295)))
...
(define-fun map__ref___2__projection ((a map__ref3)) us_rep4 (map__content3 a))
...
(define-fun dynamic_invariant3 ((temp___expr_301 Int) (temp___is_init_298 Bool) (temp___skip_constant_299 Bool) (temp___do_toplevel_300 Bool)) Bool (=> (or (= temp___is_init_298 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_301)))
...
(define-fun oeq2 ((left us_rep3) (right us_rep3)) Bool (and (= (length1 left) (length1 right)) (ite (forall ((n Int)) (=> (and (<= 1 n) (<= n (last2 left))) (= (get left n) (get right n)))) true false)))
...
(assert (forall ((container us_rep)) (forall ((key2 Int)) (! (=> (dynamic_invariant2 key2 true true true) (let ((result (find1 container key2))) (ite (not (= (has_key1 (model__ container) key2) true)) (and (not (= (has_key (positions container) result) true)) (= (bool_eq3 result no_element) true)) (and (and (= (has_key (positions container) result) true) (= (get1 (positions container) result) (find (keys container) key2))) (= (equivalent_keys (key container result) key2) true))))) :pattern ((find1 container key2))))))
(assert true)
...
(define-fun dynamic_invariant4 ((temp___expr_143 Int) (temp___is_init_140 Bool) (temp___skip_constant_141 Bool) (temp___do_toplevel_142 Bool)) Bool (=> (or (= temp___is_init_140 true) (<= 0 2147483647)) (in_range2 temp___expr_143)))
...
(assert (forall ((container us_rep)) (! (let ((result (length2 container))) (and (<= result (to_rep1 (rec__replacement__inverse_sets__map__capacity (us_split_discrs1 container)))) (dynamic_invariant4 result true false true))) :pattern ((length2 container)))))
(assert (forall ((attr__tag Int)) (forall ((container us_rep)) (! (dynamic_invariant4 (length3 attr__tag container) true false true) :pattern ((length3 attr__tag container))))))
...
(define-fun k_is_find ((container us_rep3) (key2 Int) (position Int)) Bool (and (ite (< 0 position) (k_bigger_than_range container 1 (- position 1) key2) (of_int 1)) (ite (< position (length1 container)) (k_smaller_than_range container (+ position 1) (length1 container) key2) (of_int 1))))
(declare-fun k_is_find__function_guard (Bool us_rep3 Int Int) Bool)
(assert (forall ((a1 us_rep3) (b us_rep3)) (! (= (user_eq6 a1 b) (oeq2 a1 b)) :pattern ((user_eq6 a1 b)))))
(define-fun default_initial_assumption ((temp___expr_371 us_rep3) (temp___skip_top_level_372 Bool)) Bool (=> (not (= temp___skip_top_level_372 true)) (= (length1 temp___expr_371) 0)))
(assert (forall ((container us_rep3)) (forall ((key2 Int)) (! (=> (dynamic_invariant2 key2 true true true) (let ((result (find container key2))) (and (=> (< 0 result) (and (<= result (length1 container)) (= (equivalent_keys key2 (get container result)) true))) (dynamic_invariant4 result true false true)))) :pattern ((find container key2))))))
...
(define-fun default_initial_assumption1 ((temp___expr_340 us_rep4) (temp___skip_top_level_341 Bool)) Bool (=> (not (= temp___skip_top_level_341 true)) (and (= (is_empty temp___expr_340) true) (= (length4 temp___expr_340) 0))))
(assert true)
...
(assert (forall ((container us_rep)) (! (let ((result (keys container))) (and (and (and (= (length1 result) (length2 container)) (forall ((temp___405 Int)) (=> (and (in_range6 temp___405) (= (iter_has_element result temp___405) true)) (= (has_key1 (model__ container) (get result temp___405)) true)))) (forall ((key2 Int)) (=> (and (in_range5 key2) (= (has_key1 (model__ container) key2) true)) (and (< 0 (find result key2)) (= (equivalent_keys (get result (find result key2)) key2) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length2 container))) (and (= (find result (get result i)) i) (= (k_is_find result (get result i) i) true)))))) :pattern ((keys container)))))
...
(define-fun default_initial_assumption2 ((temp___expr_391 us_rep2) (temp___skip_top_level_392 Bool)) Bool (=> (not (= temp___skip_top_level_392 true)) (and (= (is_empty1 temp___expr_391) true) (= (length5 temp___expr_391) 0))))
(assert (forall ((container us_rep)) (! (let ((result (positions container))) (and (not (= (has_key result no_element) true)) (forall ((i us_rep1)) (=> (= (has_key result i) true) (and (and (<= 1 (get1 result i)) (<= (get1 result i) (length2 container))) (forall ((j us_rep1)) (=> (= (has_key result j) true) (=> (= (get1 result i) (get1 result j)) (= (bool_eq3 i j) true))))))))) :pattern ((positions container)))))
...
(assert true)
(define-fun dynamic_invariant5 ((temp___expr_327 Int) (temp___is_init_324 Bool) (temp___skip_constant_325 Bool) (temp___do_toplevel_326 Bool)) Bool (=> (or (= temp___is_init_324 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_327)))
(assert (forall ((container us_rep4)) (forall ((key2 Int)) (! (=> (dynamic_invariant5 key2 true true true) (=> (= (of_int 1) true) (=> (exists ((k1 Int)) (and (and (in_range5 k1) (= (has_key1 container k1) true)) (= (equivalent_keys k1 key2) true))) (= (has_key1 container key2) true)))) :pattern ((has_key1 container key2))))))
...
(define-fun dynamic_invariant6 ((temp___expr_333 Int) (temp___is_init_330 Bool) (temp___skip_constant_331 Bool) (temp___do_toplevel_332 Bool)) Bool (=> (or (= temp___is_init_330 true) (<= (- 2147483648) 2147483647)) (in_range7 temp___expr_333)))
...
(assert (forall ((container us_rep4)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant5 key2 true true true) (= (has_key1 container key2) true)) (let ((result (get2 container key2))) (and (=> (= (of_int 1) true) (and (= result (w_get container (witness container key2))) (forall ((k1 Int)) (=> (and (in_range5 k1) (= (has_key1 container k1) true)) (= (= (equivalent_keys k1 key2) true) (= (witness container key2) (witness container k1))))))) (dynamic_invariant6 result true false true)))) :pattern ((get2 container key2))))))
(assert (forall ((container us_rep4)) (! (dynamic_invariant4 (length4 container) true false true) :pattern ((length4 container)))))
(assert (forall ((left us_rep4) (right us_rep4)) (! (= (= (oeq4 left right) true) (and (forall ((key2 Int)) (=> (and (in_range5 key2) (= (has_key1 left key2) true)) (and (= (has_key1 right key2) true) (= (get2 right key2) (get2 left key2))))) (forall ((key2 Int)) (=> (and (in_range5 key2) (= (has_key1 right key2) true)) (= (has_key1 left key2) true))))) :pattern ((oeq4 left right)))))
(assert (forall ((container us_rep4)) (! (= (= (is_empty container) true) (forall ((key2 Int)) (not (and (in_range5 key2) (= (has_key1 container key2) true))))) :pattern ((is_empty container)))))
(assert (forall ((left us_rep4) (right us_rep4)) (! (= (= (keys_included left right) true) (forall ((key2 Int)) (=> (and (in_range5 key2) (= (has_key1 left key2) true)) (= (has_key1 right key2) true)))) :pattern ((keys_included left right)))))
(assert (forall ((left us_rep4) (right us_rep4)) (forall ((new_key Int)) (! (=> (dynamic_invariant5 new_key true true true) (= (= (elements_equal_except left right new_key) true) (forall ((key2 Int)) (=> (and (in_range5 key2) (= (has_key1 left key2) true)) (=> (not (= (equivalent_keys key2 new_key) true)) (and (= (has_key1 right key2) true) (= (get2 left key2) (get2 right key2)))))))) :pattern ((elements_equal_except left right new_key))))))
(declare-fun has_witness (us_rep4 Int) Bool)
(declare-fun has_witness__function_guard (Bool us_rep4 Int) Bool)
(assert true)
(assert (forall ((container us_rep4)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant5 key2 true true true) (= (has_key1 container key2) true)) (let ((result (witness container key2))) (and (= (has_witness container result) true) (dynamic_invariant4 result true false true)))) :pattern ((witness container key2))))))
(assert (forall ((container us_rep4)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant4 witness1 true true true) (= (has_witness container witness1) true)) (dynamic_invariant6 (w_get container witness1) true false true)) :pattern ((w_get container witness1))))))
(define-fun dynamic_invariant7 ((temp___expr_364 Int) (temp___is_init_361 Bool) (temp___skip_constant_362 Bool) (temp___do_toplevel_363 Bool)) Bool (=> (or (= temp___is_init_361 true) (<= 0 2147483647)) (in_range6 temp___expr_364)))
(assert (forall ((container us_rep3)) (! (let ((result (length1 container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant4 result true false true))) :pattern ((length1 container)))))
...
(define-fun dynamic_invariant8 ((temp___expr_358 Int) (temp___is_init_355 Bool) (temp___skip_constant_356 Bool) (temp___do_toplevel_357 Bool)) Bool (=> (or (= temp___is_init_355 true) (<= (- 2147483648) 2147483647)) (in_range8 temp___expr_358)))
(assert (forall ((container us_rep3)) (forall ((position Int)) (! (=> (and (dynamic_invariant7 position true true true) (and (<= 1 position) (<= position (last2 container)))) (dynamic_invariant8 (get container position) true false true)) :pattern ((get container position))))))
(assert (forall ((container us_rep2)) (forall ((key2 us_rep1)) (! (=> (= (of_int 0) true) (=> (exists ((k1 us_rep1)) (and (= (has_key container k1) true) (= (bool_eq3 k1 key2) true))) (= (has_key container key2) true))) :pattern ((has_key container key2))))))
...
(define-fun dynamic_invariant9 ((temp___expr_384 Int) (temp___is_init_381 Bool) (temp___skip_constant_382 Bool) (temp___do_toplevel_383 Bool)) Bool (=> (or (= temp___is_init_381 true) (<= 1 2147483647)) (in_range9 temp___expr_384)))
...
(assert (forall ((container us_rep2)) (forall ((key2 us_rep1)) (! (=> (= (has_key container key2) true) (let ((result (get1 container key2))) (and (=> (= (of_int 0) true) (and (= result (w_get1 container (witness1 container key2))) (forall ((k1 us_rep1)) (=> (= (has_key container k1) true) (= (= (bool_eq3 k1 key2) true) (= (witness1 container key2) (witness1 container k1))))))) (dynamic_invariant9 result true false true)))) :pattern ((get1 container key2))))))
(assert (forall ((container us_rep2)) (! (dynamic_invariant4 (length5 container) true false true) :pattern ((length5 container)))))
(assert (forall ((left us_rep2) (right us_rep2)) (! (= (= (oeq3 left right) true) (and (forall ((key2 us_rep1)) (=> (= (has_key left key2) true) (and (= (has_key right key2) true) (= (get1 right key2) (get1 left key2))))) (forall ((key2 us_rep1)) (=> (= (has_key right key2) true) (= (has_key left key2) true))))) :pattern ((oeq3 left right)))))
...
(assert true)
(assert (forall ((container us_rep2)) (forall ((key2 us_rep1)) (! (=> (= (has_key container key2) true) (let ((result (witness1 container key2))) (and (= (has_witness1 container result) true) (dynamic_invariant4 result true false true)))) :pattern ((witness1 container key2))))))
(assert (forall ((container us_rep2)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant4 witness2 true true true) (= (has_witness1 container witness2) true)) (dynamic_invariant9 (w_get1 container witness2) true false true)) :pattern ((w_get1 container witness2))))))
(declare-const d__split_fields us_main_type)
(declare-const o count_type)
(declare-const replacement__inverse_sets__replace_element__container__fields us_main_type)
...
(define-fun replacement__inverse_sets__replace_element__container__fields1 () us_split_fields (mk___split_fields replacement__inverse_sets__replace_element__container__fields))
(define-fun o1 () us_rep1 (mk___rep1 (mk___split_fields1 o)))
(assert (dynamic_invariant1 a true false true))
(assert (in_range1 k))
(assert (and (= (has_key1 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) k) true) (forall ((c us_rep1)) (=> (= (has_key (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields))) c) true) (= (to_rep (select (elts a) (element (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c))) (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c))))))
(assert (= (mk___rep d__split_discrs (mk___split_fields d__split_fields)) d_old))
(assert (forall ((c us_rep1)) (=> (= (has_key (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields))) c) true) (=> (not (= (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c) k)) (= (to_rep (select (elts a) (element (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c))) (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c))))))
(assert (and (= o1 (find1 (mk___rep d__split_discrs (mk___split_fields d__split_fields)) k)) (ite (ite (= (has_key1 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) k) false) true false) (and (not (= (has_key (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields))) o1) true)) (= (bool_eq3 o1 no_element) true)) (and (and (= (has_key (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields))) o1) true) (= (get1 (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields))) o1) (find (keys (mk___rep d__split_discrs (mk___split_fields d__split_fields))) k))) (= (equivalent_keys (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) o1) k) true)))))
(assert (and (and (and (and (= (oeq2 (keys (mk___rep d__split_discrs replacement__inverse_sets__replace_element__container__fields1)) (keys (mk___rep d__split_discrs (mk___split_fields d__split_fields)))) true) (= (oeq3 (positions (mk___rep d__split_discrs replacement__inverse_sets__replace_element__container__fields1)) (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields)))) true)) (= (element (mk___rep d__split_discrs replacement__inverse_sets__replace_element__container__fields1) o1) 0)) (= (same_keys (model__ (mk___rep d__split_discrs replacement__inverse_sets__replace_element__container__fields1)) (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields)))) true)) (= (elements_equal_except (model__ (mk___rep d__split_discrs replacement__inverse_sets__replace_element__container__fields1)) (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) (key (mk___rep d__split_discrs replacement__inverse_sets__replace_element__container__fields1) o1)) true)))
(assert (= result d__split_fields))
(assert (= d__split_fields2 replacement__inverse_sets__replace_element__container__fields1))
(declare-const c us_rep1)
(assert (= (has_key (positions (mk___rep d__split_discrs d__split_fields2)) c) true))
(assert (not (= (key (mk___rep d__split_discrs d__split_fields2) c) k)))
(assert (not (= (to_rep (select (elts a) (element (mk___rep d__split_discrs d__split_fields2) c))) (key (mk___rep d__split_discrs d__split_fields2) c))))
(check-sat)
(exit)
