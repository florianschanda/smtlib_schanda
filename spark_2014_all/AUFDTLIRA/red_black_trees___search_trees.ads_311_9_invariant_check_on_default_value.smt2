...
(declare-const temp___6433 (Array Int natural))
(assert (= (tree_structure (mk___rep1 (mk___split_fields1 temp___6431 temp___6432))) true))
(assert (and (and (= (to_rep temp___643) 0) (default_initial_assumption (mk___rep1 (mk___split_fields1 temp___6431 temp___6432)) false)) (= temp___6433 (temp_____aggregate_def_431 0))))
(assert (not (type_invariant1 (mk___rep2 (mk___split_fields2 temp___643 (mk___rep1 (mk___split_fields1 temp___6431 temp___6432)) temp___6433)))))
(check-sat)
(exit)
