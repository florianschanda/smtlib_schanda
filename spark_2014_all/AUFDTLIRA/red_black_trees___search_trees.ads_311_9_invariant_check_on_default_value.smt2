...
(assert (and (and (= (to_rep temp___599) 0) (default_initial_assumption (mk___rep1 (mk___split_fields1 temp___5991 temp___5992)) false)) (= temp___5993 (temp___387 0))))
(assert (not (type_invariant1 (mk___rep2 (mk___split_fields2 temp___599 (mk___rep1 (mk___split_fields1 temp___5991 temp___5992)) temp___5993)))))
(check-sat)
(exit)
