...
(assert (not (= k12 (to_rep1 a__first))))
(assert (and (= o83 (- k12 1)) (in_range3 (- k12 1))))
(assert (= result15 (mk_int__ref k12)))
(assert (= k13 o83))
(assert (and (<= (to_rep1 a__first) k13) (<= k13 (to_rep1 a__last))))
(assert (= o84 k13))
(assert (= o85 (select a10 o84)))
(assert (= o86 (us_split_fields1 o85)))
(assert (= o87 (rec__frame_condition__cell__value o86)))
(assert (= o88 (to_rep o87)))
(assert (= result16 (ite (< max14 o88) true false)))
(assert (=> (= result16 true) (and (<= (to_rep1 a__first) k13) (<= k13 (to_rep1 a__last)))))
(assert (=> (= result16 true) (= o89 k13)))
(assert (=> (= result16 true) (= o90 (select a10 o89))))
(assert (=> (= result16 true) (= o91 (us_split_fields1 o90))))
(assert (=> (= result16 true) (= o92 (rec__frame_condition__cell__value o91))))
(assert (=> (= result16 true) (= o93 (to_rep o92))))
(assert (=> (= result16 true) (= result17 (mk_int__ref max14))))
(assert (=> (= result16 true) (= max15 o93)))
(assert (=> (= result16 true) (= max16 (mk_int__ref max15))))
(assert (=> (= result16 true) (= max17 max15)))
(assert (=> (not (= result16 true)) (= max16 (mk_int__ref max14))))
(assert (=> (not (= result16 true)) (= max17 max14)))
(assert (= (to_rep o94) (int__content max16)))
(assert (= o95 (mk___split_fields (rec__frame_condition__cell__value (us_split_fields1 (select a10 k13))) (rec__frame_condition__cell__max_left (us_split_fields1 (select a10 k13))) o94)))
(assert (= o96 (mk___rep o95)))
(assert (and (<= (to_rep1 a__first) k13) (<= k13 (to_rep1 a__last))))
(assert (= o97 k13))
(assert (= o98 (store a10 o97 o96)))
(assert (= result18 (mk_map__ref a10)))
(assert (= a11 o98))
(assert (= max18 max16))
(assert (= k16 (mk_int__ref k13)))
(assert (= a12 (mk_map__ref a11)))
(assert (= max19 max17))
(assert (= k17 k13))
(assert (= a13 a11))
(declare-const i5 Int)
(assert (<= (int__content k16) i5))
(assert (<= i5 (to_rep1 a__last)))
(declare-const j3 Int)
(assert (<= i5 j3))
(assert (<= j3 (to_rep1 a__last)))
(assert (not (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select (map__content a12) j3)))) (to_rep (rec__frame_condition__cell__max_right (us_split_fields1 (select (map__content a12) i5)))))))
(check-sat)
(exit)
