...
(assert (forall ((i Int)) (=> (and (<= k10 i) (<= i (to_rep1 a__last))) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a8 i)))) max12))))
(assert (forall ((i Int)) (=> (and (<= k10 i) (<= i (to_rep1 a__last))) (forall ((j Int)) (=> (and (<= i j) (<= j (to_rep1 a__last))) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a8 j)))) (to_rep (rec__frame_condition__cell__max_right (us_split_fields1 (select a8 i))))))))))
...
(assert (not (= k10 (to_rep1 a__first))))
(assert (and (= o45 (- k10 1)) (in_range3 (- k10 1))))
(assert (= result11 (mk_int__ref k10)))
(assert (= k11 o45))
(assert (and (<= (to_rep1 a__first) k11) (<= k11 (to_rep1 a__last))))
(assert (= o46 k11))
(assert (= o47 (select a8 o46)))
(assert (= o48 (us_split_fields1 o47)))
(assert (= o49 (rec__frame_condition__cell__value o48)))
(assert (= o50 (to_rep o49)))
(assert (= result12 (ite (< max12 o50) true false)))
(assert (=> (= result12 true) (and (<= (to_rep1 a__first) k11) (<= k11 (to_rep1 a__last)))))
(assert (=> (= result12 true) (= o51 k11)))
(assert (=> (= result12 true) (= o52 (select a8 o51))))
(assert (=> (= result12 true) (= o53 (us_split_fields1 o52))))
(assert (=> (= result12 true) (= o54 (rec__frame_condition__cell__value o53))))
(assert (=> (= result12 true) (= o55 (to_rep o54))))
(assert (=> (= result12 true) (= result13 (mk_int__ref max12))))
(assert (=> (= result12 true) (= max13 o55)))
(assert (=> (= result12 true) (= max14 (mk_int__ref max13))))
(assert (=> (= result12 true) (= max15 max13)))
(assert (=> (not (= result12 true)) (= max14 (mk_int__ref max12))))
(assert (=> (not (= result12 true)) (= max15 max12)))
(assert (= (to_rep o56) (int__content max14)))
(assert (= o57 (mk___split_fields (rec__frame_condition__cell__value (us_split_fields1 (select a8 k11))) (rec__frame_condition__cell__max_left (us_split_fields1 (select a8 k11))) o56)))
(assert (= o58 (mk___rep o57)))
(assert (and (<= (to_rep1 a__first) k11) (<= k11 (to_rep1 a__last))))
(assert (= o59 k11))
(assert (= o60 (store a8 o59 o58)))
(assert (= result14 (mk_map__ref a8)))
(assert (= a9 o60))
(assert (= max16 max14))
(assert (= k12 (mk_int__ref k11)))
(assert (= a10 (mk_map__ref a9)))
(assert (= max17 max15))
(assert (= k13 k11))
(assert (= a11 a9))
(declare-const i Int)
(assert (<= (int__content k12) i))
(assert (<= i (to_rep1 a__last)))
(declare-const j Int)
(assert (<= i j))
(assert (<= j (to_rep1 a__last)))
(assert (not (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select (map__content a10) j)))) (to_rep (rec__frame_condition__cell__max_right (us_split_fields1 (select (map__content a10) i)))))))
(check-sat)
(exit)
