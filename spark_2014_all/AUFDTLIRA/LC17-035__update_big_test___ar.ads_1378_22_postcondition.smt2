...
(define-fun dynamic_invariant4 ((temp___expr_194 Int) (temp___is_init_191 Bool) (temp___skip_constant_192 Bool) (temp___do_toplevel_193 Bool)) Bool (=> (or (= temp___is_init_191 true) (<= 50 59)) (in_range4 temp___expr_194)))
...
(declare-fun temp___2956 ((Array Int us_rep2) Int us_rep2) (Array Int us_rep2))
(assert (forall ((temp___2958 (Array Int us_rep2))) (forall ((temp___2959 Int)) (forall ((temp___2960 us_rep2)) (let ((temp___2957 (temp___2956 temp___2958 temp___2959 temp___2960))) (forall ((temp___2961 Int)) (ite (= temp___2961 temp___2959) (= (select temp___2957 temp___2961) temp___2960) (= (select temp___2957 temp___2961) (select temp___2958 temp___2961)))))))))
...
(assert (= a7 a5))
(assert (not (= (bool_eq3 (map__content a6) 1 16 (temp___2956 a i (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 (of_rep2 e) (mk___rep (mk___split_fields (of_rep f) (of_rep1 g))) (of_rep4 h))) (of_rep3 d)))) 1 16) true)))
(check-sat)
(exit)
