...
(declare-fun temp_____aggregate_def_3015 ((Array Int us_rep2) Int us_rep2) (Array Int us_rep2))
(assert (forall ((temp___3017 (Array Int us_rep2))) (forall ((temp___3018 Int)) (forall ((temp___3019 us_rep2)) (let ((temp___3016 (temp_____aggregate_def_3015 temp___3017 temp___3018 temp___3019))) (=> (dynamic_invariant temp___3018 true true true true) (forall ((temp___3020 Int)) (ite (= temp___3020 temp___3018) (= (select temp___3016 temp___3020) temp___3019) (= (select temp___3016 temp___3020) (select temp___3017 temp___3020))))))))))
...
(assert (= a7 a5))
(assert (not (= (bool_eq3 (map__content a6) 1 16 (temp_____aggregate_def_3015 a i (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 (of_rep2 e) (mk___rep (mk___split_fields (of_rep f) (of_rep1 g))) (of_rep4 h))) (of_rep3 d)))) 1 16) true)))
(check-sat)
(exit)
