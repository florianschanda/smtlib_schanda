...
(assert (not (= (to_rep2 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 (table__content simple_unc_arrays__add__result6)))) j)) (+ (to_rep2 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) j)) (to_rep2 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 b))) j))))))
(check-sat)
(exit)
