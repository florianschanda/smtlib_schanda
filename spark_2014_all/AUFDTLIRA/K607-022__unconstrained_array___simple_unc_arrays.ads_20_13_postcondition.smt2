...
(assert (=> (and (<= 1 i1) (<= i1 r7b)) (forall ((j Int)) (=> (and (<= 1 j) (<= j (- i2 1))) (= (to_rep1 (select (elts1 (rec__simple_unc_arrays__table__v1 c__split_fields4)) j)) (+ (to_rep1 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) j)) (to_rep1 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 b))) j))))))))
