...
(assert (in_range12 (int__content state19)))
(assert (not (not (let ((temp___962 (int__content state19))) (or (and (<= 2 temp___962) (<= temp___962 2)) (and (<= 9 temp___962) (<= temp___962 9)))))))
(check-sat)
(exit)
