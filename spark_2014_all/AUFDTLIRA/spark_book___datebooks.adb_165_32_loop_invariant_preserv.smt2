...
(assert (=> (= (rec__datebooks__event_record__is_used (us_split_fields7 (select book i2))) true) (and (= o (+ count2 1)) (in_range10 (+ count2 1)))))
(assert (=> (= (rec__datebooks__event_record__is_used (us_split_fields7 (select book i2))) true) (= result2 count2)))
(assert (=> (= (rec__datebooks__event_record__is_used (us_split_fields7 (select book i2))) true) (= count3 o)))
(assert (=> (not (= (rec__datebooks__event_record__is_used (us_split_fields7 (select book i2))) true)) (= count3 count2)))
(assert (not (= i2 64)))
(assert (= result3 i2))
(assert (= i3 (+ i2 1)))
