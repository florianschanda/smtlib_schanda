...
(assert (= (mk___t loops_static__loop10__result6 loops_static__loop10__result7) (mk___t loops_static__loop10__result4 loops_static__loop10__result5)))
(assert (= res3 res2))
(declare-const j1 Int)
(assert (<= (to_rep1 (first (rt a))) j1))
(assert (<= j1 i2))
(assert (not (= (to_rep (select r3 j1)) 0)))
(check-sat)
(exit)
