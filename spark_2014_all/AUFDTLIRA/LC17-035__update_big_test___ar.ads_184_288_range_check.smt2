...
(assert (=> (< i 10) (=> (< 0 e) (and (= o8 (- e 1)) (in_range1 (- e 1))))))
(assert (=> (< i 10) (=> (< 0 e) (and (= o9 (+ i 1)) (in_range (+ i 1))))))
(assert (=> (< i 10) (=> (< 0 e) (= temp___4377 (temp___641 a i e o9 o8)))))
(assert (=> (< i 10) (=> (< 0 e) (= result8 (bool_eq a3 1 10 temp___4377 1 10)))))
(assert (=> (< i 10) (=> (not (< 0 e)) (= result8 false))))
(assert (=> (< i 10) (=> (= result8 true) (= result7 true))))
(assert (=> (< i 10) (=> (not (= result8 true)) (=> (= e 0) (and (= o7 (+ i 1)) (in_range (+ i 1)))))))
(assert (=> (< i 10) (=> (not (= result8 true)) (=> (= e 0) (= temp___4379 (temp___650 a i e o7 99))))))
(assert (=> (< i 10) (=> (not (= result8 true)) (=> (= e 0) (= result7 (bool_eq a3 1 10 temp___4379 1 10))))))
(assert (=> (< i 10) (=> (not (= result8 true)) (=> (not (= e 0)) (= result7 false)))))
(assert (=> (not (< i 10)) (= result7 false)))
