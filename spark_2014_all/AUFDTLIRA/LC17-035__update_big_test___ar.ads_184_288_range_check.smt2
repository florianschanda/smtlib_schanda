...
(assert (=> (< i 10) (=> (< 0 e) (= temp___4377 (temp___641 a i e o6 o5)))))
(assert (=> (< i 10) (=> (< 0 e) (= result6 (bool_eq a3 1 10 temp___4377 1 10)))))
...
(assert (=> (< i 10) (=> (not (= result6 true)) (=> (= e 0) (= temp___4379 (temp___650 a i e o4 99))))))
(assert (=> (< i 10) (=> (not (= result6 true)) (=> (= e 0) (= result5 (bool_eq a3 1 10 temp___4379 1 10))))))
