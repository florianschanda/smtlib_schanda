...
(declare-fun temp___700 ((Array Int et1) Int Int Int Int) (Array Int et1))
(declare-fun temp___709 ((Array Int et1) Int Int Int Int) (Array Int et1))
(declare-fun temp___718 ((Array Int et1) Int Int Int Int) (Array Int et1))
(declare-fun temp___727 ((Array Int et1) Int Int Int Int) (Array Int et1))
(declare-fun temp___4424 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___4426 (Array Int et1))) (forall ((temp___4427 Int) (temp___4428 Int)) (let ((temp___4425 (temp___4424 temp___4426 temp___4427 temp___4428))) (=> (and (dynamic_invariant temp___4427 true true true true) (dynamic_invariant1 temp___4428 true true true true)) (forall ((temp___4429 Int)) (ite (= temp___4429 temp___4427) (= (to_rep (select temp___4425 temp___4429)) temp___4428) (= (select temp___4425 temp___4429) (select temp___4426 temp___4429)))))))))
(assert (forall ((temp___702 (Array Int et1))) (forall ((temp___703 Int) (temp___704 Int) (temp___705 Int) (temp___706 Int)) (let ((temp___701 (temp___700 temp___702 temp___703 temp___704 temp___705 temp___706))) (=> (and (and (and (dynamic_invariant temp___703 true true true true) (dynamic_invariant1 temp___704 true true true true)) (dynamic_invariant temp___705 true true true true)) (dynamic_invariant1 temp___706 true true true true)) (forall ((temp___707 Int)) (ite (= temp___707 temp___705) (= (to_rep (select temp___701 temp___707)) temp___706) (ite (= temp___707 temp___703) (= (to_rep (select temp___701 temp___707)) temp___704) (= (select temp___701 temp___707) (select temp___702 temp___707))))))))))
(assert (forall ((temp___711 (Array Int et1))) (forall ((temp___712 Int) (temp___713 Int) (temp___714 Int) (temp___715 Int)) (let ((temp___710 (temp___709 temp___711 temp___712 temp___713 temp___714 temp___715))) (=> (and (and (and (dynamic_invariant temp___712 true true true true) (dynamic_invariant1 temp___713 true true true true)) (dynamic_invariant temp___714 true true true true)) (dynamic_invariant1 temp___715 true true true true)) (forall ((temp___716 Int)) (ite (= temp___716 temp___714) (= (to_rep (select temp___710 temp___716)) temp___715) (ite (= temp___716 temp___712) (= (to_rep (select temp___710 temp___716)) temp___713) (= (select temp___710 temp___716) (select temp___711 temp___716))))))))))
(assert (forall ((temp___720 (Array Int et1))) (forall ((temp___721 Int) (temp___722 Int) (temp___723 Int) (temp___724 Int)) (let ((temp___719 (temp___718 temp___720 temp___721 temp___722 temp___723 temp___724))) (=> (and (and (and (dynamic_invariant temp___721 true true true true) (dynamic_invariant1 temp___722 true true true true)) (dynamic_invariant temp___723 true true true true)) (dynamic_invariant1 temp___724 true true true true)) (forall ((temp___725 Int)) (ite (= temp___725 temp___723) (= (to_rep (select temp___719 temp___725)) temp___724) (ite (= temp___725 temp___721) (= (to_rep (select temp___719 temp___725)) temp___722) (= (select temp___719 temp___725) (select temp___720 temp___725))))))))))
(assert (forall ((temp___729 (Array Int et1))) (forall ((temp___730 Int) (temp___731 Int) (temp___732 Int) (temp___733 Int)) (let ((temp___728 (temp___727 temp___729 temp___730 temp___731 temp___732 temp___733))) (=> (and (and (and (dynamic_invariant temp___730 true true true true) (dynamic_invariant1 temp___731 true true true true)) (dynamic_invariant temp___732 true true true true)) (dynamic_invariant1 temp___733 true true true true)) (forall ((temp___734 Int)) (ite (= temp___734 temp___732) (= (to_rep (select temp___728 temp___734)) temp___733) (ite (= temp___734 temp___730) (= (to_rep (select temp___728 temp___734)) temp___731) (= (select temp___728 temp___734) (select temp___729 temp___734))))))))))
...
(declare-const temp___4438 (Array Int et1))
(declare-const o5 Int)
(declare-const o6 Int)
(declare-const temp___4436 (Array Int et1))
...
(assert (= (bool_eq a1 1 10 (temp___4424 t i e) 1 10) true))
...
(assert (= j4 j1))
(assert (= a4 a2))
(assert (=> (< i 10) (=> (< 0 e) (and (= o5 (- e 1)) (in_range1 (- e 1))))))
(assert (=> (< i 10) (=> (< 0 e) (and (= o6 (+ i 1)) (in_range (+ i 1))))))
(assert (=> (< i 10) (=> (< 0 e) (= temp___4436 (temp___700 a i e o6 o5)))))
(assert (=> (< i 10) (=> (< 0 e) (= result6 (bool_eq a3 1 10 temp___4436 1 10)))))
(assert (=> (< i 10) (=> (not (< 0 e)) (= result6 false))))
(assert (=> (< i 10) (=> (= result6 true) (= result5 true))))
(assert (=> (< i 10) (=> (not (= result6 true)) (=> (= e 0) (and (= o4 (+ i 1)) (in_range (+ i 1)))))))
(assert (=> (< i 10) (=> (not (= result6 true)) (=> (= e 0) (= temp___4438 (temp___709 a i e o4 99))))))
(assert (=> (< i 10) (=> (not (= result6 true)) (=> (= e 0) (= result5 (bool_eq a3 1 10 temp___4438 1 10))))))
(assert (=> (< i 10) (=> (not (= result6 true)) (=> (not (= e 0)) (= result5 false)))))
(assert (=> (not (< i 10)) (= result5 false)))
