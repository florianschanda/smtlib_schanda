...
(assert (=> (= (length (mk___t temp___608 temp___6081)) 0) (= (temp___String_Literal_607 Tuple0) temp___610)))
(assert (=> (= (length (mk___t temp___608 temp___6081)) 0) (= (mk 1 13) temp___6101)))
(assert (=> (not (= (length (mk___t temp___608 temp___6081)) 0)) (=> (<= 1 13) (= o38 (+ (- 13 1) 1)))))
(assert (=> (not (= (length (mk___t temp___608 temp___6081)) 0)) (=> (not (<= 1 13)) (= o38 0))))
(assert (=> (not (= (length (mk___t temp___608 temp___6081)) 0)) (=> (<= (to_rep1 (first temp___6081)) (to_rep1 (last temp___6081))) (= o39 (+ (- (to_rep1 (last temp___6081)) (to_rep1 (first temp___6081))) 1)))))
(assert (=> (not (= (length (mk___t temp___608 temp___6081)) 0)) (=> (not (<= (to_rep1 (first temp___6081)) (to_rep1 (last temp___6081)))) (= o39 0))))
(assert (=> (not (= (length (mk___t temp___608 temp___6081)) 0)) (= o40 (+ o39 o38))))
(assert (=> (not (= (length (mk___t temp___608 temp___6081)) 0)) (= o41 (+ (to_rep1 (first temp___6081)) o40))))
(assert (=> (not (= (length (mk___t temp___608 temp___6081)) 0)) (= o42 (- o41 1))))
(assert (=> (not (= (length (mk___t temp___608 temp___6081)) 0)) (and (= o43 o42) (in_range1 o42))))
(assert (=> (not (= (length (mk___t temp___608 temp___6081)) 0)) (= (concat1 temp___608 (to_rep1 (first temp___6081)) (to_rep1 (last temp___6081)) (temp___String_Literal_607 Tuple0) 1 13) temp___610)))
(assert (=> (not (= (length (mk___t temp___608 temp___6081)) 0)) (= (mk (to_rep1 (first temp___6081)) o43) temp___6101)))
(assert (=> (= (length (mk___t temp___610 temp___6101)) 0) (= (elts (to_string (attr__ATTRIBUTE_IMAGE (to_rep2 (rec__ints__approx_int__precision (us_split_fields3 arg)))))) temp___613)))
(assert (=> (= (length (mk___t temp___610 temp___6101)) 0) (= (mk (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE (to_rep2 (rec__ints__approx_int__precision (us_split_fields3 arg)))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE (to_rep2 (rec__ints__approx_int__precision (us_split_fields3 arg))))))))) temp___6131)))
(assert (=> (not (= (length (mk___t temp___610 temp___6101)) 0)) (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE (to_rep2 (rec__ints__approx_int__precision (us_split_fields3 arg)))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE (to_rep2 (rec__ints__approx_int__precision (us_split_fields3 arg))))))))) (= o44 (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE (to_rep2 (rec__ints__approx_int__precision (us_split_fields3 arg)))))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE (to_rep2 (rec__ints__approx_int__precision (us_split_fields3 arg))))))))) 1)))))
(assert (=> (not (= (length (mk___t temp___610 temp___6101)) 0)) (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE (to_rep2 (rec__ints__approx_int__precision (us_split_fields3 arg)))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE (to_rep2 (rec__ints__approx_int__precision (us_split_fields3 arg)))))))))) (= o44 0))))
(assert (=> (not (= (length (mk___t temp___610 temp___6101)) 0)) (=> (<= (to_rep1 (first temp___6101)) (to_rep1 (last temp___6101))) (= o45 (+ (- (to_rep1 (last temp___6101)) (to_rep1 (first temp___6101))) 1)))))
(assert (=> (not (= (length (mk___t temp___610 temp___6101)) 0)) (=> (not (<= (to_rep1 (first temp___6101)) (to_rep1 (last temp___6101)))) (= o45 0))))
(assert (=> (not (= (length (mk___t temp___610 temp___6101)) 0)) (= o46 (+ o45 o44))))
(assert (=> (not (= (length (mk___t temp___610 temp___6101)) 0)) (= o47 (+ (to_rep1 (first temp___6101)) o46))))
(assert (=> (not (= (length (mk___t temp___610 temp___6101)) 0)) (= o48 (- o47 1))))
(assert (=> (not (= (length (mk___t temp___610 temp___6101)) 0)) (and (= o49 o48) (in_range1 o48))))
(assert (=> (not (= (length (mk___t temp___610 temp___6101)) 0)) (= (concat1 temp___610 (to_rep1 (first temp___6101)) (to_rep1 (last temp___6101)) (elts (to_string (attr__ATTRIBUTE_IMAGE (to_rep2 (rec__ints__approx_int__precision (us_split_fields3 arg)))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE (to_rep2 (rec__ints__approx_int__precision (us_split_fields3 arg)))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE (to_rep2 (rec__ints__approx_int__precision (us_split_fields3 arg))))))))) temp___613)))
(assert (=> (not (= (length (mk___t temp___610 temp___6101)) 0)) (= (mk (to_rep1 (first temp___6101)) o49) temp___6131)))
(assert (not (= (length (mk___t temp___613 temp___6131)) 0)))
(assert (=> (<= 1 2) (= o50 (+ (- 2 1) 1))))
(assert (=> (not (<= 1 2)) (= o50 0)))
(assert (=> (<= (to_rep1 (first temp___6131)) (to_rep1 (last temp___6131))) (= o51 (+ (- (to_rep1 (last temp___6131)) (to_rep1 (first temp___6131))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___6131)) (to_rep1 (last temp___6131)))) (= o51 0)))
(assert (= o52 (+ o51 o50)))
(assert (= o53 (+ (to_rep1 (first temp___6131)) o52)))
(assert (= o54 (- o53 1)))
