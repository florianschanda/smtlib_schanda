...
(define-fun dynamic_invariant1 ((temp___expr_211 us_rep1) (temp___is_init_207 Bool) (temp___skip_constant_208 Bool) (temp___do_toplevel_209 Bool) (temp___do_typ_inv_210 Bool)) Bool (and (=> (= temp___do_typ_inv_210 true) (forall ((idx Int)) (=> (and (<= 1 idx) (<= idx (- (to_rep (rec__communications__communication__num (us_split_discrs1 temp___expr_211))) 1))) (<= (let ((temp___216 (rec__messages__message__received (us_split_fields1 (let ((temp___214 (rec__communications__communication__msgs (us_split_fields3 temp___expr_211)))) (select (to_array temp___214) (+ idx 1))))))) (let ((temp___215 (rec__messages__message__received (us_split_fields1 (let ((temp___213 (rec__communications__communication__msgs (us_split_fields3 temp___expr_211)))) (select (to_array temp___213) idx)))))) (compare temp___215 1 10 temp___216 1 10))) 0)))) (let ((temp___217 (rec__communications__communication__num (us_split_discrs1 temp___expr_211)))) (and (and (dynamic_property1 1 (to_rep temp___217) (first1 (rec__communications__communication__msgs (us_split_fields3 temp___expr_211))) (last1 (rec__communications__communication__msgs (us_split_fields3 temp___expr_211)))) (and (= (first1 (rec__communications__communication__msgs (us_split_fields3 temp___expr_211))) 1) (= (last1 (rec__communications__communication__msgs (us_split_fields3 temp___expr_211))) (to_rep temp___217)))) (forall ((temp___218 Int)) (=> (and (<= (first1 (rec__communications__communication__msgs (us_split_fields3 temp___expr_211))) temp___218) (<= temp___218 (last1 (rec__communications__communication__msgs (us_split_fields3 temp___expr_211))))) (=> (= temp___is_init_207 true) (let ((temp___219 (select (to_array (rec__communications__communication__msgs (us_split_fields3 temp___expr_211))) temp___218))) (<= (let ((temp___221 (rec__messages__message__received (us_split_fields1 temp___219)))) (let ((temp___220 (rec__messages__message__sent (us_split_fields1 temp___219)))) (compare temp___220 1 10 temp___221 1 10))) 0)))))))))
(define-fun type_invariant ((temp___224 us_rep1)) Bool (forall ((idx Int)) (=> (and (<= 1 idx) (<= idx (- (to_rep (rec__communications__communication__num (us_split_discrs1 temp___224))) 1))) (<= (let ((temp___229 (rec__messages__message__received (us_split_fields1 (let ((temp___227 (rec__communications__communication__msgs (us_split_fields3 temp___224)))) (select (to_array temp___227) (+ idx 1))))))) (let ((temp___228 (rec__messages__message__received (us_split_fields1 (let ((temp___226 (rec__communications__communication__msgs (us_split_fields3 temp___224)))) (select (to_array temp___226) idx)))))) (compare temp___228 1 10 temp___229 1 10))) 0))))
(declare-sort t5b 0)
(declare-fun t5bqtint (t5b) Int)
(assert (forall ((i t5b)) (and (<= (- 2147483648) (t5bqtint i)) (<= (t5bqtint i) (- 2147483647)))))
...
(assert (forall ((i tT7bP1)) (and (<= 1 (tT7bP1qtint i)) (<= (tT7bP1qtint i) 2))))
...
(define-fun to_base ((a us_rep2)) us_rep1 (mk___rep1 (us_split_discrs2 a) (mk___split_fields1 (of_array (rec__communications__communication__msgs1 (us_split_fields5 a)) 1 2))))
(define-fun of_base ((r us_rep1)) us_rep2 (mk___rep2 (us_split_discrs1 r) (mk___split_fields2 (let ((temp___155 (rec__communications__communication__msgs (us_split_fields3 r)))) (to_array temp___155)))))
...
(define-fun dynamic_invariant5 ((temp___expr_200 us_t1) (temp___is_init_196 Bool) (temp___skip_constant_197 Bool) (temp___do_toplevel_198 Bool) (temp___do_typ_inv_199 Bool)) Bool (and (=> (not (= temp___skip_constant_197 true)) (dynamic_property2 (- 2147483648) 2147483647 (first3 temp___expr_200) (last3 temp___expr_200))) (forall ((temp___201 Int)) (=> (and (<= (first3 temp___expr_200) temp___201) (<= temp___201 (last3 temp___expr_200))) (=> (= temp___is_init_196 true) (let ((temp___202 (select (to_array1 temp___expr_200) temp___201))) (<= (let ((temp___204 (rec__messages__message__received (us_split_fields1 temp___202)))) (let ((temp___203 (rec__messages__message__sent (us_split_fields1 temp___202)))) (compare temp___203 1 10 temp___204 1 10))) 0)))))))
(assert (not (<= (compare (temp___String_Literal_301 Tuple0) 1 10 (temp___String_Literal_302 Tuple0) 1 10) 0)))
(check-sat)
(exit)
