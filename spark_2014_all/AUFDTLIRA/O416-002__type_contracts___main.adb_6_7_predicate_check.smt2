...
(define-fun dynamic_invariant ((temp___expr_146 us_rep) (temp___is_init_143 Bool) (temp___skip_constant_144 Bool) (temp___do_toplevel_145 Bool)) Bool (=> (= temp___do_toplevel_145 true) (=> (= temp___is_init_143 true) (<= (let ((temp___149 (rec__messages__message__received (us_split_fields1 temp___expr_146)))) (let ((temp___148 (rec__messages__message__sent (us_split_fields1 temp___expr_146)))) (compare temp___148 1 10 temp___149 1 10))) 0))))
(define-fun dynamic_predicate ((temp___160 us_rep)) Bool (<= (let ((temp___163 (rec__messages__message__received (us_split_fields1 temp___160)))) (let ((temp___162 (rec__messages__message__sent (us_split_fields1 temp___160)))) (compare temp___162 1 10 temp___163 1 10))) 0))
...
(define-fun bool_eq2 ((a (Array Int us_rep)) (a__first Int) (a__last Int) (b (Array Int us_rep)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_132 Int)) (=> (and (<= a__first temp___idx_132) (<= temp___idx_132 a__last)) (= (bool_eq1 (select a temp___idx_132) (select b (+ (- b__first a__first) temp___idx_132))) true)))) true false))
...
(define-fun dynamic_invariant1 ((temp___expr_185 us_rep1) (temp___is_init_182 Bool) (temp___skip_constant_183 Bool) (temp___do_toplevel_184 Bool)) Bool (and (forall ((idx Int)) (=> (and (<= 1 idx) (<= idx (- (to_rep (rec__communications__communication__num (us_split_discrs1 temp___expr_185))) 1))) (<= (let ((temp___190 (rec__messages__message__received (us_split_fields1 (let ((temp___188 (rec__communications__communication__msgs (us_split_fields3 temp___expr_185)))) (select (to_array1 temp___188) (+ idx 1))))))) (let ((temp___189 (rec__messages__message__received (us_split_fields1 (let ((temp___187 (rec__communications__communication__msgs (us_split_fields3 temp___expr_185)))) (select (to_array1 temp___187) idx)))))) (compare temp___189 1 10 temp___190 1 10))) 0))) (let ((temp___191 (rec__communications__communication__num (us_split_discrs1 temp___expr_185)))) (and (and (dynamic_property2 1 (to_rep temp___191) (first3 (rec__communications__communication__msgs (us_split_fields3 temp___expr_185))) (last3 (rec__communications__communication__msgs (us_split_fields3 temp___expr_185)))) (and (= (first3 (rec__communications__communication__msgs (us_split_fields3 temp___expr_185))) 1) (= (last3 (rec__communications__communication__msgs (us_split_fields3 temp___expr_185))) (to_rep temp___191)))) (forall ((temp___192 Int)) (=> (and (<= (first3 (rec__communications__communication__msgs (us_split_fields3 temp___expr_185))) temp___192) (<= temp___192 (last3 (rec__communications__communication__msgs (us_split_fields3 temp___expr_185))))) (=> (= temp___is_init_182 true) (let ((temp___193 (select (to_array1 (rec__communications__communication__msgs (us_split_fields3 temp___expr_185))) temp___192))) (<= (let ((temp___195 (rec__messages__message__received (us_split_fields1 temp___193)))) (let ((temp___194 (rec__messages__message__sent (us_split_fields1 temp___193)))) (compare temp___194 1 10 temp___195 1 10))) 0)))))))))
(define-fun type_invariant ((temp___198 us_rep1)) Bool (forall ((idx Int)) (=> (and (<= 1 idx) (<= idx (- (to_rep (rec__communications__communication__num (us_split_discrs1 temp___198))) 1))) (<= (let ((temp___203 (rec__messages__message__received (us_split_fields1 (let ((temp___201 (rec__communications__communication__msgs (us_split_fields3 temp___198)))) (select (to_array1 temp___201) (+ idx 1))))))) (let ((temp___202 (rec__messages__message__received (us_split_fields1 (let ((temp___200 (rec__communications__communication__msgs (us_split_fields3 temp___198)))) (select (to_array1 temp___200) idx)))))) (compare temp___202 1 10 temp___203 1 10))) 0))))
(declare-sort t5b 0)
...
(define-fun of_base ((r us_rep1)) us_rep2 (mk___rep2 (us_split_discrs1 r) (mk___split_fields2 (let ((temp___133 (rec__communications__communication__msgs (us_split_fields3 r)))) (to_array1 temp___133)))))
...
(assert (forall ((temp___263 us_rep) (temp___264 us_rep)) (let ((temp___262 (main__a__aggregate_def temp___263 temp___264))) (and (= (select temp___262 (- 2147483648)) temp___263) (= (select temp___262 (- 2147483647)) temp___264)))))
(declare-fun temp___String_Literal_266 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (= (to_rep2 (select (temp___String_Literal_266 us_void_param) 1)) 48) (= (to_rep2 (select (temp___String_Literal_266 us_void_param) 2)) 48)) (= (to_rep2 (select (temp___String_Literal_266 us_void_param) 3)) 48)) (= (to_rep2 (select (temp___String_Literal_266 us_void_param) 4)) 48)) (= (to_rep2 (select (temp___String_Literal_266 us_void_param) 5)) 45)) (= (to_rep2 (select (temp___String_Literal_266 us_void_param) 6)) 49)) (= (to_rep2 (select (temp___String_Literal_266 us_void_param) 7)) 50)) (= (to_rep2 (select (temp___String_Literal_266 us_void_param) 8)) 45)) (= (to_rep2 (select (temp___String_Literal_266 us_void_param) 9)) 50)) (= (to_rep2 (select (temp___String_Literal_266 us_void_param) 10)) 53)) :pattern ((temp___String_Literal_266 us_void_param)))))
(declare-fun temp___String_Literal_267 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (= (to_rep2 (select (temp___String_Literal_267 us_void_param) 1)) 48) (= (to_rep2 (select (temp___String_Literal_267 us_void_param) 2)) 48)) (= (to_rep2 (select (temp___String_Literal_267 us_void_param) 3)) 51)) (= (to_rep2 (select (temp___String_Literal_267 us_void_param) 4)) 51)) (= (to_rep2 (select (temp___String_Literal_267 us_void_param) 5)) 45)) (= (to_rep2 (select (temp___String_Literal_267 us_void_param) 6)) 48)) (= (to_rep2 (select (temp___String_Literal_267 us_void_param) 7)) 52)) (= (to_rep2 (select (temp___String_Literal_267 us_void_param) 8)) 45)) (= (to_rep2 (select (temp___String_Literal_267 us_void_param) 9)) 48)) (= (to_rep2 (select (temp___String_Literal_267 us_void_param) 10)) 51)) :pattern ((temp___String_Literal_267 us_void_param)))))
(declare-fun temp___String_Literal_269 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (= (to_rep2 (select (temp___String_Literal_269 us_void_param) 1)) 48) (= (to_rep2 (select (temp___String_Literal_269 us_void_param) 2)) 53)) (= (to_rep2 (select (temp___String_Literal_269 us_void_param) 3)) 55)) (= (to_rep2 (select (temp___String_Literal_269 us_void_param) 4)) 48)) (= (to_rep2 (select (temp___String_Literal_269 us_void_param) 5)) 45)) (= (to_rep2 (select (temp___String_Literal_269 us_void_param) 6)) 48)) (= (to_rep2 (select (temp___String_Literal_269 us_void_param) 7)) 48)) (= (to_rep2 (select (temp___String_Literal_269 us_void_param) 8)) 45)) (= (to_rep2 (select (temp___String_Literal_269 us_void_param) 9)) 48)) (= (to_rep2 (select (temp___String_Literal_269 us_void_param) 10)) 48)) :pattern ((temp___String_Literal_269 us_void_param)))))
(declare-fun temp___String_Literal_270 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (= (to_rep2 (select (temp___String_Literal_270 us_void_param) 1)) 48) (= (to_rep2 (select (temp___String_Literal_270 us_void_param) 2)) 54)) (= (to_rep2 (select (temp___String_Literal_270 us_void_param) 3)) 51)) (= (to_rep2 (select (temp___String_Literal_270 us_void_param) 4)) 50)) (= (to_rep2 (select (temp___String_Literal_270 us_void_param) 5)) 45)) (= (to_rep2 (select (temp___String_Literal_270 us_void_param) 6)) 48)) (= (to_rep2 (select (temp___String_Literal_270 us_void_param) 7)) 54)) (= (to_rep2 (select (temp___String_Literal_270 us_void_param) 8)) 45)) (= (to_rep2 (select (temp___String_Literal_270 us_void_param) 9)) 48)) (= (to_rep2 (select (temp___String_Literal_270 us_void_param) 10)) 56)) :pattern ((temp___String_Literal_270 us_void_param)))))
...
(define-fun dynamic_invariant5 ((temp___expr_175 us_t) (temp___is_init_172 Bool) (temp___skip_constant_173 Bool) (temp___do_toplevel_174 Bool)) Bool (and (=> (not (= temp___skip_constant_173 true)) (dynamic_property (- 2147483648) 2147483647 (first1 temp___expr_175) (last1 temp___expr_175))) (forall ((temp___176 Int)) (=> (and (<= (first1 temp___expr_175) temp___176) (<= temp___176 (last1 temp___expr_175))) (=> (= temp___is_init_172 true) (let ((temp___177 (select (to_array temp___expr_175) temp___176))) (<= (let ((temp___179 (rec__messages__message__received (us_split_fields1 temp___177)))) (let ((temp___178 (rec__messages__message__sent (us_split_fields1 temp___177)))) (compare temp___178 1 10 temp___179 1 10))) 0)))))))
...
(assert (not (<= (compare (temp___String_Literal_269 Tuple0) 1 10 (temp___String_Literal_270 Tuple0) 1 10) 0)))
(check-sat)
(exit)
