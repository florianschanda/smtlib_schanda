...
(define-fun dynamic_invariant ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= 0 6)) (in_range temp___expr_136)))
...
(assert (= o a))
(assert (= o temp___155))
(assert (= (mk 0 d) temp___1551))
(assert (not (= (ite (<= (to_rep (first temp___1531)) (to_rep (last temp___1531))) (+ (- (to_rep (last temp___1531)) (to_rep (first temp___1531))) 1) 0) (ite (<= (to_rep (first temp___1551)) (to_rep (last temp___1551))) (+ (- (to_rep (last temp___1551)) (to_rep (first temp___1551))) 1) 0))))
(check-sat)
(exit)
