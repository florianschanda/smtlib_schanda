...
(define-fun dynamic_invariant1 ((temp___expr_166 Int) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool (=> (or (= temp___is_init_162 true) (<= 0 1001)) (in_range temp___expr_166)))
...
(assert (= result tmp))
(assert (= tmp1 (to_rep (rec__arrays_of_records__basic_record__first_value (us_split_fields1 (select a 17))))))
(assert (= (to_rep o) (to_rep (rec__arrays_of_records__basic_record__first_value (us_split_fields1 (select a 5))))))
(assert (= (rec__arrays_of_records__basic_record__flag (us_split_fields1 (select a 17))) o1))
(assert (= o o2))
(assert (= (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select a 17))) o3))
(assert (= o4 o1))
(assert (= o5 o2))
(assert (= o6 o3))
...
(assert (= (rec__arrays_of_records__basic_record__flag (us_split_fields1 (select a1 5))) o9))
(assert (= o8 o10))
(assert (= (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select a1 5))) o11))
(assert (= o12 o9))
(assert (= o13 o10))
(assert (= o14 o11))
...
(assert (= tmp3 tmp1))
(assert (= a4 a2))
(assert (not (= (bool_eq1 a3 0 1001 a 0 1001) true)))
(check-sat)
(exit)
