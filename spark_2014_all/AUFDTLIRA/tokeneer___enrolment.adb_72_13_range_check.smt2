...
(assert (forall ((x Int)) (! (=> (dynamic_invariant3 x true true true) (= (integer_image x) (let ((temp___328 (to_string (attr__ATTRIBUTE_IMAGE x)))) (of_array1 (to_array temp___328) (first1 temp___328) (last1 temp___328))))) :pattern ((integer_image x)))))
...
(define-fun dynamic_invariant6 ((temp___expr_348 Int) (temp___is_init_345 Bool) (temp___skip_constant_346 Bool) (temp___do_toplevel_347 Bool)) Bool (=> (or (= temp___is_init_345 true) (<= 1 150)) (in_range3 temp___expr_348)))
...
(declare-const temp___1549 (Array Int character))
(declare-const temp___15491 t)
...
(declare-const temp___1551 (Array Int character))
(declare-const temp___15511 t)
...
(declare-const temp___1555 (Array Int character))
(declare-const temp___15551 t3)
(declare-const o18 (Array Int character))
(declare-const temp___1558 (Array Int character))
(declare-const temp___15581 t3)
...
(assert (and (= (mk___t1 temp___1548 temp___15481) (integer_image certno)) (and (dynamic_invariant2 (mk___t1 temp___1548 temp___15481) true false true) (= (mk___t1 temp___1548 temp___15481) (let ((temp___326 (to_string (attr__ATTRIBUTE_IMAGE certno)))) (mk___t1 (elts temp___326) (mk1 (to_rep1 (first (rt temp___326))) (to_rep1 (last (rt temp___326))))))))))
(assert (=> (<= (to_rep1 (first2 temp___15481)) (to_rep1 (last2 temp___15481))) (= o (+ (- (to_rep1 (last2 temp___15481)) (to_rep1 (first2 temp___15481))) 1))))
(assert (=> (not (<= (to_rep1 (first2 temp___15481)) (to_rep1 (last2 temp___15481)))) (= o 0)))
...
(assert (= (concat1 (temp___String_Literal_167 Tuple0) 1 31 temp___1548 (to_rep1 (first2 temp___15481)) (to_rep1 (last2 temp___15481))) temp___1549))
(assert (= (mk 1 o5) temp___15491))
(assert (=> (= (length (mk___t temp___1549 temp___15491)) 0) (= (temp___String_Literal_170 Tuple0) temp___1551)))
(assert (=> (= (length (mk___t temp___1549 temp___15491)) 0) (= (mk 1 3) temp___15511)))
(assert (=> (not (= (length (mk___t temp___1549 temp___15491)) 0)) (=> (<= 1 3) (= o6 (+ (- 3 1) 1)))))
(assert (=> (not (= (length (mk___t temp___1549 temp___15491)) 0)) (=> (not (<= 1 3)) (= o6 0))))
(assert (=> (not (= (length (mk___t temp___1549 temp___15491)) 0)) (=> (<= (to_rep1 (first temp___15491)) (to_rep1 (last temp___15491))) (= o7 (+ (- (to_rep1 (last temp___15491)) (to_rep1 (first temp___15491))) 1)))))
(assert (=> (not (= (length (mk___t temp___1549 temp___15491)) 0)) (=> (not (<= (to_rep1 (first temp___15491)) (to_rep1 (last temp___15491)))) (= o7 0))))
(assert (=> (not (= (length (mk___t temp___1549 temp___15491)) 0)) (= o8 (+ o7 o6))))
(assert (=> (not (= (length (mk___t temp___1549 temp___15491)) 0)) (= o9 (+ (to_rep1 (first temp___15491)) o8))))
(assert (=> (not (= (length (mk___t temp___1549 temp___15491)) 0)) (= o10 (- o9 1))))
(assert (=> (not (= (length (mk___t temp___1549 temp___15491)) 0)) (and (= o11 o10) (in_range1 o10))))
(assert (=> (not (= (length (mk___t temp___1549 temp___15491)) 0)) (= (concat1 temp___1549 (to_rep1 (first temp___15491)) (to_rep1 (last temp___15491)) (temp___String_Literal_170 Tuple0) 1 3) temp___1551)))
(assert (=> (not (= (length (mk___t temp___1549 temp___15491)) 0)) (= (mk (to_rep1 (first temp___15491)) o11) temp___15511)))
(assert (=> (= (length (mk___t temp___1551 temp___15511)) 0) (= (elts1 detail) enrolment__validate__makedescription__thedesc__assume)))
(assert (=> (= (length (mk___t temp___1551 temp___15511)) 0) (= (mk (to_rep1 (first2 (rt1 detail))) (to_rep1 (last2 (rt1 detail)))) enrolment__validate__makedescription__thedesc__assume1)))
(assert (=> (not (= (length (mk___t temp___1551 temp___15511)) 0)) (=> (<= (to_rep1 (first2 (rt1 detail))) (to_rep1 (last2 (rt1 detail)))) (= o12 (+ (- (to_rep1 (last2 (rt1 detail))) (to_rep1 (first2 (rt1 detail)))) 1)))))
(assert (=> (not (= (length (mk___t temp___1551 temp___15511)) 0)) (=> (not (<= (to_rep1 (first2 (rt1 detail))) (to_rep1 (last2 (rt1 detail))))) (= o12 0))))
(assert (=> (not (= (length (mk___t temp___1551 temp___15511)) 0)) (=> (<= (to_rep1 (first temp___15511)) (to_rep1 (last temp___15511))) (= o13 (+ (- (to_rep1 (last temp___15511)) (to_rep1 (first temp___15511))) 1)))))
(assert (=> (not (= (length (mk___t temp___1551 temp___15511)) 0)) (=> (not (<= (to_rep1 (first temp___15511)) (to_rep1 (last temp___15511)))) (= o13 0))))
(assert (=> (not (= (length (mk___t temp___1551 temp___15511)) 0)) (= o14 (+ o13 o12))))
(assert (=> (not (= (length (mk___t temp___1551 temp___15511)) 0)) (= o15 (+ (to_rep1 (first temp___15511)) o14))))
(assert (=> (not (= (length (mk___t temp___1551 temp___15511)) 0)) (= o16 (- o15 1))))
(assert (=> (not (= (length (mk___t temp___1551 temp___15511)) 0)) (and (= o17 o16) (in_range1 o16))))
(assert (=> (not (= (length (mk___t temp___1551 temp___15511)) 0)) (= (concat1 temp___1551 (to_rep1 (first temp___15511)) (to_rep1 (last temp___15511)) (elts1 detail) (to_rep1 (first2 (rt1 detail))) (to_rep1 (last2 (rt1 detail)))) enrolment__validate__makedescription__thedesc__assume)))
(assert (=> (not (= (length (mk___t temp___1551 temp___15511)) 0)) (= (mk (to_rep1 (first temp___15511)) o17) enrolment__validate__makedescription__thedesc__assume1)))
...
(assert (= (slide (elts thedesc) (to_rep1 (first (rt thedesc))) 1) temp___1555))
(assert (= (mk3 1 (to_rep1 (last (rt thedesc)))) temp___15551))
