...
(assert (=> (and (and (and (<= 0 (to_rep1 (rec__patience__state__numstacks (us_split_fields1 s)))) (<= (to_rep1 (rec__patience__state__numstacks (us_split_fields1 s))) (to_rep1 (rec__patience__state__numelts (us_split_fields1 s))))) (<= (to_rep1 (rec__patience__state__numelts (us_split_fields1 s))) 100)) (or (= (to_rep1 (rec__patience__state__numelts (us_split_fields1 s))) 0) (< 0 (to_rep1 (rec__patience__state__numstacks (us_split_fields1 s)))))) (= (= result1 true) (forall ((i Int)) (=> (and (<= 0 i) (<= i (- (to_rep1 (rec__patience__state__numstacks (us_split_fields1 s))) 1))) (and (and (<= 1 (to_rep1 (select (rec__patience__state__stacksizes (us_split_fields1 s)) i))) (<= (to_rep1 (select (rec__patience__state__stacksizes (us_split_fields1 s)) i)) (to_rep1 (rec__patience__state__numelts (us_split_fields1 s))))) (forall ((j Int)) (=> (and (<= 0 j) (<= j (- (to_rep1 (select (rec__patience__state__stacksizes (us_split_fields1 s)) i)) 1))) (and (<= 0 (to_rep1 (select (select (rec__patience__state__stacks (us_split_fields1 s)) i) j))) (< (to_rep1 (select (select (rec__patience__state__stacks (us_split_fields1 s)) i) j)) (to_rep1 (rec__patience__state__numelts (us_split_fields1 s)))))))))))))
(assert (=> (not (and (and (and (<= 0 (to_rep1 (rec__patience__state__numstacks (us_split_fields1 s)))) (<= (to_rep1 (rec__patience__state__numstacks (us_split_fields1 s))) (to_rep1 (rec__patience__state__numelts (us_split_fields1 s))))) (<= (to_rep1 (rec__patience__state__numelts (us_split_fields1 s))) 100)) (or (= (to_rep1 (rec__patience__state__numelts (us_split_fields1 s))) 0) (< 0 (to_rep1 (rec__patience__state__numstacks (us_split_fields1 s))))))) (= result1 false)))
(assert (=> (= result1 true) (= (= result true) (forall ((i Int)) (=> (and (<= 0 i) (<= i (- (to_rep1 (rec__patience__state__numelts (us_split_fields1 s))) 1))) (and (and (and (<= 0 (to_rep1 (select (rec__patience__state__posstack (us_split_fields1 s)) i))) (<= (to_rep1 (select (rec__patience__state__posstack (us_split_fields1 s)) i)) (- (to_rep1 (rec__patience__state__numstacks (us_split_fields1 s))) 1))) (and (<= 0 (to_rep1 (select (rec__patience__state__posheight (us_split_fields1 s)) i))) (<= (to_rep1 (select (rec__patience__state__posheight (us_split_fields1 s)) i)) (- (to_rep1 (select (rec__patience__state__stacksizes (us_split_fields1 s)) (to_rep1 (select (rec__patience__state__posstack (us_split_fields1 s)) i)))) 1)))) (= (to_rep1 (select (select (rec__patience__state__stacks (us_split_fields1 s)) (to_rep1 (select (rec__patience__state__posstack (us_split_fields1 s)) i))) (to_rep1 (select (rec__patience__state__posheight (us_split_fields1 s)) i)))) i)))))))
(assert (=> (not (= result1 true)) (= result false)))
(assert (= result true))
(assert (<= 0 ist))
(assert (<= ist (- (to_rep1 (rec__patience__state__numstacks (us_split_fields1 s))) 1)))
