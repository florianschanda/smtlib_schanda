...
(declare-const temp___456 (Array Int cardindex))
(declare-const o6 Int)
(declare-const o7 cardindex)
(declare-const temp___457 Int)
(declare-const o8 Int)
(declare-const temp___460 (Array Int cardindex))
...
(assert (=> (and (and (and (<= 0 (to_rep (rec__patience__state__numstacks (us_split_fields1 s)))) (<= (to_rep (rec__patience__state__numstacks (us_split_fields1 s))) (to_rep (rec__patience__state__numelts (us_split_fields1 s))))) (<= (to_rep (rec__patience__state__numelts (us_split_fields1 s))) 100)) (or (= (to_rep (rec__patience__state__numelts (us_split_fields1 s))) 0) (< 0 (to_rep (rec__patience__state__numstacks (us_split_fields1 s)))))) (= (= result1 true) (forall ((i Int)) (=> (and (<= 0 i) (<= i (- (to_rep (rec__patience__state__numstacks (us_split_fields1 s))) 1))) (and (and (<= 1 (to_rep (select (rec__patience__state__stacksizes (us_split_fields1 s)) i))) (<= (to_rep (select (rec__patience__state__stacksizes (us_split_fields1 s)) i)) (to_rep (rec__patience__state__numelts (us_split_fields1 s))))) (forall ((j Int)) (=> (and (<= 0 j) (<= j (- (to_rep (select (rec__patience__state__stacksizes (us_split_fields1 s)) i)) 1))) (and (<= 0 (to_rep (select (select (rec__patience__state__stacks (us_split_fields1 s)) i) j))) (< (to_rep (select (select (rec__patience__state__stacks (us_split_fields1 s)) i) j)) (to_rep (rec__patience__state__numelts (us_split_fields1 s)))))))))))))
(assert (=> (not (and (and (and (<= 0 (to_rep (rec__patience__state__numstacks (us_split_fields1 s)))) (<= (to_rep (rec__patience__state__numstacks (us_split_fields1 s))) (to_rep (rec__patience__state__numelts (us_split_fields1 s))))) (<= (to_rep (rec__patience__state__numelts (us_split_fields1 s))) 100)) (or (= (to_rep (rec__patience__state__numelts (us_split_fields1 s))) 0) (< 0 (to_rep (rec__patience__state__numstacks (us_split_fields1 s))))))) (= result1 false)))
(assert (=> (= result1 true) (= (= result true) (forall ((i Int)) (=> (and (<= 0 i) (<= i (- (to_rep (rec__patience__state__numelts (us_split_fields1 s))) 1))) (and (and (and (<= 0 (to_rep (select (rec__patience__state__posstack (us_split_fields1 s)) i))) (<= (to_rep (select (rec__patience__state__posstack (us_split_fields1 s)) i)) (- (to_rep (rec__patience__state__numstacks (us_split_fields1 s))) 1))) (and (<= 0 (to_rep (select (rec__patience__state__posheight (us_split_fields1 s)) i))) (<= (to_rep (select (rec__patience__state__posheight (us_split_fields1 s)) i)) (- (to_rep (select (rec__patience__state__stacksizes (us_split_fields1 s)) (to_rep (select (rec__patience__state__posstack (us_split_fields1 s)) i)))) 1)))) (= (to_rep (select (select (rec__patience__state__stacks (us_split_fields1 s)) (to_rep (select (rec__patience__state__posstack (us_split_fields1 s)) i))) (to_rep (select (rec__patience__state__posheight (us_split_fields1 s)) i)))) i)))))))
(assert (=> (not (= result1 true)) (= result false)))
(assert (= result true))
(assert (<= 0 ist))
(assert (<= ist (- (to_rep (rec__patience__state__numstacks (us_split_fields1 s))) 1)))
...
(assert (and (<= 0 ist) (<= ist 99)))
(assert (= o8 ist))
(assert (= temp___460 (select (rec__patience__state__stacks (us_split_fields1 s)) o8)))
(assert (and (<= 0 ip) (<= ip 99)))
(assert (= o9 ip))
(assert (= o10 (select temp___460 o9)))
(assert (= temp___461 (to_rep o10)))
(assert (and (<= 0 temp___461) (<= temp___461 99)))
(assert (= o11 temp___461))
(assert (= o12 (select (rec__patience__state__posheight (us_split_fields1 s)) o11)))
(assert (= o13 (to_rep o12)))
(assert (= o14 (ite (= ip o13) true false)))
(assert (and (<= 0 ist) (<= ist 99)))
(assert (= o5 ist))
(assert (= temp___456 (select (rec__patience__state__stacks (us_split_fields1 s)) o5)))
(assert (and (<= 0 ip) (<= ip 99)))
(assert (= o6 ip))
(assert (= o7 (select temp___456 o6)))
(assert (= temp___457 (to_rep o7)))
(assert (not (<= temp___457 99)))
(check-sat)
(exit)
