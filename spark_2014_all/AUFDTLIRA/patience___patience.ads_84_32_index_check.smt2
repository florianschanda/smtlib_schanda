...
(assert (= o69 ist))
(assert (= o70 (select (rec__patience__state__stacksizes (us_split_fields1 s)) o69)))
(assert (= o71 (to_rep1 o70)))
(assert (= o72 (- o71 1)))
(assert (= o73 (ite (<= ip o72) true false)))
(assert (= result8 (ite (<= 0 ip) o73 false)))
(assert (= result8 true))
(assert (and (<= 0 ist) (<= ist 99)))
(assert (= o77 ist))
(assert (= temp___430 (select (rec__patience__state__stacks (us_split_fields1 s)) o77)))
(assert (and (<= 0 ip) (<= ip 99)))
(assert (= o78 ip))
(assert (= o79 (select temp___430 o78)))
(assert (= temp___431 (to_rep1 o79)))
(assert (and (<= 0 temp___431) (<= temp___431 99)))
(assert (= o80 temp___431))
(assert (= o81 (select (rec__patience__state__posheight (us_split_fields1 s)) o80)))
(assert (= o82 (to_rep1 o81)))
(assert (= o83 (ite (= ip o82) true false)))
(assert (and (<= 0 ist) (<= ist 99)))
(assert (= o74 ist))
(assert (= temp___426 (select (rec__patience__state__stacks (us_split_fields1 s)) o74)))
(assert (and (<= 0 ip) (<= ip 99)))
(assert (= o75 ip))
(assert (= o76 (select temp___426 o75)))
(assert (= temp___427 (to_rep1 o76)))
