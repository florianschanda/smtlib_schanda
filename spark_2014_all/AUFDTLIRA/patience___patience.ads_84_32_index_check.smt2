...
(assert (and (<= 0 ist) (<= ist 99)))
(assert (= o8 ist))
(assert (= temp___430 (select (rec__patience__state__stacks (us_split_fields1 s)) o8)))
(assert (and (<= 0 ip) (<= ip 99)))
(assert (= o9 ip))
(assert (= o10 (select temp___430 o9)))
(assert (= temp___431 (to_rep1 o10)))
(assert (and (<= 0 temp___431) (<= temp___431 99)))
(assert (= o11 temp___431))
...
(assert (and (<= 0 ist) (<= ist 99)))
(assert (= o5 ist))
(assert (= temp___426 (select (rec__patience__state__stacks (us_split_fields1 s)) o5)))
(assert (and (<= 0 ip) (<= ip 99)))
(assert (= o6 ip))
(assert (= o7 (select temp___426 o6)))
(assert (= temp___427 (to_rep1 o7)))
(assert (not (<= 0 temp___427)))
(check-sat)
(exit)
