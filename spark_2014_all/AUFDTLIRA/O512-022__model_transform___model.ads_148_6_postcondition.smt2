...
(assert (not (= (bool_eq1 (owned_action (mk___rep2 (mk___split_fields2 self__split_fields4 self__split_fields5))) 0 100 (owned_action (mk___rep2 (mk___split_fields2 self__split_fields self__split_fields1))) 0 100) true)))
(check-sat)
(exit)
