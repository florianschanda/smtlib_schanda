...
(assert (and (= o64 (remove a o63)) (and (dynamic_invariant2 o64 true false true) (and (= (invariant__ o64) true) (and (= (to_rep2 (last (rt o64))) (- (to_rep2 (last (rt a))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- o63 1))) (= (to_rep (select (elts a) k1)) (to_rep (select (elts o64) k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ o63 1) k1) (<= k1 (to_rep2 (last (rt a))))) (= (to_rep (select (elts a) k1)) (to_rep (select (elts o64) (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= o63 k1) (<= k1 (- (to_rep2 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k1 1))) (to_rep (select (elts o64) k1))))))))))))
