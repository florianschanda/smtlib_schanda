...
(declare-fun temp___452 ((Array Int integer) Int Int) (Array Int integer))
(assert (forall ((temp___454 (Array Int integer))) (forall ((temp___455 Int) (temp___456 Int)) (let ((temp___453 (temp___452 temp___454 temp___455 temp___456))) (forall ((temp___457 Int)) (ite (= temp___457 temp___455) (= (select temp___453 temp___457) (of_rep temp___456)) (= (select temp___453 temp___457) (select temp___454 temp___457))))))))
(declare-fun temp___459 ((Array Int integer) Int Int) (Array Int integer))
(assert (forall ((temp___461 (Array Int integer))) (forall ((temp___462 Int) (temp___463 Int)) (let ((temp___460 (temp___459 temp___461 temp___462 temp___463))) (forall ((temp___464 Int)) (ite (= temp___464 temp___462) (= (select temp___460 temp___464) (of_rep temp___463)) (= (select temp___460 temp___464) (select temp___461 temp___464))))))))
(assert (in_range1 i))
...
(assert (= (bool_eq b (- 2147483648) 2147483647 (temp___452 c i 42) (- 2147483648) 2147483647) true))
(assert (not (= (to_rep (select a i)) (to_rep (select (temp___459 a i 42) i)))))
(check-sat)
(exit)
