...
(define-fun dynamic_invariant1 ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= 0 10000)) (in_range temp___expr_136)))
(assert (forall ((log us_rep)) (! (dynamic_invariant1 (log_size log) true false true) :pattern ((log_size log)))))
(assert (forall ((attr__tag1 Int)) (forall ((log us_rep)) (! (dynamic_invariant1 (log_size1 attr__tag1 log) true false true) :pattern ((log_size1 attr__tag1 log))))))
...
(declare-const log__split_fields6 (Array Int integer))
(declare-const log__split_fields7 log_count)
(declare-const log__split_fields8 us_private)
(assert (= (log_size (mk___rep (mk___split_fields logging__init_log__log__fields logging__init_log__log__fields1 logging__init_log__log__fields2) log__attr__tag)) 0))
(assert (= result log__split_fields))
(assert (= result1 log__split_fields1))
(assert (= result2 log__split_fields2))
(assert (= (mk___split_fields log__split_fields3 log__split_fields4 log__split_fields5) (mk___split_fields logging__init_log__log__fields logging__init_log__log__fields1 logging__init_log__log__fields2)))
(assert (not (< (log_size1 log__attr__tag (mk___rep (mk___split_fields log__split_fields3 log__split_fields4 log__split_fields5) log__attr__tag)) 10000)))
(check-sat)
(exit)
