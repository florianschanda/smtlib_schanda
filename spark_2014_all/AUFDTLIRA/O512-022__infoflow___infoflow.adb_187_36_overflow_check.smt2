...
(assert (and (= temp___486 (+ k_1 1)) (in_range1 (+ k_1 1))))
(assert (= (mk_int__ref result) (mk_int__ref i_v1)))
(assert (= i_v11 temp___486))
(assert (<= temp___486 i_v11))
(assert (<= i_v11 (to_rep a_v1__last)))
(assert (and (forall ((m Int)) (=> (and (<= (to_rep a_v1__first) m) (<= m k_1)) (= (to_rep (select a_v11 m)) (to_rep (select (elts b_v1) m))))) (forall ((m Int)) (=> (and (<= (+ k_1 1) m) (<= m (- i_v12 1))) (= (to_rep (select a_v11 m)) (to_rep (select (elts c_v1) (- m k_1))))))))
(assert (and (and (=> (<= (+ k_1 1) (to_rep a_v1__last)) (dynamic_property2 (+ k_1 1) (to_rep a_v1__last) i_v12)) (forall ((temp___484 Int)) (=> (and (<= (to_rep a_v1__first) temp___484) (<= temp___484 (to_rep a_v1__last))) (=> (<= i_v12 temp___484) (= (select a_v11 temp___484) (select a_v1 temp___484)))))) (and (<= (+ k_1 1) i_v12) (<= i_v12 (to_rep a_v1__last)))))
(assert (not (in_range1 (- i_v12 k_1))))
(check-sat)
(exit)
