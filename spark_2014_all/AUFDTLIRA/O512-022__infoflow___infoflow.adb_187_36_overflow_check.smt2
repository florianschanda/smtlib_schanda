...
(assert (and (and (=> (<= (+ k_1 1) (to_rep a_v1__last)) (dynamic_property2 (+ k_1 1) (to_rep a_v1__last) i_v12)) (forall ((temp___441 Int)) (=> (and (<= (to_rep a_v1__first) temp___441) (<= temp___441 (to_rep a_v1__last))) (=> (<= i_v12 temp___441) (= (select a_v11 temp___441) (select a_v1 temp___441)))))) (and (<= (+ k_1 1) i_v12) (<= i_v12 (to_rep a_v1__last)))))
