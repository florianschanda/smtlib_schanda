...
(assert (forall ((g1 Int)) (=> (and (<= 1 g1) (<= g1 64)) (exists ((g24 Int)) (and (and (<= 1 g24) (<= g24 64)) (= (to_rep (select g2_to_g1 g24)) g1))))))
...
(assert (<= 1 g1))
(assert (<= g1 64))
(assert (exists ((prev2 Int)) (and (and (<= 1 prev2) (<= prev2 (- g23 1))) (= (to_rep (select g2_to_g1 prev2)) g1))))
(assert (not (= (to_rep (select g2_to_g1 (to_rep1 (select result__3 g1)))) g1)))
(check-sat)
(exit)
