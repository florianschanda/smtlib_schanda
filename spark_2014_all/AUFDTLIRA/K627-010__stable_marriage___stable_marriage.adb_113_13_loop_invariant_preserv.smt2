...
(assert (forall ((temp___462 Int)) (forall ((temp___463 Int)) (= (select (stable_marriage__invert_map__result__aggregate_def temp___462) temp___463) (of_rep1 temp___462)))))
...
(assert (forall ((g11 Int)) (=> (and (<= 1 g11) (<= g11 64)) (exists ((g210 Int)) (and (and (<= 1 g210) (<= g210 64)) (= (to_rep (select g2_to_g1 g210)) g11))))))
...
(assert (forall ((g11 Int)) (=> (and (<= 1 g11) (<= g11 64)) (=> (exists ((prev21 Int)) (and (and (<= 1 prev21) (<= prev21 (- g22 1))) (= (to_rep (select g2_to_g1 prev21)) g11))) (= (to_rep (select g2_to_g1 (to_rep1 (select result__2 g11)))) g11)))))
...
(assert (<= 1 g11))
(assert (<= g11 64))
(assert (exists ((prev21 Int)) (and (and (<= 1 prev21) (<= prev21 (- g23 1))) (= (to_rep (select g2_to_g1 prev21)) g11))))
(assert (not (= (to_rep (select g2_to_g1 (to_rep1 (select result__3 g11)))) g11)))
(check-sat)
(exit)
