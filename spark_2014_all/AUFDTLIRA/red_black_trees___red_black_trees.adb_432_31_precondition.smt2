...
(assert (and (= o127 (parent (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields12)) o126)) (and (in_range3 o127) (and (= o127 (parent1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields12)))) o126)) (=> (= (size (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields12))) 0) (= o127 0))))))
(assert (and (= o128 o127) (in_range2 o127)))
(assert (not (not (= (size (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields12))) 0))))
(check-sat)
(exit)
