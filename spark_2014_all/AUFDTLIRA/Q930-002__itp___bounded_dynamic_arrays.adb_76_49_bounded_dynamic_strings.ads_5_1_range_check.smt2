...
(assert (=> (not (= (length1 temp___10342) 0)) (=> (<= (to_rep1 (first2 (rt1 right))) (to_rep1 (last2 (rt1 right)))) (= o (+ (- (to_rep1 (last2 (rt1 right))) (to_rep1 (first2 (rt1 right)))) 1)))))
(assert (=> (not (= (length1 temp___10342) 0)) (=> (not (<= (to_rep1 (first2 (rt1 right))) (to_rep1 (last2 (rt1 right))))) (= o 0))))
(assert (=> (not (= (length1 temp___10342) 0)) (=> (<= (to_rep1 (first2 temp___10341)) (to_rep1 (last2 temp___10341))) (= o1 (+ (- (to_rep1 (last2 temp___10341)) (to_rep1 (first2 temp___10341))) 1)))))
(assert (=> (not (= (length1 temp___10342) 0)) (=> (not (<= (to_rep1 (first2 temp___10341)) (to_rep1 (last2 temp___10341)))) (= o1 0))))
(assert (=> (not (= (length1 temp___10342) 0)) (= o2 (+ o1 o))))
(assert (=> (not (= (length1 temp___10342) 0)) (= o3 (+ (to_rep1 (first2 temp___10341)) o2))))
(assert (=> (not (= (length1 temp___10342) 0)) (= o4 (- o3 1))))
(assert (=> (not (= (length1 temp___10342) 0)) (and (= o5 o4) (in_range2 o4))))
...
(assert (=> (not (= (length1 temp___10342) 0)) (= (mk (to_rep1 (first2 temp___10341)) o5) temp___10351)))
(assert (dynamic_property1 1 2147483647 (to_rep1 (first temp___10351)) (to_rep1 (last temp___10351))))
(assert (= temp___1035 o6))
(assert (= (mk1 (to_rep1 (first temp___10351)) (to_rep1 (last temp___10351))) o7))
