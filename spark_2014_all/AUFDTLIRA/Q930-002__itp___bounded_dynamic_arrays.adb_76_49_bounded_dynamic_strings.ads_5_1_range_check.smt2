...
(assert (and (= (mk___t1 temp___971 temp___9711) (value left)) (and (dynamic_invariant (mk___t1 temp___971 temp___9711) true false true) (and (and (= (elts2 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 left))) temp___971) (= (mk1 (to_rep1 (first6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 left)))))) (to_rep1 (last6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 left))))))) temp___9711)) (and (and (and (= (length1 (mk___t1 temp___971 temp___9711)) (length3 left)) (= (to_rep1 (first2 temp___9711)) 1)) (= (to_rep1 (last2 temp___9711)) (length3 left))) (= (< 0 (length3 left)) (not (= (empty left) true))))))))
(assert (=> (= (length1 (mk___t1 temp___971 temp___9711)) 0) (= (elts1 right) temp___972)))
(assert (=> (= (length1 (mk___t1 temp___971 temp___9711)) 0) (= (mk (to_rep1 (first2 (rt1 right))) (to_rep1 (last2 (rt1 right)))) temp___9721)))
(assert (=> (not (= (length1 (mk___t1 temp___971 temp___9711)) 0)) (=> (<= (to_rep1 (first2 (rt1 right))) (to_rep1 (last2 (rt1 right)))) (= o3 (+ (- (to_rep1 (last2 (rt1 right))) (to_rep1 (first2 (rt1 right)))) 1)))))
(assert (=> (not (= (length1 (mk___t1 temp___971 temp___9711)) 0)) (=> (not (<= (to_rep1 (first2 (rt1 right))) (to_rep1 (last2 (rt1 right))))) (= o3 0))))
(assert (=> (not (= (length1 (mk___t1 temp___971 temp___9711)) 0)) (=> (<= (to_rep1 (first2 temp___9711)) (to_rep1 (last2 temp___9711))) (= o4 (+ (- (to_rep1 (last2 temp___9711)) (to_rep1 (first2 temp___9711))) 1)))))
(assert (=> (not (= (length1 (mk___t1 temp___971 temp___9711)) 0)) (=> (not (<= (to_rep1 (first2 temp___9711)) (to_rep1 (last2 temp___9711)))) (= o4 0))))
(assert (=> (not (= (length1 (mk___t1 temp___971 temp___9711)) 0)) (= o5 (+ o4 o3))))
(assert (=> (not (= (length1 (mk___t1 temp___971 temp___9711)) 0)) (= o6 (+ (to_rep1 (first2 temp___9711)) o5))))
(assert (=> (not (= (length1 (mk___t1 temp___971 temp___9711)) 0)) (= o7 (- o6 1))))
(assert (=> (not (= (length1 (mk___t1 temp___971 temp___9711)) 0)) (and (= o8 o7) (in_range2 o7))))
(assert (=> (not (= (length1 (mk___t1 temp___971 temp___9711)) 0)) (= (concat1 temp___971 (to_rep1 (first2 temp___9711)) (to_rep1 (last2 temp___9711)) (elts1 right) (to_rep1 (first2 (rt1 right))) (to_rep1 (last2 (rt1 right)))) temp___972)))
(assert (=> (not (= (length1 (mk___t1 temp___971 temp___9711)) 0)) (= (mk (to_rep1 (first2 temp___9711)) o8) temp___9721)))
(assert (dynamic_property1 1 2147483647 (to_rep1 (first temp___9721)) (to_rep1 (last temp___9721))))
(assert (= temp___972 o9))
(assert (= (mk1 (to_rep1 (first temp___9721)) (to_rep1 (last temp___9721))) o10))
