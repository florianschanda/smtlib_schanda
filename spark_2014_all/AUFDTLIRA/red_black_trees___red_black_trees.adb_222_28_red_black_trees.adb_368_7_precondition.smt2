...
(assert (<= 1 n5))
(assert (<= n5 100))
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c67b))) i1))) true) (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c67b) i1)))) n6)) (not (= i1 (root (rec__red_black_trees__rbt__struct (us_split_fields9 c68b)))))) (= (eq (select (nb_blacks c68b) i1) (select (nb_blacks c67b) i1)) true)))))
(assert (and (=> (<= 1 100) (in_range2 n6)) (and (<= 1 n6) (<= n6 100))))
(assert (<= 1 i))
(assert (<= i 100))
(assert (and (= temp___657 (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)))) (and (dynamic_invariant5 temp___657 true false true true) (= temp___657 (model__1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)))) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 c67b))))))))))
(assert (= o11 (select temp___657 i)))
(assert (= o12 (us_split_fields1 o11)))
(assert (= result7 (rec__tree_model__path_type__k o12)))
(assert (=> (= result7 true) (and (= temp___658 (nb_blacks c67b)) (and (= (bool_eq11 (select temp___658 0) (mk___rep5 (mk___split_fields5 (distinct 1 0) (of_rep 0) (of_rep 0)))) true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c67b))) i1))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___658 i1))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___658 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i1 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___658 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i1 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___658 i1)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___658 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i1 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___658 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i1 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___658 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i1 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___658 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i1 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___658 i1)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c67b)) i1)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___658 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i1 0)))))))))))))))
(assert (=> (= result7 true) (= o7 (select temp___658 i))))
(assert (=> (= result7 true) (= o8 (us_split_fields11 o7))))
(assert (=> (= result7 true) (= o9 (rec__red_black_trees__black_count__depth o8))))
(assert (=> (= result7 true) (= o10 (to_rep o9))))
(assert (=> (= result7 true) (= result6 (ite (< o10 n6) true false))))
(assert (=> (not (= result7 true)) (= result6 false)))
(assert (=> (= result6 true) (and (= o5 (root (rec__red_black_trees__rbt__struct (us_split_fields9 c68b)))) (and (in_range2 o5) (= o5 (to_rep (rec__search_trees__search_tree__root (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 c68b))))))))))
(assert (=> (= result6 true) (= o6 (ite (= i o5) true false))))
(assert (=> (= result6 true) (= result5 (ite (not (= o6 true)) true false))))
(assert (=> (not (= result6 true)) (= result5 false)))
(assert (= result5 true))
(assert (and (= temp___656 (nb_blacks c67b)) (and (= (bool_eq11 (select temp___656 0) (mk___rep5 (mk___split_fields5 (distinct 1 0) (of_rep 0) (of_rep 0)))) true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c67b))) i1))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___656 i1))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___656 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i1 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___656 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i1 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___656 i1)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___656 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i1 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___656 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i1 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___656 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i1 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___656 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i1 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___656 i1)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c67b)) i1)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___656 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i1 0))))))))))))))
(assert (= o13 (select temp___656 i)))
