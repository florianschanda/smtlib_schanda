...
(assert (= o11 (select temp___608 i)))
(assert (= o12 (us_split_fields1 o11)))
(assert (= result7 (rec__tree_model__path_type__k o12)))
(assert (=> (= result7 true) (and (= temp___609 (nb_blacks c67b)) (and (= (bool_eq11 (select temp___609 0) (mk___rep5 (mk___split_fields5 (of_int 1) (of_rep 0) (of_rep 0)))) true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c67b))) i1))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___609 i1))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___609 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i1 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___609 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i1 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___609 i1)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___609 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i1 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___609 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i1 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___609 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i1 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___609 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i1 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___609 i1)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c67b)) i1)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___609 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i1 0)))))))))))))))
(assert (=> (= result7 true) (= o7 (select temp___609 i))))
...
(assert (= result5 true))
(assert (and (= temp___607 (nb_blacks c67b)) (and (= (bool_eq11 (select temp___607 0) (mk___rep5 (mk___split_fields5 (of_int 1) (of_rep 0) (of_rep 0)))) true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c67b))) i1))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___607 i1))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___607 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i1 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___607 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i1 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___607 i1)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___607 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i1 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___607 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i1 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___607 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i1 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___607 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i1 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___607 i1)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c67b)) i1)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___607 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i1 0))))))))))))))
(assert (= o13 (select temp___607 i)))
