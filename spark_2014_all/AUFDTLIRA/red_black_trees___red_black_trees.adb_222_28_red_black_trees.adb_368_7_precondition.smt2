...
(assert (= result9 true))
(assert (= result10 (mk_int__ref n1)))
(assert (= n31 1))
(assert (<= 1 n31))
(assert (<= n31 100))
(assert (forall ((i14 Int)) (=> (and (<= 1 i14) (<= i14 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c67b))) i14))) true) (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c67b) i14)))) n32)) (not (= i14 (root (rec__red_black_trees__rbt__struct (us_split_fields9 c68b)))))) (= (eq (select (nb_blacks c68b) i14) (select (nb_blacks c67b) i14)) true)))))
(assert (and (=> (<= 1 100) (in_range2 n32)) (and (<= 1 n32) (<= n32 100))))
(assert (<= 1 i1))
(assert (<= i1 100))
(assert (and (= temp___608 (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)))) (and (dynamic_invariant5 temp___608 true false true) (= temp___608 (model__1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)))) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 c67b))))))))))
(assert (= o21 (select temp___608 i1)))
(assert (= o22 (us_split_fields1 o21)))
(assert (= result13 (rec__tree_model__path_type__k o22)))
(assert (=> (= result13 true) (and (= temp___609 (nb_blacks c67b)) (and (= (bool_eq11 (select temp___609 0) (mk___rep5 (mk___split_fields5 (of_int 1) (of_rep 0) (of_rep 0)))) true) (forall ((i14 Int)) (=> (and (<= 1 i14) (<= i14 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c67b))) i14))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___609 i14))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___609 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___609 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i14 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___609 i14)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___609 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___609 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i14 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___609 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i14 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___609 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i14 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___609 i14)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c67b)) i14)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___609 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i14 0)))))))))))))))
(assert (=> (= result13 true) (= o17 (select temp___609 i1))))
(assert (=> (= result13 true) (= o18 (us_split_fields11 o17))))
(assert (=> (= result13 true) (= o19 (rec__red_black_trees__black_count__depth o18))))
(assert (=> (= result13 true) (= o20 (to_rep o19))))
(assert (=> (= result13 true) (= result12 (ite (< o20 n32) true false))))
(assert (=> (not (= result13 true)) (= result12 false)))
(assert (=> (= result12 true) (and (= o15 (root (rec__red_black_trees__rbt__struct (us_split_fields9 c68b)))) (and (in_range2 o15) (= o15 (to_rep (rec__search_trees__search_tree__root (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 c68b))))))))))
(assert (=> (= result12 true) (= o16 (ite (= i1 o15) true false))))
(assert (=> (= result12 true) (= result11 (ite (not (= o16 true)) true false))))
(assert (=> (not (= result12 true)) (= result11 false)))
(assert (= result11 true))
(assert (and (= temp___607 (nb_blacks c67b)) (and (= (bool_eq11 (select temp___607 0) (mk___rep5 (mk___split_fields5 (of_int 1) (of_rep 0) (of_rep 0)))) true) (forall ((i14 Int)) (=> (and (<= 1 i14) (<= i14 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c67b))) i14))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___607 i14))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___607 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___607 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i14 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___607 i14)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___607 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___607 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i14 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___607 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i14 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___607 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i14 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___607 i14)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c67b)) i14)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___607 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i14 0))))))))))))))
(assert (= o23 (select temp___607 i1)))
(assert (not (not (= (size (rec__red_black_trees__rbt__struct (us_split_fields9 c68b))) 0))))
(check-sat)
(exit)
