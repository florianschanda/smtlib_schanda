...
(assert (not (< y x)))
(assert (=> (<= 1 1) (in_range4 hr2)))
(assert (= (let ((temp___235 (remove (remove (mk___t values2 (mk 1 100)) x) (- y 1)))) (let ((temp___234 (remove (remove (mk___t init (mk 1 100)) x) (- y 1)))) (bool_eq (elts temp___234) (to_rep1 (first (rt temp___234))) (to_rep1 (last (rt temp___234))) (elts temp___235) (to_rep1 (first (rt temp___235))) (to_rep1 (last (rt temp___235)))))) true))
(assert (and (= o157 (- y 1)) (in_range5 (- y 1))))
(assert (and (= o155 x) (in_range5 x)))
(assert (and (= o156 (remove (mk___t values2 (mk 1 100)) o155)) (and (dynamic_invariant4 o156 true false true) (and (= (invariant__ o156) true) (and (= (to_rep1 (last (rt o156))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o155 1))) (= (to_rep (select values2 k)) (to_rep (select (elts o156) k))))) (and (forall ((k Int)) (=> (and (<= (+ o155 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select (elts o156) (- k 1)))))) (forall ((k Int)) (=> (and (<= o155 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts o156) k))))))))))))
(assert (and (= o158 (remove o156 o157)) (and (dynamic_invariant4 o158 true false true) (and (= (invariant__ o158) true) (and (= (to_rep1 (last (rt o158))) (- (to_rep1 (last (rt o156))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o157 1))) (= (to_rep (select (elts o156) k)) (to_rep (select (elts o158) k))))) (and (forall ((k Int)) (=> (and (<= (+ o157 1) k) (<= k (to_rep1 (last (rt o156))))) (= (to_rep (select (elts o156) k)) (to_rep (select (elts o158) (- k 1)))))) (forall ((k Int)) (=> (and (<= o157 k) (<= k (- (to_rep1 (last (rt o156))) 1))) (= (to_rep (select (elts o156) (+ k 1))) (to_rep (select (elts o158) k))))))))))))
(assert (and (= o153 (- y 1)) (in_range5 (- y 1))))
(assert (and (= o151 x) (in_range5 x)))
(assert (and (= o152 (remove (mk___t init (mk 1 100)) o151)) (and (dynamic_invariant4 o152 true false true) (and (= (invariant__ o152) true) (and (= (to_rep1 (last (rt o152))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o151 1))) (= (to_rep (select init k)) (to_rep (select (elts o152) k))))) (and (forall ((k Int)) (=> (and (<= (+ o151 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select init k)) (to_rep (select (elts o152) (- k 1)))))) (forall ((k Int)) (=> (and (<= o151 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select init (+ k 1))) (to_rep (select (elts o152) k))))))))))))
(assert (and (= o154 (remove o152 o153)) (and (dynamic_invariant4 o154 true false true) (and (= (invariant__ o154) true) (and (= (to_rep1 (last (rt o154))) (- (to_rep1 (last (rt o152))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o153 1))) (= (to_rep (select (elts o152) k)) (to_rep (select (elts o154) k))))) (and (forall ((k Int)) (=> (and (<= (+ o153 1) k) (<= k (to_rep1 (last (rt o152))))) (= (to_rep (select (elts o152) k)) (to_rep (select (elts o154) (- k 1)))))) (forall ((k Int)) (=> (and (<= o153 k) (<= k (- (to_rep1 (last (rt o152))) 1))) (= (to_rep (select (elts o152) (+ k 1))) (to_rep (select (elts o154) k))))))))))))
(assert (and (= o159 (perm_reflexive o154 o158)) (and (in_range4 o159) (=> (= (of_int o159) true) (= (is_perm o154 o158) true)))))
(assert (= result16 (mk_int__ref hr)))
(assert (= hr17 o159))
(assert (and (= o161 y) (in_range5 y)))
(assert (and (= o160 x) (in_range5 x)))
(assert (and (= o162 (remove_swap (mk___t values2 (mk 1 100)) o160 o161)) (and (in_range4 o162) (=> (= (of_int o162) true) (= (let ((temp___157 (remove (remove (mk___t values2 (mk 1 100)) o161) o160))) (let ((temp___156 (remove (remove (mk___t values2 (mk 1 100)) o160) (- o161 1)))) (bool_eq (elts temp___156) (to_rep1 (first (rt temp___156))) (to_rep1 (last (rt temp___156))) (elts temp___157) (to_rep1 (first (rt temp___157))) (to_rep1 (last (rt temp___157)))))) true)))))
(assert (= result17 (mk_int__ref hr17)))
(assert (= hr18 o162))
(assert (and (= o169 x) (in_range5 x)))
(assert (and (= o167 y) (in_range5 y)))
(assert (and (= o168 (remove (mk___t values2 (mk 1 100)) o167)) (and (dynamic_invariant4 o168 true false true) (and (= (invariant__ o168) true) (and (= (to_rep1 (last (rt o168))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o167 1))) (= (to_rep (select values2 k)) (to_rep (select (elts o168) k))))) (and (forall ((k Int)) (=> (and (<= (+ o167 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select (elts o168) (- k 1)))))) (forall ((k Int)) (=> (and (<= o167 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts o168) k))))))))))))
(assert (and (= o170 (remove o168 o169)) (and (dynamic_invariant4 o170 true false true) (and (= (invariant__ o170) true) (and (= (to_rep1 (last (rt o170))) (- (to_rep1 (last (rt o168))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o169 1))) (= (to_rep (select (elts o168) k)) (to_rep (select (elts o170) k))))) (and (forall ((k Int)) (=> (and (<= (+ o169 1) k) (<= k (to_rep1 (last (rt o168))))) (= (to_rep (select (elts o168) k)) (to_rep (select (elts o170) (- k 1)))))) (forall ((k Int)) (=> (and (<= o169 k) (<= k (- (to_rep1 (last (rt o168))) 1))) (= (to_rep (select (elts o168) (+ k 1))) (to_rep (select (elts o170) k))))))))))))
(assert (and (= o165 (- y 1)) (in_range5 (- y 1))))
(assert (and (= o163 x) (in_range5 x)))
(assert (and (= o164 (remove (mk___t values2 (mk 1 100)) o163)) (and (dynamic_invariant4 o164 true false true) (and (= (invariant__ o164) true) (and (= (to_rep1 (last (rt o164))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o163 1))) (= (to_rep (select values2 k)) (to_rep (select (elts o164) k))))) (and (forall ((k Int)) (=> (and (<= (+ o163 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select (elts o164) (- k 1)))))) (forall ((k Int)) (=> (and (<= o163 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts o164) k))))))))))))
(assert (and (= o166 (remove o164 o165)) (and (dynamic_invariant4 o166 true false true) (and (= (invariant__ o166) true) (and (= (to_rep1 (last (rt o166))) (- (to_rep1 (last (rt o164))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o165 1))) (= (to_rep (select (elts o164) k)) (to_rep (select (elts o166) k))))) (and (forall ((k Int)) (=> (and (<= (+ o165 1) k) (<= k (to_rep1 (last (rt o164))))) (= (to_rep (select (elts o164) k)) (to_rep (select (elts o166) (- k 1)))))) (forall ((k Int)) (=> (and (<= o165 k) (<= k (- (to_rep1 (last (rt o164))) 1))) (= (to_rep (select (elts o164) (+ k 1))) (to_rep (select (elts o166) k))))))))))))
(assert (and (= o171 (perm_reflexive o166 o170)) (and (in_range4 o171) (=> (= (of_int o171) true) (= (is_perm o166 o170) true)))))
(assert (= result18 (mk_int__ref hr18)))
(assert (= hr19 o171))
(assert (and (= o182 x) (in_range5 x)))
(assert (and (= o180 y) (in_range5 y)))
(assert (and (= o181 (remove (mk___t values2 (mk 1 100)) o180)) (and (dynamic_invariant4 o181 true false true) (and (= (invariant__ o181) true) (and (= (to_rep1 (last (rt o181))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o180 1))) (= (to_rep (select values2 k)) (to_rep (select (elts o181) k))))) (and (forall ((k Int)) (=> (and (<= (+ o180 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select (elts o181) (- k 1)))))) (forall ((k Int)) (=> (and (<= o180 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts o181) k))))))))))))
(assert (and (= o183 (remove o181 o182)) (and (dynamic_invariant4 o183 true false true) (and (= (invariant__ o183) true) (and (= (to_rep1 (last (rt o183))) (- (to_rep1 (last (rt o181))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o182 1))) (= (to_rep (select (elts o181) k)) (to_rep (select (elts o183) k))))) (and (forall ((k Int)) (=> (and (<= (+ o182 1) k) (<= k (to_rep1 (last (rt o181))))) (= (to_rep (select (elts o181) k)) (to_rep (select (elts o183) (- k 1)))))) (forall ((k Int)) (=> (and (<= o182 k) (<= k (- (to_rep1 (last (rt o181))) 1))) (= (to_rep (select (elts o181) (+ k 1))) (to_rep (select (elts o183) k))))))))))))
(assert (and (= o178 (- y 1)) (in_range5 (- y 1))))
(assert (and (= o176 x) (in_range5 x)))
(assert (and (= o177 (remove (mk___t values2 (mk 1 100)) o176)) (and (dynamic_invariant4 o177 true false true) (and (= (invariant__ o177) true) (and (= (to_rep1 (last (rt o177))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o176 1))) (= (to_rep (select values2 k)) (to_rep (select (elts o177) k))))) (and (forall ((k Int)) (=> (and (<= (+ o176 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select (elts o177) (- k 1)))))) (forall ((k Int)) (=> (and (<= o176 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts o177) k))))))))))))
(assert (and (= o179 (remove o177 o178)) (and (dynamic_invariant4 o179 true false true) (and (= (invariant__ o179) true) (and (= (to_rep1 (last (rt o179))) (- (to_rep1 (last (rt o177))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o178 1))) (= (to_rep (select (elts o177) k)) (to_rep (select (elts o179) k))))) (and (forall ((k Int)) (=> (and (<= (+ o178 1) k) (<= k (to_rep1 (last (rt o177))))) (= (to_rep (select (elts o177) k)) (to_rep (select (elts o179) (- k 1)))))) (forall ((k Int)) (=> (and (<= o178 k) (<= k (- (to_rep1 (last (rt o177))) 1))) (= (to_rep (select (elts o177) (+ k 1))) (to_rep (select (elts o179) k))))))))))))
(assert (and (= o174 (- y 1)) (in_range5 (- y 1))))
(assert (and (= o172 x) (in_range5 x)))
(assert (and (= o173 (remove (mk___t init (mk 1 100)) o172)) (and (dynamic_invariant4 o173 true false true) (and (= (invariant__ o173) true) (and (= (to_rep1 (last (rt o173))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o172 1))) (= (to_rep (select init k)) (to_rep (select (elts o173) k))))) (and (forall ((k Int)) (=> (and (<= (+ o172 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select init k)) (to_rep (select (elts o173) (- k 1)))))) (forall ((k Int)) (=> (and (<= o172 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select init (+ k 1))) (to_rep (select (elts o173) k))))))))))))
(assert (and (= o175 (remove o173 o174)) (and (dynamic_invariant4 o175 true false true) (and (= (invariant__ o175) true) (and (= (to_rep1 (last (rt o175))) (- (to_rep1 (last (rt o173))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o174 1))) (= (to_rep (select (elts o173) k)) (to_rep (select (elts o175) k))))) (and (forall ((k Int)) (=> (and (<= (+ o174 1) k) (<= k (to_rep1 (last (rt o173))))) (= (to_rep (select (elts o173) k)) (to_rep (select (elts o175) (- k 1)))))) (forall ((k Int)) (=> (and (<= o174 k) (<= k (- (to_rep1 (last (rt o173))) 1))) (= (to_rep (select (elts o173) (+ k 1))) (to_rep (select (elts o175) k))))))))))))
(assert (and (= o184 (perm_transitive o175 o179 o183)) (and (in_range4 o184) (=> (= (of_int o184) true) (= (is_perm o175 o183) true)))))
(assert (= result19 (mk_int__ref hr19)))
(assert (= hr20 o184))
(assert (and (= o186 y) (in_range5 y)))
(assert (and (= temp___242 (remove (mk___t values2 (mk 1 100)) o186)) (and (dynamic_invariant4 temp___242 true false true) (and (= (invariant__ temp___242) true) (and (= (to_rep1 (last (rt temp___242))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o186 1))) (= (to_rep (select values2 k)) (to_rep (select (elts temp___242) k))))) (and (forall ((k Int)) (=> (and (<= (+ o186 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select (elts temp___242) (- k 1)))))) (forall ((k Int)) (=> (and (<= o186 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts temp___242) k))))))))))))
(assert (and (<= (to_rep1 (first (rt temp___242))) x) (<= x (to_rep1 (last (rt temp___242))))))
(assert (= o187 x))
(assert (= o188 (select (elts temp___242) o187)))
(assert (= o189 (to_rep o188)))
(assert (and (= o185 x) (in_range5 x)))
(assert (and (= temp___240 (remove (mk___t init (mk 1 100)) o185)) (and (dynamic_invariant4 temp___240 true false true) (and (= (invariant__ temp___240) true) (and (= (to_rep1 (last (rt temp___240))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o185 1))) (= (to_rep (select init k)) (to_rep (select (elts temp___240) k))))) (and (forall ((k Int)) (=> (and (<= (+ o185 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select init k)) (to_rep (select (elts temp___240) (- k 1)))))) (forall ((k Int)) (=> (and (<= o185 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select init (+ k 1))) (to_rep (select (elts temp___240) k))))))))))))
(assert (not (<= (to_rep1 (first (rt temp___240))) (- y 1))))
(check-sat)
(exit)
