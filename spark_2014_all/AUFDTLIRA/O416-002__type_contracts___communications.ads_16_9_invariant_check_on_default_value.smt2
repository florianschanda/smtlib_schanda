...
(define-fun temp___2883 () us_rep1 (mk___rep1 (mk___split_discrs temp___288) (mk___split_fields1 (mk___t temp___2881 temp___2882))))
(assert (in_range2 temp___num_287))
(assert (dynamic_invariant2 temp___2883 true false true))
(assert (not (type_invariant temp___2883)))
(check-sat)
(exit)
