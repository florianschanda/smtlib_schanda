...
(assert (<= 1 i))
(assert (<= i 100))
(assert (=> (not (= v 0)) (and (= temp___1536 (model__ f v)) (and (dynamic_invariant5 temp___1536 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1536 v))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1536 v)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 v)) (ite (and (not (= (parent f i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1536 (parent f i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1536 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1536 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1536 i1))) true) (not (= i1 v))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1536 (parent f i1)))) (position f i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1536 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1536 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1536 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1536 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1536 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1536 j)))) true)) (= j i1)))))))))))))))
(assert (=> (not (= v 0)) (= o (select temp___1536 i))))
(assert (=> (not (= v 0)) (= o1 (us_split_fields1 o))))
(assert (=> (not (= v 0)) (= result8 (rec__tree_model__path_type__k o1))))
(assert (=> (not (not (= v 0))) (= result8 false)))
(assert (= result8 true))
