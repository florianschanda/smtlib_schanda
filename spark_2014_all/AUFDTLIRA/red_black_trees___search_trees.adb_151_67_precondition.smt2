...
(assert (<= 1 i4))
(assert (<= i4 100))
(assert (=> (not (= v 0)) (and (= temp___1492 (model__ f v)) (and (dynamic_invariant5 temp___1492 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1492 v))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1492 v)))) 0) (and (forall ((i34 Int)) (=> (and (<= 1 i34) (<= i34 100)) (=> (not (= i34 v)) (ite (and (not (= (parent f i34) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1492 (parent f i34)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1492 i34))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1492 i34))) true)))))) (and (forall ((i34 Int)) (=> (and (<= 1 i34) (<= i34 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1492 i34))) true) (not (= i34 v))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1492 (parent f i34)))) (position f i34) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1492 i34)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1492 i34)))) 0)))) (forall ((i34 Int)) (=> (and (<= 1 i34) (<= i34 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1492 i34))) true) (forall ((j52 Int)) (=> (and (<= 1 j52) (<= j52 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1492 j52))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1492 i34))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1492 j52)))) true)) (= j52 i34)))))))))))))))
(assert (=> (not (= v 0)) (= o27 (select temp___1492 i4))))
(assert (=> (not (= v 0)) (= o28 (us_split_fields1 o27))))
(assert (=> (not (= v 0)) (= result12 (rec__tree_model__path_type__k o28))))
(assert (=> (= v 0) (= result12 false)))
