...
(declare-const temp___1342 (Array Int us_rep1))
...
(assert (= result2 true))
(assert (and (= temp___1342 (model__ f_old root)) (and (dynamic_invariant5 temp___1342 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1342 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1342 root)))) 0) (and (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (=> (not (= i3 root)) (ite (and (not (= (parent f_old i3) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1342 (parent f_old i3)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1342 i3))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1342 i3))) true)))))) (and (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1342 i3))) true) (not (= i3 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1342 (parent f_old i3)))) (position f_old i3) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1342 i3)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1342 i3)))) 0)))) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1342 i3))) true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1342 j2))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1342 i3))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1342 j2)))) true)) (= j2 i3))))))))))))))
(assert (= o10 (select temp___1342 j1)))
