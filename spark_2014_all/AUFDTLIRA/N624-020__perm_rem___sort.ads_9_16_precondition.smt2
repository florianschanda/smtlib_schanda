...
(assert (=> (and (<= 1 current1) (<= current1 99)) (= temp___205 current1)))
(assert (=> (and (<= 1 current1) (<= current1 99)) (= temp___204 smallest)))
...
(assert (=> (and (<= 1 current1) (<= current1 99)) (=> (not (= smallest2 current1)) (and (= o2 (perm_transitive (mk___t init (mk 1 100)) (mk___t prec2 (mk 1 100)) (mk___t values2 (mk 1 100)))) (and (in_range2 o2) (=> (= (of_int o2) true) (= (is_perm (mk___t init (mk 1 100)) (mk___t values2 (mk 1 100))) true)))))))
...
(assert (=> (and (<= 1 current1) (<= current1 99)) (= (is_perm (mk___t temp___206 (mk 1 100)) (mk___t values3 (mk 1 100))) true)))
