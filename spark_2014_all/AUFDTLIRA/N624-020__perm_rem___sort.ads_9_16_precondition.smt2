...
(declare-const temp___227 (Array Int natural))
...
(assert (= current1 1))
(assert (=> (and (<= 1 current1) (<= current1 99)) (= temp___232 values)))
(assert (=> (and (<= 1 current1) (<= current1 99)) (= temp___231 current1)))
(assert (=> (and (<= 1 current1) (<= current1 99)) (= temp___230 smallest)))
(assert (=> (and (<= 1 current1) (<= current1 99)) (= temp___229 values)))
(assert (=> (and (<= 1 current1) (<= current1 99)) (= temp___228 hr1)))
(assert (=> (and (<= 1 current1) (<= current1 99)) (= temp___227 prec1)))
...
(assert (=> (and (<= 1 current1) (<= current1 99)) (=> (not (= smallest2 current1)) (and (= o2 (perm_transitive (mk___t init (mk 1 100)) (mk___t prec2 (mk 1 100)) (mk___t values2 (mk 1 100)))) (and (in_range2 o2) (=> (= (distinct o2 0) true) (= (is_perm (mk___t init (mk 1 100)) (mk___t values2 (mk 1 100))) true)))))))
...
(assert (=> (and (<= 1 current1) (<= current1 99)) (= (is_perm (mk___t temp___232 (mk 1 100)) (mk___t values3 (mk 1 100))) true)))
(assert (=> (and (<= 1 current1) (<= current1 99)) (and (and (and (=> (<= 1 1) (in_range2 hr3)) (=> (<= 1 2147483647) (in_range1 smallest3))) (=> (<= 1 99) (in_range7 current2))) (and (<= 1 current2) (<= current2 99)))))
