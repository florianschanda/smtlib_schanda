...
(assert (forall ((item Int)) (! (=> (dynamic_invariant2 item true true true) (dynamic_invariant2 (to_lower item) true false true)) :pattern ((to_lower item)))))
...
(assert (dynamic_invariant1 res true false true))
(assert (in_range1 last2))
(assert (and (and (<= last2 (to_rep1 (last (rt str)))) (= (to_rep1 (last (rt str))) (to_rep1 (last (rt res))))) (= (to_rep1 (first (rt str))) (to_rep1 (first (rt res))))))
(assert (<= (to_rep1 (first (rt str))) j))
(assert (<= j last2))
(assert (not (= j (to_rep1 (first (rt str))))))
(assert (and (= temp___5851 (- j 1)) (in_range1 (- j 1))))
(assert (and (<= (to_rep1 (first (rt str))) temp___5851) (<= temp___5851 (to_rep1 (last (rt str))))))
(assert (= o16 temp___5851))
(assert (= o17 (select (elts str) o16)))
(assert (= o18 (to_rep o17)))
(assert (= o19 (ite (<= o18 122) true false)))
(assert (and (= temp___585 (- j 1)) (in_range1 (- j 1))))
(assert (and (<= (to_rep1 (first (rt str))) temp___585) (<= temp___585 (to_rep1 (last (rt str))))))
(assert (= o13 temp___585))
(assert (= o14 (select (elts str) o13)))
(assert (= o15 (to_rep o14)))
(assert (= o20 (ite (<= 97 o15) true false)))
(assert (= o21 (ite (= o20 true) o19 false)))
(assert (= result1 (ite (not (= o21 true)) true false)))
(assert (=> (= result1 true) (and (= temp___5861 (- j 1)) (in_range1 (- j 1)))))
(assert (=> (= result1 true) (and (<= (to_rep1 (first (rt str))) temp___5861) (<= temp___5861 (to_rep1 (last (rt str)))))))
(assert (=> (= result1 true) (= o7 temp___5861)))
(assert (=> (= result1 true) (= o8 (select (elts str) o7))))
(assert (=> (= result1 true) (= o9 (to_rep o8))))
(assert (=> (= result1 true) (= o10 (ite (<= o9 90) true false))))
(assert (=> (= result1 true) (and (= temp___586 (- j 1)) (in_range1 (- j 1)))))
(assert (=> (= result1 true) (and (<= (to_rep1 (first (rt str))) temp___586) (<= temp___586 (to_rep1 (last (rt str)))))))
(assert (=> (= result1 true) (= o4 temp___586)))
(assert (=> (= result1 true) (= o5 (select (elts str) o4))))
(assert (=> (= result1 true) (= o6 (to_rep o5))))
(assert (=> (= result1 true) (= o11 (ite (<= 65 o6) true false))))
(assert (=> (= result1 true) (= o12 (ite (= o11 true) o10 false))))
(assert (=> (= result1 true) (= result (ite (not (= o12 true)) true false))))
(assert (=> (not (= result1 true)) (= result false)))
(assert (not (= result true)))
(assert (not (<= (to_rep1 (first (rt str))) j)))
(check-sat)
(exit)
