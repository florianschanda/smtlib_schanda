...
(assert (and (= temp___6601 (- j 1)) (in_range1 (- j 1))))
(assert (and (<= (to_rep1 (first (rt str))) temp___6601) (<= temp___6601 (to_rep1 (last (rt str))))))
(assert (= o12 temp___6601))
(assert (= o13 (select (elts str) o12)))
(assert (= o14 (to_rep o13)))
(assert (= o15 (ite (<= o14 122) true false)))
(assert (and (= temp___660 (- j 1)) (in_range1 (- j 1))))
(assert (and (<= (to_rep1 (first (rt str))) temp___660) (<= temp___660 (to_rep1 (last (rt str))))))
(assert (= o9 temp___660))
...
(assert (=> (= result1 true) (and (= temp___6611 (- j 1)) (in_range1 (- j 1)))))
(assert (=> (= result1 true) (and (<= (to_rep1 (first (rt str))) temp___6611) (<= temp___6611 (to_rep1 (last (rt str)))))))
(assert (=> (= result1 true) (= o3 temp___6611)))
(assert (=> (= result1 true) (= o4 (select (elts str) o3))))
(assert (=> (= result1 true) (= o5 (to_rep o4))))
(assert (=> (= result1 true) (= o6 (ite (<= o5 90) true false))))
(assert (=> (= result1 true) (and (= temp___661 (- j 1)) (in_range1 (- j 1)))))
(assert (=> (= result1 true) (and (<= (to_rep1 (first (rt str))) temp___661) (<= temp___661 (to_rep1 (last (rt str)))))))
(assert (=> (= result1 true) (= o temp___661)))
