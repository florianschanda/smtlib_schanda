...
(assert (and (<= (to_rep1 (first (rt str))) temp___5911) (<= temp___5911 (to_rep1 (last (rt str))))))
...
(assert (and (<= (to_rep1 (first (rt str))) temp___591) (<= temp___591 (to_rep1 (last (rt str))))))
...
(assert (=> (= result1 true) (and (= temp___5921 (- j 1)) (in_range1 (- j 1)))))
(assert (=> (= result1 true) (and (<= (to_rep1 (first (rt str))) temp___5921) (<= temp___5921 (to_rep1 (last (rt str)))))))
...
(assert (=> (= result1 true) (and (= temp___592 (- j 1)) (in_range1 (- j 1)))))
(assert (=> (= result1 true) (and (<= (to_rep1 (first (rt str))) temp___592) (<= temp___592 (to_rep1 (last (rt str)))))))
