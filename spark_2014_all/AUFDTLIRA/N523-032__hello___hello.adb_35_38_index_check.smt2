...
(declare-const temp___653 Int)
(declare-const o9 Int)
(declare-const o10 character)
(declare-const o11 Int)
(declare-const temp___6531 Int)
...
(assert (and (= temp___6531 (- j 1)) (in_range1 (- j 1))))
(assert (and (<= (to_rep1 (first (rt str))) temp___6531) (<= temp___6531 (to_rep1 (last (rt str))))))
(assert (= o12 temp___6531))
(assert (= o13 (select (elts str) o12)))
(assert (= o14 (to_rep o13)))
(assert (= o15 (ite (<= o14 122) true false)))
(assert (and (= temp___653 (- j 1)) (in_range1 (- j 1))))
(assert (and (<= (to_rep1 (first (rt str))) temp___653) (<= temp___653 (to_rep1 (last (rt str))))))
(assert (= o9 temp___653))
...
(assert (=> (= result1 true) (and (= temp___6541 (- j 1)) (in_range1 (- j 1)))))
(assert (=> (= result1 true) (and (<= (to_rep1 (first (rt str))) temp___6541) (<= temp___6541 (to_rep1 (last (rt str)))))))
(assert (=> (= result1 true) (= o3 temp___6541)))
(assert (=> (= result1 true) (= o4 (select (elts str) o3))))
(assert (=> (= result1 true) (= o5 (to_rep o4))))
(assert (=> (= result1 true) (= o6 (ite (<= o5 90) true false))))
(assert (=> (= result1 true) (and (= temp___654 (- j 1)) (in_range1 (- j 1)))))
(assert (=> (= result1 true) (and (<= (to_rep1 (first (rt str))) temp___654) (<= temp___654 (to_rep1 (last (rt str)))))))
(assert (=> (= result1 true) (= o temp___654)))
...
(assert (not (<= j (to_rep1 (last (rt str))))))
(check-sat)
(exit)
