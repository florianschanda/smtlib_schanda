...
(assert (and (= result2 (is_empty (mk___split_fields my_stack__split_fields2 my_stack__split_fields3))) (= (= result2 true) (= (count (mk___split_fields my_stack__split_fields2 my_stack__split_fields3)) 0))))
