...
(assert (= (to_rep4 o1) 3))
(assert (= o1 o10))
(assert (= temp___951 o10))
(assert (= temp___9511 o6))
(assert (= temp___9512 o7))
(assert (= temp___9513 o8))
(assert (= temp___9514 o9))
(assert (= true temp___9515))
(assert (= t__attr__constrained true))
(assert (not (= temp___951 t__split_discrs)))
(check-sat)
(exit)
