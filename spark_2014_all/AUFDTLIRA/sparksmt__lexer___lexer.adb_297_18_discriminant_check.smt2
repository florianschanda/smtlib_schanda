...
(assert (= (to_rep4 o1) 3))
(assert (= o1 o10))
(assert (= temp___941 o10))
(assert (= temp___9411 o6))
(assert (= temp___9412 o7))
(assert (= temp___9413 o8))
(assert (= temp___9414 o9))
(assert (= true temp___9415))
(assert (= t__attr__constrained true))
(assert (not (= temp___941 t__split_discrs)))
(check-sat)
(exit)
