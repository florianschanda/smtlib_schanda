...
(declare-const temp___1037 token_kind)
(declare-const temp___10371 natural)
(declare-const temp___10372 natural)
(declare-const temp___10373 natural)
(declare-const temp___10374 name_id)
(declare-const temp___10375 Bool)
...
(assert (= (to_rep4 o1) 3))
(assert (= o1 o10))
(assert (= temp___1037 o10))
(assert (= temp___10371 o6))
(assert (= temp___10372 o7))
(assert (= temp___10373 o8))
(assert (= temp___10374 o9))
(assert (= true temp___10375))
(assert (= t__attr__constrained true))
(assert (not (= temp___1037 t__split_discrs)))
(check-sat)
(exit)
