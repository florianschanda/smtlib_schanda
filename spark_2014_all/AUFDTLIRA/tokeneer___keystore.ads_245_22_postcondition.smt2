...
(define-fun dynamic_invariant1 ((temp___expr_703 Int) (temp___is_init_700 Bool) (temp___skip_constant_701 Bool) (temp___do_toplevel_702 Bool)) Bool (=> (or (= temp___is_init_700 true) (<= 0 40)) (in_range1 temp___expr_703)))
(declare-fun cryptotypes__blankname__aggregate_def (Int) (Array Int character))
(assert (forall ((temp___139 Int)) (forall ((temp___140 Int)) (= (select (cryptotypes__blankname__aggregate_def temp___139) temp___140) (of_rep1 temp___139)))))
(assert (= blankname (cryptotypes__blankname__aggregate_def 32)))
(define-fun dynamic_invariant2 ((temp___expr_724 Int) (temp___is_init_721 Bool) (temp___skip_constant_722 Bool) (temp___do_toplevel_723 Bool)) Bool (=> (or (= temp___is_init_721 true) (<= 0 4294967295)) (in_range3 temp___expr_724)))
...
(declare-const temp___1209 issueridt)
(declare-const temp___12091 namecountt)
(declare-const temp___12092 (Array Int character))
...
(assert (= o o3))
(assert (= blankname o4))
(assert (= temp___1209 o2))
(assert (= temp___12091 o3))
(assert (= temp___12092 o4))
(assert (= (mk___rep (mk___split_fields temp___1209 temp___12091 temp___12092)) nullissuer))
