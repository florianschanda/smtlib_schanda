...
(assert (= (sorted (mk___t o22 (mk (to_rep a__first) (to_rep a__last))) 0 (- j2 1)) true))
(assert (= (sorted (mk___t o22 (mk (to_rep a__first) (to_rep a__last))) (+ j2 2) (+ i1 1)) true))
(assert (=> (< 0 j2) (<= (to_rep (select o22 (- j2 1))) (to_rep (select o22 (+ j2 2))))))
(assert (< x2 (to_rep (select o22 (+ j2 2)))))
(assert (= (is_perm (mk___t (elts1 b) (mk (to_rep (first2 (rt1 b))) (to_rep (last2 (rt1 b))))) (mk___t o22 (mk (to_rep a__first) (to_rep a__last)))) true))
(assert (or (and (= (to_rep (select o22 j2)) x2) (= (to_rep (select o22 (+ j2 1))) y2)) (and (= (to_rep (select o22 j2)) y2) (= (to_rep (select o22 (+ j2 1))) x2))))
...
(assert (=> (<= 0 j3) (= o17 j3)))
(assert (=> (<= 0 j3) (= o18 (select o22 o17))))
