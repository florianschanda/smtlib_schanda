...
(define-fun var_test__decision_eval__result15 () int__ref (mk_int__ref var_test__decision_eval__result7))
(define-fun d__split_discrs4 () us_split_discrs (mk___split_discrs d__split_discrs1))
(define-fun d__split_fields10 () us_split_fields (mk___split_fields d__split_fields4 d__split_fields5 d__split_fields6 d__split_fields7))
...
(assert (= d__split_fields10 (us_split_fields1 (select decision_table root_id))))
(assert (= (mk___split_discrs__ref (mk___split_discrs result4)) (mk___split_discrs__ref (mk___split_discrs d__split_discrs))))
(assert (= d__split_discrs4 (us_split_discrs1 (select decision_table root_id))))
...
(assert (= var_test__decision_eval__result11 var_test__decision_eval__result9))
(assert (= var_test__decision_eval__result12 var_test__decision_eval__result10))
(assert (=> (= kind1 0) (= var_test__decision_eval__result9 (mk_int__ref var_test__decision_eval__result1))))
(assert (=> (= kind1 0) (= var_test__decision_eval__result10 var_test__decision_eval__result1)))
(assert (=> (= kind1 0) (= result6 var_test__decision_eval__result)))
(assert (=> (= kind1 0) (= var_test__decision_eval__result1 (to_rep2 (select condition_values (to_rep1 d__split_fields4))))))
(assert (=> (not (= kind1 0)) (= var_test__decision_eval__result9 var_test__decision_eval__result15)))
(assert (=> (not (= kind1 0)) (= var_test__decision_eval__result10 var_test__decision_eval__result8)))
(assert (=> (not (= kind1 0)) (=> (= kind1 1) (= var_test__decision_eval__result2 var_test__decision_eval__result7))))
(assert (=> (not (= kind1 0)) (=> (= kind1 1) (= var_test__decision_eval__result8 var_test__decision_eval__result2))))
(assert (=> (not (= kind1 0)) (=> (= kind1 1) (and (= o (decision_eval (to_rep1 d__split_fields5) decision_table condition_values)) (and (in_range1 o) (not (= o 2)))))))
(assert (=> (not (= kind1 0)) (=> (= kind1 1) (and (= o1 (t_not o)) (and (in_range1 o1) (= o1 (ite (= o 0) 1 0)))))))
(assert (=> (not (= kind1 0)) (=> (= kind1 1) (= result7 var_test__decision_eval__result))))
(assert (=> (not (= kind1 0)) (=> (= kind1 1) (= var_test__decision_eval__result2 o1))))
(assert (=> (not (= kind1 0)) (=> (not (= kind1 1)) (= var_test__decision_eval__result15 (mk_int__ref var_test__decision_eval__result5)))))
(assert (=> (not (= kind1 0)) (=> (not (= kind1 1)) (= var_test__decision_eval__result8 var_test__decision_eval__result6))))
(assert (=> (not (= kind1 0)) (=> (not (= kind1 1)) (=> (= kind1 2) (= var_test__decision_eval__result3 var_test__decision_eval__result5)))))
(assert (=> (not (= kind1 0)) (=> (not (= kind1 1)) (=> (= kind1 2) (= var_test__decision_eval__result6 var_test__decision_eval__result3)))))
(assert (=> (not (= kind1 0)) (=> (not (= kind1 1)) (=> (= kind1 2) (and (= o3 (decision_eval (to_rep1 d__split_fields7) decision_table condition_values)) (and (in_range1 o3) (not (= o3 2))))))))
(assert (=> (not (= kind1 0)) (=> (not (= kind1 1)) (=> (= kind1 2) (and (= o2 (decision_eval (to_rep1 d__split_fields6) decision_table condition_values)) (and (in_range1 o2) (not (= o2 2))))))))
(assert (=> (not (= kind1 0)) (=> (not (= kind1 1)) (=> (= kind1 2) (and (= o4 (t_or o2 o3)) (and (in_range1 o4) (= o4 (ite (= o2 0) 0 (ite (= o2 1) o3 2)))))))))
(assert (=> (not (= kind1 0)) (=> (not (= kind1 1)) (=> (= kind1 2) (= result8 var_test__decision_eval__result)))))
(assert (=> (not (= kind1 0)) (=> (not (= kind1 1)) (=> (= kind1 2) (= var_test__decision_eval__result3 o4)))))
(assert (=> (not (= kind1 0)) (=> (not (= kind1 1)) (=> (not (= kind1 2)) (= var_test__decision_eval__result4 var_test__decision_eval__result5)))))
(assert (=> (not (= kind1 0)) (=> (not (= kind1 1)) (=> (not (= kind1 2)) (= var_test__decision_eval__result6 var_test__decision_eval__result4)))))
(assert (=> (not (= kind1 0)) (=> (not (= kind1 1)) (=> (not (= kind1 2)) (and (= o6 (decision_eval (to_rep1 d__split_fields7) decision_table condition_values)) (and (in_range1 o6) (not (= o6 2))))))))
(assert (=> (not (= kind1 0)) (=> (not (= kind1 1)) (=> (not (= kind1 2)) (and (= o5 (decision_eval (to_rep1 d__split_fields6) decision_table condition_values)) (and (in_range1 o5) (not (= o5 2))))))))
(assert (=> (not (= kind1 0)) (=> (not (= kind1 1)) (=> (not (= kind1 2)) (and (= o7 (t_and o5 o6)) (and (in_range1 o7) (= o7 (ite (= o5 1) 1 (ite (= o5 0) o6 2)))))))))
(assert (=> (not (= kind1 0)) (=> (not (= kind1 1)) (=> (not (= kind1 2)) (= result9 var_test__decision_eval__result)))))
(assert (=> (not (= kind1 0)) (=> (not (= kind1 1)) (=> (not (= kind1 2)) (= var_test__decision_eval__result4 o7)))))
(assert (= var_test__decision_eval__result13 var_test__decision_eval__result11))
...
(assert (= var_test__decision_eval__result14 var_test__decision_eval__result12))
(assert (= kind3 kind1))
...
(assert (not (not (= (int__content var_test__decision_eval__result13) 2))))
(check-sat)
(exit)
