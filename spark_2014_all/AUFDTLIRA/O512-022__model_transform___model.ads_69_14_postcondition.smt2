...
(assert (forall ((x uml_state_access)) (! (in_range1 (to_rep x)) :pattern ((to_rep x)))))
...
(assert (forall ((x name_t)) (! (= (of_rep1 (to_rep1 x)) x) :pattern ((to_rep1 x)))))
(assert (forall ((x name_t)) (! (in_range2 (to_rep1 x)) :pattern ((to_rep1 x)))))
(assert (forall ((x Int)) (! (=> (in_range2 x) (= (to_rep1 (of_rep1 x)) x)) :pattern ((to_rep1 (of_rep1 x))))))
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__model__uml_state__name_data name_t)))))
(define-fun us_split_fields_Name_Data__projection ((a us_split_fields2)) name_t (rec__model__uml_state__name_data a))
...
(define-fun bool_eq2 ((a us_rep1) (b us_rep1)) Bool (ite (= (to_rep1 (rec__model__uml_state__name_data (us_split_fields3 a))) (to_rep1 (rec__model__uml_state__name_data (us_split_fields3 b)))) true false))
...
(declare-datatypes () ((uml_state__ref (mk_uml_state__ref (uml_state__content us_rep1)))))
(define-fun uml_state__ref___projection ((a uml_state__ref)) us_rep1 (uml_state__content a))
...
(define-fun bool_eq3 ((a (Array Int us_rep1)) (a__first Int) (a__last Int) (b (Array Int us_rep1)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_132 Int)) (=> (and (<= a__first temp___idx_132) (<= temp___idx_132 a__last)) (= (bool_eq2 (select a temp___idx_132) (select b (+ (- b__first a__first) temp___idx_132))) true)))) true false))
...
(declare-datatypes () ((us_split_fields4 (mk___split_fields2 (rec__model__uml_state_machine__owned_state_data (Array Int us_rep1)) (rec__model__uml_state_machine__owned_transition_data (Array Int us_rep))))))
(define-fun us_split_fields_Owned_State_Data__projection ((a us_split_fields4)) (Array Int us_rep1) (rec__model__uml_state_machine__owned_state_data a))
(define-fun us_split_fields_Owned_Transition_Data__projection ((a us_split_fields4)) (Array Int us_rep) (rec__model__uml_state_machine__owned_transition_data a))
...
(define-fun bool_eq4 ((a us_rep2) (b us_rep2)) Bool (ite (and (= (bool_eq3 (rec__model__uml_state_machine__owned_state_data (us_split_fields5 a)) 0 100 (rec__model__uml_state_machine__owned_state_data (us_split_fields5 b)) 0 100) true) (= (bool_eq1 (rec__model__uml_state_machine__owned_transition_data (us_split_fields5 a)) 0 100 (rec__model__uml_state_machine__owned_transition_data (us_split_fields5 b)) 0 100) true)) true false))
...
(declare-fun owned_transition__function_guard ((Array Int us_rep) us_rep2) Bool)
(assert true)
...
(define-fun dynamic_invariant1 ((temp___expr_158 Int) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool)) Bool (=> (or (= temp___is_init_155 true) (<= 0 100)) (in_range1 temp___expr_158)))
(define-fun dynamic_invariant2 ((temp___expr_182 Int) (temp___is_init_179 Bool) (temp___skip_constant_180 Bool) (temp___do_toplevel_181 Bool)) Bool (=> (or (= temp___is_init_179 true) (<= 0 100)) (in_range temp___expr_182)))
...
(assert (not (= (bool_eq1 (owned_transition (mk___rep2 (mk___split_fields2 self__split_fields4 self__split_fields5))) 0 100 val__ 0 100) true)))
(check-sat)
(exit)
