...
(declare-fun user_eq2 (name_t name_t) Bool)
(declare-const dummy2 name_t)
...
(define-fun to_rep1 ((x name_t)) Int (name_tqtint x))
(declare-fun of_rep1 (Int) name_t)
(assert (forall ((x name_t)) (! (= (of_rep1 (to_rep1 x)) x) :pattern ((to_rep1 x)))))
(assert (forall ((x name_t)) (! (in_range1 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun bool_eq3 ((a (Array Int us_rep1)) (a__first Int) (a__last Int) (b (Array Int us_rep1)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (bool_eq2 (select a temp___idx_154) (select b (+ (- b__first a__first) temp___idx_154))) true)))) true false))
...
(define-fun dynamic_invariant2 ((temp___expr_210 Int) (temp___is_init_206 Bool) (temp___skip_constant_207 Bool) (temp___do_toplevel_208 Bool) (temp___do_typ_inv_209 Bool)) Bool (=> (or (= temp___is_init_206 true) (<= 0 100)) (in_range2 temp___expr_210)))
