...
(assert (= result2 true))
(assert (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f_old root) i2))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f_old root) j1)))) true))
(assert (and (= temp___1587 (model__ f root)) (and (dynamic_invariant5 temp___1587 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1587 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1587 root)))) 0) (and (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (=> (not (= i3 root)) (ite (and (not (= (parent f i3) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1587 (parent f i3)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1587 i3))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1587 i3))) true)))))) (and (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1587 i3))) true) (not (= i3 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1587 (parent f i3)))) (position f i3) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1587 i3)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1587 i3)))) 0)))) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1587 i3))) true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1587 j2))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1587 i3))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1587 j2)))) true)) (= j2 i3))))))))))))))
(assert (= o10 (select temp___1587 i2)))
(assert (= o11 (us_split_fields1 o10)))
(assert (= o12 (rec__tree_model__path_type__a o11)))
(assert (and (= o13 (length o12)) (and (in_range4 o13) (<= (+ 0 o13) 2147483647))))
(assert (= o14 (+ o13 1)))
