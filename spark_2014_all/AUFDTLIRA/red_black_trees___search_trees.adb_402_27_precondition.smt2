...
(assert (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f_old root) i9))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f_old root) j7)))) true))
(assert (and (= temp___1543 (model__ f root)) (and (dynamic_invariant5 temp___1543 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1543 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1543 root)))) 0) (and (forall ((i21 Int)) (=> (and (<= 1 i21) (<= i21 100)) (=> (not (= i21 root)) (ite (and (not (= (parent f i21) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1543 (parent f i21)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1543 i21))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1543 i21))) true)))))) (and (forall ((i21 Int)) (=> (and (<= 1 i21) (<= i21 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1543 i21))) true) (not (= i21 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1543 (parent f i21)))) (position f i21) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1543 i21)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1543 i21)))) 0)))) (forall ((i21 Int)) (=> (and (<= 1 i21) (<= i21 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1543 i21))) true) (forall ((j26 Int)) (=> (and (<= 1 j26) (<= j26 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1543 j26))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1543 i21))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1543 j26)))) true)) (= j26 i21))))))))))))))
(assert (= o103 (select temp___1543 i9)))
(assert (= o104 (us_split_fields1 o103)))
(assert (= o105 (rec__tree_model__path_type__a o104)))
(assert (and (= o106 (length o105)) (and (in_range4 o106) (<= (+ 0 o106) 2147483647))))
(assert (= o107 (+ o106 1)))
