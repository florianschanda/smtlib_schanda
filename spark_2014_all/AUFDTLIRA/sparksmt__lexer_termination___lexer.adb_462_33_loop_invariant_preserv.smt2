...
(assert (not (= (to_rep4 (rec__file_io__read_result__status current_read__split_discrs4)) 1)))
(assert (not (= (to_rep4 (rec__file_io__read_result__status current_read__split_discrs4)) 2)))
(assert (= (let ((subject r57b)) (mk_int__ref r57b4)) (let ((subject r57b)) (mk_int__ref r57b3))))
(assert (= t__split_discrs6 t__split_discrs4))
(assert (= t__split_fields9 t__split_fields7))
(assert (= r57b4 r57b3))
(assert (= t__split_discrs6 t__split_discrs4))
(assert (= t__split_fields9 t__split_fields7))
(assert (not (= (to_rep4 (rec__file_io__read_result__status current_read__split_discrs4)) 0)))
(check-sat)
(exit)
