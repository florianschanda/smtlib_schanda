...
(assert (not (= (length (mk___t temp___598 temp___5981)) 0)))
(assert (=> (<= 1 7) (= o14 (+ (- 7 1) 1))))
(assert (=> (not (<= 1 7)) (= o14 0)))
(assert (=> (<= (to_rep1 (first temp___5981)) (to_rep1 (last temp___5981))) (= o15 (+ (- (to_rep1 (last temp___5981)) (to_rep1 (first temp___5981))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___5981)) (to_rep1 (last temp___5981)))) (= o15 0)))
(assert (= o16 (+ o15 o14)))
(assert (= o17 (+ (to_rep1 (first temp___5981)) o16)))
(assert (= o18 (- o17 1)))
