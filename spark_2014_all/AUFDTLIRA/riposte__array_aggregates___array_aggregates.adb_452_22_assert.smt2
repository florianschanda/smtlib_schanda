...
(declare-fun temp___680 (Bool) (Array Int Bool))
(assert (forall ((temp___682 Bool)) (forall ((temp___683 Int)) (= (select (temp___680 temp___682) temp___683) temp___682))))
(declare-fun temp___684 (Bool) (Array Int Bool))
(assert (forall ((temp___686 Bool)) (forall ((temp___687 Int)) (= (select (temp___684 temp___686) temp___687) temp___686))))
...
(assert (= result x))
(assert (= x1 (temp___680 (of_int 1))))
(declare-const n Int)
(assert (<= 0 n))
(assert (<= n 255))
(assert (not (= (bool_eq x1 0 255 (temp___684 (= n n)) 0 255) true)))
(check-sat)
(exit)
