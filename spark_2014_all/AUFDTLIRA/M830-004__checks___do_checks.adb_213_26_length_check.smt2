...
(assert (not (= (ite (<= (to_rep x__first) (to_rep x__last)) (+ (- (to_rep x__last) (to_rep x__first)) 1) 0) (ite (<= (to_rep y__first) (to_rep y__last)) (+ (- (to_rep y__last) (to_rep y__first)) 1) 0))))
(check-sat)
(exit)
