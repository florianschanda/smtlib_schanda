...
(assert (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (select todo3 j) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j))) true)))))
(assert (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (select todo3 j) true) (forall ((k Int)) (=> (and (<= 1 k) (<= k 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 k))) true) (not (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select r2 j))) (rec__tree_model__path_type__a (us_split_fields1 (select r2 k)))) true)))))))))
...
(assert (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j))) true) (not (= j root))) (and (not (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j)))) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j))))))) true))))))
(assert (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j))) true) (not (= j root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select r2 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j))))))) (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j)))) (rec__tree_model__path_type__a (us_split_fields1 (select r2 j)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select r2 j)))) 0)))))
(assert (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (not (= j root)) (ite (and (not (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j)))) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j))))))) true)) (or (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j))) true) (= (select todo3 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j))))) true)) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j))) true)))))))
(assert (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j))) true) (not (= j root))) (not (= (select todo3 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j))))) true))))))
(assert (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j))) true) (forall ((k Int)) (=> (and (<= 1 k) (<= k 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 k))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select r2 k))) (rec__tree_model__path_type__a (us_split_fields1 (select r2 j)))) true)) (= j k))))))))
(assert (and (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 root))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select r2 root)))) 0)))
(assert (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (<= (length (rec__tree_model__path_type__a (us_split_fields1 (select r2 j)))) (- 100 (length1 unseen2))))))
(assert (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (= (= (contains unseen2 j) true) (or (not (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j))) true)) (= (select todo3 j) true))))))
