...
(assert (and (= o6 (length model____split_fields)) (and (in_range6 o6) (<= (+ 0 o6) 2147483647))))
...
(assert (=> (= result1 true) (and (= o1 (length1 model____split_fields1)) (in_range6 o1))))
(assert (=> (= result1 true) (and (= o2 (length model____split_fields)) (and (in_range6 o2) (<= (+ 0 o2) 2147483647)))))
