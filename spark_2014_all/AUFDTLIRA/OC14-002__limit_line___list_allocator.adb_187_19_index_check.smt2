...
(assert (=> (not (= first_available1 0)) (and (= o46 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range3 o46))))
(assert (=> (not (= first_available1 0)) (= result12 (ite (< 0 o46) true false))))
(assert (=> (not (= first_available1 0)) (=> (= result12 true) (and (= o45 (get (rec__list_allocator__m__t__available model____split_fields3) 1)) (in_range4 o45)))))
(assert (=> (not (= first_available1 0)) (=> (= result12 true) (= result11 (ite (= o45 first_available1) true false)))))
(assert (=> (not (= first_available1 0)) (=> (not (= result12 true)) (= result11 false))))
(assert (=> (not (not (= first_available1 0))) (and (= o47 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range3 o47))))
(assert (=> (not (not (= first_available1 0))) (= result11 (ite (= o47 0) true false))))
(assert (=> (= result11 true) (=> (not (= first_allocated1 0)) (and (= o43 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range3 o43)))))
(assert (=> (= result11 true) (=> (not (= first_allocated1 0)) (= result13 (ite (< 0 o43) true false)))))
(assert (=> (= result11 true) (=> (not (= first_allocated1 0)) (=> (= result13 true) (and (= o42 (get (rec__list_allocator__m__t__allocated model____split_fields3) 1)) (in_range4 o42))))))
(assert (=> (= result11 true) (=> (not (= first_allocated1 0)) (=> (= result13 true) (= result10 (ite (= o42 first_allocated1) true false))))))
(assert (=> (= result11 true) (=> (not (= first_allocated1 0)) (=> (not (= result13 true)) (= result10 false)))))
(assert (=> (= result11 true) (=> (not (not (= first_allocated1 0))) (and (= o44 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range3 o44)))))
(assert (=> (= result11 true) (=> (not (not (= first_allocated1 0))) (= result10 (ite (= o44 0) true false)))))
...
(assert (= result15 (ite (in_range7 o41) true false)))
...
(assert (=> (= result16 true) (and (= o39 (+ j 1)) (in_range1 (+ j 1)))))
(assert (=> (= result16 true) (and (= o40 (get (rec__list_allocator__m__t__available model____split_fields3) o39)) (in_range4 o40))))
(assert (=> (not (= result16 true)) (= o40 0)))
(assert (and (= temp___443 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (in_range4 temp___443)))
(assert (not (<= temp___443 3)))
(check-sat)
(exit)
