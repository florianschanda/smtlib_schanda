...
(assert (and (= o13 (length model____split_fields)) (and (in_range6 o13) (<= (+ 0 o13) 2147483647))))
(assert (= result3 (ite (<= o13 10000) true false)))
(assert (=> (= result3 true) (and (= o12 (length1 model____split_fields1)) (in_range6 o12))))
(assert (=> (= result3 true) (= result2 (ite (<= o12 10000) true false))))
(assert (=> (not (= result3 true)) (= result2 false)))
(assert (=> (= result2 true) (and (= o8 (length1 model____split_fields1)) (in_range6 o8))))
(assert (=> (= result2 true) (and (= o9 (length model____split_fields)) (and (in_range6 o9) (<= (+ 0 o9) 2147483647)))))
...
(assert (=> (= result1 true) (=> (not (= first_available 0)) (and (= o6 (length model____split_fields)) (and (in_range6 o6) (<= (+ 0 o6) 2147483647))))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (= result4 (ite (< 0 o6) true false)))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (=> (= result4 true) (and (= o5 (get model____split_fields 1)) (in_range7 o5))))))
...
(assert (=> (= result1 true) (=> (not (not (= first_available 0))) (and (= o7 (length model____split_fields)) (and (in_range6 o7) (<= (+ 0 o7) 2147483647))))))
