...
(declare-fun temp___175 ((Array Int et1) Int Int Int Int Int Int) (Array Int et1))
(assert (forall ((temp___177 (Array Int et1))) (forall ((temp___178 Int) (temp___179 Int) (temp___180 Int) (temp___181 Int) (temp___182 Int) (temp___183 Int)) (let ((temp___176 (temp___175 temp___177 temp___178 temp___179 temp___180 temp___181 temp___182 temp___183))) (forall ((temp___184 Int)) (ite (= temp___184 temp___182) (= (select temp___176 temp___184) (of_rep temp___183)) (ite (or (= temp___184 temp___178) (and (<= temp___179 temp___184) (<= temp___184 temp___180))) (= (select temp___176 temp___184) (of_rep temp___181)) (= (select temp___176 temp___184) (select temp___177 temp___184)))))))))
(declare-fun temp___201 ((Array Int et1) Int Int Int Int Int Int) (Array Int et1))
(assert (forall ((temp___203 (Array Int et1))) (forall ((temp___204 Int) (temp___205 Int) (temp___206 Int) (temp___207 Int) (temp___208 Int) (temp___209 Int)) (let ((temp___202 (temp___201 temp___203 temp___204 temp___205 temp___206 temp___207 temp___208 temp___209))) (forall ((temp___210 Int)) (ite (= temp___210 temp___208) (= (select temp___202 temp___210) (of_rep temp___209)) (ite (or (= temp___210 temp___204) (and (<= temp___205 temp___210) (<= temp___210 temp___206))) (= (select temp___202 temp___210) (of_rep temp___207)) (= (select temp___202 temp___210) (select temp___203 temp___210)))))))))
...
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (bool_eq a2 1 10 (temp___175 a (- i 1) i (+ j 2) (- e 1) (+ j 1) (+ e 1)) 1 10) true)))
(check-sat)
(exit)
