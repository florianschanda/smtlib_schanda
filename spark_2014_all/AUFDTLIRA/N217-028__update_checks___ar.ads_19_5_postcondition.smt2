...
(assert (= o5 (temp___229 a o4 i o3 o2 o1 o)))
(assert (= (mk_map__ref result) (mk_map__ref a)))
(assert (= a1 o5))
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (bool_eq a2 1 10 (temp___203 a (- i 1) i (+ j 2) (- e 1) (+ j 1) (+ e 1)) 1 10) true)))
(check-sat)
(exit)
