...
(assert (and (= o4 (- i2 first2)) (in_range1 (- i2 first2))))
(assert (= o5 (+ o4 1)))
(assert (and (= o6 o5) (in_range1 o5)))
(assert (and (= o8 (to__ (mk___rep s__split_fields3))) (dynamic_invariant1 o8 true false true true)))
(assert (= o7 (to_rep (last o3))))
(assert (= result1 (ite (= o7 o6) true false)))
(assert (= result1 true))
(assert (<= first2 j))
(assert (<= j i2))
(assert (not (in_range6 j)))
(check-sat)
(exit)
