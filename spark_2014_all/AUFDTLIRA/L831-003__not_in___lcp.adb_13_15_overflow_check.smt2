...
(assert (= j1 (to_rep (first (rt a)))))
(assert (<= (to_rep (first (rt a))) j1))
(assert (<= j1 (to_rep (last (rt a)))))
(assert (and (=> (<= 0 2147483647) (in_range2 l2)) (and (<= (to_rep (first (rt a))) j2) (<= j2 (to_rep (last (rt a)))))))
(assert (and (= o6 (+ x l2)) (in_range1 (+ x l2))))
(assert (= o7 (ite (<= o6 (to_rep (last (rt a)))) true false)))
(assert (and (= o5 (+ x l2)) (in_range1 (+ x l2))))
(assert (= o8 (ite (<= (to_rep (first (rt a))) o5) true false)))
(assert (= o9 (ite (= o8 true) o7 false)))
(assert (= result3 (ite (not (= o9 true)) true false)))
(assert (=> (= result3 true) (= result2 true)))
(assert (=> (not (= result3 true)) (and (= o1 (+ y l2)) (in_range1 (+ y l2)))))
(assert (=> (not (= result3 true)) (= o2 (ite (<= o1 (to_rep (last (rt a)))) true false))))
(assert (=> (not (= result3 true)) (and (= o (+ y l2)) (in_range1 (+ y l2)))))
(assert (=> (not (= result3 true)) (= o3 (ite (<= (to_rep (first (rt a))) o) true false))))
(assert (=> (not (= result3 true)) (= o4 (ite (= o3 true) o2 false))))
(assert (=> (not (= result3 true)) (= result2 (ite (not (= o4 true)) true false))))
(assert (not (= result2 true)))
(assert (= lcp__result3 lcp__result2))
(assert (and (= temp___156 (+ y l2)) (in_range1 (+ y l2))))
(assert (and (<= (to_rep (first (rt a))) temp___156) (<= temp___156 (to_rep (last (rt a))))))
(assert (= o12 temp___156))
(assert (= o13 (select (elts a) o12)))
(assert (= o14 (to_rep o13)))
(assert (not (in_range1 (+ x l2))))
(check-sat)
(exit)
