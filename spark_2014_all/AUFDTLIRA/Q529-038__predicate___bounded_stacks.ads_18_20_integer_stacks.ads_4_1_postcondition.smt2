...
(declare-const temp___3041 (Array Int element))
(declare-const temp___3042 t1)
(declare-const temp___3043 natural)
(declare-const temp___3044 us_private)
(declare-const temp___3045 Int)
...
(declare-const temp___307 us_rep)
...
(define-fun o13 () us_rep1 (mk___rep1 (mk___split_discrs o7) (mk___split_fields1 (mk___t1 o8 o9) o10 o11) o12))
(define-fun temp___3046 () us_rep1 (mk___rep1 (mk___split_discrs temp___304) (mk___split_fields1 (mk___t1 temp___3041 temp___3042) temp___3043 temp___3044) temp___3045))
...
(assert (= (rec__integer_stacks__stack__capacity this__split_discrs) temp___304))
(assert (= temp___3041 o3))
(assert (= temp___3042 o4))
(assert (= temp___3043 o5))
(assert (= temp___3044 o6))
(assert (= us_tag1 temp___3045))
(assert (dynamic_predicate1 temp___3046))
(assert (= o13 temp___3046))
(assert (= temp___3056 (to_base o13)))
...
(assert (= temp___307 (mk___rep (mk___split_discrs usq_) (mk___split_fields (mk___t usq_1 usq_2) usq_3 usq_4) this__attr__tag)))
...
(assert (= this__split_fields4 (us_split_fields1 temp___307)))
(assert (= this__split_discrs (us_split_discrs1 temp___307)))
