...
(assert (= (to_rep1 (rec__integer_stacks__stack__capacity this__split_discrs)) r19b))
(assert (in_range1 r19b))
(assert (= (to_rep1 (rec__integer_stacks__stack__capacity this__split_discrs)) r22b))
...
(assert (= (rec__integer_stacks__stack__capacity this__split_discrs) temp___276))
(assert (= temp___2761 o3))
(assert (= temp___2762 o4))
(assert (= temp___2763 o5))
(assert (= temp___2764 o6))
(assert (= us_tag1 temp___2765))
(assert (dynamic_predicate1 (mk___rep1 (mk___split_discrs temp___276) (mk___split_fields1 (mk___t1 temp___2761 temp___2762) temp___2763 temp___2764) temp___2765)))
(assert (= (mk___rep1 (mk___split_discrs o7) (mk___split_fields1 (mk___t1 o8 o9) o10 o11) o12) (mk___rep1 (mk___split_discrs temp___276) (mk___split_fields1 (mk___t1 temp___2761 temp___2762) temp___2763 temp___2764) temp___2765)))
(assert (= (mk___rep (mk___split_discrs temp___277) (mk___split_fields (mk___t temp___2771 temp___2772) temp___2773 temp___2774) temp___2775) (to_base (mk___rep1 (mk___split_discrs o7) (mk___split_fields1 (mk___t1 o8 o9) o10 o11) o12))))
(assert (= temp___277 (rec__integer_stacks__stack__capacity this__split_discrs)))
(assert (= (mk___rep (mk___split_discrs usq_) (mk___split_fields (mk___t usq_1 usq_2) usq_3 usq_4) usq_5) (mk___rep (mk___split_discrs temp___277) (mk___split_fields (mk___t temp___2771 temp___2772) temp___2773 temp___2774) temp___2775)))
(assert (= temp___279 (mk___rep (mk___split_discrs usq_) (mk___split_fields (mk___t usq_1 usq_2) usq_3 usq_4) this__attr__tag)))
...
(assert (not (= (empty (mk___rep this__split_discrs (us_split_fields__content this__split_fields5) this__attr__tag)) true)))
(check-sat)
(exit)
