...
(assert (= (same_nb_blacks c76b) true))
(assert (= n83 (mk_int__ref n46)))
(assert (= n82 (mk_int__ref n45)))
(assert (= n81 n59))
(assert (= t_old__split_fields11 (mk___split_fields__ref4 t_old__split_fields7)))
(assert (= x7 (mk_int__ref x3)))
(assert (= t__split_fields17 (mk___split_fields__ref4 t__split_fields10)))
(assert (= rho6 rho1))
(assert (= rho5 rho))
(assert (= n86 n46))
(assert (= n85 n45))
(assert (= n84 n60))
(assert (= t_old__split_fields12 t_old__split_fields7))
(assert (= x8 x3))
(assert (= t__split_fields18 t__split_fields10))
(assert (= n129 (let ((subject n7)) (mk_int__ref n49))))
(assert (= n128 (mk_int__ref n48)))
(assert (= n127 (mk_int__ref n47)))
(assert (= n126 n83))
(assert (= n125 n82))
(assert (= n124 n81))
(assert (= t_old__split_fields18 t_old__split_fields11))
(assert (= y9 (mk_int__ref y7)))
(assert (= x15 x7))
(assert (= t__split_fields30 t__split_fields17))
(assert (= rho13 rho3))
(assert (= rho12 rho2))
(assert (= rho11 rho6))
(assert (= rho10 rho5))
...
(assert (= n131 n85))
(assert (= n130 n84))
(assert (= t_old__split_fields19 t_old__split_fields12))
(assert (= y10 y7))
(assert (= x16 x8))
(assert (= t__split_fields31 t__split_fields18))
...
(assert (= result94 true))
(assert (and (= o429 (int__content x15)) (in_range2 (int__content x15))))
(assert (and (= o430 (parent (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields30)) o429)) (and (in_range3 o430) (and (= o430 (parent1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields30)))) o429)) (=> (= (size (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields30))) 0) (= o430 0))))))
(assert (and (= o431 (color (mk___rep4 (us_split_fields__content4 t__split_fields30)) o430)) (and (in_range6 o431) (= o431 (ite (= o430 0) 0 (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields__content4 t__split_fields30)) o430)))))))
(assert (= o434 (ite (= o431 1) true false)))
...
(assert (<= 1 i14))
(assert (<= i14 100))
(assert (not (= i14 (int__content x17))))
(assert (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields__content4 t__split_fields32)) (parent (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields32)) i14))) 1))
(assert (not (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields__content4 t__split_fields32)) i14)) 0)))
(check-sat)
(exit)
