...
(assert (<= temp___2509 index1))
(assert (<= index1 temp___2510))
...
(assert (and (and (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 3)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 3) index2)) (forall ((temp___2508 Int)) (=> (and (<= (to_rep1 n__first) temp___2508) (<= temp___2508 (to_rep1 n__last))) (=> (< index2 temp___2508) (= (select n3 temp___2508) (select n1 temp___2508)))))) (and (<= (+ (to_rep1 (first (rt source))) 1) index2) (<= index2 (+ (to_rep1 (first (rt source))) 3)))))
