...
(assert (<= temp___2407 index2))
(assert (<= index2 temp___2408))
...
(assert (and (and (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 3)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 3) index3)) (forall ((temp___2406 Int)) (=> (and (<= (to_rep1 n__first) temp___2406) (<= temp___2406 (to_rep1 n__last))) (=> (< index3 temp___2406) (= (select n3 temp___2406) (select n1 temp___2406)))))) (and (<= (+ (to_rep1 (first (rt source))) 1) index3) (<= index3 (+ (to_rep1 (first (rt source))) 3)))))
