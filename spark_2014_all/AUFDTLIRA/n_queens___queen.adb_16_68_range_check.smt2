...
(assert (and (= result (consistent b i)) (= (= result true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 i)) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- i1 1))) (and (and (not (= (to_rep (select b i1)) (to_rep (select b j1)))) (not (= (- i1 j1) (- (to_rep (select b i1)) (to_rep (select b j1)))))) (not (= (- i1 j1) (- (to_rep (select b j1)) (to_rep (select b i1)))))))))))))
