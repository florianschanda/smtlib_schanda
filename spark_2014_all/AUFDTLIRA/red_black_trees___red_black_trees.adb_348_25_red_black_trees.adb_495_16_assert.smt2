...
(assert (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c106b) (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) y3))))) (let ((subject n1)) n12)))
