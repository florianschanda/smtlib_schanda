...
(assert (not (= (ite (<= (to_rep1 (first (rt source))) (to_rep1 (last (rt source)))) (+ (- (to_rep1 (last (rt source))) (to_rep1 (first (rt source)))) 1) 0) (ite (<= 1 (length source)) (+ (- (length source) 1) 1) 0))))
(check-sat)
(exit)
