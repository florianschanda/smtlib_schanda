...
(assert (not (= (ite (<= (to_rep2 (first2 (rt1 source))) (to_rep2 (last2 (rt1 source)))) (+ (- (to_rep2 (last2 (rt1 source))) (to_rep2 (first2 (rt1 source)))) 1) 0) (ite (<= 1 (length2 source)) (+ (- (length2 source) 1) 1) 0))))
(check-sat)
(exit)
