...
(declare-fun temp___263 (Int) (Array Int character))
(assert (forall ((temp___265 Int)) (=> (dynamic_invariant temp___265 true true true true) (forall ((temp___266 Int)) (= (to_rep (select (temp___263 temp___265) temp___266)) temp___265)))))
...
(declare-const temp___269 (Array Int character))
...
(assert (= workspace1 (temp___263 32)))
(assert (= result1 offset))
(assert (= offset1 0))
(assert (= (mk_int__ref result2) (mk_int__ref i)))
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 1024)) (= temp___271 offset1)))
(assert (=> (and (<= 1 i1) (<= i1 1024)) (= temp___269 workspace1)))
(assert (=> (and (<= 1 i1) (<= i1 1024)) (= temp___268 i1)))
