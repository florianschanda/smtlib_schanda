...
(define-fun dynamic_invariant1 ((temp___expr_135 Int) (temp___is_init_132 Bool) (temp___skip_constant_133 Bool) (temp___do_toplevel_134 Bool)) Bool (=> (or (= temp___is_init_132 true) (<= 0 1024)) (in_range2 temp___expr_135)))
...
(assert (forall ((temp___237 Int)) (forall ((temp___238 Int)) (= (select (temp___235 temp___237) temp___238) (of_rep temp___237)))))
(define-fun dynamic_invariant2 ((temp___expr_141 Int) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool (=> (or (= temp___is_init_138 true) (<= 1 1024)) (in_range3 temp___expr_141)))
...
(declare-const temp___241 (Array Int character))
...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 1024)) (= temp___243 offset1)))
(assert (=> (and (<= 1 i1) (<= i1 1024)) (= temp___241 workspace1)))
(assert (=> (and (<= 1 i1) (<= i1 1024)) (= temp___240 i1)))
(assert (=> (and (<= 1 i1) (<= i1 1024)) (< offset2 i2)))
(assert (=> (and (<= 1 i1) (<= i1 1024)) (and (and (=> (<= 1 1024) (in_range3 i2)) (=> (<= 0 1024) (in_range2 offset2))) (and (<= 1 i2) (<= i2 1024)))))
(assert (=> (and (<= 1 i1) (<= i1 1024)) (=> (not (= (to_rep (select buffer i2)) erase_character)) (= (to_rep o) (to_rep (select buffer i2))))))
(assert (=> (and (<= 1 i1) (<= i1 1024)) (=> (not (= (to_rep (select buffer i2)) erase_character)) (and (<= 1 (+ 1 offset2)) (<= (+ 1 offset2) 1024)))))
(assert (=> (and (<= 1 i1) (<= i1 1024)) (=> (not (= (to_rep (select buffer i2)) erase_character)) (= o1 (+ 1 offset2)))))
(assert (=> (and (<= 1 i1) (<= i1 1024)) (=> (not (= (to_rep (select buffer i2)) erase_character)) (= o2 (store workspace2 o1 o)))))
(assert (=> (and (<= 1 i1) (<= i1 1024)) (=> (not (= (to_rep (select buffer i2)) erase_character)) (= workspace2 result3))))
(assert (=> (and (<= 1 i1) (<= i1 1024)) (=> (not (= (to_rep (select buffer i2)) erase_character)) (= workspace3 o2))))
(assert (=> (and (<= 1 i1) (<= i1 1024)) (=> (not (= (to_rep (select buffer i2)) erase_character)) (and (= o3 (+ offset2 1)) (in_range2 (+ offset2 1))))))
(assert (=> (and (<= 1 i1) (<= i1 1024)) (=> (not (= (to_rep (select buffer i2)) erase_character)) (= offset2 result4))))
(assert (=> (and (<= 1 i1) (<= i1 1024)) (=> (not (= (to_rep (select buffer i2)) erase_character)) (= offset3 o3))))
(assert (=> (and (<= 1 i1) (<= i1 1024)) (=> (not (not (= (to_rep (select buffer i2)) erase_character))) (= offset3 offset2))))
(assert (=> (and (<= 1 i1) (<= i1 1024)) (=> (not (not (= (to_rep (select buffer i2)) erase_character))) (= workspace3 workspace2))))
(assert (=> (and (<= 1 i1) (<= i1 1024)) (= i2 1024)))
(assert (=> (and (<= 1 i1) (<= i1 1024)) (= i2 i3)))
(assert (=> (and (<= 1 i1) (<= i1 1024)) (= offset3 offset4)))
(assert (=> (and (<= 1 i1) (<= i1 1024)) (= workspace3 workspace4)))
(assert (=> (and (<= 1 i1) (<= i1 1024)) (= i4 i2)))
(assert (=> (and (<= 1 i1) (<= i1 1024)) (= offset5 offset3)))
(assert (=> (and (<= 1 i1) (<= i1 1024)) (= workspace5 workspace3)))
(assert (=> (and (<= 1 i1) (<= i1 1024)) (= (mk_int__ref i5) (mk_int__ref i3))))
(assert (=> (and (<= 1 i1) (<= i1 1024)) (= (mk_int__ref offset6) (mk_int__ref offset4))))
(assert (=> (and (<= 1 i1) (<= i1 1024)) (= (mk_map__ref workspace6) (mk_map__ref workspace4))))
(assert (=> (and (<= 1 i1) (<= i1 1024)) (= i6 i4)))
(assert (=> (and (<= 1 i1) (<= i1 1024)) (= offset7 offset5)))
(assert (=> (and (<= 1 i1) (<= i1 1024)) (= workspace7 workspace5)))
(assert (=> (not (and (<= 1 i1) (<= i1 1024))) (= i1 i5)))
(assert (=> (not (and (<= 1 i1) (<= i1 1024))) (= offset1 offset6)))
(assert (=> (not (and (<= 1 i1) (<= i1 1024))) (= workspace1 workspace6)))
(assert (=> (not (and (<= 1 i1) (<= i1 1024))) (= i6 i1)))
(assert (=> (not (and (<= 1 i1) (<= i1 1024))) (= offset7 offset1)))
(assert (=> (not (and (<= 1 i1) (<= i1 1024))) (= workspace7 workspace1)))
