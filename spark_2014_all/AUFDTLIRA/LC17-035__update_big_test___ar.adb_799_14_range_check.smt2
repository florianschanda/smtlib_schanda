...
(declare-fun temp_____aggregate_def_5332 ((Array Int (Array Int (Array Int et1))) Int (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1))))
(declare-fun temp_____aggregate_def_5338 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
(declare-fun temp_____aggregate_def_5344 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___5334 (Array Int (Array Int (Array Int et1))))) (forall ((temp___5335 Int)) (forall ((temp___5336 (Array Int (Array Int et1)))) (let ((temp___5333 (temp_____aggregate_def_5332 temp___5334 temp___5335 temp___5336))) (=> (dynamic_invariant2 temp___5335 true true true true) (forall ((temp___5337 Int)) (ite (= temp___5337 temp___5335) (= (select temp___5333 temp___5337) temp___5336) (= (select temp___5333 temp___5337) (select temp___5334 temp___5337))))))))))
(assert (forall ((temp___5340 (Array Int (Array Int et1)))) (forall ((temp___5341 Int)) (forall ((temp___5342 (Array Int et1))) (let ((temp___5339 (temp_____aggregate_def_5338 temp___5340 temp___5341 temp___5342))) (=> (dynamic_invariant1 temp___5341 true true true true) (forall ((temp___5343 Int)) (ite (= temp___5343 temp___5341) (= (select temp___5339 temp___5343) temp___5342) (= (select temp___5339 temp___5343) (select temp___5340 temp___5343))))))))))
(assert (forall ((temp___5346 (Array Int et1))) (forall ((temp___5347 Int) (temp___5348 Int)) (let ((temp___5345 (temp_____aggregate_def_5344 temp___5346 temp___5347 temp___5348))) (=> (and (dynamic_invariant temp___5347 true true true true) (dynamic_invariant3 temp___5348 true true true true)) (forall ((temp___5349 Int)) (ite (= temp___5349 temp___5347) (= (to_rep (select temp___5345 temp___5349)) temp___5348) (= (select temp___5345 temp___5349) (select temp___5346 temp___5349)))))))))
...
(define-fun k_next3 () int__ref (mk_int__ref k_next))
(assert (in_range1 i))
(assert (in_range2 j))
(assert (in_range3 k))
(assert (in_range4 e))
...
(assert (= (bool_eq2 a 1 16 (temp_____aggregate_def_5332 t k (temp_____aggregate_def_5338 (select t k) j (temp_____aggregate_def_5344 (select (select t k) j) i e))) 1 16) true))
(assert (=> (= k 16) (= (mk_int__ref result) k_next3)))
(assert (=> (= k 16) (= k_next1 1)))
(assert (=> (not (= k 16)) (and (= o (+ k 1)) (in_range3 (+ k 1)))))
(assert (=> (not (= k 16)) (= (mk_int__ref result1) k_next3)))
