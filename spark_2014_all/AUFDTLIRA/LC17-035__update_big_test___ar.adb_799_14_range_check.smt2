...
(declare-fun temp___5332 ((Array Int (Array Int (Array Int et1))) Int (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1))))
(declare-fun temp___5338 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
(declare-fun temp___5344 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___5334 (Array Int (Array Int (Array Int et1))))) (forall ((temp___5335 Int)) (forall ((temp___5336 (Array Int (Array Int et1)))) (let ((temp___5333 (temp___5332 temp___5334 temp___5335 temp___5336))) (=> (dynamic_invariant2 temp___5335 true true true true) (forall ((temp___5337 Int)) (ite (= temp___5337 temp___5335) (= (select temp___5333 temp___5337) temp___5336) (= (select temp___5333 temp___5337) (select temp___5334 temp___5337))))))))))
(assert (forall ((temp___5340 (Array Int (Array Int et1)))) (forall ((temp___5341 Int)) (forall ((temp___5342 (Array Int et1))) (let ((temp___5339 (temp___5338 temp___5340 temp___5341 temp___5342))) (=> (dynamic_invariant1 temp___5341 true true true true) (forall ((temp___5343 Int)) (ite (= temp___5343 temp___5341) (= (select temp___5339 temp___5343) temp___5342) (= (select temp___5339 temp___5343) (select temp___5340 temp___5343))))))))))
(assert (forall ((temp___5346 (Array Int et1))) (forall ((temp___5347 Int) (temp___5348 Int)) (let ((temp___5345 (temp___5344 temp___5346 temp___5347 temp___5348))) (=> (and (dynamic_invariant temp___5347 true true true true) (dynamic_invariant3 temp___5348 true true true true)) (forall ((temp___5349 Int)) (ite (= temp___5349 temp___5347) (= (to_rep (select temp___5345 temp___5349)) temp___5348) (= (select temp___5345 temp___5349) (select temp___5346 temp___5349)))))))))
...
(assert (= (bool_eq2 a 1 16 (temp___5332 t k (temp___5338 (select t k) j (temp___5344 (select (select t k) j) i e))) 1 16) true))
