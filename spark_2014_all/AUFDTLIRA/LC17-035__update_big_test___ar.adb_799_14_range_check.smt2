...
(declare-fun temp___5273 ((Array Int (Array Int (Array Int et1))) Int (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1))))
(assert (forall ((temp___5275 (Array Int (Array Int (Array Int et1))))) (forall ((temp___5276 Int)) (forall ((temp___5277 (Array Int (Array Int et1)))) (let ((temp___5274 (temp___5273 temp___5275 temp___5276 temp___5277))) (forall ((temp___5278 Int)) (ite (= temp___5278 temp___5276) (= (select temp___5274 temp___5278) temp___5277) (= (select temp___5274 temp___5278) (select temp___5275 temp___5278)))))))))
(declare-fun temp___5279 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
(assert (forall ((temp___5281 (Array Int (Array Int et1)))) (forall ((temp___5282 Int)) (forall ((temp___5283 (Array Int et1))) (let ((temp___5280 (temp___5279 temp___5281 temp___5282 temp___5283))) (forall ((temp___5284 Int)) (ite (= temp___5284 temp___5282) (= (select temp___5280 temp___5284) temp___5283) (= (select temp___5280 temp___5284) (select temp___5281 temp___5284)))))))))
(declare-fun temp___5285 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___5287 (Array Int et1))) (forall ((temp___5288 Int) (temp___5289 Int)) (let ((temp___5286 (temp___5285 temp___5287 temp___5288 temp___5289))) (forall ((temp___5290 Int)) (ite (= temp___5290 temp___5288) (= (select temp___5286 temp___5290) (of_rep temp___5289)) (= (select temp___5286 temp___5290) (select temp___5287 temp___5290))))))))
...
(assert (= (bool_eq2 a1 1 16 (temp___5273 t1 k (temp___5279 (select t1 k) j (temp___5285 (select (select t1 k) j) i e))) 1 16) true))
(assert (=> (= k 16) (= (mk_int__ref result2) (mk_int__ref k_next))))
(assert (=> (= k 16) (= k_next1 1)))
(assert (=> (not (= k 16)) (and (= o4 (+ k 1)) (in_range3 (+ k 1)))))
(assert (=> (not (= k 16)) (= (mk_int__ref result3) (mk_int__ref k_next))))
