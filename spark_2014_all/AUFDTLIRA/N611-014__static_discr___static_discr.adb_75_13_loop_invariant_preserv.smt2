...
(assert (= (to_rep (rec__static_discr__holder__unused current__split_discrs)) (to_rep1 (last6 (rt3 a)))))
(assert (= (let ((temp___396 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 current__split_fields7))))) (bool_eq (elts3 a) (to_rep1 (first6 (rt3 a))) (to_rep1 (last6 (rt3 a))) (elts2 temp___396) (to_rep1 (first4 (rt2 temp___396))) (to_rep1 (last4 (rt2 temp___396))))) true))
(assert (= result__3 0))
(assert (< 0 (to_rep (rec__static_discr__holder__length1 current__split_fields7))))
(assert (not (<= (to_rep (rec__static_discr__holder__length1 current__split_fields7)) (to_rep1 (last6 (rt3 a))))))
(check-sat)
(exit)
