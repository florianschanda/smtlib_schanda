...
(declare-const temp___254 index)
(declare-const temp___2541 (Array Int value))
(declare-const temp___2542 (Array Int value))
...
(declare-const temp___257 index)
(declare-const temp___2571 (Array Int value))
(declare-const temp___2572 (Array Int value))
...
(assert (= temp___254 o2))
(assert (= temp___2541 o3))
(assert (= temp___2542 o4))
(assert (= result a__split_fields))
(assert (= result1 a__split_fields1))
(assert (= result2 a__split_fields2))
(assert (= temp___254 a__split_fields3))
(assert (= temp___2541 a__split_fields4))
(assert (= temp___2542 a__split_fields5))
(assert (= (to_rep o5) 23))
(assert (= o6 (store a__split_fields4 17 o5)))
(assert (= a__split_fields3 o7))
(assert (= o6 o8))
(assert (= a__split_fields5 o9))
(assert (= temp___257 o7))
(assert (= temp___2571 o8))
(assert (= temp___2572 o9))
(assert (= result3 a__split_fields3))
(assert (= result4 a__split_fields4))
(assert (= result5 a__split_fields5))
(assert (= temp___257 a__split_fields6))
(assert (= temp___2571 a__split_fields7))
(assert (= temp___2572 a__split_fields8))
