...
(assert (= n98 1))
(assert (=> (and (<= 1 n98) (<= n98 100)) (= temp___642 n98)))
(assert (=> (and (<= 1 n98) (<= n98 100)) (forall ((i14 Int)) (=> (and (<= 1 i14) (<= i14 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c100b))) i14))) true) (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c100b) i14)))) n99)) (not (= i14 y2))) (= (eq (select (nb_blacks c101b) i14) (select (nb_blacks c100b) i14)) true))))))
(assert (=> (and (<= 1 n98) (<= n98 100)) (=> (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c100b) c102b)))) n99) (= (eq (select (nb_blacks c101b) y2) (select (nb_blacks c100b) y2)) true))))
(assert (=> (and (<= 1 n98) (<= n98 100)) (and (=> (<= 1 100) (in_range2 n99)) (and (<= 1 n99) (<= n99 100)))))
(assert (=> (and (<= 1 n98) (<= n98 100)) (=> (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c100b) c102b)))) n99) (= (eq (select (nb_blacks c101b) c102b) (select (nb_blacks c100b) c102b)) true))))
(assert (=> (and (<= 1 n98) (<= n98 100)) (=> (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c100b) (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c101b)) y2))))) n99) (= (eq (select (nb_blacks c101b) (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c101b)) y2)) (select (nb_blacks c100b) (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c101b)) y2))) true))))
(assert (=> (and (<= 1 n98) (<= n98 100)) (= n99 100)))
(assert (=> (and (<= 1 n98) (<= n98 100)) (= n103 (mk_int__ref n99))))
(assert (=> (and (<= 1 n98) (<= n98 100)) (= n104 n99)))
(assert (=> (and (<= 1 n98) (<= n98 100)) (= n105 n103)))
(assert (=> (and (<= 1 n98) (<= n98 100)) (= n106 n104)))
(assert (=> (not (and (<= 1 n98) (<= n98 100))) (= n105 (mk_int__ref n98))))
(assert (=> (not (and (<= 1 n98) (<= n98 100))) (= n106 n98)))
(assert (not (= (same_nb_blacks c101b) true)))
(check-sat)
(exit)
