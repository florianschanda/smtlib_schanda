...
(assert (= result6 (mk_int__ref temp___612)))
(assert (= temp___6121 int__4))
(assert (not (= int__4 5)))
(assert (and (= o3 (+ int__4 1)) (in_range1 (+ int__4 1))))
(assert (= result7 (mk_int__ref int__4)))
(assert (= int__5 o3))
(assert (not (< temp___6121 int__5)))
(check-sat)
(exit)
