...
(assert (and (= temp___964 (- (to_rep1 (last (rt tmp))) 1)) (in_range1 (- (to_rep1 (last (rt tmp))) 1))))
(assert (and (= temp___963 (+ (to_rep1 (first (rt tmp))) 1)) (in_range1 (+ (to_rep1 (first (rt tmp))) 1))))
(assert (<= temp___963 temp___964))
(assert (not (<= (to_rep1 (first (rt tmp))) temp___963)))
(check-sat)
(exit)
