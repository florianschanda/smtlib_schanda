...
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (prev i2))) (=> (< threshold (to_rep (select b j1))) (exists ((k1 Int)) (and (and (<= 1 k1) (<= k1 cur2)) (= (to_rep (select a2 k1)) (to_rep (select b j1)))))))))
(assert (and (and (=> (<= 1 10) (in_range2 i2)) (=> (<= (- 2147483648) 2147483647) (in_range1 cur2))) (and (<= 1 i2) (<= i2 10))))
(assert (< threshold (to_rep (select b i2))))
(assert (not (in_range1 (+ cur2 1))))
(check-sat)
(exit)
