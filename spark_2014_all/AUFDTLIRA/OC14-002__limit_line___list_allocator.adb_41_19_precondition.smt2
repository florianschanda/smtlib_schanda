...
(assert (= result8 true))
(assert (and (= o55 (length model____split_fields)) (in_range6 o55)))
(assert (= result9 (ite (< j1 o55) true false)))
(assert (=> (= result9 true) (and (= o56 (+ j1 1)) (in_range1 (+ j1 1)))))
(assert (=> (= result9 true) (and (= o57 (get model____split_fields o56)) (in_range7 o57))))
(assert (=> (not (= result9 true)) (= o57 0)))
(assert (not (<= 1 j1)))
(check-sat)
(exit)
