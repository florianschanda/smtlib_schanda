...
(assert (=> (not (= first_available 0)) (and (= o10 (length model____split_fields)) (in_range6 o10))))
(assert (=> (not (= first_available 0)) (= result2 (ite (< 0 o10) true false))))
(assert (=> (not (= first_available 0)) (=> (= result2 true) (and (= o9 (get model____split_fields 1)) (in_range7 o9)))))
...
(assert (=> (not (not (= first_available 0))) (and (= o11 (length model____split_fields)) (in_range6 o11))))
(assert (=> (not (not (= first_available 0))) (= result1 (ite (= o11 0) true false))))
(assert (=> (= result1 true) (=> (not (= first_allocated 0)) (and (= o7 (length model____split_fields1)) (in_range6 o7)))))
(assert (=> (= result1 true) (=> (not (= first_allocated 0)) (= result3 (ite (< 0 o7) true false)))))
(assert (=> (= result1 true) (=> (not (= first_allocated 0)) (=> (= result3 true) (and (= o6 (get model____split_fields1 1)) (in_range7 o6))))))
...
(assert (=> (= result1 true) (=> (not (not (= first_allocated 0))) (and (= o8 (length model____split_fields1)) (in_range6 o8)))))
...
(assert (= result5 (ite (in_range4 o5) true false)))
(assert (= result5 true))
(assert (and (= o2 (length model____split_fields)) (in_range6 o2)))
(assert (= result6 (ite (< j o2) true false)))
(assert (=> (= result6 true) (and (= o3 (+ j 1)) (in_range1 (+ j 1)))))
(assert (=> (= result6 true) (and (= o4 (get model____split_fields o3)) (in_range7 o4))))
