...
(assert (=> (and (<= first4 i2) (<= i2 last5)) (and (= (to_rep (last (rt (to__ (mk___rep s__split_fields4))))) (+ (- i3 first4) 1)) (forall ((j2 Int)) (=> (and (<= first4 j2) (<= j2 i3)) (= (to_rep (select (elts (to__ (mk___rep s__split_fields4))) (+ (- j2 first4) 1))) (get (model__ l) j2)))))))
...
(assert (<= first4 i8))
(assert (<= i8 last5))
(assert (and (and (and (= (length2 (mk___rep1 res__split_discrs res__split_fields2)) (- i9 first4)) (= (to_rep (last (rt (to__ (mk___rep s__split_fields9))))) (+ (- last5 i9) 1))) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 (+ (- last5 i9) 1))) (= (to_rep (select (elts (to__ (mk___rep s__split_fields9))) j2)) (to_rep (select (elts (to__ (mk___rep (us_split_fields__content s__split_fields7)))) j2)))))) (forall ((j2 Int)) (=> (and (<= first4 j2) (<= j2 (- i9 1))) (= (get (model__ (mk___rep1 res__split_discrs res__split_fields2)) j2) (get (model__ l) (+ (- last5 j2) first4)))))))
(assert (and (=> (<= first4 last5) (dynamic_property4 first4 last5 i9)) (and (<= first4 i9) (<= i9 last5))))
(assert (and (= o18 (- i9 first4)) (in_range1 (- i9 first4))))
(assert (and (= o19 (length2 (mk___rep1 res__split_discrs res__split_fields2))) (and (in_range6 o19) (<= o19 (capacity (mk___rep1 res__split_discrs res__split_fields2))))))
(assert (= result6 (ite (= o19 o18) true false)))
(assert (=> (= result6 true) (and (= o14 (- last5 i9)) (in_range1 (- last5 i9)))))
(assert (=> (= result6 true) (= o15 (+ o14 1))))
(assert (=> (= result6 true) (and (= o16 o15) (in_range1 o15))))
(assert (=> (= result6 true) (and (= o13 (to__ (mk___rep s__split_fields9))) (and (dynamic_invariant1 o13 true false true) (and (= (to_rep (first (rt o13))) 1) (<= 0 (to_rep (last (rt o13)))))))))
(assert (=> (= result6 true) (= o17 (to_rep (last (rt o13))))))
(assert (=> (= result6 true) (= result5 (ite (= o17 o16) true false))))
(assert (=> (not (= result6 true)) (= result5 false)))
(assert (=> (= result5 true) (and (= o9 (- last5 i9)) (in_range1 (- last5 i9)))))
(assert (=> (= result5 true) (= o10 (+ o9 1))))
(assert (=> (= result5 true) (and (= o11 o10) (in_range1 o10))))
(assert (=> (= result5 true) (= o12 (ite (<= j1 o11) true false))))
(assert (=> (= result5 true) (= result7 (ite (<= 1 j1) o12 false))))
(assert (=> (= result5 true) (= (= result4 true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 (+ (- last5 i9) 1))) (= (to_rep (select (elts (to__ (mk___rep s__split_fields9))) j2)) (to_rep (select (elts (to__ (mk___rep (us_split_fields__content s__split_fields7)))) j2))))))))
(assert (=> (not (= result5 true)) (= result4 false)))
(assert (= result4 true))
(assert (and (= o2 (- i9 1)) (in_range1 (- i9 1))))
(assert (= o3 (ite (<= j o2) true false)))
(assert (= result8 (ite (<= first4 j) o3 false)))
(assert (= result8 true))
(assert (and (= o4 (- last5 j)) (in_range1 (- last5 j))))
(assert (= o5 (+ o4 first4)))
(assert (and (= o6 o5) (in_range1 o5)))
(assert (and (= o7 o6) (in_range5 o6)))
(assert (and (= o8 (get (model__ l) o7)) (and (in_range8 o8) (= o8 (get (model__ l) o7)))))
(assert (not (in_range5 j)))
(check-sat)
(exit)
