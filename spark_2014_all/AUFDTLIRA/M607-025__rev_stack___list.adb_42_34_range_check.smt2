...
(declare-sort t12s 0)
(declare-fun t12sqtint (t12s) Int)
(assert (forall ((i t12s)) (and (<= 1 (t12sqtint i)) (<= (t12sqtint i) 1))))
...
(declare-fun temp_____aggregate_def_209 (Int) (Array Int integer))
...
(define-fun dynamic_invariant2 ((temp___expr_314 Int) (temp___is_init_310 Bool) (temp___skip_constant_311 Bool) (temp___do_toplevel_312 Bool) (temp___do_typ_inv_313 Bool)) Bool (=> (or (= temp___is_init_310 true) (<= 0 100)) (in_range5 temp___expr_314)))
...
(define-fun dynamic_invariant3 ((temp___expr_307 Int) (temp___is_init_303 Bool) (temp___skip_constant_304 Bool) (temp___do_toplevel_305 Bool) (temp___do_typ_inv_306 Bool)) Bool (=> (or (= temp___is_init_303 true) (<= 0 101)) (in_range6 temp___expr_307)))
...
(define-fun dynamic_invariant4 ((temp___expr_293 Int) (temp___is_init_289 Bool) (temp___skip_constant_290 Bool) (temp___do_toplevel_291 Bool) (temp___do_typ_inv_292 Bool)) Bool (=> (or (= temp___is_init_289 true) (<= 1 100)) (in_range7 temp___expr_293)))
...
(assert (forall ((temp___211 Int)) (=> (dynamic_invariant temp___211 true true true true) (= (to_rep (select (temp_____aggregate_def_209 temp___211) 1)) temp___211))))
(define-fun dynamic_invariant9 ((temp___expr_159 Int) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool) (temp___do_typ_inv_158 Bool)) Bool (=> (or (= temp___is_init_155 true) (<= 0 100)) (in_range3 temp___expr_159)))
...
(declare-const temp___518 r1)
(declare-const temp___5181 (Array Int integer))
(declare-const o Int)
...
(assert (and (= list__reverse_list__first__assume 1) (and (in_range7 list__reverse_list__first__assume) (= list__reverse_list__first__assume 1))))
(assert (= list__reverse_list__first__assume first4))
(assert (in_range1 first4))
(assert (and (= list__reverse_list__last__assume (last4 (model__ l))) (and (in_range6 list__reverse_list__last__assume) (= list__reverse_list__last__assume (last4 (model__ l))))))
...
(assert (= i2 first4))
(assert (=> (and (<= first4 i2) (<= i2 last5)) (= temp___519 i2)))
(assert (=> (and (<= first4 i2) (<= i2 last5)) (= s__split_fields2 (mk___split_fields temp___518 temp___5181))))
(assert (=> (and (<= first4 i2) (<= i2 last5)) (and (= o i2) (in_range7 i2))))
(assert (=> (and (<= first4 i2) (<= i2 last5)) (and (= o1 (get (model__ l) o)) (and (in_range8 o1) (= o1 (get (model__ l) o))))))
(assert (=> (and (<= first4 i2) (<= i2 last5)) (= (let ((temp___215 (to__ (mk___rep s__split_fields3)))) (bool_eq (elts temp___215) (to_rep (first (rt temp___215))) (to_rep (last (rt temp___215))) (let ((temp___214 (temp_____aggregate_def_209 o1))) (let ((temp___213 (to__ (mk___rep s__split_fields2)))) (ite (= (length temp___213) 0) temp___214 (concat1 (elts temp___213) (to_rep (first (rt temp___213))) (to_rep (last (rt temp___213))) temp___214 1 1)))) (to_rep (first (let ((temp___213 (to__ (mk___rep s__split_fields2)))) (ite (= (length temp___213) 0) (mk 1 1) (mk (to_rep (first (rt temp___213))) (- (+ (to_rep (first (rt temp___213))) (+ (ite (<= (to_rep (first (rt temp___213))) (to_rep (last (rt temp___213)))) (+ (- (to_rep (last (rt temp___213))) (to_rep (first (rt temp___213)))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0))) 1)))))) (to_rep (last (let ((temp___213 (to__ (mk___rep s__split_fields2)))) (ite (= (length temp___213) 0) (mk 1 1) (mk (to_rep (first (rt temp___213))) (- (+ (to_rep (first (rt temp___213))) (+ (ite (<= (to_rep (first (rt temp___213))) (to_rep (last (rt temp___213)))) (+ (- (to_rep (last (rt temp___213))) (to_rep (first (rt temp___213)))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0))) 1)))))))) true)))
...
(assert (and (= o19 (length2 (mk___rep1 res__split_discrs res__split_fields2))) (and (in_range5 o19) (<= o19 (capacity (mk___rep1 res__split_discrs res__split_fields2))))))
...
(assert (=> (= result6 true) (and (= o13 (to__ (mk___rep s__split_fields9))) (and (dynamic_invariant1 o13 true false true true) (and (= (to_rep (first (rt o13))) 1) (<= 0 (to_rep (last (rt o13)))))))))
