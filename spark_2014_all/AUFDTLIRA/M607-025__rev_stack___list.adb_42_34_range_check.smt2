...
(assert (<= first4 i12))
(assert (<= i12 last5))
(assert (and (and (and (= (length2 (mk___rep1 res__split_discrs res__split_fields2)) (- i13 first4)) (= (to_rep (last (rt (to__ (mk___rep s__split_fields12))))) (+ (- last5 i13) 1))) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 (+ (- last5 i13) 1))) (= (to_rep (select (elts (to__ (mk___rep s__split_fields12))) j3)) (to_rep (select (elts (to__ (mk___rep (us_split_fields__content s__split_fields10)))) j3)))))) (forall ((j3 Int)) (=> (and (<= first4 j3) (<= j3 (- i13 1))) (= (get (model__ (mk___rep1 res__split_discrs res__split_fields2)) j3) (get (model__ l) (+ (- last5 j3) first4)))))))
(assert (and (=> (<= first4 last5) (dynamic_property4 first4 last5 i13)) (and (<= first4 i13) (<= i13 last5))))
(assert (and (= o35 (- i13 first4)) (in_range1 (- i13 first4))))
(assert (and (= o36 (length2 (mk___rep1 res__split_discrs res__split_fields2))) (and (in_range6 o36) (<= o36 (capacity (mk___rep1 res__split_discrs res__split_fields2))))))
(assert (= result8 (ite (= o36 o35) true false)))
(assert (=> (= result8 true) (and (= o31 (- last5 i13)) (in_range1 (- last5 i13)))))
(assert (=> (= result8 true) (= o32 (+ o31 1))))
(assert (=> (= result8 true) (and (= o33 o32) (in_range1 o32))))
(assert (=> (= result8 true) (and (= o30 (to__ (mk___rep s__split_fields12))) (and (dynamic_invariant1 o30 true false true) (and (= (to_rep (first (rt o30))) 1) (<= 0 (to_rep (last (rt o30)))))))))
(assert (=> (= result8 true) (= o34 (to_rep (last (rt o30))))))
(assert (=> (= result8 true) (= result7 (ite (= o34 o33) true false))))
(assert (=> (not (= result8 true)) (= result7 false)))
(assert (=> (= result7 true) (and (= o23 (- last5 i13)) (in_range1 (- last5 i13)))))
(assert (=> (= result7 true) (= o24 (+ o23 1))))
(assert (=> (= result7 true) (and (= o25 o24) (in_range1 o24))))
(assert (=> (= result7 true) (= o26 (ite (<= j2 o25) true false))))
(assert (=> (= result7 true) (= result9 (ite (<= 1 j2) o26 false))))
(assert (=> (= result7 true) (= (= result6 true) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 (+ (- last5 i13) 1))) (= (to_rep (select (elts (to__ (mk___rep s__split_fields12))) j3)) (to_rep (select (elts (to__ (mk___rep (us_split_fields__content s__split_fields10)))) j3))))))))
(assert (=> (not (= result7 true)) (= result6 false)))
(assert (= result6 true))
(assert (and (= o14 (- i13 1)) (in_range1 (- i13 1))))
(assert (= o15 (ite (<= j1 o14) true false)))
(assert (= result10 (ite (<= first4 j1) o15 false)))
(assert (= result10 true))
(assert (and (= o17 (- last5 j1)) (in_range1 (- last5 j1))))
(assert (= o18 (+ o17 first4)))
(assert (and (= o19 o18) (in_range1 o18)))
(assert (and (= o20 o19) (in_range5 o19)))
(assert (and (= o21 (get (model__ l) o20)) (and (in_range8 o21) (= o21 (get (model__ l) o20)))))
(assert (not (in_range5 j1)))
(check-sat)
(exit)
