...
(assert (not (= (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select (map__content data7) (get (rec__list_mod_allocator__m__t__available (us_split_fields3 (model__ (map__content data7) first_available1))) (length (rec__list_mod_allocator__m__t__available (us_split_fields3 (model__ (map__content data7) first_available1))))))))) 0)))
(check-sat)
(exit)
