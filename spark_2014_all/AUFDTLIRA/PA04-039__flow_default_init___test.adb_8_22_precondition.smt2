...
(declare-const bounded_strings__append__target__fields (Array Int character))
(declare-const bounded_strings__append__target__fields1 t)
(declare-const bounded_strings__append__target__fields2 length_type)
