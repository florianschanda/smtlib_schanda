...
(define-fun dynamic_invariant ((temp___expr_148 us_rep) (temp___is_init_145 Bool) (temp___skip_constant_146 Bool) (temp___do_toplevel_147 Bool)) Bool (let ((temp___149 (rec__bounded_strings__bounded_string__bound (us_split_discrs1 temp___expr_148)))) (and (dynamic_property1 1 (to_rep temp___149) (first1 (rec__bounded_strings__bounded_string__text (us_split_fields1 temp___expr_148))) (last1 (rec__bounded_strings__bounded_string__text (us_split_fields1 temp___expr_148)))) (and (= (first1 (rec__bounded_strings__bounded_string__text (us_split_fields1 temp___expr_148))) 1) (= (last1 (rec__bounded_strings__bounded_string__text (us_split_fields1 temp___expr_148))) (to_rep temp___149))))))
...
(define-fun of_base ((r us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r) (mk___split_fields1 (let ((temp___132 (rec__bounded_strings__bounded_string__text (us_split_fields1 r)))) (to_array temp___132)) (rec__bounded_strings__bounded_string__length (us_split_fields1 r)))))
(define-fun bool_eq3 ((a us_rep1) (b us_rep1)) Bool (ite (and (and (= (to_rep (rec__bounded_strings__bounded_string__bound (us_split_discrs2 a))) (to_rep (rec__bounded_strings__bounded_string__bound (us_split_discrs2 b)))) (= (bool_eq (rec__bounded_strings__bounded_string__text1 (us_split_fields3 a)) 1 60 (rec__bounded_strings__bounded_string__text1 (us_split_fields3 b)) 1 60) true)) (= (to_rep1 (rec__bounded_strings__bounded_string__length1 (us_split_fields3 a))) (to_rep1 (rec__bounded_strings__bounded_string__length1 (us_split_fields3 b))))) true false))
...
(assert (forall ((temp___173 Int) (temp___174 Int) (temp___175 Int)) (let ((temp___172 (temp___171 temp___173 temp___174 temp___175))) (and (=> (dynamic_property4 1 2147483647 temp___174 temp___175) (and (= (first3 temp___172) temp___174) (= (last3 temp___172) temp___175))) (forall ((temp___176 Int)) (= (select (to_array1 temp___172) temp___176) (of_rep2 temp___173)))))))
(define-fun dynamic_invariant1 ((temp___expr_164 us_rep2) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool)) Bool (in_range5 60 (to_base (rec__test__tlv_record__filestore_message (us_split_fields5 temp___expr_164)))))
(define-fun default_initial_assumption ((temp___expr_167 us_rep2) (temp___skip_top_level_168 Bool)) Bool (and (and (and (= (to_rep (rec__bounded_strings__bounded_string__bound (us_split_discrs2 (rec__test__tlv_record__filestore_message (us_split_fields5 temp___expr_167))))) 60) (= (rec__bounded_strings__bounded_string__text1 (us_split_fields3 (rec__test__tlv_record__filestore_message (us_split_fields5 temp___expr_167)))) (let ((temp___177 (temp___171 32 1 (to_rep (rec__bounded_strings__bounded_string__bound (us_split_discrs2 (rec__test__tlv_record__filestore_message (us_split_fields5 temp___expr_167)))))))) (to_array1 temp___177)))) (= (to_rep1 (rec__bounded_strings__bounded_string__length1 (us_split_fields3 (rec__test__tlv_record__filestore_message (us_split_fields5 temp___expr_167))))) 0)) (= (length1 (to_base (rec__test__tlv_record__filestore_message (us_split_fields5 temp___expr_167)))) 0)))
...
(define-fun dynamic_invariant4 ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= 1 65536)) (in_range temp___expr_136)))
(define-fun dynamic_invariant5 ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= 0 65536)) (in_range1 temp___expr_142)))
(assert (forall ((source us_rep)) (! (=> (dynamic_invariant source true true true) (dynamic_invariant5 (length1 source) true false true)) :pattern ((length1 source)))))
(assert (forall ((source us_rep)) (! (=> (dynamic_invariant source true true true) (= (length1 source) (to_rep1 (rec__bounded_strings__bounded_string__length (us_split_fields1 source))))) :pattern ((length1 source)))))
