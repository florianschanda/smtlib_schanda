...
(assert (= (color (mk___rep4 t__split_fields13) (parent (rec__red_black_trees__rbt__struct t__split_fields13) (int__content x4))) 0))
(assert (<= 1 i))
(assert (<= i 100))
(assert (and (= o50 (parent (rec__red_black_trees__rbt__struct t__split_fields13) i)) (and (in_range3 o50) (and (= o50 (parent1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields13))) i)) (=> (= (size (rec__red_black_trees__rbt__struct t__split_fields13)) 0) (= o50 0))))))
(assert (= result16 (ite (= o50 0) true false)))
(assert (not (= result16 true)))
(assert (and (= temp___885 (parent (rec__red_black_trees__rbt__struct t__split_fields13) i)) (and (in_range3 temp___885) (and (= temp___885 (parent1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields13))) i)) (=> (= (size (rec__red_black_trees__rbt__struct t__split_fields13)) 0) (= temp___885 0))))))
