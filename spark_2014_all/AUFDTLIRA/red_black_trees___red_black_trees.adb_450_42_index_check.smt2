...
(assert (<= 1 i))
(assert (<= i 100))
(assert (and (= o50 (parent (rec__red_black_trees__rbt__struct t__split_fields13) i)) (and (in_range2 o50) (and (= o50 (parent1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct t__split_fields13))) i)) (=> (= (size (rec__red_black_trees__rbt__struct t__split_fields13)) 0) (= o50 0))))))
(assert (= result16 (ite (= o50 0) true false)))
(assert (not (= result16 true)))
(assert (and (= temp___934 (parent (rec__red_black_trees__rbt__struct t__split_fields13) i)) (and (in_range2 temp___934) (and (= temp___934 (parent1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct t__split_fields13))) i)) (=> (= (size (rec__red_black_trees__rbt__struct t__split_fields13)) 0) (= temp___934 0))))))
(assert (not (<= temp___934 100)))
(check-sat)
(exit)
