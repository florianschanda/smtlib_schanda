...
(assert (and (= temp___934 (parent (rec__red_black_trees__rbt__struct t__split_fields13) i)) (and (in_range3 temp___934) (and (= temp___934 (parent1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields13))) i)) (=> (= (size (rec__red_black_trees__rbt__struct t__split_fields13)) 0) (= temp___934 0))))))
(assert (not (<= 1 temp___934)))
(check-sat)
(exit)
