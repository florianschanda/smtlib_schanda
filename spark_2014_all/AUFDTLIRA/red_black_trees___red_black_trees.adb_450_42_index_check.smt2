...
(assert (in_range2 y1))
(assert (= (same_nb_blacks c88b) true))
(assert (= (color (mk___rep4 t__split_fields16) (parent (rec__red_black_trees__rbt__struct t__split_fields16) (int__content x5))) 0))
(assert (<= 1 i7))
(assert (<= i7 100))
(assert (and (= o232 (parent (rec__red_black_trees__rbt__struct t__split_fields16) i7)) (and (in_range3 o232) (and (= o232 (parent1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields16))) i7)) (=> (= (size (rec__red_black_trees__rbt__struct t__split_fields16)) 0) (= o232 0))))))
(assert (= result56 (ite (= o232 0) true false)))
(assert (not (= result56 true)))
(assert (and (= temp___885 (parent (rec__red_black_trees__rbt__struct t__split_fields16) i7)) (and (in_range3 temp___885) (and (= temp___885 (parent1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields16))) i7)) (=> (= (size (rec__red_black_trees__rbt__struct t__split_fields16)) 0) (= temp___885 0))))))
(assert (not (<= 1 temp___885)))
(check-sat)
(exit)
