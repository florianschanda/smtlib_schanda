...
(assert (and (= temp___1815 (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) root)) (and (dynamic_invariant3 temp___1815 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1815 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1815 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1815 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1815 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1815 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1815 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1815 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i1)))) (position (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1815 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1815 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1815 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1815 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1815 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1815 j)))) true)) (= j i1))))))))))))))
(assert (= o5 (select temp___1815 i)))
...
(assert (=> (= result2 true) (and (= temp___1816 (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) root)) (and (dynamic_invariant3 temp___1816 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1816 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1816 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1816 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1816 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1816 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1816 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1816 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i1)))) (position (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1816 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1816 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1816 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1816 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1816 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1816 j)))) true)) (= j i1)))))))))))))))
(assert (=> (= result2 true) (= (mk___rep (mk___split_fields o o1)) (select temp___1816 i))))
(assert (=> (= result2 true) (= o2 (mk___split_fields o o1))))
(assert (=> (= result2 true) (= o3 (rec__tree_model__path_type__a o2))))
(assert (=> (= result2 true) (and (= o4 (length o3)) (and (in_range5 o4) (<= (+ 0 o4) 2147483647)))))
