...
(assert (and (= temp___1769 (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) root)) (and (dynamic_invariant3 temp___1769 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1769 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1769 root)))) 0) (and (forall ((i7 Int)) (=> (and (<= 1 i7) (<= i7 100)) (=> (not (= i7 root)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i7) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1769 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i7)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1769 i7))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1769 i7))) true)))))) (and (forall ((i7 Int)) (=> (and (<= 1 i7) (<= i7 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1769 i7))) true) (not (= i7 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1769 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i7)))) (position (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i7) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1769 i7)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1769 i7)))) 0)))) (forall ((i7 Int)) (=> (and (<= 1 i7) (<= i7 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1769 i7))) true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1769 j2))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1769 i7))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1769 j2)))) true)) (= j2 i7))))))))))))))
(assert (= o25 (select temp___1769 i1)))
(assert (= o26 (us_split_fields1 o25)))
(assert (= result9 (rec__tree_model__path_type__k o26)))
(assert (=> (= result9 true) (= (tree_structure (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))) true)))
(assert (=> (= result9 true) (and (= temp___1770 (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) root)) (and (dynamic_invariant3 temp___1770 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1770 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1770 root)))) 0) (and (forall ((i7 Int)) (=> (and (<= 1 i7) (<= i7 100)) (=> (not (= i7 root)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i7) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1770 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i7)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1770 i7))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1770 i7))) true)))))) (and (forall ((i7 Int)) (=> (and (<= 1 i7) (<= i7 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1770 i7))) true) (not (= i7 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1770 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i7)))) (position (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i7) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1770 i7)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1770 i7)))) 0)))) (forall ((i7 Int)) (=> (and (<= 1 i7) (<= i7 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1770 i7))) true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1770 j2))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1770 i7))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1770 j2)))) true)) (= j2 i7)))))))))))))))
(assert (=> (= result9 true) (= (mk___rep (mk___split_fields o20 o21)) (select temp___1770 i1))))
(assert (=> (= result9 true) (= o22 (mk___split_fields o20 o21))))
(assert (=> (= result9 true) (= o23 (rec__tree_model__path_type__a o22))))
(assert (=> (= result9 true) (and (= o24 (length o23)) (and (in_range5 o24) (<= (+ 0 o24) 2147483647)))))
(assert (=> (= result9 true) (= result8 (ite (< o24 n2) true false))))
