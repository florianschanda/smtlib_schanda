...
(declare-const n Int)
(declare-const i Int)
(declare-const temp___1818 (Array Int us_rep1))
(declare-const o us_rep)
(declare-const o1 Bool)
(declare-const o2 us_split_fields)
(declare-const o3 us_rep)
(declare-const o4 Int)
(declare-const temp___1817 (Array Int us_rep1))
...
(assert (and (= temp___1817 (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) root)) (and (dynamic_invariant1 temp___1817 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1817 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1817 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1817 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1817 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1817 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1817 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1817 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i1)))) (position (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1817 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1817 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1817 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1817 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1817 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1817 j)))) true)) (= j i1))))))))))))))
(assert (= o5 (select temp___1817 i)))
...
(assert (=> (= result2 true) (and (= temp___1818 (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) root)) (and (dynamic_invariant1 temp___1818 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1818 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1818 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1818 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1818 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1818 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1818 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1818 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i1)))) (position (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1818 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1818 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1818 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1818 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1818 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1818 j)))) true)) (= j i1)))))))))))))))
(assert (=> (= result2 true) (= (mk___rep (mk___split_fields o o1)) (select temp___1818 i))))
(assert (=> (= result2 true) (= o2 (mk___split_fields o o1))))
(assert (=> (= result2 true) (= o3 (rec__tree_model__path_type__a o2))))
(assert (=> (= result2 true) (and (= o4 (length o3)) (and (in_range1 o4) (<= (+ 0 o4) 2147483647)))))
