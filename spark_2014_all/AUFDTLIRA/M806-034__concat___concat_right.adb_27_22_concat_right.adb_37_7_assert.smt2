...
(declare-fun user_eq4 (t18b t18b) Bool)
(declare-const dummy4 t18b)
...
(declare-fun user_eq5 (t22b t22b) Bool)
(declare-const dummy5 t22b)
...
(assert (= (to_rep o) 1))
(assert (= o6 (concat_singleton_right temp___210 1 9 o)))
(assert (= o6 temp___212))
(assert (= (mk 1 o5) temp___2121))
(assert (= (ite (<= (to_rep (first temp___2121)) (to_rep (last temp___2121))) (+ (- (to_rep (last temp___2121)) (to_rep (first temp___2121))) 1) 0) (ite (<= 1 10) (+ (- 10 1) 1) 0)))
(assert (= o7 (slide temp___212 (to_rep (first temp___2121)) 1)))
(assert (= (mk_map__ref result) (mk_map__ref z)))
(assert (= z2 o7))
(assert (= (to_rep (select z2 1)) (to_rep (select x 1))))
(assert (= (to_rep (select z2 10)) 1))
(assert (=> (<= 1 9) (and (and (<= 1 1) (<= 1 10)) (and (<= 1 9) (<= 9 10)))))
(assert (= temp___215 y))
(assert (=> (<= 1 9) (= o10 (+ (- 9 1) 1))))
(assert (=> (not (<= 1 9)) (= o10 0)))
(assert (= o11 (+ o10 1)))
(assert (= o12 (+ 1 o11)))
(assert (= o13 (- o12 1)))
(assert (and (= o14 o13) (in_range1 o13)))
(assert (= (to_rep o8) 1))
(assert (= o9 (concat_singleton_right temp___215 1 9 o8)))
(assert (= o15 (slide o9 1 1)))
(assert (= o15 temp___217))
(assert (= (mk1 1 o14) temp___2171))
(assert (= (ite (<= (to_rep (first2 temp___2171)) (to_rep (last2 temp___2171))) (+ (- (to_rep (last2 temp___2171)) (to_rep (first2 temp___2171))) 1) 0) (ite (<= 1 10) (+ (- 10 1) 1) 0)))
(assert (= o16 (slide temp___217 (to_rep (first2 temp___2171)) 1)))
(assert (= result1 z1))
(assert (= z3 o16))
(assert (= (to_rep (select z3 1)) (to_rep (select y 1))))
(assert (not (= (to_rep (select z3 10)) 1)))
(check-sat)
(exit)
