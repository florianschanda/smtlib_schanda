...
(assert (= (ite (<= (to_rep (first2 temp___1901)) (to_rep (last2 temp___1901))) (+ (- (to_rep (last2 temp___1901)) (to_rep (first2 temp___1901))) 1) 0) (ite (<= 1 10) (+ (- 10 1) 1) 0)))
(assert (= o18 (slide temp___190 (to_rep (first2 temp___1901)) 1)))
(assert (= result1 z1))
(assert (= z3 o18))
