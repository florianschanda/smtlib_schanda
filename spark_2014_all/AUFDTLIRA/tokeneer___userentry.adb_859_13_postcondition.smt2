...
(define-fun dynamic_invariant ((temp___expr_843 Int) (temp___is_init_840 Bool) (temp___skip_constant_841 Bool) (temp___do_toplevel_842 Bool)) Bool (=> (or (= temp___is_init_840 true) (<= 0 1)) (in_range9 temp___expr_843)))
...
(define-fun dynamic_invariant1 ((temp___expr_316 Int) (temp___is_init_313 Bool) (temp___skip_constant_314 Bool) (temp___do_toplevel_315 Bool)) Bool (=> (or (= temp___is_init_313 true) (<= 0 1)) (in_range10 temp___expr_316)))
...
(assert (forall ((x statscount)) (! (in_range11 (to_rep6 x)) :pattern ((to_rep6 x)))))
...
(define-fun dynamic_invariant2 ((temp___expr_1683 Int) (temp___is_init_1680 Bool) (temp___skip_constant_1681 Bool) (temp___do_toplevel_1682 Bool)) Bool (=> (or (= temp___is_init_1680 true) (<= 0 7)) (in_range12 temp___expr_1683)))
...
(assert true)
(define-fun dynamic_invariant7 ((temp___expr_334 Int) (temp___is_init_331 Bool) (temp___skip_constant_332 Bool) (temp___do_toplevel_333 Bool)) Bool (=> (or (= temp___is_init_331 true) (<= 1 150)) (in_range4 temp___expr_334)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(define-fun dynamic_invariant8 ((temp___expr_376 Int) (temp___is_init_373 Bool) (temp___skip_constant_374 Bool) (temp___do_toplevel_375 Bool)) Bool (=> (or (= temp___is_init_373 true) (<= 1901 2099)) (in_range5 temp___expr_376)))
(define-fun dynamic_invariant9 ((temp___expr_382 Int) (temp___is_init_379 Bool) (temp___skip_constant_380 Bool) (temp___do_toplevel_381 Bool)) Bool (=> (or (= temp___is_init_379 true) (<= 1 12)) (in_range6 temp___expr_382)))
(define-fun dynamic_invariant10 ((temp___expr_388 Int) (temp___is_init_385 Bool) (temp___skip_constant_386 Bool) (temp___do_toplevel_387 Bool)) Bool (=> (or (= temp___is_init_385 true) (<= 1 31)) (in_range7 temp___expr_388)))
(define-fun dynamic_invariant11 ((temp___expr_412 Int) (temp___is_init_409 Bool) (temp___skip_constant_410 Bool) (temp___do_toplevel_411 Bool)) Bool (=> (or (= temp___is_init_409 true) (<= 0 86399999)) (in_range8 temp___expr_412)))
(assert true)
(define-fun dynamic_invariant12 ((temp___expr_1028 Int) (temp___is_init_1025 Bool) (temp___skip_constant_1026 Bool) (temp___do_toplevel_1027 Bool)) Bool (=> (or (= temp___is_init_1025 true) (<= 0 2147483647)) (in_range11 temp___expr_1028)))
...
(declare-const thestats__split_fields4 statscount)
(declare-const thestats__split_fields5 statscount)
(declare-const thestats__split_fields6 statscount)
(declare-const thestats__split_fields7 statscount)
...
(declare-const thestats__split_fields8 statscount)
(declare-const thestats__split_fields9 statscount)
(declare-const thestats__split_fields10 statscount)
(declare-const thestats__split_fields11 statscount)
...
(declare-const thestats__split_fields12 statscount)
(declare-const thestats__split_fields13 statscount)
(declare-const thestats__split_fields14 statscount)
(declare-const thestats__split_fields15 statscount)
...
(declare-const thestats__split_fields16 us_split_fields2)
...
(assert (and (= status 6) (= (and (and (= (islocked state1) true) (= (thecurrentdoor state2) 0)) (= (greaterthanorequal (thecurrenttime currenttime) (alarm_timeout state2)) true)) (= (thedooralarm state2) 0))))
(assert (= o (ispresent state4)))
(assert (= result (ite (not (= o true)) true false)))
(assert (=> (= result true) (and (= (and (and (= (islocked state10) true) (= (thecurrentdoor state11) 0)) (= (greaterthanorequal (thecurrenttime currenttime) (alarm_timeout state11)) true)) (= (thedooralarm state11) 0)) (= (= (islocked state10) true) (= (greaterthanorequal (thecurrenttime currenttime) (latch_timeout state10)) true)))))
(assert (=> (= result true) (= result1 status)))
(assert (=> (= result true) (= status2 0)))
(assert (=> (not (= result true)) (= o6 (thecurrenttime currenttime))))
(assert (=> (not (= result true)) (= result2 (greaterthan o6 (mk___rep (mk___split_fields tokenremovaltimeout__split_fields tokenremovaltimeout__split_fields1 tokenremovaltimeout__split_fields2 tokenremovaltimeout__split_fields3))))))
(assert (=> (not (= result true)) (=> (= result2 true) (= o5 (extractuser state4)))))
(assert (=> (not (= result true)) (=> (= result2 true) (= (valid_numberlogentries state15) true))))
(assert (=> (not (= result true)) (=> (= result2 true) (= result3 status))))
(assert (=> (not (= result true)) (=> (= result2 true) (= status3 7))))
(assert (=> (not (= result true)) (=> (not (= result2 true)) (= state17 state3))))
(assert (=> (not (= result true)) (=> (not (= result2 true)) (= filestate3 filestate))))
(assert (=> (not (= result true)) (=> (not (= result2 true)) (= state16 state))))
(assert (=> (not (= result true)) (=> (not (= result2 true)) (= status3 status))))
(assert (=> (not (= result true)) (=> (not (= result2 true)) (= state17 state8))))
(assert (=> (not (= result true)) (=> (not (= result2 true)) (= filestate3 filestate1))))
(assert (=> (not (= result true)) (=> (not (= result2 true)) (= state16 state5))))
(assert (=> (not (= result true)) (=> (not (= result2 true)) (= status3 status1))))
(assert (=> (not (= result true)) (= state12 state4)))
(assert (=> (not (= result true)) (= state14 state17)))
(assert (=> (not (= result true)) (= state11 state2)))
(assert (=> (not (= result true)) (= state10 state1)))
(assert (=> (not (= result true)) (= filestate2 filestate3)))
(assert (=> (not (= result true)) (= state13 state16)))
(assert (=> (not (= result true)) (= thestats__split_fields thestats__split_fields8)))
(assert (=> (not (= result true)) (= thestats__split_fields1 thestats__split_fields9)))
(assert (=> (not (= result true)) (= thestats__split_fields2 thestats__split_fields10)))
(assert (=> (not (= result true)) (= thestats__split_fields3 thestats__split_fields11)))
(assert (=> (not (= result true)) (= status2 status3)))
(assert (=> (not (= result true)) (= state12 state9)))
(assert (=> (not (= result true)) (= state14 state17)))
(assert (=> (not (= result true)) (= state11 state7)))
(assert (=> (not (= result true)) (= state10 state6)))
(assert (=> (not (= result true)) (= filestate2 filestate3)))
(assert (=> (not (= result true)) (= state13 state16)))
(assert (=> (not (= result true)) (= thestats__split_fields4 thestats__split_fields8)))
(assert (=> (not (= result true)) (= thestats__split_fields5 thestats__split_fields9)))
(assert (=> (not (= result true)) (= thestats__split_fields6 thestats__split_fields10)))
(assert (=> (not (= result true)) (= thestats__split_fields7 thestats__split_fields11)))
(assert (=> (not (= result true)) (= status2 status3)))
(assert (= state22 (mk___private__ref state12)))
(assert (= state21 (mk___private__ref state14)))
(assert (= state20 (mk___private__ref state11)))
(assert (= state19 (mk___private__ref state10)))
(assert (= filestate4 (mk___private__ref filestate2)))
(assert (= state18 (mk___private__ref state13)))
(assert (= thestats__split_fields12 thestats__split_fields8))
(assert (= thestats__split_fields13 thestats__split_fields9))
(assert (= thestats__split_fields14 thestats__split_fields10))
(assert (= thestats__split_fields15 thestats__split_fields11))
(assert (= status4 status2))
(assert (= state27 state12))
(assert (= state26 state14))
(assert (= state25 state11))
(assert (= state24 state10))
(assert (= filestate5 filestate2))
(assert (= state23 state13))
(assert (= thestats__split_fields16 (mk___split_fields1 thestats__split_fields8 thestats__split_fields9 thestats__split_fields10 thestats__split_fields11)))
(assert (= status5 status2))
(assert (= (islocked (us_private__content state19)) true))
(assert (= (thecurrentdoor (us_private__content state20)) 0))
(assert (= (greaterthanorequal (thecurrenttime currenttime) (alarm_timeout (us_private__content state20))) true))
(assert (not (= (thedooralarm (us_private__content state20)) 0)))
(check-sat)
(exit)
