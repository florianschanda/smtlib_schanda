...
(declare-fun user_eq (event_index_type event_index_type) Bool)
(declare-const dummy event_index_type)
...
(declare-const dummy5 hour_type)
...
(assert (forall ((x hour_type)) (! (in_range5 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(declare-const dummy6 minute_type)
...
(assert (forall ((x minute_type)) (! (in_range6 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(declare-const dummy7 second_type)
...
(assert (forall ((x second_type)) (! (in_range7 (to_rep5 x)) :pattern ((to_rep5 x)))))
...
(assert (forall ((a (Array Int character)) (b (Array Int character))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq3 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_91 Int)) (=> (and (<= a__first temp___idx_91) (<= temp___idx_91 a__last)) (= (to_rep6 (select a temp___idx_91)) (to_rep6 (select b (+ (- b__first a__first) temp___idx_91)))))))))))
...
(declare-fun user_eq12 (description_count_type description_count_type) Bool)
(declare-const dummy12 description_count_type)
...
(define-fun to_rep7 ((x description_count_type)) Int (description_count_typeqtint x))
...
(assert (forall ((x description_count_type)) (! (in_range9 (to_rep7 x)) :pattern ((to_rep7 x)))))
...
(declare-fun event_count_typeqtint (event_count_type) Int)
(assert (forall ((i event_count_type)) (and (<= 0 (event_count_typeqtint i)) (<= (event_count_typeqtint i) 64))))
...
(define-fun dynamic_invariant ((temp___expr_328 Int) (temp___is_init_324 Bool) (temp___skip_constant_325 Bool) (temp___do_toplevel_326 Bool) (temp___do_typ_inv_327 Bool)) Bool (=> (or (= temp___is_init_324 true) (<= 0 64)) (in_range10 temp___expr_328)))
(declare-const book (Array Int us_rep3))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(define-fun dynamic_invariant1 ((temp___expr_74 Int) (temp___is_init_70 Bool) (temp___skip_constant_71 Bool) (temp___do_toplevel_72 Bool) (temp___do_typ_inv_73 Bool)) Bool (=> (or (= temp___is_init_70 true) (<= 0 255)) (in_range8 temp___expr_74)))
(define-fun dynamic_invariant2 ((temp___expr_274 Int) (temp___is_init_270 Bool) (temp___skip_constant_271 Bool) (temp___do_toplevel_272 Bool) (temp___do_typ_inv_273 Bool)) Bool (=> (or (= temp___is_init_270 true) (<= 0 128)) (in_range9 temp___expr_274)))
(define-fun dynamic_invariant3 ((temp___expr_250 Int) (temp___is_init_246 Bool) (temp___skip_constant_247 Bool) (temp___do_toplevel_248 Bool) (temp___do_typ_inv_249 Bool)) Bool (=> (or (= temp___is_init_246 true) (<= 1 64)) (in_range1 temp___expr_250)))
(define-fun dynamic_invariant4 ((temp___expr_159 Int) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool) (temp___do_typ_inv_158 Bool)) Bool (=> (or (= temp___is_init_155 true) (<= 2000 2099)) (in_range2 temp___expr_159)))
(define-fun dynamic_invariant5 ((temp___expr_166 Int) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool (=> (or (= temp___is_init_162 true) (<= 1 12)) (in_range3 temp___expr_166)))
(define-fun dynamic_invariant6 ((temp___expr_173 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool) (temp___do_typ_inv_172 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= 1 31)) (in_range4 temp___expr_173)))
(define-fun dynamic_invariant7 ((temp___expr_180 Int) (temp___is_init_176 Bool) (temp___skip_constant_177 Bool) (temp___do_toplevel_178 Bool) (temp___do_typ_inv_179 Bool)) Bool (=> (or (= temp___is_init_176 true) (<= 0 23)) (in_range5 temp___expr_180)))
(define-fun dynamic_invariant8 ((temp___expr_187 Int) (temp___is_init_183 Bool) (temp___skip_constant_184 Bool) (temp___do_toplevel_185 Bool) (temp___do_typ_inv_186 Bool)) Bool (=> (or (= temp___is_init_183 true) (<= 0 59)) (in_range6 temp___expr_187)))
(define-fun dynamic_invariant9 ((temp___expr_194 Int) (temp___is_init_190 Bool) (temp___skip_constant_191 Bool) (temp___do_toplevel_192 Bool) (temp___do_typ_inv_193 Bool)) Bool (=> (or (= temp___is_init_190 true) (<= 0 59)) (in_range7 temp___expr_194)))
