...
(assert (= result true))
(assert (and (= stackp__get_model__3__R84s (last4 s)) (and (in_range4 stackp__get_model__3__R84s) (= stackp__get_model__3__R84s (ite (not (= (wraps_around s) true)) (- (+ (to_rep3 (rec__stackp__buffer__first (us_split_fields3 s))) (to_rep2 (rec__stackp__stack_root__length1 (us_split_fields3 s)))) 1) (- (- (+ (to_rep3 (rec__stackp__buffer__first (us_split_fields3 s))) (to_rep2 (rec__stackp__stack_root__length1 (us_split_fields3 s)))) 1) 100))))))
(assert (=> (<= 1 stackp__get_model__3__R84s) (and (and (<= 1 1) (<= 1 100)) (and (<= 1 stackp__get_model__3__R84s) (<= stackp__get_model__3__R84s 100)))))
(assert (= o (rec__stackp__stack_root__content1 (us_split_fields3 s))))
(assert (= o temp___543))
(assert (= (mk3 1 stackp__get_model__3__R84s) temp___5431))
(assert (=> (<= (to_rep3 (rec__stackp__buffer__first (us_split_fields3 s))) 100) (and (and (<= 1 (to_rep3 (rec__stackp__buffer__first (us_split_fields3 s)))) (<= (to_rep3 (rec__stackp__buffer__first (us_split_fields3 s))) 100)) (and (<= 1 100) (<= 100 100)))))
(assert (= o1 (rec__stackp__stack_root__content1 (us_split_fields3 s))))
(assert (= o1 temp___542))
(assert (= (mk2 (to_rep3 (rec__stackp__buffer__first (us_split_fields3 s))) 100) temp___5421))
(assert (=> (= (length2 (mk___t2 temp___542 temp___5421)) 0) (= temp___543 temp___544)))
(assert (=> (= (length2 (mk___t2 temp___542 temp___5421)) 0) (= (mk (to_rep1 (first6 temp___5431)) (to_rep1 (last8 temp___5431))) temp___5441)))
(assert (=> (not (= (length2 (mk___t2 temp___542 temp___5421)) 0)) (=> (<= (to_rep1 (first6 temp___5431)) (to_rep1 (last8 temp___5431))) (= o2 (+ (- (to_rep1 (last8 temp___5431)) (to_rep1 (first6 temp___5431))) 1)))))
(assert (=> (not (= (length2 (mk___t2 temp___542 temp___5421)) 0)) (=> (not (<= (to_rep1 (first6 temp___5431)) (to_rep1 (last8 temp___5431)))) (= o2 0))))
(assert (=> (not (= (length2 (mk___t2 temp___542 temp___5421)) 0)) (=> (<= (to_rep1 (first4 temp___5421)) (to_rep1 (last6 temp___5421))) (= o3 (+ (- (to_rep1 (last6 temp___5421)) (to_rep1 (first4 temp___5421))) 1)))))
(assert (=> (not (= (length2 (mk___t2 temp___542 temp___5421)) 0)) (=> (not (<= (to_rep1 (first4 temp___5421)) (to_rep1 (last6 temp___5421)))) (= o3 0))))
(assert (=> (not (= (length2 (mk___t2 temp___542 temp___5421)) 0)) (= o4 (+ o3 o2))))
(assert (=> (not (= (length2 (mk___t2 temp___542 temp___5421)) 0)) (= o5 (+ 1 o4))))
(assert (=> (not (= (length2 (mk___t2 temp___542 temp___5421)) 0)) (= o6 (- o5 1))))
(assert (=> (not (= (length2 (mk___t2 temp___542 temp___5421)) 0)) (and (= o7 o6) (in_range1 o6))))
(assert (=> (not (= (length2 (mk___t2 temp___542 temp___5421)) 0)) (= (slide (concat1 temp___542 (to_rep1 (first4 temp___5421)) (to_rep1 (last6 temp___5421)) temp___543 (to_rep1 (first6 temp___5431)) (to_rep1 (last8 temp___5431))) (to_rep1 (first4 temp___5421)) 1) temp___544)))
(assert (=> (not (= (length2 (mk___t2 temp___542 temp___5421)) 0)) (= (mk 1 o7) temp___5441)))
(assert (not (dynamic_property1 1 2147483647 (to_rep1 (first temp___5441)) (to_rep1 (last temp___5441)))))
(check-sat)
(exit)
