...
(assert (and (= o (extended_perm a b)) (and (in_range4 o) (=> (= (distinct o 0) true) (forall ((ia Int)) (=> (and (<= (to_rep1 (first (rt a))) ia) (<= ia (to_rep1 (last (rt a))))) (exists ((ib Int)) (and (and (<= (to_rep1 (first (rt b))) ib) (<= ib (to_rep1 (last (rt b))))) (and (= (to_rep (select (elts a) ia)) (to_rep (select (elts b) ib))) (= (is_perm (remove a ia) (remove b ib)) true))))))))))
