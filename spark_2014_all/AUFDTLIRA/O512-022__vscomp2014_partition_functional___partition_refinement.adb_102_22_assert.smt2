...
(declare-const c10 us_rep1)
(assert (= (has_key (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields))) c10) true))
(assert (not (= (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c10) (to_rep (select a1 i)))))
(assert (not (= (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c10) (to_rep (select a1 j)))))
(assert (not (= (to_rep (select a1 (element (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c10))) (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c10))))
(check-sat)
(exit)
