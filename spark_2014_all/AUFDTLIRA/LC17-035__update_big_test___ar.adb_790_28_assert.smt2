...
(assert (= result1 a))
(assert (= a1 o3))
(assert (not (= (bool_eq2 a1 1 16 (temp_____aggregate_def_5332 t1 k (temp_____aggregate_def_5338 (select t1 k) j (temp_____aggregate_def_5344 (select (select t1 k) j) i e))) 1 16) true)))
(check-sat)
(exit)
