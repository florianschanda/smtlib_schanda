...
(assert (forall ((temp___319 Int) (temp___320 Int) (temp___321 Int)) (let ((temp___318 (p__B19b__my_s1__aggregate_def temp___319 temp___320 temp___321))) (and (and (= (select temp___318 1) (of_rep temp___319)) (= (select temp___318 2) (of_rep temp___320))) (= (select temp___318 3) (of_rep temp___321))))))
(declare-fun p__B22b__my_s1__aggregate_def (Int Int Int) (Array Int integer))
(assert (forall ((temp___324 Int) (temp___325 Int) (temp___326 Int)) (let ((temp___323 (p__B22b__my_s1__aggregate_def temp___324 temp___325 temp___326))) (and (and (= (select temp___323 1) (of_rep temp___324)) (= (select temp___323 2) (of_rep temp___325))) (= (select temp___323 3) (of_rep temp___326))))))
(declare-fun p__B25b__my_s1__aggregate_def (Int Int Int) (Array Int integer))
(assert (forall ((temp___329 Int) (temp___330 Int) (temp___331 Int)) (let ((temp___328 (p__B25b__my_s1__aggregate_def temp___329 temp___330 temp___331))) (and (and (= (select temp___328 1) (of_rep temp___329)) (= (select temp___328 2) (of_rep temp___330))) (= (select temp___328 3) (of_rep temp___331))))))
(declare-fun p__B28b__my_s1__aggregate_def (Int Int Int) (Array Int integer))
(assert (forall ((temp___334 Int) (temp___335 Int) (temp___336 Int)) (let ((temp___333 (p__B28b__my_s1__aggregate_def temp___334 temp___335 temp___336))) (and (and (= (select temp___333 1) (of_rep temp___334)) (= (select temp___333 2) (of_rep temp___335))) (= (select temp___333 3) (of_rep temp___336))))))
...
(declare-const my_s14 (Array Int integer))
(declare-const result1 (Array Int integer))
(declare-const my_s24 (Array Int integer))
(declare-const result2 (Array Int integer))
(declare-const my_s15 (Array Int integer))
(declare-const result3 (Array Int integer))
(declare-const my_s25 (Array Int integer))
(declare-const result4 (Array Int integer))
(declare-const my_s16 (Array Int integer))
(declare-const result5 (Array Int integer))
(declare-const my_s26 (Array Int integer))
(declare-const result6 (Array Int integer))
(declare-const my_s17 (Array Int integer))
(declare-const result7 (Array Int integer))
(declare-const my_s27 (Array Int integer))
...
(assert (not (= (to_rep (select my_s24 2)) 1)))
(check-sat)
(exit)
