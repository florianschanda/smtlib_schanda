...
(assert (forall ((i tTmy_s1SP1)) (and (<= 1 (tTmy_s1SP1qtint i)) (<= (tTmy_s1SP1qtint i) 3))))
...
(assert (forall ((i tTmy_s2SP1)) (and (<= 2 (tTmy_s2SP1qtint i)) (<= (tTmy_s2SP1qtint i) 4))))
...
(assert (forall ((i tTmy_s1SP11)) (and (<= 1 (tTmy_s1SP1qtint1 i)) (<= (tTmy_s1SP1qtint1 i) 3))))
...
(assert (forall ((i tTmy_s2SP11)) (and (<= 2 (tTmy_s2SP1qtint1 i)) (<= (tTmy_s2SP1qtint1 i) 4))))
...
(assert (forall ((i tTmy_s1SP12)) (and (<= 1 (tTmy_s1SP1qtint2 i)) (<= (tTmy_s1SP1qtint2 i) 3))))
...
(assert (forall ((i tTmy_s2SP12)) (and (<= 2 (tTmy_s2SP1qtint2 i)) (<= (tTmy_s2SP1qtint2 i) 4))))
...
(assert (forall ((i tTmy_s1SP13)) (and (<= 1 (tTmy_s1SP1qtint3 i)) (<= (tTmy_s1SP1qtint3 i) 3))))
...
(assert (forall ((i tTmy_s2SP13)) (and (<= 2 (tTmy_s2SP1qtint3 i)) (<= (tTmy_s2SP1qtint3 i) 4))))
...
(assert (= my_s11 (p__B19b__my_s1__aggregate_def 1 2 3)))
