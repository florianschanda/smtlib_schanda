...
(assert (= status 6))
(assert (= result (ispresent state1)))
(assert (=> (= result true) (= o (extractuser state))))
(assert (=> (= result true) (= (valid_numberlogentries state3) true)))
(assert (=> (= result true) (= result1 status)))
(assert (=> (= result true) (= status2 7)))
