...
(declare-const r__split_fields11 (Array Int integer))
(declare-const r__split_fields12 ar_index)
(declare-const r__split_fields13 length_type)
...
(assert (and (and (= (to_rep1 r__split_fields13) (- (to_rep1 r__split_fields10) 1)) (= (head (mk___rep (mk___split_fields r__split_fields8 r__split_fields9 r__split_fields10))) h2)) (in_range h2)))
(assert (= h2 y))
(assert (not (not (= (is_empty (mk___rep (mk___split_fields r__split_fields11 r__split_fields12 r__split_fields13))) true))))
(check-sat)
(exit)
