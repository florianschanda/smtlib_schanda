...
(assert (not (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a6 i)))) (to_rep (rec__frame_condition__cell__max_left (us_split_fields1 (select a6 j)))))))
(check-sat)
(exit)
