...
(assert (not (= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a6 i1)))) (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a i1)))))))
(check-sat)
(exit)
