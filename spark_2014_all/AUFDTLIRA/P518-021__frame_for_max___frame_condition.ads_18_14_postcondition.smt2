...
(assert (or (and (and (= a8 (mk_map__ref a)) (= a5 a1)) (and (and (ite (<= (to_rep1 a__first) (to_rep1 a__last)) (= o (+ (- (to_rep1 a__last) (to_rep1 a__first)) 1)) (= o 0)) (= result (ite (= o 0) true false))) (= result true))) (and (and (and (ite (<= (to_rep1 a__first) (to_rep1 a__last)) (= o (+ (- (to_rep1 a__last) (to_rep1 a__first)) 1)) (= o 0)) (= result (ite (= o 0) true false))) (not (= result true))) (and (and (= a3 a4) (= a5 a3)) (and (and (and (= frame_condition__update_max_2__B_3__first__assume (to_rep1 a__first)) (in_range2 (to_rep1 a__first))) (= frame_condition__update_max_2__B_3__first__assume first2)) (and (in_range2 first2) (and (and (and (= frame_condition__update_max_2__B_3__last__assume (to_rep1 a__last)) (in_range2 (to_rep1 a__last))) (= frame_condition__update_max_2__B_3__last__assume last2)) (and (in_range2 last2) (and (and (and (forall ((i Int)) (=> (and (<= first3 i) (<= i last3)) (forall ((j Int)) (=> (and (<= i j) (<= j last3)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a2 i)))) (get_max_left j a2)))))) (forall ((i Int)) (=> (and (<= last3 i) (<= i first3)) (forall ((j Int)) (=> (and (<= i j) (<= j first3)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a2 j)))) (get_max_left i a2))))))) (= (frame_left (mk___t a (mk (to_rep1 a__first) (to_rep1 a__last))) a2) true)) (and (and (forall ((i Int)) (=> (and (<= first4 i) (<= i last4)) (forall ((j Int)) (=> (and (<= i j) (<= j last4)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a3 i)))) (get_max_right j a3)))))) (forall ((i Int)) (=> (and (<= last4 i) (<= i first4)) (forall ((j Int)) (=> (and (<= i j) (<= j first4)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a3 j)))) (get_max_right i a3))))))) (= (frame_right (mk___t a2 (mk (to_rep1 a__first) (to_rep1 a__last))) a3) true)))))))))))
(assert (= (mk_map__ref a6) a8))
(assert (= a7 a5))
(declare-const i Int)
(assert (<= (to_rep1 a__first) i))
(assert (<= i (to_rep1 a__last)))
(assert (not (= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a6 i)))) (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a i)))))))
(check-sat)
(exit)
