...
(assert (= hr3 o21))
(assert (not (= (let ((temp___249 (remove (remove (mk___t interm1 (mk 1 100)) y) x))) (let ((temp___248 (remove (remove (mk___t interm1 (mk 1 100)) x) (- y 1)))) (bool_eq (elts temp___248) (to_rep1 (first (rt temp___248))) (to_rep1 (last (rt temp___248))) (elts temp___249) (to_rep1 (first (rt temp___249))) (to_rep1 (last (rt temp___249)))))) true)))
(check-sat)
(exit)
