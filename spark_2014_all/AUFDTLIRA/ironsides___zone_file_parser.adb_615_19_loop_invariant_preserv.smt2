...
(assert (and (and (and (and (<= begidx2 endidx1) (<= begidx2 zlength)) (<= endidx1 zlength)) (=> (= foundtype1 1) (forall ((i6 Int)) (=> (and (<= begidx2 i6) (<= i6 endidx1)) (and (<= 48 (to_rep (select zonefileline i6))) (<= (to_rep (select zonefileline i6)) 57)))))) (and (and (in_range4 begidx2) (in_range4 endidx1)) (in_range3 foundtype1))))
...
(assert (=> (and (not (= foundtype1 3)) (< endidx1 zlength)) (and (and (and (and (<= begidx5 endidx3) (<= begidx5 zlength)) (<= endidx3 zlength)) (=> (= foundtype3 1) (forall ((i6 Int)) (=> (and (<= begidx5 i6) (<= i6 endidx3)) (and (<= 48 (to_rep (select zonefileline i6))) (<= (to_rep (select zonefileline i6)) 57)))))) (and (and (in_range4 begidx5) (in_range4 endidx3)) (in_range3 foundtype3)))))
...
(assert (= begidx10 o1))
(assert (and (and (and (and (<= begidx11 endidx8) (<= begidx11 zlength)) (<= endidx8 zlength)) (=> (= foundtype8 1) (forall ((i6 Int)) (=> (and (<= begidx11 i6) (<= i6 endidx8)) (and (<= 48 (to_rep (select zonefileline i6))) (<= (to_rep (select zonefileline i6)) 57)))))) (and (and (in_range4 begidx11) (in_range4 endidx8)) (in_range3 foundtype8))))
...
(assert (and (<= 1 temp___1618) (<= temp___1618 128)))
(assert (= o6 temp___1618))
(assert (= o7 (store newdomainname2 o6 o5)))
(assert (= result7 (mk_map__ref newdomainname2)))
(assert (= newdomainname3 o7))
(assert (not (= i2 r24b)))
...
(assert (not (<= (+ (- endidx8 begidx11) 1) 128)))
(check-sat)
(exit)
