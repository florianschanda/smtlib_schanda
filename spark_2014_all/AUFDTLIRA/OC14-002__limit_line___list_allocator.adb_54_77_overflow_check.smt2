...
(assert (=> (not (= first_available 0)) (=> (= result3 true) (and (= o9 (get model____split_fields 1)) (in_range7 o9)))))
...
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (and (= o7 (length model____split_fields1)) (in_range6 o7)))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (= result4 (ite (< 0 o7) true false)))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (=> (= result4 true) (and (= o6 (get model____split_fields1 1)) (in_range7 o6))))))
...
(assert (=> (= result2 true) (=> (not (not (= first_allocated 0))) (and (= o8 (length model____split_fields1)) (in_range6 o8)))))
(assert (=> (= result2 true) (=> (not (not (= first_allocated 0))) (= result1 (ite (= o8 0) true false)))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (=> (= result1 true) (and (= o4 (length model____split_fields)) (in_range6 o4))))
