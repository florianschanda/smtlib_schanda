...
(assert (=> (not (= first_available 0)) (= result3 (ite (< 0 o10) true false))))
(assert (=> (not (= first_available 0)) (=> (= result3 true) (and (= o9 (get model____split_fields 1)) (in_range4 o9)))))
(assert (=> (not (= first_available 0)) (=> (= result3 true) (= result2 (ite (= o9 first_available) true false)))))
...
(assert (=> (not (not (= first_available 0))) (= result2 (ite (= o11 0) true false))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (and (= o7 (length model____split_fields1)) (in_range3 o7)))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (= result4 (ite (< 0 o7) true false)))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (=> (= result4 true) (and (= o6 (get model____split_fields1 1)) (in_range4 o6))))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (=> (= result4 true) (= result1 (ite (= o6 first_allocated) true false))))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (=> (not (= result4 true)) (= result1 false)))))
(assert (=> (= result2 true) (=> (not (not (= first_allocated 0))) (and (= o8 (length model____split_fields1)) (in_range3 o8)))))
(assert (=> (= result2 true) (=> (not (not (= first_allocated 0))) (= result1 (ite (= o8 0) true false)))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (=> (= result1 true) (and (= o4 (length model____split_fields)) (in_range3 o4))))
...
(assert (= result6 true))
(assert (and (= o3 (get model____split_fields1 j)) (in_range4 o3)))
(assert (= result7 (ite (in_range6 o3) true false)))
(assert (= result7 true))
