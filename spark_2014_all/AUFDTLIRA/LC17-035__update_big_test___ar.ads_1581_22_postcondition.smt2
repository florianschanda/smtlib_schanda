...
(declare-fun temp___3303 ((Array Int (Array Int (Array Int et1))) Int (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1))))
(assert (forall ((temp___3305 (Array Int (Array Int (Array Int et1))))) (forall ((temp___3306 Int)) (forall ((temp___3307 (Array Int (Array Int et1)))) (let ((temp___3304 (temp___3303 temp___3305 temp___3306 temp___3307))) (forall ((temp___3308 Int)) (ite (= temp___3308 temp___3306) (= (select temp___3304 temp___3308) temp___3307) (= (select temp___3304 temp___3308) (select temp___3305 temp___3308)))))))))
(declare-fun temp___3309 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
(assert (forall ((temp___3311 (Array Int (Array Int et1)))) (forall ((temp___3312 Int)) (forall ((temp___3313 (Array Int et1))) (let ((temp___3310 (temp___3309 temp___3311 temp___3312 temp___3313))) (forall ((temp___3314 Int)) (ite (= temp___3314 temp___3312) (= (select temp___3310 temp___3314) temp___3313) (= (select temp___3310 temp___3314) (select temp___3311 temp___3314)))))))))
(declare-fun temp___3316 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___3318 (Array Int et1))) (forall ((temp___3319 Int) (temp___3320 Int)) (let ((temp___3317 (temp___3316 temp___3318 temp___3319 temp___3320))) (forall ((temp___3321 Int)) (ite (= temp___3321 temp___3319) (= (select temp___3317 temp___3321) (of_rep temp___3320)) (= (select temp___3317 temp___3321) (select temp___3318 temp___3321))))))))
(define-fun dynamic_invariant4 ((temp___expr_218 Int) (temp___is_init_215 Bool) (temp___skip_constant_216 Bool) (temp___do_toplevel_217 Bool)) Bool (=> (or (= temp___is_init_215 true) (<= 2 6)) (in_range4 temp___expr_218)))
...
(assert (not (= (bool_eq3 (mk___rep (mk___split_fields r__split_fields6 r__split_fields7 r__split_fields8)) (mk___rep (mk___split_fields r__split_fields (temp___3303 r__split_fields1 i (temp___3309 (select r__split_fields1 i) j (temp___3316 (select (select r__split_fields1 i) j) k e))) r__split_fields2))) true)))
(check-sat)
(exit)
