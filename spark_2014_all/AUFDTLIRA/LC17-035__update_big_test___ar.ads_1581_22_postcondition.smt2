...
(declare-fun temp___3362 ((Array Int (Array Int (Array Int et1))) Int (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1))))
(declare-fun temp___3368 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
(declare-fun temp___3375 ((Array Int et1) Int Int) (Array Int et1))
...
(assert (not (= (bool_eq3 (mk___rep (mk___split_fields r__split_fields6 r__split_fields7 r__split_fields8)) (mk___rep (mk___split_fields r__split_fields (temp___3362 r__split_fields1 i (temp___3368 (select r__split_fields1 i) j (temp___3375 (select (select r__split_fields1 i) j) k e))) r__split_fields2))) true)))
(check-sat)
(exit)
