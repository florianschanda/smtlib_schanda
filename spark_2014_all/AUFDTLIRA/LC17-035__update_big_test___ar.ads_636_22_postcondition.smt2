...
(define-fun dynamic_invariant ((temp___expr_170 Int) (temp___is_init_167 Bool) (temp___skip_constant_168 Bool) (temp___do_toplevel_169 Bool)) Bool (=> (or (= temp___is_init_167 true) (<= 90 99)) (in_range2 temp___expr_170)))
(declare-sort et1 0)
...
(assert (not (= n i)))
(assert (not (= n j)))
(assert (not (= (bool_eq2 (select a3 n) 1 16 (select a n) 1 16) true)))
(check-sat)
(exit)
