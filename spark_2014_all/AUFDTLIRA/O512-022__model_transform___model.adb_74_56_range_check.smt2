...
(assert (<= 0 t1))
(assert (<= t1 (- s12 1)))
(assert (and (= o20 t1) (in_range5 t1)))
(assert (= o21 (select cfv2 o20)))
(assert (and (= o22 (to__2 o21)) (and (in_range4 o22) (= o22 (to_rep2 (rec__model__uml_control_flow__to_data (us_split_fields9 o21)))))))
(assert (= o23 (select (map__content2 av8) o22)))
(assert (and (= o24 (name__2 o23)) (and (in_range1 o24) (= o24 (to_rep (rec__model__uml_action__name_data (us_split_fields7 o23)))))))
...
(assert (and (<= 0 t1) (<= t1 100)))
(assert (= o15 t1))
(assert (= (mk___rep1 (mk___split_fields1 o16 o17)) (select temp___451 o15)))
(assert (and (= o18 (to__ (mk___rep1 (mk___split_fields1 o16 o17)))) (and (in_range2 o18) (= o18 (to_rep1 o17)))))
(assert (= o19 (select temp___450 o18)))
(assert (and (= o25 (name o19)) (and (in_range1 o25) (= o25 (to_rep (rec__model__uml_state__name_data (us_split_fields1 o19)))))))
