...
(assert (=> (and (<= 0 s2) (<= s2 100)) (= o19 (select temp___473 s3))))
...
(assert (<= 0 t))
(assert (<= t (- s9 1)))
(assert (and (= o11 t) (in_range5 t)))
(assert (= o12 (select cfv2 o11)))
(assert (and (= o13 (to__2 o12)) (and (in_range4 o13) (= o13 (to_rep2 (rec__model__uml_control_flow__to_data (us_split_fields9 o12)))))))
...
(assert (= o6 t))
(assert (= o18 (select temp___490 o6)))
(assert (and (= o9 (to__ o18)) (and (in_range2 o9) (= o9 (to_rep1 o8)))))
(assert (= o10 (select temp___489 o9)))
