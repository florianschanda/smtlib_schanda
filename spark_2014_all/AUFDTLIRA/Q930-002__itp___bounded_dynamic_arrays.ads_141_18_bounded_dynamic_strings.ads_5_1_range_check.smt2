...
(assert (and (= o1 (length2 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t1 to____split_fields1 to____split_fields2))))) (and (in_range4 o1) (= o1 (to_rep2 to____split_fields)))))
(assert (and (= o2 (length3 tail)) (in_range1 (length3 tail))))
(assert (= o3 (+ o2 o1)))
(assert (= o4 (ite (<= o3 (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity to____split_discrs))) true false)))
