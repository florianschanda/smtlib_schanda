...
(assert (not (= (ite (<= (to_rep1 (first temp___2061)) (to_rep1 (last temp___2061))) (+ (- (to_rep1 (last temp___2061)) (to_rep1 (first temp___2061))) 1) 0) (ite (<= (to_rep1 (first (rt sub))) (to_rep1 (last (rt sub)))) (+ (- (to_rep1 (last (rt sub))) (to_rep1 (first (rt sub)))) 1) 0))))
(check-sat)
(exit)
