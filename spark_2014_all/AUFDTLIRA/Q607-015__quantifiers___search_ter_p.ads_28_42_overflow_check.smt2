...
(assert true)
(assert (forall ((a us_t) (b us_t)) (forall ((last2 Int)) (! (= (= (has_sub_range_in_prefix a last2 b) true) (exists ((j Int)) (and (and (<= (first1 a) j) (<= j last2)) (= (equal_subrange a j b) true)))) :pattern ((has_sub_range_in_prefix a last2 b))))))
...
(assert true)
(assert (forall ((a1 us_t) (b1 us_t)) (forall ((j Int)) (! (= (= (equal_subrange a1 j b1) true) (= (let ((temp___177 (let ((temp___176 (+ (- j 1) (length b1)))) (of_array1 (to_array a1) j temp___176)))) (bool_eq (to_array1 temp___177) (first3 temp___177) (last3 temp___177) (to_array b1) (first1 b1) (last1 b1))) true)) :pattern ((equal_subrange a1 j b1))))))
(declare-const o Int)
...
(assert (and (= o (length b)) (in_range (length b))))
(assert (not (in_range (+ (to_rep (last (rt a))) 1))))
(check-sat)
(exit)
