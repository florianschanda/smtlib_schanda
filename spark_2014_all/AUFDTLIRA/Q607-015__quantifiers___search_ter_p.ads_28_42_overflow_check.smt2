...
(assert true)
(assert (forall ((a1 us_t) (b1 us_t)) (forall ((j Int)) (! (= (= (equal_subrange a1 j b1) true) (= (let ((temp___153 (let ((temp___152 (+ (- j 1) (length b1)))) (of_array1 (to_array a1) j temp___152)))) (bool_eq (to_array1 temp___153) (first3 temp___153) (last3 temp___153) (to_array b1) (first1 b1) (last1 b1))) true)) :pattern ((equal_subrange a1 j b1))))))
(declare-const o Int)
