...
(define-fun dynamic_invariant1 ((temp___expr_138 Int) (temp___is_init_135 Bool) (temp___skip_constant_136 Bool) (temp___do_toplevel_137 Bool)) Bool (=> (or (= temp___is_init_135 true) (<= 1 10)) (in_range2 temp___expr_138)))
...
(assert (= result1 a))
(assert (= a1 o1))
(assert (forall ((n1 Int)) (=> (and (<= 1 n1) (<= n1 i2)) (< 0 (to_rep (select a2 n1))))))
(assert (and (and (=> (<= 1 10) (in_range2 i2)) (forall ((temp___224 Int)) (=> (and (<= 1 temp___224) (<= temp___224 10)) (=> (< i2 temp___224) (= (select a2 temp___224) (select a temp___224)))))) (and (<= 1 i2) (<= i2 10))))
(assert (<= 1 n))
(assert (<= n i2))
(assert (not (<= 1 n)))
(check-sat)
