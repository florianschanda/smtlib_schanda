...
(assert (and (= o8 (+ b_first length1)) (in_range1 (+ b_first length1))))
(assert (= o9 (- o8 1)))
...
(assert (=> (= result1 true) (= o13 (select b8 o12))))
...
(assert (and (<= (to_rep (first (rt a))) temp___280) (<= temp___280 (to_rep (last (rt a))))))
(assert (= o5 temp___280))
