...
(assert (=> (= result2 true) (and (= o9 (remove a ia)) (and (dynamic_invariant1 o9 true false true true) (and (= (invariant__ o9) true) (and (= (to_rep1 (last o1)) (- (to_rep1 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ia 1))) (= (to_rep (select (elts a) k)) (to_rep (select o k))))) (and (forall ((k Int)) (=> (and (<= (+ ia 1) k) (<= k (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select o (- k 1)))))) (forall ((k Int)) (=> (and (<= ia k) (<= k (- (to_rep1 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select o k)))))))))))))
(assert (=> (= result2 true) (and (= result1 (is_perm o9 o8)) (= (= result1 true) (or (and (= (length o9) 0) (= (length o8) 0)) (exists ((ia1 Int)) (and (and (<= (to_rep1 (first o1)) ia1) (<= ia1 (to_rep1 (last o1)))) (exists ((ib3 Int)) (and (and (<= (to_rep1 (first o4)) ib3) (<= ib3 (to_rep1 (last o4)))) (and (= (to_rep (select o ia1)) (to_rep (select o3 ib3))) (= (is_perm (remove o9 ia1) (remove o8 ib3)) true)))))))))))
...
(assert (<= 1 kb))
(assert (<= kb ib2))
(assert (not (<= (to_rep1 (first (rt b))) kb)))
(check-sat)
(exit)
