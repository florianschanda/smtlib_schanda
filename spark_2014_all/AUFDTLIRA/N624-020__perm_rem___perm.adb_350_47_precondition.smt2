...
(assert (and (= (mk___t o13 o14) (remove bb o12)) (and (dynamic_invariant2 (mk___t o13 o14) true false true) (and (= (invariant__ (mk___t o13 o14)) true) (and (= (to_rep1 (last o14)) (- (to_rep1 (last (rt bb))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o12 1))) (= (to_rep (select (elts bb) k)) (to_rep (select o13 k))))) (and (forall ((k Int)) (=> (and (<= (+ o12 1) k) (<= k (to_rep1 (last (rt bb))))) (= (to_rep (select (elts bb) k)) (to_rep (select o13 (- k 1)))))) (forall ((k Int)) (=> (and (<= o12 k) (<= k (- (to_rep1 (last (rt bb))) 1))) (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select o13 k))))))))))))
