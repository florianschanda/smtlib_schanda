...
(declare-fun temp___450 (Int Int Int) us_t1)
...
(assert (= status1 3))
(assert (= (to_rep1 (first2 (rt1 (temp___450 32 (to_rep1 description__first) (to_rep1 description__last))))) (to_rep1 description__first)))
(assert (= (to_rep1 (last2 (rt1 (temp___450 32 (to_rep1 description__first) (to_rep1 description__last))))) (to_rep1 description__last)))
(assert (= (mk___t1 temp___457 temp___4571) (temp___450 32 (to_rep1 description__first) (to_rep1 description__last))))
