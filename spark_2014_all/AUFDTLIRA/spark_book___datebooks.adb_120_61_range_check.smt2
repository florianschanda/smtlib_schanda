...
(define-fun dynamic_invariant ((temp___expr_250 Int) (temp___is_init_246 Bool) (temp___skip_constant_247 Bool) (temp___do_toplevel_248 Bool) (temp___do_typ_inv_249 Bool)) Bool (=> (or (= temp___is_init_246 true) (<= 1 64)) (in_range10 temp___expr_250)))
...
(define-fun dynamic_invariant1 ((temp___expr_274 Int) (temp___is_init_270 Bool) (temp___skip_constant_271 Bool) (temp___do_toplevel_272 Bool) (temp___do_typ_inv_273 Bool)) Bool (=> (or (= temp___is_init_270 true) (<= 0 128)) (in_range11 temp___expr_274)))
(define-fun to_rep8 ((x description_count_type)) Int (description_count_typeqtint x))
...
(declare-fun user_eq17 (status_type status_type) Bool)
(declare-const dummy17 status_type)
...
(define-fun dynamic_invariant2 ((temp___expr_335 Int) (temp___is_init_331 Bool) (temp___skip_constant_332 Bool) (temp___do_toplevel_333 Bool) (temp___do_typ_inv_334 Bool)) Bool (=> (or (= temp___is_init_331 true) (<= 0 3)) (in_range12 temp___expr_335)))
...
(declare-fun temp_____aggregate_def_450 (Int Int Int) us_t1)
...
(assert (forall ((temp___452 Int) (temp___453 Int) (temp___454 Int)) (let ((temp___451 (temp_____aggregate_def_450 temp___452 temp___453 temp___454))) (=> (dynamic_invariant4 temp___452 true true true true) (and (=> (dynamic_property 1 2147483647 temp___453 temp___454) (and (= (first3 temp___451) temp___453) (= (last3 temp___451) temp___454))) (forall ((temp___455 Int)) (= (to_rep (select (to_array1 temp___451) temp___455)) temp___452)))))))
(define-fun dynamic_invariant7 ((temp___expr_159 Int) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool) (temp___do_typ_inv_158 Bool)) Bool (=> (or (= temp___is_init_155 true) (<= 2000 2099)) (in_range4 temp___expr_159)))
(define-fun dynamic_invariant8 ((temp___expr_166 Int) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool (=> (or (= temp___is_init_162 true) (<= 1 12)) (in_range5 temp___expr_166)))
(define-fun dynamic_invariant9 ((temp___expr_173 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool) (temp___do_typ_inv_172 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= 1 31)) (in_range6 temp___expr_173)))
(define-fun dynamic_invariant10 ((temp___expr_180 Int) (temp___is_init_176 Bool) (temp___skip_constant_177 Bool) (temp___do_toplevel_178 Bool) (temp___do_typ_inv_179 Bool)) Bool (=> (or (= temp___is_init_176 true) (<= 0 23)) (in_range7 temp___expr_180)))
(define-fun dynamic_invariant11 ((temp___expr_187 Int) (temp___is_init_183 Bool) (temp___skip_constant_184 Bool) (temp___do_toplevel_185 Bool) (temp___do_typ_inv_186 Bool)) Bool (=> (or (= temp___is_init_183 true) (<= 0 59)) (in_range8 temp___expr_187)))
(define-fun dynamic_invariant12 ((temp___expr_194 Int) (temp___is_init_190 Bool) (temp___skip_constant_191 Bool) (temp___do_toplevel_192 Bool) (temp___do_typ_inv_193 Bool)) Bool (=> (or (= temp___is_init_190 true) (<= 0 59)) (in_range9 temp___expr_194)))
(declare-const description (Array Int character))
(declare-const status Int)
(declare-const i Int)
(declare-const temp___457 (Array Int character))
(declare-const temp___4571 t1)
(declare-const temp___458 (Array Int character))
(declare-const temp___4581 t)
(declare-const temp___459 (Array Int character))
(declare-const temp___4591 t)
...
(assert (=> (<= 0 3) (in_range12 status)))
(assert (=> (<= 1 64) (in_range10 i)))
(assert (= result status))
(assert (= status1 3))
(assert (= (to_rep1 (first2 (rt1 (temp_____aggregate_def_450 32 (to_rep1 description__first) (to_rep1 description__last))))) (to_rep1 description__first)))
(assert (= (to_rep1 (last2 (rt1 (temp_____aggregate_def_450 32 (to_rep1 description__first) (to_rep1 description__last))))) (to_rep1 description__last)))
(assert (= (mk___t1 temp___457 temp___4571) (temp_____aggregate_def_450 32 (to_rep1 description__first) (to_rep1 description__last))))
(assert (= temp___457 temp___458))
(assert (= (mk (to_rep1 (first2 temp___4571)) (to_rep1 (last2 temp___4571))) temp___4581))
(assert (= (ite (<= (to_rep1 (first temp___4581)) (to_rep1 (last temp___4581))) (+ (- (to_rep1 (last temp___4581)) (to_rep1 (first temp___4581))) 1) 0) (ite (<= (to_rep1 description__first) (to_rep1 description__last)) (+ (- (to_rep1 description__last) (to_rep1 description__first)) 1) 0)))
(assert (= (mk___t temp___459 temp___4591) (mk___t temp___458 temp___4581)))
(assert (= o (slide temp___459 (to_rep1 (first temp___4591)) (to_rep1 description__first))))
(assert (= result1 description))
(assert (= description1 o))
(assert (= result2 i))
(assert (= i1 1))
(assert (and (=> (<= 0 3) (in_range12 status2)) (=> (<= 1 64) (in_range10 i2))))
(assert (= (bool_eq4 (rec__datebooks__event_record__date (us_split_fields7 (select book i2))) date) true))
...
(assert (= result3 (ite (< o2 (to_rep8 (rec__datebooks__event_record__description_size (us_split_fields7 (select book i2))))) true false)))
(assert (not (= result3 true)))
(assert (= (to_rep8 (rec__datebooks__event_record__description_size (us_split_fields7 (select book i2)))) r12b))
(assert (in_range11 r12b))
(assert (= result4 j))
(assert (= j1 1))
(assert (<= 1 j1))
(assert (<= j1 r12b))
(assert (and (<= (to_rep8 (rec__datebooks__event_record__description_size (us_split_fields7 (select book i2)))) (ite (<= (to_rep1 description__first) (to_rep1 description__last)) (+ (- (to_rep1 description__last) (to_rep1 description__first)) 1) 0)) (< (- j2 1) (ite (<= (to_rep1 description__first) (to_rep1 description__last)) (+ (- (to_rep1 description__last) (to_rep1 description__first)) 1) 0))))
(assert (and (=> (<= 1 r12b) (dynamic_property3 1 r12b j2)) (and (<= 1 j2) (<= j2 r12b))))
(assert (=> (<= (to_rep1 description__first) (to_rep1 description__last)) (= o4 (+ (- (to_rep1 description__last) (to_rep1 description__first)) 1))))
(assert (=> (not (<= (to_rep1 description__first) (to_rep1 description__last))) (= o4 0)))
(assert (and (= o5 o4) (in_range1 o4)))
(assert (= o6 (ite (< (- j2 1) o5) true false)))
(assert (=> (<= (to_rep1 description__first) (to_rep1 description__last)) (= o3 (+ (- (to_rep1 description__last) (to_rep1 description__first)) 1))))
(assert (=> (not (<= (to_rep1 description__first) (to_rep1 description__last))) (= o3 0)))
