...
(declare-fun user_eq13 (description_count_type description_count_type) Bool)
(declare-const dummy13 description_count_type)
...
(define-fun dynamic_invariant ((temp___expr_231 Int) (temp___is_init_228 Bool) (temp___skip_constant_229 Bool) (temp___do_toplevel_230 Bool)) Bool (=> (or (= temp___is_init_228 true) (<= 0 128)) (in_range10 temp___expr_231)))
...
(assert (forall ((x description_count_type)) (! (in_range10 (to_rep8 x)) :pattern ((to_rep8 x)))))
...
(define-fun in_range11 ((x Int)) Bool (and (<= 1 x) (<= x 64)))
(declare-fun attr__ATTRIBUTE_IMAGE11 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check11 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE11 (us_image) Int)
(declare-fun user_eq16 (event_index_type event_index_type) Bool)
(declare-const dummy16 event_index_type)
...
(define-fun dynamic_invariant1 ((temp___expr_258 Int) (temp___is_init_255 Bool) (temp___skip_constant_256 Bool) (temp___do_toplevel_257 Bool)) Bool (=> (or (= temp___is_init_255 true) (<= 1 64)) (in_range11 temp___expr_258)))
...
(define-fun dynamic_invariant2 ((temp___expr_294 Int) (temp___is_init_291 Bool) (temp___skip_constant_292 Bool) (temp___do_toplevel_293 Bool)) Bool (=> (or (= temp___is_init_291 true) (<= 0 3)) (in_range12 temp___expr_294)))
...
(assert (forall ((temp___408 Int) (temp___409 Int) (temp___410 Int)) (let ((temp___407 (temp___406 temp___408 temp___409 temp___410))) (and (=> (dynamic_property 1 2147483647 temp___409 temp___410) (and (= (first3 temp___407) temp___409) (= (last3 temp___407) temp___410))) (forall ((temp___411 Int)) (= (select (to_array1 temp___407) temp___411) (of_rep temp___408)))))))
...
(declare-const temp___4131 t1)
(declare-const temp___414 (Array Int character))
(declare-const temp___4141 t)
(declare-const temp___415 (Array Int character))
(declare-const temp___4151 t)
...
(assert (=> (<= 1 64) (in_range11 i)))
(assert (= result status))
(assert (= status1 3))
(assert (= (to_rep1 (first2 (rt1 (temp___406 32 (to_rep1 description__first) (to_rep1 description__last))))) (to_rep1 description__first)))
(assert (= (to_rep1 (last2 (rt1 (temp___406 32 (to_rep1 description__first) (to_rep1 description__last))))) (to_rep1 description__last)))
(assert (= (mk___t1 temp___413 temp___4131) (temp___406 32 (to_rep1 description__first) (to_rep1 description__last))))
(assert (= temp___413 temp___414))
(assert (= (mk (to_rep1 (first2 temp___4131)) (to_rep1 (last2 temp___4131))) temp___4141))
(assert (= (ite (<= (to_rep1 (first temp___4141)) (to_rep1 (last temp___4141))) (+ (- (to_rep1 (last temp___4141)) (to_rep1 (first temp___4141))) 1) 0) (ite (<= (to_rep1 description__first) (to_rep1 description__last)) (+ (- (to_rep1 description__last) (to_rep1 description__first)) 1) 0)))
(assert (= (mk___t temp___415 temp___4151) (mk___t temp___414 temp___4141)))
(assert (= o (slide temp___415 (to_rep1 (first temp___4151)) (to_rep1 description__first))))
(assert (= result1 description))
(assert (= description1 o))
(assert (= result2 i))
(assert (= i1 1))
(assert (and (=> (<= 0 3) (in_range12 status2)) (=> (<= 1 64) (in_range11 i2))))
...
(assert (=> (<= (to_rep1 description__first) (to_rep1 description__last)) (= o5 (+ (- (to_rep1 description__last) (to_rep1 description__first)) 1))))
(assert (=> (not (<= (to_rep1 description__first) (to_rep1 description__last))) (= o5 0)))
(assert (and (= o6 o5) (in_range1 o5)))
(assert (= o7 (ite (< (- j2 1) o6) true false)))
