...
(define-fun bool_eq2 ((a us_rep1) (b us_rep1)) Bool (ite (and (and (= (to_rep1 (rec__stackp__buffer__first (us_split_fields3 a))) (to_rep1 (rec__stackp__buffer__first (us_split_fields3 b)))) (= (bool_eq (rec__stackp__stack_root__content1 (us_split_fields3 a)) 1 100 (rec__stackp__stack_root__content1 (us_split_fields3 b)) 1 100) true)) (= (to_rep (rec__stackp__stack_root__length1 (us_split_fields3 a))) (to_rep (rec__stackp__stack_root__length1 (us_split_fields3 b))))) true false))
...
(define-fun default_initial_assumption ((temp___expr_361 us_rep1) (temp___skip_top_level_362 Bool)) Bool (and (and (= (attr__tag1 temp___expr_361) us_tag1) (and (= (to_rep1 (rec__stackp__buffer__first (us_split_fields3 temp___expr_361))) 1) (= (to_rep (rec__stackp__stack_root__length1 (us_split_fields3 temp___expr_361))) 0))) (=> (not (= temp___skip_top_level_362 true)) (= (size (to_base temp___expr_361)) 0))))
...
(assert (forall ((s us_rep1)) (! (= (= (wraps_around s) true) (< 100 (- (+ (to_rep1 (rec__stackp__buffer__first (us_split_fields3 s))) (to_rep (rec__stackp__stack_root__length1 (us_split_fields3 s)))) 1))) :pattern ((wraps_around s)))))
...
(define-fun dynamic_invariant2 ((temp___expr_353 Int) (temp___is_init_350 Bool) (temp___skip_constant_351 Bool) (temp___do_toplevel_352 Bool)) Bool (=> (or (= temp___is_init_350 true) (<= 1 100)) (in_range1 temp___expr_353)))
(declare-const o Bool)
(declare-const result Bool)
(assert (and (= o (wraps_around s)) (= (= o true) (< 100 (- (+ (to_rep1 (rec__stackp__buffer__first (us_split_fields3 s))) (to_rep (rec__stackp__stack_root__length1 (us_split_fields3 s)))) 1)))))
(assert (= result (ite (not (= o true)) true false)))
(assert (= result true))
(assert (not (in_range (- (+ (to_rep1 (rec__stackp__buffer__first (us_split_fields3 s))) (to_rep (rec__stackp__stack_root__length1 (us_split_fields3 s)))) 1))))
(check-sat)
(exit)
