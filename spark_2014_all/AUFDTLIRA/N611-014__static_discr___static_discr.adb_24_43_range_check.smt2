...
(assert (=> (= result true) (= (mk_int__ref result1) result__3)))
(assert (=> (= result true) (= result__1 (to_rep current__split_fields3))))
(assert (=> (not (= result true)) (= (mk_int__ref result2) result__3)))
(assert (=> (not (= result true)) (= result__2 0)))
(assert (=> (not (= result true)) (= result__1 result__2)))
(assert (not (in_range2 (- (to_rep current__split_fields3) 1))))
(check-sat)
(exit)
