...
(declare-fun temp_____aggregate_def_925 ((Array Int (Array Int et1)) Int (Array Int et1) Int (Array Int et1)) (Array Int (Array Int et1)))
(declare-fun temp_____aggregate_def_933 ((Array Int et1) Int Int) (Array Int et1))
(declare-fun temp_____aggregate_def_940 ((Array Int et1) Int Int) (Array Int et1))
(declare-fun temp_____aggregate_def_948 ((Array Int (Array Int et1)) Int (Array Int et1) Int (Array Int et1)) (Array Int (Array Int et1)))
(declare-fun temp_____aggregate_def_956 ((Array Int et1) Int Int) (Array Int et1))
(declare-fun temp_____aggregate_def_963 ((Array Int et1) Int Int) (Array Int et1))
(declare-fun temp_____aggregate_def_971 ((Array Int (Array Int et1)) Int (Array Int et1) Int (Array Int et1)) (Array Int (Array Int et1)))
(declare-fun temp_____aggregate_def_979 ((Array Int et1) Int Int) (Array Int et1))
(declare-fun temp_____aggregate_def_986 ((Array Int et1) Int Int) (Array Int et1))
(declare-fun temp_____aggregate_def_994 ((Array Int (Array Int et1)) Int (Array Int et1) Int (Array Int et1)) (Array Int (Array Int et1)))
(declare-fun temp_____aggregate_def_1002 ((Array Int et1) Int Int) (Array Int et1))
(declare-fun temp_____aggregate_def_1009 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___927 (Array Int (Array Int et1)))) (forall ((temp___928 Int) (temp___930 Int)) (forall ((temp___929 (Array Int et1)) (temp___931 (Array Int et1))) (let ((temp___926 (temp_____aggregate_def_925 temp___927 temp___928 temp___929 temp___930 temp___931))) (=> (and (dynamic_invariant1 temp___928 true true true true) (dynamic_invariant1 temp___930 true true true true)) (forall ((temp___932 Int)) (ite (= temp___932 temp___930) (= (select temp___926 temp___932) temp___931) (ite (= temp___932 temp___928) (= (select temp___926 temp___932) temp___929) (= (select temp___926 temp___932) (select temp___927 temp___932)))))))))))
(assert (forall ((temp___935 (Array Int et1))) (forall ((temp___936 Int) (temp___937 Int)) (let ((temp___934 (temp_____aggregate_def_933 temp___935 temp___936 temp___937))) (=> (and (dynamic_invariant temp___936 true true true true) (dynamic_invariant2 temp___937 true true true true)) (forall ((temp___938 Int)) (ite (= temp___938 temp___936) (= (to_rep (select temp___934 temp___938)) temp___937) (= (select temp___934 temp___938) (select temp___935 temp___938)))))))))
(assert (forall ((temp___942 (Array Int et1))) (forall ((temp___943 Int) (temp___944 Int)) (let ((temp___941 (temp_____aggregate_def_940 temp___942 temp___943 temp___944))) (=> (and (dynamic_invariant temp___943 true true true true) (dynamic_invariant2 temp___944 true true true true)) (forall ((temp___945 Int)) (ite (= temp___945 temp___943) (= (to_rep (select temp___941 temp___945)) temp___944) (= (select temp___941 temp___945) (select temp___942 temp___945)))))))))
(assert (forall ((temp___950 (Array Int (Array Int et1)))) (forall ((temp___951 Int) (temp___953 Int)) (forall ((temp___952 (Array Int et1)) (temp___954 (Array Int et1))) (let ((temp___949 (temp_____aggregate_def_948 temp___950 temp___951 temp___952 temp___953 temp___954))) (=> (and (dynamic_invariant1 temp___951 true true true true) (dynamic_invariant1 temp___953 true true true true)) (forall ((temp___955 Int)) (ite (= temp___955 temp___953) (= (select temp___949 temp___955) temp___954) (ite (= temp___955 temp___951) (= (select temp___949 temp___955) temp___952) (= (select temp___949 temp___955) (select temp___950 temp___955)))))))))))
(assert (forall ((temp___958 (Array Int et1))) (forall ((temp___959 Int) (temp___960 Int)) (let ((temp___957 (temp_____aggregate_def_956 temp___958 temp___959 temp___960))) (=> (and (dynamic_invariant temp___959 true true true true) (dynamic_invariant2 temp___960 true true true true)) (forall ((temp___961 Int)) (ite (= temp___961 temp___959) (= (to_rep (select temp___957 temp___961)) temp___960) (= (select temp___957 temp___961) (select temp___958 temp___961)))))))))
(declare-const rliteral et1)
(assert (= (et1qtint rliteral) 99))
(assert (forall ((temp___965 (Array Int et1))) (forall ((temp___966 Int) (temp___967 Int)) (let ((temp___964 (temp_____aggregate_def_963 temp___965 temp___966 temp___967))) (=> (and (dynamic_invariant temp___966 true true true true) (dynamic_invariant2 temp___967 true true true true)) (forall ((temp___968 Int)) (ite (= temp___968 temp___966) (= (select temp___964 temp___968) rliteral) (= (select temp___964 temp___968) (select temp___965 temp___968)))))))))
(assert (forall ((temp___973 (Array Int (Array Int et1)))) (forall ((temp___974 Int) (temp___976 Int)) (forall ((temp___975 (Array Int et1)) (temp___977 (Array Int et1))) (let ((temp___972 (temp_____aggregate_def_971 temp___973 temp___974 temp___975 temp___976 temp___977))) (=> (and (dynamic_invariant1 temp___974 true true true true) (dynamic_invariant1 temp___976 true true true true)) (forall ((temp___978 Int)) (ite (= temp___978 temp___976) (= (select temp___972 temp___978) temp___977) (ite (= temp___978 temp___974) (= (select temp___972 temp___978) temp___975) (= (select temp___972 temp___978) (select temp___973 temp___978)))))))))))
(assert (forall ((temp___981 (Array Int et1))) (forall ((temp___982 Int) (temp___983 Int)) (let ((temp___980 (temp_____aggregate_def_979 temp___981 temp___982 temp___983))) (=> (and (dynamic_invariant temp___982 true true true true) (dynamic_invariant2 temp___983 true true true true)) (forall ((temp___984 Int)) (ite (= temp___984 temp___982) (= (to_rep (select temp___980 temp___984)) temp___983) (= (select temp___980 temp___984) (select temp___981 temp___984)))))))))
(assert (forall ((temp___988 (Array Int et1))) (forall ((temp___989 Int) (temp___990 Int)) (let ((temp___987 (temp_____aggregate_def_986 temp___988 temp___989 temp___990))) (=> (and (dynamic_invariant temp___989 true true true true) (dynamic_invariant2 temp___990 true true true true)) (forall ((temp___991 Int)) (ite (= temp___991 temp___989) (= (to_rep (select temp___987 temp___991)) temp___990) (= (select temp___987 temp___991) (select temp___988 temp___991)))))))))
(assert (forall ((temp___996 (Array Int (Array Int et1)))) (forall ((temp___997 Int) (temp___999 Int)) (forall ((temp___998 (Array Int et1)) (temp___1000 (Array Int et1))) (let ((temp___995 (temp_____aggregate_def_994 temp___996 temp___997 temp___998 temp___999 temp___1000))) (=> (and (dynamic_invariant1 temp___997 true true true true) (dynamic_invariant1 temp___999 true true true true)) (forall ((temp___1001 Int)) (ite (= temp___1001 temp___999) (= (select temp___995 temp___1001) temp___1000) (ite (= temp___1001 temp___997) (= (select temp___995 temp___1001) temp___998) (= (select temp___995 temp___1001) (select temp___996 temp___1001)))))))))))
(assert (forall ((temp___1004 (Array Int et1))) (forall ((temp___1005 Int) (temp___1006 Int)) (let ((temp___1003 (temp_____aggregate_def_1002 temp___1004 temp___1005 temp___1006))) (=> (and (dynamic_invariant temp___1005 true true true true) (dynamic_invariant2 temp___1006 true true true true)) (forall ((temp___1007 Int)) (ite (= temp___1007 temp___1005) (= (to_rep (select temp___1003 temp___1007)) temp___1006) (= (select temp___1003 temp___1007) (select temp___1004 temp___1007)))))))))
(assert (forall ((temp___1011 (Array Int et1))) (forall ((temp___1012 Int) (temp___1013 Int)) (let ((temp___1010 (temp_____aggregate_def_1009 temp___1011 temp___1012 temp___1013))) (=> (and (dynamic_invariant temp___1012 true true true true) (dynamic_invariant2 temp___1013 true true true true)) (forall ((temp___1014 Int)) (ite (= temp___1014 temp___1012) (= (select temp___1010 temp___1014) rliteral) (= (select temp___1010 temp___1014) (select temp___1011 temp___1014)))))))))
...
(declare-const temp___4648 (Array Int (Array Int et1)))
(declare-const o12 Int)
(declare-const o13 Int)
(declare-const o14 (Array Int et1))
(declare-const o15 (Array Int et1))
(declare-const o16 Int)
(declare-const temp___4643 (Array Int (Array Int et1)))
...
(assert (= a4 a2))
(assert (=> (< j 50) (=> (< 0 e) (and (= o13 (- e 1)) (in_range2 (- e 1))))))
(assert (=> (< j 50) (=> (< 0 e) (and (<= 5 (+ j 1)) (<= (+ j 1) 50)))))
(assert (=> (< j 50) (=> (< 0 e) (= o12 (+ j 1)))))
(assert (=> (< j 50) (=> (< 0 e) (= o14 (select a o12)))))
(assert (=> (< j 50) (=> (< 0 e) (= o15 (temp_____aggregate_def_940 o14 i o13)))))
(assert (=> (< j 50) (=> (< 0 e) (and (= o16 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (< j 50) (=> (< 0 e) (= temp___4643 (temp_____aggregate_def_925 a j (temp_____aggregate_def_933 (select a j) i e) o16 o15)))))
(assert (=> (< j 50) (=> (< 0 e) (= result7 (bool_eq1 a3 5 50 temp___4643 5 50)))))
(assert (=> (< j 50) (=> (not (< 0 e)) (= result7 false))))
(assert (=> (< j 50) (=> (= result7 true) (= result6 true))))
(assert (=> (< j 50) (=> (not (= result7 true)) (=> (= e 0) (and (<= 5 (+ j 1)) (<= (+ j 1) 50))))))
(assert (=> (< j 50) (=> (not (= result7 true)) (=> (= e 0) (= o8 (+ j 1))))))
(assert (=> (< j 50) (=> (not (= result7 true)) (=> (= e 0) (= o9 (select a o8))))))
(assert (=> (< j 50) (=> (not (= result7 true)) (=> (= e 0) (= o10 (temp_____aggregate_def_963 o9 i 99))))))
(assert (=> (< j 50) (=> (not (= result7 true)) (=> (= e 0) (and (= o11 (+ j 1)) (in_range1 (+ j 1)))))))
(assert (=> (< j 50) (=> (not (= result7 true)) (=> (= e 0) (= temp___4648 (temp_____aggregate_def_948 a j (temp_____aggregate_def_956 (select a j) i e) o11 o10))))))
(assert (=> (< j 50) (=> (not (= result7 true)) (=> (= e 0) (= result6 (bool_eq1 a3 5 50 temp___4648 5 50))))))
(assert (=> (< j 50) (=> (not (= result7 true)) (=> (not (= e 0)) (= result6 false)))))
(assert (=> (not (< j 50)) (= result6 false)))
