...
(declare-const temp___4589 (Array Int (Array Int et1)))
(declare-const o13 Int)
(declare-const o14 Int)
(declare-const o15 (Array Int et1))
(declare-const o16 (Array Int et1))
(declare-const o17 Int)
(declare-const temp___4584 (Array Int (Array Int et1)))
...
(assert (= a1 o2))
(assert (=> (= j 50) (= (mk_int__ref result1) (mk_int__ref j_next))))
(assert (=> (= j 50) (= j_next1 5)))
(assert (=> (not (= j 50)) (and (= o3 (+ j 1)) (in_range1 (+ j 1)))))
(assert (=> (not (= j 50)) (= (mk_int__ref result2) (mk_int__ref j_next))))
...
(assert (=> (< j 50) (=> (< 0 e) (= o16 (temp___881 o15 i o14)))))
(assert (=> (< j 50) (=> (< 0 e) (and (= o17 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (< j 50) (=> (< 0 e) (= temp___4584 (temp___866 a j (temp___874 (select a j) i e) o17 o16)))))
(assert (=> (< j 50) (=> (< 0 e) (= result7 (bool_eq1 a3 5 50 temp___4584 5 50)))))
(assert (=> (< j 50) (=> (not (< 0 e)) (= result7 false))))
(assert (=> (< j 50) (=> (= result7 true) (= result6 true))))
(assert (=> (< j 50) (=> (not (= result7 true)) (=> (= e 0) (and (<= 5 (+ j 1)) (<= (+ j 1) 50))))))
(assert (=> (< j 50) (=> (not (= result7 true)) (=> (= e 0) (= o9 (+ j 1))))))
(assert (=> (< j 50) (=> (not (= result7 true)) (=> (= e 0) (= o10 (select a o9))))))
(assert (=> (< j 50) (=> (not (= result7 true)) (=> (= e 0) (= o11 (temp___904 o10 i 99))))))
(assert (=> (< j 50) (=> (not (= result7 true)) (=> (= e 0) (and (= o12 (+ j 1)) (in_range1 (+ j 1)))))))
(assert (=> (< j 50) (=> (not (= result7 true)) (=> (= e 0) (= temp___4589 (temp___889 a j (temp___897 (select a j) i e) o12 o11))))))
(assert (=> (< j 50) (=> (not (= result7 true)) (=> (= e 0) (= result6 (bool_eq1 a3 5 50 temp___4589 5 50))))))
